...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 907,
    [".nodehawkrc"] = 559,
    [".npmpackagejsonlintrc"] = 563,
    [".omletrc"] = 1085,
    [".phrase.yml"] = 633,
    [".phraseapp.yml"] = 634,
    [".pmbot.yml"] = 619,
    [".postcssrc"] = 628,
    [".powerpages-web-template-manifest"] = 630,
    [".pre-commit-config.yml"] = 631,
    [".pre-commit-hooks.yml"] = 632,
    [".putout.json"] = 666,
    [".rehyperc"] = 691,
    [".remarkrc"] = 695,
    [".sprite files"] = 784,
    ...
    AIConfig = 29,
    ["AMX Muse Program Descriptor"] = 1133,
    ["API Builder"] = 942,
    ["AVA Configuration"] = 1005,
    ["AWS AppConfig Feature Flags-v1"] = 62,
    ["AWS CDK cdk.json"] = 245,
    ["AWS CloudFormation"] = 246,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 247,
    ["AWS Copilot Manifest"] = 1172,
    ["AWS SAM CLI Samconfig"] = 248,
    ["Adobe UXP Manifest"] = 1068,
    ["Aerleon Network & Service Definitions"] = 16,
    ["Aerleon Policy"] = 17,
    Aider = 1162,
    Air = 19,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1183,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1182,
    ["Airlock Microgateway"] = 30,
    ["Alacritty Configuration"] = 977,
    ["All Contributors configuration file"] = 1031,
    ["Ansible Argument Specs"] = 380,
    ["Ansible Collection Galaxy"] = 387,
    ["Ansible Execution Environment"] = 377,
    ["Ansible Inventory"] = 386,
    ["Ansible Meta"] = 378,
    ["Ansible Meta Runtime"] = 379,
    ["Ansible Navigator Configuration"] = 389,
    ["Ansible Playbook"] = 384,
    ["Ansible Requirements"] = 381,
    ["Ansible Rulebook"] = 385,
    ["Ansible Tasks File"] = 383,
    ["Ansible Vars File"] = 382,
    ["Ansible-lint Configuration"] = 388,
    Any = 1095,
    ["AnyWork Automation Configuration"] = 12,
    ["Apollo Router"] = 943,
    ["App config Spotify Backstage"] = 34,
    ["Application Accelerator"] = 9,
    ["Application list for a WinUtil"] = 1112,
    ArchitectFX = 1117,
    ["Argo CD"] = 49,
    ["Argo Events"] = 50,
    ["Argo Workflows"] = 51,
    ...
    AutoAPICase = 1041,
    ["Avro Avsc"] = 61,
    ["Azure Container App template for defining an immutable revision"] = 63,
    ["Azure DevOps extension manifest"] = 66,
    ["Azure Device Update for IoT Hub import manifest"] = 64,
    ["Azure Device Update for IoT Hub update manifest"] = 65,
    ["Azure IoT Edge deployment"] = 69,
    ["Azure IoT Edge deployment template"] = 70,
    ["Azure IoT EdgeAgent deployment"] = 67,
    ["Azure IoT EdgeHub deployment"] = 68,
    ["Azure IoT Operations Wasm Graph Config"] = 1181,
    ["Azure IoT Operations connector metadata"] = 1178,
    ["Azure Landing Zones Library archetype definition"] = 74,
    ["Azure Landing Zones Library archetype override"] = 75,
    ["Azure Landing Zones Library architecture definition"] = 73,
    ["Azure Landing Zones Library metadata"] = 71,
    ["Azure Landing Zones Library policy default values"] = 72,
    ["Azure Pipelines"] = 103,
    ["Azure Static Web Apps CLI configuration file"] = 788,
    ["Azure Static Web Apps configuration file"] = 787,
    ["BOSH CPI Config"] = 127,
    ["BOSH Deploy Config"] = 128,
    ["BX CI"] = 147,
    ["Bacon config"] = 3,
    ["Bashly (bashly.yml)"] = 1035,
    ["Bashly Settings (bashly-settings.yml)"] = 1036,
    ["Better Code Hub"] = 947,
    ["Better Scripts"] = 148,
    Bigconfig = 120,
    ["Biome Formatter Config"] = 76,
    ["Bitmovin Encoding Template"] = 1126,
    BizTalkServerApplicationSchema = 914,
    Bleep = 149,
    ["Block Protocol Metadata"] = 146,
    ["Boyka Framework"] = 129,
    Briefcase = 920,
    ["Build Info"] = 137,
    Buildkite = 139,
    ["Bukkit plugin.yml"] = 138,
    ["BungeeCord plugin.yml"] = 144,
    ["Butane Config"] = 990,
    C4InterFlow = 1141,
    ["CDK Environment Manager, concrete environment configuration"] = 1165,
    ["CDK Environment Manager, concrete environments definition"] = 1164,
    ["CDK Environment Manager, environment definition"] = 1163,
    ["CGS Card Game Specification (cgs.json)"] = 1073,
    ["CICS TS region tagging"] = 999,
    ["CICS TS resource import"] = 1000,
    ["CICS TS resource model"] = 1001,
    ["CICS TS resource overrides"] = 1002,
    ["CMake Presets"] = 150,
    ["CNC Codes"] = 171,
    ["CRS WAF test file"] = 1102,
    ["CRS WAF test platform overrides file"] = 1103,
    ["CSS Comb (.csscomb.json)"] = 273,
    ["CSS Lint (.csslintrc)"] = 274,
    ["CSpell (cspell.json)"] = 272,
    ["CVE Record Format"] = 179,
    CWL = 1079,
    ["Cache Warmup config"] = 151,
    ["Calqulus pipeline"] = 152,
    ["Camel YAML DSL"] = 153,
    ["Cannon TOML"] = 154,
    Carafe = 155,
    ["Cargo Make"] = 157,
    ["Cargo Manifest"] = 156,
    ["Catalog Info Backstage"] = 158,
    ["Chamaleon environment"] = 1130,
    ["Chamaleon properties"] = 1131,
    ["Chamaleon template"] = 1129,
    Changepacks = 1192,
    Changesets = 257,
    Changie = 159,
    Charmcraft = 160,
    Cheatsheets = 987,
    ["ChordPro Configuration"] = 161,
    ["Chrome Extension"] = 238,
    ["Chromia Model"] = 162,
    ["Chromia Seeder Module Config"] = 164,
    ["Chromia Seeder Root Config"] = 163,
    ["Cinnamon Spice info.json"] = 83,
    ["CircleCI config.yml"] = 214,
    ["Citation File Format"] = 259,
    CityJSON = 166,
    ["Claude Code Settings"] = 178,
    ["Clawject config"] = 177,
    ["Cloud Foundry Application Manifest"] = 1084,
    ["Cloud Run Spec v1"] = 1107,
    ["Cloud.gov Workshop Configuration"] = 84,
    ["CloudCannon Configuration"] = 89,
    ["CloudCannon Configuration (Collection Structures)"] = 98,
    ["CloudCannon Configuration (Collections)"] = 97,
    ["CloudCannon Configuration (Editables)"] = 96,
    ["CloudCannon Configuration (Inputs)"] = 91,
    ["CloudCannon Configuration (Snippets Definitions)"] = 95,
    ["CloudCannon Configuration (Snippets Imports)"] = 94,
    ["CloudCannon Configuration (Snippets)"] = 93,
    ["CloudCannon Configuration (Structure Value)"] = 92,
    ["CloudCannon Configuration (Structures)"] = 90,
    ["CloudEvents specification"] = 167,
    ["Code Climate"] = 215,
    CodeCV = 87,
    CodeRabbit = 86,
    ["CodeShip Pro services configuration files"] = 227,
    ["CodeShip Pro steps configuration files"] = 228,
    ["Codecov configuration files"] = 226,
    CodifyCLI = 88,
    Codux = 224,
    ["Cog config file"] = 172,
    ["Commandbox Box.json"] = 173,
    ["Commandbox Server.json"] = 174,
    ["Common Catalog Data"] = 236,
    ["Common Package Specification"] = 175,
    Concord = 1101,
    ["Configu .cfgu files"] = 1089,
    ["Configu .configu file"] = 1090,
    Conjure = 170,
    ["Container Structure Test"] = 928,
    Containerlab = 956,
    ["Contextive Glossary"] = 1157,
    Convex = 169,
    ["Crowdsec collection config"] = 267,
    ["Crowdsec parser config"] = 268,
    ["Crowdsec scenario config"] = 269,
    ["CumulusCI Config"] = 176,
    ["Custom Machinery Machine"] = 1074,
    ["Custom Machinery Recipe"] = 1075,
    ["Cycle Stack File"] = 180,
    CycloneDX = 181,
    ["DWP Exchange - catalogue entry"] = 316,
    ["DWP Exchange - gateway"] = 314,
    ["DWP Exchange - meta"] = 315,
    ["Dart Build Config (dart-build.json)"] = 275,
    ["Dart Test Config (dart-test.json)"] = 276,
    ["DashLord Configuration"] = 277,
    ["Data Contract Specification"] = 278,
    ["Data Product Specification"] = 279,
    ["DataYoga Connections"] = 182,
    ["DataYoga Job"] = 183,
    ["Databricks Asset Bundles"] = 1052,
    ["Datadog Continuous Testing"] = 478,
    ["Datadog Service Definition"] = 479,
    ["Datadog Software Catalog"] = 480,
    ["Datahub Ingestion Recipe"] = 1006,
    ["Debian Upstream Metadata file"] = 189,
    ["Deck config"] = 190,
    ["Dein Config"] = 191,
    ["Deno Config (deno.json)"] = 285,
    ["Dependency cruiser"] = 192,
    ["DeployStack Configuration"] = 193,
    ["Deployah Configuration"] = 1180,
    ["Deployer Recipe"] = 288,
    ["Deta Spacefile"] = 194,
    ["Detekt Config (detekt.yml)"] = 289,
    ["Devbox Config"] = 195,
    ["Devbox Plugin"] = 196,
    Devfile = 313,
    Devup = 1193,
    DipDup = 1104,
    ["Discord Webhook"] = 290,
    ["DocFx Config (docfx.json)"] = 294,
    Dofigen = 295,
    ["Dolittle Artifacts"] = 296,
    ["Dolittle Bounded Context Configuration"] = 297,
    ["Dolittle Event Horizons Configuration"] = 298,
    ["Dolittle Resources Configuration"] = 299,
    ["Dolittle Server Configuration"] = 300,
    ["Dolittle Tenant Map Configuration"] = 302,
    ["Dolittle Tenants Configuration"] = 301,
    ["Dolittle Topology"] = 303,
    ["DonateCaseBetterCasino menu"] = 1134,
    ["Drupal Breakpoints"] = 197,
    ["Drupal Config"] = 209,
    ["Drupal Info"] = 198,
    ["Drupal Layouts"] = 199,
    ["Drupal Libraries"] = 200,
    ["Drupal Links Action"] = 201,
    ["Drupal Links Contextual"] = 202,
    ["Drupal Links Menu"] = 203,
    ["Drupal Links Task"] = 204,
    ["Drupal Migration"] = 205,
    ["Drupal Permissions"] = 206,
    ["Drupal Recipe"] = 207,
    ["Drupal Routing"] = 208,
    ["Drupal Services"] = 210,
    ["Drush site aliases"] = 309,
    ["Dynamic Bash Aliases (.aliases)"] = 1043,
    ["EAS config"] = 333,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1032,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1177,
    ["EasyVCR .NET"] = 334,
    ["Eidolon Resource"] = 1118,
    ["Elgato Stream Deck"] = 319,
    Elm = 1106,
    ["Embrace Config"] = 1018,
    Endurica = 1056,
    ["Enterprise Contract Policy Spec"] = 320,
    ["Erda Pipeline"] = 1081,
    ["Erda Runtime"] = 1082,
    Esquio = 322,
    ["Estuary Flow Catalog"] = 996,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 326,
    ["EveryVoice TTS Toolkit Data Configuration"] = 327,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 331,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 330,
    ["EveryVoice TTS Toolkit Text Configuration"] = 328,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 329,
    ["Evolving Resolutive Process notation"] = 1179,
    ["Expo SDK"] = 332,
    ["F-Droid Data metadata"] = 338,
    ["FasterCI Configuration"] = 104,
    FiQuS = 342,
    Firebase = 340,
    ["FlexGet Config"] = 343,
    ["Flow.json Configurations"] = 1078,
    ["Fossa configuration file"] = 350,
    ["Fossa's fossa-deps file"] = 351,
    ["Foundry VTT - Base package Manifest"] = 345,
    ["Foundry VTT - Module Manifest"] = 346,
    ["Foundry VTT - System Data Template"] = 349,
    ["Foundry VTT - System Manifest"] = 347,
    ["Foundry VTT - World Manifest"] = 348,
    ["Foxx Manifest"] = 105,
    ["Freifunk.de Community API"] = 108,
    ["Frogbot Config"] = 109,
    ["G2P Mapping Configuration"] = 357,
    ["GCP Blueprint Metadata"] = 360,
    Gaspar = 358,
    ["GatewayCore API Gateway"] = 359,
    ["Gemini CLI settings"] = 361,
    ["GeoJSON.json latest"] = 994,
    GherKing = 998,
    ["GitHub Action"] = 366,
    ["GitHub Actions typing"] = 1114,
    ["GitHub Discussion"] = 367,
    ["GitHub Funding"] = 368,
    ["GitHub Issue Template configuration"] = 369,
    ["GitHub Issue Template forms"] = 370,
    ["GitHub Workflow"] = 371,
    ["GitHub Workflow Template Properties"] = 372,
    ["GitHub automatically generated release notes configuration"] = 373,
    ["GitLab Agent for Kubernetes configuration"] = 1070,
    GitVersion = 363,
    ["Gitea Issue Template configuration"] = 364,
    ["Gitea Issue Template forms"] = 365,
    ["Gitpod Automations"] = 375,
    ["Gitpod Configuration"] = 376,
    ["GlazeWM settings"] = 1072,
    ["Global Privacy Control"] = 362,
    Goblet = 1051,
    ["Golangci-lint Configuration"] = 391,
    ["Golangci-lint Custom Plugins Configuration"] = 392,
    ["Google Chrome Related Website Sets"] = 341,
    ["Google Cloud Workflows"] = 244,
    ["Google Digital Assetlinks"] = 1158,
    Goreleaser = 394,
    ["Goreleaser Pro"] = 395,
    Goss = 396,
    ["Gradle Build Cache Node"] = 945,
    ["Gradle Enterprise"] = 944,
    ["Grafana 5.x Dashboard"] = 397,
    ["GraphQL Code Generator"] = 402,
    ["GraphQL Config"] = 401,
    ["GraphQL Mesh"] = 400,
    ["GroovyLint configuration"] = 403,
    ["Grunt JSHint task"] = 407,
    ["Grunt Watch task"] = 408,
    ["Grunt base task"] = 409,
    ["Grunt clean task"] = 405,
    ["Grunt copy task"] = 404,
    ["Grunt cssmin task"] = 406,
    HEMTT = 910,
    Hadolint = 924,
    Hammerkit = 955,
    ["Hardware Sentry Configuration"] = 1010,
    ["HashiCorp Vault"] = 410,
    Hatch = 925,
    Hayson = 412,
    ["Haystack Pipeline"] = 413,
    ["Hazelcast 5 Configuration"] = 414,
    ["Hecate Input Schema"] = 1169,
    ["Helm Chart.lock"] = 212,
    ["Helm Chart.yaml"] = 211,
    ["Helm Unittest Test Suite"] = 213,
    ["Home Assistant Integration Manifest"] = 415,
    ["Homer dashboard configuration"] = 416,
    Hugo = 986,
    ["Hugo Theme"] = 985,
    ["Hulak Configuration"] = 423,
    ["Hyperfoil benchmark configuration"] = 422,
    ["IBM Zapp document"] = 424,
    ["IBM zCodeFormatSettings"] = 425,
    ["IMG Catapult PSP"] = 430,
    ["IVMS101 by CODE Protocol"] = 1071,
    Infrahub = 432,
    Istanbul = 1014,
    ["JDownloader2 crawler multi-rules"] = 445,
    ["JDownloader2 crawler single-rules"] = 444,
    ["JFrog Applications Config"] = 446,
    ["JFrog File Spec"] = 447,
    ["JFrog Pipelines YML DSL"] = 1020,
    ["JMeter DSL cli config"] = 448,
    JReleaser = 451,
    ["JSON Document Transform"] = 459,
    ["JSON Feed"] = 460,
    ["JSON Resume"] = 701,
    ["JSON Schema Draft 2020-12"] = 892,
    ["JSON Schema Draft 4"] = 889,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1053,
    ["JSON Schema Draft 7"] = 890,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1054,
    ["JSON Schema Draft 8 (2019-09)"] = 891,
    ["JSON-API"] = 458,
    ["JSON-e templates"] = 952,
    ["JSON-stat 2.0"] = 885,
    JSONPatch = 462,
    ["JSR Package Config (jsr.json)"] = 452,
    Jarl = 1185,
    Jasmine = 439,
    Jekyll = 440,
    ["Jenkins X Pipelines"] = 441,
    ["Jenkins X Requirements"] = 442,
    Jest = 443,
    Jocker = 449,
    ["Jovo Language Models"] = 450,
    ["Jujutsu (jj) VCS config"] = 1171,
    ["KIMMDY config file"] = 473,
    ["KODE/CI build.yaml"] = 1016,
    ["KSP-AVC"] = 886,
    ["KSP-CKAN"] = 887,
    ["KSP-NetKAN"] = 888,
    KSY = 1083,
    KSail = 355,
    ["Karakum configuration file"] = 352,
    Kas = 465,
    ["Kestra flow file"] = 474,
    ["Keycloak REST API"] = 1023,
    ["Knative Functions - func.yaml"] = 353,
    Knip = 354,
    ["Kometa (nightly) config file"] = 476,
    ["Kometa config file"] = 475,
    ["Kong DBLess config"] = 1017,
    KrakenD = 477,
    ["Kubri Configuration"] = 484,
    LOOBin = 499,
    ["Lake configuration file"] = 1174,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 249,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 250,
    ["Landing Zone Accelerator on AWS - Global Config"] = 251,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 252,
    ["Landing Zone Accelerator on AWS - Network Config"] = 253,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 254,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 255,
    ["Landing Zone Accelerator on AWS - Security Config"] = 256,
    ["Lando (landofile)"] = 99,
    ["LangGraph Platform configuration"] = 1094,
    ["Language configuration"] = 1093,
    Lefthook = 488,
    ["Liferay client-extension.yaml"] = 495,
    ["LinkML Metamodel"] = 497,
    Liquibase = 961,
    ["Liquibase Flow File"] = 962,
    ["Lively Properties"] = 498,
    ["Lobe AI Agent"] = 101,
    Loki = 102,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 539,
    ["MS2Rescore Configuration"] = 542,
    ["Madness (madness.yml)"] = 1034,
    ["Mado configuration"] = 505,
    ["MapEHR Mapping"] = 506,
    Markdownlint = 965,
    ["Mason Registry"] = 968,
    ["MegaLinter Custom Flavor"] = 509,
    ["MegaLinter configuration"] = 508,
    ["MegaLinter descriptor"] = 510,
    Melange = 1061,
    ["Meltano project definition"] = 511,
    ["Mergify Configuration"] = 543,
    ["Metadata for a Bazel module"] = 512,
    ["Metadata for a Cinnamon spice"] = 1110,
    ["Metatype Configuration"] = 513,
    ["MetricsHub Configuration"] = 514,
    ["MetricsHub Connector Configuration"] = 515,
    ["Micro Editor Syntax"] = 1044,
    ["Microsoft Band Web Tile"] = 516,
    ["Microsoft RulesEngine workflow rules"] = 1098,
    ["Microsoft RulesEngine workflow rules list"] = 1099,
    ["Minecraft Custom Main Menu Mod"] = 1062,
    ["Minecraft Data Pack Advancement"] = 518,
    ["Minecraft Data Pack Biome"] = 519,
    ["Minecraft Data Pack Configured Carver"] = 520,
    ["Minecraft Data Pack Damage Type"] = 521,
    ["Minecraft Data Pack Dimension"] = 523,
    ["Minecraft Data Pack Dimension Type"] = 522,
    ["Minecraft Data Pack Item Modifier"] = 524,
    ["Minecraft Data Pack Loot Table"] = 525,
    ["Minecraft Data Pack Metadata"] = 526,
    ["Minecraft Data Pack Predicate"] = 527,
    ["Minecraft Data Pack Recipe"] = 528,
    ["Minecraft Data Pack Tag"] = 529,
    ["Minecraft Data Pack Template Pool"] = 530,
    ["Minecraft Data Pack Trim Material"] = 535,
    ["Minecraft Data Pack Trim Pattern"] = 536,
    ["Minecraft Resource Pack Lang"] = 531,
    ["Minecraft Resource Pack Particle"] = 532,
    ["Minecraft Resource Pack Texture Mcmeta"] = 534,
    ["Minecraft Resourcepack Sounds"] = 533,
    ["Monade CLI Stack Configuration"] = 546,
    ["MongoDB Atlas Search Index Definition"] = 1015,
    ["Monika Configuration"] = 1013,
    ["Monoweave Configuration"] = 541,
    ["Motif config"] = 906,
    MultiQC = 1151,
    ["NOX Framework (Service)"] = 562,
    ["Netin Diagnostic System Template"] = 972,
    ["Netlify config"] = 549,
    ["Network-as-Code Data Model"] = 550,
    ["Next Gen UI Agent A2A Server Configuration"] = 551,
    ["Next Gen UI Agent Configuration"] = 553,
    ["Next Gen UI Agent MCP Server Configuration"] = 552,
    ["Nightwatch.js"] = 555,
    ["Node.js configuration"] = 911,
    ["NueJS configuration file"] = 567,
    ["Nuitka.yaml"] = 1076,
    ["Nullstone config"] = 569,
    ["ONe's changelog entry"] = 587,
    ["ONe's service descriptor"] = 586,
    ["ORT Server repository environment configuration"] = 595,
    ["OSCAL Assessment Plan (AP)"] = 597,
    ["OSCAL Assessment Results (AR)"] = 598,
    ["OSCAL Catalog"] = 599,
    ["OSCAL Component Definition (CDef)"] = 600,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 601,
    ["OSCAL Profile"] = 602,
    ["OSCAL System Security Plan (SSP)"] = 603,
    ["OSS Review Toolkit configuration"] = 604,
    ["OSS Review Toolkit curation"] = 605,
    ["OSS Review Toolkit package configuration"] = 606,
    ["OSS Review Toolkit repository configuration"] = 607,
    ["OSS Review Toolkit resolutions"] = 608,
    ["October CMS columns"] = 573,
    ["October CMS fields"] = 574,
    ["Oh My Posh"] = 575,
    Okteto = 576,
    ["Ona Automations"] = 578,
    Opctl = 909,
    ["Open Data Contract Standard (ODCS)"] = 590,
    ["Open Data Product Standard (ODPS)"] = 591,
    ["Open Know-How"] = 1156,
    ["OpenRewrite Resource"] = 589,
    OpenStatus = 1167,
    ["OpenUtau character yaml"] = 583,
    ["OpenUtau ustx"] = 584,
    ["OpenWeather Current Weather API"] = 951,
    ["OpenWeather Road Risk API"] = 950,
    ["Ory Hydra configuration"] = 421,
    ["Ory Keto configuration"] = 481,
    ["Ory Kratos configuration"] = 596,
    ["Ory Oathkeeper configuration"] = 571,
    ["Outblocks App configuration"] = 593,
    ["Outblocks database table"] = 594,
    ["Outblocks project configuration"] = 592,
    PDM = 615,
    POPxf = 625,
    ["POPxf Correlations"] = 626,
    Packer = 612,
    Pantsbuild = 1030,
    ["Paper paper-plugin.yml"] = 613,
    ["Pipeline component"] = 963,
    ["Platform.sh application"] = 5,
    ["Platform.sh routes"] = 6,
    ["Platform.sh services"] = 7,
    ["Plex Prerolls"] = 623,
    ["PocketMine plugin.yml"] = 620,
    ["Postman collection"] = 629,
    ["Power Pages Configuration"] = 1168,
    ["Preset list for a WinUtil"] = 1113,
    ["ProActions AI-Kit Configuration"] = 639,
    ["ProActions AI-Kit Configuration for Menus"] = 641,
    ["ProActions AI-Kit Configuration for Sections"] = 643,
    ["ProActions AI-Kit Configuration for Services"] = 640,
    ["ProActions AI-Kit Configuration for Steps"] = 644,
    ["ProActions AI-Kit Configuration for Templates"] = 642,
    ["Problem object RFC9457"] = 1059,
    ["Problem package format"] = 645,
    ["Problem package generators"] = 646,
    ["Problem package submissions"] = 647,
    ["Problem package test group metadata"] = 648,
    Pterodactyl = 1009,
    ["Pull Request Labeler"] = 665,
    Pulumi = 673,
    ["PyGTA Config"] = 669,
    PyProject = 674,
    Pylock = 1159,
    Pyright = 675,
    ["Python script metadata"] = 1153,
    ["QType AI DSL"] = 678,
    Qgoda = 677,
    Qodana = 982,
    ["Qt Creator workspace file"] = 1091,
    ["Quali Torque Blueprint Spec 2"] = 1007,
    ["QueryFirst config file"] = 1026,
    ["RKE Cluster Configuration JSON"] = 960,
    ["RKE Cluster Configuration YAML"] = 959,
    RadioHound = 668,
    Railpack = 680,
    Railway = 679,
    ["Rancher Fleet"] = 670,
    ...
    Ray = 923,
    ["Read the Docs"] = 672,
    ["Red-DiscordBot Cog"] = 688,
    ["Red-DiscordBot Cog Repo"] = 689,
    ["Red-DiscordBot Trivia"] = 690,
    ["Releasaurus Config"] = 2,
    ["Render Blueprints"] = 958,
    RenderCV = 703,
    Renovate = 702,
    ["Replit config"] = 696,
    Restate = 1146,
    ["Revel Digital Gadget Definition File"] = 1170,
    RoadRunner = 705,
    ["Robust Station Image"] = 1176,
    Rockcraft = 706,
    ["Roo Coder Custom Modes"] = 707,
    Rubocop = 698,
    ["Rudder techniques"] = 1066,
    Ruff = 699,
    ["Rust Project"] = 700,
    ["Rust toolchain"] = 711,
    ["SDMX data message"] = 737,
    ["SDMX metadata message"] = 736,
    ["SDMX structure message"] = 735,
    ["SIL Kit Participant Configuration"] = 747,
    ["SIL Kit Registry Configuration"] = 748,
    ["SPDX 2.3"] = 785,
    SWADL = 801,
    ["Safebox Config"] = 1021,
    ["Sapphire CLI Config"] = 714,
    ["SauceCTL Configuration"] = 969,
    ["Schema Catalog"] = 729,
    ["Scoop manifest"] = 734,
    ["Semantic Data Fabric (SDF) file"] = 738,
    ["Semgrep Rule"] = 740,
    ["Serenity Code Generator (Sergen)"] = 741,
    ["Serverless Framework Configuration"] = 976,
    ["Serverless Workflow"] = 978,
    ["Settings for a Cinnamon spice"] = 1109,
    ["Settings.paf"] = 743,
    ["Shopware 6 Configuration"] = 979,
    ["Shopware CLI Extension Store Configuration"] = 980,
    ["Shopware CLI Project Store Configuration"] = 981,
    ["Sigma Detection Rule"] = 745,
    ["Sigrid scope configuration file"] = 746,
    ["SkyPilot Task JSON"] = 1067,
    ["Slack app manifest"] = 750,
    Snapcraft = 752,
    Solidarity = 755,
    ["Solution filters"] = 756,
    ["Source Maps v3"] = 757,
    Sourcery = 758,
    ["Spack bootstrap.yaml"] = 759,
    ["Spack cdash.yaml"] = 760,
    ["Spack ci.yaml"] = 761,
    ["Spack compilers.yaml"] = 762,
    ["Spack concretizer.yaml"] = 763,
    ["Spack config.yaml"] = 764,
    ["Spack definitions.yaml"] = 765,
    ["Spack develop.yaml"] = 766,
    ["Spack env_vars.yaml"] = 767,
    ["Spack environment"] = 773,
    ["Spack include.yaml"] = 768,
    ["Spack mirrors.yaml"] = 769,
    ["Spack modules.yaml"] = 770,
    ["Spack packages.yaml"] = 771,
    ["Spack repos.yaml"] = 772,
    ["Spack toolchains.yaml"] = 774,
    ["Spack upstreams.yaml"] = 775,
    ["Spack view.yaml"] = 776,
    ["Speakeasy Generation Config File"] = 780,
    ["Speakeasy Lint Configuration File"] = 777,
    ["Speakeasy Test Generation Configuration File"] = 778,
    ["Speakeasy Workflow File"] = 779,
    SpecIF = 781,
    ["Specmatic Configuration"] = 782,
    ["Sponge Mixin configuration"] = 783,
    StackBlitz = 789,
    ["StackHawk Scanner Configuration"] = 975,
    Stale = 790,
    Starfish = 791,
    ["Starlake Data Pipeline"] = 948,
    Starship = 792,
    ["Statamic Blueprint"] = 793,
    ["Stella configuration file"] = 794,
    ["Streamlit configuration file"] = 795,
    ["Stryker Mutator"] = 798,
    ["StyleCop Analyzers Configuration"] = 799,
    ["Stylelint (.stylelintrc)"] = 800,
    ["Stylua Config"] = 1160,
    ["Sublime Syntax"] = 1022,
    ["Subsquid squid manifest"] = 1069,
    ["Swagger API 2.0"] = 802,
    ["Synadia Connect Component"] = 803,
    TSON = 838,
    TSTyche = 839,
    ["TYPO3 Vendor Bundler config"] = 844,
    ["Tab data for a LinUtil"] = 1116,
    ["Tab list for a LinUtil"] = 1115,
    Tach = 804,
    ["Tach Domain"] = 805,
    Talhelper = 807,
    ["Talisman configuration"] = 808,
    Taplo = 1161,
    ["Taskfile config"] = 953,
    Taurus = 809,
    Tauticord = 810,
    ["Tekton Pipeline"] = 1189,
    ["Tekton PipelineRun"] = 1190,
    ["Tekton Task"] = 1187,
    ["Tekton TaskRun"] = 1188,
    Telefonistka = 1147,
    ["Terrateam config"] = 1173,
    ["TestEnvironment.json"] = 821,
    ["TextMate Grammar"] = 820,
    Threagile = 816,
    ["Tier.run pricing.json"] = 813,
    Tikibase = 814,
    Tombi = 819,
    ["Traefik v2"] = 824,
    ["Traefik v2 File Provider"] = 825,
    ["Traefik v3"] = 826,
    ["Traefik v3 File Provider"] = 827,
    ["Travis CI (.travis.yml)"] = 823,
    Treefmt = 399,
    Trident = 1143,
    ["TrueScript for *.tscript files"] = 830,
    ["Tugboat QA config.yml"] = 1140,
    TunnelHub = 1057,
    Turborepo = 822,
    Tycho = 1105,
    Tye = 983,
    ["Tyk Gateway - Open Source v5.7+"] = 1152,
    ["UET BuildConfig.json"] = 1027,
    ["UI5 Manifest"] = 850,
    ["UNCORS configuration"] = 854,
    ["UTAM Page Object"] = 853,
    ["Ubuntu Server Autoinstall"] = 848,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1144,
    ["Uniswap Token List"] = 935,
    ["Universal Schedule Format"] = 855,
    ["Unreal Engine Uplugin"] = 1028,
    ["Unreal Engine Uproject"] = 1029,
    ["UpCloud CLI (upctl) configuration"] = 1145,
    ["Updatecli Compose"] = 991,
    ["Updatecli Policy Manifest"] = 992,
    ["Updatecli Policy Metadata"] = 993,
    Uplift = 1025,
    ["Upsun config"] = 4,
    ["User Journey Map"] = 957,
    V2Ray = 997,
    ["VSCode Code Snippets"] = 232,
    ["VSIX CLI publishing"] = 873,
    Vector = 857,
    ["Vela Pipeline Configuration"] = 860,
    Vercel = 231,
    ["Version Bumper config"] = 863,
    Vespertide = 1194,
    ["Vespertide Migration"] = 1195,
    ["Vespertide Model"] = 1196,
    ["Viash Component Config"] = 1149,
    ["Viash Package Config"] = 1150,
    Visivo = 1055,
    ["WP-CLI"] = 883,
    Wake = 1142,
    ["Waku Config"] = 1119,
    ["Web App Manifest"] = 879,
    ["Web types"] = 882,
    WebExtensions = 878,
    ["Webman package recipe"] = 1003,
    ["Windows Package Manager Installer Manifest"] = 931,
    ["Windows Package Manager Locale Manifest"] = 932,
    ["Windows Package Manager Singleton Manifest"] = 930,
    Winutil = 933,
    ["WireMock CLI import configuration"] = 1125,
    ["WireMock CLI local service configuration"] = 1124,
    ["WireMock message stub mapping"] = 1123,
    ["WireMock stub mapping"] = 1122,
    ["Woodpecker pipeline config"] = 971,
    ["Wrangler CLI"] = 884,
    ["Xstate Machine"] = 989,
    ["Yandex Workflow Language"] = 1111,
    ["Yarn Config (.yarnrc.yml)"] = 946,
    ["Yippee-Ki-JSON configuration YML"] = 937,
    ["YouTrack App"] = 1108,
    ["Zarf Package Configuration"] = 1175,
    ["Zerops.io config"] = 1096,
    ["Zerops.io import"] = 1097,
    ["Zola Configuration"] = 1186,
    ["aerleon.yml"] = 15,
    ["angular.json"] = 31,
    apko = 1060,
    ...
    ["babelrc.json"] = 111,
    ["bamboo-spec"] = 114,
    ["bashly-strings.yml"] = 1037,
    ["batect.yml"] = 113,
    ["beef-database-codegen"] = 115,
    ["beef-database-v5-codegen"] = 117,
    ["beef-entity-codegen"] = 116,
    ["beef-entity-v5-codegen"] = 118,
    ["behat.yml"] = 130,
    ["bigquery-table"] = 119,
    ["bioimageio resource description"] = 1077,
    ["bitbucket-pipelines"] = 121,
    bitrise = 122,
    ["bitrise-step"] = 123,
    ["block.json"] = 145,
    ["bottom configuration"] = 77,
    ["bower.json"] = 125,
    ["bozr.suite.json"] = 132,
    bpkg = 1038,
    ["browser.i18n.json"] = 133,
    ["browsh configuration"] = 134,
    bucklescript = 135,
    ["buf.gen.yaml"] = 79,
    ["buf.plugin.yaml"] = 80,
    ["buf.work.yaml"] = 81,
    ...
    ["build-changelog"] = 136,
    ["bun.lock"] = 141,
    ["bundleconfig.json"] = 142,
    ["bunfig.toml"] = 143,
    ["cargo-mutants-config.yaml"] = 82,
    ["ccmod.json"] = 1120,
    changelogging = 1088,
    ["chisel-slices.json"] = 258,
    ["chrome-extension-locales-messages.json"] = 239,
    ["chutzpah.json"] = 240,
    cibuildwheel = 165,
    ["clang-format (.clang-format)"] = 995,
    ["clang-tidy"] = 219,
    clangd = 218,
    clib = 220,
    ["cloud-init: cloud-config userdata"] = 222,
    ["cloud-sdk-pipeline-configuration"] = 242,
    ["cloudbuild.json"] = 243,
    cloudify = 221,
    ["cmdx.yaml"] = 85,
    codemagic = 223,
    ["coffeelint.json"] = 260,
    ["commands.json"] = 235,
    ["commitlint (.commitlintrc)"] = 934,
    ["committed.toml"] = 261,
    ["compile_commands.json"] = 234,
    ["compilerconfig.json"] = 233,
    ["completely.yml"] = 1033,
    ["component-detection-manifest.json"] = 264,
    ["component.json"] = 263,
    ["composer.json"] = 262,
    ["conda-forge"] = 168,
    ["config.yaml"] = 671,
    ["contentmanifest.json"] = 241,
    ["contribute.json"] = 265,
    ["cosmos.config.json"] = 237,
    ["crowdin.yml"] = 266,
    ["ctfd-setup configuration file"] = 1132,
    ["custom-elements.json"] = 1047,
    ["cypress.json"] = 270,
    ["datalogic-scan2deploy-android"] = 280,
    ["datalogic-scan2deploy-ce"] = 281,
    ["dbt Dependencies"] = 184,
    ["dbt Packages"] = 186,
    ["dbt Project"] = 185,
    ["dbt Selectors"] = 187,
    ["dbt YAML files"] = 188,
    ["ddev-global"] = 282,
    ["ddev-project"] = 283,
    ["debugsettings.json"] = 284,
    ["dependabot-v2.json"] = 287,
    ["dependabot.json"] = 286,
    ["deployed-cli"] = 988,
    ["devcontainer.json"] = 225,
    devinit = 939,
    ["devspace.yaml"] = 1011,
    djlint = 940,
    ["docker bake"] = 292,
    ["docker sequencer"] = 293,
    ["docker-compose.yml"] = 938,
    ["dockerd.json"] = 291,
    ["dotnet Release Index manifest"] = 304,
    ["dotnet-tools.json"] = 305,
    ["dotnetcli.host.json"] = 306,
    ["dprint.json"] = 307,
    ["drone.json"] = 308,
    ["dss-2.0.0.json"] = 310,
    ["dstack configuration"] = 311,
    ["dtool dataset metadata"] = 1127,
    ["dvc.yaml"] = 312,
    ["ecosystem.json"] = 317,
    eksctl = 318,
    ["electron-builder configuration file"] = 324,
    ["epr-manifest.json"] = 323,
    ["evcc.yaml"] = 325,
    ["ezd task runner"] = 335,
    ["fabric.mod.json"] = 337,
    ["first-timers-bot"] = 344,
    ["flagd flag configuration"] = 106,
    ["fly.io Configuration"] = 107,
    fulibWorkflows = 970,
    ["function.json"] = 356,
    ["gRPC API Gateway & OpenAPI Config"] = 10,
    ["gematik health care insurance list"] = 1138,
    ["gematik health care patient list"] = 1135,
    ["gematik health care provider institution list"] = 1137,
    ["gematik health care provider list"] = 1136,
    ["gematik tiger test environment configuration"] = 1139,
    ["git-town.toml"] = 1184,
    ["gitlab-ci"] = 374,
    ["global.json"] = 390,
    ["go-feature-flag Flag Configuration"] = 393,
    ["haxelib.json"] = 411,
    helmfile = 926,
    helmwave = 927,
    ["host-meta.json"] = 418,
    ...
    ["ide.host.json"] = 426,
    ["ifstate.yaml"] = 427,
    ["imageoptimizer.json"] = 428,
    ["importmap.json"] = 431,
    instant_python_config = 433,
    instant_python_custom_project = 434,
    ["ioBroker Configuration"] = 435,
    ["ioBroker JSON UI"] = 436,
    ["ioBroker Package manifest"] = 437,
    ["ixpect.conf.yaml"] = 438,
    ["ize.toml"] = 1024,
    ["jsconfig.json"] = 463,
    ["jscpd Configuration"] = 1008,
    jsdoc = 922,
    ["k3d.yaml"] = 464,
    ["k9s aliases.yaml"] = 466,
    ["k9s cluster-config.yaml"] = 468,
    ["k9s config.yaml"] = 467,
    ["k9s hotkeys.yaml"] = 469,
    ["k9s plugins.yaml"] = 470,
    ["k9s skin.yaml"] = 471,
    ["k9s views.yaml"] = 472,
    ["kontinuous-config.yaml"] = 483,
    ["kontinuous-values.yaml"] = 482,
    ["kustomization.yaml"] = 485,
    ["label-commenter-config.yml"] = 486,
    ["latexindent configuration"] = 100,
    ["launchsettings.json"] = 487,
    lazydocker = 1046,
    lazygit = 1045,
    ["lego.json"] = 489,
    ["lerna.json"] = 490,
    ["lgtm.yml"] = 491,
    ["liblab.config.json"] = 492,
    ["libman.json"] = 493,
    ["license-report-config.json"] = 494,
    ["linkinator.config.json"] = 496,
    ["lint-staged (.lintstagedrc)"] = 900,
    ["local.settings.json"] = 501,
    ["localazy.json"] = 502,
    ["lotus.yaml"] = 500,
    ["lsdlschema.json"] = 503,
    ["macro.json"] = 1012,
    ["markdown-link-check"] = 966,
    maturin = 967,
    mboats = 974,
    ["micro-settings.json"] = 1039,
    ["mimetypes.json"] = 517,
    ["mirrord config"] = 902,
    mise = 903,
    ["mkdocs.yml"] = 537,
    ["monospace.yml"] = 540,
    ["moon.yml"] = 1121,
    ["mprocs Configuration file"] = 1092,
    ["mrdocs.yml"] = 538,
    ["mta.yaml"] = 904,
    ["mtad.yaml"] = 905,
    ["mycode.json"] = 547,
    nFPM = 554,
    ["napari plugin manifest"] = 548,
    neoload = 917,
    ["nest-cli"] = 557,
    ["ninjs (News in JSON)"] = 556,
    ["nitro.json"] = 916,
    ["nixd configuration"] = 1065,
    ["nlu.json"] = 558,
    ["nodemon.json"] = 560,
    ["noodl config"] = 973,
    ["notebook.mod.json"] = 561,
    now = 912,
    ["npm-badges"] = 564,
    ["nswag.json"] = 568,
    ntangle = 570,
    ["nuclei-template.yaml"] = 565,
    ["nuget-project.json"] = 566,
    ["ocelot.json"] = 572,
    ["omnisharp.json"] = 577,
    openHAB = 1197,
    ["openapi.json"] = 579,
    ...
    ["overlay.json"] = 580,
    ["package.json"] = 609,
    ["package.manifest"] = 611,
    ["package.yaml"] = 610,
    ["partial-black.json"] = 131,
    ["pathfinder.yml"] = 614,
    ["pattern.json"] = 617,
    ["petstore-v1.0"] = 1019,
    pgap_yaml_input_reader = 616,
    ["pixi.toml"] = 618,
    ["plagiarize-me.yaml"] = 622,
    ["plagiarize.yaml"] = 621,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1128,
    ["podbard.yaml"] = 624,
    ["portman.json"] = 627,
    ["prefect.toml"] = 635,
    ["prefect.yaml"] = 636,
    ["prettierrc.json"] = 637,
    ["prisma.yml"] = 638,
    ["project-1.0.0-beta3.json"] = 650,
    ["project-1.0.0-beta4.json"] = 651,
    ["project-1.0.0-beta5.json"] = 652,
    ["project-1.0.0-beta6.json"] = 653,
    ["project-1.0.0-beta8.json"] = 654,
    ["project-1.0.0-rc1.json"] = 655,
    ["project-1.0.0-rc2.json"] = 656,
    ["project.json"] = 649,
    ["project.owasp.yaml"] = 657,
    ["prometheus-alertmanager.json"] = 661,
    ["prometheus.json"] = 658,
    ["prometheus.rules.json"] = 659,
    ["prometheus.rules.test.json"] = 660,
    ["proxies.json"] = 662,
    ["publiccode.yml"] = 663,
    ["pubspec.yaml"] = 664,
    ["pyrseas-0.8.json"] = 667,
    pytest = 676,
    ["quilt.mod.json"] = 1040,
    ["rc3 auth"] = 682,
    ["rc3 collection"] = 683,
    ...
    ["release drafter"] = 918,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 692,
    ["release-please-manifest.json"] = 693,
    ["release-plz.toml"] = 694,
    ["renv.lock"] = 704,
    ["rivet.json"] = 1064,
    ["rivet.yaml (legacy)"] = 1063,
    rumdl = 709,
    runny = 708,
    rustfmt = 710,
    sake = 1155,
    samt = 712,
    samtrc = 713,
    ["sarif-1.0.0.json"] = 715,
    ["sarif-2.0.0.json"] = 716,
    ["sarif-2.1.0"] = 726,
    ["sarif-2.1.0-rtm.2"] = 717,
    ["sarif-2.1.0-rtm.3"] = 719,
    ["sarif-2.1.0-rtm.4"] = 721,
    ["sarif-2.1.0-rtm.5"] = 723,
    ["sarif-2.1.0-rtm.6"] = 724,
    ["sarif-external-property-file-2.1.0"] = 727,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 718,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 720,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 722,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 725,
    ["scalingo.json configuration"] = 728,
    ["schema.org - Action"] = 730,
    ["schema.org - ContactPoint"] = 731,
    ["schema.org - Place"] = 732,
    ["schema.org - Thing"] = 733,
    ["secrethub.yml"] = 1042,
    ["semantic-release"] = 739,
    ["servicehub.config.json"] = 895,
    ["servicehub.service.json"] = 894,
    ["settings.job"] = 742,
    ["sfdx-hardis configuration"] = 744,
    ["shard.yml"] = 1080,
    ["size-limit configuration"] = 749,
    ["skaffold.yaml"] = 964,
    ["skyuxconfig.json"] = 751,
    ["snowflake-config"] = 753,
    ["snowflake-connections"] = 754,
    ["spicepod.yaml"] = 1100,
    ["sqlc configuration"] = 786,
    ["stripe-app-local.json"] = 797,
    ["stripe-app.json"] = 796,
    swcrc = 949,
    ["task.json"] = 806,
    taskcat = 913,
    ["template.json"] = 811,
    ["templatsources.json"] = 812,
    ["theme.json"] = 815,
    ["tizen_workspace.json"] = 817,
    tldr = 818,
    ["tm_devices configuration file"] = 1166,
    tmuxinator = 898,
    ["transcend.yml"] = 828,
    ["tree-sitter grammar.json"] = 398,
    ["trime.yaml"] = 829,
    ["trunk.yaml"] = 831,
    ["ts-force-config.json"] = 836,
    ["tsconfig.json"] = 832,
    ["tsd.json"] = 833,
    ["tsdoc.json"] = 834,
    ["tsdrc.json"] = 835,
    ...
    v8r = 877,
    vcluster = 1086,
    ["vcpkg configuration file"] = 230,
    ["vcpkg manifest file"] = 229,
    ["vega-lite.json"] = 859,
    ["vega.json"] = 858,
    ["venvironment.yaml"] = 861,
    ["venvplus.yaml"] = 862,
    version = 1148,
    ["version.json"] = 864,
    ["vhwdebugger-binding.yaml"] = 866,
    ["vim-addon-info"] = 867,
    ["vs-2017.3.host.json"] = 869,
    ["vs-nesting.json"] = 870,
    ["vsls.json"] = 868,
    ["vss-extension.json"] = 874,
    vtcfg = 1154,
    ["vtesttree.yaml"] = 875,
    ["vtestunit.yaml"] = 876,
    ["warp-keysets.json"] = 1048,
    ["warp-themes.json"] = 1049,
    ["warp-workflows.json"] = 1050,
    ["webhint.io"] = 1004,
    ["webjobpublishsettings.json"] = 881,
    ["webjobs-list.json"] = 880,
    ["well-known-fursona"] = 1087,
    ["xs-app.json"] = 908,
    ["xunit.runner.json"] = 893,
    yamllint = 936,
    zizmor = 1191,
    zuul = 919,
    ["Žinoma"] = 929
