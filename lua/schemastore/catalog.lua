...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 144,
    [".cryproj (generic)"] = 488,
    [".cryproj engine-5.2"] = 483,
    [".cryproj engine-5.3"] = 484,
    [".cryproj engine-5.4"] = 485,
    [".cryproj engine-5.5"] = 486,
    [".cryproj engine-dev"] = 487,
    [".csscomb.json"] = 146,
    [".csslintrc"] = 147,
    [".eslintrc"] = 192,
    [".esmrc.json"] = 184,
    ...
    [".mtaext"] = 497,
    [".nodehawkrc"] = 308,
    [".npmpackagejsonlintrc"] = 310,
    [".phraseapp.yml"] = 344,
    [".pmbot.yml"] = 336,
    [".postcssrc"] = 341,
    [".pre-commit-config.yml"] = 342,
    [".pre-commit-hooks.yml"] = 343,
    [".putout.json"] = 361,
    [".rehyperc"] = 368,
    [".remarkrc"] = 369,
    [".sprite files"] = 411,
    ...
    [".vsext"] = 463,
    [".yarnrc.yml"] = 529,
    ["<div>RIOTS' studio configuration"] = 467,
    ["@factorial/drupal-breakpoints-css"] = 4,
    ["API Builder"] = 526,
    ["AVA Configuration Schema"] = 581,
    ["AWS CDK cdk.json"] = 132,
    ["AWS CloudFormation"] = 133,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 134,
    ["Airlock Microgateway"] = 8,
    ["Airplane task"] = 9,
    ["Alacritty Configuration Schema"] = 556,
    ...
    ["Azure Pipelines"] = 44,
    ["Azure Static Web Apps CLI configuration file"] = 413,
    ["Azure Static Web Apps configuration file"] = 412,
    ["BX CI"] = 75,
    ["Better Code Hub"] = 531,
    ["Better Scripts"] = 76,
    BizTalkServerApplicationSchema = 503,
    ...
    ["Butane Config"] = 568,
    ["CICS TS region tagging"] = 575,
    ["CICS TS resource import"] = 576,
    ["CICS TS resource model"] = 577,
    ["CICS TS resource overrides"] = 578,
    ["CMake Presets"] = 77,
    ...
    ["Citation File Format"] = 135,
    CityJSON = 84,
    ["Code Climate"] = 108,
    Codux = 115,
    ["Commandbox Box.json"] = 87,
    ["Commandbox Server.json"] = 88,
    ["Common Catalog Schema"] = 124,
    ["Common types for all schemas"] = 1,
    Conjure = 85,
    ["Container Structure Test"] = 514,
    Containerlab = 538,
    ["DWP Exchange - catalogue entry"] = 181,
    ["DWP Exchange - gateway"] = 179,
    ["DWP Exchange - meta"] = 180,
    ["Dart build configuration"] = 148,
    ["Dart test config"] = 149,
    ["DashLord configuration"] = 150,
    ["Datadog Service Definition"] = 265,
    ["Datahub Ingestion Recipe Schema"] = 582,
    ...
    Devfile = 178,
    ["Discord Webhook"] = 159,
    ["Dolittle Artifacts"] = 163,
    ["Dolittle Bounded Context Configuration"] = 164,
    ["Dolittle Event Horizons Configuration"] = 165,
    ["Dolittle Resources Configuration"] = 166,
    ["Dolittle Server Configuration"] = 167,
    ["Dolittle Tenant Map Configuration"] = 169,
    ["Dolittle Tenants Configuration"] = 168,
    ["Dolittle Topology"] = 170,
    ...
    ["Drush site aliases"] = 174,
    ["Embrace Config Schema"] = 593,
    ["Error pages"] = 187,
    Esquio = 185,
    ["Estuary Flow Catalog Schema"] = 572,
    ["Expo SDK"] = 190,
    ["F-Droid Data metadata"] = 195,
    ["Facets - FSDL - Application"] = 193,
    ["Fossa configuration file"] = 200,
    ["Fossa's fossa-deps file"] = 201,
    ["Foundry VTT - Manifest"] = 198,
    ["Foundry VTT - Template"] = 199,
    ["Foxx Manifest"] = 45,
    ["GatewayCore API Gateway"] = 204,
    ["GeoJSON.json latest"] = 570,
    GherKing = 574,
    ["GitHub Action"] = 208,
    ["GitHub Funding"] = 209,
    ["GitHub Issue Template configuration"] = 211,
    ["GitHub Workflow"] = 212,
    ["GitHub Workflow Template Properties"] = 213,
    ["GitHub issue forms"] = 210,
    GitVersion = 207,
    ["Gitpod Configuration"] = 215,
    ["Global Privacy Control"] = 205,
    ["Google Cloud Workflows"] = 131,
    Goreleaser = 218,
    ["Goreleaser Pro"] = 219,
    ["Gradle Build Cache Node"] = 528,
    ["Gradle Enterprise"] = 527,
    ["Grafana 5.x Dashboard"] = 220,
    ["GraphQL Code Generator"] = 223,
    ["GraphQL Config"] = 222,
    ["GraphQL Mesh"] = 221,
    ["Grunt JSHint task"] = 227,
    ["Grunt Watch task"] = 228,
    ["Grunt base task"] = 229,
    ["Grunt clean task"] = 225,
    ["Grunt copy task"] = 224,
    ["Grunt cssmin task"] = 226,
    HEMTT = 500,
    Hadolint = 512,
    ["Hardware Sentry Configuration"] = 586,
    Hayson = 231,
    ["Haystack Pipeline"] = 232,
    ["Hazelcast 5 Configuration"] = 233,
    ["Helm Chart.lock"] = 106,
    ["Helm Chart.yaml"] = 105,
    Hugo = 564,
    ["Istanbul Schema"] = 589,
    ["JDownloader2 crawler multi-rule schema"] = 249,
    ["JDownloader2 crawler single-rule schema"] = 248,
    ["JFrog File Spec"] = 250,
    ["JFrog Pipelines YML DSL"] = 595,
    ["JSON Document Transform"] = 258,
    ["JSON Feed"] = 259,
    ["JSON Resume"] = 373,
    ["JSON Schema Draft 2020-12"] = 479,
    ["JSON Schema Draft 4"] = 476,
    ["JSON Schema Draft 7"] = 477,
    ["JSON Schema Draft 8"] = 478,
    ["JSON schema for CodeShip Pro services configuration files"] = 117,
    ["JSON schema for CodeShip Pro steps configuration files"] = 118,
    ["JSON schema for Codecov configuration files"] = 116,
    ["JSON-API"] = 257,
    ["JSON-e templates"] = 536,
    ["JSON-stat 2.0"] = 473,
    JSONPatch = 261,
    Jasmine = 244,
    Jekyll = 245,
    ["Jenkins X Pipelines"] = 246,
    ["Jenkins X Requirements"] = 247,
    ["Jovo Language Models"] = 251,
    ["KSP-AVC"] = 474,
    ["KSP-CKAN"] = 475,
    ["Keycloak REST API"] = 601,
    ["Knative Functions - func.yaml"] = 202,
    ["KoDE/CI build.yaml"] = 591,
    ["Kong DBLess Schema"] = 592,
    KrakenD = 264,
    ["LinkML Metamodel"] = 276,
    Liquibase = 542,
    ["Liquibase Flow File"] = 543,
    Markdownlint = 546,
    ["MegaLinter configuration"] = 280,
    ["MegaLinter descriptor"] = 281,
    ["Meltano plugin discovery definition"] = 283,
    ["Meltano project definition"] = 282,
    ["Microsoft Band Web Tile"] = 284,
    ["Minecraft Data Pack Advancement"] = 286,
    ["Minecraft Data Pack Biome"] = 287,
    ["Minecraft Data Pack Configured Carver"] = 288,
    ["Minecraft Data Pack Dimension"] = 290,
    ["Minecraft Data Pack Dimension Type"] = 289,
    ["Minecraft Data Pack Item Modifier"] = 291,
    ["Minecraft Data Pack Loot Table"] = 292,
    ["Minecraft Data Pack Metadata"] = 293,
    ["Minecraft Data Pack Predicate"] = 294,
    ["Minecraft Data Pack Recipe"] = 295,
    ["Minecraft Data Pack Template Pool"] = 296,
    ["Minecraft Resourcepack Sounds"] = 297,
    ["MongoDB Atlas Search Index Definition Schema"] = 590,
    ["Monika Configuration Schema"] = 588,
    ["Motif config"] = 496,
    ["Netin Diagnostic System Template"] = 551,
    ["Netlify config schema"] = 302,
    ["Nightwatch.js"] = 303,
    ["OSS Review Toolkit configuration"] = 326,
    ["OSS Review Toolkit curation"] = 327,
    ["OSS Review Toolkit package configuration"] = 328,
    ["OSS Review Toolkit repository configuration"] = 329,
    ["OSS Review Toolkit resolutions"] = 330,
    Opctl = 499,
    ["OpenWeather Current Weather API"] = 535,
    ["OpenWeather Road Risk API"] = 534,
    ["Ory Hydra configuration"] = 237,
    ["Ory Keto configuration"] = 266,
    ["Ory Kratos configuration"] = 325,
    ["Ory Oathkeeper configuration"] = 316,
    ["Outblocks App configuration"] = 323,
    ["Outblocks database table"] = 324,
    ["Outblocks project configuration"] = 322,
    Packer = 333,
    ["Pipeline component"] = 544,
    ["PocketMine plugin.yml"] = 337,
    Pterodactyl = 585,
    ["Pull Request Labeler"] = 360,
    Pulumi = 364,
    PyProject = 365,
    Qodana = 561,
    ["Quali Torque Blueprint Spec 2"] = 583,
    ["QueryFirst config file"] = 604,
    ["RKE Cluster Configuration JSON Schema"] = 541,
    ["RKE Cluster Configuration YAML Schema"] = 540,
    Ray = 511,
    ["Read the Docs"] = 363,
    ["Red-DiscordBot Cog"] = 366,
    ["Red-DiscordBot Cog Repo"] = 367,
    Renovate = 374,
    ["Replit schema"] = 370,
    RoadRunner = 375,
    ["Rust Project"] = 372,
    ["Rust toolchain"] = 377,
    ["SIL Kit Participant Configuration"] = 402,
    SWADL = 422,
    ["Sapphire CLI Config"] = 378,
    ["SauceCTL Configuration"] = 548,
    ["Schema Catalog"] = 391,
    ["Scoop manifest"] = 396,
    ["Semgrep Rule"] = 398,
    ["Serverless Framework Configuration"] = 555,
    ["Serverless Workflow Schema"] = 557,
    ["Settings.paf"] = 400,
    ["Shopware 6 Configuration"] = 558,
    ["Shopware CLI Extension Store Configuration"] = 559,
    ["Shopware CLI Project Store Configuration"] = 560,
    Solidarity = 406,
    ["Solution filters"] = 407,
    ["Source Maps v3"] = 408,
    SpecIF = 409,
    ["Sponge Mixin configuration"] = 410,
    ["StackHawk Scanner Configuration"] = 554,
    Stale = 414,
    Starship = 415,
    ["Statamic Blueprint"] = 416,
    ["StrmPrivacy Data Connector"] = 599,
    ["StrmPrivacy Data Contract"] = 600,
    ["StrmPrivacy SimpleSchema"] = 597,
    ["StrmPrivacy Stream"] = 598,
    ["StrmPrivacy batch job configuration file"] = 596,
    ["Stryker Mutator"] = 419,
    ["StyleCop Analyzers Configuration"] = 420,
    ["Swagger API 2.0"] = 423,
    TSON = 443,
    ["Talisman configuration"] = 424,
    ["Taskfile YAML Schema"] = 537,
    Taurus = 425,
    ["TestEnvironment.json"] = 432,
    Tikibase = 428,
    ["Traefik v2"] = 435,
    ["Traefik v2 File Provider"] = 436,
    Turborepo = 433,
    Tye = 562,
    ["UI5 Manifest"] = 449,
    ["UTAM Page Object"] = 451,
    ["Ubuntu Server Autoinstall"] = 447,
    ["Uniswap Token List"] = 520,
    ["Unreal Engine Uplugin"] = 605,
    ["Unreal Engine Uproject"] = 606,
    Updatecli = 569,
    Uplift = 603,
    ["User Journey Map YAML Schema"] = 539,
    V2Ray = 573,
    ["VSCode Code Snippets"] = 120,
    ["VSIX CLI publishing"] = 464,
    ["Vela Pipeline Configuration"] = 454,
    Vercel = 119,
    ["Web App Manifest"] = 469,
    ["Web types"] = 472,
    WebExtensions = 468,
    ["Webman package recipe"] = 579,
    ["Windows Package Manager Installer Manifest"] = 517,
    ["Windows Package Manager Locale Manifest"] = 518,
    ["Windows Package Manager Singleton Manifest"] = 516,
    ["Woodpecker pipeline config"] = 550,
    ["Xstate Machine Schema"] = 567,
    ["Yippee-Ki-JSON configuration YML"] = 522,
    ["angular.json"] = 10,
    ...
    ["chutzpah.json"] = 127,
    clangd = 111,
    ["cloud-init: cloud-config userdata JSON schema"] = 113,
    ["cloud-sdk-pipeline-config-schema"] = 129,
    ["cloudbuild.json"] = 130,
    cloudify = 112,
    codemagic = 114,
    ["coffeelint.json"] = 136,
    comet = 532,
    ["commands.json"] = 123,
    ["compile_commands.json"] = 122,
    ["compilerconfig.json"] = 121,
    ["component-detection-manifest.json"] = 139,
    ["component.json"] = 138,
    ["composer.json"] = 137,
    ["config.json"] = 140,
    ["contentmanifest.json"] = 128,
    ["contribute.json"] = 141,
    ["cosmos.config.json"] = 125,
    ["crowdin.yml"] = 142,
    cspell = 145,
    ["cypress.json"] = 143,
    ["datalogic-scan2deploy-android"] = 151,
    ["datalogic-scan2deploy-ce"] = 152,
    ["debugsettings.json"] = 153,
    ["dependabot-v2.json"] = 156,
    ["dependabot.json"] = 155,
    ["deployed-cli"] = 566,
    ["detekt.yml"] = 158,
    devinit = 524,
    ...
    ["docker-seq schema"] = 161,
    ["dockerd.json"] = 160,
    ["dotnet Release Index manifest"] = 171,
    ["dotnetcli.host.json"] = 172,
    ["drone.json"] = 173,
    ["dss-2.0.0.json"] = 175,
    ["dstack Workflows"] = 176,
    ["dvc.yaml"] = 177,
    ["ecosystem.json"] = 182,
    eksctl = 183,
    ["electron-builder configuration file."] = 188,
    ["epr-manifest.json"] = 186,
    ["evcc.yaml"] = 189,
    ["ezd schema"] = 191,
    ["fabric.mod.json"] = 194,
    ["first-timers-bot"] = 197,
    ["fly.io Schema"] = 46,
    fulibWorkflows = 549,
    ["function.json"] = 203,
    ["geojson.json"] = 206,
    ["gitlab-ci"] = 214,
    ["global.json"] = 216,
    ["golangci-lint Configuration"] = 217,
    ["haxelib.json"] = 230,
    helmfile = 513,
    ["host-meta.json"] = 235,
    ["host.json"] = 234,
    ...
    huskyrc = 491,
    ["ide.host.json"] = 238,
    ["imageoptimizer.json"] = 239,
    ["importmap.json"] = 241,
    ["ioBroker JSON UI"] = 242,
    ["ioBroker Package manifest"] = 243,
    ["ize.toml"] = 602,
    ["jsconfig.json"] = 262,
    ["jscpd Configuration Schema"] = 584,
    jsdoc = 510,
    ["k3d.yaml"] = 263,
    ["kustomization.yaml"] = 267,
    ["label-commenter-config.yml"] = 268,
    ["launchsettings.json"] = 269,
    ["lego.json"] = 270,
    ["lerna.json"] = 271,
    ["lgtm.yml"] = 272,
    ["libman.json"] = 273,
    ["license-report-config.json"] = 274,
    ["linkinator.config.json"] = 275,
    ["local.settings.json"] = 277,
    ["localazy.json"] = 278,
    ["lsdlschema.json"] = 279,
    ["markdown-lint-check"] = 547,
    mboats = 553,
    ["mimetypes.json"] = 285,
    ["mirrord-schema"] = 493,
    ["mta.yaml"] = 494,
    ["mtad.yaml"] = 495,
    ["mycode.json"] = 300,
    ["napari plugin manifest"] = 301,
    neoload = 505,
    ["nest-cli"] = 306,
    ["ninjs (News in JSON) 1.3"] = 305,
    ["ninjs (News in JSON) 2.0"] = 304,
    ["nlu.json"] = 307,
    ["nodemon.json"] = 309,
    ["noodl.schema.json"] = 552,
    now = 501,
    ["npm-badges"] = 311,
    ["nswag.json"] = 314,
    ntangle = 315,
    ["nuclei-template.yaml"] = 312,
    ["nuget-project.json"] = 313,
    ["ocelot.json"] = 317,
    ["omnisharp.json"] = 318,
    ["openapi.json"] = 319,
    ["openfin.json"] = 321,
    ["openrpc.json"] = 320,
    ["package.json"] = 331,
    ["package.manifest"] = 332,
    ["pattern.json"] = 335,
    ["petstore-v1.0"] = 594,
    pgap_yaml_input_reader = 334,
    ["plagiarize-me.yaml"] = 339,
    ["plagiarize.yaml"] = 338,
    ["portman.json"] = 340,
    ["prettierrc.json"] = 345,
    ["prisma.yml"] = 346,
    ["project-1.0.0-beta3.json"] = 348,
    ["project-1.0.0-beta4.json"] = 349,
    ["project-1.0.0-beta5.json"] = 350,
    ["project-1.0.0-beta6.json"] = 351,
    ["project-1.0.0-beta8.json"] = 352,
    ["project-1.0.0-rc1.json"] = 353,
    ["project-1.0.0-rc2.json"] = 354,
    ["project.json"] = 347,
    ["prometheus.json"] = 355,
    ["prometheus.rules.json"] = 356,
    ["proxies.json"] = 357,
    ["publiccode.yml"] = 358,
    ["pubspec.yaml"] = 359,
    ["pyrseas-0.8.json"] = 362,
    ["release drafter"] = 506,
    rustfmt = 376,
    ["sarif-1.0.0.json"] = 379,
    ["sarif-2.0.0.json"] = 380,
    ["sarif-2.1.0"] = 389,
    ["sarif-2.1.0-rtm.2"] = 381,
    ["sarif-2.1.0-rtm.3"] = 383,
    ["sarif-2.1.0-rtm.4"] = 385,
    ["sarif-2.1.0-rtm.5"] = 387,
    ["sarif-external-property-file-2.1.0"] = 390,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 382,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 384,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 386,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 388,
    ["schema.org - Action"] = 392,
    ["schema.org - ContactPoint"] = 393,
    ["schema.org - Place"] = 394,
    ["schema.org - Thing"] = 395,
    ["semantic-release"] = 397,
    ["servicehub.config.json"] = 482,
    ["servicehub.service.json"] = 481,
    ["settings.job"] = 399,
    ["sfdx-hardis configuration"] = 401,
    ["size-limit configuration"] = 403,
    ["skaffold.yaml"] = 545,
    ["skyuxconfig.json"] = 404,
    snapcraft = 405,
    ["stripe-app-local.json"] = 418,
    ["stripe-app.json"] = 417,
    swcrc = 533,
    taskcat = 502,
    ["template.json"] = 426,
    ["templatsources.json"] = 427,
    ["theme.json"] = 429,
    ["tizen_workspace.json"] = 430,
    tmLanguage = 431,
    tmuxinator = 490,
    ["trunk.yaml schema"] = 437,
    ["ts-force-config.json"] = 441,
    ["tsconfig.json"] = 438,
    ["tsd.json"] = 439,
    ["tsdrc.json"] = 440,
    ["tslint.json"] = 442,
    ...
    ["vega-lite.json"] = 453,
    ["vega.json"] = 452,
    ["venvironment-basic.yaml"] = 456,
    ["venvironment.yaml"] = 455,
    ["version.json"] = 457,
    ["vim-addon-info"] = 458,
    ["vs-2017.3.host.json"] = 460,
    ["vs-nesting.json"] = 461,
    ["vsls.json"] = 459,
    ["vss-extension.json"] = 465,
    ["webhint.io"] = 580,
    ["webjobpublishsettings.json"] = 471,
    ["webjobs-list.json"] = 470,
    ["xs-app.json"] = 498,
    ["xunit.runner.json"] = 480,
    yamllint = 521,
    zuul = 507,
    ["Žinoma"] = 515
  },
