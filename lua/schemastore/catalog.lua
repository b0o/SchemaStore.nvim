...
M.json = {
  ...
  index = {
    ...
    [".pmbot.yml"] = 653,
    [".postcssrc"] = 662,
    [".powerpages-web-template-manifest"] = 664,
    [".pre-commit-config.yml"] = 665,
    [".pre-commit-hooks.yml"] = 666,
    [".putout.json"] = 701,
    [".rehyperc"] = 726,
    [".remarkrc"] = 730,
    [".sprite files"] = 824,
    ...
    AIConfig = 34,
    ["AMX Muse Program Descriptor"] = 1176,
    ["API Builder"] = 984,
    ["AVA Configuration"] = 1047,
    ...
    ["AWS Copilot Manifest"] = 1215,
    ["AWS SAM CLI Samconfig"] = 269,
    ["Adobe UXP Manifest"] = 1110,
    ["Aerleon Network & Service Definitions"] = 20,
    ["Aerleon Policy"] = 21,
    ["AgentCore CLI"] = 1255,
    Aider = 1205,
    Air = 23,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1226,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1225,
    ["Airlock Microgateway"] = 35,
    ["Alacritty Configuration"] = 1019,
    ["All Contributors configuration file"] = 1073,
    ...
    ["Application list for a WinUtil"] = 1155,
    ArchitectFX = 1160,
    ["Argo CD"] = 54,
    ["Argo Events"] = 55,
    ["Argo Workflows"] = 56,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1224,
    ["Azure IoT Operations connector metadata"] = 1221,
    ...
    ["Azure Pipelines"] = 113,
    ["Azure Static Web Apps CLI configuration file"] = 828,
    ["Azure Static Web Apps configuration file"] = 827,
    BMML = 1243,
    ["BOSH CPI Config"] = 139,
    ...
    ["Bacon config"] = 5,
    ["Barba-CV"] = 83,
    ["Bashly (bashly.yml)"] = 1077,
    ["Bashly Settings (bashly-settings.yml)"] = 1078,
    Bento = 1242,
    ["Better Code Hub"] = 989,
    ["Better Scripts"] = 161,
    Bigconfig = 132,
    ["Biome Formatter Config"] = 84,
    ["Bitmovin Encoding Template"] = 1169,
    BizTalkServerApplicationSchema = 956,
    Bleep = 162,
    ["Block Protocol Metadata"] = 159,
    ["Bluebricks blueprint config"] = 1248,
    ["Boyka Framework"] = 141,
    Briefcase = 962,
    ["Build Info"] = 150,
    Buildkite = 152,
    ...
    ["Butane Config"] = 1032,
    C4InterFlow = 1184,
    ["CDK Environment Manager, concrete environment configuration"] = 1208,
    ["CDK Environment Manager, concrete environments definition"] = 1207,
    ["CDK Environment Manager, environment definition"] = 1206,
    ["CGS Card Game Specification (cgs.json)"] = 1115,
    ["CICS TS region tagging"] = 1041,
    ["CICS TS resource import"] = 1042,
    ["CICS TS resource model"] = 1043,
    ["CICS TS resource overrides"] = 1044,
    ["CMake Presets"] = 163,
    ["CNC Codes"] = 185,
    ["CRS WAF test file"] = 1145,
    ["CRS WAF test platform overrides file"] = 1146,
    ...
    ["Chamaleon environment"] = 1173,
    ["Chamaleon properties"] = 1174,
    ["Chamaleon template"] = 1172,
    Changepacks = 1235,
    Changesets = 278,
    Changie = 172,
    Charmcraft = 173,
    ...
    ["Clawject config"] = 191,
    ["Cloud Foundry Application Manifest"] = 1127,
    ["Cloud Run Spec v1"] = 1150,
    ...
    Concord = 1144,
    ["Configu .cfgu files"] = 1132,
    ["Configu .configu file"] = 1133,
    Conjure = 184,
    ["Container Structure Test"] = 970,
    Containerlab = 998,
    ["Contextive Glossary"] = 1200,
    Convex = 183,
    ["Crowdsec collection config"] = 288,
    ["Crowdsec parser config"] = 289,
    ["Crowdsec scenario config"] = 290,
    ["CumulusCI Config"] = 190,
    ["Cursor Agent Environment"] = 1253,
    ["Custom Machinery Machine"] = 1116,
    ["Custom Machinery Recipe"] = 1117,
    ...
    ["DonateCaseBetterCasino menu"] = 1177,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1085,
    ["EAS config"] = 358,
    ["ECA - Editor Code Assistant"] = 341,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1074,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1220,
    ["EasyVCR .NET"] = 359,
    ["Eidolon Resource"] = 1161,
    ...
    ["Erda Pipeline"] = 1123,
    ["Erda Runtime"] = 1124,
    ["Espanso config.yml"] = 1246,
    ["Espanso match.yml"] = 1245,
    Esquio = 346,
    ["Estuary Flow Catalog"] = 1038,
    ["Ethereum ERC1155"] = 1257,
    ["Ethereum ERC721"] = 1256,
    ...
    ["Evolving Resolutive Process notation"] = 1222,
    ["Expo SDK"] = 357,
    ...
    ["GeoJSON.json latest"] = 1036,
    GherKing = 1040,
    ["GitHub Action"] = 392,
    ["GitHub Actions typing"] = 1157,
    ...
    ["Google Digital Assetlinks"] = 1201,
    Goreleaser = 420,
    ["Goreleaser Pro"] = 421,
    Goss = 422,
    ["Gradle Build Cache Node"] = 987,
    ["Gradle Enterprise"] = 986,
    ...
    Hadolint = 966,
    Hammerkit = 997,
    ["Hardware Sentry Configuration"] = 1052,
    ...
    ["JFrog File Spec"] = 473,
    ["JFrog Pipelines YML DSL"] = 1062,
    ["JMeter DSL cli config"] = 474,
    JReleaser = 477,
    ["JSON Document Transform"] = 485,
    ["JSON Feed"] = 486,
    ["JSON Resume"] = 738,
    ["JSON Schema Draft 2020-12"] = 934,
    ["JSON Schema Draft 4"] = 931,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1095,
    ["JSON Schema Draft 7"] = 932,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1096,
    ["JSON Schema Draft 8 (2019-09)"] = 933,
    ["JSON-API"] = 484,
    ["JSON-e templates"] = 994,
    ["JSON-stat 2.0"] = 927,
    JSONPatch = 488,
    ...
    ["Jujutsu (jj) VCS config"] = 1214,
    ["KIMMDY config file"] = 499,
    ["KODE/CI build.yaml"] = 1058,
    ["KSP-AVC"] = 928,
    ["KSP-CKAN"] = 929,
    ["KSP-NetKAN"] = 930,
    KSY = 1125,
    ...
    ["Metadata for a Cinnamon spice"] = 1153,
    ["Metatype Configuration"] = 541,
    ["MetricsHub Configuration"] = 542,
    ["MetricsHub Connector Configuration"] = 543,
    ["Micro Editor Syntax"] = 1086,
    ["Microsoft Band Web Tile"] = 544,
    ["Microsoft RulesEngine workflow rules"] = 1141,
    ["Microsoft RulesEngine workflow rules list"] = 1142,
    ["Minecraft Custom Main Menu Mod"] = 1104,
    ...
    ["MongoDB Atlas Search Index Definition"] = 1057,
    ["Monika Configuration"] = 1055,
    ["Monoweave Configuration"] = 571,
    ["Motif config"] = 948,
    MultiQC = 1194,
    ["NOX Framework (Service)"] = 592,
    ["Netin Diagnostic System Template"] = 1014,
    ["Netlify config"] = 579,
    ...
    ["OpenUtau ustx"] = 615,
    ["OpenWeather Current Weather API"] = 993,
    ["OpenWeather Road Risk API"] = 992,
    ...
    PDM = 648,
    POPxf = 659,
    ["POPxf Correlations"] = 660,
    Packer = 645,
    PactSpec = 646,
    Pantsbuild = 1072,
    ["Paper paper-plugin.yml"] = 647,
    ["Pipeline component"] = 1005,
    ["Platform.sh application"] = 7,
    ["Platform.sh routes"] = 8,
    ["Platform.sh services"] = 9,
    ["Plex Prerolls"] = 657,
    ["PocketMine plugin.yml"] = 654,
    ["Postman collection"] = 663,
    ["Power Pages Configuration"] = 1211,
    ["Preset list for a WinUtil"] = 1156,
    ["ProActions AI-Kit Configuration"] = 674,
    ["ProActions AI-Kit Configuration for Menus"] = 676,
    ["ProActions AI-Kit Configuration for Sections"] = 678,
    ["ProActions AI-Kit Configuration for Services"] = 675,
    ["ProActions AI-Kit Configuration for Steps"] = 679,
    ["ProActions AI-Kit Configuration for Templates"] = 677,
    ["Problem object RFC9457"] = 1101,
    ["Problem package format"] = 680,
    ["Problem package generators"] = 681,
    ["Problem package submissions"] = 682,
    ["Problem package test group metadata"] = 683,
    Pterodactyl = 1051,
    ["Pull Request Labeler"] = 700,
    Pulumi = 708,
    ["PyGTA Config"] = 704,
    PyProject = 709,
    Pylock = 1202,
    Pyright = 710,
    ["Python script metadata"] = 1196,
    ["QType AI DSL"] = 713,
    Qgoda = 712,
    Qodana = 1024,
    ["Qt Creator workspace file"] = 1134,
    ["Quali Torque Blueprint Spec 2"] = 1049,
    ["QueryFirst config file"] = 1068,
    ["Qwen Code Settings"] = 1258,
    ["RKE Cluster Configuration JSON"] = 1002,
    ["RKE Cluster Configuration YAML"] = 1001,
    RadioHound = 703,
    ["Raid Profile"] = 1259,
    ["Raid Repo Configuration"] = 1260,
    Railpack = 715,
    Railway = 714,
    ["Rancher Fleet"] = 705,
    ["Rattler-build"] = 716,
    Ray = 965,
    ["Read the Docs"] = 707,
    ["Red-DiscordBot Cog"] = 723,
    ["Red-DiscordBot Cog Repo"] = 724,
    ["Red-DiscordBot Trivia"] = 725,
    ["Releasaurus Config"] = 4,
    ReleaseKit = 3,
    ["Render Blueprints"] = 1000,
    RenderCV = 742,
    Renovate = 739,
    ["Renovate global configuration"] = 740,
    ["Renovate inherited configuration"] = 741,
    ["Replit config"] = 731,
    Restate = 1189,
    ["Revel Digital Gadget Definition File"] = 1213,
    RoadRunner = 744,
    ["Robust Station Image"] = 1219,
    Rockcraft = 745,
    ["Roo Coder Custom Modes"] = 746,
    Rubocop = 735,
    ["Rudder techniques"] = 1108,
    Ruff = 736,
    ["Rust Project"] = 737,
    ["Rust toolchain"] = 750,
    ["SDMX data message"] = 777,
    ["SDMX metadata message"] = 776,
    ["SDMX structure message"] = 775,
    ["SIL Kit Participant Configuration"] = 787,
    ["SIL Kit Registry Configuration"] = 788,
    ["SPDX 2.3"] = 825,
    SWADL = 841,
    ["Safebox Config"] = 1063,
    ["Sapphire CLI Config"] = 753,
    ["SauceCTL Configuration"] = 1011,
    Scarb = 773,
    ["Schema Catalog"] = 768,
    ["Scoop manifest"] = 774,
    ["Semantic Data Fabric (SDF) file"] = 778,
    ["Semgrep Rule"] = 780,
    ["Serenity Code Generator (Sergen)"] = 781,
    ["Serverless Framework Configuration"] = 1018,
    ["Serverless Workflow"] = 1020,
    ["Settings for a Cinnamon spice"] = 1152,
    ["Settings.paf"] = 783,
    ["Shopware 6 Configuration"] = 1021,
    ["Shopware CLI Extension Store Configuration"] = 1022,
    ["Shopware CLI Project Store Configuration"] = 1023,
    ["Sigma Detection Rule"] = 785,
    ["Sigrid scope configuration file"] = 786,
    ["SkyPilot Task JSON"] = 1109,
    ["Slack app manifest"] = 790,
    Snapcraft = 792,
    Solidarity = 795,
    ["Solution filters"] = 796,
    ["Source Maps v3"] = 797,
    Sourcery = 798,
    ["Spack bootstrap.yaml"] = 799,
    ["Spack cdash.yaml"] = 800,
    ["Spack ci.yaml"] = 801,
    ["Spack compilers.yaml"] = 802,
    ["Spack concretizer.yaml"] = 803,
    ["Spack config.yaml"] = 804,
    ["Spack definitions.yaml"] = 805,
    ["Spack develop.yaml"] = 806,
    ["Spack env_vars.yaml"] = 807,
    ["Spack environment"] = 813,
    ["Spack include.yaml"] = 808,
    ["Spack mirrors.yaml"] = 809,
    ["Spack modules.yaml"] = 810,
    ["Spack packages.yaml"] = 811,
    ["Spack repos.yaml"] = 812,
    ["Spack toolchains.yaml"] = 814,
    ["Spack upstreams.yaml"] = 815,
    ["Spack view.yaml"] = 816,
    ["Speakeasy Generation Config File"] = 820,
    ["Speakeasy Lint Configuration File"] = 817,
    ["Speakeasy Test Generation Configuration File"] = 818,
    ["Speakeasy Workflow File"] = 819,
    SpecIF = 821,
    ["Specmatic Configuration"] = 822,
    ["Sponge Mixin configuration"] = 823,
    StackBlitz = 829,
    ["StackHawk Scanner Configuration"] = 1017,
    Stale = 830,
    Starfish = 831,
    ["Starlake Data Pipeline"] = 990,
    Starship = 832,
    ["Statamic Blueprint"] = 833,
    ["Stella configuration file"] = 834,
    ["Streamlit configuration file"] = 835,
    ["Stryker Mutator"] = 838,
    ["StyleCop Analyzers Configuration"] = 839,
    ["Stylelint (.stylelintrc)"] = 840,
    ["Stylua Config"] = 1203,
    ["Sublime Syntax"] = 1064,
    ["Subsquid squid manifest"] = 1111,
    ["Swagger API 2.0"] = 842,
    ["Synadia Connect Component"] = 843,
    TSON = 879,
    TSTyche = 880,
    ["TYPO3 Vendor Bundler config"] = 886,
    ["Tab data for a LinUtil"] = 1159,
    ["Tab list for a LinUtil"] = 1158,
    Tach = 844,
    ["Tach Domain"] = 845,
    Talhelper = 847,
    ["Talisman configuration"] = 848,
    Taplo = 1204,
    ["Taskfile config"] = 995,
    Taurus = 849,
    Tauticord = 850,
    ["Tekton Pipeline"] = 1232,
    ["Tekton PipelineRun"] = 1233,
    ["Tekton Task"] = 1230,
    ["Tekton TaskRun"] = 1231,
    Telefonistka = 1190,
    ["Terrateam config"] = 1216,
    ["TestEnvironment.json"] = 862,
    ["TextMate Grammar"] = 861,
    Threagile = 856,
    ["Tier.run pricing.json"] = 853,
    Tikibase = 854,
    Tombi = 859,
    ["Traefik v2"] = 865,
    ["Traefik v2 File Provider"] = 866,
    ["Traefik v3"] = 867,
    ["Traefik v3 File Provider"] = 868,
    ["Travis CI (.travis.yml)"] = 864,
    Treefmt = 425,
    Trident = 1186,
    ["TrueScript for *.tscript files"] = 871,
    ["Tugboat QA config.yml"] = 1183,
    TunnelHub = 1099,
    Turborepo = 863,
    Tycho = 1148,
    Tye = 1025,
    ["Tyk Gateway - Open Source v5.7+"] = 1195,
    ["UET BuildConfig.json"] = 1069,
    ["UI5 Manifest"] = 892,
    ["UNCORS configuration"] = 896,
    ["UTAM Page Object"] = 895,
    ["Ubuntu Server Autoinstall"] = 890,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1187,
    ["Uniswap Token List"] = 977,
    ["Universal Schedule Format"] = 897,
    ["Unreal Engine Uplugin"] = 1070,
    ["Unreal Engine Uproject"] = 1071,
    ["UpCloud CLI (upctl) configuration"] = 1188,
    ["Updatecli Compose"] = 1033,
    ["Updatecli Policy Manifest"] = 1034,
    ["Updatecli Policy Metadata"] = 1035,
    Uplift = 1067,
    ["Upsun config"] = 6,
    ["User Journey Map"] = 999,
    V2Ray = 1039,
    ["VSCode Code Snippets"] = 253,
    ["VSIX CLI publishing"] = 915,
    Vector = 899,
    ["Vela Pipeline Configuration"] = 902,
    Vercel = 252,
    ["Version Bumper config"] = 905,
    Vespertide = 1237,
    ["Vespertide Migration"] = 1238,
    ["Vespertide Model"] = 1239,
    ["Viash Component Config"] = 1192,
    ["Viash Package Config"] = 1193,
    Visivo = 1097,
    ["WP-CLI"] = 925,
    Wake = 1185,
    ["Waku Config"] = 1162,
    ["Web App Manifest"] = 921,
    ["Web types"] = 924,
    WebExtensions = 920,
    ["Webman package recipe"] = 1045,
    ["Windows Package Manager Installer Manifest"] = 973,
    ["Windows Package Manager Locale Manifest"] = 974,
    ["Windows Package Manager Singleton Manifest"] = 972,
    Winutil = 975,
    ["WireMock CLI import configuration"] = 1168,
    ["WireMock CLI local service configuration"] = 1167,
    ["WireMock message stub mapping"] = 1166,
    ["WireMock stub mapping"] = 1165,
    ["Woodpecker pipeline config"] = 1013,
    ["Wrangler CLI"] = 926,
    ["Xstate Machine"] = 1031,
    ["Yandex Workflow Language"] = 1154,
    ["Yarn Config (.yarnrc.yml)"] = 988,
    ["Yippee-Ki-JSON configuration YML"] = 979,
    ["YouTrack App"] = 1151,
    ["Zarf Package Configuration"] = 1218,
    ["Zerops.io config"] = 1139,
    ["Zerops.io import"] = 1140,
    ["Zola Configuration"] = 1229,
    ["aerleon.yml"] = 19,
    ["amplify.yml"] = 12,
    ["angular.json"] = 36,
    apko = 1102,
    ...
    ["behat.yml"] = 142,
    ["bigquery-table"] = 131,
    ["bioimageio resource description"] = 1119,
    ...
    ["chutzpah.json"] = 261,
    cibuildwheel = 178,
    ["clang-format (.clang-format)"] = 1037,
    ["clang-tidy"] = 239,
    clangd = 238,
    clib = 240,
    ...
    ["crowdin.yml"] = 287,
    ["ctfd-setup configuration file"] = 1175,
    ["custom-elements.json"] = 1089,
    ["cypress.json"] = 291,
    ...
    ["gematik health care insurance list"] = 1181,
    ["gematik health care patient list"] = 1178,
    ["gematik health care provider institution list"] = 1180,
    ["gematik health care provider list"] = 1179,
    ["gematik tiger test environment configuration"] = 1182,
    ["git-town.toml"] = 1227,
    ["gitlab-ci"] = 400,
    ["global.json"] = 416,
    ...
    ["lint-staged (.lintstagedrc)"] = 942,
    ["local.settings.json"] = 528,
    ["localazy.json"] = 529,
    ["lotus.yaml"] = 527,
    ["lsdlschema.json"] = 530,
    ["macro.json"] = 1054,
    ["markdown-link-check"] = 1008,
    maturin = 1009,
    mboats = 1016,
    ["micro-settings.json"] = 1081,
    ["mimetypes.json"] = 545,
    ["mirrord config"] = 944,
    mise = 945,
    ["mkdocs.yml"] = 565,
    ...
    ["monospace.yml"] = 570,
    ["moon.yml"] = 1164,
    ["mprocs Configuration file"] = 1135,
    ["mrdocs.yml"] = 567,
    ["mta.yaml"] = 946,
    ["mtad.yaml"] = 947,
    ["mycode.json"] = 577,
    ...
    ["plagiarize.yaml"] = 655,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1171,
    ["podbard.yaml"] = 658,
    ["portman.json"] = 661,
    ["prefect.toml"] = 669,
    ["prefect.yaml"] = 670,
    ...
    ["prettierrc.json"] = 672,
    ["prisma.yml"] = 673,
    ["project-1.0.0-beta3.json"] = 685,
    ["project-1.0.0-beta4.json"] = 686,
    ["project-1.0.0-beta5.json"] = 687,
    ["project-1.0.0-beta6.json"] = 688,
    ["project-1.0.0-beta8.json"] = 689,
    ["project-1.0.0-rc1.json"] = 690,
    ["project-1.0.0-rc2.json"] = 691,
    ["project.json"] = 684,
    ["project.owasp.yaml"] = 692,
    ["prometheus-alertmanager.json"] = 696,
    ["prometheus.json"] = 693,
    ["prometheus.rules.json"] = 694,
    ["prometheus.rules.test.json"] = 695,
    ["proxies.json"] = 697,
    ["publiccode.yml"] = 698,
    ["pubspec.yaml"] = 699,
    ["pyrseas-0.8.json"] = 702,
    pytest = 711,
    ["quilt.mod.json"] = 1082,
    ["rc3 auth"] = 717,
    ["rc3 collection"] = 718,
    ...
    ["release drafter"] = 960,
    ["release-hub.json"] = 2,
    ["release-please-config.json"] = 727,
    ["release-please-manifest.json"] = 728,
    ["release-plz.toml"] = 729,
    ["renv.lock"] = 743,
    ["reposets Configuration"] = 732,
    ["reposets Credentials"] = 733,
    ["rivet.json"] = 1106,
    ["rivet.yaml (legacy)"] = 1105,
    rumdl = 748,
    runny = 747,
    rustfmt = 749,
    sake = 1198,
    samt = 751,
    samtrc = 752,
    ["sarif-1.0.0.json"] = 754,
    ["sarif-2.0.0.json"] = 755,
    ["sarif-2.1.0"] = 765,
    ["sarif-2.1.0-rtm.2"] = 756,
    ["sarif-2.1.0-rtm.3"] = 758,
    ["sarif-2.1.0-rtm.4"] = 760,
    ["sarif-2.1.0-rtm.5"] = 762,
    ["sarif-2.1.0-rtm.6"] = 763,
    ["sarif-external-property-file-2.1.0"] = 766,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 757,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 759,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 761,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 764,
    ["scalingo.json configuration"] = 767,
    ["schema.org - Action"] = 769,
    ["schema.org - ContactPoint"] = 770,
    ["schema.org - Place"] = 771,
    ["schema.org - Thing"] = 772,
    ["secrethub.yml"] = 1084,
    ["semantic-release"] = 779,
    ["servicehub.config.json"] = 937,
    ["servicehub.service.json"] = 936,
    ["settings.job"] = 782,
    ["sfdx-hardis configuration"] = 784,
    ["shard.yml"] = 1122,
    ["size-limit configuration"] = 789,
    ["skaffold.yaml"] = 1006,
    ["skyuxconfig.json"] = 791,
    ["snowflake-config"] = 793,
    ["snowflake-connections"] = 794,
    ["spicepod.yaml"] = 1143,
    ["sqlc configuration"] = 826,
    ["stripe-app-local.json"] = 837,
    ["stripe-app.json"] = 836,
    swcrc = 991,
    ["task.json"] = 846,
    taskcat = 955,
    ["template.json"] = 851,
    ["templatsources.json"] = 852,
    ["text2confl config"] = 1252,
    ["theme.json"] = 855,
    ["tizen_workspace.json"] = 857,
    tldr = 858,
    ["tm_devices configuration file"] = 1209,
    tmuxinator = 940,
    tox = 860,
    ["transcend.yml"] = 869,
    ...
    ["vega-lite.json"] = 901,
    ["vega.json"] = 900,
    ["venvironment.yaml"] = 903,
    ["venvplus.yaml"] = 904,
    version = 1191,
    ["version.json"] = 906,
    ["vhwdebugger-binding.yaml"] = 908,
    ["vim-addon-info"] = 909,
    ["vs-2017.3.host.json"] = 911,
    ["vs-nesting.json"] = 912,
    ["vsls.json"] = 910,
    ["vss-extension.json"] = 916,
    vtcfg = 1197,
    ["vtesttree.yaml"] = 917,
    ["vtestunit.yaml"] = 918,
    ["warp-keysets.json"] = 1090,
    ["warp-themes.json"] = 1091,
    ["warp-workflows.json"] = 1092,
    ["webhint.io"] = 1046,
    ["webjobpublishsettings.json"] = 923,
    ["webjobs-list.json"] = 922,
    ["well-known-fursona"] = 1130,
    ["xs-app.json"] = 950,
    ["xunit.runner.json"] = 935,
    yamllint = 978,
    zizmor = 1234,
    zuul = 961,
    ["Žinoma"] = 971
