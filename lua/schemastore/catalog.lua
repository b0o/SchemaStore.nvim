...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 987,
    [".nodehawkrc"] = 620,
    [".npmpackagejsonlintrc"] = 624,
    [".omletrc"] = 1166,
    [".phrase.yml"] = 701,
    [".phraseapp.yml"] = 702,
    [".pmbot.yml"] = 686,
    [".postcssrc"] = 695,
    [".powerpages-web-template-manifest"] = 697,
    [".pre-commit-config.yml"] = 698,
    [".pre-commit-hooks.yml"] = 699,
    [".putout.json"] = 735,
    [".rehyperc"] = 760,
    [".remarkrc"] = 764,
    [".sprite files"] = 860,
    ...
    AIConfig = 36,
    ["AMX Muse Program Descriptor"] = 1214,
    ["API Builder"] = 1022,
    ["AVA Configuration"] = 1085,
    ...
    ["AWS Copilot Manifest"] = 1253,
    ["AWS SAM CLI Samconfig"] = 274,
    Acton = 1303,
    ["Adobe UXP Manifest"] = 1148,
    ["Aerleon Network & Service Definitions"] = 22,
    ["Aerleon Policy"] = 23,
    ["Agent Permission Policy"] = 1293,
    ["AgentCore CLI"] = 1294,
    Aider = 1243,
    Air = 25,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1264,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1263,
    ["Airlock Microgateway"] = 37,
    ["Alacritty Configuration"] = 1057,
    ["AlgoVoi Compliance Receipt v1"] = 12,
    ["All Contributors configuration file"] = 1111,
    Anodizer = 448,
    ...
    ["Application list for a WinUtil"] = 1193,
    ArchitectFX = 1198,
    ["Argo CD"] = 56,
    ["Argo Events"] = 57,
    ["Argo Workflows"] = 58,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1262,
    ["Azure IoT Operations connector metadata"] = 1259,
    ...
    ["Azure Pipelines"] = 116,
    ["Azure Static Web Apps CLI configuration file"] = 864,
    ["Azure Static Web Apps configuration file"] = 863,
    BMML = 1281,
    ["BOSH CPI Config"] = 142,
    ...
    ["Bacon config"] = 6,
    ["Barba-CV"] = 85,
    ["Bashly (bashly.yml)"] = 1115,
    ["Bashly Settings (bashly-settings.yml)"] = 1116,
    Bento = 1280,
    ["Better Code Hub"] = 1027,
    ["Better Scripts"] = 165,
    Bigconfig = 135,
    ["Biome Formatter Config"] = 86,
    ["Bitmovin Encoding Template"] = 1207,
    BizTalkServerApplicationSchema = 994,
    Bleep = 166,
    ["Block Protocol Metadata"] = 163,
    ["Bluebricks blueprint config"] = 1286,
    ["Boyka Framework"] = 144,
    ...
    ["Butane Config"] = 1070,
    C4InterFlow = 1222,
    ["CDK Environment Manager, concrete environment configuration"] = 1246,
    ["CDK Environment Manager, concrete environments definition"] = 1245,
    ["CDK Environment Manager, environment definition"] = 1244,
    ["CGS Card Game Specification (cgs.json)"] = 1153,
    ["CICS TS region tagging"] = 1079,
    ["CICS TS resource import"] = 1080,
    ["CICS TS resource model"] = 1081,
    ["CICS TS resource overrides"] = 1082,
    ["CMake Presets"] = 167,
    ["CNC Codes"] = 189,
    ["CRS WAF test file"] = 1183,
    ["CRS WAF test platform overrides file"] = 1184,
    ...
    ["Caido Proxy Configuration"] = 1317,
    ...
    ["Chamaleon environment"] = 1211,
    ["Chamaleon properties"] = 1212,
    ["Chamaleon template"] = 1210,
    Changepacks = 1273,
    Changesets = 283,
    Changie = 176,
    Charmcraft = 177,
    ...
    ["Clawject config"] = 195,
    ["Cloud Foundry Application Manifest"] = 1165,
    ["Cloud Run Spec v1"] = 1188,
    ...
    Concord = 1182,
    ["Configu .cfgu files"] = 1170,
    ["Configu .configu file"] = 1171,
    Conjure = 188,
    ["Container Structure Test"] = 1008,
    Containerlab = 1036,
    ["Contextive Glossary"] = 1238,
    Convex = 187,
    ["Crowdsec collection config"] = 293,
    ["Crowdsec parser config"] = 294,
    ["Crowdsec scenario config"] = 295,
    ["CumulusCI Config"] = 194,
    ["Cursor Agent Environment"] = 1291,
    ["Custom Machinery Machine"] = 1154,
    ["Custom Machinery Recipe"] = 1155,
    ...
    ["DataYoga Job"] = 205,
    ["Datadog Continuous Testing"] = 532,
    ["Datadog Service Definition"] = 533,
    ["Datadog Software Catalog"] = 534,
    ["Datahub Ingestion Recipe"] = 1086,
    ["Debian Upstream Metadata file"] = 212,
    ["Deck config"] = 213,
    ["Declarative Automation Bundles"] = 1132,
    ["DeepMatch deeplinks spec"] = 214,
    ["Dein Config"] = 215,
    ["Deno Config (deno.json)"] = 311,
    ["Dependency cruiser"] = 216,
    ["DeployStack Configuration"] = 217,
    ["Deployah Configuration"] = 1261,
    ["Deployer Recipe"] = 314,
    ["Deta Spacefile"] = 218,
    ...
    ["DonateCaseBetterCasino menu"] = 1215,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1123,
    ["EAS config"] = 382,
    ["ECA - Editor Code Assistant"] = 346,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1112,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1258,
    ["EasyVCR .NET"] = 384,
    ["Eidolon Resource"] = 1199,
    ...
    ["Envelope Team Definition"] = 1302,
    ["Envilder Map File"] = 350,
    ["Erda Pipeline"] = 1161,
    ["Erda Runtime"] = 1162,
    ["Espanso config.yml"] = 1284,
    ["Espanso match.yml"] = 1283,
    Esquio = 370,
    ["Estuary Flow Catalog"] = 1076,
    ["Ethereum ERC1155"] = 1296,
    ["Ethereum ERC721"] = 1295,
    ...
    ["Evolving Resolutive Process notation"] = 1260,
    ["Expo SDK"] = 381,
    ...
    ["GeoJSON.json latest"] = 1074,
    GherKing = 1078,
    ["GitHub Action"] = 417,
    ["GitHub Actions typing"] = 1195,
    ...
    ["Google Digital Assetlinks"] = 1239,
    Goreleaser = 446,
    ["Goreleaser Pro"] = 447,
    Goss = 449,
    ["Gradle Build Cache Node"] = 1025,
    ["Gradle Enterprise"] = 1024,
    ...
    Hadolint = 1004,
    Hammerkit = 1035,
    ["Hardware Sentry Configuration"] = 1090,
    ...
    ["IVMS101 by CODE Protocol"] = 1151,
    Infrahub = 485,
    Istanbul = 1094,
    ["JDownloader2 crawler multi-rules"] = 499,
    ["JDownloader2 crawler single-rules"] = 498,
    ["JFrog Applications Config"] = 500,
    ["JFrog File Spec"] = 501,
    ["JFrog Pipelines YML DSL"] = 1100,
    ["JMeter DSL cli config"] = 502,
    JReleaser = 505,
    ["JSON Document Transform"] = 513,
    ["JSON Feed"] = 514,
    ["JSON Resume"] = 772,
    ["JSON Schema Draft 2020-12"] = 972,
    ["JSON Schema Draft 4"] = 969,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1133,
    ["JSON Schema Draft 7"] = 970,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1134,
    ["JSON Schema Draft 8 (2019-09)"] = 971,
    ["JSON-API"] = 512,
    ["JSON-e templates"] = 1032,
    ["JSON-stat 2.0"] = 965,
    JSONPatch = 516,
    ["JSR Package Config (jsr.json)"] = 506,
    Jarl = 1266,
    Jasmine = 493,
    Jekyll = 494,
    ["Jenkins X Pipelines"] = 495,
    ["Jenkins X Requirements"] = 496,
    Jest = 497,
    Jocker = 503,
    ["Jovo Language Models"] = 504,
    ["Jujutsu (jj) VCS config"] = 1252,
    ["KIMMDY config file"] = 527,
    ["KODE/CI build.yaml"] = 1096,
    ["KSP-AVC"] = 966,
    ["KSP-CKAN"] = 967,
    ["KSP-NetKAN"] = 968,
    KSY = 1163,
    ...
    Kas = 519,
    ["Kestra flow file"] = 528,
    ["Keycloak REST API"] = 1103,
    ["Knative Functions - func.yaml"] = 404,
    Knip = 405,
    ["Knowledge Unit"] = 536,
    ["Kometa (nightly) config file"] = 530,
    ["Kometa config file"] = 529,
    ["Kong DBLess config"] = 1097,
    KrakenD = 531,
    ["Kubri Configuration"] = 539,
    LOOBin = 554,
    ["Lake configuration file"] = 1255,
    ...
    ["Lando (landofile)"] = 112,
    ["LangGraph Platform configuration"] = 1175,
    ["Language configuration"] = 1174,
    Lefthook = 543,
    ["Liferay client-extension.yaml"] = 550,
    ["LinkML Metamodel"] = 552,
    Liquibase = 1041,
    ["Liquibase Flow File"] = 1042,
    ["Lively Properties"] = 553,
    ["Lobe AI Agent"] = 114,
    Loki = 115,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 596,
    ["MS2Rescore Configuration"] = 601,
    ["Madness (madness.yml)"] = 1114,
    ["Mado configuration"] = 560,
    ["Maestro Flow"] = 561,
    ["Mail Servers Configuration"] = 1287,
    ["MapEHR Mapping"] = 562,
    Markdownlint = 1045,
    ["Mason Registry"] = 1048,
    ["MegaLinter Custom Flavor"] = 565,
    ["MegaLinter configuration"] = 564,
    ["MegaLinter descriptor"] = 566,
    Melange = 1141,
    ["Meltano project definition"] = 567,
    ["Mergify Configuration"] = 602,
    ["Metadata for a Bazel module"] = 568,
    ["Metadata for a Cinnamon spice"] = 1191,
    ["Metatype Configuration"] = 569,
    ["MetricsHub Configuration"] = 570,
    ["MetricsHub Connector Configuration"] = 571,
    ["Micro Editor Syntax"] = 1124,
    ["Microsoft Band Web Tile"] = 572,
    ["Microsoft RulesEngine workflow rules"] = 1179,
    ["Microsoft RulesEngine workflow rules list"] = 1180,
    ["Minecraft Custom Main Menu Mod"] = 1142,
    ["Minecraft Data Pack Advancement"] = 574,
    ["Minecraft Data Pack Biome"] = 575,
    ["Minecraft Data Pack Configured Carver"] = 576,
    ["Minecraft Data Pack Damage Type"] = 577,
    ["Minecraft Data Pack Dimension"] = 579,
    ["Minecraft Data Pack Dimension Type"] = 578,
    ["Minecraft Data Pack Item Modifier"] = 580,
    ["Minecraft Data Pack Loot Table"] = 581,
    ["Minecraft Data Pack Metadata"] = 582,
    ["Minecraft Data Pack Predicate"] = 583,
    ["Minecraft Data Pack Recipe"] = 584,
    ["Minecraft Data Pack Tag"] = 585,
    ["Minecraft Data Pack Template Pool"] = 586,
    ["Minecraft Data Pack Trim Material"] = 591,
    ["Minecraft Data Pack Trim Pattern"] = 592,
    ["Minecraft Resource Pack Lang"] = 587,
    ["Minecraft Resource Pack Particle"] = 588,
    ["Minecraft Resource Pack Texture Mcmeta"] = 590,
    ["Minecraft Resourcepack Sounds"] = 589,
    ["MockServer Expectations"] = 598,
    ModuleAssembler = 594,
    ["Monade CLI Stack Configuration"] = 605,
    ["MongoDB Atlas Search Index Definition"] = 1095,
    ["Monika Configuration"] = 1093,
    ["Monoweave Configuration"] = 600,
    ["Motif config"] = 986,
    MultiQC = 1232,
    ["NOX Framework (Service)"] = 623,
    ["Netin Diagnostic System Template"] = 1052,
    ["Netlify config"] = 608,
    ["Network-as-Code Data Model"] = 609,
    ["Next Gen UI Agent A2A Server Configuration"] = 610,
    ["Next Gen UI Agent Configuration"] = 612,
    ["Next Gen UI Agent MCP Server Configuration"] = 611,
    ["Nightwatch.js"] = 616,
    ["Node.js configuration"] = 991,
    ["NueJS configuration file"] = 628,
    ["Nuitka Package Config"] = 1156,
    ["Nullstone config"] = 630,
    ["ONe's changelog entry"] = 649,
    ["ONe's service descriptor"] = 648,
    ["ORT Server repository environment configuration"] = 659,
    ["OSCAL Assessment Plan (AP)"] = 661,
    ["OSCAL Assessment Results (AR)"] = 662,
    ["OSCAL Catalog"] = 663,
    ["OSCAL Component Definition (CDef)"] = 664,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 665,
    ["OSCAL Profile"] = 666,
    ["OSCAL System Security Plan (SSP)"] = 667,
    ["OSS Review Toolkit configuration"] = 668,
    ["OSS Review Toolkit curation"] = 669,
    ["OSS Review Toolkit package configuration"] = 670,
    ["OSS Review Toolkit project package manager definition"] = 671,
    ["OSS Review Toolkit repository configuration"] = 672,
    ["OSS Review Toolkit resolutions"] = 673,
    ["October CMS columns"] = 634,
    ["October CMS fields"] = 635,
    ["Oh My Posh"] = 637,
    Okteto = 638,
    ["Ona Automations"] = 640,
    Opctl = 989,
    ["Open Data Contract Standard (ODCS)"] = 653,
    ["Open Data Product Standard (ODPS)"] = 654,
    ["Open Know-How"] = 1237,
    OpenDecree = 1300,
    ["OpenDecree Configuration"] = 1301,
    ["OpenRewrite Resource"] = 651,
    OpenSRM = 655,
    OpenStatus = 1248,
    ["OpenTelemetry Declarative Configuration"] = 652,
    ["OpenUtau character yaml"] = 645,
    ["OpenUtau ustx"] = 646,
    ["OpenWeather Current Weather API"] = 1031,
    ["OpenWeather Road Risk API"] = 1030,
    ["Ory Hydra configuration"] = 474,
    ["Ory Keto configuration"] = 535,
    ["Ory Kratos configuration"] = 660,
    ["Ory Oathkeeper configuration"] = 632,
    ["Outblocks App configuration"] = 657,
    ["Outblocks database table"] = 658,
    ["Outblocks project configuration"] = 656,
    PDM = 680,
    POPxf = 692,
    ["POPxf Correlations"] = 693,
    ["PRML manifest"] = 700,
    Packer = 677,
    PactSpec = 678,
    Pantsbuild = 1110,
    ["Paper paper-plugin.yml"] = 679,
    ["Pipeline component"] = 1043,
    ["Platform.sh application"] = 8,
    ["Platform.sh routes"] = 9,
    ["Platform.sh services"] = 10,
    ["Plex Prerolls"] = 690,
    ["PocketMine plugin.yml"] = 687,
    ["Postman collection"] = 696,
    ["Power Pages Configuration"] = 1249,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1194,
    ["ProActions AI-Kit Configuration"] = 708,
    ["ProActions AI-Kit Configuration for Menus"] = 710,
    ["ProActions AI-Kit Configuration for Sections"] = 712,
    ["ProActions AI-Kit Configuration for Services"] = 709,
    ["ProActions AI-Kit Configuration for Steps"] = 713,
    ["ProActions AI-Kit Configuration for Templates"] = 711,
    ["Problem object RFC9457"] = 1139,
    ["Problem package format"] = 714,
    ["Problem package generators"] = 715,
    ["Problem package submissions"] = 716,
    ["Problem package test group metadata"] = 717,
    Pterodactyl = 1089,
    ["Pull Request Labeler"] = 734,
    Pulumi = 742,
    ["PyGTA Config"] = 738,
    PyProject = 743,
    Pylock = 1240,
    Pyright = 744,
    ["Python script metadata"] = 1234,
    ["QType AI DSL"] = 747,
    Qgoda = 746,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1311,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1309,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1315,
    ["Qlik Talend Cloud Pipeline - Project"] = 1307,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1310,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1312,
    ["Qlik Talend Cloud Pipeline - Task"] = 1308,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1314,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1313,
    Qodana = 1062,
    ["Qt Creator workspace file"] = 1172,
    ["Quali Torque Blueprint Spec 2"] = 1087,
    ["QueryFirst config file"] = 1106,
    ["QuikRun Configuration"] = 1316,
    ["Qwen Code Settings"] = 1297,
    ["RKE Cluster Configuration JSON"] = 1040,
    ["RKE Cluster Configuration YAML"] = 1039,
    RadioHound = 737,
    ["Raid Profile"] = 1298,
    ["Raid Repo Configuration"] = 1299,
    Railpack = 749,
    Railway = 748,
    ["Rancher Fleet"] = 739,
    ["Rattler-build"] = 750,
    Ray = 1003,
    ["Read the Docs"] = 741,
    ["Red-DiscordBot Cog"] = 757,
    ["Red-DiscordBot Cog Repo"] = 758,
    ["Red-DiscordBot Trivia"] = 759,
    ["Releasaurus Config"] = 5,
    ReleaseKit = 4,
    ["Render Blueprints"] = 1038,
    RenderCV = 776,
    Renovate = 773,
    ["Renovate global configuration"] = 774,
    ["Renovate inherited configuration"] = 775,
    ["Replit config"] = 765,
    Restate = 1227,
    ["Revel Digital Gadget Definition File"] = 1251,
    RoadRunner = 778,
    ["Robust Station Image"] = 1257,
    Rockcraft = 779,
    ["Roo Coder Custom Modes"] = 780,
    Rubocop = 769,
    ["Rudder techniques"] = 1146,
    Ruff = 770,
    ["Rust Project"] = 771,
    ["Rust toolchain"] = 785,
    ["SDMX data message"] = 812,
    ["SDMX metadata message"] = 811,
    ["SDMX structure message"] = 810,
    ["SIL Kit Participant Configuration"] = 822,
    ["SIL Kit Registry Configuration"] = 823,
    ["SPDX 2.3"] = 861,
    SWADL = 877,
    ["Safebox Config"] = 1101,
    ["Sapphire CLI Config"] = 788,
    ["SauceCTL Configuration"] = 1049,
    Scarb = 808,
    ["Schema Catalog"] = 803,
    ["Scoop manifest"] = 809,
    ["Semantic Data Fabric (SDF) file"] = 813,
    ["Semgrep Rule"] = 815,
    ["Serenity Code Generator (Sergen)"] = 816,
    ["Serverless Framework Configuration"] = 1056,
    ["Serverless Workflow"] = 1058,
    ["Settings for a Cinnamon spice"] = 1190,
    ["Settings.paf"] = 818,
    ["Shopware 6 Configuration"] = 1059,
    ["Shopware CLI Extension Store Configuration"] = 1060,
    ["Shopware CLI Project Store Configuration"] = 1061,
    ["Sigma Detection Rule"] = 820,
    ["Sigrid scope configuration file"] = 821,
    ["SkyPilot Task JSON"] = 1147,
    ["Slack app manifest"] = 825,
    Snapcraft = 827,
    ["Solarxy project config"] = 830,
    Solidarity = 831,
    ["Solution filters"] = 832,
    ["Source Maps v3"] = 833,
    Sourcery = 834,
    ["Spack bootstrap.yaml"] = 835,
    ["Spack cdash.yaml"] = 836,
    ["Spack ci.yaml"] = 837,
    ["Spack compilers.yaml"] = 838,
    ["Spack concretizer.yaml"] = 839,
    ["Spack config.yaml"] = 840,
    ["Spack definitions.yaml"] = 841,
    ["Spack develop.yaml"] = 842,
    ["Spack env_vars.yaml"] = 843,
    ["Spack environment"] = 849,
    ["Spack include.yaml"] = 844,
    ["Spack mirrors.yaml"] = 845,
    ["Spack modules.yaml"] = 846,
    ["Spack packages.yaml"] = 847,
    ["Spack repos.yaml"] = 848,
    ["Spack toolchains.yaml"] = 850,
    ["Spack upstreams.yaml"] = 851,
    ["Spack view.yaml"] = 852,
    ["Speakeasy Generation Config File"] = 856,
    ["Speakeasy Lint Configuration File"] = 853,
    ["Speakeasy Test Generation Configuration File"] = 854,
    ["Speakeasy Workflow File"] = 855,
    SpecIF = 857,
    ["Specmatic Configuration"] = 858,
    ["Sponge Mixin configuration"] = 859,
    StackBlitz = 865,
    ["StackHawk Scanner Configuration"] = 1055,
    Stale = 866,
    Starfish = 867,
    ["Starlake Data Pipeline"] = 1028,
    Starship = 868,
    ["Statamic Blueprint"] = 869,
    ["Stella configuration file"] = 870,
    ["Streamlit configuration file"] = 871,
    ["Stryker Mutator"] = 874,
    ["StyleCop Analyzers Configuration"] = 875,
    ["Stylelint (.stylelintrc)"] = 876,
    ["Stylua Config"] = 1241,
    ["Sublime Syntax"] = 1102,
    ["Subsquid squid manifest"] = 1149,
    ["Swagger API 2.0"] = 878,
    ["Synadia Connect Component"] = 879,
    TSON = 915,
    TSTyche = 916,
    ["TYPO3 Vendor Bundler config"] = 922,
    ["Tab data for a LinUtil"] = 1197,
    ["Tab list for a LinUtil"] = 1196,
    Tach = 880,
    ["Tach Domain"] = 881,
    Talhelper = 883,
    ["Talisman configuration"] = 884,
    Taplo = 1242,
    ["Taskfile config"] = 1033,
    Taurus = 885,
    Tauticord = 886,
    ["Tekton Pipeline"] = 1270,
    ["Tekton PipelineRun"] = 1271,
    ["Tekton Task"] = 1268,
    ["Tekton TaskRun"] = 1269,
    Telefonistka = 1228,
    ["Terrateam config"] = 1254,
    ["TestEnvironment.json"] = 898,
    ["TextMate Grammar"] = 897,
    Threagile = 892,
    ["Tier.run pricing.json"] = 889,
    Tikibase = 890,
    Tombi = 895,
    ["Traefik v2"] = 901,
    ["Traefik v2 File Provider"] = 902,
    ["Traefik v3"] = 903,
    ["Traefik v3 File Provider"] = 904,
    ["Travis CI (.travis.yml)"] = 900,
    Treefmt = 452,
    Trident = 1224,
    ["TrueScript for *.tscript files"] = 907,
    ["Tugboat QA config.yml"] = 1221,
    TunnelHub = 1137,
    Turborepo = 899,
    Tycho = 1186,
    Tye = 1063,
    ["Tyk Gateway - Open Source v5.7+"] = 1233,
    ["UET BuildConfig.json"] = 1107,
    ["UI5 Manifest"] = 928,
    ["UNCORS configuration"] = 933,
    ["UTAM Page Object"] = 931,
    ["Ubuntu Server Autoinstall"] = 926,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1225,
    ["Uniswap Token List"] = 1014,
    ["Universal Schedule Format"] = 934,
    ["Unreal Engine Uplugin"] = 1108,
    ["Unreal Engine Uproject"] = 1109,
    ["UpCloud CLI (upctl) configuration"] = 1226,
    ["Updatecli Compose"] = 1071,
    ["Updatecli Policy Manifest"] = 1072,
    ["Updatecli Policy Metadata"] = 1073,
    Uplift = 1105,
    ["Upsun config"] = 7,
    ["User Journey Map"] = 1037,
    V2Ray = 1077,
    ["VSCode Code Snippets"] = 258,
    ["VSIX CLI publishing"] = 952,
    Vector = 936,
    ["Vela Pipeline Configuration"] = 939,
    Vercel = 257,
    ["Version Bumper config"] = 942,
    Vespertide = 1275,
    ["Vespertide Migration"] = 1276,
    ["Vespertide Model"] = 1277,
    ["Viash Component Config"] = 1230,
    ["Viash Package Config"] = 1231,
    Visivo = 1135,
    ["WP-CLI"] = 962,
    Wake = 1223,
    ["Waku Config"] = 1200,
    ["Web App Manifest"] = 958,
    ["Web types"] = 961,
    WebExtensions = 957,
    ["Webman package recipe"] = 1083,
    ["Windows Package Manager Installer Manifest"] = 1011,
    ["Windows Package Manager Locale Manifest"] = 1012,
    ["Windows Package Manager Singleton Manifest"] = 1010,
    ["WireMock CLI import configuration"] = 1206,
    ["WireMock CLI local service configuration"] = 1205,
    ["WireMock message stub mapping"] = 1204,
    ["WireMock stub mapping"] = 1203,
    ["Woodpecker pipeline config"] = 1051,
    ["Wrangler CLI"] = 963,
    ["XenForo add-on manifest"] = 964,
    ["Xstate Machine"] = 1069,
    ["Yandex Workflow Language"] = 1192,
    ["Yarn Config (.yarnrc.yml)"] = 1026,
    ["Yippee-Ki-JSON configuration YML"] = 1017,
    ["YouTrack App"] = 1189,
    ["Zarf Package Configuration"] = 1256,
    ["Zerops import file"] = 1178,
    ["Zola Configuration"] = 1267,
    ["aerleon.yml"] = 21,
    ["amplify.yml"] = 14,
    ["amxx-builder manifest"] = 1318,
    ["angular.json"] = 38,
    apko = 1140,
    ...
    ["behat.yml"] = 145,
    ["bigquery-table"] = 134,
    ["bioimageio resource description"] = 1157,
    ...
    ["cargo-nextest repository configuration"] = 613,
    ["cargo-nextest user configuration"] = 614,
    ["ccmod.json"] = 1201,
    changelogging = 1169,
    ...
    ["chutzpah.json"] = 266,
    cibuildwheel = 182,
    ["clang-format (.clang-format)"] = 1075,
    ["clang-tidy"] = 243,
    clangd = 242,
    clib = 244,
    ...
    ["crowdin.yml"] = 292,
    ["ctfd-setup configuration file"] = 1213,
    ["custom-elements.json"] = 1127,
    ["cypress.json"] = 296,
    ["dacier.yml"] = 1306,
    ...
    ["gematik health care insurance list"] = 1219,
    ["gematik health care patient list"] = 1216,
    ["gematik health care provider institution list"] = 1218,
    ["gematik health care provider list"] = 1217,
    ["gematik tiger test environment configuration"] = 1220,
    ["git-town.toml"] = 1265,
    ["gitlab-ci"] = 426,
    ["global.json"] = 442,
    ...
    intlayer = 488,
    ["ioBroker Configuration"] = 489,
    ["ioBroker JSON UI"] = 490,
    ["ioBroker Package manifest"] = 491,
    ["ixpect.conf.yaml"] = 492,
    ["ize.toml"] = 1104,
    ["jsconfig.json"] = 517,
    ["jscpd Configuration"] = 1088,
    jsdoc = 1002,
    ["k3d.yaml"] = 518,
    ["k9s aliases.yaml"] = 520,
    ["k9s cluster-config.yaml"] = 522,
    ["k9s config.yaml"] = 521,
    ["k9s hotkeys.yaml"] = 523,
    ["k9s plugins.yaml"] = 524,
    ["k9s skin.yaml"] = 525,
    ["k9s views.yaml"] = 526,
    ["kontinuous-config.yaml"] = 538,
    ["kontinuous-values.yaml"] = 537,
    ["kustomization.yaml"] = 540,
    ["label-commenter-config.yml"] = 541,
    ["latexindent configuration"] = 113,
    ["launchsettings.json"] = 542,
    lazydocker = 1126,
    lazygit = 1125,
    ["lego.json"] = 544,
    ["lerna.json"] = 545,
    ["lgtm.yml"] = 546,
    ["liblab.config.json"] = 547,
    ["libman.json"] = 548,
    ["license-report-config.json"] = 549,
    ["linkinator.config.json"] = 551,
    ["lint-staged (.lintstagedrc)"] = 980,
    ["local.settings.json"] = 556,
    ["localazy.json"] = 557,
    ["lotus.yaml"] = 555,
    ["lsdlschema.json"] = 558,
    ["macro.json"] = 1092,
    ["markdown-link-check"] = 1046,
    maturin = 1047,
    mboats = 1054,
    memnex = 1304,
    ["micro-settings.json"] = 1119,
    ["mimetypes.json"] = 573,
    ["mirrord config"] = 982,
    mise = 983,
    ["mkdocs.yml"] = 593,
    ...
    ["monospace.yml"] = 599,
    ["moon.yml"] = 1202,
    ["mprocs Configuration file"] = 1173,
    ["mrdocs.yml"] = 595,
    ["mta.yaml"] = 984,
    ["mtad.yaml"] = 985,
    ["mycode.json"] = 606,
    nFPM = 615,
    ["napari plugin manifest"] = 607,
    neoload = 997,
    ["nest-cli"] = 618,
    ["nexus-rpc-gen"] = 1292,
    ["ninjs (News in JSON)"] = 617,
    ["nitro.json"] = 996,
    ["nixd configuration"] = 1145,
    ["nlu.json"] = 619,
    ["nodemon.json"] = 621,
    ["noodl config"] = 1053,
    ["notebook.mod.json"] = 622,
    now = 992,
    ["npm-badges"] = 625,
    ["nswag.json"] = 629,
    ntangle = 631,
    ["nuclei-template.yaml"] = 626,
    ["nuget-project.json"] = 627,
    ["ocelot.json"] = 633,
    ogen = 636,
    ["omnisharp.json"] = 639,
    openHAB = 1278,
    ...
    oxlint = 1289,
    ["package.json"] = 674,
    ["package.manifest"] = 676,
    ["package.yaml"] = 675,
    ["partial-black.json"] = 146,
    ["partial-fastapi.json"] = 147,
    ["partial-pixi.json"] = 685,
    ["partial-scheduled.json"] = 148,
    ["pattern.json"] = 683,
    ["petstore-v1.0"] = 1099,
    pgap_yaml_input_reader = 681,
    pgrls = 682,
    pgxgen = 1282,
    pitcms = 1285,
    ["pixi.toml"] = 684,
    ["plagiarize-me.yaml"] = 689,
    ["plagiarize.yaml"] = 688,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1209,
    ["podbard.yaml"] = 691,
    ["portman.json"] = 694,
    ["prefect.toml"] = 703,
    ["prefect.yaml"] = 704,
    ...
    ["prettierrc.json"] = 706,
    ["prisma.yml"] = 707,
    ["project-1.0.0-beta3.json"] = 719,
    ["project-1.0.0-beta4.json"] = 720,
    ["project-1.0.0-beta5.json"] = 721,
    ["project-1.0.0-beta6.json"] = 722,
    ["project-1.0.0-beta8.json"] = 723,
    ["project-1.0.0-rc1.json"] = 724,
    ["project-1.0.0-rc2.json"] = 725,
    ["project.json"] = 718,
    ["project.owasp.yaml"] = 726,
    ["prometheus-alertmanager.json"] = 730,
    ["prometheus.json"] = 727,
    ["prometheus.rules.json"] = 728,
    ["prometheus.rules.test.json"] = 729,
    ["proxies.json"] = 731,
    ["publiccode.yml"] = 732,
    ["pubspec.yaml"] = 733,
    ["pyrseas-0.8.json"] = 736,
    pytest = 745,
    ["quilt.mod.json"] = 1120,
    ["rc3 auth"] = 751,
    ["rc3 collection"] = 752,
    ...
    ["release drafter"] = 998,
    ["release-hub.json"] = 3,
    ["release-please-config.json"] = 761,
    ["release-please-manifest.json"] = 762,
    ["release-plz.toml"] = 763,
    ["renv.lock"] = 777,
    ["reposets Configuration"] = 766,
    ["reposets Credentials"] = 767,
    ["revola.json"] = 1,
    ["rivet.json"] = 1144,
    ["rivet.yaml (legacy)"] = 1143,
    rumdl = 782,
    runny = 781,
    runspec = 1305,
    rustfmt = 783,
    ...
    samt = 786,
    samtrc = 787,
    ["sarif-1.0.0.json"] = 789,
    ["sarif-2.0.0.json"] = 790,
    ["sarif-2.1.0"] = 800,
    ["sarif-2.1.0-rtm.2"] = 791,
    ["sarif-2.1.0-rtm.3"] = 793,
    ["sarif-2.1.0-rtm.4"] = 795,
    ["sarif-2.1.0-rtm.5"] = 797,
    ["sarif-2.1.0-rtm.6"] = 798,
    ["sarif-external-property-file-2.1.0"] = 801,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 792,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 794,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 796,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 799,
    ["scalingo.json configuration"] = 802,
    ["schema.org - Action"] = 804,
    ["schema.org - ContactPoint"] = 805,
    ["schema.org - Place"] = 806,
    ["schema.org - Thing"] = 807,
    ["secrethub.yml"] = 1122,
    ["semantic-release"] = 814,
    ["servicehub.config.json"] = 975,
    ["servicehub.service.json"] = 974,
    ["settings.job"] = 817,
    ["sfdx-hardis configuration"] = 819,
    ["shard.yml"] = 1160,
    ["size-limit configuration"] = 824,
    ["skaffold.yaml"] = 1044,
    ["skyuxconfig.json"] = 826,
    ["snowflake-config"] = 828,
    ["snowflake-connections"] = 829,
    ["spicepod.yaml"] = 1181,
    ["sqlc configuration"] = 862,
    ["stripe-app-local.json"] = 873,
    ["stripe-app.json"] = 872,
    swcrc = 1029,
    ["task.json"] = 882,
    taskcat = 993,
    ["template.json"] = 887,
    ["templatsources.json"] = 888,
    ["text2confl config"] = 1290,
    ["theme.json"] = 891,
    ["tizen_workspace.json"] = 893,
    tldr = 894,
    ["tm_devices configuration file"] = 1247,
    tmuxinator = 978,
    tox = 896,
    ["transcend.yml"] = 905,
    ...
    ["vega-lite.json"] = 938,
    ["vega.json"] = 937,
    ["venvironment.yaml"] = 940,
    ["venvplus.yaml"] = 941,
    version = 1229,
    ["version.json"] = 943,
    ["vhwdebugger-binding.yaml"] = 945,
    ["vim-addon-info"] = 946,
    ["vs-2017.3.host.json"] = 948,
    ["vs-nesting.json"] = 949,
    ["vsls.json"] = 947,
    ["vss-extension.json"] = 953,
    vtcfg = 1235,
    ["vtesttree.yaml"] = 954,
    ["vtestunit.yaml"] = 955,
    ["warp-keysets.json"] = 1128,
    ["warp-themes.json"] = 1129,
    ["warp-workflows.json"] = 1130,
    ["webhint.io"] = 1084,
    ["webjobpublishsettings.json"] = 960,
    ["webjobs-list.json"] = 959,
    ["well-known-fursona"] = 1168,
    ["xs-app.json"] = 988,
    ["xunit.runner.json"] = 973,
    yamlfmt = 1015,
    yamllint = 1016,
    ["zerops.yml"] = 1177,
    zizmor = 1272,
