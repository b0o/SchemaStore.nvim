...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 139,
    [".cryproj (generic)"] = 476,
    [".cryproj engine-5.2"] = 471,
    [".cryproj engine-5.3"] = 472,
    [".cryproj engine-5.4"] = 473,
    [".cryproj engine-5.5"] = 474,
    [".cryproj engine-dev"] = 475,
    [".csscomb.json"] = 141,
    [".csslintrc"] = 142,
    [".eslintrc"] = 183,
    [".esmrc.json"] = 175,
    ...
    [".mtaext"] = 484,
    [".nodehawkrc"] = 298,
    [".npmpackagejsonlintrc"] = 300,
    [".phraseapp.yml"] = 333,
    [".pmbot.yml"] = 325,
    [".postcssrc"] = 330,
    [".pre-commit-config.yml"] = 331,
    [".pre-commit-hooks.yml"] = 332,
    [".putout.json"] = 350,
    [".rehyperc"] = 356,
    [".remarkrc"] = 357,
    [".sprite files"] = 397,
    ...
    [".vsext"] = 451,
    [".yarnrc.yml"] = 516,
    ["<div>RIOTS' studio configuration"] = 455,
    ["@factorial/drupal-breakpoints-css"] = 3,
    ["API Builder"] = 513,
    ["AVA Configuration Schema"] = 567,
    ["AWS CDK cdk.json"] = 127,
    ["AWS CloudFormation"] = 128,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 129,
    ...
    ["Azure Pipelines"] = 43,
    ["Azure Static Web Apps CLI configuration file"] = 399,
    ["Azure Static Web Apps configuration file"] = 398,
    ["BX CI"] = 72,
    ["Better Code Hub"] = 518,
    ["Better Scripts"] = 73,
    BizTalkServerApplicationSchema = 490,
    ...
    ["Butane Config"] = 554,
    ["CICS TS region tagging"] = 561,
    ["CICS TS resource import"] = 562,
    ["CICS TS resource model"] = 563,
    ["CICS TS resource overrides"] = 564,
    ["CMake Presets"] = 74,
    ...
    Cheatsheets = 551,
    ["Chrome Extension"] = 121,
    ["CircleCI config.yml"] = 104,
    ["Citation File Format"] = 130,
    CityJSON = 81,
    ["Code Climate"] = 105,
    ["Commandbox Box.json"] = 84,
    ["Commandbox Server.json"] = 85,
    ["Common Catalog Schema"] = 119,
    ["Common types for all schemas"] = 1,
    Conjure = 82,
    ["Container Structure Test"] = 501,
    Containerlab = 525,
    ["Dart build configuration"] = 143,
    ["Dart test config"] = 144,
    ["DashLord configuration"] = 145,
    ["Datadog Service Definition"] = 256,
    ["Datahub Ingestion Recipe Schema"] = 568,
    ["Dein Config Schema"] = 88,
    Deno = 149,
    ["Deployer Recipe"] = 152,
    Devfile = 172,
    ["Discord Webhook"] = 154,
    ["Dolittle Artifacts"] = 158,
    ["Dolittle Bounded Context Configuration"] = 159,
    ["Dolittle Event Horizons Configuration"] = 160,
    ["Dolittle Resources Configuration"] = 161,
    ["Dolittle Server Configuration"] = 162,
    ["Dolittle Tenant Map Configuration"] = 164,
    ["Dolittle Tenants Configuration"] = 163,
    ["Dolittle Topology"] = 165,
    ["Drupal Breakpoints Schema"] = 89,
    ["Drupal Config Schema"] = 100,
    ["Drupal Info Schema"] = 90,
    ["Drupal Layouts Schema"] = 91,
    ["Drupal Libraries Schema"] = 92,
    ["Drupal Links Action Schema"] = 93,
    ["Drupal Links Contextual Schema"] = 94,
    ["Drupal Links Menu Schema"] = 95,
    ["Drupal Links Task Schema"] = 96,
    ["Drupal Migration Schema"] = 97,
    ["Drupal Permissions Schema"] = 98,
    ["Drupal Routing Schema"] = 99,
    ["Drupal Services Schema"] = 101,
    ["Drush site aliases"] = 169,
    ["Embrace Config Schema"] = 579,
    ["Error pages"] = 178,
    Esquio = 176,
    ["Estuary Flow Catalog Schema"] = 558,
    ["Expo SDK"] = 181,
    ["F-Droid Data metadata"] = 186,
    ["Facets - FSDL - Application"] = 184,
    ["Fossa configuration file"] = 191,
    ["Fossa's fossa-deps file"] = 192,
    ["Foundry VTT - Manifest"] = 189,
    ["Foundry VTT - Template"] = 190,
    ["Foxx Manifest"] = 44,
    ["GatewayCore API Gateway"] = 195,
    ["GeoJSON.json latest"] = 556,
    GherKing = 560,
    ["GitHub Action"] = 199,
    ["GitHub Funding"] = 200,
    ["GitHub Issue Template configuration"] = 202,
    ["GitHub Workflow"] = 203,
    ["GitHub Workflow Template Properties"] = 204,
    ["GitHub issue forms"] = 201,
    GitVersion = 198,
    ["Gitpod Configuration"] = 206,
    ["Global Privacy Control"] = 196,
    ["Google Cloud Workflows"] = 126,
    Goreleaser = 209,
    ["Goreleaser Pro"] = 210,
    ["Gradle Build Cache Node"] = 515,
    ["Gradle Enterprise"] = 514,
    ["Grafana 5.x Dashboard"] = 211,
    ["GraphQL Code Generator"] = 214,
    ["GraphQL Config"] = 213,
    ["GraphQL Mesh"] = 212,
    ["Grunt JSHint task"] = 218,
    ["Grunt Watch task"] = 219,
    ["Grunt base task"] = 220,
    ["Grunt clean task"] = 216,
    ["Grunt copy task"] = 215,
    ["Grunt cssmin task"] = 217,
    HEMTT = 487,
    Hadolint = 499,
    ["Hardware Sentry Configuration"] = 572,
    Hayson = 222,
    ["Haystack Pipeline"] = 223,
    ["Hazelcast 5 Configuration"] = 224,
    ["Helm Chart.lock"] = 103,
    ["Helm Chart.yaml"] = 102,
    Hugo = 550,
    ["Istanbul Schema"] = 575,
    ["JDownloader2 crawler multi-rule schema"] = 240,
    ["JDownloader2 crawler single-rule schema"] = 239,
    ["JFrog File Spec"] = 241,
    ["JFrog Pipelines YML DSL"] = 581,
    ["JSON Document Transform"] = 249,
    ["JSON Feed"] = 250,
    ["JSON Resume"] = 360,
    ["JSON Schema Draft 2020-12"] = 467,
    ["JSON Schema Draft 4"] = 464,
    ["JSON Schema Draft 7"] = 465,
    ["JSON Schema Draft 8"] = 466,
    ["JSON schema for CodeShip Pro services configuration files"] = 112,
    ["JSON schema for CodeShip Pro steps configuration files"] = 113,
    ["JSON schema for Codecov configuration files"] = 111,
    ["JSON-API"] = 248,
    ["JSON-e templates"] = 523,
    ["JSON-stat 2.0"] = 461,
    JSONPatch = 252,
    Jasmine = 235,
    Jekyll = 236,
    ["Jenkins X Pipelines"] = 237,
    ["Jenkins X Requirements"] = 238,
    ["Jovo Language Models"] = 242,
    ["KSP-AVC"] = 462,
    ["KSP-CKAN"] = 463,
    ["Keycloak REST API"] = 583,
    ["Knative Functions - func.yaml"] = 193,
    ["KoDE/CI build.yaml"] = 577,
    ["Kong DBLess Schema"] = 578,
    KrakenD = 255,
    ["LinkML Metamodel"] = 266,
    Liquibase = 529,
    ["Liquibase Flow File"] = 530,
    Markdownlint = 533,
    ["MegaLinter configuration"] = 270,
    ["MegaLinter descriptor"] = 271,
    ["Meltano plugin discovery definition"] = 273,
    ["Meltano project definition"] = 272,
    ["Microsoft Band Web Tile"] = 274,
    ["Minecraft Data Pack Advancement"] = 276,
    ["Minecraft Data Pack Biome"] = 277,
    ["Minecraft Data Pack Configured Carver"] = 278,
    ["Minecraft Data Pack Dimension"] = 280,
    ["Minecraft Data Pack Dimension Type"] = 279,
    ["Minecraft Data Pack Item Modifier"] = 281,
    ["Minecraft Data Pack Loot Table"] = 282,
    ["Minecraft Data Pack Metadata"] = 283,
    ["Minecraft Data Pack Predicate"] = 284,
    ["Minecraft Data Pack Recipe"] = 285,
    ["Minecraft Data Pack Template Pool"] = 286,
    ["Minecraft Resourcepack Sounds"] = 287,
    ["MongoDB Atlas Search Index Definition Schema"] = 576,
    ["Monika Configuration Schema"] = 574,
    ["Motif config"] = 483,
    ["Netin Diagnostic System Template"] = 538,
    ["Netlify config schema"] = 292,
    ["Nightwatch.js"] = 293,
    ["OSS Review Toolkit configuration"] = 315,
    ["OSS Review Toolkit curation"] = 316,
    ["OSS Review Toolkit package configuration"] = 317,
    ["OSS Review Toolkit repository configuration"] = 318,
    ["OSS Review Toolkit resolutions"] = 319,
    Opctl = 486,
    ["OpenWeather Current Weather API"] = 522,
    ["OpenWeather Road Risk API"] = 521,
    ["Ory Hydra configuration"] = 228,
    ["Ory Keto configuration"] = 257,
    ["Ory Kratos configuration"] = 314,
    ["Ory Oathkeeper configuration"] = 305,
    ["Outblocks App configuration"] = 312,
    ["Outblocks database table"] = 313,
    ["Outblocks project configuration"] = 311,
    Packer = 322,
    ["Pipeline component"] = 531,
    ["PocketMine plugin.yml"] = 326,
    Pterodactyl = 571,
    ["Pull Request Labeler"] = 349,
    PyProject = 353,
    Qodana = 547,
    ["Quali Torque Blueprint Spec 2"] = 569,
    ["RKE Cluster Configuration JSON Schema"] = 528,
    ["RKE Cluster Configuration YAML Schema"] = 527,
    Ray = 498,
    ["Read the Docs"] = 352,
    ["Red-DiscordBot Cog"] = 354,
    ["Red-DiscordBot Cog Repo"] = 355,
    Renovate = 361,
    ["Replit schema"] = 358,
    RoadRunner = 362,
    ["Rust toolchain"] = 364,
    SWADL = 410,
    ["Sapphire CLI Config"] = 365,
    ["SauceCTL Configuration"] = 535,
    ["Schema Catalog"] = 378,
    ["Scoop manifest"] = 383,
    ["Semgrep Rule"] = 385,
    ["Serverless Framework Configuration"] = 542,
    ["Serverless Workflow Schema"] = 543,
    ["Settings.paf"] = 387,
    ["Shopware 6 Configuration"] = 544,
    ["Shopware CLI Extension Store Configuration"] = 545,
    ["Shopware CLI Project Store Configuration"] = 546,
    Solidarity = 392,
    ["Solution filters"] = 393,
    ["Source Maps v3"] = 394,
    SpecIF = 395,
    ["Sponge Mixin configuration"] = 396,
    ["StackHawk Scanner Configuration"] = 541,
    ["StackHead CLI config"] = 400,
    ["StackHead module configuration"] = 401,
    ["StackHead project definition"] = 402,
    Stale = 403,
    Starship = 404,
    ["Statamic Blueprint"] = 405,
    ["StrmPrivacy batch job configuration file"] = 582,
    ["Stryker Mutator"] = 407,
    ["StyleCop Analyzers Configuration"] = 408,
    ["Swagger API 2.0"] = 411,
    TSON = 431,
    ["Talisman configuration"] = 412,
    ["Taskfile YAML Schema"] = 524,
    Taurus = 413,
    ["TestEnvironment.json"] = 420,
    Tikibase = 416,
    ["Traefik v2"] = 423,
    ["Traefik v2 File Provider"] = 424,
    Turborepo = 421,
    Tye = 548,
    ["UI5 Manifest"] = 437,
    ["UTAM Page Object"] = 439,
    ["Ubuntu Server Autoinstall"] = 435,
    ["Uniswap Token List"] = 507,
    Updatecli = 555,
    Uplift = 585,
    ["User Journey Map YAML Schema"] = 526,
    V2Ray = 559,
    ["VSCode Code Snippets"] = 115,
    ["VSIX CLI publishing"] = 452,
    ["Vela Pipeline Configuration"] = 442,
    Vercel = 114,
    ["Web App Manifest"] = 457,
    ["Web types"] = 460,
    WebExtensions = 456,
    ["Webman package recipe"] = 565,
    ["Windows Package Manager Installer Manifest"] = 504,
    ["Windows Package Manager Locale Manifest"] = 505,
    ["Windows Package Manager Singleton Manifest"] = 503,
    ["Woodpecker pipeline config"] = 537,
    ["Xstate Machine Schema"] = 553,
    ["Yippee-Ki-JSON configuration YML"] = 509,
    ["angular.json"] = 9,
    ...
    ["chutzpah.json"] = 122,
    ["cloud-init: cloud-config userdata JSON schema"] = 109,
    ["cloud-sdk-pipeline-config-schema"] = 124,
    ["cloudbuild.json"] = 125,
    cloudify = 108,
    codemagic = 110,
    ["coffeelint.json"] = 131,
    comet = 519,
    ["commands.json"] = 118,
    ["compile_commands.json"] = 117,
    ["compilerconfig.json"] = 116,
    ["component-detection-manifest.json"] = 134,
    ["component.json"] = 133,
    ["composer.json"] = 132,
    ["config.json"] = 135,
    ["contentmanifest.json"] = 123,
    ["contribute.json"] = 136,
    ["cosmos.config.json"] = 120,
    ["crowdin.yml"] = 137,
    cspell = 140,
    ["cypress.json"] = 138,
    ["datalogic-scan2deploy-android"] = 146,
    ["datalogic-scan2deploy-ce"] = 147,
    ["dbt Project"] = 87,
    ["debugsettings.json"] = 148,
    ["dependabot-v2.json"] = 151,
    ["dependabot.json"] = 150,
    ["deployed-cli"] = 552,
    ["detekt.yml"] = 153,
    devinit = 511,
    ["devspace.yaml"] = 573,
    ["docfx.json"] = 157,
    ["docker-compose.yml"] = 510,
    ["docker-seq schema"] = 156,
    ["dockerd.json"] = 155,
    ["dotnet Release Index manifest"] = 166,
    ["dotnetcli.host.json"] = 167,
    ["drone.json"] = 168,
    ["dss-2.0.0.json"] = 170,
    ["dvc.yaml"] = 171,
    ["ecosystem.json"] = 173,
    eksctl = 174,
    ["electron-builder configuration file."] = 179,
    ["epr-manifest.json"] = 177,
    ["evcc.yaml"] = 180,
    ["ezd schema"] = 182,
    ["fabric.mod.json"] = 185,
    ["first-timers-bot"] = 188,
    ["fly.io Schema"] = 45,
    fulibWorkflows = 536,
    ["function.json"] = 194,
    ["geojson.json"] = 197,
    ["gitlab-ci"] = 205,
    ["global.json"] = 207,
    ["golangci-lint Configuration"] = 208,
    ["haxelib.json"] = 221,
    helmfile = 500,
    ["host-meta.json"] = 226,
    ["host.json"] = 225,
    ...
    huskyrc = 479,
    ["ide.host.json"] = 229,
    ["imageoptimizer.json"] = 230,
    ["importmap.json"] = 232,
    ["ioBroker JSON UI"] = 233,
    ["ioBroker Package manifest"] = 234,
    ["ize.toml"] = 584,
    ["jsconfig.json"] = 253,
    ["jscpd Configuration Schema"] = 570,
    jsdoc = 497,
    ["k3d.yaml"] = 254,
    ["kustomization.yaml"] = 258,
    ["label-commenter-config.yml"] = 259,
    ["launchsettings.json"] = 260,
    ["lerna.json"] = 261,
    ["lgtm.yml"] = 262,
    ["libman.json"] = 263,
    ["license-report-config.json"] = 264,
    ["linkinator.config.json"] = 265,
    ["local.settings.json"] = 267,
    ["localazy.json"] = 268,
    ["lsdlschema.json"] = 269,
    ["markdown-lint-check"] = 534,
    mboats = 540,
    ["mimetypes.json"] = 275,
    ["mta.yaml"] = 481,
    ["mtad.yaml"] = 482,
    ["mycode.json"] = 290,
    ["napari plugin manifest"] = 291,
    neoload = 492,
    ["nest-cli"] = 296,
    ["ninjs (News in JSON) 1.3"] = 295,
    ["ninjs (News in JSON) 2.0"] = 294,
    ["nlu.json"] = 297,
    ["nodemon.json"] = 299,
    ["noodl.schema.json"] = 539,
    now = 488,
    ["nswag.json"] = 303,
    ntangle = 304,
    ["nuclei-template.yaml"] = 301,
    ["nuget-project.json"] = 302,
    ["ocelot.json"] = 306,
    ["omnisharp.json"] = 307,
    ["openapi.json"] = 308,
    ["openfin.json"] = 310,
    ["openrpc.json"] = 309,
    ["package.json"] = 320,
    ["package.manifest"] = 321,
    ["pattern.json"] = 324,
    ["petstore-v1.0"] = 580,
    pgap_yaml_input_reader = 323,
    ["plagiarize-me.yaml"] = 328,
    ["plagiarize.yaml"] = 327,
    ["portman.json"] = 329,
    ["prettierrc.json"] = 334,
    ["prisma.yml"] = 335,
    ["project-1.0.0-beta3.json"] = 337,
    ["project-1.0.0-beta4.json"] = 338,
    ["project-1.0.0-beta5.json"] = 339,
    ["project-1.0.0-beta6.json"] = 340,
    ["project-1.0.0-beta8.json"] = 341,
    ["project-1.0.0-rc1.json"] = 342,
    ["project-1.0.0-rc2.json"] = 343,
    ["project.json"] = 336,
    ["prometheus.json"] = 344,
    ["prometheus.rules.json"] = 345,
    ["proxies.json"] = 346,
    ["publiccode.yml"] = 347,
    ["pubspec.yaml"] = 348,
    ["pyrseas-0.8.json"] = 351,
    ["release drafter"] = 493,
    rustfmt = 363,
    ["sarif-1.0.0.json"] = 366,
    ["sarif-2.0.0.json"] = 367,
    ["sarif-2.1.0"] = 376,
    ["sarif-2.1.0-rtm.2"] = 368,
    ["sarif-2.1.0-rtm.3"] = 370,
    ["sarif-2.1.0-rtm.4"] = 372,
    ["sarif-2.1.0-rtm.5"] = 374,
    ["sarif-external-property-file-2.1.0"] = 377,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 369,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 371,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 373,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 375,
    ["schema.org - Action"] = 379,
    ["schema.org - ContactPoint"] = 380,
    ["schema.org - Place"] = 381,
    ["schema.org - Thing"] = 382,
    ["semantic-release"] = 384,
    ["servicehub.config.json"] = 470,
    ["servicehub.service.json"] = 469,
    ["settings.job"] = 386,
    ["sfdx-hardis configuration"] = 388,
    ["size-limit configuration"] = 389,
    ["skaffold.yaml"] = 532,
    ["skyuxconfig.json"] = 390,
    snapcraft = 391,
    ["stripe-app.json"] = 406,
    swcrc = 520,
    taskcat = 489,
    ["template.json"] = 414,
    ["templatsources.json"] = 415,
    ["theme.json"] = 417,
    ["tizen_workspace.json"] = 418,
    tmLanguage = 419,
    tmuxinator = 478,
    ["trunk.yaml schema"] = 425,
    ["ts-force-config.json"] = 429,
    ["tsconfig.json"] = 426,
    ["tsd.json"] = 427,
    ["tsdrc.json"] = 428,
    ["tslint.json"] = 430,
    ...
    ["vega-lite.json"] = 441,
    ["vega.json"] = 440,
    ["venvironment-basic.yaml"] = 444,
    ["venvironment.yaml"] = 443,
    ["version.json"] = 445,
    ["vim-addon-info"] = 446,
    ["vs-2017.3.host.json"] = 448,
    ["vs-nesting.json"] = 449,
    ["vsls.json"] = 447,
    ["vss-extension.json"] = 453,
    ["webhint.io"] = 566,
    ["webjobpublishsettings.json"] = 459,
    ["webjobs-list.json"] = 458,
    ["xs-app.json"] = 485,
    ["xunit.runner.json"] = 468,
    yamllint = 508,
    zuul = 494,
    ["Žinoma"] = 502
  },
  schemas = { {
      ...
      name = "dbt Project",
      url = "https://raw.githubusercontent.com/dbt-labs/dbt-core/main/schemas/dbt/manifest/v7.json"
    }, {
