...
M.json = {
  ...
  index = {
    ...
    AIConfig = 50,
    ["AMX Muse Program Descriptor"] = 1347,
    ["API Builder"] = 1153,
    ["AVA Configuration"] = 1217,
    ...
    ["AWS Copilot Manifest"] = 1386,
    ["AWS SAM CLI Samconfig"] = 328,
    Acton = 1440,
    ["Adobe UXP Manifest"] = 1280,
    ["Aerleon Network & Service Definitions"] = 30,
    ["Aerleon Policy"] = 31,
    ["Agent Permission Policy"] = 1426,
    ["Agent Run Metrics"] = 32,
    ["AgentCore CLI"] = 1427,
    ["AgentCtl MCP"] = 1429,
    ["AgentCtl config"] = 1428,
    ["AgentCtl permissions"] = 1430,
    AgentLoopKit = 1431,
    Aider = 1376,
    Air = 34,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1397,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1396,
    ["Airlock Microgateway"] = 51,
    ["Alacritty Configuration"] = 1189,
    ["AlgoVoi Compliance Receipt v1"] = 19,
    ["All Contributors configuration file"] = 1243,
    ...
    ["Application list for a WinUtil"] = 1326,
    ["ArchSmith diagram IR"] = 1469,
    ArchitectFX = 1331,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1395,
    ["Azure IoT Operations connector metadata"] = 1392,
    ...
    Badness = 151,
    ["Barba-CV"] = 105,
    ["Bashly (bashly.yml)"] = 1247,
    ["Bashly Settings (bashly-settings.yml)"] = 1248,
    Bento = 1413,
    ["Better Code Hub"] = 1158,
    ["Better Scripts"] = 195,
    Bigconfig = 160,
    ["Biome Formatter Config"] = 106,
    ["Bitmovin Encoding Template"] = 1340,
    BizTalkServerApplicationSchema = 1124,
    Bleep = 196,
    ["Block Protocol Metadata"] = 193,
    ["Bluebricks blueprint config"] = 1419,
    ["Boyka Framework"] = 173,
    ...
    ["Butane Config"] = 1202,
    C4InterFlow = 1355,
    ["CDK Environment Manager, concrete environment configuration"] = 1379,
    ["CDK Environment Manager, concrete environments definition"] = 1378,
    ["CDK Environment Manager, environment definition"] = 1377,
    ["CGS Card Game Specification (cgs.json)"] = 1285,
    ["CICS TS region tagging"] = 1211,
    ["CICS TS resource import"] = 1212,
    ["CICS TS resource model"] = 1213,
    ["CICS TS resource overrides"] = 1214,
    ["CMake Presets"] = 197,
    ["CNC Codes"] = 224,
    ["CRS WAF test file"] = 1315,
    ["CRS WAF test platform overrides file"] = 1316,
    ...
    ["Caido Proxy Configuration"] = 1455,
    ...
    ["Chamaleon environment"] = 1344,
    ["Chamaleon properties"] = 1345,
    ["Chamaleon template"] = 1343,
    Changepacks = 1406,
    Changesets = 337,
    Changie = 209,
    Charmcraft = 210,
    ...
    ["Claude Code Launch Preview"] = 1468,
    ["Claude Code Plugin Manifest"] = 232,
    ["Claude Code Plugin Marketplace"] = 233,
    ["Claude Code Settings"] = 234,
    ["Clawject config"] = 230,
    ["Cloud Foundry Application Manifest"] = 1297,
    ["Cloud Run Spec v1"] = 1321,
    ...
    Concord = 1314,
    ["Configu .cfgu files"] = 1302,
    ["Configu .configu file"] = 1303,
    Conjure = 223,
    ["Container Structure Test"] = 1138,
    Containerlab = 1167,
    ["Context Passport"] = 2,
    ["Context Reasoning Format (CRF)"] = 221,
    ["Contextive Glossary"] = 1371,
    ContractGuard = 1168,
    Convex = 222,
    ...
    ["Cursor Agent Environment"] = 1424,
    ["Custom Machinery Machine"] = 1286,
    ["Custom Machinery Recipe"] = 1287,
    ...
    ["DonateCaseBetterCasino menu"] = 1348,
    ["Draugr Saga"] = 369,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1255,
    ["EAS config"] = 444,
    ["ECA - Editor Code Assistant"] = 407,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1244,
    ["ESLint Suppressions"] = 449,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1391,
    ["EasyVCR .NET"] = 446,
    ["Eidolon Resource"] = 1332,
    ...
    ["Envelope Team Definition"] = 1439,
    ["Envilder Map File"] = 412,
    ["Erda Pipeline"] = 1293,
    ["Erda Runtime"] = 1294,
    ["Espanso config.yml"] = 1417,
    ["Espanso match.yml"] = 1416,
    Esquio = 432,
    ["Estuary Flow Catalog"] = 1208,
    ["Ethereum ERC1155"] = 1433,
    ["Ethereum ERC721"] = 1432,
    ...
    ["Evolving Resolutive Process notation"] = 1393,
    ["Expo SDK"] = 443,
    ...
    ["GeoJSON.json latest"] = 1206,
    GherKing = 1210,
    ["GitHub Action"] = 488,
    ["GitHub Actions typing"] = 1328,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 1282,
    ...
    ["Google Digital Assetlinks"] = 1372,
    Goreleaser = 524,
    ["Goreleaser Pro"] = 525,
    Goss = 527,
    ["Gradle Build Cache Node"] = 1156,
    ["Gradle Enterprise"] = 1155,
    ...
    HEMTT = 1120,
    ["HULL - Helm Uniform Layer Library"] = 1473,
    Hadolint = 1134,
    Hammerkit = 1166,
    ["Hardware Sentry Configuration"] = 1222,
    ...
    ["Hecate Input Schema"] = 1383,
    ["Helm Chart.lock"] = 287,
    ["Helm Chart.yaml"] = 286,
    ["Helm Unittest Test Suite"] = 288,
    ["Heloisa Assistant Plugins Marketplace"] = 1466,
    ["Hex file"] = 289,
    ...
    ["JFrog File Spec"] = 584,
    ["JFrog Pipelines YML DSL"] = 1232,
    ["JMeter DSL cli config"] = 585,
    JReleaser = 588,
    ["JSON Document Transform"] = 596,
    ["JSON Feed"] = 597,
    ["JSON Resume"] = 880,
    ["JSON Schema Draft 2020-12"] = 1099,
    ["JSON Schema Draft 4"] = 1096,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1265,
    ["JSON Schema Draft 7"] = 1097,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1266,
    ["JSON Schema Draft 8 (2019-09)"] = 1098,
    ["JSON-API"] = 595,
    ["JSON-e templates"] = 1163,
    ["JSON-stat 2.0"] = 1092,
    JSONPatch = 599,
    ...
    Jsontron = 600,
    ["Jujutsu (jj) VCS config"] = 1385,
    ["KIMMDY config file"] = 611,
    ["KODE/CI build.yaml"] = 1228,
    ["KSP-AVC"] = 1093,
    ["KSP-CKAN"] = 1094,
    ["KSP-NetKAN"] = 1095,
    KSY = 1295,
    ...
    ["Kong DBLess config"] = 1229,
    KrakenD = 615,
    ["Kubri Configuration"] = 623,
    LOOBin = 644,
    ["Lake configuration file"] = 1388,
    ...
    ["Lando (landofile)"] = 132,
    ["LangGraph Platform configuration"] = 1307,
    ["Language configuration"] = 1306,
    Lefthook = 630,
    ...
    ["Madness (madness.yml)"] = 1246,
    ["Mado configuration"] = 651,
    ["Maestro Flow"] = 652,
    ["Mail Servers Configuration"] = 1420,
    ["MapEHR Mapping"] = 653,
    Markdownlint = 1177,
    ["Mason Registry"] = 1180,
    ...
    ["Metadata for a Cinnamon spice"] = 1324,
    ["Metatype Configuration"] = 662,
    ["MetricsHub Configuration"] = 663,
    ["MetricsHub Connector Configuration"] = 664,
    ["Micro Editor Syntax"] = 1256,
    ["Microsoft Band Web Tile"] = 665,
    ["Microsoft RulesEngine workflow rules"] = 1311,
    ["Microsoft RulesEngine workflow rules list"] = 1312,
    ["Minecraft Custom Main Menu Mod"] = 1274,
    ...
    ["MongoDB Atlas Search Index Definition"] = 1227,
    ["Monika Configuration"] = 1225,
    ["Monoweave Configuration"] = 696,
    ["Motif config"] = 1116,
    MultiQC = 1365,
    ["NOX Framework (Service)"] = 724,
    ["Netin Diagnostic System Template"] = 1184,
    ["Netlify config"] = 705,
    ...
    ["Nightwatch.js"] = 716,
    ["Nika workflow"] = 721,
    ["Node.js configuration"] = 1121,
    ["NueJS configuration file"] = 729,
    ["Nuitka Package Config"] = 1288,
    ...
    ["OpenUtau ustx"] = 750,
    ["OpenWeather Current Weather API"] = 1162,
    ["OpenWeather Road Risk API"] = 1161,
    ...
    ["Pipeline component"] = 1175,
    ["Platform.sh application"] = 15,
    ["Platform.sh routes"] = 16,
    ["Platform.sh services"] = 17,
    ["Plex Prerolls"] = 796,
    ["PocketMine plugin.yml"] = 793,
    ["Podman Desktop Extension"] = 1457,
    ["Postman collection"] = 802,
    ["Power Pages Configuration"] = 1382,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1327,
    ...
    ["Production delivery manifest"] = 1475,
    Promtail = 837,
    Pterodactyl = 1221,
    ...
    Pylock = 1373,
    Pyright = 851,
    ["Python script metadata"] = 1367,
    ["QType AI DSL"] = 854,
    Qgoda = 853,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1449,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1447,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1453,
    ["Qlik Talend Cloud Pipeline - Project"] = 1445,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1448,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1450,
    ["Qlik Talend Cloud Pipeline - Task"] = 1446,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1452,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1451,
    Qodana = 1194,
    ["Qt Creator workspace file"] = 1304,
    ["Quali Torque Blueprint Spec 2"] = 1219,
    ["QueryFirst config file"] = 1238,
    ["QuikRun Configuration"] = 1454,
    ["Qwen Code Settings"] = 1434,
    ["RKE Cluster Configuration JSON"] = 1172,
    ["RKE Cluster Configuration YAML"] = 1171,
    RadioHound = 844,
    ["Raid Profile"] = 1435,
    ["Raid Repo Configuration"] = 1436,
    Railpack = 856,
    Railway = 855,
    ["Rancher Fleet"] = 846,
    ["Rattler-build"] = 857,
    ...
    ["Replit config"] = 872,
    Restate = 1360,
    ["Revel Digital Gadget Definition File"] = 1384,
    RoadRunner = 886,
    ["Robust Station Image"] = 1390,
    Rockcraft = 887,
    ["Roo Coder Custom Modes"] = 888,
    Rubocop = 877,
    ["Rudder techniques"] = 1278,
    Ruff = 878,
    ["Rust Project"] = 879,
    ["Rust toolchain"] = 893,
    ...
    ["Serverless Framework Configuration"] = 1188,
    ["Serverless Workflow"] = 1190,
    ["Settings for a Cinnamon spice"] = 1323,
    ["Settings.paf"] = 927,
    ["Shopware 6 Configuration"] = 1191,
    ["Shopware CLI Extension Store Configuration"] = 1192,
    ["Shopware CLI Project Store Configuration"] = 1193,
    ["Sigma Detection Rule"] = 929,
    ["SigmaCV CV"] = 7,
    ["Sigrid scope configuration file"] = 930,
    ["SkyPilot Task JSON"] = 1279,
    ["Slack app manifest"] = 937,
    ["Slang Server Configuration"] = 1461,
    Snapcraft = 939,
    ...
    StackBlitz = 978,
    ["StackHawk Scanner Configuration"] = 1187,
    Stale = 979,
    Starfish = 980,
    ["Starlake Data Pipeline"] = 1159,
    Starship = 981,
    ...
    ["Tab data for a LinUtil"] = 1330,
    ["Tab list for a LinUtil"] = 1329,
    Tach = 997,
    ["Tach Domain"] = 998,
    Talhelper = 1000,
    ["Talisman configuration"] = 1001,
    Taplo = 1375,
    ["Taskfile config"] = 1164,
    Taurus = 1002,
    Tauticord = 1003,
    ["Tekton Pipeline"] = 1403,
    ["Tekton PipelineRun"] = 1404,
    ["Tekton Task"] = 1401,
    ["Tekton TaskRun"] = 1402,
    Telefonistka = 1361,
    ...
    ["Tugboat QA config.yml"] = 1354,
    TunnelHub = 1269,
    Turborepo = 1021,
    Tycho = 1318,
    Tye = 1195,
    ["Tyk Gateway - Open Source v5.7+"] = 1366,
    ["UET BuildConfig.json"] = 1239,
    ["UI5 Manifest"] = 1052,
    ["UNCORS configuration"] = 1057,
    ["UTAM Page Object"] = 1055,
    ["Ubuntu Server Autoinstall"] = 1050,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1358,
    ["Uniswap Token List"] = 1144,
    ["Universal Schedule Format"] = 1058,
    ["Unreal Engine Uplugin"] = 1240,
    ["Unreal Engine Uproject"] = 1241,
    ["UpCloud CLI (upctl) configuration"] = 1359,
    ["Updatecli Compose"] = 1203,
    ["Updatecli Policy Manifest"] = 1204,
    ["Updatecli Policy Metadata"] = 1205,
    Uplift = 1237,
    ["Upsun config"] = 14,
    ["User Journey Map"] = 1169,
    V2Ray = 1209,
    ["VSCode Code Snippets"] = 312,
    ["VSIX CLI publishing"] = 1078,
    Vector = 1060,
    ["Vee JSON menu output"] = 1061,
    ["Vela Pipeline Configuration"] = 1064,
    Vercel = 311,
    ["Version Bumper config"] = 1067,
    Vespertide = 1408,
    ["Vespertide Migration"] = 1409,
    ["Vespertide Model"] = 1410,
    ["Viash Component Config"] = 1363,
    ["Viash Package Config"] = 1364,
    Visivo = 1267,
    Vogi = 1072,
    ["WP-CLI"] = 1089,
    Wake = 1356,
    ["Waku Config"] = 1333,
    ["Web App Manifest"] = 1085,
    ["Web types"] = 1088,
    WebExtensions = 1084,
    ["Webman package recipe"] = 1215,
    ["Windows Package Manager Installer Manifest"] = 1141,
    ["Windows Package Manager Locale Manifest"] = 1142,
    ["Windows Package Manager Singleton Manifest"] = 1140,
    ["WireMock CLI import configuration"] = 1339,
    ["WireMock CLI local service configuration"] = 1338,
    ["WireMock message stub mapping"] = 1337,
    ["WireMock stub mapping"] = 1336,
    ["Woodpecker pipeline config"] = 1183,
    ["Wrangler CLI"] = 1090,
    ["XenForo add-on manifest"] = 1091,
    ["Xstate Machine"] = 1201,
    ["Yandex Workflow Language"] = 1325,
    ["Yarn Config (.yarnrc.yml)"] = 1157,
    ["Yippee-Ki-JSON configuration YML"] = 1148,
    ["YouTrack App"] = 1322,
    ["Zarf Package Configuration"] = 1389,
    ["Zerops import file"] = 1310,
    ["Zola Configuration"] = 1400,
    abtop = 36,
    act3 = 1441,
    actionlint = 46,
    ["aerleon.yml"] = 29,
    ...
    ["behat.yml"] = 175,
    ["bigquery-table"] = 159,
    ["bioimageio resource description"] = 1289,
    ...
    ["chutzpah.json"] = 320,
    cibuildwheel = 216,
    ["clang-format (.clang-format)"] = 1207,
    ["clang-tidy"] = 295,
    clangd = 294,
    clib = 296,
    ...
    ["crowdin.yml"] = 347,
    crucible = 351,
    ["ctfd-setup configuration file"] = 1346,
    ["custom-elements.json"] = 1259,
    ["cypress.json"] = 352,
    ["dacier.yml"] = 1444,
    ...
    ["gematik health care insurance list"] = 1352,
    ["gematik health care patient list"] = 1349,
    ["gematik health care provider institution list"] = 1351,
    ["gematik health care provider list"] = 1350,
    ["gematik tiger test environment configuration"] = 1353,
    ["gh-dash"] = 486,
    ["gha-doctor"] = 487,
    ["git-cliff"] = 483,
    ["git-town.toml"] = 1398,
    ...
    ["mkdocs.yml"] = 686,
    ["mockd.yaml"] = 690,
    ["mod.pw.toml (packwiz)"] = 1459,
    ["modelparams.dev Model"] = 693,
    ["models CLI"] = 694,
    ["monospace.yml"] = 695,
    ["moon.yml"] = 1335,
    ["mprocs Configuration file"] = 1305,
    ["mrdocs.yml"] = 688,
    ["mta.yaml"] = 1114,
    ["mtad.yaml"] = 1115,
    ["mycode.json"] = 703,
    ...
    ["plagiarize.yaml"] = 794,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1342,
    ["podbard.yaml"] = 797,
    ["portman.json"] = 800,
    ["prefect.toml"] = 809,
    ["prefect.yaml"] = 810,
    ...
    servercn = 1471,
    ["servicehub.config.json"] = 1102,
    ["servicehub.service.json"] = 1101,
    ["settings.job"] = 926,
    ...
    ["text2confl config"] = 1423,
    ["theme.json"] = 1013,
    ["tizen_workspace.json"] = 1015,
    tldr = 1016,
    ["tm_devices configuration file"] = 1380,
    tmuxinator = 1105,
    tox = 1018,
    ["transcend.yml"] = 1027,
    ...
    ["vega-lite.json"] = 1063,
    ["vega.json"] = 1062,
    ["venvironment.yaml"] = 1065,
    ["venvplus.yaml"] = 1066,
    version = 1362,
    ["version.json"] = 1068,
    ["vhwdebugger-binding.yaml"] = 1070,
    ["vim-addon-info"] = 1071,
    ["vs-2017.3.host.json"] = 1074,
    ["vs-nesting.json"] = 1075,
    ["vsls.json"] = 1073,
    ["vss-extension.json"] = 1079,
    vtcfg = 1368,
    ["vtesttree.yaml"] = 1080,
    ["vtestunit.yaml"] = 1081,
    ["warp-keysets.json"] = 1260,
    ["warp-themes.json"] = 1261,
    ["warp-workflows.json"] = 1262,
    ["webhint.io"] = 1216,
    ["webjobpublishsettings.json"] = 1087,
    ["webjobs-list.json"] = 1086,
    ["well-known-fursona"] = 1300,
    ["xs-app.json"] = 1118,
    ["xunit.runner.json"] = 1100,
    ["yaml-workflow"] = 1470,
    yamlfmt = 1145,
    yamllint = 1146,
    ["yap.json"] = 1147,
