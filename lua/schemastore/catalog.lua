...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 913,
    [".nodehawkrc"] = 563,
    [".npmpackagejsonlintrc"] = 567,
    [".omletrc"] = 1092,
    [".phrase.yml"] = 637,
    [".phraseapp.yml"] = 638,
    [".pmbot.yml"] = 623,
    [".postcssrc"] = 632,
    [".powerpages-web-template-manifest"] = 634,
    [".pre-commit-config.yml"] = 635,
    [".pre-commit-hooks.yml"] = 636,
    [".putout.json"] = 670,
    [".rehyperc"] = 695,
    [".remarkrc"] = 699,
    [".sprite files"] = 790,
    ...
    ["@factorial/drupal-breakpoints-css"] = 14,
    ["A micro editor config"] = 511,
    ABCInventoryModuleData = 22,
    ABCSupplyPlan = 23,
    ["ACP Attempts"] = 24,
    ["ACP Cache File"] = 25,
    ["ACP Configuration File"] = 26,
    ["ACP Primer"] = 27,
    ["ACP Sync"] = 28,
    ["ACP Variables File"] = 29,
    AIConfig = 30,
    ["AMX Muse Program Descriptor"] = 1140,
    ["API Builder"] = 948,
    ["AVA Configuration"] = 1011,
    ["AWS AppConfig Feature Flags-v1"] = 64,
    ["AWS CDK cdk.json"] = 249,
    ["AWS CloudFormation"] = 250,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 251,
    ["AWS Copilot Manifest"] = 1179,
    ["AWS SAM CLI Samconfig"] = 252,
    ["Adobe UXP Manifest"] = 1074,
    ["Aerleon Network & Service Definitions"] = 17,
    ["Aerleon Policy"] = 18,
    Aider = 1169,
    Air = 20,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1190,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1189,
    ["Airlock Microgateway"] = 31,
    ["Alacritty Configuration"] = 983,
    ["All Contributors configuration file"] = 1037,
    ["Ansible Argument Specs"] = 384,
    ["Ansible Collection Galaxy"] = 391,
    ["Ansible Execution Environment"] = 381,
    ["Ansible Inventory"] = 390,
    ["Ansible Meta"] = 382,
    ["Ansible Meta Runtime"] = 383,
    ["Ansible Navigator Configuration"] = 393,
    ["Ansible Playbook"] = 388,
    ["Ansible Requirements"] = 385,
    ["Ansible Rulebook"] = 389,
    ["Ansible Tasks File"] = 387,
    ["Ansible Vars File"] = 386,
    ["Ansible-lint Configuration"] = 392,
    Any = 1102,
    ["AnyWork Automation Configuration"] = 13,
    ["Apollo Router"] = 949,
    ["App config Spotify Backstage"] = 35,
    ["Applicant Profile Protocol"] = 10,
    ["Application Accelerator"] = 9,
    ["Application list for a WinUtil"] = 1119,
    ArchitectFX = 1124,
    ["Argo CD"] = 50,
    ["Argo Events"] = 51,
    ["Argo Workflows"] = 52,
    AssemblyScript = 55,
    AsyncAPI = 58,
    ["AsyncAPI Tool File"] = 59,
    ["Atmos Manifests"] = 60,
    ["Aurora Agile Meta-Framework"] = 61,
    AutoAPICase = 1047,
    ["Avro Avsc"] = 62,
    ["Awesome Repositories"] = 63,
    ["Azure Container App template for defining an immutable revision"] = 65,
    ["Azure DevOps extension manifest"] = 68,
    ["Azure Device Update for IoT Hub import manifest"] = 66,
    ["Azure Device Update for IoT Hub update manifest"] = 67,
    ["Azure IoT Edge deployment"] = 71,
    ["Azure IoT Edge deployment template"] = 72,
    ["Azure IoT EdgeAgent deployment"] = 69,
    ["Azure IoT EdgeHub deployment"] = 70,
    ["Azure IoT Operations Wasm Graph Config"] = 1188,
    ["Azure IoT Operations connector metadata"] = 1185,
    ["Azure Landing Zones Library archetype definition"] = 76,
    ["Azure Landing Zones Library archetype override"] = 77,
    ["Azure Landing Zones Library architecture definition"] = 75,
    ["Azure Landing Zones Library metadata"] = 73,
    ["Azure Landing Zones Library policy default values"] = 74,
    ["Azure Pipelines"] = 106,
    ["Azure Static Web Apps CLI configuration file"] = 794,
    ["Azure Static Web Apps configuration file"] = 793,
    ["BOSH CPI Config"] = 130,
    ["BOSH Deploy Config"] = 131,
    ["BX CI"] = 150,
    ["Bacon config"] = 3,
    ["Bashly (bashly.yml)"] = 1041,
    ["Bashly Settings (bashly-settings.yml)"] = 1042,
    Bento = 1206,
    ["Better Code Hub"] = 953,
    ["Better Scripts"] = 151,
    Bigconfig = 123,
    ["Biome Formatter Config"] = 78,
    ["Bitmovin Encoding Template"] = 1133,
    BizTalkServerApplicationSchema = 920,
    Bleep = 152,
    ["Block Protocol Metadata"] = 149,
    ["Boyka Framework"] = 132,
    Briefcase = 926,
    ["Build Info"] = 140,
    Buildkite = 142,
    ["Bukkit plugin.yml"] = 141,
    ["BungeeCord plugin.yml"] = 147,
    ["Butane Config"] = 996,
    C4InterFlow = 1148,
    ["CDK Environment Manager, concrete environment configuration"] = 1172,
    ["CDK Environment Manager, concrete environments definition"] = 1171,
    ["CDK Environment Manager, environment definition"] = 1170,
    ["CGS Card Game Specification (cgs.json)"] = 1079,
    ["CICS TS region tagging"] = 1005,
    ["CICS TS resource import"] = 1006,
    ["CICS TS resource model"] = 1007,
    ["CICS TS resource overrides"] = 1008,
    ["CMake Presets"] = 153,
    ["CNC Codes"] = 174,
    ["CRS WAF test file"] = 1109,
    ["CRS WAF test platform overrides file"] = 1110,
    ["CSS Comb (.csscomb.json)"] = 277,
    ["CSS Lint (.csslintrc)"] = 278,
    ["CSpell (cspell.json)"] = 276,
    ["CVE Record Format"] = 182,
    CWL = 1085,
    ["Cache Warmup config"] = 154,
    ["Calqulus pipeline"] = 155,
    ["Camel YAML DSL"] = 156,
    ["Cannon TOML"] = 157,
    Carafe = 158,
    ["Cargo Make"] = 160,
    ["Cargo Manifest"] = 159,
    ["Catalog Info Backstage"] = 161,
    ["Chamaleon environment"] = 1137,
    ["Chamaleon properties"] = 1138,
    ["Chamaleon template"] = 1136,
    Changepacks = 1199,
    Changesets = 261,
    Changie = 162,
    Charmcraft = 163,
    Cheatsheets = 993,
    ["ChordPro Configuration"] = 164,
    ["Chrome Extension"] = 242,
    ["Chromia Model"] = 165,
    ["Chromia Seeder Module Config"] = 167,
    ["Chromia Seeder Root Config"] = 166,
    ["Cinnamon Spice info.json"] = 86,
    ["CircleCI config.yml"] = 217,
    ["Citation File Format"] = 263,
    CityJSON = 169,
    ["Claude Code Settings"] = 181,
    ["Clawject config"] = 180,
    ["Cloud Foundry Application Manifest"] = 1091,
    ["Cloud Run Spec v1"] = 1114,
    ["Cloud.gov Workshop Configuration"] = 87,
    ["CloudCannon Configuration"] = 92,
    ["CloudCannon Configuration (Collection Structures)"] = 101,
    ["CloudCannon Configuration (Collections)"] = 100,
    ["CloudCannon Configuration (Editables)"] = 99,
    ["CloudCannon Configuration (Inputs)"] = 94,
    ["CloudCannon Configuration (Snippets Definitions)"] = 98,
    ["CloudCannon Configuration (Snippets Imports)"] = 97,
    ["CloudCannon Configuration (Snippets)"] = 96,
    ["CloudCannon Configuration (Structure Value)"] = 95,
    ["CloudCannon Configuration (Structures)"] = 93,
    ["CloudEvents specification"] = 170,
    ["Code Climate"] = 218,
    CodeCV = 90,
    CodeRabbit = 89,
    ["CodeShip Pro services configuration files"] = 231,
    ["CodeShip Pro steps configuration files"] = 232,
    ["Codecov configuration files"] = 230,
    Codex = 226,
    CodifyCLI = 91,
    Codux = 228,
    ["Cog config file"] = 175,
    ["Commandbox Box.json"] = 176,
    ["Commandbox Server.json"] = 177,
    ["Common Catalog Data"] = 240,
    ["Common Package Specification"] = 178,
    Concord = 1108,
    ["Configu .cfgu files"] = 1096,
    ["Configu .configu file"] = 1097,
    Conjure = 173,
    ["Container Structure Test"] = 934,
    Containerlab = 962,
    ["Contextive Glossary"] = 1164,
    Convex = 172,
    ["Crowdsec collection config"] = 271,
    ["Crowdsec parser config"] = 272,
    ["Crowdsec scenario config"] = 273,
    ["CumulusCI Config"] = 179,
    ["Custom Machinery Machine"] = 1080,
    ["Custom Machinery Recipe"] = 1081,
    ["Cycle Stack File"] = 183,
    CycloneDX = 184,
    ["DWP Exchange - catalogue entry"] = 320,
    ["DWP Exchange - gateway"] = 318,
    ["DWP Exchange - meta"] = 319,
    ["Dart Build Config (dart-build.json)"] = 279,
    ["Dart Test Config (dart-test.json)"] = 280,
    ["DashLord Configuration"] = 281,
    ["Data Contract Specification"] = 282,
    ["Data Product Specification"] = 283,
    ["DataYoga Connections"] = 185,
    ["DataYoga Job"] = 186,
    ["Databricks Asset Bundles"] = 1058,
    ["Datadog Continuous Testing"] = 482,
    ["Datadog Service Definition"] = 483,
    ["Datadog Software Catalog"] = 484,
    ["Datahub Ingestion Recipe"] = 1012,
    ["Debian Upstream Metadata file"] = 192,
    ["Deck config"] = 193,
    ["Dein Config"] = 194,
    ["Deno Config (deno.json)"] = 289,
    ["Dependency cruiser"] = 195,
    ["DeployStack Configuration"] = 196,
    ["Deployah Configuration"] = 1187,
    ["Deployer Recipe"] = 292,
    ["Deta Spacefile"] = 197,
    ["Detekt Config (detekt.yml)"] = 293,
    ["Devbox Config"] = 198,
    ["Devbox Plugin"] = 199,
    Devfile = 317,
    Devup = 1200,
    DipDup = 1111,
    ["Discord Webhook"] = 294,
    ["DocFx Config (docfx.json)"] = 298,
    Dofigen = 299,
    ["Dolittle Artifacts"] = 300,
    ["Dolittle Bounded Context Configuration"] = 301,
    ["Dolittle Event Horizons Configuration"] = 302,
    ["Dolittle Resources Configuration"] = 303,
    ["Dolittle Server Configuration"] = 304,
    ["Dolittle Tenant Map Configuration"] = 306,
    ["Dolittle Tenants Configuration"] = 305,
    ["Dolittle Topology"] = 307,
    ["DonateCaseBetterCasino menu"] = 1141,
    ["Drupal Breakpoints"] = 200,
    ["Drupal Config"] = 212,
    ["Drupal Info"] = 201,
    ["Drupal Layouts"] = 202,
    ["Drupal Libraries"] = 203,
    ["Drupal Links Action"] = 204,
    ["Drupal Links Contextual"] = 205,
    ["Drupal Links Menu"] = 206,
    ["Drupal Links Task"] = 207,
    ["Drupal Migration"] = 208,
    ["Drupal Permissions"] = 209,
    ["Drupal Recipe"] = 210,
    ["Drupal Routing"] = 211,
    ["Drupal Services"] = 213,
    ["Drush site aliases"] = 313,
    ["Dynamic Bash Aliases (.aliases)"] = 1049,
    ["EAS config"] = 337,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1038,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1184,
    ["EasyVCR .NET"] = 338,
    ["Eidolon Resource"] = 1125,
    ["Elgato Stream Deck"] = 323,
    Elm = 1113,
    ["Embrace Config"] = 1024,
    Endurica = 1062,
    ["Enterprise Contract Policy Spec"] = 324,
    ["Erda Pipeline"] = 1087,
    ["Erda Runtime"] = 1088,
    ["Espanso config.yml"] = 1209,
    ["Espanso match.yml"] = 1208,
    Esquio = 326,
    ["Estuary Flow Catalog"] = 1002,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 330,
    ["EveryVoice TTS Toolkit Data Configuration"] = 331,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 335,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 334,
    ["EveryVoice TTS Toolkit Text Configuration"] = 332,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 333,
    ["Evolving Resolutive Process notation"] = 1186,
    ["Expo SDK"] = 336,
    ["F-Droid Data metadata"] = 342,
    ["FasterCI Configuration"] = 107,
    FiQuS = 346,
    Firebase = 344,
    ["FlexGet Config"] = 347,
    ["Flow.json Configurations"] = 1084,
    ["Fossa configuration file"] = 354,
    ["Fossa's fossa-deps file"] = 355,
    ["Foundry VTT - Base package Manifest"] = 349,
    ["Foundry VTT - Module Manifest"] = 350,
    ["Foundry VTT - System Data Template"] = 353,
    ["Foundry VTT - System Manifest"] = 351,
    ["Foundry VTT - World Manifest"] = 352,
    ["Foxx Manifest"] = 108,
    ["Freifunk.de Community API"] = 111,
    ["Frogbot Config"] = 112,
    ["G2P Mapping Configuration"] = 361,
    ["GCP Blueprint Metadata"] = 364,
    Gaspar = 362,
    ["GatewayCore API Gateway"] = 363,
    ["Gemini CLI settings"] = 365,
    ["GeoJSON.json latest"] = 1000,
    GherKing = 1004,
    ["GitHub Action"] = 370,
    ["GitHub Actions typing"] = 1121,
    ["GitHub Discussion"] = 371,
    ["GitHub Funding"] = 372,
    ["GitHub Issue Template configuration"] = 373,
    ["GitHub Issue Template forms"] = 374,
    ["GitHub Workflow"] = 375,
    ["GitHub Workflow Template Properties"] = 376,
    ["GitHub automatically generated release notes configuration"] = 377,
    ["GitLab Agent for Kubernetes configuration"] = 1076,
    GitVersion = 367,
    ["Gitea Issue Template configuration"] = 368,
    ["Gitea Issue Template forms"] = 369,
    ["Gitpod Automations"] = 379,
    ["Gitpod Configuration"] = 380,
    ["GlazeWM settings"] = 1078,
    ["Global Privacy Control"] = 366,
    Goblet = 1057,
    ["Golangci-lint Configuration"] = 395,
    ["Golangci-lint Custom Plugins Configuration"] = 396,
    ["Google Chrome Related Website Sets"] = 345,
    ["Google Cloud Workflows"] = 248,
    ["Google Digital Assetlinks"] = 1165,
    Goreleaser = 398,
    ["Goreleaser Pro"] = 399,
    Goss = 400,
    ["Gradle Build Cache Node"] = 951,
    ["Gradle Enterprise"] = 950,
    ["Grafana 5.x Dashboard"] = 401,
    ["GraphQL Code Generator"] = 406,
    ["GraphQL Config"] = 405,
    ["GraphQL Mesh"] = 404,
    ["GroovyLint configuration"] = 407,
    ["Grunt JSHint task"] = 411,
    ["Grunt Watch task"] = 412,
    ["Grunt base task"] = 413,
    ["Grunt clean task"] = 409,
    ["Grunt copy task"] = 408,
    ["Grunt cssmin task"] = 410,
    HEMTT = 916,
    Hadolint = 930,
    Hammerkit = 961,
    ["Hardware Sentry Configuration"] = 1016,
    ["HashiCorp Vault"] = 414,
    Hatch = 931,
    Hayson = 416,
    ["Haystack Pipeline"] = 417,
    ["Hazelcast 5 Configuration"] = 418,
    ["Hecate Input Schema"] = 1176,
    ["Helm Chart.lock"] = 215,
    ["Helm Chart.yaml"] = 214,
    ["Helm Unittest Test Suite"] = 216,
    ["Home Assistant Integration Manifest"] = 419,
    ["Homer dashboard configuration"] = 420,
    Hugo = 992,
    ["Hugo Theme"] = 991,
    ["Hulak Configuration"] = 427,
    ["Hyperfoil benchmark configuration"] = 426,
    ["IBM Zapp document"] = 428,
    ["IBM zCodeFormatSettings"] = 429,
    ["IMG Catapult PSP"] = 434,
    ["IVMS101 by CODE Protocol"] = 1077,
    Infrahub = 436,
    Istanbul = 1020,
    ["JDownloader2 crawler multi-rules"] = 449,
    ["JDownloader2 crawler single-rules"] = 448,
    ["JFrog Applications Config"] = 450,
    ["JFrog File Spec"] = 451,
    ["JFrog Pipelines YML DSL"] = 1026,
    ["JMeter DSL cli config"] = 452,
    JReleaser = 455,
    ["JSON Document Transform"] = 463,
    ["JSON Feed"] = 464,
    ["JSON Resume"] = 705,
    ["JSON Schema Draft 2020-12"] = 898,
    ["JSON Schema Draft 4"] = 895,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1059,
    ["JSON Schema Draft 7"] = 896,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1060,
    ["JSON Schema Draft 8 (2019-09)"] = 897,
    ["JSON-API"] = 462,
    ["JSON-e templates"] = 958,
    ["JSON-stat 2.0"] = 891,
    JSONPatch = 466,
    ["JSR Package Config (jsr.json)"] = 456,
    Jarl = 1192,
    Jasmine = 443,
    Jekyll = 444,
    ["Jenkins X Pipelines"] = 445,
    ["Jenkins X Requirements"] = 446,
    Jest = 447,
    Jocker = 453,
    ["Jovo Language Models"] = 454,
    ["Jujutsu (jj) VCS config"] = 1178,
    ["KIMMDY config file"] = 477,
    ["KODE/CI build.yaml"] = 1022,
    ["KSP-AVC"] = 892,
    ["KSP-CKAN"] = 893,
    ["KSP-NetKAN"] = 894,
    KSY = 1089,
    KSail = 359,
    ["KYA Manifest"] = 1090,
    ["Karakum configuration file"] = 356,
    Kas = 469,
    ["Kestra flow file"] = 478,
    ["Keycloak REST API"] = 1029,
    ["Knative Functions - func.yaml"] = 357,
    Knip = 358,
    ["Kometa (nightly) config file"] = 480,
    ["Kometa config file"] = 479,
    ["Kong DBLess config"] = 1023,
    KrakenD = 481,
    ["Kubri Configuration"] = 488,
    LOOBin = 503,
    ["Lake configuration file"] = 1181,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 253,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 254,
    ["Landing Zone Accelerator on AWS - Global Config"] = 255,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 256,
    ["Landing Zone Accelerator on AWS - Network Config"] = 257,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 258,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 259,
    ["Landing Zone Accelerator on AWS - Security Config"] = 260,
    ["Lando (landofile)"] = 102,
    ["LangGraph Platform configuration"] = 1101,
    ["Language configuration"] = 1100,
    Lefthook = 492,
    ["Liferay client-extension.yaml"] = 499,
    ["LinkML Metamodel"] = 501,
    Liquibase = 967,
    ["Liquibase Flow File"] = 968,
    ["Lively Properties"] = 502,
    ["Lobe AI Agent"] = 104,
    Loki = 105,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 543,
    ["MS2Rescore Configuration"] = 546,
    ["Madness (madness.yml)"] = 1040,
    ["Mado configuration"] = 509,
    ["MapEHR Mapping"] = 510,
    Markdownlint = 971,
    ["Mason Registry"] = 974,
    ["MegaLinter Custom Flavor"] = 513,
    ["MegaLinter configuration"] = 512,
    ["MegaLinter descriptor"] = 514,
    Melange = 1067,
    ["Meltano project definition"] = 515,
    ["Mergify Configuration"] = 547,
    ["Metadata for a Bazel module"] = 516,
    ["Metadata for a Cinnamon spice"] = 1117,
    ["Metatype Configuration"] = 517,
    ["MetricsHub Configuration"] = 518,
    ["MetricsHub Connector Configuration"] = 519,
    ["Micro Editor Syntax"] = 1050,
    ["Microsoft Band Web Tile"] = 520,
    ["Microsoft RulesEngine workflow rules"] = 1105,
    ["Microsoft RulesEngine workflow rules list"] = 1106,
    ["Minecraft Custom Main Menu Mod"] = 1068,
    ["Minecraft Data Pack Advancement"] = 522,
    ["Minecraft Data Pack Biome"] = 523,
    ["Minecraft Data Pack Configured Carver"] = 524,
    ["Minecraft Data Pack Damage Type"] = 525,
    ["Minecraft Data Pack Dimension"] = 527,
    ["Minecraft Data Pack Dimension Type"] = 526,
    ["Minecraft Data Pack Item Modifier"] = 528,
    ["Minecraft Data Pack Loot Table"] = 529,
    ["Minecraft Data Pack Metadata"] = 530,
    ["Minecraft Data Pack Predicate"] = 531,
    ["Minecraft Data Pack Recipe"] = 532,
    ["Minecraft Data Pack Tag"] = 533,
    ["Minecraft Data Pack Template Pool"] = 534,
    ["Minecraft Data Pack Trim Material"] = 539,
    ["Minecraft Data Pack Trim Pattern"] = 540,
    ["Minecraft Resource Pack Lang"] = 535,
    ["Minecraft Resource Pack Particle"] = 536,
    ["Minecraft Resource Pack Texture Mcmeta"] = 538,
    ["Minecraft Resourcepack Sounds"] = 537,
    ["Monade CLI Stack Configuration"] = 550,
    ["MongoDB Atlas Search Index Definition"] = 1021,
    ["Monika Configuration"] = 1019,
    ["Monoweave Configuration"] = 545,
    ["Motif config"] = 912,
    MultiQC = 1158,
    ["NOX Framework (Service)"] = 566,
    ["Netin Diagnostic System Template"] = 978,
    ["Netlify config"] = 553,
    ["Network-as-Code Data Model"] = 554,
    ["Next Gen UI Agent A2A Server Configuration"] = 555,
    ["Next Gen UI Agent Configuration"] = 557,
    ["Next Gen UI Agent MCP Server Configuration"] = 556,
    ["Nightwatch.js"] = 559,
    ["Node.js configuration"] = 917,
    ["NueJS configuration file"] = 571,
    ["Nuitka.yaml"] = 1082,
    ["Nullstone config"] = 573,
    ["ONe's changelog entry"] = 591,
    ["ONe's service descriptor"] = 590,
    ["ORT Server repository environment configuration"] = 599,
    ["OSCAL Assessment Plan (AP)"] = 601,
    ["OSCAL Assessment Results (AR)"] = 602,
    ["OSCAL Catalog"] = 603,
    ["OSCAL Component Definition (CDef)"] = 604,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 605,
    ["OSCAL Profile"] = 606,
    ["OSCAL System Security Plan (SSP)"] = 607,
    ["OSS Review Toolkit configuration"] = 608,
    ["OSS Review Toolkit curation"] = 609,
    ["OSS Review Toolkit package configuration"] = 610,
    ["OSS Review Toolkit repository configuration"] = 611,
    ["OSS Review Toolkit resolutions"] = 612,
    ["October CMS columns"] = 577,
    ["October CMS fields"] = 578,
    ["Oh My Posh"] = 579,
    Okteto = 580,
    ["Ona Automations"] = 582,
    Opctl = 915,
    ["Open Data Contract Standard (ODCS)"] = 594,
    ["Open Data Product Standard (ODPS)"] = 595,
    ["Open Know-How"] = 1163,
    ["OpenRewrite Resource"] = 593,
    OpenStatus = 1174,
    ["OpenUtau character yaml"] = 587,
    ["OpenUtau ustx"] = 588,
    ["OpenWeather Current Weather API"] = 957,
    ["OpenWeather Road Risk API"] = 956,
    ["Ory Hydra configuration"] = 425,
    ["Ory Keto configuration"] = 485,
    ["Ory Kratos configuration"] = 600,
    ["Ory Oathkeeper configuration"] = 575,
    ["Outblocks App configuration"] = 597,
    ["Outblocks database table"] = 598,
    ["Outblocks project configuration"] = 596,
    PDM = 619,
    POPxf = 629,
    ["POPxf Correlations"] = 630,
    Packer = 616,
    Pantsbuild = 1036,
    ["Paper paper-plugin.yml"] = 617,
    ["Pipeline component"] = 969,
    ["Platform.sh application"] = 5,
    ["Platform.sh routes"] = 6,
    ["Platform.sh services"] = 7,
    ["Plex Prerolls"] = 627,
    ["PocketMine plugin.yml"] = 624,
    ["Postman collection"] = 633,
    ["Power Pages Configuration"] = 1175,
    ["Preset list for a WinUtil"] = 1120,
    ["ProActions AI-Kit Configuration"] = 643,
    ["ProActions AI-Kit Configuration for Menus"] = 645,
    ["ProActions AI-Kit Configuration for Sections"] = 647,
    ["ProActions AI-Kit Configuration for Services"] = 644,
    ["ProActions AI-Kit Configuration for Steps"] = 648,
    ["ProActions AI-Kit Configuration for Templates"] = 646,
    ["Problem object RFC9457"] = 1065,
    ["Problem package format"] = 649,
    ["Problem package generators"] = 650,
    ["Problem package submissions"] = 651,
    ["Problem package test group metadata"] = 652,
    Pterodactyl = 1015,
    ["Pull Request Labeler"] = 669,
    Pulumi = 677,
    ["PyGTA Config"] = 673,
    PyProject = 678,
    Pylock = 1166,
    Pyright = 679,
    ["Python script metadata"] = 1160,
    ["QType AI DSL"] = 682,
    Qgoda = 681,
    Qodana = 988,
    ["Qt Creator workspace file"] = 1098,
    ["Quali Torque Blueprint Spec 2"] = 1013,
    ["QueryFirst config file"] = 1032,
    ["RKE Cluster Configuration JSON"] = 966,
    ["RKE Cluster Configuration YAML"] = 965,
    RadioHound = 672,
    Railpack = 684,
    Railway = 683,
    ["Rancher Fleet"] = 674,
    ...
    Ray = 929,
    ["Read the Docs"] = 676,
    ["Red-DiscordBot Cog"] = 692,
    ["Red-DiscordBot Cog Repo"] = 693,
    ["Red-DiscordBot Trivia"] = 694,
    ["Releasaurus Config"] = 2,
    ["Render Blueprints"] = 964,
    RenderCV = 709,
    Renovate = 706,
    ["Renovate global configuration"] = 707,
    ["Renovate inherited configuration"] = 708,
    ["Replit config"] = 700,
    Restate = 1153,
    ["Revel Digital Gadget Definition File"] = 1177,
    RoadRunner = 711,
    ["Robust Station Image"] = 1183,
    Rockcraft = 712,
    ["Roo Coder Custom Modes"] = 713,
    Rubocop = 702,
    ["Rudder techniques"] = 1072,
    Ruff = 703,
    ["Rust Project"] = 704,
    ["Rust toolchain"] = 717,
    ["SDMX data message"] = 743,
    ["SDMX metadata message"] = 742,
    ["SDMX structure message"] = 741,
    ["SIL Kit Participant Configuration"] = 753,
    ["SIL Kit Registry Configuration"] = 754,
    ["SPDX 2.3"] = 791,
    SWADL = 807,
    ["Safebox Config"] = 1027,
    ["Sapphire CLI Config"] = 720,
    ["SauceCTL Configuration"] = 975,
    ["Schema Catalog"] = 735,
    ["Scoop manifest"] = 740,
    ["Semantic Data Fabric (SDF) file"] = 744,
    ["Semgrep Rule"] = 746,
    ["Serenity Code Generator (Sergen)"] = 747,
    ["Serverless Framework Configuration"] = 982,
    ["Serverless Workflow"] = 984,
    ["Settings for a Cinnamon spice"] = 1116,
    ["Settings.paf"] = 749,
    ["Shopware 6 Configuration"] = 985,
    ["Shopware CLI Extension Store Configuration"] = 986,
    ["Shopware CLI Project Store Configuration"] = 987,
    ["Sigma Detection Rule"] = 751,
    ["Sigrid scope configuration file"] = 752,
    ["SkyPilot Task JSON"] = 1073,
    ["Slack app manifest"] = 756,
    Snapcraft = 758,
    Solidarity = 761,
    ["Solution filters"] = 762,
    ["Source Maps v3"] = 763,
    Sourcery = 764,
    ["Spack bootstrap.yaml"] = 765,
    ["Spack cdash.yaml"] = 766,
    ["Spack ci.yaml"] = 767,
    ["Spack compilers.yaml"] = 768,
    ["Spack concretizer.yaml"] = 769,
    ["Spack config.yaml"] = 770,
    ["Spack definitions.yaml"] = 771,
    ["Spack develop.yaml"] = 772,
    ["Spack env_vars.yaml"] = 773,
    ["Spack environment"] = 779,
    ["Spack include.yaml"] = 774,
    ["Spack mirrors.yaml"] = 775,
    ["Spack modules.yaml"] = 776,
    ["Spack packages.yaml"] = 777,
    ["Spack repos.yaml"] = 778,
    ["Spack toolchains.yaml"] = 780,
    ["Spack upstreams.yaml"] = 781,
    ["Spack view.yaml"] = 782,
    ["Speakeasy Generation Config File"] = 786,
    ["Speakeasy Lint Configuration File"] = 783,
    ["Speakeasy Test Generation Configuration File"] = 784,
    ["Speakeasy Workflow File"] = 785,
    SpecIF = 787,
    ["Specmatic Configuration"] = 788,
    ["Sponge Mixin configuration"] = 789,
    StackBlitz = 795,
    ["StackHawk Scanner Configuration"] = 981,
    Stale = 796,
    Starfish = 797,
    ["Starlake Data Pipeline"] = 954,
    Starship = 798,
    ["Statamic Blueprint"] = 799,
    ["Stella configuration file"] = 800,
    ["Streamlit configuration file"] = 801,
    ["Stryker Mutator"] = 804,
    ["StyleCop Analyzers Configuration"] = 805,
    ["Stylelint (.stylelintrc)"] = 806,
    ["Stylua Config"] = 1167,
    ["Sublime Syntax"] = 1028,
    ["Subsquid squid manifest"] = 1075,
    ["Swagger API 2.0"] = 808,
    ["Synadia Connect Component"] = 809,
    TSON = 844,
    TSTyche = 845,
    ["TYPO3 Vendor Bundler config"] = 850,
    ["Tab data for a LinUtil"] = 1123,
    ["Tab list for a LinUtil"] = 1122,
    Tach = 810,
    ["Tach Domain"] = 811,
    Talhelper = 813,
    ["Talisman configuration"] = 814,
    Taplo = 1168,
    ["Taskfile config"] = 959,
    Taurus = 815,
    Tauticord = 816,
    ["Tekton Pipeline"] = 1196,
    ["Tekton PipelineRun"] = 1197,
    ["Tekton Task"] = 1194,
    ["Tekton TaskRun"] = 1195,
    Telefonistka = 1154,
    ["Terrateam config"] = 1180,
    ["TestEnvironment.json"] = 827,
    ["TextMate Grammar"] = 826,
    Threagile = 822,
    ["Tier.run pricing.json"] = 819,
    Tikibase = 820,
    Tombi = 825,
    ["Traefik v2"] = 830,
    ["Traefik v2 File Provider"] = 831,
    ["Traefik v3"] = 832,
    ["Traefik v3 File Provider"] = 833,
    ["Travis CI (.travis.yml)"] = 829,
    Treefmt = 403,
    Trident = 1150,
    ["TrueScript for *.tscript files"] = 836,
    ["Tugboat QA config.yml"] = 1147,
    TunnelHub = 1063,
    Turborepo = 828,
    Tycho = 1112,
    Tye = 989,
    ["Tyk Gateway - Open Source v5.7+"] = 1159,
    ["UET BuildConfig.json"] = 1033,
    ["UI5 Manifest"] = 856,
    ["UNCORS configuration"] = 860,
    ["UTAM Page Object"] = 859,
    ["Ubuntu Server Autoinstall"] = 854,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1151,
    ["Uniswap Token List"] = 941,
    ["Universal Schedule Format"] = 861,
    ["Unreal Engine Uplugin"] = 1034,
    ["Unreal Engine Uproject"] = 1035,
    ["UpCloud CLI (upctl) configuration"] = 1152,
    ["Updatecli Compose"] = 997,
    ["Updatecli Policy Manifest"] = 998,
    ["Updatecli Policy Metadata"] = 999,
    Uplift = 1031,
    ["Upsun config"] = 4,
    ["User Journey Map"] = 963,
    V2Ray = 1003,
    ["VSCode Code Snippets"] = 236,
    ["VSIX CLI publishing"] = 879,
    Vector = 863,
    ["Vela Pipeline Configuration"] = 866,
    Vercel = 235,
    ["Version Bumper config"] = 869,
    Vespertide = 1201,
    ["Vespertide Migration"] = 1202,
    ["Vespertide Model"] = 1203,
    ["Viash Component Config"] = 1156,
    ["Viash Package Config"] = 1157,
    Visivo = 1061,
    ["WP-CLI"] = 889,
    Wake = 1149,
    ["Waku Config"] = 1126,
    ["Web App Manifest"] = 885,
    ["Web types"] = 888,
    WebExtensions = 884,
    ["Webman package recipe"] = 1009,
    ["Windows Package Manager Installer Manifest"] = 937,
    ["Windows Package Manager Locale Manifest"] = 938,
    ["Windows Package Manager Singleton Manifest"] = 936,
    Winutil = 939,
    ["WireMock CLI import configuration"] = 1132,
    ["WireMock CLI local service configuration"] = 1131,
    ["WireMock message stub mapping"] = 1130,
    ["WireMock stub mapping"] = 1129,
    ["Woodpecker pipeline config"] = 977,
    ["Wrangler CLI"] = 890,
    ["Xstate Machine"] = 995,
    ["Yandex Workflow Language"] = 1118,
    ["Yarn Config (.yarnrc.yml)"] = 952,
    ["Yippee-Ki-JSON configuration YML"] = 943,
    ["YouTrack App"] = 1115,
    ["Zarf Package Configuration"] = 1182,
    ["Zerops.io config"] = 1103,
    ["Zerops.io import"] = 1104,
    ["Zola Configuration"] = 1193,
    ["aerleon.yml"] = 16,
    ["angular.json"] = 32,
    apko = 1066,
    ["app-definition.yaml"] = 36,
    ["apple-app-site-association"] = 34,
    ["appsettings.StormPetrel.json"] = 41,
    ["appsettings.json"] = 39,
    ["appsscript.json"] = 38,
    ["appveyor.yml"] = 40,
    ["aqua-generate-registry.yaml"] = 43,
    ["aqua-policy.yaml"] = 44,
    ["aqua.yaml"] = 42,
    ["arazzo.json"] = 46,
    ["arb.json"] = 47,
    ["arc.json"] = 49,
    ["architect.yml"] = 48,
    ["artifacthub-repo.yml"] = 53,
    ["asm-lsp"] = 54,
    ["ast-grep rules"] = 57,
    ["ast-grep sgconfig.yml"] = 56,
    ["babelrc.json"] = 114,
    ["bamboo-spec"] = 117,
    ["bashly-strings.yml"] = 1043,
    ["batect.yml"] = 116,
    ["beef-database-codegen"] = 118,
    ["beef-database-v5-codegen"] = 120,
    ["beef-entity-codegen"] = 119,
    ["beef-entity-v5-codegen"] = 121,
    ["behat.yml"] = 133,
    ["bigquery-table"] = 122,
    ["bioimageio resource description"] = 1083,
    ["bitbucket-pipelines"] = 124,
    bitrise = 125,
    ["bitrise-step"] = 126,
    ["block.json"] = 148,
    ["bottom configuration"] = 79,
    ["bower.json"] = 128,
    ["bozr.suite.json"] = 135,
    bpkg = 1044,
    ["browser.i18n.json"] = 136,
    ["browsh configuration"] = 137,
    bucklescript = 138,
    ["buf.gen.yaml"] = 81,
    ["buf.lock"] = 82,
    ["buf.plugin.yaml"] = 83,
    ...
    ["build-changelog"] = 139,
    ["bun.lock"] = 144,
    ["bundleconfig.json"] = 145,
    ["bunfig.toml"] = 146,
    ["cargo-mutants-config.yaml"] = 85,
    ["ccmod.json"] = 1127,
    changelogging = 1095,
    ["chisel-slices.json"] = 262,
    ["chrome-extension-locales-messages.json"] = 243,
    ["chutzpah.json"] = 244,
    cibuildwheel = 168,
    ["clang-format (.clang-format)"] = 1001,
    ["clang-tidy"] = 222,
    clangd = 221,
    clib = 223,
    ["cloud-init: cloud-config userdata"] = 225,
    ["cloud-sdk-pipeline-configuration"] = 246,
    ["cloudbuild.json"] = 247,
    cloudify = 224,
    ["cmdx.yaml"] = 88,
    codemagic = 227,
    ["coffeelint.json"] = 264,
    ["commands.json"] = 239,
    ["commitlint (.commitlintrc)"] = 940,
    ["committed.toml"] = 265,
    ["compile_commands.json"] = 238,
    ["compilerconfig.json"] = 237,
    ["completely.yml"] = 1039,
    ["component-detection-manifest.json"] = 268,
    ["component.json"] = 267,
    ["composer.json"] = 266,
    ["conda-forge"] = 171,
    ["config.yaml"] = 675,
    ["contentmanifest.json"] = 245,
    ["contribute.json"] = 269,
    ["cosmos.config.json"] = 241,
    ["crowdin.yml"] = 270,
    ["ctfd-setup configuration file"] = 1139,
    ["custom-elements.json"] = 1053,
    ["cypress.json"] = 274,
    ["datalogic-scan2deploy-android"] = 284,
    ["datalogic-scan2deploy-ce"] = 285,
    ["dbt Dependencies"] = 187,
    ["dbt Packages"] = 189,
    ["dbt Project"] = 188,
    ["dbt Selectors"] = 190,
    ["dbt YAML files"] = 191,
    ["ddev-global"] = 286,
    ["ddev-project"] = 287,
    ["debugsettings.json"] = 288,
    ["dependabot-v2.json"] = 291,
    ["dependabot.json"] = 290,
    ["deployed-cli"] = 994,
    ["devcontainer.json"] = 229,
    devinit = 945,
    ["devspace.yaml"] = 1017,
    djlint = 946,
    ["docker bake"] = 296,
    ["docker sequencer"] = 297,
    ["docker-compose.yml"] = 944,
    ["dockerd.json"] = 295,
    ["dotnet Release Index manifest"] = 308,
    ["dotnet-tools.json"] = 309,
    ["dotnetcli.host.json"] = 310,
    ["dprint.json"] = 311,
    ["drone.json"] = 312,
    ["dss-2.0.0.json"] = 314,
    ["dstack configuration"] = 315,
    ["dtool dataset metadata"] = 1134,
    ["dvc.yaml"] = 316,
    ["ecosystem.json"] = 321,
    eksctl = 322,
    ["electron-builder configuration file"] = 328,
    ["epr-manifest.json"] = 327,
    ["evcc.yaml"] = 329,
    ["ezd task runner"] = 339,
    ["fabric.mod.json"] = 341,
    ["first-timers-bot"] = 348,
    ["flagd flag configuration"] = 109,
    ["fly.io Configuration"] = 110,
    fulibWorkflows = 976,
    ["function.json"] = 360,
    ["gRPC API Gateway & OpenAPI Config"] = 11,
    ["gematik health care insurance list"] = 1145,
    ["gematik health care patient list"] = 1142,
    ["gematik health care provider institution list"] = 1144,
    ["gematik health care provider list"] = 1143,
    ["gematik tiger test environment configuration"] = 1146,
    ["git-town.toml"] = 1191,
    ["gitlab-ci"] = 378,
    ["global.json"] = 394,
    ["go-feature-flag Flag Configuration"] = 397,
    ["haxelib.json"] = 415,
    helmfile = 932,
    helmwave = 933,
    ["host-meta.json"] = 422,
    ...
    ["ide.host.json"] = 430,
    ["ifstate.yaml"] = 431,
    ["imageoptimizer.json"] = 432,
    ["importmap.json"] = 435,
    instant_python_config = 437,
    instant_python_custom_project = 438,
    ["ioBroker Configuration"] = 439,
    ["ioBroker JSON UI"] = 440,
    ["ioBroker Package manifest"] = 441,
    ["ixpect.conf.yaml"] = 442,
    ["ize.toml"] = 1030,
    ["jsconfig.json"] = 467,
    ["jscpd Configuration"] = 1014,
    jsdoc = 928,
    ["k3d.yaml"] = 468,
    ["k9s aliases.yaml"] = 470,
    ["k9s cluster-config.yaml"] = 472,
    ["k9s config.yaml"] = 471,
    ["k9s hotkeys.yaml"] = 473,
    ["k9s plugins.yaml"] = 474,
    ["k9s skin.yaml"] = 475,
    ["k9s views.yaml"] = 476,
    ["kontinuous-config.yaml"] = 487,
    ["kontinuous-values.yaml"] = 486,
    ["kustomization.yaml"] = 489,
    ["label-commenter-config.yml"] = 490,
    ["latexindent configuration"] = 103,
    ["launchsettings.json"] = 491,
    lazydocker = 1052,
    lazygit = 1051,
    ["lego.json"] = 493,
    ["lerna.json"] = 494,
    ["lgtm.yml"] = 495,
    ["liblab.config.json"] = 496,
    ["libman.json"] = 497,
    ["license-report-config.json"] = 498,
    ["linkinator.config.json"] = 500,
    ["lint-staged (.lintstagedrc)"] = 906,
    ["local.settings.json"] = 505,
    ["localazy.json"] = 506,
    ["lotus.yaml"] = 504,
    ["lsdlschema.json"] = 507,
    ["macro.json"] = 1018,
    ["markdown-link-check"] = 972,
    maturin = 973,
    mboats = 980,
    ["micro-settings.json"] = 1045,
    ["mimetypes.json"] = 521,
    ["mirrord config"] = 908,
    mise = 909,
    ["mkdocs.yml"] = 541,
    ["monospace.yml"] = 544,
    ["moon.yml"] = 1128,
    ["mprocs Configuration file"] = 1099,
    ["mrdocs.yml"] = 542,
    ["mta.yaml"] = 910,
    ["mtad.yaml"] = 911,
    ["mycode.json"] = 551,
    nFPM = 558,
    ["napari plugin manifest"] = 552,
    neoload = 923,
    ["nest-cli"] = 561,
    ["ninjs (News in JSON)"] = 560,
    ["nitro.json"] = 922,
    ["nixd configuration"] = 1071,
    ["nlu.json"] = 562,
    ["nodemon.json"] = 564,
    ["noodl config"] = 979,
    ["notebook.mod.json"] = 565,
    now = 918,
    ["npm-badges"] = 568,
    ["nswag.json"] = 572,
    ntangle = 574,
    ["nuclei-template.yaml"] = 569,
    ["nuget-project.json"] = 570,
    ["ocelot.json"] = 576,
    ["omnisharp.json"] = 581,
    openHAB = 1204,
    ["openapi.json"] = 583,
    ...
    ["overlay.json"] = 584,
    ["package.json"] = 613,
    ["package.manifest"] = 615,
    ["package.yaml"] = 614,
    ["partial-black.json"] = 134,
    ["pathfinder.yml"] = 618,
    ["pattern.json"] = 621,
    ["petstore-v1.0"] = 1025,
    pgap_yaml_input_reader = 620,
    pgxgen = 1207,
    ["pixi.toml"] = 622,
    ["plagiarize-me.yaml"] = 626,
    ["plagiarize.yaml"] = 625,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1135,
    ["podbard.yaml"] = 628,
    ["portman.json"] = 631,
    ["prefect.toml"] = 639,
    ["prefect.yaml"] = 640,
    ["prettierrc.json"] = 641,
    ["prisma.yml"] = 642,
    ["project-1.0.0-beta3.json"] = 654,
    ["project-1.0.0-beta4.json"] = 655,
    ["project-1.0.0-beta5.json"] = 656,
    ["project-1.0.0-beta6.json"] = 657,
    ["project-1.0.0-beta8.json"] = 658,
    ["project-1.0.0-rc1.json"] = 659,
    ["project-1.0.0-rc2.json"] = 660,
    ["project.json"] = 653,
    ["project.owasp.yaml"] = 661,
    ["prometheus-alertmanager.json"] = 665,
    ["prometheus.json"] = 662,
    ["prometheus.rules.json"] = 663,
    ["prometheus.rules.test.json"] = 664,
    ["proxies.json"] = 666,
    ["publiccode.yml"] = 667,
    ["pubspec.yaml"] = 668,
    ["pyrseas-0.8.json"] = 671,
    pytest = 680,
    ["quilt.mod.json"] = 1046,
    ["rc3 auth"] = 686,
    ["rc3 collection"] = 687,
    ...
    ["release drafter"] = 924,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 696,
    ["release-please-manifest.json"] = 697,
    ["release-plz.toml"] = 698,
    ["renv.lock"] = 710,
    ["rivet.json"] = 1070,
    ["rivet.yaml (legacy)"] = 1069,
    rumdl = 715,
    runny = 714,
    rustfmt = 716,
    sake = 1162,
    samt = 718,
    samtrc = 719,
    ["sarif-1.0.0.json"] = 721,
    ["sarif-2.0.0.json"] = 722,
    ["sarif-2.1.0"] = 732,
    ["sarif-2.1.0-rtm.2"] = 723,
    ["sarif-2.1.0-rtm.3"] = 725,
    ["sarif-2.1.0-rtm.4"] = 727,
    ["sarif-2.1.0-rtm.5"] = 729,
    ["sarif-2.1.0-rtm.6"] = 730,
    ["sarif-external-property-file-2.1.0"] = 733,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 724,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 726,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 728,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 731,
    ["scalingo.json configuration"] = 734,
    ["schema.org - Action"] = 736,
    ["schema.org - ContactPoint"] = 737,
    ["schema.org - Place"] = 738,
    ["schema.org - Thing"] = 739,
    ["secrethub.yml"] = 1048,
    ["semantic-release"] = 745,
    ["servicehub.config.json"] = 901,
    ["servicehub.service.json"] = 900,
    ["settings.job"] = 748,
    ["sfdx-hardis configuration"] = 750,
    ["shard.yml"] = 1086,
    ["size-limit configuration"] = 755,
    ["skaffold.yaml"] = 970,
    ["skyuxconfig.json"] = 757,
    ["snowflake-config"] = 759,
    ["snowflake-connections"] = 760,
    ["spicepod.yaml"] = 1107,
    ["sqlc configuration"] = 792,
    ["stripe-app-local.json"] = 803,
    ["stripe-app.json"] = 802,
    swcrc = 955,
    ["task.json"] = 812,
    taskcat = 919,
    ["template.json"] = 817,
    ["templatsources.json"] = 818,
    ["theme.json"] = 821,
    ["tizen_workspace.json"] = 823,
    tldr = 824,
    ["tm_devices configuration file"] = 1173,
    tmuxinator = 904,
    ["transcend.yml"] = 834,
    ["tree-sitter grammar.json"] = 402,
    ["trime.yaml"] = 835,
    ["trunk.yaml"] = 837,
    ["ts-force-config.json"] = 842,
    ["tsconfig.json"] = 838,
    ["tsd.json"] = 839,
    ["tsdoc.json"] = 840,
    ["tsdrc.json"] = 841,
    ...
    v8r = 883,
    vcluster = 1093,
    ["vcpkg configuration file"] = 234,
    ["vcpkg manifest file"] = 233,
    ["vega-lite.json"] = 865,
    ["vega.json"] = 864,
    ["venvironment.yaml"] = 867,
    ["venvplus.yaml"] = 868,
    version = 1155,
    ["version.json"] = 870,
    ["vhwdebugger-binding.yaml"] = 872,
    ["vim-addon-info"] = 873,
    ["vs-2017.3.host.json"] = 875,
    ["vs-nesting.json"] = 876,
    ["vsls.json"] = 874,
    ["vss-extension.json"] = 880,
    vtcfg = 1161,
    ["vtesttree.yaml"] = 881,
    ["vtestunit.yaml"] = 882,
    ["warp-keysets.json"] = 1054,
    ["warp-themes.json"] = 1055,
    ["warp-workflows.json"] = 1056,
    ["webhint.io"] = 1010,
    ["webjobpublishsettings.json"] = 887,
    ["webjobs-list.json"] = 886,
    ["well-known-fursona"] = 1094,
    ["xs-app.json"] = 914,
    ["xunit.runner.json"] = 899,
    yamllint = 942,
    zizmor = 1198,
    zuul = 925,
    ["Žinoma"] = 935
