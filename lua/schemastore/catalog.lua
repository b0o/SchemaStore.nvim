...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 135,
    [".cryproj (generic)"] = 467,
    [".cryproj engine-5.2"] = 462,
    [".cryproj engine-5.3"] = 463,
    [".cryproj engine-5.4"] = 464,
    [".cryproj engine-5.5"] = 465,
    [".cryproj engine-dev"] = 466,
    [".csscomb.json"] = 137,
    [".csslintrc"] = 138,
    [".eslintrc"] = 179,
    [".esmrc.json"] = 171,
    ...
    [".pmbot.yml"] = 318,
    [".postcssrc"] = 323,
    [".pre-commit-config.yml"] = 324,
    [".pre-commit-hooks.yml"] = 325,
    [".putout.json"] = 343,
    [".rehyperc"] = 349,
    [".remarkrc"] = 350,
    [".sprite files"] = 390,
    ...
    [".vsext"] = 443,
    [".yarnrc.yml"] = 507,
    ["<div>RIOTS' studio configuration"] = 446,
    ["API Builder"] = 504,
    ["AVA Configuration Schema"] = 558,
    ...
    ["Azure Pipelines"] = 41,
    ["Azure Static Web Apps CLI configuration file"] = 392,
    ["Azure Static Web Apps configuration file"] = 391,
    ["BX CI"] = 70,
    ["Better Code Hub"] = 509,
    ["Better Scripts"] = 71,
    BizTalkServerApplicationSchema = 481,
    ...
    ["Butane config schema"] = 545,
    ["CICS TS region tagging"] = 552,
    ["CICS TS resource import"] = 553,
    ["CICS TS resource model"] = 554,
    ["CICS TS resource overrides"] = 555,
    ["CMake Presets"] = 72,
    ...
    ["Embrace Config Schema"] = 570,
    ["Error pages"] = 174,
    Esquio = 172,
    ["Estuary Flow Catalog Schema"] = 549,
    ["Expo SDK"] = 177,
    ...
    Goreleaser = 205,
    ["Goreleaser Pro"] = 206,
    ["Gradle Build Cache Node"] = 506,
    ["Gradle Enterprise"] = 505,
    ...
    HEMTT = 478,
    Hadolint = 490,
    ["Hardware Sentry Configuration"] = 563,
    Hayson = 218,
    ...
    ["Istanbul Schema"] = 566,
    ["JFrog File Spec"] = 235,
    ["JFrog Pipelines YML DSL"] = 572,
    ["JSON Document Transform"] = 243,
    ["JSON Feed"] = 244,
    ["JSON Resume"] = 353,
    ["JSON Schema Draft 2020-12"] = 458,
    ["JSON Schema Draft 4"] = 455,
    ["JSON Schema Draft 7"] = 456,
    ["JSON Schema Draft 8"] = 457,
    ...
    ["KSP-AVC"] = 453,
    ["KSP-CKAN"] = 454,
    ["Keycloak REST API"] = 574,
    ["KoDE/CI build.yaml"] = 568,
    ["Kong DBLess Schema"] = 569,
    KrakenD = 249,
    ["LinkML Metamodel"] = 260,
    Liquibase = 520,
    ["Liquibase Flow File"] = 521,
    Markdownlint = 524,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 567,
    ["Monika Configuration Schema"] = 565,
    ["Motif config"] = 474,
    ["Netin Diagnostic System Template"] = 529,
    ["Netlify config schema"] = 286,
    ["Nightwatch.js"] = 287,
    ["OSS Review Toolkit curation"] = 309,
    ["OSS Review Toolkit package configuration"] = 310,
    ["OSS Review Toolkit repository configuration"] = 311,
    ["OSS Review Toolkit resolutions"] = 312,
    Opctl = 477,
    ["OpenWeather Current Weather API"] = 513,
    ["OpenWeather Road Risk API"] = 512,
    ...
    Packer = 315,
    ["Pipeline component"] = 522,
    ["PocketMine plugin.yml"] = 319,
    Pterodactyl = 562,
    ["Pull Request Labeler"] = 342,
    PyProject = 346,
    Qodana = 538,
    ["Quali Torque Blueprint Spec 2"] = 560,
    ["RKE Cluster Configuration JSON Schema"] = 519,
    ["RKE Cluster Configuration YAML Schema"] = 518,
    Ray = 489,
    ["Read the Docs"] = 345,
    ["Red-DiscordBot Cog"] = 347,
    ["Red-DiscordBot Cog Repo"] = 348,
    Renovate = 354,
    ["Replit schema"] = 351,
    RoadRunner = 355,
    ["Rust toolchain"] = 357,
    SWADL = 403,
    ["Sapphire CLI Config"] = 358,
    ["SauceCTL Configuration"] = 526,
    ["Schema Catalog"] = 371,
    ["Scoop manifest"] = 376,
    ["Semgrep Rule"] = 378,
    ["Serverless Framework Configuration"] = 533,
    ["Serverless Workflow Schema"] = 534,
    ["Settings.paf"] = 380,
    ["Shopware 6 Configuration"] = 535,
    ["Shopware CLI Extension Store Configuration"] = 536,
    ["Shopware CLI Project Store Configuration"] = 537,
    Solidarity = 385,
    ["Solution filters"] = 386,
    ["Source Maps v3"] = 387,
    SpecIF = 388,
    ["Sponge Mixin configuration"] = 389,
    ["StackHawk Scanner Configuration"] = 532,
    ["StackHead CLI config"] = 393,
    ["StackHead module configuration"] = 394,
    ["StackHead project definition"] = 395,
    Stale = 396,
    Starship = 397,
    ["Statamic Blueprint"] = 398,
    ["StrmPrivacy batch job configuration file"] = 573,
    ["Stryker Mutator"] = 400,
    ["StyleCop Analyzers Configuration"] = 401,
    ["Swagger API 2.0"] = 404,
    ["Talisman configuration"] = 405,
    ["Taskfile YAML Schema"] = 515,
    Taurus = 406,
    ["TestEnvironment.json"] = 413,
    Tikibase = 409,
    ["Traefik v2"] = 416,
    ["Traefik v2 File Provider"] = 417,
    Turborepo = 414,
    Tye = 539,
    ["UI5 Manifest"] = 429,
    ["UTAM Page Object"] = 431,
    ["Ubuntu Server Autoinstall"] = 427,
    ["Uniswap Token List"] = 498,
    Updatecli = 546,
    ["User Journey Map YAML Schema"] = 517,
    V2Ray = 550,
    ["VSCode Code Snippets"] = 111,
    ["VSIX CLI publishing"] = 444,
    ["Vela Pipeline Configuration"] = 434,
    Vercel = 110,
    ["Web App Manifest"] = 448,
    ["Web types"] = 451,
    WebExtensions = 447,
    ["Webman package recipe"] = 556,
    ["Windows Package Manager Installer Manifest"] = 495,
    ["Windows Package Manager Locale Manifest"] = 496,
    ["Windows Package Manager Singleton Manifest"] = 494,
    ["Woodpecker pipeline config"] = 528,
    ["Xstate Machine Schema"] = 544,
    ["Yippee-Ki-JSON configuration YML"] = 500,
    ["angular.json"] = 8,
    ...
    ["jsconfig.json"] = 247,
    ["jscpd Configuration Schema"] = 561,
    jsdoc = 488,
    ["k3d.yaml"] = 248,
    ...
    ["openrpc.json"] = 303,
    ["package.json"] = 313,
    ["package.manifest"] = 314,
    ["pattern.json"] = 317,
    ["petstore-v1.0"] = 571,
    pgap_yaml_input_reader = 316,
    ["plagiarize-me.yaml"] = 321,
    ["plagiarize.yaml"] = 320,
    ["portman.json"] = 322,
    ["prettierrc.json"] = 327,
    ["prisma.yml"] = 328,
    ["project-1.0.0-beta3.json"] = 330,
    ["project-1.0.0-beta4.json"] = 331,
    ["project-1.0.0-beta5.json"] = 332,
    ["project-1.0.0-beta6.json"] = 333,
    ["project-1.0.0-beta8.json"] = 334,
    ["project-1.0.0-rc1.json"] = 335,
    ["project-1.0.0-rc2.json"] = 336,
    ["project.json"] = 329,
    ["prometheus.json"] = 337,
    ["prometheus.rules.json"] = 338,
    ["proxies.json"] = 339,
    ["publiccode.yml"] = 340,
    ["pubspec.yaml"] = 341,
    ["pyrseas-0.8.json"] = 344,
    ["release drafter"] = 484,
    rustfmt = 356,
    ["sarif-1.0.0.json"] = 359,
    ["sarif-2.0.0.json"] = 360,
    ["sarif-2.1.0"] = 369,
    ["sarif-2.1.0-rtm.2"] = 361,
    ["sarif-2.1.0-rtm.3"] = 363,
    ["sarif-2.1.0-rtm.4"] = 365,
    ["sarif-2.1.0-rtm.5"] = 367,
    ["sarif-external-property-file-2.1.0"] = 370,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 362,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 364,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 366,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 368,
    ["schema.org - Action"] = 372,
    ["schema.org - ContactPoint"] = 373,
    ["schema.org - Place"] = 374,
    ["schema.org - Thing"] = 375,
    ["semantic-release"] = 377,
    ["servicehub.config.json"] = 461,
    ["servicehub.service.json"] = 460,
    ["settings.job"] = 379,
    ["sfdx-hardis configuration"] = 381,
    ["size-limit configuration"] = 382,
    ["skaffold.yaml"] = 523,
    ["skyuxconfig.json"] = 383,
    snapcraft = 384,
    ["stripe-app.json"] = 399,
    swcrc = 511,
    taskcat = 480,
    ["template.json"] = 407,
    ["templatsources.json"] = 408,
    ["theme.json"] = 410,
    ["tizen_workspace.json"] = 411,
    tmLanguage = 412,
    tmuxinator = 469,
    ["trunk.yaml schema"] = 418,
    ["ts-force-config.json"] = 422,
    ["tsconfig.json"] = 419,
    ["tsd.json"] = 420,
    ["tsdrc.json"] = 421,
    ["tslint.json"] = 423,
    ...
    ["vega-lite.json"] = 433,
    ["vega.json"] = 432,
    ["venvironment-basic.yaml"] = 436,
    ["venvironment.yaml"] = 435,
    ["version.json"] = 437,
    ["vim-addon-info"] = 438,
    ["vs-2017.3.host.json"] = 440,
    ["vs-nesting.json"] = 441,
    ["vsls.json"] = 439,
    ["vss-extension.json"] = 445,
    ["webhint.io"] = 557,
    ["webjobpublishsettings.json"] = 450,
    ["webjobs-list.json"] = 449,
    ["xs-app.json"] = 476,
    ["xunit.runner.json"] = 459,
    yamllint = 499,
    zuul = 485,
    ["Žinoma"] = 493
  },
