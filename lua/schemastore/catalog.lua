...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 165,
    [".cryproj (generic)"] = 565,
    [".cryproj engine-5.2"] = 560,
    [".cryproj engine-5.3"] = 561,
    [".cryproj engine-5.4"] = 562,
    [".cryproj engine-5.5"] = 563,
    [".cryproj engine-dev"] = 564,
    [".csscomb.json"] = 167,
    [".csslintrc"] = 168,
    [".es6importsorterrc.json"] = 691,
    [".eslintrc"] = 214,
    [".esmrc.json"] = 206,
    [".ffizer.yaml"] = 218,
    [".htmlhintrc"] = 264,
    ...
    [".mtaext"] = 574,
    [".nodehawkrc"] = 358,
    [".npmpackagejsonlintrc"] = 361,
    [".phraseapp.yml"] = 400,
    [".pmbot.yml"] = 390,
    [".postcssrc"] = 395,
    [".powerpages-web-template-manifest"] = 397,
    [".pre-commit-config.yml"] = 398,
    [".pre-commit-hooks.yml"] = 399,
    [".putout.json"] = 418,
    [".rehyperc"] = 428,
    [".remarkrc"] = 429,
    [".sprite files"] = 480,
    ...
    ["<div>RIOTS' studio configuration"] = 544,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config schema"] = 320,
    ["API Builder"] = 604,
    ["AVA Configuration Schema"] = 661,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration Schema"] = 636,
    ["All Contributors configuration file"] = 690,
    ...
    ["Azure Pipelines"] = 54,
    ["Azure Static Web Apps CLI configuration file"] = 482,
    ["Azure Static Web Apps configuration file"] = 481,
    ["BX CI"] = 89,
    ["Better Code Hub"] = 609,
    ["Better Scripts"] = 90,
    BizTalkServerApplicationSchema = 580,
    ...
    ["Butane Config"] = 648,
    ["CICS TS region tagging"] = 655,
    ["CICS TS resource import"] = 656,
    ["CICS TS resource model"] = 657,
    ["CICS TS resource overrides"] = 658,
    ["CMake Presets"] = 91,
    ...
    ["Datahub Ingestion Recipe Schema"] = 662,
    ...
    ["Embrace Config Schema"] = 673,
    ["Error pages"] = 209,
    Esquio = 207,
    ["Estuary Flow Catalog Schema"] = 652,
    ["Expo SDK"] = 212,
    ...
    Goreleaser = 246,
    ["Goreleaser Pro"] = 247,
    ["Gradle Build Cache Node"] = 606,
    ["Gradle Enterprise"] = 605,
    ...
    Hadolint = 589,
    Hammerkit = 616,
    ["Hardware Sentry Configuration"] = 666,
    Hayson = 259,
    ...
    ["JFrog File Spec"] = 283,
    ["JFrog Pipelines YML DSL"] = 675,
    ["JMeter DSL cli config schema"] = 284,
    JReleaser = 286,
    ["JSON Document Transform"] = 293,
    ["JSON Feed"] = 294,
    ["JSON Resume"] = 435,
    ["JSON Schema Draft 2020-12"] = 556,
    ["JSON Schema Draft 4"] = 553,
    ["JSON Schema Draft 7"] = 554,
    ["JSON Schema Draft 8"] = 555,
    ...
    ["KSP-CKAN"] = 552,
    Kas = 299,
    ["Keycloak REST API"] = 682,
    ["Knative Functions - func.yaml"] = 228,
    ["KoDE/CI build.yaml"] = 671,
    ["Kong DBLess Schema"] = 672,
    KrakenD = 300,
    LOOBin = 315,
    ["LinkML Metamodel"] = 313,
    Liquibase = 621,
    ["Liquibase Flow File"] = 622,
    ["Lively Properties"] = 314,
    Markdownlint = 625,
    ["Mason Registry"] = 627,
    ["MegaLinter configuration"] = 321,
    ["MegaLinter descriptor"] = 322,
    ["Meltano plugin discovery definition"] = 324,
    ["Meltano project definition"] = 323,
    ["Microsoft Band Web Tile"] = 325,
    ["Minecraft Data Pack Advancement"] = 327,
    ["Minecraft Data Pack Biome"] = 328,
    ["Minecraft Data Pack Configured Carver"] = 329,
    ["Minecraft Data Pack Damage Type"] = 330,
    ["Minecraft Data Pack Dimension"] = 332,
    ["Minecraft Data Pack Dimension Type"] = 331,
    ["Minecraft Data Pack Item Modifier"] = 333,
    ["Minecraft Data Pack Loot Table"] = 334,
    ["Minecraft Data Pack Metadata"] = 335,
    ["Minecraft Data Pack Predicate"] = 336,
    ["Minecraft Data Pack Recipe"] = 337,
    ["Minecraft Data Pack Tag"] = 338,
    ["Minecraft Data Pack Template Pool"] = 339,
    ["Minecraft Data Pack Trim Material"] = 344,
    ["Minecraft Data Pack Trim Pattern"] = 345,
    ["Minecraft Resource Pack Lang"] = 340,
    ["Minecraft Resource Pack Particle"] = 341,
    ["Minecraft Resource Pack Texture Mcmeta"] = 343,
    ["Minecraft Resourcepack Sounds"] = 342,
    ["MkDocs Configuration 1.0"] = 346,
    ["MongoDB Atlas Search Index Definition Schema"] = 670,
    ["Monika Configuration Schema"] = 668,
    ["Motif config"] = 573,
    ["NOX Framework (Service)"] = 360,
    ["Netin Diagnostic System Template"] = 631,
    ["Netlify config schema"] = 351,
    ["Nexus-as-Code schema"] = 352,
    ["Nightwatch.js"] = 353,
    ["ONe's service descriptor"] = 372,
    ["OSS Review Toolkit configuration"] = 379,
    ["OSS Review Toolkit curation"] = 380,
    ["OSS Review Toolkit package configuration"] = 381,
    ["OSS Review Toolkit repository configuration"] = 382,
    ["OSS Review Toolkit resolutions"] = 383,
    Opctl = 576,
    ["OpenRewrite Resource"] = 374,
    ["OpenWeather Current Weather API"] = 613,
    ["OpenWeather Road Risk API"] = 612,
    ["Ory Hydra configuration"] = 265,
    ["Ory Keto configuration"] = 302,
    ["Ory Kratos configuration"] = 378,
    ["Ory Oathkeeper configuration"] = 367,
    ["Outblocks App configuration"] = 376,
    ["Outblocks database table"] = 377,
    ["Outblocks project configuration"] = 375,
    Packer = 386,
    Pantsbuild = 689,
    ["Paper paper-plugin.yml"] = 387,
    ["Pipeline component"] = 623,
    ["PocketMine plugin.yml"] = 391,
    ["Postman collection"] = 396,
    Pterodactyl = 665,
    ["Pull Request Labeler"] = 417,
    Pulumi = 422,
    PyProject = 423,
    Pyright = 424,
    Qodana = 641,
    ["Quali Torque Blueprint Spec 2"] = 663,
    ["QueryFirst config file"] = 685,
    ["RKE Cluster Configuration JSON Schema"] = 620,
    ["RKE Cluster Configuration YAML Schema"] = 619,
    ["Rancher Fleet"] = 420,
    Ray = 588,
    ["Read the Docs"] = 421,
    ["Red-DiscordBot Cog"] = 425,
    ["Red-DiscordBot Cog Repo"] = 426,
    ["Red-DiscordBot Trivia"] = 427,
    Renovate = 436,
    ["Replit schema"] = 430,
    RoadRunner = 437,
    Ruff = 433,
    ["Rust Project"] = 434,
    ["Rust toolchain"] = 439,
    ["SIL Kit Participant Configuration"] = 468,
    ["SIL Kit Registry Configuration"] = 469,
    SWADL = 491,
    ["Safebox Config Schema"] = 676,
    ["Sapphire CLI Config"] = 442,
    ["SauceCTL Configuration"] = 628,
    ["Schema Catalog"] = 455,
    ["Scoop manifest"] = 460,
    ["Semantic Data Fabric (SDF) file"] = 461,
    ["Semgrep Rule"] = 463,
    ["Serenity Code Generator (Sergen)"] = 464,
    ["Serverless Framework Configuration"] = 635,
    ["Serverless Workflow Schema"] = 637,
    ["Settings.paf"] = 466,
    ["Shopware 6 Configuration"] = 638,
    ["Shopware CLI Extension Store Configuration"] = 639,
    ["Shopware CLI Project Store Configuration"] = 640,
    ["Slack app manifest"] = 471,
    Solidarity = 474,
    ["Solution filters"] = 475,
    ["Source Maps v3"] = 476,
    Sourcery = 477,
    SpecIF = 478,
    ["Sponge Mixin configuration"] = 479,
    ["StackHawk Scanner Configuration"] = 634,
    Stale = 483,
    Starship = 484,
    ["Statamic Blueprint"] = 485,
    ["StrmPrivacy Data Connector"] = 680,
    ["StrmPrivacy Data Contract"] = 681,
    ["StrmPrivacy SimpleSchema"] = 678,
    ["StrmPrivacy Stream"] = 679,
    ["StrmPrivacy batch job configuration file"] = 677,
    ["Stryker Mutator"] = 488,
    ["StyleCop Analyzers Configuration"] = 489,
    ["Swagger API 2.0"] = 492,
    TSON = 516,
    ["Talisman configuration"] = 494,
    ["Taskfile YAML Schema"] = 615,
    Taurus = 495,
    ["TestEnvironment.json"] = 504,
    ["Tier.run pricing.json"] = 498,
    Tikibase = 499,
    ["Traefik v2"] = 507,
    ["Traefik v2 File Provider"] = 508,
    Turborepo = 505,
    Tye = 642,
    ["UET BuildConfig.json"] = 686,
    ["UI5 Manifest"] = 523,
    ["UTAM Page Object"] = 526,
    ["Ubuntu Server Autoinstall"] = 521,
    ["Uniswap Token List"] = 598,
    ["Unreal Engine Uplugin"] = 687,
    ["Unreal Engine Uproject"] = 688,
    Updatecli = 649,
    Uplift = 684,
    ["User Journey Map YAML Schema"] = 618,
    V2Ray = 653,
    ["VSCode Code Snippets"] = 137,
    ["VSIX CLI publishing"] = 539,
    ["Vela Pipeline Configuration"] = 529,
    Vercel = 136,
    ["Web App Manifest"] = 546,
    ["Web types"] = 549,
    WebExtensions = 545,
    ["Webman package recipe"] = 659,
    ["Windows Package Manager Installer Manifest"] = 595,
    ["Windows Package Manager Locale Manifest"] = 596,
    ["Windows Package Manager Singleton Manifest"] = 594,
    ["Woodpecker pipeline config"] = 630,
    ["Xstate Machine Schema"] = 647,
    ["Yippee-Ki-JSON configuration YML"] = 600,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 65,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 695,
    ["bashly-strings.yml"] = 696,
    ["bashly.yml"] = 694,
    ["batect.yml"] = 64,
    ["beau.yml"] = 608,
    ...
    ["ize.toml"] = 683,
    ["jsconfig.json"] = 297,
    ["jscpd Configuration Schema"] = 664,
    jsdoc = 587,
    ["k3d.yaml"] = 298,
    ...
    ["lgtm.yml"] = 309,
    ["libman.json"] = 310,
    ["license-report-config.json"] = 311,
    ["linkinator.config.json"] = 312,
    ["local.settings.json"] = 317,
    ["localazy.json"] = 318,
    ["lotus.yaml"] = 316,
    ["lsdlschema.json"] = 319,
    ["madness.yml"] = 693,
    ["markdown-lint-check"] = 626,
    mboats = 633,
    ["micro-settings.json"] = 697,
    ["mimetypes.json"] = 326,
    ["mirrord-schema"] = 570,
    ["mta.yaml"] = 571,
    ["mtad.yaml"] = 572,
    ["mycode.json"] = 349,
    ["napari plugin manifest"] = 350,
    neoload = 582,
    ["nest-cli"] = 356,
    ["ninjs (News in JSON) 1.3"] = 355,
    ["ninjs (News in JSON) 2.0"] = 354,
    ["nlu.json"] = 357,
    ["nodemon.json"] = 359,
    ["noodl.schema.json"] = 632,
    now = 578,
    ["npm-badges"] = 362,
    ["nswag.json"] = 365,
    ntangle = 366,
    ["nuclei-template.yaml"] = 363,
    ["nuget-project.json"] = 364,
    ["ocelot.json"] = 368,
    ["omnisharp.json"] = 369,
    ["openapi.json"] = 370,
    ["openfin.json"] = 373,
    ["openrpc.json"] = 371,
    ["package.json"] = 384,
    ["package.manifest"] = 385,
    ["pattern.json"] = 389,
    ["petstore-v1.0"] = 674,
    pgap_yaml_input_reader = 388,
    ["plagiarize-me.yaml"] = 393,
    ["plagiarize.yaml"] = 392,
    ["portman.json"] = 394,
    ["prettierrc.json"] = 401,
    ["prisma.yml"] = 402,
    ["project-1.0.0-beta3.json"] = 404,
    ["project-1.0.0-beta4.json"] = 405,
    ["project-1.0.0-beta5.json"] = 406,
    ["project-1.0.0-beta6.json"] = 407,
    ["project-1.0.0-beta8.json"] = 408,
    ["project-1.0.0-rc1.json"] = 409,
    ["project-1.0.0-rc2.json"] = 410,
    ["project.json"] = 403,
    ["prometheus.json"] = 411,
    ["prometheus.rules.json"] = 412,
    ["prometheus.rules.test.json"] = 413,
    ["proxies.json"] = 414,
    ["publiccode.yml"] = 415,
    ["pubspec.yaml"] = 416,
    ["pyrseas-0.8.json"] = 419,
    ["quilt.mod.json"] = 698,
    ["release drafter"] = 583,
    rtx = 432,
    rustfmt = 438,
    samt = 440,
    samtrc = 441,
    ["sarif-1.0.0.json"] = 443,
    ["sarif-2.0.0.json"] = 444,
    ["sarif-2.1.0"] = 453,
    ["sarif-2.1.0-rtm.2"] = 445,
    ["sarif-2.1.0-rtm.3"] = 447,
    ["sarif-2.1.0-rtm.4"] = 449,
    ["sarif-2.1.0-rtm.5"] = 451,
    ["sarif-external-property-file-2.1.0"] = 454,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 446,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 448,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 450,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 452,
    ["schema.org - Action"] = 456,
    ["schema.org - ContactPoint"] = 457,
    ["schema.org - Place"] = 458,
    ["schema.org - Thing"] = 459,
    ["secrethub.yml"] = 700,
    ["semantic-release"] = 462,
    ["servicehub.config.json"] = 559,
    ["servicehub.service.json"] = 558,
    ["settings.job"] = 465,
    ["sfdx-hardis configuration"] = 467,
    ["size-limit configuration"] = 470,
    ["skaffold.yaml"] = 624,
    ["skyuxconfig.json"] = 472,
    snapcraft = 473,
    ["stripe-app-local.json"] = 487,
    ["stripe-app.json"] = 486,
    swcrc = 611,
    ["task.json"] = 493,
    taskcat = 579,
    ["template.json"] = 496,
    ["templatsources.json"] = 497,
    ["theme.json"] = 500,
    ["tizen_workspace.json"] = 501,
    tldr = 502,
    tmLanguage = 503,
    tmuxinator = 567,
    ["transcend.yml"] = 509,
    ["trunk.yaml schema"] = 510,
    ["ts-force-config.json"] = 514,
    ["tsconfig.json"] = 511,
    ["tsd.json"] = 512,
    ["tsdrc.json"] = 513,
    ["tslint.json"] = 515,
    ...
    ["vega-lite.json"] = 528,
    ["vega.json"] = 527,
    ["venvironment-basic.yaml"] = 531,
    ["venvironment.yaml"] = 530,
    ["version.json"] = 532,
    ["vim-addon-info"] = 533,
    ["vs-2017.3.host.json"] = 535,
    ["vs-nesting.json"] = 536,
    ["vsls.json"] = 534,
    ["vss-extension.json"] = 540,
    ["vtesttree.yaml"] = 541,
    ["vtestunit.yaml"] = 542,
    ["webhint.io"] = 660,
    ["webjobpublishsettings.json"] = 548,
    ["webjobs-list.json"] = 547,
    ["xs-app.json"] = 575,
    ["xunit.runner.json"] = 557,
    yamllint = 599,
    zuul = 584,
    ["Žinoma"] = 593
  },
