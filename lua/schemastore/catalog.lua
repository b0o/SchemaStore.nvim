...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 196,
    [".cryproj (generic)"] = 661,
    [".cryproj engine-5.2"] = 656,
    [".cryproj engine-5.3"] = 657,
    [".cryproj engine-5.4"] = 658,
    [".cryproj engine-5.5"] = 659,
    [".cryproj engine-dev"] = 660,
    [".eslintrc"] = 252,
    [".esmrc.json"] = 244,
    [".ffizer.yaml"] = 256,
    [".htmlhintrc"] = 312,
    ...
    [".mtaext"] = 672,
    [".nodehawkrc"] = 422,
    [".npmpackagejsonlintrc"] = 426,
    [".omletrc"] = 847,
    [".phrase.yml"] = 472,
    [".phraseapp.yml"] = 473,
    [".pmbot.yml"] = 462,
    [".postcssrc"] = 467,
    [".powerpages-web-template-manifest"] = 469,
    [".pre-commit-config.yml"] = 470,
    [".pre-commit-hooks.yml"] = 471,
    [".putout.json"] = 492,
    [".rehyperc"] = 505,
    [".remarkrc"] = 507,
    [".sprite files"] = 565,
    ...
    ["<div>RIOTS' studio configuration"] = 639,
    ["@factorial/drupal-breakpoints-css"] = 5,
    ["A micro editor config"] = 376,
    AIConfig = 12,
    ["API Builder"] = 704,
    ["AVA Configuration"] = 764,
    ["AWS CDK cdk.json"] = 180,
    ["AWS CloudFormation"] = 181,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 182,
    ["AWS SAM CLI Samconfig"] = 183,
    ["Adobe UXP Manifest"] = 829,
    ["Aerleon Network & Service Definitions"] = 8,
    ["Aerleon Policy"] = 9,
    ["Airlock Microgateway"] = 13,
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 736,
    ["All Contributors configuration file"] = 794,
    ...
    ["Azure Pipelines"] = 66,
    ["Azure Static Web Apps CLI configuration file"] = 568,
    ["Azure Static Web Apps configuration file"] = 567,
    ["BX CI"] = 104,
    ["Bashly (bashly.yml)"] = 798,
    ["Bashly Settings (bashly-settings.yml)"] = 799,
    ["Better Code Hub"] = 708,
    ["Better Scripts"] = 105,
    Bigconfig = 83,
    BizTalkServerApplicationSchema = 678,
    Bleep = 106,
    ...
    ["Butane Config"] = 749,
    ["CGS Custom Card Game (CardGameDef.json)"] = 834,
    ["CICS TS region tagging"] = 758,
    ["CICS TS resource import"] = 759,
    ["CICS TS resource model"] = 760,
    ["CICS TS resource overrides"] = 761,
    ["CMake Presets"] = 107,
    ["CNC Codes"] = 119,
    ["CSS Comb (.csscomb.json)"] = 198,
    ["CSS Lint (.csslintrc)"] = 199,
    ["CSpell (cspell.json)"] = 197,
    CWL = 840,
    ...
    ["CodeShip Pro steps configuration files"] = 163,
    ["Codecov configuration files"] = 161,
    Codux = 159,
    ["Cog config file"] = 120,
    ["Commandbox Box.json"] = 121,
    ["Commandbox Server.json"] = 122,
    ["Common Catalog Data"] = 171,
    Conjure = 118,
    ["Container Structure Test"] = 691,
    Containerlab = 716,
    ["Crowdsec collection config"] = 192,
    ["Crowdsec parser config"] = 193,
    ["Crowdsec scenario config"] = 194,
    ["CumulusCI Config"] = 123,
    ["Custom Machinery Machine"] = 835,
    ["Custom Machinery Recipe"] = 836,
    ["Cycle Stack File"] = 125,
    ["DWP Exchange - catalogue entry"] = 239,
    ["DWP Exchange - gateway"] = 237,
    ["DWP Exchange - meta"] = 238,
    ["Dart Build Config (dart-build.json)"] = 200,
    ["Dart Test Config (dart-test.json)"] = 201,
    ["DashLord Configuration"] = 202,
    ["Data Contract Specification"] = 203,
    ["Data Product Specification"] = 204,
    ["DataYoga Connections"] = 126,
    ["DataYoga Job"] = 127,
    ["Databricks Asset Bundles"] = 815,
    ["Datadog Service Definition"] = 353,
    ["Datahub Ingestion Recipe"] = 765,
    ["Dein Config"] = 129,
    ["Deno Config (deno.json)"] = 210,
    ["Dependency cruiser"] = 130,
    ["Deployer Recipe"] = 213,
    ["Deta Spacefile"] = 131,
    ["Detekt Config (detekt.yml)"] = 214,
    ["Devbox Config"] = 132,
    ["Devbox Plugin"] = 133,
    Devfile = 236,
    ["Discord Webhook"] = 215,
    ["DocFx Config (docfx.json)"] = 218,
    ["Dolittle Artifacts"] = 219,
    ["Dolittle Bounded Context Configuration"] = 220,
    ["Dolittle Event Horizons Configuration"] = 221,
    ["Dolittle Resources Configuration"] = 222,
    ["Dolittle Server Configuration"] = 223,
    ["Dolittle Tenant Map Configuration"] = 225,
    ["Dolittle Tenants Configuration"] = 224,
    ["Dolittle Topology"] = 226,
    ["Drupal Breakpoints"] = 134,
    ["Drupal Config"] = 145,
    ["Drupal Info"] = 135,
    ["Drupal Layouts"] = 136,
    ["Drupal Libraries"] = 137,
    ["Drupal Links Action"] = 138,
    ["Drupal Links Contextual"] = 139,
    ["Drupal Links Menu"] = 140,
    ["Drupal Links Task"] = 141,
    ["Drupal Migration"] = 142,
    ["Drupal Permissions"] = 143,
    ["Drupal Routing"] = 144,
    ["Drupal Services"] = 146,
    ["Drush site aliases"] = 232,
    ["Dynamic Bash Aliases (.aliases)"] = 806,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 795,
    ["Elgato Stream Deck"] = 242,
    ["Embrace Config"] = 776,
    Endurica = 819,
    ["Enterprise Contract Policy Spec"] = 243,
    ["Erda Pipeline"] = 842,
    ["Erda Runtime"] = 843,
    ["Error pages"] = 247,
    Esquio = 245,
    ["Estuary Flow Catalog"] = 755,
    ["Expo SDK"] = 250,
    ["F-Droid Data metadata"] = 255,
    ["Facets - FSDL - Application"] = 253,
    ["FasterCI Configuration"] = 67,
    FiQuS = 259,
    Firebase = 257,
    ["Flow.json Configurations"] = 839,
    ["Fossa configuration file"] = 266,
    ["Fossa's fossa-deps file"] = 267,
    ["Foundry VTT - Base package Manifest"] = 261,
    ["Foundry VTT - Module Manifest"] = 262,
    ["Foundry VTT - System Data Template"] = 265,
    ["Foundry VTT - System Manifest"] = 263,
    ["Foundry VTT - World Manifest"] = 264,
    ["Foxx Manifest"] = 68,
    ["Freifunk.de Community API"] = 71,
    ["Frogbot Config"] = 72,
    ["G2P Mapping Configuration"] = 271,
    ["GCP Blueprint Metadata"] = 274,
    Gaspar = 272,
    ["GatewayCore API Gateway"] = 273,
    ["GeoJSON.json latest"] = 753,
    GherKing = 757,
    ["GitHub Action"] = 279,
    ["GitHub Discussion"] = 280,
    ["GitHub Funding"] = 281,
    ["GitHub Issue Template configuration"] = 283,
    ["GitHub Issue Template forms"] = 282,
    ["GitHub Workflow"] = 284,
    ["GitHub Workflow Template Properties"] = 285,
    ["GitLab Agent for Kubernetes configuration"] = 831,
    GitVersion = 276,
    ["Gitea Issue Template configuration"] = 277,
    ["Gitea Issue Template forms"] = 278,
    ["Gitpod Configuration"] = 287,
    ["GlazeWM settings"] = 833,
    ["Global Privacy Control"] = 275,
    Goblet = 814,
    ["Golangci-lint Configuration"] = 289,
    ["Golangci-lint Custom Plugins Configuration"] = 290,
    ["Google Chrome Related Website Sets"] = 258,
    ["Google Cloud Workflows"] = 179,
    Goreleaser = 292,
    ["Goreleaser Pro"] = 293,
    Goss = 294,
    ["Gradle Build Cache Node"] = 706,
    ["Gradle Enterprise"] = 705,
    ["Grafana 5.x Dashboard"] = 295,
    ["GraphQL Code Generator"] = 299,
    ["GraphQL Config"] = 298,
    ["GraphQL Mesh"] = 297,
    ["Grunt JSHint task"] = 303,
    ["Grunt Watch task"] = 304,
    ["Grunt base task"] = 305,
    ["Grunt clean task"] = 301,
    ["Grunt copy task"] = 300,
    ["Grunt cssmin task"] = 302,
    HEMTT = 675,
    Hadolint = 687,
    Hammerkit = 715,
    ["Hardware Sentry Configuration"] = 769,
    Hatch = 688,
    Hayson = 307,
    ["Haystack Pipeline"] = 308,
    ["Hazelcast 5 Configuration"] = 309,
    ["Helm Chart.lock"] = 148,
    ["Helm Chart.yaml"] = 147,
    ["Helm Unittest Test Suite"] = 149,
    Hugo = 745,
    ["Hugo Theme"] = 744,
    ["IBM Zapp document"] = 314,
    ["IBM zCodeFormatSettings"] = 315,
    ["IMG Catapult PSP"] = 320,
    ["IVMS101 by CODE Protocol"] = 832,
    Istanbul = 772,
    ["JDownloader2 crawler multi-rules"] = 330,
    ["JDownloader2 crawler single-rules"] = 329,
    ["JFrog Applications Config"] = 331,
    ["JFrog File Spec"] = 332,
    ["JFrog Pipelines YML DSL"] = 778,
    ["JMeter DSL cli config"] = 333,
    JReleaser = 335,
    ["JSON Document Transform"] = 343,
    ["JSON Feed"] = 344,
    ["JSON Resume"] = 512,
    ["JSON Schema Draft 2020-12"] = 652,
    ["JSON Schema Draft 4"] = 649,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 816,
    ["JSON Schema Draft 7"] = 650,
    ["JSON Schema Draft 7 (unofficial strict)"] = 817,
    ["JSON Schema Draft 8 (2019-09)"] = 651,
    ["JSON-API"] = 342,
    ["JSON-WF"] = 845,
    ["JSON-e templates"] = 713,
    ["JSON-stat 2.0"] = 646,
    JSONPatch = 346,
    ["JSR Package Config (jsr.json)"] = 336,
    Jasmine = 325,
    Jekyll = 326,
    ["Jenkins X Pipelines"] = 327,
    ["Jenkins X Requirements"] = 328,
    ["Jovo Language Models"] = 334,
    ["KIMMDY config file"] = 351,
    ["KSP-AVC"] = 647,
    ["KSP-CKAN"] = 648,
    KSY = 844,
    ["Karakum configuration file"] = 268,
    Kas = 349,
    ["Keycloak REST API"] = 786,
    ["Knative Functions - func.yaml"] = 269,
    ["KoDE/CI build.yaml"] = 774,
    ["Kong DBLess config"] = 775,
    KrakenD = 352,
    LOOBin = 371,
    Lefthook = 360,
    ["Liferay client-extension.yaml"] = 367,
    ["LinkML Metamodel"] = 369,
    Liquibase = 721,
    ["Liquibase Flow File"] = 722,
    ["Lively Properties"] = 370,
    ["Lobe AI Agent"] = 64,
    Loki = 65,
    ["MLOS Configs"] = 405,
    ["MS2Rescore Configuration"] = 408,
    ["Madness (madness.yml)"] = 797,
    Markdownlint = 725,
    ["Mason Registry"] = 727,
    ["MegaLinter configuration"] = 377,
    ["MegaLinter descriptor"] = 378,
    Melange = 823,
    ["Meltano plugin discovery definition"] = 380,
    ["Meltano project definition"] = 379,
    ["Mergify Configuration"] = 409,
    ["MetricsHub Configuration"] = 381,
    ["MetricsHub Connector Configuration"] = 382,
    ["Micro Editor Syntax"] = 807,
    ["Microsoft Band Web Tile"] = 383,
    ["Minecraft Custom Main Menu Mod"] = 824,
    ["Minecraft Data Pack Advancement"] = 385,
    ["Minecraft Data Pack Biome"] = 386,
    ["Minecraft Data Pack Configured Carver"] = 387,
    ["Minecraft Data Pack Damage Type"] = 388,
    ["Minecraft Data Pack Dimension"] = 390,
    ["Minecraft Data Pack Dimension Type"] = 389,
    ["Minecraft Data Pack Item Modifier"] = 391,
    ["Minecraft Data Pack Loot Table"] = 392,
    ["Minecraft Data Pack Metadata"] = 393,
    ["Minecraft Data Pack Predicate"] = 394,
    ["Minecraft Data Pack Recipe"] = 395,
    ["Minecraft Data Pack Tag"] = 396,
    ["Minecraft Data Pack Template Pool"] = 397,
    ["Minecraft Data Pack Trim Material"] = 402,
    ["Minecraft Data Pack Trim Pattern"] = 403,
    ["Minecraft Resource Pack Lang"] = 398,
    ["Minecraft Resource Pack Particle"] = 399,
    ["Minecraft Resource Pack Texture Mcmeta"] = 401,
    ["Minecraft Resourcepack Sounds"] = 400,
    ["MkDocs Configuration 1.0"] = 404,
    ["Monade CLI Stack Configuration"] = 412,
    ["MongoDB Atlas Search Index Definition"] = 773,
    ["Monika Configuration"] = 771,
    ["Monoweave Configuration"] = 407,
    ["Motif config"] = 671,
    ["NOX Framework (Service)"] = 425,
    ["Netin Diagnostic System Template"] = 731,
    ["Netlify config"] = 415,
    ["Network-as-Code Data Model"] = 416,
    ["Nightwatch.js"] = 417,
    ["Nuitka.yaml"] = 837,
    ["ONe's changelog entry"] = 441,
    ["ONe's service descriptor"] = 440,
    ["OSS Review Toolkit configuration"] = 448,
    ["OSS Review Toolkit curation"] = 449,
    ["OSS Review Toolkit package configuration"] = 450,
    ["OSS Review Toolkit repository configuration"] = 451,
    ["OSS Review Toolkit resolutions"] = 452,
    Opctl = 674,
    ["OpenRewrite Resource"] = 443,
    ["OpenUtau character yaml"] = 437,
    ["OpenUtau ustx"] = 438,
    ["OpenWeather Current Weather API"] = 712,
    ["OpenWeather Road Risk API"] = 711,
    ["Ory Hydra configuration"] = 313,
    ["Ory Keto configuration"] = 354,
    ["Ory Kratos configuration"] = 447,
    ["Ory Oathkeeper configuration"] = 432,
    ["Outblocks App configuration"] = 445,
    ["Outblocks database table"] = 446,
    ["Outblocks project configuration"] = 444,
    PDM = 458,
    Packer = 455,
    Pantsbuild = 793,
    ["Paper paper-plugin.yml"] = 456,
    ["Pipeline component"] = 723,
    ["PocketMine plugin.yml"] = 463,
    ["Postman collection"] = 468,
    ["Problem object RFC9457"] = 821,
    ["Problem package generators"] = 476,
    Pterodactyl = 768,
    ["Pull Request Labeler"] = 491,
    Pulumi = 497,
    PyProject = 498,
    Pyright = 499,
    Qgoda = 500,
    Qodana = 741,
    ["Quali Torque Blueprint Spec 2"] = 766,
    ["QueryFirst config file"] = 789,
    ["RKE Cluster Configuration JSON"] = 720,
    ["RKE Cluster Configuration YAML"] = 719,
    ["Rancher Fleet"] = 494,
    ["Rattler-build"] = 501,
    Ray = 686,
    ["Read the Docs"] = 496,
    ["Red-DiscordBot Cog"] = 502,
    ["Red-DiscordBot Cog Repo"] = 503,
    ["Red-DiscordBot Trivia"] = 504,
    ["Render Blueprints"] = 718,
    RenderCV = 514,
    Renovate = 513,
    ["Replit config"] = 508,
    RoadRunner = 515,
    ["Rudder techniques"] = 827,
    Ruff = 510,
    ["Rust Project"] = 511,
    ["Rust toolchain"] = 518,
    ["SDMX data message"] = 543,
    ["SDMX metadata message"] = 542,
    ["SDMX structure message"] = 541,
    ["SIL Kit Participant Configuration"] = 553,
    ["SIL Kit Registry Configuration"] = 554,
    SWADL = 579,
    ["Safebox Config"] = 779,
    ["Sapphire CLI Config"] = 521,
    ["SauceCTL Configuration"] = 728,
    ["Schema Catalog"] = 535,
    ["Scoop manifest"] = 540,
    ["Semantic Data Fabric (SDF) file"] = 544,
    ["Semgrep Rule"] = 546,
    ["Serenity Code Generator (Sergen)"] = 547,
    ["Serverless Framework Configuration"] = 735,
    ["Serverless Workflow"] = 737,
    ["Settings.paf"] = 549,
    ["Shopware 6 Configuration"] = 738,
    ["Shopware CLI Extension Store Configuration"] = 739,
    ["Shopware CLI Project Store Configuration"] = 740,
    Sigma = 551,
    ["Sigrid scope configuration file"] = 552,
    ["SkyPilot Task JSON"] = 828,
    ["Slack app manifest"] = 556,
    Solidarity = 559,
    ["Solution filters"] = 560,
    ["Source Maps v3"] = 561,
    Sourcery = 562,
    SpecIF = 563,
    ["Sponge Mixin configuration"] = 564,
    StackBlitz = 569,
    ["StackHawk Scanner Configuration"] = 734,
    Stale = 570,
    ["Starlake Data Pipeline"] = 709,
    Starship = 571,
    ["Statamic Blueprint"] = 572,
    ["Stella configuration file"] = 573,
    ["StrmPrivacy Data Connector"] = 783,
    ["StrmPrivacy Data Contract"] = 784,
    ["StrmPrivacy SimpleSchema"] = 781,
    ["StrmPrivacy Stream"] = 782,
    ["StrmPrivacy batch job configuration file"] = 780,
    ["Stryker Mutator"] = 576,
    ["StyleCop Analyzers Configuration"] = 577,
    ["Stylelint (.stylelintrc)"] = 578,
    ["Sublime Syntax"] = 785,
    ["Subsquid squid manifest"] = 830,
    ["Swagger API 2.0"] = 580,
    TSON = 606,
    TSTyche = 607,
    Talhelper = 582,
    ["Talisman configuration"] = 583,
    ["Taskfile config"] = 714,
    Taurus = 584,
    ["TestEnvironment.json"] = 593,
    ["TextMate Grammar"] = 592,
    ["Tier.run pricing.json"] = 587,
    Tikibase = 588,
    ["Traefik v2"] = 596,
    ["Traefik v2 File Provider"] = 597,
    ["Travis CI (.travis.yml)"] = 595,
    TunnelHub = 820,
    Turborepo = 594,
    Tye = 742,
    ["UET BuildConfig.json"] = 790,
    ["UI5 Manifest"] = 616,
    ["UNCORS configuration"] = 620,
    ["UTAM Page Object"] = 619,
    ["Ubuntu Server Autoinstall"] = 614,
    ["Uniswap Token List"] = 697,
    ["Unreal Engine Uplugin"] = 791,
    ["Unreal Engine Uproject"] = 792,
    ["Updatecli Compose"] = 750,
    ["Updatecli Policy Manifest"] = 751,
    ["Updatecli Policy Metadata"] = 752,
    Uplift = 788,
    ["User Journey Map"] = 717,
    V2Ray = 756,
    ["VSCode Code Snippets"] = 167,
    ["VSIX CLI publishing"] = 634,
    ["Vela Pipeline Configuration"] = 623,
    Vercel = 166,
    Visivo = 818,
    ["Web App Manifest"] = 641,
    ["Web types"] = 644,
    WebExtensions = 640,
    ["Webman package recipe"] = 762,
    ["Windows Package Manager Installer Manifest"] = 694,
    ["Windows Package Manager Locale Manifest"] = 695,
    ["Windows Package Manager Singleton Manifest"] = 693,
    ["Woodpecker pipeline config"] = 730,
    ["Wrangler CLI"] = 645,
    ["Xstate Machine"] = 748,
    ["Yarn Config (.yarnrc.yml)"] = 707,
    ["Yippee-Ki-JSON configuration YML"] = 699,
    ["aerleon.yml"] = 7,
    ["angular.json"] = 15,
    apko = 822,
    ...
    ["behat.yml"] = 90,
    ["bigquery-table"] = 82,
    ["bioimageio resource description"] = 838,
    ...
    ["chisel-slices.json"] = 184,
    ["chrome-extension-locales-messages.json"] = 174,
    ["chutzpah.json"] = 175,
    cibuildwheel = 115,
    ["clang-format (.clang-format)"] = 754,
    clangd = 154,
    clib = 155,
    ["cloud-init: cloud-config userdata"] = 157,
    ["cloud-sdk-pipeline-configuration"] = 177,
    ["cloudbuild.json"] = 178,
    cloudify = 156,
    codemagic = 158,
    ["coffeelint.json"] = 186,
    ["commands.json"] = 170,
    ["commitlint (.commitlintrc)"] = 696,
    ["compile_commands.json"] = 169,
    ["compilerconfig.json"] = 168,
    ["completely.yml"] = 796,
    ["component-detection-manifest.json"] = 189,
    ["component.json"] = 188,
    ["composer.json"] = 187,
    ["conda-forge"] = 117,
    ["config.yaml"] = 495,
    ["contentmanifest.json"] = 176,
    ["contribute.json"] = 190,
    ["cosmos.config.json"] = 172,
    ["crowdin.yml"] = 191,
    ["custom-elements.json"] = 810,
    ["cypress.json"] = 195,
    ["datalogic-scan2deploy-android"] = 205,
    ["datalogic-scan2deploy-ce"] = 206,
    ["dbt Project"] = 128,
    ["ddev-global"] = 207,
    ["ddev-project"] = 208,
    ["debugsettings.json"] = 209,
    ["dependabot-v2.json"] = 212,
    ["dependabot.json"] = 211,
    ["deployed-cli"] = 747,
    ["devcontainer.json"] = 160,
    devinit = 701,
    ["devspace.yaml"] = 770,
    djlint = 702,
    ["docker sequencer"] = 217,
    ["docker-compose.yml"] = 700,
    ["dockerd.json"] = 216,
    ["dotnet Release Index manifest"] = 227,
    ["dotnet-tools.json"] = 228,
    ["dotnetcli.host.json"] = 229,
    ["dprint.json"] = 230,
    ["drone.json"] = 231,
    ["dss-2.0.0.json"] = 233,
    ["dstack configuration"] = 234,
    ["dvc.yaml"] = 235,
    ["ecosystem.json"] = 240,
    eksctl = 241,
    ["electron-builder configuration file"] = 248,
    ["epr-manifest.json"] = 246,
    ["evcc.yaml"] = 249,
    ["ezd task runner"] = 251,
    ["fabric.mod.json"] = 254,
    ["first-timers-bot"] = 260,
    ...
    ["gitlab-ci"] = 286,
    ["global.json"] = 288,
    ["go-feature-flag Flag Configuration"] = 291,
    ["haxelib.json"] = 306,
    helmfile = 689,
    helmwave = 690,
    ["host-meta.json"] = 311,
    ...
    ["ide.host.json"] = 316,
    ["ifstate.conf"] = 317,
    ["imageoptimizer.json"] = 318,
    ["importmap.json"] = 321,
    ["ioBroker Configuration"] = 322,
    ["ioBroker JSON UI"] = 323,
    ["ioBroker Package manifest"] = 324,
    ["ize.toml"] = 787,
    ["jsconfig.json"] = 347,
    ["jscpd Configuration"] = 767,
    jsdoc = 685,
    ["k3d.yaml"] = 348,
    ["k9s plugin.yml"] = 350,
    ["kontinuous-config.yaml"] = 356,
    ["kontinuous-values.yaml"] = 355,
    ["kustomization.yaml"] = 357,
    ["label-commenter-config.yml"] = 358,
    ["latexindent configuration"] = 63,
    ["launchsettings.json"] = 359,
    lazydocker = 809,
    lazygit = 808,
    ["lego.json"] = 361,
    ["lerna.json"] = 362,
    ["lgtm.yml"] = 363,
    ["liblab.config.json"] = 364,
    ["libman.json"] = 365,
    ["license-report-config.json"] = 366,
    ["linkinator.config.json"] = 368,
    ["lint-staged (.lintstagedrc)"] = 665,
    ["local.settings.json"] = 373,
    ["localazy.json"] = 374,
    ["lotus.yaml"] = 372,
    ["lsdlschema.json"] = 375,
    ["markdown-link-check"] = 726,
    mboats = 733,
    ["micro-settings.json"] = 802,
    ["mimetypes.json"] = 384,
    ["mirrord config"] = 666,
    mise = 667,
    ["mise-settings"] = 668,
    ...
    ["mtad.yaml"] = 670,
    ["mycode.json"] = 413,
    ["napari plugin manifest"] = 414,
    neoload = 680,
    ["nest-cli"] = 420,
    ["ninjs (News in JSON) 1.3"] = 419,
    ["ninjs (News in JSON) 2.0"] = 418,
    ["nixd configuration"] = 826,
    ["nlu.json"] = 421,
    ["nodemon.json"] = 423,
    ["noodl config"] = 732,
    ["notebook.mod.json"] = 424,
    now = 676,
    ["npm-badges"] = 427,
    ["nswag.json"] = 430,
    ntangle = 431,
    ["nuclei-template.yaml"] = 428,
    ["nuget-project.json"] = 429,
    ["ocelot.json"] = 433,
    ["omnisharp.json"] = 434,
    ["openapi.json"] = 435,
    ["openfin.json"] = 442,
    ...
    ["ops.yaml"] = 439,
    ["package.json"] = 453,
    ["package.manifest"] = 454,
    ["partial-black.json"] = 91,
    ["pathfinder.yml"] = 457,
    ["pattern.json"] = 460,
    ["petstore-v1.0"] = 777,
    pgap_yaml_input_reader = 459,
    ["pixi.toml"] = 461,
    ["plagiarize-me.yaml"] = 465,
    ["plagiarize.yaml"] = 464,
    ["portman.json"] = 466,
    ["prettierrc.json"] = 474,
    ["prisma.yml"] = 475,
    ["project-1.0.0-beta3.json"] = 478,
    ["project-1.0.0-beta4.json"] = 479,
    ["project-1.0.0-beta5.json"] = 480,
    ["project-1.0.0-beta6.json"] = 481,
    ["project-1.0.0-beta8.json"] = 482,
    ["project-1.0.0-rc1.json"] = 483,
    ["project-1.0.0-rc2.json"] = 484,
    ["project.json"] = 477,
    ["prometheus.json"] = 485,
    ["prometheus.rules.json"] = 486,
    ["prometheus.rules.test.json"] = 487,
    ["proxies.json"] = 488,
    ["publiccode.yml"] = 489,
    ["pubspec.yaml"] = 490,
    ["pyrseas-0.8.json"] = 493,
    ["quilt.mod.json"] = 803,
    ["release drafter"] = 681,
    ["release-plz.toml"] = 506,
    ["rivet.yaml"] = 825,
    rockcraft = 516,
    rustfmt = 517,
    samt = 519,
    samtrc = 520,
    ["sarif-1.0.0.json"] = 522,
    ["sarif-2.0.0.json"] = 523,
    ["sarif-2.1.0"] = 533,
    ["sarif-2.1.0-rtm.2"] = 524,
    ["sarif-2.1.0-rtm.3"] = 526,
    ["sarif-2.1.0-rtm.4"] = 528,
    ["sarif-2.1.0-rtm.5"] = 530,
    ["sarif-2.1.0-rtm.6"] = 531,
    ["sarif-external-property-file-2.1.0"] = 534,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 525,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 527,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 529,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 532,
    ["schema.org - Action"] = 536,
    ["schema.org - ContactPoint"] = 537,
    ["schema.org - Place"] = 538,
    ["schema.org - Thing"] = 539,
    ["secrethub.yml"] = 805,
    ["semantic-release"] = 545,
    ["servicehub.config.json"] = 655,
    ["servicehub.service.json"] = 654,
    ["settings.job"] = 548,
    ["sfdx-hardis configuration"] = 550,
    ["shard.yml"] = 841,
    ["size-limit configuration"] = 555,
    ["skaffold.yaml"] = 724,
    ["skyuxconfig.json"] = 557,
    snapcraft = 558,
    ["sqlc configuration"] = 566,
    ["stripe-app-local.json"] = 575,
    ["stripe-app.json"] = 574,
    swcrc = 710,
    ["task.json"] = 581,
    taskcat = 677,
    ["template.json"] = 585,
    ["templatsources.json"] = 586,
    ["theme.json"] = 589,
    ["tizen_workspace.json"] = 590,
    tldr = 591,
    tmuxinator = 663,
    ["transcend.yml"] = 598,
    ["tree-sitter grammar.json"] = 296,
    ["trime.yaml"] = 599,
    ["trunk.yaml"] = 600,
    ["ts-force-config.json"] = 604,
    ["tsconfig.json"] = 601,
    ["tsd.json"] = 602,
    ["tsdrc.json"] = 603,
    ["tslint.json"] = 605,
    ...
    ["vega-lite.json"] = 622,
    ["vega.json"] = 621,
    ["venvironment-basic.yaml"] = 625,
    ["venvironment.yaml"] = 624,
    ["version.json"] = 626,
    ["vim-addon-info"] = 628,
    ["vs-2017.3.host.json"] = 630,
    ["vs-nesting.json"] = 631,
    ["vsls.json"] = 629,
    ["vss-extension.json"] = 635,
    ["vtesttree.yaml"] = 636,
    ["vtestunit.yaml"] = 637,
    ["warp-keysets.json"] = 811,
    ["warp-themes.json"] = 812,
    ["warp-workflows.json"] = 813,
    ["webhint.io"] = 763,
    ["webjobpublishsettings.json"] = 643,
    ["webjobs-list.json"] = 642,
    ["xs-app.json"] = 673,
    ["xunit.runner.json"] = 653,
    yamllint = 698,
    zuul = 682,
    ["Žinoma"] = 692
  },
