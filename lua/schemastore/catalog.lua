...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 101,
    [".cryproj (generic)"] = 400,
    [".cryproj engine-5.2"] = 395,
    [".cryproj engine-5.3"] = 396,
    [".cryproj engine-5.4"] = 397,
    [".cryproj engine-5.5"] = 398,
    [".cryproj engine-dev"] = 399,
    [".csscomb.json"] = 103,
    [".csslintrc"] = 104,
    [".eslintrc"] = 139,
    [".esmrc.json"] = 132,
    ...
    [".mtaext"] = 406,
    [".nodehawkrc"] = 245,
    [".npmpackagejsonlintrc"] = 247,
    [".phraseapp.yml"] = 274,
    [".pmbot.yml"] = 267,
    [".postcssrc"] = 272,
    [".pre-commit-config.yml"] = 273,
    [".putout.json"] = 291,
    [".rehyperc"] = 296,
    [".remarkrc"] = 297,
    [".sprite files"] = 332,
    ...
    [".vsext"] = 376,
    [".yarnrc.yml"] = 438,
    ["<div>RIOTS' studio configuration"] = 379,
    ["API Builder"] = 435,
    ["AWS CloudFormation"] = 91,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 92,
    ...
    ["Azure Pipelines"] = 36,
    ["Azure Static Web Apps CLI configuration file"] = 334,
    ["Azure Static Web Apps configuration file"] = 333,
    ["Better Code Hub"] = 440,
    BizTalkServerApplicationSchema = 412,
    Briefcase = 417,
    Buildkite = 57,
    ["Bukkit plugin.yml"] = 56,
    ["BungeeCord plugin.yml"] = 60,
    ["CMake Presets"] = 62,
    ["CSR Framework"] = 67,
    ["Camel YAML DSL"] = 63,
    Carafe = 64,
    ["Catalog Info Backstage"] = 65,
    ["Chrome Extension"] = 85,
    ["CircleCI config.yml"] = 70,
    ["Citation File Format"] = 93,
    CityJSON = 66,
    ["Code Climate"] = 71,
    ["Container Structure Test"] = 423,
    Containerlab = 448,
    ["Dart build configuration"] = 105,
    ["Dart test config"] = 106,
    ["Deployer Recipe"] = 112,
    Devfile = 130,
    ["Discord Webhook"] = 114,
    ["Dolittle Artifacts"] = 116,
    ["Dolittle Bounded Context Configuration"] = 117,
    ["Dolittle Event Horizons Configuration"] = 118,
    ["Dolittle Resources Configuration"] = 119,
    ["Dolittle Server Configuration"] = 120,
    ["Dolittle Tenant Map Configuration"] = 122,
    ["Dolittle Tenants Configuration"] = 121,
    ["Dolittle Topology"] = 123,
    ["Drush site aliases"] = 127,
    ["Error pages"] = 135,
    Esquio = 133,
    ["Expo SDK"] = 138,
    ["F-Droid Data metadata"] = 142,
    ["Facets - FSDL - Application"] = 140,
    ["Fossa configuration file"] = 147,
    ["Foundry VTT - Manifest"] = 145,
    ["Foundry VTT - Template"] = 146,
    ["Foxx Manifest"] = 37,
    ["GatewayCore API Gateway"] = 150,
    ["GitHub Action"] = 154,
    ["GitHub Funding"] = 155,
    ["GitHub Issue Template configuration"] = 157,
    ["GitHub Workflow"] = 158,
    ["GitHub Workflow Template Properties"] = 159,
    ["GitHub issue forms"] = 156,
    GitVersion = 153,
    ["Gitpod Configuration"] = 161,
    ["Global Privacy Control"] = 151,
    ["Google Cloud Workflows"] = 90,
    Goreleaser = 164,
    ["Goreleaser Pro"] = 165,
    ["Gradle Build Cache Node"] = 437,
    ["Gradle Enterprise"] = 436,
    ["Grafana 5.x Dashboard"] = 166,
    ["GraphQL Code Generator"] = 169,
    ["GraphQL Config"] = 168,
    ["GraphQL Mesh"] = 167,
    ["Grunt JSHint task"] = 173,
    ["Grunt Watch task"] = 174,
    ["Grunt base task"] = 175,
    ["Grunt clean task"] = 171,
    ["Grunt copy task"] = 170,
    ["Grunt cssmin task"] = 172,
    HEMTT = 409,
    Hadolint = 421,
    ["Hammerkit YAML Schema"] = 447,
    Hayson = 177,
    ["Haystack Pipeline"] = 178,
    ["Hazelcast 5 Configuration"] = 179,
    ["Helm Chart.lock"] = 69,
    ["Helm Chart.yaml"] = 68,
    ["JFrog File Spec"] = 192,
    ["JSON Document Transform"] = 200,
    ["JSON Feed"] = 201,
    ["JSON Resume"] = 299,
    ["JSON Schema Draft 2020-12"] = 391,
    ["JSON Schema Draft 4"] = 388,
    ["JSON Schema Draft 7"] = 389,
    ["JSON Schema Draft 8"] = 390,
    ["JSON schema for CodeShip Pro services configuration files"] = 77,
    ["JSON schema for CodeShip Pro steps configuration files"] = 78,
    ["JSON schema for Codecov configuration files"] = 76,
    ["JSON-API"] = 199,
    ["JSON-e templates"] = 445,
    ["JSON-stat 2.0"] = 385,
    JSONPatch = 203,
    ["Jekyll configuration"] = 189,
    ["Jenkins X Pipelines"] = 190,
    ["Jenkins X Requirements"] = 191,
    ["Jovo Language Models"] = 193,
    ["KSP-AVC"] = 386,
    ["KSP-CKAN"] = 387,
    Liquibase = 452,
    ["MegaLinter configuration"] = 217,
    ["MegaLinter descriptor"] = 218,
    ["Meltano plugin discovery definition"] = 220,
    ["Meltano project definition"] = 219,
    ["Microsoft Band Web Tile"] = 221,
    ["Minecraft Data Pack Advancement"] = 223,
    ["Minecraft Data Pack Biome"] = 224,
    ["Minecraft Data Pack Configured Carver"] = 225,
    ["Minecraft Data Pack Dimension"] = 227,
    ["Minecraft Data Pack Dimension Type"] = 226,
    ["Minecraft Data Pack Item Modifier"] = 228,
    ["Minecraft Data Pack Loot Table"] = 229,
    ["Minecraft Data Pack Metadata"] = 230,
    ["Minecraft Data Pack Predicate"] = 231,
    ["Minecraft Data Pack Recipe"] = 232,
    ["Minecraft Data Pack Template Pool"] = 233,
    ["Minecraft Resourcepack Sounds"] = 234,
    ["Netin Diagnostic System Template"] = 459,
    ["Netlify config schema"] = 239,
    ["Nightwatch.js"] = 240,
    ["OSS Review Toolkit repository configuration"] = 261,
    Opctl = 408,
    ["OpenWeather Current Weather API"] = 444,
    ["OpenWeather Road Risk API"] = 443,
    ["Ory Hydra configuration"] = 183,
    ["Ory Keto configuration"] = 206,
    ["Ory Kratos configuration"] = 260,
    ["Ory Oathkeeper configuration"] = 252,
    ["Outblocks App configuration"] = 258,
    ["Outblocks database table"] = 259,
    ["Outblocks project configuration"] = 257,
    Packer = 264,
    ["Pipeline component"] = 453,
    ["PocketMine plugin.yml"] = 268,
    ["Pull Request Labeler"] = 290,
    Qodana = 466,
    ["RKE Cluster Configuration JSON Schema"] = 451,
    ["RKE Cluster Configuration YAML Schema"] = 450,
    Ray = 420,
    ["Read the Docs"] = 293,
    ["Red-DiscordBot Cog"] = 294,
    ["Red-DiscordBot Cog Repo"] = 295,
    Renovate = 300,
    RoadRunner = 301,
    SWADL = 343,
    ["Sapphire CLI Config"] = 302,
    ["SauceCTL Configuration"] = 456,
    ["Schema Catalog"] = 315,
    ["Scoop manifest"] = 320,
    ["Semgrep Rule"] = 321,
    ["Serverless Framework Configuration"] = 463,
    ["Settings.paf"] = 323,
    ["Shopware CLI Extension Store Configuration"] = 464,
    ["Shopware CLI Project Store Configuration"] = 465,
    Solidarity = 328,
    ["Source Maps v3"] = 329,
    SpecIF = 330,
    ["Sponge Mixin configuration"] = 331,
    ["StackHawk Scanner Configuration"] = 462,
    ["StackHead CLI config"] = 335,
    ["StackHead module configuration"] = 336,
    ["StackHead project definition"] = 337,
    Stale = 338,
    ["Statamic Blueprint"] = 339,
    ["Stryker Mutator"] = 340,
    ["StyleCop Analyzers Configuration"] = 341,
    ["Swagger API 2.0"] = 344,
    ["Taskfile YAML Schema"] = 446,
    Taurus = 345,
    ["TestEnvironment.json"] = 350,
    ["Traefik v2"] = 352,
    ["Traefik v2 File Provider"] = 353,
    Tye = 467,
    ["UI5 Manifest"] = 365,
    ["Ubuntu Server Autoinstall"] = 363,
    ["Uniswap Token List"] = 429,
    ["User Journey Map YAML Schema"] = 449,
    ["VSCode Code Snippets"] = 80,
    ["VSIX CLI publishing"] = 377,
    ["Vela Pipeline Configuration"] = 369,
    Vercel = 79,
    ["Web App Manifest"] = 381,
    ["Web types"] = 384,
    WebExtensions = 380,
    ["Windows Package Manager Installer Manifest"] = 426,
    ["Windows Package Manager Locale Manifest"] = 427,
    ["Windows Package Manager Singleton Manifest"] = 425,
    ["Woodpecker pipeline config"] = 458,
    ["Yippee-Ki-JSON configuration YML"] = 431,
    ["angular.json"] = 6,
    ...
    bucklescript = 55,
    ["bundleconfig.json"] = 59,
    ["chutzpah.json"] = 86,
    ["cloud-sdk-pipeline-config-schema"] = 88,
    ["cloudbuild.json"] = 89,
    cloudify = 74,
    codemagic = 75,
    ["coffeelint.json"] = 94,
    comet = 441,
    ["commands.json"] = 83,
    ["compile_commands.json"] = 82,
    ["compilerconfig.json"] = 81,
    ["component.json"] = 96,
    ["composer.json"] = 95,
    ["config.json"] = 97,
    ["contentmanifest.json"] = 87,
    ["contribute.json"] = 98,
    ["cosmos.config.json"] = 84,
    ["crowdin.yml"] = 99,
    cspell = 102,
    ["cypress.json"] = 100,
    ["datalogic-scan2deploy-android"] = 107,
    ["datalogic-scan2deploy-ce"] = 108,
    ["debugsettings.json"] = 109,
    ["dependabot-v2.json"] = 111,
    ["dependabot.json"] = 110,
    ["detekt.yml"] = 113,
    devinit = 433,
    ["docfx.json"] = 115,
    ["docker-compose.yml"] = 432,
    ["dotnet Release Index manifest"] = 124,
    ["dotnetcli.host.json"] = 125,
    ["drone.json"] = 126,
    ["dss-2.0.0.json"] = 128,
    ["dvc.yaml"] = 129,
    ["ecosystem.json"] = 131,
    ["electron-builder configuration file."] = 136,
    ["epr-manifest.json"] = 134,
    ["evcc.yaml"] = 137,
    ["fabric.mod.json"] = 141,
    ["first-timers-bot"] = 144,
    fulibWorkflows = 457,
    ["func.yaml"] = 148,
    ["function.json"] = 149,
    ["geojson.json"] = 152,
    ["gitlab-ci"] = 160,
    ["global.json"] = 162,
    ["golangci-lint Configuration"] = 163,
    ["haxelib.json"] = 176,
    helmfile = 422,
    ["host-meta.json"] = 181,
    ["host.json"] = 180,
    ...
    httpmockrc = 413,
    huskyrc = 402,
    ["imageoptimizer.json"] = 184,
    ["importmap.json"] = 186,
    ["ioBroker JSON UI"] = 187,
    ["ioBroker Package manifest"] = 188,
    ["jsconfig.json"] = 204,
    jsdoc = 419,
    ["k3d.yaml"] = 205,
    ["kustomization.yaml"] = 207,
    ["label-commenter-config.yml"] = 208,
    ["launchsettings.json"] = 209,
    ["lerna.json"] = 210,
    ["lgtm.yml"] = 211,
    ["libman.json"] = 212,
    ["license-report-config.json"] = 213,
    ["local.settings.json"] = 214,
    ["localazy.json"] = 215,
    ["lsdlschema.json"] = 216,
    ["markdownlint.json"] = 455,
    mboats = 461,
    ["mimetypes.json"] = 222,
    ["mta.yaml"] = 404,
    ["mtad.yaml"] = 405,
    ["mycode.json"] = 237,
    ["napari plugin manifest"] = 238,
    neoload = 414,
    ["nest-cli"] = 243,
    ["ninjs (News in JSON) 1.3"] = 242,
    ["ninjs (News in JSON) 2.0"] = 241,
    ["nlu.json"] = 244,
    ["nodemon.json"] = 246,
    ["noodl.schema.json"] = 460,
    now = 410,
    ["nswag.json"] = 250,
    ntangle = 251,
    ["nuclei-template.yaml"] = 248,
    ["nuget-project.json"] = 249,
    ["ocelot.json"] = 253,
    ["omnisharp.json"] = 254,
    ["openapi.json"] = 255,
    ["openfin.json"] = 256,
    ["package.json"] = 262,
    ["package.manifest"] = 263,
    ["pattern.json"] = 266,
    pgap_yaml_input_reader = 265,
    ["plagiarize-me.yaml"] = 270,
    ["plagiarize.yaml"] = 269,
    ["portman.json"] = 271,
    ["prettierrc.json"] = 275,
    ["prisma.yml"] = 276,
    ["project-1.0.0-beta3.json"] = 278,
    ["project-1.0.0-beta4.json"] = 279,
    ["project-1.0.0-beta5.json"] = 280,
    ["project-1.0.0-beta6.json"] = 281,
    ["project-1.0.0-beta8.json"] = 282,
    ["project-1.0.0-rc1.json"] = 283,
    ["project-1.0.0-rc2.json"] = 284,
    ["project.json"] = 277,
    ["prometheus.json"] = 285,
    ["prometheus.rules.json"] = 286,
    ["proxies.json"] = 287,
    ["publiccode.yml"] = 288,
    ["pubspec.yaml"] = 289,
    ["pyrseas-0.8.json"] = 292,
    ["release drafter"] = 415,
    ["sarif-1.0.0.json"] = 303,
    ["sarif-2.0.0.json"] = 304,
    ["sarif-2.1.0"] = 313,
    ["sarif-2.1.0-rtm.2"] = 305,
    ["sarif-2.1.0-rtm.3"] = 307,
    ["sarif-2.1.0-rtm.4"] = 309,
    ["sarif-2.1.0-rtm.5"] = 311,
    ["sarif-external-property-file-2.1.0"] = 314,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 306,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 308,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 310,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 312,
    ["schema.org - Action"] = 316,
    ["schema.org - ContactPoint"] = 317,
    ["schema.org - Place"] = 318,
    ["schema.org - Thing"] = 319,
    ["servicehub.config.json"] = 394,
    ["servicehub.service.json"] = 393,
    ["settings.job"] = 322,
    ["sfdx-hardis configuration"] = 324,
    ["size-limit configuration"] = 325,
    ["skaffold.yaml"] = 454,
    ["skyuxconfig.json"] = 326,
    snapcraft = 327,
    swcrc = 442,
    taskcat = 411,
    ["template.json"] = 346,
    ["templatsources.json"] = 347,
    ["theme.json"] = 348,
    tmLanguage = 349,
    ["trunk.yaml schema"] = 354,
    ["ts-force-config.json"] = 358,
    ["tsconfig.json"] = 355,
    ["tsd.json"] = 356,
    ["tsdrc.json"] = 357,
    ["tslint.json"] = 359,
    ...
    ["version.json"] = 370,
    ["vim-addon-info"] = 371,
    ["vs-2017.3.host.json"] = 373,
    ["vs-nesting.json"] = 374,
    ["vsls.json"] = 372,
    ["vss-extension.json"] = 378,
    ["webjobpublishsettings.json"] = 383,
    ["webjobs-list.json"] = 382,
    ["xs-app.json"] = 407,
    ["xunit.runner.json"] = 392,
    yamllint = 430,
    zuul = 416,
    ["Žinoma"] = 424
  },
