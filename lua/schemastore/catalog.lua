...
M.json = {
  ...
  index = {
    ...
    AIConfig = 48,
    ["AMX Muse Program Descriptor"] = 1322,
    ["API Builder"] = 1128,
    ["AVA Configuration"] = 1192,
    ...
    ["AWS Copilot Manifest"] = 1361,
    ["AWS SAM CLI Samconfig"] = 319,
    Acton = 1415,
    ["Adobe UXP Manifest"] = 1255,
    ["Aerleon Network & Service Definitions"] = 30,
    ["Aerleon Policy"] = 31,
    ["Agent Permission Policy"] = 1401,
    ["AgentCore CLI"] = 1402,
    ["AgentCtl MCP"] = 1404,
    ["AgentCtl config"] = 1403,
    ["AgentCtl permissions"] = 1405,
    AgentLoopKit = 1406,
    Aider = 1351,
    Air = 33,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1372,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1371,
    ["Airlock Microgateway"] = 49,
    ["Alacritty Configuration"] = 1164,
    ["AlgoVoi Compliance Receipt v1"] = 19,
    ["All Contributors configuration file"] = 1218,
    ...
    ["Application list for a WinUtil"] = 1301,
    ["ArchSmith diagram IR"] = 1440,
    ArchitectFX = 1306,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1370,
    ["Azure IoT Operations connector metadata"] = 1367,
    ...
    ["Bacon config"] = 13,
    ["Barba-CV"] = 102,
    ["Bashly (bashly.yml)"] = 1222,
    ["Bashly Settings (bashly-settings.yml)"] = 1223,
    Bento = 1388,
    ["Better Code Hub"] = 1133,
    ["Better Scripts"] = 189,
    Bigconfig = 155,
    ["Biome Formatter Config"] = 103,
    ["Bitmovin Encoding Template"] = 1315,
    BizTalkServerApplicationSchema = 1099,
    Bleep = 190,
    ["Block Protocol Metadata"] = 187,
    ["Bluebricks blueprint config"] = 1394,
    ["Boyka Framework"] = 168,
    ...
    ["Butane Config"] = 1177,
    C4InterFlow = 1330,
    ["CDK Environment Manager, concrete environment configuration"] = 1354,
    ["CDK Environment Manager, concrete environments definition"] = 1353,
    ["CDK Environment Manager, environment definition"] = 1352,
    ["CGS Card Game Specification (cgs.json)"] = 1260,
    ["CICS TS region tagging"] = 1186,
    ["CICS TS resource import"] = 1187,
    ["CICS TS resource model"] = 1188,
    ["CICS TS resource overrides"] = 1189,
    ["CMake Presets"] = 191,
    ["CNC Codes"] = 214,
    ["CRS WAF test file"] = 1290,
    ["CRS WAF test platform overrides file"] = 1291,
    ...
    ["Caido Proxy Configuration"] = 1430,
    ...
    ["Chamaleon environment"] = 1319,
    ["Chamaleon properties"] = 1320,
    ["Chamaleon template"] = 1318,
    Changepacks = 1381,
    Changesets = 328,
    Changie = 200,
    Charmcraft = 201,
    ...
    ["Claude Code Launch Preview"] = 1439,
    ["Claude Code Plugin Manifest"] = 222,
    ["Claude Code Plugin Marketplace"] = 223,
    ["Claude Code Settings"] = 224,
    ["Clawject config"] = 220,
    ["Cloud Foundry Application Manifest"] = 1272,
    ["Cloud Run Spec v1"] = 1296,
    ...
    Concord = 1289,
    ["Configu .cfgu files"] = 1277,
    ["Configu .configu file"] = 1278,
    Conjure = 213,
    ["Container Structure Test"] = 1113,
    Containerlab = 1142,
    ["Context Passport"] = 2,
    ["Contextive Glossary"] = 1346,
    ContractGuard = 1143,
    Convex = 212,
    ...
    ["Cursor Agent Environment"] = 1399,
    ["Custom Machinery Machine"] = 1261,
    ["Custom Machinery Recipe"] = 1262,
    ...
    ["DonateCaseBetterCasino menu"] = 1323,
    ["Draugr Saga"] = 359,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1230,
    ["EAS config"] = 434,
    ["ECA - Editor Code Assistant"] = 397,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1219,
    ["ESLint Suppressions"] = 439,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1366,
    ["EasyVCR .NET"] = 436,
    ["Eidolon Resource"] = 1307,
    ...
    ["Envelope Team Definition"] = 1414,
    ["Envilder Map File"] = 402,
    ["Erda Pipeline"] = 1268,
    ["Erda Runtime"] = 1269,
    ["Espanso config.yml"] = 1392,
    ["Espanso match.yml"] = 1391,
    Esquio = 422,
    ["Estuary Flow Catalog"] = 1183,
    ["Ethereum ERC1155"] = 1408,
    ["Ethereum ERC721"] = 1407,
    ...
    ["Evolving Resolutive Process notation"] = 1368,
    ["Expo SDK"] = 433,
    ...
    ["GeoJSON.json latest"] = 1181,
    GherKing = 1185,
    ["GitHub Action"] = 477,
    ["GitHub Actions typing"] = 1303,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 1257,
    ...
    ["Google Digital Assetlinks"] = 1347,
    Goreleaser = 513,
    ["Goreleaser Pro"] = 514,
    Goss = 516,
    ["Gradle Build Cache Node"] = 1131,
    ["Gradle Enterprise"] = 1130,
    ...
    Hadolint = 1109,
    Hammerkit = 1141,
    ["Hardware Sentry Configuration"] = 1197,
    ...
    ["Hecate Input Schema"] = 1358,
    ["Helm Chart.lock"] = 276,
    ["Helm Chart.yaml"] = 275,
    ["Helm Unittest Test Suite"] = 277,
    ["Heloisa Assistant Plugins Marketplace"] = 1437,
    ["Hex file"] = 278,
    ...
    ["JFrog File Spec"] = 572,
    ["JFrog Pipelines YML DSL"] = 1207,
    ["JMeter DSL cli config"] = 573,
    JReleaser = 576,
    ["JSON Document Transform"] = 584,
    ["JSON Feed"] = 585,
    ["JSON Resume"] = 862,
    ["JSON Schema Draft 2020-12"] = 1075,
    ["JSON Schema Draft 4"] = 1072,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1240,
    ["JSON Schema Draft 7"] = 1073,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1241,
    ["JSON Schema Draft 8 (2019-09)"] = 1074,
    ["JSON-API"] = 583,
    ["JSON-e templates"] = 1138,
    ["JSON-stat 2.0"] = 1068,
    JSONPatch = 587,
    ...
    Jsontron = 588,
    ["Jujutsu (jj) VCS config"] = 1360,
    ["KIMMDY config file"] = 599,
    ["KODE/CI build.yaml"] = 1203,
    ["KSP-AVC"] = 1069,
    ["KSP-CKAN"] = 1070,
    ["KSP-NetKAN"] = 1071,
    KSY = 1270,
    ...
    ["Kong DBLess config"] = 1204,
    KrakenD = 603,
    ["Kubri Configuration"] = 611,
    LOOBin = 629,
    ["Lake configuration file"] = 1363,
    ...
    ["Lando (landofile)"] = 129,
    ["LangGraph Platform configuration"] = 1282,
    ["Language configuration"] = 1281,
    Lefthook = 616,
    ...
    ["Madness (madness.yml)"] = 1221,
    ["Mado configuration"] = 636,
    ["Maestro Flow"] = 637,
    ["Mail Servers Configuration"] = 1395,
    ["MapEHR Mapping"] = 638,
    Markdownlint = 1152,
    ["Mason Registry"] = 1155,
    ...
    ["Metadata for a Cinnamon spice"] = 1299,
    ["Metatype Configuration"] = 645,
    ["MetricsHub Configuration"] = 646,
    ["MetricsHub Connector Configuration"] = 647,
    ["Micro Editor Syntax"] = 1231,
    ["Microsoft Band Web Tile"] = 648,
    ["Microsoft RulesEngine workflow rules"] = 1286,
    ["Microsoft RulesEngine workflow rules list"] = 1287,
    ["Minecraft Custom Main Menu Mod"] = 1249,
    ...
    ["MongoDB Atlas Search Index Definition"] = 1202,
    ["Monika Configuration"] = 1200,
    ["Monoweave Configuration"] = 679,
    ["Motif config"] = 1091,
    MultiQC = 1340,
    ["NOX Framework (Service)"] = 707,
    ["Netin Diagnostic System Template"] = 1159,
    ["Netlify config"] = 688,
    ...
    ["Nightwatch.js"] = 699,
    ["Nika workflow"] = 704,
    ["Node.js configuration"] = 1096,
    ["NueJS configuration file"] = 712,
    ["Nuitka Package Config"] = 1263,
    ...
    ["OpenUtau ustx"] = 733,
    ["OpenWeather Current Weather API"] = 1137,
    ["OpenWeather Road Risk API"] = 1136,
    ...
    ["Pipeline component"] = 1150,
    ["Platform.sh application"] = 15,
    ["Platform.sh routes"] = 16,
    ["Platform.sh services"] = 17,
    ["Plex Prerolls"] = 779,
    ["PocketMine plugin.yml"] = 776,
    ["Podman Desktop Extension"] = 1432,
    ["Postman collection"] = 785,
    ["Power Pages Configuration"] = 1357,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1302,
    ...
    Pylock = 1348,
    Pyright = 833,
    ["Python script metadata"] = 1342,
    ["QType AI DSL"] = 836,
    Qgoda = 835,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1424,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1422,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1428,
    ["Qlik Talend Cloud Pipeline - Project"] = 1420,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1423,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1425,
    ["Qlik Talend Cloud Pipeline - Task"] = 1421,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1427,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1426,
    Qodana = 1169,
    ["Qt Creator workspace file"] = 1279,
    ["Quali Torque Blueprint Spec 2"] = 1194,
    ["QueryFirst config file"] = 1213,
    ["QuikRun Configuration"] = 1429,
    ["Qwen Code Settings"] = 1409,
    ["RKE Cluster Configuration JSON"] = 1147,
    ["RKE Cluster Configuration YAML"] = 1146,
    RadioHound = 826,
    ["Raid Profile"] = 1410,
    ["Raid Repo Configuration"] = 1411,
    Railpack = 838,
    Railway = 837,
    ["Rancher Fleet"] = 828,
    ["Rattler-build"] = 839,
    ...
    ["Replit config"] = 854,
    Restate = 1335,
    ["Revel Digital Gadget Definition File"] = 1359,
    RoadRunner = 868,
    ["Robust Station Image"] = 1365,
    Rockcraft = 869,
    ["Roo Coder Custom Modes"] = 870,
    Rubocop = 859,
    ["Rudder techniques"] = 1253,
    Ruff = 860,
    ["Rust Project"] = 861,
    ["Rust toolchain"] = 875,
    ...
    ["Serverless Framework Configuration"] = 1163,
    ["Serverless Workflow"] = 1165,
    ["Settings for a Cinnamon spice"] = 1298,
    ["Settings.paf"] = 909,
    ["Shopware 6 Configuration"] = 1166,
    ["Shopware CLI Extension Store Configuration"] = 1167,
    ["Shopware CLI Project Store Configuration"] = 1168,
    ["Sigma Detection Rule"] = 911,
    ["SigmaCV CV"] = 7,
    ["Sigrid scope configuration file"] = 912,
    ["SkyPilot Task JSON"] = 1254,
    ["Slack app manifest"] = 919,
    ["Slang Server Configuration"] = 1436,
    Snapcraft = 921,
    ...
    StackBlitz = 960,
    ["StackHawk Scanner Configuration"] = 1162,
    Stale = 961,
    Starfish = 962,
    ["Starlake Data Pipeline"] = 1134,
    Starship = 963,
    ...
    TSON = 1016,
    TSTyche = 1017,
    ["TYPO3 Vendor Bundler config"] = 1023,
    ["Tab data for a LinUtil"] = 1305,
    ["Tab list for a LinUtil"] = 1304,
    Tach = 979,
    ["Tach Domain"] = 980,
    Talhelper = 982,
    ["Talisman configuration"] = 983,
    Taplo = 1350,
    ["Taskfile config"] = 1139,
    Taurus = 984,
    Tauticord = 985,
    ["Tekton Pipeline"] = 1378,
    ["Tekton PipelineRun"] = 1379,
    ["Tekton Task"] = 1376,
    ["Tekton TaskRun"] = 1377,
    Telefonistka = 1336,
    ["Terrateam config"] = 1362,
    ["TestEnvironment.json"] = 997,
    ["TextMate Grammar"] = 996,
    Threagile = 991,
    ["Tier.run pricing.json"] = 988,
    Tikibase = 989,
    Tombi = 994,
    ["Traefik v2"] = 1000,
    ["Traefik v2 File Provider"] = 1001,
    ["Traefik v3"] = 1002,
    ["Traefik v3 File Provider"] = 1003,
    ["Travis CI (.travis.yml)"] = 999,
    Treefmt = 519,
    Trident = 1332,
    Trivy = 1006,
    ["TrueScript for *.tscript files"] = 1007,
    ["Tugboat QA config.yml"] = 1329,
    TunnelHub = 1244,
    Turborepo = 998,
    Tycho = 1293,
    Tye = 1170,
    ["Tyk Gateway - Open Source v5.7+"] = 1341,
    ["UET BuildConfig.json"] = 1214,
    ["UI5 Manifest"] = 1029,
    ["UNCORS configuration"] = 1034,
    ["UTAM Page Object"] = 1032,
    ["Ubuntu Server Autoinstall"] = 1027,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1333,
    ["Uniswap Token List"] = 1119,
    ["Universal Schedule Format"] = 1035,
    ["Unreal Engine Uplugin"] = 1215,
    ["Unreal Engine Uproject"] = 1216,
    ["UpCloud CLI (upctl) configuration"] = 1334,
    ["Updatecli Compose"] = 1178,
    ["Updatecli Policy Manifest"] = 1179,
    ["Updatecli Policy Metadata"] = 1180,
    Uplift = 1212,
    ["Upsun config"] = 14,
    ["User Journey Map"] = 1144,
    V2Ray = 1184,
    ["VSCode Code Snippets"] = 303,
    ["VSIX CLI publishing"] = 1055,
    Vector = 1037,
    ["Vee JSON menu output"] = 1038,
    ["Vela Pipeline Configuration"] = 1041,
    Vercel = 302,
    ["Version Bumper config"] = 1044,
    Vespertide = 1383,
    ["Vespertide Migration"] = 1384,
    ["Vespertide Model"] = 1385,
    ["Viash Component Config"] = 1338,
    ["Viash Package Config"] = 1339,
    Visivo = 1242,
    Vogi = 1049,
    ["WP-CLI"] = 1065,
    Wake = 1331,
    ["Waku Config"] = 1308,
    ["Web App Manifest"] = 1061,
    ["Web types"] = 1064,
    WebExtensions = 1060,
    ["Webman package recipe"] = 1190,
    ["Windows Package Manager Installer Manifest"] = 1116,
    ["Windows Package Manager Locale Manifest"] = 1117,
    ["Windows Package Manager Singleton Manifest"] = 1115,
    ["WireMock CLI import configuration"] = 1314,
    ["WireMock CLI local service configuration"] = 1313,
    ["WireMock message stub mapping"] = 1312,
    ["WireMock stub mapping"] = 1311,
    ["Woodpecker pipeline config"] = 1158,
    ["Wrangler CLI"] = 1066,
    ["XenForo add-on manifest"] = 1067,
    ["Xstate Machine"] = 1176,
    ["Yandex Workflow Language"] = 1300,
    ["Yarn Config (.yarnrc.yml)"] = 1132,
    ["Yippee-Ki-JSON configuration YML"] = 1123,
    ["YouTrack App"] = 1297,
    ["Zarf Package Configuration"] = 1364,
    ["Zerops import file"] = 1285,
    ["Zola Configuration"] = 1375,
    abtop = 35,
    act3 = 1416,
    actionlint = 45,
    ["aerleon.yml"] = 29,
    ["amplify.yml"] = 22,
    ["amxx-builder manifest"] = 1431,
    ["angular.json"] = 50,
    apko = 1247,
    ...
    ["behat.yml"] = 169,
    ["bigquery-table"] = 154,
    ["bioimageio resource description"] = 1264,
    ...
    ["chutzpah.json"] = 311,
    cibuildwheel = 207,
    ["clang-format (.clang-format)"] = 1182,
    ["clang-tidy"] = 284,
    clangd = 283,
    clib = 285,
    ...
    ["crowdin.yml"] = 338,
    crucible = 342,
    ["ctfd-setup configuration file"] = 1321,
    ["custom-elements.json"] = 1234,
    ["cypress.json"] = 343,
    ["dacier.yml"] = 1419,
    ...
    ["gematik health care insurance list"] = 1327,
    ["gematik health care patient list"] = 1324,
    ["gematik health care provider institution list"] = 1326,
    ["gematik health care provider list"] = 1325,
    ["gematik tiger test environment configuration"] = 1328,
    ["gh-dash"] = 475,
    ["gha-doctor"] = 476,
    ["git-cliff"] = 472,
    ["git-town.toml"] = 1373,
    ...
    lychee = 1083,
    ["macro.json"] = 1199,
    ["markdown-link-check"] = 1153,
    maturin = 1154,
    mboats = 1161,
    memnex = 1417,
    ["micro-settings.json"] = 1226,
    ["mimetypes.json"] = 649,
    ["mirrord config"] = 1087,
    ["misata.yaml"] = 1086,
    mise = 1088,
    ["mkdocs.yml"] = 669,
    ["mockd.yaml"] = 673,
    ["mod.pw.toml (packwiz)"] = 1434,
    ["modelparams.dev Model"] = 676,
    ["models CLI"] = 677,
    ["monospace.yml"] = 678,
    ["moon.yml"] = 1310,
    ["mprocs Configuration file"] = 1280,
    ["mrdocs.yml"] = 671,
    ["mta.yaml"] = 1089,
    ["mtad.yaml"] = 1090,
    ["mycode.json"] = 686,
    ...
    ["plagiarize.yaml"] = 777,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1317,
    ["podbard.yaml"] = 780,
    ["portman.json"] = 783,
    ["prefect.toml"] = 792,
    ["prefect.yaml"] = 793,
    ...
    servercn = 1442,
    ["servicehub.config.json"] = 1078,
    ["servicehub.service.json"] = 1077,
    ["settings.job"] = 908,
    ...
    ["text2confl config"] = 1398,
    ["theme.json"] = 990,
    ["tizen_workspace.json"] = 992,
    tldr = 993,
    ["tm_devices configuration file"] = 1355,
    tmuxinator = 1081,
    tox = 995,
    ["transcend.yml"] = 1004,
    ...
    ["vega-lite.json"] = 1040,
    ["vega.json"] = 1039,
    ["venvironment.yaml"] = 1042,
    ["venvplus.yaml"] = 1043,
    version = 1337,
    ["version.json"] = 1045,
    ["vhwdebugger-binding.yaml"] = 1047,
    ["vim-addon-info"] = 1048,
    ["vs-2017.3.host.json"] = 1051,
    ["vs-nesting.json"] = 1052,
    ["vsls.json"] = 1050,
    ["vss-extension.json"] = 1056,
    vtcfg = 1343,
    ["vtesttree.yaml"] = 1057,
    ["vtestunit.yaml"] = 1058,
    ["warp-keysets.json"] = 1235,
    ["warp-themes.json"] = 1236,
    ["warp-workflows.json"] = 1237,
    ["webhint.io"] = 1191,
    ["webjobpublishsettings.json"] = 1063,
    ["webjobs-list.json"] = 1062,
    ["well-known-fursona"] = 1275,
    ["xs-app.json"] = 1093,
    ["xunit.runner.json"] = 1076,
    ["yaml-workflow"] = 1441,
    yamlfmt = 1120,
    yamllint = 1121,
    ["yap.json"] = 1122,
