...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 855,
    [".nodehawkrc"] = 522,
    [".npmpackagejsonlintrc"] = 526,
    [".omletrc"] = 1031,
    [".phrase.yml"] = 589,
    [".phraseapp.yml"] = 590,
    [".pmbot.yml"] = 577,
    [".postcssrc"] = 584,
    [".powerpages-web-template-manifest"] = 586,
    [".pre-commit-config.yml"] = 587,
    [".pre-commit-hooks.yml"] = 588,
    [".putout.json"] = 617,
    [".rehyperc"] = 641,
    [".remarkrc"] = 645,
    [".sprite files"] = 732,
    ...
    ["A micro editor config"] = 473,
    ABCInventoryModuleData = 18,
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1076,
    ["API Builder"] = 890,
    ["AVA Configuration"] = 952,
    ...
    ["AWS Copilot Manifest"] = 1114,
    ["AWS SAM CLI Samconfig"] = 223,
    ["Adobe UXP Manifest"] = 1014,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1105,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 924,
    ["All Contributors configuration file"] = 977,
    ...
    ["Application list for a WinUtil"] = 1058,
    ArchitectFX = 1063,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure Pipelines"] = 79,
    ["Azure Static Web Apps CLI configuration file"] = 736,
    ["Azure Static Web Apps configuration file"] = 735,
    ["BOSH CPI Config"] = 103,
    ["BOSH Deploy Config"] = 104,
    ["BX CI"] = 123,
    ["Bashly (bashly.yml)"] = 981,
    ["Bashly Settings (bashly-settings.yml)"] = 982,
    ["Better Code Hub"] = 894,
    ["Better Scripts"] = 124,
    Bigconfig = 96,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1069,
    BizTalkServerApplicationSchema = 862,
    Bleep = 125,
    ...
    ["Butane Config"] = 937,
    C4InterFlow = 1084,
    ["CDK Environment Manager, concrete environment configuration"] = 1108,
    ["CDK Environment Manager, concrete environments definition"] = 1107,
    ["CDK Environment Manager, environment definition"] = 1106,
    ["CGS Card Game Specification (cgs.json)"] = 1019,
    ["CICS TS region tagging"] = 946,
    ["CICS TS resource import"] = 947,
    ["CICS TS resource model"] = 948,
    ["CICS TS resource overrides"] = 949,
    ["CMake Presets"] = 126,
    ["CNC Codes"] = 147,
    ["CRS WAF test file"] = 1048,
    ["CRS WAF test platform overrides file"] = 1049,
    ...
    ["Chamaleon environment"] = 1073,
    ["Chamaleon properties"] = 1074,
    ["Chamaleon template"] = 1072,
    Changesets = 232,
    Changie = 135,
    Charmcraft = 136,
    Cheatsheets = 934,
    ...
    ["Clawject config"] = 153,
    ["Cloud Foundry Application Manifest"] = 1030,
    ["Cloud Run Spec v1"] = 1053,
    ...
    Concord = 1047,
    ["Configu .cfgu files"] = 1035,
    ["Configu .configu file"] = 1036,
    Conjure = 146,
    ["Container Structure Test"] = 876,
    Containerlab = 903,
    ["Contextive Glossary"] = 1100,
    Convex = 145,
    ["Crowdsec collection config"] = 242,
    ["Crowdsec parser config"] = 243,
    ["Crowdsec scenario config"] = 244,
    ["CumulusCI Config"] = 152,
    ["Custom Machinery Machine"] = 1020,
    ["Custom Machinery Recipe"] = 1021,
    ...
    ["DataYoga Job"] = 159,
    ["Databricks Asset Bundles"] = 998,
    ["Datadog Continuous Testing"] = 445,
    ["Datadog Service Definition"] = 446,
    ["Datadog Software Catalog"] = 447,
    ["Datahub Ingestion Recipe"] = 953,
    ["Deck config"] = 165,
    ["Dein Config"] = 166,
    ...
    ["DonateCaseBetterCasino menu"] = 1077,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 989,
    ["EAS config"] = 308,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 978,
    ["EasyVCR .NET"] = 309,
    ["Eidolon Resource"] = 1064,
    ...
    ["GeoJSON.json latest"] = 941,
    GherKing = 945,
    ["GitHub Action"] = 339,
    ["GitHub Actions typing"] = 1060,
    ...
    ["Google Digital Assetlinks"] = 1101,
    Goreleaser = 367,
    ["Goreleaser Pro"] = 368,
    Goss = 369,
    ["Gradle Build Cache Node"] = 892,
    ["Gradle Enterprise"] = 891,
    ...
    Hadolint = 872,
    Hammerkit = 902,
    ["Hardware Sentry Configuration"] = 957,
    ["HashiCorp Vault"] = 381,
    Hatch = 873,
    Hayson = 383,
    ["Haystack Pipeline"] = 384,
    ["Hazelcast 5 Configuration"] = 385,
    ["Hecate Input Schema"] = 1112,
    ["Helm Chart.lock"] = 187,
    ["Helm Chart.yaml"] = 186,
    ["Helm Unittest Test Suite"] = 188,
    ["Home Assistant Integration Manifest"] = 386,
    ["Homer dashboard configuration"] = 387,
    Hugo = 933,
    ["Hugo Theme"] = 932,
    ["Hyperfoil benchmark configuration"] = 393,
    ["IBM Zapp document"] = 394,
    ["IBM zCodeFormatSettings"] = 395,
    ["IMG Catapult PSP"] = 400,
    ["IVMS101 by CODE Protocol"] = 1017,
    Infrahub = 402,
    Istanbul = 960,
    ["JDownloader2 crawler multi-rules"] = 412,
    ["JDownloader2 crawler single-rules"] = 411,
    ["JFrog Applications Config"] = 413,
    ["JFrog File Spec"] = 414,
    ["JFrog Pipelines YML DSL"] = 966,
    ["JMeter DSL cli config"] = 415,
    JReleaser = 418,
    ["JSON Document Transform"] = 426,
    ["JSON Feed"] = 427,
    ["JSON Resume"] = 651,
    ["JSON Schema Draft 2020-12"] = 841,
    ["JSON Schema Draft 4"] = 838,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 999,
    ["JSON Schema Draft 7"] = 839,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1000,
    ["JSON Schema Draft 8 (2019-09)"] = 840,
    ["JSON-API"] = 425,
    ["JSON-e templates"] = 899,
    ["JSON-stat 2.0"] = 834,
    JSONPatch = 429,
    ["JSR Package Config (jsr.json)"] = 419,
    Jasmine = 406,
    Jekyll = 407,
    ["Jenkins X Pipelines"] = 408,
    ["Jenkins X Requirements"] = 409,
    Jest = 410,
    Jocker = 416,
    ["Jovo Language Models"] = 417,
    ["Jujutsu (jj) VCS config"] = 1113,
    ["KIMMDY config file"] = 440,
    ["KODE/CI build.yaml"] = 962,
    ["KSP-AVC"] = 835,
    ["KSP-CKAN"] = 836,
    ["KSP-NetKAN"] = 837,
    KSY = 1029,
    ...
    Kas = 432,
    ["Kestra flow file"] = 441,
    ["Keycloak REST API"] = 969,
    ["Knative Functions - func.yaml"] = 328,
    ["Kometa (nightly) config file"] = 443,
    ["Kometa config file"] = 442,
    ["Kong DBLess config"] = 963,
    KrakenD = 444,
    ["Kubri Configuration"] = 451,
    LOOBin = 466,
    ["Lake configuration file"] = 1116,
    ...
    ["Lando (landofile)"] = 75,
    ["LangGraph Platform configuration"] = 1040,
    ["Language configuration"] = 1039,
    Lefthook = 455,
    ["Liferay client-extension.yaml"] = 462,
    ["LinkML Metamodel"] = 464,
    Liquibase = 908,
    ["Liquibase Flow File"] = 909,
    ["Lively Properties"] = 465,
    ["Lobe AI Agent"] = 77,
    Loki = 78,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 505,
    ["MS2Rescore Configuration"] = 508,
    ["Madness (madness.yml)"] = 980,
    ["MapEHR Mapping"] = 472,
    Markdownlint = 912,
    ["Mason Registry"] = 915,
    ["MegaLinter Custom Flavor"] = 475,
    ["MegaLinter configuration"] = 474,
    ["MegaLinter descriptor"] = 476,
    Melange = 1007,
    ["Meltano project definition"] = 477,
    ["Mergify Configuration"] = 509,
    ["Metadata for a Bazel module"] = 478,
    ["Metadata for a Cinnamon spice"] = 1056,
    ["Metatype Configuration"] = 479,
    ["MetricsHub Configuration"] = 480,
    ["MetricsHub Connector Configuration"] = 481,
    ["Micro Editor Syntax"] = 990,
    ["Microsoft Band Web Tile"] = 482,
    ["Microsoft RulesEngine workflow rules"] = 1044,
    ["Microsoft RulesEngine workflow rules list"] = 1045,
    ["Minecraft Custom Main Menu Mod"] = 1008,
    ["Minecraft Data Pack Advancement"] = 484,
    ["Minecraft Data Pack Biome"] = 485,
    ["Minecraft Data Pack Configured Carver"] = 486,
    ["Minecraft Data Pack Damage Type"] = 487,
    ["Minecraft Data Pack Dimension"] = 489,
    ["Minecraft Data Pack Dimension Type"] = 488,
    ["Minecraft Data Pack Item Modifier"] = 490,
    ["Minecraft Data Pack Loot Table"] = 491,
    ["Minecraft Data Pack Metadata"] = 492,
    ["Minecraft Data Pack Predicate"] = 493,
    ["Minecraft Data Pack Recipe"] = 494,
    ["Minecraft Data Pack Tag"] = 495,
    ["Minecraft Data Pack Template Pool"] = 496,
    ["Minecraft Data Pack Trim Material"] = 501,
    ["Minecraft Data Pack Trim Pattern"] = 502,
    ["Minecraft Resource Pack Lang"] = 497,
    ["Minecraft Resource Pack Particle"] = 498,
    ["Minecraft Resource Pack Texture Mcmeta"] = 500,
    ["Minecraft Resourcepack Sounds"] = 499,
    ["Monade CLI Stack Configuration"] = 512,
    ["MongoDB Atlas Search Index Definition"] = 961,
    ["Monika Configuration"] = 959,
    ["Monoweave Configuration"] = 507,
    ["Motif config"] = 854,
    MultiQC = 1094,
    ["NOX Framework (Service)"] = 525,
    ["Netin Diagnostic System Template"] = 919,
    ["Netlify config"] = 515,
    ["Network-as-Code Data Model"] = 516,
    ["Nightwatch.js"] = 518,
    ["Node.js configuration"] = 859,
    ["NueJS configuration file"] = 530,
    ["Nuitka.yaml"] = 1022,
    ["Nullstone config"] = 532,
    ["ONe's changelog entry"] = 546,
    ["ONe's service descriptor"] = 545,
    ["ORT Server repository environment configuration"] = 554,
    ["OSCAL Assessment Plan (AP)"] = 556,
    ["OSCAL Assessment Results (AR)"] = 557,
    ["OSCAL Catalog"] = 558,
    ["OSCAL Component Definition (CDef)"] = 559,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 560,
    ["OSCAL Profile"] = 561,
    ["OSCAL System Security Plan (SSP)"] = 562,
    ["OSS Review Toolkit configuration"] = 563,
    ["OSS Review Toolkit curation"] = 564,
    ["OSS Review Toolkit package configuration"] = 565,
    ["OSS Review Toolkit repository configuration"] = 566,
    ["OSS Review Toolkit resolutions"] = 567,
    ["October CMS columns"] = 536,
    ["October CMS fields"] = 537,
    Okteto = 538,
    Opctl = 857,
    ["Open Data Contract Standard (ODCS)"] = 549,
    ["Open Data Product Standard (ODPS)"] = 550,
    ["Open Know-How"] = 1099,
    ["OpenRewrite Resource"] = 548,
    OpenStatus = 1110,
    ["OpenUtau character yaml"] = 542,
    ["OpenUtau ustx"] = 543,
    ["OpenWeather Current Weather API"] = 898,
    ["OpenWeather Road Risk API"] = 897,
    ["Ory Hydra configuration"] = 392,
    ["Ory Keto configuration"] = 448,
    ["Ory Kratos configuration"] = 555,
    ["Ory Oathkeeper configuration"] = 534,
    ["Outblocks App configuration"] = 552,
    ["Outblocks database table"] = 553,
    ["Outblocks project configuration"] = 551,
    PDM = 573,
    Packer = 570,
    Pantsbuild = 976,
    ["Paper paper-plugin.yml"] = 571,
    ["Pipeline component"] = 910,
    ["Platform.sh application"] = 2,
    ["Platform.sh routes"] = 3,
    ["Platform.sh services"] = 4,
    ["Plex Prerolls"] = 581,
    ["PocketMine plugin.yml"] = 578,
    ["Postman collection"] = 585,
    ["Power Pages Configuration"] = 1111,
    ["Preset list for a WinUtil"] = 1059,
    ["ProActions AI-Kit Configuration"] = 594,
    ["ProActions AI-Kit Configuration for Menus"] = 596,
    ["ProActions AI-Kit Configuration for Sections"] = 598,
    ["ProActions AI-Kit Configuration for Services"] = 595,
    ["ProActions AI-Kit Configuration for Steps"] = 599,
    ["ProActions AI-Kit Configuration for Templates"] = 597,
    ["Problem object RFC9457"] = 1005,
    ["Problem package generators"] = 600,
    Pterodactyl = 956,
    ["Pull Request Labeler"] = 616,
    Pulumi = 624,
    ["PyGTA Config"] = 620,
    PyProject = 625,
    Pylock = 1102,
    Pyright = 626,
    ["Python script metadata"] = 1096,
    ["QType AI DSL"] = 629,
    Qgoda = 628,
    Qodana = 929,
    ["Qt Creator workspace file"] = 1037,
    ["Quali Torque Blueprint Spec 2"] = 954,
    ["QueryFirst config file"] = 972,
    ["RKE Cluster Configuration JSON"] = 907,
    ["RKE Cluster Configuration YAML"] = 906,
    RadioHound = 619,
    Railway = 630,
    ["Rancher Fleet"] = 621,
    ["Rattler-build"] = 631,
    Ray = 871,
    ["Read the Docs"] = 623,
    ["Red-DiscordBot Cog"] = 638,
    ["Red-DiscordBot Cog Repo"] = 639,
    ["Red-DiscordBot Trivia"] = 640,
    ["Render Blueprints"] = 905,
    RenderCV = 653,
    Renovate = 652,
    ["Replit config"] = 646,
    Restate = 1089,
    RoadRunner = 655,
    ["Roo Coder Custom Modes"] = 657,
    Rubocop = 648,
    ["Rudder techniques"] = 1012,
    Ruff = 649,
    ["Rust Project"] = 650,
    ["Rust toolchain"] = 660,
    ["SDMX data message"] = 686,
    ["SDMX metadata message"] = 685,
    ["SDMX structure message"] = 684,
    ["SIL Kit Participant Configuration"] = 696,
    ["SIL Kit Registry Configuration"] = 697,
    ["SPDX 2.3"] = 733,
    SWADL = 747,
    ["Safebox Config"] = 967,
    ["Sapphire CLI Config"] = 663,
    ["SauceCTL Configuration"] = 916,
    ["Schema Catalog"] = 678,
    ["Scoop manifest"] = 683,
    ["Semantic Data Fabric (SDF) file"] = 687,
    ["Semgrep Rule"] = 689,
    ["Serenity Code Generator (Sergen)"] = 690,
    ["Serverless Framework Configuration"] = 923,
    ["Serverless Workflow"] = 925,
    ["Settings for a Cinnamon spice"] = 1055,
    ["Settings.paf"] = 692,
    ["Shopware 6 Configuration"] = 926,
    ["Shopware CLI Extension Store Configuration"] = 927,
    ["Shopware CLI Project Store Configuration"] = 928,
    ["Sigma Detection Rule"] = 694,
    ["Sigrid scope configuration file"] = 695,
    ["SkyPilot Task JSON"] = 1013,
    ["Slack app manifest"] = 699,
    Solidarity = 704,
    ["Solution filters"] = 705,
    ["Source Maps v3"] = 706,
    Sourcery = 707,
    ["Spack bootstrap.yaml"] = 708,
    ["Spack cdash.yaml"] = 709,
    ["Spack ci.yaml"] = 710,
    ["Spack compilers.yaml"] = 711,
    ["Spack concretizer.yaml"] = 712,
    ["Spack config.yaml"] = 713,
    ["Spack definitions.yaml"] = 714,
    ["Spack develop.yaml"] = 715,
    ["Spack env_vars.yaml"] = 716,
    ["Spack environment"] = 722,
    ["Spack include.yaml"] = 717,
    ["Spack mirrors.yaml"] = 718,
    ["Spack modules.yaml"] = 719,
    ["Spack packages.yaml"] = 720,
    ["Spack repos.yaml"] = 721,
    ["Spack toolchains.yaml"] = 723,
    ["Spack upstreams.yaml"] = 724,
    ["Spack view.yaml"] = 725,
    ["Speakeasy Generation Config File"] = 729,
    ["Speakeasy Lint Configuration File"] = 726,
    ["Speakeasy Test Generation Configuration File"] = 727,
    ["Speakeasy Workflow File"] = 728,
    SpecIF = 730,
    ["Sponge Mixin configuration"] = 731,
    StackBlitz = 737,
    ["StackHawk Scanner Configuration"] = 922,
    Stale = 738,
    ["Starlake Data Pipeline"] = 895,
    Starship = 739,
    ["Statamic Blueprint"] = 740,
    ["Stella configuration file"] = 741,
    ["Stryker Mutator"] = 744,
    ["StyleCop Analyzers Configuration"] = 745,
    ["Stylelint (.stylelintrc)"] = 746,
    ["Stylua Config"] = 1103,
    ["Sublime Syntax"] = 968,
    ["Subsquid squid manifest"] = 1015,
    ["Swagger API 2.0"] = 748,
    ["Synadia Connect Component"] = 749,
    TSON = 784,
    TSTyche = 785,
    ["TYPO3 Vendor Bundler config"] = 790,
    ["Tab data for a LinUtil"] = 1062,
    ["Tab list for a LinUtil"] = 1061,
    Tach = 750,
    ["Tach Domain"] = 751,
    Talhelper = 753,
    ["Talisman configuration"] = 754,
    Taplo = 1104,
    ["Taskfile config"] = 900,
    Taurus = 755,
    Tauticord = 756,
    Telefonistka = 1090,
    ["Terrateam config"] = 1115,
    ["TestEnvironment.json"] = 767,
    ["TextMate Grammar"] = 766,
    Threagile = 762,
    ["Tier.run pricing.json"] = 759,
    Tikibase = 760,
    Tombi = 765,
    ["Traefik v2"] = 770,
    ["Traefik v2 File Provider"] = 771,
    ["Traefik v3"] = 772,
    ["Traefik v3 File Provider"] = 773,
    ["Travis CI (.travis.yml)"] = 769,
    Trident = 1086,
    ["TrueScript for *.tscript files"] = 776,
    ["Tugboat QA config.yml"] = 1083,
    TunnelHub = 1003,
    Turborepo = 768,
    Tycho = 1051,
    Tye = 930,
    ["Tyk Gateway - Open Source v5.7+"] = 1095,
    ["Typst Manifest"] = 791,
    ["UET BuildConfig.json"] = 973,
    ["UI5 Manifest"] = 797,
    ["UNCORS configuration"] = 801,
    ["UTAM Page Object"] = 800,
    ["Ubuntu Server Autoinstall"] = 795,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1087,
    ["Uniswap Token List"] = 883,
    ["Universal Schedule Format"] = 802,
    ["Unreal Engine Uplugin"] = 974,
    ["Unreal Engine Uproject"] = 975,
    ["UpCloud CLI (upctl) configuration"] = 1088,
    ["Updatecli Compose"] = 938,
    ["Updatecli Policy Manifest"] = 939,
    ["Updatecli Policy Metadata"] = 940,
    Uplift = 971,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 904,
    V2Ray = 944,
    ["VSCode Code Snippets"] = 207,
    ["VSIX CLI publishing"] = 822,
    Vector = 804,
    ["Vela Pipeline Configuration"] = 807,
    Vercel = 206,
    ["Version Bumper config"] = 812,
    ["Viash Component Config"] = 1092,
    ["Viash Package Config"] = 1093,
    Visivo = 1001,
    ["WP-CLI"] = 832,
    Wake = 1085,
    ["Waku Config"] = 1065,
    ["Web App Manifest"] = 828,
    ["Web types"] = 831,
    WebExtensions = 827,
    ["Webman package recipe"] = 950,
    ["Windows Package Manager Installer Manifest"] = 879,
    ["Windows Package Manager Locale Manifest"] = 880,
    ["Windows Package Manager Singleton Manifest"] = 878,
    Winutil = 881,
    ["WireMock stub mapping"] = 1068,
    ["Woodpecker pipeline config"] = 918,
    ["Wrangler CLI"] = 833,
    ["Xstate Machine"] = 936,
    ["Yandex Workflow Language"] = 1057,
    ["Yarn Config (.yarnrc.yml)"] = 893,
    ["Yippee-Ki-JSON configuration YML"] = 885,
    ["YouTrack App"] = 1054,
    ["Zarf Package Configuration"] = 1117,
    ["Zerops.io config"] = 1042,
    ["Zerops.io import"] = 1043,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 1006,
    ...
    ["behat.yml"] = 106,
    ["bigquery-table"] = 95,
    ["bioimageio resource description"] = 1023,
    ...
    ["crowdin.yml"] = 241,
    ["ctfd-setup configuration file"] = 1075,
    ["custom-elements.json"] = 993,
    ["cypress.json"] = 245,
    ...
    ["gematik health care insurance list"] = 1081,
    ["gematik health care patient list"] = 1078,
    ["gematik health care provider institution list"] = 1080,
    ["gematik health care provider list"] = 1079,
    ["gematik tiger test environment configuration"] = 1082,
    ["gitlab-ci"] = 347,
    ["global.json"] = 363,
    ...
    ["ide.host.json"] = 396,
    ["ifstate.conf"] = 397,
    ["imageoptimizer.json"] = 398,
    ["importmap.json"] = 401,
    ["ioBroker Configuration"] = 403,
    ["ioBroker JSON UI"] = 404,
    ["ioBroker Package manifest"] = 405,
    ["ize.toml"] = 970,
    ["jsconfig.json"] = 430,
    ["jscpd Configuration"] = 955,
    jsdoc = 870,
    ["k3d.yaml"] = 431,
    ["k9s aliases.yaml"] = 433,
    ["k9s cluster-config.yaml"] = 435,
    ["k9s config.yaml"] = 434,
    ["k9s hotkeys.yaml"] = 436,
    ["k9s plugins.yaml"] = 437,
    ["k9s skin.yaml"] = 438,
    ["k9s views.yaml"] = 439,
    ["kontinuous-config.yaml"] = 450,
    ["kontinuous-values.yaml"] = 449,
    ["kustomization.yaml"] = 452,
    ["label-commenter-config.yml"] = 453,
    ["latexindent configuration"] = 76,
    ["launchsettings.json"] = 454,
    lazydocker = 992,
    lazygit = 991,
    ["lego.json"] = 456,
    ["lerna.json"] = 457,
    ["lgtm.yml"] = 458,
    ["liblab.config.json"] = 459,
    ["libman.json"] = 460,
    ["license-report-config.json"] = 461,
    ["linkinator.config.json"] = 463,
    ["lint-staged (.lintstagedrc)"] = 849,
    ["local.settings.json"] = 468,
    ["localazy.json"] = 469,
    ["lotus.yaml"] = 467,
    ["lsdlschema.json"] = 470,
    ["markdown-link-check"] = 913,
    maturin = 914,
    mboats = 921,
    ["micro-settings.json"] = 985,
    ["mimetypes.json"] = 483,
    ["mirrord config"] = 850,
    mise = 851,
    ["mkdocs.yml"] = 503,
    ["monospace.yml"] = 506,
    ["moon.yml"] = 1067,
    ["mprocs Configuration file"] = 1038,
    ["mrdocs.yml"] = 504,
    ["mta.yaml"] = 852,
    ["mtad.yaml"] = 853,
    ["mycode.json"] = 513,
    nFPM = 517,
    ["napari plugin manifest"] = 514,
    neoload = 865,
    ["nest-cli"] = 520,
    ["ninjs (News in JSON)"] = 519,
    ["nitro.json"] = 864,
    ["nixd configuration"] = 1011,
    ["nlu.json"] = 521,
    ["nodemon.json"] = 523,
    ["noodl config"] = 920,
    ["notebook.mod.json"] = 524,
    now = 860,
    ["npm-badges"] = 527,
    ["nswag.json"] = 531,
    ntangle = 533,
    ["nuclei-template.yaml"] = 528,
    ["nuget-project.json"] = 529,
    ["ocelot.json"] = 535,
    ["omnisharp.json"] = 539,
    ["openapi.json"] = 540,
    ["openfin.json"] = 547,
    ...
    ["ops.yaml"] = 544,
    ["package.json"] = 568,
    ["package.manifest"] = 569,
    ["partial-black.json"] = 107,
    ["pathfinder.yml"] = 572,
    ["pattern.json"] = 575,
    ["petstore-v1.0"] = 965,
    pgap_yaml_input_reader = 574,
    ["pixi.toml"] = 576,
    ["plagiarize-me.yaml"] = 580,
    ["plagiarize.yaml"] = 579,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1071,
    ["podbard.yaml"] = 582,
    ["portman.json"] = 583,
    ["prefect.toml"] = 591,
    ["prettierrc.json"] = 592,
    ["prisma.yml"] = 593,
    ["project-1.0.0-beta3.json"] = 602,
    ["project-1.0.0-beta4.json"] = 603,
    ["project-1.0.0-beta5.json"] = 604,
    ["project-1.0.0-beta6.json"] = 605,
    ["project-1.0.0-beta8.json"] = 606,
    ["project-1.0.0-rc1.json"] = 607,
    ["project-1.0.0-rc2.json"] = 608,
    ["project.json"] = 601,
    ["project.owasp.yaml"] = 609,
    ["prometheus.json"] = 610,
    ["prometheus.rules.json"] = 611,
    ["prometheus.rules.test.json"] = 612,
    ["proxies.json"] = 613,
    ["publiccode.yml"] = 614,
    ["pubspec.yaml"] = 615,
    ["pyrseas-0.8.json"] = 618,
    pytest = 627,
    ["quilt.mod.json"] = 986,
    ["rc3 auth"] = 632,
    ["rc3 collection"] = 633,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 866,
    ["release-please-config.json"] = 642,
    ["release-please-manifest.json"] = 643,
    ["release-plz.toml"] = 644,
    ["renv.lock"] = 654,
    ["rivet.json"] = 1010,
    ["rivet.yaml (legacy)"] = 1009,
    rockcraft = 656,
    runny = 658,
    rustfmt = 659,
    sake = 1098,
    samt = 661,
    samtrc = 662,
    ["sarif-1.0.0.json"] = 664,
    ["sarif-2.0.0.json"] = 665,
    ["sarif-2.1.0"] = 675,
    ["sarif-2.1.0-rtm.2"] = 666,
    ["sarif-2.1.0-rtm.3"] = 668,
    ["sarif-2.1.0-rtm.4"] = 670,
    ["sarif-2.1.0-rtm.5"] = 672,
    ["sarif-2.1.0-rtm.6"] = 673,
    ["sarif-external-property-file-2.1.0"] = 676,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 667,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 669,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 671,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 674,
    ["scalingo.json configuration"] = 677,
    ["schema.org - Action"] = 679,
    ["schema.org - ContactPoint"] = 680,
    ["schema.org - Place"] = 681,
    ["schema.org - Thing"] = 682,
    ["secrethub.yml"] = 988,
    ["semantic-release"] = 688,
    ["servicehub.config.json"] = 844,
    ["servicehub.service.json"] = 843,
    ["settings.job"] = 691,
    ["sfdx-hardis configuration"] = 693,
    ["shard.yml"] = 1026,
    ["size-limit configuration"] = 698,
    ["skaffold.yaml"] = 911,
    ["skyuxconfig.json"] = 700,
    snapcraft = 701,
    ["snowflake-config"] = 702,
    ["snowflake-connections"] = 703,
    ["spicepod.yaml"] = 1046,
    ["sqlc configuration"] = 734,
    ["stripe-app-local.json"] = 743,
    ["stripe-app.json"] = 742,
    swcrc = 896,
    ["task.json"] = 752,
    taskcat = 861,
    ["template.json"] = 757,
    ["templatsources.json"] = 758,
    ["theme.json"] = 761,
    ["tizen_workspace.json"] = 763,
    tldr = 764,
    ["tm_devices configuration file"] = 1109,
    tmuxinator = 847,
    ["transcend.yml"] = 774,
    ["tree-sitter grammar.json"] = 371,
    ["trime.yaml"] = 775,
    ["trunk.yaml"] = 777,
    ["ts-force-config.json"] = 782,
    ["tsconfig.json"] = 778,
    ["tsd.json"] = 779,
    ["tsdoc.json"] = 780,
    ["tsdrc.json"] = 781,
    ...
    ["vega-lite.json"] = 806,
    ["vega.json"] = 805,
    ["venvironment-basic.yaml"] = 809,
    ["venvironment.yaml"] = 808,
    ["venvplus-basic.yaml"] = 811,
    ["venvplus.yaml"] = 810,
    version = 1091,
    ["version.json"] = 813,
    ["vhwdebugger-binding.yaml"] = 815,
    ["vim-addon-info"] = 816,
    ["vs-2017.3.host.json"] = 818,
    ["vs-nesting.json"] = 819,
    ["vsls.json"] = 817,
    ["vss-extension.json"] = 823,
    vtcfg = 1097,
    ["vtesttree.yaml"] = 824,
    ["vtestunit.yaml"] = 825,
    ["warp-keysets.json"] = 994,
    ["warp-themes.json"] = 995,
    ["warp-workflows.json"] = 996,
    ["webhint.io"] = 951,
    ["webjobpublishsettings.json"] = 830,
    ["webjobs-list.json"] = 829,
    ["well-known-fursona"] = 1033,
    ["xs-app.json"] = 856,
    ["xunit.runner.json"] = 842,
    yamllint = 884,
    zuul = 867,
    ["Žinoma"] = 877
  },
