...
M.json = {
  ...
  index = {
    ...
    ["Adobe UXP Manifest"] = 916,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Alacritty Configuration"] = 828,
    ["All Contributors configuration file"] = 881,
    ...
    ["BX CI"] = 107,
    ["Bashly (bashly.yml)"] = 885,
    ["Bashly Settings (bashly-settings.yml)"] = 886,
    ["Better Code Hub"] = 800,
    ["Better Scripts"] = 108,
    Bigconfig = 83,
    ["Biome Formatter Config"] = 53,
    ["Bitmovin Encoding Template"] = 970,
    BizTalkServerApplicationSchema = 769,
    Bleep = 109,
    ...
    ["Butane Config"] = 841,
    ["CGS Custom Card Game (CardGameDef.json)"] = 921,
    ["CICS TS region tagging"] = 850,
    ["CICS TS resource import"] = 851,
    ["CICS TS resource model"] = 852,
    ["CICS TS resource overrides"] = 853,
    ["CMake Presets"] = 110,
    ["CNC Codes"] = 125,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 893,
    ["EAS config"] = 282,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 882,
    ["EasyVCR .NET"] = 283,
    ...
    ["Goreleaser Pro"] = 340,
    Goss = 341,
    ["Gradle Build Cache Node"] = 798,
    ["Gradle Enterprise"] = 797,
    ...
    Hadolint = 779,
    Hammerkit = 807,
    ["Hardware Sentry Configuration"] = 861,
    Hatch = 780,
    Hayson = 354,
    ...
    ["JFrog File Spec"] = 383,
    ["JFrog Pipelines YML DSL"] = 870,
    ["JMeter DSL cli config"] = 384,
    JReleaser = 386,
    ["JSON Document Transform"] = 394,
    ["JSON Feed"] = 395,
    ["JSON Resume"] = 598,
    ["JSON Schema Draft 2020-12"] = 749,
    ["JSON Schema Draft 4"] = 746,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 903,
    ["JSON Schema Draft 7"] = 747,
    ["JSON Schema Draft 7 (unofficial strict)"] = 904,
    ["JSON Schema Draft 8 (2019-09)"] = 748,
    ["JSON-API"] = 393,
    ["JSON-WF"] = 932,
    ["JSON-e templates"] = 805,
    ["JSON-stat 2.0"] = 742,
    JSONPatch = 397,
    ...
    ["MongoDB Atlas Search Index Definition"] = 865,
    ["Monika Configuration"] = 863,
    ["Monoweave Configuration"] = 472,
    ["Motif config"] = 762,
    ["NOX Framework (Service)"] = 489,
    ["Netin Diagnostic System Template"] = 823,
    ["Netlify config"] = 480,
    ...
    ["OpenUtau ustx"] = 507,
    ["OpenWeather Current Weather API"] = 804,
    ["OpenWeather Road Risk API"] = 803,
    ...
    ["Quali Torque Blueprint Spec 2"] = 858,
    ["QueryFirst config file"] = 876,
    ["RKE Cluster Configuration JSON"] = 812,
    ["RKE Cluster Configuration YAML"] = 811,
    ["Rancher Fleet"] = 574,
    ["Rattler-build"] = 581,
    Ray = 778,
    ["Read the Docs"] = 576,
    ...
    ["Render Blueprints"] = 810,
    RenderCV = 600,
    Renovate = 599,
    ["Replit config"] = 594,
    RoadRunner = 602,
    ["Rudder techniques"] = 914,
    Ruff = 596,
    ["Rust Project"] = 597,
    ["Rust toolchain"] = 606,
    ...
    ["SauceCTL Configuration"] = 820,
    ["Schema Catalog"] = 623,
    ["Scoop manifest"] = 628,
    ["Semantic Data Fabric (SDF) file"] = 632,
    ["Semgrep Rule"] = 634,
    ["Serenity Code Generator (Sergen)"] = 635,
    ["Serverless Framework Configuration"] = 827,
    ["Serverless Workflow"] = 829,
    ["Settings for a Cinnamon spice"] = 957,
    ["Settings.paf"] = 637,
    ["Shopware 6 Configuration"] = 830,
    ["Shopware CLI Extension Store Configuration"] = 831,
    ["Shopware CLI Project Store Configuration"] = 832,
    ["Sigma Detection Rule"] = 639,
    ["Sigrid scope configuration file"] = 640,
    ["SkyPilot Task JSON"] = 915,
    ...
    StackBlitz = 660,
    ["StackHawk Scanner Configuration"] = 826,
    Stale = 661,
    ["Starlake Data Pipeline"] = 801,
    Starship = 662,
    ...
    Talhelper = 673,
    ["Talisman configuration"] = 674,
    ["Taskfile config"] = 806,
    Taurus = 675,
    Tauticord = 676,
    ["TestEnvironment.json"] = 685,
    ["TextMate Grammar"] = 684,
    ["Tier.run pricing.json"] = 679,
    Tikibase = 680,
    ["Traefik v2"] = 688,
    ["Traefik v2 File Provider"] = 689,
    ["Travis CI (.travis.yml)"] = 687,
    ["TrueScript for *.tscript files"] = 692,
    TunnelHub = 907,
    Turborepo = 686,
    Tycho = 953,
    Tye = 834,
    ["UET BuildConfig.json"] = 877,
    ["UI5 Manifest"] = 710,
    ["UNCORS configuration"] = 714,
    ["UTAM Page Object"] = 713,
    ["Ubuntu Server Autoinstall"] = 708,
    ["Uniswap Token List"] = 789,
    ["Unreal Engine Uplugin"] = 878,
    ["Unreal Engine Uproject"] = 879,
    ["Updatecli Compose"] = 842,
    ["Updatecli Policy Manifest"] = 843,
    ["Updatecli Policy Metadata"] = 844,
    Uplift = 875,
    ["User Journey Map"] = 809,
    V2Ray = 848,
    ["VSCode Code Snippets"] = 182,
    ["VSIX CLI publishing"] = 731,
    ["Vela Pipeline Configuration"] = 718,
    Vercel = 181,
    ["Version Bumper config"] = 721,
    Visivo = 905,
    ["Waku Config"] = 966,
    ["Web App Manifest"] = 737,
    ["Web types"] = 740,
    WebExtensions = 736,
    ["Webman package recipe"] = 854,
    ["Windows Package Manager Installer Manifest"] = 786,
    ["Windows Package Manager Locale Manifest"] = 787,
    ["Windows Package Manager Singleton Manifest"] = 785,
    ["WireMock stub mapping"] = 969,
    ["Woodpecker pipeline config"] = 822,
    ["Wrangler CLI"] = 741,
    ["Xstate Machine"] = 840,
    ["Yandex Workflow Language"] = 959,
    ["Yarn Config (.yarnrc.yml)"] = 799,
    ["Yippee-Ki-JSON configuration YML"] = 791,
    ["YouTrack App"] = 956,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 909,
    ...
    ["behat.yml"] = 92,
    ["bigquery-table"] = 82,
    ["bioimageio resource description"] = 925,
    ...
    ["lint-staged (.lintstagedrc)"] = 757,
    ["local.settings.json"] = 435,
    ["localazy.json"] = 436,
    ["lotus.yaml"] = 434,
    ["lsdlschema.json"] = 437,
    ["markdown-link-check"] = 818,
    mboats = 825,
    ["micro-settings.json"] = 889,
    ["mimetypes.json"] = 449,
    ["mirrord config"] = 758,
    mise = 759,
    ["mkdocs.yml"] = 469,
    ...
    ["servicehub.config.json"] = 752,
    ["servicehub.service.json"] = 751,
    ["settings.job"] = 636,
    ...
    taskcat = 768,
    ["template.json"] = 677,
    ["templatsources.json"] = 678,
    ["theme.json"] = 681,
    ["tizen_workspace.json"] = 682,
    tldr = 683,
    tmuxinator = 755,
    ["transcend.yml"] = 690,
    ...
    ["vega-lite.json"] = 717,
    ["vega.json"] = 716,
    ["venvironment-basic.yaml"] = 720,
    ["venvironment.yaml"] = 719,
    ["version.json"] = 722,
    ["vhwdebugger-binding.yaml"] = 724,
    ["vim-addon-info"] = 725,
    ["vs-2017.3.host.json"] = 727,
    ["vs-nesting.json"] = 728,
    ["vsls.json"] = 726,
    ["vss-extension.json"] = 732,
    ["vtesttree.yaml"] = 733,
    ["vtestunit.yaml"] = 734,
    ["warp-keysets.json"] = 898,
    ["warp-themes.json"] = 899,
    ["warp-workflows.json"] = 900,
    ["webhint.io"] = 855,
    ["webjobpublishsettings.json"] = 739,
    ["webjobs-list.json"] = 738,
    ["well-known-fursona"] = 936,
    ["xs-app.json"] = 764,
    ["xunit.runner.json"] = 750,
    yamllint = 790,
