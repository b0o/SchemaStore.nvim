...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 929,
    [".nodehawkrc"] = 573,
    [".npmpackagejsonlintrc"] = 577,
    [".omletrc"] = 1108,
    [".phrase.yml"] = 650,
    [".phraseapp.yml"] = 651,
    [".pmbot.yml"] = 636,
    [".postcssrc"] = 645,
    [".powerpages-web-template-manifest"] = 647,
    [".pre-commit-config.yml"] = 648,
    [".pre-commit-hooks.yml"] = 649,
    [".putout.json"] = 684,
    [".rehyperc"] = 709,
    [".remarkrc"] = 713,
    [".sprite files"] = 804,
    ...
    ["A micro editor config"] = 520,
    ABCClinicalDemandForecast = 24,
    ABCInventoryModuleData = 23,
    ABCSupplyPlan = 25,
    ["ACP Attempts"] = 26,
    ["ACP Cache File"] = 27,
    ["ACP Configuration File"] = 28,
    ["ACP Primer"] = 29,
    ["ACP Sync"] = 30,
    ["ACP Variables File"] = 31,
    AIConfig = 32,
    ["AMX Muse Program Descriptor"] = 1156,
    ["API Builder"] = 964,
    ["AVA Configuration"] = 1027,
    ["AWS AppConfig Feature Flags-v1"] = 66,
    ["AWS CDK cdk.json"] = 254,
    ["AWS CloudFormation"] = 255,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 256,
    ["AWS Copilot Manifest"] = 1195,
    ["AWS SAM CLI Samconfig"] = 257,
    ["Adobe UXP Manifest"] = 1090,
    ["Aerleon Network & Service Definitions"] = 18,
    ["Aerleon Policy"] = 19,
    Aider = 1185,
    Air = 21,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1206,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1205,
    ["Airlock Microgateway"] = 33,
    ["Alacritty Configuration"] = 999,
    ["All Contributors configuration file"] = 1053,
    ["Ansible Argument Specs"] = 393,
    ["Ansible Collection Galaxy"] = 400,
    ["Ansible Execution Environment"] = 390,
    ["Ansible Inventory"] = 399,
    ["Ansible Meta"] = 391,
    ["Ansible Meta Runtime"] = 392,
    ["Ansible Navigator Configuration"] = 402,
    ["Ansible Playbook"] = 397,
    ["Ansible Requirements"] = 394,
    ["Ansible Rulebook"] = 398,
    ["Ansible Tasks File"] = 396,
    ["Ansible Vars File"] = 395,
    ["Ansible-lint Configuration"] = 401,
    Any = 1118,
    ["AnyWork Automation Configuration"] = 14,
    ["Apollo Router"] = 965,
    ["App config Spotify Backstage"] = 37,
    ["Applicant Profile Protocol"] = 11,
    ["Application Accelerator"] = 9,
    ["Application list for a WinUtil"] = 1135,
    ArchitectFX = 1140,
    ["Argo CD"] = 52,
    ["Argo Events"] = 53,
    ["Argo Workflows"] = 54,
    AssemblyScript = 57,
    AsyncAPI = 60,
    ["AsyncAPI Tool File"] = 61,
    ["Atmos Manifests"] = 62,
    ["Aurora Agile Meta-Framework"] = 63,
    AutoAPICase = 1063,
    ["Avro Avsc"] = 64,
    ["Awesome Repositories"] = 65,
    ["Azure Container App template for defining an immutable revision"] = 67,
    ["Azure DevOps extension manifest"] = 70,
    ["Azure Device Update for IoT Hub import manifest"] = 68,
    ["Azure Device Update for IoT Hub update manifest"] = 69,
    ["Azure IoT Edge deployment"] = 73,
    ["Azure IoT Edge deployment template"] = 74,
    ["Azure IoT EdgeAgent deployment"] = 71,
    ["Azure IoT EdgeHub deployment"] = 72,
    ["Azure IoT Operations Wasm Graph Config"] = 1204,
    ["Azure IoT Operations connector metadata"] = 1201,
    ["Azure Landing Zones Library archetype definition"] = 78,
    ["Azure Landing Zones Library archetype override"] = 79,
    ["Azure Landing Zones Library architecture definition"] = 77,
    ["Azure Landing Zones Library metadata"] = 75,
    ["Azure Landing Zones Library policy default values"] = 76,
    ["Azure Pipelines"] = 108,
    ["Azure Static Web Apps CLI configuration file"] = 808,
    ["Azure Static Web Apps configuration file"] = 807,
    BMML = 1223,
    ["BOSH CPI Config"] = 133,
    ["BOSH Deploy Config"] = 134,
    ["BX CI"] = 153,
    ["Bacon config"] = 3,
    ["Bashly (bashly.yml)"] = 1057,
    ["Bashly Settings (bashly-settings.yml)"] = 1058,
    Bento = 1222,
    ["Better Code Hub"] = 969,
    ["Better Scripts"] = 154,
    Bigconfig = 126,
    ["Biome Formatter Config"] = 80,
    ["Bitmovin Encoding Template"] = 1149,
    BizTalkServerApplicationSchema = 936,
    Bleep = 155,
    ["Block Protocol Metadata"] = 152,
    ["Bluebricks blueprint config"] = 1228,
    ["Boyka Framework"] = 135,
    Briefcase = 942,
    ["Build Info"] = 143,
    Buildkite = 145,
    ["Bukkit plugin.yml"] = 144,
    ["BungeeCord plugin.yml"] = 150,
    ["Butane Config"] = 1012,
    C4InterFlow = 1164,
    ["CDK Environment Manager, concrete environment configuration"] = 1188,
    ["CDK Environment Manager, concrete environments definition"] = 1187,
    ["CDK Environment Manager, environment definition"] = 1186,
    ["CGS Card Game Specification (cgs.json)"] = 1095,
    ["CICS TS region tagging"] = 1021,
    ["CICS TS resource import"] = 1022,
    ["CICS TS resource model"] = 1023,
    ["CICS TS resource overrides"] = 1024,
    ["CMake Presets"] = 156,
    ["CNC Codes"] = 178,
    ["CRS WAF test file"] = 1125,
    ["CRS WAF test platform overrides file"] = 1126,
    ["CSS Comb (.csscomb.json)"] = 282,
    ["CSS Lint (.csslintrc)"] = 283,
    ["CSpell (cspell.json)"] = 281,
    ["CVE Record Format"] = 187,
    CWL = 1101,
    ["Cache Warmup config"] = 157,
    ["Calqulus pipeline"] = 158,
    ["Camel YAML DSL"] = 159,
    ["Cannon TOML"] = 160,
    Carafe = 161,
    ["Cargo Make"] = 163,
    ["Cargo Manifest"] = 162,
    ["Catalog Info Backstage"] = 164,
    ["Chamaleon environment"] = 1153,
    ["Chamaleon properties"] = 1154,
    ["Chamaleon template"] = 1152,
    Changepacks = 1215,
    Changesets = 266,
    Changie = 165,
    Charmcraft = 166,
    Cheatsheets = 1009,
    ["ChordPro Configuration"] = 167,
    ["Chrome Extension"] = 247,
    ["Chromia Model"] = 168,
    ["Chromia Seeder Module Config"] = 170,
    ["Chromia Seeder Root Config"] = 169,
    ["Cinnamon Spice info.json"] = 88,
    ["CircleCI config.yml"] = 222,
    ["Citation File Format"] = 268,
    ["Citrus test case"] = 172,
    CityJSON = 173,
    ["Claude Code Keybindings"] = 185,
    ["Claude Code Settings"] = 186,
    ["Clawject config"] = 184,
    ["Cloud Foundry Application Manifest"] = 1107,
    ["Cloud Run Spec v1"] = 1130,
    ["Cloud.gov Workshop Configuration"] = 89,
    ["CloudCannon Configuration"] = 94,
    ["CloudCannon Configuration (Collection Structures)"] = 103,
    ["CloudCannon Configuration (Collections)"] = 102,
    ["CloudCannon Configuration (Editables)"] = 101,
    ["CloudCannon Configuration (Inputs)"] = 96,
    ["CloudCannon Configuration (Snippets Definitions)"] = 100,
    ["CloudCannon Configuration (Snippets Imports)"] = 99,
    ["CloudCannon Configuration (Snippets)"] = 98,
    ["CloudCannon Configuration (Structure Value)"] = 97,
    ["CloudCannon Configuration (Structures)"] = 95,
    ["CloudEvents specification"] = 174,
    ["Code Climate"] = 223,
    CodeCV = 92,
    CodeRabbit = 91,
    ["CodeShip Pro services configuration files"] = 236,
    ["CodeShip Pro steps configuration files"] = 237,
    ["Codecov configuration files"] = 235,
    Codex = 231,
    CodifyCLI = 93,
    Codux = 233,
    ["Cog config file"] = 179,
    ["Commandbox Box.json"] = 180,
    ["Commandbox Server.json"] = 181,
    ["Common Catalog Data"] = 245,
    ["Common Package Specification"] = 182,
    Concord = 1124,
    ["Configu .cfgu files"] = 1112,
    ["Configu .configu file"] = 1113,
    Conjure = 177,
    ["Container Structure Test"] = 950,
    Containerlab = 978,
    ["Contextive Glossary"] = 1180,
    Convex = 176,
    ["Crowdsec collection config"] = 276,
    ["Crowdsec parser config"] = 277,
    ["Crowdsec scenario config"] = 278,
    ["CumulusCI Config"] = 183,
    ["Custom Machinery Machine"] = 1096,
    ["Custom Machinery Recipe"] = 1097,
    ["Cycle Stack File"] = 188,
    CycloneDX = 189,
    ["DWP Exchange - catalogue entry"] = 327,
    ["DWP Exchange - gateway"] = 325,
    ["DWP Exchange - meta"] = 326,
    ["Dart Build Config (dart-build.json)"] = 284,
    ["Dart Test Config (dart-test.json)"] = 285,
    ["DashLord Configuration"] = 286,
    ["Data Contract Specification"] = 287,
    ["Data Product Specification"] = 288,
    ["DataYoga Connections"] = 190,
    ["DataYoga Job"] = 191,
    ["Databricks Asset Bundles"] = 1074,
    ["Datadog Continuous Testing"] = 491,
    ["Datadog Service Definition"] = 492,
    ["Datadog Software Catalog"] = 493,
    ["Datahub Ingestion Recipe"] = 1028,
    ["Debian Upstream Metadata file"] = 197,
    ["Deck config"] = 198,
    ["Dein Config"] = 199,
    ["Deno Config (deno.json)"] = 294,
    ["Dependency cruiser"] = 200,
    ["DeployStack Configuration"] = 201,
    ["Deployah Configuration"] = 1203,
    ["Deployer Recipe"] = 297,
    ["Deta Spacefile"] = 202,
    ["Detekt Config (detekt.yml)"] = 298,
    ["Devbox Config"] = 203,
    ["Devbox Plugin"] = 204,
    Devfile = 324,
    Devup = 1216,
    DipDup = 1127,
    ["Discord Webhook"] = 299,
    ["DocFx Config (docfx.json)"] = 304,
    ["Docker Desktop extension metadata"] = 301,
    ["Docs MCP Manifest"] = 305,
    Dofigen = 306,
    ["Dolittle Artifacts"] = 307,
    ["Dolittle Bounded Context Configuration"] = 308,
    ["Dolittle Event Horizons Configuration"] = 309,
    ["Dolittle Resources Configuration"] = 310,
    ["Dolittle Server Configuration"] = 311,
    ["Dolittle Tenant Map Configuration"] = 313,
    ["Dolittle Tenants Configuration"] = 312,
    ["Dolittle Topology"] = 314,
    ["DonateCaseBetterCasino menu"] = 1157,
    ["Drupal Breakpoints"] = 205,
    ["Drupal Config"] = 217,
    ["Drupal Info"] = 206,
    ["Drupal Layouts"] = 207,
    ["Drupal Libraries"] = 208,
    ["Drupal Links Action"] = 209,
    ["Drupal Links Contextual"] = 210,
    ["Drupal Links Menu"] = 211,
    ["Drupal Links Task"] = 212,
    ["Drupal Migration"] = 213,
    ["Drupal Permissions"] = 214,
    ["Drupal Recipe"] = 215,
    ["Drupal Routing"] = 216,
    ["Drupal Services"] = 218,
    ["Drush site aliases"] = 320,
    ["Dynamic Bash Aliases (.aliases)"] = 1065,
    ["EAS config"] = 345,
    ["ECA - Editor Code Assistant"] = 329,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1054,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1200,
    ["EasyVCR .NET"] = 346,
    ["Eidolon Resource"] = 1141,
    ["Elgato Stream Deck"] = 331,
    Elm = 1129,
    ["Embrace Config"] = 1040,
    Endurica = 1078,
    ["Enterprise Contract Policy Spec"] = 332,
    ["Erda Pipeline"] = 1103,
    ["Erda Runtime"] = 1104,
    ["Espanso config.yml"] = 1226,
    ["Espanso match.yml"] = 1225,
    Esquio = 334,
    ["Estuary Flow Catalog"] = 1018,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 338,
    ["EveryVoice TTS Toolkit Data Configuration"] = 339,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 343,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 342,
    ["EveryVoice TTS Toolkit Text Configuration"] = 340,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 341,
    ["Evolving Resolutive Process notation"] = 1202,
    ["Expo SDK"] = 344,
    ["F-Droid Data metadata"] = 350,
    ["FasterCI Configuration"] = 109,
    FiQuS = 354,
    Firebase = 352,
    ["Flatpak Builder Manifest"] = 355,
    ["FlexGet Config"] = 356,
    ["Flow.json Configurations"] = 1100,
    ["Fossa configuration file"] = 363,
    ["Fossa's fossa-deps file"] = 364,
    ["Foundry VTT - Base package Manifest"] = 358,
    ["Foundry VTT - Module Manifest"] = 359,
    ["Foundry VTT - System Data Template"] = 362,
    ["Foundry VTT - System Manifest"] = 360,
    ["Foundry VTT - World Manifest"] = 361,
    ["Foxx Manifest"] = 110,
    ["Freifunk.de Community API"] = 113,
    ["Frogbot Config"] = 114,
    ["G2P Mapping Configuration"] = 370,
    ["GCP Blueprint Metadata"] = 373,
    Gaspar = 371,
    ["GatewayCore API Gateway"] = 372,
    ["Gemini CLI settings"] = 374,
    ["GeoJSON.json latest"] = 1016,
    GherKing = 1020,
    ["GitHub Action"] = 379,
    ["GitHub Actions typing"] = 1137,
    ["GitHub Discussion"] = 380,
    ["GitHub Funding"] = 381,
    ["GitHub Issue Template configuration"] = 382,
    ["GitHub Issue Template forms"] = 383,
    ["GitHub Workflow"] = 384,
    ["GitHub Workflow Template Properties"] = 385,
    ["GitHub automatically generated release notes configuration"] = 386,
    ["GitLab Agent for Kubernetes configuration"] = 1092,
    GitVersion = 376,
    ["Gitea Issue Template configuration"] = 377,
    ["Gitea Issue Template forms"] = 378,
    ["Gitpod Automations"] = 388,
    ["Gitpod Configuration"] = 389,
    ["GlazeWM settings"] = 1094,
    ["Global Privacy Control"] = 375,
    Goblet = 1073,
    ["Golangci-lint Configuration"] = 404,
    ["Golangci-lint Custom Plugins Configuration"] = 405,
    ["Google Chrome Related Website Sets"] = 353,
    ["Google Cloud Workflows"] = 253,
    ["Google Digital Assetlinks"] = 1181,
    Goreleaser = 407,
    ["Goreleaser Pro"] = 408,
    Goss = 409,
    ["Gradle Build Cache Node"] = 967,
    ["Gradle Enterprise"] = 966,
    ["Grafana 5.x Dashboard"] = 410,
    ["GraphQL Code Generator"] = 415,
    ["GraphQL Config"] = 414,
    ["GraphQL Mesh"] = 413,
    ["GroovyLint configuration"] = 416,
    ["Grunt JSHint task"] = 420,
    ["Grunt Watch task"] = 421,
    ["Grunt base task"] = 422,
    ["Grunt clean task"] = 418,
    ["Grunt copy task"] = 417,
    ["Grunt cssmin task"] = 419,
    HEMTT = 932,
    Hadolint = 946,
    Hammerkit = 977,
    ["Hardware Sentry Configuration"] = 1032,
    ["HashiCorp Vault"] = 423,
    Hatch = 947,
    Hayson = 425,
    ["Haystack Pipeline"] = 426,
    ["Hazelcast 5 Configuration"] = 427,
    ["Hecate Input Schema"] = 1192,
    ["Helm Chart.lock"] = 220,
    ["Helm Chart.yaml"] = 219,
    ["Helm Unittest Test Suite"] = 221,
    ["Home Assistant Integration Manifest"] = 428,
    ["Homer dashboard configuration"] = 429,
    Hugo = 1008,
    ["Hugo Theme"] = 1007,
    ["Hulak Configuration"] = 436,
    ["Hyperfoil benchmark configuration"] = 435,
    ["IBM Zapp document"] = 437,
    ["IBM zCodeFormatSettings"] = 438,
    ["IMG Catapult PSP"] = 443,
    ["IVMS101 by CODE Protocol"] = 1093,
    Infrahub = 445,
    Istanbul = 1036,
    ["JDownloader2 crawler multi-rules"] = 458,
    ["JDownloader2 crawler single-rules"] = 457,
    ["JFrog Applications Config"] = 459,
    ["JFrog File Spec"] = 460,
    ["JFrog Pipelines YML DSL"] = 1042,
    ["JMeter DSL cli config"] = 461,
    JReleaser = 464,
    ["JSON Document Transform"] = 472,
    ["JSON Feed"] = 473,
    ["JSON Resume"] = 719,
    ["JSON Schema Draft 2020-12"] = 914,
    ["JSON Schema Draft 4"] = 911,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1075,
    ["JSON Schema Draft 7"] = 912,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1076,
    ["JSON Schema Draft 8 (2019-09)"] = 913,
    ["JSON-API"] = 471,
    ["JSON-e templates"] = 974,
    ["JSON-stat 2.0"] = 907,
    JSONPatch = 475,
    ["JSR Package Config (jsr.json)"] = 465,
    Jarl = 1208,
    Jasmine = 452,
    Jekyll = 453,
    ["Jenkins X Pipelines"] = 454,
    ["Jenkins X Requirements"] = 455,
    Jest = 456,
    Jocker = 462,
    ["Jovo Language Models"] = 463,
    ["Jujutsu (jj) VCS config"] = 1194,
    ["KIMMDY config file"] = 486,
    ["KODE/CI build.yaml"] = 1038,
    ["KSP-AVC"] = 908,
    ["KSP-CKAN"] = 909,
    ["KSP-NetKAN"] = 910,
    KSY = 1105,
    KSail = 368,
    ["KYA Manifest"] = 1106,
    ["Karakum configuration file"] = 365,
    Kas = 478,
    ["Kestra flow file"] = 487,
    ["Keycloak REST API"] = 1045,
    ["Knative Functions - func.yaml"] = 366,
    Knip = 367,
    ["Kometa (nightly) config file"] = 489,
    ["Kometa config file"] = 488,
    ["Kong DBLess config"] = 1039,
    KrakenD = 490,
    ["Kubri Configuration"] = 497,
    LOOBin = 512,
    ["Lake configuration file"] = 1197,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 258,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 259,
    ["Landing Zone Accelerator on AWS - Global Config"] = 260,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 261,
    ["Landing Zone Accelerator on AWS - Network Config"] = 262,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 263,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 264,
    ["Landing Zone Accelerator on AWS - Security Config"] = 265,
    ["Lando (landofile)"] = 104,
    ["LangGraph Platform configuration"] = 1117,
    ["Language configuration"] = 1116,
    Lefthook = 501,
    ["Liferay client-extension.yaml"] = 508,
    ["LinkML Metamodel"] = 510,
    Liquibase = 983,
    ["Liquibase Flow File"] = 984,
    ["Lively Properties"] = 511,
    ["Lobe AI Agent"] = 106,
    Loki = 107,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 552,
    ["MS2Rescore Configuration"] = 556,
    ["Madness (madness.yml)"] = 1056,
    ["Mado configuration"] = 518,
    ["Mail Servers Configuration"] = 1229,
    ["MapEHR Mapping"] = 519,
    Markdownlint = 987,
    ["Mason Registry"] = 990,
    ["MegaLinter Custom Flavor"] = 522,
    ["MegaLinter configuration"] = 521,
    ["MegaLinter descriptor"] = 523,
    Melange = 1083,
    ["Meltano project definition"] = 524,
    ["Mergify Configuration"] = 557,
    ["Metadata for a Bazel module"] = 525,
    ["Metadata for a Cinnamon spice"] = 1133,
    ["Metatype Configuration"] = 526,
    ["MetricsHub Configuration"] = 527,
    ["MetricsHub Connector Configuration"] = 528,
    ["Micro Editor Syntax"] = 1066,
    ["Microsoft Band Web Tile"] = 529,
    ["Microsoft RulesEngine workflow rules"] = 1121,
    ["Microsoft RulesEngine workflow rules list"] = 1122,
    ["Minecraft Custom Main Menu Mod"] = 1084,
    ["Minecraft Data Pack Advancement"] = 531,
    ["Minecraft Data Pack Biome"] = 532,
    ["Minecraft Data Pack Configured Carver"] = 533,
    ["Minecraft Data Pack Damage Type"] = 534,
    ["Minecraft Data Pack Dimension"] = 536,
    ["Minecraft Data Pack Dimension Type"] = 535,
    ["Minecraft Data Pack Item Modifier"] = 537,
    ["Minecraft Data Pack Loot Table"] = 538,
    ["Minecraft Data Pack Metadata"] = 539,
    ["Minecraft Data Pack Predicate"] = 540,
    ["Minecraft Data Pack Recipe"] = 541,
    ["Minecraft Data Pack Tag"] = 542,
    ["Minecraft Data Pack Template Pool"] = 543,
    ["Minecraft Data Pack Trim Material"] = 548,
    ["Minecraft Data Pack Trim Pattern"] = 549,
    ["Minecraft Resource Pack Lang"] = 544,
    ["Minecraft Resource Pack Particle"] = 545,
    ["Minecraft Resource Pack Texture Mcmeta"] = 547,
    ["Minecraft Resourcepack Sounds"] = 546,
    ["Monade CLI Stack Configuration"] = 560,
    ["MongoDB Atlas Search Index Definition"] = 1037,
    ["Monika Configuration"] = 1035,
    ["Monoweave Configuration"] = 555,
    ["Motif config"] = 928,
    MultiQC = 1174,
    ["NOX Framework (Service)"] = 576,
    ["Netin Diagnostic System Template"] = 994,
    ["Netlify config"] = 563,
    ["Network-as-Code Data Model"] = 564,
    ["Next Gen UI Agent A2A Server Configuration"] = 565,
    ["Next Gen UI Agent Configuration"] = 567,
    ["Next Gen UI Agent MCP Server Configuration"] = 566,
    ["Nightwatch.js"] = 569,
    ["Node.js configuration"] = 933,
    ["NueJS configuration file"] = 581,
    ["Nuitka.yaml"] = 1098,
    ["Nullstone config"] = 583,
    ["ONe's changelog entry"] = 602,
    ["ONe's service descriptor"] = 601,
    ["ORT Server repository environment configuration"] = 612,
    ["OSCAL Assessment Plan (AP)"] = 614,
    ["OSCAL Assessment Results (AR)"] = 615,
    ["OSCAL Catalog"] = 616,
    ["OSCAL Component Definition (CDef)"] = 617,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 618,
    ["OSCAL Profile"] = 619,
    ["OSCAL System Security Plan (SSP)"] = 620,
    ["OSS Review Toolkit configuration"] = 621,
    ["OSS Review Toolkit curation"] = 622,
    ["OSS Review Toolkit package configuration"] = 623,
    ["OSS Review Toolkit repository configuration"] = 624,
    ["OSS Review Toolkit resolutions"] = 625,
    ["October CMS columns"] = 587,
    ["October CMS fields"] = 588,
    ["Oh My Posh"] = 590,
    Okteto = 591,
    ["Ona Automations"] = 593,
    Opctl = 931,
    ["Open Data Contract Standard (ODCS)"] = 606,
    ["Open Data Product Standard (ODPS)"] = 607,
    ["Open Know-How"] = 1179,
    ["OpenRewrite Resource"] = 604,
    OpenSRM = 608,
    OpenStatus = 1190,
    ["OpenTelemetry Declarative Configuration"] = 605,
    ["OpenUtau character yaml"] = 598,
    ["OpenUtau ustx"] = 599,
    ["OpenWeather Current Weather API"] = 973,
    ["OpenWeather Road Risk API"] = 972,
    ["Ory Hydra configuration"] = 434,
    ["Ory Keto configuration"] = 494,
    ["Ory Kratos configuration"] = 613,
    ["Ory Oathkeeper configuration"] = 585,
    ["Outblocks App configuration"] = 610,
    ["Outblocks database table"] = 611,
    ["Outblocks project configuration"] = 609,
    PDM = 632,
    POPxf = 642,
    ["POPxf Correlations"] = 643,
    Packer = 629,
    Pantsbuild = 1052,
    ["Paper paper-plugin.yml"] = 630,
    ["Pipeline component"] = 985,
    ["Platform.sh application"] = 5,
    ["Platform.sh routes"] = 6,
    ["Platform.sh services"] = 7,
    ["Plex Prerolls"] = 640,
    ["PocketMine plugin.yml"] = 637,
    ["Postman collection"] = 646,
    ["Power Pages Configuration"] = 1191,
    ["Preset list for a WinUtil"] = 1136,
    ["ProActions AI-Kit Configuration"] = 657,
    ["ProActions AI-Kit Configuration for Menus"] = 659,
    ["ProActions AI-Kit Configuration for Sections"] = 661,
    ["ProActions AI-Kit Configuration for Services"] = 658,
    ["ProActions AI-Kit Configuration for Steps"] = 662,
    ["ProActions AI-Kit Configuration for Templates"] = 660,
    ["Problem object RFC9457"] = 1081,
    ["Problem package format"] = 663,
    ["Problem package generators"] = 664,
    ["Problem package submissions"] = 665,
    ["Problem package test group metadata"] = 666,
    Pterodactyl = 1031,
    ["Pull Request Labeler"] = 683,
    Pulumi = 691,
    ["PyGTA Config"] = 687,
    PyProject = 692,
    Pylock = 1182,
    Pyright = 693,
    ["Python script metadata"] = 1176,
    ["QType AI DSL"] = 696,
    Qgoda = 695,
    Qodana = 1004,
    ["Qt Creator workspace file"] = 1114,
    ["Quali Torque Blueprint Spec 2"] = 1029,
    ["QueryFirst config file"] = 1048,
    ["RKE Cluster Configuration JSON"] = 982,
    ["RKE Cluster Configuration YAML"] = 981,
    RadioHound = 686,
    Railpack = 698,
    Railway = 697,
    ["Rancher Fleet"] = 688,
    ...
    Ray = 945,
    ["Read the Docs"] = 690,
    ["Red-DiscordBot Cog"] = 706,
    ["Red-DiscordBot Cog Repo"] = 707,
    ["Red-DiscordBot Trivia"] = 708,
    ["Releasaurus Config"] = 2,
    ["Render Blueprints"] = 980,
    RenderCV = 723,
    Renovate = 720,
    ["Renovate global configuration"] = 721,
    ["Renovate inherited configuration"] = 722,
    ["Replit config"] = 714,
    Restate = 1169,
    ["Revel Digital Gadget Definition File"] = 1193,
    RoadRunner = 725,
    ["Robust Station Image"] = 1199,
    Rockcraft = 726,
    ["Roo Coder Custom Modes"] = 727,
    Rubocop = 716,
    ["Rudder techniques"] = 1088,
    Ruff = 717,
    ["Rust Project"] = 718,
    ["Rust toolchain"] = 731,
    ["SDMX data message"] = 757,
    ["SDMX metadata message"] = 756,
    ["SDMX structure message"] = 755,
    ["SIL Kit Participant Configuration"] = 767,
    ["SIL Kit Registry Configuration"] = 768,
    ["SPDX 2.3"] = 805,
    SWADL = 821,
    ["Safebox Config"] = 1043,
    ["Sapphire CLI Config"] = 734,
    ["SauceCTL Configuration"] = 991,
    ["Schema Catalog"] = 749,
    ["Scoop manifest"] = 754,
    ["Semantic Data Fabric (SDF) file"] = 758,
    ["Semgrep Rule"] = 760,
    ["Serenity Code Generator (Sergen)"] = 761,
    ["Serverless Framework Configuration"] = 998,
    ["Serverless Workflow"] = 1000,
    ["Settings for a Cinnamon spice"] = 1132,
    ["Settings.paf"] = 763,
    ["Shopware 6 Configuration"] = 1001,
    ["Shopware CLI Extension Store Configuration"] = 1002,
    ["Shopware CLI Project Store Configuration"] = 1003,
    ["Sigma Detection Rule"] = 765,
    ["Sigrid scope configuration file"] = 766,
    ["SkyPilot Task JSON"] = 1089,
    ["Slack app manifest"] = 770,
    Snapcraft = 772,
    Solidarity = 775,
    ["Solution filters"] = 776,
    ["Source Maps v3"] = 777,
    Sourcery = 778,
    ["Spack bootstrap.yaml"] = 779,
    ["Spack cdash.yaml"] = 780,
    ["Spack ci.yaml"] = 781,
    ["Spack compilers.yaml"] = 782,
    ["Spack concretizer.yaml"] = 783,
    ["Spack config.yaml"] = 784,
    ["Spack definitions.yaml"] = 785,
    ["Spack develop.yaml"] = 786,
    ["Spack env_vars.yaml"] = 787,
    ["Spack environment"] = 793,
    ["Spack include.yaml"] = 788,
    ["Spack mirrors.yaml"] = 789,
    ["Spack modules.yaml"] = 790,
    ["Spack packages.yaml"] = 791,
    ["Spack repos.yaml"] = 792,
    ["Spack toolchains.yaml"] = 794,
    ["Spack upstreams.yaml"] = 795,
    ["Spack view.yaml"] = 796,
    ["Speakeasy Generation Config File"] = 800,
    ["Speakeasy Lint Configuration File"] = 797,
    ["Speakeasy Test Generation Configuration File"] = 798,
    ["Speakeasy Workflow File"] = 799,
    SpecIF = 801,
    ["Specmatic Configuration"] = 802,
    ["Sponge Mixin configuration"] = 803,
    StackBlitz = 809,
    ["StackHawk Scanner Configuration"] = 997,
    Stale = 810,
    Starfish = 811,
    ["Starlake Data Pipeline"] = 970,
    Starship = 812,
    ["Statamic Blueprint"] = 813,
    ["Stella configuration file"] = 814,
    ["Streamlit configuration file"] = 815,
    ["Stryker Mutator"] = 818,
    ["StyleCop Analyzers Configuration"] = 819,
    ["Stylelint (.stylelintrc)"] = 820,
    ["Stylua Config"] = 1183,
    ["Sublime Syntax"] = 1044,
    ["Subsquid squid manifest"] = 1091,
    ["Swagger API 2.0"] = 822,
    ["Synadia Connect Component"] = 823,
    TSON = 859,
    TSTyche = 860,
    ["TYPO3 Vendor Bundler config"] = 866,
    ["Tab data for a LinUtil"] = 1139,
    ["Tab list for a LinUtil"] = 1138,
    Tach = 824,
    ["Tach Domain"] = 825,
    Talhelper = 827,
    ["Talisman configuration"] = 828,
    Taplo = 1184,
    ["Taskfile config"] = 975,
    Taurus = 829,
    Tauticord = 830,
    ["Tekton Pipeline"] = 1212,
    ["Tekton PipelineRun"] = 1213,
    ["Tekton Task"] = 1210,
    ["Tekton TaskRun"] = 1211,
    Telefonistka = 1170,
    ["Terrateam config"] = 1196,
    ["TestEnvironment.json"] = 842,
    ["TextMate Grammar"] = 841,
    Threagile = 836,
    ["Tier.run pricing.json"] = 833,
    Tikibase = 834,
    Tombi = 839,
    ["Traefik v2"] = 845,
    ["Traefik v2 File Provider"] = 846,
    ["Traefik v3"] = 847,
    ["Traefik v3 File Provider"] = 848,
    ["Travis CI (.travis.yml)"] = 844,
    Treefmt = 412,
    Trident = 1166,
    ["TrueScript for *.tscript files"] = 851,
    ["Tugboat QA config.yml"] = 1163,
    TunnelHub = 1079,
    Turborepo = 843,
    Tycho = 1128,
    Tye = 1005,
    ["Tyk Gateway - Open Source v5.7+"] = 1175,
    ["UET BuildConfig.json"] = 1049,
    ["UI5 Manifest"] = 872,
    ["UNCORS configuration"] = 876,
    ["UTAM Page Object"] = 875,
    ["Ubuntu Server Autoinstall"] = 870,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1167,
    ["Uniswap Token List"] = 957,
    ["Universal Schedule Format"] = 877,
    ["Unreal Engine Uplugin"] = 1050,
    ["Unreal Engine Uproject"] = 1051,
    ["UpCloud CLI (upctl) configuration"] = 1168,
    ["Updatecli Compose"] = 1013,
    ["Updatecli Policy Manifest"] = 1014,
    ["Updatecli Policy Metadata"] = 1015,
    Uplift = 1047,
    ["Upsun config"] = 4,
    ["User Journey Map"] = 979,
    V2Ray = 1019,
    ["VSCode Code Snippets"] = 241,
    ["VSIX CLI publishing"] = 895,
    Vector = 879,
    ["Vela Pipeline Configuration"] = 882,
    Vercel = 240,
    ["Version Bumper config"] = 885,
    Vespertide = 1217,
    ["Vespertide Migration"] = 1218,
    ["Vespertide Model"] = 1219,
    ["Viash Component Config"] = 1172,
    ["Viash Package Config"] = 1173,
    Visivo = 1077,
    ["WP-CLI"] = 905,
    Wake = 1165,
    ["Waku Config"] = 1142,
    ["Web App Manifest"] = 901,
    ["Web types"] = 904,
    WebExtensions = 900,
    ["Webman package recipe"] = 1025,
    ["Windows Package Manager Installer Manifest"] = 953,
    ["Windows Package Manager Locale Manifest"] = 954,
    ["Windows Package Manager Singleton Manifest"] = 952,
    Winutil = 955,
    ["WireMock CLI import configuration"] = 1148,
    ["WireMock CLI local service configuration"] = 1147,
    ["WireMock message stub mapping"] = 1146,
    ["WireMock stub mapping"] = 1145,
    ["Woodpecker pipeline config"] = 993,
    ["Wrangler CLI"] = 906,
    ["Xstate Machine"] = 1011,
    ["Yandex Workflow Language"] = 1134,
    ["Yarn Config (.yarnrc.yml)"] = 968,
    ["Yippee-Ki-JSON configuration YML"] = 959,
    ["YouTrack App"] = 1131,
    ["Zarf Package Configuration"] = 1198,
    ["Zerops.io config"] = 1119,
    ["Zerops.io import"] = 1120,
    ["Zola Configuration"] = 1209,
    ["aerleon.yml"] = 17,
    ["amplify.yml"] = 10,
    ["angular.json"] = 34,
    apko = 1082,
    ["app-definition.yaml"] = 38,
    ["apple-app-site-association"] = 36,
    ["appsettings.StormPetrel.json"] = 43,
    ["appsettings.json"] = 41,
    ["appsscript.json"] = 40,
    ["appveyor.yml"] = 42,
    ["aqua-generate-registry.yaml"] = 45,
    ["aqua-policy.yaml"] = 46,
    ["aqua.yaml"] = 44,
    ["arazzo.json"] = 48,
    ["arb.json"] = 49,
    ["arc.json"] = 51,
    ["architect.yml"] = 50,
    ["artifacthub-repo.yml"] = 55,
    ["asm-lsp"] = 56,
    ["ast-grep rules"] = 59,
    ["ast-grep sgconfig.yml"] = 58,
    ["babelrc.json"] = 116,
    ["bamboo-spec"] = 120,
    basedpyright = 118,
    ["bashly-strings.yml"] = 1059,
    ["batect.yml"] = 119,
    ["beef-database-codegen"] = 121,
    ["beef-database-v5-codegen"] = 123,
    ["beef-entity-codegen"] = 122,
    ["beef-entity-v5-codegen"] = 124,
    ["behat.yml"] = 136,
    ["bigquery-table"] = 125,
    ["bioimageio resource description"] = 1099,
    ["bitbucket-pipelines"] = 127,
    bitrise = 128,
    ["bitrise-step"] = 129,
    ["block.json"] = 151,
    ["bottom configuration"] = 81,
    ["bower.json"] = 131,
    ["bozr.suite.json"] = 138,
    bpkg = 1060,
    ["browser.i18n.json"] = 139,
    ["browsh configuration"] = 140,
    bucklescript = 141,
    ["buf.gen.yaml"] = 83,
    ["buf.lock"] = 84,
    ["buf.plugin.yaml"] = 85,
    ...
    ["build-changelog"] = 142,
    ["bun.lock"] = 147,
    ["bundleconfig.json"] = 148,
    ["bunfig.toml"] = 149,
    ["cargo-mutants-config.yaml"] = 87,
    ["ccmod.json"] = 1143,
    changelogging = 1111,
    ["chisel-slices.json"] = 267,
    ["chrome-extension-locales-messages.json"] = 248,
    ["chutzpah.json"] = 249,
    cibuildwheel = 171,
    ["clang-format (.clang-format)"] = 1017,
    ["clang-tidy"] = 227,
    clangd = 226,
    clib = 228,
    ["cloud-init: cloud-config userdata"] = 230,
    ["cloud-sdk-pipeline-configuration"] = 251,
    ["cloudbuild.json"] = 252,
    cloudify = 229,
    ["cmdx.yaml"] = 90,
    codemagic = 232,
    ["coffeelint.json"] = 269,
    ["commands.json"] = 244,
    ["commitlint (.commitlintrc)"] = 956,
    ["committed.toml"] = 270,
    ["compile_commands.json"] = 243,
    ["compilerconfig.json"] = 242,
    ["completely.yml"] = 1055,
    ["component-detection-manifest.json"] = 273,
    ["component.json"] = 272,
    ["composer.json"] = 271,
    ["conda-forge"] = 175,
    ["config.yaml"] = 689,
    ["contentmanifest.json"] = 250,
    ["contribute.json"] = 274,
    ["cosmos.config.json"] = 246,
    ["crowdin.yml"] = 275,
    ["ctfd-setup configuration file"] = 1155,
    ["custom-elements.json"] = 1069,
    ["cypress.json"] = 279,
    ["datalogic-scan2deploy-android"] = 289,
    ["datalogic-scan2deploy-ce"] = 290,
    ["dbt Dependencies"] = 192,
    ["dbt Packages"] = 194,
    ["dbt Project"] = 193,
    ["dbt Selectors"] = 195,
    ["dbt YAML files"] = 196,
    ["ddev-global"] = 291,
    ["ddev-project"] = 292,
    ["debugsettings.json"] = 293,
    ["dependabot-v2.json"] = 296,
    ["dependabot.json"] = 295,
    ["deployed-cli"] = 1010,
    ["devcontainer.json"] = 234,
    devinit = 961,
    ["devspace.yaml"] = 1033,
    djlint = 962,
    ["docker bake"] = 302,
    ["docker sequencer"] = 303,
    ["docker-compose.yml"] = 960,
    ["dockerd.json"] = 300,
    ["dotnet Release Index manifest"] = 315,
    ["dotnet-tools.json"] = 316,
    ["dotnetcli.host.json"] = 317,
    ["dprint.json"] = 318,
    ["drone.json"] = 319,
    ["dss-2.0.0.json"] = 321,
    ["dstack configuration"] = 322,
    ["dtool dataset metadata"] = 1150,
    ["dvc.yaml"] = 323,
    ["ecosystem.json"] = 328,
    eksctl = 330,
    ["electron-builder configuration file"] = 336,
    ["epr-manifest.json"] = 335,
    ["evcc.yaml"] = 337,
    ["ezd task runner"] = 347,
    ["fabric.mod.json"] = 349,
    ["first-timers-bot"] = 357,
    ["flagd flag configuration"] = 111,
    ["fly.io Configuration"] = 112,
    fulibWorkflows = 992,
    ["function.json"] = 369,
    ["gRPC API Gateway & OpenAPI Config"] = 12,
    ["gematik health care insurance list"] = 1161,
    ["gematik health care patient list"] = 1158,
    ["gematik health care provider institution list"] = 1160,
    ["gematik health care provider list"] = 1159,
    ["gematik tiger test environment configuration"] = 1162,
    ["git-town.toml"] = 1207,
    ["gitlab-ci"] = 387,
    ["global.json"] = 403,
    ["go-feature-flag Flag Configuration"] = 406,
    ["haxelib.json"] = 424,
    helmfile = 948,
    helmwave = 949,
    ["host-meta.json"] = 431,
    ...
    ["ide.host.json"] = 439,
    ["ifstate.yaml"] = 440,
    ["imageoptimizer.json"] = 441,
    ["importmap.json"] = 444,
    instant_python_config = 446,
    instant_python_custom_project = 447,
    ["ioBroker Configuration"] = 448,
    ["ioBroker JSON UI"] = 449,
    ["ioBroker Package manifest"] = 450,
    ["ixpect.conf.yaml"] = 451,
    ["ize.toml"] = 1046,
    ["jsconfig.json"] = 476,
    ["jscpd Configuration"] = 1030,
    jsdoc = 944,
    ["k3d.yaml"] = 477,
    ["k9s aliases.yaml"] = 479,
    ["k9s cluster-config.yaml"] = 481,
    ["k9s config.yaml"] = 480,
    ["k9s hotkeys.yaml"] = 482,
    ["k9s plugins.yaml"] = 483,
    ["k9s skin.yaml"] = 484,
    ["k9s views.yaml"] = 485,
    ["kontinuous-config.yaml"] = 496,
    ["kontinuous-values.yaml"] = 495,
    ["kustomization.yaml"] = 498,
    ["label-commenter-config.yml"] = 499,
    ["latexindent configuration"] = 105,
    ["launchsettings.json"] = 500,
    lazydocker = 1068,
    lazygit = 1067,
    ["lego.json"] = 502,
    ["lerna.json"] = 503,
    ["lgtm.yml"] = 504,
    ["liblab.config.json"] = 505,
    ["libman.json"] = 506,
    ["license-report-config.json"] = 507,
    ["linkinator.config.json"] = 509,
    ["lint-staged (.lintstagedrc)"] = 922,
    ["local.settings.json"] = 514,
    ["localazy.json"] = 515,
    ["lotus.yaml"] = 513,
    ["lsdlschema.json"] = 516,
    ["macro.json"] = 1034,
    ["markdown-link-check"] = 988,
    maturin = 989,
    mboats = 996,
    ["micro-settings.json"] = 1061,
    ["mimetypes.json"] = 530,
    ["mirrord config"] = 924,
    mise = 925,
    ["mkdocs.yml"] = 550,
    ...
    ["monospace.yml"] = 554,
    ["moon.yml"] = 1144,
    ["mprocs Configuration file"] = 1115,
    ["mrdocs.yml"] = 551,
    ["mta.yaml"] = 926,
    ["mtad.yaml"] = 927,
    ["mycode.json"] = 561,
    nFPM = 568,
    ["napari plugin manifest"] = 562,
    neoload = 939,
    ["nest-cli"] = 571,
    ["ninjs (News in JSON)"] = 570,
    ["nitro.json"] = 938,
    ["nixd configuration"] = 1087,
    ["nlu.json"] = 572,
    ["nodemon.json"] = 574,
    ["noodl config"] = 995,
    ["notebook.mod.json"] = 575,
    now = 934,
    ["npm-badges"] = 578,
    ["nswag.json"] = 582,
    ntangle = 584,
    ["nuclei-template.yaml"] = 579,
    ["nuget-project.json"] = 580,
    ["ocelot.json"] = 586,
    ogen = 589,
    ["omnisharp.json"] = 592,
    openHAB = 1220,
    ...
    oxlint = 1231,
    ["package.json"] = 626,
    ["package.manifest"] = 628,
    ["package.yaml"] = 627,
    ["partial-black.json"] = 137,
    ["pathfinder.yml"] = 631,
    ["pattern.json"] = 634,
    ["petstore-v1.0"] = 1041,
    pgap_yaml_input_reader = 633,
    pgxgen = 1224,
    pitcms = 1227,
    ["pixi.toml"] = 635,
    ["plagiarize-me.yaml"] = 639,
    ["plagiarize.yaml"] = 638,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1151,
    ["podbard.yaml"] = 641,
    ["portman.json"] = 644,
    ["prefect.toml"] = 652,
    ["prefect.yaml"] = 653,
    ...
    ["prettierrc.json"] = 655,
    ["prisma.yml"] = 656,
    ["project-1.0.0-beta3.json"] = 668,
    ["project-1.0.0-beta4.json"] = 669,
    ["project-1.0.0-beta5.json"] = 670,
    ["project-1.0.0-beta6.json"] = 671,
    ["project-1.0.0-beta8.json"] = 672,
    ["project-1.0.0-rc1.json"] = 673,
    ["project-1.0.0-rc2.json"] = 674,
    ["project.json"] = 667,
    ["project.owasp.yaml"] = 675,
    ["prometheus-alertmanager.json"] = 679,
    ["prometheus.json"] = 676,
    ["prometheus.rules.json"] = 677,
    ["prometheus.rules.test.json"] = 678,
    ["proxies.json"] = 680,
    ["publiccode.yml"] = 681,
    ["pubspec.yaml"] = 682,
    ["pyrseas-0.8.json"] = 685,
    pytest = 694,
    ["quilt.mod.json"] = 1062,
    ["rc3 auth"] = 700,
    ["rc3 collection"] = 701,
    ...
    ["release drafter"] = 940,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 710,
    ["release-please-manifest.json"] = 711,
    ["release-plz.toml"] = 712,
    ["renv.lock"] = 724,
    ["rivet.json"] = 1086,
    ["rivet.yaml (legacy)"] = 1085,
    rumdl = 729,
    runny = 728,
    rustfmt = 730,
    sake = 1178,
    samt = 732,
    samtrc = 733,
    ["sarif-1.0.0.json"] = 735,
    ["sarif-2.0.0.json"] = 736,
    ["sarif-2.1.0"] = 746,
    ["sarif-2.1.0-rtm.2"] = 737,
    ["sarif-2.1.0-rtm.3"] = 739,
    ["sarif-2.1.0-rtm.4"] = 741,
    ["sarif-2.1.0-rtm.5"] = 743,
    ["sarif-2.1.0-rtm.6"] = 744,
    ["sarif-external-property-file-2.1.0"] = 747,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 738,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 740,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 742,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 745,
    ["scalingo.json configuration"] = 748,
    ["schema.org - Action"] = 750,
    ["schema.org - ContactPoint"] = 751,
    ["schema.org - Place"] = 752,
    ["schema.org - Thing"] = 753,
    ["secrethub.yml"] = 1064,
    ["semantic-release"] = 759,
    ["servicehub.config.json"] = 917,
    ["servicehub.service.json"] = 916,
    ["settings.job"] = 762,
    ["sfdx-hardis configuration"] = 764,
    ["shard.yml"] = 1102,
    ["size-limit configuration"] = 769,
    ["skaffold.yaml"] = 986,
    ["skyuxconfig.json"] = 771,
    ["snowflake-config"] = 773,
    ["snowflake-connections"] = 774,
    ["spicepod.yaml"] = 1123,
    ["sqlc configuration"] = 806,
    ["stripe-app-local.json"] = 817,
    ["stripe-app.json"] = 816,
    swcrc = 971,
    ["task.json"] = 826,
    taskcat = 935,
    ["template.json"] = 831,
    ["templatsources.json"] = 832,
    ["text2confl config"] = 1232,
    ["theme.json"] = 835,
    ["tizen_workspace.json"] = 837,
    tldr = 838,
    ["tm_devices configuration file"] = 1189,
    tmuxinator = 920,
    tox = 840,
    ["transcend.yml"] = 849,
    ["tree-sitter grammar.json"] = 411,
    ["trime.yaml"] = 850,
    ["trunk.yaml"] = 852,
    ["ts-force-config.json"] = 857,
    ["tsconfig.json"] = 853,
    ["tsd.json"] = 854,
    ["tsdoc.json"] = 855,
    ["tsdrc.json"] = 856,
    ...
    v8r = 899,
    vcluster = 1109,
    ["vcpkg configuration file"] = 239,
    ["vcpkg manifest file"] = 238,
    ["vega-lite.json"] = 881,
    ["vega.json"] = 880,
    ["venvironment.yaml"] = 883,
    ["venvplus.yaml"] = 884,
    version = 1171,
    ["version.json"] = 886,
    ["vhwdebugger-binding.yaml"] = 888,
    ["vim-addon-info"] = 889,
    ["vs-2017.3.host.json"] = 891,
    ["vs-nesting.json"] = 892,
    ["vsls.json"] = 890,
    ["vss-extension.json"] = 896,
    vtcfg = 1177,
    ["vtesttree.yaml"] = 897,
    ["vtestunit.yaml"] = 898,
    ["warp-keysets.json"] = 1070,
    ["warp-themes.json"] = 1071,
    ["warp-workflows.json"] = 1072,
    ["webhint.io"] = 1026,
    ["webjobpublishsettings.json"] = 903,
    ["webjobs-list.json"] = 902,
    ["well-known-fursona"] = 1110,
    ["xs-app.json"] = 930,
    ["xunit.runner.json"] = 915,
    yamllint = 958,
    zizmor = 1214,
    zuul = 941,
    ["Žinoma"] = 951
