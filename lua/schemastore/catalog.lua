...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 895,
    [".nodehawkrc"] = 552,
    [".npmpackagejsonlintrc"] = 556,
    [".omletrc"] = 1072,
    [".phrase.yml"] = 624,
    [".phraseapp.yml"] = 625,
    [".pmbot.yml"] = 610,
    [".postcssrc"] = 619,
    [".powerpages-web-template-manifest"] = 621,
    [".pre-commit-config.yml"] = 622,
    [".pre-commit-hooks.yml"] = 623,
    [".putout.json"] = 653,
    [".rehyperc"] = 678,
    [".remarkrc"] = 682,
    [".sprite files"] = 771,
    ...
    [".vsconfig"] = 859,
    [".vsext"] = 860,
    ["1Password SSH Agent Config"] = 7,
    ["@factorial/drupal-breakpoints-css"] = 12,
    ["A micro editor config"] = 500,
    ABCInventoryModuleData = 20,
    ABCSupplyPlan = 21,
    AIConfig = 22,
    ["AMX Muse Program Descriptor"] = 1119,
    ["API Builder"] = 930,
    ["AVA Configuration"] = 993,
    ["AWS AppConfig Feature Flags-v1"] = 54,
    ["AWS CDK cdk.json"] = 237,
    ["AWS CloudFormation"] = 238,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 239,
    ["AWS Copilot Manifest"] = 1158,
    ["AWS SAM CLI Samconfig"] = 240,
    ["Adobe UXP Manifest"] = 1055,
    ["Aerleon Network & Service Definitions"] = 15,
    ["Aerleon Policy"] = 16,
    Aider = 1148,
    Air = 18,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1169,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1168,
    ["Airlock Microgateway"] = 23,
    ["Alacritty Configuration"] = 965,
    ["All Contributors configuration file"] = 1018,
    ["Ansible Argument Specs"] = 372,
    ["Ansible Collection Galaxy"] = 379,
    ["Ansible Execution Environment"] = 369,
    ["Ansible Inventory"] = 378,
    ["Ansible Meta"] = 370,
    ["Ansible Meta Runtime"] = 371,
    ["Ansible Navigator Configuration"] = 381,
    ["Ansible Playbook"] = 376,
    ["Ansible Requirements"] = 373,
    ["Ansible Rulebook"] = 377,
    ["Ansible Tasks File"] = 375,
    ["Ansible Vars File"] = 374,
    ["Ansible-lint Configuration"] = 380,
    Any = 1082,
    ["AnyWork Automation Configuration"] = 11,
    ["Apollo Router"] = 931,
    ["App config Spotify Backstage"] = 27,
    ["Application Accelerator"] = 8,
    ["Application list for a WinUtil"] = 1099,
    ArchitectFX = 1104,
    ["Argo CD"] = 41,
    ["Argo Events"] = 42,
    ["Argo Workflows"] = 43,
    AssemblyScript = 46,
    AsyncAPI = 49,
    ["AsyncAPI Tool File"] = 50,
    ["Atmos Manifests"] = 51,
    ["Aurora Agile Meta-Framework"] = 52,
    AutoAPICase = 1028,
    ["Avro Avsc"] = 53,
    ["Azure Container App template for defining an immutable revision"] = 55,
    ["Azure DevOps extension manifest"] = 58,
    ["Azure Device Update for IoT Hub import manifest"] = 56,
    ["Azure Device Update for IoT Hub update manifest"] = 57,
    ["Azure IoT Edge deployment"] = 61,
    ["Azure IoT Edge deployment template"] = 62,
    ["Azure IoT EdgeAgent deployment"] = 59,
    ["Azure IoT EdgeHub deployment"] = 60,
    ["Azure IoT Operations Wasm Graph Config"] = 1167,
    ["Azure IoT Operations connector metadata"] = 1164,
    ["Azure Landing Zones Library archetype definition"] = 66,
    ["Azure Landing Zones Library archetype override"] = 67,
    ["Azure Landing Zones Library architecture definition"] = 65,
    ["Azure Landing Zones Library metadata"] = 63,
    ["Azure Landing Zones Library policy default values"] = 64,
    ["Azure Pipelines"] = 95,
    ["Azure Static Web Apps CLI configuration file"] = 775,
    ["Azure Static Web Apps configuration file"] = 774,
    ["BOSH CPI Config"] = 119,
    ["BOSH Deploy Config"] = 120,
    ["BX CI"] = 139,
    ["Bacon config"] = 2,
    ["Bashly (bashly.yml)"] = 1022,
    ["Bashly Settings (bashly-settings.yml)"] = 1023,
    ["Better Code Hub"] = 935,
    ["Better Scripts"] = 140,
    Bigconfig = 112,
    ["Biome Formatter Config"] = 68,
    ["Bitmovin Encoding Template"] = 1112,
    BizTalkServerApplicationSchema = 902,
    Bleep = 141,
    ["Block Protocol Metadata"] = 138,
    ["Boyka Framework"] = 121,
    Briefcase = 908,
    ["Build Info"] = 129,
    Buildkite = 131,
    ["Bukkit plugin.yml"] = 130,
    ["BungeeCord plugin.yml"] = 136,
    ["Butane Config"] = 978,
    C4InterFlow = 1127,
    ["CDK Environment Manager, concrete environment configuration"] = 1151,
    ["CDK Environment Manager, concrete environments definition"] = 1150,
    ["CDK Environment Manager, environment definition"] = 1149,
    ["CGS Card Game Specification (cgs.json)"] = 1060,
    ["CICS TS region tagging"] = 987,
    ["CICS TS resource import"] = 988,
    ["CICS TS resource model"] = 989,
    ["CICS TS resource overrides"] = 990,
    ["CMake Presets"] = 142,
    ["CNC Codes"] = 163,
    ["CRS WAF test file"] = 1089,
    ["CRS WAF test platform overrides file"] = 1090,
    ["CSS Comb (.csscomb.json)"] = 265,
    ["CSS Lint (.csslintrc)"] = 266,
    ["CSpell (cspell.json)"] = 264,
    ["CVE Record Format"] = 171,
    CWL = 1066,
    ["Cache Warmup config"] = 143,
    ["Calqulus pipeline"] = 144,
    ["Camel YAML DSL"] = 145,
    ["Cannon TOML"] = 146,
    Carafe = 147,
    ["Cargo Make"] = 149,
    ["Cargo Manifest"] = 148,
    ["Catalog Info Backstage"] = 150,
    ["Chamaleon environment"] = 1116,
    ["Chamaleon properties"] = 1117,
    ["Chamaleon template"] = 1115,
    Changesets = 249,
    Changie = 151,
    Charmcraft = 152,
    Cheatsheets = 975,
    ["ChordPro Configuration"] = 153,
    ["Chrome Extension"] = 230,
    ["Chromia Model"] = 154,
    ["Chromia Seeder Module Config"] = 156,
    ["Chromia Seeder Root Config"] = 155,
    ["Cinnamon Spice info.json"] = 75,
    ["CircleCI config.yml"] = 206,
    ["Citation File Format"] = 251,
    CityJSON = 158,
    ["Claude Code Settings"] = 170,
    ["Clawject config"] = 169,
    ["Cloud Foundry Application Manifest"] = 1071,
    ["Cloud Run Spec v1"] = 1094,
    ["Cloud.gov Workshop Configuration"] = 76,
    ["CloudCannon Configuration"] = 81,
    ["CloudCannon Configuration (Collection Structures)"] = 90,
    ["CloudCannon Configuration (Collections)"] = 89,
    ["CloudCannon Configuration (Editables)"] = 88,
    ["CloudCannon Configuration (Inputs)"] = 83,
    ["CloudCannon Configuration (Snippets Definitions)"] = 87,
    ["CloudCannon Configuration (Snippets Imports)"] = 86,
    ["CloudCannon Configuration (Snippets)"] = 85,
    ["CloudCannon Configuration (Structure Value)"] = 84,
    ["CloudCannon Configuration (Structures)"] = 82,
    ["CloudEvents specification"] = 159,
    ["Code Climate"] = 207,
    CodeCV = 79,
    CodeRabbit = 78,
    ["CodeShip Pro services configuration files"] = 219,
    ["CodeShip Pro steps configuration files"] = 220,
    ["Codecov configuration files"] = 218,
    CodifyCLI = 80,
    Codux = 216,
    ["Cog config file"] = 164,
    ["Commandbox Box.json"] = 165,
    ["Commandbox Server.json"] = 166,
    ["Common Catalog Data"] = 228,
    ["Common Package Specification"] = 167,
    Concord = 1088,
    ["Configu .cfgu files"] = 1076,
    ["Configu .configu file"] = 1077,
    Conjure = 162,
    ["Container Structure Test"] = 916,
    Containerlab = 944,
    ["Contextive Glossary"] = 1143,
    Convex = 161,
    ["Crowdsec collection config"] = 259,
    ["Crowdsec parser config"] = 260,
    ["Crowdsec scenario config"] = 261,
    ["CumulusCI Config"] = 168,
    ["Custom Machinery Machine"] = 1061,
    ["Custom Machinery Recipe"] = 1062,
    ["Cycle Stack File"] = 172,
    CycloneDX = 173,
    ["DWP Exchange - catalogue entry"] = 308,
    ["DWP Exchange - gateway"] = 306,
    ["DWP Exchange - meta"] = 307,
    ["Dart Build Config (dart-build.json)"] = 267,
    ["Dart Test Config (dart-test.json)"] = 268,
    ["DashLord Configuration"] = 269,
    ["Data Contract Specification"] = 270,
    ["Data Product Specification"] = 271,
    ["DataYoga Connections"] = 174,
    ["DataYoga Job"] = 175,
    ["Databricks Asset Bundles"] = 1039,
    ["Datadog Continuous Testing"] = 471,
    ["Datadog Service Definition"] = 472,
    ["Datadog Software Catalog"] = 473,
    ["Datahub Ingestion Recipe"] = 994,
    ["Debian Upstream Metadata file"] = 181,
    ["Deck config"] = 182,
    ["Dein Config"] = 183,
    ["Deno Config (deno.json)"] = 277,
    ["Dependency cruiser"] = 184,
    ["DeployStack Configuration"] = 185,
    ["Deployah Configuration"] = 1166,
    ["Deployer Recipe"] = 280,
    ["Deta Spacefile"] = 186,
    ["Detekt Config (detekt.yml)"] = 281,
    ["Devbox Config"] = 187,
    ["Devbox Plugin"] = 188,
    Devfile = 305,
    DipDup = 1091,
    ["Discord Webhook"] = 282,
    ["DocFx Config (docfx.json)"] = 286,
    Dofigen = 287,
    ["Dolittle Artifacts"] = 288,
    ["Dolittle Bounded Context Configuration"] = 289,
    ["Dolittle Event Horizons Configuration"] = 290,
    ["Dolittle Resources Configuration"] = 291,
    ["Dolittle Server Configuration"] = 292,
    ["Dolittle Tenant Map Configuration"] = 294,
    ["Dolittle Tenants Configuration"] = 293,
    ["Dolittle Topology"] = 295,
    ["DonateCaseBetterCasino menu"] = 1120,
    ["Drupal Breakpoints"] = 189,
    ["Drupal Config"] = 201,
    ["Drupal Info"] = 190,
    ["Drupal Layouts"] = 191,
    ["Drupal Libraries"] = 192,
    ["Drupal Links Action"] = 193,
    ["Drupal Links Contextual"] = 194,
    ["Drupal Links Menu"] = 195,
    ["Drupal Links Task"] = 196,
    ["Drupal Migration"] = 197,
    ["Drupal Permissions"] = 198,
    ["Drupal Recipe"] = 199,
    ["Drupal Routing"] = 200,
    ["Drupal Services"] = 202,
    ["Drush site aliases"] = 301,
    ["Dynamic Bash Aliases (.aliases)"] = 1030,
    ["EAS config"] = 325,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1019,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1163,
    ["EasyVCR .NET"] = 326,
    ["Eidolon Resource"] = 1105,
    ["Elgato Stream Deck"] = 311,
    Elm = 1093,
    ["Embrace Config"] = 1005,
    Endurica = 1043,
    ["Enterprise Contract Policy Spec"] = 312,
    ["Erda Pipeline"] = 1068,
    ["Erda Runtime"] = 1069,
    Esquio = 314,
    ["Estuary Flow Catalog"] = 984,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 318,
    ["EveryVoice TTS Toolkit Data Configuration"] = 319,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 323,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 322,
    ["EveryVoice TTS Toolkit Text Configuration"] = 320,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 321,
    ["Evolving Resolutive Process notation"] = 1165,
    ["Expo SDK"] = 324,
    ["F-Droid Data metadata"] = 330,
    ["FasterCI Configuration"] = 96,
    FiQuS = 334,
    Firebase = 332,
    ["FlexGet Config"] = 335,
    ["Flow.json Configurations"] = 1065,
    ["Fossa configuration file"] = 342,
    ["Fossa's fossa-deps file"] = 343,
    ["Foundry VTT - Base package Manifest"] = 337,
    ["Foundry VTT - Module Manifest"] = 338,
    ["Foundry VTT - System Data Template"] = 341,
    ["Foundry VTT - System Manifest"] = 339,
    ["Foundry VTT - World Manifest"] = 340,
    ["Foxx Manifest"] = 97,
    ["Freifunk.de Community API"] = 100,
    ["Frogbot Config"] = 101,
    ["G2P Mapping Configuration"] = 349,
    ["GCP Blueprint Metadata"] = 352,
    Gaspar = 350,
    ["GatewayCore API Gateway"] = 351,
    ["Gemini CLI settings"] = 353,
    ["GeoJSON.json latest"] = 982,
    GherKing = 986,
    ["GitHub Action"] = 358,
    ["GitHub Actions typing"] = 1101,
    ["GitHub Discussion"] = 359,
    ["GitHub Funding"] = 360,
    ["GitHub Issue Template configuration"] = 361,
    ["GitHub Issue Template forms"] = 362,
    ["GitHub Workflow"] = 363,
    ["GitHub Workflow Template Properties"] = 364,
    ["GitHub automatically generated release notes configuration"] = 365,
    ["GitLab Agent for Kubernetes configuration"] = 1057,
    GitVersion = 355,
    ["Gitea Issue Template configuration"] = 356,
    ["Gitea Issue Template forms"] = 357,
    ["Gitpod Automations"] = 367,
    ["Gitpod Configuration"] = 368,
    ["GlazeWM settings"] = 1059,
    ["Global Privacy Control"] = 354,
    Goblet = 1038,
    ["Golangci-lint Configuration"] = 383,
    ["Golangci-lint Custom Plugins Configuration"] = 384,
    ["Google Chrome Related Website Sets"] = 333,
    ["Google Cloud Workflows"] = 236,
    ["Google Digital Assetlinks"] = 1144,
    Goreleaser = 386,
    ["Goreleaser Pro"] = 387,
    Goss = 388,
    ["Gradle Build Cache Node"] = 933,
    ["Gradle Enterprise"] = 932,
    ["Grafana 5.x Dashboard"] = 389,
    ["GraphQL Code Generator"] = 394,
    ["GraphQL Config"] = 393,
    ["GraphQL Mesh"] = 392,
    ["GroovyLint configuration"] = 395,
    ["Grunt JSHint task"] = 399,
    ["Grunt Watch task"] = 400,
    ["Grunt base task"] = 401,
    ["Grunt clean task"] = 397,
    ["Grunt copy task"] = 396,
    ["Grunt cssmin task"] = 398,
    HEMTT = 898,
    Hadolint = 912,
    Hammerkit = 943,
    ["Hardware Sentry Configuration"] = 998,
    ["HashiCorp Vault"] = 402,
    Hatch = 913,
    Hayagriva = 404,
    Hayson = 405,
    ["Haystack Pipeline"] = 406,
    ["Hazelcast 5 Configuration"] = 407,
    ["Hecate Input Schema"] = 1155,
    ["Helm Chart.lock"] = 204,
    ["Helm Chart.yaml"] = 203,
    ["Helm Unittest Test Suite"] = 205,
    ["Home Assistant Integration Manifest"] = 408,
    ["Homer dashboard configuration"] = 409,
    Hugo = 974,
    ["Hugo Theme"] = 973,
    ["Hulak Configuration"] = 416,
    ["Hyperfoil benchmark configuration"] = 415,
    ["IBM Zapp document"] = 417,
    ["IBM zCodeFormatSettings"] = 418,
    ["IMG Catapult PSP"] = 423,
    ["IVMS101 by CODE Protocol"] = 1058,
    Infrahub = 425,
    Istanbul = 1001,
    ["JDownloader2 crawler multi-rules"] = 438,
    ["JDownloader2 crawler single-rules"] = 437,
    ["JFrog Applications Config"] = 439,
    ["JFrog File Spec"] = 440,
    ["JFrog Pipelines YML DSL"] = 1007,
    ["JMeter DSL cli config"] = 441,
    JReleaser = 444,
    ["JSON Document Transform"] = 452,
    ["JSON Feed"] = 453,
    ["JSON Resume"] = 688,
    ["JSON Schema Draft 2020-12"] = 880,
    ["JSON Schema Draft 4"] = 877,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1040,
    ["JSON Schema Draft 7"] = 878,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1041,
    ["JSON Schema Draft 8 (2019-09)"] = 879,
    ["JSON-API"] = 451,
    ["JSON-e templates"] = 940,
    ["JSON-stat 2.0"] = 873,
    JSONPatch = 455,
    ["JSR Package Config (jsr.json)"] = 445,
    Jarl = 1171,
    Jasmine = 432,
    Jekyll = 433,
    ["Jenkins X Pipelines"] = 434,
    ["Jenkins X Requirements"] = 435,
    Jest = 436,
    Jocker = 442,
    ["Jovo Language Models"] = 443,
    ["Jujutsu (jj) VCS config"] = 1157,
    ["KIMMDY config file"] = 466,
    ["KODE/CI build.yaml"] = 1003,
    ["KSP-AVC"] = 874,
    ["KSP-CKAN"] = 875,
    ["KSP-NetKAN"] = 876,
    KSY = 1070,
    KSail = 347,
    ["Karakum configuration file"] = 344,
    Kas = 458,
    ["Kestra flow file"] = 467,
    ["Keycloak REST API"] = 1010,
    ["Knative Functions - func.yaml"] = 345,
    Knip = 346,
    ["Kometa (nightly) config file"] = 469,
    ["Kometa config file"] = 468,
    ["Kong DBLess config"] = 1004,
    KrakenD = 470,
    ["Kubri Configuration"] = 477,
    LOOBin = 492,
    ["Lake configuration file"] = 1160,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 241,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 242,
    ["Landing Zone Accelerator on AWS - Global Config"] = 243,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 244,
    ["Landing Zone Accelerator on AWS - Network Config"] = 245,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 246,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 247,
    ["Landing Zone Accelerator on AWS - Security Config"] = 248,
    ["Lando (landofile)"] = 91,
    ["LangGraph Platform configuration"] = 1081,
    ["Language configuration"] = 1080,
    Lefthook = 481,
    ["Liferay client-extension.yaml"] = 488,
    ["LinkML Metamodel"] = 490,
    Liquibase = 949,
    ["Liquibase Flow File"] = 950,
    ["Lively Properties"] = 491,
    ["Lobe AI Agent"] = 93,
    Loki = 94,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 532,
    ["MS2Rescore Configuration"] = 535,
    ["Madness (madness.yml)"] = 1021,
    ["Mado configuration"] = 498,
    ["MapEHR Mapping"] = 499,
    Markdownlint = 953,
    ["Mason Registry"] = 956,
    ["MegaLinter Custom Flavor"] = 502,
    ["MegaLinter configuration"] = 501,
    ["MegaLinter descriptor"] = 503,
    Melange = 1048,
    ["Meltano project definition"] = 504,
    ["Mergify Configuration"] = 536,
    ["Metadata for a Bazel module"] = 505,
    ["Metadata for a Cinnamon spice"] = 1097,
    ["Metatype Configuration"] = 506,
    ["MetricsHub Configuration"] = 507,
    ["MetricsHub Connector Configuration"] = 508,
    ["Micro Editor Syntax"] = 1031,
    ["Microsoft Band Web Tile"] = 509,
    ["Microsoft RulesEngine workflow rules"] = 1085,
    ["Microsoft RulesEngine workflow rules list"] = 1086,
    ["Minecraft Custom Main Menu Mod"] = 1049,
    ["Minecraft Data Pack Advancement"] = 511,
    ["Minecraft Data Pack Biome"] = 512,
    ["Minecraft Data Pack Configured Carver"] = 513,
    ["Minecraft Data Pack Damage Type"] = 514,
    ["Minecraft Data Pack Dimension"] = 516,
    ["Minecraft Data Pack Dimension Type"] = 515,
    ["Minecraft Data Pack Item Modifier"] = 517,
    ["Minecraft Data Pack Loot Table"] = 518,
    ["Minecraft Data Pack Metadata"] = 519,
    ["Minecraft Data Pack Predicate"] = 520,
    ["Minecraft Data Pack Recipe"] = 521,
    ["Minecraft Data Pack Tag"] = 522,
    ["Minecraft Data Pack Template Pool"] = 523,
    ["Minecraft Data Pack Trim Material"] = 528,
    ["Minecraft Data Pack Trim Pattern"] = 529,
    ["Minecraft Resource Pack Lang"] = 524,
    ["Minecraft Resource Pack Particle"] = 525,
    ["Minecraft Resource Pack Texture Mcmeta"] = 527,
    ["Minecraft Resourcepack Sounds"] = 526,
    ["Monade CLI Stack Configuration"] = 539,
    ["MongoDB Atlas Search Index Definition"] = 1002,
    ["Monika Configuration"] = 1000,
    ["Monoweave Configuration"] = 534,
    ["Motif config"] = 894,
    MultiQC = 1137,
    ["NOX Framework (Service)"] = 555,
    ["Netin Diagnostic System Template"] = 960,
    ["Netlify config"] = 542,
    ["Network-as-Code Data Model"] = 543,
    ["Next Gen UI Agent A2A Server Configuration"] = 544,
    ["Next Gen UI Agent Configuration"] = 546,
    ["Next Gen UI Agent MCP Server Configuration"] = 545,
    ["Nightwatch.js"] = 548,
    ["Node.js configuration"] = 899,
    ["NueJS configuration file"] = 560,
    ["Nuitka.yaml"] = 1063,
    ["Nullstone config"] = 562,
    ["ONe's changelog entry"] = 578,
    ["ONe's service descriptor"] = 577,
    ["ORT Server repository environment configuration"] = 586,
    ["OSCAL Assessment Plan (AP)"] = 588,
    ["OSCAL Assessment Results (AR)"] = 589,
    ["OSCAL Catalog"] = 590,
    ["OSCAL Component Definition (CDef)"] = 591,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 592,
    ["OSCAL Profile"] = 593,
    ["OSCAL System Security Plan (SSP)"] = 594,
    ["OSS Review Toolkit configuration"] = 595,
    ["OSS Review Toolkit curation"] = 596,
    ["OSS Review Toolkit package configuration"] = 597,
    ["OSS Review Toolkit repository configuration"] = 598,
    ["OSS Review Toolkit resolutions"] = 599,
    ["October CMS columns"] = 566,
    ["October CMS fields"] = 567,
    ["Oh My Posh"] = 568,
    Okteto = 569,
    ["Ona Automations"] = 571,
    Opctl = 897,
    ["Open Data Contract Standard (ODCS)"] = 581,
    ["Open Data Product Standard (ODPS)"] = 582,
    ["Open Know-How"] = 1142,
    ["OpenRewrite Resource"] = 580,
    OpenStatus = 1153,
    ["OpenUtau character yaml"] = 574,
    ["OpenUtau ustx"] = 575,
    ["OpenWeather Current Weather API"] = 939,
    ["OpenWeather Road Risk API"] = 938,
    ["Ory Hydra configuration"] = 414,
    ["Ory Keto configuration"] = 474,
    ["Ory Kratos configuration"] = 587,
    ["Ory Oathkeeper configuration"] = 564,
    ["Outblocks App configuration"] = 584,
    ["Outblocks database table"] = 585,
    ["Outblocks project configuration"] = 583,
    PDM = 606,
    POPxf = 616,
    ["POPxf Correlations"] = 617,
    Packer = 603,
    Pantsbuild = 1017,
    ["Paper paper-plugin.yml"] = 604,
    ["Pipeline component"] = 951,
    ["Platform.sh application"] = 4,
    ["Platform.sh routes"] = 5,
    ["Platform.sh services"] = 6,
    ["Plex Prerolls"] = 614,
    ["PocketMine plugin.yml"] = 611,
    ["Postman collection"] = 620,
    ["Power Pages Configuration"] = 1154,
    ["Preset list for a WinUtil"] = 1100,
    ["ProActions AI-Kit Configuration"] = 629,
    ["ProActions AI-Kit Configuration for Menus"] = 631,
    ["ProActions AI-Kit Configuration for Sections"] = 633,
    ["ProActions AI-Kit Configuration for Services"] = 630,
    ["ProActions AI-Kit Configuration for Steps"] = 634,
    ["ProActions AI-Kit Configuration for Templates"] = 632,
    ["Problem object RFC9457"] = 1046,
    ["Problem package generators"] = 635,
    Pterodactyl = 997,
    ["Pull Request Labeler"] = 652,
    Pulumi = 660,
    ["PyGTA Config"] = 656,
    PyProject = 661,
    Pylock = 1145,
    Pyright = 662,
    ["Python script metadata"] = 1139,
    ["QType AI DSL"] = 665,
    Qgoda = 664,
    Qodana = 970,
    ["Qt Creator workspace file"] = 1078,
    ["Quali Torque Blueprint Spec 2"] = 995,
    ["QueryFirst config file"] = 1013,
    ["RKE Cluster Configuration JSON"] = 948,
    ["RKE Cluster Configuration YAML"] = 947,
    RadioHound = 655,
    Railpack = 667,
    Railway = 666,
    ["Rancher Fleet"] = 657,
    ...
    Ray = 911,
    ["Read the Docs"] = 659,
    ["Red-DiscordBot Cog"] = 675,
    ["Red-DiscordBot Cog Repo"] = 676,
    ["Red-DiscordBot Trivia"] = 677,
    ["Render Blueprints"] = 946,
    RenderCV = 690,
    Renovate = 689,
    ["Replit config"] = 683,
    Restate = 1132,
    ["Revel Digital Gadget Definition File"] = 1156,
    RoadRunner = 692,
    ["Robust Station Image"] = 1162,
    Rockcraft = 693,
    ["Roo Coder Custom Modes"] = 694,
    Rubocop = 685,
    ["Rudder techniques"] = 1053,
    Ruff = 686,
    ["Rust Project"] = 687,
    ["Rust toolchain"] = 698,
    ["SDMX data message"] = 724,
    ["SDMX metadata message"] = 723,
    ["SDMX structure message"] = 722,
    ["SIL Kit Participant Configuration"] = 734,
    ["SIL Kit Registry Configuration"] = 735,
    ["SPDX 2.3"] = 772,
    SWADL = 788,
    ["Safebox Config"] = 1008,
    ["Sapphire CLI Config"] = 701,
    ["SauceCTL Configuration"] = 957,
    ["Schema Catalog"] = 716,
    ["Scoop manifest"] = 721,
    ["Semantic Data Fabric (SDF) file"] = 725,
    ["Semgrep Rule"] = 727,
    ["Serenity Code Generator (Sergen)"] = 728,
    ["Serverless Framework Configuration"] = 964,
    ["Serverless Workflow"] = 966,
    ["Settings for a Cinnamon spice"] = 1096,
    ["Settings.paf"] = 730,
    ["Shopware 6 Configuration"] = 967,
    ["Shopware CLI Extension Store Configuration"] = 968,
    ["Shopware CLI Project Store Configuration"] = 969,
    ["Sigma Detection Rule"] = 732,
    ["Sigrid scope configuration file"] = 733,
    ["SkyPilot Task JSON"] = 1054,
    ["Slack app manifest"] = 737,
    Snapcraft = 739,
    Solidarity = 742,
    ["Solution filters"] = 743,
    ["Source Maps v3"] = 744,
    Sourcery = 745,
    ["Spack bootstrap.yaml"] = 746,
    ["Spack cdash.yaml"] = 747,
    ["Spack ci.yaml"] = 748,
    ["Spack compilers.yaml"] = 749,
    ["Spack concretizer.yaml"] = 750,
    ["Spack config.yaml"] = 751,
    ["Spack definitions.yaml"] = 752,
    ["Spack develop.yaml"] = 753,
    ["Spack env_vars.yaml"] = 754,
    ["Spack environment"] = 760,
    ["Spack include.yaml"] = 755,
    ["Spack mirrors.yaml"] = 756,
    ["Spack modules.yaml"] = 757,
    ["Spack packages.yaml"] = 758,
    ["Spack repos.yaml"] = 759,
    ["Spack toolchains.yaml"] = 761,
    ["Spack upstreams.yaml"] = 762,
    ["Spack view.yaml"] = 763,
    ["Speakeasy Generation Config File"] = 767,
    ["Speakeasy Lint Configuration File"] = 764,
    ["Speakeasy Test Generation Configuration File"] = 765,
    ["Speakeasy Workflow File"] = 766,
    SpecIF = 768,
    ["Specmatic Configuration"] = 769,
    ["Sponge Mixin configuration"] = 770,
    StackBlitz = 776,
    ["StackHawk Scanner Configuration"] = 963,
    Stale = 777,
    Starfish = 778,
    ["Starlake Data Pipeline"] = 936,
    Starship = 779,
    ["Statamic Blueprint"] = 780,
    ["Stella configuration file"] = 781,
    ["Streamlit configuration file"] = 782,
    ["Stryker Mutator"] = 785,
    ["StyleCop Analyzers Configuration"] = 786,
    ["Stylelint (.stylelintrc)"] = 787,
    ["Stylua Config"] = 1146,
    ["Sublime Syntax"] = 1009,
    ["Subsquid squid manifest"] = 1056,
    ["Swagger API 2.0"] = 789,
    ["Synadia Connect Component"] = 790,
    TSON = 825,
    TSTyche = 826,
    ["TYPO3 Vendor Bundler config"] = 831,
    ["Tab data for a LinUtil"] = 1103,
    ["Tab list for a LinUtil"] = 1102,
    Tach = 791,
    ["Tach Domain"] = 792,
    Talhelper = 794,
    ["Talisman configuration"] = 795,
    Taplo = 1147,
    ["Taskfile config"] = 941,
    Taurus = 796,
    Tauticord = 797,
    ["Tekton Pipeline"] = 1175,
    ["Tekton PipelineRun"] = 1176,
    ["Tekton Task"] = 1173,
    ["Tekton TaskRun"] = 1174,
    Telefonistka = 1133,
    ["Terrateam config"] = 1159,
    ["TestEnvironment.json"] = 808,
    ["TextMate Grammar"] = 807,
    Threagile = 803,
    ["Tier.run pricing.json"] = 800,
    Tikibase = 801,
    Tombi = 806,
    ["Traefik v2"] = 811,
    ["Traefik v2 File Provider"] = 812,
    ["Traefik v3"] = 813,
    ["Traefik v3 File Provider"] = 814,
    ["Travis CI (.travis.yml)"] = 810,
    Treefmt = 391,
    Trident = 1129,
    ["TrueScript for *.tscript files"] = 817,
    ["Tugboat QA config.yml"] = 1126,
    TunnelHub = 1044,
    Turborepo = 809,
    Tycho = 1092,
    Tye = 971,
    ["Tyk Gateway - Open Source v5.7+"] = 1138,
    ["Typst Manifest"] = 832,
    ["UET BuildConfig.json"] = 1014,
    ["UI5 Manifest"] = 838,
    ["UNCORS configuration"] = 842,
    ["UTAM Page Object"] = 841,
    ["Ubuntu Server Autoinstall"] = 836,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1130,
    ["Uniswap Token List"] = 923,
    ["Universal Schedule Format"] = 843,
    ["Unreal Engine Uplugin"] = 1015,
    ["Unreal Engine Uproject"] = 1016,
    ["UpCloud CLI (upctl) configuration"] = 1131,
    ["Updatecli Compose"] = 979,
    ["Updatecli Policy Manifest"] = 980,
    ["Updatecli Policy Metadata"] = 981,
    Uplift = 1012,
    ["Upsun config"] = 3,
    ["User Journey Map"] = 945,
    V2Ray = 985,
    ["VSCode Code Snippets"] = 224,
    ["VSIX CLI publishing"] = 861,
    Vector = 845,
    ["Vela Pipeline Configuration"] = 848,
    Vercel = 223,
    ["Version Bumper config"] = 851,
    ["Viash Component Config"] = 1135,
    ["Viash Package Config"] = 1136,
    Visivo = 1042,
    ["WP-CLI"] = 871,
    Wake = 1128,
    ["Waku Config"] = 1106,
    ["Web App Manifest"] = 867,
    ["Web types"] = 870,
    WebExtensions = 866,
    ["Webman package recipe"] = 991,
    ["Windows Package Manager Installer Manifest"] = 919,
    ["Windows Package Manager Locale Manifest"] = 920,
    ["Windows Package Manager Singleton Manifest"] = 918,
    Winutil = 921,
    ["WireMock CLI import configuration"] = 1111,
    ["WireMock CLI local service configuration"] = 1110,
    ["WireMock stub mapping"] = 1109,
    ["Woodpecker pipeline config"] = 959,
    ["Wrangler CLI"] = 872,
    ["Xstate Machine"] = 977,
    ["Yandex Workflow Language"] = 1098,
    ["Yarn Config (.yarnrc.yml)"] = 934,
    ["Yippee-Ki-JSON configuration YML"] = 925,
    ["YouTrack App"] = 1095,
    ["Zarf Package Configuration"] = 1161,
    ["Zerops.io config"] = 1083,
    ["Zerops.io import"] = 1084,
    ["Zola Configuration"] = 1172,
    ["aerleon.yml"] = 14,
    ["angular.json"] = 24,
    apko = 1047,
    ["app-definition.yaml"] = 28,
    ["apple-app-site-association"] = 26,
    ["appsettings.StormPetrel.json"] = 33,
    ["appsettings.json"] = 31,
    ["appsscript.json"] = 30,
    ["appveyor.yml"] = 32,
    ["aqua-generate-registry.yaml"] = 35,
    ["aqua-policy.yaml"] = 36,
    ["aqua.yaml"] = 34,
    ["arb.json"] = 38,
    ["arc.json"] = 40,
    ["architect.yml"] = 39,
    ["artifacthub-repo.yml"] = 44,
    ["asm-lsp"] = 45,
    ["ast-grep rules"] = 48,
    ["ast-grep sgconfig.yml"] = 47,
    ["babelrc.json"] = 103,
    ["bamboo-spec"] = 106,
    ["bashly-strings.yml"] = 1024,
    ["batect.yml"] = 105,
    ["beef-database-codegen"] = 107,
    ["beef-database-v5-codegen"] = 109,
    ["beef-entity-codegen"] = 108,
    ["beef-entity-v5-codegen"] = 110,
    ["behat.yml"] = 122,
    ["bigquery-table"] = 111,
    ["bioimageio resource description"] = 1064,
    ["bitbucket-pipelines"] = 113,
    bitrise = 114,
    ["bitrise-step"] = 115,
    ["block.json"] = 137,
    ["bottom configuration"] = 69,
    ["bower.json"] = 117,
    ["bozr.suite.json"] = 124,
    bpkg = 1025,
    ["browser.i18n.json"] = 125,
    ["browsh configuration"] = 126,
    bucklescript = 127,
    ["buf.gen.yaml"] = 71,
    ["buf.plugin.yaml"] = 72,
    ["buf.work.yaml"] = 73,
    ...
    ["build-changelog"] = 128,
    ["bun.lock"] = 133,
    ["bundleconfig.json"] = 134,
    ["bunfig.toml"] = 135,
    ["cargo-mutants-config.yaml"] = 74,
    ["ccmod.json"] = 1107,
    changelogging = 1075,
    ["chisel-slices.json"] = 250,
    ["chrome-extension-locales-messages.json"] = 231,
    ["chutzpah.json"] = 232,
    cibuildwheel = 157,
    ["clang-format (.clang-format)"] = 983,
    ["clang-tidy"] = 211,
    clangd = 210,
    clib = 212,
    ["cloud-init: cloud-config userdata"] = 214,
    ["cloud-sdk-pipeline-configuration"] = 234,
    ["cloudbuild.json"] = 235,
    cloudify = 213,
    ["cmdx.yaml"] = 77,
    codemagic = 215,
    ["coffeelint.json"] = 252,
    ["commands.json"] = 227,
    ["commitlint (.commitlintrc)"] = 922,
    ["committed.toml"] = 253,
    ["compile_commands.json"] = 226,
    ["compilerconfig.json"] = 225,
    ["completely.yml"] = 1020,
    ["component-detection-manifest.json"] = 256,
    ["component.json"] = 255,
    ["composer.json"] = 254,
    ["conda-forge"] = 160,
    ["config.yaml"] = 658,
    ["contentmanifest.json"] = 233,
    ["contribute.json"] = 257,
    ["cosmos.config.json"] = 229,
    ["crowdin.yml"] = 258,
    ["ctfd-setup configuration file"] = 1118,
    ["custom-elements.json"] = 1034,
    ["cypress.json"] = 262,
    ["datalogic-scan2deploy-android"] = 272,
    ["datalogic-scan2deploy-ce"] = 273,
    ["dbt Dependencies"] = 176,
    ["dbt Packages"] = 178,
    ["dbt Project"] = 177,
    ["dbt Selectors"] = 179,
    ["dbt YAML files"] = 180,
    ["ddev-global"] = 274,
    ["ddev-project"] = 275,
    ["debugsettings.json"] = 276,
    ["dependabot-v2.json"] = 279,
    ["dependabot.json"] = 278,
    ["deployed-cli"] = 976,
    ["devcontainer.json"] = 217,
    devinit = 927,
    ["devspace.yaml"] = 999,
    djlint = 928,
    ["docker bake"] = 284,
    ["docker sequencer"] = 285,
    ["docker-compose.yml"] = 926,
    ["dockerd.json"] = 283,
    ["dotnet Release Index manifest"] = 296,
    ["dotnet-tools.json"] = 297,
    ["dotnetcli.host.json"] = 298,
    ["dprint.json"] = 299,
    ["drone.json"] = 300,
    ["dss-2.0.0.json"] = 302,
    ["dstack configuration"] = 303,
    ["dtool dataset metadata"] = 1113,
    ["dvc.yaml"] = 304,
    ["ecosystem.json"] = 309,
    eksctl = 310,
    ["electron-builder configuration file"] = 316,
    ["epr-manifest.json"] = 315,
    ["evcc.yaml"] = 317,
    ["ezd task runner"] = 327,
    ["fabric.mod.json"] = 329,
    ["first-timers-bot"] = 336,
    ["flagd flag configuration"] = 98,
    ["fly.io Configuration"] = 99,
    fulibWorkflows = 958,
    ["function.json"] = 348,
    ["gRPC API Gateway & OpenAPI Config"] = 9,
    ["gematik health care insurance list"] = 1124,
    ["gematik health care patient list"] = 1121,
    ["gematik health care provider institution list"] = 1123,
    ["gematik health care provider list"] = 1122,
    ["gematik tiger test environment configuration"] = 1125,
    ["git-town.toml"] = 1170,
    ["gitlab-ci"] = 366,
    ["global.json"] = 382,
    ["go-feature-flag Flag Configuration"] = 385,
    ["haxelib.json"] = 403,
    helmfile = 914,
    helmwave = 915,
    ["host-meta.json"] = 411,
    ...
    ["ide.host.json"] = 419,
    ["ifstate.yaml"] = 420,
    ["imageoptimizer.json"] = 421,
    ["importmap.json"] = 424,
    instant_python_config = 426,
    instant_python_custom_project = 427,
    ["ioBroker Configuration"] = 428,
    ["ioBroker JSON UI"] = 429,
    ["ioBroker Package manifest"] = 430,
    ["ixpect.conf.yaml"] = 431,
    ["ize.toml"] = 1011,
    ["jsconfig.json"] = 456,
    ["jscpd Configuration"] = 996,
    jsdoc = 910,
    ["k3d.yaml"] = 457,
    ["k9s aliases.yaml"] = 459,
    ["k9s cluster-config.yaml"] = 461,
    ["k9s config.yaml"] = 460,
    ["k9s hotkeys.yaml"] = 462,
    ["k9s plugins.yaml"] = 463,
    ["k9s skin.yaml"] = 464,
    ["k9s views.yaml"] = 465,
    ["kontinuous-config.yaml"] = 476,
    ["kontinuous-values.yaml"] = 475,
    ["kustomization.yaml"] = 478,
    ["label-commenter-config.yml"] = 479,
    ["latexindent configuration"] = 92,
    ["launchsettings.json"] = 480,
    lazydocker = 1033,
    lazygit = 1032,
    ["lego.json"] = 482,
    ["lerna.json"] = 483,
    ["lgtm.yml"] = 484,
    ["liblab.config.json"] = 485,
    ["libman.json"] = 486,
    ["license-report-config.json"] = 487,
    ["linkinator.config.json"] = 489,
    ["lint-staged (.lintstagedrc)"] = 888,
    ["local.settings.json"] = 494,
    ["localazy.json"] = 495,
    ["lotus.yaml"] = 493,
    ["lsdlschema.json"] = 496,
    ["markdown-link-check"] = 954,
    maturin = 955,
    mboats = 962,
    ["micro-settings.json"] = 1026,
    ["mimetypes.json"] = 510,
    ["mirrord config"] = 890,
    mise = 891,
    ["mkdocs.yml"] = 530,
    ["monospace.yml"] = 533,
    ["moon.yml"] = 1108,
    ["mprocs Configuration file"] = 1079,
    ["mrdocs.yml"] = 531,
    ["mta.yaml"] = 892,
    ["mtad.yaml"] = 893,
    ["mycode.json"] = 540,
    nFPM = 547,
    ["napari plugin manifest"] = 541,
    neoload = 905,
    ["nest-cli"] = 550,
    ["ninjs (News in JSON)"] = 549,
    ["nitro.json"] = 904,
    ["nixd configuration"] = 1052,
    ["nlu.json"] = 551,
    ["nodemon.json"] = 553,
    ["noodl config"] = 961,
    ["notebook.mod.json"] = 554,
    now = 900,
    ["npm-badges"] = 557,
    ["nswag.json"] = 561,
    ntangle = 563,
    ["nuclei-template.yaml"] = 558,
    ["nuget-project.json"] = 559,
    ["ocelot.json"] = 565,
    ["omnisharp.json"] = 570,
    ["openapi.json"] = 572,
    ["openfin.json"] = 579,
    ...
    ["ops.yaml"] = 576,
    ["package.json"] = 600,
    ["package.manifest"] = 602,
    ["package.yaml"] = 601,
    ["partial-black.json"] = 123,
    ["pathfinder.yml"] = 605,
    ["pattern.json"] = 608,
    ["petstore-v1.0"] = 1006,
    pgap_yaml_input_reader = 607,
    ["pixi.toml"] = 609,
    ["plagiarize-me.yaml"] = 613,
    ["plagiarize.yaml"] = 612,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1114,
    ["podbard.yaml"] = 615,
    ["portman.json"] = 618,
    ["prefect.toml"] = 626,
    ["prettierrc.json"] = 627,
    ["prisma.yml"] = 628,
    ["project-1.0.0-beta3.json"] = 637,
    ["project-1.0.0-beta4.json"] = 638,
    ["project-1.0.0-beta5.json"] = 639,
    ["project-1.0.0-beta6.json"] = 640,
    ["project-1.0.0-beta8.json"] = 641,
    ["project-1.0.0-rc1.json"] = 642,
    ["project-1.0.0-rc2.json"] = 643,
    ["project.json"] = 636,
    ["project.owasp.yaml"] = 644,
    ["prometheus-alertmanager.json"] = 648,
    ["prometheus.json"] = 645,
    ["prometheus.rules.json"] = 646,
    ["prometheus.rules.test.json"] = 647,
    ["proxies.json"] = 649,
    ["publiccode.yml"] = 650,
    ["pubspec.yaml"] = 651,
    ["pyrseas-0.8.json"] = 654,
    pytest = 663,
    ["quilt.mod.json"] = 1027,
    ["rc3 auth"] = 669,
    ["rc3 collection"] = 670,
    ...
    ["release drafter"] = 906,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 679,
    ["release-please-manifest.json"] = 680,
    ["release-plz.toml"] = 681,
    ["renv.lock"] = 691,
    ["rivet.json"] = 1051,
    ["rivet.yaml (legacy)"] = 1050,
    rumdl = 696,
    runny = 695,
    rustfmt = 697,
    sake = 1141,
    samt = 699,
    samtrc = 700,
    ["sarif-1.0.0.json"] = 702,
    ["sarif-2.0.0.json"] = 703,
    ["sarif-2.1.0"] = 713,
    ["sarif-2.1.0-rtm.2"] = 704,
    ["sarif-2.1.0-rtm.3"] = 706,
    ["sarif-2.1.0-rtm.4"] = 708,
    ["sarif-2.1.0-rtm.5"] = 710,
    ["sarif-2.1.0-rtm.6"] = 711,
    ["sarif-external-property-file-2.1.0"] = 714,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 705,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 707,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 709,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 712,
    ["scalingo.json configuration"] = 715,
    ["schema.org - Action"] = 717,
    ["schema.org - ContactPoint"] = 718,
    ["schema.org - Place"] = 719,
    ["schema.org - Thing"] = 720,
    ["secrethub.yml"] = 1029,
    ["semantic-release"] = 726,
    ["servicehub.config.json"] = 883,
    ["servicehub.service.json"] = 882,
    ["settings.job"] = 729,
    ["sfdx-hardis configuration"] = 731,
    ["shard.yml"] = 1067,
    ["size-limit configuration"] = 736,
    ["skaffold.yaml"] = 952,
    ["skyuxconfig.json"] = 738,
    ["snowflake-config"] = 740,
    ["snowflake-connections"] = 741,
    ["spicepod.yaml"] = 1087,
    ["sqlc configuration"] = 773,
    ["stripe-app-local.json"] = 784,
    ["stripe-app.json"] = 783,
    swcrc = 937,
    ["task.json"] = 793,
    taskcat = 901,
    ["template.json"] = 798,
    ["templatsources.json"] = 799,
    ["theme.json"] = 802,
    ["tizen_workspace.json"] = 804,
    tldr = 805,
    ["tm_devices configuration file"] = 1152,
    tmuxinator = 886,
    ["transcend.yml"] = 815,
    ["tree-sitter grammar.json"] = 390,
    ["trime.yaml"] = 816,
    ["trunk.yaml"] = 818,
    ["ts-force-config.json"] = 823,
    ["tsconfig.json"] = 819,
    ["tsd.json"] = 820,
    ["tsdoc.json"] = 821,
    ["tsdrc.json"] = 822,
    ...
    v8r = 865,
    vcluster = 1073,
    ["vcpkg configuration file"] = 222,
    ["vcpkg manifest file"] = 221,
    ["vega-lite.json"] = 847,
    ["vega.json"] = 846,
    ["venvironment.yaml"] = 849,
    ["venvplus.yaml"] = 850,
    version = 1134,
    ["version.json"] = 852,
    ["vhwdebugger-binding.yaml"] = 854,
    ["vim-addon-info"] = 855,
    ["vs-2017.3.host.json"] = 857,
    ["vs-nesting.json"] = 858,
    ["vsls.json"] = 856,
    ["vss-extension.json"] = 862,
    vtcfg = 1140,
    ["vtesttree.yaml"] = 863,
    ["vtestunit.yaml"] = 864,
    ["warp-keysets.json"] = 1035,
    ["warp-themes.json"] = 1036,
    ["warp-workflows.json"] = 1037,
    ["webhint.io"] = 992,
    ["webjobpublishsettings.json"] = 869,
    ["webjobs-list.json"] = 868,
    ["well-known-fursona"] = 1074,
    ["xs-app.json"] = 896,
    ["xunit.runner.json"] = 881,
    yamllint = 924,
    zuul = 907,
    ["Žinoma"] = 917
  },
