...
M.json = {
  ...
  index = {
    ...
    ["Azure Pipelines"] = 63,
    ["Azure Static Web Apps CLI configuration file"] = 642,
    ["Azure Static Web Apps configuration file"] = 641,
    ...
    ["Datadog Service Definition"] = 402,
    ["Datadog Software Catalog"] = 403,
    ...
    Lefthook = 411,
    ["Liferay client-extension.yaml"] = 418,
    ["LinkML Metamodel"] = 420,
    Liquibase = 795,
    ["Liquibase Flow File"] = 796,
    ["Lively Properties"] = 421,
    ["Lobe AI Agent"] = 61,
    Loki = 62,
    ["MLOS Configs"] = 457,
    ["MS2Rescore Configuration"] = 460,
    ["Madness (madness.yml)"] = 866,
    ["MapEHR Mapping"] = 427,
    Markdownlint = 799,
    ["Mason Registry"] = 801,
    ["MegaLinter configuration"] = 429,
    ["MegaLinter descriptor"] = 430,
    Melange = 892,
    ["Meltano project definition"] = 431,
    ["Mergify Configuration"] = 461,
    ["Metadata for a Bazel module"] = 432,
    ["Metadata for a Cinnamon spice"] = 940,
    ["MetricsHub Configuration"] = 433,
    ["MetricsHub Connector Configuration"] = 434,
    ["Micro Editor Syntax"] = 876,
    ["Microsoft Band Web Tile"] = 435,
    ["Microsoft RulesEngine workflow rules"] = 928,
    ["Microsoft RulesEngine workflow rules list"] = 929,
    ["Minecraft Custom Main Menu Mod"] = 893,
    ["Minecraft Data Pack Advancement"] = 437,
    ["Minecraft Data Pack Biome"] = 438,
    ["Minecraft Data Pack Configured Carver"] = 439,
    ["Minecraft Data Pack Damage Type"] = 440,
    ["Minecraft Data Pack Dimension"] = 442,
    ["Minecraft Data Pack Dimension Type"] = 441,
    ["Minecraft Data Pack Item Modifier"] = 443,
    ["Minecraft Data Pack Loot Table"] = 444,
    ["Minecraft Data Pack Metadata"] = 445,
    ["Minecraft Data Pack Predicate"] = 446,
    ["Minecraft Data Pack Recipe"] = 447,
    ["Minecraft Data Pack Tag"] = 448,
    ["Minecraft Data Pack Template Pool"] = 449,
    ["Minecraft Data Pack Trim Material"] = 454,
    ["Minecraft Data Pack Trim Pattern"] = 455,
    ["Minecraft Resource Pack Lang"] = 450,
    ["Minecraft Resource Pack Particle"] = 451,
    ["Minecraft Resource Pack Texture Mcmeta"] = 453,
    ["Minecraft Resourcepack Sounds"] = 452,
    ["Monade CLI Stack Configuration"] = 464,
    ["MongoDB Atlas Search Index Definition"] = 847,
    ["Monika Configuration"] = 845,
    ["Monoweave Configuration"] = 459,
    ["Motif config"] = 745,
    ["NOX Framework (Service)"] = 476,
    ["Netin Diagnostic System Template"] = 805,
    ["Netlify config"] = 467,
    ["Network-as-Code Data Model"] = 468,
    ["Nightwatch.js"] = 469,
    ["Nuitka.yaml"] = 906,
    ["Nullstone config"] = 482,
    ...
    ["October CMS columns"] = 486,
    ["October CMS fields"] = 487,
    Opctl = 748,
    ...
    ["Ory Keto configuration"] = 404,
    ["Ory Kratos configuration"] = 502,
    ["Ory Oathkeeper configuration"] = 484,
    ...
    ["Problem package generators"] = 540,
    Pterodactyl = 842,
    ["Pull Request Labeler"] = 555,
    Pulumi = 561,
    PyProject = 562,
    Pyright = 563,
    Qgoda = 564,
    ...
    Ray = 760,
    ["Read the Docs"] = 560,
    ["Red-DiscordBot Cog"] = 572,
    ["Red-DiscordBot Cog Repo"] = 573,
    ["Red-DiscordBot Trivia"] = 574,
    ...
    ["Rust Project"] = 581,
    ["Rust toolchain"] = 589,
    ["SDMX data message"] = 614,
    ["SDMX metadata message"] = 613,
    ["SDMX structure message"] = 612,
    ["SIL Kit Participant Configuration"] = 624,
    ["SIL Kit Registry Configuration"] = 625,
    SWADL = 653,
    ["Safebox Config"] = 853,
    ["Sapphire CLI Config"] = 592,
    ["SauceCTL Configuration"] = 802,
    ["Schema Catalog"] = 606,
    ["Scoop manifest"] = 611,
    ["Semantic Data Fabric (SDF) file"] = 615,
    ["Semgrep Rule"] = 617,
    ["Serenity Code Generator (Sergen)"] = 618,
    ...
    ["Sigma Detection Rule"] = 622,
    ["Sigrid scope configuration file"] = 623,
    ["SkyPilot Task JSON"] = 897,
    ["Slack app manifest"] = 627,
    Solidarity = 630,
    ["Solution filters"] = 631,
    ["Source Maps v3"] = 632,
    Sourcery = 633,
    ["Speakeasy Lint Configuration File"] = 634,
    ["Speakeasy Test Generation Configuration File"] = 635,
    ["Speakeasy Workflow File"] = 636,
    SpecIF = 637,
    ["Sponge Mixin configuration"] = 638,
    StackBlitz = 643,
    ["StackHawk Scanner Configuration"] = 808,
    Stale = 644,
    ["Starlake Data Pipeline"] = 783,
    Starship = 645,
    ["Statamic Blueprint"] = 646,
    ["Stella configuration file"] = 647,
    ["Stryker Mutator"] = 650,
    ["StyleCop Analyzers Configuration"] = 651,
    ["Stylelint (.stylelintrc)"] = 652,
    ["Sublime Syntax"] = 854,
    ...
    Talhelper = 656,
    ["Talisman configuration"] = 657,
    ["Taskfile config"] = 788,
    Taurus = 658,
    Tauticord = 659,
    ["TestEnvironment.json"] = 668,
    ["TextMate Grammar"] = 667,
    ["Tier.run pricing.json"] = 662,
    Tikibase = 663,
    ["Traefik v2"] = 671,
    ["Traefik v2 File Provider"] = 672,
    ["Travis CI (.travis.yml)"] = 670,
    ["TrueScript for *.tscript files"] = 675,
    TunnelHub = 889,
    Turborepo = 669,
    Tycho = 935,
    Tye = 816,
    ...
    ["UI5 Manifest"] = 693,
    ["UNCORS configuration"] = 697,
    ["UTAM Page Object"] = 696,
    ["Ubuntu Server Autoinstall"] = 691,
    ...
    ["VSIX CLI publishing"] = 714,
    ["Vela Pipeline Configuration"] = 701,
    Vercel = 175,
    ["Version Bumper config"] = 704,
    Visivo = 887,
    ["Waku Config"] = 948,
    ...
    jsdoc = 759,
    ["k3d.yaml"] = 390,
    ["k9s aliases.yaml"] = 392,
    ["k9s cluster-config.yaml"] = 394,
    ["k9s config.yaml"] = 393,
    ["k9s hotkeys.yaml"] = 395,
    ["k9s plugins.yaml"] = 396,
    ["k9s skin.yaml"] = 397,
    ["k9s views.yaml"] = 398,
    ["kontinuous-config.yaml"] = 406,
    ["kontinuous-values.yaml"] = 405,
    ["kustomization.yaml"] = 408,
    ["label-commenter-config.yml"] = 409,
    ["latexindent configuration"] = 60,
    ["launchsettings.json"] = 410,
    lazydocker = 878,
    lazygit = 877,
    ["lego.json"] = 412,
    ["lerna.json"] = 413,
    ["lgtm.yml"] = 414,
    ["liblab.config.json"] = 415,
    ["libman.json"] = 416,
    ["license-report-config.json"] = 417,
    ["linkinator.config.json"] = 419,
    ["lint-staged (.lintstagedrc)"] = 739,
    ["local.settings.json"] = 424,
    ["localazy.json"] = 425,
    ["lotus.yaml"] = 423,
    ["lsdlschema.json"] = 426,
    ...
    ["mtad.yaml"] = 744,
    ["mycode.json"] = 465,
    ["napari plugin manifest"] = 466,
    neoload = 754,
    ["nest-cli"] = 471,
    ["ninjs (News in JSON)"] = 470,
    ["nixd configuration"] = 895,
    ["nlu.json"] = 472,
    ["nodemon.json"] = 474,
    ["noodl config"] = 806,
    ["notebook.mod.json"] = 475,
    now = 750,
    ["npm-badges"] = 478,
    ["nswag.json"] = 481,
    ntangle = 483,
    ["nuclei-template.yaml"] = 479,
    ["nuget-project.json"] = 480,
    ["ocelot.json"] = 485,
    ["omnisharp.json"] = 488,
    ["openapi.json"] = 489,
    ["openfin.json"] = 496,
    ...
    ["prettierrc.json"] = 538,
    ["prisma.yml"] = 539,
    ["project-1.0.0-beta3.json"] = 542,
    ["project-1.0.0-beta4.json"] = 543,
    ["project-1.0.0-beta5.json"] = 544,
    ["project-1.0.0-beta6.json"] = 545,
    ["project-1.0.0-beta8.json"] = 546,
    ["project-1.0.0-rc1.json"] = 547,
    ["project-1.0.0-rc2.json"] = 548,
    ["project.json"] = 541,
    ["prometheus.json"] = 549,
    ["prometheus.rules.json"] = 550,
    ["prometheus.rules.test.json"] = 551,
    ["proxies.json"] = 552,
    ["publiccode.yml"] = 553,
    ["pubspec.yaml"] = 554,
    ["pyrseas-0.8.json"] = 557,
    ["quilt.mod.json"] = 872,
    ["rc3 auth"] = 566,
    ["rc3 collection"] = 567,
    ["rc3 environment"] = 568,
    ...
    samt = 590,
    samtrc = 591,
    ["sarif-1.0.0.json"] = 593,
    ["sarif-2.0.0.json"] = 594,
    ["sarif-2.1.0"] = 604,
    ["sarif-2.1.0-rtm.2"] = 595,
    ["sarif-2.1.0-rtm.3"] = 597,
    ["sarif-2.1.0-rtm.4"] = 599,
    ["sarif-2.1.0-rtm.5"] = 601,
    ["sarif-2.1.0-rtm.6"] = 602,
    ["sarif-external-property-file-2.1.0"] = 605,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 596,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 598,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 600,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 603,
    ["schema.org - Action"] = 607,
    ["schema.org - ContactPoint"] = 608,
    ["schema.org - Place"] = 609,
    ["schema.org - Thing"] = 610,
    ["secrethub.yml"] = 874,
    ["semantic-release"] = 616,
    ["servicehub.config.json"] = 734,
    ["servicehub.service.json"] = 733,
    ["settings.job"] = 619,
    ["sfdx-hardis configuration"] = 621,
    ["shard.yml"] = 910,
    ["size-limit configuration"] = 626,
    ["skaffold.yaml"] = 798,
    ["skyuxconfig.json"] = 628,
    snapcraft = 629,
    ["spicepod.yaml"] = 930,
    ["sqlc configuration"] = 640,
    ["stripe-app-local.json"] = 649,
    ["stripe-app.json"] = 648,
    swcrc = 784,
    ["task.json"] = 655,
    taskcat = 751,
    ["template.json"] = 660,
    ["templatsources.json"] = 661,
    ["theme.json"] = 664,
    ["tizen_workspace.json"] = 665,
    tldr = 666,
    tmuxinator = 737,
    ["transcend.yml"] = 673,
    ...
    ["vega-lite.json"] = 700,
    ["vega.json"] = 699,
    ["venvironment-basic.yaml"] = 703,
    ["venvironment.yaml"] = 702,
    ["version.json"] = 705,
    ["vhwdebugger-binding.yaml"] = 707,
    ["vim-addon-info"] = 708,
    ["vs-2017.3.host.json"] = 710,
    ["vs-nesting.json"] = 711,
    ["vsls.json"] = 709,
    ["vss-extension.json"] = 715,
    ["vtesttree.yaml"] = 716,
    ["vtestunit.yaml"] = 717,
