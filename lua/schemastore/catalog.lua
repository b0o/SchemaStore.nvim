...
M.json = {
  ...
  index = {
    ...
    AIConfig = 29,
    ["AMX Muse Program Descriptor"] = 1130,
    ["API Builder"] = 940,
    ["AVA Configuration"] = 1003,
    ...
    ["AWS Copilot Manifest"] = 1169,
    ["AWS SAM CLI Samconfig"] = 248,
    ["Adobe UXP Manifest"] = 1066,
    ["Aerleon Network & Service Definitions"] = 16,
    ["Aerleon Policy"] = 17,
    Aider = 1159,
    Air = 19,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1180,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1179,
    ["Airlock Microgateway"] = 30,
    ["Alacritty Configuration"] = 975,
    ["All Contributors configuration file"] = 1029,
    ...
    ["Application list for a WinUtil"] = 1110,
    ArchitectFX = 1115,
    ["Argo CD"] = 49,
    ["Argo Events"] = 50,
    ["Argo Workflows"] = 51,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1178,
    ["Azure IoT Operations connector metadata"] = 1175,
    ...
    ["Azure Pipelines"] = 103,
    ["Azure Static Web Apps CLI configuration file"] = 785,
    ["Azure Static Web Apps configuration file"] = 784,
    ["BOSH CPI Config"] = 127,
    ["BOSH Deploy Config"] = 128,
    ["BX CI"] = 147,
    ["Bacon config"] = 3,
    ["Bashly (bashly.yml)"] = 1033,
    ["Bashly Settings (bashly-settings.yml)"] = 1034,
    ["Better Code Hub"] = 945,
    ["Better Scripts"] = 148,
    Bigconfig = 120,
    ["Biome Formatter Config"] = 76,
    ["Bitmovin Encoding Template"] = 1123,
    BizTalkServerApplicationSchema = 912,
    Bleep = 149,
    ...
    ["Butane Config"] = 988,
    C4InterFlow = 1138,
    ["CDK Environment Manager, concrete environment configuration"] = 1162,
    ["CDK Environment Manager, concrete environments definition"] = 1161,
    ["CDK Environment Manager, environment definition"] = 1160,
    ["CGS Card Game Specification (cgs.json)"] = 1071,
    ["CICS TS region tagging"] = 997,
    ["CICS TS resource import"] = 998,
    ["CICS TS resource model"] = 999,
    ["CICS TS resource overrides"] = 1000,
    ["CMake Presets"] = 150,
    ["CNC Codes"] = 171,
    ["CRS WAF test file"] = 1100,
    ["CRS WAF test platform overrides file"] = 1101,
    ...
    ["Chamaleon environment"] = 1127,
    ["Chamaleon properties"] = 1128,
    ["Chamaleon template"] = 1126,
    Changepacks = 1189,
    Changesets = 257,
    Changie = 159,
    Charmcraft = 160,
    ...
    ["Clawject config"] = 177,
    ["Cloud Foundry Application Manifest"] = 1082,
    ["Cloud Run Spec v1"] = 1105,
    ...
    Concord = 1099,
    ["Configu .cfgu files"] = 1087,
    ["Configu .configu file"] = 1088,
    Conjure = 170,
    ["Container Structure Test"] = 926,
    Containerlab = 954,
    ["Contextive Glossary"] = 1154,
    Convex = 169,
    ["Crowdsec collection config"] = 267,
    ["Crowdsec parser config"] = 268,
    ["Crowdsec scenario config"] = 269,
    ["CumulusCI Config"] = 176,
    ["Custom Machinery Machine"] = 1072,
    ["Custom Machinery Recipe"] = 1073,
    ...
    ["DonateCaseBetterCasino menu"] = 1131,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1041,
    ["EAS config"] = 333,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1030,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1174,
    ["EasyVCR .NET"] = 334,
    ["Eidolon Resource"] = 1116,
    ...
    ["Evolving Resolutive Process notation"] = 1176,
    ["Expo SDK"] = 332,
    ...
    ["GeoJSON.json latest"] = 992,
    GherKing = 996,
    ["GitHub Action"] = 366,
    ["GitHub Actions typing"] = 1112,
    ...
    ["Google Digital Assetlinks"] = 1155,
    Goreleaser = 394,
    ["Goreleaser Pro"] = 395,
    Goss = 396,
    ["Gradle Build Cache Node"] = 943,
    ["Gradle Enterprise"] = 942,
    ...
    Hadolint = 922,
    Hammerkit = 953,
    ["Hardware Sentry Configuration"] = 1008,
    ["HashiCorp Vault"] = 410,
    Hatch = 923,
    Hayagriva = 412,
    Hayson = 413,
    ...
    ["JFrog File Spec"] = 448,
    ["JFrog Pipelines YML DSL"] = 1018,
    ["JMeter DSL cli config"] = 449,
    JReleaser = 452,
    ["JSON Document Transform"] = 460,
    ["JSON Feed"] = 461,
    ["JSON Resume"] = 698,
    ["JSON Schema Draft 2020-12"] = 890,
    ["JSON Schema Draft 4"] = 887,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1051,
    ["JSON Schema Draft 7"] = 888,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1052,
    ["JSON Schema Draft 8 (2019-09)"] = 889,
    ["JSON-API"] = 459,
    ["JSON-e templates"] = 950,
    ["JSON-stat 2.0"] = 883,
    JSONPatch = 463,
    ...
    ["Jujutsu (jj) VCS config"] = 1168,
    ["KIMMDY config file"] = 474,
    ["KODE/CI build.yaml"] = 1014,
    ["KSP-AVC"] = 884,
    ["KSP-CKAN"] = 885,
    ["KSP-NetKAN"] = 886,
    KSY = 1081,
    ...
    ["Metadata for a Cinnamon spice"] = 1108,
    ["Metatype Configuration"] = 514,
    ["MetricsHub Configuration"] = 515,
    ["MetricsHub Connector Configuration"] = 516,
    ["Micro Editor Syntax"] = 1042,
    ["Microsoft Band Web Tile"] = 517,
    ["Microsoft RulesEngine workflow rules"] = 1096,
    ["Microsoft RulesEngine workflow rules list"] = 1097,
    ["Minecraft Custom Main Menu Mod"] = 1060,
    ...
    ["MongoDB Atlas Search Index Definition"] = 1013,
    ["Monika Configuration"] = 1011,
    ["Monoweave Configuration"] = 542,
    ["Motif config"] = 904,
    MultiQC = 1148,
    ["NOX Framework (Service)"] = 563,
    ["Netin Diagnostic System Template"] = 970,
    ["Netlify config"] = 550,
    ...
    ["OpenUtau ustx"] = 584,
    ["OpenWeather Current Weather API"] = 949,
    ["OpenWeather Road Risk API"] = 948,
    ...
    ["Power Pages Configuration"] = 1165,
    ["Preset list for a WinUtil"] = 1111,
    ...
    ["Problem object RFC9457"] = 1057,
    ["Problem package generators"] = 645,
    Pterodactyl = 1007,
    ["Pull Request Labeler"] = 662,
    Pulumi = 670,
    ["PyGTA Config"] = 666,
    PyProject = 671,
    Pylock = 1156,
    Pyright = 672,
    ["Python script metadata"] = 1150,
    ["QType AI DSL"] = 675,
    Qgoda = 674,
    Qodana = 980,
    ["Qt Creator workspace file"] = 1089,
    ["Quali Torque Blueprint Spec 2"] = 1005,
    ["QueryFirst config file"] = 1024,
    ["RKE Cluster Configuration JSON"] = 958,
    ["RKE Cluster Configuration YAML"] = 957,
    RadioHound = 665,
    Railpack = 677,
    Railway = 676,
    ["Rancher Fleet"] = 667,
    ...
    Ray = 921,
    ["Read the Docs"] = 669,
    ["Red-DiscordBot Cog"] = 685,
    ["Red-DiscordBot Cog Repo"] = 686,
    ["Red-DiscordBot Trivia"] = 687,
    ["Releasaurus Config"] = 2,
    ["Render Blueprints"] = 956,
    RenderCV = 700,
    Renovate = 699,
    ["Replit config"] = 693,
    Restate = 1143,
    ["Revel Digital Gadget Definition File"] = 1167,
    RoadRunner = 702,
    ["Robust Station Image"] = 1173,
    Rockcraft = 703,
    ["Roo Coder Custom Modes"] = 704,
    Rubocop = 695,
    ["Rudder techniques"] = 1064,
    Ruff = 696,
    ["Rust Project"] = 697,
    ["Rust toolchain"] = 708,
    ["SDMX data message"] = 734,
    ["SDMX metadata message"] = 733,
    ["SDMX structure message"] = 732,
    ["SIL Kit Participant Configuration"] = 744,
    ["SIL Kit Registry Configuration"] = 745,
    ["SPDX 2.3"] = 782,
    SWADL = 798,
    ["Safebox Config"] = 1019,
    ["Sapphire CLI Config"] = 711,
    ["SauceCTL Configuration"] = 967,
    ["Schema Catalog"] = 726,
    ["Scoop manifest"] = 731,
    ["Semantic Data Fabric (SDF) file"] = 735,
    ["Semgrep Rule"] = 737,
    ["Serenity Code Generator (Sergen)"] = 738,
    ["Serverless Framework Configuration"] = 974,
    ["Serverless Workflow"] = 976,
    ["Settings for a Cinnamon spice"] = 1107,
    ["Settings.paf"] = 740,
    ["Shopware 6 Configuration"] = 977,
    ["Shopware CLI Extension Store Configuration"] = 978,
    ["Shopware CLI Project Store Configuration"] = 979,
    ["Sigma Detection Rule"] = 742,
    ["Sigrid scope configuration file"] = 743,
    ["SkyPilot Task JSON"] = 1065,
    ["Slack app manifest"] = 747,
    Snapcraft = 749,
    Solidarity = 752,
    ["Solution filters"] = 753,
    ["Source Maps v3"] = 754,
    Sourcery = 755,
    ["Spack bootstrap.yaml"] = 756,
    ["Spack cdash.yaml"] = 757,
    ["Spack ci.yaml"] = 758,
    ["Spack compilers.yaml"] = 759,
    ["Spack concretizer.yaml"] = 760,
    ["Spack config.yaml"] = 761,
    ["Spack definitions.yaml"] = 762,
    ["Spack develop.yaml"] = 763,
    ["Spack env_vars.yaml"] = 764,
    ["Spack environment"] = 770,
    ["Spack include.yaml"] = 765,
    ["Spack mirrors.yaml"] = 766,
    ["Spack modules.yaml"] = 767,
    ["Spack packages.yaml"] = 768,
    ["Spack repos.yaml"] = 769,
    ["Spack toolchains.yaml"] = 771,
    ["Spack upstreams.yaml"] = 772,
    ["Spack view.yaml"] = 773,
    ["Speakeasy Generation Config File"] = 777,
    ["Speakeasy Lint Configuration File"] = 774,
    ["Speakeasy Test Generation Configuration File"] = 775,
    ["Speakeasy Workflow File"] = 776,
    SpecIF = 778,
    ["Specmatic Configuration"] = 779,
    ["Sponge Mixin configuration"] = 780,
    StackBlitz = 786,
    ["StackHawk Scanner Configuration"] = 973,
    Stale = 787,
    Starfish = 788,
    ["Starlake Data Pipeline"] = 946,
    Starship = 789,
    ["Statamic Blueprint"] = 790,
    ["Stella configuration file"] = 791,
    ["Streamlit configuration file"] = 792,
    ["Stryker Mutator"] = 795,
    ["StyleCop Analyzers Configuration"] = 796,
    ["Stylelint (.stylelintrc)"] = 797,
    ["Stylua Config"] = 1157,
    ["Sublime Syntax"] = 1020,
    ["Subsquid squid manifest"] = 1067,
    ["Swagger API 2.0"] = 799,
    ["Synadia Connect Component"] = 800,
    TSON = 835,
    TSTyche = 836,
    ["TYPO3 Vendor Bundler config"] = 841,
    ["Tab data for a LinUtil"] = 1114,
    ["Tab list for a LinUtil"] = 1113,
    Tach = 801,
    ["Tach Domain"] = 802,
    Talhelper = 804,
    ["Talisman configuration"] = 805,
    Taplo = 1158,
    ["Taskfile config"] = 951,
    Taurus = 806,
    Tauticord = 807,
    ["Tekton Pipeline"] = 1186,
    ["Tekton PipelineRun"] = 1187,
    ["Tekton Task"] = 1184,
    ["Tekton TaskRun"] = 1185,
    Telefonistka = 1144,
    ["Terrateam config"] = 1170,
    ["TestEnvironment.json"] = 818,
    ["TextMate Grammar"] = 817,
    Threagile = 813,
    ["Tier.run pricing.json"] = 810,
    Tikibase = 811,
    Tombi = 816,
    ["Traefik v2"] = 821,
    ["Traefik v2 File Provider"] = 822,
    ["Traefik v3"] = 823,
    ["Traefik v3 File Provider"] = 824,
    ["Travis CI (.travis.yml)"] = 820,
    Treefmt = 399,
    Trident = 1140,
    ["TrueScript for *.tscript files"] = 827,
    ["Tugboat QA config.yml"] = 1137,
    TunnelHub = 1055,
    Turborepo = 819,
    Tycho = 1103,
    Tye = 981,
    ["Tyk Gateway - Open Source v5.7+"] = 1149,
    ["Typst Manifest"] = 842,
    ["UET BuildConfig.json"] = 1025,
    ["UI5 Manifest"] = 848,
    ["UNCORS configuration"] = 852,
    ["UTAM Page Object"] = 851,
    ["Ubuntu Server Autoinstall"] = 846,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1141,
    ["Uniswap Token List"] = 933,
    ["Universal Schedule Format"] = 853,
    ["Unreal Engine Uplugin"] = 1026,
    ["Unreal Engine Uproject"] = 1027,
    ["UpCloud CLI (upctl) configuration"] = 1142,
    ["Updatecli Compose"] = 989,
    ["Updatecli Policy Manifest"] = 990,
    ["Updatecli Policy Metadata"] = 991,
    Uplift = 1023,
    ["Upsun config"] = 4,
    ["User Journey Map"] = 955,
    V2Ray = 995,
    ["VSCode Code Snippets"] = 232,
    ["VSIX CLI publishing"] = 871,
    Vector = 855,
    ...
    Wake = 1139,
    ["Waku Config"] = 1117,
    ["Web App Manifest"] = 877,
    ["Web types"] = 880,
    WebExtensions = 876,
    ["Webman package recipe"] = 1001,
    ["Windows Package Manager Installer Manifest"] = 929,
    ["Windows Package Manager Locale Manifest"] = 930,
    ["Windows Package Manager Singleton Manifest"] = 928,
    Winutil = 931,
    ["WireMock CLI import configuration"] = 1122,
    ["WireMock CLI local service configuration"] = 1121,
    ["WireMock stub mapping"] = 1120,
    ["Woodpecker pipeline config"] = 969,
    ["Wrangler CLI"] = 882,
    ["Xstate Machine"] = 987,
    ["Yandex Workflow Language"] = 1109,
    ["Yarn Config (.yarnrc.yml)"] = 944,
    ["Yippee-Ki-JSON configuration YML"] = 935,
    ["YouTrack App"] = 1106,
    ["Zarf Package Configuration"] = 1172,
    ["Zerops.io config"] = 1094,
    ["Zerops.io import"] = 1095,
    ["Zola Configuration"] = 1183,
    ["aerleon.yml"] = 15,
    ["angular.json"] = 31,
    apko = 1058,
    ...
    ["behat.yml"] = 130,
    ["bigquery-table"] = 119,
    ["bioimageio resource description"] = 1075,
    ...
    ["crowdin.yml"] = 266,
    ["ctfd-setup configuration file"] = 1129,
    ["custom-elements.json"] = 1045,
    ["cypress.json"] = 270,
    ...
    ["gematik health care insurance list"] = 1135,
    ["gematik health care patient list"] = 1132,
    ["gematik health care provider institution list"] = 1134,
    ["gematik health care provider list"] = 1133,
    ["gematik tiger test environment configuration"] = 1136,
    ["git-town.toml"] = 1181,
    ["gitlab-ci"] = 374,
    ["global.json"] = 390,
    ...
    ["lint-staged (.lintstagedrc)"] = 898,
    ["local.settings.json"] = 502,
    ["localazy.json"] = 503,
    ["lotus.yaml"] = 501,
    ["lsdlschema.json"] = 504,
    ["macro.json"] = 1010,
    ["markdown-link-check"] = 964,
    maturin = 965,
    mboats = 972,
    ["micro-settings.json"] = 1037,
    ["mimetypes.json"] = 518,
    ["mirrord config"] = 900,
    mise = 901,
    ["mkdocs.yml"] = 538,
    ["monospace.yml"] = 541,
    ["moon.yml"] = 1119,
    ["mprocs Configuration file"] = 1090,
    ["mrdocs.yml"] = 539,
    ["mta.yaml"] = 902,
    ["mtad.yaml"] = 903,
    ["mycode.json"] = 548,
    ...
    ["plagiarize.yaml"] = 621,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1125,
    ["podbard.yaml"] = 624,
    ["portman.json"] = 627,
    ["prefect.toml"] = 635,
    ["prefect.yaml"] = 636,
    ["prettierrc.json"] = 637,
    ["prisma.yml"] = 638,
    ["project-1.0.0-beta3.json"] = 647,
    ["project-1.0.0-beta4.json"] = 648,
    ["project-1.0.0-beta5.json"] = 649,
    ["project-1.0.0-beta6.json"] = 650,
    ["project-1.0.0-beta8.json"] = 651,
    ["project-1.0.0-rc1.json"] = 652,
    ["project-1.0.0-rc2.json"] = 653,
    ["project.json"] = 646,
    ["project.owasp.yaml"] = 654,
    ["prometheus-alertmanager.json"] = 658,
    ["prometheus.json"] = 655,
    ["prometheus.rules.json"] = 656,
    ["prometheus.rules.test.json"] = 657,
    ["proxies.json"] = 659,
    ["publiccode.yml"] = 660,
    ["pubspec.yaml"] = 661,
    ["pyrseas-0.8.json"] = 664,
    pytest = 673,
    ["quilt.mod.json"] = 1038,
    ["rc3 auth"] = 679,
    ["rc3 collection"] = 680,
    ...
    ["release drafter"] = 916,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 689,
    ["release-please-manifest.json"] = 690,
    ["release-plz.toml"] = 691,
    ["renv.lock"] = 701,
    ["rivet.json"] = 1062,
    ["rivet.yaml (legacy)"] = 1061,
    rumdl = 706,
    runny = 705,
    rustfmt = 707,
    sake = 1152,
    samt = 709,
    samtrc = 710,
    ["sarif-1.0.0.json"] = 712,
    ["sarif-2.0.0.json"] = 713,
    ["sarif-2.1.0"] = 723,
    ["sarif-2.1.0-rtm.2"] = 714,
    ["sarif-2.1.0-rtm.3"] = 716,
    ["sarif-2.1.0-rtm.4"] = 718,
    ["sarif-2.1.0-rtm.5"] = 720,
    ["sarif-2.1.0-rtm.6"] = 721,
    ["sarif-external-property-file-2.1.0"] = 724,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 715,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 717,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 719,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 722,
    ["scalingo.json configuration"] = 725,
    ["schema.org - Action"] = 727,
    ["schema.org - ContactPoint"] = 728,
    ["schema.org - Place"] = 729,
    ["schema.org - Thing"] = 730,
    ["secrethub.yml"] = 1040,
    ["semantic-release"] = 736,
    ["servicehub.config.json"] = 893,
    ["servicehub.service.json"] = 892,
    ["settings.job"] = 739,
    ["sfdx-hardis configuration"] = 741,
    ["shard.yml"] = 1078,
    ["size-limit configuration"] = 746,
    ["skaffold.yaml"] = 962,
    ["skyuxconfig.json"] = 748,
    ["snowflake-config"] = 750,
    ["snowflake-connections"] = 751,
    ["spicepod.yaml"] = 1098,
    ["sqlc configuration"] = 783,
    ["stripe-app-local.json"] = 794,
    ["stripe-app.json"] = 793,
    swcrc = 947,
    ["task.json"] = 803,
    taskcat = 911,
    ["template.json"] = 808,
    ["templatsources.json"] = 809,
    ["theme.json"] = 812,
    ["tizen_workspace.json"] = 814,
    tldr = 815,
    ["tm_devices configuration file"] = 1163,
    tmuxinator = 896,
    ["transcend.yml"] = 825,
    ["tree-sitter grammar.json"] = 398,
    ["trime.yaml"] = 826,
    ["trunk.yaml"] = 828,
    ["ts-force-config.json"] = 833,
    ["tsconfig.json"] = 829,
    ["tsd.json"] = 830,
    ["tsdoc.json"] = 831,
    ["tsdrc.json"] = 832,
    ...
    ["vega-lite.json"] = 857,
    ["vega.json"] = 856,
    ["venvironment.yaml"] = 859,
    ["venvplus.yaml"] = 860,
    version = 1145,
    ["version.json"] = 862,
    ["vhwdebugger-binding.yaml"] = 864,
    ["vim-addon-info"] = 865,
    ["vs-2017.3.host.json"] = 867,
    ["vs-nesting.json"] = 868,
    ["vsls.json"] = 866,
    ["vss-extension.json"] = 872,
    vtcfg = 1151,
    ["vtesttree.yaml"] = 873,
    ["vtestunit.yaml"] = 874,
    ["warp-keysets.json"] = 1046,
    ["warp-themes.json"] = 1047,
    ["warp-workflows.json"] = 1048,
    ["webhint.io"] = 1002,
    ["webjobpublishsettings.json"] = 879,
    ["webjobs-list.json"] = 878,
    ["well-known-fursona"] = 1085,
    ["xs-app.json"] = 906,
    ["xunit.runner.json"] = 891,
    yamllint = 934,
    zizmor = 1188,
    zuul = 917,
    ["Žinoma"] = 927
