...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 96,
    [".cryproj (generic)"] = 389,
    [".cryproj engine-5.2"] = 384,
    [".cryproj engine-5.3"] = 385,
    [".cryproj engine-5.4"] = 386,
    [".cryproj engine-5.5"] = 387,
    [".cryproj engine-dev"] = 388,
    [".csscomb.json"] = 98,
    [".csslintrc"] = 99,
    [".eslintrc"] = 133,
    [".esmrc.json"] = 126,
    ...
    [".mtaext"] = 395,
    [".nodehawkrc"] = 237,
    [".npmpackagejsonlintrc"] = 239,
    [".phraseapp.yml"] = 266,
    [".pmbot.yml"] = 259,
    [".postcssrc"] = 264,
    [".pre-commit-config.yml"] = 265,
    [".putout.json"] = 283,
    [".rehyperc"] = 288,
    [".remarkrc"] = 289,
    [".sprite files"] = 323,
    ...
    [".vsext"] = 365,
    [".yarnrc.yml"] = 427,
    ["<div>RIOTS' studio configuration"] = 368,
    ["API Builder"] = 424,
    ...
    ["Azure Pipelines"] = 32,
    ["Azure Static Web Apps CLI configuration file"] = 325,
    ["Azure Static Web Apps configuration file"] = 324,
    ["Better Code Hub"] = 429,
    BizTalkServerApplicationSchema = 401,
    Briefcase = 406,
    Buildkite = 53,
    ...
    Esquio = 127,
    ["Expo SDK"] = 132,
    ["F-Droid Data metadata"] = 136,
    ["Facets - FSDL - Application"] = 134,
    ["Fossa configuration file"] = 141,
    ["Foundry VTT - Manifest"] = 139,
    ["Foundry VTT - Template"] = 140,
    ["Foxx Manifest"] = 33,
    ["GatewayCore API Gateway"] = 144,
    ["GitHub Action"] = 148,
    ["GitHub Funding"] = 149,
    ["GitHub Issue Template configuration"] = 151,
    ["GitHub Workflow"] = 152,
    ["GitHub Workflow Template Properties"] = 153,
    ["GitHub issue forms"] = 150,
    GitVersion = 147,
    ["Gitpod Configuration"] = 155,
    ["Global Privacy Control"] = 145,
    ["Google Cloud Workflows"] = 85,
    Goreleaser = 158,
    ["Goreleaser Pro"] = 159,
    ["Gradle Build Cache Node"] = 426,
    ["Gradle Enterprise"] = 425,
    ["Grafana 5.x Dashboard"] = 160,
    ["GraphQL Code Generator"] = 163,
    ["GraphQL Config"] = 162,
    ["GraphQL Mesh"] = 161,
    ["Grunt JSHint task"] = 167,
    ["Grunt Watch task"] = 168,
    ["Grunt base task"] = 169,
    ["Grunt clean task"] = 165,
    ["Grunt copy task"] = 164,
    ["Grunt cssmin task"] = 166,
    HEMTT = 398,
    Hadolint = 410,
    ["Hammerkit YAML Schema"] = 436,
    Hayson = 171,
    ["Hazelcast 5 Configuration"] = 172,
    ["Helm Chart.lock"] = 64,
    ["Helm Chart.yaml"] = 63,
    ["JFrog File Spec"] = 185,
    ["JSON Document Transform"] = 193,
    ["JSON Feed"] = 194,
    ["JSON Resume"] = 291,
    ["JSON Schema Draft 2020-12"] = 380,
    ["JSON Schema Draft 4"] = 377,
    ["JSON Schema Draft 7"] = 378,
    ["JSON Schema Draft 8"] = 379,
    ...
    ["JSON-API"] = 192,
    ["JSON-e templates"] = 434,
    ["JSON-stat 2.0"] = 374,
    JSONPatch = 196,
    ["Jekyll configuration"] = 182,
    ["Jenkins X Pipelines"] = 183,
    ["Jenkins X Requirements"] = 184,
    ["Jovo Language Models"] = 186,
    ["KSP-AVC"] = 375,
    ["KSP-CKAN"] = 376,
    Liquibase = 441,
    ["MegaLinter configuration"] = 210,
    ["MegaLinter descriptor"] = 211,
    ["Meltano plugin discovery definition"] = 213,
    ["Meltano project definition"] = 212,
    ["Microsoft Band Web Tile"] = 214,
    ["Minecraft Data Pack Advancement"] = 216,
    ["Minecraft Data Pack Biome"] = 217,
    ["Minecraft Data Pack Configured Carver"] = 218,
    ["Minecraft Data Pack Dimension"] = 220,
    ["Minecraft Data Pack Dimension Type"] = 219,
    ["Minecraft Data Pack Item Modifier"] = 221,
    ["Minecraft Data Pack Loot Table"] = 222,
    ["Minecraft Data Pack Metadata"] = 223,
    ["Minecraft Data Pack Predicate"] = 224,
    ["Minecraft Data Pack Recipe"] = 225,
    ["Minecraft Data Pack Template Pool"] = 226,
    ["Minecraft Resourcepack Sounds"] = 227,
    ["Netin Diagnostic System Template"] = 448,
    ["Netlify config schema"] = 232,
    ["Nightwatch.js"] = 233,
    ["OSS Review Toolkit repository configuration"] = 253,
    Opctl = 397,
    ["OpenWeather Current Weather API"] = 433,
    ["OpenWeather Road Risk API"] = 432,
    ["Ory Hydra configuration"] = 176,
    ["Ory Keto configuration"] = 199,
    ["Ory Kratos configuration"] = 252,
    ["Ory Oathkeeper configuration"] = 244,
    ["Outblocks App configuration"] = 250,
    ["Outblocks database table"] = 251,
    ["Outblocks project configuration"] = 249,
    Packer = 256,
    ["Pipeline component"] = 442,
    ["PocketMine plugin.yml"] = 260,
    ["Pull Request Labeler"] = 282,
    ["RKE Cluster Configuration JSON Schema"] = 440,
    ["RKE Cluster Configuration YAML Schema"] = 439,
    Ray = 409,
    ["Read the Docs"] = 285,
    ...
    RoadRunner = 293,
    SWADL = 333,
    ["Sapphire CLI Config"] = 294,
    ["SauceCTL Configuration"] = 445,
    ["Schema Catalog"] = 307,
    ["Scoop manifest"] = 312,
    ["Semgrep Rule"] = 313,
    ["Serverless Framework Configuration"] = 452,
    ["Shopware CLI Extension Store Configuration"] = 453,
    Solidarity = 319,
    ["Source Maps v3"] = 320,
    SpecIF = 321,
    ["Sponge Mixin configuration"] = 322,
    ["StackHawk Scanner Configuration"] = 451,
    ["StackHead CLI config"] = 326,
    ["StackHead module configuration"] = 327,
    ["StackHead project definition"] = 328,
    Stale = 329,
    ["Stryker Mutator"] = 330,
    ["StyleCop Analyzers Configuration"] = 331,
    ["Swagger API 2.0"] = 334,
    ["Taskfile YAML Schema"] = 435,
    Taurus = 335,
    ["TestEnvironment.json"] = 340,
    ["Traefik v2"] = 342,
    ["Traefik v2 File Provider"] = 343,
    ["UI5 Manifest"] = 354,
    ["Uniswap Token List"] = 418,
    ["User Journey Map YAML Schema"] = 438,
    ["VSCode Code Snippets"] = 75,
    ["VSIX CLI publishing"] = 366,
    ["Vela Pipeline Configuration"] = 358,
    Vercel = 74,
    ["Web App Manifest"] = 370,
    ["Web types"] = 373,
    WebExtensions = 369,
    ["Windows Package Manager Installer Manifest"] = 415,
    ["Windows Package Manager Locale Manifest"] = 416,
    ["Windows Package Manager Singleton Manifest"] = 414,
    ["Woodpecker pipeline config"] = 447,
    ["Yippee-Ki-JSON configuration YML"] = 420,
    ["angular.json"] = 6,
    ...
    ["dvc.yaml"] = 123,
    ["ecosystem.json"] = 125,
    ["electron-builder configuration file."] = 130,
    ["epr-manifest.json"] = 128,
    ["evcc.yaml"] = 131,
    ["fabric.mod.json"] = 135,
    ["first-timers-bot"] = 138,
    fulibWorkflows = 446,
    ["func.yaml"] = 142,
    ["function.json"] = 143,
    ["geojson.json"] = 146,
    ["gitlab-ci"] = 154,
    ["global.json"] = 156,
    ["golangci-lint Configuration"] = 157,
    ["haxelib.json"] = 170,
    helmfile = 411,
    ["host-meta.json"] = 174,
    ["host.json"] = 173,
    ...
    httpmockrc = 402,
    huskyrc = 391,
    ["imageoptimizer.json"] = 177,
    ["importmap.json"] = 179,
    ["ioBroker JSON UI"] = 180,
    ["ioBroker Package manifest"] = 181,
    ["jsconfig.json"] = 197,
    jsdoc = 408,
    ["k3d.yaml"] = 198,
    ["kustomization.yaml"] = 200,
    ["label-commenter-config.yml"] = 201,
    ["launchsettings.json"] = 202,
    ["lerna.json"] = 203,
    ["lgtm.yml"] = 204,
    ["libman.json"] = 205,
    ["license-report-config.json"] = 206,
    ["local.settings.json"] = 207,
    ["localazy.json"] = 208,
    ["lsdlschema.json"] = 209,
    ["markdownlint.json"] = 444,
    mboats = 450,
    ["mimetypes.json"] = 215,
    ["mta.yaml"] = 393,
    ["mtad.yaml"] = 394,
    ["mycode.json"] = 230,
    ["napari plugin manifest"] = 231,
    neoload = 403,
    ["nest-cli"] = 235,
    ["ninjs (News in JSON)"] = 234,
    ["nlu.json"] = 236,
    ["nodemon.json"] = 238,
    ["noodl.schema.json"] = 449,
    now = 399,
    ["nswag.json"] = 242,
    ntangle = 243,
    ["nuclei-template.yaml"] = 240,
    ["nuget-project.json"] = 241,
    ["ocelot.json"] = 245,
    ["omnisharp.json"] = 246,
    ["openapi.json"] = 247,
    ["openfin.json"] = 248,
    ["package.json"] = 254,
    ["package.manifest"] = 255,
    ["pattern.json"] = 258,
    pgap_yaml_input_reader = 257,
    ["plagiarize-me.yaml"] = 262,
    ["plagiarize.yaml"] = 261,
    ["portman.json"] = 263,
    ["prettierrc.json"] = 267,
    ["prisma.yml"] = 268,
    ["project-1.0.0-beta3.json"] = 270,
    ["project-1.0.0-beta4.json"] = 271,
    ["project-1.0.0-beta5.json"] = 272,
    ["project-1.0.0-beta6.json"] = 273,
    ["project-1.0.0-beta8.json"] = 274,
    ["project-1.0.0-rc1.json"] = 275,
    ["project-1.0.0-rc2.json"] = 276,
    ["project.json"] = 269,
    ["prometheus.json"] = 277,
    ["prometheus.rules.json"] = 278,
    ["proxies.json"] = 279,
    ["publiccode.yml"] = 280,
    ["pubspec.yaml"] = 281,
    ["pyrseas-0.8.json"] = 284,
    ["release drafter"] = 404,
    ["sarif-1.0.0.json"] = 295,
    ["sarif-2.0.0.json"] = 296,
    ["sarif-2.1.0"] = 305,
    ["sarif-2.1.0-rtm.2"] = 297,
    ["sarif-2.1.0-rtm.3"] = 299,
    ["sarif-2.1.0-rtm.4"] = 301,
    ["sarif-2.1.0-rtm.5"] = 303,
    ["sarif-external-property-file-2.1.0"] = 306,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 298,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 300,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 302,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 304,
    ["schema.org - Action"] = 308,
    ["schema.org - ContactPoint"] = 309,
    ["schema.org - Place"] = 310,
    ["schema.org - Thing"] = 311,
    ["servicehub.config.json"] = 383,
    ["servicehub.service.json"] = 382,
    ["settings.job"] = 314,
    ["sfdx-hardis configuration"] = 315,
    ["size-limit configuration"] = 316,
    ["skaffold.yaml"] = 443,
    ["skyuxconfig.json"] = 317,
    snapcraft = 318,
    swcrc = 431,
    taskcat = 400,
    ["template.json"] = 336,
    ["templatsources.json"] = 337,
    ["theme.json"] = 338,
    tmLanguage = 339,
    ["trunk.yaml schema"] = 344,
    ["ts-force-config.json"] = 348,
    ["tsconfig.json"] = 345,
    ["tsd.json"] = 346,
    ["tsdrc.json"] = 347,
    ["tslint.json"] = 349,
    ...
    ["version.json"] = 359,
    ["vim-addon-info"] = 360,
    ["vs-2017.3.host.json"] = 362,
    ["vs-nesting.json"] = 363,
    ["vsls.json"] = 361,
    ["vss-extension.json"] = 367,
    ["webjobpublishsettings.json"] = 372,
    ["webjobs-list.json"] = 371,
    ["xs-app.json"] = 396,
    ["xunit.runner.json"] = 381,
    yamllint = 419,
    zuul = 405,
    ["Žinoma"] = 413
  },
