...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 172,
    [".cryproj (generic)"] = 593,
    [".cryproj engine-5.2"] = 588,
    [".cryproj engine-5.3"] = 589,
    [".cryproj engine-5.4"] = 590,
    [".cryproj engine-5.5"] = 591,
    [".cryproj engine-dev"] = 592,
    [".csscomb.json"] = 174,
    [".csslintrc"] = 175,
    [".es6importsorterrc.json"] = 719,
    [".eslintrc"] = 224,
    [".esmrc.json"] = 216,
    [".ffizer.yaml"] = 228,
    [".htmlhintrc"] = 279,
    ...
    [".mtaext"] = 602,
    [".nodehawkrc"] = 378,
    [".npmpackagejsonlintrc"] = 381,
    [".phraseapp.yml"] = 422,
    [".pmbot.yml"] = 412,
    [".postcssrc"] = 417,
    [".powerpages-web-template-manifest"] = 419,
    [".pre-commit-config.yml"] = 420,
    [".pre-commit-hooks.yml"] = 421,
    [".putout.json"] = 441,
    [".rehyperc"] = 453,
    [".remarkrc"] = 454,
    [".sprite files"] = 507,
    ...
    ["<div>RIOTS' studio configuration"] = 572,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 339,
    ["API Builder"] = 633,
    ["AVA Configuration"] = 689,
    ["AWS CDK cdk.json"] = 156,
    ["AWS CloudFormation"] = 157,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 158,
    ["AWS SAM CLI Samconfig"] = 159,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 13,
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 664,
    ["All Contributors configuration file"] = 718,
    ...
    ["Azure Pipelines"] = 56,
    ["Azure Static Web Apps CLI configuration file"] = 510,
    ["Azure Static Web Apps configuration file"] = 509,
    ["BX CI"] = 92,
    ["Better Code Hub"] = 637,
    ["Better Scripts"] = 93,
    Bigconfig = 73,
    BizTalkServerApplicationSchema = 608,
    Bleep = 94,
    ["Block Protocol Metadata"] = 91,
    Briefcase = 613,
    ["Build Info"] = 84,
    Buildkite = 86,
    ["Bukkit plugin.yml"] = 85,
    ["BungeeCord plugin.yml"] = 89,
    ["Butane Config"] = 676,
    ["CICS TS region tagging"] = 683,
    ["CICS TS resource import"] = 684,
    ["CICS TS resource model"] = 685,
    ["CICS TS resource overrides"] = 686,
    ["CMake Presets"] = 95,
    ["CNC Codes"] = 105,
    ["Calqulus pipeline"] = 96,
    ["Camel YAML DSL"] = 97,
    Carafe = 98,
    ["Cargo Make"] = 100,
    ["Cargo Manifest"] = 99,
    ["Catalog Info Backstage"] = 101,
    Cheatsheets = 673,
    ["Chrome Extension"] = 149,
    ["CircleCI config.yml"] = 128,
    ["Citation File Format"] = 161,
    CityJSON = 103,
    ["Code Climate"] = 129,
    CodeCV = 54,
    ["CodeShip Pro services configuration files"] = 140,
    ["CodeShip Pro steps configuration files"] = 141,
    ["Codecov configuration files"] = 139,
    Codux = 137,
    ["Cog config file"] = 106,
    ["Commandbox Box.json"] = 107,
    ["Commandbox Server.json"] = 108,
    ["Common Catalog Data"] = 147,
    ["Common types for all schemas"] = 1,
    Conjure = 104,
    ["Container Structure Test"] = 620,
    Containerlab = 645,
    ["Crowdsec collection config"] = 168,
    ["Crowdsec parser config"] = 169,
    ["Crowdsec scenario config"] = 170,
    ["DWP Exchange - catalogue entry"] = 213,
    ["DWP Exchange - gateway"] = 211,
    ["DWP Exchange - meta"] = 212,
    ["Dart build configuration"] = 176,
    ["Dart test config"] = 177,
    ["DashLord configuration"] = 178,
    ["Data Contract Specification"] = 179,
    ["Databricks Asset Bundles"] = 739,
    ["Datadog Service Definition"] = 318,
    ["Datahub Ingestion Recipe"] = 690,
    ["Dein Config"] = 110,
    Deno = 185,
    ["Deployer Recipe"] = 188,
    ["Deta Spacefile"] = 111,
    Devfile = 210,
    ["Discord Webhook"] = 190,
    ["Dolittle Artifacts"] = 194,
    ["Dolittle Bounded Context Configuration"] = 195,
    ["Dolittle Event Horizons Configuration"] = 196,
    ["Dolittle Resources Configuration"] = 197,
    ["Dolittle Server Configuration"] = 198,
    ["Dolittle Tenant Map Configuration"] = 200,
    ["Dolittle Tenants Configuration"] = 199,
    ["Dolittle Topology"] = 201,
    ["Drupal Breakpoints"] = 112,
    ["Drupal Config"] = 123,
    ["Drupal Info"] = 113,
    ["Drupal Layouts"] = 114,
    ["Drupal Libraries"] = 115,
    ["Drupal Links Action"] = 116,
    ["Drupal Links Contextual"] = 117,
    ["Drupal Links Menu"] = 118,
    ["Drupal Links Task"] = 119,
    ["Drupal Migration"] = 120,
    ["Drupal Permissions"] = 121,
    ["Drupal Routing"] = 122,
    ["Drupal Services"] = 124,
    ...
    ["Error pages"] = 219,
    Esquio = 217,
    ["Estuary Flow Catalog"] = 680,
    ["Expo SDK"] = 222,
    ["F-Droid Data metadata"] = 227,
    ["Facets - FSDL - Application"] = 225,
    ["FasterCI Configuration"] = 57,
    Firebase = 229,
    ["Fossa configuration file"] = 236,
    ["Fossa's fossa-deps file"] = 237,
    ["Foundry VTT - Base package Manifest"] = 231,
    ["Foundry VTT - Module Manifest"] = 232,
    ["Foundry VTT - System Data Template"] = 235,
    ["Foundry VTT - System Manifest"] = 233,
    ["Foundry VTT - World Manifest"] = 234,
    ["Foxx Manifest"] = 58,
    ["Freifunk.de Community API"] = 61,
    ["Frogbot Config"] = 62,
    ["G2P Mapping Configuration"] = 241,
    ["GCP Blueprint Metadata"] = 244,
    Gaspar = 242,
    ["GatewayCore API Gateway"] = 243,
    ["GeoJSON.json latest"] = 678,
    GherKing = 682,
    ["GitHub Action"] = 248,
    ["GitHub Discussion"] = 249,
    ["GitHub Funding"] = 250,
    ["GitHub Issue Template configuration"] = 252,
    ["GitHub Workflow"] = 253,
    ["GitHub Workflow Template Properties"] = 254,
    ["GitHub issue forms"] = 251,
    GitVersion = 247,
    ["Gitpod Configuration"] = 256,
    ["Global Privacy Control"] = 245,
    Goblet = 738,
    ["Google Cloud Workflows"] = 155,
    Goreleaser = 260,
    ["Goreleaser Pro"] = 261,
    Goss = 262,
    ["Gradle Build Cache Node"] = 635,
    ["Gradle Enterprise"] = 634,
    ["Grafana 5.x Dashboard"] = 263,
    ["GraphQL Code Generator"] = 266,
    ["GraphQL Config"] = 265,
    ["GraphQL Mesh"] = 264,
    ["Grunt JSHint task"] = 270,
    ["Grunt Watch task"] = 271,
    ["Grunt base task"] = 272,
    ["Grunt clean task"] = 268,
    ["Grunt copy task"] = 267,
    ["Grunt cssmin task"] = 269,
    HEMTT = 605,
    Hadolint = 617,
    Hammerkit = 644,
    ["Hardware Sentry Configuration"] = 694,
    Hayson = 274,
    ["Haystack Pipeline"] = 275,
    ["Hazelcast 5 Configuration"] = 276,
    ["Helm Chart.lock"] = 126,
    ["Helm Chart.yaml"] = 125,
    ["Helm Unittest Test Suite"] = 127,
    Hugo = 672,
    ["IBM Zapp document"] = 281,
    ["IBM zCodeFormatSettings"] = 282,
    ["IMG Catapult PSP"] = 287,
    Istanbul = 697,
    ["JDownloader2 crawler multi-rules"] = 297,
    ["JDownloader2 crawler single-rules"] = 296,
    ["JFrog Applications Config"] = 298,
    ["JFrog File Spec"] = 299,
    ["JFrog Pipelines YML DSL"] = 703,
    ["JMeter DSL cli config"] = 300,
    JReleaser = 302,
    ["JSON Document Transform"] = 309,
    ["JSON Feed"] = 310,
    ["JSON Resume"] = 460,
    ["JSON Schema Draft 2020-12"] = 584,
    ["JSON Schema Draft 4"] = 581,
    ["JSON Schema Draft 7"] = 582,
    ["JSON Schema Draft 7 (unofficial strict)"] = 740,
    ["JSON Schema Draft 8 (2019-09)"] = 583,
    ["JSON-API"] = 308,
    ["JSON-e templates"] = 642,
    ["JSON-stat 2.0"] = 578,
    JSONPatch = 312,
    Jasmine = 292,
    Jekyll = 293,
    ["Jenkins X Pipelines"] = 294,
    ["Jenkins X Requirements"] = 295,
    ["Jovo Language Models"] = 301,
    ["KSP-AVC"] = 579,
    ["KSP-CKAN"] = 580,
    ["Karakum configuration file"] = 238,
    Kas = 315,
    ["Keycloak REST API"] = 710,
    ["Knative Functions - func.yaml"] = 239,
    ["KoDE/CI build.yaml"] = 699,
    ["Kong DBLess config"] = 700,
    KrakenD = 317,
    LOOBin = 334,
    Lefthook = 325,
    ["LinkML Metamodel"] = 332,
    Liquibase = 649,
    ["Liquibase Flow File"] = 650,
    ["Lively Properties"] = 333,
    ["Lobe AI Agent"] = 55,
    ["MS2Rescore Configuration"] = 366,
    Markdownlint = 653,
    ["Mason Registry"] = 655,
    ["MegaLinter configuration"] = 340,
    ["MegaLinter descriptor"] = 341,
    ["Meltano plugin discovery definition"] = 343,
    ["Meltano project definition"] = 342,
    ["Microsoft Band Web Tile"] = 344,
    ["Minecraft Data Pack Advancement"] = 346,
    ["Minecraft Data Pack Biome"] = 347,
    ["Minecraft Data Pack Configured Carver"] = 348,
    ["Minecraft Data Pack Damage Type"] = 349,
    ["Minecraft Data Pack Dimension"] = 351,
    ["Minecraft Data Pack Dimension Type"] = 350,
    ["Minecraft Data Pack Item Modifier"] = 352,
    ["Minecraft Data Pack Loot Table"] = 353,
    ["Minecraft Data Pack Metadata"] = 354,
    ["Minecraft Data Pack Predicate"] = 355,
    ["Minecraft Data Pack Recipe"] = 356,
    ["Minecraft Data Pack Tag"] = 357,
    ["Minecraft Data Pack Template Pool"] = 358,
    ["Minecraft Data Pack Trim Material"] = 363,
    ["Minecraft Data Pack Trim Pattern"] = 364,
    ["Minecraft Resource Pack Lang"] = 359,
    ["Minecraft Resource Pack Particle"] = 360,
    ["Minecraft Resource Pack Texture Mcmeta"] = 362,
    ["Minecraft Resourcepack Sounds"] = 361,
    ["MkDocs Configuration 1.0"] = 365,
    ["MongoDB Atlas Search Index Definition"] = 698,
    ["Monika Configuration"] = 696,
    ["Motif config"] = 601,
    ["NOX Framework (Service)"] = 380,
    ["Netin Diagnostic System Template"] = 659,
    ["Netlify config"] = 371,
    ["Nexus-as-Code Data Model"] = 372,
    ["Nightwatch.js"] = 373,
    ["ONe's service descriptor"] = 393,
    ["OSS Review Toolkit configuration"] = 400,
    ["OSS Review Toolkit curation"] = 401,
    ["OSS Review Toolkit package configuration"] = 402,
    ["OSS Review Toolkit repository configuration"] = 403,
    ["OSS Review Toolkit resolutions"] = 404,
    Opctl = 604,
    ["OpenRewrite Resource"] = 395,
    ["OpenWeather Current Weather API"] = 641,
    ["OpenWeather Road Risk API"] = 640,
    ["Ory Hydra configuration"] = 280,
    ["Ory Keto configuration"] = 319,
    ["Ory Kratos configuration"] = 399,
    ["Ory Oathkeeper configuration"] = 387,
    ["Outblocks App configuration"] = 397,
    ["Outblocks database table"] = 398,
    ["Outblocks project configuration"] = 396,
    Packer = 407,
    Pantsbuild = 717,
    ["Paper paper-plugin.yml"] = 408,
    ["Pipeline component"] = 651,
    ["PocketMine plugin.yml"] = 413,
    ["Postman collection"] = 418,
    ["Problem package generators"] = 425,
    Pterodactyl = 693,
    ["Pull Request Labeler"] = 440,
    Pulumi = 446,
    PyProject = 447,
    Pyright = 448,
    Qgoda = 449,
    Qodana = 669,
    ["Quali Torque Blueprint Spec 2"] = 691,
    ["QueryFirst config file"] = 713,
    ["RKE Cluster Configuration JSON"] = 648,
    ["RKE Cluster Configuration YAML"] = 647,
    ["Rancher Fleet"] = 443,
    Ray = 616,
    ["Read the Docs"] = 445,
    ["Red-DiscordBot Cog"] = 450,
    ["Red-DiscordBot Cog Repo"] = 451,
    ["Red-DiscordBot Trivia"] = 452,
    Renovate = 461,
    ["Replit config"] = 455,
    RoadRunner = 462,
    Ruff = 458,
    ["Rust Project"] = 459,
    ["Rust toolchain"] = 464,
    ["SIL Kit Participant Configuration"] = 495,
    ["SIL Kit Registry Configuration"] = 496,
    SWADL = 519,
    ["Safebox Config"] = 704,
    ["Sapphire CLI Config"] = 467,
    ["SauceCTL Configuration"] = 656,
    ["Schema Catalog"] = 481,
    ["Scoop manifest"] = 486,
    ["Semantic Data Fabric (SDF) file"] = 487,
    ["Semgrep Rule"] = 489,
    ["Serenity Code Generator (Sergen)"] = 490,
    ["Serverless Framework Configuration"] = 663,
    ["Serverless Workflow"] = 665,
    ["Settings.paf"] = 492,
    ["Shopware 6 Configuration"] = 666,
    ["Shopware CLI Extension Store Configuration"] = 667,
    ["Shopware CLI Project Store Configuration"] = 668,
    ["Sigrid scope configuration file"] = 494,
    ["Slack app manifest"] = 498,
    Solidarity = 501,
    ["Solution filters"] = 502,
    ["Source Maps v3"] = 503,
    Sourcery = 504,
    SpecIF = 505,
    ["Sponge Mixin configuration"] = 506,
    ["StackHawk Scanner Configuration"] = 662,
    Stale = 511,
    ["Starlake Data Pipeline"] = 638,
    Starship = 512,
    ["Statamic Blueprint"] = 513,
    ["StrmPrivacy Data Connector"] = 708,
    ["StrmPrivacy Data Contract"] = 709,
    ["StrmPrivacy SimpleSchema"] = 706,
    ["StrmPrivacy Stream"] = 707,
    ["StrmPrivacy batch job configuration file"] = 705,
    ["Stryker Mutator"] = 516,
    ["StyleCop Analyzers Configuration"] = 517,
    ["Swagger API 2.0"] = 520,
    TSON = 544,
    ["Talisman configuration"] = 522,
    ["Taskfile config"] = 643,
    Taurus = 523,
    ["TestEnvironment.json"] = 532,
    ["Tier.run pricing.json"] = 526,
    Tikibase = 527,
    ["Traefik v2"] = 535,
    ["Traefik v2 File Provider"] = 536,
    Turborepo = 533,
    Tye = 670,
    ["UET BuildConfig.json"] = 714,
    ["UI5 Manifest"] = 551,
    ["UTAM Page Object"] = 554,
    ["Ubuntu Server Autoinstall"] = 549,
    ["Uniswap Token List"] = 626,
    ["Unreal Engine Uplugin"] = 715,
    ["Unreal Engine Uproject"] = 716,
    Updatecli = 677,
    Uplift = 712,
    ["User Journey Map"] = 646,
    V2Ray = 681,
    ["VSCode Code Snippets"] = 143,
    ["VSIX CLI publishing"] = 567,
    ["Vela Pipeline Configuration"] = 557,
    Vercel = 142,
    Visivo = 741,
    ["Web App Manifest"] = 574,
    ["Web types"] = 577,
    WebExtensions = 573,
    ["Webman package recipe"] = 687,
    ["Windows Package Manager Installer Manifest"] = 623,
    ["Windows Package Manager Locale Manifest"] = 624,
    ["Windows Package Manager Singleton Manifest"] = 622,
    ["Woodpecker pipeline config"] = 658,
    ["Xstate Machine"] = 675,
    ["Yippee-Ki-JSON configuration YML"] = 628,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 67,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 723,
    ["bashly-strings.yml"] = 724,
    ["bashly.yml"] = 722,
    ["batect.yml"] = 66,
    ["beef-database-codegen"] = 68,
    ["beef-database-v5-codegen"] = 70,
    ["beef-entity-codegen"] = 69,
    ["beef-entity-v5-codegen"] = 71,
    ["behat.yml"] = 80,
    ["bigquery-table"] = 72,
    ["bitbucket-pipelines"] = 74,
    bitrise = 75,
    ["bitrise-step"] = 76,
    ["block.json"] = 90,
    ["bower.json"] = 78,
    ["bozr.suite.json"] = 81,
    bpkg = 725,
    ["browser.i18n.json"] = 82,
    bucklescript = 83,
    ["bundleconfig.json"] = 88,
    ["chisel-slices.json"] = 160,
    ["chrome-extension-locales-messages.json"] = 150,
    ["chutzpah.json"] = 151,
    cibuildwheel = 102,
    clangd = 132,
    clib = 133,
    ["cloud-init: cloud-config userdata"] = 135,
    ["cloud-sdk-pipeline-configuration"] = 153,
    ["cloudbuild.json"] = 154,
    cloudify = 134,
    codemagic = 136,
    ["coffeelint.json"] = 162,
    ["commands.json"] = 146,
    ["compile_commands.json"] = 145,
    ["compilerconfig.json"] = 144,
    ["completely.yml"] = 720,
    ["component-detection-manifest.json"] = 165,
    ["component.json"] = 164,
    ["composer.json"] = 163,
    ["config.yaml"] = 444,
    ["contentmanifest.json"] = 152,
    ["contribute.json"] = 166,
    ["cosmos.config.json"] = 148,
    ["crowdin.yml"] = 167,
    cspell = 173,
    ["custom-elements.json"] = 734,
    ["cypress.json"] = 171,
    ["datalogic-scan2deploy-android"] = 180,
    ["datalogic-scan2deploy-ce"] = 181,
    ["dbt Project"] = 109,
    ["ddev-global"] = 182,
    ["ddev-project"] = 183,
    ["debugsettings.json"] = 184,
    ["dependabot-v2.json"] = 187,
    ["dependabot.json"] = 186,
    ["deployed-cli"] = 674,
    ["detekt.yml"] = 189,
    ["devcontainer.json"] = 138,
    devinit = 630,
    ["devspace.yaml"] = 695,
    djlint = 631,
    ["docfx.json"] = 193,
    ["docker sequencer"] = 192,
    ["docker-compose.yml"] = 629,
    ["dockerd.json"] = 191,
    ["dotnet Release Index manifest"] = 202,
    ["dotnetcli.host.json"] = 203,
    ["dprint.json"] = 204,
    ["drone.json"] = 205,
    ["dss-2.0.0.json"] = 207,
    ["dstack configuration"] = 208,
    ["dvc.yaml"] = 209,
    ["ecosystem.json"] = 214,
    eksctl = 215,
    ["electron-builder configuration file"] = 220,
    ["epr-manifest.json"] = 218,
    ["evcc.yaml"] = 221,
    ["ezd task runner"] = 223,
    ["fabric.mod.json"] = 226,
    ["first-timers-bot"] = 230,
    ["flagd flag configuration"] = 59,
    ["fly.io Configuration"] = 60,
    fulibWorkflows = 657,
    ["function.json"] = 240,
    ["geojson.json"] = 246,
    ["gitlab-ci"] = 255,
    ["global.json"] = 257,
    ["go-feature-flag Flag Configuration"] = 259,
    ["golangci-lint Configuration"] = 258,
    ["haxelib.json"] = 273,
    helmfile = 618,
    helmwave = 619,
    ["host-meta.json"] = 278,
    ...
    ["ide.host.json"] = 283,
    ["ifstate.conf"] = 284,
    ["imageoptimizer.json"] = 285,
    ["importmap.json"] = 288,
    ["ioBroker Configuration"] = 289,
    ["ioBroker JSON UI"] = 290,
    ["ioBroker Package manifest"] = 291,
    ["ize.toml"] = 711,
    ["jsconfig.json"] = 313,
    ["jscpd Configuration"] = 692,
    jsdoc = 615,
    ["k3d.yaml"] = 314,
    ["k9s plugin.yml"] = 316,
    ["kontinuous-config.yaml"] = 321,
    ["kontinuous-values.yaml"] = 320,
    ["kustomization.yaml"] = 322,
    ["label-commenter-config.yml"] = 323,
    ["launchsettings.json"] = 324,
    lazydocker = 733,
    lazygit = 732,
    ["lego.json"] = 326,
    ["lerna.json"] = 327,
    ["lgtm.yml"] = 328,
    ["libman.json"] = 329,
    ["license-report-config.json"] = 330,
    ["linkinator.config.json"] = 331,
    ["local.settings.json"] = 336,
    ["localazy.json"] = 337,
    ["lotus.yaml"] = 335,
    ["lsdlschema.json"] = 338,
    ["madness.yml"] = 721,
    ["markdown-lint-check"] = 654,
    mboats = 661,
    ["micro-settings.json"] = 726,
    ["mimetypes.json"] = 345,
    ["mirrord config"] = 598,
    ["mta.yaml"] = 599,
    ["mtad.yaml"] = 600,
    ["mycode.json"] = 369,
    ["napari plugin manifest"] = 370,
    neoload = 610,
    ["nest-cli"] = 376,
    ["ninjs (News in JSON) 1.3"] = 375,
    ["ninjs (News in JSON) 2.0"] = 374,
    ["nlu.json"] = 377,
    ["nodemon.json"] = 379,
    ["noodl config"] = 660,
    now = 606,
    ...
    ["nswag.json"] = 385,
    ntangle = 386,
    ["nuclei-template.yaml"] = 383,
    ["nuget-project.json"] = 384,
    ["ocelot.json"] = 388,
    ["omnisharp.json"] = 389,
    ["openapi.json"] = 390,
    ["openfin.json"] = 394,
    ...
    ["ops.yaml"] = 392,
    ["package.json"] = 405,
    ["package.manifest"] = 406,
    ["pathfinder.yml"] = 409,
    ["pattern.json"] = 411,
    ["petstore-v1.0"] = 702,
    pgap_yaml_input_reader = 410,
    ["plagiarize-me.yaml"] = 415,
    ["plagiarize.yaml"] = 414,
    ["portman.json"] = 416,
    ["prettierrc.json"] = 423,
    ["prisma.yml"] = 424,
    ["project-1.0.0-beta3.json"] = 427,
    ["project-1.0.0-beta4.json"] = 428,
    ["project-1.0.0-beta5.json"] = 429,
    ["project-1.0.0-beta6.json"] = 430,
    ["project-1.0.0-beta8.json"] = 431,
    ["project-1.0.0-rc1.json"] = 432,
    ["project-1.0.0-rc2.json"] = 433,
    ["project.json"] = 426,
    ["prometheus.json"] = 434,
    ["prometheus.rules.json"] = 435,
    ["prometheus.rules.test.json"] = 436,
    ["proxies.json"] = 437,
    ["publiccode.yml"] = 438,
    ["pubspec.yaml"] = 439,
    ["pyrseas-0.8.json"] = 442,
    ["quilt.mod.json"] = 727,
    ["release drafter"] = 611,
    rtx = 457,
    rustfmt = 463,
    samt = 465,
    samtrc = 466,
    ["sarif-1.0.0.json"] = 468,
    ["sarif-2.0.0.json"] = 469,
    ["sarif-2.1.0"] = 479,
    ["sarif-2.1.0-rtm.2"] = 470,
    ["sarif-2.1.0-rtm.3"] = 472,
    ["sarif-2.1.0-rtm.4"] = 474,
    ["sarif-2.1.0-rtm.5"] = 476,
    ["sarif-2.1.0-rtm.6"] = 477,
    ["sarif-external-property-file-2.1.0"] = 480,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 471,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 473,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 475,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 478,
    ["schema.org - Action"] = 482,
    ["schema.org - ContactPoint"] = 483,
    ["schema.org - Place"] = 484,
    ["schema.org - Thing"] = 485,
    ["secrethub.yml"] = 729,
    ["semantic-release"] = 488,
    ["servicehub.config.json"] = 587,
    ["servicehub.service.json"] = 586,
    ["settings.job"] = 491,
    ["sfdx-hardis configuration"] = 493,
    ["size-limit configuration"] = 497,
    ["skaffold.yaml"] = 652,
    ["skyuxconfig.json"] = 499,
    snapcraft = 500,
    ["sqlc configuration"] = 508,
    ["stripe-app-local.json"] = 515,
    ["stripe-app.json"] = 514,
    swcrc = 639,
    syntax = 731,
    ["task.json"] = 521,
    taskcat = 607,
    ["template.json"] = 524,
    ["templatsources.json"] = 525,
    ["theme.json"] = 528,
    ["tizen_workspace.json"] = 529,
    tldr = 530,
    tmLanguage = 531,
    tmuxinator = 595,
    ["transcend.yml"] = 537,
    ["trunk.yaml"] = 538,
    ["ts-force-config.json"] = 542,
    ["tsconfig.json"] = 539,
    ["tsd.json"] = 540,
    ["tsdrc.json"] = 541,
    ["tslint.json"] = 543,
    ...
    ["vega-lite.json"] = 556,
    ["vega.json"] = 555,
    ["venvironment-basic.yaml"] = 559,
    ["venvironment.yaml"] = 558,
    ["version.json"] = 560,
    ["vim-addon-info"] = 561,
    ["vs-2017.3.host.json"] = 563,
    ["vs-nesting.json"] = 564,
    ["vsls.json"] = 562,
    ["vss-extension.json"] = 568,
    ["vtesttree.yaml"] = 569,
    ["vtestunit.yaml"] = 570,
    ["warp-keysets.json"] = 735,
    ["warp-themes.json"] = 736,
    ["warp-workflows.json"] = 737,
    ["webhint.io"] = 688,
    ["webjobpublishsettings.json"] = 576,
    ["webjobs-list.json"] = 575,
    ["xs-app.json"] = 603,
    ["xunit.runner.json"] = 585,
    yamllint = 627,
    zuul = 612,
    ["Žinoma"] = 621
  },
