...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 723,
    [".nodehawkrc"] = 466,
    [".npmpackagejsonlintrc"] = 470,
    [".omletrc"] = 898,
    [".phrase.yml"] = 517,
    [".phraseapp.yml"] = 518,
    [".pmbot.yml"] = 507,
    [".postcssrc"] = 512,
    [".powerpages-web-template-manifest"] = 514,
    [".pre-commit-config.yml"] = 515,
    [".pre-commit-hooks.yml"] = 516,
    [".putout.json"] = 537,
    [".rehyperc"] = 556,
    [".remarkrc"] = 558,
    [".sprite files"] = 620,
    ...
    ["<div>RIOTS' studio configuration"] = 695,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 420,
    ABCSupplyPlan = 13,
    AIConfig = 14,
    ["API Builder"] = 755,
    ["AVA Configuration"] = 815,
    ["AWS AppConfig Feature Flags-v1"] = 38,
    ["AWS CDK cdk.json"] = 187,
    ["AWS CloudFormation"] = 188,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 189,
    ["AWS SAM CLI Samconfig"] = 190,
    ["Adobe UXP Manifest"] = 880,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 15,
    ["Airplane task"] = 16,
    ["Alacritty Configuration"] = 787,
    ["All Contributors configuration file"] = 845,
    ["Ansible Argument Specs"] = 316,
    ["Ansible Collection Galaxy"] = 323,
    ["Ansible Execution Environment"] = 313,
    ["Ansible Inventory"] = 322,
    ["Ansible Meta"] = 314,
    ["Ansible Meta Runtime"] = 315,
    ["Ansible Navigator Configuration"] = 325,
    ["Ansible Playbook"] = 320,
    ["Ansible Requirements"] = 317,
    ["Ansible Rulebook"] = 321,
    ["Ansible Tasks File"] = 319,
    ["Ansible Vars File"] = 318,
    ["Ansible-lint Configuration"] = 324,
    Any = 907,
    ...
    ["Azure Pipelines"] = 63,
    ["Azure Static Web Apps CLI configuration file"] = 623,
    ["Azure Static Web Apps configuration file"] = 622,
    ["BX CI"] = 102,
    ["Bashly (bashly.yml)"] = 849,
    ["Bashly Settings (bashly-settings.yml)"] = 850,
    ["Better Code Hub"] = 759,
    ["Better Scripts"] = 103,
    Bigconfig = 80,
    BizTalkServerApplicationSchema = 729,
    Bleep = 104,
    ...
    ["Butane Config"] = 800,
    ["CGS Custom Card Game (CardGameDef.json)"] = 885,
    ["CICS TS region tagging"] = 809,
    ["CICS TS resource import"] = 810,
    ["CICS TS resource model"] = 811,
    ["CICS TS resource overrides"] = 812,
    ["CMake Presets"] = 105,
    ["CNC Codes"] = 119,
    ["CRS WAF test file"] = 914,
    ["CRS WAF test platform overrides file"] = 915,
    ["CSS Comb (.csscomb.json)"] = 214,
    ["CSS Lint (.csslintrc)"] = 215,
    ["CSpell (cspell.json)"] = 213,
    ["CVE Record Format"] = 125,
    CWL = 891,
    ["Cache Warmup config"] = 106,
    ["Calqulus pipeline"] = 107,
    ["Camel YAML DSL"] = 108,
    Carafe = 109,
    ["Cargo Make"] = 111,
    ["Cargo Manifest"] = 110,
    ["Catalog Info Backstage"] = 112,
    Changesets = 199,
    Cheatsheets = 797,
    ["Chrome Extension"] = 180,
    ["Chromia Model"] = 113,
    ["CircleCI config.yml"] = 156,
    ["Citation File Format"] = 201,
    CityJSON = 115,
    ["Clawject config"] = 124,
    ...
    CodeCV = 58,
    CodeRabbit = 57,
    ["CodeShip Pro services configuration files"] = 169,
    ["CodeShip Pro steps configuration files"] = 170,
    ["Codecov configuration files"] = 168,
    CodifyCLI = 59,
    Codux = 166,
    ["Cog config file"] = 120,
    ["Commandbox Box.json"] = 121,
    ["Commandbox Server.json"] = 122,
    ["Common Catalog Data"] = 178,
    Concord = 913,
    ["Configu .cfgu files"] = 902,
    ["Configu .configu file"] = 903,
    Conjure = 118,
    ["Container Structure Test"] = 742,
    Containerlab = 767,
    ["Crowdsec collection config"] = 208,
    ["Crowdsec parser config"] = 209,
    ["Crowdsec scenario config"] = 210,
    ["CumulusCI Config"] = 123,
    ["Custom Machinery Machine"] = 886,
    ["Custom Machinery Recipe"] = 887,
    ["Cycle Stack File"] = 126,
    ["DWP Exchange - catalogue entry"] = 256,
    ["DWP Exchange - gateway"] = 254,
    ["DWP Exchange - meta"] = 255,
    ["Dart Build Config (dart-build.json)"] = 216,
    ["Dart Test Config (dart-test.json)"] = 217,
    ["DashLord Configuration"] = 218,
    ["Data Contract Specification"] = 219,
    ["Data Product Specification"] = 220,
    ["DataYoga Connections"] = 127,
    ["DataYoga Job"] = 128,
    ["Databricks Asset Bundles"] = 866,
    ["Datadog Service Definition"] = 395,
    ["Datadog Software Catalog"] = 396,
    ["Datahub Ingestion Recipe"] = 816,
    ["Dein Config"] = 134,
    ["Deno Config (deno.json)"] = 226,
    ["Dependency cruiser"] = 135,
    ["Deployer Recipe"] = 229,
    ["Deta Spacefile"] = 136,
    ["Detekt Config (detekt.yml)"] = 230,
    ["Devbox Config"] = 137,
    ["Devbox Plugin"] = 138,
    Devfile = 253,
    DipDup = 916,
    ["Discord Webhook"] = 231,
    ["DocFx Config (docfx.json)"] = 235,
    ["Dolittle Artifacts"] = 236,
    ["Dolittle Bounded Context Configuration"] = 237,
    ["Dolittle Event Horizons Configuration"] = 238,
    ["Dolittle Resources Configuration"] = 239,
    ["Dolittle Server Configuration"] = 240,
    ["Dolittle Tenant Map Configuration"] = 242,
    ["Dolittle Tenants Configuration"] = 241,
    ["Dolittle Topology"] = 243,
    ["Drupal Breakpoints"] = 139,
    ["Drupal Config"] = 151,
    ["Drupal Info"] = 140,
    ["Drupal Layouts"] = 141,
    ["Drupal Libraries"] = 142,
    ["Drupal Links Action"] = 143,
    ["Drupal Links Contextual"] = 144,
    ["Drupal Links Menu"] = 145,
    ["Drupal Links Task"] = 146,
    ["Drupal Migration"] = 147,
    ["Drupal Permissions"] = 148,
    ["Drupal Recipe"] = 149,
    ["Drupal Routing"] = 150,
    ["Drupal Services"] = 152,
    ["Drush site aliases"] = 249,
    ["Dynamic Bash Aliases (.aliases)"] = 857,
    ["EAS config"] = 274,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 846,
    ["Elgato Stream Deck"] = 259,
    Elm = 918,
    ["Embrace Config"] = 827,
    Endurica = 870,
    ["Enterprise Contract Policy Spec"] = 260,
    ["Erda Pipeline"] = 893,
    ["Erda Runtime"] = 894,
    ["Error pages"] = 264,
    Esquio = 262,
    ["Estuary Flow Catalog"] = 806,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 267,
    ["EveryVoice TTS Toolkit Data Configuration"] = 268,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 272,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 271,
    ["EveryVoice TTS Toolkit Text Configuration"] = 269,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 270,
    ["Expo SDK"] = 273,
    ["F-Droid Data metadata"] = 279,
    ["Facets - FSDL - Application"] = 277,
    ["FasterCI Configuration"] = 64,
    FiQuS = 283,
    Firebase = 281,
    ["Flow.json Configurations"] = 890,
    ["Fossa configuration file"] = 290,
    ["Fossa's fossa-deps file"] = 291,
    ["Foundry VTT - Base package Manifest"] = 285,
    ["Foundry VTT - Module Manifest"] = 286,
    ["Foundry VTT - System Data Template"] = 289,
    ["Foundry VTT - System Manifest"] = 287,
    ["Foundry VTT - World Manifest"] = 288,
    ["Foxx Manifest"] = 65,
    ["Freifunk.de Community API"] = 68,
    ["Frogbot Config"] = 69,
    ["G2P Mapping Configuration"] = 295,
    ["GCP Blueprint Metadata"] = 298,
    Gaspar = 296,
    ["GatewayCore API Gateway"] = 297,
    ["GeoJSON.json latest"] = 804,
    GherKing = 808,
    ["GitHub Action"] = 303,
    ["GitHub Discussion"] = 304,
    ["GitHub Funding"] = 305,
    ["GitHub Issue Template configuration"] = 307,
    ["GitHub Issue Template forms"] = 306,
    ["GitHub Workflow"] = 308,
    ["GitHub Workflow Template Properties"] = 309,
    ["GitHub automatically generated release notes configuration"] = 310,
    ["GitLab Agent for Kubernetes configuration"] = 882,
    GitVersion = 300,
    ["Gitea Issue Template configuration"] = 301,
    ["Gitea Issue Template forms"] = 302,
    ["Gitpod Configuration"] = 312,
    ["GlazeWM settings"] = 884,
    ["Global Privacy Control"] = 299,
    Goblet = 865,
    ["Golangci-lint Configuration"] = 327,
    ["Golangci-lint Custom Plugins Configuration"] = 328,
    ["Google Chrome Related Website Sets"] = 282,
    ["Google Cloud Workflows"] = 186,
    Goreleaser = 330,
    ["Goreleaser Pro"] = 331,
    Goss = 332,
    ["Gradle Build Cache Node"] = 757,
    ["Gradle Enterprise"] = 756,
    ["Grafana 5.x Dashboard"] = 333,
    ["GraphQL Code Generator"] = 337,
    ["GraphQL Config"] = 336,
    ["GraphQL Mesh"] = 335,
    ["Grunt JSHint task"] = 341,
    ["Grunt Watch task"] = 342,
    ["Grunt base task"] = 343,
    ["Grunt clean task"] = 339,
    ["Grunt copy task"] = 338,
    ["Grunt cssmin task"] = 340,
    HEMTT = 726,
    Hadolint = 738,
    Hammerkit = 766,
    ["Hardware Sentry Configuration"] = 820,
    Hatch = 739,
    Hayson = 345,
    ["Haystack Pipeline"] = 346,
    ["Hazelcast 5 Configuration"] = 347,
    ["Helm Chart.lock"] = 154,
    ["Helm Chart.yaml"] = 153,
    ["Helm Unittest Test Suite"] = 155,
    Hugo = 796,
    ["Hugo Theme"] = 795,
    ["Hyperfoil benchmark configuration"] = 353,
    ["IBM Zapp document"] = 354,
    ["IBM zCodeFormatSettings"] = 355,
    ["IMG Catapult PSP"] = 360,
    ["IVMS101 by CODE Protocol"] = 883,
    Infrahub = 362,
    Istanbul = 823,
    ["JDownloader2 crawler multi-rules"] = 371,
    ["JDownloader2 crawler single-rules"] = 370,
    ["JFrog Applications Config"] = 372,
    ["JFrog File Spec"] = 373,
    ["JFrog Pipelines YML DSL"] = 829,
    ["JMeter DSL cli config"] = 374,
    JReleaser = 376,
    ["JSON Document Transform"] = 384,
    ["JSON Feed"] = 385,
    ["JSON Resume"] = 563,
    ["JSON Schema Draft 2020-12"] = 708,
    ["JSON Schema Draft 4"] = 705,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 867,
    ["JSON Schema Draft 7"] = 706,
    ["JSON Schema Draft 7 (unofficial strict)"] = 868,
    ["JSON Schema Draft 8 (2019-09)"] = 707,
    ["JSON-API"] = 383,
    ["JSON-WF"] = 896,
    ["JSON-e templates"] = 764,
    ["JSON-stat 2.0"] = 702,
    JSONPatch = 387,
    ["JSR Package Config (jsr.json)"] = 377,
    Jasmine = 366,
    Jekyll = 367,
    ["Jenkins X Pipelines"] = 368,
    ["Jenkins X Requirements"] = 369,
    ["Jovo Language Models"] = 375,
    ["KIMMDY config file"] = 392,
    ["KSP-AVC"] = 703,
    ["KSP-CKAN"] = 704,
    KSY = 895,
    ["Karakum configuration file"] = 292,
    Kas = 390,
    ["Kestra flow file"] = 393,
    ["Keycloak REST API"] = 837,
    ["Knative Functions - func.yaml"] = 293,
    ["KoDE/CI build.yaml"] = 825,
    ["Kong DBLess config"] = 826,
    KrakenD = 394,
    ["Kubri Configuration"] = 400,
    LOOBin = 415,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 191,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 192,
    ["Landing Zone Accelerator on AWS - Global Config"] = 193,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 194,
    ["Landing Zone Accelerator on AWS - Network Config"] = 195,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 196,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 197,
    ["Landing Zone Accelerator on AWS - Security Config"] = 198,
    ["Language configuration"] = 906,
    Lefthook = 404,
    ["Liferay client-extension.yaml"] = 411,
    ["LinkML Metamodel"] = 413,
    Liquibase = 772,
    ["Liquibase Flow File"] = 773,
    ["Lively Properties"] = 414,
    ["Lobe AI Agent"] = 61,
    Loki = 62,
    ["MLOS Configs"] = 450,
    ["MS2Rescore Configuration"] = 453,
    ["Madness (madness.yml)"] = 848,
    Markdownlint = 776,
    ["Mason Registry"] = 778,
    ["MegaLinter configuration"] = 421,
    ["MegaLinter descriptor"] = 422,
    Melange = 874,
    ["Meltano plugin discovery definition"] = 424,
    ["Meltano project definition"] = 423,
    ["Mergify Configuration"] = 454,
    ["Metadata for a Bazel module"] = 425,
    ["MetricsHub Configuration"] = 426,
    ["MetricsHub Connector Configuration"] = 427,
    ["Micro Editor Syntax"] = 858,
    ["Microsoft Band Web Tile"] = 428,
    ["Microsoft RulesEngine workflow rules"] = 910,
    ["Microsoft RulesEngine workflow rules list"] = 911,
    ["Minecraft Custom Main Menu Mod"] = 875,
    ["Minecraft Data Pack Advancement"] = 430,
    ["Minecraft Data Pack Biome"] = 431,
    ["Minecraft Data Pack Configured Carver"] = 432,
    ["Minecraft Data Pack Damage Type"] = 433,
    ["Minecraft Data Pack Dimension"] = 435,
    ["Minecraft Data Pack Dimension Type"] = 434,
    ["Minecraft Data Pack Item Modifier"] = 436,
    ["Minecraft Data Pack Loot Table"] = 437,
    ["Minecraft Data Pack Metadata"] = 438,
    ["Minecraft Data Pack Predicate"] = 439,
    ["Minecraft Data Pack Recipe"] = 440,
    ["Minecraft Data Pack Tag"] = 441,
    ["Minecraft Data Pack Template Pool"] = 442,
    ["Minecraft Data Pack Trim Material"] = 447,
    ["Minecraft Data Pack Trim Pattern"] = 448,
    ["Minecraft Resource Pack Lang"] = 443,
    ["Minecraft Resource Pack Particle"] = 444,
    ["Minecraft Resource Pack Texture Mcmeta"] = 446,
    ["Minecraft Resourcepack Sounds"] = 445,
    ["Monade CLI Stack Configuration"] = 457,
    ["MongoDB Atlas Search Index Definition"] = 824,
    ["Monika Configuration"] = 822,
    ["Monoweave Configuration"] = 452,
    ["Motif config"] = 722,
    ["NOX Framework (Service)"] = 469,
    ["Netin Diagnostic System Template"] = 782,
    ["Netlify config"] = 460,
    ["Network-as-Code Data Model"] = 461,
    ["Nightwatch.js"] = 462,
    ["Nuitka.yaml"] = 888,
    ["ONe's changelog entry"] = 485,
    ["ONe's service descriptor"] = 484,
    ["OSS Review Toolkit configuration"] = 493,
    ["OSS Review Toolkit curation"] = 494,
    ["OSS Review Toolkit package configuration"] = 495,
    ["OSS Review Toolkit repository configuration"] = 496,
    ["OSS Review Toolkit resolutions"] = 497,
    Opctl = 725,
    ["Open Data Contract Standard (ODCS))"] = 488,
    ["OpenRewrite Resource"] = 487,
    ["OpenUtau character yaml"] = 481,
    ["OpenUtau ustx"] = 482,
    ["OpenWeather Current Weather API"] = 763,
    ["OpenWeather Road Risk API"] = 762,
    ["Ory Hydra configuration"] = 352,
    ["Ory Keto configuration"] = 397,
    ["Ory Kratos configuration"] = 492,
    ["Ory Oathkeeper configuration"] = 476,
    ["Outblocks App configuration"] = 490,
    ["Outblocks database table"] = 491,
    ["Outblocks project configuration"] = 489,
    PDM = 503,
    Packer = 500,
    Pantsbuild = 844,
    ["Paper paper-plugin.yml"] = 501,
    ["Pipeline component"] = 774,
    ["PocketMine plugin.yml"] = 508,
    ["Postman collection"] = 513,
    ["Problem object RFC9457"] = 872,
    ["Problem package generators"] = 521,
    Pterodactyl = 819,
    ["Pull Request Labeler"] = 536,
    Pulumi = 542,
    PyProject = 543,
    Pyright = 544,
    Qgoda = 545,
    Qodana = 792,
    ["Qt Creator workspace file"] = 904,
    ["Quali Torque Blueprint Spec 2"] = 817,
    ["QueryFirst config file"] = 840,
    ["RKE Cluster Configuration JSON"] = 771,
    ["RKE Cluster Configuration YAML"] = 770,
    ["Rancher Fleet"] = 539,
    ["Rattler-build"] = 546,
    Ray = 737,
    ["Read the Docs"] = 541,
    ["Red-DiscordBot Cog"] = 553,
    ["Red-DiscordBot Cog Repo"] = 554,
    ["Red-DiscordBot Trivia"] = 555,
    ["Render Blueprints"] = 769,
    RenderCV = 565,
    Renovate = 564,
    ["Replit config"] = 559,
    RoadRunner = 566,
    ["Rudder techniques"] = 878,
    Ruff = 561,
    ["Rust Project"] = 562,
    ["Rust toolchain"] = 570,
    ["SDMX data message"] = 595,
    ["SDMX metadata message"] = 594,
    ["SDMX structure message"] = 593,
    ["SIL Kit Participant Configuration"] = 605,
    ["SIL Kit Registry Configuration"] = 606,
    SWADL = 634,
    ["Safebox Config"] = 830,
    ["Sapphire CLI Config"] = 573,
    ["SauceCTL Configuration"] = 779,
    ["Schema Catalog"] = 587,
    ["Scoop manifest"] = 592,
    ["Semantic Data Fabric (SDF) file"] = 596,
    ["Semgrep Rule"] = 598,
    ["Serenity Code Generator (Sergen)"] = 599,
    ["Serverless Framework Configuration"] = 786,
    ["Serverless Workflow"] = 788,
    ["Settings.paf"] = 601,
    ["Shopware 6 Configuration"] = 789,
    ["Shopware CLI Extension Store Configuration"] = 790,
    ["Shopware CLI Project Store Configuration"] = 791,
    Sigma = 603,
    ["Sigrid scope configuration file"] = 604,
    ["SkyPilot Task JSON"] = 879,
    ["Slack app manifest"] = 608,
    Solidarity = 611,
    ["Solution filters"] = 612,
    ["Source Maps v3"] = 613,
    Sourcery = 614,
    ["Speakeasy Lint Configuration File"] = 615,
    ["Speakeasy Test Generation Configuration File"] = 616,
    ["Speakeasy Workflow File"] = 617,
    SpecIF = 618,
    ["Sponge Mixin configuration"] = 619,
    StackBlitz = 624,
    ["StackHawk Scanner Configuration"] = 785,
    Stale = 625,
    ["Starlake Data Pipeline"] = 760,
    Starship = 626,
    ["Statamic Blueprint"] = 627,
    ["Stella configuration file"] = 628,
    ["StrmPrivacy Data Connector"] = 834,
    ["StrmPrivacy Data Contract"] = 835,
    ["StrmPrivacy SimpleSchema"] = 832,
    ["StrmPrivacy Stream"] = 833,
    ["StrmPrivacy batch job configuration file"] = 831,
    ["Stryker Mutator"] = 631,
    ["StyleCop Analyzers Configuration"] = 632,
    ["Stylelint (.stylelintrc)"] = 633,
    ["Sublime Syntax"] = 836,
    ["Subsquid squid manifest"] = 881,
    ["Swagger API 2.0"] = 635,
    TSON = 661,
    TSTyche = 662,
    Talhelper = 637,
    ["Talisman configuration"] = 638,
    ["Taskfile config"] = 765,
    Taurus = 639,
    ["TestEnvironment.json"] = 648,
    ["TextMate Grammar"] = 647,
    ["Tier.run pricing.json"] = 642,
    Tikibase = 643,
    ["Traefik v2"] = 651,
    ["Traefik v2 File Provider"] = 652,
    ["Travis CI (.travis.yml)"] = 650,
    TunnelHub = 871,
    Turborepo = 649,
    Tycho = 917,
    Tye = 793,
    ["UET BuildConfig.json"] = 841,
    ["UI5 Manifest"] = 671,
    ["UNCORS configuration"] = 675,
    ["UTAM Page Object"] = 674,
    ["Ubuntu Server Autoinstall"] = 669,
    ["Uniswap Token List"] = 748,
    ["Unreal Engine Uplugin"] = 842,
    ["Unreal Engine Uproject"] = 843,
    ["Updatecli Compose"] = 801,
    ["Updatecli Policy Manifest"] = 802,
    ["Updatecli Policy Metadata"] = 803,
    Uplift = 839,
    ["User Journey Map"] = 768,
    V2Ray = 807,
    ["VSCode Code Snippets"] = 174,
    ["VSIX CLI publishing"] = 690,
    ["Vela Pipeline Configuration"] = 679,
    Vercel = 173,
    Visivo = 869,
    ["Web App Manifest"] = 697,
    ["Web types"] = 700,
    WebExtensions = 696,
    ["Webman package recipe"] = 813,
    ["Windows Package Manager Installer Manifest"] = 745,
    ["Windows Package Manager Locale Manifest"] = 746,
    ["Windows Package Manager Singleton Manifest"] = 744,
    ["Woodpecker pipeline config"] = 781,
    ["Wrangler CLI"] = 701,
    ["Xstate Machine"] = 799,
    ["Yarn Config (.yarnrc.yml)"] = 758,
    ["Yippee-Ki-JSON configuration YML"] = 750,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 873,
    ...
    ["behat.yml"] = 88,
    ["bigquery-table"] = 79,
    ["bioimageio resource description"] = 889,
    ...
    changelogging = 901,
    ["chisel-slices.json"] = 200,
    ["chrome-extension-locales-messages.json"] = 181,
    ["chutzpah.json"] = 182,
    cibuildwheel = 114,
    ["clang-format (.clang-format)"] = 805,
    ["clang-tidy"] = 161,
    clangd = 160,
    clib = 162,
    ["cloud-init: cloud-config userdata"] = 164,
    ["cloud-sdk-pipeline-configuration"] = 184,
    ["cloudbuild.json"] = 185,
    cloudify = 163,
    codemagic = 165,
    ["coffeelint.json"] = 202,
    ["commands.json"] = 177,
    ["commitlint (.commitlintrc)"] = 747,
    ["compile_commands.json"] = 176,
    ["compilerconfig.json"] = 175,
    ["completely.yml"] = 847,
    ["component-detection-manifest.json"] = 205,
    ["component.json"] = 204,
    ["composer.json"] = 203,
    ["conda-forge"] = 117,
    ["config.yaml"] = 540,
    ["contentmanifest.json"] = 183,
    ["contribute.json"] = 206,
    ["cosmos.config.json"] = 179,
    ["crowdin.yml"] = 207,
    ["custom-elements.json"] = 861,
    ["cypress.json"] = 211,
    ["datalogic-scan2deploy-android"] = 221,
    ["datalogic-scan2deploy-ce"] = 222,
    ["dbt Dependencies"] = 129,
    ["dbt Packages"] = 131,
    ["dbt Project"] = 130,
    ["dbt Selectors"] = 132,
    ["dbt YAML files"] = 133,
    ["ddev-global"] = 223,
    ["ddev-project"] = 224,
    ["debugsettings.json"] = 225,
    ["dependabot-v2.json"] = 228,
    ["dependabot.json"] = 227,
    ["deployed-cli"] = 798,
    ["devcontainer.json"] = 167,
    devinit = 752,
    ["devspace.yaml"] = 821,
    djlint = 753,
    ["docker bake"] = 233,
    ["docker sequencer"] = 234,
    ["docker-compose.yml"] = 751,
    ["dockerd.json"] = 232,
    ["dotnet Release Index manifest"] = 244,
    ["dotnet-tools.json"] = 245,
    ["dotnetcli.host.json"] = 246,
    ["dprint.json"] = 247,
    ["drone.json"] = 248,
    ["dss-2.0.0.json"] = 250,
    ["dstack configuration"] = 251,
    ["dvc.yaml"] = 252,
    ["ecosystem.json"] = 257,
    eksctl = 258,
    ["electron-builder configuration file"] = 265,
    ["epr-manifest.json"] = 263,
    ["evcc.yaml"] = 266,
    ["ezd task runner"] = 275,
    ["fabric.mod.json"] = 278,
    ["first-timers-bot"] = 284,
    ...
    ["gitlab-ci"] = 311,
    ["global.json"] = 326,
    ["go-feature-flag Flag Configuration"] = 329,
    ["haxelib.json"] = 344,
    helmfile = 740,
    helmwave = 741,
    ["host-meta.json"] = 349,
    ...
    ["ide.host.json"] = 356,
    ["ifstate.conf"] = 357,
    ["imageoptimizer.json"] = 358,
    ["importmap.json"] = 361,
    ["ioBroker Configuration"] = 363,
    ["ioBroker JSON UI"] = 364,
    ["ioBroker Package manifest"] = 365,
    ["ize.toml"] = 838,
    ["jsconfig.json"] = 388,
    ["jscpd Configuration"] = 818,
    jsdoc = 736,
    ["k3d.yaml"] = 389,
    ["k9s plugin.yml"] = 391,
    ["kontinuous-config.yaml"] = 399,
    ["kontinuous-values.yaml"] = 398,
    ["kustomization.yaml"] = 401,
    ["label-commenter-config.yml"] = 402,
    ["latexindent configuration"] = 60,
    ["launchsettings.json"] = 403,
    lazydocker = 860,
    lazygit = 859,
    ["lego.json"] = 405,
    ["lerna.json"] = 406,
    ["lgtm.yml"] = 407,
    ["liblab.config.json"] = 408,
    ["libman.json"] = 409,
    ["license-report-config.json"] = 410,
    ["linkinator.config.json"] = 412,
    ["lint-staged (.lintstagedrc)"] = 716,
    ["local.settings.json"] = 417,
    ["localazy.json"] = 418,
    ["lotus.yaml"] = 416,
    ["lsdlschema.json"] = 419,
    ["markdown-link-check"] = 777,
    mboats = 784,
    ["micro-settings.json"] = 853,
    ["mimetypes.json"] = 429,
    ["mirrord config"] = 717,
    mise = 718,
    ["mise-settings"] = 719,
    ["mkdocs.yml"] = 449,
    ["monospace.yml"] = 451,
    ["mprocs Configuration file"] = 905,
    ["mta.yaml"] = 720,
    ["mtad.yaml"] = 721,
    ["mycode.json"] = 458,
    ["napari plugin manifest"] = 459,
    neoload = 731,
    ["nest-cli"] = 464,
    ["ninjs (News in JSON)"] = 463,
    ["nixd configuration"] = 877,
    ["nlu.json"] = 465,
    ["nodemon.json"] = 467,
    ["noodl config"] = 783,
    ["notebook.mod.json"] = 468,
    now = 727,
    ["npm-badges"] = 471,
    ["nswag.json"] = 474,
    ntangle = 475,
    ["nuclei-template.yaml"] = 472,
    ["nuget-project.json"] = 473,
    ["ocelot.json"] = 477,
    ["omnisharp.json"] = 478,
    ["openapi.json"] = 479,
    ["openfin.json"] = 486,
    ...
    ["ops.yaml"] = 483,
    ["package.json"] = 498,
    ["package.manifest"] = 499,
    ["partial-black.json"] = 89,
    ["pathfinder.yml"] = 502,
    ["pattern.json"] = 505,
    ["petstore-v1.0"] = 828,
    pgap_yaml_input_reader = 504,
    ["pixi.toml"] = 506,
    ["plagiarize-me.yaml"] = 510,
    ["plagiarize.yaml"] = 509,
    ["portman.json"] = 511,
    ["prettierrc.json"] = 519,
    ["prisma.yml"] = 520,
    ["project-1.0.0-beta3.json"] = 523,
    ["project-1.0.0-beta4.json"] = 524,
    ["project-1.0.0-beta5.json"] = 525,
    ["project-1.0.0-beta6.json"] = 526,
    ["project-1.0.0-beta8.json"] = 527,
    ["project-1.0.0-rc1.json"] = 528,
    ["project-1.0.0-rc2.json"] = 529,
    ["project.json"] = 522,
    ["prometheus.json"] = 530,
    ["prometheus.rules.json"] = 531,
    ["prometheus.rules.test.json"] = 532,
    ["proxies.json"] = 533,
    ["publiccode.yml"] = 534,
    ["pubspec.yaml"] = 535,
    ["pyrseas-0.8.json"] = 538,
    ["quilt.mod.json"] = 854,
    ["rc3 auth"] = 547,
    ["rc3 collection"] = 548,
    ["rc3 environment"] = 549,
    ...
    samt = 571,
    samtrc = 572,
    ["sarif-1.0.0.json"] = 574,
    ["sarif-2.0.0.json"] = 575,
    ["sarif-2.1.0"] = 585,
    ["sarif-2.1.0-rtm.2"] = 576,
    ["sarif-2.1.0-rtm.3"] = 578,
    ["sarif-2.1.0-rtm.4"] = 580,
    ["sarif-2.1.0-rtm.5"] = 582,
    ["sarif-2.1.0-rtm.6"] = 583,
    ["sarif-external-property-file-2.1.0"] = 586,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 577,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 579,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 581,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 584,
    ["schema.org - Action"] = 588,
    ["schema.org - ContactPoint"] = 589,
    ["schema.org - Place"] = 590,
    ["schema.org - Thing"] = 591,
    ["secrethub.yml"] = 856,
    ["semantic-release"] = 597,
    ["servicehub.config.json"] = 711,
    ["servicehub.service.json"] = 710,
    ["settings.job"] = 600,
    ["sfdx-hardis configuration"] = 602,
    ["shard.yml"] = 892,
    ["size-limit configuration"] = 607,
    ["skaffold.yaml"] = 775,
    ["skyuxconfig.json"] = 609,
    snapcraft = 610,
    ["spicepod.yaml"] = 912,
    ["sqlc configuration"] = 621,
    ["stripe-app-local.json"] = 630,
    ["stripe-app.json"] = 629,
    swcrc = 761,
    ["task.json"] = 636,
    taskcat = 728,
    ["template.json"] = 640,
    ["templatsources.json"] = 641,
    ["theme.json"] = 644,
    ["tizen_workspace.json"] = 645,
    tldr = 646,
    tmuxinator = 714,
    ["transcend.yml"] = 653,
    ["tree-sitter grammar.json"] = 334,
    ["trime.yaml"] = 654,
    ["trunk.yaml"] = 655,
    ["ts-force-config.json"] = 659,
    ["tsconfig.json"] = 656,
    ["tsd.json"] = 657,
    ["tsdrc.json"] = 658,
    ["tslint.json"] = 660,
    ...
    v8r = 694,
    vcluster = 899,
    ["vcpkg configuration file"] = 172,
    ["vcpkg manifest file"] = 171,
    ["vega-lite.json"] = 678,
    ["vega.json"] = 677,
    ["venvironment-basic.yaml"] = 681,
    ["venvironment.yaml"] = 680,
    ["version.json"] = 682,
    ["vim-addon-info"] = 684,
    ["vs-2017.3.host.json"] = 686,
    ["vs-nesting.json"] = 687,
    ["vsls.json"] = 685,
    ["vss-extension.json"] = 691,
    ["vtesttree.yaml"] = 692,
    ["vtestunit.yaml"] = 693,
    ["warp-keysets.json"] = 862,
    ["warp-themes.json"] = 863,
    ["warp-workflows.json"] = 864,
    ["webhint.io"] = 814,
    ["webjobpublishsettings.json"] = 699,
    ["webjobs-list.json"] = 698,
    ["well-known-fursona"] = 900,
    ["xs-app.json"] = 724,
    ["xunit.runner.json"] = 709,
    yamllint = 749,
    ["zerops.io import file"] = 909,
    ["zerops.yml"] = 908,
    zuul = 733,
    ["Žinoma"] = 743
  },
