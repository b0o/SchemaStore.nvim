...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 175,
    [".cryproj (generic)"] = 602,
    [".cryproj engine-5.2"] = 597,
    [".cryproj engine-5.3"] = 598,
    [".cryproj engine-5.4"] = 599,
    [".cryproj engine-5.5"] = 600,
    [".cryproj engine-dev"] = 601,
    [".csscomb.json"] = 177,
    [".csslintrc"] = 178,
    [".es6importsorterrc.json"] = 732,
    [".eslintrc"] = 227,
    [".esmrc.json"] = 219,
    [".ffizer.yaml"] = 231,
    [".htmlhintrc"] = 283,
    ...
    [".mtaext"] = 611,
    [".nodehawkrc"] = 382,
    [".npmpackagejsonlintrc"] = 385,
    [".phraseapp.yml"] = 427,
    [".pmbot.yml"] = 416,
    [".postcssrc"] = 422,
    [".powerpages-web-template-manifest"] = 424,
    [".pre-commit-config.yml"] = 425,
    [".pre-commit-hooks.yml"] = 426,
    [".putout.json"] = 446,
    [".rehyperc"] = 458,
    [".remarkrc"] = 459,
    [".sprite files"] = 514,
    ...
    ["<div>RIOTS' studio configuration"] = 581,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 343,
    ["API Builder"] = 643,
    ["AVA Configuration"] = 702,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 675,
    ["All Contributors configuration file"] = 731,
    ...
    ["Azure Pipelines"] = 59,
    ["Azure Static Web Apps CLI configuration file"] = 517,
    ["Azure Static Web Apps configuration file"] = 516,
    ["BX CI"] = 95,
    ["Better Code Hub"] = 647,
    ["Better Scripts"] = 96,
    Bigconfig = 76,
    BizTalkServerApplicationSchema = 617,
    Bleep = 97,
    ...
    ["Butane Config"] = 687,
    ["CICS TS region tagging"] = 696,
    ["CICS TS resource import"] = 697,
    ["CICS TS resource model"] = 698,
    ["CICS TS resource overrides"] = 699,
    ["CMake Presets"] = 98,
    ["CNC Codes"] = 108,
    ...
    ["Databricks Asset Bundles"] = 752,
    ["Datadog Service Definition"] = 322,
    ["Datahub Ingestion Recipe"] = 703,
    ["Dein Config"] = 113,
    Deno = 188,
    ["Deployer Recipe"] = 191,
    ["Deta Spacefile"] = 114,
    ...
    ["Error pages"] = 222,
    Esquio = 220,
    ["Estuary Flow Catalog"] = 693,
    ["Expo SDK"] = 225,
    ["F-Droid Data metadata"] = 230,
    ["Facets - FSDL - Application"] = 228,
    ["FasterCI Configuration"] = 60,
    Firebase = 232,
    ["Fossa configuration file"] = 240,
    ["Fossa's fossa-deps file"] = 241,
    ["Foundry VTT - Base package Manifest"] = 235,
    ["Foundry VTT - Module Manifest"] = 236,
    ["Foundry VTT - System Data Template"] = 239,
    ["Foundry VTT - System Manifest"] = 237,
    ["Foundry VTT - World Manifest"] = 238,
    ["Foxx Manifest"] = 61,
    ["Freifunk.de Community API"] = 64,
    ["Frogbot Config"] = 65,
    ["G2P Mapping Configuration"] = 245,
    ["GCP Blueprint Metadata"] = 248,
    Gaspar = 246,
    ["GatewayCore API Gateway"] = 247,
    ["GeoJSON.json latest"] = 691,
    GherKing = 695,
    ["GitHub Action"] = 252,
    ["GitHub Discussion"] = 253,
    ["GitHub Funding"] = 254,
    ["GitHub Issue Template configuration"] = 256,
    ["GitHub Workflow"] = 257,
    ["GitHub Workflow Template Properties"] = 258,
    ["GitHub issue forms"] = 255,
    GitVersion = 251,
    ["Gitpod Configuration"] = 260,
    ["Global Privacy Control"] = 249,
    Goblet = 751,
    ["Google Chrome Related Website Sets"] = 233,
    ["Google Cloud Workflows"] = 158,
    Goreleaser = 264,
    ["Goreleaser Pro"] = 265,
    Goss = 266,
    ["Gradle Build Cache Node"] = 645,
    ["Gradle Enterprise"] = 644,
    ["Grafana 5.x Dashboard"] = 267,
    ["GraphQL Code Generator"] = 270,
    ["GraphQL Config"] = 269,
    ["GraphQL Mesh"] = 268,
    ["Grunt JSHint task"] = 274,
    ["Grunt Watch task"] = 275,
    ["Grunt base task"] = 276,
    ["Grunt clean task"] = 272,
    ["Grunt copy task"] = 271,
    ["Grunt cssmin task"] = 273,
    HEMTT = 614,
    Hadolint = 626,
    Hammerkit = 654,
    ["Hardware Sentry Configuration"] = 707,
    Hatch = 627,
    Hayson = 278,
    ["Haystack Pipeline"] = 279,
    ["Hazelcast 5 Configuration"] = 280,
    ["Helm Chart.lock"] = 129,
    ["Helm Chart.yaml"] = 128,
    ["Helm Unittest Test Suite"] = 130,
    Hugo = 683,
    ["IBM Zapp document"] = 285,
    ["IBM zCodeFormatSettings"] = 286,
    ["IMG Catapult PSP"] = 291,
    Istanbul = 710,
    ["JDownloader2 crawler multi-rules"] = 301,
    ["JDownloader2 crawler single-rules"] = 300,
    ["JFrog Applications Config"] = 302,
    ["JFrog File Spec"] = 303,
    ["JFrog Pipelines YML DSL"] = 716,
    ["JMeter DSL cli config"] = 304,
    JReleaser = 306,
    ["JSON Document Transform"] = 313,
    ["JSON Feed"] = 314,
    ["JSON Resume"] = 465,
    ["JSON Schema Draft 2020-12"] = 593,
    ["JSON Schema Draft 4"] = 590,
    ["JSON Schema Draft 7"] = 591,
    ["JSON Schema Draft 7 (unofficial strict)"] = 753,
    ["JSON Schema Draft 8 (2019-09)"] = 592,
    ["JSON-API"] = 312,
    ["JSON-e templates"] = 652,
    ["JSON-stat 2.0"] = 587,
    JSONPatch = 316,
    Jasmine = 296,
    Jekyll = 297,
    ["Jenkins X Pipelines"] = 298,
    ["Jenkins X Requirements"] = 299,
    ["Jovo Language Models"] = 305,
    ["KSP-AVC"] = 588,
    ["KSP-CKAN"] = 589,
    ["Karakum configuration file"] = 242,
    Kas = 319,
    ["Keycloak REST API"] = 723,
    ["Knative Functions - func.yaml"] = 243,
    ["KoDE/CI build.yaml"] = 712,
    ["Kong DBLess config"] = 713,
    KrakenD = 321,
    LOOBin = 338,
    Lefthook = 329,
    ["LinkML Metamodel"] = 336,
    Liquibase = 659,
    ["Liquibase Flow File"] = 660,
    ["Lively Properties"] = 337,
    ["Lobe AI Agent"] = 58,
    ["MS2Rescore Configuration"] = 370,
    Markdownlint = 663,
    ["Mason Registry"] = 665,
    ["MegaLinter configuration"] = 344,
    ["MegaLinter descriptor"] = 345,
    ["Meltano plugin discovery definition"] = 347,
    ["Meltano project definition"] = 346,
    ["Microsoft Band Web Tile"] = 348,
    ["Minecraft Data Pack Advancement"] = 350,
    ["Minecraft Data Pack Biome"] = 351,
    ["Minecraft Data Pack Configured Carver"] = 352,
    ["Minecraft Data Pack Damage Type"] = 353,
    ["Minecraft Data Pack Dimension"] = 355,
    ["Minecraft Data Pack Dimension Type"] = 354,
    ["Minecraft Data Pack Item Modifier"] = 356,
    ["Minecraft Data Pack Loot Table"] = 357,
    ["Minecraft Data Pack Metadata"] = 358,
    ["Minecraft Data Pack Predicate"] = 359,
    ["Minecraft Data Pack Recipe"] = 360,
    ["Minecraft Data Pack Tag"] = 361,
    ["Minecraft Data Pack Template Pool"] = 362,
    ["Minecraft Data Pack Trim Material"] = 367,
    ["Minecraft Data Pack Trim Pattern"] = 368,
    ["Minecraft Resource Pack Lang"] = 363,
    ["Minecraft Resource Pack Particle"] = 364,
    ["Minecraft Resource Pack Texture Mcmeta"] = 366,
    ["Minecraft Resourcepack Sounds"] = 365,
    ["MkDocs Configuration 1.0"] = 369,
    ["MongoDB Atlas Search Index Definition"] = 711,
    ["Monika Configuration"] = 709,
    ["Motif config"] = 610,
    ["NOX Framework (Service)"] = 384,
    ["Netin Diagnostic System Template"] = 669,
    ["Netlify config"] = 375,
    ["Nexus-as-Code Data Model"] = 376,
    ["Nightwatch.js"] = 377,
    ["ONe's service descriptor"] = 397,
    ["OSS Review Toolkit configuration"] = 404,
    ["OSS Review Toolkit curation"] = 405,
    ["OSS Review Toolkit package configuration"] = 406,
    ["OSS Review Toolkit repository configuration"] = 407,
    ["OSS Review Toolkit resolutions"] = 408,
    Opctl = 613,
    ["OpenRewrite Resource"] = 399,
    ["OpenWeather Current Weather API"] = 651,
    ["OpenWeather Road Risk API"] = 650,
    ["Ory Hydra configuration"] = 284,
    ["Ory Keto configuration"] = 323,
    ["Ory Kratos configuration"] = 403,
    ["Ory Oathkeeper configuration"] = 391,
    ["Outblocks App configuration"] = 401,
    ["Outblocks database table"] = 402,
    ["Outblocks project configuration"] = 400,
    Packer = 411,
    Pantsbuild = 730,
    ["Paper paper-plugin.yml"] = 412,
    ["Pipeline component"] = 661,
    ["PocketMine plugin.yml"] = 417,
    Poetry = 418,
    ["Postman collection"] = 423,
    ["Problem package generators"] = 430,
    Pterodactyl = 706,
    ["Pull Request Labeler"] = 445,
    Pulumi = 451,
    PyProject = 452,
    Pyright = 453,
    Qgoda = 454,
    Qodana = 680,
    ["Quali Torque Blueprint Spec 2"] = 704,
    ["QueryFirst config file"] = 726,
    ["RKE Cluster Configuration JSON"] = 658,
    ["RKE Cluster Configuration YAML"] = 657,
    ["Rancher Fleet"] = 448,
    Ray = 625,
    ["Read the Docs"] = 450,
    ["Red-DiscordBot Cog"] = 455,
    ["Red-DiscordBot Cog Repo"] = 456,
    ["Red-DiscordBot Trivia"] = 457,
    RenderCV = 467,
    Renovate = 466,
    ["Replit config"] = 460,
    RoadRunner = 468,
    ...
    ["Rust Project"] = 464,
    ["Rust toolchain"] = 470,
    ["SIL Kit Participant Configuration"] = 502,
    ["SIL Kit Registry Configuration"] = 503,
    SWADL = 527,
    ["Safebox Config"] = 717,
    ["Sapphire CLI Config"] = 473,
    ["SauceCTL Configuration"] = 666,
    ["Schema Catalog"] = 487,
    ["Scoop manifest"] = 492,
    ["Semantic Data Fabric (SDF) file"] = 493,
    ["Semgrep Rule"] = 495,
    ["Serenity Code Generator (Sergen)"] = 496,
    ["Serverless Framework Configuration"] = 674,
    ["Serverless Workflow"] = 676,
    ["Settings.paf"] = 498,
    Setuptools = 499,
    ["Shopware 6 Configuration"] = 677,
    ["Shopware CLI Extension Store Configuration"] = 678,
    ["Shopware CLI Project Store Configuration"] = 679,
    ["Sigrid scope configuration file"] = 501,
    ["Slack app manifest"] = 505,
    Solidarity = 508,
    ["Solution filters"] = 509,
    ["Source Maps v3"] = 510,
    Sourcery = 511,
    SpecIF = 512,
    ["Sponge Mixin configuration"] = 513,
    StackBlitz = 518,
    ["StackHawk Scanner Configuration"] = 673,
    Stale = 519,
    ["Starlake Data Pipeline"] = 648,
    Starship = 520,
    ["Statamic Blueprint"] = 521,
    ["StrmPrivacy Data Connector"] = 721,
    ["StrmPrivacy Data Contract"] = 722,
    ["StrmPrivacy SimpleSchema"] = 719,
    ["StrmPrivacy Stream"] = 720,
    ["StrmPrivacy batch job configuration file"] = 718,
    ["Stryker Mutator"] = 524,
    ["StyleCop Analyzers Configuration"] = 525,
    ["Swagger API 2.0"] = 528,
    TSON = 552,
    ["Talisman configuration"] = 530,
    ["Taskfile config"] = 653,
    Taurus = 531,
    ["TestEnvironment.json"] = 540,
    ["TextMate Grammar"] = 539,
    ["Tier.run pricing.json"] = 534,
    Tikibase = 535,
    ["Traefik v2"] = 543,
    ["Traefik v2 File Provider"] = 544,
    Turborepo = 541,
    Tye = 681,
    ["UET BuildConfig.json"] = 727,
    ["UI5 Manifest"] = 560,
    ["UTAM Page Object"] = 563,
    ["Ubuntu Server Autoinstall"] = 558,
    ["Uniswap Token List"] = 636,
    ["Unreal Engine Uplugin"] = 728,
    ["Unreal Engine Uproject"] = 729,
    ["Updatecli Compose"] = 688,
    ["Updatecli Policy Manifest"] = 689,
    ["Updatecli Policy Metadata"] = 690,
    Uplift = 725,
    ["User Journey Map"] = 656,
    V2Ray = 694,
    ["VSCode Code Snippets"] = 146,
    ["VSIX CLI publishing"] = 576,
    ["Vela Pipeline Configuration"] = 566,
    Vercel = 145,
    Visivo = 754,
    ["Web App Manifest"] = 583,
    ["Web types"] = 586,
    WebExtensions = 582,
    ["Webman package recipe"] = 700,
    ["Windows Package Manager Installer Manifest"] = 633,
    ["Windows Package Manager Locale Manifest"] = 634,
    ["Windows Package Manager Singleton Manifest"] = 632,
    ["Woodpecker pipeline config"] = 668,
    ["Xstate Machine"] = 686,
    ["Yippee-Ki-JSON configuration YML"] = 638,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 70,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 736,
    ["bashly-strings.yml"] = 737,
    ["bashly.yml"] = 735,
    ["batect.yml"] = 69,
    ...
    ["gitlab-ci"] = 259,
    ["global.json"] = 261,
    ["go-feature-flag Flag Configuration"] = 263,
    ["golangci-lint Configuration"] = 262,
    ["haxelib.json"] = 277,
    helmfile = 628,
    helmwave = 629,
    ["host-meta.json"] = 282,
    ...
    ["ide.host.json"] = 287,
    ["ifstate.conf"] = 288,
    ["imageoptimizer.json"] = 289,
    ["importmap.json"] = 292,
    ["ioBroker Configuration"] = 293,
    ["ioBroker JSON UI"] = 294,
    ["ioBroker Package manifest"] = 295,
    ["ize.toml"] = 724,
    ["jsconfig.json"] = 317,
    ["jscpd Configuration"] = 705,
    jsdoc = 624,
    ["k3d.yaml"] = 318,
    ["k9s plugin.yml"] = 320,
    ["kontinuous-config.yaml"] = 325,
    ["kontinuous-values.yaml"] = 324,
    ["kustomization.yaml"] = 326,
    ["label-commenter-config.yml"] = 327,
    ["launchsettings.json"] = 328,
    lazydocker = 746,
    lazygit = 745,
    ["lego.json"] = 330,
    ["lerna.json"] = 331,
    ["lgtm.yml"] = 332,
    ["libman.json"] = 333,
    ["license-report-config.json"] = 334,
    ["linkinator.config.json"] = 335,
    ["local.settings.json"] = 340,
    ["localazy.json"] = 341,
    ["lotus.yaml"] = 339,
    ["lsdlschema.json"] = 342,
    ["madness.yml"] = 734,
    ["markdown-lint-check"] = 664,
    mboats = 671,
    ["micro-settings.json"] = 739,
    ["mimetypes.json"] = 349,
    ["mirrord config"] = 607,
    ["mta.yaml"] = 608,
    ["mtad.yaml"] = 609,
    ["mycode.json"] = 373,
    ["napari plugin manifest"] = 374,
    neoload = 619,
    ["nest-cli"] = 380,
    ["ninjs (News in JSON) 1.3"] = 379,
    ["ninjs (News in JSON) 2.0"] = 378,
    ["nlu.json"] = 381,
    ["nodemon.json"] = 383,
    ["noodl config"] = 670,
    now = 615,
    ...
    ["nswag.json"] = 389,
    ntangle = 390,
    ["nuclei-template.yaml"] = 387,
    ["nuget-project.json"] = 388,
    ["ocelot.json"] = 392,
    ["omnisharp.json"] = 393,
    ["openapi.json"] = 394,
    ["openfin.json"] = 398,
    ...
    ["ops.yaml"] = 396,
    ["package.json"] = 409,
    ["package.manifest"] = 410,
    ["pathfinder.yml"] = 413,
    ["pattern.json"] = 415,
    ["petstore-v1.0"] = 715,
    pgap_yaml_input_reader = 414,
    ["plagiarize-me.yaml"] = 420,
    ["plagiarize.yaml"] = 419,
    ["portman.json"] = 421,
    ["prettierrc.json"] = 428,
    ["prisma.yml"] = 429,
    ["project-1.0.0-beta3.json"] = 432,
    ["project-1.0.0-beta4.json"] = 433,
    ["project-1.0.0-beta5.json"] = 434,
    ["project-1.0.0-beta6.json"] = 435,
    ["project-1.0.0-beta8.json"] = 436,
    ["project-1.0.0-rc1.json"] = 437,
    ["project-1.0.0-rc2.json"] = 438,
    ["project.json"] = 431,
    ["prometheus.json"] = 439,
    ["prometheus.rules.json"] = 440,
    ["prometheus.rules.test.json"] = 441,
    ["proxies.json"] = 442,
    ["publiccode.yml"] = 443,
    ["pubspec.yaml"] = 444,
    ["pyrseas-0.8.json"] = 447,
    ["quilt.mod.json"] = 740,
    ["release drafter"] = 620,
    rtx = 462,
    rustfmt = 469,
    samt = 471,
    samtrc = 472,
    ["sarif-1.0.0.json"] = 474,
    ["sarif-2.0.0.json"] = 475,
    ["sarif-2.1.0"] = 485,
    ["sarif-2.1.0-rtm.2"] = 476,
    ["sarif-2.1.0-rtm.3"] = 478,
    ["sarif-2.1.0-rtm.4"] = 480,
    ["sarif-2.1.0-rtm.5"] = 482,
    ["sarif-2.1.0-rtm.6"] = 483,
    ["sarif-external-property-file-2.1.0"] = 486,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 477,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 479,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 481,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 484,
    ["schema.org - Action"] = 488,
    ["schema.org - ContactPoint"] = 489,
    ["schema.org - Place"] = 490,
    ["schema.org - Thing"] = 491,
    ["scikit-build"] = 672,
    ["secrethub.yml"] = 742,
    ["semantic-release"] = 494,
    ["servicehub.config.json"] = 596,
    ["servicehub.service.json"] = 595,
    ["settings.job"] = 497,
    ["sfdx-hardis configuration"] = 500,
    ["size-limit configuration"] = 504,
    ["skaffold.yaml"] = 662,
    ["skyuxconfig.json"] = 506,
    snapcraft = 507,
    ["sqlc configuration"] = 515,
    ["stripe-app-local.json"] = 523,
    ["stripe-app.json"] = 522,
    swcrc = 649,
    syntax = 744,
    ["task.json"] = 529,
    taskcat = 616,
    ["template.json"] = 532,
    ["templatsources.json"] = 533,
    ["theme.json"] = 536,
    ["tizen_workspace.json"] = 537,
    tldr = 538,
    tmuxinator = 604,
    ["transcend.yml"] = 545,
    ["trunk.yaml"] = 546,
    ["ts-force-config.json"] = 550,
    ["tsconfig.json"] = 547,
    ["tsd.json"] = 548,
    ["tsdrc.json"] = 549,
    ["tslint.json"] = 551,
    ...
    ["vega-lite.json"] = 565,
    ["vega.json"] = 564,
    ["venvironment-basic.yaml"] = 568,
    ["venvironment.yaml"] = 567,
    ["version.json"] = 569,
    ["vim-addon-info"] = 570,
    ["vs-2017.3.host.json"] = 572,
    ["vs-nesting.json"] = 573,
    ["vsls.json"] = 571,
    ["vss-extension.json"] = 577,
    ["vtesttree.yaml"] = 578,
    ["vtestunit.yaml"] = 579,
    ["warp-keysets.json"] = 748,
    ["warp-themes.json"] = 749,
    ["warp-workflows.json"] = 750,
    ["webhint.io"] = 701,
    ["webjobpublishsettings.json"] = 585,
    ["webjobs-list.json"] = 584,
    ["xs-app.json"] = 612,
    ["xunit.runner.json"] = 594,
    yamllint = 637,
    zuul = 621,
    ["Žinoma"] = 631
  },
