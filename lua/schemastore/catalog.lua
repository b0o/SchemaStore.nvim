...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1074,
    ["API Builder"] = 888,
    ["AVA Configuration"] = 950,
    ...
    ["AWS Copilot Manifest"] = 1112,
    ["AWS SAM CLI Samconfig"] = 221,
    ["Adobe UXP Manifest"] = 1012,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1103,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 922,
    ["All Contributors configuration file"] = 975,
    ...
    ["Application list for a WinUtil"] = 1056,
    ArchitectFX = 1061,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["BX CI"] = 123,
    ["Bashly (bashly.yml)"] = 979,
    ["Bashly Settings (bashly-settings.yml)"] = 980,
    ["Better Code Hub"] = 892,
    ["Better Scripts"] = 124,
    Bigconfig = 96,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1067,
    BizTalkServerApplicationSchema = 860,
    Bleep = 125,
    ...
    ["Butane Config"] = 935,
    C4InterFlow = 1082,
    ["CDK Environment Manager, concrete environment configuration"] = 1106,
    ["CDK Environment Manager, concrete environments definition"] = 1105,
    ["CDK Environment Manager, environment definition"] = 1104,
    ["CGS Card Game Specification (cgs.json)"] = 1017,
    ["CICS TS region tagging"] = 944,
    ["CICS TS resource import"] = 945,
    ["CICS TS resource model"] = 946,
    ["CICS TS resource overrides"] = 947,
    ["CMake Presets"] = 126,
    ["CNC Codes"] = 146,
    ["CRS WAF test file"] = 1046,
    ["CRS WAF test platform overrides file"] = 1047,
    ...
    ["Chamaleon environment"] = 1071,
    ["Chamaleon properties"] = 1072,
    ["Chamaleon template"] = 1070,
    Changesets = 230,
    Changie = 135,
    Charmcraft = 136,
    Cheatsheets = 932,
    ...
    ["Clawject config"] = 152,
    ["Cloud Foundry Application Manifest"] = 1028,
    ["Cloud Run Spec v1"] = 1051,
    ...
    Concord = 1045,
    ["Configu .cfgu files"] = 1033,
    ["Configu .configu file"] = 1034,
    Conjure = 145,
    ["Container Structure Test"] = 874,
    Containerlab = 901,
    ["Contextive Glossary"] = 1098,
    Convex = 144,
    ["Crowdsec collection config"] = 240,
    ["Crowdsec parser config"] = 241,
    ["Crowdsec scenario config"] = 242,
    ["CumulusCI Config"] = 151,
    ["Custom Machinery Machine"] = 1018,
    ["Custom Machinery Recipe"] = 1019,
    ...
    ["DonateCaseBetterCasino menu"] = 1075,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 987,
    ["EAS config"] = 306,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 976,
    ["EasyVCR .NET"] = 307,
    ["Eidolon Resource"] = 1062,
    ...
    ["GeoJSON.json latest"] = 939,
    GherKing = 943,
    ["GitHub Action"] = 337,
    ["GitHub Actions typing"] = 1058,
    ...
    ["Google Digital Assetlinks"] = 1099,
    Goreleaser = 365,
    ["Goreleaser Pro"] = 366,
    Goss = 367,
    ["Gradle Build Cache Node"] = 890,
    ["Gradle Enterprise"] = 889,
    ...
    Hadolint = 870,
    Hammerkit = 900,
    ["Hardware Sentry Configuration"] = 955,
    ["HashiCorp Vault"] = 379,
    Hatch = 871,
    Hayson = 381,
    ["Haystack Pipeline"] = 382,
    ["Hazelcast 5 Configuration"] = 383,
    ["Hecate Input Schema"] = 1110,
    ["Helm Chart.lock"] = 185,
    ["Helm Chart.yaml"] = 184,
    ...
    ["JFrog File Spec"] = 412,
    ["JFrog Pipelines YML DSL"] = 964,
    ["JMeter DSL cli config"] = 413,
    JReleaser = 416,
    ["JSON Document Transform"] = 424,
    ["JSON Feed"] = 425,
    ["JSON Resume"] = 649,
    ["JSON Schema Draft 2020-12"] = 839,
    ["JSON Schema Draft 4"] = 836,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 997,
    ["JSON Schema Draft 7"] = 837,
    ["JSON Schema Draft 7 (unofficial strict)"] = 998,
    ["JSON Schema Draft 8 (2019-09)"] = 838,
    ["JSON-API"] = 423,
    ["JSON-e templates"] = 897,
    ["JSON-stat 2.0"] = 832,
    JSONPatch = 427,
    ...
    ["Jujutsu (jj) VCS config"] = 1111,
    ["KIMMDY config file"] = 438,
    ["KODE/CI build.yaml"] = 960,
    ["KSP-AVC"] = 833,
    ["KSP-CKAN"] = 834,
    ["KSP-NetKAN"] = 835,
    KSY = 1027,
    ...
    ["Metadata for a Cinnamon spice"] = 1054,
    ["Metatype Configuration"] = 477,
    ["MetricsHub Configuration"] = 478,
    ["MetricsHub Connector Configuration"] = 479,
    ["Micro Editor Syntax"] = 988,
    ["Microsoft Band Web Tile"] = 480,
    ["Microsoft RulesEngine workflow rules"] = 1042,
    ["Microsoft RulesEngine workflow rules list"] = 1043,
    ["Minecraft Custom Main Menu Mod"] = 1006,
    ...
    ["MongoDB Atlas Search Index Definition"] = 959,
    ["Monika Configuration"] = 957,
    ["Monoweave Configuration"] = 505,
    ["Motif config"] = 852,
    MultiQC = 1092,
    ["NOX Framework (Service)"] = 523,
    ["Netin Diagnostic System Template"] = 917,
    ["Netlify config"] = 513,
    ["Network-as-Code Data Model"] = 514,
    ["Nightwatch.js"] = 516,
    ["Node.js configuration"] = 857,
    ...
    ["OpenUtau ustx"] = 541,
    ["OpenWeather Current Weather API"] = 896,
    ["OpenWeather Road Risk API"] = 895,
    ...
    ["Power Pages Configuration"] = 1109,
    ["Preset list for a WinUtil"] = 1057,
    ...
    Pylock = 1100,
    Pyright = 624,
    ["Python script metadata"] = 1094,
    ["QType AI DSL"] = 627,
    Qgoda = 626,
    Qodana = 927,
    ["Qt Creator workspace file"] = 1035,
    ["Quali Torque Blueprint Spec 2"] = 952,
    ["QueryFirst config file"] = 970,
    ["RKE Cluster Configuration JSON"] = 905,
    ["RKE Cluster Configuration YAML"] = 904,
    RadioHound = 617,
    Railway = 628,
    ["Rancher Fleet"] = 619,
    ["Rattler-build"] = 629,
    ...
    ["SauceCTL Configuration"] = 914,
    ["Schema Catalog"] = 676,
    ["Scoop manifest"] = 681,
    ["Semantic Data Fabric (SDF) file"] = 685,
    ["Semgrep Rule"] = 687,
    ["Serenity Code Generator (Sergen)"] = 688,
    ["Serverless Framework Configuration"] = 921,
    ["Serverless Workflow"] = 923,
    ["Settings for a Cinnamon spice"] = 1053,
    ["Settings.paf"] = 690,
    ["Shopware 6 Configuration"] = 924,
    ["Shopware CLI Extension Store Configuration"] = 925,
    ["Shopware CLI Project Store Configuration"] = 926,
    ["Sigma Detection Rule"] = 692,
    ["Sigrid scope configuration file"] = 693,
    ["SkyPilot Task JSON"] = 1011,
    ...
    StackBlitz = 735,
    ["StackHawk Scanner Configuration"] = 920,
    Stale = 736,
    ["Starlake Data Pipeline"] = 893,
    Starship = 737,
    ...
    ["Stylua Config"] = 1101,
    ["Sublime Syntax"] = 966,
    ["Subsquid squid manifest"] = 1013,
    ["Swagger API 2.0"] = 746,
    ["Synadia Connect Component"] = 747,
    TSON = 782,
    TSTyche = 783,
    ["TYPO3 Vendor Bundler config"] = 788,
    ["Tab data for a LinUtil"] = 1060,
    ["Tab list for a LinUtil"] = 1059,
    Tach = 748,
    ["Tach Domain"] = 749,
    Talhelper = 751,
    ...
    Tombi = 763,
    ["Traefik v2"] = 768,
    ["Traefik v2 File Provider"] = 769,
    ["Traefik v3"] = 770,
    ["Traefik v3 File Provider"] = 771,
    ["Travis CI (.travis.yml)"] = 767,
    Trident = 1084,
    ["TrueScript for *.tscript files"] = 774,
    ["Tugboat QA config.yml"] = 1081,
    TunnelHub = 1001,
    Turborepo = 766,
    Tycho = 1049,
    Tye = 928,
    ["Tyk Gateway - Open Source v5.7+"] = 1093,
    ["Typst Manifest"] = 789,
    ["UET BuildConfig.json"] = 971,
    ["UI5 Manifest"] = 795,
    ["UNCORS configuration"] = 799,
    ["UTAM Page Object"] = 798,
    ["Ubuntu Server Autoinstall"] = 793,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1085,
    ["Uniswap Token List"] = 881,
    ["Universal Schedule Format"] = 800,
    ["Unreal Engine Uplugin"] = 972,
    ["Unreal Engine Uproject"] = 973,
    ["UpCloud CLI (upctl) configuration"] = 1086,
    ["Updatecli Compose"] = 936,
    ["Updatecli Policy Manifest"] = 937,
    ["Updatecli Policy Metadata"] = 938,
    Uplift = 969,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 902,
    V2Ray = 942,
    ["VSCode Code Snippets"] = 205,
    ["VSIX CLI publishing"] = 820,
    Vector = 802,
    ["Vela Pipeline Configuration"] = 805,
    Vercel = 204,
    ["Version Bumper config"] = 810,
    ["Viash Component Config"] = 1090,
    ["Viash Package Config"] = 1091,
    Visivo = 999,
    ["WP-CLI"] = 830,
    Wake = 1083,
    ["Waku Config"] = 1063,
    ["Web App Manifest"] = 826,
    ["Web types"] = 829,
    WebExtensions = 825,
    ["Webman package recipe"] = 948,
    ["Windows Package Manager Installer Manifest"] = 877,
    ["Windows Package Manager Locale Manifest"] = 878,
    ["Windows Package Manager Singleton Manifest"] = 876,
    Winutil = 879,
    ["WireMock stub mapping"] = 1066,
    ["Woodpecker pipeline config"] = 916,
    ["Wrangler CLI"] = 831,
    ["Xstate Machine"] = 934,
    ["Yandex Workflow Language"] = 1055,
    ["Yarn Config (.yarnrc.yml)"] = 891,
    ["Yippee-Ki-JSON configuration YML"] = 883,
    ["YouTrack App"] = 1052,
    ["Zerops.io config"] = 1040,
    ["Zerops.io import"] = 1041,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 1004,
    ...
    ["behat.yml"] = 106,
    ["bigquery-table"] = 95,
    ["bioimageio resource description"] = 1021,
    ...
    ["crowdin.yml"] = 239,
    ["ctfd-setup configuration file"] = 1073,
    ["custom-elements.json"] = 991,
    ["cypress.json"] = 243,
    ...
    ["gematik health care insurance list"] = 1079,
    ["gematik health care patient list"] = 1076,
    ["gematik health care provider institution list"] = 1078,
    ["gematik health care provider list"] = 1077,
    ["gematik tiger test environment configuration"] = 1080,
    ["gitlab-ci"] = 345,
    ["global.json"] = 361,
    ...
    ["lint-staged (.lintstagedrc)"] = 847,
    ["local.settings.json"] = 466,
    ["localazy.json"] = 467,
    ["lotus.yaml"] = 465,
    ["lsdlschema.json"] = 468,
    ["markdown-link-check"] = 911,
    maturin = 912,
    mboats = 919,
    ["micro-settings.json"] = 983,
    ["mimetypes.json"] = 481,
    ["mirrord config"] = 848,
    mise = 849,
    ["mkdocs.yml"] = 501,
    ["monospace.yml"] = 504,
    ["moon.yml"] = 1065,
    ["mprocs Configuration file"] = 1036,
    ["mrdocs.yml"] = 502,
    ["mta.yaml"] = 850,
    ["mtad.yaml"] = 851,
    ["mycode.json"] = 511,
    ...
    ["plagiarize.yaml"] = 577,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1069,
    ["podbard.yaml"] = 580,
    ["portman.json"] = 581,
    ["prefect.toml"] = 589,
    ["prettierrc.json"] = 590,
    ...
    ["servicehub.config.json"] = 842,
    ["servicehub.service.json"] = 841,
    ["settings.job"] = 689,
    ...
    ["theme.json"] = 759,
    ["tizen_workspace.json"] = 761,
    tldr = 762,
    ["tm_devices configuration file"] = 1107,
    tmuxinator = 845,
    ["transcend.yml"] = 772,
    ["tree-sitter grammar.json"] = 369,
    ["trime.yaml"] = 773,
    ["trunk.yaml"] = 775,
    ["ts-force-config.json"] = 780,
    ["tsconfig.json"] = 776,
    ["tsd.json"] = 777,
    ["tsdoc.json"] = 778,
    ["tsdrc.json"] = 779,
    ...
    ["vega-lite.json"] = 804,
    ["vega.json"] = 803,
    ["venvironment-basic.yaml"] = 807,
    ["venvironment.yaml"] = 806,
    ["venvplus-basic.yaml"] = 809,
    ["venvplus.yaml"] = 808,
    version = 1089,
    ["version.json"] = 811,
    ["vhwdebugger-binding.yaml"] = 813,
    ["vim-addon-info"] = 814,
    ["vs-2017.3.host.json"] = 816,
    ["vs-nesting.json"] = 817,
    ["vsls.json"] = 815,
    ["vss-extension.json"] = 821,
    vtcfg = 1095,
    ["vtesttree.yaml"] = 822,
    ["vtestunit.yaml"] = 823,
    ["warp-keysets.json"] = 992,
    ["warp-themes.json"] = 993,
    ["warp-workflows.json"] = 994,
    ["webhint.io"] = 949,
    ["webjobpublishsettings.json"] = 828,
    ["webjobs-list.json"] = 827,
    ["well-known-fursona"] = 1031,
    ["xs-app.json"] = 854,
    ["xunit.runner.json"] = 840,
    yamllint = 882,
    zuul = 865,
    ["Žinoma"] = 875
  },
