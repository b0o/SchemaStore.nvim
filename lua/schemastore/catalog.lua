...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 759,
    [".nodehawkrc"] = 482,
    [".npmpackagejsonlintrc"] = 486,
    [".omletrc"] = 930,
    [".phrase.yml"] = 547,
    [".phraseapp.yml"] = 548,
    [".pmbot.yml"] = 535,
    [".postcssrc"] = 542,
    [".powerpages-web-template-manifest"] = 544,
    [".pre-commit-config.yml"] = 545,
    [".pre-commit-hooks.yml"] = 546,
    [".putout.json"] = 568,
    [".rehyperc"] = 587,
    [".remarkrc"] = 589,
    [".sprite files"] = 652,
    ...
    ["A micro editor config"] = 437,
    ABCInventoryModuleData = 13,
    ABCSupplyPlan = 14,
    AIConfig = 15,
    ["API Builder"] = 792,
    ["AVA Configuration"] = 852,
    ["AWS AppConfig Feature Flags-v1"] = 39,
    ["AWS CDK cdk.json"] = 193,
    ["AWS CloudFormation"] = 194,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 195,
    ["AWS SAM CLI Samconfig"] = 196,
    ["Adobe UXP Manifest"] = 912,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Alacritty Configuration"] = 824,
    ["All Contributors configuration file"] = 877,
    ["Ansible Argument Specs"] = 324,
    ["Ansible Collection Galaxy"] = 331,
    ["Ansible Execution Environment"] = 321,
    ["Ansible Inventory"] = 330,
    ["Ansible Meta"] = 322,
    ["Ansible Meta Runtime"] = 323,
    ["Ansible Navigator Configuration"] = 333,
    ["Ansible Playbook"] = 328,
    ["Ansible Requirements"] = 325,
    ["Ansible Rulebook"] = 329,
    ["Ansible Tasks File"] = 327,
    ["Ansible Vars File"] = 326,
    ["Ansible-lint Configuration"] = 332,
    Any = 939,
    ["AnyWork Automation Configuration"] = 5,
    ["App config Spotify Backstage"] = 20,
    ["Application Accelerator"] = 2,
    ["Application list for a WinUtil"] = 956,
    ArchitectFX = 960,
    ["Argo Events"] = 29,
    ["Argo Workflows"] = 30,
    AssemblyScript = 33,
    ...
    ["Azure Pipelines"] = 66,
    ["Azure Static Web Apps CLI configuration file"] = 655,
    ["Azure Static Web Apps configuration file"] = 654,
    ["BOSH Deploy Config"] = 90,
    ["BX CI"] = 107,
    ["Bashly (bashly.yml)"] = 881,
    ["Bashly Settings (bashly-settings.yml)"] = 882,
    ["Better Code Hub"] = 796,
    ["Better Scripts"] = 108,
    Bigconfig = 83,
    ["Biome Formatter Config"] = 53,
    ["Bitmovin Encoding Template"] = 966,
    BizTalkServerApplicationSchema = 765,
    Bleep = 109,
    ...
    ["Butane Config"] = 837,
    ["CGS Custom Card Game (CardGameDef.json)"] = 917,
    ["CICS TS region tagging"] = 846,
    ["CICS TS resource import"] = 847,
    ["CICS TS resource model"] = 848,
    ["CICS TS resource overrides"] = 849,
    ["CMake Presets"] = 110,
    ["CNC Codes"] = 125,
    ["CRS WAF test file"] = 946,
    ["CRS WAF test platform overrides file"] = 947,
    ["CSS Comb (.csscomb.json)"] = 220,
    ["CSS Lint (.csslintrc)"] = 221,
    ["CSpell (cspell.json)"] = 219,
    ...
    ["Chamaleon environment"] = 970,
    ["Chamaleon template"] = 969,
    Changesets = 205,
    Cheatsheets = 834,
    ["Chrome Extension"] = 186,
    ["Chromia Model"] = 119,
    ["CircleCI config.yml"] = 162,
    ["Citation File Format"] = 207,
    CityJSON = 121,
    ["Clawject config"] = 130,
    ["Cloud Foundry Application Manifest"] = 929,
    ["Cloud Run Spec v1"] = 951,
    ["CloudCannon Configuration"] = 62,
    ["CloudEvents specification"] = 122,
    ["Code Climate"] = 163,
    CodeCV = 60,
    CodeRabbit = 59,
    ["CodeShip Pro services configuration files"] = 175,
    ["CodeShip Pro steps configuration files"] = 176,
    ["Codecov configuration files"] = 174,
    CodifyCLI = 61,
    Codux = 172,
    ["Cog config file"] = 126,
    ["Commandbox Box.json"] = 127,
    ["Commandbox Server.json"] = 128,
    ["Common Catalog Data"] = 184,
    Concord = 945,
    ["Configu .cfgu files"] = 934,
    ["Configu .configu file"] = 935,
    Conjure = 124,
    ["Container Structure Test"] = 779,
    Containerlab = 804,
    ["Crowdsec collection config"] = 214,
    ["Crowdsec parser config"] = 215,
    ["Crowdsec scenario config"] = 216,
    ["CumulusCI Config"] = 129,
    ["Custom Machinery Machine"] = 918,
    ["Custom Machinery Recipe"] = 919,
    ["Cycle Stack File"] = 132,
    ["DWP Exchange - catalogue entry"] = 263,
    ["DWP Exchange - gateway"] = 261,
    ["DWP Exchange - meta"] = 262,
    ["Dart Build Config (dart-build.json)"] = 222,
    ["Dart Test Config (dart-test.json)"] = 223,
    ["DashLord Configuration"] = 224,
    ["Data Contract Specification"] = 225,
    ["Data Product Specification"] = 226,
    ["DataYoga Connections"] = 133,
    ["DataYoga Job"] = 134,
    ["Databricks Asset Bundles"] = 898,
    ["Datadog Service Definition"] = 410,
    ["Datadog Software Catalog"] = 411,
    ["Datahub Ingestion Recipe"] = 853,
    ["Dein Config"] = 140,
    ["Deno Config (deno.json)"] = 232,
    ["Dependency cruiser"] = 141,
    ["Deployer Recipe"] = 235,
    ["Deta Spacefile"] = 142,
    ["Detekt Config (detekt.yml)"] = 236,
    ["Devbox Config"] = 143,
    ["Devbox Plugin"] = 144,
    Devfile = 260,
    DipDup = 948,
    ["Discord Webhook"] = 237,
    ["DocFx Config (docfx.json)"] = 241,
    Dofigen = 242,
    ["Dolittle Artifacts"] = 243,
    ["Dolittle Bounded Context Configuration"] = 244,
    ["Dolittle Event Horizons Configuration"] = 245,
    ["Dolittle Resources Configuration"] = 246,
    ["Dolittle Server Configuration"] = 247,
    ["Dolittle Tenant Map Configuration"] = 249,
    ["Dolittle Tenants Configuration"] = 248,
    ["Dolittle Topology"] = 250,
    ["Drupal Breakpoints"] = 145,
    ["Drupal Config"] = 157,
    ["Drupal Info"] = 146,
    ["Drupal Layouts"] = 147,
    ["Drupal Libraries"] = 148,
    ["Drupal Links Action"] = 149,
    ["Drupal Links Contextual"] = 150,
    ["Drupal Links Menu"] = 151,
    ["Drupal Links Task"] = 152,
    ["Drupal Migration"] = 153,
    ["Drupal Permissions"] = 154,
    ["Drupal Recipe"] = 155,
    ["Drupal Routing"] = 156,
    ["Drupal Services"] = 158,
    ["Drush site aliases"] = 256,
    ["Dynamic Bash Aliases (.aliases)"] = 889,
    ["EAS config"] = 281,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 878,
    ["EasyVCR .NET"] = 282,
    ["Eidolon Resource"] = 961,
    ["Elgato Stream Deck"] = 266,
    Elm = 950,
    ["Embrace Config"] = 864,
    Endurica = 902,
    ["Enterprise Contract Policy Spec"] = 267,
    ["Erda Pipeline"] = 925,
    ["Erda Runtime"] = 926,
    ["Error pages"] = 271,
    Esquio = 269,
    ["Estuary Flow Catalog"] = 843,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 274,
    ["EveryVoice TTS Toolkit Data Configuration"] = 275,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 279,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 278,
    ["EveryVoice TTS Toolkit Text Configuration"] = 276,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 277,
    ["Expo SDK"] = 280,
    ["F-Droid Data metadata"] = 286,
    ["FasterCI Configuration"] = 67,
    FiQuS = 290,
    Firebase = 288,
    ["Flow.json Configurations"] = 922,
    ["Fossa configuration file"] = 297,
    ["Fossa's fossa-deps file"] = 298,
    ["Foundry VTT - Base package Manifest"] = 292,
    ["Foundry VTT - Module Manifest"] = 293,
    ["Foundry VTT - System Data Template"] = 296,
    ["Foundry VTT - System Manifest"] = 294,
    ["Foundry VTT - World Manifest"] = 295,
    ["Foxx Manifest"] = 68,
    ["Freifunk.de Community API"] = 71,
    ["Frogbot Config"] = 72,
    ["G2P Mapping Configuration"] = 303,
    ["GCP Blueprint Metadata"] = 306,
    Gaspar = 304,
    ["GatewayCore API Gateway"] = 305,
    ["GeoJSON.json latest"] = 841,
    GherKing = 845,
    ["GitHub Action"] = 311,
    ["GitHub Discussion"] = 312,
    ["GitHub Funding"] = 313,
    ["GitHub Issue Template configuration"] = 314,
    ["GitHub Issue Template forms"] = 315,
    ["GitHub Workflow"] = 316,
    ["GitHub Workflow Template Properties"] = 317,
    ["GitHub automatically generated release notes configuration"] = 318,
    ["GitLab Agent for Kubernetes configuration"] = 914,
    GitVersion = 308,
    ["Gitea Issue Template configuration"] = 309,
    ["Gitea Issue Template forms"] = 310,
    ["Gitpod Configuration"] = 320,
    ["GlazeWM settings"] = 916,
    ["Global Privacy Control"] = 307,
    Goblet = 897,
    ["Golangci-lint Configuration"] = 335,
    ["Golangci-lint Custom Plugins Configuration"] = 336,
    ["Google Chrome Related Website Sets"] = 289,
    ["Google Cloud Workflows"] = 192,
    Goreleaser = 338,
    ["Goreleaser Pro"] = 339,
    Goss = 340,
    ["Gradle Build Cache Node"] = 794,
    ["Gradle Enterprise"] = 793,
    ["Grafana 5.x Dashboard"] = 341,
    ["GraphQL Code Generator"] = 345,
    ["GraphQL Config"] = 344,
    ["GraphQL Mesh"] = 343,
    ["Grunt JSHint task"] = 349,
    ["Grunt Watch task"] = 350,
    ["Grunt base task"] = 351,
    ["Grunt clean task"] = 347,
    ["Grunt copy task"] = 346,
    ["Grunt cssmin task"] = 348,
    HEMTT = 762,
    Hadolint = 775,
    Hammerkit = 803,
    ["Hardware Sentry Configuration"] = 857,
    Hatch = 776,
    Hayson = 353,
    ["Haystack Pipeline"] = 354,
    ["Hazelcast 5 Configuration"] = 355,
    ["Helm Chart.lock"] = 160,
    ["Helm Chart.yaml"] = 159,
    ["Helm Unittest Test Suite"] = 161,
    Hugo = 833,
    ["Hugo Theme"] = 832,
    ["Hyperfoil benchmark configuration"] = 361,
    ["IBM Zapp document"] = 362,
    ["IBM zCodeFormatSettings"] = 363,
    ["IMG Catapult PSP"] = 368,
    ["IVMS101 by CODE Protocol"] = 915,
    Infrahub = 370,
    Istanbul = 860,
    ["JDownloader2 crawler multi-rules"] = 380,
    ["JDownloader2 crawler single-rules"] = 379,
    ["JFrog Applications Config"] = 381,
    ["JFrog File Spec"] = 382,
    ["JFrog Pipelines YML DSL"] = 866,
    ["JMeter DSL cli config"] = 383,
    JReleaser = 385,
    ["JSON Document Transform"] = 393,
    ["JSON Feed"] = 394,
    ["JSON Resume"] = 594,
    ["JSON Schema Draft 2020-12"] = 745,
    ["JSON Schema Draft 4"] = 742,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 899,
    ["JSON Schema Draft 7"] = 743,
    ["JSON Schema Draft 7 (unofficial strict)"] = 900,
    ["JSON Schema Draft 8 (2019-09)"] = 744,
    ["JSON-API"] = 392,
    ["JSON-WF"] = 928,
    ["JSON-e templates"] = 801,
    ["JSON-stat 2.0"] = 738,
    JSONPatch = 396,
    ["JSR Package Config (jsr.json)"] = 386,
    Jasmine = 374,
    Jekyll = 375,
    ["Jenkins X Pipelines"] = 376,
    ["Jenkins X Requirements"] = 377,
    Jest = 378,
    ["Jovo Language Models"] = 384,
    ["KIMMDY config file"] = 407,
    ["KSP-AVC"] = 739,
    ["KSP-CKAN"] = 740,
    ["KSP-NetKAN"] = 741,
    KSY = 927,
    KSail = 301,
    ["Karakum configuration file"] = 299,
    Kas = 399,
    ["Kestra flow file"] = 408,
    ["Keycloak REST API"] = 869,
    ["Knative Functions - func.yaml"] = 300,
    ["KoDE/CI build.yaml"] = 862,
    ["Kong DBLess config"] = 863,
    KrakenD = 409,
    ["Kubri Configuration"] = 415,
    LOOBin = 430,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 197,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 198,
    ["Landing Zone Accelerator on AWS - Global Config"] = 199,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 200,
    ["Landing Zone Accelerator on AWS - Network Config"] = 201,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 202,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 203,
    ["Landing Zone Accelerator on AWS - Security Config"] = 204,
    ["Language configuration"] = 938,
    Lefthook = 419,
    ["Liferay client-extension.yaml"] = 426,
    ["LinkML Metamodel"] = 428,
    Liquibase = 809,
    ["Liquibase Flow File"] = 810,
    ["Lively Properties"] = 429,
    ["Lobe AI Agent"] = 64,
    Loki = 65,
    ["MLOS Configs"] = 466,
    ["MS2Rescore Configuration"] = 469,
    ["Madness (madness.yml)"] = 880,
    ["MapEHR Mapping"] = 436,
    Markdownlint = 813,
    ["Mason Registry"] = 815,
    ["MegaLinter configuration"] = 438,
    ["MegaLinter descriptor"] = 439,
    Melange = 906,
    ["Meltano project definition"] = 440,
    ["Mergify Configuration"] = 470,
    ["Metadata for a Bazel module"] = 441,
    ["Metadata for a Cinnamon spice"] = 954,
    ["MetricsHub Configuration"] = 442,
    ["MetricsHub Connector Configuration"] = 443,
    ["Micro Editor Syntax"] = 890,
    ["Microsoft Band Web Tile"] = 444,
    ["Microsoft RulesEngine workflow rules"] = 942,
    ["Microsoft RulesEngine workflow rules list"] = 943,
    ["Minecraft Custom Main Menu Mod"] = 907,
    ["Minecraft Data Pack Advancement"] = 446,
    ["Minecraft Data Pack Biome"] = 447,
    ["Minecraft Data Pack Configured Carver"] = 448,
    ["Minecraft Data Pack Damage Type"] = 449,
    ["Minecraft Data Pack Dimension"] = 451,
    ["Minecraft Data Pack Dimension Type"] = 450,
    ["Minecraft Data Pack Item Modifier"] = 452,
    ["Minecraft Data Pack Loot Table"] = 453,
    ["Minecraft Data Pack Metadata"] = 454,
    ["Minecraft Data Pack Predicate"] = 455,
    ["Minecraft Data Pack Recipe"] = 456,
    ["Minecraft Data Pack Tag"] = 457,
    ["Minecraft Data Pack Template Pool"] = 458,
    ["Minecraft Data Pack Trim Material"] = 463,
    ["Minecraft Data Pack Trim Pattern"] = 464,
    ["Minecraft Resource Pack Lang"] = 459,
    ["Minecraft Resource Pack Particle"] = 460,
    ["Minecraft Resource Pack Texture Mcmeta"] = 462,
    ["Minecraft Resourcepack Sounds"] = 461,
    ["Monade CLI Stack Configuration"] = 473,
    ["MongoDB Atlas Search Index Definition"] = 861,
    ["Monika Configuration"] = 859,
    ["Monoweave Configuration"] = 468,
    ["Motif config"] = 758,
    ["NOX Framework (Service)"] = 485,
    ["Netin Diagnostic System Template"] = 819,
    ["Netlify config"] = 476,
    ["Network-as-Code Data Model"] = 477,
    ["Nightwatch.js"] = 478,
    ["NueJS configuration file"] = 490,
    ["Nuitka.yaml"] = 920,
    ["Nullstone config"] = 492,
    ["ONe's changelog entry"] = 506,
    ["ONe's service descriptor"] = 505,
    ["OSCAL Assessment Plan (AP)"] = 514,
    ["OSCAL Assessment Results (AR)"] = 515,
    ["OSCAL Catalog"] = 516,
    ["OSCAL Component Definition (CDef)"] = 517,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 518,
    ["OSCAL Profile"] = 519,
    ["OSCAL System Security Plan (SSP)"] = 520,
    ["OSS Review Toolkit configuration"] = 521,
    ["OSS Review Toolkit curation"] = 522,
    ["OSS Review Toolkit package configuration"] = 523,
    ["OSS Review Toolkit repository configuration"] = 524,
    ["OSS Review Toolkit resolutions"] = 525,
    ["October CMS columns"] = 496,
    ["October CMS fields"] = 497,
    Okteto = 498,
    Opctl = 761,
    ["Open Data Contract Standard (ODCS)"] = 509,
    ["OpenRewrite Resource"] = 508,
    ["OpenUtau character yaml"] = 502,
    ["OpenUtau ustx"] = 503,
    ["OpenWeather Current Weather API"] = 800,
    ["OpenWeather Road Risk API"] = 799,
    ["Ory Hydra configuration"] = 360,
    ["Ory Keto configuration"] = 412,
    ["Ory Kratos configuration"] = 513,
    ["Ory Oathkeeper configuration"] = 494,
    ["Outblocks App configuration"] = 511,
    ["Outblocks database table"] = 512,
    ["Outblocks project configuration"] = 510,
    PDM = 531,
    Packer = 528,
    Pantsbuild = 876,
    ["Paper paper-plugin.yml"] = 529,
    ["Pipeline component"] = 811,
    ["Plex Prerolls"] = 539,
    ["PocketMine plugin.yml"] = 536,
    ["Postman collection"] = 543,
    ["Preset list for a WinUtil"] = 957,
    ["Problem object RFC9457"] = 904,
    ["Problem package generators"] = 552,
    Pterodactyl = 856,
    ["Pull Request Labeler"] = 567,
    Pulumi = 573,
    PyProject = 574,
    Pyright = 575,
    Qgoda = 576,
    Qodana = 829,
    ["Qt Creator workspace file"] = 936,
    ["Quali Torque Blueprint Spec 2"] = 854,
    ["QueryFirst config file"] = 872,
    ["RKE Cluster Configuration JSON"] = 808,
    ["RKE Cluster Configuration YAML"] = 807,
    ["Rancher Fleet"] = 570,
    ["Rattler-build"] = 577,
    Ray = 774,
    ["Read the Docs"] = 572,
    ["Red-DiscordBot Cog"] = 584,
    ["Red-DiscordBot Cog Repo"] = 585,
    ["Red-DiscordBot Trivia"] = 586,
    ["Render Blueprints"] = 806,
    RenderCV = 596,
    Renovate = 595,
    ["Replit config"] = 590,
    RoadRunner = 598,
    ["Rudder techniques"] = 910,
    Ruff = 592,
    ["Rust Project"] = 593,
    ["Rust toolchain"] = 602,
    ["SDMX data message"] = 627,
    ["SDMX metadata message"] = 626,
    ["SDMX structure message"] = 625,
    ["SIL Kit Participant Configuration"] = 637,
    ["SIL Kit Registry Configuration"] = 638,
    SWADL = 666,
    ["Safebox Config"] = 867,
    ["Sapphire CLI Config"] = 605,
    ["SauceCTL Configuration"] = 816,
    ["Schema Catalog"] = 619,
    ["Scoop manifest"] = 624,
    ["Semantic Data Fabric (SDF) file"] = 628,
    ["Semgrep Rule"] = 630,
    ["Serenity Code Generator (Sergen)"] = 631,
    ["Serverless Framework Configuration"] = 823,
    ["Serverless Workflow"] = 825,
    ["Settings for a Cinnamon spice"] = 953,
    ["Settings.paf"] = 633,
    ["Shopware 6 Configuration"] = 826,
    ["Shopware CLI Extension Store Configuration"] = 827,
    ["Shopware CLI Project Store Configuration"] = 828,
    ["Sigma Detection Rule"] = 635,
    ["Sigrid scope configuration file"] = 636,
    ["SkyPilot Task JSON"] = 911,
    ["Slack app manifest"] = 640,
    Solidarity = 643,
    ["Solution filters"] = 644,
    ["Source Maps v3"] = 645,
    Sourcery = 646,
    ["Speakeasy Lint Configuration File"] = 647,
    ["Speakeasy Test Generation Configuration File"] = 648,
    ["Speakeasy Workflow File"] = 649,
    SpecIF = 650,
    ["Sponge Mixin configuration"] = 651,
    StackBlitz = 656,
    ["StackHawk Scanner Configuration"] = 822,
    Stale = 657,
    ["Starlake Data Pipeline"] = 797,
    Starship = 658,
    ["Statamic Blueprint"] = 659,
    ["Stella configuration file"] = 660,
    ["Stryker Mutator"] = 663,
    ["StyleCop Analyzers Configuration"] = 664,
    ["Stylelint (.stylelintrc)"] = 665,
    ["Sublime Syntax"] = 868,
    ["Subsquid squid manifest"] = 913,
    ["Swagger API 2.0"] = 667,
    TSON = 696,
    TSTyche = 697,
    ["Tab data for a LinUtil"] = 959,
    ["Tab list for a LinUtil"] = 958,
    Talhelper = 669,
    ["Talisman configuration"] = 670,
    ["Taskfile config"] = 802,
    Taurus = 671,
    Tauticord = 672,
    ["TestEnvironment.json"] = 681,
    ["TextMate Grammar"] = 680,
    ["Tier.run pricing.json"] = 675,
    Tikibase = 676,
    ["Traefik v2"] = 684,
    ["Traefik v2 File Provider"] = 685,
    ["Travis CI (.travis.yml)"] = 683,
    ["TrueScript for *.tscript files"] = 688,
    TunnelHub = 903,
    Turborepo = 682,
    Tycho = 949,
    Tye = 830,
    ["UET BuildConfig.json"] = 873,
    ["UI5 Manifest"] = 706,
    ["UNCORS configuration"] = 710,
    ["UTAM Page Object"] = 709,
    ["Ubuntu Server Autoinstall"] = 704,
    ["Uniswap Token List"] = 785,
    ["Unreal Engine Uplugin"] = 874,
    ["Unreal Engine Uproject"] = 875,
    ["Updatecli Compose"] = 838,
    ["Updatecli Policy Manifest"] = 839,
    ["Updatecli Policy Metadata"] = 840,
    Uplift = 871,
    ["User Journey Map"] = 805,
    V2Ray = 844,
    ["VSCode Code Snippets"] = 180,
    ["VSIX CLI publishing"] = 727,
    ["Vela Pipeline Configuration"] = 714,
    Vercel = 179,
    ["Version Bumper config"] = 717,
    Visivo = 901,
    ["Waku Config"] = 962,
    ["Web App Manifest"] = 733,
    ["Web types"] = 736,
    WebExtensions = 732,
    ["Webman package recipe"] = 850,
    ["Windows Package Manager Installer Manifest"] = 782,
    ["Windows Package Manager Locale Manifest"] = 783,
    ["Windows Package Manager Singleton Manifest"] = 781,
    ["WireMock stub mapping"] = 965,
    ["Woodpecker pipeline config"] = 818,
    ["Wrangler CLI"] = 737,
    ["Xstate Machine"] = 836,
    ["Yandex Workflow Language"] = 955,
    ["Yarn Config (.yarnrc.yml)"] = 795,
    ["Yippee-Ki-JSON configuration YML"] = 787,
    ["YouTrack App"] = 952,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 905,
    ...
    ["behat.yml"] = 92,
    ["bigquery-table"] = 82,
    ["bioimageio resource description"] = 921,
    ...
    ["ccmod.json"] = 963,
    changelogging = 933,
    ["chisel-slices.json"] = 206,
    ["chrome-extension-locales-messages.json"] = 187,
    ["chutzpah.json"] = 188,
    cibuildwheel = 120,
    ["clang-format (.clang-format)"] = 842,
    ["clang-tidy"] = 167,
    clangd = 166,
    clib = 168,
    ["cloud-init: cloud-config userdata"] = 170,
    ["cloud-sdk-pipeline-configuration"] = 190,
    ["cloudbuild.json"] = 191,
    cloudify = 169,
    codemagic = 171,
    ["coffeelint.json"] = 208,
    ["commands.json"] = 183,
    ["commitlint (.commitlintrc)"] = 784,
    ["compile_commands.json"] = 182,
    ["compilerconfig.json"] = 181,
    ["completely.yml"] = 879,
    ["component-detection-manifest.json"] = 211,
    ["component.json"] = 210,
    ["composer.json"] = 209,
    ["conda-forge"] = 123,
    ["config.yaml"] = 571,
    ["contentmanifest.json"] = 189,
    ["contribute.json"] = 212,
    ["cosmos.config.json"] = 185,
    ["crowdin.yml"] = 213,
    ["ctfd-setup configuration file"] = 971,
    ["custom-elements.json"] = 893,
    ["cypress.json"] = 217,
    ["datalogic-scan2deploy-android"] = 227,
    ["datalogic-scan2deploy-ce"] = 228,
    ["dbt Dependencies"] = 135,
    ["dbt Packages"] = 137,
    ["dbt Project"] = 136,
    ["dbt Selectors"] = 138,
    ["dbt YAML files"] = 139,
    ["ddev-global"] = 229,
    ["ddev-project"] = 230,
    ["debugsettings.json"] = 231,
    ["dependabot-v2.json"] = 234,
    ["dependabot.json"] = 233,
    ["deployed-cli"] = 835,
    ["devcontainer.json"] = 173,
    devinit = 789,
    ["devspace.yaml"] = 858,
    djlint = 790,
    ["docker bake"] = 239,
    ["docker sequencer"] = 240,
    ["docker-compose.yml"] = 788,
    ["dockerd.json"] = 238,
    ["dotnet Release Index manifest"] = 251,
    ["dotnet-tools.json"] = 252,
    ["dotnetcli.host.json"] = 253,
    ["dprint.json"] = 254,
    ["drone.json"] = 255,
    ["dss-2.0.0.json"] = 257,
    ["dstack configuration"] = 258,
    ["dtool dataset metadata"] = 967,
    ["dvc.yaml"] = 259,
    ["ecosystem.json"] = 264,
    eksctl = 265,
    ["electron-builder configuration file"] = 272,
    ["epr-manifest.json"] = 270,
    ["evcc.yaml"] = 273,
    ["ezd task runner"] = 283,
    ["fabric.mod.json"] = 285,
    ["first-timers-bot"] = 291,
    ...
    ["gitlab-ci"] = 319,
    ["global.json"] = 334,
    ["go-feature-flag Flag Configuration"] = 337,
    ["haxelib.json"] = 352,
    helmfile = 777,
    helmwave = 778,
    ["host-meta.json"] = 357,
    ...
    ["ide.host.json"] = 364,
    ["ifstate.conf"] = 365,
    ["imageoptimizer.json"] = 366,
    ["importmap.json"] = 369,
    ["ioBroker Configuration"] = 371,
    ["ioBroker JSON UI"] = 372,
    ["ioBroker Package manifest"] = 373,
    ["ize.toml"] = 870,
    ["jsconfig.json"] = 397,
    ["jscpd Configuration"] = 855,
    jsdoc = 773,
    ["k3d.yaml"] = 398,
    ["k9s aliases.yaml"] = 400,
    ["k9s cluster-config.yaml"] = 402,
    ["k9s config.yaml"] = 401,
    ["k9s hotkeys.yaml"] = 403,
    ["k9s plugins.yaml"] = 404,
    ["k9s skin.yaml"] = 405,
    ["k9s views.yaml"] = 406,
    ["kontinuous-config.yaml"] = 414,
    ["kontinuous-values.yaml"] = 413,
    ["kustomization.yaml"] = 416,
    ["label-commenter-config.yml"] = 417,
    ["latexindent configuration"] = 63,
    ["launchsettings.json"] = 418,
    lazydocker = 892,
    lazygit = 891,
    ["lego.json"] = 420,
    ["lerna.json"] = 421,
    ["lgtm.yml"] = 422,
    ["liblab.config.json"] = 423,
    ["libman.json"] = 424,
    ["license-report-config.json"] = 425,
    ["linkinator.config.json"] = 427,
    ["lint-staged (.lintstagedrc)"] = 753,
    ["local.settings.json"] = 432,
    ["localazy.json"] = 433,
    ["lotus.yaml"] = 431,
    ["lsdlschema.json"] = 434,
    ["markdown-link-check"] = 814,
    mboats = 821,
    ["micro-settings.json"] = 885,
    ["mimetypes.json"] = 445,
    ["mirrord config"] = 754,
    mise = 755,
    ["mkdocs.yml"] = 465,
    ["monospace.yml"] = 467,
    ["moon.yml"] = 964,
    ["mprocs Configuration file"] = 937,
    ["mta.yaml"] = 756,
    ["mtad.yaml"] = 757,
    ["mycode.json"] = 474,
    ["napari plugin manifest"] = 475,
    neoload = 768,
    ["nest-cli"] = 480,
    ["ninjs (News in JSON)"] = 479,
    ["nitro.json"] = 767,
    ["nixd configuration"] = 909,
    ["nlu.json"] = 481,
    ["nodemon.json"] = 483,
    ["noodl config"] = 820,
    ["notebook.mod.json"] = 484,
    now = 763,
    ["npm-badges"] = 487,
    ["nswag.json"] = 491,
    ntangle = 493,
    ["nuclei-template.yaml"] = 488,
    ["nuget-project.json"] = 489,
    ["ocelot.json"] = 495,
    ["omnisharp.json"] = 499,
    ["openapi.json"] = 500,
    ["openfin.json"] = 507,
    ...
    ["ops.yaml"] = 504,
    ["package.json"] = 526,
    ["package.manifest"] = 527,
    ["partial-black.json"] = 93,
    ["pathfinder.yml"] = 530,
    ["pattern.json"] = 533,
    ["petstore-v1.0"] = 865,
    pgap_yaml_input_reader = 532,
    ["pixi.toml"] = 534,
    ["plagiarize-me.yaml"] = 538,
    ["plagiarize.yaml"] = 537,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 968,
    ["podbard.yaml"] = 540,
    ["portman.json"] = 541,
    ["prefect.toml"] = 549,
    ["prettierrc.json"] = 550,
    ["prisma.yml"] = 551,
    ["project-1.0.0-beta3.json"] = 554,
    ["project-1.0.0-beta4.json"] = 555,
    ["project-1.0.0-beta5.json"] = 556,
    ["project-1.0.0-beta6.json"] = 557,
    ["project-1.0.0-beta8.json"] = 558,
    ["project-1.0.0-rc1.json"] = 559,
    ["project-1.0.0-rc2.json"] = 560,
    ["project.json"] = 553,
    ["prometheus.json"] = 561,
    ["prometheus.rules.json"] = 562,
    ["prometheus.rules.test.json"] = 563,
    ["proxies.json"] = 564,
    ["publiccode.yml"] = 565,
    ["pubspec.yaml"] = 566,
    ["pyrseas-0.8.json"] = 569,
    ["quilt.mod.json"] = 886,
    ["rc3 auth"] = 578,
    ["rc3 collection"] = 579,
    ["rc3 environment"] = 580,
    ...
    samt = 603,
    samtrc = 604,
    ["sarif-1.0.0.json"] = 606,
    ["sarif-2.0.0.json"] = 607,
    ["sarif-2.1.0"] = 617,
    ["sarif-2.1.0-rtm.2"] = 608,
    ["sarif-2.1.0-rtm.3"] = 610,
    ["sarif-2.1.0-rtm.4"] = 612,
    ["sarif-2.1.0-rtm.5"] = 614,
    ["sarif-2.1.0-rtm.6"] = 615,
    ["sarif-external-property-file-2.1.0"] = 618,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 609,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 611,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 613,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 616,
    ["schema.org - Action"] = 620,
    ["schema.org - ContactPoint"] = 621,
    ["schema.org - Place"] = 622,
    ["schema.org - Thing"] = 623,
    ["secrethub.yml"] = 888,
    ["semantic-release"] = 629,
    ["servicehub.config.json"] = 748,
    ["servicehub.service.json"] = 747,
    ["settings.job"] = 632,
    ["sfdx-hardis configuration"] = 634,
    ["shard.yml"] = 924,
    ["size-limit configuration"] = 639,
    ["skaffold.yaml"] = 812,
    ["skyuxconfig.json"] = 641,
    snapcraft = 642,
    ["spicepod.yaml"] = 944,
    ["sqlc configuration"] = 653,
    ["stripe-app-local.json"] = 662,
    ["stripe-app.json"] = 661,
    swcrc = 798,
    ["task.json"] = 668,
    taskcat = 764,
    ["template.json"] = 673,
    ["templatsources.json"] = 674,
    ["theme.json"] = 677,
    ["tizen_workspace.json"] = 678,
    tldr = 679,
    tmuxinator = 751,
    ["transcend.yml"] = 686,
    ["tree-sitter grammar.json"] = 342,
    ["trime.yaml"] = 687,
    ["trunk.yaml"] = 689,
    ["ts-force-config.json"] = 694,
    ["tsconfig.json"] = 690,
    ["tsd.json"] = 691,
    ["tsdoc.json"] = 692,
    ["tsdrc.json"] = 693,
    ...
    v8r = 731,
    vcluster = 931,
    ["vcpkg configuration file"] = 178,
    ["vcpkg manifest file"] = 177,
    ["vega-lite.json"] = 713,
    ["vega.json"] = 712,
    ["venvironment-basic.yaml"] = 716,
    ["venvironment.yaml"] = 715,
    ["version.json"] = 718,
    ["vhwdebugger-binding.yaml"] = 720,
    ["vim-addon-info"] = 721,
    ["vs-2017.3.host.json"] = 723,
    ["vs-nesting.json"] = 724,
    ["vsls.json"] = 722,
    ["vss-extension.json"] = 728,
    ["vtesttree.yaml"] = 729,
    ["vtestunit.yaml"] = 730,
    ["warp-keysets.json"] = 894,
    ["warp-themes.json"] = 895,
    ["warp-workflows.json"] = 896,
    ["webhint.io"] = 851,
    ["webjobpublishsettings.json"] = 735,
    ["webjobs-list.json"] = 734,
    ["well-known-fursona"] = 932,
    ["xs-app.json"] = 760,
    ["xunit.runner.json"] = 746,
    yamllint = 786,
    ["zerops.io import file"] = 941,
    ["zerops.yml"] = 940,
    zuul = 770,
    ["Žinoma"] = 780
  },
