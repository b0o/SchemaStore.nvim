...
M.json = {
  ...
  index = {
    ...
    ["Adobe UXP Manifest"] = 802,
    ["Aerleon Network & Service Definitions"] = 7,
    ["Aerleon Policy"] = 8,
    ["Airlock Microgateway"] = 12,
    ["Airplane task"] = 13,
    ["Alacritty Configuration"] = 709,
    ["All Contributors configuration file"] = 767,
    ...
    ["BX CI"] = 102,
    ["Bashly (bashly.yml)"] = 771,
    ["Bashly Settings (bashly-settings.yml)"] = 772,
    ["Better Code Hub"] = 682,
    ["Better Scripts"] = 103,
    Bigconfig = 81,
    ...
    ["Butane Config"] = 722,
    ["CICS TS region tagging"] = 731,
    ["CICS TS resource import"] = 732,
    ["CICS TS resource model"] = 733,
    ["CICS TS resource overrides"] = 734,
    ["CMake Presets"] = 105,
    ["CNC Codes"] = 116,
    ...
    ["Databricks Asset Bundles"] = 788,
    ["Datadog Service Definition"] = 341,
    ["Datahub Ingestion Recipe"] = 738,
    ["Dein Config"] = 122,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 779,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 768,
    ["Elgato Stream Deck"] = 234,
    ["Embrace Config"] = 749,
    Endurica = 792,
    ["Error pages"] = 238,
    Esquio = 236,
    ["Estuary Flow Catalog"] = 728,
    ["Expo SDK"] = 241,
    ...
    Hadolint = 661,
    Hammerkit = 689,
    ["Hardware Sentry Configuration"] = 742,
    Hatch = 662,
    Hayson = 296,
    ...
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 789,
    ...
    Kas = 337,
    ["Keycloak REST API"] = 759,
    ["Knative Functions - func.yaml"] = 260,
    ["KoDE/CI build.yaml"] = 747,
    ["Kong DBLess config"] = 748,
    KrakenD = 340,
    LOOBin = 359,
    Lefthook = 348,
    ...
    ["MongoDB Atlas Search Index Definition"] = 746,
    ["Monika Configuration"] = 744,
    ["Motif config"] = 645,
    ...
    Qgoda = 480,
    Qodana = 714,
    ["Quali Torque Blueprint Spec 2"] = 739,
    ["QueryFirst config file"] = 762,
    ...
    SWADL = 555,
    ["Safebox Config"] = 752,
    ["Sapphire CLI Config"] = 500,
    ["SauceCTL Configuration"] = 701,
    ["Schema Catalog"] = 514,
    ["Scoop manifest"] = 519,
    ["Semantic Data Fabric (SDF) file"] = 520,
    ["Semgrep Rule"] = 522,
    ["Serenity Code Generator (Sergen)"] = 523,
    ["Serverless Framework Configuration"] = 708,
    ["Serverless Workflow"] = 710,
    ["Settings.paf"] = 525,
    ["Shopware 6 Configuration"] = 711,
    ["Shopware CLI Extension Store Configuration"] = 712,
    ["Shopware CLI Project Store Configuration"] = 713,
    Sigma = 527,
    ...
    StackBlitz = 545,
    ["StackHawk Scanner Configuration"] = 707,
    Stale = 546,
    ["Starlake Data Pipeline"] = 683,
    Starship = 547,
    ["Statamic Blueprint"] = 548,
    ["Stella configuration file"] = 549,
    ["StrmPrivacy Data Connector"] = 756,
    ["StrmPrivacy Data Contract"] = 757,
    ["StrmPrivacy SimpleSchema"] = 754,
    ["StrmPrivacy Stream"] = 755,
    ["StrmPrivacy batch job configuration file"] = 753,
    ["Stryker Mutator"] = 552,
    ["StyleCop Analyzers Configuration"] = 553,
    ["Stylelint (.stylelintrc)"] = 554,
    ["Sublime Syntax"] = 758,
    ["Subsquid squid manifest"] = 803,
    ["Swagger API 2.0"] = 556,
    TSON = 581,
    TSTyche = 582,
    Talhelper = 558,
    ...
    ["Travis CI (.travis.yml)"] = 571,
    TunnelHub = 793,
    Turborepo = 570,
    Tye = 715,
    ["UET BuildConfig.json"] = 763,
    ["UI5 Manifest"] = 591,
    ["UNCORS configuration"] = 595,
    ["UTAM Page Object"] = 594,
    ["Ubuntu Server Autoinstall"] = 589,
    ["Uniswap Token List"] = 671,
    ["Unreal Engine Uplugin"] = 764,
    ["Unreal Engine Uproject"] = 765,
    ["Updatecli Compose"] = 723,
    ["Updatecli Policy Manifest"] = 724,
    ["Updatecli Policy Metadata"] = 725,
    Uplift = 761,
    ...
    samt = 498,
    samtrc = 499,
    ["sarif-1.0.0.json"] = 501,
    ["sarif-2.0.0.json"] = 502,
    ["sarif-2.1.0"] = 512,
    ["sarif-2.1.0-rtm.2"] = 503,
    ["sarif-2.1.0-rtm.3"] = 505,
    ["sarif-2.1.0-rtm.4"] = 507,
    ["sarif-2.1.0-rtm.5"] = 509,
    ["sarif-2.1.0-rtm.6"] = 510,
    ["sarif-external-property-file-2.1.0"] = 513,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 504,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 506,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 508,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 511,
    ["schema.org - Action"] = 515,
    ["schema.org - ContactPoint"] = 516,
    ["schema.org - Place"] = 517,
    ["schema.org - Thing"] = 518,
    ["secrethub.yml"] = 778,
    ["semantic-release"] = 521,
    ...
    ["vtesttree.yaml"] = 610,
    ["vtestunit.yaml"] = 611,
    ["warp-keysets.json"] = 784,
    ["warp-themes.json"] = 785,
    ["warp-workflows.json"] = 786,
    ["webhint.io"] = 736,
