...
M.json = {
  ...
  index = {
    ...
    ["<div>RIOTS' studio configuration"] = 619,
    ["@factorial/drupal-breakpoints-css"] = 4,
    ["A micro editor config"] = 366,
    AIConfig = 11,
    ["API Builder"] = 684,
    ["AVA Configuration"] = 743,
    ["AWS CDK cdk.json"] = 174,
    ["AWS CloudFormation"] = 175,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 176,
    ["AWS SAM CLI Samconfig"] = 177,
    ["Adobe UXP Manifest"] = 808,
    ...
    ["BX CI"] = 102,
    ["Bashly (bashly.yml)"] = 777,
    ["Bashly Settings (bashly-settings.yml)"] = 778,
    ["Better Code Hub"] = 688,
    ["Better Scripts"] = 103,
    Bigconfig = 81,
    ...
    ["Butane Config"] = 728,
    ["CGS Custom Card Game (CardGameDef.json)"] = 813,
    ...
    ["CMake Presets"] = 105,
    ["CNC Codes"] = 116,
    ["CSS Comb (.csscomb.json)"] = 192,
    ["CSS Lint (.csslintrc)"] = 193,
    ["CSpell (cspell.json)"] = 191,
    ...
    Cheatsheets = 725,
    ["Chrome Extension"] = 167,
    ["Chromia Model"] = 112,
    ["CircleCI config.yml"] = 144,
    ["Citation File Format"] = 179,
    CityJSON = 114,
    ["Code Climate"] = 145,
    CodeCV = 61,
    ["CodeShip Pro services configuration files"] = 156,
    ["CodeShip Pro steps configuration files"] = 157,
    ["Codecov configuration files"] = 155,
    Codux = 153,
    ["Cog config file"] = 117,
    ["Commandbox Box.json"] = 118,
    ["Commandbox Server.json"] = 119,
    ["Common Catalog Data"] = 165,
    Conjure = 115,
    ["Container Structure Test"] = 671,
    Containerlab = 696,
    ["Crowdsec collection config"] = 186,
    ["Crowdsec parser config"] = 187,
    ["Crowdsec scenario config"] = 188,
    ["CumulusCI Config"] = 120,
    ["Custom Machinery Machine"] = 814,
    ["Custom Machinery Recipe"] = 815,
    ["DWP Exchange - catalogue entry"] = 232,
    ["DWP Exchange - gateway"] = 230,
    ["DWP Exchange - meta"] = 231,
    ["Dart Build Config (dart-build.json)"] = 194,
    ["Dart Test Config (dart-test.json)"] = 195,
    ["DashLord Configuration"] = 196,
    ["Data Contract Specification"] = 197,
    ["DataYoga Job"] = 121,
    ["Databricks Asset Bundles"] = 794,
    ["Datadog Service Definition"] = 343,
    ["Datahub Ingestion Recipe"] = 744,
    ["Dein Config"] = 123,
    ["Deno Config (deno.json)"] = 203,
    ["Dependency cruiser"] = 124,
    ["Deployer Recipe"] = 206,
    ["Deta Spacefile"] = 125,
    ["Detekt Config (detekt.yml)"] = 207,
    ["Devbox Config"] = 126,
    ["Devbox Plugin"] = 127,
    Devfile = 229,
    ["Discord Webhook"] = 208,
    ["DocFx Config (docfx.json)"] = 211,
    ["Dolittle Artifacts"] = 212,
    ["Dolittle Bounded Context Configuration"] = 213,
    ["Dolittle Event Horizons Configuration"] = 214,
    ["Dolittle Resources Configuration"] = 215,
    ["Dolittle Server Configuration"] = 216,
    ["Dolittle Tenant Map Configuration"] = 218,
    ["Dolittle Tenants Configuration"] = 217,
    ["Dolittle Topology"] = 219,
    ["Drupal Breakpoints"] = 128,
    ["Drupal Config"] = 139,
    ["Drupal Info"] = 129,
    ["Drupal Layouts"] = 130,
    ["Drupal Libraries"] = 131,
    ["Drupal Links Action"] = 132,
    ["Drupal Links Contextual"] = 133,
    ["Drupal Links Menu"] = 134,
    ["Drupal Links Task"] = 135,
    ["Drupal Migration"] = 136,
    ["Drupal Permissions"] = 137,
    ["Drupal Routing"] = 138,
    ["Drupal Services"] = 140,
    ["Drush site aliases"] = 225,
    ["Dynamic Bash Aliases (.aliases)"] = 785,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 774,
    ["Elgato Stream Deck"] = 235,
    ["Embrace Config"] = 755,
    Endurica = 798,
    ["Enterprise Contract Policy Spec"] = 236,
    ["Error pages"] = 240,
    Esquio = 238,
    ["Estuary Flow Catalog"] = 734,
    ["Expo SDK"] = 243,
    ["F-Droid Data metadata"] = 248,
    ["Facets - FSDL - Application"] = 246,
    ["FasterCI Configuration"] = 65,
    FiQuS = 252,
    Firebase = 250,
    ["Fossa configuration file"] = 259,
    ["Fossa's fossa-deps file"] = 260,
    ["Foundry VTT - Base package Manifest"] = 254,
    ["Foundry VTT - Module Manifest"] = 255,
    ["Foundry VTT - System Data Template"] = 258,
    ["Foundry VTT - System Manifest"] = 256,
    ["Foundry VTT - World Manifest"] = 257,
    ["Foxx Manifest"] = 66,
    ["Freifunk.de Community API"] = 69,
    ["Frogbot Config"] = 70,
    ["G2P Mapping Configuration"] = 264,
    ["GCP Blueprint Metadata"] = 267,
    Gaspar = 265,
    ["GatewayCore API Gateway"] = 266,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 810,
    GitVersion = 269,
    ["Gitpod Configuration"] = 278,
    ["GlazeWM settings"] = 812,
    ["Global Privacy Control"] = 268,
    Goblet = 793,
    ["Google Chrome Related Website Sets"] = 251,
    ["Google Cloud Workflows"] = 173,
    Goreleaser = 282,
    ["Goreleaser Pro"] = 283,
    Goss = 284,
    ...
    JReleaser = 325,
    ["JSON Document Transform"] = 333,
    ["JSON Feed"] = 334,
    ["JSON Resume"] = 496,
    ["JSON Schema Draft 2020-12"] = 632,
    ["JSON Schema Draft 4"] = 629,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 795,
    ["JSON Schema Draft 7"] = 630,
    ["JSON Schema Draft 7 (unofficial strict)"] = 796,
    ["JSON Schema Draft 8 (2019-09)"] = 631,
    ["JSON-API"] = 332,
    ["JSON-e templates"] = 693,
    ["JSON-stat 2.0"] = 626,
    JSONPatch = 336,
    ["JSR Package Config (jsr.json)"] = 326,
    Jasmine = 315,
    Jekyll = 316,
    ["Jenkins X Pipelines"] = 317,
    ["Jenkins X Requirements"] = 318,
    ["Jovo Language Models"] = 324,
    ["KIMMDY config file"] = 341,
    ["KSP-AVC"] = 627,
    ["KSP-CKAN"] = 628,
    ["Karakum configuration file"] = 261,
    Kas = 339,
    ["Keycloak REST API"] = 765,
    ["Knative Functions - func.yaml"] = 262,
    ["KoDE/CI build.yaml"] = 753,
    ["Kong DBLess config"] = 754,
    KrakenD = 342,
    LOOBin = 361,
    Lefthook = 350,
    ["Liferay client-extension.yaml"] = 357,
    ["LinkML Metamodel"] = 359,
    Liquibase = 700,
    ["Liquibase Flow File"] = 701,
    ["Lively Properties"] = 360,
    ["Lobe AI Agent"] = 63,
    ["MLOS Configs"] = 395,
    ["MS2Rescore Configuration"] = 398,
    ["Madness (madness.yml)"] = 776,
    Markdownlint = 704,
    ["Mason Registry"] = 706,
    ["MegaLinter configuration"] = 367,
    ["MegaLinter descriptor"] = 368,
    Melange = 802,
    ["Meltano plugin discovery definition"] = 370,
    ["Meltano project definition"] = 369,
    ["MetricsHub Configuration"] = 371,
    ["MetricsHub Connector Configuration"] = 372,
    ["Micro Editor Syntax"] = 786,
    ["Microsoft Band Web Tile"] = 373,
    ["Minecraft Custom Main Menu Mod"] = 803,
    ["Minecraft Data Pack Advancement"] = 375,
    ["Minecraft Data Pack Biome"] = 376,
    ["Minecraft Data Pack Configured Carver"] = 377,
    ["Minecraft Data Pack Damage Type"] = 378,
    ["Minecraft Data Pack Dimension"] = 380,
    ["Minecraft Data Pack Dimension Type"] = 379,
    ["Minecraft Data Pack Item Modifier"] = 381,
    ["Minecraft Data Pack Loot Table"] = 382,
    ["Minecraft Data Pack Metadata"] = 383,
    ["Minecraft Data Pack Predicate"] = 384,
    ["Minecraft Data Pack Recipe"] = 385,
    ["Minecraft Data Pack Tag"] = 386,
    ["Minecraft Data Pack Template Pool"] = 387,
    ["Minecraft Data Pack Trim Material"] = 392,
    ["Minecraft Data Pack Trim Pattern"] = 393,
    ["Minecraft Resource Pack Lang"] = 388,
    ["Minecraft Resource Pack Particle"] = 389,
    ["Minecraft Resource Pack Texture Mcmeta"] = 391,
    ["Minecraft Resourcepack Sounds"] = 390,
    ["MkDocs Configuration 1.0"] = 394,
    ["MongoDB Atlas Search Index Definition"] = 752,
    ["Monika Configuration"] = 750,
    ["Monoweave Configuration"] = 397,
    ["Motif config"] = 651,
    ["NOX Framework (Service)"] = 412,
    ["Netin Diagnostic System Template"] = 710,
    ["Netlify config"] = 403,
    ["Network-as-Code Data Model"] = 404,
    ["Nightwatch.js"] = 405,
    ["Nuitka.yaml"] = 816,
    ["ONe's changelog entry"] = 428,
    ["ONe's service descriptor"] = 427,
    ["OSS Review Toolkit configuration"] = 435,
    ["OSS Review Toolkit curation"] = 436,
    ["OSS Review Toolkit package configuration"] = 437,
    ["OSS Review Toolkit repository configuration"] = 438,
    ["OSS Review Toolkit resolutions"] = 439,
    Opctl = 654,
    ["OpenRewrite Resource"] = 430,
    ["OpenUtau character yaml"] = 424,
    ["OpenUtau ustx"] = 425,
    ["OpenWeather Current Weather API"] = 692,
    ["OpenWeather Road Risk API"] = 691,
    ["Ory Hydra configuration"] = 303,
    ["Ory Keto configuration"] = 344,
    ["Ory Kratos configuration"] = 434,
    ["Ory Oathkeeper configuration"] = 419,
    ["Outblocks App configuration"] = 432,
    ["Outblocks database table"] = 433,
    ["Outblocks project configuration"] = 431,
    PDM = 445,
    Packer = 442,
    Pantsbuild = 772,
    ["Paper paper-plugin.yml"] = 443,
    ["Pipeline component"] = 702,
    ["PocketMine plugin.yml"] = 449,
    ["Postman collection"] = 454,
    ["Problem object RFC9457"] = 800,
    ...
    Ray = 666,
    ["Read the Docs"] = 481,
    ["Red-DiscordBot Cog"] = 486,
    ["Red-DiscordBot Cog Repo"] = 487,
    ["Red-DiscordBot Trivia"] = 488,
    RenderCV = 498,
    Renovate = 497,
    ["Replit config"] = 492,
    RoadRunner = 499,
    ...
    ["Stylelint (.stylelintrc)"] = 559,
    ["Sublime Syntax"] = 764,
    ["Subsquid squid manifest"] = 809,
    ["Swagger API 2.0"] = 561,
    TSON = 586,
    TSTyche = 587,
    Talhelper = 563,
    ...
    V2Ray = 735,
    ["VSCode Code Snippets"] = 161,
    ["VSIX CLI publishing"] = 614,
    ["Vela Pipeline Configuration"] = 603,
    Vercel = 160,
    Visivo = 797,
    ["Web App Manifest"] = 621,
    ["Web types"] = 624,
    WebExtensions = 620,
    ...
    ["chisel-slices.json"] = 178,
    ["chrome-extension-locales-messages.json"] = 168,
    ["chutzpah.json"] = 169,
    cibuildwheel = 113,
    ["clang-format (.clang-format)"] = 733,
    clangd = 148,
    clib = 149,
    ["cloud-init: cloud-config userdata"] = 151,
    ["cloud-sdk-pipeline-configuration"] = 171,
    ["cloudbuild.json"] = 172,
    cloudify = 150,
    codemagic = 152,
    ["coffeelint.json"] = 180,
    ["commands.json"] = 164,
    ["commitlint (.commitlintrc)"] = 676,
    ["compile_commands.json"] = 163,
    ["compilerconfig.json"] = 162,
    ["completely.yml"] = 775,
    ["component-detection-manifest.json"] = 183,
    ["component.json"] = 182,
    ["composer.json"] = 181,
    ["config.yaml"] = 480,
    ["contentmanifest.json"] = 170,
    ["contribute.json"] = 184,
    ["cosmos.config.json"] = 166,
    ["crowdin.yml"] = 185,
    ["custom-elements.json"] = 789,
    ["cypress.json"] = 189,
    ["datalogic-scan2deploy-android"] = 198,
    ["datalogic-scan2deploy-ce"] = 199,
    ["dbt Project"] = 122,
    ["ddev-global"] = 200,
    ["ddev-project"] = 201,
    ["debugsettings.json"] = 202,
    ["dependabot-v2.json"] = 205,
    ["dependabot.json"] = 204,
    ["deployed-cli"] = 726,
    ["devcontainer.json"] = 154,
    devinit = 681,
    ["devspace.yaml"] = 749,
    djlint = 682,
    ["docker sequencer"] = 210,
    ["docker-compose.yml"] = 680,
    ["dockerd.json"] = 209,
    ["dotnet Release Index manifest"] = 220,
    ["dotnet-tools.json"] = 221,
    ["dotnetcli.host.json"] = 222,
    ["dprint.json"] = 223,
    ["drone.json"] = 224,
    ["dss-2.0.0.json"] = 226,
    ["dstack configuration"] = 227,
    ["dvc.yaml"] = 228,
    ["ecosystem.json"] = 233,
    eksctl = 234,
    ["electron-builder configuration file"] = 241,
    ["epr-manifest.json"] = 239,
    ["evcc.yaml"] = 242,
    ["ezd task runner"] = 244,
    ["fabric.mod.json"] = 247,
    ["first-timers-bot"] = 253,
    ...
    ["k3d.yaml"] = 338,
    ["k9s plugin.yml"] = 340,
    ["kontinuous-config.yaml"] = 346,
    ["kontinuous-values.yaml"] = 345,
    ["kustomization.yaml"] = 347,
    ["label-commenter-config.yml"] = 348,
    ["latexindent configuration"] = 62,
    ["launchsettings.json"] = 349,
    lazydocker = 788,
    lazygit = 787,
    ["lego.json"] = 351,
    ["lerna.json"] = 352,
    ["lgtm.yml"] = 353,
    ["liblab.config.json"] = 354,
    ["libman.json"] = 355,
    ["license-report-config.json"] = 356,
    ["linkinator.config.json"] = 358,
    ["lint-staged (.lintstagedrc)"] = 645,
    ["local.settings.json"] = 363,
    ["localazy.json"] = 364,
    ["lotus.yaml"] = 362,
    ["lsdlschema.json"] = 365,
    ...
    ["mtad.yaml"] = 650,
    ["mycode.json"] = 401,
    ["napari plugin manifest"] = 402,
    neoload = 660,
    ["nest-cli"] = 408,
    ["ninjs (News in JSON) 1.3"] = 407,
    ["ninjs (News in JSON) 2.0"] = 406,
    ["nixd configuration"] = 805,
    ["nlu.json"] = 409,
    ["nodemon.json"] = 411,
    ["noodl config"] = 711,
    now = 656,
    ...
    ["nswag.json"] = 417,
    ntangle = 418,
    ["nuclei-template.yaml"] = 415,
    ["nuget-project.json"] = 416,
    ["ocelot.json"] = 420,
    ["omnisharp.json"] = 421,
    ["openapi.json"] = 422,
    ["openfin.json"] = 429,
    ...
    ["ops.yaml"] = 426,
    ["package.json"] = 440,
    ["package.manifest"] = 441,
    ["partial-black.json"] = 89,
    ["pathfinder.yml"] = 444,
    ["pattern.json"] = 447,
    ["petstore-v1.0"] = 756,
    pgap_yaml_input_reader = 446,
    ...
    ["up.json"] = 595,
    v8r = 618,
    ["vcpkg configuration file"] = 159,
    ["vcpkg manifest file"] = 158,
    ["vega-lite.json"] = 602,
    ["vega.json"] = 601,
    ...
    ["version.json"] = 606,
    ["vim-addon-info"] = 608,
    ["vs-2017.3.host.json"] = 610,
    ["vs-nesting.json"] = 611,
    ["vsls.json"] = 609,
    ["vss-extension.json"] = 615,
    ["vtesttree.yaml"] = 616,
    ["vtestunit.yaml"] = 617,
    ...
    ["webhint.io"] = 742,
    ["webjobpublishsettings.json"] = 623,
    ["webjobs-list.json"] = 622,
    ["xs-app.json"] = 653,
