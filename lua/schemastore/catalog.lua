...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1022,
    [".nodehawkrc"] = 650,
    [".npmpackagejsonlintrc"] = 655,
    [".omletrc"] = 1203,
    [".phrase.yml"] = 733,
    [".phraseapp.yml"] = 734,
    [".pmbot.yml"] = 718,
    [".postcssrc"] = 727,
    [".powerpages-web-template-manifest"] = 729,
    [".pre-commit-config.yml"] = 730,
    [".pre-commit-hooks.yml"] = 731,
    [".putout.json"] = 767,
    [".rehyperc"] = 792,
    [".remarkrc"] = 796,
    [".sprite files"] = 894,
    ...
    [".vsconfig"] = 984,
    [".vsext"] = 985,
    ["1Password SSH Agent Config"] = 14,
    ["@factorial/drupal-breakpoints-css"] = 22,
    ["A micro editor config"] = 587,
    ABCClinicalDemandForecast = 32,
    ABCInventoryModuleData = 31,
    ABCSupplyPlan = 33,
    ["ACP Attempts"] = 34,
    ["ACP Cache File"] = 35,
    ["ACP Configuration File"] = 36,
    ["ACP Primer"] = 37,
    ["ACP Sync"] = 38,
    ["ACP Variables File"] = 39,
    ["AI Harness config"] = 41,
    ["AI Harness org policy"] = 42,
    AIConfig = 43,
    ["AMX Muse Program Descriptor"] = 1252,
    ["API Builder"] = 1058,
    ["AVA Configuration"] = 1122,
    ["AWS AppConfig Feature Flags-v1"] = 77,
    ["AWS CDK cdk.json"] = 284,
    ["AWS CloudFormation"] = 285,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 286,
    ["AWS Copilot Manifest"] = 1291,
    ["AWS SAM CLI Samconfig"] = 287,
    Acton = 1342,
    ["Adobe UXP Manifest"] = 1185,
    ["Aerleon Network & Service Definitions"] = 25,
    ["Aerleon Policy"] = 26,
    ["Agent Permission Policy"] = 1331,
    ["AgentCore CLI"] = 1332,
    AgentLoopKit = 1333,
    Aider = 1281,
    Air = 28,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1302,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1301,
    ["Airlock Microgateway"] = 44,
    ["Alacritty Configuration"] = 1094,
    ["AlgoVoi Compliance Receipt v1"] = 15,
    ["All Contributors configuration file"] = 1148,
    Anodizer = 469,
    ["Ansible Argument Specs"] = 452,
    ["Ansible Collection Galaxy"] = 459,
    ["Ansible Execution Environment"] = 449,
    ["Ansible Inventory"] = 458,
    ["Ansible Meta"] = 450,
    ["Ansible Meta Runtime"] = 451,
    ["Ansible Navigator Configuration"] = 461,
    ["Ansible Playbook"] = 456,
    ["Ansible Requirements"] = 453,
    ["Ansible Rulebook"] = 457,
    ["Ansible Tasks File"] = 455,
    ["Ansible Vars File"] = 454,
    ["Ansible-lint Configuration"] = 460,
    Any = 1213,
    ["AnyWork Automation Configuration"] = 21,
    ["Apollo Router"] = 1059,
    ["App config Spotify Backstage"] = 48,
    ["Applicant Profile Protocol"] = 18,
    ["Application Accelerator"] = 16,
    ["Application list for a WinUtil"] = 1231,
    ArchitectFX = 1236,
    ["Argo CD"] = 63,
    ["Argo Events"] = 64,
    ["Argo Workflows"] = 65,
    AssemblyScript = 68,
    AsyncAPI = 71,
    ["AsyncAPI Tool File"] = 72,
    ["Atmos Manifests"] = 73,
    ["Aurora Agile Meta-Framework"] = 74,
    AutoAPICase = 1158,
    ["Avro Avsc"] = 75,
    ["Awesome Repositories"] = 76,
    ["Azure Container App template for defining an immutable revision"] = 79,
    ["Azure DevOps extension manifest"] = 82,
    ["Azure Device Update for IoT Hub import manifest"] = 80,
    ["Azure Device Update for IoT Hub update manifest"] = 81,
    ["Azure IoT Edge deployment"] = 85,
    ["Azure IoT Edge deployment template"] = 86,
    ["Azure IoT EdgeAgent deployment"] = 83,
    ["Azure IoT EdgeHub deployment"] = 84,
    ["Azure IoT Operations Wasm Graph Config"] = 1300,
    ["Azure IoT Operations connector metadata"] = 1297,
    ["Azure Landing Zones Library archetype definition"] = 90,
    ["Azure Landing Zones Library archetype override"] = 91,
    ["Azure Landing Zones Library architecture definition"] = 89,
    ["Azure Landing Zones Library metadata"] = 87,
    ["Azure Landing Zones Library policy default values"] = 88,
    ["Azure Pipelines"] = 123,
    ["Azure Static Web Apps CLI configuration file"] = 898,
    ["Azure Static Web Apps configuration file"] = 897,
    BMML = 1319,
    ["BOSH BPM Config"] = 149,
    ["BOSH CPI Config"] = 150,
    ["BOSH Deploy Config"] = 151,
    ["BX CI"] = 172,
    ["Bacon config"] = 9,
    ["Barba-CV"] = 92,
    ["Bashly (bashly.yml)"] = 1152,
    ["Bashly Settings (bashly-settings.yml)"] = 1153,
    Bento = 1318,
    ["Better Code Hub"] = 1063,
    ["Better Scripts"] = 173,
    Bigconfig = 142,
    ["Biome Formatter Config"] = 93,
    ["Bitmovin Encoding Template"] = 1245,
    BizTalkServerApplicationSchema = 1029,
    Bleep = 174,
    ["Block Protocol Metadata"] = 171,
    ["Bluebricks blueprint config"] = 1324,
    ["Boyka Framework"] = 152,
    ["Bpod Finite-State Machine"] = 95,
    Briefcase = 1035,
    ["Build Info"] = 162,
    Buildkite = 164,
    ["Bukkit plugin.yml"] = 163,
    ["BungeeCord plugin.yml"] = 169,
    ["Burnless SRE config"] = 2,
    ["Butane Config"] = 1107,
    C4InterFlow = 1260,
    ["CDK Environment Manager, concrete environment configuration"] = 1284,
    ["CDK Environment Manager, concrete environments definition"] = 1283,
    ["CDK Environment Manager, environment definition"] = 1282,
    ["CGS Card Game Specification (cgs.json)"] = 1190,
    ["CICS TS region tagging"] = 1116,
    ["CICS TS resource import"] = 1117,
    ["CICS TS resource model"] = 1118,
    ["CICS TS resource overrides"] = 1119,
    ["CMake Presets"] = 175,
    ["CNC Codes"] = 197,
    ["CRS WAF test file"] = 1220,
    ["CRS WAF test platform overrides file"] = 1221,
    ["CSS Comb (.csscomb.json)"] = 313,
    ["CSS Lint (.csslintrc)"] = 314,
    ["CSpell (cspell.json)"] = 312,
    ["CVE Record Format"] = 209,
    CWL = 1196,
    ["Cache Warmup config"] = 176,
    ["Caido Proxy Configuration"] = 1356,
    ["Calqulus pipeline"] = 177,
    ["Camel YAML DSL"] = 178,
    ["Cannon TOML"] = 179,
    Carafe = 180,
    ["Cargo Make"] = 182,
    ["Cargo Manifest"] = 181,
    ["Catalog Info Backstage"] = 183,
    ["Chamaleon environment"] = 1249,
    ["Chamaleon properties"] = 1250,
    ["Chamaleon template"] = 1248,
    Changepacks = 1311,
    Changesets = 296,
    Changie = 184,
    Charmcraft = 185,
    Cheatsheets = 1104,
    ["ChordPro Configuration"] = 186,
    ["Chrome Extension"] = 277,
    ["Chromia Model"] = 187,
    ["Chromia Seeder Module Config"] = 189,
    ["Chromia Seeder Root Config"] = 188,
    ["Cinnamon Spice info.json"] = 103,
    ["CircleCI config.yml"] = 248,
    ["Citation File Format"] = 298,
    ["Citrus test case"] = 191,
    CityJSON = 192,
    ["Claude Code Keybindings"] = 204,
    ["Claude Code Plugin Manifest"] = 205,
    ["Claude Code Plugin Marketplace"] = 206,
    ["Claude Code Settings"] = 207,
    ["Clawject config"] = 203,
    ["Cloud Foundry Application Manifest"] = 1202,
    ["Cloud Run Spec v1"] = 1226,
    ["Cloud.gov Workshop Configuration"] = 104,
    ["CloudCannon Configuration"] = 109,
    ["CloudCannon Configuration (Collection Structures)"] = 118,
    ["CloudCannon Configuration (Collections)"] = 117,
    ["CloudCannon Configuration (Editables)"] = 116,
    ["CloudCannon Configuration (Inputs)"] = 111,
    ["CloudCannon Configuration (Snippets Definitions)"] = 115,
    ["CloudCannon Configuration (Snippets Imports)"] = 114,
    ["CloudCannon Configuration (Snippets)"] = 113,
    ["CloudCannon Configuration (Structure Value)"] = 112,
    ["CloudCannon Configuration (Structures)"] = 110,
    ["CloudEvents specification"] = 193,
    ["Code Climate"] = 249,
    CodeCV = 107,
    CodeRabbit = 106,
    ["CodeShip Pro services configuration files"] = 266,
    ["CodeShip Pro steps configuration files"] = 267,
    ["Codecov configuration files"] = 265,
    Codex = 257,
    ["Codex Hooks"] = 258,
    ["Codex Plugin Manifest"] = 259,
    ["Codex Skill Metadata"] = 260,
    CodifyCLI = 108,
    Codux = 262,
    ["Cog config file"] = 198,
    ["Commandbox Box.json"] = 199,
    ["Commandbox Server.json"] = 200,
    ["Common Catalog Data"] = 275,
    ["Common Package Specification"] = 201,
    Concord = 1219,
    ["Configu .cfgu files"] = 1207,
    ["Configu .configu file"] = 1208,
    Conjure = 196,
    ["Container Structure Test"] = 1043,
    Containerlab = 1072,
    ["Contextive Glossary"] = 1276,
    ContractGuard = 1073,
    Convex = 195,
    ["Crowdsec collection config"] = 307,
    ["Crowdsec parser config"] = 308,
    ["Crowdsec scenario config"] = 309,
    ["CumulusCI Config"] = 202,
    ["Cursor Agent Environment"] = 1329,
    ["Custom Machinery Machine"] = 1191,
    ["Custom Machinery Recipe"] = 1192,
    ["Cycle Stack File"] = 210,
    CycloneDX = 211,
    ["DWP Exchange - catalogue entry"] = 358,
    ["DWP Exchange - gateway"] = 356,
    ["DWP Exchange - meta"] = 357,
    ["Dart Build Config (dart-build.json)"] = 315,
    ["Dart Test Config (dart-test.json)"] = 316,
    ["DashLord Configuration"] = 317,
    ["Data Contract Specification"] = 318,
    ["Data Product Specification"] = 319,
    ["DataYoga Connections"] = 212,
    ["DataYoga Job"] = 213,
    ["Datadog Continuous Testing"] = 556,
    ["Datadog Service Definition"] = 557,
    ["Datadog Software Catalog"] = 558,
    ["Datahub Ingestion Recipe"] = 1123,
    ["Debian Upstream Metadata file"] = 220,
    DebtLens = 221,
    ["Deck config"] = 222,
    ["Declarative Automation Bundles"] = 1169,
    ["DeepMatch deeplinks spec"] = 223,
    ["Dein Config"] = 224,
    ["Deno Config (deno.json)"] = 325,
    ["Dependency cruiser"] = 225,
    ["DeployStack Configuration"] = 226,
    ["Deployah Configuration"] = 1299,
    ["Deployer Recipe"] = 328,
    ["Deta Spacefile"] = 227,
    ["Detekt Config (detekt.yml)"] = 329,
    ["Devbox Config"] = 228,
    ["Devbox Plugin"] = 229,
    Devfile = 355,
    Devup = 1312,
    DipDup = 1222,
    ["Discord Webhook"] = 330,
    ["DocFx Config (docfx.json)"] = 335,
    ["Docker Desktop extension metadata"] = 332,
    ["Docs MCP Manifest"] = 336,
    Dofigen = 337,
    ["Dolittle Artifacts"] = 338,
    ["Dolittle Bounded Context Configuration"] = 339,
    ["Dolittle Event Horizons Configuration"] = 340,
    ["Dolittle Resources Configuration"] = 341,
    ["Dolittle Server Configuration"] = 342,
    ["Dolittle Tenant Map Configuration"] = 344,
    ["Dolittle Tenants Configuration"] = 343,
    ["Dolittle Topology"] = 345,
    ["DonateCaseBetterCasino menu"] = 1253,
    ["Drupal Breakpoints"] = 230,
    ["Drupal Config"] = 242,
    ["Drupal Info"] = 231,
    ["Drupal Layouts"] = 232,
    ["Drupal Libraries"] = 233,
    ["Drupal Links Action"] = 234,
    ["Drupal Links Contextual"] = 235,
    ["Drupal Links Menu"] = 236,
    ["Drupal Links Task"] = 237,
    ["Drupal Migration"] = 238,
    ["Drupal Permissions"] = 239,
    ["Drupal Recipe"] = 240,
    ["Drupal Routing"] = 241,
    ["Drupal Services"] = 243,
    ["Drush site aliases"] = 351,
    ["Dynamic Bash Aliases (.aliases)"] = 1160,
    ["EAS config"] = 396,
    ["ECA - Editor Code Assistant"] = 360,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1149,
    ["ESLint Suppressions"] = 401,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1296,
    ["EasyVCR .NET"] = 398,
    ["Eidolon Resource"] = 1237,
    ["Elgato Stream Deck"] = 362,
    Elm = 1224,
    ["Embrace Config"] = 1135,
    Emmet = 1225,
    Endurica = 1173,
    ["Enonic XP API descriptor"] = 365,
    ["Enonic XP Admin Extension descriptor"] = 366,
    ["Enonic XP Admin Tool descriptor"] = 367,
    ["Enonic XP Application descriptor"] = 368,
    ["Enonic XP CMS descriptor"] = 369,
    ["Enonic XP Content Type descriptor"] = 370,
    ["Enonic XP Form Fragment descriptor"] = 371,
    ["Enonic XP ID Provider descriptor"] = 372,
    ["Enonic XP Layout descriptor"] = 373,
    ["Enonic XP Macro descriptor"] = 374,
    ["Enonic XP Mixin descriptor"] = 375,
    ["Enonic XP Page descriptor"] = 376,
    ["Enonic XP Part descriptor"] = 377,
    ["Enonic XP Service descriptor"] = 378,
    ["Enonic XP Site descriptor"] = 379,
    ["Enonic XP Style descriptor"] = 380,
    ["Enonic XP Task descriptor"] = 381,
    ["Enonic XP Webapp descriptor"] = 382,
    ["Enterprise Contract Policy Spec"] = 363,
    ["Envelope Team Definition"] = 1341,
    ["Envilder Map File"] = 364,
    ["Erda Pipeline"] = 1198,
    ["Erda Runtime"] = 1199,
    ["Espanso config.yml"] = 1322,
    ["Espanso match.yml"] = 1321,
    Esquio = 384,
    ["Estuary Flow Catalog"] = 1113,
    ["Ethereum ERC1155"] = 1335,
    ["Ethereum ERC721"] = 1334,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 389,
    ["EveryVoice TTS Toolkit Data Configuration"] = 390,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 394,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 393,
    ["EveryVoice TTS Toolkit Text Configuration"] = 391,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 392,
    ["Evolving Resolutive Process notation"] = 1298,
    ["Expo SDK"] = 395,
    ["Expoot app config"] = 397,
    ["F-Droid Data metadata"] = 403,
    ["FasterCI Configuration"] = 124,
    ["Fence configuration"] = 125,
    FiQuS = 407,
    Firebase = 405,
    ["Flatpak Builder Manifest"] = 408,
    ["FlexGet Config"] = 409,
    ["Flow.json Configurations"] = 1195,
    ["Fossa configuration file"] = 416,
    ["Fossa's fossa-deps file"] = 417,
    ["Foundry VTT - Base package Manifest"] = 411,
    ["Foundry VTT - Module Manifest"] = 412,
    ["Foundry VTT - System Data Template"] = 415,
    ["Foundry VTT - System Manifest"] = 413,
    ["Foundry VTT - World Manifest"] = 414,
    ["Foxx Manifest"] = 126,
    ["Freifunk.de Community API"] = 129,
    ["Frogbot Config"] = 130,
    ["G2P Mapping Configuration"] = 423,
    GAMA = 424,
    ["GCP Blueprint Metadata"] = 427,
    Gaspar = 425,
    ["GatewayCore API Gateway"] = 426,
    ["Gemini CLI settings"] = 428,
    ["GeoJSON.json latest"] = 1111,
    GherKing = 1115,
    ["GitHub Action"] = 436,
    ["GitHub Actions typing"] = 1233,
    ["GitHub Discussion"] = 437,
    ["GitHub Funding"] = 438,
    ["GitHub Issue Template configuration"] = 439,
    ["GitHub Issue Template forms"] = 440,
    ["GitHub Pages Jekyll"] = 441,
    ["GitHub Workflow"] = 442,
    ["GitHub Workflow Template Properties"] = 443,
    ["GitHub automatically generated release notes configuration"] = 444,
    ["GitLab Agent for Kubernetes configuration"] = 1187,
    GitResume = 448,
    GitVersion = 431,
    ["Gitea Issue Template configuration"] = 434,
    ["Gitea Issue Template forms"] = 435,
    Gitleaks = 432,
    ["Gitpod Automations"] = 446,
    ["Gitpod Configuration"] = 447,
    ["Glamour style"] = 429,
    ["GlazeWM settings"] = 1189,
    ["Global Privacy Control"] = 430,
    Goblet = 1168,
    ["Golangci-lint Configuration"] = 463,
    ["Golangci-lint Custom Plugins Configuration"] = 464,
    ["Google Chrome Related Website Sets"] = 406,
    ["Google Cloud Workflows"] = 283,
    ["Google Digital Assetlinks"] = 1277,
    Goreleaser = 467,
    ["Goreleaser Pro"] = 468,
    Goss = 470,
    ["Gradle Build Cache Node"] = 1061,
    ["Gradle Enterprise"] = 1060,
    ["Grafana 5.x Dashboard"] = 471,
    ["GraphQL Code Generator"] = 476,
    ["GraphQL Config"] = 475,
    ["GraphQL Mesh"] = 474,
    ["GroovyLint configuration"] = 477,
    ["Grunt JSHint task"] = 481,
    ["Grunt Watch task"] = 482,
    ["Grunt base task"] = 483,
    ["Grunt clean task"] = 479,
    ["Grunt copy task"] = 478,
    ["Grunt cssmin task"] = 480,
    HEMTT = 1025,
    Hadolint = 1039,
    Hammerkit = 1071,
    ["Hardware Sentry Configuration"] = 1127,
    ["Hashgraph Online Skill Manifest"] = 5,
    ["HashiCorp Vault"] = 484,
    Hatch = 1040,
    Hayson = 486,
    ["Haystack Pipeline"] = 487,
    ["Hazelcast 5 Configuration"] = 488,
    ["Hecate Input Schema"] = 1288,
    ["Helm Chart.lock"] = 245,
    ["Helm Chart.yaml"] = 244,
    ["Helm Unittest Test Suite"] = 246,
    ["Hex file"] = 247,
    ["Home Assistant Integration Manifest"] = 490,
    ["Homer dashboard configuration"] = 491,
    Hugo = 1103,
    ["Hugo Theme"] = 1102,
    ["Hulak Configuration"] = 498,
    ["Hyperfoil benchmark configuration"] = 497,
    ["IBM Zapp document"] = 499,
    ["IBM zCodeFormatSettings"] = 500,
    ["IMG Catapult PSP"] = 505,
    ["IVMS101 by CODE Protocol"] = 1188,
    ["Infinispan Configuration"] = 507,
    ["Infinispan Server Configuration"] = 508,
    Infrahub = 509,
    Istanbul = 1131,
    ["JDownloader2 crawler multi-rules"] = 523,
    ["JDownloader2 crawler single-rules"] = 522,
    ["JFrog Applications Config"] = 524,
    ["JFrog File Spec"] = 525,
    ["JFrog Pipelines YML DSL"] = 1137,
    ["JMeter DSL cli config"] = 526,
    JReleaser = 529,
    ["JSON Document Transform"] = 537,
    ["JSON Feed"] = 538,
    ["JSON Resume"] = 804,
    ["JSON Schema Draft 2020-12"] = 1006,
    ["JSON Schema Draft 4"] = 1003,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1170,
    ["JSON Schema Draft 7"] = 1004,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1171,
    ["JSON Schema Draft 8 (2019-09)"] = 1005,
    ["JSON-API"] = 536,
    ["JSON-e templates"] = 1068,
    ["JSON-stat 2.0"] = 999,
    JSONPatch = 540,
    ["JSR Package Config (jsr.json)"] = 530,
    Jarl = 1304,
    Jasmine = 517,
    Jekyll = 518,
    ["Jenkins X Pipelines"] = 519,
    ["Jenkins X Requirements"] = 520,
    Jest = 521,
    Jocker = 527,
    ["Jovo Language Models"] = 528,
    ["Jujutsu (jj) VCS config"] = 1290,
    ["KIMMDY config file"] = 551,
    ["KODE/CI build.yaml"] = 1133,
    ["KSP-AVC"] = 1000,
    ["KSP-CKAN"] = 1001,
    ["KSP-NetKAN"] = 1002,
    KSY = 1200,
    KSail = 421,
    ["KYA Manifest"] = 1201,
    ["Karakum configuration file"] = 418,
    Kas = 543,
    ["Kestra flow file"] = 552,
    ["Keycloak REST API"] = 1140,
    ["Knative Functions - func.yaml"] = 419,
    Knip = 420,
    ["Knowledge Unit"] = 560,
    ["Kometa (nightly) config file"] = 554,
    ["Kometa config file"] = 553,
    ["Kong DBLess config"] = 1134,
    KrakenD = 555,
    ["Kubri Configuration"] = 563,
    LOOBin = 578,
    ["Lake configuration file"] = 1293,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 288,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 289,
    ["Landing Zone Accelerator on AWS - Global Config"] = 290,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 291,
    ["Landing Zone Accelerator on AWS - Network Config"] = 292,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 293,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 294,
    ["Landing Zone Accelerator on AWS - Security Config"] = 295,
    ["Lando (landofile)"] = 119,
    ["LangGraph Platform configuration"] = 1212,
    ["Language configuration"] = 1211,
    Lefthook = 567,
    ["Liferay client-extension.yaml"] = 574,
    ["LinkML Metamodel"] = 576,
    Liquibase = 1078,
    ["Liquibase Flow File"] = 1079,
    ["Lively Properties"] = 577,
    ["Lobe AI Agent"] = 121,
    Loki = 122,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 620,
    ["MS2Rescore Configuration"] = 627,
    ["MSTest testconfig.json"] = 628,
    ["Madness (madness.yml)"] = 1151,
    ["Mado configuration"] = 584,
    ["Maestro Flow"] = 585,
    ["Mail Servers Configuration"] = 1325,
    ["MapEHR Mapping"] = 586,
    Markdownlint = 1082,
    ["Mason Registry"] = 1085,
    ["MegaLinter Custom Flavor"] = 589,
    ["MegaLinter configuration"] = 588,
    ["MegaLinter descriptor"] = 590,
    Melange = 1178,
    ["Meltano project definition"] = 591,
    ["Mergify Configuration"] = 629,
    ["Metadata for a Bazel module"] = 592,
    ["Metadata for a Cinnamon spice"] = 1229,
    ["Metatype Configuration"] = 593,
    ["MetricsHub Configuration"] = 594,
    ["MetricsHub Connector Configuration"] = 595,
    ["Micro Editor Syntax"] = 1161,
    ["Microsoft Band Web Tile"] = 596,
    ["Microsoft RulesEngine workflow rules"] = 1216,
    ["Microsoft RulesEngine workflow rules list"] = 1217,
    ["Minecraft Custom Main Menu Mod"] = 1179,
    ["Minecraft Data Pack Advancement"] = 598,
    ["Minecraft Data Pack Biome"] = 599,
    ["Minecraft Data Pack Configured Carver"] = 600,
    ["Minecraft Data Pack Damage Type"] = 601,
    ["Minecraft Data Pack Dimension"] = 603,
    ["Minecraft Data Pack Dimension Type"] = 602,
    ["Minecraft Data Pack Item Modifier"] = 604,
    ["Minecraft Data Pack Loot Table"] = 605,
    ["Minecraft Data Pack Metadata"] = 606,
    ["Minecraft Data Pack Predicate"] = 607,
    ["Minecraft Data Pack Recipe"] = 608,
    ["Minecraft Data Pack Tag"] = 609,
    ["Minecraft Data Pack Template Pool"] = 610,
    ["Minecraft Data Pack Trim Material"] = 615,
    ["Minecraft Data Pack Trim Pattern"] = 616,
    ["Minecraft Resource Pack Lang"] = 611,
    ["Minecraft Resource Pack Particle"] = 612,
    ["Minecraft Resource Pack Texture Mcmeta"] = 614,
    ["Minecraft Resourcepack Sounds"] = 613,
    ["MockServer Expectations"] = 622,
    ModuleAssembler = 618,
    ["Monade CLI Stack Configuration"] = 632,
    ["MongoDB Atlas Search Index Definition"] = 1132,
    ["Monika Configuration"] = 1130,
    ["Monoweave Configuration"] = 626,
    ["Motif config"] = 1021,
    MultiQC = 1270,
    ["NOX Framework (Service)"] = 654,
    ["Netin Diagnostic System Template"] = 1089,
    ["Netlify config"] = 635,
    ["Network-as-Code Data Model"] = 636,
    ["Next Gen UI Agent A2A Server Configuration"] = 637,
    ["Next Gen UI Agent Configuration"] = 639,
    ["Next Gen UI Agent MCP Server Configuration"] = 638,
    ["Nightwatch.js"] = 646,
    ["Nika workflow"] = 651,
    ["Node.js configuration"] = 1026,
    ["NueJS configuration file"] = 659,
    ["Nuitka Package Config"] = 1193,
    ["Nullstone config"] = 661,
    ["ONe's changelog entry"] = 680,
    ["ONe's service descriptor"] = 679,
    ["ORT Server repository environment configuration"] = 690,
    ["OSCAL Assessment Plan (AP)"] = 692,
    ["OSCAL Assessment Results (AR)"] = 693,
    ["OSCAL Catalog"] = 694,
    ["OSCAL Component Definition (CDef)"] = 695,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 696,
    ["OSCAL Profile"] = 697,
    ["OSCAL System Security Plan (SSP)"] = 698,
    ["OSS Review Toolkit configuration"] = 699,
    ["OSS Review Toolkit curation"] = 700,
    ["OSS Review Toolkit package configuration"] = 701,
    ["OSS Review Toolkit project package manager definition"] = 702,
    ["OSS Review Toolkit repository configuration"] = 703,
    ["OSS Review Toolkit resolutions"] = 704,
    ["October CMS columns"] = 665,
    ["October CMS fields"] = 666,
    ["Oh My Posh"] = 668,
    Okteto = 669,
    ["Ona Automations"] = 671,
    Opctl = 1024,
    ["Open Data Contract Standard (ODCS)"] = 684,
    ["Open Data Product Standard (ODPS)"] = 685,
    ["Open Know-How"] = 1275,
    OpenDecree = 1339,
    ["OpenDecree Configuration"] = 1340,
    ["OpenRewrite Resource"] = 682,
    OpenSRM = 686,
    OpenStatus = 1286,
    ["OpenTelemetry Declarative Configuration"] = 683,
    ["OpenUtau character yaml"] = 676,
    ["OpenUtau ustx"] = 677,
    ["OpenWeather Current Weather API"] = 1067,
    ["OpenWeather Road Risk API"] = 1066,
    ["Ory Hydra configuration"] = 496,
    ["Ory Keto configuration"] = 559,
    ["Ory Kratos configuration"] = 691,
    ["Ory Oathkeeper configuration"] = 663,
    ["Outblocks App configuration"] = 688,
    ["Outblocks database table"] = 689,
    ["Outblocks project configuration"] = 687,
    PDM = 712,
    POPxf = 724,
    ["POPxf Correlations"] = 725,
    ["PRML manifest"] = 732,
    Packer = 708,
    PactSpec = 709,
    Panache = 710,
    Pantsbuild = 1147,
    ["Paper paper-plugin.yml"] = 711,
    ["Pipeline component"] = 1080,
    ["Platform.sh application"] = 11,
    ["Platform.sh routes"] = 12,
    ["Platform.sh services"] = 13,
    ["Plex Prerolls"] = 722,
    ["PocketMine plugin.yml"] = 719,
    ["Podman Desktop Extension"] = 1358,
    ["Postman collection"] = 728,
    ["Power Pages Configuration"] = 1287,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1232,
    ["ProActions AI-Kit Configuration"] = 740,
    ["ProActions AI-Kit Configuration for Menus"] = 742,
    ["ProActions AI-Kit Configuration for Sections"] = 744,
    ["ProActions AI-Kit Configuration for Services"] = 741,
    ["ProActions AI-Kit Configuration for Steps"] = 745,
    ["ProActions AI-Kit Configuration for Templates"] = 743,
    ["Problem object RFC9457"] = 1176,
    ["Problem package format"] = 746,
    ["Problem package generators"] = 747,
    ["Problem package submissions"] = 748,
    ["Problem package test group metadata"] = 749,
    Pterodactyl = 1126,
    ["Pull Request Labeler"] = 766,
    Pulumi = 774,
    ["PyGTA Config"] = 770,
    PyProject = 775,
    Pylock = 1278,
    Pyright = 776,
    ["Python script metadata"] = 1272,
    ["QType AI DSL"] = 779,
    Qgoda = 778,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1350,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1348,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1354,
    ["Qlik Talend Cloud Pipeline - Project"] = 1346,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1349,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1351,
    ["Qlik Talend Cloud Pipeline - Task"] = 1347,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1353,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1352,
    Qodana = 1099,
    ["Qt Creator workspace file"] = 1209,
    ["Quali Torque Blueprint Spec 2"] = 1124,
    ["QueryFirst config file"] = 1143,
    ["QuikRun Configuration"] = 1355,
    ["Qwen Code Settings"] = 1336,
    ["RKE Cluster Configuration JSON"] = 1077,
    ["RKE Cluster Configuration YAML"] = 1076,
    RadioHound = 769,
    ["Raid Profile"] = 1337,
    ["Raid Repo Configuration"] = 1338,
    Railpack = 781,
    Railway = 780,
    ["Rancher Fleet"] = 771,
    ["Rattler-build"] = 782,
    Ray = 1038,
    ["Read the Docs"] = 773,
    ["Red-DiscordBot Cog"] = 789,
    ["Red-DiscordBot Cog Repo"] = 790,
    ["Red-DiscordBot Trivia"] = 791,
    ["Releasaurus Config"] = 8,
    ReleaseKit = 7,
    ["Render Blueprints"] = 1075,
    RenderCV = 808,
    Renovate = 805,
    ["Renovate global configuration"] = 806,
    ["Renovate inherited configuration"] = 807,
    ["Replit config"] = 797,
    Restate = 1265,
    ["Revel Digital Gadget Definition File"] = 1289,
    RoadRunner = 810,
    ["Robust Station Image"] = 1295,
    Rockcraft = 811,
    ["Roo Coder Custom Modes"] = 812,
    Rubocop = 801,
    ["Rudder techniques"] = 1183,
    Ruff = 802,
    ["Rust Project"] = 803,
    ["Rust toolchain"] = 817,
    ["SDMX data message"] = 844,
    ["SDMX metadata message"] = 843,
    ["SDMX structure message"] = 842,
    ["SIL Kit Participant Configuration"] = 855,
    ["SIL Kit Registry Configuration"] = 856,
    ["SPDX 2.3"] = 895,
    SWADL = 911,
    ["Safebox Config"] = 1138,
    ["Sapphire CLI Config"] = 820,
    ["SauceCTL Configuration"] = 1086,
    Scarb = 840,
    ["Schema Catalog"] = 835,
    ["Scoop manifest"] = 841,
    ["Secure SDLC Evidence Bundle"] = 845,
    ["Semantic Data Fabric (SDF) file"] = 846,
    ["Semgrep Rule"] = 848,
    ["Serenity Code Generator (Sergen)"] = 849,
    ["Serverless Framework Configuration"] = 1093,
    ["Serverless Workflow"] = 1095,
    ["Settings for a Cinnamon spice"] = 1228,
    ["Settings.paf"] = 851,
    ["Shopware 6 Configuration"] = 1096,
    ["Shopware CLI Extension Store Configuration"] = 1097,
    ["Shopware CLI Project Store Configuration"] = 1098,
    ["Sigma Detection Rule"] = 853,
    ["SigmaCV CV"] = 3,
    ["Sigrid scope configuration file"] = 854,
    ["SkyPilot Task JSON"] = 1184,
    ["Slack app manifest"] = 858,
    ["Slang Server Configuration"] = 1362,
    Snapcraft = 860,
    ["Solarxy project config"] = 863,
    Solidarity = 864,
    ["Solution filters"] = 865,
    ["Source Maps v3"] = 866,
    Sourcery = 867,
    ["Spack bootstrap.yaml"] = 868,
    ["Spack cdash.yaml"] = 869,
    ["Spack ci.yaml"] = 870,
    ["Spack compilers.yaml"] = 871,
    ["Spack concretizer.yaml"] = 872,
    ["Spack config.yaml"] = 873,
    ["Spack definitions.yaml"] = 874,
    ["Spack develop.yaml"] = 875,
    ["Spack env_vars.yaml"] = 876,
    ["Spack environment"] = 882,
    ["Spack include.yaml"] = 877,
    ["Spack mirrors.yaml"] = 878,
    ["Spack modules.yaml"] = 879,
    ["Spack packages.yaml"] = 880,
    ["Spack repos.yaml"] = 881,
    ["Spack toolchains.yaml"] = 883,
    ["Spack upstreams.yaml"] = 884,
    ["Spack view.yaml"] = 885,
    ["Speakeasy Generation Config File"] = 889,
    ["Speakeasy Lint Configuration File"] = 886,
    ["Speakeasy Test Generation Configuration File"] = 887,
    ["Speakeasy Workflow File"] = 888,
    SpecIF = 890,
    ["Specmatic Configuration"] = 891,
    ["Specpin spec file"] = 1,
    ["Sponge Mixin configuration"] = 892,
    ["Spotlight Ruleset"] = 893,
    StackBlitz = 899,
    ["StackHawk Scanner Configuration"] = 1092,
    Stale = 900,
    Starfish = 901,
    ["Starlake Data Pipeline"] = 1064,
    Starship = 902,
    ["Statamic Blueprint"] = 903,
    ["Stella configuration file"] = 904,
    ["Streamlit configuration file"] = 905,
    ["Stryker Mutator"] = 908,
    ["StyleCop Analyzers Configuration"] = 909,
    ["Stylelint (.stylelintrc)"] = 910,
    ["Stylua Config"] = 1279,
    ["Sublime Syntax"] = 1139,
    ["Subsquid squid manifest"] = 1186,
    ["Swagger API 2.0"] = 912,
    ["Synadia Connect Component"] = 913,
    TSON = 949,
    TSTyche = 950,
    ["TYPO3 Vendor Bundler config"] = 956,
    ["Tab data for a LinUtil"] = 1235,
    ["Tab list for a LinUtil"] = 1234,
    Tach = 914,
    ["Tach Domain"] = 915,
    Talhelper = 917,
    ["Talisman configuration"] = 918,
    Taplo = 1280,
    ["Taskfile config"] = 1069,
    Taurus = 919,
    Tauticord = 920,
    ["Tekton Pipeline"] = 1308,
    ["Tekton PipelineRun"] = 1309,
    ["Tekton Task"] = 1306,
    ["Tekton TaskRun"] = 1307,
    Telefonistka = 1266,
    ["Terrateam config"] = 1292,
    ["TestEnvironment.json"] = 932,
    ["TextMate Grammar"] = 931,
    Threagile = 926,
    ["Tier.run pricing.json"] = 923,
    Tikibase = 924,
    Tombi = 929,
    ["Traefik v2"] = 935,
    ["Traefik v2 File Provider"] = 936,
    ["Traefik v3"] = 937,
    ["Traefik v3 File Provider"] = 938,
    ["Travis CI (.travis.yml)"] = 934,
    Treefmt = 473,
    Trident = 1262,
    ["TrueScript for *.tscript files"] = 941,
    ["Tugboat QA config.yml"] = 1259,
    TunnelHub = 1174,
    Turborepo = 933,
    Tycho = 1223,
    Tye = 1100,
    ["Tyk Gateway - Open Source v5.7+"] = 1271,
    ["UET BuildConfig.json"] = 1144,
    ["UI5 Manifest"] = 962,
    ["UNCORS configuration"] = 967,
    ["UTAM Page Object"] = 965,
    ["Ubuntu Server Autoinstall"] = 960,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1263,
    ["Uniswap Token List"] = 1049,
    ["Universal Schedule Format"] = 968,
    ["Unreal Engine Uplugin"] = 1145,
    ["Unreal Engine Uproject"] = 1146,
    ["UpCloud CLI (upctl) configuration"] = 1264,
    ["Updatecli Compose"] = 1108,
    ["Updatecli Policy Manifest"] = 1109,
    ["Updatecli Policy Metadata"] = 1110,
    Uplift = 1142,
    ["Upsun config"] = 10,
    ["User Journey Map"] = 1074,
    V2Ray = 1114,
    ["VSCode Code Snippets"] = 271,
    ["VSIX CLI publishing"] = 986,
    Vector = 970,
    ["Vela Pipeline Configuration"] = 973,
    Vercel = 270,
    ["Version Bumper config"] = 976,
    Vespertide = 1313,
    ["Vespertide Migration"] = 1314,
    ["Vespertide Model"] = 1315,
    ["Viash Component Config"] = 1268,
    ["Viash Package Config"] = 1269,
    Visivo = 1172,
    ["WP-CLI"] = 996,
    Wake = 1261,
    ["Waku Config"] = 1238,
    ["Web App Manifest"] = 992,
    ["Web types"] = 995,
    WebExtensions = 991,
    ["Webman package recipe"] = 1120,
    ["Windows Package Manager Installer Manifest"] = 1046,
    ["Windows Package Manager Locale Manifest"] = 1047,
    ["Windows Package Manager Singleton Manifest"] = 1045,
    ["WireMock CLI import configuration"] = 1244,
    ["WireMock CLI local service configuration"] = 1243,
    ["WireMock message stub mapping"] = 1242,
    ["WireMock stub mapping"] = 1241,
    ["Woodpecker pipeline config"] = 1088,
    ["Wrangler CLI"] = 997,
    ["XenForo add-on manifest"] = 998,
    ["Xstate Machine"] = 1106,
    ["Yandex Workflow Language"] = 1230,
    ["Yarn Config (.yarnrc.yml)"] = 1062,
    ["Yippee-Ki-JSON configuration YML"] = 1053,
    ["YouTrack App"] = 1227,
    ["Zarf Package Configuration"] = 1294,
    ["Zerops import file"] = 1215,
    ["Zola Configuration"] = 1305,
    abtop = 30,
    actionlint = 40,
    ["aerleon.yml"] = 24,
    ["amplify.yml"] = 17,
    ["amxx-builder manifest"] = 1357,
    ["angular.json"] = 45,
    apko = 1177,
    ["app-definition.yaml"] = 49,
    ["apple-app-site-association"] = 47,
    ["appsettings.StormPetrel.json"] = 54,
    ["appsettings.json"] = 52,
    ["appsscript.json"] = 51,
    ["appveyor.yml"] = 53,
    ["aqua-generate-registry.yaml"] = 56,
    ["aqua-policy.yaml"] = 57,
    ["aqua.yaml"] = 55,
    ["arazzo.json"] = 59,
    ["arb.json"] = 60,
    ["arc.json"] = 62,
    ["architect.yml"] = 61,
    ["artifacthub-repo.yml"] = 66,
    ["asm-lsp"] = 67,
    ["ast-grep rules"] = 70,
    ["ast-grep sgconfig.yml"] = 69,
    ["azure.yaml"] = 78,
    ["babelrc.json"] = 132,
    ["bamboo-spec"] = 136,
    basedpyright = 134,
    ["bashly-strings.yml"] = 1154,
    ["batect.yml"] = 135,
    ["beef-database-codegen"] = 137,
    ["beef-database-v5-codegen"] = 139,
    ["beef-entity-codegen"] = 138,
    ["beef-entity-v5-codegen"] = 140,
    ["behat.yml"] = 153,
    ["bigquery-table"] = 141,
    ["bioimageio resource description"] = 1194,
    ["bitbucket-pipelines"] = 143,
    bitrise = 144,
    ["bitrise-step"] = 145,
    ["block.json"] = 170,
    ["bottom configuration"] = 94,
    ["bower.json"] = 147,
    ["bozr.suite.json"] = 157,
    bpkg = 1155,
    ["browser.i18n.json"] = 158,
    ["browsh configuration"] = 159,
    bucklescript = 160,
    ["buf.gen.yaml"] = 97,
    ["buf.lock"] = 98,
    ["buf.plugin.yaml"] = 99,
    ...
    ["build-changelog"] = 161,
    ["bun.lock"] = 166,
    ["bundleconfig.json"] = 167,
    ["bunfig.toml"] = 168,
    ["cargo-mutants-config.yaml"] = 102,
    ["cargo-nextest repository configuration"] = 640,
    ["cargo-nextest user configuration"] = 641,
    ["ccmod.json"] = 1239,
    changelogging = 1206,
    ["chisel-slices.json"] = 297,
    ["chrome-extension-locales-messages.json"] = 278,
    ["chutzpah.json"] = 279,
    cibuildwheel = 190,
    ["clang-format (.clang-format)"] = 1112,
    ["clang-tidy"] = 253,
    clangd = 252,
    clib = 254,
    ["cloud-init: cloud-config userdata"] = 256,
    ["cloud-sdk-pipeline-configuration"] = 281,
    ["cloudbuild.json"] = 282,
    cloudify = 255,
    cmakefmt = 208,
    ["cmdx.yaml"] = 105,
    ...
    ["commands.json"] = 274,
    ["commit-check"] = 300,
    ["commitlint (.commitlintrc)"] = 1048,
    ["committed.toml"] = 301,
    ["compile_commands.json"] = 273,
    ["compilerconfig.json"] = 272,
    ["completely.yml"] = 1150,
    ["component-detection-manifest.json"] = 304,
    ["component.json"] = 303,
    ["composer.json"] = 302,
    ["conda-forge"] = 194,
    ["config.yaml"] = 772,
    ["contentmanifest.json"] = 280,
    ["contribute.json"] = 305,
    ["cosmos.config.json"] = 276,
    ["crowdin.yml"] = 306,
    ["ctfd-setup configuration file"] = 1251,
    ["custom-elements.json"] = 1164,
    ["cypress.json"] = 310,
    ["dacier.yml"] = 1345,
    ["datalogic-scan2deploy-android"] = 320,
    ["datalogic-scan2deploy-ce"] = 321,
    ["dbt Dependencies"] = 215,
    ["dbt Packages"] = 217,
    ["dbt Project"] = 216,
    ["dbt Selectors"] = 218,
    ["dbt YAML files"] = 219,
    ...
    ["ddev-global"] = 322,
    ["ddev-project"] = 323,
    ["debugsettings.json"] = 324,
    ["dependabot-v2.json"] = 327,
    ["dependabot.json"] = 326,
    ["deployed-cli"] = 1105,
    ["devcontainer-feature.json"] = 264,
    ["devcontainer.json"] = 263,
    devinit = 1055,
    ["devspace.yaml"] = 1128,
    djlint = 1056,
    ["docker bake"] = 333,
    ["docker sequencer"] = 334,
    ["docker-compose.yml"] = 1054,
    ["dockerd.json"] = 331,
    ["dotnet Release Index manifest"] = 346,
    ["dotnet-tools.json"] = 347,
    ["dotnetcli.host.json"] = 348,
    ["dprint.json"] = 349,
    ["drone.json"] = 350,
    ["dss-2.0.0.json"] = 352,
    ["dstack configuration"] = 353,
    ["dtool dataset metadata"] = 1246,
    ["dvc.yaml"] = 354,
    ["ecosystem.json"] = 359,
    eksctl = 361,
    ["electron-builder configuration file"] = 387,
    ["epr-manifest.json"] = 386,
    ["estampo.toml"] = 385,
    ["evcc.yaml"] = 388,
    ["ezd task runner"] = 399,
    ["fabric.mod.json"] = 402,
    ["first-timers-bot"] = 410,
    ["flagd flag configuration"] = 127,
    ["fly.io Configuration"] = 128,
    fulibWorkflows = 1087,
    ["function.json"] = 422,
    ["gRPC API Gateway & OpenAPI Config"] = 19,
    ["gematik health care insurance list"] = 1257,
    ["gematik health care patient list"] = 1254,
    ["gematik health care provider institution list"] = 1256,
    ["gematik health care provider list"] = 1255,
    ["gematik tiger test environment configuration"] = 1258,
    ["git-cliff"] = 433,
    ["git-town.toml"] = 1303,
    ["gitlab-ci"] = 445,
    ["global.json"] = 462,
    ["go-feature-flag Flag Configuration"] = 466,
    gollama = 465,
    ["hassette.toml"] = 489,
    ["haxelib.json"] = 485,
    helmfile = 1041,
    ...
    ["ide.host.json"] = 501,
    ["ifstate.yaml"] = 502,
    ["imageoptimizer.json"] = 503,
    ["importmap.json"] = 506,
    ["index.toml (packwiz)"] = 1359,
    instant_python_config = 510,
    instant_python_custom_project = 511,
    intlayer = 512,
    ["ioBroker Configuration"] = 513,
    ["ioBroker JSON UI"] = 514,
    ["ioBroker Package manifest"] = 515,
    ["ixpect.conf.yaml"] = 516,
    ["ize.toml"] = 1141,
    ["jsconfig.json"] = 541,
    ["jscpd Configuration"] = 1125,
    jsdoc = 1037,
    ["k3d.yaml"] = 542,
    ["k9s aliases.yaml"] = 544,
    ["k9s cluster-config.yaml"] = 546,
    ["k9s config.yaml"] = 545,
    ["k9s hotkeys.yaml"] = 547,
    ["k9s plugins.yaml"] = 548,
    ["k9s skin.yaml"] = 549,
    ["k9s views.yaml"] = 550,
    ["kontinuous-config.yaml"] = 562,
    ["kontinuous-values.yaml"] = 561,
    ["kustomization.yaml"] = 564,
    ["label-commenter-config.yml"] = 565,
    ["latexindent configuration"] = 120,
    ["launchsettings.json"] = 566,
    lazydocker = 1163,
    lazygit = 1162,
    ["lego.json"] = 568,
    ["lerna.json"] = 569,
    ["lgtm.yml"] = 570,
    ["liblab.config.json"] = 571,
    ["libman.json"] = 572,
    ["license-report-config.json"] = 573,
    ["linkinator.config.json"] = 575,
    ["lint-staged (.lintstagedrc)"] = 1015,
    ["local.settings.json"] = 580,
    ["localazy.json"] = 581,
    ["lotus.yaml"] = 579,
    ["lsdlschema.json"] = 582,
    lychee = 1014,
    ["macro.json"] = 1129,
    ["markdown-link-check"] = 1083,
    maturin = 1084,
    mboats = 1091,
    memnex = 1343,
    ["micro-settings.json"] = 1156,
    ["mimetypes.json"] = 597,
    ["mirrord config"] = 1017,
    mise = 1018,
    ["mkdocs.yml"] = 617,
    ["mockd.yaml"] = 621,
    ["mod.pw.toml (packwiz)"] = 1360,
    ["modelparams.dev Model"] = 623,
    ["models CLI"] = 624,
    ["monospace.yml"] = 625,
    ["moon.yml"] = 1240,
    ["mprocs Configuration file"] = 1210,
    ["mrdocs.yml"] = 619,
    ["mta.yaml"] = 1019,
    ["mtad.yaml"] = 1020,
    ["mycode.json"] = 633,
    nFPM = 645,
    ["napari plugin manifest"] = 634,
    neoload = 1032,
    ["nest-cli"] = 648,
    ["nexus-rpc-gen"] = 1330,
    ["nf-core module environment.yml"] = 642,
    ["nf-core module meta.yml"] = 643,
    ["nf-core subworkflow meta.yml"] = 644,
    ["ninjs (News in JSON)"] = 647,
    ["nitro.json"] = 1031,
    ["nixd configuration"] = 1182,
    ["nlu.json"] = 649,
    ["nodemon.json"] = 652,
    ["noodl config"] = 1090,
    ["notebook.mod.json"] = 653,
    now = 1027,
    ["npm-badges"] = 656,
    ["nswag.json"] = 660,
    ntangle = 662,
    ["nuclei-template.yaml"] = 657,
    ["nuget-project.json"] = 658,
    ["ocelot.json"] = 664,
    ogen = 667,
    ["omnisharp.json"] = 670,
    openHAB = 1316,
    ...
    oxfmt = 1326,
    oxlint = 1327,
    ["pack.toml (packwiz)"] = 1361,
    ["package.json"] = 705,
    ["package.manifest"] = 707,
    ["package.yaml"] = 706,
    ["partial-black.json"] = 154,
    ["partial-fastapi.json"] = 155,
    ["partial-pixi.json"] = 717,
    ["partial-scheduled.json"] = 156,
    ["pattern.json"] = 715,
    ["petstore-v1.0"] = 1136,
    pgap_yaml_input_reader = 713,
    pgrls = 714,
    pgxgen = 1320,
    pitcms = 1323,
    ["pixi.toml"] = 716,
    ["plagiarize-me.yaml"] = 721,
    ["plagiarize.yaml"] = 720,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1247,
    ["podbard.yaml"] = 723,
    ["portman.json"] = 726,
    ["prefect.toml"] = 735,
    ["prefect.yaml"] = 736,
    ...
    ["prettierrc.json"] = 738,
    ["prisma.yml"] = 739,
    ["project-1.0.0-beta3.json"] = 751,
    ["project-1.0.0-beta4.json"] = 752,
    ["project-1.0.0-beta5.json"] = 753,
    ["project-1.0.0-beta6.json"] = 754,
    ["project-1.0.0-beta8.json"] = 755,
    ["project-1.0.0-rc1.json"] = 756,
    ["project-1.0.0-rc2.json"] = 757,
    ["project.json"] = 750,
    ["project.owasp.yaml"] = 758,
    ["prometheus-alertmanager.json"] = 762,
    ["prometheus.json"] = 759,
    ["prometheus.rules.json"] = 760,
    ["prometheus.rules.test.json"] = 761,
    ["proxies.json"] = 763,
    ["publiccode.yml"] = 764,
    ["pubspec.yaml"] = 765,
    ["pyrseas-0.8.json"] = 768,
    pytest = 777,
    ["quilt.mod.json"] = 1157,
    ["rc3 auth"] = 783,
    ["rc3 collection"] = 784,
    ...
    ["rc3 settings"] = 788,
    ["registry.yaml"] = 58,
    ["release drafter"] = 1033,
    ["release-hub.json"] = 6,
    ["release-please-config.json"] = 793,
    ["release-please-manifest.json"] = 794,
    ["release-plz.toml"] = 795,
    ["renv.lock"] = 809,
    ["reposets Configuration"] = 798,
    ["reposets Credentials"] = 799,
    ["revola.json"] = 4,
    ["rivet.json"] = 1181,
    ["rivet.yaml (legacy)"] = 1180,
    rumdl = 814,
    runny = 813,
    runspec = 1344,
    rustfmt = 815,
    ...
    samt = 818,
    samtrc = 819,
    ["sarif-1.0.0.json"] = 821,
    ["sarif-2.0.0.json"] = 822,
    ["sarif-2.1.0"] = 832,
    ["sarif-2.1.0-rtm.2"] = 823,
    ["sarif-2.1.0-rtm.3"] = 825,
    ["sarif-2.1.0-rtm.4"] = 827,
    ["sarif-2.1.0-rtm.5"] = 829,
    ["sarif-2.1.0-rtm.6"] = 830,
    ["sarif-external-property-file-2.1.0"] = 833,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 824,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 826,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 828,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 831,
    ["scalingo.json configuration"] = 834,
    ["schema.org - Action"] = 836,
    ["schema.org - ContactPoint"] = 837,
    ["schema.org - Place"] = 838,
    ["schema.org - Thing"] = 839,
    ["secrethub.yml"] = 1159,
    ["semantic-release"] = 847,
    ["servicehub.config.json"] = 1009,
    ["servicehub.service.json"] = 1008,
    ["settings.job"] = 850,
    ["sfdx-hardis configuration"] = 852,
    ["shard.yml"] = 1197,
    ["size-limit configuration"] = 857,
    ["skaffold.yaml"] = 1081,
    ["skyuxconfig.json"] = 859,
    ["snowflake-config"] = 861,
    ["snowflake-connections"] = 862,
    ["spicepod.yaml"] = 1218,
    ["sqlc configuration"] = 896,
    ["stripe-app-local.json"] = 907,
    ["stripe-app.json"] = 906,
    swcrc = 1065,
    ["task.json"] = 916,
    taskcat = 1028,
    ["template.json"] = 921,
    ["templatsources.json"] = 922,
    ["text2confl config"] = 1328,
    ["theme.json"] = 925,
    ["tizen_workspace.json"] = 927,
    tldr = 928,
    ["tm_devices configuration file"] = 1285,
    tmuxinator = 1012,
    tox = 930,
    ["transcend.yml"] = 939,
    ["tree-sitter grammar.json"] = 472,
    ["trime.yaml"] = 940,
    ["trunk.yaml"] = 942,
    ["ts-force-config.json"] = 947,
    ["tsconfig.json"] = 943,
    ["tsd.json"] = 944,
    ["tsdoc.json"] = 945,
    ["tsdrc.json"] = 946,
    ...
    v8r = 990,
    vcluster = 1204,
    ["vcpkg configuration file"] = 269,
    ["vcpkg manifest file"] = 268,
    ["vega-lite.json"] = 972,
    ["vega.json"] = 971,
    ["venvironment.yaml"] = 974,
    ["venvplus.yaml"] = 975,
    version = 1267,
    ["version.json"] = 977,
    ["vhwdebugger-binding.yaml"] = 979,
    ["vim-addon-info"] = 980,
    ["vs-2017.3.host.json"] = 982,
    ["vs-nesting.json"] = 983,
    ["vsls.json"] = 981,
    ["vss-extension.json"] = 987,
    vtcfg = 1273,
    ["vtesttree.yaml"] = 988,
    ["vtestunit.yaml"] = 989,
    ["warp-keysets.json"] = 1165,
    ["warp-themes.json"] = 1166,
    ["warp-workflows.json"] = 1167,
    ["webhint.io"] = 1121,
    ["webjobpublishsettings.json"] = 994,
    ["webjobs-list.json"] = 993,
    ["well-known-fursona"] = 1205,
    ["xs-app.json"] = 1023,
    ["xunit.runner.json"] = 1007,
    yamlfmt = 1050,
    yamllint = 1051,
    ["yap.json"] = 1052,
    ["zerops.yml"] = 1214,
