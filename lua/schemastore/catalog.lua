...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 167,
    [".cryproj (generic)"] = 585,
    [".cryproj engine-5.2"] = 580,
    [".cryproj engine-5.3"] = 581,
    [".cryproj engine-5.4"] = 582,
    [".cryproj engine-5.5"] = 583,
    [".cryproj engine-dev"] = 584,
    [".csscomb.json"] = 169,
    [".csslintrc"] = 170,
    [".es6importsorterrc.json"] = 711,
    [".eslintrc"] = 219,
    [".esmrc.json"] = 211,
    [".ffizer.yaml"] = 223,
    [".htmlhintrc"] = 273,
    ...
    [".mtaext"] = 594,
    [".nodehawkrc"] = 370,
    [".npmpackagejsonlintrc"] = 373,
    [".phraseapp.yml"] = 414,
    [".pmbot.yml"] = 404,
    [".postcssrc"] = 409,
    [".powerpages-web-template-manifest"] = 411,
    [".pre-commit-config.yml"] = 412,
    [".pre-commit-hooks.yml"] = 413,
    [".putout.json"] = 433,
    [".rehyperc"] = 445,
    [".remarkrc"] = 446,
    [".sprite files"] = 499,
    ...
    ["<div>RIOTS' studio configuration"] = 564,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 331,
    ["API Builder"] = 625,
    ["AVA Configuration"] = 681,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 656,
    ["All Contributors configuration file"] = 710,
    ...
    ["Azure Pipelines"] = 54,
    ["Azure Static Web Apps CLI configuration file"] = 502,
    ["Azure Static Web Apps configuration file"] = 501,
    ["BX CI"] = 89,
    ["Better Code Hub"] = 629,
    ["Better Scripts"] = 90,
    BizTalkServerApplicationSchema = 600,
    ...
    ["Butane Config"] = 668,
    ["CICS TS region tagging"] = 675,
    ["CICS TS resource import"] = 676,
    ["CICS TS resource model"] = 677,
    ["CICS TS resource overrides"] = 678,
    ["CMake Presets"] = 91,
    ["CNC Codes"] = 100,
    ...
    ["Goreleaser Pro"] = 255,
    Goss = 256,
    ["Gradle Build Cache Node"] = 627,
    ["Gradle Enterprise"] = 626,
    ...
    Hadolint = 609,
    Hammerkit = 636,
    ["Hardware Sentry Configuration"] = 686,
    Hayson = 268,
    ...
    ["JFrog File Spec"] = 292,
    ["JFrog Pipelines YML DSL"] = 695,
    ["JMeter DSL cli config"] = 293,
    JReleaser = 295,
    ["JSON Document Transform"] = 302,
    ["JSON Feed"] = 303,
    ["JSON Resume"] = 452,
    ...
    ["Jovo Language Models"] = 294,
    ["KSP-AVC"] = 571,
    ["KSP-CKAN"] = 572,
    ["Karakum configuration file"] = 233,
    Kas = 308,
    ["Keycloak REST API"] = 702,
    ["Knative Functions - func.yaml"] = 234,
    ["KoDE/CI build.yaml"] = 691,
    ["Kong DBLess config"] = 692,
    KrakenD = 309,
    LOOBin = 326,
    Lefthook = 317,
    ["LinkML Metamodel"] = 324,
    Liquibase = 641,
    ["Liquibase Flow File"] = 642,
    ["Lively Properties"] = 325,
    ["MS2Rescore Configuration"] = 358,
    Markdownlint = 645,
    ["Mason Registry"] = 647,
    ["MegaLinter configuration"] = 332,
    ["MegaLinter descriptor"] = 333,
    ["Meltano plugin discovery definition"] = 335,
    ["Meltano project definition"] = 334,
    ["Microsoft Band Web Tile"] = 336,
    ["Minecraft Data Pack Advancement"] = 338,
    ["Minecraft Data Pack Biome"] = 339,
    ["Minecraft Data Pack Configured Carver"] = 340,
    ["Minecraft Data Pack Damage Type"] = 341,
    ["Minecraft Data Pack Dimension"] = 343,
    ["Minecraft Data Pack Dimension Type"] = 342,
    ["Minecraft Data Pack Item Modifier"] = 344,
    ["Minecraft Data Pack Loot Table"] = 345,
    ["Minecraft Data Pack Metadata"] = 346,
    ["Minecraft Data Pack Predicate"] = 347,
    ["Minecraft Data Pack Recipe"] = 348,
    ["Minecraft Data Pack Tag"] = 349,
    ["Minecraft Data Pack Template Pool"] = 350,
    ["Minecraft Data Pack Trim Material"] = 355,
    ["Minecraft Data Pack Trim Pattern"] = 356,
    ["Minecraft Resource Pack Lang"] = 351,
    ["Minecraft Resource Pack Particle"] = 352,
    ["Minecraft Resource Pack Texture Mcmeta"] = 354,
    ["Minecraft Resourcepack Sounds"] = 353,
    ["MkDocs Configuration 1.0"] = 357,
    ["MongoDB Atlas Search Index Definition"] = 690,
    ["Monika Configuration"] = 688,
    ["Motif config"] = 593,
    ["NOX Framework (Service)"] = 372,
    ["Netin Diagnostic System Template"] = 651,
    ["Netlify config"] = 363,
    ["Nexus-as-Code Data Model"] = 364,
    ["Nightwatch.js"] = 365,
    ["ONe's service descriptor"] = 385,
    ["OSS Review Toolkit configuration"] = 392,
    ["OSS Review Toolkit curation"] = 393,
    ["OSS Review Toolkit package configuration"] = 394,
    ["OSS Review Toolkit repository configuration"] = 395,
    ["OSS Review Toolkit resolutions"] = 396,
    Opctl = 596,
    ["OpenRewrite Resource"] = 387,
    ["OpenWeather Current Weather API"] = 633,
    ["OpenWeather Road Risk API"] = 632,
    ["Ory Hydra configuration"] = 274,
    ["Ory Keto configuration"] = 311,
    ["Ory Kratos configuration"] = 391,
    ["Ory Oathkeeper configuration"] = 379,
    ["Outblocks App configuration"] = 389,
    ["Outblocks database table"] = 390,
    ["Outblocks project configuration"] = 388,
    Packer = 399,
    Pantsbuild = 709,
    ["Paper paper-plugin.yml"] = 400,
    ["Pipeline component"] = 643,
    ["PocketMine plugin.yml"] = 405,
    ["Postman collection"] = 410,
    ["Problem package generators"] = 417,
    Pterodactyl = 685,
    ["Pull Request Labeler"] = 432,
    Pulumi = 438,
    PyProject = 439,
    Pyright = 440,
    Qgoda = 441,
    Qodana = 661,
    ["Quali Torque Blueprint Spec 2"] = 683,
    ["QueryFirst config file"] = 705,
    ["RKE Cluster Configuration JSON"] = 640,
    ["RKE Cluster Configuration YAML"] = 639,
    ["Rancher Fleet"] = 435,
    Ray = 608,
    ["Read the Docs"] = 437,
    ["Red-DiscordBot Cog"] = 442,
    ["Red-DiscordBot Cog Repo"] = 443,
    ["Red-DiscordBot Trivia"] = 444,
    Renovate = 453,
    ["Replit config"] = 447,
    RoadRunner = 454,
    Ruff = 450,
    ["Rust Project"] = 451,
    ["Rust toolchain"] = 456,
    ["SIL Kit Participant Configuration"] = 487,
    ["SIL Kit Registry Configuration"] = 488,
    SWADL = 511,
    ["Safebox Config"] = 696,
    ["Sapphire CLI Config"] = 459,
    ["SauceCTL Configuration"] = 648,
    ["Schema Catalog"] = 473,
    ["Scoop manifest"] = 478,
    ["Semantic Data Fabric (SDF) file"] = 479,
    ["Semgrep Rule"] = 481,
    ["Serenity Code Generator (Sergen)"] = 482,
    ["Serverless Framework Configuration"] = 655,
    ["Serverless Workflow"] = 657,
    ["Settings.paf"] = 484,
    ["Shopware 6 Configuration"] = 658,
    ["Shopware CLI Extension Store Configuration"] = 659,
    ["Shopware CLI Project Store Configuration"] = 660,
    ["Sigrid scope configuration file"] = 486,
    ["Slack app manifest"] = 490,
    Solidarity = 493,
    ["Solution filters"] = 494,
    ["Source Maps v3"] = 495,
    Sourcery = 496,
    SpecIF = 497,
    ["Sponge Mixin configuration"] = 498,
    ["StackHawk Scanner Configuration"] = 654,
    Stale = 503,
    ["Starlake Data Pipeline"] = 630,
    Starship = 504,
    ["Statamic Blueprint"] = 505,
    ["StrmPrivacy Data Connector"] = 700,
    ["StrmPrivacy Data Contract"] = 701,
    ["StrmPrivacy SimpleSchema"] = 698,
    ["StrmPrivacy Stream"] = 699,
    ["StrmPrivacy batch job configuration file"] = 697,
    ["Stryker Mutator"] = 508,
    ["StyleCop Analyzers Configuration"] = 509,
    ["Swagger API 2.0"] = 512,
    TSON = 536,
    ["Talisman configuration"] = 514,
    ["Taskfile config"] = 635,
    Taurus = 515,
    ["TestEnvironment.json"] = 524,
    ["Tier.run pricing.json"] = 518,
    Tikibase = 519,
    ["Traefik v2"] = 527,
    ["Traefik v2 File Provider"] = 528,
    Turborepo = 525,
    Tye = 662,
    ["UET BuildConfig.json"] = 706,
    ["UI5 Manifest"] = 543,
    ["UTAM Page Object"] = 546,
    ["Ubuntu Server Autoinstall"] = 541,
    ["Uniswap Token List"] = 618,
    ["Unreal Engine Uplugin"] = 707,
    ["Unreal Engine Uproject"] = 708,
    Updatecli = 669,
    Uplift = 704,
    ["User Journey Map"] = 638,
    V2Ray = 673,
    ["VSCode Code Snippets"] = 138,
    ["VSIX CLI publishing"] = 559,
    ["Vela Pipeline Configuration"] = 549,
    Vercel = 137,
    ["Web App Manifest"] = 566,
    ["Web types"] = 569,
    WebExtensions = 565,
    ["Webman package recipe"] = 679,
    ["Windows Package Manager Installer Manifest"] = 615,
    ["Windows Package Manager Locale Manifest"] = 616,
    ["Windows Package Manager Singleton Manifest"] = 614,
    ["Woodpecker pipeline config"] = 650,
    ["Xstate Machine"] = 667,
    ["Yippee-Ki-JSON configuration YML"] = 620,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 65,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 715,
    ["bashly-strings.yml"] = 716,
    ["bashly.yml"] = 714,
    ["batect.yml"] = 64,
    ...
    ["ize.toml"] = 703,
    ["jsconfig.json"] = 306,
    ["jscpd Configuration"] = 684,
    jsdoc = 607,
    ["k3d.yaml"] = 307,
    ["kontinuous-config.yaml"] = 313,
    ["kontinuous-values.yaml"] = 312,
    ["kustomization.yaml"] = 314,
    ["label-commenter-config.yml"] = 315,
    ["launchsettings.json"] = 316,
    lazydocker = 725,
    lazygit = 724,
    ["lego.json"] = 318,
    ["lerna.json"] = 319,
    ["lgtm.yml"] = 320,
    ["libman.json"] = 321,
    ["license-report-config.json"] = 322,
    ["linkinator.config.json"] = 323,
    ["local.settings.json"] = 328,
    ["localazy.json"] = 329,
    ["lotus.yaml"] = 327,
    ["lsdlschema.json"] = 330,
    ["madness.yml"] = 713,
    ["markdown-lint-check"] = 646,
    mboats = 653,
    ["micro-settings.json"] = 718,
    ["mimetypes.json"] = 337,
    ["mirrord config"] = 590,
    ["mta.yaml"] = 591,
    ["mtad.yaml"] = 592,
    ["mycode.json"] = 361,
    ["napari plugin manifest"] = 362,
    neoload = 602,
    ["nest-cli"] = 368,
    ["ninjs (News in JSON) 1.3"] = 367,
    ["ninjs (News in JSON) 2.0"] = 366,
    ["nlu.json"] = 369,
    ["nodemon.json"] = 371,
    ["noodl config"] = 652,
    now = 598,
    ...
    ["nswag.json"] = 377,
    ntangle = 378,
    ["nuclei-template.yaml"] = 375,
    ["nuget-project.json"] = 376,
    ["ocelot.json"] = 380,
    ["omnisharp.json"] = 381,
    ["openapi.json"] = 382,
    ["openfin.json"] = 386,
    ...
    ["ops.yaml"] = 384,
    ["package.json"] = 397,
    ["package.manifest"] = 398,
    ["pathfinder.yml"] = 401,
    ["pattern.json"] = 403,
    ["petstore-v1.0"] = 694,
    pgap_yaml_input_reader = 402,
    ["plagiarize-me.yaml"] = 407,
    ["plagiarize.yaml"] = 406,
    ["portman.json"] = 408,
    ["prettierrc.json"] = 415,
    ["prisma.yml"] = 416,
    ["project-1.0.0-beta3.json"] = 419,
    ["project-1.0.0-beta4.json"] = 420,
    ["project-1.0.0-beta5.json"] = 421,
    ["project-1.0.0-beta6.json"] = 422,
    ["project-1.0.0-beta8.json"] = 423,
    ["project-1.0.0-rc1.json"] = 424,
    ["project-1.0.0-rc2.json"] = 425,
    ["project.json"] = 418,
    ["prometheus.json"] = 426,
    ["prometheus.rules.json"] = 427,
    ["prometheus.rules.test.json"] = 428,
    ["proxies.json"] = 429,
    ["publiccode.yml"] = 430,
    ["pubspec.yaml"] = 431,
    ["pyrseas-0.8.json"] = 434,
    ["quilt.mod.json"] = 719,
    ["release drafter"] = 603,
    rtx = 449,
    rustfmt = 455,
    samt = 457,
    samtrc = 458,
    ["sarif-1.0.0.json"] = 460,
    ["sarif-2.0.0.json"] = 461,
    ["sarif-2.1.0"] = 471,
    ["sarif-2.1.0-rtm.2"] = 462,
    ["sarif-2.1.0-rtm.3"] = 464,
    ["sarif-2.1.0-rtm.4"] = 466,
    ["sarif-2.1.0-rtm.5"] = 468,
    ["sarif-2.1.0-rtm.6"] = 469,
    ["sarif-external-property-file-2.1.0"] = 472,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 463,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 465,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 467,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 470,
    ["schema.org - Action"] = 474,
    ["schema.org - ContactPoint"] = 475,
    ["schema.org - Place"] = 476,
    ["schema.org - Thing"] = 477,
    ["secrethub.yml"] = 721,
    ["semantic-release"] = 480,
    ["servicehub.config.json"] = 579,
    ["servicehub.service.json"] = 578,
    ["settings.job"] = 483,
    ["sfdx-hardis configuration"] = 485,
    ["size-limit configuration"] = 489,
    ["skaffold.yaml"] = 644,
    ["skyuxconfig.json"] = 491,
    snapcraft = 492,
    ["sqlc configuration"] = 500,
    ["stripe-app-local.json"] = 507,
    ["stripe-app.json"] = 506,
    swcrc = 631,
    syntax = 723,
    ["task.json"] = 513,
    taskcat = 599,
    ["template.json"] = 516,
    ["templatsources.json"] = 517,
    ["theme.json"] = 520,
    ["tizen_workspace.json"] = 521,
    tldr = 522,
    tmLanguage = 523,
    tmuxinator = 587,
    ["transcend.yml"] = 529,
    ["trunk.yaml"] = 530,
    ["ts-force-config.json"] = 534,
    ["tsconfig.json"] = 531,
    ["tsd.json"] = 532,
    ["tsdrc.json"] = 533,
    ["tslint.json"] = 535,
    ...
    ["vega-lite.json"] = 548,
    ["vega.json"] = 547,
    ["venvironment-basic.yaml"] = 551,
    ["venvironment.yaml"] = 550,
    ["version.json"] = 552,
    ["vim-addon-info"] = 553,
    ["vs-2017.3.host.json"] = 555,
    ["vs-nesting.json"] = 556,
    ["vsls.json"] = 554,
    ["vss-extension.json"] = 560,
    ["vtesttree.yaml"] = 561,
    ["vtestunit.yaml"] = 562,
    ["warp-keysets.json"] = 727,
    ["warp-themes.json"] = 728,
    ["warp-workflows.json"] = 729,
    ["webhint.io"] = 680,
    ["webjobpublishsettings.json"] = 568,
    ["webjobs-list.json"] = 567,
    ["xs-app.json"] = 595,
    ["xunit.runner.json"] = 577,
    yamllint = 619,
    zuul = 604,
    ["Žinoma"] = 613
  },
