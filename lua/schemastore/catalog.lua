...
M.json = {
  ...
  index = {
    ...
    AIConfig = 47,
    ["AMX Muse Program Descriptor"] = 1320,
    ["API Builder"] = 1126,
    ["AVA Configuration"] = 1190,
    ...
    ["AWS Copilot Manifest"] = 1359,
    ["AWS SAM CLI Samconfig"] = 318,
    Acton = 1413,
    ["Adobe UXP Manifest"] = 1253,
    ["Aerleon Network & Service Definitions"] = 29,
    ["Aerleon Policy"] = 30,
    ["Agent Permission Policy"] = 1399,
    ["AgentCore CLI"] = 1400,
    ["AgentCtl MCP"] = 1402,
    ["AgentCtl config"] = 1401,
    ["AgentCtl permissions"] = 1403,
    AgentLoopKit = 1404,
    Aider = 1349,
    Air = 32,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1370,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1369,
    ["Airlock Microgateway"] = 48,
    ["Alacritty Configuration"] = 1162,
    ["AlgoVoi Compliance Receipt v1"] = 18,
    ["All Contributors configuration file"] = 1216,
    ...
    ["Application list for a WinUtil"] = 1299,
    ["ArchSmith diagram IR"] = 1438,
    ArchitectFX = 1304,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1368,
    ["Azure IoT Operations connector metadata"] = 1365,
    ...
    ["Bacon config"] = 12,
    ["Barba-CV"] = 101,
    ["Bashly (bashly.yml)"] = 1220,
    ["Bashly Settings (bashly-settings.yml)"] = 1221,
    Bento = 1386,
    ["Better Code Hub"] = 1131,
    ["Better Scripts"] = 188,
    Bigconfig = 154,
    ["Biome Formatter Config"] = 102,
    ["Bitmovin Encoding Template"] = 1313,
    BizTalkServerApplicationSchema = 1097,
    Bleep = 189,
    ["Block Protocol Metadata"] = 186,
    ["Bluebricks blueprint config"] = 1392,
    ["Boyka Framework"] = 167,
    ...
    ["Butane Config"] = 1175,
    C4InterFlow = 1328,
    ["CDK Environment Manager, concrete environment configuration"] = 1352,
    ["CDK Environment Manager, concrete environments definition"] = 1351,
    ["CDK Environment Manager, environment definition"] = 1350,
    ["CGS Card Game Specification (cgs.json)"] = 1258,
    ["CICS TS region tagging"] = 1184,
    ["CICS TS resource import"] = 1185,
    ["CICS TS resource model"] = 1186,
    ["CICS TS resource overrides"] = 1187,
    ["CMake Presets"] = 190,
    ["CNC Codes"] = 213,
    ["CRS WAF test file"] = 1288,
    ["CRS WAF test platform overrides file"] = 1289,
    ...
    ["Caido Proxy Configuration"] = 1428,
    ...
    ["Chamaleon environment"] = 1317,
    ["Chamaleon properties"] = 1318,
    ["Chamaleon template"] = 1316,
    Changepacks = 1379,
    Changesets = 327,
    Changie = 199,
    Charmcraft = 200,
    ...
    ["Claude Code Launch Preview"] = 1437,
    ["Claude Code Plugin Manifest"] = 221,
    ["Claude Code Plugin Marketplace"] = 222,
    ["Claude Code Settings"] = 223,
    ["Clawject config"] = 219,
    ["Cloud Foundry Application Manifest"] = 1270,
    ["Cloud Run Spec v1"] = 1294,
    ...
    Concord = 1287,
    ["Configu .cfgu files"] = 1275,
    ["Configu .configu file"] = 1276,
    Conjure = 212,
    ["Container Structure Test"] = 1111,
    Containerlab = 1140,
    ["Context Passport"] = 1,
    ["Contextive Glossary"] = 1344,
    ContractGuard = 1141,
    Convex = 211,
    ...
    ["Cursor Agent Environment"] = 1397,
    ["Custom Machinery Machine"] = 1259,
    ["Custom Machinery Recipe"] = 1260,
    ...
    ["DonateCaseBetterCasino menu"] = 1321,
    ["Draugr Saga"] = 358,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1228,
    ["EAS config"] = 433,
    ["ECA - Editor Code Assistant"] = 396,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1217,
    ["ESLint Suppressions"] = 438,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1364,
    ["EasyVCR .NET"] = 435,
    ["Eidolon Resource"] = 1305,
    ...
    ["Envelope Team Definition"] = 1412,
    ["Envilder Map File"] = 401,
    ["Erda Pipeline"] = 1266,
    ["Erda Runtime"] = 1267,
    ["Espanso config.yml"] = 1390,
    ["Espanso match.yml"] = 1389,
    Esquio = 421,
    ["Estuary Flow Catalog"] = 1181,
    ["Ethereum ERC1155"] = 1406,
    ["Ethereum ERC721"] = 1405,
    ...
    ["Evolving Resolutive Process notation"] = 1366,
    ["Expo SDK"] = 432,
    ...
    ["GeoJSON.json latest"] = 1179,
    GherKing = 1183,
    ["GitHub Action"] = 476,
    ["GitHub Actions typing"] = 1301,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 1255,
    ...
    ["Google Digital Assetlinks"] = 1345,
    Goreleaser = 512,
    ["Goreleaser Pro"] = 513,
    Goss = 515,
    ["Gradle Build Cache Node"] = 1129,
    ["Gradle Enterprise"] = 1128,
    ...
    Hadolint = 1107,
    Hammerkit = 1139,
    ["Hardware Sentry Configuration"] = 1195,
    ...
    ["Hecate Input Schema"] = 1356,
    ["Helm Chart.lock"] = 275,
    ["Helm Chart.yaml"] = 274,
    ["Helm Unittest Test Suite"] = 276,
    ["Heloisa Assistant Plugins Marketplace"] = 1435,
    ["Hex file"] = 277,
    ...
    ["JFrog File Spec"] = 571,
    ["JFrog Pipelines YML DSL"] = 1205,
    ["JMeter DSL cli config"] = 572,
    JReleaser = 575,
    ["JSON Document Transform"] = 583,
    ["JSON Feed"] = 584,
    ["JSON Resume"] = 861,
    ["JSON Schema Draft 2020-12"] = 1073,
    ["JSON Schema Draft 4"] = 1070,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1238,
    ["JSON Schema Draft 7"] = 1071,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1239,
    ["JSON Schema Draft 8 (2019-09)"] = 1072,
    ["JSON-API"] = 582,
    ["JSON-e templates"] = 1136,
    ["JSON-stat 2.0"] = 1066,
    JSONPatch = 586,
    ...
    Jsontron = 587,
    ["Jujutsu (jj) VCS config"] = 1358,
    ["KIMMDY config file"] = 598,
    ["KODE/CI build.yaml"] = 1201,
    ["KSP-AVC"] = 1067,
    ["KSP-CKAN"] = 1068,
    ["KSP-NetKAN"] = 1069,
    KSY = 1268,
    ...
    ["Kong DBLess config"] = 1202,
    KrakenD = 602,
    ["Kubri Configuration"] = 610,
    LOOBin = 628,
    ["Lake configuration file"] = 1361,
    ...
    ["Lando (landofile)"] = 128,
    ["LangGraph Platform configuration"] = 1280,
    ["Language configuration"] = 1279,
    Lefthook = 615,
    ...
    ["Madness (madness.yml)"] = 1219,
    ["Mado configuration"] = 635,
    ["Maestro Flow"] = 636,
    ["Mail Servers Configuration"] = 1393,
    ["MapEHR Mapping"] = 637,
    Markdownlint = 1150,
    ["Mason Registry"] = 1153,
    ...
    ["Metadata for a Cinnamon spice"] = 1297,
    ["Metatype Configuration"] = 644,
    ["MetricsHub Configuration"] = 645,
    ["MetricsHub Connector Configuration"] = 646,
    ["Micro Editor Syntax"] = 1229,
    ["Microsoft Band Web Tile"] = 647,
    ["Microsoft RulesEngine workflow rules"] = 1284,
    ["Microsoft RulesEngine workflow rules list"] = 1285,
    ["Minecraft Custom Main Menu Mod"] = 1247,
    ...
    ["MongoDB Atlas Search Index Definition"] = 1200,
    ["Monika Configuration"] = 1198,
    ["Monoweave Configuration"] = 678,
    ["Motif config"] = 1089,
    MultiQC = 1338,
    ["NOX Framework (Service)"] = 706,
    ["Netin Diagnostic System Template"] = 1157,
    ["Netlify config"] = 687,
    ...
    ["Nightwatch.js"] = 698,
    ["Nika workflow"] = 703,
    ["Node.js configuration"] = 1094,
    ["NueJS configuration file"] = 711,
    ["Nuitka Package Config"] = 1261,
    ...
    ["OpenUtau ustx"] = 732,
    ["OpenWeather Current Weather API"] = 1135,
    ["OpenWeather Road Risk API"] = 1134,
    ...
    ["Pipeline component"] = 1148,
    ["Platform.sh application"] = 14,
    ["Platform.sh routes"] = 15,
    ["Platform.sh services"] = 16,
    ["Plex Prerolls"] = 778,
    ["PocketMine plugin.yml"] = 775,
    ["Podman Desktop Extension"] = 1430,
    ["Postman collection"] = 784,
    ["Power Pages Configuration"] = 1355,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1300,
    ...
    Pylock = 1346,
    Pyright = 832,
    ["Python script metadata"] = 1340,
    ["QType AI DSL"] = 835,
    Qgoda = 834,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1422,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1420,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1426,
    ["Qlik Talend Cloud Pipeline - Project"] = 1418,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1421,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1423,
    ["Qlik Talend Cloud Pipeline - Task"] = 1419,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1425,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1424,
    Qodana = 1167,
    ["Qt Creator workspace file"] = 1277,
    ["Quali Torque Blueprint Spec 2"] = 1192,
    ["QueryFirst config file"] = 1211,
    ["QuikRun Configuration"] = 1427,
    ["Qwen Code Settings"] = 1407,
    ["RKE Cluster Configuration JSON"] = 1145,
    ["RKE Cluster Configuration YAML"] = 1144,
    RadioHound = 825,
    ["Raid Profile"] = 1408,
    ["Raid Repo Configuration"] = 1409,
    Railpack = 837,
    Railway = 836,
    ["Rancher Fleet"] = 827,
    ["Rattler-build"] = 838,
    ...
    ["Replit config"] = 853,
    Restate = 1333,
    ["Revel Digital Gadget Definition File"] = 1357,
    RoadRunner = 867,
    ["Robust Station Image"] = 1363,
    Rockcraft = 868,
    ["Roo Coder Custom Modes"] = 869,
    Rubocop = 858,
    ["Rudder techniques"] = 1251,
    Ruff = 859,
    ["Rust Project"] = 860,
    ["Rust toolchain"] = 874,
    ...
    ["Serverless Framework Configuration"] = 1161,
    ["Serverless Workflow"] = 1163,
    ["Settings for a Cinnamon spice"] = 1296,
    ["Settings.paf"] = 908,
    ["Shopware 6 Configuration"] = 1164,
    ["Shopware CLI Extension Store Configuration"] = 1165,
    ["Shopware CLI Project Store Configuration"] = 1166,
    ["Sigma Detection Rule"] = 910,
    ["SigmaCV CV"] = 6,
    ["Sigrid scope configuration file"] = 911,
    ["SkyPilot Task JSON"] = 1252,
    ["Slack app manifest"] = 918,
    ["Slang Server Configuration"] = 1434,
    Snapcraft = 920,
    ...
    StackBlitz = 959,
    ["StackHawk Scanner Configuration"] = 1160,
    Stale = 960,
    Starfish = 961,
    ["Starlake Data Pipeline"] = 1132,
    Starship = 962,
    ...
    ["Tab data for a LinUtil"] = 1303,
    ["Tab list for a LinUtil"] = 1302,
    Tach = 978,
    ["Tach Domain"] = 979,
    Talhelper = 981,
    ["Talisman configuration"] = 982,
    Taplo = 1348,
    ["Taskfile config"] = 1137,
    Taurus = 983,
    Tauticord = 984,
    ["Tekton Pipeline"] = 1376,
    ["Tekton PipelineRun"] = 1377,
    ["Tekton Task"] = 1374,
    ["Tekton TaskRun"] = 1375,
    Telefonistka = 1334,
    ["Terrateam config"] = 1360,
    ...
    ["Tugboat QA config.yml"] = 1327,
    TunnelHub = 1242,
    Turborepo = 997,
    Tycho = 1291,
    Tye = 1168,
    ["Tyk Gateway - Open Source v5.7+"] = 1339,
    ["UET BuildConfig.json"] = 1212,
    ["UI5 Manifest"] = 1028,
    ["UNCORS configuration"] = 1033,
    ["UTAM Page Object"] = 1031,
    ["Ubuntu Server Autoinstall"] = 1026,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1331,
    ["Uniswap Token List"] = 1117,
    ["Universal Schedule Format"] = 1034,
    ["Unreal Engine Uplugin"] = 1213,
    ["Unreal Engine Uproject"] = 1214,
    ["UpCloud CLI (upctl) configuration"] = 1332,
    ["Updatecli Compose"] = 1176,
    ["Updatecli Policy Manifest"] = 1177,
    ["Updatecli Policy Metadata"] = 1178,
    Uplift = 1210,
    ["Upsun config"] = 13,
    ["User Journey Map"] = 1142,
    V2Ray = 1182,
    ["VSCode Code Snippets"] = 302,
    ["VSIX CLI publishing"] = 1053,
    Vector = 1036,
    ["Vela Pipeline Configuration"] = 1039,
    Vercel = 301,
    ["Version Bumper config"] = 1042,
    Vespertide = 1381,
    ["Vespertide Migration"] = 1382,
    ["Vespertide Model"] = 1383,
    ["Viash Component Config"] = 1336,
    ["Viash Package Config"] = 1337,
    Visivo = 1240,
    Vogi = 1047,
    ["WP-CLI"] = 1063,
    Wake = 1329,
    ["Waku Config"] = 1306,
    ["Web App Manifest"] = 1059,
    ["Web types"] = 1062,
    WebExtensions = 1058,
    ["Webman package recipe"] = 1188,
    ["Windows Package Manager Installer Manifest"] = 1114,
    ["Windows Package Manager Locale Manifest"] = 1115,
    ["Windows Package Manager Singleton Manifest"] = 1113,
    ["WireMock CLI import configuration"] = 1312,
    ["WireMock CLI local service configuration"] = 1311,
    ["WireMock message stub mapping"] = 1310,
    ["WireMock stub mapping"] = 1309,
    ["Woodpecker pipeline config"] = 1156,
    ["Wrangler CLI"] = 1064,
    ["XenForo add-on manifest"] = 1065,
    ["Xstate Machine"] = 1174,
    ["Yandex Workflow Language"] = 1298,
    ["Yarn Config (.yarnrc.yml)"] = 1130,
    ["Yippee-Ki-JSON configuration YML"] = 1121,
    ["YouTrack App"] = 1295,
    ["Zarf Package Configuration"] = 1362,
    ["Zerops import file"] = 1283,
    ["Zola Configuration"] = 1373,
    abtop = 34,
    act3 = 1414,
    actionlint = 44,
    ["aerleon.yml"] = 28,
    ["amplify.yml"] = 21,
    ["amxx-builder manifest"] = 1429,
    ["angular.json"] = 49,
    apko = 1245,
    ...
    ["behat.yml"] = 168,
    ["bigquery-table"] = 153,
    ["bioimageio resource description"] = 1262,
    ...
    ["chutzpah.json"] = 310,
    cibuildwheel = 206,
    ["clang-format (.clang-format)"] = 1180,
    ["clang-tidy"] = 283,
    clangd = 282,
    clib = 284,
    ...
    ["crowdin.yml"] = 337,
    crucible = 341,
    ["ctfd-setup configuration file"] = 1319,
    ["custom-elements.json"] = 1232,
    ["cypress.json"] = 342,
    ["dacier.yml"] = 1417,
    ...
    ["gematik health care insurance list"] = 1325,
    ["gematik health care patient list"] = 1322,
    ["gematik health care provider institution list"] = 1324,
    ["gematik health care provider list"] = 1323,
    ["gematik tiger test environment configuration"] = 1326,
    ["gh-dash"] = 474,
    ["gha-doctor"] = 475,
    ["git-cliff"] = 471,
    ["git-town.toml"] = 1371,
    ...
    lychee = 1081,
    ["macro.json"] = 1197,
    ["markdown-link-check"] = 1151,
    maturin = 1152,
    mboats = 1159,
    memnex = 1415,
    ["micro-settings.json"] = 1224,
    ["mimetypes.json"] = 648,
    ["mirrord config"] = 1085,
    ["misata.yaml"] = 1084,
    mise = 1086,
    ["mkdocs.yml"] = 668,
    ["mockd.yaml"] = 672,
    ["mod.pw.toml (packwiz)"] = 1432,
    ["modelparams.dev Model"] = 675,
    ["models CLI"] = 676,
    ["monospace.yml"] = 677,
    ["moon.yml"] = 1308,
    ["mprocs Configuration file"] = 1278,
    ["mrdocs.yml"] = 670,
    ["mta.yaml"] = 1087,
    ["mtad.yaml"] = 1088,
    ["mycode.json"] = 685,
    ...
    ["plagiarize.yaml"] = 776,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1315,
    ["podbard.yaml"] = 779,
    ["portman.json"] = 782,
    ["prefect.toml"] = 791,
    ["prefect.yaml"] = 792,
    ...
    servercn = 1440,
    ["servicehub.config.json"] = 1076,
    ["servicehub.service.json"] = 1075,
    ["settings.job"] = 907,
    ...
    ["text2confl config"] = 1396,
    ["theme.json"] = 989,
    ["tizen_workspace.json"] = 991,
    tldr = 992,
    ["tm_devices configuration file"] = 1353,
    tmuxinator = 1079,
    tox = 994,
    ["transcend.yml"] = 1003,
    ...
    ["vega-lite.json"] = 1038,
    ["vega.json"] = 1037,
    ["venvironment.yaml"] = 1040,
    ["venvplus.yaml"] = 1041,
    version = 1335,
    ["version.json"] = 1043,
    ["vhwdebugger-binding.yaml"] = 1045,
    ["vim-addon-info"] = 1046,
    ["vs-2017.3.host.json"] = 1049,
    ["vs-nesting.json"] = 1050,
    ["vsls.json"] = 1048,
    ["vss-extension.json"] = 1054,
    vtcfg = 1341,
    ["vtesttree.yaml"] = 1055,
    ["vtestunit.yaml"] = 1056,
    ["warp-keysets.json"] = 1233,
    ["warp-themes.json"] = 1234,
    ["warp-workflows.json"] = 1235,
    ["webhint.io"] = 1189,
    ["webjobpublishsettings.json"] = 1061,
    ["webjobs-list.json"] = 1060,
    ["well-known-fursona"] = 1273,
    ["xs-app.json"] = 1091,
    ["xunit.runner.json"] = 1074,
    ["yaml-workflow"] = 1439,
    yamlfmt = 1118,
    yamllint = 1119,
    ["yap.json"] = 1120,
