...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 179,
    [".cryproj (generic)"] = 616,
    [".cryproj engine-5.2"] = 611,
    [".cryproj engine-5.3"] = 612,
    [".cryproj engine-5.4"] = 613,
    [".cryproj engine-5.5"] = 614,
    [".cryproj engine-dev"] = 615,
    [".csscomb.json"] = 181,
    [".csslintrc"] = 182,
    [".es6importsorterrc.json"] = 747,
    [".eslintrc"] = 231,
    [".esmrc.json"] = 223,
    [".ffizer.yaml"] = 235,
    [".htmlhintrc"] = 288,
    ...
    [".mtaext"] = 625,
    [".nodehawkrc"] = 390,
    [".npmpackagejsonlintrc"] = 393,
    [".phraseapp.yml"] = 437,
    [".pmbot.yml"] = 426,
    [".postcssrc"] = 432,
    [".powerpages-web-template-manifest"] = 434,
    [".pre-commit-config.yml"] = 435,
    [".pre-commit-hooks.yml"] = 436,
    [".putout.json"] = 456,
    [".rehyperc"] = 468,
    [".remarkrc"] = 469,
    [".sprite files"] = 524,
    ...
    ["<div>RIOTS' studio configuration"] = 595,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 349,
    ["API Builder"] = 657,
    ["AVA Configuration"] = 716,
    ["AWS CDK cdk.json"] = 163,
    ["AWS CloudFormation"] = 164,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 165,
    ["AWS SAM CLI Samconfig"] = 166,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 13,
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 689,
    ["All Contributors configuration file"] = 746,
    ...
    ["Azure Pipelines"] = 59,
    ["Azure Static Web Apps CLI configuration file"] = 527,
    ["Azure Static Web Apps configuration file"] = 526,
    ["BX CI"] = 95,
    ["Better Code Hub"] = 661,
    ["Better Scripts"] = 96,
    Bigconfig = 76,
    BizTalkServerApplicationSchema = 631,
    Bleep = 97,
    ...
    ["Butane Config"] = 701,
    ["CICS TS region tagging"] = 710,
    ["CICS TS resource import"] = 711,
    ["CICS TS resource model"] = 712,
    ["CICS TS resource overrides"] = 713,
    ["CMake Presets"] = 98,
    ["CNC Codes"] = 108,
    ...
    Cheatsheets = 698,
    ["Chrome Extension"] = 156,
    ["CircleCI config.yml"] = 133,
    ["Citation File Format"] = 168,
    CityJSON = 106,
    ["Code Climate"] = 134,
    CodeCV = 57,
    ["CodeShip Pro services configuration files"] = 145,
    ["CodeShip Pro steps configuration files"] = 146,
    ["Codecov configuration files"] = 144,
    Codux = 142,
    ["Cog config file"] = 109,
    ["Commandbox Box.json"] = 110,
    ["Commandbox Server.json"] = 111,
    ["Common Catalog Data"] = 154,
    ["Common types for all schemas"] = 1,
    Conjure = 107,
    ["Container Structure Test"] = 644,
    Containerlab = 669,
    ["Crowdsec collection config"] = 175,
    ["Crowdsec parser config"] = 176,
    ["Crowdsec scenario config"] = 177,
    ["DWP Exchange - catalogue entry"] = 220,
    ["DWP Exchange - gateway"] = 218,
    ["DWP Exchange - meta"] = 219,
    ["Dart build configuration"] = 183,
    ["Dart test config"] = 184,
    ["DashLord configuration"] = 185,
    ["Data Contract Specification"] = 186,
    ["Databricks Asset Bundles"] = 767,
    ["Datadog Service Definition"] = 327,
    ["Datahub Ingestion Recipe"] = 717,
    ["Dein Config"] = 113,
    Deno = 192,
    ["Deployer Recipe"] = 195,
    ["Deta Spacefile"] = 114,
    ...
    Devfile = 217,
    ["Discord Webhook"] = 197,
    ["Dolittle Artifacts"] = 201,
    ["Dolittle Bounded Context Configuration"] = 202,
    ["Dolittle Event Horizons Configuration"] = 203,
    ["Dolittle Resources Configuration"] = 204,
    ["Dolittle Server Configuration"] = 205,
    ["Dolittle Tenant Map Configuration"] = 207,
    ["Dolittle Tenants Configuration"] = 206,
    ["Dolittle Topology"] = 208,
    ["Drupal Breakpoints"] = 117,
    ["Drupal Config"] = 128,
    ["Drupal Info"] = 118,
    ["Drupal Layouts"] = 119,
    ["Drupal Libraries"] = 120,
    ["Drupal Links Action"] = 121,
    ["Drupal Links Contextual"] = 122,
    ["Drupal Links Menu"] = 123,
    ["Drupal Links Task"] = 124,
    ["Drupal Migration"] = 125,
    ["Drupal Permissions"] = 126,
    ["Drupal Routing"] = 127,
    ["Drupal Services"] = 129,
    ["Drush site aliases"] = 213,
    ["Embrace Config"] = 728,
    Endurica = 770,
    ["Error pages"] = 226,
    Esquio = 224,
    ["Estuary Flow Catalog"] = 707,
    ["Expo SDK"] = 229,
    ["F-Droid Data metadata"] = 234,
    ["Facets - FSDL - Application"] = 232,
    ["FasterCI Configuration"] = 60,
    FiQuS = 238,
    Firebase = 236,
    ["Fossa configuration file"] = 245,
    ["Fossa's fossa-deps file"] = 246,
    ["Foundry VTT - Base package Manifest"] = 240,
    ["Foundry VTT - Module Manifest"] = 241,
    ["Foundry VTT - System Data Template"] = 244,
    ["Foundry VTT - System Manifest"] = 242,
    ["Foundry VTT - World Manifest"] = 243,
    ["Foxx Manifest"] = 61,
    ["Freifunk.de Community API"] = 64,
    ["Frogbot Config"] = 65,
    ["G2P Mapping Configuration"] = 250,
    ["GCP Blueprint Metadata"] = 253,
    Gaspar = 251,
    ["GatewayCore API Gateway"] = 252,
    ["GeoJSON.json latest"] = 705,
    GherKing = 709,
    ["GitHub Action"] = 257,
    ["GitHub Discussion"] = 258,
    ["GitHub Funding"] = 259,
    ["GitHub Issue Template configuration"] = 261,
    ["GitHub Workflow"] = 262,
    ["GitHub Workflow Template Properties"] = 263,
    ["GitHub issue forms"] = 260,
    GitVersion = 256,
    ["Gitpod Configuration"] = 265,
    ["Global Privacy Control"] = 254,
    Goblet = 766,
    ["Google Chrome Related Website Sets"] = 237,
    ["Google Cloud Workflows"] = 162,
    Goreleaser = 269,
    ["Goreleaser Pro"] = 270,
    Goss = 271,
    ["Gradle Build Cache Node"] = 659,
    ["Gradle Enterprise"] = 658,
    ["Grafana 5.x Dashboard"] = 272,
    ["GraphQL Code Generator"] = 275,
    ["GraphQL Config"] = 274,
    ["GraphQL Mesh"] = 273,
    ["Grunt JSHint task"] = 279,
    ["Grunt Watch task"] = 280,
    ["Grunt base task"] = 281,
    ["Grunt clean task"] = 277,
    ["Grunt copy task"] = 276,
    ["Grunt cssmin task"] = 278,
    HEMTT = 628,
    Hadolint = 640,
    Hammerkit = 668,
    ["Hardware Sentry Configuration"] = 721,
    Hatch = 641,
    Hayson = 283,
    ["Haystack Pipeline"] = 284,
    ["Hazelcast 5 Configuration"] = 285,
    ["Helm Chart.lock"] = 131,
    ["Helm Chart.yaml"] = 130,
    ["Helm Unittest Test Suite"] = 132,
    Hugo = 697,
    ["IBM Zapp document"] = 290,
    ["IBM zCodeFormatSettings"] = 291,
    ["IMG Catapult PSP"] = 296,
    Istanbul = 724,
    ["JDownloader2 crawler multi-rules"] = 306,
    ["JDownloader2 crawler single-rules"] = 305,
    ["JFrog Applications Config"] = 307,
    ["JFrog File Spec"] = 308,
    ["JFrog Pipelines YML DSL"] = 730,
    ["JMeter DSL cli config"] = 309,
    JReleaser = 311,
    ["JSON Document Transform"] = 318,
    ["JSON Feed"] = 319,
    ["JSON Resume"] = 475,
    ["JSON Schema Draft 2020-12"] = 607,
    ["JSON Schema Draft 4"] = 604,
    ["JSON Schema Draft 7"] = 605,
    ["JSON Schema Draft 7 (unofficial strict)"] = 768,
    ["JSON Schema Draft 8 (2019-09)"] = 606,
    ["JSON-API"] = 317,
    ["JSON-e templates"] = 666,
    ["JSON-stat 2.0"] = 601,
    JSONPatch = 321,
    Jasmine = 301,
    Jekyll = 302,
    ["Jenkins X Pipelines"] = 303,
    ["Jenkins X Requirements"] = 304,
    ["Jovo Language Models"] = 310,
    ["KSP-AVC"] = 602,
    ["KSP-CKAN"] = 603,
    ["Karakum configuration file"] = 247,
    Kas = 324,
    ["Keycloak REST API"] = 738,
    ["Knative Functions - func.yaml"] = 248,
    ["KoDE/CI build.yaml"] = 726,
    ["Kong DBLess config"] = 727,
    KrakenD = 326,
    LOOBin = 344,
    Lefthook = 334,
    ["Liferay client-extension.yaml"] = 340,
    ["LinkML Metamodel"] = 342,
    Liquibase = 673,
    ["Liquibase Flow File"] = 674,
    ["Lively Properties"] = 343,
    ["Lobe AI Agent"] = 58,
    ["MLOS Configs"] = 376,
    ["MS2Rescore Configuration"] = 378,
    Markdownlint = 677,
    ["Mason Registry"] = 679,
    ["MegaLinter configuration"] = 350,
    ["MegaLinter descriptor"] = 351,
    Melange = 774,
    ["Meltano plugin discovery definition"] = 353,
    ["Meltano project definition"] = 352,
    ["Microsoft Band Web Tile"] = 354,
    ["Minecraft Custom Main Menu Mod"] = 775,
    ["Minecraft Data Pack Advancement"] = 356,
    ["Minecraft Data Pack Biome"] = 357,
    ["Minecraft Data Pack Configured Carver"] = 358,
    ["Minecraft Data Pack Damage Type"] = 359,
    ["Minecraft Data Pack Dimension"] = 361,
    ["Minecraft Data Pack Dimension Type"] = 360,
    ["Minecraft Data Pack Item Modifier"] = 362,
    ["Minecraft Data Pack Loot Table"] = 363,
    ["Minecraft Data Pack Metadata"] = 364,
    ["Minecraft Data Pack Predicate"] = 365,
    ["Minecraft Data Pack Recipe"] = 366,
    ["Minecraft Data Pack Tag"] = 367,
    ["Minecraft Data Pack Template Pool"] = 368,
    ["Minecraft Data Pack Trim Material"] = 373,
    ["Minecraft Data Pack Trim Pattern"] = 374,
    ["Minecraft Resource Pack Lang"] = 369,
    ["Minecraft Resource Pack Particle"] = 370,
    ["Minecraft Resource Pack Texture Mcmeta"] = 372,
    ["Minecraft Resourcepack Sounds"] = 371,
    ["MkDocs Configuration 1.0"] = 375,
    ["MongoDB Atlas Search Index Definition"] = 725,
    ["Monika Configuration"] = 723,
    ["Motif config"] = 624,
    ["NOX Framework (Service)"] = 392,
    ["Netin Diagnostic System Template"] = 683,
    ["Netlify config"] = 383,
    ["Network-as-Code Data Model"] = 384,
    ["Nightwatch.js"] = 385,
    ["ONe's service descriptor"] = 407,
    ["OSS Review Toolkit configuration"] = 414,
    ["OSS Review Toolkit curation"] = 415,
    ["OSS Review Toolkit package configuration"] = 416,
    ["OSS Review Toolkit repository configuration"] = 417,
    ["OSS Review Toolkit resolutions"] = 418,
    Opctl = 627,
    ["OpenRewrite Resource"] = 409,
    ["OpenUtau character yaml"] = 404,
    ["OpenUtau ustx"] = 405,
    ["OpenWeather Current Weather API"] = 665,
    ["OpenWeather Road Risk API"] = 664,
    ["Ory Hydra configuration"] = 289,
    ["Ory Keto configuration"] = 328,
    ["Ory Kratos configuration"] = 413,
    ["Ory Oathkeeper configuration"] = 399,
    ["Outblocks App configuration"] = 411,
    ["Outblocks database table"] = 412,
    ["Outblocks project configuration"] = 410,
    Packer = 421,
    Pantsbuild = 745,
    ["Paper paper-plugin.yml"] = 422,
    ["Pipeline component"] = 675,
    ["PocketMine plugin.yml"] = 427,
    Poetry = 428,
    ["Postman collection"] = 433,
    ["Problem object RFC9457"] = 772,
    ["Problem package generators"] = 440,
    Pterodactyl = 720,
    ["Pull Request Labeler"] = 455,
    Pulumi = 461,
    PyProject = 462,
    Pyright = 463,
    Qgoda = 464,
    Qodana = 694,
    ["Quali Torque Blueprint Spec 2"] = 718,
    ["QueryFirst config file"] = 741,
    ["RKE Cluster Configuration JSON"] = 672,
    ["RKE Cluster Configuration YAML"] = 671,
    ["Rancher Fleet"] = 458,
    Ray = 639,
    ["Read the Docs"] = 460,
    ["Red-DiscordBot Cog"] = 465,
    ["Red-DiscordBot Cog Repo"] = 466,
    ["Red-DiscordBot Trivia"] = 467,
    RenderCV = 477,
    Renovate = 476,
    ["Replit config"] = 470,
    RoadRunner = 478,
    ...
    ["Rust Project"] = 474,
    ["Rust toolchain"] = 480,
    ["SIL Kit Participant Configuration"] = 512,
    ["SIL Kit Registry Configuration"] = 513,
    SWADL = 538,
    ["Safebox Config"] = 731,
    ["Sapphire CLI Config"] = 483,
    ["SauceCTL Configuration"] = 680,
    ["Schema Catalog"] = 497,
    ["Scoop manifest"] = 502,
    ["Semantic Data Fabric (SDF) file"] = 503,
    ["Semgrep Rule"] = 505,
    ["Serenity Code Generator (Sergen)"] = 506,
    ["Serverless Framework Configuration"] = 688,
    ["Serverless Workflow"] = 690,
    ["Settings.paf"] = 508,
    Setuptools = 509,
    ["Shopware 6 Configuration"] = 691,
    ["Shopware CLI Extension Store Configuration"] = 692,
    ["Shopware CLI Project Store Configuration"] = 693,
    ["Sigrid scope configuration file"] = 511,
    ["Slack app manifest"] = 515,
    Solidarity = 518,
    ["Solution filters"] = 519,
    ["Source Maps v3"] = 520,
    Sourcery = 521,
    SpecIF = 522,
    ["Sponge Mixin configuration"] = 523,
    StackBlitz = 528,
    ["StackHawk Scanner Configuration"] = 687,
    Stale = 529,
    ["Starlake Data Pipeline"] = 662,
    Starship = 530,
    ["Statamic Blueprint"] = 531,
    ["Stella configuration file"] = 532,
    ["StrmPrivacy Data Connector"] = 735,
    ["StrmPrivacy Data Contract"] = 736,
    ["StrmPrivacy SimpleSchema"] = 733,
    ["StrmPrivacy Stream"] = 734,
    ["StrmPrivacy batch job configuration file"] = 732,
    ["Stryker Mutator"] = 535,
    ["StyleCop Analyzers Configuration"] = 536,
    ["Sublime Syntax"] = 737,
    ["Swagger API 2.0"] = 539,
    TSON = 564,
    TSTyche = 565,
    Talhelper = 541,
    ["Talisman configuration"] = 542,
    ["Taskfile config"] = 667,
    Taurus = 543,
    ["TestEnvironment.json"] = 552,
    ["TextMate Grammar"] = 551,
    ["Tier.run pricing.json"] = 546,
    Tikibase = 547,
    ["Traefik v2"] = 555,
    ["Traefik v2 File Provider"] = 556,
    TunnelHub = 771,
    Turborepo = 553,
    Tye = 695,
    ["UET BuildConfig.json"] = 742,
    ["UI5 Manifest"] = 573,
    ["UNCORS configuration"] = 577,
    ["UTAM Page Object"] = 576,
    ["Ubuntu Server Autoinstall"] = 571,
    ["Uniswap Token List"] = 650,
    ["Unreal Engine Uplugin"] = 743,
    ["Unreal Engine Uproject"] = 744,
    ["Updatecli Compose"] = 702,
    ["Updatecli Policy Manifest"] = 703,
    ["Updatecli Policy Metadata"] = 704,
    Uplift = 740,
    ["User Journey Map"] = 670,
    V2Ray = 708,
    ["VSCode Code Snippets"] = 150,
    ["VSIX CLI publishing"] = 590,
    ["Vela Pipeline Configuration"] = 580,
    Vercel = 149,
    Visivo = 769,
    ["Web App Manifest"] = 597,
    ["Web types"] = 600,
    WebExtensions = 596,
    ["Webman package recipe"] = 714,
    ["Windows Package Manager Installer Manifest"] = 647,
    ["Windows Package Manager Locale Manifest"] = 648,
    ["Windows Package Manager Singleton Manifest"] = 646,
    ["Woodpecker pipeline config"] = 682,
    ["Xstate Machine"] = 700,
    ["Yippee-Ki-JSON configuration YML"] = 652,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    apko = 773,
    ...
    ["bamboo-spec"] = 70,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 751,
    ["bashly-strings.yml"] = 752,
    ["bashly.yml"] = 750,
    ["batect.yml"] = 69,
    ...
    ["chisel-slices.json"] = 167,
    ["chrome-extension-locales-messages.json"] = 157,
    ["chutzpah.json"] = 158,
    cibuildwheel = 105,
    clangd = 137,
    clib = 138,
    ["cloud-init: cloud-config userdata"] = 140,
    ["cloud-sdk-pipeline-configuration"] = 160,
    ["cloudbuild.json"] = 161,
    cloudify = 139,
    codemagic = 141,
    ["coffeelint.json"] = 169,
    ["commands.json"] = 153,
    ["compile_commands.json"] = 152,
    ["compilerconfig.json"] = 151,
    ["completely.yml"] = 748,
    ["component-detection-manifest.json"] = 172,
    ["component.json"] = 171,
    ["composer.json"] = 170,
    ["config.yaml"] = 459,
    ["contentmanifest.json"] = 159,
    ["contribute.json"] = 173,
    ["cosmos.config.json"] = 155,
    ["crowdin.yml"] = 174,
    cspell = 180,
    ["custom-elements.json"] = 762,
    ["cypress.json"] = 178,
    ["datalogic-scan2deploy-android"] = 187,
    ["datalogic-scan2deploy-ce"] = 188,
    ["dbt Project"] = 112,
    ["ddev-global"] = 189,
    ["ddev-project"] = 190,
    ["debugsettings.json"] = 191,
    ["dependabot-v2.json"] = 194,
    ["dependabot.json"] = 193,
    ["deployed-cli"] = 699,
    ["detekt.yml"] = 196,
    ["devcontainer.json"] = 143,
    devinit = 654,
    ["devspace.yaml"] = 722,
    djlint = 655,
    ["docfx.json"] = 200,
    ["docker sequencer"] = 199,
    ["docker-compose.yml"] = 653,
    ["dockerd.json"] = 198,
    ["dotnet Release Index manifest"] = 209,
    ["dotnetcli.host.json"] = 210,
    ["dprint.json"] = 211,
    ["drone.json"] = 212,
    ["dss-2.0.0.json"] = 214,
    ["dstack configuration"] = 215,
    ["dvc.yaml"] = 216,
    ["ecosystem.json"] = 221,
    eksctl = 222,
    ["electron-builder configuration file"] = 227,
    ["epr-manifest.json"] = 225,
    ["evcc.yaml"] = 228,
    ["ezd task runner"] = 230,
    ["fabric.mod.json"] = 233,
    ["first-timers-bot"] = 239,
    ...
    ["gitlab-ci"] = 264,
    ["global.json"] = 266,
    ["go-feature-flag Flag Configuration"] = 268,
    ["golangci-lint Configuration"] = 267,
    ["haxelib.json"] = 282,
    helmfile = 642,
    helmwave = 643,
    ["host-meta.json"] = 287,
    ...
    ["ide.host.json"] = 292,
    ["ifstate.conf"] = 293,
    ["imageoptimizer.json"] = 294,
    ["importmap.json"] = 297,
    ["ioBroker Configuration"] = 298,
    ["ioBroker JSON UI"] = 299,
    ["ioBroker Package manifest"] = 300,
    ["ize.toml"] = 739,
    ["jsconfig.json"] = 322,
    ["jscpd Configuration"] = 719,
    jsdoc = 638,
    ["k3d.yaml"] = 323,
    ["k9s plugin.yml"] = 325,
    ["kontinuous-config.yaml"] = 330,
    ["kontinuous-values.yaml"] = 329,
    ["kustomization.yaml"] = 331,
    ["label-commenter-config.yml"] = 332,
    ["launchsettings.json"] = 333,
    lazydocker = 761,
    lazygit = 760,
    ["lego.json"] = 335,
    ["lerna.json"] = 336,
    ["lgtm.yml"] = 337,
    ["libman.json"] = 338,
    ["license-report-config.json"] = 339,
    ["linkinator.config.json"] = 341,
    ["local.settings.json"] = 346,
    ["localazy.json"] = 347,
    ["lotus.yaml"] = 345,
    ["lsdlschema.json"] = 348,
    ["madness.yml"] = 749,
    ["markdown-lint-check"] = 678,
    mboats = 685,
    ["micro-settings.json"] = 754,
    ["mimetypes.json"] = 355,
    ["mirrord config"] = 621,
    ["monospace.yml"] = 377,
    ["mta.yaml"] = 622,
    ["mtad.yaml"] = 623,
    ["mycode.json"] = 381,
    ["napari plugin manifest"] = 382,
    neoload = 633,
    ["nest-cli"] = 388,
    ["ninjs (News in JSON) 1.3"] = 387,
    ["ninjs (News in JSON) 2.0"] = 386,
    ["nlu.json"] = 389,
    ["nodemon.json"] = 391,
    ["noodl config"] = 684,
    now = 629,
    ...
    ["nswag.json"] = 397,
    ntangle = 398,
    ["nuclei-template.yaml"] = 395,
    ["nuget-project.json"] = 396,
    ["ocelot.json"] = 400,
    ["omnisharp.json"] = 401,
    ["openapi.json"] = 402,
    ["openfin.json"] = 408,
    ...
    ["ops.yaml"] = 406,
    ["package.json"] = 419,
    ["package.manifest"] = 420,
    ["pathfinder.yml"] = 423,
    ["pattern.json"] = 425,
    ["petstore-v1.0"] = 729,
    pgap_yaml_input_reader = 424,
    ["plagiarize-me.yaml"] = 430,
    ["plagiarize.yaml"] = 429,
    ["portman.json"] = 431,
    ["prettierrc.json"] = 438,
    ["prisma.yml"] = 439,
    ["project-1.0.0-beta3.json"] = 442,
    ["project-1.0.0-beta4.json"] = 443,
    ["project-1.0.0-beta5.json"] = 444,
    ["project-1.0.0-beta6.json"] = 445,
    ["project-1.0.0-beta8.json"] = 446,
    ["project-1.0.0-rc1.json"] = 447,
    ["project-1.0.0-rc2.json"] = 448,
    ["project.json"] = 441,
    ["prometheus.json"] = 449,
    ["prometheus.rules.json"] = 450,
    ["prometheus.rules.test.json"] = 451,
    ["proxies.json"] = 452,
    ["publiccode.yml"] = 453,
    ["pubspec.yaml"] = 454,
    ["pyrseas-0.8.json"] = 457,
    ["quilt.mod.json"] = 755,
    ["release drafter"] = 634,
    rtx = 472,
    rustfmt = 479,
    samt = 481,
    samtrc = 482,
    ["sarif-1.0.0.json"] = 484,
    ["sarif-2.0.0.json"] = 485,
    ["sarif-2.1.0"] = 495,
    ["sarif-2.1.0-rtm.2"] = 486,
    ["sarif-2.1.0-rtm.3"] = 488,
    ["sarif-2.1.0-rtm.4"] = 490,
    ["sarif-2.1.0-rtm.5"] = 492,
    ["sarif-2.1.0-rtm.6"] = 493,
    ["sarif-external-property-file-2.1.0"] = 496,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 487,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 489,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 491,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 494,
    ["schema.org - Action"] = 498,
    ["schema.org - ContactPoint"] = 499,
    ["schema.org - Place"] = 500,
    ["schema.org - Thing"] = 501,
    ["scikit-build"] = 686,
    ["secrethub.yml"] = 757,
    ["semantic-release"] = 504,
    ["servicehub.config.json"] = 610,
    ["servicehub.service.json"] = 609,
    ["settings.job"] = 507,
    ["sfdx-hardis configuration"] = 510,
    ["size-limit configuration"] = 514,
    ["skaffold.yaml"] = 676,
    ["skyuxconfig.json"] = 516,
    snapcraft = 517,
    ["sqlc configuration"] = 525,
    ["stripe-app-local.json"] = 534,
    ["stripe-app.json"] = 533,
    swcrc = 663,
    syntax = 759,
    ["task.json"] = 540,
    taskcat = 630,
    ["template.json"] = 544,
    ["templatsources.json"] = 545,
    ["theme.json"] = 548,
    ["tizen_workspace.json"] = 549,
    tldr = 550,
    tmuxinator = 618,
    ["transcend.yml"] = 557,
    ["trunk.yaml"] = 558,
    ["ts-force-config.json"] = 562,
    ["tsconfig.json"] = 559,
    ["tsd.json"] = 560,
    ["tsdrc.json"] = 561,
    ["tslint.json"] = 563,
    ...
    ["typingsrc.json"] = 570,
    ["typo3.json"] = 568,
    ["ui5-workspace.yaml"] = 575,
    ["ui5.yaml"] = 574,
    unist = 696,
    ["up.json"] = 572,
    v8r = 594,
    ["vcpkg configuration file"] = 148,
    ["vcpkg manifest file"] = 147,
    ["vega-lite.json"] = 579,
    ["vega.json"] = 578,
    ["venvironment-basic.yaml"] = 582,
    ["venvironment.yaml"] = 581,
    ["version.json"] = 583,
    ["vim-addon-info"] = 584,
    ["vs-2017.3.host.json"] = 586,
    ["vs-nesting.json"] = 587,
    ["vsls.json"] = 585,
    ["vss-extension.json"] = 591,
    ["vtesttree.yaml"] = 592,
    ["vtestunit.yaml"] = 593,
    ["warp-keysets.json"] = 763,
    ["warp-themes.json"] = 764,
    ["warp-workflows.json"] = 765,
    ["webhint.io"] = 715,
    ["webjobpublishsettings.json"] = 599,
    ["webjobs-list.json"] = 598,
    ["xs-app.json"] = 626,
    ["xunit.runner.json"] = 608,
    yamllint = 651,
    zuul = 635,
    ["Žinoma"] = 645
  },
