...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 188,
    [".cryproj (generic)"] = 633,
    [".cryproj engine-5.2"] = 628,
    [".cryproj engine-5.3"] = 629,
    [".cryproj engine-5.4"] = 630,
    [".cryproj engine-5.5"] = 631,
    [".cryproj engine-dev"] = 632,
    [".eslintrc"] = 242,
    [".esmrc.json"] = 234,
    [".ffizer.yaml"] = 246,
    [".htmlhintrc"] = 299,
    ...
    ["Azure Pipelines"] = 64,
    ["Azure Static Web Apps CLI configuration file"] = 542,
    ["Azure Static Web Apps configuration file"] = 541,
    ["BX CI"] = 102,
    ["Bashly (bashly.yml)"] = 769,
    ["Bashly Settings (bashly-settings.yml)"] = 770,
    ["Better Code Hub"] = 680,
    ["Better Scripts"] = 103,
    Bigconfig = 81,
    BizTalkServerApplicationSchema = 650,
    Bleep = 104,
    ...
    ["Butane Config"] = 720,
    ["CICS TS region tagging"] = 729,
    ["CICS TS resource import"] = 730,
    ["CICS TS resource model"] = 731,
    ["CICS TS resource overrides"] = 732,
    ["CMake Presets"] = 105,
    ["CNC Codes"] = 116,
    ["CSS Comb (.csscomb.json)"] = 190,
    ["CSS Lint (.csslintrc)"] = 191,
    ["CSpell (cspell.json)"] = 189,
    ...
    Cheatsheets = 717,
    ["Chrome Extension"] = 165,
    ["Chromia Model"] = 112,
    ["CircleCI config.yml"] = 142,
    ["Citation File Format"] = 177,
    CityJSON = 114,
    ["Code Climate"] = 143,
    CodeCV = 61,
    ["CodeShip Pro services configuration files"] = 154,
    ["CodeShip Pro steps configuration files"] = 155,
    ["Codecov configuration files"] = 153,
    Codux = 151,
    ["Cog config file"] = 117,
    ["Commandbox Box.json"] = 118,
    ["Commandbox Server.json"] = 119,
    ["Common Catalog Data"] = 163,
    Conjure = 115,
    ["Container Structure Test"] = 663,
    Containerlab = 688,
    ["Crowdsec collection config"] = 184,
    ["Crowdsec parser config"] = 185,
    ["Crowdsec scenario config"] = 186,
    ["CumulusCI Config"] = 120,
    ["DWP Exchange - catalogue entry"] = 230,
    ["DWP Exchange - gateway"] = 228,
    ["DWP Exchange - meta"] = 229,
    ["Dart Build Config (dart-build.json)"] = 192,
    ["Dart Test Config (dart-test.json)"] = 193,
    ["DashLord Configuration"] = 194,
    ["Data Contract Specification"] = 195,
    ["Databricks Asset Bundles"] = 786,
    ["Datadog Service Definition"] = 339,
    ["Datahub Ingestion Recipe"] = 736,
    ["Dein Config"] = 122,
    ["Deno Config (deno.json)"] = 201,
    ["Deployer Recipe"] = 204,
    ["Deta Spacefile"] = 123,
    ["Detekt Config (detekt.yml)"] = 205,
    ["Devbox Config"] = 124,
    ["Devbox Plugin"] = 125,
    Devfile = 227,
    ["Discord Webhook"] = 206,
    ["DocFx Config (docfx.json)"] = 209,
    ["Dolittle Artifacts"] = 210,
    ["Dolittle Bounded Context Configuration"] = 211,
    ["Dolittle Event Horizons Configuration"] = 212,
    ["Dolittle Resources Configuration"] = 213,
    ["Dolittle Server Configuration"] = 214,
    ["Dolittle Tenant Map Configuration"] = 216,
    ["Dolittle Tenants Configuration"] = 215,
    ["Dolittle Topology"] = 217,
    ["Drupal Breakpoints"] = 126,
    ["Drupal Config"] = 137,
    ["Drupal Info"] = 127,
    ["Drupal Layouts"] = 128,
    ["Drupal Libraries"] = 129,
    ["Drupal Links Action"] = 130,
    ["Drupal Links Contextual"] = 131,
    ["Drupal Links Menu"] = 132,
    ["Drupal Links Task"] = 133,
    ["Drupal Migration"] = 134,
    ["Drupal Permissions"] = 135,
    ["Drupal Routing"] = 136,
    ["Drupal Services"] = 138,
    ["Drush site aliases"] = 223,
    ["Dynamic Bash Aliases (.aliases)"] = 777,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 766,
    ["Elgato Stream Deck"] = 233,
    ["Embrace Config"] = 747,
    Endurica = 790,
    ["Error pages"] = 237,
    Esquio = 235,
    ["Estuary Flow Catalog"] = 726,
    ["Expo SDK"] = 240,
    ["F-Droid Data metadata"] = 245,
    ["Facets - FSDL - Application"] = 243,
    ["FasterCI Configuration"] = 65,
    FiQuS = 249,
    Firebase = 247,
    ["Fossa configuration file"] = 256,
    ["Fossa's fossa-deps file"] = 257,
    ["Foundry VTT - Base package Manifest"] = 251,
    ["Foundry VTT - Module Manifest"] = 252,
    ["Foundry VTT - System Data Template"] = 255,
    ["Foundry VTT - System Manifest"] = 253,
    ["Foundry VTT - World Manifest"] = 254,
    ["Foxx Manifest"] = 66,
    ...
    ["GeoJSON.json latest"] = 724,
    GherKing = 728,
    ["GitHub Action"] = 267,
    ["GitHub Discussion"] = 268,
    ["GitHub Funding"] = 269,
    ["GitHub Issue Template configuration"] = 271,
    ["GitHub Workflow"] = 272,
    ...
    Goblet = 785,
    ["Google Chrome Related Website Sets"] = 248,
    ["Google Cloud Workflows"] = 171,
    Gorder = 279,
    Goreleaser = 280,
    ["Goreleaser Pro"] = 281,
    Goss = 282,
    ["Gradle Build Cache Node"] = 678,
    ["Gradle Enterprise"] = 677,
    ["Grafana 5.x Dashboard"] = 283,
    ["GraphQL Code Generator"] = 286,
    ["GraphQL Config"] = 285,
    ["GraphQL Mesh"] = 284,
    ["Grunt JSHint task"] = 290,
    ["Grunt Watch task"] = 291,
    ["Grunt base task"] = 292,
    ["Grunt clean task"] = 288,
    ["Grunt copy task"] = 287,
    ["Grunt cssmin task"] = 289,
    HEMTT = 647,
    Hadolint = 659,
    Hammerkit = 687,
    ["Hardware Sentry Configuration"] = 740,
    Hatch = 660,
    Hayson = 294,
    ["Haystack Pipeline"] = 295,
    ["Hazelcast 5 Configuration"] = 296,
    ["Helm Chart.lock"] = 140,
    ["Helm Chart.yaml"] = 139,
    ["Helm Unittest Test Suite"] = 141,
    Hugo = 716,
    ["Hugo Theme"] = 715,
    ["IBM Zapp document"] = 301,
    ["IBM zCodeFormatSettings"] = 302,
    ["IMG Catapult PSP"] = 307,
    Istanbul = 743,
    ["JDownloader2 crawler multi-rules"] = 317,
    ["JDownloader2 crawler single-rules"] = 316,
    ["JFrog Applications Config"] = 318,
    ["JFrog File Spec"] = 319,
    ["JFrog Pipelines YML DSL"] = 749,
    ["JMeter DSL cli config"] = 320,
    JReleaser = 322,
    ["JSON Document Transform"] = 329,
    ["JSON Feed"] = 330,
    ["JSON Resume"] = 489,
    ["JSON Schema Draft 2020-12"] = 624,
    ["JSON Schema Draft 4"] = 621,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 787,
    ["JSON Schema Draft 7"] = 622,
    ["JSON Schema Draft 7 (unofficial strict)"] = 788,
    ["JSON Schema Draft 8 (2019-09)"] = 623,
    ["JSON-API"] = 328,
    ["JSON-e templates"] = 685,
    ["JSON-stat 2.0"] = 618,
    JSONPatch = 332,
    Jasmine = 312,
    Jekyll = 313,
    ["Jenkins X Pipelines"] = 314,
    ["Jenkins X Requirements"] = 315,
    ["Jovo Language Models"] = 321,
    ["KIMMDY config file"] = 337,
    ["KSP-AVC"] = 619,
    ["KSP-CKAN"] = 620,
    ["Karakum configuration file"] = 258,
    Kas = 335,
    ["Keycloak REST API"] = 757,
    ["Knative Functions - func.yaml"] = 259,
    ["KoDE/CI build.yaml"] = 745,
    ["Kong DBLess config"] = 746,
    KrakenD = 338,
    LOOBin = 357,
    Lefthook = 346,
    ["Liferay client-extension.yaml"] = 353,
    ["LinkML Metamodel"] = 355,
    Liquibase = 692,
    ["Liquibase Flow File"] = 693,
    ["Lively Properties"] = 356,
    ["Lobe AI Agent"] = 63,
    ["MLOS Configs"] = 389,
    ["MS2Rescore Configuration"] = 391,
    ["Madness (madness.yml)"] = 768,
    Markdownlint = 696,
    ["Mason Registry"] = 698,
    ["MegaLinter configuration"] = 363,
    ["MegaLinter descriptor"] = 364,
    Melange = 794,
    ["Meltano plugin discovery definition"] = 366,
    ["Meltano project definition"] = 365,
    ["Micro Editor Syntax"] = 778,
    ["Microsoft Band Web Tile"] = 367,
    ["Minecraft Custom Main Menu Mod"] = 795,
    ["Minecraft Data Pack Advancement"] = 369,
    ["Minecraft Data Pack Biome"] = 370,
    ["Minecraft Data Pack Configured Carver"] = 371,
    ["Minecraft Data Pack Damage Type"] = 372,
    ["Minecraft Data Pack Dimension"] = 374,
    ["Minecraft Data Pack Dimension Type"] = 373,
    ["Minecraft Data Pack Item Modifier"] = 375,
    ["Minecraft Data Pack Loot Table"] = 376,
    ["Minecraft Data Pack Metadata"] = 377,
    ["Minecraft Data Pack Predicate"] = 378,
    ["Minecraft Data Pack Recipe"] = 379,
    ["Minecraft Data Pack Tag"] = 380,
    ["Minecraft Data Pack Template Pool"] = 381,
    ["Minecraft Data Pack Trim Material"] = 386,
    ["Minecraft Data Pack Trim Pattern"] = 387,
    ["Minecraft Resource Pack Lang"] = 382,
    ["Minecraft Resource Pack Particle"] = 383,
    ["Minecraft Resource Pack Texture Mcmeta"] = 385,
    ["Minecraft Resourcepack Sounds"] = 384,
    ["MkDocs Configuration 1.0"] = 388,
    ["MongoDB Atlas Search Index Definition"] = 744,
    ["Monika Configuration"] = 742,
    ["Motif config"] = 643,
    ["NOX Framework (Service)"] = 405,
    ["Netin Diagnostic System Template"] = 702,
    ["Netlify config"] = 396,
    ["Network-as-Code Data Model"] = 397,
    ["Nightwatch.js"] = 398,
    ["ONe's changelog entry"] = 421,
    ["ONe's service descriptor"] = 420,
    ["OSS Review Toolkit configuration"] = 428,
    ["OSS Review Toolkit curation"] = 429,
    ["OSS Review Toolkit package configuration"] = 430,
    ["OSS Review Toolkit repository configuration"] = 431,
    ["OSS Review Toolkit resolutions"] = 432,
    Opctl = 646,
    ["OpenRewrite Resource"] = 423,
    ["OpenUtau character yaml"] = 417,
    ["OpenUtau ustx"] = 418,
    ["OpenWeather Current Weather API"] = 684,
    ["OpenWeather Road Risk API"] = 683,
    ["Ory Hydra configuration"] = 300,
    ["Ory Keto configuration"] = 340,
    ["Ory Kratos configuration"] = 427,
    ["Ory Oathkeeper configuration"] = 412,
    ["Outblocks App configuration"] = 425,
    ["Outblocks database table"] = 426,
    ["Outblocks project configuration"] = 424,
    PDM = 438,
    Packer = 435,
    Pantsbuild = 764,
    ["Paper paper-plugin.yml"] = 436,
    ["Pipeline component"] = 694,
    ...
    Qgoda = 478,
    Qodana = 712,
    ["Quali Torque Blueprint Spec 2"] = 737,
    ["QueryFirst config file"] = 760,
    ["RKE Cluster Configuration JSON"] = 691,
    ["RKE Cluster Configuration YAML"] = 690,
    ["Rancher Fleet"] = 472,
    Ray = 658,
    ["Read the Docs"] = 474,
    ...
    ["Replit config"] = 485,
    RoadRunner = 492,
    ["Rudder techniques"] = 798,
    Ruff = 487,
    ["Rust Project"] = 488,
    ["Rust toolchain"] = 495,
    ["SIL Kit Participant Configuration"] = 527,
    ["SIL Kit Registry Configuration"] = 528,
    SWADL = 553,
    ["Safebox Config"] = 750,
    ["Sapphire CLI Config"] = 498,
    ["SauceCTL Configuration"] = 699,
    ["Schema Catalog"] = 512,
    ["Scoop manifest"] = 517,
    ["Semantic Data Fabric (SDF) file"] = 518,
    ["Semgrep Rule"] = 520,
    ["Serenity Code Generator (Sergen)"] = 521,
    ["Serverless Framework Configuration"] = 706,
    ["Serverless Workflow"] = 708,
    ["Settings.paf"] = 523,
    ["Shopware 6 Configuration"] = 709,
    ["Shopware CLI Extension Store Configuration"] = 710,
    ["Shopware CLI Project Store Configuration"] = 711,
    Sigma = 525,
    ["Sigrid scope configuration file"] = 526,
    ["SkyPilot Task JSON"] = 799,
    ["Slack app manifest"] = 530,
    Solidarity = 533,
    ["Solution filters"] = 534,
    ["Source Maps v3"] = 535,
    Sourcery = 536,
    SpecIF = 537,
    ["Sponge Mixin configuration"] = 538,
    StackBlitz = 543,
    ["StackHawk Scanner Configuration"] = 705,
    Stale = 544,
    ["Starlake Data Pipeline"] = 681,
    Starship = 545,
    ["Statamic Blueprint"] = 546,
    ["Stella configuration file"] = 547,
    ["StrmPrivacy Data Connector"] = 754,
    ["StrmPrivacy Data Contract"] = 755,
    ["StrmPrivacy SimpleSchema"] = 752,
    ["StrmPrivacy Stream"] = 753,
    ["StrmPrivacy batch job configuration file"] = 751,
    ["Stryker Mutator"] = 550,
    ["StyleCop Analyzers Configuration"] = 551,
    ["Stylelint (.stylelintrc)"] = 552,
    ["Sublime Syntax"] = 756,
    ["Subsquid squid manifest"] = 801,
    ["Swagger API 2.0"] = 554,
    TSON = 579,
    TSTyche = 580,
    Talhelper = 556,
    ["Talisman configuration"] = 557,
    ["Taskfile config"] = 686,
    Taurus = 558,
    ["TestEnvironment.json"] = 567,
    ["TextMate Grammar"] = 566,
    ["Tier.run pricing.json"] = 561,
    Tikibase = 562,
    ["Traefik v2"] = 570,
    ["Traefik v2 File Provider"] = 571,
    ["Travis CI (.travis.yml)"] = 569,
    TunnelHub = 791,
    Turborepo = 568,
    Tye = 713,
    ["UET BuildConfig.json"] = 761,
    ["UI5 Manifest"] = 589,
    ["UNCORS configuration"] = 593,
    ["UTAM Page Object"] = 592,
    ["Ubuntu Server Autoinstall"] = 587,
    ["Uniswap Token List"] = 669,
    ["Unreal Engine Uplugin"] = 762,
    ["Unreal Engine Uproject"] = 763,
    ["Updatecli Compose"] = 721,
    ["Updatecli Policy Manifest"] = 722,
    ["Updatecli Policy Metadata"] = 723,
    Uplift = 759,
    ["User Journey Map"] = 689,
    V2Ray = 727,
    ["VSCode Code Snippets"] = 159,
    ...
    ["Web types"] = 616,
    WebExtensions = 612,
    ["Webman package recipe"] = 733,
    ["Windows Package Manager Installer Manifest"] = 666,
    ["Windows Package Manager Locale Manifest"] = 667,
    ["Windows Package Manager Singleton Manifest"] = 665,
    ["Woodpecker pipeline config"] = 701,
    ["Wrangler CLI"] = 617,
    ["Xstate Machine"] = 719,
    ["Yarn Config (.yarnrc.yml)"] = 679,
    ["Yippee-Ki-JSON configuration YML"] = 671,
    ["aerleon.yml"] = 6,
    ["angular.json"] = 14,
    apko = 793,
    ...
    ["chisel-slices.json"] = 176,
    ["chrome-extension-locales-messages.json"] = 166,
    ["chutzpah.json"] = 167,
    cibuildwheel = 113,
    ["clang-format (.clang-format)"] = 725,
    clangd = 146,
    clib = 147,
    ["cloud-init: cloud-config userdata"] = 149,
    ["cloud-sdk-pipeline-configuration"] = 169,
    ["cloudbuild.json"] = 170,
    cloudify = 148,
    codemagic = 150,
    ["coffeelint.json"] = 178,
    ["commands.json"] = 162,
    ["commitlint (.commitlintrc)"] = 668,
    ["compile_commands.json"] = 161,
    ["compilerconfig.json"] = 160,
    ["completely.yml"] = 767,
    ["component-detection-manifest.json"] = 181,
    ["component.json"] = 180,
    ["composer.json"] = 179,
    ["config.yaml"] = 473,
    ["contentmanifest.json"] = 168,
    ["contribute.json"] = 182,
    ["cosmos.config.json"] = 164,
    ["crowdin.yml"] = 183,
    ["custom-elements.json"] = 781,
    ["cypress.json"] = 187,
    ["datalogic-scan2deploy-android"] = 196,
    ["datalogic-scan2deploy-ce"] = 197,
    ["dbt Project"] = 121,
    ["ddev-global"] = 198,
    ["ddev-project"] = 199,
    ["debugsettings.json"] = 200,
    ["dependabot-v2.json"] = 203,
    ["dependabot.json"] = 202,
    ["deployed-cli"] = 718,
    ["devcontainer.json"] = 152,
    devinit = 673,
    ["devspace.yaml"] = 741,
    djlint = 674,
    ["docker sequencer"] = 208,
    ["docker-compose.yml"] = 672,
    ["dockerd.json"] = 207,
    ["dotnet Release Index manifest"] = 218,
    ["dotnet-tools.json"] = 219,
    ["dotnetcli.host.json"] = 220,
    ["dprint.json"] = 221,
    ["drone.json"] = 222,
    ["dss-2.0.0.json"] = 224,
    ["dstack configuration"] = 225,
    ["dvc.yaml"] = 226,
    ["ecosystem.json"] = 231,
    eksctl = 232,
    ["electron-builder configuration file"] = 238,
    ["epr-manifest.json"] = 236,
    ["evcc.yaml"] = 239,
    ["ezd task runner"] = 241,
    ["fabric.mod.json"] = 244,
    ["first-timers-bot"] = 250,
    ...
    ["gitlab-ci"] = 274,
    ["global.json"] = 276,
    ["go-feature-flag Flag Configuration"] = 278,
    ["golangci-lint Configuration"] = 277,
    ["haxelib.json"] = 293,
    helmfile = 661,
    helmwave = 662,
    ["host-meta.json"] = 298,
    ...
    ["ide.host.json"] = 303,
    ["ifstate.conf"] = 304,
    ["imageoptimizer.json"] = 305,
    ["importmap.json"] = 308,
    ["ioBroker Configuration"] = 309,
    ["ioBroker JSON UI"] = 310,
    ["ioBroker Package manifest"] = 311,
    ["ize.toml"] = 758,
    ["jsconfig.json"] = 333,
    ["jscpd Configuration"] = 738,
    jsdoc = 657,
    ["k3d.yaml"] = 334,
    ["k9s plugin.yml"] = 336,
    ["kontinuous-config.yaml"] = 342,
    ["kontinuous-values.yaml"] = 341,
    ["kustomization.yaml"] = 343,
    ["label-commenter-config.yml"] = 344,
    ["latexindent configuration"] = 62,
    ["launchsettings.json"] = 345,
    lazydocker = 780,
    lazygit = 779,
    ["lego.json"] = 347,
    ["lerna.json"] = 348,
    ["lgtm.yml"] = 349,
    ["liblab.config.json"] = 350,
    ["libman.json"] = 351,
    ["license-report-config.json"] = 352,
    ["linkinator.config.json"] = 354,
    ["lint-staged (.lintstagedrc)"] = 637,
    ["local.settings.json"] = 359,
    ["localazy.json"] = 360,
    ["lotus.yaml"] = 358,
    ["lsdlschema.json"] = 361,
    ["markdown-lint-check"] = 697,
    mboats = 704,
    ["micro-settings.json"] = 773,
    ["mimetypes.json"] = 368,
    ["mirrord config"] = 638,
    mise = 639,
    ["mise-settings"] = 640,
    ...
    ["mtad.yaml"] = 642,
    ["mycode.json"] = 394,
    ["napari plugin manifest"] = 395,
    neoload = 652,
    ["nest-cli"] = 401,
    ["ninjs (News in JSON) 1.3"] = 400,
    ["ninjs (News in JSON) 2.0"] = 399,
    ["nixd configuration"] = 797,
    ["nlu.json"] = 402,
    ["nodemon.json"] = 404,
    ["noodl config"] = 703,
    now = 648,
    ...
    ["nswag.json"] = 410,
    ntangle = 411,
    ["nuclei-template.yaml"] = 408,
    ["nuget-project.json"] = 409,
    ["ocelot.json"] = 413,
    ["omnisharp.json"] = 414,
    ["openapi.json"] = 415,
    ["openfin.json"] = 422,
    ...
    ["servicehub.config.json"] = 627,
    ["servicehub.service.json"] = 626,
    ["settings.job"] = 522,
    ["sfdx-hardis configuration"] = 524,
    ["size-limit configuration"] = 529,
    ["skaffold.yaml"] = 695,
    ["skyuxconfig.json"] = 531,
    snapcraft = 532,
    ["sqlc configuration"] = 540,
    ["stripe-app-local.json"] = 549,
    ["stripe-app.json"] = 548,
    swcrc = 682,
    ["task.json"] = 555,
    taskcat = 649,
    ["template.json"] = 559,
    ["templatsources.json"] = 560,
    ["theme.json"] = 563,
    ["tizen_workspace.json"] = 564,
    tldr = 565,
    tmuxinator = 635,
    ["transcend.yml"] = 572,
    ["trunk.yaml"] = 573,
    ["ts-force-config.json"] = 577,
    ["tsconfig.json"] = 574,
    ["tsd.json"] = 575,
    ["tsdrc.json"] = 576,
    ["tslint.json"] = 578,
    ...
    ["up.json"] = 588,
    v8r = 610,
    ["vcpkg configuration file"] = 157,
    ["vcpkg manifest file"] = 156,
    ["vega-lite.json"] = 595,
    ["vega.json"] = 594,
    ...
    ["vtesttree.yaml"] = 608,
    ["vtestunit.yaml"] = 609,
    ["warp-keysets.json"] = 782,
    ["warp-themes.json"] = 783,
    ["warp-workflows.json"] = 784,
    ["webhint.io"] = 734,
    ["webjobpublishsettings.json"] = 615,
    ["webjobs-list.json"] = 614,
    ["xs-app.json"] = 645,
    ["xunit.runner.json"] = 625,
    yamllint = 670,
    zuul = 654,
    ["Žinoma"] = 664
  },
