...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 97,
    [".cryproj (generic)"] = 394,
    [".cryproj engine-5.2"] = 389,
    [".cryproj engine-5.3"] = 390,
    [".cryproj engine-5.4"] = 391,
    [".cryproj engine-5.5"] = 392,
    [".cryproj engine-dev"] = 393,
    [".csscomb.json"] = 99,
    [".csslintrc"] = 100,
    [".eslintrc"] = 135,
    [".esmrc.json"] = 128,
    ...
    [".mtaext"] = 400,
    [".nodehawkrc"] = 239,
    [".npmpackagejsonlintrc"] = 241,
    [".phraseapp.yml"] = 268,
    [".pmbot.yml"] = 261,
    [".postcssrc"] = 266,
    [".pre-commit-config.yml"] = 267,
    [".putout.json"] = 285,
    [".rehyperc"] = 290,
    [".remarkrc"] = 291,
    [".sprite files"] = 326,
    ...
    [".vsext"] = 370,
    [".yarnrc.yml"] = 432,
    ["<div>RIOTS' studio configuration"] = 373,
    ["API Builder"] = 429,
    ...
    ["Azure Pipelines"] = 32,
    ["Azure Static Web Apps CLI configuration file"] = 328,
    ["Azure Static Web Apps configuration file"] = 327,
    ["Better Code Hub"] = 434,
    BizTalkServerApplicationSchema = 406,
    Briefcase = 411,
    Buildkite = 53,
    ...
    Goreleaser = 160,
    ["Goreleaser Pro"] = 161,
    ["Gradle Build Cache Node"] = 431,
    ["Gradle Enterprise"] = 430,
    ...
    HEMTT = 403,
    Hadolint = 415,
    ["Hammerkit YAML Schema"] = 441,
    Hayson = 173,
    ["Hazelcast 5 Configuration"] = 174,
    ["Helm Chart.lock"] = 65,
    ["Helm Chart.yaml"] = 64,
    ["JFrog File Spec"] = 187,
    ["JSON Document Transform"] = 195,
    ["JSON Feed"] = 196,
    ["JSON Resume"] = 293,
    ["JSON Schema Draft 2020-12"] = 385,
    ["JSON Schema Draft 4"] = 382,
    ["JSON Schema Draft 7"] = 383,
    ["JSON Schema Draft 8"] = 384,
    ...
    ["JSON-API"] = 194,
    ["JSON-e templates"] = 439,
    ["JSON-stat 2.0"] = 379,
    JSONPatch = 198,
    ["Jekyll configuration"] = 184,
    ["Jenkins X Pipelines"] = 185,
    ["Jenkins X Requirements"] = 186,
    ["Jovo Language Models"] = 188,
    ["KSP-AVC"] = 380,
    ["KSP-CKAN"] = 381,
    Liquibase = 446,
    ["MegaLinter configuration"] = 212,
    ["MegaLinter descriptor"] = 213,
    ["Meltano plugin discovery definition"] = 215,
    ["Meltano project definition"] = 214,
    ["Microsoft Band Web Tile"] = 216,
    ["Minecraft Data Pack Advancement"] = 218,
    ["Minecraft Data Pack Biome"] = 219,
    ["Minecraft Data Pack Configured Carver"] = 220,
    ["Minecraft Data Pack Dimension"] = 222,
    ["Minecraft Data Pack Dimension Type"] = 221,
    ["Minecraft Data Pack Item Modifier"] = 223,
    ["Minecraft Data Pack Loot Table"] = 224,
    ["Minecraft Data Pack Metadata"] = 225,
    ["Minecraft Data Pack Predicate"] = 226,
    ["Minecraft Data Pack Recipe"] = 227,
    ["Minecraft Data Pack Template Pool"] = 228,
    ["Minecraft Resourcepack Sounds"] = 229,
    ["Netin Diagnostic System Template"] = 453,
    ["Netlify config schema"] = 234,
    ["Nightwatch.js"] = 235,
    ["OSS Review Toolkit repository configuration"] = 255,
    Opctl = 402,
    ["OpenWeather Current Weather API"] = 438,
    ["OpenWeather Road Risk API"] = 437,
    ["Ory Hydra configuration"] = 178,
    ["Ory Keto configuration"] = 201,
    ["Ory Kratos configuration"] = 254,
    ["Ory Oathkeeper configuration"] = 246,
    ["Outblocks App configuration"] = 252,
    ["Outblocks database table"] = 253,
    ["Outblocks project configuration"] = 251,
    Packer = 258,
    ["Pipeline component"] = 447,
    ["PocketMine plugin.yml"] = 262,
    ["Pull Request Labeler"] = 284,
    Qodana = 460,
    ["RKE Cluster Configuration JSON Schema"] = 445,
    ["RKE Cluster Configuration YAML Schema"] = 444,
    Ray = 414,
    ["Read the Docs"] = 287,
    ["Red-DiscordBot Cog"] = 288,
    ["Red-DiscordBot Cog Repo"] = 289,
    Renovate = 294,
    RoadRunner = 295,
    SWADL = 337,
    ["Sapphire CLI Config"] = 296,
    ["SauceCTL Configuration"] = 450,
    ["Schema Catalog"] = 309,
    ["Scoop manifest"] = 314,
    ["Semgrep Rule"] = 315,
    ["Serverless Framework Configuration"] = 457,
    ["Settings.paf"] = 317,
    ["Shopware CLI Extension Store Configuration"] = 458,
    ["Shopware CLI Project Store Configuration"] = 459,
    Solidarity = 322,
    ["Source Maps v3"] = 323,
    SpecIF = 324,
    ["Sponge Mixin configuration"] = 325,
    ["StackHawk Scanner Configuration"] = 456,
    ["StackHead CLI config"] = 329,
    ["StackHead module configuration"] = 330,
    ["StackHead project definition"] = 331,
    Stale = 332,
    ["Statamic Blueprint"] = 333,
    ["Stryker Mutator"] = 334,
    ["StyleCop Analyzers Configuration"] = 335,
    ["Swagger API 2.0"] = 338,
    ["Taskfile YAML Schema"] = 440,
    Taurus = 339,
    ["TestEnvironment.json"] = 344,
    ["Traefik v2"] = 346,
    ["Traefik v2 File Provider"] = 347,
    ["UI5 Manifest"] = 359,
    ["Ubuntu Server Autoinstall"] = 357,
    ["Uniswap Token List"] = 423,
    ["User Journey Map YAML Schema"] = 443,
    ["VSCode Code Snippets"] = 76,
    ["VSIX CLI publishing"] = 371,
    ["Vela Pipeline Configuration"] = 363,
    Vercel = 75,
    ["Web App Manifest"] = 375,
    ["Web types"] = 378,
    WebExtensions = 374,
    ["Windows Package Manager Installer Manifest"] = 420,
    ["Windows Package Manager Locale Manifest"] = 421,
    ["Windows Package Manager Singleton Manifest"] = 419,
    ["Woodpecker pipeline config"] = 452,
    ["Yippee-Ki-JSON configuration YML"] = 425,
    ["angular.json"] = 6,
    ...
    httpmockrc = 407,
    huskyrc = 396,
    ["imageoptimizer.json"] = 179,
    ["importmap.json"] = 181,
    ["ioBroker JSON UI"] = 182,
    ["ioBroker Package manifest"] = 183,
    ["jsconfig.json"] = 199,
    jsdoc = 413,
    ["k3d.yaml"] = 200,
    ["kustomization.yaml"] = 202,
    ["label-commenter-config.yml"] = 203,
    ["launchsettings.json"] = 204,
    ["lerna.json"] = 205,
    ["lgtm.yml"] = 206,
    ["libman.json"] = 207,
    ["license-report-config.json"] = 208,
    ["local.settings.json"] = 209,
    ["localazy.json"] = 210,
    ["lsdlschema.json"] = 211,
    ["markdownlint.json"] = 449,
    mboats = 455,
    ["mimetypes.json"] = 217,
    ["mta.yaml"] = 398,
    ["mtad.yaml"] = 399,
    ["mycode.json"] = 232,
    ["napari plugin manifest"] = 233,
    neoload = 408,
    ["nest-cli"] = 237,
    ["ninjs (News in JSON)"] = 236,
    ["nlu.json"] = 238,
    ["nodemon.json"] = 240,
    ["noodl.schema.json"] = 454,
    now = 404,
    ["nswag.json"] = 244,
    ntangle = 245,
    ["nuclei-template.yaml"] = 242,
    ["nuget-project.json"] = 243,
    ["ocelot.json"] = 247,
    ["omnisharp.json"] = 248,
    ["openapi.json"] = 249,
    ["openfin.json"] = 250,
    ["package.json"] = 256,
    ["package.manifest"] = 257,
    ["pattern.json"] = 260,
    pgap_yaml_input_reader = 259,
    ["plagiarize-me.yaml"] = 264,
    ["plagiarize.yaml"] = 263,
    ["portman.json"] = 265,
    ["prettierrc.json"] = 269,
    ["prisma.yml"] = 270,
    ["project-1.0.0-beta3.json"] = 272,
    ["project-1.0.0-beta4.json"] = 273,
    ["project-1.0.0-beta5.json"] = 274,
    ["project-1.0.0-beta6.json"] = 275,
    ["project-1.0.0-beta8.json"] = 276,
    ["project-1.0.0-rc1.json"] = 277,
    ["project-1.0.0-rc2.json"] = 278,
    ["project.json"] = 271,
    ["prometheus.json"] = 279,
    ["prometheus.rules.json"] = 280,
    ["proxies.json"] = 281,
    ["publiccode.yml"] = 282,
    ["pubspec.yaml"] = 283,
    ["pyrseas-0.8.json"] = 286,
    ["release drafter"] = 409,
    ["sarif-1.0.0.json"] = 297,
    ["sarif-2.0.0.json"] = 298,
    ["sarif-2.1.0"] = 307,
    ["sarif-2.1.0-rtm.2"] = 299,
    ["sarif-2.1.0-rtm.3"] = 301,
    ["sarif-2.1.0-rtm.4"] = 303,
    ["sarif-2.1.0-rtm.5"] = 305,
    ["sarif-external-property-file-2.1.0"] = 308,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 300,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 302,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 304,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 306,
    ["schema.org - Action"] = 310,
    ["schema.org - ContactPoint"] = 311,
    ["schema.org - Place"] = 312,
    ["schema.org - Thing"] = 313,
    ["servicehub.config.json"] = 388,
    ["servicehub.service.json"] = 387,
    ["settings.job"] = 316,
    ["sfdx-hardis configuration"] = 318,
    ["size-limit configuration"] = 319,
    ["skaffold.yaml"] = 448,
    ["skyuxconfig.json"] = 320,
    snapcraft = 321,
    swcrc = 436,
    taskcat = 405,
    ["template.json"] = 340,
    ["templatsources.json"] = 341,
    ["theme.json"] = 342,
    tmLanguage = 343,
    ["trunk.yaml schema"] = 348,
    ["ts-force-config.json"] = 352,
    ["tsconfig.json"] = 349,
    ["tsd.json"] = 350,
    ["tsdrc.json"] = 351,
    ["tslint.json"] = 353,
    ...
    ["version.json"] = 364,
    ["vim-addon-info"] = 365,
    ["vs-2017.3.host.json"] = 367,
    ["vs-nesting.json"] = 368,
    ["vsls.json"] = 366,
    ["vss-extension.json"] = 372,
    ["webjobpublishsettings.json"] = 377,
    ["webjobs-list.json"] = 376,
    ["xs-app.json"] = 401,
    ["xunit.runner.json"] = 386,
    yamllint = 424,
    zuul = 410,
    ["Žinoma"] = 418
  },
