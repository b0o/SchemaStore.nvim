...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 165,
    [".cryproj (generic)"] = 568,
    [".cryproj engine-5.2"] = 563,
    [".cryproj engine-5.3"] = 564,
    [".cryproj engine-5.4"] = 565,
    [".cryproj engine-5.5"] = 566,
    [".cryproj engine-dev"] = 567,
    [".csscomb.json"] = 167,
    [".csslintrc"] = 168,
    [".es6importsorterrc.json"] = 695,
    [".eslintrc"] = 214,
    [".esmrc.json"] = 206,
    [".ffizer.yaml"] = 218,
    [".htmlhintrc"] = 264,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration Schema"] = 640,
    ["All Contributors configuration file"] = 694,
    ...
    ["Azure Pipelines"] = 54,
    ["Azure Static Web Apps CLI configuration file"] = 485,
    ["Azure Static Web Apps configuration file"] = 484,
    ["BX CI"] = 89,
    ["Better Code Hub"] = 613,
    ["Better Scripts"] = 90,
    BizTalkServerApplicationSchema = 583,
    ...
    ["Butane Config"] = 652,
    ["CICS TS region tagging"] = 659,
    ["CICS TS resource import"] = 660,
    ["CICS TS resource model"] = 661,
    ["CICS TS resource overrides"] = 662,
    ["CMake Presets"] = 91,
    ...
    ["Datahub Ingestion Recipe Schema"] = 666,
    ...
    ["Embrace Config Schema"] = 677,
    ["Error pages"] = 209,
    Esquio = 207,
    ["Estuary Flow Catalog Schema"] = 656,
    ["Expo SDK"] = 212,
    ...
    Goreleaser = 246,
    ["Goreleaser Pro"] = 247,
    ["Gradle Build Cache Node"] = 610,
    ["Gradle Enterprise"] = 609,
    ...
    Hadolint = 592,
    Hammerkit = 620,
    ["Hardware Sentry Configuration"] = 670,
    Hayson = 259,
    ...
    ["JFrog File Spec"] = 283,
    ["JFrog Pipelines YML DSL"] = 679,
    ["JMeter DSL cli config schema"] = 284,
    JReleaser = 286,
    ["JSON Document Transform"] = 293,
    ["JSON Feed"] = 294,
    ["JSON Resume"] = 437,
    ["JSON Schema Draft 2020-12"] = 559,
    ["JSON Schema Draft 4"] = 556,
    ["JSON Schema Draft 7"] = 557,
    ["JSON Schema Draft 8"] = 558,
    ...
    ["KSP-CKAN"] = 555,
    Kas = 299,
    ["Keycloak REST API"] = 686,
    ["Knative Functions - func.yaml"] = 228,
    ["KoDE/CI build.yaml"] = 675,
    ["Kong DBLess Schema"] = 676,
    KrakenD = 300,
    LOOBin = 316,
    Lefthook = 307,
    ["LinkML Metamodel"] = 314,
    Liquibase = 625,
    ["Liquibase Flow File"] = 626,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 674,
    ["Monika Configuration Schema"] = 672,
    ["Motif config"] = 576,
    ["NOX Framework (Service)"] = 361,
    ["Netin Diagnostic System Template"] = 635,
    ...
    ["OpenWeather Current Weather API"] = 617,
    ["OpenWeather Road Risk API"] = 616,
    ...
    Pyright = 426,
    Qodana = 645,
    ["Quali Torque Blueprint Spec 2"] = 667,
    ["QueryFirst config file"] = 689,
    ["RKE Cluster Configuration JSON Schema"] = 624,
    ["RKE Cluster Configuration YAML Schema"] = 623,
    ["Rancher Fleet"] = 422,
    Ray = 591,
    ["Read the Docs"] = 423,
    ["Red-DiscordBot Cog"] = 427,
    ["Red-DiscordBot Cog Repo"] = 428,
    ["Red-DiscordBot Trivia"] = 429,
    Renovate = 438,
    ["Replit schema"] = 432,
    RoadRunner = 439,
    Ruff = 435,
    ["Rust Project"] = 436,
    ["Rust toolchain"] = 441,
    ["SIL Kit Participant Configuration"] = 471,
    ["SIL Kit Registry Configuration"] = 472,
    SWADL = 494,
    ["Safebox Config Schema"] = 680,
    ["Sapphire CLI Config"] = 444,
    ["SauceCTL Configuration"] = 632,
    ["Schema Catalog"] = 457,
    ["Scoop manifest"] = 462,
    ["Semantic Data Fabric (SDF) file"] = 463,
    ["Semgrep Rule"] = 465,
    ["Serenity Code Generator (Sergen)"] = 466,
    ["Serverless Framework Configuration"] = 639,
    ["Serverless Workflow Schema"] = 641,
    ["Settings.paf"] = 468,
    ["Shopware 6 Configuration"] = 642,
    ["Shopware CLI Extension Store Configuration"] = 643,
    ["Shopware CLI Project Store Configuration"] = 644,
    ["Sigrid scope configuration file"] = 470,
    ["Slack app manifest"] = 474,
    Solidarity = 477,
    ["Solution filters"] = 478,
    ["Source Maps v3"] = 479,
    Sourcery = 480,
    SpecIF = 481,
    ["Sponge Mixin configuration"] = 482,
    ["StackHawk Scanner Configuration"] = 638,
    Stale = 486,
    Starship = 487,
    ["Statamic Blueprint"] = 488,
    ["StrmPrivacy Data Connector"] = 684,
    ["StrmPrivacy Data Contract"] = 685,
    ["StrmPrivacy SimpleSchema"] = 682,
    ["StrmPrivacy Stream"] = 683,
    ["StrmPrivacy batch job configuration file"] = 681,
    ["Stryker Mutator"] = 491,
    ["StyleCop Analyzers Configuration"] = 492,
    ["Swagger API 2.0"] = 495,
    TSON = 519,
    ["Talisman configuration"] = 497,
    ["Taskfile YAML Schema"] = 619,
    Taurus = 498,
    ["TestEnvironment.json"] = 507,
    ["Tier.run pricing.json"] = 501,
    Tikibase = 502,
    ["Traefik v2"] = 510,
    ["Traefik v2 File Provider"] = 511,
    Turborepo = 508,
    Tye = 646,
    ["UET BuildConfig.json"] = 690,
    ["UI5 Manifest"] = 526,
    ["UTAM Page Object"] = 529,
    ["Ubuntu Server Autoinstall"] = 524,
    ["Uniswap Token List"] = 601,
    ["Unreal Engine Uplugin"] = 691,
    ["Unreal Engine Uproject"] = 692,
    Updatecli = 653,
    Uplift = 688,
    ["User Journey Map YAML Schema"] = 622,
    V2Ray = 657,
    ["VSCode Code Snippets"] = 137,
    ["VSIX CLI publishing"] = 542,
    ["Vela Pipeline Configuration"] = 532,
    Vercel = 136,
    ["Web App Manifest"] = 549,
    ["Web types"] = 552,
    WebExtensions = 548,
    ["Webman package recipe"] = 663,
    ["Windows Package Manager Installer Manifest"] = 598,
    ["Windows Package Manager Locale Manifest"] = 599,
    ["Windows Package Manager Singleton Manifest"] = 597,
    ["Woodpecker pipeline config"] = 634,
    ["Xstate Machine Schema"] = 651,
    ["Yippee-Ki-JSON configuration YML"] = 603,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 65,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 699,
    ["bashly-strings.yml"] = 700,
    ["bashly.yml"] = 698,
    ["batect.yml"] = 64,
    ["beau.yml"] = 612,
    ...
    ["ize.toml"] = 687,
    ["jsconfig.json"] = 297,
    ["jscpd Configuration Schema"] = 668,
    jsdoc = 590,
    ["k3d.yaml"] = 298,
    ...
    ["lsdlschema.json"] = 320,
    ["madness.yml"] = 697,
    ["markdown-lint-check"] = 630,
    mboats = 637,
    ["micro-settings.json"] = 701,
    ["mimetypes.json"] = 327,
    ["mirrord-schema"] = 573,
    ["mta.yaml"] = 574,
    ["mtad.yaml"] = 575,
    ...
    samt = 442,
    samtrc = 443,
    ["sarif-1.0.0.json"] = 445,
    ["sarif-2.0.0.json"] = 446,
    ["sarif-2.1.0"] = 455,
    ["sarif-2.1.0-rtm.2"] = 447,
    ["sarif-2.1.0-rtm.3"] = 449,
    ["sarif-2.1.0-rtm.4"] = 451,
    ["sarif-2.1.0-rtm.5"] = 453,
    ["sarif-external-property-file-2.1.0"] = 456,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 448,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 450,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 452,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 454,
    ["schema.org - Action"] = 458,
    ["schema.org - ContactPoint"] = 459,
    ["schema.org - Place"] = 460,
    ["schema.org - Thing"] = 461,
    ["secrethub.yml"] = 704,
    ["semantic-release"] = 464,
    ["servicehub.config.json"] = 562,
    ["servicehub.service.json"] = 561,
    ["settings.job"] = 467,
    ["sfdx-hardis configuration"] = 469,
    ["size-limit configuration"] = 473,
    ["skaffold.yaml"] = 628,
    ["skyuxconfig.json"] = 475,
    snapcraft = 476,
    ["stripe-app-local.json"] = 490,
    ["stripe-app.json"] = 489,
    swcrc = 615,
    ["task.json"] = 496,
    taskcat = 582,
    ["template.json"] = 499,
    ["templatsources.json"] = 500,
    ["theme.json"] = 503,
    ["tizen_workspace.json"] = 504,
    tldr = 505,
    tmLanguage = 506,
    tmuxinator = 570,
    ["transcend.yml"] = 512,
    ["trunk.yaml schema"] = 513,
    ["ts-force-config.json"] = 517,
    ["tsconfig.json"] = 514,
    ["tsd.json"] = 515,
    ["tsdrc.json"] = 516,
    ["tslint.json"] = 518,
    ...
    ["vega-lite.json"] = 531,
    ["vega.json"] = 530,
    ["venvironment-basic.yaml"] = 534,
    ["venvironment.yaml"] = 533,
    ["version.json"] = 535,
    ["vim-addon-info"] = 536,
    ["vs-2017.3.host.json"] = 538,
    ["vs-nesting.json"] = 539,
    ["vsls.json"] = 537,
    ["vss-extension.json"] = 543,
    ["vtesttree.yaml"] = 544,
    ["vtestunit.yaml"] = 545,
    ["webhint.io"] = 664,
    ["webjobpublishsettings.json"] = 551,
    ["webjobs-list.json"] = 550,
    ["xs-app.json"] = 578,
    ["xunit.runner.json"] = 560,
    yamllint = 602,
    zuul = 587,
    ["Žinoma"] = 596
  },
