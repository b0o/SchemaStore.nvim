...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1113,
    [".nodehawkrc"] = 720,
    [".npmpackagejsonlintrc"] = 725,
    [".omletrc"] = 1294,
    [".phrase.yml"] = 807,
    [".phraseapp.yml"] = 808,
    [".pmbot.yml"] = 792,
    [".postcssrc"] = 801,
    [".powerpages-web-template-manifest"] = 803,
    [".pre-commit-config.yml"] = 804,
    [".pre-commit-hooks.yml"] = 805,
    [".putout.json"] = 842,
    [".rehyperc"] = 867,
    [".remarkrc"] = 871,
    [".sprite files"] = 973,
    ...
    [".vsconfig"] = 1074,
    [".vsext"] = 1075,
    ["1Password SSH Agent Config"] = 18,
    ["@factorial/drupal-breakpoints-css"] = 27,
    ["A micro editor config"] = 656,
    ["AAES evidence export (aaes.export/v1)"] = 1473,
    ["AAES evidence pack manifest (aaes.evidence-pack/1)"] = 1474,
    ABCClinicalDemandForecast = 38,
    ABCInventoryModuleData = 37,
    ABCSupplyPlan = 39,
    ["ACP Attempts"] = 40,
    ["ACP Cache File"] = 41,
    ["ACP Configuration File"] = 42,
    ["ACP Primer"] = 43,
    ["ACP Sync"] = 44,
    ["ACP Variables File"] = 45,
    ["AI Harness config"] = 47,
    ["AI Harness org policy"] = 48,
    AIConfig = 50,
    ["AMX Muse Program Descriptor"] = 1343,
    ["API Builder"] = 1149,
    ["AVA Configuration"] = 1213,
    ["AWS AppConfig Feature Flags-v1"] = 90,
    ["AWS CDK cdk.json"] = 325,
    ["AWS CloudFormation"] = 326,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 327,
    ["AWS Copilot Manifest"] = 1382,
    ["AWS SAM CLI Samconfig"] = 328,
    Acton = 1436,
    ["Adobe UXP Manifest"] = 1276,
    ["Aerleon Network & Service Definitions"] = 30,
    ["Aerleon Policy"] = 31,
    ["Agent Permission Policy"] = 1422,
    ["Agent Run Metrics"] = 32,
    ["AgentCore CLI"] = 1423,
    ["AgentCtl MCP"] = 1425,
    ["AgentCtl config"] = 1424,
    ["AgentCtl permissions"] = 1426,
    AgentLoopKit = 1427,
    Aider = 1372,
    Air = 34,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1393,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1392,
    ["Airlock Microgateway"] = 51,
    ["Alacritty Configuration"] = 1185,
    ["AlgoVoi Compliance Receipt v1"] = 19,
    ["All Contributors configuration file"] = 1239,
    ["Amazon S3 bucket CORS"] = 21,
    Ameba = 1,
    Anodizer = 526,
    ["Ansible Argument Specs"] = 508,
    ["Ansible Collection Galaxy"] = 515,
    ["Ansible Execution Environment"] = 505,
    ["Ansible Inventory"] = 514,
    ["Ansible Meta"] = 506,
    ["Ansible Meta Runtime"] = 507,
    ["Ansible Navigator Configuration"] = 517,
    ["Ansible Playbook"] = 512,
    ["Ansible Requirements"] = 509,
    ["Ansible Rulebook"] = 513,
    ["Ansible Tasks File"] = 511,
    ["Ansible Vars File"] = 510,
    ["Ansible-lint Configuration"] = 516,
    Any = 1304,
    ["AnyWork Automation Configuration"] = 26,
    ["Apollo Router"] = 1150,
    ["App config Spotify Backstage"] = 55,
    ["Applicant Profile Protocol"] = 23,
    ["Application Accelerator"] = 20,
    ["Application list for a WinUtil"] = 1322,
    ["ArchSmith diagram IR"] = 1465,
    ArchitectFX = 1327,
    ["Archival editor configuration"] = 70,
    ["Archival object definitions"] = 71,
    ["Archival site configuration"] = 72,
    ["Archival template definition"] = 73,
    ["Are The Types Wrong?"] = 79,
    ["Argo CD"] = 74,
    ["Argo Events"] = 75,
    ["Argo Workflows"] = 76,
    Arity = 77,
    AssemblyScript = 81,
    AsyncAPI = 84,
    ["AsyncAPI Tool File"] = 85,
    ["Atmos Manifests"] = 86,
    ["Aurora Agile Meta-Framework"] = 87,
    AutoAPICase = 1249,
    ["Avro Avsc"] = 88,
    ["Awesome Repositories"] = 89,
    ["Azure Container App template for defining an immutable revision"] = 92,
    ["Azure DevOps extension manifest"] = 95,
    ["Azure Device Update for IoT Hub import manifest"] = 93,
    ["Azure Device Update for IoT Hub update manifest"] = 94,
    ["Azure IoT Edge deployment"] = 98,
    ["Azure IoT Edge deployment template"] = 99,
    ["Azure IoT EdgeAgent deployment"] = 96,
    ["Azure IoT EdgeHub deployment"] = 97,
    ["Azure IoT Operations Wasm Graph Config"] = 1391,
    ["Azure IoT Operations connector metadata"] = 1388,
    ["Azure Landing Zones Library archetype definition"] = 103,
    ["Azure Landing Zones Library archetype override"] = 104,
    ["Azure Landing Zones Library architecture definition"] = 102,
    ["Azure Landing Zones Library metadata"] = 100,
    ["Azure Landing Zones Library policy default values"] = 101,
    ["Azure Pipelines"] = 139,
    ["Azure Static Web Apps CLI configuration file"] = 977,
    ["Azure Static Web Apps configuration file"] = 976,
    BMML = 1410,
    ["BOSH BPM Config"] = 167,
    ["BOSH CPI Config"] = 168,
    ["BOSH Deploy Config"] = 169,
    ["BOSH Job Spec"] = 170,
    ["BOSH Ops File"] = 172,
    ["BOSH Package Spec"] = 171,
    ["BX CI"] = 194,
    ["Bacon config"] = 13,
    Badness = 151,
    ["Barba-CV"] = 105,
    ["Bashly (bashly.yml)"] = 1243,
    ["Bashly Settings (bashly-settings.yml)"] = 1244,
    Bento = 1409,
    ["Better Code Hub"] = 1154,
    ["Better Scripts"] = 195,
    Bigconfig = 160,
    ["Biome Formatter Config"] = 106,
    ["Bitmovin Encoding Template"] = 1336,
    BizTalkServerApplicationSchema = 1120,
    Bleep = 196,
    ["Block Protocol Metadata"] = 193,
    ["Bluebricks blueprint config"] = 1415,
    ["Boyka Framework"] = 173,
    ["Bpod Finite-State Machine"] = 108,
    BrickKit = 174,
    Briefcase = 1126,
    ["Build Info"] = 184,
    Buildkite = 186,
    ["Bukkit plugin.yml"] = 185,
    ["BungeeCord plugin.yml"] = 191,
    ["Burnless SRE config"] = 6,
    ["Butane Config"] = 1198,
    C4InterFlow = 1351,
    ["CDK Environment Manager, concrete environment configuration"] = 1375,
    ["CDK Environment Manager, concrete environments definition"] = 1374,
    ["CDK Environment Manager, environment definition"] = 1373,
    ["CGS Card Game Specification (cgs.json)"] = 1281,
    ["CICS TS region tagging"] = 1207,
    ["CICS TS resource import"] = 1208,
    ["CICS TS resource model"] = 1209,
    ["CICS TS resource overrides"] = 1210,
    ["CMake Presets"] = 197,
    ["CNC Codes"] = 224,
    ["CRS WAF test file"] = 1311,
    ["CRS WAF test platform overrides file"] = 1312,
    ["CSS Comb (.csscomb.json)"] = 355,
    ["CSS Lint (.csslintrc)"] = 356,
    ["CSpell (cspell.json)"] = 354,
    ["CVE Record Format"] = 236,
    ["CVX achievements.yaml"] = 242,
    ["CVX competencies.yaml"] = 241,
    ["CVX config.yaml"] = 245,
    ["CVX education.yaml"] = 240,
    ["CVX experience.yaml"] = 239,
    ["CVX keywords.yaml"] = 244,
    ["CVX layout"] = 246,
    ["CVX personal.yaml"] = 237,
    ["CVX referees.yaml"] = 243,
    ["CVX summary.yaml"] = 238,
    CWL = 1287,
    ["Cache Warmup config"] = 198,
    ["Caido Proxy Configuration"] = 1451,
    ["Calqulus pipeline"] = 199,
    ["Camel YAML DSL"] = 200,
    ["Cannon TOML"] = 201,
    ["CanvasXpress cxplot"] = 202,
    ["CanvasXpress figure"] = 203,
    Carafe = 204,
    ["Cargo Config"] = 205,
    ["Cargo Make"] = 207,
    ["Cargo Manifest"] = 206,
    ["Catalog Info Backstage"] = 208,
    ["Chamaleon environment"] = 1340,
    ["Chamaleon properties"] = 1341,
    ["Chamaleon template"] = 1339,
    Changepacks = 1402,
    Changesets = 337,
    Changie = 209,
    Charmcraft = 210,
    Cheatsheets = 1195,
    ["ChordPro Configuration"] = 212,
    ["Chrome Extension"] = 318,
    ["Chromia Model"] = 213,
    ["Chromia Seeder Module Config"] = 215,
    ["Chromia Seeder Root Config"] = 214,
    ["Cinnamon Spice info.json"] = 116,
    ["CircleCI config.yml"] = 290,
    ["Citation File Format"] = 339,
    ["Citrus test case"] = 217,
    CityJSON = 218,
    ["Claude Code Keybindings"] = 231,
    ["Claude Code Launch Preview"] = 1464,
    ["Claude Code Plugin Manifest"] = 232,
    ["Claude Code Plugin Marketplace"] = 233,
    ["Claude Code Settings"] = 234,
    ["Clawject config"] = 230,
    ["Cloud Foundry Application Manifest"] = 1293,
    ["Cloud Run Spec v1"] = 1317,
    ["Cloud.gov Workshop Configuration"] = 117,
    ["CloudCannon Configuration"] = 122,
    ["CloudCannon Configuration (Collection Structures)"] = 131,
    ["CloudCannon Configuration (Collections)"] = 130,
    ["CloudCannon Configuration (Editables)"] = 129,
    ["CloudCannon Configuration (Inputs)"] = 124,
    ["CloudCannon Configuration (Snippets Definitions)"] = 128,
    ["CloudCannon Configuration (Snippets Imports)"] = 127,
    ["CloudCannon Configuration (Snippets)"] = 126,
    ["CloudCannon Configuration (Structure Value)"] = 125,
    ["CloudCannon Configuration (Structures)"] = 123,
    ["CloudEvents specification"] = 219,
    ["Code Climate"] = 291,
    CodeCV = 120,
    CodeRabbit = 119,
    ["Codecov configuration files"] = 308,
    Codex = 299,
    ["Codex Hooks"] = 300,
    ["Codex Plugin Manifest"] = 301,
    ["Codex Skill Metadata"] = 302,
    CodifyCLI = 121,
    Codux = 304,
    ["Cog config file"] = 225,
    ["Commandbox Box.json"] = 226,
    ["Commandbox Server.json"] = 227,
    ["Common Catalog Data"] = 316,
    ["Common Package Specification"] = 228,
    Concord = 1310,
    ["Configu .cfgu files"] = 1298,
    ["Configu .configu file"] = 1299,
    Conjure = 223,
    ["Container Structure Test"] = 1134,
    Containerlab = 1163,
    ["Context Passport"] = 2,
    ["Context Reasoning Format (CRF)"] = 221,
    ["Contextive Glossary"] = 1367,
    ContractGuard = 1164,
    Convex = 222,
    ["Crowdsec collection config"] = 348,
    ["Crowdsec parser config"] = 349,
    ["Crowdsec scenario config"] = 350,
    ["CumulusCI Config"] = 229,
    ["Cursor Agent Environment"] = 1420,
    ["Custom Machinery Machine"] = 1282,
    ["Custom Machinery Recipe"] = 1283,
    ["Cycle Stack File"] = 247,
    CycloneDX = 248,
    ["DWP Exchange - catalogue entry"] = 405,
    ["DWP Exchange - gateway"] = 403,
    ["DWP Exchange - meta"] = 404,
    ["Dagger module"] = 357,
    ["Dark Factory consumer config"] = 249,
    ["Dart Build Config (dart-build.json)"] = 358,
    ["Dart Test Config (dart-test.json)"] = 359,
    ["DashLord Configuration"] = 360,
    ["Data Contract Specification"] = 361,
    ["Data Product Specification"] = 362,
    ["DataYoga Connections"] = 250,
    ["DataYoga Job"] = 251,
    ["Datadog Continuous Testing"] = 616,
    ["Datadog Service Definition"] = 617,
    ["Datadog Software Catalog"] = 618,
    ["Datahub Ingestion Recipe"] = 1214,
    ["Debian Upstream Metadata file"] = 258,
    DebtLens = 259,
    ["Decision Reasoning Format (DRF)"] = 260,
    ["Deck config"] = 261,
    ["Declarative Automation Bundles"] = 1260,
    ["DeepMatch deeplinks spec"] = 262,
    ["Defakto CI"] = 1472,
    ["Dein Config"] = 263,
    ["Deno Config (deno.json)"] = 371,
    ["Dependency cruiser"] = 264,
    ["DeployStack Configuration"] = 265,
    ["Deployah Configuration"] = 1390,
    ["Deployer Recipe"] = 374,
    ["Design Tokens Community Group format"] = 266,
    ["Design Tokens Community Group resolver"] = 267,
    ["Deta Spacefile"] = 268,
    ["Detekt Config (detekt.yml)"] = 375,
    ["Devbox Config"] = 269,
    ["Devbox Plugin"] = 270,
    Devfile = 402,
    Devup = 1403,
    DipDup = 1313,
    ["Discord Webhook"] = 376,
    ["DocFx Config (docfx.json)"] = 381,
    ["Docker Desktop extension metadata"] = 378,
    ["Docs MCP Manifest"] = 382,
    Dofigen = 383,
    ["Dolittle Artifacts"] = 384,
    ["Dolittle Bounded Context Configuration"] = 385,
    ["Dolittle Event Horizons Configuration"] = 386,
    ["Dolittle Resources Configuration"] = 387,
    ["Dolittle Server Configuration"] = 388,
    ["Dolittle Tenant Map Configuration"] = 390,
    ["Dolittle Tenants Configuration"] = 389,
    ["Dolittle Topology"] = 391,
    ["DonateCaseBetterCasino menu"] = 1344,
    ["Draugr Saga"] = 369,
    ["Draugr Saga fragment"] = 370,
    ["Drupal Breakpoints"] = 272,
    ["Drupal Config"] = 284,
    ["Drupal Info"] = 273,
    ["Drupal Layouts"] = 274,
    ["Drupal Libraries"] = 275,
    ["Drupal Links Action"] = 276,
    ["Drupal Links Contextual"] = 277,
    ["Drupal Links Menu"] = 278,
    ["Drupal Links Task"] = 279,
    ["Drupal Migration"] = 280,
    ["Drupal Permissions"] = 281,
    ["Drupal Recipe"] = 282,
    ["Drupal Routing"] = 283,
    ["Drupal Services"] = 285,
    ["Drush site aliases"] = 397,
    ["Dust configuration"] = 400,
    ["Dynamic Bash Aliases (.aliases)"] = 1251,
    ["EAS config"] = 444,
    ["ECA - Editor Code Assistant"] = 407,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1240,
    ["ESLint Suppressions"] = 449,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1387,
    ["EasyVCR .NET"] = 446,
    ["Eidolon Resource"] = 1328,
    ["Elgato Stream Deck"] = 410,
    Elm = 1315,
    ["Embrace Config"] = 1226,
    Emmet = 1316,
    Endurica = 1264,
    ["Enonic XP API descriptor"] = 413,
    ["Enonic XP Admin Extension descriptor"] = 414,
    ["Enonic XP Admin Tool descriptor"] = 415,
    ["Enonic XP Application descriptor"] = 416,
    ["Enonic XP CMS descriptor"] = 417,
    ["Enonic XP Content Type descriptor"] = 418,
    ["Enonic XP Form Fragment descriptor"] = 419,
    ["Enonic XP ID Provider descriptor"] = 420,
    ["Enonic XP Layout descriptor"] = 421,
    ["Enonic XP Macro descriptor"] = 422,
    ["Enonic XP Mixin descriptor"] = 423,
    ["Enonic XP Page descriptor"] = 424,
    ["Enonic XP Part descriptor"] = 425,
    ["Enonic XP Service descriptor"] = 426,
    ["Enonic XP Site descriptor"] = 427,
    ["Enonic XP Style descriptor"] = 428,
    ["Enonic XP Task descriptor"] = 429,
    ["Enonic XP Webapp descriptor"] = 430,
    ["Enterprise Contract Policy Spec"] = 411,
    ["Envelope Team Definition"] = 1435,
    ["Envilder Map File"] = 412,
    ["Erda Pipeline"] = 1289,
    ["Erda Runtime"] = 1290,
    ["Espanso config.yml"] = 1413,
    ["Espanso match.yml"] = 1412,
    Esquio = 432,
    ["Estuary Flow Catalog"] = 1204,
    ["Ethereum ERC1155"] = 1429,
    ["Ethereum ERC721"] = 1428,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 437,
    ["EveryVoice TTS Toolkit Data Configuration"] = 438,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 442,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 441,
    ["EveryVoice TTS Toolkit Text Configuration"] = 439,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 440,
    ["Evolving Resolutive Process notation"] = 1389,
    ["Expo SDK"] = 443,
    ["Expoot app config"] = 445,
    ["F-Droid Data metadata"] = 451,
    ["FasterCI Configuration"] = 140,
    Fatou = 141,
    ["Fence configuration"] = 142,
    FiQuS = 455,
    Firebase = 453,
    ["Flatpak Builder Manifest"] = 456,
    ["FlexGet Config"] = 457,
    ["Flow.json Configurations"] = 1286,
    ["Fossa configuration file"] = 464,
    ["Fossa's fossa-deps file"] = 465,
    ["Foundry VTT - Base package Manifest"] = 459,
    ["Foundry VTT - Module Manifest"] = 460,
    ["Foundry VTT - System Data Template"] = 463,
    ["Foundry VTT - System Manifest"] = 461,
    ["Foundry VTT - World Manifest"] = 462,
    ["Foxx Manifest"] = 143,
    ["Freifunk.de Community API"] = 146,
    ["Frogbot Config"] = 147,
    ["G2P Mapping Configuration"] = 473,
    GAMA = 474,
    ["GCP Blueprint Metadata"] = 477,
    Gaspar = 475,
    ["GatewayCore API Gateway"] = 476,
    ["Gemini CLI settings"] = 478,
    ["GeoJSON.json latest"] = 1202,
    GherKing = 1206,
    ["GitHub Action"] = 488,
    ["GitHub Actions typing"] = 1324,
    ["GitHub CLI configuration"] = 489,
    ["GitHub CLI hosts"] = 490,
    ["GitHub Discussion"] = 491,
    ["GitHub Funding"] = 493,
    ["GitHub Issue Template configuration"] = 494,
    ["GitHub Issue Template forms"] = 495,
    ["GitHub Pages Jekyll"] = 496,
    ["GitHub Prompt"] = 492,
    ["GitHub Secret Scanning"] = 497,
    ["GitHub Workflow"] = 498,
    ["GitHub Workflow Template Properties"] = 499,
    ["GitHub automatically generated release notes configuration"] = 500,
    ["GitLab Agent for Kubernetes configuration"] = 1278,
    ["GitLab Duo Workflow"] = 502,
    GitResume = 504,
    GitVersion = 481,
    ["Gitea Issue Template configuration"] = 484,
    ["Gitea Issue Template forms"] = 485,
    Gitleaks = 482,
    ["Gitpod Configuration"] = 503,
    ["Glamour style"] = 479,
    ["GlazeWM settings"] = 1280,
    ["Global Privacy Control"] = 480,
    Goblet = 1259,
    ["Golangci-lint Configuration"] = 519,
    ["Golangci-lint Custom Plugins Configuration"] = 520,
    ["Google Chrome Related Website Sets"] = 454,
    ["Google Cloud Workflows"] = 324,
    ["Google Digital Assetlinks"] = 1368,
    Goreleaser = 524,
    ["Goreleaser Pro"] = 525,
    Goss = 527,
    ["Gradle Build Cache Node"] = 1152,
    ["Gradle Enterprise"] = 1151,
    ["Grafana 5.x Dashboard"] = 528,
    ["GraphQL Code Generator"] = 533,
    ["GraphQL Config"] = 532,
    ["GraphQL Mesh"] = 531,
    ["GroovyLint configuration"] = 534,
    ["Grunt JSHint task"] = 538,
    ["Grunt Watch task"] = 539,
    ["Grunt base task"] = 540,
    ["Grunt clean task"] = 536,
    ["Grunt copy task"] = 535,
    ["Grunt cssmin task"] = 537,
    HEMTT = 1116,
    ["HULL - Helm Uniform Layer Library"] = 1469,
    Hadolint = 1130,
    Hammerkit = 1162,
    ["Hardware Sentry Configuration"] = 1218,
    ["Hashgraph Online Skill Manifest"] = 9,
    ["HashiCorp Vault"] = 541,
    Hatch = 1131,
    Hayson = 544,
    ["Haystack Pipeline"] = 545,
    ["Hazelcast 5 Configuration"] = 546,
    ["Hecate Input Schema"] = 1379,
    ["Helm Chart.lock"] = 287,
    ["Helm Chart.yaml"] = 286,
    ["Helm Unittest Test Suite"] = 288,
    ["Heloisa Assistant Plugins Marketplace"] = 1462,
    ["Hex file"] = 289,
    ["Home Assistant Integration Manifest"] = 548,
    ["Homer dashboard configuration"] = 549,
    ["Hoverfly Simulation"] = 554,
    Hugo = 1194,
    ["Hugo Theme"] = 1193,
    ["Hulak Configuration"] = 557,
    ["Hyperfoil benchmark configuration"] = 556,
    ["IBM Zapp document"] = 558,
    ["IBM zCodeFormatSettings"] = 559,
    ["IMG Catapult PSP"] = 564,
    ["IVMS101 by CODE Protocol"] = 1279,
    ["Infinispan Configuration"] = 566,
    ["Infinispan Server Configuration"] = 567,
    Infrahub = 568,
    Istanbul = 1222,
    ["JDownloader2 crawler multi-rules"] = 582,
    ["JDownloader2 crawler single-rules"] = 581,
    ["JFrog Applications Config"] = 583,
    ["JFrog File Spec"] = 584,
    ["JFrog Pipelines YML DSL"] = 1228,
    ["JMeter DSL cli config"] = 585,
    JReleaser = 588,
    ["JSON Document Transform"] = 596,
    ["JSON Feed"] = 597,
    ["JSON Resume"] = 880,
    ["JSON Schema Draft 2020-12"] = 1095,
    ["JSON Schema Draft 4"] = 1092,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1261,
    ["JSON Schema Draft 7"] = 1093,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1262,
    ["JSON Schema Draft 8 (2019-09)"] = 1094,
    ["JSON-API"] = 595,
    ["JSON-e templates"] = 1159,
    ["JSON-stat 2.0"] = 1088,
    JSONPatch = 599,
    ["JSR Package Config (jsr.json)"] = 589,
    Jarl = 1395,
    Jasmine = 576,
    Jekyll = 577,
    ["Jenkins X Pipelines"] = 578,
    ["Jenkins X Requirements"] = 579,
    Jest = 580,
    Jocker = 586,
    ["Jovo Language Models"] = 587,
    Jsontron = 600,
    ["Jujutsu (jj) VCS config"] = 1381,
    ["KIMMDY config file"] = 611,
    ["KODE/CI build.yaml"] = 1224,
    ["KSP-AVC"] = 1089,
    ["KSP-CKAN"] = 1090,
    ["KSP-NetKAN"] = 1091,
    KSY = 1291,
    KSail = 471,
    ["KYA Manifest"] = 1292,
    ["Karakum configuration file"] = 466,
    Kas = 603,
    ["Kestra flow file"] = 612,
    ["Keycloak REST API"] = 1231,
    ["Knative Functions - func.yaml"] = 468,
    Knip = 469,
    ["Knip JSONC"] = 470,
    ["Knowledge Unit"] = 620,
    ["Kometa (nightly) config file"] = 614,
    ["Kometa config file"] = 613,
    ["Kong DBLess config"] = 1225,
    KrakenD = 615,
    ["Kubri Configuration"] = 623,
    LOOBin = 644,
    ["Lake configuration file"] = 1384,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 329,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 330,
    ["Landing Zone Accelerator on AWS - Global Config"] = 331,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 332,
    ["Landing Zone Accelerator on AWS - Network Config"] = 333,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 334,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 335,
    ["Landing Zone Accelerator on AWS - Security Config"] = 336,
    ["Lando (landofile)"] = 132,
    ["LangGraph Platform configuration"] = 1303,
    ["Language configuration"] = 1302,
    Lefthook = 630,
    ["Liferay client-extension.yaml"] = 637,
    ["LinkML Metamodel"] = 639,
    ["LiquiLens Evidence Carrier Reference v1"] = 641,
    ["LiquiLens Evidence Carrier v1"] = 640,
    Liquibase = 1169,
    ["Liquibase Flow File"] = 1170,
    ["Lively Properties"] = 643,
    ["Lobe AI Agent"] = 134,
    Loki = 135,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 689,
    ["MS2Rescore Configuration"] = 697,
    ["MSTest testconfig.json"] = 698,
    ["Madge configuration"] = 650,
    ["Madness (madness.yml)"] = 1242,
    ["Mado configuration"] = 651,
    ["Maestro Flow"] = 652,
    ["Mail Servers Configuration"] = 1416,
    ["MapEHR Mapping"] = 653,
    Markdownlint = 1173,
    ["Mason Registry"] = 1176,
    ["MegaLinter Custom Flavor"] = 658,
    ["MegaLinter configuration"] = 657,
    ["MegaLinter descriptor"] = 659,
    Melange = 1269,
    ["Meltano project definition"] = 660,
    ["Mergify Configuration"] = 699,
    ["Mermaid config"] = 4,
    ["Metadata for a Bazel module"] = 661,
    ["Metadata for a Cinnamon spice"] = 1320,
    ["Metatype Configuration"] = 662,
    ["MetricsHub Configuration"] = 663,
    ["MetricsHub Connector Configuration"] = 664,
    ["Micro Editor Syntax"] = 1252,
    ["Microsoft Band Web Tile"] = 665,
    ["Microsoft RulesEngine workflow rules"] = 1307,
    ["Microsoft RulesEngine workflow rules list"] = 1308,
    ["Minecraft Custom Main Menu Mod"] = 1270,
    ["Minecraft Data Pack Advancement"] = 667,
    ["Minecraft Data Pack Biome"] = 668,
    ["Minecraft Data Pack Configured Carver"] = 669,
    ["Minecraft Data Pack Damage Type"] = 670,
    ["Minecraft Data Pack Dimension"] = 672,
    ["Minecraft Data Pack Dimension Type"] = 671,
    ["Minecraft Data Pack Item Modifier"] = 673,
    ["Minecraft Data Pack Loot Table"] = 674,
    ["Minecraft Data Pack Metadata"] = 675,
    ["Minecraft Data Pack Predicate"] = 676,
    ["Minecraft Data Pack Recipe"] = 677,
    ["Minecraft Data Pack Tag"] = 678,
    ["Minecraft Data Pack Template Pool"] = 679,
    ["Minecraft Data Pack Trim Material"] = 684,
    ["Minecraft Data Pack Trim Pattern"] = 685,
    ["Minecraft Resource Pack Lang"] = 680,
    ["Minecraft Resource Pack Particle"] = 681,
    ["Minecraft Resource Pack Texture Mcmeta"] = 683,
    ["Minecraft Resourcepack Sounds"] = 682,
    ["MockServer Expectation"] = 691,
    ["MockServer Expectations"] = 692,
    ModuleAssembler = 687,
    ["Monade CLI Stack Configuration"] = 702,
    ["MongoDB Atlas Search Index Definition"] = 1223,
    ["Monika Configuration"] = 1221,
    ["Monoweave Configuration"] = 696,
    ["Motif config"] = 1112,
    MultiQC = 1361,
    ["NOX Framework (Service)"] = 724,
    ["Netin Diagnostic System Template"] = 1180,
    ["Netlify config"] = 705,
    ["Network-as-Code Data Model"] = 706,
    ["Next Gen UI Agent A2A Server Configuration"] = 707,
    ["Next Gen UI Agent Configuration"] = 709,
    ["Next Gen UI Agent MCP Server Configuration"] = 708,
    ["Nightwatch.js"] = 716,
    ["Nika workflow"] = 721,
    ["Node.js configuration"] = 1117,
    ["NueJS configuration file"] = 729,
    ["Nuitka Package Config"] = 1284,
    ["Nullstone config"] = 731,
    ["ODGS Data Rules"] = 738,
    ["ODGS Ontology Graph"] = 739,
    ["ODGS Standard Metrics"] = 737,
    ["OKF Graph"] = 1463,
    ["ONe's changelog entry"] = 753,
    ["ONe's service descriptor"] = 752,
    ["ORT Server repository environment configuration"] = 764,
    ["OSCAL Assessment Plan (AP)"] = 766,
    ["OSCAL Assessment Results (AR)"] = 767,
    ["OSCAL Catalog"] = 768,
    ["OSCAL Component Definition (CDef)"] = 769,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 770,
    ["OSCAL Profile"] = 771,
    ["OSCAL System Security Plan (SSP)"] = 772,
    ["OSS Review Toolkit configuration"] = 773,
    ["OSS Review Toolkit curation"] = 774,
    ["OSS Review Toolkit package configuration"] = 775,
    ["OSS Review Toolkit project package manager definition"] = 776,
    ["OSS Review Toolkit repository configuration"] = 777,
    ["OSS Review Toolkit resolutions"] = 778,
    ["October CMS columns"] = 735,
    ["October CMS fields"] = 736,
    ["Oh My Posh"] = 741,
    Okteto = 742,
    ["Ona Tasks and Services"] = 744,
    Opctl = 1115,
    ["Open Data Contract Standard (ODCS)"] = 757,
    ["Open Data Product Standard (ODPS)"] = 758,
    ["Open Know-How"] = 1366,
    ["Open Pentest Format"] = 759,
    OpenDecree = 1433,
    ["OpenDecree Configuration"] = 1434,
    ["OpenRewrite Resource"] = 755,
    OpenSRM = 760,
    OpenStatus = 1377,
    ["OpenTelemetry Declarative Configuration"] = 756,
    ["OpenUtau character yaml"] = 749,
    ["OpenUtau ustx"] = 750,
    ["OpenWeather Current Weather API"] = 1158,
    ["OpenWeather Road Risk API"] = 1157,
    ["Ory Hydra configuration"] = 555,
    ["Ory Keto configuration"] = 619,
    ["Ory Kratos configuration"] = 765,
    ["Ory Oathkeeper configuration"] = 733,
    ["Outblocks App configuration"] = 762,
    ["Outblocks database table"] = 763,
    ["Outblocks project configuration"] = 761,
    PDM = 786,
    POPxf = 798,
    ["POPxf Correlations"] = 799,
    ["PRML manifest"] = 806,
    Packer = 782,
    PactSpec = 783,
    Panache = 784,
    Pantsbuild = 1238,
    ["Paper paper-plugin.yml"] = 785,
    ["Pipeline component"] = 1171,
    ["Platform.sh application"] = 15,
    ["Platform.sh routes"] = 16,
    ["Platform.sh services"] = 17,
    ["Plex Prerolls"] = 796,
    ["PocketMine plugin.yml"] = 793,
    ["Podman Desktop Extension"] = 1453,
    ["Postman collection"] = 802,
    ["Power Pages Configuration"] = 1378,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1323,
    ["ProActions AI-Kit Configuration"] = 814,
    ["ProActions AI-Kit Configuration for Menus"] = 816,
    ["ProActions AI-Kit Configuration for Sections"] = 818,
    ["ProActions AI-Kit Configuration for Services"] = 815,
    ["ProActions AI-Kit Configuration for Steps"] = 819,
    ["ProActions AI-Kit Configuration for Templates"] = 817,
    ["Problem object RFC9457"] = 1267,
    ["Problem package format"] = 820,
    ["Problem package generators"] = 821,
    ["Problem package submissions"] = 822,
    ["Problem package test group metadata"] = 823,
    ["Production delivery manifest"] = 1471,
    Promtail = 837,
    Pterodactyl = 1217,
    ["Pull Request Labeler"] = 841,
    Pulumi = 849,
    ["PyGTA Config"] = 845,
    PyProject = 850,
    Pylock = 1369,
    Pyright = 851,
    ["Python script metadata"] = 1363,
    ["QType AI DSL"] = 854,
    Qgoda = 853,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1445,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1443,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1449,
    ["Qlik Talend Cloud Pipeline - Project"] = 1441,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1444,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1446,
    ["Qlik Talend Cloud Pipeline - Task"] = 1442,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1448,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1447,
    Qodana = 1190,
    ["Qt Creator workspace file"] = 1300,
    ["Quali Torque Blueprint Spec 2"] = 1215,
    ["QueryFirst config file"] = 1234,
    ["QuikRun Configuration"] = 1450,
    ["Qwen Code Settings"] = 1430,
    ["RKE Cluster Configuration JSON"] = 1168,
    ["RKE Cluster Configuration YAML"] = 1167,
    RadioHound = 844,
    ["Raid Profile"] = 1431,
    ["Raid Repo Configuration"] = 1432,
    Railpack = 856,
    Railway = 855,
    ["Rancher Fleet"] = 846,
    ["Rattler-build"] = 857,
    Ray = 1129,
    ["Read the Docs"] = 848,
    ["Red-DiscordBot Cog"] = 864,
    ["Red-DiscordBot Cog Repo"] = 865,
    ["Red-DiscordBot Trivia"] = 866,
    ["Releasaurus Config"] = 12,
    ReleaseKit = 11,
    ["Render Blueprints"] = 1166,
    RenderCV = 884,
    Renovate = 881,
    ["Renovate global configuration"] = 882,
    ["Renovate inherited configuration"] = 883,
    ["Replit config"] = 872,
    Restate = 1356,
    ["Revel Digital Gadget Definition File"] = 1380,
    RoadRunner = 886,
    ["Robust Station Image"] = 1386,
    Rockcraft = 887,
    ["Roo Coder Custom Modes"] = 888,
    Rubocop = 877,
    ["Rudder techniques"] = 1274,
    Ruff = 878,
    ["Rust Project"] = 879,
    ["Rust toolchain"] = 893,
    ["SDMX data message"] = 920,
    ["SDMX metadata message"] = 919,
    ["SDMX structure message"] = 918,
    ["SIL Kit Participant Configuration"] = 931,
    ["SIL Kit Registry Configuration"] = 932,
    ["SPDX 2.3"] = 974,
    SWADL = 990,
    ["Safebox Config"] = 1229,
    ["Sapphire CLI Config"] = 896,
    ["SauceCTL Configuration"] = 1177,
    Scarb = 916,
    ["Schema Catalog"] = 911,
    ["Scoop manifest"] = 917,
    ["Secure SDLC Evidence Bundle"] = 921,
    ["Semantic Data Fabric (SDF) file"] = 922,
    ["Semgrep Rule"] = 924,
    ["Serenity Code Generator (Sergen)"] = 925,
    ["Serverless Framework Configuration"] = 1184,
    ["Serverless Workflow"] = 1186,
    ["Settings for a Cinnamon spice"] = 1319,
    ["Settings.paf"] = 927,
    ["Shopware 6 Configuration"] = 1187,
    ["Shopware CLI Extension Store Configuration"] = 1188,
    ["Shopware CLI Project Store Configuration"] = 1189,
    ["Sigma Detection Rule"] = 929,
    ["SigmaCV CV"] = 7,
    ["Sigrid scope configuration file"] = 930,
    ["SkyPilot Task JSON"] = 1275,
    ["Slack app manifest"] = 937,
    ["Slang Server Configuration"] = 1457,
    Snapcraft = 939,
    ["Solarxy project config"] = 942,
    Solidarity = 943,
    ["Solution filters"] = 944,
    ["Source Maps v3"] = 945,
    Sourcery = 946,
    ["Spack bootstrap.yaml"] = 947,
    ["Spack cdash.yaml"] = 948,
    ["Spack ci.yaml"] = 949,
    ["Spack compilers.yaml"] = 950,
    ["Spack concretizer.yaml"] = 951,
    ["Spack config.yaml"] = 952,
    ["Spack definitions.yaml"] = 953,
    ["Spack develop.yaml"] = 954,
    ["Spack env_vars.yaml"] = 955,
    ["Spack environment"] = 961,
    ["Spack include.yaml"] = 956,
    ["Spack mirrors.yaml"] = 957,
    ["Spack modules.yaml"] = 958,
    ["Spack packages.yaml"] = 959,
    ["Spack repos.yaml"] = 960,
    ["Spack toolchains.yaml"] = 962,
    ["Spack upstreams.yaml"] = 963,
    ["Spack view.yaml"] = 964,
    ["Speakeasy Generation Config File"] = 968,
    ["Speakeasy Lint Configuration File"] = 965,
    ["Speakeasy Test Generation Configuration File"] = 966,
    ["Speakeasy Workflow File"] = 967,
    SpecIF = 969,
    ["Specmatic Configuration"] = 970,
    ["Specpin spec file"] = 5,
    ["Sponge Mixin configuration"] = 971,
    ["Spotlight Ruleset"] = 972,
    StackBlitz = 978,
    ["StackHawk Scanner Configuration"] = 1183,
    Stale = 979,
    Starfish = 980,
    ["Starlake Data Pipeline"] = 1155,
    Starship = 981,
    ["Statamic Blueprint"] = 982,
    ["Stella configuration file"] = 983,
    ["Streamlit configuration file"] = 984,
    ["Stryker Mutator"] = 987,
    ["StyleCop Analyzers Configuration"] = 988,
    ["Stylelint (.stylelintrc)"] = 989,
    ["Stylua Config"] = 1370,
    ["Sublime Syntax"] = 1230,
    ["Subsquid squid manifest"] = 1277,
    ["Swagger API 2.0"] = 991,
    ["Symfony Routing Configuration"] = 992,
    ["Symfony Serializer Mapping"] = 993,
    ["Symfony Services Configuration"] = 994,
    ["Symfony Validation Mapping"] = 995,
    ["Synadia Connect Component"] = 996,
    TSON = 1039,
    TSTyche = 1040,
    ["TYPO3 Vendor Bundler config"] = 1046,
    ["Tab data for a LinUtil"] = 1326,
    ["Tab list for a LinUtil"] = 1325,
    Tach = 997,
    ["Tach Domain"] = 998,
    Talhelper = 1000,
    ["Talisman configuration"] = 1001,
    Taplo = 1371,
    ["Taskfile config"] = 1160,
    Taurus = 1002,
    Tauticord = 1003,
    ["Tekton Pipeline"] = 1399,
    ["Tekton PipelineRun"] = 1400,
    ["Tekton Task"] = 1397,
    ["Tekton TaskRun"] = 1398,
    Telefonistka = 1357,
    ["Terraform PowerShell provider block manifest"] = 1006,
    ["Terraform PowerShell provider data source manifest"] = 1007,
    ["Terraform PowerShell provider resource manifest"] = 1008,
    ["Terraform PowerShell provider settings"] = 1009,
    ["Terrateam config"] = 1383,
    ["Tesseract configuration"] = 1010,
    ["TestEnvironment.json"] = 1020,
    ["TextMate Grammar"] = 1019,
    Threagile = 1014,
    ["Thunderbird Extension"] = 1079,
    ["Tier.run pricing.json"] = 1011,
    Tikibase = 1012,
    Tombi = 1017,
    ["Traefik v2"] = 1023,
    ["Traefik v2 File Provider"] = 1024,
    ["Traefik v3"] = 1025,
    ["Traefik v3 File Provider"] = 1026,
    ["Travis CI (.travis.yml)"] = 1022,
    Treefmt = 530,
    Trident = 1353,
    Trivy = 1029,
    ["TrueScript for *.tscript files"] = 1030,
    ["Tugboat QA config.yml"] = 1350,
    TunnelHub = 1265,
    Turborepo = 1021,
    Tycho = 1314,
    Tye = 1191,
    ["Tyk Gateway - Open Source v5.7+"] = 1362,
    ["UET BuildConfig.json"] = 1235,
    ["UI5 Manifest"] = 1052,
    ["UNCORS configuration"] = 1057,
    ["UTAM Page Object"] = 1055,
    ["Ubuntu Server Autoinstall"] = 1050,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1354,
    ["Uniswap Token List"] = 1140,
    ["Universal Schedule Format"] = 1058,
    ["Unreal Engine Uplugin"] = 1236,
    ["Unreal Engine Uproject"] = 1237,
    ["UpCloud CLI (upctl) configuration"] = 1355,
    ["Updatecli Compose"] = 1199,
    ["Updatecli Policy Manifest"] = 1200,
    ["Updatecli Policy Metadata"] = 1201,
    Uplift = 1233,
    ["Upsun config"] = 14,
    ["User Journey Map"] = 1165,
    V2Ray = 1205,
    ["VSCode Code Snippets"] = 312,
    ["VSIX CLI publishing"] = 1076,
    Vector = 1060,
    ["Vee JSON menu output"] = 1061,
    ["Vela Pipeline Configuration"] = 1064,
    Vercel = 311,
    ["Version Bumper config"] = 1065,
    Vespertide = 1404,
    ["Vespertide Migration"] = 1405,
    ["Vespertide Model"] = 1406,
    ["Viash Component Config"] = 1359,
    ["Viash Package Config"] = 1360,
    Visivo = 1263,
    Vogi = 1070,
    ["WP-CLI"] = 1085,
    Wake = 1352,
    ["Waku Config"] = 1329,
    ["Web App Manifest"] = 1081,
    ["Web types"] = 1084,
    WebExtensions = 1080,
    ["Webman package recipe"] = 1211,
    ["Windows Package Manager Installer Manifest"] = 1137,
    ["Windows Package Manager Locale Manifest"] = 1138,
    ["Windows Package Manager Singleton Manifest"] = 1136,
    ["WireMock CLI import configuration"] = 1335,
    ["WireMock CLI local service configuration"] = 1334,
    ["WireMock message stub mapping"] = 1333,
    ["WireMock stub mapping"] = 1332,
    ["Woodpecker pipeline config"] = 1179,
    ["Wrangler CLI"] = 1086,
    ["XenForo add-on manifest"] = 1087,
    ["Xstate Machine"] = 1197,
    ["Yandex Workflow Language"] = 1321,
    ["Yarn Config (.yarnrc.yml)"] = 1153,
    ["Yippee-Ki-JSON configuration YML"] = 1144,
    ["YouTrack App"] = 1318,
    ["Zarf Package Configuration"] = 1385,
    ["Zerops import file"] = 1306,
    ["Zola Configuration"] = 1396,
    abtop = 36,
    act3 = 1437,
    actionlint = 46,
    ["aerleon.yml"] = 29,
    aibench = 49,
    ["amplify.yml"] = 22,
    ["amxx-builder manifest"] = 1452,
    ["angular.json"] = 52,
    apko = 1268,
    ["app-definition.yaml"] = 56,
    ["apple-app-site-association"] = 54,
    ["appsettings.StormPetrel.json"] = 61,
    ["appsettings.json"] = 59,
    ["appsscript.json"] = 58,
    ["appveyor.yml"] = 60,
    ["aqua-generate-registry.yaml"] = 63,
    ["aqua-policy.yaml"] = 64,
    ["aqua.yaml"] = 62,
    ["arazzo.json"] = 66,
    ["arb.json"] = 67,
    ["arc.json"] = 69,
    ["architect.yml"] = 68,
    ["artifacthub-repo.yml"] = 78,
    ["asm-lsp"] = 80,
    ["ast-grep rules"] = 83,
    ["ast-grep sgconfig.yml"] = 82,
    ["azure.yaml"] = 91,
    ["babelrc.json"] = 149,
    ["bamboo-spec"] = 154,
    basedpyright = 152,
    ["bashly-strings.yml"] = 1245,
    ["batect.yml"] = 153,
    ["beef-database-codegen"] = 155,
    ["beef-database-v5-codegen"] = 157,
    ["beef-entity-codegen"] = 156,
    ["beef-entity-v5-codegen"] = 158,
    ["behat.yml"] = 175,
    ["bigquery-table"] = 159,
    ["bioimageio resource description"] = 1285,
    ["bitbucket-pipelines"] = 161,
    bitrise = 162,
    ["bitrise-step"] = 163,
    ["block.json"] = 192,
    ["bottom configuration"] = 107,
    ["bower.json"] = 165,
    ["bozr.suite.json"] = 179,
    bpkg = 1246,
    ["browser.i18n.json"] = 180,
    ["browsh configuration"] = 181,
    bucklescript = 182,
    ["buf.gen.yaml"] = 110,
    ["buf.lock"] = 111,
    ["buf.plugin.yaml"] = 112,
    ...
    ["build-changelog"] = 183,
    ["bun.lock"] = 188,
    ["bundleconfig.json"] = 189,
    ["bunfig.toml"] = 190,
    ["cargo-mutants-config.yaml"] = 115,
    ["cargo-nextest repository configuration"] = 710,
    ["cargo-nextest user configuration"] = 711,
    ["ccmod.json"] = 1330,
    ["cfgd Config"] = 1458,
    ["cfgd ConfigSource"] = 1461,
    ["cfgd Module"] = 1459,
    ["cfgd Profile"] = 1460,
    changelogging = 1297,
    ["chezmoi configuration"] = 211,
    ["chisel-slices.json"] = 338,
    ["chrome-extension-locales-messages.json"] = 319,
    ["chutzpah.json"] = 320,
    cibuildwheel = 216,
    ["clang-format (.clang-format)"] = 1203,
    ["clang-tidy"] = 295,
    clangd = 294,
    clib = 296,
    ["cloud-init: cloud-config userdata"] = 298,
    ["cloud-sdk-pipeline-configuration"] = 322,
    ["cloudbuild.json"] = 323,
    cloudify = 297,
    cmakefmt = 235,
    ["cmdx.yaml"] = 118,
    ...
    ["commands.json"] = 315,
    ["commit-check"] = 341,
    ["commitlint (.commitlintrc)"] = 1139,
    ["committed.toml"] = 342,
    ["compile_commands.json"] = 314,
    ["compilerconfig.json"] = 313,
    ["completely.yml"] = 1241,
    ["component-detection-manifest.json"] = 345,
    ["component.json"] = 344,
    ["composer.json"] = 343,
    ["conda-forge"] = 220,
    ["config.yaml"] = 847,
    ["contentmanifest.json"] = 321,
    ["contribute.json"] = 346,
    ["cosmos.config.json"] = 317,
    ["crowdin.yml"] = 347,
    crucible = 351,
    ["ctfd-setup configuration file"] = 1342,
    ["custom-elements.json"] = 1255,
    ["cypress.json"] = 352,
    ["dacier.yml"] = 1440,
    ["datalogic-scan2deploy-android"] = 363,
    ["datalogic-scan2deploy-ce"] = 364,
    datavzrd = 365,
    ["dbt Dependencies"] = 253,
    ["dbt Packages"] = 255,
    ["dbt Project"] = 254,
    ["dbt Selectors"] = 256,
    ["dbt YAML files"] = 257,
    ...
    ["ddev-global"] = 366,
    ["ddev-project"] = 367,
    ["debugsettings.json"] = 368,
    ["dependabot-v2.json"] = 373,
    ["dependabot.json"] = 372,
    ["deployed-cli"] = 1196,
    devconcurrent = 271,
    ["devcontainer-feature.json"] = 306,
    ["devcontainer.json"] = 305,
    devinit = 1146,
    ["devspace.yaml"] = 1219,
    djlint = 1147,
    ["docker bake"] = 379,
    ["docker sequencer"] = 380,
    ["docker-compose.yml"] = 1145,
    ["dockerd.json"] = 377,
    ["dotnet Release Index manifest"] = 392,
    ["dotnet-tools.json"] = 393,
    ["dotnetcli.host.json"] = 394,
    ["dprint.json"] = 395,
    ["drone.json"] = 396,
    ["dss-2.0.0.json"] = 398,
    ["dstack configuration"] = 399,
    ["dtool dataset metadata"] = 1337,
    ["dvc.yaml"] = 401,
    ["ecosystem.json"] = 406,
    ["editorconfig-checker"] = 408,
    eksctl = 409,
    ["electron-builder configuration file"] = 435,
    ["epr-manifest.json"] = 434,
    ["estampo.toml"] = 433,
    ["evcc.yaml"] = 436,
    ["ezd task runner"] = 447,
    ["fabric.mod.json"] = 450,
    ["first-timers-bot"] = 458,
    ["flagd flag configuration"] = 144,
    ["fly.io Configuration"] = 145,
    fulibWorkflows = 1178,
    ["function.json"] = 472,
    ["gRPC API Gateway & OpenAPI Config"] = 24,
    ["gematik health care insurance list"] = 1348,
    ["gematik health care patient list"] = 1345,
    ["gematik health care provider institution list"] = 1347,
    ["gematik health care provider list"] = 1346,
    ["gematik tiger test environment configuration"] = 1349,
    ["gh-dash"] = 486,
    ["gha-doctor"] = 487,
    ["git-cliff"] = 483,
    ["git-town.toml"] = 1394,
    ["github-settings-as-code"] = 873,
    ["gitlab-ci"] = 501,
    ["global.json"] = 518,
    ["glslint config"] = 3,
    ["go-feature-flag Flag Configuration"] = 522,
    ["gojo.yaml"] = 523,
    gollama = 521,
    ["hassette.toml"] = 547,
    ["haxelib.json"] = 542,
    ...
    ["ide.host.json"] = 560,
    ["ifstate.yaml"] = 561,
    ["imageoptimizer.json"] = 562,
    ["importmap.json"] = 565,
    ["index.toml (packwiz)"] = 1454,
    instant_python_config = 569,
    instant_python_custom_project = 570,
    intlayer = 571,
    ["ioBroker Configuration"] = 572,
    ["ioBroker JSON UI"] = 573,
    ["ioBroker Package manifest"] = 574,
    ["ixpect.conf.yaml"] = 575,
    ["ize.toml"] = 1232,
    ["jsconfig.json"] = 601,
    ["jscpd Configuration"] = 1216,
    jsdoc = 1128,
    ["k3d.yaml"] = 602,
    ["k9s aliases.yaml"] = 604,
    ["k9s cluster-config.yaml"] = 606,
    ["k9s config.yaml"] = 605,
    ["k9s hotkeys.yaml"] = 607,
    ["k9s plugins.yaml"] = 608,
    ["k9s skin.yaml"] = 609,
    ["k9s views.yaml"] = 610,
    ["kind cluster"] = 624,
    ["klin.json"] = 467,
    ["kontinuous-config.yaml"] = 622,
    ["kontinuous-values.yaml"] = 621,
    ["kustomization.yaml"] = 625,
    ["label-commenter-config.yml"] = 628,
    ["latexindent configuration"] = 133,
    ["launchsettings.json"] = 629,
    lazydocker = 1254,
    lazygit = 1253,
    ["lego.json"] = 631,
    ["lerna.json"] = 632,
    ["lgtm.yml"] = 633,
    ["liblab.config.json"] = 634,
    ["libman.json"] = 635,
    ["license-report-config.json"] = 636,
    ["linkinator.config.json"] = 638,
    ["lint-staged (.lintstagedrc)"] = 1104,
    ["litertlm_manifest.json"] = 642,
    ["local.settings.json"] = 646,
    ["localazy.json"] = 647,
    ["lotus.yaml"] = 645,
    ["lsd colors"] = 137,
    ["lsd config"] = 136,
    ...
    lychee = 1103,
    ["macro.json"] = 1220,
    ["markdown-link-check"] = 1174,
    maturin = 1175,
    mboats = 1182,
    ["mcdreforged.linked_directory_plugin.json"] = 655,
    ["mcdreforged.plugin.json"] = 654,
    memnex = 1438,
    ["micro-settings.json"] = 1247,
    ["mimetypes.json"] = 666,
    ["mirrord config"] = 1107,
    ["misata.yaml"] = 1106,
    mise = 1108,
    ...
    ["mkdocs.yml"] = 686,
    ["mockd.yaml"] = 690,
    ["mod.pw.toml (packwiz)"] = 1455,
    ["modelparams.dev Model"] = 693,
    ["models CLI"] = 694,
    ["monospace.yml"] = 695,
    ["moon.yml"] = 1331,
    ["mprocs Configuration file"] = 1301,
    ["mrdocs.yml"] = 688,
    ["mta.yaml"] = 1110,
    ["mtad.yaml"] = 1111,
    ["mycode.json"] = 703,
    nFPM = 715,
    ["napari plugin manifest"] = 704,
    neoload = 1123,
    ["nest-cli"] = 718,
    ["nexus-rpc-gen"] = 1421,
    ["nf-core module environment.yml"] = 712,
    ["nf-core module meta.yml"] = 713,
    ["nf-core subworkflow meta.yml"] = 714,
    ["ninjs (News in JSON)"] = 717,
    ["nitro.json"] = 1122,
    ["nixd configuration"] = 1273,
    ["nlu.json"] = 719,
    ["nodemon.json"] = 722,
    ["noodl config"] = 1181,
    ["notebook.mod.json"] = 723,
    now = 1118,
    ["npm-badges"] = 726,
    ["nswag.json"] = 730,
    ntangle = 732,
    ["nuclei-template.yaml"] = 727,
    ["nuget-project.json"] = 728,
    ["ocelot.json"] = 734,
    ogen = 740,
    ["omnisharp.json"] = 743,
    openHAB = 1407,
    ...
    oxfmt = 1417,
    oxlint = 1418,
    ["pack.toml (packwiz)"] = 1456,
    ["package.json"] = 779,
    ["package.manifest"] = 781,
    ["package.yaml"] = 780,
    ["partial-black.json"] = 176,
    ["partial-fastapi.json"] = 177,
    ["partial-pixi.json"] = 791,
    ["partial-scheduled.json"] = 178,
    ["pattern.json"] = 789,
    ["petstore-v1.0"] = 1227,
    pgap_yaml_input_reader = 787,
    pgrls = 788,
    pgxgen = 1411,
    pitcms = 1414,
    ["pixi.toml"] = 790,
    ["plagiarize-me.yaml"] = 795,
    ["plagiarize.yaml"] = 794,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1338,
    ["podbard.yaml"] = 797,
    ["portman.json"] = 800,
    ["prefect.toml"] = 809,
    ["prefect.yaml"] = 810,
    ...
    ["prettierrc.json"] = 812,
    ["prisma.yml"] = 813,
    ["project-1.0.0-beta3.json"] = 825,
    ["project-1.0.0-beta4.json"] = 826,
    ["project-1.0.0-beta5.json"] = 827,
    ["project-1.0.0-beta6.json"] = 828,
    ["project-1.0.0-beta8.json"] = 829,
    ["project-1.0.0-rc1.json"] = 830,
    ["project-1.0.0-rc2.json"] = 831,
    ["project.json"] = 824,
    ["project.owasp.yaml"] = 832,
    ["prometheus-alertmanager.json"] = 836,
    ["prometheus.json"] = 833,
    ["prometheus.rules.json"] = 834,
    ["prometheus.rules.test.json"] = 835,
    ["proxies.json"] = 838,
    ["publiccode.yml"] = 839,
    ["pubspec.yaml"] = 840,
    ["pyrseas-0.8.json"] = 843,
    pytest = 852,
    ["quilt.mod.json"] = 1248,
    ["rc3 auth"] = 858,
    ["rc3 collection"] = 859,
    ...
    ["rc3 settings"] = 863,
    ["registry.yaml"] = 65,
    ["release drafter"] = 1124,
    ["release-hub.json"] = 10,
    ["release-please-config.json"] = 868,
    ["release-please-manifest.json"] = 869,
    ["release-plz.toml"] = 870,
    ["renv.lock"] = 885,
    ["replacement-transformer.yaml"] = 626,
    ["reposets Configuration"] = 874,
    ["reposets Credentials"] = 875,
    ["revola.json"] = 8,
    ["rivet.json"] = 1272,
    ["rivet.yaml (legacy)"] = 1271,
    rumdl = 890,
    runny = 889,
    runspec = 1439,
    rustfmt = 891,
    ...
    samt = 894,
    samtrc = 895,
    ["sarif-1.0.0.json"] = 897,
    ["sarif-2.0.0.json"] = 898,
    ["sarif-2.1.0"] = 908,
    ["sarif-2.1.0-rtm.2"] = 899,
    ["sarif-2.1.0-rtm.3"] = 901,
    ["sarif-2.1.0-rtm.4"] = 903,
    ["sarif-2.1.0-rtm.5"] = 905,
    ["sarif-2.1.0-rtm.6"] = 906,
    ["sarif-external-property-file-2.1.0"] = 909,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 900,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 902,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 904,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 907,
    ["scalingo.json configuration"] = 910,
    ["schema.org - Action"] = 912,
    ["schema.org - ContactPoint"] = 913,
    ["schema.org - Place"] = 914,
    ["schema.org - Thing"] = 915,
    ["secrethub.yml"] = 1250,
    ["semantic-release"] = 923,
    servercn = 1467,
    ["servicehub.config.json"] = 1098,
    ["servicehub.service.json"] = 1097,
    ["settings.job"] = 926,
    ["sfdx-hardis configuration"] = 928,
    ["shard.yml"] = 1288,
    ["size-limit configuration"] = 933,
    ["skaffold.yaml"] = 1172,
    ["skill-map plugin extension manifest"] = 934,
    ["skill-map project settings"] = 935,
    ["skill-map provider kind"] = 936,
    ["skyuxconfig.json"] = 938,
    ["snowflake-config"] = 940,
    ["snowflake-connections"] = 941,
    ["spicepod.yaml"] = 1309,
    ["sqlc configuration"] = 975,
    ["stripe-app-local.json"] = 986,
    ["stripe-app.json"] = 985,
    swcrc = 1156,
    ["task.json"] = 999,
    taskcat = 1119,
    ["template.json"] = 1004,
    ["templatsources.json"] = 1005,
    ["text2confl config"] = 1419,
    ["theme.json"] = 1013,
    ["tizen_workspace.json"] = 1015,
    tldr = 1016,
    ["tm_devices configuration file"] = 1376,
    tmuxinator = 1101,
    tox = 1018,
    ["transcend.yml"] = 1027,
    ["tree-sitter grammar.json"] = 529,
    ["trime.yaml"] = 1028,
    ["trunk.yaml"] = 1031,
    ["ts-force-config.json"] = 1037,
    tsbuild = 1032,
    ["tsconfig.json"] = 1033,
    ["tsd.json"] = 1034,
    ["tsdoc.json"] = 1035,
    ...
    uv = 1059,
    v8r = 1078,
    ["value-add-transformer.yaml"] = 627,
    vcluster = 1295,
    ["vcpkg configuration file"] = 310,
    ["vcpkg manifest file"] = 309,
    ["vega-lite.json"] = 1063,
    ["vega.json"] = 1062,
    version = 1358,
    ["version.json"] = 1066,
    ["vhwdebugger-binding.yaml"] = 1068,
    ["vim-addon-info"] = 1069,
    ["vs-2017.3.host.json"] = 1072,
    ["vs-nesting.json"] = 1073,
    ["vsls.json"] = 1071,
    ["vss-extension.json"] = 1077,
    vtcfg = 1364,
    ["warp-keysets.json"] = 1256,
    ["warp-themes.json"] = 1257,
    ["warp-workflows.json"] = 1258,
    ["webhint.io"] = 1212,
    ["webjobpublishsettings.json"] = 1083,
    ["webjobs-list.json"] = 1082,
    ["well-known-fursona"] = 1296,
    ["xs-app.json"] = 1114,
    ["xunit.runner.json"] = 1096,
    ["yaml-workflow"] = 1466,
    yamlfmt = 1141,
    yamllint = 1142,
    ["yap.json"] = 1143,
  ...
  schemas = { {
      ...
      fileMatch = { "brickkit.yaml", "brickkit.*.yaml" },
      name = "BrickKit",
      ...
      fileMatch = { "**/.cargo/config", "**/.cargo/config.toml" },
      name = "Cargo Config",
      ...
      fileMatch = { "replacement-transformer.yaml", "replacement-transformer.yml", "replacementtransformer.yaml", "replacementtransformer.yml" },
      ...
      fileMatch = { "value-add-transformer.yaml", "value-add-transformer.yml", "valueaddtransformer.yaml", "valueaddtransformer.yml" },
      ...
      fileMatch = { "promtail.yaml", "promtail.yml", "promtail-config.yaml", "promtail-config.yml" },
      name = "Promtail",
      ...
      fileMatch = { "thunderbird-extension.json" },
