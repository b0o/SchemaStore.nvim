...
M.json = {
  ...
  index = {
    ...
    AIConfig = 34,
    ["AMX Muse Program Descriptor"] = 1172,
    ["API Builder"] = 980,
    ["AVA Configuration"] = 1043,
    ...
    ["AWS Copilot Manifest"] = 1211,
    ["AWS SAM CLI Samconfig"] = 267,
    ["Adobe UXP Manifest"] = 1106,
    ["Aerleon Network & Service Definitions"] = 20,
    ["Aerleon Policy"] = 21,
    ["AgentCore CLI"] = 1251,
    Aider = 1201,
    Air = 23,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1222,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1221,
    ["Airlock Microgateway"] = 35,
    ["Alacritty Configuration"] = 1015,
    ["All Contributors configuration file"] = 1069,
    ...
    ["Application list for a WinUtil"] = 1151,
    ArchitectFX = 1156,
    ["Argo CD"] = 54,
    ["Argo Events"] = 55,
    ["Argo Workflows"] = 56,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1220,
    ["Azure IoT Operations connector metadata"] = 1217,
    ...
    ["Azure Pipelines"] = 113,
    ["Azure Static Web Apps CLI configuration file"] = 824,
    ["Azure Static Web Apps configuration file"] = 823,
    BMML = 1239,
    ["BOSH CPI Config"] = 139,
    ...
    ["Bacon config"] = 5,
    ["Barba-CV"] = 83,
    ["Bashly (bashly.yml)"] = 1073,
    ["Bashly Settings (bashly-settings.yml)"] = 1074,
    Bento = 1238,
    ["Better Code Hub"] = 985,
    ["Better Scripts"] = 161,
    Bigconfig = 132,
    ["Biome Formatter Config"] = 84,
    ["Bitmovin Encoding Template"] = 1165,
    BizTalkServerApplicationSchema = 952,
    Bleep = 162,
    ["Block Protocol Metadata"] = 159,
    ["Bluebricks blueprint config"] = 1244,
    ["Boyka Framework"] = 141,
    Briefcase = 958,
    ["Build Info"] = 150,
    Buildkite = 152,
    ...
    ["Butane Config"] = 1028,
    C4InterFlow = 1180,
    ["CDK Environment Manager, concrete environment configuration"] = 1204,
    ["CDK Environment Manager, concrete environments definition"] = 1203,
    ["CDK Environment Manager, environment definition"] = 1202,
    ["CGS Card Game Specification (cgs.json)"] = 1111,
    ["CICS TS region tagging"] = 1037,
    ["CICS TS resource import"] = 1038,
    ["CICS TS resource model"] = 1039,
    ["CICS TS resource overrides"] = 1040,
    ["CMake Presets"] = 163,
    ["CNC Codes"] = 185,
    ["CRS WAF test file"] = 1141,
    ["CRS WAF test platform overrides file"] = 1142,
    ...
    ["Chamaleon environment"] = 1169,
    ["Chamaleon properties"] = 1170,
    ["Chamaleon template"] = 1168,
    Changepacks = 1231,
    Changesets = 276,
    Changie = 172,
    Charmcraft = 173,
    ...
    ["Clawject config"] = 191,
    ["Cloud Foundry Application Manifest"] = 1123,
    ["Cloud Run Spec v1"] = 1146,
    ...
    Concord = 1140,
    ["Configu .cfgu files"] = 1128,
    ["Configu .configu file"] = 1129,
    Conjure = 184,
    ["Container Structure Test"] = 966,
    Containerlab = 994,
    ["Contextive Glossary"] = 1196,
    Convex = 183,
    ["Crowdsec collection config"] = 286,
    ["Crowdsec parser config"] = 287,
    ["Crowdsec scenario config"] = 288,
    ["CumulusCI Config"] = 190,
    ["Cursor Agent Environment"] = 1249,
    ["Custom Machinery Machine"] = 1112,
    ["Custom Machinery Recipe"] = 1113,
    ...
    ["DonateCaseBetterCasino menu"] = 1173,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1081,
    ["EAS config"] = 356,
    ["ECA - Editor Code Assistant"] = 339,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1070,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1216,
    ["EasyVCR .NET"] = 357,
    ["Eidolon Resource"] = 1157,
    ...
    ["Erda Pipeline"] = 1119,
    ["Erda Runtime"] = 1120,
    ["Espanso config.yml"] = 1242,
    ["Espanso match.yml"] = 1241,
    Esquio = 344,
    ["Estuary Flow Catalog"] = 1034,
    ["Ethereum ERC1155"] = 1253,
    ["Ethereum ERC721"] = 1252,
    ...
    ["Evolving Resolutive Process notation"] = 1218,
    ["Expo SDK"] = 355,
    ...
    ["GeoJSON.json latest"] = 1032,
    GherKing = 1036,
    ["GitHub Action"] = 390,
    ["GitHub Actions typing"] = 1153,
    ...
    ["Google Digital Assetlinks"] = 1197,
    Goreleaser = 418,
    ["Goreleaser Pro"] = 419,
    Goss = 420,
    ["Gradle Build Cache Node"] = 983,
    ["Gradle Enterprise"] = 982,
    ...
    Hadolint = 962,
    Hammerkit = 993,
    ["Hardware Sentry Configuration"] = 1048,
    ...
    ["JFrog File Spec"] = 471,
    ["JFrog Pipelines YML DSL"] = 1058,
    ["JMeter DSL cli config"] = 472,
    JReleaser = 475,
    ["JSON Document Transform"] = 483,
    ["JSON Feed"] = 484,
    ["JSON Resume"] = 734,
    ["JSON Schema Draft 2020-12"] = 930,
    ["JSON Schema Draft 4"] = 927,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1091,
    ["JSON Schema Draft 7"] = 928,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1092,
    ["JSON Schema Draft 8 (2019-09)"] = 929,
    ["JSON-API"] = 482,
    ["JSON-e templates"] = 990,
    ["JSON-stat 2.0"] = 923,
    JSONPatch = 486,
    ...
    ["Jujutsu (jj) VCS config"] = 1210,
    ["KIMMDY config file"] = 497,
    ["KODE/CI build.yaml"] = 1054,
    ["KSP-AVC"] = 924,
    ["KSP-CKAN"] = 925,
    ["KSP-NetKAN"] = 926,
    KSY = 1121,
    ...
    ["Metadata for a Cinnamon spice"] = 1149,
    ["Metatype Configuration"] = 539,
    ["MetricsHub Configuration"] = 540,
    ["MetricsHub Connector Configuration"] = 541,
    ["Micro Editor Syntax"] = 1082,
    ["Microsoft Band Web Tile"] = 542,
    ["Microsoft RulesEngine workflow rules"] = 1137,
    ["Microsoft RulesEngine workflow rules list"] = 1138,
    ["Minecraft Custom Main Menu Mod"] = 1100,
    ...
    ["MongoDB Atlas Search Index Definition"] = 1053,
    ["Monika Configuration"] = 1051,
    ["Monoweave Configuration"] = 569,
    ["Motif config"] = 944,
    MultiQC = 1190,
    ["NOX Framework (Service)"] = 590,
    ["Netin Diagnostic System Template"] = 1010,
    ["Netlify config"] = 577,
    ...
    ["OpenUtau ustx"] = 613,
    ["OpenWeather Current Weather API"] = 989,
    ["OpenWeather Road Risk API"] = 988,
    ...
    ["Power Pages Configuration"] = 1207,
    ["Preset list for a WinUtil"] = 1152,
    ...
    Pylock = 1198,
    Pyright = 708,
    ["Python script metadata"] = 1192,
    ["QType AI DSL"] = 711,
    Qgoda = 710,
    Qodana = 1020,
    ["Qt Creator workspace file"] = 1130,
    ["Quali Torque Blueprint Spec 2"] = 1045,
    ["QueryFirst config file"] = 1064,
    ["Qwen Code Settings"] = 1254,
    ["RKE Cluster Configuration JSON"] = 998,
    ["RKE Cluster Configuration YAML"] = 997,
    RadioHound = 701,
    ["Raid Profile"] = 1255,
    ["Raid Repo Configuration"] = 1256,
    Railpack = 713,
    Railway = 712,
    ["Rancher Fleet"] = 703,
    ["Rattler-build"] = 714,
    ...
    ReleaseKit = 3,
    ["Render Blueprints"] = 996,
    RenderCV = 738,
    Renovate = 735,
    ["Renovate global configuration"] = 736,
    ["Renovate inherited configuration"] = 737,
    ["Replit config"] = 729,
    Restate = 1185,
    ["Revel Digital Gadget Definition File"] = 1209,
    RoadRunner = 740,
    ["Robust Station Image"] = 1215,
    Rockcraft = 741,
    ["Roo Coder Custom Modes"] = 742,
    Rubocop = 731,
    ["Rudder techniques"] = 1104,
    Ruff = 732,
    ["Rust Project"] = 733,
    ["Rust toolchain"] = 746,
    ["SDMX data message"] = 773,
    ["SDMX metadata message"] = 772,
    ["SDMX structure message"] = 771,
    ["SIL Kit Participant Configuration"] = 783,
    ["SIL Kit Registry Configuration"] = 784,
    ["SPDX 2.3"] = 821,
    SWADL = 837,
    ["Safebox Config"] = 1059,
    ["Sapphire CLI Config"] = 749,
    ["SauceCTL Configuration"] = 1007,
    Scarb = 769,
    ["Schema Catalog"] = 764,
    ["Scoop manifest"] = 770,
    ["Semantic Data Fabric (SDF) file"] = 774,
    ["Semgrep Rule"] = 776,
    ["Serenity Code Generator (Sergen)"] = 777,
    ["Serverless Framework Configuration"] = 1014,
    ["Serverless Workflow"] = 1016,
    ["Settings for a Cinnamon spice"] = 1148,
    ["Settings.paf"] = 779,
    ["Shopware 6 Configuration"] = 1017,
    ["Shopware CLI Extension Store Configuration"] = 1018,
    ["Shopware CLI Project Store Configuration"] = 1019,
    ["Sigma Detection Rule"] = 781,
    ["Sigrid scope configuration file"] = 782,
    ["SkyPilot Task JSON"] = 1105,
    ["Slack app manifest"] = 786,
    Snapcraft = 788,
    Solidarity = 791,
    ["Solution filters"] = 792,
    ["Source Maps v3"] = 793,
    Sourcery = 794,
    ["Spack bootstrap.yaml"] = 795,
    ["Spack cdash.yaml"] = 796,
    ["Spack ci.yaml"] = 797,
    ["Spack compilers.yaml"] = 798,
    ["Spack concretizer.yaml"] = 799,
    ["Spack config.yaml"] = 800,
    ["Spack definitions.yaml"] = 801,
    ["Spack develop.yaml"] = 802,
    ["Spack env_vars.yaml"] = 803,
    ["Spack environment"] = 809,
    ["Spack include.yaml"] = 804,
    ["Spack mirrors.yaml"] = 805,
    ["Spack modules.yaml"] = 806,
    ["Spack packages.yaml"] = 807,
    ["Spack repos.yaml"] = 808,
    ["Spack toolchains.yaml"] = 810,
    ["Spack upstreams.yaml"] = 811,
    ["Spack view.yaml"] = 812,
    ["Speakeasy Generation Config File"] = 816,
    ["Speakeasy Lint Configuration File"] = 813,
    ["Speakeasy Test Generation Configuration File"] = 814,
    ["Speakeasy Workflow File"] = 815,
    SpecIF = 817,
    ["Specmatic Configuration"] = 818,
    ["Sponge Mixin configuration"] = 819,
    StackBlitz = 825,
    ["StackHawk Scanner Configuration"] = 1013,
    Stale = 826,
    Starfish = 827,
    ["Starlake Data Pipeline"] = 986,
    Starship = 828,
    ["Statamic Blueprint"] = 829,
    ["Stella configuration file"] = 830,
    ["Streamlit configuration file"] = 831,
    ["Stryker Mutator"] = 834,
    ["StyleCop Analyzers Configuration"] = 835,
    ["Stylelint (.stylelintrc)"] = 836,
    ["Stylua Config"] = 1199,
    ["Sublime Syntax"] = 1060,
    ["Subsquid squid manifest"] = 1107,
    ["Swagger API 2.0"] = 838,
    ["Synadia Connect Component"] = 839,
    TSON = 875,
    TSTyche = 876,
    ["TYPO3 Vendor Bundler config"] = 882,
    ["Tab data for a LinUtil"] = 1155,
    ["Tab list for a LinUtil"] = 1154,
    Tach = 840,
    ["Tach Domain"] = 841,
    Talhelper = 843,
    ["Talisman configuration"] = 844,
    Taplo = 1200,
    ["Taskfile config"] = 991,
    Taurus = 845,
    Tauticord = 846,
    ["Tekton Pipeline"] = 1228,
    ["Tekton PipelineRun"] = 1229,
    ["Tekton Task"] = 1226,
    ["Tekton TaskRun"] = 1227,
    Telefonistka = 1186,
    ["Terrateam config"] = 1212,
    ["TestEnvironment.json"] = 858,
    ["TextMate Grammar"] = 857,
    Threagile = 852,
    ["Tier.run pricing.json"] = 849,
    Tikibase = 850,
    Tombi = 855,
    ["Traefik v2"] = 861,
    ["Traefik v2 File Provider"] = 862,
    ["Traefik v3"] = 863,
    ["Traefik v3 File Provider"] = 864,
    ["Travis CI (.travis.yml)"] = 860,
    Treefmt = 423,
    Trident = 1182,
    ["TrueScript for *.tscript files"] = 867,
    ["Tugboat QA config.yml"] = 1179,
    TunnelHub = 1095,
    Turborepo = 859,
    Tycho = 1144,
    Tye = 1021,
    ["Tyk Gateway - Open Source v5.7+"] = 1191,
    ["UET BuildConfig.json"] = 1065,
    ["UI5 Manifest"] = 888,
    ["UNCORS configuration"] = 892,
    ["UTAM Page Object"] = 891,
    ["Ubuntu Server Autoinstall"] = 886,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1183,
    ["Uniswap Token List"] = 973,
    ["Universal Schedule Format"] = 893,
    ["Unreal Engine Uplugin"] = 1066,
    ["Unreal Engine Uproject"] = 1067,
    ["UpCloud CLI (upctl) configuration"] = 1184,
    ["Updatecli Compose"] = 1029,
    ["Updatecli Policy Manifest"] = 1030,
    ["Updatecli Policy Metadata"] = 1031,
    Uplift = 1063,
    ["Upsun config"] = 6,
    ["User Journey Map"] = 995,
    V2Ray = 1035,
    ["VSCode Code Snippets"] = 251,
    ["VSIX CLI publishing"] = 911,
    Vector = 895,
    ["Vela Pipeline Configuration"] = 898,
    Vercel = 250,
    ["Version Bumper config"] = 901,
    Vespertide = 1233,
    ["Vespertide Migration"] = 1234,
    ["Vespertide Model"] = 1235,
    ["Viash Component Config"] = 1188,
    ["Viash Package Config"] = 1189,
    Visivo = 1093,
    ["WP-CLI"] = 921,
    Wake = 1181,
    ["Waku Config"] = 1158,
    ["Web App Manifest"] = 917,
    ["Web types"] = 920,
    WebExtensions = 916,
    ["Webman package recipe"] = 1041,
    ["Windows Package Manager Installer Manifest"] = 969,
    ["Windows Package Manager Locale Manifest"] = 970,
    ["Windows Package Manager Singleton Manifest"] = 968,
    Winutil = 971,
    ["WireMock CLI import configuration"] = 1164,
    ["WireMock CLI local service configuration"] = 1163,
    ["WireMock message stub mapping"] = 1162,
    ["WireMock stub mapping"] = 1161,
    ["Woodpecker pipeline config"] = 1009,
    ["Wrangler CLI"] = 922,
    ["Xstate Machine"] = 1027,
    ["Yandex Workflow Language"] = 1150,
    ["Yarn Config (.yarnrc.yml)"] = 984,
    ["Yippee-Ki-JSON configuration YML"] = 975,
    ["YouTrack App"] = 1147,
    ["Zarf Package Configuration"] = 1214,
    ["Zerops.io config"] = 1135,
    ["Zerops.io import"] = 1136,
    ["Zola Configuration"] = 1225,
    ["aerleon.yml"] = 19,
    ["amplify.yml"] = 12,
    ["angular.json"] = 36,
    apko = 1098,
    ...
    ["behat.yml"] = 142,
    ["bigquery-table"] = 131,
    ["bioimageio resource description"] = 1115,
    ...
    ["chutzpah.json"] = 259,
    cibuildwheel = 178,
    ["clang-format (.clang-format)"] = 1033,
    ["clang-tidy"] = 237,
    clangd = 236,
    clib = 238,
    ...
    ["crowdin.yml"] = 285,
    ["ctfd-setup configuration file"] = 1171,
    ["custom-elements.json"] = 1085,
    ["cypress.json"] = 289,
    ...
    ["gematik health care insurance list"] = 1177,
    ["gematik health care patient list"] = 1174,
    ["gematik health care provider institution list"] = 1176,
    ["gematik health care provider list"] = 1175,
    ["gematik tiger test environment configuration"] = 1178,
    ["git-town.toml"] = 1223,
    ["gitlab-ci"] = 398,
    ["global.json"] = 414,
    ...
    ["lint-staged (.lintstagedrc)"] = 938,
    ["local.settings.json"] = 526,
    ["localazy.json"] = 527,
    ["lotus.yaml"] = 525,
    ["lsdlschema.json"] = 528,
    ["macro.json"] = 1050,
    ["markdown-link-check"] = 1004,
    maturin = 1005,
    mboats = 1012,
    ["micro-settings.json"] = 1077,
    ["mimetypes.json"] = 543,
    ["mirrord config"] = 940,
    mise = 941,
    ["mkdocs.yml"] = 563,
    ...
    ["monospace.yml"] = 568,
    ["moon.yml"] = 1160,
    ["mprocs Configuration file"] = 1131,
    ["mrdocs.yml"] = 565,
    ["mta.yaml"] = 942,
    ["mtad.yaml"] = 943,
    ["mycode.json"] = 575,
    ...
    ["plagiarize.yaml"] = 653,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1167,
    ["podbard.yaml"] = 656,
    ["portman.json"] = 659,
    ["prefect.toml"] = 667,
    ["prefect.yaml"] = 668,
    ...
    samt = 747,
    samtrc = 748,
    ["sarif-1.0.0.json"] = 750,
    ["sarif-2.0.0.json"] = 751,
    ["sarif-2.1.0"] = 761,
    ["sarif-2.1.0-rtm.2"] = 752,
    ["sarif-2.1.0-rtm.3"] = 754,
    ["sarif-2.1.0-rtm.4"] = 756,
    ["sarif-2.1.0-rtm.5"] = 758,
    ["sarif-2.1.0-rtm.6"] = 759,
    ["sarif-external-property-file-2.1.0"] = 762,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 753,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 755,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 757,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 760,
    ["scalingo.json configuration"] = 763,
    ["schema.org - Action"] = 765,
    ["schema.org - ContactPoint"] = 766,
    ["schema.org - Place"] = 767,
    ["schema.org - Thing"] = 768,
    ["secrethub.yml"] = 1080,
    ["semantic-release"] = 775,
    ["servicehub.config.json"] = 933,
    ["servicehub.service.json"] = 932,
    ["settings.job"] = 778,
    ["sfdx-hardis configuration"] = 780,
    ["shard.yml"] = 1118,
    ["size-limit configuration"] = 785,
    ["skaffold.yaml"] = 1002,
    ["skyuxconfig.json"] = 787,
    ["snowflake-config"] = 789,
    ["snowflake-connections"] = 790,
    ["spicepod.yaml"] = 1139,
    ["sqlc configuration"] = 822,
    ["stripe-app-local.json"] = 833,
    ["stripe-app.json"] = 832,
    swcrc = 987,
    ["task.json"] = 842,
    taskcat = 951,
    ["template.json"] = 847,
    ["templatsources.json"] = 848,
    ["text2confl config"] = 1248,
    ["theme.json"] = 851,
    ["tizen_workspace.json"] = 853,
    tldr = 854,
    ["tm_devices configuration file"] = 1205,
    tmuxinator = 936,
    tox = 856,
    ["transcend.yml"] = 865,
    ...
    ["vega-lite.json"] = 897,
    ["vega.json"] = 896,
    ["venvironment.yaml"] = 899,
    ["venvplus.yaml"] = 900,
    version = 1187,
    ["version.json"] = 902,
    ["vhwdebugger-binding.yaml"] = 904,
    ["vim-addon-info"] = 905,
    ["vs-2017.3.host.json"] = 907,
    ["vs-nesting.json"] = 908,
    ["vsls.json"] = 906,
    ["vss-extension.json"] = 912,
    vtcfg = 1193,
    ["vtesttree.yaml"] = 913,
    ["vtestunit.yaml"] = 914,
    ["warp-keysets.json"] = 1086,
    ["warp-themes.json"] = 1087,
    ["warp-workflows.json"] = 1088,
    ["webhint.io"] = 1042,
    ["webjobpublishsettings.json"] = 919,
    ["webjobs-list.json"] = 918,
    ["well-known-fursona"] = 1126,
    ["xs-app.json"] = 946,
    ["xunit.runner.json"] = 931,
    yamllint = 974,
    zizmor = 1230,
    zuul = 957,
    ["Žinoma"] = 967
