...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 197,
    [".cryproj (generic)"] = 662,
    [".cryproj engine-5.2"] = 657,
    [".cryproj engine-5.3"] = 658,
    [".cryproj engine-5.4"] = 659,
    [".cryproj engine-5.5"] = 660,
    [".cryproj engine-dev"] = 661,
    [".eslintrc"] = 253,
    [".esmrc.json"] = 245,
    [".ffizer.yaml"] = 257,
    [".htmlhintrc"] = 313,
    ...
    [".mtaext"] = 673,
    [".nodehawkrc"] = 423,
    [".npmpackagejsonlintrc"] = 427,
    [".omletrc"] = 848,
    [".phrase.yml"] = 473,
    [".phraseapp.yml"] = 474,
    [".pmbot.yml"] = 463,
    [".postcssrc"] = 468,
    [".powerpages-web-template-manifest"] = 470,
    [".pre-commit-config.yml"] = 471,
    [".pre-commit-hooks.yml"] = 472,
    [".putout.json"] = 493,
    [".rehyperc"] = 506,
    [".remarkrc"] = 508,
    [".sprite files"] = 566,
    ...
    ["<div>RIOTS' studio configuration"] = 640,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 377,
    AIConfig = 13,
    ["API Builder"] = 705,
    ["AVA Configuration"] = 765,
    ...
    ["Adobe UXP Manifest"] = 830,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 14,
    ["Airplane task"] = 15,
    ["Alacritty Configuration"] = 737,
    ["All Contributors configuration file"] = 795,
    ...
    ["Azure Pipelines"] = 67,
    ["Azure Static Web Apps CLI configuration file"] = 569,
    ["Azure Static Web Apps configuration file"] = 568,
    ["BX CI"] = 105,
    ["Bashly (bashly.yml)"] = 799,
    ["Bashly Settings (bashly-settings.yml)"] = 800,
    ["Better Code Hub"] = 709,
    ["Better Scripts"] = 106,
    Bigconfig = 84,
    BizTalkServerApplicationSchema = 679,
    Bleep = 107,
    ...
    ["Butane Config"] = 750,
    ["CGS Custom Card Game (CardGameDef.json)"] = 835,
    ["CICS TS region tagging"] = 759,
    ["CICS TS resource import"] = 760,
    ["CICS TS resource model"] = 761,
    ["CICS TS resource overrides"] = 762,
    ["CMake Presets"] = 108,
    ["CNC Codes"] = 120,
    ...
    CityJSON = 117,
    ["Clawject config"] = 125,
    ["Cloud Foundry Application Manifest"] = 847,
    ["Code Climate"] = 152,
    CodeCV = 63,
    ...
    ["DataYoga Job"] = 128,
    ["Databricks Asset Bundles"] = 816,
    ["Datadog Service Definition"] = 354,
    ["Datahub Ingestion Recipe"] = 766,
    ["Dein Config"] = 130,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 807,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 796,
    ...
    ["Goreleaser Pro"] = 294,
    Goss = 295,
    ["Gradle Build Cache Node"] = 707,
    ["Gradle Enterprise"] = 706,
    ...
    Hadolint = 688,
    Hammerkit = 716,
    ["Hardware Sentry Configuration"] = 770,
    Hatch = 689,
    Hayson = 308,
    ...
    Hugo = 746,
    ["Hugo Theme"] = 745,
    ["IBM Zapp document"] = 315,
    ["IBM zCodeFormatSettings"] = 316,
    ["IMG Catapult PSP"] = 321,
    ["IVMS101 by CODE Protocol"] = 833,
    Istanbul = 773,
    ["JDownloader2 crawler multi-rules"] = 331,
    ["JDownloader2 crawler single-rules"] = 330,
    ["JFrog Applications Config"] = 332,
    ["JFrog File Spec"] = 333,
    ["JFrog Pipelines YML DSL"] = 779,
    ["JMeter DSL cli config"] = 334,
    JReleaser = 336,
    ["JSON Document Transform"] = 344,
    ["JSON Feed"] = 345,
    ["JSON Resume"] = 513,
    ["JSON Schema Draft 2020-12"] = 653,
    ["JSON Schema Draft 4"] = 650,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 817,
    ["JSON Schema Draft 7"] = 651,
    ["JSON Schema Draft 7 (unofficial strict)"] = 818,
    ["JSON Schema Draft 8 (2019-09)"] = 652,
    ["JSON-API"] = 343,
    ["JSON-WF"] = 846,
    ["JSON-e templates"] = 714,
    ["JSON-stat 2.0"] = 647,
    JSONPatch = 347,
    ["JSR Package Config (jsr.json)"] = 337,
    Jasmine = 326,
    Jekyll = 327,
    ["Jenkins X Pipelines"] = 328,
    ["Jenkins X Requirements"] = 329,
    ["Jovo Language Models"] = 335,
    ["KIMMDY config file"] = 352,
    ["KSP-AVC"] = 648,
    ["KSP-CKAN"] = 649,
    KSY = 845,
    ["Karakum configuration file"] = 269,
    Kas = 350,
    ["Keycloak REST API"] = 787,
    ["Knative Functions - func.yaml"] = 270,
    ["KoDE/CI build.yaml"] = 775,
    ["Kong DBLess config"] = 776,
    KrakenD = 353,
    LOOBin = 372,
    Lefthook = 361,
    ["Liferay client-extension.yaml"] = 368,
    ["LinkML Metamodel"] = 370,
    Liquibase = 722,
    ["Liquibase Flow File"] = 723,
    ["Lively Properties"] = 371,
    ["Lobe AI Agent"] = 65,
    Loki = 66,
    ["MLOS Configs"] = 406,
    ["MS2Rescore Configuration"] = 409,
    ["Madness (madness.yml)"] = 798,
    Markdownlint = 726,
    ["Mason Registry"] = 728,
    ["MegaLinter configuration"] = 378,
    ["MegaLinter descriptor"] = 379,
    Melange = 824,
    ["Meltano plugin discovery definition"] = 381,
    ["Meltano project definition"] = 380,
    ["Mergify Configuration"] = 410,
    ["MetricsHub Configuration"] = 382,
    ["MetricsHub Connector Configuration"] = 383,
    ["Micro Editor Syntax"] = 808,
    ["Microsoft Band Web Tile"] = 384,
    ["Minecraft Custom Main Menu Mod"] = 825,
    ["Minecraft Data Pack Advancement"] = 386,
    ["Minecraft Data Pack Biome"] = 387,
    ["Minecraft Data Pack Configured Carver"] = 388,
    ["Minecraft Data Pack Damage Type"] = 389,
    ["Minecraft Data Pack Dimension"] = 391,
    ["Minecraft Data Pack Dimension Type"] = 390,
    ["Minecraft Data Pack Item Modifier"] = 392,
    ["Minecraft Data Pack Loot Table"] = 393,
    ["Minecraft Data Pack Metadata"] = 394,
    ["Minecraft Data Pack Predicate"] = 395,
    ["Minecraft Data Pack Recipe"] = 396,
    ["Minecraft Data Pack Tag"] = 397,
    ["Minecraft Data Pack Template Pool"] = 398,
    ["Minecraft Data Pack Trim Material"] = 403,
    ["Minecraft Data Pack Trim Pattern"] = 404,
    ["Minecraft Resource Pack Lang"] = 399,
    ["Minecraft Resource Pack Particle"] = 400,
    ["Minecraft Resource Pack Texture Mcmeta"] = 402,
    ["Minecraft Resourcepack Sounds"] = 401,
    ["MkDocs Configuration 1.0"] = 405,
    ["Monade CLI Stack Configuration"] = 413,
    ["MongoDB Atlas Search Index Definition"] = 774,
    ["Monika Configuration"] = 772,
    ["Monoweave Configuration"] = 408,
    ["Motif config"] = 672,
    ["NOX Framework (Service)"] = 426,
    ["Netin Diagnostic System Template"] = 732,
    ["Netlify config"] = 416,
    ["Network-as-Code Data Model"] = 417,
    ["Nightwatch.js"] = 418,
    ["Nuitka.yaml"] = 838,
    ["ONe's changelog entry"] = 442,
    ["ONe's service descriptor"] = 441,
    ["OSS Review Toolkit configuration"] = 449,
    ["OSS Review Toolkit curation"] = 450,
    ["OSS Review Toolkit package configuration"] = 451,
    ["OSS Review Toolkit repository configuration"] = 452,
    ["OSS Review Toolkit resolutions"] = 453,
    Opctl = 675,
    ["OpenRewrite Resource"] = 444,
    ["OpenUtau character yaml"] = 438,
    ["OpenUtau ustx"] = 439,
    ["OpenWeather Current Weather API"] = 713,
    ["OpenWeather Road Risk API"] = 712,
    ["Ory Hydra configuration"] = 314,
    ["Ory Keto configuration"] = 355,
    ["Ory Kratos configuration"] = 448,
    ["Ory Oathkeeper configuration"] = 433,
    ["Outblocks App configuration"] = 446,
    ["Outblocks database table"] = 447,
    ["Outblocks project configuration"] = 445,
    PDM = 459,
    Packer = 456,
    Pantsbuild = 794,
    ["Paper paper-plugin.yml"] = 457,
    ["Pipeline component"] = 724,
    ["PocketMine plugin.yml"] = 464,
    ["Postman collection"] = 469,
    ["Problem object RFC9457"] = 822,
    ["Problem package generators"] = 477,
    Pterodactyl = 769,
    ["Pull Request Labeler"] = 492,
    Pulumi = 498,
    PyProject = 499,
    Pyright = 500,
    Qgoda = 501,
    Qodana = 742,
    ["Quali Torque Blueprint Spec 2"] = 767,
    ["QueryFirst config file"] = 790,
    ["RKE Cluster Configuration JSON"] = 721,
    ["RKE Cluster Configuration YAML"] = 720,
    ["Rancher Fleet"] = 495,
    ["Rattler-build"] = 502,
    Ray = 687,
    ["Read the Docs"] = 497,
    ["Red-DiscordBot Cog"] = 503,
    ["Red-DiscordBot Cog Repo"] = 504,
    ["Red-DiscordBot Trivia"] = 505,
    ["Render Blueprints"] = 719,
    RenderCV = 515,
    Renovate = 514,
    ["Replit config"] = 509,
    RoadRunner = 516,
    ["Rudder techniques"] = 828,
    Ruff = 511,
    ["Rust Project"] = 512,
    ["Rust toolchain"] = 519,
    ["SDMX data message"] = 544,
    ["SDMX metadata message"] = 543,
    ["SDMX structure message"] = 542,
    ["SIL Kit Participant Configuration"] = 554,
    ["SIL Kit Registry Configuration"] = 555,
    SWADL = 580,
    ["Safebox Config"] = 780,
    ["Sapphire CLI Config"] = 522,
    ["SauceCTL Configuration"] = 729,
    ["Schema Catalog"] = 536,
    ["Scoop manifest"] = 541,
    ["Semantic Data Fabric (SDF) file"] = 545,
    ["Semgrep Rule"] = 547,
    ["Serenity Code Generator (Sergen)"] = 548,
    ["Serverless Framework Configuration"] = 736,
    ["Serverless Workflow"] = 738,
    ["Settings.paf"] = 550,
    ["Shopware 6 Configuration"] = 739,
    ["Shopware CLI Extension Store Configuration"] = 740,
    ["Shopware CLI Project Store Configuration"] = 741,
    Sigma = 552,
    ["Sigrid scope configuration file"] = 553,
    ["SkyPilot Task JSON"] = 829,
    ["Slack app manifest"] = 557,
    Solidarity = 560,
    ["Solution filters"] = 561,
    ["Source Maps v3"] = 562,
    Sourcery = 563,
    SpecIF = 564,
    ["Sponge Mixin configuration"] = 565,
    StackBlitz = 570,
    ["StackHawk Scanner Configuration"] = 735,
    Stale = 571,
    ["Starlake Data Pipeline"] = 710,
    Starship = 572,
    ["Statamic Blueprint"] = 573,
    ["Stella configuration file"] = 574,
    ["StrmPrivacy Data Connector"] = 784,
    ["StrmPrivacy Data Contract"] = 785,
    ["StrmPrivacy SimpleSchema"] = 782,
    ["StrmPrivacy Stream"] = 783,
    ["StrmPrivacy batch job configuration file"] = 781,
    ["Stryker Mutator"] = 577,
    ["StyleCop Analyzers Configuration"] = 578,
    ["Stylelint (.stylelintrc)"] = 579,
    ["Sublime Syntax"] = 786,
    ["Subsquid squid manifest"] = 831,
    ["Swagger API 2.0"] = 581,
    TSON = 607,
    TSTyche = 608,
    Talhelper = 583,
    ["Talisman configuration"] = 584,
    ["Taskfile config"] = 715,
    Taurus = 585,
    ["TestEnvironment.json"] = 594,
    ["TextMate Grammar"] = 593,
    ["Tier.run pricing.json"] = 588,
    Tikibase = 589,
    ["Traefik v2"] = 597,
    ["Traefik v2 File Provider"] = 598,
    ["Travis CI (.travis.yml)"] = 596,
    TunnelHub = 821,
    Turborepo = 595,
    Tye = 743,
    ["UET BuildConfig.json"] = 791,
    ["UI5 Manifest"] = 617,
    ["UNCORS configuration"] = 621,
    ["UTAM Page Object"] = 620,
    ["Ubuntu Server Autoinstall"] = 615,
    ["Uniswap Token List"] = 698,
    ["Unreal Engine Uplugin"] = 792,
    ["Unreal Engine Uproject"] = 793,
    ["Updatecli Compose"] = 751,
    ["Updatecli Policy Manifest"] = 752,
    ["Updatecli Policy Metadata"] = 753,
    Uplift = 789,
    ["User Journey Map"] = 718,
    V2Ray = 757,
    ["VSCode Code Snippets"] = 168,
    ["VSIX CLI publishing"] = 635,
    ["Vela Pipeline Configuration"] = 624,
    Vercel = 167,
    Visivo = 819,
    ["Web App Manifest"] = 642,
    ["Web types"] = 645,
    WebExtensions = 641,
    ["Webman package recipe"] = 763,
    ["Windows Package Manager Installer Manifest"] = 695,
    ["Windows Package Manager Locale Manifest"] = 696,
    ["Windows Package Manager Singleton Manifest"] = 694,
    ["Woodpecker pipeline config"] = 731,
    ["Wrangler CLI"] = 646,
    ["Xstate Machine"] = 749,
    ["Yarn Config (.yarnrc.yml)"] = 708,
    ["Yippee-Ki-JSON configuration YML"] = 700,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 16,
    apko = 823,
    ...
    ["behat.yml"] = 91,
    ["bigquery-table"] = 83,
    ["bioimageio resource description"] = 839,
    ...
    ["ide.host.json"] = 317,
    ["ifstate.conf"] = 318,
    ["imageoptimizer.json"] = 319,
    ["importmap.json"] = 322,
    ["ioBroker Configuration"] = 323,
    ["ioBroker JSON UI"] = 324,
    ["ioBroker Package manifest"] = 325,
    ["ize.toml"] = 788,
    ["jsconfig.json"] = 348,
    ["jscpd Configuration"] = 768,
    jsdoc = 686,
    ["k3d.yaml"] = 349,
    ["k9s plugin.yml"] = 351,
    ["kontinuous-config.yaml"] = 357,
    ["kontinuous-values.yaml"] = 356,
    ["kustomization.yaml"] = 358,
    ["label-commenter-config.yml"] = 359,
    ["latexindent configuration"] = 64,
    ["launchsettings.json"] = 360,
    lazydocker = 810,
    lazygit = 809,
    ["lego.json"] = 362,
    ["lerna.json"] = 363,
    ["lgtm.yml"] = 364,
    ["liblab.config.json"] = 365,
    ["libman.json"] = 366,
    ["license-report-config.json"] = 367,
    ["linkinator.config.json"] = 369,
    ["lint-staged (.lintstagedrc)"] = 666,
    ["local.settings.json"] = 374,
    ["localazy.json"] = 375,
    ["lotus.yaml"] = 373,
    ["lsdlschema.json"] = 376,
    ["markdown-link-check"] = 727,
    mboats = 734,
    ["micro-settings.json"] = 803,
    ["mimetypes.json"] = 385,
    ["mirrord config"] = 667,
    mise = 668,
    ["mise-settings"] = 669,
    ...
    ["mtad.yaml"] = 671,
    ["mycode.json"] = 414,
    ["napari plugin manifest"] = 415,
    neoload = 681,
    ["nest-cli"] = 421,
    ["ninjs (News in JSON) 1.3"] = 420,
    ["ninjs (News in JSON) 2.0"] = 419,
    ["nixd configuration"] = 827,
    ["nlu.json"] = 422,
    ["nodemon.json"] = 424,
    ["noodl config"] = 733,
    ["notebook.mod.json"] = 425,
    now = 677,
    ["npm-badges"] = 428,
    ["nswag.json"] = 431,
    ntangle = 432,
    ["nuclei-template.yaml"] = 429,
    ["nuget-project.json"] = 430,
    ["ocelot.json"] = 434,
    ["omnisharp.json"] = 435,
    ["openapi.json"] = 436,
    ["openfin.json"] = 443,
    ...
    ["ops.yaml"] = 440,
    ["package.json"] = 454,
    ["package.manifest"] = 455,
    ["partial-black.json"] = 92,
    ["pathfinder.yml"] = 458,
    ["pattern.json"] = 461,
    ["petstore-v1.0"] = 778,
    pgap_yaml_input_reader = 460,
    ["pixi.toml"] = 462,
    ["plagiarize-me.yaml"] = 466,
    ["plagiarize.yaml"] = 465,
    ["portman.json"] = 467,
    ["prettierrc.json"] = 475,
    ["prisma.yml"] = 476,
    ["project-1.0.0-beta3.json"] = 479,
    ["project-1.0.0-beta4.json"] = 480,
    ["project-1.0.0-beta5.json"] = 481,
    ["project-1.0.0-beta6.json"] = 482,
    ["project-1.0.0-beta8.json"] = 483,
    ["project-1.0.0-rc1.json"] = 484,
    ["project-1.0.0-rc2.json"] = 485,
    ["project.json"] = 478,
    ["prometheus.json"] = 486,
    ["prometheus.rules.json"] = 487,
    ["prometheus.rules.test.json"] = 488,
    ["proxies.json"] = 489,
    ["publiccode.yml"] = 490,
    ["pubspec.yaml"] = 491,
    ["pyrseas-0.8.json"] = 494,
    ["quilt.mod.json"] = 804,
    ["release drafter"] = 682,
    ["release-plz.toml"] = 507,
    ["rivet.yaml"] = 826,
    rockcraft = 517,
    rustfmt = 518,
    samt = 520,
    samtrc = 521,
    ["sarif-1.0.0.json"] = 523,
    ["sarif-2.0.0.json"] = 524,
    ["sarif-2.1.0"] = 534,
    ["sarif-2.1.0-rtm.2"] = 525,
    ["sarif-2.1.0-rtm.3"] = 527,
    ["sarif-2.1.0-rtm.4"] = 529,
    ["sarif-2.1.0-rtm.5"] = 531,
    ["sarif-2.1.0-rtm.6"] = 532,
    ["sarif-external-property-file-2.1.0"] = 535,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 526,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 528,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 530,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 533,
    ["schema.org - Action"] = 537,
    ["schema.org - ContactPoint"] = 538,
    ["schema.org - Place"] = 539,
    ["schema.org - Thing"] = 540,
    ["secrethub.yml"] = 806,
    ["semantic-release"] = 546,
    ["servicehub.config.json"] = 656,
    ["servicehub.service.json"] = 655,
    ["settings.job"] = 549,
    ["sfdx-hardis configuration"] = 551,
    ["shard.yml"] = 842,
    ["size-limit configuration"] = 556,
    ["skaffold.yaml"] = 725,
    ["skyuxconfig.json"] = 558,
    snapcraft = 559,
    ["sqlc configuration"] = 567,
    ["stripe-app-local.json"] = 576,
    ["stripe-app.json"] = 575,
    swcrc = 711,
    ["task.json"] = 582,
    taskcat = 678,
    ["template.json"] = 586,
    ["templatsources.json"] = 587,
    ["theme.json"] = 590,
    ["tizen_workspace.json"] = 591,
    tldr = 592,
    tmuxinator = 664,
    ["transcend.yml"] = 599,
    ...
    ["vega-lite.json"] = 623,
    ["vega.json"] = 622,
    ["venvironment-basic.yaml"] = 626,
    ["venvironment.yaml"] = 625,
    ["version.json"] = 627,
    ["vim-addon-info"] = 629,
    ["vs-2017.3.host.json"] = 631,
    ["vs-nesting.json"] = 632,
    ["vsls.json"] = 630,
    ["vss-extension.json"] = 636,
    ["vtesttree.yaml"] = 637,
    ["vtestunit.yaml"] = 638,
    ["warp-keysets.json"] = 812,
    ["warp-themes.json"] = 813,
    ["warp-workflows.json"] = 814,
    ["webhint.io"] = 764,
    ["webjobpublishsettings.json"] = 644,
    ["webjobs-list.json"] = 643,
    ["well-known-fursona"] = 850,
    ["xs-app.json"] = 674,
    ["xunit.runner.json"] = 654,
    yamllint = 699,
    zuul = 683,
    ["Žinoma"] = 693
  },
