...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 143,
    [".cryproj (generic)"] = 481,
    [".cryproj engine-5.2"] = 476,
    [".cryproj engine-5.3"] = 477,
    [".cryproj engine-5.4"] = 478,
    [".cryproj engine-5.5"] = 479,
    [".cryproj engine-dev"] = 480,
    [".csscomb.json"] = 145,
    [".csslintrc"] = 146,
    [".eslintrc"] = 187,
    [".esmrc.json"] = 179,
    ...
    [".mtaext"] = 490,
    [".nodehawkrc"] = 303,
    [".npmpackagejsonlintrc"] = 305,
    [".phraseapp.yml"] = 339,
    [".pmbot.yml"] = 331,
    [".postcssrc"] = 336,
    [".pre-commit-config.yml"] = 337,
    [".pre-commit-hooks.yml"] = 338,
    [".putout.json"] = 356,
    [".rehyperc"] = 362,
    [".remarkrc"] = 363,
    [".sprite files"] = 404,
    ...
    [".vsext"] = 456,
    [".yarnrc.yml"] = 522,
    ["<div>RIOTS' studio configuration"] = 460,
    ["@factorial/drupal-breakpoints-css"] = 4,
    ["API Builder"] = 519,
    ["AVA Configuration Schema"] = 573,
    ...
    ["Azure Pipelines"] = 44,
    ["Azure Static Web Apps CLI configuration file"] = 406,
    ["Azure Static Web Apps configuration file"] = 405,
    ["BX CI"] = 75,
    ["Better Code Hub"] = 524,
    ["Better Scripts"] = 76,
    BizTalkServerApplicationSchema = 496,
    ...
    ["Butane Config"] = 560,
    ["CICS TS region tagging"] = 567,
    ["CICS TS resource import"] = 568,
    ["CICS TS resource model"] = 569,
    ["CICS TS resource overrides"] = 570,
    ["CMake Presets"] = 77,
    ...
    Conjure = 85,
    ["Container Structure Test"] = 507,
    Containerlab = 531,
    ["Dart build configuration"] = 147,
    ["Dart test config"] = 148,
    ["DashLord configuration"] = 149,
    ["Datadog Service Definition"] = 260,
    ["Datahub Ingestion Recipe Schema"] = 574,
    ...
    ["Embrace Config Schema"] = 585,
    ["Error pages"] = 182,
    Esquio = 180,
    ["Estuary Flow Catalog Schema"] = 564,
    ["Expo SDK"] = 185,
    ["F-Droid Data metadata"] = 190,
    ["Facets - FSDL - Application"] = 188,
    ["Fossa configuration file"] = 195,
    ["Fossa's fossa-deps file"] = 196,
    ["Foundry VTT - Manifest"] = 193,
    ["Foundry VTT - Template"] = 194,
    ["Foxx Manifest"] = 45,
    ["GatewayCore API Gateway"] = 199,
    ["GeoJSON.json latest"] = 562,
    GherKing = 566,
    ["GitHub Action"] = 203,
    ["GitHub Funding"] = 204,
    ["GitHub Issue Template configuration"] = 206,
    ["GitHub Workflow"] = 207,
    ["GitHub Workflow Template Properties"] = 208,
    ["GitHub issue forms"] = 205,
    GitVersion = 202,
    ["Gitpod Configuration"] = 210,
    ["Global Privacy Control"] = 200,
    ["Google Cloud Workflows"] = 130,
    Goreleaser = 213,
    ["Goreleaser Pro"] = 214,
    ["Gradle Build Cache Node"] = 521,
    ["Gradle Enterprise"] = 520,
    ["Grafana 5.x Dashboard"] = 215,
    ["GraphQL Code Generator"] = 218,
    ["GraphQL Config"] = 217,
    ["GraphQL Mesh"] = 216,
    ["Grunt JSHint task"] = 222,
    ["Grunt Watch task"] = 223,
    ["Grunt base task"] = 224,
    ["Grunt clean task"] = 220,
    ["Grunt copy task"] = 219,
    ["Grunt cssmin task"] = 221,
    HEMTT = 493,
    Hadolint = 505,
    ["Hardware Sentry Configuration"] = 578,
    Hayson = 226,
    ["Haystack Pipeline"] = 227,
    ["Hazelcast 5 Configuration"] = 228,
    ["Helm Chart.lock"] = 106,
    ["Helm Chart.yaml"] = 105,
    Hugo = 556,
    ["Istanbul Schema"] = 581,
    ["JDownloader2 crawler multi-rule schema"] = 244,
    ["JDownloader2 crawler single-rule schema"] = 243,
    ["JFrog File Spec"] = 245,
    ["JFrog Pipelines YML DSL"] = 587,
    ["JSON Document Transform"] = 253,
    ["JSON Feed"] = 254,
    ["JSON Resume"] = 366,
    ["JSON Schema Draft 2020-12"] = 472,
    ["JSON Schema Draft 4"] = 469,
    ["JSON Schema Draft 7"] = 470,
    ["JSON Schema Draft 8"] = 471,
    ...
    ["JSON-API"] = 252,
    ["JSON-e templates"] = 529,
    ["JSON-stat 2.0"] = 466,
    JSONPatch = 256,
    Jasmine = 239,
    Jekyll = 240,
    ["Jenkins X Pipelines"] = 241,
    ["Jenkins X Requirements"] = 242,
    ["Jovo Language Models"] = 246,
    ["KSP-AVC"] = 467,
    ["KSP-CKAN"] = 468,
    ["Keycloak REST API"] = 589,
    ["Knative Functions - func.yaml"] = 197,
    ["KoDE/CI build.yaml"] = 583,
    ["Kong DBLess Schema"] = 584,
    KrakenD = 259,
    ["LinkML Metamodel"] = 271,
    Liquibase = 535,
    ["Liquibase Flow File"] = 536,
    Markdownlint = 539,
    ["MegaLinter configuration"] = 275,
    ["MegaLinter descriptor"] = 276,
    ["Meltano plugin discovery definition"] = 278,
    ["Meltano project definition"] = 277,
    ["Microsoft Band Web Tile"] = 279,
    ["Minecraft Data Pack Advancement"] = 281,
    ["Minecraft Data Pack Biome"] = 282,
    ["Minecraft Data Pack Configured Carver"] = 283,
    ["Minecraft Data Pack Dimension"] = 285,
    ["Minecraft Data Pack Dimension Type"] = 284,
    ["Minecraft Data Pack Item Modifier"] = 286,
    ["Minecraft Data Pack Loot Table"] = 287,
    ["Minecraft Data Pack Metadata"] = 288,
    ["Minecraft Data Pack Predicate"] = 289,
    ["Minecraft Data Pack Recipe"] = 290,
    ["Minecraft Data Pack Template Pool"] = 291,
    ["Minecraft Resourcepack Sounds"] = 292,
    ["MongoDB Atlas Search Index Definition Schema"] = 582,
    ["Monika Configuration Schema"] = 580,
    ["Motif config"] = 489,
    ["Netin Diagnostic System Template"] = 544,
    ["Netlify config schema"] = 297,
    ["Nightwatch.js"] = 298,
    ["OSS Review Toolkit configuration"] = 321,
    ["OSS Review Toolkit curation"] = 322,
    ["OSS Review Toolkit package configuration"] = 323,
    ["OSS Review Toolkit repository configuration"] = 324,
    ["OSS Review Toolkit resolutions"] = 325,
    Opctl = 492,
    ["OpenWeather Current Weather API"] = 528,
    ["OpenWeather Road Risk API"] = 527,
    ["Ory Hydra configuration"] = 232,
    ["Ory Keto configuration"] = 261,
    ["Ory Kratos configuration"] = 320,
    ["Ory Oathkeeper configuration"] = 311,
    ["Outblocks App configuration"] = 318,
    ["Outblocks database table"] = 319,
    ["Outblocks project configuration"] = 317,
    Packer = 328,
    ["Pipeline component"] = 537,
    ["PocketMine plugin.yml"] = 332,
    Pterodactyl = 577,
    ["Pull Request Labeler"] = 355,
    PyProject = 359,
    Qodana = 553,
    ["Quali Torque Blueprint Spec 2"] = 575,
    ["QueryFirst config file"] = 592,
    ["RKE Cluster Configuration JSON Schema"] = 534,
    ["RKE Cluster Configuration YAML Schema"] = 533,
    Ray = 504,
    ["Read the Docs"] = 358,
    ["Red-DiscordBot Cog"] = 360,
    ["Red-DiscordBot Cog Repo"] = 361,
    Renovate = 367,
    ["Replit schema"] = 364,
    RoadRunner = 368,
    ["Rust toolchain"] = 370,
    ["SIL Kit Participant Configuration"] = 395,
    SWADL = 415,
    ["Sapphire CLI Config"] = 371,
    ["SauceCTL Configuration"] = 541,
    ["Schema Catalog"] = 384,
    ["Scoop manifest"] = 389,
    ["Semgrep Rule"] = 391,
    ["Serverless Framework Configuration"] = 548,
    ["Serverless Workflow Schema"] = 549,
    ["Settings.paf"] = 393,
    ["Shopware 6 Configuration"] = 550,
    ["Shopware CLI Extension Store Configuration"] = 551,
    ["Shopware CLI Project Store Configuration"] = 552,
    Solidarity = 399,
    ["Solution filters"] = 400,
    ["Source Maps v3"] = 401,
    SpecIF = 402,
    ["Sponge Mixin configuration"] = 403,
    ["StackHawk Scanner Configuration"] = 547,
    Stale = 407,
    Starship = 408,
    ["Statamic Blueprint"] = 409,
    ["StrmPrivacy batch job configuration file"] = 588,
    ["Stryker Mutator"] = 412,
    ["StyleCop Analyzers Configuration"] = 413,
    ["Swagger API 2.0"] = 416,
    TSON = 436,
    ["Talisman configuration"] = 417,
    ["Taskfile YAML Schema"] = 530,
    Taurus = 418,
    ["TestEnvironment.json"] = 425,
    Tikibase = 421,
    ["Traefik v2"] = 428,
    ["Traefik v2 File Provider"] = 429,
    Turborepo = 426,
    Tye = 554,
    ["UI5 Manifest"] = 442,
    ["UTAM Page Object"] = 444,
    ["Ubuntu Server Autoinstall"] = 440,
    ["Uniswap Token List"] = 513,
    Updatecli = 561,
    Uplift = 591,
    ["User Journey Map YAML Schema"] = 532,
    V2Ray = 565,
    ["VSCode Code Snippets"] = 119,
    ["VSIX CLI publishing"] = 457,
    ["Vela Pipeline Configuration"] = 447,
    Vercel = 118,
    ["Web App Manifest"] = 462,
    ["Web types"] = 465,
    WebExtensions = 461,
    ["Webman package recipe"] = 571,
    ["Windows Package Manager Installer Manifest"] = 510,
    ["Windows Package Manager Locale Manifest"] = 511,
    ["Windows Package Manager Singleton Manifest"] = 509,
    ["Woodpecker pipeline config"] = 543,
    ["Xstate Machine Schema"] = 559,
    ["Yippee-Ki-JSON configuration YML"] = 515,
    ["angular.json"] = 10,
    ...
    ["ecosystem.json"] = 177,
    eksctl = 178,
    ["electron-builder configuration file."] = 183,
    ["epr-manifest.json"] = 181,
    ["evcc.yaml"] = 184,
    ["ezd schema"] = 186,
    ["fabric.mod.json"] = 189,
    ["first-timers-bot"] = 192,
    ["fly.io Schema"] = 46,
    fulibWorkflows = 542,
    ["function.json"] = 198,
    ["geojson.json"] = 201,
    ["gitlab-ci"] = 209,
    ["global.json"] = 211,
    ["golangci-lint Configuration"] = 212,
    ["haxelib.json"] = 225,
    helmfile = 506,
    ["host-meta.json"] = 230,
    ["host.json"] = 229,
    ...
    huskyrc = 484,
    ["ide.host.json"] = 233,
    ["imageoptimizer.json"] = 234,
    ["importmap.json"] = 236,
    ["ioBroker JSON UI"] = 237,
    ["ioBroker Package manifest"] = 238,
    ["ize.toml"] = 590,
    ["jsconfig.json"] = 257,
    ["jscpd Configuration Schema"] = 576,
    jsdoc = 503,
    ["k3d.yaml"] = 258,
    ["kustomization.yaml"] = 262,
    ["label-commenter-config.yml"] = 263,
    ["launchsettings.json"] = 264,
    ["lego.json"] = 265,
    ["lerna.json"] = 266,
    ["lgtm.yml"] = 267,
    ["libman.json"] = 268,
    ["license-report-config.json"] = 269,
    ["linkinator.config.json"] = 270,
    ["local.settings.json"] = 272,
    ["localazy.json"] = 273,
    ["lsdlschema.json"] = 274,
    ["markdown-lint-check"] = 540,
    mboats = 546,
    ["mimetypes.json"] = 280,
    ["mirrord-schema"] = 486,
    ["mta.yaml"] = 487,
    ["mtad.yaml"] = 488,
    ["mycode.json"] = 295,
    ["napari plugin manifest"] = 296,
    neoload = 498,
    ["nest-cli"] = 301,
    ["ninjs (News in JSON) 1.3"] = 300,
    ["ninjs (News in JSON) 2.0"] = 299,
    ["nlu.json"] = 302,
    ["nodemon.json"] = 304,
    ["noodl.schema.json"] = 545,
    now = 494,
    ["npm-badges"] = 306,
    ["nswag.json"] = 309,
    ntangle = 310,
    ["nuclei-template.yaml"] = 307,
    ["nuget-project.json"] = 308,
    ["ocelot.json"] = 312,
    ["omnisharp.json"] = 313,
    ["openapi.json"] = 314,
    ["openfin.json"] = 316,
    ["openrpc.json"] = 315,
    ["package.json"] = 326,
    ["package.manifest"] = 327,
    ["pattern.json"] = 330,
    ["petstore-v1.0"] = 586,
    pgap_yaml_input_reader = 329,
    ["plagiarize-me.yaml"] = 334,
    ["plagiarize.yaml"] = 333,
    ["portman.json"] = 335,
    ["prettierrc.json"] = 340,
    ["prisma.yml"] = 341,
    ["project-1.0.0-beta3.json"] = 343,
    ["project-1.0.0-beta4.json"] = 344,
    ["project-1.0.0-beta5.json"] = 345,
    ["project-1.0.0-beta6.json"] = 346,
    ["project-1.0.0-beta8.json"] = 347,
    ["project-1.0.0-rc1.json"] = 348,
    ["project-1.0.0-rc2.json"] = 349,
    ["project.json"] = 342,
    ["prometheus.json"] = 350,
    ["prometheus.rules.json"] = 351,
    ["proxies.json"] = 352,
    ["publiccode.yml"] = 353,
    ["pubspec.yaml"] = 354,
    ["pyrseas-0.8.json"] = 357,
    ["release drafter"] = 499,
    rustfmt = 369,
    ["sarif-1.0.0.json"] = 372,
    ["sarif-2.0.0.json"] = 373,
    ["sarif-2.1.0"] = 382,
    ["sarif-2.1.0-rtm.2"] = 374,
    ["sarif-2.1.0-rtm.3"] = 376,
    ["sarif-2.1.0-rtm.4"] = 378,
    ["sarif-2.1.0-rtm.5"] = 380,
    ["sarif-external-property-file-2.1.0"] = 383,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 375,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 377,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 379,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 381,
    ["schema.org - Action"] = 385,
    ["schema.org - ContactPoint"] = 386,
    ["schema.org - Place"] = 387,
    ["schema.org - Thing"] = 388,
    ["semantic-release"] = 390,
    ["servicehub.config.json"] = 475,
    ["servicehub.service.json"] = 474,
    ["settings.job"] = 392,
    ["sfdx-hardis configuration"] = 394,
    ["size-limit configuration"] = 396,
    ["skaffold.yaml"] = 538,
    ["skyuxconfig.json"] = 397,
    snapcraft = 398,
    ["stripe-app-local.json"] = 411,
    ["stripe-app.json"] = 410,
    swcrc = 526,
    taskcat = 495,
    ["template.json"] = 419,
    ["templatsources.json"] = 420,
    ["theme.json"] = 422,
    ["tizen_workspace.json"] = 423,
    tmLanguage = 424,
    tmuxinator = 483,
    ["trunk.yaml schema"] = 430,
    ["ts-force-config.json"] = 434,
    ["tsconfig.json"] = 431,
    ["tsd.json"] = 432,
    ["tsdrc.json"] = 433,
    ["tslint.json"] = 435,
    ...
    ["vega-lite.json"] = 446,
    ["vega.json"] = 445,
    ["venvironment-basic.yaml"] = 449,
    ["venvironment.yaml"] = 448,
    ["version.json"] = 450,
    ["vim-addon-info"] = 451,
    ["vs-2017.3.host.json"] = 453,
    ["vs-nesting.json"] = 454,
    ["vsls.json"] = 452,
    ["vss-extension.json"] = 458,
    ["webhint.io"] = 572,
    ["webjobpublishsettings.json"] = 464,
    ["webjobs-list.json"] = 463,
    ["xs-app.json"] = 491,
    ["xunit.runner.json"] = 473,
    yamllint = 514,
    zuul = 500,
    ["Žinoma"] = 508
  },
