...
M.json = {
  ...
  index = {
    ...
    ["Better Code Hub"] = 502,
    ["Better Scripts"] = 71,
    BizTalkServerApplicationSchema = 474,
    ...
    ["Butane config schema"] = 538,
    ["CICS TS region tagging"] = 545,
    ["CICS TS resource import"] = 546,
    ["CICS TS resource model"] = 547,
    ["CICS TS resource overrides"] = 548,
    ["CMake Presets"] = 72,
    ...
    ["Embrace Config Schema"] = 563,
    ["Error pages"] = 173,
    Esquio = 171,
    ["Estuary Flow Catalog Schema"] = 542,
    ["Expo SDK"] = 176,
    ...
    Goreleaser = 203,
    ["Goreleaser Pro"] = 204,
    ["Gradle Build Cache Node"] = 499,
    ["Gradle Enterprise"] = 498,
    ...
    HEMTT = 471,
    Hadolint = 483,
    ["Hardware Sentry Configuration"] = 556,
    Hayson = 216,
    ...
    ["KSP-AVC"] = 446,
    ["KSP-CKAN"] = 447,
    ["KoDE/CI build.yaml"] = 561,
    ["Kong DBLess Schema"] = 562,
    KrakenD = 247,
    ["LinkML Metamodel"] = 258,
    Liquibase = 513,
    ["Liquibase Flow File"] = 514,
    Markdownlint = 517,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 560,
    ["Monika Configuration Schema"] = 558,
    ["Motif config"] = 467,
    ["Netin Diagnostic System Template"] = 522,
    ...
    Opctl = 470,
    ["OpenWeather Current Weather API"] = 506,
    ["OpenWeather Road Risk API"] = 505,
    ...
    Packer = 313,
    ["Pipeline component"] = 515,
    ["PocketMine plugin.yml"] = 317,
    Pterodactyl = 555,
    ["Pull Request Labeler"] = 340,
    PyProject = 344,
    Qodana = 531,
    ["Quali Torque Blueprint Spec 2"] = 553,
    ["RKE Cluster Configuration JSON Schema"] = 512,
    ["RKE Cluster Configuration YAML Schema"] = 511,
    Ray = 482,
    ["Read the Docs"] = 343,
    ...
    ["SauceCTL Configuration"] = 519,
    ["Schema Catalog"] = 369,
    ["Scoop manifest"] = 374,
    ["Semgrep Rule"] = 376,
    ["Serverless Framework Configuration"] = 526,
    ["Serverless Workflow Schema"] = 527,
    ["Settings.paf"] = 378,
    ["Shopware 6 Configuration"] = 528,
    ["Shopware CLI Extension Store Configuration"] = 529,
    ["Shopware CLI Project Store Configuration"] = 530,
    Solidarity = 383,
    ["Source Maps v3"] = 384,
    SpecIF = 385,
    ["Sponge Mixin configuration"] = 386,
    ["StackHawk Scanner Configuration"] = 525,
    ...
    ["Uniswap Token List"] = 491,
    Updatecli = 539,
    ["User Journey Map YAML Schema"] = 510,
    V2Ray = 543,
    ...
    ["Web types"] = 444,
    WebExtensions = 440,
    ["Webman package recipe"] = 549,
    ["Windows Package Manager Installer Manifest"] = 488,
    ["Windows Package Manager Locale Manifest"] = 489,
    ["Windows Package Manager Singleton Manifest"] = 487,
    ["Woodpecker pipeline config"] = 521,
    ["Xstate Machine Schema"] = 537,
    ["Yippee-Ki-JSON configuration YML"] = 493,
    ["angular.json"] = 8,
    ...
    ["jsconfig.json"] = 245,
    ["jscpd Configuration Schema"] = 554,
    jsdoc = 481,
    ["k3d.yaml"] = 246,
