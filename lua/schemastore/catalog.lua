...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 149,
    [".cryproj (generic)"] = 502,
    [".cryproj engine-5.2"] = 497,
    [".cryproj engine-5.3"] = 498,
    [".cryproj engine-5.4"] = 499,
    [".cryproj engine-5.5"] = 500,
    [".cryproj engine-dev"] = 501,
    [".csscomb.json"] = 151,
    [".csslintrc"] = 152,
    [".eslintrc"] = 197,
    [".esmrc.json"] = 189,
    ...
    ["Azure Pipelines"] = 47,
    ["Azure Static Web Apps CLI configuration file"] = 425,
    ["Azure Static Web Apps configuration file"] = 424,
    ["BX CI"] = 81,
    ["Better Code Hub"] = 545,
    ["Better Scripts"] = 82,
    BizTalkServerApplicationSchema = 517,
    ...
    ["Butane Config"] = 583,
    ["CICS TS region tagging"] = 590,
    ["CICS TS resource import"] = 591,
    ["CICS TS resource model"] = 592,
    ["CICS TS resource overrides"] = 593,
    ["CMake Presets"] = 83,
    ...
    ["Datahub Ingestion Recipe Schema"] = 597,
    ...
    ["Embrace Config Schema"] = 608,
    ["Error pages"] = 192,
    Esquio = 190,
    ["Estuary Flow Catalog Schema"] = 587,
    ["Expo SDK"] = 195,
    ...
    Goreleaser = 223,
    ["Goreleaser Pro"] = 224,
    ["Gradle Build Cache Node"] = 542,
    ["Gradle Enterprise"] = 541,
    ...
    Hadolint = 526,
    Hammerkit = 552,
    ["Hardware Sentry Configuration"] = 601,
    Hayson = 236,
    ...
    ["JFrog File Spec"] = 256,
    ["JFrog Pipelines YML DSL"] = 610,
    ["JSON Document Transform"] = 264,
    ["JSON Feed"] = 265,
    ["JSON Resume"] = 385,
    ["JSON Schema Draft 2020-12"] = 493,
    ["JSON Schema Draft 4"] = 490,
    ["JSON Schema Draft 7"] = 491,
    ["JSON Schema Draft 8"] = 492,
    ...
    ["KSP-AVC"] = 488,
    ["KSP-CKAN"] = 489,
    ["Keycloak REST API"] = 616,
    ["Knative Functions - func.yaml"] = 207,
    ["KoDE/CI build.yaml"] = 606,
    ["Kong DBLess Schema"] = 607,
    KrakenD = 270,
    ["LinkML Metamodel"] = 282,
    Liquibase = 557,
    ["Liquibase Flow File"] = 558,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 605,
    ["Monika Configuration Schema"] = 603,
    ["Motif config"] = 510,
    ["NOX Framework (Service)"] = 320,
    ["Netin Diagnostic System Template"] = 566,
    ...
    Opctl = 513,
    ["OpenWeather Current Weather API"] = 549,
    ["OpenWeather Road Risk API"] = 548,
    ...
    PyProject = 376,
    Qodana = 576,
    ["Quali Torque Blueprint Spec 2"] = 598,
    ["QueryFirst config file"] = 619,
    ["RKE Cluster Configuration JSON Schema"] = 556,
    ["RKE Cluster Configuration YAML Schema"] = 555,
    Ray = 525,
    ["Read the Docs"] = 374,
    ["Red-DiscordBot Cog"] = 377,
    ["Red-DiscordBot Cog Repo"] = 378,
    Renovate = 386,
    ["Replit schema"] = 381,
    RoadRunner = 387,
    Ruff = 383,
    ["Rust Project"] = 384,
    ["Rust toolchain"] = 389,
    ["SIL Kit Participant Configuration"] = 414,
    SWADL = 434,
    ["Sapphire CLI Config"] = 390,
    ["SauceCTL Configuration"] = 563,
    ["Schema Catalog"] = 403,
    ["Scoop manifest"] = 408,
    ["Semgrep Rule"] = 410,
    ["Serverless Framework Configuration"] = 570,
    ["Serverless Workflow Schema"] = 572,
    ["Settings.paf"] = 412,
    ["Shopware 6 Configuration"] = 573,
    ["Shopware CLI Extension Store Configuration"] = 574,
    ["Shopware CLI Project Store Configuration"] = 575,
    Solidarity = 418,
    ["Solution filters"] = 419,
    ["Source Maps v3"] = 420,
    SpecIF = 421,
    ["Sponge Mixin configuration"] = 422,
    ["StackHawk Scanner Configuration"] = 569,
    Stale = 426,
    Starship = 427,
    ["Statamic Blueprint"] = 428,
    ["StrmPrivacy Data Connector"] = 614,
    ["StrmPrivacy Data Contract"] = 615,
    ["StrmPrivacy SimpleSchema"] = 612,
    ["StrmPrivacy Stream"] = 613,
    ["StrmPrivacy batch job configuration file"] = 611,
    ["Stryker Mutator"] = 431,
    ["StyleCop Analyzers Configuration"] = 432,
    ["Swagger API 2.0"] = 435,
    TSON = 455,
    ["Talisman configuration"] = 436,
    ["Taskfile YAML Schema"] = 551,
    Taurus = 437,
    ["TestEnvironment.json"] = 444,
    Tikibase = 440,
    ["Traefik v2"] = 447,
    ["Traefik v2 File Provider"] = 448,
    Turborepo = 445,
    Tye = 577,
    ["UI5 Manifest"] = 462,
    ["UTAM Page Object"] = 465,
    ["Ubuntu Server Autoinstall"] = 460,
    ["Uniswap Token List"] = 534,
    ["Unreal Engine Uplugin"] = 620,
    ["Unreal Engine Uproject"] = 621,
    Updatecli = 584,
    Uplift = 618,
    ["User Journey Map YAML Schema"] = 554,
    V2Ray = 588,
    ["VSCode Code Snippets"] = 125,
    ["VSIX CLI publishing"] = 478,
    ["Vela Pipeline Configuration"] = 468,
    Vercel = 124,
    ["Web App Manifest"] = 483,
    ["Web types"] = 486,
    WebExtensions = 482,
    ["Webman package recipe"] = 594,
    ["Windows Package Manager Installer Manifest"] = 531,
    ["Windows Package Manager Locale Manifest"] = 532,
    ["Windows Package Manager Singleton Manifest"] = 530,
    ["Woodpecker pipeline config"] = 565,
    ["Xstate Machine Schema"] = 582,
    ["Yippee-Ki-JSON configuration YML"] = 536,
    ["angular.json"] = 11,
    ...
    ["ize.toml"] = 617,
    ["jsconfig.json"] = 268,
    ["jscpd Configuration Schema"] = 599,
    jsdoc = 524,
    ["k3d.yaml"] = 269,
    ...
    ["release drafter"] = 520,
    rustfmt = 388,
    ["sarif-1.0.0.json"] = 391,
    ["sarif-2.0.0.json"] = 392,
    ["sarif-2.1.0"] = 401,
    ["sarif-2.1.0-rtm.2"] = 393,
    ["sarif-2.1.0-rtm.3"] = 395,
    ["sarif-2.1.0-rtm.4"] = 397,
    ["sarif-2.1.0-rtm.5"] = 399,
    ["sarif-external-property-file-2.1.0"] = 402,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 394,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 396,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 398,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 400,
    ["schema.org - Action"] = 404,
    ["schema.org - ContactPoint"] = 405,
    ["schema.org - Place"] = 406,
    ["schema.org - Thing"] = 407,
    ["semantic-release"] = 409,
    ["servicehub.config.json"] = 496,
    ["servicehub.service.json"] = 495,
    ["settings.job"] = 411,
    ["sfdx-hardis configuration"] = 413,
    ["size-limit configuration"] = 415,
    ["skaffold.yaml"] = 560,
    ["skyuxconfig.json"] = 416,
    snapcraft = 417,
    ["stripe-app-local.json"] = 430,
    ["stripe-app.json"] = 429,
    swcrc = 547,
    taskcat = 516,
    ["template.json"] = 438,
    ["templatsources.json"] = 439,
    ["theme.json"] = 441,
    ["tizen_workspace.json"] = 442,
    tmLanguage = 443,
    tmuxinator = 504,
    ["trunk.yaml schema"] = 449,
    ["ts-force-config.json"] = 453,
    ["tsconfig.json"] = 450,
    ["tsd.json"] = 451,
    ["tsdrc.json"] = 452,
    ["tslint.json"] = 454,
    ...
    ["vega-lite.json"] = 467,
    ["vega.json"] = 466,
    ["venvironment-basic.yaml"] = 470,
    ["venvironment.yaml"] = 469,
    ["version.json"] = 471,
    ["vim-addon-info"] = 472,
    ["vs-2017.3.host.json"] = 474,
    ["vs-nesting.json"] = 475,
    ["vsls.json"] = 473,
    ["vss-extension.json"] = 479,
    ["webhint.io"] = 595,
    ["webjobpublishsettings.json"] = 485,
    ["webjobs-list.json"] = 484,
    ["xs-app.json"] = 512,
    ["xunit.runner.json"] = 494,
    yamllint = 535,
    zuul = 521,
    ["Žinoma"] = 529
  },
