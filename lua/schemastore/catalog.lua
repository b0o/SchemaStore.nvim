...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 177,
    [".cryproj (generic)"] = 608,
    [".cryproj engine-5.2"] = 603,
    [".cryproj engine-5.3"] = 604,
    [".cryproj engine-5.4"] = 605,
    [".cryproj engine-5.5"] = 606,
    [".cryproj engine-dev"] = 607,
    [".csscomb.json"] = 179,
    [".csslintrc"] = 180,
    [".es6importsorterrc.json"] = 739,
    [".eslintrc"] = 229,
    [".esmrc.json"] = 221,
    [".ffizer.yaml"] = 233,
    [".htmlhintrc"] = 285,
    ...
    [".mtaext"] = 617,
    [".nodehawkrc"] = 385,
    [".npmpackagejsonlintrc"] = 388,
    [".phraseapp.yml"] = 432,
    [".pmbot.yml"] = 421,
    [".postcssrc"] = 427,
    [".powerpages-web-template-manifest"] = 429,
    [".pre-commit-config.yml"] = 430,
    [".pre-commit-hooks.yml"] = 431,
    [".putout.json"] = 451,
    [".rehyperc"] = 463,
    [".remarkrc"] = 464,
    [".sprite files"] = 519,
    ...
    ["<div>RIOTS' studio configuration"] = 587,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 345,
    ["API Builder"] = 649,
    ["AVA Configuration"] = 708,
    ["AWS CDK cdk.json"] = 161,
    ["AWS CloudFormation"] = 162,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 163,
    ["AWS SAM CLI Samconfig"] = 164,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 13,
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 681,
    ["All Contributors configuration file"] = 738,
    ...
    ["Azure Pipelines"] = 59,
    ["Azure Static Web Apps CLI configuration file"] = 522,
    ["Azure Static Web Apps configuration file"] = 521,
    ["BX CI"] = 95,
    ["Better Code Hub"] = 653,
    ["Better Scripts"] = 96,
    Bigconfig = 76,
    BizTalkServerApplicationSchema = 623,
    Bleep = 97,
    ...
    ["Butane Config"] = 693,
    ["CICS TS region tagging"] = 702,
    ["CICS TS resource import"] = 703,
    ["CICS TS resource model"] = 704,
    ["CICS TS resource overrides"] = 705,
    ["CMake Presets"] = 98,
    ["CNC Codes"] = 108,
    ...
    Cheatsheets = 690,
    ["Chrome Extension"] = 154,
    ["CircleCI config.yml"] = 131,
    ["Citation File Format"] = 166,
    CityJSON = 106,
    ["Code Climate"] = 132,
    CodeCV = 57,
    ...
    ["Common Catalog Data"] = 152,
    ["Common types for all schemas"] = 1,
    Conjure = 107,
    ["Container Structure Test"] = 636,
    Containerlab = 661,
    ["Crowdsec collection config"] = 173,
    ["Crowdsec parser config"] = 174,
    ["Crowdsec scenario config"] = 175,
    ["DWP Exchange - catalogue entry"] = 218,
    ["DWP Exchange - gateway"] = 216,
    ["DWP Exchange - meta"] = 217,
    ["Dart build configuration"] = 181,
    ["Dart test config"] = 182,
    ["DashLord configuration"] = 183,
    ["Data Contract Specification"] = 184,
    ["Databricks Asset Bundles"] = 759,
    ["Datadog Service Definition"] = 324,
    ["Datahub Ingestion Recipe"] = 709,
    ["Dein Config"] = 113,
    Deno = 190,
    ["Deployer Recipe"] = 193,
    ["Deta Spacefile"] = 114,
    Devfile = 215,
    ["Discord Webhook"] = 195,
    ["Dolittle Artifacts"] = 199,
    ["Dolittle Bounded Context Configuration"] = 200,
    ["Dolittle Event Horizons Configuration"] = 201,
    ["Dolittle Resources Configuration"] = 202,
    ["Dolittle Server Configuration"] = 203,
    ["Dolittle Tenant Map Configuration"] = 205,
    ["Dolittle Tenants Configuration"] = 204,
    ["Dolittle Topology"] = 206,
    ...
    ["Drupal Routing"] = 125,
    ["Drupal Services"] = 127,
    ["Drush site aliases"] = 211,
    ["Embrace Config"] = 720,
    Endurica = 762,
    ["Error pages"] = 224,
    Esquio = 222,
    ["Estuary Flow Catalog"] = 699,
    ["Expo SDK"] = 227,
    ["F-Droid Data metadata"] = 232,
    ["Facets - FSDL - Application"] = 230,
    ["FasterCI Configuration"] = 60,
    Firebase = 234,
    ["Fossa configuration file"] = 242,
    ["Fossa's fossa-deps file"] = 243,
    ["Foundry VTT - Base package Manifest"] = 237,
    ["Foundry VTT - Module Manifest"] = 238,
    ["Foundry VTT - System Data Template"] = 241,
    ["Foundry VTT - System Manifest"] = 239,
    ["Foundry VTT - World Manifest"] = 240,
    ["Foxx Manifest"] = 61,
    ["Freifunk.de Community API"] = 64,
    ["Frogbot Config"] = 65,
    ["G2P Mapping Configuration"] = 247,
    ["GCP Blueprint Metadata"] = 250,
    Gaspar = 248,
    ["GatewayCore API Gateway"] = 249,
    ["GeoJSON.json latest"] = 697,
    GherKing = 701,
    ["GitHub Action"] = 254,
    ["GitHub Discussion"] = 255,
    ["GitHub Funding"] = 256,
    ["GitHub Issue Template configuration"] = 258,
    ["GitHub Workflow"] = 259,
    ["GitHub Workflow Template Properties"] = 260,
    ["GitHub issue forms"] = 257,
    GitVersion = 253,
    ["Gitpod Configuration"] = 262,
    ["Global Privacy Control"] = 251,
    Goblet = 758,
    ["Google Chrome Related Website Sets"] = 235,
    ["Google Cloud Workflows"] = 160,
    Goreleaser = 266,
    ["Goreleaser Pro"] = 267,
    Goss = 268,
    ["Gradle Build Cache Node"] = 651,
    ["Gradle Enterprise"] = 650,
    ["Grafana 5.x Dashboard"] = 269,
    ["GraphQL Code Generator"] = 272,
    ["GraphQL Config"] = 271,
    ["GraphQL Mesh"] = 270,
    ["Grunt JSHint task"] = 276,
    ["Grunt Watch task"] = 277,
    ["Grunt base task"] = 278,
    ["Grunt clean task"] = 274,
    ["Grunt copy task"] = 273,
    ["Grunt cssmin task"] = 275,
    HEMTT = 620,
    Hadolint = 632,
    Hammerkit = 660,
    ["Hardware Sentry Configuration"] = 713,
    Hatch = 633,
    Hayson = 280,
    ["Haystack Pipeline"] = 281,
    ["Hazelcast 5 Configuration"] = 282,
    ["Helm Chart.lock"] = 129,
    ["Helm Chart.yaml"] = 128,
    ["Helm Unittest Test Suite"] = 130,
    Hugo = 689,
    ["IBM Zapp document"] = 287,
    ["IBM zCodeFormatSettings"] = 288,
    ["IMG Catapult PSP"] = 293,
    Istanbul = 716,
    ["JDownloader2 crawler multi-rules"] = 303,
    ["JDownloader2 crawler single-rules"] = 302,
    ["JFrog Applications Config"] = 304,
    ["JFrog File Spec"] = 305,
    ["JFrog Pipelines YML DSL"] = 722,
    ["JMeter DSL cli config"] = 306,
    JReleaser = 308,
    ["JSON Document Transform"] = 315,
    ["JSON Feed"] = 316,
    ["JSON Resume"] = 470,
    ["JSON Schema Draft 2020-12"] = 599,
    ["JSON Schema Draft 4"] = 596,
    ["JSON Schema Draft 7"] = 597,
    ["JSON Schema Draft 7 (unofficial strict)"] = 760,
    ["JSON Schema Draft 8 (2019-09)"] = 598,
    ["JSON-API"] = 314,
    ["JSON-e templates"] = 658,
    ["JSON-stat 2.0"] = 593,
    JSONPatch = 318,
    Jasmine = 298,
    Jekyll = 299,
    ["Jenkins X Pipelines"] = 300,
    ["Jenkins X Requirements"] = 301,
    ["Jovo Language Models"] = 307,
    ["KSP-AVC"] = 594,
    ["KSP-CKAN"] = 595,
    ["Karakum configuration file"] = 244,
    Kas = 321,
    ["Keycloak REST API"] = 730,
    ["Knative Functions - func.yaml"] = 245,
    ["KoDE/CI build.yaml"] = 718,
    ["Kong DBLess config"] = 719,
    KrakenD = 323,
    LOOBin = 340,
    Lefthook = 331,
    ["LinkML Metamodel"] = 338,
    Liquibase = 665,
    ["Liquibase Flow File"] = 666,
    ["Lively Properties"] = 339,
    ["Lobe AI Agent"] = 58,
    ["MS2Rescore Configuration"] = 373,
    Markdownlint = 669,
    ["Mason Registry"] = 671,
    ["MegaLinter configuration"] = 346,
    ["MegaLinter descriptor"] = 347,
    ["Meltano plugin discovery definition"] = 349,
    ["Meltano project definition"] = 348,
    ["Microsoft Band Web Tile"] = 350,
    ["Minecraft Data Pack Advancement"] = 352,
    ["Minecraft Data Pack Biome"] = 353,
    ["Minecraft Data Pack Configured Carver"] = 354,
    ["Minecraft Data Pack Damage Type"] = 355,
    ["Minecraft Data Pack Dimension"] = 357,
    ["Minecraft Data Pack Dimension Type"] = 356,
    ["Minecraft Data Pack Item Modifier"] = 358,
    ["Minecraft Data Pack Loot Table"] = 359,
    ["Minecraft Data Pack Metadata"] = 360,
    ["Minecraft Data Pack Predicate"] = 361,
    ["Minecraft Data Pack Recipe"] = 362,
    ["Minecraft Data Pack Tag"] = 363,
    ["Minecraft Data Pack Template Pool"] = 364,
    ["Minecraft Data Pack Trim Material"] = 369,
    ["Minecraft Data Pack Trim Pattern"] = 370,
    ["Minecraft Resource Pack Lang"] = 365,
    ["Minecraft Resource Pack Particle"] = 366,
    ["Minecraft Resource Pack Texture Mcmeta"] = 368,
    ["Minecraft Resourcepack Sounds"] = 367,
    ["MkDocs Configuration 1.0"] = 371,
    ["MongoDB Atlas Search Index Definition"] = 717,
    ["Monika Configuration"] = 715,
    ["Motif config"] = 616,
    ["NOX Framework (Service)"] = 387,
    ["Netin Diagnostic System Template"] = 675,
    ["Netlify config"] = 378,
    ["Nexus-as-Code Data Model"] = 379,
    ["Nightwatch.js"] = 380,
    ["ONe's service descriptor"] = 402,
    ["OSS Review Toolkit configuration"] = 409,
    ["OSS Review Toolkit curation"] = 410,
    ["OSS Review Toolkit package configuration"] = 411,
    ["OSS Review Toolkit repository configuration"] = 412,
    ["OSS Review Toolkit resolutions"] = 413,
    Opctl = 619,
    ["OpenRewrite Resource"] = 404,
    ["OpenUtau character yaml"] = 399,
    ["OpenUtau ustx"] = 400,
    ["OpenWeather Current Weather API"] = 657,
    ["OpenWeather Road Risk API"] = 656,
    ["Ory Hydra configuration"] = 286,
    ["Ory Keto configuration"] = 325,
    ["Ory Kratos configuration"] = 408,
    ["Ory Oathkeeper configuration"] = 394,
    ["Outblocks App configuration"] = 406,
    ["Outblocks database table"] = 407,
    ["Outblocks project configuration"] = 405,
    Packer = 416,
    Pantsbuild = 737,
    ["Paper paper-plugin.yml"] = 417,
    ["Pipeline component"] = 667,
    ["PocketMine plugin.yml"] = 422,
    Poetry = 423,
    ["Postman collection"] = 428,
    ["Problem package generators"] = 435,
    Pterodactyl = 712,
    ["Pull Request Labeler"] = 450,
    Pulumi = 456,
    PyProject = 457,
    Pyright = 458,
    Qgoda = 459,
    Qodana = 686,
    ["Quali Torque Blueprint Spec 2"] = 710,
    ["QueryFirst config file"] = 733,
    ["RKE Cluster Configuration JSON"] = 664,
    ["RKE Cluster Configuration YAML"] = 663,
    ["Rancher Fleet"] = 453,
    Ray = 631,
    ["Read the Docs"] = 455,
    ["Red-DiscordBot Cog"] = 460,
    ["Red-DiscordBot Cog Repo"] = 461,
    ["Red-DiscordBot Trivia"] = 462,
    RenderCV = 472,
    Renovate = 471,
    ["Replit config"] = 465,
    RoadRunner = 473,
    ...
    ["Rust Project"] = 469,
    ["Rust toolchain"] = 475,
    ["SIL Kit Participant Configuration"] = 507,
    ["SIL Kit Registry Configuration"] = 508,
    SWADL = 532,
    ["Safebox Config"] = 723,
    ["Sapphire CLI Config"] = 478,
    ["SauceCTL Configuration"] = 672,
    ["Schema Catalog"] = 492,
    ["Scoop manifest"] = 497,
    ["Semantic Data Fabric (SDF) file"] = 498,
    ["Semgrep Rule"] = 500,
    ["Serenity Code Generator (Sergen)"] = 501,
    ["Serverless Framework Configuration"] = 680,
    ["Serverless Workflow"] = 682,
    ["Settings.paf"] = 503,
    Setuptools = 504,
    ["Shopware 6 Configuration"] = 683,
    ["Shopware CLI Extension Store Configuration"] = 684,
    ["Shopware CLI Project Store Configuration"] = 685,
    ["Sigrid scope configuration file"] = 506,
    ["Slack app manifest"] = 510,
    Solidarity = 513,
    ["Solution filters"] = 514,
    ["Source Maps v3"] = 515,
    Sourcery = 516,
    SpecIF = 517,
    ["Sponge Mixin configuration"] = 518,
    StackBlitz = 523,
    ["StackHawk Scanner Configuration"] = 679,
    Stale = 524,
    ["Starlake Data Pipeline"] = 654,
    Starship = 525,
    ["Statamic Blueprint"] = 526,
    ["StrmPrivacy Data Connector"] = 727,
    ["StrmPrivacy Data Contract"] = 728,
    ["StrmPrivacy SimpleSchema"] = 725,
    ["StrmPrivacy Stream"] = 726,
    ["StrmPrivacy batch job configuration file"] = 724,
    ["Stryker Mutator"] = 529,
    ["StyleCop Analyzers Configuration"] = 530,
    ["Sublime Syntax"] = 729,
    ["Swagger API 2.0"] = 533,
    TSON = 558,
    Talhelper = 535,
    ["Talisman configuration"] = 536,
    ["Taskfile config"] = 659,
    Taurus = 537,
    ["TestEnvironment.json"] = 546,
    ["TextMate Grammar"] = 545,
    ["Tier.run pricing.json"] = 540,
    Tikibase = 541,
    ["Traefik v2"] = 549,
    ["Traefik v2 File Provider"] = 550,
    TunnelHub = 763,
    Turborepo = 547,
    Tye = 687,
    ["UET BuildConfig.json"] = 734,
    ["UI5 Manifest"] = 566,
    ["UTAM Page Object"] = 569,
    ["Ubuntu Server Autoinstall"] = 564,
    ["Uniswap Token List"] = 642,
    ["Unreal Engine Uplugin"] = 735,
    ["Unreal Engine Uproject"] = 736,
    ["Updatecli Compose"] = 694,
    ["Updatecli Policy Manifest"] = 695,
    ["Updatecli Policy Metadata"] = 696,
    Uplift = 732,
    ["User Journey Map"] = 662,
    V2Ray = 700,
    ["VSCode Code Snippets"] = 148,
    ["VSIX CLI publishing"] = 582,
    ["Vela Pipeline Configuration"] = 572,
    Vercel = 147,
    Visivo = 761,
    ["Web App Manifest"] = 589,
    ["Web types"] = 592,
    WebExtensions = 588,
    ["Webman package recipe"] = 706,
    ["Windows Package Manager Installer Manifest"] = 639,
    ["Windows Package Manager Locale Manifest"] = 640,
    ["Windows Package Manager Singleton Manifest"] = 638,
    ["Woodpecker pipeline config"] = 674,
    ["Xstate Machine"] = 692,
    ["Yippee-Ki-JSON configuration YML"] = 644,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 70,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 743,
    ["bashly-strings.yml"] = 744,
    ["bashly.yml"] = 742,
    ["batect.yml"] = 69,
    ...
    ["chisel-slices.json"] = 165,
    ["chrome-extension-locales-messages.json"] = 155,
    ["chutzpah.json"] = 156,
    cibuildwheel = 105,
    clangd = 135,
    clib = 136,
    ["cloud-init: cloud-config userdata"] = 138,
    ["cloud-sdk-pipeline-configuration"] = 158,
    ["cloudbuild.json"] = 159,
    cloudify = 137,
    codemagic = 139,
    ["coffeelint.json"] = 167,
    ...
    ["compilerconfig.json"] = 149,
    ["completely.yml"] = 740,
    ["component-detection-manifest.json"] = 170,
    ["component.json"] = 169,
    ["composer.json"] = 168,
    ["config.yaml"] = 454,
    ["contentmanifest.json"] = 157,
    ["contribute.json"] = 171,
    ["cosmos.config.json"] = 153,
    ["crowdin.yml"] = 172,
    cspell = 178,
    ["custom-elements.json"] = 754,
    ["cypress.json"] = 176,
    ["datalogic-scan2deploy-android"] = 185,
    ["datalogic-scan2deploy-ce"] = 186,
    ["dbt Project"] = 112,
    ["ddev-global"] = 187,
    ["ddev-project"] = 188,
    ["debugsettings.json"] = 189,
    ["dependabot-v2.json"] = 192,
    ["dependabot.json"] = 191,
    ["deployed-cli"] = 691,
    ["detekt.yml"] = 194,
    ...
    djlint = 647,
    ["docfx.json"] = 198,
    ["docker sequencer"] = 197,
    ["docker-compose.yml"] = 645,
    ["dockerd.json"] = 196,
    ["dotnet Release Index manifest"] = 207,
    ["dotnetcli.host.json"] = 208,
    ["dprint.json"] = 209,
    ["drone.json"] = 210,
    ["dss-2.0.0.json"] = 212,
    ["dstack configuration"] = 213,
    ["dvc.yaml"] = 214,
    ["ecosystem.json"] = 219,
    eksctl = 220,
    ["electron-builder configuration file"] = 225,
    ["epr-manifest.json"] = 223,
    ["evcc.yaml"] = 226,
    ["ezd task runner"] = 228,
    ["fabric.mod.json"] = 231,
    ["first-timers-bot"] = 236,
    ...
    ["gitlab-ci"] = 261,
    ["global.json"] = 263,
    ["go-feature-flag Flag Configuration"] = 265,
    ["golangci-lint Configuration"] = 264,
    ["haxelib.json"] = 279,
    helmfile = 634,
    helmwave = 635,
    ["host-meta.json"] = 284,
    ...
    ["ide.host.json"] = 289,
    ["ifstate.conf"] = 290,
    ["imageoptimizer.json"] = 291,
    ["importmap.json"] = 294,
    ["ioBroker Configuration"] = 295,
    ["ioBroker JSON UI"] = 296,
    ["ioBroker Package manifest"] = 297,
    ["ize.toml"] = 731,
    ["jsconfig.json"] = 319,
    ["jscpd Configuration"] = 711,
    jsdoc = 630,
    ["k3d.yaml"] = 320,
    ["k9s plugin.yml"] = 322,
    ["kontinuous-config.yaml"] = 327,
    ["kontinuous-values.yaml"] = 326,
    ["kustomization.yaml"] = 328,
    ["label-commenter-config.yml"] = 329,
    ["launchsettings.json"] = 330,
    lazydocker = 753,
    lazygit = 752,
    ["lego.json"] = 332,
    ["lerna.json"] = 333,
    ["lgtm.yml"] = 334,
    ["libman.json"] = 335,
    ["license-report-config.json"] = 336,
    ["linkinator.config.json"] = 337,
    ["local.settings.json"] = 342,
    ["localazy.json"] = 343,
    ["lotus.yaml"] = 341,
    ["lsdlschema.json"] = 344,
    ["madness.yml"] = 741,
    ["markdown-lint-check"] = 670,
    mboats = 677,
    ["micro-settings.json"] = 746,
    ["mimetypes.json"] = 351,
    ["mirrord config"] = 613,
    ["monospace.yml"] = 372,
    ["mta.yaml"] = 614,
    ["mtad.yaml"] = 615,
    ["mycode.json"] = 376,
    ["napari plugin manifest"] = 377,
    neoload = 625,
    ["nest-cli"] = 383,
    ["ninjs (News in JSON) 1.3"] = 382,
    ["ninjs (News in JSON) 2.0"] = 381,
    ["nlu.json"] = 384,
    ["nodemon.json"] = 386,
    ["noodl config"] = 676,
    now = 621,
    ...
    ["nswag.json"] = 392,
    ntangle = 393,
    ["nuclei-template.yaml"] = 390,
    ["nuget-project.json"] = 391,
    ["ocelot.json"] = 395,
    ["omnisharp.json"] = 396,
    ["openapi.json"] = 397,
    ["openfin.json"] = 403,
    ...
    ["ops.yaml"] = 401,
    ["package.json"] = 414,
    ["package.manifest"] = 415,
    ["pathfinder.yml"] = 418,
    ["pattern.json"] = 420,
    ["petstore-v1.0"] = 721,
    pgap_yaml_input_reader = 419,
    ["plagiarize-me.yaml"] = 425,
    ["plagiarize.yaml"] = 424,
    ["portman.json"] = 426,
    ["prettierrc.json"] = 433,
    ["prisma.yml"] = 434,
    ["project-1.0.0-beta3.json"] = 437,
    ["project-1.0.0-beta4.json"] = 438,
    ["project-1.0.0-beta5.json"] = 439,
    ["project-1.0.0-beta6.json"] = 440,
    ["project-1.0.0-beta8.json"] = 441,
    ["project-1.0.0-rc1.json"] = 442,
    ["project-1.0.0-rc2.json"] = 443,
    ["project.json"] = 436,
    ["prometheus.json"] = 444,
    ["prometheus.rules.json"] = 445,
    ["prometheus.rules.test.json"] = 446,
    ["proxies.json"] = 447,
    ["publiccode.yml"] = 448,
    ["pubspec.yaml"] = 449,
    ["pyrseas-0.8.json"] = 452,
    ["quilt.mod.json"] = 747,
    ["release drafter"] = 626,
    rtx = 467,
    rustfmt = 474,
    samt = 476,
    samtrc = 477,
    ["sarif-1.0.0.json"] = 479,
    ["sarif-2.0.0.json"] = 480,
    ["sarif-2.1.0"] = 490,
    ["sarif-2.1.0-rtm.2"] = 481,
    ["sarif-2.1.0-rtm.3"] = 483,
    ["sarif-2.1.0-rtm.4"] = 485,
    ["sarif-2.1.0-rtm.5"] = 487,
    ["sarif-2.1.0-rtm.6"] = 488,
    ["sarif-external-property-file-2.1.0"] = 491,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 482,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 484,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 486,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 489,
    ["schema.org - Action"] = 493,
    ["schema.org - ContactPoint"] = 494,
    ["schema.org - Place"] = 495,
    ["schema.org - Thing"] = 496,
    ["scikit-build"] = 678,
    ["secrethub.yml"] = 749,
    ["semantic-release"] = 499,
    ["servicehub.config.json"] = 602,
    ["servicehub.service.json"] = 601,
    ["settings.job"] = 502,
    ["sfdx-hardis configuration"] = 505,
    ["size-limit configuration"] = 509,
    ["skaffold.yaml"] = 668,
    ["skyuxconfig.json"] = 511,
    snapcraft = 512,
    ["sqlc configuration"] = 520,
    ["stripe-app-local.json"] = 528,
    ["stripe-app.json"] = 527,
    swcrc = 655,
    syntax = 751,
    ["task.json"] = 534,
    taskcat = 622,
    ["template.json"] = 538,
    ["templatsources.json"] = 539,
    ["theme.json"] = 542,
    ["tizen_workspace.json"] = 543,
    tldr = 544,
    tmuxinator = 610,
    ["transcend.yml"] = 551,
    ["trunk.yaml"] = 552,
    ["ts-force-config.json"] = 556,
    ["tsconfig.json"] = 553,
    ["tsd.json"] = 554,
    ["tsdrc.json"] = 555,
    ["tslint.json"] = 557,
    ...
    ["typingsrc.json"] = 563,
    ["typo3.json"] = 561,
    ["ui5-workspace.yaml"] = 568,
    ["ui5.yaml"] = 567,
    unist = 688,
    ["up.json"] = 565,
    v8r = 586,
    ["vcpkg configuration file"] = 146,
    ["vcpkg manifest file"] = 145,
    ["vega-lite.json"] = 571,
    ["vega.json"] = 570,
    ["venvironment-basic.yaml"] = 574,
    ["venvironment.yaml"] = 573,
    ["version.json"] = 575,
    ["vim-addon-info"] = 576,
    ["vs-2017.3.host.json"] = 578,
    ["vs-nesting.json"] = 579,
    ["vsls.json"] = 577,
    ["vss-extension.json"] = 583,
    ["vtesttree.yaml"] = 584,
    ["vtestunit.yaml"] = 585,
    ["warp-keysets.json"] = 755,
    ["warp-themes.json"] = 756,
    ["warp-workflows.json"] = 757,
    ["webhint.io"] = 707,
    ["webjobpublishsettings.json"] = 591,
    ["webjobs-list.json"] = 590,
    ["xs-app.json"] = 618,
    ["xunit.runner.json"] = 600,
    yamllint = 643,
    zuul = 627,
    ["Žinoma"] = 637
  },
