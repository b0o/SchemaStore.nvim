...
M.json = {
  ...
  index = {
    ...
    [".pmbot.yml"] = 516,
    [".postcssrc"] = 522,
    [".powerpages-web-template-manifest"] = 524,
    [".pre-commit-config.yml"] = 525,
    [".pre-commit-hooks.yml"] = 526,
    [".putout.json"] = 547,
    [".rehyperc"] = 566,
    [".remarkrc"] = 568,
    [".sprite files"] = 630,
    ...
    ["<div>RIOTS' studio configuration"] = 709,
    ...
    ["Adobe UXP Manifest"] = 894,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Airplane task"] = 17,
    ["Alacritty Configuration"] = 801,
    ["All Contributors configuration file"] = 859,
    ...
    ["Application list for a WinUtil"] = 938,
    ["Argo Events"] = 29,
    ["Argo Workflows"] = 30,
    AssemblyScript = 33,
    AsyncAPI = 34,
    ...
    ["Azure Pipelines"] = 64,
    ["Azure Static Web Apps CLI configuration file"] = 633,
    ["Azure Static Web Apps configuration file"] = 632,
    ["BX CI"] = 104,
    ["Bashly (bashly.yml)"] = 863,
    ["Bashly Settings (bashly-settings.yml)"] = 864,
    ["Better Code Hub"] = 773,
    ["Better Scripts"] = 105,
    Bigconfig = 81,
    BizTalkServerApplicationSchema = 743,
    Bleep = 106,
    ...
    ["Butane Config"] = 814,
    ["CGS Custom Card Game (CardGameDef.json)"] = 899,
    ["CICS TS region tagging"] = 823,
    ["CICS TS resource import"] = 824,
    ["CICS TS resource model"] = 825,
    ["CICS TS resource overrides"] = 826,
    ["CMake Presets"] = 107,
    ["CNC Codes"] = 121,
    ["CRS WAF test file"] = 928,
    ["CRS WAF test platform overrides file"] = 929,
    ...
    CityJSON = 117,
    ["Clawject config"] = 126,
    ["Cloud Foundry Application Manifest"] = 911,
    ["Cloud Run Spec v1"] = 933,
    ...
    Concord = 927,
    ["Configu .cfgu files"] = 916,
    ["Configu .configu file"] = 917,
    Conjure = 120,
    ["Container Structure Test"] = 756,
    Containerlab = 781,
    ["Crowdsec collection config"] = 210,
    ["Crowdsec parser config"] = 211,
    ["Crowdsec scenario config"] = 212,
    ["CumulusCI Config"] = 125,
    ["Custom Machinery Machine"] = 900,
    ["Custom Machinery Recipe"] = 901,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 871,
    ["EAS config"] = 276,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 860,
    ...
    ["Goreleaser Pro"] = 333,
    Goss = 334,
    ["Gradle Build Cache Node"] = 771,
    ["Gradle Enterprise"] = 770,
    ...
    Hadolint = 752,
    Hammerkit = 780,
    ["Hardware Sentry Configuration"] = 834,
    Hatch = 753,
    Hayson = 347,
    ...
    ["JFrog File Spec"] = 375,
    ["JFrog Pipelines YML DSL"] = 843,
    ["JMeter DSL cli config"] = 376,
    JReleaser = 378,
    ["JSON Document Transform"] = 386,
    ["JSON Feed"] = 387,
    ["JSON Resume"] = 573,
    ["JSON Schema Draft 2020-12"] = 722,
    ["JSON Schema Draft 4"] = 719,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 881,
    ["JSON Schema Draft 7"] = 720,
    ["JSON Schema Draft 7 (unofficial strict)"] = 882,
    ["JSON Schema Draft 8 (2019-09)"] = 721,
    ["JSON-API"] = 385,
    ["JSON-WF"] = 910,
    ["JSON-e templates"] = 778,
    ["JSON-stat 2.0"] = 716,
    JSONPatch = 389,
    ...
    ["Keycloak REST API"] = 851,
    ["Knative Functions - func.yaml"] = 295,
    ["KoDE/CI build.yaml"] = 839,
    ["Kong DBLess config"] = 840,
    KrakenD = 402,
    ...
    ["Metadata for a Cinnamon spice"] = 936,
    ["MetricsHub Configuration"] = 435,
    ["MetricsHub Connector Configuration"] = 436,
    ["Micro Editor Syntax"] = 872,
    ["Microsoft Band Web Tile"] = 437,
    ["Microsoft RulesEngine workflow rules"] = 924,
    ["Microsoft RulesEngine workflow rules list"] = 925,
    ["Minecraft Custom Main Menu Mod"] = 889,
    ...
    ["MongoDB Atlas Search Index Definition"] = 838,
    ["Monika Configuration"] = 836,
    ["Monoweave Configuration"] = 461,
    ["Motif config"] = 736,
    ["NOX Framework (Service)"] = 478,
    ["Netin Diagnostic System Template"] = 796,
    ["Netlify config"] = 469,
    ...
    ["OSS Review Toolkit configuration"] = 502,
    ["OSS Review Toolkit curation"] = 503,
    ["OSS Review Toolkit package configuration"] = 504,
    ["OSS Review Toolkit repository configuration"] = 505,
    ["OSS Review Toolkit resolutions"] = 506,
    Opctl = 739,
    ["Open Data Contract Standard (ODCS))"] = 497,
    ["OpenRewrite Resource"] = 496,
    ["OpenUtau character yaml"] = 490,
    ["OpenUtau ustx"] = 491,
    ["OpenWeather Current Weather API"] = 777,
    ["OpenWeather Road Risk API"] = 776,
    ...
    Packer = 509,
    Pantsbuild = 858,
    ["Paper paper-plugin.yml"] = 510,
    ["Pipeline component"] = 788,
    ["PocketMine plugin.yml"] = 517,
    ["Postman collection"] = 523,
    ["Preset list for a WinUtil"] = 939,
    ["Problem object RFC9457"] = 886,
    ["Problem package generators"] = 531,
    Pterodactyl = 833,
    ["Pull Request Labeler"] = 546,
    Pulumi = 552,
    PyProject = 553,
    Pyright = 554,
    Qgoda = 555,
    Qodana = 806,
    ["Qt Creator workspace file"] = 918,
    ["Quali Torque Blueprint Spec 2"] = 831,
    ["QueryFirst config file"] = 854,
    ["RKE Cluster Configuration JSON"] = 785,
    ["RKE Cluster Configuration YAML"] = 784,
    ["Rancher Fleet"] = 549,
    ["Rattler-build"] = 556,
    Ray = 751,
    ["Read the Docs"] = 551,
    ["Red-DiscordBot Cog"] = 563,
    ["Red-DiscordBot Cog Repo"] = 564,
    ["Red-DiscordBot Trivia"] = 565,
    ["Render Blueprints"] = 783,
    RenderCV = 575,
    Renovate = 574,
    ["Replit config"] = 569,
    RoadRunner = 576,
    ["Rudder techniques"] = 892,
    Ruff = 571,
    ["Rust Project"] = 572,
    ["Rust toolchain"] = 580,
    ["SDMX data message"] = 605,
    ["SDMX metadata message"] = 604,
    ["SDMX structure message"] = 603,
    ["SIL Kit Participant Configuration"] = 615,
    ["SIL Kit Registry Configuration"] = 616,
    SWADL = 644,
    ["Safebox Config"] = 844,
    ["Sapphire CLI Config"] = 583,
    ["SauceCTL Configuration"] = 793,
    ["Schema Catalog"] = 597,
    ["Scoop manifest"] = 602,
    ["Semantic Data Fabric (SDF) file"] = 606,
    ["Semgrep Rule"] = 608,
    ["Serenity Code Generator (Sergen)"] = 609,
    ["Serverless Framework Configuration"] = 800,
    ["Serverless Workflow"] = 802,
    ["Settings for a Cinnamon spice"] = 935,
    ["Settings.paf"] = 611,
    ["Shopware 6 Configuration"] = 803,
    ["Shopware CLI Extension Store Configuration"] = 804,
    ["Shopware CLI Project Store Configuration"] = 805,
    ["Sigma Detection Rule"] = 613,
    ["Sigrid scope configuration file"] = 614,
    ["SkyPilot Task JSON"] = 893,
    ["Slack app manifest"] = 618,
    Solidarity = 621,
    ["Solution filters"] = 622,
    ["Source Maps v3"] = 623,
    Sourcery = 624,
    ["Speakeasy Lint Configuration File"] = 625,
    ["Speakeasy Test Generation Configuration File"] = 626,
    ["Speakeasy Workflow File"] = 627,
    SpecIF = 628,
    ["Sponge Mixin configuration"] = 629,
    StackBlitz = 634,
    ["StackHawk Scanner Configuration"] = 799,
    Stale = 635,
    ["Starlake Data Pipeline"] = 774,
    Starship = 636,
    ["Statamic Blueprint"] = 637,
    ["Stella configuration file"] = 638,
    ["StrmPrivacy Data Connector"] = 848,
    ["StrmPrivacy Data Contract"] = 849,
    ["StrmPrivacy SimpleSchema"] = 846,
    ["StrmPrivacy Stream"] = 847,
    ["StrmPrivacy batch job configuration file"] = 845,
    ["Stryker Mutator"] = 641,
    ["StyleCop Analyzers Configuration"] = 642,
    ["Stylelint (.stylelintrc)"] = 643,
    ["Sublime Syntax"] = 850,
    ["Subsquid squid manifest"] = 895,
    ["Swagger API 2.0"] = 645,
    TSON = 674,
    TSTyche = 675,
    ["Tab data for a LinUtil"] = 941,
    ["Tab list for a LinUtil"] = 940,
    Talhelper = 647,
    ["Talisman configuration"] = 648,
    ["Taskfile config"] = 779,
    Taurus = 649,
    Tauticord = 650,
    ["TestEnvironment.json"] = 659,
    ["TextMate Grammar"] = 658,
    ["Tier.run pricing.json"] = 653,
    Tikibase = 654,
    ["Traefik v2"] = 662,
    ["Traefik v2 File Provider"] = 663,
    ["Travis CI (.travis.yml)"] = 661,
    ["TrueScript for *.tscript files"] = 666,
    TunnelHub = 885,
    Turborepo = 660,
    Tycho = 931,
    Tye = 807,
    ["UET BuildConfig.json"] = 855,
    ["UI5 Manifest"] = 684,
    ["UNCORS configuration"] = 688,
    ["UTAM Page Object"] = 687,
    ["Ubuntu Server Autoinstall"] = 682,
    ["Uniswap Token List"] = 762,
    ["Unreal Engine Uplugin"] = 856,
    ["Unreal Engine Uproject"] = 857,
    ["Updatecli Compose"] = 815,
    ["Updatecli Policy Manifest"] = 816,
    ["Updatecli Policy Metadata"] = 817,
    Uplift = 853,
    ["User Journey Map"] = 782,
    V2Ray = 821,
    ["VSCode Code Snippets"] = 176,
    ["VSIX CLI publishing"] = 704,
    ["Vela Pipeline Configuration"] = 692,
    Vercel = 175,
    Visivo = 883,
    ["Web App Manifest"] = 711,
    ["Web types"] = 714,
    WebExtensions = 710,
    ["Webman package recipe"] = 827,
    ["Windows Package Manager Installer Manifest"] = 759,
    ["Windows Package Manager Locale Manifest"] = 760,
    ["Windows Package Manager Singleton Manifest"] = 758,
    ["Woodpecker pipeline config"] = 795,
    ["Wrangler CLI"] = 715,
    ["Xstate Machine"] = 813,
    ["Yandex Workflow Language"] = 937,
    ["Yarn Config (.yarnrc.yml)"] = 772,
    ["Yippee-Ki-JSON configuration YML"] = 764,
    ["YouTrack App"] = 934,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 18,
    apko = 887,
    ...
    ["behat.yml"] = 89,
    ["bigquery-table"] = 80,
    ["bioimageio resource description"] = 903,
    ...
    ["lint-staged (.lintstagedrc)"] = 730,
    ["local.settings.json"] = 425,
    ["localazy.json"] = 426,
    ["lotus.yaml"] = 424,
    ["lsdlschema.json"] = 427,
    ["markdown-link-check"] = 791,
    mboats = 798,
    ["micro-settings.json"] = 867,
    ["mimetypes.json"] = 438,
    ["mirrord config"] = 731,
    mise = 732,
    ["mise-settings"] = 733,
    ...
    ["ops.yaml"] = 492,
    ["package.json"] = 507,
    ["package.manifest"] = 508,
    ["partial-black.json"] = 90,
    ["pathfinder.yml"] = 511,
    ["pattern.json"] = 514,
    ["petstore-v1.0"] = 842,
    pgap_yaml_input_reader = 513,
    ["pixi.toml"] = 515,
    ["plagiarize-me.yaml"] = 519,
    ["plagiarize.yaml"] = 518,
    ["podbard.yaml"] = 520,
    ["portman.json"] = 521,
    ["prettierrc.json"] = 529,
    ["prisma.yml"] = 530,
    ["project-1.0.0-beta3.json"] = 533,
    ["project-1.0.0-beta4.json"] = 534,
    ["project-1.0.0-beta5.json"] = 535,
    ["project-1.0.0-beta6.json"] = 536,
    ["project-1.0.0-beta8.json"] = 537,
    ["project-1.0.0-rc1.json"] = 538,
    ["project-1.0.0-rc2.json"] = 539,
    ["project.json"] = 532,
    ["prometheus.json"] = 540,
    ["prometheus.rules.json"] = 541,
    ["prometheus.rules.test.json"] = 542,
    ["proxies.json"] = 543,
    ["publiccode.yml"] = 544,
    ["pubspec.yaml"] = 545,
    ["pyrseas-0.8.json"] = 548,
    ["quilt.mod.json"] = 868,
    ["rc3 auth"] = 557,
    ["rc3 collection"] = 558,
    ["rc3 environment"] = 559,
    ...
    samt = 581,
    samtrc = 582,
    ["sarif-1.0.0.json"] = 584,
    ["sarif-2.0.0.json"] = 585,
    ["sarif-2.1.0"] = 595,
    ["sarif-2.1.0-rtm.2"] = 586,
    ["sarif-2.1.0-rtm.3"] = 588,
    ["sarif-2.1.0-rtm.4"] = 590,
    ["sarif-2.1.0-rtm.5"] = 592,
    ["sarif-2.1.0-rtm.6"] = 593,
    ["sarif-external-property-file-2.1.0"] = 596,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 587,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 589,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 591,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 594,
    ["schema.org - Action"] = 598,
    ["schema.org - ContactPoint"] = 599,
    ["schema.org - Place"] = 600,
    ["schema.org - Thing"] = 601,
    ["secrethub.yml"] = 870,
    ["semantic-release"] = 607,
    ["servicehub.config.json"] = 725,
    ["servicehub.service.json"] = 724,
    ["settings.job"] = 610,
    ["sfdx-hardis configuration"] = 612,
    ["shard.yml"] = 906,
    ["size-limit configuration"] = 617,
    ["skaffold.yaml"] = 789,
    ["skyuxconfig.json"] = 619,
    snapcraft = 620,
    ["spicepod.yaml"] = 926,
    ["sqlc configuration"] = 631,
    ["stripe-app-local.json"] = 640,
    ["stripe-app.json"] = 639,
    swcrc = 775,
    ["task.json"] = 646,
    taskcat = 742,
    ["template.json"] = 651,
    ["templatsources.json"] = 652,
    ["theme.json"] = 655,
    ["tizen_workspace.json"] = 656,
    tldr = 657,
    tmuxinator = 728,
    ["transcend.yml"] = 664,
    ...
    ["vega-lite.json"] = 691,
    ["vega.json"] = 690,
    ["venvironment-basic.yaml"] = 694,
    ["venvironment.yaml"] = 693,
    ["version.json"] = 695,
    ["vhwdebugger-binding.yaml"] = 697,
    ["vim-addon-info"] = 698,
    ["vs-2017.3.host.json"] = 700,
    ["vs-nesting.json"] = 701,
    ["vsls.json"] = 699,
    ["vss-extension.json"] = 705,
    ["vtesttree.yaml"] = 706,
    ["vtestunit.yaml"] = 707,
    ["warp-keysets.json"] = 876,
    ["warp-themes.json"] = 877,
    ["warp-workflows.json"] = 878,
    ["webhint.io"] = 828,
    ["webjobpublishsettings.json"] = 713,
    ["webjobs-list.json"] = 712,
    ["well-known-fursona"] = 914,
    ["xs-app.json"] = 738,
    ["xunit.runner.json"] = 723,
    yamllint = 763,
    ["zerops.io import file"] = 923,
    ["zerops.yml"] = 922,
    zuul = 747,
    ["Žinoma"] = 757
  },
