...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 909,
    [".nodehawkrc"] = 560,
    [".npmpackagejsonlintrc"] = 564,
    [".omletrc"] = 1087,
    [".phrase.yml"] = 634,
    [".phraseapp.yml"] = 635,
    [".pmbot.yml"] = 620,
    [".postcssrc"] = 629,
    [".powerpages-web-template-manifest"] = 631,
    [".pre-commit-config.yml"] = 632,
    [".pre-commit-hooks.yml"] = 633,
    [".putout.json"] = 667,
    [".rehyperc"] = 692,
    [".remarkrc"] = 696,
    [".sprite files"] = 786,
    ...
    AIConfig = 29,
    ["AMX Muse Program Descriptor"] = 1135,
    ["API Builder"] = 944,
    ["AVA Configuration"] = 1007,
    ["AWS AppConfig Feature Flags-v1"] = 63,
    ["AWS CDK cdk.json"] = 246,
    ["AWS CloudFormation"] = 247,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 248,
    ["AWS Copilot Manifest"] = 1174,
    ["AWS SAM CLI Samconfig"] = 249,
    ["Adobe UXP Manifest"] = 1070,
    ["Aerleon Network & Service Definitions"] = 16,
    ["Aerleon Policy"] = 17,
    Aider = 1164,
    Air = 19,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1185,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1184,
    ["Airlock Microgateway"] = 30,
    ["Alacritty Configuration"] = 979,
    ["All Contributors configuration file"] = 1033,
    ["Ansible Argument Specs"] = 381,
    ["Ansible Collection Galaxy"] = 388,
    ["Ansible Execution Environment"] = 378,
    ["Ansible Inventory"] = 387,
    ["Ansible Meta"] = 379,
    ["Ansible Meta Runtime"] = 380,
    ["Ansible Navigator Configuration"] = 390,
    ["Ansible Playbook"] = 385,
    ["Ansible Requirements"] = 382,
    ["Ansible Rulebook"] = 386,
    ["Ansible Tasks File"] = 384,
    ["Ansible Vars File"] = 383,
    ["Ansible-lint Configuration"] = 389,
    Any = 1097,
    ["AnyWork Automation Configuration"] = 12,
    ["Apollo Router"] = 945,
    ["App config Spotify Backstage"] = 34,
    ["Application Accelerator"] = 9,
    ["Application list for a WinUtil"] = 1114,
    ArchitectFX = 1119,
    ["Argo CD"] = 49,
    ["Argo Events"] = 50,
    ["Argo Workflows"] = 51,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1183,
    ["Azure IoT Operations connector metadata"] = 1180,
    ...
    ["Azure Pipelines"] = 104,
    ["Azure Static Web Apps CLI configuration file"] = 790,
    ["Azure Static Web Apps configuration file"] = 789,
    ["BOSH CPI Config"] = 128,
    ["BOSH Deploy Config"] = 129,
    ["BX CI"] = 148,
    ["Bacon config"] = 3,
    ["Bashly (bashly.yml)"] = 1037,
    ["Bashly Settings (bashly-settings.yml)"] = 1038,
    Bento = 1201,
    ["Better Code Hub"] = 949,
    ["Better Scripts"] = 149,
    Bigconfig = 121,
    ["Biome Formatter Config"] = 77,
    ["Bitmovin Encoding Template"] = 1128,
    BizTalkServerApplicationSchema = 916,
    Bleep = 150,
    ["Block Protocol Metadata"] = 147,
    ["Boyka Framework"] = 130,
    Briefcase = 922,
    ["Build Info"] = 138,
    Buildkite = 140,
    ["Bukkit plugin.yml"] = 139,
    ["BungeeCord plugin.yml"] = 145,
    ["Butane Config"] = 992,
    C4InterFlow = 1143,
    ["CDK Environment Manager, concrete environment configuration"] = 1167,
    ["CDK Environment Manager, concrete environments definition"] = 1166,
    ["CDK Environment Manager, environment definition"] = 1165,
    ["CGS Card Game Specification (cgs.json)"] = 1075,
    ["CICS TS region tagging"] = 1001,
    ["CICS TS resource import"] = 1002,
    ["CICS TS resource model"] = 1003,
    ["CICS TS resource overrides"] = 1004,
    ["CMake Presets"] = 151,
    ["CNC Codes"] = 172,
    ["CRS WAF test file"] = 1104,
    ["CRS WAF test platform overrides file"] = 1105,
    ["CSS Comb (.csscomb.json)"] = 274,
    ["CSS Lint (.csslintrc)"] = 275,
    ["CSpell (cspell.json)"] = 273,
    ["CVE Record Format"] = 180,
    CWL = 1081,
    ["Cache Warmup config"] = 152,
    ["Calqulus pipeline"] = 153,
    ["Camel YAML DSL"] = 154,
    ["Cannon TOML"] = 155,
    Carafe = 156,
    ["Cargo Make"] = 158,
    ["Cargo Manifest"] = 157,
    ["Catalog Info Backstage"] = 159,
    ["Chamaleon environment"] = 1132,
    ["Chamaleon properties"] = 1133,
    ["Chamaleon template"] = 1131,
    Changepacks = 1194,
    Changesets = 258,
    Changie = 160,
    Charmcraft = 161,
    Cheatsheets = 989,
    ["ChordPro Configuration"] = 162,
    ["Chrome Extension"] = 239,
    ["Chromia Model"] = 163,
    ["Chromia Seeder Module Config"] = 165,
    ["Chromia Seeder Root Config"] = 164,
    ["Cinnamon Spice info.json"] = 84,
    ["CircleCI config.yml"] = 215,
    ["Citation File Format"] = 260,
    CityJSON = 167,
    ["Claude Code Settings"] = 179,
    ["Clawject config"] = 178,
    ["Cloud Foundry Application Manifest"] = 1086,
    ["Cloud Run Spec v1"] = 1109,
    ["Cloud.gov Workshop Configuration"] = 85,
    ["CloudCannon Configuration"] = 90,
    ["CloudCannon Configuration (Collection Structures)"] = 99,
    ["CloudCannon Configuration (Collections)"] = 98,
    ["CloudCannon Configuration (Editables)"] = 97,
    ["CloudCannon Configuration (Inputs)"] = 92,
    ["CloudCannon Configuration (Snippets Definitions)"] = 96,
    ["CloudCannon Configuration (Snippets Imports)"] = 95,
    ["CloudCannon Configuration (Snippets)"] = 94,
    ["CloudCannon Configuration (Structure Value)"] = 93,
    ["CloudCannon Configuration (Structures)"] = 91,
    ["CloudEvents specification"] = 168,
    ["Code Climate"] = 216,
    CodeCV = 88,
    CodeRabbit = 87,
    ["CodeShip Pro services configuration files"] = 228,
    ["CodeShip Pro steps configuration files"] = 229,
    ["Codecov configuration files"] = 227,
    CodifyCLI = 89,
    Codux = 225,
    ["Cog config file"] = 173,
    ["Commandbox Box.json"] = 174,
    ["Commandbox Server.json"] = 175,
    ["Common Catalog Data"] = 237,
    ["Common Package Specification"] = 176,
    Concord = 1103,
    ["Configu .cfgu files"] = 1091,
    ["Configu .configu file"] = 1092,
    Conjure = 171,
    ["Container Structure Test"] = 930,
    Containerlab = 958,
    ["Contextive Glossary"] = 1159,
    Convex = 170,
    ["Crowdsec collection config"] = 268,
    ["Crowdsec parser config"] = 269,
    ["Crowdsec scenario config"] = 270,
    ["CumulusCI Config"] = 177,
    ["Custom Machinery Machine"] = 1076,
    ["Custom Machinery Recipe"] = 1077,
    ["Cycle Stack File"] = 181,
    CycloneDX = 182,
    ["DWP Exchange - catalogue entry"] = 317,
    ["DWP Exchange - gateway"] = 315,
    ["DWP Exchange - meta"] = 316,
    ["Dart Build Config (dart-build.json)"] = 276,
    ["Dart Test Config (dart-test.json)"] = 277,
    ["DashLord Configuration"] = 278,
    ["Data Contract Specification"] = 279,
    ["Data Product Specification"] = 280,
    ["DataYoga Connections"] = 183,
    ["DataYoga Job"] = 184,
    ["Databricks Asset Bundles"] = 1054,
    ["Datadog Continuous Testing"] = 479,
    ["Datadog Service Definition"] = 480,
    ["Datadog Software Catalog"] = 481,
    ["Datahub Ingestion Recipe"] = 1008,
    ["Debian Upstream Metadata file"] = 190,
    ["Deck config"] = 191,
    ["Dein Config"] = 192,
    ["Deno Config (deno.json)"] = 286,
    ["Dependency cruiser"] = 193,
    ["DeployStack Configuration"] = 194,
    ["Deployah Configuration"] = 1182,
    ["Deployer Recipe"] = 289,
    ["Deta Spacefile"] = 195,
    ["Detekt Config (detekt.yml)"] = 290,
    ["Devbox Config"] = 196,
    ["Devbox Plugin"] = 197,
    Devfile = 314,
    Devup = 1195,
    DipDup = 1106,
    ["Discord Webhook"] = 291,
    ["DocFx Config (docfx.json)"] = 295,
    Dofigen = 296,
    ["Dolittle Artifacts"] = 297,
    ["Dolittle Bounded Context Configuration"] = 298,
    ["Dolittle Event Horizons Configuration"] = 299,
    ["Dolittle Resources Configuration"] = 300,
    ["Dolittle Server Configuration"] = 301,
    ["Dolittle Tenant Map Configuration"] = 303,
    ["Dolittle Tenants Configuration"] = 302,
    ["Dolittle Topology"] = 304,
    ["DonateCaseBetterCasino menu"] = 1136,
    ["Drupal Breakpoints"] = 198,
    ["Drupal Config"] = 210,
    ["Drupal Info"] = 199,
    ["Drupal Layouts"] = 200,
    ["Drupal Libraries"] = 201,
    ["Drupal Links Action"] = 202,
    ["Drupal Links Contextual"] = 203,
    ["Drupal Links Menu"] = 204,
    ["Drupal Links Task"] = 205,
    ["Drupal Migration"] = 206,
    ["Drupal Permissions"] = 207,
    ["Drupal Recipe"] = 208,
    ["Drupal Routing"] = 209,
    ["Drupal Services"] = 211,
    ["Drush site aliases"] = 310,
    ["Dynamic Bash Aliases (.aliases)"] = 1045,
    ["EAS config"] = 334,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1034,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1179,
    ["EasyVCR .NET"] = 335,
    ["Eidolon Resource"] = 1120,
    ["Elgato Stream Deck"] = 320,
    Elm = 1108,
    ["Embrace Config"] = 1020,
    Endurica = 1058,
    ["Enterprise Contract Policy Spec"] = 321,
    ["Erda Pipeline"] = 1083,
    ["Erda Runtime"] = 1084,
    Esquio = 323,
    ["Estuary Flow Catalog"] = 998,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 327,
    ["EveryVoice TTS Toolkit Data Configuration"] = 328,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 332,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 331,
    ["EveryVoice TTS Toolkit Text Configuration"] = 329,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 330,
    ["Evolving Resolutive Process notation"] = 1181,
    ["Expo SDK"] = 333,
    ["F-Droid Data metadata"] = 339,
    ["FasterCI Configuration"] = 105,
    FiQuS = 343,
    Firebase = 341,
    ["FlexGet Config"] = 344,
    ["Flow.json Configurations"] = 1080,
    ["Fossa configuration file"] = 351,
    ["Fossa's fossa-deps file"] = 352,
    ["Foundry VTT - Base package Manifest"] = 346,
    ["Foundry VTT - Module Manifest"] = 347,
    ["Foundry VTT - System Data Template"] = 350,
    ["Foundry VTT - System Manifest"] = 348,
    ["Foundry VTT - World Manifest"] = 349,
    ["Foxx Manifest"] = 106,
    ["Freifunk.de Community API"] = 109,
    ["Frogbot Config"] = 110,
    ["G2P Mapping Configuration"] = 358,
    ["GCP Blueprint Metadata"] = 361,
    Gaspar = 359,
    ["GatewayCore API Gateway"] = 360,
    ["Gemini CLI settings"] = 362,
    ["GeoJSON.json latest"] = 996,
    GherKing = 1000,
    ["GitHub Action"] = 367,
    ["GitHub Actions typing"] = 1116,
    ["GitHub Discussion"] = 368,
    ["GitHub Funding"] = 369,
    ["GitHub Issue Template configuration"] = 370,
    ["GitHub Issue Template forms"] = 371,
    ["GitHub Workflow"] = 372,
    ["GitHub Workflow Template Properties"] = 373,
    ["GitHub automatically generated release notes configuration"] = 374,
    ["GitLab Agent for Kubernetes configuration"] = 1072,
    GitVersion = 364,
    ["Gitea Issue Template configuration"] = 365,
    ["Gitea Issue Template forms"] = 366,
    ["Gitpod Automations"] = 376,
    ["Gitpod Configuration"] = 377,
    ["GlazeWM settings"] = 1074,
    ["Global Privacy Control"] = 363,
    Goblet = 1053,
    ["Golangci-lint Configuration"] = 392,
    ["Golangci-lint Custom Plugins Configuration"] = 393,
    ["Google Chrome Related Website Sets"] = 342,
    ["Google Cloud Workflows"] = 245,
    ["Google Digital Assetlinks"] = 1160,
    Goreleaser = 395,
    ["Goreleaser Pro"] = 396,
    Goss = 397,
    ["Gradle Build Cache Node"] = 947,
    ["Gradle Enterprise"] = 946,
    ["Grafana 5.x Dashboard"] = 398,
    ["GraphQL Code Generator"] = 403,
    ["GraphQL Config"] = 402,
    ["GraphQL Mesh"] = 401,
    ["GroovyLint configuration"] = 404,
    ["Grunt JSHint task"] = 408,
    ["Grunt Watch task"] = 409,
    ["Grunt base task"] = 410,
    ["Grunt clean task"] = 406,
    ["Grunt copy task"] = 405,
    ["Grunt cssmin task"] = 407,
    HEMTT = 912,
    Hadolint = 926,
    Hammerkit = 957,
    ["Hardware Sentry Configuration"] = 1012,
    ["HashiCorp Vault"] = 411,
    Hatch = 927,
    Hayson = 413,
    ["Haystack Pipeline"] = 414,
    ["Hazelcast 5 Configuration"] = 415,
    ["Hecate Input Schema"] = 1171,
    ["Helm Chart.lock"] = 213,
    ["Helm Chart.yaml"] = 212,
    ["Helm Unittest Test Suite"] = 214,
    ["Home Assistant Integration Manifest"] = 416,
    ["Homer dashboard configuration"] = 417,
    Hugo = 988,
    ["Hugo Theme"] = 987,
    ["Hulak Configuration"] = 424,
    ["Hyperfoil benchmark configuration"] = 423,
    ["IBM Zapp document"] = 425,
    ["IBM zCodeFormatSettings"] = 426,
    ["IMG Catapult PSP"] = 431,
    ["IVMS101 by CODE Protocol"] = 1073,
    Infrahub = 433,
    Istanbul = 1016,
    ["JDownloader2 crawler multi-rules"] = 446,
    ["JDownloader2 crawler single-rules"] = 445,
    ["JFrog Applications Config"] = 447,
    ["JFrog File Spec"] = 448,
    ["JFrog Pipelines YML DSL"] = 1022,
    ["JMeter DSL cli config"] = 449,
    JReleaser = 452,
    ["JSON Document Transform"] = 460,
    ["JSON Feed"] = 461,
    ["JSON Resume"] = 702,
    ["JSON Schema Draft 2020-12"] = 894,
    ["JSON Schema Draft 4"] = 891,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1055,
    ["JSON Schema Draft 7"] = 892,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1056,
    ["JSON Schema Draft 8 (2019-09)"] = 893,
    ["JSON-API"] = 459,
    ["JSON-e templates"] = 954,
    ["JSON-stat 2.0"] = 887,
    JSONPatch = 463,
    ["JSR Package Config (jsr.json)"] = 453,
    Jarl = 1187,
    Jasmine = 440,
    Jekyll = 441,
    ["Jenkins X Pipelines"] = 442,
    ["Jenkins X Requirements"] = 443,
    Jest = 444,
    Jocker = 450,
    ["Jovo Language Models"] = 451,
    ["Jujutsu (jj) VCS config"] = 1173,
    ["KIMMDY config file"] = 474,
    ["KODE/CI build.yaml"] = 1018,
    ["KSP-AVC"] = 888,
    ["KSP-CKAN"] = 889,
    ["KSP-NetKAN"] = 890,
    KSY = 1085,
    KSail = 356,
    ["Karakum configuration file"] = 353,
    Kas = 466,
    ["Kestra flow file"] = 475,
    ["Keycloak REST API"] = 1025,
    ["Knative Functions - func.yaml"] = 354,
    Knip = 355,
    ["Kometa (nightly) config file"] = 477,
    ["Kometa config file"] = 476,
    ["Kong DBLess config"] = 1019,
    KrakenD = 478,
    ["Kubri Configuration"] = 485,
    LOOBin = 500,
    ["Lake configuration file"] = 1176,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 250,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 251,
    ["Landing Zone Accelerator on AWS - Global Config"] = 252,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 253,
    ["Landing Zone Accelerator on AWS - Network Config"] = 254,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 255,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 256,
    ["Landing Zone Accelerator on AWS - Security Config"] = 257,
    ["Lando (landofile)"] = 100,
    ["LangGraph Platform configuration"] = 1096,
    ["Language configuration"] = 1095,
    Lefthook = 489,
    ["Liferay client-extension.yaml"] = 496,
    ["LinkML Metamodel"] = 498,
    Liquibase = 963,
    ["Liquibase Flow File"] = 964,
    ["Lively Properties"] = 499,
    ["Lobe AI Agent"] = 102,
    Loki = 103,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 540,
    ["MS2Rescore Configuration"] = 543,
    ["Madness (madness.yml)"] = 1036,
    ["Mado configuration"] = 506,
    ["MapEHR Mapping"] = 507,
    Markdownlint = 967,
    ["Mason Registry"] = 970,
    ["MegaLinter Custom Flavor"] = 510,
    ["MegaLinter configuration"] = 509,
    ["MegaLinter descriptor"] = 511,
    Melange = 1063,
    ["Meltano project definition"] = 512,
    ["Mergify Configuration"] = 544,
    ["Metadata for a Bazel module"] = 513,
    ["Metadata for a Cinnamon spice"] = 1112,
    ["Metatype Configuration"] = 514,
    ["MetricsHub Configuration"] = 515,
    ["MetricsHub Connector Configuration"] = 516,
    ["Micro Editor Syntax"] = 1046,
    ["Microsoft Band Web Tile"] = 517,
    ["Microsoft RulesEngine workflow rules"] = 1100,
    ["Microsoft RulesEngine workflow rules list"] = 1101,
    ["Minecraft Custom Main Menu Mod"] = 1064,
    ["Minecraft Data Pack Advancement"] = 519,
    ["Minecraft Data Pack Biome"] = 520,
    ["Minecraft Data Pack Configured Carver"] = 521,
    ["Minecraft Data Pack Damage Type"] = 522,
    ["Minecraft Data Pack Dimension"] = 524,
    ["Minecraft Data Pack Dimension Type"] = 523,
    ["Minecraft Data Pack Item Modifier"] = 525,
    ["Minecraft Data Pack Loot Table"] = 526,
    ["Minecraft Data Pack Metadata"] = 527,
    ["Minecraft Data Pack Predicate"] = 528,
    ["Minecraft Data Pack Recipe"] = 529,
    ["Minecraft Data Pack Tag"] = 530,
    ["Minecraft Data Pack Template Pool"] = 531,
    ["Minecraft Data Pack Trim Material"] = 536,
    ["Minecraft Data Pack Trim Pattern"] = 537,
    ["Minecraft Resource Pack Lang"] = 532,
    ["Minecraft Resource Pack Particle"] = 533,
    ["Minecraft Resource Pack Texture Mcmeta"] = 535,
    ["Minecraft Resourcepack Sounds"] = 534,
    ["Monade CLI Stack Configuration"] = 547,
    ["MongoDB Atlas Search Index Definition"] = 1017,
    ["Monika Configuration"] = 1015,
    ["Monoweave Configuration"] = 542,
    ["Motif config"] = 908,
    MultiQC = 1153,
    ["NOX Framework (Service)"] = 563,
    ["Netin Diagnostic System Template"] = 974,
    ["Netlify config"] = 550,
    ["Network-as-Code Data Model"] = 551,
    ["Next Gen UI Agent A2A Server Configuration"] = 552,
    ["Next Gen UI Agent Configuration"] = 554,
    ["Next Gen UI Agent MCP Server Configuration"] = 553,
    ["Nightwatch.js"] = 556,
    ["Node.js configuration"] = 913,
    ["NueJS configuration file"] = 568,
    ["Nuitka.yaml"] = 1078,
    ["Nullstone config"] = 570,
    ["ONe's changelog entry"] = 588,
    ["ONe's service descriptor"] = 587,
    ["ORT Server repository environment configuration"] = 596,
    ["OSCAL Assessment Plan (AP)"] = 598,
    ["OSCAL Assessment Results (AR)"] = 599,
    ["OSCAL Catalog"] = 600,
    ["OSCAL Component Definition (CDef)"] = 601,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 602,
    ["OSCAL Profile"] = 603,
    ["OSCAL System Security Plan (SSP)"] = 604,
    ["OSS Review Toolkit configuration"] = 605,
    ["OSS Review Toolkit curation"] = 606,
    ["OSS Review Toolkit package configuration"] = 607,
    ["OSS Review Toolkit repository configuration"] = 608,
    ["OSS Review Toolkit resolutions"] = 609,
    ["October CMS columns"] = 574,
    ["October CMS fields"] = 575,
    ["Oh My Posh"] = 576,
    Okteto = 577,
    ["Ona Automations"] = 579,
    Opctl = 911,
    ["Open Data Contract Standard (ODCS)"] = 591,
    ["Open Data Product Standard (ODPS)"] = 592,
    ["Open Know-How"] = 1158,
    ["OpenRewrite Resource"] = 590,
    OpenStatus = 1169,
    ["OpenUtau character yaml"] = 584,
    ["OpenUtau ustx"] = 585,
    ["OpenWeather Current Weather API"] = 953,
    ["OpenWeather Road Risk API"] = 952,
    ["Ory Hydra configuration"] = 422,
    ["Ory Keto configuration"] = 482,
    ["Ory Kratos configuration"] = 597,
    ["Ory Oathkeeper configuration"] = 572,
    ["Outblocks App configuration"] = 594,
    ["Outblocks database table"] = 595,
    ["Outblocks project configuration"] = 593,
    PDM = 616,
    POPxf = 626,
    ["POPxf Correlations"] = 627,
    Packer = 613,
    Pantsbuild = 1032,
    ["Paper paper-plugin.yml"] = 614,
    ["Pipeline component"] = 965,
    ["Platform.sh application"] = 5,
    ["Platform.sh routes"] = 6,
    ["Platform.sh services"] = 7,
    ["Plex Prerolls"] = 624,
    ["PocketMine plugin.yml"] = 621,
    ["Postman collection"] = 630,
    ["Power Pages Configuration"] = 1170,
    ["Preset list for a WinUtil"] = 1115,
    ["ProActions AI-Kit Configuration"] = 640,
    ["ProActions AI-Kit Configuration for Menus"] = 642,
    ["ProActions AI-Kit Configuration for Sections"] = 644,
    ["ProActions AI-Kit Configuration for Services"] = 641,
    ["ProActions AI-Kit Configuration for Steps"] = 645,
    ["ProActions AI-Kit Configuration for Templates"] = 643,
    ["Problem object RFC9457"] = 1061,
    ["Problem package format"] = 646,
    ["Problem package generators"] = 647,
    ["Problem package submissions"] = 648,
    ["Problem package test group metadata"] = 649,
    Pterodactyl = 1011,
    ["Pull Request Labeler"] = 666,
    Pulumi = 674,
    ["PyGTA Config"] = 670,
    PyProject = 675,
    Pylock = 1161,
    Pyright = 676,
    ["Python script metadata"] = 1155,
    ["QType AI DSL"] = 679,
    Qgoda = 678,
    Qodana = 984,
    ["Qt Creator workspace file"] = 1093,
    ["Quali Torque Blueprint Spec 2"] = 1009,
    ["QueryFirst config file"] = 1028,
    ["RKE Cluster Configuration JSON"] = 962,
    ["RKE Cluster Configuration YAML"] = 961,
    RadioHound = 669,
    Railpack = 681,
    Railway = 680,
    ["Rancher Fleet"] = 671,
    ...
    Ray = 925,
    ["Read the Docs"] = 673,
    ["Red-DiscordBot Cog"] = 689,
    ["Red-DiscordBot Cog Repo"] = 690,
    ["Red-DiscordBot Trivia"] = 691,
    ["Releasaurus Config"] = 2,
    ["Render Blueprints"] = 960,
    RenderCV = 705,
    Renovate = 703,
    ["Renovate global configuration"] = 704,
    ["Replit config"] = 697,
    Restate = 1148,
    ["Revel Digital Gadget Definition File"] = 1172,
    RoadRunner = 707,
    ["Robust Station Image"] = 1178,
    Rockcraft = 708,
    ["Roo Coder Custom Modes"] = 709,
    Rubocop = 699,
    ["Rudder techniques"] = 1068,
    Ruff = 700,
    ["Rust Project"] = 701,
    ["Rust toolchain"] = 713,
    ["SDMX data message"] = 739,
    ["SDMX metadata message"] = 738,
    ["SDMX structure message"] = 737,
    ["SIL Kit Participant Configuration"] = 749,
    ["SIL Kit Registry Configuration"] = 750,
    ["SPDX 2.3"] = 787,
    SWADL = 803,
    ["Safebox Config"] = 1023,
    ["Sapphire CLI Config"] = 716,
    ["SauceCTL Configuration"] = 971,
    ["Schema Catalog"] = 731,
    ["Scoop manifest"] = 736,
    ["Semantic Data Fabric (SDF) file"] = 740,
    ["Semgrep Rule"] = 742,
    ["Serenity Code Generator (Sergen)"] = 743,
    ["Serverless Framework Configuration"] = 978,
    ["Serverless Workflow"] = 980,
    ["Settings for a Cinnamon spice"] = 1111,
    ["Settings.paf"] = 745,
    ["Shopware 6 Configuration"] = 981,
    ["Shopware CLI Extension Store Configuration"] = 982,
    ["Shopware CLI Project Store Configuration"] = 983,
    ["Sigma Detection Rule"] = 747,
    ["Sigrid scope configuration file"] = 748,
    ["SkyPilot Task JSON"] = 1069,
    ["Slack app manifest"] = 752,
    Snapcraft = 754,
    Solidarity = 757,
    ["Solution filters"] = 758,
    ["Source Maps v3"] = 759,
    Sourcery = 760,
    ["Spack bootstrap.yaml"] = 761,
    ["Spack cdash.yaml"] = 762,
    ["Spack ci.yaml"] = 763,
    ["Spack compilers.yaml"] = 764,
    ["Spack concretizer.yaml"] = 765,
    ["Spack config.yaml"] = 766,
    ["Spack definitions.yaml"] = 767,
    ["Spack develop.yaml"] = 768,
    ["Spack env_vars.yaml"] = 769,
    ["Spack environment"] = 775,
    ["Spack include.yaml"] = 770,
    ["Spack mirrors.yaml"] = 771,
    ["Spack modules.yaml"] = 772,
    ["Spack packages.yaml"] = 773,
    ["Spack repos.yaml"] = 774,
    ["Spack toolchains.yaml"] = 776,
    ["Spack upstreams.yaml"] = 777,
    ["Spack view.yaml"] = 778,
    ["Speakeasy Generation Config File"] = 782,
    ["Speakeasy Lint Configuration File"] = 779,
    ["Speakeasy Test Generation Configuration File"] = 780,
    ["Speakeasy Workflow File"] = 781,
    SpecIF = 783,
    ["Specmatic Configuration"] = 784,
    ["Sponge Mixin configuration"] = 785,
    StackBlitz = 791,
    ["StackHawk Scanner Configuration"] = 977,
    Stale = 792,
    Starfish = 793,
    ["Starlake Data Pipeline"] = 950,
    Starship = 794,
    ["Statamic Blueprint"] = 795,
    ["Stella configuration file"] = 796,
    ["Streamlit configuration file"] = 797,
    ["Stryker Mutator"] = 800,
    ["StyleCop Analyzers Configuration"] = 801,
    ["Stylelint (.stylelintrc)"] = 802,
    ["Stylua Config"] = 1162,
    ["Sublime Syntax"] = 1024,
    ["Subsquid squid manifest"] = 1071,
    ["Swagger API 2.0"] = 804,
    ["Synadia Connect Component"] = 805,
    TSON = 840,
    TSTyche = 841,
    ["TYPO3 Vendor Bundler config"] = 846,
    ["Tab data for a LinUtil"] = 1118,
    ["Tab list for a LinUtil"] = 1117,
    Tach = 806,
    ["Tach Domain"] = 807,
    Talhelper = 809,
    ["Talisman configuration"] = 810,
    Taplo = 1163,
    ["Taskfile config"] = 955,
    Taurus = 811,
    Tauticord = 812,
    ["Tekton Pipeline"] = 1191,
    ["Tekton PipelineRun"] = 1192,
    ["Tekton Task"] = 1189,
    ["Tekton TaskRun"] = 1190,
    Telefonistka = 1149,
    ["Terrateam config"] = 1175,
    ["TestEnvironment.json"] = 823,
    ["TextMate Grammar"] = 822,
    Threagile = 818,
    ["Tier.run pricing.json"] = 815,
    Tikibase = 816,
    Tombi = 821,
    ["Traefik v2"] = 826,
    ["Traefik v2 File Provider"] = 827,
    ["Traefik v3"] = 828,
    ["Traefik v3 File Provider"] = 829,
    ["Travis CI (.travis.yml)"] = 825,
    Treefmt = 400,
    Trident = 1145,
    ["TrueScript for *.tscript files"] = 832,
    ["Tugboat QA config.yml"] = 1142,
    TunnelHub = 1059,
    Turborepo = 824,
    Tycho = 1107,
    Tye = 985,
    ["Tyk Gateway - Open Source v5.7+"] = 1154,
    ["UET BuildConfig.json"] = 1029,
    ["UI5 Manifest"] = 852,
    ["UNCORS configuration"] = 856,
    ["UTAM Page Object"] = 855,
    ["Ubuntu Server Autoinstall"] = 850,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1146,
    ["Uniswap Token List"] = 937,
    ["Universal Schedule Format"] = 857,
    ["Unreal Engine Uplugin"] = 1030,
    ["Unreal Engine Uproject"] = 1031,
    ["UpCloud CLI (upctl) configuration"] = 1147,
    ["Updatecli Compose"] = 993,
    ["Updatecli Policy Manifest"] = 994,
    ["Updatecli Policy Metadata"] = 995,
    Uplift = 1027,
    ["Upsun config"] = 4,
    ["User Journey Map"] = 959,
    V2Ray = 999,
    ["VSCode Code Snippets"] = 233,
    ["VSIX CLI publishing"] = 875,
    Vector = 859,
    ["Vela Pipeline Configuration"] = 862,
    Vercel = 232,
    ["Version Bumper config"] = 865,
    Vespertide = 1196,
    ["Vespertide Migration"] = 1197,
    ["Vespertide Model"] = 1198,
    ["Viash Component Config"] = 1151,
    ["Viash Package Config"] = 1152,
    Visivo = 1057,
    ["WP-CLI"] = 885,
    Wake = 1144,
    ["Waku Config"] = 1121,
    ["Web App Manifest"] = 881,
    ["Web types"] = 884,
    WebExtensions = 880,
    ["Webman package recipe"] = 1005,
    ["Windows Package Manager Installer Manifest"] = 933,
    ["Windows Package Manager Locale Manifest"] = 934,
    ["Windows Package Manager Singleton Manifest"] = 932,
    Winutil = 935,
    ["WireMock CLI import configuration"] = 1127,
    ["WireMock CLI local service configuration"] = 1126,
    ["WireMock message stub mapping"] = 1125,
    ["WireMock stub mapping"] = 1124,
    ["Woodpecker pipeline config"] = 973,
    ["Wrangler CLI"] = 886,
    ["Xstate Machine"] = 991,
    ["Yandex Workflow Language"] = 1113,
    ["Yarn Config (.yarnrc.yml)"] = 948,
    ["Yippee-Ki-JSON configuration YML"] = 939,
    ["YouTrack App"] = 1110,
    ["Zarf Package Configuration"] = 1177,
    ["Zerops.io config"] = 1098,
    ["Zerops.io import"] = 1099,
    ["Zola Configuration"] = 1188,
    ["aerleon.yml"] = 15,
    ["angular.json"] = 31,
    apko = 1062,
    ...
    ["babelrc.json"] = 112,
    ["bamboo-spec"] = 115,
    ["bashly-strings.yml"] = 1039,
    ["batect.yml"] = 114,
    ["beef-database-codegen"] = 116,
    ["beef-database-v5-codegen"] = 118,
    ["beef-entity-codegen"] = 117,
    ["beef-entity-v5-codegen"] = 119,
    ["behat.yml"] = 131,
    ["bigquery-table"] = 120,
    ["bioimageio resource description"] = 1079,
    ["bitbucket-pipelines"] = 122,
    bitrise = 123,
    ["bitrise-step"] = 124,
    ["block.json"] = 146,
    ...
    ["bozr.suite.json"] = 133,
    bpkg = 1040,
    ["browser.i18n.json"] = 134,
    ["browsh configuration"] = 135,
    bucklescript = 136,
    ["buf.gen.yaml"] = 80,
    ["buf.plugin.yaml"] = 81,
    ["buf.work.yaml"] = 82,
    ...
    ["build-changelog"] = 137,
    ["bun.lock"] = 142,
    ["bundleconfig.json"] = 143,
    ["bunfig.toml"] = 144,
    ["cargo-mutants-config.yaml"] = 83,
    ["ccmod.json"] = 1122,
    changelogging = 1090,
    ["chisel-slices.json"] = 259,
    ["chrome-extension-locales-messages.json"] = 240,
    ["chutzpah.json"] = 241,
    cibuildwheel = 166,
    ["clang-format (.clang-format)"] = 997,
    ["clang-tidy"] = 220,
    clangd = 219,
    clib = 221,
    ["cloud-init: cloud-config userdata"] = 223,
    ["cloud-sdk-pipeline-configuration"] = 243,
    ["cloudbuild.json"] = 244,
    cloudify = 222,
    ["cmdx.yaml"] = 86,
    codemagic = 224,
    ["coffeelint.json"] = 261,
    ["commands.json"] = 236,
    ["commitlint (.commitlintrc)"] = 936,
    ["committed.toml"] = 262,
    ["compile_commands.json"] = 235,
    ["compilerconfig.json"] = 234,
    ["completely.yml"] = 1035,
    ["component-detection-manifest.json"] = 265,
    ["component.json"] = 264,
    ["composer.json"] = 263,
    ["conda-forge"] = 169,
    ["config.yaml"] = 672,
    ["contentmanifest.json"] = 242,
    ["contribute.json"] = 266,
    ["cosmos.config.json"] = 238,
    ["crowdin.yml"] = 267,
    ["ctfd-setup configuration file"] = 1134,
    ["custom-elements.json"] = 1049,
    ["cypress.json"] = 271,
    ["datalogic-scan2deploy-android"] = 281,
    ["datalogic-scan2deploy-ce"] = 282,
    ["dbt Dependencies"] = 185,
    ["dbt Packages"] = 187,
    ["dbt Project"] = 186,
    ["dbt Selectors"] = 188,
    ["dbt YAML files"] = 189,
    ["ddev-global"] = 283,
    ["ddev-project"] = 284,
    ["debugsettings.json"] = 285,
    ["dependabot-v2.json"] = 288,
    ["dependabot.json"] = 287,
    ["deployed-cli"] = 990,
    ["devcontainer.json"] = 226,
    devinit = 941,
    ["devspace.yaml"] = 1013,
    djlint = 942,
    ["docker bake"] = 293,
    ["docker sequencer"] = 294,
    ["docker-compose.yml"] = 940,
    ["dockerd.json"] = 292,
    ["dotnet Release Index manifest"] = 305,
    ["dotnet-tools.json"] = 306,
    ["dotnetcli.host.json"] = 307,
    ["dprint.json"] = 308,
    ["drone.json"] = 309,
    ["dss-2.0.0.json"] = 311,
    ["dstack configuration"] = 312,
    ["dtool dataset metadata"] = 1129,
    ["dvc.yaml"] = 313,
    ["ecosystem.json"] = 318,
    eksctl = 319,
    ["electron-builder configuration file"] = 325,
    ["epr-manifest.json"] = 324,
    ["evcc.yaml"] = 326,
    ["ezd task runner"] = 336,
    ["fabric.mod.json"] = 338,
    ["first-timers-bot"] = 345,
    ["flagd flag configuration"] = 107,
    ["fly.io Configuration"] = 108,
    fulibWorkflows = 972,
    ["function.json"] = 357,
    ["gRPC API Gateway & OpenAPI Config"] = 10,
    ["gematik health care insurance list"] = 1140,
    ["gematik health care patient list"] = 1137,
    ["gematik health care provider institution list"] = 1139,
    ["gematik health care provider list"] = 1138,
    ["gematik tiger test environment configuration"] = 1141,
    ["git-town.toml"] = 1186,
    ["gitlab-ci"] = 375,
    ["global.json"] = 391,
    ["go-feature-flag Flag Configuration"] = 394,
    ["haxelib.json"] = 412,
    helmfile = 928,
    helmwave = 929,
    ["host-meta.json"] = 419,
    ...
    ["ide.host.json"] = 427,
    ["ifstate.yaml"] = 428,
    ["imageoptimizer.json"] = 429,
    ["importmap.json"] = 432,
    instant_python_config = 434,
    instant_python_custom_project = 435,
    ["ioBroker Configuration"] = 436,
    ["ioBroker JSON UI"] = 437,
    ["ioBroker Package manifest"] = 438,
    ["ixpect.conf.yaml"] = 439,
    ["ize.toml"] = 1026,
    ["jsconfig.json"] = 464,
    ["jscpd Configuration"] = 1010,
    jsdoc = 924,
    ["k3d.yaml"] = 465,
    ["k9s aliases.yaml"] = 467,
    ["k9s cluster-config.yaml"] = 469,
    ["k9s config.yaml"] = 468,
    ["k9s hotkeys.yaml"] = 470,
    ["k9s plugins.yaml"] = 471,
    ["k9s skin.yaml"] = 472,
    ["k9s views.yaml"] = 473,
    ["kontinuous-config.yaml"] = 484,
    ["kontinuous-values.yaml"] = 483,
    ["kustomization.yaml"] = 486,
    ["label-commenter-config.yml"] = 487,
    ["latexindent configuration"] = 101,
    ["launchsettings.json"] = 488,
    lazydocker = 1048,
    lazygit = 1047,
    ["lego.json"] = 490,
    ["lerna.json"] = 491,
    ["lgtm.yml"] = 492,
    ["liblab.config.json"] = 493,
    ["libman.json"] = 494,
    ["license-report-config.json"] = 495,
    ["linkinator.config.json"] = 497,
    ["lint-staged (.lintstagedrc)"] = 902,
    ["local.settings.json"] = 502,
    ["localazy.json"] = 503,
    ["lotus.yaml"] = 501,
    ["lsdlschema.json"] = 504,
    ["macro.json"] = 1014,
    ["markdown-link-check"] = 968,
    maturin = 969,
    mboats = 976,
    ["micro-settings.json"] = 1041,
    ["mimetypes.json"] = 518,
    ["mirrord config"] = 904,
    mise = 905,
    ["mkdocs.yml"] = 538,
    ["monospace.yml"] = 541,
    ["moon.yml"] = 1123,
    ["mprocs Configuration file"] = 1094,
    ["mrdocs.yml"] = 539,
    ["mta.yaml"] = 906,
    ["mtad.yaml"] = 907,
    ["mycode.json"] = 548,
    nFPM = 555,
    ["napari plugin manifest"] = 549,
    neoload = 919,
    ["nest-cli"] = 558,
    ["ninjs (News in JSON)"] = 557,
    ["nitro.json"] = 918,
    ["nixd configuration"] = 1067,
    ["nlu.json"] = 559,
    ["nodemon.json"] = 561,
    ["noodl config"] = 975,
    ["notebook.mod.json"] = 562,
    now = 914,
    ["npm-badges"] = 565,
    ["nswag.json"] = 569,
    ntangle = 571,
    ["nuclei-template.yaml"] = 566,
    ["nuget-project.json"] = 567,
    ["ocelot.json"] = 573,
    ["omnisharp.json"] = 578,
    openHAB = 1199,
    ["openapi.json"] = 580,
    ...
    ["overlay.json"] = 581,
    ["package.json"] = 610,
    ["package.manifest"] = 612,
    ["package.yaml"] = 611,
    ["partial-black.json"] = 132,
    ["pathfinder.yml"] = 615,
    ["pattern.json"] = 618,
    ["petstore-v1.0"] = 1021,
    pgap_yaml_input_reader = 617,
    ["pixi.toml"] = 619,
    ["plagiarize-me.yaml"] = 623,
    ["plagiarize.yaml"] = 622,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1130,
    ["podbard.yaml"] = 625,
    ["portman.json"] = 628,
    ["prefect.toml"] = 636,
    ["prefect.yaml"] = 637,
    ["prettierrc.json"] = 638,
    ["prisma.yml"] = 639,
    ["project-1.0.0-beta3.json"] = 651,
    ["project-1.0.0-beta4.json"] = 652,
    ["project-1.0.0-beta5.json"] = 653,
    ["project-1.0.0-beta6.json"] = 654,
    ["project-1.0.0-beta8.json"] = 655,
    ["project-1.0.0-rc1.json"] = 656,
    ["project-1.0.0-rc2.json"] = 657,
    ["project.json"] = 650,
    ["project.owasp.yaml"] = 658,
    ["prometheus-alertmanager.json"] = 662,
    ["prometheus.json"] = 659,
    ["prometheus.rules.json"] = 660,
    ["prometheus.rules.test.json"] = 661,
    ["proxies.json"] = 663,
    ["publiccode.yml"] = 664,
    ["pubspec.yaml"] = 665,
    ["pyrseas-0.8.json"] = 668,
    pytest = 677,
    ["quilt.mod.json"] = 1042,
    ["rc3 auth"] = 683,
    ["rc3 collection"] = 684,
    ...
    ["release drafter"] = 920,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 693,
    ["release-please-manifest.json"] = 694,
    ["release-plz.toml"] = 695,
    ["renv.lock"] = 706,
    ["rivet.json"] = 1066,
    ["rivet.yaml (legacy)"] = 1065,
    rumdl = 711,
    runny = 710,
    rustfmt = 712,
    sake = 1157,
    samt = 714,
    samtrc = 715,
    ["sarif-1.0.0.json"] = 717,
    ["sarif-2.0.0.json"] = 718,
    ["sarif-2.1.0"] = 728,
    ["sarif-2.1.0-rtm.2"] = 719,
    ["sarif-2.1.0-rtm.3"] = 721,
    ["sarif-2.1.0-rtm.4"] = 723,
    ["sarif-2.1.0-rtm.5"] = 725,
    ["sarif-2.1.0-rtm.6"] = 726,
    ["sarif-external-property-file-2.1.0"] = 729,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 720,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 722,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 724,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 727,
    ["scalingo.json configuration"] = 730,
    ["schema.org - Action"] = 732,
    ["schema.org - ContactPoint"] = 733,
    ["schema.org - Place"] = 734,
    ["schema.org - Thing"] = 735,
    ["secrethub.yml"] = 1044,
    ["semantic-release"] = 741,
    ["servicehub.config.json"] = 897,
    ["servicehub.service.json"] = 896,
    ["settings.job"] = 744,
    ["sfdx-hardis configuration"] = 746,
    ["shard.yml"] = 1082,
    ["size-limit configuration"] = 751,
    ["skaffold.yaml"] = 966,
    ["skyuxconfig.json"] = 753,
    ["snowflake-config"] = 755,
    ["snowflake-connections"] = 756,
    ["spicepod.yaml"] = 1102,
    ["sqlc configuration"] = 788,
    ["stripe-app-local.json"] = 799,
    ["stripe-app.json"] = 798,
    swcrc = 951,
    ["task.json"] = 808,
    taskcat = 915,
    ["template.json"] = 813,
    ["templatsources.json"] = 814,
    ["theme.json"] = 817,
    ["tizen_workspace.json"] = 819,
    tldr = 820,
    ["tm_devices configuration file"] = 1168,
    tmuxinator = 900,
    ["transcend.yml"] = 830,
    ["tree-sitter grammar.json"] = 399,
    ["trime.yaml"] = 831,
    ["trunk.yaml"] = 833,
    ["ts-force-config.json"] = 838,
    ["tsconfig.json"] = 834,
    ["tsd.json"] = 835,
    ["tsdoc.json"] = 836,
    ["tsdrc.json"] = 837,
    ...
    v8r = 879,
    vcluster = 1088,
    ["vcpkg configuration file"] = 231,
    ["vcpkg manifest file"] = 230,
    ["vega-lite.json"] = 861,
    ["vega.json"] = 860,
    ["venvironment.yaml"] = 863,
    ["venvplus.yaml"] = 864,
    version = 1150,
    ["version.json"] = 866,
    ["vhwdebugger-binding.yaml"] = 868,
    ["vim-addon-info"] = 869,
    ["vs-2017.3.host.json"] = 871,
    ["vs-nesting.json"] = 872,
    ["vsls.json"] = 870,
    ["vss-extension.json"] = 876,
    vtcfg = 1156,
    ["vtesttree.yaml"] = 877,
    ["vtestunit.yaml"] = 878,
    ["warp-keysets.json"] = 1050,
    ["warp-themes.json"] = 1051,
    ["warp-workflows.json"] = 1052,
    ["webhint.io"] = 1006,
    ["webjobpublishsettings.json"] = 883,
    ["webjobs-list.json"] = 882,
    ["well-known-fursona"] = 1089,
    ["xs-app.json"] = 910,
    ["xunit.runner.json"] = 895,
    yamllint = 938,
    zizmor = 1193,
    zuul = 921,
    ["Žinoma"] = 931
