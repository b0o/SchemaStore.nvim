...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 136,
    [".cryproj (generic)"] = 471,
    [".cryproj engine-5.2"] = 466,
    [".cryproj engine-5.3"] = 467,
    [".cryproj engine-5.4"] = 468,
    [".cryproj engine-5.5"] = 469,
    [".cryproj engine-dev"] = 470,
    [".csscomb.json"] = 138,
    [".csslintrc"] = 139,
    [".eslintrc"] = 180,
    [".esmrc.json"] = 172,
    ...
    [".mtaext"] = 479,
    [".nodehawkrc"] = 295,
    [".npmpackagejsonlintrc"] = 297,
    [".phraseapp.yml"] = 330,
    [".pmbot.yml"] = 322,
    [".postcssrc"] = 327,
    [".pre-commit-config.yml"] = 328,
    [".pre-commit-hooks.yml"] = 329,
    [".putout.json"] = 347,
    [".rehyperc"] = 353,
    [".remarkrc"] = 354,
    [".sprite files"] = 394,
    ...
    [".vsext"] = 447,
    [".yarnrc.yml"] = 511,
    ["<div>RIOTS' studio configuration"] = 450,
    ["@factorial/drupal-breakpoints-css"] = 3,
    ["API Builder"] = 508,
    ["AVA Configuration Schema"] = 562,
    ["AWS CDK cdk.json"] = 124,
    ["AWS CloudFormation"] = 125,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 126,
    ["Airlock Microgateway"] = 7,
    ["Airplane task"] = 8,
    ["Ansible Collection Galaxy"] = 19,
    ["Ansible Execution Environment"] = 11,
    ["Ansible Inventory"] = 18,
    ["Ansible Meta"] = 12,
    ["Ansible Meta Runtime"] = 13,
    ["Ansible Navigator Configuration"] = 21,
    ["Ansible Playbook"] = 17,
    ["Ansible Requirements"] = 14,
    ["Ansible Tasks File"] = 16,
    ["Ansible Vars File"] = 15,
    ["Ansible-lint Configuration"] = 20,
    ...
    AsyncAPI = 34,
    ["Avro Avsc"] = 35,
    ["Azure Device Update for IoT Hub import manifest"] = 36,
    ["Azure Device Update for IoT Hub update manifest"] = 37,
    ["Azure IoT Edge deployment"] = 40,
    ["Azure IoT Edge deployment template"] = 41,
    ["Azure IoT EdgeAgent deployment"] = 38,
    ["Azure IoT EdgeHub deployment"] = 39,
    ["Azure Pipelines"] = 42,
    ["Azure Static Web Apps CLI configuration file"] = 396,
    ["Azure Static Web Apps configuration file"] = 395,
    ["BX CI"] = 71,
    ["Better Code Hub"] = 513,
    ["Better Scripts"] = 72,
    BizTalkServerApplicationSchema = 485,
    ["Block Protocol Metadata"] = 70,
    Briefcase = 490,
    ["Build Info"] = 63,
    Buildkite = 65,
    ["Bukkit plugin.yml"] = 64,
    ["BungeeCord plugin.yml"] = 68,
    ["Butane Config"] = 549,
    ["CICS TS region tagging"] = 556,
    ["CICS TS resource import"] = 557,
    ["CICS TS resource model"] = 558,
    ["CICS TS resource overrides"] = 559,
    ["CMake Presets"] = 73,
    ["CNC Codes JSON Schema"] = 81,
    ["CSR Framework"] = 84,
    ["Calqulus pipeline"] = 74,
    ["Camel YAML DSL"] = 75,
    Carafe = 76,
    ["Cargo Config Schema"] = 77,
    ["Cargo Make"] = 78,
    ["Catalog Info Backstage"] = 79,
    Cheatsheets = 546,
    ["Chrome Extension"] = 118,
    ["CircleCI config.yml"] = 101,
    ["Citation File Format"] = 127,
    CityJSON = 80,
    ["Code Climate"] = 102,
    ["Commandbox Box.json"] = 82,
    ["Commandbox Server.json"] = 83,
    ["Common Catalog Schema"] = 116,
    ["Common types for all schemas"] = 1,
    ["Container Structure Test"] = 496,
    Containerlab = 520,
    ["Dart build configuration"] = 140,
    ["Dart test config"] = 141,
    ["DashLord configuration"] = 142,
    ["Datadog Service Definition"] = 253,
    ["Datahub Ingestion Recipe Schema"] = 563,
    ["Dein Config Schema"] = 85,
    Deno = 146,
    ["Deployer Recipe"] = 149,
    Devfile = 169,
    ["Discord Webhook"] = 151,
    ["Dolittle Artifacts"] = 155,
    ["Dolittle Bounded Context Configuration"] = 156,
    ["Dolittle Event Horizons Configuration"] = 157,
    ["Dolittle Resources Configuration"] = 158,
    ["Dolittle Server Configuration"] = 159,
    ["Dolittle Tenant Map Configuration"] = 161,
    ["Dolittle Tenants Configuration"] = 160,
    ["Dolittle Topology"] = 162,
    ["Drupal Breakpoints Schema"] = 86,
    ["Drupal Config Schema"] = 97,
    ["Drupal Info Schema"] = 87,
    ["Drupal Layouts Schema"] = 88,
    ["Drupal Libraries Schema"] = 89,
    ["Drupal Links Action Schema"] = 90,
    ["Drupal Links Contextual Schema"] = 91,
    ["Drupal Links Menu Schema"] = 92,
    ["Drupal Links Task Schema"] = 93,
    ["Drupal Migration Schema"] = 94,
    ["Drupal Permissions Schema"] = 95,
    ["Drupal Routing Schema"] = 96,
    ["Drupal Services Schema"] = 98,
    ["Drush site aliases"] = 166,
    ["Embrace Config Schema"] = 574,
    ["Error pages"] = 175,
    Esquio = 173,
    ["Estuary Flow Catalog Schema"] = 553,
    ["Expo SDK"] = 178,
    ["F-Droid Data metadata"] = 183,
    ["Facets - FSDL - Application"] = 181,
    ["Fossa configuration file"] = 188,
    ["Fossa's fossa-deps file"] = 189,
    ["Foundry VTT - Manifest"] = 186,
    ["Foundry VTT - Template"] = 187,
    ["Foxx Manifest"] = 43,
    ["GatewayCore API Gateway"] = 192,
    ["GeoJSON.json latest"] = 551,
    GherKing = 555,
    ["GitHub Action"] = 196,
    ["GitHub Funding"] = 197,
    ["GitHub Issue Template configuration"] = 199,
    ["GitHub Workflow"] = 200,
    ["GitHub Workflow Template Properties"] = 201,
    ["GitHub issue forms"] = 198,
    GitVersion = 195,
    ["Gitpod Configuration"] = 203,
    ["Global Privacy Control"] = 193,
    ["Google Cloud Workflows"] = 123,
    Goreleaser = 206,
    ["Goreleaser Pro"] = 207,
    ["Gradle Build Cache Node"] = 510,
    ["Gradle Enterprise"] = 509,
    ["Grafana 5.x Dashboard"] = 208,
    ["GraphQL Code Generator"] = 211,
    ["GraphQL Config"] = 210,
    ["GraphQL Mesh"] = 209,
    ["Grunt JSHint task"] = 215,
    ["Grunt Watch task"] = 216,
    ["Grunt base task"] = 217,
    ["Grunt clean task"] = 213,
    ["Grunt copy task"] = 212,
    ["Grunt cssmin task"] = 214,
    HEMTT = 482,
    Hadolint = 494,
    ["Hardware Sentry Configuration"] = 567,
    Hayson = 219,
    ["Haystack Pipeline"] = 220,
    ["Hazelcast 5 Configuration"] = 221,
    ["Helm Chart.lock"] = 100,
    ["Helm Chart.yaml"] = 99,
    Hugo = 545,
    ["Istanbul Schema"] = 570,
    ["JDownloader2 crawler multi-rule schema"] = 237,
    ["JDownloader2 crawler single-rule schema"] = 236,
    ["JFrog File Spec"] = 238,
    ["JFrog Pipelines YML DSL"] = 576,
    ["JSON Document Transform"] = 246,
    ["JSON Feed"] = 247,
    ["JSON Resume"] = 357,
    ["JSON Schema Draft 2020-12"] = 462,
    ["JSON Schema Draft 4"] = 459,
    ["JSON Schema Draft 7"] = 460,
    ["JSON Schema Draft 8"] = 461,
    ["JSON schema for CodeShip Pro services configuration files"] = 109,
    ["JSON schema for CodeShip Pro steps configuration files"] = 110,
    ["JSON schema for Codecov configuration files"] = 108,
    ["JSON-API"] = 245,
    ["JSON-e templates"] = 518,
    ["JSON-stat 2.0"] = 456,
    JSONPatch = 249,
    Jasmine = 232,
    Jekyll = 233,
    ["Jenkins X Pipelines"] = 234,
    ["Jenkins X Requirements"] = 235,
    ["Jovo Language Models"] = 239,
    ["KSP-AVC"] = 457,
    ["KSP-CKAN"] = 458,
    ["Keycloak REST API"] = 578,
    ["KoDE/CI build.yaml"] = 572,
    ["Kong DBLess Schema"] = 573,
    KrakenD = 252,
    ["LinkML Metamodel"] = 263,
    Liquibase = 524,
    ["Liquibase Flow File"] = 525,
    Markdownlint = 528,
    ["MegaLinter configuration"] = 267,
    ["MegaLinter descriptor"] = 268,
    ["Meltano plugin discovery definition"] = 270,
    ["Meltano project definition"] = 269,
    ["Microsoft Band Web Tile"] = 271,
    ["Minecraft Data Pack Advancement"] = 273,
    ["Minecraft Data Pack Biome"] = 274,
    ["Minecraft Data Pack Configured Carver"] = 275,
    ["Minecraft Data Pack Dimension"] = 277,
    ["Minecraft Data Pack Dimension Type"] = 276,
    ["Minecraft Data Pack Item Modifier"] = 278,
    ["Minecraft Data Pack Loot Table"] = 279,
    ["Minecraft Data Pack Metadata"] = 280,
    ["Minecraft Data Pack Predicate"] = 281,
    ["Minecraft Data Pack Recipe"] = 282,
    ["Minecraft Data Pack Template Pool"] = 283,
    ["Minecraft Resourcepack Sounds"] = 284,
    ["MongoDB Atlas Search Index Definition Schema"] = 571,
    ["Monika Configuration Schema"] = 569,
    ["Motif config"] = 478,
    ["Netin Diagnostic System Template"] = 533,
    ["Netlify config schema"] = 289,
    ["Nightwatch.js"] = 290,
    ["OSS Review Toolkit configuration"] = 312,
    ["OSS Review Toolkit curation"] = 313,
    ["OSS Review Toolkit package configuration"] = 314,
    ["OSS Review Toolkit repository configuration"] = 315,
    ["OSS Review Toolkit resolutions"] = 316,
    Opctl = 481,
    ["OpenWeather Current Weather API"] = 517,
    ["OpenWeather Road Risk API"] = 516,
    ["Ory Hydra configuration"] = 225,
    ["Ory Keto configuration"] = 254,
    ["Ory Kratos configuration"] = 311,
    ["Ory Oathkeeper configuration"] = 302,
    ["Outblocks App configuration"] = 309,
    ["Outblocks database table"] = 310,
    ["Outblocks project configuration"] = 308,
    Packer = 319,
    ["Pipeline component"] = 526,
    ["PocketMine plugin.yml"] = 323,
    Pterodactyl = 566,
    ["Pull Request Labeler"] = 346,
    PyProject = 350,
    Qodana = 542,
    ["Quali Torque Blueprint Spec 2"] = 564,
    ["RKE Cluster Configuration JSON Schema"] = 523,
    ["RKE Cluster Configuration YAML Schema"] = 522,
    Ray = 493,
    ["Read the Docs"] = 349,
    ["Red-DiscordBot Cog"] = 351,
    ["Red-DiscordBot Cog Repo"] = 352,
    Renovate = 358,
    ["Replit schema"] = 355,
    RoadRunner = 359,
    ["Rust toolchain"] = 361,
    SWADL = 407,
    ["Sapphire CLI Config"] = 362,
    ["SauceCTL Configuration"] = 530,
    ["Schema Catalog"] = 375,
    ["Scoop manifest"] = 380,
    ["Semgrep Rule"] = 382,
    ["Serverless Framework Configuration"] = 537,
    ["Serverless Workflow Schema"] = 538,
    ["Settings.paf"] = 384,
    ["Shopware 6 Configuration"] = 539,
    ["Shopware CLI Extension Store Configuration"] = 540,
    ["Shopware CLI Project Store Configuration"] = 541,
    Solidarity = 389,
    ["Solution filters"] = 390,
    ["Source Maps v3"] = 391,
    SpecIF = 392,
    ["Sponge Mixin configuration"] = 393,
    ["StackHawk Scanner Configuration"] = 536,
    ["StackHead CLI config"] = 397,
    ["StackHead module configuration"] = 398,
    ["StackHead project definition"] = 399,
    Stale = 400,
    Starship = 401,
    ["Statamic Blueprint"] = 402,
    ["StrmPrivacy batch job configuration file"] = 577,
    ["Stryker Mutator"] = 404,
    ["StyleCop Analyzers Configuration"] = 405,
    ["Swagger API 2.0"] = 408,
    ["Talisman configuration"] = 409,
    ["Taskfile YAML Schema"] = 519,
    Taurus = 410,
    ["TestEnvironment.json"] = 417,
    Tikibase = 413,
    ["Traefik v2"] = 420,
    ["Traefik v2 File Provider"] = 421,
    Turborepo = 418,
    Tye = 543,
    ["UI5 Manifest"] = 433,
    ["UTAM Page Object"] = 435,
    ["Ubuntu Server Autoinstall"] = 431,
    ["Uniswap Token List"] = 502,
    Updatecli = 550,
    ["User Journey Map YAML Schema"] = 521,
    V2Ray = 554,
    ["VSCode Code Snippets"] = 112,
    ["VSIX CLI publishing"] = 448,
    ["Vela Pipeline Configuration"] = 438,
    Vercel = 111,
    ["Web App Manifest"] = 452,
    ["Web types"] = 455,
    WebExtensions = 451,
    ["Webman package recipe"] = 560,
    ["Windows Package Manager Installer Manifest"] = 499,
    ["Windows Package Manager Locale Manifest"] = 500,
    ["Windows Package Manager Singleton Manifest"] = 498,
    ["Woodpecker pipeline config"] = 532,
    ["Xstate Machine Schema"] = 548,
    ["Yippee-Ki-JSON configuration YML"] = 504,
    ["angular.json"] = 9,
    ["app-definition.yaml"] = 23,
    ["apple-app-site-association"] = 22,
    ["appsettings.json"] = 26,
    ["appsscript.json"] = 25,
    ["appveyor.yml"] = 27,
    ["arc.json"] = 29,
    ...
    ["batect.yml"] = 48,
    ["beau.yml"] = 512,
    ["beef-database-codegen"] = 50,
    ["beef-entity-codegen"] = 51,
    ["behat.yml"] = 59,
    ["bigquery-table"] = 52,
    ["bitbucket-pipelines"] = 53,
    bitrise = 54,
    ["bitrise-step"] = 55,
    ["block.json"] = 69,
    ["bower.json"] = 57,
    ["bozr.suite.json"] = 60,
    ["browser.i18n.json"] = 61,
    bucklescript = 62,
    ["bundleconfig.json"] = 67,
    ["chutzpah.json"] = 119,
    ["cloud-init: cloud-config userdata JSON schema"] = 106,
    ["cloud-sdk-pipeline-config-schema"] = 121,
    ["cloudbuild.json"] = 122,
    cloudify = 105,
    codemagic = 107,
    ["coffeelint.json"] = 128,
    comet = 514,
    ["commands.json"] = 115,
    ["compile_commands.json"] = 114,
    ["compilerconfig.json"] = 113,
    ["component-detection-manifest.json"] = 131,
    ["component.json"] = 130,
    ["composer.json"] = 129,
    ["config.json"] = 132,
    ["contentmanifest.json"] = 120,
    ["contribute.json"] = 133,
    ["cosmos.config.json"] = 117,
    ["crowdin.yml"] = 134,
    cspell = 137,
    ["cypress.json"] = 135,
    ["datalogic-scan2deploy-android"] = 143,
    ["datalogic-scan2deploy-ce"] = 144,
    ["debugsettings.json"] = 145,
    ["dependabot-v2.json"] = 148,
    ["dependabot.json"] = 147,
    ["deployed-cli"] = 547,
    ["detekt.yml"] = 150,
    devinit = 506,
    ["devspace.yaml"] = 568,
    ["docfx.json"] = 154,
    ["docker-compose.yml"] = 505,
    ["docker-seq schema"] = 153,
    ["dockerd.json"] = 152,
    ["dotnet Release Index manifest"] = 163,
    ["dotnetcli.host.json"] = 164,
    ["drone.json"] = 165,
    ["dss-2.0.0.json"] = 167,
    ["dvc.yaml"] = 168,
    ["ecosystem.json"] = 170,
    eksctl = 171,
    ["electron-builder configuration file."] = 176,
    ["epr-manifest.json"] = 174,
    ["evcc.yaml"] = 177,
    ["ezd schema"] = 179,
    ["fabric.mod.json"] = 182,
    ["first-timers-bot"] = 185,
    ["fly.io Schema"] = 44,
    fulibWorkflows = 531,
    ["func.yaml"] = 190,
    ["function.json"] = 191,
    ...
    ["gitlab-ci"] = 202,
    ["global.json"] = 204,
    ["golangci-lint Configuration"] = 205,
    ["haxelib.json"] = 218,
    helmfile = 495,
    ["host-meta.json"] = 223,
    ["host.json"] = 222,
    ...
    huskyrc = 474,
    ["ide.host.json"] = 226,
    ["imageoptimizer.json"] = 227,
    ["importmap.json"] = 229,
    ["ioBroker JSON UI"] = 230,
    ["ioBroker Package manifest"] = 231,
    ["ize.toml"] = 579,
    ["jsconfig.json"] = 250,
    ["jscpd Configuration Schema"] = 565,
    jsdoc = 492,
    ["k3d.yaml"] = 251,
    ["kustomization.yaml"] = 255,
    ["label-commenter-config.yml"] = 256,
    ["launchsettings.json"] = 257,
    ["lerna.json"] = 258,
    ["lgtm.yml"] = 259,
    ["libman.json"] = 260,
    ["license-report-config.json"] = 261,
    ["linkinator.config.json"] = 262,
    ["local.settings.json"] = 264,
    ["localazy.json"] = 265,
    ["lsdlschema.json"] = 266,
    ["markdown-lint-check"] = 529,
    mboats = 535,
    ["mimetypes.json"] = 272,
    ["mta.yaml"] = 476,
    ["mtad.yaml"] = 477,
    ["mycode.json"] = 287,
    ["napari plugin manifest"] = 288,
    neoload = 487,
    ["nest-cli"] = 293,
    ["ninjs (News in JSON) 1.3"] = 292,
    ["ninjs (News in JSON) 2.0"] = 291,
    ["nlu.json"] = 294,
    ["nodemon.json"] = 296,
    ["noodl.schema.json"] = 534,
    now = 483,
    ["nswag.json"] = 300,
    ntangle = 301,
    ["nuclei-template.yaml"] = 298,
    ["nuget-project.json"] = 299,
    ["ocelot.json"] = 303,
    ["omnisharp.json"] = 304,
    ["openapi.json"] = 305,
    ["openfin.json"] = 307,
    ["openrpc.json"] = 306,
    ["package.json"] = 317,
    ["package.manifest"] = 318,
    ["pattern.json"] = 321,
    ["petstore-v1.0"] = 575,
    pgap_yaml_input_reader = 320,
    ["plagiarize-me.yaml"] = 325,
    ["plagiarize.yaml"] = 324,
    ["portman.json"] = 326,
    ["prettierrc.json"] = 331,
    ["prisma.yml"] = 332,
    ["project-1.0.0-beta3.json"] = 334,
    ["project-1.0.0-beta4.json"] = 335,
    ["project-1.0.0-beta5.json"] = 336,
    ["project-1.0.0-beta6.json"] = 337,
    ["project-1.0.0-beta8.json"] = 338,
    ["project-1.0.0-rc1.json"] = 339,
    ["project-1.0.0-rc2.json"] = 340,
    ["project.json"] = 333,
    ["prometheus.json"] = 341,
    ["prometheus.rules.json"] = 342,
    ["proxies.json"] = 343,
    ["publiccode.yml"] = 344,
    ["pubspec.yaml"] = 345,
    ["pyrseas-0.8.json"] = 348,
    ["release drafter"] = 488,
    rustfmt = 360,
    ["sarif-1.0.0.json"] = 363,
    ["sarif-2.0.0.json"] = 364,
    ["sarif-2.1.0"] = 373,
    ["sarif-2.1.0-rtm.2"] = 365,
    ["sarif-2.1.0-rtm.3"] = 367,
    ["sarif-2.1.0-rtm.4"] = 369,
    ["sarif-2.1.0-rtm.5"] = 371,
    ["sarif-external-property-file-2.1.0"] = 374,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 366,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 368,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 370,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 372,
    ["schema.org - Action"] = 376,
    ["schema.org - ContactPoint"] = 377,
    ["schema.org - Place"] = 378,
    ["schema.org - Thing"] = 379,
    ["semantic-release"] = 381,
    ["servicehub.config.json"] = 465,
    ["servicehub.service.json"] = 464,
    ["settings.job"] = 383,
    ["sfdx-hardis configuration"] = 385,
    ["size-limit configuration"] = 386,
    ["skaffold.yaml"] = 527,
    ["skyuxconfig.json"] = 387,
    snapcraft = 388,
    ["stripe-app.json"] = 403,
    swcrc = 515,
    taskcat = 484,
    ["template.json"] = 411,
    ["templatsources.json"] = 412,
    ["theme.json"] = 414,
    ["tizen_workspace.json"] = 415,
    tmLanguage = 416,
    tmuxinator = 473,
    ["trunk.yaml schema"] = 422,
    ["ts-force-config.json"] = 426,
    ["tsconfig.json"] = 423,
    ["tsd.json"] = 424,
    ["tsdrc.json"] = 425,
    ["tslint.json"] = 427,
    ...
    ["vega-lite.json"] = 437,
    ["vega.json"] = 436,
    ["venvironment-basic.yaml"] = 440,
    ["venvironment.yaml"] = 439,
    ["version.json"] = 441,
    ["vim-addon-info"] = 442,
    ["vs-2017.3.host.json"] = 444,
    ["vs-nesting.json"] = 445,
    ["vsls.json"] = 443,
    ["vss-extension.json"] = 449,
    ["webhint.io"] = 561,
    ["webjobpublishsettings.json"] = 454,
    ["webjobs-list.json"] = 453,
    ["xs-app.json"] = 480,
    ["xunit.runner.json"] = 463,
    yamllint = 503,
    zuul = 489,
    ["Žinoma"] = 497
  },
