...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 112,
    [".cryproj (generic)"] = 422,
    [".cryproj engine-5.2"] = 417,
    [".cryproj engine-5.3"] = 418,
    [".cryproj engine-5.4"] = 419,
    [".cryproj engine-5.5"] = 420,
    [".cryproj engine-dev"] = 421,
    [".csscomb.json"] = 114,
    [".csslintrc"] = 115,
    [".eslintrc"] = 152,
    [".esmrc.json"] = 145,
    ...
    [".vsext"] = 398,
    [".yarnrc.yml"] = 460,
    ["<div>RIOTS' studio configuration"] = 401,
    ["API Builder"] = 457,
    ["AVA Configuration Schema"] = 506,
    ...
    ["Azure Pipelines"] = 40,
    ["Azure Static Web Apps CLI configuration file"] = 355,
    ["Azure Static Web Apps configuration file"] = 354,
    ["Better Code Hub"] = 462,
    BizTalkServerApplicationSchema = 434,
    ...
    ["Butane config schema"] = 496,
    ["CICS TS resource overrides"] = 503,
    ["CMake Presets"] = 68,
    ["CSR Framework"] = 76,
    ...
    ["Error pages"] = 148,
    Esquio = 146,
    ["Estuary Flow Catalog Schema"] = 500,
    ["Expo SDK"] = 151,
    ...
    Goreleaser = 178,
    ["Goreleaser Pro"] = 179,
    ["Gradle Build Cache Node"] = 459,
    ["Gradle Enterprise"] = 458,
    ...
    ["JSON Feed"] = 216,
    ["JSON Resume"] = 319,
    ["JSON Schema Draft 2020-12"] = 413,
    ["JSON Schema Draft 4"] = 410,
    ["JSON Schema Draft 7"] = 411,
    ["JSON Schema Draft 8"] = 412,
    ...
    ["Netin Diagnostic System Template"] = 481,
    ...
    Opctl = 430,
    ["OpenWeather Current Weather API"] = 466,
    ["OpenWeather Road Risk API"] = 465,
    ...
    Packer = 284,
    ["Pipeline component"] = 475,
    ["PocketMine plugin.yml"] = 288,
    ["Pull Request Labeler"] = 310,
    Qodana = 489,
    ["RKE Cluster Configuration JSON Schema"] = 473,
    ["RKE Cluster Configuration YAML Schema"] = 472,
    Ray = 442,
    ["Read the Docs"] = 313,
    ...
    ["SauceCTL Configuration"] = 478,
    ["Schema Catalog"] = 335,
    ["Scoop manifest"] = 340,
    ["Semantic Release"] = 341,
    ["Semgrep Rule"] = 342,
    ["Serverless Framework Configuration"] = 485,
    ["Settings.paf"] = 344,
    ["Shopware 6 Configuration"] = 486,
    ["Shopware CLI Extension Store Configuration"] = 487,
    ["Shopware CLI Project Store Configuration"] = 488,
    Solidarity = 349,
    ["Source Maps v3"] = 350,
    SpecIF = 351,
    ["Sponge Mixin configuration"] = 352,
    ["StackHawk Scanner Configuration"] = 484,
    ["StackHead CLI config"] = 356,
    ["StackHead module configuration"] = 357,
    ["StackHead project definition"] = 358,
    Stale = 359,
    ["Statamic Blueprint"] = 360,
    ["Stryker Mutator"] = 361,
    ["StyleCop Analyzers Configuration"] = 362,
    ["Swagger API 2.0"] = 365,
    ["Taskfile YAML Schema"] = 468,
    Taurus = 366,
    ["TestEnvironment.json"] = 372,
    Tikibase = 369,
    ["Traefik v2"] = 374,
    ["Traefik v2 File Provider"] = 375,
    Tye = 490,
    ["UI5 Manifest"] = 387,
    ["Ubuntu Server Autoinstall"] = 385,
    ["Uniswap Token List"] = 451,
    Updatecli = 497,
    ["User Journey Map YAML Schema"] = 471,
    V2Ray = 501,
    ["VSCode Code Snippets"] = 90,
    ["VSIX CLI publishing"] = 399,
    ["Vela Pipeline Configuration"] = 391,
    Vercel = 89,
    ["Web App Manifest"] = 403,
    ["Web types"] = 406,
    WebExtensions = 402,
    ["Webman package recipe"] = 504,
    ["Windows Package Manager Installer Manifest"] = 448,
    ["Windows Package Manager Locale Manifest"] = 449,
    ["Windows Package Manager Singleton Manifest"] = 447,
    ["Woodpecker pipeline config"] = 480,
    ["Xstate Machine Schema"] = 495,
    ["Yippee-Ki-JSON configuration YML"] = 453,
    ["angular.json"] = 8,
    ...
    ["servicehub.config.json"] = 416,
    ["servicehub.service.json"] = 415,
    ["settings.job"] = 343,
    ["sfdx-hardis configuration"] = 345,
    ["size-limit configuration"] = 346,
    ["skaffold.yaml"] = 476,
    ["skyuxconfig.json"] = 347,
    snapcraft = 348,
    swcrc = 464,
    taskcat = 433,
    ["template.json"] = 367,
    ["templatsources.json"] = 368,
    ["theme.json"] = 370,
    tmLanguage = 371,
    ["trunk.yaml schema"] = 376,
    ["ts-force-config.json"] = 380,
    ["tsconfig.json"] = 377,
    ["tsd.json"] = 378,
    ["tsdrc.json"] = 379,
    ["tslint.json"] = 381,
    ...
    ["version.json"] = 392,
    ["vim-addon-info"] = 393,
    ["vs-2017.3.host.json"] = 395,
    ["vs-nesting.json"] = 396,
    ["vsls.json"] = 394,
    ["vss-extension.json"] = 400,
    ["webhint.io"] = 505,
    ["webjobpublishsettings.json"] = 405,
    ["webjobs-list.json"] = 404,
    ["xs-app.json"] = 429,
    ["xunit.runner.json"] = 414,
    yamllint = 452,
    zuul = 438,
    ["Žinoma"] = 446
  },
