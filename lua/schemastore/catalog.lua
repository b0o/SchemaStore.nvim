...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 152,
    [".cryproj (generic)"] = 507,
    [".cryproj engine-5.2"] = 502,
    [".cryproj engine-5.3"] = 503,
    [".cryproj engine-5.4"] = 504,
    [".cryproj engine-5.5"] = 505,
    [".cryproj engine-dev"] = 506,
    [".csscomb.json"] = 154,
    [".csslintrc"] = 155,
    [".eslintrc"] = 200,
    [".esmrc.json"] = 192,
    ...
    [".pmbot.yml"] = 350,
    [".postcssrc"] = 355,
    [".pre-commit-config.yml"] = 356,
    [".pre-commit-hooks.yml"] = 357,
    [".putout.json"] = 375,
    [".rehyperc"] = 383,
    [".remarkrc"] = 384,
    [".sprite files"] = 427,
    ...
    ["Azure Pipelines"] = 47,
    ["Azure Static Web Apps CLI configuration file"] = 429,
    ["Azure Static Web Apps configuration file"] = 428,
    ["BX CI"] = 82,
    ["Better Code Hub"] = 550,
    ["Better Scripts"] = 83,
    BizTalkServerApplicationSchema = 522,
    ...
    ["Butane Config"] = 588,
    ["CICS TS region tagging"] = 595,
    ["CICS TS resource import"] = 596,
    ["CICS TS resource model"] = 597,
    ["CICS TS resource overrides"] = 598,
    ["CMake Presets"] = 84,
    ...
    ["Datahub Ingestion Recipe Schema"] = 602,
    ...
    ["Embrace Config Schema"] = 613,
    ["Error pages"] = 195,
    Esquio = 193,
    ["Estuary Flow Catalog Schema"] = 592,
    ["Expo SDK"] = 198,
    ...
    Goreleaser = 226,
    ["Goreleaser Pro"] = 227,
    ["Gradle Build Cache Node"] = 547,
    ["Gradle Enterprise"] = 546,
    ...
    Hadolint = 531,
    Hammerkit = 557,
    ["Hardware Sentry Configuration"] = 606,
    Hayson = 239,
    ...
    ["JFrog File Spec"] = 259,
    ["JFrog Pipelines YML DSL"] = 615,
    ["JSON Document Transform"] = 267,
    ["JSON Feed"] = 268,
    ["JSON Resume"] = 389,
    ["JSON Schema Draft 2020-12"] = 498,
    ["JSON Schema Draft 4"] = 495,
    ["JSON Schema Draft 7"] = 496,
    ["JSON Schema Draft 8"] = 497,
    ...
    ["KSP-AVC"] = 493,
    ["KSP-CKAN"] = 494,
    ["Keycloak REST API"] = 621,
    ["Knative Functions - func.yaml"] = 210,
    ["KoDE/CI build.yaml"] = 611,
    ["Kong DBLess Schema"] = 612,
    KrakenD = 273,
    ["LinkML Metamodel"] = 285,
    Liquibase = 562,
    ["Liquibase Flow File"] = 563,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 610,
    ["Monika Configuration Schema"] = 608,
    ["Motif config"] = 515,
    ["NOX Framework (Service)"] = 323,
    ["Netin Diagnostic System Template"] = 571,
    ["Netlify config schema"] = 315,
    ["Nightwatch.js"] = 316,
    ["OSS Review Toolkit configuration"] = 340,
    ["OSS Review Toolkit curation"] = 341,
    ["OSS Review Toolkit package configuration"] = 342,
    ["OSS Review Toolkit repository configuration"] = 343,
    ["OSS Review Toolkit resolutions"] = 344,
    Opctl = 518,
    ["OpenWeather Current Weather API"] = 554,
    ["OpenWeather Road Risk API"] = 553,
    ["Ory Hydra configuration"] = 245,
    ["Ory Keto configuration"] = 275,
    ["Ory Kratos configuration"] = 339,
    ["Ory Oathkeeper configuration"] = 330,
    ["Outblocks App configuration"] = 337,
    ["Outblocks database table"] = 338,
    ["Outblocks project configuration"] = 336,
    Packer = 347,
    Pantsbuild = 627,
    ["Pipeline component"] = 564,
    ["PocketMine plugin.yml"] = 351,
    Pterodactyl = 605,
    ["Pull Request Labeler"] = 374,
    Pulumi = 379,
    PyProject = 380,
    Qodana = 581,
    ["Quali Torque Blueprint Spec 2"] = 603,
    ["QueryFirst config file"] = 624,
    ["RKE Cluster Configuration JSON Schema"] = 561,
    ["RKE Cluster Configuration YAML Schema"] = 560,
    ["Rancher Fleet"] = 377,
    Ray = 530,
    ["Read the Docs"] = 378,
    ["Red-DiscordBot Cog"] = 381,
    ["Red-DiscordBot Cog Repo"] = 382,
    Renovate = 390,
    ["Replit schema"] = 385,
    RoadRunner = 391,
    Ruff = 387,
    ["Rust Project"] = 388,
    ["Rust toolchain"] = 393,
    ["SIL Kit Participant Configuration"] = 418,
    SWADL = 438,
    ["Sapphire CLI Config"] = 394,
    ["SauceCTL Configuration"] = 568,
    ["Schema Catalog"] = 407,
    ["Scoop manifest"] = 412,
    ["Semgrep Rule"] = 414,
    ["Serverless Framework Configuration"] = 575,
    ["Serverless Workflow Schema"] = 577,
    ["Settings.paf"] = 416,
    ["Shopware 6 Configuration"] = 578,
    ["Shopware CLI Extension Store Configuration"] = 579,
    ["Shopware CLI Project Store Configuration"] = 580,
    Solidarity = 422,
    ["Solution filters"] = 423,
    ["Source Maps v3"] = 424,
    SpecIF = 425,
    ["Sponge Mixin configuration"] = 426,
    ["StackHawk Scanner Configuration"] = 574,
    Stale = 430,
    Starship = 431,
    ["Statamic Blueprint"] = 432,
    ["StrmPrivacy Data Connector"] = 619,
    ["StrmPrivacy Data Contract"] = 620,
    ["StrmPrivacy SimpleSchema"] = 617,
    ["StrmPrivacy Stream"] = 618,
    ["StrmPrivacy batch job configuration file"] = 616,
    ["Stryker Mutator"] = 435,
    ["StyleCop Analyzers Configuration"] = 436,
    ["Swagger API 2.0"] = 439,
    TSON = 460,
    ["Talisman configuration"] = 440,
    ["Taskfile YAML Schema"] = 556,
    Taurus = 441,
    ["TestEnvironment.json"] = 449,
    ["Tier.run pricing.json"] = 444,
    Tikibase = 445,
    ["Traefik v2"] = 452,
    ["Traefik v2 File Provider"] = 453,
    Turborepo = 450,
    Tye = 582,
    ["UI5 Manifest"] = 467,
    ["UTAM Page Object"] = 470,
    ["Ubuntu Server Autoinstall"] = 465,
    ["Uniswap Token List"] = 539,
    ["Unreal Engine Uplugin"] = 625,
    ["Unreal Engine Uproject"] = 626,
    Updatecli = 589,
    Uplift = 623,
    ["User Journey Map YAML Schema"] = 559,
    V2Ray = 593,
    ["VSCode Code Snippets"] = 128,
    ["VSIX CLI publishing"] = 483,
    ["Vela Pipeline Configuration"] = 473,
    Vercel = 127,
    ["Web App Manifest"] = 488,
    ["Web types"] = 491,
    WebExtensions = 487,
    ["Webman package recipe"] = 599,
    ["Windows Package Manager Installer Manifest"] = 536,
    ["Windows Package Manager Locale Manifest"] = 537,
    ["Windows Package Manager Singleton Manifest"] = 535,
    ["Woodpecker pipeline config"] = 570,
    ["Xstate Machine Schema"] = 587,
    ["Yippee-Ki-JSON configuration YML"] = 541,
    ["angular.json"] = 11,
    ...
    ["ize.toml"] = 622,
    ["jsconfig.json"] = 271,
    ["jscpd Configuration Schema"] = 604,
    jsdoc = 529,
    ["k3d.yaml"] = 272,
    ...
    ["openrpc.json"] = 334,
    ["package.json"] = 345,
    ["package.manifest"] = 346,
    ["pattern.json"] = 349,
    ["petstore-v1.0"] = 614,
    pgap_yaml_input_reader = 348,
    ["plagiarize-me.yaml"] = 353,
    ["plagiarize.yaml"] = 352,
    ["portman.json"] = 354,
    ["prettierrc.json"] = 359,
    ["prisma.yml"] = 360,
    ["project-1.0.0-beta3.json"] = 362,
    ["project-1.0.0-beta4.json"] = 363,
    ["project-1.0.0-beta5.json"] = 364,
    ["project-1.0.0-beta6.json"] = 365,
    ["project-1.0.0-beta8.json"] = 366,
    ["project-1.0.0-rc1.json"] = 367,
    ["project-1.0.0-rc2.json"] = 368,
    ["project.json"] = 361,
    ["prometheus.json"] = 369,
    ["prometheus.rules.json"] = 370,
    ["proxies.json"] = 371,
    ["publiccode.yml"] = 372,
    ["pubspec.yaml"] = 373,
    ["pyrseas-0.8.json"] = 376,
    ["release drafter"] = 525,
    rustfmt = 392,
    ["sarif-1.0.0.json"] = 395,
    ["sarif-2.0.0.json"] = 396,
    ["sarif-2.1.0"] = 405,
    ["sarif-2.1.0-rtm.2"] = 397,
    ["sarif-2.1.0-rtm.3"] = 399,
    ["sarif-2.1.0-rtm.4"] = 401,
    ["sarif-2.1.0-rtm.5"] = 403,
    ["sarif-external-property-file-2.1.0"] = 406,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 398,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 400,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 402,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 404,
    ["schema.org - Action"] = 408,
    ["schema.org - ContactPoint"] = 409,
    ["schema.org - Place"] = 410,
    ["schema.org - Thing"] = 411,
    ["semantic-release"] = 413,
    ["servicehub.config.json"] = 501,
    ["servicehub.service.json"] = 500,
    ["settings.job"] = 415,
    ["sfdx-hardis configuration"] = 417,
    ["size-limit configuration"] = 419,
    ["skaffold.yaml"] = 565,
    ["skyuxconfig.json"] = 420,
    snapcraft = 421,
    ["stripe-app-local.json"] = 434,
    ["stripe-app.json"] = 433,
    swcrc = 552,
    taskcat = 521,
    ["template.json"] = 442,
    ["templatsources.json"] = 443,
    ["theme.json"] = 446,
    ["tizen_workspace.json"] = 447,
    tmLanguage = 448,
    tmuxinator = 509,
    ["trunk.yaml schema"] = 454,
    ["ts-force-config.json"] = 458,
    ["tsconfig.json"] = 455,
    ["tsd.json"] = 456,
    ["tsdrc.json"] = 457,
    ["tslint.json"] = 459,
    ...
    ["vega-lite.json"] = 472,
    ["vega.json"] = 471,
    ["venvironment-basic.yaml"] = 475,
    ["venvironment.yaml"] = 474,
    ["version.json"] = 476,
    ["vim-addon-info"] = 477,
    ["vs-2017.3.host.json"] = 479,
    ["vs-nesting.json"] = 480,
    ["vsls.json"] = 478,
    ["vss-extension.json"] = 484,
    ["webhint.io"] = 600,
    ["webjobpublishsettings.json"] = 490,
    ["webjobs-list.json"] = 489,
    ["xs-app.json"] = 517,
    ["xunit.runner.json"] = 499,
    yamllint = 540,
    zuul = 526,
    ["Žinoma"] = 534
  },
