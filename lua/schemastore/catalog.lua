...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 154,
    [".cryproj (generic)"] = 516,
    [".cryproj engine-5.2"] = 511,
    [".cryproj engine-5.3"] = 512,
    [".cryproj engine-5.4"] = 513,
    [".cryproj engine-5.5"] = 514,
    [".cryproj engine-dev"] = 515,
    [".csscomb.json"] = 156,
    [".csslintrc"] = 157,
    [".eslintrc"] = 202,
    [".esmrc.json"] = 194,
    ...
    [".mtaext"] = 525,
    [".nodehawkrc"] = 326,
    [".npmpackagejsonlintrc"] = 329,
    [".phraseapp.yml"] = 364,
    [".pmbot.yml"] = 356,
    [".postcssrc"] = 361,
    [".pre-commit-config.yml"] = 362,
    [".pre-commit-hooks.yml"] = 363,
    [".putout.json"] = 381,
    [".rehyperc"] = 389,
    [".remarkrc"] = 390,
    [".sprite files"] = 435,
    ...
    ["Azure Pipelines"] = 48,
    ["Azure Static Web Apps CLI configuration file"] = 437,
    ["Azure Static Web Apps configuration file"] = 436,
    ["BX CI"] = 83,
    ["Better Code Hub"] = 559,
    ["Better Scripts"] = 84,
    BizTalkServerApplicationSchema = 531,
    ...
    ["Butane Config"] = 597,
    ["CICS TS region tagging"] = 604,
    ["CICS TS resource import"] = 605,
    ["CICS TS resource model"] = 606,
    ["CICS TS resource overrides"] = 607,
    ["CMake Presets"] = 85,
    ...
    ["Datahub Ingestion Recipe Schema"] = 611,
    ...
    ["Embrace Config Schema"] = 622,
    ["Error pages"] = 197,
    Esquio = 195,
    ["Estuary Flow Catalog Schema"] = 601,
    ["Expo SDK"] = 200,
    ...
    Goreleaser = 228,
    ["Goreleaser Pro"] = 229,
    ["Gradle Build Cache Node"] = 556,
    ["Gradle Enterprise"] = 555,
    ...
    Hadolint = 540,
    Hammerkit = 566,
    ["Hardware Sentry Configuration"] = 615,
    Hayson = 241,
    ...
    ["JFrog File Spec"] = 261,
    ["JFrog Pipelines YML DSL"] = 624,
    ["JMeter DSL cli config schema"] = 262,
    ["JSON Document Transform"] = 270,
    ["JSON Feed"] = 271,
    ["JSON Resume"] = 395,
    ["JSON Schema Draft 2020-12"] = 507,
    ["JSON Schema Draft 4"] = 504,
    ["JSON Schema Draft 7"] = 505,
    ["JSON Schema Draft 8"] = 506,
    ...
    ["KSP-AVC"] = 502,
    ["KSP-CKAN"] = 503,
    ["Keycloak REST API"] = 630,
    ["Knative Functions - func.yaml"] = 212,
    ["KoDE/CI build.yaml"] = 620,
    ["Kong DBLess Schema"] = 621,
    KrakenD = 276,
    ["LinkML Metamodel"] = 289,
    Liquibase = 571,
    ["Liquibase Flow File"] = 572,
    ...
    ["Minecraft Resourcepack Sounds"] = 314,
    ["MkDocs Configuration 1.0"] = 315,
    ["MongoDB Atlas Search Index Definition Schema"] = 619,
    ["Monika Configuration Schema"] = 617,
    ["Motif config"] = 524,
    ["NOX Framework (Service)"] = 328,
    ["Netin Diagnostic System Template"] = 580,
    ["Netlify config schema"] = 320,
    ["Nightwatch.js"] = 321,
    ["OSS Review Toolkit configuration"] = 346,
    ["OSS Review Toolkit curation"] = 347,
    ["OSS Review Toolkit package configuration"] = 348,
    ["OSS Review Toolkit repository configuration"] = 349,
    ["OSS Review Toolkit resolutions"] = 350,
    Opctl = 527,
    ["OpenRewrite Resource"] = 341,
    ["OpenWeather Current Weather API"] = 563,
    ["OpenWeather Road Risk API"] = 562,
    ["Ory Hydra configuration"] = 247,
    ["Ory Keto configuration"] = 278,
    ["Ory Kratos configuration"] = 345,
    ["Ory Oathkeeper configuration"] = 335,
    ["Outblocks App configuration"] = 343,
    ["Outblocks database table"] = 344,
    ["Outblocks project configuration"] = 342,
    Packer = 353,
    Pantsbuild = 636,
    ["Pipeline component"] = 573,
    ["PocketMine plugin.yml"] = 357,
    Pterodactyl = 614,
    ["Pull Request Labeler"] = 380,
    Pulumi = 385,
    PyProject = 386,
    Qodana = 590,
    ["Quali Torque Blueprint Spec 2"] = 612,
    ["QueryFirst config file"] = 633,
    ["RKE Cluster Configuration JSON Schema"] = 570,
    ["RKE Cluster Configuration YAML Schema"] = 569,
    ["Rancher Fleet"] = 383,
    Ray = 539,
    ["Read the Docs"] = 384,
    ["Red-DiscordBot Cog"] = 387,
    ["Red-DiscordBot Cog Repo"] = 388,
    Renovate = 396,
    ["Replit schema"] = 391,
    RoadRunner = 397,
    Ruff = 393,
    ["Rust Project"] = 394,
    ["Rust toolchain"] = 399,
    ["SIL Kit Participant Configuration"] = 425,
    SWADL = 446,
    ["Sapphire CLI Config"] = 400,
    ["SauceCTL Configuration"] = 577,
    ["Schema Catalog"] = 413,
    ["Scoop manifest"] = 418,
    ["Semgrep Rule"] = 420,
    ["Serenity Code Generator (Sergen)"] = 421,
    ["Serverless Framework Configuration"] = 584,
    ["Serverless Workflow Schema"] = 586,
    ["Settings.paf"] = 423,
    ["Shopware 6 Configuration"] = 587,
    ["Shopware CLI Extension Store Configuration"] = 588,
    ["Shopware CLI Project Store Configuration"] = 589,
    Solidarity = 429,
    ["Solution filters"] = 430,
    ["Source Maps v3"] = 431,
    Sourcery = 432,
    SpecIF = 433,
    ["Sponge Mixin configuration"] = 434,
    ["StackHawk Scanner Configuration"] = 583,
    Stale = 438,
    Starship = 439,
    ["Statamic Blueprint"] = 440,
    ["StrmPrivacy Data Connector"] = 628,
    ["StrmPrivacy Data Contract"] = 629,
    ["StrmPrivacy SimpleSchema"] = 626,
    ["StrmPrivacy Stream"] = 627,
    ["StrmPrivacy batch job configuration file"] = 625,
    ["Stryker Mutator"] = 443,
    ["StyleCop Analyzers Configuration"] = 444,
    ["Swagger API 2.0"] = 447,
    TSON = 469,
    ["Talisman configuration"] = 448,
    ["Taskfile YAML Schema"] = 565,
    Taurus = 449,
    ["TestEnvironment.json"] = 457,
    ["Tier.run pricing.json"] = 452,
    Tikibase = 453,
    ["Traefik v2"] = 460,
    ["Traefik v2 File Provider"] = 461,
    Turborepo = 458,
    Tye = 591,
    ["UI5 Manifest"] = 476,
    ["UTAM Page Object"] = 479,
    ["Ubuntu Server Autoinstall"] = 474,
    ["Uniswap Token List"] = 548,
    ["Unreal Engine Uplugin"] = 634,
    ["Unreal Engine Uproject"] = 635,
    Updatecli = 598,
    Uplift = 632,
    ["User Journey Map YAML Schema"] = 568,
    V2Ray = 602,
    ["VSCode Code Snippets"] = 130,
    ["VSIX CLI publishing"] = 492,
    ["Vela Pipeline Configuration"] = 482,
    Vercel = 129,
    ["Web App Manifest"] = 497,
    ["Web types"] = 500,
    WebExtensions = 496,
    ["Webman package recipe"] = 608,
    ["Windows Package Manager Installer Manifest"] = 545,
    ["Windows Package Manager Locale Manifest"] = 546,
    ["Windows Package Manager Singleton Manifest"] = 544,
    ["Woodpecker pipeline config"] = 579,
    ["Xstate Machine Schema"] = 596,
    ["Yippee-Ki-JSON configuration YML"] = 550,
    ["angular.json"] = 11,
    ...
    ["ize.toml"] = 631,
    ["jsconfig.json"] = 274,
    ["jscpd Configuration Schema"] = 613,
    jsdoc = 538,
    ["k3d.yaml"] = 275,
    ...
    ["mtad.yaml"] = 523,
    ["mycode.json"] = 318,
    ["napari plugin manifest"] = 319,
    neoload = 533,
    ["nest-cli"] = 324,
    ["ninjs (News in JSON) 1.3"] = 323,
    ["ninjs (News in JSON) 2.0"] = 322,
    ["nlu.json"] = 325,
    ["nodemon.json"] = 327,
    ["noodl.schema.json"] = 581,
    now = 529,
    ["npm-badges"] = 330,
    ["nswag.json"] = 333,
    ntangle = 334,
    ["nuclei-template.yaml"] = 331,
    ["nuget-project.json"] = 332,
    ["ocelot.json"] = 336,
    ["omnisharp.json"] = 337,
    ["openapi.json"] = 338,
    ["openfin.json"] = 340,
    ["openrpc.json"] = 339,
    ["package.json"] = 351,
    ["package.manifest"] = 352,
    ["pattern.json"] = 355,
    ["petstore-v1.0"] = 623,
    pgap_yaml_input_reader = 354,
    ["plagiarize-me.yaml"] = 359,
    ["plagiarize.yaml"] = 358,
    ["portman.json"] = 360,
    ["prettierrc.json"] = 365,
    ["prisma.yml"] = 366,
    ["project-1.0.0-beta3.json"] = 368,
    ["project-1.0.0-beta4.json"] = 369,
    ["project-1.0.0-beta5.json"] = 370,
    ["project-1.0.0-beta6.json"] = 371,
    ["project-1.0.0-beta8.json"] = 372,
    ["project-1.0.0-rc1.json"] = 373,
    ["project-1.0.0-rc2.json"] = 374,
    ["project.json"] = 367,
    ["prometheus.json"] = 375,
    ["prometheus.rules.json"] = 376,
    ["proxies.json"] = 377,
    ["publiccode.yml"] = 378,
    ["pubspec.yaml"] = 379,
    ["pyrseas-0.8.json"] = 382,
    ["release drafter"] = 534,
    rustfmt = 398,
    ["sarif-1.0.0.json"] = 401,
    ["sarif-2.0.0.json"] = 402,
    ["sarif-2.1.0"] = 411,
    ["sarif-2.1.0-rtm.2"] = 403,
    ["sarif-2.1.0-rtm.3"] = 405,
    ["sarif-2.1.0-rtm.4"] = 407,
    ["sarif-2.1.0-rtm.5"] = 409,
    ["sarif-external-property-file-2.1.0"] = 412,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 404,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 406,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 408,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 410,
    ["schema.org - Action"] = 414,
    ["schema.org - ContactPoint"] = 415,
    ["schema.org - Place"] = 416,
    ["schema.org - Thing"] = 417,
    ["semantic-release"] = 419,
    ["servicehub.config.json"] = 510,
    ["servicehub.service.json"] = 509,
    ["settings.job"] = 422,
    ["sfdx-hardis configuration"] = 424,
    ["size-limit configuration"] = 426,
    ["skaffold.yaml"] = 574,
    ["skyuxconfig.json"] = 427,
    snapcraft = 428,
    ["stripe-app-local.json"] = 442,
    ["stripe-app.json"] = 441,
    swcrc = 561,
    taskcat = 530,
    ["template.json"] = 450,
    ["templatsources.json"] = 451,
    ["theme.json"] = 454,
    ["tizen_workspace.json"] = 455,
    tmLanguage = 456,
    tmuxinator = 518,
    ["transcend.yml"] = 462,
    ["trunk.yaml schema"] = 463,
    ["ts-force-config.json"] = 467,
    ["tsconfig.json"] = 464,
    ["tsd.json"] = 465,
    ["tsdrc.json"] = 466,
    ["tslint.json"] = 468,
    ...
    ["vega-lite.json"] = 481,
    ["vega.json"] = 480,
    ["venvironment-basic.yaml"] = 484,
    ["venvironment.yaml"] = 483,
    ["version.json"] = 485,
    ["vim-addon-info"] = 486,
    ["vs-2017.3.host.json"] = 488,
    ["vs-nesting.json"] = 489,
    ["vsls.json"] = 487,
    ["vss-extension.json"] = 493,
    ["webhint.io"] = 609,
    ["webjobpublishsettings.json"] = 499,
    ["webjobs-list.json"] = 498,
    ["xs-app.json"] = 526,
    ["xunit.runner.json"] = 508,
    yamllint = 549,
    zuul = 535,
    ["Žinoma"] = 543
  },
