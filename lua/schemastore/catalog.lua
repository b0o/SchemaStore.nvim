...
M.json = {
  ...
  index = {
    ...
    ["Better Code Hub"] = 520,
    ["Better Scripts"] = 75,
    BizTalkServerApplicationSchema = 492,
    ...
    ["Butane Config"] = 556,
    ["CICS TS region tagging"] = 563,
    ["CICS TS resource import"] = 564,
    ["CICS TS resource model"] = 565,
    ["CICS TS resource overrides"] = 566,
    ["CMake Presets"] = 76,
    ...
    ["Embrace Config Schema"] = 581,
    ["Error pages"] = 180,
    Esquio = 178,
    ["Estuary Flow Catalog Schema"] = 560,
    ["Expo SDK"] = 183,
    ...
    Goreleaser = 211,
    ["Goreleaser Pro"] = 212,
    ["Gradle Build Cache Node"] = 517,
    ["Gradle Enterprise"] = 516,
    ...
    HEMTT = 489,
    Hadolint = 501,
    ["Hardware Sentry Configuration"] = 574,
    Hayson = 224,
    ...
    ["KSP-AVC"] = 463,
    ["KSP-CKAN"] = 464,
    ["Keycloak REST API"] = 585,
    ["Knative Functions - func.yaml"] = 195,
    ["KoDE/CI build.yaml"] = 579,
    ["Kong DBLess Schema"] = 580,
    KrakenD = 257,
    ["LinkML Metamodel"] = 268,
    Liquibase = 531,
    ["Liquibase Flow File"] = 532,
    Markdownlint = 535,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 578,
    ["Monika Configuration Schema"] = 576,
    ["Motif config"] = 485,
    ["Netin Diagnostic System Template"] = 540,
    ...
    Opctl = 488,
    ["OpenWeather Current Weather API"] = 524,
    ["OpenWeather Road Risk API"] = 523,
    ...
    Packer = 325,
    ["Pipeline component"] = 533,
    ["PocketMine plugin.yml"] = 329,
    Pterodactyl = 573,
    ["Pull Request Labeler"] = 352,
    PyProject = 356,
    Qodana = 549,
    ["Quali Torque Blueprint Spec 2"] = 571,
    ["QueryFirst config file"] = 588,
    ["RKE Cluster Configuration JSON Schema"] = 530,
    ["RKE Cluster Configuration YAML Schema"] = 529,
    Ray = 500,
    ["Read the Docs"] = 355,
    ...
    ["SauceCTL Configuration"] = 537,
    ["Schema Catalog"] = 381,
    ["Scoop manifest"] = 386,
    ["Semgrep Rule"] = 388,
    ["Serverless Framework Configuration"] = 544,
    ["Serverless Workflow Schema"] = 545,
    ["Settings.paf"] = 390,
    ["Shopware 6 Configuration"] = 546,
    ["Shopware CLI Extension Store Configuration"] = 547,
    ["Shopware CLI Project Store Configuration"] = 548,
    Solidarity = 396,
    ["Solution filters"] = 397,
    ["Source Maps v3"] = 398,
    SpecIF = 399,
    ["Sponge Mixin configuration"] = 400,
    ["StackHawk Scanner Configuration"] = 543,
    Stale = 404,
    Starship = 405,
    ["Statamic Blueprint"] = 406,
    ["StrmPrivacy batch job configuration file"] = 584,
    ["Stryker Mutator"] = 408,
    ["StyleCop Analyzers Configuration"] = 409,
    ["Swagger API 2.0"] = 412,
    TSON = 432,
    ["Talisman configuration"] = 413,
    ["Taskfile YAML Schema"] = 526,
    Taurus = 414,
    ...
    ["Uniswap Token List"] = 509,
    Updatecli = 557,
    Uplift = 587,
    ["User Journey Map YAML Schema"] = 528,
    V2Ray = 561,
    ...
    ["Web types"] = 461,
    WebExtensions = 457,
    ["Webman package recipe"] = 567,
    ["Windows Package Manager Installer Manifest"] = 506,
    ["Windows Package Manager Locale Manifest"] = 507,
    ["Windows Package Manager Singleton Manifest"] = 505,
    ["Woodpecker pipeline config"] = 539,
    ["Xstate Machine Schema"] = 555,
    ["Yippee-Ki-JSON configuration YML"] = 511,
    ["angular.json"] = 9,
    ...
    ["ize.toml"] = 586,
    ["jsconfig.json"] = 255,
    ["jscpd Configuration Schema"] = 572,
    jsdoc = 499,
    ["k3d.yaml"] = 256,
