...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 193,
    [".cryproj (generic)"] = 656,
    [".cryproj engine-5.2"] = 651,
    [".cryproj engine-5.3"] = 652,
    [".cryproj engine-5.4"] = 653,
    [".cryproj engine-5.5"] = 654,
    [".cryproj engine-dev"] = 655,
    [".eslintrc"] = 248,
    [".esmrc.json"] = 240,
    [".ffizer.yaml"] = 252,
    [".htmlhintrc"] = 308,
    ...
    [".mtaext"] = 667,
    [".nodehawkrc"] = 418,
    [".npmpackagejsonlintrc"] = 421,
    [".phrase.yml"] = 467,
    [".phraseapp.yml"] = 468,
    [".pmbot.yml"] = 457,
    [".postcssrc"] = 462,
    [".powerpages-web-template-manifest"] = 464,
    [".pre-commit-config.yml"] = 465,
    [".pre-commit-hooks.yml"] = 466,
    [".putout.json"] = 487,
    [".rehyperc"] = 500,
    [".remarkrc"] = 502,
    [".sprite files"] = 560,
    ...
    ["<div>RIOTS' studio configuration"] = 634,
    ["@factorial/drupal-breakpoints-css"] = 4,
    ["A micro editor config"] = 372,
    AIConfig = 11,
    ["API Builder"] = 699,
    ["AVA Configuration"] = 759,
    ["AWS CDK cdk.json"] = 177,
    ["AWS CloudFormation"] = 178,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 179,
    ["AWS SAM CLI Samconfig"] = 180,
    ["Adobe UXP Manifest"] = 824,
    ["Aerleon Network & Service Definitions"] = 7,
    ["Aerleon Policy"] = 8,
    ["Airlock Microgateway"] = 12,
    ["Airplane task"] = 13,
    ["Alacritty Configuration"] = 731,
    ["All Contributors configuration file"] = 789,
    ...
    ["Azure Pipelines"] = 64,
    ["Azure Static Web Apps CLI configuration file"] = 563,
    ["Azure Static Web Apps configuration file"] = 562,
    ["BX CI"] = 102,
    ["Bashly (bashly.yml)"] = 793,
    ["Bashly Settings (bashly-settings.yml)"] = 794,
    ["Better Code Hub"] = 703,
    ["Better Scripts"] = 103,
    Bigconfig = 81,
    BizTalkServerApplicationSchema = 673,
    Bleep = 104,
    ...
    ["Butane Config"] = 744,
    ["CGS Custom Card Game (CardGameDef.json)"] = 829,
    ["CICS TS region tagging"] = 753,
    ["CICS TS resource import"] = 754,
    ["CICS TS resource model"] = 755,
    ["CICS TS resource overrides"] = 756,
    ["CMake Presets"] = 105,
    ["CNC Codes"] = 117,
    ...
    Cheatsheets = 741,
    ["Chrome Extension"] = 170,
    ["Chromia Model"] = 112,
    ["CircleCI config.yml"] = 147,
    ["Citation File Format"] = 182,
    CityJSON = 114,
    ["Clawject config"] = 122,
    ["Code Climate"] = 148,
    CodeCV = 61,
    ["CodeShip Pro services configuration files"] = 159,
    ["CodeShip Pro steps configuration files"] = 160,
    ["Codecov configuration files"] = 158,
    Codux = 156,
    ["Cog config file"] = 118,
    ["Commandbox Box.json"] = 119,
    ["Commandbox Server.json"] = 120,
    ["Common Catalog Data"] = 168,
    Conjure = 116,
    ["Container Structure Test"] = 686,
    Containerlab = 711,
    ["Crowdsec collection config"] = 189,
    ["Crowdsec parser config"] = 190,
    ["Crowdsec scenario config"] = 191,
    ["CumulusCI Config"] = 121,
    ["Custom Machinery Machine"] = 830,
    ["Custom Machinery Recipe"] = 831,
    ["DWP Exchange - catalogue entry"] = 235,
    ["DWP Exchange - gateway"] = 233,
    ["DWP Exchange - meta"] = 234,
    ["Dart Build Config (dart-build.json)"] = 197,
    ["Dart Test Config (dart-test.json)"] = 198,
    ["DashLord Configuration"] = 199,
    ["Data Contract Specification"] = 200,
    ["DataYoga Connections"] = 123,
    ["DataYoga Job"] = 124,
    ["Databricks Asset Bundles"] = 810,
    ["Datadog Service Definition"] = 349,
    ["Datahub Ingestion Recipe"] = 760,
    ["Dein Config"] = 126,
    ["Deno Config (deno.json)"] = 206,
    ["Dependency cruiser"] = 127,
    ["Deployer Recipe"] = 209,
    ["Deta Spacefile"] = 128,
    ["Detekt Config (detekt.yml)"] = 210,
    ["Devbox Config"] = 129,
    ["Devbox Plugin"] = 130,
    Devfile = 232,
    ["Discord Webhook"] = 211,
    ["DocFx Config (docfx.json)"] = 214,
    ["Dolittle Artifacts"] = 215,
    ["Dolittle Bounded Context Configuration"] = 216,
    ["Dolittle Event Horizons Configuration"] = 217,
    ["Dolittle Resources Configuration"] = 218,
    ["Dolittle Server Configuration"] = 219,
    ["Dolittle Tenant Map Configuration"] = 221,
    ["Dolittle Tenants Configuration"] = 220,
    ["Dolittle Topology"] = 222,
    ...
    ["Drupal Routing"] = 141,
    ["Drupal Services"] = 143,
    ["Drush site aliases"] = 228,
    ["Dynamic Bash Aliases (.aliases)"] = 801,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 790,
    ["Elgato Stream Deck"] = 238,
    ["Embrace Config"] = 771,
    Endurica = 814,
    ...
    ["Error pages"] = 243,
    Esquio = 241,
    ["Estuary Flow Catalog"] = 750,
    ["Expo SDK"] = 246,
    ["F-Droid Data metadata"] = 251,
    ["Facets - FSDL - Application"] = 249,
    ["FasterCI Configuration"] = 65,
    FiQuS = 255,
    Firebase = 253,
    ["Flow.json Configurations"] = 834,
    ["Fossa configuration file"] = 262,
    ["Fossa's fossa-deps file"] = 263,
    ["Foundry VTT - Base package Manifest"] = 257,
    ["Foundry VTT - Module Manifest"] = 258,
    ["Foundry VTT - System Data Template"] = 261,
    ["Foundry VTT - System Manifest"] = 259,
    ["Foundry VTT - World Manifest"] = 260,
    ["Foxx Manifest"] = 66,
    ["Freifunk.de Community API"] = 69,
    ["Frogbot Config"] = 70,
    ["G2P Mapping Configuration"] = 267,
    ["GCP Blueprint Metadata"] = 270,
    Gaspar = 268,
    ["GatewayCore API Gateway"] = 269,
    ["GeoJSON.json latest"] = 748,
    GherKing = 752,
    ["GitHub Action"] = 275,
    ["GitHub Discussion"] = 276,
    ["GitHub Funding"] = 277,
    ["GitHub Issue Template configuration"] = 279,
    ["GitHub Issue Template forms"] = 278,
    ["GitHub Workflow"] = 280,
    ["GitHub Workflow Template Properties"] = 281,
    ["GitLab Agent for Kubernetes configuration"] = 826,
    GitVersion = 272,
    ["Gitea Issue Template configuration"] = 273,
    ["Gitea Issue Template forms"] = 274,
    ["Gitpod Configuration"] = 283,
    ["GlazeWM settings"] = 828,
    ["Global Privacy Control"] = 271,
    Goblet = 809,
    ["Golangci-lint Configuration"] = 285,
    ["Golangci-lint Custom Plugins Configuration"] = 286,
    ["Google Chrome Related Website Sets"] = 254,
    ["Google Cloud Workflows"] = 176,
    Goreleaser = 288,
    ["Goreleaser Pro"] = 289,
    Goss = 290,
    ["Gradle Build Cache Node"] = 701,
    ["Gradle Enterprise"] = 700,
    ["Grafana 5.x Dashboard"] = 291,
    ["GraphQL Code Generator"] = 295,
    ["GraphQL Config"] = 294,
    ["GraphQL Mesh"] = 293,
    ["Grunt JSHint task"] = 299,
    ["Grunt Watch task"] = 300,
    ["Grunt base task"] = 301,
    ["Grunt clean task"] = 297,
    ["Grunt copy task"] = 296,
    ["Grunt cssmin task"] = 298,
    HEMTT = 670,
    Hadolint = 682,
    Hammerkit = 710,
    ["Hardware Sentry Configuration"] = 764,
    Hatch = 683,
    Hayson = 303,
    ["Haystack Pipeline"] = 304,
    ["Hazelcast 5 Configuration"] = 305,
    ["Helm Chart.lock"] = 145,
    ["Helm Chart.yaml"] = 144,
    ["Helm Unittest Test Suite"] = 146,
    Hugo = 740,
    ["Hugo Theme"] = 739,
    ["IBM Zapp document"] = 310,
    ["IBM zCodeFormatSettings"] = 311,
    ["IMG Catapult PSP"] = 316,
    ["IVMS101 by CODE Protocol"] = 827,
    Istanbul = 767,
    ["JDownloader2 crawler multi-rules"] = 326,
    ["JDownloader2 crawler single-rules"] = 325,
    ["JFrog Applications Config"] = 327,
    ["JFrog File Spec"] = 328,
    ["JFrog Pipelines YML DSL"] = 773,
    ["JMeter DSL cli config"] = 329,
    JReleaser = 331,
    ["JSON Document Transform"] = 339,
    ["JSON Feed"] = 340,
    ["JSON Resume"] = 507,
    ["JSON Schema Draft 2020-12"] = 647,
    ["JSON Schema Draft 4"] = 644,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 811,
    ["JSON Schema Draft 7"] = 645,
    ["JSON Schema Draft 7 (unofficial strict)"] = 812,
    ["JSON Schema Draft 8 (2019-09)"] = 646,
    ["JSON-API"] = 338,
    ["JSON-e templates"] = 708,
    ["JSON-stat 2.0"] = 641,
    JSONPatch = 342,
    ["JSR Package Config (jsr.json)"] = 332,
    Jasmine = 321,
    Jekyll = 322,
    ["Jenkins X Pipelines"] = 323,
    ["Jenkins X Requirements"] = 324,
    ["Jovo Language Models"] = 330,
    ["KIMMDY config file"] = 347,
    ["KSP-AVC"] = 642,
    ["KSP-CKAN"] = 643,
    KSY = 839,
    ["Karakum configuration file"] = 264,
    Kas = 345,
    ["Keycloak REST API"] = 781,
    ["Knative Functions - func.yaml"] = 265,
    ["KoDE/CI build.yaml"] = 769,
    ["Kong DBLess config"] = 770,
    KrakenD = 348,
    LOOBin = 367,
    Lefthook = 356,
    ["Liferay client-extension.yaml"] = 363,
    ["LinkML Metamodel"] = 365,
    Liquibase = 716,
    ["Liquibase Flow File"] = 717,
    ["Lively Properties"] = 366,
    ["Lobe AI Agent"] = 63,
    ["MLOS Configs"] = 401,
    ["MS2Rescore Configuration"] = 404,
    ["Madness (madness.yml)"] = 792,
    Markdownlint = 720,
    ["Mason Registry"] = 722,
    ["MegaLinter configuration"] = 373,
    ["MegaLinter descriptor"] = 374,
    Melange = 818,
    ["Meltano plugin discovery definition"] = 376,
    ["Meltano project definition"] = 375,
    ["Mergify Configuration"] = 405,
    ["MetricsHub Configuration"] = 377,
    ["MetricsHub Connector Configuration"] = 378,
    ["Micro Editor Syntax"] = 802,
    ["Microsoft Band Web Tile"] = 379,
    ["Minecraft Custom Main Menu Mod"] = 819,
    ["Minecraft Data Pack Advancement"] = 381,
    ["Minecraft Data Pack Biome"] = 382,
    ["Minecraft Data Pack Configured Carver"] = 383,
    ["Minecraft Data Pack Damage Type"] = 384,
    ["Minecraft Data Pack Dimension"] = 386,
    ["Minecraft Data Pack Dimension Type"] = 385,
    ["Minecraft Data Pack Item Modifier"] = 387,
    ["Minecraft Data Pack Loot Table"] = 388,
    ["Minecraft Data Pack Metadata"] = 389,
    ["Minecraft Data Pack Predicate"] = 390,
    ["Minecraft Data Pack Recipe"] = 391,
    ["Minecraft Data Pack Tag"] = 392,
    ["Minecraft Data Pack Template Pool"] = 393,
    ["Minecraft Data Pack Trim Material"] = 398,
    ["Minecraft Data Pack Trim Pattern"] = 399,
    ["Minecraft Resource Pack Lang"] = 394,
    ["Minecraft Resource Pack Particle"] = 395,
    ["Minecraft Resource Pack Texture Mcmeta"] = 397,
    ["Minecraft Resourcepack Sounds"] = 396,
    ["MkDocs Configuration 1.0"] = 400,
    ["Monade CLI Stack Configuration"] = 408,
    ["MongoDB Atlas Search Index Definition"] = 768,
    ["Monika Configuration"] = 766,
    ["Monoweave Configuration"] = 403,
    ["Motif config"] = 666,
    ["NOX Framework (Service)"] = 420,
    ["Netin Diagnostic System Template"] = 726,
    ["Netlify config"] = 411,
    ["Network-as-Code Data Model"] = 412,
    ["Nightwatch.js"] = 413,
    ["Nuitka.yaml"] = 832,
    ["ONe's changelog entry"] = 436,
    ["ONe's service descriptor"] = 435,
    ["OSS Review Toolkit configuration"] = 443,
    ["OSS Review Toolkit curation"] = 444,
    ["OSS Review Toolkit package configuration"] = 445,
    ["OSS Review Toolkit repository configuration"] = 446,
    ["OSS Review Toolkit resolutions"] = 447,
    Opctl = 669,
    ["OpenRewrite Resource"] = 438,
    ["OpenUtau character yaml"] = 432,
    ["OpenUtau ustx"] = 433,
    ["OpenWeather Current Weather API"] = 707,
    ["OpenWeather Road Risk API"] = 706,
    ["Ory Hydra configuration"] = 309,
    ["Ory Keto configuration"] = 350,
    ["Ory Kratos configuration"] = 442,
    ["Ory Oathkeeper configuration"] = 427,
    ["Outblocks App configuration"] = 440,
    ["Outblocks database table"] = 441,
    ["Outblocks project configuration"] = 439,
    PDM = 453,
    Packer = 450,
    Pantsbuild = 788,
    ["Paper paper-plugin.yml"] = 451,
    ["Pipeline component"] = 718,
    ["PocketMine plugin.yml"] = 458,
    ["Postman collection"] = 463,
    ["Problem object RFC9457"] = 816,
    ["Problem package generators"] = 471,
    Pterodactyl = 763,
    ["Pull Request Labeler"] = 486,
    Pulumi = 492,
    PyProject = 493,
    Pyright = 494,
    Qgoda = 495,
    Qodana = 736,
    ["Quali Torque Blueprint Spec 2"] = 761,
    ["QueryFirst config file"] = 784,
    ["RKE Cluster Configuration JSON"] = 715,
    ["RKE Cluster Configuration YAML"] = 714,
    ["Rancher Fleet"] = 489,
    ["Rattler-build"] = 496,
    Ray = 681,
    ["Read the Docs"] = 491,
    ["Red-DiscordBot Cog"] = 497,
    ["Red-DiscordBot Cog Repo"] = 498,
    ["Red-DiscordBot Trivia"] = 499,
    ["Render Blueprints"] = 713,
    RenderCV = 509,
    Renovate = 508,
    ["Replit config"] = 503,
    RoadRunner = 510,
    ["Rudder techniques"] = 822,
    Ruff = 505,
    ["Rust Project"] = 506,
    ["Rust toolchain"] = 513,
    ["SDMX data message"] = 538,
    ["SDMX metadata message"] = 537,
    ["SDMX structure message"] = 536,
    ["SIL Kit Participant Configuration"] = 548,
    ["SIL Kit Registry Configuration"] = 549,
    SWADL = 574,
    ["Safebox Config"] = 774,
    ["Sapphire CLI Config"] = 516,
    ["SauceCTL Configuration"] = 723,
    ["Schema Catalog"] = 530,
    ["Scoop manifest"] = 535,
    ["Semantic Data Fabric (SDF) file"] = 539,
    ["Semgrep Rule"] = 541,
    ["Serenity Code Generator (Sergen)"] = 542,
    ["Serverless Framework Configuration"] = 730,
    ["Serverless Workflow"] = 732,
    ["Settings.paf"] = 544,
    ["Shopware 6 Configuration"] = 733,
    ["Shopware CLI Extension Store Configuration"] = 734,
    ["Shopware CLI Project Store Configuration"] = 735,
    Sigma = 546,
    ["Sigrid scope configuration file"] = 547,
    ["SkyPilot Task JSON"] = 823,
    ["Slack app manifest"] = 551,
    Solidarity = 554,
    ["Solution filters"] = 555,
    ["Source Maps v3"] = 556,
    Sourcery = 557,
    SpecIF = 558,
    ["Sponge Mixin configuration"] = 559,
    StackBlitz = 564,
    ["StackHawk Scanner Configuration"] = 729,
    Stale = 565,
    ["Starlake Data Pipeline"] = 704,
    Starship = 566,
    ["Statamic Blueprint"] = 567,
    ["Stella configuration file"] = 568,
    ["StrmPrivacy Data Connector"] = 778,
    ["StrmPrivacy Data Contract"] = 779,
    ["StrmPrivacy SimpleSchema"] = 776,
    ["StrmPrivacy Stream"] = 777,
    ["StrmPrivacy batch job configuration file"] = 775,
    ["Stryker Mutator"] = 571,
    ["StyleCop Analyzers Configuration"] = 572,
    ["Stylelint (.stylelintrc)"] = 573,
    ["Sublime Syntax"] = 780,
    ["Subsquid squid manifest"] = 825,
    ["Swagger API 2.0"] = 575,
    TSON = 601,
    TSTyche = 602,
    Talhelper = 577,
    ["Talisman configuration"] = 578,
    ["Taskfile config"] = 709,
    Taurus = 579,
    ["TestEnvironment.json"] = 588,
    ["TextMate Grammar"] = 587,
    ["Tier.run pricing.json"] = 582,
    Tikibase = 583,
    ["Traefik v2"] = 591,
    ["Traefik v2 File Provider"] = 592,
    ["Travis CI (.travis.yml)"] = 590,
    TunnelHub = 815,
    Turborepo = 589,
    Tye = 737,
    ["UET BuildConfig.json"] = 785,
    ["UI5 Manifest"] = 611,
    ["UNCORS configuration"] = 615,
    ["UTAM Page Object"] = 614,
    ["Ubuntu Server Autoinstall"] = 609,
    ["Uniswap Token List"] = 692,
    ["Unreal Engine Uplugin"] = 786,
    ["Unreal Engine Uproject"] = 787,
    ["Updatecli Compose"] = 745,
    ["Updatecli Policy Manifest"] = 746,
    ["Updatecli Policy Metadata"] = 747,
    Uplift = 783,
    ["User Journey Map"] = 712,
    V2Ray = 751,
    ["VSCode Code Snippets"] = 164,
    ["VSIX CLI publishing"] = 629,
    ["Vela Pipeline Configuration"] = 618,
    Vercel = 163,
    Visivo = 813,
    ["Web App Manifest"] = 636,
    ["Web types"] = 639,
    WebExtensions = 635,
    ["Webman package recipe"] = 757,
    ["Windows Package Manager Installer Manifest"] = 689,
    ["Windows Package Manager Locale Manifest"] = 690,
    ["Windows Package Manager Singleton Manifest"] = 688,
    ["Woodpecker pipeline config"] = 725,
    ["Wrangler CLI"] = 640,
    ["Xstate Machine"] = 743,
    ["Yarn Config (.yarnrc.yml)"] = 702,
    ["Yippee-Ki-JSON configuration YML"] = 694,
    ["aerleon.yml"] = 6,
    ["angular.json"] = 14,
    apko = 817,
    ...
    ["behat.yml"] = 88,
    ["bigquery-table"] = 80,
    ["bioimageio resource description"] = 833,
    ...
    ["chisel-slices.json"] = 181,
    ["chrome-extension-locales-messages.json"] = 171,
    ["chutzpah.json"] = 172,
    cibuildwheel = 113,
    ["clang-format (.clang-format)"] = 749,
    clangd = 151,
    clib = 152,
    ["cloud-init: cloud-config userdata"] = 154,
    ["cloud-sdk-pipeline-configuration"] = 174,
    ["cloudbuild.json"] = 175,
    cloudify = 153,
    codemagic = 155,
    ["coffeelint.json"] = 183,
    ["commands.json"] = 167,
    ["commitlint (.commitlintrc)"] = 691,
    ["compile_commands.json"] = 166,
    ["compilerconfig.json"] = 165,
    ["completely.yml"] = 791,
    ["component-detection-manifest.json"] = 186,
    ["component.json"] = 185,
    ["composer.json"] = 184,
    ["conda-forge"] = 115,
    ["config.yaml"] = 490,
    ["contentmanifest.json"] = 173,
    ["contribute.json"] = 187,
    ["cosmos.config.json"] = 169,
    ["crowdin.yml"] = 188,
    ["custom-elements.json"] = 805,
    ["cypress.json"] = 192,
    ["datalogic-scan2deploy-android"] = 201,
    ["datalogic-scan2deploy-ce"] = 202,
    ["dbt Project"] = 125,
    ["ddev-global"] = 203,
    ["ddev-project"] = 204,
    ["debugsettings.json"] = 205,
    ["dependabot-v2.json"] = 208,
    ["dependabot.json"] = 207,
    ["deployed-cli"] = 742,
    ["devcontainer.json"] = 157,
    devinit = 696,
    ["devspace.yaml"] = 765,
    djlint = 697,
    ["docker sequencer"] = 213,
    ["docker-compose.yml"] = 695,
    ["dockerd.json"] = 212,
    ["dotnet Release Index manifest"] = 223,
    ["dotnet-tools.json"] = 224,
    ["dotnetcli.host.json"] = 225,
    ["dprint.json"] = 226,
    ["drone.json"] = 227,
    ["dss-2.0.0.json"] = 229,
    ["dstack configuration"] = 230,
    ["dvc.yaml"] = 231,
    ["ecosystem.json"] = 236,
    eksctl = 237,
    ["electron-builder configuration file"] = 244,
    ["epr-manifest.json"] = 242,
    ["evcc.yaml"] = 245,
    ["ezd task runner"] = 247,
    ["fabric.mod.json"] = 250,
    ["first-timers-bot"] = 256,
    ...
    ["gitlab-ci"] = 282,
    ["global.json"] = 284,
    ["go-feature-flag Flag Configuration"] = 287,
    ["haxelib.json"] = 302,
    helmfile = 684,
    helmwave = 685,
    ["host-meta.json"] = 307,
    ...
    ["ide.host.json"] = 312,
    ["ifstate.conf"] = 313,
    ["imageoptimizer.json"] = 314,
    ["importmap.json"] = 317,
    ["ioBroker Configuration"] = 318,
    ["ioBroker JSON UI"] = 319,
    ["ioBroker Package manifest"] = 320,
    ["ize.toml"] = 782,
    ["jsconfig.json"] = 343,
    ["jscpd Configuration"] = 762,
    jsdoc = 680,
    ["k3d.yaml"] = 344,
    ["k9s plugin.yml"] = 346,
    ["kontinuous-config.yaml"] = 352,
    ["kontinuous-values.yaml"] = 351,
    ["kustomization.yaml"] = 353,
    ["label-commenter-config.yml"] = 354,
    ["latexindent configuration"] = 62,
    ["launchsettings.json"] = 355,
    lazydocker = 804,
    lazygit = 803,
    ["lego.json"] = 357,
    ["lerna.json"] = 358,
    ["lgtm.yml"] = 359,
    ["liblab.config.json"] = 360,
    ["libman.json"] = 361,
    ["license-report-config.json"] = 362,
    ["linkinator.config.json"] = 364,
    ["lint-staged (.lintstagedrc)"] = 660,
    ["local.settings.json"] = 369,
    ["localazy.json"] = 370,
    ["lotus.yaml"] = 368,
    ["lsdlschema.json"] = 371,
    ["markdown-link-check"] = 721,
    mboats = 728,
    ["micro-settings.json"] = 797,
    ["mimetypes.json"] = 380,
    ["mirrord config"] = 661,
    mise = 662,
    ["mise-settings"] = 663,
    ...
    ["mtad.yaml"] = 665,
    ["mycode.json"] = 409,
    ["napari plugin manifest"] = 410,
    neoload = 675,
    ["nest-cli"] = 416,
    ["ninjs (News in JSON) 1.3"] = 415,
    ["ninjs (News in JSON) 2.0"] = 414,
    ["nixd configuration"] = 821,
    ["nlu.json"] = 417,
    ["nodemon.json"] = 419,
    ["noodl config"] = 727,
    now = 671,
    ...
    ["nswag.json"] = 425,
    ntangle = 426,
    ["nuclei-template.yaml"] = 423,
    ["nuget-project.json"] = 424,
    ["ocelot.json"] = 428,
    ["omnisharp.json"] = 429,
    ["openapi.json"] = 430,
    ["openfin.json"] = 437,
    ...
    ["ops.yaml"] = 434,
    ["package.json"] = 448,
    ["package.manifest"] = 449,
    ["partial-black.json"] = 89,
    ["pathfinder.yml"] = 452,
    ["pattern.json"] = 455,
    ["petstore-v1.0"] = 772,
    pgap_yaml_input_reader = 454,
    ["pixi.toml"] = 456,
    ["plagiarize-me.yaml"] = 460,
    ["plagiarize.yaml"] = 459,
    ["portman.json"] = 461,
    ["prettierrc.json"] = 469,
    ["prisma.yml"] = 470,
    ["project-1.0.0-beta3.json"] = 473,
    ["project-1.0.0-beta4.json"] = 474,
    ["project-1.0.0-beta5.json"] = 475,
    ["project-1.0.0-beta6.json"] = 476,
    ["project-1.0.0-beta8.json"] = 477,
    ["project-1.0.0-rc1.json"] = 478,
    ["project-1.0.0-rc2.json"] = 479,
    ["project.json"] = 472,
    ["prometheus.json"] = 480,
    ["prometheus.rules.json"] = 481,
    ["prometheus.rules.test.json"] = 482,
    ["proxies.json"] = 483,
    ["publiccode.yml"] = 484,
    ["pubspec.yaml"] = 485,
    ["pyrseas-0.8.json"] = 488,
    ["quilt.mod.json"] = 798,
    ["release drafter"] = 676,
    ["release-plz.toml"] = 501,
    ["rivet.yaml"] = 820,
    rockcraft = 511,
    rustfmt = 512,
    samt = 514,
    samtrc = 515,
    ["sarif-1.0.0.json"] = 517,
    ["sarif-2.0.0.json"] = 518,
    ["sarif-2.1.0"] = 528,
    ["sarif-2.1.0-rtm.2"] = 519,
    ["sarif-2.1.0-rtm.3"] = 521,
    ["sarif-2.1.0-rtm.4"] = 523,
    ["sarif-2.1.0-rtm.5"] = 525,
    ["sarif-2.1.0-rtm.6"] = 526,
    ["sarif-external-property-file-2.1.0"] = 529,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 520,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 522,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 524,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 527,
    ["schema.org - Action"] = 531,
    ["schema.org - ContactPoint"] = 532,
    ["schema.org - Place"] = 533,
    ["schema.org - Thing"] = 534,
    ["secrethub.yml"] = 800,
    ["semantic-release"] = 540,
    ["servicehub.config.json"] = 650,
    ["servicehub.service.json"] = 649,
    ["settings.job"] = 543,
    ["sfdx-hardis configuration"] = 545,
    ["shard.yml"] = 836,
    ["size-limit configuration"] = 550,
    ["skaffold.yaml"] = 719,
    ["skyuxconfig.json"] = 552,
    snapcraft = 553,
    ["sqlc configuration"] = 561,
    ["stripe-app-local.json"] = 570,
    ["stripe-app.json"] = 569,
    swcrc = 705,
    ["task.json"] = 576,
    taskcat = 672,
    ["template.json"] = 580,
    ["templatsources.json"] = 581,
    ["theme.json"] = 584,
    ["tizen_workspace.json"] = 585,
    tldr = 586,
    tmuxinator = 658,
    ["transcend.yml"] = 593,
    ["tree-sitter grammar.json"] = 292,
    ["trime.yaml"] = 594,
    ["trunk.yaml"] = 595,
    ["ts-force-config.json"] = 599,
    ["tsconfig.json"] = 596,
    ["tsd.json"] = 597,
    ["tsdrc.json"] = 598,
    ["tslint.json"] = 600,
    ...
    ["typingsrc.json"] = 608,
    ["typo3.json"] = 606,
    ["ui5-workspace.yaml"] = 613,
    ["ui5.yaml"] = 612,
    unist = 738,
    ["up.json"] = 610,
    v8r = 633,
    ["vcpkg configuration file"] = 162,
    ["vcpkg manifest file"] = 161,
    ["vega-lite.json"] = 617,
    ["vega.json"] = 616,
    ["venvironment-basic.yaml"] = 620,
    ["venvironment.yaml"] = 619,
    ["version.json"] = 621,
    ["vim-addon-info"] = 623,
    ["vs-2017.3.host.json"] = 625,
    ["vs-nesting.json"] = 626,
    ["vsls.json"] = 624,
    ["vss-extension.json"] = 630,
    ["vtesttree.yaml"] = 631,
    ["vtestunit.yaml"] = 632,
    ["warp-keysets.json"] = 806,
    ["warp-themes.json"] = 807,
    ["warp-workflows.json"] = 808,
    ["webhint.io"] = 758,
    ["webjobpublishsettings.json"] = 638,
    ["webjobs-list.json"] = 637,
    ["xs-app.json"] = 668,
    ["xunit.runner.json"] = 648,
    yamllint = 693,
    zuul = 677,
    ["Žinoma"] = 687
  },
