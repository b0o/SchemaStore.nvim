...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 14,
    AIConfig = 15,
    ["AMX Muse Program Descriptor"] = 985,
    ["API Builder"] = 805,
    ["AVA Configuration"] = 865,
    ...
    ["Adobe UXP Manifest"] = 925,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Alacritty Configuration"] = 837,
    ["All Contributors configuration file"] = 890,
    ...
    ["Application list for a WinUtil"] = 968,
    ArchitectFX = 972,
    ["Argo Events"] = 29,
    ["Argo Workflows"] = 30,
    AssemblyScript = 33,
    ...
    ["Azure Pipelines"] = 66,
    ["Azure Static Web Apps CLI configuration file"] = 665,
    ["Azure Static Web Apps configuration file"] = 664,
    ["BOSH Deploy Config"] = 90,
    ["BX CI"] = 108,
    ["Bashly (bashly.yml)"] = 894,
    ["Bashly Settings (bashly-settings.yml)"] = 895,
    ["Better Code Hub"] = 809,
    ["Better Scripts"] = 109,
    Bigconfig = 83,
    ["Biome Formatter Config"] = 53,
    ["Bitmovin Encoding Template"] = 978,
    BizTalkServerApplicationSchema = 778,
    Bleep = 110,
    ...
    ["Butane Config"] = 850,
    ["CGS Card Game Specification (cgs.json)"] = 930,
    ["CICS TS region tagging"] = 859,
    ["CICS TS resource import"] = 860,
    ["CICS TS resource model"] = 861,
    ["CICS TS resource overrides"] = 862,
    ["CMake Presets"] = 111,
    ["CNC Codes"] = 126,
    ["CRS WAF test file"] = 958,
    ["CRS WAF test platform overrides file"] = 959,
    ...
    ["Chamaleon environment"] = 982,
    ["Chamaleon properties"] = 983,
    ["Chamaleon template"] = 981,
    Changesets = 208,
    Cheatsheets = 847,
    ...
    CityJSON = 122,
    ["Clawject config"] = 131,
    ["Cloud Foundry Application Manifest"] = 941,
    ["Cloud Run Spec v1"] = 963,
    ...
    Concord = 957,
    ["Configu .cfgu files"] = 946,
    ["Configu .configu file"] = 947,
    Conjure = 125,
    ["Container Structure Test"] = 792,
    Containerlab = 817,
    ["Crowdsec collection config"] = 217,
    ["Crowdsec parser config"] = 218,
    ["Crowdsec scenario config"] = 219,
    ["CumulusCI Config"] = 130,
    ["Custom Machinery Machine"] = 931,
    ["Custom Machinery Recipe"] = 932,
    ...
    ["DonateCaseBetterCasino menu"] = 986,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 902,
    ["EAS config"] = 283,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 891,
    ["EasyVCR .NET"] = 284,
    ["Eidolon Resource"] = 973,
    ...
    ["Goreleaser Pro"] = 342,
    Goss = 343,
    ["Gradle Build Cache Node"] = 807,
    ["Gradle Enterprise"] = 806,
    ...
    Hadolint = 788,
    Hammerkit = 816,
    ["Hardware Sentry Configuration"] = 870,
    Hatch = 789,
    Hayson = 356,
    ...
    ["JFrog File Spec"] = 385,
    ["JFrog Pipelines YML DSL"] = 879,
    ["JMeter DSL cli config"] = 386,
    JReleaser = 388,
    ["JSON Document Transform"] = 396,
    ["JSON Feed"] = 397,
    ["JSON Resume"] = 603,
    ["JSON Schema Draft 2020-12"] = 758,
    ["JSON Schema Draft 4"] = 755,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 912,
    ["JSON Schema Draft 7"] = 756,
    ["JSON Schema Draft 7 (unofficial strict)"] = 913,
    ["JSON Schema Draft 8 (2019-09)"] = 757,
    ["JSON-API"] = 395,
    ["JSON-e templates"] = 814,
    ["JSON-stat 2.0"] = 751,
    JSONPatch = 399,
    ...
    ["Metadata for a Cinnamon spice"] = 966,
    ["Metatype Configuration"] = 447,
    ["MetricsHub Configuration"] = 448,
    ["MetricsHub Connector Configuration"] = 449,
    ["Micro Editor Syntax"] = 903,
    ["Microsoft Band Web Tile"] = 450,
    ["Microsoft RulesEngine workflow rules"] = 954,
    ["Microsoft RulesEngine workflow rules list"] = 955,
    ["Minecraft Custom Main Menu Mod"] = 920,
    ...
    ["MongoDB Atlas Search Index Definition"] = 874,
    ["Monika Configuration"] = 872,
    ["Monoweave Configuration"] = 475,
    ["Motif config"] = 771,
    ["NOX Framework (Service)"] = 492,
    ["Netin Diagnostic System Template"] = 832,
    ["Netlify config"] = 483,
    ...
    ["OpenUtau ustx"] = 510,
    ["OpenWeather Current Weather API"] = 813,
    ["OpenWeather Road Risk API"] = 812,
    ...
    ["Pipeline component"] = 824,
    ["Plex Prerolls"] = 546,
    ["PocketMine plugin.yml"] = 543,
    ["Postman collection"] = 550,
    ["Preset list for a WinUtil"] = 969,
    ["Problem object RFC9457"] = 917,
    ["Problem package generators"] = 559,
    Pterodactyl = 869,
    ["Pull Request Labeler"] = 574,
    Pulumi = 582,
    ["PyGTA Config"] = 578,
    PyProject = 583,
    Pyright = 584,
    Qgoda = 585,
    Qodana = 842,
    ["Qt Creator workspace file"] = 948,
    ["Quali Torque Blueprint Spec 2"] = 867,
    ["QueryFirst config file"] = 885,
    ["RKE Cluster Configuration JSON"] = 821,
    ["RKE Cluster Configuration YAML"] = 820,
    RadioHound = 577,
    ["Rancher Fleet"] = 579,
    ["Rattler-build"] = 586,
    Ray = 787,
    ["Read the Docs"] = 581,
    ["Red-DiscordBot Cog"] = 593,
    ["Red-DiscordBot Cog Repo"] = 594,
    ["Red-DiscordBot Trivia"] = 595,
    ["Render Blueprints"] = 819,
    RenderCV = 605,
    Renovate = 604,
    ["Replit config"] = 599,
    RoadRunner = 607,
    ["Rudder techniques"] = 923,
    Ruff = 601,
    ["Rust Project"] = 602,
    ["Rust toolchain"] = 611,
    ["SDMX data message"] = 636,
    ["SDMX metadata message"] = 635,
    ["SDMX structure message"] = 634,
    ["SIL Kit Participant Configuration"] = 646,
    ["SIL Kit Registry Configuration"] = 647,
    SWADL = 676,
    ["Safebox Config"] = 880,
    ["Sapphire CLI Config"] = 614,
    ["SauceCTL Configuration"] = 829,
    ["Schema Catalog"] = 628,
    ["Scoop manifest"] = 633,
    ["Semantic Data Fabric (SDF) file"] = 637,
    ["Semgrep Rule"] = 639,
    ["Serenity Code Generator (Sergen)"] = 640,
    ["Serverless Framework Configuration"] = 836,
    ["Serverless Workflow"] = 838,
    ["Settings for a Cinnamon spice"] = 965,
    ["Settings.paf"] = 642,
    ["Shopware 6 Configuration"] = 839,
    ["Shopware CLI Extension Store Configuration"] = 840,
    ["Shopware CLI Project Store Configuration"] = 841,
    ["Sigma Detection Rule"] = 644,
    ["Sigrid scope configuration file"] = 645,
    ["SkyPilot Task JSON"] = 924,
    ["Slack app manifest"] = 649,
    Solidarity = 652,
    ["Solution filters"] = 653,
    ["Source Maps v3"] = 654,
    Sourcery = 655,
    ["Speakeasy Generation Config File"] = 659,
    ["Speakeasy Lint Configuration File"] = 656,
    ["Speakeasy Test Generation Configuration File"] = 657,
    ["Speakeasy Workflow File"] = 658,
    SpecIF = 660,
    ["Sponge Mixin configuration"] = 661,
    StackBlitz = 666,
    ["StackHawk Scanner Configuration"] = 835,
    Stale = 667,
    ["Starlake Data Pipeline"] = 810,
    Starship = 668,
    ["Statamic Blueprint"] = 669,
    ["Stella configuration file"] = 670,
    ["Stryker Mutator"] = 673,
    ["StyleCop Analyzers Configuration"] = 674,
    ["Stylelint (.stylelintrc)"] = 675,
    ["Sublime Syntax"] = 881,
    ["Subsquid squid manifest"] = 926,
    ["Swagger API 2.0"] = 677,
    ["Synadia Connect Component"] = 678,
    TSON = 709,
    TSTyche = 710,
    ["Tab data for a LinUtil"] = 971,
    ["Tab list for a LinUtil"] = 970,
    Talhelper = 680,
    ["Talisman configuration"] = 681,
    ["Taskfile config"] = 815,
    Taurus = 682,
    Tauticord = 683,
    ["TestEnvironment.json"] = 692,
    ["TextMate Grammar"] = 691,
    ["Tier.run pricing.json"] = 686,
    Tikibase = 687,
    ["Traefik v2"] = 695,
    ["Traefik v2 File Provider"] = 696,
    ["Traefik v3"] = 697,
    ["Traefik v3 File Provider"] = 698,
    ["Travis CI (.travis.yml)"] = 694,
    ["TrueScript for *.tscript files"] = 701,
    ["Tugboat QA config.yml"] = 992,
    TunnelHub = 916,
    Turborepo = 693,
    Tycho = 961,
    Tye = 843,
    ["UET BuildConfig.json"] = 886,
    ["UI5 Manifest"] = 719,
    ["UNCORS configuration"] = 723,
    ["UTAM Page Object"] = 722,
    ["Ubuntu Server Autoinstall"] = 717,
    ["Uniswap Token List"] = 798,
    ["Unreal Engine Uplugin"] = 887,
    ["Unreal Engine Uproject"] = 888,
    ["Updatecli Compose"] = 851,
    ["Updatecli Policy Manifest"] = 852,
    ["Updatecli Policy Metadata"] = 853,
    Uplift = 884,
    ["User Journey Map"] = 818,
    V2Ray = 857,
    ["VSCode Code Snippets"] = 183,
    ["VSIX CLI publishing"] = 740,
    ["Vela Pipeline Configuration"] = 727,
    Vercel = 182,
    ["Version Bumper config"] = 730,
    Visivo = 914,
    ["Waku Config"] = 974,
    ["Web App Manifest"] = 746,
    ["Web types"] = 749,
    WebExtensions = 745,
    ["Webman package recipe"] = 863,
    ["Windows Package Manager Installer Manifest"] = 795,
    ["Windows Package Manager Locale Manifest"] = 796,
    ["Windows Package Manager Singleton Manifest"] = 794,
    ["WireMock stub mapping"] = 977,
    ["Woodpecker pipeline config"] = 831,
    ["Wrangler CLI"] = 750,
    ["Xstate Machine"] = 849,
    ["Yandex Workflow Language"] = 967,
    ["Yarn Config (.yarnrc.yml)"] = 808,
    ["Yippee-Ki-JSON configuration YML"] = 800,
    ["YouTrack App"] = 964,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 918,
    ...
    ["behat.yml"] = 92,
    ["bigquery-table"] = 82,
    ["bioimageio resource description"] = 934,
    ...
    ["crowdin.yml"] = 216,
    ["ctfd-setup configuration file"] = 984,
    ["custom-elements.json"] = 906,
    ["cypress.json"] = 220,
    ...
    ["gematik health care insurance list"] = 990,
    ["gematik health care patient list"] = 987,
    ["gematik health care provider institution list"] = 989,
    ["gematik health care provider list"] = 988,
    ["gematik tiger test environment configuration"] = 991,
    ["gitlab-ci"] = 322,
    ["global.json"] = 337,
    ...
    ["lint-staged (.lintstagedrc)"] = 766,
    ["local.settings.json"] = 437,
    ["localazy.json"] = 438,
    ["lotus.yaml"] = 436,
    ["lsdlschema.json"] = 439,
    ["markdown-link-check"] = 827,
    mboats = 834,
    ["micro-settings.json"] = 898,
    ["mimetypes.json"] = 451,
    ["mirrord config"] = 767,
    mise = 768,
    ["mkdocs.yml"] = 471,
    ...
    ["plagiarize.yaml"] = 544,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 980,
    ["podbard.yaml"] = 547,
    ["portman.json"] = 548,
    ["prefect.toml"] = 556,
    ["prettierrc.json"] = 557,
    ...
    ["project.json"] = 560,
    ["prometheus.json"] = 568,
    ["prometheus.rules.json"] = 569,
    ["prometheus.rules.test.json"] = 570,
    ["proxies.json"] = 571,
    ["publiccode.yml"] = 572,
    ["pubspec.yaml"] = 573,
    ["pyrseas-0.8.json"] = 576,
    ["quilt.mod.json"] = 899,
    ["rc3 auth"] = 587,
    ["rc3 collection"] = 588,
    ["rc3 environment"] = 589,
    ...
    samt = 612,
    samtrc = 613,
    ["sarif-1.0.0.json"] = 615,
    ["sarif-2.0.0.json"] = 616,
    ["sarif-2.1.0"] = 626,
    ["sarif-2.1.0-rtm.2"] = 617,
    ["sarif-2.1.0-rtm.3"] = 619,
    ["sarif-2.1.0-rtm.4"] = 621,
    ["sarif-2.1.0-rtm.5"] = 623,
    ["sarif-2.1.0-rtm.6"] = 624,
    ["sarif-external-property-file-2.1.0"] = 627,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 618,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 620,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 622,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 625,
    ["schema.org - Action"] = 629,
    ["schema.org - ContactPoint"] = 630,
    ["schema.org - Place"] = 631,
    ["schema.org - Thing"] = 632,
    ["secrethub.yml"] = 901,
    ["semantic-release"] = 638,
    ["servicehub.config.json"] = 761,
    ["servicehub.service.json"] = 760,
    ["settings.job"] = 641,
    ["sfdx-hardis configuration"] = 643,
    ["shard.yml"] = 937,
    ["size-limit configuration"] = 648,
    ["skaffold.yaml"] = 825,
    ["skyuxconfig.json"] = 650,
    snapcraft = 651,
    ["spicepod.yaml"] = 956,
    ["sqlc configuration"] = 663,
    ["stripe-app-local.json"] = 672,
    ["stripe-app.json"] = 671,
    swcrc = 811,
    ["task.json"] = 679,
    taskcat = 777,
    ["template.json"] = 684,
    ["templatsources.json"] = 685,
    ["theme.json"] = 688,
    ["tizen_workspace.json"] = 689,
    tldr = 690,
    tmuxinator = 764,
    ["transcend.yml"] = 699,
    ...
    ["vega-lite.json"] = 726,
    ["vega.json"] = 725,
    ["venvironment-basic.yaml"] = 729,
    ["venvironment.yaml"] = 728,
    ["version.json"] = 731,
    ["vhwdebugger-binding.yaml"] = 733,
    ["vim-addon-info"] = 734,
    ["vs-2017.3.host.json"] = 736,
    ["vs-nesting.json"] = 737,
    ["vsls.json"] = 735,
    ["vss-extension.json"] = 741,
    ["vtesttree.yaml"] = 742,
    ["vtestunit.yaml"] = 743,
    ["warp-keysets.json"] = 907,
    ["warp-themes.json"] = 908,
    ["warp-workflows.json"] = 909,
    ["webhint.io"] = 864,
    ["webjobpublishsettings.json"] = 748,
    ["webjobs-list.json"] = 747,
    ["well-known-fursona"] = 944,
    ["xs-app.json"] = 773,
    ["xunit.runner.json"] = 759,
    yamllint = 799,
    ["zerops.io import file"] = 953,
    ["zerops.yml"] = 952,
    zuul = 783,
    ["Žinoma"] = 793
  },
