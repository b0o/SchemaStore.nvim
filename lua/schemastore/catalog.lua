...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 749,
    [".nodehawkrc"] = 476,
    [".npmpackagejsonlintrc"] = 480,
    [".omletrc"] = 919,
    [".phrase.yml"] = 538,
    [".phraseapp.yml"] = 539,
    [".pmbot.yml"] = 527,
    [".postcssrc"] = 533,
    [".powerpages-web-template-manifest"] = 535,
    [".pre-commit-config.yml"] = 536,
    [".pre-commit-hooks.yml"] = 537,
    [".putout.json"] = 559,
    [".rehyperc"] = 578,
    [".remarkrc"] = 580,
    [".sprite files"] = 642,
    ...
    ["A micro editor config"] = 431,
    ABCInventoryModuleData = 13,
    ABCSupplyPlan = 14,
    AIConfig = 15,
    ["API Builder"] = 781,
    ["AVA Configuration"] = 841,
    ...
    ["Adobe UXP Manifest"] = 901,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Alacritty Configuration"] = 813,
    ["All Contributors configuration file"] = 866,
    ...
    ["Application list for a WinUtil"] = 945,
    ArchitectFX = 949,
    ["Argo Events"] = 28,
    ["Argo Workflows"] = 29,
    AssemblyScript = 32,
    ...
    ["Azure Pipelines"] = 64,
    ["Azure Static Web Apps CLI configuration file"] = 645,
    ["Azure Static Web Apps configuration file"] = 644,
    ["BOSH Deploy Config"] = 88,
    ["BX CI"] = 105,
    ["Bashly (bashly.yml)"] = 870,
    ["Bashly Settings (bashly-settings.yml)"] = 871,
    ["Better Code Hub"] = 785,
    ["Better Scripts"] = 106,
    Bigconfig = 81,
    BizTalkServerApplicationSchema = 755,
    Bleep = 107,
    ...
    ["Butane Config"] = 826,
    ["CGS Custom Card Game (CardGameDef.json)"] = 906,
    ["CICS TS region tagging"] = 835,
    ["CICS TS resource import"] = 836,
    ["CICS TS resource model"] = 837,
    ["CICS TS resource overrides"] = 838,
    ["CMake Presets"] = 108,
    ["CNC Codes"] = 123,
    ["CRS WAF test file"] = 935,
    ["CRS WAF test platform overrides file"] = 936,
    ...
    CityJSON = 119,
    ["Clawject config"] = 128,
    ["Cloud Foundry Application Manifest"] = 918,
    ["Cloud Run Spec v1"] = 940,
    ...
    Concord = 934,
    ["Configu .cfgu files"] = 923,
    ["Configu .configu file"] = 924,
    Conjure = 122,
    ["Container Structure Test"] = 768,
    Containerlab = 793,
    ["Crowdsec collection config"] = 212,
    ["Crowdsec parser config"] = 213,
    ["Crowdsec scenario config"] = 214,
    ["CumulusCI Config"] = 127,
    ["Custom Machinery Machine"] = 907,
    ["Custom Machinery Recipe"] = 908,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 878,
    ["EAS config"] = 278,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 867,
    ["EasyVCR .NET"] = 279,
    ["Eidolon Resource"] = 950,
    ...
    ["Goreleaser Pro"] = 335,
    Goss = 336,
    ["Gradle Build Cache Node"] = 783,
    ["Gradle Enterprise"] = 782,
    ...
    Hadolint = 764,
    Hammerkit = 792,
    ["Hardware Sentry Configuration"] = 846,
    Hatch = 765,
    Hayson = 349,
    ...
    ["JFrog File Spec"] = 377,
    ["JFrog Pipelines YML DSL"] = 855,
    ["JMeter DSL cli config"] = 378,
    JReleaser = 380,
    ["JSON Document Transform"] = 388,
    ["JSON Feed"] = 389,
    ["JSON Resume"] = 585,
    ["JSON Schema Draft 2020-12"] = 735,
    ["JSON Schema Draft 4"] = 732,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 888,
    ["JSON Schema Draft 7"] = 733,
    ["JSON Schema Draft 7 (unofficial strict)"] = 889,
    ["JSON Schema Draft 8 (2019-09)"] = 734,
    ["JSON-API"] = 387,
    ["JSON-WF"] = 917,
    ["JSON-e templates"] = 790,
    ["JSON-stat 2.0"] = 728,
    JSONPatch = 391,
    ...
    ["Keycloak REST API"] = 858,
    ["Knative Functions - func.yaml"] = 297,
    ["KoDE/CI build.yaml"] = 851,
    ["Kong DBLess config"] = 852,
    KrakenD = 404,
    ...
    ["Language configuration"] = 927,
    Lefthook = 414,
    ["Liferay client-extension.yaml"] = 421,
    ["LinkML Metamodel"] = 423,
    Liquibase = 798,
    ["Liquibase Flow File"] = 799,
    ["Lively Properties"] = 424,
    ["Lobe AI Agent"] = 62,
    Loki = 63,
    ["MLOS Configs"] = 460,
    ["MS2Rescore Configuration"] = 463,
    ["Madness (madness.yml)"] = 869,
    ["MapEHR Mapping"] = 430,
    Markdownlint = 802,
    ["Mason Registry"] = 804,
    ["MegaLinter configuration"] = 432,
    ["MegaLinter descriptor"] = 433,
    Melange = 895,
    ["Meltano project definition"] = 434,
    ["Mergify Configuration"] = 464,
    ["Metadata for a Bazel module"] = 435,
    ["Metadata for a Cinnamon spice"] = 943,
    ["MetricsHub Configuration"] = 436,
    ["MetricsHub Connector Configuration"] = 437,
    ["Micro Editor Syntax"] = 879,
    ["Microsoft Band Web Tile"] = 438,
    ["Microsoft RulesEngine workflow rules"] = 931,
    ["Microsoft RulesEngine workflow rules list"] = 932,
    ["Minecraft Custom Main Menu Mod"] = 896,
    ["Minecraft Data Pack Advancement"] = 440,
    ["Minecraft Data Pack Biome"] = 441,
    ["Minecraft Data Pack Configured Carver"] = 442,
    ["Minecraft Data Pack Damage Type"] = 443,
    ["Minecraft Data Pack Dimension"] = 445,
    ["Minecraft Data Pack Dimension Type"] = 444,
    ["Minecraft Data Pack Item Modifier"] = 446,
    ["Minecraft Data Pack Loot Table"] = 447,
    ["Minecraft Data Pack Metadata"] = 448,
    ["Minecraft Data Pack Predicate"] = 449,
    ["Minecraft Data Pack Recipe"] = 450,
    ["Minecraft Data Pack Tag"] = 451,
    ["Minecraft Data Pack Template Pool"] = 452,
    ["Minecraft Data Pack Trim Material"] = 457,
    ["Minecraft Data Pack Trim Pattern"] = 458,
    ["Minecraft Resource Pack Lang"] = 453,
    ["Minecraft Resource Pack Particle"] = 454,
    ["Minecraft Resource Pack Texture Mcmeta"] = 456,
    ["Minecraft Resourcepack Sounds"] = 455,
    ["Monade CLI Stack Configuration"] = 467,
    ["MongoDB Atlas Search Index Definition"] = 850,
    ["Monika Configuration"] = 848,
    ["Monoweave Configuration"] = 462,
    ["Motif config"] = 748,
    ["NOX Framework (Service)"] = 479,
    ["Netin Diagnostic System Template"] = 808,
    ["Netlify config"] = 470,
    ["Network-as-Code Data Model"] = 471,
    ["Nightwatch.js"] = 472,
    ["Nuitka.yaml"] = 909,
    ["Nullstone config"] = 485,
    ["ONe's changelog entry"] = 498,
    ["ONe's service descriptor"] = 497,
    ["OSCAL Assessment Plan (AP)"] = 506,
    ["OSCAL Assessment Results (AR)"] = 507,
    ["OSCAL Catalog"] = 508,
    ["OSCAL Component Definition (CDef)"] = 509,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 510,
    ["OSCAL Profile"] = 511,
    ["OSCAL System Security Plan (SSP)"] = 512,
    ["OSS Review Toolkit configuration"] = 513,
    ["OSS Review Toolkit curation"] = 514,
    ["OSS Review Toolkit package configuration"] = 515,
    ["OSS Review Toolkit repository configuration"] = 516,
    ["OSS Review Toolkit resolutions"] = 517,
    ["October CMS columns"] = 489,
    ["October CMS fields"] = 490,
    Opctl = 751,
    ["Open Data Contract Standard (ODCS)"] = 501,
    ["OpenRewrite Resource"] = 500,
    ["OpenUtau character yaml"] = 494,
    ["OpenUtau ustx"] = 495,
    ["OpenWeather Current Weather API"] = 789,
    ["OpenWeather Road Risk API"] = 788,
    ["Ory Hydra configuration"] = 356,
    ["Ory Keto configuration"] = 407,
    ["Ory Kratos configuration"] = 505,
    ["Ory Oathkeeper configuration"] = 487,
    ["Outblocks App configuration"] = 503,
    ["Outblocks database table"] = 504,
    ["Outblocks project configuration"] = 502,
    PDM = 523,
    Packer = 520,
    Pantsbuild = 865,
    ["Paper paper-plugin.yml"] = 521,
    ["Pipeline component"] = 800,
    ["PocketMine plugin.yml"] = 528,
    ["Postman collection"] = 534,
    ["Preset list for a WinUtil"] = 946,
    ["Problem object RFC9457"] = 893,
    ["Problem package generators"] = 543,
    Pterodactyl = 845,
    ["Pull Request Labeler"] = 558,
    Pulumi = 564,
    PyProject = 565,
    Pyright = 566,
    Qgoda = 567,
    Qodana = 818,
    ["Qt Creator workspace file"] = 925,
    ["Quali Torque Blueprint Spec 2"] = 843,
    ["QueryFirst config file"] = 861,
    ["RKE Cluster Configuration JSON"] = 797,
    ["RKE Cluster Configuration YAML"] = 796,
    ["Rancher Fleet"] = 561,
    ["Rattler-build"] = 568,
    Ray = 763,
    ["Read the Docs"] = 563,
    ["Red-DiscordBot Cog"] = 575,
    ["Red-DiscordBot Cog Repo"] = 576,
    ["Red-DiscordBot Trivia"] = 577,
    ["Render Blueprints"] = 795,
    RenderCV = 587,
    Renovate = 586,
    ["Replit config"] = 581,
    RoadRunner = 588,
    ["Rudder techniques"] = 899,
    Ruff = 583,
    ["Rust Project"] = 584,
    ["Rust toolchain"] = 592,
    ["SDMX data message"] = 617,
    ["SDMX metadata message"] = 616,
    ["SDMX structure message"] = 615,
    ["SIL Kit Participant Configuration"] = 627,
    ["SIL Kit Registry Configuration"] = 628,
    SWADL = 656,
    ["Safebox Config"] = 856,
    ["Sapphire CLI Config"] = 595,
    ["SauceCTL Configuration"] = 805,
    ["Schema Catalog"] = 609,
    ["Scoop manifest"] = 614,
    ["Semantic Data Fabric (SDF) file"] = 618,
    ["Semgrep Rule"] = 620,
    ["Serenity Code Generator (Sergen)"] = 621,
    ["Serverless Framework Configuration"] = 812,
    ["Serverless Workflow"] = 814,
    ["Settings for a Cinnamon spice"] = 942,
    ["Settings.paf"] = 623,
    ["Shopware 6 Configuration"] = 815,
    ["Shopware CLI Extension Store Configuration"] = 816,
    ["Shopware CLI Project Store Configuration"] = 817,
    ["Sigma Detection Rule"] = 625,
    ["Sigrid scope configuration file"] = 626,
    ["SkyPilot Task JSON"] = 900,
    ["Slack app manifest"] = 630,
    Solidarity = 633,
    ["Solution filters"] = 634,
    ["Source Maps v3"] = 635,
    Sourcery = 636,
    ["Speakeasy Lint Configuration File"] = 637,
    ["Speakeasy Test Generation Configuration File"] = 638,
    ["Speakeasy Workflow File"] = 639,
    SpecIF = 640,
    ["Sponge Mixin configuration"] = 641,
    StackBlitz = 646,
    ["StackHawk Scanner Configuration"] = 811,
    Stale = 647,
    ["Starlake Data Pipeline"] = 786,
    Starship = 648,
    ["Statamic Blueprint"] = 649,
    ["Stella configuration file"] = 650,
    ["Stryker Mutator"] = 653,
    ["StyleCop Analyzers Configuration"] = 654,
    ["Stylelint (.stylelintrc)"] = 655,
    ["Sublime Syntax"] = 857,
    ["Subsquid squid manifest"] = 902,
    ["Swagger API 2.0"] = 657,
    TSON = 686,
    TSTyche = 687,
    ["Tab data for a LinUtil"] = 948,
    ["Tab list for a LinUtil"] = 947,
    Talhelper = 659,
    ["Talisman configuration"] = 660,
    ["Taskfile config"] = 791,
    Taurus = 661,
    Tauticord = 662,
    ["TestEnvironment.json"] = 671,
    ["TextMate Grammar"] = 670,
    ["Tier.run pricing.json"] = 665,
    Tikibase = 666,
    ["Traefik v2"] = 674,
    ["Traefik v2 File Provider"] = 675,
    ["Travis CI (.travis.yml)"] = 673,
    ["TrueScript for *.tscript files"] = 678,
    TunnelHub = 892,
    Turborepo = 672,
    Tycho = 938,
    Tye = 819,
    ["UET BuildConfig.json"] = 862,
    ["UI5 Manifest"] = 696,
    ["UNCORS configuration"] = 700,
    ["UTAM Page Object"] = 699,
    ["Ubuntu Server Autoinstall"] = 694,
    ["Uniswap Token List"] = 774,
    ["Unreal Engine Uplugin"] = 863,
    ["Unreal Engine Uproject"] = 864,
    ["Updatecli Compose"] = 827,
    ["Updatecli Policy Manifest"] = 828,
    ["Updatecli Policy Metadata"] = 829,
    Uplift = 860,
    ["User Journey Map"] = 794,
    V2Ray = 833,
    ["VSCode Code Snippets"] = 178,
    ["VSIX CLI publishing"] = 717,
    ["Vela Pipeline Configuration"] = 704,
    Vercel = 177,
    ["Version Bumper config"] = 707,
    Visivo = 890,
    ["Waku Config"] = 951,
    ["Web App Manifest"] = 723,
    ["Web types"] = 726,
    WebExtensions = 722,
    ["Webman package recipe"] = 839,
    ["Windows Package Manager Installer Manifest"] = 771,
    ["Windows Package Manager Locale Manifest"] = 772,
    ["Windows Package Manager Singleton Manifest"] = 770,
    ["WireMock stub mapping"] = 954,
    ["Woodpecker pipeline config"] = 807,
    ["Wrangler CLI"] = 727,
    ["Xstate Machine"] = 825,
    ["Yandex Workflow Language"] = 944,
    ["Yarn Config (.yarnrc.yml)"] = 784,
    ["Yippee-Ki-JSON configuration YML"] = 776,
    ["YouTrack App"] = 941,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 894,
    ...
    ["behat.yml"] = 90,
    ["bigquery-table"] = 80,
    ["bioimageio resource description"] = 910,
    ...
    ["lint-staged (.lintstagedrc)"] = 743,
    ["local.settings.json"] = 427,
    ["localazy.json"] = 428,
    ["lotus.yaml"] = 426,
    ["lsdlschema.json"] = 429,
    ["markdown-link-check"] = 803,
    mboats = 810,
    ["micro-settings.json"] = 874,
    ["mimetypes.json"] = 439,
    ["mirrord config"] = 744,
    mise = 745,
    ["mkdocs.yml"] = 459,
    ["monospace.yml"] = 461,
    ["moon.yml"] = 953,
    ["mprocs Configuration file"] = 926,
    ["mta.yaml"] = 746,
    ["mtad.yaml"] = 747,
    ["mycode.json"] = 468,
    ["napari plugin manifest"] = 469,
    neoload = 757,
    ["nest-cli"] = 474,
    ["ninjs (News in JSON)"] = 473,
    ["nixd configuration"] = 898,
    ["nlu.json"] = 475,
    ["nodemon.json"] = 477,
    ["noodl config"] = 809,
    ["notebook.mod.json"] = 478,
    now = 753,
    ["npm-badges"] = 481,
    ["nswag.json"] = 484,
    ntangle = 486,
    ["nuclei-template.yaml"] = 482,
    ["nuget-project.json"] = 483,
    ["ocelot.json"] = 488,
    ["omnisharp.json"] = 491,
    ["openapi.json"] = 492,
    ["openfin.json"] = 499,
    ...
    ["ops.yaml"] = 496,
    ["package.json"] = 518,
    ["package.manifest"] = 519,
    ["partial-black.json"] = 91,
    ["pathfinder.yml"] = 522,
    ["pattern.json"] = 525,
    ["petstore-v1.0"] = 854,
    pgap_yaml_input_reader = 524,
    ["pixi.toml"] = 526,
    ["plagiarize-me.yaml"] = 530,
    ["plagiarize.yaml"] = 529,
    ["podbard.yaml"] = 531,
    ["portman.json"] = 532,
    ["prefect.toml"] = 540,
    ["prettierrc.json"] = 541,
    ["prisma.yml"] = 542,
    ["project-1.0.0-beta3.json"] = 545,
    ["project-1.0.0-beta4.json"] = 546,
    ["project-1.0.0-beta5.json"] = 547,
    ["project-1.0.0-beta6.json"] = 548,
    ["project-1.0.0-beta8.json"] = 549,
    ["project-1.0.0-rc1.json"] = 550,
    ["project-1.0.0-rc2.json"] = 551,
    ["project.json"] = 544,
    ["prometheus.json"] = 552,
    ["prometheus.rules.json"] = 553,
    ["prometheus.rules.test.json"] = 554,
    ["proxies.json"] = 555,
    ["publiccode.yml"] = 556,
    ["pubspec.yaml"] = 557,
    ["pyrseas-0.8.json"] = 560,
    ["quilt.mod.json"] = 875,
    ["rc3 auth"] = 569,
    ["rc3 collection"] = 570,
    ["rc3 environment"] = 571,
    ...
    samt = 593,
    samtrc = 594,
    ["sarif-1.0.0.json"] = 596,
    ["sarif-2.0.0.json"] = 597,
    ["sarif-2.1.0"] = 607,
    ["sarif-2.1.0-rtm.2"] = 598,
    ["sarif-2.1.0-rtm.3"] = 600,
    ["sarif-2.1.0-rtm.4"] = 602,
    ["sarif-2.1.0-rtm.5"] = 604,
    ["sarif-2.1.0-rtm.6"] = 605,
    ["sarif-external-property-file-2.1.0"] = 608,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 599,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 601,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 603,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 606,
    ["schema.org - Action"] = 610,
    ["schema.org - ContactPoint"] = 611,
    ["schema.org - Place"] = 612,
    ["schema.org - Thing"] = 613,
    ["secrethub.yml"] = 877,
    ["semantic-release"] = 619,
    ["servicehub.config.json"] = 738,
    ["servicehub.service.json"] = 737,
    ["settings.job"] = 622,
    ["sfdx-hardis configuration"] = 624,
    ["shard.yml"] = 913,
    ["size-limit configuration"] = 629,
    ["skaffold.yaml"] = 801,
    ["skyuxconfig.json"] = 631,
    snapcraft = 632,
    ["spicepod.yaml"] = 933,
    ["sqlc configuration"] = 643,
    ["stripe-app-local.json"] = 652,
    ["stripe-app.json"] = 651,
    swcrc = 787,
    ["task.json"] = 658,
    taskcat = 754,
    ["template.json"] = 663,
    ["templatsources.json"] = 664,
    ["theme.json"] = 667,
    ["tizen_workspace.json"] = 668,
    tldr = 669,
    tmuxinator = 741,
    ["transcend.yml"] = 676,
    ...
    ["vega-lite.json"] = 703,
    ["vega.json"] = 702,
    ["venvironment-basic.yaml"] = 706,
    ["venvironment.yaml"] = 705,
    ["version.json"] = 708,
    ["vhwdebugger-binding.yaml"] = 710,
    ["vim-addon-info"] = 711,
    ["vs-2017.3.host.json"] = 713,
    ["vs-nesting.json"] = 714,
    ["vsls.json"] = 712,
    ["vss-extension.json"] = 718,
    ["vtesttree.yaml"] = 719,
    ["vtestunit.yaml"] = 720,
    ["warp-keysets.json"] = 883,
    ["warp-themes.json"] = 884,
    ["warp-workflows.json"] = 885,
    ["webhint.io"] = 840,
    ["webjobpublishsettings.json"] = 725,
    ["webjobs-list.json"] = 724,
    ["well-known-fursona"] = 921,
    ["xs-app.json"] = 750,
    ["xunit.runner.json"] = 736,
    yamllint = 775,
    ["zerops.io import file"] = 930,
    ["zerops.yml"] = 929,
    zuul = 759,
    ["Žinoma"] = 769
  },
