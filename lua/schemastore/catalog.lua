...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 986,
    [".nodehawkrc"] = 619,
    [".npmpackagejsonlintrc"] = 623,
    [".omletrc"] = 1165,
    [".phrase.yml"] = 700,
    [".phraseapp.yml"] = 701,
    [".pmbot.yml"] = 685,
    [".postcssrc"] = 694,
    [".powerpages-web-template-manifest"] = 696,
    [".pre-commit-config.yml"] = 697,
    [".pre-commit-hooks.yml"] = 698,
    [".putout.json"] = 734,
    [".rehyperc"] = 759,
    [".remarkrc"] = 763,
    [".sprite files"] = 859,
    ...
    ["@factorial/drupal-breakpoints-css"] = 19,
    ["A micro editor config"] = 562,
    ABCClinicalDemandForecast = 28,
    ABCInventoryModuleData = 27,
    ABCSupplyPlan = 29,
    ["ACP Attempts"] = 30,
    ["ACP Cache File"] = 31,
    ["ACP Configuration File"] = 32,
    ["ACP Primer"] = 33,
    ["ACP Sync"] = 34,
    ["ACP Variables File"] = 35,
    AIConfig = 36,
    ["AMX Muse Program Descriptor"] = 1213,
    ["API Builder"] = 1021,
    ["AVA Configuration"] = 1084,
    ["AWS AppConfig Feature Flags-v1"] = 70,
    ["AWS CDK cdk.json"] = 271,
    ["AWS CloudFormation"] = 272,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 273,
    ["AWS Copilot Manifest"] = 1252,
    ["AWS SAM CLI Samconfig"] = 274,
    Acton = 1302,
    ["Adobe UXP Manifest"] = 1147,
    ["Aerleon Network & Service Definitions"] = 22,
    ["Aerleon Policy"] = 23,
    ["Agent Permission Policy"] = 1292,
    ["AgentCore CLI"] = 1293,
    Aider = 1242,
    Air = 25,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1263,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1262,
    ["Airlock Microgateway"] = 37,
    ["Alacritty Configuration"] = 1056,
    ["AlgoVoi Compliance Receipt v1"] = 12,
    ["All Contributors configuration file"] = 1110,
    Anodizer = 448,
    ["Ansible Argument Specs"] = 432,
    ["Ansible Collection Galaxy"] = 439,
    ["Ansible Execution Environment"] = 429,
    ["Ansible Inventory"] = 438,
    ["Ansible Meta"] = 430,
    ["Ansible Meta Runtime"] = 431,
    ["Ansible Navigator Configuration"] = 441,
    ["Ansible Playbook"] = 436,
    ["Ansible Requirements"] = 433,
    ["Ansible Rulebook"] = 437,
    ["Ansible Tasks File"] = 435,
    ["Ansible Vars File"] = 434,
    ["Ansible-lint Configuration"] = 440,
    Any = 1175,
    ["AnyWork Automation Configuration"] = 18,
    ["Apollo Router"] = 1022,
    ["App config Spotify Backstage"] = 41,
    ["Applicant Profile Protocol"] = 15,
    ["Application Accelerator"] = 13,
    ["Application list for a WinUtil"] = 1192,
    ArchitectFX = 1197,
    ["Argo CD"] = 56,
    ["Argo Events"] = 57,
    ["Argo Workflows"] = 58,
    AssemblyScript = 61,
    AsyncAPI = 64,
    ["AsyncAPI Tool File"] = 65,
    ["Atmos Manifests"] = 66,
    ["Aurora Agile Meta-Framework"] = 67,
    AutoAPICase = 1120,
    ["Avro Avsc"] = 68,
    ["Awesome Repositories"] = 69,
    ["Azure Container App template for defining an immutable revision"] = 72,
    ["Azure DevOps extension manifest"] = 75,
    ["Azure Device Update for IoT Hub import manifest"] = 73,
    ["Azure Device Update for IoT Hub update manifest"] = 74,
    ["Azure IoT Edge deployment"] = 78,
    ["Azure IoT Edge deployment template"] = 79,
    ["Azure IoT EdgeAgent deployment"] = 76,
    ["Azure IoT EdgeHub deployment"] = 77,
    ["Azure IoT Operations Wasm Graph Config"] = 1261,
    ["Azure IoT Operations connector metadata"] = 1258,
    ["Azure Landing Zones Library archetype definition"] = 83,
    ["Azure Landing Zones Library archetype override"] = 84,
    ["Azure Landing Zones Library architecture definition"] = 82,
    ["Azure Landing Zones Library metadata"] = 80,
    ["Azure Landing Zones Library policy default values"] = 81,
    ["Azure Pipelines"] = 116,
    ["Azure Static Web Apps CLI configuration file"] = 863,
    ["Azure Static Web Apps configuration file"] = 862,
    BMML = 1280,
    ["BOSH CPI Config"] = 142,
    ["BOSH Deploy Config"] = 143,
    ["BX CI"] = 164,
    ["Bacon config"] = 6,
    ["Barba-CV"] = 85,
    ["Bashly (bashly.yml)"] = 1114,
    ["Bashly Settings (bashly-settings.yml)"] = 1115,
    Bento = 1279,
    ["Better Code Hub"] = 1026,
    ["Better Scripts"] = 165,
    Bigconfig = 135,
    ["Biome Formatter Config"] = 86,
    ["Bitmovin Encoding Template"] = 1206,
    BizTalkServerApplicationSchema = 993,
    Bleep = 166,
    ["Block Protocol Metadata"] = 163,
    ["Bluebricks blueprint config"] = 1285,
    ["Boyka Framework"] = 144,
    ["Bpod Finite-State Machine"] = 88,
    Briefcase = 999,
    ["Build Info"] = 154,
    Buildkite = 156,
    ["Bukkit plugin.yml"] = 155,
    ["BungeeCord plugin.yml"] = 161,
    ["Butane Config"] = 1069,
    C4InterFlow = 1221,
    ["CDK Environment Manager, concrete environment configuration"] = 1245,
    ["CDK Environment Manager, concrete environments definition"] = 1244,
    ["CDK Environment Manager, environment definition"] = 1243,
    ["CGS Card Game Specification (cgs.json)"] = 1152,
    ["CICS TS region tagging"] = 1078,
    ["CICS TS resource import"] = 1079,
    ["CICS TS resource model"] = 1080,
    ["CICS TS resource overrides"] = 1081,
    ["CMake Presets"] = 167,
    ["CNC Codes"] = 189,
    ["CRS WAF test file"] = 1182,
    ["CRS WAF test platform overrides file"] = 1183,
    ["CSS Comb (.csscomb.json)"] = 299,
    ["CSS Lint (.csslintrc)"] = 300,
    ["CSpell (cspell.json)"] = 298,
    ["CVE Record Format"] = 201,
    CWL = 1158,
    ["Cache Warmup config"] = 168,
    ["Caido Proxy Configuration"] = 1316,
    ...
    ["Cargo Make"] = 174,
    ["Cargo Manifest"] = 173,
    ["Catalog Info Backstage"] = 175,
    ["Chamaleon environment"] = 1210,
    ["Chamaleon properties"] = 1211,
    ["Chamaleon template"] = 1209,
    Changepacks = 1272,
    Changesets = 283,
    Changie = 176,
    Charmcraft = 177,
    Cheatsheets = 1066,
    ["ChordPro Configuration"] = 178,
    ["Chrome Extension"] = 264,
    ["Chromia Model"] = 179,
    ["Chromia Seeder Module Config"] = 181,
    ["Chromia Seeder Root Config"] = 180,
    ["Cinnamon Spice info.json"] = 96,
    ["CircleCI config.yml"] = 238,
    ["Citation File Format"] = 285,
    ["Citrus test case"] = 183,
    CityJSON = 184,
    ["Claude Code Keybindings"] = 196,
    ["Claude Code Plugin Manifest"] = 197,
    ["Claude Code Plugin Marketplace"] = 198,
    ["Claude Code Settings"] = 199,
    ["Clawject config"] = 195,
    ["Cloud Foundry Application Manifest"] = 1164,
    ["Cloud Run Spec v1"] = 1187,
    ["Cloud.gov Workshop Configuration"] = 97,
    ["CloudCannon Configuration"] = 102,
    ["CloudCannon Configuration (Collection Structures)"] = 111,
    ["CloudCannon Configuration (Collections)"] = 110,
    ["CloudCannon Configuration (Editables)"] = 109,
    ["CloudCannon Configuration (Inputs)"] = 104,
    ["CloudCannon Configuration (Snippets Definitions)"] = 108,
    ["CloudCannon Configuration (Snippets Imports)"] = 107,
    ["CloudCannon Configuration (Snippets)"] = 106,
    ["CloudCannon Configuration (Structure Value)"] = 105,
    ["CloudCannon Configuration (Structures)"] = 103,
    ["CloudEvents specification"] = 185,
    ["Code Climate"] = 239,
    CodeCV = 100,
    CodeRabbit = 99,
    ["CodeShip Pro services configuration files"] = 253,
    ["CodeShip Pro steps configuration files"] = 254,
    ["Codecov configuration files"] = 252,
    Codex = 247,
    ["Codex Hooks"] = 248,
    CodifyCLI = 101,
    Codux = 250,
    ["Cog config file"] = 190,
    ["Commandbox Box.json"] = 191,
    ["Commandbox Server.json"] = 192,
    ["Common Catalog Data"] = 262,
    ["Common Package Specification"] = 193,
    Concord = 1181,
    ["Configu .cfgu files"] = 1169,
    ["Configu .configu file"] = 1170,
    Conjure = 188,
    ["Container Structure Test"] = 1007,
    Containerlab = 1035,
    ["Contextive Glossary"] = 1237,
    Convex = 187,
    ["Crowdsec collection config"] = 293,
    ["Crowdsec parser config"] = 294,
    ["Crowdsec scenario config"] = 295,
    ["CumulusCI Config"] = 194,
    ["Cursor Agent Environment"] = 1290,
    ["Custom Machinery Machine"] = 1153,
    ["Custom Machinery Recipe"] = 1154,
    ["Cycle Stack File"] = 202,
    CycloneDX = 203,
    ["DWP Exchange - catalogue entry"] = 344,
    ["DWP Exchange - gateway"] = 342,
    ["DWP Exchange - meta"] = 343,
    ["Dart Build Config (dart-build.json)"] = 301,
    ["Dart Test Config (dart-test.json)"] = 302,
    ["DashLord Configuration"] = 303,
    ["Data Contract Specification"] = 304,
    ["Data Product Specification"] = 305,
    ["DataYoga Connections"] = 204,
    ["DataYoga Job"] = 205,
    ["Datadog Continuous Testing"] = 531,
    ["Datadog Service Definition"] = 532,
    ["Datadog Software Catalog"] = 533,
    ["Datahub Ingestion Recipe"] = 1085,
    ["Debian Upstream Metadata file"] = 212,
    ["Deck config"] = 213,
    ["Declarative Automation Bundles"] = 1131,
    ["DeepMatch deeplinks spec"] = 214,
    ["Dein Config"] = 215,
    ["Deno Config (deno.json)"] = 311,
    ["Dependency cruiser"] = 216,
    ["DeployStack Configuration"] = 217,
    ["Deployah Configuration"] = 1260,
    ["Deployer Recipe"] = 314,
    ["Deta Spacefile"] = 218,
    ["Detekt Config (detekt.yml)"] = 315,
    ["Devbox Config"] = 219,
    ["Devbox Plugin"] = 220,
    Devfile = 341,
    Devup = 1273,
    DipDup = 1184,
    ["Discord Webhook"] = 316,
    ["DocFx Config (docfx.json)"] = 321,
    ["Docker Desktop extension metadata"] = 318,
    ["Docs MCP Manifest"] = 322,
    Dofigen = 323,
    ["Dolittle Artifacts"] = 324,
    ["Dolittle Bounded Context Configuration"] = 325,
    ["Dolittle Event Horizons Configuration"] = 326,
    ["Dolittle Resources Configuration"] = 327,
    ["Dolittle Server Configuration"] = 328,
    ["Dolittle Tenant Map Configuration"] = 330,
    ["Dolittle Tenants Configuration"] = 329,
    ["Dolittle Topology"] = 331,
    ["DonateCaseBetterCasino menu"] = 1214,
    ["Drupal Breakpoints"] = 221,
    ["Drupal Config"] = 233,
    ["Drupal Info"] = 222,
    ["Drupal Layouts"] = 223,
    ["Drupal Libraries"] = 224,
    ["Drupal Links Action"] = 225,
    ["Drupal Links Contextual"] = 226,
    ["Drupal Links Menu"] = 227,
    ["Drupal Links Task"] = 228,
    ["Drupal Migration"] = 229,
    ["Drupal Permissions"] = 230,
    ["Drupal Recipe"] = 231,
    ["Drupal Routing"] = 232,
    ["Drupal Services"] = 234,
    ["Drush site aliases"] = 337,
    ["Dynamic Bash Aliases (.aliases)"] = 1122,
    ["EAS config"] = 382,
    ["ECA - Editor Code Assistant"] = 346,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1111,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1257,
    ["EasyVCR .NET"] = 384,
    ["Eidolon Resource"] = 1198,
    ["Elgato Stream Deck"] = 348,
    Elm = 1186,
    ["Embrace Config"] = 1097,
    Endurica = 1135,
    ["Enonic XP API descriptor"] = 351,
    ["Enonic XP Admin Extension descriptor"] = 352,
    ["Enonic XP Admin Tool descriptor"] = 353,
    ["Enonic XP Application descriptor"] = 354,
    ["Enonic XP CMS descriptor"] = 355,
    ["Enonic XP Content Type descriptor"] = 356,
    ["Enonic XP Form Fragment descriptor"] = 357,
    ["Enonic XP ID Provider descriptor"] = 358,
    ["Enonic XP Layout descriptor"] = 359,
    ["Enonic XP Macro descriptor"] = 360,
    ["Enonic XP Mixin descriptor"] = 361,
    ["Enonic XP Page descriptor"] = 362,
    ["Enonic XP Part descriptor"] = 363,
    ["Enonic XP Service descriptor"] = 364,
    ["Enonic XP Site descriptor"] = 365,
    ["Enonic XP Style descriptor"] = 366,
    ["Enonic XP Task descriptor"] = 367,
    ["Enonic XP Webapp descriptor"] = 368,
    ["Enterprise Contract Policy Spec"] = 349,
    ["Envelope Team Definition"] = 1301,
    ["Envilder Map File"] = 350,
    ["Erda Pipeline"] = 1160,
    ["Erda Runtime"] = 1161,
    ["Espanso config.yml"] = 1283,
    ["Espanso match.yml"] = 1282,
    Esquio = 370,
    ["Estuary Flow Catalog"] = 1075,
    ["Ethereum ERC1155"] = 1295,
    ["Ethereum ERC721"] = 1294,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 375,
    ["EveryVoice TTS Toolkit Data Configuration"] = 376,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 380,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 379,
    ["EveryVoice TTS Toolkit Text Configuration"] = 377,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 378,
    ["Evolving Resolutive Process notation"] = 1259,
    ["Expo SDK"] = 381,
    ["Expoot app config"] = 383,
    ["F-Droid Data metadata"] = 388,
    ["FasterCI Configuration"] = 117,
    ["Fence configuration"] = 118,
    FiQuS = 392,
    Firebase = 390,
    ["Flatpak Builder Manifest"] = 393,
    ["FlexGet Config"] = 394,
    ["Flow.json Configurations"] = 1157,
    ["Fossa configuration file"] = 401,
    ["Fossa's fossa-deps file"] = 402,
    ["Foundry VTT - Base package Manifest"] = 396,
    ["Foundry VTT - Module Manifest"] = 397,
    ["Foundry VTT - System Data Template"] = 400,
    ["Foundry VTT - System Manifest"] = 398,
    ["Foundry VTT - World Manifest"] = 399,
    ["Foxx Manifest"] = 119,
    ["Freifunk.de Community API"] = 122,
    ["Frogbot Config"] = 123,
    ["G2P Mapping Configuration"] = 408,
    ["GCP Blueprint Metadata"] = 411,
    Gaspar = 409,
    ["GatewayCore API Gateway"] = 410,
    ["Gemini CLI settings"] = 412,
    ["GeoJSON.json latest"] = 1073,
    GherKing = 1077,
    ["GitHub Action"] = 417,
    ["GitHub Actions typing"] = 1194,
    ["GitHub Discussion"] = 418,
    ["GitHub Funding"] = 419,
    ["GitHub Issue Template configuration"] = 420,
    ["GitHub Issue Template forms"] = 421,
    ["GitHub Pages Jekyll"] = 422,
    ["GitHub Workflow"] = 423,
    ["GitHub Workflow Template Properties"] = 424,
    ["GitHub automatically generated release notes configuration"] = 425,
    ["GitLab Agent for Kubernetes configuration"] = 1149,
    GitVersion = 414,
    ["Gitea Issue Template configuration"] = 415,
    ["Gitea Issue Template forms"] = 416,
    ["Gitpod Automations"] = 427,
    ["Gitpod Configuration"] = 428,
    ["GlazeWM settings"] = 1151,
    ["Global Privacy Control"] = 413,
    Goblet = 1130,
    ["Golangci-lint Configuration"] = 443,
    ["Golangci-lint Custom Plugins Configuration"] = 444,
    ["Google Chrome Related Website Sets"] = 391,
    ["Google Cloud Workflows"] = 270,
    ["Google Digital Assetlinks"] = 1238,
    Goreleaser = 446,
    ["Goreleaser Pro"] = 447,
    Goss = 449,
    ["Gradle Build Cache Node"] = 1024,
    ["Gradle Enterprise"] = 1023,
    ["Grafana 5.x Dashboard"] = 450,
    ["GraphQL Code Generator"] = 455,
    ["GraphQL Config"] = 454,
    ["GraphQL Mesh"] = 453,
    ["GroovyLint configuration"] = 456,
    ["Grunt JSHint task"] = 460,
    ["Grunt Watch task"] = 461,
    ["Grunt base task"] = 462,
    ["Grunt clean task"] = 458,
    ["Grunt copy task"] = 457,
    ["Grunt cssmin task"] = 459,
    HEMTT = 989,
    Hadolint = 1003,
    Hammerkit = 1034,
    ["Hardware Sentry Configuration"] = 1089,
    ["Hashgraph Online Skill Manifest"] = 2,
    ["HashiCorp Vault"] = 463,
    Hatch = 1004,
    Hayson = 465,
    ["Haystack Pipeline"] = 466,
    ["Hazelcast 5 Configuration"] = 467,
    ["Hecate Input Schema"] = 1249,
    ["Helm Chart.lock"] = 236,
    ["Helm Chart.yaml"] = 235,
    ["Helm Unittest Test Suite"] = 237,
    ["Home Assistant Integration Manifest"] = 468,
    ["Homer dashboard configuration"] = 469,
    Hugo = 1065,
    ["Hugo Theme"] = 1064,
    ["Hulak Configuration"] = 476,
    ["Hyperfoil benchmark configuration"] = 475,
    ["IBM Zapp document"] = 477,
    ["IBM zCodeFormatSettings"] = 478,
    ["IMG Catapult PSP"] = 483,
    ["IVMS101 by CODE Protocol"] = 1150,
    Infrahub = 485,
    Istanbul = 1093,
    ["JDownloader2 crawler multi-rules"] = 498,
    ["JDownloader2 crawler single-rules"] = 497,
    ["JFrog Applications Config"] = 499,
    ["JFrog File Spec"] = 500,
    ["JFrog Pipelines YML DSL"] = 1099,
    ["JMeter DSL cli config"] = 501,
    JReleaser = 504,
    ["JSON Document Transform"] = 512,
    ["JSON Feed"] = 513,
    ["JSON Resume"] = 771,
    ["JSON Schema Draft 2020-12"] = 971,
    ["JSON Schema Draft 4"] = 968,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1132,
    ["JSON Schema Draft 7"] = 969,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1133,
    ["JSON Schema Draft 8 (2019-09)"] = 970,
    ["JSON-API"] = 511,
    ["JSON-e templates"] = 1031,
    ["JSON-stat 2.0"] = 964,
    JSONPatch = 515,
    ["JSR Package Config (jsr.json)"] = 505,
    Jarl = 1265,
    Jasmine = 492,
    Jekyll = 493,
    ["Jenkins X Pipelines"] = 494,
    ["Jenkins X Requirements"] = 495,
    Jest = 496,
    Jocker = 502,
    ["Jovo Language Models"] = 503,
    ["Jujutsu (jj) VCS config"] = 1251,
    ["KIMMDY config file"] = 526,
    ["KODE/CI build.yaml"] = 1095,
    ["KSP-AVC"] = 965,
    ["KSP-CKAN"] = 966,
    ["KSP-NetKAN"] = 967,
    KSY = 1162,
    KSail = 406,
    ["KYA Manifest"] = 1163,
    ["Karakum configuration file"] = 403,
    Kas = 518,
    ["Kestra flow file"] = 527,
    ["Keycloak REST API"] = 1102,
    ["Knative Functions - func.yaml"] = 404,
    Knip = 405,
    ["Knowledge Unit"] = 535,
    ["Kometa (nightly) config file"] = 529,
    ["Kometa config file"] = 528,
    ["Kong DBLess config"] = 1096,
    KrakenD = 530,
    ["Kubri Configuration"] = 538,
    LOOBin = 553,
    ["Lake configuration file"] = 1254,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 275,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 276,
    ["Landing Zone Accelerator on AWS - Global Config"] = 277,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 278,
    ["Landing Zone Accelerator on AWS - Network Config"] = 279,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 280,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 281,
    ["Landing Zone Accelerator on AWS - Security Config"] = 282,
    ["Lando (landofile)"] = 112,
    ["LangGraph Platform configuration"] = 1174,
    ["Language configuration"] = 1173,
    Lefthook = 542,
    ["Liferay client-extension.yaml"] = 549,
    ["LinkML Metamodel"] = 551,
    Liquibase = 1040,
    ["Liquibase Flow File"] = 1041,
    ["Lively Properties"] = 552,
    ["Lobe AI Agent"] = 114,
    Loki = 115,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 595,
    ["MS2Rescore Configuration"] = 600,
    ["Madness (madness.yml)"] = 1113,
    ["Mado configuration"] = 559,
    ["Maestro Flow"] = 560,
    ["Mail Servers Configuration"] = 1286,
    ["MapEHR Mapping"] = 561,
    Markdownlint = 1044,
    ["Mason Registry"] = 1047,
    ["MegaLinter Custom Flavor"] = 564,
    ["MegaLinter configuration"] = 563,
    ["MegaLinter descriptor"] = 565,
    Melange = 1140,
    ["Meltano project definition"] = 566,
    ["Mergify Configuration"] = 601,
    ["Metadata for a Bazel module"] = 567,
    ["Metadata for a Cinnamon spice"] = 1190,
    ["Metatype Configuration"] = 568,
    ["MetricsHub Configuration"] = 569,
    ["MetricsHub Connector Configuration"] = 570,
    ["Micro Editor Syntax"] = 1123,
    ["Microsoft Band Web Tile"] = 571,
    ["Microsoft RulesEngine workflow rules"] = 1178,
    ["Microsoft RulesEngine workflow rules list"] = 1179,
    ["Minecraft Custom Main Menu Mod"] = 1141,
    ["Minecraft Data Pack Advancement"] = 573,
    ["Minecraft Data Pack Biome"] = 574,
    ["Minecraft Data Pack Configured Carver"] = 575,
    ["Minecraft Data Pack Damage Type"] = 576,
    ["Minecraft Data Pack Dimension"] = 578,
    ["Minecraft Data Pack Dimension Type"] = 577,
    ["Minecraft Data Pack Item Modifier"] = 579,
    ["Minecraft Data Pack Loot Table"] = 580,
    ["Minecraft Data Pack Metadata"] = 581,
    ["Minecraft Data Pack Predicate"] = 582,
    ["Minecraft Data Pack Recipe"] = 583,
    ["Minecraft Data Pack Tag"] = 584,
    ["Minecraft Data Pack Template Pool"] = 585,
    ["Minecraft Data Pack Trim Material"] = 590,
    ["Minecraft Data Pack Trim Pattern"] = 591,
    ["Minecraft Resource Pack Lang"] = 586,
    ["Minecraft Resource Pack Particle"] = 587,
    ["Minecraft Resource Pack Texture Mcmeta"] = 589,
    ["Minecraft Resourcepack Sounds"] = 588,
    ["MockServer Expectations"] = 597,
    ModuleAssembler = 593,
    ["Monade CLI Stack Configuration"] = 604,
    ["MongoDB Atlas Search Index Definition"] = 1094,
    ["Monika Configuration"] = 1092,
    ["Monoweave Configuration"] = 599,
    ["Motif config"] = 985,
    MultiQC = 1231,
    ["NOX Framework (Service)"] = 622,
    ["Netin Diagnostic System Template"] = 1051,
    ["Netlify config"] = 607,
    ["Network-as-Code Data Model"] = 608,
    ["Next Gen UI Agent A2A Server Configuration"] = 609,
    ["Next Gen UI Agent Configuration"] = 611,
    ["Next Gen UI Agent MCP Server Configuration"] = 610,
    ["Nightwatch.js"] = 615,
    ["Node.js configuration"] = 990,
    ["NueJS configuration file"] = 627,
    ["Nuitka.yaml"] = 1155,
    ["Nullstone config"] = 629,
    ["ONe's changelog entry"] = 648,
    ["ONe's service descriptor"] = 647,
    ["ORT Server repository environment configuration"] = 658,
    ["OSCAL Assessment Plan (AP)"] = 660,
    ["OSCAL Assessment Results (AR)"] = 661,
    ["OSCAL Catalog"] = 662,
    ["OSCAL Component Definition (CDef)"] = 663,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 664,
    ["OSCAL Profile"] = 665,
    ["OSCAL System Security Plan (SSP)"] = 666,
    ["OSS Review Toolkit configuration"] = 667,
    ["OSS Review Toolkit curation"] = 668,
    ["OSS Review Toolkit package configuration"] = 669,
    ["OSS Review Toolkit project package manager definition"] = 670,
    ["OSS Review Toolkit repository configuration"] = 671,
    ["OSS Review Toolkit resolutions"] = 672,
    ["October CMS columns"] = 633,
    ["October CMS fields"] = 634,
    ["Oh My Posh"] = 636,
    Okteto = 637,
    ["Ona Automations"] = 639,
    Opctl = 988,
    ["Open Data Contract Standard (ODCS)"] = 652,
    ["Open Data Product Standard (ODPS)"] = 653,
    ["Open Know-How"] = 1236,
    OpenDecree = 1299,
    ["OpenDecree Configuration"] = 1300,
    ["OpenRewrite Resource"] = 650,
    OpenSRM = 654,
    OpenStatus = 1247,
    ["OpenTelemetry Declarative Configuration"] = 651,
    ["OpenUtau character yaml"] = 644,
    ["OpenUtau ustx"] = 645,
    ["OpenWeather Current Weather API"] = 1030,
    ["OpenWeather Road Risk API"] = 1029,
    ["Ory Hydra configuration"] = 474,
    ["Ory Keto configuration"] = 534,
    ["Ory Kratos configuration"] = 659,
    ["Ory Oathkeeper configuration"] = 631,
    ["Outblocks App configuration"] = 656,
    ["Outblocks database table"] = 657,
    ["Outblocks project configuration"] = 655,
    PDM = 679,
    POPxf = 691,
    ["POPxf Correlations"] = 692,
    ["PRML manifest"] = 699,
    Packer = 676,
    PactSpec = 677,
    Pantsbuild = 1109,
    ["Paper paper-plugin.yml"] = 678,
    ["Pipeline component"] = 1042,
    ["Platform.sh application"] = 8,
    ["Platform.sh routes"] = 9,
    ["Platform.sh services"] = 10,
    ["Plex Prerolls"] = 689,
    ["PocketMine plugin.yml"] = 686,
    ["Postman collection"] = 695,
    ["Power Pages Configuration"] = 1248,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1193,
    ["ProActions AI-Kit Configuration"] = 707,
    ["ProActions AI-Kit Configuration for Menus"] = 709,
    ["ProActions AI-Kit Configuration for Sections"] = 711,
    ["ProActions AI-Kit Configuration for Services"] = 708,
    ["ProActions AI-Kit Configuration for Steps"] = 712,
    ["ProActions AI-Kit Configuration for Templates"] = 710,
    ["Problem object RFC9457"] = 1138,
    ["Problem package format"] = 713,
    ["Problem package generators"] = 714,
    ["Problem package submissions"] = 715,
    ["Problem package test group metadata"] = 716,
    Pterodactyl = 1088,
    ["Pull Request Labeler"] = 733,
    Pulumi = 741,
    ["PyGTA Config"] = 737,
    PyProject = 742,
    Pylock = 1239,
    Pyright = 743,
    ["Python script metadata"] = 1233,
    ["QType AI DSL"] = 746,
    Qgoda = 745,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1310,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1308,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1314,
    ["Qlik Talend Cloud Pipeline - Project"] = 1306,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1309,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1311,
    ["Qlik Talend Cloud Pipeline - Task"] = 1307,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1313,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1312,
    Qodana = 1061,
    ["Qt Creator workspace file"] = 1171,
    ["Quali Torque Blueprint Spec 2"] = 1086,
    ["QueryFirst config file"] = 1105,
    ["QuikRun Configuration"] = 1315,
    ["Qwen Code Settings"] = 1296,
    ["RKE Cluster Configuration JSON"] = 1039,
    ["RKE Cluster Configuration YAML"] = 1038,
    RadioHound = 736,
    ["Raid Profile"] = 1297,
    ["Raid Repo Configuration"] = 1298,
    Railpack = 748,
    Railway = 747,
    ["Rancher Fleet"] = 738,
    ["Rattler-build"] = 749,
    Ray = 1002,
    ["Read the Docs"] = 740,
    ["Red-DiscordBot Cog"] = 756,
    ["Red-DiscordBot Cog Repo"] = 757,
    ["Red-DiscordBot Trivia"] = 758,
    ["Releasaurus Config"] = 5,
    ReleaseKit = 4,
    ["Render Blueprints"] = 1037,
    RenderCV = 775,
    Renovate = 772,
    ["Renovate global configuration"] = 773,
    ["Renovate inherited configuration"] = 774,
    ["Replit config"] = 764,
    Restate = 1226,
    ["Revel Digital Gadget Definition File"] = 1250,
    RoadRunner = 777,
    ["Robust Station Image"] = 1256,
    Rockcraft = 778,
    ["Roo Coder Custom Modes"] = 779,
    Rubocop = 768,
    ["Rudder techniques"] = 1145,
    Ruff = 769,
    ["Rust Project"] = 770,
    ["Rust toolchain"] = 784,
    ["SDMX data message"] = 811,
    ["SDMX metadata message"] = 810,
    ["SDMX structure message"] = 809,
    ["SIL Kit Participant Configuration"] = 821,
    ["SIL Kit Registry Configuration"] = 822,
    ["SPDX 2.3"] = 860,
    SWADL = 876,
    ["Safebox Config"] = 1100,
    ["Sapphire CLI Config"] = 787,
    ["SauceCTL Configuration"] = 1048,
    Scarb = 807,
    ["Schema Catalog"] = 802,
    ["Scoop manifest"] = 808,
    ["Semantic Data Fabric (SDF) file"] = 812,
    ["Semgrep Rule"] = 814,
    ["Serenity Code Generator (Sergen)"] = 815,
    ["Serverless Framework Configuration"] = 1055,
    ["Serverless Workflow"] = 1057,
    ["Settings for a Cinnamon spice"] = 1189,
    ["Settings.paf"] = 817,
    ["Shopware 6 Configuration"] = 1058,
    ["Shopware CLI Extension Store Configuration"] = 1059,
    ["Shopware CLI Project Store Configuration"] = 1060,
    ["Sigma Detection Rule"] = 819,
    ["Sigrid scope configuration file"] = 820,
    ["SkyPilot Task JSON"] = 1146,
    ["Slack app manifest"] = 824,
    Snapcraft = 826,
    ["Solarxy project config"] = 829,
    Solidarity = 830,
    ["Solution filters"] = 831,
    ["Source Maps v3"] = 832,
    Sourcery = 833,
    ["Spack bootstrap.yaml"] = 834,
    ["Spack cdash.yaml"] = 835,
    ["Spack ci.yaml"] = 836,
    ["Spack compilers.yaml"] = 837,
    ["Spack concretizer.yaml"] = 838,
    ["Spack config.yaml"] = 839,
    ["Spack definitions.yaml"] = 840,
    ["Spack develop.yaml"] = 841,
    ["Spack env_vars.yaml"] = 842,
    ["Spack environment"] = 848,
    ["Spack include.yaml"] = 843,
    ["Spack mirrors.yaml"] = 844,
    ["Spack modules.yaml"] = 845,
    ["Spack packages.yaml"] = 846,
    ["Spack repos.yaml"] = 847,
    ["Spack toolchains.yaml"] = 849,
    ["Spack upstreams.yaml"] = 850,
    ["Spack view.yaml"] = 851,
    ["Speakeasy Generation Config File"] = 855,
    ["Speakeasy Lint Configuration File"] = 852,
    ["Speakeasy Test Generation Configuration File"] = 853,
    ["Speakeasy Workflow File"] = 854,
    SpecIF = 856,
    ["Specmatic Configuration"] = 857,
    ["Sponge Mixin configuration"] = 858,
    StackBlitz = 864,
    ["StackHawk Scanner Configuration"] = 1054,
    Stale = 865,
    Starfish = 866,
    ["Starlake Data Pipeline"] = 1027,
    Starship = 867,
    ["Statamic Blueprint"] = 868,
    ["Stella configuration file"] = 869,
    ["Streamlit configuration file"] = 870,
    ["Stryker Mutator"] = 873,
    ["StyleCop Analyzers Configuration"] = 874,
    ["Stylelint (.stylelintrc)"] = 875,
    ["Stylua Config"] = 1240,
    ["Sublime Syntax"] = 1101,
    ["Subsquid squid manifest"] = 1148,
    ["Swagger API 2.0"] = 877,
    ["Synadia Connect Component"] = 878,
    TSON = 914,
    TSTyche = 915,
    ["TYPO3 Vendor Bundler config"] = 921,
    ["Tab data for a LinUtil"] = 1196,
    ["Tab list for a LinUtil"] = 1195,
    Tach = 879,
    ["Tach Domain"] = 880,
    Talhelper = 882,
    ["Talisman configuration"] = 883,
    Taplo = 1241,
    ["Taskfile config"] = 1032,
    Taurus = 884,
    Tauticord = 885,
    ["Tekton Pipeline"] = 1269,
    ["Tekton PipelineRun"] = 1270,
    ["Tekton Task"] = 1267,
    ["Tekton TaskRun"] = 1268,
    Telefonistka = 1227,
    ["Terrateam config"] = 1253,
    ["TestEnvironment.json"] = 897,
    ["TextMate Grammar"] = 896,
    Threagile = 891,
    ["Tier.run pricing.json"] = 888,
    Tikibase = 889,
    Tombi = 894,
    ["Traefik v2"] = 900,
    ["Traefik v2 File Provider"] = 901,
    ["Traefik v3"] = 902,
    ["Traefik v3 File Provider"] = 903,
    ["Travis CI (.travis.yml)"] = 899,
    Treefmt = 452,
    Trident = 1223,
    ["TrueScript for *.tscript files"] = 906,
    ["Tugboat QA config.yml"] = 1220,
    TunnelHub = 1136,
    Turborepo = 898,
    Tycho = 1185,
    Tye = 1062,
    ["Tyk Gateway - Open Source v5.7+"] = 1232,
    ["UET BuildConfig.json"] = 1106,
    ["UI5 Manifest"] = 927,
    ["UNCORS configuration"] = 932,
    ["UTAM Page Object"] = 930,
    ["Ubuntu Server Autoinstall"] = 925,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1224,
    ["Uniswap Token List"] = 1013,
    ["Universal Schedule Format"] = 933,
    ["Unreal Engine Uplugin"] = 1107,
    ["Unreal Engine Uproject"] = 1108,
    ["UpCloud CLI (upctl) configuration"] = 1225,
    ["Updatecli Compose"] = 1070,
    ["Updatecli Policy Manifest"] = 1071,
    ["Updatecli Policy Metadata"] = 1072,
    Uplift = 1104,
    ["Upsun config"] = 7,
    ["User Journey Map"] = 1036,
    V2Ray = 1076,
    ["VSCode Code Snippets"] = 258,
    ["VSIX CLI publishing"] = 951,
    Vector = 935,
    ["Vela Pipeline Configuration"] = 938,
    Vercel = 257,
    ["Version Bumper config"] = 941,
    Vespertide = 1274,
    ["Vespertide Migration"] = 1275,
    ["Vespertide Model"] = 1276,
    ["Viash Component Config"] = 1229,
    ["Viash Package Config"] = 1230,
    Visivo = 1134,
    ["WP-CLI"] = 961,
    Wake = 1222,
    ["Waku Config"] = 1199,
    ["Web App Manifest"] = 957,
    ["Web types"] = 960,
    WebExtensions = 956,
    ["Webman package recipe"] = 1082,
    ["Windows Package Manager Installer Manifest"] = 1010,
    ["Windows Package Manager Locale Manifest"] = 1011,
    ["Windows Package Manager Singleton Manifest"] = 1009,
    ["WireMock CLI import configuration"] = 1205,
    ["WireMock CLI local service configuration"] = 1204,
    ["WireMock message stub mapping"] = 1203,
    ["WireMock stub mapping"] = 1202,
    ["Woodpecker pipeline config"] = 1050,
    ["Wrangler CLI"] = 962,
    ["XenForo add-on manifest"] = 963,
    ["Xstate Machine"] = 1068,
    ["Yandex Workflow Language"] = 1191,
    ["Yarn Config (.yarnrc.yml)"] = 1025,
    ["Yippee-Ki-JSON configuration YML"] = 1016,
    ["YouTrack App"] = 1188,
    ["Zarf Package Configuration"] = 1255,
    ["Zerops import file"] = 1177,
    ["Zola Configuration"] = 1266,
    ["aerleon.yml"] = 21,
    ["amplify.yml"] = 14,
    ["amxx-builder manifest"] = 1317,
    ["angular.json"] = 38,
    apko = 1139,
    ["app-definition.yaml"] = 42,
    ["apple-app-site-association"] = 40,
    ["appsettings.StormPetrel.json"] = 47,
    ["appsettings.json"] = 45,
    ["appsscript.json"] = 44,
    ["appveyor.yml"] = 46,
    ["aqua-generate-registry.yaml"] = 49,
    ["aqua-policy.yaml"] = 50,
    ["aqua.yaml"] = 48,
    ["arazzo.json"] = 52,
    ["arb.json"] = 53,
    ["arc.json"] = 55,
    ["architect.yml"] = 54,
    ["artifacthub-repo.yml"] = 59,
    ["asm-lsp"] = 60,
    ["ast-grep rules"] = 63,
    ["ast-grep sgconfig.yml"] = 62,
    ["azure.yaml"] = 71,
    ["babelrc.json"] = 125,
    ["bamboo-spec"] = 129,
    basedpyright = 127,
    ["bashly-strings.yml"] = 1116,
    ["batect.yml"] = 128,
    ["beef-database-codegen"] = 130,
    ["beef-database-v5-codegen"] = 132,
    ["beef-entity-codegen"] = 131,
    ["beef-entity-v5-codegen"] = 133,
    ["behat.yml"] = 145,
    ["bigquery-table"] = 134,
    ["bioimageio resource description"] = 1156,
    ["bitbucket-pipelines"] = 136,
    bitrise = 137,
    ["bitrise-step"] = 138,
    ["block.json"] = 162,
    ["bottom configuration"] = 87,
    ["bower.json"] = 140,
    ["bozr.suite.json"] = 149,
    bpkg = 1117,
    ["browser.i18n.json"] = 150,
    ["browsh configuration"] = 151,
    bucklescript = 152,
    ["buf.gen.yaml"] = 90,
    ["buf.lock"] = 91,
    ["buf.plugin.yaml"] = 92,
    ...
    ["build-changelog"] = 153,
    ["bun.lock"] = 158,
    ["bundleconfig.json"] = 159,
    ["bunfig.toml"] = 160,
    ["cargo-mutants-config.yaml"] = 95,
    ["cargo-nextest repository configuration"] = 612,
    ["cargo-nextest user configuration"] = 613,
    ["ccmod.json"] = 1200,
    changelogging = 1168,
    ["chisel-slices.json"] = 284,
    ["chrome-extension-locales-messages.json"] = 265,
    ["chutzpah.json"] = 266,
    cibuildwheel = 182,
    ["clang-format (.clang-format)"] = 1074,
    ["clang-tidy"] = 243,
    clangd = 242,
    clib = 244,
    ["cloud-init: cloud-config userdata"] = 246,
    ["cloud-sdk-pipeline-configuration"] = 268,
    ["cloudbuild.json"] = 269,
    cloudify = 245,
    cmakefmt = 200,
    ["cmdx.yaml"] = 98,
    ...
    ["coffeelint.json"] = 286,
    ["commands.json"] = 261,
    ["commitlint (.commitlintrc)"] = 1012,
    ["committed.toml"] = 287,
    ["compile_commands.json"] = 260,
    ["compilerconfig.json"] = 259,
    ["completely.yml"] = 1112,
    ["component-detection-manifest.json"] = 290,
    ["component.json"] = 289,
    ["composer.json"] = 288,
    ["conda-forge"] = 186,
    ["config.yaml"] = 739,
    ["contentmanifest.json"] = 267,
    ["contribute.json"] = 291,
    ["cosmos.config.json"] = 263,
    ["crowdin.yml"] = 292,
    ["ctfd-setup configuration file"] = 1212,
    ["custom-elements.json"] = 1126,
    ["cypress.json"] = 296,
    ["dacier.yml"] = 1305,
    ["datalogic-scan2deploy-android"] = 306,
    ["datalogic-scan2deploy-ce"] = 307,
    ["dbt Dependencies"] = 207,
    ["dbt Packages"] = 209,
    ["dbt Project"] = 208,
    ["dbt Selectors"] = 210,
    ["dbt YAML files"] = 211,
    ...
    ["ddev-global"] = 308,
    ["ddev-project"] = 309,
    ["debugsettings.json"] = 310,
    ["dependabot-v2.json"] = 313,
    ["dependabot.json"] = 312,
    ["deployed-cli"] = 1067,
    ["devcontainer.json"] = 251,
    devinit = 1018,
    ["devspace.yaml"] = 1090,
    djlint = 1019,
    ["docker bake"] = 319,
    ["docker sequencer"] = 320,
    ["docker-compose.yml"] = 1017,
    ["dockerd.json"] = 317,
    ["dotnet Release Index manifest"] = 332,
    ["dotnet-tools.json"] = 333,
    ["dotnetcli.host.json"] = 334,
    ["dprint.json"] = 335,
    ["drone.json"] = 336,
    ["dss-2.0.0.json"] = 338,
    ["dstack configuration"] = 339,
    ["dtool dataset metadata"] = 1207,
    ["dvc.yaml"] = 340,
    ["ecosystem.json"] = 345,
    eksctl = 347,
    ["electron-builder configuration file"] = 373,
    ["epr-manifest.json"] = 372,
    ["estampo.toml"] = 371,
    ["evcc.yaml"] = 374,
    ["ezd task runner"] = 385,
    ["fabric.mod.json"] = 387,
    ["first-timers-bot"] = 395,
    ["flagd flag configuration"] = 120,
    ["fly.io Configuration"] = 121,
    fulibWorkflows = 1049,
    ["function.json"] = 407,
    ["gRPC API Gateway & OpenAPI Config"] = 16,
    ["gematik health care insurance list"] = 1218,
    ["gematik health care patient list"] = 1215,
    ["gematik health care provider institution list"] = 1217,
    ["gematik health care provider list"] = 1216,
    ["gematik tiger test environment configuration"] = 1219,
    ["git-town.toml"] = 1264,
    ["gitlab-ci"] = 426,
    ["global.json"] = 442,
    ["go-feature-flag Flag Configuration"] = 445,
    ["haxelib.json"] = 464,
    helmfile = 1005,
    helmwave = 1006,
    ["host-meta.json"] = 471,
    ...
    ["ide.host.json"] = 479,
    ["ifstate.yaml"] = 480,
    ["imageoptimizer.json"] = 481,
    ["importmap.json"] = 484,
    instant_python_config = 486,
    instant_python_custom_project = 487,
    ["ioBroker Configuration"] = 488,
    ["ioBroker JSON UI"] = 489,
    ["ioBroker Package manifest"] = 490,
    ["ixpect.conf.yaml"] = 491,
    ["ize.toml"] = 1103,
    ["jsconfig.json"] = 516,
    ["jscpd Configuration"] = 1087,
    jsdoc = 1001,
    ["k3d.yaml"] = 517,
    ["k9s aliases.yaml"] = 519,
    ["k9s cluster-config.yaml"] = 521,
    ["k9s config.yaml"] = 520,
    ["k9s hotkeys.yaml"] = 522,
    ["k9s plugins.yaml"] = 523,
    ["k9s skin.yaml"] = 524,
    ["k9s views.yaml"] = 525,
    ["kontinuous-config.yaml"] = 537,
    ["kontinuous-values.yaml"] = 536,
    ["kustomization.yaml"] = 539,
    ["label-commenter-config.yml"] = 540,
    ["latexindent configuration"] = 113,
    ["launchsettings.json"] = 541,
    lazydocker = 1125,
    lazygit = 1124,
    ["lego.json"] = 543,
    ["lerna.json"] = 544,
    ["lgtm.yml"] = 545,
    ["liblab.config.json"] = 546,
    ["libman.json"] = 547,
    ["license-report-config.json"] = 548,
    ["linkinator.config.json"] = 550,
    ["lint-staged (.lintstagedrc)"] = 979,
    ["local.settings.json"] = 555,
    ["localazy.json"] = 556,
    ["lotus.yaml"] = 554,
    ["lsdlschema.json"] = 557,
    ["macro.json"] = 1091,
    ["markdown-link-check"] = 1045,
    maturin = 1046,
    mboats = 1053,
    memnex = 1303,
    ["micro-settings.json"] = 1118,
    ["mimetypes.json"] = 572,
    ["mirrord config"] = 981,
    mise = 982,
    ["mkdocs.yml"] = 592,
    ...
    ["monospace.yml"] = 598,
    ["moon.yml"] = 1201,
    ["mprocs Configuration file"] = 1172,
    ["mrdocs.yml"] = 594,
    ["mta.yaml"] = 983,
    ["mtad.yaml"] = 984,
    ["mycode.json"] = 605,
    nFPM = 614,
    ["napari plugin manifest"] = 606,
    neoload = 996,
    ["nest-cli"] = 617,
    ["nexus-rpc-gen"] = 1291,
    ["ninjs (News in JSON)"] = 616,
    ["nitro.json"] = 995,
    ["nixd configuration"] = 1144,
    ["nlu.json"] = 618,
    ["nodemon.json"] = 620,
    ["noodl config"] = 1052,
    ["notebook.mod.json"] = 621,
    now = 991,
    ["npm-badges"] = 624,
    ["nswag.json"] = 628,
    ntangle = 630,
    ["nuclei-template.yaml"] = 625,
    ["nuget-project.json"] = 626,
    ["ocelot.json"] = 632,
    ogen = 635,
    ["omnisharp.json"] = 638,
    openHAB = 1277,
    ...
    oxlint = 1288,
    ["package.json"] = 673,
    ["package.manifest"] = 675,
    ["package.yaml"] = 674,
    ["partial-black.json"] = 146,
    ["partial-fastapi.json"] = 147,
    ["partial-pixi.json"] = 684,
    ["partial-scheduled.json"] = 148,
    ["pattern.json"] = 682,
    ["petstore-v1.0"] = 1098,
    pgap_yaml_input_reader = 680,
    pgrls = 681,
    pgxgen = 1281,
    pitcms = 1284,
    ["pixi.toml"] = 683,
    ["plagiarize-me.yaml"] = 688,
    ["plagiarize.yaml"] = 687,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1208,
    ["podbard.yaml"] = 690,
    ["portman.json"] = 693,
    ["prefect.toml"] = 702,
    ["prefect.yaml"] = 703,
    ...
    ["prettierrc.json"] = 705,
    ["prisma.yml"] = 706,
    ["project-1.0.0-beta3.json"] = 718,
    ["project-1.0.0-beta4.json"] = 719,
    ["project-1.0.0-beta5.json"] = 720,
    ["project-1.0.0-beta6.json"] = 721,
    ["project-1.0.0-beta8.json"] = 722,
    ["project-1.0.0-rc1.json"] = 723,
    ["project-1.0.0-rc2.json"] = 724,
    ["project.json"] = 717,
    ["project.owasp.yaml"] = 725,
    ["prometheus-alertmanager.json"] = 729,
    ["prometheus.json"] = 726,
    ["prometheus.rules.json"] = 727,
    ["prometheus.rules.test.json"] = 728,
    ["proxies.json"] = 730,
    ["publiccode.yml"] = 731,
    ["pubspec.yaml"] = 732,
    ["pyrseas-0.8.json"] = 735,
    pytest = 744,
    ["quilt.mod.json"] = 1119,
    ["rc3 auth"] = 750,
    ["rc3 collection"] = 751,
    ...
    ["release drafter"] = 997,
    ["release-hub.json"] = 3,
    ["release-please-config.json"] = 760,
    ["release-please-manifest.json"] = 761,
    ["release-plz.toml"] = 762,
    ["renv.lock"] = 776,
    ["reposets Configuration"] = 765,
    ["reposets Credentials"] = 766,
    ["revola.json"] = 1,
    ["rivet.json"] = 1143,
    ["rivet.yaml (legacy)"] = 1142,
    rumdl = 781,
    runny = 780,
    runspec = 1304,
    rustfmt = 782,
    ...
    samt = 785,
    samtrc = 786,
    ["sarif-1.0.0.json"] = 788,
    ["sarif-2.0.0.json"] = 789,
    ["sarif-2.1.0"] = 799,
    ["sarif-2.1.0-rtm.2"] = 790,
    ["sarif-2.1.0-rtm.3"] = 792,
    ["sarif-2.1.0-rtm.4"] = 794,
    ["sarif-2.1.0-rtm.5"] = 796,
    ["sarif-2.1.0-rtm.6"] = 797,
    ["sarif-external-property-file-2.1.0"] = 800,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 791,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 793,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 795,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 798,
    ["scalingo.json configuration"] = 801,
    ["schema.org - Action"] = 803,
    ["schema.org - ContactPoint"] = 804,
    ["schema.org - Place"] = 805,
    ["schema.org - Thing"] = 806,
    ["secrethub.yml"] = 1121,
    ["semantic-release"] = 813,
    ["servicehub.config.json"] = 974,
    ["servicehub.service.json"] = 973,
    ["settings.job"] = 816,
    ["sfdx-hardis configuration"] = 818,
    ["shard.yml"] = 1159,
    ["size-limit configuration"] = 823,
    ["skaffold.yaml"] = 1043,
    ["skyuxconfig.json"] = 825,
    ["snowflake-config"] = 827,
    ["snowflake-connections"] = 828,
    ["spicepod.yaml"] = 1180,
    ["sqlc configuration"] = 861,
    ["stripe-app-local.json"] = 872,
    ["stripe-app.json"] = 871,
    swcrc = 1028,
    ["task.json"] = 881,
    taskcat = 992,
    ["template.json"] = 886,
    ["templatsources.json"] = 887,
    ["text2confl config"] = 1289,
    ["theme.json"] = 890,
    ["tizen_workspace.json"] = 892,
    tldr = 893,
    ["tm_devices configuration file"] = 1246,
    tmuxinator = 977,
    tox = 895,
    ["transcend.yml"] = 904,
    ["tree-sitter grammar.json"] = 451,
    ["trime.yaml"] = 905,
    ["trunk.yaml"] = 907,
    ["ts-force-config.json"] = 912,
    ["tsconfig.json"] = 908,
    ["tsd.json"] = 909,
    ["tsdoc.json"] = 910,
    ["tsdrc.json"] = 911,
    ...
    v8r = 955,
    vcluster = 1166,
    ["vcpkg configuration file"] = 256,
    ["vcpkg manifest file"] = 255,
    ["vega-lite.json"] = 937,
    ["vega.json"] = 936,
    ["venvironment.yaml"] = 939,
    ["venvplus.yaml"] = 940,
    version = 1228,
    ["version.json"] = 942,
    ["vhwdebugger-binding.yaml"] = 944,
    ["vim-addon-info"] = 945,
    ["vs-2017.3.host.json"] = 947,
    ["vs-nesting.json"] = 948,
    ["vsls.json"] = 946,
    ["vss-extension.json"] = 952,
    vtcfg = 1234,
    ["vtesttree.yaml"] = 953,
    ["vtestunit.yaml"] = 954,
    ["warp-keysets.json"] = 1127,
    ["warp-themes.json"] = 1128,
    ["warp-workflows.json"] = 1129,
    ["webhint.io"] = 1083,
    ["webjobpublishsettings.json"] = 959,
    ["webjobs-list.json"] = 958,
    ["well-known-fursona"] = 1167,
    ["xs-app.json"] = 987,
    ["xunit.runner.json"] = 972,
    yamlfmt = 1014,
    yamllint = 1015,
    ["zerops.yml"] = 1176,
    zizmor = 1271,
  ...
  schemas = { {
      ...
      fileMatch = { "**/src/main/resources/admins/extensions/*/*.yaml", "**/src/main/resources/admins/extensions/*/*.yml" },
      ...
      fileMatch = { "**/src/main/resources/application.yaml", "**/src/main/resources/application.yml" },
