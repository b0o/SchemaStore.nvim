...
M.json = {
  ...
  index = {
    ...
    ["Adobe UXP Manifest"] = 910,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Alacritty Configuration"] = 822,
    ["All Contributors configuration file"] = 875,
    ...
    ["Application list for a WinUtil"] = 954,
    ArchitectFX = 958,
    ["Argo Events"] = 28,
    ["Argo Workflows"] = 29,
    AssemblyScript = 32,
    ...
    ["Azure Pipelines"] = 65,
    ["Azure Static Web Apps CLI configuration file"] = 653,
    ["Azure Static Web Apps configuration file"] = 652,
    ["BOSH Deploy Config"] = 89,
    ["BX CI"] = 106,
    ["Bashly (bashly.yml)"] = 879,
    ["Bashly Settings (bashly-settings.yml)"] = 880,
    ["Better Code Hub"] = 794,
    ["Better Scripts"] = 107,
    Bigconfig = 82,
    ["Biome Formatter Config"] = 52,
    ["Bitmovin Encoding Template"] = 964,
    BizTalkServerApplicationSchema = 763,
    Bleep = 108,
    ...
    ["Butane Config"] = 835,
    ["CGS Custom Card Game (CardGameDef.json)"] = 915,
    ["CICS TS region tagging"] = 844,
    ["CICS TS resource import"] = 845,
    ["CICS TS resource model"] = 846,
    ["CICS TS resource overrides"] = 847,
    ["CMake Presets"] = 109,
    ["CNC Codes"] = 124,
    ["CRS WAF test file"] = 944,
    ["CRS WAF test platform overrides file"] = 945,
    ...
    ["Chamaleon environment"] = 968,
    ["Chamaleon template"] = 967,
    Changesets = 204,
    Cheatsheets = 832,
    ...
    CityJSON = 120,
    ["Clawject config"] = 129,
    ["Cloud Foundry Application Manifest"] = 927,
    ["Cloud Run Spec v1"] = 949,
    ...
    Concord = 943,
    ["Configu .cfgu files"] = 932,
    ["Configu .configu file"] = 933,
    Conjure = 123,
    ["Container Structure Test"] = 777,
    Containerlab = 802,
    ["Crowdsec collection config"] = 213,
    ["Crowdsec parser config"] = 214,
    ["Crowdsec scenario config"] = 215,
    ["CumulusCI Config"] = 128,
    ["Custom Machinery Machine"] = 916,
    ["Custom Machinery Recipe"] = 917,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 887,
    ["EAS config"] = 280,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 876,
    ["EasyVCR .NET"] = 281,
    ["Eidolon Resource"] = 959,
    ...
    ["Goreleaser Pro"] = 337,
    Goss = 338,
    ["Gradle Build Cache Node"] = 792,
    ["Gradle Enterprise"] = 791,
    ...
    Hadolint = 773,
    Hammerkit = 801,
    ["Hardware Sentry Configuration"] = 855,
    Hatch = 774,
    Hayson = 351,
    ...
    ["JFrog File Spec"] = 380,
    ["JFrog Pipelines YML DSL"] = 864,
    ["JMeter DSL cli config"] = 381,
    JReleaser = 383,
    ["JSON Document Transform"] = 391,
    ["JSON Feed"] = 392,
    ["JSON Resume"] = 592,
    ["JSON Schema Draft 2020-12"] = 743,
    ["JSON Schema Draft 4"] = 740,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 897,
    ["JSON Schema Draft 7"] = 741,
    ["JSON Schema Draft 7 (unofficial strict)"] = 898,
    ["JSON Schema Draft 8 (2019-09)"] = 742,
    ["JSON-API"] = 390,
    ["JSON-WF"] = 926,
    ["JSON-e templates"] = 799,
    ["JSON-stat 2.0"] = 736,
    JSONPatch = 394,
    ...
    ["Keycloak REST API"] = 867,
    ["Knative Functions - func.yaml"] = 299,
    ["KoDE/CI build.yaml"] = 860,
    ["Kong DBLess config"] = 861,
    KrakenD = 407,
    ...
    ["Metadata for a Cinnamon spice"] = 952,
    ["MetricsHub Configuration"] = 440,
    ["MetricsHub Connector Configuration"] = 441,
    ["Micro Editor Syntax"] = 888,
    ["Microsoft Band Web Tile"] = 442,
    ["Microsoft RulesEngine workflow rules"] = 940,
    ["Microsoft RulesEngine workflow rules list"] = 941,
    ["Minecraft Custom Main Menu Mod"] = 905,
    ...
    ["MongoDB Atlas Search Index Definition"] = 859,
    ["Monika Configuration"] = 857,
    ["Monoweave Configuration"] = 466,
    ["Motif config"] = 756,
    ["NOX Framework (Service)"] = 483,
    ["Netin Diagnostic System Template"] = 817,
    ["Netlify config"] = 474,
    ...
    ["OpenUtau ustx"] = 501,
    ["OpenWeather Current Weather API"] = 798,
    ["OpenWeather Road Risk API"] = 797,
    ...
    ["Pipeline component"] = 809,
    ["Plex Prerolls"] = 537,
    ["PocketMine plugin.yml"] = 534,
    ["Postman collection"] = 541,
    ["Preset list for a WinUtil"] = 955,
    ["Problem object RFC9457"] = 902,
    ...
    Qgoda = 574,
    Qodana = 827,
    ["Qt Creator workspace file"] = 934,
    ["Quali Torque Blueprint Spec 2"] = 852,
    ["QueryFirst config file"] = 870,
    ["RKE Cluster Configuration JSON"] = 806,
    ["RKE Cluster Configuration YAML"] = 805,
    ["Rancher Fleet"] = 568,
    ["Rattler-build"] = 575,
    Ray = 772,
    ["Read the Docs"] = 570,
    ...
    ["Render Blueprints"] = 804,
    RenderCV = 594,
    Renovate = 593,
    ["Replit config"] = 588,
    RoadRunner = 596,
    ["Rudder techniques"] = 908,
    Ruff = 590,
    ["Rust Project"] = 591,
    ["Rust toolchain"] = 600,
    ["SDMX data message"] = 625,
    ["SDMX metadata message"] = 624,
    ["SDMX structure message"] = 623,
    ["SIL Kit Participant Configuration"] = 635,
    ["SIL Kit Registry Configuration"] = 636,
    SWADL = 664,
    ["Safebox Config"] = 865,
    ["Sapphire CLI Config"] = 603,
    ["SauceCTL Configuration"] = 814,
    ["Schema Catalog"] = 617,
    ["Scoop manifest"] = 622,
    ["Semantic Data Fabric (SDF) file"] = 626,
    ["Semgrep Rule"] = 628,
    ["Serenity Code Generator (Sergen)"] = 629,
    ["Serverless Framework Configuration"] = 821,
    ["Serverless Workflow"] = 823,
    ["Settings for a Cinnamon spice"] = 951,
    ["Settings.paf"] = 631,
    ["Shopware 6 Configuration"] = 824,
    ["Shopware CLI Extension Store Configuration"] = 825,
    ["Shopware CLI Project Store Configuration"] = 826,
    ["Sigma Detection Rule"] = 633,
    ["Sigrid scope configuration file"] = 634,
    ["SkyPilot Task JSON"] = 909,
    ["Slack app manifest"] = 638,
    Solidarity = 641,
    ["Solution filters"] = 642,
    ["Source Maps v3"] = 643,
    Sourcery = 644,
    ["Speakeasy Lint Configuration File"] = 645,
    ["Speakeasy Test Generation Configuration File"] = 646,
    ["Speakeasy Workflow File"] = 647,
    SpecIF = 648,
    ["Sponge Mixin configuration"] = 649,
    StackBlitz = 654,
    ["StackHawk Scanner Configuration"] = 820,
    Stale = 655,
    ["Starlake Data Pipeline"] = 795,
    Starship = 656,
    ["Statamic Blueprint"] = 657,
    ["Stella configuration file"] = 658,
    ["Stryker Mutator"] = 661,
    ["StyleCop Analyzers Configuration"] = 662,
    ["Stylelint (.stylelintrc)"] = 663,
    ["Sublime Syntax"] = 866,
    ["Subsquid squid manifest"] = 911,
    ["Swagger API 2.0"] = 665,
    TSON = 694,
    TSTyche = 695,
    ["Tab data for a LinUtil"] = 957,
    ["Tab list for a LinUtil"] = 956,
    Talhelper = 667,
    ["Talisman configuration"] = 668,
    ["Taskfile config"] = 800,
    Taurus = 669,
    Tauticord = 670,
    ["TestEnvironment.json"] = 679,
    ["TextMate Grammar"] = 678,
    ["Tier.run pricing.json"] = 673,
    Tikibase = 674,
    ["Traefik v2"] = 682,
    ["Traefik v2 File Provider"] = 683,
    ["Travis CI (.travis.yml)"] = 681,
    ["TrueScript for *.tscript files"] = 686,
    TunnelHub = 901,
    Turborepo = 680,
    Tycho = 947,
    Tye = 828,
    ["UET BuildConfig.json"] = 871,
    ["UI5 Manifest"] = 704,
    ["UNCORS configuration"] = 708,
    ["UTAM Page Object"] = 707,
    ["Ubuntu Server Autoinstall"] = 702,
    ["Uniswap Token List"] = 783,
    ["Unreal Engine Uplugin"] = 872,
    ["Unreal Engine Uproject"] = 873,
    ["Updatecli Compose"] = 836,
    ["Updatecli Policy Manifest"] = 837,
    ["Updatecli Policy Metadata"] = 838,
    Uplift = 869,
    ["User Journey Map"] = 803,
    V2Ray = 842,
    ["VSCode Code Snippets"] = 179,
    ["VSIX CLI publishing"] = 725,
    ["Vela Pipeline Configuration"] = 712,
    Vercel = 178,
    ["Version Bumper config"] = 715,
    Visivo = 899,
    ["Waku Config"] = 960,
    ["Web App Manifest"] = 731,
    ["Web types"] = 734,
    WebExtensions = 730,
    ["Webman package recipe"] = 848,
    ["Windows Package Manager Installer Manifest"] = 780,
    ["Windows Package Manager Locale Manifest"] = 781,
    ["Windows Package Manager Singleton Manifest"] = 779,
    ["WireMock stub mapping"] = 963,
    ["Woodpecker pipeline config"] = 816,
    ["Wrangler CLI"] = 735,
    ["Xstate Machine"] = 834,
    ["Yandex Workflow Language"] = 953,
    ["Yarn Config (.yarnrc.yml)"] = 793,
    ["Yippee-Ki-JSON configuration YML"] = 785,
    ["YouTrack App"] = 950,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 903,
    ...
    ["behat.yml"] = 91,
    ["bigquery-table"] = 81,
    ["bioimageio resource description"] = 919,
    ...
    ["crowdin.yml"] = 212,
    ["ctfd-setup configuration file"] = 969,
    ["custom-elements.json"] = 891,
    ["cypress.json"] = 216,
    ...
    ["lint-staged (.lintstagedrc)"] = 751,
    ["local.settings.json"] = 430,
    ["localazy.json"] = 431,
    ["lotus.yaml"] = 429,
    ["lsdlschema.json"] = 432,
    ["markdown-link-check"] = 812,
    mboats = 819,
    ["micro-settings.json"] = 883,
    ["mimetypes.json"] = 443,
    ["mirrord config"] = 752,
    mise = 753,
    ["mkdocs.yml"] = 463,
    ...
    ["plagiarize.yaml"] = 535,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 966,
    ["podbard.yaml"] = 538,
    ["portman.json"] = 539,
    ["prefect.toml"] = 547,
    ["prettierrc.json"] = 548,
    ...
    samt = 601,
    samtrc = 602,
    ["sarif-1.0.0.json"] = 604,
    ["sarif-2.0.0.json"] = 605,
    ["sarif-2.1.0"] = 615,
    ["sarif-2.1.0-rtm.2"] = 606,
    ["sarif-2.1.0-rtm.3"] = 608,
    ["sarif-2.1.0-rtm.4"] = 610,
    ["sarif-2.1.0-rtm.5"] = 612,
    ["sarif-2.1.0-rtm.6"] = 613,
    ["sarif-external-property-file-2.1.0"] = 616,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 607,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 609,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 611,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 614,
    ["schema.org - Action"] = 618,
    ["schema.org - ContactPoint"] = 619,
    ["schema.org - Place"] = 620,
    ["schema.org - Thing"] = 621,
    ["secrethub.yml"] = 886,
    ["semantic-release"] = 627,
    ["servicehub.config.json"] = 746,
    ["servicehub.service.json"] = 745,
    ["settings.job"] = 630,
    ["sfdx-hardis configuration"] = 632,
    ["shard.yml"] = 922,
    ["size-limit configuration"] = 637,
    ["skaffold.yaml"] = 810,
    ["skyuxconfig.json"] = 639,
    snapcraft = 640,
    ["spicepod.yaml"] = 942,
    ["sqlc configuration"] = 651,
    ["stripe-app-local.json"] = 660,
    ["stripe-app.json"] = 659,
    swcrc = 796,
    ["task.json"] = 666,
    taskcat = 762,
    ["template.json"] = 671,
    ["templatsources.json"] = 672,
    ["theme.json"] = 675,
    ["tizen_workspace.json"] = 676,
    tldr = 677,
    tmuxinator = 749,
    ["transcend.yml"] = 684,
    ...
    ["vega-lite.json"] = 711,
    ["vega.json"] = 710,
    ["venvironment-basic.yaml"] = 714,
    ["venvironment.yaml"] = 713,
    ["version.json"] = 716,
    ["vhwdebugger-binding.yaml"] = 718,
    ["vim-addon-info"] = 719,
    ["vs-2017.3.host.json"] = 721,
    ["vs-nesting.json"] = 722,
    ["vsls.json"] = 720,
    ["vss-extension.json"] = 726,
    ["vtesttree.yaml"] = 727,
    ["vtestunit.yaml"] = 728,
    ["warp-keysets.json"] = 892,
    ["warp-themes.json"] = 893,
    ["warp-workflows.json"] = 894,
    ["webhint.io"] = 849,
    ["webjobpublishsettings.json"] = 733,
    ["webjobs-list.json"] = 732,
    ["well-known-fursona"] = 930,
    ["xs-app.json"] = 758,
    ["xunit.runner.json"] = 744,
    yamllint = 784,
    ["zerops.io import file"] = 939,
    ["zerops.yml"] = 938,
    zuul = 768,
    ["Žinoma"] = 778
  },
