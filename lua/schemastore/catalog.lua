...
M.json = {
  ...
  index = {
    ...
    ["Azure Pipelines"] = 63,
    ["Azure Static Web Apps CLI configuration file"] = 644,
    ["Azure Static Web Apps configuration file"] = 643,
    ["BOSH Deploy Config"] = 87,
    ["BX CI"] = 104,
    ...
    ["JSON Feed"] = 388,
    ["JSON Resume"] = 584,
    ["JSON Schema Draft 2020-12"] = 734,
    ["JSON Schema Draft 4"] = 731,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 888,
    ["JSON Schema Draft 7"] = 732,
    ["JSON Schema Draft 7 (unofficial strict)"] = 889,
    ["JSON Schema Draft 8 (2019-09)"] = 733,
    ["JSON-API"] = 386,
    ["JSON-WF"] = 917,
    ...
    ["Problem package generators"] = 542,
    Pterodactyl = 845,
    ["Pull Request Labeler"] = 557,
    Pulumi = 563,
    PyProject = 564,
    Pyright = 565,
    Qgoda = 566,
    ...
    Ray = 763,
    ["Read the Docs"] = 562,
    ["Red-DiscordBot Cog"] = 574,
    ["Red-DiscordBot Cog Repo"] = 575,
    ["Red-DiscordBot Trivia"] = 576,
    ...
    ["Rust Project"] = 583,
    ["Rust toolchain"] = 591,
    ["SDMX data message"] = 616,
    ["SDMX metadata message"] = 615,
    ["SDMX structure message"] = 614,
    ["SIL Kit Participant Configuration"] = 626,
    ["SIL Kit Registry Configuration"] = 627,
    SWADL = 655,
    ["Safebox Config"] = 856,
    ["Sapphire CLI Config"] = 594,
    ["SauceCTL Configuration"] = 805,
    ["Schema Catalog"] = 608,
    ["Scoop manifest"] = 613,
    ["Semantic Data Fabric (SDF) file"] = 617,
    ["Semgrep Rule"] = 619,
    ["Serenity Code Generator (Sergen)"] = 620,
    ...
    ["Sigma Detection Rule"] = 624,
    ["Sigrid scope configuration file"] = 625,
    ["SkyPilot Task JSON"] = 900,
    ["Slack app manifest"] = 629,
    Solidarity = 632,
    ["Solution filters"] = 633,
    ["Source Maps v3"] = 634,
    Sourcery = 635,
    ["Speakeasy Lint Configuration File"] = 636,
    ["Speakeasy Test Generation Configuration File"] = 637,
    ["Speakeasy Workflow File"] = 638,
    SpecIF = 639,
    ["Sponge Mixin configuration"] = 640,
    StackBlitz = 645,
    ["StackHawk Scanner Configuration"] = 811,
    Stale = 646,
    ["Starlake Data Pipeline"] = 786,
    Starship = 647,
    ["Statamic Blueprint"] = 648,
    ["Stella configuration file"] = 649,
    ["Stryker Mutator"] = 652,
    ["StyleCop Analyzers Configuration"] = 653,
    ["Stylelint (.stylelintrc)"] = 654,
    ["Sublime Syntax"] = 857,
    ...
    Talhelper = 658,
    ["Talisman configuration"] = 659,
    ["Taskfile config"] = 791,
    Taurus = 660,
    Tauticord = 661,
    ["TestEnvironment.json"] = 670,
    ["TextMate Grammar"] = 669,
    ["Tier.run pricing.json"] = 664,
    Tikibase = 665,
    ["Traefik v2"] = 673,
    ["Traefik v2 File Provider"] = 674,
    ["Travis CI (.travis.yml)"] = 672,
    ["TrueScript for *.tscript files"] = 677,
    TunnelHub = 892,
    Turborepo = 671,
    Tycho = 938,
    Tye = 819,
    ...
    ["UI5 Manifest"] = 695,
    ["UNCORS configuration"] = 699,
    ["UTAM Page Object"] = 698,
    ["Ubuntu Server Autoinstall"] = 693,
    ...
    ["VSIX CLI publishing"] = 716,
    ["Vela Pipeline Configuration"] = 703,
    Vercel = 176,
    ["Version Bumper config"] = 706,
    Visivo = 890,
    ["Waku Config"] = 951,
    ...
    ["prettierrc.json"] = 540,
    ["prisma.yml"] = 541,
    ["project-1.0.0-beta3.json"] = 544,
    ["project-1.0.0-beta4.json"] = 545,
    ["project-1.0.0-beta5.json"] = 546,
    ["project-1.0.0-beta6.json"] = 547,
    ["project-1.0.0-beta8.json"] = 548,
    ["project-1.0.0-rc1.json"] = 549,
    ["project-1.0.0-rc2.json"] = 550,
    ["project.json"] = 543,
    ["prometheus.json"] = 551,
    ["prometheus.rules.json"] = 552,
    ["prometheus.rules.test.json"] = 553,
    ["proxies.json"] = 554,
    ["publiccode.yml"] = 555,
    ["pubspec.yaml"] = 556,
    ["pyrseas-0.8.json"] = 559,
    ["quilt.mod.json"] = 875,
    ["rc3 auth"] = 568,
    ["rc3 collection"] = 569,
    ["rc3 environment"] = 570,
    ...
    samt = 592,
    samtrc = 593,
    ["sarif-1.0.0.json"] = 595,
    ["sarif-2.0.0.json"] = 596,
    ["sarif-2.1.0"] = 606,
    ["sarif-2.1.0-rtm.2"] = 597,
    ["sarif-2.1.0-rtm.3"] = 599,
    ["sarif-2.1.0-rtm.4"] = 601,
    ["sarif-2.1.0-rtm.5"] = 603,
    ["sarif-2.1.0-rtm.6"] = 604,
    ["sarif-external-property-file-2.1.0"] = 607,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 598,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 600,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 602,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 605,
    ["schema.org - Action"] = 609,
    ["schema.org - ContactPoint"] = 610,
    ["schema.org - Place"] = 611,
    ["schema.org - Thing"] = 612,
    ["secrethub.yml"] = 877,
    ["semantic-release"] = 618,
    ["servicehub.config.json"] = 737,
    ["servicehub.service.json"] = 736,
    ["settings.job"] = 621,
    ["sfdx-hardis configuration"] = 623,
    ["shard.yml"] = 913,
    ["size-limit configuration"] = 628,
    ["skaffold.yaml"] = 801,
    ["skyuxconfig.json"] = 630,
    snapcraft = 631,
    ["spicepod.yaml"] = 933,
    ["sqlc configuration"] = 642,
    ["stripe-app-local.json"] = 651,
    ["stripe-app.json"] = 650,
    swcrc = 787,
    ["task.json"] = 657,
    taskcat = 754,
    ["template.json"] = 662,
    ["templatsources.json"] = 663,
    ["theme.json"] = 666,
    ["tizen_workspace.json"] = 667,
    tldr = 668,
    tmuxinator = 740,
    ["transcend.yml"] = 675,
    ...
    ["vega-lite.json"] = 702,
    ["vega.json"] = 701,
    ["venvironment-basic.yaml"] = 705,
    ["venvironment.yaml"] = 704,
    ["version.json"] = 707,
    ["vhwdebugger-binding.yaml"] = 709,
    ["vim-addon-info"] = 710,
    ["vs-2017.3.host.json"] = 712,
    ["vs-nesting.json"] = 713,
    ["vsls.json"] = 711,
    ["vss-extension.json"] = 717,
    ["vtesttree.yaml"] = 718,
    ["vtestunit.yaml"] = 719,
