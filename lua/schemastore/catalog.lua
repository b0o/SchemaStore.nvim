...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 754,
    [".nodehawkrc"] = 478,
    [".npmpackagejsonlintrc"] = 482,
    [".omletrc"] = 925,
    [".phrase.yml"] = 543,
    [".phraseapp.yml"] = 544,
    [".pmbot.yml"] = 531,
    [".postcssrc"] = 538,
    [".powerpages-web-template-manifest"] = 540,
    [".pre-commit-config.yml"] = 541,
    [".pre-commit-hooks.yml"] = 542,
    [".putout.json"] = 564,
    [".rehyperc"] = 583,
    [".remarkrc"] = 585,
    [".sprite files"] = 647,
    ...
    ["A micro editor config"] = 433,
    ABCInventoryModuleData = 13,
    ABCSupplyPlan = 14,
    AIConfig = 15,
    ["API Builder"] = 787,
    ["AVA Configuration"] = 847,
    ...
    ["Adobe UXP Manifest"] = 907,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Alacritty Configuration"] = 819,
    ["All Contributors configuration file"] = 872,
    ...
    ["Application list for a WinUtil"] = 951,
    ArchitectFX = 955,
    ["Argo Events"] = 28,
    ["Argo Workflows"] = 29,
    AssemblyScript = 32,
    ...
    ["Azure Pipelines"] = 65,
    ["Azure Static Web Apps CLI configuration file"] = 650,
    ["Azure Static Web Apps configuration file"] = 649,
    ["BOSH Deploy Config"] = 89,
    ["BX CI"] = 106,
    ["Bashly (bashly.yml)"] = 876,
    ["Bashly Settings (bashly-settings.yml)"] = 877,
    ["Better Code Hub"] = 791,
    ["Better Scripts"] = 107,
    Bigconfig = 82,
    ["Biome Formatter Config"] = 52,
    ["Bitmovin Encoding Template"] = 961,
    BizTalkServerApplicationSchema = 760,
    Bleep = 108,
    ...
    ["Butane Config"] = 832,
    ["CGS Custom Card Game (CardGameDef.json)"] = 912,
    ["CICS TS region tagging"] = 841,
    ["CICS TS resource import"] = 842,
    ["CICS TS resource model"] = 843,
    ["CICS TS resource overrides"] = 844,
    ["CMake Presets"] = 109,
    ["CNC Codes"] = 124,
    ["CRS WAF test file"] = 941,
    ["CRS WAF test platform overrides file"] = 942,
    ...
    CityJSON = 120,
    ["Clawject config"] = 129,
    ["Cloud Foundry Application Manifest"] = 924,
    ["Cloud Run Spec v1"] = 946,
    ...
    Concord = 940,
    ["Configu .cfgu files"] = 929,
    ["Configu .configu file"] = 930,
    Conjure = 123,
    ["Container Structure Test"] = 774,
    Containerlab = 799,
    ["Crowdsec collection config"] = 213,
    ["Crowdsec parser config"] = 214,
    ["Crowdsec scenario config"] = 215,
    ["CumulusCI Config"] = 128,
    ["Custom Machinery Machine"] = 913,
    ["Custom Machinery Recipe"] = 914,
    ...
    ["DataYoga Job"] = 133,
    ["Databricks Asset Bundles"] = 893,
    ["Datadog Service Definition"] = 406,
    ["Datadog Software Catalog"] = 407,
    ["Datahub Ingestion Recipe"] = 848,
    ["Dein Config"] = 139,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 884,
    ["EAS config"] = 279,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 873,
    ["EasyVCR .NET"] = 280,
    ["Eidolon Resource"] = 956,
    ...
    ["Goreleaser Pro"] = 336,
    Goss = 337,
    ["Gradle Build Cache Node"] = 789,
    ["Gradle Enterprise"] = 788,
    ...
    Hadolint = 770,
    Hammerkit = 798,
    ["Hardware Sentry Configuration"] = 852,
    Hatch = 771,
    Hayson = 350,
    ...
    ["IVMS101 by CODE Protocol"] = 910,
    Infrahub = 367,
    Istanbul = 855,
    ["JDownloader2 crawler multi-rules"] = 376,
    ["JDownloader2 crawler single-rules"] = 375,
    ["JFrog Applications Config"] = 377,
    ["JFrog File Spec"] = 378,
    ["JFrog Pipelines YML DSL"] = 861,
    ["JMeter DSL cli config"] = 379,
    JReleaser = 381,
    ["JSON Document Transform"] = 389,
    ["JSON Feed"] = 390,
    ["JSON Resume"] = 590,
    ["JSON Schema Draft 2020-12"] = 740,
    ["JSON Schema Draft 4"] = 737,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 894,
    ["JSON Schema Draft 7"] = 738,
    ["JSON Schema Draft 7 (unofficial strict)"] = 895,
    ["JSON Schema Draft 8 (2019-09)"] = 739,
    ["JSON-API"] = 388,
    ["JSON-WF"] = 923,
    ["JSON-e templates"] = 796,
    ["JSON-stat 2.0"] = 733,
    JSONPatch = 392,
    ["JSR Package Config (jsr.json)"] = 382,
    Jasmine = 371,
    Jekyll = 372,
    ["Jenkins X Pipelines"] = 373,
    ["Jenkins X Requirements"] = 374,
    ["Jovo Language Models"] = 380,
    ["KIMMDY config file"] = 403,
    ["KSP-AVC"] = 734,
    ["KSP-CKAN"] = 735,
    ["KSP-NetKAN"] = 736,
    KSY = 922,
    ...
    Kas = 395,
    ["Kestra flow file"] = 404,
    ["Keycloak REST API"] = 864,
    ["Knative Functions - func.yaml"] = 298,
    ["KoDE/CI build.yaml"] = 857,
    ["Kong DBLess config"] = 858,
    KrakenD = 405,
    ["Kubri Configuration"] = 411,
    LOOBin = 426,
    ...
    ["Language configuration"] = 933,
    Lefthook = 415,
    ["Liferay client-extension.yaml"] = 422,
    ["LinkML Metamodel"] = 424,
    Liquibase = 804,
    ["Liquibase Flow File"] = 805,
    ["Lively Properties"] = 425,
    ["Lobe AI Agent"] = 63,
    Loki = 64,
    ["MLOS Configs"] = 462,
    ["MS2Rescore Configuration"] = 465,
    ["Madness (madness.yml)"] = 875,
    ["MapEHR Mapping"] = 432,
    Markdownlint = 808,
    ["Mason Registry"] = 810,
    ["MegaLinter configuration"] = 434,
    ["MegaLinter descriptor"] = 435,
    Melange = 901,
    ["Meltano project definition"] = 436,
    ["Mergify Configuration"] = 466,
    ["Metadata for a Bazel module"] = 437,
    ["Metadata for a Cinnamon spice"] = 949,
    ["MetricsHub Configuration"] = 438,
    ["MetricsHub Connector Configuration"] = 439,
    ["Micro Editor Syntax"] = 885,
    ["Microsoft Band Web Tile"] = 440,
    ["Microsoft RulesEngine workflow rules"] = 937,
    ["Microsoft RulesEngine workflow rules list"] = 938,
    ["Minecraft Custom Main Menu Mod"] = 902,
    ["Minecraft Data Pack Advancement"] = 442,
    ["Minecraft Data Pack Biome"] = 443,
    ["Minecraft Data Pack Configured Carver"] = 444,
    ["Minecraft Data Pack Damage Type"] = 445,
    ["Minecraft Data Pack Dimension"] = 447,
    ["Minecraft Data Pack Dimension Type"] = 446,
    ["Minecraft Data Pack Item Modifier"] = 448,
    ["Minecraft Data Pack Loot Table"] = 449,
    ["Minecraft Data Pack Metadata"] = 450,
    ["Minecraft Data Pack Predicate"] = 451,
    ["Minecraft Data Pack Recipe"] = 452,
    ["Minecraft Data Pack Tag"] = 453,
    ["Minecraft Data Pack Template Pool"] = 454,
    ["Minecraft Data Pack Trim Material"] = 459,
    ["Minecraft Data Pack Trim Pattern"] = 460,
    ["Minecraft Resource Pack Lang"] = 455,
    ["Minecraft Resource Pack Particle"] = 456,
    ["Minecraft Resource Pack Texture Mcmeta"] = 458,
    ["Minecraft Resourcepack Sounds"] = 457,
    ["Monade CLI Stack Configuration"] = 469,
    ["MongoDB Atlas Search Index Definition"] = 856,
    ["Monika Configuration"] = 854,
    ["Monoweave Configuration"] = 464,
    ["Motif config"] = 753,
    ["NOX Framework (Service)"] = 481,
    ["Netin Diagnostic System Template"] = 814,
    ["Netlify config"] = 472,
    ["Network-as-Code Data Model"] = 473,
    ["Nightwatch.js"] = 474,
    ["NueJS configuration file"] = 486,
    ["Nuitka.yaml"] = 915,
    ["Nullstone config"] = 488,
    ["ONe's changelog entry"] = 502,
    ["ONe's service descriptor"] = 501,
    ["OSCAL Assessment Plan (AP)"] = 510,
    ["OSCAL Assessment Results (AR)"] = 511,
    ["OSCAL Catalog"] = 512,
    ["OSCAL Component Definition (CDef)"] = 513,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 514,
    ["OSCAL Profile"] = 515,
    ["OSCAL System Security Plan (SSP)"] = 516,
    ["OSS Review Toolkit configuration"] = 517,
    ["OSS Review Toolkit curation"] = 518,
    ["OSS Review Toolkit package configuration"] = 519,
    ["OSS Review Toolkit repository configuration"] = 520,
    ["OSS Review Toolkit resolutions"] = 521,
    ["October CMS columns"] = 492,
    ["October CMS fields"] = 493,
    Okteto = 494,
    Opctl = 756,
    ["Open Data Contract Standard (ODCS)"] = 505,
    ["OpenRewrite Resource"] = 504,
    ["OpenUtau character yaml"] = 498,
    ["OpenUtau ustx"] = 499,
    ["OpenWeather Current Weather API"] = 795,
    ["OpenWeather Road Risk API"] = 794,
    ["Ory Hydra configuration"] = 357,
    ["Ory Keto configuration"] = 408,
    ["Ory Kratos configuration"] = 509,
    ["Ory Oathkeeper configuration"] = 490,
    ["Outblocks App configuration"] = 507,
    ["Outblocks database table"] = 508,
    ["Outblocks project configuration"] = 506,
    PDM = 527,
    Packer = 524,
    Pantsbuild = 871,
    ["Paper paper-plugin.yml"] = 525,
    ["Pipeline component"] = 806,
    ["Plex Prerolls"] = 535,
    ["PocketMine plugin.yml"] = 532,
    ["Postman collection"] = 539,
    ["Preset list for a WinUtil"] = 952,
    ["Problem object RFC9457"] = 899,
    ["Problem package generators"] = 548,
    Pterodactyl = 851,
    ["Pull Request Labeler"] = 563,
    Pulumi = 569,
    PyProject = 570,
    Pyright = 571,
    Qgoda = 572,
    Qodana = 824,
    ["Qt Creator workspace file"] = 931,
    ["Quali Torque Blueprint Spec 2"] = 849,
    ["QueryFirst config file"] = 867,
    ["RKE Cluster Configuration JSON"] = 803,
    ["RKE Cluster Configuration YAML"] = 802,
    ["Rancher Fleet"] = 566,
    ["Rattler-build"] = 573,
    Ray = 769,
    ["Read the Docs"] = 568,
    ["Red-DiscordBot Cog"] = 580,
    ["Red-DiscordBot Cog Repo"] = 581,
    ["Red-DiscordBot Trivia"] = 582,
    ["Render Blueprints"] = 801,
    RenderCV = 592,
    Renovate = 591,
    ["Replit config"] = 586,
    RoadRunner = 593,
    ["Rudder techniques"] = 905,
    Ruff = 588,
    ["Rust Project"] = 589,
    ["Rust toolchain"] = 597,
    ["SDMX data message"] = 622,
    ["SDMX metadata message"] = 621,
    ["SDMX structure message"] = 620,
    ["SIL Kit Participant Configuration"] = 632,
    ["SIL Kit Registry Configuration"] = 633,
    SWADL = 661,
    ["Safebox Config"] = 862,
    ["Sapphire CLI Config"] = 600,
    ["SauceCTL Configuration"] = 811,
    ["Schema Catalog"] = 614,
    ["Scoop manifest"] = 619,
    ["Semantic Data Fabric (SDF) file"] = 623,
    ["Semgrep Rule"] = 625,
    ["Serenity Code Generator (Sergen)"] = 626,
    ["Serverless Framework Configuration"] = 818,
    ["Serverless Workflow"] = 820,
    ["Settings for a Cinnamon spice"] = 948,
    ["Settings.paf"] = 628,
    ["Shopware 6 Configuration"] = 821,
    ["Shopware CLI Extension Store Configuration"] = 822,
    ["Shopware CLI Project Store Configuration"] = 823,
    ["Sigma Detection Rule"] = 630,
    ["Sigrid scope configuration file"] = 631,
    ["SkyPilot Task JSON"] = 906,
    ["Slack app manifest"] = 635,
    Solidarity = 638,
    ["Solution filters"] = 639,
    ["Source Maps v3"] = 640,
    Sourcery = 641,
    ["Speakeasy Lint Configuration File"] = 642,
    ["Speakeasy Test Generation Configuration File"] = 643,
    ["Speakeasy Workflow File"] = 644,
    SpecIF = 645,
    ["Sponge Mixin configuration"] = 646,
    StackBlitz = 651,
    ["StackHawk Scanner Configuration"] = 817,
    Stale = 652,
    ["Starlake Data Pipeline"] = 792,
    Starship = 653,
    ["Statamic Blueprint"] = 654,
    ["Stella configuration file"] = 655,
    ["Stryker Mutator"] = 658,
    ["StyleCop Analyzers Configuration"] = 659,
    ["Stylelint (.stylelintrc)"] = 660,
    ["Sublime Syntax"] = 863,
    ["Subsquid squid manifest"] = 908,
    ["Swagger API 2.0"] = 662,
    TSON = 691,
    TSTyche = 692,
    ["Tab data for a LinUtil"] = 954,
    ["Tab list for a LinUtil"] = 953,
    Talhelper = 664,
    ["Talisman configuration"] = 665,
    ["Taskfile config"] = 797,
    Taurus = 666,
    Tauticord = 667,
    ["TestEnvironment.json"] = 676,
    ["TextMate Grammar"] = 675,
    ["Tier.run pricing.json"] = 670,
    Tikibase = 671,
    ["Traefik v2"] = 679,
    ["Traefik v2 File Provider"] = 680,
    ["Travis CI (.travis.yml)"] = 678,
    ["TrueScript for *.tscript files"] = 683,
    TunnelHub = 898,
    Turborepo = 677,
    Tycho = 944,
    Tye = 825,
    ["UET BuildConfig.json"] = 868,
    ["UI5 Manifest"] = 701,
    ["UNCORS configuration"] = 705,
    ["UTAM Page Object"] = 704,
    ["Ubuntu Server Autoinstall"] = 699,
    ["Uniswap Token List"] = 780,
    ["Unreal Engine Uplugin"] = 869,
    ["Unreal Engine Uproject"] = 870,
    ["Updatecli Compose"] = 833,
    ["Updatecli Policy Manifest"] = 834,
    ["Updatecli Policy Metadata"] = 835,
    Uplift = 866,
    ["User Journey Map"] = 800,
    V2Ray = 839,
    ["VSCode Code Snippets"] = 179,
    ["VSIX CLI publishing"] = 722,
    ["Vela Pipeline Configuration"] = 709,
    Vercel = 178,
    ["Version Bumper config"] = 712,
    Visivo = 896,
    ["Waku Config"] = 957,
    ["Web App Manifest"] = 728,
    ["Web types"] = 731,
    WebExtensions = 727,
    ["Webman package recipe"] = 845,
    ["Windows Package Manager Installer Manifest"] = 777,
    ["Windows Package Manager Locale Manifest"] = 778,
    ["Windows Package Manager Singleton Manifest"] = 776,
    ["WireMock stub mapping"] = 960,
    ["Woodpecker pipeline config"] = 813,
    ["Wrangler CLI"] = 732,
    ["Xstate Machine"] = 831,
    ["Yandex Workflow Language"] = 950,
    ["Yarn Config (.yarnrc.yml)"] = 790,
    ["Yippee-Ki-JSON configuration YML"] = 782,
    ["YouTrack App"] = 947,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 900,
    ...
    ["behat.yml"] = 91,
    ["bigquery-table"] = 81,
    ["bioimageio resource description"] = 916,
    ...
    ["ize.toml"] = 865,
    ["jsconfig.json"] = 393,
    ["jscpd Configuration"] = 850,
    jsdoc = 768,
    ["k3d.yaml"] = 394,
    ["k9s aliases.yaml"] = 396,
    ["k9s cluster-config.yaml"] = 398,
    ["k9s config.yaml"] = 397,
    ["k9s hotkeys.yaml"] = 399,
    ["k9s plugins.yaml"] = 400,
    ["k9s skin.yaml"] = 401,
    ["k9s views.yaml"] = 402,
    ["kontinuous-config.yaml"] = 410,
    ["kontinuous-values.yaml"] = 409,
    ["kustomization.yaml"] = 412,
    ["label-commenter-config.yml"] = 413,
    ["latexindent configuration"] = 62,
    ["launchsettings.json"] = 414,
    lazydocker = 887,
    lazygit = 886,
    ["lego.json"] = 416,
    ["lerna.json"] = 417,
    ["lgtm.yml"] = 418,
    ["liblab.config.json"] = 419,
    ["libman.json"] = 420,
    ["license-report-config.json"] = 421,
    ["linkinator.config.json"] = 423,
    ["lint-staged (.lintstagedrc)"] = 748,
    ["local.settings.json"] = 428,
    ["localazy.json"] = 429,
    ["lotus.yaml"] = 427,
    ["lsdlschema.json"] = 430,
    ["markdown-link-check"] = 809,
    mboats = 816,
    ["micro-settings.json"] = 880,
    ["mimetypes.json"] = 441,
    ["mirrord config"] = 749,
    mise = 750,
    ["mkdocs.yml"] = 461,
    ["monospace.yml"] = 463,
    ["moon.yml"] = 959,
    ["mprocs Configuration file"] = 932,
    ["mta.yaml"] = 751,
    ["mtad.yaml"] = 752,
    ["mycode.json"] = 470,
    ["napari plugin manifest"] = 471,
    neoload = 763,
    ["nest-cli"] = 476,
    ["ninjs (News in JSON)"] = 475,
    ["nitro.json"] = 762,
    ["nixd configuration"] = 904,
    ["nlu.json"] = 477,
    ["nodemon.json"] = 479,
    ["noodl config"] = 815,
    ["notebook.mod.json"] = 480,
    now = 758,
    ["npm-badges"] = 483,
    ["nswag.json"] = 487,
    ntangle = 489,
    ["nuclei-template.yaml"] = 484,
    ["nuget-project.json"] = 485,
    ["ocelot.json"] = 491,
    ["omnisharp.json"] = 495,
    ["openapi.json"] = 496,
    ["openfin.json"] = 503,
    ...
    ["ops.yaml"] = 500,
    ["package.json"] = 522,
    ["package.manifest"] = 523,
    ["partial-black.json"] = 92,
    ["pathfinder.yml"] = 526,
    ["pattern.json"] = 529,
    ["petstore-v1.0"] = 860,
    pgap_yaml_input_reader = 528,
    ["pixi.toml"] = 530,
    ...
    ["prettierrc.json"] = 546,
    ["prisma.yml"] = 547,
    ["project-1.0.0-beta3.json"] = 550,
    ["project-1.0.0-beta4.json"] = 551,
    ["project-1.0.0-beta5.json"] = 552,
    ["project-1.0.0-beta6.json"] = 553,
    ["project-1.0.0-beta8.json"] = 554,
    ["project-1.0.0-rc1.json"] = 555,
    ["project-1.0.0-rc2.json"] = 556,
    ["project.json"] = 549,
    ["prometheus.json"] = 557,
    ["prometheus.rules.json"] = 558,
    ["prometheus.rules.test.json"] = 559,
    ["proxies.json"] = 560,
    ["publiccode.yml"] = 561,
    ["pubspec.yaml"] = 562,
    ["pyrseas-0.8.json"] = 565,
    ["quilt.mod.json"] = 881,
    ["rc3 auth"] = 574,
    ["rc3 collection"] = 575,
    ["rc3 environment"] = 576,
    ...
    samt = 598,
    samtrc = 599,
    ["sarif-1.0.0.json"] = 601,
    ["sarif-2.0.0.json"] = 602,
    ["sarif-2.1.0"] = 612,
    ["sarif-2.1.0-rtm.2"] = 603,
    ["sarif-2.1.0-rtm.3"] = 605,
    ["sarif-2.1.0-rtm.4"] = 607,
    ["sarif-2.1.0-rtm.5"] = 609,
    ["sarif-2.1.0-rtm.6"] = 610,
    ["sarif-external-property-file-2.1.0"] = 613,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 604,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 606,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 608,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 611,
    ["schema.org - Action"] = 615,
    ["schema.org - ContactPoint"] = 616,
    ["schema.org - Place"] = 617,
    ["schema.org - Thing"] = 618,
    ["secrethub.yml"] = 883,
    ["semantic-release"] = 624,
    ["servicehub.config.json"] = 743,
    ["servicehub.service.json"] = 742,
    ["settings.job"] = 627,
    ["sfdx-hardis configuration"] = 629,
    ["shard.yml"] = 919,
    ["size-limit configuration"] = 634,
    ["skaffold.yaml"] = 807,
    ["skyuxconfig.json"] = 636,
    snapcraft = 637,
    ["spicepod.yaml"] = 939,
    ["sqlc configuration"] = 648,
    ["stripe-app-local.json"] = 657,
    ["stripe-app.json"] = 656,
    swcrc = 793,
    ["task.json"] = 663,
    taskcat = 759,
    ["template.json"] = 668,
    ["templatsources.json"] = 669,
    ["theme.json"] = 672,
    ["tizen_workspace.json"] = 673,
    tldr = 674,
    tmuxinator = 746,
    ["transcend.yml"] = 681,
    ...
    ["vega-lite.json"] = 708,
    ["vega.json"] = 707,
    ["venvironment-basic.yaml"] = 711,
    ["venvironment.yaml"] = 710,
    ["version.json"] = 713,
    ["vhwdebugger-binding.yaml"] = 715,
    ["vim-addon-info"] = 716,
    ["vs-2017.3.host.json"] = 718,
    ["vs-nesting.json"] = 719,
    ["vsls.json"] = 717,
    ["vss-extension.json"] = 723,
    ["vtesttree.yaml"] = 724,
    ["vtestunit.yaml"] = 725,
    ["warp-keysets.json"] = 889,
    ["warp-themes.json"] = 890,
    ["warp-workflows.json"] = 891,
    ["webhint.io"] = 846,
    ["webjobpublishsettings.json"] = 730,
    ["webjobs-list.json"] = 729,
    ["well-known-fursona"] = 927,
    ["xs-app.json"] = 755,
    ["xunit.runner.json"] = 741,
    yamllint = 781,
    ["zerops.io import file"] = 936,
    ["zerops.yml"] = 935,
    zuul = 765,
    ["Žinoma"] = 775
  },
