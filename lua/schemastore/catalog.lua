...
M.json = {
  ...
  index = {
    ...
    ["Ansible Argument Specs"] = 326,
    ["Ansible Collection Galaxy"] = 333,
    ["Ansible Execution Environment"] = 323,
    ["Ansible Inventory"] = 332,
    ["Ansible Meta"] = 324,
    ["Ansible Meta Runtime"] = 325,
    ["Ansible Navigator Configuration"] = 335,
    ["Ansible Playbook"] = 330,
    ["Ansible Requirements"] = 327,
    ["Ansible Rulebook"] = 331,
    ["Ansible Tasks File"] = 329,
    ["Ansible Vars File"] = 328,
    ["Ansible-lint Configuration"] = 334,
    Any = 943,
    ...
    ["Datadog Service Definition"] = 414,
    ["Datadog Software Catalog"] = 415,
    ...
    ["Fossa configuration file"] = 299,
    ["Fossa's fossa-deps file"] = 300,
    ["Foundry VTT - Base package Manifest"] = 294,
    ["Foundry VTT - Module Manifest"] = 295,
    ["Foundry VTT - System Data Template"] = 298,
    ["Foundry VTT - System Manifest"] = 296,
    ["Foundry VTT - World Manifest"] = 297,
    ["Foxx Manifest"] = 68,
    ["Freifunk.de Community API"] = 71,
    ["Frogbot Config"] = 72,
    ["G2P Mapping Configuration"] = 305,
    ["GCP Blueprint Metadata"] = 308,
    Gaspar = 306,
    ["GatewayCore API Gateway"] = 307,
    ["GeoJSON.json latest"] = 845,
    GherKing = 849,
    ["GitHub Action"] = 313,
    ["GitHub Discussion"] = 314,
    ["GitHub Funding"] = 315,
    ["GitHub Issue Template configuration"] = 316,
    ["GitHub Issue Template forms"] = 317,
    ["GitHub Workflow"] = 318,
    ["GitHub Workflow Template Properties"] = 319,
    ["GitHub automatically generated release notes configuration"] = 320,
    ["GitLab Agent for Kubernetes configuration"] = 918,
    GitVersion = 310,
    ["Gitea Issue Template configuration"] = 311,
    ["Gitea Issue Template forms"] = 312,
    ["Gitpod Configuration"] = 322,
    ["GlazeWM settings"] = 920,
    ["Global Privacy Control"] = 309,
    Goblet = 901,
    ["Golangci-lint Configuration"] = 337,
    ["Golangci-lint Custom Plugins Configuration"] = 338,
    ...
    ["Grafana 5.x Dashboard"] = 343,
    ["GraphQL Code Generator"] = 347,
    ["GraphQL Config"] = 346,
    ["GraphQL Mesh"] = 345,
    ["Grunt JSHint task"] = 351,
    ["Grunt Watch task"] = 352,
    ["Grunt base task"] = 353,
    ["Grunt clean task"] = 349,
    ["Grunt copy task"] = 348,
    ["Grunt cssmin task"] = 350,
    HEMTT = 766,
    Hadolint = 779,
    Hammerkit = 807,
    ...
    Hatch = 780,
    Hayson = 355,
    ["Haystack Pipeline"] = 356,
    ["Hazelcast 5 Configuration"] = 357,
    ["Helm Chart.lock"] = 162,
    ["Helm Chart.yaml"] = 161,
    ["Helm Unittest Test Suite"] = 163,
    Hugo = 837,
    ["Hugo Theme"] = 836,
    ["Hyperfoil benchmark configuration"] = 363,
    ["IBM Zapp document"] = 364,
    ["IBM zCodeFormatSettings"] = 365,
    ["IMG Catapult PSP"] = 370,
    ["IVMS101 by CODE Protocol"] = 919,
    Infrahub = 372,
    Istanbul = 864,
    ["JDownloader2 crawler multi-rules"] = 382,
    ["JDownloader2 crawler single-rules"] = 381,
    ["JFrog Applications Config"] = 383,
    ["JFrog File Spec"] = 384,
    ["JFrog Pipelines YML DSL"] = 870,
    ["JMeter DSL cli config"] = 385,
    JReleaser = 387,
    ["JSON Document Transform"] = 395,
    ["JSON Feed"] = 396,
    ["JSON Resume"] = 598,
    ...
    ["JSON-stat 2.0"] = 742,
    JSONPatch = 398,
    ["JSR Package Config (jsr.json)"] = 388,
    Jasmine = 376,
    Jekyll = 377,
    ["Jenkins X Pipelines"] = 378,
    ["Jenkins X Requirements"] = 379,
    Jest = 380,
    ["Jovo Language Models"] = 386,
    ["KIMMDY config file"] = 409,
    ["KSP-AVC"] = 743,
    ["KSP-CKAN"] = 744,
    ["KSP-NetKAN"] = 745,
    KSY = 931,
    KSail = 303,
    ["Karakum configuration file"] = 301,
    Kas = 401,
    ["Kestra flow file"] = 410,
    ["Keycloak REST API"] = 873,
    ["Knative Functions - func.yaml"] = 302,
    ["KoDE/CI build.yaml"] = 866,
    ["Kometa (nightly) config file"] = 412,
    ["Kometa config file"] = 411,
    ["Kong DBLess config"] = 867,
    KrakenD = 413,
    ["Kubri Configuration"] = 419,
    LOOBin = 434,
    ...
    Lefthook = 423,
    ["Liferay client-extension.yaml"] = 430,
    ["LinkML Metamodel"] = 432,
    Liquibase = 813,
    ["Liquibase Flow File"] = 814,
    ["Lively Properties"] = 433,
    ["Lobe AI Agent"] = 64,
    Loki = 65,
    ["MLOS Configs"] = 470,
    ...
    Markdownlint = 817,
    ["Mason Registry"] = 819,
    ["MegaLinter configuration"] = 442,
    ["MegaLinter descriptor"] = 443,
    Melange = 910,
    ["Meltano project definition"] = 444,
    ["Mergify Configuration"] = 474,
    ["Metadata for a Bazel module"] = 445,
    ...
    ["Ory Hydra configuration"] = 362,
    ["Ory Keto configuration"] = 416,
    ...
    ["gitlab-ci"] = 321,
    ["global.json"] = 336,
    ["go-feature-flag Flag Configuration"] = 339,
    ["haxelib.json"] = 354,
    helmfile = 781,
    helmwave = 782,
    ["host-meta.json"] = 359,
    ...
    ["ide.host.json"] = 366,
    ["ifstate.conf"] = 367,
    ["imageoptimizer.json"] = 368,
    ["importmap.json"] = 371,
    ["ioBroker Configuration"] = 373,
    ["ioBroker JSON UI"] = 374,
    ["ioBroker Package manifest"] = 375,
    ["ize.toml"] = 874,
    ["jsconfig.json"] = 399,
    ["jscpd Configuration"] = 859,
    jsdoc = 777,
    ["k3d.yaml"] = 400,
    ["k9s aliases.yaml"] = 402,
    ["k9s cluster-config.yaml"] = 404,
    ["k9s config.yaml"] = 403,
    ["k9s hotkeys.yaml"] = 405,
    ["k9s plugins.yaml"] = 406,
    ["k9s skin.yaml"] = 407,
    ["k9s views.yaml"] = 408,
    ["kontinuous-config.yaml"] = 418,
    ["kontinuous-values.yaml"] = 417,
    ["kustomization.yaml"] = 420,
    ["label-commenter-config.yml"] = 421,
    ["latexindent configuration"] = 63,
    ["launchsettings.json"] = 422,
    lazydocker = 896,
    lazygit = 895,
    ["lego.json"] = 424,
    ["lerna.json"] = 425,
    ["lgtm.yml"] = 426,
    ["liblab.config.json"] = 427,
    ["libman.json"] = 428,
    ["license-report-config.json"] = 429,
    ["linkinator.config.json"] = 431,
    ["lint-staged (.lintstagedrc)"] = 757,
    ["local.settings.json"] = 436,
    ["localazy.json"] = 437,
    ["lotus.yaml"] = 435,
    ["lsdlschema.json"] = 438,
