...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 148,
    [".cryproj (generic)"] = 498,
    [".cryproj engine-5.2"] = 493,
    [".cryproj engine-5.3"] = 494,
    [".cryproj engine-5.4"] = 495,
    [".cryproj engine-5.5"] = 496,
    [".cryproj engine-dev"] = 497,
    [".csscomb.json"] = 150,
    [".csslintrc"] = 151,
    [".eslintrc"] = 196,
    [".esmrc.json"] = 188,
    ...
    [".mtaext"] = 507,
    [".nodehawkrc"] = 314,
    [".npmpackagejsonlintrc"] = 317,
    [".phraseapp.yml"] = 351,
    [".pmbot.yml"] = 343,
    [".postcssrc"] = 348,
    [".pre-commit-config.yml"] = 349,
    [".pre-commit-hooks.yml"] = 350,
    [".putout.json"] = 368,
    [".rehyperc"] = 375,
    [".remarkrc"] = 376,
    [".sprite files"] = 419,
    ...
    ["Azure Pipelines"] = 47,
    ["Azure Static Web Apps CLI configuration file"] = 421,
    ["Azure Static Web Apps configuration file"] = 420,
    ["BX CI"] = 79,
    ["Better Code Hub"] = 541,
    ["Better Scripts"] = 80,
    BizTalkServerApplicationSchema = 513,
    ["Block Protocol Metadata"] = 78,
    Briefcase = 518,
    ["Build Info"] = 71,
    Buildkite = 73,
    ["Bukkit plugin.yml"] = 72,
    ["BungeeCord plugin.yml"] = 76,
    ["Butane Config"] = 579,
    ["CICS TS region tagging"] = 586,
    ["CICS TS resource import"] = 587,
    ["CICS TS resource model"] = 588,
    ["CICS TS resource overrides"] = 589,
    ["CMake Presets"] = 81,
    ["CNC Codes JSON Schema"] = 90,
    ["Calqulus pipeline"] = 82,
    ["Camel YAML DSL"] = 83,
    Carafe = 84,
    ["Cargo Config Schema"] = 85,
    ["Cargo Make"] = 86,
    ["Catalog Info Backstage"] = 87,
    Cheatsheets = 576,
    ...
    CodeCV = 46,
    Codux = 119,
    ["Commandbox Box.json"] = 91,
    ["Commandbox Server.json"] = 92,
    ["Common Catalog Schema"] = 128,
    ["Common types for all schemas"] = 1,
    Conjure = 89,
    ["Container Structure Test"] = 524,
    Containerlab = 549,
    ...
    ["Datahub Ingestion Recipe Schema"] = 593,
    ["Deadpendency Config Schema"] = 94,
    ...
    ["Embrace Config Schema"] = 604,
    ["Error pages"] = 191,
    Esquio = 189,
    ["Estuary Flow Catalog Schema"] = 583,
    ["Expo SDK"] = 194,
    ...
    ["Foxx Manifest"] = 48,
    ["Freifunk.de Community API"] = 50,
    ["GatewayCore API Gateway"] = 208,
    ["GeoJSON.json latest"] = 581,
    GherKing = 585,
    ["GitHub Action"] = 212,
    ["GitHub Funding"] = 213,
    ...
    Goreleaser = 222,
    ["Goreleaser Pro"] = 223,
    ["Gradle Build Cache Node"] = 538,
    ["Gradle Enterprise"] = 537,
    ...
    Hadolint = 522,
    Hammerkit = 548,
    ["Hardware Sentry Configuration"] = 597,
    Hayson = 235,
    ...
    ["JFrog File Spec"] = 254,
    ["JFrog Pipelines YML DSL"] = 606,
    ["JSON Document Transform"] = 262,
    ["JSON Feed"] = 263,
    ["JSON Resume"] = 381,
    ["JSON Schema Draft 2020-12"] = 489,
    ["JSON Schema Draft 4"] = 486,
    ["JSON Schema Draft 7"] = 487,
    ["JSON Schema Draft 8"] = 488,
    ...
    ["KSP-AVC"] = 484,
    ["KSP-CKAN"] = 485,
    ["Keycloak REST API"] = 612,
    ["Knative Functions - func.yaml"] = 206,
    ["KoDE/CI build.yaml"] = 602,
    ["Kong DBLess Schema"] = 603,
    KrakenD = 268,
    ["LinkML Metamodel"] = 280,
    Liquibase = 553,
    ["Liquibase Flow File"] = 554,
    Markdownlint = 557,
    ["MegaLinter configuration"] = 285,
    ["MegaLinter descriptor"] = 286,
    ["Meltano plugin discovery definition"] = 288,
    ["Meltano project definition"] = 287,
    ["Microsoft Band Web Tile"] = 289,
    ["Minecraft Data Pack Advancement"] = 291,
    ["Minecraft Data Pack Biome"] = 292,
    ["Minecraft Data Pack Configured Carver"] = 293,
    ["Minecraft Data Pack Dimension"] = 295,
    ["Minecraft Data Pack Dimension Type"] = 294,
    ["Minecraft Data Pack Item Modifier"] = 296,
    ["Minecraft Data Pack Loot Table"] = 297,
    ["Minecraft Data Pack Metadata"] = 298,
    ["Minecraft Data Pack Predicate"] = 299,
    ["Minecraft Data Pack Recipe"] = 300,
    ["Minecraft Data Pack Tag"] = 301,
    ["Minecraft Data Pack Template Pool"] = 302,
    ["Minecraft Resourcepack Sounds"] = 303,
    ["MongoDB Atlas Search Index Definition Schema"] = 601,
    ["Monika Configuration Schema"] = 599,
    ["Motif config"] = 506,
    ["NOX Framework (Service)"] = 316,
    ["Netin Diagnostic System Template"] = 562,
    ["Netlify config schema"] = 308,
    ["Nightwatch.js"] = 309,
    ["OSS Review Toolkit configuration"] = 333,
    ["OSS Review Toolkit curation"] = 334,
    ["OSS Review Toolkit package configuration"] = 335,
    ["OSS Review Toolkit repository configuration"] = 336,
    ["OSS Review Toolkit resolutions"] = 337,
    Opctl = 509,
    ["OpenWeather Current Weather API"] = 545,
    ["OpenWeather Road Risk API"] = 544,
    ["Ory Hydra configuration"] = 241,
    ["Ory Keto configuration"] = 270,
    ["Ory Kratos configuration"] = 332,
    ["Ory Oathkeeper configuration"] = 323,
    ["Outblocks App configuration"] = 330,
    ["Outblocks database table"] = 331,
    ["Outblocks project configuration"] = 329,
    Packer = 340,
    Pantsbuild = 618,
    ["Pipeline component"] = 555,
    ["PocketMine plugin.yml"] = 344,
    Pterodactyl = 596,
    ["Pull Request Labeler"] = 367,
    Pulumi = 371,
    PyProject = 372,
    Qodana = 572,
    ["Quali Torque Blueprint Spec 2"] = 594,
    ["QueryFirst config file"] = 615,
    ["RKE Cluster Configuration JSON Schema"] = 552,
    ["RKE Cluster Configuration YAML Schema"] = 551,
    Ray = 521,
    ["Read the Docs"] = 370,
    ["Red-DiscordBot Cog"] = 373,
    ["Red-DiscordBot Cog Repo"] = 374,
    Renovate = 382,
    ["Replit schema"] = 377,
    RoadRunner = 383,
    Ruff = 379,
    ["Rust Project"] = 380,
    ["Rust toolchain"] = 385,
    ["SIL Kit Participant Configuration"] = 410,
    SWADL = 430,
    ["Sapphire CLI Config"] = 386,
    ["SauceCTL Configuration"] = 559,
    ["Schema Catalog"] = 399,
    ["Scoop manifest"] = 404,
    ["Semgrep Rule"] = 406,
    ["Serverless Framework Configuration"] = 566,
    ["Serverless Workflow Schema"] = 568,
    ["Settings.paf"] = 408,
    ["Shopware 6 Configuration"] = 569,
    ["Shopware CLI Extension Store Configuration"] = 570,
    ["Shopware CLI Project Store Configuration"] = 571,
    Solidarity = 414,
    ["Solution filters"] = 415,
    ["Source Maps v3"] = 416,
    SpecIF = 417,
    ["Sponge Mixin configuration"] = 418,
    ["StackHawk Scanner Configuration"] = 565,
    Stale = 422,
    Starship = 423,
    ["Statamic Blueprint"] = 424,
    ["StrmPrivacy Data Connector"] = 610,
    ["StrmPrivacy Data Contract"] = 611,
    ["StrmPrivacy SimpleSchema"] = 608,
    ["StrmPrivacy Stream"] = 609,
    ["StrmPrivacy batch job configuration file"] = 607,
    ["Stryker Mutator"] = 427,
    ["StyleCop Analyzers Configuration"] = 428,
    ["Swagger API 2.0"] = 431,
    TSON = 451,
    ["Talisman configuration"] = 432,
    ["Taskfile YAML Schema"] = 547,
    Taurus = 433,
    ["TestEnvironment.json"] = 440,
    Tikibase = 436,
    ["Traefik v2"] = 443,
    ["Traefik v2 File Provider"] = 444,
    Turborepo = 441,
    Tye = 573,
    ["UI5 Manifest"] = 458,
    ["UTAM Page Object"] = 461,
    ["Ubuntu Server Autoinstall"] = 456,
    ["Uniswap Token List"] = 530,
    ["Unreal Engine Uplugin"] = 616,
    ["Unreal Engine Uproject"] = 617,
    Updatecli = 580,
    Uplift = 614,
    ["User Journey Map YAML Schema"] = 550,
    V2Ray = 584,
    ["VSCode Code Snippets"] = 124,
    ["VSIX CLI publishing"] = 474,
    ["Vela Pipeline Configuration"] = 464,
    Vercel = 123,
    ["Web App Manifest"] = 479,
    ["Web types"] = 482,
    WebExtensions = 478,
    ["Webman package recipe"] = 590,
    ["Windows Package Manager Installer Manifest"] = 527,
    ["Windows Package Manager Locale Manifest"] = 528,
    ["Windows Package Manager Singleton Manifest"] = 526,
    ["Woodpecker pipeline config"] = 561,
    ["Xstate Machine Schema"] = 578,
    ["Yippee-Ki-JSON configuration YML"] = 532,
    ["angular.json"] = 11,
    ...
    ["batect.yml"] = 54,
    ["beau.yml"] = 540,
    ["beef-database-codegen"] = 56,
    ["beef-database-v5-codegen"] = 58,
    ["beef-entity-codegen"] = 57,
    ["beef-entity-v5-codegen"] = 59,
    ["behat.yml"] = 67,
    ["bigquery-table"] = 60,
    ["bitbucket-pipelines"] = 61,
    bitrise = 62,
    ["bitrise-step"] = 63,
    ["block.json"] = 77,
    ["bower.json"] = 65,
    ["bozr.suite.json"] = 68,
    ["browser.i18n.json"] = 69,
    bucklescript = 70,
    ["bundleconfig.json"] = 75,
    ["chutzpah.json"] = 131,
    clangd = 115,
    ...
    ["ize.toml"] = 613,
    ["jsconfig.json"] = 266,
    ["jscpd Configuration Schema"] = 595,
    jsdoc = 520,
    ["k3d.yaml"] = 267,
    ...
    ["local.settings.json"] = 281,
    ["localazy.json"] = 282,
    ["lsdlschema.json"] = 283,
    ["markdown-lint-check"] = 558,
    mboats = 564,
    ["mimetypes.json"] = 290,
    ["mirrord-schema"] = 503,
    ["mta.yaml"] = 504,
    ["mtad.yaml"] = 505,
    ["mycode.json"] = 306,
    ["napari plugin manifest"] = 307,
    neoload = 515,
    ["nest-cli"] = 312,
    ["ninjs (News in JSON) 1.3"] = 311,
    ["ninjs (News in JSON) 2.0"] = 310,
    ["nlu.json"] = 313,
    ["nodemon.json"] = 315,
    ["noodl.schema.json"] = 563,
    now = 511,
    ["npm-badges"] = 318,
    ["nswag.json"] = 321,
    ntangle = 322,
    ["nuclei-template.yaml"] = 319,
    ["nuget-project.json"] = 320,
    ["ocelot.json"] = 324,
    ["omnisharp.json"] = 325,
    ["openapi.json"] = 326,
    ["openfin.json"] = 328,
    ["openrpc.json"] = 327,
    ["package.json"] = 338,
    ["package.manifest"] = 339,
    ["pattern.json"] = 342,
    ["petstore-v1.0"] = 605,
    pgap_yaml_input_reader = 341,
    ["plagiarize-me.yaml"] = 346,
    ["plagiarize.yaml"] = 345,
    ["portman.json"] = 347,
    ["prettierrc.json"] = 352,
    ["prisma.yml"] = 353,
    ["project-1.0.0-beta3.json"] = 355,
    ["project-1.0.0-beta4.json"] = 356,
    ["project-1.0.0-beta5.json"] = 357,
    ["project-1.0.0-beta6.json"] = 358,
    ["project-1.0.0-beta8.json"] = 359,
    ["project-1.0.0-rc1.json"] = 360,
    ["project-1.0.0-rc2.json"] = 361,
    ["project.json"] = 354,
    ["prometheus.json"] = 362,
    ["prometheus.rules.json"] = 363,
    ["proxies.json"] = 364,
    ["publiccode.yml"] = 365,
    ["pubspec.yaml"] = 366,
    ["pyrseas-0.8.json"] = 369,
    ["release drafter"] = 516,
    rustfmt = 384,
    ["sarif-1.0.0.json"] = 387,
    ["sarif-2.0.0.json"] = 388,
    ["sarif-2.1.0"] = 397,
    ["sarif-2.1.0-rtm.2"] = 389,
    ["sarif-2.1.0-rtm.3"] = 391,
    ["sarif-2.1.0-rtm.4"] = 393,
    ["sarif-2.1.0-rtm.5"] = 395,
    ["sarif-external-property-file-2.1.0"] = 398,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 390,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 392,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 394,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 396,
    ["schema.org - Action"] = 400,
    ["schema.org - ContactPoint"] = 401,
    ["schema.org - Place"] = 402,
    ["schema.org - Thing"] = 403,
    ["semantic-release"] = 405,
    ["servicehub.config.json"] = 492,
    ["servicehub.service.json"] = 491,
    ["settings.job"] = 407,
    ["sfdx-hardis configuration"] = 409,
    ["size-limit configuration"] = 411,
    ["skaffold.yaml"] = 556,
    ["skyuxconfig.json"] = 412,
    snapcraft = 413,
    ["stripe-app-local.json"] = 426,
    ["stripe-app.json"] = 425,
    swcrc = 543,
    taskcat = 512,
    ["template.json"] = 434,
    ["templatsources.json"] = 435,
    ["theme.json"] = 437,
    ["tizen_workspace.json"] = 438,
    tmLanguage = 439,
    tmuxinator = 500,
    ["trunk.yaml schema"] = 445,
    ["ts-force-config.json"] = 449,
    ["tsconfig.json"] = 446,
    ["tsd.json"] = 447,
    ["tsdrc.json"] = 448,
    ["tslint.json"] = 450,
    ...
    ["vega-lite.json"] = 463,
    ["vega.json"] = 462,
    ["venvironment-basic.yaml"] = 466,
    ["venvironment.yaml"] = 465,
    ["version.json"] = 467,
    ["vim-addon-info"] = 468,
    ["vs-2017.3.host.json"] = 470,
    ["vs-nesting.json"] = 471,
    ["vsls.json"] = 469,
    ["vss-extension.json"] = 475,
    ["webhint.io"] = 591,
    ["webjobpublishsettings.json"] = 481,
    ["webjobs-list.json"] = 480,
    ["xs-app.json"] = 508,
    ["xunit.runner.json"] = 490,
    yamllint = 531,
    zuul = 517,
    ["Žinoma"] = 525
  },
