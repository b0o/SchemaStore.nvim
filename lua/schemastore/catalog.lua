...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1097,
    [".nodehawkrc"] = 703,
    [".npmpackagejsonlintrc"] = 708,
    [".omletrc"] = 1278,
    [".phrase.yml"] = 790,
    [".phraseapp.yml"] = 791,
    [".pmbot.yml"] = 775,
    [".postcssrc"] = 784,
    [".powerpages-web-template-manifest"] = 786,
    [".pre-commit-config.yml"] = 787,
    [".pre-commit-hooks.yml"] = 788,
    [".putout.json"] = 824,
    [".rehyperc"] = 849,
    [".remarkrc"] = 853,
    [".sprite files"] = 955,
    ...
    AIConfig = 48,
    ["AMX Muse Program Descriptor"] = 1327,
    ["API Builder"] = 1133,
    ["AVA Configuration"] = 1197,
    ["AWS AppConfig Feature Flags-v1"] = 87,
    ["AWS CDK cdk.json"] = 316,
    ["AWS CloudFormation"] = 317,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 318,
    ["AWS Copilot Manifest"] = 1366,
    ["AWS SAM CLI Samconfig"] = 319,
    Acton = 1420,
    ["Adobe UXP Manifest"] = 1260,
    ["Aerleon Network & Service Definitions"] = 30,
    ["Aerleon Policy"] = 31,
    ["Agent Permission Policy"] = 1406,
    ["AgentCore CLI"] = 1407,
    ["AgentCtl MCP"] = 1409,
    ["AgentCtl config"] = 1408,
    ["AgentCtl permissions"] = 1410,
    AgentLoopKit = 1411,
    Aider = 1356,
    Air = 33,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1377,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1376,
    ["Airlock Microgateway"] = 49,
    ["Alacritty Configuration"] = 1169,
    ["AlgoVoi Compliance Receipt v1"] = 19,
    ["All Contributors configuration file"] = 1223,
    ["Amazon S3 bucket CORS"] = 21,
    Ameba = 1,
    Anodizer = 515,
    ["Ansible Argument Specs"] = 497,
    ["Ansible Collection Galaxy"] = 504,
    ["Ansible Execution Environment"] = 494,
    ["Ansible Inventory"] = 503,
    ["Ansible Meta"] = 495,
    ["Ansible Meta Runtime"] = 496,
    ["Ansible Navigator Configuration"] = 506,
    ["Ansible Playbook"] = 501,
    ["Ansible Requirements"] = 498,
    ["Ansible Rulebook"] = 502,
    ["Ansible Tasks File"] = 500,
    ["Ansible Vars File"] = 499,
    ["Ansible-lint Configuration"] = 505,
    Any = 1288,
    ...
    ["Application list for a WinUtil"] = 1306,
    ["ArchSmith diagram IR"] = 1445,
    ArchitectFX = 1311,
    ...
    ["Are The Types Wrong?"] = 76,
    ["Argo CD"] = 72,
    ["Argo Events"] = 73,
    ["Argo Workflows"] = 74,
    AssemblyScript = 78,
    AsyncAPI = 81,
    ["AsyncAPI Tool File"] = 82,
    ["Atmos Manifests"] = 83,
    ["Aurora Agile Meta-Framework"] = 84,
    AutoAPICase = 1233,
    ["Avro Avsc"] = 85,
    ["Awesome Repositories"] = 86,
    ["Azure Container App template for defining an immutable revision"] = 89,
    ["Azure DevOps extension manifest"] = 92,
    ["Azure Device Update for IoT Hub import manifest"] = 90,
    ["Azure Device Update for IoT Hub update manifest"] = 91,
    ["Azure IoT Edge deployment"] = 95,
    ["Azure IoT Edge deployment template"] = 96,
    ["Azure IoT EdgeAgent deployment"] = 93,
    ["Azure IoT EdgeHub deployment"] = 94,
    ["Azure IoT Operations Wasm Graph Config"] = 1375,
    ["Azure IoT Operations connector metadata"] = 1372,
    ["Azure Landing Zones Library archetype definition"] = 100,
    ["Azure Landing Zones Library archetype override"] = 101,
    ["Azure Landing Zones Library architecture definition"] = 99,
    ["Azure Landing Zones Library metadata"] = 97,
    ["Azure Landing Zones Library policy default values"] = 98,
    ["Azure Pipelines"] = 136,
    ["Azure Static Web Apps CLI configuration file"] = 959,
    ["Azure Static Web Apps configuration file"] = 958,
    BMML = 1394,
    ["BOSH BPM Config"] = 162,
    ["BOSH CPI Config"] = 163,
    ["BOSH Deploy Config"] = 164,
    ["BOSH Job Spec"] = 165,
    ["BOSH Ops File"] = 167,
    ["BOSH Package Spec"] = 166,
    ["BX CI"] = 188,
    ["Bacon config"] = 13,
    ["Barba-CV"] = 102,
    ["Bashly (bashly.yml)"] = 1227,
    ["Bashly Settings (bashly-settings.yml)"] = 1228,
    Bento = 1393,
    ["Better Code Hub"] = 1138,
    ["Better Scripts"] = 189,
    Bigconfig = 155,
    ["Biome Formatter Config"] = 103,
    ["Bitmovin Encoding Template"] = 1320,
    BizTalkServerApplicationSchema = 1104,
    Bleep = 190,
    ["Block Protocol Metadata"] = 187,
    ["Bluebricks blueprint config"] = 1399,
    ["Boyka Framework"] = 168,
    ["Bpod Finite-State Machine"] = 105,
    Briefcase = 1110,
    ["Build Info"] = 178,
    Buildkite = 180,
    ["Bukkit plugin.yml"] = 179,
    ["BungeeCord plugin.yml"] = 185,
    ["Burnless SRE config"] = 6,
    ["Butane Config"] = 1182,
    C4InterFlow = 1335,
    ["CDK Environment Manager, concrete environment configuration"] = 1359,
    ["CDK Environment Manager, concrete environments definition"] = 1358,
    ["CDK Environment Manager, environment definition"] = 1357,
    ["CGS Card Game Specification (cgs.json)"] = 1265,
    ["CICS TS region tagging"] = 1191,
    ["CICS TS resource import"] = 1192,
    ["CICS TS resource model"] = 1193,
    ["CICS TS resource overrides"] = 1194,
    ["CMake Presets"] = 191,
    ["CNC Codes"] = 214,
    ["CRS WAF test file"] = 1295,
    ["CRS WAF test platform overrides file"] = 1296,
    ["CSS Comb (.csscomb.json)"] = 346,
    ["CSS Lint (.csslintrc)"] = 347,
    ["CSpell (cspell.json)"] = 345,
    ["CVE Record Format"] = 226,
    ["CVX achievements.yaml"] = 232,
    ["CVX competencies.yaml"] = 231,
    ["CVX config.yaml"] = 235,
    ["CVX education.yaml"] = 230,
    ["CVX experience.yaml"] = 229,
    ["CVX keywords.yaml"] = 234,
    ["CVX layout"] = 236,
    ["CVX personal.yaml"] = 227,
    ["CVX referees.yaml"] = 233,
    ["CVX summary.yaml"] = 228,
    CWL = 1271,
    ["Cache Warmup config"] = 192,
    ["Caido Proxy Configuration"] = 1435,
    ["Calqulus pipeline"] = 193,
    ["Camel YAML DSL"] = 194,
    ["Cannon TOML"] = 195,
    Carafe = 196,
    ["Cargo Make"] = 198,
    ["Cargo Manifest"] = 197,
    ["Catalog Info Backstage"] = 199,
    ["Chamaleon environment"] = 1324,
    ["Chamaleon properties"] = 1325,
    ["Chamaleon template"] = 1323,
    Changepacks = 1386,
    Changesets = 328,
    Changie = 200,
    Charmcraft = 201,
    Cheatsheets = 1179,
    ["ChordPro Configuration"] = 203,
    ["Chrome Extension"] = 309,
    ["Chromia Model"] = 204,
    ["Chromia Seeder Module Config"] = 206,
    ["Chromia Seeder Root Config"] = 205,
    ["Cinnamon Spice info.json"] = 113,
    ["CircleCI config.yml"] = 279,
    ["Citation File Format"] = 330,
    ["Citrus test case"] = 208,
    CityJSON = 209,
    ["Claude Code Keybindings"] = 221,
    ["Claude Code Launch Preview"] = 1444,
    ["Claude Code Plugin Manifest"] = 222,
    ["Claude Code Plugin Marketplace"] = 223,
    ["Claude Code Settings"] = 224,
    ["Clawject config"] = 220,
    ["Cloud Foundry Application Manifest"] = 1277,
    ["Cloud Run Spec v1"] = 1301,
    ["Cloud.gov Workshop Configuration"] = 114,
    ["CloudCannon Configuration"] = 119,
    ["CloudCannon Configuration (Collection Structures)"] = 128,
    ["CloudCannon Configuration (Collections)"] = 127,
    ["CloudCannon Configuration (Editables)"] = 126,
    ["CloudCannon Configuration (Inputs)"] = 121,
    ["CloudCannon Configuration (Snippets Definitions)"] = 125,
    ["CloudCannon Configuration (Snippets Imports)"] = 124,
    ["CloudCannon Configuration (Snippets)"] = 123,
    ["CloudCannon Configuration (Structure Value)"] = 122,
    ["CloudCannon Configuration (Structures)"] = 120,
    ["CloudEvents specification"] = 210,
    ["Code Climate"] = 280,
    CodeCV = 117,
    CodeRabbit = 116,
    ["CodeShip Pro services configuration files"] = 298,
    ["CodeShip Pro steps configuration files"] = 299,
    ["Codecov configuration files"] = 297,
    Codex = 288,
    ["Codex Hooks"] = 289,
    ["Codex Plugin Manifest"] = 290,
    ["Codex Skill Metadata"] = 291,
    CodifyCLI = 118,
    Codux = 293,
    ["Cog config file"] = 215,
    ["Commandbox Box.json"] = 216,
    ["Commandbox Server.json"] = 217,
    ["Common Catalog Data"] = 307,
    ["Common Package Specification"] = 218,
    Concord = 1294,
    ["Configu .cfgu files"] = 1282,
    ["Configu .configu file"] = 1283,
    Conjure = 213,
    ["Container Structure Test"] = 1118,
    Containerlab = 1147,
    ["Context Passport"] = 2,
    ["Contextive Glossary"] = 1351,
    ContractGuard = 1148,
    Convex = 212,
    ["Crowdsec collection config"] = 339,
    ["Crowdsec parser config"] = 340,
    ["Crowdsec scenario config"] = 341,
    ["CumulusCI Config"] = 219,
    ["Cursor Agent Environment"] = 1404,
    ["Custom Machinery Machine"] = 1266,
    ["Custom Machinery Recipe"] = 1267,
    ["Cycle Stack File"] = 237,
    CycloneDX = 238,
    ["DWP Exchange - catalogue entry"] = 395,
    ["DWP Exchange - gateway"] = 393,
    ["DWP Exchange - meta"] = 394,
    ["Dagger module"] = 348,
    ["Dark Factory consumer config"] = 239,
    ["Dart Build Config (dart-build.json)"] = 349,
    ["Dart Test Config (dart-test.json)"] = 350,
    ["DashLord Configuration"] = 351,
    ["Data Contract Specification"] = 352,
    ["Data Product Specification"] = 353,
    ["DataYoga Connections"] = 240,
    ["DataYoga Job"] = 241,
    ["Datadog Continuous Testing"] = 604,
    ["Datadog Service Definition"] = 605,
    ["Datadog Software Catalog"] = 606,
    ["Datahub Ingestion Recipe"] = 1198,
    ["Debian Upstream Metadata file"] = 248,
    DebtLens = 249,
    ["Deck config"] = 250,
    ["Declarative Automation Bundles"] = 1244,
    ["DeepMatch deeplinks spec"] = 251,
    ["Dein Config"] = 252,
    ["Deno Config (deno.json)"] = 361,
    ["Dependency cruiser"] = 253,
    ["DeployStack Configuration"] = 254,
    ["Deployah Configuration"] = 1374,
    ["Deployer Recipe"] = 364,
    ["Design Tokens Community Group format"] = 255,
    ["Design Tokens Community Group resolver"] = 256,
    ["Deta Spacefile"] = 257,
    ["Detekt Config (detekt.yml)"] = 365,
    ["Devbox Config"] = 258,
    ["Devbox Plugin"] = 259,
    Devfile = 392,
    Devup = 1387,
    DipDup = 1297,
    ["Discord Webhook"] = 366,
    ["DocFx Config (docfx.json)"] = 371,
    ["Docker Desktop extension metadata"] = 368,
    ["Docs MCP Manifest"] = 372,
    Dofigen = 373,
    ["Dolittle Artifacts"] = 374,
    ["Dolittle Bounded Context Configuration"] = 375,
    ["Dolittle Event Horizons Configuration"] = 376,
    ["Dolittle Resources Configuration"] = 377,
    ["Dolittle Server Configuration"] = 378,
    ["Dolittle Tenant Map Configuration"] = 380,
    ["Dolittle Tenants Configuration"] = 379,
    ["Dolittle Topology"] = 381,
    ["DonateCaseBetterCasino menu"] = 1328,
    ["Draugr Saga"] = 359,
    ["Draugr Saga fragment"] = 360,
    ["Drupal Breakpoints"] = 261,
    ["Drupal Config"] = 273,
    ["Drupal Info"] = 262,
    ["Drupal Layouts"] = 263,
    ["Drupal Libraries"] = 264,
    ["Drupal Links Action"] = 265,
    ["Drupal Links Contextual"] = 266,
    ["Drupal Links Menu"] = 267,
    ["Drupal Links Task"] = 268,
    ["Drupal Migration"] = 269,
    ["Drupal Permissions"] = 270,
    ["Drupal Recipe"] = 271,
    ["Drupal Routing"] = 272,
    ["Drupal Services"] = 274,
    ["Drush site aliases"] = 387,
    ["Dust configuration"] = 390,
    ["Dynamic Bash Aliases (.aliases)"] = 1235,
    ["EAS config"] = 434,
    ["ECA - Editor Code Assistant"] = 397,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1224,
    ["ESLint Suppressions"] = 439,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1371,
    ["EasyVCR .NET"] = 436,
    ["Eidolon Resource"] = 1312,
    ["Elgato Stream Deck"] = 400,
    Elm = 1299,
    ["Embrace Config"] = 1210,
    Emmet = 1300,
    Endurica = 1248,
    ["Enonic XP API descriptor"] = 403,
    ["Enonic XP Admin Extension descriptor"] = 404,
    ["Enonic XP Admin Tool descriptor"] = 405,
    ["Enonic XP Application descriptor"] = 406,
    ["Enonic XP CMS descriptor"] = 407,
    ["Enonic XP Content Type descriptor"] = 408,
    ["Enonic XP Form Fragment descriptor"] = 409,
    ["Enonic XP ID Provider descriptor"] = 410,
    ["Enonic XP Layout descriptor"] = 411,
    ["Enonic XP Macro descriptor"] = 412,
    ["Enonic XP Mixin descriptor"] = 413,
    ["Enonic XP Page descriptor"] = 414,
    ["Enonic XP Part descriptor"] = 415,
    ["Enonic XP Service descriptor"] = 416,
    ["Enonic XP Site descriptor"] = 417,
    ["Enonic XP Style descriptor"] = 418,
    ["Enonic XP Task descriptor"] = 419,
    ["Enonic XP Webapp descriptor"] = 420,
    ["Enterprise Contract Policy Spec"] = 401,
    ["Envelope Team Definition"] = 1419,
    ["Envilder Map File"] = 402,
    ["Erda Pipeline"] = 1273,
    ["Erda Runtime"] = 1274,
    ["Espanso config.yml"] = 1397,
    ["Espanso match.yml"] = 1396,
    Esquio = 422,
    ["Estuary Flow Catalog"] = 1188,
    ["Ethereum ERC1155"] = 1413,
    ["Ethereum ERC721"] = 1412,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 427,
    ["EveryVoice TTS Toolkit Data Configuration"] = 428,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 432,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 431,
    ["EveryVoice TTS Toolkit Text Configuration"] = 429,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 430,
    ["Evolving Resolutive Process notation"] = 1373,
    ["Expo SDK"] = 433,
    ["Expoot app config"] = 435,
    ["F-Droid Data metadata"] = 441,
    ["FasterCI Configuration"] = 137,
    ["Fence configuration"] = 138,
    FiQuS = 445,
    Firebase = 443,
    ["Flatpak Builder Manifest"] = 446,
    ["FlexGet Config"] = 447,
    ["Flow.json Configurations"] = 1270,
    ["Fossa configuration file"] = 454,
    ["Fossa's fossa-deps file"] = 455,
    ["Foundry VTT - Base package Manifest"] = 449,
    ["Foundry VTT - Module Manifest"] = 450,
    ["Foundry VTT - System Data Template"] = 453,
    ["Foundry VTT - System Manifest"] = 451,
    ["Foundry VTT - World Manifest"] = 452,
    ["Foxx Manifest"] = 139,
    ["Freifunk.de Community API"] = 142,
    ["Frogbot Config"] = 143,
    ["G2P Mapping Configuration"] = 462,
    GAMA = 463,
    ["GCP Blueprint Metadata"] = 466,
    Gaspar = 464,
    ["GatewayCore API Gateway"] = 465,
    ["Gemini CLI settings"] = 467,
    ["GeoJSON.json latest"] = 1186,
    GherKing = 1190,
    ["GitHub Action"] = 477,
    ["GitHub Actions typing"] = 1308,
    ["GitHub CLI configuration"] = 478,
    ["GitHub CLI hosts"] = 479,
    ["GitHub Discussion"] = 480,
    ["GitHub Funding"] = 482,
    ["GitHub Issue Template configuration"] = 483,
    ["GitHub Issue Template forms"] = 484,
    ["GitHub Pages Jekyll"] = 485,
    ["GitHub Prompt"] = 481,
    ["GitHub Secret Scanning"] = 486,
    ["GitHub Workflow"] = 487,
    ["GitHub Workflow Template Properties"] = 488,
    ["GitHub automatically generated release notes configuration"] = 489,
    ["GitLab Agent for Kubernetes configuration"] = 1262,
    ["GitLab Duo Workflow"] = 491,
    GitResume = 493,
    GitVersion = 470,
    ["Gitea Issue Template configuration"] = 473,
    ["Gitea Issue Template forms"] = 474,
    Gitleaks = 471,
    ["Gitpod Configuration"] = 492,
    ["Glamour style"] = 468,
    ["GlazeWM settings"] = 1264,
    ["Global Privacy Control"] = 469,
    Goblet = 1243,
    ["Golangci-lint Configuration"] = 508,
    ["Golangci-lint Custom Plugins Configuration"] = 509,
    ["Google Chrome Related Website Sets"] = 444,
    ["Google Cloud Workflows"] = 315,
    ["Google Digital Assetlinks"] = 1352,
    Goreleaser = 513,
    ["Goreleaser Pro"] = 514,
    Goss = 516,
    ["Gradle Build Cache Node"] = 1136,
    ["Gradle Enterprise"] = 1135,
    ["Grafana 5.x Dashboard"] = 517,
    ["GraphQL Code Generator"] = 522,
    ["GraphQL Config"] = 521,
    ["GraphQL Mesh"] = 520,
    ["GroovyLint configuration"] = 523,
    ["Grunt JSHint task"] = 527,
    ["Grunt Watch task"] = 528,
    ["Grunt base task"] = 529,
    ["Grunt clean task"] = 525,
    ["Grunt copy task"] = 524,
    ["Grunt cssmin task"] = 526,
    HEMTT = 1100,
    Hadolint = 1114,
    Hammerkit = 1146,
    ["Hardware Sentry Configuration"] = 1202,
    ["Hashgraph Online Skill Manifest"] = 9,
    ["HashiCorp Vault"] = 530,
    Hatch = 1115,
    Hayson = 532,
    ["Haystack Pipeline"] = 533,
    ["Hazelcast 5 Configuration"] = 534,
    ["Hecate Input Schema"] = 1363,
    ["Helm Chart.lock"] = 276,
    ["Helm Chart.yaml"] = 275,
    ["Helm Unittest Test Suite"] = 277,
    ["Heloisa Assistant Plugins Marketplace"] = 1442,
    ["Hex file"] = 278,
    ["Home Assistant Integration Manifest"] = 536,
    ["Homer dashboard configuration"] = 537,
    ["Hoverfly Simulation"] = 542,
    Hugo = 1178,
    ["Hugo Theme"] = 1177,
    ["Hulak Configuration"] = 545,
    ["Hyperfoil benchmark configuration"] = 544,
    ["IBM Zapp document"] = 546,
    ["IBM zCodeFormatSettings"] = 547,
    ["IMG Catapult PSP"] = 552,
    ["IVMS101 by CODE Protocol"] = 1263,
    ["Infinispan Configuration"] = 554,
    ["Infinispan Server Configuration"] = 555,
    Infrahub = 556,
    Istanbul = 1206,
    ["JDownloader2 crawler multi-rules"] = 570,
    ["JDownloader2 crawler single-rules"] = 569,
    ["JFrog Applications Config"] = 571,
    ["JFrog File Spec"] = 572,
    ["JFrog Pipelines YML DSL"] = 1212,
    ["JMeter DSL cli config"] = 573,
    JReleaser = 576,
    ["JSON Document Transform"] = 584,
    ["JSON Feed"] = 585,
    ["JSON Resume"] = 862,
    ["JSON Schema Draft 2020-12"] = 1080,
    ["JSON Schema Draft 4"] = 1077,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1245,
    ["JSON Schema Draft 7"] = 1078,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1246,
    ["JSON Schema Draft 8 (2019-09)"] = 1079,
    ["JSON-API"] = 583,
    ["JSON-e templates"] = 1143,
    ["JSON-stat 2.0"] = 1073,
    JSONPatch = 587,
    ["JSR Package Config (jsr.json)"] = 577,
    Jarl = 1379,
    Jasmine = 564,
    Jekyll = 565,
    ["Jenkins X Pipelines"] = 566,
    ["Jenkins X Requirements"] = 567,
    Jest = 568,
    Jocker = 574,
    ["Jovo Language Models"] = 575,
    Jsontron = 588,
    ["Jujutsu (jj) VCS config"] = 1365,
    ["KIMMDY config file"] = 599,
    ["KODE/CI build.yaml"] = 1208,
    ["KSP-AVC"] = 1074,
    ["KSP-CKAN"] = 1075,
    ["KSP-NetKAN"] = 1076,
    KSY = 1275,
    KSail = 460,
    ["KYA Manifest"] = 1276,
    ["Karakum configuration file"] = 456,
    Kas = 591,
    ["Kestra flow file"] = 600,
    ["Keycloak REST API"] = 1215,
    ["Knative Functions - func.yaml"] = 457,
    Knip = 458,
    ["Knip JSONC"] = 459,
    ["Knowledge Unit"] = 608,
    ["Kometa (nightly) config file"] = 602,
    ["Kometa config file"] = 601,
    ["Kong DBLess config"] = 1209,
    KrakenD = 603,
    ["Kubri Configuration"] = 611,
    LOOBin = 629,
    ["Lake configuration file"] = 1368,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 320,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 321,
    ["Landing Zone Accelerator on AWS - Global Config"] = 322,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 323,
    ["Landing Zone Accelerator on AWS - Network Config"] = 324,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 325,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 326,
    ["Landing Zone Accelerator on AWS - Security Config"] = 327,
    ["Lando (landofile)"] = 129,
    ["LangGraph Platform configuration"] = 1287,
    ["Language configuration"] = 1286,
    Lefthook = 616,
    ["Liferay client-extension.yaml"] = 623,
    ["LinkML Metamodel"] = 625,
    ["LiquiLens Evidence Carrier Reference v1"] = 627,
    ["LiquiLens Evidence Carrier v1"] = 626,
    Liquibase = 1153,
    ["Liquibase Flow File"] = 1154,
    ["Lively Properties"] = 628,
    ["Lobe AI Agent"] = 131,
    Loki = 132,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 672,
    ["MS2Rescore Configuration"] = 680,
    ["MSTest testconfig.json"] = 681,
    ["Madge configuration"] = 635,
    ["Madness (madness.yml)"] = 1226,
    ["Mado configuration"] = 636,
    ["Maestro Flow"] = 637,
    ["Mail Servers Configuration"] = 1400,
    ["MapEHR Mapping"] = 638,
    Markdownlint = 1157,
    ["Mason Registry"] = 1160,
    ["MegaLinter Custom Flavor"] = 641,
    ["MegaLinter configuration"] = 640,
    ["MegaLinter descriptor"] = 642,
    Melange = 1253,
    ["Meltano project definition"] = 643,
    ["Mergify Configuration"] = 682,
    ["Mermaid config"] = 4,
    ["Metadata for a Bazel module"] = 644,
    ["Metadata for a Cinnamon spice"] = 1304,
    ["Metatype Configuration"] = 645,
    ["MetricsHub Configuration"] = 646,
    ["MetricsHub Connector Configuration"] = 647,
    ["Micro Editor Syntax"] = 1236,
    ["Microsoft Band Web Tile"] = 648,
    ["Microsoft RulesEngine workflow rules"] = 1291,
    ["Microsoft RulesEngine workflow rules list"] = 1292,
    ["Minecraft Custom Main Menu Mod"] = 1254,
    ["Minecraft Data Pack Advancement"] = 650,
    ["Minecraft Data Pack Biome"] = 651,
    ["Minecraft Data Pack Configured Carver"] = 652,
    ["Minecraft Data Pack Damage Type"] = 653,
    ["Minecraft Data Pack Dimension"] = 655,
    ["Minecraft Data Pack Dimension Type"] = 654,
    ["Minecraft Data Pack Item Modifier"] = 656,
    ["Minecraft Data Pack Loot Table"] = 657,
    ["Minecraft Data Pack Metadata"] = 658,
    ["Minecraft Data Pack Predicate"] = 659,
    ["Minecraft Data Pack Recipe"] = 660,
    ["Minecraft Data Pack Tag"] = 661,
    ["Minecraft Data Pack Template Pool"] = 662,
    ["Minecraft Data Pack Trim Material"] = 667,
    ["Minecraft Data Pack Trim Pattern"] = 668,
    ["Minecraft Resource Pack Lang"] = 663,
    ["Minecraft Resource Pack Particle"] = 664,
    ["Minecraft Resource Pack Texture Mcmeta"] = 666,
    ["Minecraft Resourcepack Sounds"] = 665,
    ["MockServer Expectation"] = 674,
    ["MockServer Expectations"] = 675,
    ModuleAssembler = 670,
    ["Monade CLI Stack Configuration"] = 685,
    ["MongoDB Atlas Search Index Definition"] = 1207,
    ["Monika Configuration"] = 1205,
    ["Monoweave Configuration"] = 679,
    ["Motif config"] = 1096,
    MultiQC = 1345,
    ["NOX Framework (Service)"] = 707,
    ["Netin Diagnostic System Template"] = 1164,
    ["Netlify config"] = 688,
    ["Network-as-Code Data Model"] = 689,
    ["Next Gen UI Agent A2A Server Configuration"] = 690,
    ["Next Gen UI Agent Configuration"] = 692,
    ["Next Gen UI Agent MCP Server Configuration"] = 691,
    ["Nightwatch.js"] = 699,
    ["Nika workflow"] = 704,
    ["Node.js configuration"] = 1101,
    ["NueJS configuration file"] = 712,
    ["Nuitka Package Config"] = 1268,
    ["Nullstone config"] = 714,
    ["ODGS Data Rules"] = 721,
    ["ODGS Ontology Graph"] = 722,
    ["ODGS Standard Metrics"] = 720,
    ["OKF Graph"] = 1443,
    ["ONe's changelog entry"] = 736,
    ["ONe's service descriptor"] = 735,
    ["ORT Server repository environment configuration"] = 747,
    ["OSCAL Assessment Plan (AP)"] = 749,
    ["OSCAL Assessment Results (AR)"] = 750,
    ["OSCAL Catalog"] = 751,
    ["OSCAL Component Definition (CDef)"] = 752,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 753,
    ["OSCAL Profile"] = 754,
    ["OSCAL System Security Plan (SSP)"] = 755,
    ["OSS Review Toolkit configuration"] = 756,
    ["OSS Review Toolkit curation"] = 757,
    ["OSS Review Toolkit package configuration"] = 758,
    ["OSS Review Toolkit project package manager definition"] = 759,
    ["OSS Review Toolkit repository configuration"] = 760,
    ["OSS Review Toolkit resolutions"] = 761,
    ["October CMS columns"] = 718,
    ["October CMS fields"] = 719,
    ["Oh My Posh"] = 724,
    Okteto = 725,
    ["Ona Tasks and Services"] = 727,
    Opctl = 1099,
    ["Open Data Contract Standard (ODCS)"] = 740,
    ["Open Data Product Standard (ODPS)"] = 741,
    ["Open Know-How"] = 1350,
    ["Open Pentest Format"] = 742,
    OpenDecree = 1417,
    ["OpenDecree Configuration"] = 1418,
    ["OpenRewrite Resource"] = 738,
    OpenSRM = 743,
    OpenStatus = 1361,
    ["OpenTelemetry Declarative Configuration"] = 739,
    ["OpenUtau character yaml"] = 732,
    ["OpenUtau ustx"] = 733,
    ["OpenWeather Current Weather API"] = 1142,
    ["OpenWeather Road Risk API"] = 1141,
    ["Ory Hydra configuration"] = 543,
    ["Ory Keto configuration"] = 607,
    ["Ory Kratos configuration"] = 748,
    ["Ory Oathkeeper configuration"] = 716,
    ["Outblocks App configuration"] = 745,
    ["Outblocks database table"] = 746,
    ["Outblocks project configuration"] = 744,
    PDM = 769,
    POPxf = 781,
    ["POPxf Correlations"] = 782,
    ["PRML manifest"] = 789,
    Packer = 765,
    PactSpec = 766,
    Panache = 767,
    Pantsbuild = 1222,
    ["Paper paper-plugin.yml"] = 768,
    ["Pipeline component"] = 1155,
    ["Platform.sh application"] = 15,
    ["Platform.sh routes"] = 16,
    ["Platform.sh services"] = 17,
    ["Plex Prerolls"] = 779,
    ["PocketMine plugin.yml"] = 776,
    ["Podman Desktop Extension"] = 1437,
    ["Postman collection"] = 785,
    ["Power Pages Configuration"] = 1362,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1307,
    ["ProActions AI-Kit Configuration"] = 797,
    ["ProActions AI-Kit Configuration for Menus"] = 799,
    ["ProActions AI-Kit Configuration for Sections"] = 801,
    ["ProActions AI-Kit Configuration for Services"] = 798,
    ["ProActions AI-Kit Configuration for Steps"] = 802,
    ["ProActions AI-Kit Configuration for Templates"] = 800,
    ["Problem object RFC9457"] = 1251,
    ["Problem package format"] = 803,
    ["Problem package generators"] = 804,
    ["Problem package submissions"] = 805,
    ["Problem package test group metadata"] = 806,
    Pterodactyl = 1201,
    ["Pull Request Labeler"] = 823,
    Pulumi = 831,
    ["PyGTA Config"] = 827,
    PyProject = 832,
    Pylock = 1353,
    Pyright = 833,
    ["Python script metadata"] = 1347,
    ["QType AI DSL"] = 836,
    Qgoda = 835,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1429,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1427,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1433,
    ["Qlik Talend Cloud Pipeline - Project"] = 1425,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1428,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1430,
    ["Qlik Talend Cloud Pipeline - Task"] = 1426,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1432,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1431,
    Qodana = 1174,
    ["Qt Creator workspace file"] = 1284,
    ["Quali Torque Blueprint Spec 2"] = 1199,
    ["QueryFirst config file"] = 1218,
    ["QuikRun Configuration"] = 1434,
    ["Qwen Code Settings"] = 1414,
    ["RKE Cluster Configuration JSON"] = 1152,
    ["RKE Cluster Configuration YAML"] = 1151,
    RadioHound = 826,
    ["Raid Profile"] = 1415,
    ["Raid Repo Configuration"] = 1416,
    Railpack = 838,
    Railway = 837,
    ["Rancher Fleet"] = 828,
    ["Rattler-build"] = 839,
    Ray = 1113,
    ["Read the Docs"] = 830,
    ["Red-DiscordBot Cog"] = 846,
    ["Red-DiscordBot Cog Repo"] = 847,
    ["Red-DiscordBot Trivia"] = 848,
    ["Releasaurus Config"] = 12,
    ReleaseKit = 11,
    ["Render Blueprints"] = 1150,
    RenderCV = 866,
    Renovate = 863,
    ["Renovate global configuration"] = 864,
    ["Renovate inherited configuration"] = 865,
    ["Replit config"] = 854,
    Restate = 1340,
    ["Revel Digital Gadget Definition File"] = 1364,
    RoadRunner = 868,
    ["Robust Station Image"] = 1370,
    Rockcraft = 869,
    ["Roo Coder Custom Modes"] = 870,
    Rubocop = 859,
    ["Rudder techniques"] = 1258,
    Ruff = 860,
    ["Rust Project"] = 861,
    ["Rust toolchain"] = 875,
    ["SDMX data message"] = 902,
    ["SDMX metadata message"] = 901,
    ["SDMX structure message"] = 900,
    ["SIL Kit Participant Configuration"] = 913,
    ["SIL Kit Registry Configuration"] = 914,
    ["SPDX 2.3"] = 956,
    SWADL = 972,
    ["Safebox Config"] = 1213,
    ["Sapphire CLI Config"] = 878,
    ["SauceCTL Configuration"] = 1161,
    Scarb = 898,
    ["Schema Catalog"] = 893,
    ["Scoop manifest"] = 899,
    ["Secure SDLC Evidence Bundle"] = 903,
    ["Semantic Data Fabric (SDF) file"] = 904,
    ["Semgrep Rule"] = 906,
    ["Serenity Code Generator (Sergen)"] = 907,
    ["Serverless Framework Configuration"] = 1168,
    ["Serverless Workflow"] = 1170,
    ["Settings for a Cinnamon spice"] = 1303,
    ["Settings.paf"] = 909,
    ["Shopware 6 Configuration"] = 1171,
    ["Shopware CLI Extension Store Configuration"] = 1172,
    ["Shopware CLI Project Store Configuration"] = 1173,
    ["Sigma Detection Rule"] = 911,
    ["SigmaCV CV"] = 7,
    ["Sigrid scope configuration file"] = 912,
    ["SkyPilot Task JSON"] = 1259,
    ["Slack app manifest"] = 919,
    ["Slang Server Configuration"] = 1441,
    Snapcraft = 921,
    ["Solarxy project config"] = 924,
    Solidarity = 925,
    ["Solution filters"] = 926,
    ["Source Maps v3"] = 927,
    Sourcery = 928,
    ["Spack bootstrap.yaml"] = 929,
    ["Spack cdash.yaml"] = 930,
    ["Spack ci.yaml"] = 931,
    ["Spack compilers.yaml"] = 932,
    ["Spack concretizer.yaml"] = 933,
    ["Spack config.yaml"] = 934,
    ["Spack definitions.yaml"] = 935,
    ["Spack develop.yaml"] = 936,
    ["Spack env_vars.yaml"] = 937,
    ["Spack environment"] = 943,
    ["Spack include.yaml"] = 938,
    ["Spack mirrors.yaml"] = 939,
    ["Spack modules.yaml"] = 940,
    ["Spack packages.yaml"] = 941,
    ["Spack repos.yaml"] = 942,
    ["Spack toolchains.yaml"] = 944,
    ["Spack upstreams.yaml"] = 945,
    ["Spack view.yaml"] = 946,
    ["Speakeasy Generation Config File"] = 950,
    ["Speakeasy Lint Configuration File"] = 947,
    ["Speakeasy Test Generation Configuration File"] = 948,
    ["Speakeasy Workflow File"] = 949,
    SpecIF = 951,
    ["Specmatic Configuration"] = 952,
    ["Specpin spec file"] = 5,
    ["Sponge Mixin configuration"] = 953,
    ["Spotlight Ruleset"] = 954,
    StackBlitz = 960,
    ["StackHawk Scanner Configuration"] = 1167,
    Stale = 961,
    Starfish = 962,
    ["Starlake Data Pipeline"] = 1139,
    Starship = 963,
    ["Statamic Blueprint"] = 964,
    ["Stella configuration file"] = 965,
    ["Streamlit configuration file"] = 966,
    ["Stryker Mutator"] = 969,
    ["StyleCop Analyzers Configuration"] = 970,
    ["Stylelint (.stylelintrc)"] = 971,
    ["Stylua Config"] = 1354,
    ["Sublime Syntax"] = 1214,
    ["Subsquid squid manifest"] = 1261,
    ["Swagger API 2.0"] = 973,
    ["Symfony Routing Configuration"] = 974,
    ["Symfony Serializer Mapping"] = 975,
    ["Symfony Services Configuration"] = 976,
    ["Symfony Validation Mapping"] = 977,
    ["Synadia Connect Component"] = 978,
    TSON = 1021,
    TSTyche = 1022,
    ["TYPO3 Vendor Bundler config"] = 1028,
    ["Tab data for a LinUtil"] = 1310,
    ["Tab list for a LinUtil"] = 1309,
    Tach = 979,
    ["Tach Domain"] = 980,
    Talhelper = 982,
    ["Talisman configuration"] = 983,
    Taplo = 1355,
    ["Taskfile config"] = 1144,
    Taurus = 984,
    Tauticord = 985,
    ["Tekton Pipeline"] = 1383,
    ["Tekton PipelineRun"] = 1384,
    ["Tekton Task"] = 1381,
    ["Tekton TaskRun"] = 1382,
    Telefonistka = 1341,
    ["Terraform PowerShell provider block manifest"] = 988,
    ["Terraform PowerShell provider data source manifest"] = 989,
    ["Terraform PowerShell provider resource manifest"] = 990,
    ["Terraform PowerShell provider settings"] = 991,
    ["Terrateam config"] = 1367,
    ["Tesseract configuration"] = 992,
    ["TestEnvironment.json"] = 1002,
    ["TextMate Grammar"] = 1001,
    Threagile = 996,
    ["Tier.run pricing.json"] = 993,
    Tikibase = 994,
    Tombi = 999,
    ["Traefik v2"] = 1005,
    ["Traefik v2 File Provider"] = 1006,
    ["Traefik v3"] = 1007,
    ["Traefik v3 File Provider"] = 1008,
    ["Travis CI (.travis.yml)"] = 1004,
    Treefmt = 519,
    Trident = 1337,
    Trivy = 1011,
    ["TrueScript for *.tscript files"] = 1012,
    ["Tugboat QA config.yml"] = 1334,
    TunnelHub = 1249,
    Turborepo = 1003,
    Tycho = 1298,
    Tye = 1175,
    ["Tyk Gateway - Open Source v5.7+"] = 1346,
    ["UET BuildConfig.json"] = 1219,
    ["UI5 Manifest"] = 1034,
    ["UNCORS configuration"] = 1039,
    ["UTAM Page Object"] = 1037,
    ["Ubuntu Server Autoinstall"] = 1032,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1338,
    ["Uniswap Token List"] = 1124,
    ["Universal Schedule Format"] = 1040,
    ["Unreal Engine Uplugin"] = 1220,
    ["Unreal Engine Uproject"] = 1221,
    ["UpCloud CLI (upctl) configuration"] = 1339,
    ["Updatecli Compose"] = 1183,
    ["Updatecli Policy Manifest"] = 1184,
    ["Updatecli Policy Metadata"] = 1185,
    Uplift = 1217,
    ["Upsun config"] = 14,
    ["User Journey Map"] = 1149,
    V2Ray = 1189,
    ["VSCode Code Snippets"] = 303,
    ["VSIX CLI publishing"] = 1060,
    Vector = 1042,
    ["Vee JSON menu output"] = 1043,
    ["Vela Pipeline Configuration"] = 1046,
    Vercel = 302,
    ["Version Bumper config"] = 1049,
    Vespertide = 1388,
    ["Vespertide Migration"] = 1389,
    ["Vespertide Model"] = 1390,
    ["Viash Component Config"] = 1343,
    ["Viash Package Config"] = 1344,
    Visivo = 1247,
    Vogi = 1054,
    ["WP-CLI"] = 1070,
    Wake = 1336,
    ["Waku Config"] = 1313,
    ["Web App Manifest"] = 1066,
    ["Web types"] = 1069,
    WebExtensions = 1065,
    ["Webman package recipe"] = 1195,
    ["Windows Package Manager Installer Manifest"] = 1121,
    ["Windows Package Manager Locale Manifest"] = 1122,
    ["Windows Package Manager Singleton Manifest"] = 1120,
    ["WireMock CLI import configuration"] = 1319,
    ["WireMock CLI local service configuration"] = 1318,
    ["WireMock message stub mapping"] = 1317,
    ["WireMock stub mapping"] = 1316,
    ["Woodpecker pipeline config"] = 1163,
    ["Wrangler CLI"] = 1071,
    ["XenForo add-on manifest"] = 1072,
    ["Xstate Machine"] = 1181,
    ["Yandex Workflow Language"] = 1305,
    ["Yarn Config (.yarnrc.yml)"] = 1137,
    ["Yippee-Ki-JSON configuration YML"] = 1128,
    ["YouTrack App"] = 1302,
    ["Zarf Package Configuration"] = 1369,
    ["Zerops import file"] = 1290,
    ["Zola Configuration"] = 1380,
    abtop = 35,
    act3 = 1421,
    actionlint = 45,
    ["aerleon.yml"] = 29,
    ["amplify.yml"] = 22,
    ["amxx-builder manifest"] = 1436,
    ["angular.json"] = 50,
    apko = 1252,
    ...
    ["arc.json"] = 67,
    ["architect.yml"] = 66,
    ["artifacthub-repo.yml"] = 75,
    ["asm-lsp"] = 77,
    ["ast-grep rules"] = 80,
    ["ast-grep sgconfig.yml"] = 79,
    ["azure.yaml"] = 88,
    ["babelrc.json"] = 145,
    ["bamboo-spec"] = 149,
    basedpyright = 147,
    ["bashly-strings.yml"] = 1229,
    ["batect.yml"] = 148,
    ["beef-database-codegen"] = 150,
    ["beef-database-v5-codegen"] = 152,
    ["beef-entity-codegen"] = 151,
    ["beef-entity-v5-codegen"] = 153,
    ["behat.yml"] = 169,
    ["bigquery-table"] = 154,
    ["bioimageio resource description"] = 1269,
    ["bitbucket-pipelines"] = 156,
    bitrise = 157,
    ["bitrise-step"] = 158,
    ["block.json"] = 186,
    ["bottom configuration"] = 104,
    ["bower.json"] = 160,
    ["bozr.suite.json"] = 173,
    bpkg = 1230,
    ["browser.i18n.json"] = 174,
    ["browsh configuration"] = 175,
    bucklescript = 176,
    ["buf.gen.yaml"] = 107,
    ["buf.lock"] = 108,
    ["buf.plugin.yaml"] = 109,
    ...
    ["build-changelog"] = 177,
    ["bun.lock"] = 182,
    ["bundleconfig.json"] = 183,
    ["bunfig.toml"] = 184,
    ["cargo-mutants-config.yaml"] = 112,
    ["cargo-nextest repository configuration"] = 693,
    ["cargo-nextest user configuration"] = 694,
    ["ccmod.json"] = 1314,
    changelogging = 1281,
    ["chezmoi configuration"] = 202,
    ["chisel-slices.json"] = 329,
    ["chrome-extension-locales-messages.json"] = 310,
    ["chutzpah.json"] = 311,
    cibuildwheel = 207,
    ["clang-format (.clang-format)"] = 1187,
    ["clang-tidy"] = 284,
    clangd = 283,
    clib = 285,
    ["cloud-init: cloud-config userdata"] = 287,
    ["cloud-sdk-pipeline-configuration"] = 313,
    ["cloudbuild.json"] = 314,
    cloudify = 286,
    cmakefmt = 225,
    ["cmdx.yaml"] = 115,
    ...
    ["commands.json"] = 306,
    ["commit-check"] = 332,
    ["commitlint (.commitlintrc)"] = 1123,
    ["committed.toml"] = 333,
    ["compile_commands.json"] = 305,
    ["compilerconfig.json"] = 304,
    ["completely.yml"] = 1225,
    ["component-detection-manifest.json"] = 336,
    ["component.json"] = 335,
    ["composer.json"] = 334,
    ["conda-forge"] = 211,
    ["config.yaml"] = 829,
    ["contentmanifest.json"] = 312,
    ["contribute.json"] = 337,
    ["cosmos.config.json"] = 308,
    ["crowdin.yml"] = 338,
    crucible = 342,
    ["ctfd-setup configuration file"] = 1326,
    ["custom-elements.json"] = 1239,
    ["cypress.json"] = 343,
    ["dacier.yml"] = 1424,
    ["datalogic-scan2deploy-android"] = 354,
    ["datalogic-scan2deploy-ce"] = 355,
    ["dbt Dependencies"] = 243,
    ["dbt Packages"] = 245,
    ["dbt Project"] = 244,
    ["dbt Selectors"] = 246,
    ["dbt YAML files"] = 247,
    ...
    ["ddev-global"] = 356,
    ["ddev-project"] = 357,
    ["debugsettings.json"] = 358,
    ["dependabot-v2.json"] = 363,
    ["dependabot.json"] = 362,
    ["deployed-cli"] = 1180,
    devconcurrent = 260,
    ["devcontainer-feature.json"] = 295,
    ["devcontainer.json"] = 294,
    devinit = 1130,
    ["devspace.yaml"] = 1203,
    djlint = 1131,
    ["docker bake"] = 369,
    ["docker sequencer"] = 370,
    ["docker-compose.yml"] = 1129,
    ["dockerd.json"] = 367,
    ["dotnet Release Index manifest"] = 382,
    ["dotnet-tools.json"] = 383,
    ["dotnetcli.host.json"] = 384,
    ["dprint.json"] = 385,
    ["drone.json"] = 386,
    ["dss-2.0.0.json"] = 388,
    ["dstack configuration"] = 389,
    ["dtool dataset metadata"] = 1321,
    ["dvc.yaml"] = 391,
    ["ecosystem.json"] = 396,
    ["editorconfig-checker"] = 398,
    eksctl = 399,
    ["electron-builder configuration file"] = 425,
    ["epr-manifest.json"] = 424,
    ["estampo.toml"] = 423,
    ["evcc.yaml"] = 426,
    ["ezd task runner"] = 437,
    ["fabric.mod.json"] = 440,
    ["first-timers-bot"] = 448,
    ["flagd flag configuration"] = 140,
    ["fly.io Configuration"] = 141,
    fulibWorkflows = 1162,
    ["function.json"] = 461,
    ["gRPC API Gateway & OpenAPI Config"] = 24,
    ["gematik health care insurance list"] = 1332,
    ["gematik health care patient list"] = 1329,
    ["gematik health care provider institution list"] = 1331,
    ["gematik health care provider list"] = 1330,
    ["gematik tiger test environment configuration"] = 1333,
    ["gh-dash"] = 475,
    ["gha-doctor"] = 476,
    ["git-cliff"] = 472,
    ["git-town.toml"] = 1378,
    ["github-settings-as-code"] = 855,
    ["gitlab-ci"] = 490,
    ["global.json"] = 507,
    ["glslint config"] = 3,
    ["go-feature-flag Flag Configuration"] = 511,
    ["gojo.yaml"] = 512,
    gollama = 510,
    ["hassette.toml"] = 535,
    ["haxelib.json"] = 531,
    ...
    ["ide.host.json"] = 548,
    ["ifstate.yaml"] = 549,
    ["imageoptimizer.json"] = 550,
    ["importmap.json"] = 553,
    ["index.toml (packwiz)"] = 1438,
    instant_python_config = 557,
    instant_python_custom_project = 558,
    intlayer = 559,
    ["ioBroker Configuration"] = 560,
    ["ioBroker JSON UI"] = 561,
    ["ioBroker Package manifest"] = 562,
    ["ixpect.conf.yaml"] = 563,
    ["ize.toml"] = 1216,
    ["jsconfig.json"] = 589,
    ["jscpd Configuration"] = 1200,
    jsdoc = 1112,
    ["k3d.yaml"] = 590,
    ["k9s aliases.yaml"] = 592,
    ["k9s cluster-config.yaml"] = 594,
    ["k9s config.yaml"] = 593,
    ["k9s hotkeys.yaml"] = 595,
    ["k9s plugins.yaml"] = 596,
    ["k9s skin.yaml"] = 597,
    ["k9s views.yaml"] = 598,
    ["kind cluster"] = 612,
    ["kontinuous-config.yaml"] = 610,
    ["kontinuous-values.yaml"] = 609,
    ["kustomization.yaml"] = 613,
    ["label-commenter-config.yml"] = 614,
    ["latexindent configuration"] = 130,
    ["launchsettings.json"] = 615,
    lazydocker = 1238,
    lazygit = 1237,
    ["lego.json"] = 617,
    ["lerna.json"] = 618,
    ["lgtm.yml"] = 619,
    ["liblab.config.json"] = 620,
    ["libman.json"] = 621,
    ["license-report-config.json"] = 622,
    ["linkinator.config.json"] = 624,
    ["lint-staged (.lintstagedrc)"] = 1089,
    ["local.settings.json"] = 631,
    ["localazy.json"] = 632,
    ["lotus.yaml"] = 630,
    ["lsd colors"] = 134,
    ["lsd config"] = 133,
    ...
    lychee = 1088,
    ["macro.json"] = 1204,
    ["markdown-link-check"] = 1158,
    maturin = 1159,
    mboats = 1166,
    memnex = 1422,
    ["micro-settings.json"] = 1231,
    ["mimetypes.json"] = 649,
    ["mirrord config"] = 1092,
    ["misata.yaml"] = 1091,
    mise = 1093,
    ["mkdocs.yml"] = 669,
    ["mockd.yaml"] = 673,
    ["mod.pw.toml (packwiz)"] = 1439,
    ["modelparams.dev Model"] = 676,
    ["models CLI"] = 677,
    ["monospace.yml"] = 678,
    ["moon.yml"] = 1315,
    ["mprocs Configuration file"] = 1285,
    ["mrdocs.yml"] = 671,
    ["mta.yaml"] = 1094,
    ["mtad.yaml"] = 1095,
    ["mycode.json"] = 686,
    nFPM = 698,
    ["napari plugin manifest"] = 687,
    neoload = 1107,
    ["nest-cli"] = 701,
    ["nexus-rpc-gen"] = 1405,
    ["nf-core module environment.yml"] = 695,
    ["nf-core module meta.yml"] = 696,
    ["nf-core subworkflow meta.yml"] = 697,
    ["ninjs (News in JSON)"] = 700,
    ["nitro.json"] = 1106,
    ["nixd configuration"] = 1257,
    ["nlu.json"] = 702,
    ["nodemon.json"] = 705,
    ["noodl config"] = 1165,
    ["notebook.mod.json"] = 706,
    now = 1102,
    ["npm-badges"] = 709,
    ["nswag.json"] = 713,
    ntangle = 715,
    ["nuclei-template.yaml"] = 710,
    ["nuget-project.json"] = 711,
    ["ocelot.json"] = 717,
    ogen = 723,
    ["omnisharp.json"] = 726,
    openHAB = 1391,
    ...
    oxfmt = 1401,
    oxlint = 1402,
    ["pack.toml (packwiz)"] = 1440,
    ["package.json"] = 762,
    ["package.manifest"] = 764,
    ["package.yaml"] = 763,
    ["partial-black.json"] = 170,
    ["partial-fastapi.json"] = 171,
    ["partial-pixi.json"] = 774,
    ["partial-scheduled.json"] = 172,
    ["pattern.json"] = 772,
    ["petstore-v1.0"] = 1211,
    pgap_yaml_input_reader = 770,
    pgrls = 771,
    pgxgen = 1395,
    pitcms = 1398,
    ["pixi.toml"] = 773,
    ["plagiarize-me.yaml"] = 778,
    ["plagiarize.yaml"] = 777,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1322,
    ["podbard.yaml"] = 780,
    ["portman.json"] = 783,
    ["prefect.toml"] = 792,
    ["prefect.yaml"] = 793,
    ...
    ["prettierrc.json"] = 795,
    ["prisma.yml"] = 796,
    ["project-1.0.0-beta3.json"] = 808,
    ["project-1.0.0-beta4.json"] = 809,
    ["project-1.0.0-beta5.json"] = 810,
    ["project-1.0.0-beta6.json"] = 811,
    ["project-1.0.0-beta8.json"] = 812,
    ["project-1.0.0-rc1.json"] = 813,
    ["project-1.0.0-rc2.json"] = 814,
    ["project.json"] = 807,
    ["project.owasp.yaml"] = 815,
    ["prometheus-alertmanager.json"] = 819,
    ["prometheus.json"] = 816,
    ["prometheus.rules.json"] = 817,
    ["prometheus.rules.test.json"] = 818,
    ["proxies.json"] = 820,
    ["publiccode.yml"] = 821,
    ["pubspec.yaml"] = 822,
    ["pyrseas-0.8.json"] = 825,
    pytest = 834,
    ["quilt.mod.json"] = 1232,
    ["rc3 auth"] = 840,
    ["rc3 collection"] = 841,
    ...
    ["rc3 settings"] = 845,
    ["registry.yaml"] = 63,
    ["release drafter"] = 1108,
    ["release-hub.json"] = 10,
    ["release-please-config.json"] = 850,
    ["release-please-manifest.json"] = 851,
    ["release-plz.toml"] = 852,
    ["renv.lock"] = 867,
    ["reposets Configuration"] = 856,
    ["reposets Credentials"] = 857,
    ["revola.json"] = 8,
    ["rivet.json"] = 1256,
    ["rivet.yaml (legacy)"] = 1255,
    rumdl = 872,
    runny = 871,
    runspec = 1423,
    rustfmt = 873,
    ...
    samt = 876,
    samtrc = 877,
    ["sarif-1.0.0.json"] = 879,
    ["sarif-2.0.0.json"] = 880,
    ["sarif-2.1.0"] = 890,
    ["sarif-2.1.0-rtm.2"] = 881,
    ["sarif-2.1.0-rtm.3"] = 883,
    ["sarif-2.1.0-rtm.4"] = 885,
    ["sarif-2.1.0-rtm.5"] = 887,
    ["sarif-2.1.0-rtm.6"] = 888,
    ["sarif-external-property-file-2.1.0"] = 891,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 882,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 884,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 886,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 889,
    ["scalingo.json configuration"] = 892,
    ["schema.org - Action"] = 894,
    ["schema.org - ContactPoint"] = 895,
    ["schema.org - Place"] = 896,
    ["schema.org - Thing"] = 897,
    ["secrethub.yml"] = 1234,
    ["semantic-release"] = 905,
    servercn = 1447,
    ["servicehub.config.json"] = 1083,
    ["servicehub.service.json"] = 1082,
    ["settings.job"] = 908,
    ["sfdx-hardis configuration"] = 910,
    ["shard.yml"] = 1272,
    ["size-limit configuration"] = 915,
    ["skaffold.yaml"] = 1156,
    ["skill-map plugin extension manifest"] = 916,
    ["skill-map project settings"] = 917,
    ["skill-map provider kind"] = 918,
    ["skyuxconfig.json"] = 920,
    ["snowflake-config"] = 922,
    ["snowflake-connections"] = 923,
    ["spicepod.yaml"] = 1293,
    ["sqlc configuration"] = 957,
    ["stripe-app-local.json"] = 968,
    ["stripe-app.json"] = 967,
    swcrc = 1140,
    ["task.json"] = 981,
    taskcat = 1103,
    ["template.json"] = 986,
    ["templatsources.json"] = 987,
    ["text2confl config"] = 1403,
    ["theme.json"] = 995,
    ["tizen_workspace.json"] = 997,
    tldr = 998,
    ["tm_devices configuration file"] = 1360,
    tmuxinator = 1086,
    tox = 1000,
    ["transcend.yml"] = 1009,
    ["tree-sitter grammar.json"] = 518,
    ["trime.yaml"] = 1010,
    ["trunk.yaml"] = 1013,
    ["ts-force-config.json"] = 1019,
    tsbuild = 1014,
    ["tsconfig.json"] = 1015,
    ["tsd.json"] = 1016,
    ["tsdoc.json"] = 1017,
    ...
    v8r = 1064,
    vcluster = 1279,
    ["vcpkg configuration file"] = 301,
    ["vcpkg manifest file"] = 300,
    ["vega-lite.json"] = 1045,
    ["vega.json"] = 1044,
    ["venvironment.yaml"] = 1047,
    ["venvplus.yaml"] = 1048,
    version = 1342,
    ["version.json"] = 1050,
    ["vhwdebugger-binding.yaml"] = 1052,
    ["vim-addon-info"] = 1053,
    ["vs-2017.3.host.json"] = 1056,
    ["vs-nesting.json"] = 1057,
    ["vsls.json"] = 1055,
    ["vss-extension.json"] = 1061,
    vtcfg = 1348,
    ["vtesttree.yaml"] = 1062,
    ["vtestunit.yaml"] = 1063,
    ["warp-keysets.json"] = 1240,
    ["warp-themes.json"] = 1241,
    ["warp-workflows.json"] = 1242,
    ["webhint.io"] = 1196,
    ["webjobpublishsettings.json"] = 1068,
    ["webjobs-list.json"] = 1067,
    ["well-known-fursona"] = 1280,
    ["xs-app.json"] = 1098,
    ["xunit.runner.json"] = 1081,
    ["yaml-workflow"] = 1446,
    yamlfmt = 1125,
    yamllint = 1126,
    ["yap.json"] = 1127,
