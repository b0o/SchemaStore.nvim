...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 177,
    [".cryproj (generic)"] = 607,
    [".cryproj engine-5.2"] = 602,
    [".cryproj engine-5.3"] = 603,
    [".cryproj engine-5.4"] = 604,
    [".cryproj engine-5.5"] = 605,
    [".cryproj engine-dev"] = 606,
    [".csscomb.json"] = 179,
    [".csslintrc"] = 180,
    [".es6importsorterrc.json"] = 738,
    [".eslintrc"] = 229,
    [".esmrc.json"] = 221,
    [".ffizer.yaml"] = 233,
    [".htmlhintrc"] = 285,
    ...
    [".pmbot.yml"] = 420,
    [".postcssrc"] = 426,
    [".powerpages-web-template-manifest"] = 428,
    [".pre-commit-config.yml"] = 429,
    [".pre-commit-hooks.yml"] = 430,
    [".putout.json"] = 450,
    [".rehyperc"] = 462,
    [".remarkrc"] = 463,
    [".sprite files"] = 518,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 680,
    ["All Contributors configuration file"] = 737,
    ...
    ["Azure Pipelines"] = 59,
    ["Azure Static Web Apps CLI configuration file"] = 521,
    ["Azure Static Web Apps configuration file"] = 520,
    ["BX CI"] = 95,
    ["Better Code Hub"] = 652,
    ["Better Scripts"] = 96,
    Bigconfig = 76,
    BizTalkServerApplicationSchema = 622,
    Bleep = 97,
    ...
    ["Butane Config"] = 692,
    ["CICS TS region tagging"] = 701,
    ["CICS TS resource import"] = 702,
    ["CICS TS resource model"] = 703,
    ["CICS TS resource overrides"] = 704,
    ["CMake Presets"] = 98,
    ["CNC Codes"] = 108,
    ...
    ["Databricks Asset Bundles"] = 758,
    ["Datadog Service Definition"] = 324,
    ["Datahub Ingestion Recipe"] = 708,
    ["Dein Config"] = 113,
    Deno = 190,
    ["Deployer Recipe"] = 193,
    ["Deta Spacefile"] = 114,
    ...
    ["Goreleaser Pro"] = 267,
    Goss = 268,
    ["Gradle Build Cache Node"] = 650,
    ["Gradle Enterprise"] = 649,
    ...
    Hadolint = 631,
    Hammerkit = 659,
    ["Hardware Sentry Configuration"] = 712,
    Hatch = 632,
    Hayson = 280,
    ...
    ["JFrog File Spec"] = 305,
    ["JFrog Pipelines YML DSL"] = 721,
    ["JMeter DSL cli config"] = 306,
    JReleaser = 308,
    ["JSON Document Transform"] = 315,
    ["JSON Feed"] = 316,
    ["JSON Resume"] = 469,
    ["JSON Schema Draft 2020-12"] = 598,
    ["JSON Schema Draft 4"] = 595,
    ["JSON Schema Draft 7"] = 596,
    ["JSON Schema Draft 7 (unofficial strict)"] = 759,
    ["JSON Schema Draft 8 (2019-09)"] = 597,
    ["JSON-API"] = 314,
    ["JSON-e templates"] = 657,
    ["JSON-stat 2.0"] = 592,
    JSONPatch = 318,
    Jasmine = 298,
    Jekyll = 299,
    ...
    Kas = 321,
    ["Keycloak REST API"] = 729,
    ["Knative Functions - func.yaml"] = 245,
    ["KoDE/CI build.yaml"] = 717,
    ["Kong DBLess config"] = 718,
    KrakenD = 323,
    LOOBin = 340,
    Lefthook = 331,
    ["LinkML Metamodel"] = 338,
    Liquibase = 664,
    ["Liquibase Flow File"] = 665,
    ...
    ["MongoDB Atlas Search Index Definition"] = 716,
    ["Monika Configuration"] = 714,
    ["Motif config"] = 615,
    ["NOX Framework (Service)"] = 387,
    ["Netin Diagnostic System Template"] = 674,
    ["Netlify config"] = 378,
    ["Nexus-as-Code Data Model"] = 379,
    ["Nightwatch.js"] = 380,
    ["ONe's service descriptor"] = 401,
    ["OSS Review Toolkit configuration"] = 408,
    ["OSS Review Toolkit curation"] = 409,
    ["OSS Review Toolkit package configuration"] = 410,
    ["OSS Review Toolkit repository configuration"] = 411,
    ["OSS Review Toolkit resolutions"] = 412,
    Opctl = 618,
    ["OpenRewrite Resource"] = 403,
    ["OpenUtau character yaml"] = 399,
    ["OpenWeather Current Weather API"] = 656,
    ["OpenWeather Road Risk API"] = 655,
    ["Ory Hydra configuration"] = 286,
    ["Ory Keto configuration"] = 325,
    ["Ory Kratos configuration"] = 407,
    ["Ory Oathkeeper configuration"] = 394,
    ["Outblocks App configuration"] = 405,
    ["Outblocks database table"] = 406,
    ["Outblocks project configuration"] = 404,
    Packer = 415,
    Pantsbuild = 736,
    ["Paper paper-plugin.yml"] = 416,
    ["Pipeline component"] = 666,
    ["PocketMine plugin.yml"] = 421,
    Poetry = 422,
    ["Postman collection"] = 427,
    ["Problem package generators"] = 434,
    Pterodactyl = 711,
    ["Pull Request Labeler"] = 449,
    Pulumi = 455,
    PyProject = 456,
    Pyright = 457,
    Qgoda = 458,
    Qodana = 685,
    ["Quali Torque Blueprint Spec 2"] = 709,
    ["QueryFirst config file"] = 732,
    ["RKE Cluster Configuration JSON"] = 663,
    ["RKE Cluster Configuration YAML"] = 662,
    ["Rancher Fleet"] = 452,
    Ray = 630,
    ["Read the Docs"] = 454,
    ["Red-DiscordBot Cog"] = 459,
    ["Red-DiscordBot Cog Repo"] = 460,
    ["Red-DiscordBot Trivia"] = 461,
    RenderCV = 471,
    Renovate = 470,
    ["Replit config"] = 464,
    RoadRunner = 472,
    ...
    ["Rust Project"] = 468,
    ["Rust toolchain"] = 474,
    ["SIL Kit Participant Configuration"] = 506,
    ["SIL Kit Registry Configuration"] = 507,
    SWADL = 531,
    ["Safebox Config"] = 722,
    ["Sapphire CLI Config"] = 477,
    ["SauceCTL Configuration"] = 671,
    ["Schema Catalog"] = 491,
    ["Scoop manifest"] = 496,
    ["Semantic Data Fabric (SDF) file"] = 497,
    ["Semgrep Rule"] = 499,
    ["Serenity Code Generator (Sergen)"] = 500,
    ["Serverless Framework Configuration"] = 679,
    ["Serverless Workflow"] = 681,
    ["Settings.paf"] = 502,
    Setuptools = 503,
    ["Shopware 6 Configuration"] = 682,
    ["Shopware CLI Extension Store Configuration"] = 683,
    ["Shopware CLI Project Store Configuration"] = 684,
    ["Sigrid scope configuration file"] = 505,
    ["Slack app manifest"] = 509,
    Solidarity = 512,
    ["Solution filters"] = 513,
    ["Source Maps v3"] = 514,
    Sourcery = 515,
    SpecIF = 516,
    ["Sponge Mixin configuration"] = 517,
    StackBlitz = 522,
    ["StackHawk Scanner Configuration"] = 678,
    Stale = 523,
    ["Starlake Data Pipeline"] = 653,
    Starship = 524,
    ["Statamic Blueprint"] = 525,
    ["StrmPrivacy Data Connector"] = 726,
    ["StrmPrivacy Data Contract"] = 727,
    ["StrmPrivacy SimpleSchema"] = 724,
    ["StrmPrivacy Stream"] = 725,
    ["StrmPrivacy batch job configuration file"] = 723,
    ["Stryker Mutator"] = 528,
    ["StyleCop Analyzers Configuration"] = 529,
    ["Sublime Syntax"] = 728,
    ["Swagger API 2.0"] = 532,
    TSON = 557,
    Talhelper = 534,
    ["Talisman configuration"] = 535,
    ["Taskfile config"] = 658,
    Taurus = 536,
    ["TestEnvironment.json"] = 545,
    ["TextMate Grammar"] = 544,
    ["Tier.run pricing.json"] = 539,
    Tikibase = 540,
    ["Traefik v2"] = 548,
    ["Traefik v2 File Provider"] = 549,
    TunnelHub = 762,
    Turborepo = 546,
    Tye = 686,
    ["UET BuildConfig.json"] = 733,
    ["UI5 Manifest"] = 565,
    ["UTAM Page Object"] = 568,
    ["Ubuntu Server Autoinstall"] = 563,
    ["Uniswap Token List"] = 641,
    ["Unreal Engine Uplugin"] = 734,
    ["Unreal Engine Uproject"] = 735,
    ["Updatecli Compose"] = 693,
    ["Updatecli Policy Manifest"] = 694,
    ["Updatecli Policy Metadata"] = 695,
    Uplift = 731,
    ["User Journey Map"] = 661,
    V2Ray = 699,
    ["VSCode Code Snippets"] = 148,
    ["VSIX CLI publishing"] = 581,
    ["Vela Pipeline Configuration"] = 571,
    Vercel = 147,
    Visivo = 760,
    ["Web App Manifest"] = 588,
    ["Web types"] = 591,
    WebExtensions = 587,
    ["Webman package recipe"] = 705,
    ["Windows Package Manager Installer Manifest"] = 638,
    ["Windows Package Manager Locale Manifest"] = 639,
    ["Windows Package Manager Singleton Manifest"] = 637,
    ["Woodpecker pipeline config"] = 673,
    ["Xstate Machine"] = 691,
    ["Yippee-Ki-JSON configuration YML"] = 643,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 70,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 742,
    ["bashly-strings.yml"] = 743,
    ["bashly.yml"] = 741,
    ["batect.yml"] = 69,
    ...
    ["lsdlschema.json"] = 344,
    ["madness.yml"] = 740,
    ["markdown-lint-check"] = 669,
    mboats = 676,
    ["micro-settings.json"] = 745,
    ["mimetypes.json"] = 351,
    ["mirrord config"] = 612,
    ["monospace.yml"] = 372,
    ["mta.yaml"] = 613,
    ...
    ["ops.yaml"] = 400,
    ["package.json"] = 413,
    ["package.manifest"] = 414,
    ["pathfinder.yml"] = 417,
    ["pattern.json"] = 419,
    ["petstore-v1.0"] = 720,
    pgap_yaml_input_reader = 418,
    ["plagiarize-me.yaml"] = 424,
    ["plagiarize.yaml"] = 423,
    ["portman.json"] = 425,
    ["prettierrc.json"] = 432,
    ["prisma.yml"] = 433,
    ["project-1.0.0-beta3.json"] = 436,
    ["project-1.0.0-beta4.json"] = 437,
    ["project-1.0.0-beta5.json"] = 438,
    ["project-1.0.0-beta6.json"] = 439,
    ["project-1.0.0-beta8.json"] = 440,
    ["project-1.0.0-rc1.json"] = 441,
    ["project-1.0.0-rc2.json"] = 442,
    ["project.json"] = 435,
    ["prometheus.json"] = 443,
    ["prometheus.rules.json"] = 444,
    ["prometheus.rules.test.json"] = 445,
    ["proxies.json"] = 446,
    ["publiccode.yml"] = 447,
    ["pubspec.yaml"] = 448,
    ["pyrseas-0.8.json"] = 451,
    ["quilt.mod.json"] = 746,
    ["release drafter"] = 625,
    rtx = 466,
    rustfmt = 473,
    samt = 475,
    samtrc = 476,
    ["sarif-1.0.0.json"] = 478,
    ["sarif-2.0.0.json"] = 479,
    ["sarif-2.1.0"] = 489,
    ["sarif-2.1.0-rtm.2"] = 480,
    ["sarif-2.1.0-rtm.3"] = 482,
    ["sarif-2.1.0-rtm.4"] = 484,
    ["sarif-2.1.0-rtm.5"] = 486,
    ["sarif-2.1.0-rtm.6"] = 487,
    ["sarif-external-property-file-2.1.0"] = 490,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 481,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 483,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 485,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 488,
    ["schema.org - Action"] = 492,
    ["schema.org - ContactPoint"] = 493,
    ["schema.org - Place"] = 494,
    ["schema.org - Thing"] = 495,
    ["scikit-build"] = 677,
    ["secrethub.yml"] = 748,
    ["semantic-release"] = 498,
    ["servicehub.config.json"] = 601,
    ["servicehub.service.json"] = 600,
    ["settings.job"] = 501,
    ["sfdx-hardis configuration"] = 504,
    ["size-limit configuration"] = 508,
    ["skaffold.yaml"] = 667,
    ["skyuxconfig.json"] = 510,
    snapcraft = 511,
    ["sqlc configuration"] = 519,
    ["stripe-app-local.json"] = 527,
    ["stripe-app.json"] = 526,
    swcrc = 654,
    syntax = 750,
    ["task.json"] = 533,
    taskcat = 621,
    ["template.json"] = 537,
    ["templatsources.json"] = 538,
    ["theme.json"] = 541,
    ["tizen_workspace.json"] = 542,
    tldr = 543,
    tmuxinator = 609,
    ["transcend.yml"] = 550,
    ["trunk.yaml"] = 551,
    ["ts-force-config.json"] = 555,
    ["tsconfig.json"] = 552,
    ["tsd.json"] = 553,
    ["tsdrc.json"] = 554,
    ["tslint.json"] = 556,
    ...
    ["vega-lite.json"] = 570,
    ["vega.json"] = 569,
    ["venvironment-basic.yaml"] = 573,
    ["venvironment.yaml"] = 572,
    ["version.json"] = 574,
    ["vim-addon-info"] = 575,
    ["vs-2017.3.host.json"] = 577,
    ["vs-nesting.json"] = 578,
    ["vsls.json"] = 576,
    ["vss-extension.json"] = 582,
    ["vtesttree.yaml"] = 583,
    ["vtestunit.yaml"] = 584,
    ["warp-keysets.json"] = 754,
    ["warp-themes.json"] = 755,
    ["warp-workflows.json"] = 756,
    ["webhint.io"] = 706,
    ["webjobpublishsettings.json"] = 590,
    ["webjobs-list.json"] = 589,
    ["xs-app.json"] = 617,
    ["xunit.runner.json"] = 599,
    yamllint = 642,
    zuul = 626,
    ["Žinoma"] = 636
  },
