...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 785,
    [".nodehawkrc"] = 493,
    [".npmpackagejsonlintrc"] = 497,
    [".omletrc"] = 958,
    [".phrase.yml"] = 558,
    [".phraseapp.yml"] = 559,
    [".pmbot.yml"] = 546,
    [".postcssrc"] = 553,
    [".powerpages-web-template-manifest"] = 555,
    [".pre-commit-config.yml"] = 556,
    [".pre-commit-hooks.yml"] = 557,
    [".putout.json"] = 580,
    [".rehyperc"] = 602,
    [".remarkrc"] = 604,
    [".sprite files"] = 669,
    ...
    ["A micro editor config"] = 446,
    ABCInventoryModuleData = 14,
    ABCSupplyPlan = 15,
    AIConfig = 16,
    ["AMX Muse Program Descriptor"] = 1002,
    ["API Builder"] = 819,
    ["AVA Configuration"] = 881,
    ["AWS AppConfig Feature Flags-v1"] = 41,
    ["AWS CDK cdk.json"] = 199,
    ["AWS CloudFormation"] = 200,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 201,
    ["AWS SAM CLI Samconfig"] = 202,
    ["Adobe UXP Manifest"] = 941,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    Air = 12,
    ["Airlock Microgateway"] = 17,
    ["Alacritty Configuration"] = 853,
    ["All Contributors configuration file"] = 906,
    ["Ansible Argument Specs"] = 331,
    ["Ansible Collection Galaxy"] = 338,
    ["Ansible Execution Environment"] = 328,
    ["Ansible Inventory"] = 337,
    ["Ansible Meta"] = 329,
    ["Ansible Meta Runtime"] = 330,
    ["Ansible Navigator Configuration"] = 340,
    ["Ansible Playbook"] = 335,
    ["Ansible Requirements"] = 332,
    ["Ansible Rulebook"] = 336,
    ["Ansible Tasks File"] = 334,
    ["Ansible Vars File"] = 333,
    ["Ansible-lint Configuration"] = 339,
    Any = 967,
    ["AnyWork Automation Configuration"] = 5,
    ["App config Spotify Backstage"] = 21,
    ["Application Accelerator"] = 2,
    ["Application list for a WinUtil"] = 984,
    ArchitectFX = 989,
    ["Argo Events"] = 31,
    ["Argo Workflows"] = 32,
    AssemblyScript = 35,
    ...
    ["Azure Pipelines"] = 68,
    ["Azure Static Web Apps CLI configuration file"] = 673,
    ["Azure Static Web Apps configuration file"] = 672,
    ["BOSH Deploy Config"] = 92,
    ["BX CI"] = 110,
    ["Bashly (bashly.yml)"] = 910,
    ["Bashly Settings (bashly-settings.yml)"] = 911,
    ["Better Code Hub"] = 823,
    ["Better Scripts"] = 111,
    Bigconfig = 85,
    ["Biome Formatter Config"] = 55,
    ["Bitmovin Encoding Template"] = 995,
    BizTalkServerApplicationSchema = 791,
    Bleep = 112,
    ...
    ["Butane Config"] = 866,
    C4InterFlow = 1010,
    ["CGS Card Game Specification (cgs.json)"] = 946,
    ["CICS TS region tagging"] = 875,
    ["CICS TS resource import"] = 876,
    ["CICS TS resource model"] = 877,
    ["CICS TS resource overrides"] = 878,
    ["CMake Presets"] = 113,
    ["CNC Codes"] = 129,
    ["CRS WAF test file"] = 974,
    ["CRS WAF test platform overrides file"] = 975,
    ["CSS Comb (.csscomb.json)"] = 226,
    ["CSS Lint (.csslintrc)"] = 227,
    ["CSpell (cspell.json)"] = 225,
    ["CVE Record Format"] = 135,
    CWL = 952,
    ...
    ["Chamaleon environment"] = 999,
    ["Chamaleon properties"] = 1000,
    ["Chamaleon template"] = 998,
    Changesets = 211,
    Charmcraft = 122,
    Cheatsheets = 863,
    ["Chrome Extension"] = 192,
    ["Chromia Model"] = 123,
    ["CircleCI config.yml"] = 168,
    ["Citation File Format"] = 213,
    CityJSON = 125,
    ["Clawject config"] = 134,
    ["Cloud Foundry Application Manifest"] = 957,
    ["Cloud Run Spec v1"] = 979,
    ["CloudCannon Configuration"] = 64,
    ["CloudEvents specification"] = 126,
    ["Code Climate"] = 169,
    CodeCV = 62,
    CodeRabbit = 61,
    ["CodeShip Pro services configuration files"] = 181,
    ["CodeShip Pro steps configuration files"] = 182,
    ["Codecov configuration files"] = 180,
    CodifyCLI = 63,
    Codux = 178,
    ["Cog config file"] = 130,
    ["Commandbox Box.json"] = 131,
    ["Commandbox Server.json"] = 132,
    ["Common Catalog Data"] = 190,
    Concord = 973,
    ["Configu .cfgu files"] = 962,
    ["Configu .configu file"] = 963,
    Conjure = 128,
    ["Container Structure Test"] = 805,
    Containerlab = 832,
    ["Crowdsec collection config"] = 220,
    ["Crowdsec parser config"] = 221,
    ["Crowdsec scenario config"] = 222,
    ["CumulusCI Config"] = 133,
    ["Custom Machinery Machine"] = 947,
    ["Custom Machinery Recipe"] = 948,
    ["Cycle Stack File"] = 136,
    CycloneDX = 137,
    ["DWP Exchange - catalogue entry"] = 269,
    ["DWP Exchange - gateway"] = 267,
    ["DWP Exchange - meta"] = 268,
    ["Dart Build Config (dart-build.json)"] = 228,
    ["Dart Test Config (dart-test.json)"] = 229,
    ["DashLord Configuration"] = 230,
    ["Data Contract Specification"] = 231,
    ["Data Product Specification"] = 232,
    ["DataYoga Connections"] = 138,
    ["DataYoga Job"] = 139,
    ["Databricks Asset Bundles"] = 927,
    ["Datadog Service Definition"] = 419,
    ["Datadog Software Catalog"] = 420,
    ["Datahub Ingestion Recipe"] = 882,
    ["Dein Config"] = 145,
    ["Deno Config (deno.json)"] = 238,
    ["Dependency cruiser"] = 146,
    ["DeployStack Configuration"] = 147,
    ["Deployer Recipe"] = 241,
    ["Deta Spacefile"] = 148,
    ["Detekt Config (detekt.yml)"] = 242,
    ["Devbox Config"] = 149,
    ["Devbox Plugin"] = 150,
    Devfile = 266,
    DipDup = 976,
    ["Discord Webhook"] = 243,
    ["DocFx Config (docfx.json)"] = 247,
    Dofigen = 248,
    ["Dolittle Artifacts"] = 249,
    ["Dolittle Bounded Context Configuration"] = 250,
    ["Dolittle Event Horizons Configuration"] = 251,
    ["Dolittle Resources Configuration"] = 252,
    ["Dolittle Server Configuration"] = 253,
    ["Dolittle Tenant Map Configuration"] = 255,
    ["Dolittle Tenants Configuration"] = 254,
    ["Dolittle Topology"] = 256,
    ["DonateCaseBetterCasino menu"] = 1003,
    ["Drupal Breakpoints"] = 151,
    ["Drupal Config"] = 163,
    ["Drupal Info"] = 152,
    ["Drupal Layouts"] = 153,
    ["Drupal Libraries"] = 154,
    ["Drupal Links Action"] = 155,
    ["Drupal Links Contextual"] = 156,
    ["Drupal Links Menu"] = 157,
    ["Drupal Links Task"] = 158,
    ["Drupal Migration"] = 159,
    ["Drupal Permissions"] = 160,
    ["Drupal Recipe"] = 161,
    ["Drupal Routing"] = 162,
    ["Drupal Services"] = 164,
    ["Drush site aliases"] = 262,
    ["Dynamic Bash Aliases (.aliases)"] = 918,
    ["EAS config"] = 286,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 907,
    ["EasyVCR .NET"] = 287,
    ["Eidolon Resource"] = 990,
    ["Elgato Stream Deck"] = 272,
    Elm = 978,
    ["Embrace Config"] = 893,
    Endurica = 931,
    ["Enterprise Contract Policy Spec"] = 273,
    ["Erda Pipeline"] = 954,
    ["Erda Runtime"] = 955,
    Esquio = 275,
    ["Estuary Flow Catalog"] = 872,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 279,
    ["EveryVoice TTS Toolkit Data Configuration"] = 280,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 284,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 283,
    ["EveryVoice TTS Toolkit Text Configuration"] = 281,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 282,
    ["Expo SDK"] = 285,
    ["F-Droid Data metadata"] = 291,
    ["FasterCI Configuration"] = 69,
    FiQuS = 295,
    Firebase = 293,
    ["FlexGet Config"] = 296,
    ["Flow.json Configurations"] = 951,
    ["Fossa configuration file"] = 303,
    ["Fossa's fossa-deps file"] = 304,
    ["Foundry VTT - Base package Manifest"] = 298,
    ["Foundry VTT - Module Manifest"] = 299,
    ["Foundry VTT - System Data Template"] = 302,
    ["Foundry VTT - System Manifest"] = 300,
    ["Foundry VTT - World Manifest"] = 301,
    ["Foxx Manifest"] = 70,
    ["Freifunk.de Community API"] = 73,
    ["Frogbot Config"] = 74,
    ["G2P Mapping Configuration"] = 309,
    ["GCP Blueprint Metadata"] = 312,
    Gaspar = 310,
    ["GatewayCore API Gateway"] = 311,
    ["GeoJSON.json latest"] = 870,
    GherKing = 874,
    ["GitHub Action"] = 317,
    ["GitHub Actions typing"] = 986,
    ["GitHub Discussion"] = 318,
    ["GitHub Funding"] = 319,
    ["GitHub Issue Template configuration"] = 320,
    ["GitHub Issue Template forms"] = 321,
    ["GitHub Workflow"] = 322,
    ["GitHub Workflow Template Properties"] = 323,
    ["GitHub automatically generated release notes configuration"] = 324,
    ["GitLab Agent for Kubernetes configuration"] = 943,
    GitVersion = 314,
    ["Gitea Issue Template configuration"] = 315,
    ["Gitea Issue Template forms"] = 316,
    ["Gitpod Automations"] = 326,
    ["Gitpod Configuration"] = 327,
    ["GlazeWM settings"] = 945,
    ["Global Privacy Control"] = 313,
    Goblet = 926,
    ["Golangci-lint Configuration"] = 342,
    ["Golangci-lint Custom Plugins Configuration"] = 343,
    ["Google Chrome Related Website Sets"] = 294,
    ["Google Cloud Workflows"] = 198,
    Goreleaser = 345,
    ["Goreleaser Pro"] = 346,
    Goss = 347,
    ["Gradle Build Cache Node"] = 821,
    ["Gradle Enterprise"] = 820,
    ["Grafana 5.x Dashboard"] = 348,
    ["GraphQL Code Generator"] = 352,
    ["GraphQL Config"] = 351,
    ["GraphQL Mesh"] = 350,
    ["Grunt JSHint task"] = 356,
    ["Grunt Watch task"] = 357,
    ["Grunt base task"] = 358,
    ["Grunt clean task"] = 354,
    ["Grunt copy task"] = 353,
    ["Grunt cssmin task"] = 355,
    HEMTT = 788,
    Hadolint = 801,
    Hammerkit = 831,
    ["Hardware Sentry Configuration"] = 886,
    Hatch = 802,
    Hayson = 360,
    ["Haystack Pipeline"] = 361,
    ["Hazelcast 5 Configuration"] = 362,
    ["Helm Chart.lock"] = 166,
    ["Helm Chart.yaml"] = 165,
    ["Helm Unittest Test Suite"] = 167,
    Hugo = 862,
    ["Hugo Theme"] = 861,
    ["Hyperfoil benchmark configuration"] = 368,
    ["IBM Zapp document"] = 369,
    ["IBM zCodeFormatSettings"] = 370,
    ["IMG Catapult PSP"] = 375,
    ["IVMS101 by CODE Protocol"] = 944,
    Infrahub = 377,
    Istanbul = 889,
    ["JDownloader2 crawler multi-rules"] = 387,
    ["JDownloader2 crawler single-rules"] = 386,
    ["JFrog Applications Config"] = 388,
    ["JFrog File Spec"] = 389,
    ["JFrog Pipelines YML DSL"] = 895,
    ["JMeter DSL cli config"] = 390,
    JReleaser = 392,
    ["JSON Document Transform"] = 400,
    ["JSON Feed"] = 401,
    ["JSON Resume"] = 609,
    ["JSON Schema Draft 2020-12"] = 771,
    ["JSON Schema Draft 4"] = 768,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 928,
    ["JSON Schema Draft 7"] = 769,
    ["JSON Schema Draft 7 (unofficial strict)"] = 929,
    ["JSON Schema Draft 8 (2019-09)"] = 770,
    ["JSON-API"] = 399,
    ["JSON-e templates"] = 828,
    ["JSON-stat 2.0"] = 764,
    JSONPatch = 403,
    ["JSR Package Config (jsr.json)"] = 393,
    Jasmine = 381,
    Jekyll = 382,
    ["Jenkins X Pipelines"] = 383,
    ["Jenkins X Requirements"] = 384,
    Jest = 385,
    ["Jovo Language Models"] = 391,
    ["KIMMDY config file"] = 414,
    ["KODE/CI build.yaml"] = 891,
    ["KSP-AVC"] = 765,
    ["KSP-CKAN"] = 766,
    ["KSP-NetKAN"] = 767,
    KSY = 956,
    KSail = 307,
    ["Karakum configuration file"] = 305,
    Kas = 406,
    ["Kestra flow file"] = 415,
    ["Keycloak REST API"] = 898,
    ["Knative Functions - func.yaml"] = 306,
    ["Kometa (nightly) config file"] = 417,
    ["Kometa config file"] = 416,
    ["Kong DBLess config"] = 892,
    KrakenD = 418,
    ["Kubri Configuration"] = 424,
    LOOBin = 439,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 203,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 204,
    ["Landing Zone Accelerator on AWS - Global Config"] = 205,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 206,
    ["Landing Zone Accelerator on AWS - Network Config"] = 207,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 208,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 209,
    ["Landing Zone Accelerator on AWS - Security Config"] = 210,
    ["Language configuration"] = 966,
    Lefthook = 428,
    ["Liferay client-extension.yaml"] = 435,
    ["LinkML Metamodel"] = 437,
    Liquibase = 837,
    ["Liquibase Flow File"] = 838,
    ["Lively Properties"] = 438,
    ["Lobe AI Agent"] = 66,
    Loki = 67,
    ["MLOS Configs"] = 477,
    ["MS2Rescore Configuration"] = 480,
    ["Madness (madness.yml)"] = 909,
    ["MapEHR Mapping"] = 445,
    Markdownlint = 841,
    ["Mason Registry"] = 844,
    ["MegaLinter configuration"] = 447,
    ["MegaLinter descriptor"] = 448,
    Melange = 935,
    ["Meltano project definition"] = 449,
    ["Mergify Configuration"] = 481,
    ["Metadata for a Bazel module"] = 450,
    ["Metadata for a Cinnamon spice"] = 982,
    ["Metatype Configuration"] = 451,
    ["MetricsHub Configuration"] = 452,
    ["MetricsHub Connector Configuration"] = 453,
    ["Micro Editor Syntax"] = 919,
    ["Microsoft Band Web Tile"] = 454,
    ["Microsoft RulesEngine workflow rules"] = 970,
    ["Microsoft RulesEngine workflow rules list"] = 971,
    ["Minecraft Custom Main Menu Mod"] = 936,
    ["Minecraft Data Pack Advancement"] = 456,
    ["Minecraft Data Pack Biome"] = 457,
    ["Minecraft Data Pack Configured Carver"] = 458,
    ["Minecraft Data Pack Damage Type"] = 459,
    ["Minecraft Data Pack Dimension"] = 461,
    ["Minecraft Data Pack Dimension Type"] = 460,
    ["Minecraft Data Pack Item Modifier"] = 462,
    ["Minecraft Data Pack Loot Table"] = 463,
    ["Minecraft Data Pack Metadata"] = 464,
    ["Minecraft Data Pack Predicate"] = 465,
    ["Minecraft Data Pack Recipe"] = 466,
    ["Minecraft Data Pack Tag"] = 467,
    ["Minecraft Data Pack Template Pool"] = 468,
    ["Minecraft Data Pack Trim Material"] = 473,
    ["Minecraft Data Pack Trim Pattern"] = 474,
    ["Minecraft Resource Pack Lang"] = 469,
    ["Minecraft Resource Pack Particle"] = 470,
    ["Minecraft Resource Pack Texture Mcmeta"] = 472,
    ["Minecraft Resourcepack Sounds"] = 471,
    ["Monade CLI Stack Configuration"] = 484,
    ["MongoDB Atlas Search Index Definition"] = 890,
    ["Monika Configuration"] = 888,
    ["Monoweave Configuration"] = 479,
    ["Motif config"] = 784,
    ["NOX Framework (Service)"] = 496,
    ["Netin Diagnostic System Template"] = 848,
    ["Netlify config"] = 487,
    ["Network-as-Code Data Model"] = 488,
    ["Nightwatch.js"] = 489,
    ["NueJS configuration file"] = 501,
    ["Nuitka.yaml"] = 949,
    ["Nullstone config"] = 503,
    ["ONe's changelog entry"] = 517,
    ["ONe's service descriptor"] = 516,
    ["OSCAL Assessment Plan (AP)"] = 525,
    ["OSCAL Assessment Results (AR)"] = 526,
    ["OSCAL Catalog"] = 527,
    ["OSCAL Component Definition (CDef)"] = 528,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 529,
    ["OSCAL Profile"] = 530,
    ["OSCAL System Security Plan (SSP)"] = 531,
    ["OSS Review Toolkit configuration"] = 532,
    ["OSS Review Toolkit curation"] = 533,
    ["OSS Review Toolkit package configuration"] = 534,
    ["OSS Review Toolkit repository configuration"] = 535,
    ["OSS Review Toolkit resolutions"] = 536,
    ["October CMS columns"] = 507,
    ["October CMS fields"] = 508,
    Okteto = 509,
    Opctl = 787,
    ["Open Data Contract Standard (ODCS)"] = 520,
    ["OpenRewrite Resource"] = 519,
    ["OpenUtau character yaml"] = 513,
    ["OpenUtau ustx"] = 514,
    ["OpenWeather Current Weather API"] = 827,
    ["OpenWeather Road Risk API"] = 826,
    ["Ory Hydra configuration"] = 367,
    ["Ory Keto configuration"] = 421,
    ["Ory Kratos configuration"] = 524,
    ["Ory Oathkeeper configuration"] = 505,
    ["Outblocks App configuration"] = 522,
    ["Outblocks database table"] = 523,
    ["Outblocks project configuration"] = 521,
    PDM = 542,
    Packer = 539,
    Pantsbuild = 905,
    ["Paper paper-plugin.yml"] = 540,
    ["Pipeline component"] = 839,
    ["Plex Prerolls"] = 550,
    ["PocketMine plugin.yml"] = 547,
    ["Postman collection"] = 554,
    ["Preset list for a WinUtil"] = 985,
    ["Problem object RFC9457"] = 933,
    ["Problem package generators"] = 563,
    Pterodactyl = 885,
    ["Pull Request Labeler"] = 579,
    Pulumi = 587,
    ["PyGTA Config"] = 583,
    PyProject = 588,
    Pyright = 589,
    Qgoda = 590,
    Qodana = 858,
    ["Qt Creator workspace file"] = 964,
    ["Quali Torque Blueprint Spec 2"] = 883,
    ["QueryFirst config file"] = 901,
    ["RKE Cluster Configuration JSON"] = 836,
    ["RKE Cluster Configuration YAML"] = 835,
    RadioHound = 582,
    Railway = 591,
    ["Rancher Fleet"] = 584,
    ["Rattler-build"] = 592,
    Ray = 800,
    ["Read the Docs"] = 586,
    ["Red-DiscordBot Cog"] = 599,
    ["Red-DiscordBot Cog Repo"] = 600,
    ["Red-DiscordBot Trivia"] = 601,
    ["Render Blueprints"] = 834,
    RenderCV = 611,
    Renovate = 610,
    ["Replit config"] = 605,
    Restate = 1013,
    RoadRunner = 613,
    ["Rudder techniques"] = 939,
    Ruff = 607,
    ["Rust Project"] = 608,
    ["Rust toolchain"] = 617,
    ["SDMX data message"] = 643,
    ["SDMX metadata message"] = 642,
    ["SDMX structure message"] = 641,
    ["SIL Kit Participant Configuration"] = 653,
    ["SIL Kit Registry Configuration"] = 654,
    ["SPDX 2.3"] = 670,
    SWADL = 684,
    ["Safebox Config"] = 896,
    ["Sapphire CLI Config"] = 620,
    ["SauceCTL Configuration"] = 845,
    ["Schema Catalog"] = 635,
    ["Scoop manifest"] = 640,
    ["Semantic Data Fabric (SDF) file"] = 644,
    ["Semgrep Rule"] = 646,
    ["Serenity Code Generator (Sergen)"] = 647,
    ["Serverless Framework Configuration"] = 852,
    ["Serverless Workflow"] = 854,
    ["Settings for a Cinnamon spice"] = 981,
    ["Settings.paf"] = 649,
    ["Shopware 6 Configuration"] = 855,
    ["Shopware CLI Extension Store Configuration"] = 856,
    ["Shopware CLI Project Store Configuration"] = 857,
    ["Sigma Detection Rule"] = 651,
    ["Sigrid scope configuration file"] = 652,
    ["SkyPilot Task JSON"] = 940,
    ["Slack app manifest"] = 656,
    Solidarity = 659,
    ["Solution filters"] = 660,
    ["Source Maps v3"] = 661,
    Sourcery = 662,
    ["Speakeasy Generation Config File"] = 666,
    ["Speakeasy Lint Configuration File"] = 663,
    ["Speakeasy Test Generation Configuration File"] = 664,
    ["Speakeasy Workflow File"] = 665,
    SpecIF = 667,
    ["Sponge Mixin configuration"] = 668,
    StackBlitz = 674,
    ["StackHawk Scanner Configuration"] = 851,
    Stale = 675,
    ["Starlake Data Pipeline"] = 824,
    Starship = 676,
    ["Statamic Blueprint"] = 677,
    ["Stella configuration file"] = 678,
    ["Stryker Mutator"] = 681,
    ["StyleCop Analyzers Configuration"] = 682,
    ["Stylelint (.stylelintrc)"] = 683,
    ["Sublime Syntax"] = 897,
    ["Subsquid squid manifest"] = 942,
    ["Swagger API 2.0"] = 685,
    ["Synadia Connect Component"] = 686,
    TSON = 720,
    TSTyche = 721,
    ["Tab data for a LinUtil"] = 988,
    ["Tab list for a LinUtil"] = 987,
    Tach = 687,
    ["Tach Domain"] = 688,
    Talhelper = 690,
    ["Talisman configuration"] = 691,
    ["Taskfile config"] = 829,
    Taurus = 692,
    Tauticord = 693,
    Telefonistka = 1014,
    ["TestEnvironment.json"] = 703,
    ["TextMate Grammar"] = 702,
    ["Tier.run pricing.json"] = 696,
    Tikibase = 697,
    Tombi = 701,
    ["Traefik v2"] = 706,
    ["Traefik v2 File Provider"] = 707,
    ["Traefik v3"] = 708,
    ["Traefik v3 File Provider"] = 709,
    ["Travis CI (.travis.yml)"] = 705,
    Trident = 1012,
    ["TrueScript for *.tscript files"] = 712,
    ["Tugboat QA config.yml"] = 1009,
    TunnelHub = 932,
    Turborepo = 704,
    Tycho = 977,
    Tye = 859,
    ["Tyk Gateway - Open Source v5.7+"] = 1016,
    ["UET BuildConfig.json"] = 902,
    ["UI5 Manifest"] = 730,
    ["UNCORS configuration"] = 734,
    ["UTAM Page Object"] = 733,
    ["Ubuntu Server Autoinstall"] = 728,
    ["Uniswap Token List"] = 812,
    ["Universal Schedule Format"] = 735,
    ["Unreal Engine Uplugin"] = 903,
    ["Unreal Engine Uproject"] = 904,
    ["Updatecli Compose"] = 867,
    ["Updatecli Policy Manifest"] = 868,
    ["Updatecli Policy Metadata"] = 869,
    Uplift = 900,
    ["User Journey Map"] = 833,
    V2Ray = 873,
    ["VSCode Code Snippets"] = 186,
    ["VSIX CLI publishing"] = 753,
    Vector = 737,
    ["Vela Pipeline Configuration"] = 740,
    Vercel = 185,
    ["Version Bumper config"] = 743,
    Visivo = 930,
    Wake = 1011,
    ["Waku Config"] = 991,
    ["Web App Manifest"] = 759,
    ["Web types"] = 762,
    WebExtensions = 758,
    ["Webman package recipe"] = 879,
    ["Windows Package Manager Installer Manifest"] = 808,
    ["Windows Package Manager Locale Manifest"] = 809,
    ["Windows Package Manager Singleton Manifest"] = 807,
    Winutil = 810,
    ["WireMock stub mapping"] = 994,
    ["Woodpecker pipeline config"] = 847,
    ["Wrangler CLI"] = 763,
    ["Xstate Machine"] = 865,
    ["Yandex Workflow Language"] = 983,
    ["Yarn Config (.yarnrc.yml)"] = 822,
    ["Yippee-Ki-JSON configuration YML"] = 814,
    ["YouTrack App"] = 980,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 18,
    apko = 934,
    ...
    ["behat.yml"] = 94,
    ["bigquery-table"] = 84,
    ["bioimageio resource description"] = 950,
    ...
    ["ccmod.json"] = 992,
    changelogging = 961,
    ["chisel-slices.json"] = 212,
    ["chrome-extension-locales-messages.json"] = 193,
    ["chutzpah.json"] = 194,
    cibuildwheel = 124,
    ["clang-format (.clang-format)"] = 871,
    ["clang-tidy"] = 173,
    clangd = 172,
    clib = 174,
    ["cloud-init: cloud-config userdata"] = 176,
    ["cloud-sdk-pipeline-configuration"] = 196,
    ["cloudbuild.json"] = 197,
    cloudify = 175,
    codemagic = 177,
    ["coffeelint.json"] = 214,
    ["commands.json"] = 189,
    ["commitlint (.commitlintrc)"] = 811,
    ["compile_commands.json"] = 188,
    ["compilerconfig.json"] = 187,
    ["completely.yml"] = 908,
    ["component-detection-manifest.json"] = 217,
    ["component.json"] = 216,
    ["composer.json"] = 215,
    ["conda-forge"] = 127,
    ["config.yaml"] = 585,
    ["contentmanifest.json"] = 195,
    ["contribute.json"] = 218,
    ["cosmos.config.json"] = 191,
    ["crowdin.yml"] = 219,
    ["ctfd-setup configuration file"] = 1001,
    ["custom-elements.json"] = 922,
    ["cypress.json"] = 223,
    ["datalogic-scan2deploy-android"] = 233,
    ["datalogic-scan2deploy-ce"] = 234,
    ["dbt Dependencies"] = 140,
    ["dbt Packages"] = 142,
    ["dbt Project"] = 141,
    ["dbt Selectors"] = 143,
    ["dbt YAML files"] = 144,
    ["ddev-global"] = 235,
    ["ddev-project"] = 236,
    ["debugsettings.json"] = 237,
    ["dependabot-v2.json"] = 240,
    ["dependabot.json"] = 239,
    ["deployed-cli"] = 864,
    ["devcontainer.json"] = 179,
    devinit = 816,
    ["devspace.yaml"] = 887,
    djlint = 817,
    ["docker bake"] = 245,
    ["docker sequencer"] = 246,
    ["docker-compose.yml"] = 815,
    ["dockerd.json"] = 244,
    ["dotnet Release Index manifest"] = 257,
    ["dotnet-tools.json"] = 258,
    ["dotnetcli.host.json"] = 259,
    ["dprint.json"] = 260,
    ["drone.json"] = 261,
    ["dss-2.0.0.json"] = 263,
    ["dstack configuration"] = 264,
    ["dtool dataset metadata"] = 996,
    ["dvc.yaml"] = 265,
    ["ecosystem.json"] = 270,
    eksctl = 271,
    ["electron-builder configuration file"] = 277,
    ["epr-manifest.json"] = 276,
    ["evcc.yaml"] = 278,
    ["ezd task runner"] = 288,
    ["fabric.mod.json"] = 290,
    ["first-timers-bot"] = 297,
    ["flagd flag configuration"] = 71,
    ["fly.io Configuration"] = 72,
    fulibWorkflows = 846,
    ["function.json"] = 308,
    ["gRPC API Gateway & OpenAPI Config"] = 3,
    ["gematik health care insurance list"] = 1007,
    ["gematik health care patient list"] = 1004,
    ["gematik health care provider institution list"] = 1006,
    ["gematik health care provider list"] = 1005,
    ["gematik tiger test environment configuration"] = 1008,
    ["gitlab-ci"] = 325,
    ["global.json"] = 341,
    ["go-feature-flag Flag Configuration"] = 344,
    ["haxelib.json"] = 359,
    helmfile = 803,
    helmwave = 804,
    ["host-meta.json"] = 364,
    ...
    ["ide.host.json"] = 371,
    ["ifstate.conf"] = 372,
    ["imageoptimizer.json"] = 373,
    ["importmap.json"] = 376,
    ["ioBroker Configuration"] = 378,
    ["ioBroker JSON UI"] = 379,
    ["ioBroker Package manifest"] = 380,
    ["ize.toml"] = 899,
    ["jsconfig.json"] = 404,
    ["jscpd Configuration"] = 884,
    jsdoc = 799,
    ["k3d.yaml"] = 405,
    ["k9s aliases.yaml"] = 407,
    ["k9s cluster-config.yaml"] = 409,
    ["k9s config.yaml"] = 408,
    ["k9s hotkeys.yaml"] = 410,
    ["k9s plugins.yaml"] = 411,
    ["k9s skin.yaml"] = 412,
    ["k9s views.yaml"] = 413,
    ["kontinuous-config.yaml"] = 423,
    ["kontinuous-values.yaml"] = 422,
    ["kustomization.yaml"] = 425,
    ["label-commenter-config.yml"] = 426,
    ["latexindent configuration"] = 65,
    ["launchsettings.json"] = 427,
    lazydocker = 921,
    lazygit = 920,
    ["lego.json"] = 429,
    ["lerna.json"] = 430,
    ["lgtm.yml"] = 431,
    ["liblab.config.json"] = 432,
    ["libman.json"] = 433,
    ["license-report-config.json"] = 434,
    ["linkinator.config.json"] = 436,
    ["lint-staged (.lintstagedrc)"] = 779,
    ["local.settings.json"] = 441,
    ["localazy.json"] = 442,
    ["lotus.yaml"] = 440,
    ["lsdlschema.json"] = 443,
    ["markdown-link-check"] = 842,
    maturin = 843,
    mboats = 850,
    ["micro-settings.json"] = 914,
    ["mimetypes.json"] = 455,
    ["mirrord config"] = 780,
    mise = 781,
    ["mkdocs.yml"] = 475,
    ["monospace.yml"] = 478,
    ["moon.yml"] = 993,
    ["mprocs Configuration file"] = 965,
    ["mrdocs.yml"] = 476,
    ["mta.yaml"] = 782,
    ["mtad.yaml"] = 783,
    ["mycode.json"] = 485,
    ["napari plugin manifest"] = 486,
    neoload = 794,
    ["nest-cli"] = 491,
    ["ninjs (News in JSON)"] = 490,
    ["nitro.json"] = 793,
    ["nixd configuration"] = 938,
    ["nlu.json"] = 492,
    ["nodemon.json"] = 494,
    ["noodl config"] = 849,
    ["notebook.mod.json"] = 495,
    now = 789,
    ["npm-badges"] = 498,
    ["nswag.json"] = 502,
    ntangle = 504,
    ["nuclei-template.yaml"] = 499,
    ["nuget-project.json"] = 500,
    ["ocelot.json"] = 506,
    ["omnisharp.json"] = 510,
    ["openapi.json"] = 511,
    ["openfin.json"] = 518,
    ...
    ["ops.yaml"] = 515,
    ["package.json"] = 537,
    ["package.manifest"] = 538,
    ["partial-black.json"] = 95,
    ["pathfinder.yml"] = 541,
    ["pattern.json"] = 544,
    ["petstore-v1.0"] = 894,
    pgap_yaml_input_reader = 543,
    ["pixi.toml"] = 545,
    ["plagiarize-me.yaml"] = 549,
    ["plagiarize.yaml"] = 548,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 997,
    ["podbard.yaml"] = 551,
    ["portman.json"] = 552,
    ["prefect.toml"] = 560,
    ["prettierrc.json"] = 561,
    ["prisma.yml"] = 562,
    ["project-1.0.0-beta3.json"] = 565,
    ["project-1.0.0-beta4.json"] = 566,
    ["project-1.0.0-beta5.json"] = 567,
    ["project-1.0.0-beta6.json"] = 568,
    ["project-1.0.0-beta8.json"] = 569,
    ["project-1.0.0-rc1.json"] = 570,
    ["project-1.0.0-rc2.json"] = 571,
    ["project.json"] = 564,
    ["project.owasp.yaml"] = 572,
    ["prometheus.json"] = 573,
    ["prometheus.rules.json"] = 574,
    ["prometheus.rules.test.json"] = 575,
    ["proxies.json"] = 576,
    ["publiccode.yml"] = 577,
    ["pubspec.yaml"] = 578,
    ["pyrseas-0.8.json"] = 581,
    ["quilt.mod.json"] = 915,
    ["rc3 auth"] = 593,
    ["rc3 collection"] = 594,
    ["rc3 environment"] = 595,
    ...
    samt = 618,
    samtrc = 619,
    ["sarif-1.0.0.json"] = 621,
    ["sarif-2.0.0.json"] = 622,
    ["sarif-2.1.0"] = 632,
    ["sarif-2.1.0-rtm.2"] = 623,
    ["sarif-2.1.0-rtm.3"] = 625,
    ["sarif-2.1.0-rtm.4"] = 627,
    ["sarif-2.1.0-rtm.5"] = 629,
    ["sarif-2.1.0-rtm.6"] = 630,
    ["sarif-external-property-file-2.1.0"] = 633,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 624,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 626,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 628,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 631,
    ["scalingo.json configuration"] = 634,
    ["schema.org - Action"] = 636,
    ["schema.org - ContactPoint"] = 637,
    ["schema.org - Place"] = 638,
    ["schema.org - Thing"] = 639,
    ["secrethub.yml"] = 917,
    ["semantic-release"] = 645,
    ["servicehub.config.json"] = 774,
    ["servicehub.service.json"] = 773,
    ["settings.job"] = 648,
    ["sfdx-hardis configuration"] = 650,
    ["shard.yml"] = 953,
    ["size-limit configuration"] = 655,
    ["skaffold.yaml"] = 840,
    ["skyuxconfig.json"] = 657,
    snapcraft = 658,
    ["spicepod.yaml"] = 972,
    ["sqlc configuration"] = 671,
    ["stripe-app-local.json"] = 680,
    ["stripe-app.json"] = 679,
    swcrc = 825,
    ["task.json"] = 689,
    taskcat = 790,
    ["template.json"] = 694,
    ["templatsources.json"] = 695,
    ["theme.json"] = 698,
    ["tizen_workspace.json"] = 699,
    tldr = 700,
    tmuxinator = 777,
    ["transcend.yml"] = 710,
    ["tree-sitter grammar.json"] = 349,
    ["trime.yaml"] = 711,
    ["trunk.yaml"] = 713,
    ["ts-force-config.json"] = 718,
    ["tsconfig.json"] = 714,
    ["tsd.json"] = 715,
    ["tsdoc.json"] = 716,
    ["tsdrc.json"] = 717,
    ...
    v8r = 757,
    vcluster = 959,
    ["vcpkg configuration file"] = 184,
    ["vcpkg manifest file"] = 183,
    ["vega-lite.json"] = 739,
    ["vega.json"] = 738,
    ["venvironment-basic.yaml"] = 742,
    ["venvironment.yaml"] = 741,
    version = 1015,
    ["version.json"] = 744,
    ["vhwdebugger-binding.yaml"] = 746,
    ["vim-addon-info"] = 747,
    ["vs-2017.3.host.json"] = 749,
    ["vs-nesting.json"] = 750,
    ["vsls.json"] = 748,
    ["vss-extension.json"] = 754,
    ["vtesttree.yaml"] = 755,
    ["vtestunit.yaml"] = 756,
    ["warp-keysets.json"] = 923,
    ["warp-themes.json"] = 924,
    ["warp-workflows.json"] = 925,
    ["webhint.io"] = 880,
    ["webjobpublishsettings.json"] = 761,
    ["webjobs-list.json"] = 760,
    ["well-known-fursona"] = 960,
    ["xs-app.json"] = 786,
    ["xunit.runner.json"] = 772,
    yamllint = 813,
    ["zerops.io import file"] = 969,
    ["zerops.yml"] = 968,
    zuul = 796,
    ["Žinoma"] = 806
  },
