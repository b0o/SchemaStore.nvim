...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 721,
    [".nodehawkrc"] = 464,
    [".npmpackagejsonlintrc"] = 468,
    [".omletrc"] = 896,
    [".phrase.yml"] = 515,
    [".phraseapp.yml"] = 516,
    [".pmbot.yml"] = 505,
    [".postcssrc"] = 510,
    [".powerpages-web-template-manifest"] = 512,
    [".pre-commit-config.yml"] = 513,
    [".pre-commit-hooks.yml"] = 514,
    [".putout.json"] = 535,
    [".rehyperc"] = 554,
    [".remarkrc"] = 556,
    [".sprite files"] = 618,
    ...
    ["<div>RIOTS' studio configuration"] = 693,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 418,
    ABCSupplyPlan = 13,
    AIConfig = 14,
    ["API Builder"] = 753,
    ["AVA Configuration"] = 813,
    ["AWS AppConfig Feature Flags-v1"] = 38,
    ["AWS CDK cdk.json"] = 185,
    ["AWS CloudFormation"] = 186,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 187,
    ["AWS SAM CLI Samconfig"] = 188,
    ["Adobe UXP Manifest"] = 878,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 15,
    ["Airplane task"] = 16,
    ["Alacritty Configuration"] = 785,
    ["All Contributors configuration file"] = 843,
    ["Ansible Argument Specs"] = 314,
    ["Ansible Collection Galaxy"] = 321,
    ["Ansible Execution Environment"] = 311,
    ["Ansible Inventory"] = 320,
    ["Ansible Meta"] = 312,
    ["Ansible Meta Runtime"] = 313,
    ["Ansible Navigator Configuration"] = 323,
    ["Ansible Playbook"] = 318,
    ["Ansible Requirements"] = 315,
    ["Ansible Rulebook"] = 319,
    ["Ansible Tasks File"] = 317,
    ["Ansible Vars File"] = 316,
    ["Ansible-lint Configuration"] = 322,
    Any = 905,
    ...
    ["Azure Landing Zones Library archetype definition"] = 48,
    ["Azure Landing Zones Library archetype override"] = 49,
    ["Azure Landing Zones Library architecture definition"] = 47,
    ["Azure Pipelines"] = 61,
    ["Azure Static Web Apps CLI configuration file"] = 621,
    ["Azure Static Web Apps configuration file"] = 620,
    ["BX CI"] = 100,
    ["Bashly (bashly.yml)"] = 847,
    ["Bashly Settings (bashly-settings.yml)"] = 848,
    ["Better Code Hub"] = 757,
    ["Better Scripts"] = 101,
    Bigconfig = 78,
    BizTalkServerApplicationSchema = 727,
    Bleep = 102,
    ["Block Protocol Metadata"] = 99,
    ["Boyka Framework"] = 85,
    Briefcase = 732,
    ["Build Info"] = 92,
    Buildkite = 94,
    ["Bukkit plugin.yml"] = 93,
    ["BungeeCord plugin.yml"] = 97,
    ["Butane Config"] = 798,
    ["CGS Custom Card Game (CardGameDef.json)"] = 883,
    ["CICS TS region tagging"] = 807,
    ["CICS TS resource import"] = 808,
    ["CICS TS resource model"] = 809,
    ["CICS TS resource overrides"] = 810,
    ["CMake Presets"] = 103,
    ["CNC Codes"] = 117,
    ["CRS WAF test file"] = 912,
    ["CRS WAF test platform overrides file"] = 913,
    ["CSS Comb (.csscomb.json)"] = 212,
    ["CSS Lint (.csslintrc)"] = 213,
    ["CSpell (cspell.json)"] = 211,
    ["CVE Record Format"] = 123,
    CWL = 889,
    ["Cache Warmup config"] = 104,
    ...
    Changesets = 197,
    Cheatsheets = 795,
    ["Chrome Extension"] = 178,
    ["Chromia Model"] = 111,
    ["CircleCI config.yml"] = 154,
    ["Citation File Format"] = 199,
    CityJSON = 113,
    ["Clawject config"] = 122,
    ["Cloud Foundry Application Manifest"] = 895,
    ["CloudEvents specification"] = 114,
    ["Code Climate"] = 155,
    CodeCV = 56,
    CodeRabbit = 55,
    ["CodeShip Pro services configuration files"] = 167,
    ["CodeShip Pro steps configuration files"] = 168,
    ["Codecov configuration files"] = 166,
    CodifyCLI = 57,
    Codux = 164,
    ["Cog config file"] = 118,
    ["Commandbox Box.json"] = 119,
    ["Commandbox Server.json"] = 120,
    ["Common Catalog Data"] = 176,
    Concord = 911,
    ["Configu .cfgu files"] = 900,
    ["Configu .configu file"] = 901,
    Conjure = 116,
    ["Container Structure Test"] = 740,
    Containerlab = 765,
    ["Crowdsec collection config"] = 206,
    ["Crowdsec parser config"] = 207,
    ["Crowdsec scenario config"] = 208,
    ["CumulusCI Config"] = 121,
    ["Custom Machinery Machine"] = 884,
    ["Custom Machinery Recipe"] = 885,
    ["Cycle Stack File"] = 124,
    ["DWP Exchange - catalogue entry"] = 254,
    ["DWP Exchange - gateway"] = 252,
    ["DWP Exchange - meta"] = 253,
    ["Dart Build Config (dart-build.json)"] = 214,
    ["Dart Test Config (dart-test.json)"] = 215,
    ["DashLord Configuration"] = 216,
    ["Data Contract Specification"] = 217,
    ["Data Product Specification"] = 218,
    ["DataYoga Connections"] = 125,
    ["DataYoga Job"] = 126,
    ["Databricks Asset Bundles"] = 864,
    ["Datadog Service Definition"] = 393,
    ["Datadog Software Catalog"] = 394,
    ["Datahub Ingestion Recipe"] = 814,
    ["Dein Config"] = 132,
    ["Deno Config (deno.json)"] = 224,
    ["Dependency cruiser"] = 133,
    ["Deployer Recipe"] = 227,
    ["Deta Spacefile"] = 134,
    ["Detekt Config (detekt.yml)"] = 228,
    ["Devbox Config"] = 135,
    ["Devbox Plugin"] = 136,
    Devfile = 251,
    DipDup = 914,
    ["Discord Webhook"] = 229,
    ["DocFx Config (docfx.json)"] = 233,
    ["Dolittle Artifacts"] = 234,
    ["Dolittle Bounded Context Configuration"] = 235,
    ["Dolittle Event Horizons Configuration"] = 236,
    ["Dolittle Resources Configuration"] = 237,
    ["Dolittle Server Configuration"] = 238,
    ["Dolittle Tenant Map Configuration"] = 240,
    ["Dolittle Tenants Configuration"] = 239,
    ["Dolittle Topology"] = 241,
    ["Drupal Breakpoints"] = 137,
    ["Drupal Config"] = 149,
    ["Drupal Info"] = 138,
    ["Drupal Layouts"] = 139,
    ["Drupal Libraries"] = 140,
    ["Drupal Links Action"] = 141,
    ["Drupal Links Contextual"] = 142,
    ["Drupal Links Menu"] = 143,
    ["Drupal Links Task"] = 144,
    ["Drupal Migration"] = 145,
    ["Drupal Permissions"] = 146,
    ["Drupal Recipe"] = 147,
    ["Drupal Routing"] = 148,
    ["Drupal Services"] = 150,
    ["Drush site aliases"] = 247,
    ["Dynamic Bash Aliases (.aliases)"] = 855,
    ["EAS config"] = 272,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 844,
    ["Elgato Stream Deck"] = 257,
    Elm = 916,
    ["Embrace Config"] = 825,
    Endurica = 868,
    ["Enterprise Contract Policy Spec"] = 258,
    ["Erda Pipeline"] = 891,
    ["Erda Runtime"] = 892,
    ["Error pages"] = 262,
    Esquio = 260,
    ["Estuary Flow Catalog"] = 804,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 265,
    ["EveryVoice TTS Toolkit Data Configuration"] = 266,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 270,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 269,
    ["EveryVoice TTS Toolkit Text Configuration"] = 267,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 268,
    ["Expo SDK"] = 271,
    ["F-Droid Data metadata"] = 277,
    ["Facets - FSDL - Application"] = 275,
    ["FasterCI Configuration"] = 62,
    FiQuS = 281,
    Firebase = 279,
    ["Flow.json Configurations"] = 888,
    ["Fossa configuration file"] = 288,
    ["Fossa's fossa-deps file"] = 289,
    ["Foundry VTT - Base package Manifest"] = 283,
    ["Foundry VTT - Module Manifest"] = 284,
    ["Foundry VTT - System Data Template"] = 287,
    ["Foundry VTT - System Manifest"] = 285,
    ["Foundry VTT - World Manifest"] = 286,
    ["Foxx Manifest"] = 63,
    ["Freifunk.de Community API"] = 66,
    ["Frogbot Config"] = 67,
    ["G2P Mapping Configuration"] = 293,
    ["GCP Blueprint Metadata"] = 296,
    Gaspar = 294,
    ["GatewayCore API Gateway"] = 295,
    ["GeoJSON.json latest"] = 802,
    GherKing = 806,
    ["GitHub Action"] = 301,
    ["GitHub Discussion"] = 302,
    ["GitHub Funding"] = 303,
    ["GitHub Issue Template configuration"] = 305,
    ["GitHub Issue Template forms"] = 304,
    ["GitHub Workflow"] = 306,
    ["GitHub Workflow Template Properties"] = 307,
    ["GitHub automatically generated release notes configuration"] = 308,
    ["GitLab Agent for Kubernetes configuration"] = 880,
    GitVersion = 298,
    ["Gitea Issue Template configuration"] = 299,
    ["Gitea Issue Template forms"] = 300,
    ["Gitpod Configuration"] = 310,
    ["GlazeWM settings"] = 882,
    ["Global Privacy Control"] = 297,
    Goblet = 863,
    ["Golangci-lint Configuration"] = 325,
    ["Golangci-lint Custom Plugins Configuration"] = 326,
    ["Google Chrome Related Website Sets"] = 280,
    ["Google Cloud Workflows"] = 184,
    Goreleaser = 328,
    ["Goreleaser Pro"] = 329,
    Goss = 330,
    ["Gradle Build Cache Node"] = 755,
    ["Gradle Enterprise"] = 754,
    ["Grafana 5.x Dashboard"] = 331,
    ["GraphQL Code Generator"] = 335,
    ["GraphQL Config"] = 334,
    ["GraphQL Mesh"] = 333,
    ["Grunt JSHint task"] = 339,
    ["Grunt Watch task"] = 340,
    ["Grunt base task"] = 341,
    ["Grunt clean task"] = 337,
    ["Grunt copy task"] = 336,
    ["Grunt cssmin task"] = 338,
    HEMTT = 724,
    Hadolint = 736,
    Hammerkit = 764,
    ["Hardware Sentry Configuration"] = 818,
    Hatch = 737,
    Hayson = 343,
    ["Haystack Pipeline"] = 344,
    ["Hazelcast 5 Configuration"] = 345,
    ["Helm Chart.lock"] = 152,
    ["Helm Chart.yaml"] = 151,
    ["Helm Unittest Test Suite"] = 153,
    Hugo = 794,
    ["Hugo Theme"] = 793,
    ["Hyperfoil benchmark configuration"] = 351,
    ["IBM Zapp document"] = 352,
    ["IBM zCodeFormatSettings"] = 353,
    ["IMG Catapult PSP"] = 358,
    ["IVMS101 by CODE Protocol"] = 881,
    Infrahub = 360,
    Istanbul = 821,
    ["JDownloader2 crawler multi-rules"] = 369,
    ["JDownloader2 crawler single-rules"] = 368,
    ["JFrog Applications Config"] = 370,
    ["JFrog File Spec"] = 371,
    ["JFrog Pipelines YML DSL"] = 827,
    ["JMeter DSL cli config"] = 372,
    JReleaser = 374,
    ["JSON Document Transform"] = 382,
    ["JSON Feed"] = 383,
    ["JSON Resume"] = 561,
    ["JSON Schema Draft 2020-12"] = 706,
    ["JSON Schema Draft 4"] = 703,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 865,
    ["JSON Schema Draft 7"] = 704,
    ["JSON Schema Draft 7 (unofficial strict)"] = 866,
    ["JSON Schema Draft 8 (2019-09)"] = 705,
    ["JSON-API"] = 381,
    ["JSON-WF"] = 894,
    ["JSON-e templates"] = 762,
    ["JSON-stat 2.0"] = 700,
    JSONPatch = 385,
    ["JSR Package Config (jsr.json)"] = 375,
    Jasmine = 364,
    Jekyll = 365,
    ["Jenkins X Pipelines"] = 366,
    ["Jenkins X Requirements"] = 367,
    ["Jovo Language Models"] = 373,
    ["KIMMDY config file"] = 390,
    ["KSP-AVC"] = 701,
    ["KSP-CKAN"] = 702,
    KSY = 893,
    ["Karakum configuration file"] = 290,
    Kas = 388,
    ["Kestra flow file"] = 391,
    ["Keycloak REST API"] = 835,
    ["Knative Functions - func.yaml"] = 291,
    ["KoDE/CI build.yaml"] = 823,
    ["Kong DBLess config"] = 824,
    KrakenD = 392,
    ["Kubri Configuration"] = 398,
    LOOBin = 413,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 189,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 190,
    ["Landing Zone Accelerator on AWS - Global Config"] = 191,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 192,
    ["Landing Zone Accelerator on AWS - Network Config"] = 193,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 194,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 195,
    ["Landing Zone Accelerator on AWS - Security Config"] = 196,
    ["Language configuration"] = 904,
    Lefthook = 402,
    ["Liferay client-extension.yaml"] = 409,
    ["LinkML Metamodel"] = 411,
    Liquibase = 770,
    ["Liquibase Flow File"] = 771,
    ["Lively Properties"] = 412,
    ["Lobe AI Agent"] = 59,
    Loki = 60,
    ["MLOS Configs"] = 448,
    ["MS2Rescore Configuration"] = 451,
    ["Madness (madness.yml)"] = 846,
    Markdownlint = 774,
    ["Mason Registry"] = 776,
    ["MegaLinter configuration"] = 419,
    ["MegaLinter descriptor"] = 420,
    Melange = 872,
    ["Meltano plugin discovery definition"] = 422,
    ["Meltano project definition"] = 421,
    ["Mergify Configuration"] = 452,
    ["Metadata for a Bazel module"] = 423,
    ["MetricsHub Configuration"] = 424,
    ["MetricsHub Connector Configuration"] = 425,
    ["Micro Editor Syntax"] = 856,
    ["Microsoft Band Web Tile"] = 426,
    ["Microsoft RulesEngine workflow rules"] = 908,
    ["Microsoft RulesEngine workflow rules list"] = 909,
    ["Minecraft Custom Main Menu Mod"] = 873,
    ["Minecraft Data Pack Advancement"] = 428,
    ["Minecraft Data Pack Biome"] = 429,
    ["Minecraft Data Pack Configured Carver"] = 430,
    ["Minecraft Data Pack Damage Type"] = 431,
    ["Minecraft Data Pack Dimension"] = 433,
    ["Minecraft Data Pack Dimension Type"] = 432,
    ["Minecraft Data Pack Item Modifier"] = 434,
    ["Minecraft Data Pack Loot Table"] = 435,
    ["Minecraft Data Pack Metadata"] = 436,
    ["Minecraft Data Pack Predicate"] = 437,
    ["Minecraft Data Pack Recipe"] = 438,
    ["Minecraft Data Pack Tag"] = 439,
    ["Minecraft Data Pack Template Pool"] = 440,
    ["Minecraft Data Pack Trim Material"] = 445,
    ["Minecraft Data Pack Trim Pattern"] = 446,
    ["Minecraft Resource Pack Lang"] = 441,
    ["Minecraft Resource Pack Particle"] = 442,
    ["Minecraft Resource Pack Texture Mcmeta"] = 444,
    ["Minecraft Resourcepack Sounds"] = 443,
    ["Monade CLI Stack Configuration"] = 455,
    ["MongoDB Atlas Search Index Definition"] = 822,
    ["Monika Configuration"] = 820,
    ["Monoweave Configuration"] = 450,
    ["Motif config"] = 720,
    ["NOX Framework (Service)"] = 467,
    ["Netin Diagnostic System Template"] = 780,
    ["Netlify config"] = 458,
    ["Network-as-Code Data Model"] = 459,
    ["Nightwatch.js"] = 460,
    ["Nuitka.yaml"] = 886,
    ["ONe's changelog entry"] = 483,
    ["ONe's service descriptor"] = 482,
    ["OSS Review Toolkit configuration"] = 491,
    ["OSS Review Toolkit curation"] = 492,
    ["OSS Review Toolkit package configuration"] = 493,
    ["OSS Review Toolkit repository configuration"] = 494,
    ["OSS Review Toolkit resolutions"] = 495,
    Opctl = 723,
    ["Open Data Contract Standard (ODCS))"] = 486,
    ["OpenRewrite Resource"] = 485,
    ["OpenUtau character yaml"] = 479,
    ["OpenUtau ustx"] = 480,
    ["OpenWeather Current Weather API"] = 761,
    ["OpenWeather Road Risk API"] = 760,
    ["Ory Hydra configuration"] = 350,
    ["Ory Keto configuration"] = 395,
    ["Ory Kratos configuration"] = 490,
    ["Ory Oathkeeper configuration"] = 474,
    ["Outblocks App configuration"] = 488,
    ["Outblocks database table"] = 489,
    ["Outblocks project configuration"] = 487,
    PDM = 501,
    Packer = 498,
    Pantsbuild = 842,
    ["Paper paper-plugin.yml"] = 499,
    ["Pipeline component"] = 772,
    ["PocketMine plugin.yml"] = 506,
    ["Postman collection"] = 511,
    ["Problem object RFC9457"] = 870,
    ["Problem package generators"] = 519,
    Pterodactyl = 817,
    ["Pull Request Labeler"] = 534,
    Pulumi = 540,
    PyProject = 541,
    Pyright = 542,
    Qgoda = 543,
    Qodana = 790,
    ["Qt Creator workspace file"] = 902,
    ["Quali Torque Blueprint Spec 2"] = 815,
    ["QueryFirst config file"] = 838,
    ["RKE Cluster Configuration JSON"] = 769,
    ["RKE Cluster Configuration YAML"] = 768,
    ["Rancher Fleet"] = 537,
    ["Rattler-build"] = 544,
    Ray = 735,
    ["Read the Docs"] = 539,
    ["Red-DiscordBot Cog"] = 551,
    ["Red-DiscordBot Cog Repo"] = 552,
    ["Red-DiscordBot Trivia"] = 553,
    ["Render Blueprints"] = 767,
    RenderCV = 563,
    Renovate = 562,
    ["Replit config"] = 557,
    RoadRunner = 564,
    ["Rudder techniques"] = 876,
    Ruff = 559,
    ["Rust Project"] = 560,
    ["Rust toolchain"] = 568,
    ["SDMX data message"] = 593,
    ["SDMX metadata message"] = 592,
    ["SDMX structure message"] = 591,
    ["SIL Kit Participant Configuration"] = 603,
    ["SIL Kit Registry Configuration"] = 604,
    SWADL = 632,
    ["Safebox Config"] = 828,
    ["Sapphire CLI Config"] = 571,
    ["SauceCTL Configuration"] = 777,
    ["Schema Catalog"] = 585,
    ["Scoop manifest"] = 590,
    ["Semantic Data Fabric (SDF) file"] = 594,
    ["Semgrep Rule"] = 596,
    ["Serenity Code Generator (Sergen)"] = 597,
    ["Serverless Framework Configuration"] = 784,
    ["Serverless Workflow"] = 786,
    ["Settings.paf"] = 599,
    ["Shopware 6 Configuration"] = 787,
    ["Shopware CLI Extension Store Configuration"] = 788,
    ["Shopware CLI Project Store Configuration"] = 789,
    Sigma = 601,
    ["Sigrid scope configuration file"] = 602,
    ["SkyPilot Task JSON"] = 877,
    ["Slack app manifest"] = 606,
    Solidarity = 609,
    ["Solution filters"] = 610,
    ["Source Maps v3"] = 611,
    Sourcery = 612,
    ["Speakeasy Lint Configuration File"] = 613,
    ["Speakeasy Test Generation Configuration File"] = 614,
    ["Speakeasy Workflow File"] = 615,
    SpecIF = 616,
    ["Sponge Mixin configuration"] = 617,
    StackBlitz = 622,
    ["StackHawk Scanner Configuration"] = 783,
    Stale = 623,
    ["Starlake Data Pipeline"] = 758,
    Starship = 624,
    ["Statamic Blueprint"] = 625,
    ["Stella configuration file"] = 626,
    ["StrmPrivacy Data Connector"] = 832,
    ["StrmPrivacy Data Contract"] = 833,
    ["StrmPrivacy SimpleSchema"] = 830,
    ["StrmPrivacy Stream"] = 831,
    ["StrmPrivacy batch job configuration file"] = 829,
    ["Stryker Mutator"] = 629,
    ["StyleCop Analyzers Configuration"] = 630,
    ["Stylelint (.stylelintrc)"] = 631,
    ["Sublime Syntax"] = 834,
    ["Subsquid squid manifest"] = 879,
    ["Swagger API 2.0"] = 633,
    TSON = 659,
    TSTyche = 660,
    Talhelper = 635,
    ["Talisman configuration"] = 636,
    ["Taskfile config"] = 763,
    Taurus = 637,
    ["TestEnvironment.json"] = 646,
    ["TextMate Grammar"] = 645,
    ["Tier.run pricing.json"] = 640,
    Tikibase = 641,
    ["Traefik v2"] = 649,
    ["Traefik v2 File Provider"] = 650,
    ["Travis CI (.travis.yml)"] = 648,
    TunnelHub = 869,
    Turborepo = 647,
    Tycho = 915,
    Tye = 791,
    ["UET BuildConfig.json"] = 839,
    ["UI5 Manifest"] = 669,
    ["UNCORS configuration"] = 673,
    ["UTAM Page Object"] = 672,
    ["Ubuntu Server Autoinstall"] = 667,
    ["Uniswap Token List"] = 746,
    ["Unreal Engine Uplugin"] = 840,
    ["Unreal Engine Uproject"] = 841,
    ["Updatecli Compose"] = 799,
    ["Updatecli Policy Manifest"] = 800,
    ["Updatecli Policy Metadata"] = 801,
    Uplift = 837,
    ["User Journey Map"] = 766,
    V2Ray = 805,
    ["VSCode Code Snippets"] = 172,
    ["VSIX CLI publishing"] = 688,
    ["Vela Pipeline Configuration"] = 677,
    Vercel = 171,
    Visivo = 867,
    ["Web App Manifest"] = 695,
    ["Web types"] = 698,
    WebExtensions = 694,
    ["Webman package recipe"] = 811,
    ["Windows Package Manager Installer Manifest"] = 743,
    ["Windows Package Manager Locale Manifest"] = 744,
    ["Windows Package Manager Singleton Manifest"] = 742,
    ["Woodpecker pipeline config"] = 779,
    ["Wrangler CLI"] = 699,
    ["Xstate Machine"] = 797,
    ["Yarn Config (.yarnrc.yml)"] = 756,
    ["Yippee-Ki-JSON configuration YML"] = 748,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 871,
    ...
    ["behat.yml"] = 86,
    ["bigquery-table"] = 77,
    ["bioimageio resource description"] = 887,
    ["bitbucket-pipelines"] = 79,
    bitrise = 80,
    ["bitrise-step"] = 81,
    ["block.json"] = 98,
    ["bottom configuration"] = 50,
    ["bower.json"] = 83,
    ["bozr.suite.json"] = 88,
    bpkg = 850,
    ["browser.i18n.json"] = 89,
    ["browsh configuration"] = 90,
    bucklescript = 91,
    ["buf.gen.yaml"] = 52,
    ["buf.plugin.yaml"] = 53,
    ["buf.work.yaml"] = 54,
    ["buf.yaml"] = 51,
    ["bundleconfig.json"] = 96,
    changelogging = 899,
    ["chisel-slices.json"] = 198,
    ["chrome-extension-locales-messages.json"] = 179,
    ["chutzpah.json"] = 180,
    cibuildwheel = 112,
    ["clang-format (.clang-format)"] = 803,
    ["clang-tidy"] = 159,
    clangd = 158,
    clib = 160,
    ["cloud-init: cloud-config userdata"] = 162,
    ["cloud-sdk-pipeline-configuration"] = 182,
    ["cloudbuild.json"] = 183,
    cloudify = 161,
    codemagic = 163,
    ["coffeelint.json"] = 200,
    ["commands.json"] = 175,
    ["commitlint (.commitlintrc)"] = 745,
    ["compile_commands.json"] = 174,
    ["compilerconfig.json"] = 173,
    ["completely.yml"] = 845,
    ["component-detection-manifest.json"] = 203,
    ["component.json"] = 202,
    ["composer.json"] = 201,
    ["conda-forge"] = 115,
    ["config.yaml"] = 538,
    ["contentmanifest.json"] = 181,
    ["contribute.json"] = 204,
    ["cosmos.config.json"] = 177,
    ["crowdin.yml"] = 205,
    ["custom-elements.json"] = 859,
    ["cypress.json"] = 209,
    ["datalogic-scan2deploy-android"] = 219,
    ["datalogic-scan2deploy-ce"] = 220,
    ["dbt Dependencies"] = 127,
    ["dbt Packages"] = 129,
    ["dbt Project"] = 128,
    ["dbt Selectors"] = 130,
    ["dbt YAML files"] = 131,
    ["ddev-global"] = 221,
    ["ddev-project"] = 222,
    ["debugsettings.json"] = 223,
    ["dependabot-v2.json"] = 226,
    ["dependabot.json"] = 225,
    ["deployed-cli"] = 796,
    ["devcontainer.json"] = 165,
    devinit = 750,
    ["devspace.yaml"] = 819,
    djlint = 751,
    ["docker bake"] = 231,
    ["docker sequencer"] = 232,
    ["docker-compose.yml"] = 749,
    ["dockerd.json"] = 230,
    ["dotnet Release Index manifest"] = 242,
    ["dotnet-tools.json"] = 243,
    ["dotnetcli.host.json"] = 244,
    ["dprint.json"] = 245,
    ["drone.json"] = 246,
    ["dss-2.0.0.json"] = 248,
    ["dstack configuration"] = 249,
    ["dvc.yaml"] = 250,
    ["ecosystem.json"] = 255,
    eksctl = 256,
    ["electron-builder configuration file"] = 263,
    ["epr-manifest.json"] = 261,
    ["evcc.yaml"] = 264,
    ["ezd task runner"] = 273,
    ["fabric.mod.json"] = 276,
    ["first-timers-bot"] = 282,
    ...
    ["gitlab-ci"] = 309,
    ["global.json"] = 324,
    ["go-feature-flag Flag Configuration"] = 327,
    ["haxelib.json"] = 342,
    helmfile = 738,
    helmwave = 739,
    ["host-meta.json"] = 347,
    ...
    ["ide.host.json"] = 354,
    ["ifstate.conf"] = 355,
    ["imageoptimizer.json"] = 356,
    ["importmap.json"] = 359,
    ["ioBroker Configuration"] = 361,
    ["ioBroker JSON UI"] = 362,
    ["ioBroker Package manifest"] = 363,
    ["ize.toml"] = 836,
    ["jsconfig.json"] = 386,
    ["jscpd Configuration"] = 816,
    jsdoc = 734,
    ["k3d.yaml"] = 387,
    ["k9s plugin.yml"] = 389,
    ["kontinuous-config.yaml"] = 397,
    ["kontinuous-values.yaml"] = 396,
    ["kustomization.yaml"] = 399,
    ["label-commenter-config.yml"] = 400,
    ["latexindent configuration"] = 58,
    ["launchsettings.json"] = 401,
    lazydocker = 858,
    lazygit = 857,
    ["lego.json"] = 403,
    ["lerna.json"] = 404,
    ["lgtm.yml"] = 405,
    ["liblab.config.json"] = 406,
    ["libman.json"] = 407,
    ["license-report-config.json"] = 408,
    ["linkinator.config.json"] = 410,
    ["lint-staged (.lintstagedrc)"] = 714,
    ["local.settings.json"] = 415,
    ["localazy.json"] = 416,
    ["lotus.yaml"] = 414,
    ["lsdlschema.json"] = 417,
    ["markdown-link-check"] = 775,
    mboats = 782,
    ["micro-settings.json"] = 851,
    ["mimetypes.json"] = 427,
    ["mirrord config"] = 715,
    mise = 716,
    ["mise-settings"] = 717,
    ["mkdocs.yml"] = 447,
    ["monospace.yml"] = 449,
    ["mprocs Configuration file"] = 903,
    ["mta.yaml"] = 718,
    ["mtad.yaml"] = 719,
    ["mycode.json"] = 456,
    ["napari plugin manifest"] = 457,
    neoload = 729,
    ["nest-cli"] = 462,
    ["ninjs (News in JSON)"] = 461,
    ["nixd configuration"] = 875,
    ["nlu.json"] = 463,
    ["nodemon.json"] = 465,
    ["noodl config"] = 781,
    ["notebook.mod.json"] = 466,
    now = 725,
    ["npm-badges"] = 469,
    ["nswag.json"] = 472,
    ntangle = 473,
    ["nuclei-template.yaml"] = 470,
    ["nuget-project.json"] = 471,
    ["ocelot.json"] = 475,
    ["omnisharp.json"] = 476,
    ["openapi.json"] = 477,
    ["openfin.json"] = 484,
    ...
    ["ops.yaml"] = 481,
    ["package.json"] = 496,
    ["package.manifest"] = 497,
    ["partial-black.json"] = 87,
    ["pathfinder.yml"] = 500,
    ["pattern.json"] = 503,
    ["petstore-v1.0"] = 826,
    pgap_yaml_input_reader = 502,
    ["pixi.toml"] = 504,
    ["plagiarize-me.yaml"] = 508,
    ["plagiarize.yaml"] = 507,
    ["portman.json"] = 509,
    ["prettierrc.json"] = 517,
    ["prisma.yml"] = 518,
    ["project-1.0.0-beta3.json"] = 521,
    ["project-1.0.0-beta4.json"] = 522,
    ["project-1.0.0-beta5.json"] = 523,
    ["project-1.0.0-beta6.json"] = 524,
    ["project-1.0.0-beta8.json"] = 525,
    ["project-1.0.0-rc1.json"] = 526,
    ["project-1.0.0-rc2.json"] = 527,
    ["project.json"] = 520,
    ["prometheus.json"] = 528,
    ["prometheus.rules.json"] = 529,
    ["prometheus.rules.test.json"] = 530,
    ["proxies.json"] = 531,
    ["publiccode.yml"] = 532,
    ["pubspec.yaml"] = 533,
    ["pyrseas-0.8.json"] = 536,
    ["quilt.mod.json"] = 852,
    ["rc3 auth"] = 545,
    ["rc3 collection"] = 546,
    ["rc3 environment"] = 547,
    ...
    samt = 569,
    samtrc = 570,
    ["sarif-1.0.0.json"] = 572,
    ["sarif-2.0.0.json"] = 573,
    ["sarif-2.1.0"] = 583,
    ["sarif-2.1.0-rtm.2"] = 574,
    ["sarif-2.1.0-rtm.3"] = 576,
    ["sarif-2.1.0-rtm.4"] = 578,
    ["sarif-2.1.0-rtm.5"] = 580,
    ["sarif-2.1.0-rtm.6"] = 581,
    ["sarif-external-property-file-2.1.0"] = 584,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 575,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 577,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 579,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 582,
    ["schema.org - Action"] = 586,
    ["schema.org - ContactPoint"] = 587,
    ["schema.org - Place"] = 588,
    ["schema.org - Thing"] = 589,
    ["secrethub.yml"] = 854,
    ["semantic-release"] = 595,
    ["servicehub.config.json"] = 709,
    ["servicehub.service.json"] = 708,
    ["settings.job"] = 598,
    ["sfdx-hardis configuration"] = 600,
    ["shard.yml"] = 890,
    ["size-limit configuration"] = 605,
    ["skaffold.yaml"] = 773,
    ["skyuxconfig.json"] = 607,
    snapcraft = 608,
    ["spicepod.yaml"] = 910,
    ["sqlc configuration"] = 619,
    ["stripe-app-local.json"] = 628,
    ["stripe-app.json"] = 627,
    swcrc = 759,
    ["task.json"] = 634,
    taskcat = 726,
    ["template.json"] = 638,
    ["templatsources.json"] = 639,
    ["theme.json"] = 642,
    ["tizen_workspace.json"] = 643,
    tldr = 644,
    tmuxinator = 712,
    ["transcend.yml"] = 651,
    ["tree-sitter grammar.json"] = 332,
    ["trime.yaml"] = 652,
    ["trunk.yaml"] = 653,
    ["ts-force-config.json"] = 657,
    ["tsconfig.json"] = 654,
    ["tsd.json"] = 655,
    ["tsdrc.json"] = 656,
    ["tslint.json"] = 658,
    ...
    v8r = 692,
    vcluster = 897,
    ["vcpkg configuration file"] = 170,
    ["vcpkg manifest file"] = 169,
    ["vega-lite.json"] = 676,
    ["vega.json"] = 675,
    ["venvironment-basic.yaml"] = 679,
    ["venvironment.yaml"] = 678,
    ["version.json"] = 680,
    ["vim-addon-info"] = 682,
    ["vs-2017.3.host.json"] = 684,
    ["vs-nesting.json"] = 685,
    ["vsls.json"] = 683,
    ["vss-extension.json"] = 689,
    ["vtesttree.yaml"] = 690,
    ["vtestunit.yaml"] = 691,
    ["warp-keysets.json"] = 860,
    ["warp-themes.json"] = 861,
    ["warp-workflows.json"] = 862,
    ["webhint.io"] = 812,
    ["webjobpublishsettings.json"] = 697,
    ["webjobs-list.json"] = 696,
    ["well-known-fursona"] = 898,
    ["xs-app.json"] = 722,
    ["xunit.runner.json"] = 707,
    yamllint = 747,
    ["zerops.io import file"] = 907,
    ["zerops.yml"] = 906,
    zuul = 731,
    ["Žinoma"] = 741
  },
