...
M.json = {
  ...
  index = {
    ...
    ["All Contributors configuration file"] = 733,
    ...
    ["JSON Schema Draft 7 (unofficial strict)"] = 755,
    ...
    Turborepo = 543,
    Tye = 683,
    ["UET BuildConfig.json"] = 729,
    ["UI5 Manifest"] = 562,
    ["UTAM Page Object"] = 565,
    ["Ubuntu Server Autoinstall"] = 560,
    ["Uniswap Token List"] = 638,
    ["Unreal Engine Uplugin"] = 730,
    ["Unreal Engine Uproject"] = 731,
    ...
    ["bamboo-spec"] = 70,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 738,
    ["bashly-strings.yml"] = 739,
    ["bashly.yml"] = 737,
    ["batect.yml"] = 69,
    ...
    ["vtesttree.yaml"] = 580,
    ["vtestunit.yaml"] = 581,
    ["warp-keysets.json"] = 750,
    ["warp-themes.json"] = 751,
    ["warp-workflows.json"] = 752,
    ["webhint.io"] = 703,
