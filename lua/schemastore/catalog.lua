...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 199,
    [".cryproj (generic)"] = 672,
    [".cryproj engine-5.2"] = 667,
    [".cryproj engine-5.3"] = 668,
    [".cryproj engine-5.4"] = 669,
    [".cryproj engine-5.5"] = 670,
    [".cryproj engine-dev"] = 671,
    [".eslintrc"] = 255,
    [".esmrc.json"] = 247,
    [".ffizer.yaml"] = 259,
    [".htmlhintrc"] = 315,
    ...
    [".mtaext"] = 683,
    [".nodehawkrc"] = 426,
    [".npmpackagejsonlintrc"] = 430,
    [".omletrc"] = 858,
    [".phrase.yml"] = 476,
    [".phraseapp.yml"] = 477,
    [".pmbot.yml"] = 466,
    [".postcssrc"] = 471,
    [".powerpages-web-template-manifest"] = 473,
    [".pre-commit-config.yml"] = 474,
    [".pre-commit-hooks.yml"] = 475,
    [".putout.json"] = 496,
    [".rehyperc"] = 515,
    [".remarkrc"] = 517,
    [".sprite files"] = 575,
    ...
    ["<div>RIOTS' studio configuration"] = 650,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 380,
    ABCSupplyPlan = 13,
    AIConfig = 14,
    ["API Builder"] = 715,
    ["AVA Configuration"] = 775,
    ...
    ["Adobe UXP Manifest"] = 840,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 15,
    ["Airplane task"] = 16,
    ["Alacritty Configuration"] = 747,
    ["All Contributors configuration file"] = 805,
    ...
    ["Azure Pipelines"] = 68,
    ["Azure Static Web Apps CLI configuration file"] = 578,
    ["Azure Static Web Apps configuration file"] = 577,
    ["BX CI"] = 106,
    ["Bashly (bashly.yml)"] = 809,
    ["Bashly Settings (bashly-settings.yml)"] = 810,
    ["Better Code Hub"] = 719,
    ["Better Scripts"] = 107,
    Bigconfig = 85,
    BizTalkServerApplicationSchema = 689,
    Bleep = 108,
    ...
    ["Butane Config"] = 760,
    ["CGS Custom Card Game (CardGameDef.json)"] = 845,
    ["CICS TS region tagging"] = 769,
    ["CICS TS resource import"] = 770,
    ["CICS TS resource model"] = 771,
    ["CICS TS resource overrides"] = 772,
    ["CMake Presets"] = 109,
    ["CNC Codes"] = 121,
    ...
    CityJSON = 118,
    ["Clawject config"] = 126,
    ["Cloud Foundry Application Manifest"] = 857,
    ["Code Climate"] = 154,
    CodeCV = 64,
    ...
    ["DataYoga Job"] = 130,
    ["Databricks Asset Bundles"] = 826,
    ["Datadog Service Definition"] = 357,
    ["Datahub Ingestion Recipe"] = 776,
    ["Dein Config"] = 132,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 817,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 806,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 842,
    GitVersion = 279,
    ["Gitea Issue Template configuration"] = 280,
    ["Gitea Issue Template forms"] = 281,
    ["Gitpod Configuration"] = 290,
    ["GlazeWM settings"] = 844,
    ["Global Privacy Control"] = 278,
    Goblet = 825,
    ["Golangci-lint Configuration"] = 292,
    ["Golangci-lint Custom Plugins Configuration"] = 293,
    ["Google Chrome Related Website Sets"] = 261,
    ["Google Cloud Workflows"] = 182,
    Goreleaser = 295,
    ["Goreleaser Pro"] = 296,
    Goss = 297,
    ["Gradle Build Cache Node"] = 717,
    ["Gradle Enterprise"] = 716,
    ["Grafana 5.x Dashboard"] = 298,
    ["GraphQL Code Generator"] = 302,
    ["GraphQL Config"] = 301,
    ["GraphQL Mesh"] = 300,
    ["Grunt JSHint task"] = 306,
    ["Grunt Watch task"] = 307,
    ["Grunt base task"] = 308,
    ["Grunt clean task"] = 304,
    ["Grunt copy task"] = 303,
    ["Grunt cssmin task"] = 305,
    HEMTT = 686,
    Hadolint = 698,
    Hammerkit = 726,
    ["Hardware Sentry Configuration"] = 780,
    Hatch = 699,
    Hayson = 310,
    ["Haystack Pipeline"] = 311,
    ["Hazelcast 5 Configuration"] = 312,
    ["Helm Chart.lock"] = 151,
    ["Helm Chart.yaml"] = 150,
    ["Helm Unittest Test Suite"] = 152,
    Hugo = 756,
    ["Hugo Theme"] = 755,
    ["Hyperfoil benchmark configuration"] = 317,
    ["IBM Zapp document"] = 318,
    ["IBM zCodeFormatSettings"] = 319,
    ["IMG Catapult PSP"] = 324,
    ["IVMS101 by CODE Protocol"] = 843,
    Istanbul = 783,
    ["JDownloader2 crawler multi-rules"] = 334,
    ["JDownloader2 crawler single-rules"] = 333,
    ["JFrog Applications Config"] = 335,
    ["JFrog File Spec"] = 336,
    ["JFrog Pipelines YML DSL"] = 789,
    ["JMeter DSL cli config"] = 337,
    JReleaser = 339,
    ["JSON Document Transform"] = 347,
    ["JSON Feed"] = 348,
    ["JSON Resume"] = 522,
    ["JSON Schema Draft 2020-12"] = 663,
    ["JSON Schema Draft 4"] = 660,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 827,
    ["JSON Schema Draft 7"] = 661,
    ["JSON Schema Draft 7 (unofficial strict)"] = 828,
    ["JSON Schema Draft 8 (2019-09)"] = 662,
    ["JSON-API"] = 346,
    ["JSON-WF"] = 856,
    ["JSON-e templates"] = 724,
    ["JSON-stat 2.0"] = 657,
    JSONPatch = 350,
    ["JSR Package Config (jsr.json)"] = 340,
    Jasmine = 329,
    Jekyll = 330,
    ["Jenkins X Pipelines"] = 331,
    ["Jenkins X Requirements"] = 332,
    ["Jovo Language Models"] = 338,
    ["KIMMDY config file"] = 355,
    ["KSP-AVC"] = 658,
    ["KSP-CKAN"] = 659,
    KSY = 855,
    ["Karakum configuration file"] = 271,
    Kas = 353,
    ["Keycloak REST API"] = 797,
    ["Knative Functions - func.yaml"] = 272,
    ["KoDE/CI build.yaml"] = 785,
    ["Kong DBLess config"] = 786,
    KrakenD = 356,
    LOOBin = 375,
    Lefthook = 364,
    ["Liferay client-extension.yaml"] = 371,
    ["LinkML Metamodel"] = 373,
    Liquibase = 732,
    ["Liquibase Flow File"] = 733,
    ["Lively Properties"] = 374,
    ["Lobe AI Agent"] = 66,
    Loki = 67,
    ["MLOS Configs"] = 409,
    ["MS2Rescore Configuration"] = 412,
    ["Madness (madness.yml)"] = 808,
    Markdownlint = 736,
    ["Mason Registry"] = 738,
    ["MegaLinter configuration"] = 381,
    ["MegaLinter descriptor"] = 382,
    Melange = 834,
    ["Meltano plugin discovery definition"] = 384,
    ["Meltano project definition"] = 383,
    ["Mergify Configuration"] = 413,
    ["MetricsHub Configuration"] = 385,
    ["MetricsHub Connector Configuration"] = 386,
    ["Micro Editor Syntax"] = 818,
    ["Microsoft Band Web Tile"] = 387,
    ["Minecraft Custom Main Menu Mod"] = 835,
    ["Minecraft Data Pack Advancement"] = 389,
    ["Minecraft Data Pack Biome"] = 390,
    ["Minecraft Data Pack Configured Carver"] = 391,
    ["Minecraft Data Pack Damage Type"] = 392,
    ["Minecraft Data Pack Dimension"] = 394,
    ["Minecraft Data Pack Dimension Type"] = 393,
    ["Minecraft Data Pack Item Modifier"] = 395,
    ["Minecraft Data Pack Loot Table"] = 396,
    ["Minecraft Data Pack Metadata"] = 397,
    ["Minecraft Data Pack Predicate"] = 398,
    ["Minecraft Data Pack Recipe"] = 399,
    ["Minecraft Data Pack Tag"] = 400,
    ["Minecraft Data Pack Template Pool"] = 401,
    ["Minecraft Data Pack Trim Material"] = 406,
    ["Minecraft Data Pack Trim Pattern"] = 407,
    ["Minecraft Resource Pack Lang"] = 402,
    ["Minecraft Resource Pack Particle"] = 403,
    ["Minecraft Resource Pack Texture Mcmeta"] = 405,
    ["Minecraft Resourcepack Sounds"] = 404,
    ["MkDocs Configuration 1.0"] = 408,
    ["Monade CLI Stack Configuration"] = 416,
    ["MongoDB Atlas Search Index Definition"] = 784,
    ["Monika Configuration"] = 782,
    ["Monoweave Configuration"] = 411,
    ["Motif config"] = 682,
    ["NOX Framework (Service)"] = 429,
    ["Netin Diagnostic System Template"] = 742,
    ["Netlify config"] = 419,
    ["Network-as-Code Data Model"] = 420,
    ["Nightwatch.js"] = 421,
    ["Nuitka.yaml"] = 848,
    ["ONe's changelog entry"] = 445,
    ["ONe's service descriptor"] = 444,
    ["OSS Review Toolkit configuration"] = 452,
    ["OSS Review Toolkit curation"] = 453,
    ["OSS Review Toolkit package configuration"] = 454,
    ["OSS Review Toolkit repository configuration"] = 455,
    ["OSS Review Toolkit resolutions"] = 456,
    Opctl = 685,
    ["OpenRewrite Resource"] = 447,
    ["OpenUtau character yaml"] = 441,
    ["OpenUtau ustx"] = 442,
    ["OpenWeather Current Weather API"] = 723,
    ["OpenWeather Road Risk API"] = 722,
    ["Ory Hydra configuration"] = 316,
    ["Ory Keto configuration"] = 358,
    ["Ory Kratos configuration"] = 451,
    ["Ory Oathkeeper configuration"] = 436,
    ["Outblocks App configuration"] = 449,
    ["Outblocks database table"] = 450,
    ["Outblocks project configuration"] = 448,
    PDM = 462,
    Packer = 459,
    Pantsbuild = 804,
    ["Paper paper-plugin.yml"] = 460,
    ["Pipeline component"] = 734,
    ["PocketMine plugin.yml"] = 467,
    ["Postman collection"] = 472,
    ["Problem object RFC9457"] = 832,
    ["Problem package generators"] = 480,
    Pterodactyl = 779,
    ["Pull Request Labeler"] = 495,
    Pulumi = 501,
    PyProject = 502,
    Pyright = 503,
    Qgoda = 504,
    Qodana = 752,
    ["Quali Torque Blueprint Spec 2"] = 777,
    ["QueryFirst config file"] = 800,
    ["RKE Cluster Configuration JSON"] = 731,
    ["RKE Cluster Configuration YAML"] = 730,
    ["Rancher Fleet"] = 498,
    ["Rattler-build"] = 505,
    Ray = 697,
    ["Read the Docs"] = 500,
    ["Red-DiscordBot Cog"] = 512,
    ["Red-DiscordBot Cog Repo"] = 513,
    ["Red-DiscordBot Trivia"] = 514,
    ["Render Blueprints"] = 729,
    RenderCV = 524,
    Renovate = 523,
    ["Replit config"] = 518,
    RoadRunner = 525,
    ["Rudder techniques"] = 838,
    Ruff = 520,
    ["Rust Project"] = 521,
    ["Rust toolchain"] = 528,
    ["SDMX data message"] = 553,
    ["SDMX metadata message"] = 552,
    ["SDMX structure message"] = 551,
    ["SIL Kit Participant Configuration"] = 563,
    ["SIL Kit Registry Configuration"] = 564,
    SWADL = 589,
    ["Safebox Config"] = 790,
    ["Sapphire CLI Config"] = 531,
    ["SauceCTL Configuration"] = 739,
    ["Schema Catalog"] = 545,
    ["Scoop manifest"] = 550,
    ["Semantic Data Fabric (SDF) file"] = 554,
    ["Semgrep Rule"] = 556,
    ["Serenity Code Generator (Sergen)"] = 557,
    ["Serverless Framework Configuration"] = 746,
    ["Serverless Workflow"] = 748,
    ["Settings.paf"] = 559,
    ["Shopware 6 Configuration"] = 749,
    ["Shopware CLI Extension Store Configuration"] = 750,
    ["Shopware CLI Project Store Configuration"] = 751,
    Sigma = 561,
    ["Sigrid scope configuration file"] = 562,
    ["SkyPilot Task JSON"] = 839,
    ["Slack app manifest"] = 566,
    Solidarity = 569,
    ["Solution filters"] = 570,
    ["Source Maps v3"] = 571,
    Sourcery = 572,
    SpecIF = 573,
    ["Sponge Mixin configuration"] = 574,
    StackBlitz = 579,
    ["StackHawk Scanner Configuration"] = 745,
    Stale = 580,
    ["Starlake Data Pipeline"] = 720,
    Starship = 581,
    ["Statamic Blueprint"] = 582,
    ["Stella configuration file"] = 583,
    ["StrmPrivacy Data Connector"] = 794,
    ["StrmPrivacy Data Contract"] = 795,
    ["StrmPrivacy SimpleSchema"] = 792,
    ["StrmPrivacy Stream"] = 793,
    ["StrmPrivacy batch job configuration file"] = 791,
    ["Stryker Mutator"] = 586,
    ["StyleCop Analyzers Configuration"] = 587,
    ["Stylelint (.stylelintrc)"] = 588,
    ["Sublime Syntax"] = 796,
    ["Subsquid squid manifest"] = 841,
    ["Swagger API 2.0"] = 590,
    TSON = 616,
    TSTyche = 617,
    Talhelper = 592,
    ["Talisman configuration"] = 593,
    ["Taskfile config"] = 725,
    Taurus = 594,
    ["TestEnvironment.json"] = 603,
    ["TextMate Grammar"] = 602,
    ["Tier.run pricing.json"] = 597,
    Tikibase = 598,
    ["Traefik v2"] = 606,
    ["Traefik v2 File Provider"] = 607,
    ["Travis CI (.travis.yml)"] = 605,
    TunnelHub = 831,
    Turborepo = 604,
    Tye = 753,
    ["UET BuildConfig.json"] = 801,
    ["UI5 Manifest"] = 626,
    ["UNCORS configuration"] = 630,
    ["UTAM Page Object"] = 629,
    ["Ubuntu Server Autoinstall"] = 624,
    ["Uniswap Token List"] = 708,
    ["Unreal Engine Uplugin"] = 802,
    ["Unreal Engine Uproject"] = 803,
    ["Updatecli Compose"] = 761,
    ["Updatecli Policy Manifest"] = 762,
    ["Updatecli Policy Metadata"] = 763,
    Uplift = 799,
    ["User Journey Map"] = 728,
    V2Ray = 767,
    ["VSCode Code Snippets"] = 170,
    ["VSIX CLI publishing"] = 645,
    ["Vela Pipeline Configuration"] = 634,
    Vercel = 169,
    Visivo = 829,
    ["Web App Manifest"] = 652,
    ["Web types"] = 655,
    WebExtensions = 651,
    ["Webman package recipe"] = 773,
    ["Windows Package Manager Installer Manifest"] = 705,
    ["Windows Package Manager Locale Manifest"] = 706,
    ["Windows Package Manager Singleton Manifest"] = 704,
    ["Woodpecker pipeline config"] = 741,
    ["Wrangler CLI"] = 656,
    ["Xstate Machine"] = 759,
    ["Yarn Config (.yarnrc.yml)"] = 718,
    ["Yippee-Ki-JSON configuration YML"] = 710,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 833,
    ...
    ["behat.yml"] = 92,
    ["bigquery-table"] = 84,
    ["bioimageio resource description"] = 849,
    ...
    ["gitlab-ci"] = 289,
    ["global.json"] = 291,
    ["go-feature-flag Flag Configuration"] = 294,
    ["haxelib.json"] = 309,
    helmfile = 700,
    helmwave = 701,
    ["host-meta.json"] = 314,
    ...
    ["ide.host.json"] = 320,
    ["ifstate.conf"] = 321,
    ["imageoptimizer.json"] = 322,
    ["importmap.json"] = 325,
    ["ioBroker Configuration"] = 326,
    ["ioBroker JSON UI"] = 327,
    ["ioBroker Package manifest"] = 328,
    ["ize.toml"] = 798,
    ["jsconfig.json"] = 351,
    ["jscpd Configuration"] = 778,
    jsdoc = 696,
    ["k3d.yaml"] = 352,
    ["k9s plugin.yml"] = 354,
    ["kontinuous-config.yaml"] = 360,
    ["kontinuous-values.yaml"] = 359,
    ["kustomization.yaml"] = 361,
    ["label-commenter-config.yml"] = 362,
    ["latexindent configuration"] = 65,
    ["launchsettings.json"] = 363,
    lazydocker = 820,
    lazygit = 819,
    ["lego.json"] = 365,
    ["lerna.json"] = 366,
    ["lgtm.yml"] = 367,
    ["liblab.config.json"] = 368,
    ["libman.json"] = 369,
    ["license-report-config.json"] = 370,
    ["linkinator.config.json"] = 372,
    ["lint-staged (.lintstagedrc)"] = 676,
    ["local.settings.json"] = 377,
    ["localazy.json"] = 378,
    ["lotus.yaml"] = 376,
    ["lsdlschema.json"] = 379,
    ["markdown-link-check"] = 737,
    mboats = 744,
    ["micro-settings.json"] = 813,
    ["mimetypes.json"] = 388,
    ["mirrord config"] = 677,
    mise = 678,
    ["mise-settings"] = 679,
    ...
    ["mtad.yaml"] = 681,
    ["mycode.json"] = 417,
    ["napari plugin manifest"] = 418,
    neoload = 691,
    ["nest-cli"] = 424,
    ["ninjs (News in JSON) 1.3"] = 423,
    ["ninjs (News in JSON) 2.0"] = 422,
    ["nixd configuration"] = 837,
    ["nlu.json"] = 425,
    ["nodemon.json"] = 427,
    ["noodl config"] = 743,
    ["notebook.mod.json"] = 428,
    now = 687,
    ["npm-badges"] = 431,
    ["nswag.json"] = 434,
    ntangle = 435,
    ["nuclei-template.yaml"] = 432,
    ["nuget-project.json"] = 433,
    ["ocelot.json"] = 437,
    ["omnisharp.json"] = 438,
    ["openapi.json"] = 439,
    ["openfin.json"] = 446,
    ...
    ["ops.yaml"] = 443,
    ["package.json"] = 457,
    ["package.manifest"] = 458,
    ["partial-black.json"] = 93,
    ["pathfinder.yml"] = 461,
    ["pattern.json"] = 464,
    ["petstore-v1.0"] = 788,
    pgap_yaml_input_reader = 463,
    ["pixi.toml"] = 465,
    ["plagiarize-me.yaml"] = 469,
    ["plagiarize.yaml"] = 468,
    ["portman.json"] = 470,
    ["prettierrc.json"] = 478,
    ["prisma.yml"] = 479,
    ["project-1.0.0-beta3.json"] = 482,
    ["project-1.0.0-beta4.json"] = 483,
    ["project-1.0.0-beta5.json"] = 484,
    ["project-1.0.0-beta6.json"] = 485,
    ["project-1.0.0-beta8.json"] = 486,
    ["project-1.0.0-rc1.json"] = 487,
    ["project-1.0.0-rc2.json"] = 488,
    ["project.json"] = 481,
    ["prometheus.json"] = 489,
    ["prometheus.rules.json"] = 490,
    ["prometheus.rules.test.json"] = 491,
    ["proxies.json"] = 492,
    ["publiccode.yml"] = 493,
    ["pubspec.yaml"] = 494,
    ["pyrseas-0.8.json"] = 497,
    ["quilt.mod.json"] = 814,
    ["rc3 auth"] = 506,
    ["rc3 collection"] = 507,
    ["rc3 environment"] = 508,
    ...
    ["rc3 settings"] = 511,
    ["release drafter"] = 692,
    ["release-plz.toml"] = 516,
    ["rivet.yaml"] = 836,
    rockcraft = 526,
    rustfmt = 527,
    samt = 529,
    samtrc = 530,
    ["sarif-1.0.0.json"] = 532,
    ["sarif-2.0.0.json"] = 533,
    ["sarif-2.1.0"] = 543,
    ["sarif-2.1.0-rtm.2"] = 534,
    ["sarif-2.1.0-rtm.3"] = 536,
    ["sarif-2.1.0-rtm.4"] = 538,
    ["sarif-2.1.0-rtm.5"] = 540,
    ["sarif-2.1.0-rtm.6"] = 541,
    ["sarif-external-property-file-2.1.0"] = 544,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 535,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 537,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 539,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 542,
    ["schema.org - Action"] = 546,
    ["schema.org - ContactPoint"] = 547,
    ["schema.org - Place"] = 548,
    ["schema.org - Thing"] = 549,
    ["secrethub.yml"] = 816,
    ["semantic-release"] = 555,
    ["servicehub.config.json"] = 666,
    ["servicehub.service.json"] = 665,
    ["settings.job"] = 558,
    ["sfdx-hardis configuration"] = 560,
    ["shard.yml"] = 852,
    ["size-limit configuration"] = 565,
    ["skaffold.yaml"] = 735,
    ["skyuxconfig.json"] = 567,
    snapcraft = 568,
    ["sqlc configuration"] = 576,
    ["stripe-app-local.json"] = 585,
    ["stripe-app.json"] = 584,
    swcrc = 721,
    ["task.json"] = 591,
    taskcat = 688,
    ["template.json"] = 595,
    ["templatsources.json"] = 596,
    ["theme.json"] = 599,
    ["tizen_workspace.json"] = 600,
    tldr = 601,
    tmuxinator = 674,
    ["transcend.yml"] = 608,
    ["tree-sitter grammar.json"] = 299,
    ["trime.yaml"] = 609,
    ["trunk.yaml"] = 610,
    ["ts-force-config.json"] = 614,
    ["tsconfig.json"] = 611,
    ["tsd.json"] = 612,
    ["tsdrc.json"] = 613,
    ["tslint.json"] = 615,
    ...
    ["vega-lite.json"] = 633,
    ["vega.json"] = 632,
    ["venvironment-basic.yaml"] = 636,
    ["venvironment.yaml"] = 635,
    ["version.json"] = 637,
    ["vim-addon-info"] = 639,
    ["vs-2017.3.host.json"] = 641,
    ["vs-nesting.json"] = 642,
    ["vsls.json"] = 640,
    ["vss-extension.json"] = 646,
    ["vtesttree.yaml"] = 647,
    ["vtestunit.yaml"] = 648,
    ["warp-keysets.json"] = 822,
    ["warp-themes.json"] = 823,
    ["warp-workflows.json"] = 824,
    ["webhint.io"] = 774,
    ["webjobpublishsettings.json"] = 654,
    ["webjobs-list.json"] = 653,
    ["well-known-fursona"] = 860,
    ["xs-app.json"] = 684,
    ["xunit.runner.json"] = 664,
    yamllint = 709,
    zuul = 693,
    ["Žinoma"] = 703
  },
