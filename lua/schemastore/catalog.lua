...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1079,
    [".nodehawkrc"] = 691,
    [".npmpackagejsonlintrc"] = 696,
    [".omletrc"] = 1260,
    [".phrase.yml"] = 778,
    [".phraseapp.yml"] = 779,
    [".pmbot.yml"] = 763,
    [".postcssrc"] = 772,
    [".powerpages-web-template-manifest"] = 774,
    [".pre-commit-config.yml"] = 775,
    [".pre-commit-hooks.yml"] = 776,
    [".putout.json"] = 812,
    [".rehyperc"] = 837,
    [".remarkrc"] = 841,
    [".sprite files"] = 943,
    ...
    AIConfig = 46,
    ["AMX Muse Program Descriptor"] = 1309,
    ["API Builder"] = 1115,
    ["AVA Configuration"] = 1179,
    ...
    ["AWS Copilot Manifest"] = 1348,
    ["AWS SAM CLI Samconfig"] = 311,
    Acton = 1399,
    ["Adobe UXP Manifest"] = 1242,
    ["Aerleon Network & Service Definitions"] = 28,
    ["Aerleon Policy"] = 29,
    ["Agent Permission Policy"] = 1388,
    ["AgentCore CLI"] = 1389,
    AgentLoopKit = 1390,
    Aider = 1338,
    Air = 31,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1359,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1358,
    ["Airlock Microgateway"] = 47,
    ["Alacritty Configuration"] = 1151,
    ["AlgoVoi Compliance Receipt v1"] = 17,
    ["All Contributors configuration file"] = 1205,
    ...
    ["Application list for a WinUtil"] = 1288,
    ["ArchSmith diagram IR"] = 1424,
    ArchitectFX = 1293,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1357,
    ["Azure IoT Operations connector metadata"] = 1354,
    ...
    ["Azure Pipelines"] = 134,
    ["Azure Static Web Apps CLI configuration file"] = 947,
    ["Azure Static Web Apps configuration file"] = 946,
    BMML = 1376,
    ["BOSH BPM Config"] = 160,
    ["BOSH CPI Config"] = 161,
    ...
    ["Bacon config"] = 11,
    ["Barba-CV"] = 100,
    ["Bashly (bashly.yml)"] = 1209,
    ["Bashly Settings (bashly-settings.yml)"] = 1210,
    Bento = 1375,
    ["Better Code Hub"] = 1120,
    ["Better Scripts"] = 184,
    Bigconfig = 153,
    ["Biome Formatter Config"] = 101,
    ["Bitmovin Encoding Template"] = 1302,
    BizTalkServerApplicationSchema = 1086,
    Bleep = 185,
    ["Block Protocol Metadata"] = 182,
    ["Bluebricks blueprint config"] = 1381,
    ["Boyka Framework"] = 163,
    ...
    ["Butane Config"] = 1164,
    C4InterFlow = 1317,
    ["CDK Environment Manager, concrete environment configuration"] = 1341,
    ["CDK Environment Manager, concrete environments definition"] = 1340,
    ["CDK Environment Manager, environment definition"] = 1339,
    ["CGS Card Game Specification (cgs.json)"] = 1247,
    ["CICS TS region tagging"] = 1173,
    ["CICS TS resource import"] = 1174,
    ["CICS TS resource model"] = 1175,
    ["CICS TS resource overrides"] = 1176,
    ["CMake Presets"] = 186,
    ["CNC Codes"] = 209,
    ["CRS WAF test file"] = 1277,
    ["CRS WAF test platform overrides file"] = 1278,
    ...
    ["Caido Proxy Configuration"] = 1414,
    ...
    ["Chamaleon environment"] = 1306,
    ["Chamaleon properties"] = 1307,
    ["Chamaleon template"] = 1305,
    Changepacks = 1368,
    Changesets = 320,
    Changie = 195,
    Charmcraft = 196,
    ...
    ["Claude Code Launch Preview"] = 1423,
    ["Claude Code Plugin Manifest"] = 217,
    ["Claude Code Plugin Marketplace"] = 218,
    ["Claude Code Settings"] = 219,
    ["Clawject config"] = 215,
    ["Cloud Foundry Application Manifest"] = 1259,
    ["Cloud Run Spec v1"] = 1283,
    ...
    Concord = 1276,
    ["Configu .cfgu files"] = 1264,
    ["Configu .configu file"] = 1265,
    Conjure = 208,
    ["Container Structure Test"] = 1100,
    Containerlab = 1129,
    ["Contextive Glossary"] = 1333,
    ContractGuard = 1130,
    Convex = 207,
    ...
    ["Cursor Agent Environment"] = 1386,
    ["Custom Machinery Machine"] = 1248,
    ["Custom Machinery Recipe"] = 1249,
    ...
    ["DonateCaseBetterCasino menu"] = 1310,
    ["Draugr Saga"] = 350,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1217,
    ["EAS config"] = 424,
    ["ECA - Editor Code Assistant"] = 387,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1206,
    ["ESLint Suppressions"] = 429,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1353,
    ["EasyVCR .NET"] = 426,
    ["Eidolon Resource"] = 1294,
    ...
    ["Envelope Team Definition"] = 1398,
    ["Envilder Map File"] = 392,
    ["Erda Pipeline"] = 1255,
    ["Erda Runtime"] = 1256,
    ["Espanso config.yml"] = 1379,
    ["Espanso match.yml"] = 1378,
    Esquio = 412,
    ["Estuary Flow Catalog"] = 1170,
    ["Ethereum ERC1155"] = 1392,
    ["Ethereum ERC721"] = 1391,
    ...
    ["Evolving Resolutive Process notation"] = 1355,
    ["Expo SDK"] = 423,
    ...
    ["GeoJSON.json latest"] = 1168,
    GherKing = 1172,
    ["GitHub Action"] = 467,
    ["GitHub Actions typing"] = 1290,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 1244,
    ...
    ["Google Digital Assetlinks"] = 1334,
    Goreleaser = 503,
    ["Goreleaser Pro"] = 504,
    Goss = 506,
    ["Gradle Build Cache Node"] = 1118,
    ["Gradle Enterprise"] = 1117,
    ...
    Hadolint = 1096,
    Hammerkit = 1128,
    ["Hardware Sentry Configuration"] = 1184,
    ...
    ["Hecate Input Schema"] = 1345,
    ["Helm Chart.lock"] = 268,
    ["Helm Chart.yaml"] = 267,
    ["Helm Unittest Test Suite"] = 269,
    ["Heloisa Assistant Plugins Marketplace"] = 1421,
    ["Hex file"] = 270,
    ...
    ["JFrog File Spec"] = 562,
    ["JFrog Pipelines YML DSL"] = 1194,
    ["JMeter DSL cli config"] = 563,
    JReleaser = 566,
    ["JSON Document Transform"] = 574,
    ["JSON Feed"] = 575,
    ["JSON Resume"] = 850,
    ["JSON Schema Draft 2020-12"] = 1062,
    ["JSON Schema Draft 4"] = 1059,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1227,
    ["JSON Schema Draft 7"] = 1060,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1228,
    ["JSON Schema Draft 8 (2019-09)"] = 1061,
    ["JSON-API"] = 573,
    ["JSON-e templates"] = 1125,
    ["JSON-stat 2.0"] = 1055,
    JSONPatch = 577,
    ...
    Jsontron = 578,
    ["Jujutsu (jj) VCS config"] = 1347,
    ["KIMMDY config file"] = 589,
    ["KODE/CI build.yaml"] = 1190,
    ["KSP-AVC"] = 1056,
    ["KSP-CKAN"] = 1057,
    ["KSP-NetKAN"] = 1058,
    KSY = 1257,
    ...
    ["Kong DBLess config"] = 1191,
    KrakenD = 593,
    ["Kubri Configuration"] = 601,
    LOOBin = 617,
    ["Lake configuration file"] = 1350,
    ...
    ["Lando (landofile)"] = 127,
    ["LangGraph Platform configuration"] = 1269,
    ["Language configuration"] = 1268,
    Lefthook = 606,
    ["Liferay client-extension.yaml"] = 613,
    ["LinkML Metamodel"] = 615,
    Liquibase = 1135,
    ["Liquibase Flow File"] = 1136,
    ["Lively Properties"] = 616,
    ["Lobe AI Agent"] = 129,
    Loki = 130,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 660,
    ["MS2Rescore Configuration"] = 668,
    ["MSTest testconfig.json"] = 669,
    ["Madge configuration"] = 623,
    ["Madness (madness.yml)"] = 1208,
    ["Mado configuration"] = 624,
    ["Maestro Flow"] = 625,
    ["Mail Servers Configuration"] = 1382,
    ["MapEHR Mapping"] = 626,
    Markdownlint = 1139,
    ["Mason Registry"] = 1142,
    ["MegaLinter Custom Flavor"] = 629,
    ["MegaLinter configuration"] = 628,
    ["MegaLinter descriptor"] = 630,
    Melange = 1235,
    ["Meltano project definition"] = 631,
    ["Mergify Configuration"] = 670,
    ["Mermaid config"] = 2,
    ["Metadata for a Bazel module"] = 632,
    ["Metadata for a Cinnamon spice"] = 1286,
    ["Metatype Configuration"] = 633,
    ["MetricsHub Configuration"] = 634,
    ["MetricsHub Connector Configuration"] = 635,
    ["Micro Editor Syntax"] = 1218,
    ["Microsoft Band Web Tile"] = 636,
    ["Microsoft RulesEngine workflow rules"] = 1273,
    ["Microsoft RulesEngine workflow rules list"] = 1274,
    ["Minecraft Custom Main Menu Mod"] = 1236,
    ["Minecraft Data Pack Advancement"] = 638,
    ["Minecraft Data Pack Biome"] = 639,
    ["Minecraft Data Pack Configured Carver"] = 640,
    ["Minecraft Data Pack Damage Type"] = 641,
    ["Minecraft Data Pack Dimension"] = 643,
    ["Minecraft Data Pack Dimension Type"] = 642,
    ["Minecraft Data Pack Item Modifier"] = 644,
    ["Minecraft Data Pack Loot Table"] = 645,
    ["Minecraft Data Pack Metadata"] = 646,
    ["Minecraft Data Pack Predicate"] = 647,
    ["Minecraft Data Pack Recipe"] = 648,
    ["Minecraft Data Pack Tag"] = 649,
    ["Minecraft Data Pack Template Pool"] = 650,
    ["Minecraft Data Pack Trim Material"] = 655,
    ["Minecraft Data Pack Trim Pattern"] = 656,
    ["Minecraft Resource Pack Lang"] = 651,
    ["Minecraft Resource Pack Particle"] = 652,
    ["Minecraft Resource Pack Texture Mcmeta"] = 654,
    ["Minecraft Resourcepack Sounds"] = 653,
    ["MockServer Expectation"] = 662,
    ["MockServer Expectations"] = 663,
    ModuleAssembler = 658,
    ["Monade CLI Stack Configuration"] = 673,
    ["MongoDB Atlas Search Index Definition"] = 1189,
    ["Monika Configuration"] = 1187,
    ["Monoweave Configuration"] = 667,
    ["Motif config"] = 1078,
    MultiQC = 1327,
    ["NOX Framework (Service)"] = 695,
    ["Netin Diagnostic System Template"] = 1146,
    ["Netlify config"] = 676,
    ["Network-as-Code Data Model"] = 677,
    ["Next Gen UI Agent A2A Server Configuration"] = 678,
    ["Next Gen UI Agent Configuration"] = 680,
    ["Next Gen UI Agent MCP Server Configuration"] = 679,
    ["Nightwatch.js"] = 687,
    ["Nika workflow"] = 692,
    ["Node.js configuration"] = 1083,
    ["NueJS configuration file"] = 700,
    ["Nuitka Package Config"] = 1250,
    ["Nullstone config"] = 702,
    ["ODGS Data Rules"] = 709,
    ["ODGS Ontology Graph"] = 710,
    ["ODGS Standard Metrics"] = 708,
    ["OKF Graph"] = 1422,
    ["ONe's changelog entry"] = 724,
    ["ONe's service descriptor"] = 723,
    ["ORT Server repository environment configuration"] = 735,
    ["OSCAL Assessment Plan (AP)"] = 737,
    ["OSCAL Assessment Results (AR)"] = 738,
    ["OSCAL Catalog"] = 739,
    ["OSCAL Component Definition (CDef)"] = 740,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 741,
    ["OSCAL Profile"] = 742,
    ["OSCAL System Security Plan (SSP)"] = 743,
    ["OSS Review Toolkit configuration"] = 744,
    ["OSS Review Toolkit curation"] = 745,
    ["OSS Review Toolkit package configuration"] = 746,
    ["OSS Review Toolkit project package manager definition"] = 747,
    ["OSS Review Toolkit repository configuration"] = 748,
    ["OSS Review Toolkit resolutions"] = 749,
    ["October CMS columns"] = 706,
    ["October CMS fields"] = 707,
    ["Oh My Posh"] = 712,
    Okteto = 713,
    ["Ona Tasks and Services"] = 715,
    Opctl = 1081,
    ["Open Data Contract Standard (ODCS)"] = 728,
    ["Open Data Product Standard (ODPS)"] = 729,
    ["Open Know-How"] = 1332,
    ["Open Pentest Format"] = 730,
    OpenDecree = 1396,
    ["OpenDecree Configuration"] = 1397,
    ["OpenRewrite Resource"] = 726,
    OpenSRM = 731,
    OpenStatus = 1343,
    ["OpenTelemetry Declarative Configuration"] = 727,
    ["OpenUtau character yaml"] = 720,
    ["OpenUtau ustx"] = 721,
    ["OpenWeather Current Weather API"] = 1124,
    ["OpenWeather Road Risk API"] = 1123,
    ["Ory Hydra configuration"] = 533,
    ["Ory Keto configuration"] = 597,
    ["Ory Kratos configuration"] = 736,
    ["Ory Oathkeeper configuration"] = 704,
    ["Outblocks App configuration"] = 733,
    ["Outblocks database table"] = 734,
    ["Outblocks project configuration"] = 732,
    PDM = 757,
    POPxf = 769,
    ["POPxf Correlations"] = 770,
    ["PRML manifest"] = 777,
    Packer = 753,
    PactSpec = 754,
    Panache = 755,
    Pantsbuild = 1204,
    ["Paper paper-plugin.yml"] = 756,
    ["Pipeline component"] = 1137,
    ["Platform.sh application"] = 13,
    ["Platform.sh routes"] = 14,
    ["Platform.sh services"] = 15,
    ["Plex Prerolls"] = 767,
    ["PocketMine plugin.yml"] = 764,
    ["Podman Desktop Extension"] = 1416,
    ["Postman collection"] = 773,
    ["Power Pages Configuration"] = 1344,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1289,
    ["ProActions AI-Kit Configuration"] = 785,
    ["ProActions AI-Kit Configuration for Menus"] = 787,
    ["ProActions AI-Kit Configuration for Sections"] = 789,
    ["ProActions AI-Kit Configuration for Services"] = 786,
    ["ProActions AI-Kit Configuration for Steps"] = 790,
    ["ProActions AI-Kit Configuration for Templates"] = 788,
    ["Problem object RFC9457"] = 1233,
    ["Problem package format"] = 791,
    ["Problem package generators"] = 792,
    ["Problem package submissions"] = 793,
    ["Problem package test group metadata"] = 794,
    Pterodactyl = 1183,
    ["Pull Request Labeler"] = 811,
    Pulumi = 819,
    ["PyGTA Config"] = 815,
    PyProject = 820,
    Pylock = 1335,
    Pyright = 821,
    ["Python script metadata"] = 1329,
    ["QType AI DSL"] = 824,
    Qgoda = 823,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1408,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1406,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1412,
    ["Qlik Talend Cloud Pipeline - Project"] = 1404,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1407,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1409,
    ["Qlik Talend Cloud Pipeline - Task"] = 1405,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1411,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1410,
    Qodana = 1156,
    ["Qt Creator workspace file"] = 1266,
    ["Quali Torque Blueprint Spec 2"] = 1181,
    ["QueryFirst config file"] = 1200,
    ["QuikRun Configuration"] = 1413,
    ["Qwen Code Settings"] = 1393,
    ["RKE Cluster Configuration JSON"] = 1134,
    ["RKE Cluster Configuration YAML"] = 1133,
    RadioHound = 814,
    ["Raid Profile"] = 1394,
    ["Raid Repo Configuration"] = 1395,
    Railpack = 826,
    Railway = 825,
    ["Rancher Fleet"] = 816,
    ["Rattler-build"] = 827,
    Ray = 1095,
    ["Read the Docs"] = 818,
    ["Red-DiscordBot Cog"] = 834,
    ["Red-DiscordBot Cog Repo"] = 835,
    ["Red-DiscordBot Trivia"] = 836,
    ["Releasaurus Config"] = 10,
    ReleaseKit = 9,
    ["Render Blueprints"] = 1132,
    RenderCV = 854,
    Renovate = 851,
    ["Renovate global configuration"] = 852,
    ["Renovate inherited configuration"] = 853,
    ["Replit config"] = 842,
    Restate = 1322,
    ["Revel Digital Gadget Definition File"] = 1346,
    RoadRunner = 856,
    ["Robust Station Image"] = 1352,
    Rockcraft = 857,
    ["Roo Coder Custom Modes"] = 858,
    Rubocop = 847,
    ["Rudder techniques"] = 1240,
    Ruff = 848,
    ["Rust Project"] = 849,
    ["Rust toolchain"] = 863,
    ["SDMX data message"] = 890,
    ["SDMX metadata message"] = 889,
    ["SDMX structure message"] = 888,
    ["SIL Kit Participant Configuration"] = 901,
    ["SIL Kit Registry Configuration"] = 902,
    ["SPDX 2.3"] = 944,
    SWADL = 960,
    ["Safebox Config"] = 1195,
    ["Sapphire CLI Config"] = 866,
    ["SauceCTL Configuration"] = 1143,
    Scarb = 886,
    ["Schema Catalog"] = 881,
    ["Scoop manifest"] = 887,
    ["Secure SDLC Evidence Bundle"] = 891,
    ["Semantic Data Fabric (SDF) file"] = 892,
    ["Semgrep Rule"] = 894,
    ["Serenity Code Generator (Sergen)"] = 895,
    ["Serverless Framework Configuration"] = 1150,
    ["Serverless Workflow"] = 1152,
    ["Settings for a Cinnamon spice"] = 1285,
    ["Settings.paf"] = 897,
    ["Shopware 6 Configuration"] = 1153,
    ["Shopware CLI Extension Store Configuration"] = 1154,
    ["Shopware CLI Project Store Configuration"] = 1155,
    ["Sigma Detection Rule"] = 899,
    ["SigmaCV CV"] = 5,
    ["Sigrid scope configuration file"] = 900,
    ["SkyPilot Task JSON"] = 1241,
    ["Slack app manifest"] = 907,
    ["Slang Server Configuration"] = 1420,
    Snapcraft = 909,
    ["Solarxy project config"] = 912,
    Solidarity = 913,
    ["Solution filters"] = 914,
    ["Source Maps v3"] = 915,
    Sourcery = 916,
    ["Spack bootstrap.yaml"] = 917,
    ["Spack cdash.yaml"] = 918,
    ["Spack ci.yaml"] = 919,
    ["Spack compilers.yaml"] = 920,
    ["Spack concretizer.yaml"] = 921,
    ["Spack config.yaml"] = 922,
    ["Spack definitions.yaml"] = 923,
    ["Spack develop.yaml"] = 924,
    ["Spack env_vars.yaml"] = 925,
    ["Spack environment"] = 931,
    ["Spack include.yaml"] = 926,
    ["Spack mirrors.yaml"] = 927,
    ["Spack modules.yaml"] = 928,
    ["Spack packages.yaml"] = 929,
    ["Spack repos.yaml"] = 930,
    ["Spack toolchains.yaml"] = 932,
    ["Spack upstreams.yaml"] = 933,
    ["Spack view.yaml"] = 934,
    ["Speakeasy Generation Config File"] = 938,
    ["Speakeasy Lint Configuration File"] = 935,
    ["Speakeasy Test Generation Configuration File"] = 936,
    ["Speakeasy Workflow File"] = 937,
    SpecIF = 939,
    ["Specmatic Configuration"] = 940,
    ["Specpin spec file"] = 3,
    ["Sponge Mixin configuration"] = 941,
    ["Spotlight Ruleset"] = 942,
    StackBlitz = 948,
    ["StackHawk Scanner Configuration"] = 1149,
    Stale = 949,
    Starfish = 950,
    ["Starlake Data Pipeline"] = 1121,
    Starship = 951,
    ["Statamic Blueprint"] = 952,
    ["Stella configuration file"] = 953,
    ["Streamlit configuration file"] = 954,
    ["Stryker Mutator"] = 957,
    ["StyleCop Analyzers Configuration"] = 958,
    ["Stylelint (.stylelintrc)"] = 959,
    ["Stylua Config"] = 1336,
    ["Sublime Syntax"] = 1196,
    ["Subsquid squid manifest"] = 1243,
    ["Swagger API 2.0"] = 961,
    ["Symfony Routing Configuration"] = 962,
    ["Symfony Serializer Mapping"] = 963,
    ["Symfony Services Configuration"] = 964,
    ["Symfony Validation Mapping"] = 965,
    ["Synadia Connect Component"] = 966,
    TSON = 1004,
    TSTyche = 1005,
    ["TYPO3 Vendor Bundler config"] = 1011,
    ["Tab data for a LinUtil"] = 1292,
    ["Tab list for a LinUtil"] = 1291,
    Tach = 967,
    ["Tach Domain"] = 968,
    Talhelper = 970,
    ["Talisman configuration"] = 971,
    Taplo = 1337,
    ["Taskfile config"] = 1126,
    Taurus = 972,
    Tauticord = 973,
    ["Tekton Pipeline"] = 1365,
    ["Tekton PipelineRun"] = 1366,
    ["Tekton Task"] = 1363,
    ["Tekton TaskRun"] = 1364,
    Telefonistka = 1323,
    ["Terrateam config"] = 1349,
    ["TestEnvironment.json"] = 985,
    ["TextMate Grammar"] = 984,
    Threagile = 979,
    ["Tier.run pricing.json"] = 976,
    Tikibase = 977,
    Tombi = 982,
    ["Traefik v2"] = 988,
    ["Traefik v2 File Provider"] = 989,
    ["Traefik v3"] = 990,
    ["Traefik v3 File Provider"] = 991,
    ["Travis CI (.travis.yml)"] = 987,
    Treefmt = 509,
    Trident = 1319,
    Trivy = 994,
    ["TrueScript for *.tscript files"] = 995,
    ["Tugboat QA config.yml"] = 1316,
    TunnelHub = 1231,
    Turborepo = 986,
    Tycho = 1280,
    Tye = 1157,
    ["Tyk Gateway - Open Source v5.7+"] = 1328,
    ["UET BuildConfig.json"] = 1201,
    ["UI5 Manifest"] = 1017,
    ["UNCORS configuration"] = 1022,
    ["UTAM Page Object"] = 1020,
    ["Ubuntu Server Autoinstall"] = 1015,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1320,
    ["Uniswap Token List"] = 1106,
    ["Universal Schedule Format"] = 1023,
    ["Unreal Engine Uplugin"] = 1202,
    ["Unreal Engine Uproject"] = 1203,
    ["UpCloud CLI (upctl) configuration"] = 1321,
    ["Updatecli Compose"] = 1165,
    ["Updatecli Policy Manifest"] = 1166,
    ["Updatecli Policy Metadata"] = 1167,
    Uplift = 1199,
    ["Upsun config"] = 12,
    ["User Journey Map"] = 1131,
    V2Ray = 1171,
    ["VSCode Code Snippets"] = 295,
    ["VSIX CLI publishing"] = 1042,
    Vector = 1025,
    ["Vela Pipeline Configuration"] = 1028,
    Vercel = 294,
    ["Version Bumper config"] = 1031,
    Vespertide = 1370,
    ["Vespertide Migration"] = 1371,
    ["Vespertide Model"] = 1372,
    ["Viash Component Config"] = 1325,
    ["Viash Package Config"] = 1326,
    Visivo = 1229,
    Vogi = 1036,
    ["WP-CLI"] = 1052,
    Wake = 1318,
    ["Waku Config"] = 1295,
    ["Web App Manifest"] = 1048,
    ["Web types"] = 1051,
    WebExtensions = 1047,
    ["Webman package recipe"] = 1177,
    ["Windows Package Manager Installer Manifest"] = 1103,
    ["Windows Package Manager Locale Manifest"] = 1104,
    ["Windows Package Manager Singleton Manifest"] = 1102,
    ["WireMock CLI import configuration"] = 1301,
    ["WireMock CLI local service configuration"] = 1300,
    ["WireMock message stub mapping"] = 1299,
    ["WireMock stub mapping"] = 1298,
    ["Woodpecker pipeline config"] = 1145,
    ["Wrangler CLI"] = 1053,
    ["XenForo add-on manifest"] = 1054,
    ["Xstate Machine"] = 1163,
    ["Yandex Workflow Language"] = 1287,
    ["Yarn Config (.yarnrc.yml)"] = 1119,
    ["Yippee-Ki-JSON configuration YML"] = 1110,
    ["YouTrack App"] = 1284,
    ["Zarf Package Configuration"] = 1351,
    ["Zerops import file"] = 1272,
    ["Zola Configuration"] = 1362,
    abtop = 33,
    act3 = 1400,
    actionlint = 43,
    ["aerleon.yml"] = 27,
    ["amplify.yml"] = 20,
    ["amxx-builder manifest"] = 1415,
    ["angular.json"] = 48,
    apko = 1234,
    ...
    ["behat.yml"] = 164,
    ["bigquery-table"] = 152,
    ["bioimageio resource description"] = 1251,
    ...
    ["cargo-nextest repository configuration"] = 681,
    ["cargo-nextest user configuration"] = 682,
    ["ccmod.json"] = 1296,
    changelogging = 1263,
    ...
    ["chutzpah.json"] = 303,
    cibuildwheel = 202,
    ["clang-format (.clang-format)"] = 1169,
    ["clang-tidy"] = 276,
    clangd = 275,
    clib = 277,
    ...
    ["crowdin.yml"] = 330,
    crucible = 334,
    ["ctfd-setup configuration file"] = 1308,
    ["custom-elements.json"] = 1221,
    ["cypress.json"] = 335,
    ["dacier.yml"] = 1403,
    ...
    ["gematik health care insurance list"] = 1314,
    ["gematik health care patient list"] = 1311,
    ["gematik health care provider institution list"] = 1313,
    ["gematik health care provider list"] = 1312,
    ["gematik tiger test environment configuration"] = 1315,
    ["gh-dash"] = 465,
    ["gha-doctor"] = 466,
    ["git-cliff"] = 462,
    ["git-town.toml"] = 1360,
    ["github-settings-as-code"] = 843,
    ["gitlab-ci"] = 480,
    ["global.json"] = 497,
    ["glslint config"] = 1,
    ...
    ["lint-staged (.lintstagedrc)"] = 1071,
    ["local.settings.json"] = 619,
    ["localazy.json"] = 620,
    ["lotus.yaml"] = 618,
    ["lsd colors"] = 132,
    ["lsd config"] = 131,
    ...
    lychee = 1070,
    ["macro.json"] = 1186,
    ["markdown-link-check"] = 1140,
    maturin = 1141,
    mboats = 1148,
    memnex = 1401,
    ["micro-settings.json"] = 1213,
    ["mimetypes.json"] = 637,
    ["mirrord config"] = 1074,
    ["misata.yaml"] = 1073,
    mise = 1075,
    ["mkdocs.yml"] = 657,
    ["mockd.yaml"] = 661,
    ["mod.pw.toml (packwiz)"] = 1418,
    ["modelparams.dev Model"] = 664,
    ["models CLI"] = 665,
    ["monospace.yml"] = 666,
    ["moon.yml"] = 1297,
    ["mprocs Configuration file"] = 1267,
    ["mrdocs.yml"] = 659,
    ["mta.yaml"] = 1076,
    ["mtad.yaml"] = 1077,
    ["mycode.json"] = 674,
    nFPM = 686,
    ["napari plugin manifest"] = 675,
    neoload = 1089,
    ["nest-cli"] = 689,
    ["nexus-rpc-gen"] = 1387,
    ["nf-core module environment.yml"] = 683,
    ["nf-core module meta.yml"] = 684,
    ["nf-core subworkflow meta.yml"] = 685,
    ["ninjs (News in JSON)"] = 688,
    ["nitro.json"] = 1088,
    ["nixd configuration"] = 1239,
    ["nlu.json"] = 690,
    ["nodemon.json"] = 693,
    ["noodl config"] = 1147,
    ["notebook.mod.json"] = 694,
    now = 1084,
    ["npm-badges"] = 697,
    ["nswag.json"] = 701,
    ntangle = 703,
    ["nuclei-template.yaml"] = 698,
    ["nuget-project.json"] = 699,
    ["ocelot.json"] = 705,
    ogen = 711,
    ["omnisharp.json"] = 714,
    openHAB = 1373,
    ...
    oxfmt = 1383,
    oxlint = 1384,
    ["pack.toml (packwiz)"] = 1419,
    ["package.json"] = 750,
    ["package.manifest"] = 752,
    ["package.yaml"] = 751,
    ["partial-black.json"] = 165,
    ["partial-fastapi.json"] = 166,
    ["partial-pixi.json"] = 762,
    ["partial-scheduled.json"] = 167,
    ["pattern.json"] = 760,
    ["petstore-v1.0"] = 1193,
    pgap_yaml_input_reader = 758,
    pgrls = 759,
    pgxgen = 1377,
    pitcms = 1380,
    ["pixi.toml"] = 761,
    ["plagiarize-me.yaml"] = 766,
    ["plagiarize.yaml"] = 765,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1304,
    ["podbard.yaml"] = 768,
    ["portman.json"] = 771,
    ["prefect.toml"] = 780,
    ["prefect.yaml"] = 781,
    ...
    ["prettierrc.json"] = 783,
    ["prisma.yml"] = 784,
    ["project-1.0.0-beta3.json"] = 796,
    ["project-1.0.0-beta4.json"] = 797,
    ["project-1.0.0-beta5.json"] = 798,
    ["project-1.0.0-beta6.json"] = 799,
    ["project-1.0.0-beta8.json"] = 800,
    ["project-1.0.0-rc1.json"] = 801,
    ["project-1.0.0-rc2.json"] = 802,
    ["project.json"] = 795,
    ["project.owasp.yaml"] = 803,
    ["prometheus-alertmanager.json"] = 807,
    ["prometheus.json"] = 804,
    ["prometheus.rules.json"] = 805,
    ["prometheus.rules.test.json"] = 806,
    ["proxies.json"] = 808,
    ["publiccode.yml"] = 809,
    ["pubspec.yaml"] = 810,
    ["pyrseas-0.8.json"] = 813,
    pytest = 822,
    ["quilt.mod.json"] = 1214,
    ["rc3 auth"] = 828,
    ["rc3 collection"] = 829,
    ...
    ["rc3 settings"] = 833,
    ["registry.yaml"] = 61,
    ["release drafter"] = 1090,
    ["release-hub.json"] = 8,
    ["release-please-config.json"] = 838,
    ["release-please-manifest.json"] = 839,
    ["release-plz.toml"] = 840,
    ["renv.lock"] = 855,
    ["reposets Configuration"] = 844,
    ["reposets Credentials"] = 845,
    ["revola.json"] = 6,
    ["rivet.json"] = 1238,
    ["rivet.yaml (legacy)"] = 1237,
    rumdl = 860,
    runny = 859,
    runspec = 1402,
    rustfmt = 861,
    ...
    samt = 864,
    samtrc = 865,
    ["sarif-1.0.0.json"] = 867,
    ["sarif-2.0.0.json"] = 868,
    ["sarif-2.1.0"] = 878,
    ["sarif-2.1.0-rtm.2"] = 869,
    ["sarif-2.1.0-rtm.3"] = 871,
    ["sarif-2.1.0-rtm.4"] = 873,
    ["sarif-2.1.0-rtm.5"] = 875,
    ["sarif-2.1.0-rtm.6"] = 876,
    ["sarif-external-property-file-2.1.0"] = 879,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 870,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 872,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 874,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 877,
    ["scalingo.json configuration"] = 880,
    ["schema.org - Action"] = 882,
    ["schema.org - ContactPoint"] = 883,
    ["schema.org - Place"] = 884,
    ["schema.org - Thing"] = 885,
    ["secrethub.yml"] = 1216,
    ["semantic-release"] = 893,
    ["servicehub.config.json"] = 1065,
    ["servicehub.service.json"] = 1064,
    ["settings.job"] = 896,
    ["sfdx-hardis configuration"] = 898,
    ["shard.yml"] = 1254,
    ["size-limit configuration"] = 903,
    ["skaffold.yaml"] = 1138,
    ["skill-map plugin extension manifest"] = 904,
    ["skill-map project settings"] = 905,
    ["skill-map provider kind"] = 906,
    ["skyuxconfig.json"] = 908,
    ["snowflake-config"] = 910,
    ["snowflake-connections"] = 911,
    ["spicepod.yaml"] = 1275,
    ["sqlc configuration"] = 945,
    ["stripe-app-local.json"] = 956,
    ["stripe-app.json"] = 955,
    swcrc = 1122,
    ["task.json"] = 969,
    taskcat = 1085,
    ["template.json"] = 974,
    ["templatsources.json"] = 975,
    ["text2confl config"] = 1385,
    ["theme.json"] = 978,
    ["tizen_workspace.json"] = 980,
    tldr = 981,
    ["tm_devices configuration file"] = 1342,
    tmuxinator = 1068,
    tox = 983,
    ["transcend.yml"] = 992,
    ...
    ["vega-lite.json"] = 1027,
    ["vega.json"] = 1026,
    ["venvironment.yaml"] = 1029,
    ["venvplus.yaml"] = 1030,
    version = 1324,
    ["version.json"] = 1032,
    ["vhwdebugger-binding.yaml"] = 1034,
    ["vim-addon-info"] = 1035,
    ["vs-2017.3.host.json"] = 1038,
    ["vs-nesting.json"] = 1039,
    ["vsls.json"] = 1037,
    ["vss-extension.json"] = 1043,
    vtcfg = 1330,
    ["vtesttree.yaml"] = 1044,
    ["vtestunit.yaml"] = 1045,
    ["warp-keysets.json"] = 1222,
    ["warp-themes.json"] = 1223,
    ["warp-workflows.json"] = 1224,
    ["webhint.io"] = 1178,
    ["webjobpublishsettings.json"] = 1050,
    ["webjobs-list.json"] = 1049,
    ["well-known-fursona"] = 1262,
    ["xs-app.json"] = 1080,
    ["xunit.runner.json"] = 1063,
    ["yaml-workflow"] = 1425,
    yamlfmt = 1107,
    yamllint = 1108,
    ["yap.json"] = 1109,
