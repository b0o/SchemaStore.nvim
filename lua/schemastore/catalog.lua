...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 770,
    [".nodehawkrc"] = 488,
    [".npmpackagejsonlintrc"] = 492,
    [".omletrc"] = 940,
    [".phrase.yml"] = 553,
    [".phraseapp.yml"] = 554,
    [".pmbot.yml"] = 541,
    [".postcssrc"] = 548,
    [".powerpages-web-template-manifest"] = 550,
    [".pre-commit-config.yml"] = 551,
    [".pre-commit-hooks.yml"] = 552,
    [".putout.json"] = 574,
    [".rehyperc"] = 595,
    [".remarkrc"] = 597,
    [".sprite files"] = 660,
    ...
    ABCSupplyPlan = 14,
    AIConfig = 15,
    ["AMX Muse Program Descriptor"] = 983,
    ["API Builder"] = 803,
    ["AVA Configuration"] = 863,
    ...
    ["Adobe UXP Manifest"] = 923,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Alacritty Configuration"] = 835,
    ["All Contributors configuration file"] = 888,
    ...
    ["Application list for a WinUtil"] = 966,
    ArchitectFX = 970,
    ["Argo Events"] = 29,
    ["Argo Workflows"] = 30,
    AssemblyScript = 33,
    ...
    ["Azure Pipelines"] = 66,
    ["Azure Static Web Apps CLI configuration file"] = 663,
    ["Azure Static Web Apps configuration file"] = 662,
    ["BOSH Deploy Config"] = 90,
    ["BX CI"] = 108,
    ["Bashly (bashly.yml)"] = 892,
    ["Bashly Settings (bashly-settings.yml)"] = 893,
    ["Better Code Hub"] = 807,
    ["Better Scripts"] = 109,
    Bigconfig = 83,
    ["Biome Formatter Config"] = 53,
    ["Bitmovin Encoding Template"] = 976,
    BizTalkServerApplicationSchema = 776,
    Bleep = 110,
    ...
    ["Butane Config"] = 848,
    ["CGS Custom Card Game (CardGameDef.json)"] = 928,
    ["CICS TS region tagging"] = 857,
    ["CICS TS resource import"] = 858,
    ["CICS TS resource model"] = 859,
    ["CICS TS resource overrides"] = 860,
    ["CMake Presets"] = 111,
    ["CNC Codes"] = 126,
    ["CRS WAF test file"] = 956,
    ["CRS WAF test platform overrides file"] = 957,
    ...
    ["Chamaleon environment"] = 980,
    ["Chamaleon properties"] = 981,
    ["Chamaleon template"] = 979,
    Changesets = 208,
    Cheatsheets = 845,
    ...
    CityJSON = 122,
    ["Clawject config"] = 131,
    ["Cloud Foundry Application Manifest"] = 939,
    ["Cloud Run Spec v1"] = 961,
    ...
    Concord = 955,
    ["Configu .cfgu files"] = 944,
    ["Configu .configu file"] = 945,
    Conjure = 125,
    ["Container Structure Test"] = 790,
    Containerlab = 815,
    ["Crowdsec collection config"] = 217,
    ["Crowdsec parser config"] = 218,
    ["Crowdsec scenario config"] = 219,
    ["CumulusCI Config"] = 130,
    ["Custom Machinery Machine"] = 929,
    ["Custom Machinery Recipe"] = 930,
    ...
    ["DonateCaseBetterCasino menu"] = 984,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 900,
    ["EAS config"] = 283,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 889,
    ["EasyVCR .NET"] = 284,
    ["Eidolon Resource"] = 971,
    ...
    ["Goreleaser Pro"] = 341,
    Goss = 342,
    ["Gradle Build Cache Node"] = 805,
    ["Gradle Enterprise"] = 804,
    ...
    Hadolint = 786,
    Hammerkit = 814,
    ["Hardware Sentry Configuration"] = 868,
    Hatch = 787,
    Hayson = 355,
    ...
    ["JFrog File Spec"] = 384,
    ["JFrog Pipelines YML DSL"] = 877,
    ["JMeter DSL cli config"] = 385,
    JReleaser = 387,
    ["JSON Document Transform"] = 395,
    ["JSON Feed"] = 396,
    ["JSON Resume"] = 602,
    ["JSON Schema Draft 2020-12"] = 756,
    ["JSON Schema Draft 4"] = 753,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 910,
    ["JSON Schema Draft 7"] = 754,
    ["JSON Schema Draft 7 (unofficial strict)"] = 911,
    ["JSON Schema Draft 8 (2019-09)"] = 755,
    ["JSON-API"] = 394,
    ["JSON-e templates"] = 812,
    ["JSON-stat 2.0"] = 749,
    JSONPatch = 398,
    ...
    ["Language configuration"] = 948,
    Lefthook = 423,
    ["Liferay client-extension.yaml"] = 430,
    ["LinkML Metamodel"] = 432,
    Liquibase = 820,
    ["Liquibase Flow File"] = 821,
    ["Lively Properties"] = 433,
    ["Lobe AI Agent"] = 64,
    Loki = 65,
    ["MLOS Configs"] = 472,
    ["MS2Rescore Configuration"] = 475,
    ["Madness (madness.yml)"] = 891,
    ["MapEHR Mapping"] = 440,
    Markdownlint = 824,
    ["Mason Registry"] = 826,
    ...
    ["Mergify Configuration"] = 476,
    ["Metadata for a Bazel module"] = 445,
    ["Metadata for a Cinnamon spice"] = 964,
    ["Metatype Configuration"] = 446,
    ["MetricsHub Configuration"] = 447,
    ["MetricsHub Connector Configuration"] = 448,
    ["Micro Editor Syntax"] = 901,
    ["Microsoft Band Web Tile"] = 449,
    ["Microsoft RulesEngine workflow rules"] = 952,
    ["Microsoft RulesEngine workflow rules list"] = 953,
    ["Minecraft Custom Main Menu Mod"] = 918,
    ["Minecraft Data Pack Advancement"] = 451,
    ["Minecraft Data Pack Biome"] = 452,
    ["Minecraft Data Pack Configured Carver"] = 453,
    ["Minecraft Data Pack Damage Type"] = 454,
    ["Minecraft Data Pack Dimension"] = 456,
    ["Minecraft Data Pack Dimension Type"] = 455,
    ["Minecraft Data Pack Item Modifier"] = 457,
    ["Minecraft Data Pack Loot Table"] = 458,
    ["Minecraft Data Pack Metadata"] = 459,
    ["Minecraft Data Pack Predicate"] = 460,
    ["Minecraft Data Pack Recipe"] = 461,
    ["Minecraft Data Pack Tag"] = 462,
    ["Minecraft Data Pack Template Pool"] = 463,
    ["Minecraft Data Pack Trim Material"] = 468,
    ["Minecraft Data Pack Trim Pattern"] = 469,
    ["Minecraft Resource Pack Lang"] = 464,
    ["Minecraft Resource Pack Particle"] = 465,
    ["Minecraft Resource Pack Texture Mcmeta"] = 467,
    ["Minecraft Resourcepack Sounds"] = 466,
    ["Monade CLI Stack Configuration"] = 479,
    ["MongoDB Atlas Search Index Definition"] = 872,
    ["Monika Configuration"] = 870,
    ["Monoweave Configuration"] = 474,
    ["Motif config"] = 769,
    ["NOX Framework (Service)"] = 491,
    ["Netin Diagnostic System Template"] = 830,
    ["Netlify config"] = 482,
    ["Network-as-Code Data Model"] = 483,
    ["Nightwatch.js"] = 484,
    ["NueJS configuration file"] = 496,
    ["Nuitka.yaml"] = 931,
    ["Nullstone config"] = 498,
    ["ONe's changelog entry"] = 512,
    ["ONe's service descriptor"] = 511,
    ["OSCAL Assessment Plan (AP)"] = 520,
    ["OSCAL Assessment Results (AR)"] = 521,
    ["OSCAL Catalog"] = 522,
    ["OSCAL Component Definition (CDef)"] = 523,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 524,
    ["OSCAL Profile"] = 525,
    ["OSCAL System Security Plan (SSP)"] = 526,
    ["OSS Review Toolkit configuration"] = 527,
    ["OSS Review Toolkit curation"] = 528,
    ["OSS Review Toolkit package configuration"] = 529,
    ["OSS Review Toolkit repository configuration"] = 530,
    ["OSS Review Toolkit resolutions"] = 531,
    ["October CMS columns"] = 502,
    ["October CMS fields"] = 503,
    Okteto = 504,
    Opctl = 772,
    ["Open Data Contract Standard (ODCS)"] = 515,
    ["OpenRewrite Resource"] = 514,
    ["OpenUtau character yaml"] = 508,
    ["OpenUtau ustx"] = 509,
    ["OpenWeather Current Weather API"] = 811,
    ["OpenWeather Road Risk API"] = 810,
    ["Ory Hydra configuration"] = 362,
    ["Ory Keto configuration"] = 416,
    ["Ory Kratos configuration"] = 519,
    ["Ory Oathkeeper configuration"] = 500,
    ["Outblocks App configuration"] = 517,
    ["Outblocks database table"] = 518,
    ["Outblocks project configuration"] = 516,
    PDM = 537,
    Packer = 534,
    Pantsbuild = 887,
    ["Paper paper-plugin.yml"] = 535,
    ["Pipeline component"] = 822,
    ["Plex Prerolls"] = 545,
    ["PocketMine plugin.yml"] = 542,
    ["Postman collection"] = 549,
    ["Preset list for a WinUtil"] = 967,
    ["Problem object RFC9457"] = 915,
    ["Problem package generators"] = 558,
    Pterodactyl = 867,
    ["Pull Request Labeler"] = 573,
    Pulumi = 581,
    ["PyGTA Config"] = 577,
    PyProject = 582,
    Pyright = 583,
    Qgoda = 584,
    Qodana = 840,
    ["Qt Creator workspace file"] = 946,
    ["Quali Torque Blueprint Spec 2"] = 865,
    ["QueryFirst config file"] = 883,
    ["RKE Cluster Configuration JSON"] = 819,
    ["RKE Cluster Configuration YAML"] = 818,
    RadioHound = 576,
    ["Rancher Fleet"] = 578,
    ["Rattler-build"] = 585,
    Ray = 785,
    ["Read the Docs"] = 580,
    ["Red-DiscordBot Cog"] = 592,
    ["Red-DiscordBot Cog Repo"] = 593,
    ["Red-DiscordBot Trivia"] = 594,
    ["Render Blueprints"] = 817,
    RenderCV = 604,
    Renovate = 603,
    ["Replit config"] = 598,
    RoadRunner = 606,
    ["Rudder techniques"] = 921,
    Ruff = 600,
    ["Rust Project"] = 601,
    ["Rust toolchain"] = 610,
    ["SDMX data message"] = 635,
    ["SDMX metadata message"] = 634,
    ["SDMX structure message"] = 633,
    ["SIL Kit Participant Configuration"] = 645,
    ["SIL Kit Registry Configuration"] = 646,
    SWADL = 674,
    ["Safebox Config"] = 878,
    ["Sapphire CLI Config"] = 613,
    ["SauceCTL Configuration"] = 827,
    ["Schema Catalog"] = 627,
    ["Scoop manifest"] = 632,
    ["Semantic Data Fabric (SDF) file"] = 636,
    ["Semgrep Rule"] = 638,
    ["Serenity Code Generator (Sergen)"] = 639,
    ["Serverless Framework Configuration"] = 834,
    ["Serverless Workflow"] = 836,
    ["Settings for a Cinnamon spice"] = 963,
    ["Settings.paf"] = 641,
    ["Shopware 6 Configuration"] = 837,
    ["Shopware CLI Extension Store Configuration"] = 838,
    ["Shopware CLI Project Store Configuration"] = 839,
    ["Sigma Detection Rule"] = 643,
    ["Sigrid scope configuration file"] = 644,
    ["SkyPilot Task JSON"] = 922,
    ["Slack app manifest"] = 648,
    Solidarity = 651,
    ["Solution filters"] = 652,
    ["Source Maps v3"] = 653,
    Sourcery = 654,
    ["Speakeasy Lint Configuration File"] = 655,
    ["Speakeasy Test Generation Configuration File"] = 656,
    ["Speakeasy Workflow File"] = 657,
    SpecIF = 658,
    ["Sponge Mixin configuration"] = 659,
    StackBlitz = 664,
    ["StackHawk Scanner Configuration"] = 833,
    Stale = 665,
    ["Starlake Data Pipeline"] = 808,
    Starship = 666,
    ["Statamic Blueprint"] = 667,
    ["Stella configuration file"] = 668,
    ["Stryker Mutator"] = 671,
    ["StyleCop Analyzers Configuration"] = 672,
    ["Stylelint (.stylelintrc)"] = 673,
    ["Sublime Syntax"] = 879,
    ["Subsquid squid manifest"] = 924,
    ["Swagger API 2.0"] = 675,
    ["Synadia Connect Component"] = 676,
    TSON = 707,
    TSTyche = 708,
    ["Tab data for a LinUtil"] = 969,
    ["Tab list for a LinUtil"] = 968,
    Talhelper = 678,
    ["Talisman configuration"] = 679,
    ["Taskfile config"] = 813,
    Taurus = 680,
    Tauticord = 681,
    ["TestEnvironment.json"] = 690,
    ["TextMate Grammar"] = 689,
    ["Tier.run pricing.json"] = 684,
    Tikibase = 685,
    ["Traefik v2"] = 693,
    ["Traefik v2 File Provider"] = 694,
    ["Traefik v3"] = 695,
    ["Traefik v3 File Provider"] = 696,
    ["Travis CI (.travis.yml)"] = 692,
    ["TrueScript for *.tscript files"] = 699,
    TunnelHub = 914,
    Turborepo = 691,
    Tycho = 959,
    Tye = 841,
    ["UET BuildConfig.json"] = 884,
    ["UI5 Manifest"] = 717,
    ["UNCORS configuration"] = 721,
    ["UTAM Page Object"] = 720,
    ["Ubuntu Server Autoinstall"] = 715,
    ["Uniswap Token List"] = 796,
    ["Unreal Engine Uplugin"] = 885,
    ["Unreal Engine Uproject"] = 886,
    ["Updatecli Compose"] = 849,
    ["Updatecli Policy Manifest"] = 850,
    ["Updatecli Policy Metadata"] = 851,
    Uplift = 882,
    ["User Journey Map"] = 816,
    V2Ray = 855,
    ["VSCode Code Snippets"] = 183,
    ["VSIX CLI publishing"] = 738,
    ["Vela Pipeline Configuration"] = 725,
    Vercel = 182,
    ["Version Bumper config"] = 728,
    Visivo = 912,
    ["Waku Config"] = 972,
    ["Web App Manifest"] = 744,
    ["Web types"] = 747,
    WebExtensions = 743,
    ["Webman package recipe"] = 861,
    ["Windows Package Manager Installer Manifest"] = 793,
    ["Windows Package Manager Locale Manifest"] = 794,
    ["Windows Package Manager Singleton Manifest"] = 792,
    ["WireMock stub mapping"] = 975,
    ["Woodpecker pipeline config"] = 829,
    ["Wrangler CLI"] = 748,
    ["Xstate Machine"] = 847,
    ["Yandex Workflow Language"] = 965,
    ["Yarn Config (.yarnrc.yml)"] = 806,
    ["Yippee-Ki-JSON configuration YML"] = 798,
    ["YouTrack App"] = 962,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 916,
    ...
    ["behat.yml"] = 92,
    ["bigquery-table"] = 82,
    ["bioimageio resource description"] = 932,
    ...
    ["crowdin.yml"] = 216,
    ["ctfd-setup configuration file"] = 982,
    ["custom-elements.json"] = 904,
    ["cypress.json"] = 220,
    ...
    ["gematik health care insurance list"] = 988,
    ["gematik health care patient list"] = 985,
    ["gematik health care provider institution list"] = 987,
    ["gematik health care provider list"] = 986,
    ["gitlab-ci"] = 321,
    ["global.json"] = 336,
    ...
    ["lint-staged (.lintstagedrc)"] = 764,
    ["local.settings.json"] = 436,
    ["localazy.json"] = 437,
    ["lotus.yaml"] = 435,
    ["lsdlschema.json"] = 438,
    ["markdown-link-check"] = 825,
    mboats = 832,
    ["micro-settings.json"] = 896,
    ["mimetypes.json"] = 450,
    ["mirrord config"] = 765,
    mise = 766,
    ["mkdocs.yml"] = 470,
    ["monospace.yml"] = 473,
    ["moon.yml"] = 974,
    ["mprocs Configuration file"] = 947,
    ["mrdocs.yml"] = 471,
    ["mta.yaml"] = 767,
    ["mtad.yaml"] = 768,
    ["mycode.json"] = 480,
    ["napari plugin manifest"] = 481,
    neoload = 779,
    ["nest-cli"] = 486,
    ["ninjs (News in JSON)"] = 485,
    ["nitro.json"] = 778,
    ["nixd configuration"] = 920,
    ["nlu.json"] = 487,
    ["nodemon.json"] = 489,
    ["noodl config"] = 831,
    ["notebook.mod.json"] = 490,
    now = 774,
    ["npm-badges"] = 493,
    ["nswag.json"] = 497,
    ntangle = 499,
    ["nuclei-template.yaml"] = 494,
    ["nuget-project.json"] = 495,
    ["ocelot.json"] = 501,
    ["omnisharp.json"] = 505,
    ["openapi.json"] = 506,
    ["openfin.json"] = 513,
    ...
    ["ops.yaml"] = 510,
    ["package.json"] = 532,
    ["package.manifest"] = 533,
    ["partial-black.json"] = 93,
    ["pathfinder.yml"] = 536,
    ["pattern.json"] = 539,
    ["petstore-v1.0"] = 876,
    pgap_yaml_input_reader = 538,
    ["pixi.toml"] = 540,
    ["plagiarize-me.yaml"] = 544,
    ["plagiarize.yaml"] = 543,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 978,
    ["podbard.yaml"] = 546,
    ["portman.json"] = 547,
    ["prefect.toml"] = 555,
    ["prettierrc.json"] = 556,
    ["prisma.yml"] = 557,
    ["project-1.0.0-beta3.json"] = 560,
    ["project-1.0.0-beta4.json"] = 561,
    ["project-1.0.0-beta5.json"] = 562,
    ["project-1.0.0-beta6.json"] = 563,
    ["project-1.0.0-beta8.json"] = 564,
    ["project-1.0.0-rc1.json"] = 565,
    ["project-1.0.0-rc2.json"] = 566,
    ["project.json"] = 559,
    ["prometheus.json"] = 567,
    ["prometheus.rules.json"] = 568,
    ["prometheus.rules.test.json"] = 569,
    ["proxies.json"] = 570,
    ["publiccode.yml"] = 571,
    ["pubspec.yaml"] = 572,
    ["pyrseas-0.8.json"] = 575,
    ["quilt.mod.json"] = 897,
    ["rc3 auth"] = 586,
    ["rc3 collection"] = 587,
    ["rc3 environment"] = 588,
    ...
    samt = 611,
    samtrc = 612,
    ["sarif-1.0.0.json"] = 614,
    ["sarif-2.0.0.json"] = 615,
    ["sarif-2.1.0"] = 625,
    ["sarif-2.1.0-rtm.2"] = 616,
    ["sarif-2.1.0-rtm.3"] = 618,
    ["sarif-2.1.0-rtm.4"] = 620,
    ["sarif-2.1.0-rtm.5"] = 622,
    ["sarif-2.1.0-rtm.6"] = 623,
    ["sarif-external-property-file-2.1.0"] = 626,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 617,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 619,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 621,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 624,
    ["schema.org - Action"] = 628,
    ["schema.org - ContactPoint"] = 629,
    ["schema.org - Place"] = 630,
    ["schema.org - Thing"] = 631,
    ["secrethub.yml"] = 899,
    ["semantic-release"] = 637,
    ["servicehub.config.json"] = 759,
    ["servicehub.service.json"] = 758,
    ["settings.job"] = 640,
    ["sfdx-hardis configuration"] = 642,
    ["shard.yml"] = 935,
    ["size-limit configuration"] = 647,
    ["skaffold.yaml"] = 823,
    ["skyuxconfig.json"] = 649,
    snapcraft = 650,
    ["spicepod.yaml"] = 954,
    ["sqlc configuration"] = 661,
    ["stripe-app-local.json"] = 670,
    ["stripe-app.json"] = 669,
    swcrc = 809,
    ["task.json"] = 677,
    taskcat = 775,
    ["template.json"] = 682,
    ["templatsources.json"] = 683,
    ["theme.json"] = 686,
    ["tizen_workspace.json"] = 687,
    tldr = 688,
    tmuxinator = 762,
    ["transcend.yml"] = 697,
    ...
    ["vega-lite.json"] = 724,
    ["vega.json"] = 723,
    ["venvironment-basic.yaml"] = 727,
    ["venvironment.yaml"] = 726,
    ["version.json"] = 729,
    ["vhwdebugger-binding.yaml"] = 731,
    ["vim-addon-info"] = 732,
    ["vs-2017.3.host.json"] = 734,
    ["vs-nesting.json"] = 735,
    ["vsls.json"] = 733,
    ["vss-extension.json"] = 739,
    ["vtesttree.yaml"] = 740,
    ["vtestunit.yaml"] = 741,
    ["warp-keysets.json"] = 905,
    ["warp-themes.json"] = 906,
    ["warp-workflows.json"] = 907,
    ["webhint.io"] = 862,
    ["webjobpublishsettings.json"] = 746,
    ["webjobs-list.json"] = 745,
    ["well-known-fursona"] = 942,
    ["xs-app.json"] = 771,
    ["xunit.runner.json"] = 757,
    yamllint = 797,
    ["zerops.io import file"] = 951,
    ["zerops.yml"] = 950,
    zuul = 781,
    ["Žinoma"] = 791
  },
