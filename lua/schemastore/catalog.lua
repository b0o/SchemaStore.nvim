...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 114,
    [".cryproj (generic)"] = 432,
    [".cryproj engine-5.2"] = 427,
    [".cryproj engine-5.3"] = 428,
    [".cryproj engine-5.4"] = 429,
    [".cryproj engine-5.5"] = 430,
    [".cryproj engine-dev"] = 431,
    [".csscomb.json"] = 116,
    [".csslintrc"] = 117,
    [".eslintrc"] = 156,
    [".esmrc.json"] = 149,
    ...
    [".mtaext"] = 438,
    [".nodehawkrc"] = 269,
    [".npmpackagejsonlintrc"] = 271,
    [".phraseapp.yml"] = 303,
    [".pmbot.yml"] = 295,
    [".postcssrc"] = 300,
    [".pre-commit-config.yml"] = 301,
    [".pre-commit-hooks.yml"] = 302,
    [".putout.json"] = 320,
    [".rehyperc"] = 325,
    [".remarkrc"] = 326,
    [".sprite files"] = 362,
    ...
    [".vsext"] = 408,
    [".yarnrc.yml"] = 470,
    ["<div>RIOTS' studio configuration"] = 411,
    ["API Builder"] = 467,
    ["AVA Configuration Schema"] = 518,
    ["AWS CDK cdk.json"] = 103,
    ["AWS CloudFormation"] = 104,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 105,
    ...
    ["Azure Pipelines"] = 41,
    ["Azure Static Web Apps CLI configuration file"] = 364,
    ["Azure Static Web Apps configuration file"] = 363,
    ["BX CI"] = 69,
    ["Better Code Hub"] = 472,
    BizTalkServerApplicationSchema = 444,
    ...
    ["Butane config schema"] = 505,
    ["CICS TS region tagging"] = 512,
    ["CICS TS resource import"] = 513,
    ["CICS TS resource model"] = 514,
    ["CICS TS resource overrides"] = 515,
    ["CMake Presets"] = 70,
    ["CSR Framework"] = 78,
    ...
    ["Citation File Format"] = 106,
    CityJSON = 75,
    ["Code Climate"] = 82,
    ["Commandbox Box.json"] = 76,
    ["Commandbox Server.json"] = 77,
    ["Common types for all schemas"] = 1,
    ["Container Structure Test"] = 455,
    Containerlab = 479,
    ["Dart build configuration"] = 118,
    ["Dart test config"] = 119,
    ["DashLord configuration"] = 120,
    ["Datadog Service Catalog Definition"] = 227,
    ["Datahub Ingestion Recipe Schema"] = 519,
    Deno = 124,
    ["Deployer Recipe"] = 127,
    Devfile = 146,
    ["Discord Webhook"] = 129,
    ["Dolittle Artifacts"] = 132,
    ["Dolittle Bounded Context Configuration"] = 133,
    ["Dolittle Event Horizons Configuration"] = 134,
    ["Dolittle Resources Configuration"] = 135,
    ["Dolittle Server Configuration"] = 136,
    ["Dolittle Tenant Map Configuration"] = 138,
    ["Dolittle Tenants Configuration"] = 137,
    ["Dolittle Topology"] = 139,
    ["Drush site aliases"] = 143,
    ["Error pages"] = 152,
    Esquio = 150,
    ["Estuary Flow Catalog Schema"] = 509,
    ["Expo SDK"] = 155,
    ["F-Droid Data metadata"] = 159,
    ["Facets - FSDL - Application"] = 157,
    ["Fossa configuration file"] = 164,
    ["Fossa's fossa-deps file"] = 165,
    ["Foundry VTT - Manifest"] = 162,
    ["Foundry VTT - Template"] = 163,
    ["Foxx Manifest"] = 42,
    ["GatewayCore API Gateway"] = 168,
    ["GeoJSON.json latest"] = 507,
    GherKing = 511,
    ["GitHub Action"] = 172,
    ["GitHub Funding"] = 173,
    ["GitHub Issue Template configuration"] = 175,
    ["GitHub Workflow"] = 176,
    ["GitHub Workflow Template Properties"] = 177,
    ["GitHub issue forms"] = 174,
    GitVersion = 171,
    ["Gitpod Configuration"] = 179,
    ["Global Privacy Control"] = 169,
    ["Google Cloud Workflows"] = 102,
    Goreleaser = 182,
    ["Goreleaser Pro"] = 183,
    ["Gradle Build Cache Node"] = 469,
    ["Gradle Enterprise"] = 468,
    ["Grafana 5.x Dashboard"] = 184,
    ["GraphQL Code Generator"] = 187,
    ["GraphQL Config"] = 186,
    ["GraphQL Mesh"] = 185,
    ["Grunt JSHint task"] = 191,
    ["Grunt Watch task"] = 192,
    ["Grunt base task"] = 193,
    ["Grunt clean task"] = 189,
    ["Grunt copy task"] = 188,
    ["Grunt cssmin task"] = 190,
    HEMTT = 441,
    Hadolint = 453,
    ["Hardware Sentry Configuration"] = 523,
    Hayson = 195,
    ["Haystack Pipeline"] = 196,
    ["Hazelcast 5 Configuration"] = 197,
    ["Helm Chart.lock"] = 80,
    ["Helm Chart.yaml"] = 79,
    Hugo = 501,
    ["Istanbul Schema"] = 526,
    ["JFrog File Spec"] = 212,
    ["JSON Document Transform"] = 220,
    ["JSON Feed"] = 221,
    ["JSON Resume"] = 328,
    ["JSON Schema Draft 2020-12"] = 423,
    ["JSON Schema Draft 4"] = 420,
    ["JSON Schema Draft 7"] = 421,
    ["JSON Schema Draft 8"] = 422,
    ["JSON schema for CodeShip Pro services configuration files"] = 89,
    ["JSON schema for CodeShip Pro steps configuration files"] = 90,
    ["JSON schema for Codecov configuration files"] = 88,
    ["JSON-API"] = 219,
    ["JSON-e templates"] = 477,
    ["JSON-stat 2.0"] = 417,
    JSONPatch = 223,
    Jasmine = 208,
    Jekyll = 209,
    ["Jenkins X Pipelines"] = 210,
    ["Jenkins X Requirements"] = 211,
    ["Jovo Language Models"] = 213,
    ["KSP-AVC"] = 418,
    ["KSP-CKAN"] = 419,
    KrakenD = 226,
    ["LinkML Metamodel"] = 237,
    Liquibase = 483,
    Markdownlint = 486,
    ["MegaLinter configuration"] = 241,
    ["MegaLinter descriptor"] = 242,
    ["Meltano plugin discovery definition"] = 244,
    ["Meltano project definition"] = 243,
    ["Microsoft Band Web Tile"] = 245,
    ["Minecraft Data Pack Advancement"] = 247,
    ["Minecraft Data Pack Biome"] = 248,
    ["Minecraft Data Pack Configured Carver"] = 249,
    ["Minecraft Data Pack Dimension"] = 251,
    ["Minecraft Data Pack Dimension Type"] = 250,
    ["Minecraft Data Pack Item Modifier"] = 252,
    ["Minecraft Data Pack Loot Table"] = 253,
    ["Minecraft Data Pack Metadata"] = 254,
    ["Minecraft Data Pack Predicate"] = 255,
    ["Minecraft Data Pack Recipe"] = 256,
    ["Minecraft Data Pack Template Pool"] = 257,
    ["Minecraft Resourcepack Sounds"] = 258,
    ["Monika Configuration Schema"] = 525,
    ["Netin Diagnostic System Template"] = 490,
    ["Netlify config schema"] = 263,
    ["Nightwatch.js"] = 264,
    ["OSS Review Toolkit curation"] = 286,
    ["OSS Review Toolkit package configuration"] = 287,
    ["OSS Review Toolkit repository configuration"] = 288,
    ["OSS Review Toolkit resolutions"] = 289,
    Opctl = 440,
    ["OpenWeather Current Weather API"] = 476,
    ["OpenWeather Road Risk API"] = 475,
    ["Ory Hydra configuration"] = 201,
    ["Ory Keto configuration"] = 228,
    ["Ory Kratos configuration"] = 285,
    ["Ory Oathkeeper configuration"] = 276,
    ["Outblocks App configuration"] = 283,
    ["Outblocks database table"] = 284,
    ["Outblocks project configuration"] = 282,
    Packer = 292,
    ["Pipeline component"] = 484,
    ["PocketMine plugin.yml"] = 296,
    Pterodactyl = 522,
    ["Pull Request Labeler"] = 319,
    Qodana = 498,
    ["Quali Torque Blueprint Spec 2"] = 520,
    ["RKE Cluster Configuration JSON Schema"] = 482,
    ["RKE Cluster Configuration YAML Schema"] = 481,
    Ray = 452,
    ["Read the Docs"] = 322,
    ["Red-DiscordBot Cog"] = 323,
    ["Red-DiscordBot Cog Repo"] = 324,
    Renovate = 329,
    RoadRunner = 330,
    SWADL = 374,
    ["Sapphire CLI Config"] = 331,
    ["SauceCTL Configuration"] = 487,
    ["Schema Catalog"] = 344,
    ["Scoop manifest"] = 349,
    ["Semgrep Rule"] = 351,
    ["Serverless Framework Configuration"] = 494,
    ["Settings.paf"] = 353,
    ["Shopware 6 Configuration"] = 495,
    ["Shopware CLI Extension Store Configuration"] = 496,
    ["Shopware CLI Project Store Configuration"] = 497,
    Solidarity = 358,
    ["Source Maps v3"] = 359,
    SpecIF = 360,
    ["Sponge Mixin configuration"] = 361,
    ["StackHawk Scanner Configuration"] = 493,
    ["StackHead CLI config"] = 365,
    ["StackHead module configuration"] = 366,
    ["StackHead project definition"] = 367,
    Stale = 368,
    Starship = 369,
    ["Statamic Blueprint"] = 370,
    ["Stryker Mutator"] = 371,
    ["StyleCop Analyzers Configuration"] = 372,
    ["Swagger API 2.0"] = 375,
    ["Taskfile YAML Schema"] = 478,
    Taurus = 376,
    ["TestEnvironment.json"] = 382,
    Tikibase = 379,
    ["Traefik v2"] = 384,
    ["Traefik v2 File Provider"] = 385,
    Tye = 499,
    ["UI5 Manifest"] = 397,
    ["Ubuntu Server Autoinstall"] = 395,
    ["Uniswap Token List"] = 461,
    Updatecli = 506,
    ["User Journey Map YAML Schema"] = 480,
    V2Ray = 510,
    ["VSCode Code Snippets"] = 92,
    ["VSIX CLI publishing"] = 409,
    ["Vela Pipeline Configuration"] = 401,
    Vercel = 91,
    ["Web App Manifest"] = 413,
    ["Web types"] = 416,
    WebExtensions = 412,
    ["Webman package recipe"] = 516,
    ["Windows Package Manager Installer Manifest"] = 458,
    ["Windows Package Manager Locale Manifest"] = 459,
    ["Windows Package Manager Singleton Manifest"] = 457,
    ["Woodpecker pipeline config"] = 489,
    ["Xstate Machine Schema"] = 504,
    ["Yippee-Ki-JSON configuration YML"] = 463,
    ["angular.json"] = 8,
    ...
    ["chutzpah.json"] = 98,
    ["cloud-init: cloud-config userdata JSON schema"] = 86,
    ["cloud-sdk-pipeline-config-schema"] = 100,
    ["cloudbuild.json"] = 101,
    cloudify = 85,
    codemagic = 87,
    ["coffeelint.json"] = 107,
    comet = 473,
    ["commands.json"] = 95,
    ["compile_commands.json"] = 94,
    ["compilerconfig.json"] = 93,
    ["component.json"] = 109,
    ["composer.json"] = 108,
    ["config.json"] = 110,
    ["contentmanifest.json"] = 99,
    ["contribute.json"] = 111,
    ["cosmos.config.json"] = 96,
    ["crowdin.yml"] = 112,
    cspell = 115,
    ["cypress.json"] = 113,
    ["datalogic-scan2deploy-android"] = 121,
    ["datalogic-scan2deploy-ce"] = 122,
    ["debugsettings.json"] = 123,
    ["dependabot-v2.json"] = 126,
    ["dependabot.json"] = 125,
    ["deployed-cli"] = 503,
    ["detekt.yml"] = 128,
    devinit = 465,
    ["devspace.yaml"] = 524,
    ["docfx.json"] = 131,
    ["docker-compose.yml"] = 464,
    ["dockerd.json"] = 130,
    ["dotnet Release Index manifest"] = 140,
    ["dotnetcli.host.json"] = 141,
    ["drone.json"] = 142,
    ["dss-2.0.0.json"] = 144,
    ["dvc.yaml"] = 145,
    ["ecosystem.json"] = 147,
    eksctl = 148,
    ["electron-builder configuration file."] = 153,
    ["epr-manifest.json"] = 151,
    ["evcc.yaml"] = 154,
    ["fabric.mod.json"] = 158,
    ["first-timers-bot"] = 161,
    fulibWorkflows = 488,
    ["func.yaml"] = 166,
    ["function.json"] = 167,
    ["geojson.json"] = 170,
    ["gitlab-ci"] = 178,
    ["global.json"] = 180,
    ["golangci-lint Configuration"] = 181,
    ["haxelib.json"] = 194,
    helmfile = 454,
    ["host-meta.json"] = 199,
    ["host.json"] = 198,
    ...
    huskyrc = 434,
    ["ide.host.json"] = 202,
    ["imageoptimizer.json"] = 203,
    ["importmap.json"] = 205,
    ["ioBroker JSON UI"] = 206,
    ["ioBroker Package manifest"] = 207,
    ["jsconfig.json"] = 224,
    ["jscpd Configuration Schema"] = 521,
    jsdoc = 451,
    ["k3d.yaml"] = 225,
    ["kustomization.yaml"] = 229,
    ["label-commenter-config.yml"] = 230,
    ["launchsettings.json"] = 231,
    ["lerna.json"] = 232,
    ["lgtm.yml"] = 233,
    ["libman.json"] = 234,
    ["license-report-config.json"] = 235,
    ["linkinator.config.json"] = 236,
    ["local.settings.json"] = 238,
    ["localazy.json"] = 239,
    ["lsdlschema.json"] = 240,
    mboats = 492,
    ["mimetypes.json"] = 246,
    ...
    ["mtad.yaml"] = 437,
    ["mycode.json"] = 261,
    ["napari plugin manifest"] = 262,
    neoload = 446,
    ["nest-cli"] = 267,
    ["ninjs (News in JSON) 1.3"] = 266,
    ["ninjs (News in JSON) 2.0"] = 265,
    ["nlu.json"] = 268,
    ["nodemon.json"] = 270,
    ["noodl.schema.json"] = 491,
    now = 442,
    ["nswag.json"] = 274,
    ntangle = 275,
    ["nuclei-template.yaml"] = 272,
    ["nuget-project.json"] = 273,
    ["ocelot.json"] = 277,
    ["omnisharp.json"] = 278,
    ["openapi.json"] = 279,
    ["openfin.json"] = 281,
    ["openrpc.json"] = 280,
    ["package.json"] = 290,
    ["package.manifest"] = 291,
    ["pattern.json"] = 294,
    pgap_yaml_input_reader = 293,
    ["plagiarize-me.yaml"] = 298,
    ["plagiarize.yaml"] = 297,
    ["portman.json"] = 299,
    ["prettierrc.json"] = 304,
    ["prisma.yml"] = 305,
    ["project-1.0.0-beta3.json"] = 307,
    ["project-1.0.0-beta4.json"] = 308,
    ["project-1.0.0-beta5.json"] = 309,
    ["project-1.0.0-beta6.json"] = 310,
    ["project-1.0.0-beta8.json"] = 311,
    ["project-1.0.0-rc1.json"] = 312,
    ["project-1.0.0-rc2.json"] = 313,
    ["project.json"] = 306,
    ["prometheus.json"] = 314,
    ["prometheus.rules.json"] = 315,
    ["proxies.json"] = 316,
    ["publiccode.yml"] = 317,
    ["pubspec.yaml"] = 318,
    ["pyrseas-0.8.json"] = 321,
    ["release drafter"] = 447,
    ["sarif-1.0.0.json"] = 332,
    ["sarif-2.0.0.json"] = 333,
    ["sarif-2.1.0"] = 342,
    ["sarif-2.1.0-rtm.2"] = 334,
    ["sarif-2.1.0-rtm.3"] = 336,
    ["sarif-2.1.0-rtm.4"] = 338,
    ["sarif-2.1.0-rtm.5"] = 340,
    ["sarif-external-property-file-2.1.0"] = 343,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 335,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 337,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 339,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 341,
    ["schema.org - Action"] = 345,
    ["schema.org - ContactPoint"] = 346,
    ["schema.org - Place"] = 347,
    ["schema.org - Thing"] = 348,
    ["semantic-release"] = 350,
    ["servicehub.config.json"] = 426,
    ["servicehub.service.json"] = 425,
    ["settings.job"] = 352,
    ["sfdx-hardis configuration"] = 354,
    ["size-limit configuration"] = 355,
    ["skaffold.yaml"] = 485,
    ["skyuxconfig.json"] = 356,
    snapcraft = 357,
    swcrc = 474,
    taskcat = 443,
    ["template.json"] = 377,
    ["templatsources.json"] = 378,
    ["theme.json"] = 380,
    tmLanguage = 381,
    ["trunk.yaml schema"] = 386,
    ["ts-force-config.json"] = 390,
    ["tsconfig.json"] = 387,
    ["tsd.json"] = 388,
    ["tsdrc.json"] = 389,
    ["tslint.json"] = 391,
    ...
    ["version.json"] = 402,
    ["vim-addon-info"] = 403,
    ["vs-2017.3.host.json"] = 405,
    ["vs-nesting.json"] = 406,
    ["vsls.json"] = 404,
    ["vss-extension.json"] = 410,
    ["webhint.io"] = 517,
    ["webjobpublishsettings.json"] = 415,
    ["webjobs-list.json"] = 414,
    ["xs-app.json"] = 439,
    ["xunit.runner.json"] = 424,
    yamllint = 462,
    zuul = 448,
    ["Žinoma"] = 456
  },
