...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1114,
    [".nodehawkrc"] = 721,
    [".npmpackagejsonlintrc"] = 726,
    [".omletrc"] = 1295,
    [".phrase.yml"] = 808,
    [".phraseapp.yml"] = 809,
    [".pmbot.yml"] = 793,
    [".postcssrc"] = 802,
    [".powerpages-web-template-manifest"] = 804,
    [".pre-commit-config.yml"] = 805,
    [".pre-commit-hooks.yml"] = 806,
    [".putout.json"] = 843,
    [".rehyperc"] = 868,
    [".remarkrc"] = 872,
    [".sprite files"] = 974,
    ...
    ["AAES evidence export (aaes.export/v1)"] = 1474,
    ["AAES evidence pack manifest (aaes.evidence-pack/1)"] = 1475,
    ...
    AIConfig = 50,
    ["AMX Muse Program Descriptor"] = 1344,
    ["API Builder"] = 1150,
    ["AVA Configuration"] = 1214,
    ...
    ["AWS Copilot Manifest"] = 1383,
    ["AWS SAM CLI Samconfig"] = 328,
    Acton = 1437,
    ["Adobe UXP Manifest"] = 1277,
    ["Aerleon Network & Service Definitions"] = 30,
    ["Aerleon Policy"] = 31,
    ["Agent Permission Policy"] = 1423,
    ["Agent Run Metrics"] = 32,
    ["AgentCore CLI"] = 1424,
    ["AgentCtl MCP"] = 1426,
    ["AgentCtl config"] = 1425,
    ["AgentCtl permissions"] = 1427,
    AgentLoopKit = 1428,
    Aider = 1373,
    Air = 34,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1394,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1393,
    ...
    ["Application list for a WinUtil"] = 1323,
    ["ArchSmith diagram IR"] = 1466,
    ArchitectFX = 1328,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1392,
    ["Azure IoT Operations connector metadata"] = 1389,
    ...
    ["Azure Pipelines"] = 139,
    ["Azure Static Web Apps CLI configuration file"] = 978,
    ["Azure Static Web Apps configuration file"] = 977,
    BMML = 1411,
    ["BOSH BPM Config"] = 167,
    ["BOSH CPI Config"] = 168,
    ...
    Badness = 151,
    ["Barba-CV"] = 105,
    ["Bashly (bashly.yml)"] = 1244,
    ["Bashly Settings (bashly-settings.yml)"] = 1245,
    Bento = 1410,
    ["Better Code Hub"] = 1155,
    ["Better Scripts"] = 195,
    Bigconfig = 160,
    ["Biome Formatter Config"] = 106,
    ["Bitmovin Encoding Template"] = 1337,
    BizTalkServerApplicationSchema = 1121,
    Bleep = 196,
    ["Block Protocol Metadata"] = 193,
    ["Bluebricks blueprint config"] = 1416,
    ["Boyka Framework"] = 173,
    ...
    ["Butane Config"] = 1199,
    C4InterFlow = 1352,
    ["CDK Environment Manager, concrete environment configuration"] = 1376,
    ["CDK Environment Manager, concrete environments definition"] = 1375,
    ["CDK Environment Manager, environment definition"] = 1374,
    ["CGS Card Game Specification (cgs.json)"] = 1282,
    ["CICS TS region tagging"] = 1208,
    ["CICS TS resource import"] = 1209,
    ["CICS TS resource model"] = 1210,
    ["CICS TS resource overrides"] = 1211,
    ["CMake Presets"] = 197,
    ["CNC Codes"] = 224,
    ["CRS WAF test file"] = 1312,
    ["CRS WAF test platform overrides file"] = 1313,
    ...
    ["Caido Proxy Configuration"] = 1452,
    ...
    ["Chamaleon environment"] = 1341,
    ["Chamaleon properties"] = 1342,
    ["Chamaleon template"] = 1340,
    Changepacks = 1403,
    Changesets = 337,
    Changie = 209,
    Charmcraft = 210,
    ...
    ["Claude Code Launch Preview"] = 1465,
    ["Claude Code Plugin Manifest"] = 232,
    ["Claude Code Plugin Marketplace"] = 233,
    ["Claude Code Settings"] = 234,
    ["Clawject config"] = 230,
    ["Cloud Foundry Application Manifest"] = 1294,
    ["Cloud Run Spec v1"] = 1318,
    ...
    Concord = 1311,
    ["Configu .cfgu files"] = 1299,
    ["Configu .configu file"] = 1300,
    Conjure = 223,
    ["Container Structure Test"] = 1135,
    Containerlab = 1164,
    ["Context Passport"] = 2,
    ["Context Reasoning Format (CRF)"] = 221,
    ["Contextive Glossary"] = 1368,
    ContractGuard = 1165,
    Convex = 222,
    ...
    ["Cursor Agent Environment"] = 1421,
    ["Custom Machinery Machine"] = 1283,
    ["Custom Machinery Recipe"] = 1284,
    ...
    ["DonateCaseBetterCasino menu"] = 1345,
    ["Draugr Saga"] = 369,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1252,
    ["EAS config"] = 444,
    ["ECA - Editor Code Assistant"] = 407,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1241,
    ["ESLint Suppressions"] = 449,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1388,
    ["EasyVCR .NET"] = 446,
    ["Eidolon Resource"] = 1329,
    ...
    ["Envelope Team Definition"] = 1436,
    ["Envilder Map File"] = 412,
    ["Erda Pipeline"] = 1290,
    ["Erda Runtime"] = 1291,
    ["Espanso config.yml"] = 1414,
    ["Espanso match.yml"] = 1413,
    Esquio = 432,
    ["Estuary Flow Catalog"] = 1205,
    ["Ethereum ERC1155"] = 1430,
    ["Ethereum ERC721"] = 1429,
    ...
    ["Evolving Resolutive Process notation"] = 1390,
    ["Expo SDK"] = 443,
    ...
    ["GeoJSON.json latest"] = 1203,
    GherKing = 1207,
    ["GitHub Action"] = 488,
    ["GitHub Actions typing"] = 1325,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 1279,
    ...
    ["Google Digital Assetlinks"] = 1369,
    Goreleaser = 524,
    ["Goreleaser Pro"] = 525,
    Goss = 527,
    ["Gradle Build Cache Node"] = 1153,
    ["Gradle Enterprise"] = 1152,
    ...
    HEMTT = 1117,
    ["HULL - Helm Uniform Layer Library"] = 1470,
    Hadolint = 1131,
    Hammerkit = 1163,
    ["Hardware Sentry Configuration"] = 1219,
    ...
    ["Hecate Input Schema"] = 1380,
    ["Helm Chart.lock"] = 287,
    ["Helm Chart.yaml"] = 286,
    ["Helm Unittest Test Suite"] = 288,
    ["Heloisa Assistant Plugins Marketplace"] = 1463,
    ["Hex file"] = 289,
    ...
    ["JFrog File Spec"] = 584,
    ["JFrog Pipelines YML DSL"] = 1229,
    ["JMeter DSL cli config"] = 585,
    JReleaser = 588,
    ["JSON Document Transform"] = 596,
    ["JSON Feed"] = 597,
    ["JSON Resume"] = 881,
    ["JSON Schema Draft 2020-12"] = 1096,
    ["JSON Schema Draft 4"] = 1093,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1262,
    ["JSON Schema Draft 7"] = 1094,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1263,
    ["JSON Schema Draft 8 (2019-09)"] = 1095,
    ["JSON-API"] = 595,
    ["JSON-e templates"] = 1160,
    ["JSON-stat 2.0"] = 1089,
    JSONPatch = 599,
    ...
    Jsontron = 600,
    ["Jujutsu (jj) VCS config"] = 1382,
    ["KIMMDY config file"] = 611,
    ["KODE/CI build.yaml"] = 1225,
    ["KSP-AVC"] = 1090,
    ["KSP-CKAN"] = 1091,
    ["KSP-NetKAN"] = 1092,
    KSY = 1292,
    ...
    ["Kong DBLess config"] = 1226,
    KrakenD = 615,
    ["Kubri Configuration"] = 623,
    LOOBin = 644,
    ["Lake configuration file"] = 1385,
    ...
    ["Lando (landofile)"] = 132,
    ["LangGraph Platform configuration"] = 1304,
    ["Language configuration"] = 1303,
    Lefthook = 630,
    ...
    ["Madness (madness.yml)"] = 1243,
    ["Mado configuration"] = 651,
    ["Maestro Flow"] = 652,
    ["Mail Servers Configuration"] = 1417,
    ["MapEHR Mapping"] = 653,
    Markdownlint = 1174,
    ["Mason Registry"] = 1177,
    ...
    ["Metadata for a Cinnamon spice"] = 1321,
    ["Metatype Configuration"] = 662,
    ["MetricsHub Configuration"] = 663,
    ["MetricsHub Connector Configuration"] = 664,
    ["Micro Editor Syntax"] = 1253,
    ["Microsoft Band Web Tile"] = 665,
    ["Microsoft RulesEngine workflow rules"] = 1308,
    ["Microsoft RulesEngine workflow rules list"] = 1309,
    ["Minecraft Custom Main Menu Mod"] = 1271,
    ...
    ["MongoDB Atlas Search Index Definition"] = 1224,
    ["Monika Configuration"] = 1222,
    ["Monoweave Configuration"] = 696,
    ["Motif config"] = 1113,
    MultiQC = 1362,
    ["NOX Framework (Service)"] = 725,
    ["Nais manifests"] = 704,
    ["Netin Diagnostic System Template"] = 1181,
    ["Netlify config"] = 706,
    ["Network-as-Code Data Model"] = 707,
    ["Next Gen UI Agent A2A Server Configuration"] = 708,
    ["Next Gen UI Agent Configuration"] = 710,
    ["Next Gen UI Agent MCP Server Configuration"] = 709,
    ["Nightwatch.js"] = 717,
    ["Nika workflow"] = 722,
    ["Node.js configuration"] = 1118,
    ["NueJS configuration file"] = 730,
    ["Nuitka Package Config"] = 1285,
    ["Nullstone config"] = 732,
    ["ODGS Data Rules"] = 739,
    ["ODGS Ontology Graph"] = 740,
    ["ODGS Standard Metrics"] = 738,
    ["OKF Graph"] = 1464,
    ["ONe's changelog entry"] = 754,
    ["ONe's service descriptor"] = 753,
    ["ORT Server repository environment configuration"] = 765,
    ["OSCAL Assessment Plan (AP)"] = 767,
    ["OSCAL Assessment Results (AR)"] = 768,
    ["OSCAL Catalog"] = 769,
    ["OSCAL Component Definition (CDef)"] = 770,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 771,
    ["OSCAL Profile"] = 772,
    ["OSCAL System Security Plan (SSP)"] = 773,
    ["OSS Review Toolkit configuration"] = 774,
    ["OSS Review Toolkit curation"] = 775,
    ["OSS Review Toolkit package configuration"] = 776,
    ["OSS Review Toolkit project package manager definition"] = 777,
    ["OSS Review Toolkit repository configuration"] = 778,
    ["OSS Review Toolkit resolutions"] = 779,
    ["October CMS columns"] = 736,
    ["October CMS fields"] = 737,
    ["Oh My Posh"] = 742,
    Okteto = 743,
    ["Ona Tasks and Services"] = 745,
    Opctl = 1116,
    ["Open Data Contract Standard (ODCS)"] = 758,
    ["Open Data Product Standard (ODPS)"] = 759,
    ["Open Know-How"] = 1367,
    ["Open Pentest Format"] = 760,
    OpenDecree = 1434,
    ["OpenDecree Configuration"] = 1435,
    ["OpenRewrite Resource"] = 756,
    OpenSRM = 761,
    OpenStatus = 1378,
    ["OpenTelemetry Declarative Configuration"] = 757,
    ["OpenUtau character yaml"] = 750,
    ["OpenUtau ustx"] = 751,
    ["OpenWeather Current Weather API"] = 1159,
    ["OpenWeather Road Risk API"] = 1158,
    ["Ory Hydra configuration"] = 555,
    ["Ory Keto configuration"] = 619,
    ["Ory Kratos configuration"] = 766,
    ["Ory Oathkeeper configuration"] = 734,
    ["Outblocks App configuration"] = 763,
    ["Outblocks database table"] = 764,
    ["Outblocks project configuration"] = 762,
    PDM = 787,
    POPxf = 799,
    ["POPxf Correlations"] = 800,
    ["PRML manifest"] = 807,
    Packer = 783,
    PactSpec = 784,
    Panache = 785,
    Pantsbuild = 1239,
    ["Paper paper-plugin.yml"] = 786,
    ["Pipeline component"] = 1172,
    ["Platform.sh application"] = 15,
    ["Platform.sh routes"] = 16,
    ["Platform.sh services"] = 17,
    ["Plex Prerolls"] = 797,
    ["PocketMine plugin.yml"] = 794,
    ["Podman Desktop Extension"] = 1454,
    ["Postman collection"] = 803,
    ["Power Pages Configuration"] = 1379,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1324,
    ["ProActions AI-Kit Configuration"] = 815,
    ["ProActions AI-Kit Configuration for Menus"] = 817,
    ["ProActions AI-Kit Configuration for Sections"] = 819,
    ["ProActions AI-Kit Configuration for Services"] = 816,
    ["ProActions AI-Kit Configuration for Steps"] = 820,
    ["ProActions AI-Kit Configuration for Templates"] = 818,
    ["Problem object RFC9457"] = 1268,
    ["Problem package format"] = 821,
    ["Problem package generators"] = 822,
    ["Problem package submissions"] = 823,
    ["Problem package test group metadata"] = 824,
    ["Production delivery manifest"] = 1472,
    Promtail = 838,
    Pterodactyl = 1218,
    ["Pull Request Labeler"] = 842,
    Pulumi = 850,
    ["PyGTA Config"] = 846,
    PyProject = 851,
    Pylock = 1370,
    Pyright = 852,
    ["Python script metadata"] = 1364,
    ["QType AI DSL"] = 855,
    Qgoda = 854,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1446,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1444,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1450,
    ["Qlik Talend Cloud Pipeline - Project"] = 1442,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1445,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1447,
    ["Qlik Talend Cloud Pipeline - Task"] = 1443,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1449,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1448,
    Qodana = 1191,
    ["Qt Creator workspace file"] = 1301,
    ["Quali Torque Blueprint Spec 2"] = 1216,
    ["QueryFirst config file"] = 1235,
    ["QuikRun Configuration"] = 1451,
    ["Qwen Code Settings"] = 1431,
    ["RKE Cluster Configuration JSON"] = 1169,
    ["RKE Cluster Configuration YAML"] = 1168,
    RadioHound = 845,
    ["Raid Profile"] = 1432,
    ["Raid Repo Configuration"] = 1433,
    Railpack = 857,
    Railway = 856,
    ["Rancher Fleet"] = 847,
    ["Rattler-build"] = 858,
    Ray = 1130,
    ["Read the Docs"] = 849,
    ["Red-DiscordBot Cog"] = 865,
    ["Red-DiscordBot Cog Repo"] = 866,
    ["Red-DiscordBot Trivia"] = 867,
    ["Releasaurus Config"] = 12,
    ReleaseKit = 11,
    ["Render Blueprints"] = 1167,
    RenderCV = 885,
    Renovate = 882,
    ["Renovate global configuration"] = 883,
    ["Renovate inherited configuration"] = 884,
    ["Replit config"] = 873,
    Restate = 1357,
    ["Revel Digital Gadget Definition File"] = 1381,
    RoadRunner = 887,
    ["Robust Station Image"] = 1387,
    Rockcraft = 888,
    ["Roo Coder Custom Modes"] = 889,
    Rubocop = 878,
    ["Rudder techniques"] = 1275,
    Ruff = 879,
    ["Rust Project"] = 880,
    ["Rust toolchain"] = 894,
    ["SDMX data message"] = 921,
    ["SDMX metadata message"] = 920,
    ["SDMX structure message"] = 919,
    ["SIL Kit Participant Configuration"] = 932,
    ["SIL Kit Registry Configuration"] = 933,
    ["SPDX 2.3"] = 975,
    SWADL = 991,
    ["Safebox Config"] = 1230,
    ["Sapphire CLI Config"] = 897,
    ["SauceCTL Configuration"] = 1178,
    Scarb = 917,
    ["Schema Catalog"] = 912,
    ["Scoop manifest"] = 918,
    ["Secure SDLC Evidence Bundle"] = 922,
    ["Semantic Data Fabric (SDF) file"] = 923,
    ["Semgrep Rule"] = 925,
    ["Serenity Code Generator (Sergen)"] = 926,
    ["Serverless Framework Configuration"] = 1185,
    ["Serverless Workflow"] = 1187,
    ["Settings for a Cinnamon spice"] = 1320,
    ["Settings.paf"] = 928,
    ["Shopware 6 Configuration"] = 1188,
    ["Shopware CLI Extension Store Configuration"] = 1189,
    ["Shopware CLI Project Store Configuration"] = 1190,
    ["Sigma Detection Rule"] = 930,
    ["SigmaCV CV"] = 7,
    ["Sigrid scope configuration file"] = 931,
    ["SkyPilot Task JSON"] = 1276,
    ["Slack app manifest"] = 938,
    ["Slang Server Configuration"] = 1458,
    Snapcraft = 940,
    ["Solarxy project config"] = 943,
    Solidarity = 944,
    ["Solution filters"] = 945,
    ["Source Maps v3"] = 946,
    Sourcery = 947,
    ["Spack bootstrap.yaml"] = 948,
    ["Spack cdash.yaml"] = 949,
    ["Spack ci.yaml"] = 950,
    ["Spack compilers.yaml"] = 951,
    ["Spack concretizer.yaml"] = 952,
    ["Spack config.yaml"] = 953,
    ["Spack definitions.yaml"] = 954,
    ["Spack develop.yaml"] = 955,
    ["Spack env_vars.yaml"] = 956,
    ["Spack environment"] = 962,
    ["Spack include.yaml"] = 957,
    ["Spack mirrors.yaml"] = 958,
    ["Spack modules.yaml"] = 959,
    ["Spack packages.yaml"] = 960,
    ["Spack repos.yaml"] = 961,
    ["Spack toolchains.yaml"] = 963,
    ["Spack upstreams.yaml"] = 964,
    ["Spack view.yaml"] = 965,
    ["Speakeasy Generation Config File"] = 969,
    ["Speakeasy Lint Configuration File"] = 966,
    ["Speakeasy Test Generation Configuration File"] = 967,
    ["Speakeasy Workflow File"] = 968,
    SpecIF = 970,
    ["Specmatic Configuration"] = 971,
    ["Specpin spec file"] = 5,
    ["Sponge Mixin configuration"] = 972,
    ["Spotlight Ruleset"] = 973,
    StackBlitz = 979,
    ["StackHawk Scanner Configuration"] = 1184,
    Stale = 980,
    Starfish = 981,
    ["Starlake Data Pipeline"] = 1156,
    Starship = 982,
    ["Statamic Blueprint"] = 983,
    ["Stella configuration file"] = 984,
    ["Streamlit configuration file"] = 985,
    ["Stryker Mutator"] = 988,
    ["StyleCop Analyzers Configuration"] = 989,
    ["Stylelint (.stylelintrc)"] = 990,
    ["Stylua Config"] = 1371,
    ["Sublime Syntax"] = 1231,
    ["Subsquid squid manifest"] = 1278,
    ["Swagger API 2.0"] = 992,
    ["Symfony Routing Configuration"] = 993,
    ["Symfony Serializer Mapping"] = 994,
    ["Symfony Services Configuration"] = 995,
    ["Symfony Validation Mapping"] = 996,
    ["Synadia Connect Component"] = 997,
    TSON = 1040,
    TSTyche = 1041,
    ["TYPO3 Vendor Bundler config"] = 1047,
    ["Tab data for a LinUtil"] = 1327,
    ["Tab list for a LinUtil"] = 1326,
    Tach = 998,
    ["Tach Domain"] = 999,
    Talhelper = 1001,
    ["Talisman configuration"] = 1002,
    Taplo = 1372,
    ["Taskfile config"] = 1161,
    Taurus = 1003,
    Tauticord = 1004,
    ["Tekton Pipeline"] = 1400,
    ["Tekton PipelineRun"] = 1401,
    ["Tekton Task"] = 1398,
    ["Tekton TaskRun"] = 1399,
    Telefonistka = 1358,
    ["Terraform PowerShell provider block manifest"] = 1007,
    ["Terraform PowerShell provider data source manifest"] = 1008,
    ["Terraform PowerShell provider resource manifest"] = 1009,
    ["Terraform PowerShell provider settings"] = 1010,
    ["Terrateam config"] = 1384,
    ["Tesseract configuration"] = 1011,
    ["TestEnvironment.json"] = 1021,
    ["TextMate Grammar"] = 1020,
    Threagile = 1015,
    ["Thunderbird Extension"] = 1080,
    ["Tier.run pricing.json"] = 1012,
    Tikibase = 1013,
    Tombi = 1018,
    ["Traefik v2"] = 1024,
    ["Traefik v2 File Provider"] = 1025,
    ["Traefik v3"] = 1026,
    ["Traefik v3 File Provider"] = 1027,
    ["Travis CI (.travis.yml)"] = 1023,
    Treefmt = 530,
    Trident = 1354,
    Trivy = 1030,
    ["TrueScript for *.tscript files"] = 1031,
    ["Tugboat QA config.yml"] = 1351,
    TunnelHub = 1266,
    Turborepo = 1022,
    Tycho = 1315,
    Tye = 1192,
    ["Tyk Gateway - Open Source v5.7+"] = 1363,
    ["UET BuildConfig.json"] = 1236,
    ["UI5 Manifest"] = 1053,
    ["UNCORS configuration"] = 1058,
    ["UTAM Page Object"] = 1056,
    ["Ubuntu Server Autoinstall"] = 1051,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1355,
    ["Uniswap Token List"] = 1141,
    ["Universal Schedule Format"] = 1059,
    ["Unreal Engine Uplugin"] = 1237,
    ["Unreal Engine Uproject"] = 1238,
    ["UpCloud CLI (upctl) configuration"] = 1356,
    ["Updatecli Compose"] = 1200,
    ["Updatecli Policy Manifest"] = 1201,
    ["Updatecli Policy Metadata"] = 1202,
    Uplift = 1234,
    ["Upsun config"] = 14,
    ["User Journey Map"] = 1166,
    V2Ray = 1206,
    ["VSCode Code Snippets"] = 312,
    ["VSIX CLI publishing"] = 1077,
    Vector = 1061,
    ["Vee JSON menu output"] = 1062,
    ["Vela Pipeline Configuration"] = 1065,
    Vercel = 311,
    ["Version Bumper config"] = 1066,
    Vespertide = 1405,
    ["Vespertide Migration"] = 1406,
    ["Vespertide Model"] = 1407,
    ["Viash Component Config"] = 1360,
    ["Viash Package Config"] = 1361,
    Visivo = 1264,
    Vogi = 1071,
    ["WP-CLI"] = 1086,
    Wake = 1353,
    ["Waku Config"] = 1330,
    ["Web App Manifest"] = 1082,
    ["Web types"] = 1085,
    WebExtensions = 1081,
    ["Webman package recipe"] = 1212,
    ["Windows Package Manager Installer Manifest"] = 1138,
    ["Windows Package Manager Locale Manifest"] = 1139,
    ["Windows Package Manager Singleton Manifest"] = 1137,
    ["WireMock CLI import configuration"] = 1336,
    ["WireMock CLI local service configuration"] = 1335,
    ["WireMock message stub mapping"] = 1334,
    ["WireMock stub mapping"] = 1333,
    ["Woodpecker pipeline config"] = 1180,
    ["Wrangler CLI"] = 1087,
    ["XenForo add-on manifest"] = 1088,
    ["Xstate Machine"] = 1198,
    ["Yandex Workflow Language"] = 1322,
    ["Yarn Config (.yarnrc.yml)"] = 1154,
    ["Yippee-Ki-JSON configuration YML"] = 1145,
    ["YouTrack App"] = 1319,
    ["Zarf Package Configuration"] = 1386,
    ["Zerops import file"] = 1307,
    ["Zola Configuration"] = 1397,
    abtop = 36,
    act3 = 1438,
    actionlint = 46,
    ["aerleon.yml"] = 29,
    ...
    ["behat.yml"] = 175,
    ["bigquery-table"] = 159,
    ["bioimageio resource description"] = 1286,
    ...
    ["cargo-nextest repository configuration"] = 711,
    ["cargo-nextest user configuration"] = 712,
    ["ccmod.json"] = 1331,
    ["cfgd Config"] = 1459,
    ["cfgd ConfigSource"] = 1462,
    ["cfgd Module"] = 1460,
    ["cfgd Profile"] = 1461,
    changelogging = 1298,
    ...
    ["chutzpah.json"] = 320,
    cibuildwheel = 216,
    ["clang-format (.clang-format)"] = 1204,
    ["clang-tidy"] = 295,
    clangd = 294,
    clib = 296,
    ...
    ["crowdin.yml"] = 347,
    crucible = 351,
    ["ctfd-setup configuration file"] = 1343,
    ["custom-elements.json"] = 1256,
    ["cypress.json"] = 352,
    ["dacier.yml"] = 1441,
    ...
    ["gematik health care insurance list"] = 1349,
    ["gematik health care patient list"] = 1346,
    ["gematik health care provider institution list"] = 1348,
    ["gematik health care provider list"] = 1347,
    ["gematik tiger test environment configuration"] = 1350,
    ["gh-dash"] = 486,
    ["gha-doctor"] = 487,
    ["git-cliff"] = 483,
    ["git-town.toml"] = 1395,
    ["github-settings-as-code"] = 874,
    ["gitlab-ci"] = 501,
    ["global.json"] = 518,
    ["glslint config"] = 3,
    ...
    ["mkdocs.yml"] = 686,
    ["mockd.yaml"] = 690,
    ["mod.pw.toml (packwiz)"] = 1456,
    ["modelparams.dev Model"] = 693,
    ["models CLI"] = 694,
    ["monospace.yml"] = 695,
    ["moon.yml"] = 1332,
    ["mprocs Configuration file"] = 1302,
    ["mrdocs.yml"] = 688,
    ["mta.yaml"] = 1111,
    ["mtad.yaml"] = 1112,
    ["mycode.json"] = 703,
    nFPM = 716,
    ["napari plugin manifest"] = 705,
    neoload = 1124,
    ["nest-cli"] = 719,
    ["nexus-rpc-gen"] = 1422,
    ["nf-core module environment.yml"] = 713,
    ["nf-core module meta.yml"] = 714,
    ["nf-core subworkflow meta.yml"] = 715,
    ["ninjs (News in JSON)"] = 718,
    ["nitro.json"] = 1123,
    ["nixd configuration"] = 1274,
    ["nlu.json"] = 720,
    ["nodemon.json"] = 723,
    ["noodl config"] = 1182,
    ["notebook.mod.json"] = 724,
    now = 1119,
    ["npm-badges"] = 727,
    ["nswag.json"] = 731,
    ntangle = 733,
    ["nuclei-template.yaml"] = 728,
    ["nuget-project.json"] = 729,
    ["ocelot.json"] = 735,
    ogen = 741,
    ["omnisharp.json"] = 744,
    openHAB = 1408,
    ...
    oxfmt = 1418,
    oxlint = 1419,
    ["pack.toml (packwiz)"] = 1457,
    ["package.json"] = 780,
    ["package.manifest"] = 782,
    ["package.yaml"] = 781,
    ["partial-black.json"] = 176,
    ["partial-fastapi.json"] = 177,
    ["partial-pixi.json"] = 792,
    ["partial-scheduled.json"] = 178,
    ["pattern.json"] = 790,
    ["petstore-v1.0"] = 1228,
    pgap_yaml_input_reader = 788,
    pgrls = 789,
    pgxgen = 1412,
    pitcms = 1415,
    ["pixi.toml"] = 791,
    ["plagiarize-me.yaml"] = 796,
    ["plagiarize.yaml"] = 795,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1339,
    ["podbard.yaml"] = 798,
    ["portman.json"] = 801,
    ["prefect.toml"] = 810,
    ["prefect.yaml"] = 811,
    ...
    ["prettierrc.json"] = 813,
    ["prisma.yml"] = 814,
    ["project-1.0.0-beta3.json"] = 826,
    ["project-1.0.0-beta4.json"] = 827,
    ["project-1.0.0-beta5.json"] = 828,
    ["project-1.0.0-beta6.json"] = 829,
    ["project-1.0.0-beta8.json"] = 830,
    ["project-1.0.0-rc1.json"] = 831,
    ["project-1.0.0-rc2.json"] = 832,
    ["project.json"] = 825,
    ["project.owasp.yaml"] = 833,
    ["prometheus-alertmanager.json"] = 837,
    ["prometheus.json"] = 834,
    ["prometheus.rules.json"] = 835,
    ["prometheus.rules.test.json"] = 836,
    ["proxies.json"] = 839,
    ["publiccode.yml"] = 840,
    ["pubspec.yaml"] = 841,
    ["pyrseas-0.8.json"] = 844,
    pytest = 853,
    ["quilt.mod.json"] = 1249,
    ["rc3 auth"] = 859,
    ["rc3 collection"] = 860,
    ...
    ["rc3 settings"] = 864,
    ["registry.yaml"] = 65,
    ["release drafter"] = 1125,
    ["release-hub.json"] = 10,
    ["release-please-config.json"] = 869,
    ["release-please-manifest.json"] = 870,
    ["release-plz.toml"] = 871,
    ["renv.lock"] = 886,
    ["replacement-transformer.yaml"] = 626,
    ["reposets Configuration"] = 875,
    ["reposets Credentials"] = 876,
    ["revola.json"] = 8,
    ["rivet.json"] = 1273,
    ["rivet.yaml (legacy)"] = 1272,
    rumdl = 891,
    runny = 890,
    runspec = 1440,
    rustfmt = 892,
    ...
    samt = 895,
    samtrc = 896,
    ["sarif-1.0.0.json"] = 898,
    ["sarif-2.0.0.json"] = 899,
    ["sarif-2.1.0"] = 909,
    ["sarif-2.1.0-rtm.2"] = 900,
    ["sarif-2.1.0-rtm.3"] = 902,
    ["sarif-2.1.0-rtm.4"] = 904,
    ["sarif-2.1.0-rtm.5"] = 906,
    ["sarif-2.1.0-rtm.6"] = 907,
    ["sarif-external-property-file-2.1.0"] = 910,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 901,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 903,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 905,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 908,
    ["scalingo.json configuration"] = 911,
    ["schema.org - Action"] = 913,
    ["schema.org - ContactPoint"] = 914,
    ["schema.org - Place"] = 915,
    ["schema.org - Thing"] = 916,
    ["secrethub.yml"] = 1251,
    ["semantic-release"] = 924,
    servercn = 1468,
    ["servicehub.config.json"] = 1099,
    ["servicehub.service.json"] = 1098,
    ["settings.job"] = 927,
    ["sfdx-hardis configuration"] = 929,
    ["shard.yml"] = 1289,
    ["size-limit configuration"] = 934,
    ["skaffold.yaml"] = 1173,
    ["skill-map plugin extension manifest"] = 935,
    ["skill-map project settings"] = 936,
    ["skill-map provider kind"] = 937,
    ["skyuxconfig.json"] = 939,
    ["snowflake-config"] = 941,
    ["snowflake-connections"] = 942,
    ["spicepod.yaml"] = 1310,
    ["sqlc configuration"] = 976,
    ["stripe-app-local.json"] = 987,
    ["stripe-app.json"] = 986,
    swcrc = 1157,
    ["task.json"] = 1000,
    taskcat = 1120,
    ["template.json"] = 1005,
    ["templatsources.json"] = 1006,
    ["text2confl config"] = 1420,
    ["theme.json"] = 1014,
    ["tizen_workspace.json"] = 1016,
    tldr = 1017,
    ["tm_devices configuration file"] = 1377,
    tmuxinator = 1102,
    tox = 1019,
    ["transcend.yml"] = 1028,
    ...
    version = 1359,
    ["version.json"] = 1067,
    ["vhwdebugger-binding.yaml"] = 1069,
    ["vim-addon-info"] = 1070,
    ["vs-2017.3.host.json"] = 1073,
    ["vs-nesting.json"] = 1074,
    ["vsls.json"] = 1072,
    ["vss-extension.json"] = 1078,
    vtcfg = 1365,
    ["warp-keysets.json"] = 1257,
    ["warp-themes.json"] = 1258,
    ["warp-workflows.json"] = 1259,
    ["webhint.io"] = 1213,
    ["webjobpublishsettings.json"] = 1084,
    ["webjobs-list.json"] = 1083,
    ["well-known-fursona"] = 1297,
    ["xs-app.json"] = 1115,
    ["xunit.runner.json"] = 1097,
    ["yaml-workflow"] = 1467,
    yamlfmt = 1142,
    yamllint = 1143,
    ["yap.json"] = 1144,
