...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 919,
    [".nodehawkrc"] = 567,
    [".npmpackagejsonlintrc"] = 571,
    [".omletrc"] = 1098,
    [".phrase.yml"] = 642,
    [".phraseapp.yml"] = 643,
    [".pmbot.yml"] = 628,
    [".postcssrc"] = 637,
    [".powerpages-web-template-manifest"] = 639,
    [".pre-commit-config.yml"] = 640,
    [".pre-commit-hooks.yml"] = 641,
    [".putout.json"] = 676,
    [".rehyperc"] = 701,
    [".remarkrc"] = 705,
    [".sprite files"] = 796,
    ...
    AIConfig = 31,
    ["AMX Muse Program Descriptor"] = 1146,
    ["API Builder"] = 954,
    ["AVA Configuration"] = 1017,
    ...
    ["AWS Copilot Manifest"] = 1185,
    ["AWS SAM CLI Samconfig"] = 255,
    ["Adobe UXP Manifest"] = 1080,
    ["Aerleon Network & Service Definitions"] = 18,
    ["Aerleon Policy"] = 19,
    Aider = 1175,
    Air = 21,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1196,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1195,
    ["Airlock Microgateway"] = 32,
    ["Alacritty Configuration"] = 989,
    ["All Contributors configuration file"] = 1043,
    ["Ansible Argument Specs"] = 388,
    ["Ansible Collection Galaxy"] = 395,
    ["Ansible Execution Environment"] = 385,
    ["Ansible Inventory"] = 394,
    ["Ansible Meta"] = 386,
    ["Ansible Meta Runtime"] = 387,
    ["Ansible Navigator Configuration"] = 397,
    ["Ansible Playbook"] = 392,
    ["Ansible Requirements"] = 389,
    ["Ansible Rulebook"] = 393,
    ["Ansible Tasks File"] = 391,
    ["Ansible Vars File"] = 390,
    ["Ansible-lint Configuration"] = 396,
    Any = 1108,
    ...
    ["Application list for a WinUtil"] = 1125,
    ArchitectFX = 1130,
    ["Argo CD"] = 51,
    ["Argo Events"] = 52,
    ["Argo Workflows"] = 53,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1194,
    ["Azure IoT Operations connector metadata"] = 1191,
    ...
    ["Azure Pipelines"] = 107,
    ["Azure Static Web Apps CLI configuration file"] = 800,
    ["Azure Static Web Apps configuration file"] = 799,
    ["BOSH CPI Config"] = 132,
    ["BOSH Deploy Config"] = 133,
    ["BX CI"] = 152,
    ["Bacon config"] = 3,
    ["Bashly (bashly.yml)"] = 1047,
    ["Bashly Settings (bashly-settings.yml)"] = 1048,
    Bento = 1212,
    ["Better Code Hub"] = 959,
    ["Better Scripts"] = 153,
    Bigconfig = 125,
    ["Biome Formatter Config"] = 79,
    ["Bitmovin Encoding Template"] = 1139,
    BizTalkServerApplicationSchema = 926,
    Bleep = 154,
    ["Block Protocol Metadata"] = 151,
    ["Bluebricks blueprint config"] = 1217,
    ["Boyka Framework"] = 134,
    Briefcase = 932,
    ["Build Info"] = 142,
    Buildkite = 144,
    ...
    ["Butane Config"] = 1002,
    C4InterFlow = 1154,
    ["CDK Environment Manager, concrete environment configuration"] = 1178,
    ["CDK Environment Manager, concrete environments definition"] = 1177,
    ["CDK Environment Manager, environment definition"] = 1176,
    ["CGS Card Game Specification (cgs.json)"] = 1085,
    ["CICS TS region tagging"] = 1011,
    ["CICS TS resource import"] = 1012,
    ["CICS TS resource model"] = 1013,
    ["CICS TS resource overrides"] = 1014,
    ["CMake Presets"] = 155,
    ["CNC Codes"] = 176,
    ["CRS WAF test file"] = 1115,
    ["CRS WAF test platform overrides file"] = 1116,
    ...
    ["Chamaleon environment"] = 1143,
    ["Chamaleon properties"] = 1144,
    ["Chamaleon template"] = 1142,
    Changepacks = 1205,
    Changesets = 264,
    Changie = 164,
    Charmcraft = 165,
    ...
    ["Clawject config"] = 182,
    ["Cloud Foundry Application Manifest"] = 1097,
    ["Cloud Run Spec v1"] = 1120,
    ...
    Concord = 1114,
    ["Configu .cfgu files"] = 1102,
    ["Configu .configu file"] = 1103,
    Conjure = 175,
    ["Container Structure Test"] = 940,
    Containerlab = 968,
    ["Contextive Glossary"] = 1170,
    Convex = 174,
    ["Crowdsec collection config"] = 274,
    ["Crowdsec parser config"] = 275,
    ["Crowdsec scenario config"] = 276,
    ["CumulusCI Config"] = 181,
    ["Custom Machinery Machine"] = 1086,
    ["Custom Machinery Recipe"] = 1087,
    ["Cycle Stack File"] = 186,
    CycloneDX = 187,
    ["DWP Exchange - catalogue entry"] = 323,
    ["DWP Exchange - gateway"] = 321,
    ["DWP Exchange - meta"] = 322,
    ...
    ["DataYoga Job"] = 189,
    ["Databricks Asset Bundles"] = 1064,
    ["Datadog Continuous Testing"] = 486,
    ["Datadog Service Definition"] = 487,
    ["Datadog Software Catalog"] = 488,
    ["Datahub Ingestion Recipe"] = 1018,
    ...
    DipDup = 1117,
    ["Discord Webhook"] = 297,
    ["DocFx Config (docfx.json)"] = 301,
    Dofigen = 302,
    ["Dolittle Artifacts"] = 303,
    ["Dolittle Bounded Context Configuration"] = 304,
    ["Dolittle Event Horizons Configuration"] = 305,
    ["Dolittle Resources Configuration"] = 306,
    ["Dolittle Server Configuration"] = 307,
    ["Dolittle Tenant Map Configuration"] = 309,
    ["Dolittle Tenants Configuration"] = 308,
    ["Dolittle Topology"] = 310,
    ["DonateCaseBetterCasino menu"] = 1147,
    ...
    ["Drupal Routing"] = 214,
    ["Drupal Services"] = 216,
    ["Drush site aliases"] = 316,
    ["Dynamic Bash Aliases (.aliases)"] = 1055,
    ["EAS config"] = 341,
    ["ECA - Editor Code Assistant"] = 325,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1044,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1190,
    ["EasyVCR .NET"] = 342,
    ["Eidolon Resource"] = 1131,
    ["Elgato Stream Deck"] = 327,
    Elm = 1119,
    ["Embrace Config"] = 1030,
    Endurica = 1068,
    ["Enterprise Contract Policy Spec"] = 328,
    ["Erda Pipeline"] = 1093,
    ["Erda Runtime"] = 1094,
    ["Espanso config.yml"] = 1215,
    ["Espanso match.yml"] = 1214,
    Esquio = 330,
    ["Estuary Flow Catalog"] = 1008,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 334,
    ["EveryVoice TTS Toolkit Data Configuration"] = 335,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 339,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 338,
    ["EveryVoice TTS Toolkit Text Configuration"] = 336,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 337,
    ["Evolving Resolutive Process notation"] = 1192,
    ["Expo SDK"] = 340,
    ["F-Droid Data metadata"] = 346,
    ["FasterCI Configuration"] = 108,
    FiQuS = 350,
    Firebase = 348,
    ["FlexGet Config"] = 351,
    ["Flow.json Configurations"] = 1090,
    ["Fossa configuration file"] = 358,
    ["Fossa's fossa-deps file"] = 359,
    ["Foundry VTT - Base package Manifest"] = 353,
    ["Foundry VTT - Module Manifest"] = 354,
    ["Foundry VTT - System Data Template"] = 357,
    ["Foundry VTT - System Manifest"] = 355,
    ["Foundry VTT - World Manifest"] = 356,
    ["Foxx Manifest"] = 109,
    ["Freifunk.de Community API"] = 112,
    ["Frogbot Config"] = 113,
    ["G2P Mapping Configuration"] = 365,
    ["GCP Blueprint Metadata"] = 368,
    Gaspar = 366,
    ["GatewayCore API Gateway"] = 367,
    ["Gemini CLI settings"] = 369,
    ["GeoJSON.json latest"] = 1006,
    GherKing = 1010,
    ["GitHub Action"] = 374,
    ["GitHub Actions typing"] = 1127,
    ["GitHub Discussion"] = 375,
    ["GitHub Funding"] = 376,
    ["GitHub Issue Template configuration"] = 377,
    ["GitHub Issue Template forms"] = 378,
    ["GitHub Workflow"] = 379,
    ["GitHub Workflow Template Properties"] = 380,
    ["GitHub automatically generated release notes configuration"] = 381,
    ["GitLab Agent for Kubernetes configuration"] = 1082,
    GitVersion = 371,
    ["Gitea Issue Template configuration"] = 372,
    ["Gitea Issue Template forms"] = 373,
    ["Gitpod Automations"] = 383,
    ["Gitpod Configuration"] = 384,
    ["GlazeWM settings"] = 1084,
    ["Global Privacy Control"] = 370,
    Goblet = 1063,
    ["Golangci-lint Configuration"] = 399,
    ["Golangci-lint Custom Plugins Configuration"] = 400,
    ["Google Chrome Related Website Sets"] = 349,
    ["Google Cloud Workflows"] = 251,
    ["Google Digital Assetlinks"] = 1171,
    Goreleaser = 402,
    ["Goreleaser Pro"] = 403,
    Goss = 404,
    ["Gradle Build Cache Node"] = 957,
    ["Gradle Enterprise"] = 956,
    ["Grafana 5.x Dashboard"] = 405,
    ["GraphQL Code Generator"] = 410,
    ["GraphQL Config"] = 409,
    ["GraphQL Mesh"] = 408,
    ["GroovyLint configuration"] = 411,
    ["Grunt JSHint task"] = 415,
    ["Grunt Watch task"] = 416,
    ["Grunt base task"] = 417,
    ["Grunt clean task"] = 413,
    ["Grunt copy task"] = 412,
    ["Grunt cssmin task"] = 414,
    HEMTT = 922,
    Hadolint = 936,
    Hammerkit = 967,
    ["Hardware Sentry Configuration"] = 1022,
    ["HashiCorp Vault"] = 418,
    Hatch = 937,
    Hayson = 420,
    ["Haystack Pipeline"] = 421,
    ["Hazelcast 5 Configuration"] = 422,
    ["Hecate Input Schema"] = 1182,
    ["Helm Chart.lock"] = 218,
    ["Helm Chart.yaml"] = 217,
    ["Helm Unittest Test Suite"] = 219,
    ["Home Assistant Integration Manifest"] = 423,
    ["Homer dashboard configuration"] = 424,
    Hugo = 998,
    ["Hugo Theme"] = 997,
    ["Hulak Configuration"] = 431,
    ["Hyperfoil benchmark configuration"] = 430,
    ["IBM Zapp document"] = 432,
    ["IBM zCodeFormatSettings"] = 433,
    ["IMG Catapult PSP"] = 438,
    ["IVMS101 by CODE Protocol"] = 1083,
    Infrahub = 440,
    Istanbul = 1026,
    ["JDownloader2 crawler multi-rules"] = 453,
    ["JDownloader2 crawler single-rules"] = 452,
    ["JFrog Applications Config"] = 454,
    ["JFrog File Spec"] = 455,
    ["JFrog Pipelines YML DSL"] = 1032,
    ["JMeter DSL cli config"] = 456,
    JReleaser = 459,
    ["JSON Document Transform"] = 467,
    ["JSON Feed"] = 468,
    ["JSON Resume"] = 711,
    ["JSON Schema Draft 2020-12"] = 904,
    ["JSON Schema Draft 4"] = 901,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1065,
    ["JSON Schema Draft 7"] = 902,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1066,
    ["JSON Schema Draft 8 (2019-09)"] = 903,
    ["JSON-API"] = 466,
    ["JSON-e templates"] = 964,
    ["JSON-stat 2.0"] = 897,
    JSONPatch = 470,
    ["JSR Package Config (jsr.json)"] = 460,
    Jarl = 1198,
    Jasmine = 447,
    Jekyll = 448,
    ["Jenkins X Pipelines"] = 449,
    ["Jenkins X Requirements"] = 450,
    Jest = 451,
    Jocker = 457,
    ["Jovo Language Models"] = 458,
    ["Jujutsu (jj) VCS config"] = 1184,
    ["KIMMDY config file"] = 481,
    ["KODE/CI build.yaml"] = 1028,
    ["KSP-AVC"] = 898,
    ["KSP-CKAN"] = 899,
    ["KSP-NetKAN"] = 900,
    KSY = 1095,
    KSail = 363,
    ["KYA Manifest"] = 1096,
    ["Karakum configuration file"] = 360,
    Kas = 473,
    ["Kestra flow file"] = 482,
    ["Keycloak REST API"] = 1035,
    ["Knative Functions - func.yaml"] = 361,
    Knip = 362,
    ["Kometa (nightly) config file"] = 484,
    ["Kometa config file"] = 483,
    ["Kong DBLess config"] = 1029,
    KrakenD = 485,
    ["Kubri Configuration"] = 492,
    LOOBin = 507,
    ["Lake configuration file"] = 1187,
    ...
    ["Lando (landofile)"] = 103,
    ["LangGraph Platform configuration"] = 1107,
    ["Language configuration"] = 1106,
    Lefthook = 496,
    ["Liferay client-extension.yaml"] = 503,
    ["LinkML Metamodel"] = 505,
    Liquibase = 973,
    ["Liquibase Flow File"] = 974,
    ["Lively Properties"] = 506,
    ["Lobe AI Agent"] = 105,
    Loki = 106,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 547,
    ["MS2Rescore Configuration"] = 550,
    ["Madness (madness.yml)"] = 1046,
    ["Mado configuration"] = 513,
    ["Mail Servers Configuration"] = 1218,
    ["MapEHR Mapping"] = 514,
    Markdownlint = 977,
    ["Mason Registry"] = 980,
    ["MegaLinter Custom Flavor"] = 517,
    ["MegaLinter configuration"] = 516,
    ["MegaLinter descriptor"] = 518,
    Melange = 1073,
    ["Meltano project definition"] = 519,
    ["Mergify Configuration"] = 551,
    ["Metadata for a Bazel module"] = 520,
    ["Metadata for a Cinnamon spice"] = 1123,
    ["Metatype Configuration"] = 521,
    ["MetricsHub Configuration"] = 522,
    ["MetricsHub Connector Configuration"] = 523,
    ["Micro Editor Syntax"] = 1056,
    ["Microsoft Band Web Tile"] = 524,
    ["Microsoft RulesEngine workflow rules"] = 1111,
    ["Microsoft RulesEngine workflow rules list"] = 1112,
    ["Minecraft Custom Main Menu Mod"] = 1074,
    ["Minecraft Data Pack Advancement"] = 526,
    ["Minecraft Data Pack Biome"] = 527,
    ["Minecraft Data Pack Configured Carver"] = 528,
    ["Minecraft Data Pack Damage Type"] = 529,
    ["Minecraft Data Pack Dimension"] = 531,
    ["Minecraft Data Pack Dimension Type"] = 530,
    ["Minecraft Data Pack Item Modifier"] = 532,
    ["Minecraft Data Pack Loot Table"] = 533,
    ["Minecraft Data Pack Metadata"] = 534,
    ["Minecraft Data Pack Predicate"] = 535,
    ["Minecraft Data Pack Recipe"] = 536,
    ["Minecraft Data Pack Tag"] = 537,
    ["Minecraft Data Pack Template Pool"] = 538,
    ["Minecraft Data Pack Trim Material"] = 543,
    ["Minecraft Data Pack Trim Pattern"] = 544,
    ["Minecraft Resource Pack Lang"] = 539,
    ["Minecraft Resource Pack Particle"] = 540,
    ["Minecraft Resource Pack Texture Mcmeta"] = 542,
    ["Minecraft Resourcepack Sounds"] = 541,
    ["Monade CLI Stack Configuration"] = 554,
    ["MongoDB Atlas Search Index Definition"] = 1027,
    ["Monika Configuration"] = 1025,
    ["Monoweave Configuration"] = 549,
    ["Motif config"] = 918,
    MultiQC = 1164,
    ["NOX Framework (Service)"] = 570,
    ["Netin Diagnostic System Template"] = 984,
    ["Netlify config"] = 557,
    ["Network-as-Code Data Model"] = 558,
    ["Next Gen UI Agent A2A Server Configuration"] = 559,
    ["Next Gen UI Agent Configuration"] = 561,
    ["Next Gen UI Agent MCP Server Configuration"] = 560,
    ["Nightwatch.js"] = 563,
    ["Node.js configuration"] = 923,
    ["NueJS configuration file"] = 575,
    ["Nuitka.yaml"] = 1088,
    ["Nullstone config"] = 577,
    ["ONe's changelog entry"] = 595,
    ["ONe's service descriptor"] = 594,
    ["ORT Server repository environment configuration"] = 604,
    ["OSCAL Assessment Plan (AP)"] = 606,
    ["OSCAL Assessment Results (AR)"] = 607,
    ["OSCAL Catalog"] = 608,
    ["OSCAL Component Definition (CDef)"] = 609,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 610,
    ["OSCAL Profile"] = 611,
    ["OSCAL System Security Plan (SSP)"] = 612,
    ["OSS Review Toolkit configuration"] = 613,
    ["OSS Review Toolkit curation"] = 614,
    ["OSS Review Toolkit package configuration"] = 615,
    ["OSS Review Toolkit repository configuration"] = 616,
    ["OSS Review Toolkit resolutions"] = 617,
    ["October CMS columns"] = 581,
    ["October CMS fields"] = 582,
    ["Oh My Posh"] = 583,
    Okteto = 584,
    ["Ona Automations"] = 586,
    Opctl = 921,
    ["Open Data Contract Standard (ODCS)"] = 598,
    ["Open Data Product Standard (ODPS)"] = 599,
    ["Open Know-How"] = 1169,
    ["OpenRewrite Resource"] = 597,
    OpenSRM = 600,
    OpenStatus = 1180,
    ["OpenUtau character yaml"] = 591,
    ["OpenUtau ustx"] = 592,
    ["OpenWeather Current Weather API"] = 963,
    ["OpenWeather Road Risk API"] = 962,
    ["Ory Hydra configuration"] = 429,
    ["Ory Keto configuration"] = 489,
    ["Ory Kratos configuration"] = 605,
    ["Ory Oathkeeper configuration"] = 579,
    ["Outblocks App configuration"] = 602,
    ["Outblocks database table"] = 603,
    ["Outblocks project configuration"] = 601,
    PDM = 624,
    POPxf = 634,
    ["POPxf Correlations"] = 635,
    Packer = 621,
    Pantsbuild = 1042,
    ["Paper paper-plugin.yml"] = 622,
    ["Pipeline component"] = 975,
    ["Platform.sh application"] = 5,
    ["Platform.sh routes"] = 6,
    ["Platform.sh services"] = 7,
    ["Plex Prerolls"] = 632,
    ["PocketMine plugin.yml"] = 629,
    ["Postman collection"] = 638,
    ["Power Pages Configuration"] = 1181,
    ["Preset list for a WinUtil"] = 1126,
    ["ProActions AI-Kit Configuration"] = 649,
    ["ProActions AI-Kit Configuration for Menus"] = 651,
    ["ProActions AI-Kit Configuration for Sections"] = 653,
    ["ProActions AI-Kit Configuration for Services"] = 650,
    ["ProActions AI-Kit Configuration for Steps"] = 654,
    ["ProActions AI-Kit Configuration for Templates"] = 652,
    ["Problem object RFC9457"] = 1071,
    ["Problem package format"] = 655,
    ["Problem package generators"] = 656,
    ["Problem package submissions"] = 657,
    ["Problem package test group metadata"] = 658,
    Pterodactyl = 1021,
    ["Pull Request Labeler"] = 675,
    Pulumi = 683,
    ["PyGTA Config"] = 679,
    PyProject = 684,
    Pylock = 1172,
    Pyright = 685,
    ["Python script metadata"] = 1166,
    ["QType AI DSL"] = 688,
    Qgoda = 687,
    Qodana = 994,
    ["Qt Creator workspace file"] = 1104,
    ["Quali Torque Blueprint Spec 2"] = 1019,
    ["QueryFirst config file"] = 1038,
    ["RKE Cluster Configuration JSON"] = 972,
    ["RKE Cluster Configuration YAML"] = 971,
    RadioHound = 678,
    Railpack = 690,
    Railway = 689,
    ["Rancher Fleet"] = 680,
    ...
    Ray = 935,
    ["Read the Docs"] = 682,
    ["Red-DiscordBot Cog"] = 698,
    ["Red-DiscordBot Cog Repo"] = 699,
    ["Red-DiscordBot Trivia"] = 700,
    ["Releasaurus Config"] = 2,
    ["Render Blueprints"] = 970,
    RenderCV = 715,
    Renovate = 712,
    ["Renovate global configuration"] = 713,
    ["Renovate inherited configuration"] = 714,
    ["Replit config"] = 706,
    Restate = 1159,
    ["Revel Digital Gadget Definition File"] = 1183,
    RoadRunner = 717,
    ["Robust Station Image"] = 1189,
    Rockcraft = 718,
    ["Roo Coder Custom Modes"] = 719,
    Rubocop = 708,
    ["Rudder techniques"] = 1078,
    Ruff = 709,
    ["Rust Project"] = 710,
    ["Rust toolchain"] = 723,
    ["SDMX data message"] = 749,
    ["SDMX metadata message"] = 748,
    ["SDMX structure message"] = 747,
    ["SIL Kit Participant Configuration"] = 759,
    ["SIL Kit Registry Configuration"] = 760,
    ["SPDX 2.3"] = 797,
    SWADL = 813,
    ["Safebox Config"] = 1033,
    ["Sapphire CLI Config"] = 726,
    ["SauceCTL Configuration"] = 981,
    ["Schema Catalog"] = 741,
    ["Scoop manifest"] = 746,
    ["Semantic Data Fabric (SDF) file"] = 750,
    ["Semgrep Rule"] = 752,
    ["Serenity Code Generator (Sergen)"] = 753,
    ["Serverless Framework Configuration"] = 988,
    ["Serverless Workflow"] = 990,
    ["Settings for a Cinnamon spice"] = 1122,
    ["Settings.paf"] = 755,
    ["Shopware 6 Configuration"] = 991,
    ["Shopware CLI Extension Store Configuration"] = 992,
    ["Shopware CLI Project Store Configuration"] = 993,
    ["Sigma Detection Rule"] = 757,
    ["Sigrid scope configuration file"] = 758,
    ["SkyPilot Task JSON"] = 1079,
    ["Slack app manifest"] = 762,
    Snapcraft = 764,
    Solidarity = 767,
    ["Solution filters"] = 768,
    ["Source Maps v3"] = 769,
    Sourcery = 770,
    ["Spack bootstrap.yaml"] = 771,
    ["Spack cdash.yaml"] = 772,
    ["Spack ci.yaml"] = 773,
    ["Spack compilers.yaml"] = 774,
    ["Spack concretizer.yaml"] = 775,
    ["Spack config.yaml"] = 776,
    ["Spack definitions.yaml"] = 777,
    ["Spack develop.yaml"] = 778,
    ["Spack env_vars.yaml"] = 779,
    ["Spack environment"] = 785,
    ["Spack include.yaml"] = 780,
    ["Spack mirrors.yaml"] = 781,
    ["Spack modules.yaml"] = 782,
    ["Spack packages.yaml"] = 783,
    ["Spack repos.yaml"] = 784,
    ["Spack toolchains.yaml"] = 786,
    ["Spack upstreams.yaml"] = 787,
    ["Spack view.yaml"] = 788,
    ["Speakeasy Generation Config File"] = 792,
    ["Speakeasy Lint Configuration File"] = 789,
    ["Speakeasy Test Generation Configuration File"] = 790,
    ["Speakeasy Workflow File"] = 791,
    SpecIF = 793,
    ["Specmatic Configuration"] = 794,
    ["Sponge Mixin configuration"] = 795,
    StackBlitz = 801,
    ["StackHawk Scanner Configuration"] = 987,
    Stale = 802,
    Starfish = 803,
    ["Starlake Data Pipeline"] = 960,
    Starship = 804,
    ["Statamic Blueprint"] = 805,
    ["Stella configuration file"] = 806,
    ["Streamlit configuration file"] = 807,
    ["Stryker Mutator"] = 810,
    ["StyleCop Analyzers Configuration"] = 811,
    ["Stylelint (.stylelintrc)"] = 812,
    ["Stylua Config"] = 1173,
    ["Sublime Syntax"] = 1034,
    ["Subsquid squid manifest"] = 1081,
    ["Swagger API 2.0"] = 814,
    ["Synadia Connect Component"] = 815,
    TSON = 850,
    TSTyche = 851,
    ["TYPO3 Vendor Bundler config"] = 856,
    ["Tab data for a LinUtil"] = 1129,
    ["Tab list for a LinUtil"] = 1128,
    Tach = 816,
    ["Tach Domain"] = 817,
    Talhelper = 819,
    ["Talisman configuration"] = 820,
    Taplo = 1174,
    ["Taskfile config"] = 965,
    Taurus = 821,
    Tauticord = 822,
    ["Tekton Pipeline"] = 1202,
    ["Tekton PipelineRun"] = 1203,
    ["Tekton Task"] = 1200,
    ["Tekton TaskRun"] = 1201,
    Telefonistka = 1160,
    ["Terrateam config"] = 1186,
    ["TestEnvironment.json"] = 833,
    ["TextMate Grammar"] = 832,
    Threagile = 828,
    ["Tier.run pricing.json"] = 825,
    Tikibase = 826,
    Tombi = 831,
    ["Traefik v2"] = 836,
    ["Traefik v2 File Provider"] = 837,
    ["Traefik v3"] = 838,
    ["Traefik v3 File Provider"] = 839,
    ["Travis CI (.travis.yml)"] = 835,
    Treefmt = 407,
    Trident = 1156,
    ["TrueScript for *.tscript files"] = 842,
    ["Tugboat QA config.yml"] = 1153,
    TunnelHub = 1069,
    Turborepo = 834,
    Tycho = 1118,
    Tye = 995,
    ["Tyk Gateway - Open Source v5.7+"] = 1165,
    ["UET BuildConfig.json"] = 1039,
    ["UI5 Manifest"] = 862,
    ["UNCORS configuration"] = 866,
    ["UTAM Page Object"] = 865,
    ["Ubuntu Server Autoinstall"] = 860,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1157,
    ["Uniswap Token List"] = 947,
    ["Universal Schedule Format"] = 867,
    ["Unreal Engine Uplugin"] = 1040,
    ["Unreal Engine Uproject"] = 1041,
    ["UpCloud CLI (upctl) configuration"] = 1158,
    ["Updatecli Compose"] = 1003,
    ["Updatecli Policy Manifest"] = 1004,
    ["Updatecli Policy Metadata"] = 1005,
    Uplift = 1037,
    ["Upsun config"] = 4,
    ["User Journey Map"] = 969,
    V2Ray = 1009,
    ["VSCode Code Snippets"] = 239,
    ["VSIX CLI publishing"] = 885,
    Vector = 869,
    ["Vela Pipeline Configuration"] = 872,
    Vercel = 238,
    ["Version Bumper config"] = 875,
    Vespertide = 1207,
    ["Vespertide Migration"] = 1208,
    ["Vespertide Model"] = 1209,
    ["Viash Component Config"] = 1162,
    ["Viash Package Config"] = 1163,
    Visivo = 1067,
    ["WP-CLI"] = 895,
    Wake = 1155,
    ["Waku Config"] = 1132,
    ["Web App Manifest"] = 891,
    ["Web types"] = 894,
    WebExtensions = 890,
    ["Webman package recipe"] = 1015,
    ["Windows Package Manager Installer Manifest"] = 943,
    ["Windows Package Manager Locale Manifest"] = 944,
    ["Windows Package Manager Singleton Manifest"] = 942,
    Winutil = 945,
    ["WireMock CLI import configuration"] = 1138,
    ["WireMock CLI local service configuration"] = 1137,
    ["WireMock message stub mapping"] = 1136,
    ["WireMock stub mapping"] = 1135,
    ["Woodpecker pipeline config"] = 983,
    ["Wrangler CLI"] = 896,
    ["Xstate Machine"] = 1001,
    ["Yandex Workflow Language"] = 1124,
    ["Yarn Config (.yarnrc.yml)"] = 958,
    ["Yippee-Ki-JSON configuration YML"] = 949,
    ["YouTrack App"] = 1121,
    ["Zarf Package Configuration"] = 1188,
    ["Zerops.io config"] = 1109,
    ["Zerops.io import"] = 1110,
    ["Zola Configuration"] = 1199,
    ["aerleon.yml"] = 17,
    ["amplify.yml"] = 10,
    ["angular.json"] = 33,
    apko = 1072,
    ...
    ["behat.yml"] = 135,
    ["bigquery-table"] = 124,
    ["bioimageio resource description"] = 1089,
    ...
    ["chutzpah.json"] = 247,
    cibuildwheel = 170,
    ["clang-format (.clang-format)"] = 1007,
    ["clang-tidy"] = 225,
    clangd = 224,
    clib = 226,
    ...
    ["crowdin.yml"] = 273,
    ["ctfd-setup configuration file"] = 1145,
    ["custom-elements.json"] = 1059,
    ["cypress.json"] = 277,
    ...
    djlint = 952,
    ["docker bake"] = 299,
    ["docker sequencer"] = 300,
    ["docker-compose.yml"] = 950,
    ["dockerd.json"] = 298,
    ["dotnet Release Index manifest"] = 311,
    ["dotnet-tools.json"] = 312,
    ["dotnetcli.host.json"] = 313,
    ["dprint.json"] = 314,
    ["drone.json"] = 315,
    ["dss-2.0.0.json"] = 317,
    ["dstack configuration"] = 318,
    ["dtool dataset metadata"] = 1140,
    ["dvc.yaml"] = 319,
    ["ecosystem.json"] = 324,
    eksctl = 326,
    ["electron-builder configuration file"] = 332,
    ["epr-manifest.json"] = 331,
    ["evcc.yaml"] = 333,
    ["ezd task runner"] = 343,
    ["fabric.mod.json"] = 345,
    ["first-timers-bot"] = 352,
    ["flagd flag configuration"] = 110,
    ["fly.io Configuration"] = 111,
    fulibWorkflows = 982,
    ["function.json"] = 364,
    ["gRPC API Gateway & OpenAPI Config"] = 12,
    ["gematik health care insurance list"] = 1151,
    ["gematik health care patient list"] = 1148,
    ["gematik health care provider institution list"] = 1150,
    ["gematik health care provider list"] = 1149,
    ["gematik tiger test environment configuration"] = 1152,
    ["git-town.toml"] = 1197,
    ["gitlab-ci"] = 382,
    ["global.json"] = 398,
    ["go-feature-flag Flag Configuration"] = 401,
    ["haxelib.json"] = 419,
    helmfile = 938,
    helmwave = 939,
    ["host-meta.json"] = 426,
    ...
    ["ide.host.json"] = 434,
    ["ifstate.yaml"] = 435,
    ["imageoptimizer.json"] = 436,
    ["importmap.json"] = 439,
    instant_python_config = 441,
    instant_python_custom_project = 442,
    ["ioBroker Configuration"] = 443,
    ["ioBroker JSON UI"] = 444,
    ["ioBroker Package manifest"] = 445,
    ["ixpect.conf.yaml"] = 446,
    ["ize.toml"] = 1036,
    ["jsconfig.json"] = 471,
    ["jscpd Configuration"] = 1020,
    jsdoc = 934,
    ["k3d.yaml"] = 472,
    ["k9s aliases.yaml"] = 474,
    ["k9s cluster-config.yaml"] = 476,
    ["k9s config.yaml"] = 475,
    ["k9s hotkeys.yaml"] = 477,
    ["k9s plugins.yaml"] = 478,
    ["k9s skin.yaml"] = 479,
    ["k9s views.yaml"] = 480,
    ["kontinuous-config.yaml"] = 491,
    ["kontinuous-values.yaml"] = 490,
    ["kustomization.yaml"] = 493,
    ["label-commenter-config.yml"] = 494,
    ["latexindent configuration"] = 104,
    ["launchsettings.json"] = 495,
    lazydocker = 1058,
    lazygit = 1057,
    ["lego.json"] = 497,
    ["lerna.json"] = 498,
    ["lgtm.yml"] = 499,
    ["liblab.config.json"] = 500,
    ["libman.json"] = 501,
    ["license-report-config.json"] = 502,
    ["linkinator.config.json"] = 504,
    ["lint-staged (.lintstagedrc)"] = 912,
    ["local.settings.json"] = 509,
    ["localazy.json"] = 510,
    ["lotus.yaml"] = 508,
    ["lsdlschema.json"] = 511,
    ["macro.json"] = 1024,
    ["markdown-link-check"] = 978,
    maturin = 979,
    mboats = 986,
    ["micro-settings.json"] = 1051,
    ["mimetypes.json"] = 525,
    ["mirrord config"] = 914,
    mise = 915,
    ["mkdocs.yml"] = 545,
    ["monospace.yml"] = 548,
    ["moon.yml"] = 1134,
    ["mprocs Configuration file"] = 1105,
    ["mrdocs.yml"] = 546,
    ["mta.yaml"] = 916,
    ["mtad.yaml"] = 917,
    ["mycode.json"] = 555,
    nFPM = 562,
    ["napari plugin manifest"] = 556,
    neoload = 929,
    ["nest-cli"] = 565,
    ["ninjs (News in JSON)"] = 564,
    ["nitro.json"] = 928,
    ["nixd configuration"] = 1077,
    ["nlu.json"] = 566,
    ["nodemon.json"] = 568,
    ["noodl config"] = 985,
    ["notebook.mod.json"] = 569,
    now = 924,
    ["npm-badges"] = 572,
    ["nswag.json"] = 576,
    ntangle = 578,
    ["nuclei-template.yaml"] = 573,
    ["nuget-project.json"] = 574,
    ["ocelot.json"] = 580,
    ["omnisharp.json"] = 585,
    openHAB = 1210,
    ["openapi.json"] = 587,
    ...
    ["overlay.json"] = 588,
    ["package.json"] = 618,
    ["package.manifest"] = 620,
    ["package.yaml"] = 619,
    ["partial-black.json"] = 136,
    ["pathfinder.yml"] = 623,
    ["pattern.json"] = 626,
    ["petstore-v1.0"] = 1031,
    pgap_yaml_input_reader = 625,
    pgxgen = 1213,
    pitcms = 1216,
    ["pixi.toml"] = 627,
    ["plagiarize-me.yaml"] = 631,
    ["plagiarize.yaml"] = 630,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1141,
    ["podbard.yaml"] = 633,
    ["portman.json"] = 636,
    ["prefect.toml"] = 644,
    ["prefect.yaml"] = 645,
    ...
    ["prettierrc.json"] = 647,
    ["prisma.yml"] = 648,
    ["project-1.0.0-beta3.json"] = 660,
    ["project-1.0.0-beta4.json"] = 661,
    ["project-1.0.0-beta5.json"] = 662,
    ["project-1.0.0-beta6.json"] = 663,
    ["project-1.0.0-beta8.json"] = 664,
    ["project-1.0.0-rc1.json"] = 665,
    ["project-1.0.0-rc2.json"] = 666,
    ["project.json"] = 659,
    ["project.owasp.yaml"] = 667,
    ["prometheus-alertmanager.json"] = 671,
    ["prometheus.json"] = 668,
    ["prometheus.rules.json"] = 669,
    ["prometheus.rules.test.json"] = 670,
    ["proxies.json"] = 672,
    ["publiccode.yml"] = 673,
    ["pubspec.yaml"] = 674,
    ["pyrseas-0.8.json"] = 677,
    pytest = 686,
    ["quilt.mod.json"] = 1052,
    ["rc3 auth"] = 692,
    ["rc3 collection"] = 693,
    ...
    ["release drafter"] = 930,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 702,
    ["release-please-manifest.json"] = 703,
    ["release-plz.toml"] = 704,
    ["renv.lock"] = 716,
    ["rivet.json"] = 1076,
    ["rivet.yaml (legacy)"] = 1075,
    rumdl = 721,
    runny = 720,
    rustfmt = 722,
    sake = 1168,
    samt = 724,
    samtrc = 725,
    ["sarif-1.0.0.json"] = 727,
    ["sarif-2.0.0.json"] = 728,
    ["sarif-2.1.0"] = 738,
    ["sarif-2.1.0-rtm.2"] = 729,
    ["sarif-2.1.0-rtm.3"] = 731,
    ["sarif-2.1.0-rtm.4"] = 733,
    ["sarif-2.1.0-rtm.5"] = 735,
    ["sarif-2.1.0-rtm.6"] = 736,
    ["sarif-external-property-file-2.1.0"] = 739,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 730,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 732,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 734,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 737,
    ["scalingo.json configuration"] = 740,
    ["schema.org - Action"] = 742,
    ["schema.org - ContactPoint"] = 743,
    ["schema.org - Place"] = 744,
    ["schema.org - Thing"] = 745,
    ["secrethub.yml"] = 1054,
    ["semantic-release"] = 751,
    ["servicehub.config.json"] = 907,
    ["servicehub.service.json"] = 906,
    ["settings.job"] = 754,
    ["sfdx-hardis configuration"] = 756,
    ["shard.yml"] = 1092,
    ["size-limit configuration"] = 761,
    ["skaffold.yaml"] = 976,
    ["skyuxconfig.json"] = 763,
    ["snowflake-config"] = 765,
    ["snowflake-connections"] = 766,
    ["spicepod.yaml"] = 1113,
    ["sqlc configuration"] = 798,
    ["stripe-app-local.json"] = 809,
    ["stripe-app.json"] = 808,
    swcrc = 961,
    ["task.json"] = 818,
    taskcat = 925,
    ["template.json"] = 823,
    ["templatsources.json"] = 824,
    ["theme.json"] = 827,
    ["tizen_workspace.json"] = 829,
    tldr = 830,
    ["tm_devices configuration file"] = 1179,
    tmuxinator = 910,
    ["transcend.yml"] = 840,
    ["tree-sitter grammar.json"] = 406,
    ["trime.yaml"] = 841,
    ["trunk.yaml"] = 843,
    ["ts-force-config.json"] = 848,
    ["tsconfig.json"] = 844,
    ["tsd.json"] = 845,
    ["tsdoc.json"] = 846,
    ["tsdrc.json"] = 847,
    ...
    ["vega-lite.json"] = 871,
    ["vega.json"] = 870,
    ["venvironment.yaml"] = 873,
    ["venvplus.yaml"] = 874,
    version = 1161,
    ["version.json"] = 876,
    ["vhwdebugger-binding.yaml"] = 878,
    ["vim-addon-info"] = 879,
    ["vs-2017.3.host.json"] = 881,
    ["vs-nesting.json"] = 882,
    ["vsls.json"] = 880,
    ["vss-extension.json"] = 886,
    vtcfg = 1167,
    ["vtesttree.yaml"] = 887,
    ["vtestunit.yaml"] = 888,
    ["warp-keysets.json"] = 1060,
    ["warp-themes.json"] = 1061,
    ["warp-workflows.json"] = 1062,
    ["webhint.io"] = 1016,
    ["webjobpublishsettings.json"] = 893,
    ["webjobs-list.json"] = 892,
    ["well-known-fursona"] = 1100,
    ["xs-app.json"] = 920,
    ["xunit.runner.json"] = 905,
    yamllint = 948,
    zizmor = 1204,
    zuul = 931,
    ["Žinoma"] = 941
