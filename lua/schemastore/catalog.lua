...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 921,
    [".nodehawkrc"] = 568,
    [".npmpackagejsonlintrc"] = 572,
    [".omletrc"] = 1100,
    [".phrase.yml"] = 643,
    [".phraseapp.yml"] = 644,
    [".pmbot.yml"] = 629,
    [".postcssrc"] = 638,
    [".powerpages-web-template-manifest"] = 640,
    [".pre-commit-config.yml"] = 641,
    [".pre-commit-hooks.yml"] = 642,
    [".putout.json"] = 677,
    [".rehyperc"] = 702,
    [".remarkrc"] = 706,
    [".sprite files"] = 797,
    ...
    AIConfig = 31,
    ["AMX Muse Program Descriptor"] = 1148,
    ["API Builder"] = 956,
    ["AVA Configuration"] = 1019,
    ...
    ["AWS Copilot Manifest"] = 1187,
    ["AWS SAM CLI Samconfig"] = 255,
    ["Adobe UXP Manifest"] = 1082,
    ["Aerleon Network & Service Definitions"] = 18,
    ["Aerleon Policy"] = 19,
    Aider = 1177,
    Air = 21,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1198,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1197,
    ["Airlock Microgateway"] = 32,
    ["Alacritty Configuration"] = 991,
    ["All Contributors configuration file"] = 1045,
    ["Ansible Argument Specs"] = 389,
    ["Ansible Collection Galaxy"] = 396,
    ["Ansible Execution Environment"] = 386,
    ["Ansible Inventory"] = 395,
    ["Ansible Meta"] = 387,
    ["Ansible Meta Runtime"] = 388,
    ["Ansible Navigator Configuration"] = 398,
    ["Ansible Playbook"] = 393,
    ["Ansible Requirements"] = 390,
    ["Ansible Rulebook"] = 394,
    ["Ansible Tasks File"] = 392,
    ["Ansible Vars File"] = 391,
    ["Ansible-lint Configuration"] = 397,
    Any = 1110,
    ...
    ["Application list for a WinUtil"] = 1127,
    ArchitectFX = 1132,
    ["Argo CD"] = 51,
    ["Argo Events"] = 52,
    ["Argo Workflows"] = 53,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1196,
    ["Azure IoT Operations connector metadata"] = 1193,
    ...
    ["Azure Pipelines"] = 107,
    ["Azure Static Web Apps CLI configuration file"] = 801,
    ["Azure Static Web Apps configuration file"] = 800,
    BMML = 1215,
    ["BOSH CPI Config"] = 132,
    ["BOSH Deploy Config"] = 133,
    ["BX CI"] = 152,
    ["Bacon config"] = 3,
    ["Bashly (bashly.yml)"] = 1049,
    ["Bashly Settings (bashly-settings.yml)"] = 1050,
    Bento = 1214,
    ["Better Code Hub"] = 961,
    ["Better Scripts"] = 153,
    Bigconfig = 125,
    ["Biome Formatter Config"] = 79,
    ["Bitmovin Encoding Template"] = 1141,
    BizTalkServerApplicationSchema = 928,
    Bleep = 154,
    ["Block Protocol Metadata"] = 151,
    ["Bluebricks blueprint config"] = 1220,
    ["Boyka Framework"] = 134,
    Briefcase = 934,
    ["Build Info"] = 142,
    Buildkite = 144,
    ...
    ["Butane Config"] = 1004,
    C4InterFlow = 1156,
    ["CDK Environment Manager, concrete environment configuration"] = 1180,
    ["CDK Environment Manager, concrete environments definition"] = 1179,
    ["CDK Environment Manager, environment definition"] = 1178,
    ["CGS Card Game Specification (cgs.json)"] = 1087,
    ["CICS TS region tagging"] = 1013,
    ["CICS TS resource import"] = 1014,
    ["CICS TS resource model"] = 1015,
    ["CICS TS resource overrides"] = 1016,
    ["CMake Presets"] = 155,
    ["CNC Codes"] = 176,
    ["CRS WAF test file"] = 1117,
    ["CRS WAF test platform overrides file"] = 1118,
    ...
    ["Chamaleon environment"] = 1145,
    ["Chamaleon properties"] = 1146,
    ["Chamaleon template"] = 1144,
    Changepacks = 1207,
    Changesets = 264,
    Changie = 164,
    Charmcraft = 165,
    ...
    ["Clawject config"] = 182,
    ["Cloud Foundry Application Manifest"] = 1099,
    ["Cloud Run Spec v1"] = 1122,
    ...
    Concord = 1116,
    ["Configu .cfgu files"] = 1104,
    ["Configu .configu file"] = 1105,
    Conjure = 175,
    ["Container Structure Test"] = 942,
    Containerlab = 970,
    ["Contextive Glossary"] = 1172,
    Convex = 174,
    ["Crowdsec collection config"] = 274,
    ["Crowdsec parser config"] = 275,
    ["Crowdsec scenario config"] = 276,
    ["CumulusCI Config"] = 181,
    ["Custom Machinery Machine"] = 1088,
    ["Custom Machinery Recipe"] = 1089,
    ...
    ["DataYoga Job"] = 189,
    ["Databricks Asset Bundles"] = 1066,
    ["Datadog Continuous Testing"] = 487,
    ["Datadog Service Definition"] = 488,
    ["Datadog Software Catalog"] = 489,
    ["Datahub Ingestion Recipe"] = 1020,
    ...
    ["DonateCaseBetterCasino menu"] = 1149,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1057,
    ["EAS config"] = 342,
    ["ECA - Editor Code Assistant"] = 326,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1046,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1192,
    ["EasyVCR .NET"] = 343,
    ["Eidolon Resource"] = 1133,
    ...
    ["Erda Pipeline"] = 1095,
    ["Erda Runtime"] = 1096,
    ["Espanso config.yml"] = 1218,
    ["Espanso match.yml"] = 1217,
    Esquio = 331,
    ["Estuary Flow Catalog"] = 1010,
    ...
    ["Evolving Resolutive Process notation"] = 1194,
    ["Expo SDK"] = 341,
    ...
    Firebase = 349,
    ["FlexGet Config"] = 352,
    ["Flow.json Configurations"] = 1092,
    ["Fossa configuration file"] = 359,
    ["Fossa's fossa-deps file"] = 360,
    ["Foundry VTT - Base package Manifest"] = 354,
    ["Foundry VTT - Module Manifest"] = 355,
    ["Foundry VTT - System Data Template"] = 358,
    ["Foundry VTT - System Manifest"] = 356,
    ["Foundry VTT - World Manifest"] = 357,
    ["Foxx Manifest"] = 109,
    ["Freifunk.de Community API"] = 112,
    ["Frogbot Config"] = 113,
    ["G2P Mapping Configuration"] = 366,
    ["GCP Blueprint Metadata"] = 369,
    Gaspar = 367,
    ["GatewayCore API Gateway"] = 368,
    ["Gemini CLI settings"] = 370,
    ["GeoJSON.json latest"] = 1008,
    GherKing = 1012,
    ["GitHub Action"] = 375,
    ["GitHub Actions typing"] = 1129,
    ["GitHub Discussion"] = 376,
    ["GitHub Funding"] = 377,
    ["GitHub Issue Template configuration"] = 378,
    ["GitHub Issue Template forms"] = 379,
    ["GitHub Workflow"] = 380,
    ["GitHub Workflow Template Properties"] = 381,
    ["GitHub automatically generated release notes configuration"] = 382,
    ["GitLab Agent for Kubernetes configuration"] = 1084,
    GitVersion = 372,
    ["Gitea Issue Template configuration"] = 373,
    ["Gitea Issue Template forms"] = 374,
    ["Gitpod Automations"] = 384,
    ["Gitpod Configuration"] = 385,
    ["GlazeWM settings"] = 1086,
    ["Global Privacy Control"] = 371,
    Goblet = 1065,
    ["Golangci-lint Configuration"] = 400,
    ["Golangci-lint Custom Plugins Configuration"] = 401,
    ["Google Chrome Related Website Sets"] = 350,
    ["Google Cloud Workflows"] = 251,
    ["Google Digital Assetlinks"] = 1173,
    Goreleaser = 403,
    ["Goreleaser Pro"] = 404,
    Goss = 405,
    ["Gradle Build Cache Node"] = 959,
    ["Gradle Enterprise"] = 958,
    ["Grafana 5.x Dashboard"] = 406,
    ["GraphQL Code Generator"] = 411,
    ["GraphQL Config"] = 410,
    ["GraphQL Mesh"] = 409,
    ["GroovyLint configuration"] = 412,
    ["Grunt JSHint task"] = 416,
    ["Grunt Watch task"] = 417,
    ["Grunt base task"] = 418,
    ["Grunt clean task"] = 414,
    ["Grunt copy task"] = 413,
    ["Grunt cssmin task"] = 415,
    HEMTT = 924,
    Hadolint = 938,
    Hammerkit = 969,
    ["Hardware Sentry Configuration"] = 1024,
    ["HashiCorp Vault"] = 419,
    Hatch = 939,
    Hayson = 421,
    ["Haystack Pipeline"] = 422,
    ["Hazelcast 5 Configuration"] = 423,
    ["Hecate Input Schema"] = 1184,
    ["Helm Chart.lock"] = 218,
    ["Helm Chart.yaml"] = 217,
    ["Helm Unittest Test Suite"] = 219,
    ["Home Assistant Integration Manifest"] = 424,
    ["Homer dashboard configuration"] = 425,
    Hugo = 1000,
    ["Hugo Theme"] = 999,
    ["Hulak Configuration"] = 432,
    ["Hyperfoil benchmark configuration"] = 431,
    ["IBM Zapp document"] = 433,
    ["IBM zCodeFormatSettings"] = 434,
    ["IMG Catapult PSP"] = 439,
    ["IVMS101 by CODE Protocol"] = 1085,
    Infrahub = 441,
    Istanbul = 1028,
    ["JDownloader2 crawler multi-rules"] = 454,
    ["JDownloader2 crawler single-rules"] = 453,
    ["JFrog Applications Config"] = 455,
    ["JFrog File Spec"] = 456,
    ["JFrog Pipelines YML DSL"] = 1034,
    ["JMeter DSL cli config"] = 457,
    JReleaser = 460,
    ["JSON Document Transform"] = 468,
    ["JSON Feed"] = 469,
    ["JSON Resume"] = 712,
    ["JSON Schema Draft 2020-12"] = 906,
    ["JSON Schema Draft 4"] = 903,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1067,
    ["JSON Schema Draft 7"] = 904,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1068,
    ["JSON Schema Draft 8 (2019-09)"] = 905,
    ["JSON-API"] = 467,
    ["JSON-e templates"] = 966,
    ["JSON-stat 2.0"] = 899,
    JSONPatch = 471,
    ["JSR Package Config (jsr.json)"] = 461,
    Jarl = 1200,
    Jasmine = 448,
    Jekyll = 449,
    ["Jenkins X Pipelines"] = 450,
    ["Jenkins X Requirements"] = 451,
    Jest = 452,
    Jocker = 458,
    ["Jovo Language Models"] = 459,
    ["Jujutsu (jj) VCS config"] = 1186,
    ["KIMMDY config file"] = 482,
    ["KODE/CI build.yaml"] = 1030,
    ["KSP-AVC"] = 900,
    ["KSP-CKAN"] = 901,
    ["KSP-NetKAN"] = 902,
    KSY = 1097,
    KSail = 364,
    ["KYA Manifest"] = 1098,
    ["Karakum configuration file"] = 361,
    Kas = 474,
    ["Kestra flow file"] = 483,
    ["Keycloak REST API"] = 1037,
    ["Knative Functions - func.yaml"] = 362,
    Knip = 363,
    ["Kometa (nightly) config file"] = 485,
    ["Kometa config file"] = 484,
    ["Kong DBLess config"] = 1031,
    KrakenD = 486,
    ["Kubri Configuration"] = 493,
    LOOBin = 508,
    ["Lake configuration file"] = 1189,
    ...
    ["Lando (landofile)"] = 103,
    ["LangGraph Platform configuration"] = 1109,
    ["Language configuration"] = 1108,
    Lefthook = 497,
    ["Liferay client-extension.yaml"] = 504,
    ["LinkML Metamodel"] = 506,
    Liquibase = 975,
    ["Liquibase Flow File"] = 976,
    ["Lively Properties"] = 507,
    ["Lobe AI Agent"] = 105,
    Loki = 106,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 548,
    ["MS2Rescore Configuration"] = 551,
    ["Madness (madness.yml)"] = 1048,
    ["Mado configuration"] = 514,
    ["Mail Servers Configuration"] = 1221,
    ["MapEHR Mapping"] = 515,
    Markdownlint = 979,
    ["Mason Registry"] = 982,
    ["MegaLinter Custom Flavor"] = 518,
    ["MegaLinter configuration"] = 517,
    ["MegaLinter descriptor"] = 519,
    Melange = 1075,
    ["Meltano project definition"] = 520,
    ["Mergify Configuration"] = 552,
    ["Metadata for a Bazel module"] = 521,
    ["Metadata for a Cinnamon spice"] = 1125,
    ["Metatype Configuration"] = 522,
    ["MetricsHub Configuration"] = 523,
    ["MetricsHub Connector Configuration"] = 524,
    ["Micro Editor Syntax"] = 1058,
    ["Microsoft Band Web Tile"] = 525,
    ["Microsoft RulesEngine workflow rules"] = 1113,
    ["Microsoft RulesEngine workflow rules list"] = 1114,
    ["Minecraft Custom Main Menu Mod"] = 1076,
    ["Minecraft Data Pack Advancement"] = 527,
    ["Minecraft Data Pack Biome"] = 528,
    ["Minecraft Data Pack Configured Carver"] = 529,
    ["Minecraft Data Pack Damage Type"] = 530,
    ["Minecraft Data Pack Dimension"] = 532,
    ["Minecraft Data Pack Dimension Type"] = 531,
    ["Minecraft Data Pack Item Modifier"] = 533,
    ["Minecraft Data Pack Loot Table"] = 534,
    ["Minecraft Data Pack Metadata"] = 535,
    ["Minecraft Data Pack Predicate"] = 536,
    ["Minecraft Data Pack Recipe"] = 537,
    ["Minecraft Data Pack Tag"] = 538,
    ["Minecraft Data Pack Template Pool"] = 539,
    ["Minecraft Data Pack Trim Material"] = 544,
    ["Minecraft Data Pack Trim Pattern"] = 545,
    ["Minecraft Resource Pack Lang"] = 540,
    ["Minecraft Resource Pack Particle"] = 541,
    ["Minecraft Resource Pack Texture Mcmeta"] = 543,
    ["Minecraft Resourcepack Sounds"] = 542,
    ["Monade CLI Stack Configuration"] = 555,
    ["MongoDB Atlas Search Index Definition"] = 1029,
    ["Monika Configuration"] = 1027,
    ["Monoweave Configuration"] = 550,
    ["Motif config"] = 920,
    MultiQC = 1166,
    ["NOX Framework (Service)"] = 571,
    ["Netin Diagnostic System Template"] = 986,
    ["Netlify config"] = 558,
    ["Network-as-Code Data Model"] = 559,
    ["Next Gen UI Agent A2A Server Configuration"] = 560,
    ["Next Gen UI Agent Configuration"] = 562,
    ["Next Gen UI Agent MCP Server Configuration"] = 561,
    ["Nightwatch.js"] = 564,
    ["Node.js configuration"] = 925,
    ["NueJS configuration file"] = 576,
    ["Nuitka.yaml"] = 1090,
    ["Nullstone config"] = 578,
    ["ONe's changelog entry"] = 596,
    ["ONe's service descriptor"] = 595,
    ["ORT Server repository environment configuration"] = 605,
    ["OSCAL Assessment Plan (AP)"] = 607,
    ["OSCAL Assessment Results (AR)"] = 608,
    ["OSCAL Catalog"] = 609,
    ["OSCAL Component Definition (CDef)"] = 610,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 611,
    ["OSCAL Profile"] = 612,
    ["OSCAL System Security Plan (SSP)"] = 613,
    ["OSS Review Toolkit configuration"] = 614,
    ["OSS Review Toolkit curation"] = 615,
    ["OSS Review Toolkit package configuration"] = 616,
    ["OSS Review Toolkit repository configuration"] = 617,
    ["OSS Review Toolkit resolutions"] = 618,
    ["October CMS columns"] = 582,
    ["October CMS fields"] = 583,
    ["Oh My Posh"] = 584,
    Okteto = 585,
    ["Ona Automations"] = 587,
    Opctl = 923,
    ["Open Data Contract Standard (ODCS)"] = 599,
    ["Open Data Product Standard (ODPS)"] = 600,
    ["Open Know-How"] = 1171,
    ["OpenRewrite Resource"] = 598,
    OpenSRM = 601,
    OpenStatus = 1182,
    ["OpenUtau character yaml"] = 592,
    ["OpenUtau ustx"] = 593,
    ["OpenWeather Current Weather API"] = 965,
    ["OpenWeather Road Risk API"] = 964,
    ["Ory Hydra configuration"] = 430,
    ["Ory Keto configuration"] = 490,
    ["Ory Kratos configuration"] = 606,
    ["Ory Oathkeeper configuration"] = 580,
    ["Outblocks App configuration"] = 603,
    ["Outblocks database table"] = 604,
    ["Outblocks project configuration"] = 602,
    PDM = 625,
    POPxf = 635,
    ["POPxf Correlations"] = 636,
    Packer = 622,
    Pantsbuild = 1044,
    ["Paper paper-plugin.yml"] = 623,
    ["Pipeline component"] = 977,
    ["Platform.sh application"] = 5,
    ["Platform.sh routes"] = 6,
    ["Platform.sh services"] = 7,
    ["Plex Prerolls"] = 633,
    ["PocketMine plugin.yml"] = 630,
    ["Postman collection"] = 639,
    ["Power Pages Configuration"] = 1183,
    ["Preset list for a WinUtil"] = 1128,
    ["ProActions AI-Kit Configuration"] = 650,
    ["ProActions AI-Kit Configuration for Menus"] = 652,
    ["ProActions AI-Kit Configuration for Sections"] = 654,
    ["ProActions AI-Kit Configuration for Services"] = 651,
    ["ProActions AI-Kit Configuration for Steps"] = 655,
    ["ProActions AI-Kit Configuration for Templates"] = 653,
    ["Problem object RFC9457"] = 1073,
    ["Problem package format"] = 656,
    ["Problem package generators"] = 657,
    ["Problem package submissions"] = 658,
    ["Problem package test group metadata"] = 659,
    Pterodactyl = 1023,
    ["Pull Request Labeler"] = 676,
    Pulumi = 684,
    ["PyGTA Config"] = 680,
    PyProject = 685,
    Pylock = 1174,
    Pyright = 686,
    ["Python script metadata"] = 1168,
    ["QType AI DSL"] = 689,
    Qgoda = 688,
    Qodana = 996,
    ["Qt Creator workspace file"] = 1106,
    ["Quali Torque Blueprint Spec 2"] = 1021,
    ["QueryFirst config file"] = 1040,
    ["RKE Cluster Configuration JSON"] = 974,
    ["RKE Cluster Configuration YAML"] = 973,
    RadioHound = 679,
    Railpack = 691,
    Railway = 690,
    ["Rancher Fleet"] = 681,
    ...
    Ray = 937,
    ["Read the Docs"] = 683,
    ["Red-DiscordBot Cog"] = 699,
    ["Red-DiscordBot Cog Repo"] = 700,
    ["Red-DiscordBot Trivia"] = 701,
    ["Releasaurus Config"] = 2,
    ["Render Blueprints"] = 972,
    RenderCV = 716,
    Renovate = 713,
    ["Renovate global configuration"] = 714,
    ["Renovate inherited configuration"] = 715,
    ["Replit config"] = 707,
    Restate = 1161,
    ["Revel Digital Gadget Definition File"] = 1185,
    RoadRunner = 718,
    ["Robust Station Image"] = 1191,
    Rockcraft = 719,
    ["Roo Coder Custom Modes"] = 720,
    Rubocop = 709,
    ["Rudder techniques"] = 1080,
    Ruff = 710,
    ["Rust Project"] = 711,
    ["Rust toolchain"] = 724,
    ["SDMX data message"] = 750,
    ["SDMX metadata message"] = 749,
    ["SDMX structure message"] = 748,
    ["SIL Kit Participant Configuration"] = 760,
    ["SIL Kit Registry Configuration"] = 761,
    ["SPDX 2.3"] = 798,
    SWADL = 814,
    ["Safebox Config"] = 1035,
    ["Sapphire CLI Config"] = 727,
    ["SauceCTL Configuration"] = 983,
    ["Schema Catalog"] = 742,
    ["Scoop manifest"] = 747,
    ["Semantic Data Fabric (SDF) file"] = 751,
    ["Semgrep Rule"] = 753,
    ["Serenity Code Generator (Sergen)"] = 754,
    ["Serverless Framework Configuration"] = 990,
    ["Serverless Workflow"] = 992,
    ["Settings for a Cinnamon spice"] = 1124,
    ["Settings.paf"] = 756,
    ["Shopware 6 Configuration"] = 993,
    ["Shopware CLI Extension Store Configuration"] = 994,
    ["Shopware CLI Project Store Configuration"] = 995,
    ["Sigma Detection Rule"] = 758,
    ["Sigrid scope configuration file"] = 759,
    ["SkyPilot Task JSON"] = 1081,
    ["Slack app manifest"] = 763,
    Snapcraft = 765,
    Solidarity = 768,
    ["Solution filters"] = 769,
    ["Source Maps v3"] = 770,
    Sourcery = 771,
    ["Spack bootstrap.yaml"] = 772,
    ["Spack cdash.yaml"] = 773,
    ["Spack ci.yaml"] = 774,
    ["Spack compilers.yaml"] = 775,
    ["Spack concretizer.yaml"] = 776,
    ["Spack config.yaml"] = 777,
    ["Spack definitions.yaml"] = 778,
    ["Spack develop.yaml"] = 779,
    ["Spack env_vars.yaml"] = 780,
    ["Spack environment"] = 786,
    ["Spack include.yaml"] = 781,
    ["Spack mirrors.yaml"] = 782,
    ["Spack modules.yaml"] = 783,
    ["Spack packages.yaml"] = 784,
    ["Spack repos.yaml"] = 785,
    ["Spack toolchains.yaml"] = 787,
    ["Spack upstreams.yaml"] = 788,
    ["Spack view.yaml"] = 789,
    ["Speakeasy Generation Config File"] = 793,
    ["Speakeasy Lint Configuration File"] = 790,
    ["Speakeasy Test Generation Configuration File"] = 791,
    ["Speakeasy Workflow File"] = 792,
    SpecIF = 794,
    ["Specmatic Configuration"] = 795,
    ["Sponge Mixin configuration"] = 796,
    StackBlitz = 802,
    ["StackHawk Scanner Configuration"] = 989,
    Stale = 803,
    Starfish = 804,
    ["Starlake Data Pipeline"] = 962,
    Starship = 805,
    ["Statamic Blueprint"] = 806,
    ["Stella configuration file"] = 807,
    ["Streamlit configuration file"] = 808,
    ["Stryker Mutator"] = 811,
    ["StyleCop Analyzers Configuration"] = 812,
    ["Stylelint (.stylelintrc)"] = 813,
    ["Stylua Config"] = 1175,
    ["Sublime Syntax"] = 1036,
    ["Subsquid squid manifest"] = 1083,
    ["Swagger API 2.0"] = 815,
    ["Synadia Connect Component"] = 816,
    TSON = 852,
    TSTyche = 853,
    ["TYPO3 Vendor Bundler config"] = 858,
    ["Tab data for a LinUtil"] = 1131,
    ["Tab list for a LinUtil"] = 1130,
    Tach = 817,
    ["Tach Domain"] = 818,
    Talhelper = 820,
    ["Talisman configuration"] = 821,
    Taplo = 1176,
    ["Taskfile config"] = 967,
    Taurus = 822,
    Tauticord = 823,
    ["Tekton Pipeline"] = 1204,
    ["Tekton PipelineRun"] = 1205,
    ["Tekton Task"] = 1202,
    ["Tekton TaskRun"] = 1203,
    Telefonistka = 1162,
    ["Terrateam config"] = 1188,
    ["TestEnvironment.json"] = 835,
    ["TextMate Grammar"] = 834,
    Threagile = 829,
    ["Tier.run pricing.json"] = 826,
    Tikibase = 827,
    Tombi = 832,
    ["Traefik v2"] = 838,
    ["Traefik v2 File Provider"] = 839,
    ["Traefik v3"] = 840,
    ["Traefik v3 File Provider"] = 841,
    ["Travis CI (.travis.yml)"] = 837,
    Treefmt = 408,
    Trident = 1158,
    ["TrueScript for *.tscript files"] = 844,
    ["Tugboat QA config.yml"] = 1155,
    TunnelHub = 1071,
    Turborepo = 836,
    Tycho = 1120,
    Tye = 997,
    ["Tyk Gateway - Open Source v5.7+"] = 1167,
    ["UET BuildConfig.json"] = 1041,
    ["UI5 Manifest"] = 864,
    ["UNCORS configuration"] = 868,
    ["UTAM Page Object"] = 867,
    ["Ubuntu Server Autoinstall"] = 862,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1159,
    ["Uniswap Token List"] = 949,
    ["Universal Schedule Format"] = 869,
    ["Unreal Engine Uplugin"] = 1042,
    ["Unreal Engine Uproject"] = 1043,
    ["UpCloud CLI (upctl) configuration"] = 1160,
    ["Updatecli Compose"] = 1005,
    ["Updatecli Policy Manifest"] = 1006,
    ["Updatecli Policy Metadata"] = 1007,
    Uplift = 1039,
    ["Upsun config"] = 4,
    ["User Journey Map"] = 971,
    V2Ray = 1011,
    ["VSCode Code Snippets"] = 239,
    ["VSIX CLI publishing"] = 887,
    Vector = 871,
    ["Vela Pipeline Configuration"] = 874,
    Vercel = 238,
    ["Version Bumper config"] = 877,
    Vespertide = 1209,
    ["Vespertide Migration"] = 1210,
    ["Vespertide Model"] = 1211,
    ["Viash Component Config"] = 1164,
    ["Viash Package Config"] = 1165,
    Visivo = 1069,
    ["WP-CLI"] = 897,
    Wake = 1157,
    ["Waku Config"] = 1134,
    ["Web App Manifest"] = 893,
    ["Web types"] = 896,
    WebExtensions = 892,
    ["Webman package recipe"] = 1017,
    ["Windows Package Manager Installer Manifest"] = 945,
    ["Windows Package Manager Locale Manifest"] = 946,
    ["Windows Package Manager Singleton Manifest"] = 944,
    Winutil = 947,
    ["WireMock CLI import configuration"] = 1140,
    ["WireMock CLI local service configuration"] = 1139,
    ["WireMock message stub mapping"] = 1138,
    ["WireMock stub mapping"] = 1137,
    ["Woodpecker pipeline config"] = 985,
    ["Wrangler CLI"] = 898,
    ["Xstate Machine"] = 1003,
    ["Yandex Workflow Language"] = 1126,
    ["Yarn Config (.yarnrc.yml)"] = 960,
    ["Yippee-Ki-JSON configuration YML"] = 951,
    ["YouTrack App"] = 1123,
    ["Zarf Package Configuration"] = 1190,
    ["Zerops.io config"] = 1111,
    ["Zerops.io import"] = 1112,
    ["Zola Configuration"] = 1201,
    ["aerleon.yml"] = 17,
    ["amplify.yml"] = 10,
    ["angular.json"] = 33,
    apko = 1074,
    ...
    ["behat.yml"] = 135,
    ["bigquery-table"] = 124,
    ["bioimageio resource description"] = 1091,
    ...
    ["chutzpah.json"] = 247,
    cibuildwheel = 170,
    ["clang-format (.clang-format)"] = 1009,
    ["clang-tidy"] = 225,
    clangd = 224,
    clib = 226,
    ...
    ["crowdin.yml"] = 273,
    ["ctfd-setup configuration file"] = 1147,
    ["custom-elements.json"] = 1061,
    ["cypress.json"] = 277,
    ...
    ["ezd task runner"] = 344,
    ["fabric.mod.json"] = 346,
    ["first-timers-bot"] = 353,
    ["flagd flag configuration"] = 110,
    ["fly.io Configuration"] = 111,
    fulibWorkflows = 984,
    ["function.json"] = 365,
    ["gRPC API Gateway & OpenAPI Config"] = 12,
    ["gematik health care insurance list"] = 1153,
    ["gematik health care patient list"] = 1150,
    ["gematik health care provider institution list"] = 1152,
    ["gematik health care provider list"] = 1151,
    ["gematik tiger test environment configuration"] = 1154,
    ["git-town.toml"] = 1199,
    ["gitlab-ci"] = 383,
    ["global.json"] = 399,
    ["go-feature-flag Flag Configuration"] = 402,
    ["haxelib.json"] = 420,
    helmfile = 940,
    helmwave = 941,
    ["host-meta.json"] = 427,
    ...
    ["ide.host.json"] = 435,
    ["ifstate.yaml"] = 436,
    ["imageoptimizer.json"] = 437,
    ["importmap.json"] = 440,
    instant_python_config = 442,
    instant_python_custom_project = 443,
    ["ioBroker Configuration"] = 444,
    ["ioBroker JSON UI"] = 445,
    ["ioBroker Package manifest"] = 446,
    ["ixpect.conf.yaml"] = 447,
    ["ize.toml"] = 1038,
    ["jsconfig.json"] = 472,
    ["jscpd Configuration"] = 1022,
    jsdoc = 936,
    ["k3d.yaml"] = 473,
    ["k9s aliases.yaml"] = 475,
    ["k9s cluster-config.yaml"] = 477,
    ["k9s config.yaml"] = 476,
    ["k9s hotkeys.yaml"] = 478,
    ["k9s plugins.yaml"] = 479,
    ["k9s skin.yaml"] = 480,
    ["k9s views.yaml"] = 481,
    ["kontinuous-config.yaml"] = 492,
    ["kontinuous-values.yaml"] = 491,
    ["kustomization.yaml"] = 494,
    ["label-commenter-config.yml"] = 495,
    ["latexindent configuration"] = 104,
    ["launchsettings.json"] = 496,
    lazydocker = 1060,
    lazygit = 1059,
    ["lego.json"] = 498,
    ["lerna.json"] = 499,
    ["lgtm.yml"] = 500,
    ["liblab.config.json"] = 501,
    ["libman.json"] = 502,
    ["license-report-config.json"] = 503,
    ["linkinator.config.json"] = 505,
    ["lint-staged (.lintstagedrc)"] = 914,
    ["local.settings.json"] = 510,
    ["localazy.json"] = 511,
    ["lotus.yaml"] = 509,
    ["lsdlschema.json"] = 512,
    ["macro.json"] = 1026,
    ["markdown-link-check"] = 980,
    maturin = 981,
    mboats = 988,
    ["micro-settings.json"] = 1053,
    ["mimetypes.json"] = 526,
    ["mirrord config"] = 916,
    mise = 917,
    ["mkdocs.yml"] = 546,
    ["monospace.yml"] = 549,
    ["moon.yml"] = 1136,
    ["mprocs Configuration file"] = 1107,
    ["mrdocs.yml"] = 547,
    ["mta.yaml"] = 918,
    ["mtad.yaml"] = 919,
    ["mycode.json"] = 556,
    nFPM = 563,
    ["napari plugin manifest"] = 557,
    neoload = 931,
    ["nest-cli"] = 566,
    ["ninjs (News in JSON)"] = 565,
    ["nitro.json"] = 930,
    ["nixd configuration"] = 1079,
    ["nlu.json"] = 567,
    ["nodemon.json"] = 569,
    ["noodl config"] = 987,
    ["notebook.mod.json"] = 570,
    now = 926,
    ["npm-badges"] = 573,
    ["nswag.json"] = 577,
    ntangle = 579,
    ["nuclei-template.yaml"] = 574,
    ["nuget-project.json"] = 575,
    ["ocelot.json"] = 581,
    ["omnisharp.json"] = 586,
    openHAB = 1212,
    ["openapi.json"] = 588,
    ...
    ["pattern.json"] = 627,
    ["petstore-v1.0"] = 1033,
    pgap_yaml_input_reader = 626,
    pgxgen = 1216,
    pitcms = 1219,
    ["pixi.toml"] = 628,
    ["plagiarize-me.yaml"] = 632,
    ["plagiarize.yaml"] = 631,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1143,
    ["podbard.yaml"] = 634,
    ["portman.json"] = 637,
    ["prefect.toml"] = 645,
    ["prefect.yaml"] = 646,
    ...
    ["prettierrc.json"] = 648,
    ["prisma.yml"] = 649,
    ["project-1.0.0-beta3.json"] = 661,
    ["project-1.0.0-beta4.json"] = 662,
    ["project-1.0.0-beta5.json"] = 663,
    ["project-1.0.0-beta6.json"] = 664,
    ["project-1.0.0-beta8.json"] = 665,
    ["project-1.0.0-rc1.json"] = 666,
    ["project-1.0.0-rc2.json"] = 667,
    ["project.json"] = 660,
    ["project.owasp.yaml"] = 668,
    ["prometheus-alertmanager.json"] = 672,
    ["prometheus.json"] = 669,
    ["prometheus.rules.json"] = 670,
    ["prometheus.rules.test.json"] = 671,
    ["proxies.json"] = 673,
    ["publiccode.yml"] = 674,
    ["pubspec.yaml"] = 675,
    ["pyrseas-0.8.json"] = 678,
    pytest = 687,
    ["quilt.mod.json"] = 1054,
    ["rc3 auth"] = 693,
    ["rc3 collection"] = 694,
    ...
    ["release drafter"] = 932,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 703,
    ["release-please-manifest.json"] = 704,
    ["release-plz.toml"] = 705,
    ["renv.lock"] = 717,
    ["rivet.json"] = 1078,
    ["rivet.yaml (legacy)"] = 1077,
    rumdl = 722,
    runny = 721,
    rustfmt = 723,
    sake = 1170,
    samt = 725,
    samtrc = 726,
    ["sarif-1.0.0.json"] = 728,
    ["sarif-2.0.0.json"] = 729,
    ["sarif-2.1.0"] = 739,
    ["sarif-2.1.0-rtm.2"] = 730,
    ["sarif-2.1.0-rtm.3"] = 732,
    ["sarif-2.1.0-rtm.4"] = 734,
    ["sarif-2.1.0-rtm.5"] = 736,
    ["sarif-2.1.0-rtm.6"] = 737,
    ["sarif-external-property-file-2.1.0"] = 740,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 731,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 733,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 735,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 738,
    ["scalingo.json configuration"] = 741,
    ["schema.org - Action"] = 743,
    ["schema.org - ContactPoint"] = 744,
    ["schema.org - Place"] = 745,
    ["schema.org - Thing"] = 746,
    ["secrethub.yml"] = 1056,
    ["semantic-release"] = 752,
    ["servicehub.config.json"] = 909,
    ["servicehub.service.json"] = 908,
    ["settings.job"] = 755,
    ["sfdx-hardis configuration"] = 757,
    ["shard.yml"] = 1094,
    ["size-limit configuration"] = 762,
    ["skaffold.yaml"] = 978,
    ["skyuxconfig.json"] = 764,
    ["snowflake-config"] = 766,
    ["snowflake-connections"] = 767,
    ["spicepod.yaml"] = 1115,
    ["sqlc configuration"] = 799,
    ["stripe-app-local.json"] = 810,
    ["stripe-app.json"] = 809,
    swcrc = 963,
    ["task.json"] = 819,
    taskcat = 927,
    ["template.json"] = 824,
    ["templatsources.json"] = 825,
    ["theme.json"] = 828,
    ["tizen_workspace.json"] = 830,
    tldr = 831,
    ["tm_devices configuration file"] = 1181,
    tmuxinator = 912,
    tox = 833,
    ["transcend.yml"] = 842,
    ["tree-sitter grammar.json"] = 407,
    ["trime.yaml"] = 843,
    ["trunk.yaml"] = 845,
    ["ts-force-config.json"] = 850,
    ["tsconfig.json"] = 846,
    ["tsd.json"] = 847,
    ["tsdoc.json"] = 848,
    ["tsdrc.json"] = 849,
    ...
    ["vega-lite.json"] = 873,
    ["vega.json"] = 872,
    ["venvironment.yaml"] = 875,
    ["venvplus.yaml"] = 876,
    version = 1163,
    ["version.json"] = 878,
    ["vhwdebugger-binding.yaml"] = 880,
    ["vim-addon-info"] = 881,
    ["vs-2017.3.host.json"] = 883,
    ["vs-nesting.json"] = 884,
    ["vsls.json"] = 882,
    ["vss-extension.json"] = 888,
    vtcfg = 1169,
    ["vtesttree.yaml"] = 889,
    ["vtestunit.yaml"] = 890,
    ["warp-keysets.json"] = 1062,
    ["warp-themes.json"] = 1063,
    ["warp-workflows.json"] = 1064,
    ["webhint.io"] = 1018,
    ["webjobpublishsettings.json"] = 895,
    ["webjobs-list.json"] = 894,
    ["well-known-fursona"] = 1102,
    ["xs-app.json"] = 922,
    ["xunit.runner.json"] = 907,
    yamllint = 950,
    zizmor = 1206,
    zuul = 933,
    ["Žinoma"] = 943
