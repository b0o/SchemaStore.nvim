...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 15,
    AIConfig = 16,
    ["AMX Muse Program Descriptor"] = 1005,
    ["API Builder"] = 822,
    ["AVA Configuration"] = 884,
    ...
    ["Adobe UXP Manifest"] = 944,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    Air = 12,
    ["Airlock Microgateway"] = 17,
    ["Alacritty Configuration"] = 856,
    ["All Contributors configuration file"] = 909,
    ...
    ["Application list for a WinUtil"] = 987,
    ArchitectFX = 992,
    ["Argo Events"] = 31,
    ["Argo Workflows"] = 32,
    AssemblyScript = 35,
    ...
    ["Azure Pipelines"] = 68,
    ["Azure Static Web Apps CLI configuration file"] = 676,
    ["Azure Static Web Apps configuration file"] = 675,
    ["BOSH Deploy Config"] = 92,
    ["BX CI"] = 110,
    ["Bashly (bashly.yml)"] = 913,
    ["Bashly Settings (bashly-settings.yml)"] = 914,
    ["Better Code Hub"] = 826,
    ["Better Scripts"] = 111,
    Bigconfig = 85,
    ["Biome Formatter Config"] = 55,
    ["Bitmovin Encoding Template"] = 998,
    BizTalkServerApplicationSchema = 794,
    Bleep = 112,
    ...
    ["Butane Config"] = 869,
    C4InterFlow = 1013,
    ["CGS Card Game Specification (cgs.json)"] = 949,
    ["CICS TS region tagging"] = 878,
    ["CICS TS resource import"] = 879,
    ["CICS TS resource model"] = 880,
    ["CICS TS resource overrides"] = 881,
    ["CMake Presets"] = 113,
    ["CNC Codes"] = 129,
    ["CRS WAF test file"] = 977,
    ["CRS WAF test platform overrides file"] = 978,
    ...
    ["Chamaleon environment"] = 1002,
    ["Chamaleon properties"] = 1003,
    ["Chamaleon template"] = 1001,
    Changesets = 212,
    Charmcraft = 122,
    Cheatsheets = 866,
    ...
    CityJSON = 125,
    ["Clawject config"] = 135,
    ["Cloud Foundry Application Manifest"] = 960,
    ["Cloud Run Spec v1"] = 982,
    ...
    Concord = 976,
    ["Configu .cfgu files"] = 965,
    ["Configu .configu file"] = 966,
    Conjure = 128,
    ["Container Structure Test"] = 808,
    Containerlab = 835,
    ["Crowdsec collection config"] = 221,
    ["Crowdsec parser config"] = 222,
    ["Crowdsec scenario config"] = 223,
    ["CumulusCI Config"] = 134,
    ["Custom Machinery Machine"] = 950,
    ["Custom Machinery Recipe"] = 951,
    ...
    ["DonateCaseBetterCasino menu"] = 1006,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 921,
    ["EAS config"] = 287,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 910,
    ["EasyVCR .NET"] = 288,
    ["Eidolon Resource"] = 993,
    ...
    ["GeoJSON.json latest"] = 873,
    GherKing = 877,
    ["GitHub Action"] = 318,
    ["GitHub Actions typing"] = 989,
    ...
    ["Goreleaser Pro"] = 347,
    Goss = 348,
    ["Gradle Build Cache Node"] = 824,
    ["Gradle Enterprise"] = 823,
    ...
    Hadolint = 804,
    Hammerkit = 834,
    ["Hardware Sentry Configuration"] = 889,
    Hatch = 805,
    Hayson = 361,
    ...
    ["JFrog File Spec"] = 390,
    ["JFrog Pipelines YML DSL"] = 898,
    ["JMeter DSL cli config"] = 391,
    JReleaser = 393,
    ["JSON Document Transform"] = 401,
    ["JSON Feed"] = 402,
    ["JSON Resume"] = 610,
    ["JSON Schema Draft 2020-12"] = 774,
    ["JSON Schema Draft 4"] = 771,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 931,
    ["JSON Schema Draft 7"] = 772,
    ["JSON Schema Draft 7 (unofficial strict)"] = 932,
    ["JSON Schema Draft 8 (2019-09)"] = 773,
    ["JSON-API"] = 400,
    ["JSON-e templates"] = 831,
    ["JSON-stat 2.0"] = 767,
    JSONPatch = 404,
    ...
    ["Metadata for a Cinnamon spice"] = 985,
    ["Metatype Configuration"] = 452,
    ["MetricsHub Configuration"] = 453,
    ["MetricsHub Connector Configuration"] = 454,
    ["Micro Editor Syntax"] = 922,
    ["Microsoft Band Web Tile"] = 455,
    ["Microsoft RulesEngine workflow rules"] = 973,
    ["Microsoft RulesEngine workflow rules list"] = 974,
    ["Minecraft Custom Main Menu Mod"] = 939,
    ...
    ["MongoDB Atlas Search Index Definition"] = 893,
    ["Monika Configuration"] = 891,
    ["Monoweave Configuration"] = 480,
    ["Motif config"] = 787,
    MultiQC = 1021,
    ["NOX Framework (Service)"] = 497,
    ["Netin Diagnostic System Template"] = 851,
    ["Netlify config"] = 488,
    ...
    ["OpenUtau ustx"] = 515,
    ["OpenWeather Current Weather API"] = 830,
    ["OpenWeather Road Risk API"] = 829,
    ...
    ["Pipeline component"] = 842,
    ["Plex Prerolls"] = 551,
    ["PocketMine plugin.yml"] = 548,
    ["Postman collection"] = 555,
    ["Preset list for a WinUtil"] = 988,
    ["Problem object RFC9457"] = 936,
    ...
    PyProject = 589,
    Pyright = 590,
    ["Python script metadata"] = 1023,
    Qgoda = 591,
    Qodana = 861,
    ["Qt Creator workspace file"] = 967,
    ["Quali Torque Blueprint Spec 2"] = 886,
    ["QueryFirst config file"] = 904,
    ["RKE Cluster Configuration JSON"] = 839,
    ["RKE Cluster Configuration YAML"] = 838,
    RadioHound = 583,
    Railway = 592,
    ["Rancher Fleet"] = 585,
    ["Rattler-build"] = 593,
    ...
    ["Render Blueprints"] = 837,
    RenderCV = 612,
    Renovate = 611,
    ["Replit config"] = 606,
    Restate = 1016,
    RoadRunner = 614,
    ["Rudder techniques"] = 942,
    Ruff = 608,
    ["Rust Project"] = 609,
    ["Rust toolchain"] = 618,
    ...
    ["SauceCTL Configuration"] = 848,
    ["Schema Catalog"] = 636,
    ["Scoop manifest"] = 641,
    ["Semantic Data Fabric (SDF) file"] = 645,
    ["Semgrep Rule"] = 647,
    ["Serenity Code Generator (Sergen)"] = 648,
    ["Serverless Framework Configuration"] = 855,
    ["Serverless Workflow"] = 857,
    ["Settings for a Cinnamon spice"] = 984,
    ["Settings.paf"] = 650,
    ["Shopware 6 Configuration"] = 858,
    ["Shopware CLI Extension Store Configuration"] = 859,
    ["Shopware CLI Project Store Configuration"] = 860,
    ["Sigma Detection Rule"] = 652,
    ["Sigrid scope configuration file"] = 653,
    ["SkyPilot Task JSON"] = 943,
    ["Slack app manifest"] = 657,
    Solidarity = 662,
    ["Solution filters"] = 663,
    ["Source Maps v3"] = 664,
    Sourcery = 665,
    ["Speakeasy Generation Config File"] = 669,
    ["Speakeasy Lint Configuration File"] = 666,
    ["Speakeasy Test Generation Configuration File"] = 667,
    ["Speakeasy Workflow File"] = 668,
    SpecIF = 670,
    ["Sponge Mixin configuration"] = 671,
    StackBlitz = 677,
    ["StackHawk Scanner Configuration"] = 854,
    Stale = 678,
    ["Starlake Data Pipeline"] = 827,
    Starship = 679,
    ["Statamic Blueprint"] = 680,
    ["Stella configuration file"] = 681,
    ["Stryker Mutator"] = 684,
    ["StyleCop Analyzers Configuration"] = 685,
    ["Stylelint (.stylelintrc)"] = 686,
    ["Sublime Syntax"] = 900,
    ["Subsquid squid manifest"] = 945,
    ["Swagger API 2.0"] = 688,
    ["Synadia Connect Component"] = 689,
    TSON = 723,
    TSTyche = 724,
    ["Tab data for a LinUtil"] = 991,
    ["Tab list for a LinUtil"] = 990,
    Tach = 690,
    ["Tach Domain"] = 691,
    Talhelper = 693,
    ["Talisman configuration"] = 694,
    ["Taskfile config"] = 832,
    Taurus = 695,
    Tauticord = 696,
    Telefonistka = 1017,
    ["TestEnvironment.json"] = 706,
    ["TextMate Grammar"] = 705,
    ["Tier.run pricing.json"] = 699,
    Tikibase = 700,
    Tombi = 704,
    ["Traefik v2"] = 709,
    ["Traefik v2 File Provider"] = 710,
    ["Traefik v3"] = 711,
    ["Traefik v3 File Provider"] = 712,
    ["Travis CI (.travis.yml)"] = 708,
    Trident = 1015,
    ["TrueScript for *.tscript files"] = 715,
    ["Tugboat QA config.yml"] = 1012,
    TunnelHub = 935,
    Turborepo = 707,
    Tycho = 980,
    Tye = 862,
    ["Tyk Gateway - Open Source v5.7+"] = 1022,
    ["UET BuildConfig.json"] = 905,
    ["UI5 Manifest"] = 733,
    ["UNCORS configuration"] = 737,
    ["UTAM Page Object"] = 736,
    ["Ubuntu Server Autoinstall"] = 731,
    ["Uniswap Token List"] = 815,
    ["Universal Schedule Format"] = 738,
    ["Unreal Engine Uplugin"] = 906,
    ["Unreal Engine Uproject"] = 907,
    ["Updatecli Compose"] = 870,
    ["Updatecli Policy Manifest"] = 871,
    ["Updatecli Policy Metadata"] = 872,
    Uplift = 903,
    ["User Journey Map"] = 836,
    V2Ray = 876,
    ["VSCode Code Snippets"] = 187,
    ["VSIX CLI publishing"] = 756,
    Vector = 740,
    ["Vela Pipeline Configuration"] = 743,
    Vercel = 186,
    ["Version Bumper config"] = 746,
    ["Viash Component Config"] = 1019,
    ["Viash Package Config"] = 1020,
    Visivo = 933,
    Wake = 1014,
    ["Waku Config"] = 994,
    ["Web App Manifest"] = 762,
    ["Web types"] = 765,
    WebExtensions = 761,
    ["Webman package recipe"] = 882,
    ["Windows Package Manager Installer Manifest"] = 811,
    ["Windows Package Manager Locale Manifest"] = 812,
    ["Windows Package Manager Singleton Manifest"] = 810,
    Winutil = 813,
    ["WireMock stub mapping"] = 997,
    ["Woodpecker pipeline config"] = 850,
    ["Wrangler CLI"] = 766,
    ["Xstate Machine"] = 868,
    ["Yandex Workflow Language"] = 986,
    ["Yarn Config (.yarnrc.yml)"] = 825,
    ["Yippee-Ki-JSON configuration YML"] = 817,
    ["YouTrack App"] = 983,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 18,
    apko = 937,
    ...
    ["behat.yml"] = 94,
    ["bigquery-table"] = 84,
    ["bioimageio resource description"] = 953,
    ...
    ["crowdin.yml"] = 220,
    ["ctfd-setup configuration file"] = 1004,
    ["custom-elements.json"] = 925,
    ["cypress.json"] = 224,
    ...
    ["gematik health care insurance list"] = 1010,
    ["gematik health care patient list"] = 1007,
    ["gematik health care provider institution list"] = 1009,
    ["gematik health care provider list"] = 1008,
    ["gematik tiger test environment configuration"] = 1011,
    ["gitlab-ci"] = 326,
    ["global.json"] = 342,
    ...
    ["lint-staged (.lintstagedrc)"] = 782,
    ["local.settings.json"] = 442,
    ["localazy.json"] = 443,
    ["lotus.yaml"] = 441,
    ["lsdlschema.json"] = 444,
    ["markdown-link-check"] = 845,
    maturin = 846,
    mboats = 853,
    ["micro-settings.json"] = 917,
    ["mimetypes.json"] = 456,
    ["mirrord config"] = 783,
    mise = 784,
    ["mkdocs.yml"] = 476,
    ...
    ["plagiarize.yaml"] = 549,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1000,
    ["podbard.yaml"] = 552,
    ["portman.json"] = 553,
    ["prefect.toml"] = 561,
    ["prettierrc.json"] = 562,
    ...
    ["servicehub.config.json"] = 777,
    ["servicehub.service.json"] = 776,
    ["settings.job"] = 649,
    ...
    snapcraft = 659,
    ["snowflake-config"] = 660,
    ["snowflake-connections"] = 661,
    ["spicepod.yaml"] = 975,
    ["sqlc configuration"] = 674,
    ["stripe-app-local.json"] = 683,
    ["stripe-app.json"] = 682,
    swcrc = 828,
    ["task.json"] = 692,
    taskcat = 793,
    ["template.json"] = 697,
    ["templatsources.json"] = 698,
    ["theme.json"] = 701,
    ["tizen_workspace.json"] = 702,
    tldr = 703,
    tmuxinator = 780,
    ["transcend.yml"] = 713,
    ...
    ["vega-lite.json"] = 742,
    ["vega.json"] = 741,
    ["venvironment-basic.yaml"] = 745,
    ["venvironment.yaml"] = 744,
    version = 1018,
    ["version.json"] = 747,
    ["vhwdebugger-binding.yaml"] = 749,
    ["vim-addon-info"] = 750,
    ["vs-2017.3.host.json"] = 752,
    ["vs-nesting.json"] = 753,
    ["vsls.json"] = 751,
    ["vss-extension.json"] = 757,
    vtcfg = 1024,
    ["vtesttree.yaml"] = 758,
    ["vtestunit.yaml"] = 759,
    ["warp-keysets.json"] = 926,
    ["warp-themes.json"] = 927,
    ["warp-workflows.json"] = 928,
    ["webhint.io"] = 883,
    ["webjobpublishsettings.json"] = 764,
    ["webjobs-list.json"] = 763,
    ["well-known-fursona"] = 963,
    ["xs-app.json"] = 789,
    ["xunit.runner.json"] = 775,
    yamllint = 816,
    ["zerops.io import file"] = 972,
    ["zerops.yml"] = 971,
    zuul = 799,
    ["Žinoma"] = 809
  },
