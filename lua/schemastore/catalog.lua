...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 145,
    [".cryproj (generic)"] = 489,
    [".cryproj engine-5.2"] = 484,
    [".cryproj engine-5.3"] = 485,
    [".cryproj engine-5.4"] = 486,
    [".cryproj engine-5.5"] = 487,
    [".cryproj engine-dev"] = 488,
    [".csscomb.json"] = 147,
    [".csslintrc"] = 148,
    [".eslintrc"] = 193,
    [".esmrc.json"] = 185,
    ...
    [".mtaext"] = 498,
    [".nodehawkrc"] = 309,
    [".npmpackagejsonlintrc"] = 311,
    [".phraseapp.yml"] = 345,
    [".pmbot.yml"] = 337,
    [".postcssrc"] = 342,
    [".pre-commit-config.yml"] = 343,
    [".pre-commit-hooks.yml"] = 344,
    [".putout.json"] = 362,
    [".rehyperc"] = 369,
    [".remarkrc"] = 370,
    [".sprite files"] = 412,
    ...
    ["Azure Pipelines"] = 45,
    ["Azure Static Web Apps CLI configuration file"] = 414,
    ["Azure Static Web Apps configuration file"] = 413,
    ["BX CI"] = 76,
    ["Better Code Hub"] = 532,
    ["Better Scripts"] = 77,
    BizTalkServerApplicationSchema = 504,
    ...
    ["Butane Config"] = 569,
    ["CICS TS region tagging"] = 576,
    ["CICS TS resource import"] = 577,
    ["CICS TS resource model"] = 578,
    ["CICS TS resource overrides"] = 579,
    ["CMake Presets"] = 78,
    ...
    ["Datahub Ingestion Recipe Schema"] = 583,
    ...
    ["Embrace Config Schema"] = 594,
    ["Error pages"] = 188,
    Esquio = 186,
    ["Estuary Flow Catalog Schema"] = 573,
    ["Expo SDK"] = 191,
    ...
    Goreleaser = 219,
    ["Goreleaser Pro"] = 220,
    ["Gradle Build Cache Node"] = 529,
    ["Gradle Enterprise"] = 528,
    ...
    HEMTT = 501,
    Hadolint = 513,
    ["Hardware Sentry Configuration"] = 587,
    Hayson = 232,
    ...
    ["JFrog File Spec"] = 251,
    ["JFrog Pipelines YML DSL"] = 596,
    ["JSON Document Transform"] = 259,
    ["JSON Feed"] = 260,
    ["JSON Resume"] = 374,
    ["JSON Schema Draft 2020-12"] = 480,
    ["JSON Schema Draft 4"] = 477,
    ["JSON Schema Draft 7"] = 478,
    ["JSON Schema Draft 8"] = 479,
    ...
    ["KSP-AVC"] = 475,
    ["KSP-CKAN"] = 476,
    ["Keycloak REST API"] = 602,
    ["Knative Functions - func.yaml"] = 203,
    ["KoDE/CI build.yaml"] = 592,
    ["Kong DBLess Schema"] = 593,
    KrakenD = 265,
    ["LinkML Metamodel"] = 277,
    Liquibase = 543,
    ["Liquibase Flow File"] = 544,
    Markdownlint = 547,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 591,
    ["Monika Configuration Schema"] = 589,
    ["Motif config"] = 497,
    ["Netin Diagnostic System Template"] = 552,
    ["Netlify config schema"] = 303,
    ["Nightwatch.js"] = 304,
    ["OSS Review Toolkit configuration"] = 327,
    ["OSS Review Toolkit curation"] = 328,
    ["OSS Review Toolkit package configuration"] = 329,
    ["OSS Review Toolkit repository configuration"] = 330,
    ["OSS Review Toolkit resolutions"] = 331,
    Opctl = 500,
    ["OpenWeather Current Weather API"] = 536,
    ["OpenWeather Road Risk API"] = 535,
    ["Ory Hydra configuration"] = 238,
    ["Ory Keto configuration"] = 267,
    ["Ory Kratos configuration"] = 326,
    ["Ory Oathkeeper configuration"] = 317,
    ["Outblocks App configuration"] = 324,
    ["Outblocks database table"] = 325,
    ["Outblocks project configuration"] = 323,
    Packer = 334,
    ["Pipeline component"] = 545,
    ["PocketMine plugin.yml"] = 338,
    Pterodactyl = 586,
    ["Pull Request Labeler"] = 361,
    Pulumi = 365,
    PyProject = 366,
    Qodana = 562,
    ["Quali Torque Blueprint Spec 2"] = 584,
    ["QueryFirst config file"] = 605,
    ["RKE Cluster Configuration JSON Schema"] = 542,
    ["RKE Cluster Configuration YAML Schema"] = 541,
    Ray = 512,
    ["Read the Docs"] = 364,
    ["Red-DiscordBot Cog"] = 367,
    ["Red-DiscordBot Cog Repo"] = 368,
    Renovate = 375,
    ["Replit schema"] = 371,
    RoadRunner = 376,
    ["Rust Project"] = 373,
    ["Rust toolchain"] = 378,
    ["SIL Kit Participant Configuration"] = 403,
    SWADL = 423,
    ["Sapphire CLI Config"] = 379,
    ["SauceCTL Configuration"] = 549,
    ["Schema Catalog"] = 392,
    ["Scoop manifest"] = 397,
    ["Semgrep Rule"] = 399,
    ["Serverless Framework Configuration"] = 556,
    ["Serverless Workflow Schema"] = 558,
    ["Settings.paf"] = 401,
    ["Shopware 6 Configuration"] = 559,
    ["Shopware CLI Extension Store Configuration"] = 560,
    ["Shopware CLI Project Store Configuration"] = 561,
    Solidarity = 407,
    ["Solution filters"] = 408,
    ["Source Maps v3"] = 409,
    SpecIF = 410,
    ["Sponge Mixin configuration"] = 411,
    ["StackHawk Scanner Configuration"] = 555,
    Stale = 415,
    Starship = 416,
    ["Statamic Blueprint"] = 417,
    ["StrmPrivacy Data Connector"] = 600,
    ["StrmPrivacy Data Contract"] = 601,
    ["StrmPrivacy SimpleSchema"] = 598,
    ["StrmPrivacy Stream"] = 599,
    ["StrmPrivacy batch job configuration file"] = 597,
    ["Stryker Mutator"] = 420,
    ["StyleCop Analyzers Configuration"] = 421,
    ["Swagger API 2.0"] = 424,
    TSON = 444,
    ["Talisman configuration"] = 425,
    ["Taskfile YAML Schema"] = 538,
    Taurus = 426,
    ["TestEnvironment.json"] = 433,
    Tikibase = 429,
    ["Traefik v2"] = 436,
    ["Traefik v2 File Provider"] = 437,
    Turborepo = 434,
    Tye = 563,
    ["UI5 Manifest"] = 450,
    ["UTAM Page Object"] = 452,
    ["Ubuntu Server Autoinstall"] = 448,
    ["Uniswap Token List"] = 521,
    ["Unreal Engine Uplugin"] = 606,
    ["Unreal Engine Uproject"] = 607,
    Updatecli = 570,
    Uplift = 604,
    ["User Journey Map YAML Schema"] = 540,
    V2Ray = 574,
    ["VSCode Code Snippets"] = 121,
    ["VSIX CLI publishing"] = 465,
    ["Vela Pipeline Configuration"] = 455,
    Vercel = 120,
    ["Web App Manifest"] = 470,
    ["Web types"] = 473,
    WebExtensions = 469,
    ["Webman package recipe"] = 580,
    ["Windows Package Manager Installer Manifest"] = 518,
    ["Windows Package Manager Locale Manifest"] = 519,
    ["Windows Package Manager Singleton Manifest"] = 517,
    ["Woodpecker pipeline config"] = 551,
    ["Xstate Machine Schema"] = 568,
    ["Yippee-Ki-JSON configuration YML"] = 523,
    ["angular.json"] = 10,
    ...
    ["ize.toml"] = 603,
    ["jsconfig.json"] = 263,
    ["jscpd Configuration Schema"] = 585,
    jsdoc = 511,
    ["k3d.yaml"] = 264,
    ...
    ["nlu.json"] = 308,
    ["nodemon.json"] = 310,
    ["noodl.schema.json"] = 553,
    now = 502,
    ["npm-badges"] = 312,
    ["nswag.json"] = 315,
    ntangle = 316,
    ["nuclei-template.yaml"] = 313,
    ["nuget-project.json"] = 314,
    ["ocelot.json"] = 318,
    ["omnisharp.json"] = 319,
    ["openapi.json"] = 320,
    ["openfin.json"] = 322,
    ["openrpc.json"] = 321,
    ["package.json"] = 332,
    ["package.manifest"] = 333,
    ["pattern.json"] = 336,
    ["petstore-v1.0"] = 595,
    pgap_yaml_input_reader = 335,
    ["plagiarize-me.yaml"] = 340,
    ["plagiarize.yaml"] = 339,
    ["portman.json"] = 341,
    ["prettierrc.json"] = 346,
    ["prisma.yml"] = 347,
    ["project-1.0.0-beta3.json"] = 349,
    ["project-1.0.0-beta4.json"] = 350,
    ["project-1.0.0-beta5.json"] = 351,
    ["project-1.0.0-beta6.json"] = 352,
    ["project-1.0.0-beta8.json"] = 353,
    ["project-1.0.0-rc1.json"] = 354,
    ["project-1.0.0-rc2.json"] = 355,
    ["project.json"] = 348,
    ["prometheus.json"] = 356,
    ["prometheus.rules.json"] = 357,
    ["proxies.json"] = 358,
    ["publiccode.yml"] = 359,
    ["pubspec.yaml"] = 360,
    ["pyrseas-0.8.json"] = 363,
    ["release drafter"] = 507,
    rustfmt = 377,
    ["sarif-1.0.0.json"] = 380,
    ["sarif-2.0.0.json"] = 381,
    ["sarif-2.1.0"] = 390,
    ["sarif-2.1.0-rtm.2"] = 382,
    ["sarif-2.1.0-rtm.3"] = 384,
    ["sarif-2.1.0-rtm.4"] = 386,
    ["sarif-2.1.0-rtm.5"] = 388,
    ["sarif-external-property-file-2.1.0"] = 391,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 383,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 385,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 387,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 389,
    ["schema.org - Action"] = 393,
    ["schema.org - ContactPoint"] = 394,
    ["schema.org - Place"] = 395,
    ["schema.org - Thing"] = 396,
    ["semantic-release"] = 398,
    ["servicehub.config.json"] = 483,
    ["servicehub.service.json"] = 482,
    ["settings.job"] = 400,
    ["sfdx-hardis configuration"] = 402,
    ["size-limit configuration"] = 404,
    ["skaffold.yaml"] = 546,
    ["skyuxconfig.json"] = 405,
    snapcraft = 406,
    ["stripe-app-local.json"] = 419,
    ["stripe-app.json"] = 418,
    swcrc = 534,
    taskcat = 503,
    ["template.json"] = 427,
    ["templatsources.json"] = 428,
    ["theme.json"] = 430,
    ["tizen_workspace.json"] = 431,
    tmLanguage = 432,
    tmuxinator = 491,
    ["trunk.yaml schema"] = 438,
    ["ts-force-config.json"] = 442,
    ["tsconfig.json"] = 439,
    ["tsd.json"] = 440,
    ["tsdrc.json"] = 441,
    ["tslint.json"] = 443,
    ...
    ["vega-lite.json"] = 454,
    ["vega.json"] = 453,
    ["venvironment-basic.yaml"] = 457,
    ["venvironment.yaml"] = 456,
    ["version.json"] = 458,
    ["vim-addon-info"] = 459,
    ["vs-2017.3.host.json"] = 461,
    ["vs-nesting.json"] = 462,
    ["vsls.json"] = 460,
    ["vss-extension.json"] = 466,
    ["webhint.io"] = 581,
    ["webjobpublishsettings.json"] = 472,
    ["webjobs-list.json"] = 471,
    ["xs-app.json"] = 499,
    ["xunit.runner.json"] = 481,
    yamllint = 522,
    zuul = 508,
    ["Žinoma"] = 516
  },
