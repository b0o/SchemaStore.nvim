...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 947,
    [".nodehawkrc"] = 587,
    [".npmpackagejsonlintrc"] = 591,
    [".omletrc"] = 1126,
    [".phrase.yml"] = 665,
    [".phraseapp.yml"] = 666,
    [".pmbot.yml"] = 651,
    [".postcssrc"] = 660,
    [".powerpages-web-template-manifest"] = 662,
    [".pre-commit-config.yml"] = 663,
    [".pre-commit-hooks.yml"] = 664,
    [".putout.json"] = 699,
    [".rehyperc"] = 724,
    [".remarkrc"] = 728,
    [".sprite files"] = 822,
    ...
    AIConfig = 34,
    ["AMX Muse Program Descriptor"] = 1174,
    ["API Builder"] = 982,
    ["AVA Configuration"] = 1045,
    ["AWS AppConfig Feature Flags-v1"] = 68,
    ["AWS CDK cdk.json"] = 264,
    ["AWS CloudFormation"] = 265,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 266,
    ["AWS Copilot Manifest"] = 1213,
    ["AWS SAM CLI Samconfig"] = 267,
    ["Adobe UXP Manifest"] = 1108,
    ["Aerleon Network & Service Definitions"] = 20,
    ["Aerleon Policy"] = 21,
    ["AgentCore CLI"] = 1253,
    Aider = 1203,
    Air = 23,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1224,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1223,
    ["Airlock Microgateway"] = 35,
    ["Alacritty Configuration"] = 1017,
    ["All Contributors configuration file"] = 1071,
    ["Ansible Argument Specs"] = 404,
    ["Ansible Collection Galaxy"] = 411,
    ["Ansible Execution Environment"] = 401,
    ["Ansible Inventory"] = 410,
    ["Ansible Meta"] = 402,
    ["Ansible Meta Runtime"] = 403,
    ["Ansible Navigator Configuration"] = 413,
    ["Ansible Playbook"] = 408,
    ["Ansible Requirements"] = 405,
    ["Ansible Rulebook"] = 409,
    ["Ansible Tasks File"] = 407,
    ["Ansible Vars File"] = 406,
    ["Ansible-lint Configuration"] = 412,
    Any = 1136,
    ...
    ["Application list for a WinUtil"] = 1153,
    ArchitectFX = 1158,
    ["Argo CD"] = 54,
    ["Argo Events"] = 55,
    ["Argo Workflows"] = 56,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1222,
    ["Azure IoT Operations connector metadata"] = 1219,
    ...
    ["Azure Pipelines"] = 113,
    ["Azure Static Web Apps CLI configuration file"] = 826,
    ["Azure Static Web Apps configuration file"] = 825,
    BMML = 1241,
    ["BOSH CPI Config"] = 139,
    ...
    ["Bacon config"] = 5,
    ["Barba-CV"] = 83,
    ["Bashly (bashly.yml)"] = 1075,
    ["Bashly Settings (bashly-settings.yml)"] = 1076,
    Bento = 1240,
    ["Better Code Hub"] = 987,
    ["Better Scripts"] = 161,
    Bigconfig = 132,
    ["Biome Formatter Config"] = 84,
    ["Bitmovin Encoding Template"] = 1167,
    BizTalkServerApplicationSchema = 954,
    Bleep = 162,
    ["Block Protocol Metadata"] = 159,
    ["Bluebricks blueprint config"] = 1246,
    ["Boyka Framework"] = 141,
    Briefcase = 960,
    ["Build Info"] = 150,
    Buildkite = 152,
    ...
    ["Butane Config"] = 1030,
    C4InterFlow = 1182,
    ["CDK Environment Manager, concrete environment configuration"] = 1206,
    ["CDK Environment Manager, concrete environments definition"] = 1205,
    ["CDK Environment Manager, environment definition"] = 1204,
    ["CGS Card Game Specification (cgs.json)"] = 1113,
    ["CICS TS region tagging"] = 1039,
    ["CICS TS resource import"] = 1040,
    ["CICS TS resource model"] = 1041,
    ["CICS TS resource overrides"] = 1042,
    ["CMake Presets"] = 163,
    ["CNC Codes"] = 185,
    ["CRS WAF test file"] = 1143,
    ["CRS WAF test platform overrides file"] = 1144,
    ["CSS Comb (.csscomb.json)"] = 292,
    ["CSS Lint (.csslintrc)"] = 293,
    ["CSpell (cspell.json)"] = 291,
    ["CVE Record Format"] = 195,
    CWL = 1119,
    ...
    ["Chamaleon environment"] = 1171,
    ["Chamaleon properties"] = 1172,
    ["Chamaleon template"] = 1170,
    Changepacks = 1233,
    Changesets = 276,
    Changie = 172,
    Charmcraft = 173,
    ...
    ["Chrome Extension"] = 257,
    ["Chromia Model"] = 175,
    ["Chromia Seeder Module Config"] = 177,
    ["Chromia Seeder Root Config"] = 176,
    ["Cinnamon Spice info.json"] = 93,
    ["CircleCI config.yml"] = 232,
    ["Citation File Format"] = 278,
    ["Citrus test case"] = 179,
    CityJSON = 180,
    ["Claude Code Keybindings"] = 192,
    ["Claude Code Settings"] = 193,
    ["Clawject config"] = 191,
    ["Cloud Foundry Application Manifest"] = 1125,
    ["Cloud Run Spec v1"] = 1148,
    ...
    CodeCV = 97,
    CodeRabbit = 96,
    ["CodeShip Pro services configuration files"] = 246,
    ["CodeShip Pro steps configuration files"] = 247,
    ["Codecov configuration files"] = 245,
    Codex = 241,
    CodifyCLI = 98,
    Codux = 243,
    ["Cog config file"] = 186,
    ...
    ["Common Catalog Data"] = 255,
    ["Common Package Specification"] = 189,
    Concord = 1142,
    ["Configu .cfgu files"] = 1130,
    ["Configu .configu file"] = 1131,
    Conjure = 184,
    ["Container Structure Test"] = 968,
    Containerlab = 996,
    ["Contextive Glossary"] = 1198,
    Convex = 183,
    ["Crowdsec collection config"] = 286,
    ["Crowdsec parser config"] = 287,
    ["Crowdsec scenario config"] = 288,
    ["CumulusCI Config"] = 190,
    ["Cursor Agent Environment"] = 1251,
    ["Custom Machinery Machine"] = 1114,
    ["Custom Machinery Recipe"] = 1115,
    ["Cycle Stack File"] = 196,
    CycloneDX = 197,
    ["DWP Exchange - catalogue entry"] = 337,
    ["DWP Exchange - gateway"] = 335,
    ["DWP Exchange - meta"] = 336,
    ["Dart Build Config (dart-build.json)"] = 294,
    ["Dart Test Config (dart-test.json)"] = 295,
    ["DashLord Configuration"] = 296,
    ["Data Contract Specification"] = 297,
    ["Data Product Specification"] = 298,
    ["DataYoga Connections"] = 198,
    ["DataYoga Job"] = 199,
    ["Databricks Asset Bundles"] = 1092,
    ["Datadog Continuous Testing"] = 502,
    ["Datadog Service Definition"] = 503,
    ["Datadog Software Catalog"] = 504,
    ["Datahub Ingestion Recipe"] = 1046,
    ["Debian Upstream Metadata file"] = 206,
    ["Deck config"] = 207,
    ["DeepMatch deeplinks spec"] = 208,
    ["Dein Config"] = 209,
    ["Deno Config (deno.json)"] = 304,
    ["Dependency cruiser"] = 210,
    ["DeployStack Configuration"] = 211,
    ["Deployah Configuration"] = 1221,
    ["Deployer Recipe"] = 307,
    ["Deta Spacefile"] = 212,
    ["Detekt Config (detekt.yml)"] = 308,
    ["Devbox Config"] = 213,
    ["Devbox Plugin"] = 214,
    Devfile = 334,
    Devup = 1234,
    DipDup = 1145,
    ["Discord Webhook"] = 309,
    ["DocFx Config (docfx.json)"] = 314,
    ["Docker Desktop extension metadata"] = 311,
    ["Docs MCP Manifest"] = 315,
    Dofigen = 316,
    ["Dolittle Artifacts"] = 317,
    ["Dolittle Bounded Context Configuration"] = 318,
    ["Dolittle Event Horizons Configuration"] = 319,
    ["Dolittle Resources Configuration"] = 320,
    ["Dolittle Server Configuration"] = 321,
    ["Dolittle Tenant Map Configuration"] = 323,
    ["Dolittle Tenants Configuration"] = 322,
    ["Dolittle Topology"] = 324,
    ["DonateCaseBetterCasino menu"] = 1175,
    ["Drupal Breakpoints"] = 215,
    ["Drupal Config"] = 227,
    ["Drupal Info"] = 216,
    ["Drupal Layouts"] = 217,
    ["Drupal Libraries"] = 218,
    ["Drupal Links Action"] = 219,
    ["Drupal Links Contextual"] = 220,
    ["Drupal Links Menu"] = 221,
    ["Drupal Links Task"] = 222,
    ["Drupal Migration"] = 223,
    ["Drupal Permissions"] = 224,
    ["Drupal Recipe"] = 225,
    ["Drupal Routing"] = 226,
    ["Drupal Services"] = 228,
    ["Drush site aliases"] = 330,
    ["Dynamic Bash Aliases (.aliases)"] = 1083,
    ["EAS config"] = 356,
    ["ECA - Editor Code Assistant"] = 339,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1072,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1218,
    ["EasyVCR .NET"] = 357,
    ["Eidolon Resource"] = 1159,
    ["Elgato Stream Deck"] = 341,
    Elm = 1147,
    ["Embrace Config"] = 1058,
    Endurica = 1096,
    ["Enterprise Contract Policy Spec"] = 342,
    ["Erda Pipeline"] = 1121,
    ["Erda Runtime"] = 1122,
    ["Espanso config.yml"] = 1244,
    ["Espanso match.yml"] = 1243,
    Esquio = 344,
    ["Estuary Flow Catalog"] = 1036,
    ["Ethereum ERC1155"] = 1255,
    ["Ethereum ERC721"] = 1254,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 349,
    ["EveryVoice TTS Toolkit Data Configuration"] = 350,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 354,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 353,
    ["EveryVoice TTS Toolkit Text Configuration"] = 351,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 352,
    ["Evolving Resolutive Process notation"] = 1220,
    ["Expo SDK"] = 355,
    ["F-Droid Data metadata"] = 361,
    ["FasterCI Configuration"] = 114,
    ["Fence configuration"] = 115,
    FiQuS = 365,
    Firebase = 363,
    ["Flatpak Builder Manifest"] = 366,
    ["FlexGet Config"] = 367,
    ["Flow.json Configurations"] = 1118,
    ["Fossa configuration file"] = 374,
    ["Fossa's fossa-deps file"] = 375,
    ["Foundry VTT - Base package Manifest"] = 369,
    ["Foundry VTT - Module Manifest"] = 370,
    ["Foundry VTT - System Data Template"] = 373,
    ["Foundry VTT - System Manifest"] = 371,
    ["Foundry VTT - World Manifest"] = 372,
    ["Foxx Manifest"] = 116,
    ["Freifunk.de Community API"] = 119,
    ["Frogbot Config"] = 120,
    ["G2P Mapping Configuration"] = 381,
    ["GCP Blueprint Metadata"] = 384,
    Gaspar = 382,
    ["GatewayCore API Gateway"] = 383,
    ["Gemini CLI settings"] = 385,
    ["GeoJSON.json latest"] = 1034,
    GherKing = 1038,
    ["GitHub Action"] = 390,
    ["GitHub Actions typing"] = 1155,
    ["GitHub Discussion"] = 391,
    ["GitHub Funding"] = 392,
    ["GitHub Issue Template configuration"] = 393,
    ["GitHub Issue Template forms"] = 394,
    ["GitHub Workflow"] = 395,
    ["GitHub Workflow Template Properties"] = 396,
    ["GitHub automatically generated release notes configuration"] = 397,
    ["GitLab Agent for Kubernetes configuration"] = 1110,
    GitVersion = 387,
    ["Gitea Issue Template configuration"] = 388,
    ["Gitea Issue Template forms"] = 389,
    ["Gitpod Automations"] = 399,
    ["Gitpod Configuration"] = 400,
    ["GlazeWM settings"] = 1112,
    ["Global Privacy Control"] = 386,
    Goblet = 1091,
    ["Golangci-lint Configuration"] = 415,
    ["Golangci-lint Custom Plugins Configuration"] = 416,
    ["Google Chrome Related Website Sets"] = 364,
    ["Google Cloud Workflows"] = 263,
    ["Google Digital Assetlinks"] = 1199,
    Goreleaser = 418,
    ["Goreleaser Pro"] = 419,
    Goss = 420,
    ["Gradle Build Cache Node"] = 985,
    ["Gradle Enterprise"] = 984,
    ["Grafana 5.x Dashboard"] = 421,
    ["GraphQL Code Generator"] = 426,
    ["GraphQL Config"] = 425,
    ["GraphQL Mesh"] = 424,
    ["GroovyLint configuration"] = 427,
    ["Grunt JSHint task"] = 431,
    ["Grunt Watch task"] = 432,
    ["Grunt base task"] = 433,
    ["Grunt clean task"] = 429,
    ["Grunt copy task"] = 428,
    ["Grunt cssmin task"] = 430,
    HEMTT = 950,
    Hadolint = 964,
    Hammerkit = 995,
    ["Hardware Sentry Configuration"] = 1050,
    ["Hashgraph Online Skill Manifest"] = 1,
    ["HashiCorp Vault"] = 434,
    Hatch = 965,
    Hayson = 436,
    ["Haystack Pipeline"] = 437,
    ["Hazelcast 5 Configuration"] = 438,
    ["Hecate Input Schema"] = 1210,
    ["Helm Chart.lock"] = 230,
    ["Helm Chart.yaml"] = 229,
    ["Helm Unittest Test Suite"] = 231,
    ["Home Assistant Integration Manifest"] = 439,
    ["Homer dashboard configuration"] = 440,
    Hugo = 1026,
    ["Hugo Theme"] = 1025,
    ["Hulak Configuration"] = 447,
    ["Hyperfoil benchmark configuration"] = 446,
    ["IBM Zapp document"] = 448,
    ["IBM zCodeFormatSettings"] = 449,
    ["IMG Catapult PSP"] = 454,
    ["IVMS101 by CODE Protocol"] = 1111,
    Infrahub = 456,
    Istanbul = 1054,
    ["JDownloader2 crawler multi-rules"] = 469,
    ["JDownloader2 crawler single-rules"] = 468,
    ["JFrog Applications Config"] = 470,
    ["JFrog File Spec"] = 471,
    ["JFrog Pipelines YML DSL"] = 1060,
    ["JMeter DSL cli config"] = 472,
    JReleaser = 475,
    ["JSON Document Transform"] = 483,
    ["JSON Feed"] = 484,
    ["JSON Resume"] = 736,
    ["JSON Schema Draft 2020-12"] = 932,
    ["JSON Schema Draft 4"] = 929,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1093,
    ["JSON Schema Draft 7"] = 930,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1094,
    ["JSON Schema Draft 8 (2019-09)"] = 931,
    ["JSON-API"] = 482,
    ["JSON-e templates"] = 992,
    ["JSON-stat 2.0"] = 925,
    JSONPatch = 486,
    ["JSR Package Config (jsr.json)"] = 476,
    Jarl = 1226,
    Jasmine = 463,
    Jekyll = 464,
    ["Jenkins X Pipelines"] = 465,
    ["Jenkins X Requirements"] = 466,
    Jest = 467,
    Jocker = 473,
    ["Jovo Language Models"] = 474,
    ["Jujutsu (jj) VCS config"] = 1212,
    ["KIMMDY config file"] = 497,
    ["KODE/CI build.yaml"] = 1056,
    ["KSP-AVC"] = 926,
    ["KSP-CKAN"] = 927,
    ["KSP-NetKAN"] = 928,
    KSY = 1123,
    KSail = 379,
    ["KYA Manifest"] = 1124,
    ["Karakum configuration file"] = 376,
    Kas = 489,
    ["Kestra flow file"] = 498,
    ["Keycloak REST API"] = 1063,
    ["Knative Functions - func.yaml"] = 377,
    Knip = 378,
    ["Knowledge Unit"] = 506,
    ["Kometa (nightly) config file"] = 500,
    ["Kometa config file"] = 499,
    ["Kong DBLess config"] = 1057,
    KrakenD = 501,
    ["Kubri Configuration"] = 509,
    LOOBin = 524,
    ["Lake configuration file"] = 1215,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 268,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 269,
    ["Landing Zone Accelerator on AWS - Global Config"] = 270,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 271,
    ["Landing Zone Accelerator on AWS - Network Config"] = 272,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 273,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 274,
    ["Landing Zone Accelerator on AWS - Security Config"] = 275,
    ["Lando (landofile)"] = 109,
    ["LangGraph Platform configuration"] = 1135,
    ["Language configuration"] = 1134,
    Lefthook = 513,
    ["Liferay client-extension.yaml"] = 520,
    ["LinkML Metamodel"] = 522,
    Liquibase = 1001,
    ["Liquibase Flow File"] = 1002,
    ["Lively Properties"] = 523,
    ["Lobe AI Agent"] = 111,
    Loki = 112,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 566,
    ["MS2Rescore Configuration"] = 570,
    ["Madness (madness.yml)"] = 1074,
    ["Mado configuration"] = 530,
    ["Maestro Flow"] = 531,
    ["Mail Servers Configuration"] = 1247,
    ["MapEHR Mapping"] = 532,
    Markdownlint = 1005,
    ["Mason Registry"] = 1008,
    ["MegaLinter Custom Flavor"] = 535,
    ["MegaLinter configuration"] = 534,
    ["MegaLinter descriptor"] = 536,
    Melange = 1101,
    ["Meltano project definition"] = 537,
    ["Mergify Configuration"] = 571,
    ["Metadata for a Bazel module"] = 538,
    ["Metadata for a Cinnamon spice"] = 1151,
    ["Metatype Configuration"] = 539,
    ["MetricsHub Configuration"] = 540,
    ["MetricsHub Connector Configuration"] = 541,
    ["Micro Editor Syntax"] = 1084,
    ["Microsoft Band Web Tile"] = 542,
    ["Microsoft RulesEngine workflow rules"] = 1139,
    ["Microsoft RulesEngine workflow rules list"] = 1140,
    ["Minecraft Custom Main Menu Mod"] = 1102,
    ["Minecraft Data Pack Advancement"] = 544,
    ["Minecraft Data Pack Biome"] = 545,
    ["Minecraft Data Pack Configured Carver"] = 546,
    ["Minecraft Data Pack Damage Type"] = 547,
    ["Minecraft Data Pack Dimension"] = 549,
    ["Minecraft Data Pack Dimension Type"] = 548,
    ["Minecraft Data Pack Item Modifier"] = 550,
    ["Minecraft Data Pack Loot Table"] = 551,
    ["Minecraft Data Pack Metadata"] = 552,
    ["Minecraft Data Pack Predicate"] = 553,
    ["Minecraft Data Pack Recipe"] = 554,
    ["Minecraft Data Pack Tag"] = 555,
    ["Minecraft Data Pack Template Pool"] = 556,
    ["Minecraft Data Pack Trim Material"] = 561,
    ["Minecraft Data Pack Trim Pattern"] = 562,
    ["Minecraft Resource Pack Lang"] = 557,
    ["Minecraft Resource Pack Particle"] = 558,
    ["Minecraft Resource Pack Texture Mcmeta"] = 560,
    ["Minecraft Resourcepack Sounds"] = 559,
    ModuleAssembler = 564,
    ["Monade CLI Stack Configuration"] = 574,
    ["MongoDB Atlas Search Index Definition"] = 1055,
    ["Monika Configuration"] = 1053,
    ["Monoweave Configuration"] = 569,
    ["Motif config"] = 946,
    MultiQC = 1192,
    ["NOX Framework (Service)"] = 590,
    ["Netin Diagnostic System Template"] = 1012,
    ["Netlify config"] = 577,
    ["Network-as-Code Data Model"] = 578,
    ["Next Gen UI Agent A2A Server Configuration"] = 579,
    ["Next Gen UI Agent Configuration"] = 581,
    ["Next Gen UI Agent MCP Server Configuration"] = 580,
    ["Nightwatch.js"] = 583,
    ["Node.js configuration"] = 951,
    ["NueJS configuration file"] = 595,
    ["Nuitka.yaml"] = 1116,
    ["Nullstone config"] = 597,
    ["ONe's changelog entry"] = 616,
    ["ONe's service descriptor"] = 615,
    ["ORT Server repository environment configuration"] = 626,
    ["OSCAL Assessment Plan (AP)"] = 628,
    ["OSCAL Assessment Results (AR)"] = 629,
    ["OSCAL Catalog"] = 630,
    ["OSCAL Component Definition (CDef)"] = 631,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 632,
    ["OSCAL Profile"] = 633,
    ["OSCAL System Security Plan (SSP)"] = 634,
    ["OSS Review Toolkit configuration"] = 635,
    ["OSS Review Toolkit curation"] = 636,
    ["OSS Review Toolkit package configuration"] = 637,
    ["OSS Review Toolkit repository configuration"] = 638,
    ["OSS Review Toolkit resolutions"] = 639,
    ["October CMS columns"] = 601,
    ["October CMS fields"] = 602,
    ["Oh My Posh"] = 604,
    Okteto = 605,
    ["Ona Automations"] = 607,
    Opctl = 949,
    ["Open Data Contract Standard (ODCS)"] = 620,
    ["Open Data Product Standard (ODPS)"] = 621,
    ["Open Know-How"] = 1197,
    ["OpenRewrite Resource"] = 618,
    OpenSRM = 622,
    OpenStatus = 1208,
    ["OpenTelemetry Declarative Configuration"] = 619,
    ["OpenUtau character yaml"] = 612,
    ["OpenUtau ustx"] = 613,
    ["OpenWeather Current Weather API"] = 991,
    ["OpenWeather Road Risk API"] = 990,
    ["Ory Hydra configuration"] = 445,
    ["Ory Keto configuration"] = 505,
    ["Ory Kratos configuration"] = 627,
    ["Ory Oathkeeper configuration"] = 599,
    ["Outblocks App configuration"] = 624,
    ["Outblocks database table"] = 625,
    ["Outblocks project configuration"] = 623,
    PDM = 646,
    POPxf = 657,
    ["POPxf Correlations"] = 658,
    Packer = 643,
    PactSpec = 644,
    Pantsbuild = 1070,
    ["Paper paper-plugin.yml"] = 645,
    ["Pipeline component"] = 1003,
    ["Platform.sh application"] = 7,
    ["Platform.sh routes"] = 8,
    ["Platform.sh services"] = 9,
    ["Plex Prerolls"] = 655,
    ["PocketMine plugin.yml"] = 652,
    ["Postman collection"] = 661,
    ["Power Pages Configuration"] = 1209,
    ["Preset list for a WinUtil"] = 1154,
    ["ProActions AI-Kit Configuration"] = 672,
    ["ProActions AI-Kit Configuration for Menus"] = 674,
    ["ProActions AI-Kit Configuration for Sections"] = 676,
    ["ProActions AI-Kit Configuration for Services"] = 673,
    ["ProActions AI-Kit Configuration for Steps"] = 677,
    ["ProActions AI-Kit Configuration for Templates"] = 675,
    ["Problem object RFC9457"] = 1099,
    ["Problem package format"] = 678,
    ["Problem package generators"] = 679,
    ["Problem package submissions"] = 680,
    ["Problem package test group metadata"] = 681,
    Pterodactyl = 1049,
    ["Pull Request Labeler"] = 698,
    Pulumi = 706,
    ["PyGTA Config"] = 702,
    PyProject = 707,
    Pylock = 1200,
    Pyright = 708,
    ["Python script metadata"] = 1194,
    ["QType AI DSL"] = 711,
    Qgoda = 710,
    Qodana = 1022,
    ["Qt Creator workspace file"] = 1132,
    ["Quali Torque Blueprint Spec 2"] = 1047,
    ["QueryFirst config file"] = 1066,
    ["Qwen Code Settings"] = 1256,
    ["RKE Cluster Configuration JSON"] = 1000,
    ["RKE Cluster Configuration YAML"] = 999,
    RadioHound = 701,
    ["Raid Profile"] = 1257,
    ["Raid Repo Configuration"] = 1258,
    Railpack = 713,
    Railway = 712,
    ["Rancher Fleet"] = 703,
    ["Rattler-build"] = 714,
    Ray = 963,
    ["Read the Docs"] = 705,
    ["Red-DiscordBot Cog"] = 721,
    ["Red-DiscordBot Cog Repo"] = 722,
    ["Red-DiscordBot Trivia"] = 723,
    ["Releasaurus Config"] = 4,
    ReleaseKit = 3,
    ["Render Blueprints"] = 998,
    RenderCV = 740,
    Renovate = 737,
    ["Renovate global configuration"] = 738,
    ["Renovate inherited configuration"] = 739,
    ["Replit config"] = 729,
    Restate = 1187,
    ["Revel Digital Gadget Definition File"] = 1211,
    RoadRunner = 742,
    ["Robust Station Image"] = 1217,
    Rockcraft = 743,
    ["Roo Coder Custom Modes"] = 744,
    Rubocop = 733,
    ["Rudder techniques"] = 1106,
    Ruff = 734,
    ["Rust Project"] = 735,
    ["Rust toolchain"] = 748,
    ["SDMX data message"] = 775,
    ["SDMX metadata message"] = 774,
    ["SDMX structure message"] = 773,
    ["SIL Kit Participant Configuration"] = 785,
    ["SIL Kit Registry Configuration"] = 786,
    ["SPDX 2.3"] = 823,
    SWADL = 839,
    ["Safebox Config"] = 1061,
    ["Sapphire CLI Config"] = 751,
    ["SauceCTL Configuration"] = 1009,
    Scarb = 771,
    ["Schema Catalog"] = 766,
    ["Scoop manifest"] = 772,
    ["Semantic Data Fabric (SDF) file"] = 776,
    ["Semgrep Rule"] = 778,
    ["Serenity Code Generator (Sergen)"] = 779,
    ["Serverless Framework Configuration"] = 1016,
    ["Serverless Workflow"] = 1018,
    ["Settings for a Cinnamon spice"] = 1150,
    ["Settings.paf"] = 781,
    ["Shopware 6 Configuration"] = 1019,
    ["Shopware CLI Extension Store Configuration"] = 1020,
    ["Shopware CLI Project Store Configuration"] = 1021,
    ["Sigma Detection Rule"] = 783,
    ["Sigrid scope configuration file"] = 784,
    ["SkyPilot Task JSON"] = 1107,
    ["Slack app manifest"] = 788,
    Snapcraft = 790,
    Solidarity = 793,
    ["Solution filters"] = 794,
    ["Source Maps v3"] = 795,
    Sourcery = 796,
    ["Spack bootstrap.yaml"] = 797,
    ["Spack cdash.yaml"] = 798,
    ["Spack ci.yaml"] = 799,
    ["Spack compilers.yaml"] = 800,
    ["Spack concretizer.yaml"] = 801,
    ["Spack config.yaml"] = 802,
    ["Spack definitions.yaml"] = 803,
    ["Spack develop.yaml"] = 804,
    ["Spack env_vars.yaml"] = 805,
    ["Spack environment"] = 811,
    ["Spack include.yaml"] = 806,
    ["Spack mirrors.yaml"] = 807,
    ["Spack modules.yaml"] = 808,
    ["Spack packages.yaml"] = 809,
    ["Spack repos.yaml"] = 810,
    ["Spack toolchains.yaml"] = 812,
    ["Spack upstreams.yaml"] = 813,
    ["Spack view.yaml"] = 814,
    ["Speakeasy Generation Config File"] = 818,
    ["Speakeasy Lint Configuration File"] = 815,
    ["Speakeasy Test Generation Configuration File"] = 816,
    ["Speakeasy Workflow File"] = 817,
    SpecIF = 819,
    ["Specmatic Configuration"] = 820,
    ["Sponge Mixin configuration"] = 821,
    StackBlitz = 827,
    ["StackHawk Scanner Configuration"] = 1015,
    Stale = 828,
    Starfish = 829,
    ["Starlake Data Pipeline"] = 988,
    Starship = 830,
    ["Statamic Blueprint"] = 831,
    ["Stella configuration file"] = 832,
    ["Streamlit configuration file"] = 833,
    ["Stryker Mutator"] = 836,
    ["StyleCop Analyzers Configuration"] = 837,
    ["Stylelint (.stylelintrc)"] = 838,
    ["Stylua Config"] = 1201,
    ["Sublime Syntax"] = 1062,
    ["Subsquid squid manifest"] = 1109,
    ["Swagger API 2.0"] = 840,
    ["Synadia Connect Component"] = 841,
    TSON = 877,
    TSTyche = 878,
    ["TYPO3 Vendor Bundler config"] = 884,
    ["Tab data for a LinUtil"] = 1157,
    ["Tab list for a LinUtil"] = 1156,
    Tach = 842,
    ["Tach Domain"] = 843,
    Talhelper = 845,
    ["Talisman configuration"] = 846,
    Taplo = 1202,
    ["Taskfile config"] = 993,
    Taurus = 847,
    Tauticord = 848,
    ["Tekton Pipeline"] = 1230,
    ["Tekton PipelineRun"] = 1231,
    ["Tekton Task"] = 1228,
    ["Tekton TaskRun"] = 1229,
    Telefonistka = 1188,
    ["Terrateam config"] = 1214,
    ["TestEnvironment.json"] = 860,
    ["TextMate Grammar"] = 859,
    Threagile = 854,
    ["Tier.run pricing.json"] = 851,
    Tikibase = 852,
    Tombi = 857,
    ["Traefik v2"] = 863,
    ["Traefik v2 File Provider"] = 864,
    ["Traefik v3"] = 865,
    ["Traefik v3 File Provider"] = 866,
    ["Travis CI (.travis.yml)"] = 862,
    Treefmt = 423,
    Trident = 1184,
    ["TrueScript for *.tscript files"] = 869,
    ["Tugboat QA config.yml"] = 1181,
    TunnelHub = 1097,
    Turborepo = 861,
    Tycho = 1146,
    Tye = 1023,
    ["Tyk Gateway - Open Source v5.7+"] = 1193,
    ["UET BuildConfig.json"] = 1067,
    ["UI5 Manifest"] = 890,
    ["UNCORS configuration"] = 894,
    ["UTAM Page Object"] = 893,
    ["Ubuntu Server Autoinstall"] = 888,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1185,
    ["Uniswap Token List"] = 975,
    ["Universal Schedule Format"] = 895,
    ["Unreal Engine Uplugin"] = 1068,
    ["Unreal Engine Uproject"] = 1069,
    ["UpCloud CLI (upctl) configuration"] = 1186,
    ["Updatecli Compose"] = 1031,
    ["Updatecli Policy Manifest"] = 1032,
    ["Updatecli Policy Metadata"] = 1033,
    Uplift = 1065,
    ["Upsun config"] = 6,
    ["User Journey Map"] = 997,
    V2Ray = 1037,
    ["VSCode Code Snippets"] = 251,
    ["VSIX CLI publishing"] = 913,
    Vector = 897,
    ["Vela Pipeline Configuration"] = 900,
    Vercel = 250,
    ["Version Bumper config"] = 903,
    Vespertide = 1235,
    ["Vespertide Migration"] = 1236,
    ["Vespertide Model"] = 1237,
    ["Viash Component Config"] = 1190,
    ["Viash Package Config"] = 1191,
    Visivo = 1095,
    ["WP-CLI"] = 923,
    Wake = 1183,
    ["Waku Config"] = 1160,
    ["Web App Manifest"] = 919,
    ["Web types"] = 922,
    WebExtensions = 918,
    ["Webman package recipe"] = 1043,
    ["Windows Package Manager Installer Manifest"] = 971,
    ["Windows Package Manager Locale Manifest"] = 972,
    ["Windows Package Manager Singleton Manifest"] = 970,
    Winutil = 973,
    ["WireMock CLI import configuration"] = 1166,
    ["WireMock CLI local service configuration"] = 1165,
    ["WireMock message stub mapping"] = 1164,
    ["WireMock stub mapping"] = 1163,
    ["Woodpecker pipeline config"] = 1011,
    ["Wrangler CLI"] = 924,
    ["Xstate Machine"] = 1029,
    ["Yandex Workflow Language"] = 1152,
    ["Yarn Config (.yarnrc.yml)"] = 986,
    ["Yippee-Ki-JSON configuration YML"] = 977,
    ["YouTrack App"] = 1149,
    ["Zarf Package Configuration"] = 1216,
    ["Zerops.io config"] = 1137,
    ["Zerops.io import"] = 1138,
    ["Zola Configuration"] = 1227,
    ["aerleon.yml"] = 19,
    ["amplify.yml"] = 12,
    ["angular.json"] = 36,
    apko = 1100,
    ...
    ["behat.yml"] = 142,
    ["bigquery-table"] = 131,
    ["bioimageio resource description"] = 1117,
    ...
    ["ccmod.json"] = 1161,
    changelogging = 1129,
    ["chisel-slices.json"] = 277,
    ["chrome-extension-locales-messages.json"] = 258,
    ["chutzpah.json"] = 259,
    cibuildwheel = 178,
    ["clang-format (.clang-format)"] = 1035,
    ["clang-tidy"] = 237,
    clangd = 236,
    clib = 238,
    ["cloud-init: cloud-config userdata"] = 240,
    ["cloud-sdk-pipeline-configuration"] = 261,
    ["cloudbuild.json"] = 262,
    cloudify = 239,
    cmakefmt = 194,
    ["cmdx.yaml"] = 95,
    ...
    ["coffeelint.json"] = 279,
    ["commands.json"] = 254,
    ["commitlint (.commitlintrc)"] = 974,
    ["committed.toml"] = 280,
    ["compile_commands.json"] = 253,
    ["compilerconfig.json"] = 252,
    ["completely.yml"] = 1073,
    ["component-detection-manifest.json"] = 283,
    ["component.json"] = 282,
    ["composer.json"] = 281,
    ["conda-forge"] = 182,
    ["config.yaml"] = 704,
    ["contentmanifest.json"] = 260,
    ["contribute.json"] = 284,
    ["cosmos.config.json"] = 256,
    ["crowdin.yml"] = 285,
    ["ctfd-setup configuration file"] = 1173,
    ["custom-elements.json"] = 1087,
    ["cypress.json"] = 289,
    ["datalogic-scan2deploy-android"] = 299,
    ["datalogic-scan2deploy-ce"] = 300,
    ["dbt Dependencies"] = 201,
    ["dbt Packages"] = 203,
    ["dbt Project"] = 202,
    ["dbt Selectors"] = 204,
    ["dbt YAML files"] = 205,
    ...
    ["ddev-global"] = 301,
    ["ddev-project"] = 302,
    ["debugsettings.json"] = 303,
    ["dependabot-v2.json"] = 306,
    ["dependabot.json"] = 305,
    ["deployed-cli"] = 1028,
    ["devcontainer.json"] = 244,
    devinit = 979,
    ["devspace.yaml"] = 1051,
    djlint = 980,
    ["docker bake"] = 312,
    ["docker sequencer"] = 313,
    ["docker-compose.yml"] = 978,
    ["dockerd.json"] = 310,
    ["dotnet Release Index manifest"] = 325,
    ["dotnet-tools.json"] = 326,
    ["dotnetcli.host.json"] = 327,
    ["dprint.json"] = 328,
    ["drone.json"] = 329,
    ["dss-2.0.0.json"] = 331,
    ["dstack configuration"] = 332,
    ["dtool dataset metadata"] = 1168,
    ["dvc.yaml"] = 333,
    ["ecosystem.json"] = 338,
    eksctl = 340,
    ["electron-builder configuration file"] = 347,
    ["epr-manifest.json"] = 346,
    ["estampo.toml"] = 345,
    ["evcc.yaml"] = 348,
    ["ezd task runner"] = 358,
    ["fabric.mod.json"] = 360,
    ["first-timers-bot"] = 368,
    ["flagd flag configuration"] = 117,
    ["fly.io Configuration"] = 118,
    fulibWorkflows = 1010,
    ["function.json"] = 380,
    ["gRPC API Gateway & OpenAPI Config"] = 14,
    ["gematik health care insurance list"] = 1179,
    ["gematik health care patient list"] = 1176,
    ["gematik health care provider institution list"] = 1178,
    ["gematik health care provider list"] = 1177,
    ["gematik tiger test environment configuration"] = 1180,
    ["git-town.toml"] = 1225,
    ["gitlab-ci"] = 398,
    ["global.json"] = 414,
    ["go-feature-flag Flag Configuration"] = 417,
    ["haxelib.json"] = 435,
    helmfile = 966,
    helmwave = 967,
    ["host-meta.json"] = 442,
    ...
    ["ide.host.json"] = 450,
    ["ifstate.yaml"] = 451,
    ["imageoptimizer.json"] = 452,
    ["importmap.json"] = 455,
    instant_python_config = 457,
    instant_python_custom_project = 458,
    ["ioBroker Configuration"] = 459,
    ["ioBroker JSON UI"] = 460,
    ["ioBroker Package manifest"] = 461,
    ["ixpect.conf.yaml"] = 462,
    ["ize.toml"] = 1064,
    ["jsconfig.json"] = 487,
    ["jscpd Configuration"] = 1048,
    jsdoc = 962,
    ["k3d.yaml"] = 488,
    ["k9s aliases.yaml"] = 490,
    ["k9s cluster-config.yaml"] = 492,
    ["k9s config.yaml"] = 491,
    ["k9s hotkeys.yaml"] = 493,
    ["k9s plugins.yaml"] = 494,
    ["k9s skin.yaml"] = 495,
    ["k9s views.yaml"] = 496,
    ["kontinuous-config.yaml"] = 508,
    ["kontinuous-values.yaml"] = 507,
    ["kustomization.yaml"] = 510,
    ["label-commenter-config.yml"] = 511,
    ["latexindent configuration"] = 110,
    ["launchsettings.json"] = 512,
    lazydocker = 1086,
    lazygit = 1085,
    ["lego.json"] = 514,
    ["lerna.json"] = 515,
    ["lgtm.yml"] = 516,
    ["liblab.config.json"] = 517,
    ["libman.json"] = 518,
    ["license-report-config.json"] = 519,
    ["linkinator.config.json"] = 521,
    ["lint-staged (.lintstagedrc)"] = 940,
    ["local.settings.json"] = 526,
    ["localazy.json"] = 527,
    ["lotus.yaml"] = 525,
    ["lsdlschema.json"] = 528,
    ["macro.json"] = 1052,
    ["markdown-link-check"] = 1006,
    maturin = 1007,
    mboats = 1014,
    ["micro-settings.json"] = 1079,
    ["mimetypes.json"] = 543,
    ["mirrord config"] = 942,
    mise = 943,
    ["mkdocs.yml"] = 563,
    ...
    ["monospace.yml"] = 568,
    ["moon.yml"] = 1162,
    ["mprocs Configuration file"] = 1133,
    ["mrdocs.yml"] = 565,
    ["mta.yaml"] = 944,
    ["mtad.yaml"] = 945,
    ["mycode.json"] = 575,
    nFPM = 582,
    ["napari plugin manifest"] = 576,
    neoload = 957,
    ["nest-cli"] = 585,
    ["nexus-rpc-gen"] = 1252,
    ["ninjs (News in JSON)"] = 584,
    ["nitro.json"] = 956,
    ["nixd configuration"] = 1105,
    ["nlu.json"] = 586,
    ["nodemon.json"] = 588,
    ["noodl config"] = 1013,
    ["notebook.mod.json"] = 589,
    now = 952,
    ["npm-badges"] = 592,
    ["nswag.json"] = 596,
    ntangle = 598,
    ["nuclei-template.yaml"] = 593,
    ["nuget-project.json"] = 594,
    ["ocelot.json"] = 600,
    ogen = 603,
    ["omnisharp.json"] = 606,
    openHAB = 1238,
    ...
    oxlint = 1249,
    ["package.json"] = 640,
    ["package.manifest"] = 642,
    ["package.yaml"] = 641,
    ["partial-black.json"] = 143,
    ["partial-fastapi.json"] = 144,
    ["partial-pixi.json"] = 650,
    ["pattern.json"] = 648,
    ["petstore-v1.0"] = 1059,
    pgap_yaml_input_reader = 647,
    pgxgen = 1242,
    pitcms = 1245,
    ["pixi.toml"] = 649,
    ["plagiarize-me.yaml"] = 654,
    ["plagiarize.yaml"] = 653,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1169,
    ["podbard.yaml"] = 656,
    ["portman.json"] = 659,
    ["prefect.toml"] = 667,
    ["prefect.yaml"] = 668,
    ...
    ["prettierrc.json"] = 670,
    ["prisma.yml"] = 671,
    ["project-1.0.0-beta3.json"] = 683,
    ["project-1.0.0-beta4.json"] = 684,
    ["project-1.0.0-beta5.json"] = 685,
    ["project-1.0.0-beta6.json"] = 686,
    ["project-1.0.0-beta8.json"] = 687,
    ["project-1.0.0-rc1.json"] = 688,
    ["project-1.0.0-rc2.json"] = 689,
    ["project.json"] = 682,
    ["project.owasp.yaml"] = 690,
    ["prometheus-alertmanager.json"] = 694,
    ["prometheus.json"] = 691,
    ["prometheus.rules.json"] = 692,
    ["prometheus.rules.test.json"] = 693,
    ["proxies.json"] = 695,
    ["publiccode.yml"] = 696,
    ["pubspec.yaml"] = 697,
    ["pyrseas-0.8.json"] = 700,
    pytest = 709,
    ["quilt.mod.json"] = 1080,
    ["rc3 auth"] = 715,
    ["rc3 collection"] = 716,
    ...
    ["release drafter"] = 958,
    ["release-hub.json"] = 2,
    ["release-please-config.json"] = 725,
    ["release-please-manifest.json"] = 726,
    ["release-plz.toml"] = 727,
    ["renv.lock"] = 741,
    ["reposets Configuration"] = 730,
    ["reposets Credentials"] = 731,
    ["rivet.json"] = 1104,
    ["rivet.yaml (legacy)"] = 1103,
    rumdl = 746,
    runny = 745,
    rustfmt = 747,
    sake = 1196,
    samt = 749,
    samtrc = 750,
    ["sarif-1.0.0.json"] = 752,
    ["sarif-2.0.0.json"] = 753,
    ["sarif-2.1.0"] = 763,
    ["sarif-2.1.0-rtm.2"] = 754,
    ["sarif-2.1.0-rtm.3"] = 756,
    ["sarif-2.1.0-rtm.4"] = 758,
    ["sarif-2.1.0-rtm.5"] = 760,
    ["sarif-2.1.0-rtm.6"] = 761,
    ["sarif-external-property-file-2.1.0"] = 764,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 755,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 757,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 759,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 762,
    ["scalingo.json configuration"] = 765,
    ["schema.org - Action"] = 767,
    ["schema.org - ContactPoint"] = 768,
    ["schema.org - Place"] = 769,
    ["schema.org - Thing"] = 770,
    ["secrethub.yml"] = 1082,
    ["semantic-release"] = 777,
    ["servicehub.config.json"] = 935,
    ["servicehub.service.json"] = 934,
    ["settings.job"] = 780,
    ["sfdx-hardis configuration"] = 782,
    ["shard.yml"] = 1120,
    ["size-limit configuration"] = 787,
    ["skaffold.yaml"] = 1004,
    ["skyuxconfig.json"] = 789,
    ["snowflake-config"] = 791,
    ["snowflake-connections"] = 792,
    ["spicepod.yaml"] = 1141,
    ["sqlc configuration"] = 824,
    ["stripe-app-local.json"] = 835,
    ["stripe-app.json"] = 834,
    swcrc = 989,
    ["task.json"] = 844,
    taskcat = 953,
    ["template.json"] = 849,
    ["templatsources.json"] = 850,
    ["text2confl config"] = 1250,
    ["theme.json"] = 853,
    ["tizen_workspace.json"] = 855,
    tldr = 856,
    ["tm_devices configuration file"] = 1207,
    tmuxinator = 938,
    tox = 858,
    ["transcend.yml"] = 867,
    ["tree-sitter grammar.json"] = 422,
    ["trime.yaml"] = 868,
    ["trunk.yaml"] = 870,
    ["ts-force-config.json"] = 875,
    ["tsconfig.json"] = 871,
    ["tsd.json"] = 872,
    ["tsdoc.json"] = 873,
    ["tsdrc.json"] = 874,
    ...
    v8r = 917,
    vcluster = 1127,
    ["vcpkg configuration file"] = 249,
    ["vcpkg manifest file"] = 248,
    ["vega-lite.json"] = 899,
    ["vega.json"] = 898,
    ["venvironment.yaml"] = 901,
    ["venvplus.yaml"] = 902,
    version = 1189,
    ["version.json"] = 904,
    ["vhwdebugger-binding.yaml"] = 906,
    ["vim-addon-info"] = 907,
    ["vs-2017.3.host.json"] = 909,
    ["vs-nesting.json"] = 910,
    ["vsls.json"] = 908,
    ["vss-extension.json"] = 914,
    vtcfg = 1195,
    ["vtesttree.yaml"] = 915,
    ["vtestunit.yaml"] = 916,
    ["warp-keysets.json"] = 1088,
    ["warp-themes.json"] = 1089,
    ["warp-workflows.json"] = 1090,
    ["webhint.io"] = 1044,
    ["webjobpublishsettings.json"] = 921,
    ["webjobs-list.json"] = 920,
    ["well-known-fursona"] = 1128,
    ["xs-app.json"] = 948,
    ["xunit.runner.json"] = 933,
    yamllint = 976,
    zizmor = 1232,
    zuul = 959,
    ["Žinoma"] = 969
