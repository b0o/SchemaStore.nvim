...
M.json = {
  ...
  index = {
    ...
    AIConfig = 35,
    ["AMX Muse Program Descriptor"] = 1181,
    ["API Builder"] = 989,
    ["AVA Configuration"] = 1052,
    ...
    ["AWS Copilot Manifest"] = 1220,
    ["AWS SAM CLI Samconfig"] = 271,
    ["Adobe UXP Manifest"] = 1115,
    ["Aerleon Network & Service Definitions"] = 21,
    ["Aerleon Policy"] = 22,
    ["AgentCore CLI"] = 1260,
    Aider = 1210,
    Air = 24,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1231,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1230,
    ["Airlock Microgateway"] = 36,
    ["Alacritty Configuration"] = 1024,
    ["All Contributors configuration file"] = 1078,
    ...
    ["Application list for a WinUtil"] = 1160,
    ArchitectFX = 1165,
    ["Argo CD"] = 55,
    ["Argo Events"] = 56,
    ["Argo Workflows"] = 57,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1229,
    ["Azure IoT Operations connector metadata"] = 1226,
    ...
    ["Bacon config"] = 6,
    ["Barba-CV"] = 84,
    ["Bashly (bashly.yml)"] = 1082,
    ["Bashly Settings (bashly-settings.yml)"] = 1083,
    Bento = 1247,
    ["Better Code Hub"] = 994,
    ["Better Scripts"] = 163,
    Bigconfig = 134,
    ["Biome Formatter Config"] = 85,
    ["Bitmovin Encoding Template"] = 1174,
    BizTalkServerApplicationSchema = 960,
    Bleep = 164,
    ["Block Protocol Metadata"] = 161,
    ["Bluebricks blueprint config"] = 1253,
    ["Boyka Framework"] = 143,
    ...
    ["Butane Config"] = 1037,
    C4InterFlow = 1189,
    ["CDK Environment Manager, concrete environment configuration"] = 1213,
    ["CDK Environment Manager, concrete environments definition"] = 1212,
    ["CDK Environment Manager, environment definition"] = 1211,
    ["CGS Card Game Specification (cgs.json)"] = 1120,
    ["CICS TS region tagging"] = 1046,
    ["CICS TS resource import"] = 1047,
    ["CICS TS resource model"] = 1048,
    ["CICS TS resource overrides"] = 1049,
    ["CMake Presets"] = 165,
    ["CNC Codes"] = 187,
    ["CRS WAF test file"] = 1150,
    ["CRS WAF test platform overrides file"] = 1151,
    ...
    ["Chamaleon environment"] = 1178,
    ["Chamaleon properties"] = 1179,
    ["Chamaleon template"] = 1177,
    Changepacks = 1240,
    Changesets = 280,
    Changie = 174,
    Charmcraft = 175,
    ...
    ["Clawject config"] = 193,
    ["Cloud Foundry Application Manifest"] = 1132,
    ["Cloud Run Spec v1"] = 1155,
    ...
    Concord = 1149,
    ["Configu .cfgu files"] = 1137,
    ["Configu .configu file"] = 1138,
    Conjure = 186,
    ["Container Structure Test"] = 974,
    Containerlab = 1003,
    ["Contextive Glossary"] = 1205,
    Convex = 185,
    ["Crowdsec collection config"] = 290,
    ["Crowdsec parser config"] = 291,
    ["Crowdsec scenario config"] = 292,
    ["CumulusCI Config"] = 192,
    ["Cursor Agent Environment"] = 1258,
    ["Custom Machinery Machine"] = 1121,
    ["Custom Machinery Recipe"] = 1122,
    ...
    ["DonateCaseBetterCasino menu"] = 1182,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1090,
    ["EAS config"] = 360,
    ["ECA - Editor Code Assistant"] = 343,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1079,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1225,
    ["EasyVCR .NET"] = 362,
    ["Eidolon Resource"] = 1166,
    ...
    ["Erda Pipeline"] = 1128,
    ["Erda Runtime"] = 1129,
    ["Espanso config.yml"] = 1251,
    ["Espanso match.yml"] = 1250,
    Esquio = 348,
    ["Estuary Flow Catalog"] = 1043,
    ["Ethereum ERC1155"] = 1262,
    ["Ethereum ERC721"] = 1261,
    ...
    ["Evolving Resolutive Process notation"] = 1227,
    ["Expo SDK"] = 359,
    ...
    ["GeoJSON.json latest"] = 1041,
    GherKing = 1045,
    ["GitHub Action"] = 395,
    ["GitHub Actions typing"] = 1162,
    ...
    ["Google Digital Assetlinks"] = 1206,
    Goreleaser = 423,
    ["Goreleaser Pro"] = 424,
    Goss = 425,
    ["Gradle Build Cache Node"] = 992,
    ["Gradle Enterprise"] = 991,
    ...
    Hadolint = 970,
    Hammerkit = 1002,
    ["Hardware Sentry Configuration"] = 1057,
    ...
    ["JFrog File Spec"] = 476,
    ["JFrog Pipelines YML DSL"] = 1067,
    ["JMeter DSL cli config"] = 477,
    JReleaser = 480,
    ["JSON Document Transform"] = 488,
    ["JSON Feed"] = 489,
    ["JSON Resume"] = 741,
    ["JSON Schema Draft 2020-12"] = 938,
    ["JSON Schema Draft 4"] = 935,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1100,
    ["JSON Schema Draft 7"] = 936,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1101,
    ["JSON Schema Draft 8 (2019-09)"] = 937,
    ["JSON-API"] = 487,
    ["JSON-e templates"] = 999,
    ["JSON-stat 2.0"] = 931,
    JSONPatch = 491,
    ...
    ["Jujutsu (jj) VCS config"] = 1219,
    ["KIMMDY config file"] = 502,
    ["KODE/CI build.yaml"] = 1063,
    ["KSP-AVC"] = 932,
    ["KSP-CKAN"] = 933,
    ["KSP-NetKAN"] = 934,
    KSY = 1130,
    ...
    ["Metadata for a Cinnamon spice"] = 1158,
    ["Metatype Configuration"] = 544,
    ["MetricsHub Configuration"] = 545,
    ["MetricsHub Connector Configuration"] = 546,
    ["Micro Editor Syntax"] = 1091,
    ["Microsoft Band Web Tile"] = 547,
    ["Microsoft RulesEngine workflow rules"] = 1146,
    ["Microsoft RulesEngine workflow rules list"] = 1147,
    ["Minecraft Custom Main Menu Mod"] = 1109,
    ...
    ["MongoDB Atlas Search Index Definition"] = 1062,
    ["Monika Configuration"] = 1060,
    ["Monoweave Configuration"] = 574,
    ["Motif config"] = 952,
    MultiQC = 1199,
    ["NOX Framework (Service)"] = 595,
    ["Netin Diagnostic System Template"] = 1019,
    ["Netlify config"] = 582,
    ...
    ["OpenUtau ustx"] = 618,
    ["OpenWeather Current Weather API"] = 998,
    ["OpenWeather Road Risk API"] = 997,
    ...
    ["Power Pages Configuration"] = 1216,
    ["Preset list for a WinUtil"] = 1161,
    ...
    Pylock = 1207,
    Pyright = 713,
    ["Python script metadata"] = 1201,
    ["QType AI DSL"] = 716,
    Qgoda = 715,
    Qodana = 1029,
    ["Qt Creator workspace file"] = 1139,
    ["Quali Torque Blueprint Spec 2"] = 1054,
    ["QueryFirst config file"] = 1073,
    ["Qwen Code Settings"] = 1263,
    ["RKE Cluster Configuration JSON"] = 1007,
    ["RKE Cluster Configuration YAML"] = 1006,
    RadioHound = 706,
    ["Raid Profile"] = 1264,
    ["Raid Repo Configuration"] = 1265,
    Railpack = 718,
    Railway = 717,
    ["Rancher Fleet"] = 708,
    ["Rattler-build"] = 719,
    ...
    ["Replit config"] = 734,
    Restate = 1194,
    ["Revel Digital Gadget Definition File"] = 1218,
    RoadRunner = 747,
    ["Robust Station Image"] = 1224,
    Rockcraft = 748,
    ["Roo Coder Custom Modes"] = 749,
    Rubocop = 738,
    ["Rudder techniques"] = 1113,
    Ruff = 739,
    ["Rust Project"] = 740,
    ["Rust toolchain"] = 754,
    ...
    ["Serverless Framework Configuration"] = 1023,
    ["Serverless Workflow"] = 1025,
    ["Settings for a Cinnamon spice"] = 1157,
    ["Settings.paf"] = 787,
    ["Shopware 6 Configuration"] = 1026,
    ["Shopware CLI Extension Store Configuration"] = 1027,
    ["Shopware CLI Project Store Configuration"] = 1028,
    ["Sigma Detection Rule"] = 789,
    ["Sigrid scope configuration file"] = 790,
    ["SkyPilot Task JSON"] = 1114,
    ...
    StackBlitz = 833,
    ["StackHawk Scanner Configuration"] = 1022,
    Stale = 834,
    Starfish = 835,
    ["Starlake Data Pipeline"] = 995,
    Starship = 836,
    ...
    ["Stylua Config"] = 1208,
    ["Sublime Syntax"] = 1069,
    ["Subsquid squid manifest"] = 1116,
    ["Swagger API 2.0"] = 846,
    ["Synadia Connect Component"] = 847,
    TSON = 883,
    TSTyche = 884,
    ["TYPO3 Vendor Bundler config"] = 890,
    ["Tab data for a LinUtil"] = 1164,
    ["Tab list for a LinUtil"] = 1163,
    Tach = 848,
    ["Tach Domain"] = 849,
    Talhelper = 851,
    ["Talisman configuration"] = 852,
    Taplo = 1209,
    ["Taskfile config"] = 1000,
    Taurus = 853,
    Tauticord = 854,
    ["Tekton Pipeline"] = 1237,
    ["Tekton PipelineRun"] = 1238,
    ["Tekton Task"] = 1235,
    ["Tekton TaskRun"] = 1236,
    Telefonistka = 1195,
    ["Terrateam config"] = 1221,
    ...
    ["Tugboat QA config.yml"] = 1188,
    TunnelHub = 1104,
    Turborepo = 867,
    Tycho = 1153,
    Tye = 1030,
    ["Tyk Gateway - Open Source v5.7+"] = 1200,
    ["UET BuildConfig.json"] = 1074,
    ["UI5 Manifest"] = 896,
    ["UNCORS configuration"] = 900,
    ["UTAM Page Object"] = 899,
    ["Ubuntu Server Autoinstall"] = 894,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1192,
    ["Uniswap Token List"] = 981,
    ["Universal Schedule Format"] = 901,
    ["Unreal Engine Uplugin"] = 1075,
    ["Unreal Engine Uproject"] = 1076,
    ["UpCloud CLI (upctl) configuration"] = 1193,
    ["Updatecli Compose"] = 1038,
    ["Updatecli Policy Manifest"] = 1039,
    ["Updatecli Policy Metadata"] = 1040,
    Uplift = 1072,
    ["Upsun config"] = 7,
    ["User Journey Map"] = 1004,
    V2Ray = 1044,
    ...
    Vespertide = 1242,
    ["Vespertide Migration"] = 1243,
    ["Vespertide Model"] = 1244,
    ["Viash Component Config"] = 1197,
    ["Viash Package Config"] = 1198,
    Visivo = 1102,
    ["WP-CLI"] = 929,
    Wake = 1190,
    ["Waku Config"] = 1167,
    ...
    ["Web types"] = 928,
    WebExtensions = 924,
    ["Webman package recipe"] = 1050,
    ["Windows Package Manager Installer Manifest"] = 977,
    ["Windows Package Manager Locale Manifest"] = 978,
    ["Windows Package Manager Singleton Manifest"] = 976,
    Winutil = 979,
    ["WireMock CLI import configuration"] = 1173,
    ["WireMock CLI local service configuration"] = 1172,
    ["WireMock message stub mapping"] = 1171,
    ["WireMock stub mapping"] = 1170,
    ["Woodpecker pipeline config"] = 1018,
    ["Wrangler CLI"] = 930,
    ["Xstate Machine"] = 1036,
    ["Yandex Workflow Language"] = 1159,
    ["Yarn Config (.yarnrc.yml)"] = 993,
    ["Yippee-Ki-JSON configuration YML"] = 984,
    ["YouTrack App"] = 1156,
    ["Zarf Package Configuration"] = 1223,
    ["Zerops.io config"] = 1144,
    ["Zerops.io import"] = 1145,
    ["Zola Configuration"] = 1234,
    ["aerleon.yml"] = 20,
    ["amplify.yml"] = 13,
    ["angular.json"] = 37,
    apko = 1107,
    ...
    ["behat.yml"] = 144,
    ["bigquery-table"] = 133,
    ["bioimageio resource description"] = 1124,
    ...
    ["chutzpah.json"] = 263,
    cibuildwheel = 180,
    ["clang-format (.clang-format)"] = 1042,
    ["clang-tidy"] = 241,
    clangd = 240,
    clib = 242,
    ...
    ["crowdin.yml"] = 289,
    ["ctfd-setup configuration file"] = 1180,
    ["custom-elements.json"] = 1094,
    ["cypress.json"] = 293,
    ...
    ["gematik health care insurance list"] = 1186,
    ["gematik health care patient list"] = 1183,
    ["gematik health care provider institution list"] = 1185,
    ["gematik health care provider list"] = 1184,
    ["gematik tiger test environment configuration"] = 1187,
    ["git-town.toml"] = 1232,
    ["gitlab-ci"] = 403,
    ["global.json"] = 419,
    ...
    ["lint-staged (.lintstagedrc)"] = 946,
    ["local.settings.json"] = 531,
    ["localazy.json"] = 532,
    ["lotus.yaml"] = 530,
    ["lsdlschema.json"] = 533,
    ["macro.json"] = 1059,
    ["markdown-link-check"] = 1013,
    maturin = 1014,
    mboats = 1021,
    ["micro-settings.json"] = 1086,
    ["mimetypes.json"] = 548,
    ["mirrord config"] = 948,
    mise = 949,
    ["mkdocs.yml"] = 568,
    ...
    ["monospace.yml"] = 573,
    ["moon.yml"] = 1169,
    ["mprocs Configuration file"] = 1140,
    ["mrdocs.yml"] = 570,
    ["mta.yaml"] = 950,
    ["mtad.yaml"] = 951,
    ["mycode.json"] = 580,
    ...
    ["plagiarize.yaml"] = 658,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1176,
    ["podbard.yaml"] = 661,
    ["portman.json"] = 664,
    ["prefect.toml"] = 672,
    ["prefect.yaml"] = 673,
    ...
    ["servicehub.config.json"] = 941,
    ["servicehub.service.json"] = 940,
    ["settings.job"] = 786,
    ...
    ["text2confl config"] = 1257,
    ["theme.json"] = 859,
    ["tizen_workspace.json"] = 861,
    tldr = 862,
    ["tm_devices configuration file"] = 1214,
    tmuxinator = 944,
    tox = 864,
    ["transcend.yml"] = 873,
    ...
    ["vtesttree.yaml"] = 921,
    ["vtestunit.yaml"] = 922,
    ["warp-keysets.json"] = 1095,
    ["warp-themes.json"] = 1096,
    ["warp-workflows.json"] = 1097,
    ["webhint.io"] = 1051,
    ["webjobpublishsettings.json"] = 927,
    ["webjobs-list.json"] = 926,
    ["well-known-fursona"] = 1135,
    ["xs-app.json"] = 954,
    ["xunit.runner.json"] = 939,
    yamlfmt = 982,
    yamllint = 983,
    zizmor = 1239,
    zuul = 965,
