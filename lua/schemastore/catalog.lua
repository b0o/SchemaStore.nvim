...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1077,
    ["API Builder"] = 891,
    ["AVA Configuration"] = 953,
    ...
    ["AWS Copilot Manifest"] = 1115,
    ["AWS SAM CLI Samconfig"] = 223,
    ["Adobe UXP Manifest"] = 1015,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1106,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 925,
    ["All Contributors configuration file"] = 978,
    ...
    ["Application list for a WinUtil"] = 1059,
    ArchitectFX = 1064,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["BX CI"] = 123,
    ["Bashly (bashly.yml)"] = 982,
    ["Bashly Settings (bashly-settings.yml)"] = 983,
    ["Better Code Hub"] = 895,
    ["Better Scripts"] = 124,
    Bigconfig = 96,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1070,
    BizTalkServerApplicationSchema = 863,
    Bleep = 125,
    ...
    ["Butane Config"] = 938,
    C4InterFlow = 1085,
    ["CDK Environment Manager, concrete environment configuration"] = 1109,
    ["CDK Environment Manager, concrete environments definition"] = 1108,
    ["CDK Environment Manager, environment definition"] = 1107,
    ["CGS Card Game Specification (cgs.json)"] = 1020,
    ["CICS TS region tagging"] = 947,
    ["CICS TS resource import"] = 948,
    ["CICS TS resource model"] = 949,
    ["CICS TS resource overrides"] = 950,
    ["CMake Presets"] = 126,
    ["CNC Codes"] = 147,
    ["CRS WAF test file"] = 1049,
    ["CRS WAF test platform overrides file"] = 1050,
    ...
    ["Chamaleon environment"] = 1074,
    ["Chamaleon properties"] = 1075,
    ["Chamaleon template"] = 1073,
    Changesets = 232,
    Changie = 135,
    Charmcraft = 136,
    Cheatsheets = 935,
    ...
    ["Clawject config"] = 153,
    ["Cloud Foundry Application Manifest"] = 1031,
    ["Cloud Run Spec v1"] = 1054,
    ...
    Concord = 1048,
    ["Configu .cfgu files"] = 1036,
    ["Configu .configu file"] = 1037,
    Conjure = 146,
    ["Container Structure Test"] = 877,
    Containerlab = 904,
    ["Contextive Glossary"] = 1101,
    Convex = 145,
    ["Crowdsec collection config"] = 242,
    ["Crowdsec parser config"] = 243,
    ["Crowdsec scenario config"] = 244,
    ["CumulusCI Config"] = 152,
    ["Custom Machinery Machine"] = 1021,
    ["Custom Machinery Recipe"] = 1022,
    ...
    ["DonateCaseBetterCasino menu"] = 1078,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 990,
    ["EAS config"] = 308,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 979,
    ["EasyVCR .NET"] = 309,
    ["Eidolon Resource"] = 1065,
    ...
    ["GeoJSON.json latest"] = 942,
    GherKing = 946,
    ["GitHub Action"] = 339,
    ["GitHub Actions typing"] = 1061,
    ...
    ["Google Digital Assetlinks"] = 1102,
    Goreleaser = 367,
    ["Goreleaser Pro"] = 368,
    Goss = 369,
    ["Gradle Build Cache Node"] = 893,
    ["Gradle Enterprise"] = 892,
    ...
    Hadolint = 873,
    Hammerkit = 903,
    ["Hardware Sentry Configuration"] = 958,
    ["HashiCorp Vault"] = 381,
    Hatch = 874,
    Hayagriva = 383,
    Hayson = 384,
    ...
    ["JFrog File Spec"] = 415,
    ["JFrog Pipelines YML DSL"] = 967,
    ["JMeter DSL cli config"] = 416,
    JReleaser = 419,
    ["JSON Document Transform"] = 427,
    ["JSON Feed"] = 428,
    ["JSON Resume"] = 652,
    ["JSON Schema Draft 2020-12"] = 842,
    ["JSON Schema Draft 4"] = 839,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1000,
    ["JSON Schema Draft 7"] = 840,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1001,
    ["JSON Schema Draft 8 (2019-09)"] = 841,
    ["JSON-API"] = 426,
    ["JSON-e templates"] = 900,
    ["JSON-stat 2.0"] = 835,
    JSONPatch = 430,
    ...
    ["Jujutsu (jj) VCS config"] = 1114,
    ["KIMMDY config file"] = 441,
    ["KODE/CI build.yaml"] = 963,
    ["KSP-AVC"] = 836,
    ["KSP-CKAN"] = 837,
    ["KSP-NetKAN"] = 838,
    KSY = 1030,
    ...
    ["Metadata for a Cinnamon spice"] = 1057,
    ["Metatype Configuration"] = 480,
    ["MetricsHub Configuration"] = 481,
    ["MetricsHub Connector Configuration"] = 482,
    ["Micro Editor Syntax"] = 991,
    ["Microsoft Band Web Tile"] = 483,
    ["Microsoft RulesEngine workflow rules"] = 1045,
    ["Microsoft RulesEngine workflow rules list"] = 1046,
    ["Minecraft Custom Main Menu Mod"] = 1009,
    ...
    ["MongoDB Atlas Search Index Definition"] = 962,
    ["Monika Configuration"] = 960,
    ["Monoweave Configuration"] = 508,
    ["Motif config"] = 855,
    MultiQC = 1095,
    ["NOX Framework (Service)"] = 526,
    ["Netin Diagnostic System Template"] = 920,
    ["Netlify config"] = 516,
    ["Network-as-Code Data Model"] = 517,
    ["Nightwatch.js"] = 519,
    ["Node.js configuration"] = 860,
    ...
    ["OpenUtau ustx"] = 544,
    ["OpenWeather Current Weather API"] = 899,
    ["OpenWeather Road Risk API"] = 898,
    ...
    ["Power Pages Configuration"] = 1112,
    ["Preset list for a WinUtil"] = 1060,
    ...
    Pylock = 1103,
    Pyright = 627,
    ["Python script metadata"] = 1097,
    ["QType AI DSL"] = 630,
    Qgoda = 629,
    Qodana = 930,
    ["Qt Creator workspace file"] = 1038,
    ["Quali Torque Blueprint Spec 2"] = 955,
    ["QueryFirst config file"] = 973,
    ["RKE Cluster Configuration JSON"] = 908,
    ["RKE Cluster Configuration YAML"] = 907,
    RadioHound = 620,
    Railway = 631,
    ["Rancher Fleet"] = 622,
    ["Rattler-build"] = 632,
    ...
    ["SauceCTL Configuration"] = 917,
    ["Schema Catalog"] = 679,
    ["Scoop manifest"] = 684,
    ["Semantic Data Fabric (SDF) file"] = 688,
    ["Semgrep Rule"] = 690,
    ["Serenity Code Generator (Sergen)"] = 691,
    ["Serverless Framework Configuration"] = 924,
    ["Serverless Workflow"] = 926,
    ["Settings for a Cinnamon spice"] = 1056,
    ["Settings.paf"] = 693,
    ["Shopware 6 Configuration"] = 927,
    ["Shopware CLI Extension Store Configuration"] = 928,
    ["Shopware CLI Project Store Configuration"] = 929,
    ["Sigma Detection Rule"] = 695,
    ["Sigrid scope configuration file"] = 696,
    ["SkyPilot Task JSON"] = 1014,
    ...
    StackBlitz = 738,
    ["StackHawk Scanner Configuration"] = 923,
    Stale = 739,
    ["Starlake Data Pipeline"] = 896,
    Starship = 740,
    ["Statamic Blueprint"] = 741,
    ["Stella configuration file"] = 742,
    ["Stryker Mutator"] = 745,
    ["StyleCop Analyzers Configuration"] = 746,
    ["Stylelint (.stylelintrc)"] = 747,
    ["Stylua Config"] = 1104,
    ["Sublime Syntax"] = 969,
    ["Subsquid squid manifest"] = 1016,
    ["Swagger API 2.0"] = 749,
    ["Synadia Connect Component"] = 750,
    TSON = 785,
    TSTyche = 786,
    ["TYPO3 Vendor Bundler config"] = 791,
    ["Tab data for a LinUtil"] = 1063,
    ["Tab list for a LinUtil"] = 1062,
    Tach = 751,
    ["Tach Domain"] = 752,
    Talhelper = 754,
    ["Talisman configuration"] = 755,
    Taplo = 1105,
    ["Taskfile config"] = 901,
    Taurus = 756,
    Tauticord = 757,
    Telefonistka = 1091,
    ["Terrateam config"] = 1116,
    ["TestEnvironment.json"] = 768,
    ["TextMate Grammar"] = 767,
    Threagile = 763,
    ["Tier.run pricing.json"] = 760,
    Tikibase = 761,
    Tombi = 766,
    ["Traefik v2"] = 771,
    ["Traefik v2 File Provider"] = 772,
    ["Traefik v3"] = 773,
    ["Traefik v3 File Provider"] = 774,
    ["Travis CI (.travis.yml)"] = 770,
    Trident = 1087,
    ["TrueScript for *.tscript files"] = 777,
    ["Tugboat QA config.yml"] = 1084,
    TunnelHub = 1004,
    Turborepo = 769,
    Tycho = 1052,
    Tye = 931,
    ["Tyk Gateway - Open Source v5.7+"] = 1096,
    ["Typst Manifest"] = 792,
    ["UET BuildConfig.json"] = 974,
    ["UI5 Manifest"] = 798,
    ["UNCORS configuration"] = 802,
    ["UTAM Page Object"] = 801,
    ["Ubuntu Server Autoinstall"] = 796,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1088,
    ["Uniswap Token List"] = 884,
    ["Universal Schedule Format"] = 803,
    ["Unreal Engine Uplugin"] = 975,
    ["Unreal Engine Uproject"] = 976,
    ["UpCloud CLI (upctl) configuration"] = 1089,
    ["Updatecli Compose"] = 939,
    ["Updatecli Policy Manifest"] = 940,
    ["Updatecli Policy Metadata"] = 941,
    Uplift = 972,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 905,
    V2Ray = 945,
    ["VSCode Code Snippets"] = 207,
    ["VSIX CLI publishing"] = 823,
    Vector = 805,
    ["Vela Pipeline Configuration"] = 808,
    Vercel = 206,
    ["Version Bumper config"] = 813,
    ["Viash Component Config"] = 1093,
    ["Viash Package Config"] = 1094,
    Visivo = 1002,
    ["WP-CLI"] = 833,
    Wake = 1086,
    ["Waku Config"] = 1066,
    ["Web App Manifest"] = 829,
    ["Web types"] = 832,
    WebExtensions = 828,
    ["Webman package recipe"] = 951,
    ["Windows Package Manager Installer Manifest"] = 880,
    ["Windows Package Manager Locale Manifest"] = 881,
    ["Windows Package Manager Singleton Manifest"] = 879,
    Winutil = 882,
    ["WireMock stub mapping"] = 1069,
    ["Woodpecker pipeline config"] = 919,
    ["Wrangler CLI"] = 834,
    ["Xstate Machine"] = 937,
    ["Yandex Workflow Language"] = 1058,
    ["Yarn Config (.yarnrc.yml)"] = 894,
    ["Yippee-Ki-JSON configuration YML"] = 886,
    ["YouTrack App"] = 1055,
    ["Zarf Package Configuration"] = 1118,
    ["Zerops.io config"] = 1043,
    ["Zerops.io import"] = 1044,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 1007,
    ...
    ["behat.yml"] = 106,
    ["bigquery-table"] = 95,
    ["bioimageio resource description"] = 1024,
    ...
    ["crowdin.yml"] = 241,
    ["ctfd-setup configuration file"] = 1076,
    ["custom-elements.json"] = 994,
    ["cypress.json"] = 245,
    ...
    ["gematik health care insurance list"] = 1082,
    ["gematik health care patient list"] = 1079,
    ["gematik health care provider institution list"] = 1081,
    ["gematik health care provider list"] = 1080,
    ["gematik tiger test environment configuration"] = 1083,
    ["gitlab-ci"] = 347,
    ["global.json"] = 363,
    ...
    ["lint-staged (.lintstagedrc)"] = 850,
    ["local.settings.json"] = 469,
    ["localazy.json"] = 470,
    ["lotus.yaml"] = 468,
    ["lsdlschema.json"] = 471,
    ["markdown-link-check"] = 914,
    maturin = 915,
    mboats = 922,
    ["micro-settings.json"] = 986,
    ["mimetypes.json"] = 484,
    ["mirrord config"] = 851,
    mise = 852,
    ["mkdocs.yml"] = 504,
    ["monospace.yml"] = 507,
    ["moon.yml"] = 1068,
    ["mprocs Configuration file"] = 1039,
    ["mrdocs.yml"] = 505,
    ["mta.yaml"] = 853,
    ["mtad.yaml"] = 854,
    ["mycode.json"] = 514,
    ...
    ["plagiarize.yaml"] = 580,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1072,
    ["podbard.yaml"] = 583,
    ["portman.json"] = 584,
    ["prefect.toml"] = 592,
    ["prettierrc.json"] = 593,
    ...
    ["servicehub.config.json"] = 845,
    ["servicehub.service.json"] = 844,
    ["settings.job"] = 692,
    ...
    ["stripe-app-local.json"] = 744,
    ["stripe-app.json"] = 743,
    swcrc = 897,
    ["task.json"] = 753,
    taskcat = 862,
    ["template.json"] = 758,
    ["templatsources.json"] = 759,
    ["theme.json"] = 762,
    ["tizen_workspace.json"] = 764,
    tldr = 765,
    ["tm_devices configuration file"] = 1110,
    tmuxinator = 848,
    ["transcend.yml"] = 775,
    ["tree-sitter grammar.json"] = 371,
    ["trime.yaml"] = 776,
    ["trunk.yaml"] = 778,
    ["ts-force-config.json"] = 783,
    ["tsconfig.json"] = 779,
    ["tsd.json"] = 780,
    ["tsdoc.json"] = 781,
    ["tsdrc.json"] = 782,
    ...
    ["vega-lite.json"] = 807,
    ["vega.json"] = 806,
    ["venvironment-basic.yaml"] = 810,
    ["venvironment.yaml"] = 809,
    ["venvplus-basic.yaml"] = 812,
    ["venvplus.yaml"] = 811,
    version = 1092,
    ["version.json"] = 814,
    ["vhwdebugger-binding.yaml"] = 816,
    ["vim-addon-info"] = 817,
    ["vs-2017.3.host.json"] = 819,
    ["vs-nesting.json"] = 820,
    ["vsls.json"] = 818,
    ["vss-extension.json"] = 824,
    vtcfg = 1098,
    ["vtesttree.yaml"] = 825,
    ["vtestunit.yaml"] = 826,
    ["warp-keysets.json"] = 995,
    ["warp-themes.json"] = 996,
    ["warp-workflows.json"] = 997,
    ["webhint.io"] = 952,
    ["webjobpublishsettings.json"] = 831,
    ["webjobs-list.json"] = 830,
    ["well-known-fursona"] = 1034,
    ["xs-app.json"] = 857,
    ["xunit.runner.json"] = 843,
    yamllint = 885,
    zuul = 868,
    ["Žinoma"] = 878
  },
