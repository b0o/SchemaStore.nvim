...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 204,
    [".cryproj (generic)"] = 705,
    [".cryproj engine-5.2"] = 700,
    [".cryproj engine-5.3"] = 701,
    [".cryproj engine-5.4"] = 702,
    [".cryproj engine-5.5"] = 703,
    [".cryproj engine-dev"] = 704,
    [".eslintrc"] = 268,
    [".esmrc.json"] = 253,
    [".ffizer.yaml"] = 272,
    [".htmlhintrc"] = 342,
    ...
    [".mtaext"] = 716,
    [".nodehawkrc"] = 457,
    [".npmpackagejsonlintrc"] = 461,
    [".omletrc"] = 891,
    [".phrase.yml"] = 508,
    [".phraseapp.yml"] = 509,
    [".pmbot.yml"] = 498,
    [".postcssrc"] = 503,
    [".powerpages-web-template-manifest"] = 505,
    [".pre-commit-config.yml"] = 506,
    [".pre-commit-hooks.yml"] = 507,
    [".putout.json"] = 528,
    [".rehyperc"] = 547,
    [".remarkrc"] = 549,
    [".sprite files"] = 608,
    ...
    ["<div>RIOTS' studio configuration"] = 683,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 411,
    ABCSupplyPlan = 13,
    AIConfig = 14,
    ["API Builder"] = 748,
    ["AVA Configuration"] = 808,
    ["AWS CDK cdk.json"] = 179,
    ["AWS CloudFormation"] = 180,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 181,
    ["AWS SAM CLI Samconfig"] = 182,
    ["Adobe UXP Manifest"] = 873,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 15,
    ["Airplane task"] = 16,
    ["Alacritty Configuration"] = 780,
    ["All Contributors configuration file"] = 838,
    ["Ansible Argument Specs"] = 308,
    ["Ansible Collection Galaxy"] = 315,
    ["Ansible Execution Environment"] = 305,
    ["Ansible Inventory"] = 314,
    ["Ansible Meta"] = 306,
    ["Ansible Meta Runtime"] = 307,
    ["Ansible Navigator Configuration"] = 317,
    ["Ansible Playbook"] = 312,
    ["Ansible Requirements"] = 309,
    ["Ansible Rulebook"] = 313,
    ["Ansible Tasks File"] = 311,
    ["Ansible Vars File"] = 310,
    ["Ansible-lint Configuration"] = 316,
    Any = 900,
    ...
    ["Azure Pipelines"] = 59,
    ["Azure Static Web Apps CLI configuration file"] = 611,
    ["Azure Static Web Apps configuration file"] = 610,
    ["BX CI"] = 98,
    ["Bashly (bashly.yml)"] = 842,
    ["Bashly Settings (bashly-settings.yml)"] = 843,
    ["Better Code Hub"] = 752,
    ["Better Scripts"] = 99,
    Bigconfig = 76,
    BizTalkServerApplicationSchema = 722,
    Bleep = 100,
    ...
    ["Butane Config"] = 793,
    ["CGS Custom Card Game (CardGameDef.json)"] = 878,
    ["CICS TS region tagging"] = 802,
    ["CICS TS resource import"] = 803,
    ["CICS TS resource model"] = 804,
    ["CICS TS resource overrides"] = 805,
    ["CMake Presets"] = 101,
    ["CNC Codes"] = 115,
    ["CRS WAF test file"] = 907,
    ["CRS WAF test platform overrides file"] = 908,
    ...
    Changesets = 191,
    Cheatsheets = 790,
    ["Chrome Extension"] = 172,
    ["Chromia Model"] = 109,
    ["CircleCI config.yml"] = 148,
    ["Citation File Format"] = 193,
    CityJSON = 111,
    ["Clawject config"] = 120,
    ["Cloud Foundry Application Manifest"] = 890,
    ["CloudEvents specification"] = 112,
    ["Code Climate"] = 149,
    CodeCV = 55,
    CodeRabbit = 54,
    ["CodeShip Pro services configuration files"] = 161,
    ["CodeShip Pro steps configuration files"] = 162,
    ["Codecov configuration files"] = 160,
    Codux = 158,
    ["Cog config file"] = 116,
    ["Commandbox Box.json"] = 117,
    ["Commandbox Server.json"] = 118,
    ["Common Catalog Data"] = 170,
    Concord = 906,
    ["Configu .cfgu files"] = 895,
    ["Configu .configu file"] = 896,
    Conjure = 114,
    ["Container Structure Test"] = 735,
    Containerlab = 760,
    ["Crowdsec collection config"] = 200,
    ["Crowdsec parser config"] = 201,
    ["Crowdsec scenario config"] = 202,
    ["CumulusCI Config"] = 119,
    ["Custom Machinery Machine"] = 879,
    ["Custom Machinery Recipe"] = 880,
    ["Cycle Stack File"] = 122,
    ["DWP Exchange - catalogue entry"] = 248,
    ["DWP Exchange - gateway"] = 246,
    ["DWP Exchange - meta"] = 247,
    ["Dart Build Config (dart-build.json)"] = 208,
    ["Dart Test Config (dart-test.json)"] = 209,
    ["DashLord Configuration"] = 210,
    ["Data Contract Specification"] = 211,
    ["Data Product Specification"] = 212,
    ["DataYoga Connections"] = 123,
    ["DataYoga Job"] = 124,
    ["Databricks Asset Bundles"] = 859,
    ["Datadog Service Definition"] = 386,
    ["Datadog Software Catalog"] = 387,
    ["Datahub Ingestion Recipe"] = 809,
    ["Dein Config"] = 126,
    ["Deno Config (deno.json)"] = 218,
    ["Dependency cruiser"] = 127,
    ["Deployer Recipe"] = 221,
    ["Deta Spacefile"] = 128,
    ["Detekt Config (detekt.yml)"] = 222,
    ["Devbox Config"] = 129,
    ["Devbox Plugin"] = 130,
    Devfile = 245,
    DipDup = 909,
    ["Discord Webhook"] = 223,
    ["DocFx Config (docfx.json)"] = 227,
    ["Dolittle Artifacts"] = 228,
    ["Dolittle Bounded Context Configuration"] = 229,
    ["Dolittle Event Horizons Configuration"] = 230,
    ["Dolittle Resources Configuration"] = 231,
    ["Dolittle Server Configuration"] = 232,
    ["Dolittle Tenant Map Configuration"] = 234,
    ["Dolittle Tenants Configuration"] = 233,
    ["Dolittle Topology"] = 235,
    ["Drupal Breakpoints"] = 131,
    ["Drupal Config"] = 143,
    ["Drupal Info"] = 132,
    ["Drupal Layouts"] = 133,
    ["Drupal Libraries"] = 134,
    ["Drupal Links Action"] = 135,
    ["Drupal Links Contextual"] = 136,
    ["Drupal Links Menu"] = 137,
    ["Drupal Links Task"] = 138,
    ["Drupal Migration"] = 139,
    ["Drupal Permissions"] = 140,
    ["Drupal Recipe"] = 141,
    ["Drupal Routing"] = 142,
    ["Drupal Services"] = 144,
    ["Drush site aliases"] = 241,
    ["Dynamic Bash Aliases (.aliases)"] = 850,
    ["EAS config"] = 266,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 839,
    ["Elgato Stream Deck"] = 251,
    ["Embrace Config"] = 820,
    Endurica = 863,
    ["Enterprise Contract Policy Spec"] = 252,
    ["Erda Pipeline"] = 886,
    ["Erda Runtime"] = 887,
    ["Error pages"] = 256,
    Esquio = 254,
    ["Estuary Flow Catalog"] = 799,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 259,
    ["EveryVoice TTS Toolkit Data Configuration"] = 260,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 264,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 263,
    ["EveryVoice TTS Toolkit Text Configuration"] = 261,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 262,
    ["Expo SDK"] = 265,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 875,
    GitVersion = 292,
    ["Gitea Issue Template configuration"] = 293,
    ["Gitea Issue Template forms"] = 294,
    ["Gitpod Configuration"] = 304,
    ["GlazeWM settings"] = 877,
    ["Global Privacy Control"] = 291,
    Goblet = 858,
    ["Golangci-lint Configuration"] = 319,
    ["Golangci-lint Custom Plugins Configuration"] = 320,
    ["Google Chrome Related Website Sets"] = 274,
    ["Google Cloud Workflows"] = 178,
    Goreleaser = 322,
    ["Goreleaser Pro"] = 323,
    Goss = 324,
    ["Gradle Build Cache Node"] = 750,
    ["Gradle Enterprise"] = 749,
    ["Grafana 5.x Dashboard"] = 325,
    ["GraphQL Code Generator"] = 329,
    ["GraphQL Config"] = 328,
    ["GraphQL Mesh"] = 327,
    ["Grunt JSHint task"] = 333,
    ["Grunt Watch task"] = 334,
    ["Grunt base task"] = 335,
    ["Grunt clean task"] = 331,
    ["Grunt copy task"] = 330,
    ["Grunt cssmin task"] = 332,
    HEMTT = 719,
    Hadolint = 731,
    Hammerkit = 759,
    ["Hardware Sentry Configuration"] = 813,
    Hatch = 732,
    Hayson = 337,
    ["Haystack Pipeline"] = 338,
    ["Hazelcast 5 Configuration"] = 339,
    ["Helm Chart.lock"] = 146,
    ["Helm Chart.yaml"] = 145,
    ["Helm Unittest Test Suite"] = 147,
    Hugo = 789,
    ["Hugo Theme"] = 788,
    ["Hyperfoil benchmark configuration"] = 345,
    ["IBM Zapp document"] = 346,
    ["IBM zCodeFormatSettings"] = 347,
    ["IMG Catapult PSP"] = 352,
    ["IVMS101 by CODE Protocol"] = 876,
    Infrahub = 354,
    Istanbul = 816,
    ["JDownloader2 crawler multi-rules"] = 363,
    ["JDownloader2 crawler single-rules"] = 362,
    ["JFrog Applications Config"] = 364,
    ["JFrog File Spec"] = 365,
    ["JFrog Pipelines YML DSL"] = 822,
    ["JMeter DSL cli config"] = 366,
    JReleaser = 368,
    ["JSON Document Transform"] = 376,
    ["JSON Feed"] = 377,
    ["JSON Resume"] = 554,
    ["JSON Schema Draft 2020-12"] = 696,
    ["JSON Schema Draft 4"] = 693,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 860,
    ["JSON Schema Draft 7"] = 694,
    ["JSON Schema Draft 7 (unofficial strict)"] = 861,
    ["JSON Schema Draft 8 (2019-09)"] = 695,
    ["JSON-API"] = 375,
    ["JSON-WF"] = 889,
    ["JSON-e templates"] = 757,
    ["JSON-stat 2.0"] = 690,
    JSONPatch = 379,
    ["JSR Package Config (jsr.json)"] = 369,
    Jasmine = 358,
    Jekyll = 359,
    ["Jenkins X Pipelines"] = 360,
    ["Jenkins X Requirements"] = 361,
    ["Jovo Language Models"] = 367,
    ["KIMMDY config file"] = 384,
    ["KSP-AVC"] = 691,
    ["KSP-CKAN"] = 692,
    KSY = 888,
    ["Karakum configuration file"] = 284,
    Kas = 382,
    ["Keycloak REST API"] = 830,
    ["Knative Functions - func.yaml"] = 285,
    ["KoDE/CI build.yaml"] = 818,
    ["Kong DBLess config"] = 819,
    KrakenD = 385,
    ["Kubri Configuration"] = 391,
    LOOBin = 406,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 183,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 184,
    ["Landing Zone Accelerator on AWS - Global Config"] = 185,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 186,
    ["Landing Zone Accelerator on AWS - Network Config"] = 187,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 188,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 189,
    ["Landing Zone Accelerator on AWS - Security Config"] = 190,
    ["Language configuration"] = 899,
    Lefthook = 395,
    ["Liferay client-extension.yaml"] = 402,
    ["LinkML Metamodel"] = 404,
    Liquibase = 765,
    ["Liquibase Flow File"] = 766,
    ["Lively Properties"] = 405,
    ["Lobe AI Agent"] = 57,
    Loki = 58,
    ["MLOS Configs"] = 441,
    ["MS2Rescore Configuration"] = 444,
    ["Madness (madness.yml)"] = 841,
    Markdownlint = 769,
    ["Mason Registry"] = 771,
    ["MegaLinter configuration"] = 412,
    ["MegaLinter descriptor"] = 413,
    Melange = 867,
    ["Meltano plugin discovery definition"] = 415,
    ["Meltano project definition"] = 414,
    ["Mergify Configuration"] = 445,
    ["Metadata for a Bazel module"] = 416,
    ["MetricsHub Configuration"] = 417,
    ["MetricsHub Connector Configuration"] = 418,
    ["Micro Editor Syntax"] = 851,
    ["Microsoft Band Web Tile"] = 419,
    ["Microsoft RulesEngine workflow rules"] = 903,
    ["Microsoft RulesEngine workflow rules list"] = 904,
    ["Minecraft Custom Main Menu Mod"] = 868,
    ["Minecraft Data Pack Advancement"] = 421,
    ["Minecraft Data Pack Biome"] = 422,
    ["Minecraft Data Pack Configured Carver"] = 423,
    ["Minecraft Data Pack Damage Type"] = 424,
    ["Minecraft Data Pack Dimension"] = 426,
    ["Minecraft Data Pack Dimension Type"] = 425,
    ["Minecraft Data Pack Item Modifier"] = 427,
    ["Minecraft Data Pack Loot Table"] = 428,
    ["Minecraft Data Pack Metadata"] = 429,
    ["Minecraft Data Pack Predicate"] = 430,
    ["Minecraft Data Pack Recipe"] = 431,
    ["Minecraft Data Pack Tag"] = 432,
    ["Minecraft Data Pack Template Pool"] = 433,
    ["Minecraft Data Pack Trim Material"] = 438,
    ["Minecraft Data Pack Trim Pattern"] = 439,
    ["Minecraft Resource Pack Lang"] = 434,
    ["Minecraft Resource Pack Particle"] = 435,
    ["Minecraft Resource Pack Texture Mcmeta"] = 437,
    ["Minecraft Resourcepack Sounds"] = 436,
    ["Monade CLI Stack Configuration"] = 448,
    ["MongoDB Atlas Search Index Definition"] = 817,
    ["Monika Configuration"] = 815,
    ["Monoweave Configuration"] = 443,
    ["Motif config"] = 715,
    ["NOX Framework (Service)"] = 460,
    ["Netin Diagnostic System Template"] = 775,
    ["Netlify config"] = 451,
    ["Network-as-Code Data Model"] = 452,
    ["Nightwatch.js"] = 453,
    ["Nuitka.yaml"] = 881,
    ["ONe's changelog entry"] = 476,
    ["ONe's service descriptor"] = 475,
    ["OSS Review Toolkit configuration"] = 484,
    ["OSS Review Toolkit curation"] = 485,
    ["OSS Review Toolkit package configuration"] = 486,
    ["OSS Review Toolkit repository configuration"] = 487,
    ["OSS Review Toolkit resolutions"] = 488,
    Opctl = 718,
    ["Open Data Contract Standard (ODCS))"] = 479,
    ["OpenRewrite Resource"] = 478,
    ["OpenUtau character yaml"] = 472,
    ["OpenUtau ustx"] = 473,
    ["OpenWeather Current Weather API"] = 756,
    ["OpenWeather Road Risk API"] = 755,
    ["Ory Hydra configuration"] = 344,
    ["Ory Keto configuration"] = 388,
    ["Ory Kratos configuration"] = 483,
    ["Ory Oathkeeper configuration"] = 467,
    ["Outblocks App configuration"] = 481,
    ["Outblocks database table"] = 482,
    ["Outblocks project configuration"] = 480,
    PDM = 494,
    Packer = 491,
    Pantsbuild = 837,
    ["Paper paper-plugin.yml"] = 492,
    ["Pipeline component"] = 767,
    ["PocketMine plugin.yml"] = 499,
    ["Postman collection"] = 504,
    ["Problem object RFC9457"] = 865,
    ["Problem package generators"] = 512,
    Pterodactyl = 812,
    ["Pull Request Labeler"] = 527,
    Pulumi = 533,
    PyProject = 534,
    Pyright = 535,
    Qgoda = 536,
    Qodana = 785,
    ["Qt Creator workspace file"] = 897,
    ["Quali Torque Blueprint Spec 2"] = 810,
    ["QueryFirst config file"] = 833,
    ["RKE Cluster Configuration JSON"] = 764,
    ["RKE Cluster Configuration YAML"] = 763,
    ["Rancher Fleet"] = 530,
    ["Rattler-build"] = 537,
    Ray = 730,
    ["Read the Docs"] = 532,
    ["Red-DiscordBot Cog"] = 544,
    ["Red-DiscordBot Cog Repo"] = 545,
    ["Red-DiscordBot Trivia"] = 546,
    ["Render Blueprints"] = 762,
    RenderCV = 556,
    Renovate = 555,
    ["Replit config"] = 550,
    RoadRunner = 557,
    ["Rudder techniques"] = 871,
    Ruff = 552,
    ["Rust Project"] = 553,
    ["Rust toolchain"] = 561,
    ["SDMX data message"] = 586,
    ["SDMX metadata message"] = 585,
    ["SDMX structure message"] = 584,
    ["SIL Kit Participant Configuration"] = 596,
    ["SIL Kit Registry Configuration"] = 597,
    SWADL = 622,
    ["Safebox Config"] = 823,
    ["Sapphire CLI Config"] = 564,
    ["SauceCTL Configuration"] = 772,
    ["Schema Catalog"] = 578,
    ["Scoop manifest"] = 583,
    ["Semantic Data Fabric (SDF) file"] = 587,
    ["Semgrep Rule"] = 589,
    ["Serenity Code Generator (Sergen)"] = 590,
    ["Serverless Framework Configuration"] = 779,
    ["Serverless Workflow"] = 781,
    ["Settings.paf"] = 592,
    ["Shopware 6 Configuration"] = 782,
    ["Shopware CLI Extension Store Configuration"] = 783,
    ["Shopware CLI Project Store Configuration"] = 784,
    Sigma = 594,
    ["Sigrid scope configuration file"] = 595,
    ["SkyPilot Task JSON"] = 872,
    ["Slack app manifest"] = 599,
    Solidarity = 602,
    ["Solution filters"] = 603,
    ["Source Maps v3"] = 604,
    Sourcery = 605,
    SpecIF = 606,
    ["Sponge Mixin configuration"] = 607,
    StackBlitz = 612,
    ["StackHawk Scanner Configuration"] = 778,
    Stale = 613,
    ["Starlake Data Pipeline"] = 753,
    Starship = 614,
    ["Statamic Blueprint"] = 615,
    ["Stella configuration file"] = 616,
    ["StrmPrivacy Data Connector"] = 827,
    ["StrmPrivacy Data Contract"] = 828,
    ["StrmPrivacy SimpleSchema"] = 825,
    ["StrmPrivacy Stream"] = 826,
    ["StrmPrivacy batch job configuration file"] = 824,
    ["Stryker Mutator"] = 619,
    ["StyleCop Analyzers Configuration"] = 620,
    ["Stylelint (.stylelintrc)"] = 621,
    ["Sublime Syntax"] = 829,
    ["Subsquid squid manifest"] = 874,
    ["Swagger API 2.0"] = 623,
    TSON = 649,
    TSTyche = 650,
    Talhelper = 625,
    ["Talisman configuration"] = 626,
    ["Taskfile config"] = 758,
    Taurus = 627,
    ["TestEnvironment.json"] = 636,
    ["TextMate Grammar"] = 635,
    ["Tier.run pricing.json"] = 630,
    Tikibase = 631,
    ["Traefik v2"] = 639,
    ["Traefik v2 File Provider"] = 640,
    ["Travis CI (.travis.yml)"] = 638,
    TunnelHub = 864,
    Turborepo = 637,
    Tycho = 910,
    Tye = 786,
    ["UET BuildConfig.json"] = 834,
    ["UI5 Manifest"] = 659,
    ["UNCORS configuration"] = 663,
    ["UTAM Page Object"] = 662,
    ["Ubuntu Server Autoinstall"] = 657,
    ["Uniswap Token List"] = 741,
    ["Unreal Engine Uplugin"] = 835,
    ["Unreal Engine Uproject"] = 836,
    ["Updatecli Compose"] = 794,
    ["Updatecli Policy Manifest"] = 795,
    ["Updatecli Policy Metadata"] = 796,
    Uplift = 832,
    ["User Journey Map"] = 761,
    V2Ray = 800,
    ["VSCode Code Snippets"] = 166,
    ["VSIX CLI publishing"] = 678,
    ["Vela Pipeline Configuration"] = 667,
    Vercel = 165,
    Visivo = 862,
    ["Web App Manifest"] = 685,
    ["Web types"] = 688,
    WebExtensions = 684,
    ["Webman package recipe"] = 806,
    ["Windows Package Manager Installer Manifest"] = 738,
    ["Windows Package Manager Locale Manifest"] = 739,
    ["Windows Package Manager Singleton Manifest"] = 737,
    ["Woodpecker pipeline config"] = 774,
    ["Wrangler CLI"] = 689,
    ["Xstate Machine"] = 792,
    ["Yarn Config (.yarnrc.yml)"] = 751,
    ["Yippee-Ki-JSON configuration YML"] = 743,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 866,
    ...
    ["behat.yml"] = 84,
    ["bigquery-table"] = 75,
    ["bioimageio resource description"] = 882,
    ...
    changelogging = 894,
    ["chisel-slices.json"] = 192,
    ["chrome-extension-locales-messages.json"] = 173,
    ["chutzpah.json"] = 174,
    cibuildwheel = 110,
    ["clang-format (.clang-format)"] = 798,
    ["clang-tidy"] = 153,
    clangd = 152,
    clib = 154,
    ["cloud-init: cloud-config userdata"] = 156,
    ["cloud-sdk-pipeline-configuration"] = 176,
    ["cloudbuild.json"] = 177,
    cloudify = 155,
    codemagic = 157,
    ["coffeelint.json"] = 194,
    ["commands.json"] = 169,
    ["commitlint (.commitlintrc)"] = 740,
    ["compile_commands.json"] = 168,
    ["compilerconfig.json"] = 167,
    ["completely.yml"] = 840,
    ["component-detection-manifest.json"] = 197,
    ["component.json"] = 196,
    ["composer.json"] = 195,
    ["conda-forge"] = 113,
    ["config.yaml"] = 531,
    ["contentmanifest.json"] = 175,
    ["contribute.json"] = 198,
    ["cosmos.config.json"] = 171,
    ["crowdin.yml"] = 199,
    ["custom-elements.json"] = 854,
    ["cypress.json"] = 203,
    ["datalogic-scan2deploy-android"] = 213,
    ["datalogic-scan2deploy-ce"] = 214,
    ["dbt Project"] = 125,
    ["ddev-global"] = 215,
    ["ddev-project"] = 216,
    ["debugsettings.json"] = 217,
    ["dependabot-v2.json"] = 220,
    ["dependabot.json"] = 219,
    ["deployed-cli"] = 791,
    ["devcontainer.json"] = 159,
    devinit = 745,
    ["devspace.yaml"] = 814,
    djlint = 746,
    ["docker bake"] = 225,
    ["docker sequencer"] = 226,
    ["docker-compose.yml"] = 744,
    ["dockerd.json"] = 224,
    ["dotnet Release Index manifest"] = 236,
    ["dotnet-tools.json"] = 237,
    ["dotnetcli.host.json"] = 238,
    ["dprint.json"] = 239,
    ["drone.json"] = 240,
    ["dss-2.0.0.json"] = 242,
    ["dstack configuration"] = 243,
    ["dvc.yaml"] = 244,
    ["ecosystem.json"] = 249,
    eksctl = 250,
    ["electron-builder configuration file"] = 257,
    ["epr-manifest.json"] = 255,
    ["evcc.yaml"] = 258,
    ["ezd task runner"] = 267,
    ["fabric.mod.json"] = 270,
    ...
    ["gitlab-ci"] = 303,
    ["global.json"] = 318,
    ["go-feature-flag Flag Configuration"] = 321,
    ["haxelib.json"] = 336,
    helmfile = 733,
    helmwave = 734,
    ["host-meta.json"] = 341,
    ...
    ["ide.host.json"] = 348,
    ["ifstate.conf"] = 349,
    ["imageoptimizer.json"] = 350,
    ["importmap.json"] = 353,
    ["ioBroker Configuration"] = 355,
    ["ioBroker JSON UI"] = 356,
    ["ioBroker Package manifest"] = 357,
    ["ize.toml"] = 831,
    ["jsconfig.json"] = 380,
    ["jscpd Configuration"] = 811,
    jsdoc = 729,
    ["k3d.yaml"] = 381,
    ["k9s plugin.yml"] = 383,
    ["kontinuous-config.yaml"] = 390,
    ["kontinuous-values.yaml"] = 389,
    ["kustomization.yaml"] = 392,
    ["label-commenter-config.yml"] = 393,
    ["latexindent configuration"] = 56,
    ["launchsettings.json"] = 394,
    lazydocker = 853,
    lazygit = 852,
    ["lego.json"] = 396,
    ["lerna.json"] = 397,
    ["lgtm.yml"] = 398,
    ["liblab.config.json"] = 399,
    ["libman.json"] = 400,
    ["license-report-config.json"] = 401,
    ["linkinator.config.json"] = 403,
    ["lint-staged (.lintstagedrc)"] = 709,
    ["local.settings.json"] = 408,
    ["localazy.json"] = 409,
    ["lotus.yaml"] = 407,
    ["lsdlschema.json"] = 410,
    ["markdown-link-check"] = 770,
    mboats = 777,
    ["micro-settings.json"] = 846,
    ["mimetypes.json"] = 420,
    ["mirrord config"] = 710,
    mise = 711,
    ["mise-settings"] = 712,
    ["mkdocs.yml"] = 440,
    ["monospace.yml"] = 442,
    ["mprocs Configuration file"] = 898,
    ["mta.yaml"] = 713,
    ["mtad.yaml"] = 714,
    ["mycode.json"] = 449,
    ["napari plugin manifest"] = 450,
    neoload = 724,
    ["nest-cli"] = 455,
    ["ninjs (News in JSON)"] = 454,
    ["nixd configuration"] = 870,
    ["nlu.json"] = 456,
    ["nodemon.json"] = 458,
    ["noodl config"] = 776,
    ["notebook.mod.json"] = 459,
    now = 720,
    ["npm-badges"] = 462,
    ["nswag.json"] = 465,
    ntangle = 466,
    ["nuclei-template.yaml"] = 463,
    ["nuget-project.json"] = 464,
    ["ocelot.json"] = 468,
    ["omnisharp.json"] = 469,
    ["openapi.json"] = 470,
    ["openfin.json"] = 477,
    ...
    ["ops.yaml"] = 474,
    ["package.json"] = 489,
    ["package.manifest"] = 490,
    ["partial-black.json"] = 85,
    ["pathfinder.yml"] = 493,
    ["pattern.json"] = 496,
    ["petstore-v1.0"] = 821,
    pgap_yaml_input_reader = 495,
    ["pixi.toml"] = 497,
    ["plagiarize-me.yaml"] = 501,
    ["plagiarize.yaml"] = 500,
    ["portman.json"] = 502,
    ["prettierrc.json"] = 510,
    ["prisma.yml"] = 511,
    ["project-1.0.0-beta3.json"] = 514,
    ["project-1.0.0-beta4.json"] = 515,
    ["project-1.0.0-beta5.json"] = 516,
    ["project-1.0.0-beta6.json"] = 517,
    ["project-1.0.0-beta8.json"] = 518,
    ["project-1.0.0-rc1.json"] = 519,
    ["project-1.0.0-rc2.json"] = 520,
    ["project.json"] = 513,
    ["prometheus.json"] = 521,
    ["prometheus.rules.json"] = 522,
    ["prometheus.rules.test.json"] = 523,
    ["proxies.json"] = 524,
    ["publiccode.yml"] = 525,
    ["pubspec.yaml"] = 526,
    ["pyrseas-0.8.json"] = 529,
    ["quilt.mod.json"] = 847,
    ["rc3 auth"] = 538,
    ["rc3 collection"] = 539,
    ["rc3 environment"] = 540,
    ...
    samt = 562,
    samtrc = 563,
    ["sarif-1.0.0.json"] = 565,
    ["sarif-2.0.0.json"] = 566,
    ["sarif-2.1.0"] = 576,
    ["sarif-2.1.0-rtm.2"] = 567,
    ["sarif-2.1.0-rtm.3"] = 569,
    ["sarif-2.1.0-rtm.4"] = 571,
    ["sarif-2.1.0-rtm.5"] = 573,
    ["sarif-2.1.0-rtm.6"] = 574,
    ["sarif-external-property-file-2.1.0"] = 577,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 568,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 570,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 572,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 575,
    ["schema.org - Action"] = 579,
    ["schema.org - ContactPoint"] = 580,
    ["schema.org - Place"] = 581,
    ["schema.org - Thing"] = 582,
    ["secrethub.yml"] = 849,
    ["semantic-release"] = 588,
    ["servicehub.config.json"] = 699,
    ["servicehub.service.json"] = 698,
    ["settings.job"] = 591,
    ["sfdx-hardis configuration"] = 593,
    ["shard.yml"] = 885,
    ["size-limit configuration"] = 598,
    ["skaffold.yaml"] = 768,
    ["skyuxconfig.json"] = 600,
    snapcraft = 601,
    ["spicepod.yaml"] = 905,
    ["sqlc configuration"] = 609,
    ["stripe-app-local.json"] = 618,
    ["stripe-app.json"] = 617,
    swcrc = 754,
    ["task.json"] = 624,
    taskcat = 721,
    ["template.json"] = 628,
    ["templatsources.json"] = 629,
    ["theme.json"] = 632,
    ["tizen_workspace.json"] = 633,
    tldr = 634,
    tmuxinator = 707,
    ["transcend.yml"] = 641,
    ["tree-sitter grammar.json"] = 326,
    ["trime.yaml"] = 642,
    ["trunk.yaml"] = 643,
    ["ts-force-config.json"] = 647,
    ["tsconfig.json"] = 644,
    ["tsd.json"] = 645,
    ["tsdrc.json"] = 646,
    ["tslint.json"] = 648,
    ...
    v8r = 682,
    vcluster = 892,
    ["vcpkg configuration file"] = 164,
    ["vcpkg manifest file"] = 163,
    ["vega-lite.json"] = 666,
    ["vega.json"] = 665,
    ["venvironment-basic.yaml"] = 669,
    ["venvironment.yaml"] = 668,
    ["version.json"] = 670,
    ["vim-addon-info"] = 672,
    ["vs-2017.3.host.json"] = 674,
    ["vs-nesting.json"] = 675,
    ["vsls.json"] = 673,
    ["vss-extension.json"] = 679,
    ["vtesttree.yaml"] = 680,
    ["vtestunit.yaml"] = 681,
    ["warp-keysets.json"] = 855,
    ["warp-themes.json"] = 856,
    ["warp-workflows.json"] = 857,
    ["webhint.io"] = 807,
    ["webjobpublishsettings.json"] = 687,
    ["webjobs-list.json"] = 686,
    ["well-known-fursona"] = 893,
    ["xs-app.json"] = 717,
    ["xunit.runner.json"] = 697,
    yamllint = 742,
    ["zerops.io import file"] = 902,
    ["zerops.yml"] = 901,
    zuul = 726,
    ["Žinoma"] = 736
  },
