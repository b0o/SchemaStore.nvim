...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 15,
    AIConfig = 16,
    ["AMX Muse Program Descriptor"] = 995,
    ["API Builder"] = 813,
    ["AVA Configuration"] = 874,
    ...
    ["Adobe UXP Manifest"] = 934,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    Air = 12,
    ["Airlock Microgateway"] = 17,
    ["Alacritty Configuration"] = 846,
    ["All Contributors configuration file"] = 899,
    ...
    ["Application list for a WinUtil"] = 977,
    ArchitectFX = 982,
    ["Argo Events"] = 30,
    ["Argo Workflows"] = 31,
    AssemblyScript = 34,
    ...
    ["BX CI"] = 109,
    ["Bashly (bashly.yml)"] = 903,
    ["Bashly Settings (bashly-settings.yml)"] = 904,
    ["Better Code Hub"] = 817,
    ["Better Scripts"] = 110,
    Bigconfig = 84,
    ["Biome Formatter Config"] = 54,
    ["Bitmovin Encoding Template"] = 988,
    ...
    ["Butane Config"] = 859,
    C4InterFlow = 1003,
    ["CGS Card Game Specification (cgs.json)"] = 939,
    ["CICS TS region tagging"] = 868,
    ["CICS TS resource import"] = 869,
    ["CICS TS resource model"] = 870,
    ["CICS TS resource overrides"] = 871,
    ["CMake Presets"] = 112,
    ["CNC Codes"] = 127,
    ["CRS WAF test file"] = 967,
    ["CRS WAF test platform overrides file"] = 968,
    ...
    ["Chamaleon environment"] = 992,
    ["Chamaleon properties"] = 993,
    ["Chamaleon template"] = 991,
    Changesets = 209,
    Cheatsheets = 856,
    ...
    CityJSON = 123,
    ["Clawject config"] = 132,
    ["Cloud Foundry Application Manifest"] = 950,
    ["Cloud Run Spec v1"] = 972,
    ...
    Concord = 966,
    ["Configu .cfgu files"] = 955,
    ["Configu .configu file"] = 956,
    Conjure = 126,
    ...
    ["Custom Machinery Machine"] = 940,
    ["Custom Machinery Recipe"] = 941,
    ...
    ["DonateCaseBetterCasino menu"] = 996,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 911,
    ["EAS config"] = 284,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 900,
    ["EasyVCR .NET"] = 285,
    ["Eidolon Resource"] = 983,
    ...
    ["GeoJSON.json latest"] = 863,
    GherKing = 867,
    ["GitHub Action"] = 315,
    ["GitHub Actions typing"] = 979,
    ...
    ["Goreleaser Pro"] = 344,
    Goss = 345,
    ["Gradle Build Cache Node"] = 815,
    ["Gradle Enterprise"] = 814,
    ...
    Hadolint = 796,
    Hammerkit = 824,
    ["Hardware Sentry Configuration"] = 879,
    Hatch = 797,
    Hayson = 358,
    ...
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 921,
    ["JSON Schema Draft 7"] = 764,
    ["JSON Schema Draft 7 (unofficial strict)"] = 922,
    ["JSON Schema Draft 8 (2019-09)"] = 765,
    ["JSON-API"] = 397,
    ["JSON-e templates"] = 822,
    ["JSON-stat 2.0"] = 759,
    JSONPatch = 401,
    ...
    ["Metadata for a Cinnamon spice"] = 975,
    ["Metatype Configuration"] = 449,
    ["MetricsHub Configuration"] = 450,
    ["MetricsHub Connector Configuration"] = 451,
    ["Micro Editor Syntax"] = 912,
    ["Microsoft Band Web Tile"] = 452,
    ["Microsoft RulesEngine workflow rules"] = 963,
    ["Microsoft RulesEngine workflow rules list"] = 964,
    ["Minecraft Custom Main Menu Mod"] = 929,
    ...
    ["MongoDB Atlas Search Index Definition"] = 883,
    ["Monika Configuration"] = 881,
    ["Monoweave Configuration"] = 477,
    ["Motif config"] = 779,
    ["NOX Framework (Service)"] = 494,
    ["Netin Diagnostic System Template"] = 841,
    ["Netlify config"] = 485,
    ...
    ["OpenUtau ustx"] = 512,
    ["OpenWeather Current Weather API"] = 821,
    ["OpenWeather Road Risk API"] = 820,
    ...
    ["Pipeline component"] = 832,
    ["Plex Prerolls"] = 548,
    ["PocketMine plugin.yml"] = 545,
    ["Postman collection"] = 552,
    ["Preset list for a WinUtil"] = 978,
    ["Problem object RFC9457"] = 926,
    ...
    Qgoda = 588,
    Qodana = 851,
    ["Qt Creator workspace file"] = 957,
    ["Quali Torque Blueprint Spec 2"] = 876,
    ["QueryFirst config file"] = 894,
    ["RKE Cluster Configuration JSON"] = 829,
    ["RKE Cluster Configuration YAML"] = 828,
    RadioHound = 580,
    Railway = 589,
    ["Rancher Fleet"] = 582,
    ["Rattler-build"] = 590,
    ...
    ["SauceCTL Configuration"] = 838,
    ["Schema Catalog"] = 633,
    ["Scoop manifest"] = 638,
    ["Semantic Data Fabric (SDF) file"] = 642,
    ["Semgrep Rule"] = 644,
    ["Serenity Code Generator (Sergen)"] = 645,
    ["Serverless Framework Configuration"] = 845,
    ["Serverless Workflow"] = 847,
    ["Settings for a Cinnamon spice"] = 974,
    ["Settings.paf"] = 647,
    ["Shopware 6 Configuration"] = 848,
    ["Shopware CLI Extension Store Configuration"] = 849,
    ["Shopware CLI Project Store Configuration"] = 850,
    ["Sigma Detection Rule"] = 649,
    ["Sigrid scope configuration file"] = 650,
    ["SkyPilot Task JSON"] = 933,
    ...
    StackBlitz = 672,
    ["StackHawk Scanner Configuration"] = 844,
    Stale = 673,
    ["Starlake Data Pipeline"] = 818,
    Starship = 674,
    ...
    ["Sublime Syntax"] = 890,
    ["Subsquid squid manifest"] = 935,
    ["Swagger API 2.0"] = 683,
    ["Synadia Connect Component"] = 684,
    TSON = 716,
    TSTyche = 717,
    ["Tab data for a LinUtil"] = 981,
    ["Tab list for a LinUtil"] = 980,
    Talhelper = 686,
    ...
    ["Tugboat QA config.yml"] = 1002,
    TunnelHub = 925,
    Turborepo = 700,
    Tycho = 970,
    Tye = 852,
    ["UET BuildConfig.json"] = 895,
    ["UI5 Manifest"] = 726,
    ["UNCORS configuration"] = 730,
    ["UTAM Page Object"] = 729,
    ["Ubuntu Server Autoinstall"] = 724,
    ["Uniswap Token List"] = 806,
    ["Unreal Engine Uplugin"] = 896,
    ["Unreal Engine Uproject"] = 897,
    ["Updatecli Compose"] = 860,
    ["Updatecli Policy Manifest"] = 861,
    ["Updatecli Policy Metadata"] = 862,
    Uplift = 893,
    ["User Journey Map"] = 826,
    V2Ray = 866,
    ...
    ["WireMock stub mapping"] = 987,
    ["Woodpecker pipeline config"] = 840,
    ["Wrangler CLI"] = 758,
    ["Xstate Machine"] = 858,
    ["Yandex Workflow Language"] = 976,
    ["Yarn Config (.yarnrc.yml)"] = 816,
    ["Yippee-Ki-JSON configuration YML"] = 808,
    ["YouTrack App"] = 973,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 18,
    apko = 927,
    ...
    ["behat.yml"] = 93,
    ["bigquery-table"] = 83,
    ["bioimageio resource description"] = 943,
    ...
    ["crowdin.yml"] = 217,
    ["ctfd-setup configuration file"] = 994,
    ["custom-elements.json"] = 915,
    ["cypress.json"] = 221,
    ...
    ["gematik health care insurance list"] = 1000,
    ["gematik health care patient list"] = 997,
    ["gematik health care provider institution list"] = 999,
    ["gematik health care provider list"] = 998,
    ["gematik tiger test environment configuration"] = 1001,
    ["gitlab-ci"] = 323,
    ["global.json"] = 339,
    ...
    ["lotus.yaml"] = 438,
    ["lsdlschema.json"] = 441,
    ["markdown-link-check"] = 835,
    maturin = 836,
    mboats = 843,
    ["micro-settings.json"] = 907,
    ["mimetypes.json"] = 453,
    ["mirrord config"] = 775,
    mise = 776,
    ["mkdocs.yml"] = 473,
    ...
    ["plagiarize.yaml"] = 546,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 990,
    ["podbard.yaml"] = 549,
    ["portman.json"] = 550,
    ["prefect.toml"] = 558,
    ["prettierrc.json"] = 559,
    ...
    ["vtesttree.yaml"] = 750,
    ["vtestunit.yaml"] = 751,
    ["warp-keysets.json"] = 916,
    ["warp-themes.json"] = 917,
    ["warp-workflows.json"] = 918,
    ["webhint.io"] = 873,
    ["webjobpublishsettings.json"] = 756,
    ["webjobs-list.json"] = 755,
    ["well-known-fursona"] = 953,
    ["xs-app.json"] = 781,
    ["xunit.runner.json"] = 767,
    yamllint = 807,
    ["zerops.io import file"] = 962,
    ["zerops.yml"] = 961,
    zuul = 791,
    ["Žinoma"] = 801
  },
