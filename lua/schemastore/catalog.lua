...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 178,
    [".cryproj (generic)"] = 614,
    [".cryproj engine-5.2"] = 609,
    [".cryproj engine-5.3"] = 610,
    [".cryproj engine-5.4"] = 611,
    [".cryproj engine-5.5"] = 612,
    [".cryproj engine-dev"] = 613,
    [".csscomb.json"] = 180,
    [".csslintrc"] = 181,
    [".es6importsorterrc.json"] = 745,
    [".eslintrc"] = 230,
    [".esmrc.json"] = 222,
    [".ffizer.yaml"] = 234,
    [".htmlhintrc"] = 287,
    ...
    [".mtaext"] = 623,
    [".nodehawkrc"] = 389,
    [".npmpackagejsonlintrc"] = 392,
    [".phraseapp.yml"] = 436,
    [".pmbot.yml"] = 425,
    [".postcssrc"] = 431,
    [".powerpages-web-template-manifest"] = 433,
    [".pre-commit-config.yml"] = 434,
    [".pre-commit-hooks.yml"] = 435,
    [".putout.json"] = 455,
    [".rehyperc"] = 467,
    [".remarkrc"] = 468,
    [".sprite files"] = 523,
    ...
    ["<div>RIOTS' studio configuration"] = 593,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 348,
    ["API Builder"] = 655,
    ["AVA Configuration"] = 714,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 687,
    ["All Contributors configuration file"] = 744,
    ...
    ["Azure Pipelines"] = 59,
    ["Azure Static Web Apps CLI configuration file"] = 526,
    ["Azure Static Web Apps configuration file"] = 525,
    ["BX CI"] = 95,
    ["Better Code Hub"] = 659,
    ["Better Scripts"] = 96,
    Bigconfig = 76,
    BizTalkServerApplicationSchema = 629,
    Bleep = 97,
    ...
    ["Butane Config"] = 699,
    ["CICS TS region tagging"] = 708,
    ["CICS TS resource import"] = 709,
    ["CICS TS resource model"] = 710,
    ["CICS TS resource overrides"] = 711,
    ["CMake Presets"] = 98,
    ["CNC Codes"] = 108,
    ...
    ["Databricks Asset Bundles"] = 765,
    ["Datadog Service Definition"] = 326,
    ["Datahub Ingestion Recipe"] = 715,
    ["Dein Config"] = 113,
    Deno = 191,
    ["Deployer Recipe"] = 194,
    ["Deta Spacefile"] = 114,
    ...
    ["Goreleaser Pro"] = 269,
    Goss = 270,
    ["Gradle Build Cache Node"] = 657,
    ["Gradle Enterprise"] = 656,
    ...
    Hadolint = 638,
    Hammerkit = 666,
    ["Hardware Sentry Configuration"] = 719,
    Hatch = 639,
    Hayson = 282,
    ...
    ["JFrog File Spec"] = 307,
    ["JFrog Pipelines YML DSL"] = 728,
    ["JMeter DSL cli config"] = 308,
    JReleaser = 310,
    ["JSON Document Transform"] = 317,
    ["JSON Feed"] = 318,
    ["JSON Resume"] = 474,
    ["JSON Schema Draft 2020-12"] = 605,
    ["JSON Schema Draft 4"] = 602,
    ["JSON Schema Draft 7"] = 603,
    ["JSON Schema Draft 7 (unofficial strict)"] = 766,
    ["JSON Schema Draft 8 (2019-09)"] = 604,
    ["JSON-API"] = 316,
    ["JSON-e templates"] = 664,
    ["JSON-stat 2.0"] = 599,
    JSONPatch = 320,
    Jasmine = 300,
    Jekyll = 301,
    ...
    Kas = 323,
    ["Keycloak REST API"] = 736,
    ["Knative Functions - func.yaml"] = 247,
    ["KoDE/CI build.yaml"] = 724,
    ["Kong DBLess config"] = 725,
    KrakenD = 325,
    LOOBin = 343,
    Lefthook = 333,
    ["Liferay client-extension.yaml"] = 339,
    ["LinkML Metamodel"] = 341,
    Liquibase = 671,
    ["Liquibase Flow File"] = 672,
    ["Lively Properties"] = 342,
    ["Lobe AI Agent"] = 58,
    ["MLOS Configs"] = 375,
    ["MS2Rescore Configuration"] = 377,
    Markdownlint = 675,
    ["Mason Registry"] = 677,
    ["MegaLinter configuration"] = 349,
    ["MegaLinter descriptor"] = 350,
    Melange = 772,
    ...
    ["Minecraft Data Pack Damage Type"] = 358,
    ["Minecraft Data Pack Dimension"] = 360,
    ["Minecraft Data Pack Dimension Type"] = 359,
    ["Minecraft Data Pack Item Modifier"] = 361,
    ["Minecraft Data Pack Loot Table"] = 362,
    ["Minecraft Data Pack Metadata"] = 363,
    ["Minecraft Data Pack Predicate"] = 364,
    ["Minecraft Data Pack Recipe"] = 365,
    ["Minecraft Data Pack Tag"] = 366,
    ["Minecraft Data Pack Template Pool"] = 367,
    ["Minecraft Data Pack Trim Material"] = 372,
    ["Minecraft Data Pack Trim Pattern"] = 373,
    ["Minecraft Resource Pack Lang"] = 368,
    ["Minecraft Resource Pack Particle"] = 369,
    ["Minecraft Resource Pack Texture Mcmeta"] = 371,
    ["Minecraft Resourcepack Sounds"] = 370,
    ["MkDocs Configuration 1.0"] = 374,
    ["MongoDB Atlas Search Index Definition"] = 723,
    ["Monika Configuration"] = 721,
    ["Motif config"] = 622,
    ["NOX Framework (Service)"] = 391,
    ["Netin Diagnostic System Template"] = 681,
    ["Netlify config"] = 382,
    ["Nexus-as-Code Data Model"] = 383,
    ["Nightwatch.js"] = 384,
    ["ONe's service descriptor"] = 406,
    ["OSS Review Toolkit configuration"] = 413,
    ["OSS Review Toolkit curation"] = 414,
    ["OSS Review Toolkit package configuration"] = 415,
    ["OSS Review Toolkit repository configuration"] = 416,
    ["OSS Review Toolkit resolutions"] = 417,
    Opctl = 625,
    ["OpenRewrite Resource"] = 408,
    ["OpenUtau character yaml"] = 403,
    ["OpenUtau ustx"] = 404,
    ["OpenWeather Current Weather API"] = 663,
    ["OpenWeather Road Risk API"] = 662,
    ["Ory Hydra configuration"] = 288,
    ["Ory Keto configuration"] = 327,
    ["Ory Kratos configuration"] = 412,
    ["Ory Oathkeeper configuration"] = 398,
    ["Outblocks App configuration"] = 410,
    ["Outblocks database table"] = 411,
    ["Outblocks project configuration"] = 409,
    Packer = 420,
    Pantsbuild = 743,
    ["Paper paper-plugin.yml"] = 421,
    ["Pipeline component"] = 673,
    ["PocketMine plugin.yml"] = 426,
    Poetry = 427,
    ["Postman collection"] = 432,
    ["Problem object RFC9457"] = 770,
    ["Problem package generators"] = 439,
    Pterodactyl = 718,
    ["Pull Request Labeler"] = 454,
    Pulumi = 460,
    PyProject = 461,
    Pyright = 462,
    Qgoda = 463,
    Qodana = 692,
    ["Quali Torque Blueprint Spec 2"] = 716,
    ["QueryFirst config file"] = 739,
    ["RKE Cluster Configuration JSON"] = 670,
    ["RKE Cluster Configuration YAML"] = 669,
    ["Rancher Fleet"] = 457,
    Ray = 637,
    ["Read the Docs"] = 459,
    ["Red-DiscordBot Cog"] = 464,
    ["Red-DiscordBot Cog Repo"] = 465,
    ["Red-DiscordBot Trivia"] = 466,
    RenderCV = 476,
    Renovate = 475,
    ["Replit config"] = 469,
    RoadRunner = 477,
    ...
    ["Rust Project"] = 473,
    ["Rust toolchain"] = 479,
    ["SIL Kit Participant Configuration"] = 511,
    ["SIL Kit Registry Configuration"] = 512,
    SWADL = 537,
    ["Safebox Config"] = 729,
    ["Sapphire CLI Config"] = 482,
    ["SauceCTL Configuration"] = 678,
    ["Schema Catalog"] = 496,
    ["Scoop manifest"] = 501,
    ["Semantic Data Fabric (SDF) file"] = 502,
    ["Semgrep Rule"] = 504,
    ["Serenity Code Generator (Sergen)"] = 505,
    ["Serverless Framework Configuration"] = 686,
    ["Serverless Workflow"] = 688,
    ["Settings.paf"] = 507,
    Setuptools = 508,
    ["Shopware 6 Configuration"] = 689,
    ["Shopware CLI Extension Store Configuration"] = 690,
    ["Shopware CLI Project Store Configuration"] = 691,
    ["Sigrid scope configuration file"] = 510,
    ["Slack app manifest"] = 514,
    Solidarity = 517,
    ["Solution filters"] = 518,
    ["Source Maps v3"] = 519,
    Sourcery = 520,
    SpecIF = 521,
    ["Sponge Mixin configuration"] = 522,
    StackBlitz = 527,
    ["StackHawk Scanner Configuration"] = 685,
    Stale = 528,
    ["Starlake Data Pipeline"] = 660,
    Starship = 529,
    ["Statamic Blueprint"] = 530,
    ["Stella configuration file"] = 531,
    ["StrmPrivacy Data Connector"] = 733,
    ["StrmPrivacy Data Contract"] = 734,
    ["StrmPrivacy SimpleSchema"] = 731,
    ["StrmPrivacy Stream"] = 732,
    ["StrmPrivacy batch job configuration file"] = 730,
    ["Stryker Mutator"] = 534,
    ["StyleCop Analyzers Configuration"] = 535,
    ["Sublime Syntax"] = 735,
    ["Swagger API 2.0"] = 538,
    TSON = 563,
    TSTyche = 564,
    Talhelper = 540,
    ["Talisman configuration"] = 541,
    ["Taskfile config"] = 665,
    Taurus = 542,
    ["TestEnvironment.json"] = 551,
    ["TextMate Grammar"] = 550,
    ["Tier.run pricing.json"] = 545,
    Tikibase = 546,
    ["Traefik v2"] = 554,
    ["Traefik v2 File Provider"] = 555,
    TunnelHub = 769,
    Turborepo = 552,
    Tye = 693,
    ["UET BuildConfig.json"] = 740,
    ["UI5 Manifest"] = 572,
    ["UTAM Page Object"] = 575,
    ["Ubuntu Server Autoinstall"] = 570,
    ["Uniswap Token List"] = 648,
    ["Unreal Engine Uplugin"] = 741,
    ["Unreal Engine Uproject"] = 742,
    ["Updatecli Compose"] = 700,
    ["Updatecli Policy Manifest"] = 701,
    ["Updatecli Policy Metadata"] = 702,
    Uplift = 738,
    ["User Journey Map"] = 668,
    V2Ray = 706,
    ["VSCode Code Snippets"] = 149,
    ["VSIX CLI publishing"] = 588,
    ["Vela Pipeline Configuration"] = 578,
    Vercel = 148,
    Visivo = 767,
    ["Web App Manifest"] = 595,
    ["Web types"] = 598,
    WebExtensions = 594,
    ["Webman package recipe"] = 712,
    ["Windows Package Manager Installer Manifest"] = 645,
    ["Windows Package Manager Locale Manifest"] = 646,
    ["Windows Package Manager Singleton Manifest"] = 644,
    ["Woodpecker pipeline config"] = 680,
    ["Xstate Machine"] = 698,
    ["Yippee-Ki-JSON configuration YML"] = 650,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    apko = 771,
    ...
    ["bamboo-spec"] = 70,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 749,
    ["bashly-strings.yml"] = 750,
    ["bashly.yml"] = 748,
    ["batect.yml"] = 69,
    ...
    ["linkinator.config.json"] = 340,
    ["local.settings.json"] = 345,
    ["localazy.json"] = 346,
    ["lotus.yaml"] = 344,
    ["lsdlschema.json"] = 347,
    ["madness.yml"] = 747,
    ["markdown-lint-check"] = 676,
    mboats = 683,
    ["micro-settings.json"] = 752,
    ["mimetypes.json"] = 354,
    ["mirrord config"] = 619,
    ["monospace.yml"] = 376,
    ["mta.yaml"] = 620,
    ["mtad.yaml"] = 621,
    ["mycode.json"] = 380,
    ["napari plugin manifest"] = 381,
    neoload = 631,
    ["nest-cli"] = 387,
    ["ninjs (News in JSON) 1.3"] = 386,
    ["ninjs (News in JSON) 2.0"] = 385,
    ["nlu.json"] = 388,
    ["nodemon.json"] = 390,
    ["noodl config"] = 682,
    now = 627,
    ...
    ["nswag.json"] = 396,
    ntangle = 397,
    ["nuclei-template.yaml"] = 394,
    ["nuget-project.json"] = 395,
    ["ocelot.json"] = 399,
    ["omnisharp.json"] = 400,
    ["openapi.json"] = 401,
    ["openfin.json"] = 407,
    ...
    ["ops.yaml"] = 405,
    ["package.json"] = 418,
    ["package.manifest"] = 419,
    ["pathfinder.yml"] = 422,
    ["pattern.json"] = 424,
    ["petstore-v1.0"] = 727,
    pgap_yaml_input_reader = 423,
    ["plagiarize-me.yaml"] = 429,
    ["plagiarize.yaml"] = 428,
    ["portman.json"] = 430,
    ["prettierrc.json"] = 437,
    ["prisma.yml"] = 438,
    ["project-1.0.0-beta3.json"] = 441,
    ["project-1.0.0-beta4.json"] = 442,
    ["project-1.0.0-beta5.json"] = 443,
    ["project-1.0.0-beta6.json"] = 444,
    ["project-1.0.0-beta8.json"] = 445,
    ["project-1.0.0-rc1.json"] = 446,
    ["project-1.0.0-rc2.json"] = 447,
    ["project.json"] = 440,
    ["prometheus.json"] = 448,
    ["prometheus.rules.json"] = 449,
    ["prometheus.rules.test.json"] = 450,
    ["proxies.json"] = 451,
    ["publiccode.yml"] = 452,
    ["pubspec.yaml"] = 453,
    ["pyrseas-0.8.json"] = 456,
    ["quilt.mod.json"] = 753,
    ["release drafter"] = 632,
    rtx = 471,
    rustfmt = 478,
    samt = 480,
    samtrc = 481,
    ["sarif-1.0.0.json"] = 483,
    ["sarif-2.0.0.json"] = 484,
    ["sarif-2.1.0"] = 494,
    ["sarif-2.1.0-rtm.2"] = 485,
    ["sarif-2.1.0-rtm.3"] = 487,
    ["sarif-2.1.0-rtm.4"] = 489,
    ["sarif-2.1.0-rtm.5"] = 491,
    ["sarif-2.1.0-rtm.6"] = 492,
    ["sarif-external-property-file-2.1.0"] = 495,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 486,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 488,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 490,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 493,
    ["schema.org - Action"] = 497,
    ["schema.org - ContactPoint"] = 498,
    ["schema.org - Place"] = 499,
    ["schema.org - Thing"] = 500,
    ["scikit-build"] = 684,
    ["secrethub.yml"] = 755,
    ["semantic-release"] = 503,
    ["servicehub.config.json"] = 608,
    ["servicehub.service.json"] = 607,
    ["settings.job"] = 506,
    ["sfdx-hardis configuration"] = 509,
    ["size-limit configuration"] = 513,
    ["skaffold.yaml"] = 674,
    ["skyuxconfig.json"] = 515,
    snapcraft = 516,
    ["sqlc configuration"] = 524,
    ["stripe-app-local.json"] = 533,
    ["stripe-app.json"] = 532,
    swcrc = 661,
    syntax = 757,
    ["task.json"] = 539,
    taskcat = 628,
    ["template.json"] = 543,
    ["templatsources.json"] = 544,
    ["theme.json"] = 547,
    ["tizen_workspace.json"] = 548,
    tldr = 549,
    tmuxinator = 616,
    ["transcend.yml"] = 556,
    ["trunk.yaml"] = 557,
    ["ts-force-config.json"] = 561,
    ["tsconfig.json"] = 558,
    ["tsd.json"] = 559,
    ["tsdrc.json"] = 560,
    ["tslint.json"] = 562,
    ...
    ["vega-lite.json"] = 577,
    ["vega.json"] = 576,
    ["venvironment-basic.yaml"] = 580,
    ["venvironment.yaml"] = 579,
    ["version.json"] = 581,
    ["vim-addon-info"] = 582,
    ["vs-2017.3.host.json"] = 584,
    ["vs-nesting.json"] = 585,
    ["vsls.json"] = 583,
    ["vss-extension.json"] = 589,
    ["vtesttree.yaml"] = 590,
    ["vtestunit.yaml"] = 591,
    ["warp-keysets.json"] = 761,
    ["warp-themes.json"] = 762,
    ["warp-workflows.json"] = 763,
    ["webhint.io"] = 713,
    ["webjobpublishsettings.json"] = 597,
    ["webjobs-list.json"] = 596,
    ["xs-app.json"] = 624,
    ["xunit.runner.json"] = 606,
    yamllint = 649,
    zuul = 633,
    ["Žinoma"] = 643
  },
