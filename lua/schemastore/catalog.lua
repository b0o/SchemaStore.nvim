...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 217,
    [".cryproj (generic)"] = 702,
    [".cryproj engine-5.2"] = 697,
    [".cryproj engine-5.3"] = 698,
    [".cryproj engine-5.4"] = 699,
    [".cryproj engine-5.5"] = 700,
    [".cryproj engine-dev"] = 701,
    [".eslintrc"] = 280,
    [".esmrc.json"] = 265,
    [".ffizer.yaml"] = 284,
    [".htmlhintrc"] = 341,
    ...
    [".mtaext"] = 713,
    [".nodehawkrc"] = 455,
    [".npmpackagejsonlintrc"] = 459,
    [".omletrc"] = 888,
    [".phrase.yml"] = 506,
    [".phraseapp.yml"] = 507,
    [".pmbot.yml"] = 496,
    [".postcssrc"] = 501,
    [".powerpages-web-template-manifest"] = 503,
    [".pre-commit-config.yml"] = 504,
    [".pre-commit-hooks.yml"] = 505,
    [".putout.json"] = 526,
    [".rehyperc"] = 545,
    [".remarkrc"] = 547,
    [".sprite files"] = 605,
    ...
    ["<div>RIOTS' studio configuration"] = 680,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 410,
    ABCSupplyPlan = 13,
    AIConfig = 14,
    ["API Builder"] = 745,
    ["AVA Configuration"] = 805,
    ...
    ["Adobe UXP Manifest"] = 870,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 15,
    ["Airplane task"] = 16,
    ["Alacritty Configuration"] = 777,
    ["All Contributors configuration file"] = 835,
    ["Ansible Argument Specs"] = 22,
    ["Ansible Collection Galaxy"] = 29,
    ["Ansible Execution Environment"] = 19,
    ["Ansible Inventory"] = 28,
    ["Ansible Meta"] = 20,
    ["Ansible Meta Runtime"] = 21,
    ["Ansible Navigator Configuration"] = 31,
    ["Ansible Playbook"] = 26,
    ["Ansible Requirements"] = 23,
    ["Ansible Rulebook"] = 27,
    ...
    AutoAPICase = 845,
    ["Avro Avsc"] = 50,
    ["Azure Container App template for defining an immutable revision"] = 51,
    ["Azure DevOps extension manifest"] = 54,
    ["Azure Device Update for IoT Hub import manifest"] = 52,
    ["Azure Device Update for IoT Hub update manifest"] = 53,
    ["Azure IoT Edge deployment"] = 57,
    ["Azure IoT Edge deployment template"] = 58,
    ["Azure IoT EdgeAgent deployment"] = 55,
    ["Azure IoT EdgeHub deployment"] = 56,
    ["Azure Landing Zones Library archetype definition"] = 60,
    ["Azure Landing Zones Library archetype override"] = 61,
    ["Azure Landing Zones Library architecture definition"] = 59,
    ["Azure Pipelines"] = 72,
    ["Azure Static Web Apps CLI configuration file"] = 608,
    ["Azure Static Web Apps configuration file"] = 607,
    ["BX CI"] = 111,
    ["Bashly (bashly.yml)"] = 839,
    ["Bashly Settings (bashly-settings.yml)"] = 840,
    ["Better Code Hub"] = 749,
    ["Better Scripts"] = 112,
    Bigconfig = 89,
    BizTalkServerApplicationSchema = 719,
    Bleep = 113,
    ["Block Protocol Metadata"] = 110,
    ["Boyka Framework"] = 96,
    Briefcase = 724,
    ["Build Info"] = 103,
    Buildkite = 105,
    ["Bukkit plugin.yml"] = 104,
    ["BungeeCord plugin.yml"] = 108,
    ["Butane Config"] = 790,
    ["CGS Custom Card Game (CardGameDef.json)"] = 875,
    ["CICS TS region tagging"] = 799,
    ["CICS TS resource import"] = 800,
    ["CICS TS resource model"] = 801,
    ["CICS TS resource overrides"] = 802,
    ["CMake Presets"] = 114,
    ["CNC Codes"] = 128,
    ...
    CWL = 881,
    ["Cache Warmup config"] = 115,
    ["Calqulus pipeline"] = 116,
    ["Camel YAML DSL"] = 117,
    Carafe = 118,
    ["Cargo Make"] = 120,
    ["Cargo Manifest"] = 119,
    ...
    CityJSON = 124,
    ["Clawject config"] = 133,
    ["Cloud Foundry Application Manifest"] = 887,
    ...
    Concord = 903,
    ["Configu .cfgu files"] = 892,
    ["Configu .configu file"] = 893,
    Conjure = 127,
    ["Container Structure Test"] = 732,
    Containerlab = 757,
    ["Crowdsec collection config"] = 213,
    ["Crowdsec parser config"] = 214,
    ["Crowdsec scenario config"] = 215,
    ["CumulusCI Config"] = 132,
    ["Custom Machinery Machine"] = 876,
    ["Custom Machinery Recipe"] = 877,
    ...
    ["DataYoga Job"] = 137,
    ["Databricks Asset Bundles"] = 856,
    ["Datadog Service Definition"] = 385,
    ["Datadog Software Catalog"] = 386,
    ["Datahub Ingestion Recipe"] = 806,
    ["Dein Config"] = 139,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 847,
    ["EAS config"] = 278,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 836,
    ...
    ["Facets - FSDL - Application"] = 281,
    ["FasterCI Configuration"] = 73,
    FiQuS = 287,
    Firebase = 285,
    ["Flow.json Configurations"] = 880,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 872,
    GitVersion = 304,
    ["Gitea Issue Template configuration"] = 305,
    ["Gitea Issue Template forms"] = 306,
    ["Gitpod Configuration"] = 316,
    ["GlazeWM settings"] = 874,
    ["Global Privacy Control"] = 303,
    Goblet = 855,
    ["Golangci-lint Configuration"] = 318,
    ["Golangci-lint Custom Plugins Configuration"] = 319,
    ["Google Chrome Related Website Sets"] = 286,
    ["Google Cloud Workflows"] = 191,
    Goreleaser = 321,
    ["Goreleaser Pro"] = 322,
    Goss = 323,
    ["Gradle Build Cache Node"] = 747,
    ["Gradle Enterprise"] = 746,
    ["Grafana 5.x Dashboard"] = 324,
    ["GraphQL Code Generator"] = 328,
    ["GraphQL Config"] = 327,
    ["GraphQL Mesh"] = 326,
    ["Grunt JSHint task"] = 332,
    ["Grunt Watch task"] = 333,
    ["Grunt base task"] = 334,
    ["Grunt clean task"] = 330,
    ["Grunt copy task"] = 329,
    ["Grunt cssmin task"] = 331,
    HEMTT = 716,
    Hadolint = 728,
    Hammerkit = 756,
    ["Hardware Sentry Configuration"] = 810,
    Hatch = 729,
    Hayson = 336,
    ["Haystack Pipeline"] = 337,
    ["Hazelcast 5 Configuration"] = 338,
    ["Helm Chart.lock"] = 159,
    ["Helm Chart.yaml"] = 158,
    ["Helm Unittest Test Suite"] = 160,
    Hugo = 786,
    ["Hugo Theme"] = 785,
    ["Hyperfoil benchmark configuration"] = 344,
    ["IBM Zapp document"] = 345,
    ["IBM zCodeFormatSettings"] = 346,
    ["IMG Catapult PSP"] = 351,
    ["IVMS101 by CODE Protocol"] = 873,
    Infrahub = 353,
    Istanbul = 813,
    ["JDownloader2 crawler multi-rules"] = 362,
    ["JDownloader2 crawler single-rules"] = 361,
    ["JFrog Applications Config"] = 363,
    ["JFrog File Spec"] = 364,
    ["JFrog Pipelines YML DSL"] = 819,
    ["JMeter DSL cli config"] = 365,
    JReleaser = 367,
    ["JSON Document Transform"] = 375,
    ["JSON Feed"] = 376,
    ["JSON Resume"] = 552,
    ["JSON Schema Draft 2020-12"] = 693,
    ["JSON Schema Draft 4"] = 690,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 857,
    ["JSON Schema Draft 7"] = 691,
    ["JSON Schema Draft 7 (unofficial strict)"] = 858,
    ["JSON Schema Draft 8 (2019-09)"] = 692,
    ["JSON-API"] = 374,
    ["JSON-WF"] = 886,
    ["JSON-e templates"] = 754,
    ["JSON-stat 2.0"] = 687,
    JSONPatch = 378,
    ["JSR Package Config (jsr.json)"] = 368,
    Jasmine = 357,
    Jekyll = 358,
    ["Jenkins X Pipelines"] = 359,
    ["Jenkins X Requirements"] = 360,
    ["Jovo Language Models"] = 366,
    ["KIMMDY config file"] = 383,
    ["KSP-AVC"] = 688,
    ["KSP-CKAN"] = 689,
    KSY = 885,
    ["Karakum configuration file"] = 296,
    Kas = 381,
    ["Keycloak REST API"] = 827,
    ["Knative Functions - func.yaml"] = 297,
    ["KoDE/CI build.yaml"] = 815,
    ["Kong DBLess config"] = 816,
    KrakenD = 384,
    ["Kubri Configuration"] = 390,
    LOOBin = 405,
    ...
    ["Language configuration"] = 896,
    Lefthook = 394,
    ["Liferay client-extension.yaml"] = 401,
    ["LinkML Metamodel"] = 403,
    Liquibase = 762,
    ["Liquibase Flow File"] = 763,
    ["Lively Properties"] = 404,
    ["Lobe AI Agent"] = 70,
    Loki = 71,
    ["MLOS Configs"] = 439,
    ["MS2Rescore Configuration"] = 442,
    ["Madness (madness.yml)"] = 838,
    Markdownlint = 766,
    ["Mason Registry"] = 768,
    ["MegaLinter configuration"] = 411,
    ["MegaLinter descriptor"] = 412,
    Melange = 864,
    ["Meltano plugin discovery definition"] = 414,
    ["Meltano project definition"] = 413,
    ["Mergify Configuration"] = 443,
    ["MetricsHub Configuration"] = 415,
    ["MetricsHub Connector Configuration"] = 416,
    ["Micro Editor Syntax"] = 848,
    ["Microsoft Band Web Tile"] = 417,
    ["Microsoft RulesEngine workflow rules"] = 900,
    ["Microsoft RulesEngine workflow rules list"] = 901,
    ["Minecraft Custom Main Menu Mod"] = 865,
    ["Minecraft Data Pack Advancement"] = 419,
    ["Minecraft Data Pack Biome"] = 420,
    ["Minecraft Data Pack Configured Carver"] = 421,
    ["Minecraft Data Pack Damage Type"] = 422,
    ["Minecraft Data Pack Dimension"] = 424,
    ["Minecraft Data Pack Dimension Type"] = 423,
    ["Minecraft Data Pack Item Modifier"] = 425,
    ["Minecraft Data Pack Loot Table"] = 426,
    ["Minecraft Data Pack Metadata"] = 427,
    ["Minecraft Data Pack Predicate"] = 428,
    ["Minecraft Data Pack Recipe"] = 429,
    ["Minecraft Data Pack Tag"] = 430,
    ["Minecraft Data Pack Template Pool"] = 431,
    ["Minecraft Data Pack Trim Material"] = 436,
    ["Minecraft Data Pack Trim Pattern"] = 437,
    ["Minecraft Resource Pack Lang"] = 432,
    ["Minecraft Resource Pack Particle"] = 433,
    ["Minecraft Resource Pack Texture Mcmeta"] = 435,
    ["Minecraft Resourcepack Sounds"] = 434,
    ["Monade CLI Stack Configuration"] = 446,
    ["MongoDB Atlas Search Index Definition"] = 814,
    ["Monika Configuration"] = 812,
    ["Monoweave Configuration"] = 441,
    ["Motif config"] = 712,
    ["NOX Framework (Service)"] = 458,
    ["Netin Diagnostic System Template"] = 772,
    ["Netlify config"] = 449,
    ["Network-as-Code Data Model"] = 450,
    ["Nightwatch.js"] = 451,
    ["Nuitka.yaml"] = 878,
    ["ONe's changelog entry"] = 474,
    ["ONe's service descriptor"] = 473,
    ["OSS Review Toolkit configuration"] = 482,
    ["OSS Review Toolkit curation"] = 483,
    ["OSS Review Toolkit package configuration"] = 484,
    ["OSS Review Toolkit repository configuration"] = 485,
    ["OSS Review Toolkit resolutions"] = 486,
    Opctl = 715,
    ["Open Data Contract Standard (ODCS))"] = 477,
    ["OpenRewrite Resource"] = 476,
    ["OpenUtau character yaml"] = 470,
    ["OpenUtau ustx"] = 471,
    ["OpenWeather Current Weather API"] = 753,
    ["OpenWeather Road Risk API"] = 752,
    ["Ory Hydra configuration"] = 343,
    ["Ory Keto configuration"] = 387,
    ["Ory Kratos configuration"] = 481,
    ["Ory Oathkeeper configuration"] = 465,
    ["Outblocks App configuration"] = 479,
    ["Outblocks database table"] = 480,
    ["Outblocks project configuration"] = 478,
    PDM = 492,
    Packer = 489,
    Pantsbuild = 834,
    ["Paper paper-plugin.yml"] = 490,
    ["Pipeline component"] = 764,
    ["PocketMine plugin.yml"] = 497,
    ["Postman collection"] = 502,
    ["Problem object RFC9457"] = 862,
    ["Problem package generators"] = 510,
    Pterodactyl = 809,
    ["Pull Request Labeler"] = 525,
    Pulumi = 531,
    PyProject = 532,
    Pyright = 533,
    Qgoda = 534,
    Qodana = 782,
    ["Qt Creator workspace file"] = 894,
    ["Quali Torque Blueprint Spec 2"] = 807,
    ["QueryFirst config file"] = 830,
    ["RKE Cluster Configuration JSON"] = 761,
    ["RKE Cluster Configuration YAML"] = 760,
    ["Rancher Fleet"] = 528,
    ["Rattler-build"] = 535,
    Ray = 727,
    ["Read the Docs"] = 530,
    ["Red-DiscordBot Cog"] = 542,
    ["Red-DiscordBot Cog Repo"] = 543,
    ["Red-DiscordBot Trivia"] = 544,
    ["Render Blueprints"] = 759,
    RenderCV = 554,
    Renovate = 553,
    ["Replit config"] = 548,
    RoadRunner = 555,
    ["Rudder techniques"] = 868,
    Ruff = 550,
    ["Rust Project"] = 551,
    ["Rust toolchain"] = 558,
    ["SDMX data message"] = 583,
    ["SDMX metadata message"] = 582,
    ["SDMX structure message"] = 581,
    ["SIL Kit Participant Configuration"] = 593,
    ["SIL Kit Registry Configuration"] = 594,
    SWADL = 619,
    ["Safebox Config"] = 820,
    ["Sapphire CLI Config"] = 561,
    ["SauceCTL Configuration"] = 769,
    ["Schema Catalog"] = 575,
    ["Scoop manifest"] = 580,
    ["Semantic Data Fabric (SDF) file"] = 584,
    ["Semgrep Rule"] = 586,
    ["Serenity Code Generator (Sergen)"] = 587,
    ["Serverless Framework Configuration"] = 776,
    ["Serverless Workflow"] = 778,
    ["Settings.paf"] = 589,
    ["Shopware 6 Configuration"] = 779,
    ["Shopware CLI Extension Store Configuration"] = 780,
    ["Shopware CLI Project Store Configuration"] = 781,
    Sigma = 591,
    ["Sigrid scope configuration file"] = 592,
    ["SkyPilot Task JSON"] = 869,
    ["Slack app manifest"] = 596,
    Solidarity = 599,
    ["Solution filters"] = 600,
    ["Source Maps v3"] = 601,
    Sourcery = 602,
    SpecIF = 603,
    ["Sponge Mixin configuration"] = 604,
    StackBlitz = 609,
    ["StackHawk Scanner Configuration"] = 775,
    Stale = 610,
    ["Starlake Data Pipeline"] = 750,
    Starship = 611,
    ["Statamic Blueprint"] = 612,
    ["Stella configuration file"] = 613,
    ["StrmPrivacy Data Connector"] = 824,
    ["StrmPrivacy Data Contract"] = 825,
    ["StrmPrivacy SimpleSchema"] = 822,
    ["StrmPrivacy Stream"] = 823,
    ["StrmPrivacy batch job configuration file"] = 821,
    ["Stryker Mutator"] = 616,
    ["StyleCop Analyzers Configuration"] = 617,
    ["Stylelint (.stylelintrc)"] = 618,
    ["Sublime Syntax"] = 826,
    ["Subsquid squid manifest"] = 871,
    ["Swagger API 2.0"] = 620,
    TSON = 646,
    TSTyche = 647,
    Talhelper = 622,
    ["Talisman configuration"] = 623,
    ["Taskfile config"] = 755,
    Taurus = 624,
    ["TestEnvironment.json"] = 633,
    ["TextMate Grammar"] = 632,
    ["Tier.run pricing.json"] = 627,
    Tikibase = 628,
    ["Traefik v2"] = 636,
    ["Traefik v2 File Provider"] = 637,
    ["Travis CI (.travis.yml)"] = 635,
    TunnelHub = 861,
    Turborepo = 634,
    Tye = 783,
    ["UET BuildConfig.json"] = 831,
    ["UI5 Manifest"] = 656,
    ["UNCORS configuration"] = 660,
    ["UTAM Page Object"] = 659,
    ["Ubuntu Server Autoinstall"] = 654,
    ["Uniswap Token List"] = 738,
    ["Unreal Engine Uplugin"] = 832,
    ["Unreal Engine Uproject"] = 833,
    ["Updatecli Compose"] = 791,
    ["Updatecli Policy Manifest"] = 792,
    ["Updatecli Policy Metadata"] = 793,
    Uplift = 829,
    ["User Journey Map"] = 758,
    V2Ray = 797,
    ["VSCode Code Snippets"] = 179,
    ["VSIX CLI publishing"] = 675,
    ["Vela Pipeline Configuration"] = 664,
    Vercel = 178,
    Visivo = 859,
    ["Web App Manifest"] = 682,
    ["Web types"] = 685,
    WebExtensions = 681,
    ["Webman package recipe"] = 803,
    ["Windows Package Manager Installer Manifest"] = 735,
    ["Windows Package Manager Locale Manifest"] = 736,
    ["Windows Package Manager Singleton Manifest"] = 734,
    ["Woodpecker pipeline config"] = 771,
    ["Wrangler CLI"] = 686,
    ["Xstate Machine"] = 789,
    ["Yarn Config (.yarnrc.yml)"] = 748,
    ["Yippee-Ki-JSON configuration YML"] = 740,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 863,
    ["app-definition.yaml"] = 34,
    ["apple-app-site-association"] = 32,
    ["appsettings.json"] = 37,
    ["appsscript.json"] = 36,
    ["appveyor.yml"] = 38,
    ["arc.json"] = 40,
    ...
    ["behat.yml"] = 97,
    ["bigquery-table"] = 88,
    ["bioimageio resource description"] = 879,
    ["bitbucket-pipelines"] = 90,
    bitrise = 91,
    ["bitrise-step"] = 92,
    ["block.json"] = 109,
    ["bottom configuration"] = 62,
    ["bower.json"] = 94,
    ["bozr.suite.json"] = 99,
    bpkg = 842,
    ...
    ["gitlab-ci"] = 315,
    ["global.json"] = 317,
    ["go-feature-flag Flag Configuration"] = 320,
    ["haxelib.json"] = 335,
    helmfile = 730,
    helmwave = 731,
    ["host-meta.json"] = 340,
    ...
    ["ide.host.json"] = 347,
    ["ifstate.conf"] = 348,
    ["imageoptimizer.json"] = 349,
    ["importmap.json"] = 352,
    ["ioBroker Configuration"] = 354,
    ["ioBroker JSON UI"] = 355,
    ["ioBroker Package manifest"] = 356,
    ["ize.toml"] = 828,
    ["jsconfig.json"] = 379,
    ["jscpd Configuration"] = 808,
    jsdoc = 726,
    ["k3d.yaml"] = 380,
    ["k9s plugin.yml"] = 382,
    ["kontinuous-config.yaml"] = 389,
    ["kontinuous-values.yaml"] = 388,
    ["kustomization.yaml"] = 391,
    ["label-commenter-config.yml"] = 392,
    ["latexindent configuration"] = 69,
    ["launchsettings.json"] = 393,
    lazydocker = 850,
    lazygit = 849,
    ["lego.json"] = 395,
    ["lerna.json"] = 396,
    ["lgtm.yml"] = 397,
    ["liblab.config.json"] = 398,
    ["libman.json"] = 399,
    ["license-report-config.json"] = 400,
    ["linkinator.config.json"] = 402,
    ["lint-staged (.lintstagedrc)"] = 706,
    ["local.settings.json"] = 407,
    ["localazy.json"] = 408,
    ["lotus.yaml"] = 406,
    ["lsdlschema.json"] = 409,
    ["markdown-link-check"] = 767,
    mboats = 774,
    ["micro-settings.json"] = 843,
    ["mimetypes.json"] = 418,
    ["mirrord config"] = 707,
    mise = 708,
    ["mise-settings"] = 709,
    ["mkdocs.yml"] = 438,
    ["monospace.yml"] = 440,
    ["mprocs Configuration file"] = 895,
    ["mta.yaml"] = 710,
    ["mtad.yaml"] = 711,
    ["mycode.json"] = 447,
    ["napari plugin manifest"] = 448,
    neoload = 721,
    ["nest-cli"] = 453,
    ["ninjs (News in JSON)"] = 452,
    ["nixd configuration"] = 867,
    ["nlu.json"] = 454,
    ["nodemon.json"] = 456,
    ["noodl config"] = 773,
    ["notebook.mod.json"] = 457,
    now = 717,
    ["npm-badges"] = 460,
    ["nswag.json"] = 463,
    ntangle = 464,
    ["nuclei-template.yaml"] = 461,
    ["nuget-project.json"] = 462,
    ["ocelot.json"] = 466,
    ["omnisharp.json"] = 467,
    ["openapi.json"] = 468,
    ["openfin.json"] = 475,
    ...
    ["ops.yaml"] = 472,
    ["package.json"] = 487,
    ["package.manifest"] = 488,
    ["partial-black.json"] = 98,
    ["pathfinder.yml"] = 491,
    ["pattern.json"] = 494,
    ["petstore-v1.0"] = 818,
    pgap_yaml_input_reader = 493,
    ["pixi.toml"] = 495,
    ["plagiarize-me.yaml"] = 499,
    ["plagiarize.yaml"] = 498,
    ["portman.json"] = 500,
    ["prettierrc.json"] = 508,
    ["prisma.yml"] = 509,
    ["project-1.0.0-beta3.json"] = 512,
    ["project-1.0.0-beta4.json"] = 513,
    ["project-1.0.0-beta5.json"] = 514,
    ["project-1.0.0-beta6.json"] = 515,
    ["project-1.0.0-beta8.json"] = 516,
    ["project-1.0.0-rc1.json"] = 517,
    ["project-1.0.0-rc2.json"] = 518,
    ["project.json"] = 511,
    ["prometheus.json"] = 519,
    ["prometheus.rules.json"] = 520,
    ["prometheus.rules.test.json"] = 521,
    ["proxies.json"] = 522,
    ["publiccode.yml"] = 523,
    ["pubspec.yaml"] = 524,
    ["pyrseas-0.8.json"] = 527,
    ["quilt.mod.json"] = 844,
    ["rc3 auth"] = 536,
    ["rc3 collection"] = 537,
    ["rc3 environment"] = 538,
    ...
    ["rc3 settings"] = 541,
    ["release drafter"] = 722,
    ["release-plz.toml"] = 546,
    ["rivet.yaml"] = 866,
    rockcraft = 556,
    rustfmt = 557,
    samt = 559,
    samtrc = 560,
    ["sarif-1.0.0.json"] = 562,
    ["sarif-2.0.0.json"] = 563,
    ["sarif-2.1.0"] = 573,
    ["sarif-2.1.0-rtm.2"] = 564,
    ["sarif-2.1.0-rtm.3"] = 566,
    ["sarif-2.1.0-rtm.4"] = 568,
    ["sarif-2.1.0-rtm.5"] = 570,
    ["sarif-2.1.0-rtm.6"] = 571,
    ["sarif-external-property-file-2.1.0"] = 574,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 565,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 567,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 569,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 572,
    ["schema.org - Action"] = 576,
    ["schema.org - ContactPoint"] = 577,
    ["schema.org - Place"] = 578,
    ["schema.org - Thing"] = 579,
    ["secrethub.yml"] = 846,
    ["semantic-release"] = 585,
    ["servicehub.config.json"] = 696,
    ["servicehub.service.json"] = 695,
    ["settings.job"] = 588,
    ["sfdx-hardis configuration"] = 590,
    ["shard.yml"] = 882,
    ["size-limit configuration"] = 595,
    ["skaffold.yaml"] = 765,
    ["skyuxconfig.json"] = 597,
    snapcraft = 598,
    ["spicepod.yaml"] = 902,
    ["sqlc configuration"] = 606,
    ["stripe-app-local.json"] = 615,
    ["stripe-app.json"] = 614,
    swcrc = 751,
    ["task.json"] = 621,
    taskcat = 718,
    ["template.json"] = 625,
    ["templatsources.json"] = 626,
    ["theme.json"] = 629,
    ["tizen_workspace.json"] = 630,
    tldr = 631,
    tmuxinator = 704,
    ["transcend.yml"] = 638,
    ["tree-sitter grammar.json"] = 325,
    ["trime.yaml"] = 639,
    ["trunk.yaml"] = 640,
    ["ts-force-config.json"] = 644,
    ["tsconfig.json"] = 641,
    ["tsd.json"] = 642,
    ["tsdrc.json"] = 643,
    ["tslint.json"] = 645,
    ...
    ["vega-lite.json"] = 663,
    ["vega.json"] = 662,
    ["venvironment-basic.yaml"] = 666,
    ["venvironment.yaml"] = 665,
    ["version.json"] = 667,
    ["vim-addon-info"] = 669,
    ["vs-2017.3.host.json"] = 671,
    ["vs-nesting.json"] = 672,
    ["vsls.json"] = 670,
    ["vss-extension.json"] = 676,
    ["vtesttree.yaml"] = 677,
    ["vtestunit.yaml"] = 678,
    ["warp-keysets.json"] = 852,
    ["warp-themes.json"] = 853,
    ["warp-workflows.json"] = 854,
    ["webhint.io"] = 804,
    ["webjobpublishsettings.json"] = 684,
    ["webjobs-list.json"] = 683,
    ["well-known-fursona"] = 890,
    ["xs-app.json"] = 714,
    ["xunit.runner.json"] = 694,
    yamllint = 739,
    ["zerops.io import file"] = 899,
    ["zerops.yml"] = 898,
    zuul = 723,
    ["Žinoma"] = 733
  },
