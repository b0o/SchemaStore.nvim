...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1082,
    [".nodehawkrc"] = 694,
    [".npmpackagejsonlintrc"] = 699,
    [".omletrc"] = 1263,
    [".phrase.yml"] = 781,
    [".phraseapp.yml"] = 782,
    [".pmbot.yml"] = 766,
    [".postcssrc"] = 775,
    [".powerpages-web-template-manifest"] = 777,
    [".pre-commit-config.yml"] = 778,
    [".pre-commit-hooks.yml"] = 779,
    [".putout.json"] = 815,
    [".rehyperc"] = 840,
    [".remarkrc"] = 844,
    [".sprite files"] = 946,
    ...
    AIConfig = 46,
    ["AMX Muse Program Descriptor"] = 1312,
    ["API Builder"] = 1118,
    ["AVA Configuration"] = 1182,
    ["AWS AppConfig Feature Flags-v1"] = 85,
    ["AWS CDK cdk.json"] = 309,
    ["AWS CloudFormation"] = 310,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 311,
    ["AWS Copilot Manifest"] = 1351,
    ["AWS SAM CLI Samconfig"] = 312,
    Acton = 1402,
    ["Adobe UXP Manifest"] = 1245,
    ["Aerleon Network & Service Definitions"] = 28,
    ["Aerleon Policy"] = 29,
    ["Agent Permission Policy"] = 1391,
    ["AgentCore CLI"] = 1392,
    AgentLoopKit = 1393,
    Aider = 1341,
    Air = 31,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1362,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1361,
    ["Airlock Microgateway"] = 47,
    ["Alacritty Configuration"] = 1154,
    ["AlgoVoi Compliance Receipt v1"] = 17,
    ["All Contributors configuration file"] = 1208,
    ["Amazon S3 bucket CORS"] = 19,
    Anodizer = 506,
    ["Ansible Argument Specs"] = 488,
    ["Ansible Collection Galaxy"] = 495,
    ["Ansible Execution Environment"] = 485,
    ["Ansible Inventory"] = 494,
    ["Ansible Meta"] = 486,
    ["Ansible Meta Runtime"] = 487,
    ["Ansible Navigator Configuration"] = 497,
    ["Ansible Playbook"] = 492,
    ["Ansible Requirements"] = 489,
    ["Ansible Rulebook"] = 493,
    ["Ansible Tasks File"] = 491,
    ["Ansible Vars File"] = 490,
    ["Ansible-lint Configuration"] = 496,
    Any = 1273,
    ...
    ["Application list for a WinUtil"] = 1291,
    ["ArchSmith diagram IR"] = 1427,
    ArchitectFX = 1296,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1360,
    ["Azure IoT Operations connector metadata"] = 1357,
    ...
    ["Azure Pipelines"] = 134,
    ["Azure Static Web Apps CLI configuration file"] = 950,
    ["Azure Static Web Apps configuration file"] = 949,
    BMML = 1379,
    ["BOSH BPM Config"] = 160,
    ["BOSH CPI Config"] = 161,
    ...
    ["Bacon config"] = 11,
    ["Barba-CV"] = 100,
    ["Bashly (bashly.yml)"] = 1212,
    ["Bashly Settings (bashly-settings.yml)"] = 1213,
    Bento = 1378,
    ["Better Code Hub"] = 1123,
    ["Better Scripts"] = 184,
    Bigconfig = 153,
    ["Biome Formatter Config"] = 101,
    ["Bitmovin Encoding Template"] = 1305,
    BizTalkServerApplicationSchema = 1089,
    Bleep = 185,
    ["Block Protocol Metadata"] = 182,
    ["Bluebricks blueprint config"] = 1384,
    ["Boyka Framework"] = 163,
    ["Bpod Finite-State Machine"] = 103,
    Briefcase = 1095,
    ["Build Info"] = 173,
    Buildkite = 175,
    ["Bukkit plugin.yml"] = 174,
    ["BungeeCord plugin.yml"] = 180,
    ["Burnless SRE config"] = 4,
    ["Butane Config"] = 1167,
    C4InterFlow = 1320,
    ["CDK Environment Manager, concrete environment configuration"] = 1344,
    ["CDK Environment Manager, concrete environments definition"] = 1343,
    ["CDK Environment Manager, environment definition"] = 1342,
    ["CGS Card Game Specification (cgs.json)"] = 1250,
    ["CICS TS region tagging"] = 1176,
    ["CICS TS resource import"] = 1177,
    ["CICS TS resource model"] = 1178,
    ["CICS TS resource overrides"] = 1179,
    ["CMake Presets"] = 186,
    ["CNC Codes"] = 209,
    ["CRS WAF test file"] = 1280,
    ["CRS WAF test platform overrides file"] = 1281,
    ["CSS Comb (.csscomb.json)"] = 339,
    ["CSS Lint (.csslintrc)"] = 340,
    ["CSpell (cspell.json)"] = 338,
    ["CVE Record Format"] = 221,
    ["CVX achievements.yaml"] = 227,
    ["CVX competencies.yaml"] = 226,
    ["CVX config.yaml"] = 230,
    ["CVX education.yaml"] = 225,
    ["CVX experience.yaml"] = 224,
    ["CVX keywords.yaml"] = 229,
    ["CVX layout"] = 231,
    ["CVX personal.yaml"] = 222,
    ["CVX referees.yaml"] = 228,
    ["CVX summary.yaml"] = 223,
    CWL = 1256,
    ["Cache Warmup config"] = 187,
    ["Caido Proxy Configuration"] = 1417,
    ["Calqulus pipeline"] = 188,
    ["Camel YAML DSL"] = 189,
    ["Cannon TOML"] = 190,
    Carafe = 191,
    ["Cargo Make"] = 193,
    ["Cargo Manifest"] = 192,
    ["Catalog Info Backstage"] = 194,
    ["Chamaleon environment"] = 1309,
    ["Chamaleon properties"] = 1310,
    ["Chamaleon template"] = 1308,
    Changepacks = 1371,
    Changesets = 321,
    Changie = 195,
    Charmcraft = 196,
    Cheatsheets = 1164,
    ["ChordPro Configuration"] = 198,
    ["Chrome Extension"] = 302,
    ["Chromia Model"] = 199,
    ["Chromia Seeder Module Config"] = 201,
    ["Chromia Seeder Root Config"] = 200,
    ["Cinnamon Spice info.json"] = 111,
    ["CircleCI config.yml"] = 272,
    ["Citation File Format"] = 323,
    ["Citrus test case"] = 203,
    CityJSON = 204,
    ["Claude Code Keybindings"] = 216,
    ["Claude Code Launch Preview"] = 1426,
    ["Claude Code Plugin Manifest"] = 217,
    ["Claude Code Plugin Marketplace"] = 218,
    ["Claude Code Settings"] = 219,
    ["Clawject config"] = 215,
    ["Cloud Foundry Application Manifest"] = 1262,
    ["Cloud Run Spec v1"] = 1286,
    ...
    ["CloudEvents specification"] = 205,
    ["Code Climate"] = 273,
    CodeCV = 115,
    CodeRabbit = 114,
    ["CodeShip Pro services configuration files"] = 291,
    ["CodeShip Pro steps configuration files"] = 292,
    ["Codecov configuration files"] = 290,
    Codex = 281,
    ["Codex Hooks"] = 282,
    ["Codex Plugin Manifest"] = 283,
    ["Codex Skill Metadata"] = 284,
    CodifyCLI = 116,
    Codux = 286,
    ["Cog config file"] = 210,
    ["Commandbox Box.json"] = 211,
    ["Commandbox Server.json"] = 212,
    ["Common Catalog Data"] = 300,
    ["Common Package Specification"] = 213,
    Concord = 1279,
    ["Configu .cfgu files"] = 1267,
    ["Configu .configu file"] = 1268,
    Conjure = 208,
    ["Container Structure Test"] = 1103,
    Containerlab = 1132,
    ["Contextive Glossary"] = 1336,
    ContractGuard = 1133,
    Convex = 207,
    ["Crowdsec collection config"] = 332,
    ["Crowdsec parser config"] = 333,
    ["Crowdsec scenario config"] = 334,
    ["CumulusCI Config"] = 214,
    ["Cursor Agent Environment"] = 1389,
    ["Custom Machinery Machine"] = 1251,
    ["Custom Machinery Recipe"] = 1252,
    ["Cycle Stack File"] = 232,
    CycloneDX = 233,
    ["DWP Exchange - catalogue entry"] = 386,
    ["DWP Exchange - gateway"] = 384,
    ["DWP Exchange - meta"] = 385,
    ["Dark Factory consumer config"] = 234,
    ["Dart Build Config (dart-build.json)"] = 341,
    ["Dart Test Config (dart-test.json)"] = 342,
    ["DashLord Configuration"] = 343,
    ["Data Contract Specification"] = 344,
    ["Data Product Specification"] = 345,
    ["DataYoga Connections"] = 235,
    ["DataYoga Job"] = 236,
    ["Datadog Continuous Testing"] = 595,
    ["Datadog Service Definition"] = 596,
    ["Datadog Software Catalog"] = 597,
    ["Datahub Ingestion Recipe"] = 1183,
    ["Debian Upstream Metadata file"] = 243,
    DebtLens = 244,
    ["Deck config"] = 245,
    ["Declarative Automation Bundles"] = 1229,
    ["DeepMatch deeplinks spec"] = 246,
    ["Dein Config"] = 247,
    ["Deno Config (deno.json)"] = 352,
    ["Dependency cruiser"] = 248,
    ["DeployStack Configuration"] = 249,
    ["Deployah Configuration"] = 1359,
    ["Deployer Recipe"] = 355,
    ["Deta Spacefile"] = 250,
    ["Detekt Config (detekt.yml)"] = 356,
    ["Devbox Config"] = 251,
    ["Devbox Plugin"] = 252,
    Devfile = 383,
    Devup = 1372,
    DipDup = 1282,
    ["Discord Webhook"] = 357,
    ["DocFx Config (docfx.json)"] = 362,
    ["Docker Desktop extension metadata"] = 359,
    ["Docs MCP Manifest"] = 363,
    Dofigen = 364,
    ["Dolittle Artifacts"] = 365,
    ["Dolittle Bounded Context Configuration"] = 366,
    ["Dolittle Event Horizons Configuration"] = 367,
    ["Dolittle Resources Configuration"] = 368,
    ["Dolittle Server Configuration"] = 369,
    ["Dolittle Tenant Map Configuration"] = 371,
    ["Dolittle Tenants Configuration"] = 370,
    ["Dolittle Topology"] = 372,
    ["DonateCaseBetterCasino menu"] = 1313,
    ["Draugr Saga"] = 351,
    ["Drupal Breakpoints"] = 254,
    ["Drupal Config"] = 266,
    ["Drupal Info"] = 255,
    ["Drupal Layouts"] = 256,
    ["Drupal Libraries"] = 257,
    ["Drupal Links Action"] = 258,
    ["Drupal Links Contextual"] = 259,
    ["Drupal Links Menu"] = 260,
    ["Drupal Links Task"] = 261,
    ["Drupal Migration"] = 262,
    ["Drupal Permissions"] = 263,
    ["Drupal Recipe"] = 264,
    ["Drupal Routing"] = 265,
    ["Drupal Services"] = 267,
    ["Drush site aliases"] = 378,
    ["Dust configuration"] = 381,
    ["Dynamic Bash Aliases (.aliases)"] = 1220,
    ["EAS config"] = 425,
    ["ECA - Editor Code Assistant"] = 388,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1209,
    ["ESLint Suppressions"] = 430,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1356,
    ["EasyVCR .NET"] = 427,
    ["Eidolon Resource"] = 1297,
    ["Elgato Stream Deck"] = 391,
    Elm = 1284,
    ["Embrace Config"] = 1195,
    Emmet = 1285,
    Endurica = 1233,
    ["Enonic XP API descriptor"] = 394,
    ["Enonic XP Admin Extension descriptor"] = 395,
    ["Enonic XP Admin Tool descriptor"] = 396,
    ["Enonic XP Application descriptor"] = 397,
    ["Enonic XP CMS descriptor"] = 398,
    ["Enonic XP Content Type descriptor"] = 399,
    ["Enonic XP Form Fragment descriptor"] = 400,
    ["Enonic XP ID Provider descriptor"] = 401,
    ["Enonic XP Layout descriptor"] = 402,
    ["Enonic XP Macro descriptor"] = 403,
    ["Enonic XP Mixin descriptor"] = 404,
    ["Enonic XP Page descriptor"] = 405,
    ["Enonic XP Part descriptor"] = 406,
    ["Enonic XP Service descriptor"] = 407,
    ["Enonic XP Site descriptor"] = 408,
    ["Enonic XP Style descriptor"] = 409,
    ["Enonic XP Task descriptor"] = 410,
    ["Enonic XP Webapp descriptor"] = 411,
    ["Enterprise Contract Policy Spec"] = 392,
    ["Envelope Team Definition"] = 1401,
    ["Envilder Map File"] = 393,
    ["Erda Pipeline"] = 1258,
    ["Erda Runtime"] = 1259,
    ["Espanso config.yml"] = 1382,
    ["Espanso match.yml"] = 1381,
    Esquio = 413,
    ["Estuary Flow Catalog"] = 1173,
    ["Ethereum ERC1155"] = 1395,
    ["Ethereum ERC721"] = 1394,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 418,
    ["EveryVoice TTS Toolkit Data Configuration"] = 419,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 423,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 422,
    ["EveryVoice TTS Toolkit Text Configuration"] = 420,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 421,
    ["Evolving Resolutive Process notation"] = 1358,
    ["Expo SDK"] = 424,
    ["Expoot app config"] = 426,
    ["F-Droid Data metadata"] = 432,
    ["FasterCI Configuration"] = 135,
    ["Fence configuration"] = 136,
    FiQuS = 436,
    Firebase = 434,
    ["Flatpak Builder Manifest"] = 437,
    ["FlexGet Config"] = 438,
    ["Flow.json Configurations"] = 1255,
    ["Fossa configuration file"] = 445,
    ["Fossa's fossa-deps file"] = 446,
    ["Foundry VTT - Base package Manifest"] = 440,
    ["Foundry VTT - Module Manifest"] = 441,
    ["Foundry VTT - System Data Template"] = 444,
    ["Foundry VTT - System Manifest"] = 442,
    ["Foundry VTT - World Manifest"] = 443,
    ["Foxx Manifest"] = 137,
    ["Freifunk.de Community API"] = 140,
    ["Frogbot Config"] = 141,
    ["G2P Mapping Configuration"] = 453,
    GAMA = 454,
    ["GCP Blueprint Metadata"] = 457,
    Gaspar = 455,
    ["GatewayCore API Gateway"] = 456,
    ["Gemini CLI settings"] = 458,
    ["GeoJSON.json latest"] = 1171,
    GherKing = 1175,
    ["GitHub Action"] = 468,
    ["GitHub Actions typing"] = 1293,
    ["GitHub CLI configuration"] = 469,
    ["GitHub CLI hosts"] = 470,
    ["GitHub Discussion"] = 471,
    ["GitHub Funding"] = 473,
    ["GitHub Issue Template configuration"] = 474,
    ["GitHub Issue Template forms"] = 475,
    ["GitHub Pages Jekyll"] = 476,
    ["GitHub Prompt"] = 472,
    ["GitHub Secret Scanning"] = 477,
    ["GitHub Workflow"] = 478,
    ["GitHub Workflow Template Properties"] = 479,
    ["GitHub automatically generated release notes configuration"] = 480,
    ["GitLab Agent for Kubernetes configuration"] = 1247,
    ["GitLab Duo Workflow"] = 482,
    GitResume = 484,
    GitVersion = 461,
    ["Gitea Issue Template configuration"] = 464,
    ["Gitea Issue Template forms"] = 465,
    Gitleaks = 462,
    ["Gitpod Configuration"] = 483,
    ["Glamour style"] = 459,
    ["GlazeWM settings"] = 1249,
    ["Global Privacy Control"] = 460,
    Goblet = 1228,
    ["Golangci-lint Configuration"] = 499,
    ["Golangci-lint Custom Plugins Configuration"] = 500,
    ["Google Chrome Related Website Sets"] = 435,
    ["Google Cloud Workflows"] = 308,
    ["Google Digital Assetlinks"] = 1337,
    Goreleaser = 504,
    ["Goreleaser Pro"] = 505,
    Goss = 507,
    ["Gradle Build Cache Node"] = 1121,
    ["Gradle Enterprise"] = 1120,
    ["Grafana 5.x Dashboard"] = 508,
    ["GraphQL Code Generator"] = 513,
    ["GraphQL Config"] = 512,
    ["GraphQL Mesh"] = 511,
    ["GroovyLint configuration"] = 514,
    ["Grunt JSHint task"] = 518,
    ["Grunt Watch task"] = 519,
    ["Grunt base task"] = 520,
    ["Grunt clean task"] = 516,
    ["Grunt copy task"] = 515,
    ["Grunt cssmin task"] = 517,
    HEMTT = 1085,
    Hadolint = 1099,
    Hammerkit = 1131,
    ["Hardware Sentry Configuration"] = 1187,
    ["Hashgraph Online Skill Manifest"] = 7,
    ["HashiCorp Vault"] = 521,
    Hatch = 1100,
    Hayson = 523,
    ["Haystack Pipeline"] = 524,
    ["Hazelcast 5 Configuration"] = 525,
    ["Hecate Input Schema"] = 1348,
    ["Helm Chart.lock"] = 269,
    ["Helm Chart.yaml"] = 268,
    ["Helm Unittest Test Suite"] = 270,
    ["Heloisa Assistant Plugins Marketplace"] = 1424,
    ["Hex file"] = 271,
    ["Home Assistant Integration Manifest"] = 527,
    ["Homer dashboard configuration"] = 528,
    ["Hoverfly Simulation"] = 533,
    Hugo = 1163,
    ["Hugo Theme"] = 1162,
    ["Hulak Configuration"] = 536,
    ["Hyperfoil benchmark configuration"] = 535,
    ["IBM Zapp document"] = 537,
    ["IBM zCodeFormatSettings"] = 538,
    ["IMG Catapult PSP"] = 543,
    ["IVMS101 by CODE Protocol"] = 1248,
    ["Infinispan Configuration"] = 545,
    ["Infinispan Server Configuration"] = 546,
    Infrahub = 547,
    Istanbul = 1191,
    ["JDownloader2 crawler multi-rules"] = 561,
    ["JDownloader2 crawler single-rules"] = 560,
    ["JFrog Applications Config"] = 562,
    ["JFrog File Spec"] = 563,
    ["JFrog Pipelines YML DSL"] = 1197,
    ["JMeter DSL cli config"] = 564,
    JReleaser = 567,
    ["JSON Document Transform"] = 575,
    ["JSON Feed"] = 576,
    ["JSON Resume"] = 853,
    ["JSON Schema Draft 2020-12"] = 1065,
    ["JSON Schema Draft 4"] = 1062,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1230,
    ["JSON Schema Draft 7"] = 1063,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1231,
    ["JSON Schema Draft 8 (2019-09)"] = 1064,
    ["JSON-API"] = 574,
    ["JSON-e templates"] = 1128,
    ["JSON-stat 2.0"] = 1058,
    JSONPatch = 578,
    ["JSR Package Config (jsr.json)"] = 568,
    Jarl = 1364,
    Jasmine = 555,
    Jekyll = 556,
    ["Jenkins X Pipelines"] = 557,
    ["Jenkins X Requirements"] = 558,
    Jest = 559,
    Jocker = 565,
    ["Jovo Language Models"] = 566,
    Jsontron = 579,
    ["Jujutsu (jj) VCS config"] = 1350,
    ["KIMMDY config file"] = 590,
    ["KODE/CI build.yaml"] = 1193,
    ["KSP-AVC"] = 1059,
    ["KSP-CKAN"] = 1060,
    ["KSP-NetKAN"] = 1061,
    KSY = 1260,
    KSail = 451,
    ["KYA Manifest"] = 1261,
    ["Karakum configuration file"] = 447,
    Kas = 582,
    ["Kestra flow file"] = 591,
    ["Keycloak REST API"] = 1200,
    ["Knative Functions - func.yaml"] = 448,
    Knip = 449,
    ["Knip JSONC"] = 450,
    ["Knowledge Unit"] = 599,
    ["Kometa (nightly) config file"] = 593,
    ["Kometa config file"] = 592,
    ["Kong DBLess config"] = 1194,
    KrakenD = 594,
    ["Kubri Configuration"] = 602,
    LOOBin = 620,
    ["Lake configuration file"] = 1353,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 313,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 314,
    ["Landing Zone Accelerator on AWS - Global Config"] = 315,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 316,
    ["Landing Zone Accelerator on AWS - Network Config"] = 317,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 318,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 319,
    ["Landing Zone Accelerator on AWS - Security Config"] = 320,
    ["Lando (landofile)"] = 127,
    ["LangGraph Platform configuration"] = 1272,
    ["Language configuration"] = 1271,
    Lefthook = 607,
    ["Liferay client-extension.yaml"] = 614,
    ["LinkML Metamodel"] = 616,
    ["LiquiLens Evidence Carrier Reference v1"] = 618,
    ["LiquiLens Evidence Carrier v1"] = 617,
    Liquibase = 1138,
    ["Liquibase Flow File"] = 1139,
    ["Lively Properties"] = 619,
    ["Lobe AI Agent"] = 129,
    Loki = 130,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 663,
    ["MS2Rescore Configuration"] = 671,
    ["MSTest testconfig.json"] = 672,
    ["Madge configuration"] = 626,
    ["Madness (madness.yml)"] = 1211,
    ["Mado configuration"] = 627,
    ["Maestro Flow"] = 628,
    ["Mail Servers Configuration"] = 1385,
    ["MapEHR Mapping"] = 629,
    Markdownlint = 1142,
    ["Mason Registry"] = 1145,
    ["MegaLinter Custom Flavor"] = 632,
    ["MegaLinter configuration"] = 631,
    ["MegaLinter descriptor"] = 633,
    Melange = 1238,
    ["Meltano project definition"] = 634,
    ["Mergify Configuration"] = 673,
    ["Mermaid config"] = 2,
    ["Metadata for a Bazel module"] = 635,
    ["Metadata for a Cinnamon spice"] = 1289,
    ["Metatype Configuration"] = 636,
    ["MetricsHub Configuration"] = 637,
    ["MetricsHub Connector Configuration"] = 638,
    ["Micro Editor Syntax"] = 1221,
    ["Microsoft Band Web Tile"] = 639,
    ["Microsoft RulesEngine workflow rules"] = 1276,
    ["Microsoft RulesEngine workflow rules list"] = 1277,
    ["Minecraft Custom Main Menu Mod"] = 1239,
    ["Minecraft Data Pack Advancement"] = 641,
    ["Minecraft Data Pack Biome"] = 642,
    ["Minecraft Data Pack Configured Carver"] = 643,
    ["Minecraft Data Pack Damage Type"] = 644,
    ["Minecraft Data Pack Dimension"] = 646,
    ["Minecraft Data Pack Dimension Type"] = 645,
    ["Minecraft Data Pack Item Modifier"] = 647,
    ["Minecraft Data Pack Loot Table"] = 648,
    ["Minecraft Data Pack Metadata"] = 649,
    ["Minecraft Data Pack Predicate"] = 650,
    ["Minecraft Data Pack Recipe"] = 651,
    ["Minecraft Data Pack Tag"] = 652,
    ["Minecraft Data Pack Template Pool"] = 653,
    ["Minecraft Data Pack Trim Material"] = 658,
    ["Minecraft Data Pack Trim Pattern"] = 659,
    ["Minecraft Resource Pack Lang"] = 654,
    ["Minecraft Resource Pack Particle"] = 655,
    ["Minecraft Resource Pack Texture Mcmeta"] = 657,
    ["Minecraft Resourcepack Sounds"] = 656,
    ["MockServer Expectation"] = 665,
    ["MockServer Expectations"] = 666,
    ModuleAssembler = 661,
    ["Monade CLI Stack Configuration"] = 676,
    ["MongoDB Atlas Search Index Definition"] = 1192,
    ["Monika Configuration"] = 1190,
    ["Monoweave Configuration"] = 670,
    ["Motif config"] = 1081,
    MultiQC = 1330,
    ["NOX Framework (Service)"] = 698,
    ["Netin Diagnostic System Template"] = 1149,
    ["Netlify config"] = 679,
    ["Network-as-Code Data Model"] = 680,
    ["Next Gen UI Agent A2A Server Configuration"] = 681,
    ["Next Gen UI Agent Configuration"] = 683,
    ["Next Gen UI Agent MCP Server Configuration"] = 682,
    ["Nightwatch.js"] = 690,
    ["Nika workflow"] = 695,
    ["Node.js configuration"] = 1086,
    ["NueJS configuration file"] = 703,
    ["Nuitka Package Config"] = 1253,
    ["Nullstone config"] = 705,
    ["ODGS Data Rules"] = 712,
    ["ODGS Ontology Graph"] = 713,
    ["ODGS Standard Metrics"] = 711,
    ["OKF Graph"] = 1425,
    ["ONe's changelog entry"] = 727,
    ["ONe's service descriptor"] = 726,
    ["ORT Server repository environment configuration"] = 738,
    ["OSCAL Assessment Plan (AP)"] = 740,
    ["OSCAL Assessment Results (AR)"] = 741,
    ["OSCAL Catalog"] = 742,
    ["OSCAL Component Definition (CDef)"] = 743,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 744,
    ["OSCAL Profile"] = 745,
    ["OSCAL System Security Plan (SSP)"] = 746,
    ["OSS Review Toolkit configuration"] = 747,
    ["OSS Review Toolkit curation"] = 748,
    ["OSS Review Toolkit package configuration"] = 749,
    ["OSS Review Toolkit project package manager definition"] = 750,
    ["OSS Review Toolkit repository configuration"] = 751,
    ["OSS Review Toolkit resolutions"] = 752,
    ["October CMS columns"] = 709,
    ["October CMS fields"] = 710,
    ["Oh My Posh"] = 715,
    Okteto = 716,
    ["Ona Tasks and Services"] = 718,
    Opctl = 1084,
    ["Open Data Contract Standard (ODCS)"] = 731,
    ["Open Data Product Standard (ODPS)"] = 732,
    ["Open Know-How"] = 1335,
    ["Open Pentest Format"] = 733,
    OpenDecree = 1399,
    ["OpenDecree Configuration"] = 1400,
    ["OpenRewrite Resource"] = 729,
    OpenSRM = 734,
    OpenStatus = 1346,
    ["OpenTelemetry Declarative Configuration"] = 730,
    ["OpenUtau character yaml"] = 723,
    ["OpenUtau ustx"] = 724,
    ["OpenWeather Current Weather API"] = 1127,
    ["OpenWeather Road Risk API"] = 1126,
    ["Ory Hydra configuration"] = 534,
    ["Ory Keto configuration"] = 598,
    ["Ory Kratos configuration"] = 739,
    ["Ory Oathkeeper configuration"] = 707,
    ["Outblocks App configuration"] = 736,
    ["Outblocks database table"] = 737,
    ["Outblocks project configuration"] = 735,
    PDM = 760,
    POPxf = 772,
    ["POPxf Correlations"] = 773,
    ["PRML manifest"] = 780,
    Packer = 756,
    PactSpec = 757,
    Panache = 758,
    Pantsbuild = 1207,
    ["Paper paper-plugin.yml"] = 759,
    ["Pipeline component"] = 1140,
    ["Platform.sh application"] = 13,
    ["Platform.sh routes"] = 14,
    ["Platform.sh services"] = 15,
    ["Plex Prerolls"] = 770,
    ["PocketMine plugin.yml"] = 767,
    ["Podman Desktop Extension"] = 1419,
    ["Postman collection"] = 776,
    ["Power Pages Configuration"] = 1347,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1292,
    ["ProActions AI-Kit Configuration"] = 788,
    ["ProActions AI-Kit Configuration for Menus"] = 790,
    ["ProActions AI-Kit Configuration for Sections"] = 792,
    ["ProActions AI-Kit Configuration for Services"] = 789,
    ["ProActions AI-Kit Configuration for Steps"] = 793,
    ["ProActions AI-Kit Configuration for Templates"] = 791,
    ["Problem object RFC9457"] = 1236,
    ["Problem package format"] = 794,
    ["Problem package generators"] = 795,
    ["Problem package submissions"] = 796,
    ["Problem package test group metadata"] = 797,
    Pterodactyl = 1186,
    ["Pull Request Labeler"] = 814,
    Pulumi = 822,
    ["PyGTA Config"] = 818,
    PyProject = 823,
    Pylock = 1338,
    Pyright = 824,
    ["Python script metadata"] = 1332,
    ["QType AI DSL"] = 827,
    Qgoda = 826,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1411,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1409,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1415,
    ["Qlik Talend Cloud Pipeline - Project"] = 1407,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1410,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1412,
    ["Qlik Talend Cloud Pipeline - Task"] = 1408,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1414,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1413,
    Qodana = 1159,
    ["Qt Creator workspace file"] = 1269,
    ["Quali Torque Blueprint Spec 2"] = 1184,
    ["QueryFirst config file"] = 1203,
    ["QuikRun Configuration"] = 1416,
    ["Qwen Code Settings"] = 1396,
    ["RKE Cluster Configuration JSON"] = 1137,
    ["RKE Cluster Configuration YAML"] = 1136,
    RadioHound = 817,
    ["Raid Profile"] = 1397,
    ["Raid Repo Configuration"] = 1398,
    Railpack = 829,
    Railway = 828,
    ["Rancher Fleet"] = 819,
    ["Rattler-build"] = 830,
    Ray = 1098,
    ["Read the Docs"] = 821,
    ["Red-DiscordBot Cog"] = 837,
    ["Red-DiscordBot Cog Repo"] = 838,
    ["Red-DiscordBot Trivia"] = 839,
    ["Releasaurus Config"] = 10,
    ReleaseKit = 9,
    ["Render Blueprints"] = 1135,
    RenderCV = 857,
    Renovate = 854,
    ["Renovate global configuration"] = 855,
    ["Renovate inherited configuration"] = 856,
    ["Replit config"] = 845,
    Restate = 1325,
    ["Revel Digital Gadget Definition File"] = 1349,
    RoadRunner = 859,
    ["Robust Station Image"] = 1355,
    Rockcraft = 860,
    ["Roo Coder Custom Modes"] = 861,
    Rubocop = 850,
    ["Rudder techniques"] = 1243,
    Ruff = 851,
    ["Rust Project"] = 852,
    ["Rust toolchain"] = 866,
    ["SDMX data message"] = 893,
    ["SDMX metadata message"] = 892,
    ["SDMX structure message"] = 891,
    ["SIL Kit Participant Configuration"] = 904,
    ["SIL Kit Registry Configuration"] = 905,
    ["SPDX 2.3"] = 947,
    SWADL = 963,
    ["Safebox Config"] = 1198,
    ["Sapphire CLI Config"] = 869,
    ["SauceCTL Configuration"] = 1146,
    Scarb = 889,
    ["Schema Catalog"] = 884,
    ["Scoop manifest"] = 890,
    ["Secure SDLC Evidence Bundle"] = 894,
    ["Semantic Data Fabric (SDF) file"] = 895,
    ["Semgrep Rule"] = 897,
    ["Serenity Code Generator (Sergen)"] = 898,
    ["Serverless Framework Configuration"] = 1153,
    ["Serverless Workflow"] = 1155,
    ["Settings for a Cinnamon spice"] = 1288,
    ["Settings.paf"] = 900,
    ["Shopware 6 Configuration"] = 1156,
    ["Shopware CLI Extension Store Configuration"] = 1157,
    ["Shopware CLI Project Store Configuration"] = 1158,
    ["Sigma Detection Rule"] = 902,
    ["SigmaCV CV"] = 5,
    ["Sigrid scope configuration file"] = 903,
    ["SkyPilot Task JSON"] = 1244,
    ["Slack app manifest"] = 910,
    ["Slang Server Configuration"] = 1423,
    Snapcraft = 912,
    ["Solarxy project config"] = 915,
    Solidarity = 916,
    ["Solution filters"] = 917,
    ["Source Maps v3"] = 918,
    Sourcery = 919,
    ["Spack bootstrap.yaml"] = 920,
    ["Spack cdash.yaml"] = 921,
    ["Spack ci.yaml"] = 922,
    ["Spack compilers.yaml"] = 923,
    ["Spack concretizer.yaml"] = 924,
    ["Spack config.yaml"] = 925,
    ["Spack definitions.yaml"] = 926,
    ["Spack develop.yaml"] = 927,
    ["Spack env_vars.yaml"] = 928,
    ["Spack environment"] = 934,
    ["Spack include.yaml"] = 929,
    ["Spack mirrors.yaml"] = 930,
    ["Spack modules.yaml"] = 931,
    ["Spack packages.yaml"] = 932,
    ["Spack repos.yaml"] = 933,
    ["Spack toolchains.yaml"] = 935,
    ["Spack upstreams.yaml"] = 936,
    ["Spack view.yaml"] = 937,
    ["Speakeasy Generation Config File"] = 941,
    ["Speakeasy Lint Configuration File"] = 938,
    ["Speakeasy Test Generation Configuration File"] = 939,
    ["Speakeasy Workflow File"] = 940,
    SpecIF = 942,
    ["Specmatic Configuration"] = 943,
    ["Specpin spec file"] = 3,
    ["Sponge Mixin configuration"] = 944,
    ["Spotlight Ruleset"] = 945,
    StackBlitz = 951,
    ["StackHawk Scanner Configuration"] = 1152,
    Stale = 952,
    Starfish = 953,
    ["Starlake Data Pipeline"] = 1124,
    Starship = 954,
    ["Statamic Blueprint"] = 955,
    ["Stella configuration file"] = 956,
    ["Streamlit configuration file"] = 957,
    ["Stryker Mutator"] = 960,
    ["StyleCop Analyzers Configuration"] = 961,
    ["Stylelint (.stylelintrc)"] = 962,
    ["Stylua Config"] = 1339,
    ["Sublime Syntax"] = 1199,
    ["Subsquid squid manifest"] = 1246,
    ["Swagger API 2.0"] = 964,
    ["Symfony Routing Configuration"] = 965,
    ["Symfony Serializer Mapping"] = 966,
    ["Symfony Services Configuration"] = 967,
    ["Symfony Validation Mapping"] = 968,
    ["Synadia Connect Component"] = 969,
    TSON = 1007,
    TSTyche = 1008,
    ["TYPO3 Vendor Bundler config"] = 1014,
    ["Tab data for a LinUtil"] = 1295,
    ["Tab list for a LinUtil"] = 1294,
    Tach = 970,
    ["Tach Domain"] = 971,
    Talhelper = 973,
    ["Talisman configuration"] = 974,
    Taplo = 1340,
    ["Taskfile config"] = 1129,
    Taurus = 975,
    Tauticord = 976,
    ["Tekton Pipeline"] = 1368,
    ["Tekton PipelineRun"] = 1369,
    ["Tekton Task"] = 1366,
    ["Tekton TaskRun"] = 1367,
    Telefonistka = 1326,
    ["Terrateam config"] = 1352,
    ["TestEnvironment.json"] = 988,
    ["TextMate Grammar"] = 987,
    Threagile = 982,
    ["Tier.run pricing.json"] = 979,
    Tikibase = 980,
    Tombi = 985,
    ["Traefik v2"] = 991,
    ["Traefik v2 File Provider"] = 992,
    ["Traefik v3"] = 993,
    ["Traefik v3 File Provider"] = 994,
    ["Travis CI (.travis.yml)"] = 990,
    Treefmt = 510,
    Trident = 1322,
    Trivy = 997,
    ["TrueScript for *.tscript files"] = 998,
    ["Tugboat QA config.yml"] = 1319,
    TunnelHub = 1234,
    Turborepo = 989,
    Tycho = 1283,
    Tye = 1160,
    ["Tyk Gateway - Open Source v5.7+"] = 1331,
    ["UET BuildConfig.json"] = 1204,
    ["UI5 Manifest"] = 1020,
    ["UNCORS configuration"] = 1025,
    ["UTAM Page Object"] = 1023,
    ["Ubuntu Server Autoinstall"] = 1018,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1323,
    ["Uniswap Token List"] = 1109,
    ["Universal Schedule Format"] = 1026,
    ["Unreal Engine Uplugin"] = 1205,
    ["Unreal Engine Uproject"] = 1206,
    ["UpCloud CLI (upctl) configuration"] = 1324,
    ["Updatecli Compose"] = 1168,
    ["Updatecli Policy Manifest"] = 1169,
    ["Updatecli Policy Metadata"] = 1170,
    Uplift = 1202,
    ["Upsun config"] = 12,
    ["User Journey Map"] = 1134,
    V2Ray = 1174,
    ["VSCode Code Snippets"] = 296,
    ["VSIX CLI publishing"] = 1045,
    Vector = 1028,
    ["Vela Pipeline Configuration"] = 1031,
    Vercel = 295,
    ["Version Bumper config"] = 1034,
    Vespertide = 1373,
    ["Vespertide Migration"] = 1374,
    ["Vespertide Model"] = 1375,
    ["Viash Component Config"] = 1328,
    ["Viash Package Config"] = 1329,
    Visivo = 1232,
    Vogi = 1039,
    ["WP-CLI"] = 1055,
    Wake = 1321,
    ["Waku Config"] = 1298,
    ["Web App Manifest"] = 1051,
    ["Web types"] = 1054,
    WebExtensions = 1050,
    ["Webman package recipe"] = 1180,
    ["Windows Package Manager Installer Manifest"] = 1106,
    ["Windows Package Manager Locale Manifest"] = 1107,
    ["Windows Package Manager Singleton Manifest"] = 1105,
    ["WireMock CLI import configuration"] = 1304,
    ["WireMock CLI local service configuration"] = 1303,
    ["WireMock message stub mapping"] = 1302,
    ["WireMock stub mapping"] = 1301,
    ["Woodpecker pipeline config"] = 1148,
    ["Wrangler CLI"] = 1056,
    ["XenForo add-on manifest"] = 1057,
    ["Xstate Machine"] = 1166,
    ["Yandex Workflow Language"] = 1290,
    ["Yarn Config (.yarnrc.yml)"] = 1122,
    ["Yippee-Ki-JSON configuration YML"] = 1113,
    ["YouTrack App"] = 1287,
    ["Zarf Package Configuration"] = 1354,
    ["Zerops import file"] = 1275,
    ["Zola Configuration"] = 1365,
    abtop = 33,
    act3 = 1403,
    actionlint = 43,
    ["aerleon.yml"] = 27,
    ["amplify.yml"] = 20,
    ["amxx-builder manifest"] = 1418,
    ["angular.json"] = 48,
    apko = 1237,
    ...
    ["behat.yml"] = 164,
    ["bigquery-table"] = 152,
    ["bioimageio resource description"] = 1254,
    ...
    ["bozr.suite.json"] = 168,
    bpkg = 1215,
    ["browser.i18n.json"] = 169,
    ["browsh configuration"] = 170,
    bucklescript = 171,
    ["buf.gen.yaml"] = 105,
    ["buf.lock"] = 106,
    ["buf.plugin.yaml"] = 107,
    ...
    ["build-changelog"] = 172,
    ["bun.lock"] = 177,
    ["bundleconfig.json"] = 178,
    ["bunfig.toml"] = 179,
    ["cargo-mutants-config.yaml"] = 110,
    ["cargo-nextest repository configuration"] = 684,
    ["cargo-nextest user configuration"] = 685,
    ["ccmod.json"] = 1299,
    changelogging = 1266,
    ["chezmoi configuration"] = 197,
    ["chisel-slices.json"] = 322,
    ["chrome-extension-locales-messages.json"] = 303,
    ["chutzpah.json"] = 304,
    cibuildwheel = 202,
    ["clang-format (.clang-format)"] = 1172,
    ["clang-tidy"] = 277,
    clangd = 276,
    clib = 278,
    ["cloud-init: cloud-config userdata"] = 280,
    ["cloud-sdk-pipeline-configuration"] = 306,
    ["cloudbuild.json"] = 307,
    cloudify = 279,
    cmakefmt = 220,
    ["cmdx.yaml"] = 113,
    ...
    ["commands.json"] = 299,
    ["commit-check"] = 325,
    ["commitlint (.commitlintrc)"] = 1108,
    ["committed.toml"] = 326,
    ["compile_commands.json"] = 298,
    ["compilerconfig.json"] = 297,
    ["completely.yml"] = 1210,
    ["component-detection-manifest.json"] = 329,
    ["component.json"] = 328,
    ["composer.json"] = 327,
    ["conda-forge"] = 206,
    ["config.yaml"] = 820,
    ["contentmanifest.json"] = 305,
    ["contribute.json"] = 330,
    ["cosmos.config.json"] = 301,
    ["crowdin.yml"] = 331,
    crucible = 335,
    ["ctfd-setup configuration file"] = 1311,
    ["custom-elements.json"] = 1224,
    ["cypress.json"] = 336,
    ["dacier.yml"] = 1406,
    ["datalogic-scan2deploy-android"] = 346,
    ["datalogic-scan2deploy-ce"] = 347,
    ["dbt Dependencies"] = 238,
    ["dbt Packages"] = 240,
    ["dbt Project"] = 239,
    ["dbt Selectors"] = 241,
    ["dbt YAML files"] = 242,
    ...
    ["ddev-global"] = 348,
    ["ddev-project"] = 349,
    ["debugsettings.json"] = 350,
    ["dependabot-v2.json"] = 354,
    ["dependabot.json"] = 353,
    ["deployed-cli"] = 1165,
    devconcurrent = 253,
    ["devcontainer-feature.json"] = 288,
    ["devcontainer.json"] = 287,
    devinit = 1115,
    ["devspace.yaml"] = 1188,
    djlint = 1116,
    ["docker bake"] = 360,
    ["docker sequencer"] = 361,
    ["docker-compose.yml"] = 1114,
    ["dockerd.json"] = 358,
    ["dotnet Release Index manifest"] = 373,
    ["dotnet-tools.json"] = 374,
    ["dotnetcli.host.json"] = 375,
    ["dprint.json"] = 376,
    ["drone.json"] = 377,
    ["dss-2.0.0.json"] = 379,
    ["dstack configuration"] = 380,
    ["dtool dataset metadata"] = 1306,
    ["dvc.yaml"] = 382,
    ["ecosystem.json"] = 387,
    ["editorconfig-checker"] = 389,
    eksctl = 390,
    ["electron-builder configuration file"] = 416,
    ["epr-manifest.json"] = 415,
    ["estampo.toml"] = 414,
    ["evcc.yaml"] = 417,
    ["ezd task runner"] = 428,
    ["fabric.mod.json"] = 431,
    ["first-timers-bot"] = 439,
    ["flagd flag configuration"] = 138,
    ["fly.io Configuration"] = 139,
    fulibWorkflows = 1147,
    ["function.json"] = 452,
    ["gRPC API Gateway & OpenAPI Config"] = 22,
    ["gematik health care insurance list"] = 1317,
    ["gematik health care patient list"] = 1314,
    ["gematik health care provider institution list"] = 1316,
    ["gematik health care provider list"] = 1315,
    ["gematik tiger test environment configuration"] = 1318,
    ["gh-dash"] = 466,
    ["gha-doctor"] = 467,
    ["git-cliff"] = 463,
    ["git-town.toml"] = 1363,
    ["github-settings-as-code"] = 846,
    ["gitlab-ci"] = 481,
    ["global.json"] = 498,
    ["glslint config"] = 1,
    ["go-feature-flag Flag Configuration"] = 502,
    ["gojo.yaml"] = 503,
    gollama = 501,
    ["hassette.toml"] = 526,
    ["haxelib.json"] = 522,
    ...
    ["ide.host.json"] = 539,
    ["ifstate.yaml"] = 540,
    ["imageoptimizer.json"] = 541,
    ["importmap.json"] = 544,
    ["index.toml (packwiz)"] = 1420,
    instant_python_config = 548,
    instant_python_custom_project = 549,
    intlayer = 550,
    ["ioBroker Configuration"] = 551,
    ["ioBroker JSON UI"] = 552,
    ["ioBroker Package manifest"] = 553,
    ["ixpect.conf.yaml"] = 554,
    ["ize.toml"] = 1201,
    ["jsconfig.json"] = 580,
    ["jscpd Configuration"] = 1185,
    jsdoc = 1097,
    ["k3d.yaml"] = 581,
    ["k9s aliases.yaml"] = 583,
    ["k9s cluster-config.yaml"] = 585,
    ["k9s config.yaml"] = 584,
    ["k9s hotkeys.yaml"] = 586,
    ["k9s plugins.yaml"] = 587,
    ["k9s skin.yaml"] = 588,
    ["k9s views.yaml"] = 589,
    ["kind cluster"] = 603,
    ["kontinuous-config.yaml"] = 601,
    ["kontinuous-values.yaml"] = 600,
    ["kustomization.yaml"] = 604,
    ["label-commenter-config.yml"] = 605,
    ["latexindent configuration"] = 128,
    ["launchsettings.json"] = 606,
    lazydocker = 1223,
    lazygit = 1222,
    ["lego.json"] = 608,
    ["lerna.json"] = 609,
    ["lgtm.yml"] = 610,
    ["liblab.config.json"] = 611,
    ["libman.json"] = 612,
    ["license-report-config.json"] = 613,
    ["linkinator.config.json"] = 615,
    ["lint-staged (.lintstagedrc)"] = 1074,
    ["local.settings.json"] = 622,
    ["localazy.json"] = 623,
    ["lotus.yaml"] = 621,
    ["lsd colors"] = 132,
    ["lsd config"] = 131,
    ...
    lychee = 1073,
    ["macro.json"] = 1189,
    ["markdown-link-check"] = 1143,
    maturin = 1144,
    mboats = 1151,
    memnex = 1404,
    ["micro-settings.json"] = 1216,
    ["mimetypes.json"] = 640,
    ["mirrord config"] = 1077,
    ["misata.yaml"] = 1076,
    mise = 1078,
    ["mkdocs.yml"] = 660,
    ["mockd.yaml"] = 664,
    ["mod.pw.toml (packwiz)"] = 1421,
    ["modelparams.dev Model"] = 667,
    ["models CLI"] = 668,
    ["monospace.yml"] = 669,
    ["moon.yml"] = 1300,
    ["mprocs Configuration file"] = 1270,
    ["mrdocs.yml"] = 662,
    ["mta.yaml"] = 1079,
    ["mtad.yaml"] = 1080,
    ["mycode.json"] = 677,
    nFPM = 689,
    ["napari plugin manifest"] = 678,
    neoload = 1092,
    ["nest-cli"] = 692,
    ["nexus-rpc-gen"] = 1390,
    ["nf-core module environment.yml"] = 686,
    ["nf-core module meta.yml"] = 687,
    ["nf-core subworkflow meta.yml"] = 688,
    ["ninjs (News in JSON)"] = 691,
    ["nitro.json"] = 1091,
    ["nixd configuration"] = 1242,
    ["nlu.json"] = 693,
    ["nodemon.json"] = 696,
    ["noodl config"] = 1150,
    ["notebook.mod.json"] = 697,
    now = 1087,
    ["npm-badges"] = 700,
    ["nswag.json"] = 704,
    ntangle = 706,
    ["nuclei-template.yaml"] = 701,
    ["nuget-project.json"] = 702,
    ["ocelot.json"] = 708,
    ogen = 714,
    ["omnisharp.json"] = 717,
    openHAB = 1376,
    ...
    oxfmt = 1386,
    oxlint = 1387,
    ["pack.toml (packwiz)"] = 1422,
    ["package.json"] = 753,
    ["package.manifest"] = 755,
    ["package.yaml"] = 754,
    ["partial-black.json"] = 165,
    ["partial-fastapi.json"] = 166,
    ["partial-pixi.json"] = 765,
    ["partial-scheduled.json"] = 167,
    ["pattern.json"] = 763,
    ["petstore-v1.0"] = 1196,
    pgap_yaml_input_reader = 761,
    pgrls = 762,
    pgxgen = 1380,
    pitcms = 1383,
    ["pixi.toml"] = 764,
    ["plagiarize-me.yaml"] = 769,
    ["plagiarize.yaml"] = 768,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1307,
    ["podbard.yaml"] = 771,
    ["portman.json"] = 774,
    ["prefect.toml"] = 783,
    ["prefect.yaml"] = 784,
    ...
    ["prettierrc.json"] = 786,
    ["prisma.yml"] = 787,
    ["project-1.0.0-beta3.json"] = 799,
    ["project-1.0.0-beta4.json"] = 800,
    ["project-1.0.0-beta5.json"] = 801,
    ["project-1.0.0-beta6.json"] = 802,
    ["project-1.0.0-beta8.json"] = 803,
    ["project-1.0.0-rc1.json"] = 804,
    ["project-1.0.0-rc2.json"] = 805,
    ["project.json"] = 798,
    ["project.owasp.yaml"] = 806,
    ["prometheus-alertmanager.json"] = 810,
    ["prometheus.json"] = 807,
    ["prometheus.rules.json"] = 808,
    ["prometheus.rules.test.json"] = 809,
    ["proxies.json"] = 811,
    ["publiccode.yml"] = 812,
    ["pubspec.yaml"] = 813,
    ["pyrseas-0.8.json"] = 816,
    pytest = 825,
    ["quilt.mod.json"] = 1217,
    ["rc3 auth"] = 831,
    ["rc3 collection"] = 832,
    ...
    ["rc3 settings"] = 836,
    ["registry.yaml"] = 61,
    ["release drafter"] = 1093,
    ["release-hub.json"] = 8,
    ["release-please-config.json"] = 841,
    ["release-please-manifest.json"] = 842,
    ["release-plz.toml"] = 843,
    ["renv.lock"] = 858,
    ["reposets Configuration"] = 847,
    ["reposets Credentials"] = 848,
    ["revola.json"] = 6,
    ["rivet.json"] = 1241,
    ["rivet.yaml (legacy)"] = 1240,
    rumdl = 863,
    runny = 862,
    runspec = 1405,
    rustfmt = 864,
    ...
    samt = 867,
    samtrc = 868,
    ["sarif-1.0.0.json"] = 870,
    ["sarif-2.0.0.json"] = 871,
    ["sarif-2.1.0"] = 881,
    ["sarif-2.1.0-rtm.2"] = 872,
    ["sarif-2.1.0-rtm.3"] = 874,
    ["sarif-2.1.0-rtm.4"] = 876,
    ["sarif-2.1.0-rtm.5"] = 878,
    ["sarif-2.1.0-rtm.6"] = 879,
    ["sarif-external-property-file-2.1.0"] = 882,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 873,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 875,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 877,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 880,
    ["scalingo.json configuration"] = 883,
    ["schema.org - Action"] = 885,
    ["schema.org - ContactPoint"] = 886,
    ["schema.org - Place"] = 887,
    ["schema.org - Thing"] = 888,
    ["secrethub.yml"] = 1219,
    ["semantic-release"] = 896,
    ["servicehub.config.json"] = 1068,
    ["servicehub.service.json"] = 1067,
    ["settings.job"] = 899,
    ["sfdx-hardis configuration"] = 901,
    ["shard.yml"] = 1257,
    ["size-limit configuration"] = 906,
    ["skaffold.yaml"] = 1141,
    ["skill-map plugin extension manifest"] = 907,
    ["skill-map project settings"] = 908,
    ["skill-map provider kind"] = 909,
    ["skyuxconfig.json"] = 911,
    ["snowflake-config"] = 913,
    ["snowflake-connections"] = 914,
    ["spicepod.yaml"] = 1278,
    ["sqlc configuration"] = 948,
    ["stripe-app-local.json"] = 959,
    ["stripe-app.json"] = 958,
    swcrc = 1125,
    ["task.json"] = 972,
    taskcat = 1088,
    ["template.json"] = 977,
    ["templatsources.json"] = 978,
    ["text2confl config"] = 1388,
    ["theme.json"] = 981,
    ["tizen_workspace.json"] = 983,
    tldr = 984,
    ["tm_devices configuration file"] = 1345,
    tmuxinator = 1071,
    tox = 986,
    ["transcend.yml"] = 995,
    ["tree-sitter grammar.json"] = 509,
    ["trime.yaml"] = 996,
    ["trunk.yaml"] = 999,
    ["ts-force-config.json"] = 1005,
    tsbuild = 1000,
    ["tsconfig.json"] = 1001,
    ["tsd.json"] = 1002,
    ["tsdoc.json"] = 1003,
    ...
    v8r = 1049,
    vcluster = 1264,
    ["vcpkg configuration file"] = 294,
    ["vcpkg manifest file"] = 293,
    ["vega-lite.json"] = 1030,
    ["vega.json"] = 1029,
    ["venvironment.yaml"] = 1032,
    ["venvplus.yaml"] = 1033,
    version = 1327,
    ["version.json"] = 1035,
    ["vhwdebugger-binding.yaml"] = 1037,
    ["vim-addon-info"] = 1038,
    ["vs-2017.3.host.json"] = 1041,
    ["vs-nesting.json"] = 1042,
    ["vsls.json"] = 1040,
    ["vss-extension.json"] = 1046,
    vtcfg = 1333,
    ["vtesttree.yaml"] = 1047,
    ["vtestunit.yaml"] = 1048,
    ["warp-keysets.json"] = 1225,
    ["warp-themes.json"] = 1226,
    ["warp-workflows.json"] = 1227,
    ["webhint.io"] = 1181,
    ["webjobpublishsettings.json"] = 1053,
    ["webjobs-list.json"] = 1052,
    ["well-known-fursona"] = 1265,
    ["xs-app.json"] = 1083,
    ["xunit.runner.json"] = 1066,
    ["yaml-workflow"] = 1428,
    yamlfmt = 1110,
    yamllint = 1111,
    ["yap.json"] = 1112,
