...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 780,
    [".nodehawkrc"] = 491,
    [".npmpackagejsonlintrc"] = 495,
    [".omletrc"] = 952,
    [".phrase.yml"] = 556,
    [".phraseapp.yml"] = 557,
    [".pmbot.yml"] = 544,
    [".postcssrc"] = 551,
    [".powerpages-web-template-manifest"] = 553,
    [".pre-commit-config.yml"] = 554,
    [".pre-commit-hooks.yml"] = 555,
    [".putout.json"] = 578,
    [".rehyperc"] = 600,
    [".remarkrc"] = 602,
    [".sprite files"] = 667,
    ...
    ["A micro editor config"] = 444,
    ABCInventoryModuleData = 14,
    ABCSupplyPlan = 15,
    AIConfig = 16,
    ["AMX Muse Program Descriptor"] = 996,
    ["API Builder"] = 814,
    ["AVA Configuration"] = 875,
    ["AWS AppConfig Feature Flags-v1"] = 40,
    ["AWS CDK cdk.json"] = 197,
    ["AWS CloudFormation"] = 198,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 199,
    ["AWS SAM CLI Samconfig"] = 200,
    ["Adobe UXP Manifest"] = 935,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    Air = 12,
    ["Airlock Microgateway"] = 17,
    ["Alacritty Configuration"] = 847,
    ["All Contributors configuration file"] = 900,
    ["Ansible Argument Specs"] = 329,
    ["Ansible Collection Galaxy"] = 336,
    ["Ansible Execution Environment"] = 326,
    ["Ansible Inventory"] = 335,
    ["Ansible Meta"] = 327,
    ["Ansible Meta Runtime"] = 328,
    ["Ansible Navigator Configuration"] = 338,
    ["Ansible Playbook"] = 333,
    ["Ansible Requirements"] = 330,
    ["Ansible Rulebook"] = 334,
    ["Ansible Tasks File"] = 332,
    ["Ansible Vars File"] = 331,
    ["Ansible-lint Configuration"] = 337,
    Any = 961,
    ["AnyWork Automation Configuration"] = 5,
    ["App config Spotify Backstage"] = 21,
    ["Application Accelerator"] = 2,
    ["Application list for a WinUtil"] = 978,
    ArchitectFX = 983,
    ["Argo Events"] = 30,
    ["Argo Workflows"] = 31,
    AssemblyScript = 34,
    ...
    ["Azure Pipelines"] = 67,
    ["Azure Static Web Apps CLI configuration file"] = 671,
    ["Azure Static Web Apps configuration file"] = 670,
    ["BOSH Deploy Config"] = 91,
    ["BX CI"] = 109,
    ["Bashly (bashly.yml)"] = 904,
    ["Bashly Settings (bashly-settings.yml)"] = 905,
    ["Better Code Hub"] = 818,
    ["Better Scripts"] = 110,
    Bigconfig = 84,
    ["Biome Formatter Config"] = 54,
    ["Bitmovin Encoding Template"] = 989,
    BizTalkServerApplicationSchema = 786,
    Bleep = 111,
    ...
    ["Butane Config"] = 860,
    C4InterFlow = 1004,
    ["CGS Card Game Specification (cgs.json)"] = 940,
    ["CICS TS region tagging"] = 869,
    ["CICS TS resource import"] = 870,
    ["CICS TS resource model"] = 871,
    ["CICS TS resource overrides"] = 872,
    ["CMake Presets"] = 112,
    ["CNC Codes"] = 127,
    ["CRS WAF test file"] = 968,
    ["CRS WAF test platform overrides file"] = 969,
    ["CSS Comb (.csscomb.json)"] = 224,
    ["CSS Lint (.csslintrc)"] = 225,
    ["CSpell (cspell.json)"] = 223,
    ["CVE Record Format"] = 133,
    CWL = 946,
    ...
    ["Chamaleon environment"] = 993,
    ["Chamaleon properties"] = 994,
    ["Chamaleon template"] = 992,
    Changesets = 209,
    Cheatsheets = 857,
    ["Chrome Extension"] = 190,
    ["Chromia Model"] = 121,
    ["CircleCI config.yml"] = 166,
    ["Citation File Format"] = 211,
    CityJSON = 123,
    ["Clawject config"] = 132,
    ["Cloud Foundry Application Manifest"] = 951,
    ["Cloud Run Spec v1"] = 973,
    ["CloudCannon Configuration"] = 63,
    ["CloudEvents specification"] = 124,
    ["Code Climate"] = 167,
    CodeCV = 61,
    CodeRabbit = 60,
    ["CodeShip Pro services configuration files"] = 179,
    ["CodeShip Pro steps configuration files"] = 180,
    ["Codecov configuration files"] = 178,
    CodifyCLI = 62,
    Codux = 176,
    ["Cog config file"] = 128,
    ["Commandbox Box.json"] = 129,
    ["Commandbox Server.json"] = 130,
    ["Common Catalog Data"] = 188,
    Concord = 967,
    ["Configu .cfgu files"] = 956,
    ["Configu .configu file"] = 957,
    Conjure = 126,
    ["Container Structure Test"] = 800,
    Containerlab = 826,
    ["Crowdsec collection config"] = 218,
    ["Crowdsec parser config"] = 219,
    ["Crowdsec scenario config"] = 220,
    ["CumulusCI Config"] = 131,
    ["Custom Machinery Machine"] = 941,
    ["Custom Machinery Recipe"] = 942,
    ["Cycle Stack File"] = 134,
    CycloneDX = 135,
    ["DWP Exchange - catalogue entry"] = 267,
    ["DWP Exchange - gateway"] = 265,
    ["DWP Exchange - meta"] = 266,
    ["Dart Build Config (dart-build.json)"] = 226,
    ["Dart Test Config (dart-test.json)"] = 227,
    ["DashLord Configuration"] = 228,
    ["Data Contract Specification"] = 229,
    ["Data Product Specification"] = 230,
    ["DataYoga Connections"] = 136,
    ["DataYoga Job"] = 137,
    ["Databricks Asset Bundles"] = 921,
    ["Datadog Service Definition"] = 417,
    ["Datadog Software Catalog"] = 418,
    ["Datahub Ingestion Recipe"] = 876,
    ["Dein Config"] = 143,
    ["Deno Config (deno.json)"] = 236,
    ["Dependency cruiser"] = 144,
    ["DeployStack Configuration"] = 145,
    ["Deployer Recipe"] = 239,
    ["Deta Spacefile"] = 146,
    ["Detekt Config (detekt.yml)"] = 240,
    ["Devbox Config"] = 147,
    ["Devbox Plugin"] = 148,
    Devfile = 264,
    DipDup = 970,
    ["Discord Webhook"] = 241,
    ["DocFx Config (docfx.json)"] = 245,
    Dofigen = 246,
    ["Dolittle Artifacts"] = 247,
    ["Dolittle Bounded Context Configuration"] = 248,
    ["Dolittle Event Horizons Configuration"] = 249,
    ["Dolittle Resources Configuration"] = 250,
    ["Dolittle Server Configuration"] = 251,
    ["Dolittle Tenant Map Configuration"] = 253,
    ["Dolittle Tenants Configuration"] = 252,
    ["Dolittle Topology"] = 254,
    ["DonateCaseBetterCasino menu"] = 997,
    ["Drupal Breakpoints"] = 149,
    ["Drupal Config"] = 161,
    ["Drupal Info"] = 150,
    ["Drupal Layouts"] = 151,
    ["Drupal Libraries"] = 152,
    ["Drupal Links Action"] = 153,
    ["Drupal Links Contextual"] = 154,
    ["Drupal Links Menu"] = 155,
    ["Drupal Links Task"] = 156,
    ["Drupal Migration"] = 157,
    ["Drupal Permissions"] = 158,
    ["Drupal Recipe"] = 159,
    ["Drupal Routing"] = 160,
    ["Drupal Services"] = 162,
    ["Drush site aliases"] = 260,
    ["Dynamic Bash Aliases (.aliases)"] = 912,
    ["EAS config"] = 284,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 901,
    ["EasyVCR .NET"] = 285,
    ["Eidolon Resource"] = 984,
    ["Elgato Stream Deck"] = 270,
    Elm = 972,
    ["Embrace Config"] = 887,
    Endurica = 925,
    ["Enterprise Contract Policy Spec"] = 271,
    ["Erda Pipeline"] = 948,
    ["Erda Runtime"] = 949,
    Esquio = 273,
    ["Estuary Flow Catalog"] = 866,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 277,
    ["EveryVoice TTS Toolkit Data Configuration"] = 278,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 282,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 281,
    ["EveryVoice TTS Toolkit Text Configuration"] = 279,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 280,
    ["Expo SDK"] = 283,
    ["F-Droid Data metadata"] = 289,
    ["FasterCI Configuration"] = 68,
    FiQuS = 293,
    Firebase = 291,
    ["FlexGet Config"] = 294,
    ["Flow.json Configurations"] = 945,
    ["Fossa configuration file"] = 301,
    ["Fossa's fossa-deps file"] = 302,
    ["Foundry VTT - Base package Manifest"] = 296,
    ["Foundry VTT - Module Manifest"] = 297,
    ["Foundry VTT - System Data Template"] = 300,
    ["Foundry VTT - System Manifest"] = 298,
    ["Foundry VTT - World Manifest"] = 299,
    ["Foxx Manifest"] = 69,
    ["Freifunk.de Community API"] = 72,
    ["Frogbot Config"] = 73,
    ["G2P Mapping Configuration"] = 307,
    ["GCP Blueprint Metadata"] = 310,
    Gaspar = 308,
    ["GatewayCore API Gateway"] = 309,
    ["GeoJSON.json latest"] = 864,
    GherKing = 868,
    ["GitHub Action"] = 315,
    ["GitHub Actions typing"] = 980,
    ["GitHub Discussion"] = 316,
    ["GitHub Funding"] = 317,
    ["GitHub Issue Template configuration"] = 318,
    ["GitHub Issue Template forms"] = 319,
    ["GitHub Workflow"] = 320,
    ["GitHub Workflow Template Properties"] = 321,
    ["GitHub automatically generated release notes configuration"] = 322,
    ["GitLab Agent for Kubernetes configuration"] = 937,
    GitVersion = 312,
    ["Gitea Issue Template configuration"] = 313,
    ["Gitea Issue Template forms"] = 314,
    ["Gitpod Automations"] = 324,
    ["Gitpod Configuration"] = 325,
    ["GlazeWM settings"] = 939,
    ["Global Privacy Control"] = 311,
    Goblet = 920,
    ["Golangci-lint Configuration"] = 340,
    ["Golangci-lint Custom Plugins Configuration"] = 341,
    ["Google Chrome Related Website Sets"] = 292,
    ["Google Cloud Workflows"] = 196,
    Goreleaser = 343,
    ["Goreleaser Pro"] = 344,
    Goss = 345,
    ["Gradle Build Cache Node"] = 816,
    ["Gradle Enterprise"] = 815,
    ["Grafana 5.x Dashboard"] = 346,
    ["GraphQL Code Generator"] = 350,
    ["GraphQL Config"] = 349,
    ["GraphQL Mesh"] = 348,
    ["Grunt JSHint task"] = 354,
    ["Grunt Watch task"] = 355,
    ["Grunt base task"] = 356,
    ["Grunt clean task"] = 352,
    ["Grunt copy task"] = 351,
    ["Grunt cssmin task"] = 353,
    HEMTT = 783,
    Hadolint = 796,
    Hammerkit = 825,
    ["Hardware Sentry Configuration"] = 880,
    Hatch = 797,
    Hayson = 358,
    ["Haystack Pipeline"] = 359,
    ["Hazelcast 5 Configuration"] = 360,
    ["Helm Chart.lock"] = 164,
    ["Helm Chart.yaml"] = 163,
    ["Helm Unittest Test Suite"] = 165,
    Hugo = 856,
    ["Hugo Theme"] = 855,
    ["Hyperfoil benchmark configuration"] = 366,
    ["IBM Zapp document"] = 367,
    ["IBM zCodeFormatSettings"] = 368,
    ["IMG Catapult PSP"] = 373,
    ["IVMS101 by CODE Protocol"] = 938,
    Infrahub = 375,
    Istanbul = 883,
    ["JDownloader2 crawler multi-rules"] = 385,
    ["JDownloader2 crawler single-rules"] = 384,
    ["JFrog Applications Config"] = 386,
    ["JFrog File Spec"] = 387,
    ["JFrog Pipelines YML DSL"] = 889,
    ["JMeter DSL cli config"] = 388,
    JReleaser = 390,
    ["JSON Document Transform"] = 398,
    ["JSON Feed"] = 399,
    ["JSON Resume"] = 607,
    ["JSON Schema Draft 2020-12"] = 766,
    ["JSON Schema Draft 4"] = 763,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 922,
    ["JSON Schema Draft 7"] = 764,
    ["JSON Schema Draft 7 (unofficial strict)"] = 923,
    ["JSON Schema Draft 8 (2019-09)"] = 765,
    ["JSON-API"] = 397,
    ["JSON-e templates"] = 823,
    ["JSON-stat 2.0"] = 759,
    JSONPatch = 401,
    ["JSR Package Config (jsr.json)"] = 391,
    Jasmine = 379,
    Jekyll = 380,
    ["Jenkins X Pipelines"] = 381,
    ["Jenkins X Requirements"] = 382,
    Jest = 383,
    ["Jovo Language Models"] = 389,
    ["KIMMDY config file"] = 412,
    ["KODE/CI build.yaml"] = 885,
    ["KSP-AVC"] = 760,
    ["KSP-CKAN"] = 761,
    ["KSP-NetKAN"] = 762,
    KSY = 950,
    KSail = 305,
    ["Karakum configuration file"] = 303,
    Kas = 404,
    ["Kestra flow file"] = 413,
    ["Keycloak REST API"] = 892,
    ["Knative Functions - func.yaml"] = 304,
    ["Kometa (nightly) config file"] = 415,
    ["Kometa config file"] = 414,
    ["Kong DBLess config"] = 886,
    KrakenD = 416,
    ["Kubri Configuration"] = 422,
    LOOBin = 437,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 201,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 202,
    ["Landing Zone Accelerator on AWS - Global Config"] = 203,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 204,
    ["Landing Zone Accelerator on AWS - Network Config"] = 205,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 206,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 207,
    ["Landing Zone Accelerator on AWS - Security Config"] = 208,
    ["Language configuration"] = 960,
    Lefthook = 426,
    ["Liferay client-extension.yaml"] = 433,
    ["LinkML Metamodel"] = 435,
    Liquibase = 831,
    ["Liquibase Flow File"] = 832,
    ["Lively Properties"] = 436,
    ["Lobe AI Agent"] = 65,
    Loki = 66,
    ["MLOS Configs"] = 475,
    ["MS2Rescore Configuration"] = 478,
    ["Madness (madness.yml)"] = 903,
    ["MapEHR Mapping"] = 443,
    Markdownlint = 835,
    ["Mason Registry"] = 838,
    ["MegaLinter configuration"] = 445,
    ["MegaLinter descriptor"] = 446,
    Melange = 929,
    ["Meltano project definition"] = 447,
    ["Mergify Configuration"] = 479,
    ["Metadata for a Bazel module"] = 448,
    ["Metadata for a Cinnamon spice"] = 976,
    ["Metatype Configuration"] = 449,
    ["MetricsHub Configuration"] = 450,
    ["MetricsHub Connector Configuration"] = 451,
    ["Micro Editor Syntax"] = 913,
    ["Microsoft Band Web Tile"] = 452,
    ["Microsoft RulesEngine workflow rules"] = 964,
    ["Microsoft RulesEngine workflow rules list"] = 965,
    ["Minecraft Custom Main Menu Mod"] = 930,
    ["Minecraft Data Pack Advancement"] = 454,
    ["Minecraft Data Pack Biome"] = 455,
    ["Minecraft Data Pack Configured Carver"] = 456,
    ["Minecraft Data Pack Damage Type"] = 457,
    ["Minecraft Data Pack Dimension"] = 459,
    ["Minecraft Data Pack Dimension Type"] = 458,
    ["Minecraft Data Pack Item Modifier"] = 460,
    ["Minecraft Data Pack Loot Table"] = 461,
    ["Minecraft Data Pack Metadata"] = 462,
    ["Minecraft Data Pack Predicate"] = 463,
    ["Minecraft Data Pack Recipe"] = 464,
    ["Minecraft Data Pack Tag"] = 465,
    ["Minecraft Data Pack Template Pool"] = 466,
    ["Minecraft Data Pack Trim Material"] = 471,
    ["Minecraft Data Pack Trim Pattern"] = 472,
    ["Minecraft Resource Pack Lang"] = 467,
    ["Minecraft Resource Pack Particle"] = 468,
    ["Minecraft Resource Pack Texture Mcmeta"] = 470,
    ["Minecraft Resourcepack Sounds"] = 469,
    ["Monade CLI Stack Configuration"] = 482,
    ["MongoDB Atlas Search Index Definition"] = 884,
    ["Monika Configuration"] = 882,
    ["Monoweave Configuration"] = 477,
    ["Motif config"] = 779,
    ["NOX Framework (Service)"] = 494,
    ["Netin Diagnostic System Template"] = 842,
    ["Netlify config"] = 485,
    ["Network-as-Code Data Model"] = 486,
    ["Nightwatch.js"] = 487,
    ["NueJS configuration file"] = 499,
    ["Nuitka.yaml"] = 943,
    ["Nullstone config"] = 501,
    ["ONe's changelog entry"] = 515,
    ["ONe's service descriptor"] = 514,
    ["OSCAL Assessment Plan (AP)"] = 523,
    ["OSCAL Assessment Results (AR)"] = 524,
    ["OSCAL Catalog"] = 525,
    ["OSCAL Component Definition (CDef)"] = 526,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 527,
    ["OSCAL Profile"] = 528,
    ["OSCAL System Security Plan (SSP)"] = 529,
    ["OSS Review Toolkit configuration"] = 530,
    ["OSS Review Toolkit curation"] = 531,
    ["OSS Review Toolkit package configuration"] = 532,
    ["OSS Review Toolkit repository configuration"] = 533,
    ["OSS Review Toolkit resolutions"] = 534,
    ["October CMS columns"] = 505,
    ["October CMS fields"] = 506,
    Okteto = 507,
    Opctl = 782,
    ["Open Data Contract Standard (ODCS)"] = 518,
    ["OpenRewrite Resource"] = 517,
    ["OpenUtau character yaml"] = 511,
    ["OpenUtau ustx"] = 512,
    ["OpenWeather Current Weather API"] = 822,
    ["OpenWeather Road Risk API"] = 821,
    ["Ory Hydra configuration"] = 365,
    ["Ory Keto configuration"] = 419,
    ["Ory Kratos configuration"] = 522,
    ["Ory Oathkeeper configuration"] = 503,
    ["Outblocks App configuration"] = 520,
    ["Outblocks database table"] = 521,
    ["Outblocks project configuration"] = 519,
    PDM = 540,
    Packer = 537,
    Pantsbuild = 899,
    ["Paper paper-plugin.yml"] = 538,
    ["Pipeline component"] = 833,
    ["Plex Prerolls"] = 548,
    ["PocketMine plugin.yml"] = 545,
    ["Postman collection"] = 552,
    ["Preset list for a WinUtil"] = 979,
    ["Problem object RFC9457"] = 927,
    ["Problem package generators"] = 561,
    Pterodactyl = 879,
    ["Pull Request Labeler"] = 577,
    Pulumi = 585,
    ["PyGTA Config"] = 581,
    PyProject = 586,
    Pyright = 587,
    Qgoda = 588,
    Qodana = 852,
    ["Qt Creator workspace file"] = 958,
    ["Quali Torque Blueprint Spec 2"] = 877,
    ["QueryFirst config file"] = 895,
    ["RKE Cluster Configuration JSON"] = 830,
    ["RKE Cluster Configuration YAML"] = 829,
    RadioHound = 580,
    Railway = 589,
    ["Rancher Fleet"] = 582,
    ["Rattler-build"] = 590,
    Ray = 795,
    ["Read the Docs"] = 584,
    ["Red-DiscordBot Cog"] = 597,
    ["Red-DiscordBot Cog Repo"] = 598,
    ["Red-DiscordBot Trivia"] = 599,
    ["Render Blueprints"] = 828,
    RenderCV = 609,
    Renovate = 608,
    ["Replit config"] = 603,
    Restate = 1007,
    RoadRunner = 611,
    ["Rudder techniques"] = 933,
    Ruff = 605,
    ["Rust Project"] = 606,
    ["Rust toolchain"] = 615,
    ["SDMX data message"] = 641,
    ["SDMX metadata message"] = 640,
    ["SDMX structure message"] = 639,
    ["SIL Kit Participant Configuration"] = 651,
    ["SIL Kit Registry Configuration"] = 652,
    ["SPDX 2.3"] = 668,
    SWADL = 682,
    ["Safebox Config"] = 890,
    ["Sapphire CLI Config"] = 618,
    ["SauceCTL Configuration"] = 839,
    ["Schema Catalog"] = 633,
    ["Scoop manifest"] = 638,
    ["Semantic Data Fabric (SDF) file"] = 642,
    ["Semgrep Rule"] = 644,
    ["Serenity Code Generator (Sergen)"] = 645,
    ["Serverless Framework Configuration"] = 846,
    ["Serverless Workflow"] = 848,
    ["Settings for a Cinnamon spice"] = 975,
    ["Settings.paf"] = 647,
    ["Shopware 6 Configuration"] = 849,
    ["Shopware CLI Extension Store Configuration"] = 850,
    ["Shopware CLI Project Store Configuration"] = 851,
    ["Sigma Detection Rule"] = 649,
    ["Sigrid scope configuration file"] = 650,
    ["SkyPilot Task JSON"] = 934,
    ["Slack app manifest"] = 654,
    Solidarity = 657,
    ["Solution filters"] = 658,
    ["Source Maps v3"] = 659,
    Sourcery = 660,
    ["Speakeasy Generation Config File"] = 664,
    ["Speakeasy Lint Configuration File"] = 661,
    ["Speakeasy Test Generation Configuration File"] = 662,
    ["Speakeasy Workflow File"] = 663,
    SpecIF = 665,
    ["Sponge Mixin configuration"] = 666,
    StackBlitz = 672,
    ["StackHawk Scanner Configuration"] = 845,
    Stale = 673,
    ["Starlake Data Pipeline"] = 819,
    Starship = 674,
    ["Statamic Blueprint"] = 675,
    ["Stella configuration file"] = 676,
    ["Stryker Mutator"] = 679,
    ["StyleCop Analyzers Configuration"] = 680,
    ["Stylelint (.stylelintrc)"] = 681,
    ["Sublime Syntax"] = 891,
    ["Subsquid squid manifest"] = 936,
    ["Swagger API 2.0"] = 683,
    ["Synadia Connect Component"] = 684,
    TSON = 716,
    TSTyche = 717,
    ["Tab data for a LinUtil"] = 982,
    ["Tab list for a LinUtil"] = 981,
    Talhelper = 686,
    ["Talisman configuration"] = 687,
    ["Taskfile config"] = 824,
    Taurus = 688,
    Tauticord = 689,
    ...
    Tombi = 697,
    ["Traefik v2"] = 702,
    ["Traefik v2 File Provider"] = 703,
    ["Traefik v3"] = 704,
    ["Traefik v3 File Provider"] = 705,
    ["Travis CI (.travis.yml)"] = 701,
    Trident = 1006,
    ["TrueScript for *.tscript files"] = 708,
    ["Tugboat QA config.yml"] = 1003,
    TunnelHub = 926,
    Turborepo = 700,
    Tycho = 971,
    Tye = 853,
    ["UET BuildConfig.json"] = 896,
    ["UI5 Manifest"] = 726,
    ["UNCORS configuration"] = 730,
    ["UTAM Page Object"] = 729,
    ["Ubuntu Server Autoinstall"] = 724,
    ["Uniswap Token List"] = 807,
    ["Unreal Engine Uplugin"] = 897,
    ["Unreal Engine Uproject"] = 898,
    ["Updatecli Compose"] = 861,
    ["Updatecli Policy Manifest"] = 862,
    ["Updatecli Policy Metadata"] = 863,
    Uplift = 894,
    ["User Journey Map"] = 827,
    V2Ray = 867,
    ["VSCode Code Snippets"] = 184,
    ["VSIX CLI publishing"] = 748,
    Vector = 732,
    ["Vela Pipeline Configuration"] = 735,
    Vercel = 183,
    ["Version Bumper config"] = 738,
    Visivo = 924,
    Wake = 1005,
    ["Waku Config"] = 985,
    ["Web App Manifest"] = 754,
    ["Web types"] = 757,
    WebExtensions = 753,
    ["Webman package recipe"] = 873,
    ["Windows Package Manager Installer Manifest"] = 803,
    ["Windows Package Manager Locale Manifest"] = 804,
    ["Windows Package Manager Singleton Manifest"] = 802,
    Winutil = 805,
    ["WireMock stub mapping"] = 988,
    ["Woodpecker pipeline config"] = 841,
    ["Wrangler CLI"] = 758,
    ["Xstate Machine"] = 859,
    ["Yandex Workflow Language"] = 977,
    ["Yarn Config (.yarnrc.yml)"] = 817,
    ["Yippee-Ki-JSON configuration YML"] = 809,
    ["YouTrack App"] = 974,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 18,
    apko = 928,
    ...
    ["behat.yml"] = 93,
    ["bigquery-table"] = 83,
    ["bioimageio resource description"] = 944,
    ...
    ["ccmod.json"] = 986,
    changelogging = 955,
    ["chisel-slices.json"] = 210,
    ["chrome-extension-locales-messages.json"] = 191,
    ["chutzpah.json"] = 192,
    cibuildwheel = 122,
    ["clang-format (.clang-format)"] = 865,
    ["clang-tidy"] = 171,
    clangd = 170,
    clib = 172,
    ["cloud-init: cloud-config userdata"] = 174,
    ["cloud-sdk-pipeline-configuration"] = 194,
    ["cloudbuild.json"] = 195,
    cloudify = 173,
    codemagic = 175,
    ["coffeelint.json"] = 212,
    ["commands.json"] = 187,
    ["commitlint (.commitlintrc)"] = 806,
    ["compile_commands.json"] = 186,
    ["compilerconfig.json"] = 185,
    ["completely.yml"] = 902,
    ["component-detection-manifest.json"] = 215,
    ["component.json"] = 214,
    ["composer.json"] = 213,
    ["conda-forge"] = 125,
    ["config.yaml"] = 583,
    ["contentmanifest.json"] = 193,
    ["contribute.json"] = 216,
    ["cosmos.config.json"] = 189,
    ["crowdin.yml"] = 217,
    ["ctfd-setup configuration file"] = 995,
    ["custom-elements.json"] = 916,
    ["cypress.json"] = 221,
    ["datalogic-scan2deploy-android"] = 231,
    ["datalogic-scan2deploy-ce"] = 232,
    ["dbt Dependencies"] = 138,
    ["dbt Packages"] = 140,
    ["dbt Project"] = 139,
    ["dbt Selectors"] = 141,
    ["dbt YAML files"] = 142,
    ["ddev-global"] = 233,
    ["ddev-project"] = 234,
    ["debugsettings.json"] = 235,
    ["dependabot-v2.json"] = 238,
    ["dependabot.json"] = 237,
    ["deployed-cli"] = 858,
    ["devcontainer.json"] = 177,
    devinit = 811,
    ["devspace.yaml"] = 881,
    djlint = 812,
    ["docker bake"] = 243,
    ["docker sequencer"] = 244,
    ["docker-compose.yml"] = 810,
    ["dockerd.json"] = 242,
    ["dotnet Release Index manifest"] = 255,
    ["dotnet-tools.json"] = 256,
    ["dotnetcli.host.json"] = 257,
    ["dprint.json"] = 258,
    ["drone.json"] = 259,
    ["dss-2.0.0.json"] = 261,
    ["dstack configuration"] = 262,
    ["dtool dataset metadata"] = 990,
    ["dvc.yaml"] = 263,
    ["ecosystem.json"] = 268,
    eksctl = 269,
    ["electron-builder configuration file"] = 275,
    ["epr-manifest.json"] = 274,
    ["evcc.yaml"] = 276,
    ["ezd task runner"] = 286,
    ["fabric.mod.json"] = 288,
    ["first-timers-bot"] = 295,
    ["flagd flag configuration"] = 70,
    ["fly.io Configuration"] = 71,
    fulibWorkflows = 840,
    ["function.json"] = 306,
    ["gRPC API Gateway & OpenAPI Config"] = 3,
    ["gematik health care insurance list"] = 1001,
    ["gematik health care patient list"] = 998,
    ["gematik health care provider institution list"] = 1000,
    ["gematik health care provider list"] = 999,
    ["gematik tiger test environment configuration"] = 1002,
    ["gitlab-ci"] = 323,
    ["global.json"] = 339,
    ["go-feature-flag Flag Configuration"] = 342,
    ["haxelib.json"] = 357,
    helmfile = 798,
    helmwave = 799,
    ["host-meta.json"] = 362,
    ...
    ["ide.host.json"] = 369,
    ["ifstate.conf"] = 370,
    ["imageoptimizer.json"] = 371,
    ["importmap.json"] = 374,
    ["ioBroker Configuration"] = 376,
    ["ioBroker JSON UI"] = 377,
    ["ioBroker Package manifest"] = 378,
    ["ize.toml"] = 893,
    ["jsconfig.json"] = 402,
    ["jscpd Configuration"] = 878,
    jsdoc = 794,
    ["k3d.yaml"] = 403,
    ["k9s aliases.yaml"] = 405,
    ["k9s cluster-config.yaml"] = 407,
    ["k9s config.yaml"] = 406,
    ["k9s hotkeys.yaml"] = 408,
    ["k9s plugins.yaml"] = 409,
    ["k9s skin.yaml"] = 410,
    ["k9s views.yaml"] = 411,
    ["kontinuous-config.yaml"] = 421,
    ["kontinuous-values.yaml"] = 420,
    ["kustomization.yaml"] = 423,
    ["label-commenter-config.yml"] = 424,
    ["latexindent configuration"] = 64,
    ["launchsettings.json"] = 425,
    lazydocker = 915,
    lazygit = 914,
    ["lego.json"] = 427,
    ["lerna.json"] = 428,
    ["lgtm.yml"] = 429,
    ["liblab.config.json"] = 430,
    ["libman.json"] = 431,
    ["license-report-config.json"] = 432,
    ["linkinator.config.json"] = 434,
    ["lint-staged (.lintstagedrc)"] = 774,
    ["local.settings.json"] = 439,
    ["localazy.json"] = 440,
    ["lotus.yaml"] = 438,
    ["lsdlschema.json"] = 441,
    ["markdown-link-check"] = 836,
    maturin = 837,
    mboats = 844,
    ["micro-settings.json"] = 908,
    ["mimetypes.json"] = 453,
    ["mirrord config"] = 775,
    mise = 776,
    ["mkdocs.yml"] = 473,
    ["monospace.yml"] = 476,
    ["moon.yml"] = 987,
    ["mprocs Configuration file"] = 959,
    ["mrdocs.yml"] = 474,
    ["mta.yaml"] = 777,
    ["mtad.yaml"] = 778,
    ["mycode.json"] = 483,
    ["napari plugin manifest"] = 484,
    neoload = 789,
    ["nest-cli"] = 489,
    ["ninjs (News in JSON)"] = 488,
    ["nitro.json"] = 788,
    ["nixd configuration"] = 932,
    ["nlu.json"] = 490,
    ["nodemon.json"] = 492,
    ["noodl config"] = 843,
    ["notebook.mod.json"] = 493,
    now = 784,
    ["npm-badges"] = 496,
    ["nswag.json"] = 500,
    ntangle = 502,
    ["nuclei-template.yaml"] = 497,
    ["nuget-project.json"] = 498,
    ["ocelot.json"] = 504,
    ["omnisharp.json"] = 508,
    ["openapi.json"] = 509,
    ["openfin.json"] = 516,
    ...
    ["ops.yaml"] = 513,
    ["package.json"] = 535,
    ["package.manifest"] = 536,
    ["partial-black.json"] = 94,
    ["pathfinder.yml"] = 539,
    ["pattern.json"] = 542,
    ["petstore-v1.0"] = 888,
    pgap_yaml_input_reader = 541,
    ["pixi.toml"] = 543,
    ["plagiarize-me.yaml"] = 547,
    ["plagiarize.yaml"] = 546,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 991,
    ["podbard.yaml"] = 549,
    ["portman.json"] = 550,
    ["prefect.toml"] = 558,
    ["prettierrc.json"] = 559,
    ["prisma.yml"] = 560,
    ["project-1.0.0-beta3.json"] = 563,
    ["project-1.0.0-beta4.json"] = 564,
    ["project-1.0.0-beta5.json"] = 565,
    ["project-1.0.0-beta6.json"] = 566,
    ["project-1.0.0-beta8.json"] = 567,
    ["project-1.0.0-rc1.json"] = 568,
    ["project-1.0.0-rc2.json"] = 569,
    ["project.json"] = 562,
    ["project.owasp.yaml"] = 570,
    ["prometheus.json"] = 571,
    ["prometheus.rules.json"] = 572,
    ["prometheus.rules.test.json"] = 573,
    ["proxies.json"] = 574,
    ["publiccode.yml"] = 575,
    ["pubspec.yaml"] = 576,
    ["pyrseas-0.8.json"] = 579,
    ["quilt.mod.json"] = 909,
    ["rc3 auth"] = 591,
    ["rc3 collection"] = 592,
    ["rc3 environment"] = 593,
    ...
    samt = 616,
    samtrc = 617,
    ["sarif-1.0.0.json"] = 619,
    ["sarif-2.0.0.json"] = 620,
    ["sarif-2.1.0"] = 630,
    ["sarif-2.1.0-rtm.2"] = 621,
    ["sarif-2.1.0-rtm.3"] = 623,
    ["sarif-2.1.0-rtm.4"] = 625,
    ["sarif-2.1.0-rtm.5"] = 627,
    ["sarif-2.1.0-rtm.6"] = 628,
    ["sarif-external-property-file-2.1.0"] = 631,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 622,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 624,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 626,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 629,
    ["scalingo.json configuration"] = 632,
    ["schema.org - Action"] = 634,
    ["schema.org - ContactPoint"] = 635,
    ["schema.org - Place"] = 636,
    ["schema.org - Thing"] = 637,
    ["secrethub.yml"] = 911,
    ["semantic-release"] = 643,
    ["servicehub.config.json"] = 769,
    ["servicehub.service.json"] = 768,
    ["settings.job"] = 646,
    ["sfdx-hardis configuration"] = 648,
    ["shard.yml"] = 947,
    ["size-limit configuration"] = 653,
    ["skaffold.yaml"] = 834,
    ["skyuxconfig.json"] = 655,
    snapcraft = 656,
    ["spicepod.yaml"] = 966,
    ["sqlc configuration"] = 669,
    ["stripe-app-local.json"] = 678,
    ["stripe-app.json"] = 677,
    swcrc = 820,
    ["task.json"] = 685,
    taskcat = 785,
    ["template.json"] = 690,
    ["templatsources.json"] = 691,
    ["theme.json"] = 694,
    ["tizen_workspace.json"] = 695,
    tldr = 696,
    tmuxinator = 772,
    ["transcend.yml"] = 706,
    ["tree-sitter grammar.json"] = 347,
    ["trime.yaml"] = 707,
    ["trunk.yaml"] = 709,
    ["ts-force-config.json"] = 714,
    ["tsconfig.json"] = 710,
    ["tsd.json"] = 711,
    ["tsdoc.json"] = 712,
    ["tsdrc.json"] = 713,
    ...
    v8r = 752,
    vcluster = 953,
    ["vcpkg configuration file"] = 182,
    ["vcpkg manifest file"] = 181,
    ["vega-lite.json"] = 734,
    ["vega.json"] = 733,
    ["venvironment-basic.yaml"] = 737,
    ["venvironment.yaml"] = 736,
    ["version.json"] = 739,
    ["vhwdebugger-binding.yaml"] = 741,
    ["vim-addon-info"] = 742,
    ["vs-2017.3.host.json"] = 744,
    ["vs-nesting.json"] = 745,
    ["vsls.json"] = 743,
    ["vss-extension.json"] = 749,
    ["vtesttree.yaml"] = 750,
    ["vtestunit.yaml"] = 751,
    ["warp-keysets.json"] = 917,
    ["warp-themes.json"] = 918,
    ["warp-workflows.json"] = 919,
    ["webhint.io"] = 874,
    ["webjobpublishsettings.json"] = 756,
    ["webjobs-list.json"] = 755,
    ["well-known-fursona"] = 954,
    ["xs-app.json"] = 781,
    ["xunit.runner.json"] = 767,
    yamllint = 808,
    ["zerops.io import file"] = 963,
    ["zerops.yml"] = 962,
    zuul = 791,
    ["Žinoma"] = 801
  },
