...
M.json = {
  ...
  index = {
    ...
    AIConfig = 48,
    ["AMX Muse Program Descriptor"] = 1326,
    ["API Builder"] = 1132,
    ["AVA Configuration"] = 1196,
    ...
    ["AWS Copilot Manifest"] = 1365,
    ["AWS SAM CLI Samconfig"] = 319,
    Acton = 1419,
    ["Adobe UXP Manifest"] = 1259,
    ["Aerleon Network & Service Definitions"] = 30,
    ["Aerleon Policy"] = 31,
    ["Agent Permission Policy"] = 1405,
    ["AgentCore CLI"] = 1406,
    ["AgentCtl MCP"] = 1408,
    ["AgentCtl config"] = 1407,
    ["AgentCtl permissions"] = 1409,
    AgentLoopKit = 1410,
    Aider = 1355,
    Air = 33,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1376,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1375,
    ["Airlock Microgateway"] = 49,
    ["Alacritty Configuration"] = 1168,
    ["AlgoVoi Compliance Receipt v1"] = 19,
    ["All Contributors configuration file"] = 1222,
    ...
    ["Application list for a WinUtil"] = 1305,
    ["ArchSmith diagram IR"] = 1444,
    ArchitectFX = 1310,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1374,
    ["Azure IoT Operations connector metadata"] = 1371,
    ...
    ["Bacon config"] = 13,
    ["Barba-CV"] = 102,
    ["Bashly (bashly.yml)"] = 1226,
    ["Bashly Settings (bashly-settings.yml)"] = 1227,
    Bento = 1392,
    ["Better Code Hub"] = 1137,
    ["Better Scripts"] = 189,
    Bigconfig = 155,
    ["Biome Formatter Config"] = 103,
    ["Bitmovin Encoding Template"] = 1319,
    BizTalkServerApplicationSchema = 1103,
    Bleep = 190,
    ["Block Protocol Metadata"] = 187,
    ["Bluebricks blueprint config"] = 1398,
    ["Boyka Framework"] = 168,
    ...
    ["Butane Config"] = 1181,
    C4InterFlow = 1334,
    ["CDK Environment Manager, concrete environment configuration"] = 1358,
    ["CDK Environment Manager, concrete environments definition"] = 1357,
    ["CDK Environment Manager, environment definition"] = 1356,
    ["CGS Card Game Specification (cgs.json)"] = 1264,
    ["CICS TS region tagging"] = 1190,
    ["CICS TS resource import"] = 1191,
    ["CICS TS resource model"] = 1192,
    ["CICS TS resource overrides"] = 1193,
    ["CMake Presets"] = 191,
    ["CNC Codes"] = 214,
    ["CRS WAF test file"] = 1294,
    ["CRS WAF test platform overrides file"] = 1295,
    ...
    ["Caido Proxy Configuration"] = 1434,
    ...
    ["Chamaleon environment"] = 1323,
    ["Chamaleon properties"] = 1324,
    ["Chamaleon template"] = 1322,
    Changepacks = 1385,
    Changesets = 328,
    Changie = 200,
    Charmcraft = 201,
    ...
    ["Claude Code Launch Preview"] = 1443,
    ["Claude Code Plugin Manifest"] = 222,
    ["Claude Code Plugin Marketplace"] = 223,
    ["Claude Code Settings"] = 224,
    ["Clawject config"] = 220,
    ["Cloud Foundry Application Manifest"] = 1276,
    ["Cloud Run Spec v1"] = 1300,
    ...
    Concord = 1293,
    ["Configu .cfgu files"] = 1281,
    ["Configu .configu file"] = 1282,
    Conjure = 213,
    ["Container Structure Test"] = 1117,
    Containerlab = 1146,
    ["Context Passport"] = 2,
    ["Contextive Glossary"] = 1350,
    ContractGuard = 1147,
    Convex = 212,
    ...
    ["Cursor Agent Environment"] = 1403,
    ["Custom Machinery Machine"] = 1265,
    ["Custom Machinery Recipe"] = 1266,
    ...
    ["DonateCaseBetterCasino menu"] = 1327,
    ["Draugr Saga"] = 359,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1234,
    ["EAS config"] = 434,
    ["ECA - Editor Code Assistant"] = 397,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1223,
    ["ESLint Suppressions"] = 439,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1370,
    ["EasyVCR .NET"] = 436,
    ["Eidolon Resource"] = 1311,
    ...
    ["Envelope Team Definition"] = 1418,
    ["Envilder Map File"] = 402,
    ["Erda Pipeline"] = 1272,
    ["Erda Runtime"] = 1273,
    ["Espanso config.yml"] = 1396,
    ["Espanso match.yml"] = 1395,
    Esquio = 422,
    ["Estuary Flow Catalog"] = 1187,
    ["Ethereum ERC1155"] = 1412,
    ["Ethereum ERC721"] = 1411,
    ...
    ["Evolving Resolutive Process notation"] = 1372,
    ["Expo SDK"] = 433,
    ...
    ["GeoJSON.json latest"] = 1185,
    GherKing = 1189,
    ["GitHub Action"] = 477,
    ["GitHub Actions typing"] = 1307,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 1261,
    ...
    ["Google Digital Assetlinks"] = 1351,
    Goreleaser = 513,
    ["Goreleaser Pro"] = 514,
    Goss = 516,
    ["Gradle Build Cache Node"] = 1135,
    ["Gradle Enterprise"] = 1134,
    ...
    Hadolint = 1113,
    Hammerkit = 1145,
    ["Hardware Sentry Configuration"] = 1201,
    ...
    ["Hecate Input Schema"] = 1362,
    ["Helm Chart.lock"] = 276,
    ["Helm Chart.yaml"] = 275,
    ["Helm Unittest Test Suite"] = 277,
    ["Heloisa Assistant Plugins Marketplace"] = 1441,
    ["Hex file"] = 278,
    ...
    ["JFrog File Spec"] = 572,
    ["JFrog Pipelines YML DSL"] = 1211,
    ["JMeter DSL cli config"] = 573,
    JReleaser = 576,
    ["JSON Document Transform"] = 584,
    ["JSON Feed"] = 585,
    ["JSON Resume"] = 862,
    ["JSON Schema Draft 2020-12"] = 1079,
    ["JSON Schema Draft 4"] = 1076,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1244,
    ["JSON Schema Draft 7"] = 1077,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1245,
    ["JSON Schema Draft 8 (2019-09)"] = 1078,
    ["JSON-API"] = 583,
    ["JSON-e templates"] = 1142,
    ["JSON-stat 2.0"] = 1072,
    JSONPatch = 587,
    ...
    Jsontron = 588,
    ["Jujutsu (jj) VCS config"] = 1364,
    ["KIMMDY config file"] = 599,
    ["KODE/CI build.yaml"] = 1207,
    ["KSP-AVC"] = 1073,
    ["KSP-CKAN"] = 1074,
    ["KSP-NetKAN"] = 1075,
    KSY = 1274,
    ...
    ["Kong DBLess config"] = 1208,
    KrakenD = 603,
    ["Kubri Configuration"] = 611,
    LOOBin = 629,
    ["Lake configuration file"] = 1367,
    ...
    ["Lando (landofile)"] = 129,
    ["LangGraph Platform configuration"] = 1286,
    ["Language configuration"] = 1285,
    Lefthook = 616,
    ...
    ["Madness (madness.yml)"] = 1225,
    ["Mado configuration"] = 636,
    ["Maestro Flow"] = 637,
    ["Mail Servers Configuration"] = 1399,
    ["MapEHR Mapping"] = 638,
    Markdownlint = 1156,
    ["Mason Registry"] = 1159,
    ...
    ["Metadata for a Cinnamon spice"] = 1303,
    ["Metatype Configuration"] = 645,
    ["MetricsHub Configuration"] = 646,
    ["MetricsHub Connector Configuration"] = 647,
    ["Micro Editor Syntax"] = 1235,
    ["Microsoft Band Web Tile"] = 648,
    ["Microsoft RulesEngine workflow rules"] = 1290,
    ["Microsoft RulesEngine workflow rules list"] = 1291,
    ["Minecraft Custom Main Menu Mod"] = 1253,
    ...
    ["MongoDB Atlas Search Index Definition"] = 1206,
    ["Monika Configuration"] = 1204,
    ["Monoweave Configuration"] = 679,
    ["Motif config"] = 1095,
    MultiQC = 1344,
    ["NOX Framework (Service)"] = 707,
    ["Netin Diagnostic System Template"] = 1163,
    ["Netlify config"] = 688,
    ...
    ["Nightwatch.js"] = 699,
    ["Nika workflow"] = 704,
    ["Node.js configuration"] = 1100,
    ["NueJS configuration file"] = 712,
    ["Nuitka Package Config"] = 1267,
    ...
    ["OpenUtau ustx"] = 733,
    ["OpenWeather Current Weather API"] = 1141,
    ["OpenWeather Road Risk API"] = 1140,
    ...
    ["Pipeline component"] = 1154,
    ["Platform.sh application"] = 15,
    ["Platform.sh routes"] = 16,
    ["Platform.sh services"] = 17,
    ["Plex Prerolls"] = 779,
    ["PocketMine plugin.yml"] = 776,
    ["Podman Desktop Extension"] = 1436,
    ["Postman collection"] = 785,
    ["Power Pages Configuration"] = 1361,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1306,
    ...
    Pylock = 1352,
    Pyright = 833,
    ["Python script metadata"] = 1346,
    ["QType AI DSL"] = 836,
    Qgoda = 835,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1428,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1426,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1432,
    ["Qlik Talend Cloud Pipeline - Project"] = 1424,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1427,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1429,
    ["Qlik Talend Cloud Pipeline - Task"] = 1425,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1431,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1430,
    Qodana = 1173,
    ["Qt Creator workspace file"] = 1283,
    ["Quali Torque Blueprint Spec 2"] = 1198,
    ["QueryFirst config file"] = 1217,
    ["QuikRun Configuration"] = 1433,
    ["Qwen Code Settings"] = 1413,
    ["RKE Cluster Configuration JSON"] = 1151,
    ["RKE Cluster Configuration YAML"] = 1150,
    RadioHound = 826,
    ["Raid Profile"] = 1414,
    ["Raid Repo Configuration"] = 1415,
    Railpack = 838,
    Railway = 837,
    ["Rancher Fleet"] = 828,
    ["Rattler-build"] = 839,
    ...
    ["Replit config"] = 854,
    Restate = 1339,
    ["Revel Digital Gadget Definition File"] = 1363,
    RoadRunner = 868,
    ["Robust Station Image"] = 1369,
    Rockcraft = 869,
    ["Roo Coder Custom Modes"] = 870,
    Rubocop = 859,
    ["Rudder techniques"] = 1257,
    Ruff = 860,
    ["Rust Project"] = 861,
    ["Rust toolchain"] = 875,
    ...
    ["Serverless Framework Configuration"] = 1167,
    ["Serverless Workflow"] = 1169,
    ["Settings for a Cinnamon spice"] = 1302,
    ["Settings.paf"] = 909,
    ["Shopware 6 Configuration"] = 1170,
    ["Shopware CLI Extension Store Configuration"] = 1171,
    ["Shopware CLI Project Store Configuration"] = 1172,
    ["Sigma Detection Rule"] = 911,
    ["SigmaCV CV"] = 7,
    ["Sigrid scope configuration file"] = 912,
    ["SkyPilot Task JSON"] = 1258,
    ["Slack app manifest"] = 919,
    ["Slang Server Configuration"] = 1440,
    Snapcraft = 921,
    ...
    StackBlitz = 960,
    ["StackHawk Scanner Configuration"] = 1166,
    Stale = 961,
    Starfish = 962,
    ["Starlake Data Pipeline"] = 1138,
    Starship = 963,
    ...
    TSON = 1020,
    TSTyche = 1021,
    ["TYPO3 Vendor Bundler config"] = 1027,
    ["Tab data for a LinUtil"] = 1309,
    ["Tab list for a LinUtil"] = 1308,
    Tach = 979,
    ["Tach Domain"] = 980,
    Talhelper = 982,
    ["Talisman configuration"] = 983,
    Taplo = 1354,
    ["Taskfile config"] = 1143,
    Taurus = 984,
    Tauticord = 985,
    ["Tekton Pipeline"] = 1382,
    ["Tekton PipelineRun"] = 1383,
    ["Tekton Task"] = 1380,
    ["Tekton TaskRun"] = 1381,
    Telefonistka = 1340,
    ...
    ["Terrateam config"] = 1366,
    ["TestEnvironment.json"] = 1001,
    ["TextMate Grammar"] = 1000,
    Threagile = 995,
    ["Tier.run pricing.json"] = 992,
    Tikibase = 993,
    Tombi = 998,
    ["Traefik v2"] = 1004,
    ["Traefik v2 File Provider"] = 1005,
    ["Traefik v3"] = 1006,
    ["Traefik v3 File Provider"] = 1007,
    ["Travis CI (.travis.yml)"] = 1003,
    Treefmt = 519,
    Trident = 1336,
    Trivy = 1010,
    ["TrueScript for *.tscript files"] = 1011,
    ["Tugboat QA config.yml"] = 1333,
    TunnelHub = 1248,
    Turborepo = 1002,
    Tycho = 1297,
    Tye = 1174,
    ["Tyk Gateway - Open Source v5.7+"] = 1345,
    ["UET BuildConfig.json"] = 1218,
    ["UI5 Manifest"] = 1033,
    ["UNCORS configuration"] = 1038,
    ["UTAM Page Object"] = 1036,
    ["Ubuntu Server Autoinstall"] = 1031,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1337,
    ["Uniswap Token List"] = 1123,
    ["Universal Schedule Format"] = 1039,
    ["Unreal Engine Uplugin"] = 1219,
    ["Unreal Engine Uproject"] = 1220,
    ["UpCloud CLI (upctl) configuration"] = 1338,
    ["Updatecli Compose"] = 1182,
    ["Updatecli Policy Manifest"] = 1183,
    ["Updatecli Policy Metadata"] = 1184,
    Uplift = 1216,
    ["Upsun config"] = 14,
    ["User Journey Map"] = 1148,
    V2Ray = 1188,
    ["VSCode Code Snippets"] = 303,
    ["VSIX CLI publishing"] = 1059,
    Vector = 1041,
    ["Vee JSON menu output"] = 1042,
    ["Vela Pipeline Configuration"] = 1045,
    Vercel = 302,
    ["Version Bumper config"] = 1048,
    Vespertide = 1387,
    ["Vespertide Migration"] = 1388,
    ["Vespertide Model"] = 1389,
    ["Viash Component Config"] = 1342,
    ["Viash Package Config"] = 1343,
    Visivo = 1246,
    Vogi = 1053,
    ["WP-CLI"] = 1069,
    Wake = 1335,
    ["Waku Config"] = 1312,
    ["Web App Manifest"] = 1065,
    ["Web types"] = 1068,
    WebExtensions = 1064,
    ["Webman package recipe"] = 1194,
    ["Windows Package Manager Installer Manifest"] = 1120,
    ["Windows Package Manager Locale Manifest"] = 1121,
    ["Windows Package Manager Singleton Manifest"] = 1119,
    ["WireMock CLI import configuration"] = 1318,
    ["WireMock CLI local service configuration"] = 1317,
    ["WireMock message stub mapping"] = 1316,
    ["WireMock stub mapping"] = 1315,
    ["Woodpecker pipeline config"] = 1162,
    ["Wrangler CLI"] = 1070,
    ["XenForo add-on manifest"] = 1071,
    ["Xstate Machine"] = 1180,
    ["Yandex Workflow Language"] = 1304,
    ["Yarn Config (.yarnrc.yml)"] = 1136,
    ["Yippee-Ki-JSON configuration YML"] = 1127,
    ["YouTrack App"] = 1301,
    ["Zarf Package Configuration"] = 1368,
    ["Zerops import file"] = 1289,
    ["Zola Configuration"] = 1379,
    abtop = 35,
    act3 = 1420,
    actionlint = 45,
    ["aerleon.yml"] = 29,
    ["amplify.yml"] = 22,
    ["amxx-builder manifest"] = 1435,
    ["angular.json"] = 50,
    apko = 1251,
    ...
    ["behat.yml"] = 169,
    ["bigquery-table"] = 154,
    ["bioimageio resource description"] = 1268,
    ...
    ["chutzpah.json"] = 311,
    cibuildwheel = 207,
    ["clang-format (.clang-format)"] = 1186,
    ["clang-tidy"] = 284,
    clangd = 283,
    clib = 285,
    ...
    ["crowdin.yml"] = 338,
    crucible = 342,
    ["ctfd-setup configuration file"] = 1325,
    ["custom-elements.json"] = 1238,
    ["cypress.json"] = 343,
    ["dacier.yml"] = 1423,
    ...
    ["gematik health care insurance list"] = 1331,
    ["gematik health care patient list"] = 1328,
    ["gematik health care provider institution list"] = 1330,
    ["gematik health care provider list"] = 1329,
    ["gematik tiger test environment configuration"] = 1332,
    ["gh-dash"] = 475,
    ["gha-doctor"] = 476,
    ["git-cliff"] = 472,
    ["git-town.toml"] = 1377,
    ...
    lychee = 1087,
    ["macro.json"] = 1203,
    ["markdown-link-check"] = 1157,
    maturin = 1158,
    mboats = 1165,
    memnex = 1421,
    ["micro-settings.json"] = 1230,
    ["mimetypes.json"] = 649,
    ["mirrord config"] = 1091,
    ["misata.yaml"] = 1090,
    mise = 1092,
    ["mkdocs.yml"] = 669,
    ["mockd.yaml"] = 673,
    ["mod.pw.toml (packwiz)"] = 1438,
    ["modelparams.dev Model"] = 676,
    ["models CLI"] = 677,
    ["monospace.yml"] = 678,
    ["moon.yml"] = 1314,
    ["mprocs Configuration file"] = 1284,
    ["mrdocs.yml"] = 671,
    ["mta.yaml"] = 1093,
    ["mtad.yaml"] = 1094,
    ["mycode.json"] = 686,
    ...
    ["plagiarize.yaml"] = 777,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1321,
    ["podbard.yaml"] = 780,
    ["portman.json"] = 783,
    ["prefect.toml"] = 792,
    ["prefect.yaml"] = 793,
    ...
    servercn = 1446,
    ["servicehub.config.json"] = 1082,
    ["servicehub.service.json"] = 1081,
    ["settings.job"] = 908,
    ...
    ["text2confl config"] = 1402,
    ["theme.json"] = 994,
    ["tizen_workspace.json"] = 996,
    tldr = 997,
    ["tm_devices configuration file"] = 1359,
    tmuxinator = 1085,
    tox = 999,
    ["transcend.yml"] = 1008,
    ...
    ["vega-lite.json"] = 1044,
    ["vega.json"] = 1043,
    ["venvironment.yaml"] = 1046,
    ["venvplus.yaml"] = 1047,
    version = 1341,
    ["version.json"] = 1049,
    ["vhwdebugger-binding.yaml"] = 1051,
    ["vim-addon-info"] = 1052,
    ["vs-2017.3.host.json"] = 1055,
    ["vs-nesting.json"] = 1056,
    ["vsls.json"] = 1054,
    ["vss-extension.json"] = 1060,
    vtcfg = 1347,
    ["vtesttree.yaml"] = 1061,
    ["vtestunit.yaml"] = 1062,
    ["warp-keysets.json"] = 1239,
    ["warp-themes.json"] = 1240,
    ["warp-workflows.json"] = 1241,
    ["webhint.io"] = 1195,
    ["webjobpublishsettings.json"] = 1067,
    ["webjobs-list.json"] = 1066,
    ["well-known-fursona"] = 1279,
    ["xs-app.json"] = 1097,
    ["xunit.runner.json"] = 1080,
    ["yaml-workflow"] = 1445,
    yamlfmt = 1124,
    yamllint = 1125,
    ["yap.json"] = 1126,
