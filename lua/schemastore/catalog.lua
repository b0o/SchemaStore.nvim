...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1036,
    [".nodehawkrc"] = 662,
    [".npmpackagejsonlintrc"] = 667,
    [".omletrc"] = 1217,
    [".phrase.yml"] = 745,
    [".phraseapp.yml"] = 746,
    [".pmbot.yml"] = 730,
    [".postcssrc"] = 739,
    [".powerpages-web-template-manifest"] = 741,
    [".pre-commit-config.yml"] = 742,
    [".pre-commit-hooks.yml"] = 743,
    [".putout.json"] = 779,
    [".rehyperc"] = 804,
    [".remarkrc"] = 808,
    [".sprite files"] = 906,
    ...
    AIConfig = 45,
    ["AMX Muse Program Descriptor"] = 1266,
    ["API Builder"] = 1072,
    ["AVA Configuration"] = 1136,
    ...
    ["AWS Copilot Manifest"] = 1305,
    ["AWS SAM CLI Samconfig"] = 293,
    Acton = 1356,
    ["Adobe UXP Manifest"] = 1199,
    ["Aerleon Network & Service Definitions"] = 27,
    ["Aerleon Policy"] = 28,
    ["Agent Permission Policy"] = 1345,
    ["AgentCore CLI"] = 1346,
    AgentLoopKit = 1347,
    Aider = 1295,
    Air = 30,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1316,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1315,
    ["Airlock Microgateway"] = 46,
    ["Alacritty Configuration"] = 1108,
    ["AlgoVoi Compliance Receipt v1"] = 16,
    ["All Contributors configuration file"] = 1162,
    ["Amazon S3 bucket CORS"] = 18,
    Anodizer = 477,
    ["Ansible Argument Specs"] = 460,
    ["Ansible Collection Galaxy"] = 467,
    ["Ansible Execution Environment"] = 457,
    ["Ansible Inventory"] = 466,
    ["Ansible Meta"] = 458,
    ["Ansible Meta Runtime"] = 459,
    ["Ansible Navigator Configuration"] = 469,
    ["Ansible Playbook"] = 464,
    ["Ansible Requirements"] = 461,
    ["Ansible Rulebook"] = 465,
    ["Ansible Tasks File"] = 463,
    ["Ansible Vars File"] = 462,
    ["Ansible-lint Configuration"] = 468,
    Any = 1227,
    ...
    ["Application list for a WinUtil"] = 1245,
    ArchitectFX = 1250,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1314,
    ["Azure IoT Operations connector metadata"] = 1311,
    ...
    ["Azure Pipelines"] = 129,
    ["Azure Static Web Apps CLI configuration file"] = 910,
    ["Azure Static Web Apps configuration file"] = 909,
    BMML = 1333,
    ["BOSH BPM Config"] = 155,
    ["BOSH CPI Config"] = 156,
    ...
    ["Bacon config"] = 10,
    ["Barba-CV"] = 95,
    ["Bashly (bashly.yml)"] = 1166,
    ["Bashly Settings (bashly-settings.yml)"] = 1167,
    Bento = 1332,
    ["Better Code Hub"] = 1077,
    ["Better Scripts"] = 179,
    Bigconfig = 148,
    ["Biome Formatter Config"] = 96,
    ["Bitmovin Encoding Template"] = 1259,
    BizTalkServerApplicationSchema = 1043,
    Bleep = 180,
    ["Block Protocol Metadata"] = 177,
    ["Bluebricks blueprint config"] = 1338,
    ["Boyka Framework"] = 158,
    ...
    ["Butane Config"] = 1121,
    C4InterFlow = 1274,
    ["CDK Environment Manager, concrete environment configuration"] = 1298,
    ["CDK Environment Manager, concrete environments definition"] = 1297,
    ["CDK Environment Manager, environment definition"] = 1296,
    ["CGS Card Game Specification (cgs.json)"] = 1204,
    ["CICS TS region tagging"] = 1130,
    ["CICS TS resource import"] = 1131,
    ["CICS TS resource model"] = 1132,
    ["CICS TS resource overrides"] = 1133,
    ["CMake Presets"] = 181,
    ["CNC Codes"] = 203,
    ["CRS WAF test file"] = 1234,
    ["CRS WAF test platform overrides file"] = 1235,
    ...
    ["Caido Proxy Configuration"] = 1371,
    ...
    ["Chamaleon environment"] = 1263,
    ["Chamaleon properties"] = 1264,
    ["Chamaleon template"] = 1262,
    Changepacks = 1325,
    Changesets = 302,
    Changie = 190,
    Charmcraft = 191,
    ...
    ["Clawject config"] = 209,
    ["Cloud Foundry Application Manifest"] = 1216,
    ["Cloud Run Spec v1"] = 1240,
    ...
    Concord = 1233,
    ["Configu .cfgu files"] = 1221,
    ["Configu .configu file"] = 1222,
    Conjure = 202,
    ["Container Structure Test"] = 1057,
    Containerlab = 1086,
    ["Contextive Glossary"] = 1290,
    ContractGuard = 1087,
    Convex = 201,
    ...
    ["Cursor Agent Environment"] = 1343,
    ["Custom Machinery Machine"] = 1205,
    ["Custom Machinery Recipe"] = 1206,
    ...
    ["DataYoga Job"] = 219,
    ["Datadog Continuous Testing"] = 565,
    ["Datadog Service Definition"] = 566,
    ["Datadog Software Catalog"] = 567,
    ["Datahub Ingestion Recipe"] = 1137,
    ["Debian Upstream Metadata file"] = 226,
    DebtLens = 227,
    ["Deck config"] = 228,
    ["Declarative Automation Bundles"] = 1183,
    ["DeepMatch deeplinks spec"] = 229,
    ["Dein Config"] = 230,
    ["Deno Config (deno.json)"] = 331,
    ["Dependency cruiser"] = 231,
    ["DeployStack Configuration"] = 232,
    ["Deployah Configuration"] = 1313,
    ["Deployer Recipe"] = 334,
    ["Deta Spacefile"] = 233,
    ...
    ["DonateCaseBetterCasino menu"] = 1267,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1174,
    ["EAS config"] = 403,
    ["ECA - Editor Code Assistant"] = 366,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1163,
    ["ESLint Suppressions"] = 408,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1310,
    ["EasyVCR .NET"] = 405,
    ["Eidolon Resource"] = 1251,
    ...
    ["Envelope Team Definition"] = 1355,
    ["Envilder Map File"] = 371,
    ["Erda Pipeline"] = 1212,
    ["Erda Runtime"] = 1213,
    ["Espanso config.yml"] = 1336,
    ["Espanso match.yml"] = 1335,
    Esquio = 391,
    ["Estuary Flow Catalog"] = 1127,
    ["Ethereum ERC1155"] = 1349,
    ["Ethereum ERC721"] = 1348,
    ...
    ["Evolving Resolutive Process notation"] = 1312,
    ["Expo SDK"] = 402,
    ...
    ["GeoJSON.json latest"] = 1125,
    GherKing = 1129,
    ["GitHub Action"] = 443,
    ["GitHub Actions typing"] = 1247,
    ["GitHub Discussion"] = 444,
    ["GitHub Funding"] = 445,
    ["GitHub Issue Template configuration"] = 446,
    ["GitHub Issue Template forms"] = 447,
    ["GitHub Pages Jekyll"] = 448,
    ["GitHub Secret Scanning"] = 449,
    ["GitHub Workflow"] = 450,
    ["GitHub Workflow Template Properties"] = 451,
    ["GitHub automatically generated release notes configuration"] = 452,
    ["GitLab Agent for Kubernetes configuration"] = 1201,
    GitResume = 456,
    GitVersion = 438,
    ["Gitea Issue Template configuration"] = 441,
    ["Gitea Issue Template forms"] = 442,
    Gitleaks = 439,
    ["Gitpod Automations"] = 454,
    ["Gitpod Configuration"] = 455,
    ["Glamour style"] = 436,
    ["GlazeWM settings"] = 1203,
    ["Global Privacy Control"] = 437,
    Goblet = 1182,
    ["Golangci-lint Configuration"] = 471,
    ["Golangci-lint Custom Plugins Configuration"] = 472,
    ["Google Chrome Related Website Sets"] = 413,
    ["Google Cloud Workflows"] = 289,
    ["Google Digital Assetlinks"] = 1291,
    Goreleaser = 475,
    ["Goreleaser Pro"] = 476,
    Goss = 478,
    ["Gradle Build Cache Node"] = 1075,
    ["Gradle Enterprise"] = 1074,
    ["Grafana 5.x Dashboard"] = 479,
    ["GraphQL Code Generator"] = 484,
    ["GraphQL Config"] = 483,
    ["GraphQL Mesh"] = 482,
    ["GroovyLint configuration"] = 485,
    ["Grunt JSHint task"] = 489,
    ["Grunt Watch task"] = 490,
    ["Grunt base task"] = 491,
    ["Grunt clean task"] = 487,
    ["Grunt copy task"] = 486,
    ["Grunt cssmin task"] = 488,
    HEMTT = 1039,
    Hadolint = 1053,
    Hammerkit = 1085,
    ["Hardware Sentry Configuration"] = 1141,
    ["Hashgraph Online Skill Manifest"] = 6,
    ["HashiCorp Vault"] = 492,
    Hatch = 1054,
    Hayson = 494,
    ["Haystack Pipeline"] = 495,
    ["Hazelcast 5 Configuration"] = 496,
    ["Hecate Input Schema"] = 1302,
    ["Helm Chart.lock"] = 251,
    ["Helm Chart.yaml"] = 250,
    ["Helm Unittest Test Suite"] = 252,
    ["Heloisa Assistant Plugins Marketplace"] = 1378,
    ["Hex file"] = 253,
    ["Home Assistant Integration Manifest"] = 498,
    ["Homer dashboard configuration"] = 499,
    ["Hoverfly Simulation"] = 504,
    Hugo = 1117,
    ["Hugo Theme"] = 1116,
    ["Hulak Configuration"] = 507,
    ["Hyperfoil benchmark configuration"] = 506,
    ["IBM Zapp document"] = 508,
    ["IBM zCodeFormatSettings"] = 509,
    ["IMG Catapult PSP"] = 514,
    ["IVMS101 by CODE Protocol"] = 1202,
    ["Infinispan Configuration"] = 516,
    ["Infinispan Server Configuration"] = 517,
    Infrahub = 518,
    Istanbul = 1145,
    ["JDownloader2 crawler multi-rules"] = 532,
    ["JDownloader2 crawler single-rules"] = 531,
    ["JFrog Applications Config"] = 533,
    ["JFrog File Spec"] = 534,
    ["JFrog Pipelines YML DSL"] = 1151,
    ["JMeter DSL cli config"] = 535,
    JReleaser = 538,
    ["JSON Document Transform"] = 546,
    ["JSON Feed"] = 547,
    ["JSON Resume"] = 816,
    ["JSON Schema Draft 2020-12"] = 1019,
    ["JSON Schema Draft 4"] = 1016,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1184,
    ["JSON Schema Draft 7"] = 1017,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1185,
    ["JSON Schema Draft 8 (2019-09)"] = 1018,
    ["JSON-API"] = 545,
    ["JSON-e templates"] = 1082,
    ["JSON-stat 2.0"] = 1012,
    JSONPatch = 549,
    ["JSR Package Config (jsr.json)"] = 539,
    Jarl = 1318,
    Jasmine = 526,
    Jekyll = 527,
    ["Jenkins X Pipelines"] = 528,
    ["Jenkins X Requirements"] = 529,
    Jest = 530,
    Jocker = 536,
    ["Jovo Language Models"] = 537,
    ["Jujutsu (jj) VCS config"] = 1304,
    ["KIMMDY config file"] = 560,
    ["KODE/CI build.yaml"] = 1147,
    ["KSP-AVC"] = 1013,
    ["KSP-CKAN"] = 1014,
    ["KSP-NetKAN"] = 1015,
    KSY = 1214,
    ...
    Kas = 552,
    ["Kestra flow file"] = 561,
    ["Keycloak REST API"] = 1154,
    ["Knative Functions - func.yaml"] = 426,
    Knip = 427,
    ["Knowledge Unit"] = 569,
    ["Kometa (nightly) config file"] = 563,
    ["Kometa config file"] = 562,
    ["Kong DBLess config"] = 1148,
    KrakenD = 564,
    ["Kubri Configuration"] = 572,
    LOOBin = 588,
    ["Lake configuration file"] = 1307,
    ...
    ["Lando (landofile)"] = 122,
    ["LangGraph Platform configuration"] = 1226,
    ["Language configuration"] = 1225,
    Lefthook = 577,
    ["Liferay client-extension.yaml"] = 584,
    ["LinkML Metamodel"] = 586,
    Liquibase = 1092,
    ["Liquibase Flow File"] = 1093,
    ["Lively Properties"] = 587,
    ["Lobe AI Agent"] = 124,
    Loki = 125,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 631,
    ["MS2Rescore Configuration"] = 639,
    ["MSTest testconfig.json"] = 640,
    ["Madge configuration"] = 594,
    ["Madness (madness.yml)"] = 1165,
    ["Mado configuration"] = 595,
    ["Maestro Flow"] = 596,
    ["Mail Servers Configuration"] = 1339,
    ["MapEHR Mapping"] = 597,
    Markdownlint = 1096,
    ["Mason Registry"] = 1099,
    ["MegaLinter Custom Flavor"] = 600,
    ["MegaLinter configuration"] = 599,
    ["MegaLinter descriptor"] = 601,
    Melange = 1192,
    ["Meltano project definition"] = 602,
    ["Mergify Configuration"] = 641,
    ["Mermaid config"] = 1,
    ["Metadata for a Bazel module"] = 603,
    ["Metadata for a Cinnamon spice"] = 1243,
    ["Metatype Configuration"] = 604,
    ["MetricsHub Configuration"] = 605,
    ["MetricsHub Connector Configuration"] = 606,
    ["Micro Editor Syntax"] = 1175,
    ["Microsoft Band Web Tile"] = 607,
    ["Microsoft RulesEngine workflow rules"] = 1230,
    ["Microsoft RulesEngine workflow rules list"] = 1231,
    ["Minecraft Custom Main Menu Mod"] = 1193,
    ["Minecraft Data Pack Advancement"] = 609,
    ["Minecraft Data Pack Biome"] = 610,
    ["Minecraft Data Pack Configured Carver"] = 611,
    ["Minecraft Data Pack Damage Type"] = 612,
    ["Minecraft Data Pack Dimension"] = 614,
    ["Minecraft Data Pack Dimension Type"] = 613,
    ["Minecraft Data Pack Item Modifier"] = 615,
    ["Minecraft Data Pack Loot Table"] = 616,
    ["Minecraft Data Pack Metadata"] = 617,
    ["Minecraft Data Pack Predicate"] = 618,
    ["Minecraft Data Pack Recipe"] = 619,
    ["Minecraft Data Pack Tag"] = 620,
    ["Minecraft Data Pack Template Pool"] = 621,
    ["Minecraft Data Pack Trim Material"] = 626,
    ["Minecraft Data Pack Trim Pattern"] = 627,
    ["Minecraft Resource Pack Lang"] = 622,
    ["Minecraft Resource Pack Particle"] = 623,
    ["Minecraft Resource Pack Texture Mcmeta"] = 625,
    ["Minecraft Resourcepack Sounds"] = 624,
    ["MockServer Expectation"] = 633,
    ["MockServer Expectations"] = 634,
    ModuleAssembler = 629,
    ["Monade CLI Stack Configuration"] = 644,
    ["MongoDB Atlas Search Index Definition"] = 1146,
    ["Monika Configuration"] = 1144,
    ["Monoweave Configuration"] = 638,
    ["Motif config"] = 1035,
    MultiQC = 1284,
    ["NOX Framework (Service)"] = 666,
    ["Netin Diagnostic System Template"] = 1103,
    ["Netlify config"] = 647,
    ["Network-as-Code Data Model"] = 648,
    ["Next Gen UI Agent A2A Server Configuration"] = 649,
    ["Next Gen UI Agent Configuration"] = 651,
    ["Next Gen UI Agent MCP Server Configuration"] = 650,
    ["Nightwatch.js"] = 658,
    ["Nika workflow"] = 663,
    ["Node.js configuration"] = 1040,
    ["NueJS configuration file"] = 671,
    ["Nuitka Package Config"] = 1207,
    ["Nullstone config"] = 673,
    ["OKF Graph"] = 1379,
    ["ONe's changelog entry"] = 692,
    ["ONe's service descriptor"] = 691,
    ["ORT Server repository environment configuration"] = 702,
    ["OSCAL Assessment Plan (AP)"] = 704,
    ["OSCAL Assessment Results (AR)"] = 705,
    ["OSCAL Catalog"] = 706,
    ["OSCAL Component Definition (CDef)"] = 707,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 708,
    ["OSCAL Profile"] = 709,
    ["OSCAL System Security Plan (SSP)"] = 710,
    ["OSS Review Toolkit configuration"] = 711,
    ["OSS Review Toolkit curation"] = 712,
    ["OSS Review Toolkit package configuration"] = 713,
    ["OSS Review Toolkit project package manager definition"] = 714,
    ["OSS Review Toolkit repository configuration"] = 715,
    ["OSS Review Toolkit resolutions"] = 716,
    ["October CMS columns"] = 677,
    ["October CMS fields"] = 678,
    ["Oh My Posh"] = 680,
    Okteto = 681,
    ["Ona Automations"] = 683,
    Opctl = 1038,
    ["Open Data Contract Standard (ODCS)"] = 696,
    ["Open Data Product Standard (ODPS)"] = 697,
    ["Open Know-How"] = 1289,
    OpenDecree = 1353,
    ["OpenDecree Configuration"] = 1354,
    ["OpenRewrite Resource"] = 694,
    OpenSRM = 698,
    OpenStatus = 1300,
    ["OpenTelemetry Declarative Configuration"] = 695,
    ["OpenUtau character yaml"] = 688,
    ["OpenUtau ustx"] = 689,
    ["OpenWeather Current Weather API"] = 1081,
    ["OpenWeather Road Risk API"] = 1080,
    ["Ory Hydra configuration"] = 505,
    ["Ory Keto configuration"] = 568,
    ["Ory Kratos configuration"] = 703,
    ["Ory Oathkeeper configuration"] = 675,
    ["Outblocks App configuration"] = 700,
    ["Outblocks database table"] = 701,
    ["Outblocks project configuration"] = 699,
    PDM = 724,
    POPxf = 736,
    ["POPxf Correlations"] = 737,
    ["PRML manifest"] = 744,
    Packer = 720,
    PactSpec = 721,
    Panache = 722,
    Pantsbuild = 1161,
    ["Paper paper-plugin.yml"] = 723,
    ["Pipeline component"] = 1094,
    ["Platform.sh application"] = 12,
    ["Platform.sh routes"] = 13,
    ["Platform.sh services"] = 14,
    ["Plex Prerolls"] = 734,
    ["PocketMine plugin.yml"] = 731,
    ["Podman Desktop Extension"] = 1373,
    ["Postman collection"] = 740,
    ["Power Pages Configuration"] = 1301,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1246,
    ["ProActions AI-Kit Configuration"] = 752,
    ["ProActions AI-Kit Configuration for Menus"] = 754,
    ["ProActions AI-Kit Configuration for Sections"] = 756,
    ["ProActions AI-Kit Configuration for Services"] = 753,
    ["ProActions AI-Kit Configuration for Steps"] = 757,
    ["ProActions AI-Kit Configuration for Templates"] = 755,
    ["Problem object RFC9457"] = 1190,
    ["Problem package format"] = 758,
    ["Problem package generators"] = 759,
    ["Problem package submissions"] = 760,
    ["Problem package test group metadata"] = 761,
    Pterodactyl = 1140,
    ["Pull Request Labeler"] = 778,
    Pulumi = 786,
    ["PyGTA Config"] = 782,
    PyProject = 787,
    Pylock = 1292,
    Pyright = 788,
    ["Python script metadata"] = 1286,
    ["QType AI DSL"] = 791,
    Qgoda = 790,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1365,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1363,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1369,
    ["Qlik Talend Cloud Pipeline - Project"] = 1361,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1364,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1366,
    ["Qlik Talend Cloud Pipeline - Task"] = 1362,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1368,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1367,
    Qodana = 1113,
    ["Qt Creator workspace file"] = 1223,
    ["Quali Torque Blueprint Spec 2"] = 1138,
    ["QueryFirst config file"] = 1157,
    ["QuikRun Configuration"] = 1370,
    ["Qwen Code Settings"] = 1350,
    ["RKE Cluster Configuration JSON"] = 1091,
    ["RKE Cluster Configuration YAML"] = 1090,
    RadioHound = 781,
    ["Raid Profile"] = 1351,
    ["Raid Repo Configuration"] = 1352,
    Railpack = 793,
    Railway = 792,
    ["Rancher Fleet"] = 783,
    ["Rattler-build"] = 794,
    Ray = 1052,
    ["Read the Docs"] = 785,
    ["Red-DiscordBot Cog"] = 801,
    ["Red-DiscordBot Cog Repo"] = 802,
    ["Red-DiscordBot Trivia"] = 803,
    ["Releasaurus Config"] = 9,
    ReleaseKit = 8,
    ["Render Blueprints"] = 1089,
    RenderCV = 820,
    Renovate = 817,
    ["Renovate global configuration"] = 818,
    ["Renovate inherited configuration"] = 819,
    ["Replit config"] = 809,
    Restate = 1279,
    ["Revel Digital Gadget Definition File"] = 1303,
    RoadRunner = 822,
    ["Robust Station Image"] = 1309,
    Rockcraft = 823,
    ["Roo Coder Custom Modes"] = 824,
    Rubocop = 813,
    ["Rudder techniques"] = 1197,
    Ruff = 814,
    ["Rust Project"] = 815,
    ["Rust toolchain"] = 829,
    ["SDMX data message"] = 856,
    ["SDMX metadata message"] = 855,
    ["SDMX structure message"] = 854,
    ["SIL Kit Participant Configuration"] = 867,
    ["SIL Kit Registry Configuration"] = 868,
    ["SPDX 2.3"] = 907,
    SWADL = 923,
    ["Safebox Config"] = 1152,
    ["Sapphire CLI Config"] = 832,
    ["SauceCTL Configuration"] = 1100,
    Scarb = 852,
    ["Schema Catalog"] = 847,
    ["Scoop manifest"] = 853,
    ["Secure SDLC Evidence Bundle"] = 857,
    ["Semantic Data Fabric (SDF) file"] = 858,
    ["Semgrep Rule"] = 860,
    ["Serenity Code Generator (Sergen)"] = 861,
    ["Serverless Framework Configuration"] = 1107,
    ["Serverless Workflow"] = 1109,
    ["Settings for a Cinnamon spice"] = 1242,
    ["Settings.paf"] = 863,
    ["Shopware 6 Configuration"] = 1110,
    ["Shopware CLI Extension Store Configuration"] = 1111,
    ["Shopware CLI Project Store Configuration"] = 1112,
    ["Sigma Detection Rule"] = 865,
    ["SigmaCV CV"] = 4,
    ["Sigrid scope configuration file"] = 866,
    ["SkyPilot Task JSON"] = 1198,
    ["Slack app manifest"] = 870,
    ["Slang Server Configuration"] = 1377,
    Snapcraft = 872,
    ["Solarxy project config"] = 875,
    Solidarity = 876,
    ["Solution filters"] = 877,
    ["Source Maps v3"] = 878,
    Sourcery = 879,
    ["Spack bootstrap.yaml"] = 880,
    ["Spack cdash.yaml"] = 881,
    ["Spack ci.yaml"] = 882,
    ["Spack compilers.yaml"] = 883,
    ["Spack concretizer.yaml"] = 884,
    ["Spack config.yaml"] = 885,
    ["Spack definitions.yaml"] = 886,
    ["Spack develop.yaml"] = 887,
    ["Spack env_vars.yaml"] = 888,
    ["Spack environment"] = 894,
    ["Spack include.yaml"] = 889,
    ["Spack mirrors.yaml"] = 890,
    ["Spack modules.yaml"] = 891,
    ["Spack packages.yaml"] = 892,
    ["Spack repos.yaml"] = 893,
    ["Spack toolchains.yaml"] = 895,
    ["Spack upstreams.yaml"] = 896,
    ["Spack view.yaml"] = 897,
    ["Speakeasy Generation Config File"] = 901,
    ["Speakeasy Lint Configuration File"] = 898,
    ["Speakeasy Test Generation Configuration File"] = 899,
    ["Speakeasy Workflow File"] = 900,
    SpecIF = 902,
    ["Specmatic Configuration"] = 903,
    ["Specpin spec file"] = 2,
    ["Sponge Mixin configuration"] = 904,
    ["Spotlight Ruleset"] = 905,
    StackBlitz = 911,
    ["StackHawk Scanner Configuration"] = 1106,
    Stale = 912,
    Starfish = 913,
    ["Starlake Data Pipeline"] = 1078,
    Starship = 914,
    ["Statamic Blueprint"] = 915,
    ["Stella configuration file"] = 916,
    ["Streamlit configuration file"] = 917,
    ["Stryker Mutator"] = 920,
    ["StyleCop Analyzers Configuration"] = 921,
    ["Stylelint (.stylelintrc)"] = 922,
    ["Stylua Config"] = 1293,
    ["Sublime Syntax"] = 1153,
    ["Subsquid squid manifest"] = 1200,
    ["Swagger API 2.0"] = 924,
    ["Synadia Connect Component"] = 925,
    TSON = 962,
    TSTyche = 963,
    ["TYPO3 Vendor Bundler config"] = 969,
    ["Tab data for a LinUtil"] = 1249,
    ["Tab list for a LinUtil"] = 1248,
    Tach = 926,
    ["Tach Domain"] = 927,
    Talhelper = 929,
    ["Talisman configuration"] = 930,
    Taplo = 1294,
    ["Taskfile config"] = 1083,
    Taurus = 931,
    Tauticord = 932,
    ["Tekton Pipeline"] = 1322,
    ["Tekton PipelineRun"] = 1323,
    ["Tekton Task"] = 1320,
    ["Tekton TaskRun"] = 1321,
    Telefonistka = 1280,
    ["Terrateam config"] = 1306,
    ["TestEnvironment.json"] = 944,
    ["TextMate Grammar"] = 943,
    Threagile = 938,
    ["Tier.run pricing.json"] = 935,
    Tikibase = 936,
    Tombi = 941,
    ["Traefik v2"] = 947,
    ["Traefik v2 File Provider"] = 948,
    ["Traefik v3"] = 949,
    ["Traefik v3 File Provider"] = 950,
    ["Travis CI (.travis.yml)"] = 946,
    Treefmt = 481,
    Trident = 1276,
    Trivy = 953,
    ["TrueScript for *.tscript files"] = 954,
    ["Tugboat QA config.yml"] = 1273,
    TunnelHub = 1188,
    Turborepo = 945,
    Tycho = 1237,
    Tye = 1114,
    ["Tyk Gateway - Open Source v5.7+"] = 1285,
    ["UET BuildConfig.json"] = 1158,
    ["UI5 Manifest"] = 975,
    ["UNCORS configuration"] = 980,
    ["UTAM Page Object"] = 978,
    ["Ubuntu Server Autoinstall"] = 973,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1277,
    ["Uniswap Token List"] = 1063,
    ["Universal Schedule Format"] = 981,
    ["Unreal Engine Uplugin"] = 1159,
    ["Unreal Engine Uproject"] = 1160,
    ["UpCloud CLI (upctl) configuration"] = 1278,
    ["Updatecli Compose"] = 1122,
    ["Updatecli Policy Manifest"] = 1123,
    ["Updatecli Policy Metadata"] = 1124,
    Uplift = 1156,
    ["Upsun config"] = 11,
    ["User Journey Map"] = 1088,
    V2Ray = 1128,
    ["VSCode Code Snippets"] = 277,
    ["VSIX CLI publishing"] = 999,
    Vector = 983,
    ["Vela Pipeline Configuration"] = 986,
    Vercel = 276,
    ["Version Bumper config"] = 989,
    Vespertide = 1327,
    ["Vespertide Migration"] = 1328,
    ["Vespertide Model"] = 1329,
    ["Viash Component Config"] = 1282,
    ["Viash Package Config"] = 1283,
    Visivo = 1186,
    ["WP-CLI"] = 1009,
    Wake = 1275,
    ["Waku Config"] = 1252,
    ["Web App Manifest"] = 1005,
    ["Web types"] = 1008,
    WebExtensions = 1004,
    ["Webman package recipe"] = 1134,
    ["Windows Package Manager Installer Manifest"] = 1060,
    ["Windows Package Manager Locale Manifest"] = 1061,
    ["Windows Package Manager Singleton Manifest"] = 1059,
    ["WireMock CLI import configuration"] = 1258,
    ["WireMock CLI local service configuration"] = 1257,
    ["WireMock message stub mapping"] = 1256,
    ["WireMock stub mapping"] = 1255,
    ["Woodpecker pipeline config"] = 1102,
    ["Wrangler CLI"] = 1010,
    ["XenForo add-on manifest"] = 1011,
    ["Xstate Machine"] = 1120,
    ["Yandex Workflow Language"] = 1244,
    ["Yarn Config (.yarnrc.yml)"] = 1076,
    ["Yippee-Ki-JSON configuration YML"] = 1067,
    ["YouTrack App"] = 1241,
    ["Zarf Package Configuration"] = 1308,
    ["Zerops import file"] = 1229,
    ["Zola Configuration"] = 1319,
    abtop = 32,
    act3 = 1357,
    actionlint = 42,
    ["aerleon.yml"] = 26,
    ["amplify.yml"] = 19,
    ["amxx-builder manifest"] = 1372,
    ["angular.json"] = 47,
    apko = 1191,
    ...
    ["behat.yml"] = 159,
    ["bigquery-table"] = 147,
    ["bioimageio resource description"] = 1208,
    ...
    ["cargo-nextest repository configuration"] = 652,
    ["cargo-nextest user configuration"] = 653,
    ["ccmod.json"] = 1253,
    changelogging = 1220,
    ...
    ["chutzpah.json"] = 285,
    cibuildwheel = 196,
    ["clang-format (.clang-format)"] = 1126,
    ["clang-tidy"] = 259,
    clangd = 258,
    clib = 260,
    ...
    ["crowdin.yml"] = 312,
    ["ctfd-setup configuration file"] = 1265,
    ["custom-elements.json"] = 1178,
    ["cypress.json"] = 316,
    ["dacier.yml"] = 1360,
    ...
    ["gematik health care insurance list"] = 1271,
    ["gematik health care patient list"] = 1268,
    ["gematik health care provider institution list"] = 1270,
    ["gematik health care provider list"] = 1269,
    ["gematik tiger test environment configuration"] = 1272,
    ["git-cliff"] = 440,
    ["git-town.toml"] = 1317,
    ["gitlab-ci"] = 453,
    ["global.json"] = 470,
    ["go-feature-flag Flag Configuration"] = 474,
    gollama = 473,
    ["hassette.toml"] = 497,
    ["haxelib.json"] = 493,
    helmfile = 1055,
    ...
    ["ide.host.json"] = 510,
    ["ifstate.yaml"] = 511,
    ["imageoptimizer.json"] = 512,
    ["importmap.json"] = 515,
    ["index.toml (packwiz)"] = 1374,
    instant_python_config = 519,
    instant_python_custom_project = 520,
    intlayer = 521,
    ["ioBroker Configuration"] = 522,
    ["ioBroker JSON UI"] = 523,
    ["ioBroker Package manifest"] = 524,
    ["ixpect.conf.yaml"] = 525,
    ["ize.toml"] = 1155,
    ["jsconfig.json"] = 550,
    ["jscpd Configuration"] = 1139,
    jsdoc = 1051,
    ["k3d.yaml"] = 551,
    ["k9s aliases.yaml"] = 553,
    ["k9s cluster-config.yaml"] = 555,
    ["k9s config.yaml"] = 554,
    ["k9s hotkeys.yaml"] = 556,
    ["k9s plugins.yaml"] = 557,
    ["k9s skin.yaml"] = 558,
    ["k9s views.yaml"] = 559,
    ["kind cluster"] = 573,
    ["kontinuous-config.yaml"] = 571,
    ["kontinuous-values.yaml"] = 570,
    ["kustomization.yaml"] = 574,
    ["label-commenter-config.yml"] = 575,
    ["latexindent configuration"] = 123,
    ["launchsettings.json"] = 576,
    lazydocker = 1177,
    lazygit = 1176,
    ["lego.json"] = 578,
    ["lerna.json"] = 579,
    ["lgtm.yml"] = 580,
    ["liblab.config.json"] = 581,
    ["libman.json"] = 582,
    ["license-report-config.json"] = 583,
    ["linkinator.config.json"] = 585,
    ["lint-staged (.lintstagedrc)"] = 1028,
    ["local.settings.json"] = 590,
    ["localazy.json"] = 591,
    ["lotus.yaml"] = 589,
    ["lsd colors"] = 127,
    ["lsd config"] = 126,
    ...
    lychee = 1027,
    ["macro.json"] = 1143,
    ["markdown-link-check"] = 1097,
    maturin = 1098,
    mboats = 1105,
    memnex = 1358,
    ["micro-settings.json"] = 1170,
    ["mimetypes.json"] = 608,
    ["mirrord config"] = 1031,
    ["misata.yaml"] = 1030,
    mise = 1032,
    ["mkdocs.yml"] = 628,
    ["mockd.yaml"] = 632,
    ["mod.pw.toml (packwiz)"] = 1375,
    ["modelparams.dev Model"] = 635,
    ["models CLI"] = 636,
    ["monospace.yml"] = 637,
    ["moon.yml"] = 1254,
    ["mprocs Configuration file"] = 1224,
    ["mrdocs.yml"] = 630,
    ["mta.yaml"] = 1033,
    ["mtad.yaml"] = 1034,
    ["mycode.json"] = 645,
    nFPM = 657,
    ["napari plugin manifest"] = 646,
    neoload = 1046,
    ["nest-cli"] = 660,
    ["nexus-rpc-gen"] = 1344,
    ["nf-core module environment.yml"] = 654,
    ["nf-core module meta.yml"] = 655,
    ["nf-core subworkflow meta.yml"] = 656,
    ["ninjs (News in JSON)"] = 659,
    ["nitro.json"] = 1045,
    ["nixd configuration"] = 1196,
    ["nlu.json"] = 661,
    ["nodemon.json"] = 664,
    ["noodl config"] = 1104,
    ["notebook.mod.json"] = 665,
    now = 1041,
    ["npm-badges"] = 668,
    ["nswag.json"] = 672,
    ntangle = 674,
    ["nuclei-template.yaml"] = 669,
    ["nuget-project.json"] = 670,
    ["ocelot.json"] = 676,
    ogen = 679,
    ["omnisharp.json"] = 682,
    openHAB = 1330,
    ...
    oxfmt = 1340,
    oxlint = 1341,
    ["pack.toml (packwiz)"] = 1376,
    ["package.json"] = 717,
    ["package.manifest"] = 719,
    ["package.yaml"] = 718,
    ["partial-black.json"] = 160,
    ["partial-fastapi.json"] = 161,
    ["partial-pixi.json"] = 729,
    ["partial-scheduled.json"] = 162,
    ["pattern.json"] = 727,
    ["petstore-v1.0"] = 1150,
    pgap_yaml_input_reader = 725,
    pgrls = 726,
    pgxgen = 1334,
    pitcms = 1337,
    ["pixi.toml"] = 728,
    ["plagiarize-me.yaml"] = 733,
    ["plagiarize.yaml"] = 732,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1261,
    ["podbard.yaml"] = 735,
    ["portman.json"] = 738,
    ["prefect.toml"] = 747,
    ["prefect.yaml"] = 748,
    ...
    ["prettierrc.json"] = 750,
    ["prisma.yml"] = 751,
    ["project-1.0.0-beta3.json"] = 763,
    ["project-1.0.0-beta4.json"] = 764,
    ["project-1.0.0-beta5.json"] = 765,
    ["project-1.0.0-beta6.json"] = 766,
    ["project-1.0.0-beta8.json"] = 767,
    ["project-1.0.0-rc1.json"] = 768,
    ["project-1.0.0-rc2.json"] = 769,
    ["project.json"] = 762,
    ["project.owasp.yaml"] = 770,
    ["prometheus-alertmanager.json"] = 774,
    ["prometheus.json"] = 771,
    ["prometheus.rules.json"] = 772,
    ["prometheus.rules.test.json"] = 773,
    ["proxies.json"] = 775,
    ["publiccode.yml"] = 776,
    ["pubspec.yaml"] = 777,
    ["pyrseas-0.8.json"] = 780,
    pytest = 789,
    ["quilt.mod.json"] = 1171,
    ["rc3 auth"] = 795,
    ["rc3 collection"] = 796,
    ...
    ["rc3 settings"] = 800,
    ["registry.yaml"] = 60,
    ["release drafter"] = 1047,
    ["release-hub.json"] = 7,
    ["release-please-config.json"] = 805,
    ["release-please-manifest.json"] = 806,
    ["release-plz.toml"] = 807,
    ["renv.lock"] = 821,
    ["reposets Configuration"] = 810,
    ["reposets Credentials"] = 811,
    ["revola.json"] = 5,
    ["rivet.json"] = 1195,
    ["rivet.yaml (legacy)"] = 1194,
    rumdl = 826,
    runny = 825,
    runspec = 1359,
    rustfmt = 827,
    ...
    samt = 830,
    samtrc = 831,
    ["sarif-1.0.0.json"] = 833,
    ["sarif-2.0.0.json"] = 834,
    ["sarif-2.1.0"] = 844,
    ["sarif-2.1.0-rtm.2"] = 835,
    ["sarif-2.1.0-rtm.3"] = 837,
    ["sarif-2.1.0-rtm.4"] = 839,
    ["sarif-2.1.0-rtm.5"] = 841,
    ["sarif-2.1.0-rtm.6"] = 842,
    ["sarif-external-property-file-2.1.0"] = 845,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 836,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 838,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 840,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 843,
    ["scalingo.json configuration"] = 846,
    ["schema.org - Action"] = 848,
    ["schema.org - ContactPoint"] = 849,
    ["schema.org - Place"] = 850,
    ["schema.org - Thing"] = 851,
    ["secrethub.yml"] = 1173,
    ["semantic-release"] = 859,
    ["servicehub.config.json"] = 1022,
    ["servicehub.service.json"] = 1021,
    ["settings.job"] = 862,
    ["sfdx-hardis configuration"] = 864,
    ["shard.yml"] = 1211,
    ["size-limit configuration"] = 869,
    ["skaffold.yaml"] = 1095,
    ["skyuxconfig.json"] = 871,
    ["snowflake-config"] = 873,
    ["snowflake-connections"] = 874,
    ["spicepod.yaml"] = 1232,
    ["sqlc configuration"] = 908,
    ["stripe-app-local.json"] = 919,
    ["stripe-app.json"] = 918,
    swcrc = 1079,
    ["task.json"] = 928,
    taskcat = 1042,
    ["template.json"] = 933,
    ["templatsources.json"] = 934,
    ["text2confl config"] = 1342,
    ["theme.json"] = 937,
    ["tizen_workspace.json"] = 939,
    tldr = 940,
    ["tm_devices configuration file"] = 1299,
    tmuxinator = 1025,
    tox = 942,
    ["transcend.yml"] = 951,
    ["tree-sitter grammar.json"] = 480,
    ["trime.yaml"] = 952,
    ["trunk.yaml"] = 955,
    ["ts-force-config.json"] = 960,
    ["tsconfig.json"] = 956,
    ["tsd.json"] = 957,
    ["tsdoc.json"] = 958,
    ["tsdrc.json"] = 959,
    ...
    ["vega-lite.json"] = 985,
    ["vega.json"] = 984,
    ["venvironment.yaml"] = 987,
    ["venvplus.yaml"] = 988,
    version = 1281,
    ["version.json"] = 990,
    ["vhwdebugger-binding.yaml"] = 992,
    ["vim-addon-info"] = 993,
    ["vs-2017.3.host.json"] = 995,
    ["vs-nesting.json"] = 996,
    ["vsls.json"] = 994,
    ["vss-extension.json"] = 1000,
    vtcfg = 1287,
    ["vtesttree.yaml"] = 1001,
    ["vtestunit.yaml"] = 1002,
    ["warp-keysets.json"] = 1179,
    ["warp-themes.json"] = 1180,
    ["warp-workflows.json"] = 1181,
    ["webhint.io"] = 1135,
    ["webjobpublishsettings.json"] = 1007,
    ["webjobs-list.json"] = 1006,
    ["well-known-fursona"] = 1219,
    ["xs-app.json"] = 1037,
    ["xunit.runner.json"] = 1020,
    yamlfmt = 1064,
    yamllint = 1065,
    ["yap.json"] = 1066,
    ["zerops.yml"] = 1228,
