...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 177,
    [".cryproj (generic)"] = 609,
    [".cryproj engine-5.2"] = 604,
    [".cryproj engine-5.3"] = 605,
    [".cryproj engine-5.4"] = 606,
    [".cryproj engine-5.5"] = 607,
    [".cryproj engine-dev"] = 608,
    [".csscomb.json"] = 179,
    [".csslintrc"] = 180,
    [".es6importsorterrc.json"] = 740,
    [".eslintrc"] = 229,
    [".esmrc.json"] = 221,
    [".ffizer.yaml"] = 233,
    [".htmlhintrc"] = 285,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 682,
    ["All Contributors configuration file"] = 739,
    ...
    ["Better Scripts"] = 96,
    Bigconfig = 76,
    BizTalkServerApplicationSchema = 624,
    Bleep = 97,
    ...
    ["Butane Config"] = 694,
    ["CICS TS region tagging"] = 703,
    ["CICS TS resource import"] = 704,
    ["CICS TS resource model"] = 705,
    ["CICS TS resource overrides"] = 706,
    ["CMake Presets"] = 98,
    ["CNC Codes"] = 108,
    ...
    ["Databricks Asset Bundles"] = 760,
    ["Datadog Service Definition"] = 324,
    ["Datahub Ingestion Recipe"] = 710,
    ["Dein Config"] = 113,
    Deno = 190,
    ["Deployer Recipe"] = 193,
    ["Deta Spacefile"] = 114,
    ...
    ["Goreleaser Pro"] = 267,
    Goss = 268,
    ["Gradle Build Cache Node"] = 652,
    ["Gradle Enterprise"] = 651,
    ...
    Hadolint = 633,
    Hammerkit = 661,
    ["Hardware Sentry Configuration"] = 714,
    Hatch = 634,
    Hayson = 280,
    ...
    ["JFrog File Spec"] = 305,
    ["JFrog Pipelines YML DSL"] = 723,
    ["JMeter DSL cli config"] = 306,
    JReleaser = 308,
    ["JSON Document Transform"] = 315,
    ["JSON Feed"] = 316,
    ["JSON Resume"] = 470,
    ["JSON Schema Draft 2020-12"] = 600,
    ["JSON Schema Draft 4"] = 597,
    ["JSON Schema Draft 7"] = 598,
    ["JSON Schema Draft 7 (unofficial strict)"] = 761,
    ["JSON Schema Draft 8 (2019-09)"] = 599,
    ["JSON-API"] = 314,
    ["JSON-e templates"] = 659,
    ["JSON-stat 2.0"] = 594,
    JSONPatch = 318,
    Jasmine = 298,
    Jekyll = 299,
    ...
    Kas = 321,
    ["Keycloak REST API"] = 731,
    ["Knative Functions - func.yaml"] = 245,
    ["KoDE/CI build.yaml"] = 719,
    ["Kong DBLess config"] = 720,
    KrakenD = 323,
    LOOBin = 340,
    Lefthook = 331,
    ["LinkML Metamodel"] = 338,
    Liquibase = 666,
    ["Liquibase Flow File"] = 667,
    ...
    ["MongoDB Atlas Search Index Definition"] = 718,
    ["Monika Configuration"] = 716,
    ["Motif config"] = 617,
    ["NOX Framework (Service)"] = 387,
    ["Netin Diagnostic System Template"] = 676,
    ["Netlify config"] = 378,
    ...
    ["OpenUtau ustx"] = 400,
    ["OpenWeather Current Weather API"] = 658,
    ["OpenWeather Road Risk API"] = 657,
    ...
    Qgoda = 459,
    Qodana = 687,
    ["Quali Torque Blueprint Spec 2"] = 711,
    ["QueryFirst config file"] = 734,
    ["RKE Cluster Configuration JSON"] = 665,
    ["RKE Cluster Configuration YAML"] = 664,
    ["Rancher Fleet"] = 453,
    Ray = 632,
    ["Read the Docs"] = 455,
    ...
    ["SauceCTL Configuration"] = 673,
    ["Schema Catalog"] = 492,
    ["Scoop manifest"] = 497,
    ["Semantic Data Fabric (SDF) file"] = 498,
    ["Semgrep Rule"] = 500,
    ["Serenity Code Generator (Sergen)"] = 501,
    ["Serverless Framework Configuration"] = 681,
    ["Serverless Workflow"] = 683,
    ["Settings.paf"] = 503,
    Setuptools = 504,
    ["Shopware 6 Configuration"] = 684,
    ["Shopware CLI Extension Store Configuration"] = 685,
    ["Shopware CLI Project Store Configuration"] = 686,
    ...
    StackBlitz = 523,
    ["StackHawk Scanner Configuration"] = 680,
    Stale = 524,
    ["Starlake Data Pipeline"] = 655,
    Starship = 525,
    ["Statamic Blueprint"] = 526,
    ["StrmPrivacy Data Connector"] = 728,
    ["StrmPrivacy Data Contract"] = 729,
    ["StrmPrivacy SimpleSchema"] = 726,
    ["StrmPrivacy Stream"] = 727,
    ["StrmPrivacy batch job configuration file"] = 725,
    ["Stryker Mutator"] = 529,
    ...
    Turborepo = 547,
    Tye = 688,
    ["UET BuildConfig.json"] = 735,
    ["UI5 Manifest"] = 567,
    ["UTAM Page Object"] = 570,
    ["Ubuntu Server Autoinstall"] = 565,
    ["Uniswap Token List"] = 643,
    ["Unreal Engine Uplugin"] = 736,
    ["Unreal Engine Uproject"] = 737,
    ["Updatecli Compose"] = 695,
    ["Updatecli Policy Manifest"] = 696,
    ["Updatecli Policy Metadata"] = 697,
    Uplift = 733,
    ["User Journey Map"] = 663,
    V2Ray = 701,
    ["VSCode Code Snippets"] = 148,
    ["VSIX CLI publishing"] = 583,
    ["Vela Pipeline Configuration"] = 573,
    Vercel = 147,
    Visivo = 762,
    ["Web App Manifest"] = 590,
    ["Web types"] = 593,
    WebExtensions = 589,
    ["Webman package recipe"] = 707,
    ["Windows Package Manager Installer Manifest"] = 640,
    ["Windows Package Manager Locale Manifest"] = 641,
    ["Windows Package Manager Singleton Manifest"] = 639,
    ["Woodpecker pipeline config"] = 675,
    ["Xstate Machine"] = 693,
    ["Yippee-Ki-JSON configuration YML"] = 645,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 70,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 744,
    ["bashly-strings.yml"] = 745,
    ["bashly.yml"] = 743,
    ["batect.yml"] = 69,
    ...
    ["lsdlschema.json"] = 344,
    ["madness.yml"] = 742,
    ["markdown-lint-check"] = 671,
    mboats = 678,
    ["micro-settings.json"] = 747,
    ["mimetypes.json"] = 351,
    ["mirrord config"] = 614,
    ["monospace.yml"] = 372,
    ["mta.yaml"] = 615,
    ...
    ["servicehub.config.json"] = 603,
    ["servicehub.service.json"] = 602,
    ["settings.job"] = 502,
    ...
    ["vega-lite.json"] = 572,
    ["vega.json"] = 571,
    ["venvironment-basic.yaml"] = 575,
    ["venvironment.yaml"] = 574,
    ["version.json"] = 576,
    ["vim-addon-info"] = 577,
    ["vs-2017.3.host.json"] = 579,
    ["vs-nesting.json"] = 580,
    ["vsls.json"] = 578,
    ["vss-extension.json"] = 584,
    ["vtesttree.yaml"] = 585,
    ["vtestunit.yaml"] = 586,
    ["warp-keysets.json"] = 756,
    ["warp-themes.json"] = 757,
    ["warp-workflows.json"] = 758,
    ["webhint.io"] = 708,
    ["webjobpublishsettings.json"] = 592,
    ["webjobs-list.json"] = 591,
    ["xs-app.json"] = 619,
    ["xunit.runner.json"] = 601,
    yamllint = 644,
    zuul = 628,
    ["Žinoma"] = 638
  },
