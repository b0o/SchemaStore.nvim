...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 201,
    [".cryproj (generic)"] = 676,
    [".cryproj engine-5.2"] = 671,
    [".cryproj engine-5.3"] = 672,
    [".cryproj engine-5.4"] = 673,
    [".cryproj engine-5.5"] = 674,
    [".cryproj engine-dev"] = 675,
    [".eslintrc"] = 257,
    [".esmrc.json"] = 249,
    [".ffizer.yaml"] = 261,
    [".htmlhintrc"] = 318,
    ...
    [".mtaext"] = 687,
    [".nodehawkrc"] = 430,
    [".npmpackagejsonlintrc"] = 434,
    [".omletrc"] = 862,
    [".phrase.yml"] = 480,
    [".phraseapp.yml"] = 481,
    [".pmbot.yml"] = 470,
    [".postcssrc"] = 475,
    [".powerpages-web-template-manifest"] = 477,
    [".pre-commit-config.yml"] = 478,
    [".pre-commit-hooks.yml"] = 479,
    [".putout.json"] = 500,
    [".rehyperc"] = 519,
    [".remarkrc"] = 521,
    [".sprite files"] = 579,
    ...
    ["<div>RIOTS' studio configuration"] = 654,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 385,
    ABCSupplyPlan = 13,
    AIConfig = 14,
    ["API Builder"] = 719,
    ["AVA Configuration"] = 779,
    ...
    ["Adobe UXP Manifest"] = 844,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 15,
    ["Airplane task"] = 16,
    ["Alacritty Configuration"] = 751,
    ["All Contributors configuration file"] = 809,
    ...
    ["Azure Pipelines"] = 68,
    ["Azure Static Web Apps CLI configuration file"] = 582,
    ["Azure Static Web Apps configuration file"] = 581,
    ["BX CI"] = 106,
    ["Bashly (bashly.yml)"] = 813,
    ["Bashly Settings (bashly-settings.yml)"] = 814,
    ["Better Code Hub"] = 723,
    ["Better Scripts"] = 107,
    Bigconfig = 85,
    BizTalkServerApplicationSchema = 693,
    Bleep = 108,
    ...
    ["Butane Config"] = 764,
    ["CGS Custom Card Game (CardGameDef.json)"] = 849,
    ["CICS TS region tagging"] = 773,
    ["CICS TS resource import"] = 774,
    ["CICS TS resource model"] = 775,
    ["CICS TS resource overrides"] = 776,
    ["CMake Presets"] = 109,
    ["CNC Codes"] = 121,
    ...
    CityJSON = 118,
    ["Clawject config"] = 126,
    ["Cloud Foundry Application Manifest"] = 861,
    ["Code Climate"] = 155,
    CodeCV = 64,
    ...
    ["Custom Machinery Machine"] = 850,
    ["Custom Machinery Recipe"] = 851,
    ...
    ["DataYoga Job"] = 130,
    ["Databricks Asset Bundles"] = 830,
    ["Datadog Service Definition"] = 361,
    ["Datahub Ingestion Recipe"] = 780,
    ["Dein Config"] = 132,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 821,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 810,
    ...
    ["Error pages"] = 252,
    Esquio = 250,
    ["Estuary Flow Catalog"] = 770,
    ["Expo SDK"] = 255,
    ["F-Droid Data metadata"] = 260,
    ["Facets - FSDL - Application"] = 258,
    ["FasterCI Configuration"] = 69,
    FiQuS = 264,
    Firebase = 262,
    ["Flow.json Configurations"] = 854,
    ["Fossa configuration file"] = 271,
    ["Fossa's fossa-deps file"] = 272,
    ["Foundry VTT - Base package Manifest"] = 266,
    ["Foundry VTT - Module Manifest"] = 267,
    ["Foundry VTT - System Data Template"] = 270,
    ["Foundry VTT - System Manifest"] = 268,
    ["Foundry VTT - World Manifest"] = 269,
    ["Foxx Manifest"] = 70,
    ["Freifunk.de Community API"] = 73,
    ["Frogbot Config"] = 74,
    ["G2P Mapping Configuration"] = 276,
    ["GCP Blueprint Metadata"] = 279,
    Gaspar = 277,
    ["GatewayCore API Gateway"] = 278,
    ["GeoJSON.json latest"] = 768,
    GherKing = 772,
    ["GitHub Action"] = 284,
    ["GitHub Discussion"] = 285,
    ["GitHub Funding"] = 286,
    ["GitHub Issue Template configuration"] = 288,
    ["GitHub Issue Template forms"] = 287,
    ["GitHub Workflow"] = 289,
    ["GitHub Workflow Template Properties"] = 290,
    ["GitHub automatically generated release notes configuration"] = 291,
    ["GitLab Agent for Kubernetes configuration"] = 846,
    GitVersion = 281,
    ["Gitea Issue Template configuration"] = 282,
    ["Gitea Issue Template forms"] = 283,
    ["Gitpod Configuration"] = 293,
    ["GlazeWM settings"] = 848,
    ["Global Privacy Control"] = 280,
    Goblet = 829,
    ["Golangci-lint Configuration"] = 295,
    ["Golangci-lint Custom Plugins Configuration"] = 296,
    ["Google Chrome Related Website Sets"] = 263,
    ["Google Cloud Workflows"] = 184,
    Goreleaser = 298,
    ["Goreleaser Pro"] = 299,
    Goss = 300,
    ["Gradle Build Cache Node"] = 721,
    ["Gradle Enterprise"] = 720,
    ["Grafana 5.x Dashboard"] = 301,
    ["GraphQL Code Generator"] = 305,
    ["GraphQL Config"] = 304,
    ["GraphQL Mesh"] = 303,
    ["Grunt JSHint task"] = 309,
    ["Grunt Watch task"] = 310,
    ["Grunt base task"] = 311,
    ["Grunt clean task"] = 307,
    ["Grunt copy task"] = 306,
    ["Grunt cssmin task"] = 308,
    HEMTT = 690,
    Hadolint = 702,
    Hammerkit = 730,
    ["Hardware Sentry Configuration"] = 784,
    Hatch = 703,
    Hayson = 313,
    ["Haystack Pipeline"] = 314,
    ["Hazelcast 5 Configuration"] = 315,
    ["Helm Chart.lock"] = 152,
    ["Helm Chart.yaml"] = 151,
    ["Helm Unittest Test Suite"] = 153,
    Hugo = 760,
    ["Hugo Theme"] = 759,
    ["Hyperfoil benchmark configuration"] = 320,
    ["IBM Zapp document"] = 321,
    ["IBM zCodeFormatSettings"] = 322,
    ["IMG Catapult PSP"] = 327,
    ["IVMS101 by CODE Protocol"] = 847,
    Infrahub = 329,
    Istanbul = 787,
    ["JDownloader2 crawler multi-rules"] = 338,
    ["JDownloader2 crawler single-rules"] = 337,
    ["JFrog Applications Config"] = 339,
    ["JFrog File Spec"] = 340,
    ["JFrog Pipelines YML DSL"] = 793,
    ["JMeter DSL cli config"] = 341,
    JReleaser = 343,
    ["JSON Document Transform"] = 351,
    ["JSON Feed"] = 352,
    ["JSON Resume"] = 526,
    ["JSON Schema Draft 2020-12"] = 667,
    ["JSON Schema Draft 4"] = 664,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 831,
    ["JSON Schema Draft 7"] = 665,
    ["JSON Schema Draft 7 (unofficial strict)"] = 832,
    ["JSON Schema Draft 8 (2019-09)"] = 666,
    ["JSON-API"] = 350,
    ["JSON-WF"] = 860,
    ["JSON-e templates"] = 728,
    ["JSON-stat 2.0"] = 661,
    JSONPatch = 354,
    ["JSR Package Config (jsr.json)"] = 344,
    Jasmine = 333,
    Jekyll = 334,
    ["Jenkins X Pipelines"] = 335,
    ["Jenkins X Requirements"] = 336,
    ["Jovo Language Models"] = 342,
    ["KIMMDY config file"] = 359,
    ["KSP-AVC"] = 662,
    ["KSP-CKAN"] = 663,
    KSY = 859,
    ["Karakum configuration file"] = 273,
    Kas = 357,
    ["Keycloak REST API"] = 801,
    ["Knative Functions - func.yaml"] = 274,
    ["KoDE/CI build.yaml"] = 789,
    ["Kong DBLess config"] = 790,
    KrakenD = 360,
    ["Kubri Configuration"] = 365,
    LOOBin = 380,
    Lefthook = 369,
    ["Liferay client-extension.yaml"] = 376,
    ["LinkML Metamodel"] = 378,
    Liquibase = 736,
    ["Liquibase Flow File"] = 737,
    ["Lively Properties"] = 379,
    ["Lobe AI Agent"] = 66,
    Loki = 67,
    ["MLOS Configs"] = 414,
    ["MS2Rescore Configuration"] = 417,
    ["Madness (madness.yml)"] = 812,
    Markdownlint = 740,
    ["Mason Registry"] = 742,
    ["MegaLinter configuration"] = 386,
    ["MegaLinter descriptor"] = 387,
    Melange = 838,
    ["Meltano plugin discovery definition"] = 389,
    ["Meltano project definition"] = 388,
    ["Mergify Configuration"] = 418,
    ["MetricsHub Configuration"] = 390,
    ["MetricsHub Connector Configuration"] = 391,
    ["Micro Editor Syntax"] = 822,
    ["Microsoft Band Web Tile"] = 392,
    ["Minecraft Custom Main Menu Mod"] = 839,
    ["Minecraft Data Pack Advancement"] = 394,
    ["Minecraft Data Pack Biome"] = 395,
    ["Minecraft Data Pack Configured Carver"] = 396,
    ["Minecraft Data Pack Damage Type"] = 397,
    ["Minecraft Data Pack Dimension"] = 399,
    ["Minecraft Data Pack Dimension Type"] = 398,
    ["Minecraft Data Pack Item Modifier"] = 400,
    ["Minecraft Data Pack Loot Table"] = 401,
    ["Minecraft Data Pack Metadata"] = 402,
    ["Minecraft Data Pack Predicate"] = 403,
    ["Minecraft Data Pack Recipe"] = 404,
    ["Minecraft Data Pack Tag"] = 405,
    ["Minecraft Data Pack Template Pool"] = 406,
    ["Minecraft Data Pack Trim Material"] = 411,
    ["Minecraft Data Pack Trim Pattern"] = 412,
    ["Minecraft Resource Pack Lang"] = 407,
    ["Minecraft Resource Pack Particle"] = 408,
    ["Minecraft Resource Pack Texture Mcmeta"] = 410,
    ["Minecraft Resourcepack Sounds"] = 409,
    ["MkDocs Configuration 1.0"] = 413,
    ["Monade CLI Stack Configuration"] = 421,
    ["MongoDB Atlas Search Index Definition"] = 788,
    ["Monika Configuration"] = 786,
    ["Monoweave Configuration"] = 416,
    ["Motif config"] = 686,
    ["NOX Framework (Service)"] = 433,
    ["Netin Diagnostic System Template"] = 746,
    ["Netlify config"] = 424,
    ["Network-as-Code Data Model"] = 425,
    ["Nightwatch.js"] = 426,
    ["Nuitka.yaml"] = 852,
    ["ONe's changelog entry"] = 449,
    ["ONe's service descriptor"] = 448,
    ["OSS Review Toolkit configuration"] = 456,
    ["OSS Review Toolkit curation"] = 457,
    ["OSS Review Toolkit package configuration"] = 458,
    ["OSS Review Toolkit repository configuration"] = 459,
    ["OSS Review Toolkit resolutions"] = 460,
    Opctl = 689,
    ["OpenRewrite Resource"] = 451,
    ["OpenUtau character yaml"] = 445,
    ["OpenUtau ustx"] = 446,
    ["OpenWeather Current Weather API"] = 727,
    ["OpenWeather Road Risk API"] = 726,
    ["Ory Hydra configuration"] = 319,
    ["Ory Keto configuration"] = 362,
    ["Ory Kratos configuration"] = 455,
    ["Ory Oathkeeper configuration"] = 440,
    ["Outblocks App configuration"] = 453,
    ["Outblocks database table"] = 454,
    ["Outblocks project configuration"] = 452,
    PDM = 466,
    Packer = 463,
    Pantsbuild = 808,
    ["Paper paper-plugin.yml"] = 464,
    ["Pipeline component"] = 738,
    ["PocketMine plugin.yml"] = 471,
    ["Postman collection"] = 476,
    ["Problem object RFC9457"] = 836,
    ["Problem package generators"] = 484,
    Pterodactyl = 783,
    ["Pull Request Labeler"] = 499,
    Pulumi = 505,
    PyProject = 506,
    Pyright = 507,
    Qgoda = 508,
    ...
    ["RKE Cluster Configuration YAML"] = 734,
    ["Rancher Fleet"] = 502,
    ["Rattler-build"] = 509,
    Ray = 701,
    ["Read the Docs"] = 504,
    ["Red-DiscordBot Cog"] = 516,
    ["Red-DiscordBot Cog Repo"] = 517,
    ["Red-DiscordBot Trivia"] = 518,
    ["Render Blueprints"] = 733,
    RenderCV = 528,
    Renovate = 527,
    ["Replit config"] = 522,
    RoadRunner = 529,
    ["Rudder techniques"] = 842,
    Ruff = 524,
    ["Rust Project"] = 525,
    ["Rust toolchain"] = 532,
    ["SDMX data message"] = 557,
    ["SDMX metadata message"] = 556,
    ["SDMX structure message"] = 555,
    ["SIL Kit Participant Configuration"] = 567,
    ["SIL Kit Registry Configuration"] = 568,
    SWADL = 593,
    ["Safebox Config"] = 794,
    ["Sapphire CLI Config"] = 535,
    ["SauceCTL Configuration"] = 743,
    ["Schema Catalog"] = 549,
    ["Scoop manifest"] = 554,
    ["Semantic Data Fabric (SDF) file"] = 558,
    ["Semgrep Rule"] = 560,
    ["Serenity Code Generator (Sergen)"] = 561,
    ["Serverless Framework Configuration"] = 750,
    ["Serverless Workflow"] = 752,
    ["Settings.paf"] = 563,
    ["Shopware 6 Configuration"] = 753,
    ["Shopware CLI Extension Store Configuration"] = 754,
    ["Shopware CLI Project Store Configuration"] = 755,
    Sigma = 565,
    ["Sigrid scope configuration file"] = 566,
    ["SkyPilot Task JSON"] = 843,
    ["Slack app manifest"] = 570,
    Solidarity = 573,
    ["Solution filters"] = 574,
    ["Source Maps v3"] = 575,
    Sourcery = 576,
    SpecIF = 577,
    ["Sponge Mixin configuration"] = 578,
    StackBlitz = 583,
    ["StackHawk Scanner Configuration"] = 749,
    Stale = 584,
    ["Starlake Data Pipeline"] = 724,
    Starship = 585,
    ["Statamic Blueprint"] = 586,
    ["Stella configuration file"] = 587,
    ["StrmPrivacy Data Connector"] = 798,
    ["StrmPrivacy Data Contract"] = 799,
    ["StrmPrivacy SimpleSchema"] = 796,
    ["StrmPrivacy Stream"] = 797,
    ["StrmPrivacy batch job configuration file"] = 795,
    ["Stryker Mutator"] = 590,
    ["StyleCop Analyzers Configuration"] = 591,
    ["Stylelint (.stylelintrc)"] = 592,
    ["Sublime Syntax"] = 800,
    ["Subsquid squid manifest"] = 845,
    ["Swagger API 2.0"] = 594,
    TSON = 620,
    TSTyche = 621,
    Talhelper = 596,
    ["Talisman configuration"] = 597,
    ["Taskfile config"] = 729,
    Taurus = 598,
    ["TestEnvironment.json"] = 607,
    ["TextMate Grammar"] = 606,
    ["Tier.run pricing.json"] = 601,
    Tikibase = 602,
    ["Traefik v2"] = 610,
    ["Traefik v2 File Provider"] = 611,
    ["Travis CI (.travis.yml)"] = 609,
    TunnelHub = 835,
    Turborepo = 608,
    Tye = 757,
    ["UET BuildConfig.json"] = 805,
    ["UI5 Manifest"] = 630,
    ["UNCORS configuration"] = 634,
    ["UTAM Page Object"] = 633,
    ["Ubuntu Server Autoinstall"] = 628,
    ["Uniswap Token List"] = 712,
    ["Unreal Engine Uplugin"] = 806,
    ["Unreal Engine Uproject"] = 807,
    ["Updatecli Compose"] = 765,
    ["Updatecli Policy Manifest"] = 766,
    ["Updatecli Policy Metadata"] = 767,
    Uplift = 803,
    ["User Journey Map"] = 732,
    V2Ray = 771,
    ["VSCode Code Snippets"] = 172,
    ["VSIX CLI publishing"] = 649,
    ["Vela Pipeline Configuration"] = 638,
    Vercel = 171,
    Visivo = 833,
    ["Web App Manifest"] = 656,
    ["Web types"] = 659,
    WebExtensions = 655,
    ["Webman package recipe"] = 777,
    ["Windows Package Manager Installer Manifest"] = 709,
    ["Windows Package Manager Locale Manifest"] = 710,
    ["Windows Package Manager Singleton Manifest"] = 708,
    ["Woodpecker pipeline config"] = 745,
    ["Wrangler CLI"] = 660,
    ["Xstate Machine"] = 763,
    ["Yarn Config (.yarnrc.yml)"] = 722,
    ["Yippee-Ki-JSON configuration YML"] = 714,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 837,
    ...
    ["behat.yml"] = 92,
    ["bigquery-table"] = 84,
    ["bioimageio resource description"] = 853,
    ...
    ["gitlab-ci"] = 292,
    ["global.json"] = 294,
    ["go-feature-flag Flag Configuration"] = 297,
    ["haxelib.json"] = 312,
    helmfile = 704,
    helmwave = 705,
    ["host-meta.json"] = 317,
    ...
    ["ide.host.json"] = 323,
    ["ifstate.conf"] = 324,
    ["imageoptimizer.json"] = 325,
    ["importmap.json"] = 328,
    ["ioBroker Configuration"] = 330,
    ["ioBroker JSON UI"] = 331,
    ["ioBroker Package manifest"] = 332,
    ["ize.toml"] = 802,
    ["jsconfig.json"] = 355,
    ["jscpd Configuration"] = 782,
    jsdoc = 700,
    ["k3d.yaml"] = 356,
    ["k9s plugin.yml"] = 358,
    ["kontinuous-config.yaml"] = 364,
    ["kontinuous-values.yaml"] = 363,
    ["kustomization.yaml"] = 366,
    ["label-commenter-config.yml"] = 367,
    ["latexindent configuration"] = 65,
    ["launchsettings.json"] = 368,
    lazydocker = 824,
    lazygit = 823,
    ["lego.json"] = 370,
    ["lerna.json"] = 371,
    ["lgtm.yml"] = 372,
    ["liblab.config.json"] = 373,
    ["libman.json"] = 374,
    ["license-report-config.json"] = 375,
    ["linkinator.config.json"] = 377,
    ["lint-staged (.lintstagedrc)"] = 680,
    ["local.settings.json"] = 382,
    ["localazy.json"] = 383,
    ["lotus.yaml"] = 381,
    ["lsdlschema.json"] = 384,
    ["markdown-link-check"] = 741,
    mboats = 748,
    ["micro-settings.json"] = 817,
    ["mimetypes.json"] = 393,
    ["mirrord config"] = 681,
    mise = 682,
    ["mise-settings"] = 683,
    ...
    ["mtad.yaml"] = 685,
    ["mycode.json"] = 422,
    ["napari plugin manifest"] = 423,
    neoload = 695,
    ["nest-cli"] = 428,
    ["ninjs (News in JSON)"] = 427,
    ["nixd configuration"] = 841,
    ["nlu.json"] = 429,
    ["nodemon.json"] = 431,
    ["noodl config"] = 747,
    ["notebook.mod.json"] = 432,
    now = 691,
    ["npm-badges"] = 435,
    ["nswag.json"] = 438,
    ntangle = 439,
    ["nuclei-template.yaml"] = 436,
    ["nuget-project.json"] = 437,
    ["ocelot.json"] = 441,
    ["omnisharp.json"] = 442,
    ["openapi.json"] = 443,
    ["openfin.json"] = 450,
    ...
    ["ops.yaml"] = 447,
    ["package.json"] = 461,
    ["package.manifest"] = 462,
    ["partial-black.json"] = 93,
    ["pathfinder.yml"] = 465,
    ["pattern.json"] = 468,
    ["petstore-v1.0"] = 792,
    pgap_yaml_input_reader = 467,
    ["pixi.toml"] = 469,
    ["plagiarize-me.yaml"] = 473,
    ["plagiarize.yaml"] = 472,
    ["portman.json"] = 474,
    ["prettierrc.json"] = 482,
    ["prisma.yml"] = 483,
    ["project-1.0.0-beta3.json"] = 486,
    ["project-1.0.0-beta4.json"] = 487,
    ["project-1.0.0-beta5.json"] = 488,
    ["project-1.0.0-beta6.json"] = 489,
    ["project-1.0.0-beta8.json"] = 490,
    ["project-1.0.0-rc1.json"] = 491,
    ["project-1.0.0-rc2.json"] = 492,
    ["project.json"] = 485,
    ["prometheus.json"] = 493,
    ["prometheus.rules.json"] = 494,
    ["prometheus.rules.test.json"] = 495,
    ["proxies.json"] = 496,
    ["publiccode.yml"] = 497,
    ["pubspec.yaml"] = 498,
    ["pyrseas-0.8.json"] = 501,
    ["quilt.mod.json"] = 818,
    ["rc3 auth"] = 510,
    ["rc3 collection"] = 511,
    ["rc3 environment"] = 512,
    ...
    ["rc3 settings"] = 515,
    ["release drafter"] = 696,
    ["release-plz.toml"] = 520,
    ["rivet.yaml"] = 840,
    rockcraft = 530,
    rustfmt = 531,
    samt = 533,
    samtrc = 534,
    ["sarif-1.0.0.json"] = 536,
    ["sarif-2.0.0.json"] = 537,
    ["sarif-2.1.0"] = 547,
    ["sarif-2.1.0-rtm.2"] = 538,
    ["sarif-2.1.0-rtm.3"] = 540,
    ["sarif-2.1.0-rtm.4"] = 542,
    ["sarif-2.1.0-rtm.5"] = 544,
    ["sarif-2.1.0-rtm.6"] = 545,
    ["sarif-external-property-file-2.1.0"] = 548,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 539,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 541,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 543,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 546,
    ["schema.org - Action"] = 550,
    ["schema.org - ContactPoint"] = 551,
    ["schema.org - Place"] = 552,
    ["schema.org - Thing"] = 553,
    ["secrethub.yml"] = 820,
    ["semantic-release"] = 559,
    ["servicehub.config.json"] = 670,
    ["servicehub.service.json"] = 669,
    ["settings.job"] = 562,
    ["sfdx-hardis configuration"] = 564,
    ["shard.yml"] = 856,
    ["size-limit configuration"] = 569,
    ["skaffold.yaml"] = 739,
    ["skyuxconfig.json"] = 571,
    snapcraft = 572,
    ["sqlc configuration"] = 580,
    ["stripe-app-local.json"] = 589,
    ["stripe-app.json"] = 588,
    swcrc = 725,
    ["task.json"] = 595,
    taskcat = 692,
    ["template.json"] = 599,
    ["templatsources.json"] = 600,
    ["theme.json"] = 603,
    ["tizen_workspace.json"] = 604,
    tldr = 605,
    tmuxinator = 678,
    ["transcend.yml"] = 612,
    ["tree-sitter grammar.json"] = 302,
    ["trime.yaml"] = 613,
    ["trunk.yaml"] = 614,
    ["ts-force-config.json"] = 618,
    ["tsconfig.json"] = 615,
    ["tsd.json"] = 616,
    ["tsdrc.json"] = 617,
    ["tslint.json"] = 619,
    ...
    ["vega-lite.json"] = 637,
    ["vega.json"] = 636,
    ["venvironment-basic.yaml"] = 640,
    ["venvironment.yaml"] = 639,
    ["version.json"] = 641,
    ["vim-addon-info"] = 643,
    ["vs-2017.3.host.json"] = 645,
    ["vs-nesting.json"] = 646,
    ["vsls.json"] = 644,
    ["vss-extension.json"] = 650,
    ["vtesttree.yaml"] = 651,
    ["vtestunit.yaml"] = 652,
    ["warp-keysets.json"] = 826,
    ["warp-themes.json"] = 827,
    ["warp-workflows.json"] = 828,
    ["webhint.io"] = 778,
    ["webjobpublishsettings.json"] = 658,
    ["webjobs-list.json"] = 657,
    ["well-known-fursona"] = 864,
    ["xs-app.json"] = 688,
    ["xunit.runner.json"] = 668,
    yamllint = 713,
    zuul = 697,
    ["Žinoma"] = 707
  },
