...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 167,
    [".cryproj (generic)"] = 577,
    [".cryproj engine-5.2"] = 572,
    [".cryproj engine-5.3"] = 573,
    [".cryproj engine-5.4"] = 574,
    [".cryproj engine-5.5"] = 575,
    [".cryproj engine-dev"] = 576,
    [".csscomb.json"] = 169,
    [".csslintrc"] = 170,
    [".es6importsorterrc.json"] = 704,
    [".eslintrc"] = 218,
    [".esmrc.json"] = 210,
    [".ffizer.yaml"] = 222,
    [".htmlhintrc"] = 270,
    ...
    [".mtaext"] = 586,
    [".nodehawkrc"] = 365,
    [".npmpackagejsonlintrc"] = 368,
    [".phraseapp.yml"] = 408,
    [".pmbot.yml"] = 398,
    [".postcssrc"] = 403,
    [".powerpages-web-template-manifest"] = 405,
    [".pre-commit-config.yml"] = 406,
    [".pre-commit-hooks.yml"] = 407,
    [".putout.json"] = 426,
    [".rehyperc"] = 437,
    [".remarkrc"] = 438,
    [".sprite files"] = 491,
    ...
    ["<div>RIOTS' studio configuration"] = 556,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config schema"] = 327,
    ["API Builder"] = 617,
    ["AVA Configuration Schema"] = 674,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration Schema"] = 649,
    ["All Contributors configuration file"] = 703,
    ...
    ["Azure Pipelines"] = 54,
    ["Azure Static Web Apps CLI configuration file"] = 493,
    ["Azure Static Web Apps configuration file"] = 492,
    ["BX CI"] = 89,
    ["Better Code Hub"] = 622,
    ["Better Scripts"] = 90,
    BizTalkServerApplicationSchema = 592,
    ...
    ["Butane Config"] = 661,
    ["CICS TS region tagging"] = 668,
    ["CICS TS resource import"] = 669,
    ["CICS TS resource model"] = 670,
    ["CICS TS resource overrides"] = 671,
    ["CMake Presets"] = 91,
    ...
    ["Datahub Ingestion Recipe Schema"] = 675,
    ...
    ["Embrace Config Schema"] = 686,
    ["Error pages"] = 213,
    Esquio = 211,
    ["Estuary Flow Catalog Schema"] = 665,
    ["Expo SDK"] = 216,
    ...
    ["Goreleaser Pro"] = 252,
    Goss = 253,
    ["Gradle Build Cache Node"] = 619,
    ["Gradle Enterprise"] = 618,
    ...
    Hadolint = 601,
    Hammerkit = 629,
    ["Hardware Sentry Configuration"] = 679,
    Hayson = 265,
    ...
    ["JFrog File Spec"] = 289,
    ["JFrog Pipelines YML DSL"] = 688,
    ["JMeter DSL cli config schema"] = 290,
    JReleaser = 292,
    ["JSON Document Transform"] = 299,
    ["JSON Feed"] = 300,
    ["JSON Resume"] = 444,
    ["JSON Schema Draft 2020-12"] = 568,
    ["JSON Schema Draft 4"] = 565,
    ["JSON Schema Draft 7"] = 566,
    ["JSON Schema Draft 8"] = 567,
    ...
    Kas = 305,
    ["Keycloak REST API"] = 695,
    ["Knative Functions - func.yaml"] = 233,
    ["KoDE/CI build.yaml"] = 684,
    ["Kong DBLess Schema"] = 685,
    KrakenD = 306,
    LOOBin = 322,
    Lefthook = 313,
    ["LinkML Metamodel"] = 320,
    Liquibase = 634,
    ["Liquibase Flow File"] = 635,
    ["Lively Properties"] = 321,
    Markdownlint = 638,
    ["Mason Registry"] = 640,
    ["MegaLinter configuration"] = 328,
    ["MegaLinter descriptor"] = 329,
    ["Meltano plugin discovery definition"] = 331,
    ["Meltano project definition"] = 330,
    ["Microsoft Band Web Tile"] = 332,
    ["Minecraft Data Pack Advancement"] = 334,
    ["Minecraft Data Pack Biome"] = 335,
    ["Minecraft Data Pack Configured Carver"] = 336,
    ["Minecraft Data Pack Damage Type"] = 337,
    ["Minecraft Data Pack Dimension"] = 339,
    ["Minecraft Data Pack Dimension Type"] = 338,
    ["Minecraft Data Pack Item Modifier"] = 340,
    ["Minecraft Data Pack Loot Table"] = 341,
    ["Minecraft Data Pack Metadata"] = 342,
    ["Minecraft Data Pack Predicate"] = 343,
    ["Minecraft Data Pack Recipe"] = 344,
    ["Minecraft Data Pack Tag"] = 345,
    ["Minecraft Data Pack Template Pool"] = 346,
    ["Minecraft Data Pack Trim Material"] = 351,
    ["Minecraft Data Pack Trim Pattern"] = 352,
    ["Minecraft Resource Pack Lang"] = 347,
    ["Minecraft Resource Pack Particle"] = 348,
    ["Minecraft Resource Pack Texture Mcmeta"] = 350,
    ["Minecraft Resourcepack Sounds"] = 349,
    ["MkDocs Configuration 1.0"] = 353,
    ["MongoDB Atlas Search Index Definition Schema"] = 683,
    ["Monika Configuration Schema"] = 681,
    ["Motif config"] = 585,
    ["NOX Framework (Service)"] = 367,
    ["Netin Diagnostic System Template"] = 644,
    ["Netlify config schema"] = 358,
    ["Nexus-as-Code schema"] = 359,
    ["Nightwatch.js"] = 360,
    ["ONe's service descriptor"] = 380,
    ["OSS Review Toolkit configuration"] = 387,
    ["OSS Review Toolkit curation"] = 388,
    ["OSS Review Toolkit package configuration"] = 389,
    ["OSS Review Toolkit repository configuration"] = 390,
    ["OSS Review Toolkit resolutions"] = 391,
    Opctl = 588,
    ["OpenRewrite Resource"] = 382,
    ["OpenWeather Current Weather API"] = 626,
    ["OpenWeather Road Risk API"] = 625,
    ["Ory Hydra configuration"] = 271,
    ["Ory Keto configuration"] = 308,
    ["Ory Kratos configuration"] = 386,
    ["Ory Oathkeeper configuration"] = 374,
    ["Outblocks App configuration"] = 384,
    ["Outblocks database table"] = 385,
    ["Outblocks project configuration"] = 383,
    Packer = 394,
    Pantsbuild = 702,
    ["Paper paper-plugin.yml"] = 395,
    ["Pipeline component"] = 636,
    ["PocketMine plugin.yml"] = 399,
    ["Postman collection"] = 404,
    Pterodactyl = 678,
    ["Pull Request Labeler"] = 425,
    Pulumi = 431,
    PyProject = 432,
    Pyright = 433,
    Qodana = 654,
    ["Quali Torque Blueprint Spec 2"] = 676,
    ["QueryFirst config file"] = 698,
    ["RKE Cluster Configuration JSON Schema"] = 633,
    ["RKE Cluster Configuration YAML Schema"] = 632,
    ["Rancher Fleet"] = 428,
    Ray = 600,
    ["Read the Docs"] = 430,
    ["Red-DiscordBot Cog"] = 434,
    ["Red-DiscordBot Cog Repo"] = 435,
    ["Red-DiscordBot Trivia"] = 436,
    Renovate = 445,
    ["Replit schema"] = 439,
    RoadRunner = 446,
    Ruff = 442,
    ["Rust Project"] = 443,
    ["Rust toolchain"] = 448,
    ["SIL Kit Participant Configuration"] = 479,
    ["SIL Kit Registry Configuration"] = 480,
    SWADL = 502,
    ["Safebox Config Schema"] = 689,
    ["Sapphire CLI Config"] = 451,
    ["SauceCTL Configuration"] = 641,
    ["Schema Catalog"] = 465,
    ["Scoop manifest"] = 470,
    ["Semantic Data Fabric (SDF) file"] = 471,
    ["Semgrep Rule"] = 473,
    ["Serenity Code Generator (Sergen)"] = 474,
    ["Serverless Framework Configuration"] = 648,
    ["Serverless Workflow Schema"] = 650,
    ["Settings.paf"] = 476,
    ["Shopware 6 Configuration"] = 651,
    ["Shopware CLI Extension Store Configuration"] = 652,
    ["Shopware CLI Project Store Configuration"] = 653,
    ["Sigrid scope configuration file"] = 478,
    ["Slack app manifest"] = 482,
    Solidarity = 485,
    ["Solution filters"] = 486,
    ["Source Maps v3"] = 487,
    Sourcery = 488,
    SpecIF = 489,
    ["Sponge Mixin configuration"] = 490,
    ["StackHawk Scanner Configuration"] = 647,
    Stale = 494,
    Starship = 495,
    ["Statamic Blueprint"] = 496,
    ["StrmPrivacy Data Connector"] = 693,
    ["StrmPrivacy Data Contract"] = 694,
    ["StrmPrivacy SimpleSchema"] = 691,
    ["StrmPrivacy Stream"] = 692,
    ["StrmPrivacy batch job configuration file"] = 690,
    ["Stryker Mutator"] = 499,
    ["StyleCop Analyzers Configuration"] = 500,
    ["Swagger API 2.0"] = 503,
    TSON = 528,
    ["Talisman configuration"] = 505,
    ["Taskfile YAML Schema"] = 628,
    Taurus = 506,
    ["TestEnvironment.json"] = 515,
    ["Tier.run pricing.json"] = 509,
    Tikibase = 510,
    ["Traefik v2"] = 518,
    ["Traefik v2 File Provider"] = 519,
    Turborepo = 516,
    Tye = 655,
    ["UET BuildConfig.json"] = 699,
    ["UI5 Manifest"] = 535,
    ["UTAM Page Object"] = 538,
    ["Ubuntu Server Autoinstall"] = 533,
    ["Uniswap Token List"] = 610,
    ["Unreal Engine Uplugin"] = 700,
    ["Unreal Engine Uproject"] = 701,
    Updatecli = 662,
    Uplift = 697,
    ["User Journey Map YAML Schema"] = 631,
    V2Ray = 666,
    ["VSCode Code Snippets"] = 138,
    ["VSIX CLI publishing"] = 551,
    ["Vela Pipeline Configuration"] = 541,
    Vercel = 137,
    ["Web App Manifest"] = 558,
    ["Web types"] = 561,
    WebExtensions = 557,
    ["Webman package recipe"] = 672,
    ["Windows Package Manager Installer Manifest"] = 607,
    ["Windows Package Manager Locale Manifest"] = 608,
    ["Windows Package Manager Singleton Manifest"] = 606,
    ["Woodpecker pipeline config"] = 643,
    ["Xstate Machine Schema"] = 660,
    ["Yippee-Ki-JSON configuration YML"] = 612,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 65,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 708,
    ["bashly-strings.yml"] = 709,
    ["bashly.yml"] = 707,
    ["batect.yml"] = 64,
    ["beau.yml"] = 621,
    ...
    ["ize.toml"] = 696,
    ["jsconfig.json"] = 303,
    ["jscpd Configuration Schema"] = 677,
    jsdoc = 599,
    ["k3d.yaml"] = 304,
    ["kontinuous-values.yaml"] = 309,
    ["kustomization.yaml"] = 310,
    ["label-commenter-config.yml"] = 311,
    ["launchsettings.json"] = 312,
    lazydocker = 718,
    lazygit = 717,
    ["lego.json"] = 314,
    ["lerna.json"] = 315,
    ["lgtm.yml"] = 316,
    ["libman.json"] = 317,
    ["license-report-config.json"] = 318,
    ["linkinator.config.json"] = 319,
    ["local.settings.json"] = 324,
    ["localazy.json"] = 325,
    ["lotus.yaml"] = 323,
    ["lsdlschema.json"] = 326,
    ["madness.yml"] = 706,
    ["markdown-lint-check"] = 639,
    mboats = 646,
    ["micro-settings.json"] = 711,
    ["mimetypes.json"] = 333,
    ["mirrord-schema"] = 582,
    ["mta.yaml"] = 583,
    ["mtad.yaml"] = 584,
    ["mycode.json"] = 356,
    ["napari plugin manifest"] = 357,
    neoload = 594,
    ["nest-cli"] = 363,
    ["ninjs (News in JSON) 1.3"] = 362,
    ["ninjs (News in JSON) 2.0"] = 361,
    ["nlu.json"] = 364,
    ["nodemon.json"] = 366,
    ["noodl.schema.json"] = 645,
    now = 590,
    ["npm-badges"] = 369,
    ["nswag.json"] = 372,
    ntangle = 373,
    ["nuclei-template.yaml"] = 370,
    ["nuget-project.json"] = 371,
    ["ocelot.json"] = 375,
    ["omnisharp.json"] = 376,
    ["openapi.json"] = 377,
    ["openfin.json"] = 381,
    ...
    ["ops.yaml"] = 379,
    ["package.json"] = 392,
    ["package.manifest"] = 393,
    ["pattern.json"] = 397,
    ["petstore-v1.0"] = 687,
    pgap_yaml_input_reader = 396,
    ["plagiarize-me.yaml"] = 401,
    ["plagiarize.yaml"] = 400,
    ["portman.json"] = 402,
    ["prettierrc.json"] = 409,
    ["prisma.yml"] = 410,
    ["project-1.0.0-beta3.json"] = 412,
    ["project-1.0.0-beta4.json"] = 413,
    ["project-1.0.0-beta5.json"] = 414,
    ["project-1.0.0-beta6.json"] = 415,
    ["project-1.0.0-beta8.json"] = 416,
    ["project-1.0.0-rc1.json"] = 417,
    ["project-1.0.0-rc2.json"] = 418,
    ["project.json"] = 411,
    ["prometheus.json"] = 419,
    ["prometheus.rules.json"] = 420,
    ["prometheus.rules.test.json"] = 421,
    ["proxies.json"] = 422,
    ["publiccode.yml"] = 423,
    ["pubspec.yaml"] = 424,
    ["pyrseas-0.8.json"] = 427,
    ["quilt.mod.json"] = 712,
    ["release drafter"] = 595,
    rtx = 441,
    rustfmt = 447,
    samt = 449,
    samtrc = 450,
    ["sarif-1.0.0.json"] = 452,
    ["sarif-2.0.0.json"] = 453,
    ["sarif-2.1.0"] = 463,
    ["sarif-2.1.0-rtm.2"] = 454,
    ["sarif-2.1.0-rtm.3"] = 456,
    ["sarif-2.1.0-rtm.4"] = 458,
    ["sarif-2.1.0-rtm.5"] = 460,
    ["sarif-2.1.0-rtm.6"] = 461,
    ["sarif-external-property-file-2.1.0"] = 464,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 455,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 457,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 459,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 462,
    ["schema.org - Action"] = 466,
    ["schema.org - ContactPoint"] = 467,
    ["schema.org - Place"] = 468,
    ["schema.org - Thing"] = 469,
    ["secrethub.yml"] = 714,
    ["semantic-release"] = 472,
    ["servicehub.config.json"] = 571,
    ["servicehub.service.json"] = 570,
    ["settings.job"] = 475,
    ["sfdx-hardis configuration"] = 477,
    ["size-limit configuration"] = 481,
    ["skaffold.yaml"] = 637,
    ["skyuxconfig.json"] = 483,
    snapcraft = 484,
    ["stripe-app-local.json"] = 498,
    ["stripe-app.json"] = 497,
    swcrc = 624,
    syntax = 716,
    ["task.json"] = 504,
    taskcat = 591,
    ["template.json"] = 507,
    ["templatsources.json"] = 508,
    ["theme.json"] = 511,
    ["tizen_workspace.json"] = 512,
    tldr = 513,
    tmLanguage = 514,
    tmuxinator = 579,
    ["transcend-pathfinder.yml"] = 521,
    ["transcend.yml"] = 520,
    ["trunk.yaml schema"] = 522,
    ["ts-force-config.json"] = 526,
    ["tsconfig.json"] = 523,
    ["tsd.json"] = 524,
    ["tsdrc.json"] = 525,
    ["tslint.json"] = 527,
    ...
    ["vega-lite.json"] = 540,
    ["vega.json"] = 539,
    ["venvironment-basic.yaml"] = 543,
    ["venvironment.yaml"] = 542,
    ["version.json"] = 544,
    ["vim-addon-info"] = 545,
    ["vs-2017.3.host.json"] = 547,
    ["vs-nesting.json"] = 548,
    ["vsls.json"] = 546,
    ["vss-extension.json"] = 552,
    ["vtesttree.yaml"] = 553,
    ["vtestunit.yaml"] = 554,
    ["webhint.io"] = 673,
    ["webjobpublishsettings.json"] = 560,
    ["webjobs-list.json"] = 559,
    ["xs-app.json"] = 587,
    ["xunit.runner.json"] = 569,
    yamllint = 611,
    zuul = 596,
    ["Žinoma"] = 605
  },
