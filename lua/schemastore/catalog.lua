...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1038,
    ["API Builder"] = 853,
    ["AVA Configuration"] = 915,
    ...
    ["Adobe UXP Manifest"] = 977,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1066,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 887,
    ["All Contributors configuration file"] = 940,
    ...
    ["Application list for a WinUtil"] = 1020,
    ArchitectFX = 1025,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure Pipelines"] = 77,
    ["Azure Static Web Apps CLI configuration file"] = 702,
    ["Azure Static Web Apps configuration file"] = 701,
    ["BOSH Deploy Config"] = 101,
    ["BX CI"] = 119,
    ["Bashly (bashly.yml)"] = 944,
    ["Bashly Settings (bashly-settings.yml)"] = 945,
    ["Better Code Hub"] = 857,
    ["Better Scripts"] = 120,
    Bigconfig = 94,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1031,
    BizTalkServerApplicationSchema = 825,
    Bleep = 121,
    ...
    ["CICS TS resource model"] = 911,
    ["CICS TS resource overrides"] = 912,
    ["CMake Presets"] = 122,
    ["CNC Codes"] = 141,
    ["CRS WAF test file"] = 1010,
    ["CRS WAF test platform overrides file"] = 1011,
    ...
    ["Chamaleon environment"] = 1035,
    ["Chamaleon properties"] = 1036,
    ["Chamaleon template"] = 1034,
    Changesets = 224,
    Charmcraft = 131,
    Cheatsheets = 897,
    ...
    CityJSON = 136,
    ["Clawject config"] = 147,
    ["Cloud Foundry Application Manifest"] = 993,
    ["Cloud Run Spec v1"] = 1015,
    ...
    Concord = 1009,
    ["Configu .cfgu files"] = 998,
    ["Configu .configu file"] = 999,
    Conjure = 140,
    ["Container Structure Test"] = 839,
    Containerlab = 866,
    ["Contextive Glossary"] = 1061,
    Convex = 139,
    ["Crowdsec collection config"] = 234,
    ["Crowdsec parser config"] = 235,
    ["Crowdsec scenario config"] = 236,
    ["CumulusCI Config"] = 146,
    ["Custom Machinery Machine"] = 983,
    ["Custom Machinery Recipe"] = 984,
    ...
    ["DonateCaseBetterCasino menu"] = 1039,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 952,
    ["EAS config"] = 300,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 941,
    ["EasyVCR .NET"] = 301,
    ["Eidolon Resource"] = 1026,
    ...
    ["GeoJSON.json latest"] = 904,
    GherKing = 908,
    ["GitHub Action"] = 331,
    ["GitHub Actions typing"] = 1022,
    ...
    ["Google Digital Assetlinks"] = 1062,
    Goreleaser = 359,
    ["Goreleaser Pro"] = 360,
    Goss = 361,
    ["Gradle Build Cache Node"] = 855,
    ["Gradle Enterprise"] = 854,
    ...
    Hadolint = 835,
    Hammerkit = 865,
    ["Hardware Sentry Configuration"] = 920,
    Hatch = 836,
    Hayson = 374,
    ...
    ["JFrog File Spec"] = 405,
    ["JFrog Pipelines YML DSL"] = 929,
    ["JMeter DSL cli config"] = 406,
    JReleaser = 408,
    ["JSON Document Transform"] = 416,
    ["JSON Feed"] = 417,
    ["JSON Resume"] = 636,
    ["JSON Schema Draft 2020-12"] = 804,
    ["JSON Schema Draft 4"] = 801,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 962,
    ["JSON Schema Draft 7"] = 802,
    ["JSON Schema Draft 7 (unofficial strict)"] = 963,
    ["JSON Schema Draft 8 (2019-09)"] = 803,
    ["JSON-API"] = 415,
    ["JSON-e templates"] = 862,
    ["JSON-stat 2.0"] = 797,
    JSONPatch = 419,
    ...
    ["Metadata for a Cinnamon spice"] = 1018,
    ["Metatype Configuration"] = 467,
    ["MetricsHub Configuration"] = 468,
    ["MetricsHub Connector Configuration"] = 469,
    ["Micro Editor Syntax"] = 953,
    ["Microsoft Band Web Tile"] = 470,
    ["Microsoft RulesEngine workflow rules"] = 1006,
    ["Microsoft RulesEngine workflow rules list"] = 1007,
    ["Minecraft Custom Main Menu Mod"] = 971,
    ...
    ["MongoDB Atlas Search Index Definition"] = 924,
    ["Monika Configuration"] = 922,
    ["Monoweave Configuration"] = 495,
    ["Motif config"] = 817,
    MultiQC = 1055,
    ["NOX Framework (Service)"] = 513,
    ["Netin Diagnostic System Template"] = 882,
    ["Netlify config"] = 503,
    ["Network-as-Code Data Model"] = 504,
    ["Nightwatch.js"] = 506,
    ["Node.js configuration"] = 822,
    ...
    ["OpenUtau ustx"] = 531,
    ["OpenWeather Current Weather API"] = 861,
    ["OpenWeather Road Risk API"] = 860,
    ...
    ["Preset list for a WinUtil"] = 1021,
    ...
    Pylock = 1063,
    Pyright = 613,
    ["Python script metadata"] = 1057,
    Qgoda = 615,
    Qodana = 892,
    ["Qt Creator workspace file"] = 1000,
    ["Quali Torque Blueprint Spec 2"] = 917,
    ["QueryFirst config file"] = 935,
    ["RKE Cluster Configuration JSON"] = 870,
    ["RKE Cluster Configuration YAML"] = 869,
    RadioHound = 606,
    Railway = 616,
    ["Rancher Fleet"] = 608,
    ["Rattler-build"] = 617,
    ...
    ["Render Blueprints"] = 868,
    RenderCV = 638,
    Renovate = 637,
    ["Replit config"] = 632,
    Restate = 1050,
    RoadRunner = 640,
    ["Rudder techniques"] = 975,
    Ruff = 634,
    ["Rust Project"] = 635,
    ["Rust toolchain"] = 644,
    ["SDMX data message"] = 670,
    ["SDMX metadata message"] = 669,
    ["SDMX structure message"] = 668,
    ["SIL Kit Participant Configuration"] = 680,
    ["SIL Kit Registry Configuration"] = 681,
    ["SPDX 2.3"] = 699,
    SWADL = 713,
    ["Safebox Config"] = 930,
    ["Sapphire CLI Config"] = 647,
    ["SauceCTL Configuration"] = 879,
    ["Schema Catalog"] = 662,
    ["Scoop manifest"] = 667,
    ["Semantic Data Fabric (SDF) file"] = 671,
    ["Semgrep Rule"] = 673,
    ["Serenity Code Generator (Sergen)"] = 674,
    ["Serverless Framework Configuration"] = 886,
    ["Serverless Workflow"] = 888,
    ["Settings for a Cinnamon spice"] = 1017,
    ["Settings.paf"] = 676,
    ["Shopware 6 Configuration"] = 889,
    ["Shopware CLI Extension Store Configuration"] = 890,
    ["Shopware CLI Project Store Configuration"] = 891,
    ["Sigma Detection Rule"] = 678,
    ["Sigrid scope configuration file"] = 679,
    ["SkyPilot Task JSON"] = 976,
    ["Slack app manifest"] = 683,
    Solidarity = 688,
    ["Solution filters"] = 689,
    ["Source Maps v3"] = 690,
    Sourcery = 691,
    ["Speakeasy Generation Config File"] = 695,
    ["Speakeasy Lint Configuration File"] = 692,
    ["Speakeasy Test Generation Configuration File"] = 693,
    ["Speakeasy Workflow File"] = 694,
    SpecIF = 696,
    ["Sponge Mixin configuration"] = 697,
    StackBlitz = 703,
    ["StackHawk Scanner Configuration"] = 885,
    Stale = 704,
    ["Starlake Data Pipeline"] = 858,
    Starship = 705,
    ["Statamic Blueprint"] = 706,
    ["Stella configuration file"] = 707,
    ["Stryker Mutator"] = 710,
    ["StyleCop Analyzers Configuration"] = 711,
    ["Stylelint (.stylelintrc)"] = 712,
    ["Stylua Config"] = 1064,
    ["Sublime Syntax"] = 931,
    ["Subsquid squid manifest"] = 978,
    ["Swagger API 2.0"] = 714,
    ["Synadia Connect Component"] = 715,
    TSON = 749,
    TSTyche = 750,
    ["Tab data for a LinUtil"] = 1024,
    ["Tab list for a LinUtil"] = 1023,
    Tach = 716,
    ["Tach Domain"] = 717,
    Talhelper = 719,
    ["Talisman configuration"] = 720,
    Taplo = 1065,
    ["Taskfile config"] = 863,
    Taurus = 721,
    Tauticord = 722,
    Telefonistka = 1051,
    ["TestEnvironment.json"] = 732,
    ["TextMate Grammar"] = 731,
    ["Tier.run pricing.json"] = 725,
    Tikibase = 726,
    Tombi = 730,
    ["Traefik v2"] = 735,
    ["Traefik v2 File Provider"] = 736,
    ["Traefik v3"] = 737,
    ["Traefik v3 File Provider"] = 738,
    ["Travis CI (.travis.yml)"] = 734,
    Trident = 1048,
    ["TrueScript for *.tscript files"] = 741,
    ["Tugboat QA config.yml"] = 1045,
    TunnelHub = 966,
    Turborepo = 733,
    Tycho = 1013,
    Tye = 893,
    ["Tyk Gateway - Open Source v5.7+"] = 1056,
    ["Typst Manifest"] = 755,
    ["UET BuildConfig.json"] = 936,
    ["UI5 Manifest"] = 761,
    ["UNCORS configuration"] = 765,
    ["UTAM Page Object"] = 764,
    ["Ubuntu Server Autoinstall"] = 759,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1049,
    ["Uniswap Token List"] = 846,
    ["Universal Schedule Format"] = 766,
    ["Unreal Engine Uplugin"] = 937,
    ["Unreal Engine Uproject"] = 938,
    ["Updatecli Compose"] = 901,
    ["Updatecli Policy Manifest"] = 902,
    ["Updatecli Policy Metadata"] = 903,
    Uplift = 934,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 867,
    V2Ray = 907,
    ["VSCode Code Snippets"] = 199,
    ["VSIX CLI publishing"] = 786,
    Vector = 768,
    ["Vela Pipeline Configuration"] = 771,
    Vercel = 198,
    ["Version Bumper config"] = 776,
    ["Viash Component Config"] = 1053,
    ["Viash Package Config"] = 1054,
    Visivo = 964,
    Wake = 1047,
    ["Waku Config"] = 1027,
    ["Web App Manifest"] = 792,
    ["Web types"] = 795,
    WebExtensions = 791,
    ["Webman package recipe"] = 913,
    ["Windows Package Manager Installer Manifest"] = 842,
    ["Windows Package Manager Locale Manifest"] = 843,
    ["Windows Package Manager Singleton Manifest"] = 841,
    Winutil = 844,
    ["WireMock stub mapping"] = 1030,
    ["Woodpecker pipeline config"] = 881,
    ["Wrangler CLI"] = 796,
    ["Xstate Machine"] = 899,
    ["Yandex Workflow Language"] = 1019,
    ["Yarn Config (.yarnrc.yml)"] = 856,
    ["Yippee-Ki-JSON configuration YML"] = 848,
    ["YouTrack App"] = 1016,
    ["Zerops.io config"] = 1004,
    ["Zerops.io import"] = 1005,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 969,
    ...
    ["behat.yml"] = 103,
    ["bigquery-table"] = 93,
    ["bioimageio resource description"] = 986,
    ...
    ["crowdin.yml"] = 233,
    ["ctfd-setup configuration file"] = 1037,
    ["custom-elements.json"] = 956,
    ["cypress.json"] = 237,
    ...
    ["gematik health care insurance list"] = 1043,
    ["gematik health care patient list"] = 1040,
    ["gematik health care provider institution list"] = 1042,
    ["gematik health care provider list"] = 1041,
    ["gematik tiger test environment configuration"] = 1044,
    ["gitlab-ci"] = 339,
    ["global.json"] = 355,
    ...
    ["lint-staged (.lintstagedrc)"] = 812,
    ["local.settings.json"] = 457,
    ["localazy.json"] = 458,
    ["lotus.yaml"] = 456,
    ["lsdlschema.json"] = 459,
    ["markdown-link-check"] = 876,
    maturin = 877,
    mboats = 884,
    ["micro-settings.json"] = 948,
    ["mimetypes.json"] = 471,
    ["mirrord config"] = 813,
    mise = 814,
    ["mkdocs.yml"] = 491,
    ["monospace.yml"] = 494,
    ["moon.yml"] = 1029,
    ["mprocs Configuration file"] = 1001,
    ["mrdocs.yml"] = 492,
    ["mta.yaml"] = 815,
    ["mtad.yaml"] = 816,
    ["mycode.json"] = 501,
    ...
    ["plagiarize.yaml"] = 566,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1033,
    ["podbard.yaml"] = 569,
    ["portman.json"] = 570,
    ["prefect.toml"] = 578,
    ["prettierrc.json"] = 579,
    ...
    samt = 645,
    samtrc = 646,
    ["sarif-1.0.0.json"] = 648,
    ["sarif-2.0.0.json"] = 649,
    ["sarif-2.1.0"] = 659,
    ["sarif-2.1.0-rtm.2"] = 650,
    ["sarif-2.1.0-rtm.3"] = 652,
    ["sarif-2.1.0-rtm.4"] = 654,
    ["sarif-2.1.0-rtm.5"] = 656,
    ["sarif-2.1.0-rtm.6"] = 657,
    ["sarif-external-property-file-2.1.0"] = 660,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 651,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 653,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 655,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 658,
    ["scalingo.json configuration"] = 661,
    ["schema.org - Action"] = 663,
    ["schema.org - ContactPoint"] = 664,
    ["schema.org - Place"] = 665,
    ["schema.org - Thing"] = 666,
    ["secrethub.yml"] = 951,
    ["semantic-release"] = 672,
    ["servicehub.config.json"] = 807,
    ["servicehub.service.json"] = 806,
    ["settings.job"] = 675,
    ["sfdx-hardis configuration"] = 677,
    ["shard.yml"] = 989,
    ["size-limit configuration"] = 682,
    ["skaffold.yaml"] = 874,
    ["skyuxconfig.json"] = 684,
    snapcraft = 685,
    ["snowflake-config"] = 686,
    ["snowflake-connections"] = 687,
    ["spicepod.yaml"] = 1008,
    ["sqlc configuration"] = 700,
    ["stripe-app-local.json"] = 709,
    ["stripe-app.json"] = 708,
    swcrc = 859,
    ["task.json"] = 718,
    taskcat = 824,
    ["template.json"] = 723,
    ["templatsources.json"] = 724,
    ["theme.json"] = 727,
    ...
    ["vega-lite.json"] = 770,
    ["vega.json"] = 769,
    ["venvironment-basic.yaml"] = 773,
    ["venvironment.yaml"] = 772,
    ["venvplus-basic.yaml"] = 775,
    ["venvplus.yaml"] = 774,
    version = 1052,
    ["version.json"] = 777,
    ["vhwdebugger-binding.yaml"] = 779,
    ["vim-addon-info"] = 780,
    ["vs-2017.3.host.json"] = 782,
    ["vs-nesting.json"] = 783,
    ["vsls.json"] = 781,
    ["vss-extension.json"] = 787,
    vtcfg = 1058,
    ["vtesttree.yaml"] = 788,
    ["vtestunit.yaml"] = 789,
    ["warp-keysets.json"] = 957,
    ["warp-themes.json"] = 958,
    ["warp-workflows.json"] = 959,
    ["webhint.io"] = 914,
    ["webjobpublishsettings.json"] = 794,
    ["webjobs-list.json"] = 793,
    ["well-known-fursona"] = 996,
    ["xs-app.json"] = 819,
    ["xunit.runner.json"] = 805,
    yamllint = 847,
    zuul = 830,
    ["Žinoma"] = 840
  },
