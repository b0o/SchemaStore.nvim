...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 823,
    [".nodehawkrc"] = 514,
    [".npmpackagejsonlintrc"] = 518,
    [".omletrc"] = 999,
    [".phrase.yml"] = 580,
    [".phraseapp.yml"] = 581,
    [".pmbot.yml"] = 568,
    [".postcssrc"] = 575,
    [".powerpages-web-template-manifest"] = 577,
    [".pre-commit-config.yml"] = 578,
    [".pre-commit-hooks.yml"] = 579,
    [".putout.json"] = 608,
    [".rehyperc"] = 631,
    [".remarkrc"] = 635,
    [".sprite files"] = 703,
    ...
    ["A micro editor config"] = 466,
    ABCInventoryModuleData = 18,
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1043,
    ["API Builder"] = 858,
    ["AVA Configuration"] = 920,
    ["AWS AppConfig Feature Flags-v1"] = 49,
    ["AWS CDK cdk.json"] = 215,
    ["AWS CloudFormation"] = 216,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 217,
    ["AWS SAM CLI Samconfig"] = 218,
    ["Adobe UXP Manifest"] = 982,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1071,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 892,
    ["All Contributors configuration file"] = 945,
    ["Ansible Argument Specs"] = 348,
    ["Ansible Collection Galaxy"] = 355,
    ["Ansible Execution Environment"] = 345,
    ["Ansible Inventory"] = 354,
    ["Ansible Meta"] = 346,
    ["Ansible Meta Runtime"] = 347,
    ["Ansible Navigator Configuration"] = 357,
    ["Ansible Playbook"] = 352,
    ["Ansible Requirements"] = 349,
    ["Ansible Rulebook"] = 353,
    ["Ansible Tasks File"] = 351,
    ["Ansible Vars File"] = 350,
    ["Ansible-lint Configuration"] = 356,
    Any = 1008,
    ["AnyWork Automation Configuration"] = 9,
    ["App config Spotify Backstage"] = 25,
    ["Application Accelerator"] = 6,
    ["Application list for a WinUtil"] = 1025,
    ArchitectFX = 1030,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure Pipelines"] = 78,
    ["Azure Static Web Apps CLI configuration file"] = 707,
    ["Azure Static Web Apps configuration file"] = 706,
    ["BOSH CPI Config"] = 102,
    ["BOSH Deploy Config"] = 103,
    ["BX CI"] = 122,
    ["Bashly (bashly.yml)"] = 949,
    ["Bashly Settings (bashly-settings.yml)"] = 950,
    ["Better Code Hub"] = 862,
    ["Better Scripts"] = 123,
    Bigconfig = 95,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1036,
    BizTalkServerApplicationSchema = 830,
    Bleep = 124,
    ...
    ["Butane Config"] = 905,
    C4InterFlow = 1051,
    ["CDK Environment Manager, concrete environment configuration"] = 1074,
    ["CDK Environment Manager, concrete environments definition"] = 1073,
    ["CDK Environment Manager, environment definition"] = 1072,
    ["CGS Card Game Specification (cgs.json)"] = 987,
    ["CICS TS region tagging"] = 914,
    ["CICS TS resource import"] = 915,
    ["CICS TS resource model"] = 916,
    ["CICS TS resource overrides"] = 917,
    ["CMake Presets"] = 125,
    ["CNC Codes"] = 144,
    ["CRS WAF test file"] = 1015,
    ["CRS WAF test platform overrides file"] = 1016,
    ["CSS Comb (.csscomb.json)"] = 243,
    ["CSS Lint (.csslintrc)"] = 244,
    ["CSpell (cspell.json)"] = 242,
    ["CVE Record Format"] = 151,
    CWL = 993,
    ...
    ["Chamaleon environment"] = 1040,
    ["Chamaleon properties"] = 1041,
    ["Chamaleon template"] = 1039,
    Changesets = 227,
    Charmcraft = 134,
    Cheatsheets = 902,
    ["Chrome Extension"] = 208,
    ["Chromia Model"] = 135,
    ["Chromia Seeder Module Config"] = 137,
    ["Chromia Seeder Root Config"] = 136,
    ["Cinnamon Spice info.json"] = 70,
    ["CircleCI config.yml"] = 184,
    ["Citation File Format"] = 229,
    CityJSON = 139,
    ["Clawject config"] = 150,
    ["Cloud Foundry Application Manifest"] = 998,
    ["Cloud Run Spec v1"] = 1020,
    ["CloudCannon Configuration"] = 74,
    ["CloudEvents specification"] = 140,
    ["Code Climate"] = 185,
    CodeCV = 72,
    CodeRabbit = 71,
    ["CodeShip Pro services configuration files"] = 197,
    ["CodeShip Pro steps configuration files"] = 198,
    ["Codecov configuration files"] = 196,
    CodifyCLI = 73,
    Codux = 194,
    ["Cog config file"] = 145,
    ["Commandbox Box.json"] = 146,
    ["Commandbox Server.json"] = 147,
    ["Common Catalog Data"] = 206,
    ["Common Package Specification"] = 148,
    Concord = 1014,
    ["Configu .cfgu files"] = 1003,
    ["Configu .configu file"] = 1004,
    Conjure = 143,
    ["Container Structure Test"] = 844,
    Containerlab = 871,
    ["Contextive Glossary"] = 1066,
    Convex = 142,
    ["Crowdsec collection config"] = 237,
    ["Crowdsec parser config"] = 238,
    ["Crowdsec scenario config"] = 239,
    ["CumulusCI Config"] = 149,
    ["Custom Machinery Machine"] = 988,
    ["Custom Machinery Recipe"] = 989,
    ["Cycle Stack File"] = 152,
    CycloneDX = 153,
    ["DWP Exchange - catalogue entry"] = 286,
    ["DWP Exchange - gateway"] = 284,
    ["DWP Exchange - meta"] = 285,
    ["Dart Build Config (dart-build.json)"] = 245,
    ["Dart Test Config (dart-test.json)"] = 246,
    ["DashLord Configuration"] = 247,
    ["Data Contract Specification"] = 248,
    ["Data Product Specification"] = 249,
    ["DataYoga Connections"] = 154,
    ["DataYoga Job"] = 155,
    ["Databricks Asset Bundles"] = 966,
    ["Datadog Service Definition"] = 439,
    ["Datadog Software Catalog"] = 440,
    ["Datahub Ingestion Recipe"] = 921,
    ["Dein Config"] = 161,
    ["Deno Config (deno.json)"] = 255,
    ["Dependency cruiser"] = 162,
    ["DeployStack Configuration"] = 163,
    ["Deployer Recipe"] = 258,
    ["Deta Spacefile"] = 164,
    ["Detekt Config (detekt.yml)"] = 259,
    ["Devbox Config"] = 165,
    ["Devbox Plugin"] = 166,
    Devfile = 283,
    DipDup = 1017,
    ["Discord Webhook"] = 260,
    ["DocFx Config (docfx.json)"] = 264,
    Dofigen = 265,
    ["Dolittle Artifacts"] = 266,
    ["Dolittle Bounded Context Configuration"] = 267,
    ["Dolittle Event Horizons Configuration"] = 268,
    ["Dolittle Resources Configuration"] = 269,
    ["Dolittle Server Configuration"] = 270,
    ["Dolittle Tenant Map Configuration"] = 272,
    ["Dolittle Tenants Configuration"] = 271,
    ["Dolittle Topology"] = 273,
    ["DonateCaseBetterCasino menu"] = 1044,
    ["Drupal Breakpoints"] = 167,
    ["Drupal Config"] = 179,
    ["Drupal Info"] = 168,
    ["Drupal Layouts"] = 169,
    ["Drupal Libraries"] = 170,
    ["Drupal Links Action"] = 171,
    ["Drupal Links Contextual"] = 172,
    ["Drupal Links Menu"] = 173,
    ["Drupal Links Task"] = 174,
    ["Drupal Migration"] = 175,
    ["Drupal Permissions"] = 176,
    ["Drupal Recipe"] = 177,
    ["Drupal Routing"] = 178,
    ["Drupal Services"] = 180,
    ["Drush site aliases"] = 279,
    ["Dynamic Bash Aliases (.aliases)"] = 957,
    ["EAS config"] = 303,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 946,
    ["EasyVCR .NET"] = 304,
    ["Eidolon Resource"] = 1031,
    ["Elgato Stream Deck"] = 289,
    Elm = 1019,
    ["Embrace Config"] = 932,
    Endurica = 970,
    ["Enterprise Contract Policy Spec"] = 290,
    ["Erda Pipeline"] = 995,
    ["Erda Runtime"] = 996,
    Esquio = 292,
    ["Estuary Flow Catalog"] = 911,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 296,
    ["EveryVoice TTS Toolkit Data Configuration"] = 297,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 301,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 300,
    ["EveryVoice TTS Toolkit Text Configuration"] = 298,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 299,
    ["Expo SDK"] = 302,
    ["F-Droid Data metadata"] = 308,
    ["FasterCI Configuration"] = 79,
    FiQuS = 312,
    Firebase = 310,
    ["FlexGet Config"] = 313,
    ["Flow.json Configurations"] = 992,
    ["Fossa configuration file"] = 320,
    ["Fossa's fossa-deps file"] = 321,
    ["Foundry VTT - Base package Manifest"] = 315,
    ["Foundry VTT - Module Manifest"] = 316,
    ["Foundry VTT - System Data Template"] = 319,
    ["Foundry VTT - System Manifest"] = 317,
    ["Foundry VTT - World Manifest"] = 318,
    ["Foxx Manifest"] = 80,
    ["Freifunk.de Community API"] = 83,
    ["Frogbot Config"] = 84,
    ["G2P Mapping Configuration"] = 326,
    ["GCP Blueprint Metadata"] = 329,
    Gaspar = 327,
    ["GatewayCore API Gateway"] = 328,
    ["GeoJSON.json latest"] = 909,
    GherKing = 913,
    ["GitHub Action"] = 334,
    ["GitHub Actions typing"] = 1027,
    ["GitHub Discussion"] = 335,
    ["GitHub Funding"] = 336,
    ["GitHub Issue Template configuration"] = 337,
    ["GitHub Issue Template forms"] = 338,
    ["GitHub Workflow"] = 339,
    ["GitHub Workflow Template Properties"] = 340,
    ["GitHub automatically generated release notes configuration"] = 341,
    ["GitLab Agent for Kubernetes configuration"] = 984,
    GitVersion = 331,
    ["Gitea Issue Template configuration"] = 332,
    ["Gitea Issue Template forms"] = 333,
    ["Gitpod Automations"] = 343,
    ["Gitpod Configuration"] = 344,
    ["GlazeWM settings"] = 986,
    ["Global Privacy Control"] = 330,
    Goblet = 965,
    ["Golangci-lint Configuration"] = 359,
    ["Golangci-lint Custom Plugins Configuration"] = 360,
    ["Google Chrome Related Website Sets"] = 311,
    ["Google Cloud Workflows"] = 214,
    ["Google Digital Assetlinks"] = 1067,
    Goreleaser = 362,
    ["Goreleaser Pro"] = 363,
    Goss = 364,
    ["Gradle Build Cache Node"] = 860,
    ["Gradle Enterprise"] = 859,
    ["Grafana 5.x Dashboard"] = 365,
    ["GraphQL Code Generator"] = 369,
    ["GraphQL Config"] = 368,
    ["GraphQL Mesh"] = 367,
    ["Grunt JSHint task"] = 373,
    ["Grunt Watch task"] = 374,
    ["Grunt base task"] = 375,
    ["Grunt clean task"] = 371,
    ["Grunt copy task"] = 370,
    ["Grunt cssmin task"] = 372,
    HEMTT = 826,
    Hadolint = 840,
    Hammerkit = 870,
    ["Hardware Sentry Configuration"] = 925,
    Hatch = 841,
    Hayson = 377,
    ["Haystack Pipeline"] = 378,
    ["Hazelcast 5 Configuration"] = 379,
    ["Hecate Input Schema"] = 1078,
    ["Helm Chart.lock"] = 182,
    ["Helm Chart.yaml"] = 181,
    ["Helm Unittest Test Suite"] = 183,
    ["Home Assistant Integration Manifest"] = 380,
    ["Homer dashboard configuration"] = 381,
    Hugo = 901,
    ["Hugo Theme"] = 900,
    ["Hyperfoil benchmark configuration"] = 387,
    ["IBM Zapp document"] = 388,
    ["IBM zCodeFormatSettings"] = 389,
    ["IMG Catapult PSP"] = 394,
    ["IVMS101 by CODE Protocol"] = 985,
    Infrahub = 396,
    Istanbul = 928,
    ["JDownloader2 crawler multi-rules"] = 406,
    ["JDownloader2 crawler single-rules"] = 405,
    ["JFrog Applications Config"] = 407,
    ["JFrog File Spec"] = 408,
    ["JFrog Pipelines YML DSL"] = 934,
    ["JMeter DSL cli config"] = 409,
    JReleaser = 412,
    ["JSON Document Transform"] = 420,
    ["JSON Feed"] = 421,
    ["JSON Resume"] = 640,
    ["JSON Schema Draft 2020-12"] = 809,
    ["JSON Schema Draft 4"] = 806,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 967,
    ["JSON Schema Draft 7"] = 807,
    ["JSON Schema Draft 7 (unofficial strict)"] = 968,
    ["JSON Schema Draft 8 (2019-09)"] = 808,
    ["JSON-API"] = 419,
    ["JSON-e templates"] = 867,
    ["JSON-stat 2.0"] = 802,
    JSONPatch = 423,
    ["JSR Package Config (jsr.json)"] = 413,
    Jasmine = 400,
    Jekyll = 401,
    ["Jenkins X Pipelines"] = 402,
    ["Jenkins X Requirements"] = 403,
    Jest = 404,
    Jocker = 410,
    ["Jovo Language Models"] = 411,
    ["KIMMDY config file"] = 434,
    ["KODE/CI build.yaml"] = 930,
    ["KSP-AVC"] = 803,
    ["KSP-CKAN"] = 804,
    ["KSP-NetKAN"] = 805,
    KSY = 997,
    KSail = 324,
    ["Karakum configuration file"] = 322,
    Kas = 426,
    ["Kestra flow file"] = 435,
    ["Keycloak REST API"] = 937,
    ["Knative Functions - func.yaml"] = 323,
    ["Kometa (nightly) config file"] = 437,
    ["Kometa config file"] = 436,
    ["Kong DBLess config"] = 931,
    KrakenD = 438,
    ["Kubri Configuration"] = 444,
    LOOBin = 459,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 219,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 220,
    ["Landing Zone Accelerator on AWS - Global Config"] = 221,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 222,
    ["Landing Zone Accelerator on AWS - Network Config"] = 223,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 224,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 225,
    ["Landing Zone Accelerator on AWS - Security Config"] = 226,
    ["Language configuration"] = 1007,
    Lefthook = 448,
    ["Liferay client-extension.yaml"] = 455,
    ["LinkML Metamodel"] = 457,
    Liquibase = 876,
    ["Liquibase Flow File"] = 877,
    ["Lively Properties"] = 458,
    ["Lobe AI Agent"] = 76,
    Loki = 77,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 497,
    ["MS2Rescore Configuration"] = 500,
    ["Madness (madness.yml)"] = 948,
    ["MapEHR Mapping"] = 465,
    Markdownlint = 880,
    ["Mason Registry"] = 883,
    ["MegaLinter configuration"] = 467,
    ["MegaLinter descriptor"] = 468,
    Melange = 975,
    ["Meltano project definition"] = 469,
    ["Mergify Configuration"] = 501,
    ["Metadata for a Bazel module"] = 470,
    ["Metadata for a Cinnamon spice"] = 1023,
    ["Metatype Configuration"] = 471,
    ["MetricsHub Configuration"] = 472,
    ["MetricsHub Connector Configuration"] = 473,
    ["Micro Editor Syntax"] = 958,
    ["Microsoft Band Web Tile"] = 474,
    ["Microsoft RulesEngine workflow rules"] = 1011,
    ["Microsoft RulesEngine workflow rules list"] = 1012,
    ["Minecraft Custom Main Menu Mod"] = 976,
    ["Minecraft Data Pack Advancement"] = 476,
    ["Minecraft Data Pack Biome"] = 477,
    ["Minecraft Data Pack Configured Carver"] = 478,
    ["Minecraft Data Pack Damage Type"] = 479,
    ["Minecraft Data Pack Dimension"] = 481,
    ["Minecraft Data Pack Dimension Type"] = 480,
    ["Minecraft Data Pack Item Modifier"] = 482,
    ["Minecraft Data Pack Loot Table"] = 483,
    ["Minecraft Data Pack Metadata"] = 484,
    ["Minecraft Data Pack Predicate"] = 485,
    ["Minecraft Data Pack Recipe"] = 486,
    ["Minecraft Data Pack Tag"] = 487,
    ["Minecraft Data Pack Template Pool"] = 488,
    ["Minecraft Data Pack Trim Material"] = 493,
    ["Minecraft Data Pack Trim Pattern"] = 494,
    ["Minecraft Resource Pack Lang"] = 489,
    ["Minecraft Resource Pack Particle"] = 490,
    ["Minecraft Resource Pack Texture Mcmeta"] = 492,
    ["Minecraft Resourcepack Sounds"] = 491,
    ["Monade CLI Stack Configuration"] = 504,
    ["MongoDB Atlas Search Index Definition"] = 929,
    ["Monika Configuration"] = 927,
    ["Monoweave Configuration"] = 499,
    ["Motif config"] = 822,
    MultiQC = 1060,
    ["NOX Framework (Service)"] = 517,
    ["Netin Diagnostic System Template"] = 887,
    ["Netlify config"] = 507,
    ["Network-as-Code Data Model"] = 508,
    ["Nightwatch.js"] = 510,
    ["Node.js configuration"] = 827,
    ["NueJS configuration file"] = 522,
    ["Nuitka.yaml"] = 990,
    ["Nullstone config"] = 524,
    ["ONe's changelog entry"] = 538,
    ["ONe's service descriptor"] = 537,
    ["ORT Server repository environment configuration"] = 545,
    ["OSCAL Assessment Plan (AP)"] = 547,
    ["OSCAL Assessment Results (AR)"] = 548,
    ["OSCAL Catalog"] = 549,
    ["OSCAL Component Definition (CDef)"] = 550,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 551,
    ["OSCAL Profile"] = 552,
    ["OSCAL System Security Plan (SSP)"] = 553,
    ["OSS Review Toolkit configuration"] = 554,
    ["OSS Review Toolkit curation"] = 555,
    ["OSS Review Toolkit package configuration"] = 556,
    ["OSS Review Toolkit repository configuration"] = 557,
    ["OSS Review Toolkit resolutions"] = 558,
    ["October CMS columns"] = 528,
    ["October CMS fields"] = 529,
    Okteto = 530,
    Opctl = 825,
    ["Open Data Contract Standard (ODCS)"] = 541,
    ["Open Know-How"] = 1065,
    ["OpenRewrite Resource"] = 540,
    OpenStatus = 1076,
    ["OpenUtau character yaml"] = 534,
    ["OpenUtau ustx"] = 535,
    ["OpenWeather Current Weather API"] = 866,
    ["OpenWeather Road Risk API"] = 865,
    ["Ory Hydra configuration"] = 386,
    ["Ory Keto configuration"] = 441,
    ["Ory Kratos configuration"] = 546,
    ["Ory Oathkeeper configuration"] = 526,
    ["Outblocks App configuration"] = 543,
    ["Outblocks database table"] = 544,
    ["Outblocks project configuration"] = 542,
    PDM = 564,
    Packer = 561,
    Pantsbuild = 944,
    ["Paper paper-plugin.yml"] = 562,
    ["Pipeline component"] = 878,
    ["Platform.sh application"] = 2,
    ["Platform.sh routes"] = 3,
    ["Platform.sh services"] = 4,
    ["Plex Prerolls"] = 572,
    ["PocketMine plugin.yml"] = 569,
    ["Postman collection"] = 576,
    ["Power Pages Configuration"] = 1077,
    ["Preset list for a WinUtil"] = 1026,
    ["ProActions AI-Kit Configuration"] = 585,
    ["ProActions AI-Kit Configuration for Menus"] = 587,
    ["ProActions AI-Kit Configuration for Sections"] = 589,
    ["ProActions AI-Kit Configuration for Services"] = 586,
    ["ProActions AI-Kit Configuration for Steps"] = 590,
    ["ProActions AI-Kit Configuration for Templates"] = 588,
    ["Problem object RFC9457"] = 973,
    ["Problem package generators"] = 591,
    Pterodactyl = 924,
    ["Pull Request Labeler"] = 607,
    Pulumi = 615,
    ["PyGTA Config"] = 611,
    PyProject = 616,
    Pylock = 1068,
    Pyright = 617,
    ["Python script metadata"] = 1062,
    Qgoda = 619,
    Qodana = 897,
    ["Qt Creator workspace file"] = 1005,
    ["Quali Torque Blueprint Spec 2"] = 922,
    ["QueryFirst config file"] = 940,
    ["RKE Cluster Configuration JSON"] = 875,
    ["RKE Cluster Configuration YAML"] = 874,
    RadioHound = 610,
    Railway = 620,
    ["Rancher Fleet"] = 612,
    ["Rattler-build"] = 621,
    Ray = 839,
    ["Read the Docs"] = 614,
    ["Red-DiscordBot Cog"] = 628,
    ["Red-DiscordBot Cog Repo"] = 629,
    ["Red-DiscordBot Trivia"] = 630,
    ["Render Blueprints"] = 873,
    RenderCV = 642,
    Renovate = 641,
    ["Replit config"] = 636,
    Restate = 1055,
    RoadRunner = 644,
    ["Roo Coder Custom Modes"] = 646,
    ["Rudder techniques"] = 980,
    Ruff = 638,
    ["Rust Project"] = 639,
    ["Rust toolchain"] = 649,
    ["SDMX data message"] = 675,
    ["SDMX metadata message"] = 674,
    ["SDMX structure message"] = 673,
    ["SIL Kit Participant Configuration"] = 685,
    ["SIL Kit Registry Configuration"] = 686,
    ["SPDX 2.3"] = 704,
    SWADL = 718,
    ["Safebox Config"] = 935,
    ["Sapphire CLI Config"] = 652,
    ["SauceCTL Configuration"] = 884,
    ["Schema Catalog"] = 667,
    ["Scoop manifest"] = 672,
    ["Semantic Data Fabric (SDF) file"] = 676,
    ["Semgrep Rule"] = 678,
    ["Serenity Code Generator (Sergen)"] = 679,
    ["Serverless Framework Configuration"] = 891,
    ["Serverless Workflow"] = 893,
    ["Settings for a Cinnamon spice"] = 1022,
    ["Settings.paf"] = 681,
    ["Shopware 6 Configuration"] = 894,
    ["Shopware CLI Extension Store Configuration"] = 895,
    ["Shopware CLI Project Store Configuration"] = 896,
    ["Sigma Detection Rule"] = 683,
    ["Sigrid scope configuration file"] = 684,
    ["SkyPilot Task JSON"] = 981,
    ["Slack app manifest"] = 688,
    Solidarity = 693,
    ["Solution filters"] = 694,
    ["Source Maps v3"] = 695,
    Sourcery = 696,
    ["Speakeasy Generation Config File"] = 700,
    ["Speakeasy Lint Configuration File"] = 697,
    ["Speakeasy Test Generation Configuration File"] = 698,
    ["Speakeasy Workflow File"] = 699,
    SpecIF = 701,
    ["Sponge Mixin configuration"] = 702,
    StackBlitz = 708,
    ["StackHawk Scanner Configuration"] = 890,
    Stale = 709,
    ["Starlake Data Pipeline"] = 863,
    Starship = 710,
    ["Statamic Blueprint"] = 711,
    ["Stella configuration file"] = 712,
    ["Stryker Mutator"] = 715,
    ["StyleCop Analyzers Configuration"] = 716,
    ["Stylelint (.stylelintrc)"] = 717,
    ["Stylua Config"] = 1069,
    ["Sublime Syntax"] = 936,
    ["Subsquid squid manifest"] = 983,
    ["Swagger API 2.0"] = 719,
    ["Synadia Connect Component"] = 720,
    TSON = 754,
    TSTyche = 755,
    ["Tab data for a LinUtil"] = 1029,
    ["Tab list for a LinUtil"] = 1028,
    Tach = 721,
    ["Tach Domain"] = 722,
    Talhelper = 724,
    ["Talisman configuration"] = 725,
    Taplo = 1070,
    ["Taskfile config"] = 868,
    Taurus = 726,
    Tauticord = 727,
    Telefonistka = 1056,
    ["TestEnvironment.json"] = 737,
    ["TextMate Grammar"] = 736,
    ["Tier.run pricing.json"] = 730,
    Tikibase = 731,
    Tombi = 735,
    ["Traefik v2"] = 740,
    ["Traefik v2 File Provider"] = 741,
    ["Traefik v3"] = 742,
    ["Traefik v3 File Provider"] = 743,
    ["Travis CI (.travis.yml)"] = 739,
    Trident = 1053,
    ["TrueScript for *.tscript files"] = 746,
    ["Tugboat QA config.yml"] = 1050,
    TunnelHub = 971,
    Turborepo = 738,
    Tycho = 1018,
    Tye = 898,
    ["Tyk Gateway - Open Source v5.7+"] = 1061,
    ["Typst Manifest"] = 760,
    ["UET BuildConfig.json"] = 941,
    ["UI5 Manifest"] = 766,
    ["UNCORS configuration"] = 770,
    ["UTAM Page Object"] = 769,
    ["Ubuntu Server Autoinstall"] = 764,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1054,
    ["Uniswap Token List"] = 851,
    ["Universal Schedule Format"] = 771,
    ["Unreal Engine Uplugin"] = 942,
    ["Unreal Engine Uproject"] = 943,
    ["Updatecli Compose"] = 906,
    ["Updatecli Policy Manifest"] = 907,
    ["Updatecli Policy Metadata"] = 908,
    Uplift = 939,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 872,
    V2Ray = 912,
    ["VSCode Code Snippets"] = 202,
    ["VSIX CLI publishing"] = 791,
    Vector = 773,
    ["Vela Pipeline Configuration"] = 776,
    Vercel = 201,
    ["Version Bumper config"] = 781,
    ["Viash Component Config"] = 1058,
    ["Viash Package Config"] = 1059,
    Visivo = 969,
    Wake = 1052,
    ["Waku Config"] = 1032,
    ["Web App Manifest"] = 797,
    ["Web types"] = 800,
    WebExtensions = 796,
    ["Webman package recipe"] = 918,
    ["Windows Package Manager Installer Manifest"] = 847,
    ["Windows Package Manager Locale Manifest"] = 848,
    ["Windows Package Manager Singleton Manifest"] = 846,
    Winutil = 849,
    ["WireMock stub mapping"] = 1035,
    ["Woodpecker pipeline config"] = 886,
    ["Wrangler CLI"] = 801,
    ["Xstate Machine"] = 904,
    ["Yandex Workflow Language"] = 1024,
    ["Yarn Config (.yarnrc.yml)"] = 861,
    ["Yippee-Ki-JSON configuration YML"] = 853,
    ["YouTrack App"] = 1021,
    ["Zerops.io config"] = 1009,
    ["Zerops.io import"] = 1010,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 974,
    ...
    ["behat.yml"] = 105,
    ["bigquery-table"] = 94,
    ["bioimageio resource description"] = 991,
    ...
    ["ccmod.json"] = 1033,
    changelogging = 1002,
    ["chisel-slices.json"] = 228,
    ["chrome-extension-locales-messages.json"] = 209,
    ["chutzpah.json"] = 210,
    cibuildwheel = 138,
    ["clang-format (.clang-format)"] = 910,
    ["clang-tidy"] = 189,
    clangd = 188,
    clib = 190,
    ["cloud-init: cloud-config userdata"] = 192,
    ["cloud-sdk-pipeline-configuration"] = 212,
    ["cloudbuild.json"] = 213,
    cloudify = 191,
    codemagic = 193,
    ["coffeelint.json"] = 230,
    ["commands.json"] = 205,
    ["commitlint (.commitlintrc)"] = 850,
    ["committed.toml"] = 231,
    ["compile_commands.json"] = 204,
    ["compilerconfig.json"] = 203,
    ["completely.yml"] = 947,
    ["component-detection-manifest.json"] = 234,
    ["component.json"] = 233,
    ["composer.json"] = 232,
    ["conda-forge"] = 141,
    ["config.yaml"] = 613,
    ["contentmanifest.json"] = 211,
    ["contribute.json"] = 235,
    ["cosmos.config.json"] = 207,
    ["crowdin.yml"] = 236,
    ["ctfd-setup configuration file"] = 1042,
    ["custom-elements.json"] = 961,
    ["cypress.json"] = 240,
    ["datalogic-scan2deploy-android"] = 250,
    ["datalogic-scan2deploy-ce"] = 251,
    ["dbt Dependencies"] = 156,
    ["dbt Packages"] = 158,
    ["dbt Project"] = 157,
    ["dbt Selectors"] = 159,
    ["dbt YAML files"] = 160,
    ["ddev-global"] = 252,
    ["ddev-project"] = 253,
    ["debugsettings.json"] = 254,
    ["dependabot-v2.json"] = 257,
    ["dependabot.json"] = 256,
    ["deployed-cli"] = 903,
    ["devcontainer.json"] = 195,
    devinit = 855,
    ["devspace.yaml"] = 926,
    djlint = 856,
    ["docker bake"] = 262,
    ["docker sequencer"] = 263,
    ["docker-compose.yml"] = 854,
    ["dockerd.json"] = 261,
    ["dotnet Release Index manifest"] = 274,
    ["dotnet-tools.json"] = 275,
    ["dotnetcli.host.json"] = 276,
    ["dprint.json"] = 277,
    ["drone.json"] = 278,
    ["dss-2.0.0.json"] = 280,
    ["dstack configuration"] = 281,
    ["dtool dataset metadata"] = 1037,
    ["dvc.yaml"] = 282,
    ["ecosystem.json"] = 287,
    eksctl = 288,
    ["electron-builder configuration file"] = 294,
    ["epr-manifest.json"] = 293,
    ["evcc.yaml"] = 295,
    ["ezd task runner"] = 305,
    ["fabric.mod.json"] = 307,
    ["first-timers-bot"] = 314,
    ["flagd flag configuration"] = 81,
    ["fly.io Configuration"] = 82,
    fulibWorkflows = 885,
    ["function.json"] = 325,
    ["gRPC API Gateway & OpenAPI Config"] = 7,
    ["gematik health care insurance list"] = 1048,
    ["gematik health care patient list"] = 1045,
    ["gematik health care provider institution list"] = 1047,
    ["gematik health care provider list"] = 1046,
    ["gematik tiger test environment configuration"] = 1049,
    ["gitlab-ci"] = 342,
    ["global.json"] = 358,
    ["go-feature-flag Flag Configuration"] = 361,
    ["haxelib.json"] = 376,
    helmfile = 842,
    helmwave = 843,
    ["host-meta.json"] = 383,
    ...
    ["ide.host.json"] = 390,
    ["ifstate.conf"] = 391,
    ["imageoptimizer.json"] = 392,
    ["importmap.json"] = 395,
    ["ioBroker Configuration"] = 397,
    ["ioBroker JSON UI"] = 398,
    ["ioBroker Package manifest"] = 399,
    ["ize.toml"] = 938,
    ["jsconfig.json"] = 424,
    ["jscpd Configuration"] = 923,
    jsdoc = 838,
    ["k3d.yaml"] = 425,
    ["k9s aliases.yaml"] = 427,
    ["k9s cluster-config.yaml"] = 429,
    ["k9s config.yaml"] = 428,
    ["k9s hotkeys.yaml"] = 430,
    ["k9s plugins.yaml"] = 431,
    ["k9s skin.yaml"] = 432,
    ["k9s views.yaml"] = 433,
    ["kontinuous-config.yaml"] = 443,
    ["kontinuous-values.yaml"] = 442,
    ["kustomization.yaml"] = 445,
    ["label-commenter-config.yml"] = 446,
    ["latexindent configuration"] = 75,
    ["launchsettings.json"] = 447,
    lazydocker = 960,
    lazygit = 959,
    ["lego.json"] = 449,
    ["lerna.json"] = 450,
    ["lgtm.yml"] = 451,
    ["liblab.config.json"] = 452,
    ["libman.json"] = 453,
    ["license-report-config.json"] = 454,
    ["linkinator.config.json"] = 456,
    ["lint-staged (.lintstagedrc)"] = 817,
    ["local.settings.json"] = 461,
    ["localazy.json"] = 462,
    ["lotus.yaml"] = 460,
    ["lsdlschema.json"] = 463,
    ["markdown-link-check"] = 881,
    maturin = 882,
    mboats = 889,
    ["micro-settings.json"] = 953,
    ["mimetypes.json"] = 475,
    ["mirrord config"] = 818,
    mise = 819,
    ["mkdocs.yml"] = 495,
    ["monospace.yml"] = 498,
    ["moon.yml"] = 1034,
    ["mprocs Configuration file"] = 1006,
    ["mrdocs.yml"] = 496,
    ["mta.yaml"] = 820,
    ["mtad.yaml"] = 821,
    ["mycode.json"] = 505,
    nFPM = 509,
    ["napari plugin manifest"] = 506,
    neoload = 833,
    ["nest-cli"] = 512,
    ["ninjs (News in JSON)"] = 511,
    ["nitro.json"] = 832,
    ["nixd configuration"] = 979,
    ["nlu.json"] = 513,
    ["nodemon.json"] = 515,
    ["noodl config"] = 888,
    ["notebook.mod.json"] = 516,
    now = 828,
    ["npm-badges"] = 519,
    ["nswag.json"] = 523,
    ntangle = 525,
    ["nuclei-template.yaml"] = 520,
    ["nuget-project.json"] = 521,
    ["ocelot.json"] = 527,
    ["omnisharp.json"] = 531,
    ["openapi.json"] = 532,
    ["openfin.json"] = 539,
    ...
    ["ops.yaml"] = 536,
    ["package.json"] = 559,
    ["package.manifest"] = 560,
    ["partial-black.json"] = 106,
    ["pathfinder.yml"] = 563,
    ["pattern.json"] = 566,
    ["petstore-v1.0"] = 933,
    pgap_yaml_input_reader = 565,
    ["pixi.toml"] = 567,
    ["plagiarize-me.yaml"] = 571,
    ["plagiarize.yaml"] = 570,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1038,
    ["podbard.yaml"] = 573,
    ["portman.json"] = 574,
    ["prefect.toml"] = 582,
    ["prettierrc.json"] = 583,
    ["prisma.yml"] = 584,
    ["project-1.0.0-beta3.json"] = 593,
    ["project-1.0.0-beta4.json"] = 594,
    ["project-1.0.0-beta5.json"] = 595,
    ["project-1.0.0-beta6.json"] = 596,
    ["project-1.0.0-beta8.json"] = 597,
    ["project-1.0.0-rc1.json"] = 598,
    ["project-1.0.0-rc2.json"] = 599,
    ["project.json"] = 592,
    ["project.owasp.yaml"] = 600,
    ["prometheus.json"] = 601,
    ["prometheus.rules.json"] = 602,
    ["prometheus.rules.test.json"] = 603,
    ["proxies.json"] = 604,
    ["publiccode.yml"] = 605,
    ["pubspec.yaml"] = 606,
    ["pyrseas-0.8.json"] = 609,
    pytest = 618,
    ["quilt.mod.json"] = 954,
    ["rc3 auth"] = 622,
    ["rc3 collection"] = 623,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 834,
    ["release-please-config.json"] = 632,
    ["release-please-manifest.json"] = 633,
    ["release-plz.toml"] = 634,
    ["renv.lock"] = 643,
    ["rivet.json"] = 978,
    ["rivet.yaml (legacy)"] = 977,
    rockcraft = 645,
    runny = 647,
    rustfmt = 648,
    sake = 1064,
    samt = 650,
    samtrc = 651,
    ["sarif-1.0.0.json"] = 653,
    ["sarif-2.0.0.json"] = 654,
    ["sarif-2.1.0"] = 664,
    ["sarif-2.1.0-rtm.2"] = 655,
    ["sarif-2.1.0-rtm.3"] = 657,
    ["sarif-2.1.0-rtm.4"] = 659,
    ["sarif-2.1.0-rtm.5"] = 661,
    ["sarif-2.1.0-rtm.6"] = 662,
    ["sarif-external-property-file-2.1.0"] = 665,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 656,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 658,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 660,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 663,
    ["scalingo.json configuration"] = 666,
    ["schema.org - Action"] = 668,
    ["schema.org - ContactPoint"] = 669,
    ["schema.org - Place"] = 670,
    ["schema.org - Thing"] = 671,
    ["secrethub.yml"] = 956,
    ["semantic-release"] = 677,
    ["servicehub.config.json"] = 812,
    ["servicehub.service.json"] = 811,
    ["settings.job"] = 680,
    ["sfdx-hardis configuration"] = 682,
    ["shard.yml"] = 994,
    ["size-limit configuration"] = 687,
    ["skaffold.yaml"] = 879,
    ["skyuxconfig.json"] = 689,
    snapcraft = 690,
    ["snowflake-config"] = 691,
    ["snowflake-connections"] = 692,
    ["spicepod.yaml"] = 1013,
    ["sqlc configuration"] = 705,
    ["stripe-app-local.json"] = 714,
    ["stripe-app.json"] = 713,
    swcrc = 864,
    ["task.json"] = 723,
    taskcat = 829,
    ["template.json"] = 728,
    ["templatsources.json"] = 729,
    ["theme.json"] = 732,
    ["tizen_workspace.json"] = 733,
    tldr = 734,
    ["tm_devices configuration file"] = 1075,
    tmuxinator = 815,
    ["transcend.yml"] = 744,
    ["tree-sitter grammar.json"] = 366,
    ["trime.yaml"] = 745,
    ["trunk.yaml"] = 747,
    ["ts-force-config.json"] = 752,
    ["tsconfig.json"] = 748,
    ["tsd.json"] = 749,
    ["tsdoc.json"] = 750,
    ["tsdrc.json"] = 751,
    ...
    v8r = 795,
    vcluster = 1000,
    ["vcpkg configuration file"] = 200,
    ["vcpkg manifest file"] = 199,
    ["vega-lite.json"] = 775,
    ["vega.json"] = 774,
    ["venvironment-basic.yaml"] = 778,
    ["venvironment.yaml"] = 777,
    ["venvplus-basic.yaml"] = 780,
    ["venvplus.yaml"] = 779,
    version = 1057,
    ["version.json"] = 782,
    ["vhwdebugger-binding.yaml"] = 784,
    ["vim-addon-info"] = 785,
    ["vs-2017.3.host.json"] = 787,
    ["vs-nesting.json"] = 788,
    ["vsls.json"] = 786,
    ["vss-extension.json"] = 792,
    vtcfg = 1063,
    ["vtesttree.yaml"] = 793,
    ["vtestunit.yaml"] = 794,
    ["warp-keysets.json"] = 962,
    ["warp-themes.json"] = 963,
    ["warp-workflows.json"] = 964,
    ["webhint.io"] = 919,
    ["webjobpublishsettings.json"] = 799,
    ["webjobs-list.json"] = 798,
    ["well-known-fursona"] = 1001,
    ["xs-app.json"] = 824,
    ["xunit.runner.json"] = 810,
    yamllint = 852,
    zuul = 835,
    ["Žinoma"] = 845
  },
