...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 167,
    [".cryproj (generic)"] = 582,
    [".cryproj engine-5.2"] = 577,
    [".cryproj engine-5.3"] = 578,
    [".cryproj engine-5.4"] = 579,
    [".cryproj engine-5.5"] = 580,
    [".cryproj engine-dev"] = 581,
    [".csscomb.json"] = 169,
    [".csslintrc"] = 170,
    [".es6importsorterrc.json"] = 709,
    [".eslintrc"] = 218,
    [".esmrc.json"] = 210,
    [".ffizer.yaml"] = 222,
    [".htmlhintrc"] = 271,
    ...
    [".mtaext"] = 591,
    [".nodehawkrc"] = 367,
    [".npmpackagejsonlintrc"] = 370,
    [".phraseapp.yml"] = 411,
    [".pmbot.yml"] = 401,
    [".postcssrc"] = 406,
    [".powerpages-web-template-manifest"] = 408,
    [".pre-commit-config.yml"] = 409,
    [".pre-commit-hooks.yml"] = 410,
    [".putout.json"] = 430,
    [".rehyperc"] = 442,
    [".remarkrc"] = 443,
    [".sprite files"] = 496,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration Schema"] = 654,
    ["All Contributors configuration file"] = 708,
    ...
    ["Azure Pipelines"] = 54,
    ["Azure Static Web Apps CLI configuration file"] = 499,
    ["Azure Static Web Apps configuration file"] = 498,
    ["BX CI"] = 89,
    ["Better Code Hub"] = 627,
    ["Better Scripts"] = 90,
    BizTalkServerApplicationSchema = 597,
    ...
    ["Butane Config"] = 666,
    ["CICS TS region tagging"] = 673,
    ["CICS TS resource import"] = 674,
    ["CICS TS resource model"] = 675,
    ["CICS TS resource overrides"] = 676,
    ["CMake Presets"] = 91,
    ...
    ["Datahub Ingestion Recipe Schema"] = 680,
    ...
    ["Embrace Config Schema"] = 691,
    ["Error pages"] = 213,
    Esquio = 211,
    ["Estuary Flow Catalog Schema"] = 670,
    ["Expo SDK"] = 216,
    ...
    ["Frogbot Config"] = 60,
    ["G2P Mapping Configuration"] = 235,
    ["GCP Blueprint Metadata"] = 237,
    ["GatewayCore API Gateway"] = 236,
    ["GeoJSON.json latest"] = 668,
    GherKing = 672,
    ["GitHub Action"] = 241,
    ["GitHub Discussion"] = 242,
    ["GitHub Funding"] = 243,
    ["GitHub Issue Template configuration"] = 245,
    ["GitHub Workflow"] = 246,
    ["GitHub Workflow Template Properties"] = 247,
    ["GitHub issue forms"] = 244,
    GitVersion = 240,
    ["Gitpod Configuration"] = 249,
    ["Global Privacy Control"] = 238,
    ["Google Cloud Workflows"] = 150,
    Goreleaser = 252,
    ["Goreleaser Pro"] = 253,
    Goss = 254,
    ["Gradle Build Cache Node"] = 624,
    ["Gradle Enterprise"] = 623,
    ["Grafana 5.x Dashboard"] = 255,
    ["GraphQL Code Generator"] = 258,
    ["GraphQL Config"] = 257,
    ["GraphQL Mesh"] = 256,
    ["Grunt JSHint task"] = 262,
    ["Grunt Watch task"] = 263,
    ["Grunt base task"] = 264,
    ["Grunt clean task"] = 260,
    ["Grunt copy task"] = 259,
    ["Grunt cssmin task"] = 261,
    HEMTT = 594,
    Hadolint = 606,
    Hammerkit = 634,
    ["Hardware Sentry Configuration"] = 684,
    Hayson = 266,
    ["Haystack Pipeline"] = 267,
    ["Hazelcast 5 Configuration"] = 268,
    ["Helm Chart.lock"] = 121,
    ["Helm Chart.yaml"] = 120,
    ...
    ["JSON-API"] = 299,
    ["JSON-e templates"] = 632,
    ["JSON-stat 2.0"] = 567,
    JSONPatch = 303,
    Jasmine = 284,
    Jekyll = 285,
    ["Jenkins X Pipelines"] = 286,
    ["Jenkins X Requirements"] = 287,
    ["Jovo Language Models"] = 292,
    ["KSP-AVC"] = 568,
    ["KSP-CKAN"] = 569,
    ["Karakum configuration file"] = 232,
    Kas = 306,
    ["Keycloak REST API"] = 700,
    ["Knative Functions - func.yaml"] = 233,
    ["KoDE/CI build.yaml"] = 689,
    ["Kong DBLess Schema"] = 690,
    KrakenD = 307,
    LOOBin = 324,
    Lefthook = 315,
    ["LinkML Metamodel"] = 322,
    Liquibase = 639,
    ["Liquibase Flow File"] = 640,
    ["Lively Properties"] = 323,
    Markdownlint = 643,
    ["Mason Registry"] = 645,
    ["MegaLinter configuration"] = 330,
    ["MegaLinter descriptor"] = 331,
    ["Meltano plugin discovery definition"] = 333,
    ["Meltano project definition"] = 332,
    ["Microsoft Band Web Tile"] = 334,
    ["Minecraft Data Pack Advancement"] = 336,
    ["Minecraft Data Pack Biome"] = 337,
    ["Minecraft Data Pack Configured Carver"] = 338,
    ["Minecraft Data Pack Damage Type"] = 339,
    ["Minecraft Data Pack Dimension"] = 341,
    ["Minecraft Data Pack Dimension Type"] = 340,
    ["Minecraft Data Pack Item Modifier"] = 342,
    ["Minecraft Data Pack Loot Table"] = 343,
    ["Minecraft Data Pack Metadata"] = 344,
    ["Minecraft Data Pack Predicate"] = 345,
    ["Minecraft Data Pack Recipe"] = 346,
    ["Minecraft Data Pack Tag"] = 347,
    ["Minecraft Data Pack Template Pool"] = 348,
    ["Minecraft Data Pack Trim Material"] = 353,
    ["Minecraft Data Pack Trim Pattern"] = 354,
    ["Minecraft Resource Pack Lang"] = 349,
    ["Minecraft Resource Pack Particle"] = 350,
    ["Minecraft Resource Pack Texture Mcmeta"] = 352,
    ["Minecraft Resourcepack Sounds"] = 351,
    ["MkDocs Configuration 1.0"] = 355,
    ["MongoDB Atlas Search Index Definition Schema"] = 688,
    ["Monika Configuration Schema"] = 686,
    ["Motif config"] = 590,
    ["NOX Framework (Service)"] = 369,
    ["Netin Diagnostic System Template"] = 649,
    ["Netlify config schema"] = 360,
    ["Nexus-as-Code schema"] = 361,
    ["Nightwatch.js"] = 362,
    ["ONe's service descriptor"] = 382,
    ["OSS Review Toolkit configuration"] = 389,
    ["OSS Review Toolkit curation"] = 390,
    ["OSS Review Toolkit package configuration"] = 391,
    ["OSS Review Toolkit repository configuration"] = 392,
    ["OSS Review Toolkit resolutions"] = 393,
    Opctl = 593,
    ["OpenRewrite Resource"] = 384,
    ["OpenWeather Current Weather API"] = 631,
    ["OpenWeather Road Risk API"] = 630,
    ["Ory Hydra configuration"] = 272,
    ["Ory Keto configuration"] = 309,
    ["Ory Kratos configuration"] = 388,
    ["Ory Oathkeeper configuration"] = 376,
    ["Outblocks App configuration"] = 386,
    ["Outblocks database table"] = 387,
    ["Outblocks project configuration"] = 385,
    Packer = 396,
    Pantsbuild = 707,
    ["Paper paper-plugin.yml"] = 397,
    ["Pipeline component"] = 641,
    ["PocketMine plugin.yml"] = 402,
    ["Postman collection"] = 407,
    ["Problem package generators"] = 414,
    Pterodactyl = 683,
    ["Pull Request Labeler"] = 429,
    Pulumi = 435,
    PyProject = 436,
    Pyright = 437,
    Qgoda = 438,
    Qodana = 659,
    ["Quali Torque Blueprint Spec 2"] = 681,
    ["QueryFirst config file"] = 703,
    ["RKE Cluster Configuration JSON Schema"] = 638,
    ["RKE Cluster Configuration YAML Schema"] = 637,
    ["Rancher Fleet"] = 432,
    Ray = 605,
    ["Read the Docs"] = 434,
    ["Red-DiscordBot Cog"] = 439,
    ...
    SWADL = 508,
    ["Safebox Config Schema"] = 694,
    ["Sapphire CLI Config"] = 456,
    ["SauceCTL Configuration"] = 646,
    ["Schema Catalog"] = 470,
    ["Scoop manifest"] = 475,
    ["Semantic Data Fabric (SDF) file"] = 476,
    ["Semgrep Rule"] = 478,
    ["Serenity Code Generator (Sergen)"] = 479,
    ["Serverless Framework Configuration"] = 653,
    ["Serverless Workflow Schema"] = 655,
    ["Settings.paf"] = 481,
    ["Shopware 6 Configuration"] = 656,
    ["Shopware CLI Extension Store Configuration"] = 657,
    ["Shopware CLI Project Store Configuration"] = 658,
    ["Sigrid scope configuration file"] = 483,
    ["Slack app manifest"] = 487,
    Solidarity = 490,
    ["Solution filters"] = 491,
    ["Source Maps v3"] = 492,
    Sourcery = 493,
    SpecIF = 494,
    ["Sponge Mixin configuration"] = 495,
    ["StackHawk Scanner Configuration"] = 652,
    Stale = 500,
    Starship = 501,
    ["Statamic Blueprint"] = 502,
    ["StrmPrivacy Data Connector"] = 698,
    ["StrmPrivacy Data Contract"] = 699,
    ["StrmPrivacy SimpleSchema"] = 696,
    ["StrmPrivacy Stream"] = 697,
    ["StrmPrivacy batch job configuration file"] = 695,
    ["Stryker Mutator"] = 505,
    ["StyleCop Analyzers Configuration"] = 506,
    ["Swagger API 2.0"] = 509,
    TSON = 533,
    ["Talisman configuration"] = 511,
    ["Taskfile YAML Schema"] = 633,
    Taurus = 512,
    ["TestEnvironment.json"] = 521,
    ["Tier.run pricing.json"] = 515,
    Tikibase = 516,
    ["Traefik v2"] = 524,
    ["Traefik v2 File Provider"] = 525,
    Turborepo = 522,
    Tye = 660,
    ["UET BuildConfig.json"] = 704,
    ["UI5 Manifest"] = 540,
    ["UTAM Page Object"] = 543,
    ["Ubuntu Server Autoinstall"] = 538,
    ["Uniswap Token List"] = 615,
    ["Unreal Engine Uplugin"] = 705,
    ["Unreal Engine Uproject"] = 706,
    Updatecli = 667,
    Uplift = 702,
    ["User Journey Map YAML Schema"] = 636,
    V2Ray = 671,
    ["VSCode Code Snippets"] = 138,
    ["VSIX CLI publishing"] = 556,
    ["Vela Pipeline Configuration"] = 546,
    Vercel = 137,
    ["Web App Manifest"] = 563,
    ["Web types"] = 566,
    WebExtensions = 562,
    ["Webman package recipe"] = 677,
    ["Windows Package Manager Installer Manifest"] = 612,
    ["Windows Package Manager Locale Manifest"] = 613,
    ["Windows Package Manager Singleton Manifest"] = 611,
    ["Woodpecker pipeline config"] = 648,
    ["Xstate Machine Schema"] = 665,
    ...
    ["bamboo-spec"] = 65,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 713,
    ["bashly-strings.yml"] = 714,
    ["bashly.yml"] = 712,
    ["batect.yml"] = 64,
    ["beau.yml"] = 626,
    ...
    ["gitlab-ci"] = 248,
    ["global.json"] = 250,
    ["golangci-lint Configuration"] = 251,
    ["haxelib.json"] = 265,
    helmfile = 607,
    helmwave = 608,
    ["host-meta.json"] = 270,
    ...
    ["ide.host.json"] = 275,
    ["ifstate.conf"] = 276,
    ["imageoptimizer.json"] = 277,
    ["importmap.json"] = 280,
    ["ioBroker Configuration"] = 281,
    ["ioBroker JSON UI"] = 282,
    ["ioBroker Package manifest"] = 283,
    ["ize.toml"] = 701,
    ["jsconfig.json"] = 304,
    ["jscpd Configuration Schema"] = 682,
    jsdoc = 604,
    ["k3d.yaml"] = 305,
    ["kontinuous-config.yaml"] = 311,
    ["kontinuous-values.yaml"] = 310,
    ["kustomization.yaml"] = 312,
    ["label-commenter-config.yml"] = 313,
    ["launchsettings.json"] = 314,
    lazydocker = 723,
    lazygit = 722,
    ["lego.json"] = 316,
    ["lerna.json"] = 317,
    ["lgtm.yml"] = 318,
    ["libman.json"] = 319,
    ["license-report-config.json"] = 320,
    ["linkinator.config.json"] = 321,
    ["local.settings.json"] = 326,
    ["localazy.json"] = 327,
    ["lotus.yaml"] = 325,
    ["lsdlschema.json"] = 328,
    ["madness.yml"] = 711,
    ["markdown-lint-check"] = 644,
    mboats = 651,
    ["micro-settings.json"] = 716,
    ["mimetypes.json"] = 335,
    ["mirrord-schema"] = 587,
    ["mta.yaml"] = 588,
    ["mtad.yaml"] = 589,
    ["mycode.json"] = 358,
    ["napari plugin manifest"] = 359,
    neoload = 599,
    ["nest-cli"] = 365,
    ["ninjs (News in JSON) 1.3"] = 364,
    ["ninjs (News in JSON) 2.0"] = 363,
    ["nlu.json"] = 366,
    ["nodemon.json"] = 368,
    ["noodl.schema.json"] = 650,
    now = 595,
    ["npm-badges"] = 371,
    ["nswag.json"] = 374,
    ntangle = 375,
    ["nuclei-template.yaml"] = 372,
    ["nuget-project.json"] = 373,
    ["ocelot.json"] = 377,
    ["omnisharp.json"] = 378,
    ["openapi.json"] = 379,
    ["openfin.json"] = 383,
    ...
    ["ops.yaml"] = 381,
    ["package.json"] = 394,
    ["package.manifest"] = 395,
    ["pathfinder.yml"] = 398,
    ["pattern.json"] = 400,
    ["petstore-v1.0"] = 692,
    pgap_yaml_input_reader = 399,
    ["plagiarize-me.yaml"] = 404,
    ["plagiarize.yaml"] = 403,
    ["portman.json"] = 405,
    ["prettierrc.json"] = 412,
    ["prisma.yml"] = 413,
    ["project-1.0.0-beta3.json"] = 416,
    ["project-1.0.0-beta4.json"] = 417,
    ["project-1.0.0-beta5.json"] = 418,
    ["project-1.0.0-beta6.json"] = 419,
    ["project-1.0.0-beta8.json"] = 420,
    ["project-1.0.0-rc1.json"] = 421,
    ["project-1.0.0-rc2.json"] = 422,
    ["project.json"] = 415,
    ["prometheus.json"] = 423,
    ["prometheus.rules.json"] = 424,
    ["prometheus.rules.test.json"] = 425,
    ["proxies.json"] = 426,
    ["publiccode.yml"] = 427,
    ["pubspec.yaml"] = 428,
    ["pyrseas-0.8.json"] = 431,
    ["quilt.mod.json"] = 717,
    ["release drafter"] = 600,
    rtx = 446,
    rustfmt = 452,
    samt = 454,
    samtrc = 455,
    ["sarif-1.0.0.json"] = 457,
    ["sarif-2.0.0.json"] = 458,
    ["sarif-2.1.0"] = 468,
    ["sarif-2.1.0-rtm.2"] = 459,
    ["sarif-2.1.0-rtm.3"] = 461,
    ["sarif-2.1.0-rtm.4"] = 463,
    ["sarif-2.1.0-rtm.5"] = 465,
    ["sarif-2.1.0-rtm.6"] = 466,
    ["sarif-external-property-file-2.1.0"] = 469,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 460,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 462,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 464,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 467,
    ["schema.org - Action"] = 471,
    ["schema.org - ContactPoint"] = 472,
    ["schema.org - Place"] = 473,
    ["schema.org - Thing"] = 474,
    ["secrethub.yml"] = 719,
    ["semantic-release"] = 477,
    ["servicehub.config.json"] = 576,
    ["servicehub.service.json"] = 575,
    ["settings.job"] = 480,
    ["sfdx-hardis configuration"] = 482,
    ["size-limit configuration"] = 486,
    ["skaffold.yaml"] = 642,
    ...
    taskcat = 596,
    ["template.json"] = 513,
    ["templatsources.json"] = 514,
    ["theme.json"] = 517,
    ["tizen_workspace.json"] = 518,
    tldr = 519,
    tmLanguage = 520,
    tmuxinator = 584,
    ["transcend.yml"] = 526,
    ...
    ["vega-lite.json"] = 545,
    ["vega.json"] = 544,
    ["venvironment-basic.yaml"] = 548,
    ["venvironment.yaml"] = 547,
    ["version.json"] = 549,
    ["vim-addon-info"] = 550,
    ["vs-2017.3.host.json"] = 552,
    ["vs-nesting.json"] = 553,
    ["vsls.json"] = 551,
