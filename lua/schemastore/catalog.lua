...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 135,
    [".cryproj (generic)"] = 463,
    [".cryproj engine-5.2"] = 458,
    [".cryproj engine-5.3"] = 459,
    [".cryproj engine-5.4"] = 460,
    [".cryproj engine-5.5"] = 461,
    [".cryproj engine-dev"] = 462,
    [".csscomb.json"] = 137,
    [".csslintrc"] = 138,
    [".eslintrc"] = 179,
    [".esmrc.json"] = 171,
    ...
    [".vsext"] = 439,
    [".yarnrc.yml"] = 503,
    ["<div>RIOTS' studio configuration"] = 442,
    ["API Builder"] = 500,
    ["AVA Configuration Schema"] = 554,
    ...
    ["Better Code Hub"] = 505,
    ["Better Scripts"] = 71,
    BizTalkServerApplicationSchema = 477,
    ...
    ["Butane config schema"] = 541,
    ["CICS TS region tagging"] = 548,
    ["CICS TS resource import"] = 549,
    ["CICS TS resource model"] = 550,
    ["CICS TS resource overrides"] = 551,
    ["CMake Presets"] = 72,
    ...
    ["Embrace Config Schema"] = 566,
    ["Error pages"] = 174,
    Esquio = 172,
    ["Estuary Flow Catalog Schema"] = 545,
    ["Expo SDK"] = 177,
    ...
    Goreleaser = 205,
    ["Goreleaser Pro"] = 206,
    ["Gradle Build Cache Node"] = 502,
    ["Gradle Enterprise"] = 501,
    ...
    HEMTT = 474,
    Hadolint = 486,
    ["Hardware Sentry Configuration"] = 559,
    Hayson = 218,
    ...
    ["JSON Feed"] = 244,
    ["JSON Resume"] = 353,
    ["JSON Schema Draft 2020-12"] = 454,
    ["JSON Schema Draft 4"] = 451,
    ["JSON Schema Draft 7"] = 452,
    ["JSON Schema Draft 8"] = 453,
    ...
    ["KSP-AVC"] = 449,
    ["KSP-CKAN"] = 450,
    ["KoDE/CI build.yaml"] = 564,
    ["Kong DBLess Schema"] = 565,
    KrakenD = 249,
    ["LinkML Metamodel"] = 260,
    Liquibase = 516,
    ["Liquibase Flow File"] = 517,
    Markdownlint = 520,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 563,
    ["Monika Configuration Schema"] = 561,
    ["Motif config"] = 470,
    ["Netin Diagnostic System Template"] = 525,
    ...
    Opctl = 473,
    ["OpenWeather Current Weather API"] = 509,
    ["OpenWeather Road Risk API"] = 508,
    ...
    Packer = 315,
    ["Pipeline component"] = 518,
    ["PocketMine plugin.yml"] = 319,
    Pterodactyl = 558,
    ["Pull Request Labeler"] = 342,
    PyProject = 346,
    Qodana = 534,
    ["Quali Torque Blueprint Spec 2"] = 556,
    ["RKE Cluster Configuration JSON Schema"] = 515,
    ["RKE Cluster Configuration YAML Schema"] = 514,
    Ray = 485,
    ["Read the Docs"] = 345,
    ...
    ["SauceCTL Configuration"] = 522,
    ["Schema Catalog"] = 371,
    ["Scoop manifest"] = 376,
    ["Semgrep Rule"] = 378,
    ["Serverless Framework Configuration"] = 529,
    ["Serverless Workflow Schema"] = 530,
    ["Settings.paf"] = 380,
    ["Shopware 6 Configuration"] = 531,
    ["Shopware CLI Extension Store Configuration"] = 532,
    ["Shopware CLI Project Store Configuration"] = 533,
    Solidarity = 385,
    ["Source Maps v3"] = 386,
    SpecIF = 387,
    ["Sponge Mixin configuration"] = 388,
    ["StackHawk Scanner Configuration"] = 528,
    ...
    ["Taskfile YAML Schema"] = 511,
    Taurus = 405,
    ["TestEnvironment.json"] = 411,
    Tikibase = 408,
    ["Traefik v2"] = 414,
    ["Traefik v2 File Provider"] = 415,
    Turborepo = 412,
    Tye = 535,
    ["UI5 Manifest"] = 427,
    ["UTAM Page Object"] = 429,
    ["Ubuntu Server Autoinstall"] = 425,
    ["Uniswap Token List"] = 494,
    Updatecli = 542,
    ["User Journey Map YAML Schema"] = 513,
    V2Ray = 546,
    ["VSCode Code Snippets"] = 111,
    ["VSIX CLI publishing"] = 440,
    ["Vela Pipeline Configuration"] = 432,
    Vercel = 110,
    ["Web App Manifest"] = 444,
    ["Web types"] = 447,
    WebExtensions = 443,
    ["Webman package recipe"] = 552,
    ["Windows Package Manager Installer Manifest"] = 491,
    ["Windows Package Manager Locale Manifest"] = 492,
    ["Windows Package Manager Singleton Manifest"] = 490,
    ["Woodpecker pipeline config"] = 524,
    ["Xstate Machine Schema"] = 540,
    ["Yippee-Ki-JSON configuration YML"] = 496,
    ["angular.json"] = 8,
    ...
    ["jsconfig.json"] = 247,
    ["jscpd Configuration Schema"] = 557,
    jsdoc = 484,
    ["k3d.yaml"] = 248,
    ...
    ["servicehub.config.json"] = 457,
    ["servicehub.service.json"] = 456,
    ["settings.job"] = 379,
    ...
    tmLanguage = 410,
    tmuxinator = 465,
    ["trunk.yaml schema"] = 416,
    ["ts-force-config.json"] = 420,
    ["tsconfig.json"] = 417,
    ["tsd.json"] = 418,
    ["tsdrc.json"] = 419,
    ["tslint.json"] = 421,
    ...
    ["version.json"] = 433,
    ["vim-addon-info"] = 434,
    ["vs-2017.3.host.json"] = 436,
    ["vs-nesting.json"] = 437,
    ["vsls.json"] = 435,
    ["vss-extension.json"] = 441,
    ["webhint.io"] = 553,
    ["webjobpublishsettings.json"] = 446,
    ["webjobs-list.json"] = 445,
    ["xs-app.json"] = 472,
    ["xunit.runner.json"] = 455,
    yamllint = 495,
    zuul = 481,
    ["Žinoma"] = 489
  },
