...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 217,
    [".cryproj (generic)"] = 703,
    [".cryproj engine-5.2"] = 698,
    [".cryproj engine-5.3"] = 699,
    [".cryproj engine-5.4"] = 700,
    [".cryproj engine-5.5"] = 701,
    [".cryproj engine-dev"] = 702,
    [".eslintrc"] = 280,
    [".esmrc.json"] = 265,
    [".ffizer.yaml"] = 284,
    [".htmlhintrc"] = 341,
    ...
    [".mtaext"] = 714,
    [".nodehawkrc"] = 456,
    [".npmpackagejsonlintrc"] = 460,
    [".omletrc"] = 889,
    [".phrase.yml"] = 507,
    [".phraseapp.yml"] = 508,
    [".pmbot.yml"] = 497,
    [".postcssrc"] = 502,
    [".powerpages-web-template-manifest"] = 504,
    [".pre-commit-config.yml"] = 505,
    [".pre-commit-hooks.yml"] = 506,
    [".putout.json"] = 527,
    [".rehyperc"] = 546,
    [".remarkrc"] = 548,
    [".sprite files"] = 606,
    ...
    ["Adobe UXP Manifest"] = 871,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 15,
    ["Airplane task"] = 16,
    ["Alacritty Configuration"] = 778,
    ["All Contributors configuration file"] = 836,
    ...
    ["Azure Pipelines"] = 72,
    ["Azure Static Web Apps CLI configuration file"] = 609,
    ["Azure Static Web Apps configuration file"] = 608,
    ["BX CI"] = 111,
    ["Bashly (bashly.yml)"] = 840,
    ["Bashly Settings (bashly-settings.yml)"] = 841,
    ["Better Code Hub"] = 750,
    ["Better Scripts"] = 112,
    Bigconfig = 89,
    BizTalkServerApplicationSchema = 720,
    Bleep = 113,
    ...
    ["Butane Config"] = 791,
    ["CGS Custom Card Game (CardGameDef.json)"] = 876,
    ["CICS TS region tagging"] = 800,
    ["CICS TS resource import"] = 801,
    ["CICS TS resource model"] = 802,
    ["CICS TS resource overrides"] = 803,
    ["CMake Presets"] = 114,
    ["CNC Codes"] = 128,
    ...
    CityJSON = 124,
    ["Clawject config"] = 133,
    ["Cloud Foundry Application Manifest"] = 888,
    ...
    Concord = 904,
    ["Configu .cfgu files"] = 893,
    ["Configu .configu file"] = 894,
    Conjure = 127,
    ["Container Structure Test"] = 733,
    Containerlab = 758,
    ["Crowdsec collection config"] = 213,
    ["Crowdsec parser config"] = 214,
    ["Crowdsec scenario config"] = 215,
    ["CumulusCI Config"] = 132,
    ["Custom Machinery Machine"] = 877,
    ["Custom Machinery Recipe"] = 878,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 848,
    ["EAS config"] = 278,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 837,
    ...
    ["Goreleaser Pro"] = 322,
    Goss = 323,
    ["Gradle Build Cache Node"] = 748,
    ["Gradle Enterprise"] = 747,
    ...
    Hadolint = 729,
    Hammerkit = 757,
    ["Hardware Sentry Configuration"] = 811,
    Hatch = 730,
    Hayson = 336,
    ...
    ["JFrog File Spec"] = 364,
    ["JFrog Pipelines YML DSL"] = 820,
    ["JMeter DSL cli config"] = 365,
    JReleaser = 367,
    ["JSON Document Transform"] = 375,
    ["JSON Feed"] = 376,
    ["JSON Resume"] = 553,
    ["JSON Schema Draft 2020-12"] = 694,
    ["JSON Schema Draft 4"] = 691,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 858,
    ["JSON Schema Draft 7"] = 692,
    ["JSON Schema Draft 7 (unofficial strict)"] = 859,
    ["JSON Schema Draft 8 (2019-09)"] = 693,
    ["JSON-API"] = 374,
    ["JSON-WF"] = 887,
    ["JSON-e templates"] = 755,
    ["JSON-stat 2.0"] = 688,
    JSONPatch = 378,
    ...
    Kas = 381,
    ["Keycloak REST API"] = 828,
    ["Knative Functions - func.yaml"] = 297,
    ["KoDE/CI build.yaml"] = 816,
    ["Kong DBLess config"] = 817,
    KrakenD = 384,
    ...
    ["Language configuration"] = 897,
    Lefthook = 394,
    ["Liferay client-extension.yaml"] = 401,
    ["LinkML Metamodel"] = 403,
    Liquibase = 763,
    ["Liquibase Flow File"] = 764,
    ["Lively Properties"] = 404,
    ["Lobe AI Agent"] = 70,
    Loki = 71,
    ["MLOS Configs"] = 440,
    ["MS2Rescore Configuration"] = 443,
    ["Madness (madness.yml)"] = 839,
    Markdownlint = 767,
    ["Mason Registry"] = 769,
    ...
    ["Mergify Configuration"] = 444,
    ["Metadata for a Bazel module"] = 415,
    ["MetricsHub Configuration"] = 416,
    ["MetricsHub Connector Configuration"] = 417,
    ["Micro Editor Syntax"] = 849,
    ["Microsoft Band Web Tile"] = 418,
    ["Microsoft RulesEngine workflow rules"] = 901,
    ["Microsoft RulesEngine workflow rules list"] = 902,
    ["Minecraft Custom Main Menu Mod"] = 866,
    ["Minecraft Data Pack Advancement"] = 420,
    ["Minecraft Data Pack Biome"] = 421,
    ["Minecraft Data Pack Configured Carver"] = 422,
    ["Minecraft Data Pack Damage Type"] = 423,
    ["Minecraft Data Pack Dimension"] = 425,
    ["Minecraft Data Pack Dimension Type"] = 424,
    ["Minecraft Data Pack Item Modifier"] = 426,
    ["Minecraft Data Pack Loot Table"] = 427,
    ["Minecraft Data Pack Metadata"] = 428,
    ["Minecraft Data Pack Predicate"] = 429,
    ["Minecraft Data Pack Recipe"] = 430,
    ["Minecraft Data Pack Tag"] = 431,
    ["Minecraft Data Pack Template Pool"] = 432,
    ["Minecraft Data Pack Trim Material"] = 437,
    ["Minecraft Data Pack Trim Pattern"] = 438,
    ["Minecraft Resource Pack Lang"] = 433,
    ["Minecraft Resource Pack Particle"] = 434,
    ["Minecraft Resource Pack Texture Mcmeta"] = 436,
    ["Minecraft Resourcepack Sounds"] = 435,
    ["Monade CLI Stack Configuration"] = 447,
    ["MongoDB Atlas Search Index Definition"] = 815,
    ["Monika Configuration"] = 813,
    ["Monoweave Configuration"] = 442,
    ["Motif config"] = 713,
    ["NOX Framework (Service)"] = 459,
    ["Netin Diagnostic System Template"] = 773,
    ["Netlify config"] = 450,
    ["Network-as-Code Data Model"] = 451,
    ["Nightwatch.js"] = 452,
    ["Nuitka.yaml"] = 879,
    ["ONe's changelog entry"] = 475,
    ["ONe's service descriptor"] = 474,
    ["OSS Review Toolkit configuration"] = 483,
    ["OSS Review Toolkit curation"] = 484,
    ["OSS Review Toolkit package configuration"] = 485,
    ["OSS Review Toolkit repository configuration"] = 486,
    ["OSS Review Toolkit resolutions"] = 487,
    Opctl = 716,
    ["Open Data Contract Standard (ODCS))"] = 478,
    ["OpenRewrite Resource"] = 477,
    ["OpenUtau character yaml"] = 471,
    ["OpenUtau ustx"] = 472,
    ["OpenWeather Current Weather API"] = 754,
    ["OpenWeather Road Risk API"] = 753,
    ["Ory Hydra configuration"] = 343,
    ["Ory Keto configuration"] = 387,
    ["Ory Kratos configuration"] = 482,
    ["Ory Oathkeeper configuration"] = 466,
    ["Outblocks App configuration"] = 480,
    ["Outblocks database table"] = 481,
    ["Outblocks project configuration"] = 479,
    PDM = 493,
    Packer = 490,
    Pantsbuild = 835,
    ["Paper paper-plugin.yml"] = 491,
    ["Pipeline component"] = 765,
    ["PocketMine plugin.yml"] = 498,
    ["Postman collection"] = 503,
    ["Problem object RFC9457"] = 863,
    ["Problem package generators"] = 511,
    Pterodactyl = 810,
    ["Pull Request Labeler"] = 526,
    Pulumi = 532,
    PyProject = 533,
    Pyright = 534,
    Qgoda = 535,
    Qodana = 783,
    ["Qt Creator workspace file"] = 895,
    ["Quali Torque Blueprint Spec 2"] = 808,
    ["QueryFirst config file"] = 831,
    ["RKE Cluster Configuration JSON"] = 762,
    ["RKE Cluster Configuration YAML"] = 761,
    ["Rancher Fleet"] = 529,
    ["Rattler-build"] = 536,
    Ray = 728,
    ["Read the Docs"] = 531,
    ["Red-DiscordBot Cog"] = 543,
    ["Red-DiscordBot Cog Repo"] = 544,
    ["Red-DiscordBot Trivia"] = 545,
    ["Render Blueprints"] = 760,
    RenderCV = 555,
    Renovate = 554,
    ["Replit config"] = 549,
    RoadRunner = 556,
    ["Rudder techniques"] = 869,
    Ruff = 551,
    ["Rust Project"] = 552,
    ["Rust toolchain"] = 559,
    ["SDMX data message"] = 584,
    ["SDMX metadata message"] = 583,
    ["SDMX structure message"] = 582,
    ["SIL Kit Participant Configuration"] = 594,
    ["SIL Kit Registry Configuration"] = 595,
    SWADL = 620,
    ["Safebox Config"] = 821,
    ["Sapphire CLI Config"] = 562,
    ["SauceCTL Configuration"] = 770,
    ["Schema Catalog"] = 576,
    ["Scoop manifest"] = 581,
    ["Semantic Data Fabric (SDF) file"] = 585,
    ["Semgrep Rule"] = 587,
    ["Serenity Code Generator (Sergen)"] = 588,
    ["Serverless Framework Configuration"] = 777,
    ["Serverless Workflow"] = 779,
    ["Settings.paf"] = 590,
    ["Shopware 6 Configuration"] = 780,
    ["Shopware CLI Extension Store Configuration"] = 781,
    ["Shopware CLI Project Store Configuration"] = 782,
    Sigma = 592,
    ["Sigrid scope configuration file"] = 593,
    ["SkyPilot Task JSON"] = 870,
    ["Slack app manifest"] = 597,
    Solidarity = 600,
    ["Solution filters"] = 601,
    ["Source Maps v3"] = 602,
    Sourcery = 603,
    SpecIF = 604,
    ["Sponge Mixin configuration"] = 605,
    StackBlitz = 610,
    ["StackHawk Scanner Configuration"] = 776,
    Stale = 611,
    ["Starlake Data Pipeline"] = 751,
    Starship = 612,
    ["Statamic Blueprint"] = 613,
    ["Stella configuration file"] = 614,
    ["StrmPrivacy Data Connector"] = 825,
    ["StrmPrivacy Data Contract"] = 826,
    ["StrmPrivacy SimpleSchema"] = 823,
    ["StrmPrivacy Stream"] = 824,
    ["StrmPrivacy batch job configuration file"] = 822,
    ["Stryker Mutator"] = 617,
    ["StyleCop Analyzers Configuration"] = 618,
    ["Stylelint (.stylelintrc)"] = 619,
    ["Sublime Syntax"] = 827,
    ["Subsquid squid manifest"] = 872,
    ["Swagger API 2.0"] = 621,
    TSON = 647,
    TSTyche = 648,
    Talhelper = 623,
    ["Talisman configuration"] = 624,
    ["Taskfile config"] = 756,
    Taurus = 625,
    ["TestEnvironment.json"] = 634,
    ["TextMate Grammar"] = 633,
    ["Tier.run pricing.json"] = 628,
    Tikibase = 629,
    ["Traefik v2"] = 637,
    ["Traefik v2 File Provider"] = 638,
    ...
    ["UI5 Manifest"] = 657,
    ["UNCORS configuration"] = 661,
    ["UTAM Page Object"] = 660,
    ["Ubuntu Server Autoinstall"] = 655,
    ["Uniswap Token List"] = 739,
    ["Unreal Engine Uplugin"] = 833,
    ["Unreal Engine Uproject"] = 834,
    ["Updatecli Compose"] = 792,
    ["Updatecli Policy Manifest"] = 793,
    ["Updatecli Policy Metadata"] = 794,
    Uplift = 830,
    ["User Journey Map"] = 759,
    V2Ray = 798,
    ["VSCode Code Snippets"] = 179,
    ["VSIX CLI publishing"] = 676,
    ["Vela Pipeline Configuration"] = 665,
    Vercel = 178,
    Visivo = 860,
    ["Web App Manifest"] = 683,
    ["Web types"] = 686,
    WebExtensions = 682,
    ["Webman package recipe"] = 804,
    ["Windows Package Manager Installer Manifest"] = 736,
    ["Windows Package Manager Locale Manifest"] = 737,
    ["Windows Package Manager Singleton Manifest"] = 735,
    ["Woodpecker pipeline config"] = 772,
    ["Wrangler CLI"] = 687,
    ["Xstate Machine"] = 790,
    ["Yarn Config (.yarnrc.yml)"] = 749,
    ["Yippee-Ki-JSON configuration YML"] = 741,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 864,
    ...
    ["behat.yml"] = 97,
    ["bigquery-table"] = 88,
    ["bioimageio resource description"] = 880,
    ...
    ["lint-staged (.lintstagedrc)"] = 707,
    ["local.settings.json"] = 407,
    ["localazy.json"] = 408,
    ["lotus.yaml"] = 406,
    ["lsdlschema.json"] = 409,
    ["markdown-link-check"] = 768,
    mboats = 775,
    ["micro-settings.json"] = 844,
    ["mimetypes.json"] = 419,
    ["mirrord config"] = 708,
    mise = 709,
    ["mise-settings"] = 710,
    ["mkdocs.yml"] = 439,
    ["monospace.yml"] = 441,
    ["mprocs Configuration file"] = 896,
    ["mta.yaml"] = 711,
    ["mtad.yaml"] = 712,
    ["mycode.json"] = 448,
    ["napari plugin manifest"] = 449,
    neoload = 722,
    ["nest-cli"] = 454,
    ["ninjs (News in JSON)"] = 453,
    ["nixd configuration"] = 868,
    ["nlu.json"] = 455,
    ["nodemon.json"] = 457,
    ["noodl config"] = 774,
    ["notebook.mod.json"] = 458,
    now = 718,
    ["npm-badges"] = 461,
    ["nswag.json"] = 464,
    ntangle = 465,
    ["nuclei-template.yaml"] = 462,
    ["nuget-project.json"] = 463,
    ["ocelot.json"] = 467,
    ["omnisharp.json"] = 468,
    ["openapi.json"] = 469,
    ["openfin.json"] = 476,
    ...
    ["ops.yaml"] = 473,
    ["package.json"] = 488,
    ["package.manifest"] = 489,
    ["partial-black.json"] = 98,
    ["pathfinder.yml"] = 492,
    ["pattern.json"] = 495,
    ["petstore-v1.0"] = 819,
    pgap_yaml_input_reader = 494,
    ["pixi.toml"] = 496,
    ["plagiarize-me.yaml"] = 500,
    ["plagiarize.yaml"] = 499,
    ["portman.json"] = 501,
    ["prettierrc.json"] = 509,
    ["prisma.yml"] = 510,
    ["project-1.0.0-beta3.json"] = 513,
    ["project-1.0.0-beta4.json"] = 514,
    ["project-1.0.0-beta5.json"] = 515,
    ["project-1.0.0-beta6.json"] = 516,
    ["project-1.0.0-beta8.json"] = 517,
    ["project-1.0.0-rc1.json"] = 518,
    ["project-1.0.0-rc2.json"] = 519,
    ["project.json"] = 512,
    ["prometheus.json"] = 520,
    ["prometheus.rules.json"] = 521,
    ["prometheus.rules.test.json"] = 522,
    ["proxies.json"] = 523,
    ["publiccode.yml"] = 524,
    ["pubspec.yaml"] = 525,
    ["pyrseas-0.8.json"] = 528,
    ["quilt.mod.json"] = 845,
    ["rc3 auth"] = 537,
    ["rc3 collection"] = 538,
    ["rc3 environment"] = 539,
    ...
    ["rc3 settings"] = 542,
    ["release drafter"] = 723,
    ["release-plz.toml"] = 547,
    ["rivet.yaml"] = 867,
    rockcraft = 557,
    rustfmt = 558,
    samt = 560,
    samtrc = 561,
    ["sarif-1.0.0.json"] = 563,
    ["sarif-2.0.0.json"] = 564,
    ["sarif-2.1.0"] = 574,
    ["sarif-2.1.0-rtm.2"] = 565,
    ["sarif-2.1.0-rtm.3"] = 567,
    ["sarif-2.1.0-rtm.4"] = 569,
    ["sarif-2.1.0-rtm.5"] = 571,
    ["sarif-2.1.0-rtm.6"] = 572,
    ["sarif-external-property-file-2.1.0"] = 575,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 566,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 568,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 570,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 573,
    ["schema.org - Action"] = 577,
    ["schema.org - ContactPoint"] = 578,
    ["schema.org - Place"] = 579,
    ["schema.org - Thing"] = 580,
    ["secrethub.yml"] = 847,
    ["semantic-release"] = 586,
    ["servicehub.config.json"] = 697,
    ["servicehub.service.json"] = 696,
    ["settings.job"] = 589,
    ["sfdx-hardis configuration"] = 591,
    ["shard.yml"] = 883,
    ["size-limit configuration"] = 596,
    ["skaffold.yaml"] = 766,
    ["skyuxconfig.json"] = 598,
    snapcraft = 599,
    ["spicepod.yaml"] = 903,
    ["sqlc configuration"] = 607,
    ["stripe-app-local.json"] = 616,
    ["stripe-app.json"] = 615,
    swcrc = 752,
    ["task.json"] = 622,
    taskcat = 719,
    ["template.json"] = 626,
    ["templatsources.json"] = 627,
    ["theme.json"] = 630,
    ["tizen_workspace.json"] = 631,
    tldr = 632,
    tmuxinator = 705,
    ["transcend.yml"] = 639,
    ...
    ["vega-lite.json"] = 664,
    ["vega.json"] = 663,
    ["venvironment-basic.yaml"] = 667,
    ["venvironment.yaml"] = 666,
    ["version.json"] = 668,
    ["vim-addon-info"] = 670,
    ["vs-2017.3.host.json"] = 672,
    ["vs-nesting.json"] = 673,
    ["vsls.json"] = 671,
    ["vss-extension.json"] = 677,
    ["vtesttree.yaml"] = 678,
    ["vtestunit.yaml"] = 679,
    ["warp-keysets.json"] = 853,
    ["warp-themes.json"] = 854,
    ["warp-workflows.json"] = 855,
    ["webhint.io"] = 805,
    ["webjobpublishsettings.json"] = 685,
    ["webjobs-list.json"] = 684,
    ["well-known-fursona"] = 891,
    ["xs-app.json"] = 715,
    ["xunit.runner.json"] = 695,
    yamllint = 740,
    ["zerops.io import file"] = 900,
    ["zerops.yml"] = 899,
    zuul = 724,
    ["Žinoma"] = 734
  },
