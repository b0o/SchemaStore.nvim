...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 826,
    [".nodehawkrc"] = 515,
    [".npmpackagejsonlintrc"] = 519,
    [".omletrc"] = 1002,
    [".phrase.yml"] = 581,
    [".phraseapp.yml"] = 582,
    [".pmbot.yml"] = 569,
    [".postcssrc"] = 576,
    [".powerpages-web-template-manifest"] = 578,
    [".pre-commit-config.yml"] = 579,
    [".pre-commit-hooks.yml"] = 580,
    [".putout.json"] = 609,
    [".rehyperc"] = 632,
    [".remarkrc"] = 636,
    [".sprite files"] = 705,
    ...
    ["A micro editor config"] = 467,
    ABCInventoryModuleData = 18,
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1046,
    ["API Builder"] = 861,
    ["AVA Configuration"] = 923,
    ["AWS AppConfig Feature Flags-v1"] = 49,
    ["AWS CDK cdk.json"] = 216,
    ["AWS CloudFormation"] = 217,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 218,
    ["AWS SAM CLI Samconfig"] = 219,
    ["Adobe UXP Manifest"] = 985,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1074,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 895,
    ["All Contributors configuration file"] = 948,
    ["Ansible Argument Specs"] = 349,
    ["Ansible Collection Galaxy"] = 356,
    ["Ansible Execution Environment"] = 346,
    ["Ansible Inventory"] = 355,
    ["Ansible Meta"] = 347,
    ["Ansible Meta Runtime"] = 348,
    ["Ansible Navigator Configuration"] = 358,
    ["Ansible Playbook"] = 353,
    ["Ansible Requirements"] = 350,
    ["Ansible Rulebook"] = 354,
    ["Ansible Tasks File"] = 352,
    ["Ansible Vars File"] = 351,
    ["Ansible-lint Configuration"] = 357,
    Any = 1011,
    ["AnyWork Automation Configuration"] = 9,
    ["App config Spotify Backstage"] = 25,
    ["Application Accelerator"] = 6,
    ["Application list for a WinUtil"] = 1028,
    ArchitectFX = 1033,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure Pipelines"] = 78,
    ["Azure Static Web Apps CLI configuration file"] = 709,
    ["Azure Static Web Apps configuration file"] = 708,
    ["BOSH CPI Config"] = 102,
    ["BOSH Deploy Config"] = 103,
    ["BX CI"] = 122,
    ["Bashly (bashly.yml)"] = 952,
    ["Bashly Settings (bashly-settings.yml)"] = 953,
    ["Better Code Hub"] = 865,
    ["Better Scripts"] = 123,
    Bigconfig = 95,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1039,
    BizTalkServerApplicationSchema = 833,
    Bleep = 124,
    ["Block Protocol Metadata"] = 121,
    ["Boyka Framework"] = 104,
    Briefcase = 839,
    ["Build Info"] = 112,
    Buildkite = 114,
    ["Bukkit plugin.yml"] = 113,
    ["BungeeCord plugin.yml"] = 119,
    ["Butane Config"] = 908,
    C4InterFlow = 1054,
    ["CDK Environment Manager, concrete environment configuration"] = 1077,
    ["CDK Environment Manager, concrete environments definition"] = 1076,
    ["CDK Environment Manager, environment definition"] = 1075,
    ["CGS Card Game Specification (cgs.json)"] = 990,
    ["CICS TS region tagging"] = 917,
    ["CICS TS resource import"] = 918,
    ["CICS TS resource model"] = 919,
    ["CICS TS resource overrides"] = 920,
    ["CMake Presets"] = 125,
    ["CNC Codes"] = 144,
    ["CRS WAF test file"] = 1018,
    ["CRS WAF test platform overrides file"] = 1019,
    ["CSS Comb (.csscomb.json)"] = 244,
    ["CSS Lint (.csslintrc)"] = 245,
    ["CSpell (cspell.json)"] = 243,
    ["CVE Record Format"] = 152,
    CWL = 996,
    ["Cache Warmup config"] = 126,
    ["Calqulus pipeline"] = 127,
    ["Camel YAML DSL"] = 128,
    ["Cannon TOML"] = 129,
    Carafe = 130,
    ["Cargo Make"] = 132,
    ["Cargo Manifest"] = 131,
    ["Catalog Info Backstage"] = 133,
    ["Chamaleon environment"] = 1043,
    ["Chamaleon properties"] = 1044,
    ["Chamaleon template"] = 1042,
    Changesets = 228,
    Charmcraft = 134,
    Cheatsheets = 905,
    ["Chrome Extension"] = 209,
    ["Chromia Model"] = 135,
    ["Chromia Seeder Module Config"] = 137,
    ["Chromia Seeder Root Config"] = 136,
    ["Cinnamon Spice info.json"] = 70,
    ["CircleCI config.yml"] = 185,
    ["Citation File Format"] = 230,
    CityJSON = 139,
    ["Claude Code Settings"] = 151,
    ["Clawject config"] = 150,
    ["Cloud Foundry Application Manifest"] = 1001,
    ["Cloud Run Spec v1"] = 1023,
    ["CloudCannon Configuration"] = 74,
    ["CloudEvents specification"] = 140,
    ["Code Climate"] = 186,
    CodeCV = 72,
    CodeRabbit = 71,
    ["CodeShip Pro services configuration files"] = 198,
    ["CodeShip Pro steps configuration files"] = 199,
    ["Codecov configuration files"] = 197,
    CodifyCLI = 73,
    Codux = 195,
    ["Cog config file"] = 145,
    ["Commandbox Box.json"] = 146,
    ["Commandbox Server.json"] = 147,
    ["Common Catalog Data"] = 207,
    ["Common Package Specification"] = 148,
    Concord = 1017,
    ["Configu .cfgu files"] = 1006,
    ["Configu .configu file"] = 1007,
    Conjure = 143,
    ["Container Structure Test"] = 847,
    Containerlab = 874,
    ["Contextive Glossary"] = 1069,
    Convex = 142,
    ["Crowdsec collection config"] = 238,
    ["Crowdsec parser config"] = 239,
    ["Crowdsec scenario config"] = 240,
    ["CumulusCI Config"] = 149,
    ["Custom Machinery Machine"] = 991,
    ["Custom Machinery Recipe"] = 992,
    ["Cycle Stack File"] = 153,
    CycloneDX = 154,
    ["DWP Exchange - catalogue entry"] = 287,
    ["DWP Exchange - gateway"] = 285,
    ["DWP Exchange - meta"] = 286,
    ["Dart Build Config (dart-build.json)"] = 246,
    ["Dart Test Config (dart-test.json)"] = 247,
    ["DashLord Configuration"] = 248,
    ["Data Contract Specification"] = 249,
    ["Data Product Specification"] = 250,
    ["DataYoga Connections"] = 155,
    ["DataYoga Job"] = 156,
    ["Databricks Asset Bundles"] = 969,
    ["Datadog Service Definition"] = 440,
    ["Datadog Software Catalog"] = 441,
    ["Datahub Ingestion Recipe"] = 924,
    ["Dein Config"] = 162,
    ["Deno Config (deno.json)"] = 256,
    ["Dependency cruiser"] = 163,
    ["DeployStack Configuration"] = 164,
    ["Deployer Recipe"] = 259,
    ["Deta Spacefile"] = 165,
    ["Detekt Config (detekt.yml)"] = 260,
    ["Devbox Config"] = 166,
    ["Devbox Plugin"] = 167,
    Devfile = 284,
    DipDup = 1020,
    ["Discord Webhook"] = 261,
    ["DocFx Config (docfx.json)"] = 265,
    Dofigen = 266,
    ["Dolittle Artifacts"] = 267,
    ["Dolittle Bounded Context Configuration"] = 268,
    ["Dolittle Event Horizons Configuration"] = 269,
    ["Dolittle Resources Configuration"] = 270,
    ["Dolittle Server Configuration"] = 271,
    ["Dolittle Tenant Map Configuration"] = 273,
    ["Dolittle Tenants Configuration"] = 272,
    ["Dolittle Topology"] = 274,
    ["DonateCaseBetterCasino menu"] = 1047,
    ["Drupal Breakpoints"] = 168,
    ["Drupal Config"] = 180,
    ["Drupal Info"] = 169,
    ["Drupal Layouts"] = 170,
    ["Drupal Libraries"] = 171,
    ["Drupal Links Action"] = 172,
    ["Drupal Links Contextual"] = 173,
    ["Drupal Links Menu"] = 174,
    ["Drupal Links Task"] = 175,
    ["Drupal Migration"] = 176,
    ["Drupal Permissions"] = 177,
    ["Drupal Recipe"] = 178,
    ["Drupal Routing"] = 179,
    ["Drupal Services"] = 181,
    ["Drush site aliases"] = 280,
    ["Dynamic Bash Aliases (.aliases)"] = 960,
    ["EAS config"] = 304,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 949,
    ["EasyVCR .NET"] = 305,
    ["Eidolon Resource"] = 1034,
    ["Elgato Stream Deck"] = 290,
    Elm = 1022,
    ["Embrace Config"] = 935,
    Endurica = 973,
    ["Enterprise Contract Policy Spec"] = 291,
    ["Erda Pipeline"] = 998,
    ["Erda Runtime"] = 999,
    Esquio = 293,
    ["Estuary Flow Catalog"] = 914,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 297,
    ["EveryVoice TTS Toolkit Data Configuration"] = 298,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 302,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 301,
    ["EveryVoice TTS Toolkit Text Configuration"] = 299,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 300,
    ["Expo SDK"] = 303,
    ["F-Droid Data metadata"] = 309,
    ["FasterCI Configuration"] = 79,
    FiQuS = 313,
    Firebase = 311,
    ["FlexGet Config"] = 314,
    ["Flow.json Configurations"] = 995,
    ["Fossa configuration file"] = 321,
    ["Fossa's fossa-deps file"] = 322,
    ["Foundry VTT - Base package Manifest"] = 316,
    ["Foundry VTT - Module Manifest"] = 317,
    ["Foundry VTT - System Data Template"] = 320,
    ["Foundry VTT - System Manifest"] = 318,
    ["Foundry VTT - World Manifest"] = 319,
    ["Foxx Manifest"] = 80,
    ["Freifunk.de Community API"] = 83,
    ["Frogbot Config"] = 84,
    ["G2P Mapping Configuration"] = 327,
    ["GCP Blueprint Metadata"] = 330,
    Gaspar = 328,
    ["GatewayCore API Gateway"] = 329,
    ["GeoJSON.json latest"] = 912,
    GherKing = 916,
    ["GitHub Action"] = 335,
    ["GitHub Actions typing"] = 1030,
    ["GitHub Discussion"] = 336,
    ["GitHub Funding"] = 337,
    ["GitHub Issue Template configuration"] = 338,
    ["GitHub Issue Template forms"] = 339,
    ["GitHub Workflow"] = 340,
    ["GitHub Workflow Template Properties"] = 341,
    ["GitHub automatically generated release notes configuration"] = 342,
    ["GitLab Agent for Kubernetes configuration"] = 987,
    GitVersion = 332,
    ["Gitea Issue Template configuration"] = 333,
    ["Gitea Issue Template forms"] = 334,
    ["Gitpod Automations"] = 344,
    ["Gitpod Configuration"] = 345,
    ["GlazeWM settings"] = 989,
    ["Global Privacy Control"] = 331,
    Goblet = 968,
    ["Golangci-lint Configuration"] = 360,
    ["Golangci-lint Custom Plugins Configuration"] = 361,
    ["Google Chrome Related Website Sets"] = 312,
    ["Google Cloud Workflows"] = 215,
    ["Google Digital Assetlinks"] = 1070,
    Goreleaser = 363,
    ["Goreleaser Pro"] = 364,
    Goss = 365,
    ["Gradle Build Cache Node"] = 863,
    ["Gradle Enterprise"] = 862,
    ["Grafana 5.x Dashboard"] = 366,
    ["GraphQL Code Generator"] = 370,
    ["GraphQL Config"] = 369,
    ["GraphQL Mesh"] = 368,
    ["Grunt JSHint task"] = 374,
    ["Grunt Watch task"] = 375,
    ["Grunt base task"] = 376,
    ["Grunt clean task"] = 372,
    ["Grunt copy task"] = 371,
    ["Grunt cssmin task"] = 373,
    HEMTT = 829,
    Hadolint = 843,
    Hammerkit = 873,
    ["Hardware Sentry Configuration"] = 928,
    Hatch = 844,
    Hayson = 378,
    ["Haystack Pipeline"] = 379,
    ["Hazelcast 5 Configuration"] = 380,
    ["Hecate Input Schema"] = 1081,
    ["Helm Chart.lock"] = 183,
    ["Helm Chart.yaml"] = 182,
    ["Helm Unittest Test Suite"] = 184,
    ["Home Assistant Integration Manifest"] = 381,
    ["Homer dashboard configuration"] = 382,
    Hugo = 904,
    ["Hugo Theme"] = 903,
    ["Hyperfoil benchmark configuration"] = 388,
    ["IBM Zapp document"] = 389,
    ["IBM zCodeFormatSettings"] = 390,
    ["IMG Catapult PSP"] = 395,
    ["IVMS101 by CODE Protocol"] = 988,
    Infrahub = 397,
    Istanbul = 931,
    ["JDownloader2 crawler multi-rules"] = 407,
    ["JDownloader2 crawler single-rules"] = 406,
    ["JFrog Applications Config"] = 408,
    ["JFrog File Spec"] = 409,
    ["JFrog Pipelines YML DSL"] = 937,
    ["JMeter DSL cli config"] = 410,
    JReleaser = 413,
    ["JSON Document Transform"] = 421,
    ["JSON Feed"] = 422,
    ["JSON Resume"] = 642,
    ["JSON Schema Draft 2020-12"] = 812,
    ["JSON Schema Draft 4"] = 809,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 970,
    ["JSON Schema Draft 7"] = 810,
    ["JSON Schema Draft 7 (unofficial strict)"] = 971,
    ["JSON Schema Draft 8 (2019-09)"] = 811,
    ["JSON-API"] = 420,
    ["JSON-e templates"] = 870,
    ["JSON-stat 2.0"] = 805,
    JSONPatch = 424,
    ["JSR Package Config (jsr.json)"] = 414,
    Jasmine = 401,
    Jekyll = 402,
    ["Jenkins X Pipelines"] = 403,
    ["Jenkins X Requirements"] = 404,
    Jest = 405,
    Jocker = 411,
    ["Jovo Language Models"] = 412,
    ["KIMMDY config file"] = 435,
    ["KODE/CI build.yaml"] = 933,
    ["KSP-AVC"] = 806,
    ["KSP-CKAN"] = 807,
    ["KSP-NetKAN"] = 808,
    KSY = 1000,
    KSail = 325,
    ["Karakum configuration file"] = 323,
    Kas = 427,
    ["Kestra flow file"] = 436,
    ["Keycloak REST API"] = 940,
    ["Knative Functions - func.yaml"] = 324,
    ["Kometa (nightly) config file"] = 438,
    ["Kometa config file"] = 437,
    ["Kong DBLess config"] = 934,
    KrakenD = 439,
    ["Kubri Configuration"] = 445,
    LOOBin = 460,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 220,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 221,
    ["Landing Zone Accelerator on AWS - Global Config"] = 222,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 223,
    ["Landing Zone Accelerator on AWS - Network Config"] = 224,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 225,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 226,
    ["Landing Zone Accelerator on AWS - Security Config"] = 227,
    ["Language configuration"] = 1010,
    Lefthook = 449,
    ["Liferay client-extension.yaml"] = 456,
    ["LinkML Metamodel"] = 458,
    Liquibase = 879,
    ["Liquibase Flow File"] = 880,
    ["Lively Properties"] = 459,
    ["Lobe AI Agent"] = 76,
    Loki = 77,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 498,
    ["MS2Rescore Configuration"] = 501,
    ["Madness (madness.yml)"] = 951,
    ["MapEHR Mapping"] = 466,
    Markdownlint = 883,
    ["Mason Registry"] = 886,
    ["MegaLinter configuration"] = 468,
    ["MegaLinter descriptor"] = 469,
    Melange = 978,
    ["Meltano project definition"] = 470,
    ["Mergify Configuration"] = 502,
    ["Metadata for a Bazel module"] = 471,
    ["Metadata for a Cinnamon spice"] = 1026,
    ["Metatype Configuration"] = 472,
    ["MetricsHub Configuration"] = 473,
    ["MetricsHub Connector Configuration"] = 474,
    ["Micro Editor Syntax"] = 961,
    ["Microsoft Band Web Tile"] = 475,
    ["Microsoft RulesEngine workflow rules"] = 1014,
    ["Microsoft RulesEngine workflow rules list"] = 1015,
    ["Minecraft Custom Main Menu Mod"] = 979,
    ["Minecraft Data Pack Advancement"] = 477,
    ["Minecraft Data Pack Biome"] = 478,
    ["Minecraft Data Pack Configured Carver"] = 479,
    ["Minecraft Data Pack Damage Type"] = 480,
    ["Minecraft Data Pack Dimension"] = 482,
    ["Minecraft Data Pack Dimension Type"] = 481,
    ["Minecraft Data Pack Item Modifier"] = 483,
    ["Minecraft Data Pack Loot Table"] = 484,
    ["Minecraft Data Pack Metadata"] = 485,
    ["Minecraft Data Pack Predicate"] = 486,
    ["Minecraft Data Pack Recipe"] = 487,
    ["Minecraft Data Pack Tag"] = 488,
    ["Minecraft Data Pack Template Pool"] = 489,
    ["Minecraft Data Pack Trim Material"] = 494,
    ["Minecraft Data Pack Trim Pattern"] = 495,
    ["Minecraft Resource Pack Lang"] = 490,
    ["Minecraft Resource Pack Particle"] = 491,
    ["Minecraft Resource Pack Texture Mcmeta"] = 493,
    ["Minecraft Resourcepack Sounds"] = 492,
    ["Monade CLI Stack Configuration"] = 505,
    ["MongoDB Atlas Search Index Definition"] = 932,
    ["Monika Configuration"] = 930,
    ["Monoweave Configuration"] = 500,
    ["Motif config"] = 825,
    MultiQC = 1063,
    ["NOX Framework (Service)"] = 518,
    ["Netin Diagnostic System Template"] = 890,
    ["Netlify config"] = 508,
    ["Network-as-Code Data Model"] = 509,
    ["Nightwatch.js"] = 511,
    ["Node.js configuration"] = 830,
    ["NueJS configuration file"] = 523,
    ["Nuitka.yaml"] = 993,
    ["Nullstone config"] = 525,
    ["ONe's changelog entry"] = 539,
    ["ONe's service descriptor"] = 538,
    ["ORT Server repository environment configuration"] = 546,
    ["OSCAL Assessment Plan (AP)"] = 548,
    ["OSCAL Assessment Results (AR)"] = 549,
    ["OSCAL Catalog"] = 550,
    ["OSCAL Component Definition (CDef)"] = 551,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 552,
    ["OSCAL Profile"] = 553,
    ["OSCAL System Security Plan (SSP)"] = 554,
    ["OSS Review Toolkit configuration"] = 555,
    ["OSS Review Toolkit curation"] = 556,
    ["OSS Review Toolkit package configuration"] = 557,
    ["OSS Review Toolkit repository configuration"] = 558,
    ["OSS Review Toolkit resolutions"] = 559,
    ["October CMS columns"] = 529,
    ["October CMS fields"] = 530,
    Okteto = 531,
    Opctl = 828,
    ["Open Data Contract Standard (ODCS)"] = 542,
    ["Open Know-How"] = 1068,
    ["OpenRewrite Resource"] = 541,
    OpenStatus = 1079,
    ["OpenUtau character yaml"] = 535,
    ["OpenUtau ustx"] = 536,
    ["OpenWeather Current Weather API"] = 869,
    ["OpenWeather Road Risk API"] = 868,
    ["Ory Hydra configuration"] = 387,
    ["Ory Keto configuration"] = 442,
    ["Ory Kratos configuration"] = 547,
    ["Ory Oathkeeper configuration"] = 527,
    ["Outblocks App configuration"] = 544,
    ["Outblocks database table"] = 545,
    ["Outblocks project configuration"] = 543,
    PDM = 565,
    Packer = 562,
    Pantsbuild = 947,
    ["Paper paper-plugin.yml"] = 563,
    ["Pipeline component"] = 881,
    ["Platform.sh application"] = 2,
    ["Platform.sh routes"] = 3,
    ["Platform.sh services"] = 4,
    ["Plex Prerolls"] = 573,
    ["PocketMine plugin.yml"] = 570,
    ["Postman collection"] = 577,
    ["Power Pages Configuration"] = 1080,
    ["Preset list for a WinUtil"] = 1029,
    ["ProActions AI-Kit Configuration"] = 586,
    ["ProActions AI-Kit Configuration for Menus"] = 588,
    ["ProActions AI-Kit Configuration for Sections"] = 590,
    ["ProActions AI-Kit Configuration for Services"] = 587,
    ["ProActions AI-Kit Configuration for Steps"] = 591,
    ["ProActions AI-Kit Configuration for Templates"] = 589,
    ["Problem object RFC9457"] = 976,
    ["Problem package generators"] = 592,
    Pterodactyl = 927,
    ["Pull Request Labeler"] = 608,
    Pulumi = 616,
    ["PyGTA Config"] = 612,
    PyProject = 617,
    Pylock = 1071,
    Pyright = 618,
    ["Python script metadata"] = 1065,
    Qgoda = 620,
    Qodana = 900,
    ["Qt Creator workspace file"] = 1008,
    ["Quali Torque Blueprint Spec 2"] = 925,
    ["QueryFirst config file"] = 943,
    ["RKE Cluster Configuration JSON"] = 878,
    ["RKE Cluster Configuration YAML"] = 877,
    RadioHound = 611,
    Railway = 621,
    ["Rancher Fleet"] = 613,
    ["Rattler-build"] = 622,
    Ray = 842,
    ["Read the Docs"] = 615,
    ["Red-DiscordBot Cog"] = 629,
    ["Red-DiscordBot Cog Repo"] = 630,
    ["Red-DiscordBot Trivia"] = 631,
    ["Render Blueprints"] = 876,
    RenderCV = 644,
    Renovate = 643,
    ["Replit config"] = 637,
    Restate = 1058,
    RoadRunner = 646,
    ["Roo Coder Custom Modes"] = 648,
    Rubocop = 639,
    ["Rudder techniques"] = 983,
    Ruff = 640,
    ["Rust Project"] = 641,
    ["Rust toolchain"] = 651,
    ["SDMX data message"] = 677,
    ["SDMX metadata message"] = 676,
    ["SDMX structure message"] = 675,
    ["SIL Kit Participant Configuration"] = 687,
    ["SIL Kit Registry Configuration"] = 688,
    ["SPDX 2.3"] = 706,
    SWADL = 720,
    ["Safebox Config"] = 938,
    ["Sapphire CLI Config"] = 654,
    ["SauceCTL Configuration"] = 887,
    ["Schema Catalog"] = 669,
    ["Scoop manifest"] = 674,
    ["Semantic Data Fabric (SDF) file"] = 678,
    ["Semgrep Rule"] = 680,
    ["Serenity Code Generator (Sergen)"] = 681,
    ["Serverless Framework Configuration"] = 894,
    ["Serverless Workflow"] = 896,
    ["Settings for a Cinnamon spice"] = 1025,
    ["Settings.paf"] = 683,
    ["Shopware 6 Configuration"] = 897,
    ["Shopware CLI Extension Store Configuration"] = 898,
    ["Shopware CLI Project Store Configuration"] = 899,
    ["Sigma Detection Rule"] = 685,
    ["Sigrid scope configuration file"] = 686,
    ["SkyPilot Task JSON"] = 984,
    ["Slack app manifest"] = 690,
    Solidarity = 695,
    ["Solution filters"] = 696,
    ["Source Maps v3"] = 697,
    Sourcery = 698,
    ["Speakeasy Generation Config File"] = 702,
    ["Speakeasy Lint Configuration File"] = 699,
    ["Speakeasy Test Generation Configuration File"] = 700,
    ["Speakeasy Workflow File"] = 701,
    SpecIF = 703,
    ["Sponge Mixin configuration"] = 704,
    StackBlitz = 710,
    ["StackHawk Scanner Configuration"] = 893,
    Stale = 711,
    ["Starlake Data Pipeline"] = 866,
    Starship = 712,
    ["Statamic Blueprint"] = 713,
    ["Stella configuration file"] = 714,
    ["Stryker Mutator"] = 717,
    ["StyleCop Analyzers Configuration"] = 718,
    ["Stylelint (.stylelintrc)"] = 719,
    ["Stylua Config"] = 1072,
    ["Sublime Syntax"] = 939,
    ["Subsquid squid manifest"] = 986,
    ["Swagger API 2.0"] = 721,
    ["Synadia Connect Component"] = 722,
    TSON = 756,
    TSTyche = 757,
    ["TYPO3 Vendor Bundler config"] = 762,
    ["Tab data for a LinUtil"] = 1032,
    ["Tab list for a LinUtil"] = 1031,
    Tach = 723,
    ["Tach Domain"] = 724,
    Talhelper = 726,
    ["Talisman configuration"] = 727,
    Taplo = 1073,
    ["Taskfile config"] = 871,
    Taurus = 728,
    Tauticord = 729,
    Telefonistka = 1059,
    ["TestEnvironment.json"] = 739,
    ["TextMate Grammar"] = 738,
    ["Tier.run pricing.json"] = 732,
    Tikibase = 733,
    Tombi = 737,
    ["Traefik v2"] = 742,
    ["Traefik v2 File Provider"] = 743,
    ["Traefik v3"] = 744,
    ["Traefik v3 File Provider"] = 745,
    ["Travis CI (.travis.yml)"] = 741,
    Trident = 1056,
    ["TrueScript for *.tscript files"] = 748,
    ["Tugboat QA config.yml"] = 1053,
    TunnelHub = 974,
    Turborepo = 740,
    Tycho = 1021,
    Tye = 901,
    ["Tyk Gateway - Open Source v5.7+"] = 1064,
    ["Typst Manifest"] = 763,
    ["UET BuildConfig.json"] = 944,
    ["UI5 Manifest"] = 769,
    ["UNCORS configuration"] = 773,
    ["UTAM Page Object"] = 772,
    ["Ubuntu Server Autoinstall"] = 767,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1057,
    ["Uniswap Token List"] = 854,
    ["Universal Schedule Format"] = 774,
    ["Unreal Engine Uplugin"] = 945,
    ["Unreal Engine Uproject"] = 946,
    ["Updatecli Compose"] = 909,
    ["Updatecli Policy Manifest"] = 910,
    ["Updatecli Policy Metadata"] = 911,
    Uplift = 942,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 875,
    V2Ray = 915,
    ["VSCode Code Snippets"] = 203,
    ["VSIX CLI publishing"] = 794,
    Vector = 776,
    ["Vela Pipeline Configuration"] = 779,
    Vercel = 202,
    ["Version Bumper config"] = 784,
    ["Viash Component Config"] = 1061,
    ["Viash Package Config"] = 1062,
    Visivo = 972,
    Wake = 1055,
    ["Waku Config"] = 1035,
    ["Web App Manifest"] = 800,
    ["Web types"] = 803,
    WebExtensions = 799,
    ["Webman package recipe"] = 921,
    ["Windows Package Manager Installer Manifest"] = 850,
    ["Windows Package Manager Locale Manifest"] = 851,
    ["Windows Package Manager Singleton Manifest"] = 849,
    Winutil = 852,
    ["WireMock stub mapping"] = 1038,
    ["Woodpecker pipeline config"] = 889,
    ["Wrangler CLI"] = 804,
    ["Xstate Machine"] = 907,
    ["Yandex Workflow Language"] = 1027,
    ["Yarn Config (.yarnrc.yml)"] = 864,
    ["Yippee-Ki-JSON configuration YML"] = 856,
    ["YouTrack App"] = 1024,
    ["Zerops.io config"] = 1012,
    ["Zerops.io import"] = 1013,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 977,
    ...
    ["babelrc.json"] = 86,
    ["bamboo-spec"] = 89,
    ["bashly-strings.yml"] = 954,
    ["batect.yml"] = 88,
    ["beef-database-codegen"] = 90,
    ["beef-database-v5-codegen"] = 92,
    ["beef-entity-codegen"] = 91,
    ["beef-entity-v5-codegen"] = 93,
    ["behat.yml"] = 105,
    ["bigquery-table"] = 94,
    ["bioimageio resource description"] = 994,
    ...
    ["bozr.suite.json"] = 107,
    bpkg = 955,
    ["browser.i18n.json"] = 108,
    ["browsh configuration"] = 109,
    bucklescript = 110,
    ["buf.gen.yaml"] = 66,
    ["buf.plugin.yaml"] = 67,
    ["buf.work.yaml"] = 68,
    ...
    ["build-changelog"] = 111,
    ["bun.lock"] = 116,
    ["bundleconfig.json"] = 117,
    ["bunfig.toml"] = 118,
    ["cargo-mutants-config.yaml"] = 69,
    ["ccmod.json"] = 1036,
    changelogging = 1005,
    ["chisel-slices.json"] = 229,
    ["chrome-extension-locales-messages.json"] = 210,
    ["chutzpah.json"] = 211,
    cibuildwheel = 138,
    ["clang-format (.clang-format)"] = 913,
    ["clang-tidy"] = 190,
    clangd = 189,
    clib = 191,
    ["cloud-init: cloud-config userdata"] = 193,
    ["cloud-sdk-pipeline-configuration"] = 213,
    ["cloudbuild.json"] = 214,
    cloudify = 192,
    codemagic = 194,
    ["coffeelint.json"] = 231,
    ["commands.json"] = 206,
    ["commitlint (.commitlintrc)"] = 853,
    ["committed.toml"] = 232,
    ["compile_commands.json"] = 205,
    ["compilerconfig.json"] = 204,
    ["completely.yml"] = 950,
    ["component-detection-manifest.json"] = 235,
    ["component.json"] = 234,
    ["composer.json"] = 233,
    ["conda-forge"] = 141,
    ["config.yaml"] = 614,
    ["contentmanifest.json"] = 212,
    ["contribute.json"] = 236,
    ["cosmos.config.json"] = 208,
    ["crowdin.yml"] = 237,
    ["ctfd-setup configuration file"] = 1045,
    ["custom-elements.json"] = 964,
    ["cypress.json"] = 241,
    ["datalogic-scan2deploy-android"] = 251,
    ["datalogic-scan2deploy-ce"] = 252,
    ["dbt Dependencies"] = 157,
    ["dbt Packages"] = 159,
    ["dbt Project"] = 158,
    ["dbt Selectors"] = 160,
    ["dbt YAML files"] = 161,
    ["ddev-global"] = 253,
    ["ddev-project"] = 254,
    ["debugsettings.json"] = 255,
    ["dependabot-v2.json"] = 258,
    ["dependabot.json"] = 257,
    ["deployed-cli"] = 906,
    ["devcontainer.json"] = 196,
    devinit = 858,
    ["devspace.yaml"] = 929,
    djlint = 859,
    ["docker bake"] = 263,
    ["docker sequencer"] = 264,
    ["docker-compose.yml"] = 857,
    ["dockerd.json"] = 262,
    ["dotnet Release Index manifest"] = 275,
    ["dotnet-tools.json"] = 276,
    ["dotnetcli.host.json"] = 277,
    ["dprint.json"] = 278,
    ["drone.json"] = 279,
    ["dss-2.0.0.json"] = 281,
    ["dstack configuration"] = 282,
    ["dtool dataset metadata"] = 1040,
    ["dvc.yaml"] = 283,
    ["ecosystem.json"] = 288,
    eksctl = 289,
    ["electron-builder configuration file"] = 295,
    ["epr-manifest.json"] = 294,
    ["evcc.yaml"] = 296,
    ["ezd task runner"] = 306,
    ["fabric.mod.json"] = 308,
    ["first-timers-bot"] = 315,
    ["flagd flag configuration"] = 81,
    ["fly.io Configuration"] = 82,
    fulibWorkflows = 888,
    ["function.json"] = 326,
    ["gRPC API Gateway & OpenAPI Config"] = 7,
    ["gematik health care insurance list"] = 1051,
    ["gematik health care patient list"] = 1048,
    ["gematik health care provider institution list"] = 1050,
    ["gematik health care provider list"] = 1049,
    ["gematik tiger test environment configuration"] = 1052,
    ["gitlab-ci"] = 343,
    ["global.json"] = 359,
    ["go-feature-flag Flag Configuration"] = 362,
    ["haxelib.json"] = 377,
    helmfile = 845,
    helmwave = 846,
    ["host-meta.json"] = 384,
    ...
    ["ide.host.json"] = 391,
    ["ifstate.conf"] = 392,
    ["imageoptimizer.json"] = 393,
    ["importmap.json"] = 396,
    ["ioBroker Configuration"] = 398,
    ["ioBroker JSON UI"] = 399,
    ["ioBroker Package manifest"] = 400,
    ["ize.toml"] = 941,
    ["jsconfig.json"] = 425,
    ["jscpd Configuration"] = 926,
    jsdoc = 841,
    ["k3d.yaml"] = 426,
    ["k9s aliases.yaml"] = 428,
    ["k9s cluster-config.yaml"] = 430,
    ["k9s config.yaml"] = 429,
    ["k9s hotkeys.yaml"] = 431,
    ["k9s plugins.yaml"] = 432,
    ["k9s skin.yaml"] = 433,
    ["k9s views.yaml"] = 434,
    ["kontinuous-config.yaml"] = 444,
    ["kontinuous-values.yaml"] = 443,
    ["kustomization.yaml"] = 446,
    ["label-commenter-config.yml"] = 447,
    ["latexindent configuration"] = 75,
    ...
    ["lerna.json"] = 451,
    ["lgtm.yml"] = 452,
    ["liblab.config.json"] = 453,
    ["libman.json"] = 454,
    ["license-report-config.json"] = 455,
    ["linkinator.config.json"] = 457,
    ["lint-staged (.lintstagedrc)"] = 820,
    ["local.settings.json"] = 462,
    ["localazy.json"] = 463,
    ["lotus.yaml"] = 461,
    ["lsdlschema.json"] = 464,
    ["markdown-link-check"] = 884,
    maturin = 885,
    mboats = 892,
    ["micro-settings.json"] = 956,
    ["mimetypes.json"] = 476,
    ["mirrord config"] = 821,
    mise = 822,
    ["mkdocs.yml"] = 496,
    ["monospace.yml"] = 499,
    ["moon.yml"] = 1037,
    ["mprocs Configuration file"] = 1009,
    ["mrdocs.yml"] = 497,
    ["mta.yaml"] = 823,
    ["mtad.yaml"] = 824,
    ["mycode.json"] = 506,
    nFPM = 510,
    ["napari plugin manifest"] = 507,
    neoload = 836,
    ["nest-cli"] = 513,
    ["ninjs (News in JSON)"] = 512,
    ["nitro.json"] = 835,
    ["nixd configuration"] = 982,
    ["nlu.json"] = 514,
    ["nodemon.json"] = 516,
    ["noodl config"] = 891,
    ["notebook.mod.json"] = 517,
    now = 831,
    ["npm-badges"] = 520,
    ["nswag.json"] = 524,
    ntangle = 526,
    ["nuclei-template.yaml"] = 521,
    ["nuget-project.json"] = 522,
    ["ocelot.json"] = 528,
    ["omnisharp.json"] = 532,
    ["openapi.json"] = 533,
    ["openfin.json"] = 540,
    ...
    ["ops.yaml"] = 537,
    ["package.json"] = 560,
    ["package.manifest"] = 561,
    ["partial-black.json"] = 106,
    ["pathfinder.yml"] = 564,
    ["pattern.json"] = 567,
    ["petstore-v1.0"] = 936,
    pgap_yaml_input_reader = 566,
    ["pixi.toml"] = 568,
    ["plagiarize-me.yaml"] = 572,
    ["plagiarize.yaml"] = 571,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1041,
    ["podbard.yaml"] = 574,
    ["portman.json"] = 575,
    ["prefect.toml"] = 583,
    ["prettierrc.json"] = 584,
    ["prisma.yml"] = 585,
    ["project-1.0.0-beta3.json"] = 594,
    ["project-1.0.0-beta4.json"] = 595,
    ["project-1.0.0-beta5.json"] = 596,
    ["project-1.0.0-beta6.json"] = 597,
    ["project-1.0.0-beta8.json"] = 598,
    ["project-1.0.0-rc1.json"] = 599,
    ["project-1.0.0-rc2.json"] = 600,
    ["project.json"] = 593,
    ["project.owasp.yaml"] = 601,
    ["prometheus.json"] = 602,
    ["prometheus.rules.json"] = 603,
    ["prometheus.rules.test.json"] = 604,
    ["proxies.json"] = 605,
    ["publiccode.yml"] = 606,
    ["pubspec.yaml"] = 607,
    ["pyrseas-0.8.json"] = 610,
    pytest = 619,
    ["quilt.mod.json"] = 957,
    ["rc3 auth"] = 623,
    ["rc3 collection"] = 624,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 837,
    ["release-please-config.json"] = 633,
    ["release-please-manifest.json"] = 634,
    ["release-plz.toml"] = 635,
    ["renv.lock"] = 645,
    ["rivet.json"] = 981,
    ["rivet.yaml (legacy)"] = 980,
    rockcraft = 647,
    runny = 649,
    rustfmt = 650,
    sake = 1067,
    samt = 652,
    samtrc = 653,
    ["sarif-1.0.0.json"] = 655,
    ["sarif-2.0.0.json"] = 656,
    ["sarif-2.1.0"] = 666,
    ["sarif-2.1.0-rtm.2"] = 657,
    ["sarif-2.1.0-rtm.3"] = 659,
    ["sarif-2.1.0-rtm.4"] = 661,
    ["sarif-2.1.0-rtm.5"] = 663,
    ["sarif-2.1.0-rtm.6"] = 664,
    ["sarif-external-property-file-2.1.0"] = 667,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 658,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 660,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 662,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 665,
    ["scalingo.json configuration"] = 668,
    ["schema.org - Action"] = 670,
    ["schema.org - ContactPoint"] = 671,
    ["schema.org - Place"] = 672,
    ["schema.org - Thing"] = 673,
    ["secrethub.yml"] = 959,
    ["semantic-release"] = 679,
    ["servicehub.config.json"] = 815,
    ["servicehub.service.json"] = 814,
    ["settings.job"] = 682,
    ["sfdx-hardis configuration"] = 684,
    ["shard.yml"] = 997,
    ["size-limit configuration"] = 689,
    ["skaffold.yaml"] = 882,
    ["skyuxconfig.json"] = 691,
    snapcraft = 692,
    ["snowflake-config"] = 693,
    ["snowflake-connections"] = 694,
    ["spicepod.yaml"] = 1016,
    ["sqlc configuration"] = 707,
    ["stripe-app-local.json"] = 716,
    ["stripe-app.json"] = 715,
    swcrc = 867,
    ["task.json"] = 725,
    taskcat = 832,
    ["template.json"] = 730,
    ["templatsources.json"] = 731,
    ["theme.json"] = 734,
    ["tizen_workspace.json"] = 735,
    tldr = 736,
    ["tm_devices configuration file"] = 1078,
    tmuxinator = 818,
    ["transcend.yml"] = 746,
    ["tree-sitter grammar.json"] = 367,
    ["trime.yaml"] = 747,
    ["trunk.yaml"] = 749,
    ["ts-force-config.json"] = 754,
    ["tsconfig.json"] = 750,
    ["tsd.json"] = 751,
    ["tsdoc.json"] = 752,
    ["tsdrc.json"] = 753,
    ...
    v8r = 798,
    vcluster = 1003,
    ["vcpkg configuration file"] = 201,
    ["vcpkg manifest file"] = 200,
    ["vega-lite.json"] = 778,
    ["vega.json"] = 777,
    ["venvironment-basic.yaml"] = 781,
    ["venvironment.yaml"] = 780,
    ["venvplus-basic.yaml"] = 783,
    ["venvplus.yaml"] = 782,
    version = 1060,
    ["version.json"] = 785,
    ["vhwdebugger-binding.yaml"] = 787,
    ["vim-addon-info"] = 788,
    ["vs-2017.3.host.json"] = 790,
    ["vs-nesting.json"] = 791,
    ["vsls.json"] = 789,
    ["vss-extension.json"] = 795,
    vtcfg = 1066,
    ["vtesttree.yaml"] = 796,
    ["vtestunit.yaml"] = 797,
    ["warp-keysets.json"] = 965,
    ["warp-themes.json"] = 966,
    ["warp-workflows.json"] = 967,
    ["webhint.io"] = 922,
    ["webjobpublishsettings.json"] = 802,
    ["webjobs-list.json"] = 801,
    ["well-known-fursona"] = 1004,
    ["xs-app.json"] = 827,
    ["xunit.runner.json"] = 813,
    yamllint = 855,
    zuul = 838,
    ["Žinoma"] = 848
  },
