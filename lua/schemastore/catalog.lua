...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 195,
    [".cryproj (generic)"] = 660,
    [".cryproj engine-5.2"] = 655,
    [".cryproj engine-5.3"] = 656,
    [".cryproj engine-5.4"] = 657,
    [".cryproj engine-5.5"] = 658,
    [".cryproj engine-dev"] = 659,
    [".eslintrc"] = 251,
    [".esmrc.json"] = 243,
    [".ffizer.yaml"] = 255,
    [".htmlhintrc"] = 311,
    ...
    [".mtaext"] = 671,
    [".nodehawkrc"] = 421,
    [".npmpackagejsonlintrc"] = 425,
    [".phrase.yml"] = 471,
    [".phraseapp.yml"] = 472,
    [".pmbot.yml"] = 461,
    [".postcssrc"] = 466,
    [".powerpages-web-template-manifest"] = 468,
    [".pre-commit-config.yml"] = 469,
    [".pre-commit-hooks.yml"] = 470,
    [".putout.json"] = 491,
    [".rehyperc"] = 504,
    [".remarkrc"] = 506,
    [".sprite files"] = 564,
    ...
    ["<div>RIOTS' studio configuration"] = 638,
    ["@factorial/drupal-breakpoints-css"] = 5,
    ["A micro editor config"] = 375,
    AIConfig = 12,
    ["API Builder"] = 703,
    ["AVA Configuration"] = 763,
    ...
    ["Adobe UXP Manifest"] = 828,
    ["Aerleon Network & Service Definitions"] = 8,
    ["Aerleon Policy"] = 9,
    ["Airlock Microgateway"] = 13,
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 735,
    ["All Contributors configuration file"] = 793,
    ...
    AutoAPICase = 803,
    ["Avro Avsc"] = 48,
    ["Azure Container App template for defining an immutable revision"] = 49,
    ["Azure DevOps extension manifest"] = 52,
    ["Azure Device Update for IoT Hub import manifest"] = 50,
    ["Azure Device Update for IoT Hub update manifest"] = 51,
    ["Azure IoT Edge deployment"] = 55,
    ["Azure IoT Edge deployment template"] = 56,
    ["Azure IoT EdgeAgent deployment"] = 53,
    ["Azure IoT EdgeHub deployment"] = 54,
    ["Azure Pipelines"] = 65,
    ["Azure Static Web Apps CLI configuration file"] = 567,
    ["Azure Static Web Apps configuration file"] = 566,
    ["BX CI"] = 103,
    ["Bashly (bashly.yml)"] = 797,
    ["Bashly Settings (bashly-settings.yml)"] = 798,
    ["Better Code Hub"] = 707,
    ["Better Scripts"] = 104,
    Bigconfig = 82,
    BizTalkServerApplicationSchema = 677,
    Bleep = 105,
    ...
    ["Butane Config"] = 748,
    ["CGS Custom Card Game (CardGameDef.json)"] = 833,
    ["CICS TS region tagging"] = 757,
    ["CICS TS resource import"] = 758,
    ["CICS TS resource model"] = 759,
    ["CICS TS resource overrides"] = 760,
    ["CMake Presets"] = 106,
    ["CNC Codes"] = 118,
    ["CSS Comb (.csscomb.json)"] = 197,
    ["CSS Lint (.csslintrc)"] = 198,
    ["CSpell (cspell.json)"] = 196,
    CWL = 839,
    ...
    ["Chromia Model"] = 113,
    ["CircleCI config.yml"] = 149,
    ["Citation File Format"] = 184,
    CityJSON = 115,
    ["Clawject config"] = 123,
    ["Code Climate"] = 150,
    CodeCV = 62,
    ...
    Codux = 158,
    ["Cog config file"] = 119,
    ["Commandbox Box.json"] = 120,
    ["Commandbox Server.json"] = 121,
    ["Common Catalog Data"] = 170,
    Conjure = 117,
    ["Container Structure Test"] = 690,
    Containerlab = 715,
    ["Crowdsec collection config"] = 191,
    ["Crowdsec parser config"] = 192,
    ["Crowdsec scenario config"] = 193,
    ["CumulusCI Config"] = 122,
    ["Custom Machinery Machine"] = 834,
    ["Custom Machinery Recipe"] = 835,
    ["Cycle Stack File"] = 124,
    ["DWP Exchange - catalogue entry"] = 238,
    ["DWP Exchange - gateway"] = 236,
    ["DWP Exchange - meta"] = 237,
    ["Dart Build Config (dart-build.json)"] = 199,
    ["Dart Test Config (dart-test.json)"] = 200,
    ["DashLord Configuration"] = 201,
    ["Data Contract Specification"] = 202,
    ["Data Product Specification"] = 203,
    ["DataYoga Connections"] = 125,
    ["DataYoga Job"] = 126,
    ["Databricks Asset Bundles"] = 814,
    ["Datadog Service Definition"] = 352,
    ["Datahub Ingestion Recipe"] = 764,
    ["Dein Config"] = 128,
    ["Deno Config (deno.json)"] = 209,
    ["Dependency cruiser"] = 129,
    ["Deployer Recipe"] = 212,
    ["Deta Spacefile"] = 130,
    ["Detekt Config (detekt.yml)"] = 213,
    ["Devbox Config"] = 131,
    ["Devbox Plugin"] = 132,
    Devfile = 235,
    ["Discord Webhook"] = 214,
    ["DocFx Config (docfx.json)"] = 217,
    ["Dolittle Artifacts"] = 218,
    ["Dolittle Bounded Context Configuration"] = 219,
    ["Dolittle Event Horizons Configuration"] = 220,
    ["Dolittle Resources Configuration"] = 221,
    ["Dolittle Server Configuration"] = 222,
    ["Dolittle Tenant Map Configuration"] = 224,
    ["Dolittle Tenants Configuration"] = 223,
    ["Dolittle Topology"] = 225,
    ["Drupal Breakpoints"] = 133,
    ["Drupal Config"] = 144,
    ["Drupal Info"] = 134,
    ["Drupal Layouts"] = 135,
    ["Drupal Libraries"] = 136,
    ["Drupal Links Action"] = 137,
    ["Drupal Links Contextual"] = 138,
    ["Drupal Links Menu"] = 139,
    ["Drupal Links Task"] = 140,
    ["Drupal Migration"] = 141,
    ["Drupal Permissions"] = 142,
    ["Drupal Routing"] = 143,
    ["Drupal Services"] = 145,
    ["Drush site aliases"] = 231,
    ["Dynamic Bash Aliases (.aliases)"] = 805,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 794,
    ["Elgato Stream Deck"] = 241,
    ["Embrace Config"] = 775,
    Endurica = 818,
    ["Enterprise Contract Policy Spec"] = 242,
    ["Erda Pipeline"] = 841,
    ["Erda Runtime"] = 842,
    ["Error pages"] = 246,
    Esquio = 244,
    ["Estuary Flow Catalog"] = 754,
    ["Expo SDK"] = 249,
    ["F-Droid Data metadata"] = 254,
    ["Facets - FSDL - Application"] = 252,
    ["FasterCI Configuration"] = 66,
    FiQuS = 258,
    Firebase = 256,
    ["Flow.json Configurations"] = 838,
    ["Fossa configuration file"] = 265,
    ["Fossa's fossa-deps file"] = 266,
    ["Foundry VTT - Base package Manifest"] = 260,
    ["Foundry VTT - Module Manifest"] = 261,
    ["Foundry VTT - System Data Template"] = 264,
    ["Foundry VTT - System Manifest"] = 262,
    ["Foundry VTT - World Manifest"] = 263,
    ["Foxx Manifest"] = 67,
    ["Freifunk.de Community API"] = 70,
    ["Frogbot Config"] = 71,
    ["G2P Mapping Configuration"] = 270,
    ["GCP Blueprint Metadata"] = 273,
    Gaspar = 271,
    ["GatewayCore API Gateway"] = 272,
    ["GeoJSON.json latest"] = 752,
    GherKing = 756,
    ["GitHub Action"] = 278,
    ["GitHub Discussion"] = 279,
    ["GitHub Funding"] = 280,
    ["GitHub Issue Template configuration"] = 282,
    ["GitHub Issue Template forms"] = 281,
    ["GitHub Workflow"] = 283,
    ["GitHub Workflow Template Properties"] = 284,
    ["GitLab Agent for Kubernetes configuration"] = 830,
    GitVersion = 275,
    ["Gitea Issue Template configuration"] = 276,
    ["Gitea Issue Template forms"] = 277,
    ["Gitpod Configuration"] = 286,
    ["GlazeWM settings"] = 832,
    ["Global Privacy Control"] = 274,
    Goblet = 813,
    ["Golangci-lint Configuration"] = 288,
    ["Golangci-lint Custom Plugins Configuration"] = 289,
    ["Google Chrome Related Website Sets"] = 257,
    ["Google Cloud Workflows"] = 178,
    Goreleaser = 291,
    ["Goreleaser Pro"] = 292,
    Goss = 293,
    ["Gradle Build Cache Node"] = 705,
    ["Gradle Enterprise"] = 704,
    ["Grafana 5.x Dashboard"] = 294,
    ["GraphQL Code Generator"] = 298,
    ["GraphQL Config"] = 297,
    ["GraphQL Mesh"] = 296,
    ["Grunt JSHint task"] = 302,
    ["Grunt Watch task"] = 303,
    ["Grunt base task"] = 304,
    ["Grunt clean task"] = 300,
    ["Grunt copy task"] = 299,
    ["Grunt cssmin task"] = 301,
    HEMTT = 674,
    Hadolint = 686,
    Hammerkit = 714,
    ["Hardware Sentry Configuration"] = 768,
    Hatch = 687,
    Hayson = 306,
    ["Haystack Pipeline"] = 307,
    ["Hazelcast 5 Configuration"] = 308,
    ["Helm Chart.lock"] = 147,
    ["Helm Chart.yaml"] = 146,
    ["Helm Unittest Test Suite"] = 148,
    Hugo = 744,
    ["Hugo Theme"] = 743,
    ["IBM Zapp document"] = 313,
    ["IBM zCodeFormatSettings"] = 314,
    ["IMG Catapult PSP"] = 319,
    ["IVMS101 by CODE Protocol"] = 831,
    Istanbul = 771,
    ["JDownloader2 crawler multi-rules"] = 329,
    ["JDownloader2 crawler single-rules"] = 328,
    ["JFrog Applications Config"] = 330,
    ["JFrog File Spec"] = 331,
    ["JFrog Pipelines YML DSL"] = 777,
    ["JMeter DSL cli config"] = 332,
    JReleaser = 334,
    ["JSON Document Transform"] = 342,
    ["JSON Feed"] = 343,
    ["JSON Resume"] = 511,
    ["JSON Schema Draft 2020-12"] = 651,
    ["JSON Schema Draft 4"] = 648,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 815,
    ["JSON Schema Draft 7"] = 649,
    ["JSON Schema Draft 7 (unofficial strict)"] = 816,
    ["JSON Schema Draft 8 (2019-09)"] = 650,
    ["JSON-API"] = 341,
    ["JSON-WF"] = 844,
    ["JSON-e templates"] = 712,
    ["JSON-stat 2.0"] = 645,
    JSONPatch = 345,
    ["JSR Package Config (jsr.json)"] = 335,
    Jasmine = 324,
    Jekyll = 325,
    ["Jenkins X Pipelines"] = 326,
    ["Jenkins X Requirements"] = 327,
    ["Jovo Language Models"] = 333,
    ["KIMMDY config file"] = 350,
    ["KSP-AVC"] = 646,
    ["KSP-CKAN"] = 647,
    KSY = 843,
    ["Karakum configuration file"] = 267,
    Kas = 348,
    ["Keycloak REST API"] = 785,
    ["Knative Functions - func.yaml"] = 268,
    ["KoDE/CI build.yaml"] = 773,
    ["Kong DBLess config"] = 774,
    KrakenD = 351,
    LOOBin = 370,
    Lefthook = 359,
    ["Liferay client-extension.yaml"] = 366,
    ["LinkML Metamodel"] = 368,
    Liquibase = 720,
    ["Liquibase Flow File"] = 721,
    ["Lively Properties"] = 369,
    ["Lobe AI Agent"] = 64,
    ["MLOS Configs"] = 404,
    ["MS2Rescore Configuration"] = 407,
    ["Madness (madness.yml)"] = 796,
    Markdownlint = 724,
    ["Mason Registry"] = 726,
    ["MegaLinter configuration"] = 376,
    ["MegaLinter descriptor"] = 377,
    Melange = 822,
    ["Meltano plugin discovery definition"] = 379,
    ["Meltano project definition"] = 378,
    ["Mergify Configuration"] = 408,
    ["MetricsHub Configuration"] = 380,
    ["MetricsHub Connector Configuration"] = 381,
    ["Micro Editor Syntax"] = 806,
    ["Microsoft Band Web Tile"] = 382,
    ["Minecraft Custom Main Menu Mod"] = 823,
    ["Minecraft Data Pack Advancement"] = 384,
    ["Minecraft Data Pack Biome"] = 385,
    ["Minecraft Data Pack Configured Carver"] = 386,
    ["Minecraft Data Pack Damage Type"] = 387,
    ["Minecraft Data Pack Dimension"] = 389,
    ["Minecraft Data Pack Dimension Type"] = 388,
    ["Minecraft Data Pack Item Modifier"] = 390,
    ["Minecraft Data Pack Loot Table"] = 391,
    ["Minecraft Data Pack Metadata"] = 392,
    ["Minecraft Data Pack Predicate"] = 393,
    ["Minecraft Data Pack Recipe"] = 394,
    ["Minecraft Data Pack Tag"] = 395,
    ["Minecraft Data Pack Template Pool"] = 396,
    ["Minecraft Data Pack Trim Material"] = 401,
    ["Minecraft Data Pack Trim Pattern"] = 402,
    ["Minecraft Resource Pack Lang"] = 397,
    ["Minecraft Resource Pack Particle"] = 398,
    ["Minecraft Resource Pack Texture Mcmeta"] = 400,
    ["Minecraft Resourcepack Sounds"] = 399,
    ["MkDocs Configuration 1.0"] = 403,
    ["Monade CLI Stack Configuration"] = 411,
    ["MongoDB Atlas Search Index Definition"] = 772,
    ["Monika Configuration"] = 770,
    ["Monoweave Configuration"] = 406,
    ["Motif config"] = 670,
    ["NOX Framework (Service)"] = 424,
    ["Netin Diagnostic System Template"] = 730,
    ["Netlify config"] = 414,
    ["Network-as-Code Data Model"] = 415,
    ["Nightwatch.js"] = 416,
    ["Nuitka.yaml"] = 836,
    ["ONe's changelog entry"] = 440,
    ["ONe's service descriptor"] = 439,
    ["OSS Review Toolkit configuration"] = 447,
    ["OSS Review Toolkit curation"] = 448,
    ["OSS Review Toolkit package configuration"] = 449,
    ["OSS Review Toolkit repository configuration"] = 450,
    ["OSS Review Toolkit resolutions"] = 451,
    Opctl = 673,
    ["OpenRewrite Resource"] = 442,
    ["OpenUtau character yaml"] = 436,
    ["OpenUtau ustx"] = 437,
    ["OpenWeather Current Weather API"] = 711,
    ["OpenWeather Road Risk API"] = 710,
    ["Ory Hydra configuration"] = 312,
    ["Ory Keto configuration"] = 353,
    ["Ory Kratos configuration"] = 446,
    ["Ory Oathkeeper configuration"] = 431,
    ["Outblocks App configuration"] = 444,
    ["Outblocks database table"] = 445,
    ["Outblocks project configuration"] = 443,
    PDM = 457,
    Packer = 454,
    Pantsbuild = 792,
    ["Paper paper-plugin.yml"] = 455,
    ["Pipeline component"] = 722,
    ["PocketMine plugin.yml"] = 462,
    ["Postman collection"] = 467,
    ["Problem object RFC9457"] = 820,
    ["Problem package generators"] = 475,
    Pterodactyl = 767,
    ["Pull Request Labeler"] = 490,
    Pulumi = 496,
    PyProject = 497,
    Pyright = 498,
    Qgoda = 499,
    Qodana = 740,
    ["Quali Torque Blueprint Spec 2"] = 765,
    ["QueryFirst config file"] = 788,
    ["RKE Cluster Configuration JSON"] = 719,
    ["RKE Cluster Configuration YAML"] = 718,
    ["Rancher Fleet"] = 493,
    ["Rattler-build"] = 500,
    Ray = 685,
    ["Read the Docs"] = 495,
    ["Red-DiscordBot Cog"] = 501,
    ["Red-DiscordBot Cog Repo"] = 502,
    ["Red-DiscordBot Trivia"] = 503,
    ["Render Blueprints"] = 717,
    RenderCV = 513,
    Renovate = 512,
    ["Replit config"] = 507,
    RoadRunner = 514,
    ["Rudder techniques"] = 826,
    Ruff = 509,
    ["Rust Project"] = 510,
    ["Rust toolchain"] = 517,
    ["SDMX data message"] = 542,
    ["SDMX metadata message"] = 541,
    ["SDMX structure message"] = 540,
    ["SIL Kit Participant Configuration"] = 552,
    ["SIL Kit Registry Configuration"] = 553,
    SWADL = 578,
    ["Safebox Config"] = 778,
    ["Sapphire CLI Config"] = 520,
    ["SauceCTL Configuration"] = 727,
    ["Schema Catalog"] = 534,
    ["Scoop manifest"] = 539,
    ["Semantic Data Fabric (SDF) file"] = 543,
    ["Semgrep Rule"] = 545,
    ["Serenity Code Generator (Sergen)"] = 546,
    ["Serverless Framework Configuration"] = 734,
    ["Serverless Workflow"] = 736,
    ["Settings.paf"] = 548,
    ["Shopware 6 Configuration"] = 737,
    ["Shopware CLI Extension Store Configuration"] = 738,
    ["Shopware CLI Project Store Configuration"] = 739,
    Sigma = 550,
    ["Sigrid scope configuration file"] = 551,
    ["SkyPilot Task JSON"] = 827,
    ["Slack app manifest"] = 555,
    Solidarity = 558,
    ["Solution filters"] = 559,
    ["Source Maps v3"] = 560,
    Sourcery = 561,
    SpecIF = 562,
    ["Sponge Mixin configuration"] = 563,
    StackBlitz = 568,
    ["StackHawk Scanner Configuration"] = 733,
    Stale = 569,
    ["Starlake Data Pipeline"] = 708,
    Starship = 570,
    ["Statamic Blueprint"] = 571,
    ["Stella configuration file"] = 572,
    ["StrmPrivacy Data Connector"] = 782,
    ["StrmPrivacy Data Contract"] = 783,
    ["StrmPrivacy SimpleSchema"] = 780,
    ["StrmPrivacy Stream"] = 781,
    ["StrmPrivacy batch job configuration file"] = 779,
    ["Stryker Mutator"] = 575,
    ["StyleCop Analyzers Configuration"] = 576,
    ["Stylelint (.stylelintrc)"] = 577,
    ["Sublime Syntax"] = 784,
    ["Subsquid squid manifest"] = 829,
    ["Swagger API 2.0"] = 579,
    TSON = 605,
    TSTyche = 606,
    Talhelper = 581,
    ["Talisman configuration"] = 582,
    ["Taskfile config"] = 713,
    Taurus = 583,
    ["TestEnvironment.json"] = 592,
    ["TextMate Grammar"] = 591,
    ["Tier.run pricing.json"] = 586,
    Tikibase = 587,
    ["Traefik v2"] = 595,
    ["Traefik v2 File Provider"] = 596,
    ["Travis CI (.travis.yml)"] = 594,
    TunnelHub = 819,
    Turborepo = 593,
    Tye = 741,
    ["UET BuildConfig.json"] = 789,
    ["UI5 Manifest"] = 615,
    ["UNCORS configuration"] = 619,
    ["UTAM Page Object"] = 618,
    ["Ubuntu Server Autoinstall"] = 613,
    ["Uniswap Token List"] = 696,
    ["Unreal Engine Uplugin"] = 790,
    ["Unreal Engine Uproject"] = 791,
    ["Updatecli Compose"] = 749,
    ["Updatecli Policy Manifest"] = 750,
    ["Updatecli Policy Metadata"] = 751,
    Uplift = 787,
    ["User Journey Map"] = 716,
    V2Ray = 755,
    ["VSCode Code Snippets"] = 166,
    ["VSIX CLI publishing"] = 633,
    ["Vela Pipeline Configuration"] = 622,
    Vercel = 165,
    Visivo = 817,
    ["Web App Manifest"] = 640,
    ["Web types"] = 643,
    WebExtensions = 639,
    ["Webman package recipe"] = 761,
    ["Windows Package Manager Installer Manifest"] = 693,
    ["Windows Package Manager Locale Manifest"] = 694,
    ["Windows Package Manager Singleton Manifest"] = 692,
    ["Woodpecker pipeline config"] = 729,
    ["Wrangler CLI"] = 644,
    ["Xstate Machine"] = 747,
    ["Yarn Config (.yarnrc.yml)"] = 706,
    ["Yippee-Ki-JSON configuration YML"] = 698,
    ["aerleon.yml"] = 7,
    ["angular.json"] = 15,
    apko = 821,
    ...
    ["behat.yml"] = 89,
    ["bigquery-table"] = 81,
    ["bioimageio resource description"] = 837,
    ["bitbucket-pipelines"] = 83,
    bitrise = 84,
    ["bitrise-step"] = 85,
    ["block.json"] = 101,
    ["bottom configuration"] = 57,
    ["bower.json"] = 87,
    ["bozr.suite.json"] = 91,
    bpkg = 800,
    ...
    ["chisel-slices.json"] = 183,
    ["chrome-extension-locales-messages.json"] = 173,
    ["chutzpah.json"] = 174,
    cibuildwheel = 114,
    ["clang-format (.clang-format)"] = 753,
    clangd = 153,
    clib = 154,
    ...
    ["coffeelint.json"] = 185,
    ["commands.json"] = 169,
    ["commitlint (.commitlintrc)"] = 695,
    ["compile_commands.json"] = 168,
    ["compilerconfig.json"] = 167,
    ["completely.yml"] = 795,
    ["component-detection-manifest.json"] = 188,
    ["component.json"] = 187,
    ["composer.json"] = 186,
    ["conda-forge"] = 116,
    ["config.yaml"] = 494,
    ...
    ["crowdin.yml"] = 190,
    ["custom-elements.json"] = 809,
    ["cypress.json"] = 194,
    ["datalogic-scan2deploy-android"] = 204,
    ["datalogic-scan2deploy-ce"] = 205,
    ["dbt Project"] = 127,
    ["ddev-global"] = 206,
    ["ddev-project"] = 207,
    ["debugsettings.json"] = 208,
    ["dependabot-v2.json"] = 211,
    ["dependabot.json"] = 210,
    ["deployed-cli"] = 746,
    ...
    ["devspace.yaml"] = 769,
    djlint = 701,
    ["docker sequencer"] = 216,
    ["docker-compose.yml"] = 699,
    ["dockerd.json"] = 215,
    ["dotnet Release Index manifest"] = 226,
    ["dotnet-tools.json"] = 227,
    ["dotnetcli.host.json"] = 228,
    ["dprint.json"] = 229,
    ["drone.json"] = 230,
    ["dss-2.0.0.json"] = 232,
    ["dstack configuration"] = 233,
    ["dvc.yaml"] = 234,
    ["ecosystem.json"] = 239,
    eksctl = 240,
    ["electron-builder configuration file"] = 247,
    ["epr-manifest.json"] = 245,
    ["evcc.yaml"] = 248,
    ["ezd task runner"] = 250,
    ["fabric.mod.json"] = 253,
    ["first-timers-bot"] = 259,
    ...
    ["gitlab-ci"] = 285,
    ["global.json"] = 287,
    ["go-feature-flag Flag Configuration"] = 290,
    ["haxelib.json"] = 305,
    helmfile = 688,
    helmwave = 689,
    ["host-meta.json"] = 310,
    ...
    ["ide.host.json"] = 315,
    ["ifstate.conf"] = 316,
    ["imageoptimizer.json"] = 317,
    ["importmap.json"] = 320,
    ["ioBroker Configuration"] = 321,
    ["ioBroker JSON UI"] = 322,
    ["ioBroker Package manifest"] = 323,
    ["ize.toml"] = 786,
    ["jsconfig.json"] = 346,
    ["jscpd Configuration"] = 766,
    jsdoc = 684,
    ["k3d.yaml"] = 347,
    ["k9s plugin.yml"] = 349,
    ["kontinuous-config.yaml"] = 355,
    ["kontinuous-values.yaml"] = 354,
    ["kustomization.yaml"] = 356,
    ["label-commenter-config.yml"] = 357,
    ["latexindent configuration"] = 63,
    ["launchsettings.json"] = 358,
    lazydocker = 808,
    lazygit = 807,
    ["lego.json"] = 360,
    ["lerna.json"] = 361,
    ["lgtm.yml"] = 362,
    ["liblab.config.json"] = 363,
    ["libman.json"] = 364,
    ["license-report-config.json"] = 365,
    ["linkinator.config.json"] = 367,
    ["lint-staged (.lintstagedrc)"] = 664,
    ["local.settings.json"] = 372,
    ["localazy.json"] = 373,
    ["lotus.yaml"] = 371,
    ["lsdlschema.json"] = 374,
    ["markdown-link-check"] = 725,
    mboats = 732,
    ["micro-settings.json"] = 801,
    ["mimetypes.json"] = 383,
    ["mirrord config"] = 665,
    mise = 666,
    ["mise-settings"] = 667,
    ...
    ["mtad.yaml"] = 669,
    ["mycode.json"] = 412,
    ["napari plugin manifest"] = 413,
    neoload = 679,
    ["nest-cli"] = 419,
    ["ninjs (News in JSON) 1.3"] = 418,
    ["ninjs (News in JSON) 2.0"] = 417,
    ["nixd configuration"] = 825,
    ["nlu.json"] = 420,
    ["nodemon.json"] = 422,
    ["noodl config"] = 731,
    ["notebook.mod.json"] = 423,
    now = 675,
    ["npm-badges"] = 426,
    ["nswag.json"] = 429,
    ntangle = 430,
    ["nuclei-template.yaml"] = 427,
    ["nuget-project.json"] = 428,
    ["ocelot.json"] = 432,
    ["omnisharp.json"] = 433,
    ["openapi.json"] = 434,
    ["openfin.json"] = 441,
    ...
    ["ops.yaml"] = 438,
    ["package.json"] = 452,
    ["package.manifest"] = 453,
    ["partial-black.json"] = 90,
    ["pathfinder.yml"] = 456,
    ["pattern.json"] = 459,
    ["petstore-v1.0"] = 776,
    pgap_yaml_input_reader = 458,
    ["pixi.toml"] = 460,
    ["plagiarize-me.yaml"] = 464,
    ["plagiarize.yaml"] = 463,
    ["portman.json"] = 465,
    ["prettierrc.json"] = 473,
    ["prisma.yml"] = 474,
    ["project-1.0.0-beta3.json"] = 477,
    ["project-1.0.0-beta4.json"] = 478,
    ["project-1.0.0-beta5.json"] = 479,
    ["project-1.0.0-beta6.json"] = 480,
    ["project-1.0.0-beta8.json"] = 481,
    ["project-1.0.0-rc1.json"] = 482,
    ["project-1.0.0-rc2.json"] = 483,
    ["project.json"] = 476,
    ["prometheus.json"] = 484,
    ["prometheus.rules.json"] = 485,
    ["prometheus.rules.test.json"] = 486,
    ["proxies.json"] = 487,
    ["publiccode.yml"] = 488,
    ["pubspec.yaml"] = 489,
    ["pyrseas-0.8.json"] = 492,
    ["quilt.mod.json"] = 802,
    ["release drafter"] = 680,
    ["release-plz.toml"] = 505,
    ["rivet.yaml"] = 824,
    rockcraft = 515,
    rustfmt = 516,
    samt = 518,
    samtrc = 519,
    ["sarif-1.0.0.json"] = 521,
    ["sarif-2.0.0.json"] = 522,
    ["sarif-2.1.0"] = 532,
    ["sarif-2.1.0-rtm.2"] = 523,
    ["sarif-2.1.0-rtm.3"] = 525,
    ["sarif-2.1.0-rtm.4"] = 527,
    ["sarif-2.1.0-rtm.5"] = 529,
    ["sarif-2.1.0-rtm.6"] = 530,
    ["sarif-external-property-file-2.1.0"] = 533,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 524,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 526,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 528,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 531,
    ["schema.org - Action"] = 535,
    ["schema.org - ContactPoint"] = 536,
    ["schema.org - Place"] = 537,
    ["schema.org - Thing"] = 538,
    ["secrethub.yml"] = 804,
    ["semantic-release"] = 544,
    ["servicehub.config.json"] = 654,
    ["servicehub.service.json"] = 653,
    ["settings.job"] = 547,
    ["sfdx-hardis configuration"] = 549,
    ["shard.yml"] = 840,
    ["size-limit configuration"] = 554,
    ["skaffold.yaml"] = 723,
    ["skyuxconfig.json"] = 556,
    snapcraft = 557,
    ["sqlc configuration"] = 565,
    ["stripe-app-local.json"] = 574,
    ["stripe-app.json"] = 573,
    swcrc = 709,
    ["task.json"] = 580,
    taskcat = 676,
    ["template.json"] = 584,
    ["templatsources.json"] = 585,
    ["theme.json"] = 588,
    ["tizen_workspace.json"] = 589,
    tldr = 590,
    tmuxinator = 662,
    ["transcend.yml"] = 597,
    ["tree-sitter grammar.json"] = 295,
    ["trime.yaml"] = 598,
    ["trunk.yaml"] = 599,
    ["ts-force-config.json"] = 603,
    ["tsconfig.json"] = 600,
    ["tsd.json"] = 601,
    ["tsdrc.json"] = 602,
    ["tslint.json"] = 604,
    ...
    ["vega-lite.json"] = 621,
    ["vega.json"] = 620,
    ["venvironment-basic.yaml"] = 624,
    ["venvironment.yaml"] = 623,
    ["version.json"] = 625,
    ["vim-addon-info"] = 627,
    ["vs-2017.3.host.json"] = 629,
    ["vs-nesting.json"] = 630,
    ["vsls.json"] = 628,
    ["vss-extension.json"] = 634,
    ["vtesttree.yaml"] = 635,
    ["vtestunit.yaml"] = 636,
    ["warp-keysets.json"] = 810,
    ["warp-themes.json"] = 811,
    ["warp-workflows.json"] = 812,
    ["webhint.io"] = 762,
    ["webjobpublishsettings.json"] = 642,
    ["webjobs-list.json"] = 641,
    ["xs-app.json"] = 672,
    ["xunit.runner.json"] = 652,
    yamllint = 697,
    zuul = 681,
    ["Žinoma"] = 691
  },
