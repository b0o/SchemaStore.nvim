...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 216,
    [".cryproj (generic)"] = 694,
    [".cryproj engine-5.2"] = 689,
    [".cryproj engine-5.3"] = 690,
    [".cryproj engine-5.4"] = 691,
    [".cryproj engine-5.5"] = 692,
    [".cryproj engine-dev"] = 693,
    [".eslintrc"] = 273,
    [".esmrc.json"] = 264,
    [".ffizer.yaml"] = 277,
    [".htmlhintrc"] = 334,
    ...
    [".mtaext"] = 705,
    [".nodehawkrc"] = 447,
    [".npmpackagejsonlintrc"] = 451,
    [".omletrc"] = 880,
    [".phrase.yml"] = 498,
    [".phraseapp.yml"] = 499,
    [".pmbot.yml"] = 488,
    [".postcssrc"] = 493,
    [".powerpages-web-template-manifest"] = 495,
    [".pre-commit-config.yml"] = 496,
    [".pre-commit-hooks.yml"] = 497,
    [".putout.json"] = 518,
    [".rehyperc"] = 537,
    [".remarkrc"] = 539,
    [".sprite files"] = 597,
    ...
    ["<div>RIOTS' studio configuration"] = 672,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 402,
    ABCSupplyPlan = 13,
    AIConfig = 14,
    ["API Builder"] = 737,
    ["AVA Configuration"] = 797,
    ...
    ["Adobe UXP Manifest"] = 862,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 15,
    ["Airplane task"] = 16,
    ["Alacritty Configuration"] = 769,
    ["All Contributors configuration file"] = 827,
    ...
    ["Azure Pipelines"] = 72,
    ["Azure Static Web Apps CLI configuration file"] = 600,
    ["Azure Static Web Apps configuration file"] = 599,
    ["BX CI"] = 110,
    ["Bashly (bashly.yml)"] = 831,
    ["Bashly Settings (bashly-settings.yml)"] = 832,
    ["Better Code Hub"] = 741,
    ["Better Scripts"] = 111,
    Bigconfig = 89,
    BizTalkServerApplicationSchema = 711,
    Bleep = 112,
    ...
    ["Butane Config"] = 782,
    ["CGS Custom Card Game (CardGameDef.json)"] = 867,
    ["CICS TS region tagging"] = 791,
    ["CICS TS resource import"] = 792,
    ["CICS TS resource model"] = 793,
    ["CICS TS resource overrides"] = 794,
    ["CMake Presets"] = 113,
    ["CNC Codes"] = 127,
    ...
    CityJSON = 123,
    ["Clawject config"] = 132,
    ["Cloud Foundry Application Manifest"] = 879,
    ...
    ["Configu .cfgu files"] = 884,
    ["Configu .configu file"] = 885,
    Conjure = 126,
    ["Container Structure Test"] = 724,
    Containerlab = 749,
    ["Crowdsec collection config"] = 212,
    ["Crowdsec parser config"] = 213,
    ["Crowdsec scenario config"] = 214,
    ["CumulusCI Config"] = 131,
    ["Custom Machinery Machine"] = 868,
    ["Custom Machinery Recipe"] = 869,
    ...
    ["DataYoga Job"] = 136,
    ["Databricks Asset Bundles"] = 848,
    ["Datadog Service Definition"] = 378,
    ["Datahub Ingestion Recipe"] = 798,
    ["Dein Config"] = 138,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 839,
    ["EAS config"] = 271,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 828,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 864,
    GitVersion = 297,
    ["Gitea Issue Template configuration"] = 298,
    ["Gitea Issue Template forms"] = 299,
    ["Gitpod Configuration"] = 309,
    ["GlazeWM settings"] = 866,
    ["Global Privacy Control"] = 296,
    Goblet = 847,
    ["Golangci-lint Configuration"] = 311,
    ["Golangci-lint Custom Plugins Configuration"] = 312,
    ["Google Chrome Related Website Sets"] = 279,
    ["Google Cloud Workflows"] = 190,
    Goreleaser = 314,
    ["Goreleaser Pro"] = 315,
    Goss = 316,
    ["Gradle Build Cache Node"] = 739,
    ["Gradle Enterprise"] = 738,
    ["Grafana 5.x Dashboard"] = 317,
    ["GraphQL Code Generator"] = 321,
    ["GraphQL Config"] = 320,
    ["GraphQL Mesh"] = 319,
    ["Grunt JSHint task"] = 325,
    ["Grunt Watch task"] = 326,
    ["Grunt base task"] = 327,
    ["Grunt clean task"] = 323,
    ["Grunt copy task"] = 322,
    ["Grunt cssmin task"] = 324,
    HEMTT = 708,
    Hadolint = 720,
    Hammerkit = 748,
    ["Hardware Sentry Configuration"] = 802,
    Hatch = 721,
    Hayson = 329,
    ["Haystack Pipeline"] = 330,
    ["Hazelcast 5 Configuration"] = 331,
    ["Helm Chart.lock"] = 158,
    ["Helm Chart.yaml"] = 157,
    ["Helm Unittest Test Suite"] = 159,
    Hugo = 778,
    ["Hugo Theme"] = 777,
    ["Hyperfoil benchmark configuration"] = 337,
    ["IBM Zapp document"] = 338,
    ["IBM zCodeFormatSettings"] = 339,
    ["IMG Catapult PSP"] = 344,
    ["IVMS101 by CODE Protocol"] = 865,
    Infrahub = 346,
    Istanbul = 805,
    ["JDownloader2 crawler multi-rules"] = 355,
    ["JDownloader2 crawler single-rules"] = 354,
    ["JFrog Applications Config"] = 356,
    ["JFrog File Spec"] = 357,
    ["JFrog Pipelines YML DSL"] = 811,
    ["JMeter DSL cli config"] = 358,
    JReleaser = 360,
    ["JSON Document Transform"] = 368,
    ["JSON Feed"] = 369,
    ["JSON Resume"] = 544,
    ["JSON Schema Draft 2020-12"] = 685,
    ["JSON Schema Draft 4"] = 682,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 849,
    ["JSON Schema Draft 7"] = 683,
    ["JSON Schema Draft 7 (unofficial strict)"] = 850,
    ["JSON Schema Draft 8 (2019-09)"] = 684,
    ["JSON-API"] = 367,
    ["JSON-WF"] = 878,
    ["JSON-e templates"] = 746,
    ["JSON-stat 2.0"] = 679,
    JSONPatch = 371,
    ["JSR Package Config (jsr.json)"] = 361,
    Jasmine = 350,
    Jekyll = 351,
    ["Jenkins X Pipelines"] = 352,
    ["Jenkins X Requirements"] = 353,
    ["Jovo Language Models"] = 359,
    ["KIMMDY config file"] = 376,
    ["KSP-AVC"] = 680,
    ["KSP-CKAN"] = 681,
    KSY = 877,
    ["Karakum configuration file"] = 289,
    Kas = 374,
    ["Keycloak REST API"] = 819,
    ["Knative Functions - func.yaml"] = 290,
    ["KoDE/CI build.yaml"] = 807,
    ["Kong DBLess config"] = 808,
    KrakenD = 377,
    ["Kubri Configuration"] = 382,
    LOOBin = 397,
    ...
    Lefthook = 386,
    ["Liferay client-extension.yaml"] = 393,
    ["LinkML Metamodel"] = 395,
    Liquibase = 754,
    ["Liquibase Flow File"] = 755,
    ["Lively Properties"] = 396,
    ["Lobe AI Agent"] = 70,
    Loki = 71,
    ["MLOS Configs"] = 431,
    ["MS2Rescore Configuration"] = 434,
    ["Madness (madness.yml)"] = 830,
    Markdownlint = 758,
    ["Mason Registry"] = 760,
    ["MegaLinter configuration"] = 403,
    ["MegaLinter descriptor"] = 404,
    Melange = 856,
    ["Meltano plugin discovery definition"] = 406,
    ["Meltano project definition"] = 405,
    ["Mergify Configuration"] = 435,
    ["MetricsHub Configuration"] = 407,
    ["MetricsHub Connector Configuration"] = 408,
    ["Micro Editor Syntax"] = 840,
    ["Microsoft Band Web Tile"] = 409,
    ["Minecraft Custom Main Menu Mod"] = 857,
    ["Minecraft Data Pack Advancement"] = 411,
    ["Minecraft Data Pack Biome"] = 412,
    ["Minecraft Data Pack Configured Carver"] = 413,
    ["Minecraft Data Pack Damage Type"] = 414,
    ["Minecraft Data Pack Dimension"] = 416,
    ["Minecraft Data Pack Dimension Type"] = 415,
    ["Minecraft Data Pack Item Modifier"] = 417,
    ["Minecraft Data Pack Loot Table"] = 418,
    ["Minecraft Data Pack Metadata"] = 419,
    ["Minecraft Data Pack Predicate"] = 420,
    ["Minecraft Data Pack Recipe"] = 421,
    ["Minecraft Data Pack Tag"] = 422,
    ["Minecraft Data Pack Template Pool"] = 423,
    ["Minecraft Data Pack Trim Material"] = 428,
    ["Minecraft Data Pack Trim Pattern"] = 429,
    ["Minecraft Resource Pack Lang"] = 424,
    ["Minecraft Resource Pack Particle"] = 425,
    ["Minecraft Resource Pack Texture Mcmeta"] = 427,
    ["Minecraft Resourcepack Sounds"] = 426,
    ["Monade CLI Stack Configuration"] = 438,
    ["MongoDB Atlas Search Index Definition"] = 806,
    ["Monika Configuration"] = 804,
    ["Monoweave Configuration"] = 433,
    ["Motif config"] = 704,
    ["NOX Framework (Service)"] = 450,
    ["Netin Diagnostic System Template"] = 764,
    ["Netlify config"] = 441,
    ["Network-as-Code Data Model"] = 442,
    ["Nightwatch.js"] = 443,
    ["Nuitka.yaml"] = 870,
    ["ONe's changelog entry"] = 466,
    ["ONe's service descriptor"] = 465,
    ["OSS Review Toolkit configuration"] = 474,
    ["OSS Review Toolkit curation"] = 475,
    ["OSS Review Toolkit package configuration"] = 476,
    ["OSS Review Toolkit repository configuration"] = 477,
    ["OSS Review Toolkit resolutions"] = 478,
    Opctl = 707,
    ["Open Data Contract Standard (ODCS))"] = 469,
    ["OpenRewrite Resource"] = 468,
    ["OpenUtau character yaml"] = 462,
    ["OpenUtau ustx"] = 463,
    ["OpenWeather Current Weather API"] = 745,
    ["OpenWeather Road Risk API"] = 744,
    ["Ory Hydra configuration"] = 336,
    ["Ory Keto configuration"] = 379,
    ["Ory Kratos configuration"] = 473,
    ["Ory Oathkeeper configuration"] = 457,
    ["Outblocks App configuration"] = 471,
    ["Outblocks database table"] = 472,
    ["Outblocks project configuration"] = 470,
    PDM = 484,
    Packer = 481,
    Pantsbuild = 826,
    ["Paper paper-plugin.yml"] = 482,
    ["Pipeline component"] = 756,
    ["PocketMine plugin.yml"] = 489,
    ["Postman collection"] = 494,
    ["Problem object RFC9457"] = 854,
    ["Problem package generators"] = 502,
    Pterodactyl = 801,
    ["Pull Request Labeler"] = 517,
    Pulumi = 523,
    PyProject = 524,
    Pyright = 525,
    Qgoda = 526,
    Qodana = 774,
    ["Qt Creator workspace file"] = 886,
    ["Quali Torque Blueprint Spec 2"] = 799,
    ["QueryFirst config file"] = 822,
    ["RKE Cluster Configuration JSON"] = 753,
    ["RKE Cluster Configuration YAML"] = 752,
    ["Rancher Fleet"] = 520,
    ["Rattler-build"] = 527,
    Ray = 719,
    ["Read the Docs"] = 522,
    ["Red-DiscordBot Cog"] = 534,
    ["Red-DiscordBot Cog Repo"] = 535,
    ["Red-DiscordBot Trivia"] = 536,
    ["Render Blueprints"] = 751,
    RenderCV = 546,
    Renovate = 545,
    ["Replit config"] = 540,
    RoadRunner = 547,
    ["Rudder techniques"] = 860,
    Ruff = 542,
    ["Rust Project"] = 543,
    ["Rust toolchain"] = 550,
    ["SDMX data message"] = 575,
    ["SDMX metadata message"] = 574,
    ["SDMX structure message"] = 573,
    ["SIL Kit Participant Configuration"] = 585,
    ["SIL Kit Registry Configuration"] = 586,
    SWADL = 611,
    ["Safebox Config"] = 812,
    ["Sapphire CLI Config"] = 553,
    ["SauceCTL Configuration"] = 761,
    ["Schema Catalog"] = 567,
    ["Scoop manifest"] = 572,
    ["Semantic Data Fabric (SDF) file"] = 576,
    ["Semgrep Rule"] = 578,
    ["Serenity Code Generator (Sergen)"] = 579,
    ["Serverless Framework Configuration"] = 768,
    ["Serverless Workflow"] = 770,
    ["Settings.paf"] = 581,
    ["Shopware 6 Configuration"] = 771,
    ["Shopware CLI Extension Store Configuration"] = 772,
    ["Shopware CLI Project Store Configuration"] = 773,
    Sigma = 583,
    ["Sigrid scope configuration file"] = 584,
    ["SkyPilot Task JSON"] = 861,
    ["Slack app manifest"] = 588,
    Solidarity = 591,
    ["Solution filters"] = 592,
    ["Source Maps v3"] = 593,
    Sourcery = 594,
    SpecIF = 595,
    ["Sponge Mixin configuration"] = 596,
    StackBlitz = 601,
    ["StackHawk Scanner Configuration"] = 767,
    Stale = 602,
    ["Starlake Data Pipeline"] = 742,
    Starship = 603,
    ["Statamic Blueprint"] = 604,
    ["Stella configuration file"] = 605,
    ["StrmPrivacy Data Connector"] = 816,
    ["StrmPrivacy Data Contract"] = 817,
    ["StrmPrivacy SimpleSchema"] = 814,
    ["StrmPrivacy Stream"] = 815,
    ["StrmPrivacy batch job configuration file"] = 813,
    ["Stryker Mutator"] = 608,
    ["StyleCop Analyzers Configuration"] = 609,
    ["Stylelint (.stylelintrc)"] = 610,
    ["Sublime Syntax"] = 818,
    ["Subsquid squid manifest"] = 863,
    ["Swagger API 2.0"] = 612,
    TSON = 638,
    TSTyche = 639,
    Talhelper = 614,
    ["Talisman configuration"] = 615,
    ["Taskfile config"] = 747,
    Taurus = 616,
    ["TestEnvironment.json"] = 625,
    ["TextMate Grammar"] = 624,
    ["Tier.run pricing.json"] = 619,
    Tikibase = 620,
    ["Traefik v2"] = 628,
    ["Traefik v2 File Provider"] = 629,
    ["Travis CI (.travis.yml)"] = 627,
    TunnelHub = 853,
    Turborepo = 626,
    Tye = 775,
    ["UET BuildConfig.json"] = 823,
    ["UI5 Manifest"] = 648,
    ["UNCORS configuration"] = 652,
    ["UTAM Page Object"] = 651,
    ["Ubuntu Server Autoinstall"] = 646,
    ["Uniswap Token List"] = 730,
    ["Unreal Engine Uplugin"] = 824,
    ["Unreal Engine Uproject"] = 825,
    ["Updatecli Compose"] = 783,
    ["Updatecli Policy Manifest"] = 784,
    ["Updatecli Policy Metadata"] = 785,
    Uplift = 821,
    ["User Journey Map"] = 750,
    V2Ray = 789,
    ["VSCode Code Snippets"] = 178,
    ["VSIX CLI publishing"] = 667,
    ["Vela Pipeline Configuration"] = 656,
    Vercel = 177,
    Visivo = 851,
    ["Web App Manifest"] = 674,
    ["Web types"] = 677,
    WebExtensions = 673,
    ["Webman package recipe"] = 795,
    ["Windows Package Manager Installer Manifest"] = 727,
    ["Windows Package Manager Locale Manifest"] = 728,
    ["Windows Package Manager Singleton Manifest"] = 726,
    ["Woodpecker pipeline config"] = 763,
    ["Wrangler CLI"] = 678,
    ["Xstate Machine"] = 781,
    ["Yarn Config (.yarnrc.yml)"] = 740,
    ["Yippee-Ki-JSON configuration YML"] = 732,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 855,
    ...
    ["behat.yml"] = 96,
    ["bigquery-table"] = 88,
    ["bioimageio resource description"] = 871,
    ...
    ["gitlab-ci"] = 308,
    ["global.json"] = 310,
    ["go-feature-flag Flag Configuration"] = 313,
    ["haxelib.json"] = 328,
    helmfile = 722,
    helmwave = 723,
    ["host-meta.json"] = 333,
    ...
    ["ide.host.json"] = 340,
    ["ifstate.conf"] = 341,
    ["imageoptimizer.json"] = 342,
    ["importmap.json"] = 345,
    ["ioBroker Configuration"] = 347,
    ["ioBroker JSON UI"] = 348,
    ["ioBroker Package manifest"] = 349,
    ["ize.toml"] = 820,
    ["jsconfig.json"] = 372,
    ["jscpd Configuration"] = 800,
    jsdoc = 718,
    ["k3d.yaml"] = 373,
    ["k9s plugin.yml"] = 375,
    ["kontinuous-config.yaml"] = 381,
    ["kontinuous-values.yaml"] = 380,
    ["kustomization.yaml"] = 383,
    ["label-commenter-config.yml"] = 384,
    ["latexindent configuration"] = 69,
    ["launchsettings.json"] = 385,
    lazydocker = 842,
    lazygit = 841,
    ["lego.json"] = 387,
    ["lerna.json"] = 388,
    ["lgtm.yml"] = 389,
    ["liblab.config.json"] = 390,
    ["libman.json"] = 391,
    ["license-report-config.json"] = 392,
    ["linkinator.config.json"] = 394,
    ["lint-staged (.lintstagedrc)"] = 698,
    ["local.settings.json"] = 399,
    ["localazy.json"] = 400,
    ["lotus.yaml"] = 398,
    ["lsdlschema.json"] = 401,
    ["markdown-link-check"] = 759,
    mboats = 766,
    ["micro-settings.json"] = 835,
    ["mimetypes.json"] = 410,
    ["mirrord config"] = 699,
    mise = 700,
    ["mise-settings"] = 701,
    ["mkdocs.yml"] = 430,
    ["monospace.yml"] = 432,
    ["mprocs Configuration file"] = 887,
    ["mta.yaml"] = 702,
    ["mtad.yaml"] = 703,
    ["mycode.json"] = 439,
    ["napari plugin manifest"] = 440,
    neoload = 713,
    ["nest-cli"] = 445,
    ["ninjs (News in JSON)"] = 444,
    ["nixd configuration"] = 859,
    ["nlu.json"] = 446,
    ["nodemon.json"] = 448,
    ["noodl config"] = 765,
    ["notebook.mod.json"] = 449,
    now = 709,
    ["npm-badges"] = 452,
    ["nswag.json"] = 455,
    ntangle = 456,
    ["nuclei-template.yaml"] = 453,
    ["nuget-project.json"] = 454,
    ["ocelot.json"] = 458,
    ["omnisharp.json"] = 459,
    ["openapi.json"] = 460,
    ["openfin.json"] = 467,
    ...
    ["ops.yaml"] = 464,
    ["package.json"] = 479,
    ["package.manifest"] = 480,
    ["partial-black.json"] = 97,
    ["pathfinder.yml"] = 483,
    ["pattern.json"] = 486,
    ["petstore-v1.0"] = 810,
    pgap_yaml_input_reader = 485,
    ["pixi.toml"] = 487,
    ["plagiarize-me.yaml"] = 491,
    ["plagiarize.yaml"] = 490,
    ["portman.json"] = 492,
    ["prettierrc.json"] = 500,
    ["prisma.yml"] = 501,
    ["project-1.0.0-beta3.json"] = 504,
    ["project-1.0.0-beta4.json"] = 505,
    ["project-1.0.0-beta5.json"] = 506,
    ["project-1.0.0-beta6.json"] = 507,
    ["project-1.0.0-beta8.json"] = 508,
    ["project-1.0.0-rc1.json"] = 509,
    ["project-1.0.0-rc2.json"] = 510,
    ["project.json"] = 503,
    ["prometheus.json"] = 511,
    ["prometheus.rules.json"] = 512,
    ["prometheus.rules.test.json"] = 513,
    ["proxies.json"] = 514,
    ["publiccode.yml"] = 515,
    ["pubspec.yaml"] = 516,
    ["pyrseas-0.8.json"] = 519,
    ["quilt.mod.json"] = 836,
    ["rc3 auth"] = 528,
    ["rc3 collection"] = 529,
    ["rc3 environment"] = 530,
    ...
    ["rc3 settings"] = 533,
    ["release drafter"] = 714,
    ["release-plz.toml"] = 538,
    ["rivet.yaml"] = 858,
    rockcraft = 548,
    rustfmt = 549,
    samt = 551,
    samtrc = 552,
    ["sarif-1.0.0.json"] = 554,
    ["sarif-2.0.0.json"] = 555,
    ["sarif-2.1.0"] = 565,
    ["sarif-2.1.0-rtm.2"] = 556,
    ["sarif-2.1.0-rtm.3"] = 558,
    ["sarif-2.1.0-rtm.4"] = 560,
    ["sarif-2.1.0-rtm.5"] = 562,
    ["sarif-2.1.0-rtm.6"] = 563,
    ["sarif-external-property-file-2.1.0"] = 566,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 557,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 559,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 561,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 564,
    ["schema.org - Action"] = 568,
    ["schema.org - ContactPoint"] = 569,
    ["schema.org - Place"] = 570,
    ["schema.org - Thing"] = 571,
    ["secrethub.yml"] = 838,
    ["semantic-release"] = 577,
    ["servicehub.config.json"] = 688,
    ["servicehub.service.json"] = 687,
    ["settings.job"] = 580,
    ["sfdx-hardis configuration"] = 582,
    ["shard.yml"] = 874,
    ["size-limit configuration"] = 587,
    ["skaffold.yaml"] = 757,
    ["skyuxconfig.json"] = 589,
    snapcraft = 590,
    ["sqlc configuration"] = 598,
    ["stripe-app-local.json"] = 607,
    ["stripe-app.json"] = 606,
    swcrc = 743,
    ["task.json"] = 613,
    taskcat = 710,
    ["template.json"] = 617,
    ["templatsources.json"] = 618,
    ["theme.json"] = 621,
    ["tizen_workspace.json"] = 622,
    tldr = 623,
    tmuxinator = 696,
    ["transcend.yml"] = 630,
    ["tree-sitter grammar.json"] = 318,
    ["trime.yaml"] = 631,
    ["trunk.yaml"] = 632,
    ["ts-force-config.json"] = 636,
    ["tsconfig.json"] = 633,
    ["tsd.json"] = 634,
    ["tsdrc.json"] = 635,
    ["tslint.json"] = 637,
    ...
    ["vega-lite.json"] = 655,
    ["vega.json"] = 654,
    ["venvironment-basic.yaml"] = 658,
    ["venvironment.yaml"] = 657,
    ["version.json"] = 659,
    ["vim-addon-info"] = 661,
    ["vs-2017.3.host.json"] = 663,
    ["vs-nesting.json"] = 664,
    ["vsls.json"] = 662,
    ["vss-extension.json"] = 668,
    ["vtesttree.yaml"] = 669,
    ["vtestunit.yaml"] = 670,
    ["warp-keysets.json"] = 844,
    ["warp-themes.json"] = 845,
    ["warp-workflows.json"] = 846,
    ["webhint.io"] = 796,
    ["webjobpublishsettings.json"] = 676,
    ["webjobs-list.json"] = 675,
    ["well-known-fursona"] = 882,
    ["xs-app.json"] = 706,
    ["xunit.runner.json"] = 686,
    yamllint = 731,
    zuul = 715,
    ["Žinoma"] = 725
  },
