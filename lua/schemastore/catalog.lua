...
M.json = {
  ...
  index = {
    ...
    [".pmbot.yml"] = 684,
    [".postcssrc"] = 693,
    [".powerpages-web-template-manifest"] = 695,
    [".pre-commit-config.yml"] = 696,
    [".pre-commit-hooks.yml"] = 697,
    [".putout.json"] = 733,
    [".rehyperc"] = 758,
    [".remarkrc"] = 762,
    [".sprite files"] = 858,
    ...
    AIConfig = 36,
    ["AMX Muse Program Descriptor"] = 1212,
    ["API Builder"] = 1020,
    ["AVA Configuration"] = 1083,
    ...
    ["AWS Copilot Manifest"] = 1251,
    ["AWS SAM CLI Samconfig"] = 274,
    Acton = 1301,
    ["Adobe UXP Manifest"] = 1146,
    ["Aerleon Network & Service Definitions"] = 22,
    ["Aerleon Policy"] = 23,
    ["Agent Permission Policy"] = 1291,
    ["AgentCore CLI"] = 1292,
    Aider = 1241,
    Air = 25,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1262,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1261,
    ["Airlock Microgateway"] = 37,
    ["Alacritty Configuration"] = 1055,
    ["AlgoVoi Compliance Receipt v1"] = 12,
    ["All Contributors configuration file"] = 1109,
    Anodizer = 448,
    ...
    ["Application list for a WinUtil"] = 1191,
    ArchitectFX = 1196,
    ["Argo CD"] = 56,
    ["Argo Events"] = 57,
    ["Argo Workflows"] = 58,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1260,
    ["Azure IoT Operations connector metadata"] = 1257,
    ...
    ["Azure Pipelines"] = 116,
    ["Azure Static Web Apps CLI configuration file"] = 862,
    ["Azure Static Web Apps configuration file"] = 861,
    BMML = 1279,
    ["BOSH CPI Config"] = 142,
    ...
    ["Bacon config"] = 6,
    ["Barba-CV"] = 85,
    ["Bashly (bashly.yml)"] = 1113,
    ["Bashly Settings (bashly-settings.yml)"] = 1114,
    Bento = 1278,
    ["Better Code Hub"] = 1025,
    ["Better Scripts"] = 165,
    Bigconfig = 135,
    ["Biome Formatter Config"] = 86,
    ["Bitmovin Encoding Template"] = 1205,
    BizTalkServerApplicationSchema = 992,
    Bleep = 166,
    ["Block Protocol Metadata"] = 163,
    ["Bluebricks blueprint config"] = 1284,
    ["Boyka Framework"] = 144,
    ...
    ["Butane Config"] = 1068,
    C4InterFlow = 1220,
    ["CDK Environment Manager, concrete environment configuration"] = 1244,
    ["CDK Environment Manager, concrete environments definition"] = 1243,
    ["CDK Environment Manager, environment definition"] = 1242,
    ["CGS Card Game Specification (cgs.json)"] = 1151,
    ["CICS TS region tagging"] = 1077,
    ["CICS TS resource import"] = 1078,
    ["CICS TS resource model"] = 1079,
    ["CICS TS resource overrides"] = 1080,
    ["CMake Presets"] = 167,
    ["CNC Codes"] = 189,
    ["CRS WAF test file"] = 1181,
    ["CRS WAF test platform overrides file"] = 1182,
    ...
    ["Caido Proxy Configuration"] = 1315,
    ...
    ["Chamaleon environment"] = 1209,
    ["Chamaleon properties"] = 1210,
    ["Chamaleon template"] = 1208,
    Changepacks = 1271,
    Changesets = 283,
    Changie = 176,
    Charmcraft = 177,
    ...
    ["Clawject config"] = 195,
    ["Cloud Foundry Application Manifest"] = 1163,
    ["Cloud Run Spec v1"] = 1186,
    ...
    Concord = 1180,
    ["Configu .cfgu files"] = 1168,
    ["Configu .configu file"] = 1169,
    Conjure = 188,
    ["Container Structure Test"] = 1006,
    Containerlab = 1034,
    ["Contextive Glossary"] = 1236,
    Convex = 187,
    ["Crowdsec collection config"] = 293,
    ["Crowdsec parser config"] = 294,
    ["Crowdsec scenario config"] = 295,
    ["CumulusCI Config"] = 194,
    ["Cursor Agent Environment"] = 1289,
    ["Custom Machinery Machine"] = 1152,
    ["Custom Machinery Recipe"] = 1153,
    ...
    ["DonateCaseBetterCasino menu"] = 1213,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1121,
    ["EAS config"] = 382,
    ["ECA - Editor Code Assistant"] = 346,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1110,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1256,
    ["EasyVCR .NET"] = 384,
    ["Eidolon Resource"] = 1197,
    ...
    ["Envelope Team Definition"] = 1300,
    ["Envilder Map File"] = 350,
    ["Erda Pipeline"] = 1159,
    ["Erda Runtime"] = 1160,
    ["Espanso config.yml"] = 1282,
    ["Espanso match.yml"] = 1281,
    Esquio = 370,
    ["Estuary Flow Catalog"] = 1074,
    ["Ethereum ERC1155"] = 1294,
    ["Ethereum ERC721"] = 1293,
    ...
    ["Evolving Resolutive Process notation"] = 1258,
    ["Expo SDK"] = 381,
    ...
    ["GeoJSON.json latest"] = 1072,
    GherKing = 1076,
    ["GitHub Action"] = 417,
    ["GitHub Actions typing"] = 1193,
    ...
    ["Google Digital Assetlinks"] = 1237,
    Goreleaser = 446,
    ["Goreleaser Pro"] = 447,
    Goss = 449,
    ["Gradle Build Cache Node"] = 1023,
    ["Gradle Enterprise"] = 1022,
    ...
    Hadolint = 1002,
    Hammerkit = 1033,
    ["Hardware Sentry Configuration"] = 1088,
    ...
    ["JFrog File Spec"] = 500,
    ["JFrog Pipelines YML DSL"] = 1098,
    ["JMeter DSL cli config"] = 501,
    JReleaser = 504,
    ["JSON Document Transform"] = 512,
    ["JSON Feed"] = 513,
    ["JSON Resume"] = 770,
    ["JSON Schema Draft 2020-12"] = 970,
    ["JSON Schema Draft 4"] = 967,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1131,
    ["JSON Schema Draft 7"] = 968,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1132,
    ["JSON Schema Draft 8 (2019-09)"] = 969,
    ["JSON-API"] = 511,
    ["JSON-e templates"] = 1030,
    ["JSON-stat 2.0"] = 963,
    JSONPatch = 515,
    ...
    ["Jujutsu (jj) VCS config"] = 1250,
    ["KIMMDY config file"] = 526,
    ["KODE/CI build.yaml"] = 1094,
    ["KSP-AVC"] = 964,
    ["KSP-CKAN"] = 965,
    ["KSP-NetKAN"] = 966,
    KSY = 1161,
    ...
    ["Metadata for a Cinnamon spice"] = 1189,
    ["Metatype Configuration"] = 568,
    ["MetricsHub Configuration"] = 569,
    ["MetricsHub Connector Configuration"] = 570,
    ["Micro Editor Syntax"] = 1122,
    ["Microsoft Band Web Tile"] = 571,
    ["Microsoft RulesEngine workflow rules"] = 1177,
    ["Microsoft RulesEngine workflow rules list"] = 1178,
    ["Minecraft Custom Main Menu Mod"] = 1140,
    ...
    ["MongoDB Atlas Search Index Definition"] = 1093,
    ["Monika Configuration"] = 1091,
    ["Monoweave Configuration"] = 599,
    ["Motif config"] = 984,
    MultiQC = 1230,
    ["NOX Framework (Service)"] = 622,
    ["Netin Diagnostic System Template"] = 1050,
    ["Netlify config"] = 607,
    ...
    ["OSS Review Toolkit repository configuration"] = 670,
    ["OSS Review Toolkit resolutions"] = 671,
    ...
    ["OpenUtau ustx"] = 645,
    ["OpenWeather Current Weather API"] = 1029,
    ["OpenWeather Road Risk API"] = 1028,
    ...
    PDM = 678,
    POPxf = 690,
    ["POPxf Correlations"] = 691,
    ["PRML manifest"] = 698,
    Packer = 675,
    PactSpec = 676,
    Pantsbuild = 1108,
    ["Paper paper-plugin.yml"] = 677,
    ["Pipeline component"] = 1041,
    ["Platform.sh application"] = 8,
    ["Platform.sh routes"] = 9,
    ["Platform.sh services"] = 10,
    ["Plex Prerolls"] = 688,
    ["PocketMine plugin.yml"] = 685,
    ["Postman collection"] = 694,
    ["Power Pages Configuration"] = 1247,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1192,
    ["ProActions AI-Kit Configuration"] = 706,
    ["ProActions AI-Kit Configuration for Menus"] = 708,
    ["ProActions AI-Kit Configuration for Sections"] = 710,
    ["ProActions AI-Kit Configuration for Services"] = 707,
    ["ProActions AI-Kit Configuration for Steps"] = 711,
    ["ProActions AI-Kit Configuration for Templates"] = 709,
    ["Problem object RFC9457"] = 1137,
    ["Problem package format"] = 712,
    ["Problem package generators"] = 713,
    ["Problem package submissions"] = 714,
    ["Problem package test group metadata"] = 715,
    Pterodactyl = 1087,
    ...
    Pylock = 1238,
    Pyright = 742,
    ["Python script metadata"] = 1232,
    ["QType AI DSL"] = 745,
    Qgoda = 744,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1309,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1307,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1313,
    ["Qlik Talend Cloud Pipeline - Project"] = 1305,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1308,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1310,
    ["Qlik Talend Cloud Pipeline - Task"] = 1306,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1312,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1311,
    Qodana = 1060,
    ["Qt Creator workspace file"] = 1170,
    ["Quali Torque Blueprint Spec 2"] = 1085,
    ["QueryFirst config file"] = 1104,
    ["QuikRun Configuration"] = 1314,
    ["Qwen Code Settings"] = 1295,
    ["RKE Cluster Configuration JSON"] = 1038,
    ["RKE Cluster Configuration YAML"] = 1037,
    RadioHound = 735,
    ["Raid Profile"] = 1296,
    ["Raid Repo Configuration"] = 1297,
    Railpack = 747,
    Railway = 746,
    ["Rancher Fleet"] = 737,
    ["Rattler-build"] = 748,
    Ray = 1001,
    ["Read the Docs"] = 739,
    ["Red-DiscordBot Cog"] = 755,
    ["Red-DiscordBot Cog Repo"] = 756,
    ["Red-DiscordBot Trivia"] = 757,
    ["Releasaurus Config"] = 5,
    ReleaseKit = 4,
    ["Render Blueprints"] = 1036,
    RenderCV = 774,
    Renovate = 771,
    ["Renovate global configuration"] = 772,
    ["Renovate inherited configuration"] = 773,
    ["Replit config"] = 763,
    Restate = 1225,
    ["Revel Digital Gadget Definition File"] = 1249,
    RoadRunner = 776,
    ["Robust Station Image"] = 1255,
    Rockcraft = 777,
    ["Roo Coder Custom Modes"] = 778,
    Rubocop = 767,
    ["Rudder techniques"] = 1144,
    Ruff = 768,
    ["Rust Project"] = 769,
    ["Rust toolchain"] = 783,
    ["SDMX data message"] = 810,
    ["SDMX metadata message"] = 809,
    ["SDMX structure message"] = 808,
    ["SIL Kit Participant Configuration"] = 820,
    ["SIL Kit Registry Configuration"] = 821,
    ["SPDX 2.3"] = 859,
    SWADL = 875,
    ["Safebox Config"] = 1099,
    ["Sapphire CLI Config"] = 786,
    ["SauceCTL Configuration"] = 1047,
    Scarb = 806,
    ["Schema Catalog"] = 801,
    ["Scoop manifest"] = 807,
    ["Semantic Data Fabric (SDF) file"] = 811,
    ["Semgrep Rule"] = 813,
    ["Serenity Code Generator (Sergen)"] = 814,
    ["Serverless Framework Configuration"] = 1054,
    ["Serverless Workflow"] = 1056,
    ["Settings for a Cinnamon spice"] = 1188,
    ["Settings.paf"] = 816,
    ["Shopware 6 Configuration"] = 1057,
    ["Shopware CLI Extension Store Configuration"] = 1058,
    ["Shopware CLI Project Store Configuration"] = 1059,
    ["Sigma Detection Rule"] = 818,
    ["Sigrid scope configuration file"] = 819,
    ["SkyPilot Task JSON"] = 1145,
    ["Slack app manifest"] = 823,
    Snapcraft = 825,
    ["Solarxy project config"] = 828,
    Solidarity = 829,
    ["Solution filters"] = 830,
    ["Source Maps v3"] = 831,
    Sourcery = 832,
    ["Spack bootstrap.yaml"] = 833,
    ["Spack cdash.yaml"] = 834,
    ["Spack ci.yaml"] = 835,
    ["Spack compilers.yaml"] = 836,
    ["Spack concretizer.yaml"] = 837,
    ["Spack config.yaml"] = 838,
    ["Spack definitions.yaml"] = 839,
    ["Spack develop.yaml"] = 840,
    ["Spack env_vars.yaml"] = 841,
    ["Spack environment"] = 847,
    ["Spack include.yaml"] = 842,
    ["Spack mirrors.yaml"] = 843,
    ["Spack modules.yaml"] = 844,
    ["Spack packages.yaml"] = 845,
    ["Spack repos.yaml"] = 846,
    ["Spack toolchains.yaml"] = 848,
    ["Spack upstreams.yaml"] = 849,
    ["Spack view.yaml"] = 850,
    ["Speakeasy Generation Config File"] = 854,
    ["Speakeasy Lint Configuration File"] = 851,
    ["Speakeasy Test Generation Configuration File"] = 852,
    ["Speakeasy Workflow File"] = 853,
    SpecIF = 855,
    ["Specmatic Configuration"] = 856,
    ["Sponge Mixin configuration"] = 857,
    StackBlitz = 863,
    ["StackHawk Scanner Configuration"] = 1053,
    Stale = 864,
    Starfish = 865,
    ["Starlake Data Pipeline"] = 1026,
    Starship = 866,
    ["Statamic Blueprint"] = 867,
    ["Stella configuration file"] = 868,
    ["Streamlit configuration file"] = 869,
    ["Stryker Mutator"] = 872,
    ["StyleCop Analyzers Configuration"] = 873,
    ["Stylelint (.stylelintrc)"] = 874,
    ["Stylua Config"] = 1239,
    ["Sublime Syntax"] = 1100,
    ["Subsquid squid manifest"] = 1147,
    ["Swagger API 2.0"] = 876,
    ["Synadia Connect Component"] = 877,
    TSON = 913,
    TSTyche = 914,
    ["TYPO3 Vendor Bundler config"] = 920,
    ["Tab data for a LinUtil"] = 1195,
    ["Tab list for a LinUtil"] = 1194,
    Tach = 878,
    ["Tach Domain"] = 879,
    Talhelper = 881,
    ["Talisman configuration"] = 882,
    Taplo = 1240,
    ["Taskfile config"] = 1031,
    Taurus = 883,
    Tauticord = 884,
    ["Tekton Pipeline"] = 1268,
    ["Tekton PipelineRun"] = 1269,
    ["Tekton Task"] = 1266,
    ["Tekton TaskRun"] = 1267,
    Telefonistka = 1226,
    ["Terrateam config"] = 1252,
    ["TestEnvironment.json"] = 896,
    ["TextMate Grammar"] = 895,
    Threagile = 890,
    ["Tier.run pricing.json"] = 887,
    Tikibase = 888,
    Tombi = 893,
    ["Traefik v2"] = 899,
    ["Traefik v2 File Provider"] = 900,
    ["Traefik v3"] = 901,
    ["Traefik v3 File Provider"] = 902,
    ["Travis CI (.travis.yml)"] = 898,
    Treefmt = 452,
    Trident = 1222,
    ["TrueScript for *.tscript files"] = 905,
    ["Tugboat QA config.yml"] = 1219,
    TunnelHub = 1135,
    Turborepo = 897,
    Tycho = 1184,
    Tye = 1061,
    ["Tyk Gateway - Open Source v5.7+"] = 1231,
    ["UET BuildConfig.json"] = 1105,
    ["UI5 Manifest"] = 926,
    ["UNCORS configuration"] = 931,
    ["UTAM Page Object"] = 929,
    ["Ubuntu Server Autoinstall"] = 924,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1223,
    ["Uniswap Token List"] = 1012,
    ["Universal Schedule Format"] = 932,
    ["Unreal Engine Uplugin"] = 1106,
    ["Unreal Engine Uproject"] = 1107,
    ["UpCloud CLI (upctl) configuration"] = 1224,
    ["Updatecli Compose"] = 1069,
    ["Updatecli Policy Manifest"] = 1070,
    ["Updatecli Policy Metadata"] = 1071,
    Uplift = 1103,
    ["Upsun config"] = 7,
    ["User Journey Map"] = 1035,
    V2Ray = 1075,
    ["VSCode Code Snippets"] = 258,
    ["VSIX CLI publishing"] = 950,
    Vector = 934,
    ["Vela Pipeline Configuration"] = 937,
    Vercel = 257,
    ["Version Bumper config"] = 940,
    Vespertide = 1273,
    ["Vespertide Migration"] = 1274,
    ["Vespertide Model"] = 1275,
    ["Viash Component Config"] = 1228,
    ["Viash Package Config"] = 1229,
    Visivo = 1133,
    ["WP-CLI"] = 960,
    Wake = 1221,
    ["Waku Config"] = 1198,
    ["Web App Manifest"] = 956,
    ["Web types"] = 959,
    WebExtensions = 955,
    ["Webman package recipe"] = 1081,
    ["Windows Package Manager Installer Manifest"] = 1009,
    ["Windows Package Manager Locale Manifest"] = 1010,
    ["Windows Package Manager Singleton Manifest"] = 1008,
    ["WireMock CLI import configuration"] = 1204,
    ["WireMock CLI local service configuration"] = 1203,
    ["WireMock message stub mapping"] = 1202,
    ["WireMock stub mapping"] = 1201,
    ["Woodpecker pipeline config"] = 1049,
    ["Wrangler CLI"] = 961,
    ["XenForo add-on manifest"] = 962,
    ["Xstate Machine"] = 1067,
    ["Yandex Workflow Language"] = 1190,
    ["Yarn Config (.yarnrc.yml)"] = 1024,
    ["Yippee-Ki-JSON configuration YML"] = 1015,
    ["YouTrack App"] = 1187,
    ["Zarf Package Configuration"] = 1254,
    ["Zerops import file"] = 1176,
    ["Zola Configuration"] = 1265,
    ["aerleon.yml"] = 21,
    ["amplify.yml"] = 14,
    ["amxx-builder manifest"] = 1316,
    ["angular.json"] = 38,
    apko = 1138,
    ...
    ["behat.yml"] = 145,
    ["bigquery-table"] = 134,
    ["bioimageio resource description"] = 1155,
    ...
    ["chutzpah.json"] = 266,
    cibuildwheel = 182,
    ["clang-format (.clang-format)"] = 1073,
    ["clang-tidy"] = 243,
    clangd = 242,
    clib = 244,
    ...
    ["crowdin.yml"] = 292,
    ["ctfd-setup configuration file"] = 1211,
    ["custom-elements.json"] = 1125,
    ["cypress.json"] = 296,
    ["dacier.yml"] = 1304,
    ...
    ["gematik health care insurance list"] = 1217,
    ["gematik health care patient list"] = 1214,
    ["gematik health care provider institution list"] = 1216,
    ["gematik health care provider list"] = 1215,
    ["gematik tiger test environment configuration"] = 1218,
    ["git-town.toml"] = 1263,
    ["gitlab-ci"] = 426,
    ["global.json"] = 442,
    ...
    ["lint-staged (.lintstagedrc)"] = 978,
    ["local.settings.json"] = 555,
    ["localazy.json"] = 556,
    ["lotus.yaml"] = 554,
    ["lsdlschema.json"] = 557,
    ["macro.json"] = 1090,
    ["markdown-link-check"] = 1044,
    maturin = 1045,
    mboats = 1052,
    memnex = 1302,
    ["micro-settings.json"] = 1117,
    ["mimetypes.json"] = 572,
    ["mirrord config"] = 980,
    mise = 981,
    ["mkdocs.yml"] = 592,
    ...
    ["monospace.yml"] = 598,
    ["moon.yml"] = 1200,
    ["mprocs Configuration file"] = 1171,
    ["mrdocs.yml"] = 594,
    ["mta.yaml"] = 982,
    ["mtad.yaml"] = 983,
    ["mycode.json"] = 605,
    ...
    oxlint = 1287,
    ["package.json"] = 672,
    ["package.manifest"] = 674,
    ["package.yaml"] = 673,
    ["partial-black.json"] = 146,
    ["partial-fastapi.json"] = 147,
    ["partial-pixi.json"] = 683,
    ["partial-scheduled.json"] = 148,
    ["pattern.json"] = 681,
    ["petstore-v1.0"] = 1097,
    pgap_yaml_input_reader = 679,
    pgrls = 680,
    pgxgen = 1280,
    pitcms = 1283,
    ["pixi.toml"] = 682,
    ["plagiarize-me.yaml"] = 687,
    ["plagiarize.yaml"] = 686,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1207,
    ["podbard.yaml"] = 689,
    ["portman.json"] = 692,
    ["prefect.toml"] = 701,
    ["prefect.yaml"] = 702,
    ...
    ["prettierrc.json"] = 704,
    ["prisma.yml"] = 705,
    ["project-1.0.0-beta3.json"] = 717,
    ["project-1.0.0-beta4.json"] = 718,
    ["project-1.0.0-beta5.json"] = 719,
    ["project-1.0.0-beta6.json"] = 720,
    ["project-1.0.0-beta8.json"] = 721,
    ["project-1.0.0-rc1.json"] = 722,
    ["project-1.0.0-rc2.json"] = 723,
    ["project.json"] = 716,
    ["project.owasp.yaml"] = 724,
    ["prometheus-alertmanager.json"] = 728,
    ["prometheus.json"] = 725,
    ["prometheus.rules.json"] = 726,
    ["prometheus.rules.test.json"] = 727,
    ["proxies.json"] = 729,
    ["publiccode.yml"] = 730,
    ["pubspec.yaml"] = 731,
    ["pyrseas-0.8.json"] = 734,
    pytest = 743,
    ["quilt.mod.json"] = 1118,
    ["rc3 auth"] = 749,
    ["rc3 collection"] = 750,
    ...
    ["release drafter"] = 996,
    ["release-hub.json"] = 3,
    ["release-please-config.json"] = 759,
    ["release-please-manifest.json"] = 760,
    ["release-plz.toml"] = 761,
    ["renv.lock"] = 775,
    ["reposets Configuration"] = 764,
    ["reposets Credentials"] = 765,
    ["revola.json"] = 1,
    ["rivet.json"] = 1142,
    ["rivet.yaml (legacy)"] = 1141,
    rumdl = 780,
    runny = 779,
    runspec = 1303,
    rustfmt = 781,
    ...
    samt = 784,
    samtrc = 785,
    ["sarif-1.0.0.json"] = 787,
    ["sarif-2.0.0.json"] = 788,
    ["sarif-2.1.0"] = 798,
    ["sarif-2.1.0-rtm.2"] = 789,
    ["sarif-2.1.0-rtm.3"] = 791,
    ["sarif-2.1.0-rtm.4"] = 793,
    ["sarif-2.1.0-rtm.5"] = 795,
    ["sarif-2.1.0-rtm.6"] = 796,
    ["sarif-external-property-file-2.1.0"] = 799,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 790,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 792,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 794,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 797,
    ["scalingo.json configuration"] = 800,
    ["schema.org - Action"] = 802,
    ["schema.org - ContactPoint"] = 803,
    ["schema.org - Place"] = 804,
    ["schema.org - Thing"] = 805,
    ["secrethub.yml"] = 1120,
    ["semantic-release"] = 812,
    ["servicehub.config.json"] = 973,
    ["servicehub.service.json"] = 972,
    ["settings.job"] = 815,
    ["sfdx-hardis configuration"] = 817,
    ["shard.yml"] = 1158,
    ["size-limit configuration"] = 822,
    ["skaffold.yaml"] = 1042,
    ["skyuxconfig.json"] = 824,
    ["snowflake-config"] = 826,
    ["snowflake-connections"] = 827,
    ["spicepod.yaml"] = 1179,
    ["sqlc configuration"] = 860,
    ["stripe-app-local.json"] = 871,
    ["stripe-app.json"] = 870,
    swcrc = 1027,
    ["task.json"] = 880,
    taskcat = 991,
    ["template.json"] = 885,
    ["templatsources.json"] = 886,
    ["text2confl config"] = 1288,
    ["theme.json"] = 889,
    ["tizen_workspace.json"] = 891,
    tldr = 892,
    ["tm_devices configuration file"] = 1245,
    tmuxinator = 976,
    tox = 894,
    ["transcend.yml"] = 903,
    ...
    ["vega-lite.json"] = 936,
    ["vega.json"] = 935,
    ["venvironment.yaml"] = 938,
    ["venvplus.yaml"] = 939,
    version = 1227,
    ["version.json"] = 941,
    ["vhwdebugger-binding.yaml"] = 943,
    ["vim-addon-info"] = 944,
    ["vs-2017.3.host.json"] = 946,
    ["vs-nesting.json"] = 947,
    ["vsls.json"] = 945,
    ["vss-extension.json"] = 951,
    vtcfg = 1233,
    ["vtesttree.yaml"] = 952,
    ["vtestunit.yaml"] = 953,
    ["warp-keysets.json"] = 1126,
    ["warp-themes.json"] = 1127,
    ["warp-workflows.json"] = 1128,
    ["webhint.io"] = 1082,
    ["webjobpublishsettings.json"] = 958,
    ["webjobs-list.json"] = 957,
    ["well-known-fursona"] = 1166,
    ["xs-app.json"] = 986,
    ["xunit.runner.json"] = 971,
    yamlfmt = 1013,
    yamllint = 1014,
    ["zerops.yml"] = 1175,
    zizmor = 1270,
