...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 112,
    [".cryproj (generic)"] = 426,
    [".cryproj engine-5.2"] = 421,
    [".cryproj engine-5.3"] = 422,
    [".cryproj engine-5.4"] = 423,
    [".cryproj engine-5.5"] = 424,
    [".cryproj engine-dev"] = 425,
    [".csscomb.json"] = 114,
    [".csslintrc"] = 115,
    [".eslintrc"] = 152,
    [".esmrc.json"] = 145,
    ...
    [".vsext"] = 402,
    [".yarnrc.yml"] = 464,
    ["<div>RIOTS' studio configuration"] = 405,
    ["API Builder"] = 461,
    ["AVA Configuration Schema"] = 513,
    ...
    ["Better Code Hub"] = 466,
    BizTalkServerApplicationSchema = 438,
    ...
    ["Butane config schema"] = 500,
    ["CICS TS region tagging"] = 507,
    ["CICS TS resource import"] = 508,
    ["CICS TS resource model"] = 509,
    ["CICS TS resource overrides"] = 510,
    ["CMake Presets"] = 68,
    ["CSR Framework"] = 76,
    ...
    ["Error pages"] = 148,
    Esquio = 146,
    ["Estuary Flow Catalog Schema"] = 504,
    ["Expo SDK"] = 151,
    ...
    Goreleaser = 178,
    ["Goreleaser Pro"] = 179,
    ["Gradle Build Cache Node"] = 463,
    ["Gradle Enterprise"] = 462,
    ...
    ["JSON Feed"] = 217,
    ["JSON Resume"] = 323,
    ["JSON Schema Draft 2020-12"] = 417,
    ["JSON Schema Draft 4"] = 414,
    ["JSON Schema Draft 7"] = 415,
    ["JSON Schema Draft 8"] = 416,
    ...
    ["Netin Diagnostic System Template"] = 485,
    ...
    Opctl = 434,
    ["OpenWeather Current Weather API"] = 470,
    ["OpenWeather Road Risk API"] = 469,
    ...
    Packer = 287,
    ["Pipeline component"] = 479,
    ["PocketMine plugin.yml"] = 291,
    ["Pull Request Labeler"] = 314,
    Qodana = 493,
    ["Quali Torque Blueprint Spec 2"] = 515,
    ["RKE Cluster Configuration JSON Schema"] = 477,
    ["RKE Cluster Configuration YAML Schema"] = 476,
    Ray = 446,
    ["Read the Docs"] = 317,
    ...
    ["SauceCTL Configuration"] = 482,
    ["Schema Catalog"] = 339,
    ["Scoop manifest"] = 344,
    ["Semantic Release"] = 345,
    ["Semgrep Rule"] = 346,
    ["Serverless Framework Configuration"] = 489,
    ["Settings.paf"] = 348,
    ["Shopware 6 Configuration"] = 490,
    ["Shopware CLI Extension Store Configuration"] = 491,
    ["Shopware CLI Project Store Configuration"] = 492,
    Solidarity = 353,
    ["Source Maps v3"] = 354,
    SpecIF = 355,
    ["Sponge Mixin configuration"] = 356,
    ["StackHawk Scanner Configuration"] = 488,
    ["StackHead CLI config"] = 360,
    ["StackHead module configuration"] = 361,
    ["StackHead project definition"] = 362,
    Stale = 363,
    ["Statamic Blueprint"] = 364,
    ["Stryker Mutator"] = 365,
    ["StyleCop Analyzers Configuration"] = 366,
    ["Swagger API 2.0"] = 369,
    ["Taskfile YAML Schema"] = 472,
    Taurus = 370,
    ["TestEnvironment.json"] = 376,
    Tikibase = 373,
    ["Traefik v2"] = 378,
    ["Traefik v2 File Provider"] = 379,
    Tye = 494,
    ["UI5 Manifest"] = 391,
    ["Ubuntu Server Autoinstall"] = 389,
    ["Uniswap Token List"] = 455,
    Updatecli = 501,
    ["User Journey Map YAML Schema"] = 475,
    V2Ray = 505,
    ["VSCode Code Snippets"] = 90,
    ["VSIX CLI publishing"] = 403,
    ["Vela Pipeline Configuration"] = 395,
    Vercel = 89,
    ["Web App Manifest"] = 407,
    ["Web types"] = 410,
    WebExtensions = 406,
    ["Webman package recipe"] = 511,
    ["Windows Package Manager Installer Manifest"] = 452,
    ["Windows Package Manager Locale Manifest"] = 453,
    ["Windows Package Manager Singleton Manifest"] = 451,
    ["Woodpecker pipeline config"] = 484,
    ["Xstate Machine Schema"] = 499,
    ["Yippee-Ki-JSON configuration YML"] = 457,
    ["angular.json"] = 8,
    ...
    taskcat = 437,
    ["template.json"] = 371,
    ["templatsources.json"] = 372,
    ["theme.json"] = 374,
    tmLanguage = 375,
    ["trunk.yaml schema"] = 380,
    ["ts-force-config.json"] = 384,
    ["tsconfig.json"] = 381,
    ["tsd.json"] = 382,
    ["tsdrc.json"] = 383,
    ["tslint.json"] = 385,
    ...
    ["version.json"] = 396,
    ["vim-addon-info"] = 397,
    ["vs-2017.3.host.json"] = 399,
    ["vs-nesting.json"] = 400,
    ["vsls.json"] = 398,
    ["vss-extension.json"] = 404,
    ["webhint.io"] = 512,
    ["webjobpublishsettings.json"] = 409,
    ["webjobs-list.json"] = 408,
    ["xs-app.json"] = 433,
    ["xunit.runner.json"] = 418,
    yamllint = 456,
    zuul = 442,
    ["Žinoma"] = 450
  },
