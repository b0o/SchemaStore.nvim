...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1068,
    [".nodehawkrc"] = 685,
    [".npmpackagejsonlintrc"] = 690,
    [".omletrc"] = 1249,
    [".phrase.yml"] = 771,
    [".phraseapp.yml"] = 772,
    [".pmbot.yml"] = 756,
    [".postcssrc"] = 765,
    [".powerpages-web-template-manifest"] = 767,
    [".pre-commit-config.yml"] = 768,
    [".pre-commit-hooks.yml"] = 769,
    [".putout.json"] = 805,
    [".rehyperc"] = 830,
    [".remarkrc"] = 834,
    [".sprite files"] = 936,
    ...
    AIConfig = 45,
    ["AMX Muse Program Descriptor"] = 1298,
    ["API Builder"] = 1104,
    ["AVA Configuration"] = 1168,
    ...
    ["AWS Copilot Manifest"] = 1337,
    ["AWS SAM CLI Samconfig"] = 308,
    Acton = 1388,
    ["Adobe UXP Manifest"] = 1231,
    ["Aerleon Network & Service Definitions"] = 27,
    ["Aerleon Policy"] = 28,
    ["Agent Permission Policy"] = 1377,
    ["AgentCore CLI"] = 1378,
    AgentLoopKit = 1379,
    Aider = 1327,
    Air = 30,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1348,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1347,
    ["Airlock Microgateway"] = 46,
    ["Alacritty Configuration"] = 1140,
    ["AlgoVoi Compliance Receipt v1"] = 16,
    ["All Contributors configuration file"] = 1194,
    ...
    ["Application list for a WinUtil"] = 1277,
    ArchitectFX = 1282,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1346,
    ["Azure IoT Operations connector metadata"] = 1343,
    ...
    ["Azure Pipelines"] = 133,
    ["Azure Static Web Apps CLI configuration file"] = 940,
    ["Azure Static Web Apps configuration file"] = 939,
    BMML = 1365,
    ["BOSH BPM Config"] = 159,
    ["BOSH CPI Config"] = 160,
    ...
    ["Bacon config"] = 10,
    ["Barba-CV"] = 99,
    ["Bashly (bashly.yml)"] = 1198,
    ["Bashly Settings (bashly-settings.yml)"] = 1199,
    Bento = 1364,
    ["Better Code Hub"] = 1109,
    ["Better Scripts"] = 183,
    Bigconfig = 152,
    ["Biome Formatter Config"] = 100,
    ["Bitmovin Encoding Template"] = 1291,
    BizTalkServerApplicationSchema = 1075,
    Bleep = 184,
    ["Block Protocol Metadata"] = 181,
    ["Bluebricks blueprint config"] = 1370,
    ["Boyka Framework"] = 162,
    ...
    ["Butane Config"] = 1153,
    C4InterFlow = 1306,
    ["CDK Environment Manager, concrete environment configuration"] = 1330,
    ["CDK Environment Manager, concrete environments definition"] = 1329,
    ["CDK Environment Manager, environment definition"] = 1328,
    ["CGS Card Game Specification (cgs.json)"] = 1236,
    ["CICS TS region tagging"] = 1162,
    ["CICS TS resource import"] = 1163,
    ["CICS TS resource model"] = 1164,
    ["CICS TS resource overrides"] = 1165,
    ["CMake Presets"] = 185,
    ["CNC Codes"] = 208,
    ["CRS WAF test file"] = 1266,
    ["CRS WAF test platform overrides file"] = 1267,
    ...
    ["Caido Proxy Configuration"] = 1403,
    ...
    ["Chamaleon environment"] = 1295,
    ["Chamaleon properties"] = 1296,
    ["Chamaleon template"] = 1294,
    Changepacks = 1357,
    Changesets = 317,
    Changie = 194,
    Charmcraft = 195,
    ...
    ["Claude Code Launch Preview"] = 1412,
    ["Claude Code Plugin Manifest"] = 216,
    ["Claude Code Plugin Marketplace"] = 217,
    ["Claude Code Settings"] = 218,
    ["Clawject config"] = 214,
    ["Cloud Foundry Application Manifest"] = 1248,
    ["Cloud Run Spec v1"] = 1272,
    ...
    Concord = 1265,
    ["Configu .cfgu files"] = 1253,
    ["Configu .configu file"] = 1254,
    Conjure = 207,
    ["Container Structure Test"] = 1089,
    Containerlab = 1118,
    ["Contextive Glossary"] = 1322,
    ContractGuard = 1119,
    Convex = 206,
    ...
    ["Cursor Agent Environment"] = 1375,
    ["Custom Machinery Machine"] = 1237,
    ["Custom Machinery Recipe"] = 1238,
    ...
    ["DataYoga Job"] = 234,
    ["Datadog Continuous Testing"] = 588,
    ["Datadog Service Definition"] = 589,
    ["Datadog Software Catalog"] = 590,
    ["Datahub Ingestion Recipe"] = 1169,
    ["Debian Upstream Metadata file"] = 241,
    DebtLens = 242,
    ["Deck config"] = 243,
    ["Declarative Automation Bundles"] = 1215,
    ["DeepMatch deeplinks spec"] = 244,
    ["Dein Config"] = 245,
    ["Deno Config (deno.json)"] = 347,
    ["Dependency cruiser"] = 246,
    ["DeployStack Configuration"] = 247,
    ["Deployah Configuration"] = 1345,
    ["Deployer Recipe"] = 350,
    ["Deta Spacefile"] = 248,
    ...
    ["DonateCaseBetterCasino menu"] = 1299,
    ["Draugr Saga"] = 346,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1206,
    ["EAS config"] = 420,
    ["ECA - Editor Code Assistant"] = 383,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1195,
    ["ESLint Suppressions"] = 425,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1342,
    ["EasyVCR .NET"] = 422,
    ["Eidolon Resource"] = 1283,
    ...
    ["Envelope Team Definition"] = 1387,
    ["Envilder Map File"] = 388,
    ["Erda Pipeline"] = 1244,
    ["Erda Runtime"] = 1245,
    ["Espanso config.yml"] = 1368,
    ["Espanso match.yml"] = 1367,
    Esquio = 408,
    ["Estuary Flow Catalog"] = 1159,
    ["Ethereum ERC1155"] = 1381,
    ["Ethereum ERC721"] = 1380,
    ...
    ["Evolving Resolutive Process notation"] = 1344,
    ["Expo SDK"] = 419,
    ...
    ["GeoJSON.json latest"] = 1157,
    GherKing = 1161,
    ["GitHub Action"] = 463,
    ["GitHub Actions typing"] = 1279,
    ...
    ["Google Digital Assetlinks"] = 1323,
    Goreleaser = 498,
    ["Goreleaser Pro"] = 499,
    Goss = 501,
    ["Gradle Build Cache Node"] = 1107,
    ["Gradle Enterprise"] = 1106,
    ["Grafana 5.x Dashboard"] = 502,
    ["GraphQL Code Generator"] = 507,
    ["GraphQL Config"] = 506,
    ["GraphQL Mesh"] = 505,
    ["GroovyLint configuration"] = 508,
    ["Grunt JSHint task"] = 512,
    ["Grunt Watch task"] = 513,
    ["Grunt base task"] = 514,
    ["Grunt clean task"] = 510,
    ["Grunt copy task"] = 509,
    ["Grunt cssmin task"] = 511,
    HEMTT = 1071,
    Hadolint = 1085,
    Hammerkit = 1117,
    ["Hardware Sentry Configuration"] = 1173,
    ["Hashgraph Online Skill Manifest"] = 6,
    ["HashiCorp Vault"] = 515,
    Hatch = 1086,
    Hayson = 517,
    ["Haystack Pipeline"] = 518,
    ["Hazelcast 5 Configuration"] = 519,
    ["Hecate Input Schema"] = 1334,
    ["Helm Chart.lock"] = 266,
    ["Helm Chart.yaml"] = 265,
    ["Helm Unittest Test Suite"] = 267,
    ["Heloisa Assistant Plugins Marketplace"] = 1410,
    ["Hex file"] = 268,
    ["Home Assistant Integration Manifest"] = 521,
    ["Homer dashboard configuration"] = 522,
    ["Hoverfly Simulation"] = 527,
    Hugo = 1149,
    ["Hugo Theme"] = 1148,
    ["Hulak Configuration"] = 530,
    ["Hyperfoil benchmark configuration"] = 529,
    ["IBM Zapp document"] = 531,
    ["IBM zCodeFormatSettings"] = 532,
    ["IMG Catapult PSP"] = 537,
    ["IVMS101 by CODE Protocol"] = 1234,
    ["Infinispan Configuration"] = 539,
    ["Infinispan Server Configuration"] = 540,
    Infrahub = 541,
    Istanbul = 1177,
    ["JDownloader2 crawler multi-rules"] = 555,
    ["JDownloader2 crawler single-rules"] = 554,
    ["JFrog Applications Config"] = 556,
    ["JFrog File Spec"] = 557,
    ["JFrog Pipelines YML DSL"] = 1183,
    ["JMeter DSL cli config"] = 558,
    JReleaser = 561,
    ["JSON Document Transform"] = 569,
    ["JSON Feed"] = 570,
    ["JSON Resume"] = 843,
    ["JSON Schema Draft 2020-12"] = 1051,
    ["JSON Schema Draft 4"] = 1048,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1216,
    ["JSON Schema Draft 7"] = 1049,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1217,
    ["JSON Schema Draft 8 (2019-09)"] = 1050,
    ["JSON-API"] = 568,
    ["JSON-e templates"] = 1114,
    ["JSON-stat 2.0"] = 1044,
    JSONPatch = 572,
    ["JSR Package Config (jsr.json)"] = 562,
    Jarl = 1350,
    Jasmine = 549,
    Jekyll = 550,
    ["Jenkins X Pipelines"] = 551,
    ["Jenkins X Requirements"] = 552,
    Jest = 553,
    Jocker = 559,
    ["Jovo Language Models"] = 560,
    ["Jujutsu (jj) VCS config"] = 1336,
    ["KIMMDY config file"] = 583,
    ["KODE/CI build.yaml"] = 1179,
    ["KSP-AVC"] = 1045,
    ["KSP-CKAN"] = 1046,
    ["KSP-NetKAN"] = 1047,
    KSY = 1246,
    ...
    Kas = 575,
    ["Kestra flow file"] = 584,
    ["Keycloak REST API"] = 1186,
    ["Knative Functions - func.yaml"] = 443,
    Knip = 444,
    ["Knip JSONC"] = 445,
    ["Knowledge Unit"] = 592,
    ["Kometa (nightly) config file"] = 586,
    ["Kometa config file"] = 585,
    ["Kong DBLess config"] = 1180,
    KrakenD = 587,
    ["Kubri Configuration"] = 595,
    LOOBin = 611,
    ["Lake configuration file"] = 1339,
    ...
    ["Lando (landofile)"] = 126,
    ["LangGraph Platform configuration"] = 1258,
    ["Language configuration"] = 1257,
    Lefthook = 600,
    ["Liferay client-extension.yaml"] = 607,
    ["LinkML Metamodel"] = 609,
    Liquibase = 1124,
    ["Liquibase Flow File"] = 1125,
    ["Lively Properties"] = 610,
    ["Lobe AI Agent"] = 128,
    Loki = 129,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 654,
    ["MS2Rescore Configuration"] = 662,
    ["MSTest testconfig.json"] = 663,
    ["Madge configuration"] = 617,
    ["Madness (madness.yml)"] = 1197,
    ["Mado configuration"] = 618,
    ["Maestro Flow"] = 619,
    ["Mail Servers Configuration"] = 1371,
    ["MapEHR Mapping"] = 620,
    Markdownlint = 1128,
    ["Mason Registry"] = 1131,
    ["MegaLinter Custom Flavor"] = 623,
    ["MegaLinter configuration"] = 622,
    ["MegaLinter descriptor"] = 624,
    Melange = 1224,
    ["Meltano project definition"] = 625,
    ["Mergify Configuration"] = 664,
    ["Mermaid config"] = 1,
    ["Metadata for a Bazel module"] = 626,
    ["Metadata for a Cinnamon spice"] = 1275,
    ["Metatype Configuration"] = 627,
    ["MetricsHub Configuration"] = 628,
    ["MetricsHub Connector Configuration"] = 629,
    ["Micro Editor Syntax"] = 1207,
    ["Microsoft Band Web Tile"] = 630,
    ["Microsoft RulesEngine workflow rules"] = 1262,
    ["Microsoft RulesEngine workflow rules list"] = 1263,
    ["Minecraft Custom Main Menu Mod"] = 1225,
    ["Minecraft Data Pack Advancement"] = 632,
    ["Minecraft Data Pack Biome"] = 633,
    ["Minecraft Data Pack Configured Carver"] = 634,
    ["Minecraft Data Pack Damage Type"] = 635,
    ["Minecraft Data Pack Dimension"] = 637,
    ["Minecraft Data Pack Dimension Type"] = 636,
    ["Minecraft Data Pack Item Modifier"] = 638,
    ["Minecraft Data Pack Loot Table"] = 639,
    ["Minecraft Data Pack Metadata"] = 640,
    ["Minecraft Data Pack Predicate"] = 641,
    ["Minecraft Data Pack Recipe"] = 642,
    ["Minecraft Data Pack Tag"] = 643,
    ["Minecraft Data Pack Template Pool"] = 644,
    ["Minecraft Data Pack Trim Material"] = 649,
    ["Minecraft Data Pack Trim Pattern"] = 650,
    ["Minecraft Resource Pack Lang"] = 645,
    ["Minecraft Resource Pack Particle"] = 646,
    ["Minecraft Resource Pack Texture Mcmeta"] = 648,
    ["Minecraft Resourcepack Sounds"] = 647,
    ["MockServer Expectation"] = 656,
    ["MockServer Expectations"] = 657,
    ModuleAssembler = 652,
    ["Monade CLI Stack Configuration"] = 667,
    ["MongoDB Atlas Search Index Definition"] = 1178,
    ["Monika Configuration"] = 1176,
    ["Monoweave Configuration"] = 661,
    ["Motif config"] = 1067,
    MultiQC = 1316,
    ["NOX Framework (Service)"] = 689,
    ["Netin Diagnostic System Template"] = 1135,
    ["Netlify config"] = 670,
    ["Network-as-Code Data Model"] = 671,
    ["Next Gen UI Agent A2A Server Configuration"] = 672,
    ["Next Gen UI Agent Configuration"] = 674,
    ["Next Gen UI Agent MCP Server Configuration"] = 673,
    ["Nightwatch.js"] = 681,
    ["Nika workflow"] = 686,
    ["Node.js configuration"] = 1072,
    ["NueJS configuration file"] = 694,
    ["Nuitka Package Config"] = 1239,
    ["Nullstone config"] = 696,
    ["ODGS Data Rules"] = 703,
    ["ODGS Ontology Graph"] = 704,
    ["ODGS Standard Metrics"] = 702,
    ["OKF Graph"] = 1411,
    ["ONe's changelog entry"] = 718,
    ["ONe's service descriptor"] = 717,
    ["ORT Server repository environment configuration"] = 728,
    ["OSCAL Assessment Plan (AP)"] = 730,
    ["OSCAL Assessment Results (AR)"] = 731,
    ["OSCAL Catalog"] = 732,
    ["OSCAL Component Definition (CDef)"] = 733,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 734,
    ["OSCAL Profile"] = 735,
    ["OSCAL System Security Plan (SSP)"] = 736,
    ["OSS Review Toolkit configuration"] = 737,
    ["OSS Review Toolkit curation"] = 738,
    ["OSS Review Toolkit package configuration"] = 739,
    ["OSS Review Toolkit project package manager definition"] = 740,
    ["OSS Review Toolkit repository configuration"] = 741,
    ["OSS Review Toolkit resolutions"] = 742,
    ["October CMS columns"] = 700,
    ["October CMS fields"] = 701,
    ["Oh My Posh"] = 706,
    Okteto = 707,
    ["Ona Automations"] = 709,
    Opctl = 1070,
    ["Open Data Contract Standard (ODCS)"] = 722,
    ["Open Data Product Standard (ODPS)"] = 723,
    ["Open Know-How"] = 1321,
    OpenDecree = 1385,
    ["OpenDecree Configuration"] = 1386,
    ["OpenRewrite Resource"] = 720,
    OpenSRM = 724,
    OpenStatus = 1332,
    ["OpenTelemetry Declarative Configuration"] = 721,
    ["OpenUtau character yaml"] = 714,
    ["OpenUtau ustx"] = 715,
    ["OpenWeather Current Weather API"] = 1113,
    ["OpenWeather Road Risk API"] = 1112,
    ["Ory Hydra configuration"] = 528,
    ["Ory Keto configuration"] = 591,
    ["Ory Kratos configuration"] = 729,
    ["Ory Oathkeeper configuration"] = 698,
    ["Outblocks App configuration"] = 726,
    ["Outblocks database table"] = 727,
    ["Outblocks project configuration"] = 725,
    PDM = 750,
    POPxf = 762,
    ["POPxf Correlations"] = 763,
    ["PRML manifest"] = 770,
    Packer = 746,
    PactSpec = 747,
    Panache = 748,
    Pantsbuild = 1193,
    ["Paper paper-plugin.yml"] = 749,
    ["Pipeline component"] = 1126,
    ["Platform.sh application"] = 12,
    ["Platform.sh routes"] = 13,
    ["Platform.sh services"] = 14,
    ["Plex Prerolls"] = 760,
    ["PocketMine plugin.yml"] = 757,
    ["Podman Desktop Extension"] = 1405,
    ["Postman collection"] = 766,
    ["Power Pages Configuration"] = 1333,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1278,
    ["ProActions AI-Kit Configuration"] = 778,
    ["ProActions AI-Kit Configuration for Menus"] = 780,
    ["ProActions AI-Kit Configuration for Sections"] = 782,
    ["ProActions AI-Kit Configuration for Services"] = 779,
    ["ProActions AI-Kit Configuration for Steps"] = 783,
    ["ProActions AI-Kit Configuration for Templates"] = 781,
    ["Problem object RFC9457"] = 1222,
    ["Problem package format"] = 784,
    ["Problem package generators"] = 785,
    ["Problem package submissions"] = 786,
    ["Problem package test group metadata"] = 787,
    Pterodactyl = 1172,
    ["Pull Request Labeler"] = 804,
    Pulumi = 812,
    ["PyGTA Config"] = 808,
    PyProject = 813,
    Pylock = 1324,
    Pyright = 814,
    ["Python script metadata"] = 1318,
    ["QType AI DSL"] = 817,
    Qgoda = 816,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1397,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1395,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1401,
    ["Qlik Talend Cloud Pipeline - Project"] = 1393,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1396,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1398,
    ["Qlik Talend Cloud Pipeline - Task"] = 1394,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1400,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1399,
    Qodana = 1145,
    ["Qt Creator workspace file"] = 1255,
    ["Quali Torque Blueprint Spec 2"] = 1170,
    ["QueryFirst config file"] = 1189,
    ["QuikRun Configuration"] = 1402,
    ["Qwen Code Settings"] = 1382,
    ["RKE Cluster Configuration JSON"] = 1123,
    ["RKE Cluster Configuration YAML"] = 1122,
    RadioHound = 807,
    ["Raid Profile"] = 1383,
    ["Raid Repo Configuration"] = 1384,
    Railpack = 819,
    Railway = 818,
    ["Rancher Fleet"] = 809,
    ["Rattler-build"] = 820,
    Ray = 1084,
    ["Read the Docs"] = 811,
    ["Red-DiscordBot Cog"] = 827,
    ["Red-DiscordBot Cog Repo"] = 828,
    ["Red-DiscordBot Trivia"] = 829,
    ["Releasaurus Config"] = 9,
    ReleaseKit = 8,
    ["Render Blueprints"] = 1121,
    RenderCV = 847,
    Renovate = 844,
    ["Renovate global configuration"] = 845,
    ["Renovate inherited configuration"] = 846,
    ["Replit config"] = 835,
    Restate = 1311,
    ["Revel Digital Gadget Definition File"] = 1335,
    RoadRunner = 849,
    ["Robust Station Image"] = 1341,
    Rockcraft = 850,
    ["Roo Coder Custom Modes"] = 851,
    Rubocop = 840,
    ["Rudder techniques"] = 1229,
    Ruff = 841,
    ["Rust Project"] = 842,
    ["Rust toolchain"] = 856,
    ["SDMX data message"] = 883,
    ["SDMX metadata message"] = 882,
    ["SDMX structure message"] = 881,
    ["SIL Kit Participant Configuration"] = 894,
    ["SIL Kit Registry Configuration"] = 895,
    ["SPDX 2.3"] = 937,
    SWADL = 953,
    ["Safebox Config"] = 1184,
    ["Sapphire CLI Config"] = 859,
    ["SauceCTL Configuration"] = 1132,
    Scarb = 879,
    ["Schema Catalog"] = 874,
    ["Scoop manifest"] = 880,
    ["Secure SDLC Evidence Bundle"] = 884,
    ["Semantic Data Fabric (SDF) file"] = 885,
    ["Semgrep Rule"] = 887,
    ["Serenity Code Generator (Sergen)"] = 888,
    ["Serverless Framework Configuration"] = 1139,
    ["Serverless Workflow"] = 1141,
    ["Settings for a Cinnamon spice"] = 1274,
    ["Settings.paf"] = 890,
    ["Shopware 6 Configuration"] = 1142,
    ["Shopware CLI Extension Store Configuration"] = 1143,
    ["Shopware CLI Project Store Configuration"] = 1144,
    ["Sigma Detection Rule"] = 892,
    ["SigmaCV CV"] = 4,
    ["Sigrid scope configuration file"] = 893,
    ["SkyPilot Task JSON"] = 1230,
    ["Slack app manifest"] = 900,
    ["Slang Server Configuration"] = 1409,
    Snapcraft = 902,
    ["Solarxy project config"] = 905,
    Solidarity = 906,
    ["Solution filters"] = 907,
    ["Source Maps v3"] = 908,
    Sourcery = 909,
    ["Spack bootstrap.yaml"] = 910,
    ["Spack cdash.yaml"] = 911,
    ["Spack ci.yaml"] = 912,
    ["Spack compilers.yaml"] = 913,
    ["Spack concretizer.yaml"] = 914,
    ["Spack config.yaml"] = 915,
    ["Spack definitions.yaml"] = 916,
    ["Spack develop.yaml"] = 917,
    ["Spack env_vars.yaml"] = 918,
    ["Spack environment"] = 924,
    ["Spack include.yaml"] = 919,
    ["Spack mirrors.yaml"] = 920,
    ["Spack modules.yaml"] = 921,
    ["Spack packages.yaml"] = 922,
    ["Spack repos.yaml"] = 923,
    ["Spack toolchains.yaml"] = 925,
    ["Spack upstreams.yaml"] = 926,
    ["Spack view.yaml"] = 927,
    ["Speakeasy Generation Config File"] = 931,
    ["Speakeasy Lint Configuration File"] = 928,
    ["Speakeasy Test Generation Configuration File"] = 929,
    ["Speakeasy Workflow File"] = 930,
    SpecIF = 932,
    ["Specmatic Configuration"] = 933,
    ["Specpin spec file"] = 2,
    ["Sponge Mixin configuration"] = 934,
    ["Spotlight Ruleset"] = 935,
    StackBlitz = 941,
    ["StackHawk Scanner Configuration"] = 1138,
    Stale = 942,
    Starfish = 943,
    ["Starlake Data Pipeline"] = 1110,
    Starship = 944,
    ["Statamic Blueprint"] = 945,
    ["Stella configuration file"] = 946,
    ["Streamlit configuration file"] = 947,
    ["Stryker Mutator"] = 950,
    ["StyleCop Analyzers Configuration"] = 951,
    ["Stylelint (.stylelintrc)"] = 952,
    ["Stylua Config"] = 1325,
    ["Sublime Syntax"] = 1185,
    ["Subsquid squid manifest"] = 1232,
    ["Swagger API 2.0"] = 954,
    ["Synadia Connect Component"] = 955,
    TSON = 993,
    TSTyche = 994,
    ["TYPO3 Vendor Bundler config"] = 1000,
    ["Tab data for a LinUtil"] = 1281,
    ["Tab list for a LinUtil"] = 1280,
    Tach = 956,
    ["Tach Domain"] = 957,
    Talhelper = 959,
    ["Talisman configuration"] = 960,
    Taplo = 1326,
    ["Taskfile config"] = 1115,
    Taurus = 961,
    Tauticord = 962,
    ["Tekton Pipeline"] = 1354,
    ["Tekton PipelineRun"] = 1355,
    ["Tekton Task"] = 1352,
    ["Tekton TaskRun"] = 1353,
    Telefonistka = 1312,
    ["Terrateam config"] = 1338,
    ["TestEnvironment.json"] = 974,
    ["TextMate Grammar"] = 973,
    Threagile = 968,
    ["Tier.run pricing.json"] = 965,
    Tikibase = 966,
    Tombi = 971,
    ["Traefik v2"] = 977,
    ["Traefik v2 File Provider"] = 978,
    ["Traefik v3"] = 979,
    ["Traefik v3 File Provider"] = 980,
    ["Travis CI (.travis.yml)"] = 976,
    Treefmt = 504,
    Trident = 1308,
    Trivy = 983,
    ["TrueScript for *.tscript files"] = 984,
    ["Tugboat QA config.yml"] = 1305,
    TunnelHub = 1220,
    Turborepo = 975,
    Tycho = 1269,
    Tye = 1146,
    ["Tyk Gateway - Open Source v5.7+"] = 1317,
    ["UET BuildConfig.json"] = 1190,
    ["UI5 Manifest"] = 1006,
    ["UNCORS configuration"] = 1011,
    ["UTAM Page Object"] = 1009,
    ["Ubuntu Server Autoinstall"] = 1004,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1309,
    ["Uniswap Token List"] = 1095,
    ["Universal Schedule Format"] = 1012,
    ["Unreal Engine Uplugin"] = 1191,
    ["Unreal Engine Uproject"] = 1192,
    ["UpCloud CLI (upctl) configuration"] = 1310,
    ["Updatecli Compose"] = 1154,
    ["Updatecli Policy Manifest"] = 1155,
    ["Updatecli Policy Metadata"] = 1156,
    Uplift = 1188,
    ["Upsun config"] = 11,
    ["User Journey Map"] = 1120,
    V2Ray = 1160,
    ["VSCode Code Snippets"] = 292,
    ["VSIX CLI publishing"] = 1031,
    Vector = 1014,
    ["Vela Pipeline Configuration"] = 1017,
    Vercel = 291,
    ["Version Bumper config"] = 1020,
    Vespertide = 1359,
    ["Vespertide Migration"] = 1360,
    ["Vespertide Model"] = 1361,
    ["Viash Component Config"] = 1314,
    ["Viash Package Config"] = 1315,
    Visivo = 1218,
    Vogi = 1025,
    ["WP-CLI"] = 1041,
    Wake = 1307,
    ["Waku Config"] = 1284,
    ["Web App Manifest"] = 1037,
    ["Web types"] = 1040,
    WebExtensions = 1036,
    ["Webman package recipe"] = 1166,
    ["Windows Package Manager Installer Manifest"] = 1092,
    ["Windows Package Manager Locale Manifest"] = 1093,
    ["Windows Package Manager Singleton Manifest"] = 1091,
    ["WireMock CLI import configuration"] = 1290,
    ["WireMock CLI local service configuration"] = 1289,
    ["WireMock message stub mapping"] = 1288,
    ["WireMock stub mapping"] = 1287,
    ["Woodpecker pipeline config"] = 1134,
    ["Wrangler CLI"] = 1042,
    ["XenForo add-on manifest"] = 1043,
    ["Xstate Machine"] = 1152,
    ["Yandex Workflow Language"] = 1276,
    ["Yarn Config (.yarnrc.yml)"] = 1108,
    ["Yippee-Ki-JSON configuration YML"] = 1099,
    ["YouTrack App"] = 1273,
    ["Zarf Package Configuration"] = 1340,
    ["Zerops import file"] = 1261,
    ["Zola Configuration"] = 1351,
    abtop = 32,
    act3 = 1389,
    actionlint = 42,
    ["aerleon.yml"] = 26,
    ["amplify.yml"] = 19,
    ["amxx-builder manifest"] = 1404,
    ["angular.json"] = 47,
    apko = 1223,
    ...
    ["behat.yml"] = 163,
    ["bigquery-table"] = 151,
    ["bioimageio resource description"] = 1240,
    ...
    ["cargo-nextest repository configuration"] = 675,
    ["cargo-nextest user configuration"] = 676,
    ["ccmod.json"] = 1285,
    changelogging = 1252,
    ...
    ["chutzpah.json"] = 300,
    cibuildwheel = 201,
    ["clang-format (.clang-format)"] = 1158,
    ["clang-tidy"] = 274,
    clangd = 273,
    clib = 275,
    ...
    ["crowdin.yml"] = 327,
    ["ctfd-setup configuration file"] = 1297,
    ["custom-elements.json"] = 1210,
    ["cypress.json"] = 331,
    ["dacier.yml"] = 1392,
    ...
    ["gematik health care insurance list"] = 1303,
    ["gematik health care patient list"] = 1300,
    ["gematik health care provider institution list"] = 1302,
    ["gematik health care provider list"] = 1301,
    ["gematik tiger test environment configuration"] = 1304,
    ["gh-dash"] = 461,
    ["gha-doctor"] = 462,
    ["git-cliff"] = 458,
    ["git-town.toml"] = 1349,
    ...
    ["ide.host.json"] = 533,
    ["ifstate.yaml"] = 534,
    ["imageoptimizer.json"] = 535,
    ["importmap.json"] = 538,
    ["index.toml (packwiz)"] = 1406,
    instant_python_config = 542,
    instant_python_custom_project = 543,
    intlayer = 544,
    ["ioBroker Configuration"] = 545,
    ["ioBroker JSON UI"] = 546,
    ["ioBroker Package manifest"] = 547,
    ["ixpect.conf.yaml"] = 548,
    ["ize.toml"] = 1187,
    ["jsconfig.json"] = 573,
    ["jscpd Configuration"] = 1171,
    jsdoc = 1083,
    ["k3d.yaml"] = 574,
    ["k9s aliases.yaml"] = 576,
    ["k9s cluster-config.yaml"] = 578,
    ["k9s config.yaml"] = 577,
    ["k9s hotkeys.yaml"] = 579,
    ["k9s plugins.yaml"] = 580,
    ["k9s skin.yaml"] = 581,
    ["k9s views.yaml"] = 582,
    ["kind cluster"] = 596,
    ["kontinuous-config.yaml"] = 594,
    ["kontinuous-values.yaml"] = 593,
    ["kustomization.yaml"] = 597,
    ["label-commenter-config.yml"] = 598,
    ["latexindent configuration"] = 127,
    ["launchsettings.json"] = 599,
    lazydocker = 1209,
    lazygit = 1208,
    ["lego.json"] = 601,
    ["lerna.json"] = 602,
    ["lgtm.yml"] = 603,
    ["liblab.config.json"] = 604,
    ["libman.json"] = 605,
    ["license-report-config.json"] = 606,
    ["linkinator.config.json"] = 608,
    ["lint-staged (.lintstagedrc)"] = 1060,
    ["local.settings.json"] = 613,
    ["localazy.json"] = 614,
    ["lotus.yaml"] = 612,
    ["lsd colors"] = 131,
    ["lsd config"] = 130,
    ...
    lychee = 1059,
    ["macro.json"] = 1175,
    ["markdown-link-check"] = 1129,
    maturin = 1130,
    mboats = 1137,
    memnex = 1390,
    ["micro-settings.json"] = 1202,
    ["mimetypes.json"] = 631,
    ["mirrord config"] = 1063,
    ["misata.yaml"] = 1062,
    mise = 1064,
    ["mkdocs.yml"] = 651,
    ["mockd.yaml"] = 655,
    ["mod.pw.toml (packwiz)"] = 1407,
    ["modelparams.dev Model"] = 658,
    ["models CLI"] = 659,
    ["monospace.yml"] = 660,
    ["moon.yml"] = 1286,
    ["mprocs Configuration file"] = 1256,
    ["mrdocs.yml"] = 653,
    ["mta.yaml"] = 1065,
    ["mtad.yaml"] = 1066,
    ["mycode.json"] = 668,
    nFPM = 680,
    ["napari plugin manifest"] = 669,
    neoload = 1078,
    ["nest-cli"] = 683,
    ["nexus-rpc-gen"] = 1376,
    ["nf-core module environment.yml"] = 677,
    ["nf-core module meta.yml"] = 678,
    ["nf-core subworkflow meta.yml"] = 679,
    ["ninjs (News in JSON)"] = 682,
    ["nitro.json"] = 1077,
    ["nixd configuration"] = 1228,
    ["nlu.json"] = 684,
    ["nodemon.json"] = 687,
    ["noodl config"] = 1136,
    ["notebook.mod.json"] = 688,
    now = 1073,
    ["npm-badges"] = 691,
    ["nswag.json"] = 695,
    ntangle = 697,
    ["nuclei-template.yaml"] = 692,
    ["nuget-project.json"] = 693,
    ["ocelot.json"] = 699,
    ogen = 705,
    ["omnisharp.json"] = 708,
    openHAB = 1362,
    ...
    oxfmt = 1372,
    oxlint = 1373,
    ["pack.toml (packwiz)"] = 1408,
    ["package.json"] = 743,
    ["package.manifest"] = 745,
    ["package.yaml"] = 744,
    ["partial-black.json"] = 164,
    ["partial-fastapi.json"] = 165,
    ["partial-pixi.json"] = 755,
    ["partial-scheduled.json"] = 166,
    ["pattern.json"] = 753,
    ["petstore-v1.0"] = 1182,
    pgap_yaml_input_reader = 751,
    pgrls = 752,
    pgxgen = 1366,
    pitcms = 1369,
    ["pixi.toml"] = 754,
    ["plagiarize-me.yaml"] = 759,
    ["plagiarize.yaml"] = 758,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1293,
    ["podbard.yaml"] = 761,
    ["portman.json"] = 764,
    ["prefect.toml"] = 773,
    ["prefect.yaml"] = 774,
    ...
    ["prettierrc.json"] = 776,
    ["prisma.yml"] = 777,
    ["project-1.0.0-beta3.json"] = 789,
    ["project-1.0.0-beta4.json"] = 790,
    ["project-1.0.0-beta5.json"] = 791,
    ["project-1.0.0-beta6.json"] = 792,
    ["project-1.0.0-beta8.json"] = 793,
    ["project-1.0.0-rc1.json"] = 794,
    ["project-1.0.0-rc2.json"] = 795,
    ["project.json"] = 788,
    ["project.owasp.yaml"] = 796,
    ["prometheus-alertmanager.json"] = 800,
    ["prometheus.json"] = 797,
    ["prometheus.rules.json"] = 798,
    ["prometheus.rules.test.json"] = 799,
    ["proxies.json"] = 801,
    ["publiccode.yml"] = 802,
    ["pubspec.yaml"] = 803,
    ["pyrseas-0.8.json"] = 806,
    pytest = 815,
    ["quilt.mod.json"] = 1203,
    ["rc3 auth"] = 821,
    ["rc3 collection"] = 822,
    ...
    ["rc3 settings"] = 826,
    ["registry.yaml"] = 60,
    ["release drafter"] = 1079,
    ["release-hub.json"] = 7,
    ["release-please-config.json"] = 831,
    ["release-please-manifest.json"] = 832,
    ["release-plz.toml"] = 833,
    ["renv.lock"] = 848,
    ["repo-settings-as-code"] = 836,
    ["reposets Configuration"] = 837,
    ["reposets Credentials"] = 838,
    ["revola.json"] = 5,
    ["rivet.json"] = 1227,
    ["rivet.yaml (legacy)"] = 1226,
    rumdl = 853,
    runny = 852,
    runspec = 1391,
    rustfmt = 854,
    ...
    samt = 857,
    samtrc = 858,
    ["sarif-1.0.0.json"] = 860,
    ["sarif-2.0.0.json"] = 861,
    ["sarif-2.1.0"] = 871,
    ["sarif-2.1.0-rtm.2"] = 862,
    ["sarif-2.1.0-rtm.3"] = 864,
    ["sarif-2.1.0-rtm.4"] = 866,
    ["sarif-2.1.0-rtm.5"] = 868,
    ["sarif-2.1.0-rtm.6"] = 869,
    ["sarif-external-property-file-2.1.0"] = 872,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 863,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 865,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 867,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 870,
    ["scalingo.json configuration"] = 873,
    ["schema.org - Action"] = 875,
    ["schema.org - ContactPoint"] = 876,
    ["schema.org - Place"] = 877,
    ["schema.org - Thing"] = 878,
    ["secrethub.yml"] = 1205,
    ["semantic-release"] = 886,
    ["servicehub.config.json"] = 1054,
    ["servicehub.service.json"] = 1053,
    ["settings.job"] = 889,
    ["sfdx-hardis configuration"] = 891,
    ["shard.yml"] = 1243,
    ["size-limit configuration"] = 896,
    ["skaffold.yaml"] = 1127,
    ["skill-map plugin extension manifest"] = 897,
    ["skill-map project settings"] = 898,
    ["skill-map provider kind"] = 899,
    ["skyuxconfig.json"] = 901,
    ["snowflake-config"] = 903,
    ["snowflake-connections"] = 904,
    ["spicepod.yaml"] = 1264,
    ["sqlc configuration"] = 938,
    ["stripe-app-local.json"] = 949,
    ["stripe-app.json"] = 948,
    swcrc = 1111,
    ["task.json"] = 958,
    taskcat = 1074,
    ["template.json"] = 963,
    ["templatsources.json"] = 964,
    ["text2confl config"] = 1374,
    ["theme.json"] = 967,
    ["tizen_workspace.json"] = 969,
    tldr = 970,
    ["tm_devices configuration file"] = 1331,
    tmuxinator = 1057,
    tox = 972,
    ["transcend.yml"] = 981,
    ["tree-sitter grammar.json"] = 503,
    ["trime.yaml"] = 982,
    ["trunk.yaml"] = 985,
    ["ts-force-config.json"] = 991,
    tsbuild = 986,
    ["tsconfig.json"] = 987,
    ["tsd.json"] = 988,
    ["tsdoc.json"] = 989,
    ...
    ["vega-lite.json"] = 1016,
    ["vega.json"] = 1015,
    ["venvironment.yaml"] = 1018,
    ["venvplus.yaml"] = 1019,
    version = 1313,
    ["version.json"] = 1021,
    ["vhwdebugger-binding.yaml"] = 1023,
    ["vim-addon-info"] = 1024,
    ["vs-2017.3.host.json"] = 1027,
    ["vs-nesting.json"] = 1028,
    ["vsls.json"] = 1026,
    ["vss-extension.json"] = 1032,
    vtcfg = 1319,
    ["vtesttree.yaml"] = 1033,
    ["vtestunit.yaml"] = 1034,
    ["warp-keysets.json"] = 1211,
    ["warp-themes.json"] = 1212,
    ["warp-workflows.json"] = 1213,
    ["webhint.io"] = 1167,
    ["webjobpublishsettings.json"] = 1039,
    ["webjobs-list.json"] = 1038,
    ["well-known-fursona"] = 1251,
    ["xs-app.json"] = 1069,
    ["xunit.runner.json"] = 1052,
    yamlfmt = 1096,
    yamllint = 1097,
    ["yap.json"] = 1098,
    ["zerops.yml"] = 1260,
