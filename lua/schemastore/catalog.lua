...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 193,
    [".cryproj (generic)"] = 653,
    [".cryproj engine-5.2"] = 648,
    [".cryproj engine-5.3"] = 649,
    [".cryproj engine-5.4"] = 650,
    [".cryproj engine-5.5"] = 651,
    [".cryproj engine-dev"] = 652,
    [".eslintrc"] = 248,
    [".esmrc.json"] = 240,
    [".ffizer.yaml"] = 252,
    [".htmlhintrc"] = 307,
    ...
    ["Adobe UXP Manifest"] = 821,
    ["Aerleon Network & Service Definitions"] = 7,
    ["Aerleon Policy"] = 8,
    ["Airlock Microgateway"] = 12,
    ["Airplane task"] = 13,
    ["Alacritty Configuration"] = 728,
    ["All Contributors configuration file"] = 786,
    ...
    ["Azure Pipelines"] = 64,
    ["Azure Static Web Apps CLI configuration file"] = 560,
    ["Azure Static Web Apps configuration file"] = 559,
    ["BX CI"] = 102,
    ["Bashly (bashly.yml)"] = 790,
    ["Bashly Settings (bashly-settings.yml)"] = 791,
    ["Better Code Hub"] = 700,
    ["Better Scripts"] = 103,
    Bigconfig = 81,
    BizTalkServerApplicationSchema = 670,
    Bleep = 104,
    ...
    ["Butane Config"] = 741,
    ["CGS Custom Card Game (CardGameDef.json)"] = 826,
    ["CICS TS region tagging"] = 750,
    ["CICS TS resource import"] = 751,
    ["CICS TS resource model"] = 752,
    ["CICS TS resource overrides"] = 753,
    ["CMake Presets"] = 105,
    ["CNC Codes"] = 117,
    ...
    ["DataYoga Job"] = 124,
    ["Databricks Asset Bundles"] = 807,
    ["Datadog Service Definition"] = 348,
    ["Datahub Ingestion Recipe"] = 757,
    ["Dein Config"] = 126,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 798,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 787,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 823,
    GitVersion = 272,
    ["Gitea Issue Template forms"] = 273,
    ["Gitpod Configuration"] = 282,
    ["GlazeWM settings"] = 825,
    ...
    ["Goreleaser Pro"] = 288,
    Goss = 289,
    ["Gradle Build Cache Node"] = 698,
    ["Gradle Enterprise"] = 697,
    ...
    Hadolint = 679,
    Hammerkit = 707,
    ["Hardware Sentry Configuration"] = 761,
    Hatch = 680,
    Hayson = 302,
    ...
    ["IVMS101 by CODE Protocol"] = 824,
    Istanbul = 764,
    ["JDownloader2 crawler multi-rules"] = 325,
    ["JDownloader2 crawler single-rules"] = 324,
    ["JFrog Applications Config"] = 326,
    ["JFrog File Spec"] = 327,
    ["JFrog Pipelines YML DSL"] = 770,
    ["JMeter DSL cli config"] = 328,
    JReleaser = 330,
    ["JSON Document Transform"] = 338,
    ["JSON Feed"] = 339,
    ["JSON Resume"] = 504,
    ["JSON Schema Draft 2020-12"] = 644,
    ["JSON Schema Draft 4"] = 641,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 808,
    ["JSON Schema Draft 7"] = 642,
    ["JSON Schema Draft 7 (unofficial strict)"] = 809,
    ["JSON Schema Draft 8 (2019-09)"] = 643,
    ["JSON-API"] = 337,
    ["JSON-e templates"] = 705,
    ["JSON-stat 2.0"] = 638,
    JSONPatch = 341,
    ...
    ["KoDE/CI build.yaml"] = 766,
    ["Kong DBLess config"] = 767,
    KrakenD = 347,
    LOOBin = 366,
    Lefthook = 355,
    ...
    ["Micro Editor Syntax"] = 799,
    ["Microsoft Band Web Tile"] = 378,
    ["Minecraft Custom Main Menu Mod"] = 816,
    ...
    ["MongoDB Atlas Search Index Definition"] = 765,
    ["Monika Configuration"] = 763,
    ["Monoweave Configuration"] = 402,
    ["Motif config"] = 663,
    ["NOX Framework (Service)"] = 418,
    ["Netin Diagnostic System Template"] = 723,
    ["Netlify config"] = 409,
    ...
    ["OpenUtau ustx"] = 431,
    ["OpenWeather Current Weather API"] = 704,
    ["OpenWeather Road Risk API"] = 703,
    ...
    ["Pipeline component"] = 715,
    ["PocketMine plugin.yml"] = 456,
    ["Postman collection"] = 461,
    ["Problem object RFC9457"] = 813,
    ["Problem package generators"] = 468,
    Pterodactyl = 760,
    ["Pull Request Labeler"] = 483,
    Pulumi = 489,
    PyProject = 490,
    Pyright = 491,
    Qgoda = 492,
    Qodana = 733,
    ["Quali Torque Blueprint Spec 2"] = 758,
    ["QueryFirst config file"] = 781,
    ["RKE Cluster Configuration JSON"] = 712,
    ["RKE Cluster Configuration YAML"] = 711,
    ["Rancher Fleet"] = 486,
    ["Rattler-build"] = 493,
    Ray = 678,
    ["Read the Docs"] = 488,
    ["Red-DiscordBot Cog"] = 494,
    ["Red-DiscordBot Cog Repo"] = 495,
    ["Red-DiscordBot Trivia"] = 496,
    ["Render Blueprints"] = 710,
    RenderCV = 506,
    Renovate = 505,
    ["Replit config"] = 500,
    RoadRunner = 507,
    ["Rudder techniques"] = 819,
    Ruff = 502,
    ["Rust Project"] = 503,
    ["Rust toolchain"] = 510,
    ["SDMX data message"] = 535,
    ["SDMX metadata message"] = 534,
    ["SDMX structure message"] = 533,
    ["SIL Kit Participant Configuration"] = 545,
    ["SIL Kit Registry Configuration"] = 546,
    SWADL = 571,
    ["Safebox Config"] = 771,
    ["Sapphire CLI Config"] = 513,
    ["SauceCTL Configuration"] = 720,
    ["Schema Catalog"] = 527,
    ["Scoop manifest"] = 532,
    ["Semantic Data Fabric (SDF) file"] = 536,
    ["Semgrep Rule"] = 538,
    ["Serenity Code Generator (Sergen)"] = 539,
    ["Serverless Framework Configuration"] = 727,
    ["Serverless Workflow"] = 729,
    ["Settings.paf"] = 541,
    ["Shopware 6 Configuration"] = 730,
    ["Shopware CLI Extension Store Configuration"] = 731,
    ["Shopware CLI Project Store Configuration"] = 732,
    Sigma = 543,
    ["Sigrid scope configuration file"] = 544,
    ["SkyPilot Task JSON"] = 820,
    ["Slack app manifest"] = 548,
    Solidarity = 551,
    ["Solution filters"] = 552,
    ["Source Maps v3"] = 553,
    Sourcery = 554,
    SpecIF = 555,
    ["Sponge Mixin configuration"] = 556,
    StackBlitz = 561,
    ["StackHawk Scanner Configuration"] = 726,
    Stale = 562,
    ["Starlake Data Pipeline"] = 701,
    Starship = 563,
    ["Statamic Blueprint"] = 564,
    ["Stella configuration file"] = 565,
    ["StrmPrivacy Data Connector"] = 775,
    ["StrmPrivacy Data Contract"] = 776,
    ["StrmPrivacy SimpleSchema"] = 773,
    ["StrmPrivacy Stream"] = 774,
    ["StrmPrivacy batch job configuration file"] = 772,
    ["Stryker Mutator"] = 568,
    ["StyleCop Analyzers Configuration"] = 569,
    ["Stylelint (.stylelintrc)"] = 570,
    ["Sublime Syntax"] = 777,
    ["Subsquid squid manifest"] = 822,
    ["Swagger API 2.0"] = 572,
    TSON = 598,
    TSTyche = 599,
    Talhelper = 574,
    ["Talisman configuration"] = 575,
    ["Taskfile config"] = 706,
    Taurus = 576,
    ["TestEnvironment.json"] = 585,
    ["TextMate Grammar"] = 584,
    ["Tier.run pricing.json"] = 579,
    Tikibase = 580,
    ["Traefik v2"] = 588,
    ["Traefik v2 File Provider"] = 589,
    ["Travis CI (.travis.yml)"] = 587,
    TunnelHub = 812,
    Turborepo = 586,
    Tye = 734,
    ["UET BuildConfig.json"] = 782,
    ["UI5 Manifest"] = 608,
    ["UNCORS configuration"] = 612,
    ["UTAM Page Object"] = 611,
    ["Ubuntu Server Autoinstall"] = 606,
    ["Uniswap Token List"] = 689,
    ["Unreal Engine Uplugin"] = 783,
    ["Unreal Engine Uproject"] = 784,
    ["Updatecli Compose"] = 742,
    ["Updatecli Policy Manifest"] = 743,
    ["Updatecli Policy Metadata"] = 744,
    Uplift = 780,
    ["User Journey Map"] = 709,
    V2Ray = 748,
    ["VSCode Code Snippets"] = 164,
    ["VSIX CLI publishing"] = 626,
    ["Vela Pipeline Configuration"] = 615,
    Vercel = 163,
    Visivo = 810,
    ["Web App Manifest"] = 633,
    ["Web types"] = 636,
    WebExtensions = 632,
    ["Webman package recipe"] = 754,
    ["Windows Package Manager Installer Manifest"] = 686,
    ["Windows Package Manager Locale Manifest"] = 687,
    ["Windows Package Manager Singleton Manifest"] = 685,
    ["Woodpecker pipeline config"] = 722,
    ["Wrangler CLI"] = 637,
    ["Xstate Machine"] = 740,
    ["Yarn Config (.yarnrc.yml)"] = 699,
    ["Yippee-Ki-JSON configuration YML"] = 691,
    ["aerleon.yml"] = 6,
    ["angular.json"] = 14,
    apko = 814,
    ...
    ["behat.yml"] = 88,
    ["bigquery-table"] = 80,
    ["bioimageio resource description"] = 830,
    ...
    ["lint-staged (.lintstagedrc)"] = 657,
    ["local.settings.json"] = 368,
    ["localazy.json"] = 369,
    ["lotus.yaml"] = 367,
    ["lsdlschema.json"] = 370,
    ["markdown-link-check"] = 718,
    mboats = 725,
    ["micro-settings.json"] = 794,
    ["mimetypes.json"] = 379,
    ["mirrord config"] = 658,
    mise = 659,
    ["mise-settings"] = 660,
    ...
    ["prettierrc.json"] = 466,
    ["prisma.yml"] = 467,
    ["project-1.0.0-beta3.json"] = 470,
    ["project-1.0.0-beta4.json"] = 471,
    ["project-1.0.0-beta5.json"] = 472,
    ["project-1.0.0-beta6.json"] = 473,
    ["project-1.0.0-beta8.json"] = 474,
    ["project-1.0.0-rc1.json"] = 475,
    ["project-1.0.0-rc2.json"] = 476,
    ["project.json"] = 469,
    ["prometheus.json"] = 477,
    ["prometheus.rules.json"] = 478,
    ["prometheus.rules.test.json"] = 479,
    ["proxies.json"] = 480,
    ["publiccode.yml"] = 481,
    ["pubspec.yaml"] = 482,
    ["pyrseas-0.8.json"] = 485,
    ["quilt.mod.json"] = 795,
    ["release drafter"] = 673,
    ["release-plz.toml"] = 498,
    ["rivet.yaml"] = 817,
    rockcraft = 508,
    rustfmt = 509,
    samt = 511,
    samtrc = 512,
    ["sarif-1.0.0.json"] = 514,
    ["sarif-2.0.0.json"] = 515,
    ["sarif-2.1.0"] = 525,
    ["sarif-2.1.0-rtm.2"] = 516,
    ["sarif-2.1.0-rtm.3"] = 518,
    ["sarif-2.1.0-rtm.4"] = 520,
    ["sarif-2.1.0-rtm.5"] = 522,
    ["sarif-2.1.0-rtm.6"] = 523,
    ["sarif-external-property-file-2.1.0"] = 526,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 517,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 519,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 521,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 524,
    ["schema.org - Action"] = 528,
    ["schema.org - ContactPoint"] = 529,
    ["schema.org - Place"] = 530,
    ["schema.org - Thing"] = 531,
    ["secrethub.yml"] = 797,
    ["semantic-release"] = 537,
    ["servicehub.config.json"] = 647,
    ...
    snapcraft = 550,
    ["sqlc configuration"] = 558,
    ["stripe-app-local.json"] = 567,
    ["stripe-app.json"] = 566,
    swcrc = 702,
    ["task.json"] = 573,
    taskcat = 669,
    ["template.json"] = 577,
    ["templatsources.json"] = 578,
    ["theme.json"] = 581,
    ["tizen_workspace.json"] = 582,
    tldr = 583,
    tmuxinator = 655,
    ["transcend.yml"] = 590,
    ...
    ["vega-lite.json"] = 614,
    ["vega.json"] = 613,
    ["venvironment-basic.yaml"] = 617,
    ["venvironment.yaml"] = 616,
    ["version.json"] = 618,
    ["vim-addon-info"] = 620,
    ["vs-2017.3.host.json"] = 622,
    ["vs-nesting.json"] = 623,
    ["vsls.json"] = 621,
    ["vss-extension.json"] = 627,
    ["vtesttree.yaml"] = 628,
    ["vtestunit.yaml"] = 629,
    ["warp-keysets.json"] = 803,
    ["warp-themes.json"] = 804,
    ["warp-workflows.json"] = 805,
    ["webhint.io"] = 755,
    ["webjobpublishsettings.json"] = 635,
    ["webjobs-list.json"] = 634,
    ["xs-app.json"] = 665,
    ["xunit.runner.json"] = 645,
    yamllint = 690,
    zuul = 674,
    ["Žinoma"] = 684
  },
