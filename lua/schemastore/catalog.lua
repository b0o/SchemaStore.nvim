...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 175,
    [".cryproj (generic)"] = 599,
    [".cryproj engine-5.2"] = 594,
    [".cryproj engine-5.3"] = 595,
    [".cryproj engine-5.4"] = 596,
    [".cryproj engine-5.5"] = 597,
    [".cryproj engine-dev"] = 598,
    [".csscomb.json"] = 177,
    [".csslintrc"] = 178,
    [".es6importsorterrc.json"] = 726,
    [".eslintrc"] = 227,
    [".esmrc.json"] = 219,
    [".ffizer.yaml"] = 231,
    [".htmlhintrc"] = 282,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 671,
    ["All Contributors configuration file"] = 725,
    ...
    ["Azure Pipelines"] = 59,
    ["Azure Static Web Apps CLI configuration file"] = 515,
    ["Azure Static Web Apps configuration file"] = 514,
    ["BX CI"] = 95,
    ["Better Code Hub"] = 643,
    ["Better Scripts"] = 96,
    Bigconfig = 76,
    BizTalkServerApplicationSchema = 614,
    Bleep = 97,
    ...
    ["Butane Config"] = 683,
    ["CICS TS region tagging"] = 690,
    ["CICS TS resource import"] = 691,
    ["CICS TS resource model"] = 692,
    ["CICS TS resource overrides"] = 693,
    ["CMake Presets"] = 98,
    ["CNC Codes"] = 108,
    ...
    ["Databricks Asset Bundles"] = 746,
    ["Datadog Service Definition"] = 321,
    ["Datahub Ingestion Recipe"] = 697,
    ["Dein Config"] = 113,
    Deno = 188,
    ["Deployer Recipe"] = 191,
    ["Deta Spacefile"] = 114,
    ...
    ["Goreleaser Pro"] = 264,
    Goss = 265,
    ["Gradle Build Cache Node"] = 641,
    ["Gradle Enterprise"] = 640,
    ...
    Hadolint = 623,
    Hammerkit = 650,
    ["Hardware Sentry Configuration"] = 701,
    Hayson = 277,
    ...
    ["JFrog File Spec"] = 302,
    ["JFrog Pipelines YML DSL"] = 710,
    ["JMeter DSL cli config"] = 303,
    JReleaser = 305,
    ["JSON Document Transform"] = 312,
    ["JSON Feed"] = 313,
    ["JSON Resume"] = 464,
    ["JSON Schema Draft 2020-12"] = 590,
    ["JSON Schema Draft 4"] = 587,
    ["JSON Schema Draft 7"] = 588,
    ["JSON Schema Draft 7 (unofficial strict)"] = 747,
    ["JSON Schema Draft 8 (2019-09)"] = 589,
    ["JSON-API"] = 311,
    ["JSON-e templates"] = 648,
    ["JSON-stat 2.0"] = 584,
    JSONPatch = 315,
    Jasmine = 295,
    Jekyll = 296,
    ...
    Kas = 318,
    ["Keycloak REST API"] = 717,
    ["Knative Functions - func.yaml"] = 242,
    ["KoDE/CI build.yaml"] = 706,
    ["Kong DBLess config"] = 707,
    KrakenD = 320,
    LOOBin = 337,
    Lefthook = 328,
    ["LinkML Metamodel"] = 335,
    Liquibase = 655,
    ["Liquibase Flow File"] = 656,
    ...
    ["MongoDB Atlas Search Index Definition"] = 705,
    ["Monika Configuration"] = 703,
    ["Motif config"] = 607,
    ["NOX Framework (Service)"] = 383,
    ["Netin Diagnostic System Template"] = 665,
    ["Netlify config"] = 374,
    ...
    ["OpenWeather Current Weather API"] = 647,
    ["OpenWeather Road Risk API"] = 646,
    ...
    Qgoda = 453,
    Qodana = 676,
    ["Quali Torque Blueprint Spec 2"] = 698,
    ["QueryFirst config file"] = 720,
    ["RKE Cluster Configuration JSON"] = 654,
    ["RKE Cluster Configuration YAML"] = 653,
    ["Rancher Fleet"] = 447,
    Ray = 622,
    ["Read the Docs"] = 449,
    ...
    ["Rust Project"] = 463,
    ["Rust toolchain"] = 468,
    ["SIL Kit Participant Configuration"] = 500,
    ["SIL Kit Registry Configuration"] = 501,
    SWADL = 524,
    ["Safebox Config"] = 711,
    ["Sapphire CLI Config"] = 471,
    ["SauceCTL Configuration"] = 662,
    ["Schema Catalog"] = 485,
    ["Scoop manifest"] = 490,
    ["Semantic Data Fabric (SDF) file"] = 491,
    ["Semgrep Rule"] = 493,
    ["Serenity Code Generator (Sergen)"] = 494,
    ["Serverless Framework Configuration"] = 670,
    ["Serverless Workflow"] = 672,
    ["Settings.paf"] = 496,
    Setuptools = 497,
    ["Shopware 6 Configuration"] = 673,
    ["Shopware CLI Extension Store Configuration"] = 674,
    ["Shopware CLI Project Store Configuration"] = 675,
    ["Sigrid scope configuration file"] = 499,
    ["Slack app manifest"] = 503,
    Solidarity = 506,
    ["Solution filters"] = 507,
    ["Source Maps v3"] = 508,
    Sourcery = 509,
    SpecIF = 510,
    ["Sponge Mixin configuration"] = 511,
    ["StackHawk Scanner Configuration"] = 669,
    Stale = 516,
    ["Starlake Data Pipeline"] = 644,
    Starship = 517,
    ["Statamic Blueprint"] = 518,
    ["StrmPrivacy Data Connector"] = 715,
    ["StrmPrivacy Data Contract"] = 716,
    ["StrmPrivacy SimpleSchema"] = 713,
    ["StrmPrivacy Stream"] = 714,
    ["StrmPrivacy batch job configuration file"] = 712,
    ["Stryker Mutator"] = 521,
    ["StyleCop Analyzers Configuration"] = 522,
    ["Swagger API 2.0"] = 525,
    TSON = 549,
    ["Talisman configuration"] = 527,
    ["Taskfile config"] = 649,
    Taurus = 528,
    ["TestEnvironment.json"] = 537,
    ["TextMate Grammar"] = 536,
    ["Tier.run pricing.json"] = 531,
    Tikibase = 532,
    ["Traefik v2"] = 540,
    ["Traefik v2 File Provider"] = 541,
    Turborepo = 538,
    Tye = 677,
    ["UET BuildConfig.json"] = 721,
    ["UI5 Manifest"] = 557,
    ["UTAM Page Object"] = 560,
    ["Ubuntu Server Autoinstall"] = 555,
    ["Uniswap Token List"] = 632,
    ["Unreal Engine Uplugin"] = 722,
    ["Unreal Engine Uproject"] = 723,
    Updatecli = 684,
    Uplift = 719,
    ["User Journey Map"] = 652,
    V2Ray = 688,
    ["VSCode Code Snippets"] = 146,
    ["VSIX CLI publishing"] = 573,
    ["Vela Pipeline Configuration"] = 563,
    Vercel = 145,
    Visivo = 748,
    ["Web App Manifest"] = 580,
    ["Web types"] = 583,
    WebExtensions = 579,
    ["Webman package recipe"] = 694,
    ["Windows Package Manager Installer Manifest"] = 629,
    ["Windows Package Manager Locale Manifest"] = 630,
    ["Windows Package Manager Singleton Manifest"] = 628,
    ["Woodpecker pipeline config"] = 664,
    ["Xstate Machine"] = 682,
    ["Yippee-Ki-JSON configuration YML"] = 634,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 70,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 730,
    ["bashly-strings.yml"] = 731,
    ["bashly.yml"] = 729,
    ["batect.yml"] = 69,
    ...
    ["lsdlschema.json"] = 341,
    ["madness.yml"] = 728,
    ["markdown-lint-check"] = 660,
    mboats = 667,
    ["micro-settings.json"] = 733,
    ["mimetypes.json"] = 348,
    ["mirrord config"] = 604,
    ["mta.yaml"] = 605,
    ["mtad.yaml"] = 606,
    ...
    ["servicehub.config.json"] = 593,
    ["servicehub.service.json"] = 592,
    ["settings.job"] = 495,
    ["sfdx-hardis configuration"] = 498,
    ["size-limit configuration"] = 502,
    ["skaffold.yaml"] = 658,
    ["skyuxconfig.json"] = 504,
    snapcraft = 505,
    ["sqlc configuration"] = 513,
    ["stripe-app-local.json"] = 520,
    ["stripe-app.json"] = 519,
    swcrc = 645,
    syntax = 738,
    ["task.json"] = 526,
    taskcat = 613,
    ["template.json"] = 529,
    ["templatsources.json"] = 530,
    ["theme.json"] = 533,
    ["tizen_workspace.json"] = 534,
    tldr = 535,
    tmuxinator = 601,
    ["transcend.yml"] = 542,
    ["trunk.yaml"] = 543,
    ["ts-force-config.json"] = 547,
    ["tsconfig.json"] = 544,
    ["tsd.json"] = 545,
    ["tsdrc.json"] = 546,
    ["tslint.json"] = 548,
    ...
    ["vega-lite.json"] = 562,
    ["vega.json"] = 561,
    ["venvironment-basic.yaml"] = 565,
    ["venvironment.yaml"] = 564,
    ["version.json"] = 566,
    ["vim-addon-info"] = 567,
    ["vs-2017.3.host.json"] = 569,
    ["vs-nesting.json"] = 570,
    ["vsls.json"] = 568,
    ["vss-extension.json"] = 574,
    ["vtesttree.yaml"] = 575,
    ["vtestunit.yaml"] = 576,
    ["warp-keysets.json"] = 742,
    ["warp-themes.json"] = 743,
    ["warp-workflows.json"] = 744,
    ["webhint.io"] = 695,
    ["webjobpublishsettings.json"] = 582,
    ["webjobs-list.json"] = 581,
    ["xs-app.json"] = 609,
    ["xunit.runner.json"] = 591,
    yamllint = 633,
    zuul = 618,
    ["Žinoma"] = 627
  },
