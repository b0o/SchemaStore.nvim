...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 197,
    [".cryproj (generic)"] = 669,
    [".cryproj engine-5.2"] = 664,
    [".cryproj engine-5.3"] = 665,
    [".cryproj engine-5.4"] = 666,
    [".cryproj engine-5.5"] = 667,
    [".cryproj engine-dev"] = 668,
    [".eslintrc"] = 253,
    [".esmrc.json"] = 245,
    [".ffizer.yaml"] = 257,
    [".htmlhintrc"] = 313,
    ...
    [".mtaext"] = 680,
    [".nodehawkrc"] = 424,
    [".npmpackagejsonlintrc"] = 428,
    [".omletrc"] = 855,
    [".phrase.yml"] = 474,
    [".phraseapp.yml"] = 475,
    [".pmbot.yml"] = 464,
    [".postcssrc"] = 469,
    [".powerpages-web-template-manifest"] = 471,
    [".pre-commit-config.yml"] = 472,
    [".pre-commit-hooks.yml"] = 473,
    [".putout.json"] = 494,
    [".rehyperc"] = 513,
    [".remarkrc"] = 515,
    [".sprite files"] = 573,
    ...
    ["<div>RIOTS' studio configuration"] = 647,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 378,
    AIConfig = 13,
    ["API Builder"] = 712,
    ["AVA Configuration"] = 772,
    ["AWS CDK cdk.json"] = 181,
    ["AWS CloudFormation"] = 182,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 183,
    ["AWS SAM CLI Samconfig"] = 184,
    ["Adobe UXP Manifest"] = 837,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 14,
    ["Airplane task"] = 15,
    ["Alacritty Configuration"] = 744,
    ["All Contributors configuration file"] = 802,
    ...
    ["Azure Pipelines"] = 67,
    ["Azure Static Web Apps CLI configuration file"] = 576,
    ["Azure Static Web Apps configuration file"] = 575,
    ["BX CI"] = 105,
    ["Bashly (bashly.yml)"] = 806,
    ["Bashly Settings (bashly-settings.yml)"] = 807,
    ["Better Code Hub"] = 716,
    ["Better Scripts"] = 106,
    Bigconfig = 84,
    BizTalkServerApplicationSchema = 686,
    Bleep = 107,
    ...
    ["Butane Config"] = 757,
    ["CGS Custom Card Game (CardGameDef.json)"] = 842,
    ["CICS TS region tagging"] = 766,
    ["CICS TS resource import"] = 767,
    ["CICS TS resource model"] = 768,
    ["CICS TS resource overrides"] = 769,
    ["CMake Presets"] = 108,
    ["CNC Codes"] = 120,
    ["CSS Comb (.csscomb.json)"] = 199,
    ["CSS Lint (.csslintrc)"] = 200,
    ["CSpell (cspell.json)"] = 198,
    CWL = 848,
    ...
    Cheatsheets = 754,
    ["Chrome Extension"] = 174,
    ["Chromia Model"] = 115,
    ["CircleCI config.yml"] = 151,
    ["Citation File Format"] = 186,
    CityJSON = 117,
    ["Clawject config"] = 125,
    ["Cloud Foundry Application Manifest"] = 854,
    ["Code Climate"] = 152,
    CodeCV = 63,
    ["CodeShip Pro services configuration files"] = 163,
    ["CodeShip Pro steps configuration files"] = 164,
    ["Codecov configuration files"] = 162,
    Codux = 160,
    ["Cog config file"] = 121,
    ["Commandbox Box.json"] = 122,
    ["Commandbox Server.json"] = 123,
    ["Common Catalog Data"] = 172,
    Conjure = 119,
    ["Container Structure Test"] = 699,
    Containerlab = 724,
    ["Crowdsec collection config"] = 193,
    ["Crowdsec parser config"] = 194,
    ["Crowdsec scenario config"] = 195,
    ["CumulusCI Config"] = 124,
    ["Custom Machinery Machine"] = 843,
    ["Custom Machinery Recipe"] = 844,
    ["Cycle Stack File"] = 126,
    ["DWP Exchange - catalogue entry"] = 240,
    ["DWP Exchange - gateway"] = 238,
    ["DWP Exchange - meta"] = 239,
    ["Dart Build Config (dart-build.json)"] = 201,
    ["Dart Test Config (dart-test.json)"] = 202,
    ["DashLord Configuration"] = 203,
    ["Data Contract Specification"] = 204,
    ["Data Product Specification"] = 205,
    ["DataYoga Connections"] = 127,
    ["DataYoga Job"] = 128,
    ["Databricks Asset Bundles"] = 823,
    ["Datadog Service Definition"] = 355,
    ["Datahub Ingestion Recipe"] = 773,
    ["Dein Config"] = 130,
    ["Deno Config (deno.json)"] = 211,
    ["Dependency cruiser"] = 131,
    ["Deployer Recipe"] = 214,
    ["Deta Spacefile"] = 132,
    ["Detekt Config (detekt.yml)"] = 215,
    ["Devbox Config"] = 133,
    ["Devbox Plugin"] = 134,
    Devfile = 237,
    ["Discord Webhook"] = 216,
    ["DocFx Config (docfx.json)"] = 219,
    ["Dolittle Artifacts"] = 220,
    ["Dolittle Bounded Context Configuration"] = 221,
    ["Dolittle Event Horizons Configuration"] = 222,
    ["Dolittle Resources Configuration"] = 223,
    ["Dolittle Server Configuration"] = 224,
    ["Dolittle Tenant Map Configuration"] = 226,
    ["Dolittle Tenants Configuration"] = 225,
    ["Dolittle Topology"] = 227,
    ...
    ["Drupal Routing"] = 145,
    ["Drupal Services"] = 147,
    ["Drush site aliases"] = 233,
    ["Dynamic Bash Aliases (.aliases)"] = 814,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 803,
    ["Elgato Stream Deck"] = 243,
    ["Embrace Config"] = 784,
    Endurica = 827,
    ["Enterprise Contract Policy Spec"] = 244,
    ["Erda Pipeline"] = 850,
    ["Erda Runtime"] = 851,
    ["Error pages"] = 248,
    Esquio = 246,
    ["Estuary Flow Catalog"] = 763,
    ["Expo SDK"] = 251,
    ["F-Droid Data metadata"] = 256,
    ["Facets - FSDL - Application"] = 254,
    ["FasterCI Configuration"] = 68,
    FiQuS = 260,
    Firebase = 258,
    ["Flow.json Configurations"] = 847,
    ["Fossa configuration file"] = 267,
    ["Fossa's fossa-deps file"] = 268,
    ["Foundry VTT - Base package Manifest"] = 262,
    ["Foundry VTT - Module Manifest"] = 263,
    ["Foundry VTT - System Data Template"] = 266,
    ["Foundry VTT - System Manifest"] = 264,
    ["Foundry VTT - World Manifest"] = 265,
    ["Foxx Manifest"] = 69,
    ["Freifunk.de Community API"] = 72,
    ["Frogbot Config"] = 73,
    ["G2P Mapping Configuration"] = 272,
    ["GCP Blueprint Metadata"] = 275,
    Gaspar = 273,
    ["GatewayCore API Gateway"] = 274,
    ["GeoJSON.json latest"] = 761,
    GherKing = 765,
    ["GitHub Action"] = 280,
    ["GitHub Discussion"] = 281,
    ["GitHub Funding"] = 282,
    ["GitHub Issue Template configuration"] = 284,
    ["GitHub Issue Template forms"] = 283,
    ["GitHub Workflow"] = 285,
    ["GitHub Workflow Template Properties"] = 286,
    ["GitLab Agent for Kubernetes configuration"] = 839,
    GitVersion = 277,
    ["Gitea Issue Template configuration"] = 278,
    ["Gitea Issue Template forms"] = 279,
    ["Gitpod Configuration"] = 288,
    ["GlazeWM settings"] = 841,
    ["Global Privacy Control"] = 276,
    Goblet = 822,
    ["Golangci-lint Configuration"] = 290,
    ["Golangci-lint Custom Plugins Configuration"] = 291,
    ["Google Chrome Related Website Sets"] = 259,
    ["Google Cloud Workflows"] = 180,
    Goreleaser = 293,
    ["Goreleaser Pro"] = 294,
    Goss = 295,
    ["Gradle Build Cache Node"] = 714,
    ["Gradle Enterprise"] = 713,
    ["Grafana 5.x Dashboard"] = 296,
    ["GraphQL Code Generator"] = 300,
    ["GraphQL Config"] = 299,
    ["GraphQL Mesh"] = 298,
    ["Grunt JSHint task"] = 304,
    ["Grunt Watch task"] = 305,
    ["Grunt base task"] = 306,
    ["Grunt clean task"] = 302,
    ["Grunt copy task"] = 301,
    ["Grunt cssmin task"] = 303,
    HEMTT = 683,
    Hadolint = 695,
    Hammerkit = 723,
    ["Hardware Sentry Configuration"] = 777,
    Hatch = 696,
    Hayson = 308,
    ["Haystack Pipeline"] = 309,
    ["Hazelcast 5 Configuration"] = 310,
    ["Helm Chart.lock"] = 149,
    ["Helm Chart.yaml"] = 148,
    ["Helm Unittest Test Suite"] = 150,
    Hugo = 753,
    ["Hugo Theme"] = 752,
    ["Hyperfoil benchmark configuration"] = 315,
    ["IBM Zapp document"] = 316,
    ["IBM zCodeFormatSettings"] = 317,
    ["IMG Catapult PSP"] = 322,
    ["IVMS101 by CODE Protocol"] = 840,
    Istanbul = 780,
    ["JDownloader2 crawler multi-rules"] = 332,
    ["JDownloader2 crawler single-rules"] = 331,
    ["JFrog Applications Config"] = 333,
    ["JFrog File Spec"] = 334,
    ["JFrog Pipelines YML DSL"] = 786,
    ["JMeter DSL cli config"] = 335,
    JReleaser = 337,
    ["JSON Document Transform"] = 345,
    ["JSON Feed"] = 346,
    ["JSON Resume"] = 520,
    ["JSON Schema Draft 2020-12"] = 660,
    ["JSON Schema Draft 4"] = 657,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 824,
    ["JSON Schema Draft 7"] = 658,
    ["JSON Schema Draft 7 (unofficial strict)"] = 825,
    ["JSON Schema Draft 8 (2019-09)"] = 659,
    ["JSON-API"] = 344,
    ["JSON-WF"] = 853,
    ["JSON-e templates"] = 721,
    ["JSON-stat 2.0"] = 654,
    JSONPatch = 348,
    ["JSR Package Config (jsr.json)"] = 338,
    Jasmine = 327,
    Jekyll = 328,
    ["Jenkins X Pipelines"] = 329,
    ["Jenkins X Requirements"] = 330,
    ["Jovo Language Models"] = 336,
    ["KIMMDY config file"] = 353,
    ["KSP-AVC"] = 655,
    ["KSP-CKAN"] = 656,
    KSY = 852,
    ["Karakum configuration file"] = 269,
    Kas = 351,
    ["Keycloak REST API"] = 794,
    ["Knative Functions - func.yaml"] = 270,
    ["KoDE/CI build.yaml"] = 782,
    ["Kong DBLess config"] = 783,
    KrakenD = 354,
    LOOBin = 373,
    Lefthook = 362,
    ["Liferay client-extension.yaml"] = 369,
    ["LinkML Metamodel"] = 371,
    Liquibase = 729,
    ["Liquibase Flow File"] = 730,
    ["Lively Properties"] = 372,
    ["Lobe AI Agent"] = 65,
    Loki = 66,
    ["MLOS Configs"] = 407,
    ["MS2Rescore Configuration"] = 410,
    ["Madness (madness.yml)"] = 805,
    Markdownlint = 733,
    ["Mason Registry"] = 735,
    ["MegaLinter configuration"] = 379,
    ["MegaLinter descriptor"] = 380,
    Melange = 831,
    ["Meltano plugin discovery definition"] = 382,
    ["Meltano project definition"] = 381,
    ["Mergify Configuration"] = 411,
    ["MetricsHub Configuration"] = 383,
    ["MetricsHub Connector Configuration"] = 384,
    ["Micro Editor Syntax"] = 815,
    ["Microsoft Band Web Tile"] = 385,
    ["Minecraft Custom Main Menu Mod"] = 832,
    ["Minecraft Data Pack Advancement"] = 387,
    ["Minecraft Data Pack Biome"] = 388,
    ["Minecraft Data Pack Configured Carver"] = 389,
    ["Minecraft Data Pack Damage Type"] = 390,
    ["Minecraft Data Pack Dimension"] = 392,
    ["Minecraft Data Pack Dimension Type"] = 391,
    ["Minecraft Data Pack Item Modifier"] = 393,
    ["Minecraft Data Pack Loot Table"] = 394,
    ["Minecraft Data Pack Metadata"] = 395,
    ["Minecraft Data Pack Predicate"] = 396,
    ["Minecraft Data Pack Recipe"] = 397,
    ["Minecraft Data Pack Tag"] = 398,
    ["Minecraft Data Pack Template Pool"] = 399,
    ["Minecraft Data Pack Trim Material"] = 404,
    ["Minecraft Data Pack Trim Pattern"] = 405,
    ["Minecraft Resource Pack Lang"] = 400,
    ["Minecraft Resource Pack Particle"] = 401,
    ["Minecraft Resource Pack Texture Mcmeta"] = 403,
    ["Minecraft Resourcepack Sounds"] = 402,
    ["MkDocs Configuration 1.0"] = 406,
    ["Monade CLI Stack Configuration"] = 414,
    ["MongoDB Atlas Search Index Definition"] = 781,
    ["Monika Configuration"] = 779,
    ["Monoweave Configuration"] = 409,
    ["Motif config"] = 679,
    ["NOX Framework (Service)"] = 427,
    ["Netin Diagnostic System Template"] = 739,
    ["Netlify config"] = 417,
    ["Network-as-Code Data Model"] = 418,
    ["Nightwatch.js"] = 419,
    ["Nuitka.yaml"] = 845,
    ["ONe's changelog entry"] = 443,
    ["ONe's service descriptor"] = 442,
    ["OSS Review Toolkit configuration"] = 450,
    ["OSS Review Toolkit curation"] = 451,
    ["OSS Review Toolkit package configuration"] = 452,
    ["OSS Review Toolkit repository configuration"] = 453,
    ["OSS Review Toolkit resolutions"] = 454,
    Opctl = 682,
    ["OpenRewrite Resource"] = 445,
    ["OpenUtau character yaml"] = 439,
    ["OpenUtau ustx"] = 440,
    ["OpenWeather Current Weather API"] = 720,
    ["OpenWeather Road Risk API"] = 719,
    ["Ory Hydra configuration"] = 314,
    ["Ory Keto configuration"] = 356,
    ["Ory Kratos configuration"] = 449,
    ["Ory Oathkeeper configuration"] = 434,
    ["Outblocks App configuration"] = 447,
    ["Outblocks database table"] = 448,
    ["Outblocks project configuration"] = 446,
    PDM = 460,
    Packer = 457,
    Pantsbuild = 801,
    ["Paper paper-plugin.yml"] = 458,
    ["Pipeline component"] = 731,
    ["PocketMine plugin.yml"] = 465,
    ["Postman collection"] = 470,
    ["Problem object RFC9457"] = 829,
    ["Problem package generators"] = 478,
    Pterodactyl = 776,
    ["Pull Request Labeler"] = 493,
    Pulumi = 499,
    PyProject = 500,
    Pyright = 501,
    Qgoda = 502,
    Qodana = 749,
    ["Quali Torque Blueprint Spec 2"] = 774,
    ["QueryFirst config file"] = 797,
    ["RKE Cluster Configuration JSON"] = 728,
    ["RKE Cluster Configuration YAML"] = 727,
    ["Rancher Fleet"] = 496,
    ["Rattler-build"] = 503,
    Ray = 694,
    ["Read the Docs"] = 498,
    ["Red-DiscordBot Cog"] = 510,
    ["Red-DiscordBot Cog Repo"] = 511,
    ["Red-DiscordBot Trivia"] = 512,
    ["Render Blueprints"] = 726,
    RenderCV = 522,
    Renovate = 521,
    ["Replit config"] = 516,
    RoadRunner = 523,
    ["Rudder techniques"] = 835,
    Ruff = 518,
    ["Rust Project"] = 519,
    ["Rust toolchain"] = 526,
    ["SDMX data message"] = 551,
    ["SDMX metadata message"] = 550,
    ["SDMX structure message"] = 549,
    ["SIL Kit Participant Configuration"] = 561,
    ["SIL Kit Registry Configuration"] = 562,
    SWADL = 587,
    ["Safebox Config"] = 787,
    ["Sapphire CLI Config"] = 529,
    ["SauceCTL Configuration"] = 736,
    ["Schema Catalog"] = 543,
    ["Scoop manifest"] = 548,
    ["Semantic Data Fabric (SDF) file"] = 552,
    ["Semgrep Rule"] = 554,
    ["Serenity Code Generator (Sergen)"] = 555,
    ["Serverless Framework Configuration"] = 743,
    ["Serverless Workflow"] = 745,
    ["Settings.paf"] = 557,
    ["Shopware 6 Configuration"] = 746,
    ["Shopware CLI Extension Store Configuration"] = 747,
    ["Shopware CLI Project Store Configuration"] = 748,
    Sigma = 559,
    ["Sigrid scope configuration file"] = 560,
    ["SkyPilot Task JSON"] = 836,
    ["Slack app manifest"] = 564,
    Solidarity = 567,
    ["Solution filters"] = 568,
    ["Source Maps v3"] = 569,
    Sourcery = 570,
    SpecIF = 571,
    ["Sponge Mixin configuration"] = 572,
    StackBlitz = 577,
    ["StackHawk Scanner Configuration"] = 742,
    Stale = 578,
    ["Starlake Data Pipeline"] = 717,
    Starship = 579,
    ["Statamic Blueprint"] = 580,
    ["Stella configuration file"] = 581,
    ["StrmPrivacy Data Connector"] = 791,
    ["StrmPrivacy Data Contract"] = 792,
    ["StrmPrivacy SimpleSchema"] = 789,
    ["StrmPrivacy Stream"] = 790,
    ["StrmPrivacy batch job configuration file"] = 788,
    ["Stryker Mutator"] = 584,
    ["StyleCop Analyzers Configuration"] = 585,
    ["Stylelint (.stylelintrc)"] = 586,
    ["Sublime Syntax"] = 793,
    ["Subsquid squid manifest"] = 838,
    ["Swagger API 2.0"] = 588,
    TSON = 614,
    TSTyche = 615,
    Talhelper = 590,
    ["Talisman configuration"] = 591,
    ["Taskfile config"] = 722,
    Taurus = 592,
    ["TestEnvironment.json"] = 601,
    ["TextMate Grammar"] = 600,
    ["Tier.run pricing.json"] = 595,
    Tikibase = 596,
    ["Traefik v2"] = 604,
    ["Traefik v2 File Provider"] = 605,
    ["Travis CI (.travis.yml)"] = 603,
    TunnelHub = 828,
    Turborepo = 602,
    Tye = 750,
    ["UET BuildConfig.json"] = 798,
    ["UI5 Manifest"] = 624,
    ["UNCORS configuration"] = 628,
    ["UTAM Page Object"] = 627,
    ["Ubuntu Server Autoinstall"] = 622,
    ["Uniswap Token List"] = 705,
    ["Unreal Engine Uplugin"] = 799,
    ["Unreal Engine Uproject"] = 800,
    ["Updatecli Compose"] = 758,
    ["Updatecli Policy Manifest"] = 759,
    ["Updatecli Policy Metadata"] = 760,
    Uplift = 796,
    ["User Journey Map"] = 725,
    V2Ray = 764,
    ["VSCode Code Snippets"] = 168,
    ["VSIX CLI publishing"] = 642,
    ["Vela Pipeline Configuration"] = 631,
    Vercel = 167,
    Visivo = 826,
    ["Web App Manifest"] = 649,
    ["Web types"] = 652,
    WebExtensions = 648,
    ["Webman package recipe"] = 770,
    ["Windows Package Manager Installer Manifest"] = 702,
    ["Windows Package Manager Locale Manifest"] = 703,
    ["Windows Package Manager Singleton Manifest"] = 701,
    ["Woodpecker pipeline config"] = 738,
    ["Wrangler CLI"] = 653,
    ["Xstate Machine"] = 756,
    ["Yarn Config (.yarnrc.yml)"] = 715,
    ["Yippee-Ki-JSON configuration YML"] = 707,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 16,
    apko = 830,
    ...
    ["behat.yml"] = 91,
    ["bigquery-table"] = 83,
    ["bioimageio resource description"] = 846,
    ...
    ["chisel-slices.json"] = 185,
    ["chrome-extension-locales-messages.json"] = 175,
    ["chutzpah.json"] = 176,
    cibuildwheel = 116,
    ["clang-format (.clang-format)"] = 762,
    clangd = 155,
    clib = 156,
    ["cloud-init: cloud-config userdata"] = 158,
    ["cloud-sdk-pipeline-configuration"] = 178,
    ["cloudbuild.json"] = 179,
    cloudify = 157,
    codemagic = 159,
    ["coffeelint.json"] = 187,
    ["commands.json"] = 171,
    ["commitlint (.commitlintrc)"] = 704,
    ["compile_commands.json"] = 170,
    ["compilerconfig.json"] = 169,
    ["completely.yml"] = 804,
    ["component-detection-manifest.json"] = 190,
    ["component.json"] = 189,
    ["composer.json"] = 188,
    ["conda-forge"] = 118,
    ["config.yaml"] = 497,
    ["contentmanifest.json"] = 177,
    ["contribute.json"] = 191,
    ["cosmos.config.json"] = 173,
    ["crowdin.yml"] = 192,
    ["custom-elements.json"] = 818,
    ["cypress.json"] = 196,
    ["datalogic-scan2deploy-android"] = 206,
    ["datalogic-scan2deploy-ce"] = 207,
    ["dbt Project"] = 129,
    ["ddev-global"] = 208,
    ["ddev-project"] = 209,
    ["debugsettings.json"] = 210,
    ["dependabot-v2.json"] = 213,
    ["dependabot.json"] = 212,
    ["deployed-cli"] = 755,
    ["devcontainer.json"] = 161,
    devinit = 709,
    ["devspace.yaml"] = 778,
    djlint = 710,
    ["docker sequencer"] = 218,
    ["docker-compose.yml"] = 708,
    ["dockerd.json"] = 217,
    ["dotnet Release Index manifest"] = 228,
    ["dotnet-tools.json"] = 229,
    ["dotnetcli.host.json"] = 230,
    ["dprint.json"] = 231,
    ["drone.json"] = 232,
    ["dss-2.0.0.json"] = 234,
    ["dstack configuration"] = 235,
    ["dvc.yaml"] = 236,
    ["ecosystem.json"] = 241,
    eksctl = 242,
    ["electron-builder configuration file"] = 249,
    ["epr-manifest.json"] = 247,
    ["evcc.yaml"] = 250,
    ["ezd task runner"] = 252,
    ["fabric.mod.json"] = 255,
    ["first-timers-bot"] = 261,
    ...
    ["gitlab-ci"] = 287,
    ["global.json"] = 289,
    ["go-feature-flag Flag Configuration"] = 292,
    ["haxelib.json"] = 307,
    helmfile = 697,
    helmwave = 698,
    ["host-meta.json"] = 312,
    ...
    ["ide.host.json"] = 318,
    ["ifstate.conf"] = 319,
    ["imageoptimizer.json"] = 320,
    ["importmap.json"] = 323,
    ["ioBroker Configuration"] = 324,
    ["ioBroker JSON UI"] = 325,
    ["ioBroker Package manifest"] = 326,
    ["ize.toml"] = 795,
    ["jsconfig.json"] = 349,
    ["jscpd Configuration"] = 775,
    jsdoc = 693,
    ["k3d.yaml"] = 350,
    ["k9s plugin.yml"] = 352,
    ["kontinuous-config.yaml"] = 358,
    ["kontinuous-values.yaml"] = 357,
    ["kustomization.yaml"] = 359,
    ["label-commenter-config.yml"] = 360,
    ["latexindent configuration"] = 64,
    ["launchsettings.json"] = 361,
    lazydocker = 817,
    lazygit = 816,
    ["lego.json"] = 363,
    ["lerna.json"] = 364,
    ["lgtm.yml"] = 365,
    ["liblab.config.json"] = 366,
    ["libman.json"] = 367,
    ["license-report-config.json"] = 368,
    ["linkinator.config.json"] = 370,
    ["lint-staged (.lintstagedrc)"] = 673,
    ["local.settings.json"] = 375,
    ["localazy.json"] = 376,
    ["lotus.yaml"] = 374,
    ["lsdlschema.json"] = 377,
    ["markdown-link-check"] = 734,
    mboats = 741,
    ["micro-settings.json"] = 810,
    ["mimetypes.json"] = 386,
    ["mirrord config"] = 674,
    mise = 675,
    ["mise-settings"] = 676,
    ...
    ["mtad.yaml"] = 678,
    ["mycode.json"] = 415,
    ["napari plugin manifest"] = 416,
    neoload = 688,
    ["nest-cli"] = 422,
    ["ninjs (News in JSON) 1.3"] = 421,
    ["ninjs (News in JSON) 2.0"] = 420,
    ["nixd configuration"] = 834,
    ["nlu.json"] = 423,
    ["nodemon.json"] = 425,
    ["noodl config"] = 740,
    ["notebook.mod.json"] = 426,
    now = 684,
    ["npm-badges"] = 429,
    ["nswag.json"] = 432,
    ntangle = 433,
    ["nuclei-template.yaml"] = 430,
    ["nuget-project.json"] = 431,
    ["ocelot.json"] = 435,
    ["omnisharp.json"] = 436,
    ["openapi.json"] = 437,
    ["openfin.json"] = 444,
    ...
    ["ops.yaml"] = 441,
    ["package.json"] = 455,
    ["package.manifest"] = 456,
    ["partial-black.json"] = 92,
    ["pathfinder.yml"] = 459,
    ["pattern.json"] = 462,
    ["petstore-v1.0"] = 785,
    pgap_yaml_input_reader = 461,
    ["pixi.toml"] = 463,
    ["plagiarize-me.yaml"] = 467,
    ["plagiarize.yaml"] = 466,
    ["portman.json"] = 468,
    ["prettierrc.json"] = 476,
    ["prisma.yml"] = 477,
    ["project-1.0.0-beta3.json"] = 480,
    ["project-1.0.0-beta4.json"] = 481,
    ["project-1.0.0-beta5.json"] = 482,
    ["project-1.0.0-beta6.json"] = 483,
    ["project-1.0.0-beta8.json"] = 484,
    ["project-1.0.0-rc1.json"] = 485,
    ["project-1.0.0-rc2.json"] = 486,
    ["project.json"] = 479,
    ["prometheus.json"] = 487,
    ["prometheus.rules.json"] = 488,
    ["prometheus.rules.test.json"] = 489,
    ["proxies.json"] = 490,
    ["publiccode.yml"] = 491,
    ["pubspec.yaml"] = 492,
    ["pyrseas-0.8.json"] = 495,
    ["quilt.mod.json"] = 811,
    ["rc3 auth"] = 504,
    ["rc3 collection"] = 505,
    ["rc3 environment"] = 506,
    ...
    ["rc3 settings"] = 509,
    ["release drafter"] = 689,
    ["release-plz.toml"] = 514,
    ["rivet.yaml"] = 833,
    rockcraft = 524,
    rustfmt = 525,
    samt = 527,
    samtrc = 528,
    ["sarif-1.0.0.json"] = 530,
    ["sarif-2.0.0.json"] = 531,
    ["sarif-2.1.0"] = 541,
    ["sarif-2.1.0-rtm.2"] = 532,
    ["sarif-2.1.0-rtm.3"] = 534,
    ["sarif-2.1.0-rtm.4"] = 536,
    ["sarif-2.1.0-rtm.5"] = 538,
    ["sarif-2.1.0-rtm.6"] = 539,
    ["sarif-external-property-file-2.1.0"] = 542,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 533,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 535,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 537,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 540,
    ["schema.org - Action"] = 544,
    ["schema.org - ContactPoint"] = 545,
    ["schema.org - Place"] = 546,
    ["schema.org - Thing"] = 547,
    ["secrethub.yml"] = 813,
    ["semantic-release"] = 553,
    ["servicehub.config.json"] = 663,
    ["servicehub.service.json"] = 662,
    ["settings.job"] = 556,
    ["sfdx-hardis configuration"] = 558,
    ["shard.yml"] = 849,
    ["size-limit configuration"] = 563,
    ["skaffold.yaml"] = 732,
    ["skyuxconfig.json"] = 565,
    snapcraft = 566,
    ["sqlc configuration"] = 574,
    ["stripe-app-local.json"] = 583,
    ["stripe-app.json"] = 582,
    swcrc = 718,
    ["task.json"] = 589,
    taskcat = 685,
    ["template.json"] = 593,
    ["templatsources.json"] = 594,
    ["theme.json"] = 597,
    ["tizen_workspace.json"] = 598,
    tldr = 599,
    tmuxinator = 671,
    ["transcend.yml"] = 606,
    ["tree-sitter grammar.json"] = 297,
    ["trime.yaml"] = 607,
    ["trunk.yaml"] = 608,
    ["ts-force-config.json"] = 612,
    ["tsconfig.json"] = 609,
    ["tsd.json"] = 610,
    ["tsdrc.json"] = 611,
    ["tslint.json"] = 613,
    ...
    ["typingsrc.json"] = 621,
    ["typo3.json"] = 619,
    ["ui5-workspace.yaml"] = 626,
    ["ui5.yaml"] = 625,
    unist = 751,
    ["up.json"] = 623,
    v8r = 646,
    vcluster = 856,
    ["vcpkg configuration file"] = 166,
    ["vcpkg manifest file"] = 165,
    ["vega-lite.json"] = 630,
    ["vega.json"] = 629,
    ["venvironment-basic.yaml"] = 633,
    ["venvironment.yaml"] = 632,
    ["version.json"] = 634,
    ["vim-addon-info"] = 636,
    ["vs-2017.3.host.json"] = 638,
    ["vs-nesting.json"] = 639,
    ["vsls.json"] = 637,
    ["vss-extension.json"] = 643,
    ["vtesttree.yaml"] = 644,
    ["vtestunit.yaml"] = 645,
    ["warp-keysets.json"] = 819,
    ["warp-themes.json"] = 820,
    ["warp-workflows.json"] = 821,
    ["webhint.io"] = 771,
    ["webjobpublishsettings.json"] = 651,
    ["webjobs-list.json"] = 650,
    ["well-known-fursona"] = 857,
    ["xs-app.json"] = 681,
    ["xunit.runner.json"] = 661,
    yamllint = 706,
    zuul = 690,
    ["Žinoma"] = 700
  },
