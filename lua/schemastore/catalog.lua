...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 858,
    [".nodehawkrc"] = 523,
    [".npmpackagejsonlintrc"] = 527,
    [".omletrc"] = 1034,
    [".phrase.yml"] = 590,
    [".phraseapp.yml"] = 591,
    [".pmbot.yml"] = 578,
    [".postcssrc"] = 585,
    [".powerpages-web-template-manifest"] = 587,
    [".pre-commit-config.yml"] = 588,
    [".pre-commit-hooks.yml"] = 589,
    [".putout.json"] = 618,
    [".rehyperc"] = 642,
    [".remarkrc"] = 646,
    [".sprite files"] = 733,
    ...
    ["A micro editor config"] = 474,
    ABCInventoryModuleData = 18,
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1079,
    ["API Builder"] = 893,
    ["AVA Configuration"] = 955,
    ["AWS AppConfig Feature Flags-v1"] = 49,
    ["AWS CDK cdk.json"] = 220,
    ["AWS CloudFormation"] = 221,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 222,
    ["AWS Copilot Manifest"] = 1117,
    ["AWS SAM CLI Samconfig"] = 223,
    ["Adobe UXP Manifest"] = 1017,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1108,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 927,
    ["All Contributors configuration file"] = 980,
    ["Ansible Argument Specs"] = 353,
    ["Ansible Collection Galaxy"] = 360,
    ["Ansible Execution Environment"] = 350,
    ["Ansible Inventory"] = 359,
    ["Ansible Meta"] = 351,
    ["Ansible Meta Runtime"] = 352,
    ["Ansible Navigator Configuration"] = 362,
    ["Ansible Playbook"] = 357,
    ["Ansible Requirements"] = 354,
    ["Ansible Rulebook"] = 358,
    ["Ansible Tasks File"] = 356,
    ["Ansible Vars File"] = 355,
    ["Ansible-lint Configuration"] = 361,
    Any = 1044,
    ["AnyWork Automation Configuration"] = 9,
    ["App config Spotify Backstage"] = 25,
    ["Application Accelerator"] = 6,
    ["Application list for a WinUtil"] = 1061,
    ArchitectFX = 1066,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Atmos Manifests"] = 46,
    ["Aurora Agile Meta-Framework"] = 47,
    AutoAPICase = 990,
    ["Avro Avsc"] = 48,
    ...
    ["Azure Landing Zones Library metadata"] = 58,
    ["Azure Landing Zones Library policy default values"] = 59,
    ["Azure Pipelines"] = 79,
    ["Azure Static Web Apps CLI configuration file"] = 737,
    ["Azure Static Web Apps configuration file"] = 736,
    ["BOSH CPI Config"] = 103,
    ["BOSH Deploy Config"] = 104,
    ["BX CI"] = 123,
    ["Bashly (bashly.yml)"] = 984,
    ["Bashly Settings (bashly-settings.yml)"] = 985,
    ["Better Code Hub"] = 897,
    ["Better Scripts"] = 124,
    Bigconfig = 96,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1072,
    BizTalkServerApplicationSchema = 865,
    Bleep = 125,
    ["Block Protocol Metadata"] = 122,
    ["Boyka Framework"] = 105,
    Briefcase = 871,
    ["Build Info"] = 113,
    Buildkite = 115,
    ["Bukkit plugin.yml"] = 114,
    ["BungeeCord plugin.yml"] = 120,
    ["Butane Config"] = 940,
    C4InterFlow = 1087,
    ["CDK Environment Manager, concrete environment configuration"] = 1111,
    ["CDK Environment Manager, concrete environments definition"] = 1110,
    ["CDK Environment Manager, environment definition"] = 1109,
    ["CGS Card Game Specification (cgs.json)"] = 1022,
    ["CICS TS region tagging"] = 949,
    ["CICS TS resource import"] = 950,
    ["CICS TS resource model"] = 951,
    ["CICS TS resource overrides"] = 952,
    ["CMake Presets"] = 126,
    ["CNC Codes"] = 147,
    ["CRS WAF test file"] = 1051,
    ["CRS WAF test platform overrides file"] = 1052,
    ["CSS Comb (.csscomb.json)"] = 248,
    ["CSS Lint (.csslintrc)"] = 249,
    ["CSpell (cspell.json)"] = 247,
    ["CVE Record Format"] = 155,
    CWL = 1028,
    ["Cache Warmup config"] = 127,
    ["Calqulus pipeline"] = 128,
    ["Camel YAML DSL"] = 129,
    ["Cannon TOML"] = 130,
    Carafe = 131,
    ["Cargo Make"] = 133,
    ["Cargo Manifest"] = 132,
    ["Catalog Info Backstage"] = 134,
    ["Chamaleon environment"] = 1076,
    ["Chamaleon properties"] = 1077,
    ["Chamaleon template"] = 1075,
    Changesets = 232,
    Changie = 135,
    Charmcraft = 136,
    Cheatsheets = 937,
    ["ChordPro Configuration"] = 137,
    ["Chrome Extension"] = 213,
    ["Chromia Model"] = 138,
    ["Chromia Seeder Module Config"] = 140,
    ["Chromia Seeder Root Config"] = 139,
    ["Cinnamon Spice info.json"] = 70,
    ["CircleCI config.yml"] = 189,
    ["Citation File Format"] = 234,
    CityJSON = 142,
    ["Claude Code Settings"] = 154,
    ["Clawject config"] = 153,
    ["Cloud Foundry Application Manifest"] = 1033,
    ["Cloud Run Spec v1"] = 1056,
    ["CloudCannon Configuration"] = 74,
    ["CloudEvents specification"] = 143,
    ["Code Climate"] = 190,
    CodeCV = 72,
    CodeRabbit = 71,
    ["CodeShip Pro services configuration files"] = 202,
    ["CodeShip Pro steps configuration files"] = 203,
    ["Codecov configuration files"] = 201,
    CodifyCLI = 73,
    Codux = 199,
    ["Cog config file"] = 148,
    ["Commandbox Box.json"] = 149,
    ["Commandbox Server.json"] = 150,
    ["Common Catalog Data"] = 211,
    ["Common Package Specification"] = 151,
    Concord = 1050,
    ["Configu .cfgu files"] = 1038,
    ["Configu .configu file"] = 1039,
    Conjure = 146,
    ["Container Structure Test"] = 879,
    Containerlab = 906,
    ["Contextive Glossary"] = 1103,
    Convex = 145,
    ["Crowdsec collection config"] = 242,
    ["Crowdsec parser config"] = 243,
    ["Crowdsec scenario config"] = 244,
    ["CumulusCI Config"] = 152,
    ["Custom Machinery Machine"] = 1023,
    ["Custom Machinery Recipe"] = 1024,
    ["Cycle Stack File"] = 156,
    CycloneDX = 157,
    ["DWP Exchange - catalogue entry"] = 291,
    ["DWP Exchange - gateway"] = 289,
    ["DWP Exchange - meta"] = 290,
    ["Dart Build Config (dart-build.json)"] = 250,
    ["Dart Test Config (dart-test.json)"] = 251,
    ["DashLord Configuration"] = 252,
    ["Data Contract Specification"] = 253,
    ["Data Product Specification"] = 254,
    ["DataYoga Connections"] = 158,
    ["DataYoga Job"] = 159,
    ["Databricks Asset Bundles"] = 1001,
    ["Datadog Continuous Testing"] = 446,
    ["Datadog Service Definition"] = 447,
    ["Datadog Software Catalog"] = 448,
    ["Datahub Ingestion Recipe"] = 956,
    ["Deck config"] = 165,
    ["Dein Config"] = 166,
    ["Deno Config (deno.json)"] = 260,
    ["Dependency cruiser"] = 167,
    ["DeployStack Configuration"] = 168,
    ["Deployer Recipe"] = 263,
    ["Deta Spacefile"] = 169,
    ["Detekt Config (detekt.yml)"] = 264,
    ["Devbox Config"] = 170,
    ["Devbox Plugin"] = 171,
    Devfile = 288,
    DipDup = 1053,
    ["Discord Webhook"] = 265,
    ["DocFx Config (docfx.json)"] = 269,
    Dofigen = 270,
    ["Dolittle Artifacts"] = 271,
    ["Dolittle Bounded Context Configuration"] = 272,
    ["Dolittle Event Horizons Configuration"] = 273,
    ["Dolittle Resources Configuration"] = 274,
    ["Dolittle Server Configuration"] = 275,
    ["Dolittle Tenant Map Configuration"] = 277,
    ["Dolittle Tenants Configuration"] = 276,
    ["Dolittle Topology"] = 278,
    ["DonateCaseBetterCasino menu"] = 1080,
    ["Drupal Breakpoints"] = 172,
    ["Drupal Config"] = 184,
    ["Drupal Info"] = 173,
    ["Drupal Layouts"] = 174,
    ["Drupal Libraries"] = 175,
    ["Drupal Links Action"] = 176,
    ["Drupal Links Contextual"] = 177,
    ["Drupal Links Menu"] = 178,
    ["Drupal Links Task"] = 179,
    ["Drupal Migration"] = 180,
    ["Drupal Permissions"] = 181,
    ["Drupal Recipe"] = 182,
    ["Drupal Routing"] = 183,
    ["Drupal Services"] = 185,
    ["Drush site aliases"] = 284,
    ["Dynamic Bash Aliases (.aliases)"] = 992,
    ["EAS config"] = 308,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 981,
    ["EasyVCR .NET"] = 309,
    ["Eidolon Resource"] = 1067,
    ["Elgato Stream Deck"] = 294,
    Elm = 1055,
    ["Embrace Config"] = 967,
    Endurica = 1005,
    ["Enterprise Contract Policy Spec"] = 295,
    ["Erda Pipeline"] = 1030,
    ["Erda Runtime"] = 1031,
    Esquio = 297,
    ["Estuary Flow Catalog"] = 946,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 301,
    ["EveryVoice TTS Toolkit Data Configuration"] = 302,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 306,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 305,
    ["EveryVoice TTS Toolkit Text Configuration"] = 303,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 304,
    ["Expo SDK"] = 307,
    ["F-Droid Data metadata"] = 313,
    ["FasterCI Configuration"] = 80,
    FiQuS = 317,
    Firebase = 315,
    ["FlexGet Config"] = 318,
    ["Flow.json Configurations"] = 1027,
    ["Fossa configuration file"] = 325,
    ["Fossa's fossa-deps file"] = 326,
    ["Foundry VTT - Base package Manifest"] = 320,
    ["Foundry VTT - Module Manifest"] = 321,
    ["Foundry VTT - System Data Template"] = 324,
    ["Foundry VTT - System Manifest"] = 322,
    ["Foundry VTT - World Manifest"] = 323,
    ["Foxx Manifest"] = 81,
    ["Freifunk.de Community API"] = 84,
    ["Frogbot Config"] = 85,
    ["G2P Mapping Configuration"] = 331,
    ["GCP Blueprint Metadata"] = 334,
    Gaspar = 332,
    ["GatewayCore API Gateway"] = 333,
    ["GeoJSON.json latest"] = 944,
    GherKing = 948,
    ["GitHub Action"] = 339,
    ["GitHub Actions typing"] = 1063,
    ["GitHub Discussion"] = 340,
    ["GitHub Funding"] = 341,
    ["GitHub Issue Template configuration"] = 342,
    ["GitHub Issue Template forms"] = 343,
    ["GitHub Workflow"] = 344,
    ["GitHub Workflow Template Properties"] = 345,
    ["GitHub automatically generated release notes configuration"] = 346,
    ["GitLab Agent for Kubernetes configuration"] = 1019,
    GitVersion = 336,
    ["Gitea Issue Template configuration"] = 337,
    ["Gitea Issue Template forms"] = 338,
    ["Gitpod Automations"] = 348,
    ["Gitpod Configuration"] = 349,
    ["GlazeWM settings"] = 1021,
    ["Global Privacy Control"] = 335,
    Goblet = 1000,
    ["Golangci-lint Configuration"] = 364,
    ["Golangci-lint Custom Plugins Configuration"] = 365,
    ["Google Chrome Related Website Sets"] = 316,
    ["Google Cloud Workflows"] = 219,
    ["Google Digital Assetlinks"] = 1104,
    Goreleaser = 367,
    ["Goreleaser Pro"] = 368,
    Goss = 369,
    ["Gradle Build Cache Node"] = 895,
    ["Gradle Enterprise"] = 894,
    ["Grafana 5.x Dashboard"] = 370,
    ["GraphQL Code Generator"] = 374,
    ["GraphQL Config"] = 373,
    ["GraphQL Mesh"] = 372,
    ["Grunt JSHint task"] = 378,
    ["Grunt Watch task"] = 379,
    ["Grunt base task"] = 380,
    ["Grunt clean task"] = 376,
    ["Grunt copy task"] = 375,
    ["Grunt cssmin task"] = 377,
    HEMTT = 861,
    Hadolint = 875,
    Hammerkit = 905,
    ["Hardware Sentry Configuration"] = 960,
    ["HashiCorp Vault"] = 381,
    Hatch = 876,
    Hayagriva = 383,
    Hayson = 384,
    ["Haystack Pipeline"] = 385,
    ["Hazelcast 5 Configuration"] = 386,
    ["Hecate Input Schema"] = 1115,
    ["Helm Chart.lock"] = 187,
    ["Helm Chart.yaml"] = 186,
    ["Helm Unittest Test Suite"] = 188,
    ["Home Assistant Integration Manifest"] = 387,
    ["Homer dashboard configuration"] = 388,
    Hugo = 936,
    ["Hugo Theme"] = 935,
    ["Hyperfoil benchmark configuration"] = 394,
    ["IBM Zapp document"] = 395,
    ["IBM zCodeFormatSettings"] = 396,
    ["IMG Catapult PSP"] = 401,
    ["IVMS101 by CODE Protocol"] = 1020,
    Infrahub = 403,
    Istanbul = 963,
    ["JDownloader2 crawler multi-rules"] = 413,
    ["JDownloader2 crawler single-rules"] = 412,
    ["JFrog Applications Config"] = 414,
    ["JFrog File Spec"] = 415,
    ["JFrog Pipelines YML DSL"] = 969,
    ["JMeter DSL cli config"] = 416,
    JReleaser = 419,
    ["JSON Document Transform"] = 427,
    ["JSON Feed"] = 428,
    ["JSON Resume"] = 652,
    ["JSON Schema Draft 2020-12"] = 843,
    ["JSON Schema Draft 4"] = 840,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1002,
    ["JSON Schema Draft 7"] = 841,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1003,
    ["JSON Schema Draft 8 (2019-09)"] = 842,
    ["JSON-API"] = 426,
    ["JSON-e templates"] = 902,
    ["JSON-stat 2.0"] = 836,
    JSONPatch = 430,
    ["JSR Package Config (jsr.json)"] = 420,
    Jasmine = 407,
    Jekyll = 408,
    ["Jenkins X Pipelines"] = 409,
    ["Jenkins X Requirements"] = 410,
    Jest = 411,
    Jocker = 417,
    ["Jovo Language Models"] = 418,
    ["Jujutsu (jj) VCS config"] = 1116,
    ["KIMMDY config file"] = 441,
    ["KODE/CI build.yaml"] = 965,
    ["KSP-AVC"] = 837,
    ["KSP-CKAN"] = 838,
    ["KSP-NetKAN"] = 839,
    KSY = 1032,
    KSail = 329,
    ["Karakum configuration file"] = 327,
    Kas = 433,
    ["Kestra flow file"] = 442,
    ["Keycloak REST API"] = 972,
    ["Knative Functions - func.yaml"] = 328,
    ["Kometa (nightly) config file"] = 444,
    ["Kometa config file"] = 443,
    ["Kong DBLess config"] = 966,
    KrakenD = 445,
    ["Kubri Configuration"] = 452,
    LOOBin = 467,
    ["Lake configuration file"] = 1119,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 224,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 225,
    ["Landing Zone Accelerator on AWS - Global Config"] = 226,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 227,
    ["Landing Zone Accelerator on AWS - Network Config"] = 228,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 229,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 230,
    ["Landing Zone Accelerator on AWS - Security Config"] = 231,
    ["Lando (landofile)"] = 75,
    ["LangGraph Platform configuration"] = 1043,
    ["Language configuration"] = 1042,
    Lefthook = 456,
    ["Liferay client-extension.yaml"] = 463,
    ["LinkML Metamodel"] = 465,
    Liquibase = 911,
    ["Liquibase Flow File"] = 912,
    ["Lively Properties"] = 466,
    ["Lobe AI Agent"] = 77,
    Loki = 78,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 506,
    ["MS2Rescore Configuration"] = 509,
    ["Madness (madness.yml)"] = 983,
    ["MapEHR Mapping"] = 473,
    Markdownlint = 915,
    ["Mason Registry"] = 918,
    ["MegaLinter Custom Flavor"] = 476,
    ["MegaLinter configuration"] = 475,
    ["MegaLinter descriptor"] = 477,
    Melange = 1010,
    ["Meltano project definition"] = 478,
    ["Mergify Configuration"] = 510,
    ["Metadata for a Bazel module"] = 479,
    ["Metadata for a Cinnamon spice"] = 1059,
    ["Metatype Configuration"] = 480,
    ["MetricsHub Configuration"] = 481,
    ["MetricsHub Connector Configuration"] = 482,
    ["Micro Editor Syntax"] = 993,
    ["Microsoft Band Web Tile"] = 483,
    ["Microsoft RulesEngine workflow rules"] = 1047,
    ["Microsoft RulesEngine workflow rules list"] = 1048,
    ["Minecraft Custom Main Menu Mod"] = 1011,
    ["Minecraft Data Pack Advancement"] = 485,
    ["Minecraft Data Pack Biome"] = 486,
    ["Minecraft Data Pack Configured Carver"] = 487,
    ["Minecraft Data Pack Damage Type"] = 488,
    ["Minecraft Data Pack Dimension"] = 490,
    ["Minecraft Data Pack Dimension Type"] = 489,
    ["Minecraft Data Pack Item Modifier"] = 491,
    ["Minecraft Data Pack Loot Table"] = 492,
    ["Minecraft Data Pack Metadata"] = 493,
    ["Minecraft Data Pack Predicate"] = 494,
    ["Minecraft Data Pack Recipe"] = 495,
    ["Minecraft Data Pack Tag"] = 496,
    ["Minecraft Data Pack Template Pool"] = 497,
    ["Minecraft Data Pack Trim Material"] = 502,
    ["Minecraft Data Pack Trim Pattern"] = 503,
    ["Minecraft Resource Pack Lang"] = 498,
    ["Minecraft Resource Pack Particle"] = 499,
    ["Minecraft Resource Pack Texture Mcmeta"] = 501,
    ["Minecraft Resourcepack Sounds"] = 500,
    ["Monade CLI Stack Configuration"] = 513,
    ["MongoDB Atlas Search Index Definition"] = 964,
    ["Monika Configuration"] = 962,
    ["Monoweave Configuration"] = 508,
    ["Motif config"] = 857,
    MultiQC = 1097,
    ["NOX Framework (Service)"] = 526,
    ["Netin Diagnostic System Template"] = 922,
    ["Netlify config"] = 516,
    ["Network-as-Code Data Model"] = 517,
    ["Nightwatch.js"] = 519,
    ["Node.js configuration"] = 862,
    ["NueJS configuration file"] = 531,
    ["Nuitka.yaml"] = 1025,
    ["Nullstone config"] = 533,
    ["ONe's changelog entry"] = 547,
    ["ONe's service descriptor"] = 546,
    ["ORT Server repository environment configuration"] = 555,
    ["OSCAL Assessment Plan (AP)"] = 557,
    ["OSCAL Assessment Results (AR)"] = 558,
    ["OSCAL Catalog"] = 559,
    ["OSCAL Component Definition (CDef)"] = 560,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 561,
    ["OSCAL Profile"] = 562,
    ["OSCAL System Security Plan (SSP)"] = 563,
    ["OSS Review Toolkit configuration"] = 564,
    ["OSS Review Toolkit curation"] = 565,
    ["OSS Review Toolkit package configuration"] = 566,
    ["OSS Review Toolkit repository configuration"] = 567,
    ["OSS Review Toolkit resolutions"] = 568,
    ["October CMS columns"] = 537,
    ["October CMS fields"] = 538,
    Okteto = 539,
    Opctl = 860,
    ["Open Data Contract Standard (ODCS)"] = 550,
    ["Open Data Product Standard (ODPS)"] = 551,
    ["Open Know-How"] = 1102,
    ["OpenRewrite Resource"] = 549,
    OpenStatus = 1113,
    ["OpenUtau character yaml"] = 543,
    ["OpenUtau ustx"] = 544,
    ["OpenWeather Current Weather API"] = 901,
    ["OpenWeather Road Risk API"] = 900,
    ["Ory Hydra configuration"] = 393,
    ["Ory Keto configuration"] = 449,
    ["Ory Kratos configuration"] = 556,
    ["Ory Oathkeeper configuration"] = 535,
    ["Outblocks App configuration"] = 553,
    ["Outblocks database table"] = 554,
    ["Outblocks project configuration"] = 552,
    PDM = 574,
    Packer = 571,
    Pantsbuild = 979,
    ["Paper paper-plugin.yml"] = 572,
    ["Pipeline component"] = 913,
    ["Platform.sh application"] = 2,
    ["Platform.sh routes"] = 3,
    ["Platform.sh services"] = 4,
    ["Plex Prerolls"] = 582,
    ["PocketMine plugin.yml"] = 579,
    ["Postman collection"] = 586,
    ["Power Pages Configuration"] = 1114,
    ["Preset list for a WinUtil"] = 1062,
    ["ProActions AI-Kit Configuration"] = 595,
    ["ProActions AI-Kit Configuration for Menus"] = 597,
    ["ProActions AI-Kit Configuration for Sections"] = 599,
    ["ProActions AI-Kit Configuration for Services"] = 596,
    ["ProActions AI-Kit Configuration for Steps"] = 600,
    ["ProActions AI-Kit Configuration for Templates"] = 598,
    ["Problem object RFC9457"] = 1008,
    ["Problem package generators"] = 601,
    Pterodactyl = 959,
    ["Pull Request Labeler"] = 617,
    Pulumi = 625,
    ["PyGTA Config"] = 621,
    PyProject = 626,
    Pylock = 1105,
    Pyright = 627,
    ["Python script metadata"] = 1099,
    ["QType AI DSL"] = 630,
    Qgoda = 629,
    Qodana = 932,
    ["Qt Creator workspace file"] = 1040,
    ["Quali Torque Blueprint Spec 2"] = 957,
    ["QueryFirst config file"] = 975,
    ["RKE Cluster Configuration JSON"] = 910,
    ["RKE Cluster Configuration YAML"] = 909,
    RadioHound = 620,
    Railway = 631,
    ["Rancher Fleet"] = 622,
    ["Rattler-build"] = 632,
    Ray = 874,
    ["Read the Docs"] = 624,
    ["Red-DiscordBot Cog"] = 639,
    ["Red-DiscordBot Cog Repo"] = 640,
    ["Red-DiscordBot Trivia"] = 641,
    ["Render Blueprints"] = 908,
    RenderCV = 654,
    Renovate = 653,
    ["Replit config"] = 647,
    Restate = 1092,
    RoadRunner = 656,
    ["Roo Coder Custom Modes"] = 658,
    Rubocop = 649,
    ["Rudder techniques"] = 1015,
    Ruff = 650,
    ["Rust Project"] = 651,
    ["Rust toolchain"] = 661,
    ["SDMX data message"] = 687,
    ["SDMX metadata message"] = 686,
    ["SDMX structure message"] = 685,
    ["SIL Kit Participant Configuration"] = 697,
    ["SIL Kit Registry Configuration"] = 698,
    ["SPDX 2.3"] = 734,
    SWADL = 749,
    ["Safebox Config"] = 970,
    ["Sapphire CLI Config"] = 664,
    ["SauceCTL Configuration"] = 919,
    ["Schema Catalog"] = 679,
    ["Scoop manifest"] = 684,
    ["Semantic Data Fabric (SDF) file"] = 688,
    ["Semgrep Rule"] = 690,
    ["Serenity Code Generator (Sergen)"] = 691,
    ["Serverless Framework Configuration"] = 926,
    ["Serverless Workflow"] = 928,
    ["Settings for a Cinnamon spice"] = 1058,
    ["Settings.paf"] = 693,
    ["Shopware 6 Configuration"] = 929,
    ["Shopware CLI Extension Store Configuration"] = 930,
    ["Shopware CLI Project Store Configuration"] = 931,
    ["Sigma Detection Rule"] = 695,
    ["Sigrid scope configuration file"] = 696,
    ["SkyPilot Task JSON"] = 1016,
    ["Slack app manifest"] = 700,
    Solidarity = 705,
    ["Solution filters"] = 706,
    ["Source Maps v3"] = 707,
    Sourcery = 708,
    ["Spack bootstrap.yaml"] = 709,
    ["Spack cdash.yaml"] = 710,
    ["Spack ci.yaml"] = 711,
    ["Spack compilers.yaml"] = 712,
    ["Spack concretizer.yaml"] = 713,
    ["Spack config.yaml"] = 714,
    ["Spack definitions.yaml"] = 715,
    ["Spack develop.yaml"] = 716,
    ["Spack env_vars.yaml"] = 717,
    ["Spack environment"] = 723,
    ["Spack include.yaml"] = 718,
    ["Spack mirrors.yaml"] = 719,
    ["Spack modules.yaml"] = 720,
    ["Spack packages.yaml"] = 721,
    ["Spack repos.yaml"] = 722,
    ["Spack toolchains.yaml"] = 724,
    ["Spack upstreams.yaml"] = 725,
    ["Spack view.yaml"] = 726,
    ["Speakeasy Generation Config File"] = 730,
    ["Speakeasy Lint Configuration File"] = 727,
    ["Speakeasy Test Generation Configuration File"] = 728,
    ["Speakeasy Workflow File"] = 729,
    SpecIF = 731,
    ["Sponge Mixin configuration"] = 732,
    StackBlitz = 738,
    ["StackHawk Scanner Configuration"] = 925,
    Stale = 739,
    ["Starlake Data Pipeline"] = 898,
    Starship = 740,
    ["Statamic Blueprint"] = 741,
    ["Stella configuration file"] = 742,
    ["Streamlit configuration file"] = 743,
    ["Stryker Mutator"] = 746,
    ["StyleCop Analyzers Configuration"] = 747,
    ["Stylelint (.stylelintrc)"] = 748,
    ["Stylua Config"] = 1106,
    ["Sublime Syntax"] = 971,
    ["Subsquid squid manifest"] = 1018,
    ["Swagger API 2.0"] = 750,
    ["Synadia Connect Component"] = 751,
    TSON = 786,
    TSTyche = 787,
    ["TYPO3 Vendor Bundler config"] = 792,
    ["Tab data for a LinUtil"] = 1065,
    ["Tab list for a LinUtil"] = 1064,
    Tach = 752,
    ["Tach Domain"] = 753,
    Talhelper = 755,
    ["Talisman configuration"] = 756,
    Taplo = 1107,
    ["Taskfile config"] = 903,
    Taurus = 757,
    Tauticord = 758,
    Telefonistka = 1093,
    ["Terrateam config"] = 1118,
    ["TestEnvironment.json"] = 769,
    ["TextMate Grammar"] = 768,
    Threagile = 764,
    ["Tier.run pricing.json"] = 761,
    Tikibase = 762,
    Tombi = 767,
    ["Traefik v2"] = 772,
    ["Traefik v2 File Provider"] = 773,
    ["Traefik v3"] = 774,
    ["Traefik v3 File Provider"] = 775,
    ["Travis CI (.travis.yml)"] = 771,
    Trident = 1089,
    ["TrueScript for *.tscript files"] = 778,
    ["Tugboat QA config.yml"] = 1086,
    TunnelHub = 1006,
    Turborepo = 770,
    Tycho = 1054,
    Tye = 933,
    ["Tyk Gateway - Open Source v5.7+"] = 1098,
    ["Typst Manifest"] = 793,
    ["UET BuildConfig.json"] = 976,
    ["UI5 Manifest"] = 799,
    ["UNCORS configuration"] = 803,
    ["UTAM Page Object"] = 802,
    ["Ubuntu Server Autoinstall"] = 797,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1090,
    ["Uniswap Token List"] = 886,
    ["Universal Schedule Format"] = 804,
    ["Unreal Engine Uplugin"] = 977,
    ["Unreal Engine Uproject"] = 978,
    ["UpCloud CLI (upctl) configuration"] = 1091,
    ["Updatecli Compose"] = 941,
    ["Updatecli Policy Manifest"] = 942,
    ["Updatecli Policy Metadata"] = 943,
    Uplift = 974,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 907,
    V2Ray = 947,
    ["VSCode Code Snippets"] = 207,
    ["VSIX CLI publishing"] = 824,
    Vector = 806,
    ["Vela Pipeline Configuration"] = 809,
    Vercel = 206,
    ["Version Bumper config"] = 814,
    ["Viash Component Config"] = 1095,
    ["Viash Package Config"] = 1096,
    Visivo = 1004,
    ["WP-CLI"] = 834,
    Wake = 1088,
    ["Waku Config"] = 1068,
    ["Web App Manifest"] = 830,
    ["Web types"] = 833,
    WebExtensions = 829,
    ["Webman package recipe"] = 953,
    ["Windows Package Manager Installer Manifest"] = 882,
    ["Windows Package Manager Locale Manifest"] = 883,
    ["Windows Package Manager Singleton Manifest"] = 881,
    Winutil = 884,
    ["WireMock stub mapping"] = 1071,
    ["Woodpecker pipeline config"] = 921,
    ["Wrangler CLI"] = 835,
    ["Xstate Machine"] = 939,
    ["Yandex Workflow Language"] = 1060,
    ["Yarn Config (.yarnrc.yml)"] = 896,
    ["Yippee-Ki-JSON configuration YML"] = 888,
    ["YouTrack App"] = 1057,
    ["Zarf Package Configuration"] = 1120,
    ["Zerops.io config"] = 1045,
    ["Zerops.io import"] = 1046,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 1009,
    ...
    ["babelrc.json"] = 87,
    ["bamboo-spec"] = 90,
    ["bashly-strings.yml"] = 986,
    ["batect.yml"] = 89,
    ["beef-database-codegen"] = 91,
    ["beef-database-v5-codegen"] = 93,
    ["beef-entity-codegen"] = 92,
    ["beef-entity-v5-codegen"] = 94,
    ["behat.yml"] = 106,
    ["bigquery-table"] = 95,
    ["bioimageio resource description"] = 1026,
    ["bitbucket-pipelines"] = 97,
    bitrise = 98,
    ["bitrise-step"] = 99,
    ["block.json"] = 121,
    ["bottom configuration"] = 64,
    ["bower.json"] = 101,
    ["bozr.suite.json"] = 108,
    bpkg = 987,
    ["browser.i18n.json"] = 109,
    ["browsh configuration"] = 110,
    bucklescript = 111,
    ["buf.gen.yaml"] = 66,
    ["buf.plugin.yaml"] = 67,
    ["buf.work.yaml"] = 68,
    ...
    ["build-changelog"] = 112,
    ["bun.lock"] = 117,
    ["bundleconfig.json"] = 118,
    ["bunfig.toml"] = 119,
    ["cargo-mutants-config.yaml"] = 69,
    ["ccmod.json"] = 1069,
    changelogging = 1037,
    ["chisel-slices.json"] = 233,
    ["chrome-extension-locales-messages.json"] = 214,
    ["chutzpah.json"] = 215,
    cibuildwheel = 141,
    ["clang-format (.clang-format)"] = 945,
    ["clang-tidy"] = 194,
    clangd = 193,
    clib = 195,
    ["cloud-init: cloud-config userdata"] = 197,
    ["cloud-sdk-pipeline-configuration"] = 217,
    ["cloudbuild.json"] = 218,
    cloudify = 196,
    codemagic = 198,
    ["coffeelint.json"] = 235,
    ["commands.json"] = 210,
    ["commitlint (.commitlintrc)"] = 885,
    ["committed.toml"] = 236,
    ["compile_commands.json"] = 209,
    ["compilerconfig.json"] = 208,
    ["completely.yml"] = 982,
    ["component-detection-manifest.json"] = 239,
    ["component.json"] = 238,
    ["composer.json"] = 237,
    ["conda-forge"] = 144,
    ["config.yaml"] = 623,
    ["contentmanifest.json"] = 216,
    ["contribute.json"] = 240,
    ["cosmos.config.json"] = 212,
    ["crowdin.yml"] = 241,
    ["ctfd-setup configuration file"] = 1078,
    ["custom-elements.json"] = 996,
    ["cypress.json"] = 245,
    ["datalogic-scan2deploy-android"] = 255,
    ["datalogic-scan2deploy-ce"] = 256,
    ["dbt Dependencies"] = 160,
    ["dbt Packages"] = 162,
    ["dbt Project"] = 161,
    ["dbt Selectors"] = 163,
    ["dbt YAML files"] = 164,
    ["ddev-global"] = 257,
    ["ddev-project"] = 258,
    ["debugsettings.json"] = 259,
    ["dependabot-v2.json"] = 262,
    ["dependabot.json"] = 261,
    ["deployed-cli"] = 938,
    ["devcontainer.json"] = 200,
    devinit = 890,
    ["devspace.yaml"] = 961,
    djlint = 891,
    ["docker bake"] = 267,
    ["docker sequencer"] = 268,
    ["docker-compose.yml"] = 889,
    ["dockerd.json"] = 266,
    ["dotnet Release Index manifest"] = 279,
    ["dotnet-tools.json"] = 280,
    ["dotnetcli.host.json"] = 281,
    ["dprint.json"] = 282,
    ["drone.json"] = 283,
    ["dss-2.0.0.json"] = 285,
    ["dstack configuration"] = 286,
    ["dtool dataset metadata"] = 1073,
    ["dvc.yaml"] = 287,
    ["ecosystem.json"] = 292,
    eksctl = 293,
    ["electron-builder configuration file"] = 299,
    ["epr-manifest.json"] = 298,
    ["evcc.yaml"] = 300,
    ["ezd task runner"] = 310,
    ["fabric.mod.json"] = 312,
    ["first-timers-bot"] = 319,
    ["flagd flag configuration"] = 82,
    ["fly.io Configuration"] = 83,
    fulibWorkflows = 920,
    ["function.json"] = 330,
    ["gRPC API Gateway & OpenAPI Config"] = 7,
    ["gematik health care insurance list"] = 1084,
    ["gematik health care patient list"] = 1081,
    ["gematik health care provider institution list"] = 1083,
    ["gematik health care provider list"] = 1082,
    ["gematik tiger test environment configuration"] = 1085,
    ["gitlab-ci"] = 347,
    ["global.json"] = 363,
    ["go-feature-flag Flag Configuration"] = 366,
    ["haxelib.json"] = 382,
    helmfile = 877,
    helmwave = 878,
    ["host-meta.json"] = 390,
    ...
    ["ide.host.json"] = 397,
    ["ifstate.conf"] = 398,
    ["imageoptimizer.json"] = 399,
    ["importmap.json"] = 402,
    ["ioBroker Configuration"] = 404,
    ["ioBroker JSON UI"] = 405,
    ["ioBroker Package manifest"] = 406,
    ["ize.toml"] = 973,
    ["jsconfig.json"] = 431,
    ["jscpd Configuration"] = 958,
    jsdoc = 873,
    ["k3d.yaml"] = 432,
    ["k9s aliases.yaml"] = 434,
    ["k9s cluster-config.yaml"] = 436,
    ["k9s config.yaml"] = 435,
    ["k9s hotkeys.yaml"] = 437,
    ["k9s plugins.yaml"] = 438,
    ["k9s skin.yaml"] = 439,
    ["k9s views.yaml"] = 440,
    ["kontinuous-config.yaml"] = 451,
    ["kontinuous-values.yaml"] = 450,
    ["kustomization.yaml"] = 453,
    ["label-commenter-config.yml"] = 454,
    ["latexindent configuration"] = 76,
    ["launchsettings.json"] = 455,
    lazydocker = 995,
    lazygit = 994,
    ["lego.json"] = 457,
    ["lerna.json"] = 458,
    ["lgtm.yml"] = 459,
    ["liblab.config.json"] = 460,
    ["libman.json"] = 461,
    ["license-report-config.json"] = 462,
    ["linkinator.config.json"] = 464,
    ["lint-staged (.lintstagedrc)"] = 851,
    ["local.settings.json"] = 469,
    ["localazy.json"] = 470,
    ["lotus.yaml"] = 468,
    ["lsdlschema.json"] = 471,
    ["markdown-link-check"] = 916,
    maturin = 917,
    mboats = 924,
    ["micro-settings.json"] = 988,
    ["mimetypes.json"] = 484,
    ["mirrord config"] = 853,
    mise = 854,
    ["mkdocs.yml"] = 504,
    ["monospace.yml"] = 507,
    ["moon.yml"] = 1070,
    ["mprocs Configuration file"] = 1041,
    ["mrdocs.yml"] = 505,
    ["mta.yaml"] = 855,
    ["mtad.yaml"] = 856,
    ["mycode.json"] = 514,
    nFPM = 518,
    ["napari plugin manifest"] = 515,
    neoload = 868,
    ["nest-cli"] = 521,
    ["ninjs (News in JSON)"] = 520,
    ["nitro.json"] = 867,
    ["nixd configuration"] = 1014,
    ["nlu.json"] = 522,
    ["nodemon.json"] = 524,
    ["noodl config"] = 923,
    ["notebook.mod.json"] = 525,
    now = 863,
    ["npm-badges"] = 528,
    ["nswag.json"] = 532,
    ntangle = 534,
    ["nuclei-template.yaml"] = 529,
    ["nuget-project.json"] = 530,
    ["ocelot.json"] = 536,
    ["omnisharp.json"] = 540,
    ["openapi.json"] = 541,
    ["openfin.json"] = 548,
    ...
    ["ops.yaml"] = 545,
    ["package.json"] = 569,
    ["package.manifest"] = 570,
    ["partial-black.json"] = 107,
    ["pathfinder.yml"] = 573,
    ["pattern.json"] = 576,
    ["petstore-v1.0"] = 968,
    pgap_yaml_input_reader = 575,
    ["pixi.toml"] = 577,
    ["plagiarize-me.yaml"] = 581,
    ["plagiarize.yaml"] = 580,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1074,
    ["podbard.yaml"] = 583,
    ["portman.json"] = 584,
    ["prefect.toml"] = 592,
    ["prettierrc.json"] = 593,
    ["prisma.yml"] = 594,
    ["project-1.0.0-beta3.json"] = 603,
    ["project-1.0.0-beta4.json"] = 604,
    ["project-1.0.0-beta5.json"] = 605,
    ["project-1.0.0-beta6.json"] = 606,
    ["project-1.0.0-beta8.json"] = 607,
    ["project-1.0.0-rc1.json"] = 608,
    ["project-1.0.0-rc2.json"] = 609,
    ["project.json"] = 602,
    ["project.owasp.yaml"] = 610,
    ["prometheus.json"] = 611,
    ["prometheus.rules.json"] = 612,
    ["prometheus.rules.test.json"] = 613,
    ["proxies.json"] = 614,
    ["publiccode.yml"] = 615,
    ["pubspec.yaml"] = 616,
    ["pyrseas-0.8.json"] = 619,
    pytest = 628,
    ["quilt.mod.json"] = 989,
    ["rc3 auth"] = 633,
    ["rc3 collection"] = 634,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 869,
    ["release-please-config.json"] = 643,
    ["release-please-manifest.json"] = 644,
    ["release-plz.toml"] = 645,
    ["renv.lock"] = 655,
    ["rivet.json"] = 1013,
    ["rivet.yaml (legacy)"] = 1012,
    rockcraft = 657,
    runny = 659,
    rustfmt = 660,
    sake = 1101,
    samt = 662,
    samtrc = 663,
    ["sarif-1.0.0.json"] = 665,
    ["sarif-2.0.0.json"] = 666,
    ["sarif-2.1.0"] = 676,
    ["sarif-2.1.0-rtm.2"] = 667,
    ["sarif-2.1.0-rtm.3"] = 669,
    ["sarif-2.1.0-rtm.4"] = 671,
    ["sarif-2.1.0-rtm.5"] = 673,
    ["sarif-2.1.0-rtm.6"] = 674,
    ["sarif-external-property-file-2.1.0"] = 677,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 668,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 670,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 672,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 675,
    ["scalingo.json configuration"] = 678,
    ["schema.org - Action"] = 680,
    ["schema.org - ContactPoint"] = 681,
    ["schema.org - Place"] = 682,
    ["schema.org - Thing"] = 683,
    ["secrethub.yml"] = 991,
    ["semantic-release"] = 689,
    ["servicehub.config.json"] = 846,
    ["servicehub.service.json"] = 845,
    ["settings.job"] = 692,
    ["sfdx-hardis configuration"] = 694,
    ["shard.yml"] = 1029,
    ["size-limit configuration"] = 699,
    ["skaffold.yaml"] = 914,
    ["skyuxconfig.json"] = 701,
    snapcraft = 702,
    ["snowflake-config"] = 703,
    ["snowflake-connections"] = 704,
    ["spicepod.yaml"] = 1049,
    ["sqlc configuration"] = 735,
    ["stripe-app-local.json"] = 745,
    ["stripe-app.json"] = 744,
    swcrc = 899,
    ["task.json"] = 754,
    taskcat = 864,
    ["template.json"] = 759,
    ["templatsources.json"] = 760,
    ["theme.json"] = 763,
    ["tizen_workspace.json"] = 765,
    tldr = 766,
    ["tm_devices configuration file"] = 1112,
    tmuxinator = 849,
    ["transcend.yml"] = 776,
    ["tree-sitter grammar.json"] = 371,
    ["trime.yaml"] = 777,
    ["trunk.yaml"] = 779,
    ["ts-force-config.json"] = 784,
    ["tsconfig.json"] = 780,
    ["tsd.json"] = 781,
    ["tsdoc.json"] = 782,
    ["tsdrc.json"] = 783,
    ...
    v8r = 828,
    vcluster = 1035,
    ["vcpkg configuration file"] = 205,
    ["vcpkg manifest file"] = 204,
    ["vega-lite.json"] = 808,
    ["vega.json"] = 807,
    ["venvironment-basic.yaml"] = 811,
    ["venvironment.yaml"] = 810,
    ["venvplus-basic.yaml"] = 813,
    ["venvplus.yaml"] = 812,
    version = 1094,
    ["version.json"] = 815,
    ["vhwdebugger-binding.yaml"] = 817,
    ["vim-addon-info"] = 818,
    ["vs-2017.3.host.json"] = 820,
    ["vs-nesting.json"] = 821,
    ["vsls.json"] = 819,
    ["vss-extension.json"] = 825,
    vtcfg = 1100,
    ["vtesttree.yaml"] = 826,
    ["vtestunit.yaml"] = 827,
    ["warp-keysets.json"] = 997,
    ["warp-themes.json"] = 998,
    ["warp-workflows.json"] = 999,
    ["webhint.io"] = 954,
    ["webjobpublishsettings.json"] = 832,
    ["webjobs-list.json"] = 831,
    ["well-known-fursona"] = 1036,
    ["xs-app.json"] = 859,
    ["xunit.runner.json"] = 844,
    yamllint = 887,
    zuul = 870,
    ["Žinoma"] = 880
  },
