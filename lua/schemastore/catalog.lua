...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 154,
    [".cryproj (generic)"] = 519,
    [".cryproj engine-5.2"] = 514,
    [".cryproj engine-5.3"] = 515,
    [".cryproj engine-5.4"] = 516,
    [".cryproj engine-5.5"] = 517,
    [".cryproj engine-dev"] = 518,
    [".csscomb.json"] = 156,
    [".csslintrc"] = 157,
    [".eslintrc"] = 202,
    [".esmrc.json"] = 194,
    ...
    [".mtaext"] = 528,
    [".nodehawkrc"] = 328,
    [".npmpackagejsonlintrc"] = 331,
    [".phraseapp.yml"] = 366,
    [".pmbot.yml"] = 358,
    [".postcssrc"] = 363,
    [".pre-commit-config.yml"] = 364,
    [".pre-commit-hooks.yml"] = 365,
    [".putout.json"] = 383,
    [".rehyperc"] = 391,
    [".remarkrc"] = 392,
    [".sprite files"] = 438,
    ...
    ["Azure Pipelines"] = 48,
    ["Azure Static Web Apps CLI configuration file"] = 440,
    ["Azure Static Web Apps configuration file"] = 439,
    ["BX CI"] = 83,
    ["Better Code Hub"] = 562,
    ["Better Scripts"] = 84,
    BizTalkServerApplicationSchema = 534,
    ...
    ["Butane Config"] = 600,
    ["CICS TS region tagging"] = 607,
    ["CICS TS resource import"] = 608,
    ["CICS TS resource model"] = 609,
    ["CICS TS resource overrides"] = 610,
    ["CMake Presets"] = 85,
    ...
    ["Datahub Ingestion Recipe Schema"] = 614,
    ...
    ["Embrace Config Schema"] = 625,
    ["Error pages"] = 197,
    Esquio = 195,
    ["Estuary Flow Catalog Schema"] = 604,
    ["Expo SDK"] = 200,
    ...
    Goreleaser = 228,
    ["Goreleaser Pro"] = 229,
    ["Gradle Build Cache Node"] = 559,
    ["Gradle Enterprise"] = 558,
    ...
    Hadolint = 543,
    Hammerkit = 569,
    ["Hardware Sentry Configuration"] = 618,
    Hayson = 241,
    ...
    ["JFrog File Spec"] = 261,
    ["JFrog Pipelines YML DSL"] = 627,
    ["JMeter DSL cli config schema"] = 262,
    ["JSON Document Transform"] = 270,
    ["JSON Feed"] = 271,
    ["JSON Resume"] = 397,
    ["JSON Schema Draft 2020-12"] = 510,
    ["JSON Schema Draft 4"] = 507,
    ["JSON Schema Draft 7"] = 508,
    ["JSON Schema Draft 8"] = 509,
    ...
    ["KSP-AVC"] = 505,
    ["KSP-CKAN"] = 506,
    ["Keycloak REST API"] = 633,
    ["Knative Functions - func.yaml"] = 212,
    ["KoDE/CI build.yaml"] = 623,
    ["Kong DBLess Schema"] = 624,
    KrakenD = 276,
    ["LinkML Metamodel"] = 289,
    Liquibase = 574,
    ["Liquibase Flow File"] = 575,
    ...
    ["MkDocs Configuration 1.0"] = 317,
    ["MongoDB Atlas Search Index Definition Schema"] = 622,
    ["Monika Configuration Schema"] = 620,
    ["Motif config"] = 527,
    ["NOX Framework (Service)"] = 330,
    ["Netin Diagnostic System Template"] = 583,
    ["Netlify config schema"] = 322,
    ["Nightwatch.js"] = 323,
    ["OSS Review Toolkit configuration"] = 348,
    ["OSS Review Toolkit curation"] = 349,
    ["OSS Review Toolkit package configuration"] = 350,
    ["OSS Review Toolkit repository configuration"] = 351,
    ["OSS Review Toolkit resolutions"] = 352,
    Opctl = 530,
    ["OpenRewrite Resource"] = 343,
    ["OpenWeather Current Weather API"] = 566,
    ["OpenWeather Road Risk API"] = 565,
    ["Ory Hydra configuration"] = 247,
    ["Ory Keto configuration"] = 278,
    ["Ory Kratos configuration"] = 347,
    ["Ory Oathkeeper configuration"] = 337,
    ["Outblocks App configuration"] = 345,
    ["Outblocks database table"] = 346,
    ["Outblocks project configuration"] = 344,
    Packer = 355,
    Pantsbuild = 639,
    ["Pipeline component"] = 576,
    ["PocketMine plugin.yml"] = 359,
    Pterodactyl = 617,
    ["Pull Request Labeler"] = 382,
    Pulumi = 387,
    PyProject = 388,
    Qodana = 593,
    ["Quali Torque Blueprint Spec 2"] = 615,
    ["QueryFirst config file"] = 636,
    ["RKE Cluster Configuration JSON Schema"] = 573,
    ["RKE Cluster Configuration YAML Schema"] = 572,
    ["Rancher Fleet"] = 385,
    Ray = 542,
    ["Read the Docs"] = 386,
    ["Red-DiscordBot Cog"] = 389,
    ["Red-DiscordBot Cog Repo"] = 390,
    Renovate = 398,
    ["Replit schema"] = 393,
    RoadRunner = 399,
    Ruff = 395,
    ["Rust Project"] = 396,
    ["Rust toolchain"] = 401,
    ["SIL Kit Participant Configuration"] = 427,
    SWADL = 449,
    ["Sapphire CLI Config"] = 402,
    ["SauceCTL Configuration"] = 580,
    ["Schema Catalog"] = 415,
    ["Scoop manifest"] = 420,
    ["Semgrep Rule"] = 422,
    ["Serenity Code Generator (Sergen)"] = 423,
    ["Serverless Framework Configuration"] = 587,
    ["Serverless Workflow Schema"] = 589,
    ["Settings.paf"] = 425,
    ["Shopware 6 Configuration"] = 590,
    ["Shopware CLI Extension Store Configuration"] = 591,
    ["Shopware CLI Project Store Configuration"] = 592,
    ["Slack app manifest"] = 429,
    Solidarity = 432,
    ["Solution filters"] = 433,
    ["Source Maps v3"] = 434,
    Sourcery = 435,
    SpecIF = 436,
    ["Sponge Mixin configuration"] = 437,
    ["StackHawk Scanner Configuration"] = 586,
    Stale = 441,
    Starship = 442,
    ["Statamic Blueprint"] = 443,
    ["StrmPrivacy Data Connector"] = 631,
    ["StrmPrivacy Data Contract"] = 632,
    ["StrmPrivacy SimpleSchema"] = 629,
    ["StrmPrivacy Stream"] = 630,
    ["StrmPrivacy batch job configuration file"] = 628,
    ["Stryker Mutator"] = 446,
    ["StyleCop Analyzers Configuration"] = 447,
    ["Swagger API 2.0"] = 450,
    TSON = 472,
    ["Talisman configuration"] = 451,
    ["Taskfile YAML Schema"] = 568,
    Taurus = 452,
    ["TestEnvironment.json"] = 460,
    ["Tier.run pricing.json"] = 455,
    Tikibase = 456,
    ["Traefik v2"] = 463,
    ["Traefik v2 File Provider"] = 464,
    Turborepo = 461,
    Tye = 594,
    ["UI5 Manifest"] = 479,
    ["UTAM Page Object"] = 482,
    ["Ubuntu Server Autoinstall"] = 477,
    ["Uniswap Token List"] = 551,
    ["Unreal Engine Uplugin"] = 637,
    ["Unreal Engine Uproject"] = 638,
    Updatecli = 601,
    Uplift = 635,
    ["User Journey Map YAML Schema"] = 571,
    V2Ray = 605,
    ["VSCode Code Snippets"] = 130,
    ["VSIX CLI publishing"] = 495,
    ["Vela Pipeline Configuration"] = 485,
    Vercel = 129,
    ["Web App Manifest"] = 500,
    ["Web types"] = 503,
    WebExtensions = 499,
    ["Webman package recipe"] = 611,
    ["Windows Package Manager Installer Manifest"] = 548,
    ["Windows Package Manager Locale Manifest"] = 549,
    ["Windows Package Manager Singleton Manifest"] = 547,
    ["Woodpecker pipeline config"] = 582,
    ["Xstate Machine Schema"] = 599,
    ["Yippee-Ki-JSON configuration YML"] = 553,
    ["angular.json"] = 11,
    ...
    ["ize.toml"] = 634,
    ["jsconfig.json"] = 274,
    ["jscpd Configuration Schema"] = 616,
    jsdoc = 541,
    ["k3d.yaml"] = 275,
    ...
    ["mtad.yaml"] = 526,
    ["mycode.json"] = 320,
    ["napari plugin manifest"] = 321,
    neoload = 536,
    ["nest-cli"] = 326,
    ["ninjs (News in JSON) 1.3"] = 325,
    ["ninjs (News in JSON) 2.0"] = 324,
    ["nlu.json"] = 327,
    ["nodemon.json"] = 329,
    ["noodl.schema.json"] = 584,
    now = 532,
    ["npm-badges"] = 332,
    ["nswag.json"] = 335,
    ntangle = 336,
    ["nuclei-template.yaml"] = 333,
    ["nuget-project.json"] = 334,
    ["ocelot.json"] = 338,
    ["omnisharp.json"] = 339,
    ["openapi.json"] = 340,
    ["openfin.json"] = 342,
    ["openrpc.json"] = 341,
    ["package.json"] = 353,
    ["package.manifest"] = 354,
    ["pattern.json"] = 357,
    ["petstore-v1.0"] = 626,
    pgap_yaml_input_reader = 356,
    ["plagiarize-me.yaml"] = 361,
    ["plagiarize.yaml"] = 360,
    ["portman.json"] = 362,
    ["prettierrc.json"] = 367,
    ["prisma.yml"] = 368,
    ["project-1.0.0-beta3.json"] = 370,
    ["project-1.0.0-beta4.json"] = 371,
    ["project-1.0.0-beta5.json"] = 372,
    ["project-1.0.0-beta6.json"] = 373,
    ["project-1.0.0-beta8.json"] = 374,
    ["project-1.0.0-rc1.json"] = 375,
    ["project-1.0.0-rc2.json"] = 376,
    ["project.json"] = 369,
    ["prometheus.json"] = 377,
    ["prometheus.rules.json"] = 378,
    ["proxies.json"] = 379,
    ["publiccode.yml"] = 380,
    ["pubspec.yaml"] = 381,
    ["pyrseas-0.8.json"] = 384,
    ["release drafter"] = 537,
    rustfmt = 400,
    ["sarif-1.0.0.json"] = 403,
    ["sarif-2.0.0.json"] = 404,
    ["sarif-2.1.0"] = 413,
    ["sarif-2.1.0-rtm.2"] = 405,
    ["sarif-2.1.0-rtm.3"] = 407,
    ["sarif-2.1.0-rtm.4"] = 409,
    ["sarif-2.1.0-rtm.5"] = 411,
    ["sarif-external-property-file-2.1.0"] = 414,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 406,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 408,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 410,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 412,
    ["schema.org - Action"] = 416,
    ["schema.org - ContactPoint"] = 417,
    ["schema.org - Place"] = 418,
    ["schema.org - Thing"] = 419,
    ["semantic-release"] = 421,
    ["servicehub.config.json"] = 513,
    ["servicehub.service.json"] = 512,
    ["settings.job"] = 424,
    ["sfdx-hardis configuration"] = 426,
    ["size-limit configuration"] = 428,
    ["skaffold.yaml"] = 577,
    ["skyuxconfig.json"] = 430,
    snapcraft = 431,
    ["stripe-app-local.json"] = 445,
    ["stripe-app.json"] = 444,
    swcrc = 564,
    taskcat = 533,
    ["template.json"] = 453,
    ["templatsources.json"] = 454,
    ["theme.json"] = 457,
    ["tizen_workspace.json"] = 458,
    tmLanguage = 459,
    tmuxinator = 521,
    ["transcend.yml"] = 465,
    ["trunk.yaml schema"] = 466,
    ["ts-force-config.json"] = 470,
    ["tsconfig.json"] = 467,
    ["tsd.json"] = 468,
    ["tsdrc.json"] = 469,
    ["tslint.json"] = 471,
    ...
    ["vega-lite.json"] = 484,
    ["vega.json"] = 483,
    ["venvironment-basic.yaml"] = 487,
    ["venvironment.yaml"] = 486,
    ["version.json"] = 488,
    ["vim-addon-info"] = 489,
    ["vs-2017.3.host.json"] = 491,
    ["vs-nesting.json"] = 492,
    ["vsls.json"] = 490,
    ["vss-extension.json"] = 496,
    ["webhint.io"] = 612,
    ["webjobpublishsettings.json"] = 502,
    ["webjobs-list.json"] = 501,
    ["xs-app.json"] = 529,
    ["xunit.runner.json"] = 511,
    yamllint = 552,
    zuul = 538,
    ["Žinoma"] = 546
  },
