...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1016,
    [".nodehawkrc"] = 646,
    [".npmpackagejsonlintrc"] = 650,
    [".omletrc"] = 1197,
    [".phrase.yml"] = 728,
    [".phraseapp.yml"] = 729,
    [".pmbot.yml"] = 713,
    [".postcssrc"] = 722,
    [".powerpages-web-template-manifest"] = 724,
    [".pre-commit-config.yml"] = 725,
    [".pre-commit-hooks.yml"] = 726,
    [".putout.json"] = 762,
    [".rehyperc"] = 787,
    [".remarkrc"] = 791,
    [".sprite files"] = 889,
    ...
    AIConfig = 43,
    ["AMX Muse Program Descriptor"] = 1246,
    ["API Builder"] = 1052,
    ["AVA Configuration"] = 1116,
    ...
    ["AWS Copilot Manifest"] = 1285,
    ["AWS SAM CLI Samconfig"] = 287,
    Acton = 1336,
    ["Adobe UXP Manifest"] = 1179,
    ["Aerleon Network & Service Definitions"] = 25,
    ["Aerleon Policy"] = 26,
    ["Agent Permission Policy"] = 1325,
    ["AgentCore CLI"] = 1326,
    AgentLoopKit = 1327,
    Aider = 1275,
    Air = 28,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1296,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1295,
    ["Airlock Microgateway"] = 44,
    ["Alacritty Configuration"] = 1088,
    ["AlgoVoi Compliance Receipt v1"] = 15,
    ["All Contributors configuration file"] = 1142,
    Anodizer = 467,
    ["Ansible Argument Specs"] = 450,
    ["Ansible Collection Galaxy"] = 457,
    ["Ansible Execution Environment"] = 447,
    ["Ansible Inventory"] = 456,
    ["Ansible Meta"] = 448,
    ["Ansible Meta Runtime"] = 449,
    ["Ansible Navigator Configuration"] = 459,
    ["Ansible Playbook"] = 454,
    ["Ansible Requirements"] = 451,
    ["Ansible Rulebook"] = 455,
    ["Ansible Tasks File"] = 453,
    ["Ansible Vars File"] = 452,
    ["Ansible-lint Configuration"] = 458,
    Any = 1207,
    ...
    ["Application list for a WinUtil"] = 1225,
    ArchitectFX = 1230,
    ["Argo CD"] = 63,
    ["Argo Events"] = 64,
    ["Argo Workflows"] = 65,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1294,
    ["Azure IoT Operations connector metadata"] = 1291,
    ...
    ["Azure Pipelines"] = 123,
    ["Azure Static Web Apps CLI configuration file"] = 893,
    ["Azure Static Web Apps configuration file"] = 892,
    BMML = 1313,
    ["BOSH BPM Config"] = 149,
    ["BOSH CPI Config"] = 150,
    ...
    ["Bacon config"] = 9,
    ["Barba-CV"] = 92,
    ["Bashly (bashly.yml)"] = 1146,
    ["Bashly Settings (bashly-settings.yml)"] = 1147,
    Bento = 1312,
    ["Better Code Hub"] = 1057,
    ["Better Scripts"] = 173,
    Bigconfig = 142,
    ["Biome Formatter Config"] = 93,
    ["Bitmovin Encoding Template"] = 1239,
    BizTalkServerApplicationSchema = 1023,
    Bleep = 174,
    ["Block Protocol Metadata"] = 171,
    ["Bluebricks blueprint config"] = 1318,
    ["Boyka Framework"] = 152,
    ...
    ["Butane Config"] = 1101,
    C4InterFlow = 1254,
    ["CDK Environment Manager, concrete environment configuration"] = 1278,
    ["CDK Environment Manager, concrete environments definition"] = 1277,
    ["CDK Environment Manager, environment definition"] = 1276,
    ["CGS Card Game Specification (cgs.json)"] = 1184,
    ["CICS TS region tagging"] = 1110,
    ["CICS TS resource import"] = 1111,
    ["CICS TS resource model"] = 1112,
    ["CICS TS resource overrides"] = 1113,
    ["CMake Presets"] = 175,
    ["CNC Codes"] = 197,
    ["CRS WAF test file"] = 1214,
    ["CRS WAF test platform overrides file"] = 1215,
    ...
    ["Caido Proxy Configuration"] = 1350,
    ...
    ["Chamaleon environment"] = 1243,
    ["Chamaleon properties"] = 1244,
    ["Chamaleon template"] = 1242,
    Changepacks = 1305,
    Changesets = 296,
    Changie = 184,
    Charmcraft = 185,
    ...
    ["Clawject config"] = 203,
    ["Cloud Foundry Application Manifest"] = 1196,
    ["Cloud Run Spec v1"] = 1220,
    ...
    Concord = 1213,
    ["Configu .cfgu files"] = 1201,
    ["Configu .configu file"] = 1202,
    Conjure = 196,
    ["Container Structure Test"] = 1037,
    Containerlab = 1066,
    ["Contextive Glossary"] = 1270,
    ContractGuard = 1067,
    Convex = 195,
    ...
    ["Cursor Agent Environment"] = 1323,
    ["Custom Machinery Machine"] = 1185,
    ["Custom Machinery Recipe"] = 1186,
    ...
    ["DataYoga Job"] = 213,
    ["Datadog Continuous Testing"] = 553,
    ["Datadog Service Definition"] = 554,
    ["Datadog Software Catalog"] = 555,
    ["Datahub Ingestion Recipe"] = 1117,
    ["Debian Upstream Metadata file"] = 220,
    DebtLens = 221,
    ["Deck config"] = 222,
    ["Declarative Automation Bundles"] = 1163,
    ["DeepMatch deeplinks spec"] = 223,
    ["Dein Config"] = 224,
    ["Deno Config (deno.json)"] = 325,
    ["Dependency cruiser"] = 225,
    ["DeployStack Configuration"] = 226,
    ["Deployah Configuration"] = 1293,
    ["Deployer Recipe"] = 328,
    ["Deta Spacefile"] = 227,
    ...
    ["DonateCaseBetterCasino menu"] = 1247,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1154,
    ["EAS config"] = 396,
    ["ECA - Editor Code Assistant"] = 360,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1143,
    ["ESLint Suppressions"] = 401,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1290,
    ["EasyVCR .NET"] = 398,
    ["Eidolon Resource"] = 1231,
    ...
    ["Envelope Team Definition"] = 1335,
    ["Envilder Map File"] = 364,
    ["Erda Pipeline"] = 1192,
    ["Erda Runtime"] = 1193,
    ["Espanso config.yml"] = 1316,
    ["Espanso match.yml"] = 1315,
    Esquio = 384,
    ["Estuary Flow Catalog"] = 1107,
    ["Ethereum ERC1155"] = 1329,
    ["Ethereum ERC721"] = 1328,
    ...
    ["Evolving Resolutive Process notation"] = 1292,
    ["Expo SDK"] = 395,
    ...
    ["GeoJSON.json latest"] = 1105,
    GherKing = 1109,
    ["GitHub Action"] = 434,
    ["GitHub Actions typing"] = 1227,
    ["GitHub Discussion"] = 435,
    ["GitHub Funding"] = 436,
    ["GitHub Issue Template configuration"] = 437,
    ["GitHub Issue Template forms"] = 438,
    ["GitHub Pages Jekyll"] = 439,
    ["GitHub Workflow"] = 440,
    ["GitHub Workflow Template Properties"] = 441,
    ["GitHub automatically generated release notes configuration"] = 442,
    ["GitLab Agent for Kubernetes configuration"] = 1181,
    GitResume = 446,
    GitVersion = 431,
    ["Gitea Issue Template configuration"] = 432,
    ["Gitea Issue Template forms"] = 433,
    ["Gitpod Automations"] = 444,
    ["Gitpod Configuration"] = 445,
    ["Glamour style"] = 429,
    ["GlazeWM settings"] = 1183,
    ["Global Privacy Control"] = 430,
    Goblet = 1162,
    ["Golangci-lint Configuration"] = 461,
    ["Golangci-lint Custom Plugins Configuration"] = 462,
    ["Google Chrome Related Website Sets"] = 406,
    ["Google Cloud Workflows"] = 283,
    ["Google Digital Assetlinks"] = 1271,
    Goreleaser = 465,
    ["Goreleaser Pro"] = 466,
    Goss = 468,
    ["Gradle Build Cache Node"] = 1055,
    ["Gradle Enterprise"] = 1054,
    ["Grafana 5.x Dashboard"] = 469,
    ["GraphQL Code Generator"] = 474,
    ["GraphQL Config"] = 473,
    ["GraphQL Mesh"] = 472,
    ["GroovyLint configuration"] = 475,
    ["Grunt JSHint task"] = 479,
    ["Grunt Watch task"] = 480,
    ["Grunt base task"] = 481,
    ["Grunt clean task"] = 477,
    ["Grunt copy task"] = 476,
    ["Grunt cssmin task"] = 478,
    HEMTT = 1019,
    Hadolint = 1033,
    Hammerkit = 1065,
    ["Hardware Sentry Configuration"] = 1121,
    ["Hashgraph Online Skill Manifest"] = 5,
    ["HashiCorp Vault"] = 482,
    Hatch = 1034,
    Hayson = 484,
    ["Haystack Pipeline"] = 485,
    ["Hazelcast 5 Configuration"] = 486,
    ["Hecate Input Schema"] = 1282,
    ["Helm Chart.lock"] = 245,
    ["Helm Chart.yaml"] = 244,
    ["Helm Unittest Test Suite"] = 246,
    ["Hex file"] = 247,
    ["Home Assistant Integration Manifest"] = 487,
    ["Homer dashboard configuration"] = 488,
    Hugo = 1097,
    ["Hugo Theme"] = 1096,
    ["Hulak Configuration"] = 495,
    ["Hyperfoil benchmark configuration"] = 494,
    ["IBM Zapp document"] = 496,
    ["IBM zCodeFormatSettings"] = 497,
    ["IMG Catapult PSP"] = 502,
    ["IVMS101 by CODE Protocol"] = 1182,
    ["Infinispan Configuration"] = 504,
    ["Infinispan Server Configuration"] = 505,
    Infrahub = 506,
    Istanbul = 1125,
    ["JDownloader2 crawler multi-rules"] = 520,
    ["JDownloader2 crawler single-rules"] = 519,
    ["JFrog Applications Config"] = 521,
    ["JFrog File Spec"] = 522,
    ["JFrog Pipelines YML DSL"] = 1131,
    ["JMeter DSL cli config"] = 523,
    JReleaser = 526,
    ["JSON Document Transform"] = 534,
    ["JSON Feed"] = 535,
    ["JSON Resume"] = 799,
    ["JSON Schema Draft 2020-12"] = 1001,
    ["JSON Schema Draft 4"] = 998,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1164,
    ["JSON Schema Draft 7"] = 999,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1165,
    ["JSON Schema Draft 8 (2019-09)"] = 1000,
    ["JSON-API"] = 533,
    ["JSON-e templates"] = 1062,
    ["JSON-stat 2.0"] = 994,
    JSONPatch = 537,
    ["JSR Package Config (jsr.json)"] = 527,
    Jarl = 1298,
    Jasmine = 514,
    Jekyll = 515,
    ["Jenkins X Pipelines"] = 516,
    ["Jenkins X Requirements"] = 517,
    Jest = 518,
    Jocker = 524,
    ["Jovo Language Models"] = 525,
    ["Jujutsu (jj) VCS config"] = 1284,
    ["KIMMDY config file"] = 548,
    ["KODE/CI build.yaml"] = 1127,
    ["KSP-AVC"] = 995,
    ["KSP-CKAN"] = 996,
    ["KSP-NetKAN"] = 997,
    KSY = 1194,
    ...
    Kas = 540,
    ["Kestra flow file"] = 549,
    ["Keycloak REST API"] = 1134,
    ["Knative Functions - func.yaml"] = 419,
    Knip = 420,
    ["Knowledge Unit"] = 557,
    ["Kometa (nightly) config file"] = 551,
    ["Kometa config file"] = 550,
    ["Kong DBLess config"] = 1128,
    KrakenD = 552,
    ["Kubri Configuration"] = 560,
    LOOBin = 575,
    ["Lake configuration file"] = 1287,
    ...
    ["Lando (landofile)"] = 119,
    ["LangGraph Platform configuration"] = 1206,
    ["Language configuration"] = 1205,
    Lefthook = 564,
    ["Liferay client-extension.yaml"] = 571,
    ["LinkML Metamodel"] = 573,
    Liquibase = 1072,
    ["Liquibase Flow File"] = 1073,
    ["Lively Properties"] = 574,
    ["Lobe AI Agent"] = 121,
    Loki = 122,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 617,
    ["MS2Rescore Configuration"] = 623,
    ["MSTest testconfig.json"] = 624,
    ["Madness (madness.yml)"] = 1145,
    ["Mado configuration"] = 581,
    ["Maestro Flow"] = 582,
    ["Mail Servers Configuration"] = 1319,
    ["MapEHR Mapping"] = 583,
    Markdownlint = 1076,
    ["Mason Registry"] = 1079,
    ["MegaLinter Custom Flavor"] = 586,
    ["MegaLinter configuration"] = 585,
    ["MegaLinter descriptor"] = 587,
    Melange = 1172,
    ["Meltano project definition"] = 588,
    ["Mergify Configuration"] = 625,
    ["Metadata for a Bazel module"] = 589,
    ["Metadata for a Cinnamon spice"] = 1223,
    ["Metatype Configuration"] = 590,
    ["MetricsHub Configuration"] = 591,
    ["MetricsHub Connector Configuration"] = 592,
    ["Micro Editor Syntax"] = 1155,
    ["Microsoft Band Web Tile"] = 593,
    ["Microsoft RulesEngine workflow rules"] = 1210,
    ["Microsoft RulesEngine workflow rules list"] = 1211,
    ["Minecraft Custom Main Menu Mod"] = 1173,
    ["Minecraft Data Pack Advancement"] = 595,
    ["Minecraft Data Pack Biome"] = 596,
    ["Minecraft Data Pack Configured Carver"] = 597,
    ["Minecraft Data Pack Damage Type"] = 598,
    ["Minecraft Data Pack Dimension"] = 600,
    ["Minecraft Data Pack Dimension Type"] = 599,
    ["Minecraft Data Pack Item Modifier"] = 601,
    ["Minecraft Data Pack Loot Table"] = 602,
    ["Minecraft Data Pack Metadata"] = 603,
    ["Minecraft Data Pack Predicate"] = 604,
    ["Minecraft Data Pack Recipe"] = 605,
    ["Minecraft Data Pack Tag"] = 606,
    ["Minecraft Data Pack Template Pool"] = 607,
    ["Minecraft Data Pack Trim Material"] = 612,
    ["Minecraft Data Pack Trim Pattern"] = 613,
    ["Minecraft Resource Pack Lang"] = 608,
    ["Minecraft Resource Pack Particle"] = 609,
    ["Minecraft Resource Pack Texture Mcmeta"] = 611,
    ["Minecraft Resourcepack Sounds"] = 610,
    ["MockServer Expectations"] = 619,
    ModuleAssembler = 615,
    ["Monade CLI Stack Configuration"] = 628,
    ["MongoDB Atlas Search Index Definition"] = 1126,
    ["Monika Configuration"] = 1124,
    ["Monoweave Configuration"] = 622,
    ["Motif config"] = 1015,
    MultiQC = 1264,
    ["NOX Framework (Service)"] = 649,
    ["Netin Diagnostic System Template"] = 1083,
    ["Netlify config"] = 631,
    ["Network-as-Code Data Model"] = 632,
    ["Next Gen UI Agent A2A Server Configuration"] = 633,
    ["Next Gen UI Agent Configuration"] = 635,
    ["Next Gen UI Agent MCP Server Configuration"] = 634,
    ["Nightwatch.js"] = 642,
    ["Node.js configuration"] = 1020,
    ["NueJS configuration file"] = 654,
    ["Nuitka Package Config"] = 1187,
    ["Nullstone config"] = 656,
    ["ONe's changelog entry"] = 675,
    ["ONe's service descriptor"] = 674,
    ["ORT Server repository environment configuration"] = 685,
    ["OSCAL Assessment Plan (AP)"] = 687,
    ["OSCAL Assessment Results (AR)"] = 688,
    ["OSCAL Catalog"] = 689,
    ["OSCAL Component Definition (CDef)"] = 690,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 691,
    ["OSCAL Profile"] = 692,
    ["OSCAL System Security Plan (SSP)"] = 693,
    ["OSS Review Toolkit configuration"] = 694,
    ["OSS Review Toolkit curation"] = 695,
    ["OSS Review Toolkit package configuration"] = 696,
    ["OSS Review Toolkit project package manager definition"] = 697,
    ["OSS Review Toolkit repository configuration"] = 698,
    ["OSS Review Toolkit resolutions"] = 699,
    ["October CMS columns"] = 660,
    ["October CMS fields"] = 661,
    ["Oh My Posh"] = 663,
    Okteto = 664,
    ["Ona Automations"] = 666,
    Opctl = 1018,
    ["Open Data Contract Standard (ODCS)"] = 679,
    ["Open Data Product Standard (ODPS)"] = 680,
    ["Open Know-How"] = 1269,
    OpenDecree = 1333,
    ["OpenDecree Configuration"] = 1334,
    ["OpenRewrite Resource"] = 677,
    OpenSRM = 681,
    OpenStatus = 1280,
    ["OpenTelemetry Declarative Configuration"] = 678,
    ["OpenUtau character yaml"] = 671,
    ["OpenUtau ustx"] = 672,
    ["OpenWeather Current Weather API"] = 1061,
    ["OpenWeather Road Risk API"] = 1060,
    ["Ory Hydra configuration"] = 493,
    ["Ory Keto configuration"] = 556,
    ["Ory Kratos configuration"] = 686,
    ["Ory Oathkeeper configuration"] = 658,
    ["Outblocks App configuration"] = 683,
    ["Outblocks database table"] = 684,
    ["Outblocks project configuration"] = 682,
    PDM = 707,
    POPxf = 719,
    ["POPxf Correlations"] = 720,
    ["PRML manifest"] = 727,
    Packer = 703,
    PactSpec = 704,
    Panache = 705,
    Pantsbuild = 1141,
    ["Paper paper-plugin.yml"] = 706,
    ["Pipeline component"] = 1074,
    ["Platform.sh application"] = 11,
    ["Platform.sh routes"] = 12,
    ["Platform.sh services"] = 13,
    ["Plex Prerolls"] = 717,
    ["PocketMine plugin.yml"] = 714,
    ["Podman Desktop Extension"] = 1352,
    ["Postman collection"] = 723,
    ["Power Pages Configuration"] = 1281,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1226,
    ["ProActions AI-Kit Configuration"] = 735,
    ["ProActions AI-Kit Configuration for Menus"] = 737,
    ["ProActions AI-Kit Configuration for Sections"] = 739,
    ["ProActions AI-Kit Configuration for Services"] = 736,
    ["ProActions AI-Kit Configuration for Steps"] = 740,
    ["ProActions AI-Kit Configuration for Templates"] = 738,
    ["Problem object RFC9457"] = 1170,
    ["Problem package format"] = 741,
    ["Problem package generators"] = 742,
    ["Problem package submissions"] = 743,
    ["Problem package test group metadata"] = 744,
    Pterodactyl = 1120,
    ["Pull Request Labeler"] = 761,
    Pulumi = 769,
    ["PyGTA Config"] = 765,
    PyProject = 770,
    Pylock = 1272,
    Pyright = 771,
    ["Python script metadata"] = 1266,
    ["QType AI DSL"] = 774,
    Qgoda = 773,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1344,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1342,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1348,
    ["Qlik Talend Cloud Pipeline - Project"] = 1340,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1343,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1345,
    ["Qlik Talend Cloud Pipeline - Task"] = 1341,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1347,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1346,
    Qodana = 1093,
    ["Qt Creator workspace file"] = 1203,
    ["Quali Torque Blueprint Spec 2"] = 1118,
    ["QueryFirst config file"] = 1137,
    ["QuikRun Configuration"] = 1349,
    ["Qwen Code Settings"] = 1330,
    ["RKE Cluster Configuration JSON"] = 1071,
    ["RKE Cluster Configuration YAML"] = 1070,
    RadioHound = 764,
    ["Raid Profile"] = 1331,
    ["Raid Repo Configuration"] = 1332,
    Railpack = 776,
    Railway = 775,
    ["Rancher Fleet"] = 766,
    ["Rattler-build"] = 777,
    Ray = 1032,
    ["Read the Docs"] = 768,
    ["Red-DiscordBot Cog"] = 784,
    ["Red-DiscordBot Cog Repo"] = 785,
    ["Red-DiscordBot Trivia"] = 786,
    ["Releasaurus Config"] = 8,
    ReleaseKit = 7,
    ["Render Blueprints"] = 1069,
    RenderCV = 803,
    Renovate = 800,
    ["Renovate global configuration"] = 801,
    ["Renovate inherited configuration"] = 802,
    ["Replit config"] = 792,
    Restate = 1259,
    ["Revel Digital Gadget Definition File"] = 1283,
    RoadRunner = 805,
    ["Robust Station Image"] = 1289,
    Rockcraft = 806,
    ["Roo Coder Custom Modes"] = 807,
    Rubocop = 796,
    ["Rudder techniques"] = 1177,
    Ruff = 797,
    ["Rust Project"] = 798,
    ["Rust toolchain"] = 812,
    ["SDMX data message"] = 839,
    ["SDMX metadata message"] = 838,
    ["SDMX structure message"] = 837,
    ["SIL Kit Participant Configuration"] = 850,
    ["SIL Kit Registry Configuration"] = 851,
    ["SPDX 2.3"] = 890,
    SWADL = 906,
    ["Safebox Config"] = 1132,
    ["Sapphire CLI Config"] = 815,
    ["SauceCTL Configuration"] = 1080,
    Scarb = 835,
    ["Schema Catalog"] = 830,
    ["Scoop manifest"] = 836,
    ["Secure SDLC Evidence Bundle"] = 840,
    ["Semantic Data Fabric (SDF) file"] = 841,
    ["Semgrep Rule"] = 843,
    ["Serenity Code Generator (Sergen)"] = 844,
    ["Serverless Framework Configuration"] = 1087,
    ["Serverless Workflow"] = 1089,
    ["Settings for a Cinnamon spice"] = 1222,
    ["Settings.paf"] = 846,
    ["Shopware 6 Configuration"] = 1090,
    ["Shopware CLI Extension Store Configuration"] = 1091,
    ["Shopware CLI Project Store Configuration"] = 1092,
    ["Sigma Detection Rule"] = 848,
    ["SigmaCV CV"] = 3,
    ["Sigrid scope configuration file"] = 849,
    ["SkyPilot Task JSON"] = 1178,
    ["Slack app manifest"] = 853,
    ["Slang Server Configuration"] = 1353,
    Snapcraft = 855,
    ["Solarxy project config"] = 858,
    Solidarity = 859,
    ["Solution filters"] = 860,
    ["Source Maps v3"] = 861,
    Sourcery = 862,
    ["Spack bootstrap.yaml"] = 863,
    ["Spack cdash.yaml"] = 864,
    ["Spack ci.yaml"] = 865,
    ["Spack compilers.yaml"] = 866,
    ["Spack concretizer.yaml"] = 867,
    ["Spack config.yaml"] = 868,
    ["Spack definitions.yaml"] = 869,
    ["Spack develop.yaml"] = 870,
    ["Spack env_vars.yaml"] = 871,
    ["Spack environment"] = 877,
    ["Spack include.yaml"] = 872,
    ["Spack mirrors.yaml"] = 873,
    ["Spack modules.yaml"] = 874,
    ["Spack packages.yaml"] = 875,
    ["Spack repos.yaml"] = 876,
    ["Spack toolchains.yaml"] = 878,
    ["Spack upstreams.yaml"] = 879,
    ["Spack view.yaml"] = 880,
    ["Speakeasy Generation Config File"] = 884,
    ["Speakeasy Lint Configuration File"] = 881,
    ["Speakeasy Test Generation Configuration File"] = 882,
    ["Speakeasy Workflow File"] = 883,
    SpecIF = 885,
    ["Specmatic Configuration"] = 886,
    ["Specpin spec file"] = 1,
    ["Sponge Mixin configuration"] = 887,
    ["Spotlight Ruleset"] = 888,
    StackBlitz = 894,
    ["StackHawk Scanner Configuration"] = 1086,
    Stale = 895,
    Starfish = 896,
    ["Starlake Data Pipeline"] = 1058,
    Starship = 897,
    ["Statamic Blueprint"] = 898,
    ["Stella configuration file"] = 899,
    ["Streamlit configuration file"] = 900,
    ["Stryker Mutator"] = 903,
    ["StyleCop Analyzers Configuration"] = 904,
    ["Stylelint (.stylelintrc)"] = 905,
    ["Stylua Config"] = 1273,
    ["Sublime Syntax"] = 1133,
    ["Subsquid squid manifest"] = 1180,
    ["Swagger API 2.0"] = 907,
    ["Synadia Connect Component"] = 908,
    TSON = 944,
    TSTyche = 945,
    ["TYPO3 Vendor Bundler config"] = 951,
    ["Tab data for a LinUtil"] = 1229,
    ["Tab list for a LinUtil"] = 1228,
    Tach = 909,
    ["Tach Domain"] = 910,
    Talhelper = 912,
    ["Talisman configuration"] = 913,
    Taplo = 1274,
    ["Taskfile config"] = 1063,
    Taurus = 914,
    Tauticord = 915,
    ["Tekton Pipeline"] = 1302,
    ["Tekton PipelineRun"] = 1303,
    ["Tekton Task"] = 1300,
    ["Tekton TaskRun"] = 1301,
    Telefonistka = 1260,
    ["Terrateam config"] = 1286,
    ["TestEnvironment.json"] = 927,
    ["TextMate Grammar"] = 926,
    Threagile = 921,
    ["Tier.run pricing.json"] = 918,
    Tikibase = 919,
    Tombi = 924,
    ["Traefik v2"] = 930,
    ["Traefik v2 File Provider"] = 931,
    ["Traefik v3"] = 932,
    ["Traefik v3 File Provider"] = 933,
    ["Travis CI (.travis.yml)"] = 929,
    Treefmt = 471,
    Trident = 1256,
    ["TrueScript for *.tscript files"] = 936,
    ["Tugboat QA config.yml"] = 1253,
    TunnelHub = 1168,
    Turborepo = 928,
    Tycho = 1217,
    Tye = 1094,
    ["Tyk Gateway - Open Source v5.7+"] = 1265,
    ["UET BuildConfig.json"] = 1138,
    ["UI5 Manifest"] = 957,
    ["UNCORS configuration"] = 962,
    ["UTAM Page Object"] = 960,
    ["Ubuntu Server Autoinstall"] = 955,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1257,
    ["Uniswap Token List"] = 1043,
    ["Universal Schedule Format"] = 963,
    ["Unreal Engine Uplugin"] = 1139,
    ["Unreal Engine Uproject"] = 1140,
    ["UpCloud CLI (upctl) configuration"] = 1258,
    ["Updatecli Compose"] = 1102,
    ["Updatecli Policy Manifest"] = 1103,
    ["Updatecli Policy Metadata"] = 1104,
    Uplift = 1136,
    ["Upsun config"] = 10,
    ["User Journey Map"] = 1068,
    V2Ray = 1108,
    ["VSCode Code Snippets"] = 271,
    ["VSIX CLI publishing"] = 981,
    Vector = 965,
    ["Vela Pipeline Configuration"] = 968,
    Vercel = 270,
    ["Version Bumper config"] = 971,
    Vespertide = 1307,
    ["Vespertide Migration"] = 1308,
    ["Vespertide Model"] = 1309,
    ["Viash Component Config"] = 1262,
    ["Viash Package Config"] = 1263,
    Visivo = 1166,
    ["WP-CLI"] = 991,
    Wake = 1255,
    ["Waku Config"] = 1232,
    ["Web App Manifest"] = 987,
    ["Web types"] = 990,
    WebExtensions = 986,
    ["Webman package recipe"] = 1114,
    ["Windows Package Manager Installer Manifest"] = 1040,
    ["Windows Package Manager Locale Manifest"] = 1041,
    ["Windows Package Manager Singleton Manifest"] = 1039,
    ["WireMock CLI import configuration"] = 1238,
    ["WireMock CLI local service configuration"] = 1237,
    ["WireMock message stub mapping"] = 1236,
    ["WireMock stub mapping"] = 1235,
    ["Woodpecker pipeline config"] = 1082,
    ["Wrangler CLI"] = 992,
    ["XenForo add-on manifest"] = 993,
    ["Xstate Machine"] = 1100,
    ["Yandex Workflow Language"] = 1224,
    ["Yarn Config (.yarnrc.yml)"] = 1056,
    ["Yippee-Ki-JSON configuration YML"] = 1047,
    ["YouTrack App"] = 1221,
    ["Zarf Package Configuration"] = 1288,
    ["Zerops import file"] = 1209,
    ["Zola Configuration"] = 1299,
    abtop = 30,
    actionlint = 40,
    ["aerleon.yml"] = 24,
    ["amplify.yml"] = 17,
    ["amxx-builder manifest"] = 1351,
    ["angular.json"] = 45,
    apko = 1171,
    ...
    ["behat.yml"] = 153,
    ["bigquery-table"] = 141,
    ["bioimageio resource description"] = 1188,
    ...
    ["cargo-nextest repository configuration"] = 636,
    ["cargo-nextest user configuration"] = 637,
    ["ccmod.json"] = 1233,
    changelogging = 1200,
    ...
    ["chutzpah.json"] = 279,
    cibuildwheel = 190,
    ["clang-format (.clang-format)"] = 1106,
    ["clang-tidy"] = 253,
    clangd = 252,
    clib = 254,
    ...
    ["crowdin.yml"] = 306,
    ["ctfd-setup configuration file"] = 1245,
    ["custom-elements.json"] = 1158,
    ["cypress.json"] = 310,
    ["dacier.yml"] = 1339,
    ...
    ["gematik health care insurance list"] = 1251,
    ["gematik health care patient list"] = 1248,
    ["gematik health care provider institution list"] = 1250,
    ["gematik health care provider list"] = 1249,
    ["gematik tiger test environment configuration"] = 1252,
    ["git-town.toml"] = 1297,
    ["gitlab-ci"] = 443,
    ["global.json"] = 460,
    ["go-feature-flag Flag Configuration"] = 464,
    gollama = 463,
    ["haxelib.json"] = 483,
    helmfile = 1035,
    helmwave = 1036,
    ...
    ["ide.host.json"] = 498,
    ["ifstate.yaml"] = 499,
    ["imageoptimizer.json"] = 500,
    ["importmap.json"] = 503,
    instant_python_config = 507,
    instant_python_custom_project = 508,
    intlayer = 509,
    ["ioBroker Configuration"] = 510,
    ["ioBroker JSON UI"] = 511,
    ["ioBroker Package manifest"] = 512,
    ["ixpect.conf.yaml"] = 513,
    ["ize.toml"] = 1135,
    ["jsconfig.json"] = 538,
    ["jscpd Configuration"] = 1119,
    jsdoc = 1031,
    ["k3d.yaml"] = 539,
    ["k9s aliases.yaml"] = 541,
    ["k9s cluster-config.yaml"] = 543,
    ["k9s config.yaml"] = 542,
    ["k9s hotkeys.yaml"] = 544,
    ["k9s plugins.yaml"] = 545,
    ["k9s skin.yaml"] = 546,
    ["k9s views.yaml"] = 547,
    ["kontinuous-config.yaml"] = 559,
    ["kontinuous-values.yaml"] = 558,
    ["kustomization.yaml"] = 561,
    ["label-commenter-config.yml"] = 562,
    ["latexindent configuration"] = 120,
    ["launchsettings.json"] = 563,
    lazydocker = 1157,
    lazygit = 1156,
    ["lego.json"] = 565,
    ["lerna.json"] = 566,
    ["lgtm.yml"] = 567,
    ["liblab.config.json"] = 568,
    ["libman.json"] = 569,
    ["license-report-config.json"] = 570,
    ["linkinator.config.json"] = 572,
    ["lint-staged (.lintstagedrc)"] = 1009,
    ["local.settings.json"] = 577,
    ["localazy.json"] = 578,
    ["lotus.yaml"] = 576,
    ["lsdlschema.json"] = 579,
    ["macro.json"] = 1123,
    ["markdown-link-check"] = 1077,
    maturin = 1078,
    mboats = 1085,
    memnex = 1337,
    ["micro-settings.json"] = 1150,
    ["mimetypes.json"] = 594,
    ["mirrord config"] = 1011,
    mise = 1012,
    ["mkdocs.yml"] = 614,
    ["mockd.yaml"] = 618,
    ["modelparams.dev Model"] = 620,
    ["monospace.yml"] = 621,
    ["moon.yml"] = 1234,
    ["mprocs Configuration file"] = 1204,
    ["mrdocs.yml"] = 616,
    ["mta.yaml"] = 1013,
    ["mtad.yaml"] = 1014,
    ["mycode.json"] = 629,
    nFPM = 641,
    ["napari plugin manifest"] = 630,
    neoload = 1026,
    ["nest-cli"] = 644,
    ["nexus-rpc-gen"] = 1324,
    ["nf-core module environment.yml"] = 638,
    ["nf-core module meta.yml"] = 639,
    ["nf-core subworkflow meta.yml"] = 640,
    ["ninjs (News in JSON)"] = 643,
    ["nitro.json"] = 1025,
    ["nixd configuration"] = 1176,
    ["nlu.json"] = 645,
    ["nodemon.json"] = 647,
    ["noodl config"] = 1084,
    ["notebook.mod.json"] = 648,
    now = 1021,
    ["npm-badges"] = 651,
    ["nswag.json"] = 655,
    ntangle = 657,
    ["nuclei-template.yaml"] = 652,
    ["nuget-project.json"] = 653,
    ["ocelot.json"] = 659,
    ogen = 662,
    ["omnisharp.json"] = 665,
    openHAB = 1310,
    ...
    oxlint = 1321,
    ["package.json"] = 700,
    ["package.manifest"] = 702,
    ["package.yaml"] = 701,
    ["partial-black.json"] = 154,
    ["partial-fastapi.json"] = 155,
    ["partial-pixi.json"] = 712,
    ["partial-scheduled.json"] = 156,
    ["pattern.json"] = 710,
    ["petstore-v1.0"] = 1130,
    pgap_yaml_input_reader = 708,
    pgrls = 709,
    pgxgen = 1314,
    pitcms = 1317,
    ["pixi.toml"] = 711,
    ["plagiarize-me.yaml"] = 716,
    ["plagiarize.yaml"] = 715,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1241,
    ["podbard.yaml"] = 718,
    ["portman.json"] = 721,
    ["prefect.toml"] = 730,
    ["prefect.yaml"] = 731,
    ...
    ["prettierrc.json"] = 733,
    ["prisma.yml"] = 734,
    ["project-1.0.0-beta3.json"] = 746,
    ["project-1.0.0-beta4.json"] = 747,
    ["project-1.0.0-beta5.json"] = 748,
    ["project-1.0.0-beta6.json"] = 749,
    ["project-1.0.0-beta8.json"] = 750,
    ["project-1.0.0-rc1.json"] = 751,
    ["project-1.0.0-rc2.json"] = 752,
    ["project.json"] = 745,
    ["project.owasp.yaml"] = 753,
    ["prometheus-alertmanager.json"] = 757,
    ["prometheus.json"] = 754,
    ["prometheus.rules.json"] = 755,
    ["prometheus.rules.test.json"] = 756,
    ["proxies.json"] = 758,
    ["publiccode.yml"] = 759,
    ["pubspec.yaml"] = 760,
    ["pyrseas-0.8.json"] = 763,
    pytest = 772,
    ["quilt.mod.json"] = 1151,
    ["rc3 auth"] = 778,
    ["rc3 collection"] = 779,
    ...
    ["rc3 settings"] = 783,
    ["registry.yaml"] = 58,
    ["release drafter"] = 1027,
    ["release-hub.json"] = 6,
    ["release-please-config.json"] = 788,
    ["release-please-manifest.json"] = 789,
    ["release-plz.toml"] = 790,
    ["renv.lock"] = 804,
    ["reposets Configuration"] = 793,
    ["reposets Credentials"] = 794,
    ["revola.json"] = 4,
    ["rivet.json"] = 1175,
    ["rivet.yaml (legacy)"] = 1174,
    rumdl = 809,
    runny = 808,
    runspec = 1338,
    rustfmt = 810,
    ...
    samt = 813,
    samtrc = 814,
    ["sarif-1.0.0.json"] = 816,
    ["sarif-2.0.0.json"] = 817,
    ["sarif-2.1.0"] = 827,
    ["sarif-2.1.0-rtm.2"] = 818,
    ["sarif-2.1.0-rtm.3"] = 820,
    ["sarif-2.1.0-rtm.4"] = 822,
    ["sarif-2.1.0-rtm.5"] = 824,
    ["sarif-2.1.0-rtm.6"] = 825,
    ["sarif-external-property-file-2.1.0"] = 828,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 819,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 821,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 823,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 826,
    ["scalingo.json configuration"] = 829,
    ["schema.org - Action"] = 831,
    ["schema.org - ContactPoint"] = 832,
    ["schema.org - Place"] = 833,
    ["schema.org - Thing"] = 834,
    ["secrethub.yml"] = 1153,
    ["semantic-release"] = 842,
    ["servicehub.config.json"] = 1004,
    ["servicehub.service.json"] = 1003,
    ["settings.job"] = 845,
    ["sfdx-hardis configuration"] = 847,
    ["shard.yml"] = 1191,
    ["size-limit configuration"] = 852,
    ["skaffold.yaml"] = 1075,
    ["skyuxconfig.json"] = 854,
    ["snowflake-config"] = 856,
    ["snowflake-connections"] = 857,
    ["spicepod.yaml"] = 1212,
    ["sqlc configuration"] = 891,
    ["stripe-app-local.json"] = 902,
    ["stripe-app.json"] = 901,
    swcrc = 1059,
    ["task.json"] = 911,
    taskcat = 1022,
    ["template.json"] = 916,
    ["templatsources.json"] = 917,
    ["text2confl config"] = 1322,
    ["theme.json"] = 920,
    ["tizen_workspace.json"] = 922,
    tldr = 923,
    ["tm_devices configuration file"] = 1279,
    tmuxinator = 1007,
    tox = 925,
    ["transcend.yml"] = 934,
    ["tree-sitter grammar.json"] = 470,
    ["trime.yaml"] = 935,
    ["trunk.yaml"] = 937,
    ["ts-force-config.json"] = 942,
    ["tsconfig.json"] = 938,
    ["tsd.json"] = 939,
    ["tsdoc.json"] = 940,
    ["tsdrc.json"] = 941,
    ...
    ["vega-lite.json"] = 967,
    ["vega.json"] = 966,
    ["venvironment.yaml"] = 969,
    ["venvplus.yaml"] = 970,
    version = 1261,
    ["version.json"] = 972,
    ["vhwdebugger-binding.yaml"] = 974,
    ["vim-addon-info"] = 975,
    ["vs-2017.3.host.json"] = 977,
    ["vs-nesting.json"] = 978,
    ["vsls.json"] = 976,
    ["vss-extension.json"] = 982,
    vtcfg = 1267,
    ["vtesttree.yaml"] = 983,
    ["vtestunit.yaml"] = 984,
    ["warp-keysets.json"] = 1159,
    ["warp-themes.json"] = 1160,
    ["warp-workflows.json"] = 1161,
    ["webhint.io"] = 1115,
    ["webjobpublishsettings.json"] = 989,
    ["webjobs-list.json"] = 988,
    ["well-known-fursona"] = 1199,
    ["xs-app.json"] = 1017,
    ["xunit.runner.json"] = 1002,
    yamlfmt = 1044,
    yamllint = 1045,
    ["yap.json"] = 1046,
    ["zerops.yml"] = 1208,
