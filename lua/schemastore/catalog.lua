...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 154,
    [".cryproj (generic)"] = 520,
    [".cryproj engine-5.2"] = 515,
    [".cryproj engine-5.3"] = 516,
    [".cryproj engine-5.4"] = 517,
    [".cryproj engine-5.5"] = 518,
    [".cryproj engine-dev"] = 519,
    [".csscomb.json"] = 156,
    [".csslintrc"] = 157,
    [".eslintrc"] = 202,
    [".esmrc.json"] = 194,
    ...
    [".mtaext"] = 529,
    [".nodehawkrc"] = 329,
    [".npmpackagejsonlintrc"] = 332,
    [".phraseapp.yml"] = 367,
    [".pmbot.yml"] = 359,
    [".postcssrc"] = 364,
    [".pre-commit-config.yml"] = 365,
    [".pre-commit-hooks.yml"] = 366,
    [".putout.json"] = 384,
    [".rehyperc"] = 392,
    [".remarkrc"] = 393,
    [".sprite files"] = 439,
    ...
    [".vsext"] = 495,
    [".yarnrc.yml"] = 561,
    ["<div>RIOTS' studio configuration"] = 499,
    ["@factorial/drupal-breakpoints-css"] = 5,
    ["A micro editor config schema"] = 294,
    ["API Builder"] = 558,
    ["AVA Configuration Schema"] = 614,
    ["AWS CDK cdk.json"] = 142,
    ["AWS CloudFormation"] = 143,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 144,
    ["Airlock Microgateway"] = 9,
    ["Airplane task"] = 10,
    ["Alacritty Configuration Schema"] = 589,
    ["All Contributors configuration file"] = 641,
    ...
    ["Azure Pipelines"] = 48,
    ["Azure Static Web Apps CLI configuration file"] = 441,
    ["Azure Static Web Apps configuration file"] = 440,
    ["BX CI"] = 83,
    ["Better Code Hub"] = 563,
    ["Better Scripts"] = 84,
    BizTalkServerApplicationSchema = 535,
    ...
    ["Butane Config"] = 601,
    ["CICS TS region tagging"] = 608,
    ["CICS TS resource import"] = 609,
    ["CICS TS resource model"] = 610,
    ["CICS TS resource overrides"] = 611,
    ["CMake Presets"] = 85,
    ...
    Conjure = 93,
    ["Container Structure Test"] = 546,
    Containerlab = 571,
    ["DWP Exchange - catalogue entry"] = 191,
    ["DWP Exchange - gateway"] = 189,
    ["DWP Exchange - meta"] = 190,
    ["Dart build configuration"] = 158,
    ["Dart test config"] = 159,
    ["DashLord configuration"] = 160,
    ["Datadog Service Definition"] = 277,
    ["Datahub Ingestion Recipe Schema"] = 615,
    ["Dein Config Schema"] = 99,
    Deno = 164,
    ["Deployer Recipe"] = 167,
    Devfile = 188,
    ["Discord Webhook"] = 169,
    ["Dolittle Artifacts"] = 173,
    ["Dolittle Bounded Context Configuration"] = 174,
    ["Dolittle Event Horizons Configuration"] = 175,
    ["Dolittle Resources Configuration"] = 176,
    ["Dolittle Server Configuration"] = 177,
    ["Dolittle Tenant Map Configuration"] = 179,
    ["Dolittle Tenants Configuration"] = 178,
    ["Dolittle Topology"] = 180,
    ...
    ["Drush site aliases"] = 184,
    ["Embrace Config Schema"] = 626,
    ["Error pages"] = 197,
    Esquio = 195,
    ["Estuary Flow Catalog Schema"] = 605,
    ["Expo SDK"] = 200,
    ["F-Droid Data metadata"] = 205,
    ["Facets - FSDL - Application"] = 203,
    ["FasterCI Configuration"] = 49,
    ["Fossa configuration file"] = 210,
    ["Fossa's fossa-deps file"] = 211,
    ["Foundry VTT - Manifest"] = 208,
    ["Foundry VTT - Template"] = 209,
    ["Foxx Manifest"] = 50,
    ["Freifunk.de Community API"] = 53,
    ["Frogbot Config"] = 54,
    ["GatewayCore API Gateway"] = 214,
    ["GeoJSON.json latest"] = 603,
    GherKing = 607,
    ["GitHub Action"] = 218,
    ["GitHub Funding"] = 219,
    ["GitHub Issue Template configuration"] = 221,
    ["GitHub Workflow"] = 222,
    ["GitHub Workflow Template Properties"] = 223,
    ["GitHub issue forms"] = 220,
    GitVersion = 217,
    ["Gitpod Configuration"] = 225,
    ["Global Privacy Control"] = 215,
    ["Google Cloud Workflows"] = 141,
    Goreleaser = 228,
    ["Goreleaser Pro"] = 229,
    ["Gradle Build Cache Node"] = 560,
    ["Gradle Enterprise"] = 559,
    ["Grafana 5.x Dashboard"] = 230,
    ["GraphQL Code Generator"] = 233,
    ["GraphQL Config"] = 232,
    ["GraphQL Mesh"] = 231,
    ["Grunt JSHint task"] = 237,
    ["Grunt Watch task"] = 238,
    ["Grunt base task"] = 239,
    ["Grunt clean task"] = 235,
    ["Grunt copy task"] = 234,
    ["Grunt cssmin task"] = 236,
    HEMTT = 532,
    Hadolint = 544,
    Hammerkit = 570,
    ["Hardware Sentry Configuration"] = 619,
    Hayson = 241,
    ["Haystack Pipeline"] = 242,
    ["Hazelcast 5 Configuration"] = 243,
    ["Helm Chart.lock"] = 114,
    ["Helm Chart.yaml"] = 113,
    ["Helm Unittest Test Suite"] = 115,
    Hugo = 597,
    ["Istanbul Schema"] = 622,
    ["JDownloader2 crawler multi-rule schema"] = 260,
    ["JDownloader2 crawler single-rule schema"] = 259,
    ["JFrog File Spec"] = 261,
    ["JFrog Pipelines YML DSL"] = 628,
    ["JMeter DSL cli config schema"] = 262,
    ["JSON Document Transform"] = 270,
    ["JSON Feed"] = 271,
    ["JSON Resume"] = 398,
    ["JSON Schema Draft 2020-12"] = 511,
    ["JSON Schema Draft 4"] = 508,
    ["JSON Schema Draft 7"] = 509,
    ["JSON Schema Draft 8"] = 510,
    ...
    ["JSON-API"] = 269,
    ["JSON-e templates"] = 568,
    ["JSON-stat 2.0"] = 505,
    JSONPatch = 273,
    Jasmine = 255,
    Jekyll = 256,
    ["Jenkins X Pipelines"] = 257,
    ["Jenkins X Requirements"] = 258,
    ["Jovo Language Models"] = 263,
    ["KSP-AVC"] = 506,
    ["KSP-CKAN"] = 507,
    ["Keycloak REST API"] = 634,
    ["Knative Functions - func.yaml"] = 212,
    ["KoDE/CI build.yaml"] = 624,
    ["Kong DBLess Schema"] = 625,
    KrakenD = 276,
    ["LinkML Metamodel"] = 289,
    Liquibase = 575,
    ["Liquibase Flow File"] = 576,
    ["Lively Properties"] = 290,
    Markdownlint = 579,
    ["MegaLinter configuration"] = 295,
    ["MegaLinter descriptor"] = 296,
    ["Meltano plugin discovery definition"] = 298,
    ["Meltano project definition"] = 297,
    ["Microsoft Band Web Tile"] = 299,
    ["Minecraft Data Pack Advancement"] = 301,
    ["Minecraft Data Pack Biome"] = 302,
    ["Minecraft Data Pack Configured Carver"] = 303,
    ["Minecraft Data Pack Damage Type"] = 304,
    ["Minecraft Data Pack Dimension"] = 306,
    ["Minecraft Data Pack Dimension Type"] = 305,
    ["Minecraft Data Pack Item Modifier"] = 307,
    ["Minecraft Data Pack Loot Table"] = 308,
    ["Minecraft Data Pack Metadata"] = 309,
    ["Minecraft Data Pack Predicate"] = 310,
    ["Minecraft Data Pack Recipe"] = 311,
    ["Minecraft Data Pack Tag"] = 312,
    ["Minecraft Data Pack Template Pool"] = 313,
    ["Minecraft Resource Pack Lang"] = 314,
    ["Minecraft Resource Pack Particle"] = 315,
    ["Minecraft Resource Pack Texture Mcmeta"] = 317,
    ["Minecraft Resourcepack Sounds"] = 316,
    ["MkDocs Configuration 1.0"] = 318,
    ["MongoDB Atlas Search Index Definition Schema"] = 623,
    ["Monika Configuration Schema"] = 621,
    ["Motif config"] = 528,
    ["NOX Framework (Service)"] = 331,
    ["Netin Diagnostic System Template"] = 584,
    ["Netlify config schema"] = 323,
    ["Nightwatch.js"] = 324,
    ["OSS Review Toolkit configuration"] = 349,
    ["OSS Review Toolkit curation"] = 350,
    ["OSS Review Toolkit package configuration"] = 351,
    ["OSS Review Toolkit repository configuration"] = 352,
    ["OSS Review Toolkit resolutions"] = 353,
    Opctl = 531,
    ["OpenRewrite Resource"] = 344,
    ["OpenWeather Current Weather API"] = 567,
    ["OpenWeather Road Risk API"] = 566,
    ["Ory Hydra configuration"] = 247,
    ["Ory Keto configuration"] = 278,
    ["Ory Kratos configuration"] = 348,
    ["Ory Oathkeeper configuration"] = 338,
    ["Outblocks App configuration"] = 346,
    ["Outblocks database table"] = 347,
    ["Outblocks project configuration"] = 345,
    Packer = 356,
    Pantsbuild = 640,
    ["Pipeline component"] = 577,
    ["PocketMine plugin.yml"] = 360,
    Pterodactyl = 618,
    ["Pull Request Labeler"] = 383,
    Pulumi = 388,
    PyProject = 389,
    Qodana = 594,
    ["Quali Torque Blueprint Spec 2"] = 616,
    ["QueryFirst config file"] = 637,
    ["RKE Cluster Configuration JSON Schema"] = 574,
    ["RKE Cluster Configuration YAML Schema"] = 573,
    ["Rancher Fleet"] = 386,
    Ray = 543,
    ["Read the Docs"] = 387,
    ["Red-DiscordBot Cog"] = 390,
    ["Red-DiscordBot Cog Repo"] = 391,
    Renovate = 399,
    ["Replit schema"] = 394,
    RoadRunner = 400,
    Ruff = 396,
    ["Rust Project"] = 397,
    ["Rust toolchain"] = 402,
    ["SIL Kit Participant Configuration"] = 428,
    SWADL = 450,
    ["Sapphire CLI Config"] = 403,
    ["SauceCTL Configuration"] = 581,
    ["Schema Catalog"] = 416,
    ["Scoop manifest"] = 421,
    ["Semgrep Rule"] = 423,
    ["Serenity Code Generator (Sergen)"] = 424,
    ["Serverless Framework Configuration"] = 588,
    ["Serverless Workflow Schema"] = 590,
    ["Settings.paf"] = 426,
    ["Shopware 6 Configuration"] = 591,
    ["Shopware CLI Extension Store Configuration"] = 592,
    ["Shopware CLI Project Store Configuration"] = 593,
    ["Slack app manifest"] = 430,
    Solidarity = 433,
    ["Solution filters"] = 434,
    ["Source Maps v3"] = 435,
    Sourcery = 436,
    SpecIF = 437,
    ["Sponge Mixin configuration"] = 438,
    ["StackHawk Scanner Configuration"] = 587,
    Stale = 442,
    Starship = 443,
    ["Statamic Blueprint"] = 444,
    ["StrmPrivacy Data Connector"] = 632,
    ["StrmPrivacy Data Contract"] = 633,
    ["StrmPrivacy SimpleSchema"] = 630,
    ["StrmPrivacy Stream"] = 631,
    ["StrmPrivacy batch job configuration file"] = 629,
    ["Stryker Mutator"] = 447,
    ["StyleCop Analyzers Configuration"] = 448,
    ["Swagger API 2.0"] = 451,
    TSON = 473,
    ["Talisman configuration"] = 452,
    ["Taskfile YAML Schema"] = 569,
    Taurus = 453,
    ["TestEnvironment.json"] = 461,
    ["Tier.run pricing.json"] = 456,
    Tikibase = 457,
    ["Traefik v2"] = 464,
    ["Traefik v2 File Provider"] = 465,
    Turborepo = 462,
    Tye = 595,
    ["UI5 Manifest"] = 480,
    ["UTAM Page Object"] = 483,
    ["Ubuntu Server Autoinstall"] = 478,
    ["Uniswap Token List"] = 552,
    ["Unreal Engine Uplugin"] = 638,
    ["Unreal Engine Uproject"] = 639,
    Updatecli = 602,
    Uplift = 636,
    ["User Journey Map YAML Schema"] = 572,
    V2Ray = 606,
    ["VSCode Code Snippets"] = 130,
    ["VSIX CLI publishing"] = 496,
    ["Vela Pipeline Configuration"] = 486,
    Vercel = 129,
    ["Web App Manifest"] = 501,
    ["Web types"] = 504,
    WebExtensions = 500,
    ["Webman package recipe"] = 612,
    ["Windows Package Manager Installer Manifest"] = 549,
    ["Windows Package Manager Locale Manifest"] = 550,
    ["Windows Package Manager Singleton Manifest"] = 548,
    ["Woodpecker pipeline config"] = 583,
    ["Xstate Machine Schema"] = 600,
    ["Yippee-Ki-JSON configuration YML"] = 554,
    ["angular.json"] = 11,
    ...
    cspell = 155,
    ["cypress.json"] = 153,
    ["datalogic-scan2deploy-android"] = 161,
    ["datalogic-scan2deploy-ce"] = 162,
    ["dbt Project"] = 98,
    ["debugsettings.json"] = 163,
    ["dependabot-v2.json"] = 166,
    ["dependabot.json"] = 165,
    ["deployed-cli"] = 599,
    ["detekt.yml"] = 168,
    ...
    ["devspace.yaml"] = 620,
    ["docfx.json"] = 172,
    ["docker-compose.yml"] = 555,
    ["docker-seq schema"] = 171,
    ["dockerd.json"] = 170,
    ["dotnet Release Index manifest"] = 181,
    ["dotnetcli.host.json"] = 182,
    ["drone.json"] = 183,
    ["dss-2.0.0.json"] = 185,
    ["dstack Workflows"] = 186,
    ["dvc.yaml"] = 187,
    ["ecosystem.json"] = 192,
    eksctl = 193,
    ["electron-builder configuration file."] = 198,
    ["epr-manifest.json"] = 196,
    ["evcc.yaml"] = 199,
    ["ezd schema"] = 201,
    ["fabric.mod.json"] = 204,
    ["first-timers-bot"] = 207,
    ...
    ["gitlab-ci"] = 224,
    ["global.json"] = 226,
    ["golangci-lint Configuration"] = 227,
    ["haxelib.json"] = 240,
    helmfile = 545,
    ["host-meta.json"] = 245,
    ["host.json"] = 244,
    ...
    ["ide.host.json"] = 248,
    ["ifstate.conf"] = 249,
    ["imageoptimizer.json"] = 250,
    ["importmap.json"] = 252,
    ["ioBroker JSON UI"] = 253,
    ["ioBroker Package manifest"] = 254,
    ["ize.toml"] = 635,
    ["jsconfig.json"] = 274,
    ["jscpd Configuration Schema"] = 617,
    jsdoc = 542,
    ["k3d.yaml"] = 275,
    ["kontinuous-values.yaml"] = 279,
    ["kustomization.yaml"] = 280,
    ["label-commenter-config.yml"] = 281,
    ["launchsettings.json"] = 282,
    ["lego.json"] = 283,
    ["lerna.json"] = 284,
    ["lgtm.yml"] = 285,
    ["libman.json"] = 286,
    ["license-report-config.json"] = 287,
    ["linkinator.config.json"] = 288,
    ["local.settings.json"] = 291,
    ["localazy.json"] = 292,
    ["lsdlschema.json"] = 293,
    ["markdown-lint-check"] = 580,
    mboats = 586,
    ["mimetypes.json"] = 300,
    ["mirrord-schema"] = 525,
    ["mta.yaml"] = 526,
    ["mtad.yaml"] = 527,
    ["mycode.json"] = 321,
    ["napari plugin manifest"] = 322,
    neoload = 537,
    ["nest-cli"] = 327,
    ["ninjs (News in JSON) 1.3"] = 326,
    ["ninjs (News in JSON) 2.0"] = 325,
    ["nlu.json"] = 328,
    ["nodemon.json"] = 330,
    ["noodl.schema.json"] = 585,
    now = 533,
    ["npm-badges"] = 333,
    ["nswag.json"] = 336,
    ntangle = 337,
    ["nuclei-template.yaml"] = 334,
    ["nuget-project.json"] = 335,
    ["ocelot.json"] = 339,
    ["omnisharp.json"] = 340,
    ["openapi.json"] = 341,
    ["openfin.json"] = 343,
    ["openrpc.json"] = 342,
    ["package.json"] = 354,
    ["package.manifest"] = 355,
    ["pattern.json"] = 358,
    ["petstore-v1.0"] = 627,
    pgap_yaml_input_reader = 357,
    ["plagiarize-me.yaml"] = 362,
    ["plagiarize.yaml"] = 361,
    ["portman.json"] = 363,
    ["prettierrc.json"] = 368,
    ["prisma.yml"] = 369,
    ["project-1.0.0-beta3.json"] = 371,
    ["project-1.0.0-beta4.json"] = 372,
    ["project-1.0.0-beta5.json"] = 373,
    ["project-1.0.0-beta6.json"] = 374,
    ["project-1.0.0-beta8.json"] = 375,
    ["project-1.0.0-rc1.json"] = 376,
    ["project-1.0.0-rc2.json"] = 377,
    ["project.json"] = 370,
    ["prometheus.json"] = 378,
    ["prometheus.rules.json"] = 379,
    ["proxies.json"] = 380,
    ["publiccode.yml"] = 381,
    ["pubspec.yaml"] = 382,
    ["pyrseas-0.8.json"] = 385,
    ["release drafter"] = 538,
    rustfmt = 401,
    ["sarif-1.0.0.json"] = 404,
    ["sarif-2.0.0.json"] = 405,
    ["sarif-2.1.0"] = 414,
    ["sarif-2.1.0-rtm.2"] = 406,
    ["sarif-2.1.0-rtm.3"] = 408,
    ["sarif-2.1.0-rtm.4"] = 410,
    ["sarif-2.1.0-rtm.5"] = 412,
    ["sarif-external-property-file-2.1.0"] = 415,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 407,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 409,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 411,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 413,
    ["schema.org - Action"] = 417,
    ["schema.org - ContactPoint"] = 418,
    ["schema.org - Place"] = 419,
    ["schema.org - Thing"] = 420,
    ["semantic-release"] = 422,
    ["servicehub.config.json"] = 514,
    ["servicehub.service.json"] = 513,
    ["settings.job"] = 425,
    ["sfdx-hardis configuration"] = 427,
    ["size-limit configuration"] = 429,
    ["skaffold.yaml"] = 578,
    ["skyuxconfig.json"] = 431,
    snapcraft = 432,
    ["stripe-app-local.json"] = 446,
    ["stripe-app.json"] = 445,
    swcrc = 565,
    taskcat = 534,
    ["template.json"] = 454,
    ["templatsources.json"] = 455,
    ["theme.json"] = 458,
    ["tizen_workspace.json"] = 459,
    tmLanguage = 460,
    tmuxinator = 522,
    ["transcend.yml"] = 466,
    ["trunk.yaml schema"] = 467,
    ["ts-force-config.json"] = 471,
    ["tsconfig.json"] = 468,
    ["tsd.json"] = 469,
    ["tsdrc.json"] = 470,
    ["tslint.json"] = 472,
    ...
    ["vega-lite.json"] = 485,
    ["vega.json"] = 484,
    ["venvironment-basic.yaml"] = 488,
    ["venvironment.yaml"] = 487,
    ["version.json"] = 489,
    ["vim-addon-info"] = 490,
    ["vs-2017.3.host.json"] = 492,
    ["vs-nesting.json"] = 493,
    ["vsls.json"] = 491,
    ["vss-extension.json"] = 497,
    ["webhint.io"] = 613,
    ["webjobpublishsettings.json"] = 503,
    ["webjobs-list.json"] = 502,
    ["xs-app.json"] = 530,
    ["xunit.runner.json"] = 512,
    yamllint = 553,
    zuul = 539,
    ["Žinoma"] = 547
  },
