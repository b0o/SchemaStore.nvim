...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 181,
    [".cryproj (generic)"] = 625,
    [".cryproj engine-5.2"] = 620,
    [".cryproj engine-5.3"] = 621,
    [".cryproj engine-5.4"] = 622,
    [".cryproj engine-5.5"] = 623,
    [".cryproj engine-dev"] = 624,
    [".csscomb.json"] = 183,
    [".csslintrc"] = 184,
    [".es6importsorterrc.json"] = 757,
    [".eslintrc"] = 233,
    [".esmrc.json"] = 225,
    [".ffizer.yaml"] = 237,
    [".htmlhintrc"] = 290,
    ...
    [".mtaext"] = 634,
    [".nodehawkrc"] = 394,
    [".npmpackagejsonlintrc"] = 397,
    [".phraseapp.yml"] = 444,
    [".pmbot.yml"] = 433,
    [".postcssrc"] = 439,
    [".powerpages-web-template-manifest"] = 441,
    [".pre-commit-config.yml"] = 442,
    [".pre-commit-hooks.yml"] = 443,
    [".putout.json"] = 463,
    [".rehyperc"] = 475,
    [".remarkrc"] = 477,
    [".sprite files"] = 533,
    ...
    ["<div>RIOTS' studio configuration"] = 604,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 352,
    ["API Builder"] = 666,
    ["AVA Configuration"] = 726,
    ["AWS CDK cdk.json"] = 165,
    ["AWS CloudFormation"] = 166,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 167,
    ["AWS SAM CLI Samconfig"] = 168,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 13,
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 698,
    ["All Contributors configuration file"] = 756,
    ...
    ["Azure Pipelines"] = 60,
    ["Azure Static Web Apps CLI configuration file"] = 536,
    ["Azure Static Web Apps configuration file"] = 535,
    ["BX CI"] = 96,
    ["Better Code Hub"] = 670,
    ["Better Scripts"] = 97,
    Bigconfig = 77,
    BizTalkServerApplicationSchema = 640,
    Bleep = 98,
    ["Block Protocol Metadata"] = 95,
    Briefcase = 645,
    ["Build Info"] = 88,
    Buildkite = 90,
    ["Bukkit plugin.yml"] = 89,
    ["BungeeCord plugin.yml"] = 93,
    ["Butane Config"] = 711,
    ["CICS TS region tagging"] = 720,
    ["CICS TS resource import"] = 721,
    ["CICS TS resource model"] = 722,
    ["CICS TS resource overrides"] = 723,
    ["CMake Presets"] = 99,
    ["CNC Codes"] = 109,
    ["Calqulus pipeline"] = 100,
    ["Camel YAML DSL"] = 101,
    Carafe = 102,
    ["Cargo Make"] = 104,
    ["Cargo Manifest"] = 103,
    ["Catalog Info Backstage"] = 105,
    Cheatsheets = 708,
    ["Chrome Extension"] = 158,
    ["CircleCI config.yml"] = 135,
    ["Citation File Format"] = 170,
    CityJSON = 107,
    ["Code Climate"] = 136,
    CodeCV = 58,
    ["CodeShip Pro services configuration files"] = 147,
    ["CodeShip Pro steps configuration files"] = 148,
    ["Codecov configuration files"] = 146,
    Codux = 144,
    ["Cog config file"] = 110,
    ["Commandbox Box.json"] = 111,
    ["Commandbox Server.json"] = 112,
    ["Common Catalog Data"] = 156,
    ["Common types for all schemas"] = 1,
    Conjure = 108,
    ["Container Structure Test"] = 653,
    Containerlab = 678,
    ["Crowdsec collection config"] = 177,
    ["Crowdsec parser config"] = 178,
    ["Crowdsec scenario config"] = 179,
    ["CumulusCI Config"] = 113,
    ["DWP Exchange - catalogue entry"] = 222,
    ["DWP Exchange - gateway"] = 220,
    ["DWP Exchange - meta"] = 221,
    ["Dart build configuration"] = 185,
    ["Dart test config"] = 186,
    ["DashLord configuration"] = 187,
    ["Data Contract Specification"] = 188,
    ["Databricks Asset Bundles"] = 777,
    ["Datadog Service Definition"] = 330,
    ["Datahub Ingestion Recipe"] = 727,
    ["Dein Config"] = 115,
    Deno = 194,
    ["Deployer Recipe"] = 197,
    ["Deta Spacefile"] = 116,
    ...
    Devfile = 219,
    ["Discord Webhook"] = 199,
    ["Dolittle Artifacts"] = 203,
    ["Dolittle Bounded Context Configuration"] = 204,
    ["Dolittle Event Horizons Configuration"] = 205,
    ["Dolittle Resources Configuration"] = 206,
    ["Dolittle Server Configuration"] = 207,
    ["Dolittle Tenant Map Configuration"] = 209,
    ["Dolittle Tenants Configuration"] = 208,
    ["Dolittle Topology"] = 210,
    ["Drupal Breakpoints"] = 119,
    ["Drupal Config"] = 130,
    ["Drupal Info"] = 120,
    ["Drupal Layouts"] = 121,
    ["Drupal Libraries"] = 122,
    ["Drupal Links Action"] = 123,
    ["Drupal Links Contextual"] = 124,
    ["Drupal Links Menu"] = 125,
    ["Drupal Links Task"] = 126,
    ["Drupal Migration"] = 127,
    ["Drupal Permissions"] = 128,
    ["Drupal Routing"] = 129,
    ["Drupal Services"] = 131,
    ["Drush site aliases"] = 215,
    ["Embrace Config"] = 738,
    Endurica = 780,
    ["Error pages"] = 228,
    Esquio = 226,
    ["Estuary Flow Catalog"] = 717,
    ["Expo SDK"] = 231,
    ["F-Droid Data metadata"] = 236,
    ["Facets - FSDL - Application"] = 234,
    ["FasterCI Configuration"] = 61,
    FiQuS = 240,
    Firebase = 238,
    ["Fossa configuration file"] = 247,
    ["Fossa's fossa-deps file"] = 248,
    ["Foundry VTT - Base package Manifest"] = 242,
    ["Foundry VTT - Module Manifest"] = 243,
    ["Foundry VTT - System Data Template"] = 246,
    ["Foundry VTT - System Manifest"] = 244,
    ["Foundry VTT - World Manifest"] = 245,
    ["Foxx Manifest"] = 62,
    ["Freifunk.de Community API"] = 65,
    ["Frogbot Config"] = 66,
    ["G2P Mapping Configuration"] = 252,
    ["GCP Blueprint Metadata"] = 255,
    Gaspar = 253,
    ["GatewayCore API Gateway"] = 254,
    ["GeoJSON.json latest"] = 715,
    GherKing = 719,
    ["GitHub Action"] = 259,
    ["GitHub Discussion"] = 260,
    ["GitHub Funding"] = 261,
    ["GitHub Issue Template configuration"] = 263,
    ["GitHub Workflow"] = 264,
    ["GitHub Workflow Template Properties"] = 265,
    ["GitHub issue forms"] = 262,
    GitVersion = 258,
    ["Gitpod Configuration"] = 267,
    ["Global Privacy Control"] = 256,
    Goblet = 776,
    ["Google Chrome Related Website Sets"] = 239,
    ["Google Cloud Workflows"] = 164,
    Goreleaser = 271,
    ["Goreleaser Pro"] = 272,
    Goss = 273,
    ["Gradle Build Cache Node"] = 668,
    ["Gradle Enterprise"] = 667,
    ["Grafana 5.x Dashboard"] = 274,
    ["GraphQL Code Generator"] = 277,
    ["GraphQL Config"] = 276,
    ["GraphQL Mesh"] = 275,
    ["Grunt JSHint task"] = 281,
    ["Grunt Watch task"] = 282,
    ["Grunt base task"] = 283,
    ["Grunt clean task"] = 279,
    ["Grunt copy task"] = 278,
    ["Grunt cssmin task"] = 280,
    HEMTT = 637,
    Hadolint = 649,
    Hammerkit = 677,
    ["Hardware Sentry Configuration"] = 731,
    Hatch = 650,
    Hayson = 285,
    ["Haystack Pipeline"] = 286,
    ["Hazelcast 5 Configuration"] = 287,
    ["Helm Chart.lock"] = 133,
    ["Helm Chart.yaml"] = 132,
    ["Helm Unittest Test Suite"] = 134,
    Hugo = 707,
    ["Hugo Theme"] = 706,
    ["IBM Zapp document"] = 292,
    ["IBM zCodeFormatSettings"] = 293,
    ["IMG Catapult PSP"] = 298,
    Istanbul = 734,
    ["JDownloader2 crawler multi-rules"] = 308,
    ["JDownloader2 crawler single-rules"] = 307,
    ["JFrog Applications Config"] = 309,
    ["JFrog File Spec"] = 310,
    ["JFrog Pipelines YML DSL"] = 740,
    ["JMeter DSL cli config"] = 311,
    JReleaser = 313,
    ["JSON Document Transform"] = 320,
    ["JSON Feed"] = 321,
    ["JSON Resume"] = 483,
    ["JSON Schema Draft 2020-12"] = 616,
    ["JSON Schema Draft 4"] = 613,
    ["JSON Schema Draft 7"] = 614,
    ["JSON Schema Draft 7 (unofficial strict)"] = 778,
    ["JSON Schema Draft 8 (2019-09)"] = 615,
    ["JSON-API"] = 319,
    ["JSON-e templates"] = 675,
    ["JSON-stat 2.0"] = 610,
    JSONPatch = 323,
    Jasmine = 303,
    Jekyll = 304,
    ["Jenkins X Pipelines"] = 305,
    ["Jenkins X Requirements"] = 306,
    ["Jovo Language Models"] = 312,
    ["KIMMDY config file"] = 328,
    ["KSP-AVC"] = 611,
    ["KSP-CKAN"] = 612,
    ["Karakum configuration file"] = 249,
    Kas = 326,
    ["Keycloak REST API"] = 748,
    ["Knative Functions - func.yaml"] = 250,
    ["KoDE/CI build.yaml"] = 736,
    ["Kong DBLess config"] = 737,
    KrakenD = 329,
    LOOBin = 347,
    Lefthook = 337,
    ["Liferay client-extension.yaml"] = 343,
    ["LinkML Metamodel"] = 345,
    Liquibase = 682,
    ["Liquibase Flow File"] = 683,
    ["Lively Properties"] = 346,
    ["Lobe AI Agent"] = 59,
    ["MLOS Configs"] = 379,
    ["MS2Rescore Configuration"] = 381,
    Markdownlint = 686,
    ["Mason Registry"] = 688,
    ["MegaLinter configuration"] = 353,
    ["MegaLinter descriptor"] = 354,
    Melange = 784,
    ["Meltano plugin discovery definition"] = 356,
    ["Meltano project definition"] = 355,
    ["Microsoft Band Web Tile"] = 357,
    ["Minecraft Custom Main Menu Mod"] = 785,
    ["Minecraft Data Pack Advancement"] = 359,
    ["Minecraft Data Pack Biome"] = 360,
    ["Minecraft Data Pack Configured Carver"] = 361,
    ["Minecraft Data Pack Damage Type"] = 362,
    ["Minecraft Data Pack Dimension"] = 364,
    ["Minecraft Data Pack Dimension Type"] = 363,
    ["Minecraft Data Pack Item Modifier"] = 365,
    ["Minecraft Data Pack Loot Table"] = 366,
    ["Minecraft Data Pack Metadata"] = 367,
    ["Minecraft Data Pack Predicate"] = 368,
    ["Minecraft Data Pack Recipe"] = 369,
    ["Minecraft Data Pack Tag"] = 370,
    ["Minecraft Data Pack Template Pool"] = 371,
    ["Minecraft Data Pack Trim Material"] = 376,
    ["Minecraft Data Pack Trim Pattern"] = 377,
    ["Minecraft Resource Pack Lang"] = 372,
    ["Minecraft Resource Pack Particle"] = 373,
    ["Minecraft Resource Pack Texture Mcmeta"] = 375,
    ["Minecraft Resourcepack Sounds"] = 374,
    ["MkDocs Configuration 1.0"] = 378,
    ["MongoDB Atlas Search Index Definition"] = 735,
    ["Monika Configuration"] = 733,
    ["Motif config"] = 633,
    ["NOX Framework (Service)"] = 396,
    ["Netin Diagnostic System Template"] = 692,
    ["Netlify config"] = 387,
    ["Network-as-Code Data Model"] = 388,
    ["Nightwatch.js"] = 389,
    ["ONe's changelog entry"] = 412,
    ["ONe's service descriptor"] = 411,
    ["OSS Review Toolkit configuration"] = 419,
    ["OSS Review Toolkit curation"] = 420,
    ["OSS Review Toolkit package configuration"] = 421,
    ["OSS Review Toolkit repository configuration"] = 422,
    ["OSS Review Toolkit resolutions"] = 423,
    Opctl = 636,
    ["OpenRewrite Resource"] = 414,
    ["OpenUtau character yaml"] = 408,
    ["OpenUtau ustx"] = 409,
    ["OpenWeather Current Weather API"] = 674,
    ["OpenWeather Road Risk API"] = 673,
    ["Ory Hydra configuration"] = 291,
    ["Ory Keto configuration"] = 331,
    ["Ory Kratos configuration"] = 418,
    ["Ory Oathkeeper configuration"] = 403,
    ["Outblocks App configuration"] = 416,
    ["Outblocks database table"] = 417,
    ["Outblocks project configuration"] = 415,
    PDM = 429,
    ["PDM Partial"] = 430,
    Packer = 426,
    Pantsbuild = 755,
    ["Paper paper-plugin.yml"] = 427,
    ["Pipeline component"] = 684,
    ["PocketMine plugin.yml"] = 434,
    Poetry = 435,
    ["Postman collection"] = 440,
    ["Problem object RFC9457"] = 782,
    ["Problem package generators"] = 447,
    Pterodactyl = 730,
    ["Pull Request Labeler"] = 462,
    Pulumi = 468,
    PyProject = 469,
    Pyright = 470,
    Qgoda = 471,
    Qodana = 703,
    ["Quali Torque Blueprint Spec 2"] = 728,
    ["QueryFirst config file"] = 751,
    ["RKE Cluster Configuration JSON"] = 681,
    ["RKE Cluster Configuration YAML"] = 680,
    ["Rancher Fleet"] = 465,
    Ray = 648,
    ["Read the Docs"] = 467,
    ["Red-DiscordBot Cog"] = 472,
    ["Red-DiscordBot Cog Repo"] = 473,
    ["Red-DiscordBot Trivia"] = 474,
    RenderCV = 485,
    Renovate = 484,
    ["Replit config"] = 478,
    RoadRunner = 486,
    ...
    ["Rust Project"] = 482,
    ["Rust toolchain"] = 488,
    ["SIL Kit Participant Configuration"] = 521,
    ["SIL Kit Registry Configuration"] = 522,
    SWADL = 547,
    ["Safebox Config"] = 741,
    ["Sapphire CLI Config"] = 491,
    ["SauceCTL Configuration"] = 689,
    ["Schema Catalog"] = 505,
    ["Scoop manifest"] = 510,
    ["Semantic Data Fabric (SDF) file"] = 511,
    ["Semgrep Rule"] = 513,
    ["Serenity Code Generator (Sergen)"] = 514,
    ["Serverless Framework Configuration"] = 697,
    ["Serverless Workflow"] = 699,
    ["Settings.paf"] = 516,
    Setuptools = 517,
    ["Shopware 6 Configuration"] = 700,
    ["Shopware CLI Extension Store Configuration"] = 701,
    ["Shopware CLI Project Store Configuration"] = 702,
    Sigma = 519,
    ["Sigrid scope configuration file"] = 520,
    ["Slack app manifest"] = 524,
    Solidarity = 527,
    ["Solution filters"] = 528,
    ["Source Maps v3"] = 529,
    Sourcery = 530,
    SpecIF = 531,
    ["Sponge Mixin configuration"] = 532,
    StackBlitz = 537,
    ["StackHawk Scanner Configuration"] = 696,
    Stale = 538,
    ["Starlake Data Pipeline"] = 671,
    Starship = 539,
    ["Statamic Blueprint"] = 540,
    ["Stella configuration file"] = 541,
    ["StrmPrivacy Data Connector"] = 745,
    ["StrmPrivacy Data Contract"] = 746,
    ["StrmPrivacy SimpleSchema"] = 743,
    ["StrmPrivacy Stream"] = 744,
    ["StrmPrivacy batch job configuration file"] = 742,
    ["Stryker Mutator"] = 544,
    ["StyleCop Analyzers Configuration"] = 545,
    ["Sublime Syntax"] = 747,
    ["Swagger API 2.0"] = 548,
    TSON = 573,
    TSTyche = 574,
    Talhelper = 550,
    ["Talisman configuration"] = 551,
    ["Taskfile config"] = 676,
    Taurus = 552,
    ["TestEnvironment.json"] = 561,
    ["TextMate Grammar"] = 560,
    ["Tier.run pricing.json"] = 555,
    Tikibase = 556,
    ["Traefik v2"] = 564,
    ["Traefik v2 File Provider"] = 565,
    TunnelHub = 781,
    Turborepo = 562,
    Tye = 704,
    ["UET BuildConfig.json"] = 752,
    ["UI5 Manifest"] = 582,
    ["UNCORS configuration"] = 586,
    ["UTAM Page Object"] = 585,
    ["Ubuntu Server Autoinstall"] = 580,
    ["Uniswap Token List"] = 659,
    ["Unreal Engine Uplugin"] = 753,
    ["Unreal Engine Uproject"] = 754,
    ["Updatecli Compose"] = 712,
    ["Updatecli Policy Manifest"] = 713,
    ["Updatecli Policy Metadata"] = 714,
    Uplift = 750,
    ["User Journey Map"] = 679,
    V2Ray = 718,
    ["VSCode Code Snippets"] = 152,
    ["VSIX CLI publishing"] = 599,
    ["Vela Pipeline Configuration"] = 589,
    Vercel = 151,
    Visivo = 779,
    ["Web App Manifest"] = 606,
    ["Web types"] = 609,
    WebExtensions = 605,
    ["Webman package recipe"] = 724,
    ["Windows Package Manager Installer Manifest"] = 656,
    ["Windows Package Manager Locale Manifest"] = 657,
    ["Windows Package Manager Singleton Manifest"] = 655,
    ["Woodpecker pipeline config"] = 691,
    ["Xstate Machine"] = 710,
    ["Yippee-Ki-JSON configuration YML"] = 661,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    apko = 783,
    ...
    ["bamboo-spec"] = 71,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 761,
    ["bashly-strings.yml"] = 762,
    ["bashly.yml"] = 760,
    ["batect.yml"] = 70,
    ...
    ["bozr.suite.json"] = 85,
    bpkg = 763,
    ["browser.i18n.json"] = 86,
    bucklescript = 87,
    ["buf.gen.yaml"] = 55,
    ["buf.plugin.yaml"] = 56,
    ["buf.work.yaml"] = 57,
    ["buf.yaml"] = 54,
    ["bundleconfig.json"] = 92,
    ["chisel-slices.json"] = 169,
    ["chrome-extension-locales-messages.json"] = 159,
    ["chutzpah.json"] = 160,
    cibuildwheel = 106,
    clangd = 139,
    clib = 140,
    ["cloud-init: cloud-config userdata"] = 142,
    ["cloud-sdk-pipeline-configuration"] = 162,
    ["cloudbuild.json"] = 163,
    cloudify = 141,
    codemagic = 143,
    ["coffeelint.json"] = 171,
    ["commands.json"] = 155,
    ["compile_commands.json"] = 154,
    ["compilerconfig.json"] = 153,
    ["completely.yml"] = 758,
    ["component-detection-manifest.json"] = 174,
    ["component.json"] = 173,
    ["composer.json"] = 172,
    ["config.yaml"] = 466,
    ["contentmanifest.json"] = 161,
    ["contribute.json"] = 175,
    ["cosmos.config.json"] = 157,
    ["crowdin.yml"] = 176,
    cspell = 182,
    ["custom-elements.json"] = 772,
    ["cypress.json"] = 180,
    ["datalogic-scan2deploy-android"] = 189,
    ["datalogic-scan2deploy-ce"] = 190,
    ["dbt Project"] = 114,
    ["ddev-global"] = 191,
    ["ddev-project"] = 192,
    ["debugsettings.json"] = 193,
    ["dependabot-v2.json"] = 196,
    ["dependabot.json"] = 195,
    ["deployed-cli"] = 709,
    ["detekt.yml"] = 198,
    ["devcontainer.json"] = 145,
    devinit = 663,
    ["devspace.yaml"] = 732,
    djlint = 664,
    ["docfx.json"] = 202,
    ["docker sequencer"] = 201,
    ["docker-compose.yml"] = 662,
    ["dockerd.json"] = 200,
    ["dotnet Release Index manifest"] = 211,
    ["dotnetcli.host.json"] = 212,
    ["dprint.json"] = 213,
    ["drone.json"] = 214,
    ["dss-2.0.0.json"] = 216,
    ["dstack configuration"] = 217,
    ["dvc.yaml"] = 218,
    ["ecosystem.json"] = 223,
    eksctl = 224,
    ["electron-builder configuration file"] = 229,
    ["epr-manifest.json"] = 227,
    ["evcc.yaml"] = 230,
    ["ezd task runner"] = 232,
    ["fabric.mod.json"] = 235,
    ["first-timers-bot"] = 241,
    ...
    ["gitlab-ci"] = 266,
    ["global.json"] = 268,
    ["go-feature-flag Flag Configuration"] = 270,
    ["golangci-lint Configuration"] = 269,
    ["haxelib.json"] = 284,
    helmfile = 651,
    helmwave = 652,
    ["host-meta.json"] = 289,
    ...
    ["ide.host.json"] = 294,
    ["ifstate.conf"] = 295,
    ["imageoptimizer.json"] = 296,
    ["importmap.json"] = 299,
    ["ioBroker Configuration"] = 300,
    ["ioBroker JSON UI"] = 301,
    ["ioBroker Package manifest"] = 302,
    ["ize.toml"] = 749,
    ["jsconfig.json"] = 324,
    ["jscpd Configuration"] = 729,
    jsdoc = 647,
    ["k3d.yaml"] = 325,
    ["k9s plugin.yml"] = 327,
    ["kontinuous-config.yaml"] = 333,
    ["kontinuous-values.yaml"] = 332,
    ["kustomization.yaml"] = 334,
    ["label-commenter-config.yml"] = 335,
    ["launchsettings.json"] = 336,
    lazydocker = 771,
    lazygit = 770,
    ["lego.json"] = 338,
    ["lerna.json"] = 339,
    ["lgtm.yml"] = 340,
    ["libman.json"] = 341,
    ["license-report-config.json"] = 342,
    ["linkinator.config.json"] = 344,
    ["local.settings.json"] = 349,
    ["localazy.json"] = 350,
    ["lotus.yaml"] = 348,
    ["lsdlschema.json"] = 351,
    ["madness.yml"] = 759,
    ["markdown-lint-check"] = 687,
    mboats = 694,
    ["micro-settings.json"] = 764,
    ["mimetypes.json"] = 358,
    ["mirrord config"] = 630,
    ["monospace.yml"] = 380,
    ["mta.yaml"] = 631,
    ...
    ["mycode.json"] = 384,
    mypy = 385,
    ["napari plugin manifest"] = 386,
    neoload = 642,
    ["nest-cli"] = 392,
    ["ninjs (News in JSON) 1.3"] = 391,
    ["ninjs (News in JSON) 2.0"] = 390,
    ["nlu.json"] = 393,
    ["nodemon.json"] = 395,
    ["noodl config"] = 693,
    now = 638,
    ...
    ["nswag.json"] = 401,
    ntangle = 402,
    ["nuclei-template.yaml"] = 399,
    ["nuget-project.json"] = 400,
    ["ocelot.json"] = 404,
    ["omnisharp.json"] = 405,
    ["openapi.json"] = 406,
    ["openfin.json"] = 413,
    ...
    ["ops.yaml"] = 410,
    ["package.json"] = 424,
    ["package.manifest"] = 425,
    ["pathfinder.yml"] = 428,
    ["pattern.json"] = 432,
    ["petstore-v1.0"] = 739,
    pgap_yaml_input_reader = 431,
    ["plagiarize-me.yaml"] = 437,
    ["plagiarize.yaml"] = 436,
    ["portman.json"] = 438,
    ["prettierrc.json"] = 445,
    ["prisma.yml"] = 446,
    ["project-1.0.0-beta3.json"] = 449,
    ["project-1.0.0-beta4.json"] = 450,
    ["project-1.0.0-beta5.json"] = 451,
    ["project-1.0.0-beta6.json"] = 452,
    ["project-1.0.0-beta8.json"] = 453,
    ["project-1.0.0-rc1.json"] = 454,
    ["project-1.0.0-rc2.json"] = 455,
    ["project.json"] = 448,
    ["prometheus.json"] = 456,
    ["prometheus.rules.json"] = 457,
    ["prometheus.rules.test.json"] = 458,
    ["proxies.json"] = 459,
    ["publiccode.yml"] = 460,
    ["pubspec.yaml"] = 461,
    ["pyrseas-0.8.json"] = 464,
    ["quilt.mod.json"] = 765,
    ["release drafter"] = 643,
    ["release-plz.toml"] = 476,
    rtx = 480,
    rustfmt = 487,
    samt = 489,
    samtrc = 490,
    ["sarif-1.0.0.json"] = 492,
    ["sarif-2.0.0.json"] = 493,
    ["sarif-2.1.0"] = 503,
    ["sarif-2.1.0-rtm.2"] = 494,
    ["sarif-2.1.0-rtm.3"] = 496,
    ["sarif-2.1.0-rtm.4"] = 498,
    ["sarif-2.1.0-rtm.5"] = 500,
    ["sarif-2.1.0-rtm.6"] = 501,
    ["sarif-external-property-file-2.1.0"] = 504,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 495,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 497,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 499,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 502,
    ["schema.org - Action"] = 506,
    ["schema.org - ContactPoint"] = 507,
    ["schema.org - Place"] = 508,
    ["schema.org - Thing"] = 509,
    ["scikit-build"] = 695,
    ["secrethub.yml"] = 767,
    ["semantic-release"] = 512,
    ["servicehub.config.json"] = 619,
    ["servicehub.service.json"] = 618,
    ["settings.job"] = 515,
    ["sfdx-hardis configuration"] = 518,
    ["size-limit configuration"] = 523,
    ["skaffold.yaml"] = 685,
    ["skyuxconfig.json"] = 525,
    snapcraft = 526,
    ["sqlc configuration"] = 534,
    ["stripe-app-local.json"] = 543,
    ["stripe-app.json"] = 542,
    swcrc = 672,
    syntax = 769,
    ["task.json"] = 549,
    taskcat = 639,
    ["template.json"] = 553,
    ["templatsources.json"] = 554,
    ["theme.json"] = 557,
    ["tizen_workspace.json"] = 558,
    tldr = 559,
    tmuxinator = 627,
    ["transcend.yml"] = 566,
    ["trunk.yaml"] = 567,
    ["ts-force-config.json"] = 571,
    ["tsconfig.json"] = 568,
    ["tsd.json"] = 569,
    ["tsdrc.json"] = 570,
    ["tslint.json"] = 572,
    ...
    ["typingsrc.json"] = 579,
    ["typo3.json"] = 577,
    ["ui5-workspace.yaml"] = 584,
    ["ui5.yaml"] = 583,
    unist = 705,
    ["up.json"] = 581,
    v8r = 603,
    ["vcpkg configuration file"] = 150,
    ["vcpkg manifest file"] = 149,
    ["vega-lite.json"] = 588,
    ["vega.json"] = 587,
    ["venvironment-basic.yaml"] = 591,
    ["venvironment.yaml"] = 590,
    ["version.json"] = 592,
    ["vim-addon-info"] = 593,
    ["vs-2017.3.host.json"] = 595,
    ["vs-nesting.json"] = 596,
    ["vsls.json"] = 594,
    ["vss-extension.json"] = 600,
    ["vtesttree.yaml"] = 601,
    ["vtestunit.yaml"] = 602,
    ["warp-keysets.json"] = 773,
    ["warp-themes.json"] = 774,
    ["warp-workflows.json"] = 775,
    ["webhint.io"] = 725,
    ["webjobpublishsettings.json"] = 608,
    ["webjobs-list.json"] = 607,
    ["xs-app.json"] = 635,
    ["xunit.runner.json"] = 617,
    yamllint = 660,
    zuul = 644,
    ["Žinoma"] = 654
  },
