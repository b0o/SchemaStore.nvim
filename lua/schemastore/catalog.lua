...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1103,
    [".nodehawkrc"] = 709,
    [".npmpackagejsonlintrc"] = 714,
    [".omletrc"] = 1284,
    [".phrase.yml"] = 796,
    [".phraseapp.yml"] = 797,
    [".pmbot.yml"] = 781,
    [".postcssrc"] = 790,
    [".powerpages-web-template-manifest"] = 792,
    [".pre-commit-config.yml"] = 793,
    [".pre-commit-hooks.yml"] = 794,
    [".putout.json"] = 830,
    [".rehyperc"] = 855,
    [".remarkrc"] = 859,
    [".sprite files"] = 961,
    ...
    ["A micro editor config"] = 645,
    ABCClinicalDemandForecast = 37,
    ABCInventoryModuleData = 36,
    ABCSupplyPlan = 38,
    ["ACP Attempts"] = 39,
    ["ACP Cache File"] = 40,
    ["ACP Configuration File"] = 41,
    ["ACP Primer"] = 42,
    ["ACP Sync"] = 43,
    ["ACP Variables File"] = 44,
    ["AI Harness config"] = 46,
    ["AI Harness org policy"] = 47,
    AIConfig = 48,
    ["AMX Muse Program Descriptor"] = 1333,
    ["API Builder"] = 1139,
    ["AVA Configuration"] = 1203,
    ["AWS AppConfig Feature Flags-v1"] = 88,
    ["AWS CDK cdk.json"] = 321,
    ["AWS CloudFormation"] = 322,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 323,
    ["AWS Copilot Manifest"] = 1372,
    ["AWS SAM CLI Samconfig"] = 324,
    Acton = 1426,
    ["Adobe UXP Manifest"] = 1266,
    ["Aerleon Network & Service Definitions"] = 30,
    ["Aerleon Policy"] = 31,
    ["Agent Permission Policy"] = 1412,
    ["AgentCore CLI"] = 1413,
    ["AgentCtl MCP"] = 1415,
    ["AgentCtl config"] = 1414,
    ["AgentCtl permissions"] = 1416,
    AgentLoopKit = 1417,
    Aider = 1362,
    Air = 33,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1383,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1382,
    ["Airlock Microgateway"] = 49,
    ["Alacritty Configuration"] = 1175,
    ["AlgoVoi Compliance Receipt v1"] = 19,
    ["All Contributors configuration file"] = 1229,
    ["Amazon S3 bucket CORS"] = 21,
    Ameba = 1,
    Anodizer = 520,
    ["Ansible Argument Specs"] = 502,
    ["Ansible Collection Galaxy"] = 509,
    ["Ansible Execution Environment"] = 499,
    ["Ansible Inventory"] = 508,
    ["Ansible Meta"] = 500,
    ["Ansible Meta Runtime"] = 501,
    ["Ansible Navigator Configuration"] = 511,
    ["Ansible Playbook"] = 506,
    ["Ansible Requirements"] = 503,
    ["Ansible Rulebook"] = 507,
    ["Ansible Tasks File"] = 505,
    ["Ansible Vars File"] = 504,
    ["Ansible-lint Configuration"] = 510,
    Any = 1294,
    ["AnyWork Automation Configuration"] = 26,
    ["Apollo Router"] = 1140,
    ["App config Spotify Backstage"] = 53,
    ["Applicant Profile Protocol"] = 23,
    ["Application Accelerator"] = 20,
    ["Application list for a WinUtil"] = 1312,
    ["ArchSmith diagram IR"] = 1455,
    ArchitectFX = 1317,
    ["Archival editor configuration"] = 68,
    ["Archival object definitions"] = 69,
    ["Archival site configuration"] = 70,
    ["Archival template definition"] = 71,
    ["Are The Types Wrong?"] = 77,
    ["Argo CD"] = 72,
    ["Argo Events"] = 73,
    ["Argo Workflows"] = 74,
    Arity = 75,
    AssemblyScript = 79,
    AsyncAPI = 82,
    ["AsyncAPI Tool File"] = 83,
    ["Atmos Manifests"] = 84,
    ["Aurora Agile Meta-Framework"] = 85,
    AutoAPICase = 1239,
    ["Avro Avsc"] = 86,
    ["Awesome Repositories"] = 87,
    ["Azure Container App template for defining an immutable revision"] = 90,
    ["Azure DevOps extension manifest"] = 93,
    ["Azure Device Update for IoT Hub import manifest"] = 91,
    ["Azure Device Update for IoT Hub update manifest"] = 92,
    ["Azure IoT Edge deployment"] = 96,
    ["Azure IoT Edge deployment template"] = 97,
    ["Azure IoT EdgeAgent deployment"] = 94,
    ["Azure IoT EdgeHub deployment"] = 95,
    ["Azure IoT Operations Wasm Graph Config"] = 1381,
    ["Azure IoT Operations connector metadata"] = 1378,
    ["Azure Landing Zones Library archetype definition"] = 101,
    ["Azure Landing Zones Library archetype override"] = 102,
    ["Azure Landing Zones Library architecture definition"] = 100,
    ["Azure Landing Zones Library metadata"] = 98,
    ["Azure Landing Zones Library policy default values"] = 99,
    ["Azure Pipelines"] = 137,
    ["Azure Static Web Apps CLI configuration file"] = 965,
    ["Azure Static Web Apps configuration file"] = 964,
    BMML = 1400,
    ["BOSH BPM Config"] = 165,
    ["BOSH CPI Config"] = 166,
    ["BOSH Deploy Config"] = 167,
    ["BOSH Job Spec"] = 168,
    ["BOSH Ops File"] = 170,
    ["BOSH Package Spec"] = 169,
    ["BX CI"] = 191,
    ["Bacon config"] = 13,
    Badness = 149,
    ["Barba-CV"] = 103,
    ["Bashly (bashly.yml)"] = 1233,
    ["Bashly Settings (bashly-settings.yml)"] = 1234,
    Bento = 1399,
    ["Better Code Hub"] = 1144,
    ["Better Scripts"] = 192,
    Bigconfig = 158,
    ["Biome Formatter Config"] = 104,
    ["Bitmovin Encoding Template"] = 1326,
    BizTalkServerApplicationSchema = 1110,
    Bleep = 193,
    ["Block Protocol Metadata"] = 190,
    ["Bluebricks blueprint config"] = 1405,
    ["Boyka Framework"] = 171,
    ["Bpod Finite-State Machine"] = 106,
    Briefcase = 1116,
    ["Build Info"] = 181,
    Buildkite = 183,
    ["Bukkit plugin.yml"] = 182,
    ["BungeeCord plugin.yml"] = 188,
    ["Burnless SRE config"] = 6,
    ["Butane Config"] = 1188,
    C4InterFlow = 1341,
    ["CDK Environment Manager, concrete environment configuration"] = 1365,
    ["CDK Environment Manager, concrete environments definition"] = 1364,
    ["CDK Environment Manager, environment definition"] = 1363,
    ["CGS Card Game Specification (cgs.json)"] = 1271,
    ["CICS TS region tagging"] = 1197,
    ["CICS TS resource import"] = 1198,
    ["CICS TS resource model"] = 1199,
    ["CICS TS resource overrides"] = 1200,
    ["CMake Presets"] = 194,
    ["CNC Codes"] = 218,
    ["CRS WAF test file"] = 1301,
    ["CRS WAF test platform overrides file"] = 1302,
    ["CSS Comb (.csscomb.json)"] = 351,
    ["CSS Lint (.csslintrc)"] = 352,
    ["CSpell (cspell.json)"] = 350,
    ["CVE Record Format"] = 230,
    ["CVX achievements.yaml"] = 236,
    ["CVX competencies.yaml"] = 235,
    ["CVX config.yaml"] = 239,
    ["CVX education.yaml"] = 234,
    ["CVX experience.yaml"] = 233,
    ["CVX keywords.yaml"] = 238,
    ["CVX layout"] = 240,
    ["CVX personal.yaml"] = 231,
    ["CVX referees.yaml"] = 237,
    ["CVX summary.yaml"] = 232,
    CWL = 1277,
    ["Cache Warmup config"] = 195,
    ["Caido Proxy Configuration"] = 1441,
    ["Calqulus pipeline"] = 196,
    ["Camel YAML DSL"] = 197,
    ["Cannon TOML"] = 198,
    Carafe = 199,
    ["Cargo Make"] = 201,
    ["Cargo Manifest"] = 200,
    ["Catalog Info Backstage"] = 202,
    ["Chamaleon environment"] = 1330,
    ["Chamaleon properties"] = 1331,
    ["Chamaleon template"] = 1329,
    Changepacks = 1392,
    Changesets = 333,
    Changie = 203,
    Charmcraft = 204,
    Cheatsheets = 1185,
    ["ChordPro Configuration"] = 206,
    ["Chrome Extension"] = 314,
    ["Chromia Model"] = 207,
    ["Chromia Seeder Module Config"] = 209,
    ["Chromia Seeder Root Config"] = 208,
    ["Cinnamon Spice info.json"] = 114,
    ["CircleCI config.yml"] = 284,
    ["Citation File Format"] = 335,
    ["Citrus test case"] = 211,
    CityJSON = 212,
    ["Claude Code Keybindings"] = 225,
    ["Claude Code Launch Preview"] = 1454,
    ["Claude Code Plugin Manifest"] = 226,
    ["Claude Code Plugin Marketplace"] = 227,
    ["Claude Code Settings"] = 228,
    ["Clawject config"] = 224,
    ["Cloud Foundry Application Manifest"] = 1283,
    ["Cloud Run Spec v1"] = 1307,
    ["Cloud.gov Workshop Configuration"] = 115,
    ["CloudCannon Configuration"] = 120,
    ["CloudCannon Configuration (Collection Structures)"] = 129,
    ["CloudCannon Configuration (Collections)"] = 128,
    ["CloudCannon Configuration (Editables)"] = 127,
    ["CloudCannon Configuration (Inputs)"] = 122,
    ["CloudCannon Configuration (Snippets Definitions)"] = 126,
    ["CloudCannon Configuration (Snippets Imports)"] = 125,
    ["CloudCannon Configuration (Snippets)"] = 124,
    ["CloudCannon Configuration (Structure Value)"] = 123,
    ["CloudCannon Configuration (Structures)"] = 121,
    ["CloudEvents specification"] = 213,
    ["Code Climate"] = 285,
    CodeCV = 118,
    CodeRabbit = 117,
    ["CodeShip Pro services configuration files"] = 303,
    ["CodeShip Pro steps configuration files"] = 304,
    ["Codecov configuration files"] = 302,
    Codex = 293,
    ["Codex Hooks"] = 294,
    ["Codex Plugin Manifest"] = 295,
    ["Codex Skill Metadata"] = 296,
    CodifyCLI = 119,
    Codux = 298,
    ["Cog config file"] = 219,
    ["Commandbox Box.json"] = 220,
    ["Commandbox Server.json"] = 221,
    ["Common Catalog Data"] = 312,
    ["Common Package Specification"] = 222,
    Concord = 1300,
    ["Configu .cfgu files"] = 1288,
    ["Configu .configu file"] = 1289,
    Conjure = 217,
    ["Container Structure Test"] = 1124,
    Containerlab = 1153,
    ["Context Passport"] = 2,
    ["Context Reasoning Format (CRF)"] = 215,
    ["Contextive Glossary"] = 1357,
    ContractGuard = 1154,
    Convex = 216,
    ["Crowdsec collection config"] = 344,
    ["Crowdsec parser config"] = 345,
    ["Crowdsec scenario config"] = 346,
    ["CumulusCI Config"] = 223,
    ["Cursor Agent Environment"] = 1410,
    ["Custom Machinery Machine"] = 1272,
    ["Custom Machinery Recipe"] = 1273,
    ["Cycle Stack File"] = 241,
    CycloneDX = 242,
    ["DWP Exchange - catalogue entry"] = 400,
    ["DWP Exchange - gateway"] = 398,
    ["DWP Exchange - meta"] = 399,
    ["Dagger module"] = 353,
    ["Dark Factory consumer config"] = 243,
    ["Dart Build Config (dart-build.json)"] = 354,
    ["Dart Test Config (dart-test.json)"] = 355,
    ["DashLord Configuration"] = 356,
    ["Data Contract Specification"] = 357,
    ["Data Product Specification"] = 358,
    ["DataYoga Connections"] = 244,
    ["DataYoga Job"] = 245,
    ["Datadog Continuous Testing"] = 609,
    ["Datadog Service Definition"] = 610,
    ["Datadog Software Catalog"] = 611,
    ["Datahub Ingestion Recipe"] = 1204,
    ["Debian Upstream Metadata file"] = 252,
    DebtLens = 253,
    ["Decision Reasoning Format (DRF)"] = 254,
    ["Deck config"] = 255,
    ["Declarative Automation Bundles"] = 1250,
    ["DeepMatch deeplinks spec"] = 256,
    ["Dein Config"] = 257,
    ["Deno Config (deno.json)"] = 366,
    ["Dependency cruiser"] = 258,
    ["DeployStack Configuration"] = 259,
    ["Deployah Configuration"] = 1380,
    ["Deployer Recipe"] = 369,
    ["Design Tokens Community Group format"] = 260,
    ["Design Tokens Community Group resolver"] = 261,
    ["Deta Spacefile"] = 262,
    ["Detekt Config (detekt.yml)"] = 370,
    ["Devbox Config"] = 263,
    ["Devbox Plugin"] = 264,
    Devfile = 397,
    Devup = 1393,
    DipDup = 1303,
    ["Discord Webhook"] = 371,
    ["DocFx Config (docfx.json)"] = 376,
    ["Docker Desktop extension metadata"] = 373,
    ["Docs MCP Manifest"] = 377,
    Dofigen = 378,
    ["Dolittle Artifacts"] = 379,
    ["Dolittle Bounded Context Configuration"] = 380,
    ["Dolittle Event Horizons Configuration"] = 381,
    ["Dolittle Resources Configuration"] = 382,
    ["Dolittle Server Configuration"] = 383,
    ["Dolittle Tenant Map Configuration"] = 385,
    ["Dolittle Tenants Configuration"] = 384,
    ["Dolittle Topology"] = 386,
    ["DonateCaseBetterCasino menu"] = 1334,
    ["Draugr Saga"] = 364,
    ["Draugr Saga fragment"] = 365,
    ["Drupal Breakpoints"] = 266,
    ["Drupal Config"] = 278,
    ["Drupal Info"] = 267,
    ["Drupal Layouts"] = 268,
    ["Drupal Libraries"] = 269,
    ["Drupal Links Action"] = 270,
    ["Drupal Links Contextual"] = 271,
    ["Drupal Links Menu"] = 272,
    ["Drupal Links Task"] = 273,
    ["Drupal Migration"] = 274,
    ["Drupal Permissions"] = 275,
    ["Drupal Recipe"] = 276,
    ["Drupal Routing"] = 277,
    ["Drupal Services"] = 279,
    ["Drush site aliases"] = 392,
    ["Dust configuration"] = 395,
    ["Dynamic Bash Aliases (.aliases)"] = 1241,
    ["EAS config"] = 439,
    ["ECA - Editor Code Assistant"] = 402,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1230,
    ["ESLint Suppressions"] = 444,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1377,
    ["EasyVCR .NET"] = 441,
    ["Eidolon Resource"] = 1318,
    ["Elgato Stream Deck"] = 405,
    Elm = 1305,
    ["Embrace Config"] = 1216,
    Emmet = 1306,
    Endurica = 1254,
    ["Enonic XP API descriptor"] = 408,
    ["Enonic XP Admin Extension descriptor"] = 409,
    ["Enonic XP Admin Tool descriptor"] = 410,
    ["Enonic XP Application descriptor"] = 411,
    ["Enonic XP CMS descriptor"] = 412,
    ["Enonic XP Content Type descriptor"] = 413,
    ["Enonic XP Form Fragment descriptor"] = 414,
    ["Enonic XP ID Provider descriptor"] = 415,
    ["Enonic XP Layout descriptor"] = 416,
    ["Enonic XP Macro descriptor"] = 417,
    ["Enonic XP Mixin descriptor"] = 418,
    ["Enonic XP Page descriptor"] = 419,
    ["Enonic XP Part descriptor"] = 420,
    ["Enonic XP Service descriptor"] = 421,
    ["Enonic XP Site descriptor"] = 422,
    ["Enonic XP Style descriptor"] = 423,
    ["Enonic XP Task descriptor"] = 424,
    ["Enonic XP Webapp descriptor"] = 425,
    ["Enterprise Contract Policy Spec"] = 406,
    ["Envelope Team Definition"] = 1425,
    ["Envilder Map File"] = 407,
    ["Erda Pipeline"] = 1279,
    ["Erda Runtime"] = 1280,
    ["Espanso config.yml"] = 1403,
    ["Espanso match.yml"] = 1402,
    Esquio = 427,
    ["Estuary Flow Catalog"] = 1194,
    ["Ethereum ERC1155"] = 1419,
    ["Ethereum ERC721"] = 1418,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 432,
    ["EveryVoice TTS Toolkit Data Configuration"] = 433,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 437,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 436,
    ["EveryVoice TTS Toolkit Text Configuration"] = 434,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 435,
    ["Evolving Resolutive Process notation"] = 1379,
    ["Expo SDK"] = 438,
    ["Expoot app config"] = 440,
    ["F-Droid Data metadata"] = 446,
    ["FasterCI Configuration"] = 138,
    Fatou = 139,
    ["Fence configuration"] = 140,
    FiQuS = 450,
    Firebase = 448,
    ["Flatpak Builder Manifest"] = 451,
    ["FlexGet Config"] = 452,
    ["Flow.json Configurations"] = 1276,
    ["Fossa configuration file"] = 459,
    ["Fossa's fossa-deps file"] = 460,
    ["Foundry VTT - Base package Manifest"] = 454,
    ["Foundry VTT - Module Manifest"] = 455,
    ["Foundry VTT - System Data Template"] = 458,
    ["Foundry VTT - System Manifest"] = 456,
    ["Foundry VTT - World Manifest"] = 457,
    ["Foxx Manifest"] = 141,
    ["Freifunk.de Community API"] = 144,
    ["Frogbot Config"] = 145,
    ["G2P Mapping Configuration"] = 467,
    GAMA = 468,
    ["GCP Blueprint Metadata"] = 471,
    Gaspar = 469,
    ["GatewayCore API Gateway"] = 470,
    ["Gemini CLI settings"] = 472,
    ["GeoJSON.json latest"] = 1192,
    GherKing = 1196,
    ["GitHub Action"] = 482,
    ["GitHub Actions typing"] = 1314,
    ["GitHub CLI configuration"] = 483,
    ["GitHub CLI hosts"] = 484,
    ["GitHub Discussion"] = 485,
    ["GitHub Funding"] = 487,
    ["GitHub Issue Template configuration"] = 488,
    ["GitHub Issue Template forms"] = 489,
    ["GitHub Pages Jekyll"] = 490,
    ["GitHub Prompt"] = 486,
    ["GitHub Secret Scanning"] = 491,
    ["GitHub Workflow"] = 492,
    ["GitHub Workflow Template Properties"] = 493,
    ["GitHub automatically generated release notes configuration"] = 494,
    ["GitLab Agent for Kubernetes configuration"] = 1268,
    ["GitLab Duo Workflow"] = 496,
    GitResume = 498,
    GitVersion = 475,
    ["Gitea Issue Template configuration"] = 478,
    ["Gitea Issue Template forms"] = 479,
    Gitleaks = 476,
    ["Gitpod Configuration"] = 497,
    ["Glamour style"] = 473,
    ["GlazeWM settings"] = 1270,
    ["Global Privacy Control"] = 474,
    Goblet = 1249,
    ["Golangci-lint Configuration"] = 513,
    ["Golangci-lint Custom Plugins Configuration"] = 514,
    ["Google Chrome Related Website Sets"] = 449,
    ["Google Cloud Workflows"] = 320,
    ["Google Digital Assetlinks"] = 1358,
    Goreleaser = 518,
    ["Goreleaser Pro"] = 519,
    Goss = 521,
    ["Gradle Build Cache Node"] = 1142,
    ["Gradle Enterprise"] = 1141,
    ["Grafana 5.x Dashboard"] = 522,
    ["GraphQL Code Generator"] = 527,
    ["GraphQL Config"] = 526,
    ["GraphQL Mesh"] = 525,
    ["GroovyLint configuration"] = 528,
    ["Grunt JSHint task"] = 532,
    ["Grunt Watch task"] = 533,
    ["Grunt base task"] = 534,
    ["Grunt clean task"] = 530,
    ["Grunt copy task"] = 529,
    ["Grunt cssmin task"] = 531,
    HEMTT = 1106,
    ["HULL - Helm Uniform Layer Library"] = 1459,
    Hadolint = 1120,
    Hammerkit = 1152,
    ["Hardware Sentry Configuration"] = 1208,
    ["Hashgraph Online Skill Manifest"] = 9,
    ["HashiCorp Vault"] = 535,
    Hatch = 1121,
    Hayson = 537,
    ["Haystack Pipeline"] = 538,
    ["Hazelcast 5 Configuration"] = 539,
    ["Hecate Input Schema"] = 1369,
    ["Helm Chart.lock"] = 281,
    ["Helm Chart.yaml"] = 280,
    ["Helm Unittest Test Suite"] = 282,
    ["Heloisa Assistant Plugins Marketplace"] = 1452,
    ["Hex file"] = 283,
    ["Home Assistant Integration Manifest"] = 541,
    ["Homer dashboard configuration"] = 542,
    ["Hoverfly Simulation"] = 547,
    Hugo = 1184,
    ["Hugo Theme"] = 1183,
    ["Hulak Configuration"] = 550,
    ["Hyperfoil benchmark configuration"] = 549,
    ["IBM Zapp document"] = 551,
    ["IBM zCodeFormatSettings"] = 552,
    ["IMG Catapult PSP"] = 557,
    ["IVMS101 by CODE Protocol"] = 1269,
    ["Infinispan Configuration"] = 559,
    ["Infinispan Server Configuration"] = 560,
    Infrahub = 561,
    Istanbul = 1212,
    ["JDownloader2 crawler multi-rules"] = 575,
    ["JDownloader2 crawler single-rules"] = 574,
    ["JFrog Applications Config"] = 576,
    ["JFrog File Spec"] = 577,
    ["JFrog Pipelines YML DSL"] = 1218,
    ["JMeter DSL cli config"] = 578,
    JReleaser = 581,
    ["JSON Document Transform"] = 589,
    ["JSON Feed"] = 590,
    ["JSON Resume"] = 868,
    ["JSON Schema Draft 2020-12"] = 1086,
    ["JSON Schema Draft 4"] = 1083,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1251,
    ["JSON Schema Draft 7"] = 1084,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1252,
    ["JSON Schema Draft 8 (2019-09)"] = 1085,
    ["JSON-API"] = 588,
    ["JSON-e templates"] = 1149,
    ["JSON-stat 2.0"] = 1079,
    JSONPatch = 592,
    ["JSR Package Config (jsr.json)"] = 582,
    Jarl = 1385,
    Jasmine = 569,
    Jekyll = 570,
    ["Jenkins X Pipelines"] = 571,
    ["Jenkins X Requirements"] = 572,
    Jest = 573,
    Jocker = 579,
    ["Jovo Language Models"] = 580,
    Jsontron = 593,
    ["Jujutsu (jj) VCS config"] = 1371,
    ["KIMMDY config file"] = 604,
    ["KODE/CI build.yaml"] = 1214,
    ["KSP-AVC"] = 1080,
    ["KSP-CKAN"] = 1081,
    ["KSP-NetKAN"] = 1082,
    KSY = 1281,
    KSail = 465,
    ["KYA Manifest"] = 1282,
    ["Karakum configuration file"] = 461,
    Kas = 596,
    ["Kestra flow file"] = 605,
    ["Keycloak REST API"] = 1221,
    ["Knative Functions - func.yaml"] = 462,
    Knip = 463,
    ["Knip JSONC"] = 464,
    ["Knowledge Unit"] = 613,
    ["Kometa (nightly) config file"] = 607,
    ["Kometa config file"] = 606,
    ["Kong DBLess config"] = 1215,
    KrakenD = 608,
    ["Kubri Configuration"] = 616,
    LOOBin = 635,
    ["Lake configuration file"] = 1374,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 325,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 326,
    ["Landing Zone Accelerator on AWS - Global Config"] = 327,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 328,
    ["Landing Zone Accelerator on AWS - Network Config"] = 329,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 330,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 331,
    ["Landing Zone Accelerator on AWS - Security Config"] = 332,
    ["Lando (landofile)"] = 130,
    ["LangGraph Platform configuration"] = 1293,
    ["Language configuration"] = 1292,
    Lefthook = 621,
    ["Liferay client-extension.yaml"] = 628,
    ["LinkML Metamodel"] = 630,
    ["LiquiLens Evidence Carrier Reference v1"] = 632,
    ["LiquiLens Evidence Carrier v1"] = 631,
    Liquibase = 1159,
    ["Liquibase Flow File"] = 1160,
    ["Lively Properties"] = 634,
    ["Lobe AI Agent"] = 132,
    Loki = 133,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 678,
    ["MS2Rescore Configuration"] = 686,
    ["MSTest testconfig.json"] = 687,
    ["Madge configuration"] = 641,
    ["Madness (madness.yml)"] = 1232,
    ["Mado configuration"] = 642,
    ["Maestro Flow"] = 643,
    ["Mail Servers Configuration"] = 1406,
    ["MapEHR Mapping"] = 644,
    Markdownlint = 1163,
    ["Mason Registry"] = 1166,
    ["MegaLinter Custom Flavor"] = 647,
    ["MegaLinter configuration"] = 646,
    ["MegaLinter descriptor"] = 648,
    Melange = 1259,
    ["Meltano project definition"] = 649,
    ["Mergify Configuration"] = 688,
    ["Mermaid config"] = 4,
    ["Metadata for a Bazel module"] = 650,
    ["Metadata for a Cinnamon spice"] = 1310,
    ["Metatype Configuration"] = 651,
    ["MetricsHub Configuration"] = 652,
    ["MetricsHub Connector Configuration"] = 653,
    ["Micro Editor Syntax"] = 1242,
    ["Microsoft Band Web Tile"] = 654,
    ["Microsoft RulesEngine workflow rules"] = 1297,
    ["Microsoft RulesEngine workflow rules list"] = 1298,
    ["Minecraft Custom Main Menu Mod"] = 1260,
    ["Minecraft Data Pack Advancement"] = 656,
    ["Minecraft Data Pack Biome"] = 657,
    ["Minecraft Data Pack Configured Carver"] = 658,
    ["Minecraft Data Pack Damage Type"] = 659,
    ["Minecraft Data Pack Dimension"] = 661,
    ["Minecraft Data Pack Dimension Type"] = 660,
    ["Minecraft Data Pack Item Modifier"] = 662,
    ["Minecraft Data Pack Loot Table"] = 663,
    ["Minecraft Data Pack Metadata"] = 664,
    ["Minecraft Data Pack Predicate"] = 665,
    ["Minecraft Data Pack Recipe"] = 666,
    ["Minecraft Data Pack Tag"] = 667,
    ["Minecraft Data Pack Template Pool"] = 668,
    ["Minecraft Data Pack Trim Material"] = 673,
    ["Minecraft Data Pack Trim Pattern"] = 674,
    ["Minecraft Resource Pack Lang"] = 669,
    ["Minecraft Resource Pack Particle"] = 670,
    ["Minecraft Resource Pack Texture Mcmeta"] = 672,
    ["Minecraft Resourcepack Sounds"] = 671,
    ["MockServer Expectation"] = 680,
    ["MockServer Expectations"] = 681,
    ModuleAssembler = 676,
    ["Monade CLI Stack Configuration"] = 691,
    ["MongoDB Atlas Search Index Definition"] = 1213,
    ["Monika Configuration"] = 1211,
    ["Monoweave Configuration"] = 685,
    ["Motif config"] = 1102,
    MultiQC = 1351,
    ["NOX Framework (Service)"] = 713,
    ["Netin Diagnostic System Template"] = 1170,
    ["Netlify config"] = 694,
    ["Network-as-Code Data Model"] = 695,
    ["Next Gen UI Agent A2A Server Configuration"] = 696,
    ["Next Gen UI Agent Configuration"] = 698,
    ["Next Gen UI Agent MCP Server Configuration"] = 697,
    ["Nightwatch.js"] = 705,
    ["Nika workflow"] = 710,
    ["Node.js configuration"] = 1107,
    ["NueJS configuration file"] = 718,
    ["Nuitka Package Config"] = 1274,
    ["Nullstone config"] = 720,
    ["ODGS Data Rules"] = 727,
    ["ODGS Ontology Graph"] = 728,
    ["ODGS Standard Metrics"] = 726,
    ["OKF Graph"] = 1453,
    ["ONe's changelog entry"] = 742,
    ["ONe's service descriptor"] = 741,
    ["ORT Server repository environment configuration"] = 753,
    ["OSCAL Assessment Plan (AP)"] = 755,
    ["OSCAL Assessment Results (AR)"] = 756,
    ["OSCAL Catalog"] = 757,
    ["OSCAL Component Definition (CDef)"] = 758,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 759,
    ["OSCAL Profile"] = 760,
    ["OSCAL System Security Plan (SSP)"] = 761,
    ["OSS Review Toolkit configuration"] = 762,
    ["OSS Review Toolkit curation"] = 763,
    ["OSS Review Toolkit package configuration"] = 764,
    ["OSS Review Toolkit project package manager definition"] = 765,
    ["OSS Review Toolkit repository configuration"] = 766,
    ["OSS Review Toolkit resolutions"] = 767,
    ["October CMS columns"] = 724,
    ["October CMS fields"] = 725,
    ["Oh My Posh"] = 730,
    Okteto = 731,
    ["Ona Tasks and Services"] = 733,
    Opctl = 1105,
    ["Open Data Contract Standard (ODCS)"] = 746,
    ["Open Data Product Standard (ODPS)"] = 747,
    ["Open Know-How"] = 1356,
    ["Open Pentest Format"] = 748,
    OpenDecree = 1423,
    ["OpenDecree Configuration"] = 1424,
    ["OpenRewrite Resource"] = 744,
    OpenSRM = 749,
    OpenStatus = 1367,
    ["OpenTelemetry Declarative Configuration"] = 745,
    ["OpenUtau character yaml"] = 738,
    ["OpenUtau ustx"] = 739,
    ["OpenWeather Current Weather API"] = 1148,
    ["OpenWeather Road Risk API"] = 1147,
    ["Ory Hydra configuration"] = 548,
    ["Ory Keto configuration"] = 612,
    ["Ory Kratos configuration"] = 754,
    ["Ory Oathkeeper configuration"] = 722,
    ["Outblocks App configuration"] = 751,
    ["Outblocks database table"] = 752,
    ["Outblocks project configuration"] = 750,
    PDM = 775,
    POPxf = 787,
    ["POPxf Correlations"] = 788,
    ["PRML manifest"] = 795,
    Packer = 771,
    PactSpec = 772,
    Panache = 773,
    Pantsbuild = 1228,
    ["Paper paper-plugin.yml"] = 774,
    ["Pipeline component"] = 1161,
    ["Platform.sh application"] = 15,
    ["Platform.sh routes"] = 16,
    ["Platform.sh services"] = 17,
    ["Plex Prerolls"] = 785,
    ["PocketMine plugin.yml"] = 782,
    ["Podman Desktop Extension"] = 1443,
    ["Postman collection"] = 791,
    ["Power Pages Configuration"] = 1368,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1313,
    ["ProActions AI-Kit Configuration"] = 803,
    ["ProActions AI-Kit Configuration for Menus"] = 805,
    ["ProActions AI-Kit Configuration for Sections"] = 807,
    ["ProActions AI-Kit Configuration for Services"] = 804,
    ["ProActions AI-Kit Configuration for Steps"] = 808,
    ["ProActions AI-Kit Configuration for Templates"] = 806,
    ["Problem object RFC9457"] = 1257,
    ["Problem package format"] = 809,
    ["Problem package generators"] = 810,
    ["Problem package submissions"] = 811,
    ["Problem package test group metadata"] = 812,
    Pterodactyl = 1207,
    ["Pull Request Labeler"] = 829,
    Pulumi = 837,
    ["PyGTA Config"] = 833,
    PyProject = 838,
    Pylock = 1359,
    Pyright = 839,
    ["Python script metadata"] = 1353,
    ["QType AI DSL"] = 842,
    Qgoda = 841,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1435,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1433,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1439,
    ["Qlik Talend Cloud Pipeline - Project"] = 1431,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1434,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1436,
    ["Qlik Talend Cloud Pipeline - Task"] = 1432,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1438,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1437,
    Qodana = 1180,
    ["Qt Creator workspace file"] = 1290,
    ["Quali Torque Blueprint Spec 2"] = 1205,
    ["QueryFirst config file"] = 1224,
    ["QuikRun Configuration"] = 1440,
    ["Qwen Code Settings"] = 1420,
    ["RKE Cluster Configuration JSON"] = 1158,
    ["RKE Cluster Configuration YAML"] = 1157,
    RadioHound = 832,
    ["Raid Profile"] = 1421,
    ["Raid Repo Configuration"] = 1422,
    Railpack = 844,
    Railway = 843,
    ["Rancher Fleet"] = 834,
    ["Rattler-build"] = 845,
    Ray = 1119,
    ["Read the Docs"] = 836,
    ["Red-DiscordBot Cog"] = 852,
    ["Red-DiscordBot Cog Repo"] = 853,
    ["Red-DiscordBot Trivia"] = 854,
    ["Releasaurus Config"] = 12,
    ReleaseKit = 11,
    ["Render Blueprints"] = 1156,
    RenderCV = 872,
    Renovate = 869,
    ["Renovate global configuration"] = 870,
    ["Renovate inherited configuration"] = 871,
    ["Replit config"] = 860,
    Restate = 1346,
    ["Revel Digital Gadget Definition File"] = 1370,
    RoadRunner = 874,
    ["Robust Station Image"] = 1376,
    Rockcraft = 875,
    ["Roo Coder Custom Modes"] = 876,
    Rubocop = 865,
    ["Rudder techniques"] = 1264,
    Ruff = 866,
    ["Rust Project"] = 867,
    ["Rust toolchain"] = 881,
    ["SDMX data message"] = 908,
    ["SDMX metadata message"] = 907,
    ["SDMX structure message"] = 906,
    ["SIL Kit Participant Configuration"] = 919,
    ["SIL Kit Registry Configuration"] = 920,
    ["SPDX 2.3"] = 962,
    SWADL = 978,
    ["Safebox Config"] = 1219,
    ["Sapphire CLI Config"] = 884,
    ["SauceCTL Configuration"] = 1167,
    Scarb = 904,
    ["Schema Catalog"] = 899,
    ["Scoop manifest"] = 905,
    ["Secure SDLC Evidence Bundle"] = 909,
    ["Semantic Data Fabric (SDF) file"] = 910,
    ["Semgrep Rule"] = 912,
    ["Serenity Code Generator (Sergen)"] = 913,
    ["Serverless Framework Configuration"] = 1174,
    ["Serverless Workflow"] = 1176,
    ["Settings for a Cinnamon spice"] = 1309,
    ["Settings.paf"] = 915,
    ["Shopware 6 Configuration"] = 1177,
    ["Shopware CLI Extension Store Configuration"] = 1178,
    ["Shopware CLI Project Store Configuration"] = 1179,
    ["Sigma Detection Rule"] = 917,
    ["SigmaCV CV"] = 7,
    ["Sigrid scope configuration file"] = 918,
    ["SkyPilot Task JSON"] = 1265,
    ["Slack app manifest"] = 925,
    ["Slang Server Configuration"] = 1447,
    Snapcraft = 927,
    ["Solarxy project config"] = 930,
    Solidarity = 931,
    ["Solution filters"] = 932,
    ["Source Maps v3"] = 933,
    Sourcery = 934,
    ["Spack bootstrap.yaml"] = 935,
    ["Spack cdash.yaml"] = 936,
    ["Spack ci.yaml"] = 937,
    ["Spack compilers.yaml"] = 938,
    ["Spack concretizer.yaml"] = 939,
    ["Spack config.yaml"] = 940,
    ["Spack definitions.yaml"] = 941,
    ["Spack develop.yaml"] = 942,
    ["Spack env_vars.yaml"] = 943,
    ["Spack environment"] = 949,
    ["Spack include.yaml"] = 944,
    ["Spack mirrors.yaml"] = 945,
    ["Spack modules.yaml"] = 946,
    ["Spack packages.yaml"] = 947,
    ["Spack repos.yaml"] = 948,
    ["Spack toolchains.yaml"] = 950,
    ["Spack upstreams.yaml"] = 951,
    ["Spack view.yaml"] = 952,
    ["Speakeasy Generation Config File"] = 956,
    ["Speakeasy Lint Configuration File"] = 953,
    ["Speakeasy Test Generation Configuration File"] = 954,
    ["Speakeasy Workflow File"] = 955,
    SpecIF = 957,
    ["Specmatic Configuration"] = 958,
    ["Specpin spec file"] = 5,
    ["Sponge Mixin configuration"] = 959,
    ["Spotlight Ruleset"] = 960,
    StackBlitz = 966,
    ["StackHawk Scanner Configuration"] = 1173,
    Stale = 967,
    Starfish = 968,
    ["Starlake Data Pipeline"] = 1145,
    Starship = 969,
    ["Statamic Blueprint"] = 970,
    ["Stella configuration file"] = 971,
    ["Streamlit configuration file"] = 972,
    ["Stryker Mutator"] = 975,
    ["StyleCop Analyzers Configuration"] = 976,
    ["Stylelint (.stylelintrc)"] = 977,
    ["Stylua Config"] = 1360,
    ["Sublime Syntax"] = 1220,
    ["Subsquid squid manifest"] = 1267,
    ["Swagger API 2.0"] = 979,
    ["Symfony Routing Configuration"] = 980,
    ["Symfony Serializer Mapping"] = 981,
    ["Symfony Services Configuration"] = 982,
    ["Symfony Validation Mapping"] = 983,
    ["Synadia Connect Component"] = 984,
    TSON = 1027,
    TSTyche = 1028,
    ["TYPO3 Vendor Bundler config"] = 1034,
    ["Tab data for a LinUtil"] = 1316,
    ["Tab list for a LinUtil"] = 1315,
    Tach = 985,
    ["Tach Domain"] = 986,
    Talhelper = 988,
    ["Talisman configuration"] = 989,
    Taplo = 1361,
    ["Taskfile config"] = 1150,
    Taurus = 990,
    Tauticord = 991,
    ["Tekton Pipeline"] = 1389,
    ["Tekton PipelineRun"] = 1390,
    ["Tekton Task"] = 1387,
    ["Tekton TaskRun"] = 1388,
    Telefonistka = 1347,
    ["Terraform PowerShell provider block manifest"] = 994,
    ["Terraform PowerShell provider data source manifest"] = 995,
    ["Terraform PowerShell provider resource manifest"] = 996,
    ["Terraform PowerShell provider settings"] = 997,
    ["Terrateam config"] = 1373,
    ["Tesseract configuration"] = 998,
    ["TestEnvironment.json"] = 1008,
    ["TextMate Grammar"] = 1007,
    Threagile = 1002,
    ["Tier.run pricing.json"] = 999,
    Tikibase = 1000,
    Tombi = 1005,
    ["Traefik v2"] = 1011,
    ["Traefik v2 File Provider"] = 1012,
    ["Traefik v3"] = 1013,
    ["Traefik v3 File Provider"] = 1014,
    ["Travis CI (.travis.yml)"] = 1010,
    Treefmt = 524,
    Trident = 1343,
    Trivy = 1017,
    ["TrueScript for *.tscript files"] = 1018,
    ["Tugboat QA config.yml"] = 1340,
    TunnelHub = 1255,
    Turborepo = 1009,
    Tycho = 1304,
    Tye = 1181,
    ["Tyk Gateway - Open Source v5.7+"] = 1352,
    ["UET BuildConfig.json"] = 1225,
    ["UI5 Manifest"] = 1040,
    ["UNCORS configuration"] = 1045,
    ["UTAM Page Object"] = 1043,
    ["Ubuntu Server Autoinstall"] = 1038,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1344,
    ["Uniswap Token List"] = 1130,
    ["Universal Schedule Format"] = 1046,
    ["Unreal Engine Uplugin"] = 1226,
    ["Unreal Engine Uproject"] = 1227,
    ["UpCloud CLI (upctl) configuration"] = 1345,
    ["Updatecli Compose"] = 1189,
    ["Updatecli Policy Manifest"] = 1190,
    ["Updatecli Policy Metadata"] = 1191,
    Uplift = 1223,
    ["Upsun config"] = 14,
    ["User Journey Map"] = 1155,
    V2Ray = 1195,
    ["VSCode Code Snippets"] = 308,
    ["VSIX CLI publishing"] = 1066,
    Vector = 1048,
    ["Vee JSON menu output"] = 1049,
    ["Vela Pipeline Configuration"] = 1052,
    Vercel = 307,
    ["Version Bumper config"] = 1055,
    Vespertide = 1394,
    ["Vespertide Migration"] = 1395,
    ["Vespertide Model"] = 1396,
    ["Viash Component Config"] = 1349,
    ["Viash Package Config"] = 1350,
    Visivo = 1253,
    Vogi = 1060,
    ["WP-CLI"] = 1076,
    Wake = 1342,
    ["Waku Config"] = 1319,
    ["Web App Manifest"] = 1072,
    ["Web types"] = 1075,
    WebExtensions = 1071,
    ["Webman package recipe"] = 1201,
    ["Windows Package Manager Installer Manifest"] = 1127,
    ["Windows Package Manager Locale Manifest"] = 1128,
    ["Windows Package Manager Singleton Manifest"] = 1126,
    ["WireMock CLI import configuration"] = 1325,
    ["WireMock CLI local service configuration"] = 1324,
    ["WireMock message stub mapping"] = 1323,
    ["WireMock stub mapping"] = 1322,
    ["Woodpecker pipeline config"] = 1169,
    ["Wrangler CLI"] = 1077,
    ["XenForo add-on manifest"] = 1078,
    ["Xstate Machine"] = 1187,
    ["Yandex Workflow Language"] = 1311,
    ["Yarn Config (.yarnrc.yml)"] = 1143,
    ["Yippee-Ki-JSON configuration YML"] = 1134,
    ["YouTrack App"] = 1308,
    ["Zarf Package Configuration"] = 1375,
    ["Zerops import file"] = 1296,
    ["Zola Configuration"] = 1386,
    abtop = 35,
    act3 = 1427,
    actionlint = 45,
    ["aerleon.yml"] = 29,
    ["amplify.yml"] = 22,
    ["amxx-builder manifest"] = 1442,
    ["angular.json"] = 50,
    apko = 1258,
    ["app-definition.yaml"] = 54,
    ["apple-app-site-association"] = 52,
    ["appsettings.StormPetrel.json"] = 59,
    ["appsettings.json"] = 57,
    ["appsscript.json"] = 56,
    ["appveyor.yml"] = 58,
    ["aqua-generate-registry.yaml"] = 61,
    ["aqua-policy.yaml"] = 62,
    ["aqua.yaml"] = 60,
    ["arazzo.json"] = 64,
    ["arb.json"] = 65,
    ["arc.json"] = 67,
    ["architect.yml"] = 66,
    ["artifacthub-repo.yml"] = 76,
    ["asm-lsp"] = 78,
    ["ast-grep rules"] = 81,
    ["ast-grep sgconfig.yml"] = 80,
    ["azure.yaml"] = 89,
    ["babelrc.json"] = 147,
    ["bamboo-spec"] = 152,
    basedpyright = 150,
    ["bashly-strings.yml"] = 1235,
    ["batect.yml"] = 151,
    ["beef-database-codegen"] = 153,
    ["beef-database-v5-codegen"] = 155,
    ["beef-entity-codegen"] = 154,
    ["beef-entity-v5-codegen"] = 156,
    ["behat.yml"] = 172,
    ["bigquery-table"] = 157,
    ["bioimageio resource description"] = 1275,
    ["bitbucket-pipelines"] = 159,
    bitrise = 160,
    ["bitrise-step"] = 161,
    ["block.json"] = 189,
    ["bottom configuration"] = 105,
    ["bower.json"] = 163,
    ["bozr.suite.json"] = 176,
    bpkg = 1236,
    ["browser.i18n.json"] = 177,
    ["browsh configuration"] = 178,
    bucklescript = 179,
    ["buf.gen.yaml"] = 108,
    ["buf.lock"] = 109,
    ["buf.plugin.yaml"] = 110,
    ...
    ["build-changelog"] = 180,
    ["bun.lock"] = 185,
    ["bundleconfig.json"] = 186,
    ["bunfig.toml"] = 187,
    ["cargo-mutants-config.yaml"] = 113,
    ["cargo-nextest repository configuration"] = 699,
    ["cargo-nextest user configuration"] = 700,
    ["ccmod.json"] = 1320,
    ["cfgd Config"] = 1448,
    ["cfgd ConfigSource"] = 1451,
    ["cfgd Module"] = 1449,
    ["cfgd Profile"] = 1450,
    changelogging = 1287,
    ["chezmoi configuration"] = 205,
    ["chisel-slices.json"] = 334,
    ["chrome-extension-locales-messages.json"] = 315,
    ["chutzpah.json"] = 316,
    cibuildwheel = 210,
    ["clang-format (.clang-format)"] = 1193,
    ["clang-tidy"] = 289,
    clangd = 288,
    clib = 290,
    ["cloud-init: cloud-config userdata"] = 292,
    ["cloud-sdk-pipeline-configuration"] = 318,
    ["cloudbuild.json"] = 319,
    cloudify = 291,
    cmakefmt = 229,
    ["cmdx.yaml"] = 116,
    ...
    ["commands.json"] = 311,
    ["commit-check"] = 337,
    ["commitlint (.commitlintrc)"] = 1129,
    ["committed.toml"] = 338,
    ["compile_commands.json"] = 310,
    ["compilerconfig.json"] = 309,
    ["completely.yml"] = 1231,
    ["component-detection-manifest.json"] = 341,
    ["component.json"] = 340,
    ["composer.json"] = 339,
    ["conda-forge"] = 214,
    ["config.yaml"] = 835,
    ["contentmanifest.json"] = 317,
    ["contribute.json"] = 342,
    ["cosmos.config.json"] = 313,
    ["crowdin.yml"] = 343,
    crucible = 347,
    ["ctfd-setup configuration file"] = 1332,
    ["custom-elements.json"] = 1245,
    ["cypress.json"] = 348,
    ["dacier.yml"] = 1430,
    ["datalogic-scan2deploy-android"] = 359,
    ["datalogic-scan2deploy-ce"] = 360,
    ["dbt Dependencies"] = 247,
    ["dbt Packages"] = 249,
    ["dbt Project"] = 248,
    ["dbt Selectors"] = 250,
    ["dbt YAML files"] = 251,
    ...
    ["ddev-global"] = 361,
    ["ddev-project"] = 362,
    ["debugsettings.json"] = 363,
    ["dependabot-v2.json"] = 368,
    ["dependabot.json"] = 367,
    ["deployed-cli"] = 1186,
    devconcurrent = 265,
    ["devcontainer-feature.json"] = 300,
    ["devcontainer.json"] = 299,
    devinit = 1136,
    ["devspace.yaml"] = 1209,
    djlint = 1137,
    ["docker bake"] = 374,
    ["docker sequencer"] = 375,
    ["docker-compose.yml"] = 1135,
    ["dockerd.json"] = 372,
    ["dotnet Release Index manifest"] = 387,
    ["dotnet-tools.json"] = 388,
    ["dotnetcli.host.json"] = 389,
    ["dprint.json"] = 390,
    ["drone.json"] = 391,
    ["dss-2.0.0.json"] = 393,
    ["dstack configuration"] = 394,
    ["dtool dataset metadata"] = 1327,
    ["dvc.yaml"] = 396,
    ["ecosystem.json"] = 401,
    ["editorconfig-checker"] = 403,
    eksctl = 404,
    ["electron-builder configuration file"] = 430,
    ["epr-manifest.json"] = 429,
    ["estampo.toml"] = 428,
    ["evcc.yaml"] = 431,
    ["ezd task runner"] = 442,
    ["fabric.mod.json"] = 445,
    ["first-timers-bot"] = 453,
    ["flagd flag configuration"] = 142,
    ["fly.io Configuration"] = 143,
    fulibWorkflows = 1168,
    ["function.json"] = 466,
    ["gRPC API Gateway & OpenAPI Config"] = 24,
    ["gematik health care insurance list"] = 1338,
    ["gematik health care patient list"] = 1335,
    ["gematik health care provider institution list"] = 1337,
    ["gematik health care provider list"] = 1336,
    ["gematik tiger test environment configuration"] = 1339,
    ["gh-dash"] = 480,
    ["gha-doctor"] = 481,
    ["git-cliff"] = 477,
    ["git-town.toml"] = 1384,
    ["github-settings-as-code"] = 861,
    ["gitlab-ci"] = 495,
    ["global.json"] = 512,
    ["glslint config"] = 3,
    ["go-feature-flag Flag Configuration"] = 516,
    ["gojo.yaml"] = 517,
    gollama = 515,
    ["hassette.toml"] = 540,
    ["haxelib.json"] = 536,
    ...
    ["ide.host.json"] = 553,
    ["ifstate.yaml"] = 554,
    ["imageoptimizer.json"] = 555,
    ["importmap.json"] = 558,
    ["index.toml (packwiz)"] = 1444,
    instant_python_config = 562,
    instant_python_custom_project = 563,
    intlayer = 564,
    ["ioBroker Configuration"] = 565,
    ["ioBroker JSON UI"] = 566,
    ["ioBroker Package manifest"] = 567,
    ["ixpect.conf.yaml"] = 568,
    ["ize.toml"] = 1222,
    ["jsconfig.json"] = 594,
    ["jscpd Configuration"] = 1206,
    jsdoc = 1118,
    ["k3d.yaml"] = 595,
    ["k9s aliases.yaml"] = 597,
    ["k9s cluster-config.yaml"] = 599,
    ["k9s config.yaml"] = 598,
    ["k9s hotkeys.yaml"] = 600,
    ["k9s plugins.yaml"] = 601,
    ["k9s skin.yaml"] = 602,
    ["k9s views.yaml"] = 603,
    ["kind cluster"] = 617,
    ["kontinuous-config.yaml"] = 615,
    ["kontinuous-values.yaml"] = 614,
    ["kustomization.yaml"] = 618,
    ["label-commenter-config.yml"] = 619,
    ["latexindent configuration"] = 131,
    ["launchsettings.json"] = 620,
    lazydocker = 1244,
    lazygit = 1243,
    ["lego.json"] = 622,
    ["lerna.json"] = 623,
    ["lgtm.yml"] = 624,
    ["liblab.config.json"] = 625,
    ["libman.json"] = 626,
    ["license-report-config.json"] = 627,
    ["linkinator.config.json"] = 629,
    ["lint-staged (.lintstagedrc)"] = 1095,
    ["litertlm_manifest.json"] = 633,
    ["local.settings.json"] = 637,
    ["localazy.json"] = 638,
    ["lotus.yaml"] = 636,
    ["lsd colors"] = 135,
    ["lsd config"] = 134,
    ...
    lychee = 1094,
    ["macro.json"] = 1210,
    ["markdown-link-check"] = 1164,
    maturin = 1165,
    mboats = 1172,
    memnex = 1428,
    ["micro-settings.json"] = 1237,
    ["mimetypes.json"] = 655,
    ["mirrord config"] = 1098,
    ["misata.yaml"] = 1097,
    mise = 1099,
    ["mkdocs.yml"] = 675,
    ["mockd.yaml"] = 679,
    ["mod.pw.toml (packwiz)"] = 1445,
    ["modelparams.dev Model"] = 682,
    ["models CLI"] = 683,
    ["monospace.yml"] = 684,
    ["moon.yml"] = 1321,
    ["mprocs Configuration file"] = 1291,
    ["mrdocs.yml"] = 677,
    ["mta.yaml"] = 1100,
    ["mtad.yaml"] = 1101,
    ["mycode.json"] = 692,
    nFPM = 704,
    ["napari plugin manifest"] = 693,
    neoload = 1113,
    ["nest-cli"] = 707,
    ["nexus-rpc-gen"] = 1411,
    ["nf-core module environment.yml"] = 701,
    ["nf-core module meta.yml"] = 702,
    ["nf-core subworkflow meta.yml"] = 703,
    ["ninjs (News in JSON)"] = 706,
    ["nitro.json"] = 1112,
    ["nixd configuration"] = 1263,
    ["nlu.json"] = 708,
    ["nodemon.json"] = 711,
    ["noodl config"] = 1171,
    ["notebook.mod.json"] = 712,
    now = 1108,
    ["npm-badges"] = 715,
    ["nswag.json"] = 719,
    ntangle = 721,
    ["nuclei-template.yaml"] = 716,
    ["nuget-project.json"] = 717,
    ["ocelot.json"] = 723,
    ogen = 729,
    ["omnisharp.json"] = 732,
    openHAB = 1397,
    ...
    oxfmt = 1407,
    oxlint = 1408,
    ["pack.toml (packwiz)"] = 1446,
    ["package.json"] = 768,
    ["package.manifest"] = 770,
    ["package.yaml"] = 769,
    ["partial-black.json"] = 173,
    ["partial-fastapi.json"] = 174,
    ["partial-pixi.json"] = 780,
    ["partial-scheduled.json"] = 175,
    ["pattern.json"] = 778,
    ["petstore-v1.0"] = 1217,
    pgap_yaml_input_reader = 776,
    pgrls = 777,
    pgxgen = 1401,
    pitcms = 1404,
    ["pixi.toml"] = 779,
    ["plagiarize-me.yaml"] = 784,
    ["plagiarize.yaml"] = 783,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1328,
    ["podbard.yaml"] = 786,
    ["portman.json"] = 789,
    ["prefect.toml"] = 798,
    ["prefect.yaml"] = 799,
    ...
    ["prettierrc.json"] = 801,
    ["prisma.yml"] = 802,
    ["project-1.0.0-beta3.json"] = 814,
    ["project-1.0.0-beta4.json"] = 815,
    ["project-1.0.0-beta5.json"] = 816,
    ["project-1.0.0-beta6.json"] = 817,
    ["project-1.0.0-beta8.json"] = 818,
    ["project-1.0.0-rc1.json"] = 819,
    ["project-1.0.0-rc2.json"] = 820,
    ["project.json"] = 813,
    ["project.owasp.yaml"] = 821,
    ["prometheus-alertmanager.json"] = 825,
    ["prometheus.json"] = 822,
    ["prometheus.rules.json"] = 823,
    ["prometheus.rules.test.json"] = 824,
    ["proxies.json"] = 826,
    ["publiccode.yml"] = 827,
    ["pubspec.yaml"] = 828,
    ["pyrseas-0.8.json"] = 831,
    pytest = 840,
    ["quilt.mod.json"] = 1238,
    ["rc3 auth"] = 846,
    ["rc3 collection"] = 847,
    ...
    ["rc3 settings"] = 851,
    ["registry.yaml"] = 63,
    ["release drafter"] = 1114,
    ["release-hub.json"] = 10,
    ["release-please-config.json"] = 856,
    ["release-please-manifest.json"] = 857,
    ["release-plz.toml"] = 858,
    ["renv.lock"] = 873,
    ["reposets Configuration"] = 862,
    ["reposets Credentials"] = 863,
    ["revola.json"] = 8,
    ["rivet.json"] = 1262,
    ["rivet.yaml (legacy)"] = 1261,
    rumdl = 878,
    runny = 877,
    runspec = 1429,
    rustfmt = 879,
    ...
    samt = 882,
    samtrc = 883,
    ["sarif-1.0.0.json"] = 885,
    ["sarif-2.0.0.json"] = 886,
    ["sarif-2.1.0"] = 896,
    ["sarif-2.1.0-rtm.2"] = 887,
    ["sarif-2.1.0-rtm.3"] = 889,
    ["sarif-2.1.0-rtm.4"] = 891,
    ["sarif-2.1.0-rtm.5"] = 893,
    ["sarif-2.1.0-rtm.6"] = 894,
    ["sarif-external-property-file-2.1.0"] = 897,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 888,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 890,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 892,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 895,
    ["scalingo.json configuration"] = 898,
    ["schema.org - Action"] = 900,
    ["schema.org - ContactPoint"] = 901,
    ["schema.org - Place"] = 902,
    ["schema.org - Thing"] = 903,
    ["secrethub.yml"] = 1240,
    ["semantic-release"] = 911,
    servercn = 1457,
    ["servicehub.config.json"] = 1089,
    ["servicehub.service.json"] = 1088,
    ["settings.job"] = 914,
    ["sfdx-hardis configuration"] = 916,
    ["shard.yml"] = 1278,
    ["size-limit configuration"] = 921,
    ["skaffold.yaml"] = 1162,
    ["skill-map plugin extension manifest"] = 922,
    ["skill-map project settings"] = 923,
    ["skill-map provider kind"] = 924,
    ["skyuxconfig.json"] = 926,
    ["snowflake-config"] = 928,
    ["snowflake-connections"] = 929,
    ["spicepod.yaml"] = 1299,
    ["sqlc configuration"] = 963,
    ["stripe-app-local.json"] = 974,
    ["stripe-app.json"] = 973,
    swcrc = 1146,
    ["task.json"] = 987,
    taskcat = 1109,
    ["template.json"] = 992,
    ["templatsources.json"] = 993,
    ["text2confl config"] = 1409,
    ["theme.json"] = 1001,
    ["tizen_workspace.json"] = 1003,
    tldr = 1004,
    ["tm_devices configuration file"] = 1366,
    tmuxinator = 1092,
    tox = 1006,
    ["transcend.yml"] = 1015,
    ["tree-sitter grammar.json"] = 523,
    ["trime.yaml"] = 1016,
    ["trunk.yaml"] = 1019,
    ["ts-force-config.json"] = 1025,
    tsbuild = 1020,
    ["tsconfig.json"] = 1021,
    ["tsd.json"] = 1022,
    ["tsdoc.json"] = 1023,
    ...
    v8r = 1070,
    vcluster = 1285,
    ["vcpkg configuration file"] = 306,
    ["vcpkg manifest file"] = 305,
    ["vega-lite.json"] = 1051,
    ["vega.json"] = 1050,
    ["venvironment.yaml"] = 1053,
    ["venvplus.yaml"] = 1054,
    version = 1348,
    ["version.json"] = 1056,
    ["vhwdebugger-binding.yaml"] = 1058,
    ["vim-addon-info"] = 1059,
    ["vs-2017.3.host.json"] = 1062,
    ["vs-nesting.json"] = 1063,
    ["vsls.json"] = 1061,
    ["vss-extension.json"] = 1067,
    vtcfg = 1354,
    ["vtesttree.yaml"] = 1068,
    ["vtestunit.yaml"] = 1069,
    ["warp-keysets.json"] = 1246,
    ["warp-themes.json"] = 1247,
    ["warp-workflows.json"] = 1248,
    ["webhint.io"] = 1202,
    ["webjobpublishsettings.json"] = 1074,
    ["webjobs-list.json"] = 1073,
    ["well-known-fursona"] = 1286,
    ["xs-app.json"] = 1104,
    ["xunit.runner.json"] = 1087,
    ["yaml-workflow"] = 1456,
    yamlfmt = 1131,
    yamllint = 1132,
    ["yap.json"] = 1133,
