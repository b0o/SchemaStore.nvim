...
M.json = {
  ...
  index = {
    ...
    ["<div>RIOTS' studio configuration"] = 612,
    ...
    ["BX CI"] = 102,
    ["Bashly (bashly.yml)"] = 770,
    ["Bashly Settings (bashly-settings.yml)"] = 771,
    ["Better Code Hub"] = 681,
    ["Better Scripts"] = 103,
    Bigconfig = 81,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 778,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 767,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 803,
    GitVersion = 267,
    ...
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 788,
    ["JSON Schema Draft 7"] = 623,
    ["JSON Schema Draft 7 (unofficial strict)"] = 789,
    ...
    ["Micro Editor Syntax"] = 779,
    ["Microsoft Band Web Tile"] = 368,
    ["Minecraft Custom Main Menu Mod"] = 796,
    ...
    ["PocketMine plugin.yml"] = 443,
    ["Postman collection"] = 448,
    ["Problem object RFC9457"] = 793,
    ...
    ["Stylelint (.stylelintrc)"] = 553,
    ["Sublime Syntax"] = 757,
    ["Subsquid squid manifest"] = 802,
    ["Swagger API 2.0"] = 555,
    TSON = 580,
    TSTyche = 581,
    Talhelper = 557,
    ...
    ["Travis CI (.travis.yml)"] = 570,
    TunnelHub = 792,
    Turborepo = 569,
    Tye = 714,
    ["UET BuildConfig.json"] = 762,
    ["UI5 Manifest"] = 590,
    ["UNCORS configuration"] = 594,
    ["UTAM Page Object"] = 593,
    ["Ubuntu Server Autoinstall"] = 588,
    ...
    ["VSIX CLI publishing"] = 607,
    ["Vela Pipeline Configuration"] = 597,
    Vercel = 159,
    Visivo = 790,
    ["Web App Manifest"] = 614,
    ["Web types"] = 617,
    WebExtensions = 613,
    ...
    ["vega-lite.json"] = 596,
    ["vega.json"] = 595,
    ["venvironment-basic.yaml"] = 599,
    ["venvironment.yaml"] = 598,
    ["version.json"] = 600,
    ["vim-addon-info"] = 601,
    ["vs-2017.3.host.json"] = 603,
    ["vs-nesting.json"] = 604,
    ["vsls.json"] = 602,
    ["vss-extension.json"] = 608,
    ["vtesttree.yaml"] = 609,
    ["vtestunit.yaml"] = 610,
    ...
    ["webhint.io"] = 735,
    ["webjobpublishsettings.json"] = 616,
    ["webjobs-list.json"] = 615,
    ["xs-app.json"] = 646,
