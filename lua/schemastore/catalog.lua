...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 166,
    [".cryproj (generic)"] = 573,
    [".cryproj engine-5.2"] = 568,
    [".cryproj engine-5.3"] = 569,
    [".cryproj engine-5.4"] = 570,
    [".cryproj engine-5.5"] = 571,
    [".cryproj engine-dev"] = 572,
    [".csscomb.json"] = 168,
    [".csslintrc"] = 169,
    [".es6importsorterrc.json"] = 700,
    [".eslintrc"] = 215,
    [".esmrc.json"] = 207,
    [".ffizer.yaml"] = 219,
    [".htmlhintrc"] = 266,
    ...
    [".mtaext"] = 582,
    [".nodehawkrc"] = 361,
    [".npmpackagejsonlintrc"] = 364,
    [".phraseapp.yml"] = 404,
    [".pmbot.yml"] = 394,
    [".postcssrc"] = 399,
    [".powerpages-web-template-manifest"] = 401,
    [".pre-commit-config.yml"] = 402,
    [".pre-commit-hooks.yml"] = 403,
    [".putout.json"] = 422,
    [".rehyperc"] = 433,
    [".remarkrc"] = 434,
    [".sprite files"] = 487,
    ...
    ["<div>RIOTS' studio configuration"] = 552,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config schema"] = 323,
    ["API Builder"] = 613,
    ["AVA Configuration Schema"] = 670,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration Schema"] = 645,
    ["All Contributors configuration file"] = 699,
    ...
    ["Azure Pipelines"] = 54,
    ["Azure Static Web Apps CLI configuration file"] = 489,
    ["Azure Static Web Apps configuration file"] = 488,
    ["BX CI"] = 89,
    ["Better Code Hub"] = 618,
    ["Better Scripts"] = 90,
    BizTalkServerApplicationSchema = 588,
    ...
    ["Butane Config"] = 657,
    ["CICS TS region tagging"] = 664,
    ["CICS TS resource import"] = 665,
    ["CICS TS resource model"] = 666,
    ["CICS TS resource overrides"] = 667,
    ["CMake Presets"] = 91,
    ...
    ["Datadog Service Definition"] = 303,
    ["Datahub Ingestion Recipe Schema"] = 671,
    ...
    ["Embrace Config Schema"] = 682,
    ["Error pages"] = 210,
    Esquio = 208,
    ["Estuary Flow Catalog Schema"] = 661,
    ["Expo SDK"] = 213,
    ...
    Goreleaser = 248,
    ["Goreleaser Pro"] = 249,
    ["Gradle Build Cache Node"] = 615,
    ["Gradle Enterprise"] = 614,
    ["Grafana 5.x Dashboard"] = 250,
    ["GraphQL Code Generator"] = 253,
    ["GraphQL Config"] = 252,
    ["GraphQL Mesh"] = 251,
    ["Grunt JSHint task"] = 257,
    ["Grunt Watch task"] = 258,
    ["Grunt base task"] = 259,
    ["Grunt clean task"] = 255,
    ["Grunt copy task"] = 254,
    ["Grunt cssmin task"] = 256,
    HEMTT = 585,
    Hadolint = 597,
    Hammerkit = 625,
    ["Hardware Sentry Configuration"] = 675,
    Hayson = 261,
    ["Haystack Pipeline"] = 262,
    ["Hazelcast 5 Configuration"] = 263,
    ["Helm Chart.lock"] = 121,
    ["Helm Chart.yaml"] = 120,
    ["Helm Unittest Test Suite"] = 122,
    Hugo = 653,
    ["IBM Zapp document"] = 268,
    ["IBM zCodeFormatSettings"] = 269,
    ["IMG Catapult PSP"] = 274,
    ["Istanbul Schema"] = 678,
    ["JDownloader2 crawler multi-rule schema"] = 284,
    ["JDownloader2 crawler single-rule schema"] = 283,
    ["JFrog File Spec"] = 285,
    ["JFrog Pipelines YML DSL"] = 684,
    ["JMeter DSL cli config schema"] = 286,
    JReleaser = 288,
    ["JSON Document Transform"] = 295,
    ["JSON Feed"] = 296,
    ["JSON Resume"] = 440,
    ["JSON Schema Draft 2020-12"] = 564,
    ["JSON Schema Draft 4"] = 561,
    ["JSON Schema Draft 7"] = 562,
    ["JSON Schema Draft 8"] = 563,
    ...
    ["JSON-API"] = 294,
    ["JSON-e templates"] = 623,
    ["JSON-stat 2.0"] = 558,
    JSONPatch = 298,
    Jasmine = 279,
    Jekyll = 280,
    ["Jenkins X Pipelines"] = 281,
    ["Jenkins X Requirements"] = 282,
    ["Jovo Language Models"] = 287,
    ["KSP-AVC"] = 559,
    ["KSP-CKAN"] = 560,
    ["Karakum configuration file"] = 229,
    Kas = 301,
    ["Keycloak REST API"] = 691,
    ["Knative Functions - func.yaml"] = 230,
    ["KoDE/CI build.yaml"] = 680,
    ["Kong DBLess Schema"] = 681,
    KrakenD = 302,
    LOOBin = 318,
    Lefthook = 309,
    ["LinkML Metamodel"] = 316,
    Liquibase = 630,
    ["Liquibase Flow File"] = 631,
    ["Lively Properties"] = 317,
    Markdownlint = 634,
    ["Mason Registry"] = 636,
    ["MegaLinter configuration"] = 324,
    ["MegaLinter descriptor"] = 325,
    ["Meltano plugin discovery definition"] = 327,
    ["Meltano project definition"] = 326,
    ["Microsoft Band Web Tile"] = 328,
    ["Minecraft Data Pack Advancement"] = 330,
    ["Minecraft Data Pack Biome"] = 331,
    ["Minecraft Data Pack Configured Carver"] = 332,
    ["Minecraft Data Pack Damage Type"] = 333,
    ["Minecraft Data Pack Dimension"] = 335,
    ["Minecraft Data Pack Dimension Type"] = 334,
    ["Minecraft Data Pack Item Modifier"] = 336,
    ["Minecraft Data Pack Loot Table"] = 337,
    ["Minecraft Data Pack Metadata"] = 338,
    ["Minecraft Data Pack Predicate"] = 339,
    ["Minecraft Data Pack Recipe"] = 340,
    ["Minecraft Data Pack Tag"] = 341,
    ["Minecraft Data Pack Template Pool"] = 342,
    ["Minecraft Data Pack Trim Material"] = 347,
    ["Minecraft Data Pack Trim Pattern"] = 348,
    ["Minecraft Resource Pack Lang"] = 343,
    ["Minecraft Resource Pack Particle"] = 344,
    ["Minecraft Resource Pack Texture Mcmeta"] = 346,
    ["Minecraft Resourcepack Sounds"] = 345,
    ["MkDocs Configuration 1.0"] = 349,
    ["MongoDB Atlas Search Index Definition Schema"] = 679,
    ["Monika Configuration Schema"] = 677,
    ["Motif config"] = 581,
    ["NOX Framework (Service)"] = 363,
    ["Netin Diagnostic System Template"] = 640,
    ["Netlify config schema"] = 354,
    ["Nexus-as-Code schema"] = 355,
    ["Nightwatch.js"] = 356,
    ["ONe's service descriptor"] = 376,
    ["OSS Review Toolkit configuration"] = 383,
    ["OSS Review Toolkit curation"] = 384,
    ["OSS Review Toolkit package configuration"] = 385,
    ["OSS Review Toolkit repository configuration"] = 386,
    ["OSS Review Toolkit resolutions"] = 387,
    Opctl = 584,
    ["OpenRewrite Resource"] = 378,
    ["OpenWeather Current Weather API"] = 622,
    ["OpenWeather Road Risk API"] = 621,
    ["Ory Hydra configuration"] = 267,
    ["Ory Keto configuration"] = 304,
    ["Ory Kratos configuration"] = 382,
    ["Ory Oathkeeper configuration"] = 370,
    ["Outblocks App configuration"] = 380,
    ["Outblocks database table"] = 381,
    ["Outblocks project configuration"] = 379,
    Packer = 390,
    Pantsbuild = 698,
    ["Paper paper-plugin.yml"] = 391,
    ["Pipeline component"] = 632,
    ["PocketMine plugin.yml"] = 395,
    ["Postman collection"] = 400,
    Pterodactyl = 674,
    ["Pull Request Labeler"] = 421,
    Pulumi = 427,
    PyProject = 428,
    Pyright = 429,
    Qodana = 650,
    ["Quali Torque Blueprint Spec 2"] = 672,
    ["QueryFirst config file"] = 694,
    ["RKE Cluster Configuration JSON Schema"] = 629,
    ["RKE Cluster Configuration YAML Schema"] = 628,
    ["Rancher Fleet"] = 424,
    Ray = 596,
    ["Read the Docs"] = 426,
    ["Red-DiscordBot Cog"] = 430,
    ["Red-DiscordBot Cog Repo"] = 431,
    ["Red-DiscordBot Trivia"] = 432,
    Renovate = 441,
    ["Replit schema"] = 435,
    RoadRunner = 442,
    Ruff = 438,
    ["Rust Project"] = 439,
    ["Rust toolchain"] = 444,
    ["SIL Kit Participant Configuration"] = 475,
    ["SIL Kit Registry Configuration"] = 476,
    SWADL = 498,
    ["Safebox Config Schema"] = 685,
    ["Sapphire CLI Config"] = 447,
    ["SauceCTL Configuration"] = 637,
    ["Schema Catalog"] = 461,
    ["Scoop manifest"] = 466,
    ["Semantic Data Fabric (SDF) file"] = 467,
    ["Semgrep Rule"] = 469,
    ["Serenity Code Generator (Sergen)"] = 470,
    ["Serverless Framework Configuration"] = 644,
    ["Serverless Workflow Schema"] = 646,
    ["Settings.paf"] = 472,
    ["Shopware 6 Configuration"] = 647,
    ["Shopware CLI Extension Store Configuration"] = 648,
    ["Shopware CLI Project Store Configuration"] = 649,
    ["Sigrid scope configuration file"] = 474,
    ["Slack app manifest"] = 478,
    Solidarity = 481,
    ["Solution filters"] = 482,
    ["Source Maps v3"] = 483,
    Sourcery = 484,
    SpecIF = 485,
    ["Sponge Mixin configuration"] = 486,
    ["StackHawk Scanner Configuration"] = 643,
    Stale = 490,
    Starship = 491,
    ["Statamic Blueprint"] = 492,
    ["StrmPrivacy Data Connector"] = 689,
    ["StrmPrivacy Data Contract"] = 690,
    ["StrmPrivacy SimpleSchema"] = 687,
    ["StrmPrivacy Stream"] = 688,
    ["StrmPrivacy batch job configuration file"] = 686,
    ["Stryker Mutator"] = 495,
    ["StyleCop Analyzers Configuration"] = 496,
    ["Swagger API 2.0"] = 499,
    TSON = 524,
    ["Talisman configuration"] = 501,
    ["Taskfile YAML Schema"] = 624,
    Taurus = 502,
    ["TestEnvironment.json"] = 511,
    ["Tier.run pricing.json"] = 505,
    Tikibase = 506,
    ["Traefik v2"] = 514,
    ["Traefik v2 File Provider"] = 515,
    Turborepo = 512,
    Tye = 651,
    ["UET BuildConfig.json"] = 695,
    ["UI5 Manifest"] = 531,
    ["UTAM Page Object"] = 534,
    ["Ubuntu Server Autoinstall"] = 529,
    ["Uniswap Token List"] = 606,
    ["Unreal Engine Uplugin"] = 696,
    ["Unreal Engine Uproject"] = 697,
    Updatecli = 658,
    Uplift = 693,
    ["User Journey Map YAML Schema"] = 627,
    V2Ray = 662,
    ["VSCode Code Snippets"] = 138,
    ["VSIX CLI publishing"] = 547,
    ["Vela Pipeline Configuration"] = 537,
    Vercel = 137,
    ["Web App Manifest"] = 554,
    ["Web types"] = 557,
    WebExtensions = 553,
    ["Webman package recipe"] = 668,
    ["Windows Package Manager Installer Manifest"] = 603,
    ["Windows Package Manager Locale Manifest"] = 604,
    ["Windows Package Manager Singleton Manifest"] = 602,
    ["Woodpecker pipeline config"] = 639,
    ["Xstate Machine Schema"] = 656,
    ["Yippee-Ki-JSON configuration YML"] = 608,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 65,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 704,
    ["bashly-strings.yml"] = 705,
    ["bashly.yml"] = 703,
    ["batect.yml"] = 64,
    ["beau.yml"] = 617,
    ...
    ["ide.host.json"] = 270,
    ["ifstate.conf"] = 271,
    ["imageoptimizer.json"] = 272,
    ["importmap.json"] = 275,
    ["ioBroker Configuration"] = 276,
    ["ioBroker JSON UI"] = 277,
    ["ioBroker Package manifest"] = 278,
    ["ize.toml"] = 692,
    ["jsconfig.json"] = 299,
    ["jscpd Configuration Schema"] = 673,
    jsdoc = 595,
    ["k3d.yaml"] = 300,
    ["kontinuous-values.yaml"] = 305,
    ["kustomization.yaml"] = 306,
    ["label-commenter-config.yml"] = 307,
    ["launchsettings.json"] = 308,
    lazydocker = 714,
    lazygit = 713,
    ["lego.json"] = 310,
    ["lerna.json"] = 311,
    ["lgtm.yml"] = 312,
    ["libman.json"] = 313,
    ["license-report-config.json"] = 314,
    ["linkinator.config.json"] = 315,
    ["local.settings.json"] = 320,
    ["localazy.json"] = 321,
    ["lotus.yaml"] = 319,
    ["lsdlschema.json"] = 322,
    ["madness.yml"] = 702,
    ["markdown-lint-check"] = 635,
    mboats = 642,
    ["micro-settings.json"] = 707,
    ["mimetypes.json"] = 329,
    ["mirrord-schema"] = 578,
    ["mta.yaml"] = 579,
    ["mtad.yaml"] = 580,
    ["mycode.json"] = 352,
    ["napari plugin manifest"] = 353,
    neoload = 590,
    ["nest-cli"] = 359,
    ["ninjs (News in JSON) 1.3"] = 358,
    ["ninjs (News in JSON) 2.0"] = 357,
    ["nlu.json"] = 360,
    ["nodemon.json"] = 362,
    ["noodl.schema.json"] = 641,
    now = 586,
    ["npm-badges"] = 365,
    ["nswag.json"] = 368,
    ntangle = 369,
    ["nuclei-template.yaml"] = 366,
    ["nuget-project.json"] = 367,
    ["ocelot.json"] = 371,
    ["omnisharp.json"] = 372,
    ["openapi.json"] = 373,
    ["openfin.json"] = 377,
    ...
    ["ops.yaml"] = 375,
    ["package.json"] = 388,
    ["package.manifest"] = 389,
    ["pattern.json"] = 393,
    ["petstore-v1.0"] = 683,
    pgap_yaml_input_reader = 392,
    ["plagiarize-me.yaml"] = 397,
    ["plagiarize.yaml"] = 396,
    ["portman.json"] = 398,
    ["prettierrc.json"] = 405,
    ["prisma.yml"] = 406,
    ["project-1.0.0-beta3.json"] = 408,
    ["project-1.0.0-beta4.json"] = 409,
    ["project-1.0.0-beta5.json"] = 410,
    ["project-1.0.0-beta6.json"] = 411,
    ["project-1.0.0-beta8.json"] = 412,
    ["project-1.0.0-rc1.json"] = 413,
    ["project-1.0.0-rc2.json"] = 414,
    ["project.json"] = 407,
    ["prometheus.json"] = 415,
    ["prometheus.rules.json"] = 416,
    ["prometheus.rules.test.json"] = 417,
    ["proxies.json"] = 418,
    ["publiccode.yml"] = 419,
    ["pubspec.yaml"] = 420,
    ["pyrseas-0.8.json"] = 423,
    ["quilt.mod.json"] = 708,
    ["release drafter"] = 591,
    rtx = 437,
    rustfmt = 443,
    samt = 445,
    samtrc = 446,
    ["sarif-1.0.0.json"] = 448,
    ["sarif-2.0.0.json"] = 449,
    ["sarif-2.1.0"] = 459,
    ["sarif-2.1.0-rtm.2"] = 450,
    ["sarif-2.1.0-rtm.3"] = 452,
    ["sarif-2.1.0-rtm.4"] = 454,
    ["sarif-2.1.0-rtm.5"] = 456,
    ["sarif-2.1.0-rtm.6"] = 457,
    ["sarif-external-property-file-2.1.0"] = 460,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 451,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 453,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 455,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 458,
    ["schema.org - Action"] = 462,
    ["schema.org - ContactPoint"] = 463,
    ["schema.org - Place"] = 464,
    ["schema.org - Thing"] = 465,
    ["secrethub.yml"] = 710,
    ["semantic-release"] = 468,
    ["servicehub.config.json"] = 567,
    ["servicehub.service.json"] = 566,
    ["settings.job"] = 471,
    ["sfdx-hardis configuration"] = 473,
    ["size-limit configuration"] = 477,
    ["skaffold.yaml"] = 633,
    ["skyuxconfig.json"] = 479,
    snapcraft = 480,
    ["stripe-app-local.json"] = 494,
    ["stripe-app.json"] = 493,
    swcrc = 620,
    syntax = 712,
    ["task.json"] = 500,
    taskcat = 587,
    ["template.json"] = 503,
    ["templatsources.json"] = 504,
    ["theme.json"] = 507,
    ["tizen_workspace.json"] = 508,
    tldr = 509,
    tmLanguage = 510,
    tmuxinator = 575,
    ["transcend-pathfinder.yml"] = 517,
    ["transcend.yml"] = 516,
    ["trunk.yaml schema"] = 518,
    ["ts-force-config.json"] = 522,
    ["tsconfig.json"] = 519,
    ["tsd.json"] = 520,
    ["tsdrc.json"] = 521,
    ["tslint.json"] = 523,
    ...
    ["vega-lite.json"] = 536,
    ["vega.json"] = 535,
    ["venvironment-basic.yaml"] = 539,
    ["venvironment.yaml"] = 538,
    ["version.json"] = 540,
    ["vim-addon-info"] = 541,
    ["vs-2017.3.host.json"] = 543,
    ["vs-nesting.json"] = 544,
    ["vsls.json"] = 542,
    ["vss-extension.json"] = 548,
    ["vtesttree.yaml"] = 549,
    ["vtestunit.yaml"] = 550,
    ["webhint.io"] = 669,
    ["webjobpublishsettings.json"] = 556,
    ["webjobs-list.json"] = 555,
    ["xs-app.json"] = 583,
    ["xunit.runner.json"] = 565,
    yamllint = 607,
    zuul = 592,
    ["Žinoma"] = 601
  },
