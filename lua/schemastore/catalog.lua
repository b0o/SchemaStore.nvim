...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 990,
    [".nodehawkrc"] = 622,
    [".npmpackagejsonlintrc"] = 626,
    [".omletrc"] = 1170,
    [".phrase.yml"] = 704,
    [".phraseapp.yml"] = 705,
    [".pmbot.yml"] = 689,
    [".postcssrc"] = 698,
    [".powerpages-web-template-manifest"] = 700,
    [".pre-commit-config.yml"] = 701,
    [".pre-commit-hooks.yml"] = 702,
    [".putout.json"] = 738,
    [".rehyperc"] = 763,
    [".remarkrc"] = 767,
    [".sprite files"] = 863,
    ...
    AIConfig = 36,
    ["AMX Muse Program Descriptor"] = 1218,
    ["API Builder"] = 1026,
    ["AVA Configuration"] = 1089,
    ...
    ["AWS Copilot Manifest"] = 1257,
    ["AWS SAM CLI Samconfig"] = 274,
    Acton = 1307,
    ["Adobe UXP Manifest"] = 1152,
    ["Aerleon Network & Service Definitions"] = 22,
    ["Aerleon Policy"] = 23,
    ["Agent Permission Policy"] = 1297,
    ["AgentCore CLI"] = 1298,
    Aider = 1247,
    Air = 25,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1268,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1267,
    ["Airlock Microgateway"] = 37,
    ["Alacritty Configuration"] = 1061,
    ["AlgoVoi Compliance Receipt v1"] = 12,
    ["All Contributors configuration file"] = 1115,
    Anodizer = 448,
    ...
    ["Application list for a WinUtil"] = 1197,
    ArchitectFX = 1202,
    ["Argo CD"] = 56,
    ["Argo Events"] = 57,
    ["Argo Workflows"] = 58,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1266,
    ["Azure IoT Operations connector metadata"] = 1263,
    ...
    ["Azure Pipelines"] = 116,
    ["Azure Static Web Apps CLI configuration file"] = 867,
    ["Azure Static Web Apps configuration file"] = 866,
    BMML = 1285,
    ["BOSH CPI Config"] = 142,
    ...
    ["Bacon config"] = 6,
    ["Barba-CV"] = 85,
    ["Bashly (bashly.yml)"] = 1119,
    ["Bashly Settings (bashly-settings.yml)"] = 1120,
    Bento = 1284,
    ["Better Code Hub"] = 1031,
    ["Better Scripts"] = 165,
    Bigconfig = 135,
    ["Biome Formatter Config"] = 86,
    ["Bitmovin Encoding Template"] = 1211,
    BizTalkServerApplicationSchema = 997,
    Bleep = 166,
    ["Block Protocol Metadata"] = 163,
    ["Bluebricks blueprint config"] = 1290,
    ["Boyka Framework"] = 144,
    ...
    ["Butane Config"] = 1074,
    C4InterFlow = 1226,
    ["CDK Environment Manager, concrete environment configuration"] = 1250,
    ["CDK Environment Manager, concrete environments definition"] = 1249,
    ["CDK Environment Manager, environment definition"] = 1248,
    ["CGS Card Game Specification (cgs.json)"] = 1157,
    ["CICS TS region tagging"] = 1083,
    ["CICS TS resource import"] = 1084,
    ["CICS TS resource model"] = 1085,
    ["CICS TS resource overrides"] = 1086,
    ["CMake Presets"] = 167,
    ["CNC Codes"] = 189,
    ["CRS WAF test file"] = 1187,
    ["CRS WAF test platform overrides file"] = 1188,
    ...
    ["Caido Proxy Configuration"] = 1321,
    ...
    ["Chamaleon environment"] = 1215,
    ["Chamaleon properties"] = 1216,
    ["Chamaleon template"] = 1214,
    Changepacks = 1277,
    Changesets = 283,
    Changie = 176,
    Charmcraft = 177,
    ...
    ["Clawject config"] = 195,
    ["Cloud Foundry Application Manifest"] = 1169,
    ["Cloud Run Spec v1"] = 1192,
    ...
    Concord = 1186,
    ["Configu .cfgu files"] = 1174,
    ["Configu .configu file"] = 1175,
    Conjure = 188,
    ["Container Structure Test"] = 1011,
    Containerlab = 1040,
    ["Contextive Glossary"] = 1242,
    Convex = 187,
    ["Crowdsec collection config"] = 293,
    ["Crowdsec parser config"] = 294,
    ["Crowdsec scenario config"] = 295,
    ["CumulusCI Config"] = 194,
    ["Cursor Agent Environment"] = 1295,
    ["Custom Machinery Machine"] = 1158,
    ["Custom Machinery Recipe"] = 1159,
    ...
    ["DataYoga Job"] = 205,
    ["Datadog Continuous Testing"] = 534,
    ["Datadog Service Definition"] = 535,
    ["Datadog Software Catalog"] = 536,
    ["Datahub Ingestion Recipe"] = 1090,
    ["Debian Upstream Metadata file"] = 212,
    ["Deck config"] = 213,
    ["Declarative Automation Bundles"] = 1136,
    ["DeepMatch deeplinks spec"] = 214,
    ["Dein Config"] = 215,
    ["Deno Config (deno.json)"] = 311,
    ["Dependency cruiser"] = 216,
    ["DeployStack Configuration"] = 217,
    ["Deployah Configuration"] = 1265,
    ["Deployer Recipe"] = 314,
    ["Deta Spacefile"] = 218,
    ...
    ["DonateCaseBetterCasino menu"] = 1219,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1127,
    ["EAS config"] = 382,
    ["ECA - Editor Code Assistant"] = 346,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1116,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1262,
    ["EasyVCR .NET"] = 384,
    ["Eidolon Resource"] = 1203,
    ...
    ["Envelope Team Definition"] = 1306,
    ["Envilder Map File"] = 350,
    ["Erda Pipeline"] = 1165,
    ["Erda Runtime"] = 1166,
    ["Espanso config.yml"] = 1288,
    ["Espanso match.yml"] = 1287,
    Esquio = 370,
    ["Estuary Flow Catalog"] = 1080,
    ["Ethereum ERC1155"] = 1300,
    ["Ethereum ERC721"] = 1299,
    ...
    ["Evolving Resolutive Process notation"] = 1264,
    ["Expo SDK"] = 381,
    ...
    ["GeoJSON.json latest"] = 1078,
    GherKing = 1082,
    ["GitHub Action"] = 417,
    ["GitHub Actions typing"] = 1199,
    ...
    ["Google Digital Assetlinks"] = 1243,
    Goreleaser = 446,
    ["Goreleaser Pro"] = 447,
    Goss = 449,
    ["Gradle Build Cache Node"] = 1029,
    ["Gradle Enterprise"] = 1028,
    ...
    Hadolint = 1007,
    Hammerkit = 1039,
    ["Hardware Sentry Configuration"] = 1094,
    ...
    ["IVMS101 by CODE Protocol"] = 1155,
    ["Infinispan Configuration"] = 485,
    ["Infinispan Server Configuration"] = 486,
    Infrahub = 487,
    Istanbul = 1098,
    ["JDownloader2 crawler multi-rules"] = 501,
    ["JDownloader2 crawler single-rules"] = 500,
    ["JFrog Applications Config"] = 502,
    ["JFrog File Spec"] = 503,
    ["JFrog Pipelines YML DSL"] = 1104,
    ["JMeter DSL cli config"] = 504,
    JReleaser = 507,
    ["JSON Document Transform"] = 515,
    ["JSON Feed"] = 516,
    ["JSON Resume"] = 775,
    ["JSON Schema Draft 2020-12"] = 975,
    ["JSON Schema Draft 4"] = 972,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1137,
    ["JSON Schema Draft 7"] = 973,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1138,
    ["JSON Schema Draft 8 (2019-09)"] = 974,
    ["JSON-API"] = 514,
    ["JSON-e templates"] = 1036,
    ["JSON-stat 2.0"] = 968,
    JSONPatch = 518,
    ["JSR Package Config (jsr.json)"] = 508,
    Jarl = 1270,
    Jasmine = 495,
    Jekyll = 496,
    ["Jenkins X Pipelines"] = 497,
    ["Jenkins X Requirements"] = 498,
    Jest = 499,
    Jocker = 505,
    ["Jovo Language Models"] = 506,
    ["Jujutsu (jj) VCS config"] = 1256,
    ["KIMMDY config file"] = 529,
    ["KODE/CI build.yaml"] = 1100,
    ["KSP-AVC"] = 969,
    ["KSP-CKAN"] = 970,
    ["KSP-NetKAN"] = 971,
    KSY = 1167,
    ...
    Kas = 521,
    ["Kestra flow file"] = 530,
    ["Keycloak REST API"] = 1107,
    ["Knative Functions - func.yaml"] = 404,
    Knip = 405,
    ["Knowledge Unit"] = 538,
    ["Kometa (nightly) config file"] = 532,
    ["Kometa config file"] = 531,
    ["Kong DBLess config"] = 1101,
    KrakenD = 533,
    ["Kubri Configuration"] = 541,
    LOOBin = 556,
    ["Lake configuration file"] = 1259,
    ...
    ["Lando (landofile)"] = 112,
    ["LangGraph Platform configuration"] = 1179,
    ["Language configuration"] = 1178,
    Lefthook = 545,
    ["Liferay client-extension.yaml"] = 552,
    ["LinkML Metamodel"] = 554,
    Liquibase = 1045,
    ["Liquibase Flow File"] = 1046,
    ["Lively Properties"] = 555,
    ["Lobe AI Agent"] = 114,
    Loki = 115,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 598,
    ["MS2Rescore Configuration"] = 603,
    ["Madness (madness.yml)"] = 1118,
    ["Mado configuration"] = 562,
    ["Maestro Flow"] = 563,
    ["Mail Servers Configuration"] = 1291,
    ["MapEHR Mapping"] = 564,
    Markdownlint = 1049,
    ["Mason Registry"] = 1052,
    ["MegaLinter Custom Flavor"] = 567,
    ["MegaLinter configuration"] = 566,
    ["MegaLinter descriptor"] = 568,
    Melange = 1145,
    ["Meltano project definition"] = 569,
    ["Mergify Configuration"] = 604,
    ["Metadata for a Bazel module"] = 570,
    ["Metadata for a Cinnamon spice"] = 1195,
    ["Metatype Configuration"] = 571,
    ["MetricsHub Configuration"] = 572,
    ["MetricsHub Connector Configuration"] = 573,
    ["Micro Editor Syntax"] = 1128,
    ["Microsoft Band Web Tile"] = 574,
    ["Microsoft RulesEngine workflow rules"] = 1183,
    ["Microsoft RulesEngine workflow rules list"] = 1184,
    ["Minecraft Custom Main Menu Mod"] = 1146,
    ["Minecraft Data Pack Advancement"] = 576,
    ["Minecraft Data Pack Biome"] = 577,
    ["Minecraft Data Pack Configured Carver"] = 578,
    ["Minecraft Data Pack Damage Type"] = 579,
    ["Minecraft Data Pack Dimension"] = 581,
    ["Minecraft Data Pack Dimension Type"] = 580,
    ["Minecraft Data Pack Item Modifier"] = 582,
    ["Minecraft Data Pack Loot Table"] = 583,
    ["Minecraft Data Pack Metadata"] = 584,
    ["Minecraft Data Pack Predicate"] = 585,
    ["Minecraft Data Pack Recipe"] = 586,
    ["Minecraft Data Pack Tag"] = 587,
    ["Minecraft Data Pack Template Pool"] = 588,
    ["Minecraft Data Pack Trim Material"] = 593,
    ["Minecraft Data Pack Trim Pattern"] = 594,
    ["Minecraft Resource Pack Lang"] = 589,
    ["Minecraft Resource Pack Particle"] = 590,
    ["Minecraft Resource Pack Texture Mcmeta"] = 592,
    ["Minecraft Resourcepack Sounds"] = 591,
    ["MockServer Expectations"] = 600,
    ModuleAssembler = 596,
    ["Monade CLI Stack Configuration"] = 607,
    ["MongoDB Atlas Search Index Definition"] = 1099,
    ["Monika Configuration"] = 1097,
    ["Monoweave Configuration"] = 602,
    ["Motif config"] = 989,
    MultiQC = 1236,
    ["NOX Framework (Service)"] = 625,
    ["Netin Diagnostic System Template"] = 1056,
    ["Netlify config"] = 610,
    ["Network-as-Code Data Model"] = 611,
    ["Next Gen UI Agent A2A Server Configuration"] = 612,
    ["Next Gen UI Agent Configuration"] = 614,
    ["Next Gen UI Agent MCP Server Configuration"] = 613,
    ["Nightwatch.js"] = 618,
    ["Node.js configuration"] = 994,
    ["NueJS configuration file"] = 630,
    ["Nuitka Package Config"] = 1160,
    ["Nullstone config"] = 632,
    ["ONe's changelog entry"] = 651,
    ["ONe's service descriptor"] = 650,
    ["ORT Server repository environment configuration"] = 661,
    ["OSCAL Assessment Plan (AP)"] = 663,
    ["OSCAL Assessment Results (AR)"] = 664,
    ["OSCAL Catalog"] = 665,
    ["OSCAL Component Definition (CDef)"] = 666,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 667,
    ["OSCAL Profile"] = 668,
    ["OSCAL System Security Plan (SSP)"] = 669,
    ["OSS Review Toolkit configuration"] = 670,
    ["OSS Review Toolkit curation"] = 671,
    ["OSS Review Toolkit package configuration"] = 672,
    ["OSS Review Toolkit project package manager definition"] = 673,
    ["OSS Review Toolkit repository configuration"] = 674,
    ["OSS Review Toolkit resolutions"] = 675,
    ["October CMS columns"] = 636,
    ["October CMS fields"] = 637,
    ["Oh My Posh"] = 639,
    Okteto = 640,
    ["Ona Automations"] = 642,
    Opctl = 992,
    ["Open Data Contract Standard (ODCS)"] = 655,
    ["Open Data Product Standard (ODPS)"] = 656,
    ["Open Know-How"] = 1241,
    OpenDecree = 1304,
    ["OpenDecree Configuration"] = 1305,
    ["OpenRewrite Resource"] = 653,
    OpenSRM = 657,
    OpenStatus = 1252,
    ["OpenTelemetry Declarative Configuration"] = 654,
    ["OpenUtau character yaml"] = 647,
    ["OpenUtau ustx"] = 648,
    ["OpenWeather Current Weather API"] = 1035,
    ["OpenWeather Road Risk API"] = 1034,
    ["Ory Hydra configuration"] = 474,
    ["Ory Keto configuration"] = 537,
    ["Ory Kratos configuration"] = 662,
    ["Ory Oathkeeper configuration"] = 634,
    ["Outblocks App configuration"] = 659,
    ["Outblocks database table"] = 660,
    ["Outblocks project configuration"] = 658,
    PDM = 683,
    POPxf = 695,
    ["POPxf Correlations"] = 696,
    ["PRML manifest"] = 703,
    Packer = 679,
    PactSpec = 680,
    Panache = 681,
    Pantsbuild = 1114,
    ["Paper paper-plugin.yml"] = 682,
    ["Pipeline component"] = 1047,
    ["Platform.sh application"] = 8,
    ["Platform.sh routes"] = 9,
    ["Platform.sh services"] = 10,
    ["Plex Prerolls"] = 693,
    ["PocketMine plugin.yml"] = 690,
    ["Postman collection"] = 699,
    ["Power Pages Configuration"] = 1253,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1198,
    ["ProActions AI-Kit Configuration"] = 711,
    ["ProActions AI-Kit Configuration for Menus"] = 713,
    ["ProActions AI-Kit Configuration for Sections"] = 715,
    ["ProActions AI-Kit Configuration for Services"] = 712,
    ["ProActions AI-Kit Configuration for Steps"] = 716,
    ["ProActions AI-Kit Configuration for Templates"] = 714,
    ["Problem object RFC9457"] = 1143,
    ["Problem package format"] = 717,
    ["Problem package generators"] = 718,
    ["Problem package submissions"] = 719,
    ["Problem package test group metadata"] = 720,
    Pterodactyl = 1093,
    ["Pull Request Labeler"] = 737,
    Pulumi = 745,
    ["PyGTA Config"] = 741,
    PyProject = 746,
    Pylock = 1244,
    Pyright = 747,
    ["Python script metadata"] = 1238,
    ["QType AI DSL"] = 750,
    Qgoda = 749,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1315,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1313,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1319,
    ["Qlik Talend Cloud Pipeline - Project"] = 1311,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1314,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1316,
    ["Qlik Talend Cloud Pipeline - Task"] = 1312,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1318,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1317,
    Qodana = 1066,
    ["Qt Creator workspace file"] = 1176,
    ["Quali Torque Blueprint Spec 2"] = 1091,
    ["QueryFirst config file"] = 1110,
    ["QuikRun Configuration"] = 1320,
    ["Qwen Code Settings"] = 1301,
    ["RKE Cluster Configuration JSON"] = 1044,
    ["RKE Cluster Configuration YAML"] = 1043,
    RadioHound = 740,
    ["Raid Profile"] = 1302,
    ["Raid Repo Configuration"] = 1303,
    Railpack = 752,
    Railway = 751,
    ["Rancher Fleet"] = 742,
    ["Rattler-build"] = 753,
    Ray = 1006,
    ["Read the Docs"] = 744,
    ["Red-DiscordBot Cog"] = 760,
    ["Red-DiscordBot Cog Repo"] = 761,
    ["Red-DiscordBot Trivia"] = 762,
    ["Releasaurus Config"] = 5,
    ReleaseKit = 4,
    ["Render Blueprints"] = 1042,
    RenderCV = 779,
    Renovate = 776,
    ["Renovate global configuration"] = 777,
    ["Renovate inherited configuration"] = 778,
    ["Replit config"] = 768,
    Restate = 1231,
    ["Revel Digital Gadget Definition File"] = 1255,
    RoadRunner = 781,
    ["Robust Station Image"] = 1261,
    Rockcraft = 782,
    ["Roo Coder Custom Modes"] = 783,
    Rubocop = 772,
    ["Rudder techniques"] = 1150,
    Ruff = 773,
    ["Rust Project"] = 774,
    ["Rust toolchain"] = 788,
    ["SDMX data message"] = 815,
    ["SDMX metadata message"] = 814,
    ["SDMX structure message"] = 813,
    ["SIL Kit Participant Configuration"] = 825,
    ["SIL Kit Registry Configuration"] = 826,
    ["SPDX 2.3"] = 864,
    SWADL = 880,
    ["Safebox Config"] = 1105,
    ["Sapphire CLI Config"] = 791,
    ["SauceCTL Configuration"] = 1053,
    Scarb = 811,
    ["Schema Catalog"] = 806,
    ["Scoop manifest"] = 812,
    ["Semantic Data Fabric (SDF) file"] = 816,
    ["Semgrep Rule"] = 818,
    ["Serenity Code Generator (Sergen)"] = 819,
    ["Serverless Framework Configuration"] = 1060,
    ["Serverless Workflow"] = 1062,
    ["Settings for a Cinnamon spice"] = 1194,
    ["Settings.paf"] = 821,
    ["Shopware 6 Configuration"] = 1063,
    ["Shopware CLI Extension Store Configuration"] = 1064,
    ["Shopware CLI Project Store Configuration"] = 1065,
    ["Sigma Detection Rule"] = 823,
    ["Sigrid scope configuration file"] = 824,
    ["SkyPilot Task JSON"] = 1151,
    ["Slack app manifest"] = 828,
    Snapcraft = 830,
    ["Solarxy project config"] = 833,
    Solidarity = 834,
    ["Solution filters"] = 835,
    ["Source Maps v3"] = 836,
    Sourcery = 837,
    ["Spack bootstrap.yaml"] = 838,
    ["Spack cdash.yaml"] = 839,
    ["Spack ci.yaml"] = 840,
    ["Spack compilers.yaml"] = 841,
    ["Spack concretizer.yaml"] = 842,
    ["Spack config.yaml"] = 843,
    ["Spack definitions.yaml"] = 844,
    ["Spack develop.yaml"] = 845,
    ["Spack env_vars.yaml"] = 846,
    ["Spack environment"] = 852,
    ["Spack include.yaml"] = 847,
    ["Spack mirrors.yaml"] = 848,
    ["Spack modules.yaml"] = 849,
    ["Spack packages.yaml"] = 850,
    ["Spack repos.yaml"] = 851,
    ["Spack toolchains.yaml"] = 853,
    ["Spack upstreams.yaml"] = 854,
    ["Spack view.yaml"] = 855,
    ["Speakeasy Generation Config File"] = 859,
    ["Speakeasy Lint Configuration File"] = 856,
    ["Speakeasy Test Generation Configuration File"] = 857,
    ["Speakeasy Workflow File"] = 858,
    SpecIF = 860,
    ["Specmatic Configuration"] = 861,
    ["Sponge Mixin configuration"] = 862,
    StackBlitz = 868,
    ["StackHawk Scanner Configuration"] = 1059,
    Stale = 869,
    Starfish = 870,
    ["Starlake Data Pipeline"] = 1032,
    Starship = 871,
    ["Statamic Blueprint"] = 872,
    ["Stella configuration file"] = 873,
    ["Streamlit configuration file"] = 874,
    ["Stryker Mutator"] = 877,
    ["StyleCop Analyzers Configuration"] = 878,
    ["Stylelint (.stylelintrc)"] = 879,
    ["Stylua Config"] = 1245,
    ["Sublime Syntax"] = 1106,
    ["Subsquid squid manifest"] = 1153,
    ["Swagger API 2.0"] = 881,
    ["Synadia Connect Component"] = 882,
    TSON = 918,
    TSTyche = 919,
    ["TYPO3 Vendor Bundler config"] = 925,
    ["Tab data for a LinUtil"] = 1201,
    ["Tab list for a LinUtil"] = 1200,
    Tach = 883,
    ["Tach Domain"] = 884,
    Talhelper = 886,
    ["Talisman configuration"] = 887,
    Taplo = 1246,
    ["Taskfile config"] = 1037,
    Taurus = 888,
    Tauticord = 889,
    ["Tekton Pipeline"] = 1274,
    ["Tekton PipelineRun"] = 1275,
    ["Tekton Task"] = 1272,
    ["Tekton TaskRun"] = 1273,
    Telefonistka = 1232,
    ["Terrateam config"] = 1258,
    ["TestEnvironment.json"] = 901,
    ["TextMate Grammar"] = 900,
    Threagile = 895,
    ["Tier.run pricing.json"] = 892,
    Tikibase = 893,
    Tombi = 898,
    ["Traefik v2"] = 904,
    ["Traefik v2 File Provider"] = 905,
    ["Traefik v3"] = 906,
    ["Traefik v3 File Provider"] = 907,
    ["Travis CI (.travis.yml)"] = 903,
    Treefmt = 452,
    Trident = 1228,
    ["TrueScript for *.tscript files"] = 910,
    ["Tugboat QA config.yml"] = 1225,
    TunnelHub = 1141,
    Turborepo = 902,
    Tycho = 1190,
    Tye = 1067,
    ["Tyk Gateway - Open Source v5.7+"] = 1237,
    ["UET BuildConfig.json"] = 1111,
    ["UI5 Manifest"] = 931,
    ["UNCORS configuration"] = 936,
    ["UTAM Page Object"] = 934,
    ["Ubuntu Server Autoinstall"] = 929,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1229,
    ["Uniswap Token List"] = 1017,
    ["Universal Schedule Format"] = 937,
    ["Unreal Engine Uplugin"] = 1112,
    ["Unreal Engine Uproject"] = 1113,
    ["UpCloud CLI (upctl) configuration"] = 1230,
    ["Updatecli Compose"] = 1075,
    ["Updatecli Policy Manifest"] = 1076,
    ["Updatecli Policy Metadata"] = 1077,
    Uplift = 1109,
    ["Upsun config"] = 7,
    ["User Journey Map"] = 1041,
    V2Ray = 1081,
    ["VSCode Code Snippets"] = 258,
    ["VSIX CLI publishing"] = 955,
    Vector = 939,
    ["Vela Pipeline Configuration"] = 942,
    Vercel = 257,
    ["Version Bumper config"] = 945,
    Vespertide = 1279,
    ["Vespertide Migration"] = 1280,
    ["Vespertide Model"] = 1281,
    ["Viash Component Config"] = 1234,
    ["Viash Package Config"] = 1235,
    Visivo = 1139,
    ["WP-CLI"] = 965,
    Wake = 1227,
    ["Waku Config"] = 1204,
    ["Web App Manifest"] = 961,
    ["Web types"] = 964,
    WebExtensions = 960,
    ["Webman package recipe"] = 1087,
    ["Windows Package Manager Installer Manifest"] = 1014,
    ["Windows Package Manager Locale Manifest"] = 1015,
    ["Windows Package Manager Singleton Manifest"] = 1013,
    ["WireMock CLI import configuration"] = 1210,
    ["WireMock CLI local service configuration"] = 1209,
    ["WireMock message stub mapping"] = 1208,
    ["WireMock stub mapping"] = 1207,
    ["Woodpecker pipeline config"] = 1055,
    ["Wrangler CLI"] = 966,
    ["XenForo add-on manifest"] = 967,
    ["Xstate Machine"] = 1073,
    ["Yandex Workflow Language"] = 1196,
    ["Yarn Config (.yarnrc.yml)"] = 1030,
    ["Yippee-Ki-JSON configuration YML"] = 1021,
    ["YouTrack App"] = 1193,
    ["Zarf Package Configuration"] = 1260,
    ["Zerops import file"] = 1182,
    ["Zola Configuration"] = 1271,
    ["aerleon.yml"] = 21,
    ["amplify.yml"] = 14,
    ["amxx-builder manifest"] = 1322,
    ["angular.json"] = 38,
    apko = 1144,
    ...
    ["behat.yml"] = 145,
    ["bigquery-table"] = 134,
    ["bioimageio resource description"] = 1161,
    ...
    ["cargo-nextest repository configuration"] = 615,
    ["cargo-nextest user configuration"] = 616,
    ["ccmod.json"] = 1205,
    changelogging = 1173,
    ...
    ["chutzpah.json"] = 266,
    cibuildwheel = 182,
    ["clang-format (.clang-format)"] = 1079,
    ["clang-tidy"] = 243,
    clangd = 242,
    clib = 244,
    ...
    ["crowdin.yml"] = 292,
    ["ctfd-setup configuration file"] = 1217,
    ["custom-elements.json"] = 1131,
    ["cypress.json"] = 296,
    ["dacier.yml"] = 1310,
    ...
    ["gematik health care insurance list"] = 1223,
    ["gematik health care patient list"] = 1220,
    ["gematik health care provider institution list"] = 1222,
    ["gematik health care provider list"] = 1221,
    ["gematik tiger test environment configuration"] = 1224,
    ["git-town.toml"] = 1269,
    ["gitlab-ci"] = 426,
    ["global.json"] = 442,
    ...
    ["importmap.json"] = 484,
    instant_python_config = 488,
    instant_python_custom_project = 489,
    intlayer = 490,
    ["ioBroker Configuration"] = 491,
    ["ioBroker JSON UI"] = 492,
    ["ioBroker Package manifest"] = 493,
    ["ixpect.conf.yaml"] = 494,
    ["ize.toml"] = 1108,
    ["jsconfig.json"] = 519,
    ["jscpd Configuration"] = 1092,
    jsdoc = 1005,
    ["k3d.yaml"] = 520,
    ["k9s aliases.yaml"] = 522,
    ["k9s cluster-config.yaml"] = 524,
    ["k9s config.yaml"] = 523,
    ["k9s hotkeys.yaml"] = 525,
    ["k9s plugins.yaml"] = 526,
    ["k9s skin.yaml"] = 527,
    ["k9s views.yaml"] = 528,
    ["kontinuous-config.yaml"] = 540,
    ["kontinuous-values.yaml"] = 539,
    ["kustomization.yaml"] = 542,
    ["label-commenter-config.yml"] = 543,
    ["latexindent configuration"] = 113,
    ["launchsettings.json"] = 544,
    lazydocker = 1130,
    lazygit = 1129,
    ["lego.json"] = 546,
    ["lerna.json"] = 547,
    ["lgtm.yml"] = 548,
    ["liblab.config.json"] = 549,
    ["libman.json"] = 550,
    ["license-report-config.json"] = 551,
    ["linkinator.config.json"] = 553,
    ["lint-staged (.lintstagedrc)"] = 983,
    ["local.settings.json"] = 558,
    ["localazy.json"] = 559,
    ["lotus.yaml"] = 557,
    ["lsdlschema.json"] = 560,
    ["macro.json"] = 1096,
    ["markdown-link-check"] = 1050,
    maturin = 1051,
    mboats = 1058,
    memnex = 1308,
    ["micro-settings.json"] = 1123,
    ["mimetypes.json"] = 575,
    ["mirrord config"] = 985,
    mise = 986,
    ["mkdocs.yml"] = 595,
    ...
    ["monospace.yml"] = 601,
    ["moon.yml"] = 1206,
    ["mprocs Configuration file"] = 1177,
    ["mrdocs.yml"] = 597,
    ["mta.yaml"] = 987,
    ["mtad.yaml"] = 988,
    ["mycode.json"] = 608,
    nFPM = 617,
    ["napari plugin manifest"] = 609,
    neoload = 1000,
    ["nest-cli"] = 620,
    ["nexus-rpc-gen"] = 1296,
    ["ninjs (News in JSON)"] = 619,
    ["nitro.json"] = 999,
    ["nixd configuration"] = 1149,
    ["nlu.json"] = 621,
    ["nodemon.json"] = 623,
    ["noodl config"] = 1057,
    ["notebook.mod.json"] = 624,
    now = 995,
    ["npm-badges"] = 627,
    ["nswag.json"] = 631,
    ntangle = 633,
    ["nuclei-template.yaml"] = 628,
    ["nuget-project.json"] = 629,
    ["ocelot.json"] = 635,
    ogen = 638,
    ["omnisharp.json"] = 641,
    openHAB = 1282,
    ...
    oxlint = 1293,
    ["package.json"] = 676,
    ["package.manifest"] = 678,
    ["package.yaml"] = 677,
    ["partial-black.json"] = 146,
    ["partial-fastapi.json"] = 147,
    ["partial-pixi.json"] = 688,
    ["partial-scheduled.json"] = 148,
    ["pattern.json"] = 686,
    ["petstore-v1.0"] = 1103,
    pgap_yaml_input_reader = 684,
    pgrls = 685,
    pgxgen = 1286,
    pitcms = 1289,
    ["pixi.toml"] = 687,
    ["plagiarize-me.yaml"] = 692,
    ["plagiarize.yaml"] = 691,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1213,
    ["podbard.yaml"] = 694,
    ["portman.json"] = 697,
    ["prefect.toml"] = 706,
    ["prefect.yaml"] = 707,
    ...
    ["prettierrc.json"] = 709,
    ["prisma.yml"] = 710,
    ["project-1.0.0-beta3.json"] = 722,
    ["project-1.0.0-beta4.json"] = 723,
    ["project-1.0.0-beta5.json"] = 724,
    ["project-1.0.0-beta6.json"] = 725,
    ["project-1.0.0-beta8.json"] = 726,
    ["project-1.0.0-rc1.json"] = 727,
    ["project-1.0.0-rc2.json"] = 728,
    ["project.json"] = 721,
    ["project.owasp.yaml"] = 729,
    ["prometheus-alertmanager.json"] = 733,
    ["prometheus.json"] = 730,
    ["prometheus.rules.json"] = 731,
    ["prometheus.rules.test.json"] = 732,
    ["proxies.json"] = 734,
    ["publiccode.yml"] = 735,
    ["pubspec.yaml"] = 736,
    ["pyrseas-0.8.json"] = 739,
    pytest = 748,
    ["quilt.mod.json"] = 1124,
    ["rc3 auth"] = 754,
    ["rc3 collection"] = 755,
    ...
    ["rc3 settings"] = 759,
    ["registry.yaml"] = 51,
    ["release drafter"] = 1001,
    ["release-hub.json"] = 3,
    ["release-please-config.json"] = 764,
    ["release-please-manifest.json"] = 765,
    ["release-plz.toml"] = 766,
    ["renv.lock"] = 780,
    ["reposets Configuration"] = 769,
    ["reposets Credentials"] = 770,
    ["revola.json"] = 1,
    ["rivet.json"] = 1148,
    ["rivet.yaml (legacy)"] = 1147,
    rumdl = 785,
    runny = 784,
    runspec = 1309,
    rustfmt = 786,
    ...
    samt = 789,
    samtrc = 790,
    ["sarif-1.0.0.json"] = 792,
    ["sarif-2.0.0.json"] = 793,
    ["sarif-2.1.0"] = 803,
    ["sarif-2.1.0-rtm.2"] = 794,
    ["sarif-2.1.0-rtm.3"] = 796,
    ["sarif-2.1.0-rtm.4"] = 798,
    ["sarif-2.1.0-rtm.5"] = 800,
    ["sarif-2.1.0-rtm.6"] = 801,
    ["sarif-external-property-file-2.1.0"] = 804,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 795,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 797,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 799,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 802,
    ["scalingo.json configuration"] = 805,
    ["schema.org - Action"] = 807,
    ["schema.org - ContactPoint"] = 808,
    ["schema.org - Place"] = 809,
    ["schema.org - Thing"] = 810,
    ["secrethub.yml"] = 1126,
    ["semantic-release"] = 817,
    ["servicehub.config.json"] = 978,
    ["servicehub.service.json"] = 977,
    ["settings.job"] = 820,
    ["sfdx-hardis configuration"] = 822,
    ["shard.yml"] = 1164,
    ["size-limit configuration"] = 827,
    ["skaffold.yaml"] = 1048,
    ["skyuxconfig.json"] = 829,
    ["snowflake-config"] = 831,
    ["snowflake-connections"] = 832,
    ["spicepod.yaml"] = 1185,
    ["sqlc configuration"] = 865,
    ["stripe-app-local.json"] = 876,
    ["stripe-app.json"] = 875,
    swcrc = 1033,
    ["task.json"] = 885,
    taskcat = 996,
    ["template.json"] = 890,
    ["templatsources.json"] = 891,
    ["text2confl config"] = 1294,
    ["theme.json"] = 894,
    ["tizen_workspace.json"] = 896,
    tldr = 897,
    ["tm_devices configuration file"] = 1251,
    tmuxinator = 981,
    tox = 899,
    ["transcend.yml"] = 908,
    ...
    ["vega-lite.json"] = 941,
    ["vega.json"] = 940,
    ["venvironment.yaml"] = 943,
    ["venvplus.yaml"] = 944,
    version = 1233,
    ["version.json"] = 946,
    ["vhwdebugger-binding.yaml"] = 948,
    ["vim-addon-info"] = 949,
    ["vs-2017.3.host.json"] = 951,
    ["vs-nesting.json"] = 952,
    ["vsls.json"] = 950,
    ["vss-extension.json"] = 956,
    vtcfg = 1239,
    ["vtesttree.yaml"] = 957,
    ["vtestunit.yaml"] = 958,
    ["warp-keysets.json"] = 1132,
    ["warp-themes.json"] = 1133,
    ["warp-workflows.json"] = 1134,
    ["webhint.io"] = 1088,
    ["webjobpublishsettings.json"] = 963,
    ["webjobs-list.json"] = 962,
    ["well-known-fursona"] = 1172,
    ["xs-app.json"] = 991,
    ["xunit.runner.json"] = 976,
    yamlfmt = 1018,
    yamllint = 1019,
    ["yap.json"] = 1020,
    ["zerops.yml"] = 1181,
