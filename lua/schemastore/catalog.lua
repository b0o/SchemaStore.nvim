...
M.json = {
  ...
  index = {
    ...
    ["Ansible Argument Specs"] = 307,
    ["Ansible Collection Galaxy"] = 314,
    ["Ansible Execution Environment"] = 304,
    ["Ansible Inventory"] = 313,
    ["Ansible Meta"] = 305,
    ["Ansible Meta Runtime"] = 306,
    ["Ansible Navigator Configuration"] = 316,
    ["Ansible Playbook"] = 311,
    ["Ansible Requirements"] = 308,
    ["Ansible Rulebook"] = 312,
    ["Ansible Tasks File"] = 310,
    ["Ansible Vars File"] = 309,
    ["Ansible-lint Configuration"] = 315,
    Any = 898,
    ...
    ["DWP Exchange - catalogue entry"] = 247,
    ["DWP Exchange - gateway"] = 245,
    ["DWP Exchange - meta"] = 246,
    ...
    ["Dolittle Bounded Context Configuration"] = 228,
    ["Dolittle Event Horizons Configuration"] = 229,
    ["Dolittle Resources Configuration"] = 230,
    ["Dolittle Server Configuration"] = 231,
    ["Dolittle Tenant Map Configuration"] = 233,
    ["Dolittle Tenants Configuration"] = 232,
    ["Dolittle Topology"] = 234,
    ...
    ["Drupal Routing"] = 142,
    ["Drupal Services"] = 144,
    ["Drush site aliases"] = 240,
    ["Dynamic Bash Aliases (.aliases)"] = 848,
    ["EAS config"] = 265,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 837,
    ["Elgato Stream Deck"] = 250,
    ["Embrace Config"] = 818,
    Endurica = 861,
    ["Enterprise Contract Policy Spec"] = 251,
    ["Erda Pipeline"] = 884,
    ["Erda Runtime"] = 885,
    ["Error pages"] = 255,
    Esquio = 253,
    ["Estuary Flow Catalog"] = 797,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 258,
    ["EveryVoice TTS Toolkit Data Configuration"] = 259,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 263,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 262,
    ["EveryVoice TTS Toolkit Text Configuration"] = 260,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 261,
    ["Expo SDK"] = 264,
    ["F-Droid Data metadata"] = 270,
    ["Facets - FSDL - Application"] = 268,
    ["FasterCI Configuration"] = 60,
    FiQuS = 274,
    Firebase = 272,
    ["Flow.json Configurations"] = 881,
    ["Fossa configuration file"] = 281,
    ["Fossa's fossa-deps file"] = 282,
    ["Foundry VTT - Base package Manifest"] = 276,
    ["Foundry VTT - Module Manifest"] = 277,
    ["Foundry VTT - System Data Template"] = 280,
    ["Foundry VTT - System Manifest"] = 278,
    ["Foundry VTT - World Manifest"] = 279,
    ["Foxx Manifest"] = 61,
    ["Freifunk.de Community API"] = 64,
    ["Frogbot Config"] = 65,
    ["G2P Mapping Configuration"] = 286,
    ["GCP Blueprint Metadata"] = 289,
    Gaspar = 287,
    ["GatewayCore API Gateway"] = 288,
    ["GeoJSON.json latest"] = 795,
    GherKing = 799,
    ["GitHub Action"] = 294,
    ["GitHub Discussion"] = 295,
    ["GitHub Funding"] = 296,
    ["GitHub Issue Template configuration"] = 298,
    ["GitHub Issue Template forms"] = 297,
    ["GitHub Workflow"] = 299,
    ["GitHub Workflow Template Properties"] = 300,
    ["GitHub automatically generated release notes configuration"] = 301,
    ["GitLab Agent for Kubernetes configuration"] = 873,
    GitVersion = 291,
    ["Gitea Issue Template configuration"] = 292,
    ["Gitea Issue Template forms"] = 293,
    ["Gitpod Configuration"] = 303,
    ["GlazeWM settings"] = 875,
    ["Global Privacy Control"] = 290,
    Goblet = 856,
    ["Golangci-lint Configuration"] = 318,
    ["Golangci-lint Custom Plugins Configuration"] = 319,
    ["Google Chrome Related Website Sets"] = 273,
    ...
    ["KSP-CKAN"] = 690,
    KSY = 886,
    ["Karakum configuration file"] = 283,
    Kas = 381,
    ["Keycloak REST API"] = 828,
    ["Knative Functions - func.yaml"] = 284,
    ...
    ["devspace.yaml"] = 812,
    djlint = 744,
    ["docker sequencer"] = 225,
    ["docker-compose.yml"] = 742,
    ["dockerd.json"] = 224,
    ["dotnet Release Index manifest"] = 235,
    ["dotnet-tools.json"] = 236,
    ["dotnetcli.host.json"] = 237,
    ["dprint.json"] = 238,
    ["drone.json"] = 239,
    ["dss-2.0.0.json"] = 241,
    ["dstack configuration"] = 242,
    ["dvc.yaml"] = 243,
    ["ecosystem.json"] = 248,
    eksctl = 249,
    ["electron-builder configuration file"] = 256,
    ["epr-manifest.json"] = 254,
    ["evcc.yaml"] = 257,
    ["ezd task runner"] = 266,
    ["fabric.mod.json"] = 269,
    ["first-timers-bot"] = 275,
