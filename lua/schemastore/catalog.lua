...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 149,
    [".cryproj (generic)"] = 501,
    [".cryproj engine-5.2"] = 496,
    [".cryproj engine-5.3"] = 497,
    [".cryproj engine-5.4"] = 498,
    [".cryproj engine-5.5"] = 499,
    [".cryproj engine-dev"] = 500,
    [".csscomb.json"] = 151,
    [".csslintrc"] = 152,
    [".eslintrc"] = 197,
    [".esmrc.json"] = 189,
    ...
    [".mtaext"] = 510,
    [".nodehawkrc"] = 317,
    [".npmpackagejsonlintrc"] = 320,
    [".phraseapp.yml"] = 354,
    [".pmbot.yml"] = 346,
    [".postcssrc"] = 351,
    [".pre-commit-config.yml"] = 352,
    [".pre-commit-hooks.yml"] = 353,
    [".putout.json"] = 371,
    [".rehyperc"] = 378,
    [".remarkrc"] = 379,
    [".sprite files"] = 422,
    ...
    [".vsext"] = 476,
    [".yarnrc.yml"] = 542,
    ["<div>RIOTS' studio configuration"] = 480,
    ["@factorial/drupal-breakpoints-css"] = 5,
    ["A micro editor config schema"] = 286,
    ["API Builder"] = 539,
    ["AVA Configuration Schema"] = 595,
    ...
    ["Azure Pipelines"] = 47,
    ["Azure Static Web Apps CLI configuration file"] = 424,
    ["Azure Static Web Apps configuration file"] = 423,
    ["BX CI"] = 81,
    ["Better Code Hub"] = 544,
    ["Better Scripts"] = 82,
    BizTalkServerApplicationSchema = 516,
    ...
    ["Butane Config"] = 582,
    ["CICS TS region tagging"] = 589,
    ["CICS TS resource import"] = 590,
    ["CICS TS resource model"] = 591,
    ["CICS TS resource overrides"] = 592,
    ["CMake Presets"] = 83,
    ...
    ["Datahub Ingestion Recipe Schema"] = 596,
    ...
    ["Embrace Config Schema"] = 607,
    ["Error pages"] = 192,
    Esquio = 190,
    ["Estuary Flow Catalog Schema"] = 586,
    ["Expo SDK"] = 195,
    ...
    Goreleaser = 223,
    ["Goreleaser Pro"] = 224,
    ["Gradle Build Cache Node"] = 541,
    ["Gradle Enterprise"] = 540,
    ...
    Hadolint = 525,
    Hammerkit = 551,
    ["Hardware Sentry Configuration"] = 600,
    Hayson = 236,
    ...
    ["JFrog File Spec"] = 255,
    ["JFrog Pipelines YML DSL"] = 609,
    ["JSON Document Transform"] = 263,
    ["JSON Feed"] = 264,
    ["JSON Resume"] = 384,
    ["JSON Schema Draft 2020-12"] = 492,
    ["JSON Schema Draft 4"] = 489,
    ["JSON Schema Draft 7"] = 490,
    ["JSON Schema Draft 8"] = 491,
    ...
    ["KSP-AVC"] = 487,
    ["KSP-CKAN"] = 488,
    ["Keycloak REST API"] = 615,
    ["Knative Functions - func.yaml"] = 207,
    ["KoDE/CI build.yaml"] = 605,
    ["Kong DBLess Schema"] = 606,
    KrakenD = 269,
    ["LinkML Metamodel"] = 281,
    Liquibase = 556,
    ["Liquibase Flow File"] = 557,
    ["Lively Properties"] = 282,
    Markdownlint = 560,
    ["MegaLinter configuration"] = 287,
    ["MegaLinter descriptor"] = 288,
    ["Meltano plugin discovery definition"] = 290,
    ["Meltano project definition"] = 289,
    ["Microsoft Band Web Tile"] = 291,
    ["Minecraft Data Pack Advancement"] = 293,
    ["Minecraft Data Pack Biome"] = 294,
    ["Minecraft Data Pack Configured Carver"] = 295,
    ["Minecraft Data Pack Dimension"] = 297,
    ["Minecraft Data Pack Dimension Type"] = 296,
    ["Minecraft Data Pack Item Modifier"] = 298,
    ["Minecraft Data Pack Loot Table"] = 299,
    ["Minecraft Data Pack Metadata"] = 300,
    ["Minecraft Data Pack Predicate"] = 301,
    ["Minecraft Data Pack Recipe"] = 302,
    ["Minecraft Data Pack Tag"] = 303,
    ["Minecraft Data Pack Template Pool"] = 304,
    ["Minecraft Resourcepack Sounds"] = 305,
    ["MkDocs Configuration 1.0"] = 306,
    ["MongoDB Atlas Search Index Definition Schema"] = 604,
    ["Monika Configuration Schema"] = 602,
    ["Motif config"] = 509,
    ["NOX Framework (Service)"] = 319,
    ["Netin Diagnostic System Template"] = 565,
    ["Netlify config schema"] = 311,
    ["Nightwatch.js"] = 312,
    ["OSS Review Toolkit configuration"] = 336,
    ["OSS Review Toolkit curation"] = 337,
    ["OSS Review Toolkit package configuration"] = 338,
    ["OSS Review Toolkit repository configuration"] = 339,
    ["OSS Review Toolkit resolutions"] = 340,
    Opctl = 512,
    ["OpenWeather Current Weather API"] = 548,
    ["OpenWeather Road Risk API"] = 547,
    ["Ory Hydra configuration"] = 242,
    ["Ory Keto configuration"] = 271,
    ["Ory Kratos configuration"] = 335,
    ["Ory Oathkeeper configuration"] = 326,
    ["Outblocks App configuration"] = 333,
    ["Outblocks database table"] = 334,
    ["Outblocks project configuration"] = 332,
    Packer = 343,
    Pantsbuild = 621,
    ["Pipeline component"] = 558,
    ["PocketMine plugin.yml"] = 347,
    Pterodactyl = 599,
    ["Pull Request Labeler"] = 370,
    Pulumi = 374,
    PyProject = 375,
    Qodana = 575,
    ["Quali Torque Blueprint Spec 2"] = 597,
    ["QueryFirst config file"] = 618,
    ["RKE Cluster Configuration JSON Schema"] = 555,
    ["RKE Cluster Configuration YAML Schema"] = 554,
    Ray = 524,
    ["Read the Docs"] = 373,
    ["Red-DiscordBot Cog"] = 376,
    ["Red-DiscordBot Cog Repo"] = 377,
    Renovate = 385,
    ["Replit schema"] = 380,
    RoadRunner = 386,
    Ruff = 382,
    ["Rust Project"] = 383,
    ["Rust toolchain"] = 388,
    ["SIL Kit Participant Configuration"] = 413,
    SWADL = 433,
    ["Sapphire CLI Config"] = 389,
    ["SauceCTL Configuration"] = 562,
    ["Schema Catalog"] = 402,
    ["Scoop manifest"] = 407,
    ["Semgrep Rule"] = 409,
    ["Serverless Framework Configuration"] = 569,
    ["Serverless Workflow Schema"] = 571,
    ["Settings.paf"] = 411,
    ["Shopware 6 Configuration"] = 572,
    ["Shopware CLI Extension Store Configuration"] = 573,
    ["Shopware CLI Project Store Configuration"] = 574,
    Solidarity = 417,
    ["Solution filters"] = 418,
    ["Source Maps v3"] = 419,
    SpecIF = 420,
    ["Sponge Mixin configuration"] = 421,
    ["StackHawk Scanner Configuration"] = 568,
    Stale = 425,
    Starship = 426,
    ["Statamic Blueprint"] = 427,
    ["StrmPrivacy Data Connector"] = 613,
    ["StrmPrivacy Data Contract"] = 614,
    ["StrmPrivacy SimpleSchema"] = 611,
    ["StrmPrivacy Stream"] = 612,
    ["StrmPrivacy batch job configuration file"] = 610,
    ["Stryker Mutator"] = 430,
    ["StyleCop Analyzers Configuration"] = 431,
    ["Swagger API 2.0"] = 434,
    TSON = 454,
    ["Talisman configuration"] = 435,
    ["Taskfile YAML Schema"] = 550,
    Taurus = 436,
    ["TestEnvironment.json"] = 443,
    Tikibase = 439,
    ["Traefik v2"] = 446,
    ["Traefik v2 File Provider"] = 447,
    Turborepo = 444,
    Tye = 576,
    ["UI5 Manifest"] = 461,
    ["UTAM Page Object"] = 464,
    ["Ubuntu Server Autoinstall"] = 459,
    ["Uniswap Token List"] = 533,
    ["Unreal Engine Uplugin"] = 619,
    ["Unreal Engine Uproject"] = 620,
    Updatecli = 583,
    Uplift = 617,
    ["User Journey Map YAML Schema"] = 553,
    V2Ray = 587,
    ["VSCode Code Snippets"] = 125,
    ["VSIX CLI publishing"] = 477,
    ["Vela Pipeline Configuration"] = 467,
    Vercel = 124,
    ["Web App Manifest"] = 482,
    ["Web types"] = 485,
    WebExtensions = 481,
    ["Webman package recipe"] = 593,
    ["Windows Package Manager Installer Manifest"] = 530,
    ["Windows Package Manager Locale Manifest"] = 531,
    ["Windows Package Manager Singleton Manifest"] = 529,
    ["Woodpecker pipeline config"] = 564,
    ["Xstate Machine Schema"] = 581,
    ["Yippee-Ki-JSON configuration YML"] = 535,
    ["angular.json"] = 11,
    ...
    ["ize.toml"] = 616,
    ["jsconfig.json"] = 267,
    ["jscpd Configuration Schema"] = 598,
    jsdoc = 523,
    ["k3d.yaml"] = 268,
    ...
    ["local.settings.json"] = 283,
    ["localazy.json"] = 284,
    ["lsdlschema.json"] = 285,
    ["markdown-lint-check"] = 561,
    mboats = 567,
    ["mimetypes.json"] = 292,
    ["mirrord-schema"] = 506,
    ["mta.yaml"] = 507,
    ["mtad.yaml"] = 508,
    ["mycode.json"] = 309,
    ["napari plugin manifest"] = 310,
    neoload = 518,
    ["nest-cli"] = 315,
    ["ninjs (News in JSON) 1.3"] = 314,
    ["ninjs (News in JSON) 2.0"] = 313,
    ["nlu.json"] = 316,
    ["nodemon.json"] = 318,
    ["noodl.schema.json"] = 566,
    now = 514,
    ["npm-badges"] = 321,
    ["nswag.json"] = 324,
    ntangle = 325,
    ["nuclei-template.yaml"] = 322,
    ["nuget-project.json"] = 323,
    ["ocelot.json"] = 327,
    ["omnisharp.json"] = 328,
    ["openapi.json"] = 329,
    ["openfin.json"] = 331,
    ["openrpc.json"] = 330,
    ["package.json"] = 341,
    ["package.manifest"] = 342,
    ["pattern.json"] = 345,
    ["petstore-v1.0"] = 608,
    pgap_yaml_input_reader = 344,
    ["plagiarize-me.yaml"] = 349,
    ["plagiarize.yaml"] = 348,
    ["portman.json"] = 350,
    ["prettierrc.json"] = 355,
    ["prisma.yml"] = 356,
    ["project-1.0.0-beta3.json"] = 358,
    ["project-1.0.0-beta4.json"] = 359,
    ["project-1.0.0-beta5.json"] = 360,
    ["project-1.0.0-beta6.json"] = 361,
    ["project-1.0.0-beta8.json"] = 362,
    ["project-1.0.0-rc1.json"] = 363,
    ["project-1.0.0-rc2.json"] = 364,
    ["project.json"] = 357,
    ["prometheus.json"] = 365,
    ["prometheus.rules.json"] = 366,
    ["proxies.json"] = 367,
    ["publiccode.yml"] = 368,
    ["pubspec.yaml"] = 369,
    ["pyrseas-0.8.json"] = 372,
    ["release drafter"] = 519,
    rustfmt = 387,
    ["sarif-1.0.0.json"] = 390,
    ["sarif-2.0.0.json"] = 391,
    ["sarif-2.1.0"] = 400,
    ["sarif-2.1.0-rtm.2"] = 392,
    ["sarif-2.1.0-rtm.3"] = 394,
    ["sarif-2.1.0-rtm.4"] = 396,
    ["sarif-2.1.0-rtm.5"] = 398,
    ["sarif-external-property-file-2.1.0"] = 401,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 393,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 395,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 397,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 399,
    ["schema.org - Action"] = 403,
    ["schema.org - ContactPoint"] = 404,
    ["schema.org - Place"] = 405,
    ["schema.org - Thing"] = 406,
    ["semantic-release"] = 408,
    ["servicehub.config.json"] = 495,
    ["servicehub.service.json"] = 494,
    ["settings.job"] = 410,
    ["sfdx-hardis configuration"] = 412,
    ["size-limit configuration"] = 414,
    ["skaffold.yaml"] = 559,
    ["skyuxconfig.json"] = 415,
    snapcraft = 416,
    ["stripe-app-local.json"] = 429,
    ["stripe-app.json"] = 428,
    swcrc = 546,
    taskcat = 515,
    ["template.json"] = 437,
    ["templatsources.json"] = 438,
    ["theme.json"] = 440,
    ["tizen_workspace.json"] = 441,
    tmLanguage = 442,
    tmuxinator = 503,
    ["trunk.yaml schema"] = 448,
    ["ts-force-config.json"] = 452,
    ["tsconfig.json"] = 449,
    ["tsd.json"] = 450,
    ["tsdrc.json"] = 451,
    ["tslint.json"] = 453,
    ...
    ["vega-lite.json"] = 466,
    ["vega.json"] = 465,
    ["venvironment-basic.yaml"] = 469,
    ["venvironment.yaml"] = 468,
    ["version.json"] = 470,
    ["vim-addon-info"] = 471,
    ["vs-2017.3.host.json"] = 473,
    ["vs-nesting.json"] = 474,
    ["vsls.json"] = 472,
    ["vss-extension.json"] = 478,
    ["webhint.io"] = 594,
    ["webjobpublishsettings.json"] = 484,
    ["webjobs-list.json"] = 483,
    ["xs-app.json"] = 511,
    ["xunit.runner.json"] = 493,
    yamllint = 534,
    zuul = 520,
    ["Žinoma"] = 528
  },
