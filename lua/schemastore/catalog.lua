...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 161,
    [".cryproj (generic)"] = 555,
    [".cryproj engine-5.2"] = 550,
    [".cryproj engine-5.3"] = 551,
    [".cryproj engine-5.4"] = 552,
    [".cryproj engine-5.5"] = 553,
    [".cryproj engine-dev"] = 554,
    [".csscomb.json"] = 163,
    [".csslintrc"] = 164,
    [".es6importsorterrc.json"] = 678,
    [".eslintrc"] = 209,
    [".esmrc.json"] = 201,
    [".ffizer.yaml"] = 213,
    [".htmlhintrc"] = 258,
    ...
    [".mtaext"] = 564,
    [".nodehawkrc"] = 350,
    [".npmpackagejsonlintrc"] = 353,
    [".phraseapp.yml"] = 392,
    [".pmbot.yml"] = 382,
    [".postcssrc"] = 387,
    [".powerpages-web-template-manifest"] = 389,
    [".pre-commit-config.yml"] = 390,
    [".pre-commit-hooks.yml"] = 391,
    [".putout.json"] = 409,
    [".rehyperc"] = 419,
    [".remarkrc"] = 420,
    [".sprite files"] = 470,
    ...
    [".vsext"] = 528,
    [".yarnrc.yml"] = 596,
    ["<div>RIOTS' studio configuration"] = 534,
    ["@factorial/drupal-breakpoints-css"] = 5,
    ["A micro editor config schema"] = 314,
    ["API Builder"] = 593,
    ["AVA Configuration Schema"] = 650,
    ["AWS CDK cdk.json"] = 146,
    ["AWS CloudFormation"] = 147,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 148,
    ["Aerleon Network & Service Definitions"] = 8,
    ["Aerleon Policy"] = 9,
    ["Airlock Microgateway"] = 12,
    ["Airplane task"] = 13,
    ["Alacritty Configuration Schema"] = 625,
    ["All Contributors configuration file"] = 677,
    ...
    AssemblyScript = 40,
    AsyncAPI = 41,
    ["AsyncAPI Tool File"] = 42,
    AutoAPICase = 684,
    ["Avro Avsc"] = 43,
    ["Azure Device Update for IoT Hub import manifest"] = 44,
    ["Azure Device Update for IoT Hub update manifest"] = 45,
    ...
    ["Azure Pipelines"] = 51,
    ["Azure Static Web Apps CLI configuration file"] = 472,
    ["Azure Static Web Apps configuration file"] = 471,
    ["BX CI"] = 86,
    ["Better Code Hub"] = 598,
    ["Better Scripts"] = 87,
    BizTalkServerApplicationSchema = 570,
    ["Block Protocol Metadata"] = 85,
    Briefcase = 575,
    ["Build Info"] = 78,
    Buildkite = 80,
    ["Bukkit plugin.yml"] = 79,
    ["BungeeCord plugin.yml"] = 83,
    ["Butane Config"] = 637,
    ["CICS TS region tagging"] = 644,
    ["CICS TS resource import"] = 645,
    ["CICS TS resource model"] = 646,
    ["CICS TS resource overrides"] = 647,
    ["CMake Presets"] = 88,
    ["CNC Codes JSON Schema"] = 97,
    ["Calqulus pipeline"] = 89,
    ["Camel YAML DSL"] = 90,
    Carafe = 91,
    ["Cargo Config Schema"] = 92,
    ["Cargo Make"] = 93,
    ["Catalog Info Backstage"] = 94,
    Cheatsheets = 634,
    ["Chrome Extension"] = 140,
    ["CircleCI config.yml"] = 120,
    ["Citation File Format"] = 149,
    CityJSON = 95,
    ["Code Climate"] = 121,
    CodeCV = 50,
    Codux = 128,
    ["Cog config file"] = 98,
    ["Commandbox Box.json"] = 99,
    ["Commandbox Server.json"] = 100,
    ["Common Catalog Schema"] = 138,
    ["Common types for all schemas"] = 1,
    Conjure = 96,
    ["Container Structure Test"] = 581,
    Containerlab = 606,
    ["Crowdsec collection Schema"] = 157,
    ["Crowdsec parser Schema"] = 158,
    ["Crowdsec scenario Schema"] = 159,
    ["DWP Exchange - catalogue entry"] = 198,
    ["DWP Exchange - gateway"] = 196,
    ["DWP Exchange - meta"] = 197,
    ["Dart build configuration"] = 165,
    ["Dart test config"] = 166,
    ["DashLord configuration"] = 167,
    ["Datadog Service Definition"] = 295,
    ["Datahub Ingestion Recipe Schema"] = 651,
    ["Dein Config Schema"] = 102,
    Deno = 171,
    ["Deployer Recipe"] = 174,
    ["Deta Spacefile Schema"] = 103,
    Devfile = 195,
    ["Discord Webhook"] = 176,
    ["Dolittle Artifacts"] = 180,
    ["Dolittle Bounded Context Configuration"] = 181,
    ["Dolittle Event Horizons Configuration"] = 182,
    ["Dolittle Resources Configuration"] = 183,
    ["Dolittle Server Configuration"] = 184,
    ["Dolittle Tenant Map Configuration"] = 186,
    ["Dolittle Tenants Configuration"] = 185,
    ["Dolittle Topology"] = 187,
    ["Drupal Breakpoints Schema"] = 104,
    ["Drupal Config Schema"] = 115,
    ["Drupal Info Schema"] = 105,
    ["Drupal Layouts Schema"] = 106,
    ["Drupal Libraries Schema"] = 107,
    ["Drupal Links Action Schema"] = 108,
    ["Drupal Links Contextual Schema"] = 109,
    ["Drupal Links Menu Schema"] = 110,
    ["Drupal Links Task Schema"] = 111,
    ["Drupal Migration Schema"] = 112,
    ["Drupal Permissions Schema"] = 113,
    ["Drupal Routing Schema"] = 114,
    ["Drupal Services Schema"] = 116,
    ["Drush site aliases"] = 191,
    ["Embrace Config Schema"] = 662,
    ["Error pages"] = 204,
    Esquio = 202,
    ["Estuary Flow Catalog Schema"] = 641,
    ["Expo SDK"] = 207,
    ["F-Droid Data metadata"] = 212,
    ["Facets - FSDL - Application"] = 210,
    ["FasterCI Configuration"] = 52,
    ["Fossa configuration file"] = 220,
    ["Fossa's fossa-deps file"] = 221,
    ["Foundry VTT - Base package Manifest"] = 215,
    ["Foundry VTT - Module Manifest"] = 216,
    ["Foundry VTT - System Data Template"] = 219,
    ["Foundry VTT - System Manifest"] = 217,
    ["Foundry VTT - World Manifest"] = 218,
    ["Foxx Manifest"] = 53,
    ["Freifunk.de Community API"] = 56,
    ["Frogbot Config"] = 57,
    ["GCP Blueprint Metadata"] = 225,
    ["GatewayCore API Gateway"] = 224,
    ["GeoJSON.json latest"] = 639,
    GherKing = 643,
    ["GitHub Action"] = 229,
    ["GitHub Discussion"] = 230,
    ["GitHub Funding"] = 231,
    ["GitHub Issue Template configuration"] = 233,
    ["GitHub Workflow"] = 234,
    ["GitHub Workflow Template Properties"] = 235,
    ["GitHub issue forms"] = 232,
    GitVersion = 228,
    ["Gitpod Configuration"] = 237,
    ["Global Privacy Control"] = 226,
    ["Google Cloud Workflows"] = 145,
    Goreleaser = 240,
    ["Goreleaser Pro"] = 241,
    ["Gradle Build Cache Node"] = 595,
    ["Gradle Enterprise"] = 594,
    ["Grafana 5.x Dashboard"] = 242,
    ["GraphQL Code Generator"] = 245,
    ["GraphQL Config"] = 244,
    ["GraphQL Mesh"] = 243,
    ["Grunt JSHint task"] = 249,
    ["Grunt Watch task"] = 250,
    ["Grunt base task"] = 251,
    ["Grunt clean task"] = 247,
    ["Grunt copy task"] = 246,
    ["Grunt cssmin task"] = 248,
    HEMTT = 567,
    Hadolint = 579,
    Hammerkit = 605,
    ["Hardware Sentry Configuration"] = 655,
    Hayson = 253,
    ["Haystack Pipeline"] = 254,
    ["Hazelcast 5 Configuration"] = 255,
    ["Helm Chart.lock"] = 118,
    ["Helm Chart.yaml"] = 117,
    ["Helm Unittest Test Suite"] = 119,
    Hugo = 633,
    ["IBM Zapp document"] = 260,
    ["IBM zCodeFormatSettings"] = 261,
    ["IMG Catapult PSP"] = 266,
    ["Istanbul Schema"] = 658,
    ["JDownloader2 crawler multi-rule schema"] = 276,
    ["JDownloader2 crawler single-rule schema"] = 275,
    ["JFrog File Spec"] = 277,
    ["JFrog Pipelines YML DSL"] = 664,
    ["JMeter DSL cli config schema"] = 278,
    JReleaser = 280,
    ["JSON Document Transform"] = 287,
    ["JSON Feed"] = 288,
    ["JSON Resume"] = 426,
    ["JSON Schema Draft 2020-12"] = 546,
    ["JSON Schema Draft 4"] = 543,
    ["JSON Schema Draft 7"] = 544,
    ["JSON Schema Draft 8"] = 545,
    ["JSON schema for CodeShip Pro services configuration files"] = 131,
    ["JSON schema for CodeShip Pro steps configuration files"] = 132,
    ["JSON schema for Codecov configuration files"] = 130,
    ["JSON-API"] = 286,
    ["JSON-e templates"] = 603,
    ["JSON-stat 2.0"] = 540,
    JSONPatch = 290,
    Jasmine = 271,
    Jekyll = 272,
    ["Jenkins X Pipelines"] = 273,
    ["Jenkins X Requirements"] = 274,
    ["Jovo Language Models"] = 279,
    ["KSP-AVC"] = 541,
    ["KSP-CKAN"] = 542,
    Kas = 293,
    ["Keycloak REST API"] = 670,
    ["Knative Functions - func.yaml"] = 222,
    ["KoDE/CI build.yaml"] = 660,
    ["Kong DBLess Schema"] = 661,
    KrakenD = 294,
    LOOBin = 309,
    ["LinkML Metamodel"] = 307,
    Liquibase = 610,
    ["Liquibase Flow File"] = 611,
    ["Lively Properties"] = 308,
    Markdownlint = 614,
    ["Mason Registry"] = 616,
    ["MegaLinter configuration"] = 315,
    ["MegaLinter descriptor"] = 316,
    ["Meltano plugin discovery definition"] = 318,
    ["Meltano project definition"] = 317,
    ["Microsoft Band Web Tile"] = 319,
    ["Minecraft Data Pack Advancement"] = 321,
    ["Minecraft Data Pack Biome"] = 322,
    ["Minecraft Data Pack Configured Carver"] = 323,
    ["Minecraft Data Pack Damage Type"] = 324,
    ["Minecraft Data Pack Dimension"] = 326,
    ["Minecraft Data Pack Dimension Type"] = 325,
    ["Minecraft Data Pack Item Modifier"] = 327,
    ["Minecraft Data Pack Loot Table"] = 328,
    ["Minecraft Data Pack Metadata"] = 329,
    ["Minecraft Data Pack Predicate"] = 330,
    ["Minecraft Data Pack Recipe"] = 331,
    ["Minecraft Data Pack Tag"] = 332,
    ["Minecraft Data Pack Template Pool"] = 333,
    ["Minecraft Resource Pack Lang"] = 334,
    ["Minecraft Resource Pack Particle"] = 335,
    ["Minecraft Resource Pack Texture Mcmeta"] = 337,
    ["Minecraft Resourcepack Sounds"] = 336,
    ["MkDocs Configuration 1.0"] = 338,
    ["MongoDB Atlas Search Index Definition Schema"] = 659,
    ["Monika Configuration Schema"] = 657,
    ["Motif config"] = 563,
    ["NOX Framework (Service)"] = 352,
    ["Netin Diagnostic System Template"] = 620,
    ["Netlify config schema"] = 343,
    ["Nexus-as-Code schema"] = 344,
    ["Nightwatch.js"] = 345,
    ["ONe's service descriptor"] = 364,
    ["OSS Review Toolkit configuration"] = 371,
    ["OSS Review Toolkit curation"] = 372,
    ["OSS Review Toolkit package configuration"] = 373,
    ["OSS Review Toolkit repository configuration"] = 374,
    ["OSS Review Toolkit resolutions"] = 375,
    Opctl = 566,
    ["OpenRewrite Resource"] = 366,
    ["OpenWeather Current Weather API"] = 602,
    ["OpenWeather Road Risk API"] = 601,
    ["Ory Hydra configuration"] = 259,
    ["Ory Keto configuration"] = 296,
    ["Ory Kratos configuration"] = 370,
    ["Ory Oathkeeper configuration"] = 359,
    ["Outblocks App configuration"] = 368,
    ["Outblocks database table"] = 369,
    ["Outblocks project configuration"] = 367,
    Packer = 378,
    Pantsbuild = 676,
    ["Paper paper-plugin.yml"] = 379,
    ["Pipeline component"] = 612,
    ["PocketMine plugin.yml"] = 383,
    ["Postman collection"] = 388,
    Pterodactyl = 654,
    ["Pull Request Labeler"] = 408,
    Pulumi = 413,
    PyProject = 414,
    Pyright = 415,
    Qodana = 630,
    ["Quali Torque Blueprint Spec 2"] = 652,
    ["QueryFirst config file"] = 673,
    ["RKE Cluster Configuration JSON Schema"] = 609,
    ["RKE Cluster Configuration YAML Schema"] = 608,
    ["Rancher Fleet"] = 411,
    Ray = 578,
    ["Read the Docs"] = 412,
    ["Red-DiscordBot Cog"] = 416,
    ["Red-DiscordBot Cog Repo"] = 417,
    ["Red-DiscordBot Trivia"] = 418,
    Renovate = 427,
    ["Replit schema"] = 421,
    RoadRunner = 428,
    Ruff = 424,
    ["Rust Project"] = 425,
    ["Rust toolchain"] = 430,
    ["SIL Kit Participant Configuration"] = 459,
    SWADL = 481,
    ["Sapphire CLI Config"] = 433,
    ["SauceCTL Configuration"] = 617,
    ["Schema Catalog"] = 446,
    ["Scoop manifest"] = 451,
    ["Semantic Data Fabric (SDF) file"] = 452,
    ["Semgrep Rule"] = 454,
    ["Serenity Code Generator (Sergen)"] = 455,
    ["Serverless Framework Configuration"] = 624,
    ["Serverless Workflow Schema"] = 626,
    ["Settings.paf"] = 457,
    ["Shopware 6 Configuration"] = 627,
    ["Shopware CLI Extension Store Configuration"] = 628,
    ["Shopware CLI Project Store Configuration"] = 629,
    ["Slack app manifest"] = 461,
    Solidarity = 464,
    ["Solution filters"] = 465,
    ["Source Maps v3"] = 466,
    Sourcery = 467,
    SpecIF = 468,
    ["Sponge Mixin configuration"] = 469,
    ["StackHawk Scanner Configuration"] = 623,
    Stale = 473,
    Starship = 474,
    ["Statamic Blueprint"] = 475,
    ["StrmPrivacy Data Connector"] = 668,
    ["StrmPrivacy Data Contract"] = 669,
    ["StrmPrivacy SimpleSchema"] = 666,
    ["StrmPrivacy Stream"] = 667,
    ["StrmPrivacy batch job configuration file"] = 665,
    ["Stryker Mutator"] = 478,
    ["StyleCop Analyzers Configuration"] = 479,
    ["Swagger API 2.0"] = 482,
    TSON = 506,
    ["Talisman configuration"] = 484,
    ["Taskfile YAML Schema"] = 604,
    Taurus = 485,
    ["TestEnvironment.json"] = 494,
    ["Tier.run pricing.json"] = 488,
    Tikibase = 489,
    ["Traefik v2"] = 497,
    ["Traefik v2 File Provider"] = 498,
    Turborepo = 495,
    Tye = 631,
    ["UI5 Manifest"] = 513,
    ["UTAM Page Object"] = 516,
    ["Ubuntu Server Autoinstall"] = 511,
    ["Uniswap Token List"] = 587,
    ["Unreal Engine Uplugin"] = 674,
    ["Unreal Engine Uproject"] = 675,
    Updatecli = 638,
    Uplift = 672,
    ["User Journey Map YAML Schema"] = 607,
    V2Ray = 642,
    ["VSCode Code Snippets"] = 134,
    ["VSIX CLI publishing"] = 529,
    ["Vela Pipeline Configuration"] = 519,
    Vercel = 133,
    ["Web App Manifest"] = 536,
    ["Web types"] = 539,
    WebExtensions = 535,
    ["Webman package recipe"] = 648,
    ["Windows Package Manager Installer Manifest"] = 584,
    ["Windows Package Manager Locale Manifest"] = 585,
    ["Windows Package Manager Singleton Manifest"] = 583,
    ["Woodpecker pipeline config"] = 619,
    ["Xstate Machine Schema"] = 636,
    ["Yippee-Ki-JSON configuration YML"] = 589,
    ["aerleon.yml"] = 7,
    ["angular.json"] = 14,
    ["app-definition.yaml"] = 30,
    ...
    ["arc.json"] = 36,
    ["architect.yml"] = 35,
    ["artifacthub-repo.yml"] = 39,
    ["babelrc.json"] = 59,
    ["bamboo-spec"] = 62,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 680,
    ["bashly-strings.yml"] = 681,
    ["bashly.yml"] = 679,
    ["batect.yml"] = 61,
    ["beau.yml"] = 597,
    ["beef-database-codegen"] = 63,
    ["beef-database-v5-codegen"] = 65,
    ["beef-entity-codegen"] = 64,
    ["beef-entity-v5-codegen"] = 66,
    ["behat.yml"] = 74,
    ["bigquery-table"] = 67,
    ["bitbucket-pipelines"] = 68,
    bitrise = 69,
    ["bitrise-step"] = 70,
    ["block.json"] = 84,
    ["bower.json"] = 72,
    ["bozr.suite.json"] = 75,
    ["browser.i18n.json"] = 76,
    bucklescript = 77,
    ["bundleconfig.json"] = 82,
    ["chutzpah.json"] = 141,
    clangd = 124,
    ["cloud-init: cloud-config userdata JSON schema"] = 126,
    ["cloud-sdk-pipeline-config-schema"] = 143,
    ["cloudbuild.json"] = 144,
    cloudify = 125,
    codemagic = 127,
    ["coffeelint.json"] = 150,
    comet = 599,
    ["commands.json"] = 137,
    ["compile_commands.json"] = 136,
    ["compilerconfig.json"] = 135,
    ["component-detection-manifest.json"] = 153,
    ["component.json"] = 152,
    ["composer.json"] = 151,
    ["config.json"] = 154,
    ["contentmanifest.json"] = 142,
    ["contribute.json"] = 155,
    ["cosmos.config.json"] = 139,
    ["crowdin.yml"] = 156,
    cspell = 162,
    ["cypress.json"] = 160,
    ["datalogic-scan2deploy-android"] = 168,
    ["datalogic-scan2deploy-ce"] = 169,
    ["dbt Project"] = 101,
    ["debugsettings.json"] = 170,
    ["dependabot-v2.json"] = 173,
    ["dependabot.json"] = 172,
    ["deployed-cli"] = 635,
    ["detekt.yml"] = 175,
    ["devcontainer.json"] = 129,
    devinit = 591,
    ["devspace.yaml"] = 656,
    ["docfx.json"] = 179,
    ["docker-compose.yml"] = 590,
    ["docker-seq schema"] = 178,
    ["dockerd.json"] = 177,
    ["dotnet Release Index manifest"] = 188,
    ["dotnetcli.host.json"] = 189,
    ["drone.json"] = 190,
    ["dss-2.0.0.json"] = 192,
    ["dstack Workflows"] = 193,
    ["dvc.yaml"] = 194,
    ["ecosystem.json"] = 199,
    eksctl = 200,
    ["electron-builder configuration file."] = 205,
    ["epr-manifest.json"] = 203,
    ["evcc.yaml"] = 206,
    ["ezd schema"] = 208,
    ["fabric.mod.json"] = 211,
    ["first-timers-bot"] = 214,
    ["flagd flag configuration"] = 54,
    ["fly.io Schema"] = 55,
    fulibWorkflows = 618,
    ["function.json"] = 223,
    ["geojson.json"] = 227,
    ["gitlab-ci"] = 236,
    ["global.json"] = 238,
    ["golangci-lint Configuration"] = 239,
    ["haxelib.json"] = 252,
    helmfile = 580,
    ["host-meta.json"] = 257,
    ["host.json"] = 256,
    ...
    ["ide.host.json"] = 262,
    ["ifstate.conf"] = 263,
    ["imageoptimizer.json"] = 264,
    ["importmap.json"] = 267,
    ["ioBroker Configuration"] = 268,
    ["ioBroker JSON UI"] = 269,
    ["ioBroker Package manifest"] = 270,
    ["ize.toml"] = 671,
    ["jsconfig.json"] = 291,
    ["jscpd Configuration Schema"] = 653,
    jsdoc = 577,
    ["k3d.yaml"] = 292,
    ["kontinuous-values.yaml"] = 297,
    ["kustomization.yaml"] = 298,
    ["label-commenter-config.yml"] = 299,
    ["launchsettings.json"] = 300,
    ["lego.json"] = 301,
    ["lerna.json"] = 302,
    ["lgtm.yml"] = 303,
    ["libman.json"] = 304,
    ["license-report-config.json"] = 305,
    ["linkinator.config.json"] = 306,
    ["local.settings.json"] = 311,
    ["localazy.json"] = 312,
    ["lotus.yaml"] = 310,
    ["lsdlschema.json"] = 313,
    ["markdown-lint-check"] = 615,
    mboats = 622,
    ["micro-settings.json"] = 682,
    ["mimetypes.json"] = 320,
    ["mirrord-schema"] = 560,
    ["mta.yaml"] = 561,
    ["mtad.yaml"] = 562,
    ["mycode.json"] = 341,
    ["napari plugin manifest"] = 342,
    neoload = 572,
    ["nest-cli"] = 348,
    ["ninjs (News in JSON) 1.3"] = 347,
    ["ninjs (News in JSON) 2.0"] = 346,
    ["nlu.json"] = 349,
    ["nodemon.json"] = 351,
    ["noodl.schema.json"] = 621,
    now = 568,
    ["npm-badges"] = 354,
    ["nswag.json"] = 357,
    ntangle = 358,
    ["nuclei-template.yaml"] = 355,
    ["nuget-project.json"] = 356,
    ["ocelot.json"] = 360,
    ["omnisharp.json"] = 361,
    ["openapi.json"] = 362,
    ["openfin.json"] = 365,
    ["openrpc.json"] = 363,
    ["package.json"] = 376,
    ["package.manifest"] = 377,
    ["pattern.json"] = 381,
    ["petstore-v1.0"] = 663,
    pgap_yaml_input_reader = 380,
    ["plagiarize-me.yaml"] = 385,
    ["plagiarize.yaml"] = 384,
    ["portman.json"] = 386,
    ["prettierrc.json"] = 393,
    ["prisma.yml"] = 394,
    ["project-1.0.0-beta3.json"] = 396,
    ["project-1.0.0-beta4.json"] = 397,
    ["project-1.0.0-beta5.json"] = 398,
    ["project-1.0.0-beta6.json"] = 399,
    ["project-1.0.0-beta8.json"] = 400,
    ["project-1.0.0-rc1.json"] = 401,
    ["project-1.0.0-rc2.json"] = 402,
    ["project.json"] = 395,
    ["prometheus.json"] = 403,
    ["prometheus.rules.json"] = 404,
    ["proxies.json"] = 405,
    ["publiccode.yml"] = 406,
    ["pubspec.yaml"] = 407,
    ["pyrseas-0.8.json"] = 410,
    ["quilt.mod.json"] = 683,
    ["release drafter"] = 573,
    rtx = 423,
    rustfmt = 429,
    samt = 431,
    samtrc = 432,
    ["sarif-1.0.0.json"] = 434,
    ["sarif-2.0.0.json"] = 435,
    ["sarif-2.1.0"] = 444,
    ["sarif-2.1.0-rtm.2"] = 436,
    ["sarif-2.1.0-rtm.3"] = 438,
    ["sarif-2.1.0-rtm.4"] = 440,
    ["sarif-2.1.0-rtm.5"] = 442,
    ["sarif-external-property-file-2.1.0"] = 445,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 437,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 439,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 441,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 443,
    ["schema.org - Action"] = 447,
    ["schema.org - ContactPoint"] = 448,
    ["schema.org - Place"] = 449,
    ["schema.org - Thing"] = 450,
    ["semantic-release"] = 453,
    ["servicehub.config.json"] = 549,
    ["servicehub.service.json"] = 548,
    ["settings.job"] = 456,
    ["sfdx-hardis configuration"] = 458,
    ["size-limit configuration"] = 460,
    ["skaffold.yaml"] = 613,
    ["skyuxconfig.json"] = 462,
    snapcraft = 463,
    ["stripe-app-local.json"] = 477,
    ["stripe-app.json"] = 476,
    swcrc = 600,
    ["task.json"] = 483,
    taskcat = 569,
    ["template.json"] = 486,
    ["templatsources.json"] = 487,
    ["theme.json"] = 490,
    ["tizen_workspace.json"] = 491,
    tldr = 492,
    tmLanguage = 493,
    tmuxinator = 557,
    ["transcend.yml"] = 499,
    ["trunk.yaml schema"] = 500,
    ["ts-force-config.json"] = 504,
    ["tsconfig.json"] = 501,
    ["tsd.json"] = 502,
    ["tsdrc.json"] = 503,
    ["tslint.json"] = 505,
    ...
    ["vega-lite.json"] = 518,
    ["vega.json"] = 517,
    ["venvironment-basic.yaml"] = 521,
    ["venvironment.yaml"] = 520,
    ["version.json"] = 522,
    ["vim-addon-info"] = 523,
    ["vs-2017.3.host.json"] = 525,
    ["vs-nesting.json"] = 526,
    ["vsls.json"] = 524,
    ["vss-extension.json"] = 530,
    ["vtesttree.yaml"] = 531,
    ["vtestunit.yaml"] = 532,
    ["webhint.io"] = 649,
    ["webjobpublishsettings.json"] = 538,
    ["webjobs-list.json"] = 537,
    ["xs-app.json"] = 565,
    ["xunit.runner.json"] = 547,
    yamllint = 588,
    zuul = 574,
    ["Žinoma"] = 582
  },
