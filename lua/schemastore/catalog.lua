...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 112,
    [".cryproj (generic)"] = 425,
    [".cryproj engine-5.2"] = 420,
    [".cryproj engine-5.3"] = 421,
    [".cryproj engine-5.4"] = 422,
    [".cryproj engine-5.5"] = 423,
    [".cryproj engine-dev"] = 424,
    [".csscomb.json"] = 114,
    [".csslintrc"] = 115,
    [".eslintrc"] = 152,
    [".esmrc.json"] = 145,
    ...
    [".mtaext"] = 431,
    [".nodehawkrc"] = 264,
    [".npmpackagejsonlintrc"] = 266,
    [".phraseapp.yml"] = 297,
    [".pmbot.yml"] = 289,
    [".postcssrc"] = 294,
    [".pre-commit-config.yml"] = 295,
    [".pre-commit-hooks.yml"] = 296,
    [".putout.json"] = 314,
    [".rehyperc"] = 319,
    [".remarkrc"] = 320,
    [".sprite files"] = 356,
    ...
    [".vsext"] = 401,
    [".yarnrc.yml"] = 463,
    ["<div>RIOTS' studio configuration"] = 404,
    ["API Builder"] = 460,
    ["AVA Configuration Schema"] = 509,
    ...
    ["Azure Pipelines"] = 40,
    ["Azure Static Web Apps CLI configuration file"] = 358,
    ["Azure Static Web Apps configuration file"] = 357,
    ["Better Code Hub"] = 465,
    BizTalkServerApplicationSchema = 437,
    ...
    ["Butane config schema"] = 499,
    ["CICS TS resource overrides"] = 506,
    ["CMake Presets"] = 68,
    ["CSR Framework"] = 76,
    ...
    ["Container Structure Test"] = 448,
    Containerlab = 473,
    ["Dart build configuration"] = 116,
    ["Dart test config"] = 117,
    ["Datahub Ingestion Recipe Schema"] = 510,
    Deno = 121,
    ["Deployer Recipe"] = 124,
    Devfile = 142,
    ["Discord Webhook"] = 126,
    ...
    ["Error pages"] = 148,
    Esquio = 146,
    ["Estuary Flow Catalog Schema"] = 503,
    ["Expo SDK"] = 151,
    ...
    Goreleaser = 178,
    ["Goreleaser Pro"] = 179,
    ["Gradle Build Cache Node"] = 462,
    ["Gradle Enterprise"] = 461,
    ...
    Hugo = 495,
    ["JFrog File Spec"] = 207,
    ["JSON Document Transform"] = 215,
    ["JSON Feed"] = 216,
    ["JSON Resume"] = 322,
    ["JSON Schema Draft 2020-12"] = 416,
    ["JSON Schema Draft 4"] = 413,
    ["JSON Schema Draft 7"] = 414,
    ["JSON Schema Draft 8"] = 415,
    ...
    ["JSON-API"] = 214,
    ["JSON-e templates"] = 470,
    ["JSON-stat 2.0"] = 410,
    JSONPatch = 218,
    Jekyll = 204,
    ["Jenkins X Pipelines"] = 205,
    ["Jenkins X Requirements"] = 206,
    ["Jovo Language Models"] = 208,
    ["KSP-AVC"] = 411,
    ["KSP-CKAN"] = 412,
    KrakenD = 221,
    ["LinkML Metamodel"] = 232,
    Liquibase = 477,
    Markdownlint = 480,
    ["MegaLinter configuration"] = 236,
    ["MegaLinter descriptor"] = 237,
    ["Meltano plugin discovery definition"] = 239,
    ["Meltano project definition"] = 238,
    ["Microsoft Band Web Tile"] = 240,
    ["Minecraft Data Pack Advancement"] = 242,
    ["Minecraft Data Pack Biome"] = 243,
    ["Minecraft Data Pack Configured Carver"] = 244,
    ["Minecraft Data Pack Dimension"] = 246,
    ["Minecraft Data Pack Dimension Type"] = 245,
    ["Minecraft Data Pack Item Modifier"] = 247,
    ["Minecraft Data Pack Loot Table"] = 248,
    ["Minecraft Data Pack Metadata"] = 249,
    ["Minecraft Data Pack Predicate"] = 250,
    ["Minecraft Data Pack Recipe"] = 251,
    ["Minecraft Data Pack Template Pool"] = 252,
    ["Minecraft Resourcepack Sounds"] = 253,
    ["Netin Diagnostic System Template"] = 484,
    ["Netlify config schema"] = 258,
    ["Nightwatch.js"] = 259,
    ["OSS Review Toolkit curation"] = 280,
    ["OSS Review Toolkit package configuration"] = 281,
    ["OSS Review Toolkit repository configuration"] = 282,
    ["OSS Review Toolkit resolutions"] = 283,
    Opctl = 433,
    ["OpenWeather Current Weather API"] = 469,
    ["OpenWeather Road Risk API"] = 468,
    ["Ory Hydra configuration"] = 197,
    ["Ory Keto configuration"] = 223,
    ["Ory Kratos configuration"] = 279,
    ["Ory Oathkeeper configuration"] = 271,
    ["Outblocks App configuration"] = 277,
    ["Outblocks database table"] = 278,
    ["Outblocks project configuration"] = 276,
    Packer = 286,
    ["Pipeline component"] = 478,
    ["PocketMine plugin.yml"] = 290,
    ["Pull Request Labeler"] = 313,
    Qodana = 492,
    ["Quali Torque Blueprint Spec 2"] = 511,
    ["RKE Cluster Configuration JSON Schema"] = 476,
    ["RKE Cluster Configuration YAML Schema"] = 475,
    Ray = 445,
    ["Read the Docs"] = 316,
    ["Red-DiscordBot Cog"] = 317,
    ["Red-DiscordBot Cog Repo"] = 318,
    Renovate = 323,
    RoadRunner = 324,
    SWADL = 367,
    ["Sapphire CLI Config"] = 325,
    ["SauceCTL Configuration"] = 481,
    ["Schema Catalog"] = 338,
    ["Scoop manifest"] = 343,
    ["Semantic Release"] = 344,
    ["Semgrep Rule"] = 345,
    ["Serverless Framework Configuration"] = 488,
    ["Settings.paf"] = 347,
    ["Shopware 6 Configuration"] = 489,
    ["Shopware CLI Extension Store Configuration"] = 490,
    ["Shopware CLI Project Store Configuration"] = 491,
    Solidarity = 352,
    ["Source Maps v3"] = 353,
    SpecIF = 354,
    ["Sponge Mixin configuration"] = 355,
    ["StackHawk Scanner Configuration"] = 487,
    ["StackHead CLI config"] = 359,
    ["StackHead module configuration"] = 360,
    ["StackHead project definition"] = 361,
    Stale = 362,
    ["Statamic Blueprint"] = 363,
    ["Stryker Mutator"] = 364,
    ["StyleCop Analyzers Configuration"] = 365,
    ["Swagger API 2.0"] = 368,
    ["Taskfile YAML Schema"] = 471,
    Taurus = 369,
    ["TestEnvironment.json"] = 375,
    Tikibase = 372,
    ["Traefik v2"] = 377,
    ["Traefik v2 File Provider"] = 378,
    Tye = 493,
    ["UI5 Manifest"] = 390,
    ["Ubuntu Server Autoinstall"] = 388,
    ["Uniswap Token List"] = 454,
    Updatecli = 500,
    ["User Journey Map YAML Schema"] = 474,
    V2Ray = 504,
    ["VSCode Code Snippets"] = 90,
    ["VSIX CLI publishing"] = 402,
    ["Vela Pipeline Configuration"] = 394,
    Vercel = 89,
    ["Web App Manifest"] = 406,
    ["Web types"] = 409,
    WebExtensions = 405,
    ["Webman package recipe"] = 507,
    ["Windows Package Manager Installer Manifest"] = 451,
    ["Windows Package Manager Locale Manifest"] = 452,
    ["Windows Package Manager Singleton Manifest"] = 450,
    ["Woodpecker pipeline config"] = 483,
    ["Xstate Machine Schema"] = 498,
    ["Yippee-Ki-JSON configuration YML"] = 456,
    ["angular.json"] = 8,
    ...
    jsdoc = 444,
    ["k3d.yaml"] = 220,
    ["kustomization.yaml"] = 224,
    ["label-commenter-config.yml"] = 225,
    ["launchsettings.json"] = 226,
    ["lerna.json"] = 227,
    ["lgtm.yml"] = 228,
    ["libman.json"] = 229,
    ["license-report-config.json"] = 230,
    ["linkinator.config.json"] = 231,
    ["local.settings.json"] = 233,
    ["localazy.json"] = 234,
    ["lsdlschema.json"] = 235,
    mboats = 486,
    ["mimetypes.json"] = 241,
    ...
    ["mtad.yaml"] = 430,
    ["mycode.json"] = 256,
    ["napari plugin manifest"] = 257,
    neoload = 439,
    ["nest-cli"] = 262,
    ["ninjs (News in JSON) 1.3"] = 261,
    ["ninjs (News in JSON) 2.0"] = 260,
    ["nlu.json"] = 263,
    ["nodemon.json"] = 265,
    ["noodl.schema.json"] = 485,
    now = 435,
    ["nswag.json"] = 269,
    ntangle = 270,
    ["nuclei-template.yaml"] = 267,
    ["nuget-project.json"] = 268,
    ["ocelot.json"] = 272,
    ["omnisharp.json"] = 273,
    ["openapi.json"] = 274,
    ["openfin.json"] = 275,
    ["package.json"] = 284,
    ["package.manifest"] = 285,
    ["pattern.json"] = 288,
    pgap_yaml_input_reader = 287,
    ["plagiarize-me.yaml"] = 292,
    ["plagiarize.yaml"] = 291,
    ["portman.json"] = 293,
    ["prettierrc.json"] = 298,
    ["prisma.yml"] = 299,
    ["project-1.0.0-beta3.json"] = 301,
    ["project-1.0.0-beta4.json"] = 302,
    ["project-1.0.0-beta5.json"] = 303,
    ["project-1.0.0-beta6.json"] = 304,
    ["project-1.0.0-beta8.json"] = 305,
    ["project-1.0.0-rc1.json"] = 306,
    ["project-1.0.0-rc2.json"] = 307,
    ["project.json"] = 300,
    ["prometheus.json"] = 308,
    ["prometheus.rules.json"] = 309,
    ["proxies.json"] = 310,
    ["publiccode.yml"] = 311,
    ["pubspec.yaml"] = 312,
    ["pyrseas-0.8.json"] = 315,
    ["release drafter"] = 440,
    ["sarif-1.0.0.json"] = 326,
    ["sarif-2.0.0.json"] = 327,
    ["sarif-2.1.0"] = 336,
    ["sarif-2.1.0-rtm.2"] = 328,
    ["sarif-2.1.0-rtm.3"] = 330,
    ["sarif-2.1.0-rtm.4"] = 332,
    ["sarif-2.1.0-rtm.5"] = 334,
    ["sarif-external-property-file-2.1.0"] = 337,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 329,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 331,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 333,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 335,
    ["schema.org - Action"] = 339,
    ["schema.org - ContactPoint"] = 340,
    ["schema.org - Place"] = 341,
    ["schema.org - Thing"] = 342,
    ["service.datadog.yaml"] = 222,
    ["servicehub.config.json"] = 419,
    ["servicehub.service.json"] = 418,
    ["settings.job"] = 346,
    ["sfdx-hardis configuration"] = 348,
    ["size-limit configuration"] = 349,
    ["skaffold.yaml"] = 479,
    ["skyuxconfig.json"] = 350,
    snapcraft = 351,
    swcrc = 467,
    taskcat = 436,
    ["template.json"] = 370,
    ["templatsources.json"] = 371,
    ["theme.json"] = 373,
    tmLanguage = 374,
    ["trunk.yaml schema"] = 379,
    ["ts-force-config.json"] = 383,
    ["tsconfig.json"] = 380,
    ["tsd.json"] = 381,
    ["tsdrc.json"] = 382,
    ["tslint.json"] = 384,
    ...
    ["version.json"] = 395,
    ["vim-addon-info"] = 396,
    ["vs-2017.3.host.json"] = 398,
    ["vs-nesting.json"] = 399,
    ["vsls.json"] = 397,
    ["vss-extension.json"] = 403,
    ["webhint.io"] = 508,
    ["webjobpublishsettings.json"] = 408,
    ["webjobs-list.json"] = 407,
    ["xs-app.json"] = 432,
    ["xunit.runner.json"] = 417,
    yamllint = 455,
    zuul = 441,
    ["Žinoma"] = 449
  },
