...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 189,
    [".cryproj (generic)"] = 637,
    [".cryproj engine-5.2"] = 632,
    [".cryproj engine-5.3"] = 633,
    [".cryproj engine-5.4"] = 634,
    [".cryproj engine-5.5"] = 635,
    [".cryproj engine-dev"] = 636,
    [".eslintrc"] = 243,
    [".esmrc.json"] = 235,
    [".ffizer.yaml"] = 247,
    [".htmlhintrc"] = 301,
    ...
    ["<div>RIOTS' studio configuration"] = 615,
    ...
    ["BX CI"] = 102,
    ["Bashly (bashly.yml)"] = 773,
    ["Bashly Settings (bashly-settings.yml)"] = 774,
    ["Better Code Hub"] = 684,
    ["Better Scripts"] = 103,
    Bigconfig = 81,
    BizTalkServerApplicationSchema = 654,
    Bleep = 104,
    ...
    ["Butane Config"] = 724,
    ["CGS Custom Card Game (CardGameDef.json)"] = 809,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 781,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 770,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 806,
    GitVersion = 267,
    ["Gitpod Configuration"] = 276,
    ["GlazeWM settings"] = 808,
    ...
    ["Goreleaser Pro"] = 282,
    Goss = 283,
    ["Gradle Build Cache Node"] = 682,
    ["Gradle Enterprise"] = 681,
    ...
    ["JSON Feed"] = 332,
    ["JSON Resume"] = 493,
    ["JSON Schema Draft 2020-12"] = 628,
    ["JSON Schema Draft 4"] = 625,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 791,
    ["JSON Schema Draft 7"] = 626,
    ["JSON Schema Draft 7 (unofficial strict)"] = 792,
    ["JSON Schema Draft 8 (2019-09)"] = 627,
    ["JSON-API"] = 330,
    ["JSON-e templates"] = 689,
    ["JSON-stat 2.0"] = 622,
    JSONPatch = 334,
    Jasmine = 314,
    Jekyll = 315,
    ...
    ["Micro Editor Syntax"] = 782,
    ["Microsoft Band Web Tile"] = 371,
    ["Minecraft Custom Main Menu Mod"] = 799,
    ...
    ["Netin Diagnostic System Template"] = 706,
    ["Netlify config"] = 400,
    ...
    ["OpenUtau ustx"] = 422,
    ["OpenWeather Current Weather API"] = 688,
    ["OpenWeather Road Risk API"] = 687,
    ...
    ["Pipeline component"] = 698,
    ["PocketMine plugin.yml"] = 446,
    ["Postman collection"] = 451,
    ["Problem object RFC9457"] = 796,
    ...
    ["RKE Cluster Configuration JSON"] = 695,
    ["RKE Cluster Configuration YAML"] = 694,
    ["Rancher Fleet"] = 476,
    Ray = 662,
    ["Read the Docs"] = 478,
    ...
    Uplift = 763,
    ["User Journey Map"] = 693,
    V2Ray = 731,
    ["VSCode Code Snippets"] = 160,
    ["VSIX CLI publishing"] = 610,
    ["Vela Pipeline Configuration"] = 600,
    Vercel = 159,
    Visivo = 793,
    ["Web App Manifest"] = 617,
    ["Web types"] = 620,
    WebExtensions = 616,
    ["Webman package recipe"] = 737,
    ["Windows Package Manager Installer Manifest"] = 670,
    ["Windows Package Manager Locale Manifest"] = 671,
    ["Windows Package Manager Singleton Manifest"] = 669,
    ["Woodpecker pipeline config"] = 705,
    ["Wrangler CLI"] = 621,
    ["Xstate Machine"] = 723,
    ["Yarn Config (.yarnrc.yml)"] = 683,
    ["Yippee-Ki-JSON configuration YML"] = 675,
    ["aerleon.yml"] = 6,
    ["angular.json"] = 14,
    apko = 797,
    ...
    ["lint-staged (.lintstagedrc)"] = 641,
    ["local.settings.json"] = 361,
    ["localazy.json"] = 362,
    ["lotus.yaml"] = 360,
    ["lsdlschema.json"] = 363,
    ["markdown-lint-check"] = 701,
    mboats = 708,
    ...
    ["servicehub.config.json"] = 631,
    ["servicehub.service.json"] = 630,
    ["settings.job"] = 526,
    ...
    ["version.json"] = 603,
    ["vim-addon-info"] = 604,
    ["vs-2017.3.host.json"] = 606,
    ["vs-nesting.json"] = 607,
    ["vsls.json"] = 605,
    ["vss-extension.json"] = 611,
    ["vtesttree.yaml"] = 612,
    ["vtestunit.yaml"] = 613,
    ...
    ["webhint.io"] = 738,
    ["webjobpublishsettings.json"] = 619,
    ["webjobs-list.json"] = 618,
    ["xs-app.json"] = 649,
    ["xunit.runner.json"] = 629,
    yamllint = 674,
    zuul = 658,
    ["Žinoma"] = 668
  },
