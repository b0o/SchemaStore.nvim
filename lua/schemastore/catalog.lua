...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 993,
    [".nodehawkrc"] = 625,
    [".npmpackagejsonlintrc"] = 629,
    [".omletrc"] = 1173,
    [".phrase.yml"] = 707,
    [".phraseapp.yml"] = 708,
    [".pmbot.yml"] = 692,
    [".postcssrc"] = 701,
    [".powerpages-web-template-manifest"] = 703,
    [".pre-commit-config.yml"] = 704,
    [".pre-commit-hooks.yml"] = 705,
    [".putout.json"] = 741,
    [".rehyperc"] = 766,
    [".remarkrc"] = 770,
    [".sprite files"] = 866,
    ...
    AIConfig = 37,
    ["AMX Muse Program Descriptor"] = 1222,
    ["API Builder"] = 1029,
    ["AVA Configuration"] = 1092,
    ["AWS AppConfig Feature Flags-v1"] = 71,
    ["AWS CDK cdk.json"] = 273,
    ["AWS CloudFormation"] = 274,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 275,
    ["AWS Copilot Manifest"] = 1261,
    ["AWS SAM CLI Samconfig"] = 276,
    Acton = 1312,
    ["Adobe UXP Manifest"] = 1155,
    ["Aerleon Network & Service Definitions"] = 23,
    ["Aerleon Policy"] = 24,
    ["Agent Permission Policy"] = 1301,
    ["AgentCore CLI"] = 1302,
    AgentLoopKit = 1303,
    Aider = 1251,
    Air = 26,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1272,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1271,
    ["Airlock Microgateway"] = 38,
    ["Alacritty Configuration"] = 1064,
    ["AlgoVoi Compliance Receipt v1"] = 13,
    ["All Contributors configuration file"] = 1118,
    Anodizer = 451,
    ["Ansible Argument Specs"] = 435,
    ["Ansible Collection Galaxy"] = 442,
    ["Ansible Execution Environment"] = 432,
    ["Ansible Inventory"] = 441,
    ["Ansible Meta"] = 433,
    ["Ansible Meta Runtime"] = 434,
    ["Ansible Navigator Configuration"] = 444,
    ["Ansible Playbook"] = 439,
    ["Ansible Requirements"] = 436,
    ["Ansible Rulebook"] = 440,
    ["Ansible Tasks File"] = 438,
    ["Ansible Vars File"] = 437,
    ["Ansible-lint Configuration"] = 443,
    Any = 1183,
    ...
    ["Application list for a WinUtil"] = 1201,
    ArchitectFX = 1206,
    ["Argo CD"] = 57,
    ["Argo Events"] = 58,
    ["Argo Workflows"] = 59,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1270,
    ["Azure IoT Operations connector metadata"] = 1267,
    ...
    ["Azure Pipelines"] = 117,
    ["Azure Static Web Apps CLI configuration file"] = 870,
    ["Azure Static Web Apps configuration file"] = 869,
    BMML = 1289,
    ["BOSH CPI Config"] = 143,
    ...
    ["Bacon config"] = 7,
    ["Barba-CV"] = 86,
    ["Bashly (bashly.yml)"] = 1122,
    ["Bashly Settings (bashly-settings.yml)"] = 1123,
    Bento = 1288,
    ["Better Code Hub"] = 1034,
    ["Better Scripts"] = 166,
    Bigconfig = 136,
    ["Biome Formatter Config"] = 87,
    ["Bitmovin Encoding Template"] = 1215,
    BizTalkServerApplicationSchema = 1000,
    Bleep = 167,
    ["Block Protocol Metadata"] = 164,
    ["Bluebricks blueprint config"] = 1294,
    ["Boyka Framework"] = 145,
    ...
    ["Butane Config"] = 1077,
    C4InterFlow = 1230,
    ["CDK Environment Manager, concrete environment configuration"] = 1254,
    ["CDK Environment Manager, concrete environments definition"] = 1253,
    ["CDK Environment Manager, environment definition"] = 1252,
    ["CGS Card Game Specification (cgs.json)"] = 1160,
    ["CICS TS region tagging"] = 1086,
    ["CICS TS resource import"] = 1087,
    ["CICS TS resource model"] = 1088,
    ["CICS TS resource overrides"] = 1089,
    ["CMake Presets"] = 168,
    ["CNC Codes"] = 190,
    ["CRS WAF test file"] = 1190,
    ["CRS WAF test platform overrides file"] = 1191,
    ["CSS Comb (.csscomb.json)"] = 301,
    ["CSS Lint (.csslintrc)"] = 302,
    ["CSpell (cspell.json)"] = 300,
    ["CVE Record Format"] = 202,
    CWL = 1166,
    ["Cache Warmup config"] = 169,
    ["Caido Proxy Configuration"] = 1326,
    ...
    ["Chamaleon environment"] = 1219,
    ["Chamaleon properties"] = 1220,
    ["Chamaleon template"] = 1218,
    Changepacks = 1281,
    Changesets = 285,
    Changie = 177,
    Charmcraft = 178,
    ...
    ["Clawject config"] = 196,
    ["Cloud Foundry Application Manifest"] = 1172,
    ["Cloud Run Spec v1"] = 1196,
    ...
    CodeCV = 101,
    CodeRabbit = 100,
    ["CodeShip Pro services configuration files"] = 255,
    ["CodeShip Pro steps configuration files"] = 256,
    ["Codecov configuration files"] = 254,
    Codex = 249,
    ["Codex Hooks"] = 250,
    CodifyCLI = 102,
    Codux = 252,
    ...
    ["Common Catalog Data"] = 264,
    ["Common Package Specification"] = 194,
    Concord = 1189,
    ["Configu .cfgu files"] = 1177,
    ["Configu .configu file"] = 1178,
    Conjure = 189,
    ["Container Structure Test"] = 1014,
    Containerlab = 1043,
    ["Contextive Glossary"] = 1246,
    Convex = 188,
    ["Crowdsec collection config"] = 295,
    ["Crowdsec parser config"] = 296,
    ["Crowdsec scenario config"] = 297,
    ["CumulusCI Config"] = 195,
    ["Cursor Agent Environment"] = 1299,
    ["Custom Machinery Machine"] = 1161,
    ["Custom Machinery Recipe"] = 1162,
    ["Cycle Stack File"] = 203,
    CycloneDX = 204,
    ["DWP Exchange - catalogue entry"] = 346,
    ["DWP Exchange - gateway"] = 344,
    ["DWP Exchange - meta"] = 345,
    ["Dart Build Config (dart-build.json)"] = 303,
    ["Dart Test Config (dart-test.json)"] = 304,
    ["DashLord Configuration"] = 305,
    ["Data Contract Specification"] = 306,
    ["Data Product Specification"] = 307,
    ["DataYoga Connections"] = 205,
    ["DataYoga Job"] = 206,
    ["Datadog Continuous Testing"] = 537,
    ["Datadog Service Definition"] = 538,
    ["Datadog Software Catalog"] = 539,
    ["Datahub Ingestion Recipe"] = 1093,
    ["Debian Upstream Metadata file"] = 213,
    ["Deck config"] = 214,
    ["Declarative Automation Bundles"] = 1139,
    ["DeepMatch deeplinks spec"] = 215,
    ["Dein Config"] = 216,
    ["Deno Config (deno.json)"] = 313,
    ["Dependency cruiser"] = 217,
    ["DeployStack Configuration"] = 218,
    ["Deployah Configuration"] = 1269,
    ["Deployer Recipe"] = 316,
    ["Deta Spacefile"] = 219,
    ["Detekt Config (detekt.yml)"] = 317,
    ["Devbox Config"] = 220,
    ["Devbox Plugin"] = 221,
    Devfile = 343,
    Devup = 1282,
    DipDup = 1192,
    ["Discord Webhook"] = 318,
    ["DocFx Config (docfx.json)"] = 323,
    ["Docker Desktop extension metadata"] = 320,
    ["Docs MCP Manifest"] = 324,
    Dofigen = 325,
    ["Dolittle Artifacts"] = 326,
    ["Dolittle Bounded Context Configuration"] = 327,
    ["Dolittle Event Horizons Configuration"] = 328,
    ["Dolittle Resources Configuration"] = 329,
    ["Dolittle Server Configuration"] = 330,
    ["Dolittle Tenant Map Configuration"] = 332,
    ["Dolittle Tenants Configuration"] = 331,
    ["Dolittle Topology"] = 333,
    ["DonateCaseBetterCasino menu"] = 1223,
    ...
    ["Drupal Routing"] = 233,
    ["Drupal Services"] = 235,
    ["Drush site aliases"] = 339,
    ["Dynamic Bash Aliases (.aliases)"] = 1130,
    ["EAS config"] = 384,
    ["ECA - Editor Code Assistant"] = 348,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1119,
    ["ESLint Suppressions"] = 389,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1266,
    ["EasyVCR .NET"] = 386,
    ["Eidolon Resource"] = 1207,
    ["Elgato Stream Deck"] = 350,
    Elm = 1194,
    ["Embrace Config"] = 1105,
    Emmet = 1195,
    Endurica = 1143,
    ["Enonic XP API descriptor"] = 353,
    ["Enonic XP Admin Extension descriptor"] = 354,
    ["Enonic XP Admin Tool descriptor"] = 355,
    ["Enonic XP Application descriptor"] = 356,
    ["Enonic XP CMS descriptor"] = 357,
    ["Enonic XP Content Type descriptor"] = 358,
    ["Enonic XP Form Fragment descriptor"] = 359,
    ["Enonic XP ID Provider descriptor"] = 360,
    ["Enonic XP Layout descriptor"] = 361,
    ["Enonic XP Macro descriptor"] = 362,
    ["Enonic XP Mixin descriptor"] = 363,
    ["Enonic XP Page descriptor"] = 364,
    ["Enonic XP Part descriptor"] = 365,
    ["Enonic XP Service descriptor"] = 366,
    ["Enonic XP Site descriptor"] = 367,
    ["Enonic XP Style descriptor"] = 368,
    ["Enonic XP Task descriptor"] = 369,
    ["Enonic XP Webapp descriptor"] = 370,
    ["Enterprise Contract Policy Spec"] = 351,
    ["Envelope Team Definition"] = 1311,
    ["Envilder Map File"] = 352,
    ["Erda Pipeline"] = 1168,
    ["Erda Runtime"] = 1169,
    ["Espanso config.yml"] = 1292,
    ["Espanso match.yml"] = 1291,
    Esquio = 372,
    ["Estuary Flow Catalog"] = 1083,
    ["Ethereum ERC1155"] = 1305,
    ["Ethereum ERC721"] = 1304,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 377,
    ["EveryVoice TTS Toolkit Data Configuration"] = 378,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 382,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 381,
    ["EveryVoice TTS Toolkit Text Configuration"] = 379,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 380,
    ["Evolving Resolutive Process notation"] = 1268,
    ["Expo SDK"] = 383,
    ["Expoot app config"] = 385,
    ["F-Droid Data metadata"] = 391,
    ["FasterCI Configuration"] = 118,
    ["Fence configuration"] = 119,
    FiQuS = 395,
    Firebase = 393,
    ["Flatpak Builder Manifest"] = 396,
    ["FlexGet Config"] = 397,
    ["Flow.json Configurations"] = 1165,
    ["Fossa configuration file"] = 404,
    ["Fossa's fossa-deps file"] = 405,
    ["Foundry VTT - Base package Manifest"] = 399,
    ["Foundry VTT - Module Manifest"] = 400,
    ["Foundry VTT - System Data Template"] = 403,
    ["Foundry VTT - System Manifest"] = 401,
    ["Foundry VTT - World Manifest"] = 402,
    ["Foxx Manifest"] = 120,
    ["Freifunk.de Community API"] = 123,
    ["Frogbot Config"] = 124,
    ["G2P Mapping Configuration"] = 411,
    ["GCP Blueprint Metadata"] = 414,
    Gaspar = 412,
    ["GatewayCore API Gateway"] = 413,
    ["Gemini CLI settings"] = 415,
    ["GeoJSON.json latest"] = 1081,
    GherKing = 1085,
    ["GitHub Action"] = 420,
    ["GitHub Actions typing"] = 1203,
    ["GitHub Discussion"] = 421,
    ["GitHub Funding"] = 422,
    ["GitHub Issue Template configuration"] = 423,
    ["GitHub Issue Template forms"] = 424,
    ["GitHub Pages Jekyll"] = 425,
    ["GitHub Workflow"] = 426,
    ["GitHub Workflow Template Properties"] = 427,
    ["GitHub automatically generated release notes configuration"] = 428,
    ["GitLab Agent for Kubernetes configuration"] = 1157,
    GitVersion = 417,
    ["Gitea Issue Template configuration"] = 418,
    ["Gitea Issue Template forms"] = 419,
    ["Gitpod Automations"] = 430,
    ["Gitpod Configuration"] = 431,
    ["GlazeWM settings"] = 1159,
    ["Global Privacy Control"] = 416,
    Goblet = 1138,
    ["Golangci-lint Configuration"] = 446,
    ["Golangci-lint Custom Plugins Configuration"] = 447,
    ["Google Chrome Related Website Sets"] = 394,
    ["Google Cloud Workflows"] = 272,
    ["Google Digital Assetlinks"] = 1247,
    Goreleaser = 449,
    ["Goreleaser Pro"] = 450,
    Goss = 452,
    ["Gradle Build Cache Node"] = 1032,
    ["Gradle Enterprise"] = 1031,
    ["Grafana 5.x Dashboard"] = 453,
    ["GraphQL Code Generator"] = 458,
    ["GraphQL Config"] = 457,
    ["GraphQL Mesh"] = 456,
    ["GroovyLint configuration"] = 459,
    ["Grunt JSHint task"] = 463,
    ["Grunt Watch task"] = 464,
    ["Grunt base task"] = 465,
    ["Grunt clean task"] = 461,
    ["Grunt copy task"] = 460,
    ["Grunt cssmin task"] = 462,
    HEMTT = 996,
    Hadolint = 1010,
    Hammerkit = 1042,
    ["Hardware Sentry Configuration"] = 1097,
    ["Hashgraph Online Skill Manifest"] = 3,
    ["HashiCorp Vault"] = 466,
    Hatch = 1011,
    Hayson = 468,
    ["Haystack Pipeline"] = 469,
    ["Hazelcast 5 Configuration"] = 470,
    ["Hecate Input Schema"] = 1258,
    ["Helm Chart.lock"] = 237,
    ["Helm Chart.yaml"] = 236,
    ["Helm Unittest Test Suite"] = 238,
    ["Hex file"] = 239,
    ["Home Assistant Integration Manifest"] = 471,
    ["Homer dashboard configuration"] = 472,
    Hugo = 1073,
    ["Hugo Theme"] = 1072,
    ["Hulak Configuration"] = 479,
    ["Hyperfoil benchmark configuration"] = 478,
    ["IBM Zapp document"] = 480,
    ["IBM zCodeFormatSettings"] = 481,
    ["IMG Catapult PSP"] = 486,
    ["IVMS101 by CODE Protocol"] = 1158,
    ["Infinispan Configuration"] = 488,
    ["Infinispan Server Configuration"] = 489,
    Infrahub = 490,
    Istanbul = 1101,
    ["JDownloader2 crawler multi-rules"] = 504,
    ["JDownloader2 crawler single-rules"] = 503,
    ["JFrog Applications Config"] = 505,
    ["JFrog File Spec"] = 506,
    ["JFrog Pipelines YML DSL"] = 1107,
    ["JMeter DSL cli config"] = 507,
    JReleaser = 510,
    ["JSON Document Transform"] = 518,
    ["JSON Feed"] = 519,
    ["JSON Resume"] = 778,
    ["JSON Schema Draft 2020-12"] = 978,
    ["JSON Schema Draft 4"] = 975,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1140,
    ["JSON Schema Draft 7"] = 976,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1141,
    ["JSON Schema Draft 8 (2019-09)"] = 977,
    ["JSON-API"] = 517,
    ["JSON-e templates"] = 1039,
    ["JSON-stat 2.0"] = 971,
    JSONPatch = 521,
    ["JSR Package Config (jsr.json)"] = 511,
    Jarl = 1274,
    Jasmine = 498,
    Jekyll = 499,
    ["Jenkins X Pipelines"] = 500,
    ["Jenkins X Requirements"] = 501,
    Jest = 502,
    Jocker = 508,
    ["Jovo Language Models"] = 509,
    ["Jujutsu (jj) VCS config"] = 1260,
    ["KIMMDY config file"] = 532,
    ["KODE/CI build.yaml"] = 1103,
    ["KSP-AVC"] = 972,
    ["KSP-CKAN"] = 973,
    ["KSP-NetKAN"] = 974,
    KSY = 1170,
    KSail = 409,
    ["KYA Manifest"] = 1171,
    ["Karakum configuration file"] = 406,
    Kas = 524,
    ["Kestra flow file"] = 533,
    ["Keycloak REST API"] = 1110,
    ["Knative Functions - func.yaml"] = 407,
    Knip = 408,
    ["Knowledge Unit"] = 541,
    ["Kometa (nightly) config file"] = 535,
    ["Kometa config file"] = 534,
    ["Kong DBLess config"] = 1104,
    KrakenD = 536,
    ["Kubri Configuration"] = 544,
    LOOBin = 559,
    ["Lake configuration file"] = 1263,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 277,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 278,
    ["Landing Zone Accelerator on AWS - Global Config"] = 279,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 280,
    ["Landing Zone Accelerator on AWS - Network Config"] = 281,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 282,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 283,
    ["Landing Zone Accelerator on AWS - Security Config"] = 284,
    ["Lando (landofile)"] = 113,
    ["LangGraph Platform configuration"] = 1182,
    ["Language configuration"] = 1181,
    Lefthook = 548,
    ["Liferay client-extension.yaml"] = 555,
    ["LinkML Metamodel"] = 557,
    Liquibase = 1048,
    ["Liquibase Flow File"] = 1049,
    ["Lively Properties"] = 558,
    ["Lobe AI Agent"] = 115,
    Loki = 116,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 601,
    ["MS2Rescore Configuration"] = 606,
    ["Madness (madness.yml)"] = 1121,
    ["Mado configuration"] = 565,
    ["Maestro Flow"] = 566,
    ["Mail Servers Configuration"] = 1295,
    ["MapEHR Mapping"] = 567,
    Markdownlint = 1052,
    ["Mason Registry"] = 1055,
    ["MegaLinter Custom Flavor"] = 570,
    ["MegaLinter configuration"] = 569,
    ["MegaLinter descriptor"] = 571,
    Melange = 1148,
    ["Meltano project definition"] = 572,
    ["Mergify Configuration"] = 607,
    ["Metadata for a Bazel module"] = 573,
    ["Metadata for a Cinnamon spice"] = 1199,
    ["Metatype Configuration"] = 574,
    ["MetricsHub Configuration"] = 575,
    ["MetricsHub Connector Configuration"] = 576,
    ["Micro Editor Syntax"] = 1131,
    ["Microsoft Band Web Tile"] = 577,
    ["Microsoft RulesEngine workflow rules"] = 1186,
    ["Microsoft RulesEngine workflow rules list"] = 1187,
    ["Minecraft Custom Main Menu Mod"] = 1149,
    ["Minecraft Data Pack Advancement"] = 579,
    ["Minecraft Data Pack Biome"] = 580,
    ["Minecraft Data Pack Configured Carver"] = 581,
    ["Minecraft Data Pack Damage Type"] = 582,
    ["Minecraft Data Pack Dimension"] = 584,
    ["Minecraft Data Pack Dimension Type"] = 583,
    ["Minecraft Data Pack Item Modifier"] = 585,
    ["Minecraft Data Pack Loot Table"] = 586,
    ["Minecraft Data Pack Metadata"] = 587,
    ["Minecraft Data Pack Predicate"] = 588,
    ["Minecraft Data Pack Recipe"] = 589,
    ["Minecraft Data Pack Tag"] = 590,
    ["Minecraft Data Pack Template Pool"] = 591,
    ["Minecraft Data Pack Trim Material"] = 596,
    ["Minecraft Data Pack Trim Pattern"] = 597,
    ["Minecraft Resource Pack Lang"] = 592,
    ["Minecraft Resource Pack Particle"] = 593,
    ["Minecraft Resource Pack Texture Mcmeta"] = 595,
    ["Minecraft Resourcepack Sounds"] = 594,
    ["MockServer Expectations"] = 603,
    ModuleAssembler = 599,
    ["Monade CLI Stack Configuration"] = 610,
    ["MongoDB Atlas Search Index Definition"] = 1102,
    ["Monika Configuration"] = 1100,
    ["Monoweave Configuration"] = 605,
    ["Motif config"] = 992,
    MultiQC = 1240,
    ["NOX Framework (Service)"] = 628,
    ["Netin Diagnostic System Template"] = 1059,
    ["Netlify config"] = 613,
    ["Network-as-Code Data Model"] = 614,
    ["Next Gen UI Agent A2A Server Configuration"] = 615,
    ["Next Gen UI Agent Configuration"] = 617,
    ["Next Gen UI Agent MCP Server Configuration"] = 616,
    ["Nightwatch.js"] = 621,
    ["Node.js configuration"] = 997,
    ["NueJS configuration file"] = 633,
    ["Nuitka Package Config"] = 1163,
    ["Nullstone config"] = 635,
    ["ONe's changelog entry"] = 654,
    ["ONe's service descriptor"] = 653,
    ["ORT Server repository environment configuration"] = 664,
    ["OSCAL Assessment Plan (AP)"] = 666,
    ["OSCAL Assessment Results (AR)"] = 667,
    ["OSCAL Catalog"] = 668,
    ["OSCAL Component Definition (CDef)"] = 669,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 670,
    ["OSCAL Profile"] = 671,
    ["OSCAL System Security Plan (SSP)"] = 672,
    ["OSS Review Toolkit configuration"] = 673,
    ["OSS Review Toolkit curation"] = 674,
    ["OSS Review Toolkit package configuration"] = 675,
    ["OSS Review Toolkit project package manager definition"] = 676,
    ["OSS Review Toolkit repository configuration"] = 677,
    ["OSS Review Toolkit resolutions"] = 678,
    ["October CMS columns"] = 639,
    ["October CMS fields"] = 640,
    ["Oh My Posh"] = 642,
    Okteto = 643,
    ["Ona Automations"] = 645,
    Opctl = 995,
    ["Open Data Contract Standard (ODCS)"] = 658,
    ["Open Data Product Standard (ODPS)"] = 659,
    ["Open Know-How"] = 1245,
    OpenDecree = 1309,
    ["OpenDecree Configuration"] = 1310,
    ["OpenRewrite Resource"] = 656,
    OpenSRM = 660,
    OpenStatus = 1256,
    ["OpenTelemetry Declarative Configuration"] = 657,
    ["OpenUtau character yaml"] = 650,
    ["OpenUtau ustx"] = 651,
    ["OpenWeather Current Weather API"] = 1038,
    ["OpenWeather Road Risk API"] = 1037,
    ["Ory Hydra configuration"] = 477,
    ["Ory Keto configuration"] = 540,
    ["Ory Kratos configuration"] = 665,
    ["Ory Oathkeeper configuration"] = 637,
    ["Outblocks App configuration"] = 662,
    ["Outblocks database table"] = 663,
    ["Outblocks project configuration"] = 661,
    PDM = 686,
    POPxf = 698,
    ["POPxf Correlations"] = 699,
    ["PRML manifest"] = 706,
    Packer = 682,
    PactSpec = 683,
    Panache = 684,
    Pantsbuild = 1117,
    ["Paper paper-plugin.yml"] = 685,
    ["Pipeline component"] = 1050,
    ["Platform.sh application"] = 9,
    ["Platform.sh routes"] = 10,
    ["Platform.sh services"] = 11,
    ["Plex Prerolls"] = 696,
    ["PocketMine plugin.yml"] = 693,
    ["Podman Desktop Extension"] = 1328,
    ["Postman collection"] = 702,
    ["Power Pages Configuration"] = 1257,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1202,
    ["ProActions AI-Kit Configuration"] = 714,
    ["ProActions AI-Kit Configuration for Menus"] = 716,
    ["ProActions AI-Kit Configuration for Sections"] = 718,
    ["ProActions AI-Kit Configuration for Services"] = 715,
    ["ProActions AI-Kit Configuration for Steps"] = 719,
    ["ProActions AI-Kit Configuration for Templates"] = 717,
    ["Problem object RFC9457"] = 1146,
    ["Problem package format"] = 720,
    ["Problem package generators"] = 721,
    ["Problem package submissions"] = 722,
    ["Problem package test group metadata"] = 723,
    Pterodactyl = 1096,
    ["Pull Request Labeler"] = 740,
    Pulumi = 748,
    ["PyGTA Config"] = 744,
    PyProject = 749,
    Pylock = 1248,
    Pyright = 750,
    ["Python script metadata"] = 1242,
    ["QType AI DSL"] = 753,
    Qgoda = 752,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1320,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1318,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1324,
    ["Qlik Talend Cloud Pipeline - Project"] = 1316,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1319,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1321,
    ["Qlik Talend Cloud Pipeline - Task"] = 1317,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1323,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1322,
    Qodana = 1069,
    ["Qt Creator workspace file"] = 1179,
    ["Quali Torque Blueprint Spec 2"] = 1094,
    ["QueryFirst config file"] = 1113,
    ["QuikRun Configuration"] = 1325,
    ["Qwen Code Settings"] = 1306,
    ["RKE Cluster Configuration JSON"] = 1047,
    ["RKE Cluster Configuration YAML"] = 1046,
    RadioHound = 743,
    ["Raid Profile"] = 1307,
    ["Raid Repo Configuration"] = 1308,
    Railpack = 755,
    Railway = 754,
    ["Rancher Fleet"] = 745,
    ["Rattler-build"] = 756,
    Ray = 1009,
    ["Read the Docs"] = 747,
    ["Red-DiscordBot Cog"] = 763,
    ["Red-DiscordBot Cog Repo"] = 764,
    ["Red-DiscordBot Trivia"] = 765,
    ["Releasaurus Config"] = 6,
    ReleaseKit = 5,
    ["Render Blueprints"] = 1045,
    RenderCV = 782,
    Renovate = 779,
    ["Renovate global configuration"] = 780,
    ["Renovate inherited configuration"] = 781,
    ["Replit config"] = 771,
    Restate = 1235,
    ["Revel Digital Gadget Definition File"] = 1259,
    RoadRunner = 784,
    ["Robust Station Image"] = 1265,
    Rockcraft = 785,
    ["Roo Coder Custom Modes"] = 786,
    Rubocop = 775,
    ["Rudder techniques"] = 1153,
    Ruff = 776,
    ["Rust Project"] = 777,
    ["Rust toolchain"] = 791,
    ["SDMX data message"] = 818,
    ["SDMX metadata message"] = 817,
    ["SDMX structure message"] = 816,
    ["SIL Kit Participant Configuration"] = 828,
    ["SIL Kit Registry Configuration"] = 829,
    ["SPDX 2.3"] = 867,
    SWADL = 883,
    ["Safebox Config"] = 1108,
    ["Sapphire CLI Config"] = 794,
    ["SauceCTL Configuration"] = 1056,
    Scarb = 814,
    ["Schema Catalog"] = 809,
    ["Scoop manifest"] = 815,
    ["Semantic Data Fabric (SDF) file"] = 819,
    ["Semgrep Rule"] = 821,
    ["Serenity Code Generator (Sergen)"] = 822,
    ["Serverless Framework Configuration"] = 1063,
    ["Serverless Workflow"] = 1065,
    ["Settings for a Cinnamon spice"] = 1198,
    ["Settings.paf"] = 824,
    ["Shopware 6 Configuration"] = 1066,
    ["Shopware CLI Extension Store Configuration"] = 1067,
    ["Shopware CLI Project Store Configuration"] = 1068,
    ["Sigma Detection Rule"] = 826,
    ["SigmaCV CV"] = 1,
    ["Sigrid scope configuration file"] = 827,
    ["SkyPilot Task JSON"] = 1154,
    ["Slack app manifest"] = 831,
    Snapcraft = 833,
    ["Solarxy project config"] = 836,
    Solidarity = 837,
    ["Solution filters"] = 838,
    ["Source Maps v3"] = 839,
    Sourcery = 840,
    ["Spack bootstrap.yaml"] = 841,
    ["Spack cdash.yaml"] = 842,
    ["Spack ci.yaml"] = 843,
    ["Spack compilers.yaml"] = 844,
    ["Spack concretizer.yaml"] = 845,
    ["Spack config.yaml"] = 846,
    ["Spack definitions.yaml"] = 847,
    ["Spack develop.yaml"] = 848,
    ["Spack env_vars.yaml"] = 849,
    ["Spack environment"] = 855,
    ["Spack include.yaml"] = 850,
    ["Spack mirrors.yaml"] = 851,
    ["Spack modules.yaml"] = 852,
    ["Spack packages.yaml"] = 853,
    ["Spack repos.yaml"] = 854,
    ["Spack toolchains.yaml"] = 856,
    ["Spack upstreams.yaml"] = 857,
    ["Spack view.yaml"] = 858,
    ["Speakeasy Generation Config File"] = 862,
    ["Speakeasy Lint Configuration File"] = 859,
    ["Speakeasy Test Generation Configuration File"] = 860,
    ["Speakeasy Workflow File"] = 861,
    SpecIF = 863,
    ["Specmatic Configuration"] = 864,
    ["Sponge Mixin configuration"] = 865,
    StackBlitz = 871,
    ["StackHawk Scanner Configuration"] = 1062,
    Stale = 872,
    Starfish = 873,
    ["Starlake Data Pipeline"] = 1035,
    Starship = 874,
    ["Statamic Blueprint"] = 875,
    ["Stella configuration file"] = 876,
    ["Streamlit configuration file"] = 877,
    ["Stryker Mutator"] = 880,
    ["StyleCop Analyzers Configuration"] = 881,
    ["Stylelint (.stylelintrc)"] = 882,
    ["Stylua Config"] = 1249,
    ["Sublime Syntax"] = 1109,
    ["Subsquid squid manifest"] = 1156,
    ["Swagger API 2.0"] = 884,
    ["Synadia Connect Component"] = 885,
    TSON = 921,
    TSTyche = 922,
    ["TYPO3 Vendor Bundler config"] = 928,
    ["Tab data for a LinUtil"] = 1205,
    ["Tab list for a LinUtil"] = 1204,
    Tach = 886,
    ["Tach Domain"] = 887,
    Talhelper = 889,
    ["Talisman configuration"] = 890,
    Taplo = 1250,
    ["Taskfile config"] = 1040,
    Taurus = 891,
    Tauticord = 892,
    ["Tekton Pipeline"] = 1278,
    ["Tekton PipelineRun"] = 1279,
    ["Tekton Task"] = 1276,
    ["Tekton TaskRun"] = 1277,
    Telefonistka = 1236,
    ["Terrateam config"] = 1262,
    ["TestEnvironment.json"] = 904,
    ["TextMate Grammar"] = 903,
    Threagile = 898,
    ["Tier.run pricing.json"] = 895,
    Tikibase = 896,
    Tombi = 901,
    ["Traefik v2"] = 907,
    ["Traefik v2 File Provider"] = 908,
    ["Traefik v3"] = 909,
    ["Traefik v3 File Provider"] = 910,
    ["Travis CI (.travis.yml)"] = 906,
    Treefmt = 455,
    Trident = 1232,
    ["TrueScript for *.tscript files"] = 913,
    ["Tugboat QA config.yml"] = 1229,
    TunnelHub = 1144,
    Turborepo = 905,
    Tycho = 1193,
    Tye = 1070,
    ["Tyk Gateway - Open Source v5.7+"] = 1241,
    ["UET BuildConfig.json"] = 1114,
    ["UI5 Manifest"] = 934,
    ["UNCORS configuration"] = 939,
    ["UTAM Page Object"] = 937,
    ["Ubuntu Server Autoinstall"] = 932,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1233,
    ["Uniswap Token List"] = 1020,
    ["Universal Schedule Format"] = 940,
    ["Unreal Engine Uplugin"] = 1115,
    ["Unreal Engine Uproject"] = 1116,
    ["UpCloud CLI (upctl) configuration"] = 1234,
    ["Updatecli Compose"] = 1078,
    ["Updatecli Policy Manifest"] = 1079,
    ["Updatecli Policy Metadata"] = 1080,
    Uplift = 1112,
    ["Upsun config"] = 8,
    ["User Journey Map"] = 1044,
    V2Ray = 1084,
    ["VSCode Code Snippets"] = 260,
    ["VSIX CLI publishing"] = 958,
    Vector = 942,
    ["Vela Pipeline Configuration"] = 945,
    Vercel = 259,
    ["Version Bumper config"] = 948,
    Vespertide = 1283,
    ["Vespertide Migration"] = 1284,
    ["Vespertide Model"] = 1285,
    ["Viash Component Config"] = 1238,
    ["Viash Package Config"] = 1239,
    Visivo = 1142,
    ["WP-CLI"] = 968,
    Wake = 1231,
    ["Waku Config"] = 1208,
    ["Web App Manifest"] = 964,
    ["Web types"] = 967,
    WebExtensions = 963,
    ["Webman package recipe"] = 1090,
    ["Windows Package Manager Installer Manifest"] = 1017,
    ["Windows Package Manager Locale Manifest"] = 1018,
    ["Windows Package Manager Singleton Manifest"] = 1016,
    ["WireMock CLI import configuration"] = 1214,
    ["WireMock CLI local service configuration"] = 1213,
    ["WireMock message stub mapping"] = 1212,
    ["WireMock stub mapping"] = 1211,
    ["Woodpecker pipeline config"] = 1058,
    ["Wrangler CLI"] = 969,
    ["XenForo add-on manifest"] = 970,
    ["Xstate Machine"] = 1076,
    ["Yandex Workflow Language"] = 1200,
    ["Yarn Config (.yarnrc.yml)"] = 1033,
    ["Yippee-Ki-JSON configuration YML"] = 1024,
    ["YouTrack App"] = 1197,
    ["Zarf Package Configuration"] = 1264,
    ["Zerops import file"] = 1185,
    ["Zola Configuration"] = 1275,
    ["aerleon.yml"] = 22,
    ["amplify.yml"] = 15,
    ["amxx-builder manifest"] = 1327,
    ["angular.json"] = 39,
    apko = 1147,
    ...
    ["behat.yml"] = 146,
    ["bigquery-table"] = 135,
    ["bioimageio resource description"] = 1164,
    ...
    ["cargo-nextest repository configuration"] = 618,
    ["cargo-nextest user configuration"] = 619,
    ["ccmod.json"] = 1209,
    changelogging = 1176,
    ["chisel-slices.json"] = 286,
    ["chrome-extension-locales-messages.json"] = 267,
    ["chutzpah.json"] = 268,
    cibuildwheel = 183,
    ["clang-format (.clang-format)"] = 1082,
    ["clang-tidy"] = 245,
    clangd = 244,
    clib = 246,
    ["cloud-init: cloud-config userdata"] = 248,
    ["cloud-sdk-pipeline-configuration"] = 270,
    ["cloudbuild.json"] = 271,
    cloudify = 247,
    cmakefmt = 201,
    ["cmdx.yaml"] = 99,
    ...
    ["coffeelint.json"] = 288,
    ["commands.json"] = 263,
    ["commitlint (.commitlintrc)"] = 1019,
    ["committed.toml"] = 289,
    ["compile_commands.json"] = 262,
    ["compilerconfig.json"] = 261,
    ["completely.yml"] = 1120,
    ["component-detection-manifest.json"] = 292,
    ["component.json"] = 291,
    ["composer.json"] = 290,
    ["conda-forge"] = 187,
    ["config.yaml"] = 746,
    ["contentmanifest.json"] = 269,
    ["contribute.json"] = 293,
    ["cosmos.config.json"] = 265,
    ["crowdin.yml"] = 294,
    ["ctfd-setup configuration file"] = 1221,
    ["custom-elements.json"] = 1134,
    ["cypress.json"] = 298,
    ["dacier.yml"] = 1315,
    ["datalogic-scan2deploy-android"] = 308,
    ["datalogic-scan2deploy-ce"] = 309,
    ...
    ["ddev-global"] = 310,
    ["ddev-project"] = 311,
    ["debugsettings.json"] = 312,
    ["dependabot-v2.json"] = 315,
    ["dependabot.json"] = 314,
    ["deployed-cli"] = 1075,
    ["devcontainer.json"] = 253,
    devinit = 1026,
    ["devspace.yaml"] = 1098,
    djlint = 1027,
    ["docker bake"] = 321,
    ["docker sequencer"] = 322,
    ["docker-compose.yml"] = 1025,
    ["dockerd.json"] = 319,
    ["dotnet Release Index manifest"] = 334,
    ["dotnet-tools.json"] = 335,
    ["dotnetcli.host.json"] = 336,
    ["dprint.json"] = 337,
    ["drone.json"] = 338,
    ["dss-2.0.0.json"] = 340,
    ["dstack configuration"] = 341,
    ["dtool dataset metadata"] = 1216,
    ["dvc.yaml"] = 342,
    ["ecosystem.json"] = 347,
    eksctl = 349,
    ["electron-builder configuration file"] = 375,
    ["epr-manifest.json"] = 374,
    ["estampo.toml"] = 373,
    ["evcc.yaml"] = 376,
    ["ezd task runner"] = 387,
    ["fabric.mod.json"] = 390,
    ["first-timers-bot"] = 398,
    ["flagd flag configuration"] = 121,
    ["fly.io Configuration"] = 122,
    fulibWorkflows = 1057,
    ["function.json"] = 410,
    ["gRPC API Gateway & OpenAPI Config"] = 17,
    ["gematik health care insurance list"] = 1227,
    ["gematik health care patient list"] = 1224,
    ["gematik health care provider institution list"] = 1226,
    ["gematik health care provider list"] = 1225,
    ["gematik tiger test environment configuration"] = 1228,
    ["git-town.toml"] = 1273,
    ["gitlab-ci"] = 429,
    ["global.json"] = 445,
    ["go-feature-flag Flag Configuration"] = 448,
    ["haxelib.json"] = 467,
    helmfile = 1012,
    helmwave = 1013,
    ["host-meta.json"] = 474,
    ...
    ["ide.host.json"] = 482,
    ["ifstate.yaml"] = 483,
    ["imageoptimizer.json"] = 484,
    ["importmap.json"] = 487,
    instant_python_config = 491,
    instant_python_custom_project = 492,
    intlayer = 493,
    ["ioBroker Configuration"] = 494,
    ["ioBroker JSON UI"] = 495,
    ["ioBroker Package manifest"] = 496,
    ["ixpect.conf.yaml"] = 497,
    ["ize.toml"] = 1111,
    ["jsconfig.json"] = 522,
    ["jscpd Configuration"] = 1095,
    jsdoc = 1008,
    ["k3d.yaml"] = 523,
    ["k9s aliases.yaml"] = 525,
    ["k9s cluster-config.yaml"] = 527,
    ["k9s config.yaml"] = 526,
    ["k9s hotkeys.yaml"] = 528,
    ["k9s plugins.yaml"] = 529,
    ["k9s skin.yaml"] = 530,
    ["k9s views.yaml"] = 531,
    ["kontinuous-config.yaml"] = 543,
    ["kontinuous-values.yaml"] = 542,
    ["kustomization.yaml"] = 545,
    ["label-commenter-config.yml"] = 546,
    ["latexindent configuration"] = 114,
    ["launchsettings.json"] = 547,
    lazydocker = 1133,
    lazygit = 1132,
    ["lego.json"] = 549,
    ["lerna.json"] = 550,
    ["lgtm.yml"] = 551,
    ["liblab.config.json"] = 552,
    ["libman.json"] = 553,
    ["license-report-config.json"] = 554,
    ["linkinator.config.json"] = 556,
    ["lint-staged (.lintstagedrc)"] = 986,
    ["local.settings.json"] = 561,
    ["localazy.json"] = 562,
    ["lotus.yaml"] = 560,
    ["lsdlschema.json"] = 563,
    ["macro.json"] = 1099,
    ["markdown-link-check"] = 1053,
    maturin = 1054,
    mboats = 1061,
    memnex = 1313,
    ["micro-settings.json"] = 1126,
    ["mimetypes.json"] = 578,
    ["mirrord config"] = 988,
    mise = 989,
    ["mkdocs.yml"] = 598,
    ...
    ["monospace.yml"] = 604,
    ["moon.yml"] = 1210,
    ["mprocs Configuration file"] = 1180,
    ["mrdocs.yml"] = 600,
    ["mta.yaml"] = 990,
    ["mtad.yaml"] = 991,
    ["mycode.json"] = 611,
    nFPM = 620,
    ["napari plugin manifest"] = 612,
    neoload = 1003,
    ["nest-cli"] = 623,
    ["nexus-rpc-gen"] = 1300,
    ["ninjs (News in JSON)"] = 622,
    ["nitro.json"] = 1002,
    ["nixd configuration"] = 1152,
    ["nlu.json"] = 624,
    ["nodemon.json"] = 626,
    ["noodl config"] = 1060,
    ["notebook.mod.json"] = 627,
    now = 998,
    ["npm-badges"] = 630,
    ["nswag.json"] = 634,
    ntangle = 636,
    ["nuclei-template.yaml"] = 631,
    ["nuget-project.json"] = 632,
    ["ocelot.json"] = 638,
    ogen = 641,
    ["omnisharp.json"] = 644,
    openHAB = 1286,
    ...
    oxlint = 1297,
    ["package.json"] = 679,
    ["package.manifest"] = 681,
    ["package.yaml"] = 680,
    ["partial-black.json"] = 147,
    ["partial-fastapi.json"] = 148,
    ["partial-pixi.json"] = 691,
    ["partial-scheduled.json"] = 149,
    ["pattern.json"] = 689,
    ["petstore-v1.0"] = 1106,
    pgap_yaml_input_reader = 687,
    pgrls = 688,
    pgxgen = 1290,
    pitcms = 1293,
    ["pixi.toml"] = 690,
    ["plagiarize-me.yaml"] = 695,
    ["plagiarize.yaml"] = 694,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1217,
    ["podbard.yaml"] = 697,
    ["portman.json"] = 700,
    ["prefect.toml"] = 709,
    ["prefect.yaml"] = 710,
    ...
    ["prettierrc.json"] = 712,
    ["prisma.yml"] = 713,
    ["project-1.0.0-beta3.json"] = 725,
    ["project-1.0.0-beta4.json"] = 726,
    ["project-1.0.0-beta5.json"] = 727,
    ["project-1.0.0-beta6.json"] = 728,
    ["project-1.0.0-beta8.json"] = 729,
    ["project-1.0.0-rc1.json"] = 730,
    ["project-1.0.0-rc2.json"] = 731,
    ["project.json"] = 724,
    ["project.owasp.yaml"] = 732,
    ["prometheus-alertmanager.json"] = 736,
    ["prometheus.json"] = 733,
    ["prometheus.rules.json"] = 734,
    ["prometheus.rules.test.json"] = 735,
    ["proxies.json"] = 737,
    ["publiccode.yml"] = 738,
    ["pubspec.yaml"] = 739,
    ["pyrseas-0.8.json"] = 742,
    pytest = 751,
    ["quilt.mod.json"] = 1127,
    ["rc3 auth"] = 757,
    ["rc3 collection"] = 758,
    ...
    ["rc3 settings"] = 762,
    ["registry.yaml"] = 52,
    ["release drafter"] = 1004,
    ["release-hub.json"] = 4,
    ["release-please-config.json"] = 767,
    ["release-please-manifest.json"] = 768,
    ["release-plz.toml"] = 769,
    ["renv.lock"] = 783,
    ["reposets Configuration"] = 772,
    ["reposets Credentials"] = 773,
    ["revola.json"] = 2,
    ["rivet.json"] = 1151,
    ["rivet.yaml (legacy)"] = 1150,
    rumdl = 788,
    runny = 787,
    runspec = 1314,
    rustfmt = 789,
    ...
    samt = 792,
    samtrc = 793,
    ["sarif-1.0.0.json"] = 795,
    ["sarif-2.0.0.json"] = 796,
    ["sarif-2.1.0"] = 806,
    ["sarif-2.1.0-rtm.2"] = 797,
    ["sarif-2.1.0-rtm.3"] = 799,
    ["sarif-2.1.0-rtm.4"] = 801,
    ["sarif-2.1.0-rtm.5"] = 803,
    ["sarif-2.1.0-rtm.6"] = 804,
    ["sarif-external-property-file-2.1.0"] = 807,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 798,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 800,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 802,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 805,
    ["scalingo.json configuration"] = 808,
    ["schema.org - Action"] = 810,
    ["schema.org - ContactPoint"] = 811,
    ["schema.org - Place"] = 812,
    ["schema.org - Thing"] = 813,
    ["secrethub.yml"] = 1129,
    ["semantic-release"] = 820,
    ["servicehub.config.json"] = 981,
    ["servicehub.service.json"] = 980,
    ["settings.job"] = 823,
    ["sfdx-hardis configuration"] = 825,
    ["shard.yml"] = 1167,
    ["size-limit configuration"] = 830,
    ["skaffold.yaml"] = 1051,
    ["skyuxconfig.json"] = 832,
    ["snowflake-config"] = 834,
    ["snowflake-connections"] = 835,
    ["spicepod.yaml"] = 1188,
    ["sqlc configuration"] = 868,
    ["stripe-app-local.json"] = 879,
    ["stripe-app.json"] = 878,
    swcrc = 1036,
    ["task.json"] = 888,
    taskcat = 999,
    ["template.json"] = 893,
    ["templatsources.json"] = 894,
    ["text2confl config"] = 1298,
    ["theme.json"] = 897,
    ["tizen_workspace.json"] = 899,
    tldr = 900,
    ["tm_devices configuration file"] = 1255,
    tmuxinator = 984,
    tox = 902,
    ["transcend.yml"] = 911,
    ["tree-sitter grammar.json"] = 454,
    ["trime.yaml"] = 912,
    ["trunk.yaml"] = 914,
    ["ts-force-config.json"] = 919,
    ["tsconfig.json"] = 915,
    ["tsd.json"] = 916,
    ["tsdoc.json"] = 917,
    ["tsdrc.json"] = 918,
    ...
    v8r = 962,
    vcluster = 1174,
    ["vcpkg configuration file"] = 258,
    ["vcpkg manifest file"] = 257,
    ["vega-lite.json"] = 944,
    ["vega.json"] = 943,
    ["venvironment.yaml"] = 946,
    ["venvplus.yaml"] = 947,
    version = 1237,
    ["version.json"] = 949,
    ["vhwdebugger-binding.yaml"] = 951,
    ["vim-addon-info"] = 952,
    ["vs-2017.3.host.json"] = 954,
    ["vs-nesting.json"] = 955,
    ["vsls.json"] = 953,
    ["vss-extension.json"] = 959,
    vtcfg = 1243,
    ["vtesttree.yaml"] = 960,
    ["vtestunit.yaml"] = 961,
    ["warp-keysets.json"] = 1135,
    ["warp-themes.json"] = 1136,
    ["warp-workflows.json"] = 1137,
    ["webhint.io"] = 1091,
    ["webjobpublishsettings.json"] = 966,
    ["webjobs-list.json"] = 965,
    ["well-known-fursona"] = 1175,
    ["xs-app.json"] = 994,
    ["xunit.runner.json"] = 979,
    yamlfmt = 1021,
    yamllint = 1022,
    ["yap.json"] = 1023,
    ["zerops.yml"] = 1184,
