...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1090,
    ["API Builder"] = 904,
    ["AVA Configuration"] = 966,
    ...
    ["AWS Copilot Manifest"] = 1129,
    ["AWS SAM CLI Samconfig"] = 226,
    ["Adobe UXP Manifest"] = 1028,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1119,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 938,
    ["All Contributors configuration file"] = 991,
    ...
    ["Application list for a WinUtil"] = 1072,
    ArchitectFX = 1077,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1138,
    ["Azure IoT Operations connector metadata"] = 1135,
    ...
    ["Azure Pipelines"] = 81,
    ["Azure Static Web Apps CLI configuration file"] = 747,
    ["Azure Static Web Apps configuration file"] = 746,
    ["BOSH CPI Config"] = 105,
    ["BOSH Deploy Config"] = 106,
    ["BX CI"] = 125,
    ["Bashly (bashly.yml)"] = 995,
    ["Bashly Settings (bashly-settings.yml)"] = 996,
    ["Better Code Hub"] = 908,
    ["Better Scripts"] = 126,
    Bigconfig = 98,
    ["Biome Formatter Config"] = 65,
    ["Bitmovin Encoding Template"] = 1083,
    BizTalkServerApplicationSchema = 876,
    Bleep = 127,
    ...
    ["Butane Config"] = 951,
    C4InterFlow = 1098,
    ["CDK Environment Manager, concrete environment configuration"] = 1122,
    ["CDK Environment Manager, concrete environments definition"] = 1121,
    ["CDK Environment Manager, environment definition"] = 1120,
    ["CGS Card Game Specification (cgs.json)"] = 1033,
    ["CICS TS region tagging"] = 960,
    ["CICS TS resource import"] = 961,
    ["CICS TS resource model"] = 962,
    ["CICS TS resource overrides"] = 963,
    ["CMake Presets"] = 128,
    ["CNC Codes"] = 149,
    ["CRS WAF test file"] = 1062,
    ["CRS WAF test platform overrides file"] = 1063,
    ...
    ["Chamaleon environment"] = 1087,
    ["Chamaleon properties"] = 1088,
    ["Chamaleon template"] = 1086,
    Changesets = 235,
    Changie = 137,
    Charmcraft = 138,
    Cheatsheets = 948,
    ...
    ["Clawject config"] = 155,
    ["Cloud Foundry Application Manifest"] = 1044,
    ["Cloud Run Spec v1"] = 1067,
    ...
    Concord = 1061,
    ["Configu .cfgu files"] = 1049,
    ["Configu .configu file"] = 1050,
    Conjure = 148,
    ["Container Structure Test"] = 890,
    Containerlab = 917,
    ["Contextive Glossary"] = 1114,
    Convex = 147,
    ["Crowdsec collection config"] = 245,
    ["Crowdsec parser config"] = 246,
    ["Crowdsec scenario config"] = 247,
    ["CumulusCI Config"] = 154,
    ["Custom Machinery Machine"] = 1034,
    ["Custom Machinery Recipe"] = 1035,
    ...
    ["DonateCaseBetterCasino menu"] = 1091,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1003,
    ["EAS config"] = 311,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 992,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1134,
    ["EasyVCR .NET"] = 312,
    ["Eidolon Resource"] = 1078,
    ...
    ["Evolving Resolutive Process notation"] = 1136,
    ["Expo SDK"] = 310,
    ...
    ["GeoJSON.json latest"] = 955,
    GherKing = 959,
    ["GitHub Action"] = 342,
    ["GitHub Actions typing"] = 1074,
    ...
    ["Google Digital Assetlinks"] = 1115,
    Goreleaser = 370,
    ["Goreleaser Pro"] = 371,
    Goss = 372,
    ["Gradle Build Cache Node"] = 906,
    ["Gradle Enterprise"] = 905,
    ...
    Hadolint = 886,
    Hammerkit = 916,
    ["Hardware Sentry Configuration"] = 971,
    ["HashiCorp Vault"] = 385,
    Hatch = 887,
    Hayagriva = 387,
    Hayson = 388,
    ...
    ["JFrog File Spec"] = 421,
    ["JFrog Pipelines YML DSL"] = 980,
    ["JMeter DSL cli config"] = 422,
    JReleaser = 425,
    ["JSON Document Transform"] = 433,
    ["JSON Feed"] = 434,
    ["JSON Resume"] = 661,
    ["JSON Schema Draft 2020-12"] = 854,
    ["JSON Schema Draft 4"] = 851,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1013,
    ["JSON Schema Draft 7"] = 852,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1014,
    ["JSON Schema Draft 8 (2019-09)"] = 853,
    ["JSON-API"] = 432,
    ["JSON-e templates"] = 913,
    ["JSON-stat 2.0"] = 847,
    JSONPatch = 436,
    ...
    ["Jujutsu (jj) VCS config"] = 1128,
    ["KIMMDY config file"] = 447,
    ["KODE/CI build.yaml"] = 976,
    ["KSP-AVC"] = 848,
    ["KSP-CKAN"] = 849,
    ["KSP-NetKAN"] = 850,
    KSY = 1043,
    ...
    ["Metadata for a Cinnamon spice"] = 1070,
    ["Metatype Configuration"] = 487,
    ["MetricsHub Configuration"] = 488,
    ["MetricsHub Connector Configuration"] = 489,
    ["Micro Editor Syntax"] = 1004,
    ["Microsoft Band Web Tile"] = 490,
    ["Microsoft RulesEngine workflow rules"] = 1058,
    ["Microsoft RulesEngine workflow rules list"] = 1059,
    ["Minecraft Custom Main Menu Mod"] = 1022,
    ...
    ["MongoDB Atlas Search Index Definition"] = 975,
    ["Monika Configuration"] = 973,
    ["Monoweave Configuration"] = 515,
    ["Motif config"] = 868,
    MultiQC = 1108,
    ["NOX Framework (Service)"] = 534,
    ["Netin Diagnostic System Template"] = 933,
    ["Netlify config"] = 523,
    ["Network-as-Code Data Model"] = 524,
    ["Next Gen UI Agent Configuration"] = 525,
    ["Nightwatch.js"] = 527,
    ["Node.js configuration"] = 873,
    ...
    ["OpenUtau ustx"] = 553,
    ["OpenWeather Current Weather API"] = 912,
    ["OpenWeather Road Risk API"] = 911,
    ...
    ["Power Pages Configuration"] = 1125,
    ["Preset list for a WinUtil"] = 1073,
    ...
    Pylock = 1116,
    Pyright = 636,
    ["Python script metadata"] = 1110,
    ["QType AI DSL"] = 639,
    Qgoda = 638,
    Qodana = 943,
    ["Qt Creator workspace file"] = 1051,
    ["Quali Torque Blueprint Spec 2"] = 968,
    ["QueryFirst config file"] = 986,
    ["RKE Cluster Configuration JSON"] = 921,
    ["RKE Cluster Configuration YAML"] = 920,
    RadioHound = 629,
    Railway = 640,
    ["Rancher Fleet"] = 631,
    ["Rattler-build"] = 641,
    ...
    ["Render Blueprints"] = 919,
    RenderCV = 663,
    Renovate = 662,
    ["Replit config"] = 656,
    Restate = 1103,
    ["Revel Digital Gadget Definition File"] = 1127,
    RoadRunner = 665,
    ["Robust Station Image"] = 1133,
    ["Roo Coder Custom Modes"] = 667,
    Rubocop = 658,
    ["Rudder techniques"] = 1026,
    Ruff = 659,
    ["Rust Project"] = 660,
    ["Rust toolchain"] = 670,
    ["SDMX data message"] = 696,
    ["SDMX metadata message"] = 695,
    ["SDMX structure message"] = 694,
    ["SIL Kit Participant Configuration"] = 706,
    ["SIL Kit Registry Configuration"] = 707,
    ["SPDX 2.3"] = 744,
    SWADL = 760,
    ["Safebox Config"] = 981,
    ["Sapphire CLI Config"] = 673,
    ["SauceCTL Configuration"] = 930,
    ["Schema Catalog"] = 688,
    ["Scoop manifest"] = 693,
    ["Semantic Data Fabric (SDF) file"] = 697,
    ["Semgrep Rule"] = 699,
    ["Serenity Code Generator (Sergen)"] = 700,
    ["Serverless Framework Configuration"] = 937,
    ["Serverless Workflow"] = 939,
    ["Settings for a Cinnamon spice"] = 1069,
    ["Settings.paf"] = 702,
    ["Shopware 6 Configuration"] = 940,
    ["Shopware CLI Extension Store Configuration"] = 941,
    ["Shopware CLI Project Store Configuration"] = 942,
    ["Sigma Detection Rule"] = 704,
    ["Sigrid scope configuration file"] = 705,
    ["SkyPilot Task JSON"] = 1027,
    ["Slack app manifest"] = 709,
    Solidarity = 714,
    ["Solution filters"] = 715,
    ["Source Maps v3"] = 716,
    Sourcery = 717,
    ["Spack bootstrap.yaml"] = 718,
    ["Spack cdash.yaml"] = 719,
    ["Spack ci.yaml"] = 720,
    ["Spack compilers.yaml"] = 721,
    ["Spack concretizer.yaml"] = 722,
    ["Spack config.yaml"] = 723,
    ["Spack definitions.yaml"] = 724,
    ["Spack develop.yaml"] = 725,
    ["Spack env_vars.yaml"] = 726,
    ["Spack environment"] = 732,
    ["Spack include.yaml"] = 727,
    ["Spack mirrors.yaml"] = 728,
    ["Spack modules.yaml"] = 729,
    ["Spack packages.yaml"] = 730,
    ["Spack repos.yaml"] = 731,
    ["Spack toolchains.yaml"] = 733,
    ["Spack upstreams.yaml"] = 734,
    ["Spack view.yaml"] = 735,
    ["Speakeasy Generation Config File"] = 739,
    ["Speakeasy Lint Configuration File"] = 736,
    ["Speakeasy Test Generation Configuration File"] = 737,
    ["Speakeasy Workflow File"] = 738,
    SpecIF = 740,
    ["Specmatic Configuration"] = 741,
    ["Sponge Mixin configuration"] = 742,
    StackBlitz = 748,
    ["StackHawk Scanner Configuration"] = 936,
    Stale = 749,
    Starfish = 750,
    ["Starlake Data Pipeline"] = 909,
    Starship = 751,
    ["Statamic Blueprint"] = 752,
    ["Stella configuration file"] = 753,
    ["Streamlit configuration file"] = 754,
    ["Stryker Mutator"] = 757,
    ["StyleCop Analyzers Configuration"] = 758,
    ["Stylelint (.stylelintrc)"] = 759,
    ["Stylua Config"] = 1117,
    ["Sublime Syntax"] = 982,
    ["Subsquid squid manifest"] = 1029,
    ["Swagger API 2.0"] = 761,
    ["Synadia Connect Component"] = 762,
    TSON = 797,
    TSTyche = 798,
    ["TYPO3 Vendor Bundler config"] = 803,
    ["Tab data for a LinUtil"] = 1076,
    ["Tab list for a LinUtil"] = 1075,
    Tach = 763,
    ["Tach Domain"] = 764,
    Talhelper = 766,
    ["Talisman configuration"] = 767,
    Taplo = 1118,
    ["Taskfile config"] = 914,
    Taurus = 768,
    Tauticord = 769,
    Telefonistka = 1104,
    ["Terrateam config"] = 1130,
    ["TestEnvironment.json"] = 780,
    ["TextMate Grammar"] = 779,
    Threagile = 775,
    ["Tier.run pricing.json"] = 772,
    Tikibase = 773,
    Tombi = 778,
    ["Traefik v2"] = 783,
    ["Traefik v2 File Provider"] = 784,
    ["Traefik v3"] = 785,
    ["Traefik v3 File Provider"] = 786,
    ["Travis CI (.travis.yml)"] = 782,
    Treefmt = 375,
    Trident = 1100,
    ["TrueScript for *.tscript files"] = 789,
    ["Tugboat QA config.yml"] = 1097,
    TunnelHub = 1017,
    Turborepo = 781,
    Tycho = 1065,
    Tye = 944,
    ["Tyk Gateway - Open Source v5.7+"] = 1109,
    ["Typst Manifest"] = 804,
    ["UET BuildConfig.json"] = 987,
    ["UI5 Manifest"] = 810,
    ["UNCORS configuration"] = 814,
    ["UTAM Page Object"] = 813,
    ["Ubuntu Server Autoinstall"] = 808,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1101,
    ["Uniswap Token List"] = 897,
    ["Universal Schedule Format"] = 815,
    ["Unreal Engine Uplugin"] = 988,
    ["Unreal Engine Uproject"] = 989,
    ["UpCloud CLI (upctl) configuration"] = 1102,
    ["Updatecli Compose"] = 952,
    ["Updatecli Policy Manifest"] = 953,
    ["Updatecli Policy Metadata"] = 954,
    Uplift = 985,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 918,
    V2Ray = 958,
    ["VSCode Code Snippets"] = 210,
    ["VSIX CLI publishing"] = 835,
    Vector = 817,
    ["Vela Pipeline Configuration"] = 820,
    Vercel = 209,
    ["Version Bumper config"] = 825,
    ["Viash Component Config"] = 1106,
    ["Viash Package Config"] = 1107,
    Visivo = 1015,
    ["WP-CLI"] = 845,
    Wake = 1099,
    ["Waku Config"] = 1079,
    ["Web App Manifest"] = 841,
    ["Web types"] = 844,
    WebExtensions = 840,
    ["Webman package recipe"] = 964,
    ["Windows Package Manager Installer Manifest"] = 893,
    ["Windows Package Manager Locale Manifest"] = 894,
    ["Windows Package Manager Singleton Manifest"] = 892,
    Winutil = 895,
    ["WireMock stub mapping"] = 1082,
    ["Woodpecker pipeline config"] = 932,
    ["Wrangler CLI"] = 846,
    ["Xstate Machine"] = 950,
    ["Yandex Workflow Language"] = 1071,
    ["Yarn Config (.yarnrc.yml)"] = 907,
    ["Yippee-Ki-JSON configuration YML"] = 899,
    ["YouTrack App"] = 1068,
    ["Zarf Package Configuration"] = 1132,
    ["Zerops.io config"] = 1056,
    ["Zerops.io import"] = 1057,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 1020,
    ...
    ["behat.yml"] = 108,
    ["bigquery-table"] = 97,
    ["bioimageio resource description"] = 1037,
    ...
    ["crowdin.yml"] = 244,
    ["ctfd-setup configuration file"] = 1089,
    ["custom-elements.json"] = 1007,
    ["cypress.json"] = 248,
    ...
    ["gematik health care insurance list"] = 1095,
    ["gematik health care patient list"] = 1092,
    ["gematik health care provider institution list"] = 1094,
    ["gematik health care provider list"] = 1093,
    ["gematik tiger test environment configuration"] = 1096,
    ["gitlab-ci"] = 350,
    ["global.json"] = 366,
    ...
    ["lint-staged (.lintstagedrc)"] = 862,
    ["local.settings.json"] = 475,
    ["localazy.json"] = 476,
    ["lotus.yaml"] = 474,
    ["lsdlschema.json"] = 477,
    ["markdown-link-check"] = 927,
    maturin = 928,
    mboats = 935,
    ["micro-settings.json"] = 999,
    ["mimetypes.json"] = 491,
    ["mirrord config"] = 864,
    mise = 865,
    ["mkdocs.yml"] = 511,
    ["monospace.yml"] = 514,
    ["moon.yml"] = 1081,
    ["mprocs Configuration file"] = 1052,
    ["mrdocs.yml"] = 512,
    ["mta.yaml"] = 866,
    ["mtad.yaml"] = 867,
    ["mycode.json"] = 521,
    ...
    ["plagiarize.yaml"] = 589,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1085,
    ["podbard.yaml"] = 592,
    ["portman.json"] = 593,
    ["prefect.toml"] = 601,
    ["prettierrc.json"] = 602,
    ...
    samt = 671,
    samtrc = 672,
    ["sarif-1.0.0.json"] = 674,
    ["sarif-2.0.0.json"] = 675,
    ["sarif-2.1.0"] = 685,
    ["sarif-2.1.0-rtm.2"] = 676,
    ["sarif-2.1.0-rtm.3"] = 678,
    ["sarif-2.1.0-rtm.4"] = 680,
    ["sarif-2.1.0-rtm.5"] = 682,
    ["sarif-2.1.0-rtm.6"] = 683,
    ["sarif-external-property-file-2.1.0"] = 686,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 677,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 679,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 681,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 684,
    ["scalingo.json configuration"] = 687,
    ["schema.org - Action"] = 689,
    ["schema.org - ContactPoint"] = 690,
    ["schema.org - Place"] = 691,
    ["schema.org - Thing"] = 692,
    ["secrethub.yml"] = 1002,
    ["semantic-release"] = 698,
    ["servicehub.config.json"] = 857,
    ["servicehub.service.json"] = 856,
    ["settings.job"] = 701,
    ["sfdx-hardis configuration"] = 703,
    ["shard.yml"] = 1040,
    ["size-limit configuration"] = 708,
    ["skaffold.yaml"] = 925,
    ["skyuxconfig.json"] = 710,
    snapcraft = 711,
    ["snowflake-config"] = 712,
    ["snowflake-connections"] = 713,
    ["spicepod.yaml"] = 1060,
    ["sqlc configuration"] = 745,
    ["stripe-app-local.json"] = 756,
    ["stripe-app.json"] = 755,
    swcrc = 910,
    ["task.json"] = 765,
    taskcat = 875,
    ["template.json"] = 770,
    ["templatsources.json"] = 771,
    ["theme.json"] = 774,
    ["tizen_workspace.json"] = 776,
    tldr = 777,
    ["tm_devices configuration file"] = 1123,
    tmuxinator = 860,
    ["transcend.yml"] = 787,
    ["tree-sitter grammar.json"] = 374,
    ["trime.yaml"] = 788,
    ["trunk.yaml"] = 790,
    ["ts-force-config.json"] = 795,
    ["tsconfig.json"] = 791,
    ["tsd.json"] = 792,
    ["tsdoc.json"] = 793,
    ["tsdrc.json"] = 794,
    ...
    ["vega-lite.json"] = 819,
    ["vega.json"] = 818,
    ["venvironment-basic.yaml"] = 822,
    ["venvironment.yaml"] = 821,
    ["venvplus-basic.yaml"] = 824,
    ["venvplus.yaml"] = 823,
    version = 1105,
    ["version.json"] = 826,
    ["vhwdebugger-binding.yaml"] = 828,
    ["vim-addon-info"] = 829,
    ["vs-2017.3.host.json"] = 831,
    ["vs-nesting.json"] = 832,
    ["vsls.json"] = 830,
    ["vss-extension.json"] = 836,
    vtcfg = 1111,
    ["vtesttree.yaml"] = 837,
    ["vtestunit.yaml"] = 838,
    ["warp-keysets.json"] = 1008,
    ["warp-themes.json"] = 1009,
    ["warp-workflows.json"] = 1010,
    ["webhint.io"] = 965,
    ["webjobpublishsettings.json"] = 843,
    ["webjobs-list.json"] = 842,
    ["well-known-fursona"] = 1047,
    ["xs-app.json"] = 870,
    ["xunit.runner.json"] = 855,
    yamllint = 898,
    zuul = 881,
    ["Žinoma"] = 891
  },
