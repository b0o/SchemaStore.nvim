...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 189,
    [".cryproj (generic)"] = 636,
    [".cryproj engine-5.2"] = 631,
    [".cryproj engine-5.3"] = 632,
    [".cryproj engine-5.4"] = 633,
    [".cryproj engine-5.5"] = 634,
    [".cryproj engine-dev"] = 635,
    [".eslintrc"] = 243,
    [".esmrc.json"] = 235,
    [".ffizer.yaml"] = 247,
    [".htmlhintrc"] = 301,
    ...
    [".mtaext"] = 647,
    [".nodehawkrc"] = 406,
    [".npmpackagejsonlintrc"] = 409,
    [".phraseapp.yml"] = 454,
    [".pmbot.yml"] = 444,
    [".postcssrc"] = 449,
    [".powerpages-web-template-manifest"] = 451,
    [".pre-commit-config.yml"] = 452,
    [".pre-commit-hooks.yml"] = 453,
    [".putout.json"] = 473,
    [".rehyperc"] = 485,
    [".remarkrc"] = 487,
    [".sprite files"] = 542,
    ...
    ["BX CI"] = 102,
    ["Bashly (bashly.yml)"] = 772,
    ["Bashly Settings (bashly-settings.yml)"] = 773,
    ["Better Code Hub"] = 683,
    ["Better Scripts"] = 103,
    Bigconfig = 81,
    BizTalkServerApplicationSchema = 653,
    Bleep = 104,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 780,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 769,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 805,
    GitVersion = 267,
    ["Gitpod Configuration"] = 276,
    ["GlazeWM settings"] = 807,
    ...
    ["Goreleaser Pro"] = 282,
    Goss = 283,
    ["Gradle Build Cache Node"] = 681,
    ["Gradle Enterprise"] = 680,
    ...
    ["JSON Feed"] = 332,
    ["JSON Resume"] = 492,
    ["JSON Schema Draft 2020-12"] = 627,
    ["JSON Schema Draft 4"] = 624,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 790,
    ["JSON Schema Draft 7"] = 625,
    ["JSON Schema Draft 7 (unofficial strict)"] = 791,
    ["JSON Schema Draft 8 (2019-09)"] = 626,
    ["JSON-API"] = 330,
    ["JSON-e templates"] = 688,
    ["JSON-stat 2.0"] = 621,
    JSONPatch = 334,
    Jasmine = 314,
    Jekyll = 315,
    ...
    ["Motif config"] = 646,
    ["NOX Framework (Service)"] = 408,
    ["Netin Diagnostic System Template"] = 705,
    ["Netlify config"] = 399,
    ...
    ["OSS Review Toolkit curation"] = 432,
    ["OSS Review Toolkit package configuration"] = 433,
    ["OSS Review Toolkit repository configuration"] = 434,
    ["OSS Review Toolkit resolutions"] = 435,
    Opctl = 649,
    ["OpenRewrite Resource"] = 426,
    ["OpenUtau character yaml"] = 420,
    ["OpenUtau ustx"] = 421,
    ["OpenWeather Current Weather API"] = 687,
    ["OpenWeather Road Risk API"] = 686,
    ["Ory Hydra configuration"] = 302,
    ["Ory Keto configuration"] = 342,
    ["Ory Kratos configuration"] = 430,
    ["Ory Oathkeeper configuration"] = 415,
    ["Outblocks App configuration"] = 428,
    ["Outblocks database table"] = 429,
    ["Outblocks project configuration"] = 427,
    PDM = 441,
    Packer = 438,
    Pantsbuild = 767,
    ["Paper paper-plugin.yml"] = 439,
    ["Pipeline component"] = 697,
    ["PocketMine plugin.yml"] = 445,
    ["Postman collection"] = 450,
    ["Problem object RFC9457"] = 795,
    ["Problem package generators"] = 457,
    Pterodactyl = 742,
    ["Pull Request Labeler"] = 472,
    Pulumi = 478,
    PyProject = 479,
    Pyright = 480,
    Qgoda = 481,
    ...
    ["RKE Cluster Configuration JSON"] = 694,
    ["RKE Cluster Configuration YAML"] = 693,
    ["Rancher Fleet"] = 475,
    Ray = 661,
    ["Read the Docs"] = 477,
    ["Red-DiscordBot Cog"] = 482,
    ["Red-DiscordBot Cog Repo"] = 483,
    ["Red-DiscordBot Trivia"] = 484,
    RenderCV = 494,
    Renovate = 493,
    ["Replit config"] = 488,
    RoadRunner = 495,
    ["Rudder techniques"] = 801,
    Ruff = 490,
    ["Rust Project"] = 491,
    ["Rust toolchain"] = 498,
    ...
    SWADL = 556,
    ["Safebox Config"] = 753,
    ["Sapphire CLI Config"] = 501,
    ["SauceCTL Configuration"] = 702,
    ["Schema Catalog"] = 515,
    ["Scoop manifest"] = 520,
    ["Semantic Data Fabric (SDF) file"] = 521,
    ["Semgrep Rule"] = 523,
    ["Serenity Code Generator (Sergen)"] = 524,
    ...
    ["Stylelint (.stylelintrc)"] = 555,
    ["Sublime Syntax"] = 759,
    ["Subsquid squid manifest"] = 804,
    ["Swagger API 2.0"] = 557,
    TSON = 582,
    TSTyche = 583,
    Talhelper = 559,
    ...
    ["Windows Package Manager Installer Manifest"] = 669,
    ["Windows Package Manager Locale Manifest"] = 670,
    ["Windows Package Manager Singleton Manifest"] = 668,
    ["Woodpecker pipeline config"] = 704,
    ["Wrangler CLI"] = 620,
    ["Xstate Machine"] = 722,
    ["Yarn Config (.yarnrc.yml)"] = 682,
    ["Yippee-Ki-JSON configuration YML"] = 674,
    ["aerleon.yml"] = 6,
    ["angular.json"] = 14,
    apko = 796,
    ...
    ["lint-staged (.lintstagedrc)"] = 640,
    ["local.settings.json"] = 361,
    ["localazy.json"] = 362,
    ["lotus.yaml"] = 360,
    ["lsdlschema.json"] = 363,
    ["markdown-lint-check"] = 700,
    mboats = 707,
    ...
    ["mtad.yaml"] = 645,
    ["mycode.json"] = 397,
    ["napari plugin manifest"] = 398,
    neoload = 655,
    ["nest-cli"] = 404,
    ["ninjs (News in JSON) 1.3"] = 403,
    ["ninjs (News in JSON) 2.0"] = 402,
    ["nixd configuration"] = 800,
    ["nlu.json"] = 405,
    ["nodemon.json"] = 407,
    ["noodl config"] = 706,
    now = 651,
    ...
    ["nswag.json"] = 413,
    ntangle = 414,
    ["nuclei-template.yaml"] = 411,
    ["nuget-project.json"] = 412,
    ["ocelot.json"] = 416,
    ["omnisharp.json"] = 417,
    ["openapi.json"] = 418,
    ["openfin.json"] = 425,
    ...
    ["ops.yaml"] = 422,
    ["package.json"] = 436,
    ["package.manifest"] = 437,
    ["partial-black.json"] = 89,
    ["pathfinder.yml"] = 440,
    ["pattern.json"] = 443,
    ["petstore-v1.0"] = 751,
    pgap_yaml_input_reader = 442,
    ["plagiarize-me.yaml"] = 447,
    ["plagiarize.yaml"] = 446,
    ["portman.json"] = 448,
    ["prettierrc.json"] = 455,
    ["prisma.yml"] = 456,
    ["project-1.0.0-beta3.json"] = 459,
    ["project-1.0.0-beta4.json"] = 460,
    ["project-1.0.0-beta5.json"] = 461,
    ["project-1.0.0-beta6.json"] = 462,
    ["project-1.0.0-beta8.json"] = 463,
    ["project-1.0.0-rc1.json"] = 464,
    ["project-1.0.0-rc2.json"] = 465,
    ["project.json"] = 458,
    ["prometheus.json"] = 466,
    ["prometheus.rules.json"] = 467,
    ["prometheus.rules.test.json"] = 468,
    ["proxies.json"] = 469,
    ["publiccode.yml"] = 470,
    ["pubspec.yaml"] = 471,
    ["pyrseas-0.8.json"] = 474,
    ["quilt.mod.json"] = 777,
    ["release drafter"] = 656,
    ["release-plz.toml"] = 486,
    ["rivet.yaml"] = 799,
    rockcraft = 496,
    rustfmt = 497,
    samt = 499,
    samtrc = 500,
    ["sarif-1.0.0.json"] = 502,
    ["sarif-2.0.0.json"] = 503,
    ["sarif-2.1.0"] = 513,
    ["sarif-2.1.0-rtm.2"] = 504,
    ["sarif-2.1.0-rtm.3"] = 506,
    ["sarif-2.1.0-rtm.4"] = 508,
    ["sarif-2.1.0-rtm.5"] = 510,
    ["sarif-2.1.0-rtm.6"] = 511,
    ["sarif-external-property-file-2.1.0"] = 514,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 505,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 507,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 509,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 512,
    ["schema.org - Action"] = 516,
    ["schema.org - ContactPoint"] = 517,
    ["schema.org - Place"] = 518,
    ["schema.org - Thing"] = 519,
    ["secrethub.yml"] = 779,
    ["semantic-release"] = 522,
    ["servicehub.config.json"] = 630,
    ["servicehub.service.json"] = 629,
    ["settings.job"] = 525,
