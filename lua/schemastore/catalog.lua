...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 822,
    [".nodehawkrc"] = 513,
    [".npmpackagejsonlintrc"] = 517,
    [".omletrc"] = 998,
    [".phrase.yml"] = 579,
    [".phraseapp.yml"] = 580,
    [".pmbot.yml"] = 567,
    [".postcssrc"] = 574,
    [".powerpages-web-template-manifest"] = 576,
    [".pre-commit-config.yml"] = 577,
    [".pre-commit-hooks.yml"] = 578,
    [".putout.json"] = 607,
    [".rehyperc"] = 630,
    [".remarkrc"] = 634,
    [".sprite files"] = 702,
    ...
    ["A micro editor config"] = 465,
    ABCInventoryModuleData = 18,
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1042,
    ["API Builder"] = 857,
    ["AVA Configuration"] = 919,
    ...
    ["Adobe UXP Manifest"] = 981,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1070,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 891,
    ["All Contributors configuration file"] = 944,
    ...
    ["Application list for a WinUtil"] = 1024,
    ArchitectFX = 1029,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure Pipelines"] = 78,
    ["Azure Static Web Apps CLI configuration file"] = 706,
    ["Azure Static Web Apps configuration file"] = 705,
    ["BOSH CPI Config"] = 102,
    ["BOSH Deploy Config"] = 103,
    ["BX CI"] = 122,
    ["Bashly (bashly.yml)"] = 948,
    ["Bashly Settings (bashly-settings.yml)"] = 949,
    ["Better Code Hub"] = 861,
    ["Better Scripts"] = 123,
    Bigconfig = 95,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1035,
    BizTalkServerApplicationSchema = 829,
    Bleep = 124,
    ...
    ["Butane Config"] = 904,
    C4InterFlow = 1050,
    ["CDK Environment Manager, concrete environment configuration"] = 1073,
    ["CDK Environment Manager, concrete environments definition"] = 1072,
    ["CDK Environment Manager, environment definition"] = 1071,
    ["CGS Card Game Specification (cgs.json)"] = 986,
    ["CICS TS region tagging"] = 913,
    ["CICS TS resource import"] = 914,
    ["CICS TS resource model"] = 915,
    ["CICS TS resource overrides"] = 916,
    ["CMake Presets"] = 125,
    ["CNC Codes"] = 144,
    ["CRS WAF test file"] = 1014,
    ["CRS WAF test platform overrides file"] = 1015,
    ...
    ["Chamaleon environment"] = 1039,
    ["Chamaleon properties"] = 1040,
    ["Chamaleon template"] = 1038,
    Changesets = 227,
    Charmcraft = 134,
    Cheatsheets = 901,
    ...
    CityJSON = 139,
    ["Clawject config"] = 150,
    ["Cloud Foundry Application Manifest"] = 997,
    ["Cloud Run Spec v1"] = 1019,
    ...
    Concord = 1013,
    ["Configu .cfgu files"] = 1002,
    ["Configu .configu file"] = 1003,
    Conjure = 143,
    ["Container Structure Test"] = 843,
    Containerlab = 870,
    ["Contextive Glossary"] = 1065,
    Convex = 142,
    ["Crowdsec collection config"] = 237,
    ["Crowdsec parser config"] = 238,
    ["Crowdsec scenario config"] = 239,
    ["CumulusCI Config"] = 149,
    ["Custom Machinery Machine"] = 987,
    ["Custom Machinery Recipe"] = 988,
    ...
    ["DataYoga Job"] = 155,
    ["Databricks Asset Bundles"] = 965,
    ["Datadog Service Definition"] = 438,
    ["Datadog Software Catalog"] = 439,
    ["Datahub Ingestion Recipe"] = 920,
    ["Dein Config"] = 161,
    ...
    ["DonateCaseBetterCasino menu"] = 1043,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 956,
    ["EAS config"] = 303,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 945,
    ["EasyVCR .NET"] = 304,
    ["Eidolon Resource"] = 1030,
    ...
    ["GeoJSON.json latest"] = 908,
    GherKing = 912,
    ["GitHub Action"] = 334,
    ["GitHub Actions typing"] = 1026,
    ...
    ["Google Digital Assetlinks"] = 1066,
    Goreleaser = 362,
    ["Goreleaser Pro"] = 363,
    Goss = 364,
    ["Gradle Build Cache Node"] = 859,
    ["Gradle Enterprise"] = 858,
    ...
    Hadolint = 839,
    Hammerkit = 869,
    ["Hardware Sentry Configuration"] = 924,
    Hatch = 840,
    Hayson = 377,
    ...
    ["JFrog File Spec"] = 408,
    ["JFrog Pipelines YML DSL"] = 933,
    ["JMeter DSL cli config"] = 409,
    JReleaser = 411,
    ["JSON Document Transform"] = 419,
    ["JSON Feed"] = 420,
    ["JSON Resume"] = 639,
    ["JSON Schema Draft 2020-12"] = 808,
    ["JSON Schema Draft 4"] = 805,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 966,
    ["JSON Schema Draft 7"] = 806,
    ["JSON Schema Draft 7 (unofficial strict)"] = 967,
    ["JSON Schema Draft 8 (2019-09)"] = 807,
    ["JSON-API"] = 418,
    ["JSON-e templates"] = 866,
    ["JSON-stat 2.0"] = 801,
    JSONPatch = 422,
    ["JSR Package Config (jsr.json)"] = 412,
    Jasmine = 400,
    Jekyll = 401,
    ["Jenkins X Pipelines"] = 402,
    ["Jenkins X Requirements"] = 403,
    Jest = 404,
    ["Jovo Language Models"] = 410,
    ["KIMMDY config file"] = 433,
    ["KODE/CI build.yaml"] = 929,
    ["KSP-AVC"] = 802,
    ["KSP-CKAN"] = 803,
    ["KSP-NetKAN"] = 804,
    KSY = 996,
    ...
    Kas = 425,
    ["Kestra flow file"] = 434,
    ["Keycloak REST API"] = 936,
    ["Knative Functions - func.yaml"] = 323,
    ["Kometa (nightly) config file"] = 436,
    ["Kometa config file"] = 435,
    ["Kong DBLess config"] = 930,
    KrakenD = 437,
    ["Kubri Configuration"] = 443,
    LOOBin = 458,
    ...
    ["Language configuration"] = 1006,
    Lefthook = 447,
    ["Liferay client-extension.yaml"] = 454,
    ["LinkML Metamodel"] = 456,
    Liquibase = 875,
    ["Liquibase Flow File"] = 876,
    ["Lively Properties"] = 457,
    ["Lobe AI Agent"] = 76,
    Loki = 77,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 496,
    ["MS2Rescore Configuration"] = 499,
    ["Madness (madness.yml)"] = 947,
    ["MapEHR Mapping"] = 464,
    Markdownlint = 879,
    ["Mason Registry"] = 882,
    ["MegaLinter configuration"] = 466,
    ["MegaLinter descriptor"] = 467,
    Melange = 974,
    ["Meltano project definition"] = 468,
    ["Mergify Configuration"] = 500,
    ["Metadata for a Bazel module"] = 469,
    ["Metadata for a Cinnamon spice"] = 1022,
    ["Metatype Configuration"] = 470,
    ["MetricsHub Configuration"] = 471,
    ["MetricsHub Connector Configuration"] = 472,
    ["Micro Editor Syntax"] = 957,
    ["Microsoft Band Web Tile"] = 473,
    ["Microsoft RulesEngine workflow rules"] = 1010,
    ["Microsoft RulesEngine workflow rules list"] = 1011,
    ["Minecraft Custom Main Menu Mod"] = 975,
    ["Minecraft Data Pack Advancement"] = 475,
    ["Minecraft Data Pack Biome"] = 476,
    ["Minecraft Data Pack Configured Carver"] = 477,
    ["Minecraft Data Pack Damage Type"] = 478,
    ["Minecraft Data Pack Dimension"] = 480,
    ["Minecraft Data Pack Dimension Type"] = 479,
    ["Minecraft Data Pack Item Modifier"] = 481,
    ["Minecraft Data Pack Loot Table"] = 482,
    ["Minecraft Data Pack Metadata"] = 483,
    ["Minecraft Data Pack Predicate"] = 484,
    ["Minecraft Data Pack Recipe"] = 485,
    ["Minecraft Data Pack Tag"] = 486,
    ["Minecraft Data Pack Template Pool"] = 487,
    ["Minecraft Data Pack Trim Material"] = 492,
    ["Minecraft Data Pack Trim Pattern"] = 493,
    ["Minecraft Resource Pack Lang"] = 488,
    ["Minecraft Resource Pack Particle"] = 489,
    ["Minecraft Resource Pack Texture Mcmeta"] = 491,
    ["Minecraft Resourcepack Sounds"] = 490,
    ["Monade CLI Stack Configuration"] = 503,
    ["MongoDB Atlas Search Index Definition"] = 928,
    ["Monika Configuration"] = 926,
    ["Monoweave Configuration"] = 498,
    ["Motif config"] = 821,
    MultiQC = 1059,
    ["NOX Framework (Service)"] = 516,
    ["Netin Diagnostic System Template"] = 886,
    ["Netlify config"] = 506,
    ["Network-as-Code Data Model"] = 507,
    ["Nightwatch.js"] = 509,
    ["Node.js configuration"] = 826,
    ["NueJS configuration file"] = 521,
    ["Nuitka.yaml"] = 989,
    ["Nullstone config"] = 523,
    ["ONe's changelog entry"] = 537,
    ["ONe's service descriptor"] = 536,
    ["ORT Server repository environment configuration"] = 544,
    ["OSCAL Assessment Plan (AP)"] = 546,
    ["OSCAL Assessment Results (AR)"] = 547,
    ["OSCAL Catalog"] = 548,
    ["OSCAL Component Definition (CDef)"] = 549,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 550,
    ["OSCAL Profile"] = 551,
    ["OSCAL System Security Plan (SSP)"] = 552,
    ["OSS Review Toolkit configuration"] = 553,
    ["OSS Review Toolkit curation"] = 554,
    ["OSS Review Toolkit package configuration"] = 555,
    ["OSS Review Toolkit repository configuration"] = 556,
    ["OSS Review Toolkit resolutions"] = 557,
    ["October CMS columns"] = 527,
    ["October CMS fields"] = 528,
    Okteto = 529,
    Opctl = 824,
    ["Open Data Contract Standard (ODCS)"] = 540,
    ["Open Know-How"] = 1064,
    ["OpenRewrite Resource"] = 539,
    OpenStatus = 1075,
    ["OpenUtau character yaml"] = 533,
    ["OpenUtau ustx"] = 534,
    ["OpenWeather Current Weather API"] = 865,
    ["OpenWeather Road Risk API"] = 864,
    ["Ory Hydra configuration"] = 386,
    ["Ory Keto configuration"] = 440,
    ["Ory Kratos configuration"] = 545,
    ["Ory Oathkeeper configuration"] = 525,
    ["Outblocks App configuration"] = 542,
    ["Outblocks database table"] = 543,
    ["Outblocks project configuration"] = 541,
    PDM = 563,
    Packer = 560,
    Pantsbuild = 943,
    ["Paper paper-plugin.yml"] = 561,
    ["Pipeline component"] = 877,
    ...
    ["ProActions AI-Kit Configuration for Sections"] = 588,
    ["ProActions AI-Kit Configuration for Services"] = 585,
    ["ProActions AI-Kit Configuration for Steps"] = 589,
    ["ProActions AI-Kit Configuration for Templates"] = 587,
    ["Problem object RFC9457"] = 972,
    ["Problem package generators"] = 590,
    Pterodactyl = 923,
    ["Pull Request Labeler"] = 606,
    Pulumi = 614,
    ["PyGTA Config"] = 610,
    PyProject = 615,
    Pylock = 1067,
    Pyright = 616,
    ["Python script metadata"] = 1061,
    Qgoda = 618,
    Qodana = 896,
    ["Qt Creator workspace file"] = 1004,
    ["Quali Torque Blueprint Spec 2"] = 921,
    ["QueryFirst config file"] = 939,
    ["RKE Cluster Configuration JSON"] = 874,
    ["RKE Cluster Configuration YAML"] = 873,
    RadioHound = 609,
    Railway = 619,
    ["Rancher Fleet"] = 611,
    ["Rattler-build"] = 620,
    Ray = 838,
    ["Read the Docs"] = 613,
    ["Red-DiscordBot Cog"] = 627,
    ["Red-DiscordBot Cog Repo"] = 628,
    ["Red-DiscordBot Trivia"] = 629,
    ["Render Blueprints"] = 872,
    RenderCV = 641,
    Renovate = 640,
    ["Replit config"] = 635,
    Restate = 1054,
    RoadRunner = 643,
    ["Roo Coder Custom Modes"] = 645,
    ["Rudder techniques"] = 979,
    Ruff = 637,
    ["Rust Project"] = 638,
    ["Rust toolchain"] = 648,
    ["SDMX data message"] = 674,
    ["SDMX metadata message"] = 673,
    ["SDMX structure message"] = 672,
    ["SIL Kit Participant Configuration"] = 684,
    ["SIL Kit Registry Configuration"] = 685,
    ["SPDX 2.3"] = 703,
    SWADL = 717,
    ["Safebox Config"] = 934,
    ["Sapphire CLI Config"] = 651,
    ["SauceCTL Configuration"] = 883,
    ["Schema Catalog"] = 666,
    ["Scoop manifest"] = 671,
    ["Semantic Data Fabric (SDF) file"] = 675,
    ["Semgrep Rule"] = 677,
    ["Serenity Code Generator (Sergen)"] = 678,
    ["Serverless Framework Configuration"] = 890,
    ["Serverless Workflow"] = 892,
    ["Settings for a Cinnamon spice"] = 1021,
    ["Settings.paf"] = 680,
    ["Shopware 6 Configuration"] = 893,
    ["Shopware CLI Extension Store Configuration"] = 894,
    ["Shopware CLI Project Store Configuration"] = 895,
    ["Sigma Detection Rule"] = 682,
    ["Sigrid scope configuration file"] = 683,
    ["SkyPilot Task JSON"] = 980,
    ["Slack app manifest"] = 687,
    Solidarity = 692,
    ["Solution filters"] = 693,
    ["Source Maps v3"] = 694,
    Sourcery = 695,
    ["Speakeasy Generation Config File"] = 699,
    ["Speakeasy Lint Configuration File"] = 696,
    ["Speakeasy Test Generation Configuration File"] = 697,
    ["Speakeasy Workflow File"] = 698,
    SpecIF = 700,
    ["Sponge Mixin configuration"] = 701,
    StackBlitz = 707,
    ["StackHawk Scanner Configuration"] = 889,
    Stale = 708,
    ["Starlake Data Pipeline"] = 862,
    Starship = 709,
    ["Statamic Blueprint"] = 710,
    ["Stella configuration file"] = 711,
    ["Stryker Mutator"] = 714,
    ["StyleCop Analyzers Configuration"] = 715,
    ["Stylelint (.stylelintrc)"] = 716,
    ["Stylua Config"] = 1068,
    ["Sublime Syntax"] = 935,
    ["Subsquid squid manifest"] = 982,
    ["Swagger API 2.0"] = 718,
    ["Synadia Connect Component"] = 719,
    TSON = 753,
    TSTyche = 754,
    ["Tab data for a LinUtil"] = 1028,
    ["Tab list for a LinUtil"] = 1027,
    Tach = 720,
    ["Tach Domain"] = 721,
    Talhelper = 723,
    ["Talisman configuration"] = 724,
    Taplo = 1069,
    ["Taskfile config"] = 867,
    Taurus = 725,
    Tauticord = 726,
    Telefonistka = 1055,
    ["TestEnvironment.json"] = 736,
    ["TextMate Grammar"] = 735,
    ["Tier.run pricing.json"] = 729,
    Tikibase = 730,
    Tombi = 734,
    ["Traefik v2"] = 739,
    ["Traefik v2 File Provider"] = 740,
    ["Traefik v3"] = 741,
    ["Traefik v3 File Provider"] = 742,
    ["Travis CI (.travis.yml)"] = 738,
    Trident = 1052,
    ["TrueScript for *.tscript files"] = 745,
    ["Tugboat QA config.yml"] = 1049,
    TunnelHub = 970,
    Turborepo = 737,
    Tycho = 1017,
    Tye = 897,
    ["Tyk Gateway - Open Source v5.7+"] = 1060,
    ["Typst Manifest"] = 759,
    ["UET BuildConfig.json"] = 940,
    ["UI5 Manifest"] = 765,
    ["UNCORS configuration"] = 769,
    ["UTAM Page Object"] = 768,
    ["Ubuntu Server Autoinstall"] = 763,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1053,
    ["Uniswap Token List"] = 850,
    ["Universal Schedule Format"] = 770,
    ["Unreal Engine Uplugin"] = 941,
    ["Unreal Engine Uproject"] = 942,
    ["Updatecli Compose"] = 905,
    ["Updatecli Policy Manifest"] = 906,
    ["Updatecli Policy Metadata"] = 907,
    Uplift = 938,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 871,
    V2Ray = 911,
    ["VSCode Code Snippets"] = 202,
    ["VSIX CLI publishing"] = 790,
    Vector = 772,
    ["Vela Pipeline Configuration"] = 775,
    Vercel = 201,
    ["Version Bumper config"] = 780,
    ["Viash Component Config"] = 1057,
    ["Viash Package Config"] = 1058,
    Visivo = 968,
    Wake = 1051,
    ["Waku Config"] = 1031,
    ["Web App Manifest"] = 796,
    ["Web types"] = 799,
    WebExtensions = 795,
    ["Webman package recipe"] = 917,
    ["Windows Package Manager Installer Manifest"] = 846,
    ["Windows Package Manager Locale Manifest"] = 847,
    ["Windows Package Manager Singleton Manifest"] = 845,
    Winutil = 848,
    ["WireMock stub mapping"] = 1034,
    ["Woodpecker pipeline config"] = 885,
    ["Wrangler CLI"] = 800,
    ["Xstate Machine"] = 903,
    ["Yandex Workflow Language"] = 1023,
    ["Yarn Config (.yarnrc.yml)"] = 860,
    ["Yippee-Ki-JSON configuration YML"] = 852,
    ["YouTrack App"] = 1020,
    ["Zerops.io config"] = 1008,
    ["Zerops.io import"] = 1009,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 973,
    ...
    ["behat.yml"] = 105,
    ["bigquery-table"] = 94,
    ["bioimageio resource description"] = 990,
    ...
    ["crowdin.yml"] = 236,
    ["ctfd-setup configuration file"] = 1041,
    ["custom-elements.json"] = 960,
    ["cypress.json"] = 240,
    ...
    ["gematik health care insurance list"] = 1047,
    ["gematik health care patient list"] = 1044,
    ["gematik health care provider institution list"] = 1046,
    ["gematik health care provider list"] = 1045,
    ["gematik tiger test environment configuration"] = 1048,
    ["gitlab-ci"] = 342,
    ["global.json"] = 358,
    ...
    ["ize.toml"] = 937,
    ["jsconfig.json"] = 423,
    ["jscpd Configuration"] = 922,
    jsdoc = 837,
    ["k3d.yaml"] = 424,
    ["k9s aliases.yaml"] = 426,
    ["k9s cluster-config.yaml"] = 428,
    ["k9s config.yaml"] = 427,
    ["k9s hotkeys.yaml"] = 429,
    ["k9s plugins.yaml"] = 430,
    ["k9s skin.yaml"] = 431,
    ["k9s views.yaml"] = 432,
    ["kontinuous-config.yaml"] = 442,
    ["kontinuous-values.yaml"] = 441,
    ["kustomization.yaml"] = 444,
    ["label-commenter-config.yml"] = 445,
    ["latexindent configuration"] = 75,
    ["launchsettings.json"] = 446,
    lazydocker = 959,
    lazygit = 958,
    ["lego.json"] = 448,
    ["lerna.json"] = 449,
    ["lgtm.yml"] = 450,
    ["liblab.config.json"] = 451,
    ["libman.json"] = 452,
    ["license-report-config.json"] = 453,
    ["linkinator.config.json"] = 455,
    ["lint-staged (.lintstagedrc)"] = 816,
    ["local.settings.json"] = 460,
    ["localazy.json"] = 461,
    ["lotus.yaml"] = 459,
    ["lsdlschema.json"] = 462,
    ["markdown-link-check"] = 880,
    maturin = 881,
    mboats = 888,
    ["micro-settings.json"] = 952,
    ["mimetypes.json"] = 474,
    ["mirrord config"] = 817,
    mise = 818,
    ["mkdocs.yml"] = 494,
    ["monospace.yml"] = 497,
    ["moon.yml"] = 1033,
    ["mprocs Configuration file"] = 1005,
    ["mrdocs.yml"] = 495,
    ["mta.yaml"] = 819,
    ["mtad.yaml"] = 820,
    ["mycode.json"] = 504,
    nFPM = 508,
    ["napari plugin manifest"] = 505,
    neoload = 832,
    ["nest-cli"] = 511,
    ["ninjs (News in JSON)"] = 510,
    ["nitro.json"] = 831,
    ["nixd configuration"] = 978,
    ["nlu.json"] = 512,
    ["nodemon.json"] = 514,
    ["noodl config"] = 887,
    ["notebook.mod.json"] = 515,
    now = 827,
    ["npm-badges"] = 518,
    ["nswag.json"] = 522,
    ntangle = 524,
    ["nuclei-template.yaml"] = 519,
    ["nuget-project.json"] = 520,
    ["ocelot.json"] = 526,
    ["omnisharp.json"] = 530,
    ["openapi.json"] = 531,
    ["openfin.json"] = 538,
    ...
    ["ops.yaml"] = 535,
    ["package.json"] = 558,
    ["package.manifest"] = 559,
    ["partial-black.json"] = 106,
    ["pathfinder.yml"] = 562,
    ["pattern.json"] = 565,
    ["petstore-v1.0"] = 932,
    pgap_yaml_input_reader = 564,
    ["pixi.toml"] = 566,
    ["plagiarize-me.yaml"] = 570,
    ["plagiarize.yaml"] = 569,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1037,
    ["podbard.yaml"] = 572,
    ["portman.json"] = 573,
    ["prefect.toml"] = 581,
    ["prettierrc.json"] = 582,
    ["prisma.yml"] = 583,
    ["project-1.0.0-beta3.json"] = 592,
    ["project-1.0.0-beta4.json"] = 593,
    ["project-1.0.0-beta5.json"] = 594,
    ["project-1.0.0-beta6.json"] = 595,
    ["project-1.0.0-beta8.json"] = 596,
    ["project-1.0.0-rc1.json"] = 597,
    ["project-1.0.0-rc2.json"] = 598,
    ["project.json"] = 591,
    ["project.owasp.yaml"] = 599,
    ["prometheus.json"] = 600,
    ["prometheus.rules.json"] = 601,
    ["prometheus.rules.test.json"] = 602,
    ["proxies.json"] = 603,
    ["publiccode.yml"] = 604,
    ["pubspec.yaml"] = 605,
    ["pyrseas-0.8.json"] = 608,
    pytest = 617,
    ["quilt.mod.json"] = 953,
    ["rc3 auth"] = 621,
    ["rc3 collection"] = 622,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 833,
    ["release-please-config.json"] = 631,
    ["release-please-manifest.json"] = 632,
    ["release-plz.toml"] = 633,
    ["renv.lock"] = 642,
    ["rivet.json"] = 977,
    ["rivet.yaml (legacy)"] = 976,
    rockcraft = 644,
    runny = 646,
    rustfmt = 647,
    sake = 1063,
    samt = 649,
    samtrc = 650,
    ["sarif-1.0.0.json"] = 652,
    ["sarif-2.0.0.json"] = 653,
    ["sarif-2.1.0"] = 663,
    ["sarif-2.1.0-rtm.2"] = 654,
    ["sarif-2.1.0-rtm.3"] = 656,
    ["sarif-2.1.0-rtm.4"] = 658,
    ["sarif-2.1.0-rtm.5"] = 660,
    ["sarif-2.1.0-rtm.6"] = 661,
    ["sarif-external-property-file-2.1.0"] = 664,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 655,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 657,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 659,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 662,
    ["scalingo.json configuration"] = 665,
    ["schema.org - Action"] = 667,
    ["schema.org - ContactPoint"] = 668,
    ["schema.org - Place"] = 669,
    ["schema.org - Thing"] = 670,
    ["secrethub.yml"] = 955,
    ["semantic-release"] = 676,
    ["servicehub.config.json"] = 811,
    ["servicehub.service.json"] = 810,
    ["settings.job"] = 679,
    ["sfdx-hardis configuration"] = 681,
    ["shard.yml"] = 993,
    ["size-limit configuration"] = 686,
    ["skaffold.yaml"] = 878,
    ["skyuxconfig.json"] = 688,
    snapcraft = 689,
    ["snowflake-config"] = 690,
    ["snowflake-connections"] = 691,
    ["spicepod.yaml"] = 1012,
    ["sqlc configuration"] = 704,
    ["stripe-app-local.json"] = 713,
    ["stripe-app.json"] = 712,
    swcrc = 863,
    ["task.json"] = 722,
    taskcat = 828,
    ["template.json"] = 727,
    ["templatsources.json"] = 728,
    ["theme.json"] = 731,
    ["tizen_workspace.json"] = 732,
    tldr = 733,
    ["tm_devices configuration file"] = 1074,
    tmuxinator = 814,
    ["transcend.yml"] = 743,
    ["tree-sitter grammar.json"] = 366,
    ["trime.yaml"] = 744,
    ["trunk.yaml"] = 746,
    ["ts-force-config.json"] = 751,
    ["tsconfig.json"] = 747,
    ["tsd.json"] = 748,
    ["tsdoc.json"] = 749,
    ["tsdrc.json"] = 750,
    ...
    ["vega-lite.json"] = 774,
    ["vega.json"] = 773,
    ["venvironment-basic.yaml"] = 777,
    ["venvironment.yaml"] = 776,
    ["venvplus-basic.yaml"] = 779,
    ["venvplus.yaml"] = 778,
    version = 1056,
    ["version.json"] = 781,
    ["vhwdebugger-binding.yaml"] = 783,
    ["vim-addon-info"] = 784,
    ["vs-2017.3.host.json"] = 786,
    ["vs-nesting.json"] = 787,
    ["vsls.json"] = 785,
    ["vss-extension.json"] = 791,
    vtcfg = 1062,
    ["vtesttree.yaml"] = 792,
    ["vtestunit.yaml"] = 793,
    ["warp-keysets.json"] = 961,
    ["warp-themes.json"] = 962,
    ["warp-workflows.json"] = 963,
    ["webhint.io"] = 918,
    ["webjobpublishsettings.json"] = 798,
    ["webjobs-list.json"] = 797,
    ["well-known-fursona"] = 1000,
    ["xs-app.json"] = 823,
    ["xunit.runner.json"] = 809,
    yamllint = 851,
    zuul = 834,
    ["Žinoma"] = 844
  },
