...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 135,
    [".cryproj (generic)"] = 468,
    [".cryproj engine-5.2"] = 463,
    [".cryproj engine-5.3"] = 464,
    [".cryproj engine-5.4"] = 465,
    [".cryproj engine-5.5"] = 466,
    [".cryproj engine-dev"] = 467,
    [".csscomb.json"] = 137,
    [".csslintrc"] = 138,
    [".eslintrc"] = 179,
    [".esmrc.json"] = 171,
    ...
    [".mtaext"] = 476,
    [".nodehawkrc"] = 292,
    [".npmpackagejsonlintrc"] = 294,
    [".phraseapp.yml"] = 327,
    [".pmbot.yml"] = 319,
    [".postcssrc"] = 324,
    [".pre-commit-config.yml"] = 325,
    [".pre-commit-hooks.yml"] = 326,
    [".putout.json"] = 344,
    [".rehyperc"] = 350,
    [".remarkrc"] = 351,
    [".sprite files"] = 391,
    ...
    [".vsext"] = 444,
    [".yarnrc.yml"] = 508,
    ["<div>RIOTS' studio configuration"] = 447,
    ["API Builder"] = 505,
    ["AVA Configuration Schema"] = 559,
    ...
    ["Azure Pipelines"] = 41,
    ["Azure Static Web Apps CLI configuration file"] = 393,
    ["Azure Static Web Apps configuration file"] = 392,
    ["BX CI"] = 70,
    ["Better Code Hub"] = 510,
    ["Better Scripts"] = 71,
    BizTalkServerApplicationSchema = 482,
    ...
    ["Butane config schema"] = 546,
    ["CICS TS region tagging"] = 553,
    ["CICS TS resource import"] = 554,
    ["CICS TS resource model"] = 555,
    ["CICS TS resource overrides"] = 556,
    ["CMake Presets"] = 72,
    ...
    ["Container Structure Test"] = 493,
    Containerlab = 517,
    ["Dart build configuration"] = 139,
    ["Dart test config"] = 140,
    ["DashLord configuration"] = 141,
    ["Datadog Service Definition"] = 250,
    ["Datahub Ingestion Recipe Schema"] = 560,
    ...
    ["Embrace Config Schema"] = 571,
    ["Error pages"] = 174,
    Esquio = 172,
    ["Estuary Flow Catalog Schema"] = 550,
    ["Expo SDK"] = 177,
    ...
    Goreleaser = 205,
    ["Goreleaser Pro"] = 206,
    ["Gradle Build Cache Node"] = 507,
    ["Gradle Enterprise"] = 506,
    ...
    HEMTT = 479,
    Hadolint = 491,
    ["Hardware Sentry Configuration"] = 564,
    Hayson = 218,
    ...
    ["Istanbul Schema"] = 567,
    ["JFrog File Spec"] = 235,
    ["JFrog Pipelines YML DSL"] = 573,
    ["JSON Document Transform"] = 243,
    ["JSON Feed"] = 244,
    ["JSON Resume"] = 354,
    ["JSON Schema Draft 2020-12"] = 459,
    ["JSON Schema Draft 4"] = 456,
    ["JSON Schema Draft 7"] = 457,
    ["JSON Schema Draft 8"] = 458,
    ...
    ["KSP-AVC"] = 454,
    ["KSP-CKAN"] = 455,
    ["Keycloak REST API"] = 575,
    ["KoDE/CI build.yaml"] = 569,
    ["Kong DBLess Schema"] = 570,
    KrakenD = 249,
    ["LinkML Metamodel"] = 260,
    Liquibase = 521,
    ["Liquibase Flow File"] = 522,
    Markdownlint = 525,
    ["MegaLinter configuration"] = 264,
    ["MegaLinter descriptor"] = 265,
    ["Meltano plugin discovery definition"] = 267,
    ["Meltano project definition"] = 266,
    ["Microsoft Band Web Tile"] = 268,
    ["Minecraft Data Pack Advancement"] = 270,
    ["Minecraft Data Pack Biome"] = 271,
    ["Minecraft Data Pack Configured Carver"] = 272,
    ["Minecraft Data Pack Dimension"] = 274,
    ["Minecraft Data Pack Dimension Type"] = 273,
    ["Minecraft Data Pack Item Modifier"] = 275,
    ["Minecraft Data Pack Loot Table"] = 276,
    ["Minecraft Data Pack Metadata"] = 277,
    ["Minecraft Data Pack Predicate"] = 278,
    ["Minecraft Data Pack Recipe"] = 279,
    ["Minecraft Data Pack Template Pool"] = 280,
    ["Minecraft Resourcepack Sounds"] = 281,
    ["MongoDB Atlas Search Index Definition Schema"] = 568,
    ["Monika Configuration Schema"] = 566,
    ["Motif config"] = 475,
    ["Netin Diagnostic System Template"] = 530,
    ["Netlify config schema"] = 286,
    ["Nightwatch.js"] = 287,
    ["OSS Review Toolkit configuration"] = 309,
    ["OSS Review Toolkit curation"] = 310,
    ["OSS Review Toolkit package configuration"] = 311,
    ["OSS Review Toolkit repository configuration"] = 312,
    ["OSS Review Toolkit resolutions"] = 313,
    Opctl = 478,
    ["OpenWeather Current Weather API"] = 514,
    ["OpenWeather Road Risk API"] = 513,
    ["Ory Hydra configuration"] = 224,
    ["Ory Keto configuration"] = 251,
    ["Ory Kratos configuration"] = 308,
    ["Ory Oathkeeper configuration"] = 299,
    ["Outblocks App configuration"] = 306,
    ["Outblocks database table"] = 307,
    ["Outblocks project configuration"] = 305,
    Packer = 316,
    ["Pipeline component"] = 523,
    ["PocketMine plugin.yml"] = 320,
    Pterodactyl = 563,
    ["Pull Request Labeler"] = 343,
    PyProject = 347,
    Qodana = 539,
    ["Quali Torque Blueprint Spec 2"] = 561,
    ["RKE Cluster Configuration JSON Schema"] = 520,
    ["RKE Cluster Configuration YAML Schema"] = 519,
    Ray = 490,
    ["Read the Docs"] = 346,
    ["Red-DiscordBot Cog"] = 348,
    ["Red-DiscordBot Cog Repo"] = 349,
    Renovate = 355,
    ["Replit schema"] = 352,
    RoadRunner = 356,
    ["Rust toolchain"] = 358,
    SWADL = 404,
    ["Sapphire CLI Config"] = 359,
    ["SauceCTL Configuration"] = 527,
    ["Schema Catalog"] = 372,
    ["Scoop manifest"] = 377,
    ["Semgrep Rule"] = 379,
    ["Serverless Framework Configuration"] = 534,
    ["Serverless Workflow Schema"] = 535,
    ["Settings.paf"] = 381,
    ["Shopware 6 Configuration"] = 536,
    ["Shopware CLI Extension Store Configuration"] = 537,
    ["Shopware CLI Project Store Configuration"] = 538,
    Solidarity = 386,
    ["Solution filters"] = 387,
    ["Source Maps v3"] = 388,
    SpecIF = 389,
    ["Sponge Mixin configuration"] = 390,
    ["StackHawk Scanner Configuration"] = 533,
    ["StackHead CLI config"] = 394,
    ["StackHead module configuration"] = 395,
    ["StackHead project definition"] = 396,
    Stale = 397,
    Starship = 398,
    ["Statamic Blueprint"] = 399,
    ["StrmPrivacy batch job configuration file"] = 574,
    ["Stryker Mutator"] = 401,
    ["StyleCop Analyzers Configuration"] = 402,
    ["Swagger API 2.0"] = 405,
    ["Talisman configuration"] = 406,
    ["Taskfile YAML Schema"] = 516,
    Taurus = 407,
    ["TestEnvironment.json"] = 414,
    Tikibase = 410,
    ["Traefik v2"] = 417,
    ["Traefik v2 File Provider"] = 418,
    Turborepo = 415,
    Tye = 540,
    ["UI5 Manifest"] = 430,
    ["UTAM Page Object"] = 432,
    ["Ubuntu Server Autoinstall"] = 428,
    ["Uniswap Token List"] = 499,
    Updatecli = 547,
    ["User Journey Map YAML Schema"] = 518,
    V2Ray = 551,
    ["VSCode Code Snippets"] = 111,
    ["VSIX CLI publishing"] = 445,
    ["Vela Pipeline Configuration"] = 435,
    Vercel = 110,
    ["Web App Manifest"] = 449,
    ["Web types"] = 452,
    WebExtensions = 448,
    ["Webman package recipe"] = 557,
    ["Windows Package Manager Installer Manifest"] = 496,
    ["Windows Package Manager Locale Manifest"] = 497,
    ["Windows Package Manager Singleton Manifest"] = 495,
    ["Woodpecker pipeline config"] = 529,
    ["Xstate Machine Schema"] = 545,
    ["Yippee-Ki-JSON configuration YML"] = 501,
    ["angular.json"] = 8,
    ...
    ["jsconfig.json"] = 247,
    ["jscpd Configuration Schema"] = 562,
    jsdoc = 489,
    ["k3d.yaml"] = 248,
    ["kustomization.yaml"] = 252,
    ["label-commenter-config.yml"] = 253,
    ["launchsettings.json"] = 254,
    ["lerna.json"] = 255,
    ["lgtm.yml"] = 256,
    ["libman.json"] = 257,
    ["license-report-config.json"] = 258,
    ["linkinator.config.json"] = 259,
    ["local.settings.json"] = 261,
    ["localazy.json"] = 262,
    ["lsdlschema.json"] = 263,
    ["markdown-lint-check"] = 526,
    mboats = 532,
    ["mimetypes.json"] = 269,
    ["mta.yaml"] = 473,
    ["mtad.yaml"] = 474,
    ["mycode.json"] = 284,
    ["napari plugin manifest"] = 285,
    neoload = 484,
    ["nest-cli"] = 290,
    ["ninjs (News in JSON) 1.3"] = 289,
    ["ninjs (News in JSON) 2.0"] = 288,
    ["nlu.json"] = 291,
    ["nodemon.json"] = 293,
    ["noodl.schema.json"] = 531,
    now = 480,
    ["nswag.json"] = 297,
    ntangle = 298,
    ["nuclei-template.yaml"] = 295,
    ["nuget-project.json"] = 296,
    ["ocelot.json"] = 300,
    ["omnisharp.json"] = 301,
    ["openapi.json"] = 302,
    ["openfin.json"] = 304,
    ["openrpc.json"] = 303,
    ["package.json"] = 314,
    ["package.manifest"] = 315,
    ["pattern.json"] = 318,
    ["petstore-v1.0"] = 572,
    pgap_yaml_input_reader = 317,
    ["plagiarize-me.yaml"] = 322,
    ["plagiarize.yaml"] = 321,
    ["portman.json"] = 323,
    ["prettierrc.json"] = 328,
    ["prisma.yml"] = 329,
    ["project-1.0.0-beta3.json"] = 331,
    ["project-1.0.0-beta4.json"] = 332,
    ["project-1.0.0-beta5.json"] = 333,
    ["project-1.0.0-beta6.json"] = 334,
    ["project-1.0.0-beta8.json"] = 335,
    ["project-1.0.0-rc1.json"] = 336,
    ["project-1.0.0-rc2.json"] = 337,
    ["project.json"] = 330,
    ["prometheus.json"] = 338,
    ["prometheus.rules.json"] = 339,
    ["proxies.json"] = 340,
    ["publiccode.yml"] = 341,
    ["pubspec.yaml"] = 342,
    ["pyrseas-0.8.json"] = 345,
    ["release drafter"] = 485,
    rustfmt = 357,
    ["sarif-1.0.0.json"] = 360,
    ["sarif-2.0.0.json"] = 361,
    ["sarif-2.1.0"] = 370,
    ["sarif-2.1.0-rtm.2"] = 362,
    ["sarif-2.1.0-rtm.3"] = 364,
    ["sarif-2.1.0-rtm.4"] = 366,
    ["sarif-2.1.0-rtm.5"] = 368,
    ["sarif-external-property-file-2.1.0"] = 371,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 363,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 365,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 367,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 369,
    ["schema.org - Action"] = 373,
    ["schema.org - ContactPoint"] = 374,
    ["schema.org - Place"] = 375,
    ["schema.org - Thing"] = 376,
    ["semantic-release"] = 378,
    ["servicehub.config.json"] = 462,
    ["servicehub.service.json"] = 461,
    ["settings.job"] = 380,
    ["sfdx-hardis configuration"] = 382,
    ["size-limit configuration"] = 383,
    ["skaffold.yaml"] = 524,
    ["skyuxconfig.json"] = 384,
    snapcraft = 385,
    ["stripe-app.json"] = 400,
    swcrc = 512,
    taskcat = 481,
    ["template.json"] = 408,
    ["templatsources.json"] = 409,
    ["theme.json"] = 411,
    ["tizen_workspace.json"] = 412,
    tmLanguage = 413,
    tmuxinator = 470,
    ["trunk.yaml schema"] = 419,
    ["ts-force-config.json"] = 423,
    ["tsconfig.json"] = 420,
    ["tsd.json"] = 421,
    ["tsdrc.json"] = 422,
    ["tslint.json"] = 424,
    ...
    ["vega-lite.json"] = 434,
    ["vega.json"] = 433,
    ["venvironment-basic.yaml"] = 437,
    ["venvironment.yaml"] = 436,
    ["version.json"] = 438,
    ["vim-addon-info"] = 439,
    ["vs-2017.3.host.json"] = 441,
    ["vs-nesting.json"] = 442,
    ["vsls.json"] = 440,
    ["vss-extension.json"] = 446,
    ["webhint.io"] = 558,
    ["webjobpublishsettings.json"] = 451,
    ["webjobs-list.json"] = 450,
    ["xs-app.json"] = 477,
    ["xunit.runner.json"] = 460,
    yamllint = 500,
    zuul = 486,
    ["Žinoma"] = 494
  },
