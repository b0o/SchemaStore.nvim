...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1087,
    [".nodehawkrc"] = 699,
    [".npmpackagejsonlintrc"] = 704,
    [".omletrc"] = 1268,
    [".phrase.yml"] = 786,
    [".phraseapp.yml"] = 787,
    [".pmbot.yml"] = 771,
    [".postcssrc"] = 780,
    [".powerpages-web-template-manifest"] = 782,
    [".pre-commit-config.yml"] = 783,
    [".pre-commit-hooks.yml"] = 784,
    [".putout.json"] = 820,
    [".rehyperc"] = 845,
    [".remarkrc"] = 849,
    [".sprite files"] = 951,
    ...
    AIConfig = 46,
    ["AMX Muse Program Descriptor"] = 1317,
    ["API Builder"] = 1123,
    ["AVA Configuration"] = 1187,
    ...
    ["AWS Copilot Manifest"] = 1356,
    ["AWS SAM CLI Samconfig"] = 317,
    Acton = 1410,
    ["Adobe UXP Manifest"] = 1250,
    ["Aerleon Network & Service Definitions"] = 28,
    ["Aerleon Policy"] = 29,
    ["Agent Permission Policy"] = 1396,
    ["AgentCore CLI"] = 1397,
    ["AgentCtl MCP"] = 1399,
    ["AgentCtl config"] = 1398,
    ["AgentCtl permissions"] = 1400,
    AgentLoopKit = 1401,
    Aider = 1346,
    Air = 31,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1367,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1366,
    ["Airlock Microgateway"] = 47,
    ["Alacritty Configuration"] = 1159,
    ["AlgoVoi Compliance Receipt v1"] = 17,
    ["All Contributors configuration file"] = 1213,
    ["Amazon S3 bucket CORS"] = 19,
    Anodizer = 511,
    ["Ansible Argument Specs"] = 493,
    ["Ansible Collection Galaxy"] = 500,
    ["Ansible Execution Environment"] = 490,
    ["Ansible Inventory"] = 499,
    ["Ansible Meta"] = 491,
    ["Ansible Meta Runtime"] = 492,
    ["Ansible Navigator Configuration"] = 502,
    ["Ansible Playbook"] = 497,
    ["Ansible Requirements"] = 494,
    ["Ansible Rulebook"] = 498,
    ["Ansible Tasks File"] = 496,
    ["Ansible Vars File"] = 495,
    ["Ansible-lint Configuration"] = 501,
    Any = 1278,
    ...
    ["Application list for a WinUtil"] = 1296,
    ["ArchSmith diagram IR"] = 1435,
    ArchitectFX = 1301,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1365,
    ["Azure IoT Operations connector metadata"] = 1362,
    ...
    ["Azure Pipelines"] = 134,
    ["Azure Static Web Apps CLI configuration file"] = 955,
    ["Azure Static Web Apps configuration file"] = 954,
    BMML = 1384,
    ["BOSH BPM Config"] = 160,
    ["BOSH CPI Config"] = 161,
    ...
    ["Bacon config"] = 11,
    ["Barba-CV"] = 100,
    ["Bashly (bashly.yml)"] = 1217,
    ["Bashly Settings (bashly-settings.yml)"] = 1218,
    Bento = 1383,
    ["Better Code Hub"] = 1128,
    ["Better Scripts"] = 187,
    Bigconfig = 153,
    ["Biome Formatter Config"] = 101,
    ["Bitmovin Encoding Template"] = 1310,
    BizTalkServerApplicationSchema = 1094,
    Bleep = 188,
    ["Block Protocol Metadata"] = 185,
    ["Bluebricks blueprint config"] = 1389,
    ["Boyka Framework"] = 166,
    ...
    ["Butane Config"] = 1172,
    C4InterFlow = 1325,
    ["CDK Environment Manager, concrete environment configuration"] = 1349,
    ["CDK Environment Manager, concrete environments definition"] = 1348,
    ["CDK Environment Manager, environment definition"] = 1347,
    ["CGS Card Game Specification (cgs.json)"] = 1255,
    ["CICS TS region tagging"] = 1181,
    ["CICS TS resource import"] = 1182,
    ["CICS TS resource model"] = 1183,
    ["CICS TS resource overrides"] = 1184,
    ["CMake Presets"] = 189,
    ["CNC Codes"] = 212,
    ["CRS WAF test file"] = 1285,
    ["CRS WAF test platform overrides file"] = 1286,
    ...
    ["Caido Proxy Configuration"] = 1425,
    ...
    ["Chamaleon environment"] = 1314,
    ["Chamaleon properties"] = 1315,
    ["Chamaleon template"] = 1313,
    Changepacks = 1376,
    Changesets = 326,
    Changie = 198,
    Charmcraft = 199,
    ...
    ["Claude Code Launch Preview"] = 1434,
    ["Claude Code Plugin Manifest"] = 220,
    ["Claude Code Plugin Marketplace"] = 221,
    ["Claude Code Settings"] = 222,
    ["Clawject config"] = 218,
    ["Cloud Foundry Application Manifest"] = 1267,
    ["Cloud Run Spec v1"] = 1291,
    ...
    Concord = 1284,
    ["Configu .cfgu files"] = 1272,
    ["Configu .configu file"] = 1273,
    Conjure = 211,
    ["Container Structure Test"] = 1108,
    Containerlab = 1137,
    ["Contextive Glossary"] = 1341,
    ContractGuard = 1138,
    Convex = 210,
    ...
    ["Cursor Agent Environment"] = 1394,
    ["Custom Machinery Machine"] = 1256,
    ["Custom Machinery Recipe"] = 1257,
    ["Cycle Stack File"] = 235,
    CycloneDX = 236,
    ["DWP Exchange - catalogue entry"] = 391,
    ["DWP Exchange - gateway"] = 389,
    ["DWP Exchange - meta"] = 390,
    ["Dark Factory consumer config"] = 237,
    ["Dart Build Config (dart-build.json)"] = 346,
    ["Dart Test Config (dart-test.json)"] = 347,
    ["DashLord Configuration"] = 348,
    ["Data Contract Specification"] = 349,
    ["Data Product Specification"] = 350,
    ["DataYoga Connections"] = 238,
    ["DataYoga Job"] = 239,
    ["Datadog Continuous Testing"] = 600,
    ["Datadog Service Definition"] = 601,
    ["Datadog Software Catalog"] = 602,
    ["Datahub Ingestion Recipe"] = 1188,
    ["Debian Upstream Metadata file"] = 246,
    DebtLens = 247,
    ["Deck config"] = 248,
    ["Declarative Automation Bundles"] = 1234,
    ["DeepMatch deeplinks spec"] = 249,
    ["Dein Config"] = 250,
    ["Deno Config (deno.json)"] = 357,
    ["Dependency cruiser"] = 251,
    ["DeployStack Configuration"] = 252,
    ["Deployah Configuration"] = 1364,
    ["Deployer Recipe"] = 360,
    ["Design Tokens Community Group format"] = 253,
    ["Design Tokens Community Group resolver"] = 254,
    ["Deta Spacefile"] = 255,
    ["Detekt Config (detekt.yml)"] = 361,
    ["Devbox Config"] = 256,
    ["Devbox Plugin"] = 257,
    Devfile = 388,
    Devup = 1377,
    DipDup = 1287,
    ["Discord Webhook"] = 362,
    ["DocFx Config (docfx.json)"] = 367,
    ["Docker Desktop extension metadata"] = 364,
    ["Docs MCP Manifest"] = 368,
    Dofigen = 369,
    ["Dolittle Artifacts"] = 370,
    ["Dolittle Bounded Context Configuration"] = 371,
    ["Dolittle Event Horizons Configuration"] = 372,
    ["Dolittle Resources Configuration"] = 373,
    ["Dolittle Server Configuration"] = 374,
    ["Dolittle Tenant Map Configuration"] = 376,
    ["Dolittle Tenants Configuration"] = 375,
    ["Dolittle Topology"] = 377,
    ["DonateCaseBetterCasino menu"] = 1318,
    ["Draugr Saga"] = 356,
    ...
    ["Drupal Routing"] = 270,
    ["Drupal Services"] = 272,
    ["Drush site aliases"] = 383,
    ["Dust configuration"] = 386,
    ["Dynamic Bash Aliases (.aliases)"] = 1225,
    ["EAS config"] = 430,
    ["ECA - Editor Code Assistant"] = 393,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1214,
    ["ESLint Suppressions"] = 435,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1361,
    ["EasyVCR .NET"] = 432,
    ["Eidolon Resource"] = 1302,
    ["Elgato Stream Deck"] = 396,
    Elm = 1289,
    ["Embrace Config"] = 1200,
    Emmet = 1290,
    Endurica = 1238,
    ["Enonic XP API descriptor"] = 399,
    ["Enonic XP Admin Extension descriptor"] = 400,
    ["Enonic XP Admin Tool descriptor"] = 401,
    ["Enonic XP Application descriptor"] = 402,
    ["Enonic XP CMS descriptor"] = 403,
    ["Enonic XP Content Type descriptor"] = 404,
    ["Enonic XP Form Fragment descriptor"] = 405,
    ["Enonic XP ID Provider descriptor"] = 406,
    ["Enonic XP Layout descriptor"] = 407,
    ["Enonic XP Macro descriptor"] = 408,
    ["Enonic XP Mixin descriptor"] = 409,
    ["Enonic XP Page descriptor"] = 410,
    ["Enonic XP Part descriptor"] = 411,
    ["Enonic XP Service descriptor"] = 412,
    ["Enonic XP Site descriptor"] = 413,
    ["Enonic XP Style descriptor"] = 414,
    ["Enonic XP Task descriptor"] = 415,
    ["Enonic XP Webapp descriptor"] = 416,
    ["Enterprise Contract Policy Spec"] = 397,
    ["Envelope Team Definition"] = 1409,
    ["Envilder Map File"] = 398,
    ["Erda Pipeline"] = 1263,
    ["Erda Runtime"] = 1264,
    ["Espanso config.yml"] = 1387,
    ["Espanso match.yml"] = 1386,
    Esquio = 418,
    ["Estuary Flow Catalog"] = 1178,
    ["Ethereum ERC1155"] = 1403,
    ["Ethereum ERC721"] = 1402,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 423,
    ["EveryVoice TTS Toolkit Data Configuration"] = 424,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 428,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 427,
    ["EveryVoice TTS Toolkit Text Configuration"] = 425,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 426,
    ["Evolving Resolutive Process notation"] = 1363,
    ["Expo SDK"] = 429,
    ["Expoot app config"] = 431,
    ["F-Droid Data metadata"] = 437,
    ["FasterCI Configuration"] = 135,
    ["Fence configuration"] = 136,
    FiQuS = 441,
    Firebase = 439,
    ["Flatpak Builder Manifest"] = 442,
    ["FlexGet Config"] = 443,
    ["Flow.json Configurations"] = 1260,
    ["Fossa configuration file"] = 450,
    ["Fossa's fossa-deps file"] = 451,
    ["Foundry VTT - Base package Manifest"] = 445,
    ["Foundry VTT - Module Manifest"] = 446,
    ["Foundry VTT - System Data Template"] = 449,
    ["Foundry VTT - System Manifest"] = 447,
    ["Foundry VTT - World Manifest"] = 448,
    ["Foxx Manifest"] = 137,
    ["Freifunk.de Community API"] = 140,
    ["Frogbot Config"] = 141,
    ["G2P Mapping Configuration"] = 458,
    GAMA = 459,
    ["GCP Blueprint Metadata"] = 462,
    Gaspar = 460,
    ["GatewayCore API Gateway"] = 461,
    ["Gemini CLI settings"] = 463,
    ["GeoJSON.json latest"] = 1176,
    GherKing = 1180,
    ["GitHub Action"] = 473,
    ["GitHub Actions typing"] = 1298,
    ["GitHub CLI configuration"] = 474,
    ["GitHub CLI hosts"] = 475,
    ["GitHub Discussion"] = 476,
    ["GitHub Funding"] = 478,
    ["GitHub Issue Template configuration"] = 479,
    ["GitHub Issue Template forms"] = 480,
    ["GitHub Pages Jekyll"] = 481,
    ["GitHub Prompt"] = 477,
    ["GitHub Secret Scanning"] = 482,
    ["GitHub Workflow"] = 483,
    ["GitHub Workflow Template Properties"] = 484,
    ["GitHub automatically generated release notes configuration"] = 485,
    ["GitLab Agent for Kubernetes configuration"] = 1252,
    ["GitLab Duo Workflow"] = 487,
    GitResume = 489,
    GitVersion = 466,
    ["Gitea Issue Template configuration"] = 469,
    ["Gitea Issue Template forms"] = 470,
    Gitleaks = 467,
    ["Gitpod Configuration"] = 488,
    ["Glamour style"] = 464,
    ["GlazeWM settings"] = 1254,
    ["Global Privacy Control"] = 465,
    Goblet = 1233,
    ["Golangci-lint Configuration"] = 504,
    ["Golangci-lint Custom Plugins Configuration"] = 505,
    ["Google Chrome Related Website Sets"] = 440,
    ["Google Cloud Workflows"] = 313,
    ["Google Digital Assetlinks"] = 1342,
    Goreleaser = 509,
    ["Goreleaser Pro"] = 510,
    Goss = 512,
    ["Gradle Build Cache Node"] = 1126,
    ["Gradle Enterprise"] = 1125,
    ["Grafana 5.x Dashboard"] = 513,
    ["GraphQL Code Generator"] = 518,
    ["GraphQL Config"] = 517,
    ["GraphQL Mesh"] = 516,
    ["GroovyLint configuration"] = 519,
    ["Grunt JSHint task"] = 523,
    ["Grunt Watch task"] = 524,
    ["Grunt base task"] = 525,
    ["Grunt clean task"] = 521,
    ["Grunt copy task"] = 520,
    ["Grunt cssmin task"] = 522,
    HEMTT = 1090,
    Hadolint = 1104,
    Hammerkit = 1136,
    ["Hardware Sentry Configuration"] = 1192,
    ["Hashgraph Online Skill Manifest"] = 7,
    ["HashiCorp Vault"] = 526,
    Hatch = 1105,
    Hayson = 528,
    ["Haystack Pipeline"] = 529,
    ["Hazelcast 5 Configuration"] = 530,
    ["Hecate Input Schema"] = 1353,
    ["Helm Chart.lock"] = 274,
    ["Helm Chart.yaml"] = 273,
    ["Helm Unittest Test Suite"] = 275,
    ["Heloisa Assistant Plugins Marketplace"] = 1432,
    ["Hex file"] = 276,
    ["Home Assistant Integration Manifest"] = 532,
    ["Homer dashboard configuration"] = 533,
    ["Hoverfly Simulation"] = 538,
    Hugo = 1168,
    ["Hugo Theme"] = 1167,
    ["Hulak Configuration"] = 541,
    ["Hyperfoil benchmark configuration"] = 540,
    ["IBM Zapp document"] = 542,
    ["IBM zCodeFormatSettings"] = 543,
    ["IMG Catapult PSP"] = 548,
    ["IVMS101 by CODE Protocol"] = 1253,
    ["Infinispan Configuration"] = 550,
    ["Infinispan Server Configuration"] = 551,
    Infrahub = 552,
    Istanbul = 1196,
    ["JDownloader2 crawler multi-rules"] = 566,
    ["JDownloader2 crawler single-rules"] = 565,
    ["JFrog Applications Config"] = 567,
    ["JFrog File Spec"] = 568,
    ["JFrog Pipelines YML DSL"] = 1202,
    ["JMeter DSL cli config"] = 569,
    JReleaser = 572,
    ["JSON Document Transform"] = 580,
    ["JSON Feed"] = 581,
    ["JSON Resume"] = 858,
    ["JSON Schema Draft 2020-12"] = 1070,
    ["JSON Schema Draft 4"] = 1067,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1235,
    ["JSON Schema Draft 7"] = 1068,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1236,
    ["JSON Schema Draft 8 (2019-09)"] = 1069,
    ["JSON-API"] = 579,
    ["JSON-e templates"] = 1133,
    ["JSON-stat 2.0"] = 1063,
    JSONPatch = 583,
    ["JSR Package Config (jsr.json)"] = 573,
    Jarl = 1369,
    Jasmine = 560,
    Jekyll = 561,
    ["Jenkins X Pipelines"] = 562,
    ["Jenkins X Requirements"] = 563,
    Jest = 564,
    Jocker = 570,
    ["Jovo Language Models"] = 571,
    Jsontron = 584,
    ["Jujutsu (jj) VCS config"] = 1355,
    ["KIMMDY config file"] = 595,
    ["KODE/CI build.yaml"] = 1198,
    ["KSP-AVC"] = 1064,
    ["KSP-CKAN"] = 1065,
    ["KSP-NetKAN"] = 1066,
    KSY = 1265,
    KSail = 456,
    ["KYA Manifest"] = 1266,
    ["Karakum configuration file"] = 452,
    Kas = 587,
    ["Kestra flow file"] = 596,
    ["Keycloak REST API"] = 1205,
    ["Knative Functions - func.yaml"] = 453,
    Knip = 454,
    ["Knip JSONC"] = 455,
    ["Knowledge Unit"] = 604,
    ["Kometa (nightly) config file"] = 598,
    ["Kometa config file"] = 597,
    ["Kong DBLess config"] = 1199,
    KrakenD = 599,
    ["Kubri Configuration"] = 607,
    LOOBin = 625,
    ["Lake configuration file"] = 1358,
    ...
    ["Lando (landofile)"] = 127,
    ["LangGraph Platform configuration"] = 1277,
    ["Language configuration"] = 1276,
    Lefthook = 612,
    ["Liferay client-extension.yaml"] = 619,
    ["LinkML Metamodel"] = 621,
    ["LiquiLens Evidence Carrier Reference v1"] = 623,
    ["LiquiLens Evidence Carrier v1"] = 622,
    Liquibase = 1143,
    ["Liquibase Flow File"] = 1144,
    ["Lively Properties"] = 624,
    ["Lobe AI Agent"] = 129,
    Loki = 130,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 668,
    ["MS2Rescore Configuration"] = 676,
    ["MSTest testconfig.json"] = 677,
    ["Madge configuration"] = 631,
    ["Madness (madness.yml)"] = 1216,
    ["Mado configuration"] = 632,
    ["Maestro Flow"] = 633,
    ["Mail Servers Configuration"] = 1390,
    ["MapEHR Mapping"] = 634,
    Markdownlint = 1147,
    ["Mason Registry"] = 1150,
    ["MegaLinter Custom Flavor"] = 637,
    ["MegaLinter configuration"] = 636,
    ["MegaLinter descriptor"] = 638,
    Melange = 1243,
    ["Meltano project definition"] = 639,
    ["Mergify Configuration"] = 678,
    ["Mermaid config"] = 2,
    ["Metadata for a Bazel module"] = 640,
    ["Metadata for a Cinnamon spice"] = 1294,
    ["Metatype Configuration"] = 641,
    ["MetricsHub Configuration"] = 642,
    ["MetricsHub Connector Configuration"] = 643,
    ["Micro Editor Syntax"] = 1226,
    ["Microsoft Band Web Tile"] = 644,
    ["Microsoft RulesEngine workflow rules"] = 1281,
    ["Microsoft RulesEngine workflow rules list"] = 1282,
    ["Minecraft Custom Main Menu Mod"] = 1244,
    ["Minecraft Data Pack Advancement"] = 646,
    ["Minecraft Data Pack Biome"] = 647,
    ["Minecraft Data Pack Configured Carver"] = 648,
    ["Minecraft Data Pack Damage Type"] = 649,
    ["Minecraft Data Pack Dimension"] = 651,
    ["Minecraft Data Pack Dimension Type"] = 650,
    ["Minecraft Data Pack Item Modifier"] = 652,
    ["Minecraft Data Pack Loot Table"] = 653,
    ["Minecraft Data Pack Metadata"] = 654,
    ["Minecraft Data Pack Predicate"] = 655,
    ["Minecraft Data Pack Recipe"] = 656,
    ["Minecraft Data Pack Tag"] = 657,
    ["Minecraft Data Pack Template Pool"] = 658,
    ["Minecraft Data Pack Trim Material"] = 663,
    ["Minecraft Data Pack Trim Pattern"] = 664,
    ["Minecraft Resource Pack Lang"] = 659,
    ["Minecraft Resource Pack Particle"] = 660,
    ["Minecraft Resource Pack Texture Mcmeta"] = 662,
    ["Minecraft Resourcepack Sounds"] = 661,
    ["MockServer Expectation"] = 670,
    ["MockServer Expectations"] = 671,
    ModuleAssembler = 666,
    ["Monade CLI Stack Configuration"] = 681,
    ["MongoDB Atlas Search Index Definition"] = 1197,
    ["Monika Configuration"] = 1195,
    ["Monoweave Configuration"] = 675,
    ["Motif config"] = 1086,
    MultiQC = 1335,
    ["NOX Framework (Service)"] = 703,
    ["Netin Diagnostic System Template"] = 1154,
    ["Netlify config"] = 684,
    ["Network-as-Code Data Model"] = 685,
    ["Next Gen UI Agent A2A Server Configuration"] = 686,
    ["Next Gen UI Agent Configuration"] = 688,
    ["Next Gen UI Agent MCP Server Configuration"] = 687,
    ["Nightwatch.js"] = 695,
    ["Nika workflow"] = 700,
    ["Node.js configuration"] = 1091,
    ["NueJS configuration file"] = 708,
    ["Nuitka Package Config"] = 1258,
    ["Nullstone config"] = 710,
    ["ODGS Data Rules"] = 717,
    ["ODGS Ontology Graph"] = 718,
    ["ODGS Standard Metrics"] = 716,
    ["OKF Graph"] = 1433,
    ["ONe's changelog entry"] = 732,
    ["ONe's service descriptor"] = 731,
    ["ORT Server repository environment configuration"] = 743,
    ["OSCAL Assessment Plan (AP)"] = 745,
    ["OSCAL Assessment Results (AR)"] = 746,
    ["OSCAL Catalog"] = 747,
    ["OSCAL Component Definition (CDef)"] = 748,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 749,
    ["OSCAL Profile"] = 750,
    ["OSCAL System Security Plan (SSP)"] = 751,
    ["OSS Review Toolkit configuration"] = 752,
    ["OSS Review Toolkit curation"] = 753,
    ["OSS Review Toolkit package configuration"] = 754,
    ["OSS Review Toolkit project package manager definition"] = 755,
    ["OSS Review Toolkit repository configuration"] = 756,
    ["OSS Review Toolkit resolutions"] = 757,
    ["October CMS columns"] = 714,
    ["October CMS fields"] = 715,
    ["Oh My Posh"] = 720,
    Okteto = 721,
    ["Ona Tasks and Services"] = 723,
    Opctl = 1089,
    ["Open Data Contract Standard (ODCS)"] = 736,
    ["Open Data Product Standard (ODPS)"] = 737,
    ["Open Know-How"] = 1340,
    ["Open Pentest Format"] = 738,
    OpenDecree = 1407,
    ["OpenDecree Configuration"] = 1408,
    ["OpenRewrite Resource"] = 734,
    OpenSRM = 739,
    OpenStatus = 1351,
    ["OpenTelemetry Declarative Configuration"] = 735,
    ["OpenUtau character yaml"] = 728,
    ["OpenUtau ustx"] = 729,
    ["OpenWeather Current Weather API"] = 1132,
    ["OpenWeather Road Risk API"] = 1131,
    ["Ory Hydra configuration"] = 539,
    ["Ory Keto configuration"] = 603,
    ["Ory Kratos configuration"] = 744,
    ["Ory Oathkeeper configuration"] = 712,
    ["Outblocks App configuration"] = 741,
    ["Outblocks database table"] = 742,
    ["Outblocks project configuration"] = 740,
    PDM = 765,
    POPxf = 777,
    ["POPxf Correlations"] = 778,
    ["PRML manifest"] = 785,
    Packer = 761,
    PactSpec = 762,
    Panache = 763,
    Pantsbuild = 1212,
    ["Paper paper-plugin.yml"] = 764,
    ["Pipeline component"] = 1145,
    ["Platform.sh application"] = 13,
    ["Platform.sh routes"] = 14,
    ["Platform.sh services"] = 15,
    ["Plex Prerolls"] = 775,
    ["PocketMine plugin.yml"] = 772,
    ["Podman Desktop Extension"] = 1427,
    ["Postman collection"] = 781,
    ["Power Pages Configuration"] = 1352,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1297,
    ["ProActions AI-Kit Configuration"] = 793,
    ["ProActions AI-Kit Configuration for Menus"] = 795,
    ["ProActions AI-Kit Configuration for Sections"] = 797,
    ["ProActions AI-Kit Configuration for Services"] = 794,
    ["ProActions AI-Kit Configuration for Steps"] = 798,
    ["ProActions AI-Kit Configuration for Templates"] = 796,
    ["Problem object RFC9457"] = 1241,
    ["Problem package format"] = 799,
    ["Problem package generators"] = 800,
    ["Problem package submissions"] = 801,
    ["Problem package test group metadata"] = 802,
    Pterodactyl = 1191,
    ["Pull Request Labeler"] = 819,
    Pulumi = 827,
    ["PyGTA Config"] = 823,
    PyProject = 828,
    Pylock = 1343,
    Pyright = 829,
    ["Python script metadata"] = 1337,
    ["QType AI DSL"] = 832,
    Qgoda = 831,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1419,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1417,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1423,
    ["Qlik Talend Cloud Pipeline - Project"] = 1415,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1418,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1420,
    ["Qlik Talend Cloud Pipeline - Task"] = 1416,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1422,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1421,
    Qodana = 1164,
    ["Qt Creator workspace file"] = 1274,
    ["Quali Torque Blueprint Spec 2"] = 1189,
    ["QueryFirst config file"] = 1208,
    ["QuikRun Configuration"] = 1424,
    ["Qwen Code Settings"] = 1404,
    ["RKE Cluster Configuration JSON"] = 1142,
    ["RKE Cluster Configuration YAML"] = 1141,
    RadioHound = 822,
    ["Raid Profile"] = 1405,
    ["Raid Repo Configuration"] = 1406,
    Railpack = 834,
    Railway = 833,
    ["Rancher Fleet"] = 824,
    ["Rattler-build"] = 835,
    Ray = 1103,
    ["Read the Docs"] = 826,
    ["Red-DiscordBot Cog"] = 842,
    ["Red-DiscordBot Cog Repo"] = 843,
    ["Red-DiscordBot Trivia"] = 844,
    ["Releasaurus Config"] = 10,
    ReleaseKit = 9,
    ["Render Blueprints"] = 1140,
    RenderCV = 862,
    Renovate = 859,
    ["Renovate global configuration"] = 860,
    ["Renovate inherited configuration"] = 861,
    ["Replit config"] = 850,
    Restate = 1330,
    ["Revel Digital Gadget Definition File"] = 1354,
    RoadRunner = 864,
    ["Robust Station Image"] = 1360,
    Rockcraft = 865,
    ["Roo Coder Custom Modes"] = 866,
    Rubocop = 855,
    ["Rudder techniques"] = 1248,
    Ruff = 856,
    ["Rust Project"] = 857,
    ["Rust toolchain"] = 871,
    ["SDMX data message"] = 898,
    ["SDMX metadata message"] = 897,
    ["SDMX structure message"] = 896,
    ["SIL Kit Participant Configuration"] = 909,
    ["SIL Kit Registry Configuration"] = 910,
    ["SPDX 2.3"] = 952,
    SWADL = 968,
    ["Safebox Config"] = 1203,
    ["Sapphire CLI Config"] = 874,
    ["SauceCTL Configuration"] = 1151,
    Scarb = 894,
    ["Schema Catalog"] = 889,
    ["Scoop manifest"] = 895,
    ["Secure SDLC Evidence Bundle"] = 899,
    ["Semantic Data Fabric (SDF) file"] = 900,
    ["Semgrep Rule"] = 902,
    ["Serenity Code Generator (Sergen)"] = 903,
    ["Serverless Framework Configuration"] = 1158,
    ["Serverless Workflow"] = 1160,
    ["Settings for a Cinnamon spice"] = 1293,
    ["Settings.paf"] = 905,
    ["Shopware 6 Configuration"] = 1161,
    ["Shopware CLI Extension Store Configuration"] = 1162,
    ["Shopware CLI Project Store Configuration"] = 1163,
    ["Sigma Detection Rule"] = 907,
    ["SigmaCV CV"] = 5,
    ["Sigrid scope configuration file"] = 908,
    ["SkyPilot Task JSON"] = 1249,
    ["Slack app manifest"] = 915,
    ["Slang Server Configuration"] = 1431,
    Snapcraft = 917,
    ["Solarxy project config"] = 920,
    Solidarity = 921,
    ["Solution filters"] = 922,
    ["Source Maps v3"] = 923,
    Sourcery = 924,
    ["Spack bootstrap.yaml"] = 925,
    ["Spack cdash.yaml"] = 926,
    ["Spack ci.yaml"] = 927,
    ["Spack compilers.yaml"] = 928,
    ["Spack concretizer.yaml"] = 929,
    ["Spack config.yaml"] = 930,
    ["Spack definitions.yaml"] = 931,
    ["Spack develop.yaml"] = 932,
    ["Spack env_vars.yaml"] = 933,
    ["Spack environment"] = 939,
    ["Spack include.yaml"] = 934,
    ["Spack mirrors.yaml"] = 935,
    ["Spack modules.yaml"] = 936,
    ["Spack packages.yaml"] = 937,
    ["Spack repos.yaml"] = 938,
    ["Spack toolchains.yaml"] = 940,
    ["Spack upstreams.yaml"] = 941,
    ["Spack view.yaml"] = 942,
    ["Speakeasy Generation Config File"] = 946,
    ["Speakeasy Lint Configuration File"] = 943,
    ["Speakeasy Test Generation Configuration File"] = 944,
    ["Speakeasy Workflow File"] = 945,
    SpecIF = 947,
    ["Specmatic Configuration"] = 948,
    ["Specpin spec file"] = 3,
    ["Sponge Mixin configuration"] = 949,
    ["Spotlight Ruleset"] = 950,
    StackBlitz = 956,
    ["StackHawk Scanner Configuration"] = 1157,
    Stale = 957,
    Starfish = 958,
    ["Starlake Data Pipeline"] = 1129,
    Starship = 959,
    ["Statamic Blueprint"] = 960,
    ["Stella configuration file"] = 961,
    ["Streamlit configuration file"] = 962,
    ["Stryker Mutator"] = 965,
    ["StyleCop Analyzers Configuration"] = 966,
    ["Stylelint (.stylelintrc)"] = 967,
    ["Stylua Config"] = 1344,
    ["Sublime Syntax"] = 1204,
    ["Subsquid squid manifest"] = 1251,
    ["Swagger API 2.0"] = 969,
    ["Symfony Routing Configuration"] = 970,
    ["Symfony Serializer Mapping"] = 971,
    ["Symfony Services Configuration"] = 972,
    ["Symfony Validation Mapping"] = 973,
    ["Synadia Connect Component"] = 974,
    TSON = 1012,
    TSTyche = 1013,
    ["TYPO3 Vendor Bundler config"] = 1019,
    ["Tab data for a LinUtil"] = 1300,
    ["Tab list for a LinUtil"] = 1299,
    Tach = 975,
    ["Tach Domain"] = 976,
    Talhelper = 978,
    ["Talisman configuration"] = 979,
    Taplo = 1345,
    ["Taskfile config"] = 1134,
    Taurus = 980,
    Tauticord = 981,
    ["Tekton Pipeline"] = 1373,
    ["Tekton PipelineRun"] = 1374,
    ["Tekton Task"] = 1371,
    ["Tekton TaskRun"] = 1372,
    Telefonistka = 1331,
    ["Terrateam config"] = 1357,
    ["TestEnvironment.json"] = 993,
    ["TextMate Grammar"] = 992,
    Threagile = 987,
    ["Tier.run pricing.json"] = 984,
    Tikibase = 985,
    Tombi = 990,
    ["Traefik v2"] = 996,
    ["Traefik v2 File Provider"] = 997,
    ["Traefik v3"] = 998,
    ["Traefik v3 File Provider"] = 999,
    ["Travis CI (.travis.yml)"] = 995,
    Treefmt = 515,
    Trident = 1327,
    Trivy = 1002,
    ["TrueScript for *.tscript files"] = 1003,
    ["Tugboat QA config.yml"] = 1324,
    TunnelHub = 1239,
    Turborepo = 994,
    Tycho = 1288,
    Tye = 1165,
    ["Tyk Gateway - Open Source v5.7+"] = 1336,
    ["UET BuildConfig.json"] = 1209,
    ["UI5 Manifest"] = 1025,
    ["UNCORS configuration"] = 1030,
    ["UTAM Page Object"] = 1028,
    ["Ubuntu Server Autoinstall"] = 1023,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1328,
    ["Uniswap Token List"] = 1114,
    ["Universal Schedule Format"] = 1031,
    ["Unreal Engine Uplugin"] = 1210,
    ["Unreal Engine Uproject"] = 1211,
    ["UpCloud CLI (upctl) configuration"] = 1329,
    ["Updatecli Compose"] = 1173,
    ["Updatecli Policy Manifest"] = 1174,
    ["Updatecli Policy Metadata"] = 1175,
    Uplift = 1207,
    ["Upsun config"] = 12,
    ["User Journey Map"] = 1139,
    V2Ray = 1179,
    ["VSCode Code Snippets"] = 301,
    ["VSIX CLI publishing"] = 1050,
    Vector = 1033,
    ["Vela Pipeline Configuration"] = 1036,
    Vercel = 300,
    ["Version Bumper config"] = 1039,
    Vespertide = 1378,
    ["Vespertide Migration"] = 1379,
    ["Vespertide Model"] = 1380,
    ["Viash Component Config"] = 1333,
    ["Viash Package Config"] = 1334,
    Visivo = 1237,
    Vogi = 1044,
    ["WP-CLI"] = 1060,
    Wake = 1326,
    ["Waku Config"] = 1303,
    ["Web App Manifest"] = 1056,
    ["Web types"] = 1059,
    WebExtensions = 1055,
    ["Webman package recipe"] = 1185,
    ["Windows Package Manager Installer Manifest"] = 1111,
    ["Windows Package Manager Locale Manifest"] = 1112,
    ["Windows Package Manager Singleton Manifest"] = 1110,
    ["WireMock CLI import configuration"] = 1309,
    ["WireMock CLI local service configuration"] = 1308,
    ["WireMock message stub mapping"] = 1307,
    ["WireMock stub mapping"] = 1306,
    ["Woodpecker pipeline config"] = 1153,
    ["Wrangler CLI"] = 1061,
    ["XenForo add-on manifest"] = 1062,
    ["Xstate Machine"] = 1171,
    ["Yandex Workflow Language"] = 1295,
    ["Yarn Config (.yarnrc.yml)"] = 1127,
    ["Yippee-Ki-JSON configuration YML"] = 1118,
    ["YouTrack App"] = 1292,
    ["Zarf Package Configuration"] = 1359,
    ["Zerops import file"] = 1280,
    ["Zola Configuration"] = 1370,
    abtop = 33,
    act3 = 1411,
    actionlint = 43,
    ["aerleon.yml"] = 27,
    ["amplify.yml"] = 20,
    ["amxx-builder manifest"] = 1426,
    ["angular.json"] = 48,
    apko = 1242,
    ...
    ["behat.yml"] = 167,
    ["bigquery-table"] = 152,
    ["bioimageio resource description"] = 1259,
    ...
    ["cargo-nextest repository configuration"] = 689,
    ["cargo-nextest user configuration"] = 690,
    ["ccmod.json"] = 1304,
    changelogging = 1271,
    ...
    ["chutzpah.json"] = 309,
    cibuildwheel = 205,
    ["clang-format (.clang-format)"] = 1177,
    ["clang-tidy"] = 282,
    clangd = 281,
    clib = 283,
    ...
    ["crowdin.yml"] = 336,
    crucible = 340,
    ["ctfd-setup configuration file"] = 1316,
    ["custom-elements.json"] = 1229,
    ["cypress.json"] = 341,
    ["dacier.yml"] = 1414,
    ["datalogic-scan2deploy-android"] = 351,
    ["datalogic-scan2deploy-ce"] = 352,
    ...
    ["ddev-global"] = 353,
    ["ddev-project"] = 354,
    ["debugsettings.json"] = 355,
    ["dependabot-v2.json"] = 359,
    ["dependabot.json"] = 358,
    ["deployed-cli"] = 1170,
    devconcurrent = 258,
    ...
    djlint = 1121,
    ["docker bake"] = 365,
    ["docker sequencer"] = 366,
    ["docker-compose.yml"] = 1119,
    ["dockerd.json"] = 363,
    ["dotnet Release Index manifest"] = 378,
    ["dotnet-tools.json"] = 379,
    ["dotnetcli.host.json"] = 380,
    ["dprint.json"] = 381,
    ["drone.json"] = 382,
    ["dss-2.0.0.json"] = 384,
    ["dstack configuration"] = 385,
    ["dtool dataset metadata"] = 1311,
    ["dvc.yaml"] = 387,
    ["ecosystem.json"] = 392,
    ["editorconfig-checker"] = 394,
    eksctl = 395,
    ["electron-builder configuration file"] = 421,
    ["epr-manifest.json"] = 420,
    ["estampo.toml"] = 419,
    ["evcc.yaml"] = 422,
    ["ezd task runner"] = 433,
    ["fabric.mod.json"] = 436,
    ["first-timers-bot"] = 444,
    ["flagd flag configuration"] = 138,
    ["fly.io Configuration"] = 139,
    fulibWorkflows = 1152,
    ["function.json"] = 457,
    ["gRPC API Gateway & OpenAPI Config"] = 22,
    ["gematik health care insurance list"] = 1322,
    ["gematik health care patient list"] = 1319,
    ["gematik health care provider institution list"] = 1321,
    ["gematik health care provider list"] = 1320,
    ["gematik tiger test environment configuration"] = 1323,
    ["gh-dash"] = 471,
    ["gha-doctor"] = 472,
    ["git-cliff"] = 468,
    ["git-town.toml"] = 1368,
    ["github-settings-as-code"] = 851,
    ["gitlab-ci"] = 486,
    ["global.json"] = 503,
    ["glslint config"] = 1,
    ["go-feature-flag Flag Configuration"] = 507,
    ["gojo.yaml"] = 508,
    gollama = 506,
    ["hassette.toml"] = 531,
    ["haxelib.json"] = 527,
    ...
    ["ide.host.json"] = 544,
    ["ifstate.yaml"] = 545,
    ["imageoptimizer.json"] = 546,
    ["importmap.json"] = 549,
    ["index.toml (packwiz)"] = 1428,
    instant_python_config = 553,
    instant_python_custom_project = 554,
    intlayer = 555,
    ["ioBroker Configuration"] = 556,
    ["ioBroker JSON UI"] = 557,
    ["ioBroker Package manifest"] = 558,
    ["ixpect.conf.yaml"] = 559,
    ["ize.toml"] = 1206,
    ["jsconfig.json"] = 585,
    ["jscpd Configuration"] = 1190,
    jsdoc = 1102,
    ["k3d.yaml"] = 586,
    ["k9s aliases.yaml"] = 588,
    ["k9s cluster-config.yaml"] = 590,
    ["k9s config.yaml"] = 589,
    ["k9s hotkeys.yaml"] = 591,
    ["k9s plugins.yaml"] = 592,
    ["k9s skin.yaml"] = 593,
    ["k9s views.yaml"] = 594,
    ["kind cluster"] = 608,
    ["kontinuous-config.yaml"] = 606,
    ["kontinuous-values.yaml"] = 605,
    ["kustomization.yaml"] = 609,
    ["label-commenter-config.yml"] = 610,
    ["latexindent configuration"] = 128,
    ["launchsettings.json"] = 611,
    lazydocker = 1228,
    lazygit = 1227,
    ["lego.json"] = 613,
    ["lerna.json"] = 614,
    ["lgtm.yml"] = 615,
    ["liblab.config.json"] = 616,
    ["libman.json"] = 617,
    ["license-report-config.json"] = 618,
    ["linkinator.config.json"] = 620,
    ["lint-staged (.lintstagedrc)"] = 1079,
    ["local.settings.json"] = 627,
    ["localazy.json"] = 628,
    ["lotus.yaml"] = 626,
    ["lsd colors"] = 132,
    ["lsd config"] = 131,
    ...
    lychee = 1078,
    ["macro.json"] = 1194,
    ["markdown-link-check"] = 1148,
    maturin = 1149,
    mboats = 1156,
    memnex = 1412,
    ["micro-settings.json"] = 1221,
    ["mimetypes.json"] = 645,
    ["mirrord config"] = 1082,
    ["misata.yaml"] = 1081,
    mise = 1083,
    ["mkdocs.yml"] = 665,
    ["mockd.yaml"] = 669,
    ["mod.pw.toml (packwiz)"] = 1429,
    ["modelparams.dev Model"] = 672,
    ["models CLI"] = 673,
    ["monospace.yml"] = 674,
    ["moon.yml"] = 1305,
    ["mprocs Configuration file"] = 1275,
    ["mrdocs.yml"] = 667,
    ["mta.yaml"] = 1084,
    ["mtad.yaml"] = 1085,
    ["mycode.json"] = 682,
    nFPM = 694,
    ["napari plugin manifest"] = 683,
    neoload = 1097,
    ["nest-cli"] = 697,
    ["nexus-rpc-gen"] = 1395,
    ["nf-core module environment.yml"] = 691,
    ["nf-core module meta.yml"] = 692,
    ["nf-core subworkflow meta.yml"] = 693,
    ["ninjs (News in JSON)"] = 696,
    ["nitro.json"] = 1096,
    ["nixd configuration"] = 1247,
    ["nlu.json"] = 698,
    ["nodemon.json"] = 701,
    ["noodl config"] = 1155,
    ["notebook.mod.json"] = 702,
    now = 1092,
    ["npm-badges"] = 705,
    ["nswag.json"] = 709,
    ntangle = 711,
    ["nuclei-template.yaml"] = 706,
    ["nuget-project.json"] = 707,
    ["ocelot.json"] = 713,
    ogen = 719,
    ["omnisharp.json"] = 722,
    openHAB = 1381,
    ...
    oxfmt = 1391,
    oxlint = 1392,
    ["pack.toml (packwiz)"] = 1430,
    ["package.json"] = 758,
    ["package.manifest"] = 760,
    ["package.yaml"] = 759,
    ["partial-black.json"] = 168,
    ["partial-fastapi.json"] = 169,
    ["partial-pixi.json"] = 770,
    ["partial-scheduled.json"] = 170,
    ["pattern.json"] = 768,
    ["petstore-v1.0"] = 1201,
    pgap_yaml_input_reader = 766,
    pgrls = 767,
    pgxgen = 1385,
    pitcms = 1388,
    ["pixi.toml"] = 769,
    ["plagiarize-me.yaml"] = 774,
    ["plagiarize.yaml"] = 773,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1312,
    ["podbard.yaml"] = 776,
    ["portman.json"] = 779,
    ["prefect.toml"] = 788,
    ["prefect.yaml"] = 789,
    ...
    ["prettierrc.json"] = 791,
    ["prisma.yml"] = 792,
    ["project-1.0.0-beta3.json"] = 804,
    ["project-1.0.0-beta4.json"] = 805,
    ["project-1.0.0-beta5.json"] = 806,
    ["project-1.0.0-beta6.json"] = 807,
    ["project-1.0.0-beta8.json"] = 808,
    ["project-1.0.0-rc1.json"] = 809,
    ["project-1.0.0-rc2.json"] = 810,
    ["project.json"] = 803,
    ["project.owasp.yaml"] = 811,
    ["prometheus-alertmanager.json"] = 815,
    ["prometheus.json"] = 812,
    ["prometheus.rules.json"] = 813,
    ["prometheus.rules.test.json"] = 814,
    ["proxies.json"] = 816,
    ["publiccode.yml"] = 817,
    ["pubspec.yaml"] = 818,
    ["pyrseas-0.8.json"] = 821,
    pytest = 830,
    ["quilt.mod.json"] = 1222,
    ["rc3 auth"] = 836,
    ["rc3 collection"] = 837,
    ...
    ["rc3 settings"] = 841,
    ["registry.yaml"] = 61,
    ["release drafter"] = 1098,
    ["release-hub.json"] = 8,
    ["release-please-config.json"] = 846,
    ["release-please-manifest.json"] = 847,
    ["release-plz.toml"] = 848,
    ["renv.lock"] = 863,
    ["reposets Configuration"] = 852,
    ["reposets Credentials"] = 853,
    ["revola.json"] = 6,
    ["rivet.json"] = 1246,
    ["rivet.yaml (legacy)"] = 1245,
    rumdl = 868,
    runny = 867,
    runspec = 1413,
    rustfmt = 869,
    ...
    samt = 872,
    samtrc = 873,
    ["sarif-1.0.0.json"] = 875,
    ["sarif-2.0.0.json"] = 876,
    ["sarif-2.1.0"] = 886,
    ["sarif-2.1.0-rtm.2"] = 877,
    ["sarif-2.1.0-rtm.3"] = 879,
    ["sarif-2.1.0-rtm.4"] = 881,
    ["sarif-2.1.0-rtm.5"] = 883,
    ["sarif-2.1.0-rtm.6"] = 884,
    ["sarif-external-property-file-2.1.0"] = 887,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 878,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 880,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 882,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 885,
    ["scalingo.json configuration"] = 888,
    ["schema.org - Action"] = 890,
    ["schema.org - ContactPoint"] = 891,
    ["schema.org - Place"] = 892,
    ["schema.org - Thing"] = 893,
    ["secrethub.yml"] = 1224,
    ["semantic-release"] = 901,
    servercn = 1437,
    ["servicehub.config.json"] = 1073,
    ["servicehub.service.json"] = 1072,
    ["settings.job"] = 904,
    ["sfdx-hardis configuration"] = 906,
    ["shard.yml"] = 1262,
    ["size-limit configuration"] = 911,
    ["skaffold.yaml"] = 1146,
    ["skill-map plugin extension manifest"] = 912,
    ["skill-map project settings"] = 913,
    ["skill-map provider kind"] = 914,
    ["skyuxconfig.json"] = 916,
    ["snowflake-config"] = 918,
    ["snowflake-connections"] = 919,
    ["spicepod.yaml"] = 1283,
    ["sqlc configuration"] = 953,
    ["stripe-app-local.json"] = 964,
    ["stripe-app.json"] = 963,
    swcrc = 1130,
    ["task.json"] = 977,
    taskcat = 1093,
    ["template.json"] = 982,
    ["templatsources.json"] = 983,
    ["text2confl config"] = 1393,
    ["theme.json"] = 986,
    ["tizen_workspace.json"] = 988,
    tldr = 989,
    ["tm_devices configuration file"] = 1350,
    tmuxinator = 1076,
    tox = 991,
    ["transcend.yml"] = 1000,
    ["tree-sitter grammar.json"] = 514,
    ["trime.yaml"] = 1001,
    ["trunk.yaml"] = 1004,
    ["ts-force-config.json"] = 1010,
    tsbuild = 1005,
    ["tsconfig.json"] = 1006,
    ["tsd.json"] = 1007,
    ["tsdoc.json"] = 1008,
    ...
    ["vega-lite.json"] = 1035,
    ["vega.json"] = 1034,
    ["venvironment.yaml"] = 1037,
    ["venvplus.yaml"] = 1038,
    version = 1332,
    ["version.json"] = 1040,
    ["vhwdebugger-binding.yaml"] = 1042,
    ["vim-addon-info"] = 1043,
    ["vs-2017.3.host.json"] = 1046,
    ["vs-nesting.json"] = 1047,
    ["vsls.json"] = 1045,
    ["vss-extension.json"] = 1051,
    vtcfg = 1338,
    ["vtesttree.yaml"] = 1052,
    ["vtestunit.yaml"] = 1053,
    ["warp-keysets.json"] = 1230,
    ["warp-themes.json"] = 1231,
    ["warp-workflows.json"] = 1232,
    ["webhint.io"] = 1186,
    ["webjobpublishsettings.json"] = 1058,
    ["webjobs-list.json"] = 1057,
    ["well-known-fursona"] = 1270,
    ["xs-app.json"] = 1088,
    ["xunit.runner.json"] = 1071,
    ["yaml-workflow"] = 1436,
    yamlfmt = 1115,
    yamllint = 1116,
    ["yap.json"] = 1117,
