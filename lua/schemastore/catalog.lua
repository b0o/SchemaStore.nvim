...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 15,
    AIConfig = 16,
    ["AMX Muse Program Descriptor"] = 998,
    ["API Builder"] = 816,
    ["AVA Configuration"] = 877,
    ...
    ["Adobe UXP Manifest"] = 937,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    Air = 12,
    ["Airlock Microgateway"] = 17,
    ["Alacritty Configuration"] = 849,
    ["All Contributors configuration file"] = 902,
    ...
    ["Application list for a WinUtil"] = 980,
    ArchitectFX = 985,
    ["Argo Events"] = 30,
    ["Argo Workflows"] = 31,
    AssemblyScript = 34,
    ...
    ["BX CI"] = 109,
    ["Bashly (bashly.yml)"] = 906,
    ["Bashly Settings (bashly-settings.yml)"] = 907,
    ["Better Code Hub"] = 820,
    ["Better Scripts"] = 110,
    Bigconfig = 84,
    ["Biome Formatter Config"] = 54,
    ["Bitmovin Encoding Template"] = 991,
    ...
    ["Butane Config"] = 862,
    C4InterFlow = 1006,
    ["CGS Card Game Specification (cgs.json)"] = 942,
    ["CICS TS region tagging"] = 871,
    ["CICS TS resource import"] = 872,
    ["CICS TS resource model"] = 873,
    ["CICS TS resource overrides"] = 874,
    ["CMake Presets"] = 112,
    ["CNC Codes"] = 128,
    ["CRS WAF test file"] = 970,
    ["CRS WAF test platform overrides file"] = 971,
    ...
    ["Chamaleon environment"] = 995,
    ["Chamaleon properties"] = 996,
    ["Chamaleon template"] = 994,
    Changesets = 210,
    Charmcraft = 121,
    Cheatsheets = 859,
    ...
    CityJSON = 124,
    ["Clawject config"] = 133,
    ["Cloud Foundry Application Manifest"] = 953,
    ["Cloud Run Spec v1"] = 975,
    ...
    Concord = 969,
    ["Configu .cfgu files"] = 958,
    ["Configu .configu file"] = 959,
    Conjure = 127,
    ...
    ["Custom Machinery Machine"] = 943,
    ["Custom Machinery Recipe"] = 944,
    ...
    ["DonateCaseBetterCasino menu"] = 999,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 914,
    ["EAS config"] = 285,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 903,
    ["EasyVCR .NET"] = 286,
    ["Eidolon Resource"] = 986,
    ...
    ["GeoJSON.json latest"] = 866,
    GherKing = 870,
    ["GitHub Action"] = 316,
    ["GitHub Actions typing"] = 982,
    ...
    Hadolint = 798,
    Hammerkit = 827,
    ["Hardware Sentry Configuration"] = 882,
    Hatch = 799,
    Hayson = 359,
    ...
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 924,
    ["JSON Schema Draft 7"] = 766,
    ["JSON Schema Draft 7 (unofficial strict)"] = 925,
    ...
    ["Metadata for a Cinnamon spice"] = 978,
    ["Metatype Configuration"] = 450,
    ["MetricsHub Configuration"] = 451,
    ["MetricsHub Connector Configuration"] = 452,
    ["Micro Editor Syntax"] = 915,
    ["Microsoft Band Web Tile"] = 453,
    ["Microsoft RulesEngine workflow rules"] = 966,
    ["Microsoft RulesEngine workflow rules list"] = 967,
    ["Minecraft Custom Main Menu Mod"] = 932,
    ...
    ["MongoDB Atlas Search Index Definition"] = 886,
    ["Monika Configuration"] = 884,
    ["Monoweave Configuration"] = 478,
    ["Motif config"] = 781,
    ["NOX Framework (Service)"] = 495,
    ["Netin Diagnostic System Template"] = 844,
    ["Netlify config"] = 486,
    ...
    ["Pipeline component"] = 835,
    ["Plex Prerolls"] = 549,
    ["PocketMine plugin.yml"] = 546,
    ["Postman collection"] = 553,
    ["Preset list for a WinUtil"] = 981,
    ["Problem object RFC9457"] = 929,
    ...
    Qgoda = 589,
    Qodana = 854,
    ["Qt Creator workspace file"] = 960,
    ["Quali Torque Blueprint Spec 2"] = 879,
    ["QueryFirst config file"] = 897,
    ["RKE Cluster Configuration JSON"] = 832,
    ["RKE Cluster Configuration YAML"] = 831,
    RadioHound = 581,
    Railway = 590,
    ["Rancher Fleet"] = 583,
    ["Rattler-build"] = 591,
    ...
    ["Render Blueprints"] = 830,
    RenderCV = 610,
    Renovate = 609,
    ["Replit config"] = 604,
    Restate = 1009,
    RoadRunner = 612,
    ["Rudder techniques"] = 935,
    Ruff = 606,
    ["Rust Project"] = 607,
    ["Rust toolchain"] = 616,
    ...
    ["SauceCTL Configuration"] = 841,
    ["Schema Catalog"] = 634,
    ["Scoop manifest"] = 639,
    ["Semantic Data Fabric (SDF) file"] = 643,
    ["Semgrep Rule"] = 645,
    ["Serenity Code Generator (Sergen)"] = 646,
    ["Serverless Framework Configuration"] = 848,
    ["Serverless Workflow"] = 850,
    ["Settings for a Cinnamon spice"] = 977,
    ["Settings.paf"] = 648,
    ["Shopware 6 Configuration"] = 851,
    ["Shopware CLI Extension Store Configuration"] = 852,
    ["Shopware CLI Project Store Configuration"] = 853,
    ["Sigma Detection Rule"] = 650,
    ["Sigrid scope configuration file"] = 651,
    ["SkyPilot Task JSON"] = 936,
    ...
    StackBlitz = 673,
    ["StackHawk Scanner Configuration"] = 847,
    Stale = 674,
    ...
    ["Sublime Syntax"] = 893,
    ["Subsquid squid manifest"] = 938,
    ["Swagger API 2.0"] = 684,
    ["Synadia Connect Component"] = 685,
    TSON = 717,
    TSTyche = 718,
    ["Tab data for a LinUtil"] = 984,
    ["Tab list for a LinUtil"] = 983,
    Talhelper = 687,
    ...
    ["Tugboat QA config.yml"] = 1005,
    TunnelHub = 928,
    Turborepo = 701,
    Tycho = 973,
    Tye = 855,
    ["UET BuildConfig.json"] = 898,
    ["UI5 Manifest"] = 727,
    ...
    ["Unreal Engine Uplugin"] = 899,
    ["Unreal Engine Uproject"] = 900,
    ["Updatecli Compose"] = 863,
    ["Updatecli Policy Manifest"] = 864,
    ["Updatecli Policy Metadata"] = 865,
    Uplift = 896,
    ["User Journey Map"] = 829,
    V2Ray = 869,
    ...
    Winutil = 807,
    ["WireMock stub mapping"] = 990,
    ["Woodpecker pipeline config"] = 843,
    ["Wrangler CLI"] = 760,
    ["Xstate Machine"] = 861,
    ["Yandex Workflow Language"] = 979,
    ...
    ["behat.yml"] = 93,
    ["bigquery-table"] = 83,
    ["bioimageio resource description"] = 946,
    ...
    ["crowdin.yml"] = 218,
    ["ctfd-setup configuration file"] = 997,
    ["custom-elements.json"] = 918,
    ["cypress.json"] = 222,
    ...
    ["gematik health care insurance list"] = 1003,
    ["gematik health care patient list"] = 1000,
    ["gematik health care provider institution list"] = 1002,
    ["gematik health care provider list"] = 1001,
    ["gematik tiger test environment configuration"] = 1004,
    ["gitlab-ci"] = 324,
    ["global.json"] = 340,
    ...
    ["lotus.yaml"] = 439,
    ["lsdlschema.json"] = 442,
    ["markdown-link-check"] = 838,
    maturin = 839,
    mboats = 846,
    ["micro-settings.json"] = 910,
    ["mimetypes.json"] = 454,
    ["mirrord config"] = 777,
    mise = 778,
    ["mkdocs.yml"] = 474,
    ...
    ["plagiarize.yaml"] = 547,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 993,
    ["podbard.yaml"] = 550,
    ["portman.json"] = 551,
    ["prefect.toml"] = 559,
    ["prettierrc.json"] = 560,
    ...
    ["vtesttree.yaml"] = 752,
    ["vtestunit.yaml"] = 753,
    ["warp-keysets.json"] = 919,
    ["warp-themes.json"] = 920,
    ["warp-workflows.json"] = 921,
    ["webhint.io"] = 876,
    ["webjobpublishsettings.json"] = 758,
    ["webjobs-list.json"] = 757,
    ["well-known-fursona"] = 956,
    ["xs-app.json"] = 783,
    ["xunit.runner.json"] = 769,
    yamllint = 810,
    ["zerops.io import file"] = 965,
    ["zerops.yml"] = 964,
    zuul = 793,
    ["Žinoma"] = 803
  },
