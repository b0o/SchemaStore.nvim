...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 135,
    [".cryproj (generic)"] = 465,
    [".cryproj engine-5.2"] = 460,
    [".cryproj engine-5.3"] = 461,
    [".cryproj engine-5.4"] = 462,
    [".cryproj engine-5.5"] = 463,
    [".cryproj engine-dev"] = 464,
    [".csscomb.json"] = 137,
    [".csslintrc"] = 138,
    [".eslintrc"] = 179,
    [".esmrc.json"] = 171,
    ...
    [".vsext"] = 441,
    [".yarnrc.yml"] = 505,
    ["<div>RIOTS' studio configuration"] = 444,
    ["API Builder"] = 502,
    ["AVA Configuration Schema"] = 556,
    ...
    ["Better Code Hub"] = 507,
    ["Better Scripts"] = 71,
    BizTalkServerApplicationSchema = 479,
    ...
    ["Butane config schema"] = 543,
    ["CICS TS region tagging"] = 550,
    ["CICS TS resource import"] = 551,
    ["CICS TS resource model"] = 552,
    ["CICS TS resource overrides"] = 553,
    ["CMake Presets"] = 72,
    ...
    ["Embrace Config Schema"] = 568,
    ["Error pages"] = 174,
    Esquio = 172,
    ["Estuary Flow Catalog Schema"] = 547,
    ["Expo SDK"] = 177,
    ...
    Goreleaser = 205,
    ["Goreleaser Pro"] = 206,
    ["Gradle Build Cache Node"] = 504,
    ["Gradle Enterprise"] = 503,
    ...
    HEMTT = 476,
    Hadolint = 488,
    ["Hardware Sentry Configuration"] = 561,
    Hayson = 218,
    ...
    ["Istanbul Schema"] = 564,
    ["JFrog File Spec"] = 235,
    ["JFrog Pipelines YML DSL"] = 570,
    ["JSON Document Transform"] = 243,
    ["JSON Feed"] = 244,
    ["JSON Resume"] = 353,
    ["JSON Schema Draft 2020-12"] = 456,
    ["JSON Schema Draft 4"] = 453,
    ["JSON Schema Draft 7"] = 454,
    ["JSON Schema Draft 8"] = 455,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 565,
    ["Monika Configuration Schema"] = 563,
    ["Motif config"] = 472,
    ["Netin Diagnostic System Template"] = 527,
    ...
    Opctl = 475,
    ["OpenWeather Current Weather API"] = 511,
    ["OpenWeather Road Risk API"] = 510,
    ...
    Packer = 315,
    ["Pipeline component"] = 520,
    ["PocketMine plugin.yml"] = 319,
    Pterodactyl = 560,
    ["Pull Request Labeler"] = 342,
    PyProject = 346,
    Qodana = 536,
    ["Quali Torque Blueprint Spec 2"] = 558,
    ["RKE Cluster Configuration JSON Schema"] = 517,
    ["RKE Cluster Configuration YAML Schema"] = 516,
    Ray = 487,
    ["Read the Docs"] = 345,
    ...
    ["SauceCTL Configuration"] = 524,
    ["Schema Catalog"] = 371,
    ["Scoop manifest"] = 376,
    ["Semgrep Rule"] = 378,
    ["Serverless Framework Configuration"] = 531,
    ["Serverless Workflow Schema"] = 532,
    ["Settings.paf"] = 380,
    ["Shopware 6 Configuration"] = 533,
    ["Shopware CLI Extension Store Configuration"] = 534,
    ["Shopware CLI Project Store Configuration"] = 535,
    Solidarity = 385,
    ["Solution filters"] = 386,
    ["Source Maps v3"] = 387,
    SpecIF = 388,
    ["Sponge Mixin configuration"] = 389,
    ["StackHawk Scanner Configuration"] = 530,
    ...
    ["Uniswap Token List"] = 496,
    Updatecli = 544,
    ["User Journey Map YAML Schema"] = 515,
    V2Ray = 548,
    ["VSCode Code Snippets"] = 111,
    ["VSIX CLI publishing"] = 442,
    ["Vela Pipeline Configuration"] = 434,
    Vercel = 110,
    ["Web App Manifest"] = 446,
    ["Web types"] = 449,
    WebExtensions = 445,
    ["Webman package recipe"] = 554,
    ["Windows Package Manager Installer Manifest"] = 493,
    ["Windows Package Manager Locale Manifest"] = 494,
    ["Windows Package Manager Singleton Manifest"] = 492,
    ["Woodpecker pipeline config"] = 526,
    ["Xstate Machine Schema"] = 542,
    ["Yippee-Ki-JSON configuration YML"] = 498,
    ["angular.json"] = 8,
    ...
    ["jsconfig.json"] = 247,
    ["jscpd Configuration Schema"] = 559,
    jsdoc = 486,
    ["k3d.yaml"] = 248,
    ...
    ["servicehub.config.json"] = 459,
    ["servicehub.service.json"] = 458,
    ["settings.job"] = 379,
    ...
    ["version.json"] = 435,
    ["vim-addon-info"] = 436,
    ["vs-2017.3.host.json"] = 438,
    ["vs-nesting.json"] = 439,
    ["vsls.json"] = 437,
    ["vss-extension.json"] = 443,
    ["webhint.io"] = 555,
    ["webjobpublishsettings.json"] = 448,
    ["webjobs-list.json"] = 447,
    ["xs-app.json"] = 474,
    ["xunit.runner.json"] = 457,
    yamllint = 497,
    zuul = 483,
    ["Žinoma"] = 491
  },
