...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 158,
    [".cryproj (generic)"] = 537,
    [".cryproj engine-5.2"] = 532,
    [".cryproj engine-5.3"] = 533,
    [".cryproj engine-5.4"] = 534,
    [".cryproj engine-5.5"] = 535,
    [".cryproj engine-dev"] = 536,
    [".csscomb.json"] = 160,
    [".csslintrc"] = 161,
    [".es6importsorterrc.json"] = 660,
    [".eslintrc"] = 206,
    [".esmrc.json"] = 198,
    [".ffizer.yaml"] = 210,
    [".htmlhintrc"] = 251,
    ...
    [".mtaext"] = 546,
    [".nodehawkrc"] = 341,
    [".npmpackagejsonlintrc"] = 344,
    [".phraseapp.yml"] = 380,
    [".pmbot.yml"] = 371,
    [".postcssrc"] = 376,
    [".powerpages-web-template-manifest"] = 377,
    [".pre-commit-config.yml"] = 378,
    [".pre-commit-hooks.yml"] = 379,
    [".putout.json"] = 397,
    [".rehyperc"] = 406,
    [".remarkrc"] = 407,
    [".sprite files"] = 454,
    ...
    [".vsext"] = 511,
    [".yarnrc.yml"] = 578,
    ["<div>RIOTS' studio configuration"] = 516,
    ["@factorial/drupal-breakpoints-css"] = 5,
    ["A micro editor config schema"] = 306,
    ["API Builder"] = 575,
    ["AVA Configuration Schema"] = 632,
    ["AWS CDK cdk.json"] = 143,
    ["AWS CloudFormation"] = 144,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 145,
    ["Airlock Microgateway"] = 9,
    ["Airplane task"] = 10,
    ["Alacritty Configuration Schema"] = 607,
    ["All Contributors configuration file"] = 659,
    ...
    ["Azure Pipelines"] = 48,
    ["Azure Static Web Apps CLI configuration file"] = 456,
    ["Azure Static Web Apps configuration file"] = 455,
    ["BX CI"] = 83,
    ["Better Code Hub"] = 580,
    ["Better Scripts"] = 84,
    BizTalkServerApplicationSchema = 552,
    ...
    ["Butane Config"] = 619,
    ["CICS TS region tagging"] = 626,
    ["CICS TS resource import"] = 627,
    ["CICS TS resource model"] = 628,
    ["CICS TS resource overrides"] = 629,
    ["CMake Presets"] = 85,
    ...
    ["Datadog Service Definition"] = 287,
    ["Datahub Ingestion Recipe Schema"] = 633,
    ...
    ["Embrace Config Schema"] = 644,
    ["Error pages"] = 201,
    Esquio = 199,
    ["Estuary Flow Catalog Schema"] = 623,
    ["Expo SDK"] = 204,
    ["F-Droid Data metadata"] = 209,
    ["Facets - FSDL - Application"] = 207,
    ["FasterCI Configuration"] = 49,
    ["Fossa configuration file"] = 214,
    ["Fossa's fossa-deps file"] = 215,
    ["Foundry VTT - Manifest"] = 212,
    ["Foundry VTT - Template"] = 213,
    ["Foxx Manifest"] = 50,
    ["Freifunk.de Community API"] = 53,
    ["Frogbot Config"] = 54,
    ["GatewayCore API Gateway"] = 218,
    ["GeoJSON.json latest"] = 621,
    GherKing = 625,
    ["GitHub Action"] = 222,
    ["GitHub Discussion"] = 223,
    ["GitHub Funding"] = 224,
    ["GitHub Issue Template configuration"] = 226,
    ["GitHub Workflow"] = 227,
    ["GitHub Workflow Template Properties"] = 228,
    ["GitHub issue forms"] = 225,
    GitVersion = 221,
    ["Gitpod Configuration"] = 230,
    ["Global Privacy Control"] = 219,
    ["Google Cloud Workflows"] = 142,
    Goreleaser = 233,
    ["Goreleaser Pro"] = 234,
    ["Gradle Build Cache Node"] = 577,
    ["Gradle Enterprise"] = 576,
    ["Grafana 5.x Dashboard"] = 235,
    ["GraphQL Code Generator"] = 238,
    ["GraphQL Config"] = 237,
    ["GraphQL Mesh"] = 236,
    ["Grunt JSHint task"] = 242,
    ["Grunt Watch task"] = 243,
    ["Grunt base task"] = 244,
    ["Grunt clean task"] = 240,
    ["Grunt copy task"] = 239,
    ["Grunt cssmin task"] = 241,
    HEMTT = 549,
    Hadolint = 561,
    Hammerkit = 587,
    ["Hardware Sentry Configuration"] = 637,
    Hayson = 246,
    ["Haystack Pipeline"] = 247,
    ["Hazelcast 5 Configuration"] = 248,
    ["Helm Chart.lock"] = 115,
    ["Helm Chart.yaml"] = 114,
    ["Helm Unittest Test Suite"] = 116,
    Hugo = 615,
    ["IBM Zapp document"] = 253,
    ["IBM zCodeFormatSettings"] = 254,
    ["IMG Catapult PSP"] = 259,
    ["Istanbul Schema"] = 640,
    ["JDownloader2 crawler multi-rule schema"] = 269,
    ["JDownloader2 crawler single-rule schema"] = 268,
    ["JFrog File Spec"] = 270,
    ["JFrog Pipelines YML DSL"] = 646,
    ["JMeter DSL cli config schema"] = 271,
    ["JSON Document Transform"] = 279,
    ["JSON Feed"] = 280,
    ["JSON Resume"] = 413,
    ["JSON Schema Draft 2020-12"] = 528,
    ["JSON Schema Draft 4"] = 525,
    ["JSON Schema Draft 7"] = 526,
    ["JSON Schema Draft 8"] = 527,
    ...
    ["JSON-API"] = 278,
    ["JSON-e templates"] = 585,
    ["JSON-stat 2.0"] = 522,
    JSONPatch = 282,
    Jasmine = 264,
    Jekyll = 265,
    ["Jenkins X Pipelines"] = 266,
    ["Jenkins X Requirements"] = 267,
    ["Jovo Language Models"] = 272,
    ["KSP-AVC"] = 523,
    ["KSP-CKAN"] = 524,
    Kas = 285,
    ["Keycloak REST API"] = 652,
    ["Knative Functions - func.yaml"] = 216,
    ["KoDE/CI build.yaml"] = 642,
    ["Kong DBLess Schema"] = 643,
    KrakenD = 286,
    LOOBin = 301,
    ["LinkML Metamodel"] = 299,
    Liquibase = 592,
    ["Liquibase Flow File"] = 593,
    ["Lively Properties"] = 300,
    Markdownlint = 596,
    ["Mason Registry"] = 598,
    ["MegaLinter configuration"] = 307,
    ["MegaLinter descriptor"] = 308,
    ["Meltano plugin discovery definition"] = 310,
    ["Meltano project definition"] = 309,
    ["Microsoft Band Web Tile"] = 311,
    ["Minecraft Data Pack Advancement"] = 313,
    ["Minecraft Data Pack Biome"] = 314,
    ["Minecraft Data Pack Configured Carver"] = 315,
    ["Minecraft Data Pack Damage Type"] = 316,
    ["Minecraft Data Pack Dimension"] = 318,
    ["Minecraft Data Pack Dimension Type"] = 317,
    ["Minecraft Data Pack Item Modifier"] = 319,
    ["Minecraft Data Pack Loot Table"] = 320,
    ["Minecraft Data Pack Metadata"] = 321,
    ["Minecraft Data Pack Predicate"] = 322,
    ["Minecraft Data Pack Recipe"] = 323,
    ["Minecraft Data Pack Tag"] = 324,
    ["Minecraft Data Pack Template Pool"] = 325,
    ["Minecraft Resource Pack Lang"] = 326,
    ["Minecraft Resource Pack Particle"] = 327,
    ["Minecraft Resource Pack Texture Mcmeta"] = 329,
    ["Minecraft Resourcepack Sounds"] = 328,
    ["MkDocs Configuration 1.0"] = 330,
    ["MongoDB Atlas Search Index Definition Schema"] = 641,
    ["Monika Configuration Schema"] = 639,
    ["Motif config"] = 545,
    ["NOX Framework (Service)"] = 343,
    ["Netin Diagnostic System Template"] = 602,
    ["Netlify config schema"] = 335,
    ["Nightwatch.js"] = 336,
    ["OSS Review Toolkit configuration"] = 361,
    ["OSS Review Toolkit curation"] = 362,
    ["OSS Review Toolkit package configuration"] = 363,
    ["OSS Review Toolkit repository configuration"] = 364,
    ["OSS Review Toolkit resolutions"] = 365,
    Opctl = 548,
    ["OpenRewrite Resource"] = 356,
    ["OpenWeather Current Weather API"] = 584,
    ["OpenWeather Road Risk API"] = 583,
    ["Ory Hydra configuration"] = 252,
    ["Ory Keto configuration"] = 288,
    ["Ory Kratos configuration"] = 360,
    ["Ory Oathkeeper configuration"] = 350,
    ["Outblocks App configuration"] = 358,
    ["Outblocks database table"] = 359,
    ["Outblocks project configuration"] = 357,
    Packer = 368,
    Pantsbuild = 658,
    ["Pipeline component"] = 594,
    ["PocketMine plugin.yml"] = 372,
    Pterodactyl = 636,
    ["Pull Request Labeler"] = 396,
    Pulumi = 401,
    PyProject = 402,
    Qodana = 612,
    ["Quali Torque Blueprint Spec 2"] = 634,
    ["QueryFirst config file"] = 655,
    ["RKE Cluster Configuration JSON Schema"] = 591,
    ["RKE Cluster Configuration YAML Schema"] = 590,
    ["Rancher Fleet"] = 399,
    Ray = 560,
    ["Read the Docs"] = 400,
    ["Red-DiscordBot Cog"] = 403,
    ["Red-DiscordBot Cog Repo"] = 404,
    ["Red-DiscordBot Trivia"] = 405,
    Renovate = 414,
    ["Replit schema"] = 408,
    RoadRunner = 415,
    Ruff = 411,
    ["Rust Project"] = 412,
    ["Rust toolchain"] = 417,
    ["SIL Kit Participant Configuration"] = 443,
    SWADL = 465,
    ["Sapphire CLI Config"] = 418,
    ["SauceCTL Configuration"] = 599,
    ["Schema Catalog"] = 431,
    ["Scoop manifest"] = 436,
    ["Semgrep Rule"] = 438,
    ["Serenity Code Generator (Sergen)"] = 439,
    ["Serverless Framework Configuration"] = 606,
    ["Serverless Workflow Schema"] = 608,
    ["Settings.paf"] = 441,
    ["Shopware 6 Configuration"] = 609,
    ["Shopware CLI Extension Store Configuration"] = 610,
    ["Shopware CLI Project Store Configuration"] = 611,
    ["Slack app manifest"] = 445,
    Solidarity = 448,
    ["Solution filters"] = 449,
    ["Source Maps v3"] = 450,
    Sourcery = 451,
    SpecIF = 452,
    ["Sponge Mixin configuration"] = 453,
    ["StackHawk Scanner Configuration"] = 605,
    Stale = 457,
    Starship = 458,
    ["Statamic Blueprint"] = 459,
    ["StrmPrivacy Data Connector"] = 650,
    ["StrmPrivacy Data Contract"] = 651,
    ["StrmPrivacy SimpleSchema"] = 648,
    ["StrmPrivacy Stream"] = 649,
    ["StrmPrivacy batch job configuration file"] = 647,
    ["Stryker Mutator"] = 462,
    ["StyleCop Analyzers Configuration"] = 463,
    ["Swagger API 2.0"] = 466,
    TSON = 489,
    ["Talisman configuration"] = 468,
    ["Taskfile YAML Schema"] = 586,
    Taurus = 469,
    ["TestEnvironment.json"] = 477,
    ["Tier.run pricing.json"] = 472,
    Tikibase = 473,
    ["Traefik v2"] = 480,
    ["Traefik v2 File Provider"] = 481,
    Turborepo = 478,
    Tye = 613,
    ["UI5 Manifest"] = 496,
    ["UTAM Page Object"] = 499,
    ["Ubuntu Server Autoinstall"] = 494,
    ["Uniswap Token List"] = 569,
    ["Unreal Engine Uplugin"] = 656,
    ["Unreal Engine Uproject"] = 657,
    Updatecli = 620,
    Uplift = 654,
    ["User Journey Map YAML Schema"] = 589,
    V2Ray = 624,
    ["VSCode Code Snippets"] = 131,
    ["VSIX CLI publishing"] = 512,
    ["Vela Pipeline Configuration"] = 502,
    Vercel = 130,
    ["Web App Manifest"] = 518,
    ["Web types"] = 521,
    WebExtensions = 517,
    ["Webman package recipe"] = 630,
    ["Windows Package Manager Installer Manifest"] = 566,
    ["Windows Package Manager Locale Manifest"] = 567,
    ["Windows Package Manager Singleton Manifest"] = 565,
    ["Woodpecker pipeline config"] = 601,
    ["Xstate Machine Schema"] = 618,
    ["Yippee-Ki-JSON configuration YML"] = 571,
    ["angular.json"] = 11,
    ...
    ["bamboo-spec"] = 59,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 662,
    ["bashly-strings.yml"] = 663,
    ["bashly.yml"] = 661,
    ["batect.yml"] = 58,
    ["beau.yml"] = 579,
    ...
    ["gitlab-ci"] = 229,
    ["global.json"] = 231,
    ["golangci-lint Configuration"] = 232,
    ["haxelib.json"] = 245,
    helmfile = 562,
    ["host-meta.json"] = 250,
    ["host.json"] = 249,
    ...
    ["ide.host.json"] = 255,
    ["ifstate.conf"] = 256,
    ["imageoptimizer.json"] = 257,
    ["importmap.json"] = 260,
    ["ioBroker Configuration"] = 261,
    ["ioBroker JSON UI"] = 262,
    ["ioBroker Package manifest"] = 263,
    ["ize.toml"] = 653,
    ["jsconfig.json"] = 283,
    ["jscpd Configuration Schema"] = 635,
    jsdoc = 559,
    ["k3d.yaml"] = 284,
    ["kontinuous-values.yaml"] = 289,
    ["kustomization.yaml"] = 290,
    ["label-commenter-config.yml"] = 291,
    ["launchsettings.json"] = 292,
    ["lego.json"] = 293,
    ["lerna.json"] = 294,
    ["lgtm.yml"] = 295,
    ["libman.json"] = 296,
    ["license-report-config.json"] = 297,
    ["linkinator.config.json"] = 298,
    ["local.settings.json"] = 303,
    ["localazy.json"] = 304,
    ["lotus.yaml"] = 302,
    ["lsdlschema.json"] = 305,
    ["markdown-lint-check"] = 597,
    mboats = 604,
    ["mimetypes.json"] = 312,
    ["mirrord-schema"] = 542,
    ["mta.yaml"] = 543,
    ["mtad.yaml"] = 544,
    ["mycode.json"] = 333,
    ["napari plugin manifest"] = 334,
    neoload = 554,
    ["nest-cli"] = 339,
    ["ninjs (News in JSON) 1.3"] = 338,
    ["ninjs (News in JSON) 2.0"] = 337,
    ["nlu.json"] = 340,
    ["nodemon.json"] = 342,
    ["noodl.schema.json"] = 603,
    now = 550,
    ["npm-badges"] = 345,
    ["nswag.json"] = 348,
    ntangle = 349,
    ["nuclei-template.yaml"] = 346,
    ["nuget-project.json"] = 347,
    ["ocelot.json"] = 351,
    ["omnisharp.json"] = 352,
    ["openapi.json"] = 353,
    ["openfin.json"] = 355,
    ["openrpc.json"] = 354,
    ["package.json"] = 366,
    ["package.manifest"] = 367,
    ["pattern.json"] = 370,
    ["petstore-v1.0"] = 645,
    pgap_yaml_input_reader = 369,
    ["plagiarize-me.yaml"] = 374,
    ["plagiarize.yaml"] = 373,
    ["portman.json"] = 375,
    ["prettierrc.json"] = 381,
    ["prisma.yml"] = 382,
    ["project-1.0.0-beta3.json"] = 384,
    ["project-1.0.0-beta4.json"] = 385,
    ["project-1.0.0-beta5.json"] = 386,
    ["project-1.0.0-beta6.json"] = 387,
    ["project-1.0.0-beta8.json"] = 388,
    ["project-1.0.0-rc1.json"] = 389,
    ["project-1.0.0-rc2.json"] = 390,
    ["project.json"] = 383,
    ["prometheus.json"] = 391,
    ["prometheus.rules.json"] = 392,
    ["proxies.json"] = 393,
    ["publiccode.yml"] = 394,
    ["pubspec.yaml"] = 395,
    ["pyrseas-0.8.json"] = 398,
    ["release drafter"] = 555,
    rtx = 410,
    rustfmt = 416,
    ["sarif-1.0.0.json"] = 419,
    ["sarif-2.0.0.json"] = 420,
    ["sarif-2.1.0"] = 429,
    ["sarif-2.1.0-rtm.2"] = 421,
    ["sarif-2.1.0-rtm.3"] = 423,
    ["sarif-2.1.0-rtm.4"] = 425,
    ["sarif-2.1.0-rtm.5"] = 427,
    ["sarif-external-property-file-2.1.0"] = 430,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 422,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 424,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 426,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 428,
    ["schema.org - Action"] = 432,
    ["schema.org - ContactPoint"] = 433,
    ["schema.org - Place"] = 434,
    ["schema.org - Thing"] = 435,
    ["semantic-release"] = 437,
    ["servicehub.config.json"] = 531,
    ["servicehub.service.json"] = 530,
    ["settings.job"] = 440,
    ["sfdx-hardis configuration"] = 442,
    ["size-limit configuration"] = 444,
    ["skaffold.yaml"] = 595,
    ["skyuxconfig.json"] = 446,
    snapcraft = 447,
    ["stripe-app-local.json"] = 461,
    ["stripe-app.json"] = 460,
    swcrc = 582,
    ["task.json"] = 467,
    taskcat = 551,
    ["template.json"] = 470,
    ["templatsources.json"] = 471,
    ["theme.json"] = 474,
    ["tizen_workspace.json"] = 475,
    tmLanguage = 476,
    tmuxinator = 539,
    ["transcend.yml"] = 482,
    ["trunk.yaml schema"] = 483,
    ["ts-force-config.json"] = 487,
    ["tsconfig.json"] = 484,
    ["tsd.json"] = 485,
    ["tsdrc.json"] = 486,
    ["tslint.json"] = 488,
    ...
    ["vega-lite.json"] = 501,
    ["vega.json"] = 500,
    ["venvironment-basic.yaml"] = 504,
    ["venvironment.yaml"] = 503,
    ["version.json"] = 505,
    ["vim-addon-info"] = 506,
    ["vs-2017.3.host.json"] = 508,
    ["vs-nesting.json"] = 509,
    ["vsls.json"] = 507,
    ["vss-extension.json"] = 513,
    ["vtesttree.yaml"] = 514,
    ["webhint.io"] = 631,
    ["webjobpublishsettings.json"] = 520,
    ["webjobs-list.json"] = 519,
    ["xs-app.json"] = 547,
    ["xunit.runner.json"] = 529,
    yamllint = 570,
    zuul = 556,
    ["Žinoma"] = 564
  },
