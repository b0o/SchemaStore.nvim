...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 165,
    [".cryproj (generic)"] = 561,
    [".cryproj engine-5.2"] = 556,
    [".cryproj engine-5.3"] = 557,
    [".cryproj engine-5.4"] = 558,
    [".cryproj engine-5.5"] = 559,
    [".cryproj engine-dev"] = 560,
    [".csscomb.json"] = 167,
    [".csslintrc"] = 168,
    [".es6importsorterrc.json"] = 684,
    [".eslintrc"] = 213,
    [".esmrc.json"] = 205,
    [".ffizer.yaml"] = 217,
    [".htmlhintrc"] = 263,
    ...
    [".mtaext"] = 570,
    [".nodehawkrc"] = 355,
    [".npmpackagejsonlintrc"] = 358,
    [".phraseapp.yml"] = 397,
    [".pmbot.yml"] = 387,
    [".postcssrc"] = 392,
    [".powerpages-web-template-manifest"] = 394,
    [".pre-commit-config.yml"] = 395,
    [".pre-commit-hooks.yml"] = 396,
    [".putout.json"] = 415,
    [".rehyperc"] = 425,
    [".remarkrc"] = 426,
    [".sprite files"] = 476,
    ...
    ["<div>RIOTS' studio configuration"] = 540,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config schema"] = 319,
    ["API Builder"] = 599,
    ["AVA Configuration Schema"] = 656,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration Schema"] = 631,
    ["All Contributors configuration file"] = 683,
    ...
    ["Azure Pipelines"] = 54,
    ["Azure Static Web Apps CLI configuration file"] = 478,
    ["Azure Static Web Apps configuration file"] = 477,
    ["BX CI"] = 89,
    ["Better Code Hub"] = 604,
    ["Better Scripts"] = 90,
    BizTalkServerApplicationSchema = 576,
    ...
    ["Butane Config"] = 643,
    ["CICS TS region tagging"] = 650,
    ["CICS TS resource import"] = 651,
    ["CICS TS resource model"] = 652,
    ["CICS TS resource overrides"] = 653,
    ["CMake Presets"] = 91,
    ...
    ["Datadog Service Definition"] = 300,
    ["Datahub Ingestion Recipe Schema"] = 657,
    ...
    ["Embrace Config Schema"] = 668,
    ["Error pages"] = 208,
    Esquio = 206,
    ["Estuary Flow Catalog Schema"] = 647,
    ["Expo SDK"] = 211,
    ...
    ["Frogbot Config"] = 60,
    ["GCP Blueprint Metadata"] = 230,
    ["GatewayCore API Gateway"] = 229,
    ["GeoJSON.json latest"] = 645,
    GherKing = 649,
    ["GitHub Action"] = 234,
    ["GitHub Discussion"] = 235,
    ["GitHub Funding"] = 236,
    ["GitHub Issue Template configuration"] = 238,
    ["GitHub Workflow"] = 239,
    ["GitHub Workflow Template Properties"] = 240,
    ["GitHub issue forms"] = 237,
    GitVersion = 233,
    ["Gitpod Configuration"] = 242,
    ["Global Privacy Control"] = 231,
    ["Google Cloud Workflows"] = 149,
    Goreleaser = 245,
    ["Goreleaser Pro"] = 246,
    ["Gradle Build Cache Node"] = 601,
    ["Gradle Enterprise"] = 600,
    ["Grafana 5.x Dashboard"] = 247,
    ["GraphQL Code Generator"] = 250,
    ["GraphQL Config"] = 249,
    ["GraphQL Mesh"] = 248,
    ["Grunt JSHint task"] = 254,
    ["Grunt Watch task"] = 255,
    ["Grunt base task"] = 256,
    ["Grunt clean task"] = 252,
    ["Grunt copy task"] = 251,
    ["Grunt cssmin task"] = 253,
    HEMTT = 573,
    Hadolint = 585,
    Hammerkit = 611,
    ["Hardware Sentry Configuration"] = 661,
    Hayson = 258,
    ["Haystack Pipeline"] = 259,
    ["Hazelcast 5 Configuration"] = 260,
    ["Helm Chart.lock"] = 121,
    ["Helm Chart.yaml"] = 120,
    ["Helm Unittest Test Suite"] = 122,
    Hugo = 639,
    ["IBM Zapp document"] = 265,
    ["IBM zCodeFormatSettings"] = 266,
    ["IMG Catapult PSP"] = 271,
    ["Istanbul Schema"] = 664,
    ["JDownloader2 crawler multi-rule schema"] = 281,
    ["JDownloader2 crawler single-rule schema"] = 280,
    ["JFrog File Spec"] = 282,
    ["JFrog Pipelines YML DSL"] = 670,
    ["JMeter DSL cli config schema"] = 283,
    JReleaser = 285,
    ["JSON Document Transform"] = 292,
    ["JSON Feed"] = 293,
    ["JSON Resume"] = 432,
    ["JSON Schema Draft 2020-12"] = 552,
    ["JSON Schema Draft 4"] = 549,
    ["JSON Schema Draft 7"] = 550,
    ["JSON Schema Draft 8"] = 551,
    ...
    ["JSON-API"] = 291,
    ["JSON-e templates"] = 609,
    ["JSON-stat 2.0"] = 546,
    JSONPatch = 295,
    Jasmine = 276,
    Jekyll = 277,
    ["Jenkins X Pipelines"] = 278,
    ["Jenkins X Requirements"] = 279,
    ["Jovo Language Models"] = 284,
    ["KSP-AVC"] = 547,
    ["KSP-CKAN"] = 548,
    Kas = 298,
    ["Keycloak REST API"] = 676,
    ["Knative Functions - func.yaml"] = 227,
    ["KoDE/CI build.yaml"] = 666,
    ["Kong DBLess Schema"] = 667,
    KrakenD = 299,
    LOOBin = 314,
    ["LinkML Metamodel"] = 312,
    Liquibase = 616,
    ["Liquibase Flow File"] = 617,
    ["Lively Properties"] = 313,
    Markdownlint = 620,
    ["Mason Registry"] = 622,
    ["MegaLinter configuration"] = 320,
    ["MegaLinter descriptor"] = 321,
    ["Meltano plugin discovery definition"] = 323,
    ["Meltano project definition"] = 322,
    ["Microsoft Band Web Tile"] = 324,
    ["Minecraft Data Pack Advancement"] = 326,
    ["Minecraft Data Pack Biome"] = 327,
    ["Minecraft Data Pack Configured Carver"] = 328,
    ["Minecraft Data Pack Damage Type"] = 329,
    ["Minecraft Data Pack Dimension"] = 331,
    ["Minecraft Data Pack Dimension Type"] = 330,
    ["Minecraft Data Pack Item Modifier"] = 332,
    ["Minecraft Data Pack Loot Table"] = 333,
    ["Minecraft Data Pack Metadata"] = 334,
    ["Minecraft Data Pack Predicate"] = 335,
    ["Minecraft Data Pack Recipe"] = 336,
    ["Minecraft Data Pack Tag"] = 337,
    ["Minecraft Data Pack Template Pool"] = 338,
    ["Minecraft Resource Pack Lang"] = 339,
    ["Minecraft Resource Pack Particle"] = 340,
    ["Minecraft Resource Pack Texture Mcmeta"] = 342,
    ["Minecraft Resourcepack Sounds"] = 341,
    ["MkDocs Configuration 1.0"] = 343,
    ["MongoDB Atlas Search Index Definition Schema"] = 665,
    ["Monika Configuration Schema"] = 663,
    ["Motif config"] = 569,
    ["NOX Framework (Service)"] = 357,
    ["Netin Diagnostic System Template"] = 626,
    ["Netlify config schema"] = 348,
    ["Nexus-as-Code schema"] = 349,
    ["Nightwatch.js"] = 350,
    ["ONe's service descriptor"] = 369,
    ["OSS Review Toolkit configuration"] = 376,
    ["OSS Review Toolkit curation"] = 377,
    ["OSS Review Toolkit package configuration"] = 378,
    ["OSS Review Toolkit repository configuration"] = 379,
    ["OSS Review Toolkit resolutions"] = 380,
    Opctl = 572,
    ["OpenRewrite Resource"] = 371,
    ["OpenWeather Current Weather API"] = 608,
    ["OpenWeather Road Risk API"] = 607,
    ["Ory Hydra configuration"] = 264,
    ["Ory Keto configuration"] = 301,
    ["Ory Kratos configuration"] = 375,
    ["Ory Oathkeeper configuration"] = 364,
    ["Outblocks App configuration"] = 373,
    ["Outblocks database table"] = 374,
    ["Outblocks project configuration"] = 372,
    Packer = 383,
    Pantsbuild = 682,
    ["Paper paper-plugin.yml"] = 384,
    ["Pipeline component"] = 618,
    ["PocketMine plugin.yml"] = 388,
    ["Postman collection"] = 393,
    Pterodactyl = 660,
    ["Pull Request Labeler"] = 414,
    Pulumi = 419,
    PyProject = 420,
    Pyright = 421,
    Qodana = 636,
    ["Quali Torque Blueprint Spec 2"] = 658,
    ["QueryFirst config file"] = 679,
    ["RKE Cluster Configuration JSON Schema"] = 615,
    ["RKE Cluster Configuration YAML Schema"] = 614,
    ["Rancher Fleet"] = 417,
    Ray = 584,
    ["Read the Docs"] = 418,
    ["Red-DiscordBot Cog"] = 422,
    ["Red-DiscordBot Cog Repo"] = 423,
    ["Red-DiscordBot Trivia"] = 424,
    Renovate = 433,
    ["Replit schema"] = 427,
    RoadRunner = 434,
    Ruff = 430,
    ["Rust Project"] = 431,
    ["Rust toolchain"] = 436,
    ["SIL Kit Participant Configuration"] = 465,
    SWADL = 487,
    ["Sapphire CLI Config"] = 439,
    ["SauceCTL Configuration"] = 623,
    ["Schema Catalog"] = 452,
    ["Scoop manifest"] = 457,
    ["Semantic Data Fabric (SDF) file"] = 458,
    ["Semgrep Rule"] = 460,
    ["Serenity Code Generator (Sergen)"] = 461,
    ["Serverless Framework Configuration"] = 630,
    ["Serverless Workflow Schema"] = 632,
    ["Settings.paf"] = 463,
    ["Shopware 6 Configuration"] = 633,
    ["Shopware CLI Extension Store Configuration"] = 634,
    ["Shopware CLI Project Store Configuration"] = 635,
    ["Slack app manifest"] = 467,
    Solidarity = 470,
    ["Solution filters"] = 471,
    ["Source Maps v3"] = 472,
    Sourcery = 473,
    SpecIF = 474,
    ["Sponge Mixin configuration"] = 475,
    ["StackHawk Scanner Configuration"] = 629,
    Stale = 479,
    Starship = 480,
    ["Statamic Blueprint"] = 481,
    ["StrmPrivacy Data Connector"] = 674,
    ["StrmPrivacy Data Contract"] = 675,
    ["StrmPrivacy SimpleSchema"] = 672,
    ["StrmPrivacy Stream"] = 673,
    ["StrmPrivacy batch job configuration file"] = 671,
    ["Stryker Mutator"] = 484,
    ["StyleCop Analyzers Configuration"] = 485,
    ["Swagger API 2.0"] = 488,
    TSON = 512,
    ["Talisman configuration"] = 490,
    ["Taskfile YAML Schema"] = 610,
    Taurus = 491,
    ["TestEnvironment.json"] = 500,
    ["Tier.run pricing.json"] = 494,
    Tikibase = 495,
    ["Traefik v2"] = 503,
    ["Traefik v2 File Provider"] = 504,
    Turborepo = 501,
    Tye = 637,
    ["UI5 Manifest"] = 519,
    ["UTAM Page Object"] = 522,
    ["Ubuntu Server Autoinstall"] = 517,
    ["Uniswap Token List"] = 593,
    ["Unreal Engine Uplugin"] = 680,
    ["Unreal Engine Uproject"] = 681,
    Updatecli = 644,
    Uplift = 678,
    ["User Journey Map YAML Schema"] = 613,
    V2Ray = 648,
    ["VSCode Code Snippets"] = 137,
    ["VSIX CLI publishing"] = 535,
    ["Vela Pipeline Configuration"] = 525,
    Vercel = 136,
    ["Web App Manifest"] = 542,
    ["Web types"] = 545,
    WebExtensions = 541,
    ["Webman package recipe"] = 654,
    ["Windows Package Manager Installer Manifest"] = 590,
    ["Windows Package Manager Locale Manifest"] = 591,
    ["Windows Package Manager Singleton Manifest"] = 589,
    ["Woodpecker pipeline config"] = 625,
    ["Xstate Machine Schema"] = 642,
    ["Yippee-Ki-JSON configuration YML"] = 595,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 65,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 688,
    ["bashly-strings.yml"] = 689,
    ["bashly.yml"] = 687,
    ["batect.yml"] = 64,
    ["beau.yml"] = 603,
    ...
    ["gitlab-ci"] = 241,
    ["global.json"] = 243,
    ["golangci-lint Configuration"] = 244,
    ["haxelib.json"] = 257,
    helmfile = 586,
    ["host-meta.json"] = 262,
    ["host.json"] = 261,
    ...
    ["ide.host.json"] = 267,
    ["ifstate.conf"] = 268,
    ["imageoptimizer.json"] = 269,
    ["importmap.json"] = 272,
    ["ioBroker Configuration"] = 273,
    ["ioBroker JSON UI"] = 274,
    ["ioBroker Package manifest"] = 275,
    ["ize.toml"] = 677,
    ["jsconfig.json"] = 296,
    ["jscpd Configuration Schema"] = 659,
    jsdoc = 583,
    ["k3d.yaml"] = 297,
    ["kontinuous-values.yaml"] = 302,
    ["kustomization.yaml"] = 303,
    ["label-commenter-config.yml"] = 304,
    ["launchsettings.json"] = 305,
    ["lego.json"] = 306,
    ["lerna.json"] = 307,
    ["lgtm.yml"] = 308,
    ["libman.json"] = 309,
    ["license-report-config.json"] = 310,
    ["linkinator.config.json"] = 311,
    ["local.settings.json"] = 316,
    ["localazy.json"] = 317,
    ["lotus.yaml"] = 315,
    ["lsdlschema.json"] = 318,
    ["madness.yml"] = 686,
    ["markdown-lint-check"] = 621,
    mboats = 628,
    ["micro-settings.json"] = 690,
    ["mimetypes.json"] = 325,
    ["mirrord-schema"] = 566,
    ["mta.yaml"] = 567,
    ["mtad.yaml"] = 568,
    ["mycode.json"] = 346,
    ["napari plugin manifest"] = 347,
    neoload = 578,
    ["nest-cli"] = 353,
    ["ninjs (News in JSON) 1.3"] = 352,
    ["ninjs (News in JSON) 2.0"] = 351,
    ["nlu.json"] = 354,
    ["nodemon.json"] = 356,
    ["noodl.schema.json"] = 627,
    now = 574,
    ["npm-badges"] = 359,
    ["nswag.json"] = 362,
    ntangle = 363,
    ["nuclei-template.yaml"] = 360,
    ["nuget-project.json"] = 361,
    ["ocelot.json"] = 365,
    ["omnisharp.json"] = 366,
    ["openapi.json"] = 367,
    ["openfin.json"] = 370,
    ["openrpc.json"] = 368,
    ["package.json"] = 381,
    ["package.manifest"] = 382,
    ["pattern.json"] = 386,
    ["petstore-v1.0"] = 669,
    pgap_yaml_input_reader = 385,
    ["plagiarize-me.yaml"] = 390,
    ["plagiarize.yaml"] = 389,
    ["portman.json"] = 391,
    ["prettierrc.json"] = 398,
    ["prisma.yml"] = 399,
    ["project-1.0.0-beta3.json"] = 401,
    ["project-1.0.0-beta4.json"] = 402,
    ["project-1.0.0-beta5.json"] = 403,
    ["project-1.0.0-beta6.json"] = 404,
    ["project-1.0.0-beta8.json"] = 405,
    ["project-1.0.0-rc1.json"] = 406,
    ["project-1.0.0-rc2.json"] = 407,
    ["project.json"] = 400,
    ["prometheus.json"] = 408,
    ["prometheus.rules.json"] = 409,
    ["prometheus.rules.test.json"] = 410,
    ["proxies.json"] = 411,
    ["publiccode.yml"] = 412,
    ["pubspec.yaml"] = 413,
    ["pyrseas-0.8.json"] = 416,
    ["quilt.mod.json"] = 691,
    ["release drafter"] = 579,
    rtx = 429,
    rustfmt = 435,
    samt = 437,
    samtrc = 438,
    ["sarif-1.0.0.json"] = 440,
    ["sarif-2.0.0.json"] = 441,
    ["sarif-2.1.0"] = 450,
    ["sarif-2.1.0-rtm.2"] = 442,
    ["sarif-2.1.0-rtm.3"] = 444,
    ["sarif-2.1.0-rtm.4"] = 446,
    ["sarif-2.1.0-rtm.5"] = 448,
    ["sarif-external-property-file-2.1.0"] = 451,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 443,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 445,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 447,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 449,
    ["schema.org - Action"] = 453,
    ["schema.org - ContactPoint"] = 454,
    ["schema.org - Place"] = 455,
    ["schema.org - Thing"] = 456,
    ["semantic-release"] = 459,
    ["servicehub.config.json"] = 555,
    ["servicehub.service.json"] = 554,
    ["settings.job"] = 462,
    ["sfdx-hardis configuration"] = 464,
    ["size-limit configuration"] = 466,
    ["skaffold.yaml"] = 619,
    ["skyuxconfig.json"] = 468,
    snapcraft = 469,
    ["stripe-app-local.json"] = 483,
    ["stripe-app.json"] = 482,
    swcrc = 606,
    ["task.json"] = 489,
    taskcat = 575,
    ["template.json"] = 492,
    ["templatsources.json"] = 493,
    ["theme.json"] = 496,
    ["tizen_workspace.json"] = 497,
    tldr = 498,
    tmLanguage = 499,
    tmuxinator = 563,
    ["transcend.yml"] = 505,
    ["trunk.yaml schema"] = 506,
    ["ts-force-config.json"] = 510,
    ["tsconfig.json"] = 507,
    ["tsd.json"] = 508,
    ["tsdrc.json"] = 509,
    ["tslint.json"] = 511,
    ...
    ["vega-lite.json"] = 524,
    ["vega.json"] = 523,
    ["venvironment-basic.yaml"] = 527,
    ["venvironment.yaml"] = 526,
    ["version.json"] = 528,
    ["vim-addon-info"] = 529,
    ["vs-2017.3.host.json"] = 531,
    ["vs-nesting.json"] = 532,
    ["vsls.json"] = 530,
    ["vss-extension.json"] = 536,
    ["vtesttree.yaml"] = 537,
    ["vtestunit.yaml"] = 538,
    ["webhint.io"] = 655,
    ["webjobpublishsettings.json"] = 544,
    ["webjobs-list.json"] = 543,
    ["xs-app.json"] = 571,
    ["xunit.runner.json"] = 553,
    yamllint = 594,
    zuul = 580,
    ["Žinoma"] = 588
  },
