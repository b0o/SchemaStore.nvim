...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 720,
    [".nodehawkrc"] = 463,
    [".npmpackagejsonlintrc"] = 467,
    [".omletrc"] = 895,
    [".phrase.yml"] = 514,
    [".phraseapp.yml"] = 515,
    [".pmbot.yml"] = 504,
    [".postcssrc"] = 509,
    [".powerpages-web-template-manifest"] = 511,
    [".pre-commit-config.yml"] = 512,
    [".pre-commit-hooks.yml"] = 513,
    [".putout.json"] = 534,
    [".rehyperc"] = 553,
    [".remarkrc"] = 555,
    [".sprite files"] = 617,
    ...
    ["<div>RIOTS' studio configuration"] = 692,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 417,
    ABCSupplyPlan = 13,
    AIConfig = 14,
    ["API Builder"] = 752,
    ...
    ["Azure Pipelines"] = 60,
    ["Azure Static Web Apps CLI configuration file"] = 620,
    ["Azure Static Web Apps configuration file"] = 619,
    ["BX CI"] = 99,
    ...
    ["Datadog Service Definition"] = 392,
    ["Datadog Software Catalog"] = 393,
    ...
    ["JSON Feed"] = 382,
    ["JSON Resume"] = 560,
    ["JSON Schema Draft 2020-12"] = 705,
    ["JSON Schema Draft 4"] = 702,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 864,
    ["JSON Schema Draft 7"] = 703,
    ["JSON Schema Draft 7 (unofficial strict)"] = 865,
    ["JSON Schema Draft 8 (2019-09)"] = 704,
    ["JSON-API"] = 380,
    ["JSON-WF"] = 893,
    ...
    Lefthook = 401,
    ["Liferay client-extension.yaml"] = 408,
    ["LinkML Metamodel"] = 410,
    Liquibase = 769,
    ["Liquibase Flow File"] = 770,
    ["Lively Properties"] = 411,
    ["Lobe AI Agent"] = 58,
    Loki = 59,
    ["MLOS Configs"] = 447,
    ["MS2Rescore Configuration"] = 450,
    ["Madness (madness.yml)"] = 845,
    Markdownlint = 773,
    ["Mason Registry"] = 775,
    ["MegaLinter configuration"] = 418,
    ["MegaLinter descriptor"] = 419,
    Melange = 871,
    ["Meltano plugin discovery definition"] = 421,
    ["Meltano project definition"] = 420,
    ["Mergify Configuration"] = 451,
    ["Metadata for a Bazel module"] = 422,
    ["MetricsHub Configuration"] = 423,
    ["MetricsHub Connector Configuration"] = 424,
    ["Micro Editor Syntax"] = 855,
    ["Microsoft Band Web Tile"] = 425,
    ["Microsoft RulesEngine workflow rules"] = 907,
    ["Microsoft RulesEngine workflow rules list"] = 908,
    ["Minecraft Custom Main Menu Mod"] = 872,
    ["Minecraft Data Pack Advancement"] = 427,
    ["Minecraft Data Pack Biome"] = 428,
    ["Minecraft Data Pack Configured Carver"] = 429,
    ["Minecraft Data Pack Damage Type"] = 430,
    ["Minecraft Data Pack Dimension"] = 432,
    ["Minecraft Data Pack Dimension Type"] = 431,
    ["Minecraft Data Pack Item Modifier"] = 433,
    ["Minecraft Data Pack Loot Table"] = 434,
    ["Minecraft Data Pack Metadata"] = 435,
    ["Minecraft Data Pack Predicate"] = 436,
    ["Minecraft Data Pack Recipe"] = 437,
    ["Minecraft Data Pack Tag"] = 438,
    ["Minecraft Data Pack Template Pool"] = 439,
    ["Minecraft Data Pack Trim Material"] = 444,
    ["Minecraft Data Pack Trim Pattern"] = 445,
    ["Minecraft Resource Pack Lang"] = 440,
    ["Minecraft Resource Pack Particle"] = 441,
    ["Minecraft Resource Pack Texture Mcmeta"] = 443,
    ["Minecraft Resourcepack Sounds"] = 442,
    ["Monade CLI Stack Configuration"] = 454,
    ["MongoDB Atlas Search Index Definition"] = 821,
    ["Monika Configuration"] = 819,
    ["Monoweave Configuration"] = 449,
    ["Motif config"] = 719,
    ["NOX Framework (Service)"] = 466,
    ["Netin Diagnostic System Template"] = 779,
    ["Netlify config"] = 457,
    ["Network-as-Code Data Model"] = 458,
    ["Nightwatch.js"] = 459,
    ["Nuitka.yaml"] = 885,
    ["ONe's changelog entry"] = 482,
    ["ONe's service descriptor"] = 481,
    ["OSS Review Toolkit configuration"] = 490,
    ["OSS Review Toolkit curation"] = 491,
    ["OSS Review Toolkit package configuration"] = 492,
    ["OSS Review Toolkit repository configuration"] = 493,
    ["OSS Review Toolkit resolutions"] = 494,
    Opctl = 722,
    ["Open Data Contract Standard (ODCS))"] = 485,
    ["OpenRewrite Resource"] = 484,
    ["OpenUtau character yaml"] = 478,
    ["OpenUtau ustx"] = 479,
    ["OpenWeather Current Weather API"] = 760,
    ["OpenWeather Road Risk API"] = 759,
    ["Ory Hydra configuration"] = 349,
    ["Ory Keto configuration"] = 394,
    ["Ory Kratos configuration"] = 489,
    ["Ory Oathkeeper configuration"] = 473,
    ["Outblocks App configuration"] = 487,
    ["Outblocks database table"] = 488,
    ["Outblocks project configuration"] = 486,
    PDM = 500,
    Packer = 497,
    Pantsbuild = 841,
    ["Paper paper-plugin.yml"] = 498,
    ["Pipeline component"] = 771,
    ["PocketMine plugin.yml"] = 505,
    ["Postman collection"] = 510,
    ["Problem object RFC9457"] = 869,
    ["Problem package generators"] = 518,
    Pterodactyl = 816,
    ["Pull Request Labeler"] = 533,
    Pulumi = 539,
    PyProject = 540,
    Pyright = 541,
    Qgoda = 542,
    ...
    Ray = 734,
    ["Read the Docs"] = 538,
    ["Red-DiscordBot Cog"] = 550,
    ["Red-DiscordBot Cog Repo"] = 551,
    ["Red-DiscordBot Trivia"] = 552,
    ...
    ["Rust Project"] = 559,
    ["Rust toolchain"] = 567,
    ["SDMX data message"] = 592,
    ["SDMX metadata message"] = 591,
    ["SDMX structure message"] = 590,
    ["SIL Kit Participant Configuration"] = 602,
    ["SIL Kit Registry Configuration"] = 603,
    SWADL = 631,
    ["Safebox Config"] = 827,
    ["Sapphire CLI Config"] = 570,
    ["SauceCTL Configuration"] = 776,
    ["Schema Catalog"] = 584,
    ["Scoop manifest"] = 589,
    ["Semantic Data Fabric (SDF) file"] = 593,
    ["Semgrep Rule"] = 595,
    ["Serenity Code Generator (Sergen)"] = 596,
    ...
    Sigma = 600,
    ["Sigrid scope configuration file"] = 601,
    ["SkyPilot Task JSON"] = 876,
    ["Slack app manifest"] = 605,
    Solidarity = 608,
    ["Solution filters"] = 609,
    ["Source Maps v3"] = 610,
    Sourcery = 611,
    ["Speakeasy Lint Configuration File"] = 612,
    ["Speakeasy Test Generation Configuration File"] = 613,
    ["Speakeasy Workflow File"] = 614,
    SpecIF = 615,
    ["Sponge Mixin configuration"] = 616,
    StackBlitz = 621,
    ["StackHawk Scanner Configuration"] = 782,
    Stale = 622,
    ["Starlake Data Pipeline"] = 757,
    Starship = 623,
    ["Statamic Blueprint"] = 624,
    ["Stella configuration file"] = 625,
    ...
    ["Stryker Mutator"] = 628,
    ["StyleCop Analyzers Configuration"] = 629,
    ["Stylelint (.stylelintrc)"] = 630,
    ["Sublime Syntax"] = 833,
    ...
    TSTyche = 659,
    Talhelper = 634,
    ["Talisman configuration"] = 635,
    ["Taskfile config"] = 762,
    Taurus = 636,
    ["TestEnvironment.json"] = 645,
    ["TextMate Grammar"] = 644,
    ["Tier.run pricing.json"] = 639,
    Tikibase = 640,
    ["Traefik v2"] = 648,
    ["Traefik v2 File Provider"] = 649,
    ["Travis CI (.travis.yml)"] = 647,
    TunnelHub = 868,
    Turborepo = 646,
    Tycho = 914,
    Tye = 790,
    ...
    ["UI5 Manifest"] = 668,
    ["UNCORS configuration"] = 672,
    ["UTAM Page Object"] = 671,
    ["Ubuntu Server Autoinstall"] = 666,
    ...
    ["VSIX CLI publishing"] = 687,
    ["Vela Pipeline Configuration"] = 676,
    Vercel = 170,
    Visivo = 866,
    ["Web App Manifest"] = 694,
    ["Web types"] = 697,
    WebExtensions = 693,
    ...
    ["k3d.yaml"] = 386,
    ["k9s plugin.yml"] = 388,
    ["kontinuous-config.yaml"] = 396,
    ["kontinuous-values.yaml"] = 395,
    ["kustomization.yaml"] = 398,
    ["label-commenter-config.yml"] = 399,
    ["latexindent configuration"] = 57,
    ["launchsettings.json"] = 400,
    lazydocker = 857,
    lazygit = 856,
    ["lego.json"] = 402,
    ["lerna.json"] = 403,
    ["lgtm.yml"] = 404,
    ["liblab.config.json"] = 405,
    ["libman.json"] = 406,
    ["license-report-config.json"] = 407,
    ["linkinator.config.json"] = 409,
    ["lint-staged (.lintstagedrc)"] = 713,
    ["local.settings.json"] = 414,
    ["localazy.json"] = 415,
    ["lotus.yaml"] = 413,
    ["lsdlschema.json"] = 416,
    ...
    ["mtad.yaml"] = 718,
    ["mycode.json"] = 455,
    ["napari plugin manifest"] = 456,
    neoload = 728,
    ["nest-cli"] = 461,
    ["ninjs (News in JSON)"] = 460,
    ["nixd configuration"] = 874,
    ["nlu.json"] = 462,
    ["nodemon.json"] = 464,
    ["noodl config"] = 780,
    ["notebook.mod.json"] = 465,
    now = 724,
    ["npm-badges"] = 468,
    ["nswag.json"] = 471,
    ntangle = 472,
    ["nuclei-template.yaml"] = 469,
    ["nuget-project.json"] = 470,
    ["ocelot.json"] = 474,
    ["omnisharp.json"] = 475,
    ["openapi.json"] = 476,
    ["openfin.json"] = 483,
    ...
    ["ops.yaml"] = 480,
    ["package.json"] = 495,
    ["package.manifest"] = 496,
    ["partial-black.json"] = 86,
    ["pathfinder.yml"] = 499,
    ["pattern.json"] = 502,
    ["petstore-v1.0"] = 825,
    pgap_yaml_input_reader = 501,
    ["pixi.toml"] = 503,
    ["plagiarize-me.yaml"] = 507,
    ["plagiarize.yaml"] = 506,
    ["portman.json"] = 508,
    ["prettierrc.json"] = 516,
    ["prisma.yml"] = 517,
    ["project-1.0.0-beta3.json"] = 520,
    ["project-1.0.0-beta4.json"] = 521,
    ["project-1.0.0-beta5.json"] = 522,
    ["project-1.0.0-beta6.json"] = 523,
    ["project-1.0.0-beta8.json"] = 524,
    ["project-1.0.0-rc1.json"] = 525,
    ["project-1.0.0-rc2.json"] = 526,
    ["project.json"] = 519,
    ["prometheus.json"] = 527,
    ["prometheus.rules.json"] = 528,
    ["prometheus.rules.test.json"] = 529,
    ["proxies.json"] = 530,
    ["publiccode.yml"] = 531,
    ["pubspec.yaml"] = 532,
    ["pyrseas-0.8.json"] = 535,
    ["quilt.mod.json"] = 851,
    ["rc3 auth"] = 544,
    ["rc3 collection"] = 545,
    ["rc3 environment"] = 546,
    ...
    samt = 568,
    samtrc = 569,
    ["sarif-1.0.0.json"] = 571,
    ["sarif-2.0.0.json"] = 572,
    ["sarif-2.1.0"] = 582,
    ["sarif-2.1.0-rtm.2"] = 573,
    ["sarif-2.1.0-rtm.3"] = 575,
    ["sarif-2.1.0-rtm.4"] = 577,
    ["sarif-2.1.0-rtm.5"] = 579,
    ["sarif-2.1.0-rtm.6"] = 580,
    ["sarif-external-property-file-2.1.0"] = 583,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 574,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 576,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 578,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 581,
    ["schema.org - Action"] = 585,
    ["schema.org - ContactPoint"] = 586,
    ["schema.org - Place"] = 587,
    ["schema.org - Thing"] = 588,
    ["secrethub.yml"] = 853,
    ["semantic-release"] = 594,
    ["servicehub.config.json"] = 708,
    ["servicehub.service.json"] = 707,
    ["settings.job"] = 597,
    ["sfdx-hardis configuration"] = 599,
    ["shard.yml"] = 889,
    ["size-limit configuration"] = 604,
    ["skaffold.yaml"] = 772,
    ["skyuxconfig.json"] = 606,
    snapcraft = 607,
    ["spicepod.yaml"] = 909,
    ["sqlc configuration"] = 618,
    ["stripe-app-local.json"] = 627,
    ["stripe-app.json"] = 626,
    swcrc = 758,
    ["task.json"] = 633,
    taskcat = 725,
    ["template.json"] = 637,
    ["templatsources.json"] = 638,
    ["theme.json"] = 641,
    ["tizen_workspace.json"] = 642,
    tldr = 643,
    tmuxinator = 711,
    ["transcend.yml"] = 650,
    ...
    ["vega-lite.json"] = 675,
    ["vega.json"] = 674,
    ["venvironment-basic.yaml"] = 678,
    ["venvironment.yaml"] = 677,
    ["version.json"] = 679,
    ["vim-addon-info"] = 681,
    ["vs-2017.3.host.json"] = 683,
    ["vs-nesting.json"] = 684,
    ["vsls.json"] = 682,
    ["vss-extension.json"] = 688,
    ["vtesttree.yaml"] = 689,
    ["vtestunit.yaml"] = 690,
    ...
    ["webhint.io"] = 811,
    ["webjobpublishsettings.json"] = 696,
    ["webjobs-list.json"] = 695,
    ["well-known-fursona"] = 897,
    ["xs-app.json"] = 721,
    ["xunit.runner.json"] = 706,
    yamllint = 746,
