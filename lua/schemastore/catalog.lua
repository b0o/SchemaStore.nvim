...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 14,
    AIConfig = 15,
    ["AMX Muse Program Descriptor"] = 978,
    ["API Builder"] = 799,
    ...
    ["DonateCaseBetterCasino menu"] = 979,
    ...
    ["crowdin.yml"] = 215,
    ["ctfd-setup configuration file"] = 977,
    ...
    ["gematik health care insurance list"] = 983,
    ["gematik health care patient list"] = 980,
    ["gematik health care provider institution list"] = 982,
    ["gematik health care provider list"] = 981,
    ["gitlab-ci"] = 320,
    ["global.json"] = 335,
