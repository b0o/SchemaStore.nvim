...
M.json = {
  ...
  index = {
    ...
    [".pmbot.yml"] = 584,
    [".postcssrc"] = 591,
    [".powerpages-web-template-manifest"] = 593,
    [".pre-commit-config.yml"] = 594,
    [".pre-commit-hooks.yml"] = 595,
    [".putout.json"] = 624,
    [".rehyperc"] = 648,
    [".remarkrc"] = 652,
    [".sprite files"] = 739,
    ...
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1086,
    ["API Builder"] = 900,
    ["AVA Configuration"] = 962,
    ...
    ["AWS Copilot Manifest"] = 1125,
    ["AWS SAM CLI Samconfig"] = 226,
    ["Adobe UXP Manifest"] = 1024,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1115,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 934,
    ["All Contributors configuration file"] = 987,
    ...
    ["Application list for a WinUtil"] = 1068,
    ArchitectFX = 1073,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure IoT Operations connector metadata"] = 1131,
    ...
    ["Azure Pipelines"] = 81,
    ["Azure Static Web Apps CLI configuration file"] = 743,
    ["Azure Static Web Apps configuration file"] = 742,
    ["BOSH CPI Config"] = 105,
    ["BOSH Deploy Config"] = 106,
    ["BX CI"] = 125,
    ["Bashly (bashly.yml)"] = 991,
    ["Bashly Settings (bashly-settings.yml)"] = 992,
    ["Better Code Hub"] = 904,
    ["Better Scripts"] = 126,
    Bigconfig = 98,
    ["Biome Formatter Config"] = 65,
    ["Bitmovin Encoding Template"] = 1079,
    BizTalkServerApplicationSchema = 872,
    Bleep = 127,
    ...
    ["Butane Config"] = 947,
    C4InterFlow = 1094,
    ["CDK Environment Manager, concrete environment configuration"] = 1118,
    ["CDK Environment Manager, concrete environments definition"] = 1117,
    ["CDK Environment Manager, environment definition"] = 1116,
    ["CGS Card Game Specification (cgs.json)"] = 1029,
    ["CICS TS region tagging"] = 956,
    ["CICS TS resource import"] = 957,
    ["CICS TS resource model"] = 958,
    ["CICS TS resource overrides"] = 959,
    ["CMake Presets"] = 128,
    ["CNC Codes"] = 149,
    ["CRS WAF test file"] = 1058,
    ["CRS WAF test platform overrides file"] = 1059,
    ...
    ["Chamaleon environment"] = 1083,
    ["Chamaleon properties"] = 1084,
    ["Chamaleon template"] = 1082,
    Changesets = 235,
    Changie = 137,
    Charmcraft = 138,
    Cheatsheets = 944,
    ...
    ["Clawject config"] = 155,
    ["Cloud Foundry Application Manifest"] = 1040,
    ["Cloud Run Spec v1"] = 1063,
    ...
    Concord = 1057,
    ["Configu .cfgu files"] = 1045,
    ["Configu .configu file"] = 1046,
    Conjure = 148,
    ["Container Structure Test"] = 886,
    Containerlab = 913,
    ["Contextive Glossary"] = 1110,
    Convex = 147,
    ["Crowdsec collection config"] = 245,
    ["Crowdsec parser config"] = 246,
    ["Crowdsec scenario config"] = 247,
    ["CumulusCI Config"] = 154,
    ["Custom Machinery Machine"] = 1030,
    ["Custom Machinery Recipe"] = 1031,
    ...
    ["DonateCaseBetterCasino menu"] = 1087,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 999,
    ["EAS config"] = 311,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 988,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1130,
    ["EasyVCR .NET"] = 312,
    ["Eidolon Resource"] = 1074,
    ...
    ["Evolving Resolutive Process notation"] = 1132,
    ["Expo SDK"] = 310,
    ...
    ["GeoJSON.json latest"] = 951,
    GherKing = 955,
    ["GitHub Action"] = 342,
    ["GitHub Actions typing"] = 1070,
    ...
    ["Google Digital Assetlinks"] = 1111,
    Goreleaser = 370,
    ["Goreleaser Pro"] = 371,
    Goss = 372,
    ["Gradle Build Cache Node"] = 902,
    ["Gradle Enterprise"] = 901,
    ...
    Hadolint = 882,
    Hammerkit = 912,
    ["Hardware Sentry Configuration"] = 967,
    ["HashiCorp Vault"] = 385,
    Hatch = 883,
    Hayagriva = 387,
    Hayson = 388,
    ...
    ["JFrog File Spec"] = 420,
    ["JFrog Pipelines YML DSL"] = 976,
    ["JMeter DSL cli config"] = 421,
    JReleaser = 424,
    ["JSON Document Transform"] = 432,
    ["JSON Feed"] = 433,
    ["JSON Resume"] = 658,
    ["JSON Schema Draft 2020-12"] = 850,
    ["JSON Schema Draft 4"] = 847,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1009,
    ["JSON Schema Draft 7"] = 848,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1010,
    ["JSON Schema Draft 8 (2019-09)"] = 849,
    ["JSON-API"] = 431,
    ["JSON-e templates"] = 909,
    ["JSON-stat 2.0"] = 843,
    JSONPatch = 435,
    ...
    ["Jujutsu (jj) VCS config"] = 1124,
    ["KIMMDY config file"] = 446,
    ["KODE/CI build.yaml"] = 972,
    ["KSP-AVC"] = 844,
    ["KSP-CKAN"] = 845,
    ["KSP-NetKAN"] = 846,
    KSY = 1039,
    ...
    ["Metadata for a Cinnamon spice"] = 1066,
    ["Metatype Configuration"] = 486,
    ["MetricsHub Configuration"] = 487,
    ["MetricsHub Connector Configuration"] = 488,
    ["Micro Editor Syntax"] = 1000,
    ["Microsoft Band Web Tile"] = 489,
    ["Microsoft RulesEngine workflow rules"] = 1054,
    ["Microsoft RulesEngine workflow rules list"] = 1055,
    ["Minecraft Custom Main Menu Mod"] = 1018,
    ...
    ["MongoDB Atlas Search Index Definition"] = 971,
    ["Monika Configuration"] = 969,
    ["Monoweave Configuration"] = 514,
    ["Motif config"] = 864,
    MultiQC = 1104,
    ["NOX Framework (Service)"] = 532,
    ["Netin Diagnostic System Template"] = 929,
    ["Netlify config"] = 522,
    ["Network-as-Code Data Model"] = 523,
    ["Nightwatch.js"] = 525,
    ["Node.js configuration"] = 869,
    ["NueJS configuration file"] = 537,
    ["Nuitka.yaml"] = 1032,
    ["Nullstone config"] = 539,
    ["ONe's changelog entry"] = 553,
    ["ONe's service descriptor"] = 552,
    ["ORT Server repository environment configuration"] = 561,
    ["OSCAL Assessment Plan (AP)"] = 563,
    ["OSCAL Assessment Results (AR)"] = 564,
    ["OSCAL Catalog"] = 565,
    ["OSCAL Component Definition (CDef)"] = 566,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 567,
    ["OSCAL Profile"] = 568,
    ["OSCAL System Security Plan (SSP)"] = 569,
    ["OSS Review Toolkit configuration"] = 570,
    ["OSS Review Toolkit curation"] = 571,
    ["OSS Review Toolkit package configuration"] = 572,
    ["OSS Review Toolkit repository configuration"] = 573,
    ["OSS Review Toolkit resolutions"] = 574,
    ["October CMS columns"] = 543,
    ["October CMS fields"] = 544,
    Okteto = 545,
    Opctl = 867,
    ["Open Data Contract Standard (ODCS)"] = 556,
    ["Open Data Product Standard (ODPS)"] = 557,
    ["Open Know-How"] = 1109,
    ["OpenRewrite Resource"] = 555,
    OpenStatus = 1120,
    ["OpenUtau character yaml"] = 549,
    ["OpenUtau ustx"] = 550,
    ["OpenWeather Current Weather API"] = 908,
    ["OpenWeather Road Risk API"] = 907,
    ["Ory Hydra configuration"] = 397,
    ["Ory Keto configuration"] = 454,
    ["Ory Kratos configuration"] = 562,
    ["Ory Oathkeeper configuration"] = 541,
    ["Outblocks App configuration"] = 559,
    ["Outblocks database table"] = 560,
    ["Outblocks project configuration"] = 558,
    PDM = 580,
    Packer = 577,
    Pantsbuild = 986,
    ["Paper paper-plugin.yml"] = 578,
    ["Pipeline component"] = 920,
    ["Platform.sh application"] = 2,
    ["Platform.sh routes"] = 3,
    ["Platform.sh services"] = 4,
    ["Plex Prerolls"] = 588,
    ["PocketMine plugin.yml"] = 585,
    ["Postman collection"] = 592,
    ["Power Pages Configuration"] = 1121,
    ["Preset list for a WinUtil"] = 1069,
    ["ProActions AI-Kit Configuration"] = 601,
    ["ProActions AI-Kit Configuration for Menus"] = 603,
    ["ProActions AI-Kit Configuration for Sections"] = 605,
    ["ProActions AI-Kit Configuration for Services"] = 602,
    ["ProActions AI-Kit Configuration for Steps"] = 606,
    ["ProActions AI-Kit Configuration for Templates"] = 604,
    ["Problem object RFC9457"] = 1015,
    ["Problem package generators"] = 607,
    Pterodactyl = 966,
    ["Pull Request Labeler"] = 623,
    Pulumi = 631,
    ["PyGTA Config"] = 627,
    PyProject = 632,
    Pylock = 1112,
    Pyright = 633,
    ["Python script metadata"] = 1106,
    ["QType AI DSL"] = 636,
    Qgoda = 635,
    Qodana = 939,
    ["Qt Creator workspace file"] = 1047,
    ["Quali Torque Blueprint Spec 2"] = 964,
    ["QueryFirst config file"] = 982,
    ["RKE Cluster Configuration JSON"] = 917,
    ["RKE Cluster Configuration YAML"] = 916,
    RadioHound = 626,
    Railway = 637,
    ["Rancher Fleet"] = 628,
    ["Rattler-build"] = 638,
    Ray = 881,
    ["Read the Docs"] = 630,
    ["Red-DiscordBot Cog"] = 645,
    ["Red-DiscordBot Cog Repo"] = 646,
    ["Red-DiscordBot Trivia"] = 647,
    ["Render Blueprints"] = 915,
    RenderCV = 660,
    Renovate = 659,
    ["Replit config"] = 653,
    Restate = 1099,
    ["Revel Digital Gadget Definition File"] = 1123,
    RoadRunner = 662,
    ["Robust Station Image"] = 1129,
    ["Roo Coder Custom Modes"] = 664,
    Rubocop = 655,
    ["Rudder techniques"] = 1022,
    Ruff = 656,
    ["Rust Project"] = 657,
    ["Rust toolchain"] = 667,
    ["SDMX data message"] = 693,
    ["SDMX metadata message"] = 692,
    ["SDMX structure message"] = 691,
    ["SIL Kit Participant Configuration"] = 703,
    ["SIL Kit Registry Configuration"] = 704,
    ["SPDX 2.3"] = 740,
    SWADL = 756,
    ["Safebox Config"] = 977,
    ["Sapphire CLI Config"] = 670,
    ["SauceCTL Configuration"] = 926,
    ["Schema Catalog"] = 685,
    ["Scoop manifest"] = 690,
    ["Semantic Data Fabric (SDF) file"] = 694,
    ["Semgrep Rule"] = 696,
    ["Serenity Code Generator (Sergen)"] = 697,
    ["Serverless Framework Configuration"] = 933,
    ["Serverless Workflow"] = 935,
    ["Settings for a Cinnamon spice"] = 1065,
    ["Settings.paf"] = 699,
    ["Shopware 6 Configuration"] = 936,
    ["Shopware CLI Extension Store Configuration"] = 937,
    ["Shopware CLI Project Store Configuration"] = 938,
    ["Sigma Detection Rule"] = 701,
    ["Sigrid scope configuration file"] = 702,
    ["SkyPilot Task JSON"] = 1023,
    ["Slack app manifest"] = 706,
    Solidarity = 711,
    ["Solution filters"] = 712,
    ["Source Maps v3"] = 713,
    Sourcery = 714,
    ["Spack bootstrap.yaml"] = 715,
    ["Spack cdash.yaml"] = 716,
    ["Spack ci.yaml"] = 717,
    ["Spack compilers.yaml"] = 718,
    ["Spack concretizer.yaml"] = 719,
    ["Spack config.yaml"] = 720,
    ["Spack definitions.yaml"] = 721,
    ["Spack develop.yaml"] = 722,
    ["Spack env_vars.yaml"] = 723,
    ["Spack environment"] = 729,
    ["Spack include.yaml"] = 724,
    ["Spack mirrors.yaml"] = 725,
    ["Spack modules.yaml"] = 726,
    ["Spack packages.yaml"] = 727,
    ["Spack repos.yaml"] = 728,
    ["Spack toolchains.yaml"] = 730,
    ["Spack upstreams.yaml"] = 731,
    ["Spack view.yaml"] = 732,
    ["Speakeasy Generation Config File"] = 736,
    ["Speakeasy Lint Configuration File"] = 733,
    ["Speakeasy Test Generation Configuration File"] = 734,
    ["Speakeasy Workflow File"] = 735,
    SpecIF = 737,
    ["Sponge Mixin configuration"] = 738,
    StackBlitz = 744,
    ["StackHawk Scanner Configuration"] = 932,
    Stale = 745,
    Starfish = 746,
    ["Starlake Data Pipeline"] = 905,
    Starship = 747,
    ["Statamic Blueprint"] = 748,
    ["Stella configuration file"] = 749,
    ["Streamlit configuration file"] = 750,
    ["Stryker Mutator"] = 753,
    ["StyleCop Analyzers Configuration"] = 754,
    ["Stylelint (.stylelintrc)"] = 755,
    ["Stylua Config"] = 1113,
    ["Sublime Syntax"] = 978,
    ["Subsquid squid manifest"] = 1025,
    ["Swagger API 2.0"] = 757,
    ["Synadia Connect Component"] = 758,
    TSON = 793,
    TSTyche = 794,
    ["TYPO3 Vendor Bundler config"] = 799,
    ["Tab data for a LinUtil"] = 1072,
    ["Tab list for a LinUtil"] = 1071,
    Tach = 759,
    ["Tach Domain"] = 760,
    Talhelper = 762,
    ["Talisman configuration"] = 763,
    Taplo = 1114,
    ["Taskfile config"] = 910,
    Taurus = 764,
    Tauticord = 765,
    Telefonistka = 1100,
    ["Terrateam config"] = 1126,
    ["TestEnvironment.json"] = 776,
    ["TextMate Grammar"] = 775,
    Threagile = 771,
    ["Tier.run pricing.json"] = 768,
    Tikibase = 769,
    Tombi = 774,
    ["Traefik v2"] = 779,
    ["Traefik v2 File Provider"] = 780,
    ["Traefik v3"] = 781,
    ["Traefik v3 File Provider"] = 782,
    ["Travis CI (.travis.yml)"] = 778,
    Treefmt = 375,
    Trident = 1096,
    ["TrueScript for *.tscript files"] = 785,
    ["Tugboat QA config.yml"] = 1093,
    TunnelHub = 1013,
    Turborepo = 777,
    Tycho = 1061,
    Tye = 940,
    ["Tyk Gateway - Open Source v5.7+"] = 1105,
    ["Typst Manifest"] = 800,
    ["UET BuildConfig.json"] = 983,
    ["UI5 Manifest"] = 806,
    ["UNCORS configuration"] = 810,
    ["UTAM Page Object"] = 809,
    ["Ubuntu Server Autoinstall"] = 804,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1097,
    ["Uniswap Token List"] = 893,
    ["Universal Schedule Format"] = 811,
    ["Unreal Engine Uplugin"] = 984,
    ["Unreal Engine Uproject"] = 985,
    ["UpCloud CLI (upctl) configuration"] = 1098,
    ["Updatecli Compose"] = 948,
    ["Updatecli Policy Manifest"] = 949,
    ["Updatecli Policy Metadata"] = 950,
    Uplift = 981,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 914,
    V2Ray = 954,
    ["VSCode Code Snippets"] = 210,
    ["VSIX CLI publishing"] = 831,
    Vector = 813,
    ["Vela Pipeline Configuration"] = 816,
    Vercel = 209,
    ["Version Bumper config"] = 821,
    ["Viash Component Config"] = 1102,
    ["Viash Package Config"] = 1103,
    Visivo = 1011,
    ["WP-CLI"] = 841,
    Wake = 1095,
    ["Waku Config"] = 1075,
    ["Web App Manifest"] = 837,
    ["Web types"] = 840,
    WebExtensions = 836,
    ["Webman package recipe"] = 960,
    ["Windows Package Manager Installer Manifest"] = 889,
    ["Windows Package Manager Locale Manifest"] = 890,
    ["Windows Package Manager Singleton Manifest"] = 888,
    Winutil = 891,
    ["WireMock stub mapping"] = 1078,
    ["Woodpecker pipeline config"] = 928,
    ["Wrangler CLI"] = 842,
    ["Xstate Machine"] = 946,
    ["Yandex Workflow Language"] = 1067,
    ["Yarn Config (.yarnrc.yml)"] = 903,
    ["Yippee-Ki-JSON configuration YML"] = 895,
    ["YouTrack App"] = 1064,
    ["Zarf Package Configuration"] = 1128,
    ["Zerops.io config"] = 1052,
    ["Zerops.io import"] = 1053,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 1016,
    ...
    ["behat.yml"] = 108,
    ["bigquery-table"] = 97,
    ["bioimageio resource description"] = 1033,
    ...
    ["crowdin.yml"] = 244,
    ["ctfd-setup configuration file"] = 1085,
    ["custom-elements.json"] = 1003,
    ["cypress.json"] = 248,
    ...
    ["gematik health care insurance list"] = 1091,
    ["gematik health care patient list"] = 1088,
    ["gematik health care provider institution list"] = 1090,
    ["gematik health care provider list"] = 1089,
    ["gematik tiger test environment configuration"] = 1092,
    ["gitlab-ci"] = 350,
    ["global.json"] = 366,
    ...
    ["lint-staged (.lintstagedrc)"] = 858,
    ["local.settings.json"] = 474,
    ["localazy.json"] = 475,
    ["lotus.yaml"] = 473,
    ["lsdlschema.json"] = 476,
    ["markdown-link-check"] = 923,
    maturin = 924,
    mboats = 931,
    ["micro-settings.json"] = 995,
    ["mimetypes.json"] = 490,
    ["mirrord config"] = 860,
    mise = 861,
    ["mkdocs.yml"] = 510,
    ["monospace.yml"] = 513,
    ["moon.yml"] = 1077,
    ["mprocs Configuration file"] = 1048,
    ["mrdocs.yml"] = 511,
    ["mta.yaml"] = 862,
    ["mtad.yaml"] = 863,
    ["mycode.json"] = 520,
    ...
    ["ops.yaml"] = 551,
    ["package.json"] = 575,
    ["package.manifest"] = 576,
    ["partial-black.json"] = 109,
    ["pathfinder.yml"] = 579,
    ["pattern.json"] = 582,
    ["petstore-v1.0"] = 975,
    pgap_yaml_input_reader = 581,
    ["pixi.toml"] = 583,
    ["plagiarize-me.yaml"] = 587,
    ["plagiarize.yaml"] = 586,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1081,
    ["podbard.yaml"] = 589,
    ["portman.json"] = 590,
    ["prefect.toml"] = 598,
    ["prettierrc.json"] = 599,
    ["prisma.yml"] = 600,
    ["project-1.0.0-beta3.json"] = 609,
    ["project-1.0.0-beta4.json"] = 610,
    ["project-1.0.0-beta5.json"] = 611,
    ["project-1.0.0-beta6.json"] = 612,
    ["project-1.0.0-beta8.json"] = 613,
    ["project-1.0.0-rc1.json"] = 614,
    ["project-1.0.0-rc2.json"] = 615,
    ["project.json"] = 608,
    ["project.owasp.yaml"] = 616,
    ["prometheus.json"] = 617,
    ["prometheus.rules.json"] = 618,
    ["prometheus.rules.test.json"] = 619,
    ["proxies.json"] = 620,
    ["publiccode.yml"] = 621,
    ["pubspec.yaml"] = 622,
    ["pyrseas-0.8.json"] = 625,
    pytest = 634,
    ["quilt.mod.json"] = 996,
    ["rc3 auth"] = 639,
    ["rc3 collection"] = 640,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 876,
    ["release-please-config.json"] = 649,
    ["release-please-manifest.json"] = 650,
    ["release-plz.toml"] = 651,
    ["renv.lock"] = 661,
    ["rivet.json"] = 1020,
    ["rivet.yaml (legacy)"] = 1019,
    rockcraft = 663,
    runny = 665,
    rustfmt = 666,
    sake = 1108,
    samt = 668,
    samtrc = 669,
    ["sarif-1.0.0.json"] = 671,
    ["sarif-2.0.0.json"] = 672,
    ["sarif-2.1.0"] = 682,
    ["sarif-2.1.0-rtm.2"] = 673,
    ["sarif-2.1.0-rtm.3"] = 675,
    ["sarif-2.1.0-rtm.4"] = 677,
    ["sarif-2.1.0-rtm.5"] = 679,
    ["sarif-2.1.0-rtm.6"] = 680,
    ["sarif-external-property-file-2.1.0"] = 683,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 674,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 676,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 678,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 681,
    ["scalingo.json configuration"] = 684,
    ["schema.org - Action"] = 686,
    ["schema.org - ContactPoint"] = 687,
    ["schema.org - Place"] = 688,
    ["schema.org - Thing"] = 689,
    ["secrethub.yml"] = 998,
    ["semantic-release"] = 695,
    ["servicehub.config.json"] = 853,
    ["servicehub.service.json"] = 852,
    ["settings.job"] = 698,
    ["sfdx-hardis configuration"] = 700,
    ["shard.yml"] = 1036,
    ["size-limit configuration"] = 705,
    ["skaffold.yaml"] = 921,
    ["skyuxconfig.json"] = 707,
    snapcraft = 708,
    ["snowflake-config"] = 709,
    ["snowflake-connections"] = 710,
    ["spicepod.yaml"] = 1056,
    ["sqlc configuration"] = 741,
    ["stripe-app-local.json"] = 752,
    ["stripe-app.json"] = 751,
    swcrc = 906,
    ["task.json"] = 761,
    taskcat = 871,
    ["template.json"] = 766,
    ["templatsources.json"] = 767,
    ["theme.json"] = 770,
    ["tizen_workspace.json"] = 772,
    tldr = 773,
    ["tm_devices configuration file"] = 1119,
    tmuxinator = 856,
    ["transcend.yml"] = 783,
    ["tree-sitter grammar.json"] = 374,
    ["trime.yaml"] = 784,
    ["trunk.yaml"] = 786,
    ["ts-force-config.json"] = 791,
    ["tsconfig.json"] = 787,
    ["tsd.json"] = 788,
    ["tsdoc.json"] = 789,
    ["tsdrc.json"] = 790,
    ...
    ["vega-lite.json"] = 815,
    ["vega.json"] = 814,
    ["venvironment-basic.yaml"] = 818,
    ["venvironment.yaml"] = 817,
    ["venvplus-basic.yaml"] = 820,
    ["venvplus.yaml"] = 819,
    version = 1101,
    ["version.json"] = 822,
    ["vhwdebugger-binding.yaml"] = 824,
    ["vim-addon-info"] = 825,
    ["vs-2017.3.host.json"] = 827,
    ["vs-nesting.json"] = 828,
    ["vsls.json"] = 826,
    ["vss-extension.json"] = 832,
    vtcfg = 1107,
    ["vtesttree.yaml"] = 833,
    ["vtestunit.yaml"] = 834,
    ["warp-keysets.json"] = 1004,
    ["warp-themes.json"] = 1005,
    ["warp-workflows.json"] = 1006,
    ["webhint.io"] = 961,
    ["webjobpublishsettings.json"] = 839,
    ["webjobs-list.json"] = 838,
    ["well-known-fursona"] = 1043,
    ["xs-app.json"] = 866,
    ["xunit.runner.json"] = 851,
    yamllint = 894,
    zuul = 877,
    ["Žinoma"] = 887
  },
