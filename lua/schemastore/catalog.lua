...
M.json = {
  ...
  index = {
    ...
    AIConfig = 45,
    ["AMX Muse Program Descriptor"] = 1288,
    ["API Builder"] = 1094,
    ["AVA Configuration"] = 1158,
    ...
    ["AWS Copilot Manifest"] = 1327,
    ["AWS SAM CLI Samconfig"] = 304,
    Acton = 1378,
    ["Adobe UXP Manifest"] = 1221,
    ["Aerleon Network & Service Definitions"] = 27,
    ["Aerleon Policy"] = 28,
    ["Agent Permission Policy"] = 1367,
    ["AgentCore CLI"] = 1368,
    AgentLoopKit = 1369,
    Aider = 1317,
    Air = 30,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1338,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1337,
    ["Airlock Microgateway"] = 46,
    ["Alacritty Configuration"] = 1130,
    ["AlgoVoi Compliance Receipt v1"] = 16,
    ["All Contributors configuration file"] = 1184,
    ...
    ["Application list for a WinUtil"] = 1267,
    ArchitectFX = 1272,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1336,
    ["Azure IoT Operations connector metadata"] = 1333,
    ...
    ["Azure Pipelines"] = 129,
    ["Azure Static Web Apps CLI configuration file"] = 932,
    ["Azure Static Web Apps configuration file"] = 931,
    BMML = 1355,
    ["BOSH BPM Config"] = 155,
    ["BOSH CPI Config"] = 156,
    ...
    ["Bacon config"] = 10,
    ["Barba-CV"] = 95,
    ["Bashly (bashly.yml)"] = 1188,
    ["Bashly Settings (bashly-settings.yml)"] = 1189,
    Bento = 1354,
    ["Better Code Hub"] = 1099,
    ["Better Scripts"] = 179,
    Bigconfig = 148,
    ["Biome Formatter Config"] = 96,
    ["Bitmovin Encoding Template"] = 1281,
    BizTalkServerApplicationSchema = 1065,
    Bleep = 180,
    ["Block Protocol Metadata"] = 177,
    ["Bluebricks blueprint config"] = 1360,
    ["Boyka Framework"] = 158,
    ...
    ["Butane Config"] = 1143,
    C4InterFlow = 1296,
    ["CDK Environment Manager, concrete environment configuration"] = 1320,
    ["CDK Environment Manager, concrete environments definition"] = 1319,
    ["CDK Environment Manager, environment definition"] = 1318,
    ["CGS Card Game Specification (cgs.json)"] = 1226,
    ["CICS TS region tagging"] = 1152,
    ["CICS TS resource import"] = 1153,
    ["CICS TS resource model"] = 1154,
    ["CICS TS resource overrides"] = 1155,
    ["CMake Presets"] = 181,
    ["CNC Codes"] = 204,
    ["CRS WAF test file"] = 1256,
    ["CRS WAF test platform overrides file"] = 1257,
    ...
    ["Caido Proxy Configuration"] = 1393,
    ...
    ["Chamaleon environment"] = 1285,
    ["Chamaleon properties"] = 1286,
    ["Chamaleon template"] = 1284,
    Changepacks = 1347,
    Changesets = 313,
    Changie = 190,
    Charmcraft = 191,
    ...
    ["Claude Code Launch Preview"] = 1402,
    ["Claude Code Plugin Manifest"] = 212,
    ["Claude Code Plugin Marketplace"] = 213,
    ["Claude Code Settings"] = 214,
    ["Clawject config"] = 210,
    ["Cloud Foundry Application Manifest"] = 1238,
    ["Cloud Run Spec v1"] = 1262,
    ...
    Concord = 1255,
    ["Configu .cfgu files"] = 1243,
    ["Configu .configu file"] = 1244,
    Conjure = 203,
    ["Container Structure Test"] = 1079,
    Containerlab = 1108,
    ["Contextive Glossary"] = 1312,
    ContractGuard = 1109,
    Convex = 202,
    ...
    ["Cursor Agent Environment"] = 1365,
    ["Custom Machinery Machine"] = 1227,
    ["Custom Machinery Recipe"] = 1228,
    ...
    ["DonateCaseBetterCasino menu"] = 1289,
    ["Draugr Saga"] = 342,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1196,
    ["EAS config"] = 416,
    ["ECA - Editor Code Assistant"] = 379,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1185,
    ["ESLint Suppressions"] = 421,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1332,
    ["EasyVCR .NET"] = 418,
    ["Eidolon Resource"] = 1273,
    ...
    ["Envelope Team Definition"] = 1377,
    ["Envilder Map File"] = 384,
    ["Erda Pipeline"] = 1234,
    ["Erda Runtime"] = 1235,
    ["Espanso config.yml"] = 1358,
    ["Espanso match.yml"] = 1357,
    Esquio = 404,
    ["Estuary Flow Catalog"] = 1149,
    ["Ethereum ERC1155"] = 1371,
    ["Ethereum ERC721"] = 1370,
    ...
    ["Evolving Resolutive Process notation"] = 1334,
    ["Expo SDK"] = 415,
    ...
    ["GeoJSON.json latest"] = 1147,
    GherKing = 1151,
    ["GitHub Action"] = 458,
    ["GitHub Actions typing"] = 1269,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 1223,
    GitResume = 474,
    GitVersion = 452,
    ...
    ["Google Digital Assetlinks"] = 1313,
    Goreleaser = 493,
    ["Goreleaser Pro"] = 494,
    Goss = 496,
    ["Gradle Build Cache Node"] = 1097,
    ["Gradle Enterprise"] = 1096,
    ...
    Hadolint = 1075,
    Hammerkit = 1107,
    ["Hardware Sentry Configuration"] = 1163,
    ...
    ["Hecate Input Schema"] = 1324,
    ["Helm Chart.lock"] = 262,
    ["Helm Chart.yaml"] = 261,
    ["Helm Unittest Test Suite"] = 263,
    ["Heloisa Assistant Plugins Marketplace"] = 1400,
    ["Hex file"] = 264,
    ...
    ["JFrog File Spec"] = 552,
    ["JFrog Pipelines YML DSL"] = 1173,
    ["JMeter DSL cli config"] = 553,
    JReleaser = 556,
    ["JSON Document Transform"] = 564,
    ["JSON Feed"] = 565,
    ["JSON Resume"] = 838,
    ["JSON Schema Draft 2020-12"] = 1041,
    ["JSON Schema Draft 4"] = 1038,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1206,
    ["JSON Schema Draft 7"] = 1039,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1207,
    ["JSON Schema Draft 8 (2019-09)"] = 1040,
    ["JSON-API"] = 563,
    ["JSON-e templates"] = 1104,
    ["JSON-stat 2.0"] = 1034,
    JSONPatch = 567,
    ...
    ["Jujutsu (jj) VCS config"] = 1326,
    ["KIMMDY config file"] = 578,
    ["KODE/CI build.yaml"] = 1169,
    ["KSP-AVC"] = 1035,
    ["KSP-CKAN"] = 1036,
    ["KSP-NetKAN"] = 1037,
    KSY = 1236,
    ...
    ["Kong DBLess config"] = 1170,
    KrakenD = 582,
    ["Kubri Configuration"] = 590,
    LOOBin = 606,
    ["Lake configuration file"] = 1329,
    ...
    ["Lando (landofile)"] = 122,
    ["LangGraph Platform configuration"] = 1248,
    ["Language configuration"] = 1247,
    Lefthook = 595,
    ["Liferay client-extension.yaml"] = 602,
    ["LinkML Metamodel"] = 604,
    Liquibase = 1114,
    ["Liquibase Flow File"] = 1115,
    ...
    ["Madness (madness.yml)"] = 1187,
    ["Mado configuration"] = 613,
    ["Maestro Flow"] = 614,
    ["Mail Servers Configuration"] = 1361,
    ["MapEHR Mapping"] = 615,
    Markdownlint = 1118,
    ["Mason Registry"] = 1121,
    ...
    ["Metadata for a Cinnamon spice"] = 1265,
    ["Metatype Configuration"] = 622,
    ["MetricsHub Configuration"] = 623,
    ["MetricsHub Connector Configuration"] = 624,
    ["Micro Editor Syntax"] = 1197,
    ["Microsoft Band Web Tile"] = 625,
    ["Microsoft RulesEngine workflow rules"] = 1252,
    ["Microsoft RulesEngine workflow rules list"] = 1253,
    ["Minecraft Custom Main Menu Mod"] = 1215,
    ...
    ["MongoDB Atlas Search Index Definition"] = 1168,
    ["Monika Configuration"] = 1166,
    ["Monoweave Configuration"] = 656,
    ["Motif config"] = 1057,
    MultiQC = 1306,
    ["NOX Framework (Service)"] = 684,
    ["Netin Diagnostic System Template"] = 1125,
    ["Netlify config"] = 665,
    ...
    ["Nightwatch.js"] = 676,
    ["Nika workflow"] = 681,
    ["Node.js configuration"] = 1062,
    ["NueJS configuration file"] = 689,
    ["Nuitka Package Config"] = 1229,
    ...
    ["OpenUtau ustx"] = 710,
    ["OpenWeather Current Weather API"] = 1103,
    ["OpenWeather Road Risk API"] = 1102,
    ...
    ["Pipeline component"] = 1116,
    ["Platform.sh application"] = 12,
    ["Platform.sh routes"] = 13,
    ["Platform.sh services"] = 14,
    ["Plex Prerolls"] = 755,
    ["PocketMine plugin.yml"] = 752,
    ["Podman Desktop Extension"] = 1395,
    ["Postman collection"] = 761,
    ["Power Pages Configuration"] = 1323,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1268,
    ...
    Pylock = 1314,
    Pyright = 809,
    ["Python script metadata"] = 1308,
    ["QType AI DSL"] = 812,
    Qgoda = 811,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1387,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1385,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1391,
    ["Qlik Talend Cloud Pipeline - Project"] = 1383,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1386,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1388,
    ["Qlik Talend Cloud Pipeline - Task"] = 1384,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1390,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1389,
    Qodana = 1135,
    ["Qt Creator workspace file"] = 1245,
    ["Quali Torque Blueprint Spec 2"] = 1160,
    ["QueryFirst config file"] = 1179,
    ["QuikRun Configuration"] = 1392,
    ["Qwen Code Settings"] = 1372,
    ["RKE Cluster Configuration JSON"] = 1113,
    ["RKE Cluster Configuration YAML"] = 1112,
    RadioHound = 802,
    ["Raid Profile"] = 1373,
    ["Raid Repo Configuration"] = 1374,
    Railpack = 814,
    Railway = 813,
    ["Rancher Fleet"] = 804,
    ["Rattler-build"] = 815,
    ...
    ["Replit config"] = 830,
    Restate = 1301,
    ["Revel Digital Gadget Definition File"] = 1325,
    RoadRunner = 844,
    ["Robust Station Image"] = 1331,
    Rockcraft = 845,
    ["Roo Coder Custom Modes"] = 846,
    Rubocop = 835,
    ["Rudder techniques"] = 1219,
    Ruff = 836,
    ["Rust Project"] = 837,
    ["Rust toolchain"] = 851,
    ...
    ["Serverless Framework Configuration"] = 1129,
    ["Serverless Workflow"] = 1131,
    ["Settings for a Cinnamon spice"] = 1264,
    ["Settings.paf"] = 885,
    ["Shopware 6 Configuration"] = 1132,
    ["Shopware CLI Extension Store Configuration"] = 1133,
    ["Shopware CLI Project Store Configuration"] = 1134,
    ["Sigma Detection Rule"] = 887,
    ["SigmaCV CV"] = 4,
    ["Sigrid scope configuration file"] = 888,
    ["SkyPilot Task JSON"] = 1220,
    ["Slack app manifest"] = 892,
    ["Slang Server Configuration"] = 1399,
    Snapcraft = 894,
    ["Solarxy project config"] = 897,
    Solidarity = 898,
    ["Solution filters"] = 899,
    ["Source Maps v3"] = 900,
    Sourcery = 901,
    ["Spack bootstrap.yaml"] = 902,
    ["Spack cdash.yaml"] = 903,
    ["Spack ci.yaml"] = 904,
    ["Spack compilers.yaml"] = 905,
    ["Spack concretizer.yaml"] = 906,
    ["Spack config.yaml"] = 907,
    ["Spack definitions.yaml"] = 908,
    ["Spack develop.yaml"] = 909,
    ["Spack env_vars.yaml"] = 910,
    ["Spack environment"] = 916,
    ["Spack include.yaml"] = 911,
    ["Spack mirrors.yaml"] = 912,
    ["Spack modules.yaml"] = 913,
    ["Spack packages.yaml"] = 914,
    ["Spack repos.yaml"] = 915,
    ["Spack toolchains.yaml"] = 917,
    ["Spack upstreams.yaml"] = 918,
    ["Spack view.yaml"] = 919,
    ["Speakeasy Generation Config File"] = 923,
    ["Speakeasy Lint Configuration File"] = 920,
    ["Speakeasy Test Generation Configuration File"] = 921,
    ["Speakeasy Workflow File"] = 922,
    SpecIF = 924,
    ["Specmatic Configuration"] = 925,
    ["Specpin spec file"] = 2,
    ["Sponge Mixin configuration"] = 926,
    ["Spotlight Ruleset"] = 927,
    StackBlitz = 933,
    ["StackHawk Scanner Configuration"] = 1128,
    Stale = 934,
    Starfish = 935,
    ["Starlake Data Pipeline"] = 1100,
    Starship = 936,
    ["Statamic Blueprint"] = 937,
    ["Stella configuration file"] = 938,
    ["Streamlit configuration file"] = 939,
    ["Stryker Mutator"] = 942,
    ["StyleCop Analyzers Configuration"] = 943,
    ["Stylelint (.stylelintrc)"] = 944,
    ["Stylua Config"] = 1315,
    ["Sublime Syntax"] = 1175,
    ["Subsquid squid manifest"] = 1222,
    ["Swagger API 2.0"] = 946,
    ["Synadia Connect Component"] = 947,
    TSON = 984,
    TSTyche = 985,
    ["TYPO3 Vendor Bundler config"] = 991,
    ["Tab data for a LinUtil"] = 1271,
    ["Tab list for a LinUtil"] = 1270,
    Tach = 948,
    ["Tach Domain"] = 949,
    Talhelper = 951,
    ["Talisman configuration"] = 952,
    Taplo = 1316,
    ["Taskfile config"] = 1105,
    Taurus = 953,
    Tauticord = 954,
    ["Tekton Pipeline"] = 1344,
    ["Tekton PipelineRun"] = 1345,
    ["Tekton Task"] = 1342,
    ["Tekton TaskRun"] = 1343,
    Telefonistka = 1302,
    ["Terrateam config"] = 1328,
    ["TestEnvironment.json"] = 966,
    ["TextMate Grammar"] = 965,
    Threagile = 960,
    ["Tier.run pricing.json"] = 957,
    Tikibase = 958,
    Tombi = 963,
    ["Traefik v2"] = 969,
    ["Traefik v2 File Provider"] = 970,
    ["Traefik v3"] = 971,
    ["Traefik v3 File Provider"] = 972,
    ["Travis CI (.travis.yml)"] = 968,
    Treefmt = 499,
    Trident = 1298,
    Trivy = 975,
    ["TrueScript for *.tscript files"] = 976,
    ["Tugboat QA config.yml"] = 1295,
    TunnelHub = 1210,
    Turborepo = 967,
    Tycho = 1259,
    Tye = 1136,
    ["Tyk Gateway - Open Source v5.7+"] = 1307,
    ["UET BuildConfig.json"] = 1180,
    ["UI5 Manifest"] = 997,
    ["UNCORS configuration"] = 1002,
    ["UTAM Page Object"] = 1000,
    ["Ubuntu Server Autoinstall"] = 995,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1299,
    ["Uniswap Token List"] = 1085,
    ["Universal Schedule Format"] = 1003,
    ["Unreal Engine Uplugin"] = 1181,
    ["Unreal Engine Uproject"] = 1182,
    ["UpCloud CLI (upctl) configuration"] = 1300,
    ["Updatecli Compose"] = 1144,
    ["Updatecli Policy Manifest"] = 1145,
    ["Updatecli Policy Metadata"] = 1146,
    Uplift = 1178,
    ["Upsun config"] = 11,
    ["User Journey Map"] = 1110,
    V2Ray = 1150,
    ["VSCode Code Snippets"] = 288,
    ["VSIX CLI publishing"] = 1021,
    Vector = 1005,
    ["Vela Pipeline Configuration"] = 1008,
    Vercel = 287,
    ["Version Bumper config"] = 1011,
    Vespertide = 1349,
    ["Vespertide Migration"] = 1350,
    ["Vespertide Model"] = 1351,
    ["Viash Component Config"] = 1304,
    ["Viash Package Config"] = 1305,
    Visivo = 1208,
    ["WP-CLI"] = 1031,
    Wake = 1297,
    ["Waku Config"] = 1274,
    ["Web App Manifest"] = 1027,
    ["Web types"] = 1030,
    WebExtensions = 1026,
    ["Webman package recipe"] = 1156,
    ["Windows Package Manager Installer Manifest"] = 1082,
    ["Windows Package Manager Locale Manifest"] = 1083,
    ["Windows Package Manager Singleton Manifest"] = 1081,
    ["WireMock CLI import configuration"] = 1280,
    ["WireMock CLI local service configuration"] = 1279,
    ["WireMock message stub mapping"] = 1278,
    ["WireMock stub mapping"] = 1277,
    ["Woodpecker pipeline config"] = 1124,
    ["Wrangler CLI"] = 1032,
    ["XenForo add-on manifest"] = 1033,
    ["Xstate Machine"] = 1142,
    ["Yandex Workflow Language"] = 1266,
    ["Yarn Config (.yarnrc.yml)"] = 1098,
    ["Yippee-Ki-JSON configuration YML"] = 1089,
    ["YouTrack App"] = 1263,
    ["Zarf Package Configuration"] = 1330,
    ["Zerops import file"] = 1251,
    ["Zola Configuration"] = 1341,
    abtop = 32,
    act3 = 1379,
    actionlint = 42,
    ["aerleon.yml"] = 26,
    ["amplify.yml"] = 19,
    ["amxx-builder manifest"] = 1394,
    ["angular.json"] = 47,
    apko = 1213,
    ...
    ["behat.yml"] = 159,
    ["bigquery-table"] = 147,
    ["bioimageio resource description"] = 1230,
    ...
    ["chutzpah.json"] = 296,
    cibuildwheel = 197,
    ["clang-format (.clang-format)"] = 1148,
    ["clang-tidy"] = 270,
    clangd = 269,
    clib = 271,
    ...
    ["crowdin.yml"] = 323,
    ["ctfd-setup configuration file"] = 1287,
    ["custom-elements.json"] = 1200,
    ["cypress.json"] = 327,
    ["dacier.yml"] = 1382,
    ...
    ["gematik health care insurance list"] = 1293,
    ["gematik health care patient list"] = 1290,
    ["gematik health care provider institution list"] = 1292,
    ["gematik health care provider list"] = 1291,
    ["gematik tiger test environment configuration"] = 1294,
    ["gh-dash"] = 457,
    ["git-cliff"] = 454,
    ["git-town.toml"] = 1339,
    ["gitlab-ci"] = 471,
    ...
    lychee = 1049,
    ["macro.json"] = 1165,
    ["markdown-link-check"] = 1119,
    maturin = 1120,
    mboats = 1127,
    memnex = 1380,
    ["micro-settings.json"] = 1192,
    ["mimetypes.json"] = 626,
    ["mirrord config"] = 1053,
    ["misata.yaml"] = 1052,
    mise = 1054,
    ["mkdocs.yml"] = 646,
    ["mockd.yaml"] = 650,
    ["mod.pw.toml (packwiz)"] = 1397,
    ["modelparams.dev Model"] = 653,
    ["models CLI"] = 654,
    ["monospace.yml"] = 655,
    ["moon.yml"] = 1276,
    ["mprocs Configuration file"] = 1246,
    ["mrdocs.yml"] = 648,
    ["mta.yaml"] = 1055,
    ["mtad.yaml"] = 1056,
    ["mycode.json"] = 663,
    ...
    ["plagiarize.yaml"] = 753,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1283,
    ["podbard.yaml"] = 756,
    ["portman.json"] = 759,
    ["prefect.toml"] = 768,
    ["prefect.yaml"] = 769,
    ...
    ["servicehub.config.json"] = 1044,
    ["servicehub.service.json"] = 1043,
    ["settings.job"] = 884,
    ["sfdx-hardis configuration"] = 886,
    ["shard.yml"] = 1233,
    ["size-limit configuration"] = 891,
    ["skaffold.yaml"] = 1117,
    ["skyuxconfig.json"] = 893,
    ["snowflake-config"] = 895,
    ["snowflake-connections"] = 896,
    ["spicepod.yaml"] = 1254,
    ["sqlc configuration"] = 930,
    ["stripe-app-local.json"] = 941,
    ["stripe-app.json"] = 940,
    swcrc = 1101,
    ["task.json"] = 950,
    taskcat = 1064,
    ["template.json"] = 955,
    ["templatsources.json"] = 956,
    ["text2confl config"] = 1364,
    ["theme.json"] = 959,
    ["tizen_workspace.json"] = 961,
    tldr = 962,
    ["tm_devices configuration file"] = 1321,
    tmuxinator = 1047,
    tox = 964,
    ["transcend.yml"] = 973,
    ...
    ["vega-lite.json"] = 1007,
    ["vega.json"] = 1006,
    ["venvironment.yaml"] = 1009,
    ["venvplus.yaml"] = 1010,
    version = 1303,
    ["version.json"] = 1012,
    ["vhwdebugger-binding.yaml"] = 1014,
    ["vim-addon-info"] = 1015,
    ["vs-2017.3.host.json"] = 1017,
    ["vs-nesting.json"] = 1018,
    ["vsls.json"] = 1016,
    ["vss-extension.json"] = 1022,
    vtcfg = 1309,
    ["vtesttree.yaml"] = 1023,
    ["vtestunit.yaml"] = 1024,
    ["warp-keysets.json"] = 1201,
    ["warp-themes.json"] = 1202,
    ["warp-workflows.json"] = 1203,
    ["webhint.io"] = 1157,
    ["webjobpublishsettings.json"] = 1029,
    ["webjobs-list.json"] = 1028,
    ["well-known-fursona"] = 1241,
    ["xs-app.json"] = 1059,
    ["xunit.runner.json"] = 1042,
    yamlfmt = 1086,
    yamllint = 1087,
    ["yap.json"] = 1088,
    ["zerops.yml"] = 1250,
