...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 91,
    [".cryproj (generic)"] = 381,
    [".cryproj engine-5.2"] = 376,
    [".cryproj engine-5.3"] = 377,
    [".cryproj engine-5.4"] = 378,
    [".cryproj engine-5.5"] = 379,
    [".cryproj engine-dev"] = 380,
    [".csscomb.json"] = 93,
    [".csslintrc"] = 94,
    [".eslintrc"] = 127,
    [".esmrc.json"] = 121,
    ...
    [".mtaext"] = 387,
    [".nodehawkrc"] = 229,
    [".npmpackagejsonlintrc"] = 231,
    [".phraseapp.yml"] = 258,
    [".pmbot.yml"] = 251,
    [".postcssrc"] = 256,
    [".pre-commit-config.yml"] = 257,
    [".putout.json"] = 275,
    [".rehyperc"] = 280,
    [".remarkrc"] = 281,
    [".sprite files"] = 315,
    ...
    [".vsext"] = 357,
    [".yarnrc.yml"] = 419,
    ["<div>RIOTS' studio configuration"] = 360,
    ["API Builder"] = 416,
    ["AWS CloudFormation"] = 81,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 82,
    ["Airlock Microgateway"] = 5,
    ["Ansible Collection Galaxy"] = 11,
    ...
    ["Argo Workflows"] = 21,
    ["Avro Avsc"] = 23,
    ["Azure IoT Edge deployment"] = 26,
    ["Azure IoT Edge deployment template"] = 27,
    ["Azure IoT EdgeAgent deployment"] = 24,
    ["Azure IoT EdgeHub deployment"] = 25,
    ["Azure Pipelines"] = 28,
    ["Azure Static Web Apps CLI configuration file"] = 317,
    ["Azure Static Web Apps configuration file"] = 316,
    ["Better Code Hub"] = 421,
    BizTalkServerApplicationSchema = 393,
    Briefcase = 398,
    Buildkite = 49,
    ["Bukkit plugin.yml"] = 48,
    ["BungeeCord plugin.yml"] = 52,
    ["CMake Presets"] = 54,
    ["Camel YAML DSL"] = 55,
    Carafe = 56,
    ["Catalog Info Backstage"] = 57,
    ["Chrome Extension"] = 75,
    ["CircleCI config.yml"] = 61,
    ["Citation File Format"] = 83,
    CityJSON = 58,
    ["Code Climate"] = 62,
    ["Container Structure Test"] = 404,
    Containerlab = 429,
    ["Dart build configuration"] = 95,
    ["Dart test config"] = 96,
    ["Deployer Recipe"] = 102,
    ["Discord Webhook"] = 104,
    ["Dolittle Artifacts"] = 106,
    ["Dolittle Bounded Context Configuration"] = 107,
    ["Dolittle Event Horizons Configuration"] = 108,
    ["Dolittle Resources Configuration"] = 109,
    ["Dolittle Server Configuration"] = 110,
    ["Dolittle Tenant Map Configuration"] = 112,
    ["Dolittle Tenants Configuration"] = 111,
    ["Dolittle Topology"] = 113,
    ["Drush site aliases"] = 116,
    ["Eclipse Che Devfile"] = 119,
    Esquio = 122,
    ["Expo SDK"] = 126,
    ["F-Droid Data metadata"] = 130,
    ["Facets - FSDL - Application"] = 128,
    ["Fossa configuration file"] = 135,
    ["Foundry VTT - Manifest"] = 133,
    ["Foundry VTT - Template"] = 134,
    ["Foxx Manifest"] = 29,
    ["GatewayCore API Gateway"] = 138,
    ["GitHub Action"] = 142,
    ["GitHub Funding"] = 143,
    ["GitHub Issue Template configuration"] = 145,
    ["GitHub Workflow"] = 146,
    ["GitHub Workflow Template Properties"] = 147,
    ["GitHub issue forms"] = 144,
    GitVersion = 141,
    ["Gitpod Configuration"] = 149,
    ["Global Privacy Control"] = 139,
    ["Google Cloud Workflows"] = 80,
    Goreleaser = 152,
    ["Goreleaser Pro"] = 153,
    ["Gradle Build Cache Node"] = 418,
    ["Gradle Enterprise"] = 417,
    ["Grafana 5.x Dashboard"] = 154,
    ["GraphQL Code Generator"] = 157,
    ["GraphQL Config"] = 156,
    ["GraphQL Mesh"] = 155,
    ["Grunt JSHint task"] = 161,
    ["Grunt Watch task"] = 162,
    ["Grunt base task"] = 163,
    ["Grunt clean task"] = 159,
    ["Grunt copy task"] = 158,
    ["Grunt cssmin task"] = 160,
    HEMTT = 390,
    Hadolint = 402,
    ["Hammerkit YAML Schema"] = 428,
    Hayson = 165,
    ["Hazelcast 5 Configuration"] = 166,
    ["Helm Chart.lock"] = 60,
    ["Helm Chart.yaml"] = 59,
    ["JFrog File Spec"] = 178,
    ["JSON Document Transform"] = 186,
    ["JSON Feed"] = 187,
    ["JSON Resume"] = 283,
    ["JSON Schema Draft 2020-12"] = 372,
    ["JSON Schema Draft 4"] = 369,
    ["JSON Schema Draft 7"] = 370,
    ["JSON Schema Draft 8"] = 371,
    ["JSON schema for CodeShip Pro services configuration files"] = 68,
    ["JSON schema for CodeShip Pro steps configuration files"] = 69,
    ["JSON schema for Codecov configuration files"] = 67,
    ["JSON-API"] = 185,
    ["JSON-e templates"] = 426,
    ["JSON-stat 2.0"] = 366,
    JSONPatch = 189,
    ["Jekyll configuration"] = 175,
    ["Jenkins X Pipelines"] = 176,
    ["Jenkins X Requirements"] = 177,
    ["Jovo Language Models"] = 179,
    ["KSP-AVC"] = 367,
    ["KSP-CKAN"] = 368,
    Liquibase = 433,
    ["MegaLinter configuration"] = 203,
    ["MegaLinter descriptor"] = 204,
    ["Meltano project definition"] = 205,
    ["Microsoft Band Web Tile"] = 206,
    ["Minecraft Data Pack Advancement"] = 208,
    ["Minecraft Data Pack Biome"] = 209,
    ["Minecraft Data Pack Configured Carver"] = 210,
    ["Minecraft Data Pack Dimension"] = 212,
    ["Minecraft Data Pack Dimension Type"] = 211,
    ["Minecraft Data Pack Item Modifier"] = 213,
    ["Minecraft Data Pack Loot Table"] = 214,
    ["Minecraft Data Pack Metadata"] = 215,
    ["Minecraft Data Pack Predicate"] = 216,
    ["Minecraft Data Pack Recipe"] = 217,
    ["Minecraft Data Pack Template Pool"] = 218,
    ["Minecraft Resourcepack Sounds"] = 219,
    ["Netin Diagnostic System Template"] = 440,
    ["Netlify config schema"] = 224,
    ["Nightwatch.js"] = 225,
    ["OSS Review Toolkit repository configuration"] = 245,
    Opctl = 389,
    ["OpenWeather Current Weather API"] = 425,
    ["OpenWeather Road Risk API"] = 424,
    ["Ory Hydra configuration"] = 170,
    ["Ory Keto configuration"] = 192,
    ["Ory Kratos configuration"] = 244,
    ["Ory Oathkeeper configuration"] = 236,
    ["Outblocks App configuration"] = 242,
    ["Outblocks database table"] = 243,
    ["Outblocks project configuration"] = 241,
    Packer = 248,
    ["Pipeline component"] = 434,
    ["PocketMine plugin.yml"] = 252,
    ["Pull Request Labeler"] = 274,
    ["RKE Cluster Configuration JSON Schema"] = 432,
    ["RKE Cluster Configuration YAML Schema"] = 431,
    Ray = 401,
    ["Read the Docs"] = 277,
    ["Red-DiscordBot Сog"] = 278,
    ["Red-DiscordBot Сog Repo"] = 279,
    Renovate = 284,
    RoadRunner = 285,
    SWADL = 325,
    ["Sapphire CLI Config"] = 286,
    ["SauceCTL Configuration"] = 437,
    ["Schema Catalog"] = 299,
    ["Scoop manifest"] = 304,
    ["Semgrep Rule"] = 305,
    ["Serverless Framework Configuration"] = 444,
    Solidarity = 311,
    ["Source Maps v3"] = 312,
    SpecIF = 313,
    ["Sponge Mixin configuration"] = 314,
    ["StackHawk Scanner Configuration"] = 443,
    ["StackHead CLI config"] = 318,
    ["StackHead module configuration"] = 319,
    ["StackHead project definition"] = 320,
    Stale = 321,
    ["Stryker Mutator"] = 322,
    ["StyleCop Analyzers Configuration"] = 323,
    ["Swagger API 2.0"] = 326,
    ["Taskfile YAML Schema"] = 427,
    Taurus = 327,
    ["TestEnvironment.json"] = 332,
    ["Traefik v2"] = 334,
    ["Traefik v2 File Provider"] = 335,
    ["UI5 Manifest"] = 346,
    ["Uniswap Token List"] = 410,
    ["User Journey Map YAML Schema"] = 430,
    ["VSCode Code Snippets"] = 70,
    ["VSIX CLI publishing"] = 358,
    ["Vela Pipeline Configuration"] = 350,
    ["Web App Manifest"] = 362,
    ["Web types"] = 365,
    WebExtensions = 361,
    ["Windows Package Manager Installer Manifest"] = 407,
    ["Windows Package Manager Locale Manifest"] = 408,
    ["Windows Package Manager Singleton Manifest"] = 406,
    ["Woodpecker pipeline config"] = 439,
    ["Yippee-Ki-JSON configuration YML"] = 412,
    ["angular.json"] = 6,
    ["app-definition.yaml"] = 14,
    ["apple-app-site-association"] = 13,
    ["appsettings.json"] = 17,
    ["appsscript.json"] = 16,
    ["appveyor.yml"] = 18,
    ["arc.json"] = 20,
    ["architect.yml"] = 19,
    ["artifacthub-repo.yml"] = 22,
    ["babelrc.json"] = 31,
    ["bamboo-spec"] = 34,
    ["batect.yml"] = 33,
    ["beau.yml"] = 420,
    ["beef-database-codegen"] = 35,
    ["beef-entity-codegen"] = 36,
    ["behat.yml"] = 44,
    ["bigquery-table"] = 37,
    ["bitbucket-pipelines"] = 38,
    bitrise = 39,
    ["bitrise-step"] = 40,
    ["block.json"] = 53,
    ["bower.json"] = 42,
    ["bozr.suite.json"] = 45,
    ["browser.i18n.json"] = 46,
    bucklescript = 47,
    ["bundleconfig.json"] = 51,
    ["chutzpah.json"] = 76,
    ["cloud-sdk-pipeline-config-schema"] = 78,
    ["cloudbuild.json"] = 79,
    cloudify = 65,
    codemagic = 66,
    ["coffeelint.json"] = 84,
    comet = 422,
    ["commands.json"] = 73,
    ["compile_commands.json"] = 72,
    ["compilerconfig.json"] = 71,
    ["component.json"] = 86,
    ["composer.json"] = 85,
    ["config.json"] = 87,
    ["contentmanifest.json"] = 77,
    ["contribute.json"] = 88,
    ["cosmos.config.json"] = 74,
    ["crowdin.yml"] = 89,
    cspell = 92,
    ["cypress.json"] = 90,
    ["datalogic-scan2deploy-android"] = 97,
    ["datalogic-scan2deploy-ce"] = 98,
    ["debugsettings.json"] = 99,
    ["dependabot-v2.json"] = 101,
    ["dependabot.json"] = 100,
    ["detekt.yml"] = 103,
    devinit = 414,
    ["docfx.json"] = 105,
    ["docker-compose.yml"] = 413,
    ["dotnetcli.host.json"] = 114,
    ["drone.json"] = 115,
    ["dss-2.0.0.json"] = 117,
    ["dvc.yaml"] = 118,
    ["ecosystem.json"] = 120,
    ["electron-builder configuration file."] = 124,
    ["epr-manifest.json"] = 123,
    ["evcc.yaml"] = 125,
    ["fabric.mod.json"] = 129,
    ["first-timers-bot"] = 132,
    fulibWorkflows = 438,
    ["func.yaml"] = 136,
    ["function.json"] = 137,
    ["geojson.json"] = 140,
    ["gitlab-ci"] = 148,
    ["global.json"] = 150,
    ["golangci-lint Configuration"] = 151,
    ["haxelib.json"] = 164,
    helmfile = 403,
    ["host-meta.json"] = 168,
    ["host.json"] = 167,
    ...
    httpmockrc = 394,
    huskyrc = 383,
    ["imageoptimizer.json"] = 171,
    ["ioBroker JSON UI"] = 173,
    ["ioBroker Package manifest"] = 174,
    ["jsconfig.json"] = 190,
    jsdoc = 400,
    ["k3d.yaml"] = 191,
    ["kustomization.yaml"] = 193,
    ["label-commenter-config.yml"] = 194,
    ["launchsettings.json"] = 195,
    ["lerna.json"] = 196,
    ["lgtm.yml"] = 197,
    ["libman.json"] = 198,
    ["license-report-config.json"] = 199,
    ["local.settings.json"] = 200,
    ["localazy.json"] = 201,
    ["lsdlschema.json"] = 202,
    ["markdownlint.json"] = 436,
    mboats = 442,
    ["mimetypes.json"] = 207,
    ["mta.yaml"] = 385,
    ["mtad.yaml"] = 386,
    ["mycode.json"] = 222,
    ["napari plugin manifest"] = 223,
    neoload = 395,
    ["nest-cli"] = 227,
    ["ninjs (News in JSON)"] = 226,
    ["nlu.json"] = 228,
    ["nodemon.json"] = 230,
    ["noodl.schema.json"] = 441,
    now = 391,
    ["nswag.json"] = 234,
    ntangle = 235,
    ["nuclei-template.yaml"] = 232,
    ["nuget-project.json"] = 233,
    ["ocelot.json"] = 237,
    ["omnisharp.json"] = 238,
    ["openapi.json"] = 239,
    ["openfin.json"] = 240,
    ["package.json"] = 246,
    ["package.manifest"] = 247,
    ["pattern.json"] = 250,
    pgap_yaml_input_reader = 249,
    ["plagiarize-me.yaml"] = 254,
    ["plagiarize.yaml"] = 253,
    ["portman.json"] = 255,
    ["prettierrc.json"] = 259,
    ["prisma.yml"] = 260,
    ["project-1.0.0-beta3.json"] = 262,
    ["project-1.0.0-beta4.json"] = 263,
    ["project-1.0.0-beta5.json"] = 264,
    ["project-1.0.0-beta6.json"] = 265,
    ["project-1.0.0-beta8.json"] = 266,
    ["project-1.0.0-rc1.json"] = 267,
    ["project-1.0.0-rc2.json"] = 268,
    ["project.json"] = 261,
    ["prometheus.json"] = 269,
    ["prometheus.rules.json"] = 270,
    ["proxies.json"] = 271,
    ["publiccode.yml"] = 272,
    ["pubspec.yaml"] = 273,
    ["pyrseas-0.8.json"] = 276,
    ["release drafter"] = 396,
    ["sarif-1.0.0.json"] = 287,
    ["sarif-2.0.0.json"] = 288,
    ["sarif-2.1.0"] = 297,
    ["sarif-2.1.0-rtm.2"] = 289,
    ["sarif-2.1.0-rtm.3"] = 291,
    ["sarif-2.1.0-rtm.4"] = 293,
    ["sarif-2.1.0-rtm.5"] = 295,
    ["sarif-external-property-file-2.1.0"] = 298,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 290,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 292,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 294,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 296,
    ["schema.org - Action"] = 300,
    ["schema.org - ContactPoint"] = 301,
    ["schema.org - Place"] = 302,
    ["schema.org - Thing"] = 303,
    ["servicehub.config.json"] = 375,
    ["servicehub.service.json"] = 374,
    ["settings.job"] = 306,
    ["sfdx-hardis configuration"] = 307,
    ["size-limit configuration"] = 308,
    ["skaffold.yaml"] = 435,
    ["skyuxconfig.json"] = 309,
    snapcraft = 310,
    swcrc = 423,
    taskcat = 392,
    ["template.json"] = 328,
    ["templatsources.json"] = 329,
    ["theme.json"] = 330,
    tmLanguage = 331,
    ["trunk.yaml schema"] = 336,
    ["ts-force-config.json"] = 340,
    ["tsconfig.json"] = 337,
    ["tsd.json"] = 338,
    ["tsdrc.json"] = 339,
    ["tslint.json"] = 341,
    ...
    ["version.json"] = 351,
    ["vim-addon-info"] = 352,
    ["vs-2017.3.host.json"] = 354,
    ["vs-nesting.json"] = 355,
    ["vsls.json"] = 353,
    ["vss-extension.json"] = 359,
    ["webjobpublishsettings.json"] = 364,
    ["webjobs-list.json"] = 363,
    ["xs-app.json"] = 388,
    ["xunit.runner.json"] = 373,
    yamllint = 411,
    zuul = 397,
    ["Žinoma"] = 405
  },
