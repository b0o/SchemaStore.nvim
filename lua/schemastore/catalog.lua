...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 189,
    [".cryproj (generic)"] = 645,
    [".cryproj engine-5.2"] = 640,
    [".cryproj engine-5.3"] = 641,
    [".cryproj engine-5.4"] = 642,
    [".cryproj engine-5.5"] = 643,
    [".cryproj engine-dev"] = 644,
    [".csscomb.json"] = 191,
    [".csslintrc"] = 192,
    [".es6importsorterrc.json"] = 780,
    [".eslintrc"] = 243,
    [".esmrc.json"] = 235,
    [".ffizer.yaml"] = 248,
    [".htmlhintrc"] = 304,
    ...
    ["Airplane task"] = 15,
    ["Alacritty Configuration"] = 721,
    ["All Contributors configuration file"] = 779,
    ...
    ["Azure Pipelines"] = 65,
    ["Azure Static Web Apps CLI configuration file"] = 554,
    ["Azure Static Web Apps configuration file"] = 553,
    ["BX CI"] = 102,
    ["Better Code Hub"] = 692,
    ["Better Scripts"] = 103,
    Bigconfig = 82,
    BizTalkServerApplicationSchema = 662,
    Bleep = 104,
    ...
    ["Butane Config"] = 734,
    ["CICS TS region tagging"] = 743,
    ["CICS TS resource import"] = 744,
    ["CICS TS resource model"] = 745,
    ["CICS TS resource overrides"] = 746,
    ["CMake Presets"] = 105,
    ["CNC Codes"] = 117,
    ...
    ["Databricks Asset Bundles"] = 800,
    ["Datadog Service Definition"] = 344,
    ["Datahub Ingestion Recipe"] = 750,
    ["Dein Config"] = 123,
    Deno = 202,
    ["Deployer Recipe"] = 205,
    ["Deta Spacefile"] = 124,
    ...
    ["ESLint Plugin Partial"] = 244,
    ["Elgato Stream Deck"] = 234,
    ["Embrace Config"] = 761,
    Endurica = 803,
    ["Error pages"] = 238,
    Esquio = 236,
    ["Estuary Flow Catalog"] = 740,
    ["Expo SDK"] = 241,
    ...
    ["Frogbot Config"] = 71,
    ["Fusion resource pack metadata"] = 263,
    ["Fusion texture metadata"] = 264,
    ["G2P Mapping Configuration"] = 265,
    ["GCP Blueprint Metadata"] = 268,
    Gaspar = 266,
    ["GatewayCore API Gateway"] = 267,
    ["GeoJSON.json latest"] = 738,
    GherKing = 742,
    ["GitHub Action"] = 272,
    ...
    ["Goreleaser Pro"] = 286,
    Goss = 287,
    ["Gradle Build Cache Node"] = 690,
    ["Gradle Enterprise"] = 689,
    ...
    Hadolint = 671,
    Hammerkit = 699,
    ["Hardware Sentry Configuration"] = 754,
    Hatch = 672,
    Hayson = 299,
    ...
    ["JFrog File Spec"] = 324,
    ["JFrog Pipelines YML DSL"] = 763,
    ["JMeter DSL cli config"] = 325,
    JReleaser = 327,
    ["JSON Document Transform"] = 334,
    ["JSON Feed"] = 335,
    ["JSON Resume"] = 499,
    ["JSON Schema Draft 2020-12"] = 636,
    ["JSON Schema Draft 4"] = 633,
    ["JSON Schema Draft 7"] = 634,
    ["JSON Schema Draft 7 (unofficial strict)"] = 801,
    ["JSON Schema Draft 8 (2019-09)"] = 635,
    ["JSON-API"] = 333,
    ["JSON-e templates"] = 697,
    ["JSON-stat 2.0"] = 630,
    JSONPatch = 337,
    Jasmine = 317,
    Jekyll = 318,
    ...
    Kas = 340,
    ["Keycloak REST API"] = 771,
    ["Knative Functions - func.yaml"] = 261,
    ["KoDE/CI build.yaml"] = 759,
    ["Kong DBLess config"] = 760,
    KrakenD = 343,
    LOOBin = 362,
    Lefthook = 351,
    ...
    ["MongoDB Atlas Search Index Definition"] = 758,
    ["Monika Configuration"] = 756,
    ["Motif config"] = 655,
    ["NOX Framework (Service)"] = 411,
    ["Netin Diagnostic System Template"] = 714,
    ["Netlify config"] = 402,
    ["Network-as-Code Data Model"] = 403,
    ["Nightwatch.js"] = 404,
    ["ONe's changelog entry"] = 427,
    ["ONe's service descriptor"] = 426,
    ["OSS Review Toolkit configuration"] = 434,
    ["OSS Review Toolkit curation"] = 435,
    ["OSS Review Toolkit package configuration"] = 436,
    ["OSS Review Toolkit repository configuration"] = 437,
    ["OSS Review Toolkit resolutions"] = 438,
    Opctl = 658,
    ["OpenRewrite Resource"] = 429,
    ["OpenUtau character yaml"] = 423,
    ["OpenUtau ustx"] = 424,
    ["OpenWeather Current Weather API"] = 696,
    ["OpenWeather Road Risk API"] = 695,
    ["Ory Hydra configuration"] = 305,
    ["Ory Keto configuration"] = 345,
    ["Ory Kratos configuration"] = 433,
    ["Ory Oathkeeper configuration"] = 418,
    ["Outblocks App configuration"] = 431,
    ["Outblocks database table"] = 432,
    ["Outblocks project configuration"] = 430,
    PDM = 444,
    ["PDM Partial"] = 445,
    Packer = 441,
    Pantsbuild = 778,
    ["Paper paper-plugin.yml"] = 442,
    ["Partial-Setuptools"] = 535,
    ["Partial-poetry"] = 451,
    ["Pipeline component"] = 706,
    ...
    Qgoda = 488,
    Qodana = 726,
    ["Quali Torque Blueprint Spec 2"] = 751,
    ["QueryFirst config file"] = 774,
    ["RKE Cluster Configuration JSON"] = 703,
    ["RKE Cluster Configuration YAML"] = 702,
    ["Rancher Fleet"] = 481,
    Ray = 670,
    ["Read the Docs"] = 483,
    ["Red-DiscordBot Cog"] = 489,
    ["Red-DiscordBot Cog Repo"] = 490,
    ["Red-DiscordBot Trivia"] = 491,
    RenderCV = 501,
    Renovate = 500,
    ["Replit config"] = 495,
    RoadRunner = 502,
    ...
    ["Rust Project"] = 498,
    ["Rust toolchain"] = 505,
    ["SIL Kit Participant Configuration"] = 539,
    ["SIL Kit Registry Configuration"] = 540,
    SWADL = 565,
    ["Safebox Config"] = 764,
    ["Sapphire CLI Config"] = 508,
    ["SauceCTL Configuration"] = 711,
    ["Schema Catalog"] = 522,
    ["Scoop manifest"] = 527,
    ["Semantic Data Fabric (SDF) file"] = 528,
    ["Semgrep Rule"] = 530,
    ["Serenity Code Generator (Sergen)"] = 531,
    ["Serverless Framework Configuration"] = 720,
    ["Serverless Workflow"] = 722,
    ["Settings.paf"] = 533,
    Setuptools = 534,
    ["Shopware 6 Configuration"] = 723,
    ["Shopware CLI Extension Store Configuration"] = 724,
    ["Shopware CLI Project Store Configuration"] = 725,
    Sigma = 537,
    ["Sigrid scope configuration file"] = 538,
    ["SkyPilot Task JSON"] = 812,
    ["Slack app manifest"] = 542,
    Solidarity = 545,
    ["Solution filters"] = 546,
    ["Source Maps v3"] = 547,
    Sourcery = 548,
    SpecIF = 549,
    ["Sponge Mixin configuration"] = 550,
    StackBlitz = 555,
    ["StackHawk Scanner Configuration"] = 719,
    Stale = 556,
    ["Starlake Data Pipeline"] = 693,
    Starship = 557,
    ["Statamic Blueprint"] = 558,
    ["Stella configuration file"] = 559,
    ["StrmPrivacy Data Connector"] = 768,
    ["StrmPrivacy Data Contract"] = 769,
    ["StrmPrivacy SimpleSchema"] = 766,
    ["StrmPrivacy Stream"] = 767,
    ["StrmPrivacy batch job configuration file"] = 765,
    ["Stryker Mutator"] = 562,
    ["StyleCop Analyzers Configuration"] = 563,
    ["Sublime Syntax"] = 770,
    ...
    TSTyche = 592,
    Talhelper = 568,
    ["Talisman configuration"] = 569,
    ["Taskfile config"] = 698,
    Taurus = 570,
    ["TestEnvironment.json"] = 579,
    ["TextMate Grammar"] = 578,
    ["Tier.run pricing.json"] = 573,
    Tikibase = 574,
    ["Traefik v2"] = 582,
    ["Traefik v2 File Provider"] = 583,
    TunnelHub = 804,
    Turborepo = 580,
    Tye = 727,
    ["UET BuildConfig.json"] = 775,
    ["UI5 Manifest"] = 601,
    ["UNCORS configuration"] = 605,
    ["UTAM Page Object"] = 604,
    ["Ubuntu Server Autoinstall"] = 599,
    ["Uniswap Token List"] = 681,
    ["Unreal Engine Uplugin"] = 776,
    ["Unreal Engine Uproject"] = 777,
    ["Updatecli Compose"] = 735,
    ["Updatecli Policy Manifest"] = 736,
    ["Updatecli Policy Metadata"] = 737,
    Uplift = 773,
    ["User Journey Map"] = 701,
    V2Ray = 741,
    ["VSCode Code Snippets"] = 160,
    ["VSIX CLI publishing"] = 618,
    ["Vela Pipeline Configuration"] = 608,
    Vercel = 159,
    Visivo = 802,
    ["Web App Manifest"] = 625,
    ["Web types"] = 628,
    WebExtensions = 624,
    ["Webman package recipe"] = 747,
    ["Windows Package Manager Installer Manifest"] = 678,
    ["Windows Package Manager Locale Manifest"] = 679,
    ["Windows Package Manager Singleton Manifest"] = 677,
    ["Woodpecker pipeline config"] = 713,
    ["Wrangler CLI"] = 629,
    ["Xstate Machine"] = 733,
    ["Yippee-Ki-JSON configuration YML"] = 683,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 16,
    apko = 806,
    ...
    ["bamboo-spec"] = 76,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 784,
    ["bashly-strings.yml"] = 785,
    ["bashly.yml"] = 783,
    ["batect.yml"] = 75,
    ...
    ["lsdlschema.json"] = 366,
    ["madness.yml"] = 782,
    ["markdown-lint-check"] = 709,
    mboats = 716,
    ["micro-settings.json"] = 787,
    ["mimetypes.json"] = 373,
    ["mirrord config"] = 650,
    mise = 651,
    ["mise-settings"] = 652,
    ...
    ["mycode.json"] = 399,
    mypy = 400,
    ["napari plugin manifest"] = 401,
    neoload = 664,
    ["nest-cli"] = 407,
    ["ninjs (News in JSON) 1.3"] = 406,
    ["ninjs (News in JSON) 2.0"] = 405,
    ...
    ["nswag.json"] = 416,
    ntangle = 417,
    ["nuclei-template.yaml"] = 414,
    ["nuget-project.json"] = 415,
    ["ocelot.json"] = 419,
    ["omnisharp.json"] = 420,
    ["openapi.json"] = 421,
    ["openfin.json"] = 428,
    ...
    ["ops.yaml"] = 425,
    ["package.json"] = 439,
    ["package.manifest"] = 440,
    ["partial-cibuildwheel"] = 114,
    ["partial-scikit-build"] = 718,
    ["pathfinder.yml"] = 443,
    ["pattern.json"] = 447,
    ["petstore-v1.0"] = 762,
    ...
    ["quilt.mod.json"] = 788,
    ["release drafter"] = 665,
    ["release-plz.toml"] = 493,
    ["rivet.yaml"] = 809,
    rockcraft = 503,
    rustfmt = 504,
    samt = 506,
    samtrc = 507,
    ["sarif-1.0.0.json"] = 509,
    ["sarif-2.0.0.json"] = 510,
    ["sarif-2.1.0"] = 520,
    ["sarif-2.1.0-rtm.2"] = 511,
    ["sarif-2.1.0-rtm.3"] = 513,
    ["sarif-2.1.0-rtm.4"] = 515,
    ["sarif-2.1.0-rtm.5"] = 517,
    ["sarif-2.1.0-rtm.6"] = 518,
    ["sarif-external-property-file-2.1.0"] = 521,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 512,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 514,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 516,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 519,
    ["schema.org - Action"] = 523,
    ["schema.org - ContactPoint"] = 524,
    ["schema.org - Place"] = 525,
    ["schema.org - Thing"] = 526,
    ["scikit-build"] = 717,
    ["secrethub.yml"] = 790,
    ["semantic-release"] = 529,
    ["servicehub.config.json"] = 639,
    ["servicehub.service.json"] = 638,
    ["settings.job"] = 532,
    ["sfdx-hardis configuration"] = 536,
    ["size-limit configuration"] = 541,
    ["skaffold.yaml"] = 707,
    ["skyuxconfig.json"] = 543,
    snapcraft = 544,
    ["sqlc configuration"] = 552,
    ["stripe-app-local.json"] = 561,
    ["stripe-app.json"] = 560,
    swcrc = 694,
    syntax = 792,
    ["task.json"] = 567,
    taskcat = 661,
    ["template.json"] = 571,
    ["templatsources.json"] = 572,
    ["theme.json"] = 575,
    ["tizen_workspace.json"] = 576,
    tldr = 577,
    tmuxinator = 647,
    ["transcend.yml"] = 584,
    ["trunk.yaml"] = 585,
    ...
    ["version.json"] = 611,
    ["vim-addon-info"] = 612,
    ["vs-2017.3.host.json"] = 614,
    ["vs-nesting.json"] = 615,
    ["vsls.json"] = 613,
    ["vss-extension.json"] = 619,
    ["vtesttree.yaml"] = 620,
    ["vtestunit.yaml"] = 621,
    ["warp-keysets.json"] = 796,
    ["warp-themes.json"] = 797,
    ["warp-workflows.json"] = 798,
    ["webhint.io"] = 748,
    ["webjobpublishsettings.json"] = 627,
    ["webjobs-list.json"] = 626,
    ["xs-app.json"] = 657,
    ["xunit.runner.json"] = 637,
    yamllint = 682,
    zuul = 666,
    ["Žinoma"] = 676
  },
