...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 95,
    [".cryproj (generic)"] = 386,
    [".cryproj engine-5.2"] = 381,
    [".cryproj engine-5.3"] = 382,
    [".cryproj engine-5.4"] = 383,
    [".cryproj engine-5.5"] = 384,
    [".cryproj engine-dev"] = 385,
    [".csscomb.json"] = 97,
    [".csslintrc"] = 98,
    [".eslintrc"] = 131,
    [".esmrc.json"] = 125,
    ...
    [".mtaext"] = 392,
    [".nodehawkrc"] = 234,
    [".npmpackagejsonlintrc"] = 236,
    [".phraseapp.yml"] = 263,
    [".pmbot.yml"] = 256,
    [".postcssrc"] = 261,
    [".pre-commit-config.yml"] = 262,
    [".putout.json"] = 280,
    [".rehyperc"] = 285,
    [".remarkrc"] = 286,
    [".sprite files"] = 320,
    ...
    [".vsext"] = 362,
    [".yarnrc.yml"] = 424,
    ["<div>RIOTS' studio configuration"] = 365,
    ["API Builder"] = 421,
    ...
    ["Azure Pipelines"] = 32,
    ["Azure Static Web Apps CLI configuration file"] = 322,
    ["Azure Static Web Apps configuration file"] = 321,
    ["Better Code Hub"] = 426,
    BizTalkServerApplicationSchema = 398,
    Briefcase = 403,
    Buildkite = 53,
    ...
    Goreleaser = 156,
    ["Goreleaser Pro"] = 157,
    ["Gradle Build Cache Node"] = 423,
    ["Gradle Enterprise"] = 422,
    ...
    HEMTT = 395,
    Hadolint = 407,
    ["Hammerkit YAML Schema"] = 433,
    Hayson = 169,
    ["Hazelcast 5 Configuration"] = 170,
    ["Helm Chart.lock"] = 64,
    ["Helm Chart.yaml"] = 63,
    ["JFrog File Spec"] = 182,
    ["JSON Document Transform"] = 190,
    ["JSON Feed"] = 191,
    ["JSON Resume"] = 288,
    ["JSON Schema Draft 2020-12"] = 377,
    ["JSON Schema Draft 4"] = 374,
    ["JSON Schema Draft 7"] = 375,
    ["JSON Schema Draft 8"] = 376,
    ...
    ["JSON-API"] = 189,
    ["JSON-e templates"] = 431,
    ["JSON-stat 2.0"] = 371,
    JSONPatch = 193,
    ["Jekyll configuration"] = 179,
    ["Jenkins X Pipelines"] = 180,
    ["Jenkins X Requirements"] = 181,
    ["Jovo Language Models"] = 183,
    ["KSP-AVC"] = 372,
    ["KSP-CKAN"] = 373,
    Liquibase = 438,
    ["MegaLinter configuration"] = 207,
    ["MegaLinter descriptor"] = 208,
    ["Meltano plugin discovery definition"] = 210,
    ["Meltano project definition"] = 209,
    ["Microsoft Band Web Tile"] = 211,
    ["Minecraft Data Pack Advancement"] = 213,
    ["Minecraft Data Pack Biome"] = 214,
    ["Minecraft Data Pack Configured Carver"] = 215,
    ["Minecraft Data Pack Dimension"] = 217,
    ["Minecraft Data Pack Dimension Type"] = 216,
    ["Minecraft Data Pack Item Modifier"] = 218,
    ["Minecraft Data Pack Loot Table"] = 219,
    ["Minecraft Data Pack Metadata"] = 220,
    ["Minecraft Data Pack Predicate"] = 221,
    ["Minecraft Data Pack Recipe"] = 222,
    ["Minecraft Data Pack Template Pool"] = 223,
    ["Minecraft Resourcepack Sounds"] = 224,
    ["Netin Diagnostic System Template"] = 445,
    ["Netlify config schema"] = 229,
    ["Nightwatch.js"] = 230,
    ["OSS Review Toolkit repository configuration"] = 250,
    Opctl = 394,
    ["OpenWeather Current Weather API"] = 430,
    ["OpenWeather Road Risk API"] = 429,
    ["Ory Hydra configuration"] = 174,
    ["Ory Keto configuration"] = 196,
    ["Ory Kratos configuration"] = 249,
    ["Ory Oathkeeper configuration"] = 241,
    ["Outblocks App configuration"] = 247,
    ["Outblocks database table"] = 248,
    ["Outblocks project configuration"] = 246,
    Packer = 253,
    ["Pipeline component"] = 439,
    ["PocketMine plugin.yml"] = 257,
    ["Pull Request Labeler"] = 279,
    ["RKE Cluster Configuration JSON Schema"] = 437,
    ["RKE Cluster Configuration YAML Schema"] = 436,
    Ray = 406,
    ["Read the Docs"] = 282,
    ["Red-DiscordBot Сog"] = 283,
    ["Red-DiscordBot Сog Repo"] = 284,
    Renovate = 289,
    RoadRunner = 290,
    SWADL = 330,
    ["Sapphire CLI Config"] = 291,
    ["SauceCTL Configuration"] = 442,
    ["Schema Catalog"] = 304,
    ["Scoop manifest"] = 309,
    ["Semgrep Rule"] = 310,
    ["Serverless Framework Configuration"] = 449,
    ["Shopware CLI Extension Store Configuration"] = 450,
    Solidarity = 316,
    ["Source Maps v3"] = 317,
    SpecIF = 318,
    ["Sponge Mixin configuration"] = 319,
    ["StackHawk Scanner Configuration"] = 448,
    ["StackHead CLI config"] = 323,
    ["StackHead module configuration"] = 324,
    ["StackHead project definition"] = 325,
    Stale = 326,
    ["Stryker Mutator"] = 327,
    ["StyleCop Analyzers Configuration"] = 328,
    ["Swagger API 2.0"] = 331,
    ["Taskfile YAML Schema"] = 432,
    Taurus = 332,
    ["TestEnvironment.json"] = 337,
    ["Traefik v2"] = 339,
    ["Traefik v2 File Provider"] = 340,
    ["UI5 Manifest"] = 351,
    ["Uniswap Token List"] = 415,
    ["User Journey Map YAML Schema"] = 435,
    ["VSCode Code Snippets"] = 74,
    ["VSIX CLI publishing"] = 363,
    ["Vela Pipeline Configuration"] = 355,
    ["Web App Manifest"] = 367,
    ["Web types"] = 370,
    WebExtensions = 366,
    ["Windows Package Manager Installer Manifest"] = 412,
    ["Windows Package Manager Locale Manifest"] = 413,
    ["Windows Package Manager Singleton Manifest"] = 411,
    ["Woodpecker pipeline config"] = 444,
    ["Yippee-Ki-JSON configuration YML"] = 417,
    ["angular.json"] = 6,
    ...
    ["ioBroker JSON UI"] = 177,
    ["ioBroker Package manifest"] = 178,
    ["jsconfig.json"] = 194,
    jsdoc = 405,
    ["k3d.yaml"] = 195,
    ["kustomization.yaml"] = 197,
    ["label-commenter-config.yml"] = 198,
    ["launchsettings.json"] = 199,
    ["lerna.json"] = 200,
    ["lgtm.yml"] = 201,
    ["libman.json"] = 202,
    ["license-report-config.json"] = 203,
    ["local.settings.json"] = 204,
    ["localazy.json"] = 205,
    ["lsdlschema.json"] = 206,
    ["markdownlint.json"] = 441,
    mboats = 447,
    ["mimetypes.json"] = 212,
    ["mta.yaml"] = 390,
    ["mtad.yaml"] = 391,
    ["mycode.json"] = 227,
    ["napari plugin manifest"] = 228,
    neoload = 400,
    ["nest-cli"] = 232,
    ["ninjs (News in JSON)"] = 231,
    ["nlu.json"] = 233,
    ["nodemon.json"] = 235,
    ["noodl.schema.json"] = 446,
    now = 396,
    ["nswag.json"] = 239,
    ntangle = 240,
    ["nuclei-template.yaml"] = 237,
    ["nuget-project.json"] = 238,
    ["ocelot.json"] = 242,
    ["omnisharp.json"] = 243,
    ["openapi.json"] = 244,
    ["openfin.json"] = 245,
    ["package.json"] = 251,
    ["package.manifest"] = 252,
    ["pattern.json"] = 255,
    pgap_yaml_input_reader = 254,
    ["plagiarize-me.yaml"] = 259,
    ["plagiarize.yaml"] = 258,
    ["portman.json"] = 260,
    ["prettierrc.json"] = 264,
    ["prisma.yml"] = 265,
    ["project-1.0.0-beta3.json"] = 267,
    ["project-1.0.0-beta4.json"] = 268,
    ["project-1.0.0-beta5.json"] = 269,
    ["project-1.0.0-beta6.json"] = 270,
    ["project-1.0.0-beta8.json"] = 271,
    ["project-1.0.0-rc1.json"] = 272,
    ["project-1.0.0-rc2.json"] = 273,
    ["project.json"] = 266,
    ["prometheus.json"] = 274,
    ["prometheus.rules.json"] = 275,
    ["proxies.json"] = 276,
    ["publiccode.yml"] = 277,
    ["pubspec.yaml"] = 278,
    ["pyrseas-0.8.json"] = 281,
    ["release drafter"] = 401,
    ["sarif-1.0.0.json"] = 292,
    ["sarif-2.0.0.json"] = 293,
    ["sarif-2.1.0"] = 302,
    ["sarif-2.1.0-rtm.2"] = 294,
    ["sarif-2.1.0-rtm.3"] = 296,
    ["sarif-2.1.0-rtm.4"] = 298,
    ["sarif-2.1.0-rtm.5"] = 300,
    ["sarif-external-property-file-2.1.0"] = 303,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 295,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 297,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 299,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 301,
    ["schema.org - Action"] = 305,
    ["schema.org - ContactPoint"] = 306,
    ["schema.org - Place"] = 307,
    ["schema.org - Thing"] = 308,
    ["servicehub.config.json"] = 380,
    ["servicehub.service.json"] = 379,
    ["settings.job"] = 311,
    ["sfdx-hardis configuration"] = 312,
    ["size-limit configuration"] = 313,
    ["skaffold.yaml"] = 440,
    ["skyuxconfig.json"] = 314,
    snapcraft = 315,
    swcrc = 428,
    taskcat = 397,
    ["template.json"] = 333,
    ["templatsources.json"] = 334,
    ["theme.json"] = 335,
    tmLanguage = 336,
    ["trunk.yaml schema"] = 341,
    ["ts-force-config.json"] = 345,
    ["tsconfig.json"] = 342,
    ["tsd.json"] = 343,
    ["tsdrc.json"] = 344,
    ["tslint.json"] = 346,
    ...
    ["version.json"] = 356,
    ["vim-addon-info"] = 357,
    ["vs-2017.3.host.json"] = 359,
    ["vs-nesting.json"] = 360,
    ["vsls.json"] = 358,
    ["vss-extension.json"] = 364,
    ["webjobpublishsettings.json"] = 369,
    ["webjobs-list.json"] = 368,
    ["xs-app.json"] = 393,
    ["xunit.runner.json"] = 378,
    yamllint = 416,
    zuul = 402,
    ["Žinoma"] = 410
  },
