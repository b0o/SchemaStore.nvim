...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1112,
    [".nodehawkrc"] = 717,
    [".npmpackagejsonlintrc"] = 722,
    [".omletrc"] = 1293,
    [".phrase.yml"] = 804,
    [".phraseapp.yml"] = 805,
    [".pmbot.yml"] = 789,
    [".postcssrc"] = 798,
    [".powerpages-web-template-manifest"] = 800,
    [".pre-commit-config.yml"] = 801,
    [".pre-commit-hooks.yml"] = 802,
    [".putout.json"] = 838,
    [".rehyperc"] = 863,
    [".remarkrc"] = 867,
    [".sprite files"] = 969,
    ...
    AIConfig = 50,
    ["AMX Muse Program Descriptor"] = 1342,
    ["API Builder"] = 1148,
    ["AVA Configuration"] = 1212,
    ...
    ["AWS Copilot Manifest"] = 1381,
    ["AWS SAM CLI Samconfig"] = 327,
    Acton = 1435,
    ["Adobe UXP Manifest"] = 1275,
    ["Aerleon Network & Service Definitions"] = 30,
    ["Aerleon Policy"] = 31,
    ["Agent Permission Policy"] = 1421,
    ["Agent Run Metrics"] = 32,
    ["AgentCore CLI"] = 1422,
    ["AgentCtl MCP"] = 1424,
    ["AgentCtl config"] = 1423,
    ["AgentCtl permissions"] = 1425,
    AgentLoopKit = 1426,
    Aider = 1371,
    Air = 34,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1392,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1391,
    ["Airlock Microgateway"] = 51,
    ["Alacritty Configuration"] = 1184,
    ["AlgoVoi Compliance Receipt v1"] = 19,
    ["All Contributors configuration file"] = 1238,
    ...
    ["Application list for a WinUtil"] = 1321,
    ["ArchSmith diagram IR"] = 1464,
    ArchitectFX = 1326,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1390,
    ["Azure IoT Operations connector metadata"] = 1387,
    ...
    ["Azure Pipelines"] = 139,
    ["Azure Static Web Apps CLI configuration file"] = 973,
    ["Azure Static Web Apps configuration file"] = 972,
    BMML = 1409,
    ["BOSH BPM Config"] = 167,
    ["BOSH CPI Config"] = 168,
    ...
    Badness = 151,
    ["Barba-CV"] = 105,
    ["Bashly (bashly.yml)"] = 1242,
    ["Bashly Settings (bashly-settings.yml)"] = 1243,
    Bento = 1408,
    ["Better Code Hub"] = 1153,
    ["Better Scripts"] = 194,
    Bigconfig = 160,
    ["Biome Formatter Config"] = 106,
    ["Bitmovin Encoding Template"] = 1335,
    BizTalkServerApplicationSchema = 1119,
    Bleep = 195,
    ["Block Protocol Metadata"] = 192,
    ["Bluebricks blueprint config"] = 1414,
    ["Boyka Framework"] = 173,
    ...
    ["Butane Config"] = 1197,
    C4InterFlow = 1350,
    ["CDK Environment Manager, concrete environment configuration"] = 1374,
    ["CDK Environment Manager, concrete environments definition"] = 1373,
    ["CDK Environment Manager, environment definition"] = 1372,
    ["CGS Card Game Specification (cgs.json)"] = 1280,
    ["CICS TS region tagging"] = 1206,
    ["CICS TS resource import"] = 1207,
    ["CICS TS resource model"] = 1208,
    ["CICS TS resource overrides"] = 1209,
    ["CMake Presets"] = 196,
    ["CNC Codes"] = 223,
    ["CRS WAF test file"] = 1310,
    ["CRS WAF test platform overrides file"] = 1311,
    ...
    ["Caido Proxy Configuration"] = 1450,
    ...
    ["Chamaleon environment"] = 1339,
    ["Chamaleon properties"] = 1340,
    ["Chamaleon template"] = 1338,
    Changepacks = 1401,
    Changesets = 336,
    Changie = 208,
    Charmcraft = 209,
    ...
    ["Claude Code Launch Preview"] = 1463,
    ["Claude Code Plugin Manifest"] = 231,
    ["Claude Code Plugin Marketplace"] = 232,
    ["Claude Code Settings"] = 233,
    ["Clawject config"] = 229,
    ["Cloud Foundry Application Manifest"] = 1292,
    ["Cloud Run Spec v1"] = 1316,
    ...
    Concord = 1309,
    ["Configu .cfgu files"] = 1297,
    ["Configu .configu file"] = 1298,
    Conjure = 222,
    ["Container Structure Test"] = 1133,
    Containerlab = 1162,
    ["Context Passport"] = 2,
    ["Context Reasoning Format (CRF)"] = 220,
    ["Contextive Glossary"] = 1366,
    ContractGuard = 1163,
    Convex = 221,
    ...
    ["Cursor Agent Environment"] = 1419,
    ["Custom Machinery Machine"] = 1281,
    ["Custom Machinery Recipe"] = 1282,
    ...
    ["DonateCaseBetterCasino menu"] = 1343,
    ["Draugr Saga"] = 368,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1250,
    ["EAS config"] = 443,
    ["ECA - Editor Code Assistant"] = 406,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1239,
    ["ESLint Suppressions"] = 448,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1386,
    ["EasyVCR .NET"] = 445,
    ["Eidolon Resource"] = 1327,
    ...
    ["Envelope Team Definition"] = 1434,
    ["Envilder Map File"] = 411,
    ["Erda Pipeline"] = 1288,
    ["Erda Runtime"] = 1289,
    ["Espanso config.yml"] = 1412,
    ["Espanso match.yml"] = 1411,
    Esquio = 431,
    ["Estuary Flow Catalog"] = 1203,
    ["Ethereum ERC1155"] = 1428,
    ["Ethereum ERC721"] = 1427,
    ...
    ["Evolving Resolutive Process notation"] = 1388,
    ["Expo SDK"] = 442,
    ...
    ["GeoJSON.json latest"] = 1201,
    GherKing = 1205,
    ["GitHub Action"] = 487,
    ["GitHub Actions typing"] = 1323,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 1277,
    ...
    ["Google Digital Assetlinks"] = 1367,
    Goreleaser = 523,
    ["Goreleaser Pro"] = 524,
    Goss = 526,
    ["Gradle Build Cache Node"] = 1151,
    ["Gradle Enterprise"] = 1150,
    ...
    HEMTT = 1115,
    ["HULL - Helm Uniform Layer Library"] = 1468,
    Hadolint = 1129,
    Hammerkit = 1161,
    ["Hardware Sentry Configuration"] = 1217,
    ...
    ["Hecate Input Schema"] = 1378,
    ["Helm Chart.lock"] = 286,
    ["Helm Chart.yaml"] = 285,
    ["Helm Unittest Test Suite"] = 287,
    ["Heloisa Assistant Plugins Marketplace"] = 1461,
    ["Hex file"] = 288,
    ...
    ["JFrog File Spec"] = 583,
    ["JFrog Pipelines YML DSL"] = 1227,
    ["JMeter DSL cli config"] = 584,
    JReleaser = 587,
    ["JSON Document Transform"] = 595,
    ["JSON Feed"] = 596,
    ["JSON Resume"] = 876,
    ["JSON Schema Draft 2020-12"] = 1094,
    ["JSON Schema Draft 4"] = 1091,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1260,
    ["JSON Schema Draft 7"] = 1092,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1261,
    ["JSON Schema Draft 8 (2019-09)"] = 1093,
    ["JSON-API"] = 594,
    ["JSON-e templates"] = 1158,
    ["JSON-stat 2.0"] = 1087,
    JSONPatch = 598,
    ...
    Jsontron = 599,
    ["Jujutsu (jj) VCS config"] = 1380,
    ["KIMMDY config file"] = 610,
    ["KODE/CI build.yaml"] = 1223,
    ["KSP-AVC"] = 1088,
    ["KSP-CKAN"] = 1089,
    ["KSP-NetKAN"] = 1090,
    KSY = 1290,
    ...
    ["Kong DBLess config"] = 1224,
    KrakenD = 614,
    ["Kubri Configuration"] = 622,
    LOOBin = 643,
    ["Lake configuration file"] = 1383,
    ...
    ["Lando (landofile)"] = 132,
    ["LangGraph Platform configuration"] = 1302,
    ["Language configuration"] = 1301,
    Lefthook = 629,
    ...
    Liquibase = 1168,
    ["Liquibase Flow File"] = 1169,
    ["Lively Properties"] = 642,
    ["Lobe AI Agent"] = 134,
    Loki = 135,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 686,
    ["MS2Rescore Configuration"] = 694,
    ["MSTest testconfig.json"] = 695,
    ["Madge configuration"] = 649,
    ["Madness (madness.yml)"] = 1241,
    ["Mado configuration"] = 650,
    ["Maestro Flow"] = 651,
    ["Mail Servers Configuration"] = 1415,
    ["MapEHR Mapping"] = 652,
    Markdownlint = 1172,
    ["Mason Registry"] = 1175,
    ["MegaLinter Custom Flavor"] = 655,
    ["MegaLinter configuration"] = 654,
    ["MegaLinter descriptor"] = 656,
    Melange = 1268,
    ["Meltano project definition"] = 657,
    ["Mergify Configuration"] = 696,
    ["Mermaid config"] = 4,
    ["Metadata for a Bazel module"] = 658,
    ["Metadata for a Cinnamon spice"] = 1319,
    ["Metatype Configuration"] = 659,
    ["MetricsHub Configuration"] = 660,
    ["MetricsHub Connector Configuration"] = 661,
    ["Micro Editor Syntax"] = 1251,
    ["Microsoft Band Web Tile"] = 662,
    ["Microsoft RulesEngine workflow rules"] = 1306,
    ["Microsoft RulesEngine workflow rules list"] = 1307,
    ["Minecraft Custom Main Menu Mod"] = 1269,
    ["Minecraft Data Pack Advancement"] = 664,
    ["Minecraft Data Pack Biome"] = 665,
    ["Minecraft Data Pack Configured Carver"] = 666,
    ["Minecraft Data Pack Damage Type"] = 667,
    ["Minecraft Data Pack Dimension"] = 669,
    ["Minecraft Data Pack Dimension Type"] = 668,
    ["Minecraft Data Pack Item Modifier"] = 670,
    ["Minecraft Data Pack Loot Table"] = 671,
    ["Minecraft Data Pack Metadata"] = 672,
    ["Minecraft Data Pack Predicate"] = 673,
    ["Minecraft Data Pack Recipe"] = 674,
    ["Minecraft Data Pack Tag"] = 675,
    ["Minecraft Data Pack Template Pool"] = 676,
    ["Minecraft Data Pack Trim Material"] = 681,
    ["Minecraft Data Pack Trim Pattern"] = 682,
    ["Minecraft Resource Pack Lang"] = 677,
    ["Minecraft Resource Pack Particle"] = 678,
    ["Minecraft Resource Pack Texture Mcmeta"] = 680,
    ["Minecraft Resourcepack Sounds"] = 679,
    ["MockServer Expectation"] = 688,
    ["MockServer Expectations"] = 689,
    ModuleAssembler = 684,
    ["Monade CLI Stack Configuration"] = 699,
    ["MongoDB Atlas Search Index Definition"] = 1222,
    ["Monika Configuration"] = 1220,
    ["Monoweave Configuration"] = 693,
    ["Motif config"] = 1111,
    MultiQC = 1360,
    ["NOX Framework (Service)"] = 721,
    ["Netin Diagnostic System Template"] = 1179,
    ["Netlify config"] = 702,
    ["Network-as-Code Data Model"] = 703,
    ["Next Gen UI Agent A2A Server Configuration"] = 704,
    ["Next Gen UI Agent Configuration"] = 706,
    ["Next Gen UI Agent MCP Server Configuration"] = 705,
    ["Nightwatch.js"] = 713,
    ["Nika workflow"] = 718,
    ["Node.js configuration"] = 1116,
    ["NueJS configuration file"] = 726,
    ["Nuitka Package Config"] = 1283,
    ["Nullstone config"] = 728,
    ["ODGS Data Rules"] = 735,
    ["ODGS Ontology Graph"] = 736,
    ["ODGS Standard Metrics"] = 734,
    ["OKF Graph"] = 1462,
    ["ONe's changelog entry"] = 750,
    ["ONe's service descriptor"] = 749,
    ["ORT Server repository environment configuration"] = 761,
    ["OSCAL Assessment Plan (AP)"] = 763,
    ["OSCAL Assessment Results (AR)"] = 764,
    ["OSCAL Catalog"] = 765,
    ["OSCAL Component Definition (CDef)"] = 766,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 767,
    ["OSCAL Profile"] = 768,
    ["OSCAL System Security Plan (SSP)"] = 769,
    ["OSS Review Toolkit configuration"] = 770,
    ["OSS Review Toolkit curation"] = 771,
    ["OSS Review Toolkit package configuration"] = 772,
    ["OSS Review Toolkit project package manager definition"] = 773,
    ["OSS Review Toolkit repository configuration"] = 774,
    ["OSS Review Toolkit resolutions"] = 775,
    ["October CMS columns"] = 732,
    ["October CMS fields"] = 733,
    ["Oh My Posh"] = 738,
    Okteto = 739,
    ["Ona Tasks and Services"] = 741,
    Opctl = 1114,
    ["Open Data Contract Standard (ODCS)"] = 754,
    ["Open Data Product Standard (ODPS)"] = 755,
    ["Open Know-How"] = 1365,
    ["Open Pentest Format"] = 756,
    OpenDecree = 1432,
    ["OpenDecree Configuration"] = 1433,
    ["OpenRewrite Resource"] = 752,
    OpenSRM = 757,
    OpenStatus = 1376,
    ["OpenTelemetry Declarative Configuration"] = 753,
    ["OpenUtau character yaml"] = 746,
    ["OpenUtau ustx"] = 747,
    ["OpenWeather Current Weather API"] = 1157,
    ["OpenWeather Road Risk API"] = 1156,
    ["Ory Hydra configuration"] = 554,
    ["Ory Keto configuration"] = 618,
    ["Ory Kratos configuration"] = 762,
    ["Ory Oathkeeper configuration"] = 730,
    ["Outblocks App configuration"] = 759,
    ["Outblocks database table"] = 760,
    ["Outblocks project configuration"] = 758,
    PDM = 783,
    POPxf = 795,
    ["POPxf Correlations"] = 796,
    ["PRML manifest"] = 803,
    Packer = 779,
    PactSpec = 780,
    Panache = 781,
    Pantsbuild = 1237,
    ["Paper paper-plugin.yml"] = 782,
    ["Pipeline component"] = 1170,
    ["Platform.sh application"] = 15,
    ["Platform.sh routes"] = 16,
    ["Platform.sh services"] = 17,
    ["Plex Prerolls"] = 793,
    ["PocketMine plugin.yml"] = 790,
    ["Podman Desktop Extension"] = 1452,
    ["Postman collection"] = 799,
    ["Power Pages Configuration"] = 1377,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1322,
    ["ProActions AI-Kit Configuration"] = 811,
    ["ProActions AI-Kit Configuration for Menus"] = 813,
    ["ProActions AI-Kit Configuration for Sections"] = 815,
    ["ProActions AI-Kit Configuration for Services"] = 812,
    ["ProActions AI-Kit Configuration for Steps"] = 816,
    ["ProActions AI-Kit Configuration for Templates"] = 814,
    ["Problem object RFC9457"] = 1266,
    ["Problem package format"] = 817,
    ["Problem package generators"] = 818,
    ["Problem package submissions"] = 819,
    ["Problem package test group metadata"] = 820,
    ["Production delivery manifest"] = 1470,
    Pterodactyl = 1216,
    ["Pull Request Labeler"] = 837,
    Pulumi = 845,
    ["PyGTA Config"] = 841,
    PyProject = 846,
    Pylock = 1368,
    Pyright = 847,
    ["Python script metadata"] = 1362,
    ["QType AI DSL"] = 850,
    Qgoda = 849,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1444,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1442,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1448,
    ["Qlik Talend Cloud Pipeline - Project"] = 1440,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1443,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1445,
    ["Qlik Talend Cloud Pipeline - Task"] = 1441,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1447,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1446,
    Qodana = 1189,
    ["Qt Creator workspace file"] = 1299,
    ["Quali Torque Blueprint Spec 2"] = 1214,
    ["QueryFirst config file"] = 1233,
    ["QuikRun Configuration"] = 1449,
    ["Qwen Code Settings"] = 1429,
    ["RKE Cluster Configuration JSON"] = 1167,
    ["RKE Cluster Configuration YAML"] = 1166,
    RadioHound = 840,
    ["Raid Profile"] = 1430,
    ["Raid Repo Configuration"] = 1431,
    Railpack = 852,
    Railway = 851,
    ["Rancher Fleet"] = 842,
    ["Rattler-build"] = 853,
    Ray = 1128,
    ["Read the Docs"] = 844,
    ["Red-DiscordBot Cog"] = 860,
    ["Red-DiscordBot Cog Repo"] = 861,
    ["Red-DiscordBot Trivia"] = 862,
    ["Releasaurus Config"] = 12,
    ReleaseKit = 11,
    ["Render Blueprints"] = 1165,
    RenderCV = 880,
    Renovate = 877,
    ["Renovate global configuration"] = 878,
    ["Renovate inherited configuration"] = 879,
    ["Replit config"] = 868,
    Restate = 1355,
    ["Revel Digital Gadget Definition File"] = 1379,
    RoadRunner = 882,
    ["Robust Station Image"] = 1385,
    Rockcraft = 883,
    ["Roo Coder Custom Modes"] = 884,
    Rubocop = 873,
    ["Rudder techniques"] = 1273,
    Ruff = 874,
    ["Rust Project"] = 875,
    ["Rust toolchain"] = 889,
    ["SDMX data message"] = 916,
    ["SDMX metadata message"] = 915,
    ["SDMX structure message"] = 914,
    ["SIL Kit Participant Configuration"] = 927,
    ["SIL Kit Registry Configuration"] = 928,
    ["SPDX 2.3"] = 970,
    SWADL = 986,
    ["Safebox Config"] = 1228,
    ["Sapphire CLI Config"] = 892,
    ["SauceCTL Configuration"] = 1176,
    Scarb = 912,
    ["Schema Catalog"] = 907,
    ["Scoop manifest"] = 913,
    ["Secure SDLC Evidence Bundle"] = 917,
    ["Semantic Data Fabric (SDF) file"] = 918,
    ["Semgrep Rule"] = 920,
    ["Serenity Code Generator (Sergen)"] = 921,
    ["Serverless Framework Configuration"] = 1183,
    ["Serverless Workflow"] = 1185,
    ["Settings for a Cinnamon spice"] = 1318,
    ["Settings.paf"] = 923,
    ["Shopware 6 Configuration"] = 1186,
    ["Shopware CLI Extension Store Configuration"] = 1187,
    ["Shopware CLI Project Store Configuration"] = 1188,
    ["Sigma Detection Rule"] = 925,
    ["SigmaCV CV"] = 7,
    ["Sigrid scope configuration file"] = 926,
    ["SkyPilot Task JSON"] = 1274,
    ["Slack app manifest"] = 933,
    ["Slang Server Configuration"] = 1456,
    Snapcraft = 935,
    ["Solarxy project config"] = 938,
    Solidarity = 939,
    ["Solution filters"] = 940,
    ["Source Maps v3"] = 941,
    Sourcery = 942,
    ["Spack bootstrap.yaml"] = 943,
    ["Spack cdash.yaml"] = 944,
    ["Spack ci.yaml"] = 945,
    ["Spack compilers.yaml"] = 946,
    ["Spack concretizer.yaml"] = 947,
    ["Spack config.yaml"] = 948,
    ["Spack definitions.yaml"] = 949,
    ["Spack develop.yaml"] = 950,
    ["Spack env_vars.yaml"] = 951,
    ["Spack environment"] = 957,
    ["Spack include.yaml"] = 952,
    ["Spack mirrors.yaml"] = 953,
    ["Spack modules.yaml"] = 954,
    ["Spack packages.yaml"] = 955,
    ["Spack repos.yaml"] = 956,
    ["Spack toolchains.yaml"] = 958,
    ["Spack upstreams.yaml"] = 959,
    ["Spack view.yaml"] = 960,
    ["Speakeasy Generation Config File"] = 964,
    ["Speakeasy Lint Configuration File"] = 961,
    ["Speakeasy Test Generation Configuration File"] = 962,
    ["Speakeasy Workflow File"] = 963,
    SpecIF = 965,
    ["Specmatic Configuration"] = 966,
    ["Specpin spec file"] = 5,
    ["Sponge Mixin configuration"] = 967,
    ["Spotlight Ruleset"] = 968,
    StackBlitz = 974,
    ["StackHawk Scanner Configuration"] = 1182,
    Stale = 975,
    Starfish = 976,
    ["Starlake Data Pipeline"] = 1154,
    Starship = 977,
    ["Statamic Blueprint"] = 978,
    ["Stella configuration file"] = 979,
    ["Streamlit configuration file"] = 980,
    ["Stryker Mutator"] = 983,
    ["StyleCop Analyzers Configuration"] = 984,
    ["Stylelint (.stylelintrc)"] = 985,
    ["Stylua Config"] = 1369,
    ["Sublime Syntax"] = 1229,
    ["Subsquid squid manifest"] = 1276,
    ["Swagger API 2.0"] = 987,
    ["Symfony Routing Configuration"] = 988,
    ["Symfony Serializer Mapping"] = 989,
    ["Symfony Services Configuration"] = 990,
    ["Symfony Validation Mapping"] = 991,
    ["Synadia Connect Component"] = 992,
    TSON = 1035,
    TSTyche = 1036,
    ["TYPO3 Vendor Bundler config"] = 1042,
    ["Tab data for a LinUtil"] = 1325,
    ["Tab list for a LinUtil"] = 1324,
    Tach = 993,
    ["Tach Domain"] = 994,
    Talhelper = 996,
    ["Talisman configuration"] = 997,
    Taplo = 1370,
    ["Taskfile config"] = 1159,
    Taurus = 998,
    Tauticord = 999,
    ["Tekton Pipeline"] = 1398,
    ["Tekton PipelineRun"] = 1399,
    ["Tekton Task"] = 1396,
    ["Tekton TaskRun"] = 1397,
    Telefonistka = 1356,
    ["Terraform PowerShell provider block manifest"] = 1002,
    ["Terraform PowerShell provider data source manifest"] = 1003,
    ["Terraform PowerShell provider resource manifest"] = 1004,
    ["Terraform PowerShell provider settings"] = 1005,
    ["Terrateam config"] = 1382,
    ["Tesseract configuration"] = 1006,
    ["TestEnvironment.json"] = 1016,
    ["TextMate Grammar"] = 1015,
    Threagile = 1010,
    ["Tier.run pricing.json"] = 1007,
    Tikibase = 1008,
    Tombi = 1013,
    ["Traefik v2"] = 1019,
    ["Traefik v2 File Provider"] = 1020,
    ["Traefik v3"] = 1021,
    ["Traefik v3 File Provider"] = 1022,
    ["Travis CI (.travis.yml)"] = 1018,
    Treefmt = 529,
    Trident = 1352,
    Trivy = 1025,
    ["TrueScript for *.tscript files"] = 1026,
    ["Tugboat QA config.yml"] = 1349,
    TunnelHub = 1264,
    Turborepo = 1017,
    Tycho = 1313,
    Tye = 1190,
    ["Tyk Gateway - Open Source v5.7+"] = 1361,
    ["UET BuildConfig.json"] = 1234,
    ["UI5 Manifest"] = 1048,
    ["UNCORS configuration"] = 1053,
    ["UTAM Page Object"] = 1051,
    ["Ubuntu Server Autoinstall"] = 1046,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1353,
    ["Uniswap Token List"] = 1139,
    ["Universal Schedule Format"] = 1054,
    ["Unreal Engine Uplugin"] = 1235,
    ["Unreal Engine Uproject"] = 1236,
    ["UpCloud CLI (upctl) configuration"] = 1354,
    ["Updatecli Compose"] = 1198,
    ["Updatecli Policy Manifest"] = 1199,
    ["Updatecli Policy Metadata"] = 1200,
    Uplift = 1232,
    ["Upsun config"] = 14,
    ["User Journey Map"] = 1164,
    V2Ray = 1204,
    ["VSCode Code Snippets"] = 311,
    ["VSIX CLI publishing"] = 1074,
    Vector = 1056,
    ["Vee JSON menu output"] = 1057,
    ["Vela Pipeline Configuration"] = 1060,
    Vercel = 310,
    ["Version Bumper config"] = 1063,
    Vespertide = 1403,
    ["Vespertide Migration"] = 1404,
    ["Vespertide Model"] = 1405,
    ["Viash Component Config"] = 1358,
    ["Viash Package Config"] = 1359,
    Visivo = 1262,
    Vogi = 1068,
    ["WP-CLI"] = 1084,
    Wake = 1351,
    ["Waku Config"] = 1328,
    ["Web App Manifest"] = 1080,
    ["Web types"] = 1083,
    WebExtensions = 1079,
    ["Webman package recipe"] = 1210,
    ["Windows Package Manager Installer Manifest"] = 1136,
    ["Windows Package Manager Locale Manifest"] = 1137,
    ["Windows Package Manager Singleton Manifest"] = 1135,
    ["WireMock CLI import configuration"] = 1334,
    ["WireMock CLI local service configuration"] = 1333,
    ["WireMock message stub mapping"] = 1332,
    ["WireMock stub mapping"] = 1331,
    ["Woodpecker pipeline config"] = 1178,
    ["Wrangler CLI"] = 1085,
    ["XenForo add-on manifest"] = 1086,
    ["Xstate Machine"] = 1196,
    ["Yandex Workflow Language"] = 1320,
    ["Yarn Config (.yarnrc.yml)"] = 1152,
    ["Yippee-Ki-JSON configuration YML"] = 1143,
    ["YouTrack App"] = 1317,
    ["Zarf Package Configuration"] = 1384,
    ["Zerops import file"] = 1305,
    ["Zola Configuration"] = 1395,
    abtop = 36,
    act3 = 1436,
    actionlint = 46,
    ["aerleon.yml"] = 29,
    ...
    ["behat.yml"] = 174,
    ["bigquery-table"] = 159,
    ["bioimageio resource description"] = 1284,
    ...
    ["cargo-nextest repository configuration"] = 707,
    ["cargo-nextest user configuration"] = 708,
    ["ccmod.json"] = 1329,
    ["cfgd Config"] = 1457,
    ["cfgd ConfigSource"] = 1460,
    ["cfgd Module"] = 1458,
    ["cfgd Profile"] = 1459,
    changelogging = 1296,
    ...
    ["chutzpah.json"] = 319,
    cibuildwheel = 215,
    ["clang-format (.clang-format)"] = 1202,
    ["clang-tidy"] = 294,
    clangd = 293,
    clib = 295,
    ...
    ["crowdin.yml"] = 346,
    crucible = 350,
    ["ctfd-setup configuration file"] = 1341,
    ["custom-elements.json"] = 1254,
    ["cypress.json"] = 351,
    ["dacier.yml"] = 1439,
    ...
    ["gematik health care insurance list"] = 1347,
    ["gematik health care patient list"] = 1344,
    ["gematik health care provider institution list"] = 1346,
    ["gematik health care provider list"] = 1345,
    ["gematik tiger test environment configuration"] = 1348,
    ["gh-dash"] = 485,
    ["gha-doctor"] = 486,
    ["git-cliff"] = 482,
    ["git-town.toml"] = 1393,
    ["github-settings-as-code"] = 869,
    ["gitlab-ci"] = 500,
    ["global.json"] = 517,
    ["glslint config"] = 3,
    ...
    lychee = 1102,
    ["macro.json"] = 1219,
    ["markdown-link-check"] = 1173,
    maturin = 1174,
    mboats = 1181,
    memnex = 1437,
    ["micro-settings.json"] = 1246,
    ["mimetypes.json"] = 663,
    ["mirrord config"] = 1106,
    ["misata.yaml"] = 1105,
    mise = 1107,
    ...
    ["mkdocs.yml"] = 683,
    ["mockd.yaml"] = 687,
    ["mod.pw.toml (packwiz)"] = 1454,
    ["modelparams.dev Model"] = 690,
    ["models CLI"] = 691,
    ["monospace.yml"] = 692,
    ["moon.yml"] = 1330,
    ["mprocs Configuration file"] = 1300,
    ["mrdocs.yml"] = 685,
    ["mta.yaml"] = 1109,
    ["mtad.yaml"] = 1110,
    ["mycode.json"] = 700,
    nFPM = 712,
    ["napari plugin manifest"] = 701,
    neoload = 1122,
    ["nest-cli"] = 715,
    ["nexus-rpc-gen"] = 1420,
    ["nf-core module environment.yml"] = 709,
    ["nf-core module meta.yml"] = 710,
    ["nf-core subworkflow meta.yml"] = 711,
    ["ninjs (News in JSON)"] = 714,
    ["nitro.json"] = 1121,
    ["nixd configuration"] = 1272,
    ["nlu.json"] = 716,
    ["nodemon.json"] = 719,
    ["noodl config"] = 1180,
    ["notebook.mod.json"] = 720,
    now = 1117,
    ["npm-badges"] = 723,
    ["nswag.json"] = 727,
    ntangle = 729,
    ["nuclei-template.yaml"] = 724,
    ["nuget-project.json"] = 725,
    ["ocelot.json"] = 731,
    ogen = 737,
    ["omnisharp.json"] = 740,
    openHAB = 1406,
    ...
    oxfmt = 1416,
    oxlint = 1417,
    ["pack.toml (packwiz)"] = 1455,
    ["package.json"] = 776,
    ["package.manifest"] = 778,
    ["package.yaml"] = 777,
    ["partial-black.json"] = 175,
    ["partial-fastapi.json"] = 176,
    ["partial-pixi.json"] = 788,
    ["partial-scheduled.json"] = 177,
    ["pattern.json"] = 786,
    ["petstore-v1.0"] = 1226,
    pgap_yaml_input_reader = 784,
    pgrls = 785,
    pgxgen = 1410,
    pitcms = 1413,
    ["pixi.toml"] = 787,
    ["plagiarize-me.yaml"] = 792,
    ["plagiarize.yaml"] = 791,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1337,
    ["podbard.yaml"] = 794,
    ["portman.json"] = 797,
    ["prefect.toml"] = 806,
    ["prefect.yaml"] = 807,
    ...
    ["prettierrc.json"] = 809,
    ["prisma.yml"] = 810,
    ["project-1.0.0-beta3.json"] = 822,
    ["project-1.0.0-beta4.json"] = 823,
    ["project-1.0.0-beta5.json"] = 824,
    ["project-1.0.0-beta6.json"] = 825,
    ["project-1.0.0-beta8.json"] = 826,
    ["project-1.0.0-rc1.json"] = 827,
    ["project-1.0.0-rc2.json"] = 828,
    ["project.json"] = 821,
    ["project.owasp.yaml"] = 829,
    ["prometheus-alertmanager.json"] = 833,
    ["prometheus.json"] = 830,
    ["prometheus.rules.json"] = 831,
    ["prometheus.rules.test.json"] = 832,
    ["proxies.json"] = 834,
    ["publiccode.yml"] = 835,
    ["pubspec.yaml"] = 836,
    ["pyrseas-0.8.json"] = 839,
    pytest = 848,
    ["quilt.mod.json"] = 1247,
    ["rc3 auth"] = 854,
    ["rc3 collection"] = 855,
    ...
    ["rc3 settings"] = 859,
    ["registry.yaml"] = 65,
    ["release drafter"] = 1123,
    ["release-hub.json"] = 10,
    ["release-please-config.json"] = 864,
    ["release-please-manifest.json"] = 865,
    ["release-plz.toml"] = 866,
    ["renv.lock"] = 881,
    ["replacement-transformer.yaml"] = 625,
    ["reposets Configuration"] = 870,
    ["reposets Credentials"] = 871,
    ["revola.json"] = 8,
    ["rivet.json"] = 1271,
    ["rivet.yaml (legacy)"] = 1270,
    rumdl = 886,
    runny = 885,
    runspec = 1438,
    rustfmt = 887,
    ...
    samt = 890,
    samtrc = 891,
    ["sarif-1.0.0.json"] = 893,
    ["sarif-2.0.0.json"] = 894,
    ["sarif-2.1.0"] = 904,
    ["sarif-2.1.0-rtm.2"] = 895,
    ["sarif-2.1.0-rtm.3"] = 897,
    ["sarif-2.1.0-rtm.4"] = 899,
    ["sarif-2.1.0-rtm.5"] = 901,
    ["sarif-2.1.0-rtm.6"] = 902,
    ["sarif-external-property-file-2.1.0"] = 905,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 896,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 898,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 900,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 903,
    ["scalingo.json configuration"] = 906,
    ["schema.org - Action"] = 908,
    ["schema.org - ContactPoint"] = 909,
    ["schema.org - Place"] = 910,
    ["schema.org - Thing"] = 911,
    ["secrethub.yml"] = 1249,
    ["semantic-release"] = 919,
    servercn = 1466,
    ["servicehub.config.json"] = 1097,
    ["servicehub.service.json"] = 1096,
    ["settings.job"] = 922,
    ["sfdx-hardis configuration"] = 924,
    ["shard.yml"] = 1287,
    ["size-limit configuration"] = 929,
    ["skaffold.yaml"] = 1171,
    ["skill-map plugin extension manifest"] = 930,
    ["skill-map project settings"] = 931,
    ["skill-map provider kind"] = 932,
    ["skyuxconfig.json"] = 934,
    ["snowflake-config"] = 936,
    ["snowflake-connections"] = 937,
    ["spicepod.yaml"] = 1308,
    ["sqlc configuration"] = 971,
    ["stripe-app-local.json"] = 982,
    ["stripe-app.json"] = 981,
    swcrc = 1155,
    ["task.json"] = 995,
    taskcat = 1118,
    ["template.json"] = 1000,
    ["templatsources.json"] = 1001,
    ["text2confl config"] = 1418,
    ["theme.json"] = 1009,
    ["tizen_workspace.json"] = 1011,
    tldr = 1012,
    ["tm_devices configuration file"] = 1375,
    tmuxinator = 1100,
    tox = 1014,
    ["transcend.yml"] = 1023,
    ...
    ["vega-lite.json"] = 1059,
    ["vega.json"] = 1058,
    ["venvironment.yaml"] = 1061,
    ["venvplus.yaml"] = 1062,
    version = 1357,
    ["version.json"] = 1064,
    ["vhwdebugger-binding.yaml"] = 1066,
    ["vim-addon-info"] = 1067,
    ["vs-2017.3.host.json"] = 1070,
    ["vs-nesting.json"] = 1071,
    ["vsls.json"] = 1069,
    ["vss-extension.json"] = 1075,
    vtcfg = 1363,
    ["vtesttree.yaml"] = 1076,
    ["vtestunit.yaml"] = 1077,
    ["warp-keysets.json"] = 1255,
    ["warp-themes.json"] = 1256,
    ["warp-workflows.json"] = 1257,
    ["webhint.io"] = 1211,
    ["webjobpublishsettings.json"] = 1082,
    ["webjobs-list.json"] = 1081,
    ["well-known-fursona"] = 1295,
    ["xs-app.json"] = 1113,
    ["xunit.runner.json"] = 1095,
    ["yaml-workflow"] = 1465,
    yamlfmt = 1140,
    yamllint = 1141,
    ["yap.json"] = 1142,
