...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 165,
    [".cryproj (generic)"] = 564,
    [".cryproj engine-5.2"] = 559,
    [".cryproj engine-5.3"] = 560,
    [".cryproj engine-5.4"] = 561,
    [".cryproj engine-5.5"] = 562,
    [".cryproj engine-dev"] = 563,
    [".csscomb.json"] = 167,
    [".csslintrc"] = 168,
    [".es6importsorterrc.json"] = 689,
    [".eslintrc"] = 214,
    [".esmrc.json"] = 206,
    [".ffizer.yaml"] = 218,
    [".htmlhintrc"] = 264,
    ...
    [".mtaext"] = 573,
    [".nodehawkrc"] = 357,
    [".npmpackagejsonlintrc"] = 360,
    [".phraseapp.yml"] = 399,
    [".pmbot.yml"] = 389,
    [".postcssrc"] = 394,
    [".powerpages-web-template-manifest"] = 396,
    [".pre-commit-config.yml"] = 397,
    [".pre-commit-hooks.yml"] = 398,
    [".putout.json"] = 417,
    [".rehyperc"] = 427,
    [".remarkrc"] = 428,
    [".sprite files"] = 479,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration Schema"] = 635,
    ["All Contributors configuration file"] = 688,
    ...
    ["Azure Pipelines"] = 54,
    ["Azure Static Web Apps CLI configuration file"] = 481,
    ["Azure Static Web Apps configuration file"] = 480,
    ["BX CI"] = 89,
    ["Better Code Hub"] = 608,
    ["Better Scripts"] = 90,
    BizTalkServerApplicationSchema = 579,
    ...
    ["Butane Config"] = 647,
    ["CICS TS region tagging"] = 654,
    ["CICS TS resource import"] = 655,
    ["CICS TS resource model"] = 656,
    ["CICS TS resource overrides"] = 657,
    ["CMake Presets"] = 91,
    ...
    ["Datahub Ingestion Recipe Schema"] = 661,
    ...
    ["Embrace Config Schema"] = 672,
    ["Error pages"] = 209,
    Esquio = 207,
    ["Estuary Flow Catalog Schema"] = 651,
    ["Expo SDK"] = 212,
    ...
    Goreleaser = 246,
    ["Goreleaser Pro"] = 247,
    ["Gradle Build Cache Node"] = 605,
    ["Gradle Enterprise"] = 604,
    ...
    Hadolint = 588,
    Hammerkit = 615,
    ["Hardware Sentry Configuration"] = 665,
    Hayson = 259,
    ...
    ["JFrog File Spec"] = 283,
    ["JFrog Pipelines YML DSL"] = 674,
    ["JMeter DSL cli config schema"] = 284,
    JReleaser = 286,
    ["JSON Document Transform"] = 293,
    ["JSON Feed"] = 294,
    ["JSON Resume"] = 434,
    ["JSON Schema Draft 2020-12"] = 555,
    ["JSON Schema Draft 4"] = 552,
    ["JSON Schema Draft 7"] = 553,
    ["JSON Schema Draft 8"] = 554,
    ...
    ["KSP-CKAN"] = 551,
    Kas = 299,
    ["Keycloak REST API"] = 680,
    ["Knative Functions - func.yaml"] = 228,
    ["KoDE/CI build.yaml"] = 670,
    ["Kong DBLess Schema"] = 671,
    KrakenD = 300,
    LOOBin = 315,
    ["LinkML Metamodel"] = 313,
    Liquibase = 620,
    ["Liquibase Flow File"] = 621,
    ...
    ["MkDocs Configuration 1.0"] = 345,
    ["MongoDB Atlas Search Index Definition Schema"] = 669,
    ["Monika Configuration Schema"] = 667,
    ["Motif config"] = 572,
    ["NOX Framework (Service)"] = 359,
    ["Netin Diagnostic System Template"] = 630,
    ["Netlify config schema"] = 350,
    ["Nexus-as-Code schema"] = 351,
    ["Nightwatch.js"] = 352,
    ["ONe's service descriptor"] = 371,
    ["OSS Review Toolkit configuration"] = 378,
    ["OSS Review Toolkit curation"] = 379,
    ["OSS Review Toolkit package configuration"] = 380,
    ["OSS Review Toolkit repository configuration"] = 381,
    ["OSS Review Toolkit resolutions"] = 382,
    Opctl = 575,
    ["OpenRewrite Resource"] = 373,
    ["OpenWeather Current Weather API"] = 612,
    ["OpenWeather Road Risk API"] = 611,
    ["Ory Hydra configuration"] = 265,
    ["Ory Keto configuration"] = 302,
    ["Ory Kratos configuration"] = 377,
    ["Ory Oathkeeper configuration"] = 366,
    ["Outblocks App configuration"] = 375,
    ["Outblocks database table"] = 376,
    ["Outblocks project configuration"] = 374,
    Packer = 385,
    Pantsbuild = 687,
    ["Paper paper-plugin.yml"] = 386,
    ["Pipeline component"] = 622,
    ["PocketMine plugin.yml"] = 390,
    ["Postman collection"] = 395,
    Pterodactyl = 664,
    ["Pull Request Labeler"] = 416,
    Pulumi = 421,
    PyProject = 422,
    Pyright = 423,
    Qodana = 640,
    ["Quali Torque Blueprint Spec 2"] = 662,
    ["QueryFirst config file"] = 683,
    ["RKE Cluster Configuration JSON Schema"] = 619,
    ["RKE Cluster Configuration YAML Schema"] = 618,
    ["Rancher Fleet"] = 419,
    Ray = 587,
    ["Read the Docs"] = 420,
    ["Red-DiscordBot Cog"] = 424,
    ["Red-DiscordBot Cog Repo"] = 425,
    ["Red-DiscordBot Trivia"] = 426,
    Renovate = 435,
    ["Replit schema"] = 429,
    RoadRunner = 436,
    Ruff = 432,
    ["Rust Project"] = 433,
    ["Rust toolchain"] = 438,
    ["SIL Kit Participant Configuration"] = 467,
    ["SIL Kit Registry Configuration"] = 468,
    SWADL = 490,
    ["Sapphire CLI Config"] = 441,
    ["SauceCTL Configuration"] = 627,
    ["Schema Catalog"] = 454,
    ["Scoop manifest"] = 459,
    ["Semantic Data Fabric (SDF) file"] = 460,
    ["Semgrep Rule"] = 462,
    ["Serenity Code Generator (Sergen)"] = 463,
    ["Serverless Framework Configuration"] = 634,
    ["Serverless Workflow Schema"] = 636,
    ["Settings.paf"] = 465,
    ["Shopware 6 Configuration"] = 637,
    ["Shopware CLI Extension Store Configuration"] = 638,
    ["Shopware CLI Project Store Configuration"] = 639,
    ["Slack app manifest"] = 470,
    Solidarity = 473,
    ["Solution filters"] = 474,
    ["Source Maps v3"] = 475,
    Sourcery = 476,
    SpecIF = 477,
    ["Sponge Mixin configuration"] = 478,
    ["StackHawk Scanner Configuration"] = 633,
    Stale = 482,
    Starship = 483,
    ["Statamic Blueprint"] = 484,
    ["StrmPrivacy Data Connector"] = 678,
    ["StrmPrivacy Data Contract"] = 679,
    ["StrmPrivacy SimpleSchema"] = 676,
    ["StrmPrivacy Stream"] = 677,
    ["StrmPrivacy batch job configuration file"] = 675,
    ["Stryker Mutator"] = 487,
    ["StyleCop Analyzers Configuration"] = 488,
    ["Swagger API 2.0"] = 491,
    TSON = 515,
    ["Talisman configuration"] = 493,
    ["Taskfile YAML Schema"] = 614,
    Taurus = 494,
    ["TestEnvironment.json"] = 503,
    ["Tier.run pricing.json"] = 497,
    Tikibase = 498,
    ["Traefik v2"] = 506,
    ["Traefik v2 File Provider"] = 507,
    Turborepo = 504,
    Tye = 641,
    ["UET BuildConfig.json"] = 684,
    ["UI5 Manifest"] = 522,
    ["UTAM Page Object"] = 525,
    ["Ubuntu Server Autoinstall"] = 520,
    ["Uniswap Token List"] = 597,
    ["Unreal Engine Uplugin"] = 685,
    ["Unreal Engine Uproject"] = 686,
    Updatecli = 648,
    Uplift = 682,
    ["User Journey Map YAML Schema"] = 617,
    V2Ray = 652,
    ["VSCode Code Snippets"] = 137,
    ["VSIX CLI publishing"] = 538,
    ["Vela Pipeline Configuration"] = 528,
    Vercel = 136,
    ["Web App Manifest"] = 545,
    ["Web types"] = 548,
    WebExtensions = 544,
    ["Webman package recipe"] = 658,
    ["Windows Package Manager Installer Manifest"] = 594,
    ["Windows Package Manager Locale Manifest"] = 595,
    ["Windows Package Manager Singleton Manifest"] = 593,
    ["Woodpecker pipeline config"] = 629,
    ["Xstate Machine Schema"] = 646,
    ["Yippee-Ki-JSON configuration YML"] = 599,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 65,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 693,
    ["bashly-strings.yml"] = 694,
    ["bashly.yml"] = 692,
    ["batect.yml"] = 64,
    ["beau.yml"] = 607,
    ...
    ["ize.toml"] = 681,
    ["jsconfig.json"] = 297,
    ["jscpd Configuration Schema"] = 663,
    jsdoc = 586,
    ["k3d.yaml"] = 298,
    ...
    ["lsdlschema.json"] = 319,
    ["madness.yml"] = 691,
    ["markdown-lint-check"] = 625,
    mboats = 632,
    ["micro-settings.json"] = 695,
    ["mimetypes.json"] = 326,
    ["mirrord-schema"] = 569,
    ["mta.yaml"] = 570,
    ["mtad.yaml"] = 571,
    ["mycode.json"] = 348,
    ["napari plugin manifest"] = 349,
    neoload = 581,
    ["nest-cli"] = 355,
    ["ninjs (News in JSON) 1.3"] = 354,
    ["ninjs (News in JSON) 2.0"] = 353,
    ["nlu.json"] = 356,
    ["nodemon.json"] = 358,
    ["noodl.schema.json"] = 631,
    now = 577,
    ["npm-badges"] = 361,
    ["nswag.json"] = 364,
    ntangle = 365,
    ["nuclei-template.yaml"] = 362,
    ["nuget-project.json"] = 363,
    ["ocelot.json"] = 367,
    ["omnisharp.json"] = 368,
    ["openapi.json"] = 369,
    ["openfin.json"] = 372,
    ["openrpc.json"] = 370,
    ["package.json"] = 383,
    ["package.manifest"] = 384,
    ["pattern.json"] = 388,
    ["petstore-v1.0"] = 673,
    pgap_yaml_input_reader = 387,
    ["plagiarize-me.yaml"] = 392,
    ["plagiarize.yaml"] = 391,
    ["portman.json"] = 393,
    ["prettierrc.json"] = 400,
    ["prisma.yml"] = 401,
    ["project-1.0.0-beta3.json"] = 403,
    ["project-1.0.0-beta4.json"] = 404,
    ["project-1.0.0-beta5.json"] = 405,
    ["project-1.0.0-beta6.json"] = 406,
    ["project-1.0.0-beta8.json"] = 407,
    ["project-1.0.0-rc1.json"] = 408,
    ["project-1.0.0-rc2.json"] = 409,
    ["project.json"] = 402,
    ["prometheus.json"] = 410,
    ["prometheus.rules.json"] = 411,
    ["prometheus.rules.test.json"] = 412,
    ["proxies.json"] = 413,
    ["publiccode.yml"] = 414,
    ["pubspec.yaml"] = 415,
    ["pyrseas-0.8.json"] = 418,
    ["quilt.mod.json"] = 696,
    ["release drafter"] = 582,
    rtx = 431,
    rustfmt = 437,
    samt = 439,
    samtrc = 440,
    ["sarif-1.0.0.json"] = 442,
    ["sarif-2.0.0.json"] = 443,
    ["sarif-2.1.0"] = 452,
    ["sarif-2.1.0-rtm.2"] = 444,
    ["sarif-2.1.0-rtm.3"] = 446,
    ["sarif-2.1.0-rtm.4"] = 448,
    ["sarif-2.1.0-rtm.5"] = 450,
    ["sarif-external-property-file-2.1.0"] = 453,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 445,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 447,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 449,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 451,
    ["schema.org - Action"] = 455,
    ["schema.org - ContactPoint"] = 456,
    ["schema.org - Place"] = 457,
    ["schema.org - Thing"] = 458,
    ["secrethub.yml"] = 698,
    ["semantic-release"] = 461,
    ["servicehub.config.json"] = 558,
    ["servicehub.service.json"] = 557,
    ["settings.job"] = 464,
    ["sfdx-hardis configuration"] = 466,
    ["size-limit configuration"] = 469,
    ["skaffold.yaml"] = 623,
    ["skyuxconfig.json"] = 471,
    snapcraft = 472,
    ["stripe-app-local.json"] = 486,
    ["stripe-app.json"] = 485,
    swcrc = 610,
    ["task.json"] = 492,
    taskcat = 578,
    ["template.json"] = 495,
    ["templatsources.json"] = 496,
    ["theme.json"] = 499,
    ["tizen_workspace.json"] = 500,
    tldr = 501,
    tmLanguage = 502,
    tmuxinator = 566,
    ["transcend.yml"] = 508,
    ["trunk.yaml schema"] = 509,
    ["ts-force-config.json"] = 513,
    ["tsconfig.json"] = 510,
    ["tsd.json"] = 511,
    ["tsdrc.json"] = 512,
    ["tslint.json"] = 514,
    ...
    ["vega-lite.json"] = 527,
    ["vega.json"] = 526,
    ["venvironment-basic.yaml"] = 530,
    ["venvironment.yaml"] = 529,
    ["version.json"] = 531,
    ["vim-addon-info"] = 532,
    ["vs-2017.3.host.json"] = 534,
    ["vs-nesting.json"] = 535,
    ["vsls.json"] = 533,
    ["vss-extension.json"] = 539,
    ["vtesttree.yaml"] = 540,
    ["vtestunit.yaml"] = 541,
    ["webhint.io"] = 659,
    ["webjobpublishsettings.json"] = 547,
    ["webjobs-list.json"] = 546,
    ["xs-app.json"] = 574,
    ["xunit.runner.json"] = 556,
    yamllint = 598,
    zuul = 583,
    ["Žinoma"] = 592
  },
