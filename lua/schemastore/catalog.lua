...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 14,
    AIConfig = 15,
    ["AMX Muse Program Descriptor"] = 976,
    ["API Builder"] = 797,
    ["AVA Configuration"] = 857,
    ...
    ["Adobe UXP Manifest"] = 917,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Alacritty Configuration"] = 829,
    ["All Contributors configuration file"] = 882,
    ...
    ["Application list for a WinUtil"] = 960,
    ArchitectFX = 964,
    ["Argo Events"] = 29,
    ["Argo Workflows"] = 30,
    AssemblyScript = 33,
    ...
    ["Azure Pipelines"] = 66,
    ["Azure Static Web Apps CLI configuration file"] = 659,
    ["Azure Static Web Apps configuration file"] = 658,
    ["BOSH Deploy Config"] = 90,
    ["BX CI"] = 107,
    ["Bashly (bashly.yml)"] = 886,
    ["Bashly Settings (bashly-settings.yml)"] = 887,
    ["Better Code Hub"] = 801,
    ["Better Scripts"] = 108,
    Bigconfig = 83,
    ["Biome Formatter Config"] = 53,
    ["Bitmovin Encoding Template"] = 970,
    BizTalkServerApplicationSchema = 770,
    Bleep = 109,
    ...
    ["Butane Config"] = 842,
    ["CGS Custom Card Game (CardGameDef.json)"] = 922,
    ["CICS TS region tagging"] = 851,
    ["CICS TS resource import"] = 852,
    ["CICS TS resource model"] = 853,
    ["CICS TS resource overrides"] = 854,
    ["CMake Presets"] = 110,
    ["CNC Codes"] = 125,
    ["CRS WAF test file"] = 950,
    ["CRS WAF test platform overrides file"] = 951,
    ...
    ["Chamaleon environment"] = 974,
    ["Chamaleon template"] = 973,
    Changesets = 207,
    Cheatsheets = 839,
    ...
    CityJSON = 121,
    ["Clawject config"] = 130,
    ["Cloud Foundry Application Manifest"] = 933,
    ["Cloud Run Spec v1"] = 955,
    ...
    Concord = 949,
    ["Configu .cfgu files"] = 938,
    ["Configu .configu file"] = 939,
    Conjure = 124,
    ["Container Structure Test"] = 784,
    Containerlab = 809,
    ["Crowdsec collection config"] = 216,
    ["Crowdsec parser config"] = 217,
    ["Crowdsec scenario config"] = 218,
    ["CumulusCI Config"] = 129,
    ["Custom Machinery Machine"] = 923,
    ["Custom Machinery Recipe"] = 924,
    ...
    ["DonateCaseBetterCasino menu"] = 977,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 894,
    ["EAS config"] = 282,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 883,
    ["EasyVCR .NET"] = 283,
    ["Eidolon Resource"] = 965,
    ...
    ["Goreleaser Pro"] = 340,
    Goss = 341,
    ["Gradle Build Cache Node"] = 799,
    ["Gradle Enterprise"] = 798,
    ...
    Hadolint = 780,
    Hammerkit = 808,
    ["Hardware Sentry Configuration"] = 862,
    Hatch = 781,
    Hayson = 354,
    ...
    ["JFrog File Spec"] = 383,
    ["JFrog Pipelines YML DSL"] = 871,
    ["JMeter DSL cli config"] = 384,
    JReleaser = 386,
    ["JSON Document Transform"] = 394,
    ["JSON Feed"] = 395,
    ["JSON Resume"] = 598,
    ["JSON Schema Draft 2020-12"] = 750,
    ["JSON Schema Draft 4"] = 747,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 904,
    ["JSON Schema Draft 7"] = 748,
    ["JSON Schema Draft 7 (unofficial strict)"] = 905,
    ["JSON Schema Draft 8 (2019-09)"] = 749,
    ["JSON-API"] = 393,
    ["JSON-e templates"] = 806,
    ["JSON-stat 2.0"] = 743,
    JSONPatch = 397,
    ...
    ["Metadata for a Cinnamon spice"] = 958,
    ["Metatype Configuration"] = 445,
    ["MetricsHub Configuration"] = 446,
    ["MetricsHub Connector Configuration"] = 447,
    ["Micro Editor Syntax"] = 895,
    ["Microsoft Band Web Tile"] = 448,
    ["Microsoft RulesEngine workflow rules"] = 946,
    ["Microsoft RulesEngine workflow rules list"] = 947,
    ["Minecraft Custom Main Menu Mod"] = 912,
    ...
    ["MongoDB Atlas Search Index Definition"] = 866,
    ["Monika Configuration"] = 864,
    ["Monoweave Configuration"] = 472,
    ["Motif config"] = 763,
    ["NOX Framework (Service)"] = 489,
    ["Netin Diagnostic System Template"] = 824,
    ["Netlify config"] = 480,
    ...
    ["OpenUtau ustx"] = 507,
    ["OpenWeather Current Weather API"] = 805,
    ["OpenWeather Road Risk API"] = 804,
    ...
    ["Pipeline component"] = 816,
    ["Plex Prerolls"] = 543,
    ["PocketMine plugin.yml"] = 540,
    ["Postman collection"] = 547,
    ["Preset list for a WinUtil"] = 961,
    ["Problem object RFC9457"] = 909,
    ...
    Qgoda = 580,
    Qodana = 834,
    ["Qt Creator workspace file"] = 940,
    ["Quali Torque Blueprint Spec 2"] = 859,
    ["QueryFirst config file"] = 877,
    ["RKE Cluster Configuration JSON"] = 813,
    ["RKE Cluster Configuration YAML"] = 812,
    ["Rancher Fleet"] = 574,
    ["Rattler-build"] = 581,
    Ray = 779,
    ["Read the Docs"] = 576,
    ["Red-DiscordBot Cog"] = 588,
    ["Red-DiscordBot Cog Repo"] = 589,
    ["Red-DiscordBot Trivia"] = 590,
    ["Render Blueprints"] = 811,
    RenderCV = 600,
    Renovate = 599,
    ["Replit config"] = 594,
    RoadRunner = 602,
    ["Rudder techniques"] = 915,
    Ruff = 596,
    ["Rust Project"] = 597,
    ["Rust toolchain"] = 606,
    ["SDMX data message"] = 631,
    ["SDMX metadata message"] = 630,
    ["SDMX structure message"] = 629,
    ["SIL Kit Participant Configuration"] = 641,
    ["SIL Kit Registry Configuration"] = 642,
    SWADL = 670,
    ["Safebox Config"] = 872,
    ["Sapphire CLI Config"] = 609,
    ["SauceCTL Configuration"] = 821,
    ["Schema Catalog"] = 623,
    ["Scoop manifest"] = 628,
    ["Semantic Data Fabric (SDF) file"] = 632,
    ["Semgrep Rule"] = 634,
    ["Serenity Code Generator (Sergen)"] = 635,
    ["Serverless Framework Configuration"] = 828,
    ["Serverless Workflow"] = 830,
    ["Settings for a Cinnamon spice"] = 957,
    ["Settings.paf"] = 637,
    ["Shopware 6 Configuration"] = 831,
    ["Shopware CLI Extension Store Configuration"] = 832,
    ["Shopware CLI Project Store Configuration"] = 833,
    ["Sigma Detection Rule"] = 639,
    ["Sigrid scope configuration file"] = 640,
    ["SkyPilot Task JSON"] = 916,
    ["Slack app manifest"] = 644,
    Solidarity = 647,
    ["Solution filters"] = 648,
    ["Source Maps v3"] = 649,
    Sourcery = 650,
    ["Speakeasy Lint Configuration File"] = 651,
    ["Speakeasy Test Generation Configuration File"] = 652,
    ["Speakeasy Workflow File"] = 653,
    SpecIF = 654,
    ["Sponge Mixin configuration"] = 655,
    StackBlitz = 660,
    ["StackHawk Scanner Configuration"] = 827,
    Stale = 661,
    ["Starlake Data Pipeline"] = 802,
    Starship = 662,
    ["Statamic Blueprint"] = 663,
    ["Stella configuration file"] = 664,
    ["Stryker Mutator"] = 667,
    ["StyleCop Analyzers Configuration"] = 668,
    ["Stylelint (.stylelintrc)"] = 669,
    ["Sublime Syntax"] = 873,
    ["Subsquid squid manifest"] = 918,
    ["Swagger API 2.0"] = 671,
    ["Synadia Connect Component"] = 672,
    TSON = 701,
    TSTyche = 702,
    ["Tab data for a LinUtil"] = 963,
    ["Tab list for a LinUtil"] = 962,
    Talhelper = 674,
    ["Talisman configuration"] = 675,
    ["Taskfile config"] = 807,
    Taurus = 676,
    Tauticord = 677,
    ["TestEnvironment.json"] = 686,
    ["TextMate Grammar"] = 685,
    ["Tier.run pricing.json"] = 680,
    Tikibase = 681,
    ["Traefik v2"] = 689,
    ["Traefik v2 File Provider"] = 690,
    ["Travis CI (.travis.yml)"] = 688,
    ["TrueScript for *.tscript files"] = 693,
    TunnelHub = 908,
    Turborepo = 687,
    Tycho = 953,
    Tye = 835,
    ["UET BuildConfig.json"] = 878,
    ["UI5 Manifest"] = 711,
    ["UNCORS configuration"] = 715,
    ["UTAM Page Object"] = 714,
    ["Ubuntu Server Autoinstall"] = 709,
    ["Uniswap Token List"] = 790,
    ["Unreal Engine Uplugin"] = 879,
    ["Unreal Engine Uproject"] = 880,
    ["Updatecli Compose"] = 843,
    ["Updatecli Policy Manifest"] = 844,
    ["Updatecli Policy Metadata"] = 845,
    Uplift = 876,
    ["User Journey Map"] = 810,
    V2Ray = 849,
    ["VSCode Code Snippets"] = 182,
    ["VSIX CLI publishing"] = 732,
    ["Vela Pipeline Configuration"] = 719,
    Vercel = 181,
    ["Version Bumper config"] = 722,
    Visivo = 906,
    ["Waku Config"] = 966,
    ["Web App Manifest"] = 738,
    ["Web types"] = 741,
    WebExtensions = 737,
    ["Webman package recipe"] = 855,
    ["Windows Package Manager Installer Manifest"] = 787,
    ["Windows Package Manager Locale Manifest"] = 788,
    ["Windows Package Manager Singleton Manifest"] = 786,
    ["WireMock stub mapping"] = 969,
    ["Woodpecker pipeline config"] = 823,
    ["Wrangler CLI"] = 742,
    ["Xstate Machine"] = 841,
    ["Yandex Workflow Language"] = 959,
    ["Yarn Config (.yarnrc.yml)"] = 800,
    ["Yippee-Ki-JSON configuration YML"] = 792,
    ["YouTrack App"] = 956,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 910,
    ...
    ["behat.yml"] = 92,
    ["bigquery-table"] = 82,
    ["bioimageio resource description"] = 926,
    ...
    ["crowdin.yml"] = 215,
    ["ctfd-setup configuration file"] = 975,
    ["custom-elements.json"] = 898,
    ["cypress.json"] = 219,
    ...
    ["lint-staged (.lintstagedrc)"] = 758,
    ["local.settings.json"] = 435,
    ["localazy.json"] = 436,
    ["lotus.yaml"] = 434,
    ["lsdlschema.json"] = 437,
    ["markdown-link-check"] = 819,
    mboats = 826,
    ["micro-settings.json"] = 890,
    ["mimetypes.json"] = 449,
    ["mirrord config"] = 759,
    mise = 760,
    ["mkdocs.yml"] = 469,
    ...
    ["plagiarize.yaml"] = 541,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 972,
    ["podbard.yaml"] = 544,
    ["portman.json"] = 545,
    ["prefect.toml"] = 553,
    ["prettierrc.json"] = 554,
    ...
    samt = 607,
    samtrc = 608,
    ["sarif-1.0.0.json"] = 610,
    ["sarif-2.0.0.json"] = 611,
    ["sarif-2.1.0"] = 621,
    ["sarif-2.1.0-rtm.2"] = 612,
    ["sarif-2.1.0-rtm.3"] = 614,
    ["sarif-2.1.0-rtm.4"] = 616,
    ["sarif-2.1.0-rtm.5"] = 618,
    ["sarif-2.1.0-rtm.6"] = 619,
    ["sarif-external-property-file-2.1.0"] = 622,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 613,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 615,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 617,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 620,
    ["schema.org - Action"] = 624,
    ["schema.org - ContactPoint"] = 625,
    ["schema.org - Place"] = 626,
    ["schema.org - Thing"] = 627,
    ["secrethub.yml"] = 893,
    ["semantic-release"] = 633,
    ["servicehub.config.json"] = 753,
    ["servicehub.service.json"] = 752,
    ["settings.job"] = 636,
    ["sfdx-hardis configuration"] = 638,
    ["shard.yml"] = 929,
    ["size-limit configuration"] = 643,
    ["skaffold.yaml"] = 817,
    ["skyuxconfig.json"] = 645,
    snapcraft = 646,
    ["spicepod.yaml"] = 948,
    ["sqlc configuration"] = 657,
    ["stripe-app-local.json"] = 666,
    ["stripe-app.json"] = 665,
    swcrc = 803,
    ["task.json"] = 673,
    taskcat = 769,
    ["template.json"] = 678,
    ["templatsources.json"] = 679,
    ["theme.json"] = 682,
    ["tizen_workspace.json"] = 683,
    tldr = 684,
    tmuxinator = 756,
    ["transcend.yml"] = 691,
    ...
    ["vega-lite.json"] = 718,
    ["vega.json"] = 717,
    ["venvironment-basic.yaml"] = 721,
    ["venvironment.yaml"] = 720,
    ["version.json"] = 723,
    ["vhwdebugger-binding.yaml"] = 725,
    ["vim-addon-info"] = 726,
    ["vs-2017.3.host.json"] = 728,
    ["vs-nesting.json"] = 729,
    ["vsls.json"] = 727,
    ["vss-extension.json"] = 733,
    ["vtesttree.yaml"] = 734,
    ["vtestunit.yaml"] = 735,
    ["warp-keysets.json"] = 899,
    ["warp-themes.json"] = 900,
    ["warp-workflows.json"] = 901,
    ["webhint.io"] = 856,
    ["webjobpublishsettings.json"] = 740,
    ["webjobs-list.json"] = 739,
    ["well-known-fursona"] = 936,
    ["xs-app.json"] = 765,
    ["xunit.runner.json"] = 751,
    yamllint = 791,
    ["zerops.io import file"] = 945,
    ["zerops.yml"] = 944,
    zuul = 775,
    ["Žinoma"] = 785
  },
