...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 900,
    [".nodehawkrc"] = 556,
    [".npmpackagejsonlintrc"] = 560,
    [".omletrc"] = 1078,
    [".phrase.yml"] = 629,
    [".phraseapp.yml"] = 630,
    [".pmbot.yml"] = 615,
    [".postcssrc"] = 624,
    [".powerpages-web-template-manifest"] = 626,
    [".pre-commit-config.yml"] = 627,
    [".pre-commit-hooks.yml"] = 628,
    [".putout.json"] = 658,
    [".rehyperc"] = 683,
    [".remarkrc"] = 687,
    [".sprite files"] = 776,
    ...
    AIConfig = 25,
    ["AMX Muse Program Descriptor"] = 1125,
    ["API Builder"] = 935,
    ["AVA Configuration"] = 998,
    ["AWS AppConfig Feature Flags-v1"] = 58,
    ["AWS CDK cdk.json"] = 241,
    ["AWS CloudFormation"] = 242,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 243,
    ["AWS Copilot Manifest"] = 1164,
    ["AWS SAM CLI Samconfig"] = 244,
    ["Adobe UXP Manifest"] = 1061,
    ["Aerleon Network & Service Definitions"] = 15,
    ["Aerleon Policy"] = 16,
    Aider = 1154,
    Air = 18,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1175,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1174,
    ["Airlock Microgateway"] = 26,
    ["Alacritty Configuration"] = 970,
    ["All Contributors configuration file"] = 1024,
    ["Ansible Argument Specs"] = 376,
    ["Ansible Collection Galaxy"] = 383,
    ["Ansible Execution Environment"] = 373,
    ["Ansible Inventory"] = 382,
    ["Ansible Meta"] = 374,
    ["Ansible Meta Runtime"] = 375,
    ["Ansible Navigator Configuration"] = 385,
    ["Ansible Playbook"] = 380,
    ["Ansible Requirements"] = 377,
    ["Ansible Rulebook"] = 381,
    ["Ansible Tasks File"] = 379,
    ["Ansible Vars File"] = 378,
    ["Ansible-lint Configuration"] = 384,
    Any = 1088,
    ["AnyWork Automation Configuration"] = 11,
    ["Apollo Router"] = 936,
    ["App config Spotify Backstage"] = 30,
    ["Application Accelerator"] = 8,
    ["Application list for a WinUtil"] = 1105,
    ArchitectFX = 1110,
    ["Argo CD"] = 45,
    ["Argo Events"] = 46,
    ["Argo Workflows"] = 47,
    AssemblyScript = 50,
    AsyncAPI = 53,
    ["AsyncAPI Tool File"] = 54,
    ["Atmos Manifests"] = 55,
    ["Aurora Agile Meta-Framework"] = 56,
    AutoAPICase = 1034,
    ["Avro Avsc"] = 57,
    ["Azure Container App template for defining an immutable revision"] = 59,
    ["Azure DevOps extension manifest"] = 62,
    ["Azure Device Update for IoT Hub import manifest"] = 60,
    ["Azure Device Update for IoT Hub update manifest"] = 61,
    ["Azure IoT Edge deployment"] = 65,
    ["Azure IoT Edge deployment template"] = 66,
    ["Azure IoT EdgeAgent deployment"] = 63,
    ["Azure IoT EdgeHub deployment"] = 64,
    ["Azure IoT Operations Wasm Graph Config"] = 1173,
    ["Azure IoT Operations connector metadata"] = 1170,
    ["Azure Landing Zones Library archetype definition"] = 70,
    ["Azure Landing Zones Library archetype override"] = 71,
    ["Azure Landing Zones Library architecture definition"] = 69,
    ["Azure Landing Zones Library metadata"] = 67,
    ["Azure Landing Zones Library policy default values"] = 68,
    ["Azure Pipelines"] = 99,
    ["Azure Static Web Apps CLI configuration file"] = 780,
    ["Azure Static Web Apps configuration file"] = 779,
    ["BOSH CPI Config"] = 123,
    ["BOSH Deploy Config"] = 124,
    ["BX CI"] = 143,
    ["Bacon config"] = 2,
    ["Bashly (bashly.yml)"] = 1028,
    ["Bashly Settings (bashly-settings.yml)"] = 1029,
    ["Better Code Hub"] = 940,
    ["Better Scripts"] = 144,
    Bigconfig = 116,
    ["Biome Formatter Config"] = 72,
    ["Bitmovin Encoding Template"] = 1118,
    BizTalkServerApplicationSchema = 907,
    Bleep = 145,
    ["Block Protocol Metadata"] = 142,
    ["Boyka Framework"] = 125,
    Briefcase = 913,
    ["Build Info"] = 133,
    Buildkite = 135,
    ["Bukkit plugin.yml"] = 134,
    ["BungeeCord plugin.yml"] = 140,
    ["Butane Config"] = 983,
    C4InterFlow = 1133,
    ["CDK Environment Manager, concrete environment configuration"] = 1157,
    ["CDK Environment Manager, concrete environments definition"] = 1156,
    ["CDK Environment Manager, environment definition"] = 1155,
    ["CGS Card Game Specification (cgs.json)"] = 1066,
    ["CICS TS region tagging"] = 992,
    ["CICS TS resource import"] = 993,
    ["CICS TS resource model"] = 994,
    ["CICS TS resource overrides"] = 995,
    ["CMake Presets"] = 146,
    ["CNC Codes"] = 167,
    ["CRS WAF test file"] = 1095,
    ["CRS WAF test platform overrides file"] = 1096,
    ["CSS Comb (.csscomb.json)"] = 269,
    ["CSS Lint (.csslintrc)"] = 270,
    ["CSpell (cspell.json)"] = 268,
    ["CVE Record Format"] = 175,
    CWL = 1072,
    ["Cache Warmup config"] = 147,
    ["Calqulus pipeline"] = 148,
    ["Camel YAML DSL"] = 149,
    ["Cannon TOML"] = 150,
    Carafe = 151,
    ["Cargo Make"] = 153,
    ["Cargo Manifest"] = 152,
    ["Catalog Info Backstage"] = 154,
    ...
    Charmcraft = 156,
    Cheatsheets = 980,
    ["ChordPro Configuration"] = 157,
    ["Chrome Extension"] = 234,
    ["Chromia Model"] = 158,
    ["Chromia Seeder Module Config"] = 160,
    ["Chromia Seeder Root Config"] = 159,
    ["Cinnamon Spice info.json"] = 79,
    ["CircleCI config.yml"] = 210,
    ["Citation File Format"] = 255,
    CityJSON = 162,
    ["Claude Code Settings"] = 174,
    ["Clawject config"] = 173,
    ["Cloud Foundry Application Manifest"] = 1077,
    ["Cloud Run Spec v1"] = 1100,
    ["Cloud.gov Workshop Configuration"] = 80,
    ["CloudCannon Configuration"] = 85,
    ["CloudCannon Configuration (Collection Structures)"] = 94,
    ["CloudCannon Configuration (Collections)"] = 93,
    ["CloudCannon Configuration (Editables)"] = 92,
    ["CloudCannon Configuration (Inputs)"] = 87,
    ["CloudCannon Configuration (Snippets Definitions)"] = 91,
    ["CloudCannon Configuration (Snippets Imports)"] = 90,
    ["CloudCannon Configuration (Snippets)"] = 89,
    ["CloudCannon Configuration (Structure Value)"] = 88,
    ["CloudCannon Configuration (Structures)"] = 86,
    ["CloudEvents specification"] = 163,
    ["Code Climate"] = 211,
    CodeCV = 83,
    CodeRabbit = 82,
    ["CodeShip Pro services configuration files"] = 223,
    ["CodeShip Pro steps configuration files"] = 224,
    ["Codecov configuration files"] = 222,
    CodifyCLI = 84,
    Codux = 220,
    ["Cog config file"] = 168,
    ["Commandbox Box.json"] = 169,
    ["Commandbox Server.json"] = 170,
    ["Common Catalog Data"] = 232,
    ["Common Package Specification"] = 171,
    Concord = 1094,
    ["Configu .cfgu files"] = 1082,
    ["Configu .configu file"] = 1083,
    Conjure = 166,
    ["Container Structure Test"] = 921,
    Containerlab = 949,
    ["Contextive Glossary"] = 1149,
    Convex = 165,
    ["Crowdsec collection config"] = 263,
    ["Crowdsec parser config"] = 264,
    ["Crowdsec scenario config"] = 265,
    ["CumulusCI Config"] = 172,
    ["Custom Machinery Machine"] = 1067,
    ["Custom Machinery Recipe"] = 1068,
    ["Cycle Stack File"] = 176,
    CycloneDX = 177,
    ["DWP Exchange - catalogue entry"] = 312,
    ["DWP Exchange - gateway"] = 310,
    ["DWP Exchange - meta"] = 311,
    ["Dart Build Config (dart-build.json)"] = 271,
    ["Dart Test Config (dart-test.json)"] = 272,
    ["DashLord Configuration"] = 273,
    ["Data Contract Specification"] = 274,
    ["Data Product Specification"] = 275,
    ["DataYoga Connections"] = 178,
    ["DataYoga Job"] = 179,
    ["Databricks Asset Bundles"] = 1045,
    ["Datadog Continuous Testing"] = 475,
    ["Datadog Service Definition"] = 476,
    ["Datadog Software Catalog"] = 477,
    ["Datahub Ingestion Recipe"] = 999,
    ["Debian Upstream Metadata file"] = 185,
    ["Deck config"] = 186,
    ["Dein Config"] = 187,
    ["Deno Config (deno.json)"] = 281,
    ["Dependency cruiser"] = 188,
    ["DeployStack Configuration"] = 189,
    ["Deployah Configuration"] = 1172,
    ["Deployer Recipe"] = 284,
    ["Deta Spacefile"] = 190,
    ["Detekt Config (detekt.yml)"] = 285,
    ["Devbox Config"] = 191,
    ["Devbox Plugin"] = 192,
    Devfile = 309,
    DipDup = 1097,
    ...
    Dofigen = 291,
    ["Dolittle Artifacts"] = 292,
    ["Dolittle Bounded Context Configuration"] = 293,
    ["Dolittle Event Horizons Configuration"] = 294,
    ["Dolittle Resources Configuration"] = 295,
    ["Dolittle Server Configuration"] = 296,
    ["Dolittle Tenant Map Configuration"] = 298,
    ["Dolittle Tenants Configuration"] = 297,
    ["Dolittle Topology"] = 299,
    ["DonateCaseBetterCasino menu"] = 1126,
    ["Drupal Breakpoints"] = 193,
    ["Drupal Config"] = 205,
    ["Drupal Info"] = 194,
    ["Drupal Layouts"] = 195,
    ["Drupal Libraries"] = 196,
    ["Drupal Links Action"] = 197,
    ["Drupal Links Contextual"] = 198,
    ["Drupal Links Menu"] = 199,
    ["Drupal Links Task"] = 200,
    ["Drupal Migration"] = 201,
    ["Drupal Permissions"] = 202,
    ["Drupal Recipe"] = 203,
    ["Drupal Routing"] = 204,
    ["Drupal Services"] = 206,
    ["Drush site aliases"] = 305,
    ["Dynamic Bash Aliases (.aliases)"] = 1036,
    ["EAS config"] = 329,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1025,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1169,
    ["EasyVCR .NET"] = 330,
    ["Eidolon Resource"] = 1111,
    ["Elgato Stream Deck"] = 315,
    Elm = 1099,
    ["Embrace Config"] = 1011,
    Endurica = 1049,
    ["Enterprise Contract Policy Spec"] = 316,
    ["Erda Pipeline"] = 1074,
    ["Erda Runtime"] = 1075,
    Esquio = 318,
    ["Estuary Flow Catalog"] = 989,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 322,
    ["EveryVoice TTS Toolkit Data Configuration"] = 323,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 327,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 326,
    ["EveryVoice TTS Toolkit Text Configuration"] = 324,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 325,
    ["Evolving Resolutive Process notation"] = 1171,
    ["Expo SDK"] = 328,
    ["F-Droid Data metadata"] = 334,
    ["FasterCI Configuration"] = 100,
    FiQuS = 338,
    Firebase = 336,
    ["FlexGet Config"] = 339,
    ["Flow.json Configurations"] = 1071,
    ["Fossa configuration file"] = 346,
    ["Fossa's fossa-deps file"] = 347,
    ["Foundry VTT - Base package Manifest"] = 341,
    ["Foundry VTT - Module Manifest"] = 342,
    ["Foundry VTT - System Data Template"] = 345,
    ["Foundry VTT - System Manifest"] = 343,
    ["Foundry VTT - World Manifest"] = 344,
    ["Foxx Manifest"] = 101,
    ["Freifunk.de Community API"] = 104,
    ["Frogbot Config"] = 105,
    ["G2P Mapping Configuration"] = 353,
    ["GCP Blueprint Metadata"] = 356,
    Gaspar = 354,
    ["GatewayCore API Gateway"] = 355,
    ["Gemini CLI settings"] = 357,
    ["GeoJSON.json latest"] = 987,
    GherKing = 991,
    ["GitHub Action"] = 362,
    ["GitHub Actions typing"] = 1107,
    ["GitHub Discussion"] = 363,
    ["GitHub Funding"] = 364,
    ["GitHub Issue Template configuration"] = 365,
    ["GitHub Issue Template forms"] = 366,
    ["GitHub Workflow"] = 367,
    ["GitHub Workflow Template Properties"] = 368,
    ["GitHub automatically generated release notes configuration"] = 369,
    ["GitLab Agent for Kubernetes configuration"] = 1063,
    GitVersion = 359,
    ["Gitea Issue Template configuration"] = 360,
    ["Gitea Issue Template forms"] = 361,
    ["Gitpod Automations"] = 371,
    ["Gitpod Configuration"] = 372,
    ["GlazeWM settings"] = 1065,
    ["Global Privacy Control"] = 358,
    Goblet = 1044,
    ["Golangci-lint Configuration"] = 387,
    ["Golangci-lint Custom Plugins Configuration"] = 388,
    ["Google Chrome Related Website Sets"] = 337,
    ["Google Cloud Workflows"] = 240,
    ["Google Digital Assetlinks"] = 1150,
    Goreleaser = 390,
    ["Goreleaser Pro"] = 391,
    Goss = 392,
    ["Gradle Build Cache Node"] = 938,
    ["Gradle Enterprise"] = 937,
    ["Grafana 5.x Dashboard"] = 393,
    ["GraphQL Code Generator"] = 398,
    ["GraphQL Config"] = 397,
    ["GraphQL Mesh"] = 396,
    ["GroovyLint configuration"] = 399,
    ["Grunt JSHint task"] = 403,
    ["Grunt Watch task"] = 404,
    ["Grunt base task"] = 405,
    ["Grunt clean task"] = 401,
    ["Grunt copy task"] = 400,
    ["Grunt cssmin task"] = 402,
    HEMTT = 903,
    Hadolint = 917,
    Hammerkit = 948,
    ["Hardware Sentry Configuration"] = 1003,
    ["HashiCorp Vault"] = 406,
    Hatch = 918,
    Hayagriva = 408,
    Hayson = 409,
    ["Haystack Pipeline"] = 410,
    ["Hazelcast 5 Configuration"] = 411,
    ["Hecate Input Schema"] = 1161,
    ["Helm Chart.lock"] = 208,
    ["Helm Chart.yaml"] = 207,
    ["Helm Unittest Test Suite"] = 209,
    ["Home Assistant Integration Manifest"] = 412,
    ["Homer dashboard configuration"] = 413,
    Hugo = 979,
    ["Hugo Theme"] = 978,
    ["Hulak Configuration"] = 420,
    ["Hyperfoil benchmark configuration"] = 419,
    ["IBM Zapp document"] = 421,
    ["IBM zCodeFormatSettings"] = 422,
    ["IMG Catapult PSP"] = 427,
    ["IVMS101 by CODE Protocol"] = 1064,
    Infrahub = 429,
    Istanbul = 1007,
    ["JDownloader2 crawler multi-rules"] = 442,
    ["JDownloader2 crawler single-rules"] = 441,
    ["JFrog Applications Config"] = 443,
    ["JFrog File Spec"] = 444,
    ["JFrog Pipelines YML DSL"] = 1013,
    ["JMeter DSL cli config"] = 445,
    JReleaser = 448,
    ["JSON Document Transform"] = 456,
    ["JSON Feed"] = 457,
    ["JSON Resume"] = 693,
    ["JSON Schema Draft 2020-12"] = 885,
    ["JSON Schema Draft 4"] = 882,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1046,
    ["JSON Schema Draft 7"] = 883,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1047,
    ["JSON Schema Draft 8 (2019-09)"] = 884,
    ["JSON-API"] = 455,
    ["JSON-e templates"] = 945,
    ["JSON-stat 2.0"] = 878,
    JSONPatch = 459,
    ["JSR Package Config (jsr.json)"] = 449,
    Jarl = 1177,
    Jasmine = 436,
    Jekyll = 437,
    ["Jenkins X Pipelines"] = 438,
    ["Jenkins X Requirements"] = 439,
    Jest = 440,
    Jocker = 446,
    ["Jovo Language Models"] = 447,
    ["Jujutsu (jj) VCS config"] = 1163,
    ["KIMMDY config file"] = 470,
    ["KODE/CI build.yaml"] = 1009,
    ["KSP-AVC"] = 879,
    ["KSP-CKAN"] = 880,
    ["KSP-NetKAN"] = 881,
    KSY = 1076,
    KSail = 351,
    ["Karakum configuration file"] = 348,
    Kas = 462,
    ["Kestra flow file"] = 471,
    ["Keycloak REST API"] = 1016,
    ["Knative Functions - func.yaml"] = 349,
    Knip = 350,
    ["Kometa (nightly) config file"] = 473,
    ["Kometa config file"] = 472,
    ["Kong DBLess config"] = 1010,
    KrakenD = 474,
    ["Kubri Configuration"] = 481,
    LOOBin = 496,
    ["Lake configuration file"] = 1166,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 245,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 246,
    ["Landing Zone Accelerator on AWS - Global Config"] = 247,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 248,
    ["Landing Zone Accelerator on AWS - Network Config"] = 249,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 250,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 251,
    ["Landing Zone Accelerator on AWS - Security Config"] = 252,
    ["Lando (landofile)"] = 95,
    ["LangGraph Platform configuration"] = 1087,
    ["Language configuration"] = 1086,
    Lefthook = 485,
    ["Liferay client-extension.yaml"] = 492,
    ["LinkML Metamodel"] = 494,
    Liquibase = 954,
    ["Liquibase Flow File"] = 955,
    ["Lively Properties"] = 495,
    ["Lobe AI Agent"] = 97,
    Loki = 98,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 536,
    ["MS2Rescore Configuration"] = 539,
    ["Madness (madness.yml)"] = 1027,
    ["Mado configuration"] = 502,
    ["MapEHR Mapping"] = 503,
    Markdownlint = 958,
    ["Mason Registry"] = 961,
    ["MegaLinter Custom Flavor"] = 506,
    ["MegaLinter configuration"] = 505,
    ["MegaLinter descriptor"] = 507,
    Melange = 1054,
    ["Meltano project definition"] = 508,
    ["Mergify Configuration"] = 540,
    ["Metadata for a Bazel module"] = 509,
    ["Metadata for a Cinnamon spice"] = 1103,
    ["Metatype Configuration"] = 510,
    ["MetricsHub Configuration"] = 511,
    ["MetricsHub Connector Configuration"] = 512,
    ["Micro Editor Syntax"] = 1037,
    ["Microsoft Band Web Tile"] = 513,
    ["Microsoft RulesEngine workflow rules"] = 1091,
    ["Microsoft RulesEngine workflow rules list"] = 1092,
    ["Minecraft Custom Main Menu Mod"] = 1055,
    ["Minecraft Data Pack Advancement"] = 515,
    ["Minecraft Data Pack Biome"] = 516,
    ["Minecraft Data Pack Configured Carver"] = 517,
    ["Minecraft Data Pack Damage Type"] = 518,
    ["Minecraft Data Pack Dimension"] = 520,
    ["Minecraft Data Pack Dimension Type"] = 519,
    ["Minecraft Data Pack Item Modifier"] = 521,
    ["Minecraft Data Pack Loot Table"] = 522,
    ["Minecraft Data Pack Metadata"] = 523,
    ["Minecraft Data Pack Predicate"] = 524,
    ["Minecraft Data Pack Recipe"] = 525,
    ["Minecraft Data Pack Tag"] = 526,
    ["Minecraft Data Pack Template Pool"] = 527,
    ["Minecraft Data Pack Trim Material"] = 532,
    ["Minecraft Data Pack Trim Pattern"] = 533,
    ["Minecraft Resource Pack Lang"] = 528,
    ["Minecraft Resource Pack Particle"] = 529,
    ["Minecraft Resource Pack Texture Mcmeta"] = 531,
    ["Minecraft Resourcepack Sounds"] = 530,
    ["Monade CLI Stack Configuration"] = 543,
    ["MongoDB Atlas Search Index Definition"] = 1008,
    ["Monika Configuration"] = 1006,
    ["Monoweave Configuration"] = 538,
    ["Motif config"] = 899,
    MultiQC = 1143,
    ["NOX Framework (Service)"] = 559,
    ["Netin Diagnostic System Template"] = 965,
    ["Netlify config"] = 546,
    ["Network-as-Code Data Model"] = 547,
    ["Next Gen UI Agent A2A Server Configuration"] = 548,
    ["Next Gen UI Agent Configuration"] = 550,
    ["Next Gen UI Agent MCP Server Configuration"] = 549,
    ["Nightwatch.js"] = 552,
    ["Node.js configuration"] = 904,
    ["NueJS configuration file"] = 564,
    ["Nuitka.yaml"] = 1069,
    ["Nullstone config"] = 566,
    ["ONe's changelog entry"] = 583,
    ["ONe's service descriptor"] = 582,
    ["ORT Server repository environment configuration"] = 591,
    ["OSCAL Assessment Plan (AP)"] = 593,
    ["OSCAL Assessment Results (AR)"] = 594,
    ["OSCAL Catalog"] = 595,
    ["OSCAL Component Definition (CDef)"] = 596,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 597,
    ["OSCAL Profile"] = 598,
    ["OSCAL System Security Plan (SSP)"] = 599,
    ["OSS Review Toolkit configuration"] = 600,
    ["OSS Review Toolkit curation"] = 601,
    ["OSS Review Toolkit package configuration"] = 602,
    ["OSS Review Toolkit repository configuration"] = 603,
    ["OSS Review Toolkit resolutions"] = 604,
    ["October CMS columns"] = 570,
    ["October CMS fields"] = 571,
    ["Oh My Posh"] = 572,
    Okteto = 573,
    ["Ona Automations"] = 575,
    Opctl = 902,
    ["Open Data Contract Standard (ODCS)"] = 586,
    ["Open Data Product Standard (ODPS)"] = 587,
    ["Open Know-How"] = 1148,
    ["OpenRewrite Resource"] = 585,
    OpenStatus = 1159,
    ["OpenUtau character yaml"] = 579,
    ["OpenUtau ustx"] = 580,
    ["OpenWeather Current Weather API"] = 944,
    ["OpenWeather Road Risk API"] = 943,
    ["Ory Hydra configuration"] = 418,
    ["Ory Keto configuration"] = 478,
    ["Ory Kratos configuration"] = 592,
    ["Ory Oathkeeper configuration"] = 568,
    ["Outblocks App configuration"] = 589,
    ["Outblocks database table"] = 590,
    ["Outblocks project configuration"] = 588,
    PDM = 611,
    POPxf = 621,
    ["POPxf Correlations"] = 622,
    Packer = 608,
    Pantsbuild = 1023,
    ["Paper paper-plugin.yml"] = 609,
    ["Pipeline component"] = 956,
    ["Platform.sh application"] = 4,
    ["Platform.sh routes"] = 5,
    ["Platform.sh services"] = 6,
    ["Plex Prerolls"] = 619,
    ["PocketMine plugin.yml"] = 616,
    ["Postman collection"] = 625,
    ["Power Pages Configuration"] = 1160,
    ["Preset list for a WinUtil"] = 1106,
    ["ProActions AI-Kit Configuration"] = 634,
    ["ProActions AI-Kit Configuration for Menus"] = 636,
    ["ProActions AI-Kit Configuration for Sections"] = 638,
    ["ProActions AI-Kit Configuration for Services"] = 635,
    ["ProActions AI-Kit Configuration for Steps"] = 639,
    ["ProActions AI-Kit Configuration for Templates"] = 637,
    ["Problem object RFC9457"] = 1052,
    ["Problem package generators"] = 640,
    Pterodactyl = 1002,
    ["Pull Request Labeler"] = 657,
    Pulumi = 665,
    ["PyGTA Config"] = 661,
    PyProject = 666,
    Pylock = 1151,
    Pyright = 667,
    ["Python script metadata"] = 1145,
    ["QType AI DSL"] = 670,
    Qgoda = 669,
    Qodana = 975,
    ["Qt Creator workspace file"] = 1084,
    ["Quali Torque Blueprint Spec 2"] = 1000,
    ["QueryFirst config file"] = 1019,
    ["RKE Cluster Configuration JSON"] = 953,
    ["RKE Cluster Configuration YAML"] = 952,
    RadioHound = 660,
    Railpack = 672,
    Railway = 671,
    ["Rancher Fleet"] = 662,
    ...
    Ray = 916,
    ["Read the Docs"] = 664,
    ["Red-DiscordBot Cog"] = 680,
    ["Red-DiscordBot Cog Repo"] = 681,
    ["Red-DiscordBot Trivia"] = 682,
    ["Render Blueprints"] = 951,
    RenderCV = 695,
    Renovate = 694,
    ["Replit config"] = 688,
    Restate = 1138,
    ["Revel Digital Gadget Definition File"] = 1162,
    RoadRunner = 697,
    ["Robust Station Image"] = 1168,
    Rockcraft = 698,
    ["Roo Coder Custom Modes"] = 699,
    Rubocop = 690,
    ["Rudder techniques"] = 1059,
    Ruff = 691,
    ["Rust Project"] = 692,
    ["Rust toolchain"] = 703,
    ["SDMX data message"] = 729,
    ["SDMX metadata message"] = 728,
    ["SDMX structure message"] = 727,
    ["SIL Kit Participant Configuration"] = 739,
    ["SIL Kit Registry Configuration"] = 740,
    ["SPDX 2.3"] = 777,
    SWADL = 793,
    ["Safebox Config"] = 1014,
    ["Sapphire CLI Config"] = 706,
    ["SauceCTL Configuration"] = 962,
    ["Schema Catalog"] = 721,
    ["Scoop manifest"] = 726,
    ["Semantic Data Fabric (SDF) file"] = 730,
    ["Semgrep Rule"] = 732,
    ["Serenity Code Generator (Sergen)"] = 733,
    ["Serverless Framework Configuration"] = 969,
    ["Serverless Workflow"] = 971,
    ["Settings for a Cinnamon spice"] = 1102,
    ["Settings.paf"] = 735,
    ["Shopware 6 Configuration"] = 972,
    ["Shopware CLI Extension Store Configuration"] = 973,
    ["Shopware CLI Project Store Configuration"] = 974,
    ["Sigma Detection Rule"] = 737,
    ["Sigrid scope configuration file"] = 738,
    ["SkyPilot Task JSON"] = 1060,
    ["Slack app manifest"] = 742,
    Snapcraft = 744,
    Solidarity = 747,
    ["Solution filters"] = 748,
    ["Source Maps v3"] = 749,
    Sourcery = 750,
    ["Spack bootstrap.yaml"] = 751,
    ["Spack cdash.yaml"] = 752,
    ["Spack ci.yaml"] = 753,
    ["Spack compilers.yaml"] = 754,
    ["Spack concretizer.yaml"] = 755,
    ["Spack config.yaml"] = 756,
    ["Spack definitions.yaml"] = 757,
    ["Spack develop.yaml"] = 758,
    ["Spack env_vars.yaml"] = 759,
    ["Spack environment"] = 765,
    ["Spack include.yaml"] = 760,
    ["Spack mirrors.yaml"] = 761,
    ["Spack modules.yaml"] = 762,
    ["Spack packages.yaml"] = 763,
    ["Spack repos.yaml"] = 764,
    ["Spack toolchains.yaml"] = 766,
    ["Spack upstreams.yaml"] = 767,
    ["Spack view.yaml"] = 768,
    ["Speakeasy Generation Config File"] = 772,
    ["Speakeasy Lint Configuration File"] = 769,
    ["Speakeasy Test Generation Configuration File"] = 770,
    ["Speakeasy Workflow File"] = 771,
    SpecIF = 773,
    ["Specmatic Configuration"] = 774,
    ["Sponge Mixin configuration"] = 775,
    StackBlitz = 781,
    ["StackHawk Scanner Configuration"] = 968,
    Stale = 782,
    Starfish = 783,
    ["Starlake Data Pipeline"] = 941,
    Starship = 784,
    ["Statamic Blueprint"] = 785,
    ["Stella configuration file"] = 786,
    ["Streamlit configuration file"] = 787,
    ["Stryker Mutator"] = 790,
    ["StyleCop Analyzers Configuration"] = 791,
    ["Stylelint (.stylelintrc)"] = 792,
    ["Stylua Config"] = 1152,
    ["Sublime Syntax"] = 1015,
    ["Subsquid squid manifest"] = 1062,
    ["Swagger API 2.0"] = 794,
    ["Synadia Connect Component"] = 795,
    TSON = 830,
    TSTyche = 831,
    ["TYPO3 Vendor Bundler config"] = 836,
    ["Tab data for a LinUtil"] = 1109,
    ["Tab list for a LinUtil"] = 1108,
    Tach = 796,
    ["Tach Domain"] = 797,
    Talhelper = 799,
    ["Talisman configuration"] = 800,
    Taplo = 1153,
    ["Taskfile config"] = 946,
    Taurus = 801,
    Tauticord = 802,
    ["Tekton Pipeline"] = 1181,
    ["Tekton PipelineRun"] = 1182,
    ["Tekton Task"] = 1179,
    ["Tekton TaskRun"] = 1180,
    Telefonistka = 1139,
    ["Terrateam config"] = 1165,
    ["TestEnvironment.json"] = 813,
    ["TextMate Grammar"] = 812,
    Threagile = 808,
    ["Tier.run pricing.json"] = 805,
    Tikibase = 806,
    Tombi = 811,
    ["Traefik v2"] = 816,
    ["Traefik v2 File Provider"] = 817,
    ["Traefik v3"] = 818,
    ["Traefik v3 File Provider"] = 819,
    ["Travis CI (.travis.yml)"] = 815,
    Treefmt = 395,
    Trident = 1135,
    ["TrueScript for *.tscript files"] = 822,
    ["Tugboat QA config.yml"] = 1132,
    TunnelHub = 1050,
    Turborepo = 814,
    Tycho = 1098,
    Tye = 976,
    ["Tyk Gateway - Open Source v5.7+"] = 1144,
    ["Typst Manifest"] = 837,
    ["UET BuildConfig.json"] = 1020,
    ["UI5 Manifest"] = 843,
    ["UNCORS configuration"] = 847,
    ["UTAM Page Object"] = 846,
    ["Ubuntu Server Autoinstall"] = 841,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1136,
    ["Uniswap Token List"] = 928,
    ["Universal Schedule Format"] = 848,
    ["Unreal Engine Uplugin"] = 1021,
    ["Unreal Engine Uproject"] = 1022,
    ["UpCloud CLI (upctl) configuration"] = 1137,
    ["Updatecli Compose"] = 984,
    ["Updatecli Policy Manifest"] = 985,
    ["Updatecli Policy Metadata"] = 986,
    Uplift = 1018,
    ["Upsun config"] = 3,
    ["User Journey Map"] = 950,
    V2Ray = 990,
    ["VSCode Code Snippets"] = 228,
    ["VSIX CLI publishing"] = 866,
    Vector = 850,
    ["Vela Pipeline Configuration"] = 853,
    Vercel = 227,
    ["Version Bumper config"] = 856,
    ["Viash Component Config"] = 1141,
    ["Viash Package Config"] = 1142,
    Visivo = 1048,
    ["WP-CLI"] = 876,
    Wake = 1134,
    ["Waku Config"] = 1112,
    ["Web App Manifest"] = 872,
    ["Web types"] = 875,
    WebExtensions = 871,
    ["Webman package recipe"] = 996,
    ["Windows Package Manager Installer Manifest"] = 924,
    ["Windows Package Manager Locale Manifest"] = 925,
    ["Windows Package Manager Singleton Manifest"] = 923,
    Winutil = 926,
    ["WireMock CLI import configuration"] = 1117,
    ["WireMock CLI local service configuration"] = 1116,
    ["WireMock stub mapping"] = 1115,
    ["Woodpecker pipeline config"] = 964,
    ["Wrangler CLI"] = 877,
    ["Xstate Machine"] = 982,
    ["Yandex Workflow Language"] = 1104,
    ["Yarn Config (.yarnrc.yml)"] = 939,
    ["Yippee-Ki-JSON configuration YML"] = 930,
    ["YouTrack App"] = 1101,
    ["Zarf Package Configuration"] = 1167,
    ["Zerops.io config"] = 1089,
    ["Zerops.io import"] = 1090,
    ["Zola Configuration"] = 1178,
    ["aerleon.yml"] = 14,
    ["angular.json"] = 27,
    apko = 1053,
    ...
    ["arc.json"] = 44,
    ["architect.yml"] = 43,
    ["artifacthub-repo.yml"] = 48,
    ["asm-lsp"] = 49,
    ["ast-grep rules"] = 52,
    ["ast-grep sgconfig.yml"] = 51,
    ["babelrc.json"] = 107,
    ["bamboo-spec"] = 110,
    ["bashly-strings.yml"] = 1030,
    ["batect.yml"] = 109,
    ["beef-database-codegen"] = 111,
    ["beef-database-v5-codegen"] = 113,
    ["beef-entity-codegen"] = 112,
    ["beef-entity-v5-codegen"] = 114,
    ["behat.yml"] = 126,
    ["bigquery-table"] = 115,
    ["bioimageio resource description"] = 1070,
    ["bitbucket-pipelines"] = 117,
    bitrise = 118,
    ["bitrise-step"] = 119,
    ["block.json"] = 141,
    ["bottom configuration"] = 73,
    ["bower.json"] = 121,
    ["bozr.suite.json"] = 128,
    bpkg = 1031,
    ["browser.i18n.json"] = 129,
    ["browsh configuration"] = 130,
    bucklescript = 131,
    ["buf.gen.yaml"] = 75,
    ["buf.plugin.yaml"] = 76,
    ["buf.work.yaml"] = 77,
    ...
    ["build-changelog"] = 132,
    ["bun.lock"] = 137,
    ["bundleconfig.json"] = 138,
    ["bunfig.toml"] = 139,
    ["cargo-mutants-config.yaml"] = 78,
    ["ccmod.json"] = 1113,
    changelogging = 1081,
    ["chisel-slices.json"] = 254,
    ["chrome-extension-locales-messages.json"] = 235,
    ["chutzpah.json"] = 236,
    cibuildwheel = 161,
    ["clang-format (.clang-format)"] = 988,
    ["clang-tidy"] = 215,
    clangd = 214,
    clib = 216,
    ["cloud-init: cloud-config userdata"] = 218,
    ["cloud-sdk-pipeline-configuration"] = 238,
    ["cloudbuild.json"] = 239,
    cloudify = 217,
    ["cmdx.yaml"] = 81,
    codemagic = 219,
    ["coffeelint.json"] = 256,
    ["commands.json"] = 231,
    ["commitlint (.commitlintrc)"] = 927,
    ["committed.toml"] = 257,
    ["compile_commands.json"] = 230,
    ["compilerconfig.json"] = 229,
    ["completely.yml"] = 1026,
    ["component-detection-manifest.json"] = 260,
    ["component.json"] = 259,
    ["composer.json"] = 258,
    ["conda-forge"] = 164,
    ["config.yaml"] = 663,
    ["contentmanifest.json"] = 237,
    ["contribute.json"] = 261,
    ["cosmos.config.json"] = 233,
    ["crowdin.yml"] = 262,
    ["ctfd-setup configuration file"] = 1124,
    ["custom-elements.json"] = 1040,
    ["cypress.json"] = 266,
    ["datalogic-scan2deploy-android"] = 276,
    ["datalogic-scan2deploy-ce"] = 277,
    ["dbt Dependencies"] = 180,
    ["dbt Packages"] = 182,
    ["dbt Project"] = 181,
    ["dbt Selectors"] = 183,
    ["dbt YAML files"] = 184,
    ["ddev-global"] = 278,
    ["ddev-project"] = 279,
    ["debugsettings.json"] = 280,
    ["dependabot-v2.json"] = 283,
    ["dependabot.json"] = 282,
    ["deployed-cli"] = 981,
    ["devcontainer.json"] = 221,
    devinit = 932,
    ["devspace.yaml"] = 1004,
    djlint = 933,
    ["docker bake"] = 288,
    ["docker sequencer"] = 289,
    ["docker-compose.yml"] = 931,
    ["dockerd.json"] = 287,
    ["dotnet Release Index manifest"] = 300,
    ["dotnet-tools.json"] = 301,
    ["dotnetcli.host.json"] = 302,
    ["dprint.json"] = 303,
    ["drone.json"] = 304,
    ["dss-2.0.0.json"] = 306,
    ["dstack configuration"] = 307,
    ["dtool dataset metadata"] = 1119,
    ["dvc.yaml"] = 308,
    ["ecosystem.json"] = 313,
    eksctl = 314,
    ["electron-builder configuration file"] = 320,
    ["epr-manifest.json"] = 319,
    ["evcc.yaml"] = 321,
    ["ezd task runner"] = 331,
    ["fabric.mod.json"] = 333,
    ["first-timers-bot"] = 340,
    ["flagd flag configuration"] = 102,
    ["fly.io Configuration"] = 103,
    fulibWorkflows = 963,
    ["function.json"] = 352,
    ["gRPC API Gateway & OpenAPI Config"] = 9,
    ["gematik health care insurance list"] = 1130,
    ["gematik health care patient list"] = 1127,
    ["gematik health care provider institution list"] = 1129,
    ["gematik health care provider list"] = 1128,
    ["gematik tiger test environment configuration"] = 1131,
    ["git-town.toml"] = 1176,
    ["gitlab-ci"] = 370,
    ["global.json"] = 386,
    ["go-feature-flag Flag Configuration"] = 389,
    ["haxelib.json"] = 407,
    helmfile = 919,
    helmwave = 920,
    ["host-meta.json"] = 415,
    ...
    ["ide.host.json"] = 423,
    ["ifstate.yaml"] = 424,
    ["imageoptimizer.json"] = 425,
    ["importmap.json"] = 428,
    instant_python_config = 430,
    instant_python_custom_project = 431,
    ["ioBroker Configuration"] = 432,
    ["ioBroker JSON UI"] = 433,
    ["ioBroker Package manifest"] = 434,
    ["ixpect.conf.yaml"] = 435,
    ["ize.toml"] = 1017,
    ["jsconfig.json"] = 460,
    ["jscpd Configuration"] = 1001,
    jsdoc = 915,
    ["k3d.yaml"] = 461,
    ["k9s aliases.yaml"] = 463,
    ["k9s cluster-config.yaml"] = 465,
    ["k9s config.yaml"] = 464,
    ["k9s hotkeys.yaml"] = 466,
    ["k9s plugins.yaml"] = 467,
    ["k9s skin.yaml"] = 468,
    ["k9s views.yaml"] = 469,
    ["kontinuous-config.yaml"] = 480,
    ["kontinuous-values.yaml"] = 479,
    ["kustomization.yaml"] = 482,
    ["label-commenter-config.yml"] = 483,
    ["latexindent configuration"] = 96,
    ["launchsettings.json"] = 484,
    lazydocker = 1039,
    lazygit = 1038,
    ["lego.json"] = 486,
    ["lerna.json"] = 487,
    ["lgtm.yml"] = 488,
    ["liblab.config.json"] = 489,
    ["libman.json"] = 490,
    ["license-report-config.json"] = 491,
    ["linkinator.config.json"] = 493,
    ["lint-staged (.lintstagedrc)"] = 893,
    ["local.settings.json"] = 498,
    ["localazy.json"] = 499,
    ["lotus.yaml"] = 497,
    ["lsdlschema.json"] = 500,
    ["markdown-link-check"] = 959,
    maturin = 960,
    mboats = 967,
    ["micro-settings.json"] = 1032,
    ["mimetypes.json"] = 514,
    ["mirrord config"] = 895,
    mise = 896,
    ["mkdocs.yml"] = 534,
    ["monospace.yml"] = 537,
    ["moon.yml"] = 1114,
    ["mprocs Configuration file"] = 1085,
    ["mrdocs.yml"] = 535,
    ["mta.yaml"] = 897,
    ["mtad.yaml"] = 898,
    ["mycode.json"] = 544,
    nFPM = 551,
    ["napari plugin manifest"] = 545,
    neoload = 910,
    ["nest-cli"] = 554,
    ["ninjs (News in JSON)"] = 553,
    ["nitro.json"] = 909,
    ["nixd configuration"] = 1058,
    ["nlu.json"] = 555,
    ["nodemon.json"] = 557,
    ["noodl config"] = 966,
    ["notebook.mod.json"] = 558,
    now = 905,
    ["npm-badges"] = 561,
    ["nswag.json"] = 565,
    ntangle = 567,
    ["nuclei-template.yaml"] = 562,
    ["nuget-project.json"] = 563,
    ["ocelot.json"] = 569,
    ["omnisharp.json"] = 574,
    ["openapi.json"] = 576,
    ["openfin.json"] = 584,
    ...
    ["overlay.json"] = 577,
    ["package.json"] = 605,
    ["package.manifest"] = 607,
    ["package.yaml"] = 606,
    ["partial-black.json"] = 127,
    ["pathfinder.yml"] = 610,
    ["pattern.json"] = 613,
    ["petstore-v1.0"] = 1012,
    pgap_yaml_input_reader = 612,
    ["pixi.toml"] = 614,
    ["plagiarize-me.yaml"] = 618,
    ["plagiarize.yaml"] = 617,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1120,
    ["podbard.yaml"] = 620,
    ["portman.json"] = 623,
    ["prefect.toml"] = 631,
    ["prettierrc.json"] = 632,
    ["prisma.yml"] = 633,
    ["project-1.0.0-beta3.json"] = 642,
    ["project-1.0.0-beta4.json"] = 643,
    ["project-1.0.0-beta5.json"] = 644,
    ["project-1.0.0-beta6.json"] = 645,
    ["project-1.0.0-beta8.json"] = 646,
    ["project-1.0.0-rc1.json"] = 647,
    ["project-1.0.0-rc2.json"] = 648,
    ["project.json"] = 641,
    ["project.owasp.yaml"] = 649,
    ["prometheus-alertmanager.json"] = 653,
    ["prometheus.json"] = 650,
    ["prometheus.rules.json"] = 651,
    ["prometheus.rules.test.json"] = 652,
    ["proxies.json"] = 654,
    ["publiccode.yml"] = 655,
    ["pubspec.yaml"] = 656,
    ["pyrseas-0.8.json"] = 659,
    pytest = 668,
    ["quilt.mod.json"] = 1033,
    ["rc3 auth"] = 674,
    ["rc3 collection"] = 675,
    ...
    ["release drafter"] = 911,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 684,
    ["release-please-manifest.json"] = 685,
    ["release-plz.toml"] = 686,
    ["renv.lock"] = 696,
    ["rivet.json"] = 1057,
    ["rivet.yaml (legacy)"] = 1056,
    rumdl = 701,
    runny = 700,
    rustfmt = 702,
    sake = 1147,
    samt = 704,
    samtrc = 705,
    ["sarif-1.0.0.json"] = 707,
    ["sarif-2.0.0.json"] = 708,
    ["sarif-2.1.0"] = 718,
    ["sarif-2.1.0-rtm.2"] = 709,
    ["sarif-2.1.0-rtm.3"] = 711,
    ["sarif-2.1.0-rtm.4"] = 713,
    ["sarif-2.1.0-rtm.5"] = 715,
    ["sarif-2.1.0-rtm.6"] = 716,
    ["sarif-external-property-file-2.1.0"] = 719,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 710,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 712,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 714,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 717,
    ["scalingo.json configuration"] = 720,
    ["schema.org - Action"] = 722,
    ["schema.org - ContactPoint"] = 723,
    ["schema.org - Place"] = 724,
    ["schema.org - Thing"] = 725,
    ["secrethub.yml"] = 1035,
    ["semantic-release"] = 731,
    ["servicehub.config.json"] = 888,
    ["servicehub.service.json"] = 887,
    ["settings.job"] = 734,
    ["sfdx-hardis configuration"] = 736,
    ["shard.yml"] = 1073,
    ["size-limit configuration"] = 741,
    ["skaffold.yaml"] = 957,
    ["skyuxconfig.json"] = 743,
    ["snowflake-config"] = 745,
    ["snowflake-connections"] = 746,
    ["spicepod.yaml"] = 1093,
    ["sqlc configuration"] = 778,
    ["stripe-app-local.json"] = 789,
    ["stripe-app.json"] = 788,
    swcrc = 942,
    ["task.json"] = 798,
    taskcat = 906,
    ["template.json"] = 803,
    ["templatsources.json"] = 804,
    ["theme.json"] = 807,
    ["tizen_workspace.json"] = 809,
    tldr = 810,
    ["tm_devices configuration file"] = 1158,
    tmuxinator = 891,
    ["transcend.yml"] = 820,
    ["tree-sitter grammar.json"] = 394,
    ["trime.yaml"] = 821,
    ["trunk.yaml"] = 823,
    ["ts-force-config.json"] = 828,
    ["tsconfig.json"] = 824,
    ["tsd.json"] = 825,
    ["tsdoc.json"] = 826,
    ["tsdrc.json"] = 827,
    ...
    v8r = 870,
    vcluster = 1079,
    ["vcpkg configuration file"] = 226,
    ["vcpkg manifest file"] = 225,
    ["vega-lite.json"] = 852,
    ["vega.json"] = 851,
    ["venvironment.yaml"] = 854,
    ["venvplus.yaml"] = 855,
    version = 1140,
    ["version.json"] = 857,
    ["vhwdebugger-binding.yaml"] = 859,
    ["vim-addon-info"] = 860,
    ["vs-2017.3.host.json"] = 862,
    ["vs-nesting.json"] = 863,
    ["vsls.json"] = 861,
    ["vss-extension.json"] = 867,
    vtcfg = 1146,
    ["vtesttree.yaml"] = 868,
    ["vtestunit.yaml"] = 869,
    ["warp-keysets.json"] = 1041,
    ["warp-themes.json"] = 1042,
    ["warp-workflows.json"] = 1043,
    ["webhint.io"] = 997,
    ["webjobpublishsettings.json"] = 874,
    ["webjobs-list.json"] = 873,
    ["well-known-fursona"] = 1080,
    ["xs-app.json"] = 901,
    ["xunit.runner.json"] = 886,
    yamllint = 929,
    zuul = 912,
    ["Žinoma"] = 922
  },
