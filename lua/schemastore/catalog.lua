...
M.json = {
  ...
  index = {
    ...
    ["AWS CDK cdk.json"] = 259,
    ["AWS CloudFormation"] = 260,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 261,
    ["AWS Copilot Manifest"] = 1201,
    ["AWS SAM CLI Samconfig"] = 262,
    ...
    ["Ansible Argument Specs"] = 398,
    ["Ansible Collection Galaxy"] = 405,
    ["Ansible Execution Environment"] = 395,
    ["Ansible Inventory"] = 404,
    ["Ansible Meta"] = 396,
    ["Ansible Meta Runtime"] = 397,
    ["Ansible Navigator Configuration"] = 407,
    ["Ansible Playbook"] = 402,
    ["Ansible Requirements"] = 399,
    ["Ansible Rulebook"] = 403,
    ["Ansible Tasks File"] = 401,
    ["Ansible Vars File"] = 400,
    ["Ansible-lint Configuration"] = 406,
    Any = 1124,
    ...
    ["Azure Container App template for defining an immutable revision"] = 69,
    ["Azure DevOps extension manifest"] = 72,
    ["Azure Device Update for IoT Hub import manifest"] = 70,
    ["Azure Device Update for IoT Hub update manifest"] = 71,
    ["Azure IoT Edge deployment"] = 75,
    ["Azure IoT Edge deployment template"] = 76,
    ["Azure IoT EdgeAgent deployment"] = 73,
    ["Azure IoT EdgeHub deployment"] = 74,
    ["Azure IoT Operations Wasm Graph Config"] = 1210,
    ["Azure IoT Operations connector metadata"] = 1207,
    ["Azure Landing Zones Library archetype definition"] = 80,
    ["Azure Landing Zones Library archetype override"] = 81,
    ["Azure Landing Zones Library architecture definition"] = 79,
    ["Azure Landing Zones Library metadata"] = 77,
    ["Azure Landing Zones Library policy default values"] = 78,
    ["Azure Pipelines"] = 111,
    ["Azure Static Web Apps CLI configuration file"] = 814,
    ["Azure Static Web Apps configuration file"] = 813,
    BMML = 1229,
    ["BOSH CPI Config"] = 136,
    ["BOSH Deploy Config"] = 137,
    ["BX CI"] = 156,
    ["Bacon config"] = 5,
    ["Barba-CV"] = 82,
    ...
    ["Better Scripts"] = 157,
    Bigconfig = 129,
    ["Biome Formatter Config"] = 83,
    ["Bitmovin Encoding Template"] = 1155,
    BizTalkServerApplicationSchema = 942,
    Bleep = 158,
    ["Block Protocol Metadata"] = 155,
    ["Bluebricks blueprint config"] = 1234,
    ["Boyka Framework"] = 138,
    Briefcase = 948,
    ["Build Info"] = 146,
    Buildkite = 148,
    ["Bukkit plugin.yml"] = 147,
    ["BungeeCord plugin.yml"] = 153,
    ["Butane Config"] = 1018,
    C4InterFlow = 1170,
    ...
    ["CSS Comb (.csscomb.json)"] = 287,
    ["CSS Lint (.csslintrc)"] = 288,
    ["CSpell (cspell.json)"] = 286,
    ["CVE Record Format"] = 190,
    CWL = 1107,
    ["Cache Warmup config"] = 160,
    ["Calqulus pipeline"] = 161,
    ["Camel YAML DSL"] = 162,
    ["Cannon TOML"] = 163,
    Carafe = 164,
    ["Cargo Make"] = 166,
    ["Cargo Manifest"] = 165,
    ["Catalog Info Backstage"] = 167,
    ...
    Charmcraft = 169,
    Cheatsheets = 1015,
    ["ChordPro Configuration"] = 170,
    ["Chrome Extension"] = 252,
    ["Chromia Model"] = 171,
    ["Chromia Seeder Module Config"] = 173,
    ["Chromia Seeder Root Config"] = 172,
    ["Cinnamon Spice info.json"] = 91,
    ["CircleCI config.yml"] = 227,
    ["Citation File Format"] = 273,
    ["Citrus test case"] = 175,
    CityJSON = 176,
    ["Claude Code Keybindings"] = 188,
    ["Claude Code Settings"] = 189,
    ["Clawject config"] = 187,
    ["Cloud Foundry Application Manifest"] = 1113,
    ["Cloud Run Spec v1"] = 1136,
    ["Cloud.gov Workshop Configuration"] = 92,
    ["CloudCannon Configuration"] = 97,
    ["CloudCannon Configuration (Collection Structures)"] = 106,
    ["CloudCannon Configuration (Collections)"] = 105,
    ["CloudCannon Configuration (Editables)"] = 104,
    ["CloudCannon Configuration (Inputs)"] = 99,
    ["CloudCannon Configuration (Snippets Definitions)"] = 103,
    ["CloudCannon Configuration (Snippets Imports)"] = 102,
    ["CloudCannon Configuration (Snippets)"] = 101,
    ["CloudCannon Configuration (Structure Value)"] = 100,
    ["CloudCannon Configuration (Structures)"] = 98,
    ["CloudEvents specification"] = 177,
    ["Code Climate"] = 228,
    CodeCV = 95,
    CodeRabbit = 94,
    ["CodeShip Pro services configuration files"] = 241,
    ["CodeShip Pro steps configuration files"] = 242,
    ["Codecov configuration files"] = 240,
    Codex = 236,
    CodifyCLI = 96,
    Codux = 238,
    ["Cog config file"] = 182,
    ["Commandbox Box.json"] = 183,
    ["Commandbox Server.json"] = 184,
    ["Common Catalog Data"] = 250,
    ["Common Package Specification"] = 185,
    Concord = 1130,
    ...
    Convex = 179,
    ["Crowdsec collection config"] = 281,
    ["Crowdsec parser config"] = 282,
    ["Crowdsec scenario config"] = 283,
    ["CumulusCI Config"] = 186,
    ["Cursor Agent Environment"] = 1239,
    ["Custom Machinery Machine"] = 1102,
    ["Custom Machinery Recipe"] = 1103,
    ["Cycle Stack File"] = 191,
    CycloneDX = 192,
    ["DWP Exchange - catalogue entry"] = 332,
    ["DWP Exchange - gateway"] = 330,
    ["DWP Exchange - meta"] = 331,
    ["Dart Build Config (dart-build.json)"] = 289,
    ["Dart Test Config (dart-test.json)"] = 290,
    ["DashLord Configuration"] = 291,
    ["Data Contract Specification"] = 292,
    ["Data Product Specification"] = 293,
    ["DataYoga Connections"] = 193,
    ["DataYoga Job"] = 194,
    ["Databricks Asset Bundles"] = 1080,
    ["Datadog Continuous Testing"] = 496,
    ["Datadog Service Definition"] = 497,
    ["Datadog Software Catalog"] = 498,
    ["Datahub Ingestion Recipe"] = 1034,
    ["Debian Upstream Metadata file"] = 201,
    ["Deck config"] = 202,
    ["DeepMatch deeplinks spec"] = 203,
    ["Dein Config"] = 204,
    ["Deno Config (deno.json)"] = 299,
    ["Dependency cruiser"] = 205,
    ["DeployStack Configuration"] = 206,
    ["Deployah Configuration"] = 1209,
    ["Deployer Recipe"] = 302,
    ["Deta Spacefile"] = 207,
    ["Detekt Config (detekt.yml)"] = 303,
    ["Devbox Config"] = 208,
    ["Devbox Plugin"] = 209,
    Devfile = 329,
    Devup = 1222,
    DipDup = 1133,
    ["Discord Webhook"] = 304,
    ["DocFx Config (docfx.json)"] = 309,
    ["Docker Desktop extension metadata"] = 306,
    ["Docs MCP Manifest"] = 310,
    Dofigen = 311,
    ["Dolittle Artifacts"] = 312,
    ["Dolittle Bounded Context Configuration"] = 313,
    ["Dolittle Event Horizons Configuration"] = 314,
    ["Dolittle Resources Configuration"] = 315,
    ["Dolittle Server Configuration"] = 316,
    ["Dolittle Tenant Map Configuration"] = 318,
    ["Dolittle Tenants Configuration"] = 317,
    ["Dolittle Topology"] = 319,
    ["DonateCaseBetterCasino menu"] = 1163,
    ["Drupal Breakpoints"] = 210,
    ["Drupal Config"] = 222,
    ["Drupal Info"] = 211,
    ["Drupal Layouts"] = 212,
    ["Drupal Libraries"] = 213,
    ["Drupal Links Action"] = 214,
    ["Drupal Links Contextual"] = 215,
    ["Drupal Links Menu"] = 216,
    ["Drupal Links Task"] = 217,
    ["Drupal Migration"] = 218,
    ["Drupal Permissions"] = 219,
    ["Drupal Recipe"] = 220,
    ["Drupal Routing"] = 221,
    ["Drupal Services"] = 223,
    ["Drush site aliases"] = 325,
    ["Dynamic Bash Aliases (.aliases)"] = 1071,
    ["EAS config"] = 350,
    ["ECA - Editor Code Assistant"] = 334,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1060,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1206,
    ["EasyVCR .NET"] = 351,
    ["Eidolon Resource"] = 1147,
    ["Elgato Stream Deck"] = 336,
    Elm = 1135,
    ["Embrace Config"] = 1046,
    Endurica = 1084,
    ["Enterprise Contract Policy Spec"] = 337,
    ["Erda Pipeline"] = 1109,
    ["Erda Runtime"] = 1110,
    ...
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 343,
    ["EveryVoice TTS Toolkit Data Configuration"] = 344,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 348,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 347,
    ["EveryVoice TTS Toolkit Text Configuration"] = 345,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 346,
    ["Evolving Resolutive Process notation"] = 1208,
    ["Expo SDK"] = 349,
    ["F-Droid Data metadata"] = 355,
    ["FasterCI Configuration"] = 112,
    FiQuS = 359,
    Firebase = 357,
    ["Flatpak Builder Manifest"] = 360,
    ["FlexGet Config"] = 361,
    ["Flow.json Configurations"] = 1106,
    ["Fossa configuration file"] = 368,
    ["Fossa's fossa-deps file"] = 369,
    ["Foundry VTT - Base package Manifest"] = 363,
    ["Foundry VTT - Module Manifest"] = 364,
    ["Foundry VTT - System Data Template"] = 367,
    ["Foundry VTT - System Manifest"] = 365,
    ["Foundry VTT - World Manifest"] = 366,
    ["Foxx Manifest"] = 113,
    ["Freifunk.de Community API"] = 116,
    ["Frogbot Config"] = 117,
    ["G2P Mapping Configuration"] = 375,
    ["GCP Blueprint Metadata"] = 378,
    Gaspar = 376,
    ["GatewayCore API Gateway"] = 377,
    ["Gemini CLI settings"] = 379,
    ["GeoJSON.json latest"] = 1022,
    GherKing = 1026,
    ["GitHub Action"] = 384,
    ["GitHub Actions typing"] = 1143,
    ["GitHub Discussion"] = 385,
    ["GitHub Funding"] = 386,
    ["GitHub Issue Template configuration"] = 387,
    ["GitHub Issue Template forms"] = 388,
    ["GitHub Workflow"] = 389,
    ["GitHub Workflow Template Properties"] = 390,
    ["GitHub automatically generated release notes configuration"] = 391,
    ["GitLab Agent for Kubernetes configuration"] = 1098,
    GitVersion = 381,
    ["Gitea Issue Template configuration"] = 382,
    ["Gitea Issue Template forms"] = 383,
    ["Gitpod Automations"] = 393,
    ["Gitpod Configuration"] = 394,
    ["GlazeWM settings"] = 1100,
    ["Global Privacy Control"] = 380,
    Goblet = 1079,
    ["Golangci-lint Configuration"] = 409,
    ["Golangci-lint Custom Plugins Configuration"] = 410,
    ["Google Chrome Related Website Sets"] = 358,
    ["Google Cloud Workflows"] = 258,
    ...
    ["Grafana 5.x Dashboard"] = 415,
    ["GraphQL Code Generator"] = 420,
    ["GraphQL Config"] = 419,
    ["GraphQL Mesh"] = 418,
    ["GroovyLint configuration"] = 421,
    ["Grunt JSHint task"] = 425,
    ["Grunt Watch task"] = 426,
    ["Grunt base task"] = 427,
    ["Grunt clean task"] = 423,
    ["Grunt copy task"] = 422,
    ["Grunt cssmin task"] = 424,
    HEMTT = 938,
    Hadolint = 952,
    Hammerkit = 983,
    ...
    Hatch = 953,
    Hayson = 430,
    ["Haystack Pipeline"] = 431,
    ["Hazelcast 5 Configuration"] = 432,
    ["Hecate Input Schema"] = 1198,
    ["Helm Chart.lock"] = 225,
    ["Helm Chart.yaml"] = 224,
    ["Helm Unittest Test Suite"] = 226,
    ["Home Assistant Integration Manifest"] = 433,
    ["Homer dashboard configuration"] = 434,
    Hugo = 1014,
    ["Hugo Theme"] = 1013,
    ["Hulak Configuration"] = 441,
    ["Hyperfoil benchmark configuration"] = 440,
    ["IBM Zapp document"] = 442,
    ["IBM zCodeFormatSettings"] = 443,
    ["IMG Catapult PSP"] = 448,
    ["IVMS101 by CODE Protocol"] = 1099,
    Infrahub = 450,
    Istanbul = 1042,
    ["JDownloader2 crawler multi-rules"] = 463,
    ["JDownloader2 crawler single-rules"] = 462,
    ["JFrog Applications Config"] = 464,
    ["JFrog File Spec"] = 465,
    ["JFrog Pipelines YML DSL"] = 1048,
    ["JMeter DSL cli config"] = 466,
    JReleaser = 469,
    ["JSON Document Transform"] = 477,
    ["JSON Feed"] = 478,
    ["JSON Resume"] = 725,
    ...
    ["JSON-stat 2.0"] = 913,
    JSONPatch = 480,
    ["JSR Package Config (jsr.json)"] = 470,
    Jarl = 1214,
    Jasmine = 457,
    Jekyll = 458,
    ["Jenkins X Pipelines"] = 459,
    ["Jenkins X Requirements"] = 460,
    Jest = 461,
    Jocker = 467,
    ["Jovo Language Models"] = 468,
    ["Jujutsu (jj) VCS config"] = 1200,
    ["KIMMDY config file"] = 491,
    ...
    KSail = 373,
    ["KYA Manifest"] = 1112,
    ["Karakum configuration file"] = 370,
    Kas = 483,
    ["Kestra flow file"] = 492,
    ["Keycloak REST API"] = 1051,
    ["Knative Functions - func.yaml"] = 371,
    Knip = 372,
    ["Kometa (nightly) config file"] = 494,
    ["Kometa config file"] = 493,
    ["Kong DBLess config"] = 1045,
    KrakenD = 495,
    ["Kubri Configuration"] = 502,
    LOOBin = 517,
    ["Lake configuration file"] = 1203,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 263,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 264,
    ["Landing Zone Accelerator on AWS - Global Config"] = 265,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 266,
    ["Landing Zone Accelerator on AWS - Network Config"] = 267,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 268,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 269,
    ["Landing Zone Accelerator on AWS - Security Config"] = 270,
    ["Lando (landofile)"] = 107,
    ["LangGraph Platform configuration"] = 1123,
    ["Language configuration"] = 1122,
    Lefthook = 506,
    ["Liferay client-extension.yaml"] = 513,
    ["LinkML Metamodel"] = 515,
    Liquibase = 989,
    ["Liquibase Flow File"] = 990,
    ["Lively Properties"] = 516,
    ["Lobe AI Agent"] = 109,
    Loki = 110,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 558,
    ["MS2Rescore Configuration"] = 562,
    ["Madness (madness.yml)"] = 1062,
    ["Mado configuration"] = 523,
    ["Maestro Flow"] = 524,
    ["Mail Servers Configuration"] = 1235,
    ["MapEHR Mapping"] = 525,
    Markdownlint = 993,
    ["Mason Registry"] = 996,
    ["MegaLinter Custom Flavor"] = 528,
    ["MegaLinter configuration"] = 527,
    ["MegaLinter descriptor"] = 529,
    Melange = 1089,
    ["Meltano project definition"] = 530,
    ["Mergify Configuration"] = 563,
    ["Metadata for a Bazel module"] = 531,
    ["Metadata for a Cinnamon spice"] = 1139,
    ["Metatype Configuration"] = 532,
    ["MetricsHub Configuration"] = 533,
    ["MetricsHub Connector Configuration"] = 534,
    ["Micro Editor Syntax"] = 1072,
    ["Microsoft Band Web Tile"] = 535,
    ...
    ["Minecraft Data Pack Advancement"] = 537,
    ["Minecraft Data Pack Biome"] = 538,
    ["Minecraft Data Pack Configured Carver"] = 539,
    ["Minecraft Data Pack Damage Type"] = 540,
    ["Minecraft Data Pack Dimension"] = 542,
    ["Minecraft Data Pack Dimension Type"] = 541,
    ["Minecraft Data Pack Item Modifier"] = 543,
    ["Minecraft Data Pack Loot Table"] = 544,
    ["Minecraft Data Pack Metadata"] = 545,
    ["Minecraft Data Pack Predicate"] = 546,
    ["Minecraft Data Pack Recipe"] = 547,
    ["Minecraft Data Pack Tag"] = 548,
    ["Minecraft Data Pack Template Pool"] = 549,
    ["Minecraft Data Pack Trim Material"] = 554,
    ["Minecraft Data Pack Trim Pattern"] = 555,
    ["Minecraft Resource Pack Lang"] = 550,
    ["Minecraft Resource Pack Particle"] = 551,
    ["Minecraft Resource Pack Texture Mcmeta"] = 553,
    ["Minecraft Resourcepack Sounds"] = 552,
    ["Monade CLI Stack Configuration"] = 566,
    ["MongoDB Atlas Search Index Definition"] = 1043,
    ["Monika Configuration"] = 1041,
    ["Monoweave Configuration"] = 561,
    ["Motif config"] = 934,
    MultiQC = 1180,
    ["NOX Framework (Service)"] = 582,
    ["Netin Diagnostic System Template"] = 1000,
    ["Netlify config"] = 569,
    ["Network-as-Code Data Model"] = 570,
    ["Next Gen UI Agent A2A Server Configuration"] = 571,
    ["Next Gen UI Agent Configuration"] = 573,
    ["Next Gen UI Agent MCP Server Configuration"] = 572,
    ["Nightwatch.js"] = 575,
    ["Node.js configuration"] = 939,
    ["NueJS configuration file"] = 587,
    ["Nuitka.yaml"] = 1104,
    ["Nullstone config"] = 589,
    ["ONe's changelog entry"] = 608,
    ["ONe's service descriptor"] = 607,
    ["ORT Server repository environment configuration"] = 618,
    ["OSCAL Assessment Plan (AP)"] = 620,
    ["OSCAL Assessment Results (AR)"] = 621,
    ["OSCAL Catalog"] = 622,
    ["OSCAL Component Definition (CDef)"] = 623,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 624,
    ["OSCAL Profile"] = 625,
    ["OSCAL System Security Plan (SSP)"] = 626,
    ["OSS Review Toolkit configuration"] = 627,
    ["OSS Review Toolkit curation"] = 628,
    ["OSS Review Toolkit package configuration"] = 629,
    ["OSS Review Toolkit repository configuration"] = 630,
    ["OSS Review Toolkit resolutions"] = 631,
    ["October CMS columns"] = 593,
    ["October CMS fields"] = 594,
    ["Oh My Posh"] = 596,
    Okteto = 597,
    ["Ona Automations"] = 599,
    Opctl = 937,
    ["Open Data Contract Standard (ODCS)"] = 612,
    ["Open Data Product Standard (ODPS)"] = 613,
    ["Open Know-How"] = 1185,
    ["OpenRewrite Resource"] = 610,
    OpenSRM = 614,
    OpenStatus = 1196,
    ["OpenTelemetry Declarative Configuration"] = 611,
    ["OpenUtau character yaml"] = 604,
    ["OpenUtau ustx"] = 605,
    ["OpenWeather Current Weather API"] = 979,
    ["OpenWeather Road Risk API"] = 978,
    ["Ory Hydra configuration"] = 439,
    ["Ory Keto configuration"] = 499,
    ["Ory Kratos configuration"] = 619,
    ["Ory Oathkeeper configuration"] = 591,
    ["Outblocks App configuration"] = 616,
    ["Outblocks database table"] = 617,
    ["Outblocks project configuration"] = 615,
    PDM = 637,
    POPxf = 648,
    ["POPxf Correlations"] = 649,
    Packer = 635,
    Pantsbuild = 1058,
    ["Paper paper-plugin.yml"] = 636,
    ...
    ["batect.yml"] = 122,
    ["beef-database-codegen"] = 124,
    ["beef-database-v5-codegen"] = 126,
    ["beef-entity-codegen"] = 125,
    ["beef-entity-v5-codegen"] = 127,
    ["behat.yml"] = 139,
    ["bigquery-table"] = 128,
    ["bioimageio resource description"] = 1105,
    ["bitbucket-pipelines"] = 130,
    bitrise = 131,
    ["bitrise-step"] = 132,
    ["block.json"] = 154,
    ["bottom configuration"] = 84,
    ["bower.json"] = 134,
    ["bozr.suite.json"] = 141,
    bpkg = 1066,
    ["browser.i18n.json"] = 142,
    ["browsh configuration"] = 143,
    bucklescript = 144,
    ["buf.gen.yaml"] = 86,
    ["buf.lock"] = 87,
    ["buf.plugin.yaml"] = 88,
    ...
    ["build-changelog"] = 145,
    ["bun.lock"] = 150,
    ["bundleconfig.json"] = 151,
    ["bunfig.toml"] = 152,
    ["cargo-mutants-config.yaml"] = 90,
    ["ccmod.json"] = 1149,
    changelogging = 1117,
    ["chisel-slices.json"] = 272,
    ["chrome-extension-locales-messages.json"] = 253,
    ["chutzpah.json"] = 254,
    cibuildwheel = 174,
    ...
    clangd = 231,
    clib = 233,
    ["cloud-init: cloud-config userdata"] = 235,
    ["cloud-sdk-pipeline-configuration"] = 256,
    ["cloudbuild.json"] = 257,
    cloudify = 234,
    ["cmdx.yaml"] = 93,
    codemagic = 237,
    ...
    ["committed.toml"] = 275,
    ["compile_commands.json"] = 248,
    ["compilerconfig.json"] = 247,
    ["completely.yml"] = 1061,
    ["component-detection-manifest.json"] = 278,
    ["component.json"] = 277,
    ["composer.json"] = 276,
    ["conda-forge"] = 178,
    ["config.yaml"] = 695,
    ["contentmanifest.json"] = 255,
    ["contribute.json"] = 279,
    ["cosmos.config.json"] = 251,
    ["crowdin.yml"] = 280,
    ["ctfd-setup configuration file"] = 1161,
    ["custom-elements.json"] = 1075,
    ["cypress.json"] = 284,
    ["datalogic-scan2deploy-android"] = 294,
    ["datalogic-scan2deploy-ce"] = 295,
    ["dbt Dependencies"] = 196,
    ["dbt Packages"] = 198,
    ["dbt Project"] = 197,
    ["dbt Selectors"] = 199,
    ["dbt YAML files"] = 200,
    ...
    ["ddev-global"] = 296,
    ["ddev-project"] = 297,
    ["debugsettings.json"] = 298,
    ["dependabot-v2.json"] = 301,
    ["dependabot.json"] = 300,
    ["deployed-cli"] = 1016,
    ["devcontainer.json"] = 239,
    devinit = 967,
    ["devspace.yaml"] = 1039,
    djlint = 968,
    ["docker bake"] = 307,
    ["docker sequencer"] = 308,
    ["docker-compose.yml"] = 966,
    ["dockerd.json"] = 305,
    ["dotnet Release Index manifest"] = 320,
    ["dotnet-tools.json"] = 321,
    ["dotnetcli.host.json"] = 322,
    ["dprint.json"] = 323,
    ["drone.json"] = 324,
    ["dss-2.0.0.json"] = 326,
    ["dstack configuration"] = 327,
    ["dtool dataset metadata"] = 1156,
    ["dvc.yaml"] = 328,
    ["ecosystem.json"] = 333,
    eksctl = 335,
    ["electron-builder configuration file"] = 341,
    ["epr-manifest.json"] = 340,
    ["evcc.yaml"] = 342,
    ["ezd task runner"] = 352,
    ["fabric.mod.json"] = 354,
    ["first-timers-bot"] = 362,
    ["flagd flag configuration"] = 114,
    ["fly.io Configuration"] = 115,
    fulibWorkflows = 998,
    ["function.json"] = 374,
    ...
    ["gitlab-ci"] = 392,
    ["global.json"] = 408,
    ["go-feature-flag Flag Configuration"] = 411,
    ["haxelib.json"] = 429,
    helmfile = 954,
    helmwave = 955,
    ["host-meta.json"] = 436,
    ...
    ["ide.host.json"] = 444,
    ["ifstate.yaml"] = 445,
    ["imageoptimizer.json"] = 446,
    ["importmap.json"] = 449,
    instant_python_config = 451,
    instant_python_custom_project = 452,
    ["ioBroker Configuration"] = 453,
    ["ioBroker JSON UI"] = 454,
    ["ioBroker Package manifest"] = 455,
    ["ixpect.conf.yaml"] = 456,
    ["ize.toml"] = 1052,
    ["jsconfig.json"] = 481,
    ["jscpd Configuration"] = 1036,
    jsdoc = 950,
    ["k3d.yaml"] = 482,
    ["k9s aliases.yaml"] = 484,
    ["k9s cluster-config.yaml"] = 486,
    ["k9s config.yaml"] = 485,
    ["k9s hotkeys.yaml"] = 487,
    ["k9s plugins.yaml"] = 488,
    ["k9s skin.yaml"] = 489,
    ["k9s views.yaml"] = 490,
    ["kontinuous-config.yaml"] = 501,
    ["kontinuous-values.yaml"] = 500,
    ["kustomization.yaml"] = 503,
    ["label-commenter-config.yml"] = 504,
    ["latexindent configuration"] = 108,
    ["launchsettings.json"] = 505,
    lazydocker = 1074,
    lazygit = 1073,
    ["lego.json"] = 507,
    ["lerna.json"] = 508,
    ["lgtm.yml"] = 509,
    ["liblab.config.json"] = 510,
    ["libman.json"] = 511,
    ["license-report-config.json"] = 512,
    ["linkinator.config.json"] = 514,
    ["lint-staged (.lintstagedrc)"] = 928,
    ["local.settings.json"] = 519,
    ["localazy.json"] = 520,
    ["lotus.yaml"] = 518,
    ["lsdlschema.json"] = 521,
    ["macro.json"] = 1040,
    ...
    ["mycode.json"] = 567,
    nFPM = 574,
    ["napari plugin manifest"] = 568,
    neoload = 945,
    ["nest-cli"] = 577,
    ["nexus-rpc-gen"] = 1240,
    ["ninjs (News in JSON)"] = 576,
    ["nitro.json"] = 944,
    ["nixd configuration"] = 1093,
    ["nlu.json"] = 578,
    ["nodemon.json"] = 580,
    ["noodl config"] = 1001,
    ["notebook.mod.json"] = 581,
    now = 940,
    ["npm-badges"] = 584,
    ["nswag.json"] = 588,
    ntangle = 590,
    ["nuclei-template.yaml"] = 585,
    ["nuget-project.json"] = 586,
    ["ocelot.json"] = 592,
    ogen = 595,
    ["omnisharp.json"] = 598,
    openHAB = 1226,
    ...
    oxlint = 1237,
    ["package.json"] = 632,
    ["package.manifest"] = 634,
    ["package.yaml"] = 633,
    ["partial-black.json"] = 140,
    ...
    v8r = 905,
    vcluster = 1115,
    ["vcpkg configuration file"] = 244,
    ["vcpkg manifest file"] = 243,
    ["vega-lite.json"] = 887,
    ["vega.json"] = 886,
