...
M.json = {
  ...
  index = {
    ...
    ["Airplane task"] = 15,
    ["Alacritty Configuration"] = 718,
    ["All Contributors configuration file"] = 776,
    ...
    ["Azure Pipelines"] = 65,
    ["Azure Static Web Apps CLI configuration file"] = 552,
    ["Azure Static Web Apps configuration file"] = 551,
    ["BX CI"] = 102,
    ["Better Code Hub"] = 689,
    ["Better Scripts"] = 103,
    Bigconfig = 82,
    ...
    ["Butane Config"] = 731,
    ["CICS TS region tagging"] = 740,
    ["CICS TS resource import"] = 741,
    ["CICS TS resource model"] = 742,
    ["CICS TS resource overrides"] = 743,
    ["CMake Presets"] = 105,
    ["CNC Codes"] = 117,
    ...
    ["Dart build configuration"] = 193,
    ["Dart test config"] = 194,
    ["DashLord configuration"] = 195,
    ["Data Contract Specification"] = 196,
    ["Databricks Asset Bundles"] = 797,
    ["Datadog Service Definition"] = 343,
    ["Datahub Ingestion Recipe"] = 747,
    ["Dein Config"] = 123,
    Deno = 202,
    ["Deployer Recipe"] = 205,
    ["Deta Spacefile"] = 124,
    ...
    ["ESLint Plugin Partial"] = 243,
    ["Embrace Config"] = 758,
    Endurica = 800,
    ["Error pages"] = 237,
    Esquio = 235,
    ["Estuary Flow Catalog"] = 737,
    ["Expo SDK"] = 240,
    ...
    ["Frogbot Config"] = 71,
    ["Fusion resource pack metadata"] = 262,
    ["Fusion texture metadata"] = 263,
    ["G2P Mapping Configuration"] = 264,
    ["GCP Blueprint Metadata"] = 267,
    Gaspar = 265,
    ["GatewayCore API Gateway"] = 266,
    ["GeoJSON.json latest"] = 735,
    GherKing = 739,
    ["GitHub Action"] = 271,
    ...
    Hadolint = 668,
    Hammerkit = 696,
    ["Hardware Sentry Configuration"] = 751,
    Hatch = 669,
    Hayson = 298,
    ...
    Kas = 339,
    ["Keycloak REST API"] = 768,
    ["Knative Functions - func.yaml"] = 260,
    ["KoDE/CI build.yaml"] = 756,
    ["Kong DBLess config"] = 757,
    KrakenD = 342,
    LOOBin = 361,
    Lefthook = 350,
    ...
    ["MongoDB Atlas Search Index Definition"] = 755,
    ["Monika Configuration"] = 753,
    ["Motif config"] = 652,
    ...
    ["Partial-Setuptools"] = 533,
    ["Partial-poetry"] = 450,
    ["Pipeline component"] = 703,
    ["PocketMine plugin.yml"] = 448,
    Poetry = 449,
    ...
    Qgoda = 487,
    Qodana = 723,
    ["Quali Torque Blueprint Spec 2"] = 748,
    ["QueryFirst config file"] = 771,
    ...
    ["Rust Project"] = 497,
    ["Rust toolchain"] = 503,
    ["SIL Kit Participant Configuration"] = 537,
    ["SIL Kit Registry Configuration"] = 538,
    SWADL = 563,
    ["Safebox Config"] = 761,
    ...
    ["Serverless Framework Configuration"] = 717,
    ["Serverless Workflow"] = 719,
    ["Settings.paf"] = 531,
    Setuptools = 532,
    ["Shopware 6 Configuration"] = 720,
    ["Shopware CLI Extension Store Configuration"] = 721,
    ["Shopware CLI Project Store Configuration"] = 722,
    Sigma = 535,
    ["Sigrid scope configuration file"] = 536,
    ["SkyPilot Task JSON"] = 809,
    ["Slack app manifest"] = 540,
    Solidarity = 543,
    ["Solution filters"] = 544,
    ["Source Maps v3"] = 545,
    Sourcery = 546,
    SpecIF = 547,
    ["Sponge Mixin configuration"] = 548,
    StackBlitz = 553,
    ["StackHawk Scanner Configuration"] = 716,
    Stale = 554,
    ["Starlake Data Pipeline"] = 690,
    Starship = 555,
    ["Statamic Blueprint"] = 556,
    ["Stella configuration file"] = 557,
    ["StrmPrivacy Data Connector"] = 765,
    ["StrmPrivacy Data Contract"] = 766,
    ["StrmPrivacy SimpleSchema"] = 763,
    ["StrmPrivacy Stream"] = 764,
    ["StrmPrivacy batch job configuration file"] = 762,
    ["Stryker Mutator"] = 560,
    ["StyleCop Analyzers Configuration"] = 561,
    ["Sublime Syntax"] = 767,
    ["Swagger API 2.0"] = 564,
    TSON = 589,
    TSTyche = 590,
    Talhelper = 566,
    ["Talisman configuration"] = 567,
    ["Taskfile config"] = 695,
    Taurus = 568,
    ["TestEnvironment.json"] = 577,
    ["TextMate Grammar"] = 576,
    ["Tier.run pricing.json"] = 571,
    Tikibase = 572,
    ["Traefik v2"] = 580,
    ["Traefik v2 File Provider"] = 581,
    TunnelHub = 801,
    Turborepo = 578,
    Tye = 724,
    ["UET BuildConfig.json"] = 772,
    ["UI5 Manifest"] = 599,
    ["UNCORS configuration"] = 603,
    ["UTAM Page Object"] = 602,
    ["Ubuntu Server Autoinstall"] = 597,
    ["Uniswap Token List"] = 678,
    ["Unreal Engine Uplugin"] = 773,
    ["Unreal Engine Uproject"] = 774,
    ["Updatecli Compose"] = 732,
    ["Updatecli Policy Manifest"] = 733,
    ["Updatecli Policy Metadata"] = 734,
    Uplift = 770,
    ["User Journey Map"] = 698,
    V2Ray = 738,
    ["VSCode Code Snippets"] = 160,
    ["VSIX CLI publishing"] = 616,
    ["Vela Pipeline Configuration"] = 606,
    Vercel = 159,
    Visivo = 799,
    ["Web App Manifest"] = 623,
    ["Web types"] = 626,
    WebExtensions = 622,
    ["Webman package recipe"] = 744,
    ...
    ["bamboo-spec"] = 76,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 781,
    ["bashly-strings.yml"] = 782,
    ["bashly.yml"] = 780,
    ["batect.yml"] = 75,
    ...
    ["partial-cibuildwheel"] = 114,
    ["partial-scikit-build"] = 715,
    ["pathfinder.yml"] = 442,
    ["pattern.json"] = 446,
    ["petstore-v1.0"] = 759,
    pgap_yaml_input_reader = 445,
    ...
    ["settings.job"] = 530,
    ["sfdx-hardis configuration"] = 534,
    ["size-limit configuration"] = 539,
    ["skaffold.yaml"] = 704,
    ["skyuxconfig.json"] = 541,
    snapcraft = 542,
    ["sqlc configuration"] = 550,
    ["stripe-app-local.json"] = 559,
    ["stripe-app.json"] = 558,
    swcrc = 691,
    syntax = 789,
    ["task.json"] = 565,
    taskcat = 658,
    ["template.json"] = 569,
    ["templatsources.json"] = 570,
    ["theme.json"] = 573,
    ["tizen_workspace.json"] = 574,
    tldr = 575,
    tmuxinator = 644,
    ["transcend.yml"] = 582,
    ["trunk.yaml"] = 583,
    ["ts-force-config.json"] = 587,
    ["tsconfig.json"] = 584,
    ["tsd.json"] = 585,
    ["tsdrc.json"] = 586,
    ["tslint.json"] = 588,
    ...
    ["vega-lite.json"] = 605,
    ["vega.json"] = 604,
    ["venvironment-basic.yaml"] = 608,
    ["venvironment.yaml"] = 607,
    ["version.json"] = 609,
    ["vim-addon-info"] = 610,
    ...
    ["vtesttree.yaml"] = 618,
    ["vtestunit.yaml"] = 619,
    ["warp-keysets.json"] = 793,
    ["warp-themes.json"] = 794,
    ["warp-workflows.json"] = 795,
    ["webhint.io"] = 745,
