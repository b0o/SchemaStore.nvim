...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 137,
    [".cryproj (generic)"] = 473,
    [".cryproj engine-5.2"] = 468,
    [".cryproj engine-5.3"] = 469,
    [".cryproj engine-5.4"] = 470,
    [".cryproj engine-5.5"] = 471,
    [".cryproj engine-dev"] = 472,
    [".csscomb.json"] = 139,
    [".csslintrc"] = 140,
    [".eslintrc"] = 181,
    [".esmrc.json"] = 173,
    ...
    [".mtaext"] = 481,
    [".nodehawkrc"] = 296,
    [".npmpackagejsonlintrc"] = 298,
    [".phraseapp.yml"] = 331,
    [".pmbot.yml"] = 323,
    [".postcssrc"] = 328,
    [".pre-commit-config.yml"] = 329,
    [".pre-commit-hooks.yml"] = 330,
    [".putout.json"] = 348,
    [".rehyperc"] = 354,
    [".remarkrc"] = 355,
    [".sprite files"] = 395,
    ...
    [".vsext"] = 449,
    [".yarnrc.yml"] = 513,
    ["<div>RIOTS' studio configuration"] = 452,
    ["@factorial/drupal-breakpoints-css"] = 3,
    ["API Builder"] = 510,
    ["AVA Configuration Schema"] = 564,
    ["AWS CDK cdk.json"] = 125,
    ["AWS CloudFormation"] = 126,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 127,
    ...
    ["Azure Pipelines"] = 43,
    ["Azure Static Web Apps CLI configuration file"] = 397,
    ["Azure Static Web Apps configuration file"] = 396,
    ["BX CI"] = 72,
    ["Better Code Hub"] = 515,
    ["Better Scripts"] = 73,
    BizTalkServerApplicationSchema = 487,
    ...
    ["Butane Config"] = 551,
    ["CICS TS region tagging"] = 558,
    ["CICS TS resource import"] = 559,
    ["CICS TS resource model"] = 560,
    ["CICS TS resource overrides"] = 561,
    ["CMake Presets"] = 74,
    ["CNC Codes JSON Schema"] = 82,
    ["CSR Framework"] = 85,
    ...
    Cheatsheets = 548,
    ["Chrome Extension"] = 119,
    ["CircleCI config.yml"] = 102,
    ["Citation File Format"] = 128,
    CityJSON = 81,
    ["Code Climate"] = 103,
    ["Commandbox Box.json"] = 83,
    ["Commandbox Server.json"] = 84,
    ["Common Catalog Schema"] = 117,
    ["Common types for all schemas"] = 1,
    ["Container Structure Test"] = 498,
    Containerlab = 522,
    ["Dart build configuration"] = 141,
    ["Dart test config"] = 142,
    ["DashLord configuration"] = 143,
    ["Datadog Service Definition"] = 254,
    ["Datahub Ingestion Recipe Schema"] = 565,
    ["Dein Config Schema"] = 86,
    Deno = 147,
    ["Deployer Recipe"] = 150,
    Devfile = 170,
    ["Discord Webhook"] = 152,
    ["Dolittle Artifacts"] = 156,
    ["Dolittle Bounded Context Configuration"] = 157,
    ["Dolittle Event Horizons Configuration"] = 158,
    ["Dolittle Resources Configuration"] = 159,
    ["Dolittle Server Configuration"] = 160,
    ["Dolittle Tenant Map Configuration"] = 162,
    ["Dolittle Tenants Configuration"] = 161,
    ["Dolittle Topology"] = 163,
    ["Drupal Breakpoints Schema"] = 87,
    ["Drupal Config Schema"] = 98,
    ["Drupal Info Schema"] = 88,
    ["Drupal Layouts Schema"] = 89,
    ["Drupal Libraries Schema"] = 90,
    ["Drupal Links Action Schema"] = 91,
    ["Drupal Links Contextual Schema"] = 92,
    ["Drupal Links Menu Schema"] = 93,
    ["Drupal Links Task Schema"] = 94,
    ["Drupal Migration Schema"] = 95,
    ["Drupal Permissions Schema"] = 96,
    ["Drupal Routing Schema"] = 97,
    ["Drupal Services Schema"] = 99,
    ["Drush site aliases"] = 167,
    ["Embrace Config Schema"] = 576,
    ["Error pages"] = 176,
    Esquio = 174,
    ["Estuary Flow Catalog Schema"] = 555,
    ["Expo SDK"] = 179,
    ["F-Droid Data metadata"] = 184,
    ["Facets - FSDL - Application"] = 182,
    ["Fossa configuration file"] = 189,
    ["Fossa's fossa-deps file"] = 190,
    ["Foundry VTT - Manifest"] = 187,
    ["Foundry VTT - Template"] = 188,
    ["Foxx Manifest"] = 44,
    ["GatewayCore API Gateway"] = 193,
    ["GeoJSON.json latest"] = 553,
    GherKing = 557,
    ["GitHub Action"] = 197,
    ["GitHub Funding"] = 198,
    ["GitHub Issue Template configuration"] = 200,
    ["GitHub Workflow"] = 201,
    ["GitHub Workflow Template Properties"] = 202,
    ["GitHub issue forms"] = 199,
    GitVersion = 196,
    ["Gitpod Configuration"] = 204,
    ["Global Privacy Control"] = 194,
    ["Google Cloud Workflows"] = 124,
    Goreleaser = 207,
    ["Goreleaser Pro"] = 208,
    ["Gradle Build Cache Node"] = 512,
    ["Gradle Enterprise"] = 511,
    ["Grafana 5.x Dashboard"] = 209,
    ["GraphQL Code Generator"] = 212,
    ["GraphQL Config"] = 211,
    ["GraphQL Mesh"] = 210,
    ["Grunt JSHint task"] = 216,
    ["Grunt Watch task"] = 217,
    ["Grunt base task"] = 218,
    ["Grunt clean task"] = 214,
    ["Grunt copy task"] = 213,
    ["Grunt cssmin task"] = 215,
    HEMTT = 484,
    Hadolint = 496,
    ["Hardware Sentry Configuration"] = 569,
    Hayson = 220,
    ["Haystack Pipeline"] = 221,
    ["Hazelcast 5 Configuration"] = 222,
    ["Helm Chart.lock"] = 101,
    ["Helm Chart.yaml"] = 100,
    Hugo = 547,
    ["Istanbul Schema"] = 572,
    ["JDownloader2 crawler multi-rule schema"] = 238,
    ["JDownloader2 crawler single-rule schema"] = 237,
    ["JFrog File Spec"] = 239,
    ["JFrog Pipelines YML DSL"] = 578,
    ["JSON Document Transform"] = 247,
    ["JSON Feed"] = 248,
    ["JSON Resume"] = 358,
    ["JSON Schema Draft 2020-12"] = 464,
    ["JSON Schema Draft 4"] = 461,
    ["JSON Schema Draft 7"] = 462,
    ["JSON Schema Draft 8"] = 463,
    ["JSON schema for CodeShip Pro services configuration files"] = 110,
    ["JSON schema for CodeShip Pro steps configuration files"] = 111,
    ["JSON schema for Codecov configuration files"] = 109,
    ["JSON-API"] = 246,
    ["JSON-e templates"] = 520,
    ["JSON-stat 2.0"] = 458,
    JSONPatch = 250,
    Jasmine = 233,
    Jekyll = 234,
    ["Jenkins X Pipelines"] = 235,
    ["Jenkins X Requirements"] = 236,
    ["Jovo Language Models"] = 240,
    ["KSP-AVC"] = 459,
    ["KSP-CKAN"] = 460,
    ["Keycloak REST API"] = 580,
    ["KoDE/CI build.yaml"] = 574,
    ["Kong DBLess Schema"] = 575,
    KrakenD = 253,
    ["LinkML Metamodel"] = 264,
    Liquibase = 526,
    ["Liquibase Flow File"] = 527,
    Markdownlint = 530,
    ["MegaLinter configuration"] = 268,
    ["MegaLinter descriptor"] = 269,
    ["Meltano plugin discovery definition"] = 271,
    ["Meltano project definition"] = 270,
    ["Microsoft Band Web Tile"] = 272,
    ["Minecraft Data Pack Advancement"] = 274,
    ["Minecraft Data Pack Biome"] = 275,
    ["Minecraft Data Pack Configured Carver"] = 276,
    ["Minecraft Data Pack Dimension"] = 278,
    ["Minecraft Data Pack Dimension Type"] = 277,
    ["Minecraft Data Pack Item Modifier"] = 279,
    ["Minecraft Data Pack Loot Table"] = 280,
    ["Minecraft Data Pack Metadata"] = 281,
    ["Minecraft Data Pack Predicate"] = 282,
    ["Minecraft Data Pack Recipe"] = 283,
    ["Minecraft Data Pack Template Pool"] = 284,
    ["Minecraft Resourcepack Sounds"] = 285,
    ["MongoDB Atlas Search Index Definition Schema"] = 573,
    ["Monika Configuration Schema"] = 571,
    ["Motif config"] = 480,
    ["Netin Diagnostic System Template"] = 535,
    ["Netlify config schema"] = 290,
    ["Nightwatch.js"] = 291,
    ["OSS Review Toolkit configuration"] = 313,
    ["OSS Review Toolkit curation"] = 314,
    ["OSS Review Toolkit package configuration"] = 315,
    ["OSS Review Toolkit repository configuration"] = 316,
    ["OSS Review Toolkit resolutions"] = 317,
    Opctl = 483,
    ["OpenWeather Current Weather API"] = 519,
    ["OpenWeather Road Risk API"] = 518,
    ["Ory Hydra configuration"] = 226,
    ["Ory Keto configuration"] = 255,
    ["Ory Kratos configuration"] = 312,
    ["Ory Oathkeeper configuration"] = 303,
    ["Outblocks App configuration"] = 310,
    ["Outblocks database table"] = 311,
    ["Outblocks project configuration"] = 309,
    Packer = 320,
    ["Pipeline component"] = 528,
    ["PocketMine plugin.yml"] = 324,
    Pterodactyl = 568,
    ["Pull Request Labeler"] = 347,
    PyProject = 351,
    Qodana = 544,
    ["Quali Torque Blueprint Spec 2"] = 566,
    ["RKE Cluster Configuration JSON Schema"] = 525,
    ["RKE Cluster Configuration YAML Schema"] = 524,
    Ray = 495,
    ["Read the Docs"] = 350,
    ["Red-DiscordBot Cog"] = 352,
    ["Red-DiscordBot Cog Repo"] = 353,
    Renovate = 359,
    ["Replit schema"] = 356,
    RoadRunner = 360,
    ["Rust toolchain"] = 362,
    SWADL = 408,
    ["Sapphire CLI Config"] = 363,
    ["SauceCTL Configuration"] = 532,
    ["Schema Catalog"] = 376,
    ["Scoop manifest"] = 381,
    ["Semgrep Rule"] = 383,
    ["Serverless Framework Configuration"] = 539,
    ["Serverless Workflow Schema"] = 540,
    ["Settings.paf"] = 385,
    ["Shopware 6 Configuration"] = 541,
    ["Shopware CLI Extension Store Configuration"] = 542,
    ["Shopware CLI Project Store Configuration"] = 543,
    Solidarity = 390,
    ["Solution filters"] = 391,
    ["Source Maps v3"] = 392,
    SpecIF = 393,
    ["Sponge Mixin configuration"] = 394,
    ["StackHawk Scanner Configuration"] = 538,
    ["StackHead CLI config"] = 398,
    ["StackHead module configuration"] = 399,
    ["StackHead project definition"] = 400,
    Stale = 401,
    Starship = 402,
    ["Statamic Blueprint"] = 403,
    ["StrmPrivacy batch job configuration file"] = 579,
    ["Stryker Mutator"] = 405,
    ["StyleCop Analyzers Configuration"] = 406,
    ["Swagger API 2.0"] = 409,
    TSON = 429,
    ["Talisman configuration"] = 410,
    ["Taskfile YAML Schema"] = 521,
    Taurus = 411,
    ["TestEnvironment.json"] = 418,
    Tikibase = 414,
    ["Traefik v2"] = 421,
    ["Traefik v2 File Provider"] = 422,
    Turborepo = 419,
    Tye = 545,
    ["UI5 Manifest"] = 435,
    ["UTAM Page Object"] = 437,
    ["Ubuntu Server Autoinstall"] = 433,
    ["Uniswap Token List"] = 504,
    Updatecli = 552,
    ["User Journey Map YAML Schema"] = 523,
    V2Ray = 556,
    ["VSCode Code Snippets"] = 113,
    ["VSIX CLI publishing"] = 450,
    ["Vela Pipeline Configuration"] = 440,
    Vercel = 112,
    ["Web App Manifest"] = 454,
    ["Web types"] = 457,
    WebExtensions = 453,
    ["Webman package recipe"] = 562,
    ["Windows Package Manager Installer Manifest"] = 501,
    ["Windows Package Manager Locale Manifest"] = 502,
    ["Windows Package Manager Singleton Manifest"] = 500,
    ["Woodpecker pipeline config"] = 534,
    ["Xstate Machine Schema"] = 550,
    ["Yippee-Ki-JSON configuration YML"] = 506,
    ["angular.json"] = 9,
    ...
    ["chutzpah.json"] = 120,
    ["cloud-init: cloud-config userdata JSON schema"] = 107,
    ["cloud-sdk-pipeline-config-schema"] = 122,
    ["cloudbuild.json"] = 123,
    cloudify = 106,
    codemagic = 108,
    ["coffeelint.json"] = 129,
    comet = 516,
    ["commands.json"] = 116,
    ["compile_commands.json"] = 115,
    ["compilerconfig.json"] = 114,
    ["component-detection-manifest.json"] = 132,
    ["component.json"] = 131,
    ["composer.json"] = 130,
    ["config.json"] = 133,
    ["contentmanifest.json"] = 121,
    ["contribute.json"] = 134,
    ["cosmos.config.json"] = 118,
    ["crowdin.yml"] = 135,
    cspell = 138,
    ["cypress.json"] = 136,
    ["datalogic-scan2deploy-android"] = 144,
    ["datalogic-scan2deploy-ce"] = 145,
    ["debugsettings.json"] = 146,
    ["dependabot-v2.json"] = 149,
    ["dependabot.json"] = 148,
    ["deployed-cli"] = 549,
    ["detekt.yml"] = 151,
    devinit = 508,
    ...
    ["docker-seq schema"] = 154,
    ["dockerd.json"] = 153,
    ["dotnet Release Index manifest"] = 164,
    ["dotnetcli.host.json"] = 165,
    ["drone.json"] = 166,
    ["dss-2.0.0.json"] = 168,
    ["dvc.yaml"] = 169,
    ["ecosystem.json"] = 171,
    eksctl = 172,
    ["electron-builder configuration file."] = 177,
    ["epr-manifest.json"] = 175,
    ["evcc.yaml"] = 178,
    ["ezd schema"] = 180,
    ["fabric.mod.json"] = 183,
    ["first-timers-bot"] = 186,
    ["fly.io Schema"] = 45,
    fulibWorkflows = 533,
    ["func.yaml"] = 191,
    ["function.json"] = 192,
    ...
    ["gitlab-ci"] = 203,
    ["global.json"] = 205,
    ["golangci-lint Configuration"] = 206,
    ["haxelib.json"] = 219,
    helmfile = 497,
    ["host-meta.json"] = 224,
    ["host.json"] = 223,
    ...
    huskyrc = 476,
    ["ide.host.json"] = 227,
    ["imageoptimizer.json"] = 228,
    ["importmap.json"] = 230,
    ["ioBroker JSON UI"] = 231,
    ["ioBroker Package manifest"] = 232,
    ["ize.toml"] = 581,
    ["jsconfig.json"] = 251,
    ["jscpd Configuration Schema"] = 567,
    jsdoc = 494,
    ["k3d.yaml"] = 252,
    ["kustomization.yaml"] = 256,
    ["label-commenter-config.yml"] = 257,
    ["launchsettings.json"] = 258,
    ["lerna.json"] = 259,
    ["lgtm.yml"] = 260,
    ["libman.json"] = 261,
    ["license-report-config.json"] = 262,
    ["linkinator.config.json"] = 263,
    ["local.settings.json"] = 265,
    ["localazy.json"] = 266,
    ["lsdlschema.json"] = 267,
    ["markdown-lint-check"] = 531,
    mboats = 537,
    ["mimetypes.json"] = 273,
    ["mta.yaml"] = 478,
    ["mtad.yaml"] = 479,
    ["mycode.json"] = 288,
    ["napari plugin manifest"] = 289,
    neoload = 489,
    ["nest-cli"] = 294,
    ["ninjs (News in JSON) 1.3"] = 293,
    ["ninjs (News in JSON) 2.0"] = 292,
    ["nlu.json"] = 295,
    ["nodemon.json"] = 297,
    ["noodl.schema.json"] = 536,
    now = 485,
    ["nswag.json"] = 301,
    ntangle = 302,
    ["nuclei-template.yaml"] = 299,
    ["nuget-project.json"] = 300,
    ["ocelot.json"] = 304,
    ["omnisharp.json"] = 305,
    ["openapi.json"] = 306,
    ["openfin.json"] = 308,
    ["openrpc.json"] = 307,
    ["package.json"] = 318,
    ["package.manifest"] = 319,
    ["pattern.json"] = 322,
    ["petstore-v1.0"] = 577,
    pgap_yaml_input_reader = 321,
    ["plagiarize-me.yaml"] = 326,
    ["plagiarize.yaml"] = 325,
    ["portman.json"] = 327,
    ["prettierrc.json"] = 332,
    ["prisma.yml"] = 333,
    ["project-1.0.0-beta3.json"] = 335,
    ["project-1.0.0-beta4.json"] = 336,
    ["project-1.0.0-beta5.json"] = 337,
    ["project-1.0.0-beta6.json"] = 338,
    ["project-1.0.0-beta8.json"] = 339,
    ["project-1.0.0-rc1.json"] = 340,
    ["project-1.0.0-rc2.json"] = 341,
    ["project.json"] = 334,
    ["prometheus.json"] = 342,
    ["prometheus.rules.json"] = 343,
    ["proxies.json"] = 344,
    ["publiccode.yml"] = 345,
    ["pubspec.yaml"] = 346,
    ["pyrseas-0.8.json"] = 349,
    ["release drafter"] = 490,
    rustfmt = 361,
    ["sarif-1.0.0.json"] = 364,
    ["sarif-2.0.0.json"] = 365,
    ["sarif-2.1.0"] = 374,
    ["sarif-2.1.0-rtm.2"] = 366,
    ["sarif-2.1.0-rtm.3"] = 368,
    ["sarif-2.1.0-rtm.4"] = 370,
    ["sarif-2.1.0-rtm.5"] = 372,
    ["sarif-external-property-file-2.1.0"] = 375,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 367,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 369,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 371,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 373,
    ["schema.org - Action"] = 377,
    ["schema.org - ContactPoint"] = 378,
    ["schema.org - Place"] = 379,
    ["schema.org - Thing"] = 380,
    ["semantic-release"] = 382,
    ["servicehub.config.json"] = 467,
    ["servicehub.service.json"] = 466,
    ["settings.job"] = 384,
    ["sfdx-hardis configuration"] = 386,
    ["size-limit configuration"] = 387,
    ["skaffold.yaml"] = 529,
    ["skyuxconfig.json"] = 388,
    snapcraft = 389,
    ["stripe-app.json"] = 404,
    swcrc = 517,
    taskcat = 486,
    ["template.json"] = 412,
    ["templatsources.json"] = 413,
    ["theme.json"] = 415,
    ["tizen_workspace.json"] = 416,
    tmLanguage = 417,
    tmuxinator = 475,
    ["trunk.yaml schema"] = 423,
    ["ts-force-config.json"] = 427,
    ["tsconfig.json"] = 424,
    ["tsd.json"] = 425,
    ["tsdrc.json"] = 426,
    ["tslint.json"] = 428,
    ...
    ["vega-lite.json"] = 439,
    ["vega.json"] = 438,
    ["venvironment-basic.yaml"] = 442,
    ["venvironment.yaml"] = 441,
    ["version.json"] = 443,
    ["vim-addon-info"] = 444,
    ["vs-2017.3.host.json"] = 446,
    ["vs-nesting.json"] = 447,
    ["vsls.json"] = 445,
    ["vss-extension.json"] = 451,
    ["webhint.io"] = 563,
    ["webjobpublishsettings.json"] = 456,
    ["webjobs-list.json"] = 455,
    ["xs-app.json"] = 482,
    ["xunit.runner.json"] = 465,
    yamllint = 505,
    zuul = 491,
    ["Žinoma"] = 499
  },
