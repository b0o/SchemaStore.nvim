...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 111,
    [".cryproj (generic)"] = 418,
    [".cryproj engine-5.2"] = 413,
    [".cryproj engine-5.3"] = 414,
    [".cryproj engine-5.4"] = 415,
    [".cryproj engine-5.5"] = 416,
    [".cryproj engine-dev"] = 417,
    [".csscomb.json"] = 113,
    [".csslintrc"] = 114,
    [".eslintrc"] = 151,
    [".esmrc.json"] = 144,
    ...
    [".mtaext"] = 424,
    [".nodehawkrc"] = 262,
    [".npmpackagejsonlintrc"] = 264,
    [".phraseapp.yml"] = 291,
    [".pmbot.yml"] = 284,
    [".postcssrc"] = 289,
    [".pre-commit-config.yml"] = 290,
    [".putout.json"] = 308,
    [".rehyperc"] = 313,
    [".remarkrc"] = 314,
    [".sprite files"] = 349,
    ...
    [".vsext"] = 394,
    [".yarnrc.yml"] = 456,
    ["<div>RIOTS' studio configuration"] = 397,
    ["API Builder"] = 453,
    ["AWS CDK cdk.json"] = 100,
    ["AWS CloudFormation"] = 101,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 102,
    ...
    ["Azure Pipelines"] = 40,
    ["Azure Static Web Apps CLI configuration file"] = 351,
    ["Azure Static Web Apps configuration file"] = 350,
    ["Better Code Hub"] = 458,
    BizTalkServerApplicationSchema = 430,
    ...
    ["Butane config schema"] = 492,
    ["CICS TS resource overrides"] = 499,
    ["CMake Presets"] = 68,
    ["CSR Framework"] = 75,
    ["Camel YAML DSL"] = 69,
    Carafe = 70,
    ["Catalog Info Backstage"] = 71,
    Cheatsheets = 489,
    ["Chrome Extension"] = 94,
    ["CircleCI config.yml"] = 78,
    ["Citation File Format"] = 103,
    CityJSON = 72,
    ["Code Climate"] = 79,
    ["Commandbox Box.json"] = 73,
    ["Commandbox Server.json"] = 74,
    ["Common types for all schemas"] = 1,
    ["Container Structure Test"] = 441,
    Containerlab = 466,
    ["Dart build configuration"] = 115,
    ["Dart test config"] = 116,
    Deno = 120,
    ["Deployer Recipe"] = 123,
    Devfile = 141,
    ["Discord Webhook"] = 125,
    ["Dolittle Artifacts"] = 127,
    ["Dolittle Bounded Context Configuration"] = 128,
    ["Dolittle Event Horizons Configuration"] = 129,
    ["Dolittle Resources Configuration"] = 130,
    ["Dolittle Server Configuration"] = 131,
    ["Dolittle Tenant Map Configuration"] = 133,
    ["Dolittle Tenants Configuration"] = 132,
    ["Dolittle Topology"] = 134,
    ["Drush site aliases"] = 138,
    ["Error pages"] = 147,
    Esquio = 145,
    ["Estuary Flow Catalog Schema"] = 496,
    ["Expo SDK"] = 150,
    ["F-Droid Data metadata"] = 154,
    ["Facets - FSDL - Application"] = 152,
    ["Fossa configuration file"] = 159,
    ["Fossa's fossa-deps file"] = 160,
    ["Foundry VTT - Manifest"] = 157,
    ["Foundry VTT - Template"] = 158,
    ["Foxx Manifest"] = 41,
    ["GatewayCore API Gateway"] = 163,
    ["GeoJSON.json latest"] = 494,
    GherKing = 498,
    ["GitHub Action"] = 167,
    ["GitHub Funding"] = 168,
    ["GitHub Issue Template configuration"] = 170,
    ["GitHub Workflow"] = 171,
    ["GitHub Workflow Template Properties"] = 172,
    ["GitHub issue forms"] = 169,
    GitVersion = 166,
    ["Gitpod Configuration"] = 174,
    ["Global Privacy Control"] = 164,
    ["Google Cloud Workflows"] = 99,
    Goreleaser = 177,
    ["Goreleaser Pro"] = 178,
    ["Gradle Build Cache Node"] = 455,
    ["Gradle Enterprise"] = 454,
    ["Grafana 5.x Dashboard"] = 179,
    ["GraphQL Code Generator"] = 182,
    ["GraphQL Config"] = 181,
    ["GraphQL Mesh"] = 180,
    ["Grunt JSHint task"] = 186,
    ["Grunt Watch task"] = 187,
    ["Grunt base task"] = 188,
    ["Grunt clean task"] = 184,
    ["Grunt copy task"] = 183,
    ["Grunt cssmin task"] = 185,
    HEMTT = 427,
    Hadolint = 439,
    ["Hammerkit YAML Schema"] = 465,
    Hayson = 190,
    ["Haystack Pipeline"] = 191,
    ["Hazelcast 5 Configuration"] = 192,
    ["Helm Chart.lock"] = 77,
    ["Helm Chart.yaml"] = 76,
    Hugo = 488,
    ["JFrog File Spec"] = 206,
    ["JSON Document Transform"] = 214,
    ["JSON Feed"] = 215,
    ["JSON Resume"] = 316,
    ["JSON Schema Draft 2020-12"] = 409,
    ["JSON Schema Draft 4"] = 406,
    ["JSON Schema Draft 7"] = 407,
    ["JSON Schema Draft 8"] = 408,
    ["JSON schema for CodeShip Pro services configuration files"] = 86,
    ["JSON schema for CodeShip Pro steps configuration files"] = 87,
    ["JSON schema for Codecov configuration files"] = 85,
    ["JSON-API"] = 213,
    ["JSON-e templates"] = 463,
    ["JSON-stat 2.0"] = 403,
    JSONPatch = 217,
    Jekyll = 203,
    ["Jenkins X Pipelines"] = 204,
    ["Jenkins X Requirements"] = 205,
    ["Jovo Language Models"] = 207,
    ["KSP-AVC"] = 404,
    ["KSP-CKAN"] = 405,
    ["LinkML Metamodel"] = 230,
    Liquibase = 470,
    Markdownlint = 473,
    ["MegaLinter configuration"] = 234,
    ["MegaLinter descriptor"] = 235,
    ["Meltano plugin discovery definition"] = 237,
    ["Meltano project definition"] = 236,
    ["Microsoft Band Web Tile"] = 238,
    ["Minecraft Data Pack Advancement"] = 240,
    ["Minecraft Data Pack Biome"] = 241,
    ["Minecraft Data Pack Configured Carver"] = 242,
    ["Minecraft Data Pack Dimension"] = 244,
    ["Minecraft Data Pack Dimension Type"] = 243,
    ["Minecraft Data Pack Item Modifier"] = 245,
    ["Minecraft Data Pack Loot Table"] = 246,
    ["Minecraft Data Pack Metadata"] = 247,
    ["Minecraft Data Pack Predicate"] = 248,
    ["Minecraft Data Pack Recipe"] = 249,
    ["Minecraft Data Pack Template Pool"] = 250,
    ["Minecraft Resourcepack Sounds"] = 251,
    ["Netin Diagnostic System Template"] = 477,
    ["Netlify config schema"] = 256,
    ["Nightwatch.js"] = 257,
    ["OSS Review Toolkit repository configuration"] = 278,
    Opctl = 426,
    ["OpenWeather Current Weather API"] = 462,
    ["OpenWeather Road Risk API"] = 461,
    ["Ory Hydra configuration"] = 196,
    ["Ory Keto configuration"] = 221,
    ["Ory Kratos configuration"] = 277,
    ["Ory Oathkeeper configuration"] = 269,
    ["Outblocks App configuration"] = 275,
    ["Outblocks database table"] = 276,
    ["Outblocks project configuration"] = 274,
    Packer = 281,
    ["Pipeline component"] = 471,
    ["PocketMine plugin.yml"] = 285,
    ["Pull Request Labeler"] = 307,
    Qodana = 485,
    ["RKE Cluster Configuration JSON Schema"] = 469,
    ["RKE Cluster Configuration YAML Schema"] = 468,
    Ray = 438,
    ["Read the Docs"] = 310,
    ["Red-DiscordBot Cog"] = 311,
    ["Red-DiscordBot Cog Repo"] = 312,
    Renovate = 317,
    RoadRunner = 318,
    SWADL = 360,
    ["Sapphire CLI Config"] = 319,
    ["SauceCTL Configuration"] = 474,
    ["Schema Catalog"] = 332,
    ["Scoop manifest"] = 337,
    ["Semgrep Rule"] = 338,
    ["Serverless Framework Configuration"] = 481,
    ["Settings.paf"] = 340,
    ["Shopware 6 Configuration"] = 482,
    ["Shopware CLI Extension Store Configuration"] = 483,
    ["Shopware CLI Project Store Configuration"] = 484,
    Solidarity = 345,
    ["Source Maps v3"] = 346,
    SpecIF = 347,
    ["Sponge Mixin configuration"] = 348,
    ["StackHawk Scanner Configuration"] = 480,
    ["StackHead CLI config"] = 352,
    ["StackHead module configuration"] = 353,
    ["StackHead project definition"] = 354,
    Stale = 355,
    ["Statamic Blueprint"] = 356,
    ["Stryker Mutator"] = 357,
    ["StyleCop Analyzers Configuration"] = 358,
    ["Swagger API 2.0"] = 361,
    ["Taskfile YAML Schema"] = 464,
    Taurus = 362,
    ["TestEnvironment.json"] = 368,
    Tikibase = 365,
    ["Traefik v2"] = 370,
    ["Traefik v2 File Provider"] = 371,
    Tye = 486,
    ["UI5 Manifest"] = 383,
    ["Ubuntu Server Autoinstall"] = 381,
    ["Uniswap Token List"] = 447,
    Updatecli = 493,
    ["User Journey Map YAML Schema"] = 467,
    V2Ray = 497,
    ["VSCode Code Snippets"] = 89,
    ["VSIX CLI publishing"] = 395,
    ["Vela Pipeline Configuration"] = 387,
    Vercel = 88,
    ["Web App Manifest"] = 399,
    ["Web types"] = 402,
    WebExtensions = 398,
    ["Webman package recipe"] = 500,
    ["Windows Package Manager Installer Manifest"] = 444,
    ["Windows Package Manager Locale Manifest"] = 445,
    ["Windows Package Manager Singleton Manifest"] = 443,
    ["Woodpecker pipeline config"] = 476,
    ["Xstate Machine Schema"] = 491,
    ["Yippee-Ki-JSON configuration YML"] = 449,
    ["angular.json"] = 8,
    ...
    ["chutzpah.json"] = 95,
    ["cloud-init: cloud-config userdata JSON schema"] = 83,
    ["cloud-sdk-pipeline-config-schema"] = 97,
    ["cloudbuild.json"] = 98,
    cloudify = 82,
    codemagic = 84,
    ["coffeelint.json"] = 104,
    comet = 459,
    ["commands.json"] = 92,
    ["compile_commands.json"] = 91,
    ["compilerconfig.json"] = 90,
    ["component.json"] = 106,
    ["composer.json"] = 105,
    ["config.json"] = 107,
    ["contentmanifest.json"] = 96,
    ["contribute.json"] = 108,
    ["cosmos.config.json"] = 93,
    ["crowdin.yml"] = 109,
    cspell = 112,
    ["cypress.json"] = 110,
    ["datalogic-scan2deploy-android"] = 117,
    ["datalogic-scan2deploy-ce"] = 118,
    ["debugsettings.json"] = 119,
    ["dependabot-v2.json"] = 122,
    ["dependabot.json"] = 121,
    ["deployed-cli"] = 490,
    ["detekt.yml"] = 124,
    devinit = 451,
    ["docfx.json"] = 126,
    ["docker-compose.yml"] = 450,
    ["dotnet Release Index manifest"] = 135,
    ["dotnetcli.host.json"] = 136,
    ["drone.json"] = 137,
    ["dss-2.0.0.json"] = 139,
    ["dvc.yaml"] = 140,
    ["ecosystem.json"] = 142,
    eksctl = 143,
    ["electron-builder configuration file."] = 148,
    ["epr-manifest.json"] = 146,
    ["evcc.yaml"] = 149,
    ["fabric.mod.json"] = 153,
    ["first-timers-bot"] = 156,
    fulibWorkflows = 475,
    ["func.yaml"] = 161,
    ["function.json"] = 162,
    ["geojson.json"] = 165,
    ["gitlab-ci"] = 173,
    ["global.json"] = 175,
    ["golangci-lint Configuration"] = 176,
    ["haxelib.json"] = 189,
    helmfile = 440,
    ["host-meta.json"] = 194,
    ["host.json"] = 193,
    ...
    huskyrc = 420,
    ["ide.host.json"] = 197,
    ["imageoptimizer.json"] = 198,
    ["importmap.json"] = 200,
    ["ioBroker JSON UI"] = 201,
    ["ioBroker Package manifest"] = 202,
    ["jsconfig.json"] = 218,
    jsdoc = 437,
    ["k3d.yaml"] = 219,
    ["kustomization.yaml"] = 222,
    ["label-commenter-config.yml"] = 223,
    ["launchsettings.json"] = 224,
    ["lerna.json"] = 225,
    ["lgtm.yml"] = 226,
    ["libman.json"] = 227,
    ["license-report-config.json"] = 228,
    ["linkinator.config.json"] = 229,
    ["local.settings.json"] = 231,
    ["localazy.json"] = 232,
    ["lsdlschema.json"] = 233,
    mboats = 479,
    ["mimetypes.json"] = 239,
    ...
    ["mtad.yaml"] = 423,
    ["mycode.json"] = 254,
    ["napari plugin manifest"] = 255,
    neoload = 432,
    ["nest-cli"] = 260,
    ["ninjs (News in JSON) 1.3"] = 259,
    ["ninjs (News in JSON) 2.0"] = 258,
    ["nlu.json"] = 261,
    ["nodemon.json"] = 263,
    ["noodl.schema.json"] = 478,
    now = 428,
    ["nswag.json"] = 267,
    ntangle = 268,
    ["nuclei-template.yaml"] = 265,
    ["nuget-project.json"] = 266,
    ["ocelot.json"] = 270,
    ["omnisharp.json"] = 271,
    ["openapi.json"] = 272,
    ["openfin.json"] = 273,
    ["package.json"] = 279,
    ["package.manifest"] = 280,
    ["pattern.json"] = 283,
    pgap_yaml_input_reader = 282,
    ["plagiarize-me.yaml"] = 287,
    ["plagiarize.yaml"] = 286,
    ["portman.json"] = 288,
    ["prettierrc.json"] = 292,
    ["prisma.yml"] = 293,
    ["project-1.0.0-beta3.json"] = 295,
    ["project-1.0.0-beta4.json"] = 296,
    ["project-1.0.0-beta5.json"] = 297,
    ["project-1.0.0-beta6.json"] = 298,
    ["project-1.0.0-beta8.json"] = 299,
    ["project-1.0.0-rc1.json"] = 300,
    ["project-1.0.0-rc2.json"] = 301,
    ["project.json"] = 294,
    ["prometheus.json"] = 302,
    ["prometheus.rules.json"] = 303,
    ["proxies.json"] = 304,
    ["publiccode.yml"] = 305,
    ["pubspec.yaml"] = 306,
    ["pyrseas-0.8.json"] = 309,
    ["release drafter"] = 433,
    ["sarif-1.0.0.json"] = 320,
    ["sarif-2.0.0.json"] = 321,
    ["sarif-2.1.0"] = 330,
    ["sarif-2.1.0-rtm.2"] = 322,
    ["sarif-2.1.0-rtm.3"] = 324,
    ["sarif-2.1.0-rtm.4"] = 326,
    ["sarif-2.1.0-rtm.5"] = 328,
    ["sarif-external-property-file-2.1.0"] = 331,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 323,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 325,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 327,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 329,
    ["schema.org - Action"] = 333,
    ["schema.org - ContactPoint"] = 334,
    ["schema.org - Place"] = 335,
    ["schema.org - Thing"] = 336,
    ["service.datadog.yaml"] = 220,
    ["servicehub.config.json"] = 412,
    ["servicehub.service.json"] = 411,
    ["settings.job"] = 339,
    ["sfdx-hardis configuration"] = 341,
    ["size-limit configuration"] = 342,
    ["skaffold.yaml"] = 472,
    ["skyuxconfig.json"] = 343,
    snapcraft = 344,
    swcrc = 460,
    taskcat = 429,
    ["template.json"] = 363,
    ["templatsources.json"] = 364,
    ["theme.json"] = 366,
    tmLanguage = 367,
    ["trunk.yaml schema"] = 372,
    ["ts-force-config.json"] = 376,
    ["tsconfig.json"] = 373,
    ["tsd.json"] = 374,
    ["tsdrc.json"] = 375,
    ["tslint.json"] = 377,
