...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 756,
    [".nodehawkrc"] = 480,
    [".npmpackagejsonlintrc"] = 484,
    [".omletrc"] = 927,
    [".phrase.yml"] = 545,
    [".phraseapp.yml"] = 546,
    [".pmbot.yml"] = 533,
    [".postcssrc"] = 540,
    [".powerpages-web-template-manifest"] = 542,
    [".pre-commit-config.yml"] = 543,
    [".pre-commit-hooks.yml"] = 544,
    [".putout.json"] = 566,
    [".rehyperc"] = 585,
    [".remarkrc"] = 587,
    [".sprite files"] = 649,
    ...
    ["A micro editor config"] = 435,
    ABCInventoryModuleData = 13,
    ABCSupplyPlan = 14,
    AIConfig = 15,
    ["API Builder"] = 789,
    ["AVA Configuration"] = 849,
    ["AWS AppConfig Feature Flags-v1"] = 38,
    ["AWS CDK cdk.json"] = 192,
    ["AWS CloudFormation"] = 193,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 194,
    ["AWS SAM CLI Samconfig"] = 195,
    ["Adobe UXP Manifest"] = 909,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Alacritty Configuration"] = 821,
    ["All Contributors configuration file"] = 874,
    ["Ansible Argument Specs"] = 322,
    ["Ansible Collection Galaxy"] = 329,
    ["Ansible Execution Environment"] = 319,
    ["Ansible Inventory"] = 328,
    ["Ansible Meta"] = 320,
    ["Ansible Meta Runtime"] = 321,
    ["Ansible Navigator Configuration"] = 331,
    ["Ansible Playbook"] = 326,
    ["Ansible Requirements"] = 323,
    ["Ansible Rulebook"] = 327,
    ["Ansible Tasks File"] = 325,
    ["Ansible Vars File"] = 324,
    ["Ansible-lint Configuration"] = 330,
    Any = 936,
    ["AnyWork Automation Configuration"] = 5,
    ["App config Spotify Backstage"] = 20,
    ["Application Accelerator"] = 2,
    ["Application list for a WinUtil"] = 953,
    ArchitectFX = 957,
    ["Argo Events"] = 28,
    ["Argo Workflows"] = 29,
    AssemblyScript = 32,
    ...
    AutoAPICase = 884,
    ["Avro Avsc"] = 37,
    ["Azure Container App template for defining an immutable revision"] = 39,
    ["Azure DevOps extension manifest"] = 42,
    ["Azure Device Update for IoT Hub import manifest"] = 40,
    ["Azure Device Update for IoT Hub update manifest"] = 41,
    ["Azure IoT Edge deployment"] = 45,
    ["Azure IoT Edge deployment template"] = 46,
    ["Azure IoT EdgeAgent deployment"] = 43,
    ["Azure IoT EdgeHub deployment"] = 44,
    ["Azure Landing Zones Library archetype definition"] = 50,
    ["Azure Landing Zones Library archetype override"] = 51,
    ["Azure Landing Zones Library architecture definition"] = 49,
    ["Azure Landing Zones Library metadata"] = 47,
    ["Azure Landing Zones Library policy default values"] = 48,
    ["Azure Pipelines"] = 65,
    ["Azure Static Web Apps CLI configuration file"] = 652,
    ["Azure Static Web Apps configuration file"] = 651,
    ["BOSH Deploy Config"] = 89,
    ["BX CI"] = 106,
    ["Bashly (bashly.yml)"] = 878,
    ["Bashly Settings (bashly-settings.yml)"] = 879,
    ["Better Code Hub"] = 793,
    ["Better Scripts"] = 107,
    Bigconfig = 82,
    ["Biome Formatter Config"] = 52,
    ["Bitmovin Encoding Template"] = 963,
    BizTalkServerApplicationSchema = 762,
    Bleep = 108,
    ["Block Protocol Metadata"] = 105,
    ["Boyka Framework"] = 90,
    Briefcase = 768,
    ["Build Info"] = 97,
    Buildkite = 99,
    ["Bukkit plugin.yml"] = 98,
    ["BungeeCord plugin.yml"] = 103,
    ["Butane Config"] = 834,
    ["CGS Custom Card Game (CardGameDef.json)"] = 914,
    ["CICS TS region tagging"] = 843,
    ["CICS TS resource import"] = 844,
    ["CICS TS resource model"] = 845,
    ["CICS TS resource overrides"] = 846,
    ["CMake Presets"] = 109,
    ["CNC Codes"] = 124,
    ["CRS WAF test file"] = 943,
    ["CRS WAF test platform overrides file"] = 944,
    ["CSS Comb (.csscomb.json)"] = 219,
    ["CSS Lint (.csslintrc)"] = 220,
    ["CSpell (cspell.json)"] = 218,
    ["CVE Record Format"] = 130,
    CWL = 920,
    ["Cache Warmup config"] = 110,
    ["Calqulus pipeline"] = 111,
    ["Camel YAML DSL"] = 112,
    ["Cannon TOML"] = 113,
    Carafe = 114,
    ["Cargo Make"] = 116,
    ...
    ["Chamaleon environment"] = 967,
    ["Chamaleon template"] = 966,
    Changesets = 204,
    Cheatsheets = 831,
    ["Chrome Extension"] = 185,
    ["Chromia Model"] = 118,
    ["CircleCI config.yml"] = 161,
    ["Citation File Format"] = 206,
    CityJSON = 120,
    ["Clawject config"] = 129,
    ["Cloud Foundry Application Manifest"] = 926,
    ["Cloud Run Spec v1"] = 948,
    ["CloudCannon Configuration"] = 61,
    ["CloudEvents specification"] = 121,
    ["Code Climate"] = 162,
    CodeCV = 59,
    CodeRabbit = 58,
    ["CodeShip Pro services configuration files"] = 174,
    ["CodeShip Pro steps configuration files"] = 175,
    ["Codecov configuration files"] = 173,
    CodifyCLI = 60,
    Codux = 171,
    ["Cog config file"] = 125,
    ["Commandbox Box.json"] = 126,
    ["Commandbox Server.json"] = 127,
    ["Common Catalog Data"] = 183,
    Concord = 942,
    ["Configu .cfgu files"] = 931,
    ["Configu .configu file"] = 932,
    Conjure = 123,
    ["Container Structure Test"] = 776,
    Containerlab = 801,
    ["Crowdsec collection config"] = 213,
    ["Crowdsec parser config"] = 214,
    ["Crowdsec scenario config"] = 215,
    ["CumulusCI Config"] = 128,
    ["Custom Machinery Machine"] = 915,
    ["Custom Machinery Recipe"] = 916,
    ["Cycle Stack File"] = 131,
    ["DWP Exchange - catalogue entry"] = 262,
    ["DWP Exchange - gateway"] = 260,
    ["DWP Exchange - meta"] = 261,
    ["Dart Build Config (dart-build.json)"] = 221,
    ["Dart Test Config (dart-test.json)"] = 222,
    ["DashLord Configuration"] = 223,
    ["Data Contract Specification"] = 224,
    ["Data Product Specification"] = 225,
    ["DataYoga Connections"] = 132,
    ["DataYoga Job"] = 133,
    ["Databricks Asset Bundles"] = 895,
    ["Datadog Service Definition"] = 408,
    ["Datadog Software Catalog"] = 409,
    ["Datahub Ingestion Recipe"] = 850,
    ["Dein Config"] = 139,
    ["Deno Config (deno.json)"] = 231,
    ["Dependency cruiser"] = 140,
    ["Deployer Recipe"] = 234,
    ["Deta Spacefile"] = 141,
    ["Detekt Config (detekt.yml)"] = 235,
    ["Devbox Config"] = 142,
    ["Devbox Plugin"] = 143,
    Devfile = 259,
    DipDup = 945,
    ["Discord Webhook"] = 236,
    ["DocFx Config (docfx.json)"] = 240,
    Dofigen = 241,
    ["Dolittle Artifacts"] = 242,
    ["Dolittle Bounded Context Configuration"] = 243,
    ["Dolittle Event Horizons Configuration"] = 244,
    ["Dolittle Resources Configuration"] = 245,
    ["Dolittle Server Configuration"] = 246,
    ["Dolittle Tenant Map Configuration"] = 248,
    ["Dolittle Tenants Configuration"] = 247,
    ["Dolittle Topology"] = 249,
    ["Drupal Breakpoints"] = 144,
    ["Drupal Config"] = 156,
    ["Drupal Info"] = 145,
    ["Drupal Layouts"] = 146,
    ["Drupal Libraries"] = 147,
    ["Drupal Links Action"] = 148,
    ["Drupal Links Contextual"] = 149,
    ["Drupal Links Menu"] = 150,
    ["Drupal Links Task"] = 151,
    ["Drupal Migration"] = 152,
    ["Drupal Permissions"] = 153,
    ["Drupal Recipe"] = 154,
    ["Drupal Routing"] = 155,
    ["Drupal Services"] = 157,
    ["Drush site aliases"] = 255,
    ["Dynamic Bash Aliases (.aliases)"] = 886,
    ["EAS config"] = 280,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 875,
    ["EasyVCR .NET"] = 281,
    ["Eidolon Resource"] = 958,
    ["Elgato Stream Deck"] = 265,
    Elm = 947,
    ["Embrace Config"] = 861,
    Endurica = 899,
    ["Enterprise Contract Policy Spec"] = 266,
    ["Erda Pipeline"] = 922,
    ["Erda Runtime"] = 923,
    ["Error pages"] = 270,
    Esquio = 268,
    ["Estuary Flow Catalog"] = 840,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 273,
    ["EveryVoice TTS Toolkit Data Configuration"] = 274,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 278,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 277,
    ["EveryVoice TTS Toolkit Text Configuration"] = 275,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 276,
    ["Expo SDK"] = 279,
    ["F-Droid Data metadata"] = 285,
    ["FasterCI Configuration"] = 66,
    FiQuS = 289,
    Firebase = 287,
    ["Flow.json Configurations"] = 919,
    ["Fossa configuration file"] = 296,
    ["Fossa's fossa-deps file"] = 297,
    ["Foundry VTT - Base package Manifest"] = 291,
    ["Foundry VTT - Module Manifest"] = 292,
    ["Foundry VTT - System Data Template"] = 295,
    ["Foundry VTT - System Manifest"] = 293,
    ["Foundry VTT - World Manifest"] = 294,
    ["Foxx Manifest"] = 67,
    ["Freifunk.de Community API"] = 70,
    ["Frogbot Config"] = 71,
    ["G2P Mapping Configuration"] = 301,
    ["GCP Blueprint Metadata"] = 304,
    Gaspar = 302,
    ["GatewayCore API Gateway"] = 303,
    ["GeoJSON.json latest"] = 838,
    GherKing = 842,
    ["GitHub Action"] = 309,
    ["GitHub Discussion"] = 310,
    ["GitHub Funding"] = 311,
    ["GitHub Issue Template configuration"] = 312,
    ["GitHub Issue Template forms"] = 313,
    ["GitHub Workflow"] = 314,
    ["GitHub Workflow Template Properties"] = 315,
    ["GitHub automatically generated release notes configuration"] = 316,
    ["GitLab Agent for Kubernetes configuration"] = 911,
    GitVersion = 306,
    ["Gitea Issue Template configuration"] = 307,
    ["Gitea Issue Template forms"] = 308,
    ["Gitpod Configuration"] = 318,
    ["GlazeWM settings"] = 913,
    ["Global Privacy Control"] = 305,
    Goblet = 894,
    ["Golangci-lint Configuration"] = 333,
    ["Golangci-lint Custom Plugins Configuration"] = 334,
    ["Google Chrome Related Website Sets"] = 288,
    ["Google Cloud Workflows"] = 191,
    Goreleaser = 336,
    ["Goreleaser Pro"] = 337,
    Goss = 338,
    ["Gradle Build Cache Node"] = 791,
    ["Gradle Enterprise"] = 790,
    ["Grafana 5.x Dashboard"] = 339,
    ["GraphQL Code Generator"] = 343,
    ["GraphQL Config"] = 342,
    ["GraphQL Mesh"] = 341,
    ["Grunt JSHint task"] = 347,
    ["Grunt Watch task"] = 348,
    ["Grunt base task"] = 349,
    ["Grunt clean task"] = 345,
    ["Grunt copy task"] = 344,
    ["Grunt cssmin task"] = 346,
    HEMTT = 759,
    Hadolint = 772,
    Hammerkit = 800,
    ["Hardware Sentry Configuration"] = 854,
    Hatch = 773,
    Hayson = 351,
    ["Haystack Pipeline"] = 352,
    ["Hazelcast 5 Configuration"] = 353,
    ["Helm Chart.lock"] = 159,
    ["Helm Chart.yaml"] = 158,
    ["Helm Unittest Test Suite"] = 160,
    Hugo = 830,
    ["Hugo Theme"] = 829,
    ["Hyperfoil benchmark configuration"] = 359,
    ["IBM Zapp document"] = 360,
    ["IBM zCodeFormatSettings"] = 361,
    ["IMG Catapult PSP"] = 366,
    ["IVMS101 by CODE Protocol"] = 912,
    Infrahub = 368,
    Istanbul = 857,
    ["JDownloader2 crawler multi-rules"] = 378,
    ["JDownloader2 crawler single-rules"] = 377,
    ["JFrog Applications Config"] = 379,
    ["JFrog File Spec"] = 380,
    ["JFrog Pipelines YML DSL"] = 863,
    ["JMeter DSL cli config"] = 381,
    JReleaser = 383,
    ["JSON Document Transform"] = 391,
    ["JSON Feed"] = 392,
    ["JSON Resume"] = 592,
    ["JSON Schema Draft 2020-12"] = 742,
    ["JSON Schema Draft 4"] = 739,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 896,
    ["JSON Schema Draft 7"] = 740,
    ["JSON Schema Draft 7 (unofficial strict)"] = 897,
    ["JSON Schema Draft 8 (2019-09)"] = 741,
    ["JSON-API"] = 390,
    ["JSON-WF"] = 925,
    ["JSON-e templates"] = 798,
    ["JSON-stat 2.0"] = 735,
    JSONPatch = 394,
    ["JSR Package Config (jsr.json)"] = 384,
    Jasmine = 372,
    Jekyll = 373,
    ["Jenkins X Pipelines"] = 374,
    ["Jenkins X Requirements"] = 375,
    Jest = 376,
    ["Jovo Language Models"] = 382,
    ["KIMMDY config file"] = 405,
    ["KSP-AVC"] = 736,
    ["KSP-CKAN"] = 737,
    ["KSP-NetKAN"] = 738,
    KSY = 924,
    ["Karakum configuration file"] = 298,
    Kas = 397,
    ["Kestra flow file"] = 406,
    ["Keycloak REST API"] = 866,
    ["Knative Functions - func.yaml"] = 299,
    ["KoDE/CI build.yaml"] = 859,
    ["Kong DBLess config"] = 860,
    KrakenD = 407,
    ["Kubri Configuration"] = 413,
    LOOBin = 428,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 196,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 197,
    ["Landing Zone Accelerator on AWS - Global Config"] = 198,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 199,
    ["Landing Zone Accelerator on AWS - Network Config"] = 200,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 201,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 202,
    ["Landing Zone Accelerator on AWS - Security Config"] = 203,
    ["Language configuration"] = 935,
    Lefthook = 417,
    ["Liferay client-extension.yaml"] = 424,
    ["LinkML Metamodel"] = 426,
    Liquibase = 806,
    ["Liquibase Flow File"] = 807,
    ["Lively Properties"] = 427,
    ["Lobe AI Agent"] = 63,
    Loki = 64,
    ["MLOS Configs"] = 464,
    ["MS2Rescore Configuration"] = 467,
    ["Madness (madness.yml)"] = 877,
    ["MapEHR Mapping"] = 434,
    Markdownlint = 810,
    ["Mason Registry"] = 812,
    ["MegaLinter configuration"] = 436,
    ["MegaLinter descriptor"] = 437,
    Melange = 903,
    ["Meltano project definition"] = 438,
    ["Mergify Configuration"] = 468,
    ["Metadata for a Bazel module"] = 439,
    ["Metadata for a Cinnamon spice"] = 951,
    ["MetricsHub Configuration"] = 440,
    ["MetricsHub Connector Configuration"] = 441,
    ["Micro Editor Syntax"] = 887,
    ["Microsoft Band Web Tile"] = 442,
    ["Microsoft RulesEngine workflow rules"] = 939,
    ["Microsoft RulesEngine workflow rules list"] = 940,
    ["Minecraft Custom Main Menu Mod"] = 904,
    ["Minecraft Data Pack Advancement"] = 444,
    ["Minecraft Data Pack Biome"] = 445,
    ["Minecraft Data Pack Configured Carver"] = 446,
    ["Minecraft Data Pack Damage Type"] = 447,
    ["Minecraft Data Pack Dimension"] = 449,
    ["Minecraft Data Pack Dimension Type"] = 448,
    ["Minecraft Data Pack Item Modifier"] = 450,
    ["Minecraft Data Pack Loot Table"] = 451,
    ["Minecraft Data Pack Metadata"] = 452,
    ["Minecraft Data Pack Predicate"] = 453,
    ["Minecraft Data Pack Recipe"] = 454,
    ["Minecraft Data Pack Tag"] = 455,
    ["Minecraft Data Pack Template Pool"] = 456,
    ["Minecraft Data Pack Trim Material"] = 461,
    ["Minecraft Data Pack Trim Pattern"] = 462,
    ["Minecraft Resource Pack Lang"] = 457,
    ["Minecraft Resource Pack Particle"] = 458,
    ["Minecraft Resource Pack Texture Mcmeta"] = 460,
    ["Minecraft Resourcepack Sounds"] = 459,
    ["Monade CLI Stack Configuration"] = 471,
    ["MongoDB Atlas Search Index Definition"] = 858,
    ["Monika Configuration"] = 856,
    ["Monoweave Configuration"] = 466,
    ["Motif config"] = 755,
    ["NOX Framework (Service)"] = 483,
    ["Netin Diagnostic System Template"] = 816,
    ["Netlify config"] = 474,
    ["Network-as-Code Data Model"] = 475,
    ["Nightwatch.js"] = 476,
    ["NueJS configuration file"] = 488,
    ["Nuitka.yaml"] = 917,
    ["Nullstone config"] = 490,
    ["ONe's changelog entry"] = 504,
    ["ONe's service descriptor"] = 503,
    ["OSCAL Assessment Plan (AP)"] = 512,
    ["OSCAL Assessment Results (AR)"] = 513,
    ["OSCAL Catalog"] = 514,
    ["OSCAL Component Definition (CDef)"] = 515,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 516,
    ["OSCAL Profile"] = 517,
    ["OSCAL System Security Plan (SSP)"] = 518,
    ["OSS Review Toolkit configuration"] = 519,
    ["OSS Review Toolkit curation"] = 520,
    ["OSS Review Toolkit package configuration"] = 521,
    ["OSS Review Toolkit repository configuration"] = 522,
    ["OSS Review Toolkit resolutions"] = 523,
    ["October CMS columns"] = 494,
    ["October CMS fields"] = 495,
    Okteto = 496,
    Opctl = 758,
    ["Open Data Contract Standard (ODCS)"] = 507,
    ["OpenRewrite Resource"] = 506,
    ["OpenUtau character yaml"] = 500,
    ["OpenUtau ustx"] = 501,
    ["OpenWeather Current Weather API"] = 797,
    ["OpenWeather Road Risk API"] = 796,
    ["Ory Hydra configuration"] = 358,
    ["Ory Keto configuration"] = 410,
    ["Ory Kratos configuration"] = 511,
    ["Ory Oathkeeper configuration"] = 492,
    ["Outblocks App configuration"] = 509,
    ["Outblocks database table"] = 510,
    ["Outblocks project configuration"] = 508,
    PDM = 529,
    Packer = 526,
    Pantsbuild = 873,
    ["Paper paper-plugin.yml"] = 527,
    ["Pipeline component"] = 808,
    ["Plex Prerolls"] = 537,
    ["PocketMine plugin.yml"] = 534,
    ["Postman collection"] = 541,
    ["Preset list for a WinUtil"] = 954,
    ["Problem object RFC9457"] = 901,
    ["Problem package generators"] = 550,
    Pterodactyl = 853,
    ["Pull Request Labeler"] = 565,
    Pulumi = 571,
    PyProject = 572,
    Pyright = 573,
    Qgoda = 574,
    Qodana = 826,
    ["Qt Creator workspace file"] = 933,
    ["Quali Torque Blueprint Spec 2"] = 851,
    ["QueryFirst config file"] = 869,
    ["RKE Cluster Configuration JSON"] = 805,
    ["RKE Cluster Configuration YAML"] = 804,
    ["Rancher Fleet"] = 568,
    ["Rattler-build"] = 575,
    Ray = 771,
    ["Read the Docs"] = 570,
    ["Red-DiscordBot Cog"] = 582,
    ["Red-DiscordBot Cog Repo"] = 583,
    ["Red-DiscordBot Trivia"] = 584,
    ["Render Blueprints"] = 803,
    RenderCV = 594,
    Renovate = 593,
    ["Replit config"] = 588,
    RoadRunner = 595,
    ["Rudder techniques"] = 907,
    Ruff = 590,
    ["Rust Project"] = 591,
    ["Rust toolchain"] = 599,
    ["SDMX data message"] = 624,
    ["SDMX metadata message"] = 623,
    ["SDMX structure message"] = 622,
    ["SIL Kit Participant Configuration"] = 634,
    ["SIL Kit Registry Configuration"] = 635,
    SWADL = 663,
    ["Safebox Config"] = 864,
    ["Sapphire CLI Config"] = 602,
    ["SauceCTL Configuration"] = 813,
    ["Schema Catalog"] = 616,
    ["Scoop manifest"] = 621,
    ["Semantic Data Fabric (SDF) file"] = 625,
    ["Semgrep Rule"] = 627,
    ["Serenity Code Generator (Sergen)"] = 628,
    ["Serverless Framework Configuration"] = 820,
    ["Serverless Workflow"] = 822,
    ["Settings for a Cinnamon spice"] = 950,
    ["Settings.paf"] = 630,
    ["Shopware 6 Configuration"] = 823,
    ["Shopware CLI Extension Store Configuration"] = 824,
    ["Shopware CLI Project Store Configuration"] = 825,
    ["Sigma Detection Rule"] = 632,
    ["Sigrid scope configuration file"] = 633,
    ["SkyPilot Task JSON"] = 908,
    ["Slack app manifest"] = 637,
    Solidarity = 640,
    ["Solution filters"] = 641,
    ["Source Maps v3"] = 642,
    Sourcery = 643,
    ["Speakeasy Lint Configuration File"] = 644,
    ["Speakeasy Test Generation Configuration File"] = 645,
    ["Speakeasy Workflow File"] = 646,
    SpecIF = 647,
    ["Sponge Mixin configuration"] = 648,
    StackBlitz = 653,
    ["StackHawk Scanner Configuration"] = 819,
    Stale = 654,
    ["Starlake Data Pipeline"] = 794,
    Starship = 655,
    ["Statamic Blueprint"] = 656,
    ["Stella configuration file"] = 657,
    ["Stryker Mutator"] = 660,
    ["StyleCop Analyzers Configuration"] = 661,
    ["Stylelint (.stylelintrc)"] = 662,
    ["Sublime Syntax"] = 865,
    ["Subsquid squid manifest"] = 910,
    ["Swagger API 2.0"] = 664,
    TSON = 693,
    TSTyche = 694,
    ["Tab data for a LinUtil"] = 956,
    ["Tab list for a LinUtil"] = 955,
    Talhelper = 666,
    ["Talisman configuration"] = 667,
    ["Taskfile config"] = 799,
    Taurus = 668,
    Tauticord = 669,
    ["TestEnvironment.json"] = 678,
    ["TextMate Grammar"] = 677,
    ["Tier.run pricing.json"] = 672,
    Tikibase = 673,
    ["Traefik v2"] = 681,
    ["Traefik v2 File Provider"] = 682,
    ["Travis CI (.travis.yml)"] = 680,
    ["TrueScript for *.tscript files"] = 685,
    TunnelHub = 900,
    Turborepo = 679,
    Tycho = 946,
    Tye = 827,
    ["UET BuildConfig.json"] = 870,
    ["UI5 Manifest"] = 703,
    ["UNCORS configuration"] = 707,
    ["UTAM Page Object"] = 706,
    ["Ubuntu Server Autoinstall"] = 701,
    ["Uniswap Token List"] = 782,
    ["Unreal Engine Uplugin"] = 871,
    ["Unreal Engine Uproject"] = 872,
    ["Updatecli Compose"] = 835,
    ["Updatecli Policy Manifest"] = 836,
    ["Updatecli Policy Metadata"] = 837,
    Uplift = 868,
    ["User Journey Map"] = 802,
    V2Ray = 841,
    ["VSCode Code Snippets"] = 179,
    ["VSIX CLI publishing"] = 724,
    ["Vela Pipeline Configuration"] = 711,
    Vercel = 178,
    ["Version Bumper config"] = 714,
    Visivo = 898,
    ["Waku Config"] = 959,
    ["Web App Manifest"] = 730,
    ["Web types"] = 733,
    WebExtensions = 729,
    ["Webman package recipe"] = 847,
    ["Windows Package Manager Installer Manifest"] = 779,
    ["Windows Package Manager Locale Manifest"] = 780,
    ["Windows Package Manager Singleton Manifest"] = 778,
    ["WireMock stub mapping"] = 962,
    ["Woodpecker pipeline config"] = 815,
    ["Wrangler CLI"] = 734,
    ["Xstate Machine"] = 833,
    ["Yandex Workflow Language"] = 952,
    ["Yarn Config (.yarnrc.yml)"] = 792,
    ["Yippee-Ki-JSON configuration YML"] = 784,
    ["YouTrack App"] = 949,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 902,
    ...
    ["behat.yml"] = 91,
    ["bigquery-table"] = 81,
    ["bioimageio resource description"] = 918,
    ...
    ["bozr.suite.json"] = 93,
    bpkg = 881,
    ["browser.i18n.json"] = 94,
    ["browsh configuration"] = 95,
    bucklescript = 96,
    ["buf.gen.yaml"] = 55,
    ["buf.plugin.yaml"] = 56,
    ["buf.work.yaml"] = 57,
    ["buf.yaml"] = 54,
    ["bundleconfig.json"] = 101,
    ["bunfig.toml"] = 102,
    ["ccmod.json"] = 960,
    changelogging = 930,
    ["chisel-slices.json"] = 205,
    ["chrome-extension-locales-messages.json"] = 186,
    ["chutzpah.json"] = 187,
    cibuildwheel = 119,
    ["clang-format (.clang-format)"] = 839,
    ["clang-tidy"] = 166,
    clangd = 165,
    clib = 167,
    ["cloud-init: cloud-config userdata"] = 169,
    ["cloud-sdk-pipeline-configuration"] = 189,
    ["cloudbuild.json"] = 190,
    cloudify = 168,
    codemagic = 170,
    ["coffeelint.json"] = 207,
    ["commands.json"] = 182,
    ["commitlint (.commitlintrc)"] = 781,
    ["compile_commands.json"] = 181,
    ["compilerconfig.json"] = 180,
    ["completely.yml"] = 876,
    ["component-detection-manifest.json"] = 210,
    ["component.json"] = 209,
    ["composer.json"] = 208,
    ["conda-forge"] = 122,
    ["config.yaml"] = 569,
    ["contentmanifest.json"] = 188,
    ["contribute.json"] = 211,
    ["cosmos.config.json"] = 184,
    ["crowdin.yml"] = 212,
    ["ctfd-setup configuration file"] = 968,
    ["custom-elements.json"] = 890,
    ["cypress.json"] = 216,
    ["datalogic-scan2deploy-android"] = 226,
    ["datalogic-scan2deploy-ce"] = 227,
    ["dbt Dependencies"] = 134,
    ["dbt Packages"] = 136,
    ["dbt Project"] = 135,
    ["dbt Selectors"] = 137,
    ["dbt YAML files"] = 138,
    ["ddev-global"] = 228,
    ["ddev-project"] = 229,
    ["debugsettings.json"] = 230,
    ["dependabot-v2.json"] = 233,
    ["dependabot.json"] = 232,
    ["deployed-cli"] = 832,
    ["devcontainer.json"] = 172,
    devinit = 786,
    ["devspace.yaml"] = 855,
    djlint = 787,
    ["docker bake"] = 238,
    ["docker sequencer"] = 239,
    ["docker-compose.yml"] = 785,
    ["dockerd.json"] = 237,
    ["dotnet Release Index manifest"] = 250,
    ["dotnet-tools.json"] = 251,
    ["dotnetcli.host.json"] = 252,
    ["dprint.json"] = 253,
    ["drone.json"] = 254,
    ["dss-2.0.0.json"] = 256,
    ["dstack configuration"] = 257,
    ["dtool dataset metadata"] = 964,
    ["dvc.yaml"] = 258,
    ["ecosystem.json"] = 263,
    eksctl = 264,
    ["electron-builder configuration file"] = 271,
    ["epr-manifest.json"] = 269,
    ["evcc.yaml"] = 272,
    ["ezd task runner"] = 282,
    ["fabric.mod.json"] = 284,
    ["first-timers-bot"] = 290,
    ...
    ["gitlab-ci"] = 317,
    ["global.json"] = 332,
    ["go-feature-flag Flag Configuration"] = 335,
    ["haxelib.json"] = 350,
    helmfile = 774,
    helmwave = 775,
    ["host-meta.json"] = 355,
    ...
    ["ide.host.json"] = 362,
    ["ifstate.conf"] = 363,
    ["imageoptimizer.json"] = 364,
    ["importmap.json"] = 367,
    ["ioBroker Configuration"] = 369,
    ["ioBroker JSON UI"] = 370,
    ["ioBroker Package manifest"] = 371,
    ["ize.toml"] = 867,
    ["jsconfig.json"] = 395,
    ["jscpd Configuration"] = 852,
    jsdoc = 770,
    ["k3d.yaml"] = 396,
    ["k9s aliases.yaml"] = 398,
    ["k9s cluster-config.yaml"] = 400,
    ["k9s config.yaml"] = 399,
    ["k9s hotkeys.yaml"] = 401,
    ["k9s plugins.yaml"] = 402,
    ["k9s skin.yaml"] = 403,
    ["k9s views.yaml"] = 404,
    ["kontinuous-config.yaml"] = 412,
    ["kontinuous-values.yaml"] = 411,
    ["kustomization.yaml"] = 414,
    ["label-commenter-config.yml"] = 415,
    ["latexindent configuration"] = 62,
    ["launchsettings.json"] = 416,
    lazydocker = 889,
    lazygit = 888,
    ["lego.json"] = 418,
    ["lerna.json"] = 419,
    ["lgtm.yml"] = 420,
    ["liblab.config.json"] = 421,
    ["libman.json"] = 422,
    ["license-report-config.json"] = 423,
    ["linkinator.config.json"] = 425,
    ["lint-staged (.lintstagedrc)"] = 750,
    ["local.settings.json"] = 430,
    ["localazy.json"] = 431,
    ["lotus.yaml"] = 429,
    ["lsdlschema.json"] = 432,
    ["markdown-link-check"] = 811,
    mboats = 818,
    ["micro-settings.json"] = 882,
    ["mimetypes.json"] = 443,
    ["mirrord config"] = 751,
    mise = 752,
    ["mkdocs.yml"] = 463,
    ["monospace.yml"] = 465,
    ["moon.yml"] = 961,
    ["mprocs Configuration file"] = 934,
    ["mta.yaml"] = 753,
    ["mtad.yaml"] = 754,
    ["mycode.json"] = 472,
    ["napari plugin manifest"] = 473,
    neoload = 765,
    ["nest-cli"] = 478,
    ["ninjs (News in JSON)"] = 477,
    ["nitro.json"] = 764,
    ["nixd configuration"] = 906,
    ["nlu.json"] = 479,
    ["nodemon.json"] = 481,
    ["noodl config"] = 817,
    ["notebook.mod.json"] = 482,
    now = 760,
    ["npm-badges"] = 485,
    ["nswag.json"] = 489,
    ntangle = 491,
    ["nuclei-template.yaml"] = 486,
    ["nuget-project.json"] = 487,
    ["ocelot.json"] = 493,
    ["omnisharp.json"] = 497,
    ["openapi.json"] = 498,
    ["openfin.json"] = 505,
    ...
    ["ops.yaml"] = 502,
    ["package.json"] = 524,
    ["package.manifest"] = 525,
    ["partial-black.json"] = 92,
    ["pathfinder.yml"] = 528,
    ["pattern.json"] = 531,
    ["petstore-v1.0"] = 862,
    pgap_yaml_input_reader = 530,
    ["pixi.toml"] = 532,
    ["plagiarize-me.yaml"] = 536,
    ["plagiarize.yaml"] = 535,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 965,
    ["podbard.yaml"] = 538,
    ["portman.json"] = 539,
    ["prefect.toml"] = 547,
    ["prettierrc.json"] = 548,
    ["prisma.yml"] = 549,
    ["project-1.0.0-beta3.json"] = 552,
    ["project-1.0.0-beta4.json"] = 553,
    ["project-1.0.0-beta5.json"] = 554,
    ["project-1.0.0-beta6.json"] = 555,
    ["project-1.0.0-beta8.json"] = 556,
    ["project-1.0.0-rc1.json"] = 557,
    ["project-1.0.0-rc2.json"] = 558,
    ["project.json"] = 551,
    ["prometheus.json"] = 559,
    ["prometheus.rules.json"] = 560,
    ["prometheus.rules.test.json"] = 561,
    ["proxies.json"] = 562,
    ["publiccode.yml"] = 563,
    ["pubspec.yaml"] = 564,
    ["pyrseas-0.8.json"] = 567,
    ["quilt.mod.json"] = 883,
    ["rc3 auth"] = 576,
    ["rc3 collection"] = 577,
    ["rc3 environment"] = 578,
    ...
    samt = 600,
    samtrc = 601,
    ["sarif-1.0.0.json"] = 603,
    ["sarif-2.0.0.json"] = 604,
    ["sarif-2.1.0"] = 614,
    ["sarif-2.1.0-rtm.2"] = 605,
    ["sarif-2.1.0-rtm.3"] = 607,
    ["sarif-2.1.0-rtm.4"] = 609,
    ["sarif-2.1.0-rtm.5"] = 611,
    ["sarif-2.1.0-rtm.6"] = 612,
    ["sarif-external-property-file-2.1.0"] = 615,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 606,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 608,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 610,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 613,
    ["schema.org - Action"] = 617,
    ["schema.org - ContactPoint"] = 618,
    ["schema.org - Place"] = 619,
    ["schema.org - Thing"] = 620,
    ["secrethub.yml"] = 885,
    ["semantic-release"] = 626,
    ["servicehub.config.json"] = 745,
    ["servicehub.service.json"] = 744,
    ["settings.job"] = 629,
    ["sfdx-hardis configuration"] = 631,
    ["shard.yml"] = 921,
    ["size-limit configuration"] = 636,
    ["skaffold.yaml"] = 809,
    ["skyuxconfig.json"] = 638,
    snapcraft = 639,
    ["spicepod.yaml"] = 941,
    ["sqlc configuration"] = 650,
    ["stripe-app-local.json"] = 659,
    ["stripe-app.json"] = 658,
    swcrc = 795,
    ["task.json"] = 665,
    taskcat = 761,
    ["template.json"] = 670,
    ["templatsources.json"] = 671,
    ["theme.json"] = 674,
    ["tizen_workspace.json"] = 675,
    tldr = 676,
    tmuxinator = 748,
    ["transcend.yml"] = 683,
    ["tree-sitter grammar.json"] = 340,
    ["trime.yaml"] = 684,
    ["trunk.yaml"] = 686,
    ["ts-force-config.json"] = 691,
    ["tsconfig.json"] = 687,
    ["tsd.json"] = 688,
    ["tsdoc.json"] = 689,
    ["tsdrc.json"] = 690,
    ...
    v8r = 728,
    vcluster = 928,
    ["vcpkg configuration file"] = 177,
    ["vcpkg manifest file"] = 176,
    ["vega-lite.json"] = 710,
    ["vega.json"] = 709,
    ["venvironment-basic.yaml"] = 713,
    ["venvironment.yaml"] = 712,
    ["version.json"] = 715,
    ["vhwdebugger-binding.yaml"] = 717,
    ["vim-addon-info"] = 718,
    ["vs-2017.3.host.json"] = 720,
    ["vs-nesting.json"] = 721,
    ["vsls.json"] = 719,
    ["vss-extension.json"] = 725,
    ["vtesttree.yaml"] = 726,
    ["vtestunit.yaml"] = 727,
    ["warp-keysets.json"] = 891,
    ["warp-themes.json"] = 892,
    ["warp-workflows.json"] = 893,
    ["webhint.io"] = 848,
    ["webjobpublishsettings.json"] = 732,
    ["webjobs-list.json"] = 731,
    ["well-known-fursona"] = 929,
    ["xs-app.json"] = 757,
    ["xunit.runner.json"] = 743,
    yamllint = 783,
    ["zerops.io import file"] = 938,
    ["zerops.yml"] = 937,
    zuul = 767,
    ["Žinoma"] = 777
  },
