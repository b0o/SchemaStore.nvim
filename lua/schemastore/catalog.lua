...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 729,
    [".nodehawkrc"] = 469,
    [".npmpackagejsonlintrc"] = 473,
    [".omletrc"] = 904,
    [".phrase.yml"] = 520,
    [".phraseapp.yml"] = 521,
    [".pmbot.yml"] = 510,
    [".postcssrc"] = 515,
    [".powerpages-web-template-manifest"] = 517,
    [".pre-commit-config.yml"] = 518,
    [".pre-commit-hooks.yml"] = 519,
    [".putout.json"] = 540,
    [".rehyperc"] = 559,
    [".remarkrc"] = 561,
    [".sprite files"] = 623,
    ...
    ["<div>RIOTS' studio configuration"] = 701,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 423,
    ABCInventoryModuleData = 13,
    ABCSupplyPlan = 14,
    AIConfig = 15,
    ["API Builder"] = 761,
    ["AVA Configuration"] = 821,
    ...
    ["Adobe UXP Manifest"] = 886,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Airplane task"] = 17,
    ["Alacritty Configuration"] = 793,
    ["All Contributors configuration file"] = 851,
    ...
    ["Azure Pipelines"] = 64,
    ["Azure Static Web Apps CLI configuration file"] = 626,
    ["Azure Static Web Apps configuration file"] = 625,
    ["BX CI"] = 104,
    ["Bashly (bashly.yml)"] = 855,
    ["Bashly Settings (bashly-settings.yml)"] = 856,
    ["Better Code Hub"] = 765,
    ["Better Scripts"] = 105,
    Bigconfig = 81,
    BizTalkServerApplicationSchema = 735,
    Bleep = 106,
    ...
    ["Butane Config"] = 806,
    ["CGS Custom Card Game (CardGameDef.json)"] = 891,
    ["CICS TS region tagging"] = 815,
    ["CICS TS resource import"] = 816,
    ["CICS TS resource model"] = 817,
    ["CICS TS resource overrides"] = 818,
    ["CMake Presets"] = 107,
    ["CNC Codes"] = 121,
    ["CRS WAF test file"] = 920,
    ["CRS WAF test platform overrides file"] = 921,
    ...
    CityJSON = 117,
    ["Clawject config"] = 126,
    ["Cloud Foundry Application Manifest"] = 903,
    ["Cloud Run Spec v1"] = 925,
    ...
    Concord = 919,
    ["Configu .cfgu files"] = 908,
    ["Configu .configu file"] = 909,
    Conjure = 120,
    ["Container Structure Test"] = 748,
    Containerlab = 773,
    ["Crowdsec collection config"] = 210,
    ["Crowdsec parser config"] = 211,
    ["Crowdsec scenario config"] = 212,
    ["CumulusCI Config"] = 125,
    ["Custom Machinery Machine"] = 892,
    ["Custom Machinery Recipe"] = 893,
    ...
    ["DataYoga Job"] = 130,
    ["Databricks Asset Bundles"] = 872,
    ["Datadog Service Definition"] = 397,
    ["Datadog Software Catalog"] = 398,
    ["Datahub Ingestion Recipe"] = 822,
    ["Dein Config"] = 136,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 863,
    ["EAS config"] = 276,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 852,
    ...
    ["Goreleaser Pro"] = 333,
    Goss = 334,
    ["Gradle Build Cache Node"] = 763,
    ["Gradle Enterprise"] = 762,
    ...
    Hadolint = 744,
    Hammerkit = 772,
    ["Hardware Sentry Configuration"] = 826,
    Hatch = 745,
    Hayson = 347,
    ...
    ["JFrog File Spec"] = 375,
    ["JFrog Pipelines YML DSL"] = 835,
    ["JMeter DSL cli config"] = 376,
    JReleaser = 378,
    ["JSON Document Transform"] = 386,
    ["JSON Feed"] = 387,
    ["JSON Resume"] = 566,
    ["JSON Schema Draft 2020-12"] = 714,
    ["JSON Schema Draft 4"] = 711,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 873,
    ["JSON Schema Draft 7"] = 712,
    ["JSON Schema Draft 7 (unofficial strict)"] = 874,
    ["JSON Schema Draft 8 (2019-09)"] = 713,
    ["JSON-API"] = 385,
    ["JSON-WF"] = 902,
    ["JSON-e templates"] = 770,
    ["JSON-stat 2.0"] = 708,
    JSONPatch = 389,
    ...
    ["KIMMDY config file"] = 394,
    ["KSP-AVC"] = 709,
    ["KSP-CKAN"] = 710,
    KSY = 901,
    ["Karakum configuration file"] = 294,
    Kas = 392,
    ["Kestra flow file"] = 395,
    ["Keycloak REST API"] = 843,
    ["Knative Functions - func.yaml"] = 295,
    ["KoDE/CI build.yaml"] = 831,
    ["Kong DBLess config"] = 832,
    KrakenD = 396,
    ["Kubri Configuration"] = 402,
    LOOBin = 417,
    ...
    ["Language configuration"] = 912,
    Lefthook = 406,
    ["Liferay client-extension.yaml"] = 413,
    ["LinkML Metamodel"] = 415,
    Liquibase = 778,
    ["Liquibase Flow File"] = 779,
    ["Lively Properties"] = 416,
    ["Lobe AI Agent"] = 62,
    Loki = 63,
    ["MLOS Configs"] = 453,
    ["MS2Rescore Configuration"] = 456,
    ["Madness (madness.yml)"] = 854,
    ["MapEHR Mapping"] = 422,
    Markdownlint = 782,
    ["Mason Registry"] = 784,
    ["MegaLinter configuration"] = 424,
    ["MegaLinter descriptor"] = 425,
    Melange = 880,
    ["Meltano plugin discovery definition"] = 427,
    ["Meltano project definition"] = 426,
    ["Mergify Configuration"] = 457,
    ["Metadata for a Bazel module"] = 428,
    ["Metadata for a Cinnamon spice"] = 928,
    ["MetricsHub Configuration"] = 429,
    ["MetricsHub Connector Configuration"] = 430,
    ["Micro Editor Syntax"] = 864,
    ["Microsoft Band Web Tile"] = 431,
    ["Microsoft RulesEngine workflow rules"] = 916,
    ["Microsoft RulesEngine workflow rules list"] = 917,
    ["Minecraft Custom Main Menu Mod"] = 881,
    ["Minecraft Data Pack Advancement"] = 433,
    ["Minecraft Data Pack Biome"] = 434,
    ["Minecraft Data Pack Configured Carver"] = 435,
    ["Minecraft Data Pack Damage Type"] = 436,
    ["Minecraft Data Pack Dimension"] = 438,
    ["Minecraft Data Pack Dimension Type"] = 437,
    ["Minecraft Data Pack Item Modifier"] = 439,
    ["Minecraft Data Pack Loot Table"] = 440,
    ["Minecraft Data Pack Metadata"] = 441,
    ["Minecraft Data Pack Predicate"] = 442,
    ["Minecraft Data Pack Recipe"] = 443,
    ["Minecraft Data Pack Tag"] = 444,
    ["Minecraft Data Pack Template Pool"] = 445,
    ["Minecraft Data Pack Trim Material"] = 450,
    ["Minecraft Data Pack Trim Pattern"] = 451,
    ["Minecraft Resource Pack Lang"] = 446,
    ["Minecraft Resource Pack Particle"] = 447,
    ["Minecraft Resource Pack Texture Mcmeta"] = 449,
    ["Minecraft Resourcepack Sounds"] = 448,
    ["Monade CLI Stack Configuration"] = 460,
    ["MongoDB Atlas Search Index Definition"] = 830,
    ["Monika Configuration"] = 828,
    ["Monoweave Configuration"] = 455,
    ["Motif config"] = 728,
    ["NOX Framework (Service)"] = 472,
    ["Netin Diagnostic System Template"] = 788,
    ["Netlify config"] = 463,
    ["Network-as-Code Data Model"] = 464,
    ["Nightwatch.js"] = 465,
    ["Nuitka.yaml"] = 894,
    ["ONe's changelog entry"] = 488,
    ["ONe's service descriptor"] = 487,
    ["OSS Review Toolkit configuration"] = 496,
    ["OSS Review Toolkit curation"] = 497,
    ["OSS Review Toolkit package configuration"] = 498,
    ["OSS Review Toolkit repository configuration"] = 499,
    ["OSS Review Toolkit resolutions"] = 500,
    Opctl = 731,
    ["Open Data Contract Standard (ODCS))"] = 491,
    ["OpenRewrite Resource"] = 490,
    ["OpenUtau character yaml"] = 484,
    ["OpenUtau ustx"] = 485,
    ["OpenWeather Current Weather API"] = 769,
    ["OpenWeather Road Risk API"] = 768,
    ["Ory Hydra configuration"] = 354,
    ["Ory Keto configuration"] = 399,
    ["Ory Kratos configuration"] = 495,
    ["Ory Oathkeeper configuration"] = 479,
    ["Outblocks App configuration"] = 493,
    ["Outblocks database table"] = 494,
    ["Outblocks project configuration"] = 492,
    PDM = 506,
    Packer = 503,
    Pantsbuild = 850,
    ["Paper paper-plugin.yml"] = 504,
    ...
    Pterodactyl = 825,
    ["Pull Request Labeler"] = 539,
    Pulumi = 545,
    PyProject = 546,
    Pyright = 547,
    Qgoda = 548,
    Qodana = 798,
    ["Qt Creator workspace file"] = 910,
    ["Quali Torque Blueprint Spec 2"] = 823,
    ["QueryFirst config file"] = 846,
    ["RKE Cluster Configuration JSON"] = 777,
    ["RKE Cluster Configuration YAML"] = 776,
    ["Rancher Fleet"] = 542,
    ["Rattler-build"] = 549,
    Ray = 743,
    ["Read the Docs"] = 544,
    ["Red-DiscordBot Cog"] = 556,
    ["Red-DiscordBot Cog Repo"] = 557,
    ["Red-DiscordBot Trivia"] = 558,
    ["Render Blueprints"] = 775,
    RenderCV = 568,
    Renovate = 567,
    ["Replit config"] = 562,
    RoadRunner = 569,
    ["Rudder techniques"] = 884,
    Ruff = 564,
    ["Rust Project"] = 565,
    ["Rust toolchain"] = 573,
    ["SDMX data message"] = 598,
    ["SDMX metadata message"] = 597,
    ["SDMX structure message"] = 596,
    ["SIL Kit Participant Configuration"] = 608,
    ["SIL Kit Registry Configuration"] = 609,
    SWADL = 637,
    ["Safebox Config"] = 836,
    ["Sapphire CLI Config"] = 576,
    ["SauceCTL Configuration"] = 785,
    ["Schema Catalog"] = 590,
    ["Scoop manifest"] = 595,
    ["Semantic Data Fabric (SDF) file"] = 599,
    ["Semgrep Rule"] = 601,
    ["Serenity Code Generator (Sergen)"] = 602,
    ["Serverless Framework Configuration"] = 792,
    ["Serverless Workflow"] = 794,
    ["Settings for a Cinnamon spice"] = 927,
    ["Settings.paf"] = 604,
    ["Shopware 6 Configuration"] = 795,
    ["Shopware CLI Extension Store Configuration"] = 796,
    ["Shopware CLI Project Store Configuration"] = 797,
    Sigma = 606,
    ["Sigrid scope configuration file"] = 607,
    ["SkyPilot Task JSON"] = 885,
    ["Slack app manifest"] = 611,
    Solidarity = 614,
    ["Solution filters"] = 615,
    ["Source Maps v3"] = 616,
    Sourcery = 617,
    ["Speakeasy Lint Configuration File"] = 618,
    ["Speakeasy Test Generation Configuration File"] = 619,
    ["Speakeasy Workflow File"] = 620,
    SpecIF = 621,
    ["Sponge Mixin configuration"] = 622,
    StackBlitz = 627,
    ["StackHawk Scanner Configuration"] = 791,
    Stale = 628,
    ["Starlake Data Pipeline"] = 766,
    Starship = 629,
    ["Statamic Blueprint"] = 630,
    ["Stella configuration file"] = 631,
    ["StrmPrivacy Data Connector"] = 840,
    ["StrmPrivacy Data Contract"] = 841,
    ["StrmPrivacy SimpleSchema"] = 838,
    ["StrmPrivacy Stream"] = 839,
    ["StrmPrivacy batch job configuration file"] = 837,
    ["Stryker Mutator"] = 634,
    ["StyleCop Analyzers Configuration"] = 635,
    ["Stylelint (.stylelintrc)"] = 636,
    ["Sublime Syntax"] = 842,
    ["Subsquid squid manifest"] = 887,
    ["Swagger API 2.0"] = 638,
    TSON = 666,
    TSTyche = 667,
    ...
    ["Taskfile config"] = 771,
    Taurus = 642,
    ["TestEnvironment.json"] = 651,
    ["TextMate Grammar"] = 650,
    ["Tier.run pricing.json"] = 645,
    Tikibase = 646,
    ["Traefik v2"] = 654,
    ["Traefik v2 File Provider"] = 655,
    ["Travis CI (.travis.yml)"] = 653,
    ["TrueScript for *.tscript files"] = 658,
    TunnelHub = 877,
    Turborepo = 652,
    Tycho = 923,
    Tye = 799,
    ["UET BuildConfig.json"] = 847,
    ["UI5 Manifest"] = 676,
    ["UNCORS configuration"] = 680,
    ["UTAM Page Object"] = 679,
    ["Ubuntu Server Autoinstall"] = 674,
    ["Uniswap Token List"] = 754,
    ["Unreal Engine Uplugin"] = 848,
    ["Unreal Engine Uproject"] = 849,
    ["Updatecli Compose"] = 807,
    ["Updatecli Policy Manifest"] = 808,
    ["Updatecli Policy Metadata"] = 809,
    Uplift = 845,
    ["User Journey Map"] = 774,
    V2Ray = 813,
    ["VSCode Code Snippets"] = 176,
    ["VSIX CLI publishing"] = 696,
    ["Vela Pipeline Configuration"] = 684,
    Vercel = 175,
    Visivo = 875,
    ["Web App Manifest"] = 703,
    ["Web types"] = 706,
    WebExtensions = 702,
    ["Webman package recipe"] = 819,
    ["Windows Package Manager Installer Manifest"] = 751,
    ["Windows Package Manager Locale Manifest"] = 752,
    ["Windows Package Manager Singleton Manifest"] = 750,
    ["Woodpecker pipeline config"] = 787,
    ["Wrangler CLI"] = 707,
    ["Xstate Machine"] = 805,
    ["Yandex Workflow Language"] = 929,
    ["Yarn Config (.yarnrc.yml)"] = 764,
    ["Yippee-Ki-JSON configuration YML"] = 756,
    ["YouTrack App"] = 926,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 18,
    apko = 879,
    ...
    ["behat.yml"] = 89,
    ["bigquery-table"] = 80,
    ["bioimageio resource description"] = 895,
    ...
    ["ize.toml"] = 844,
    ["jsconfig.json"] = 390,
    ["jscpd Configuration"] = 824,
    jsdoc = 742,
    ["k3d.yaml"] = 391,
    ["k9s plugin.yml"] = 393,
    ["kontinuous-config.yaml"] = 401,
    ["kontinuous-values.yaml"] = 400,
    ["kustomization.yaml"] = 403,
    ["label-commenter-config.yml"] = 404,
    ["latexindent configuration"] = 61,
    ["launchsettings.json"] = 405,
    lazydocker = 866,
    lazygit = 865,
    ["lego.json"] = 407,
    ["lerna.json"] = 408,
    ["lgtm.yml"] = 409,
    ["liblab.config.json"] = 410,
    ["libman.json"] = 411,
    ["license-report-config.json"] = 412,
    ["linkinator.config.json"] = 414,
    ["lint-staged (.lintstagedrc)"] = 722,
    ["local.settings.json"] = 419,
    ["localazy.json"] = 420,
    ["lotus.yaml"] = 418,
    ["lsdlschema.json"] = 421,
    ["markdown-link-check"] = 783,
    mboats = 790,
    ["micro-settings.json"] = 859,
    ["mimetypes.json"] = 432,
    ["mirrord config"] = 723,
    mise = 724,
    ["mise-settings"] = 725,
    ["mkdocs.yml"] = 452,
    ["monospace.yml"] = 454,
    ["mprocs Configuration file"] = 911,
    ["mta.yaml"] = 726,
    ["mtad.yaml"] = 727,
    ["mycode.json"] = 461,
    ["napari plugin manifest"] = 462,
    neoload = 737,
    ["nest-cli"] = 467,
    ["ninjs (News in JSON)"] = 466,
    ["nixd configuration"] = 883,
    ["nlu.json"] = 468,
    ["nodemon.json"] = 470,
    ["noodl config"] = 789,
    ["notebook.mod.json"] = 471,
    now = 733,
    ["npm-badges"] = 474,
    ["nswag.json"] = 477,
    ntangle = 478,
    ["nuclei-template.yaml"] = 475,
    ["nuget-project.json"] = 476,
    ["ocelot.json"] = 480,
    ["omnisharp.json"] = 481,
    ["openapi.json"] = 482,
    ["openfin.json"] = 489,
    ...
    ["ops.yaml"] = 486,
    ["package.json"] = 501,
    ["package.manifest"] = 502,
    ["partial-black.json"] = 90,
    ["pathfinder.yml"] = 505,
    ["pattern.json"] = 508,
    ["petstore-v1.0"] = 834,
    pgap_yaml_input_reader = 507,
    ["pixi.toml"] = 509,
    ["plagiarize-me.yaml"] = 513,
    ["plagiarize.yaml"] = 512,
    ["portman.json"] = 514,
    ["prettierrc.json"] = 522,
    ["prisma.yml"] = 523,
    ["project-1.0.0-beta3.json"] = 526,
    ["project-1.0.0-beta4.json"] = 527,
    ["project-1.0.0-beta5.json"] = 528,
    ["project-1.0.0-beta6.json"] = 529,
    ["project-1.0.0-beta8.json"] = 530,
    ["project-1.0.0-rc1.json"] = 531,
    ["project-1.0.0-rc2.json"] = 532,
    ["project.json"] = 525,
    ["prometheus.json"] = 533,
    ["prometheus.rules.json"] = 534,
    ["prometheus.rules.test.json"] = 535,
    ["proxies.json"] = 536,
    ["publiccode.yml"] = 537,
    ["pubspec.yaml"] = 538,
    ["pyrseas-0.8.json"] = 541,
    ["quilt.mod.json"] = 860,
    ["rc3 auth"] = 550,
    ["rc3 collection"] = 551,
    ["rc3 environment"] = 552,
    ...
    samt = 574,
    samtrc = 575,
    ["sarif-1.0.0.json"] = 577,
    ["sarif-2.0.0.json"] = 578,
    ["sarif-2.1.0"] = 588,
    ["sarif-2.1.0-rtm.2"] = 579,
    ["sarif-2.1.0-rtm.3"] = 581,
    ["sarif-2.1.0-rtm.4"] = 583,
    ["sarif-2.1.0-rtm.5"] = 585,
    ["sarif-2.1.0-rtm.6"] = 586,
    ["sarif-external-property-file-2.1.0"] = 589,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 580,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 582,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 584,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 587,
    ["schema.org - Action"] = 591,
    ["schema.org - ContactPoint"] = 592,
    ["schema.org - Place"] = 593,
    ["schema.org - Thing"] = 594,
    ["secrethub.yml"] = 862,
    ["semantic-release"] = 600,
    ["servicehub.config.json"] = 717,
    ["servicehub.service.json"] = 716,
    ["settings.job"] = 603,
    ["sfdx-hardis configuration"] = 605,
    ["shard.yml"] = 898,
    ["size-limit configuration"] = 610,
    ["skaffold.yaml"] = 781,
    ["skyuxconfig.json"] = 612,
    snapcraft = 613,
    ["spicepod.yaml"] = 918,
    ["sqlc configuration"] = 624,
    ["stripe-app-local.json"] = 633,
    ["stripe-app.json"] = 632,
    swcrc = 767,
    ["task.json"] = 639,
    taskcat = 734,
    ["template.json"] = 643,
    ["templatsources.json"] = 644,
    ["theme.json"] = 647,
    ["tizen_workspace.json"] = 648,
    tldr = 649,
    tmuxinator = 720,
    ["transcend.yml"] = 656,
    ...
    ["vega-lite.json"] = 683,
    ["vega.json"] = 682,
    ["venvironment-basic.yaml"] = 686,
    ["venvironment.yaml"] = 685,
    ["version.json"] = 687,
    ["vhwdebugger-binding.yaml"] = 689,
    ["vim-addon-info"] = 690,
    ["vs-2017.3.host.json"] = 692,
    ["vs-nesting.json"] = 693,
    ["vsls.json"] = 691,
    ["vss-extension.json"] = 697,
    ["vtesttree.yaml"] = 698,
    ["vtestunit.yaml"] = 699,
    ["warp-keysets.json"] = 868,
    ["warp-themes.json"] = 869,
    ["warp-workflows.json"] = 870,
    ["webhint.io"] = 820,
    ["webjobpublishsettings.json"] = 705,
    ["webjobs-list.json"] = 704,
    ["well-known-fursona"] = 906,
    ["xs-app.json"] = 730,
    ["xunit.runner.json"] = 715,
    yamllint = 755,
    ["zerops.io import file"] = 915,
    ["zerops.yml"] = 914,
    zuul = 739,
    ["Žinoma"] = 749
  },
