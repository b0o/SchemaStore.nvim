...
M.json = {
  ...
  index = {
    ...
    AIConfig = 25,
    ["AMX Muse Program Descriptor"] = 1126,
    ["API Builder"] = 936,
    ["AVA Configuration"] = 999,
    ...
    ["AWS Copilot Manifest"] = 1165,
    ["AWS SAM CLI Samconfig"] = 244,
    ["Adobe UXP Manifest"] = 1062,
    ["Aerleon Network & Service Definitions"] = 15,
    ["Aerleon Policy"] = 16,
    Aider = 1155,
    Air = 18,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1176,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1175,
    ["Airlock Microgateway"] = 26,
    ["Alacritty Configuration"] = 971,
    ["All Contributors configuration file"] = 1025,
    ...
    ["Application list for a WinUtil"] = 1106,
    ArchitectFX = 1111,
    ["Argo CD"] = 45,
    ["Argo Events"] = 46,
    ["Argo Workflows"] = 47,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1174,
    ["Azure IoT Operations connector metadata"] = 1171,
    ...
    ["Azure Pipelines"] = 99,
    ["Azure Static Web Apps CLI configuration file"] = 781,
    ["Azure Static Web Apps configuration file"] = 780,
    ["BOSH CPI Config"] = 123,
    ["BOSH Deploy Config"] = 124,
    ["BX CI"] = 143,
    ["Bacon config"] = 2,
    ["Bashly (bashly.yml)"] = 1029,
    ["Bashly Settings (bashly-settings.yml)"] = 1030,
    ["Better Code Hub"] = 941,
    ["Better Scripts"] = 144,
    Bigconfig = 116,
    ["Biome Formatter Config"] = 72,
    ["Bitmovin Encoding Template"] = 1119,
    BizTalkServerApplicationSchema = 908,
    Bleep = 145,
    ...
    ["Butane Config"] = 984,
    C4InterFlow = 1134,
    ["CDK Environment Manager, concrete environment configuration"] = 1158,
    ["CDK Environment Manager, concrete environments definition"] = 1157,
    ["CDK Environment Manager, environment definition"] = 1156,
    ["CGS Card Game Specification (cgs.json)"] = 1067,
    ["CICS TS region tagging"] = 993,
    ["CICS TS resource import"] = 994,
    ["CICS TS resource model"] = 995,
    ["CICS TS resource overrides"] = 996,
    ["CMake Presets"] = 146,
    ["CNC Codes"] = 167,
    ["CRS WAF test file"] = 1096,
    ["CRS WAF test platform overrides file"] = 1097,
    ...
    ["Clawject config"] = 173,
    ["Cloud Foundry Application Manifest"] = 1078,
    ["Cloud Run Spec v1"] = 1101,
    ...
    Concord = 1095,
    ["Configu .cfgu files"] = 1083,
    ["Configu .configu file"] = 1084,
    Conjure = 166,
    ["Container Structure Test"] = 922,
    Containerlab = 950,
    ["Contextive Glossary"] = 1150,
    Convex = 165,
    ["Crowdsec collection config"] = 263,
    ["Crowdsec parser config"] = 264,
    ["Crowdsec scenario config"] = 265,
    ["CumulusCI Config"] = 172,
    ["Custom Machinery Machine"] = 1068,
    ["Custom Machinery Recipe"] = 1069,
    ...
    ["DonateCaseBetterCasino menu"] = 1127,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1037,
    ["EAS config"] = 329,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1026,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1170,
    ["EasyVCR .NET"] = 330,
    ["Eidolon Resource"] = 1112,
    ...
    ["Evolving Resolutive Process notation"] = 1172,
    ["Expo SDK"] = 328,
    ...
    ["GeoJSON.json latest"] = 988,
    GherKing = 992,
    ["GitHub Action"] = 362,
    ["GitHub Actions typing"] = 1108,
    ...
    ["Google Digital Assetlinks"] = 1151,
    Goreleaser = 390,
    ["Goreleaser Pro"] = 391,
    Goss = 392,
    ["Gradle Build Cache Node"] = 939,
    ["Gradle Enterprise"] = 938,
    ...
    Hadolint = 918,
    Hammerkit = 949,
    ["Hardware Sentry Configuration"] = 1004,
    ["HashiCorp Vault"] = 406,
    Hatch = 919,
    Hayagriva = 408,
    Hayson = 409,
    ...
    ["JFrog File Spec"] = 444,
    ["JFrog Pipelines YML DSL"] = 1014,
    ["JMeter DSL cli config"] = 445,
    JReleaser = 448,
    ["JSON Document Transform"] = 456,
    ["JSON Feed"] = 457,
    ["JSON Resume"] = 694,
    ["JSON Schema Draft 2020-12"] = 886,
    ["JSON Schema Draft 4"] = 883,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1047,
    ["JSON Schema Draft 7"] = 884,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1048,
    ["JSON Schema Draft 8 (2019-09)"] = 885,
    ["JSON-API"] = 455,
    ["JSON-e templates"] = 946,
    ["JSON-stat 2.0"] = 879,
    JSONPatch = 459,
    ...
    ["Jujutsu (jj) VCS config"] = 1164,
    ["KIMMDY config file"] = 470,
    ["KODE/CI build.yaml"] = 1010,
    ["KSP-AVC"] = 880,
    ["KSP-CKAN"] = 881,
    ["KSP-NetKAN"] = 882,
    KSY = 1077,
    ...
    ["Metadata for a Cinnamon spice"] = 1104,
    ["Metatype Configuration"] = 510,
    ["MetricsHub Configuration"] = 511,
    ["MetricsHub Connector Configuration"] = 512,
    ["Micro Editor Syntax"] = 1038,
    ["Microsoft Band Web Tile"] = 513,
    ["Microsoft RulesEngine workflow rules"] = 1092,
    ["Microsoft RulesEngine workflow rules list"] = 1093,
    ["Minecraft Custom Main Menu Mod"] = 1056,
    ...
    ["MongoDB Atlas Search Index Definition"] = 1009,
    ["Monika Configuration"] = 1007,
    ["Monoweave Configuration"] = 538,
    ["Motif config"] = 900,
    MultiQC = 1144,
    ["NOX Framework (Service)"] = 559,
    ["Netin Diagnostic System Template"] = 966,
    ["Netlify config"] = 546,
    ...
    ["OpenUtau ustx"] = 580,
    ["OpenWeather Current Weather API"] = 945,
    ["OpenWeather Road Risk API"] = 944,
    ...
    ["Power Pages Configuration"] = 1161,
    ["Preset list for a WinUtil"] = 1107,
    ["ProActions AI-Kit Configuration"] = 635,
    ["ProActions AI-Kit Configuration for Menus"] = 637,
    ["ProActions AI-Kit Configuration for Sections"] = 639,
    ["ProActions AI-Kit Configuration for Services"] = 636,
    ["ProActions AI-Kit Configuration for Steps"] = 640,
    ["ProActions AI-Kit Configuration for Templates"] = 638,
    ["Problem object RFC9457"] = 1053,
    ["Problem package generators"] = 641,
    Pterodactyl = 1003,
    ["Pull Request Labeler"] = 658,
    Pulumi = 666,
    ["PyGTA Config"] = 662,
    PyProject = 667,
    Pylock = 1152,
    Pyright = 668,
    ["Python script metadata"] = 1146,
    ["QType AI DSL"] = 671,
    Qgoda = 670,
    Qodana = 976,
    ["Qt Creator workspace file"] = 1085,
    ["Quali Torque Blueprint Spec 2"] = 1001,
    ["QueryFirst config file"] = 1020,
    ["RKE Cluster Configuration JSON"] = 954,
    ["RKE Cluster Configuration YAML"] = 953,
    RadioHound = 661,
    Railpack = 673,
    Railway = 672,
    ["Rancher Fleet"] = 663,
    ...
    Ray = 917,
    ["Read the Docs"] = 665,
    ["Red-DiscordBot Cog"] = 681,
    ["Red-DiscordBot Cog Repo"] = 682,
    ["Red-DiscordBot Trivia"] = 683,
    ["Render Blueprints"] = 952,
    RenderCV = 696,
    Renovate = 695,
    ["Replit config"] = 689,
    Restate = 1139,
    ["Revel Digital Gadget Definition File"] = 1163,
    RoadRunner = 698,
    ["Robust Station Image"] = 1169,
    Rockcraft = 699,
    ["Roo Coder Custom Modes"] = 700,
    Rubocop = 691,
    ["Rudder techniques"] = 1060,
    Ruff = 692,
    ["Rust Project"] = 693,
    ["Rust toolchain"] = 704,
    ["SDMX data message"] = 730,
    ["SDMX metadata message"] = 729,
    ["SDMX structure message"] = 728,
    ["SIL Kit Participant Configuration"] = 740,
    ["SIL Kit Registry Configuration"] = 741,
    ["SPDX 2.3"] = 778,
    SWADL = 794,
    ["Safebox Config"] = 1015,
    ["Sapphire CLI Config"] = 707,
    ["SauceCTL Configuration"] = 963,
    ["Schema Catalog"] = 722,
    ["Scoop manifest"] = 727,
    ["Semantic Data Fabric (SDF) file"] = 731,
    ["Semgrep Rule"] = 733,
    ["Serenity Code Generator (Sergen)"] = 734,
    ["Serverless Framework Configuration"] = 970,
    ["Serverless Workflow"] = 972,
    ["Settings for a Cinnamon spice"] = 1103,
    ["Settings.paf"] = 736,
    ["Shopware 6 Configuration"] = 973,
    ["Shopware CLI Extension Store Configuration"] = 974,
    ["Shopware CLI Project Store Configuration"] = 975,
    ["Sigma Detection Rule"] = 738,
    ["Sigrid scope configuration file"] = 739,
    ["SkyPilot Task JSON"] = 1061,
    ["Slack app manifest"] = 743,
    Snapcraft = 745,
    Solidarity = 748,
    ["Solution filters"] = 749,
    ["Source Maps v3"] = 750,
    Sourcery = 751,
    ["Spack bootstrap.yaml"] = 752,
    ["Spack cdash.yaml"] = 753,
    ["Spack ci.yaml"] = 754,
    ["Spack compilers.yaml"] = 755,
    ["Spack concretizer.yaml"] = 756,
    ["Spack config.yaml"] = 757,
    ["Spack definitions.yaml"] = 758,
    ["Spack develop.yaml"] = 759,
    ["Spack env_vars.yaml"] = 760,
    ["Spack environment"] = 766,
    ["Spack include.yaml"] = 761,
    ["Spack mirrors.yaml"] = 762,
    ["Spack modules.yaml"] = 763,
    ["Spack packages.yaml"] = 764,
    ["Spack repos.yaml"] = 765,
    ["Spack toolchains.yaml"] = 767,
    ["Spack upstreams.yaml"] = 768,
    ["Spack view.yaml"] = 769,
    ["Speakeasy Generation Config File"] = 773,
    ["Speakeasy Lint Configuration File"] = 770,
    ["Speakeasy Test Generation Configuration File"] = 771,
    ["Speakeasy Workflow File"] = 772,
    SpecIF = 774,
    ["Specmatic Configuration"] = 775,
    ["Sponge Mixin configuration"] = 776,
    StackBlitz = 782,
    ["StackHawk Scanner Configuration"] = 969,
    Stale = 783,
    Starfish = 784,
    ["Starlake Data Pipeline"] = 942,
    Starship = 785,
    ["Statamic Blueprint"] = 786,
    ["Stella configuration file"] = 787,
    ["Streamlit configuration file"] = 788,
    ["Stryker Mutator"] = 791,
    ["StyleCop Analyzers Configuration"] = 792,
    ["Stylelint (.stylelintrc)"] = 793,
    ["Stylua Config"] = 1153,
    ["Sublime Syntax"] = 1016,
    ["Subsquid squid manifest"] = 1063,
    ["Swagger API 2.0"] = 795,
    ["Synadia Connect Component"] = 796,
    TSON = 831,
    TSTyche = 832,
    ["TYPO3 Vendor Bundler config"] = 837,
    ["Tab data for a LinUtil"] = 1110,
    ["Tab list for a LinUtil"] = 1109,
    Tach = 797,
    ["Tach Domain"] = 798,
    Talhelper = 800,
    ["Talisman configuration"] = 801,
    Taplo = 1154,
    ["Taskfile config"] = 947,
    Taurus = 802,
    Tauticord = 803,
    ["Tekton Pipeline"] = 1182,
    ["Tekton PipelineRun"] = 1183,
    ["Tekton Task"] = 1180,
    ["Tekton TaskRun"] = 1181,
    Telefonistka = 1140,
    ["Terrateam config"] = 1166,
    ["TestEnvironment.json"] = 814,
    ["TextMate Grammar"] = 813,
    Threagile = 809,
    ["Tier.run pricing.json"] = 806,
    Tikibase = 807,
    Tombi = 812,
    ["Traefik v2"] = 817,
    ["Traefik v2 File Provider"] = 818,
    ["Traefik v3"] = 819,
    ["Traefik v3 File Provider"] = 820,
    ["Travis CI (.travis.yml)"] = 816,
    Treefmt = 395,
    Trident = 1136,
    ["TrueScript for *.tscript files"] = 823,
    ["Tugboat QA config.yml"] = 1133,
    TunnelHub = 1051,
    Turborepo = 815,
    Tycho = 1099,
    Tye = 977,
    ["Tyk Gateway - Open Source v5.7+"] = 1145,
    ["Typst Manifest"] = 838,
    ["UET BuildConfig.json"] = 1021,
    ["UI5 Manifest"] = 844,
    ["UNCORS configuration"] = 848,
    ["UTAM Page Object"] = 847,
    ["Ubuntu Server Autoinstall"] = 842,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1137,
    ["Uniswap Token List"] = 929,
    ["Universal Schedule Format"] = 849,
    ["Unreal Engine Uplugin"] = 1022,
    ["Unreal Engine Uproject"] = 1023,
    ["UpCloud CLI (upctl) configuration"] = 1138,
    ["Updatecli Compose"] = 985,
    ["Updatecli Policy Manifest"] = 986,
    ["Updatecli Policy Metadata"] = 987,
    Uplift = 1019,
    ["Upsun config"] = 3,
    ["User Journey Map"] = 951,
    V2Ray = 991,
    ["VSCode Code Snippets"] = 228,
    ["VSIX CLI publishing"] = 867,
    Vector = 851,
    ["Vela Pipeline Configuration"] = 854,
    Vercel = 227,
    ["Version Bumper config"] = 857,
    ["Viash Component Config"] = 1142,
    ["Viash Package Config"] = 1143,
    Visivo = 1049,
    ["WP-CLI"] = 877,
    Wake = 1135,
    ["Waku Config"] = 1113,
    ["Web App Manifest"] = 873,
    ["Web types"] = 876,
    WebExtensions = 872,
    ["Webman package recipe"] = 997,
    ["Windows Package Manager Installer Manifest"] = 925,
    ["Windows Package Manager Locale Manifest"] = 926,
    ["Windows Package Manager Singleton Manifest"] = 924,
    Winutil = 927,
    ["WireMock CLI import configuration"] = 1118,
    ["WireMock CLI local service configuration"] = 1117,
    ["WireMock stub mapping"] = 1116,
    ["Woodpecker pipeline config"] = 965,
    ["Wrangler CLI"] = 878,
    ["Xstate Machine"] = 983,
    ["Yandex Workflow Language"] = 1105,
    ["Yarn Config (.yarnrc.yml)"] = 940,
    ["Yippee-Ki-JSON configuration YML"] = 931,
    ["YouTrack App"] = 1102,
    ["Zarf Package Configuration"] = 1168,
    ["Zerops.io config"] = 1090,
    ["Zerops.io import"] = 1091,
    ["Zola Configuration"] = 1179,
    ["aerleon.yml"] = 14,
    ["angular.json"] = 27,
    apko = 1054,
    ...
    ["behat.yml"] = 126,
    ["bigquery-table"] = 115,
    ["bioimageio resource description"] = 1071,
    ...
    ["crowdin.yml"] = 262,
    ["ctfd-setup configuration file"] = 1125,
    ["custom-elements.json"] = 1041,
    ["cypress.json"] = 266,
    ...
    ["gematik health care insurance list"] = 1131,
    ["gematik health care patient list"] = 1128,
    ["gematik health care provider institution list"] = 1130,
    ["gematik health care provider list"] = 1129,
    ["gematik tiger test environment configuration"] = 1132,
    ["git-town.toml"] = 1177,
    ["gitlab-ci"] = 370,
    ["global.json"] = 386,
    ...
    ["lint-staged (.lintstagedrc)"] = 894,
    ["local.settings.json"] = 498,
    ["localazy.json"] = 499,
    ["lotus.yaml"] = 497,
    ["lsdlschema.json"] = 500,
    ["markdown-link-check"] = 960,
    maturin = 961,
    mboats = 968,
    ["micro-settings.json"] = 1033,
    ["mimetypes.json"] = 514,
    ["mirrord config"] = 896,
    mise = 897,
    ["mkdocs.yml"] = 534,
    ["monospace.yml"] = 537,
    ["moon.yml"] = 1115,
    ["mprocs Configuration file"] = 1086,
    ["mrdocs.yml"] = 535,
    ["mta.yaml"] = 898,
    ["mtad.yaml"] = 899,
    ["mycode.json"] = 544,
    ...
    ["plagiarize.yaml"] = 617,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1121,
    ["podbard.yaml"] = 620,
    ["portman.json"] = 623,
    ["prefect.toml"] = 631,
    ["prefect.yaml"] = 632,
    ["prettierrc.json"] = 633,
    ["prisma.yml"] = 634,
    ["project-1.0.0-beta3.json"] = 643,
    ["project-1.0.0-beta4.json"] = 644,
    ["project-1.0.0-beta5.json"] = 645,
    ["project-1.0.0-beta6.json"] = 646,
    ["project-1.0.0-beta8.json"] = 647,
    ["project-1.0.0-rc1.json"] = 648,
    ["project-1.0.0-rc2.json"] = 649,
    ["project.json"] = 642,
    ["project.owasp.yaml"] = 650,
    ["prometheus-alertmanager.json"] = 654,
    ["prometheus.json"] = 651,
    ["prometheus.rules.json"] = 652,
    ["prometheus.rules.test.json"] = 653,
    ["proxies.json"] = 655,
    ["publiccode.yml"] = 656,
    ["pubspec.yaml"] = 657,
    ["pyrseas-0.8.json"] = 660,
    pytest = 669,
    ["quilt.mod.json"] = 1034,
    ["rc3 auth"] = 675,
    ["rc3 collection"] = 676,
    ...
    ["release drafter"] = 912,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 685,
    ["release-please-manifest.json"] = 686,
    ["release-plz.toml"] = 687,
    ["renv.lock"] = 697,
    ["rivet.json"] = 1058,
    ["rivet.yaml (legacy)"] = 1057,
    rumdl = 702,
    runny = 701,
    rustfmt = 703,
    sake = 1148,
    samt = 705,
    samtrc = 706,
    ["sarif-1.0.0.json"] = 708,
    ["sarif-2.0.0.json"] = 709,
    ["sarif-2.1.0"] = 719,
    ["sarif-2.1.0-rtm.2"] = 710,
    ["sarif-2.1.0-rtm.3"] = 712,
    ["sarif-2.1.0-rtm.4"] = 714,
    ["sarif-2.1.0-rtm.5"] = 716,
    ["sarif-2.1.0-rtm.6"] = 717,
    ["sarif-external-property-file-2.1.0"] = 720,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 711,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 713,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 715,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 718,
    ["scalingo.json configuration"] = 721,
    ["schema.org - Action"] = 723,
    ["schema.org - ContactPoint"] = 724,
    ["schema.org - Place"] = 725,
    ["schema.org - Thing"] = 726,
    ["secrethub.yml"] = 1036,
    ["semantic-release"] = 732,
    ["servicehub.config.json"] = 889,
    ["servicehub.service.json"] = 888,
    ["settings.job"] = 735,
    ["sfdx-hardis configuration"] = 737,
    ["shard.yml"] = 1074,
    ["size-limit configuration"] = 742,
    ["skaffold.yaml"] = 958,
    ["skyuxconfig.json"] = 744,
    ["snowflake-config"] = 746,
    ["snowflake-connections"] = 747,
    ["spicepod.yaml"] = 1094,
    ["sqlc configuration"] = 779,
    ["stripe-app-local.json"] = 790,
    ["stripe-app.json"] = 789,
    swcrc = 943,
    ["task.json"] = 799,
    taskcat = 907,
    ["template.json"] = 804,
    ["templatsources.json"] = 805,
    ["theme.json"] = 808,
    ["tizen_workspace.json"] = 810,
    tldr = 811,
    ["tm_devices configuration file"] = 1159,
    tmuxinator = 892,
    ["transcend.yml"] = 821,
    ["tree-sitter grammar.json"] = 394,
    ["trime.yaml"] = 822,
    ["trunk.yaml"] = 824,
    ["ts-force-config.json"] = 829,
    ["tsconfig.json"] = 825,
    ["tsd.json"] = 826,
    ["tsdoc.json"] = 827,
    ["tsdrc.json"] = 828,
    ...
    ["vega-lite.json"] = 853,
    ["vega.json"] = 852,
    ["venvironment.yaml"] = 855,
    ["venvplus.yaml"] = 856,
    version = 1141,
    ["version.json"] = 858,
    ["vhwdebugger-binding.yaml"] = 860,
    ["vim-addon-info"] = 861,
    ["vs-2017.3.host.json"] = 863,
    ["vs-nesting.json"] = 864,
    ["vsls.json"] = 862,
    ["vss-extension.json"] = 868,
    vtcfg = 1147,
    ["vtesttree.yaml"] = 869,
    ["vtestunit.yaml"] = 870,
    ["warp-keysets.json"] = 1042,
    ["warp-themes.json"] = 1043,
    ["warp-workflows.json"] = 1044,
    ["webhint.io"] = 998,
    ["webjobpublishsettings.json"] = 875,
    ["webjobs-list.json"] = 874,
    ["well-known-fursona"] = 1081,
    ["xs-app.json"] = 902,
