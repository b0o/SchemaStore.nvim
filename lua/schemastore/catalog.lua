...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 952,
    [".nodehawkrc"] = 591,
    [".npmpackagejsonlintrc"] = 595,
    [".omletrc"] = 1131,
    [".phrase.yml"] = 669,
    [".phraseapp.yml"] = 670,
    [".pmbot.yml"] = 655,
    [".postcssrc"] = 664,
    [".powerpages-web-template-manifest"] = 666,
    [".pre-commit-config.yml"] = 667,
    [".pre-commit-hooks.yml"] = 668,
    [".putout.json"] = 703,
    [".rehyperc"] = 728,
    [".remarkrc"] = 732,
    [".sprite files"] = 827,
    ...
    AIConfig = 35,
    ["AMX Muse Program Descriptor"] = 1179,
    ["API Builder"] = 987,
    ["AVA Configuration"] = 1050,
    ["AWS AppConfig Feature Flags-v1"] = 69,
    ["AWS CDK cdk.json"] = 267,
    ["AWS CloudFormation"] = 268,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 269,
    ["AWS Copilot Manifest"] = 1218,
    ["AWS SAM CLI Samconfig"] = 270,
    ["Adobe UXP Manifest"] = 1113,
    ["Aerleon Network & Service Definitions"] = 21,
    ["Aerleon Policy"] = 22,
    ["AgentCore CLI"] = 1258,
    Aider = 1208,
    Air = 24,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1229,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1228,
    ["Airlock Microgateway"] = 36,
    ["Alacritty Configuration"] = 1022,
    ["All Contributors configuration file"] = 1076,
    ["Ansible Argument Specs"] = 408,
    ["Ansible Collection Galaxy"] = 415,
    ["Ansible Execution Environment"] = 405,
    ["Ansible Inventory"] = 414,
    ["Ansible Meta"] = 406,
    ["Ansible Meta Runtime"] = 407,
    ["Ansible Navigator Configuration"] = 417,
    ["Ansible Playbook"] = 412,
    ["Ansible Requirements"] = 409,
    ["Ansible Rulebook"] = 413,
    ["Ansible Tasks File"] = 411,
    ["Ansible Vars File"] = 410,
    ["Ansible-lint Configuration"] = 416,
    Any = 1141,
    ...
    ["Application list for a WinUtil"] = 1158,
    ArchitectFX = 1163,
    ["Argo CD"] = 55,
    ["Argo Events"] = 56,
    ["Argo Workflows"] = 57,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1227,
    ["Azure IoT Operations connector metadata"] = 1224,
    ...
    ["Azure Pipelines"] = 114,
    ["Azure Static Web Apps CLI configuration file"] = 831,
    ["Azure Static Web Apps configuration file"] = 830,
    BMML = 1246,
    ["BOSH CPI Config"] = 140,
    ["BOSH Deploy Config"] = 141,
    ["BX CI"] = 161,
    ["Bacon config"] = 6,
    ["Barba-CV"] = 84,
    ["Bashly (bashly.yml)"] = 1080,
    ["Bashly Settings (bashly-settings.yml)"] = 1081,
    Bento = 1245,
    ["Better Code Hub"] = 992,
    ["Better Scripts"] = 162,
    Bigconfig = 133,
    ["Biome Formatter Config"] = 85,
    ["Bitmovin Encoding Template"] = 1172,
    BizTalkServerApplicationSchema = 959,
    Bleep = 163,
    ["Block Protocol Metadata"] = 160,
    ["Bluebricks blueprint config"] = 1251,
    ["Boyka Framework"] = 142,
    Briefcase = 965,
    ["Build Info"] = 151,
    Buildkite = 153,
    ["Bukkit plugin.yml"] = 152,
    ["BungeeCord plugin.yml"] = 158,
    ["Butane Config"] = 1035,
    C4InterFlow = 1187,
    ["CDK Environment Manager, concrete environment configuration"] = 1211,
    ["CDK Environment Manager, concrete environments definition"] = 1210,
    ["CDK Environment Manager, environment definition"] = 1209,
    ["CGS Card Game Specification (cgs.json)"] = 1118,
    ["CICS TS region tagging"] = 1044,
    ["CICS TS resource import"] = 1045,
    ["CICS TS resource model"] = 1046,
    ["CICS TS resource overrides"] = 1047,
    ["CMake Presets"] = 164,
    ["CNC Codes"] = 186,
    ["CRS WAF test file"] = 1148,
    ["CRS WAF test platform overrides file"] = 1149,
    ["CSS Comb (.csscomb.json)"] = 295,
    ["CSS Lint (.csslintrc)"] = 296,
    ["CSpell (cspell.json)"] = 294,
    ["CVE Record Format"] = 198,
    CWL = 1124,
    ["Cache Warmup config"] = 165,
    ["Calqulus pipeline"] = 166,
    ["Camel YAML DSL"] = 167,
    ["Cannon TOML"] = 168,
    Carafe = 169,
    ["Cargo Make"] = 171,
    ["Cargo Manifest"] = 170,
    ["Catalog Info Backstage"] = 172,
    ["Chamaleon environment"] = 1176,
    ["Chamaleon properties"] = 1177,
    ["Chamaleon template"] = 1175,
    Changepacks = 1238,
    Changesets = 279,
    Changie = 173,
    Charmcraft = 174,
    Cheatsheets = 1032,
    ["ChordPro Configuration"] = 175,
    ["Chrome Extension"] = 260,
    ["Chromia Model"] = 176,
    ["Chromia Seeder Module Config"] = 178,
    ["Chromia Seeder Root Config"] = 177,
    ["Cinnamon Spice info.json"] = 94,
    ["CircleCI config.yml"] = 235,
    ["Citation File Format"] = 281,
    ["Citrus test case"] = 180,
    CityJSON = 181,
    ["Claude Code Keybindings"] = 193,
    ["Claude Code Plugin Manifest"] = 194,
    ["Claude Code Plugin Marketplace"] = 195,
    ["Claude Code Settings"] = 196,
    ["Clawject config"] = 192,
    ["Cloud Foundry Application Manifest"] = 1130,
    ["Cloud Run Spec v1"] = 1153,
    ["Cloud.gov Workshop Configuration"] = 95,
    ["CloudCannon Configuration"] = 100,
    ["CloudCannon Configuration (Collection Structures)"] = 109,
    ["CloudCannon Configuration (Collections)"] = 108,
    ["CloudCannon Configuration (Editables)"] = 107,
    ["CloudCannon Configuration (Inputs)"] = 102,
    ["CloudCannon Configuration (Snippets Definitions)"] = 106,
    ["CloudCannon Configuration (Snippets Imports)"] = 105,
    ["CloudCannon Configuration (Snippets)"] = 104,
    ["CloudCannon Configuration (Structure Value)"] = 103,
    ["CloudCannon Configuration (Structures)"] = 101,
    ["CloudEvents specification"] = 182,
    ["Code Climate"] = 236,
    CodeCV = 98,
    CodeRabbit = 97,
    ["CodeShip Pro services configuration files"] = 249,
    ["CodeShip Pro steps configuration files"] = 250,
    ["Codecov configuration files"] = 248,
    Codex = 244,
    CodifyCLI = 99,
    Codux = 246,
    ["Cog config file"] = 187,
    ["Commandbox Box.json"] = 188,
    ["Commandbox Server.json"] = 189,
    ["Common Catalog Data"] = 258,
    ["Common Package Specification"] = 190,
    Concord = 1147,
    ["Configu .cfgu files"] = 1135,
    ["Configu .configu file"] = 1136,
    Conjure = 185,
    ["Container Structure Test"] = 973,
    Containerlab = 1001,
    ["Contextive Glossary"] = 1203,
    Convex = 184,
    ["Crowdsec collection config"] = 289,
    ["Crowdsec parser config"] = 290,
    ["Crowdsec scenario config"] = 291,
    ["CumulusCI Config"] = 191,
    ["Cursor Agent Environment"] = 1256,
    ["Custom Machinery Machine"] = 1119,
    ["Custom Machinery Recipe"] = 1120,
    ["Cycle Stack File"] = 199,
    CycloneDX = 200,
    ["DWP Exchange - catalogue entry"] = 340,
    ["DWP Exchange - gateway"] = 338,
    ["DWP Exchange - meta"] = 339,
    ["Dart Build Config (dart-build.json)"] = 297,
    ["Dart Test Config (dart-test.json)"] = 298,
    ["DashLord Configuration"] = 299,
    ["Data Contract Specification"] = 300,
    ["Data Product Specification"] = 301,
    ["DataYoga Connections"] = 201,
    ["DataYoga Job"] = 202,
    ["Datadog Continuous Testing"] = 506,
    ["Datadog Service Definition"] = 507,
    ["Datadog Software Catalog"] = 508,
    ["Datahub Ingestion Recipe"] = 1051,
    ["Debian Upstream Metadata file"] = 209,
    ["Deck config"] = 210,
    ["Declarative Automation Bundles"] = 1097,
    ["DeepMatch deeplinks spec"] = 211,
    ["Dein Config"] = 212,
    ["Deno Config (deno.json)"] = 307,
    ["Dependency cruiser"] = 213,
    ["DeployStack Configuration"] = 214,
    ["Deployah Configuration"] = 1226,
    ["Deployer Recipe"] = 310,
    ["Deta Spacefile"] = 215,
    ["Detekt Config (detekt.yml)"] = 311,
    ["Devbox Config"] = 216,
    ["Devbox Plugin"] = 217,
    Devfile = 337,
    Devup = 1239,
    DipDup = 1150,
    ["Discord Webhook"] = 312,
    ["DocFx Config (docfx.json)"] = 317,
    ["Docker Desktop extension metadata"] = 314,
    ["Docs MCP Manifest"] = 318,
    Dofigen = 319,
    ["Dolittle Artifacts"] = 320,
    ["Dolittle Bounded Context Configuration"] = 321,
    ["Dolittle Event Horizons Configuration"] = 322,
    ["Dolittle Resources Configuration"] = 323,
    ["Dolittle Server Configuration"] = 324,
    ["Dolittle Tenant Map Configuration"] = 326,
    ["Dolittle Tenants Configuration"] = 325,
    ["Dolittle Topology"] = 327,
    ["DonateCaseBetterCasino menu"] = 1180,
    ["Drupal Breakpoints"] = 218,
    ["Drupal Config"] = 230,
    ["Drupal Info"] = 219,
    ["Drupal Layouts"] = 220,
    ["Drupal Libraries"] = 221,
    ["Drupal Links Action"] = 222,
    ["Drupal Links Contextual"] = 223,
    ["Drupal Links Menu"] = 224,
    ["Drupal Links Task"] = 225,
    ["Drupal Migration"] = 226,
    ["Drupal Permissions"] = 227,
    ["Drupal Recipe"] = 228,
    ["Drupal Routing"] = 229,
    ["Drupal Services"] = 231,
    ["Drush site aliases"] = 333,
    ["Dynamic Bash Aliases (.aliases)"] = 1088,
    ["EAS config"] = 359,
    ["ECA - Editor Code Assistant"] = 342,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1077,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1223,
    ["EasyVCR .NET"] = 361,
    ["Eidolon Resource"] = 1164,
    ["Elgato Stream Deck"] = 344,
    Elm = 1152,
    ["Embrace Config"] = 1063,
    Endurica = 1101,
    ["Enterprise Contract Policy Spec"] = 345,
    ["Erda Pipeline"] = 1126,
    ["Erda Runtime"] = 1127,
    ["Espanso config.yml"] = 1249,
    ["Espanso match.yml"] = 1248,
    Esquio = 347,
    ["Estuary Flow Catalog"] = 1041,
    ["Ethereum ERC1155"] = 1260,
    ["Ethereum ERC721"] = 1259,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 352,
    ["EveryVoice TTS Toolkit Data Configuration"] = 353,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 357,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 356,
    ["EveryVoice TTS Toolkit Text Configuration"] = 354,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 355,
    ["Evolving Resolutive Process notation"] = 1225,
    ["Expo SDK"] = 358,
    ["Expoot app config"] = 360,
    ["F-Droid Data metadata"] = 365,
    ["FasterCI Configuration"] = 115,
    ["Fence configuration"] = 116,
    FiQuS = 369,
    Firebase = 367,
    ["Flatpak Builder Manifest"] = 370,
    ["FlexGet Config"] = 371,
    ["Flow.json Configurations"] = 1123,
    ["Fossa configuration file"] = 378,
    ["Fossa's fossa-deps file"] = 379,
    ["Foundry VTT - Base package Manifest"] = 373,
    ["Foundry VTT - Module Manifest"] = 374,
    ["Foundry VTT - System Data Template"] = 377,
    ["Foundry VTT - System Manifest"] = 375,
    ["Foundry VTT - World Manifest"] = 376,
    ["Foxx Manifest"] = 117,
    ["Freifunk.de Community API"] = 120,
    ["Frogbot Config"] = 121,
    ["G2P Mapping Configuration"] = 385,
    ["GCP Blueprint Metadata"] = 388,
    Gaspar = 386,
    ["GatewayCore API Gateway"] = 387,
    ["Gemini CLI settings"] = 389,
    ["GeoJSON.json latest"] = 1039,
    GherKing = 1043,
    ["GitHub Action"] = 394,
    ["GitHub Actions typing"] = 1160,
    ["GitHub Discussion"] = 395,
    ["GitHub Funding"] = 396,
    ["GitHub Issue Template configuration"] = 397,
    ["GitHub Issue Template forms"] = 398,
    ["GitHub Workflow"] = 399,
    ["GitHub Workflow Template Properties"] = 400,
    ["GitHub automatically generated release notes configuration"] = 401,
    ["GitLab Agent for Kubernetes configuration"] = 1115,
    GitVersion = 391,
    ["Gitea Issue Template configuration"] = 392,
    ["Gitea Issue Template forms"] = 393,
    ["Gitpod Automations"] = 403,
    ["Gitpod Configuration"] = 404,
    ["GlazeWM settings"] = 1117,
    ["Global Privacy Control"] = 390,
    Goblet = 1096,
    ["Golangci-lint Configuration"] = 419,
    ["Golangci-lint Custom Plugins Configuration"] = 420,
    ["Google Chrome Related Website Sets"] = 368,
    ["Google Cloud Workflows"] = 266,
    ["Google Digital Assetlinks"] = 1204,
    Goreleaser = 422,
    ["Goreleaser Pro"] = 423,
    Goss = 424,
    ["Gradle Build Cache Node"] = 990,
    ["Gradle Enterprise"] = 989,
    ["Grafana 5.x Dashboard"] = 425,
    ["GraphQL Code Generator"] = 430,
    ["GraphQL Config"] = 429,
    ["GraphQL Mesh"] = 428,
    ["GroovyLint configuration"] = 431,
    ["Grunt JSHint task"] = 435,
    ["Grunt Watch task"] = 436,
    ["Grunt base task"] = 437,
    ["Grunt clean task"] = 433,
    ["Grunt copy task"] = 432,
    ["Grunt cssmin task"] = 434,
    HEMTT = 955,
    Hadolint = 969,
    Hammerkit = 1000,
    ["Hardware Sentry Configuration"] = 1055,
    ["Hashgraph Online Skill Manifest"] = 2,
    ["HashiCorp Vault"] = 438,
    Hatch = 970,
    Hayson = 440,
    ["Haystack Pipeline"] = 441,
    ["Hazelcast 5 Configuration"] = 442,
    ["Hecate Input Schema"] = 1215,
    ["Helm Chart.lock"] = 233,
    ["Helm Chart.yaml"] = 232,
    ["Helm Unittest Test Suite"] = 234,
    ["Home Assistant Integration Manifest"] = 443,
    ["Homer dashboard configuration"] = 444,
    Hugo = 1031,
    ["Hugo Theme"] = 1030,
    ["Hulak Configuration"] = 451,
    ["Hyperfoil benchmark configuration"] = 450,
    ["IBM Zapp document"] = 452,
    ["IBM zCodeFormatSettings"] = 453,
    ["IMG Catapult PSP"] = 458,
    ["IVMS101 by CODE Protocol"] = 1116,
    Infrahub = 460,
    Istanbul = 1059,
    ["JDownloader2 crawler multi-rules"] = 473,
    ["JDownloader2 crawler single-rules"] = 472,
    ["JFrog Applications Config"] = 474,
    ["JFrog File Spec"] = 475,
    ["JFrog Pipelines YML DSL"] = 1065,
    ["JMeter DSL cli config"] = 476,
    JReleaser = 479,
    ["JSON Document Transform"] = 487,
    ["JSON Feed"] = 488,
    ["JSON Resume"] = 740,
    ["JSON Schema Draft 2020-12"] = 937,
    ["JSON Schema Draft 4"] = 934,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1098,
    ["JSON Schema Draft 7"] = 935,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1099,
    ["JSON Schema Draft 8 (2019-09)"] = 936,
    ["JSON-API"] = 486,
    ["JSON-e templates"] = 997,
    ["JSON-stat 2.0"] = 930,
    JSONPatch = 490,
    ["JSR Package Config (jsr.json)"] = 480,
    Jarl = 1231,
    Jasmine = 467,
    Jekyll = 468,
    ["Jenkins X Pipelines"] = 469,
    ["Jenkins X Requirements"] = 470,
    Jest = 471,
    Jocker = 477,
    ["Jovo Language Models"] = 478,
    ["Jujutsu (jj) VCS config"] = 1217,
    ["KIMMDY config file"] = 501,
    ["KODE/CI build.yaml"] = 1061,
    ["KSP-AVC"] = 931,
    ["KSP-CKAN"] = 932,
    ["KSP-NetKAN"] = 933,
    KSY = 1128,
    KSail = 383,
    ["KYA Manifest"] = 1129,
    ["Karakum configuration file"] = 380,
    Kas = 493,
    ["Kestra flow file"] = 502,
    ["Keycloak REST API"] = 1068,
    ["Knative Functions - func.yaml"] = 381,
    Knip = 382,
    ["Knowledge Unit"] = 510,
    ["Kometa (nightly) config file"] = 504,
    ["Kometa config file"] = 503,
    ["Kong DBLess config"] = 1062,
    KrakenD = 505,
    ["Kubri Configuration"] = 513,
    LOOBin = 528,
    ["Lake configuration file"] = 1220,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 271,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 272,
    ["Landing Zone Accelerator on AWS - Global Config"] = 273,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 274,
    ["Landing Zone Accelerator on AWS - Network Config"] = 275,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 276,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 277,
    ["Landing Zone Accelerator on AWS - Security Config"] = 278,
    ["Lando (landofile)"] = 110,
    ["LangGraph Platform configuration"] = 1140,
    ["Language configuration"] = 1139,
    Lefthook = 517,
    ["Liferay client-extension.yaml"] = 524,
    ["LinkML Metamodel"] = 526,
    Liquibase = 1006,
    ["Liquibase Flow File"] = 1007,
    ["Lively Properties"] = 527,
    ["Lobe AI Agent"] = 112,
    Loki = 113,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 570,
    ["MS2Rescore Configuration"] = 574,
    ["Madness (madness.yml)"] = 1079,
    ["Mado configuration"] = 534,
    ["Maestro Flow"] = 535,
    ["Mail Servers Configuration"] = 1252,
    ["MapEHR Mapping"] = 536,
    Markdownlint = 1010,
    ["Mason Registry"] = 1013,
    ["MegaLinter Custom Flavor"] = 539,
    ["MegaLinter configuration"] = 538,
    ["MegaLinter descriptor"] = 540,
    Melange = 1106,
    ["Meltano project definition"] = 541,
    ["Mergify Configuration"] = 575,
    ["Metadata for a Bazel module"] = 542,
    ["Metadata for a Cinnamon spice"] = 1156,
    ["Metatype Configuration"] = 543,
    ["MetricsHub Configuration"] = 544,
    ["MetricsHub Connector Configuration"] = 545,
    ["Micro Editor Syntax"] = 1089,
    ["Microsoft Band Web Tile"] = 546,
    ["Microsoft RulesEngine workflow rules"] = 1144,
    ["Microsoft RulesEngine workflow rules list"] = 1145,
    ["Minecraft Custom Main Menu Mod"] = 1107,
    ["Minecraft Data Pack Advancement"] = 548,
    ["Minecraft Data Pack Biome"] = 549,
    ["Minecraft Data Pack Configured Carver"] = 550,
    ["Minecraft Data Pack Damage Type"] = 551,
    ["Minecraft Data Pack Dimension"] = 553,
    ["Minecraft Data Pack Dimension Type"] = 552,
    ["Minecraft Data Pack Item Modifier"] = 554,
    ["Minecraft Data Pack Loot Table"] = 555,
    ["Minecraft Data Pack Metadata"] = 556,
    ["Minecraft Data Pack Predicate"] = 557,
    ["Minecraft Data Pack Recipe"] = 558,
    ["Minecraft Data Pack Tag"] = 559,
    ["Minecraft Data Pack Template Pool"] = 560,
    ["Minecraft Data Pack Trim Material"] = 565,
    ["Minecraft Data Pack Trim Pattern"] = 566,
    ["Minecraft Resource Pack Lang"] = 561,
    ["Minecraft Resource Pack Particle"] = 562,
    ["Minecraft Resource Pack Texture Mcmeta"] = 564,
    ["Minecraft Resourcepack Sounds"] = 563,
    ModuleAssembler = 568,
    ["Monade CLI Stack Configuration"] = 578,
    ["MongoDB Atlas Search Index Definition"] = 1060,
    ["Monika Configuration"] = 1058,
    ["Monoweave Configuration"] = 573,
    ["Motif config"] = 951,
    MultiQC = 1197,
    ["NOX Framework (Service)"] = 594,
    ["Netin Diagnostic System Template"] = 1017,
    ["Netlify config"] = 581,
    ["Network-as-Code Data Model"] = 582,
    ["Next Gen UI Agent A2A Server Configuration"] = 583,
    ["Next Gen UI Agent Configuration"] = 585,
    ["Next Gen UI Agent MCP Server Configuration"] = 584,
    ["Nightwatch.js"] = 587,
    ["Node.js configuration"] = 956,
    ["NueJS configuration file"] = 599,
    ["Nuitka.yaml"] = 1121,
    ["Nullstone config"] = 601,
    ["ONe's changelog entry"] = 620,
    ["ONe's service descriptor"] = 619,
    ["ORT Server repository environment configuration"] = 630,
    ["OSCAL Assessment Plan (AP)"] = 632,
    ["OSCAL Assessment Results (AR)"] = 633,
    ["OSCAL Catalog"] = 634,
    ["OSCAL Component Definition (CDef)"] = 635,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 636,
    ["OSCAL Profile"] = 637,
    ["OSCAL System Security Plan (SSP)"] = 638,
    ["OSS Review Toolkit configuration"] = 639,
    ["OSS Review Toolkit curation"] = 640,
    ["OSS Review Toolkit package configuration"] = 641,
    ["OSS Review Toolkit repository configuration"] = 642,
    ["OSS Review Toolkit resolutions"] = 643,
    ["October CMS columns"] = 605,
    ["October CMS fields"] = 606,
    ["Oh My Posh"] = 608,
    Okteto = 609,
    ["Ona Automations"] = 611,
    Opctl = 954,
    ...
    OpenSRM = 626,
    OpenStatus = 1213,
    ["OpenTelemetry Declarative Configuration"] = 623,
    ["OpenUtau character yaml"] = 616,
    ["OpenUtau ustx"] = 617,
    ["OpenWeather Current Weather API"] = 996,
    ["OpenWeather Road Risk API"] = 995,
    ["Ory Hydra configuration"] = 449,
    ["Ory Keto configuration"] = 509,
    ["Ory Kratos configuration"] = 631,
    ["Ory Oathkeeper configuration"] = 603,
    ["Outblocks App configuration"] = 628,
    ["Outblocks database table"] = 629,
    ["Outblocks project configuration"] = 627,
    PDM = 650,
    POPxf = 661,
    ["POPxf Correlations"] = 662,
    Packer = 647,
    PactSpec = 648,
    Pantsbuild = 1075,
    ["Paper paper-plugin.yml"] = 649,
    ["Pipeline component"] = 1008,
    ["Platform.sh application"] = 8,
    ["Platform.sh routes"] = 9,
    ["Platform.sh services"] = 10,
    ["Plex Prerolls"] = 659,
    ["PocketMine plugin.yml"] = 656,
    ["Postman collection"] = 665,
    ["Power Pages Configuration"] = 1214,
    ["Preset list for a WinUtil"] = 1159,
    ["ProActions AI-Kit Configuration"] = 676,
    ["ProActions AI-Kit Configuration for Menus"] = 678,
    ["ProActions AI-Kit Configuration for Sections"] = 680,
    ["ProActions AI-Kit Configuration for Services"] = 677,
    ["ProActions AI-Kit Configuration for Steps"] = 681,
    ["ProActions AI-Kit Configuration for Templates"] = 679,
    ["Problem object RFC9457"] = 1104,
    ["Problem package format"] = 682,
    ["Problem package generators"] = 683,
    ["Problem package submissions"] = 684,
    ["Problem package test group metadata"] = 685,
    Pterodactyl = 1054,
    ["Pull Request Labeler"] = 702,
    Pulumi = 710,
    ["PyGTA Config"] = 706,
    PyProject = 711,
    Pylock = 1205,
    Pyright = 712,
    ["Python script metadata"] = 1199,
    ["QType AI DSL"] = 715,
    Qgoda = 714,
    Qodana = 1027,
    ["Qt Creator workspace file"] = 1137,
    ["Quali Torque Blueprint Spec 2"] = 1052,
    ["QueryFirst config file"] = 1071,
    ["Qwen Code Settings"] = 1261,
    ["RKE Cluster Configuration JSON"] = 1005,
    ["RKE Cluster Configuration YAML"] = 1004,
    RadioHound = 705,
    ["Raid Profile"] = 1262,
    ["Raid Repo Configuration"] = 1263,
    Railpack = 717,
    Railway = 716,
    ["Rancher Fleet"] = 707,
    ["Rattler-build"] = 718,
    Ray = 968,
    ["Read the Docs"] = 709,
    ["Red-DiscordBot Cog"] = 725,
    ["Red-DiscordBot Cog Repo"] = 726,
    ["Red-DiscordBot Trivia"] = 727,
    ["Releasaurus Config"] = 5,
    ReleaseKit = 4,
    ["Render Blueprints"] = 1003,
    RenderCV = 744,
    Renovate = 741,
    ["Renovate global configuration"] = 742,
    ["Renovate inherited configuration"] = 743,
    ["Replit config"] = 733,
    Restate = 1192,
    ["Revel Digital Gadget Definition File"] = 1216,
    RoadRunner = 746,
    ["Robust Station Image"] = 1222,
    Rockcraft = 747,
    ["Roo Coder Custom Modes"] = 748,
    Rubocop = 737,
    ["Rudder techniques"] = 1111,
    Ruff = 738,
    ["Rust Project"] = 739,
    ["Rust toolchain"] = 753,
    ["SDMX data message"] = 780,
    ["SDMX metadata message"] = 779,
    ["SDMX structure message"] = 778,
    ["SIL Kit Participant Configuration"] = 790,
    ["SIL Kit Registry Configuration"] = 791,
    ["SPDX 2.3"] = 828,
    SWADL = 844,
    ["Safebox Config"] = 1066,
    ["Sapphire CLI Config"] = 756,
    ["SauceCTL Configuration"] = 1014,
    Scarb = 776,
    ["Schema Catalog"] = 771,
    ["Scoop manifest"] = 777,
    ["Semantic Data Fabric (SDF) file"] = 781,
    ["Semgrep Rule"] = 783,
    ["Serenity Code Generator (Sergen)"] = 784,
    ["Serverless Framework Configuration"] = 1021,
    ["Serverless Workflow"] = 1023,
    ["Settings for a Cinnamon spice"] = 1155,
    ["Settings.paf"] = 786,
    ["Shopware 6 Configuration"] = 1024,
    ["Shopware CLI Extension Store Configuration"] = 1025,
    ["Shopware CLI Project Store Configuration"] = 1026,
    ["Sigma Detection Rule"] = 788,
    ["Sigrid scope configuration file"] = 789,
    ["SkyPilot Task JSON"] = 1112,
    ["Slack app manifest"] = 793,
    Snapcraft = 795,
    Solidarity = 798,
    ["Solution filters"] = 799,
    ["Source Maps v3"] = 800,
    Sourcery = 801,
    ["Spack bootstrap.yaml"] = 802,
    ["Spack cdash.yaml"] = 803,
    ["Spack ci.yaml"] = 804,
    ["Spack compilers.yaml"] = 805,
    ["Spack concretizer.yaml"] = 806,
    ["Spack config.yaml"] = 807,
    ["Spack definitions.yaml"] = 808,
    ["Spack develop.yaml"] = 809,
    ["Spack env_vars.yaml"] = 810,
    ["Spack environment"] = 816,
    ["Spack include.yaml"] = 811,
    ["Spack mirrors.yaml"] = 812,
    ["Spack modules.yaml"] = 813,
    ["Spack packages.yaml"] = 814,
    ["Spack repos.yaml"] = 815,
    ["Spack toolchains.yaml"] = 817,
    ["Spack upstreams.yaml"] = 818,
    ["Spack view.yaml"] = 819,
    ["Speakeasy Generation Config File"] = 823,
    ["Speakeasy Lint Configuration File"] = 820,
    ["Speakeasy Test Generation Configuration File"] = 821,
    ["Speakeasy Workflow File"] = 822,
    SpecIF = 824,
    ["Specmatic Configuration"] = 825,
    ["Sponge Mixin configuration"] = 826,
    StackBlitz = 832,
    ["StackHawk Scanner Configuration"] = 1020,
    Stale = 833,
    Starfish = 834,
    ["Starlake Data Pipeline"] = 993,
    Starship = 835,
    ["Statamic Blueprint"] = 836,
    ["Stella configuration file"] = 837,
    ["Streamlit configuration file"] = 838,
    ["Stryker Mutator"] = 841,
    ["StyleCop Analyzers Configuration"] = 842,
    ["Stylelint (.stylelintrc)"] = 843,
    ["Stylua Config"] = 1206,
    ["Sublime Syntax"] = 1067,
    ["Subsquid squid manifest"] = 1114,
    ["Swagger API 2.0"] = 845,
    ["Synadia Connect Component"] = 846,
    TSON = 882,
    TSTyche = 883,
    ["TYPO3 Vendor Bundler config"] = 889,
    ["Tab data for a LinUtil"] = 1162,
    ["Tab list for a LinUtil"] = 1161,
    Tach = 847,
    ["Tach Domain"] = 848,
    Talhelper = 850,
    ["Talisman configuration"] = 851,
    Taplo = 1207,
    ["Taskfile config"] = 998,
    Taurus = 852,
    Tauticord = 853,
    ["Tekton Pipeline"] = 1235,
    ["Tekton PipelineRun"] = 1236,
    ["Tekton Task"] = 1233,
    ["Tekton TaskRun"] = 1234,
    Telefonistka = 1193,
    ["Terrateam config"] = 1219,
    ["TestEnvironment.json"] = 865,
    ["TextMate Grammar"] = 864,
    Threagile = 859,
    ["Tier.run pricing.json"] = 856,
    Tikibase = 857,
    Tombi = 862,
    ["Traefik v2"] = 868,
    ["Traefik v2 File Provider"] = 869,
    ["Traefik v3"] = 870,
    ["Traefik v3 File Provider"] = 871,
    ["Travis CI (.travis.yml)"] = 867,
    Treefmt = 427,
    Trident = 1189,
    ["TrueScript for *.tscript files"] = 874,
    ["Tugboat QA config.yml"] = 1186,
    TunnelHub = 1102,
    Turborepo = 866,
    Tycho = 1151,
    Tye = 1028,
    ["Tyk Gateway - Open Source v5.7+"] = 1198,
    ["UET BuildConfig.json"] = 1072,
    ["UI5 Manifest"] = 895,
    ["UNCORS configuration"] = 899,
    ["UTAM Page Object"] = 898,
    ["Ubuntu Server Autoinstall"] = 893,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1190,
    ["Uniswap Token List"] = 980,
    ["Universal Schedule Format"] = 900,
    ["Unreal Engine Uplugin"] = 1073,
    ["Unreal Engine Uproject"] = 1074,
    ["UpCloud CLI (upctl) configuration"] = 1191,
    ["Updatecli Compose"] = 1036,
    ["Updatecli Policy Manifest"] = 1037,
    ["Updatecli Policy Metadata"] = 1038,
    Uplift = 1070,
    ["Upsun config"] = 7,
    ["User Journey Map"] = 1002,
    V2Ray = 1042,
    ["VSCode Code Snippets"] = 254,
    ["VSIX CLI publishing"] = 918,
    Vector = 902,
    ["Vela Pipeline Configuration"] = 905,
    Vercel = 253,
    ["Version Bumper config"] = 908,
    Vespertide = 1240,
    ["Vespertide Migration"] = 1241,
    ["Vespertide Model"] = 1242,
    ["Viash Component Config"] = 1195,
    ["Viash Package Config"] = 1196,
    Visivo = 1100,
    ["WP-CLI"] = 928,
    Wake = 1188,
    ["Waku Config"] = 1165,
    ["Web App Manifest"] = 924,
    ["Web types"] = 927,
    WebExtensions = 923,
    ["Webman package recipe"] = 1048,
    ["Windows Package Manager Installer Manifest"] = 976,
    ["Windows Package Manager Locale Manifest"] = 977,
    ["Windows Package Manager Singleton Manifest"] = 975,
    Winutil = 978,
    ["WireMock CLI import configuration"] = 1171,
    ["WireMock CLI local service configuration"] = 1170,
    ["WireMock message stub mapping"] = 1169,
    ["WireMock stub mapping"] = 1168,
    ["Woodpecker pipeline config"] = 1016,
    ["Wrangler CLI"] = 929,
    ["Xstate Machine"] = 1034,
    ["Yandex Workflow Language"] = 1157,
    ["Yarn Config (.yarnrc.yml)"] = 991,
    ["Yippee-Ki-JSON configuration YML"] = 982,
    ["YouTrack App"] = 1154,
    ["Zarf Package Configuration"] = 1221,
    ["Zerops.io config"] = 1142,
    ["Zerops.io import"] = 1143,
    ["Zola Configuration"] = 1232,
    ["aerleon.yml"] = 20,
    ["amplify.yml"] = 13,
    ["angular.json"] = 37,
    apko = 1105,
    ...
    ["bamboo-spec"] = 127,
    basedpyright = 125,
    ["bashly-strings.yml"] = 1082,
    ["batect.yml"] = 126,
    ["beef-database-codegen"] = 128,
    ["beef-database-v5-codegen"] = 130,
    ["beef-entity-codegen"] = 129,
    ["beef-entity-v5-codegen"] = 131,
    ["behat.yml"] = 143,
    ["bigquery-table"] = 132,
    ["bioimageio resource description"] = 1122,
    ["bitbucket-pipelines"] = 134,
    bitrise = 135,
    ["bitrise-step"] = 136,
    ["block.json"] = 159,
    ...
    ["bozr.suite.json"] = 146,
    bpkg = 1083,
    ["browser.i18n.json"] = 147,
    ["browsh configuration"] = 148,
    bucklescript = 149,
    ["buf.gen.yaml"] = 88,
    ["buf.lock"] = 89,
    ["buf.plugin.yaml"] = 90,
    ...
    ["build-changelog"] = 150,
    ["bun.lock"] = 155,
    ["bundleconfig.json"] = 156,
    ["bunfig.toml"] = 157,
    ["cargo-mutants-config.yaml"] = 93,
    ["ccmod.json"] = 1166,
    changelogging = 1134,
    ["chisel-slices.json"] = 280,
    ["chrome-extension-locales-messages.json"] = 261,
    ["chutzpah.json"] = 262,
    cibuildwheel = 179,
    ["clang-format (.clang-format)"] = 1040,
    ["clang-tidy"] = 240,
    clangd = 239,
    clib = 241,
    ["cloud-init: cloud-config userdata"] = 243,
    ["cloud-sdk-pipeline-configuration"] = 264,
    ["cloudbuild.json"] = 265,
    cloudify = 242,
    cmakefmt = 197,
    ["cmdx.yaml"] = 96,
    ...
    ["coffeelint.json"] = 282,
    ["commands.json"] = 257,
    ["commitlint (.commitlintrc)"] = 979,
    ["committed.toml"] = 283,
    ["compile_commands.json"] = 256,
    ["compilerconfig.json"] = 255,
    ["completely.yml"] = 1078,
    ["component-detection-manifest.json"] = 286,
    ["component.json"] = 285,
    ["composer.json"] = 284,
    ["conda-forge"] = 183,
    ["config.yaml"] = 708,
    ["contentmanifest.json"] = 263,
    ["contribute.json"] = 287,
    ["cosmos.config.json"] = 259,
    ["crowdin.yml"] = 288,
    ["ctfd-setup configuration file"] = 1178,
    ["custom-elements.json"] = 1092,
    ["cypress.json"] = 292,
    ["datalogic-scan2deploy-android"] = 302,
    ["datalogic-scan2deploy-ce"] = 303,
    ["dbt Dependencies"] = 204,
    ["dbt Packages"] = 206,
    ["dbt Project"] = 205,
    ["dbt Selectors"] = 207,
    ["dbt YAML files"] = 208,
    ...
    ["ddev-global"] = 304,
    ["ddev-project"] = 305,
    ["debugsettings.json"] = 306,
    ["dependabot-v2.json"] = 309,
    ["dependabot.json"] = 308,
    ["deployed-cli"] = 1033,
    ["devcontainer.json"] = 247,
    devinit = 984,
    ["devspace.yaml"] = 1056,
    djlint = 985,
    ["docker bake"] = 315,
    ["docker sequencer"] = 316,
    ["docker-compose.yml"] = 983,
    ["dockerd.json"] = 313,
    ["dotnet Release Index manifest"] = 328,
    ["dotnet-tools.json"] = 329,
    ["dotnetcli.host.json"] = 330,
    ["dprint.json"] = 331,
    ["drone.json"] = 332,
    ["dss-2.0.0.json"] = 334,
    ["dstack configuration"] = 335,
    ["dtool dataset metadata"] = 1173,
    ["dvc.yaml"] = 336,
    ["ecosystem.json"] = 341,
    eksctl = 343,
    ["electron-builder configuration file"] = 350,
    ["epr-manifest.json"] = 349,
    ["estampo.toml"] = 348,
    ["evcc.yaml"] = 351,
    ["ezd task runner"] = 362,
    ["fabric.mod.json"] = 364,
    ["first-timers-bot"] = 372,
    ["flagd flag configuration"] = 118,
    ["fly.io Configuration"] = 119,
    fulibWorkflows = 1015,
    ["function.json"] = 384,
    ["gRPC API Gateway & OpenAPI Config"] = 15,
    ["gematik health care insurance list"] = 1184,
    ["gematik health care patient list"] = 1181,
    ["gematik health care provider institution list"] = 1183,
    ["gematik health care provider list"] = 1182,
    ["gematik tiger test environment configuration"] = 1185,
    ["git-town.toml"] = 1230,
    ["gitlab-ci"] = 402,
    ["global.json"] = 418,
    ["go-feature-flag Flag Configuration"] = 421,
    ["haxelib.json"] = 439,
    helmfile = 971,
    helmwave = 972,
    ["host-meta.json"] = 446,
    ...
    ["ide.host.json"] = 454,
    ["ifstate.yaml"] = 455,
    ["imageoptimizer.json"] = 456,
    ["importmap.json"] = 459,
    instant_python_config = 461,
    instant_python_custom_project = 462,
    ["ioBroker Configuration"] = 463,
    ["ioBroker JSON UI"] = 464,
    ["ioBroker Package manifest"] = 465,
    ["ixpect.conf.yaml"] = 466,
    ["ize.toml"] = 1069,
    ["jsconfig.json"] = 491,
    ["jscpd Configuration"] = 1053,
    jsdoc = 967,
    ["k3d.yaml"] = 492,
    ["k9s aliases.yaml"] = 494,
    ["k9s cluster-config.yaml"] = 496,
    ["k9s config.yaml"] = 495,
    ["k9s hotkeys.yaml"] = 497,
    ["k9s plugins.yaml"] = 498,
    ["k9s skin.yaml"] = 499,
    ["k9s views.yaml"] = 500,
    ["kontinuous-config.yaml"] = 512,
    ["kontinuous-values.yaml"] = 511,
    ["kustomization.yaml"] = 514,
    ["label-commenter-config.yml"] = 515,
    ["latexindent configuration"] = 111,
    ["launchsettings.json"] = 516,
    lazydocker = 1091,
    lazygit = 1090,
    ["lego.json"] = 518,
    ["lerna.json"] = 519,
    ["lgtm.yml"] = 520,
    ["liblab.config.json"] = 521,
    ["libman.json"] = 522,
    ["license-report-config.json"] = 523,
    ["linkinator.config.json"] = 525,
    ["lint-staged (.lintstagedrc)"] = 945,
    ["local.settings.json"] = 530,
    ["localazy.json"] = 531,
    ["lotus.yaml"] = 529,
    ["lsdlschema.json"] = 532,
    ["macro.json"] = 1057,
    ["markdown-link-check"] = 1011,
    maturin = 1012,
    mboats = 1019,
    ["micro-settings.json"] = 1084,
    ["mimetypes.json"] = 547,
    ["mirrord config"] = 947,
    mise = 948,
    ["mkdocs.yml"] = 567,
    ...
    ["monospace.yml"] = 572,
    ["moon.yml"] = 1167,
    ["mprocs Configuration file"] = 1138,
    ["mrdocs.yml"] = 569,
    ["mta.yaml"] = 949,
    ["mtad.yaml"] = 950,
    ["mycode.json"] = 579,
    nFPM = 586,
    ["napari plugin manifest"] = 580,
    neoload = 962,
    ["nest-cli"] = 589,
    ["nexus-rpc-gen"] = 1257,
    ["ninjs (News in JSON)"] = 588,
    ["nitro.json"] = 961,
    ["nixd configuration"] = 1110,
    ["nlu.json"] = 590,
    ["nodemon.json"] = 592,
    ["noodl config"] = 1018,
    ["notebook.mod.json"] = 593,
    now = 957,
    ["npm-badges"] = 596,
    ["nswag.json"] = 600,
    ntangle = 602,
    ["nuclei-template.yaml"] = 597,
    ["nuget-project.json"] = 598,
    ["ocelot.json"] = 604,
    ogen = 607,
    ["omnisharp.json"] = 610,
    openHAB = 1243,
    ...
    oxlint = 1254,
    ["package.json"] = 644,
    ["package.manifest"] = 646,
    ["package.yaml"] = 645,
    ["partial-black.json"] = 144,
    ["partial-fastapi.json"] = 145,
    ["partial-pixi.json"] = 654,
    ["pattern.json"] = 652,
    ["petstore-v1.0"] = 1064,
    pgap_yaml_input_reader = 651,
    pgxgen = 1247,
    pitcms = 1250,
    ["pixi.toml"] = 653,
    ["plagiarize-me.yaml"] = 658,
    ["plagiarize.yaml"] = 657,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1174,
    ["podbard.yaml"] = 660,
    ["portman.json"] = 663,
    ["prefect.toml"] = 671,
    ["prefect.yaml"] = 672,
    ...
    ["prettierrc.json"] = 674,
    ["prisma.yml"] = 675,
    ["project-1.0.0-beta3.json"] = 687,
    ["project-1.0.0-beta4.json"] = 688,
    ["project-1.0.0-beta5.json"] = 689,
    ["project-1.0.0-beta6.json"] = 690,
    ["project-1.0.0-beta8.json"] = 691,
    ["project-1.0.0-rc1.json"] = 692,
    ["project-1.0.0-rc2.json"] = 693,
    ["project.json"] = 686,
    ["project.owasp.yaml"] = 694,
    ["prometheus-alertmanager.json"] = 698,
    ["prometheus.json"] = 695,
    ["prometheus.rules.json"] = 696,
    ["prometheus.rules.test.json"] = 697,
    ["proxies.json"] = 699,
    ["publiccode.yml"] = 700,
    ["pubspec.yaml"] = 701,
    ["pyrseas-0.8.json"] = 704,
    pytest = 713,
    ["quilt.mod.json"] = 1085,
    ["rc3 auth"] = 719,
    ["rc3 collection"] = 720,
    ...
    ["release drafter"] = 963,
    ["release-hub.json"] = 3,
    ["release-please-config.json"] = 729,
    ["release-please-manifest.json"] = 730,
    ["release-plz.toml"] = 731,
    ["renv.lock"] = 745,
    ["reposets Configuration"] = 734,
    ["reposets Credentials"] = 735,
    ["revola.json"] = 1,
    ["rivet.json"] = 1109,
    ["rivet.yaml (legacy)"] = 1108,
    rumdl = 750,
    runny = 749,
    rustfmt = 751,
    ryl = 752,
    ...
    samt = 754,
    samtrc = 755,
    ["sarif-1.0.0.json"] = 757,
    ["sarif-2.0.0.json"] = 758,
    ["sarif-2.1.0"] = 768,
    ["sarif-2.1.0-rtm.2"] = 759,
    ["sarif-2.1.0-rtm.3"] = 761,
    ["sarif-2.1.0-rtm.4"] = 763,
    ["sarif-2.1.0-rtm.5"] = 765,
    ["sarif-2.1.0-rtm.6"] = 766,
    ["sarif-external-property-file-2.1.0"] = 769,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 760,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 762,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 764,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 767,
    ["scalingo.json configuration"] = 770,
    ["schema.org - Action"] = 772,
    ["schema.org - ContactPoint"] = 773,
    ["schema.org - Place"] = 774,
    ["schema.org - Thing"] = 775,
    ["secrethub.yml"] = 1087,
    ["semantic-release"] = 782,
    ["servicehub.config.json"] = 940,
    ["servicehub.service.json"] = 939,
    ["settings.job"] = 785,
    ["sfdx-hardis configuration"] = 787,
    ["shard.yml"] = 1125,
    ["size-limit configuration"] = 792,
    ["skaffold.yaml"] = 1009,
    ["skyuxconfig.json"] = 794,
    ["snowflake-config"] = 796,
    ["snowflake-connections"] = 797,
    ["spicepod.yaml"] = 1146,
    ["sqlc configuration"] = 829,
    ["stripe-app-local.json"] = 840,
    ["stripe-app.json"] = 839,
    swcrc = 994,
    ["task.json"] = 849,
    taskcat = 958,
    ["template.json"] = 854,
    ["templatsources.json"] = 855,
    ["text2confl config"] = 1255,
    ["theme.json"] = 858,
    ["tizen_workspace.json"] = 860,
    tldr = 861,
    ["tm_devices configuration file"] = 1212,
    tmuxinator = 943,
    tox = 863,
    ["transcend.yml"] = 872,
    ["tree-sitter grammar.json"] = 426,
    ["trime.yaml"] = 873,
    ["trunk.yaml"] = 875,
    ["ts-force-config.json"] = 880,
    ["tsconfig.json"] = 876,
    ["tsd.json"] = 877,
    ["tsdoc.json"] = 878,
    ["tsdrc.json"] = 879,
    ...
    v8r = 922,
    vcluster = 1132,
    ["vcpkg configuration file"] = 252,
    ["vcpkg manifest file"] = 251,
    ["vega-lite.json"] = 904,
    ["vega.json"] = 903,
    ["venvironment.yaml"] = 906,
    ["venvplus.yaml"] = 907,
    version = 1194,
    ["version.json"] = 909,
    ["vhwdebugger-binding.yaml"] = 911,
    ["vim-addon-info"] = 912,
    ["vs-2017.3.host.json"] = 914,
    ["vs-nesting.json"] = 915,
    ["vsls.json"] = 913,
    ["vss-extension.json"] = 919,
    vtcfg = 1200,
    ["vtesttree.yaml"] = 920,
    ["vtestunit.yaml"] = 921,
    ["warp-keysets.json"] = 1093,
    ["warp-themes.json"] = 1094,
    ["warp-workflows.json"] = 1095,
    ["webhint.io"] = 1049,
    ["webjobpublishsettings.json"] = 926,
    ["webjobs-list.json"] = 925,
    ["well-known-fursona"] = 1133,
    ["xs-app.json"] = 953,
    ["xunit.runner.json"] = 938,
    yamllint = 981,
    zizmor = 1237,
    zuul = 964,
    ["Žinoma"] = 974
