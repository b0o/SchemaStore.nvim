...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 96,
    [".cryproj (generic)"] = 390,
    [".cryproj engine-5.2"] = 385,
    [".cryproj engine-5.3"] = 386,
    [".cryproj engine-5.4"] = 387,
    [".cryproj engine-5.5"] = 388,
    [".cryproj engine-dev"] = 389,
    [".csscomb.json"] = 98,
    [".csslintrc"] = 99,
    [".eslintrc"] = 133,
    [".esmrc.json"] = 126,
    ...
    ["Better Code Hub"] = 430,
    BizTalkServerApplicationSchema = 402,
    Briefcase = 407,
    Buildkite = 53,
    ...
    Goreleaser = 158,
    ["Goreleaser Pro"] = 159,
    ["Gradle Build Cache Node"] = 427,
    ["Gradle Enterprise"] = 426,
    ...
    ["JSON Feed"] = 194,
    ["JSON Resume"] = 291,
    ["JSON Schema Draft 2020-12"] = 381,
    ["JSON Schema Draft 4"] = 378,
    ["JSON Schema Draft 7"] = 379,
    ["JSON Schema Draft 8"] = 380,
    ...
    ["Netin Diagnostic System Template"] = 449,
    ["Netlify config schema"] = 232,
    ["Nightwatch.js"] = 233,
    ["OSS Review Toolkit repository configuration"] = 253,
    Opctl = 398,
    ["OpenWeather Current Weather API"] = 434,
    ["OpenWeather Road Risk API"] = 433,
    ...
    ["SauceCTL Configuration"] = 446,
    ["Schema Catalog"] = 307,
    ["Scoop manifest"] = 312,
    ["Semgrep Rule"] = 313,
    ["Serverless Framework Configuration"] = 453,
    ["Shopware CLI Extension Store Configuration"] = 454,
    ["Shopware CLI Project Store Configuration"] = 455,
    Solidarity = 319,
    ["Source Maps v3"] = 320,
    SpecIF = 321,
    ["Sponge Mixin configuration"] = 322,
    ["StackHawk Scanner Configuration"] = 452,
    ["StackHead CLI config"] = 326,
    ["StackHead module configuration"] = 327,
    ["StackHead project definition"] = 328,
    Stale = 329,
    ["Statamic Blueprint"] = 330,
    ["Stryker Mutator"] = 331,
    ["StyleCop Analyzers Configuration"] = 332,
    ["Swagger API 2.0"] = 335,
    ["Taskfile YAML Schema"] = 436,
    Taurus = 336,
    ["TestEnvironment.json"] = 341,
    ["Traefik v2"] = 343,
    ["Traefik v2 File Provider"] = 344,
    ["UI5 Manifest"] = 355,
    ["Uniswap Token List"] = 419,
    ["User Journey Map YAML Schema"] = 439,
    ["VSCode Code Snippets"] = 75,
    ["VSIX CLI publishing"] = 367,
    ["Vela Pipeline Configuration"] = 359,
    Vercel = 74,
    ["Web App Manifest"] = 371,
    ["Web types"] = 374,
    WebExtensions = 370,
    ["Windows Package Manager Installer Manifest"] = 416,
    ["Windows Package Manager Locale Manifest"] = 417,
    ...
    ["servicehub.config.json"] = 384,
    ["servicehub.service.json"] = 383,
    ["settings.job"] = 314,
    ...
    taskcat = 401,
    ["template.json"] = 337,
    ["templatsources.json"] = 338,
    ["theme.json"] = 339,
    tmLanguage = 340,
    ["trunk.yaml schema"] = 345,
    ["ts-force-config.json"] = 349,
    ["tsconfig.json"] = 346,
    ["tsd.json"] = 347,
    ["tsdrc.json"] = 348,
    ["tslint.json"] = 350,
    ...
    ["version.json"] = 360,
    ["vim-addon-info"] = 361,
    ["vs-2017.3.host.json"] = 363,
    ["vs-nesting.json"] = 364,
    ["vsls.json"] = 362,
    ["vss-extension.json"] = 368,
    ["webjobpublishsettings.json"] = 373,
    ["webjobs-list.json"] = 372,
    ["xs-app.json"] = 397,
