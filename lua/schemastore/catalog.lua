...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 911,
    [".nodehawkrc"] = 562,
    [".npmpackagejsonlintrc"] = 566,
    [".omletrc"] = 1090,
    [".phrase.yml"] = 636,
    [".phraseapp.yml"] = 637,
    [".pmbot.yml"] = 622,
    [".postcssrc"] = 631,
    [".powerpages-web-template-manifest"] = 633,
    [".pre-commit-config.yml"] = 634,
    [".pre-commit-hooks.yml"] = 635,
    [".putout.json"] = 669,
    [".rehyperc"] = 694,
    [".remarkrc"] = 698,
    [".sprite files"] = 788,
    ...
    ["@factorial/drupal-breakpoints-css"] = 13,
    ["A micro editor config"] = 510,
    ABCInventoryModuleData = 21,
    ABCSupplyPlan = 22,
    ["ACP Attempts"] = 23,
    ["ACP Cache File"] = 24,
    ["ACP Configuration File"] = 25,
    ["ACP Primer"] = 26,
    ["ACP Sync"] = 27,
    ["ACP Variables File"] = 28,
    AIConfig = 29,
    ["AMX Muse Program Descriptor"] = 1138,
    ["API Builder"] = 946,
    ["AVA Configuration"] = 1009,
    ["AWS AppConfig Feature Flags-v1"] = 63,
    ["AWS CDK cdk.json"] = 248,
    ["AWS CloudFormation"] = 249,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 250,
    ["AWS Copilot Manifest"] = 1177,
    ["AWS SAM CLI Samconfig"] = 251,
    ["Adobe UXP Manifest"] = 1072,
    ["Aerleon Network & Service Definitions"] = 16,
    ["Aerleon Policy"] = 17,
    Aider = 1167,
    Air = 19,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1188,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1187,
    ["Airlock Microgateway"] = 30,
    ["Alacritty Configuration"] = 981,
    ["All Contributors configuration file"] = 1035,
    ["Ansible Argument Specs"] = 383,
    ["Ansible Collection Galaxy"] = 390,
    ["Ansible Execution Environment"] = 380,
    ["Ansible Inventory"] = 389,
    ["Ansible Meta"] = 381,
    ["Ansible Meta Runtime"] = 382,
    ["Ansible Navigator Configuration"] = 392,
    ["Ansible Playbook"] = 387,
    ["Ansible Requirements"] = 384,
    ["Ansible Rulebook"] = 388,
    ["Ansible Tasks File"] = 386,
    ["Ansible Vars File"] = 385,
    ["Ansible-lint Configuration"] = 391,
    Any = 1100,
    ["AnyWork Automation Configuration"] = 12,
    ["Apollo Router"] = 947,
    ["App config Spotify Backstage"] = 34,
    ["Application Accelerator"] = 9,
    ["Application list for a WinUtil"] = 1117,
    ArchitectFX = 1122,
    ["Argo CD"] = 49,
    ["Argo Events"] = 50,
    ["Argo Workflows"] = 51,
    AssemblyScript = 54,
    AsyncAPI = 57,
    ["AsyncAPI Tool File"] = 58,
    ["Atmos Manifests"] = 59,
    ["Aurora Agile Meta-Framework"] = 60,
    AutoAPICase = 1045,
    ["Avro Avsc"] = 61,
    ["Awesome Repositories"] = 62,
    ["Azure Container App template for defining an immutable revision"] = 64,
    ["Azure DevOps extension manifest"] = 67,
    ["Azure Device Update for IoT Hub import manifest"] = 65,
    ["Azure Device Update for IoT Hub update manifest"] = 66,
    ["Azure IoT Edge deployment"] = 70,
    ["Azure IoT Edge deployment template"] = 71,
    ["Azure IoT EdgeAgent deployment"] = 68,
    ["Azure IoT EdgeHub deployment"] = 69,
    ["Azure IoT Operations Wasm Graph Config"] = 1186,
    ["Azure IoT Operations connector metadata"] = 1183,
    ["Azure Landing Zones Library archetype definition"] = 75,
    ["Azure Landing Zones Library archetype override"] = 76,
    ["Azure Landing Zones Library architecture definition"] = 74,
    ["Azure Landing Zones Library metadata"] = 72,
    ["Azure Landing Zones Library policy default values"] = 73,
    ["Azure Pipelines"] = 105,
    ["Azure Static Web Apps CLI configuration file"] = 792,
    ["Azure Static Web Apps configuration file"] = 791,
    ["BOSH CPI Config"] = 129,
    ["BOSH Deploy Config"] = 130,
    ["BX CI"] = 149,
    ["Bacon config"] = 3,
    ["Bashly (bashly.yml)"] = 1039,
    ["Bashly Settings (bashly-settings.yml)"] = 1040,
    Bento = 1204,
    ["Better Code Hub"] = 951,
    ["Better Scripts"] = 150,
    Bigconfig = 122,
    ["Biome Formatter Config"] = 77,
    ["Bitmovin Encoding Template"] = 1131,
    BizTalkServerApplicationSchema = 918,
    Bleep = 151,
    ["Block Protocol Metadata"] = 148,
    ["Boyka Framework"] = 131,
    Briefcase = 924,
    ["Build Info"] = 139,
    Buildkite = 141,
    ["Bukkit plugin.yml"] = 140,
    ["BungeeCord plugin.yml"] = 146,
    ["Butane Config"] = 994,
    C4InterFlow = 1146,
    ["CDK Environment Manager, concrete environment configuration"] = 1170,
    ["CDK Environment Manager, concrete environments definition"] = 1169,
    ["CDK Environment Manager, environment definition"] = 1168,
    ["CGS Card Game Specification (cgs.json)"] = 1077,
    ["CICS TS region tagging"] = 1003,
    ["CICS TS resource import"] = 1004,
    ["CICS TS resource model"] = 1005,
    ["CICS TS resource overrides"] = 1006,
    ["CMake Presets"] = 152,
    ["CNC Codes"] = 173,
    ["CRS WAF test file"] = 1107,
    ["CRS WAF test platform overrides file"] = 1108,
    ["CSS Comb (.csscomb.json)"] = 276,
    ["CSS Lint (.csslintrc)"] = 277,
    ["CSpell (cspell.json)"] = 275,
    ["CVE Record Format"] = 181,
    CWL = 1083,
    ["Cache Warmup config"] = 153,
    ["Calqulus pipeline"] = 154,
    ["Camel YAML DSL"] = 155,
    ["Cannon TOML"] = 156,
    Carafe = 157,
    ["Cargo Make"] = 159,
    ["Cargo Manifest"] = 158,
    ["Catalog Info Backstage"] = 160,
    ["Chamaleon environment"] = 1135,
    ["Chamaleon properties"] = 1136,
    ["Chamaleon template"] = 1134,
    Changepacks = 1197,
    Changesets = 260,
    Changie = 161,
    Charmcraft = 162,
    Cheatsheets = 991,
    ["ChordPro Configuration"] = 163,
    ["Chrome Extension"] = 241,
    ["Chromia Model"] = 164,
    ["Chromia Seeder Module Config"] = 166,
    ["Chromia Seeder Root Config"] = 165,
    ["Cinnamon Spice info.json"] = 85,
    ["CircleCI config.yml"] = 216,
    ["Citation File Format"] = 262,
    CityJSON = 168,
    ["Claude Code Settings"] = 180,
    ["Clawject config"] = 179,
    ["Cloud Foundry Application Manifest"] = 1089,
    ["Cloud Run Spec v1"] = 1112,
    ["Cloud.gov Workshop Configuration"] = 86,
    ["CloudCannon Configuration"] = 91,
    ["CloudCannon Configuration (Collection Structures)"] = 100,
    ["CloudCannon Configuration (Collections)"] = 99,
    ["CloudCannon Configuration (Editables)"] = 98,
    ["CloudCannon Configuration (Inputs)"] = 93,
    ["CloudCannon Configuration (Snippets Definitions)"] = 97,
    ["CloudCannon Configuration (Snippets Imports)"] = 96,
    ["CloudCannon Configuration (Snippets)"] = 95,
    ["CloudCannon Configuration (Structure Value)"] = 94,
    ["CloudCannon Configuration (Structures)"] = 92,
    ["CloudEvents specification"] = 169,
    ["Code Climate"] = 217,
    CodeCV = 89,
    CodeRabbit = 88,
    ["CodeShip Pro services configuration files"] = 230,
    ["CodeShip Pro steps configuration files"] = 231,
    ["Codecov configuration files"] = 229,
    Codex = 225,
    CodifyCLI = 90,
    Codux = 227,
    ["Cog config file"] = 174,
    ["Commandbox Box.json"] = 175,
    ["Commandbox Server.json"] = 176,
    ["Common Catalog Data"] = 239,
    ["Common Package Specification"] = 177,
    Concord = 1106,
    ["Configu .cfgu files"] = 1094,
    ["Configu .configu file"] = 1095,
    Conjure = 172,
    ["Container Structure Test"] = 932,
    Containerlab = 960,
    ["Contextive Glossary"] = 1162,
    Convex = 171,
    ["Crowdsec collection config"] = 270,
    ["Crowdsec parser config"] = 271,
    ["Crowdsec scenario config"] = 272,
    ["CumulusCI Config"] = 178,
    ["Custom Machinery Machine"] = 1078,
    ["Custom Machinery Recipe"] = 1079,
    ["Cycle Stack File"] = 182,
    CycloneDX = 183,
    ["DWP Exchange - catalogue entry"] = 319,
    ["DWP Exchange - gateway"] = 317,
    ["DWP Exchange - meta"] = 318,
    ["Dart Build Config (dart-build.json)"] = 278,
    ["Dart Test Config (dart-test.json)"] = 279,
    ["DashLord Configuration"] = 280,
    ["Data Contract Specification"] = 281,
    ["Data Product Specification"] = 282,
    ["DataYoga Connections"] = 184,
    ["DataYoga Job"] = 185,
    ["Databricks Asset Bundles"] = 1056,
    ["Datadog Continuous Testing"] = 481,
    ["Datadog Service Definition"] = 482,
    ["Datadog Software Catalog"] = 483,
    ["Datahub Ingestion Recipe"] = 1010,
    ["Debian Upstream Metadata file"] = 191,
    ["Deck config"] = 192,
    ["Dein Config"] = 193,
    ["Deno Config (deno.json)"] = 288,
    ["Dependency cruiser"] = 194,
    ["DeployStack Configuration"] = 195,
    ["Deployah Configuration"] = 1185,
    ["Deployer Recipe"] = 291,
    ["Deta Spacefile"] = 196,
    ["Detekt Config (detekt.yml)"] = 292,
    ["Devbox Config"] = 197,
    ["Devbox Plugin"] = 198,
    Devfile = 316,
    Devup = 1198,
    DipDup = 1109,
    ["Discord Webhook"] = 293,
    ["DocFx Config (docfx.json)"] = 297,
    Dofigen = 298,
    ["Dolittle Artifacts"] = 299,
    ["Dolittle Bounded Context Configuration"] = 300,
    ["Dolittle Event Horizons Configuration"] = 301,
    ["Dolittle Resources Configuration"] = 302,
    ["Dolittle Server Configuration"] = 303,
    ["Dolittle Tenant Map Configuration"] = 305,
    ["Dolittle Tenants Configuration"] = 304,
    ["Dolittle Topology"] = 306,
    ["DonateCaseBetterCasino menu"] = 1139,
    ["Drupal Breakpoints"] = 199,
    ["Drupal Config"] = 211,
    ["Drupal Info"] = 200,
    ["Drupal Layouts"] = 201,
    ["Drupal Libraries"] = 202,
    ["Drupal Links Action"] = 203,
    ["Drupal Links Contextual"] = 204,
    ["Drupal Links Menu"] = 205,
    ["Drupal Links Task"] = 206,
    ["Drupal Migration"] = 207,
    ["Drupal Permissions"] = 208,
    ["Drupal Recipe"] = 209,
    ["Drupal Routing"] = 210,
    ["Drupal Services"] = 212,
    ["Drush site aliases"] = 312,
    ["Dynamic Bash Aliases (.aliases)"] = 1047,
    ["EAS config"] = 336,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1036,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1182,
    ["EasyVCR .NET"] = 337,
    ["Eidolon Resource"] = 1123,
    ["Elgato Stream Deck"] = 322,
    Elm = 1111,
    ["Embrace Config"] = 1022,
    Endurica = 1060,
    ["Enterprise Contract Policy Spec"] = 323,
    ["Erda Pipeline"] = 1085,
    ["Erda Runtime"] = 1086,
    ["Espanso config.yml"] = 1207,
    ["Espanso match.yml"] = 1206,
    Esquio = 325,
    ["Estuary Flow Catalog"] = 1000,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 329,
    ["EveryVoice TTS Toolkit Data Configuration"] = 330,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 334,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 333,
    ["EveryVoice TTS Toolkit Text Configuration"] = 331,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 332,
    ["Evolving Resolutive Process notation"] = 1184,
    ["Expo SDK"] = 335,
    ["F-Droid Data metadata"] = 341,
    ["FasterCI Configuration"] = 106,
    FiQuS = 345,
    Firebase = 343,
    ["FlexGet Config"] = 346,
    ["Flow.json Configurations"] = 1082,
    ["Fossa configuration file"] = 353,
    ["Fossa's fossa-deps file"] = 354,
    ["Foundry VTT - Base package Manifest"] = 348,
    ["Foundry VTT - Module Manifest"] = 349,
    ["Foundry VTT - System Data Template"] = 352,
    ["Foundry VTT - System Manifest"] = 350,
    ["Foundry VTT - World Manifest"] = 351,
    ["Foxx Manifest"] = 107,
    ["Freifunk.de Community API"] = 110,
    ["Frogbot Config"] = 111,
    ["G2P Mapping Configuration"] = 360,
    ["GCP Blueprint Metadata"] = 363,
    Gaspar = 361,
    ["GatewayCore API Gateway"] = 362,
    ["Gemini CLI settings"] = 364,
    ["GeoJSON.json latest"] = 998,
    GherKing = 1002,
    ["GitHub Action"] = 369,
    ["GitHub Actions typing"] = 1119,
    ["GitHub Discussion"] = 370,
    ["GitHub Funding"] = 371,
    ["GitHub Issue Template configuration"] = 372,
    ["GitHub Issue Template forms"] = 373,
    ["GitHub Workflow"] = 374,
    ["GitHub Workflow Template Properties"] = 375,
    ["GitHub automatically generated release notes configuration"] = 376,
    ["GitLab Agent for Kubernetes configuration"] = 1074,
    GitVersion = 366,
    ["Gitea Issue Template configuration"] = 367,
    ["Gitea Issue Template forms"] = 368,
    ["Gitpod Automations"] = 378,
    ["Gitpod Configuration"] = 379,
    ["GlazeWM settings"] = 1076,
    ["Global Privacy Control"] = 365,
    Goblet = 1055,
    ["Golangci-lint Configuration"] = 394,
    ["Golangci-lint Custom Plugins Configuration"] = 395,
    ["Google Chrome Related Website Sets"] = 344,
    ["Google Cloud Workflows"] = 247,
    ["Google Digital Assetlinks"] = 1163,
    Goreleaser = 397,
    ["Goreleaser Pro"] = 398,
    Goss = 399,
    ["Gradle Build Cache Node"] = 949,
    ["Gradle Enterprise"] = 948,
    ["Grafana 5.x Dashboard"] = 400,
    ["GraphQL Code Generator"] = 405,
    ["GraphQL Config"] = 404,
    ["GraphQL Mesh"] = 403,
    ["GroovyLint configuration"] = 406,
    ["Grunt JSHint task"] = 410,
    ["Grunt Watch task"] = 411,
    ["Grunt base task"] = 412,
    ["Grunt clean task"] = 408,
    ["Grunt copy task"] = 407,
    ["Grunt cssmin task"] = 409,
    HEMTT = 914,
    Hadolint = 928,
    Hammerkit = 959,
    ["Hardware Sentry Configuration"] = 1014,
    ["HashiCorp Vault"] = 413,
    Hatch = 929,
    Hayson = 415,
    ["Haystack Pipeline"] = 416,
    ["Hazelcast 5 Configuration"] = 417,
    ["Hecate Input Schema"] = 1174,
    ["Helm Chart.lock"] = 214,
    ["Helm Chart.yaml"] = 213,
    ["Helm Unittest Test Suite"] = 215,
    ["Home Assistant Integration Manifest"] = 418,
    ["Homer dashboard configuration"] = 419,
    Hugo = 990,
    ["Hugo Theme"] = 989,
    ["Hulak Configuration"] = 426,
    ["Hyperfoil benchmark configuration"] = 425,
    ["IBM Zapp document"] = 427,
    ["IBM zCodeFormatSettings"] = 428,
    ["IMG Catapult PSP"] = 433,
    ["IVMS101 by CODE Protocol"] = 1075,
    Infrahub = 435,
    Istanbul = 1018,
    ["JDownloader2 crawler multi-rules"] = 448,
    ["JDownloader2 crawler single-rules"] = 447,
    ["JFrog Applications Config"] = 449,
    ["JFrog File Spec"] = 450,
    ["JFrog Pipelines YML DSL"] = 1024,
    ["JMeter DSL cli config"] = 451,
    JReleaser = 454,
    ["JSON Document Transform"] = 462,
    ["JSON Feed"] = 463,
    ["JSON Resume"] = 704,
    ["JSON Schema Draft 2020-12"] = 896,
    ["JSON Schema Draft 4"] = 893,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1057,
    ["JSON Schema Draft 7"] = 894,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1058,
    ["JSON Schema Draft 8 (2019-09)"] = 895,
    ["JSON-API"] = 461,
    ["JSON-e templates"] = 956,
    ["JSON-stat 2.0"] = 889,
    JSONPatch = 465,
    ["JSR Package Config (jsr.json)"] = 455,
    Jarl = 1190,
    Jasmine = 442,
    Jekyll = 443,
    ["Jenkins X Pipelines"] = 444,
    ["Jenkins X Requirements"] = 445,
    Jest = 446,
    Jocker = 452,
    ["Jovo Language Models"] = 453,
    ["Jujutsu (jj) VCS config"] = 1176,
    ["KIMMDY config file"] = 476,
    ["KODE/CI build.yaml"] = 1020,
    ["KSP-AVC"] = 890,
    ["KSP-CKAN"] = 891,
    ["KSP-NetKAN"] = 892,
    KSY = 1087,
    KSail = 358,
    ["KYA Manifest"] = 1088,
    ["Karakum configuration file"] = 355,
    Kas = 468,
    ["Kestra flow file"] = 477,
    ["Keycloak REST API"] = 1027,
    ["Knative Functions - func.yaml"] = 356,
    Knip = 357,
    ["Kometa (nightly) config file"] = 479,
    ["Kometa config file"] = 478,
    ["Kong DBLess config"] = 1021,
    KrakenD = 480,
    ["Kubri Configuration"] = 487,
    LOOBin = 502,
    ["Lake configuration file"] = 1179,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 252,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 253,
    ["Landing Zone Accelerator on AWS - Global Config"] = 254,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 255,
    ["Landing Zone Accelerator on AWS - Network Config"] = 256,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 257,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 258,
    ["Landing Zone Accelerator on AWS - Security Config"] = 259,
    ["Lando (landofile)"] = 101,
    ["LangGraph Platform configuration"] = 1099,
    ["Language configuration"] = 1098,
    Lefthook = 491,
    ["Liferay client-extension.yaml"] = 498,
    ["LinkML Metamodel"] = 500,
    Liquibase = 965,
    ["Liquibase Flow File"] = 966,
    ["Lively Properties"] = 501,
    ["Lobe AI Agent"] = 103,
    Loki = 104,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 542,
    ["MS2Rescore Configuration"] = 545,
    ["Madness (madness.yml)"] = 1038,
    ["Mado configuration"] = 508,
    ["MapEHR Mapping"] = 509,
    Markdownlint = 969,
    ["Mason Registry"] = 972,
    ["MegaLinter Custom Flavor"] = 512,
    ["MegaLinter configuration"] = 511,
    ["MegaLinter descriptor"] = 513,
    Melange = 1065,
    ["Meltano project definition"] = 514,
    ["Mergify Configuration"] = 546,
    ["Metadata for a Bazel module"] = 515,
    ["Metadata for a Cinnamon spice"] = 1115,
    ["Metatype Configuration"] = 516,
    ["MetricsHub Configuration"] = 517,
    ["MetricsHub Connector Configuration"] = 518,
    ["Micro Editor Syntax"] = 1048,
    ["Microsoft Band Web Tile"] = 519,
    ["Microsoft RulesEngine workflow rules"] = 1103,
    ["Microsoft RulesEngine workflow rules list"] = 1104,
    ["Minecraft Custom Main Menu Mod"] = 1066,
    ["Minecraft Data Pack Advancement"] = 521,
    ["Minecraft Data Pack Biome"] = 522,
    ["Minecraft Data Pack Configured Carver"] = 523,
    ["Minecraft Data Pack Damage Type"] = 524,
    ["Minecraft Data Pack Dimension"] = 526,
    ["Minecraft Data Pack Dimension Type"] = 525,
    ["Minecraft Data Pack Item Modifier"] = 527,
    ["Minecraft Data Pack Loot Table"] = 528,
    ["Minecraft Data Pack Metadata"] = 529,
    ["Minecraft Data Pack Predicate"] = 530,
    ["Minecraft Data Pack Recipe"] = 531,
    ["Minecraft Data Pack Tag"] = 532,
    ["Minecraft Data Pack Template Pool"] = 533,
    ["Minecraft Data Pack Trim Material"] = 538,
    ["Minecraft Data Pack Trim Pattern"] = 539,
    ["Minecraft Resource Pack Lang"] = 534,
    ["Minecraft Resource Pack Particle"] = 535,
    ["Minecraft Resource Pack Texture Mcmeta"] = 537,
    ["Minecraft Resourcepack Sounds"] = 536,
    ["Monade CLI Stack Configuration"] = 549,
    ["MongoDB Atlas Search Index Definition"] = 1019,
    ["Monika Configuration"] = 1017,
    ["Monoweave Configuration"] = 544,
    ["Motif config"] = 910,
    MultiQC = 1156,
    ["NOX Framework (Service)"] = 565,
    ["Netin Diagnostic System Template"] = 976,
    ["Netlify config"] = 552,
    ["Network-as-Code Data Model"] = 553,
    ["Next Gen UI Agent A2A Server Configuration"] = 554,
    ["Next Gen UI Agent Configuration"] = 556,
    ["Next Gen UI Agent MCP Server Configuration"] = 555,
    ["Nightwatch.js"] = 558,
    ["Node.js configuration"] = 915,
    ["NueJS configuration file"] = 570,
    ["Nuitka.yaml"] = 1080,
    ["Nullstone config"] = 572,
    ["ONe's changelog entry"] = 590,
    ["ONe's service descriptor"] = 589,
    ["ORT Server repository environment configuration"] = 598,
    ["OSCAL Assessment Plan (AP)"] = 600,
    ["OSCAL Assessment Results (AR)"] = 601,
    ["OSCAL Catalog"] = 602,
    ["OSCAL Component Definition (CDef)"] = 603,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 604,
    ["OSCAL Profile"] = 605,
    ["OSCAL System Security Plan (SSP)"] = 606,
    ["OSS Review Toolkit configuration"] = 607,
    ["OSS Review Toolkit curation"] = 608,
    ["OSS Review Toolkit package configuration"] = 609,
    ["OSS Review Toolkit repository configuration"] = 610,
    ["OSS Review Toolkit resolutions"] = 611,
    ["October CMS columns"] = 576,
    ["October CMS fields"] = 577,
    ["Oh My Posh"] = 578,
    Okteto = 579,
    ["Ona Automations"] = 581,
    Opctl = 913,
    ["Open Data Contract Standard (ODCS)"] = 593,
    ["Open Data Product Standard (ODPS)"] = 594,
    ["Open Know-How"] = 1161,
    ["OpenRewrite Resource"] = 592,
    OpenStatus = 1172,
    ["OpenUtau character yaml"] = 586,
    ["OpenUtau ustx"] = 587,
    ["OpenWeather Current Weather API"] = 955,
    ["OpenWeather Road Risk API"] = 954,
    ["Ory Hydra configuration"] = 424,
    ["Ory Keto configuration"] = 484,
    ["Ory Kratos configuration"] = 599,
    ["Ory Oathkeeper configuration"] = 574,
    ["Outblocks App configuration"] = 596,
    ["Outblocks database table"] = 597,
    ["Outblocks project configuration"] = 595,
    PDM = 618,
    POPxf = 628,
    ["POPxf Correlations"] = 629,
    Packer = 615,
    Pantsbuild = 1034,
    ["Paper paper-plugin.yml"] = 616,
    ["Pipeline component"] = 967,
    ["Platform.sh application"] = 5,
    ["Platform.sh routes"] = 6,
    ["Platform.sh services"] = 7,
    ["Plex Prerolls"] = 626,
    ["PocketMine plugin.yml"] = 623,
    ["Postman collection"] = 632,
    ["Power Pages Configuration"] = 1173,
    ["Preset list for a WinUtil"] = 1118,
    ["ProActions AI-Kit Configuration"] = 642,
    ["ProActions AI-Kit Configuration for Menus"] = 644,
    ["ProActions AI-Kit Configuration for Sections"] = 646,
    ["ProActions AI-Kit Configuration for Services"] = 643,
    ["ProActions AI-Kit Configuration for Steps"] = 647,
    ["ProActions AI-Kit Configuration for Templates"] = 645,
    ["Problem object RFC9457"] = 1063,
    ["Problem package format"] = 648,
    ["Problem package generators"] = 649,
    ["Problem package submissions"] = 650,
    ["Problem package test group metadata"] = 651,
    Pterodactyl = 1013,
    ["Pull Request Labeler"] = 668,
    Pulumi = 676,
    ["PyGTA Config"] = 672,
    PyProject = 677,
    Pylock = 1164,
    Pyright = 678,
    ["Python script metadata"] = 1158,
    ["QType AI DSL"] = 681,
    Qgoda = 680,
    Qodana = 986,
    ["Qt Creator workspace file"] = 1096,
    ["Quali Torque Blueprint Spec 2"] = 1011,
    ["QueryFirst config file"] = 1030,
    ["RKE Cluster Configuration JSON"] = 964,
    ["RKE Cluster Configuration YAML"] = 963,
    RadioHound = 671,
    Railpack = 683,
    Railway = 682,
    ["Rancher Fleet"] = 673,
    ...
    Ray = 927,
    ["Read the Docs"] = 675,
    ["Red-DiscordBot Cog"] = 691,
    ["Red-DiscordBot Cog Repo"] = 692,
    ["Red-DiscordBot Trivia"] = 693,
    ["Releasaurus Config"] = 2,
    ["Render Blueprints"] = 962,
    RenderCV = 707,
    Renovate = 705,
    ["Renovate global configuration"] = 706,
    ["Replit config"] = 699,
    Restate = 1151,
    ["Revel Digital Gadget Definition File"] = 1175,
    RoadRunner = 709,
    ["Robust Station Image"] = 1181,
    Rockcraft = 710,
    ["Roo Coder Custom Modes"] = 711,
    Rubocop = 701,
    ["Rudder techniques"] = 1070,
    Ruff = 702,
    ["Rust Project"] = 703,
    ["Rust toolchain"] = 715,
    ["SDMX data message"] = 741,
    ["SDMX metadata message"] = 740,
    ["SDMX structure message"] = 739,
    ["SIL Kit Participant Configuration"] = 751,
    ["SIL Kit Registry Configuration"] = 752,
    ["SPDX 2.3"] = 789,
    SWADL = 805,
    ["Safebox Config"] = 1025,
    ["Sapphire CLI Config"] = 718,
    ["SauceCTL Configuration"] = 973,
    ["Schema Catalog"] = 733,
    ["Scoop manifest"] = 738,
    ["Semantic Data Fabric (SDF) file"] = 742,
    ["Semgrep Rule"] = 744,
    ["Serenity Code Generator (Sergen)"] = 745,
    ["Serverless Framework Configuration"] = 980,
    ["Serverless Workflow"] = 982,
    ["Settings for a Cinnamon spice"] = 1114,
    ["Settings.paf"] = 747,
    ["Shopware 6 Configuration"] = 983,
    ["Shopware CLI Extension Store Configuration"] = 984,
    ["Shopware CLI Project Store Configuration"] = 985,
    ["Sigma Detection Rule"] = 749,
    ["Sigrid scope configuration file"] = 750,
    ["SkyPilot Task JSON"] = 1071,
    ["Slack app manifest"] = 754,
    Snapcraft = 756,
    Solidarity = 759,
    ["Solution filters"] = 760,
    ["Source Maps v3"] = 761,
    Sourcery = 762,
    ["Spack bootstrap.yaml"] = 763,
    ["Spack cdash.yaml"] = 764,
    ["Spack ci.yaml"] = 765,
    ["Spack compilers.yaml"] = 766,
    ["Spack concretizer.yaml"] = 767,
    ["Spack config.yaml"] = 768,
    ["Spack definitions.yaml"] = 769,
    ["Spack develop.yaml"] = 770,
    ["Spack env_vars.yaml"] = 771,
    ["Spack environment"] = 777,
    ["Spack include.yaml"] = 772,
    ["Spack mirrors.yaml"] = 773,
    ["Spack modules.yaml"] = 774,
    ["Spack packages.yaml"] = 775,
    ["Spack repos.yaml"] = 776,
    ["Spack toolchains.yaml"] = 778,
    ["Spack upstreams.yaml"] = 779,
    ["Spack view.yaml"] = 780,
    ["Speakeasy Generation Config File"] = 784,
    ["Speakeasy Lint Configuration File"] = 781,
    ["Speakeasy Test Generation Configuration File"] = 782,
    ["Speakeasy Workflow File"] = 783,
    SpecIF = 785,
    ["Specmatic Configuration"] = 786,
    ["Sponge Mixin configuration"] = 787,
    StackBlitz = 793,
    ["StackHawk Scanner Configuration"] = 979,
    Stale = 794,
    Starfish = 795,
    ["Starlake Data Pipeline"] = 952,
    Starship = 796,
    ["Statamic Blueprint"] = 797,
    ["Stella configuration file"] = 798,
    ["Streamlit configuration file"] = 799,
    ["Stryker Mutator"] = 802,
    ["StyleCop Analyzers Configuration"] = 803,
    ["Stylelint (.stylelintrc)"] = 804,
    ["Stylua Config"] = 1165,
    ["Sublime Syntax"] = 1026,
    ["Subsquid squid manifest"] = 1073,
    ["Swagger API 2.0"] = 806,
    ["Synadia Connect Component"] = 807,
    TSON = 842,
    TSTyche = 843,
    ["TYPO3 Vendor Bundler config"] = 848,
    ["Tab data for a LinUtil"] = 1121,
    ["Tab list for a LinUtil"] = 1120,
    Tach = 808,
    ["Tach Domain"] = 809,
    Talhelper = 811,
    ["Talisman configuration"] = 812,
    Taplo = 1166,
    ["Taskfile config"] = 957,
    Taurus = 813,
    Tauticord = 814,
    ["Tekton Pipeline"] = 1194,
    ["Tekton PipelineRun"] = 1195,
    ["Tekton Task"] = 1192,
    ["Tekton TaskRun"] = 1193,
    Telefonistka = 1152,
    ["Terrateam config"] = 1178,
    ["TestEnvironment.json"] = 825,
    ["TextMate Grammar"] = 824,
    Threagile = 820,
    ["Tier.run pricing.json"] = 817,
    Tikibase = 818,
    Tombi = 823,
    ["Traefik v2"] = 828,
    ["Traefik v2 File Provider"] = 829,
    ["Traefik v3"] = 830,
    ["Traefik v3 File Provider"] = 831,
    ["Travis CI (.travis.yml)"] = 827,
    Treefmt = 402,
    Trident = 1148,
    ["TrueScript for *.tscript files"] = 834,
    ["Tugboat QA config.yml"] = 1145,
    TunnelHub = 1061,
    Turborepo = 826,
    Tycho = 1110,
    Tye = 987,
    ["Tyk Gateway - Open Source v5.7+"] = 1157,
    ["UET BuildConfig.json"] = 1031,
    ["UI5 Manifest"] = 854,
    ["UNCORS configuration"] = 858,
    ["UTAM Page Object"] = 857,
    ["Ubuntu Server Autoinstall"] = 852,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1149,
    ["Uniswap Token List"] = 939,
    ["Universal Schedule Format"] = 859,
    ["Unreal Engine Uplugin"] = 1032,
    ["Unreal Engine Uproject"] = 1033,
    ["UpCloud CLI (upctl) configuration"] = 1150,
    ["Updatecli Compose"] = 995,
    ["Updatecli Policy Manifest"] = 996,
    ["Updatecli Policy Metadata"] = 997,
    Uplift = 1029,
    ["Upsun config"] = 4,
    ["User Journey Map"] = 961,
    V2Ray = 1001,
    ["VSCode Code Snippets"] = 235,
    ["VSIX CLI publishing"] = 877,
    Vector = 861,
    ["Vela Pipeline Configuration"] = 864,
    Vercel = 234,
    ["Version Bumper config"] = 867,
    Vespertide = 1199,
    ["Vespertide Migration"] = 1200,
    ["Vespertide Model"] = 1201,
    ["Viash Component Config"] = 1154,
    ["Viash Package Config"] = 1155,
    Visivo = 1059,
    ["WP-CLI"] = 887,
    Wake = 1147,
    ["Waku Config"] = 1124,
    ["Web App Manifest"] = 883,
    ["Web types"] = 886,
    WebExtensions = 882,
    ["Webman package recipe"] = 1007,
    ["Windows Package Manager Installer Manifest"] = 935,
    ["Windows Package Manager Locale Manifest"] = 936,
    ["Windows Package Manager Singleton Manifest"] = 934,
    Winutil = 937,
    ["WireMock CLI import configuration"] = 1130,
    ["WireMock CLI local service configuration"] = 1129,
    ["WireMock message stub mapping"] = 1128,
    ["WireMock stub mapping"] = 1127,
    ["Woodpecker pipeline config"] = 975,
    ["Wrangler CLI"] = 888,
    ["Xstate Machine"] = 993,
    ["Yandex Workflow Language"] = 1116,
    ["Yarn Config (.yarnrc.yml)"] = 950,
    ["Yippee-Ki-JSON configuration YML"] = 941,
    ["YouTrack App"] = 1113,
    ["Zarf Package Configuration"] = 1180,
    ["Zerops.io config"] = 1101,
    ["Zerops.io import"] = 1102,
    ["Zola Configuration"] = 1191,
    ["aerleon.yml"] = 15,
    ["angular.json"] = 31,
    apko = 1064,
    ["app-definition.yaml"] = 35,
    ["apple-app-site-association"] = 33,
    ["appsettings.StormPetrel.json"] = 40,
    ["appsettings.json"] = 38,
    ["appsscript.json"] = 37,
    ["appveyor.yml"] = 39,
    ["aqua-generate-registry.yaml"] = 42,
    ["aqua-policy.yaml"] = 43,
    ["aqua.yaml"] = 41,
    ["arazzo.json"] = 45,
    ["arb.json"] = 46,
    ["arc.json"] = 48,
    ["architect.yml"] = 47,
    ["artifacthub-repo.yml"] = 52,
    ["asm-lsp"] = 53,
    ["ast-grep rules"] = 56,
    ["ast-grep sgconfig.yml"] = 55,
    ["babelrc.json"] = 113,
    ["bamboo-spec"] = 116,
    ["bashly-strings.yml"] = 1041,
    ["batect.yml"] = 115,
    ["beef-database-codegen"] = 117,
    ["beef-database-v5-codegen"] = 119,
    ["beef-entity-codegen"] = 118,
    ["beef-entity-v5-codegen"] = 120,
    ["behat.yml"] = 132,
    ["bigquery-table"] = 121,
    ["bioimageio resource description"] = 1081,
    ["bitbucket-pipelines"] = 123,
    bitrise = 124,
    ["bitrise-step"] = 125,
    ["block.json"] = 147,
    ["bottom configuration"] = 78,
    ["bower.json"] = 127,
    ["bozr.suite.json"] = 134,
    bpkg = 1042,
    ["browser.i18n.json"] = 135,
    ["browsh configuration"] = 136,
    bucklescript = 137,
    ["buf.gen.yaml"] = 80,
    ["buf.lock"] = 81,
    ["buf.plugin.yaml"] = 82,
    ...
    ["build-changelog"] = 138,
    ["bun.lock"] = 143,
    ["bundleconfig.json"] = 144,
    ["bunfig.toml"] = 145,
    ["cargo-mutants-config.yaml"] = 84,
    ["ccmod.json"] = 1125,
    changelogging = 1093,
    ["chisel-slices.json"] = 261,
    ["chrome-extension-locales-messages.json"] = 242,
    ["chutzpah.json"] = 243,
    cibuildwheel = 167,
    ["clang-format (.clang-format)"] = 999,
    ["clang-tidy"] = 221,
    clangd = 220,
    clib = 222,
    ["cloud-init: cloud-config userdata"] = 224,
    ["cloud-sdk-pipeline-configuration"] = 245,
    ["cloudbuild.json"] = 246,
    cloudify = 223,
    ["cmdx.yaml"] = 87,
    codemagic = 226,
    ["coffeelint.json"] = 263,
    ["commands.json"] = 238,
    ["commitlint (.commitlintrc)"] = 938,
    ["committed.toml"] = 264,
    ["compile_commands.json"] = 237,
    ["compilerconfig.json"] = 236,
    ["completely.yml"] = 1037,
    ["component-detection-manifest.json"] = 267,
    ["component.json"] = 266,
    ["composer.json"] = 265,
    ["conda-forge"] = 170,
    ["config.yaml"] = 674,
    ["contentmanifest.json"] = 244,
    ["contribute.json"] = 268,
    ["cosmos.config.json"] = 240,
    ["crowdin.yml"] = 269,
    ["ctfd-setup configuration file"] = 1137,
    ["custom-elements.json"] = 1051,
    ["cypress.json"] = 273,
    ["datalogic-scan2deploy-android"] = 283,
    ["datalogic-scan2deploy-ce"] = 284,
    ["dbt Dependencies"] = 186,
    ["dbt Packages"] = 188,
    ["dbt Project"] = 187,
    ["dbt Selectors"] = 189,
    ["dbt YAML files"] = 190,
    ["ddev-global"] = 285,
    ["ddev-project"] = 286,
    ["debugsettings.json"] = 287,
    ["dependabot-v2.json"] = 290,
    ["dependabot.json"] = 289,
    ["deployed-cli"] = 992,
    ["devcontainer.json"] = 228,
    devinit = 943,
    ["devspace.yaml"] = 1015,
    djlint = 944,
    ["docker bake"] = 295,
    ["docker sequencer"] = 296,
    ["docker-compose.yml"] = 942,
    ["dockerd.json"] = 294,
    ["dotnet Release Index manifest"] = 307,
    ["dotnet-tools.json"] = 308,
    ["dotnetcli.host.json"] = 309,
    ["dprint.json"] = 310,
    ["drone.json"] = 311,
    ["dss-2.0.0.json"] = 313,
    ["dstack configuration"] = 314,
    ["dtool dataset metadata"] = 1132,
    ["dvc.yaml"] = 315,
    ["ecosystem.json"] = 320,
    eksctl = 321,
    ["electron-builder configuration file"] = 327,
    ["epr-manifest.json"] = 326,
    ["evcc.yaml"] = 328,
    ["ezd task runner"] = 338,
    ["fabric.mod.json"] = 340,
    ["first-timers-bot"] = 347,
    ["flagd flag configuration"] = 108,
    ["fly.io Configuration"] = 109,
    fulibWorkflows = 974,
    ["function.json"] = 359,
    ["gRPC API Gateway & OpenAPI Config"] = 10,
    ["gematik health care insurance list"] = 1143,
    ["gematik health care patient list"] = 1140,
    ["gematik health care provider institution list"] = 1142,
    ["gematik health care provider list"] = 1141,
    ["gematik tiger test environment configuration"] = 1144,
    ["git-town.toml"] = 1189,
    ["gitlab-ci"] = 377,
    ["global.json"] = 393,
    ["go-feature-flag Flag Configuration"] = 396,
    ["haxelib.json"] = 414,
    helmfile = 930,
    helmwave = 931,
    ["host-meta.json"] = 421,
    ...
    ["ide.host.json"] = 429,
    ["ifstate.yaml"] = 430,
    ["imageoptimizer.json"] = 431,
    ["importmap.json"] = 434,
    instant_python_config = 436,
    instant_python_custom_project = 437,
    ["ioBroker Configuration"] = 438,
    ["ioBroker JSON UI"] = 439,
    ["ioBroker Package manifest"] = 440,
    ["ixpect.conf.yaml"] = 441,
    ["ize.toml"] = 1028,
    ["jsconfig.json"] = 466,
    ["jscpd Configuration"] = 1012,
    jsdoc = 926,
    ["k3d.yaml"] = 467,
    ["k9s aliases.yaml"] = 469,
    ["k9s cluster-config.yaml"] = 471,
    ["k9s config.yaml"] = 470,
    ["k9s hotkeys.yaml"] = 472,
    ["k9s plugins.yaml"] = 473,
    ["k9s skin.yaml"] = 474,
    ["k9s views.yaml"] = 475,
    ["kontinuous-config.yaml"] = 486,
    ["kontinuous-values.yaml"] = 485,
    ["kustomization.yaml"] = 488,
    ["label-commenter-config.yml"] = 489,
    ["latexindent configuration"] = 102,
    ["launchsettings.json"] = 490,
    lazydocker = 1050,
    lazygit = 1049,
    ["lego.json"] = 492,
    ["lerna.json"] = 493,
    ["lgtm.yml"] = 494,
    ["liblab.config.json"] = 495,
    ["libman.json"] = 496,
    ["license-report-config.json"] = 497,
    ["linkinator.config.json"] = 499,
    ["lint-staged (.lintstagedrc)"] = 904,
    ["local.settings.json"] = 504,
    ["localazy.json"] = 505,
    ["lotus.yaml"] = 503,
    ["lsdlschema.json"] = 506,
    ["macro.json"] = 1016,
    ["markdown-link-check"] = 970,
    maturin = 971,
    mboats = 978,
    ["micro-settings.json"] = 1043,
    ["mimetypes.json"] = 520,
    ["mirrord config"] = 906,
    mise = 907,
    ["mkdocs.yml"] = 540,
    ["monospace.yml"] = 543,
    ["moon.yml"] = 1126,
    ["mprocs Configuration file"] = 1097,
    ["mrdocs.yml"] = 541,
    ["mta.yaml"] = 908,
    ["mtad.yaml"] = 909,
    ["mycode.json"] = 550,
    nFPM = 557,
    ["napari plugin manifest"] = 551,
    neoload = 921,
    ["nest-cli"] = 560,
    ["ninjs (News in JSON)"] = 559,
    ["nitro.json"] = 920,
    ["nixd configuration"] = 1069,
    ["nlu.json"] = 561,
    ["nodemon.json"] = 563,
    ["noodl config"] = 977,
    ["notebook.mod.json"] = 564,
    now = 916,
    ["npm-badges"] = 567,
    ["nswag.json"] = 571,
    ntangle = 573,
    ["nuclei-template.yaml"] = 568,
    ["nuget-project.json"] = 569,
    ["ocelot.json"] = 575,
    ["omnisharp.json"] = 580,
    openHAB = 1202,
    ["openapi.json"] = 582,
    ...
    ["overlay.json"] = 583,
    ["package.json"] = 612,
    ["package.manifest"] = 614,
    ["package.yaml"] = 613,
    ["partial-black.json"] = 133,
    ["pathfinder.yml"] = 617,
    ["pattern.json"] = 620,
    ["petstore-v1.0"] = 1023,
    pgap_yaml_input_reader = 619,
    pgxgen = 1205,
    ["pixi.toml"] = 621,
    ["plagiarize-me.yaml"] = 625,
    ["plagiarize.yaml"] = 624,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1133,
    ["podbard.yaml"] = 627,
    ["portman.json"] = 630,
    ["prefect.toml"] = 638,
    ["prefect.yaml"] = 639,
    ["prettierrc.json"] = 640,
    ["prisma.yml"] = 641,
    ["project-1.0.0-beta3.json"] = 653,
    ["project-1.0.0-beta4.json"] = 654,
    ["project-1.0.0-beta5.json"] = 655,
    ["project-1.0.0-beta6.json"] = 656,
    ["project-1.0.0-beta8.json"] = 657,
    ["project-1.0.0-rc1.json"] = 658,
    ["project-1.0.0-rc2.json"] = 659,
    ["project.json"] = 652,
    ["project.owasp.yaml"] = 660,
    ["prometheus-alertmanager.json"] = 664,
    ["prometheus.json"] = 661,
    ["prometheus.rules.json"] = 662,
    ["prometheus.rules.test.json"] = 663,
    ["proxies.json"] = 665,
    ["publiccode.yml"] = 666,
    ["pubspec.yaml"] = 667,
    ["pyrseas-0.8.json"] = 670,
    pytest = 679,
    ["quilt.mod.json"] = 1044,
    ["rc3 auth"] = 685,
    ["rc3 collection"] = 686,
    ...
    ["release drafter"] = 922,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 695,
    ["release-please-manifest.json"] = 696,
    ["release-plz.toml"] = 697,
    ["renv.lock"] = 708,
    ["rivet.json"] = 1068,
    ["rivet.yaml (legacy)"] = 1067,
    rumdl = 713,
    runny = 712,
    rustfmt = 714,
    sake = 1160,
    samt = 716,
    samtrc = 717,
    ["sarif-1.0.0.json"] = 719,
    ["sarif-2.0.0.json"] = 720,
    ["sarif-2.1.0"] = 730,
    ["sarif-2.1.0-rtm.2"] = 721,
    ["sarif-2.1.0-rtm.3"] = 723,
    ["sarif-2.1.0-rtm.4"] = 725,
    ["sarif-2.1.0-rtm.5"] = 727,
    ["sarif-2.1.0-rtm.6"] = 728,
    ["sarif-external-property-file-2.1.0"] = 731,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 722,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 724,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 726,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 729,
    ["scalingo.json configuration"] = 732,
    ["schema.org - Action"] = 734,
    ["schema.org - ContactPoint"] = 735,
    ["schema.org - Place"] = 736,
    ["schema.org - Thing"] = 737,
    ["secrethub.yml"] = 1046,
    ["semantic-release"] = 743,
    ["servicehub.config.json"] = 899,
    ["servicehub.service.json"] = 898,
    ["settings.job"] = 746,
    ["sfdx-hardis configuration"] = 748,
    ["shard.yml"] = 1084,
    ["size-limit configuration"] = 753,
    ["skaffold.yaml"] = 968,
    ["skyuxconfig.json"] = 755,
    ["snowflake-config"] = 757,
    ["snowflake-connections"] = 758,
    ["spicepod.yaml"] = 1105,
    ["sqlc configuration"] = 790,
    ["stripe-app-local.json"] = 801,
    ["stripe-app.json"] = 800,
    swcrc = 953,
    ["task.json"] = 810,
    taskcat = 917,
    ["template.json"] = 815,
    ["templatsources.json"] = 816,
    ["theme.json"] = 819,
    ["tizen_workspace.json"] = 821,
    tldr = 822,
    ["tm_devices configuration file"] = 1171,
    tmuxinator = 902,
    ["transcend.yml"] = 832,
    ["tree-sitter grammar.json"] = 401,
    ["trime.yaml"] = 833,
    ["trunk.yaml"] = 835,
    ["ts-force-config.json"] = 840,
    ["tsconfig.json"] = 836,
    ["tsd.json"] = 837,
    ["tsdoc.json"] = 838,
    ["tsdrc.json"] = 839,
    ...
    v8r = 881,
    vcluster = 1091,
    ["vcpkg configuration file"] = 233,
    ["vcpkg manifest file"] = 232,
    ["vega-lite.json"] = 863,
    ["vega.json"] = 862,
    ["venvironment.yaml"] = 865,
    ["venvplus.yaml"] = 866,
    version = 1153,
    ["version.json"] = 868,
    ["vhwdebugger-binding.yaml"] = 870,
    ["vim-addon-info"] = 871,
    ["vs-2017.3.host.json"] = 873,
    ["vs-nesting.json"] = 874,
    ["vsls.json"] = 872,
    ["vss-extension.json"] = 878,
    vtcfg = 1159,
    ["vtesttree.yaml"] = 879,
    ["vtestunit.yaml"] = 880,
    ["warp-keysets.json"] = 1052,
    ["warp-themes.json"] = 1053,
    ["warp-workflows.json"] = 1054,
    ["webhint.io"] = 1008,
    ["webjobpublishsettings.json"] = 885,
    ["webjobs-list.json"] = 884,
    ["well-known-fursona"] = 1092,
    ["xs-app.json"] = 912,
    ["xunit.runner.json"] = 897,
    yamllint = 940,
    zizmor = 1196,
    zuul = 923,
    ["Žinoma"] = 933
