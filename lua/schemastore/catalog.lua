...
M.json = {
  ...
  index = {
    ...
    ["CICS TS resource overrides"] = 508,
    ["CMake Presets"] = 68,
    ["CSR Framework"] = 76,
    ...
    ["Datahub Ingestion Recipe Schema"] = 512,
    Deno = 121,
    ["Deployer Recipe"] = 124,
    Devfile = 142,
    ["Discord Webhook"] = 126,
    ...
    Qodana = 493,
    ["Quali Torque Blueprint Spec 2"] = 513,
