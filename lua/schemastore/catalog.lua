...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 179,
    [".cryproj (generic)"] = 618,
    [".cryproj engine-5.2"] = 613,
    [".cryproj engine-5.3"] = 614,
    [".cryproj engine-5.4"] = 615,
    [".cryproj engine-5.5"] = 616,
    [".cryproj engine-dev"] = 617,
    [".csscomb.json"] = 181,
    [".csslintrc"] = 182,
    [".es6importsorterrc.json"] = 749,
    [".eslintrc"] = 231,
    [".esmrc.json"] = 223,
    [".ffizer.yaml"] = 235,
    [".htmlhintrc"] = 288,
    ...
    [".mtaext"] = 627,
    [".nodehawkrc"] = 391,
    [".npmpackagejsonlintrc"] = 394,
    [".phraseapp.yml"] = 438,
    [".pmbot.yml"] = 427,
    [".postcssrc"] = 433,
    [".powerpages-web-template-manifest"] = 435,
    [".pre-commit-config.yml"] = 436,
    [".pre-commit-hooks.yml"] = 437,
    [".putout.json"] = 457,
    [".rehyperc"] = 469,
    [".remarkrc"] = 471,
    [".sprite files"] = 526,
    ...
    ["<div>RIOTS' studio configuration"] = 597,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 350,
    ["API Builder"] = 659,
    ["AVA Configuration"] = 718,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 691,
    ["All Contributors configuration file"] = 748,
    ...
    ["Azure Pipelines"] = 59,
    ["Azure Static Web Apps CLI configuration file"] = 529,
    ["Azure Static Web Apps configuration file"] = 528,
    ["BX CI"] = 95,
    ["Better Code Hub"] = 663,
    ["Better Scripts"] = 96,
    Bigconfig = 76,
    BizTalkServerApplicationSchema = 633,
    Bleep = 97,
    ...
    ["Butane Config"] = 703,
    ["CICS TS region tagging"] = 712,
    ["CICS TS resource import"] = 713,
    ["CICS TS resource model"] = 714,
    ["CICS TS resource overrides"] = 715,
    ["CMake Presets"] = 98,
    ["CNC Codes"] = 108,
    ...
    ["Databricks Asset Bundles"] = 769,
    ["Datadog Service Definition"] = 328,
    ["Datahub Ingestion Recipe"] = 719,
    ["Dein Config"] = 113,
    Deno = 192,
    ["Deployer Recipe"] = 195,
    ["Deta Spacefile"] = 114,
    ...
    ["Goreleaser Pro"] = 270,
    Goss = 271,
    ["Gradle Build Cache Node"] = 661,
    ["Gradle Enterprise"] = 660,
    ...
    Hadolint = 642,
    Hammerkit = 670,
    ["Hardware Sentry Configuration"] = 723,
    Hatch = 643,
    Hayson = 283,
    ...
    ["JFrog File Spec"] = 308,
    ["JFrog Pipelines YML DSL"] = 732,
    ["JMeter DSL cli config"] = 309,
    JReleaser = 311,
    ["JSON Document Transform"] = 318,
    ["JSON Feed"] = 319,
    ["JSON Resume"] = 477,
    ["JSON Schema Draft 2020-12"] = 609,
    ["JSON Schema Draft 4"] = 606,
    ["JSON Schema Draft 7"] = 607,
    ["JSON Schema Draft 7 (unofficial strict)"] = 770,
    ["JSON Schema Draft 8 (2019-09)"] = 608,
    ["JSON-API"] = 317,
    ["JSON-e templates"] = 668,
    ["JSON-stat 2.0"] = 603,
    JSONPatch = 321,
    Jasmine = 301,
    Jekyll = 302,
    ...
    ["KIMMDY config file"] = 326,
    ["KSP-AVC"] = 604,
    ["KSP-CKAN"] = 605,
    ["Karakum configuration file"] = 247,
    Kas = 324,
    ["Keycloak REST API"] = 740,
    ["Knative Functions - func.yaml"] = 248,
    ["KoDE/CI build.yaml"] = 728,
    ["Kong DBLess config"] = 729,
    KrakenD = 327,
    LOOBin = 345,
    Lefthook = 335,
    ["Liferay client-extension.yaml"] = 341,
    ["LinkML Metamodel"] = 343,
    Liquibase = 675,
    ["Liquibase Flow File"] = 676,
    ["Lively Properties"] = 344,
    ["Lobe AI Agent"] = 58,
    ["MLOS Configs"] = 377,
    ["MS2Rescore Configuration"] = 379,
    Markdownlint = 679,
    ["Mason Registry"] = 681,
    ["MegaLinter configuration"] = 351,
    ["MegaLinter descriptor"] = 352,
    Melange = 776,
    ["Meltano plugin discovery definition"] = 354,
    ["Meltano project definition"] = 353,
    ["Microsoft Band Web Tile"] = 355,
    ["Minecraft Custom Main Menu Mod"] = 777,
    ["Minecraft Data Pack Advancement"] = 357,
    ["Minecraft Data Pack Biome"] = 358,
    ["Minecraft Data Pack Configured Carver"] = 359,
    ["Minecraft Data Pack Damage Type"] = 360,
    ["Minecraft Data Pack Dimension"] = 362,
    ["Minecraft Data Pack Dimension Type"] = 361,
    ["Minecraft Data Pack Item Modifier"] = 363,
    ["Minecraft Data Pack Loot Table"] = 364,
    ["Minecraft Data Pack Metadata"] = 365,
    ["Minecraft Data Pack Predicate"] = 366,
    ["Minecraft Data Pack Recipe"] = 367,
    ["Minecraft Data Pack Tag"] = 368,
    ["Minecraft Data Pack Template Pool"] = 369,
    ["Minecraft Data Pack Trim Material"] = 374,
    ["Minecraft Data Pack Trim Pattern"] = 375,
    ["Minecraft Resource Pack Lang"] = 370,
    ["Minecraft Resource Pack Particle"] = 371,
    ["Minecraft Resource Pack Texture Mcmeta"] = 373,
    ["Minecraft Resourcepack Sounds"] = 372,
    ["MkDocs Configuration 1.0"] = 376,
    ["MongoDB Atlas Search Index Definition"] = 727,
    ["Monika Configuration"] = 725,
    ["Motif config"] = 626,
    ["NOX Framework (Service)"] = 393,
    ["Netin Diagnostic System Template"] = 685,
    ["Netlify config"] = 384,
    ["Network-as-Code Data Model"] = 385,
    ["Nightwatch.js"] = 386,
    ["ONe's service descriptor"] = 408,
    ["OSS Review Toolkit configuration"] = 415,
    ["OSS Review Toolkit curation"] = 416,
    ["OSS Review Toolkit package configuration"] = 417,
    ["OSS Review Toolkit repository configuration"] = 418,
    ["OSS Review Toolkit resolutions"] = 419,
    Opctl = 629,
    ["OpenRewrite Resource"] = 410,
    ["OpenUtau character yaml"] = 405,
    ["OpenUtau ustx"] = 406,
    ["OpenWeather Current Weather API"] = 667,
    ["OpenWeather Road Risk API"] = 666,
    ["Ory Hydra configuration"] = 289,
    ["Ory Keto configuration"] = 329,
    ["Ory Kratos configuration"] = 414,
    ["Ory Oathkeeper configuration"] = 400,
    ["Outblocks App configuration"] = 412,
    ["Outblocks database table"] = 413,
    ["Outblocks project configuration"] = 411,
    Packer = 422,
    Pantsbuild = 747,
    ["Paper paper-plugin.yml"] = 423,
    ["Pipeline component"] = 677,
    ["PocketMine plugin.yml"] = 428,
    Poetry = 429,
    ["Postman collection"] = 434,
    ["Problem object RFC9457"] = 774,
    ["Problem package generators"] = 441,
    Pterodactyl = 722,
    ["Pull Request Labeler"] = 456,
    Pulumi = 462,
    PyProject = 463,
    Pyright = 464,
    Qgoda = 465,
    Qodana = 696,
    ["Quali Torque Blueprint Spec 2"] = 720,
    ["QueryFirst config file"] = 743,
    ["RKE Cluster Configuration JSON"] = 674,
    ["RKE Cluster Configuration YAML"] = 673,
    ["Rancher Fleet"] = 459,
    Ray = 641,
    ["Read the Docs"] = 461,
    ["Red-DiscordBot Cog"] = 466,
    ["Red-DiscordBot Cog Repo"] = 467,
    ["Red-DiscordBot Trivia"] = 468,
    RenderCV = 479,
    Renovate = 478,
    ["Replit config"] = 472,
    RoadRunner = 480,
    ...
    ["Rust Project"] = 476,
    ["Rust toolchain"] = 482,
    ["SIL Kit Participant Configuration"] = 514,
    ["SIL Kit Registry Configuration"] = 515,
    SWADL = 540,
    ["Safebox Config"] = 733,
    ["Sapphire CLI Config"] = 485,
    ["SauceCTL Configuration"] = 682,
    ["Schema Catalog"] = 499,
    ["Scoop manifest"] = 504,
    ["Semantic Data Fabric (SDF) file"] = 505,
    ["Semgrep Rule"] = 507,
    ["Serenity Code Generator (Sergen)"] = 508,
    ["Serverless Framework Configuration"] = 690,
    ["Serverless Workflow"] = 692,
    ["Settings.paf"] = 510,
    Setuptools = 511,
    ["Shopware 6 Configuration"] = 693,
    ["Shopware CLI Extension Store Configuration"] = 694,
    ["Shopware CLI Project Store Configuration"] = 695,
    ["Sigrid scope configuration file"] = 513,
    ["Slack app manifest"] = 517,
    Solidarity = 520,
    ["Solution filters"] = 521,
    ["Source Maps v3"] = 522,
    Sourcery = 523,
    SpecIF = 524,
    ["Sponge Mixin configuration"] = 525,
    StackBlitz = 530,
    ["StackHawk Scanner Configuration"] = 689,
    Stale = 531,
    ["Starlake Data Pipeline"] = 664,
    Starship = 532,
    ["Statamic Blueprint"] = 533,
    ["Stella configuration file"] = 534,
    ["StrmPrivacy Data Connector"] = 737,
    ["StrmPrivacy Data Contract"] = 738,
    ["StrmPrivacy SimpleSchema"] = 735,
    ["StrmPrivacy Stream"] = 736,
    ["StrmPrivacy batch job configuration file"] = 734,
    ["Stryker Mutator"] = 537,
    ["StyleCop Analyzers Configuration"] = 538,
    ["Sublime Syntax"] = 739,
    ["Swagger API 2.0"] = 541,
    TSON = 566,
    TSTyche = 567,
    Talhelper = 543,
    ["Talisman configuration"] = 544,
    ["Taskfile config"] = 669,
    Taurus = 545,
    ["TestEnvironment.json"] = 554,
    ["TextMate Grammar"] = 553,
    ["Tier.run pricing.json"] = 548,
    Tikibase = 549,
    ["Traefik v2"] = 557,
    ["Traefik v2 File Provider"] = 558,
    TunnelHub = 773,
    Turborepo = 555,
    Tye = 697,
    ["UET BuildConfig.json"] = 744,
    ["UI5 Manifest"] = 575,
    ["UNCORS configuration"] = 579,
    ["UTAM Page Object"] = 578,
    ["Ubuntu Server Autoinstall"] = 573,
    ["Uniswap Token List"] = 652,
    ["Unreal Engine Uplugin"] = 745,
    ["Unreal Engine Uproject"] = 746,
    ["Updatecli Compose"] = 704,
    ["Updatecli Policy Manifest"] = 705,
    ["Updatecli Policy Metadata"] = 706,
    Uplift = 742,
    ["User Journey Map"] = 672,
    V2Ray = 710,
    ["VSCode Code Snippets"] = 150,
    ["VSIX CLI publishing"] = 592,
    ["Vela Pipeline Configuration"] = 582,
    Vercel = 149,
    Visivo = 771,
    ["Web App Manifest"] = 599,
    ["Web types"] = 602,
    WebExtensions = 598,
    ["Webman package recipe"] = 716,
    ["Windows Package Manager Installer Manifest"] = 649,
    ["Windows Package Manager Locale Manifest"] = 650,
    ["Windows Package Manager Singleton Manifest"] = 648,
    ["Woodpecker pipeline config"] = 684,
    ["Xstate Machine"] = 702,
    ["Yippee-Ki-JSON configuration YML"] = 654,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    apko = 775,
    ...
    ["bamboo-spec"] = 70,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 753,
    ["bashly-strings.yml"] = 754,
    ["bashly.yml"] = 752,
    ["batect.yml"] = 69,
    ...
    ["ize.toml"] = 741,
    ["jsconfig.json"] = 322,
    ["jscpd Configuration"] = 721,
    jsdoc = 640,
    ["k3d.yaml"] = 323,
    ["k9s plugin.yml"] = 325,
    ["kontinuous-config.yaml"] = 331,
    ["kontinuous-values.yaml"] = 330,
    ["kustomization.yaml"] = 332,
    ["label-commenter-config.yml"] = 333,
    ["launchsettings.json"] = 334,
    lazydocker = 763,
    lazygit = 762,
    ["lego.json"] = 336,
    ["lerna.json"] = 337,
    ["lgtm.yml"] = 338,
    ["libman.json"] = 339,
    ["license-report-config.json"] = 340,
    ["linkinator.config.json"] = 342,
    ["local.settings.json"] = 347,
    ["localazy.json"] = 348,
    ["lotus.yaml"] = 346,
    ["lsdlschema.json"] = 349,
    ["madness.yml"] = 751,
    ["markdown-lint-check"] = 680,
    mboats = 687,
    ["micro-settings.json"] = 756,
    ["mimetypes.json"] = 356,
    ["mirrord config"] = 623,
    ["monospace.yml"] = 378,
    ["mta.yaml"] = 624,
    ["mtad.yaml"] = 625,
    ["mycode.json"] = 382,
    ["napari plugin manifest"] = 383,
    neoload = 635,
    ["nest-cli"] = 389,
    ["ninjs (News in JSON) 1.3"] = 388,
    ["ninjs (News in JSON) 2.0"] = 387,
    ["nlu.json"] = 390,
    ["nodemon.json"] = 392,
    ["noodl config"] = 686,
    now = 631,
    ...
    ["nswag.json"] = 398,
    ntangle = 399,
    ["nuclei-template.yaml"] = 396,
    ["nuget-project.json"] = 397,
    ["ocelot.json"] = 401,
    ["omnisharp.json"] = 402,
    ["openapi.json"] = 403,
    ["openfin.json"] = 409,
    ...
    ["ops.yaml"] = 407,
    ["package.json"] = 420,
    ["package.manifest"] = 421,
    ["pathfinder.yml"] = 424,
    ["pattern.json"] = 426,
    ["petstore-v1.0"] = 731,
    pgap_yaml_input_reader = 425,
    ["plagiarize-me.yaml"] = 431,
    ["plagiarize.yaml"] = 430,
    ["portman.json"] = 432,
    ["prettierrc.json"] = 439,
    ["prisma.yml"] = 440,
    ["project-1.0.0-beta3.json"] = 443,
    ["project-1.0.0-beta4.json"] = 444,
    ["project-1.0.0-beta5.json"] = 445,
    ["project-1.0.0-beta6.json"] = 446,
    ["project-1.0.0-beta8.json"] = 447,
    ["project-1.0.0-rc1.json"] = 448,
    ["project-1.0.0-rc2.json"] = 449,
    ["project.json"] = 442,
    ["prometheus.json"] = 450,
    ["prometheus.rules.json"] = 451,
    ["prometheus.rules.test.json"] = 452,
    ["proxies.json"] = 453,
    ["publiccode.yml"] = 454,
    ["pubspec.yaml"] = 455,
    ["pyrseas-0.8.json"] = 458,
    ["quilt.mod.json"] = 757,
    ["release drafter"] = 636,
    ["release-plz.toml"] = 470,
    rtx = 474,
    rustfmt = 481,
    samt = 483,
    samtrc = 484,
    ["sarif-1.0.0.json"] = 486,
    ["sarif-2.0.0.json"] = 487,
    ["sarif-2.1.0"] = 497,
    ["sarif-2.1.0-rtm.2"] = 488,
    ["sarif-2.1.0-rtm.3"] = 490,
    ["sarif-2.1.0-rtm.4"] = 492,
    ["sarif-2.1.0-rtm.5"] = 494,
    ["sarif-2.1.0-rtm.6"] = 495,
    ["sarif-external-property-file-2.1.0"] = 498,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 489,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 491,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 493,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 496,
    ["schema.org - Action"] = 500,
    ["schema.org - ContactPoint"] = 501,
    ["schema.org - Place"] = 502,
    ["schema.org - Thing"] = 503,
    ["scikit-build"] = 688,
    ["secrethub.yml"] = 759,
    ["semantic-release"] = 506,
    ["servicehub.config.json"] = 612,
    ["servicehub.service.json"] = 611,
    ["settings.job"] = 509,
    ["sfdx-hardis configuration"] = 512,
    ["size-limit configuration"] = 516,
    ["skaffold.yaml"] = 678,
    ["skyuxconfig.json"] = 518,
    snapcraft = 519,
    ["sqlc configuration"] = 527,
    ["stripe-app-local.json"] = 536,
    ["stripe-app.json"] = 535,
    swcrc = 665,
    syntax = 761,
    ["task.json"] = 542,
    taskcat = 632,
    ["template.json"] = 546,
    ["templatsources.json"] = 547,
    ["theme.json"] = 550,
    ["tizen_workspace.json"] = 551,
    tldr = 552,
    tmuxinator = 620,
    ["transcend.yml"] = 559,
    ["trunk.yaml"] = 560,
    ["ts-force-config.json"] = 564,
    ["tsconfig.json"] = 561,
    ["tsd.json"] = 562,
    ["tsdrc.json"] = 563,
    ["tslint.json"] = 565,
    ...
    ["vega-lite.json"] = 581,
    ["vega.json"] = 580,
    ["venvironment-basic.yaml"] = 584,
    ["venvironment.yaml"] = 583,
    ["version.json"] = 585,
    ["vim-addon-info"] = 586,
    ["vs-2017.3.host.json"] = 588,
    ["vs-nesting.json"] = 589,
    ["vsls.json"] = 587,
    ["vss-extension.json"] = 593,
    ["vtesttree.yaml"] = 594,
    ["vtestunit.yaml"] = 595,
    ["warp-keysets.json"] = 765,
    ["warp-themes.json"] = 766,
    ["warp-workflows.json"] = 767,
    ["webhint.io"] = 717,
    ["webjobpublishsettings.json"] = 601,
    ["webjobs-list.json"] = 600,
    ["xs-app.json"] = 628,
    ["xunit.runner.json"] = 610,
    yamllint = 653,
    zuul = 637,
    ["Žinoma"] = 647
  },
