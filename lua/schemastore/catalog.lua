...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 870,
    [".nodehawkrc"] = 531,
    [".npmpackagejsonlintrc"] = 535,
    [".omletrc"] = 1046,
    [".phrase.yml"] = 599,
    [".phraseapp.yml"] = 600,
    [".pmbot.yml"] = 587,
    [".postcssrc"] = 594,
    [".powerpages-web-template-manifest"] = 596,
    [".pre-commit-config.yml"] = 597,
    [".pre-commit-hooks.yml"] = 598,
    [".putout.json"] = 627,
    [".rehyperc"] = 651,
    [".remarkrc"] = 655,
    [".sprite files"] = 744,
    ...
    ["A micro editor config"] = 481,
    ABCInventoryModuleData = 18,
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1091,
    ["API Builder"] = 905,
    ["AVA Configuration"] = 967,
    ...
    ["AWS Copilot Manifest"] = 1130,
    ["AWS SAM CLI Samconfig"] = 226,
    ["Adobe UXP Manifest"] = 1029,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1120,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 939,
    ["All Contributors configuration file"] = 992,
    ["Ansible Argument Specs"] = 356,
    ["Ansible Collection Galaxy"] = 363,
    ["Ansible Execution Environment"] = 353,
    ["Ansible Inventory"] = 362,
    ["Ansible Meta"] = 354,
    ["Ansible Meta Runtime"] = 355,
    ["Ansible Navigator Configuration"] = 365,
    ["Ansible Playbook"] = 360,
    ["Ansible Requirements"] = 357,
    ["Ansible Rulebook"] = 361,
    ["Ansible Tasks File"] = 359,
    ["Ansible Vars File"] = 358,
    ["Ansible-lint Configuration"] = 364,
    Any = 1056,
    ["AnyWork Automation Configuration"] = 9,
    ["App config Spotify Backstage"] = 25,
    ["Application Accelerator"] = 6,
    ["Application list for a WinUtil"] = 1073,
    ArchitectFX = 1078,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1139,
    ["Azure IoT Operations connector metadata"] = 1136,
    ...
    ["Azure Pipelines"] = 81,
    ["Azure Static Web Apps CLI configuration file"] = 748,
    ["Azure Static Web Apps configuration file"] = 747,
    ["BOSH CPI Config"] = 105,
    ["BOSH Deploy Config"] = 106,
    ["BX CI"] = 125,
    ["Bashly (bashly.yml)"] = 996,
    ["Bashly Settings (bashly-settings.yml)"] = 997,
    ["Better Code Hub"] = 909,
    ["Better Scripts"] = 126,
    Bigconfig = 98,
    ["Biome Formatter Config"] = 65,
    ["Bitmovin Encoding Template"] = 1084,
    BizTalkServerApplicationSchema = 877,
    Bleep = 127,
    ...
    ["Butane Config"] = 952,
    C4InterFlow = 1099,
    ["CDK Environment Manager, concrete environment configuration"] = 1123,
    ["CDK Environment Manager, concrete environments definition"] = 1122,
    ["CDK Environment Manager, environment definition"] = 1121,
    ["CGS Card Game Specification (cgs.json)"] = 1034,
    ["CICS TS region tagging"] = 961,
    ["CICS TS resource import"] = 962,
    ["CICS TS resource model"] = 963,
    ["CICS TS resource overrides"] = 964,
    ["CMake Presets"] = 128,
    ["CNC Codes"] = 149,
    ["CRS WAF test file"] = 1063,
    ["CRS WAF test platform overrides file"] = 1064,
    ...
    ["Chamaleon environment"] = 1088,
    ["Chamaleon properties"] = 1089,
    ["Chamaleon template"] = 1087,
    Changesets = 235,
    Changie = 137,
    Charmcraft = 138,
    Cheatsheets = 949,
    ...
    ["Clawject config"] = 155,
    ["Cloud Foundry Application Manifest"] = 1045,
    ["Cloud Run Spec v1"] = 1068,
    ...
    Concord = 1062,
    ["Configu .cfgu files"] = 1050,
    ["Configu .configu file"] = 1051,
    Conjure = 148,
    ["Container Structure Test"] = 891,
    Containerlab = 918,
    ["Contextive Glossary"] = 1115,
    Convex = 147,
    ["Crowdsec collection config"] = 245,
    ["Crowdsec parser config"] = 246,
    ["Crowdsec scenario config"] = 247,
    ["CumulusCI Config"] = 154,
    ["Custom Machinery Machine"] = 1035,
    ["Custom Machinery Recipe"] = 1036,
    ...
    ["DataYoga Job"] = 161,
    ["Databricks Asset Bundles"] = 1013,
    ["Datadog Continuous Testing"] = 452,
    ["Datadog Service Definition"] = 453,
    ["Datadog Software Catalog"] = 454,
    ["Datahub Ingestion Recipe"] = 968,
    ...
    ["DonateCaseBetterCasino menu"] = 1092,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1004,
    ["EAS config"] = 311,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 993,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1135,
    ["EasyVCR .NET"] = 312,
    ["Eidolon Resource"] = 1079,
    ...
    ["Evolving Resolutive Process notation"] = 1137,
    ["Expo SDK"] = 310,
    ...
    ["Frogbot Config"] = 87,
    ["G2P Mapping Configuration"] = 334,
    ["GCP Blueprint Metadata"] = 337,
    Gaspar = 335,
    ["GatewayCore API Gateway"] = 336,
    ["GeoJSON.json latest"] = 956,
    GherKing = 960,
    ["GitHub Action"] = 342,
    ["GitHub Actions typing"] = 1075,
    ["GitHub Discussion"] = 343,
    ["GitHub Funding"] = 344,
    ["GitHub Issue Template configuration"] = 345,
    ["GitHub Issue Template forms"] = 346,
    ["GitHub Workflow"] = 347,
    ["GitHub Workflow Template Properties"] = 348,
    ["GitHub automatically generated release notes configuration"] = 349,
    ["GitLab Agent for Kubernetes configuration"] = 1031,
    GitVersion = 339,
    ["Gitea Issue Template configuration"] = 340,
    ["Gitea Issue Template forms"] = 341,
    ["Gitpod Automations"] = 351,
    ["Gitpod Configuration"] = 352,
    ["GlazeWM settings"] = 1033,
    ["Global Privacy Control"] = 338,
    Goblet = 1012,
    ["Golangci-lint Configuration"] = 367,
    ["Golangci-lint Custom Plugins Configuration"] = 368,
    ["Google Chrome Related Website Sets"] = 319,
    ["Google Cloud Workflows"] = 222,
    ["Google Digital Assetlinks"] = 1116,
    Goreleaser = 370,
    ["Goreleaser Pro"] = 371,
    Goss = 372,
    ["Gradle Build Cache Node"] = 907,
    ["Gradle Enterprise"] = 906,
    ["Grafana 5.x Dashboard"] = 373,
    ["GraphQL Code Generator"] = 378,
    ["GraphQL Config"] = 377,
    ["GraphQL Mesh"] = 376,
    ["Grunt JSHint task"] = 382,
    ["Grunt Watch task"] = 383,
    ["Grunt base task"] = 384,
    ["Grunt clean task"] = 380,
    ["Grunt copy task"] = 379,
    ["Grunt cssmin task"] = 381,
    HEMTT = 873,
    Hadolint = 887,
    Hammerkit = 917,
    ["Hardware Sentry Configuration"] = 972,
    ["HashiCorp Vault"] = 385,
    Hatch = 888,
    Hayagriva = 387,
    Hayson = 388,
    ["Haystack Pipeline"] = 389,
    ["Hazelcast 5 Configuration"] = 390,
    ["Hecate Input Schema"] = 1127,
    ["Helm Chart.lock"] = 190,
    ["Helm Chart.yaml"] = 189,
    ["Helm Unittest Test Suite"] = 191,
    ["Home Assistant Integration Manifest"] = 391,
    ["Homer dashboard configuration"] = 392,
    Hugo = 948,
    ["Hugo Theme"] = 947,
    ["Hulak Configuration"] = 399,
    ["Hyperfoil benchmark configuration"] = 398,
    ["IBM Zapp document"] = 400,
    ["IBM zCodeFormatSettings"] = 401,
    ["IMG Catapult PSP"] = 406,
    ["IVMS101 by CODE Protocol"] = 1032,
    Infrahub = 408,
    Istanbul = 975,
    ["JDownloader2 crawler multi-rules"] = 419,
    ["JDownloader2 crawler single-rules"] = 418,
    ["JFrog Applications Config"] = 420,
    ["JFrog File Spec"] = 421,
    ["JFrog Pipelines YML DSL"] = 981,
    ["JMeter DSL cli config"] = 422,
    JReleaser = 425,
    ["JSON Document Transform"] = 433,
    ["JSON Feed"] = 434,
    ["JSON Resume"] = 661,
    ["JSON Schema Draft 2020-12"] = 855,
    ["JSON Schema Draft 4"] = 852,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1014,
    ["JSON Schema Draft 7"] = 853,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1015,
    ["JSON Schema Draft 8 (2019-09)"] = 854,
    ["JSON-API"] = 432,
    ["JSON-e templates"] = 914,
    ["JSON-stat 2.0"] = 848,
    JSONPatch = 436,
    ["JSR Package Config (jsr.json)"] = 426,
    Jasmine = 413,
    Jekyll = 414,
    ["Jenkins X Pipelines"] = 415,
    ["Jenkins X Requirements"] = 416,
    Jest = 417,
    Jocker = 423,
    ["Jovo Language Models"] = 424,
    ["Jujutsu (jj) VCS config"] = 1129,
    ["KIMMDY config file"] = 447,
    ["KODE/CI build.yaml"] = 977,
    ["KSP-AVC"] = 849,
    ["KSP-CKAN"] = 850,
    ["KSP-NetKAN"] = 851,
    KSY = 1044,
    ...
    Kas = 439,
    ["Kestra flow file"] = 448,
    ["Keycloak REST API"] = 984,
    ["Knative Functions - func.yaml"] = 331,
    ["Kometa (nightly) config file"] = 450,
    ["Kometa config file"] = 449,
    ["Kong DBLess config"] = 978,
    KrakenD = 451,
    ["Kubri Configuration"] = 458,
    LOOBin = 473,
    ["Lake configuration file"] = 1132,
    ...
    ["Lando (landofile)"] = 77,
    ["LangGraph Platform configuration"] = 1055,
    ["Language configuration"] = 1054,
    Lefthook = 462,
    ["Liferay client-extension.yaml"] = 469,
    ["LinkML Metamodel"] = 471,
    Liquibase = 923,
    ["Liquibase Flow File"] = 924,
    ["Lively Properties"] = 472,
    ["Lobe AI Agent"] = 79,
    Loki = 80,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 513,
    ["MS2Rescore Configuration"] = 516,
    ["Madness (madness.yml)"] = 995,
    ["Mado configuration"] = 479,
    ["MapEHR Mapping"] = 480,
    Markdownlint = 927,
    ["Mason Registry"] = 930,
    ["MegaLinter Custom Flavor"] = 483,
    ["MegaLinter configuration"] = 482,
    ["MegaLinter descriptor"] = 484,
    Melange = 1022,
    ["Meltano project definition"] = 485,
    ["Mergify Configuration"] = 517,
    ["Metadata for a Bazel module"] = 486,
    ["Metadata for a Cinnamon spice"] = 1071,
    ["Metatype Configuration"] = 487,
    ["MetricsHub Configuration"] = 488,
    ["MetricsHub Connector Configuration"] = 489,
    ["Micro Editor Syntax"] = 1005,
    ["Microsoft Band Web Tile"] = 490,
    ["Microsoft RulesEngine workflow rules"] = 1059,
    ["Microsoft RulesEngine workflow rules list"] = 1060,
    ["Minecraft Custom Main Menu Mod"] = 1023,
    ["Minecraft Data Pack Advancement"] = 492,
    ["Minecraft Data Pack Biome"] = 493,
    ["Minecraft Data Pack Configured Carver"] = 494,
    ["Minecraft Data Pack Damage Type"] = 495,
    ["Minecraft Data Pack Dimension"] = 497,
    ["Minecraft Data Pack Dimension Type"] = 496,
    ["Minecraft Data Pack Item Modifier"] = 498,
    ["Minecraft Data Pack Loot Table"] = 499,
    ["Minecraft Data Pack Metadata"] = 500,
    ["Minecraft Data Pack Predicate"] = 501,
    ["Minecraft Data Pack Recipe"] = 502,
    ["Minecraft Data Pack Tag"] = 503,
    ["Minecraft Data Pack Template Pool"] = 504,
    ["Minecraft Data Pack Trim Material"] = 509,
    ["Minecraft Data Pack Trim Pattern"] = 510,
    ["Minecraft Resource Pack Lang"] = 505,
    ["Minecraft Resource Pack Particle"] = 506,
    ["Minecraft Resource Pack Texture Mcmeta"] = 508,
    ["Minecraft Resourcepack Sounds"] = 507,
    ["Monade CLI Stack Configuration"] = 520,
    ["MongoDB Atlas Search Index Definition"] = 976,
    ["Monika Configuration"] = 974,
    ["Monoweave Configuration"] = 515,
    ["Motif config"] = 869,
    MultiQC = 1109,
    ["NOX Framework (Service)"] = 534,
    ["Netin Diagnostic System Template"] = 934,
    ["Netlify config"] = 523,
    ["Network-as-Code Data Model"] = 524,
    ["Next Gen UI Agent Configuration"] = 525,
    ["Nightwatch.js"] = 527,
    ["Node.js configuration"] = 874,
    ["NueJS configuration file"] = 539,
    ["Nuitka.yaml"] = 1037,
    ["Nullstone config"] = 541,
    ["ONe's changelog entry"] = 556,
    ["ONe's service descriptor"] = 555,
    ["ORT Server repository environment configuration"] = 564,
    ["OSCAL Assessment Plan (AP)"] = 566,
    ["OSCAL Assessment Results (AR)"] = 567,
    ["OSCAL Catalog"] = 568,
    ["OSCAL Component Definition (CDef)"] = 569,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 570,
    ["OSCAL Profile"] = 571,
    ["OSCAL System Security Plan (SSP)"] = 572,
    ["OSS Review Toolkit configuration"] = 573,
    ["OSS Review Toolkit curation"] = 574,
    ["OSS Review Toolkit package configuration"] = 575,
    ["OSS Review Toolkit repository configuration"] = 576,
    ["OSS Review Toolkit resolutions"] = 577,
    ["October CMS columns"] = 545,
    ["October CMS fields"] = 546,
    Okteto = 547,
    ["Ona Automations"] = 549,
    Opctl = 872,
    ["Open Data Contract Standard (ODCS)"] = 559,
    ["Open Data Product Standard (ODPS)"] = 560,
    ["Open Know-How"] = 1114,
    ["OpenRewrite Resource"] = 558,
    OpenStatus = 1125,
    ["OpenUtau character yaml"] = 552,
    ["OpenUtau ustx"] = 553,
    ["OpenWeather Current Weather API"] = 913,
    ["OpenWeather Road Risk API"] = 912,
    ["Ory Hydra configuration"] = 397,
    ["Ory Keto configuration"] = 455,
    ["Ory Kratos configuration"] = 565,
    ["Ory Oathkeeper configuration"] = 543,
    ["Outblocks App configuration"] = 562,
    ["Outblocks database table"] = 563,
    ["Outblocks project configuration"] = 561,
    PDM = 583,
    Packer = 580,
    Pantsbuild = 991,
    ["Paper paper-plugin.yml"] = 581,
    ["Pipeline component"] = 925,
    ["Platform.sh application"] = 2,
    ["Platform.sh routes"] = 3,
    ["Platform.sh services"] = 4,
    ["Plex Prerolls"] = 591,
    ["PocketMine plugin.yml"] = 588,
    ["Postman collection"] = 595,
    ["Power Pages Configuration"] = 1126,
    ["Preset list for a WinUtil"] = 1074,
    ["ProActions AI-Kit Configuration"] = 604,
    ["ProActions AI-Kit Configuration for Menus"] = 606,
    ["ProActions AI-Kit Configuration for Sections"] = 608,
    ["ProActions AI-Kit Configuration for Services"] = 605,
    ["ProActions AI-Kit Configuration for Steps"] = 609,
    ["ProActions AI-Kit Configuration for Templates"] = 607,
    ["Problem object RFC9457"] = 1020,
    ["Problem package generators"] = 610,
    Pterodactyl = 971,
    ["Pull Request Labeler"] = 626,
    Pulumi = 634,
    ["PyGTA Config"] = 630,
    PyProject = 635,
    Pylock = 1117,
    Pyright = 636,
    ["Python script metadata"] = 1111,
    ["QType AI DSL"] = 639,
    Qgoda = 638,
    Qodana = 944,
    ["Qt Creator workspace file"] = 1052,
    ["Quali Torque Blueprint Spec 2"] = 969,
    ["QueryFirst config file"] = 987,
    ["RKE Cluster Configuration JSON"] = 922,
    ["RKE Cluster Configuration YAML"] = 921,
    RadioHound = 629,
    Railway = 640,
    ["Rancher Fleet"] = 631,
    ["Rattler-build"] = 641,
    Ray = 886,
    ["Read the Docs"] = 633,
    ["Red-DiscordBot Cog"] = 648,
    ["Red-DiscordBot Cog Repo"] = 649,
    ["Red-DiscordBot Trivia"] = 650,
    ["Render Blueprints"] = 920,
    RenderCV = 663,
    Renovate = 662,
    ["Replit config"] = 656,
    Restate = 1104,
    ["Revel Digital Gadget Definition File"] = 1128,
    RoadRunner = 665,
    ["Robust Station Image"] = 1134,
    ["Roo Coder Custom Modes"] = 667,
    Rubocop = 658,
    ["Rudder techniques"] = 1027,
    Ruff = 659,
    ["Rust Project"] = 660,
    ["Rust toolchain"] = 671,
    ["SDMX data message"] = 697,
    ["SDMX metadata message"] = 696,
    ["SDMX structure message"] = 695,
    ["SIL Kit Participant Configuration"] = 707,
    ["SIL Kit Registry Configuration"] = 708,
    ["SPDX 2.3"] = 745,
    SWADL = 761,
    ["Safebox Config"] = 982,
    ["Sapphire CLI Config"] = 674,
    ["SauceCTL Configuration"] = 931,
    ["Schema Catalog"] = 689,
    ["Scoop manifest"] = 694,
    ["Semantic Data Fabric (SDF) file"] = 698,
    ["Semgrep Rule"] = 700,
    ["Serenity Code Generator (Sergen)"] = 701,
    ["Serverless Framework Configuration"] = 938,
    ["Serverless Workflow"] = 940,
    ["Settings for a Cinnamon spice"] = 1070,
    ["Settings.paf"] = 703,
    ["Shopware 6 Configuration"] = 941,
    ["Shopware CLI Extension Store Configuration"] = 942,
    ["Shopware CLI Project Store Configuration"] = 943,
    ["Sigma Detection Rule"] = 705,
    ["Sigrid scope configuration file"] = 706,
    ["SkyPilot Task JSON"] = 1028,
    ["Slack app manifest"] = 710,
    Solidarity = 715,
    ["Solution filters"] = 716,
    ["Source Maps v3"] = 717,
    Sourcery = 718,
    ["Spack bootstrap.yaml"] = 719,
    ["Spack cdash.yaml"] = 720,
    ["Spack ci.yaml"] = 721,
    ["Spack compilers.yaml"] = 722,
    ["Spack concretizer.yaml"] = 723,
    ["Spack config.yaml"] = 724,
    ["Spack definitions.yaml"] = 725,
    ["Spack develop.yaml"] = 726,
    ["Spack env_vars.yaml"] = 727,
    ["Spack environment"] = 733,
    ["Spack include.yaml"] = 728,
    ["Spack mirrors.yaml"] = 729,
    ["Spack modules.yaml"] = 730,
    ["Spack packages.yaml"] = 731,
    ["Spack repos.yaml"] = 732,
    ["Spack toolchains.yaml"] = 734,
    ["Spack upstreams.yaml"] = 735,
    ["Spack view.yaml"] = 736,
    ["Speakeasy Generation Config File"] = 740,
    ["Speakeasy Lint Configuration File"] = 737,
    ["Speakeasy Test Generation Configuration File"] = 738,
    ["Speakeasy Workflow File"] = 739,
    SpecIF = 741,
    ["Specmatic Configuration"] = 742,
    ["Sponge Mixin configuration"] = 743,
    StackBlitz = 749,
    ["StackHawk Scanner Configuration"] = 937,
    Stale = 750,
    Starfish = 751,
    ["Starlake Data Pipeline"] = 910,
    Starship = 752,
    ["Statamic Blueprint"] = 753,
    ["Stella configuration file"] = 754,
    ["Streamlit configuration file"] = 755,
    ["Stryker Mutator"] = 758,
    ["StyleCop Analyzers Configuration"] = 759,
    ["Stylelint (.stylelintrc)"] = 760,
    ["Stylua Config"] = 1118,
    ["Sublime Syntax"] = 983,
    ["Subsquid squid manifest"] = 1030,
    ["Swagger API 2.0"] = 762,
    ["Synadia Connect Component"] = 763,
    TSON = 798,
    TSTyche = 799,
    ["TYPO3 Vendor Bundler config"] = 804,
    ["Tab data for a LinUtil"] = 1077,
    ["Tab list for a LinUtil"] = 1076,
    Tach = 764,
    ["Tach Domain"] = 765,
    Talhelper = 767,
    ["Talisman configuration"] = 768,
    Taplo = 1119,
    ["Taskfile config"] = 915,
    Taurus = 769,
    Tauticord = 770,
    Telefonistka = 1105,
    ["Terrateam config"] = 1131,
    ["TestEnvironment.json"] = 781,
    ["TextMate Grammar"] = 780,
    Threagile = 776,
    ["Tier.run pricing.json"] = 773,
    Tikibase = 774,
    Tombi = 779,
    ["Traefik v2"] = 784,
    ["Traefik v2 File Provider"] = 785,
    ["Traefik v3"] = 786,
    ["Traefik v3 File Provider"] = 787,
    ["Travis CI (.travis.yml)"] = 783,
    Treefmt = 375,
    Trident = 1101,
    ["TrueScript for *.tscript files"] = 790,
    ["Tugboat QA config.yml"] = 1098,
    TunnelHub = 1018,
    Turborepo = 782,
    Tycho = 1066,
    Tye = 945,
    ["Tyk Gateway - Open Source v5.7+"] = 1110,
    ["Typst Manifest"] = 805,
    ["UET BuildConfig.json"] = 988,
    ["UI5 Manifest"] = 811,
    ["UNCORS configuration"] = 815,
    ["UTAM Page Object"] = 814,
    ["Ubuntu Server Autoinstall"] = 809,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1102,
    ["Uniswap Token List"] = 898,
    ["Universal Schedule Format"] = 816,
    ["Unreal Engine Uplugin"] = 989,
    ["Unreal Engine Uproject"] = 990,
    ["UpCloud CLI (upctl) configuration"] = 1103,
    ["Updatecli Compose"] = 953,
    ["Updatecli Policy Manifest"] = 954,
    ["Updatecli Policy Metadata"] = 955,
    Uplift = 986,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 919,
    V2Ray = 959,
    ["VSCode Code Snippets"] = 210,
    ["VSIX CLI publishing"] = 836,
    Vector = 818,
    ["Vela Pipeline Configuration"] = 821,
    Vercel = 209,
    ["Version Bumper config"] = 826,
    ["Viash Component Config"] = 1107,
    ["Viash Package Config"] = 1108,
    Visivo = 1016,
    ["WP-CLI"] = 846,
    Wake = 1100,
    ["Waku Config"] = 1080,
    ["Web App Manifest"] = 842,
    ["Web types"] = 845,
    WebExtensions = 841,
    ["Webman package recipe"] = 965,
    ["Windows Package Manager Installer Manifest"] = 894,
    ["Windows Package Manager Locale Manifest"] = 895,
    ["Windows Package Manager Singleton Manifest"] = 893,
    Winutil = 896,
    ["WireMock stub mapping"] = 1083,
    ["Woodpecker pipeline config"] = 933,
    ["Wrangler CLI"] = 847,
    ["Xstate Machine"] = 951,
    ["Yandex Workflow Language"] = 1072,
    ["Yarn Config (.yarnrc.yml)"] = 908,
    ["Yippee-Ki-JSON configuration YML"] = 900,
    ["YouTrack App"] = 1069,
    ["Zarf Package Configuration"] = 1133,
    ["Zerops.io config"] = 1057,
    ["Zerops.io import"] = 1058,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 1021,
    ...
    ["behat.yml"] = 108,
    ["bigquery-table"] = 97,
    ["bioimageio resource description"] = 1038,
    ...
    ["crowdin.yml"] = 244,
    ["ctfd-setup configuration file"] = 1090,
    ["custom-elements.json"] = 1008,
    ["cypress.json"] = 248,
    ...
    ["gematik health care insurance list"] = 1096,
    ["gematik health care patient list"] = 1093,
    ["gematik health care provider institution list"] = 1095,
    ["gematik health care provider list"] = 1094,
    ["gematik tiger test environment configuration"] = 1097,
    ["gitlab-ci"] = 350,
    ["global.json"] = 366,
    ["go-feature-flag Flag Configuration"] = 369,
    ["haxelib.json"] = 386,
    helmfile = 889,
    helmwave = 890,
    ["host-meta.json"] = 394,
    ...
    ["ide.host.json"] = 402,
    ["ifstate.yaml"] = 403,
    ["imageoptimizer.json"] = 404,
    ["importmap.json"] = 407,
    ["ioBroker Configuration"] = 409,
    ["ioBroker JSON UI"] = 410,
    ["ioBroker Package manifest"] = 411,
    ["ixpect.conf.yaml"] = 412,
    ["ize.toml"] = 985,
    ["jsconfig.json"] = 437,
    ["jscpd Configuration"] = 970,
    jsdoc = 885,
    ["k3d.yaml"] = 438,
    ["k9s aliases.yaml"] = 440,
    ["k9s cluster-config.yaml"] = 442,
    ["k9s config.yaml"] = 441,
    ["k9s hotkeys.yaml"] = 443,
    ["k9s plugins.yaml"] = 444,
    ["k9s skin.yaml"] = 445,
    ["k9s views.yaml"] = 446,
    ["kontinuous-config.yaml"] = 457,
    ["kontinuous-values.yaml"] = 456,
    ["kustomization.yaml"] = 459,
    ["label-commenter-config.yml"] = 460,
    ["latexindent configuration"] = 78,
    ["launchsettings.json"] = 461,
    lazydocker = 1007,
    lazygit = 1006,
    ["lego.json"] = 463,
    ["lerna.json"] = 464,
    ["lgtm.yml"] = 465,
    ["liblab.config.json"] = 466,
    ["libman.json"] = 467,
    ["license-report-config.json"] = 468,
    ["linkinator.config.json"] = 470,
    ["lint-staged (.lintstagedrc)"] = 863,
    ["local.settings.json"] = 475,
    ["localazy.json"] = 476,
    ["lotus.yaml"] = 474,
    ["lsdlschema.json"] = 477,
    ["markdown-link-check"] = 928,
    maturin = 929,
    mboats = 936,
    ["micro-settings.json"] = 1000,
    ["mimetypes.json"] = 491,
    ["mirrord config"] = 865,
    mise = 866,
    ["mkdocs.yml"] = 511,
    ["monospace.yml"] = 514,
    ["moon.yml"] = 1082,
    ["mprocs Configuration file"] = 1053,
    ["mrdocs.yml"] = 512,
    ["mta.yaml"] = 867,
    ["mtad.yaml"] = 868,
    ["mycode.json"] = 521,
    nFPM = 526,
    ["napari plugin manifest"] = 522,
    neoload = 880,
    ["nest-cli"] = 529,
    ["ninjs (News in JSON)"] = 528,
    ["nitro.json"] = 879,
    ["nixd configuration"] = 1026,
    ["nlu.json"] = 530,
    ["nodemon.json"] = 532,
    ["noodl config"] = 935,
    ["notebook.mod.json"] = 533,
    now = 875,
    ["npm-badges"] = 536,
    ["nswag.json"] = 540,
    ntangle = 542,
    ["nuclei-template.yaml"] = 537,
    ["nuget-project.json"] = 538,
    ["ocelot.json"] = 544,
    ["omnisharp.json"] = 548,
    ["openapi.json"] = 550,
    ["openfin.json"] = 557,
    ...
    ["ops.yaml"] = 554,
    ["package.json"] = 578,
    ["package.manifest"] = 579,
    ["partial-black.json"] = 109,
    ["pathfinder.yml"] = 582,
    ["pattern.json"] = 585,
    ["petstore-v1.0"] = 980,
    pgap_yaml_input_reader = 584,
    ["pixi.toml"] = 586,
    ["plagiarize-me.yaml"] = 590,
    ["plagiarize.yaml"] = 589,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1086,
    ["podbard.yaml"] = 592,
    ["portman.json"] = 593,
    ["prefect.toml"] = 601,
    ["prettierrc.json"] = 602,
    ["prisma.yml"] = 603,
    ["project-1.0.0-beta3.json"] = 612,
    ["project-1.0.0-beta4.json"] = 613,
    ["project-1.0.0-beta5.json"] = 614,
    ["project-1.0.0-beta6.json"] = 615,
    ["project-1.0.0-beta8.json"] = 616,
    ["project-1.0.0-rc1.json"] = 617,
    ["project-1.0.0-rc2.json"] = 618,
    ["project.json"] = 611,
    ["project.owasp.yaml"] = 619,
    ["prometheus.json"] = 620,
    ["prometheus.rules.json"] = 621,
    ["prometheus.rules.test.json"] = 622,
    ["proxies.json"] = 623,
    ["publiccode.yml"] = 624,
    ["pubspec.yaml"] = 625,
    ["pyrseas-0.8.json"] = 628,
    pytest = 637,
    ["quilt.mod.json"] = 1001,
    ["rc3 auth"] = 642,
    ["rc3 collection"] = 643,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 881,
    ["release-please-config.json"] = 652,
    ["release-please-manifest.json"] = 653,
    ["release-plz.toml"] = 654,
    ["renv.lock"] = 664,
    ["rivet.json"] = 1025,
    ["rivet.yaml (legacy)"] = 1024,
    rockcraft = 666,
    rumdl = 669,
    runny = 668,
    rustfmt = 670,
    ...
    samt = 672,
    samtrc = 673,
    ["sarif-1.0.0.json"] = 675,
    ["sarif-2.0.0.json"] = 676,
    ["sarif-2.1.0"] = 686,
    ["sarif-2.1.0-rtm.2"] = 677,
    ["sarif-2.1.0-rtm.3"] = 679,
    ["sarif-2.1.0-rtm.4"] = 681,
    ["sarif-2.1.0-rtm.5"] = 683,
    ["sarif-2.1.0-rtm.6"] = 684,
    ["sarif-external-property-file-2.1.0"] = 687,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 678,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 680,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 682,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 685,
    ["scalingo.json configuration"] = 688,
    ["schema.org - Action"] = 690,
    ["schema.org - ContactPoint"] = 691,
    ["schema.org - Place"] = 692,
    ["schema.org - Thing"] = 693,
    ["secrethub.yml"] = 1003,
    ["semantic-release"] = 699,
    ["servicehub.config.json"] = 858,
    ["servicehub.service.json"] = 857,
    ["settings.job"] = 702,
    ["sfdx-hardis configuration"] = 704,
    ["shard.yml"] = 1041,
    ["size-limit configuration"] = 709,
    ["skaffold.yaml"] = 926,
    ["skyuxconfig.json"] = 711,
    snapcraft = 712,
    ["snowflake-config"] = 713,
    ["snowflake-connections"] = 714,
    ["spicepod.yaml"] = 1061,
    ["sqlc configuration"] = 746,
    ["stripe-app-local.json"] = 757,
    ["stripe-app.json"] = 756,
    swcrc = 911,
    ["task.json"] = 766,
    taskcat = 876,
    ["template.json"] = 771,
    ["templatsources.json"] = 772,
    ["theme.json"] = 775,
    ["tizen_workspace.json"] = 777,
    tldr = 778,
    ["tm_devices configuration file"] = 1124,
    tmuxinator = 861,
    ["transcend.yml"] = 788,
    ["tree-sitter grammar.json"] = 374,
    ["trime.yaml"] = 789,
    ["trunk.yaml"] = 791,
    ["ts-force-config.json"] = 796,
    ["tsconfig.json"] = 792,
    ["tsd.json"] = 793,
    ["tsdoc.json"] = 794,
    ["tsdrc.json"] = 795,
    ...
    ["vega-lite.json"] = 820,
    ["vega.json"] = 819,
    ["venvironment-basic.yaml"] = 823,
    ["venvironment.yaml"] = 822,
    ["venvplus-basic.yaml"] = 825,
    ["venvplus.yaml"] = 824,
    version = 1106,
    ["version.json"] = 827,
    ["vhwdebugger-binding.yaml"] = 829,
    ["vim-addon-info"] = 830,
    ["vs-2017.3.host.json"] = 832,
    ["vs-nesting.json"] = 833,
    ["vsls.json"] = 831,
    ["vss-extension.json"] = 837,
    vtcfg = 1112,
    ["vtesttree.yaml"] = 838,
    ["vtestunit.yaml"] = 839,
    ["warp-keysets.json"] = 1009,
    ["warp-themes.json"] = 1010,
    ["warp-workflows.json"] = 1011,
    ["webhint.io"] = 966,
    ["webjobpublishsettings.json"] = 844,
    ["webjobs-list.json"] = 843,
    ["well-known-fursona"] = 1048,
    ["xs-app.json"] = 871,
    ["xunit.runner.json"] = 856,
    yamllint = 899,
    zuul = 882,
    ["Žinoma"] = 892
  },
