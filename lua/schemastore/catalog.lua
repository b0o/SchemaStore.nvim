...
M.json = {
  ...
  index = {
    ...
    [".pmbot.yml"] = 526,
    [".postcssrc"] = 532,
    [".powerpages-web-template-manifest"] = 534,
    [".pre-commit-config.yml"] = 535,
    [".pre-commit-hooks.yml"] = 536,
    [".putout.json"] = 557,
    [".rehyperc"] = 576,
    [".remarkrc"] = 578,
    [".sprite files"] = 640,
    ...
    ["<div>RIOTS' studio configuration"] = 720,
    ...
    ["Adobe UXP Manifest"] = 900,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Airplane task"] = 17,
    ["Alacritty Configuration"] = 812,
    ["All Contributors configuration file"] = 865,
    ...
    ["Application list for a WinUtil"] = 944,
    ArchitectFX = 948,
    ["Argo Events"] = 29,
    ["Argo Workflows"] = 30,
    AssemblyScript = 33,
    ...
    ["Azure Pipelines"] = 64,
    ["Azure Static Web Apps CLI configuration file"] = 643,
    ["Azure Static Web Apps configuration file"] = 642,
    ["BOSH Deploy Config"] = 88,
    ["BX CI"] = 105,
    ["Bashly (bashly.yml)"] = 869,
    ["Bashly Settings (bashly-settings.yml)"] = 870,
    ["Better Code Hub"] = 784,
    ["Better Scripts"] = 106,
    Bigconfig = 81,
    BizTalkServerApplicationSchema = 754,
    Bleep = 107,
    ...
    ["Butane Config"] = 825,
    ["CGS Custom Card Game (CardGameDef.json)"] = 905,
    ["CICS TS region tagging"] = 834,
    ["CICS TS resource import"] = 835,
    ["CICS TS resource model"] = 836,
    ["CICS TS resource overrides"] = 837,
    ["CMake Presets"] = 108,
    ["CNC Codes"] = 122,
    ["CRS WAF test file"] = 934,
    ["CRS WAF test platform overrides file"] = 935,
    ...
    CityJSON = 118,
    ["Clawject config"] = 127,
    ["Cloud Foundry Application Manifest"] = 917,
    ["Cloud Run Spec v1"] = 939,
    ...
    Concord = 933,
    ["Configu .cfgu files"] = 922,
    ["Configu .configu file"] = 923,
    Conjure = 121,
    ["Container Structure Test"] = 767,
    Containerlab = 792,
    ["Crowdsec collection config"] = 211,
    ["Crowdsec parser config"] = 212,
    ["Crowdsec scenario config"] = 213,
    ["CumulusCI Config"] = 126,
    ["Custom Machinery Machine"] = 906,
    ["Custom Machinery Recipe"] = 907,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 877,
    ["EAS config"] = 277,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 866,
    ["Eidolon Resource"] = 949,
    ...
    ["Goreleaser Pro"] = 334,
    Goss = 335,
    ["Gradle Build Cache Node"] = 782,
    ["Gradle Enterprise"] = 781,
    ...
    Hadolint = 763,
    Hammerkit = 791,
    ["Hardware Sentry Configuration"] = 845,
    Hatch = 764,
    Hayson = 348,
    ...
    ["JFrog File Spec"] = 376,
    ["JFrog Pipelines YML DSL"] = 854,
    ["JMeter DSL cli config"] = 377,
    JReleaser = 379,
    ["JSON Document Transform"] = 387,
    ["JSON Feed"] = 388,
    ["JSON Resume"] = 583,
    ["JSON Schema Draft 2020-12"] = 733,
    ["JSON Schema Draft 4"] = 730,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 887,
    ["JSON Schema Draft 7"] = 731,
    ["JSON Schema Draft 7 (unofficial strict)"] = 888,
    ["JSON Schema Draft 8 (2019-09)"] = 732,
    ["JSON-API"] = 386,
    ["JSON-WF"] = 916,
    ["JSON-e templates"] = 789,
    ["JSON-stat 2.0"] = 727,
    JSONPatch = 390,
    ...
    ["Keycloak REST API"] = 857,
    ["Knative Functions - func.yaml"] = 296,
    ["KoDE/CI build.yaml"] = 850,
    ["Kong DBLess config"] = 851,
    KrakenD = 403,
    ...
    ["Metadata for a Cinnamon spice"] = 942,
    ["MetricsHub Configuration"] = 436,
    ["MetricsHub Connector Configuration"] = 437,
    ["Micro Editor Syntax"] = 878,
    ["Microsoft Band Web Tile"] = 438,
    ["Microsoft RulesEngine workflow rules"] = 930,
    ["Microsoft RulesEngine workflow rules list"] = 931,
    ["Minecraft Custom Main Menu Mod"] = 895,
    ...
    ["MongoDB Atlas Search Index Definition"] = 849,
    ["Monika Configuration"] = 847,
    ["Monoweave Configuration"] = 462,
    ["Motif config"] = 747,
    ["NOX Framework (Service)"] = 479,
    ["Netin Diagnostic System Template"] = 807,
    ["Netlify config"] = 470,
    ["Network-as-Code Data Model"] = 471,
    ["Nightwatch.js"] = 472,
    ["Nuitka.yaml"] = 908,
    ["ONe's changelog entry"] = 497,
    ["ONe's service descriptor"] = 496,
    ["OSCAL Assessment Plan (AP)"] = 505,
    ["OSCAL Assessment Results (AR)"] = 506,
    ["OSCAL Catalog"] = 507,
    ["OSCAL Component Definition (CDef)"] = 508,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 509,
    ["OSCAL Profile"] = 510,
    ["OSCAL System Security Plan (SSP)"] = 511,
    ["OSS Review Toolkit configuration"] = 512,
    ["OSS Review Toolkit curation"] = 513,
    ["OSS Review Toolkit package configuration"] = 514,
    ["OSS Review Toolkit repository configuration"] = 515,
    ["OSS Review Toolkit resolutions"] = 516,
    ...
    ["OpenUtau ustx"] = 494,
    ["OpenWeather Current Weather API"] = 788,
    ["OpenWeather Road Risk API"] = 787,
    ["Ory Hydra configuration"] = 355,
    ["Ory Keto configuration"] = 406,
    ["Ory Kratos configuration"] = 504,
    ["Ory Oathkeeper configuration"] = 486,
    ["Outblocks App configuration"] = 502,
    ["Outblocks database table"] = 503,
    ["Outblocks project configuration"] = 501,
    PDM = 522,
    Packer = 519,
    Pantsbuild = 864,
    ["Paper paper-plugin.yml"] = 520,
    ["Pipeline component"] = 799,
    ["PocketMine plugin.yml"] = 527,
    ["Postman collection"] = 533,
    ["Preset list for a WinUtil"] = 945,
    ["Problem object RFC9457"] = 892,
    ["Problem package generators"] = 541,
    Pterodactyl = 844,
    ["Pull Request Labeler"] = 556,
    Pulumi = 562,
    PyProject = 563,
    Pyright = 564,
    Qgoda = 565,
    Qodana = 817,
    ["Qt Creator workspace file"] = 924,
    ["Quali Torque Blueprint Spec 2"] = 842,
    ["QueryFirst config file"] = 860,
    ["RKE Cluster Configuration JSON"] = 796,
    ["RKE Cluster Configuration YAML"] = 795,
    ["Rancher Fleet"] = 559,
    ["Rattler-build"] = 566,
    Ray = 762,
    ["Read the Docs"] = 561,
    ["Red-DiscordBot Cog"] = 573,
    ["Red-DiscordBot Cog Repo"] = 574,
    ["Red-DiscordBot Trivia"] = 575,
    ["Render Blueprints"] = 794,
    RenderCV = 585,
    Renovate = 584,
    ["Replit config"] = 579,
    RoadRunner = 586,
    ["Rudder techniques"] = 898,
    Ruff = 581,
    ["Rust Project"] = 582,
    ["Rust toolchain"] = 590,
    ["SDMX data message"] = 615,
    ["SDMX metadata message"] = 614,
    ["SDMX structure message"] = 613,
    ["SIL Kit Participant Configuration"] = 625,
    ["SIL Kit Registry Configuration"] = 626,
    SWADL = 654,
    ["Safebox Config"] = 855,
    ["Sapphire CLI Config"] = 593,
    ["SauceCTL Configuration"] = 804,
    ["Schema Catalog"] = 607,
    ["Scoop manifest"] = 612,
    ["Semantic Data Fabric (SDF) file"] = 616,
    ["Semgrep Rule"] = 618,
    ["Serenity Code Generator (Sergen)"] = 619,
    ["Serverless Framework Configuration"] = 811,
    ["Serverless Workflow"] = 813,
    ["Settings for a Cinnamon spice"] = 941,
    ["Settings.paf"] = 621,
    ["Shopware 6 Configuration"] = 814,
    ["Shopware CLI Extension Store Configuration"] = 815,
    ["Shopware CLI Project Store Configuration"] = 816,
    ["Sigma Detection Rule"] = 623,
    ["Sigrid scope configuration file"] = 624,
    ["SkyPilot Task JSON"] = 899,
    ["Slack app manifest"] = 628,
    Solidarity = 631,
    ["Solution filters"] = 632,
    ["Source Maps v3"] = 633,
    Sourcery = 634,
    ["Speakeasy Lint Configuration File"] = 635,
    ["Speakeasy Test Generation Configuration File"] = 636,
    ["Speakeasy Workflow File"] = 637,
    SpecIF = 638,
    ["Sponge Mixin configuration"] = 639,
    StackBlitz = 644,
    ["StackHawk Scanner Configuration"] = 810,
    Stale = 645,
    ["Starlake Data Pipeline"] = 785,
    Starship = 646,
    ["Statamic Blueprint"] = 647,
    ["Stella configuration file"] = 648,
    ["Stryker Mutator"] = 651,
    ["StyleCop Analyzers Configuration"] = 652,
    ["Stylelint (.stylelintrc)"] = 653,
    ["Sublime Syntax"] = 856,
    ["Subsquid squid manifest"] = 901,
    ["Swagger API 2.0"] = 655,
    TSON = 684,
    TSTyche = 685,
    ["Tab data for a LinUtil"] = 947,
    ["Tab list for a LinUtil"] = 946,
    Talhelper = 657,
    ["Talisman configuration"] = 658,
    ["Taskfile config"] = 790,
    Taurus = 659,
    Tauticord = 660,
    ["TestEnvironment.json"] = 669,
    ["TextMate Grammar"] = 668,
    ["Tier.run pricing.json"] = 663,
    Tikibase = 664,
    ["Traefik v2"] = 672,
    ["Traefik v2 File Provider"] = 673,
    ["Travis CI (.travis.yml)"] = 671,
    ["TrueScript for *.tscript files"] = 676,
    TunnelHub = 891,
    Turborepo = 670,
    Tycho = 937,
    Tye = 818,
    ["UET BuildConfig.json"] = 861,
    ["UI5 Manifest"] = 694,
    ["UNCORS configuration"] = 698,
    ["UTAM Page Object"] = 697,
    ["Ubuntu Server Autoinstall"] = 692,
    ["Uniswap Token List"] = 773,
    ["Unreal Engine Uplugin"] = 862,
    ["Unreal Engine Uproject"] = 863,
    ["Updatecli Compose"] = 826,
    ["Updatecli Policy Manifest"] = 827,
    ["Updatecli Policy Metadata"] = 828,
    Uplift = 859,
    ["User Journey Map"] = 793,
    V2Ray = 832,
    ["VSCode Code Snippets"] = 177,
    ["VSIX CLI publishing"] = 715,
    ["Vela Pipeline Configuration"] = 702,
    Vercel = 176,
    ["Version Bumper config"] = 705,
    Visivo = 889,
    ["Waku Config"] = 950,
    ["Web App Manifest"] = 722,
    ["Web types"] = 725,
    WebExtensions = 721,
    ["Webman package recipe"] = 838,
    ["Windows Package Manager Installer Manifest"] = 770,
    ["Windows Package Manager Locale Manifest"] = 771,
    ["Windows Package Manager Singleton Manifest"] = 769,
    ["Woodpecker pipeline config"] = 806,
    ["Wrangler CLI"] = 726,
    ["Xstate Machine"] = 824,
    ["Yandex Workflow Language"] = 943,
    ["Yarn Config (.yarnrc.yml)"] = 783,
    ["Yippee-Ki-JSON configuration YML"] = 775,
    ["YouTrack App"] = 940,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 18,
    apko = 893,
    ...
    ["behat.yml"] = 90,
    ["bigquery-table"] = 80,
    ["bioimageio resource description"] = 909,
    ...
    ["lint-staged (.lintstagedrc)"] = 741,
    ["local.settings.json"] = 426,
    ["localazy.json"] = 427,
    ["lotus.yaml"] = 425,
    ["lsdlschema.json"] = 428,
    ["markdown-link-check"] = 802,
    mboats = 809,
    ["micro-settings.json"] = 873,
    ["mimetypes.json"] = 439,
    ["mirrord config"] = 742,
    mise = 743,
    ["mise-settings"] = 744,
    ...
    ["ops.yaml"] = 495,
    ["package.json"] = 517,
    ["package.manifest"] = 518,
    ["partial-black.json"] = 91,
    ["pathfinder.yml"] = 521,
    ["pattern.json"] = 524,
    ["petstore-v1.0"] = 853,
    pgap_yaml_input_reader = 523,
    ["pixi.toml"] = 525,
    ["plagiarize-me.yaml"] = 529,
    ["plagiarize.yaml"] = 528,
    ["podbard.yaml"] = 530,
    ["portman.json"] = 531,
    ["prettierrc.json"] = 539,
    ["prisma.yml"] = 540,
    ["project-1.0.0-beta3.json"] = 543,
    ["project-1.0.0-beta4.json"] = 544,
    ["project-1.0.0-beta5.json"] = 545,
    ["project-1.0.0-beta6.json"] = 546,
    ["project-1.0.0-beta8.json"] = 547,
    ["project-1.0.0-rc1.json"] = 548,
    ["project-1.0.0-rc2.json"] = 549,
    ["project.json"] = 542,
    ["prometheus.json"] = 550,
    ["prometheus.rules.json"] = 551,
    ["prometheus.rules.test.json"] = 552,
    ["proxies.json"] = 553,
    ["publiccode.yml"] = 554,
    ["pubspec.yaml"] = 555,
    ["pyrseas-0.8.json"] = 558,
    ["quilt.mod.json"] = 874,
    ["rc3 auth"] = 567,
    ["rc3 collection"] = 568,
    ["rc3 environment"] = 569,
    ...
    samt = 591,
    samtrc = 592,
    ["sarif-1.0.0.json"] = 594,
    ["sarif-2.0.0.json"] = 595,
    ["sarif-2.1.0"] = 605,
    ["sarif-2.1.0-rtm.2"] = 596,
    ["sarif-2.1.0-rtm.3"] = 598,
    ["sarif-2.1.0-rtm.4"] = 600,
    ["sarif-2.1.0-rtm.5"] = 602,
    ["sarif-2.1.0-rtm.6"] = 603,
    ["sarif-external-property-file-2.1.0"] = 606,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 597,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 599,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 601,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 604,
    ["schema.org - Action"] = 608,
    ["schema.org - ContactPoint"] = 609,
    ["schema.org - Place"] = 610,
    ["schema.org - Thing"] = 611,
    ["secrethub.yml"] = 876,
    ["semantic-release"] = 617,
    ["servicehub.config.json"] = 736,
    ["servicehub.service.json"] = 735,
    ["settings.job"] = 620,
    ["sfdx-hardis configuration"] = 622,
    ["shard.yml"] = 912,
    ["size-limit configuration"] = 627,
    ["skaffold.yaml"] = 800,
    ["skyuxconfig.json"] = 629,
    snapcraft = 630,
    ["spicepod.yaml"] = 932,
    ["sqlc configuration"] = 641,
    ["stripe-app-local.json"] = 650,
    ["stripe-app.json"] = 649,
    swcrc = 786,
    ["task.json"] = 656,
    taskcat = 753,
    ["template.json"] = 661,
    ["templatsources.json"] = 662,
    ["theme.json"] = 665,
    ["tizen_workspace.json"] = 666,
    tldr = 667,
    tmuxinator = 739,
    ["transcend.yml"] = 674,
    ...
    ["vega-lite.json"] = 701,
    ["vega.json"] = 700,
    ["venvironment-basic.yaml"] = 704,
    ["venvironment.yaml"] = 703,
    ["version.json"] = 706,
    ["vhwdebugger-binding.yaml"] = 708,
    ["vim-addon-info"] = 709,
    ["vs-2017.3.host.json"] = 711,
    ["vs-nesting.json"] = 712,
    ["vsls.json"] = 710,
    ["vss-extension.json"] = 716,
    ["vtesttree.yaml"] = 717,
    ["vtestunit.yaml"] = 718,
    ["warp-keysets.json"] = 882,
    ["warp-themes.json"] = 883,
    ["warp-workflows.json"] = 884,
    ["webhint.io"] = 839,
    ["webjobpublishsettings.json"] = 724,
    ["webjobs-list.json"] = 723,
    ["well-known-fursona"] = 920,
    ["xs-app.json"] = 749,
    ["xunit.runner.json"] = 734,
    yamllint = 774,
    ["zerops.io import file"] = 929,
    ["zerops.yml"] = 928,
    zuul = 758,
    ["Žinoma"] = 768
  },
