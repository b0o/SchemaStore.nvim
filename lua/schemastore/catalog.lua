...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 158,
    [".cryproj (generic)"] = 552,
    [".cryproj engine-5.2"] = 547,
    [".cryproj engine-5.3"] = 548,
    [".cryproj engine-5.4"] = 549,
    [".cryproj engine-5.5"] = 550,
    [".cryproj engine-dev"] = 551,
    [".csscomb.json"] = 160,
    [".csslintrc"] = 161,
    [".es6importsorterrc.json"] = 675,
    [".eslintrc"] = 206,
    [".esmrc.json"] = 198,
    [".ffizer.yaml"] = 210,
    [".htmlhintrc"] = 255,
    ...
    [".mtaext"] = 561,
    [".nodehawkrc"] = 347,
    [".npmpackagejsonlintrc"] = 350,
    [".phraseapp.yml"] = 389,
    [".pmbot.yml"] = 379,
    [".postcssrc"] = 384,
    [".powerpages-web-template-manifest"] = 386,
    [".pre-commit-config.yml"] = 387,
    [".pre-commit-hooks.yml"] = 388,
    [".putout.json"] = 406,
    [".rehyperc"] = 416,
    [".remarkrc"] = 417,
    [".sprite files"] = 467,
    ...
    [".vsext"] = 525,
    [".yarnrc.yml"] = 593,
    ["<div>RIOTS' studio configuration"] = 531,
    ["@factorial/drupal-breakpoints-css"] = 5,
    ["A micro editor config schema"] = 311,
    ["API Builder"] = 590,
    ["AVA Configuration Schema"] = 647,
    ["AWS CDK cdk.json"] = 143,
    ["AWS CloudFormation"] = 144,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 145,
    ["Airlock Microgateway"] = 9,
    ["Airplane task"] = 10,
    ["Alacritty Configuration Schema"] = 622,
    ["All Contributors configuration file"] = 674,
    ["Ansible Argument Specs"] = 16,
    ["Ansible Collection Galaxy"] = 23,
    ["Ansible Execution Environment"] = 13,
    ["Ansible Inventory"] = 22,
    ["Ansible Meta"] = 14,
    ["Ansible Meta Runtime"] = 15,
    ["Ansible Navigator Configuration"] = 25,
    ["Ansible Playbook"] = 20,
    ["Ansible Requirements"] = 17,
    ["Ansible Rulebook"] = 21,
    ["Ansible Tasks File"] = 19,
    ["Ansible Vars File"] = 18,
    ["Ansible-lint Configuration"] = 24,
    ...
    ["Azure Pipelines"] = 48,
    ["Azure Static Web Apps CLI configuration file"] = 469,
    ["Azure Static Web Apps configuration file"] = 468,
    ["BX CI"] = 83,
    ["Better Code Hub"] = 595,
    ["Better Scripts"] = 84,
    BizTalkServerApplicationSchema = 567,
    ["Block Protocol Metadata"] = 82,
    Briefcase = 572,
    ["Build Info"] = 75,
    Buildkite = 77,
    ["Bukkit plugin.yml"] = 76,
    ["BungeeCord plugin.yml"] = 80,
    ["Butane Config"] = 634,
    ["CICS TS region tagging"] = 641,
    ["CICS TS resource import"] = 642,
    ["CICS TS resource model"] = 643,
    ["CICS TS resource overrides"] = 644,
    ["CMake Presets"] = 85,
    ["CNC Codes JSON Schema"] = 94,
    ["Calqulus pipeline"] = 86,
    ["Camel YAML DSL"] = 87,
    Carafe = 88,
    ["Cargo Config Schema"] = 89,
    ["Cargo Make"] = 90,
    ["Catalog Info Backstage"] = 91,
    Cheatsheets = 631,
    ["Chrome Extension"] = 137,
    ["CircleCI config.yml"] = 117,
    ["Citation File Format"] = 146,
    CityJSON = 92,
    ["Code Climate"] = 118,
    CodeCV = 47,
    Codux = 125,
    ["Cog config file"] = 95,
    ["Commandbox Box.json"] = 96,
    ["Commandbox Server.json"] = 97,
    ["Common Catalog Schema"] = 135,
    ["Common types for all schemas"] = 1,
    Conjure = 93,
    ["Container Structure Test"] = 578,
    Containerlab = 603,
    ["Crowdsec collection Schema"] = 154,
    ["Crowdsec parser Schema"] = 155,
    ["Crowdsec scenario Schema"] = 156,
    ["DWP Exchange - catalogue entry"] = 195,
    ["DWP Exchange - gateway"] = 193,
    ["DWP Exchange - meta"] = 194,
    ["Dart build configuration"] = 162,
    ["Dart test config"] = 163,
    ["DashLord configuration"] = 164,
    ["Datadog Service Definition"] = 292,
    ["Datahub Ingestion Recipe Schema"] = 648,
    ["Dein Config Schema"] = 99,
    Deno = 168,
    ["Deployer Recipe"] = 171,
    ["Deta Spacefile Schema"] = 100,
    Devfile = 192,
    ["Discord Webhook"] = 173,
    ["Dolittle Artifacts"] = 177,
    ["Dolittle Bounded Context Configuration"] = 178,
    ["Dolittle Event Horizons Configuration"] = 179,
    ["Dolittle Resources Configuration"] = 180,
    ["Dolittle Server Configuration"] = 181,
    ["Dolittle Tenant Map Configuration"] = 183,
    ["Dolittle Tenants Configuration"] = 182,
    ["Dolittle Topology"] = 184,
    ["Drupal Breakpoints Schema"] = 101,
    ["Drupal Config Schema"] = 112,
    ["Drupal Info Schema"] = 102,
    ["Drupal Layouts Schema"] = 103,
    ["Drupal Libraries Schema"] = 104,
    ["Drupal Links Action Schema"] = 105,
    ["Drupal Links Contextual Schema"] = 106,
    ["Drupal Links Menu Schema"] = 107,
    ["Drupal Links Task Schema"] = 108,
    ["Drupal Migration Schema"] = 109,
    ["Drupal Permissions Schema"] = 110,
    ["Drupal Routing Schema"] = 111,
    ["Drupal Services Schema"] = 113,
    ["Drush site aliases"] = 188,
    ["Embrace Config Schema"] = 659,
    ["Error pages"] = 201,
    Esquio = 199,
    ["Estuary Flow Catalog Schema"] = 638,
    ["Expo SDK"] = 204,
    ["F-Droid Data metadata"] = 209,
    ["Facets - FSDL - Application"] = 207,
    ["FasterCI Configuration"] = 49,
    ["Fossa configuration file"] = 217,
    ["Fossa's fossa-deps file"] = 218,
    ["Foundry VTT - Base package Manifest"] = 212,
    ["Foundry VTT - Module Manifest"] = 213,
    ["Foundry VTT - System Data Template"] = 216,
    ["Foundry VTT - System Manifest"] = 214,
    ["Foundry VTT - World Manifest"] = 215,
    ["Foxx Manifest"] = 50,
    ["Freifunk.de Community API"] = 53,
    ["Frogbot Config"] = 54,
    ["GCP Blueprint Metadata"] = 222,
    ["GatewayCore API Gateway"] = 221,
    ["GeoJSON.json latest"] = 636,
    GherKing = 640,
    ["GitHub Action"] = 226,
    ["GitHub Discussion"] = 227,
    ["GitHub Funding"] = 228,
    ["GitHub Issue Template configuration"] = 230,
    ["GitHub Workflow"] = 231,
    ["GitHub Workflow Template Properties"] = 232,
    ["GitHub issue forms"] = 229,
    GitVersion = 225,
    ["Gitpod Configuration"] = 234,
    ["Global Privacy Control"] = 223,
    ["Google Cloud Workflows"] = 142,
    Goreleaser = 237,
    ["Goreleaser Pro"] = 238,
    ["Gradle Build Cache Node"] = 592,
    ["Gradle Enterprise"] = 591,
    ["Grafana 5.x Dashboard"] = 239,
    ["GraphQL Code Generator"] = 242,
    ["GraphQL Config"] = 241,
    ["GraphQL Mesh"] = 240,
    ["Grunt JSHint task"] = 246,
    ["Grunt Watch task"] = 247,
    ["Grunt base task"] = 248,
    ["Grunt clean task"] = 244,
    ["Grunt copy task"] = 243,
    ["Grunt cssmin task"] = 245,
    HEMTT = 564,
    Hadolint = 576,
    Hammerkit = 602,
    ["Hardware Sentry Configuration"] = 652,
    Hayson = 250,
    ["Haystack Pipeline"] = 251,
    ["Hazelcast 5 Configuration"] = 252,
    ["Helm Chart.lock"] = 115,
    ["Helm Chart.yaml"] = 114,
    ["Helm Unittest Test Suite"] = 116,
    Hugo = 630,
    ["IBM Zapp document"] = 257,
    ["IBM zCodeFormatSettings"] = 258,
    ["IMG Catapult PSP"] = 263,
    ["Istanbul Schema"] = 655,
    ["JDownloader2 crawler multi-rule schema"] = 273,
    ["JDownloader2 crawler single-rule schema"] = 272,
    ["JFrog File Spec"] = 274,
    ["JFrog Pipelines YML DSL"] = 661,
    ["JMeter DSL cli config schema"] = 275,
    JReleaser = 277,
    ["JSON Document Transform"] = 284,
    ["JSON Feed"] = 285,
    ["JSON Resume"] = 423,
    ["JSON Schema Draft 2020-12"] = 543,
    ["JSON Schema Draft 4"] = 540,
    ["JSON Schema Draft 7"] = 541,
    ["JSON Schema Draft 8"] = 542,
    ["JSON schema for CodeShip Pro services configuration files"] = 128,
    ["JSON schema for CodeShip Pro steps configuration files"] = 129,
    ["JSON schema for Codecov configuration files"] = 127,
    ["JSON-API"] = 283,
    ["JSON-e templates"] = 600,
    ["JSON-stat 2.0"] = 537,
    JSONPatch = 287,
    Jasmine = 268,
    Jekyll = 269,
    ["Jenkins X Pipelines"] = 270,
    ["Jenkins X Requirements"] = 271,
    ["Jovo Language Models"] = 276,
    ["KSP-AVC"] = 538,
    ["KSP-CKAN"] = 539,
    Kas = 290,
    ["Keycloak REST API"] = 667,
    ["Knative Functions - func.yaml"] = 219,
    ["KoDE/CI build.yaml"] = 657,
    ["Kong DBLess Schema"] = 658,
    KrakenD = 291,
    LOOBin = 306,
    ["LinkML Metamodel"] = 304,
    Liquibase = 607,
    ["Liquibase Flow File"] = 608,
    ["Lively Properties"] = 305,
    Markdownlint = 611,
    ["Mason Registry"] = 613,
    ["MegaLinter configuration"] = 312,
    ["MegaLinter descriptor"] = 313,
    ["Meltano plugin discovery definition"] = 315,
    ["Meltano project definition"] = 314,
    ["Microsoft Band Web Tile"] = 316,
    ["Minecraft Data Pack Advancement"] = 318,
    ["Minecraft Data Pack Biome"] = 319,
    ["Minecraft Data Pack Configured Carver"] = 320,
    ["Minecraft Data Pack Damage Type"] = 321,
    ["Minecraft Data Pack Dimension"] = 323,
    ["Minecraft Data Pack Dimension Type"] = 322,
    ["Minecraft Data Pack Item Modifier"] = 324,
    ["Minecraft Data Pack Loot Table"] = 325,
    ["Minecraft Data Pack Metadata"] = 326,
    ["Minecraft Data Pack Predicate"] = 327,
    ["Minecraft Data Pack Recipe"] = 328,
    ["Minecraft Data Pack Tag"] = 329,
    ["Minecraft Data Pack Template Pool"] = 330,
    ["Minecraft Resource Pack Lang"] = 331,
    ["Minecraft Resource Pack Particle"] = 332,
    ["Minecraft Resource Pack Texture Mcmeta"] = 334,
    ["Minecraft Resourcepack Sounds"] = 333,
    ["MkDocs Configuration 1.0"] = 335,
    ["MongoDB Atlas Search Index Definition Schema"] = 656,
    ["Monika Configuration Schema"] = 654,
    ["Motif config"] = 560,
    ["NOX Framework (Service)"] = 349,
    ["Netin Diagnostic System Template"] = 617,
    ["Netlify config schema"] = 340,
    ["Nexus-as-Code schema"] = 341,
    ["Nightwatch.js"] = 342,
    ["ONe's service descriptor"] = 361,
    ["OSS Review Toolkit configuration"] = 368,
    ["OSS Review Toolkit curation"] = 369,
    ["OSS Review Toolkit package configuration"] = 370,
    ["OSS Review Toolkit repository configuration"] = 371,
    ["OSS Review Toolkit resolutions"] = 372,
    Opctl = 563,
    ["OpenRewrite Resource"] = 363,
    ["OpenWeather Current Weather API"] = 599,
    ["OpenWeather Road Risk API"] = 598,
    ["Ory Hydra configuration"] = 256,
    ["Ory Keto configuration"] = 293,
    ["Ory Kratos configuration"] = 367,
    ["Ory Oathkeeper configuration"] = 356,
    ["Outblocks App configuration"] = 365,
    ["Outblocks database table"] = 366,
    ["Outblocks project configuration"] = 364,
    Packer = 375,
    Pantsbuild = 673,
    ["Paper paper-plugin.yml"] = 376,
    ["Pipeline component"] = 609,
    ["PocketMine plugin.yml"] = 380,
    ["Postman collection"] = 385,
    Pterodactyl = 651,
    ["Pull Request Labeler"] = 405,
    Pulumi = 410,
    PyProject = 411,
    Pyright = 412,
    Qodana = 627,
    ["Quali Torque Blueprint Spec 2"] = 649,
    ["QueryFirst config file"] = 670,
    ["RKE Cluster Configuration JSON Schema"] = 606,
    ["RKE Cluster Configuration YAML Schema"] = 605,
    ["Rancher Fleet"] = 408,
    Ray = 575,
    ["Read the Docs"] = 409,
    ["Red-DiscordBot Cog"] = 413,
    ["Red-DiscordBot Cog Repo"] = 414,
    ["Red-DiscordBot Trivia"] = 415,
    Renovate = 424,
    ["Replit schema"] = 418,
    RoadRunner = 425,
    Ruff = 421,
    ["Rust Project"] = 422,
    ["Rust toolchain"] = 427,
    ["SIL Kit Participant Configuration"] = 456,
    SWADL = 478,
    ["Sapphire CLI Config"] = 430,
    ["SauceCTL Configuration"] = 614,
    ["Schema Catalog"] = 443,
    ["Scoop manifest"] = 448,
    ["Semantic Data Fabric (SDF) file"] = 449,
    ["Semgrep Rule"] = 451,
    ["Serenity Code Generator (Sergen)"] = 452,
    ["Serverless Framework Configuration"] = 621,
    ["Serverless Workflow Schema"] = 623,
    ["Settings.paf"] = 454,
    ["Shopware 6 Configuration"] = 624,
    ["Shopware CLI Extension Store Configuration"] = 625,
    ["Shopware CLI Project Store Configuration"] = 626,
    ["Slack app manifest"] = 458,
    Solidarity = 461,
    ["Solution filters"] = 462,
    ["Source Maps v3"] = 463,
    Sourcery = 464,
    SpecIF = 465,
    ["Sponge Mixin configuration"] = 466,
    ["StackHawk Scanner Configuration"] = 620,
    Stale = 470,
    Starship = 471,
    ["Statamic Blueprint"] = 472,
    ["StrmPrivacy Data Connector"] = 665,
    ["StrmPrivacy Data Contract"] = 666,
    ["StrmPrivacy SimpleSchema"] = 663,
    ["StrmPrivacy Stream"] = 664,
    ["StrmPrivacy batch job configuration file"] = 662,
    ["Stryker Mutator"] = 475,
    ["StyleCop Analyzers Configuration"] = 476,
    ["Swagger API 2.0"] = 479,
    TSON = 503,
    ["Talisman configuration"] = 481,
    ["Taskfile YAML Schema"] = 601,
    Taurus = 482,
    ["TestEnvironment.json"] = 491,
    ["Tier.run pricing.json"] = 485,
    Tikibase = 486,
    ["Traefik v2"] = 494,
    ["Traefik v2 File Provider"] = 495,
    Turborepo = 492,
    Tye = 628,
    ["UI5 Manifest"] = 510,
    ["UTAM Page Object"] = 513,
    ["Ubuntu Server Autoinstall"] = 508,
    ["Uniswap Token List"] = 584,
    ["Unreal Engine Uplugin"] = 671,
    ["Unreal Engine Uproject"] = 672,
    Updatecli = 635,
    Uplift = 669,
    ["User Journey Map YAML Schema"] = 604,
    V2Ray = 639,
    ["VSCode Code Snippets"] = 131,
    ["VSIX CLI publishing"] = 526,
    ["Vela Pipeline Configuration"] = 516,
    Vercel = 130,
    ["Web App Manifest"] = 533,
    ["Web types"] = 536,
    WebExtensions = 532,
    ["Webman package recipe"] = 645,
    ["Windows Package Manager Installer Manifest"] = 581,
    ["Windows Package Manager Locale Manifest"] = 582,
    ["Windows Package Manager Singleton Manifest"] = 580,
    ["Woodpecker pipeline config"] = 616,
    ["Xstate Machine Schema"] = 633,
    ["Yippee-Ki-JSON configuration YML"] = 586,
    ["angular.json"] = 11,
    ...
    ["bamboo-spec"] = 59,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 677,
    ["bashly-strings.yml"] = 678,
    ["bashly.yml"] = 676,
    ["batect.yml"] = 58,
    ["beau.yml"] = 594,
    ["beef-database-codegen"] = 60,
    ["beef-database-v5-codegen"] = 62,
    ["beef-entity-codegen"] = 61,
    ["beef-entity-v5-codegen"] = 63,
    ["behat.yml"] = 71,
    ["bigquery-table"] = 64,
    ["bitbucket-pipelines"] = 65,
    bitrise = 66,
    ["bitrise-step"] = 67,
    ["block.json"] = 81,
    ["bower.json"] = 69,
    ["bozr.suite.json"] = 72,
    ["browser.i18n.json"] = 73,
    bucklescript = 74,
    ["bundleconfig.json"] = 79,
    ["chutzpah.json"] = 138,
    clangd = 121,
    ["cloud-init: cloud-config userdata JSON schema"] = 123,
    ["cloud-sdk-pipeline-config-schema"] = 140,
    ["cloudbuild.json"] = 141,
    cloudify = 122,
    codemagic = 124,
    ["coffeelint.json"] = 147,
    ...
    ["compilerconfig.json"] = 132,
    ["component-detection-manifest.json"] = 150,
    ["component.json"] = 149,
    ["composer.json"] = 148,
    ["config.json"] = 151,
    ["contentmanifest.json"] = 139,
    ["contribute.json"] = 152,
    ["cosmos.config.json"] = 136,
    ["crowdin.yml"] = 153,
    cspell = 159,
    ["cypress.json"] = 157,
    ["datalogic-scan2deploy-android"] = 165,
    ["datalogic-scan2deploy-ce"] = 166,
    ["dbt Project"] = 98,
    ["debugsettings.json"] = 167,
    ["dependabot-v2.json"] = 170,
    ["dependabot.json"] = 169,
    ["deployed-cli"] = 632,
    ["detekt.yml"] = 172,
    ["devcontainer.json"] = 126,
    devinit = 588,
    ["devspace.yaml"] = 653,
    ["docfx.json"] = 176,
    ["docker-compose.yml"] = 587,
    ["docker-seq schema"] = 175,
    ["dockerd.json"] = 174,
    ["dotnet Release Index manifest"] = 185,
    ["dotnetcli.host.json"] = 186,
    ["drone.json"] = 187,
    ["dss-2.0.0.json"] = 189,
    ["dstack Workflows"] = 190,
    ["dvc.yaml"] = 191,
    ["ecosystem.json"] = 196,
    eksctl = 197,
    ["electron-builder configuration file."] = 202,
    ["epr-manifest.json"] = 200,
    ["evcc.yaml"] = 203,
    ["ezd schema"] = 205,
    ["fabric.mod.json"] = 208,
    ["first-timers-bot"] = 211,
    ["flagd flag configuration"] = 51,
    ["fly.io Schema"] = 52,
    fulibWorkflows = 615,
    ["function.json"] = 220,
    ["geojson.json"] = 224,
    ["gitlab-ci"] = 233,
    ["global.json"] = 235,
    ["golangci-lint Configuration"] = 236,
    ["haxelib.json"] = 249,
    helmfile = 577,
    ["host-meta.json"] = 254,
    ["host.json"] = 253,
    ...
    ["ide.host.json"] = 259,
    ["ifstate.conf"] = 260,
    ["imageoptimizer.json"] = 261,
    ["importmap.json"] = 264,
    ["ioBroker Configuration"] = 265,
    ["ioBroker JSON UI"] = 266,
    ["ioBroker Package manifest"] = 267,
    ["ize.toml"] = 668,
    ["jsconfig.json"] = 288,
    ["jscpd Configuration Schema"] = 650,
    jsdoc = 574,
    ["k3d.yaml"] = 289,
    ["kontinuous-values.yaml"] = 294,
    ["kustomization.yaml"] = 295,
    ["label-commenter-config.yml"] = 296,
    ["launchsettings.json"] = 297,
    ["lego.json"] = 298,
    ["lerna.json"] = 299,
    ["lgtm.yml"] = 300,
    ["libman.json"] = 301,
    ["license-report-config.json"] = 302,
    ["linkinator.config.json"] = 303,
    ["local.settings.json"] = 308,
    ["localazy.json"] = 309,
    ["lotus.yaml"] = 307,
    ["lsdlschema.json"] = 310,
    ["markdown-lint-check"] = 612,
    mboats = 619,
    ["micro-settings.json"] = 679,
    ["mimetypes.json"] = 317,
    ["mirrord-schema"] = 557,
    ["mta.yaml"] = 558,
    ["mtad.yaml"] = 559,
    ["mycode.json"] = 338,
    ["napari plugin manifest"] = 339,
    neoload = 569,
    ["nest-cli"] = 345,
    ["ninjs (News in JSON) 1.3"] = 344,
    ["ninjs (News in JSON) 2.0"] = 343,
    ["nlu.json"] = 346,
    ["nodemon.json"] = 348,
    ["noodl.schema.json"] = 618,
    now = 565,
    ["npm-badges"] = 351,
    ["nswag.json"] = 354,
    ntangle = 355,
    ["nuclei-template.yaml"] = 352,
    ["nuget-project.json"] = 353,
    ["ocelot.json"] = 357,
    ["omnisharp.json"] = 358,
    ["openapi.json"] = 359,
    ["openfin.json"] = 362,
    ["openrpc.json"] = 360,
    ["package.json"] = 373,
    ["package.manifest"] = 374,
    ["pattern.json"] = 378,
    ["petstore-v1.0"] = 660,
    pgap_yaml_input_reader = 377,
    ["plagiarize-me.yaml"] = 382,
    ["plagiarize.yaml"] = 381,
    ["portman.json"] = 383,
    ["prettierrc.json"] = 390,
    ["prisma.yml"] = 391,
    ["project-1.0.0-beta3.json"] = 393,
    ["project-1.0.0-beta4.json"] = 394,
    ["project-1.0.0-beta5.json"] = 395,
    ["project-1.0.0-beta6.json"] = 396,
    ["project-1.0.0-beta8.json"] = 397,
    ["project-1.0.0-rc1.json"] = 398,
    ["project-1.0.0-rc2.json"] = 399,
    ["project.json"] = 392,
    ["prometheus.json"] = 400,
    ["prometheus.rules.json"] = 401,
    ["proxies.json"] = 402,
    ["publiccode.yml"] = 403,
    ["pubspec.yaml"] = 404,
    ["pyrseas-0.8.json"] = 407,
    ["quilt.mod.json"] = 680,
    ["release drafter"] = 570,
    rtx = 420,
    rustfmt = 426,
    samt = 428,
    samtrc = 429,
    ["sarif-1.0.0.json"] = 431,
    ["sarif-2.0.0.json"] = 432,
    ["sarif-2.1.0"] = 441,
    ["sarif-2.1.0-rtm.2"] = 433,
    ["sarif-2.1.0-rtm.3"] = 435,
    ["sarif-2.1.0-rtm.4"] = 437,
    ["sarif-2.1.0-rtm.5"] = 439,
    ["sarif-external-property-file-2.1.0"] = 442,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 434,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 436,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 438,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 440,
    ["schema.org - Action"] = 444,
    ["schema.org - ContactPoint"] = 445,
    ["schema.org - Place"] = 446,
    ["schema.org - Thing"] = 447,
    ["semantic-release"] = 450,
    ["servicehub.config.json"] = 546,
    ["servicehub.service.json"] = 545,
    ["settings.job"] = 453,
    ["sfdx-hardis configuration"] = 455,
    ["size-limit configuration"] = 457,
    ["skaffold.yaml"] = 610,
    ["skyuxconfig.json"] = 459,
    snapcraft = 460,
    ["stripe-app-local.json"] = 474,
    ["stripe-app.json"] = 473,
    swcrc = 597,
    ["task.json"] = 480,
    taskcat = 566,
    ["template.json"] = 483,
    ["templatsources.json"] = 484,
    ["theme.json"] = 487,
    ["tizen_workspace.json"] = 488,
    tldr = 489,
    tmLanguage = 490,
    tmuxinator = 554,
    ["transcend.yml"] = 496,
    ["trunk.yaml schema"] = 497,
    ["ts-force-config.json"] = 501,
    ["tsconfig.json"] = 498,
    ["tsd.json"] = 499,
    ["tsdrc.json"] = 500,
    ["tslint.json"] = 502,
    ...
    ["vega-lite.json"] = 515,
    ["vega.json"] = 514,
    ["venvironment-basic.yaml"] = 518,
    ["venvironment.yaml"] = 517,
    ["version.json"] = 519,
    ["vim-addon-info"] = 520,
    ["vs-2017.3.host.json"] = 522,
    ["vs-nesting.json"] = 523,
    ["vsls.json"] = 521,
    ["vss-extension.json"] = 527,
    ["vtesttree.yaml"] = 528,
    ["vtestunit.yaml"] = 529,
    ["webhint.io"] = 646,
    ["webjobpublishsettings.json"] = 535,
    ["webjobs-list.json"] = 534,
    ["xs-app.json"] = 562,
    ["xunit.runner.json"] = 544,
    yamllint = 585,
    zuul = 571,
    ["Žinoma"] = 579
  },
