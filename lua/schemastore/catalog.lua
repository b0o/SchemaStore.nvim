...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 181,
    [".cryproj (generic)"] = 623,
    [".cryproj engine-5.2"] = 618,
    [".cryproj engine-5.3"] = 619,
    [".cryproj engine-5.4"] = 620,
    [".cryproj engine-5.5"] = 621,
    [".cryproj engine-dev"] = 622,
    [".csscomb.json"] = 183,
    [".csslintrc"] = 184,
    [".es6importsorterrc.json"] = 755,
    [".eslintrc"] = 233,
    [".esmrc.json"] = 225,
    [".ffizer.yaml"] = 237,
    [".htmlhintrc"] = 290,
    ...
    [".pmbot.yml"] = 431,
    [".postcssrc"] = 437,
    [".powerpages-web-template-manifest"] = 439,
    [".pre-commit-config.yml"] = 440,
    [".pre-commit-hooks.yml"] = 441,
    [".putout.json"] = 461,
    [".rehyperc"] = 473,
    [".remarkrc"] = 475,
    [".sprite files"] = 531,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 696,
    ["All Contributors configuration file"] = 754,
    ...
    ["Azure Pipelines"] = 60,
    ["Azure Static Web Apps CLI configuration file"] = 534,
    ["Azure Static Web Apps configuration file"] = 533,
    ["BX CI"] = 96,
    ["Better Code Hub"] = 668,
    ["Better Scripts"] = 97,
    Bigconfig = 77,
    BizTalkServerApplicationSchema = 638,
    Bleep = 98,
    ...
    ["Butane Config"] = 709,
    ["CICS TS region tagging"] = 718,
    ["CICS TS resource import"] = 719,
    ["CICS TS resource model"] = 720,
    ["CICS TS resource overrides"] = 721,
    ["CMake Presets"] = 99,
    ["CNC Codes"] = 109,
    ...
    ["Databricks Asset Bundles"] = 775,
    ["Datadog Service Definition"] = 330,
    ["Datahub Ingestion Recipe"] = 725,
    ["Dein Config"] = 115,
    Deno = 194,
    ["Deployer Recipe"] = 197,
    ["Deta Spacefile"] = 116,
    ...
    ["Goreleaser Pro"] = 272,
    Goss = 273,
    ["Gradle Build Cache Node"] = 666,
    ["Gradle Enterprise"] = 665,
    ...
    Hadolint = 647,
    Hammerkit = 675,
    ["Hardware Sentry Configuration"] = 729,
    Hatch = 648,
    Hayson = 285,
    ...
    ["JFrog File Spec"] = 310,
    ["JFrog Pipelines YML DSL"] = 738,
    ["JMeter DSL cli config"] = 311,
    JReleaser = 313,
    ["JSON Document Transform"] = 320,
    ["JSON Feed"] = 321,
    ["JSON Resume"] = 481,
    ["JSON Schema Draft 2020-12"] = 614,
    ["JSON Schema Draft 4"] = 611,
    ["JSON Schema Draft 7"] = 612,
    ["JSON Schema Draft 7 (unofficial strict)"] = 776,
    ["JSON Schema Draft 8 (2019-09)"] = 613,
    ["JSON-API"] = 319,
    ["JSON-e templates"] = 673,
    ["JSON-stat 2.0"] = 608,
    JSONPatch = 323,
    Jasmine = 303,
    Jekyll = 304,
    ...
    Kas = 326,
    ["Keycloak REST API"] = 746,
    ["Knative Functions - func.yaml"] = 250,
    ["KoDE/CI build.yaml"] = 734,
    ["Kong DBLess config"] = 735,
    KrakenD = 329,
    LOOBin = 347,
    Lefthook = 337,
    ...
    ["Minecraft Custom Main Menu Mod"] = 783,
    ...
    ["MongoDB Atlas Search Index Definition"] = 733,
    ["Monika Configuration"] = 731,
    ["Motif config"] = 631,
    ["NOX Framework (Service)"] = 396,
    ["Netin Diagnostic System Template"] = 690,
    ["Netlify config"] = 387,
    ...
    ["OpenUtau ustx"] = 409,
    ["OpenWeather Current Weather API"] = 672,
    ["OpenWeather Road Risk API"] = 671,
    ...
    ["Pipeline component"] = 682,
    ["PocketMine plugin.yml"] = 432,
    Poetry = 433,
    ["Postman collection"] = 438,
    ["Problem object RFC9457"] = 780,
    ["Problem package generators"] = 445,
    Pterodactyl = 728,
    ["Pull Request Labeler"] = 460,
    Pulumi = 466,
    PyProject = 467,
    Pyright = 468,
    Qgoda = 469,
    Qodana = 701,
    ["Quali Torque Blueprint Spec 2"] = 726,
    ["QueryFirst config file"] = 749,
    ["RKE Cluster Configuration JSON"] = 679,
    ["RKE Cluster Configuration YAML"] = 678,
    ["Rancher Fleet"] = 463,
    Ray = 646,
    ["Read the Docs"] = 465,
    ["Red-DiscordBot Cog"] = 470,
    ["Red-DiscordBot Cog Repo"] = 471,
    ["Red-DiscordBot Trivia"] = 472,
    RenderCV = 483,
    Renovate = 482,
    ["Replit config"] = 476,
    RoadRunner = 484,
    ...
    ["Rust Project"] = 480,
    ["Rust toolchain"] = 486,
    ["SIL Kit Participant Configuration"] = 519,
    ["SIL Kit Registry Configuration"] = 520,
    SWADL = 545,
    ["Safebox Config"] = 739,
    ["Sapphire CLI Config"] = 489,
    ["SauceCTL Configuration"] = 687,
    ["Schema Catalog"] = 503,
    ["Scoop manifest"] = 508,
    ["Semantic Data Fabric (SDF) file"] = 509,
    ["Semgrep Rule"] = 511,
    ["Serenity Code Generator (Sergen)"] = 512,
    ["Serverless Framework Configuration"] = 695,
    ["Serverless Workflow"] = 697,
    ["Settings.paf"] = 514,
    Setuptools = 515,
    ["Shopware 6 Configuration"] = 698,
    ["Shopware CLI Extension Store Configuration"] = 699,
    ["Shopware CLI Project Store Configuration"] = 700,
    Sigma = 517,
    ["Sigrid scope configuration file"] = 518,
    ["Slack app manifest"] = 522,
    Solidarity = 525,
    ["Solution filters"] = 526,
    ["Source Maps v3"] = 527,
    Sourcery = 528,
    SpecIF = 529,
    ["Sponge Mixin configuration"] = 530,
    StackBlitz = 535,
    ["StackHawk Scanner Configuration"] = 694,
    Stale = 536,
    ["Starlake Data Pipeline"] = 669,
    Starship = 537,
    ["Statamic Blueprint"] = 538,
    ["Stella configuration file"] = 539,
    ["StrmPrivacy Data Connector"] = 743,
    ["StrmPrivacy Data Contract"] = 744,
    ["StrmPrivacy SimpleSchema"] = 741,
    ["StrmPrivacy Stream"] = 742,
    ["StrmPrivacy batch job configuration file"] = 740,
    ["Stryker Mutator"] = 542,
    ["StyleCop Analyzers Configuration"] = 543,
    ["Sublime Syntax"] = 745,
    ["Swagger API 2.0"] = 546,
    TSON = 571,
    TSTyche = 572,
    Talhelper = 548,
    ["Talisman configuration"] = 549,
    ["Taskfile config"] = 674,
    Taurus = 550,
    ["TestEnvironment.json"] = 559,
    ["TextMate Grammar"] = 558,
    ["Tier.run pricing.json"] = 553,
    Tikibase = 554,
    ["Traefik v2"] = 562,
    ["Traefik v2 File Provider"] = 563,
    TunnelHub = 779,
    Turborepo = 560,
    Tye = 702,
    ["UET BuildConfig.json"] = 750,
    ["UI5 Manifest"] = 580,
    ["UNCORS configuration"] = 584,
    ["UTAM Page Object"] = 583,
    ["Ubuntu Server Autoinstall"] = 578,
    ["Uniswap Token List"] = 657,
    ["Unreal Engine Uplugin"] = 751,
    ["Unreal Engine Uproject"] = 752,
    ["Updatecli Compose"] = 710,
    ["Updatecli Policy Manifest"] = 711,
    ["Updatecli Policy Metadata"] = 712,
    Uplift = 748,
    ["User Journey Map"] = 677,
    V2Ray = 716,
    ["VSCode Code Snippets"] = 152,
    ["VSIX CLI publishing"] = 597,
    ["Vela Pipeline Configuration"] = 587,
    Vercel = 151,
    Visivo = 777,
    ["Web App Manifest"] = 604,
    ["Web types"] = 607,
    WebExtensions = 603,
    ["Webman package recipe"] = 722,
    ["Windows Package Manager Installer Manifest"] = 654,
    ["Windows Package Manager Locale Manifest"] = 655,
    ["Windows Package Manager Singleton Manifest"] = 653,
    ["Woodpecker pipeline config"] = 689,
    ["Xstate Machine"] = 708,
    ["Yippee-Ki-JSON configuration YML"] = 659,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    apko = 781,
    ...
    ["bamboo-spec"] = 71,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 759,
    ["bashly-strings.yml"] = 760,
    ["bashly.yml"] = 758,
    ["batect.yml"] = 70,
    ...
    ["lsdlschema.json"] = 351,
    ["madness.yml"] = 757,
    ["markdown-lint-check"] = 685,
    mboats = 692,
    ["micro-settings.json"] = 762,
    ["mimetypes.json"] = 358,
    ["mirrord config"] = 628,
    ["monospace.yml"] = 380,
    ["mta.yaml"] = 629,
    ...
    ["pattern.json"] = 430,
    ["petstore-v1.0"] = 737,
    pgap_yaml_input_reader = 429,
    ["plagiarize-me.yaml"] = 435,
    ["plagiarize.yaml"] = 434,
    ["portman.json"] = 436,
    ["prettierrc.json"] = 443,
    ["prisma.yml"] = 444,
    ["project-1.0.0-beta3.json"] = 447,
    ["project-1.0.0-beta4.json"] = 448,
    ["project-1.0.0-beta5.json"] = 449,
    ["project-1.0.0-beta6.json"] = 450,
    ["project-1.0.0-beta8.json"] = 451,
    ["project-1.0.0-rc1.json"] = 452,
    ["project-1.0.0-rc2.json"] = 453,
    ["project.json"] = 446,
    ["prometheus.json"] = 454,
    ["prometheus.rules.json"] = 455,
    ["prometheus.rules.test.json"] = 456,
    ["proxies.json"] = 457,
    ["publiccode.yml"] = 458,
    ["pubspec.yaml"] = 459,
    ["pyrseas-0.8.json"] = 462,
    ["quilt.mod.json"] = 763,
    ["release drafter"] = 641,
    ["release-plz.toml"] = 474,
    rtx = 478,
    rustfmt = 485,
    samt = 487,
    samtrc = 488,
    ["sarif-1.0.0.json"] = 490,
    ["sarif-2.0.0.json"] = 491,
    ["sarif-2.1.0"] = 501,
    ["sarif-2.1.0-rtm.2"] = 492,
    ["sarif-2.1.0-rtm.3"] = 494,
    ["sarif-2.1.0-rtm.4"] = 496,
    ["sarif-2.1.0-rtm.5"] = 498,
    ["sarif-2.1.0-rtm.6"] = 499,
    ["sarif-external-property-file-2.1.0"] = 502,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 493,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 495,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 497,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 500,
    ["schema.org - Action"] = 504,
    ["schema.org - ContactPoint"] = 505,
    ["schema.org - Place"] = 506,
    ["schema.org - Thing"] = 507,
    ["scikit-build"] = 693,
    ["secrethub.yml"] = 765,
    ["semantic-release"] = 510,
    ["servicehub.config.json"] = 617,
    ["servicehub.service.json"] = 616,
    ["settings.job"] = 513,
    ["sfdx-hardis configuration"] = 516,
    ["size-limit configuration"] = 521,
    ["skaffold.yaml"] = 683,
    ["skyuxconfig.json"] = 523,
    snapcraft = 524,
    ["sqlc configuration"] = 532,
    ["stripe-app-local.json"] = 541,
    ["stripe-app.json"] = 540,
    swcrc = 670,
    syntax = 767,
    ["task.json"] = 547,
    taskcat = 637,
    ["template.json"] = 551,
    ["templatsources.json"] = 552,
    ["theme.json"] = 555,
    ["tizen_workspace.json"] = 556,
    tldr = 557,
    tmuxinator = 625,
    ["transcend.yml"] = 564,
    ["trunk.yaml"] = 565,
    ["ts-force-config.json"] = 569,
    ["tsconfig.json"] = 566,
    ["tsd.json"] = 567,
    ["tsdrc.json"] = 568,
    ["tslint.json"] = 570,
    ...
    ["vega-lite.json"] = 586,
    ["vega.json"] = 585,
    ["venvironment-basic.yaml"] = 589,
    ["venvironment.yaml"] = 588,
    ["version.json"] = 590,
    ["vim-addon-info"] = 591,
    ["vs-2017.3.host.json"] = 593,
    ["vs-nesting.json"] = 594,
    ["vsls.json"] = 592,
    ["vss-extension.json"] = 598,
    ["vtesttree.yaml"] = 599,
    ["vtestunit.yaml"] = 600,
    ["warp-keysets.json"] = 771,
    ["warp-themes.json"] = 772,
    ["warp-workflows.json"] = 773,
    ["webhint.io"] = 723,
    ["webjobpublishsettings.json"] = 606,
    ["webjobs-list.json"] = 605,
    ["xs-app.json"] = 633,
    ["xunit.runner.json"] = 615,
    yamllint = 658,
    zuul = 642,
    ["Žinoma"] = 652
  },
