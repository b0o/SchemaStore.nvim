...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 933,
    [".nodehawkrc"] = 576,
    [".npmpackagejsonlintrc"] = 580,
    [".omletrc"] = 1112,
    [".phrase.yml"] = 654,
    [".phraseapp.yml"] = 655,
    [".pmbot.yml"] = 640,
    [".postcssrc"] = 649,
    [".powerpages-web-template-manifest"] = 651,
    [".pre-commit-config.yml"] = 652,
    [".pre-commit-hooks.yml"] = 653,
    [".putout.json"] = 688,
    [".rehyperc"] = 713,
    [".remarkrc"] = 717,
    [".sprite files"] = 808,
    ...
    [".vsconfig"] = 897,
    [".vsext"] = 898,
    ["1Password SSH Agent Config"] = 9,
    ["@factorial/drupal-breakpoints-css"] = 16,
    ["A micro editor config"] = 523,
    ABCClinicalDemandForecast = 25,
    ABCInventoryModuleData = 24,
    ABCSupplyPlan = 26,
    ["ACP Attempts"] = 27,
    ["ACP Cache File"] = 28,
    ["ACP Configuration File"] = 29,
    ["ACP Primer"] = 30,
    ["ACP Sync"] = 31,
    ["ACP Variables File"] = 32,
    AIConfig = 33,
    ["AMX Muse Program Descriptor"] = 1160,
    ["API Builder"] = 968,
    ["AVA Configuration"] = 1031,
    ["AWS AppConfig Feature Flags-v1"] = 67,
    ["AWS CDK cdk.json"] = 257,
    ["AWS CloudFormation"] = 258,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 259,
    ["AWS Copilot Manifest"] = 1199,
    ["AWS SAM CLI Samconfig"] = 260,
    ["Adobe UXP Manifest"] = 1094,
    ["Aerleon Network & Service Definitions"] = 19,
    ["Aerleon Policy"] = 20,
    Aider = 1189,
    Air = 22,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1210,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1209,
    ["Airlock Microgateway"] = 34,
    ["Alacritty Configuration"] = 1003,
    ["All Contributors configuration file"] = 1057,
    ["Ansible Argument Specs"] = 396,
    ["Ansible Collection Galaxy"] = 403,
    ["Ansible Execution Environment"] = 393,
    ["Ansible Inventory"] = 402,
    ["Ansible Meta"] = 394,
    ["Ansible Meta Runtime"] = 395,
    ["Ansible Navigator Configuration"] = 405,
    ["Ansible Playbook"] = 400,
    ["Ansible Requirements"] = 397,
    ["Ansible Rulebook"] = 401,
    ["Ansible Tasks File"] = 399,
    ["Ansible Vars File"] = 398,
    ["Ansible-lint Configuration"] = 404,
    Any = 1122,
    ["AnyWork Automation Configuration"] = 15,
    ["Apollo Router"] = 969,
    ["App config Spotify Backstage"] = 38,
    ["Applicant Profile Protocol"] = 12,
    ["Application Accelerator"] = 10,
    ["Application list for a WinUtil"] = 1139,
    ArchitectFX = 1144,
    ["Argo CD"] = 53,
    ["Argo Events"] = 54,
    ["Argo Workflows"] = 55,
    AssemblyScript = 58,
    AsyncAPI = 61,
    ["AsyncAPI Tool File"] = 62,
    ["Atmos Manifests"] = 63,
    ["Aurora Agile Meta-Framework"] = 64,
    AutoAPICase = 1067,
    ["Avro Avsc"] = 65,
    ["Awesome Repositories"] = 66,
    ["Azure Container App template for defining an immutable revision"] = 68,
    ["Azure DevOps extension manifest"] = 71,
    ["Azure Device Update for IoT Hub import manifest"] = 69,
    ["Azure Device Update for IoT Hub update manifest"] = 70,
    ["Azure IoT Edge deployment"] = 74,
    ["Azure IoT Edge deployment template"] = 75,
    ["Azure IoT EdgeAgent deployment"] = 72,
    ["Azure IoT EdgeHub deployment"] = 73,
    ["Azure IoT Operations Wasm Graph Config"] = 1208,
    ["Azure IoT Operations connector metadata"] = 1205,
    ["Azure Landing Zones Library archetype definition"] = 79,
    ["Azure Landing Zones Library archetype override"] = 80,
    ["Azure Landing Zones Library architecture definition"] = 78,
    ["Azure Landing Zones Library metadata"] = 76,
    ["Azure Landing Zones Library policy default values"] = 77,
    ["Azure Pipelines"] = 109,
    ["Azure Static Web Apps CLI configuration file"] = 812,
    ["Azure Static Web Apps configuration file"] = 811,
    BMML = 1227,
    ["BOSH CPI Config"] = 134,
    ["BOSH Deploy Config"] = 135,
    ["BX CI"] = 154,
    ["Bacon config"] = 4,
    ["Bashly (bashly.yml)"] = 1061,
    ["Bashly Settings (bashly-settings.yml)"] = 1062,
    Bento = 1226,
    ["Better Code Hub"] = 973,
    ["Better Scripts"] = 155,
    Bigconfig = 127,
    ["Biome Formatter Config"] = 81,
    ["Bitmovin Encoding Template"] = 1153,
    BizTalkServerApplicationSchema = 940,
    Bleep = 156,
    ["Block Protocol Metadata"] = 153,
    ["Bluebricks blueprint config"] = 1232,
    ["Boyka Framework"] = 136,
    Briefcase = 946,
    ["Build Info"] = 144,
    Buildkite = 146,
    ["Bukkit plugin.yml"] = 145,
    ["BungeeCord plugin.yml"] = 151,
    ["Butane Config"] = 1016,
    C4InterFlow = 1168,
    ["CDK Environment Manager, concrete environment configuration"] = 1192,
    ["CDK Environment Manager, concrete environments definition"] = 1191,
    ["CDK Environment Manager, environment definition"] = 1190,
    ["CGS Card Game Specification (cgs.json)"] = 1099,
    ["CICS TS region tagging"] = 1025,
    ["CICS TS resource import"] = 1026,
    ["CICS TS resource model"] = 1027,
    ["CICS TS resource overrides"] = 1028,
    ["CMake Presets"] = 157,
    ["CNC Codes"] = 179,
    ["CRS WAF test file"] = 1129,
    ["CRS WAF test platform overrides file"] = 1130,
    ["CSS Comb (.csscomb.json)"] = 285,
    ["CSS Lint (.csslintrc)"] = 286,
    ["CSpell (cspell.json)"] = 284,
    ["CVE Record Format"] = 188,
    CWL = 1105,
    ["Cache Warmup config"] = 158,
    ["Calqulus pipeline"] = 159,
    ["Camel YAML DSL"] = 160,
    ["Cannon TOML"] = 161,
    Carafe = 162,
    ["Cargo Make"] = 164,
    ["Cargo Manifest"] = 163,
    ["Catalog Info Backstage"] = 165,
    ["Chamaleon environment"] = 1157,
    ["Chamaleon properties"] = 1158,
    ["Chamaleon template"] = 1156,
    Changepacks = 1219,
    Changesets = 269,
    Changie = 166,
    Charmcraft = 167,
    Cheatsheets = 1013,
    ["ChordPro Configuration"] = 168,
    ["Chrome Extension"] = 250,
    ["Chromia Model"] = 169,
    ["Chromia Seeder Module Config"] = 171,
    ["Chromia Seeder Root Config"] = 170,
    ["Cinnamon Spice info.json"] = 89,
    ["CircleCI config.yml"] = 225,
    ["Citation File Format"] = 271,
    ["Citrus test case"] = 173,
    CityJSON = 174,
    ["Claude Code Keybindings"] = 186,
    ["Claude Code Settings"] = 187,
    ["Clawject config"] = 185,
    ["Cloud Foundry Application Manifest"] = 1111,
    ["Cloud Run Spec v1"] = 1134,
    ["Cloud.gov Workshop Configuration"] = 90,
    ["CloudCannon Configuration"] = 95,
    ["CloudCannon Configuration (Collection Structures)"] = 104,
    ["CloudCannon Configuration (Collections)"] = 103,
    ["CloudCannon Configuration (Editables)"] = 102,
    ["CloudCannon Configuration (Inputs)"] = 97,
    ["CloudCannon Configuration (Snippets Definitions)"] = 101,
    ["CloudCannon Configuration (Snippets Imports)"] = 100,
    ["CloudCannon Configuration (Snippets)"] = 99,
    ["CloudCannon Configuration (Structure Value)"] = 98,
    ["CloudCannon Configuration (Structures)"] = 96,
    ["CloudEvents specification"] = 175,
    ["Code Climate"] = 226,
    CodeCV = 93,
    CodeRabbit = 92,
    ["CodeShip Pro services configuration files"] = 239,
    ["CodeShip Pro steps configuration files"] = 240,
    ["Codecov configuration files"] = 238,
    Codex = 234,
    CodifyCLI = 94,
    Codux = 236,
    ["Cog config file"] = 180,
    ["Commandbox Box.json"] = 181,
    ["Commandbox Server.json"] = 182,
    ["Common Catalog Data"] = 248,
    ["Common Package Specification"] = 183,
    Concord = 1128,
    ["Configu .cfgu files"] = 1116,
    ["Configu .configu file"] = 1117,
    Conjure = 178,
    ["Container Structure Test"] = 954,
    Containerlab = 982,
    ["Contextive Glossary"] = 1184,
    Convex = 177,
    ["Crowdsec collection config"] = 279,
    ["Crowdsec parser config"] = 280,
    ["Crowdsec scenario config"] = 281,
    ["CumulusCI Config"] = 184,
    ["Custom Machinery Machine"] = 1100,
    ["Custom Machinery Recipe"] = 1101,
    ["Cycle Stack File"] = 189,
    CycloneDX = 190,
    ["DWP Exchange - catalogue entry"] = 330,
    ["DWP Exchange - gateway"] = 328,
    ["DWP Exchange - meta"] = 329,
    ["Dart Build Config (dart-build.json)"] = 287,
    ["Dart Test Config (dart-test.json)"] = 288,
    ["DashLord Configuration"] = 289,
    ["Data Contract Specification"] = 290,
    ["Data Product Specification"] = 291,
    ["DataYoga Connections"] = 191,
    ["DataYoga Job"] = 192,
    ["Databricks Asset Bundles"] = 1078,
    ["Datadog Continuous Testing"] = 494,
    ["Datadog Service Definition"] = 495,
    ["Datadog Software Catalog"] = 496,
    ["Datahub Ingestion Recipe"] = 1032,
    ["Debian Upstream Metadata file"] = 199,
    ["Deck config"] = 200,
    ["DeepMatch deeplinks spec"] = 201,
    ["Dein Config"] = 202,
    ["Deno Config (deno.json)"] = 297,
    ["Dependency cruiser"] = 203,
    ["DeployStack Configuration"] = 204,
    ["Deployah Configuration"] = 1207,
    ["Deployer Recipe"] = 300,
    ["Deta Spacefile"] = 205,
    ["Detekt Config (detekt.yml)"] = 301,
    ["Devbox Config"] = 206,
    ["Devbox Plugin"] = 207,
    Devfile = 327,
    Devup = 1220,
    DipDup = 1131,
    ["Discord Webhook"] = 302,
    ["DocFx Config (docfx.json)"] = 307,
    ["Docker Desktop extension metadata"] = 304,
    ["Docs MCP Manifest"] = 308,
    Dofigen = 309,
    ["Dolittle Artifacts"] = 310,
    ["Dolittle Bounded Context Configuration"] = 311,
    ["Dolittle Event Horizons Configuration"] = 312,
    ["Dolittle Resources Configuration"] = 313,
    ["Dolittle Server Configuration"] = 314,
    ["Dolittle Tenant Map Configuration"] = 316,
    ["Dolittle Tenants Configuration"] = 315,
    ["Dolittle Topology"] = 317,
    ["DonateCaseBetterCasino menu"] = 1161,
    ["Drupal Breakpoints"] = 208,
    ["Drupal Config"] = 220,
    ["Drupal Info"] = 209,
    ["Drupal Layouts"] = 210,
    ["Drupal Libraries"] = 211,
    ["Drupal Links Action"] = 212,
    ["Drupal Links Contextual"] = 213,
    ["Drupal Links Menu"] = 214,
    ["Drupal Links Task"] = 215,
    ["Drupal Migration"] = 216,
    ["Drupal Permissions"] = 217,
    ["Drupal Recipe"] = 218,
    ["Drupal Routing"] = 219,
    ["Drupal Services"] = 221,
    ["Drush site aliases"] = 323,
    ["Dynamic Bash Aliases (.aliases)"] = 1069,
    ["EAS config"] = 348,
    ["ECA - Editor Code Assistant"] = 332,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1058,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1204,
    ["EasyVCR .NET"] = 349,
    ["Eidolon Resource"] = 1145,
    ["Elgato Stream Deck"] = 334,
    Elm = 1133,
    ["Embrace Config"] = 1044,
    Endurica = 1082,
    ["Enterprise Contract Policy Spec"] = 335,
    ["Erda Pipeline"] = 1107,
    ["Erda Runtime"] = 1108,
    ["Espanso config.yml"] = 1230,
    ["Espanso match.yml"] = 1229,
    Esquio = 337,
    ["Estuary Flow Catalog"] = 1022,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 341,
    ["EveryVoice TTS Toolkit Data Configuration"] = 342,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 346,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 345,
    ["EveryVoice TTS Toolkit Text Configuration"] = 343,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 344,
    ["Evolving Resolutive Process notation"] = 1206,
    ["Expo SDK"] = 347,
    ["F-Droid Data metadata"] = 353,
    ["FasterCI Configuration"] = 110,
    FiQuS = 357,
    Firebase = 355,
    ["Flatpak Builder Manifest"] = 358,
    ["FlexGet Config"] = 359,
    ["Flow.json Configurations"] = 1104,
    ["Fossa configuration file"] = 366,
    ["Fossa's fossa-deps file"] = 367,
    ["Foundry VTT - Base package Manifest"] = 361,
    ["Foundry VTT - Module Manifest"] = 362,
    ["Foundry VTT - System Data Template"] = 365,
    ["Foundry VTT - System Manifest"] = 363,
    ["Foundry VTT - World Manifest"] = 364,
    ["Foxx Manifest"] = 111,
    ["Freifunk.de Community API"] = 114,
    ["Frogbot Config"] = 115,
    ["G2P Mapping Configuration"] = 373,
    ["GCP Blueprint Metadata"] = 376,
    Gaspar = 374,
    ["GatewayCore API Gateway"] = 375,
    ["Gemini CLI settings"] = 377,
    ["GeoJSON.json latest"] = 1020,
    GherKing = 1024,
    ["GitHub Action"] = 382,
    ["GitHub Actions typing"] = 1141,
    ["GitHub Discussion"] = 383,
    ["GitHub Funding"] = 384,
    ["GitHub Issue Template configuration"] = 385,
    ["GitHub Issue Template forms"] = 386,
    ["GitHub Workflow"] = 387,
    ["GitHub Workflow Template Properties"] = 388,
    ["GitHub automatically generated release notes configuration"] = 389,
    ["GitLab Agent for Kubernetes configuration"] = 1096,
    GitVersion = 379,
    ["Gitea Issue Template configuration"] = 380,
    ["Gitea Issue Template forms"] = 381,
    ["Gitpod Automations"] = 391,
    ["Gitpod Configuration"] = 392,
    ["GlazeWM settings"] = 1098,
    ["Global Privacy Control"] = 378,
    Goblet = 1077,
    ["Golangci-lint Configuration"] = 407,
    ["Golangci-lint Custom Plugins Configuration"] = 408,
    ["Google Chrome Related Website Sets"] = 356,
    ["Google Cloud Workflows"] = 256,
    ["Google Digital Assetlinks"] = 1185,
    Goreleaser = 410,
    ["Goreleaser Pro"] = 411,
    Goss = 412,
    ["Gradle Build Cache Node"] = 971,
    ["Gradle Enterprise"] = 970,
    ["Grafana 5.x Dashboard"] = 413,
    ["GraphQL Code Generator"] = 418,
    ["GraphQL Config"] = 417,
    ["GraphQL Mesh"] = 416,
    ["GroovyLint configuration"] = 419,
    ["Grunt JSHint task"] = 423,
    ["Grunt Watch task"] = 424,
    ["Grunt base task"] = 425,
    ["Grunt clean task"] = 421,
    ["Grunt copy task"] = 420,
    ["Grunt cssmin task"] = 422,
    HEMTT = 936,
    Hadolint = 950,
    Hammerkit = 981,
    ["Hardware Sentry Configuration"] = 1036,
    ["Hashgraph Online Skill Manifest"] = 1,
    ["HashiCorp Vault"] = 426,
    Hatch = 951,
    Hayson = 428,
    ["Haystack Pipeline"] = 429,
    ["Hazelcast 5 Configuration"] = 430,
    ["Hecate Input Schema"] = 1196,
    ["Helm Chart.lock"] = 223,
    ["Helm Chart.yaml"] = 222,
    ["Helm Unittest Test Suite"] = 224,
    ["Home Assistant Integration Manifest"] = 431,
    ["Homer dashboard configuration"] = 432,
    Hugo = 1012,
    ["Hugo Theme"] = 1011,
    ["Hulak Configuration"] = 439,
    ["Hyperfoil benchmark configuration"] = 438,
    ["IBM Zapp document"] = 440,
    ["IBM zCodeFormatSettings"] = 441,
    ["IMG Catapult PSP"] = 446,
    ["IVMS101 by CODE Protocol"] = 1097,
    Infrahub = 448,
    Istanbul = 1040,
    ["JDownloader2 crawler multi-rules"] = 461,
    ["JDownloader2 crawler single-rules"] = 460,
    ["JFrog Applications Config"] = 462,
    ["JFrog File Spec"] = 463,
    ["JFrog Pipelines YML DSL"] = 1046,
    ["JMeter DSL cli config"] = 464,
    JReleaser = 467,
    ["JSON Document Transform"] = 475,
    ["JSON Feed"] = 476,
    ["JSON Resume"] = 723,
    ["JSON Schema Draft 2020-12"] = 918,
    ["JSON Schema Draft 4"] = 915,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1079,
    ["JSON Schema Draft 7"] = 916,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1080,
    ["JSON Schema Draft 8 (2019-09)"] = 917,
    ["JSON-API"] = 474,
    ["JSON-e templates"] = 978,
    ["JSON-stat 2.0"] = 911,
    JSONPatch = 478,
    ["JSR Package Config (jsr.json)"] = 468,
    Jarl = 1212,
    Jasmine = 455,
    Jekyll = 456,
    ["Jenkins X Pipelines"] = 457,
    ["Jenkins X Requirements"] = 458,
    Jest = 459,
    Jocker = 465,
    ["Jovo Language Models"] = 466,
    ["Jujutsu (jj) VCS config"] = 1198,
    ["KIMMDY config file"] = 489,
    ["KODE/CI build.yaml"] = 1042,
    ["KSP-AVC"] = 912,
    ["KSP-CKAN"] = 913,
    ["KSP-NetKAN"] = 914,
    KSY = 1109,
    KSail = 371,
    ["KYA Manifest"] = 1110,
    ["Karakum configuration file"] = 368,
    Kas = 481,
    ["Kestra flow file"] = 490,
    ["Keycloak REST API"] = 1049,
    ["Knative Functions - func.yaml"] = 369,
    Knip = 370,
    ["Kometa (nightly) config file"] = 492,
    ["Kometa config file"] = 491,
    ["Kong DBLess config"] = 1043,
    KrakenD = 493,
    ["Kubri Configuration"] = 500,
    LOOBin = 515,
    ["Lake configuration file"] = 1201,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 261,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 262,
    ["Landing Zone Accelerator on AWS - Global Config"] = 263,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 264,
    ["Landing Zone Accelerator on AWS - Network Config"] = 265,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 266,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 267,
    ["Landing Zone Accelerator on AWS - Security Config"] = 268,
    ["Lando (landofile)"] = 105,
    ["LangGraph Platform configuration"] = 1121,
    ["Language configuration"] = 1120,
    Lefthook = 504,
    ["Liferay client-extension.yaml"] = 511,
    ["LinkML Metamodel"] = 513,
    Liquibase = 987,
    ["Liquibase Flow File"] = 988,
    ["Lively Properties"] = 514,
    ["Lobe AI Agent"] = 107,
    Loki = 108,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 555,
    ["MS2Rescore Configuration"] = 559,
    ["Madness (madness.yml)"] = 1060,
    ["Mado configuration"] = 521,
    ["Mail Servers Configuration"] = 1233,
    ["MapEHR Mapping"] = 522,
    Markdownlint = 991,
    ["Mason Registry"] = 994,
    ["MegaLinter Custom Flavor"] = 525,
    ["MegaLinter configuration"] = 524,
    ["MegaLinter descriptor"] = 526,
    Melange = 1087,
    ["Meltano project definition"] = 527,
    ["Mergify Configuration"] = 560,
    ["Metadata for a Bazel module"] = 528,
    ["Metadata for a Cinnamon spice"] = 1137,
    ["Metatype Configuration"] = 529,
    ["MetricsHub Configuration"] = 530,
    ["MetricsHub Connector Configuration"] = 531,
    ["Micro Editor Syntax"] = 1070,
    ["Microsoft Band Web Tile"] = 532,
    ["Microsoft RulesEngine workflow rules"] = 1125,
    ["Microsoft RulesEngine workflow rules list"] = 1126,
    ["Minecraft Custom Main Menu Mod"] = 1088,
    ["Minecraft Data Pack Advancement"] = 534,
    ["Minecraft Data Pack Biome"] = 535,
    ["Minecraft Data Pack Configured Carver"] = 536,
    ["Minecraft Data Pack Damage Type"] = 537,
    ["Minecraft Data Pack Dimension"] = 539,
    ["Minecraft Data Pack Dimension Type"] = 538,
    ["Minecraft Data Pack Item Modifier"] = 540,
    ["Minecraft Data Pack Loot Table"] = 541,
    ["Minecraft Data Pack Metadata"] = 542,
    ["Minecraft Data Pack Predicate"] = 543,
    ["Minecraft Data Pack Recipe"] = 544,
    ["Minecraft Data Pack Tag"] = 545,
    ["Minecraft Data Pack Template Pool"] = 546,
    ["Minecraft Data Pack Trim Material"] = 551,
    ["Minecraft Data Pack Trim Pattern"] = 552,
    ["Minecraft Resource Pack Lang"] = 547,
    ["Minecraft Resource Pack Particle"] = 548,
    ["Minecraft Resource Pack Texture Mcmeta"] = 550,
    ["Minecraft Resourcepack Sounds"] = 549,
    ["Monade CLI Stack Configuration"] = 563,
    ["MongoDB Atlas Search Index Definition"] = 1041,
    ["Monika Configuration"] = 1039,
    ["Monoweave Configuration"] = 558,
    ["Motif config"] = 932,
    MultiQC = 1178,
    ["NOX Framework (Service)"] = 579,
    ["Netin Diagnostic System Template"] = 998,
    ["Netlify config"] = 566,
    ["Network-as-Code Data Model"] = 567,
    ["Next Gen UI Agent A2A Server Configuration"] = 568,
    ["Next Gen UI Agent Configuration"] = 570,
    ["Next Gen UI Agent MCP Server Configuration"] = 569,
    ["Nightwatch.js"] = 572,
    ["Node.js configuration"] = 937,
    ["NueJS configuration file"] = 584,
    ["Nuitka.yaml"] = 1102,
    ["Nullstone config"] = 586,
    ["ONe's changelog entry"] = 605,
    ["ONe's service descriptor"] = 604,
    ["ORT Server repository environment configuration"] = 615,
    ["OSCAL Assessment Plan (AP)"] = 617,
    ["OSCAL Assessment Results (AR)"] = 618,
    ["OSCAL Catalog"] = 619,
    ["OSCAL Component Definition (CDef)"] = 620,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 621,
    ["OSCAL Profile"] = 622,
    ["OSCAL System Security Plan (SSP)"] = 623,
    ["OSS Review Toolkit configuration"] = 624,
    ["OSS Review Toolkit curation"] = 625,
    ["OSS Review Toolkit package configuration"] = 626,
    ["OSS Review Toolkit repository configuration"] = 627,
    ["OSS Review Toolkit resolutions"] = 628,
    ["October CMS columns"] = 590,
    ["October CMS fields"] = 591,
    ["Oh My Posh"] = 593,
    Okteto = 594,
    ["Ona Automations"] = 596,
    Opctl = 935,
    ["Open Data Contract Standard (ODCS)"] = 609,
    ["Open Data Product Standard (ODPS)"] = 610,
    ["Open Know-How"] = 1183,
    ["OpenRewrite Resource"] = 607,
    OpenSRM = 611,
    OpenStatus = 1194,
    ["OpenTelemetry Declarative Configuration"] = 608,
    ["OpenUtau character yaml"] = 601,
    ["OpenUtau ustx"] = 602,
    ["OpenWeather Current Weather API"] = 977,
    ["OpenWeather Road Risk API"] = 976,
    ["Ory Hydra configuration"] = 437,
    ["Ory Keto configuration"] = 497,
    ["Ory Kratos configuration"] = 616,
    ["Ory Oathkeeper configuration"] = 588,
    ["Outblocks App configuration"] = 613,
    ["Outblocks database table"] = 614,
    ["Outblocks project configuration"] = 612,
    PDM = 635,
    POPxf = 646,
    ["POPxf Correlations"] = 647,
    Packer = 632,
    Pantsbuild = 1056,
    ["Paper paper-plugin.yml"] = 633,
    ["Pipeline component"] = 989,
    ["Platform.sh application"] = 6,
    ["Platform.sh routes"] = 7,
    ["Platform.sh services"] = 8,
    ["Plex Prerolls"] = 644,
    ["PocketMine plugin.yml"] = 641,
    ["Postman collection"] = 650,
    ["Power Pages Configuration"] = 1195,
    ["Preset list for a WinUtil"] = 1140,
    ["ProActions AI-Kit Configuration"] = 661,
    ["ProActions AI-Kit Configuration for Menus"] = 663,
    ["ProActions AI-Kit Configuration for Sections"] = 665,
    ["ProActions AI-Kit Configuration for Services"] = 662,
    ["ProActions AI-Kit Configuration for Steps"] = 666,
    ["ProActions AI-Kit Configuration for Templates"] = 664,
    ["Problem object RFC9457"] = 1085,
    ["Problem package format"] = 667,
    ["Problem package generators"] = 668,
    ["Problem package submissions"] = 669,
    ["Problem package test group metadata"] = 670,
    Pterodactyl = 1035,
    ["Pull Request Labeler"] = 687,
    Pulumi = 695,
    ["PyGTA Config"] = 691,
    PyProject = 696,
    Pylock = 1186,
    Pyright = 697,
    ["Python script metadata"] = 1180,
    ["QType AI DSL"] = 700,
    Qgoda = 699,
    Qodana = 1008,
    ["Qt Creator workspace file"] = 1118,
    ["Quali Torque Blueprint Spec 2"] = 1033,
    ["QueryFirst config file"] = 1052,
    ["RKE Cluster Configuration JSON"] = 986,
    ["RKE Cluster Configuration YAML"] = 985,
    RadioHound = 690,
    Railpack = 702,
    Railway = 701,
    ["Rancher Fleet"] = 692,
    ...
    Ray = 949,
    ["Read the Docs"] = 694,
    ["Red-DiscordBot Cog"] = 710,
    ["Red-DiscordBot Cog Repo"] = 711,
    ["Red-DiscordBot Trivia"] = 712,
    ["Releasaurus Config"] = 3,
    ["Render Blueprints"] = 984,
    RenderCV = 727,
    Renovate = 724,
    ["Renovate global configuration"] = 725,
    ["Renovate inherited configuration"] = 726,
    ["Replit config"] = 718,
    Restate = 1173,
    ["Revel Digital Gadget Definition File"] = 1197,
    RoadRunner = 729,
    ["Robust Station Image"] = 1203,
    Rockcraft = 730,
    ["Roo Coder Custom Modes"] = 731,
    Rubocop = 720,
    ["Rudder techniques"] = 1092,
    Ruff = 721,
    ["Rust Project"] = 722,
    ["Rust toolchain"] = 735,
    ["SDMX data message"] = 761,
    ["SDMX metadata message"] = 760,
    ["SDMX structure message"] = 759,
    ["SIL Kit Participant Configuration"] = 771,
    ["SIL Kit Registry Configuration"] = 772,
    ["SPDX 2.3"] = 809,
    SWADL = 825,
    ["Safebox Config"] = 1047,
    ["Sapphire CLI Config"] = 738,
    ["SauceCTL Configuration"] = 995,
    ["Schema Catalog"] = 753,
    ["Scoop manifest"] = 758,
    ["Semantic Data Fabric (SDF) file"] = 762,
    ["Semgrep Rule"] = 764,
    ["Serenity Code Generator (Sergen)"] = 765,
    ["Serverless Framework Configuration"] = 1002,
    ["Serverless Workflow"] = 1004,
    ["Settings for a Cinnamon spice"] = 1136,
    ["Settings.paf"] = 767,
    ["Shopware 6 Configuration"] = 1005,
    ["Shopware CLI Extension Store Configuration"] = 1006,
    ["Shopware CLI Project Store Configuration"] = 1007,
    ["Sigma Detection Rule"] = 769,
    ["Sigrid scope configuration file"] = 770,
    ["SkyPilot Task JSON"] = 1093,
    ["Slack app manifest"] = 774,
    Snapcraft = 776,
    Solidarity = 779,
    ["Solution filters"] = 780,
    ["Source Maps v3"] = 781,
    Sourcery = 782,
    ["Spack bootstrap.yaml"] = 783,
    ["Spack cdash.yaml"] = 784,
    ["Spack ci.yaml"] = 785,
    ["Spack compilers.yaml"] = 786,
    ["Spack concretizer.yaml"] = 787,
    ["Spack config.yaml"] = 788,
    ["Spack definitions.yaml"] = 789,
    ["Spack develop.yaml"] = 790,
    ["Spack env_vars.yaml"] = 791,
    ["Spack environment"] = 797,
    ["Spack include.yaml"] = 792,
    ["Spack mirrors.yaml"] = 793,
    ["Spack modules.yaml"] = 794,
    ["Spack packages.yaml"] = 795,
    ["Spack repos.yaml"] = 796,
    ["Spack toolchains.yaml"] = 798,
    ["Spack upstreams.yaml"] = 799,
    ["Spack view.yaml"] = 800,
    ["Speakeasy Generation Config File"] = 804,
    ["Speakeasy Lint Configuration File"] = 801,
    ["Speakeasy Test Generation Configuration File"] = 802,
    ["Speakeasy Workflow File"] = 803,
    SpecIF = 805,
    ["Specmatic Configuration"] = 806,
    ["Sponge Mixin configuration"] = 807,
    StackBlitz = 813,
    ["StackHawk Scanner Configuration"] = 1001,
    Stale = 814,
    Starfish = 815,
    ["Starlake Data Pipeline"] = 974,
    Starship = 816,
    ["Statamic Blueprint"] = 817,
    ["Stella configuration file"] = 818,
    ["Streamlit configuration file"] = 819,
    ["Stryker Mutator"] = 822,
    ["StyleCop Analyzers Configuration"] = 823,
    ["Stylelint (.stylelintrc)"] = 824,
    ["Stylua Config"] = 1187,
    ["Sublime Syntax"] = 1048,
    ["Subsquid squid manifest"] = 1095,
    ["Swagger API 2.0"] = 826,
    ["Synadia Connect Component"] = 827,
    TSON = 863,
    TSTyche = 864,
    ["TYPO3 Vendor Bundler config"] = 870,
    ["Tab data for a LinUtil"] = 1143,
    ["Tab list for a LinUtil"] = 1142,
    Tach = 828,
    ["Tach Domain"] = 829,
    Talhelper = 831,
    ["Talisman configuration"] = 832,
    Taplo = 1188,
    ["Taskfile config"] = 979,
    Taurus = 833,
    Tauticord = 834,
    ["Tekton Pipeline"] = 1216,
    ["Tekton PipelineRun"] = 1217,
    ["Tekton Task"] = 1214,
    ["Tekton TaskRun"] = 1215,
    Telefonistka = 1174,
    ["Terrateam config"] = 1200,
    ["TestEnvironment.json"] = 846,
    ["TextMate Grammar"] = 845,
    Threagile = 840,
    ["Tier.run pricing.json"] = 837,
    Tikibase = 838,
    Tombi = 843,
    ["Traefik v2"] = 849,
    ["Traefik v2 File Provider"] = 850,
    ["Traefik v3"] = 851,
    ["Traefik v3 File Provider"] = 852,
    ["Travis CI (.travis.yml)"] = 848,
    Treefmt = 415,
    Trident = 1170,
    ["TrueScript for *.tscript files"] = 855,
    ["Tugboat QA config.yml"] = 1167,
    TunnelHub = 1083,
    Turborepo = 847,
    Tycho = 1132,
    Tye = 1009,
    ["Tyk Gateway - Open Source v5.7+"] = 1179,
    ["UET BuildConfig.json"] = 1053,
    ["UI5 Manifest"] = 876,
    ["UNCORS configuration"] = 880,
    ["UTAM Page Object"] = 879,
    ["Ubuntu Server Autoinstall"] = 874,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1171,
    ["Uniswap Token List"] = 961,
    ["Universal Schedule Format"] = 881,
    ["Unreal Engine Uplugin"] = 1054,
    ["Unreal Engine Uproject"] = 1055,
    ["UpCloud CLI (upctl) configuration"] = 1172,
    ["Updatecli Compose"] = 1017,
    ["Updatecli Policy Manifest"] = 1018,
    ["Updatecli Policy Metadata"] = 1019,
    Uplift = 1051,
    ["Upsun config"] = 5,
    ["User Journey Map"] = 983,
    V2Ray = 1023,
    ["VSCode Code Snippets"] = 244,
    ["VSIX CLI publishing"] = 899,
    Vector = 883,
    ["Vela Pipeline Configuration"] = 886,
    Vercel = 243,
    ["Version Bumper config"] = 889,
    Vespertide = 1221,
    ["Vespertide Migration"] = 1222,
    ["Vespertide Model"] = 1223,
    ["Viash Component Config"] = 1176,
    ["Viash Package Config"] = 1177,
    Visivo = 1081,
    ["WP-CLI"] = 909,
    Wake = 1169,
    ["Waku Config"] = 1146,
    ["Web App Manifest"] = 905,
    ["Web types"] = 908,
    WebExtensions = 904,
    ["Webman package recipe"] = 1029,
    ["Windows Package Manager Installer Manifest"] = 957,
    ["Windows Package Manager Locale Manifest"] = 958,
    ["Windows Package Manager Singleton Manifest"] = 956,
    Winutil = 959,
    ["WireMock CLI import configuration"] = 1152,
    ["WireMock CLI local service configuration"] = 1151,
    ["WireMock message stub mapping"] = 1150,
    ["WireMock stub mapping"] = 1149,
    ["Woodpecker pipeline config"] = 997,
    ["Wrangler CLI"] = 910,
    ["Xstate Machine"] = 1015,
    ["Yandex Workflow Language"] = 1138,
    ["Yarn Config (.yarnrc.yml)"] = 972,
    ["Yippee-Ki-JSON configuration YML"] = 963,
    ["YouTrack App"] = 1135,
    ["Zarf Package Configuration"] = 1202,
    ["Zerops.io config"] = 1123,
    ["Zerops.io import"] = 1124,
    ["Zola Configuration"] = 1213,
    ["aerleon.yml"] = 18,
    ["amplify.yml"] = 11,
    ["angular.json"] = 35,
    apko = 1086,
    ["app-definition.yaml"] = 39,
    ["apple-app-site-association"] = 37,
    ["appsettings.StormPetrel.json"] = 44,
    ["appsettings.json"] = 42,
    ["appsscript.json"] = 41,
    ["appveyor.yml"] = 43,
    ["aqua-generate-registry.yaml"] = 46,
    ["aqua-policy.yaml"] = 47,
    ["aqua.yaml"] = 45,
    ["arazzo.json"] = 49,
    ["arb.json"] = 50,
    ["arc.json"] = 52,
    ["architect.yml"] = 51,
    ["artifacthub-repo.yml"] = 56,
    ["asm-lsp"] = 57,
    ["ast-grep rules"] = 60,
    ["ast-grep sgconfig.yml"] = 59,
    ["babelrc.json"] = 117,
    ["bamboo-spec"] = 121,
    basedpyright = 119,
    ["bashly-strings.yml"] = 1063,
    ["batect.yml"] = 120,
    ["beef-database-codegen"] = 122,
    ["beef-database-v5-codegen"] = 124,
    ["beef-entity-codegen"] = 123,
    ["beef-entity-v5-codegen"] = 125,
    ["behat.yml"] = 137,
    ["bigquery-table"] = 126,
    ["bioimageio resource description"] = 1103,
    ["bitbucket-pipelines"] = 128,
    bitrise = 129,
    ["bitrise-step"] = 130,
    ["block.json"] = 152,
    ["bottom configuration"] = 82,
    ["bower.json"] = 132,
    ["bozr.suite.json"] = 139,
    bpkg = 1064,
    ["browser.i18n.json"] = 140,
    ["browsh configuration"] = 141,
    bucklescript = 142,
    ["buf.gen.yaml"] = 84,
    ["buf.lock"] = 85,
    ["buf.plugin.yaml"] = 86,
    ...
    ["build-changelog"] = 143,
    ["bun.lock"] = 148,
    ["bundleconfig.json"] = 149,
    ["bunfig.toml"] = 150,
    ["cargo-mutants-config.yaml"] = 88,
    ["ccmod.json"] = 1147,
    changelogging = 1115,
    ["chisel-slices.json"] = 270,
    ["chrome-extension-locales-messages.json"] = 251,
    ["chutzpah.json"] = 252,
    cibuildwheel = 172,
    ["clang-format (.clang-format)"] = 1021,
    ["clang-tidy"] = 230,
    clangd = 229,
    clib = 231,
    ["cloud-init: cloud-config userdata"] = 233,
    ["cloud-sdk-pipeline-configuration"] = 254,
    ["cloudbuild.json"] = 255,
    cloudify = 232,
    ["cmdx.yaml"] = 91,
    codemagic = 235,
    ["coffeelint.json"] = 272,
    ["commands.json"] = 247,
    ["commitlint (.commitlintrc)"] = 960,
    ["committed.toml"] = 273,
    ["compile_commands.json"] = 246,
    ["compilerconfig.json"] = 245,
    ["completely.yml"] = 1059,
    ["component-detection-manifest.json"] = 276,
    ["component.json"] = 275,
    ["composer.json"] = 274,
    ["conda-forge"] = 176,
    ["config.yaml"] = 693,
    ["contentmanifest.json"] = 253,
    ["contribute.json"] = 277,
    ["cosmos.config.json"] = 249,
    ["crowdin.yml"] = 278,
    ["ctfd-setup configuration file"] = 1159,
    ["custom-elements.json"] = 1073,
    ["cypress.json"] = 282,
    ["datalogic-scan2deploy-android"] = 292,
    ["datalogic-scan2deploy-ce"] = 293,
    ["dbt Dependencies"] = 194,
    ["dbt Packages"] = 196,
    ["dbt Project"] = 195,
    ["dbt Selectors"] = 197,
    ["dbt YAML files"] = 198,
    ...
    ["ddev-global"] = 294,
    ["ddev-project"] = 295,
    ["debugsettings.json"] = 296,
    ["dependabot-v2.json"] = 299,
    ["dependabot.json"] = 298,
    ["deployed-cli"] = 1014,
    ["devcontainer.json"] = 237,
    devinit = 965,
    ["devspace.yaml"] = 1037,
    djlint = 966,
    ["docker bake"] = 305,
    ["docker sequencer"] = 306,
    ["docker-compose.yml"] = 964,
    ["dockerd.json"] = 303,
    ["dotnet Release Index manifest"] = 318,
    ["dotnet-tools.json"] = 319,
    ["dotnetcli.host.json"] = 320,
    ["dprint.json"] = 321,
    ["drone.json"] = 322,
    ["dss-2.0.0.json"] = 324,
    ["dstack configuration"] = 325,
    ["dtool dataset metadata"] = 1154,
    ["dvc.yaml"] = 326,
    ["ecosystem.json"] = 331,
    eksctl = 333,
    ["electron-builder configuration file"] = 339,
    ["epr-manifest.json"] = 338,
    ["evcc.yaml"] = 340,
    ["ezd task runner"] = 350,
    ["fabric.mod.json"] = 352,
    ["first-timers-bot"] = 360,
    ["flagd flag configuration"] = 112,
    ["fly.io Configuration"] = 113,
    fulibWorkflows = 996,
    ["function.json"] = 372,
    ["gRPC API Gateway & OpenAPI Config"] = 13,
    ["gematik health care insurance list"] = 1165,
    ["gematik health care patient list"] = 1162,
    ["gematik health care provider institution list"] = 1164,
    ["gematik health care provider list"] = 1163,
    ["gematik tiger test environment configuration"] = 1166,
    ["git-town.toml"] = 1211,
    ["gitlab-ci"] = 390,
    ["global.json"] = 406,
    ["go-feature-flag Flag Configuration"] = 409,
    ["haxelib.json"] = 427,
    helmfile = 952,
    helmwave = 953,
    ["host-meta.json"] = 434,
    ...
    ["ide.host.json"] = 442,
    ["ifstate.yaml"] = 443,
    ["imageoptimizer.json"] = 444,
    ["importmap.json"] = 447,
    instant_python_config = 449,
    instant_python_custom_project = 450,
    ["ioBroker Configuration"] = 451,
    ["ioBroker JSON UI"] = 452,
    ["ioBroker Package manifest"] = 453,
    ["ixpect.conf.yaml"] = 454,
    ["ize.toml"] = 1050,
    ["jsconfig.json"] = 479,
    ["jscpd Configuration"] = 1034,
    jsdoc = 948,
    ["k3d.yaml"] = 480,
    ["k9s aliases.yaml"] = 482,
    ["k9s cluster-config.yaml"] = 484,
    ["k9s config.yaml"] = 483,
    ["k9s hotkeys.yaml"] = 485,
    ["k9s plugins.yaml"] = 486,
    ["k9s skin.yaml"] = 487,
    ["k9s views.yaml"] = 488,
    ["kontinuous-config.yaml"] = 499,
    ["kontinuous-values.yaml"] = 498,
    ["kustomization.yaml"] = 501,
    ["label-commenter-config.yml"] = 502,
    ["latexindent configuration"] = 106,
    ["launchsettings.json"] = 503,
    lazydocker = 1072,
    lazygit = 1071,
    ["lego.json"] = 505,
    ["lerna.json"] = 506,
    ["lgtm.yml"] = 507,
    ["liblab.config.json"] = 508,
    ["libman.json"] = 509,
    ["license-report-config.json"] = 510,
    ["linkinator.config.json"] = 512,
    ["lint-staged (.lintstagedrc)"] = 926,
    ["local.settings.json"] = 517,
    ["localazy.json"] = 518,
    ["lotus.yaml"] = 516,
    ["lsdlschema.json"] = 519,
    ["macro.json"] = 1038,
    ["markdown-link-check"] = 992,
    maturin = 993,
    mboats = 1000,
    ["micro-settings.json"] = 1065,
    ["mimetypes.json"] = 533,
    ["mirrord config"] = 928,
    mise = 929,
    ["mkdocs.yml"] = 553,
    ...
    ["monospace.yml"] = 557,
    ["moon.yml"] = 1148,
    ["mprocs Configuration file"] = 1119,
    ["mrdocs.yml"] = 554,
    ["mta.yaml"] = 930,
    ["mtad.yaml"] = 931,
    ["mycode.json"] = 564,
    nFPM = 571,
    ["napari plugin manifest"] = 565,
    neoload = 943,
    ["nest-cli"] = 574,
    ["ninjs (News in JSON)"] = 573,
    ["nitro.json"] = 942,
    ["nixd configuration"] = 1091,
    ["nlu.json"] = 575,
    ["nodemon.json"] = 577,
    ["noodl config"] = 999,
    ["notebook.mod.json"] = 578,
    now = 938,
    ["npm-badges"] = 581,
    ["nswag.json"] = 585,
    ntangle = 587,
    ["nuclei-template.yaml"] = 582,
    ["nuget-project.json"] = 583,
    ["ocelot.json"] = 589,
    ogen = 592,
    ["omnisharp.json"] = 595,
    openHAB = 1224,
    ...
    oxlint = 1235,
    ["package.json"] = 629,
    ["package.manifest"] = 631,
    ["package.yaml"] = 630,
    ["partial-black.json"] = 138,
    ["partial-pixi.json"] = 639,
    ["pathfinder.yml"] = 634,
    ["pattern.json"] = 637,
    ["petstore-v1.0"] = 1045,
    pgap_yaml_input_reader = 636,
    pgxgen = 1228,
    pitcms = 1231,
    ["pixi.toml"] = 638,
    ["plagiarize-me.yaml"] = 643,
    ["plagiarize.yaml"] = 642,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1155,
    ["podbard.yaml"] = 645,
    ["portman.json"] = 648,
    ["prefect.toml"] = 656,
    ["prefect.yaml"] = 657,
    ...
    ["prettierrc.json"] = 659,
    ["prisma.yml"] = 660,
    ["project-1.0.0-beta3.json"] = 672,
    ["project-1.0.0-beta4.json"] = 673,
    ["project-1.0.0-beta5.json"] = 674,
    ["project-1.0.0-beta6.json"] = 675,
    ["project-1.0.0-beta8.json"] = 676,
    ["project-1.0.0-rc1.json"] = 677,
    ["project-1.0.0-rc2.json"] = 678,
    ["project.json"] = 671,
    ["project.owasp.yaml"] = 679,
    ["prometheus-alertmanager.json"] = 683,
    ["prometheus.json"] = 680,
    ["prometheus.rules.json"] = 681,
    ["prometheus.rules.test.json"] = 682,
    ["proxies.json"] = 684,
    ["publiccode.yml"] = 685,
    ["pubspec.yaml"] = 686,
    ["pyrseas-0.8.json"] = 689,
    pytest = 698,
    ["quilt.mod.json"] = 1066,
    ["rc3 auth"] = 704,
    ["rc3 collection"] = 705,
    ...
    ["release drafter"] = 944,
    ["release-hub.json"] = 2,
    ["release-please-config.json"] = 714,
    ["release-please-manifest.json"] = 715,
    ["release-plz.toml"] = 716,
    ["renv.lock"] = 728,
    ["rivet.json"] = 1090,
    ["rivet.yaml (legacy)"] = 1089,
    rumdl = 733,
    runny = 732,
    rustfmt = 734,
    sake = 1182,
    samt = 736,
    samtrc = 737,
    ["sarif-1.0.0.json"] = 739,
    ["sarif-2.0.0.json"] = 740,
    ["sarif-2.1.0"] = 750,
    ["sarif-2.1.0-rtm.2"] = 741,
    ["sarif-2.1.0-rtm.3"] = 743,
    ["sarif-2.1.0-rtm.4"] = 745,
    ["sarif-2.1.0-rtm.5"] = 747,
    ["sarif-2.1.0-rtm.6"] = 748,
    ["sarif-external-property-file-2.1.0"] = 751,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 742,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 744,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 746,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 749,
    ["scalingo.json configuration"] = 752,
    ["schema.org - Action"] = 754,
    ["schema.org - ContactPoint"] = 755,
    ["schema.org - Place"] = 756,
    ["schema.org - Thing"] = 757,
    ["secrethub.yml"] = 1068,
    ["semantic-release"] = 763,
    ["servicehub.config.json"] = 921,
    ["servicehub.service.json"] = 920,
    ["settings.job"] = 766,
    ["sfdx-hardis configuration"] = 768,
    ["shard.yml"] = 1106,
    ["size-limit configuration"] = 773,
    ["skaffold.yaml"] = 990,
    ["skyuxconfig.json"] = 775,
    ["snowflake-config"] = 777,
    ["snowflake-connections"] = 778,
    ["spicepod.yaml"] = 1127,
    ["sqlc configuration"] = 810,
    ["stripe-app-local.json"] = 821,
    ["stripe-app.json"] = 820,
    swcrc = 975,
    ["task.json"] = 830,
    taskcat = 939,
    ["template.json"] = 835,
    ["templatsources.json"] = 836,
    ["text2confl config"] = 1236,
    ["theme.json"] = 839,
    ["tizen_workspace.json"] = 841,
    tldr = 842,
    ["tm_devices configuration file"] = 1193,
    tmuxinator = 924,
    tox = 844,
    ["transcend.yml"] = 853,
    ["tree-sitter grammar.json"] = 414,
    ["trime.yaml"] = 854,
    ["trunk.yaml"] = 856,
    ["ts-force-config.json"] = 861,
    ["tsconfig.json"] = 857,
    ["tsd.json"] = 858,
    ["tsdoc.json"] = 859,
    ["tsdrc.json"] = 860,
    ...
    v8r = 903,
    vcluster = 1113,
    ["vcpkg configuration file"] = 242,
    ["vcpkg manifest file"] = 241,
    ["vega-lite.json"] = 885,
    ["vega.json"] = 884,
    ["venvironment.yaml"] = 887,
    ["venvplus.yaml"] = 888,
    version = 1175,
    ["version.json"] = 890,
    ["vhwdebugger-binding.yaml"] = 892,
    ["vim-addon-info"] = 893,
    ["vs-2017.3.host.json"] = 895,
    ["vs-nesting.json"] = 896,
    ["vsls.json"] = 894,
    ["vss-extension.json"] = 900,
    vtcfg = 1181,
    ["vtesttree.yaml"] = 901,
    ["vtestunit.yaml"] = 902,
    ["warp-keysets.json"] = 1074,
    ["warp-themes.json"] = 1075,
    ["warp-workflows.json"] = 1076,
    ["webhint.io"] = 1030,
    ["webjobpublishsettings.json"] = 907,
    ["webjobs-list.json"] = 906,
    ["well-known-fursona"] = 1114,
    ["xs-app.json"] = 934,
    ["xunit.runner.json"] = 919,
    yamllint = 962,
    zizmor = 1218,
    zuul = 945,
    ["Žinoma"] = 955
