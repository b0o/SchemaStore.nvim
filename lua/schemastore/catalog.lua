...
M.json = {
  ...
  index = {
    ...
    [".pmbot.yml"] = 570,
    [".postcssrc"] = 577,
    [".powerpages-web-template-manifest"] = 579,
    [".pre-commit-config.yml"] = 580,
    [".pre-commit-hooks.yml"] = 581,
    [".putout.json"] = 610,
    [".rehyperc"] = 634,
    [".remarkrc"] = 638,
    [".sprite files"] = 707,
    ...
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1050,
    ["API Builder"] = 864,
    ["AVA Configuration"] = 926,
    ...
    ["Alacritty Configuration"] = 898,
    ["All Contributors configuration file"] = 951,
    ...
    ["Application list for a WinUtil"] = 1032,
    ArchitectFX = 1037,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure Pipelines"] = 79,
    ["Azure Static Web Apps CLI configuration file"] = 711,
    ["Azure Static Web Apps configuration file"] = 710,
    ["BOSH CPI Config"] = 103,
    ["BOSH Deploy Config"] = 104,
    ["BX CI"] = 123,
    ["Bashly (bashly.yml)"] = 955,
    ["Bashly Settings (bashly-settings.yml)"] = 956,
    ["Better Code Hub"] = 868,
    ["Better Scripts"] = 124,
    Bigconfig = 96,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1043,
    BizTalkServerApplicationSchema = 836,
    Bleep = 125,
    ...
    ["Butane Config"] = 911,
    C4InterFlow = 1058,
    ["CDK Environment Manager, concrete environment configuration"] = 1081,
    ["CDK Environment Manager, concrete environments definition"] = 1080,
    ["CDK Environment Manager, environment definition"] = 1079,
    ["CGS Card Game Specification (cgs.json)"] = 993,
    ["CICS TS region tagging"] = 920,
    ["CICS TS resource import"] = 921,
    ["CICS TS resource model"] = 922,
    ["CICS TS resource overrides"] = 923,
    ["CMake Presets"] = 126,
    ["CNC Codes"] = 145,
    ["CRS WAF test file"] = 1022,
    ["CRS WAF test platform overrides file"] = 1023,
    ...
    ["Chamaleon environment"] = 1047,
    ["Chamaleon properties"] = 1048,
    ["Chamaleon template"] = 1046,
    Changesets = 229,
    Charmcraft = 135,
    Cheatsheets = 908,
    ...
    ["Clawject config"] = 151,
    ["Cloud Foundry Application Manifest"] = 1004,
    ["Cloud Run Spec v1"] = 1027,
    ...
    Concord = 1021,
    ["Configu .cfgu files"] = 1009,
    ["Configu .configu file"] = 1010,
    Conjure = 144,
    ["Container Structure Test"] = 850,
    Containerlab = 877,
    ["Contextive Glossary"] = 1073,
    Convex = 143,
    ["Crowdsec collection config"] = 239,
    ["Crowdsec parser config"] = 240,
    ["Crowdsec scenario config"] = 241,
    ["CumulusCI Config"] = 150,
    ["Custom Machinery Machine"] = 994,
    ["Custom Machinery Recipe"] = 995,
    ...
    ["DonateCaseBetterCasino menu"] = 1051,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 963,
    ["EAS config"] = 305,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 952,
    ["EasyVCR .NET"] = 306,
    ["Eidolon Resource"] = 1038,
    ...
    ["GeoJSON.json latest"] = 915,
    GherKing = 919,
    ["GitHub Action"] = 336,
    ["GitHub Actions typing"] = 1034,
    ...
    ["Google Digital Assetlinks"] = 1074,
    Goreleaser = 364,
    ["Goreleaser Pro"] = 365,
    Goss = 366,
    ["Gradle Build Cache Node"] = 866,
    ["Gradle Enterprise"] = 865,
    ...
    Hadolint = 846,
    Hammerkit = 876,
    ["Hardware Sentry Configuration"] = 931,
    Hatch = 847,
    Hayson = 379,
    ["Haystack Pipeline"] = 380,
    ["Hazelcast 5 Configuration"] = 381,
    ["Hecate Input Schema"] = 1085,
    ["Helm Chart.lock"] = 184,
    ["Helm Chart.yaml"] = 183,
    ...
    ["JFrog File Spec"] = 410,
    ["JFrog Pipelines YML DSL"] = 940,
    ["JMeter DSL cli config"] = 411,
    JReleaser = 414,
    ["JSON Document Transform"] = 422,
    ["JSON Feed"] = 423,
    ["JSON Resume"] = 644,
    ["JSON Schema Draft 2020-12"] = 815,
    ["JSON Schema Draft 4"] = 812,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 973,
    ["JSON Schema Draft 7"] = 813,
    ["JSON Schema Draft 7 (unofficial strict)"] = 974,
    ["JSON Schema Draft 8 (2019-09)"] = 814,
    ["JSON-API"] = 421,
    ["JSON-e templates"] = 873,
    ["JSON-stat 2.0"] = 808,
    JSONPatch = 425,
    ...
    ["Metadata for a Cinnamon spice"] = 1030,
    ["Metatype Configuration"] = 473,
    ["MetricsHub Configuration"] = 474,
    ["MetricsHub Connector Configuration"] = 475,
    ["Micro Editor Syntax"] = 964,
    ["Microsoft Band Web Tile"] = 476,
    ["Microsoft RulesEngine workflow rules"] = 1018,
    ["Microsoft RulesEngine workflow rules list"] = 1019,
    ["Minecraft Custom Main Menu Mod"] = 982,
    ...
    ["MongoDB Atlas Search Index Definition"] = 935,
    ["Monika Configuration"] = 933,
    ["Monoweave Configuration"] = 501,
    ["Motif config"] = 828,
    MultiQC = 1067,
    ["NOX Framework (Service)"] = 519,
    ["Netin Diagnostic System Template"] = 893,
    ["Netlify config"] = 509,
    ["Network-as-Code Data Model"] = 510,
    ["Nightwatch.js"] = 512,
    ["Node.js configuration"] = 833,
    ["NueJS configuration file"] = 524,
    ["Nuitka.yaml"] = 996,
    ["Nullstone config"] = 526,
    ["ONe's changelog entry"] = 540,
    ["ONe's service descriptor"] = 539,
    ["ORT Server repository environment configuration"] = 547,
    ["OSCAL Assessment Plan (AP)"] = 549,
    ["OSCAL Assessment Results (AR)"] = 550,
    ["OSCAL Catalog"] = 551,
    ["OSCAL Component Definition (CDef)"] = 552,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 553,
    ["OSCAL Profile"] = 554,
    ["OSCAL System Security Plan (SSP)"] = 555,
    ["OSS Review Toolkit configuration"] = 556,
    ["OSS Review Toolkit curation"] = 557,
    ["OSS Review Toolkit package configuration"] = 558,
    ["OSS Review Toolkit repository configuration"] = 559,
    ["OSS Review Toolkit resolutions"] = 560,
    ...
    ["OpenUtau ustx"] = 537,
    ["OpenWeather Current Weather API"] = 872,
    ["OpenWeather Road Risk API"] = 871,
    ["Ory Hydra configuration"] = 388,
    ["Ory Keto configuration"] = 443,
    ["Ory Kratos configuration"] = 548,
    ["Ory Oathkeeper configuration"] = 528,
    ["Outblocks App configuration"] = 545,
    ["Outblocks database table"] = 546,
    ["Outblocks project configuration"] = 544,
    PDM = 566,
    Packer = 563,
    Pantsbuild = 950,
    ["Paper paper-plugin.yml"] = 564,
    ["Pipeline component"] = 884,
    ["Platform.sh application"] = 2,
    ["Platform.sh routes"] = 3,
    ["Platform.sh services"] = 4,
    ["Plex Prerolls"] = 574,
    ["PocketMine plugin.yml"] = 571,
    ["Postman collection"] = 578,
    ["Power Pages Configuration"] = 1084,
    ["Preset list for a WinUtil"] = 1033,
    ["ProActions AI-Kit Configuration"] = 587,
    ["ProActions AI-Kit Configuration for Menus"] = 589,
    ["ProActions AI-Kit Configuration for Sections"] = 591,
    ["ProActions AI-Kit Configuration for Services"] = 588,
    ["ProActions AI-Kit Configuration for Steps"] = 592,
    ["ProActions AI-Kit Configuration for Templates"] = 590,
    ["Problem object RFC9457"] = 979,
    ["Problem package generators"] = 593,
    Pterodactyl = 930,
    ["Pull Request Labeler"] = 609,
    Pulumi = 617,
    ["PyGTA Config"] = 613,
    PyProject = 618,
    Pylock = 1075,
    Pyright = 619,
    ["Python script metadata"] = 1069,
    ["QType AI DSL"] = 622,
    Qgoda = 621,
    Qodana = 903,
    ["Qt Creator workspace file"] = 1011,
    ["Quali Torque Blueprint Spec 2"] = 928,
    ["QueryFirst config file"] = 946,
    ["RKE Cluster Configuration JSON"] = 881,
    ["RKE Cluster Configuration YAML"] = 880,
    RadioHound = 612,
    Railway = 623,
    ["Rancher Fleet"] = 614,
    ["Rattler-build"] = 624,
    Ray = 845,
    ["Read the Docs"] = 616,
    ["Red-DiscordBot Cog"] = 631,
    ["Red-DiscordBot Cog Repo"] = 632,
    ["Red-DiscordBot Trivia"] = 633,
    ["Render Blueprints"] = 879,
    RenderCV = 646,
    Renovate = 645,
    ["Replit config"] = 639,
    Restate = 1062,
    RoadRunner = 648,
    ["Roo Coder Custom Modes"] = 650,
    Rubocop = 641,
    ["Rudder techniques"] = 986,
    Ruff = 642,
    ["Rust Project"] = 643,
    ["Rust toolchain"] = 653,
    ["SDMX data message"] = 679,
    ["SDMX metadata message"] = 678,
    ["SDMX structure message"] = 677,
    ["SIL Kit Participant Configuration"] = 689,
    ["SIL Kit Registry Configuration"] = 690,
    ["SPDX 2.3"] = 708,
    SWADL = 722,
    ["Safebox Config"] = 941,
    ["Sapphire CLI Config"] = 656,
    ["SauceCTL Configuration"] = 890,
    ["Schema Catalog"] = 671,
    ["Scoop manifest"] = 676,
    ["Semantic Data Fabric (SDF) file"] = 680,
    ["Semgrep Rule"] = 682,
    ["Serenity Code Generator (Sergen)"] = 683,
    ["Serverless Framework Configuration"] = 897,
    ["Serverless Workflow"] = 899,
    ["Settings for a Cinnamon spice"] = 1029,
    ["Settings.paf"] = 685,
    ["Shopware 6 Configuration"] = 900,
    ["Shopware CLI Extension Store Configuration"] = 901,
    ["Shopware CLI Project Store Configuration"] = 902,
    ["Sigma Detection Rule"] = 687,
    ["Sigrid scope configuration file"] = 688,
    ["SkyPilot Task JSON"] = 987,
    ["Slack app manifest"] = 692,
    Solidarity = 697,
    ["Solution filters"] = 698,
    ["Source Maps v3"] = 699,
    Sourcery = 700,
    ["Speakeasy Generation Config File"] = 704,
    ["Speakeasy Lint Configuration File"] = 701,
    ["Speakeasy Test Generation Configuration File"] = 702,
    ["Speakeasy Workflow File"] = 703,
    SpecIF = 705,
    ["Sponge Mixin configuration"] = 706,
    StackBlitz = 712,
    ["StackHawk Scanner Configuration"] = 896,
    Stale = 713,
    ["Starlake Data Pipeline"] = 869,
    Starship = 714,
    ["Statamic Blueprint"] = 715,
    ["Stella configuration file"] = 716,
    ["Stryker Mutator"] = 719,
    ["StyleCop Analyzers Configuration"] = 720,
    ["Stylelint (.stylelintrc)"] = 721,
    ["Stylua Config"] = 1076,
    ["Sublime Syntax"] = 942,
    ["Subsquid squid manifest"] = 989,
    ["Swagger API 2.0"] = 723,
    ["Synadia Connect Component"] = 724,
    TSON = 758,
    TSTyche = 759,
    ["TYPO3 Vendor Bundler config"] = 764,
    ["Tab data for a LinUtil"] = 1036,
    ["Tab list for a LinUtil"] = 1035,
    Tach = 725,
    ["Tach Domain"] = 726,
    Talhelper = 728,
    ["Talisman configuration"] = 729,
    Taplo = 1077,
    ["Taskfile config"] = 874,
    Taurus = 730,
    Tauticord = 731,
    Telefonistka = 1063,
    ["TestEnvironment.json"] = 741,
    ["TextMate Grammar"] = 740,
    ["Tier.run pricing.json"] = 734,
    Tikibase = 735,
    Tombi = 739,
    ["Traefik v2"] = 744,
    ["Traefik v2 File Provider"] = 745,
    ["Traefik v3"] = 746,
    ["Traefik v3 File Provider"] = 747,
    ["Travis CI (.travis.yml)"] = 743,
    Trident = 1060,
    ["TrueScript for *.tscript files"] = 750,
    ["Tugboat QA config.yml"] = 1057,
    TunnelHub = 977,
    Turborepo = 742,
    Tycho = 1025,
    Tye = 904,
    ["Tyk Gateway - Open Source v5.7+"] = 1068,
    ["Typst Manifest"] = 765,
    ["UET BuildConfig.json"] = 947,
    ["UI5 Manifest"] = 771,
    ["UNCORS configuration"] = 775,
    ["UTAM Page Object"] = 774,
    ["Ubuntu Server Autoinstall"] = 769,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1061,
    ["Uniswap Token List"] = 857,
    ["Universal Schedule Format"] = 776,
    ["Unreal Engine Uplugin"] = 948,
    ["Unreal Engine Uproject"] = 949,
    ["Updatecli Compose"] = 912,
    ["Updatecli Policy Manifest"] = 913,
    ["Updatecli Policy Metadata"] = 914,
    Uplift = 945,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 878,
    V2Ray = 918,
    ["VSCode Code Snippets"] = 204,
    ["VSIX CLI publishing"] = 796,
    Vector = 778,
    ["Vela Pipeline Configuration"] = 781,
    Vercel = 203,
    ["Version Bumper config"] = 786,
    ["Viash Component Config"] = 1065,
    ["Viash Package Config"] = 1066,
    Visivo = 975,
    ["WP-CLI"] = 806,
    Wake = 1059,
    ["Waku Config"] = 1039,
    ["Web App Manifest"] = 802,
    ["Web types"] = 805,
    WebExtensions = 801,
    ["Webman package recipe"] = 924,
    ["Windows Package Manager Installer Manifest"] = 853,
    ["Windows Package Manager Locale Manifest"] = 854,
    ["Windows Package Manager Singleton Manifest"] = 852,
    Winutil = 855,
    ["WireMock stub mapping"] = 1042,
    ["Woodpecker pipeline config"] = 892,
    ["Wrangler CLI"] = 807,
    ["Xstate Machine"] = 910,
    ["Yandex Workflow Language"] = 1031,
    ["Yarn Config (.yarnrc.yml)"] = 867,
    ["Yippee-Ki-JSON configuration YML"] = 859,
    ["YouTrack App"] = 1028,
    ["Zerops.io config"] = 1016,
    ["Zerops.io import"] = 1017,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 980,
    ...
    ["behat.yml"] = 106,
    ["bigquery-table"] = 95,
    ["bioimageio resource description"] = 997,
    ...
    ["crowdin.yml"] = 238,
    ["ctfd-setup configuration file"] = 1049,
    ["custom-elements.json"] = 967,
    ["cypress.json"] = 242,
    ...
    ["gematik health care insurance list"] = 1055,
    ["gematik health care patient list"] = 1052,
    ["gematik health care provider institution list"] = 1054,
    ["gematik health care provider list"] = 1053,
    ["gematik tiger test environment configuration"] = 1056,
    ["gitlab-ci"] = 344,
    ["global.json"] = 360,
    ...
    ["lint-staged (.lintstagedrc)"] = 823,
    ["local.settings.json"] = 463,
    ["localazy.json"] = 464,
    ["lotus.yaml"] = 462,
    ["lsdlschema.json"] = 465,
    ["markdown-link-check"] = 887,
    maturin = 888,
    mboats = 895,
    ["micro-settings.json"] = 959,
    ["mimetypes.json"] = 477,
    ["mirrord config"] = 824,
    mise = 825,
    ["mkdocs.yml"] = 497,
    ["monospace.yml"] = 500,
    ["moon.yml"] = 1041,
    ["mprocs Configuration file"] = 1012,
    ["mrdocs.yml"] = 498,
    ["mta.yaml"] = 826,
    ["mtad.yaml"] = 827,
    ["mycode.json"] = 507,
    ...
    ["ops.yaml"] = 538,
    ["package.json"] = 561,
    ["package.manifest"] = 562,
    ["partial-black.json"] = 107,
    ["pathfinder.yml"] = 565,
    ["pattern.json"] = 568,
    ["petstore-v1.0"] = 939,
    pgap_yaml_input_reader = 567,
    ["pixi.toml"] = 569,
    ["plagiarize-me.yaml"] = 573,
    ["plagiarize.yaml"] = 572,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1045,
    ["podbard.yaml"] = 575,
    ["portman.json"] = 576,
    ["prefect.toml"] = 584,
    ["prettierrc.json"] = 585,
    ["prisma.yml"] = 586,
    ["project-1.0.0-beta3.json"] = 595,
    ["project-1.0.0-beta4.json"] = 596,
    ["project-1.0.0-beta5.json"] = 597,
    ["project-1.0.0-beta6.json"] = 598,
    ["project-1.0.0-beta8.json"] = 599,
    ["project-1.0.0-rc1.json"] = 600,
    ["project-1.0.0-rc2.json"] = 601,
    ["project.json"] = 594,
    ["project.owasp.yaml"] = 602,
    ["prometheus.json"] = 603,
    ["prometheus.rules.json"] = 604,
    ["prometheus.rules.test.json"] = 605,
    ["proxies.json"] = 606,
    ["publiccode.yml"] = 607,
    ["pubspec.yaml"] = 608,
    ["pyrseas-0.8.json"] = 611,
    pytest = 620,
    ["quilt.mod.json"] = 960,
    ["rc3 auth"] = 625,
    ["rc3 collection"] = 626,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 840,
    ["release-please-config.json"] = 635,
    ["release-please-manifest.json"] = 636,
    ["release-plz.toml"] = 637,
    ["renv.lock"] = 647,
    ["rivet.json"] = 984,
    ["rivet.yaml (legacy)"] = 983,
    rockcraft = 649,
    runny = 651,
    rustfmt = 652,
    sake = 1071,
    samt = 654,
    samtrc = 655,
    ["sarif-1.0.0.json"] = 657,
    ["sarif-2.0.0.json"] = 658,
    ["sarif-2.1.0"] = 668,
    ["sarif-2.1.0-rtm.2"] = 659,
    ["sarif-2.1.0-rtm.3"] = 661,
    ["sarif-2.1.0-rtm.4"] = 663,
    ["sarif-2.1.0-rtm.5"] = 665,
    ["sarif-2.1.0-rtm.6"] = 666,
    ["sarif-external-property-file-2.1.0"] = 669,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 660,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 662,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 664,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 667,
    ["scalingo.json configuration"] = 670,
    ["schema.org - Action"] = 672,
    ["schema.org - ContactPoint"] = 673,
    ["schema.org - Place"] = 674,
    ["schema.org - Thing"] = 675,
    ["secrethub.yml"] = 962,
    ["semantic-release"] = 681,
    ["servicehub.config.json"] = 818,
    ["servicehub.service.json"] = 817,
    ["settings.job"] = 684,
    ["sfdx-hardis configuration"] = 686,
    ["shard.yml"] = 1000,
    ["size-limit configuration"] = 691,
    ["skaffold.yaml"] = 885,
    ["skyuxconfig.json"] = 693,
    snapcraft = 694,
    ["snowflake-config"] = 695,
    ["snowflake-connections"] = 696,
    ["spicepod.yaml"] = 1020,
    ["sqlc configuration"] = 709,
    ["stripe-app-local.json"] = 718,
    ["stripe-app.json"] = 717,
    swcrc = 870,
    ["task.json"] = 727,
    taskcat = 835,
    ["template.json"] = 732,
    ["templatsources.json"] = 733,
    ["theme.json"] = 736,
    ["tizen_workspace.json"] = 737,
    tldr = 738,
    ["tm_devices configuration file"] = 1082,
    tmuxinator = 821,
    ["transcend.yml"] = 748,
    ["tree-sitter grammar.json"] = 368,
    ["trime.yaml"] = 749,
    ["trunk.yaml"] = 751,
    ["ts-force-config.json"] = 756,
    ["tsconfig.json"] = 752,
    ["tsd.json"] = 753,
    ["tsdoc.json"] = 754,
    ["tsdrc.json"] = 755,
    ...
    ["vega-lite.json"] = 780,
    ["vega.json"] = 779,
    ["venvironment-basic.yaml"] = 783,
    ["venvironment.yaml"] = 782,
    ["venvplus-basic.yaml"] = 785,
    ["venvplus.yaml"] = 784,
    version = 1064,
    ["version.json"] = 787,
    ["vhwdebugger-binding.yaml"] = 789,
    ["vim-addon-info"] = 790,
    ["vs-2017.3.host.json"] = 792,
    ["vs-nesting.json"] = 793,
    ["vsls.json"] = 791,
    ["vss-extension.json"] = 797,
    vtcfg = 1070,
    ["vtesttree.yaml"] = 798,
    ["vtestunit.yaml"] = 799,
    ["warp-keysets.json"] = 968,
    ["warp-themes.json"] = 969,
    ["warp-workflows.json"] = 970,
    ["webhint.io"] = 925,
    ["webjobpublishsettings.json"] = 804,
    ["webjobs-list.json"] = 803,
    ["well-known-fursona"] = 1007,
    ["xs-app.json"] = 830,
    ["xunit.runner.json"] = 816,
    yamllint = 858,
    zuul = 841,
    ["Žinoma"] = 851
  },
