...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 97,
    [".cryproj (generic)"] = 395,
    [".cryproj engine-5.2"] = 390,
    [".cryproj engine-5.3"] = 391,
    [".cryproj engine-5.4"] = 392,
    [".cryproj engine-5.5"] = 393,
    [".cryproj engine-dev"] = 394,
    [".csscomb.json"] = 99,
    [".csslintrc"] = 100,
    [".eslintrc"] = 135,
    [".esmrc.json"] = 128,
    ...
    [".mtaext"] = 401,
    [".nodehawkrc"] = 240,
    [".npmpackagejsonlintrc"] = 242,
    [".phraseapp.yml"] = 269,
    [".pmbot.yml"] = 262,
    [".postcssrc"] = 267,
    [".pre-commit-config.yml"] = 268,
    [".putout.json"] = 286,
    [".rehyperc"] = 291,
    [".remarkrc"] = 292,
    [".sprite files"] = 327,
    ...
    [".vsext"] = 371,
    [".yarnrc.yml"] = 433,
    ["<div>RIOTS' studio configuration"] = 374,
    ["API Builder"] = 430,
    ...
    ["Azure Pipelines"] = 32,
    ["Azure Static Web Apps CLI configuration file"] = 329,
    ["Azure Static Web Apps configuration file"] = 328,
    ["Better Code Hub"] = 435,
    BizTalkServerApplicationSchema = 407,
    Briefcase = 412,
    Buildkite = 53,
    ...
    Goreleaser = 160,
    ["Goreleaser Pro"] = 161,
    ["Gradle Build Cache Node"] = 432,
    ["Gradle Enterprise"] = 431,
    ...
    ["JSON Feed"] = 197,
    ["JSON Resume"] = 294,
    ["JSON Schema Draft 2020-12"] = 386,
    ["JSON Schema Draft 4"] = 383,
    ["JSON Schema Draft 7"] = 384,
    ["JSON Schema Draft 8"] = 385,
    ...
    ["Netin Diagnostic System Template"] = 454,
    ["Netlify config schema"] = 235,
    ["Nightwatch.js"] = 236,
    ["OSS Review Toolkit repository configuration"] = 256,
    Opctl = 403,
    ["OpenWeather Current Weather API"] = 439,
    ["OpenWeather Road Risk API"] = 438,
    ["Ory Hydra configuration"] = 179,
    ["Ory Keto configuration"] = 202,
    ["Ory Kratos configuration"] = 255,
    ["Ory Oathkeeper configuration"] = 247,
    ["Outblocks App configuration"] = 253,
    ["Outblocks database table"] = 254,
    ["Outblocks project configuration"] = 252,
    Packer = 259,
    ["Pipeline component"] = 448,
    ["PocketMine plugin.yml"] = 263,
    ["Pull Request Labeler"] = 285,
    Qodana = 461,
    ["RKE Cluster Configuration JSON Schema"] = 446,
    ["RKE Cluster Configuration YAML Schema"] = 445,
    Ray = 415,
    ["Read the Docs"] = 288,
    ["Red-DiscordBot Cog"] = 289,
    ["Red-DiscordBot Cog Repo"] = 290,
    Renovate = 295,
    RoadRunner = 296,
    SWADL = 338,
    ["Sapphire CLI Config"] = 297,
    ["SauceCTL Configuration"] = 451,
    ["Schema Catalog"] = 310,
    ["Scoop manifest"] = 315,
    ["Semgrep Rule"] = 316,
    ["Serverless Framework Configuration"] = 458,
    ["Settings.paf"] = 318,
    ["Shopware CLI Extension Store Configuration"] = 459,
    ["Shopware CLI Project Store Configuration"] = 460,
    Solidarity = 323,
    ["Source Maps v3"] = 324,
    SpecIF = 325,
    ["Sponge Mixin configuration"] = 326,
    ["StackHawk Scanner Configuration"] = 457,
    ["StackHead CLI config"] = 330,
    ["StackHead module configuration"] = 331,
    ["StackHead project definition"] = 332,
    Stale = 333,
    ["Statamic Blueprint"] = 334,
    ["Stryker Mutator"] = 335,
    ["StyleCop Analyzers Configuration"] = 336,
    ["Swagger API 2.0"] = 339,
    ["Taskfile YAML Schema"] = 441,
    Taurus = 340,
    ...
    ["User Journey Map YAML Schema"] = 444,
    ["VSCode Code Snippets"] = 76,
    ["VSIX CLI publishing"] = 372,
    ["Vela Pipeline Configuration"] = 364,
    Vercel = 75,
    ["Web App Manifest"] = 376,
    ["Web types"] = 379,
    WebExtensions = 375,
    ["Windows Package Manager Installer Manifest"] = 421,
    ["Windows Package Manager Locale Manifest"] = 422,
    ["Windows Package Manager Singleton Manifest"] = 420,
    ["Woodpecker pipeline config"] = 453,
    ["Yippee-Ki-JSON configuration YML"] = 426,
    ["angular.json"] = 6,
    ...
    neoload = 409,
    ["nest-cli"] = 238,
    ["ninjs (News in JSON)"] = 237,
    ["nlu.json"] = 239,
    ["nodemon.json"] = 241,
    ["noodl.schema.json"] = 455,
    now = 405,
    ["nswag.json"] = 245,
    ntangle = 246,
    ["nuclei-template.yaml"] = 243,
    ["nuget-project.json"] = 244,
    ["ocelot.json"] = 248,
    ["omnisharp.json"] = 249,
    ["openapi.json"] = 250,
    ["openfin.json"] = 251,
    ["package.json"] = 257,
    ["package.manifest"] = 258,
    ["pattern.json"] = 261,
    pgap_yaml_input_reader = 260,
    ["plagiarize-me.yaml"] = 265,
    ["plagiarize.yaml"] = 264,
    ["portman.json"] = 266,
    ["prettierrc.json"] = 270,
    ["prisma.yml"] = 271,
    ["project-1.0.0-beta3.json"] = 273,
    ["project-1.0.0-beta4.json"] = 274,
    ["project-1.0.0-beta5.json"] = 275,
    ["project-1.0.0-beta6.json"] = 276,
    ["project-1.0.0-beta8.json"] = 277,
    ["project-1.0.0-rc1.json"] = 278,
    ["project-1.0.0-rc2.json"] = 279,
    ["project.json"] = 272,
    ["prometheus.json"] = 280,
    ["prometheus.rules.json"] = 281,
    ["proxies.json"] = 282,
    ["publiccode.yml"] = 283,
    ["pubspec.yaml"] = 284,
    ["pyrseas-0.8.json"] = 287,
    ["release drafter"] = 410,
    ["sarif-1.0.0.json"] = 298,
    ["sarif-2.0.0.json"] = 299,
    ["sarif-2.1.0"] = 308,
    ["sarif-2.1.0-rtm.2"] = 300,
    ["sarif-2.1.0-rtm.3"] = 302,
    ["sarif-2.1.0-rtm.4"] = 304,
    ["sarif-2.1.0-rtm.5"] = 306,
    ["sarif-external-property-file-2.1.0"] = 309,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 301,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 303,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 305,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 307,
    ["schema.org - Action"] = 311,
    ["schema.org - ContactPoint"] = 312,
    ["schema.org - Place"] = 313,
    ["schema.org - Thing"] = 314,
    ["servicehub.config.json"] = 389,
    ["servicehub.service.json"] = 388,
    ["settings.job"] = 317,
    ["sfdx-hardis configuration"] = 319,
    ["size-limit configuration"] = 320,
    ["skaffold.yaml"] = 449,
    ["skyuxconfig.json"] = 321,
    snapcraft = 322,
    swcrc = 437,
    taskcat = 406,
    ["template.json"] = 341,
    ["templatsources.json"] = 342,
    ["theme.json"] = 343,
    tmLanguage = 344,
    ["trunk.yaml schema"] = 349,
    ["ts-force-config.json"] = 353,
    ["tsconfig.json"] = 350,
    ["tsd.json"] = 351,
    ["tsdrc.json"] = 352,
    ["tslint.json"] = 354,
    ...
    ["version.json"] = 365,
    ["vim-addon-info"] = 366,
    ["vs-2017.3.host.json"] = 368,
    ["vs-nesting.json"] = 369,
    ["vsls.json"] = 367,
    ["vss-extension.json"] = 373,
    ["webjobpublishsettings.json"] = 378,
    ["webjobs-list.json"] = 377,
    ["xs-app.json"] = 402,
    ["xunit.runner.json"] = 387,
    yamllint = 425,
    zuul = 411,
    ["Žinoma"] = 419
  },
