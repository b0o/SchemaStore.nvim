...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 876,
    [".nodehawkrc"] = 535,
    [".npmpackagejsonlintrc"] = 539,
    [".omletrc"] = 1052,
    [".phrase.yml"] = 604,
    [".phraseapp.yml"] = 605,
    [".pmbot.yml"] = 592,
    [".postcssrc"] = 599,
    [".powerpages-web-template-manifest"] = 601,
    [".pre-commit-config.yml"] = 602,
    [".pre-commit-hooks.yml"] = 603,
    [".putout.json"] = 633,
    [".rehyperc"] = 657,
    [".remarkrc"] = 661,
    [".sprite files"] = 750,
    ...
    ["A micro editor config"] = 485,
    ABCInventoryModuleData = 20,
    ABCSupplyPlan = 21,
    AIConfig = 22,
    ["AMX Muse Program Descriptor"] = 1097,
    ["API Builder"] = 911,
    ["AVA Configuration"] = 973,
    ["AWS AppConfig Feature Flags-v1"] = 53,
    ["AWS CDK cdk.json"] = 225,
    ["AWS CloudFormation"] = 226,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 227,
    ["AWS Copilot Manifest"] = 1136,
    ["AWS SAM CLI Samconfig"] = 228,
    ["Adobe UXP Manifest"] = 1035,
    ["Aerleon Network & Service Definitions"] = 15,
    ["Aerleon Policy"] = 16,
    Aider = 1126,
    Air = 18,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1147,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1146,
    ["Airlock Microgateway"] = 23,
    ["Alacritty Configuration"] = 945,
    ["All Contributors configuration file"] = 998,
    ["Ansible Argument Specs"] = 360,
    ["Ansible Collection Galaxy"] = 367,
    ["Ansible Execution Environment"] = 357,
    ["Ansible Inventory"] = 366,
    ["Ansible Meta"] = 358,
    ["Ansible Meta Runtime"] = 359,
    ["Ansible Navigator Configuration"] = 369,
    ["Ansible Playbook"] = 364,
    ["Ansible Requirements"] = 361,
    ["Ansible Rulebook"] = 365,
    ["Ansible Tasks File"] = 363,
    ["Ansible Vars File"] = 362,
    ["Ansible-lint Configuration"] = 368,
    Any = 1062,
    ["AnyWork Automation Configuration"] = 11,
    ["App config Spotify Backstage"] = 27,
    ["Application Accelerator"] = 8,
    ["Application list for a WinUtil"] = 1079,
    ArchitectFX = 1084,
    ["Argo Events"] = 41,
    ["Argo Workflows"] = 42,
    AssemblyScript = 45,
    AsyncAPI = 48,
    ["AsyncAPI Tool File"] = 49,
    ["Atmos Manifests"] = 50,
    ["Aurora Agile Meta-Framework"] = 51,
    AutoAPICase = 1008,
    ["Avro Avsc"] = 52,
    ["Azure Container App template for defining an immutable revision"] = 54,
    ["Azure DevOps extension manifest"] = 57,
    ["Azure Device Update for IoT Hub import manifest"] = 55,
    ["Azure Device Update for IoT Hub update manifest"] = 56,
    ["Azure IoT Edge deployment"] = 60,
    ["Azure IoT Edge deployment template"] = 61,
    ["Azure IoT EdgeAgent deployment"] = 58,
    ["Azure IoT EdgeHub deployment"] = 59,
    ["Azure IoT Operations Wasm Graph Config"] = 1145,
    ["Azure IoT Operations connector metadata"] = 1142,
    ["Azure Landing Zones Library archetype definition"] = 65,
    ["Azure Landing Zones Library archetype override"] = 66,
    ["Azure Landing Zones Library architecture definition"] = 64,
    ["Azure Landing Zones Library metadata"] = 62,
    ["Azure Landing Zones Library policy default values"] = 63,
    ["Azure Pipelines"] = 83,
    ["Azure Static Web Apps CLI configuration file"] = 754,
    ["Azure Static Web Apps configuration file"] = 753,
    ["BOSH CPI Config"] = 107,
    ["BOSH Deploy Config"] = 108,
    ["BX CI"] = 127,
    ["Bacon config"] = 2,
    ["Bashly (bashly.yml)"] = 1002,
    ["Bashly Settings (bashly-settings.yml)"] = 1003,
    ["Better Code Hub"] = 915,
    ["Better Scripts"] = 128,
    Bigconfig = 100,
    ["Biome Formatter Config"] = 67,
    ["Bitmovin Encoding Template"] = 1090,
    BizTalkServerApplicationSchema = 883,
    Bleep = 129,
    ["Block Protocol Metadata"] = 126,
    ["Boyka Framework"] = 109,
    Briefcase = 889,
    ["Build Info"] = 117,
    Buildkite = 119,
    ["Bukkit plugin.yml"] = 118,
    ["BungeeCord plugin.yml"] = 124,
    ["Butane Config"] = 958,
    C4InterFlow = 1105,
    ["CDK Environment Manager, concrete environment configuration"] = 1129,
    ["CDK Environment Manager, concrete environments definition"] = 1128,
    ["CDK Environment Manager, environment definition"] = 1127,
    ["CGS Card Game Specification (cgs.json)"] = 1040,
    ["CICS TS region tagging"] = 967,
    ["CICS TS resource import"] = 968,
    ["CICS TS resource model"] = 969,
    ["CICS TS resource overrides"] = 970,
    ["CMake Presets"] = 130,
    ["CNC Codes"] = 151,
    ["CRS WAF test file"] = 1069,
    ["CRS WAF test platform overrides file"] = 1070,
    ["CSS Comb (.csscomb.json)"] = 253,
    ["CSS Lint (.csslintrc)"] = 254,
    ["CSpell (cspell.json)"] = 252,
    ["CVE Record Format"] = 159,
    CWL = 1046,
    ["Cache Warmup config"] = 131,
    ["Calqulus pipeline"] = 132,
    ["Camel YAML DSL"] = 133,
    ["Cannon TOML"] = 134,
    Carafe = 135,
    ["Cargo Make"] = 137,
    ["Cargo Manifest"] = 136,
    ["Catalog Info Backstage"] = 138,
    ["Chamaleon environment"] = 1094,
    ["Chamaleon properties"] = 1095,
    ["Chamaleon template"] = 1093,
    Changesets = 237,
    Changie = 139,
    Charmcraft = 140,
    Cheatsheets = 955,
    ["ChordPro Configuration"] = 141,
    ["Chrome Extension"] = 218,
    ["Chromia Model"] = 142,
    ["Chromia Seeder Module Config"] = 144,
    ["Chromia Seeder Root Config"] = 143,
    ["Cinnamon Spice info.json"] = 74,
    ["CircleCI config.yml"] = 194,
    ["Citation File Format"] = 239,
    CityJSON = 146,
    ["Claude Code Settings"] = 158,
    ["Clawject config"] = 157,
    ["Cloud Foundry Application Manifest"] = 1051,
    ["Cloud Run Spec v1"] = 1074,
    ["CloudCannon Configuration"] = 78,
    ["CloudEvents specification"] = 147,
    ["Code Climate"] = 195,
    CodeCV = 76,
    CodeRabbit = 75,
    ["CodeShip Pro services configuration files"] = 207,
    ["CodeShip Pro steps configuration files"] = 208,
    ["Codecov configuration files"] = 206,
    CodifyCLI = 77,
    Codux = 204,
    ["Cog config file"] = 152,
    ["Commandbox Box.json"] = 153,
    ["Commandbox Server.json"] = 154,
    ["Common Catalog Data"] = 216,
    ["Common Package Specification"] = 155,
    Concord = 1068,
    ["Configu .cfgu files"] = 1056,
    ["Configu .configu file"] = 1057,
    Conjure = 150,
    ["Container Structure Test"] = 897,
    Containerlab = 924,
    ["Contextive Glossary"] = 1121,
    Convex = 149,
    ["Crowdsec collection config"] = 247,
    ["Crowdsec parser config"] = 248,
    ["Crowdsec scenario config"] = 249,
    ["CumulusCI Config"] = 156,
    ["Custom Machinery Machine"] = 1041,
    ["Custom Machinery Recipe"] = 1042,
    ["Cycle Stack File"] = 160,
    CycloneDX = 161,
    ["DWP Exchange - catalogue entry"] = 296,
    ["DWP Exchange - gateway"] = 294,
    ["DWP Exchange - meta"] = 295,
    ["Dart Build Config (dart-build.json)"] = 255,
    ["Dart Test Config (dart-test.json)"] = 256,
    ["DashLord Configuration"] = 257,
    ["Data Contract Specification"] = 258,
    ["Data Product Specification"] = 259,
    ["DataYoga Connections"] = 162,
    ["DataYoga Job"] = 163,
    ["Databricks Asset Bundles"] = 1019,
    ["Datadog Continuous Testing"] = 456,
    ["Datadog Service Definition"] = 457,
    ["Datadog Software Catalog"] = 458,
    ["Datahub Ingestion Recipe"] = 974,
    ["Debian Upstream Metadata file"] = 169,
    ["Deck config"] = 170,
    ["Dein Config"] = 171,
    ["Deno Config (deno.json)"] = 265,
    ["Dependency cruiser"] = 172,
    ["DeployStack Configuration"] = 173,
    ["Deployah Configuration"] = 1144,
    ["Deployer Recipe"] = 268,
    ["Deta Spacefile"] = 174,
    ["Detekt Config (detekt.yml)"] = 269,
    ["Devbox Config"] = 175,
    ["Devbox Plugin"] = 176,
    Devfile = 293,
    DipDup = 1071,
    ["Discord Webhook"] = 270,
    ["DocFx Config (docfx.json)"] = 274,
    Dofigen = 275,
    ["Dolittle Artifacts"] = 276,
    ["Dolittle Bounded Context Configuration"] = 277,
    ["Dolittle Event Horizons Configuration"] = 278,
    ["Dolittle Resources Configuration"] = 279,
    ["Dolittle Server Configuration"] = 280,
    ["Dolittle Tenant Map Configuration"] = 282,
    ["Dolittle Tenants Configuration"] = 281,
    ["Dolittle Topology"] = 283,
    ["DonateCaseBetterCasino menu"] = 1098,
    ["Drupal Breakpoints"] = 177,
    ["Drupal Config"] = 189,
    ["Drupal Info"] = 178,
    ["Drupal Layouts"] = 179,
    ["Drupal Libraries"] = 180,
    ["Drupal Links Action"] = 181,
    ["Drupal Links Contextual"] = 182,
    ["Drupal Links Menu"] = 183,
    ["Drupal Links Task"] = 184,
    ["Drupal Migration"] = 185,
    ["Drupal Permissions"] = 186,
    ["Drupal Recipe"] = 187,
    ["Drupal Routing"] = 188,
    ["Drupal Services"] = 190,
    ["Drush site aliases"] = 289,
    ["Dynamic Bash Aliases (.aliases)"] = 1010,
    ["EAS config"] = 313,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 999,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1141,
    ["EasyVCR .NET"] = 314,
    ["Eidolon Resource"] = 1085,
    ["Elgato Stream Deck"] = 299,
    Elm = 1073,
    ["Embrace Config"] = 985,
    Endurica = 1023,
    ["Enterprise Contract Policy Spec"] = 300,
    ["Erda Pipeline"] = 1048,
    ["Erda Runtime"] = 1049,
    Esquio = 302,
    ["Estuary Flow Catalog"] = 964,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 306,
    ["EveryVoice TTS Toolkit Data Configuration"] = 307,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 311,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 310,
    ["EveryVoice TTS Toolkit Text Configuration"] = 308,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 309,
    ["Evolving Resolutive Process notation"] = 1143,
    ["Expo SDK"] = 312,
    ["F-Droid Data metadata"] = 318,
    ["FasterCI Configuration"] = 84,
    FiQuS = 322,
    Firebase = 320,
    ["FlexGet Config"] = 323,
    ["Flow.json Configurations"] = 1045,
    ["Fossa configuration file"] = 330,
    ["Fossa's fossa-deps file"] = 331,
    ["Foundry VTT - Base package Manifest"] = 325,
    ["Foundry VTT - Module Manifest"] = 326,
    ["Foundry VTT - System Data Template"] = 329,
    ["Foundry VTT - System Manifest"] = 327,
    ["Foundry VTT - World Manifest"] = 328,
    ["Foxx Manifest"] = 85,
    ["Freifunk.de Community API"] = 88,
    ["Frogbot Config"] = 89,
    ["G2P Mapping Configuration"] = 337,
    ["GCP Blueprint Metadata"] = 340,
    Gaspar = 338,
    ["GatewayCore API Gateway"] = 339,
    ["Gemini CLI settings"] = 341,
    ["GeoJSON.json latest"] = 962,
    GherKing = 966,
    ["GitHub Action"] = 346,
    ["GitHub Actions typing"] = 1081,
    ["GitHub Discussion"] = 347,
    ["GitHub Funding"] = 348,
    ["GitHub Issue Template configuration"] = 349,
    ["GitHub Issue Template forms"] = 350,
    ["GitHub Workflow"] = 351,
    ["GitHub Workflow Template Properties"] = 352,
    ["GitHub automatically generated release notes configuration"] = 353,
    ["GitLab Agent for Kubernetes configuration"] = 1037,
    GitVersion = 343,
    ["Gitea Issue Template configuration"] = 344,
    ["Gitea Issue Template forms"] = 345,
    ["Gitpod Automations"] = 355,
    ["Gitpod Configuration"] = 356,
    ["GlazeWM settings"] = 1039,
    ["Global Privacy Control"] = 342,
    Goblet = 1018,
    ["Golangci-lint Configuration"] = 371,
    ["Golangci-lint Custom Plugins Configuration"] = 372,
    ["Google Chrome Related Website Sets"] = 321,
    ["Google Cloud Workflows"] = 224,
    ["Google Digital Assetlinks"] = 1122,
    Goreleaser = 374,
    ["Goreleaser Pro"] = 375,
    Goss = 376,
    ["Gradle Build Cache Node"] = 913,
    ["Gradle Enterprise"] = 912,
    ["Grafana 5.x Dashboard"] = 377,
    ["GraphQL Code Generator"] = 382,
    ["GraphQL Config"] = 381,
    ["GraphQL Mesh"] = 380,
    ["Grunt JSHint task"] = 386,
    ["Grunt Watch task"] = 387,
    ["Grunt base task"] = 388,
    ["Grunt clean task"] = 384,
    ["Grunt copy task"] = 383,
    ["Grunt cssmin task"] = 385,
    HEMTT = 879,
    Hadolint = 893,
    Hammerkit = 923,
    ["Hardware Sentry Configuration"] = 978,
    ["HashiCorp Vault"] = 389,
    Hatch = 894,
    Hayagriva = 391,
    Hayson = 392,
    ["Haystack Pipeline"] = 393,
    ["Hazelcast 5 Configuration"] = 394,
    ["Hecate Input Schema"] = 1133,
    ["Helm Chart.lock"] = 192,
    ["Helm Chart.yaml"] = 191,
    ["Helm Unittest Test Suite"] = 193,
    ["Home Assistant Integration Manifest"] = 395,
    ["Homer dashboard configuration"] = 396,
    Hugo = 954,
    ["Hugo Theme"] = 953,
    ["Hulak Configuration"] = 403,
    ["Hyperfoil benchmark configuration"] = 402,
    ["IBM Zapp document"] = 404,
    ["IBM zCodeFormatSettings"] = 405,
    ["IMG Catapult PSP"] = 410,
    ["IVMS101 by CODE Protocol"] = 1038,
    Infrahub = 412,
    Istanbul = 981,
    ["JDownloader2 crawler multi-rules"] = 423,
    ["JDownloader2 crawler single-rules"] = 422,
    ["JFrog Applications Config"] = 424,
    ["JFrog File Spec"] = 425,
    ["JFrog Pipelines YML DSL"] = 987,
    ["JMeter DSL cli config"] = 426,
    JReleaser = 429,
    ["JSON Document Transform"] = 437,
    ["JSON Feed"] = 438,
    ["JSON Resume"] = 667,
    ["JSON Schema Draft 2020-12"] = 861,
    ["JSON Schema Draft 4"] = 858,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1020,
    ["JSON Schema Draft 7"] = 859,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1021,
    ["JSON Schema Draft 8 (2019-09)"] = 860,
    ["JSON-API"] = 436,
    ["JSON-e templates"] = 920,
    ["JSON-stat 2.0"] = 854,
    JSONPatch = 440,
    ["JSR Package Config (jsr.json)"] = 430,
    Jasmine = 417,
    Jekyll = 418,
    ["Jenkins X Pipelines"] = 419,
    ["Jenkins X Requirements"] = 420,
    Jest = 421,
    Jocker = 427,
    ["Jovo Language Models"] = 428,
    ["Jujutsu (jj) VCS config"] = 1135,
    ["KIMMDY config file"] = 451,
    ["KODE/CI build.yaml"] = 983,
    ["KSP-AVC"] = 855,
    ["KSP-CKAN"] = 856,
    ["KSP-NetKAN"] = 857,
    KSY = 1050,
    KSail = 335,
    ["Karakum configuration file"] = 332,
    Kas = 443,
    ["Kestra flow file"] = 452,
    ["Keycloak REST API"] = 990,
    ["Knative Functions - func.yaml"] = 333,
    Knip = 334,
    ["Kometa (nightly) config file"] = 454,
    ["Kometa config file"] = 453,
    ["Kong DBLess config"] = 984,
    KrakenD = 455,
    ["Kubri Configuration"] = 462,
    LOOBin = 477,
    ["Lake configuration file"] = 1138,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 229,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 230,
    ["Landing Zone Accelerator on AWS - Global Config"] = 231,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 232,
    ["Landing Zone Accelerator on AWS - Network Config"] = 233,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 234,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 235,
    ["Landing Zone Accelerator on AWS - Security Config"] = 236,
    ["Lando (landofile)"] = 79,
    ["LangGraph Platform configuration"] = 1061,
    ["Language configuration"] = 1060,
    Lefthook = 466,
    ["Liferay client-extension.yaml"] = 473,
    ["LinkML Metamodel"] = 475,
    Liquibase = 929,
    ["Liquibase Flow File"] = 930,
    ["Lively Properties"] = 476,
    ["Lobe AI Agent"] = 81,
    Loki = 82,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 517,
    ["MS2Rescore Configuration"] = 520,
    ["Madness (madness.yml)"] = 1001,
    ["Mado configuration"] = 483,
    ["MapEHR Mapping"] = 484,
    Markdownlint = 933,
    ["Mason Registry"] = 936,
    ["MegaLinter Custom Flavor"] = 487,
    ["MegaLinter configuration"] = 486,
    ["MegaLinter descriptor"] = 488,
    Melange = 1028,
    ["Meltano project definition"] = 489,
    ["Mergify Configuration"] = 521,
    ["Metadata for a Bazel module"] = 490,
    ["Metadata for a Cinnamon spice"] = 1077,
    ["Metatype Configuration"] = 491,
    ["MetricsHub Configuration"] = 492,
    ["MetricsHub Connector Configuration"] = 493,
    ["Micro Editor Syntax"] = 1011,
    ["Microsoft Band Web Tile"] = 494,
    ["Microsoft RulesEngine workflow rules"] = 1065,
    ["Microsoft RulesEngine workflow rules list"] = 1066,
    ["Minecraft Custom Main Menu Mod"] = 1029,
    ["Minecraft Data Pack Advancement"] = 496,
    ["Minecraft Data Pack Biome"] = 497,
    ["Minecraft Data Pack Configured Carver"] = 498,
    ["Minecraft Data Pack Damage Type"] = 499,
    ["Minecraft Data Pack Dimension"] = 501,
    ["Minecraft Data Pack Dimension Type"] = 500,
    ["Minecraft Data Pack Item Modifier"] = 502,
    ["Minecraft Data Pack Loot Table"] = 503,
    ["Minecraft Data Pack Metadata"] = 504,
    ["Minecraft Data Pack Predicate"] = 505,
    ["Minecraft Data Pack Recipe"] = 506,
    ["Minecraft Data Pack Tag"] = 507,
    ["Minecraft Data Pack Template Pool"] = 508,
    ["Minecraft Data Pack Trim Material"] = 513,
    ["Minecraft Data Pack Trim Pattern"] = 514,
    ["Minecraft Resource Pack Lang"] = 509,
    ["Minecraft Resource Pack Particle"] = 510,
    ["Minecraft Resource Pack Texture Mcmeta"] = 512,
    ["Minecraft Resourcepack Sounds"] = 511,
    ["Monade CLI Stack Configuration"] = 524,
    ["MongoDB Atlas Search Index Definition"] = 982,
    ["Monika Configuration"] = 980,
    ["Monoweave Configuration"] = 519,
    ["Motif config"] = 875,
    MultiQC = 1115,
    ["NOX Framework (Service)"] = 538,
    ["Netin Diagnostic System Template"] = 940,
    ["Netlify config"] = 527,
    ["Network-as-Code Data Model"] = 528,
    ["Next Gen UI Agent Configuration"] = 529,
    ["Nightwatch.js"] = 531,
    ["Node.js configuration"] = 880,
    ["NueJS configuration file"] = 543,
    ["Nuitka.yaml"] = 1043,
    ["Nullstone config"] = 545,
    ["ONe's changelog entry"] = 560,
    ["ONe's service descriptor"] = 559,
    ["ORT Server repository environment configuration"] = 568,
    ["OSCAL Assessment Plan (AP)"] = 570,
    ["OSCAL Assessment Results (AR)"] = 571,
    ["OSCAL Catalog"] = 572,
    ["OSCAL Component Definition (CDef)"] = 573,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 574,
    ["OSCAL Profile"] = 575,
    ["OSCAL System Security Plan (SSP)"] = 576,
    ["OSS Review Toolkit configuration"] = 577,
    ["OSS Review Toolkit curation"] = 578,
    ["OSS Review Toolkit package configuration"] = 579,
    ["OSS Review Toolkit repository configuration"] = 580,
    ["OSS Review Toolkit resolutions"] = 581,
    ["October CMS columns"] = 549,
    ["October CMS fields"] = 550,
    Okteto = 551,
    ["Ona Automations"] = 553,
    Opctl = 878,
    ["Open Data Contract Standard (ODCS)"] = 563,
    ["Open Data Product Standard (ODPS)"] = 564,
    ["Open Know-How"] = 1120,
    ["OpenRewrite Resource"] = 562,
    OpenStatus = 1131,
    ["OpenUtau character yaml"] = 556,
    ["OpenUtau ustx"] = 557,
    ["OpenWeather Current Weather API"] = 919,
    ["OpenWeather Road Risk API"] = 918,
    ["Ory Hydra configuration"] = 401,
    ["Ory Keto configuration"] = 459,
    ["Ory Kratos configuration"] = 569,
    ["Ory Oathkeeper configuration"] = 547,
    ["Outblocks App configuration"] = 566,
    ["Outblocks database table"] = 567,
    ["Outblocks project configuration"] = 565,
    PDM = 588,
    Packer = 585,
    Pantsbuild = 997,
    ["Paper paper-plugin.yml"] = 586,
    ["Pipeline component"] = 931,
    ["Platform.sh application"] = 4,
    ["Platform.sh routes"] = 5,
    ["Platform.sh services"] = 6,
    ["Plex Prerolls"] = 596,
    ["PocketMine plugin.yml"] = 593,
    ["Postman collection"] = 600,
    ["Power Pages Configuration"] = 1132,
    ["Preset list for a WinUtil"] = 1080,
    ["ProActions AI-Kit Configuration"] = 609,
    ["ProActions AI-Kit Configuration for Menus"] = 611,
    ["ProActions AI-Kit Configuration for Sections"] = 613,
    ["ProActions AI-Kit Configuration for Services"] = 610,
    ["ProActions AI-Kit Configuration for Steps"] = 614,
    ["ProActions AI-Kit Configuration for Templates"] = 612,
    ["Problem object RFC9457"] = 1026,
    ["Problem package generators"] = 615,
    Pterodactyl = 977,
    ["Pull Request Labeler"] = 632,
    Pulumi = 640,
    ["PyGTA Config"] = 636,
    PyProject = 641,
    Pylock = 1123,
    Pyright = 642,
    ["Python script metadata"] = 1117,
    ["QType AI DSL"] = 645,
    Qgoda = 644,
    Qodana = 950,
    ["Qt Creator workspace file"] = 1058,
    ["Quali Torque Blueprint Spec 2"] = 975,
    ["QueryFirst config file"] = 993,
    ["RKE Cluster Configuration JSON"] = 928,
    ["RKE Cluster Configuration YAML"] = 927,
    RadioHound = 635,
    Railway = 646,
    ["Rancher Fleet"] = 637,
    ["Rattler-build"] = 647,
    Ray = 892,
    ["Read the Docs"] = 639,
    ["Red-DiscordBot Cog"] = 654,
    ["Red-DiscordBot Cog Repo"] = 655,
    ["Red-DiscordBot Trivia"] = 656,
    ["Render Blueprints"] = 926,
    RenderCV = 669,
    Renovate = 668,
    ["Replit config"] = 662,
    Restate = 1110,
    ["Revel Digital Gadget Definition File"] = 1134,
    RoadRunner = 671,
    ["Robust Station Image"] = 1140,
    Rockcraft = 672,
    ["Roo Coder Custom Modes"] = 673,
    Rubocop = 664,
    ["Rudder techniques"] = 1033,
    Ruff = 665,
    ["Rust Project"] = 666,
    ["Rust toolchain"] = 677,
    ["SDMX data message"] = 703,
    ["SDMX metadata message"] = 702,
    ["SDMX structure message"] = 701,
    ["SIL Kit Participant Configuration"] = 713,
    ["SIL Kit Registry Configuration"] = 714,
    ["SPDX 2.3"] = 751,
    SWADL = 767,
    ["Safebox Config"] = 988,
    ["Sapphire CLI Config"] = 680,
    ["SauceCTL Configuration"] = 937,
    ["Schema Catalog"] = 695,
    ["Scoop manifest"] = 700,
    ["Semantic Data Fabric (SDF) file"] = 704,
    ["Semgrep Rule"] = 706,
    ["Serenity Code Generator (Sergen)"] = 707,
    ["Serverless Framework Configuration"] = 944,
    ["Serverless Workflow"] = 946,
    ["Settings for a Cinnamon spice"] = 1076,
    ["Settings.paf"] = 709,
    ["Shopware 6 Configuration"] = 947,
    ["Shopware CLI Extension Store Configuration"] = 948,
    ["Shopware CLI Project Store Configuration"] = 949,
    ["Sigma Detection Rule"] = 711,
    ["Sigrid scope configuration file"] = 712,
    ["SkyPilot Task JSON"] = 1034,
    ["Slack app manifest"] = 716,
    Snapcraft = 718,
    Solidarity = 721,
    ["Solution filters"] = 722,
    ["Source Maps v3"] = 723,
    Sourcery = 724,
    ["Spack bootstrap.yaml"] = 725,
    ["Spack cdash.yaml"] = 726,
    ["Spack ci.yaml"] = 727,
    ["Spack compilers.yaml"] = 728,
    ["Spack concretizer.yaml"] = 729,
    ["Spack config.yaml"] = 730,
    ["Spack definitions.yaml"] = 731,
    ["Spack develop.yaml"] = 732,
    ["Spack env_vars.yaml"] = 733,
    ["Spack environment"] = 739,
    ["Spack include.yaml"] = 734,
    ["Spack mirrors.yaml"] = 735,
    ["Spack modules.yaml"] = 736,
    ["Spack packages.yaml"] = 737,
    ["Spack repos.yaml"] = 738,
    ["Spack toolchains.yaml"] = 740,
    ["Spack upstreams.yaml"] = 741,
    ["Spack view.yaml"] = 742,
    ["Speakeasy Generation Config File"] = 746,
    ["Speakeasy Lint Configuration File"] = 743,
    ["Speakeasy Test Generation Configuration File"] = 744,
    ["Speakeasy Workflow File"] = 745,
    SpecIF = 747,
    ["Specmatic Configuration"] = 748,
    ["Sponge Mixin configuration"] = 749,
    StackBlitz = 755,
    ["StackHawk Scanner Configuration"] = 943,
    Stale = 756,
    Starfish = 757,
    ["Starlake Data Pipeline"] = 916,
    Starship = 758,
    ["Statamic Blueprint"] = 759,
    ["Stella configuration file"] = 760,
    ["Streamlit configuration file"] = 761,
    ["Stryker Mutator"] = 764,
    ["StyleCop Analyzers Configuration"] = 765,
    ["Stylelint (.stylelintrc)"] = 766,
    ["Stylua Config"] = 1124,
    ["Sublime Syntax"] = 989,
    ["Subsquid squid manifest"] = 1036,
    ["Swagger API 2.0"] = 768,
    ["Synadia Connect Component"] = 769,
    TSON = 804,
    TSTyche = 805,
    ["TYPO3 Vendor Bundler config"] = 810,
    ["Tab data for a LinUtil"] = 1083,
    ["Tab list for a LinUtil"] = 1082,
    Tach = 770,
    ["Tach Domain"] = 771,
    Talhelper = 773,
    ["Talisman configuration"] = 774,
    Taplo = 1125,
    ["Taskfile config"] = 921,
    Taurus = 775,
    Tauticord = 776,
    Telefonistka = 1111,
    ["Terrateam config"] = 1137,
    ["TestEnvironment.json"] = 787,
    ["TextMate Grammar"] = 786,
    Threagile = 782,
    ["Tier.run pricing.json"] = 779,
    Tikibase = 780,
    Tombi = 785,
    ["Traefik v2"] = 790,
    ["Traefik v2 File Provider"] = 791,
    ["Traefik v3"] = 792,
    ["Traefik v3 File Provider"] = 793,
    ["Travis CI (.travis.yml)"] = 789,
    Treefmt = 379,
    Trident = 1107,
    ["TrueScript for *.tscript files"] = 796,
    ["Tugboat QA config.yml"] = 1104,
    TunnelHub = 1024,
    Turborepo = 788,
    Tycho = 1072,
    Tye = 951,
    ["Tyk Gateway - Open Source v5.7+"] = 1116,
    ["Typst Manifest"] = 811,
    ["UET BuildConfig.json"] = 994,
    ["UI5 Manifest"] = 817,
    ["UNCORS configuration"] = 821,
    ["UTAM Page Object"] = 820,
    ["Ubuntu Server Autoinstall"] = 815,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1108,
    ["Uniswap Token List"] = 904,
    ["Universal Schedule Format"] = 822,
    ["Unreal Engine Uplugin"] = 995,
    ["Unreal Engine Uproject"] = 996,
    ["UpCloud CLI (upctl) configuration"] = 1109,
    ["Updatecli Compose"] = 959,
    ["Updatecli Policy Manifest"] = 960,
    ["Updatecli Policy Metadata"] = 961,
    Uplift = 992,
    ["Upsun config"] = 3,
    ["User Journey Map"] = 925,
    V2Ray = 965,
    ["VSCode Code Snippets"] = 212,
    ["VSIX CLI publishing"] = 842,
    Vector = 824,
    ["Vela Pipeline Configuration"] = 827,
    Vercel = 211,
    ["Version Bumper config"] = 832,
    ["Viash Component Config"] = 1113,
    ["Viash Package Config"] = 1114,
    Visivo = 1022,
    ["WP-CLI"] = 852,
    Wake = 1106,
    ["Waku Config"] = 1086,
    ["Web App Manifest"] = 848,
    ["Web types"] = 851,
    WebExtensions = 847,
    ["Webman package recipe"] = 971,
    ["Windows Package Manager Installer Manifest"] = 900,
    ["Windows Package Manager Locale Manifest"] = 901,
    ["Windows Package Manager Singleton Manifest"] = 899,
    Winutil = 902,
    ["WireMock stub mapping"] = 1089,
    ["Woodpecker pipeline config"] = 939,
    ["Wrangler CLI"] = 853,
    ["Xstate Machine"] = 957,
    ["Yandex Workflow Language"] = 1078,
    ["Yarn Config (.yarnrc.yml)"] = 914,
    ["Yippee-Ki-JSON configuration YML"] = 906,
    ["YouTrack App"] = 1075,
    ["Zarf Package Configuration"] = 1139,
    ["Zerops.io config"] = 1063,
    ["Zerops.io import"] = 1064,
    ["aerleon.yml"] = 14,
    ["angular.json"] = 24,
    apko = 1027,
    ...
    ["arc.json"] = 40,
    ["architect.yml"] = 39,
    ["artifacthub-repo.yml"] = 43,
    ["asm-lsp"] = 44,
    ["ast-grep rules"] = 47,
    ["ast-grep sgconfig.yml"] = 46,
    ["babelrc.json"] = 91,
    ["bamboo-spec"] = 94,
    ["bashly-strings.yml"] = 1004,
    ["batect.yml"] = 93,
    ["beef-database-codegen"] = 95,
    ["beef-database-v5-codegen"] = 97,
    ["beef-entity-codegen"] = 96,
    ["beef-entity-v5-codegen"] = 98,
    ["behat.yml"] = 110,
    ["bigquery-table"] = 99,
    ["bioimageio resource description"] = 1044,
    ["bitbucket-pipelines"] = 101,
    bitrise = 102,
    ["bitrise-step"] = 103,
    ["block.json"] = 125,
    ["bottom configuration"] = 68,
    ["bower.json"] = 105,
    ["bozr.suite.json"] = 112,
    bpkg = 1005,
    ["browser.i18n.json"] = 113,
    ["browsh configuration"] = 114,
    bucklescript = 115,
    ["buf.gen.yaml"] = 70,
    ["buf.plugin.yaml"] = 71,
    ["buf.work.yaml"] = 72,
    ...
    ["build-changelog"] = 116,
    ["bun.lock"] = 121,
    ["bundleconfig.json"] = 122,
    ["bunfig.toml"] = 123,
    ["cargo-mutants-config.yaml"] = 73,
    ["ccmod.json"] = 1087,
    changelogging = 1055,
    ["chisel-slices.json"] = 238,
    ["chrome-extension-locales-messages.json"] = 219,
    ["chutzpah.json"] = 220,
    cibuildwheel = 145,
    ["clang-format (.clang-format)"] = 963,
    ["clang-tidy"] = 199,
    clangd = 198,
    clib = 200,
    ["cloud-init: cloud-config userdata"] = 202,
    ["cloud-sdk-pipeline-configuration"] = 222,
    ["cloudbuild.json"] = 223,
    cloudify = 201,
    codemagic = 203,
    ["coffeelint.json"] = 240,
    ["commands.json"] = 215,
    ["commitlint (.commitlintrc)"] = 903,
    ["committed.toml"] = 241,
    ["compile_commands.json"] = 214,
    ["compilerconfig.json"] = 213,
    ["completely.yml"] = 1000,
    ["component-detection-manifest.json"] = 244,
    ["component.json"] = 243,
    ["composer.json"] = 242,
    ["conda-forge"] = 148,
    ["config.yaml"] = 638,
    ["contentmanifest.json"] = 221,
    ["contribute.json"] = 245,
    ["cosmos.config.json"] = 217,
    ["crowdin.yml"] = 246,
    ["ctfd-setup configuration file"] = 1096,
    ["custom-elements.json"] = 1014,
    ["cypress.json"] = 250,
    ["datalogic-scan2deploy-android"] = 260,
    ["datalogic-scan2deploy-ce"] = 261,
    ["dbt Dependencies"] = 164,
    ["dbt Packages"] = 166,
    ["dbt Project"] = 165,
    ["dbt Selectors"] = 167,
    ["dbt YAML files"] = 168,
    ["ddev-global"] = 262,
    ["ddev-project"] = 263,
    ["debugsettings.json"] = 264,
    ["dependabot-v2.json"] = 267,
    ["dependabot.json"] = 266,
    ["deployed-cli"] = 956,
    ["devcontainer.json"] = 205,
    devinit = 908,
    ["devspace.yaml"] = 979,
    djlint = 909,
    ["docker bake"] = 272,
    ["docker sequencer"] = 273,
    ["docker-compose.yml"] = 907,
    ["dockerd.json"] = 271,
    ["dotnet Release Index manifest"] = 284,
    ["dotnet-tools.json"] = 285,
    ["dotnetcli.host.json"] = 286,
    ["dprint.json"] = 287,
    ["drone.json"] = 288,
    ["dss-2.0.0.json"] = 290,
    ["dstack configuration"] = 291,
    ["dtool dataset metadata"] = 1091,
    ["dvc.yaml"] = 292,
    ["ecosystem.json"] = 297,
    eksctl = 298,
    ["electron-builder configuration file"] = 304,
    ["epr-manifest.json"] = 303,
    ["evcc.yaml"] = 305,
    ["ezd task runner"] = 315,
    ["fabric.mod.json"] = 317,
    ["first-timers-bot"] = 324,
    ["flagd flag configuration"] = 86,
    ["fly.io Configuration"] = 87,
    fulibWorkflows = 938,
    ["function.json"] = 336,
    ["gRPC API Gateway & OpenAPI Config"] = 9,
    ["gematik health care insurance list"] = 1102,
    ["gematik health care patient list"] = 1099,
    ["gematik health care provider institution list"] = 1101,
    ["gematik health care provider list"] = 1100,
    ["gematik tiger test environment configuration"] = 1103,
    ["gitlab-ci"] = 354,
    ["global.json"] = 370,
    ["go-feature-flag Flag Configuration"] = 373,
    ["haxelib.json"] = 390,
    helmfile = 895,
    helmwave = 896,
    ["host-meta.json"] = 398,
    ...
    ["ide.host.json"] = 406,
    ["ifstate.yaml"] = 407,
    ["imageoptimizer.json"] = 408,
    ["importmap.json"] = 411,
    ["ioBroker Configuration"] = 413,
    ["ioBroker JSON UI"] = 414,
    ["ioBroker Package manifest"] = 415,
    ["ixpect.conf.yaml"] = 416,
    ["ize.toml"] = 991,
    ["jsconfig.json"] = 441,
    ["jscpd Configuration"] = 976,
    jsdoc = 891,
    ["k3d.yaml"] = 442,
    ["k9s aliases.yaml"] = 444,
    ["k9s cluster-config.yaml"] = 446,
    ["k9s config.yaml"] = 445,
    ["k9s hotkeys.yaml"] = 447,
    ["k9s plugins.yaml"] = 448,
    ["k9s skin.yaml"] = 449,
    ["k9s views.yaml"] = 450,
    ["kontinuous-config.yaml"] = 461,
    ["kontinuous-values.yaml"] = 460,
    ["kustomization.yaml"] = 463,
    ["label-commenter-config.yml"] = 464,
    ["latexindent configuration"] = 80,
    ["launchsettings.json"] = 465,
    lazydocker = 1013,
    lazygit = 1012,
    ["lego.json"] = 467,
    ["lerna.json"] = 468,
    ["lgtm.yml"] = 469,
    ["liblab.config.json"] = 470,
    ["libman.json"] = 471,
    ["license-report-config.json"] = 472,
    ["linkinator.config.json"] = 474,
    ["lint-staged (.lintstagedrc)"] = 869,
    ["local.settings.json"] = 479,
    ["localazy.json"] = 480,
    ["lotus.yaml"] = 478,
    ["lsdlschema.json"] = 481,
    ["markdown-link-check"] = 934,
    maturin = 935,
    mboats = 942,
    ["micro-settings.json"] = 1006,
    ["mimetypes.json"] = 495,
    ["mirrord config"] = 871,
    mise = 872,
    ["mkdocs.yml"] = 515,
    ["monospace.yml"] = 518,
    ["moon.yml"] = 1088,
    ["mprocs Configuration file"] = 1059,
    ["mrdocs.yml"] = 516,
    ["mta.yaml"] = 873,
    ["mtad.yaml"] = 874,
    ["mycode.json"] = 525,
    nFPM = 530,
    ["napari plugin manifest"] = 526,
    neoload = 886,
    ["nest-cli"] = 533,
    ["ninjs (News in JSON)"] = 532,
    ["nitro.json"] = 885,
    ["nixd configuration"] = 1032,
    ["nlu.json"] = 534,
    ["nodemon.json"] = 536,
    ["noodl config"] = 941,
    ["notebook.mod.json"] = 537,
    now = 881,
    ["npm-badges"] = 540,
    ["nswag.json"] = 544,
    ntangle = 546,
    ["nuclei-template.yaml"] = 541,
    ["nuget-project.json"] = 542,
    ["ocelot.json"] = 548,
    ["omnisharp.json"] = 552,
    ["openapi.json"] = 554,
    ["openfin.json"] = 561,
    ...
    ["ops.yaml"] = 558,
    ["package.json"] = 582,
    ["package.manifest"] = 584,
    ["package.yaml"] = 583,
    ["partial-black.json"] = 111,
    ["pathfinder.yml"] = 587,
    ["pattern.json"] = 590,
    ["petstore-v1.0"] = 986,
    pgap_yaml_input_reader = 589,
    ["pixi.toml"] = 591,
    ["plagiarize-me.yaml"] = 595,
    ["plagiarize.yaml"] = 594,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1092,
    ["podbard.yaml"] = 597,
    ["portman.json"] = 598,
    ["prefect.toml"] = 606,
    ["prettierrc.json"] = 607,
    ["prisma.yml"] = 608,
    ["project-1.0.0-beta3.json"] = 617,
    ["project-1.0.0-beta4.json"] = 618,
    ["project-1.0.0-beta5.json"] = 619,
    ["project-1.0.0-beta6.json"] = 620,
    ["project-1.0.0-beta8.json"] = 621,
    ["project-1.0.0-rc1.json"] = 622,
    ["project-1.0.0-rc2.json"] = 623,
    ["project.json"] = 616,
    ["project.owasp.yaml"] = 624,
    ["prometheus-alertmanager.json"] = 628,
    ["prometheus.json"] = 625,
    ["prometheus.rules.json"] = 626,
    ["prometheus.rules.test.json"] = 627,
    ["proxies.json"] = 629,
    ["publiccode.yml"] = 630,
    ["pubspec.yaml"] = 631,
    ["pyrseas-0.8.json"] = 634,
    pytest = 643,
    ["quilt.mod.json"] = 1007,
    ["rc3 auth"] = 648,
    ["rc3 collection"] = 649,
    ...
    ["release drafter"] = 887,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 658,
    ["release-please-manifest.json"] = 659,
    ["release-plz.toml"] = 660,
    ["renv.lock"] = 670,
    ["rivet.json"] = 1031,
    ["rivet.yaml (legacy)"] = 1030,
    rumdl = 675,
    runny = 674,
    rustfmt = 676,
    sake = 1119,
    samt = 678,
    samtrc = 679,
    ["sarif-1.0.0.json"] = 681,
    ["sarif-2.0.0.json"] = 682,
    ["sarif-2.1.0"] = 692,
    ["sarif-2.1.0-rtm.2"] = 683,
    ["sarif-2.1.0-rtm.3"] = 685,
    ["sarif-2.1.0-rtm.4"] = 687,
    ["sarif-2.1.0-rtm.5"] = 689,
    ["sarif-2.1.0-rtm.6"] = 690,
    ["sarif-external-property-file-2.1.0"] = 693,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 684,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 686,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 688,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 691,
    ["scalingo.json configuration"] = 694,
    ["schema.org - Action"] = 696,
    ["schema.org - ContactPoint"] = 697,
    ["schema.org - Place"] = 698,
    ["schema.org - Thing"] = 699,
    ["secrethub.yml"] = 1009,
    ["semantic-release"] = 705,
    ["servicehub.config.json"] = 864,
    ["servicehub.service.json"] = 863,
    ["settings.job"] = 708,
    ["sfdx-hardis configuration"] = 710,
    ["shard.yml"] = 1047,
    ["size-limit configuration"] = 715,
    ["skaffold.yaml"] = 932,
    ["skyuxconfig.json"] = 717,
    ["snowflake-config"] = 719,
    ["snowflake-connections"] = 720,
    ["spicepod.yaml"] = 1067,
    ["sqlc configuration"] = 752,
    ["stripe-app-local.json"] = 763,
    ["stripe-app.json"] = 762,
    swcrc = 917,
    ["task.json"] = 772,
    taskcat = 882,
    ["template.json"] = 777,
    ["templatsources.json"] = 778,
    ["theme.json"] = 781,
    ["tizen_workspace.json"] = 783,
    tldr = 784,
    ["tm_devices configuration file"] = 1130,
    tmuxinator = 867,
    ["transcend.yml"] = 794,
    ["tree-sitter grammar.json"] = 378,
    ["trime.yaml"] = 795,
    ["trunk.yaml"] = 797,
    ["ts-force-config.json"] = 802,
    ["tsconfig.json"] = 798,
    ["tsd.json"] = 799,
    ["tsdoc.json"] = 800,
    ["tsdrc.json"] = 801,
    ...
    v8r = 846,
    vcluster = 1053,
    ["vcpkg configuration file"] = 210,
    ["vcpkg manifest file"] = 209,
    ["vega-lite.json"] = 826,
    ["vega.json"] = 825,
    ["venvironment-basic.yaml"] = 829,
    ["venvironment.yaml"] = 828,
    ["venvplus-basic.yaml"] = 831,
    ["venvplus.yaml"] = 830,
    version = 1112,
    ["version.json"] = 833,
    ["vhwdebugger-binding.yaml"] = 835,
    ["vim-addon-info"] = 836,
    ["vs-2017.3.host.json"] = 838,
    ["vs-nesting.json"] = 839,
    ["vsls.json"] = 837,
    ["vss-extension.json"] = 843,
    vtcfg = 1118,
    ["vtesttree.yaml"] = 844,
    ["vtestunit.yaml"] = 845,
    ["warp-keysets.json"] = 1015,
    ["warp-themes.json"] = 1016,
    ["warp-workflows.json"] = 1017,
    ["webhint.io"] = 972,
    ["webjobpublishsettings.json"] = 850,
    ["webjobs-list.json"] = 849,
    ["well-known-fursona"] = 1054,
    ["xs-app.json"] = 877,
    ["xunit.runner.json"] = 862,
    yamllint = 905,
    zuul = 888,
    ["Žinoma"] = 898
  },
  schemas = { {
      ...
      fileMatch = { "venvplus-basic.yaml", "*.venvplus-basic.yaml", "venvplus-basic.yml", "*.venvplus-basic.yml", "venvplus-basic.json", "*.venvplus-basic.json" },
