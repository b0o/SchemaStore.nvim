...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 212,
    [".cryproj (generic)"] = 690,
    [".cryproj engine-5.2"] = 685,
    [".cryproj engine-5.3"] = 686,
    [".cryproj engine-5.4"] = 687,
    [".cryproj engine-5.5"] = 688,
    [".cryproj engine-dev"] = 689,
    [".eslintrc"] = 269,
    [".esmrc.json"] = 260,
    [".ffizer.yaml"] = 273,
    [".htmlhintrc"] = 330,
    ...
    [".mtaext"] = 701,
    [".nodehawkrc"] = 443,
    [".npmpackagejsonlintrc"] = 447,
    [".omletrc"] = 876,
    [".phrase.yml"] = 494,
    [".phraseapp.yml"] = 495,
    [".pmbot.yml"] = 484,
    [".postcssrc"] = 489,
    [".powerpages-web-template-manifest"] = 491,
    [".pre-commit-config.yml"] = 492,
    [".pre-commit-hooks.yml"] = 493,
    [".putout.json"] = 514,
    [".rehyperc"] = 533,
    [".remarkrc"] = 535,
    [".sprite files"] = 593,
    ...
    ["<div>RIOTS' studio configuration"] = 668,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 398,
    ABCSupplyPlan = 13,
    AIConfig = 14,
    ["API Builder"] = 733,
    ["AVA Configuration"] = 793,
    ...
    ["Adobe UXP Manifest"] = 858,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 15,
    ["Airplane task"] = 16,
    ["Alacritty Configuration"] = 765,
    ["All Contributors configuration file"] = 823,
    ...
    ["Azure Pipelines"] = 69,
    ["Azure Static Web Apps CLI configuration file"] = 596,
    ["Azure Static Web Apps configuration file"] = 595,
    ["BX CI"] = 107,
    ["Bashly (bashly.yml)"] = 827,
    ["Bashly Settings (bashly-settings.yml)"] = 828,
    ["Better Code Hub"] = 737,
    ["Better Scripts"] = 108,
    Bigconfig = 86,
    BizTalkServerApplicationSchema = 707,
    Bleep = 109,
    ...
    ["Butane Config"] = 778,
    ["CGS Custom Card Game (CardGameDef.json)"] = 863,
    ["CICS TS region tagging"] = 787,
    ["CICS TS resource import"] = 788,
    ["CICS TS resource model"] = 789,
    ["CICS TS resource overrides"] = 790,
    ["CMake Presets"] = 110,
    ["CNC Codes"] = 123,
    ...
    CityJSON = 120,
    ["Clawject config"] = 128,
    ["Cloud Foundry Application Manifest"] = 875,
    ["Code Climate"] = 157,
    CodeCV = 65,
    CodeRabbit = 64,
    ...
    ["Configu .cfgu files"] = 880,
    ["Configu .configu file"] = 881,
    Conjure = 122,
    ["Container Structure Test"] = 720,
    Containerlab = 745,
    ["Crowdsec collection config"] = 208,
    ["Crowdsec parser config"] = 209,
    ["Crowdsec scenario config"] = 210,
    ["CumulusCI Config"] = 127,
    ["Custom Machinery Machine"] = 864,
    ["Custom Machinery Recipe"] = 865,
    ["Cycle Stack File"] = 130,
    ["DWP Exchange - catalogue entry"] = 255,
    ["DWP Exchange - gateway"] = 253,
    ["DWP Exchange - meta"] = 254,
    ...
    ["DataYoga Job"] = 132,
    ["Databricks Asset Bundles"] = 844,
    ["Datadog Service Definition"] = 374,
    ["Datahub Ingestion Recipe"] = 794,
    ["Dein Config"] = 134,
    ...
    Devfile = 252,
    ["Discord Webhook"] = 231,
    ["DocFx Config (docfx.json)"] = 234,
    ["Dolittle Artifacts"] = 235,
    ["Dolittle Bounded Context Configuration"] = 236,
    ["Dolittle Event Horizons Configuration"] = 237,
    ["Dolittle Resources Configuration"] = 238,
    ["Dolittle Server Configuration"] = 239,
    ["Dolittle Tenant Map Configuration"] = 241,
    ["Dolittle Tenants Configuration"] = 240,
    ["Dolittle Topology"] = 242,
    ...
    ["Drupal Routing"] = 150,
    ["Drupal Services"] = 152,
    ["Drush site aliases"] = 248,
    ["Dynamic Bash Aliases (.aliases)"] = 835,
    ["EAS config"] = 267,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 824,
    ["Elgato Stream Deck"] = 258,
    ["Embrace Config"] = 805,
    Endurica = 848,
    ["Enterprise Contract Policy Spec"] = 259,
    ["Erda Pipeline"] = 871,
    ["Erda Runtime"] = 872,
    ["Error pages"] = 263,
    Esquio = 261,
    ["Estuary Flow Catalog"] = 784,
    ["Expo SDK"] = 266,
    ["F-Droid Data metadata"] = 272,
    ["Facets - FSDL - Application"] = 270,
    ["FasterCI Configuration"] = 70,
    FiQuS = 276,
    Firebase = 274,
    ["Flow.json Configurations"] = 868,
    ["Fossa configuration file"] = 283,
    ["Fossa's fossa-deps file"] = 284,
    ["Foundry VTT - Base package Manifest"] = 278,
    ["Foundry VTT - Module Manifest"] = 279,
    ["Foundry VTT - System Data Template"] = 282,
    ["Foundry VTT - System Manifest"] = 280,
    ["Foundry VTT - World Manifest"] = 281,
    ["Foxx Manifest"] = 71,
    ["Freifunk.de Community API"] = 74,
    ["Frogbot Config"] = 75,
    ["G2P Mapping Configuration"] = 288,
    ["GCP Blueprint Metadata"] = 291,
    Gaspar = 289,
    ["GatewayCore API Gateway"] = 290,
    ["GeoJSON.json latest"] = 782,
    GherKing = 786,
    ["GitHub Action"] = 296,
    ["GitHub Discussion"] = 297,
    ["GitHub Funding"] = 298,
    ["GitHub Issue Template configuration"] = 300,
    ["GitHub Issue Template forms"] = 299,
    ["GitHub Workflow"] = 301,
    ["GitHub Workflow Template Properties"] = 302,
    ["GitHub automatically generated release notes configuration"] = 303,
    ["GitLab Agent for Kubernetes configuration"] = 860,
    GitVersion = 293,
    ["Gitea Issue Template configuration"] = 294,
    ["Gitea Issue Template forms"] = 295,
    ["Gitpod Configuration"] = 305,
    ["GlazeWM settings"] = 862,
    ["Global Privacy Control"] = 292,
    Goblet = 843,
    ["Golangci-lint Configuration"] = 307,
    ["Golangci-lint Custom Plugins Configuration"] = 308,
    ["Google Chrome Related Website Sets"] = 275,
    ["Google Cloud Workflows"] = 186,
    Goreleaser = 310,
    ["Goreleaser Pro"] = 311,
    Goss = 312,
    ["Gradle Build Cache Node"] = 735,
    ["Gradle Enterprise"] = 734,
    ["Grafana 5.x Dashboard"] = 313,
    ["GraphQL Code Generator"] = 317,
    ["GraphQL Config"] = 316,
    ["GraphQL Mesh"] = 315,
    ["Grunt JSHint task"] = 321,
    ["Grunt Watch task"] = 322,
    ["Grunt base task"] = 323,
    ["Grunt clean task"] = 319,
    ["Grunt copy task"] = 318,
    ["Grunt cssmin task"] = 320,
    HEMTT = 704,
    Hadolint = 716,
    Hammerkit = 744,
    ["Hardware Sentry Configuration"] = 798,
    Hatch = 717,
    Hayson = 325,
    ["Haystack Pipeline"] = 326,
    ["Hazelcast 5 Configuration"] = 327,
    ["Helm Chart.lock"] = 154,
    ["Helm Chart.yaml"] = 153,
    ["Helm Unittest Test Suite"] = 155,
    Hugo = 774,
    ["Hugo Theme"] = 773,
    ["Hyperfoil benchmark configuration"] = 333,
    ["IBM Zapp document"] = 334,
    ["IBM zCodeFormatSettings"] = 335,
    ["IMG Catapult PSP"] = 340,
    ["IVMS101 by CODE Protocol"] = 861,
    Infrahub = 342,
    Istanbul = 801,
    ["JDownloader2 crawler multi-rules"] = 351,
    ["JDownloader2 crawler single-rules"] = 350,
    ["JFrog Applications Config"] = 352,
    ["JFrog File Spec"] = 353,
    ["JFrog Pipelines YML DSL"] = 807,
    ["JMeter DSL cli config"] = 354,
    JReleaser = 356,
    ["JSON Document Transform"] = 364,
    ["JSON Feed"] = 365,
    ["JSON Resume"] = 540,
    ["JSON Schema Draft 2020-12"] = 681,
    ["JSON Schema Draft 4"] = 678,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 845,
    ["JSON Schema Draft 7"] = 679,
    ["JSON Schema Draft 7 (unofficial strict)"] = 846,
    ["JSON Schema Draft 8 (2019-09)"] = 680,
    ["JSON-API"] = 363,
    ["JSON-WF"] = 874,
    ["JSON-e templates"] = 742,
    ["JSON-stat 2.0"] = 675,
    JSONPatch = 367,
    ["JSR Package Config (jsr.json)"] = 357,
    Jasmine = 346,
    Jekyll = 347,
    ["Jenkins X Pipelines"] = 348,
    ["Jenkins X Requirements"] = 349,
    ["Jovo Language Models"] = 355,
    ["KIMMDY config file"] = 372,
    ["KSP-AVC"] = 676,
    ["KSP-CKAN"] = 677,
    KSY = 873,
    ["Karakum configuration file"] = 285,
    Kas = 370,
    ["Keycloak REST API"] = 815,
    ["Knative Functions - func.yaml"] = 286,
    ["KoDE/CI build.yaml"] = 803,
    ["Kong DBLess config"] = 804,
    KrakenD = 373,
    ["Kubri Configuration"] = 378,
    LOOBin = 393,
    ...
    Lefthook = 382,
    ["Liferay client-extension.yaml"] = 389,
    ["LinkML Metamodel"] = 391,
    Liquibase = 750,
    ["Liquibase Flow File"] = 751,
    ["Lively Properties"] = 392,
    ["Lobe AI Agent"] = 67,
    Loki = 68,
    ["MLOS Configs"] = 427,
    ["MS2Rescore Configuration"] = 430,
    ["Madness (madness.yml)"] = 826,
    Markdownlint = 754,
    ["Mason Registry"] = 756,
    ["MegaLinter configuration"] = 399,
    ["MegaLinter descriptor"] = 400,
    Melange = 852,
    ["Meltano plugin discovery definition"] = 402,
    ["Meltano project definition"] = 401,
    ["Mergify Configuration"] = 431,
    ["MetricsHub Configuration"] = 403,
    ["MetricsHub Connector Configuration"] = 404,
    ["Micro Editor Syntax"] = 836,
    ["Microsoft Band Web Tile"] = 405,
    ["Minecraft Custom Main Menu Mod"] = 853,
    ["Minecraft Data Pack Advancement"] = 407,
    ["Minecraft Data Pack Biome"] = 408,
    ["Minecraft Data Pack Configured Carver"] = 409,
    ["Minecraft Data Pack Damage Type"] = 410,
    ["Minecraft Data Pack Dimension"] = 412,
    ["Minecraft Data Pack Dimension Type"] = 411,
    ["Minecraft Data Pack Item Modifier"] = 413,
    ["Minecraft Data Pack Loot Table"] = 414,
    ["Minecraft Data Pack Metadata"] = 415,
    ["Minecraft Data Pack Predicate"] = 416,
    ["Minecraft Data Pack Recipe"] = 417,
    ["Minecraft Data Pack Tag"] = 418,
    ["Minecraft Data Pack Template Pool"] = 419,
    ["Minecraft Data Pack Trim Material"] = 424,
    ["Minecraft Data Pack Trim Pattern"] = 425,
    ["Minecraft Resource Pack Lang"] = 420,
    ["Minecraft Resource Pack Particle"] = 421,
    ["Minecraft Resource Pack Texture Mcmeta"] = 423,
    ["Minecraft Resourcepack Sounds"] = 422,
    ["Monade CLI Stack Configuration"] = 434,
    ["MongoDB Atlas Search Index Definition"] = 802,
    ["Monika Configuration"] = 800,
    ["Monoweave Configuration"] = 429,
    ["Motif config"] = 700,
    ["NOX Framework (Service)"] = 446,
    ["Netin Diagnostic System Template"] = 760,
    ["Netlify config"] = 437,
    ["Network-as-Code Data Model"] = 438,
    ["Nightwatch.js"] = 439,
    ["Nuitka.yaml"] = 866,
    ["ONe's changelog entry"] = 462,
    ["ONe's service descriptor"] = 461,
    ["OSS Review Toolkit configuration"] = 470,
    ["OSS Review Toolkit curation"] = 471,
    ["OSS Review Toolkit package configuration"] = 472,
    ["OSS Review Toolkit repository configuration"] = 473,
    ["OSS Review Toolkit resolutions"] = 474,
    Opctl = 703,
    ["Open Data Contract Standard (ODCS))"] = 465,
    ["OpenRewrite Resource"] = 464,
    ["OpenUtau character yaml"] = 458,
    ["OpenUtau ustx"] = 459,
    ["OpenWeather Current Weather API"] = 741,
    ["OpenWeather Road Risk API"] = 740,
    ["Ory Hydra configuration"] = 332,
    ["Ory Keto configuration"] = 375,
    ["Ory Kratos configuration"] = 469,
    ["Ory Oathkeeper configuration"] = 453,
    ["Outblocks App configuration"] = 467,
    ["Outblocks database table"] = 468,
    ["Outblocks project configuration"] = 466,
    PDM = 480,
    Packer = 477,
    Pantsbuild = 822,
    ["Paper paper-plugin.yml"] = 478,
    ["Pipeline component"] = 752,
    ["PocketMine plugin.yml"] = 485,
    ["Postman collection"] = 490,
    ["Problem object RFC9457"] = 850,
    ["Problem package generators"] = 498,
    Pterodactyl = 797,
    ["Pull Request Labeler"] = 513,
    Pulumi = 519,
    PyProject = 520,
    Pyright = 521,
    Qgoda = 522,
    Qodana = 770,
    ["Qt Creator workspace file"] = 882,
    ["Quali Torque Blueprint Spec 2"] = 795,
    ["QueryFirst config file"] = 818,
    ["RKE Cluster Configuration JSON"] = 749,
    ["RKE Cluster Configuration YAML"] = 748,
    ["Rancher Fleet"] = 516,
    ["Rattler-build"] = 523,
    Ray = 715,
    ["Read the Docs"] = 518,
    ["Red-DiscordBot Cog"] = 530,
    ["Red-DiscordBot Cog Repo"] = 531,
    ["Red-DiscordBot Trivia"] = 532,
    ["Render Blueprints"] = 747,
    RenderCV = 542,
    Renovate = 541,
    ["Replit config"] = 536,
    RoadRunner = 543,
    ["Rudder techniques"] = 856,
    Ruff = 538,
    ["Rust Project"] = 539,
    ["Rust toolchain"] = 546,
    ["SDMX data message"] = 571,
    ["SDMX metadata message"] = 570,
    ["SDMX structure message"] = 569,
    ["SIL Kit Participant Configuration"] = 581,
    ["SIL Kit Registry Configuration"] = 582,
    SWADL = 607,
    ["Safebox Config"] = 808,
    ["Sapphire CLI Config"] = 549,
    ["SauceCTL Configuration"] = 757,
    ["Schema Catalog"] = 563,
    ["Scoop manifest"] = 568,
    ["Semantic Data Fabric (SDF) file"] = 572,
    ["Semgrep Rule"] = 574,
    ["Serenity Code Generator (Sergen)"] = 575,
    ["Serverless Framework Configuration"] = 764,
    ["Serverless Workflow"] = 766,
    ["Settings.paf"] = 577,
    ["Shopware 6 Configuration"] = 767,
    ["Shopware CLI Extension Store Configuration"] = 768,
    ["Shopware CLI Project Store Configuration"] = 769,
    Sigma = 579,
    ["Sigrid scope configuration file"] = 580,
    ["SkyPilot Task JSON"] = 857,
    ["Slack app manifest"] = 584,
    Solidarity = 587,
    ["Solution filters"] = 588,
    ["Source Maps v3"] = 589,
    Sourcery = 590,
    SpecIF = 591,
    ["Sponge Mixin configuration"] = 592,
    StackBlitz = 597,
    ["StackHawk Scanner Configuration"] = 763,
    Stale = 598,
    ["Starlake Data Pipeline"] = 738,
    Starship = 599,
    ["Statamic Blueprint"] = 600,
    ["Stella configuration file"] = 601,
    ["StrmPrivacy Data Connector"] = 812,
    ["StrmPrivacy Data Contract"] = 813,
    ["StrmPrivacy SimpleSchema"] = 810,
    ["StrmPrivacy Stream"] = 811,
    ["StrmPrivacy batch job configuration file"] = 809,
    ["Stryker Mutator"] = 604,
    ["StyleCop Analyzers Configuration"] = 605,
    ["Stylelint (.stylelintrc)"] = 606,
    ["Sublime Syntax"] = 814,
    ["Subsquid squid manifest"] = 859,
    ["Swagger API 2.0"] = 608,
    TSON = 634,
    TSTyche = 635,
    Talhelper = 610,
    ["Talisman configuration"] = 611,
    ["Taskfile config"] = 743,
    Taurus = 612,
    ["TestEnvironment.json"] = 621,
    ["TextMate Grammar"] = 620,
    ["Tier.run pricing.json"] = 615,
    Tikibase = 616,
    ["Traefik v2"] = 624,
    ["Traefik v2 File Provider"] = 625,
    ["Travis CI (.travis.yml)"] = 623,
    TunnelHub = 849,
    Turborepo = 622,
    Tye = 771,
    ["UET BuildConfig.json"] = 819,
    ["UI5 Manifest"] = 644,
    ["UNCORS configuration"] = 648,
    ["UTAM Page Object"] = 647,
    ["Ubuntu Server Autoinstall"] = 642,
    ["Uniswap Token List"] = 726,
    ["Unreal Engine Uplugin"] = 820,
    ["Unreal Engine Uproject"] = 821,
    ["Updatecli Compose"] = 779,
    ["Updatecli Policy Manifest"] = 780,
    ["Updatecli Policy Metadata"] = 781,
    Uplift = 817,
    ["User Journey Map"] = 746,
    V2Ray = 785,
    ["VSCode Code Snippets"] = 174,
    ["VSIX CLI publishing"] = 663,
    ["Vela Pipeline Configuration"] = 652,
    Vercel = 173,
    Visivo = 847,
    ["Web App Manifest"] = 670,
    ["Web types"] = 673,
    WebExtensions = 669,
    ["Webman package recipe"] = 791,
    ["Windows Package Manager Installer Manifest"] = 723,
    ["Windows Package Manager Locale Manifest"] = 724,
    ["Windows Package Manager Singleton Manifest"] = 722,
    ["Woodpecker pipeline config"] = 759,
    ["Wrangler CLI"] = 674,
    ["Xstate Machine"] = 777,
    ["Yarn Config (.yarnrc.yml)"] = 736,
    ["Yippee-Ki-JSON configuration YML"] = 728,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 851,
    ...
    ["behat.yml"] = 93,
    ["bigquery-table"] = 85,
    ["bioimageio resource description"] = 867,
    ...
    ["devspace.yaml"] = 799,
    djlint = 731,
    ["docker sequencer"] = 233,
    ["docker-compose.yml"] = 729,
    ["dockerd.json"] = 232,
    ["dotnet Release Index manifest"] = 243,
    ["dotnet-tools.json"] = 244,
    ["dotnetcli.host.json"] = 245,
    ["dprint.json"] = 246,
    ["drone.json"] = 247,
    ["dss-2.0.0.json"] = 249,
    ["dstack configuration"] = 250,
    ["dvc.yaml"] = 251,
    ["ecosystem.json"] = 256,
    eksctl = 257,
    ["electron-builder configuration file"] = 264,
    ["epr-manifest.json"] = 262,
    ["evcc.yaml"] = 265,
    ["ezd task runner"] = 268,
    ["fabric.mod.json"] = 271,
    ["first-timers-bot"] = 277,
    ...
    ["gitlab-ci"] = 304,
    ["global.json"] = 306,
    ["go-feature-flag Flag Configuration"] = 309,
    ["haxelib.json"] = 324,
    helmfile = 718,
    helmwave = 719,
    ["host-meta.json"] = 329,
    ...
    ["ide.host.json"] = 336,
    ["ifstate.conf"] = 337,
    ["imageoptimizer.json"] = 338,
    ["importmap.json"] = 341,
    ["ioBroker Configuration"] = 343,
    ["ioBroker JSON UI"] = 344,
    ["ioBroker Package manifest"] = 345,
    ["ize.toml"] = 816,
    ["jsconfig.json"] = 368,
    ["jscpd Configuration"] = 796,
    jsdoc = 714,
    ["k3d.yaml"] = 369,
    ["k9s plugin.yml"] = 371,
    ["kontinuous-config.yaml"] = 377,
    ["kontinuous-values.yaml"] = 376,
    ["kustomization.yaml"] = 379,
    ["label-commenter-config.yml"] = 380,
    ["latexindent configuration"] = 66,
    ["launchsettings.json"] = 381,
    lazydocker = 838,
    lazygit = 837,
    ["lego.json"] = 383,
    ["lerna.json"] = 384,
    ["lgtm.yml"] = 385,
    ["liblab.config.json"] = 386,
    ["libman.json"] = 387,
    ["license-report-config.json"] = 388,
    ["linkinator.config.json"] = 390,
    ["lint-staged (.lintstagedrc)"] = 694,
    ["local.settings.json"] = 395,
    ["localazy.json"] = 396,
    ["lotus.yaml"] = 394,
    ["lsdlschema.json"] = 397,
    ["markdown-link-check"] = 755,
    mboats = 762,
    ["micro-settings.json"] = 831,
    ["mimetypes.json"] = 406,
    ["mirrord config"] = 695,
    mise = 696,
    ["mise-settings"] = 697,
    ["mkdocs.yml"] = 426,
    ["monospace.yml"] = 428,
    ["mprocs Configuration file"] = 883,
    ["mta.yaml"] = 698,
    ["mtad.yaml"] = 699,
    ["mycode.json"] = 435,
    ["napari plugin manifest"] = 436,
    neoload = 709,
    ["nest-cli"] = 441,
    ["ninjs (News in JSON)"] = 440,
    ["nixd configuration"] = 855,
    ["nlu.json"] = 442,
    ["nodemon.json"] = 444,
    ["noodl config"] = 761,
    ["notebook.mod.json"] = 445,
    now = 705,
    ["npm-badges"] = 448,
    ["nswag.json"] = 451,
    ntangle = 452,
    ["nuclei-template.yaml"] = 449,
    ["nuget-project.json"] = 450,
    ["ocelot.json"] = 454,
    ["omnisharp.json"] = 455,
    ["openapi.json"] = 456,
    ["openfin.json"] = 463,
    ...
    ["ops.yaml"] = 460,
    ["package.json"] = 475,
    ["package.manifest"] = 476,
    ["partial-black.json"] = 94,
    ["pathfinder.yml"] = 479,
    ["pattern.json"] = 482,
    ["petstore-v1.0"] = 806,
    pgap_yaml_input_reader = 481,
    ["pixi.toml"] = 483,
    ["plagiarize-me.yaml"] = 487,
    ["plagiarize.yaml"] = 486,
    ["portman.json"] = 488,
    ["prettierrc.json"] = 496,
    ["prisma.yml"] = 497,
    ["project-1.0.0-beta3.json"] = 500,
    ["project-1.0.0-beta4.json"] = 501,
    ["project-1.0.0-beta5.json"] = 502,
    ["project-1.0.0-beta6.json"] = 503,
    ["project-1.0.0-beta8.json"] = 504,
    ["project-1.0.0-rc1.json"] = 505,
    ["project-1.0.0-rc2.json"] = 506,
    ["project.json"] = 499,
    ["prometheus.json"] = 507,
    ["prometheus.rules.json"] = 508,
    ["prometheus.rules.test.json"] = 509,
    ["proxies.json"] = 510,
    ["publiccode.yml"] = 511,
    ["pubspec.yaml"] = 512,
    ["pyrseas-0.8.json"] = 515,
    ["quilt.mod.json"] = 832,
    ["rc3 auth"] = 524,
    ["rc3 collection"] = 525,
    ["rc3 environment"] = 526,
    ...
    ["rc3 settings"] = 529,
    ["release drafter"] = 710,
    ["release-plz.toml"] = 534,
    ["rivet.yaml"] = 854,
    rockcraft = 544,
    rustfmt = 545,
    samt = 547,
    samtrc = 548,
    ["sarif-1.0.0.json"] = 550,
    ["sarif-2.0.0.json"] = 551,
    ["sarif-2.1.0"] = 561,
    ["sarif-2.1.0-rtm.2"] = 552,
    ["sarif-2.1.0-rtm.3"] = 554,
    ["sarif-2.1.0-rtm.4"] = 556,
    ["sarif-2.1.0-rtm.5"] = 558,
    ["sarif-2.1.0-rtm.6"] = 559,
    ["sarif-external-property-file-2.1.0"] = 562,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 553,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 555,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 557,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 560,
    ["schema.org - Action"] = 564,
    ["schema.org - ContactPoint"] = 565,
    ["schema.org - Place"] = 566,
    ["schema.org - Thing"] = 567,
    ["secrethub.yml"] = 834,
    ["semantic-release"] = 573,
    ["servicehub.config.json"] = 684,
    ["servicehub.service.json"] = 683,
    ["settings.job"] = 576,
    ["sfdx-hardis configuration"] = 578,
    ["shard.yml"] = 870,
    ["size-limit configuration"] = 583,
    ["skaffold.yaml"] = 753,
    ["skyuxconfig.json"] = 585,
    snapcraft = 586,
    ["sqlc configuration"] = 594,
    ["stripe-app-local.json"] = 603,
    ["stripe-app.json"] = 602,
    swcrc = 739,
    ["task.json"] = 609,
    taskcat = 706,
    ["template.json"] = 613,
    ["templatsources.json"] = 614,
    ["theme.json"] = 617,
    ["tizen_workspace.json"] = 618,
    tldr = 619,
    tmuxinator = 692,
    ["transcend.yml"] = 626,
    ["tree-sitter grammar.json"] = 314,
    ["trime.yaml"] = 627,
    ["trunk.yaml"] = 628,
    ["ts-force-config.json"] = 632,
    ["tsconfig.json"] = 629,
    ["tsd.json"] = 630,
    ["tsdrc.json"] = 631,
    ["tslint.json"] = 633,
    ...
    ["vega-lite.json"] = 651,
    ["vega.json"] = 650,
    ["venvironment-basic.yaml"] = 654,
    ["venvironment.yaml"] = 653,
    ["version.json"] = 655,
    ["vim-addon-info"] = 657,
    ["vs-2017.3.host.json"] = 659,
    ["vs-nesting.json"] = 660,
    ["vsls.json"] = 658,
    ["vss-extension.json"] = 664,
    ["vtesttree.yaml"] = 665,
    ["vtestunit.yaml"] = 666,
    ["warp-keysets.json"] = 840,
    ["warp-themes.json"] = 841,
    ["warp-workflows.json"] = 842,
    ["webhint.io"] = 792,
    ["webjobpublishsettings.json"] = 672,
    ["webjobs-list.json"] = 671,
    ["well-known-fursona"] = 878,
    ["xs-app.json"] = 702,
    ["xunit.runner.json"] = 682,
    yamllint = 727,
    zuul = 711,
    ["Žinoma"] = 721
  },
