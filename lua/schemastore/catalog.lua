...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 178,
    [".cryproj (generic)"] = 610,
    [".cryproj engine-5.2"] = 605,
    [".cryproj engine-5.3"] = 606,
    [".cryproj engine-5.4"] = 607,
    [".cryproj engine-5.5"] = 608,
    [".cryproj engine-dev"] = 609,
    [".csscomb.json"] = 180,
    [".csslintrc"] = 181,
    [".es6importsorterrc.json"] = 741,
    [".eslintrc"] = 230,
    [".esmrc.json"] = 222,
    [".ffizer.yaml"] = 234,
    [".htmlhintrc"] = 286,
    ...
    [".mtaext"] = 619,
    [".nodehawkrc"] = 386,
    [".npmpackagejsonlintrc"] = 389,
    [".phraseapp.yml"] = 433,
    [".pmbot.yml"] = 422,
    [".postcssrc"] = 428,
    [".powerpages-web-template-manifest"] = 430,
    [".pre-commit-config.yml"] = 431,
    [".pre-commit-hooks.yml"] = 432,
    [".putout.json"] = 452,
    [".rehyperc"] = 464,
    [".remarkrc"] = 465,
    [".sprite files"] = 520,
    ...
    ["<div>RIOTS' studio configuration"] = 589,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 346,
    ["API Builder"] = 651,
    ["AVA Configuration"] = 710,
    ["AWS CDK cdk.json"] = 162,
    ["AWS CloudFormation"] = 163,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 164,
    ["AWS SAM CLI Samconfig"] = 165,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 13,
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 683,
    ["All Contributors configuration file"] = 740,
    ...
    ["Azure Pipelines"] = 59,
    ["Azure Static Web Apps CLI configuration file"] = 523,
    ["Azure Static Web Apps configuration file"] = 522,
    ["BX CI"] = 95,
    ["Better Code Hub"] = 655,
    ["Better Scripts"] = 96,
    Bigconfig = 76,
    BizTalkServerApplicationSchema = 625,
    Bleep = 97,
    ...
    ["Butane Config"] = 695,
    ["CICS TS region tagging"] = 704,
    ["CICS TS resource import"] = 705,
    ["CICS TS resource model"] = 706,
    ["CICS TS resource overrides"] = 707,
    ["CMake Presets"] = 98,
    ["CNC Codes"] = 108,
    ...
    Cheatsheets = 692,
    ["Chrome Extension"] = 155,
    ["CircleCI config.yml"] = 132,
    ["Citation File Format"] = 167,
    CityJSON = 106,
    ["Code Climate"] = 133,
    CodeCV = 57,
    ["CodeShip Pro services configuration files"] = 144,
    ["CodeShip Pro steps configuration files"] = 145,
    ["Codecov configuration files"] = 143,
    Codux = 141,
    ["Cog config file"] = 109,
    ["Commandbox Box.json"] = 110,
    ["Commandbox Server.json"] = 111,
    ["Common Catalog Data"] = 153,
    ["Common types for all schemas"] = 1,
    Conjure = 107,
    ["Container Structure Test"] = 638,
    Containerlab = 663,
    ["Crowdsec collection config"] = 174,
    ["Crowdsec parser config"] = 175,
    ["Crowdsec scenario config"] = 176,
    ["DWP Exchange - catalogue entry"] = 219,
    ["DWP Exchange - gateway"] = 217,
    ["DWP Exchange - meta"] = 218,
    ["Dart build configuration"] = 182,
    ["Dart test config"] = 183,
    ["DashLord configuration"] = 184,
    ["Data Contract Specification"] = 185,
    ["Databricks Asset Bundles"] = 761,
    ["Datadog Service Definition"] = 325,
    ["Datahub Ingestion Recipe"] = 711,
    ["Dein Config"] = 113,
    Deno = 191,
    ["Deployer Recipe"] = 194,
    ["Deta Spacefile"] = 114,
    ...
    Devfile = 216,
    ["Discord Webhook"] = 196,
    ["Dolittle Artifacts"] = 200,
    ["Dolittle Bounded Context Configuration"] = 201,
    ["Dolittle Event Horizons Configuration"] = 202,
    ["Dolittle Resources Configuration"] = 203,
    ["Dolittle Server Configuration"] = 204,
    ["Dolittle Tenant Map Configuration"] = 206,
    ["Dolittle Tenants Configuration"] = 205,
    ["Dolittle Topology"] = 207,
    ["Drupal Breakpoints"] = 116,
    ["Drupal Config"] = 127,
    ["Drupal Info"] = 117,
    ["Drupal Layouts"] = 118,
    ["Drupal Libraries"] = 119,
    ["Drupal Links Action"] = 120,
    ["Drupal Links Contextual"] = 121,
    ["Drupal Links Menu"] = 122,
    ["Drupal Links Task"] = 123,
    ["Drupal Migration"] = 124,
    ["Drupal Permissions"] = 125,
    ["Drupal Routing"] = 126,
    ["Drupal Services"] = 128,
    ["Drush site aliases"] = 212,
    ["Embrace Config"] = 722,
    Endurica = 764,
    ["Error pages"] = 225,
    Esquio = 223,
    ["Estuary Flow Catalog"] = 701,
    ["Expo SDK"] = 228,
    ["F-Droid Data metadata"] = 233,
    ["Facets - FSDL - Application"] = 231,
    ["FasterCI Configuration"] = 60,
    Firebase = 235,
    ["Fossa configuration file"] = 243,
    ["Fossa's fossa-deps file"] = 244,
    ["Foundry VTT - Base package Manifest"] = 238,
    ["Foundry VTT - Module Manifest"] = 239,
    ["Foundry VTT - System Data Template"] = 242,
    ["Foundry VTT - System Manifest"] = 240,
    ["Foundry VTT - World Manifest"] = 241,
    ["Foxx Manifest"] = 61,
    ["Freifunk.de Community API"] = 64,
    ["Frogbot Config"] = 65,
    ["G2P Mapping Configuration"] = 248,
    ["GCP Blueprint Metadata"] = 251,
    Gaspar = 249,
    ["GatewayCore API Gateway"] = 250,
    ["GeoJSON.json latest"] = 699,
    GherKing = 703,
    ["GitHub Action"] = 255,
    ["GitHub Discussion"] = 256,
    ["GitHub Funding"] = 257,
    ["GitHub Issue Template configuration"] = 259,
    ["GitHub Workflow"] = 260,
    ["GitHub Workflow Template Properties"] = 261,
    ["GitHub issue forms"] = 258,
    GitVersion = 254,
    ["Gitpod Configuration"] = 263,
    ["Global Privacy Control"] = 252,
    Goblet = 760,
    ["Google Chrome Related Website Sets"] = 236,
    ["Google Cloud Workflows"] = 161,
    Goreleaser = 267,
    ["Goreleaser Pro"] = 268,
    Goss = 269,
    ["Gradle Build Cache Node"] = 653,
    ["Gradle Enterprise"] = 652,
    ["Grafana 5.x Dashboard"] = 270,
    ["GraphQL Code Generator"] = 273,
    ["GraphQL Config"] = 272,
    ["GraphQL Mesh"] = 271,
    ["Grunt JSHint task"] = 277,
    ["Grunt Watch task"] = 278,
    ["Grunt base task"] = 279,
    ["Grunt clean task"] = 275,
    ["Grunt copy task"] = 274,
    ["Grunt cssmin task"] = 276,
    HEMTT = 622,
    Hadolint = 634,
    Hammerkit = 662,
    ["Hardware Sentry Configuration"] = 715,
    Hatch = 635,
    Hayson = 281,
    ["Haystack Pipeline"] = 282,
    ["Hazelcast 5 Configuration"] = 283,
    ["Helm Chart.lock"] = 130,
    ["Helm Chart.yaml"] = 129,
    ["Helm Unittest Test Suite"] = 131,
    Hugo = 691,
    ["IBM Zapp document"] = 288,
    ["IBM zCodeFormatSettings"] = 289,
    ["IMG Catapult PSP"] = 294,
    Istanbul = 718,
    ["JDownloader2 crawler multi-rules"] = 304,
    ["JDownloader2 crawler single-rules"] = 303,
    ["JFrog Applications Config"] = 305,
    ["JFrog File Spec"] = 306,
    ["JFrog Pipelines YML DSL"] = 724,
    ["JMeter DSL cli config"] = 307,
    JReleaser = 309,
    ["JSON Document Transform"] = 316,
    ["JSON Feed"] = 317,
    ["JSON Resume"] = 471,
    ["JSON Schema Draft 2020-12"] = 601,
    ["JSON Schema Draft 4"] = 598,
    ["JSON Schema Draft 7"] = 599,
    ["JSON Schema Draft 7 (unofficial strict)"] = 762,
    ["JSON Schema Draft 8 (2019-09)"] = 600,
    ["JSON-API"] = 315,
    ["JSON-e templates"] = 660,
    ["JSON-stat 2.0"] = 595,
    JSONPatch = 319,
    Jasmine = 299,
    Jekyll = 300,
    ["Jenkins X Pipelines"] = 301,
    ["Jenkins X Requirements"] = 302,
    ["Jovo Language Models"] = 308,
    ["KSP-AVC"] = 596,
    ["KSP-CKAN"] = 597,
    ["Karakum configuration file"] = 245,
    Kas = 322,
    ["Keycloak REST API"] = 732,
    ["Knative Functions - func.yaml"] = 246,
    ["KoDE/CI build.yaml"] = 720,
    ["Kong DBLess config"] = 721,
    KrakenD = 324,
    LOOBin = 341,
    Lefthook = 332,
    ["LinkML Metamodel"] = 339,
    Liquibase = 667,
    ["Liquibase Flow File"] = 668,
    ["Lively Properties"] = 340,
    ["Lobe AI Agent"] = 58,
    ["MS2Rescore Configuration"] = 374,
    Markdownlint = 671,
    ["Mason Registry"] = 673,
    ["MegaLinter configuration"] = 347,
    ["MegaLinter descriptor"] = 348,
    ["Meltano plugin discovery definition"] = 350,
    ["Meltano project definition"] = 349,
    ["Microsoft Band Web Tile"] = 351,
    ["Minecraft Data Pack Advancement"] = 353,
    ["Minecraft Data Pack Biome"] = 354,
    ["Minecraft Data Pack Configured Carver"] = 355,
    ["Minecraft Data Pack Damage Type"] = 356,
    ["Minecraft Data Pack Dimension"] = 358,
    ["Minecraft Data Pack Dimension Type"] = 357,
    ["Minecraft Data Pack Item Modifier"] = 359,
    ["Minecraft Data Pack Loot Table"] = 360,
    ["Minecraft Data Pack Metadata"] = 361,
    ["Minecraft Data Pack Predicate"] = 362,
    ["Minecraft Data Pack Recipe"] = 363,
    ["Minecraft Data Pack Tag"] = 364,
    ["Minecraft Data Pack Template Pool"] = 365,
    ["Minecraft Data Pack Trim Material"] = 370,
    ["Minecraft Data Pack Trim Pattern"] = 371,
    ["Minecraft Resource Pack Lang"] = 366,
    ["Minecraft Resource Pack Particle"] = 367,
    ["Minecraft Resource Pack Texture Mcmeta"] = 369,
    ["Minecraft Resourcepack Sounds"] = 368,
    ["MkDocs Configuration 1.0"] = 372,
    ["MongoDB Atlas Search Index Definition"] = 719,
    ["Monika Configuration"] = 717,
    ["Motif config"] = 618,
    ["NOX Framework (Service)"] = 388,
    ["Netin Diagnostic System Template"] = 677,
    ["Netlify config"] = 379,
    ["Nexus-as-Code Data Model"] = 380,
    ["Nightwatch.js"] = 381,
    ["ONe's service descriptor"] = 403,
    ["OSS Review Toolkit configuration"] = 410,
    ["OSS Review Toolkit curation"] = 411,
    ["OSS Review Toolkit package configuration"] = 412,
    ["OSS Review Toolkit repository configuration"] = 413,
    ["OSS Review Toolkit resolutions"] = 414,
    Opctl = 621,
    ["OpenRewrite Resource"] = 405,
    ["OpenUtau character yaml"] = 400,
    ["OpenUtau ustx"] = 401,
    ["OpenWeather Current Weather API"] = 659,
    ["OpenWeather Road Risk API"] = 658,
    ["Ory Hydra configuration"] = 287,
    ["Ory Keto configuration"] = 326,
    ["Ory Kratos configuration"] = 409,
    ["Ory Oathkeeper configuration"] = 395,
    ["Outblocks App configuration"] = 407,
    ["Outblocks database table"] = 408,
    ["Outblocks project configuration"] = 406,
    Packer = 417,
    Pantsbuild = 739,
    ["Paper paper-plugin.yml"] = 418,
    ["Pipeline component"] = 669,
    ["PocketMine plugin.yml"] = 423,
    Poetry = 424,
    ["Postman collection"] = 429,
    ["Problem package generators"] = 436,
    Pterodactyl = 714,
    ["Pull Request Labeler"] = 451,
    Pulumi = 457,
    PyProject = 458,
    Pyright = 459,
    Qgoda = 460,
    Qodana = 688,
    ["Quali Torque Blueprint Spec 2"] = 712,
    ["QueryFirst config file"] = 735,
    ["RKE Cluster Configuration JSON"] = 666,
    ["RKE Cluster Configuration YAML"] = 665,
    ["Rancher Fleet"] = 454,
    Ray = 633,
    ["Read the Docs"] = 456,
    ["Red-DiscordBot Cog"] = 461,
    ["Red-DiscordBot Cog Repo"] = 462,
    ["Red-DiscordBot Trivia"] = 463,
    RenderCV = 473,
    Renovate = 472,
    ["Replit config"] = 466,
    RoadRunner = 474,
    ...
    ["Rust Project"] = 470,
    ["Rust toolchain"] = 476,
    ["SIL Kit Participant Configuration"] = 508,
    ["SIL Kit Registry Configuration"] = 509,
    SWADL = 533,
    ["Safebox Config"] = 725,
    ["Sapphire CLI Config"] = 479,
    ["SauceCTL Configuration"] = 674,
    ["Schema Catalog"] = 493,
    ["Scoop manifest"] = 498,
    ["Semantic Data Fabric (SDF) file"] = 499,
    ["Semgrep Rule"] = 501,
    ["Serenity Code Generator (Sergen)"] = 502,
    ["Serverless Framework Configuration"] = 682,
    ["Serverless Workflow"] = 684,
    ["Settings.paf"] = 504,
    Setuptools = 505,
    ["Shopware 6 Configuration"] = 685,
    ["Shopware CLI Extension Store Configuration"] = 686,
    ["Shopware CLI Project Store Configuration"] = 687,
    ["Sigrid scope configuration file"] = 507,
    ["Slack app manifest"] = 511,
    Solidarity = 514,
    ["Solution filters"] = 515,
    ["Source Maps v3"] = 516,
    Sourcery = 517,
    SpecIF = 518,
    ["Sponge Mixin configuration"] = 519,
    StackBlitz = 524,
    ["StackHawk Scanner Configuration"] = 681,
    Stale = 525,
    ["Starlake Data Pipeline"] = 656,
    Starship = 526,
    ["Statamic Blueprint"] = 527,
    ["StrmPrivacy Data Connector"] = 729,
    ["StrmPrivacy Data Contract"] = 730,
    ["StrmPrivacy SimpleSchema"] = 727,
    ["StrmPrivacy Stream"] = 728,
    ["StrmPrivacy batch job configuration file"] = 726,
    ["Stryker Mutator"] = 530,
    ["StyleCop Analyzers Configuration"] = 531,
    ["Sublime Syntax"] = 731,
    ["Swagger API 2.0"] = 534,
    TSON = 559,
    TSTyche = 560,
    Talhelper = 536,
    ["Talisman configuration"] = 537,
    ["Taskfile config"] = 661,
    Taurus = 538,
    ["TestEnvironment.json"] = 547,
    ["TextMate Grammar"] = 546,
    ["Tier.run pricing.json"] = 541,
    Tikibase = 542,
    ["Traefik v2"] = 550,
    ["Traefik v2 File Provider"] = 551,
    TunnelHub = 765,
    Turborepo = 548,
    Tye = 689,
    ["UET BuildConfig.json"] = 736,
    ["UI5 Manifest"] = 568,
    ["UTAM Page Object"] = 571,
    ["Ubuntu Server Autoinstall"] = 566,
    ["Uniswap Token List"] = 644,
    ["Unreal Engine Uplugin"] = 737,
    ["Unreal Engine Uproject"] = 738,
    ["Updatecli Compose"] = 696,
    ["Updatecli Policy Manifest"] = 697,
    ["Updatecli Policy Metadata"] = 698,
    Uplift = 734,
    ["User Journey Map"] = 664,
    V2Ray = 702,
    ["VSCode Code Snippets"] = 149,
    ["VSIX CLI publishing"] = 584,
    ["Vela Pipeline Configuration"] = 574,
    Vercel = 148,
    Visivo = 763,
    ["Web App Manifest"] = 591,
    ["Web types"] = 594,
    WebExtensions = 590,
    ["Webman package recipe"] = 708,
    ["Windows Package Manager Installer Manifest"] = 641,
    ["Windows Package Manager Locale Manifest"] = 642,
    ["Windows Package Manager Singleton Manifest"] = 640,
    ["Woodpecker pipeline config"] = 676,
    ["Xstate Machine"] = 694,
    ["Yippee-Ki-JSON configuration YML"] = 646,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 70,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 745,
    ["bashly-strings.yml"] = 746,
    ["bashly.yml"] = 744,
    ["batect.yml"] = 69,
    ...
    ["chisel-slices.json"] = 166,
    ["chrome-extension-locales-messages.json"] = 156,
    ["chutzpah.json"] = 157,
    cibuildwheel = 105,
    clangd = 136,
    clib = 137,
    ["cloud-init: cloud-config userdata"] = 139,
    ["cloud-sdk-pipeline-configuration"] = 159,
    ["cloudbuild.json"] = 160,
    cloudify = 138,
    codemagic = 140,
    ["coffeelint.json"] = 168,
    ["commands.json"] = 152,
    ["compile_commands.json"] = 151,
    ["compilerconfig.json"] = 150,
    ["completely.yml"] = 742,
    ["component-detection-manifest.json"] = 171,
    ["component.json"] = 170,
    ["composer.json"] = 169,
    ["config.yaml"] = 455,
    ["contentmanifest.json"] = 158,
    ["contribute.json"] = 172,
    ["cosmos.config.json"] = 154,
    ["crowdin.yml"] = 173,
    cspell = 179,
    ["custom-elements.json"] = 756,
    ["cypress.json"] = 177,
    ["datalogic-scan2deploy-android"] = 186,
    ["datalogic-scan2deploy-ce"] = 187,
    ["dbt Project"] = 112,
    ["ddev-global"] = 188,
    ["ddev-project"] = 189,
    ["debugsettings.json"] = 190,
    ["dependabot-v2.json"] = 193,
    ["dependabot.json"] = 192,
    ["deployed-cli"] = 693,
    ["detekt.yml"] = 195,
    ["devcontainer.json"] = 142,
    devinit = 648,
    ["devspace.yaml"] = 716,
    djlint = 649,
    ["docfx.json"] = 199,
    ["docker sequencer"] = 198,
    ["docker-compose.yml"] = 647,
    ["dockerd.json"] = 197,
    ["dotnet Release Index manifest"] = 208,
    ["dotnetcli.host.json"] = 209,
    ["dprint.json"] = 210,
    ["drone.json"] = 211,
    ["dss-2.0.0.json"] = 213,
    ["dstack configuration"] = 214,
    ["dvc.yaml"] = 215,
    ["ecosystem.json"] = 220,
    eksctl = 221,
    ["electron-builder configuration file"] = 226,
    ["epr-manifest.json"] = 224,
    ["evcc.yaml"] = 227,
    ["ezd task runner"] = 229,
    ["fabric.mod.json"] = 232,
    ["first-timers-bot"] = 237,
    ...
    ["gitlab-ci"] = 262,
    ["global.json"] = 264,
    ["go-feature-flag Flag Configuration"] = 266,
    ["golangci-lint Configuration"] = 265,
    ["haxelib.json"] = 280,
    helmfile = 636,
    helmwave = 637,
    ["host-meta.json"] = 285,
    ...
    ["ide.host.json"] = 290,
    ["ifstate.conf"] = 291,
    ["imageoptimizer.json"] = 292,
    ["importmap.json"] = 295,
    ["ioBroker Configuration"] = 296,
    ["ioBroker JSON UI"] = 297,
    ["ioBroker Package manifest"] = 298,
    ["ize.toml"] = 733,
    ["jsconfig.json"] = 320,
    ["jscpd Configuration"] = 713,
    jsdoc = 632,
    ["k3d.yaml"] = 321,
    ["k9s plugin.yml"] = 323,
    ["kontinuous-config.yaml"] = 328,
    ["kontinuous-values.yaml"] = 327,
    ["kustomization.yaml"] = 329,
    ["label-commenter-config.yml"] = 330,
    ["launchsettings.json"] = 331,
    lazydocker = 755,
    lazygit = 754,
    ["lego.json"] = 333,
    ["lerna.json"] = 334,
    ["lgtm.yml"] = 335,
    ["libman.json"] = 336,
    ["license-report-config.json"] = 337,
    ["linkinator.config.json"] = 338,
    ["local.settings.json"] = 343,
    ["localazy.json"] = 344,
    ["lotus.yaml"] = 342,
    ["lsdlschema.json"] = 345,
    ["madness.yml"] = 743,
    ["markdown-lint-check"] = 672,
    mboats = 679,
    ["micro-settings.json"] = 748,
    ["mimetypes.json"] = 352,
    ["mirrord config"] = 615,
    ["monospace.yml"] = 373,
    ["mta.yaml"] = 616,
    ["mtad.yaml"] = 617,
    ["mycode.json"] = 377,
    ["napari plugin manifest"] = 378,
    neoload = 627,
    ["nest-cli"] = 384,
    ["ninjs (News in JSON) 1.3"] = 383,
    ["ninjs (News in JSON) 2.0"] = 382,
    ["nlu.json"] = 385,
    ["nodemon.json"] = 387,
    ["noodl config"] = 678,
    now = 623,
    ...
    ["nswag.json"] = 393,
    ntangle = 394,
    ["nuclei-template.yaml"] = 391,
    ["nuget-project.json"] = 392,
    ["ocelot.json"] = 396,
    ["omnisharp.json"] = 397,
    ["openapi.json"] = 398,
    ["openfin.json"] = 404,
    ...
    ["ops.yaml"] = 402,
    ["package.json"] = 415,
    ["package.manifest"] = 416,
    ["pathfinder.yml"] = 419,
    ["pattern.json"] = 421,
    ["petstore-v1.0"] = 723,
    pgap_yaml_input_reader = 420,
    ["plagiarize-me.yaml"] = 426,
    ["plagiarize.yaml"] = 425,
    ["portman.json"] = 427,
    ["prettierrc.json"] = 434,
    ["prisma.yml"] = 435,
    ["project-1.0.0-beta3.json"] = 438,
    ["project-1.0.0-beta4.json"] = 439,
    ["project-1.0.0-beta5.json"] = 440,
    ["project-1.0.0-beta6.json"] = 441,
    ["project-1.0.0-beta8.json"] = 442,
    ["project-1.0.0-rc1.json"] = 443,
    ["project-1.0.0-rc2.json"] = 444,
    ["project.json"] = 437,
    ["prometheus.json"] = 445,
    ["prometheus.rules.json"] = 446,
    ["prometheus.rules.test.json"] = 447,
    ["proxies.json"] = 448,
    ["publiccode.yml"] = 449,
    ["pubspec.yaml"] = 450,
    ["pyrseas-0.8.json"] = 453,
    ["quilt.mod.json"] = 749,
    ["release drafter"] = 628,
    rtx = 468,
    rustfmt = 475,
    samt = 477,
    samtrc = 478,
    ["sarif-1.0.0.json"] = 480,
    ["sarif-2.0.0.json"] = 481,
    ["sarif-2.1.0"] = 491,
    ["sarif-2.1.0-rtm.2"] = 482,
    ["sarif-2.1.0-rtm.3"] = 484,
    ["sarif-2.1.0-rtm.4"] = 486,
    ["sarif-2.1.0-rtm.5"] = 488,
    ["sarif-2.1.0-rtm.6"] = 489,
    ["sarif-external-property-file-2.1.0"] = 492,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 483,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 485,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 487,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 490,
    ["schema.org - Action"] = 494,
    ["schema.org - ContactPoint"] = 495,
    ["schema.org - Place"] = 496,
    ["schema.org - Thing"] = 497,
    ["scikit-build"] = 680,
    ["secrethub.yml"] = 751,
    ["semantic-release"] = 500,
    ["servicehub.config.json"] = 604,
    ["servicehub.service.json"] = 603,
    ["settings.job"] = 503,
    ["sfdx-hardis configuration"] = 506,
    ["size-limit configuration"] = 510,
    ["skaffold.yaml"] = 670,
    ["skyuxconfig.json"] = 512,
    snapcraft = 513,
    ["sqlc configuration"] = 521,
    ["stripe-app-local.json"] = 529,
    ["stripe-app.json"] = 528,
    swcrc = 657,
    syntax = 753,
    ["task.json"] = 535,
    taskcat = 624,
    ["template.json"] = 539,
    ["templatsources.json"] = 540,
    ["theme.json"] = 543,
    ["tizen_workspace.json"] = 544,
    tldr = 545,
    tmuxinator = 612,
    ["transcend.yml"] = 552,
    ["trunk.yaml"] = 553,
    ["ts-force-config.json"] = 557,
    ["tsconfig.json"] = 554,
    ["tsd.json"] = 555,
    ["tsdrc.json"] = 556,
    ["tslint.json"] = 558,
    ...
    ["typingsrc.json"] = 565,
    ["typo3.json"] = 563,
    ["ui5-workspace.yaml"] = 570,
    ["ui5.yaml"] = 569,
    unist = 690,
    ["up.json"] = 567,
    v8r = 588,
    ["vcpkg configuration file"] = 147,
    ["vcpkg manifest file"] = 146,
    ["vega-lite.json"] = 573,
    ["vega.json"] = 572,
    ["venvironment-basic.yaml"] = 576,
    ["venvironment.yaml"] = 575,
    ["version.json"] = 577,
    ["vim-addon-info"] = 578,
    ["vs-2017.3.host.json"] = 580,
    ["vs-nesting.json"] = 581,
    ["vsls.json"] = 579,
    ["vss-extension.json"] = 585,
    ["vtesttree.yaml"] = 586,
    ["vtestunit.yaml"] = 587,
    ["warp-keysets.json"] = 757,
    ["warp-themes.json"] = 758,
    ["warp-workflows.json"] = 759,
    ["webhint.io"] = 709,
    ["webjobpublishsettings.json"] = 593,
    ["webjobs-list.json"] = 592,
    ["xs-app.json"] = 620,
    ["xunit.runner.json"] = 602,
    yamllint = 645,
    zuul = 629,
    ["Žinoma"] = 639
  },
