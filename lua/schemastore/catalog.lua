...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 991,
    [".nodehawkrc"] = 623,
    [".npmpackagejsonlintrc"] = 627,
    [".omletrc"] = 1171,
    [".phrase.yml"] = 705,
    [".phraseapp.yml"] = 706,
    [".pmbot.yml"] = 690,
    [".postcssrc"] = 699,
    [".powerpages-web-template-manifest"] = 701,
    [".pre-commit-config.yml"] = 702,
    [".pre-commit-hooks.yml"] = 703,
    [".putout.json"] = 739,
    [".rehyperc"] = 764,
    [".remarkrc"] = 768,
    [".sprite files"] = 864,
    ...
    AIConfig = 36,
    ["AMX Muse Program Descriptor"] = 1220,
    ["API Builder"] = 1027,
    ["AVA Configuration"] = 1090,
    ...
    ["AWS Copilot Manifest"] = 1259,
    ["AWS SAM CLI Samconfig"] = 274,
    Acton = 1309,
    ["Adobe UXP Manifest"] = 1153,
    ["Aerleon Network & Service Definitions"] = 22,
    ["Aerleon Policy"] = 23,
    ["Agent Permission Policy"] = 1299,
    ["AgentCore CLI"] = 1300,
    Aider = 1249,
    Air = 25,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1270,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1269,
    ["Airlock Microgateway"] = 37,
    ["Alacritty Configuration"] = 1062,
    ["AlgoVoi Compliance Receipt v1"] = 12,
    ["All Contributors configuration file"] = 1116,
    Anodizer = 449,
    ["Ansible Argument Specs"] = 433,
    ["Ansible Collection Galaxy"] = 440,
    ["Ansible Execution Environment"] = 430,
    ["Ansible Inventory"] = 439,
    ["Ansible Meta"] = 431,
    ["Ansible Meta Runtime"] = 432,
    ["Ansible Navigator Configuration"] = 442,
    ["Ansible Playbook"] = 437,
    ["Ansible Requirements"] = 434,
    ["Ansible Rulebook"] = 438,
    ["Ansible Tasks File"] = 436,
    ["Ansible Vars File"] = 435,
    ["Ansible-lint Configuration"] = 441,
    Any = 1181,
    ...
    ["Application list for a WinUtil"] = 1199,
    ArchitectFX = 1204,
    ["Argo CD"] = 56,
    ["Argo Events"] = 57,
    ["Argo Workflows"] = 58,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1268,
    ["Azure IoT Operations connector metadata"] = 1265,
    ...
    ["Azure Pipelines"] = 116,
    ["Azure Static Web Apps CLI configuration file"] = 868,
    ["Azure Static Web Apps configuration file"] = 867,
    BMML = 1287,
    ["BOSH CPI Config"] = 142,
    ...
    ["Bacon config"] = 6,
    ["Barba-CV"] = 85,
    ["Bashly (bashly.yml)"] = 1120,
    ["Bashly Settings (bashly-settings.yml)"] = 1121,
    Bento = 1286,
    ["Better Code Hub"] = 1032,
    ["Better Scripts"] = 165,
    Bigconfig = 135,
    ["Biome Formatter Config"] = 86,
    ["Bitmovin Encoding Template"] = 1213,
    BizTalkServerApplicationSchema = 998,
    Bleep = 166,
    ["Block Protocol Metadata"] = 163,
    ["Bluebricks blueprint config"] = 1292,
    ["Boyka Framework"] = 144,
    ...
    ["Butane Config"] = 1075,
    C4InterFlow = 1228,
    ["CDK Environment Manager, concrete environment configuration"] = 1252,
    ["CDK Environment Manager, concrete environments definition"] = 1251,
    ["CDK Environment Manager, environment definition"] = 1250,
    ["CGS Card Game Specification (cgs.json)"] = 1158,
    ["CICS TS region tagging"] = 1084,
    ["CICS TS resource import"] = 1085,
    ["CICS TS resource model"] = 1086,
    ["CICS TS resource overrides"] = 1087,
    ["CMake Presets"] = 167,
    ["CNC Codes"] = 189,
    ["CRS WAF test file"] = 1188,
    ["CRS WAF test platform overrides file"] = 1189,
    ...
    ["Caido Proxy Configuration"] = 1323,
    ...
    ["Chamaleon environment"] = 1217,
    ["Chamaleon properties"] = 1218,
    ["Chamaleon template"] = 1216,
    Changepacks = 1279,
    Changesets = 283,
    Changie = 176,
    Charmcraft = 177,
    ...
    ["Clawject config"] = 195,
    ["Cloud Foundry Application Manifest"] = 1170,
    ["Cloud Run Spec v1"] = 1194,
    ...
    Concord = 1187,
    ["Configu .cfgu files"] = 1175,
    ["Configu .configu file"] = 1176,
    Conjure = 188,
    ["Container Structure Test"] = 1012,
    Containerlab = 1041,
    ["Contextive Glossary"] = 1244,
    Convex = 187,
    ["Crowdsec collection config"] = 293,
    ["Crowdsec parser config"] = 294,
    ["Crowdsec scenario config"] = 295,
    ["CumulusCI Config"] = 194,
    ["Cursor Agent Environment"] = 1297,
    ["Custom Machinery Machine"] = 1159,
    ["Custom Machinery Recipe"] = 1160,
    ...
    ["DataYoga Job"] = 205,
    ["Datadog Continuous Testing"] = 535,
    ["Datadog Service Definition"] = 536,
    ["Datadog Software Catalog"] = 537,
    ["Datahub Ingestion Recipe"] = 1091,
    ["Debian Upstream Metadata file"] = 212,
    ["Deck config"] = 213,
    ["Declarative Automation Bundles"] = 1137,
    ["DeepMatch deeplinks spec"] = 214,
    ["Dein Config"] = 215,
    ["Deno Config (deno.json)"] = 311,
    ["Dependency cruiser"] = 216,
    ["DeployStack Configuration"] = 217,
    ["Deployah Configuration"] = 1267,
    ["Deployer Recipe"] = 314,
    ["Deta Spacefile"] = 218,
    ...
    ["DonateCaseBetterCasino menu"] = 1221,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1128,
    ["EAS config"] = 382,
    ["ECA - Editor Code Assistant"] = 346,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1117,
    ["ESLint Suppressions"] = 387,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1264,
    ["EasyVCR .NET"] = 384,
    ["Eidolon Resource"] = 1205,
    ...
    ["Envelope Team Definition"] = 1308,
    ["Envilder Map File"] = 350,
    ["Erda Pipeline"] = 1166,
    ["Erda Runtime"] = 1167,
    ["Espanso config.yml"] = 1290,
    ["Espanso match.yml"] = 1289,
    Esquio = 370,
    ["Estuary Flow Catalog"] = 1081,
    ["Ethereum ERC1155"] = 1302,
    ["Ethereum ERC721"] = 1301,
    ...
    ["Evolving Resolutive Process notation"] = 1266,
    ["Expo SDK"] = 381,
    ["Expoot app config"] = 383,
    ["F-Droid Data metadata"] = 389,
    ["FasterCI Configuration"] = 117,
    ["Fence configuration"] = 118,
    FiQuS = 393,
    Firebase = 391,
    ["Flatpak Builder Manifest"] = 394,
    ["FlexGet Config"] = 395,
    ["Flow.json Configurations"] = 1163,
    ["Fossa configuration file"] = 402,
    ["Fossa's fossa-deps file"] = 403,
    ["Foundry VTT - Base package Manifest"] = 397,
    ["Foundry VTT - Module Manifest"] = 398,
    ["Foundry VTT - System Data Template"] = 401,
    ["Foundry VTT - System Manifest"] = 399,
    ["Foundry VTT - World Manifest"] = 400,
    ["Foxx Manifest"] = 119,
    ["Freifunk.de Community API"] = 122,
    ["Frogbot Config"] = 123,
    ["G2P Mapping Configuration"] = 409,
    ["GCP Blueprint Metadata"] = 412,
    Gaspar = 410,
    ["GatewayCore API Gateway"] = 411,
    ["Gemini CLI settings"] = 413,
    ["GeoJSON.json latest"] = 1079,
    GherKing = 1083,
    ["GitHub Action"] = 418,
    ["GitHub Actions typing"] = 1201,
    ["GitHub Discussion"] = 419,
    ["GitHub Funding"] = 420,
    ["GitHub Issue Template configuration"] = 421,
    ["GitHub Issue Template forms"] = 422,
    ["GitHub Pages Jekyll"] = 423,
    ["GitHub Workflow"] = 424,
    ["GitHub Workflow Template Properties"] = 425,
    ["GitHub automatically generated release notes configuration"] = 426,
    ["GitLab Agent for Kubernetes configuration"] = 1155,
    GitVersion = 415,
    ["Gitea Issue Template configuration"] = 416,
    ["Gitea Issue Template forms"] = 417,
    ["Gitpod Automations"] = 428,
    ["Gitpod Configuration"] = 429,
    ["GlazeWM settings"] = 1157,
    ["Global Privacy Control"] = 414,
    Goblet = 1136,
    ["Golangci-lint Configuration"] = 444,
    ["Golangci-lint Custom Plugins Configuration"] = 445,
    ["Google Chrome Related Website Sets"] = 392,
    ["Google Cloud Workflows"] = 270,
    ["Google Digital Assetlinks"] = 1245,
    Goreleaser = 447,
    ["Goreleaser Pro"] = 448,
    Goss = 450,
    ["Gradle Build Cache Node"] = 1030,
    ["Gradle Enterprise"] = 1029,
    ["Grafana 5.x Dashboard"] = 451,
    ["GraphQL Code Generator"] = 456,
    ["GraphQL Config"] = 455,
    ["GraphQL Mesh"] = 454,
    ["GroovyLint configuration"] = 457,
    ["Grunt JSHint task"] = 461,
    ["Grunt Watch task"] = 462,
    ["Grunt base task"] = 463,
    ["Grunt clean task"] = 459,
    ["Grunt copy task"] = 458,
    ["Grunt cssmin task"] = 460,
    HEMTT = 994,
    Hadolint = 1008,
    Hammerkit = 1040,
    ["Hardware Sentry Configuration"] = 1095,
    ["Hashgraph Online Skill Manifest"] = 2,
    ["HashiCorp Vault"] = 464,
    Hatch = 1009,
    Hayson = 466,
    ["Haystack Pipeline"] = 467,
    ["Hazelcast 5 Configuration"] = 468,
    ["Hecate Input Schema"] = 1256,
    ["Helm Chart.lock"] = 236,
    ["Helm Chart.yaml"] = 235,
    ["Helm Unittest Test Suite"] = 237,
    ["Home Assistant Integration Manifest"] = 469,
    ["Homer dashboard configuration"] = 470,
    Hugo = 1071,
    ["Hugo Theme"] = 1070,
    ["Hulak Configuration"] = 477,
    ["Hyperfoil benchmark configuration"] = 476,
    ["IBM Zapp document"] = 478,
    ["IBM zCodeFormatSettings"] = 479,
    ["IMG Catapult PSP"] = 484,
    ["IVMS101 by CODE Protocol"] = 1156,
    ["Infinispan Configuration"] = 486,
    ["Infinispan Server Configuration"] = 487,
    Infrahub = 488,
    Istanbul = 1099,
    ["JDownloader2 crawler multi-rules"] = 502,
    ["JDownloader2 crawler single-rules"] = 501,
    ["JFrog Applications Config"] = 503,
    ["JFrog File Spec"] = 504,
    ["JFrog Pipelines YML DSL"] = 1105,
    ["JMeter DSL cli config"] = 505,
    JReleaser = 508,
    ["JSON Document Transform"] = 516,
    ["JSON Feed"] = 517,
    ["JSON Resume"] = 776,
    ["JSON Schema Draft 2020-12"] = 976,
    ["JSON Schema Draft 4"] = 973,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1138,
    ["JSON Schema Draft 7"] = 974,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1139,
    ["JSON Schema Draft 8 (2019-09)"] = 975,
    ["JSON-API"] = 515,
    ["JSON-e templates"] = 1037,
    ["JSON-stat 2.0"] = 969,
    JSONPatch = 519,
    ["JSR Package Config (jsr.json)"] = 509,
    Jarl = 1272,
    Jasmine = 496,
    Jekyll = 497,
    ["Jenkins X Pipelines"] = 498,
    ["Jenkins X Requirements"] = 499,
    Jest = 500,
    Jocker = 506,
    ["Jovo Language Models"] = 507,
    ["Jujutsu (jj) VCS config"] = 1258,
    ["KIMMDY config file"] = 530,
    ["KODE/CI build.yaml"] = 1101,
    ["KSP-AVC"] = 970,
    ["KSP-CKAN"] = 971,
    ["KSP-NetKAN"] = 972,
    KSY = 1168,
    KSail = 407,
    ["KYA Manifest"] = 1169,
    ["Karakum configuration file"] = 404,
    Kas = 522,
    ["Kestra flow file"] = 531,
    ["Keycloak REST API"] = 1108,
    ["Knative Functions - func.yaml"] = 405,
    Knip = 406,
    ["Knowledge Unit"] = 539,
    ["Kometa (nightly) config file"] = 533,
    ["Kometa config file"] = 532,
    ["Kong DBLess config"] = 1102,
    KrakenD = 534,
    ["Kubri Configuration"] = 542,
    LOOBin = 557,
    ["Lake configuration file"] = 1261,
    ...
    ["Lando (landofile)"] = 112,
    ["LangGraph Platform configuration"] = 1180,
    ["Language configuration"] = 1179,
    Lefthook = 546,
    ["Liferay client-extension.yaml"] = 553,
    ["LinkML Metamodel"] = 555,
    Liquibase = 1046,
    ["Liquibase Flow File"] = 1047,
    ["Lively Properties"] = 556,
    ["Lobe AI Agent"] = 114,
    Loki = 115,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 599,
    ["MS2Rescore Configuration"] = 604,
    ["Madness (madness.yml)"] = 1119,
    ["Mado configuration"] = 563,
    ["Maestro Flow"] = 564,
    ["Mail Servers Configuration"] = 1293,
    ["MapEHR Mapping"] = 565,
    Markdownlint = 1050,
    ["Mason Registry"] = 1053,
    ["MegaLinter Custom Flavor"] = 568,
    ["MegaLinter configuration"] = 567,
    ["MegaLinter descriptor"] = 569,
    Melange = 1146,
    ["Meltano project definition"] = 570,
    ["Mergify Configuration"] = 605,
    ["Metadata for a Bazel module"] = 571,
    ["Metadata for a Cinnamon spice"] = 1197,
    ["Metatype Configuration"] = 572,
    ["MetricsHub Configuration"] = 573,
    ["MetricsHub Connector Configuration"] = 574,
    ["Micro Editor Syntax"] = 1129,
    ["Microsoft Band Web Tile"] = 575,
    ["Microsoft RulesEngine workflow rules"] = 1184,
    ["Microsoft RulesEngine workflow rules list"] = 1185,
    ["Minecraft Custom Main Menu Mod"] = 1147,
    ["Minecraft Data Pack Advancement"] = 577,
    ["Minecraft Data Pack Biome"] = 578,
    ["Minecraft Data Pack Configured Carver"] = 579,
    ["Minecraft Data Pack Damage Type"] = 580,
    ["Minecraft Data Pack Dimension"] = 582,
    ["Minecraft Data Pack Dimension Type"] = 581,
    ["Minecraft Data Pack Item Modifier"] = 583,
    ["Minecraft Data Pack Loot Table"] = 584,
    ["Minecraft Data Pack Metadata"] = 585,
    ["Minecraft Data Pack Predicate"] = 586,
    ["Minecraft Data Pack Recipe"] = 587,
    ["Minecraft Data Pack Tag"] = 588,
    ["Minecraft Data Pack Template Pool"] = 589,
    ["Minecraft Data Pack Trim Material"] = 594,
    ["Minecraft Data Pack Trim Pattern"] = 595,
    ["Minecraft Resource Pack Lang"] = 590,
    ["Minecraft Resource Pack Particle"] = 591,
    ["Minecraft Resource Pack Texture Mcmeta"] = 593,
    ["Minecraft Resourcepack Sounds"] = 592,
    ["MockServer Expectations"] = 601,
    ModuleAssembler = 597,
    ["Monade CLI Stack Configuration"] = 608,
    ["MongoDB Atlas Search Index Definition"] = 1100,
    ["Monika Configuration"] = 1098,
    ["Monoweave Configuration"] = 603,
    ["Motif config"] = 990,
    MultiQC = 1238,
    ["NOX Framework (Service)"] = 626,
    ["Netin Diagnostic System Template"] = 1057,
    ["Netlify config"] = 611,
    ["Network-as-Code Data Model"] = 612,
    ["Next Gen UI Agent A2A Server Configuration"] = 613,
    ["Next Gen UI Agent Configuration"] = 615,
    ["Next Gen UI Agent MCP Server Configuration"] = 614,
    ["Nightwatch.js"] = 619,
    ["Node.js configuration"] = 995,
    ["NueJS configuration file"] = 631,
    ["Nuitka Package Config"] = 1161,
    ["Nullstone config"] = 633,
    ["ONe's changelog entry"] = 652,
    ["ONe's service descriptor"] = 651,
    ["ORT Server repository environment configuration"] = 662,
    ["OSCAL Assessment Plan (AP)"] = 664,
    ["OSCAL Assessment Results (AR)"] = 665,
    ["OSCAL Catalog"] = 666,
    ["OSCAL Component Definition (CDef)"] = 667,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 668,
    ["OSCAL Profile"] = 669,
    ["OSCAL System Security Plan (SSP)"] = 670,
    ["OSS Review Toolkit configuration"] = 671,
    ["OSS Review Toolkit curation"] = 672,
    ["OSS Review Toolkit package configuration"] = 673,
    ["OSS Review Toolkit project package manager definition"] = 674,
    ["OSS Review Toolkit repository configuration"] = 675,
    ["OSS Review Toolkit resolutions"] = 676,
    ["October CMS columns"] = 637,
    ["October CMS fields"] = 638,
    ["Oh My Posh"] = 640,
    Okteto = 641,
    ["Ona Automations"] = 643,
    Opctl = 993,
    ["Open Data Contract Standard (ODCS)"] = 656,
    ["Open Data Product Standard (ODPS)"] = 657,
    ["Open Know-How"] = 1243,
    OpenDecree = 1306,
    ["OpenDecree Configuration"] = 1307,
    ["OpenRewrite Resource"] = 654,
    OpenSRM = 658,
    OpenStatus = 1254,
    ["OpenTelemetry Declarative Configuration"] = 655,
    ["OpenUtau character yaml"] = 648,
    ["OpenUtau ustx"] = 649,
    ["OpenWeather Current Weather API"] = 1036,
    ["OpenWeather Road Risk API"] = 1035,
    ["Ory Hydra configuration"] = 475,
    ["Ory Keto configuration"] = 538,
    ["Ory Kratos configuration"] = 663,
    ["Ory Oathkeeper configuration"] = 635,
    ["Outblocks App configuration"] = 660,
    ["Outblocks database table"] = 661,
    ["Outblocks project configuration"] = 659,
    PDM = 684,
    POPxf = 696,
    ["POPxf Correlations"] = 697,
    ["PRML manifest"] = 704,
    Packer = 680,
    PactSpec = 681,
    Panache = 682,
    Pantsbuild = 1115,
    ["Paper paper-plugin.yml"] = 683,
    ["Pipeline component"] = 1048,
    ["Platform.sh application"] = 8,
    ["Platform.sh routes"] = 9,
    ["Platform.sh services"] = 10,
    ["Plex Prerolls"] = 694,
    ["PocketMine plugin.yml"] = 691,
    ["Podman Desktop Extension"] = 1325,
    ["Postman collection"] = 700,
    ["Power Pages Configuration"] = 1255,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1200,
    ["ProActions AI-Kit Configuration"] = 712,
    ["ProActions AI-Kit Configuration for Menus"] = 714,
    ["ProActions AI-Kit Configuration for Sections"] = 716,
    ["ProActions AI-Kit Configuration for Services"] = 713,
    ["ProActions AI-Kit Configuration for Steps"] = 717,
    ["ProActions AI-Kit Configuration for Templates"] = 715,
    ["Problem object RFC9457"] = 1144,
    ["Problem package format"] = 718,
    ["Problem package generators"] = 719,
    ["Problem package submissions"] = 720,
    ["Problem package test group metadata"] = 721,
    Pterodactyl = 1094,
    ["Pull Request Labeler"] = 738,
    Pulumi = 746,
    ["PyGTA Config"] = 742,
    PyProject = 747,
    Pylock = 1246,
    Pyright = 748,
    ["Python script metadata"] = 1240,
    ["QType AI DSL"] = 751,
    Qgoda = 750,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1317,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1315,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1321,
    ["Qlik Talend Cloud Pipeline - Project"] = 1313,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1316,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1318,
    ["Qlik Talend Cloud Pipeline - Task"] = 1314,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1320,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1319,
    Qodana = 1067,
    ["Qt Creator workspace file"] = 1177,
    ["Quali Torque Blueprint Spec 2"] = 1092,
    ["QueryFirst config file"] = 1111,
    ["QuikRun Configuration"] = 1322,
    ["Qwen Code Settings"] = 1303,
    ["RKE Cluster Configuration JSON"] = 1045,
    ["RKE Cluster Configuration YAML"] = 1044,
    RadioHound = 741,
    ["Raid Profile"] = 1304,
    ["Raid Repo Configuration"] = 1305,
    Railpack = 753,
    Railway = 752,
    ["Rancher Fleet"] = 743,
    ["Rattler-build"] = 754,
    Ray = 1007,
    ["Read the Docs"] = 745,
    ["Red-DiscordBot Cog"] = 761,
    ["Red-DiscordBot Cog Repo"] = 762,
    ["Red-DiscordBot Trivia"] = 763,
    ["Releasaurus Config"] = 5,
    ReleaseKit = 4,
    ["Render Blueprints"] = 1043,
    RenderCV = 780,
    Renovate = 777,
    ["Renovate global configuration"] = 778,
    ["Renovate inherited configuration"] = 779,
    ["Replit config"] = 769,
    Restate = 1233,
    ["Revel Digital Gadget Definition File"] = 1257,
    RoadRunner = 782,
    ["Robust Station Image"] = 1263,
    Rockcraft = 783,
    ["Roo Coder Custom Modes"] = 784,
    Rubocop = 773,
    ["Rudder techniques"] = 1151,
    Ruff = 774,
    ["Rust Project"] = 775,
    ["Rust toolchain"] = 789,
    ["SDMX data message"] = 816,
    ["SDMX metadata message"] = 815,
    ["SDMX structure message"] = 814,
    ["SIL Kit Participant Configuration"] = 826,
    ["SIL Kit Registry Configuration"] = 827,
    ["SPDX 2.3"] = 865,
    SWADL = 881,
    ["Safebox Config"] = 1106,
    ["Sapphire CLI Config"] = 792,
    ["SauceCTL Configuration"] = 1054,
    Scarb = 812,
    ["Schema Catalog"] = 807,
    ["Scoop manifest"] = 813,
    ["Semantic Data Fabric (SDF) file"] = 817,
    ["Semgrep Rule"] = 819,
    ["Serenity Code Generator (Sergen)"] = 820,
    ["Serverless Framework Configuration"] = 1061,
    ["Serverless Workflow"] = 1063,
    ["Settings for a Cinnamon spice"] = 1196,
    ["Settings.paf"] = 822,
    ["Shopware 6 Configuration"] = 1064,
    ["Shopware CLI Extension Store Configuration"] = 1065,
    ["Shopware CLI Project Store Configuration"] = 1066,
    ["Sigma Detection Rule"] = 824,
    ["Sigrid scope configuration file"] = 825,
    ["SkyPilot Task JSON"] = 1152,
    ["Slack app manifest"] = 829,
    Snapcraft = 831,
    ["Solarxy project config"] = 834,
    Solidarity = 835,
    ["Solution filters"] = 836,
    ["Source Maps v3"] = 837,
    Sourcery = 838,
    ["Spack bootstrap.yaml"] = 839,
    ["Spack cdash.yaml"] = 840,
    ["Spack ci.yaml"] = 841,
    ["Spack compilers.yaml"] = 842,
    ["Spack concretizer.yaml"] = 843,
    ["Spack config.yaml"] = 844,
    ["Spack definitions.yaml"] = 845,
    ["Spack develop.yaml"] = 846,
    ["Spack env_vars.yaml"] = 847,
    ["Spack environment"] = 853,
    ["Spack include.yaml"] = 848,
    ["Spack mirrors.yaml"] = 849,
    ["Spack modules.yaml"] = 850,
    ["Spack packages.yaml"] = 851,
    ["Spack repos.yaml"] = 852,
    ["Spack toolchains.yaml"] = 854,
    ["Spack upstreams.yaml"] = 855,
    ["Spack view.yaml"] = 856,
    ["Speakeasy Generation Config File"] = 860,
    ["Speakeasy Lint Configuration File"] = 857,
    ["Speakeasy Test Generation Configuration File"] = 858,
    ["Speakeasy Workflow File"] = 859,
    SpecIF = 861,
    ["Specmatic Configuration"] = 862,
    ["Sponge Mixin configuration"] = 863,
    StackBlitz = 869,
    ["StackHawk Scanner Configuration"] = 1060,
    Stale = 870,
    Starfish = 871,
    ["Starlake Data Pipeline"] = 1033,
    Starship = 872,
    ["Statamic Blueprint"] = 873,
    ["Stella configuration file"] = 874,
    ["Streamlit configuration file"] = 875,
    ["Stryker Mutator"] = 878,
    ["StyleCop Analyzers Configuration"] = 879,
    ["Stylelint (.stylelintrc)"] = 880,
    ["Stylua Config"] = 1247,
    ["Sublime Syntax"] = 1107,
    ["Subsquid squid manifest"] = 1154,
    ["Swagger API 2.0"] = 882,
    ["Synadia Connect Component"] = 883,
    TSON = 919,
    TSTyche = 920,
    ["TYPO3 Vendor Bundler config"] = 926,
    ["Tab data for a LinUtil"] = 1203,
    ["Tab list for a LinUtil"] = 1202,
    Tach = 884,
    ["Tach Domain"] = 885,
    Talhelper = 887,
    ["Talisman configuration"] = 888,
    Taplo = 1248,
    ["Taskfile config"] = 1038,
    Taurus = 889,
    Tauticord = 890,
    ["Tekton Pipeline"] = 1276,
    ["Tekton PipelineRun"] = 1277,
    ["Tekton Task"] = 1274,
    ["Tekton TaskRun"] = 1275,
    Telefonistka = 1234,
    ["Terrateam config"] = 1260,
    ["TestEnvironment.json"] = 902,
    ["TextMate Grammar"] = 901,
    Threagile = 896,
    ["Tier.run pricing.json"] = 893,
    Tikibase = 894,
    Tombi = 899,
    ["Traefik v2"] = 905,
    ["Traefik v2 File Provider"] = 906,
    ["Traefik v3"] = 907,
    ["Traefik v3 File Provider"] = 908,
    ["Travis CI (.travis.yml)"] = 904,
    Treefmt = 453,
    Trident = 1230,
    ["TrueScript for *.tscript files"] = 911,
    ["Tugboat QA config.yml"] = 1227,
    TunnelHub = 1142,
    Turborepo = 903,
    Tycho = 1191,
    Tye = 1068,
    ["Tyk Gateway - Open Source v5.7+"] = 1239,
    ["UET BuildConfig.json"] = 1112,
    ["UI5 Manifest"] = 932,
    ["UNCORS configuration"] = 937,
    ["UTAM Page Object"] = 935,
    ["Ubuntu Server Autoinstall"] = 930,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1231,
    ["Uniswap Token List"] = 1018,
    ["Universal Schedule Format"] = 938,
    ["Unreal Engine Uplugin"] = 1113,
    ["Unreal Engine Uproject"] = 1114,
    ["UpCloud CLI (upctl) configuration"] = 1232,
    ["Updatecli Compose"] = 1076,
    ["Updatecli Policy Manifest"] = 1077,
    ["Updatecli Policy Metadata"] = 1078,
    Uplift = 1110,
    ["Upsun config"] = 7,
    ["User Journey Map"] = 1042,
    V2Ray = 1082,
    ["VSCode Code Snippets"] = 258,
    ["VSIX CLI publishing"] = 956,
    Vector = 940,
    ["Vela Pipeline Configuration"] = 943,
    Vercel = 257,
    ["Version Bumper config"] = 946,
    Vespertide = 1281,
    ["Vespertide Migration"] = 1282,
    ["Vespertide Model"] = 1283,
    ["Viash Component Config"] = 1236,
    ["Viash Package Config"] = 1237,
    Visivo = 1140,
    ["WP-CLI"] = 966,
    Wake = 1229,
    ["Waku Config"] = 1206,
    ["Web App Manifest"] = 962,
    ["Web types"] = 965,
    WebExtensions = 961,
    ["Webman package recipe"] = 1088,
    ["Windows Package Manager Installer Manifest"] = 1015,
    ["Windows Package Manager Locale Manifest"] = 1016,
    ["Windows Package Manager Singleton Manifest"] = 1014,
    ["WireMock CLI import configuration"] = 1212,
    ["WireMock CLI local service configuration"] = 1211,
    ["WireMock message stub mapping"] = 1210,
    ["WireMock stub mapping"] = 1209,
    ["Woodpecker pipeline config"] = 1056,
    ["Wrangler CLI"] = 967,
    ["XenForo add-on manifest"] = 968,
    ["Xstate Machine"] = 1074,
    ["Yandex Workflow Language"] = 1198,
    ["Yarn Config (.yarnrc.yml)"] = 1031,
    ["Yippee-Ki-JSON configuration YML"] = 1022,
    ["YouTrack App"] = 1195,
    ["Zarf Package Configuration"] = 1262,
    ["Zerops import file"] = 1183,
    ["Zola Configuration"] = 1273,
    ["aerleon.yml"] = 21,
    ["amplify.yml"] = 14,
    ["amxx-builder manifest"] = 1324,
    ["angular.json"] = 38,
    apko = 1145,
    ...
    ["behat.yml"] = 145,
    ["bigquery-table"] = 134,
    ["bioimageio resource description"] = 1162,
    ...
    ["cargo-nextest repository configuration"] = 616,
    ["cargo-nextest user configuration"] = 617,
    ["ccmod.json"] = 1207,
    changelogging = 1174,
    ...
    ["chutzpah.json"] = 266,
    cibuildwheel = 182,
    ["clang-format (.clang-format)"] = 1080,
    ["clang-tidy"] = 243,
    clangd = 242,
    clib = 244,
    ...
    ["crowdin.yml"] = 292,
    ["ctfd-setup configuration file"] = 1219,
    ["custom-elements.json"] = 1132,
    ["cypress.json"] = 296,
    ["dacier.yml"] = 1312,
    ...
    ["ezd task runner"] = 385,
    ["fabric.mod.json"] = 388,
    ["first-timers-bot"] = 396,
    ["flagd flag configuration"] = 120,
    ["fly.io Configuration"] = 121,
    fulibWorkflows = 1055,
    ["function.json"] = 408,
    ["gRPC API Gateway & OpenAPI Config"] = 16,
    ["gematik health care insurance list"] = 1225,
    ["gematik health care patient list"] = 1222,
    ["gematik health care provider institution list"] = 1224,
    ["gematik health care provider list"] = 1223,
    ["gematik tiger test environment configuration"] = 1226,
    ["git-town.toml"] = 1271,
    ["gitlab-ci"] = 427,
    ["global.json"] = 443,
    ["go-feature-flag Flag Configuration"] = 446,
    ["haxelib.json"] = 465,
    helmfile = 1010,
    helmwave = 1011,
    ["host-meta.json"] = 472,
    ...
    ["ide.host.json"] = 480,
    ["ifstate.yaml"] = 481,
    ["imageoptimizer.json"] = 482,
    ["importmap.json"] = 485,
    instant_python_config = 489,
    instant_python_custom_project = 490,
    intlayer = 491,
    ["ioBroker Configuration"] = 492,
    ["ioBroker JSON UI"] = 493,
    ["ioBroker Package manifest"] = 494,
    ["ixpect.conf.yaml"] = 495,
    ["ize.toml"] = 1109,
    ["jsconfig.json"] = 520,
    ["jscpd Configuration"] = 1093,
    jsdoc = 1006,
    ["k3d.yaml"] = 521,
    ["k9s aliases.yaml"] = 523,
    ["k9s cluster-config.yaml"] = 525,
    ["k9s config.yaml"] = 524,
    ["k9s hotkeys.yaml"] = 526,
    ["k9s plugins.yaml"] = 527,
    ["k9s skin.yaml"] = 528,
    ["k9s views.yaml"] = 529,
    ["kontinuous-config.yaml"] = 541,
    ["kontinuous-values.yaml"] = 540,
    ["kustomization.yaml"] = 543,
    ["label-commenter-config.yml"] = 544,
    ["latexindent configuration"] = 113,
    ["launchsettings.json"] = 545,
    lazydocker = 1131,
    lazygit = 1130,
    ["lego.json"] = 547,
    ["lerna.json"] = 548,
    ["lgtm.yml"] = 549,
    ["liblab.config.json"] = 550,
    ["libman.json"] = 551,
    ["license-report-config.json"] = 552,
    ["linkinator.config.json"] = 554,
    ["lint-staged (.lintstagedrc)"] = 984,
    ["local.settings.json"] = 559,
    ["localazy.json"] = 560,
    ["lotus.yaml"] = 558,
    ["lsdlschema.json"] = 561,
    ["macro.json"] = 1097,
    ["markdown-link-check"] = 1051,
    maturin = 1052,
    mboats = 1059,
    memnex = 1310,
    ["micro-settings.json"] = 1124,
    ["mimetypes.json"] = 576,
    ["mirrord config"] = 986,
    mise = 987,
    ["mkdocs.yml"] = 596,
    ...
    ["monospace.yml"] = 602,
    ["moon.yml"] = 1208,
    ["mprocs Configuration file"] = 1178,
    ["mrdocs.yml"] = 598,
    ["mta.yaml"] = 988,
    ["mtad.yaml"] = 989,
    ["mycode.json"] = 609,
    nFPM = 618,
    ["napari plugin manifest"] = 610,
    neoload = 1001,
    ["nest-cli"] = 621,
    ["nexus-rpc-gen"] = 1298,
    ["ninjs (News in JSON)"] = 620,
    ["nitro.json"] = 1000,
    ["nixd configuration"] = 1150,
    ["nlu.json"] = 622,
    ["nodemon.json"] = 624,
    ["noodl config"] = 1058,
    ["notebook.mod.json"] = 625,
    now = 996,
    ["npm-badges"] = 628,
    ["nswag.json"] = 632,
    ntangle = 634,
    ["nuclei-template.yaml"] = 629,
    ["nuget-project.json"] = 630,
    ["ocelot.json"] = 636,
    ogen = 639,
    ["omnisharp.json"] = 642,
    openHAB = 1284,
    ...
    oxlint = 1295,
    ["package.json"] = 677,
    ["package.manifest"] = 679,
    ["package.yaml"] = 678,
    ["partial-black.json"] = 146,
    ["partial-fastapi.json"] = 147,
    ["partial-pixi.json"] = 689,
    ["partial-scheduled.json"] = 148,
    ["pattern.json"] = 687,
    ["petstore-v1.0"] = 1104,
    pgap_yaml_input_reader = 685,
    pgrls = 686,
    pgxgen = 1288,
    pitcms = 1291,
    ["pixi.toml"] = 688,
    ["plagiarize-me.yaml"] = 693,
    ["plagiarize.yaml"] = 692,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1215,
    ["podbard.yaml"] = 695,
    ["portman.json"] = 698,
    ["prefect.toml"] = 707,
    ["prefect.yaml"] = 708,
    ...
    ["prettierrc.json"] = 710,
    ["prisma.yml"] = 711,
    ["project-1.0.0-beta3.json"] = 723,
    ["project-1.0.0-beta4.json"] = 724,
    ["project-1.0.0-beta5.json"] = 725,
    ["project-1.0.0-beta6.json"] = 726,
    ["project-1.0.0-beta8.json"] = 727,
    ["project-1.0.0-rc1.json"] = 728,
    ["project-1.0.0-rc2.json"] = 729,
    ["project.json"] = 722,
    ["project.owasp.yaml"] = 730,
    ["prometheus-alertmanager.json"] = 734,
    ["prometheus.json"] = 731,
    ["prometheus.rules.json"] = 732,
    ["prometheus.rules.test.json"] = 733,
    ["proxies.json"] = 735,
    ["publiccode.yml"] = 736,
    ["pubspec.yaml"] = 737,
    ["pyrseas-0.8.json"] = 740,
    pytest = 749,
    ["quilt.mod.json"] = 1125,
    ["rc3 auth"] = 755,
    ["rc3 collection"] = 756,
    ...
    ["rc3 settings"] = 760,
    ["registry.yaml"] = 51,
    ["release drafter"] = 1002,
    ["release-hub.json"] = 3,
    ["release-please-config.json"] = 765,
    ["release-please-manifest.json"] = 766,
    ["release-plz.toml"] = 767,
    ["renv.lock"] = 781,
    ["reposets Configuration"] = 770,
    ["reposets Credentials"] = 771,
    ["revola.json"] = 1,
    ["rivet.json"] = 1149,
    ["rivet.yaml (legacy)"] = 1148,
    rumdl = 786,
    runny = 785,
    runspec = 1311,
    rustfmt = 787,
    ...
    samt = 790,
    samtrc = 791,
    ["sarif-1.0.0.json"] = 793,
    ["sarif-2.0.0.json"] = 794,
    ["sarif-2.1.0"] = 804,
    ["sarif-2.1.0-rtm.2"] = 795,
    ["sarif-2.1.0-rtm.3"] = 797,
    ["sarif-2.1.0-rtm.4"] = 799,
    ["sarif-2.1.0-rtm.5"] = 801,
    ["sarif-2.1.0-rtm.6"] = 802,
    ["sarif-external-property-file-2.1.0"] = 805,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 796,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 798,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 800,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 803,
    ["scalingo.json configuration"] = 806,
    ["schema.org - Action"] = 808,
    ["schema.org - ContactPoint"] = 809,
    ["schema.org - Place"] = 810,
    ["schema.org - Thing"] = 811,
    ["secrethub.yml"] = 1127,
    ["semantic-release"] = 818,
    ["servicehub.config.json"] = 979,
    ["servicehub.service.json"] = 978,
    ["settings.job"] = 821,
    ["sfdx-hardis configuration"] = 823,
    ["shard.yml"] = 1165,
    ["size-limit configuration"] = 828,
    ["skaffold.yaml"] = 1049,
    ["skyuxconfig.json"] = 830,
    ["snowflake-config"] = 832,
    ["snowflake-connections"] = 833,
    ["spicepod.yaml"] = 1186,
    ["sqlc configuration"] = 866,
    ["stripe-app-local.json"] = 877,
    ["stripe-app.json"] = 876,
    swcrc = 1034,
    ["task.json"] = 886,
    taskcat = 997,
    ["template.json"] = 891,
    ["templatsources.json"] = 892,
    ["text2confl config"] = 1296,
    ["theme.json"] = 895,
    ["tizen_workspace.json"] = 897,
    tldr = 898,
    ["tm_devices configuration file"] = 1253,
    tmuxinator = 982,
    tox = 900,
    ["transcend.yml"] = 909,
    ["tree-sitter grammar.json"] = 452,
    ["trime.yaml"] = 910,
    ["trunk.yaml"] = 912,
    ["ts-force-config.json"] = 917,
    ["tsconfig.json"] = 913,
    ["tsd.json"] = 914,
    ["tsdoc.json"] = 915,
    ["tsdrc.json"] = 916,
    ...
    ["vega-lite.json"] = 942,
    ["vega.json"] = 941,
    ["venvironment.yaml"] = 944,
    ["venvplus.yaml"] = 945,
    version = 1235,
    ["version.json"] = 947,
    ["vhwdebugger-binding.yaml"] = 949,
    ["vim-addon-info"] = 950,
    ["vs-2017.3.host.json"] = 952,
    ["vs-nesting.json"] = 953,
    ["vsls.json"] = 951,
    ["vss-extension.json"] = 957,
    vtcfg = 1241,
    ["vtesttree.yaml"] = 958,
    ["vtestunit.yaml"] = 959,
    ["warp-keysets.json"] = 1133,
    ["warp-themes.json"] = 1134,
    ["warp-workflows.json"] = 1135,
    ["webhint.io"] = 1089,
    ["webjobpublishsettings.json"] = 964,
    ["webjobs-list.json"] = 963,
    ["well-known-fursona"] = 1173,
    ["xs-app.json"] = 992,
    ["xunit.runner.json"] = 977,
    yamlfmt = 1019,
    yamllint = 1020,
    ["yap.json"] = 1021,
    ["zerops.yml"] = 1182,
