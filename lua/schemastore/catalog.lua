...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 112,
    [".cryproj (generic)"] = 428,
    [".cryproj engine-5.2"] = 423,
    [".cryproj engine-5.3"] = 424,
    [".cryproj engine-5.4"] = 425,
    [".cryproj engine-5.5"] = 426,
    [".cryproj engine-dev"] = 427,
    [".csscomb.json"] = 114,
    [".csslintrc"] = 115,
    [".eslintrc"] = 153,
    [".esmrc.json"] = 146,
    ...
    [".mtaext"] = 434,
    [".nodehawkrc"] = 266,
    [".npmpackagejsonlintrc"] = 268,
    [".phraseapp.yml"] = 299,
    [".pmbot.yml"] = 291,
    [".postcssrc"] = 296,
    [".pre-commit-config.yml"] = 297,
    [".pre-commit-hooks.yml"] = 298,
    [".putout.json"] = 316,
    [".rehyperc"] = 321,
    [".remarkrc"] = 322,
    [".sprite files"] = 358,
    ...
    [".vsext"] = 404,
    [".yarnrc.yml"] = 466,
    ["<div>RIOTS' studio configuration"] = 407,
    ["API Builder"] = 463,
    ["AVA Configuration Schema"] = 515,
    ...
    ["Azure Pipelines"] = 40,
    ["Azure Static Web Apps CLI configuration file"] = 360,
    ["Azure Static Web Apps configuration file"] = 359,
    ["Better Code Hub"] = 468,
    BizTalkServerApplicationSchema = 440,
    ...
    ["Butane config schema"] = 502,
    ["CICS TS region tagging"] = 509,
    ["CICS TS resource import"] = 510,
    ["CICS TS resource model"] = 511,
    ["CICS TS resource overrides"] = 512,
    ["CMake Presets"] = 68,
    ["CSR Framework"] = 76,
    ...
    ["Container Structure Test"] = 451,
    Containerlab = 476,
    ["Dart build configuration"] = 116,
    ["Dart test config"] = 117,
    ["Datadog Service Catalog Definition"] = 224,
    ["Datahub Ingestion Recipe Schema"] = 516,
    Deno = 121,
    ["Deployer Recipe"] = 124,
    Devfile = 143,
    ["Discord Webhook"] = 126,
    ["Dolittle Artifacts"] = 129,
    ["Dolittle Bounded Context Configuration"] = 130,
    ["Dolittle Event Horizons Configuration"] = 131,
    ["Dolittle Resources Configuration"] = 132,
    ["Dolittle Server Configuration"] = 133,
    ["Dolittle Tenant Map Configuration"] = 135,
    ["Dolittle Tenants Configuration"] = 134,
    ["Dolittle Topology"] = 136,
    ["Drush site aliases"] = 140,
    ["Error pages"] = 149,
    Esquio = 147,
    ["Estuary Flow Catalog Schema"] = 506,
    ["Expo SDK"] = 152,
    ["F-Droid Data metadata"] = 156,
    ["Facets - FSDL - Application"] = 154,
    ["Fossa configuration file"] = 161,
    ["Fossa's fossa-deps file"] = 162,
    ["Foundry VTT - Manifest"] = 159,
    ["Foundry VTT - Template"] = 160,
    ["Foxx Manifest"] = 41,
    ["GatewayCore API Gateway"] = 165,
    ["GeoJSON.json latest"] = 504,
    GherKing = 508,
    ["GitHub Action"] = 169,
    ["GitHub Funding"] = 170,
    ["GitHub Issue Template configuration"] = 172,
    ["GitHub Workflow"] = 173,
    ["GitHub Workflow Template Properties"] = 174,
    ["GitHub issue forms"] = 171,
    GitVersion = 168,
    ["Gitpod Configuration"] = 176,
    ["Global Privacy Control"] = 166,
    ["Google Cloud Workflows"] = 100,
    Goreleaser = 179,
    ["Goreleaser Pro"] = 180,
    ["Gradle Build Cache Node"] = 465,
    ["Gradle Enterprise"] = 464,
    ["Grafana 5.x Dashboard"] = 181,
    ["GraphQL Code Generator"] = 184,
    ["GraphQL Config"] = 183,
    ["GraphQL Mesh"] = 182,
    ["Grunt JSHint task"] = 188,
    ["Grunt Watch task"] = 189,
    ["Grunt base task"] = 190,
    ["Grunt clean task"] = 186,
    ["Grunt copy task"] = 185,
    ["Grunt cssmin task"] = 187,
    HEMTT = 437,
    Hadolint = 449,
    ["Hammerkit YAML Schema"] = 475,
    ["Hardware Sentry Configuration"] = 520,
    Hayson = 192,
    ["Haystack Pipeline"] = 193,
    ["Hazelcast 5 Configuration"] = 194,
    ["Helm Chart.lock"] = 78,
    ["Helm Chart.yaml"] = 77,
    Hugo = 498,
    ["JFrog File Spec"] = 209,
    ["JSON Document Transform"] = 217,
    ["JSON Feed"] = 218,
    ["JSON Resume"] = 324,
    ["JSON Schema Draft 2020-12"] = 419,
    ["JSON Schema Draft 4"] = 416,
    ["JSON Schema Draft 7"] = 417,
    ["JSON Schema Draft 8"] = 418,
    ...
    ["JSON-API"] = 216,
    ["JSON-e templates"] = 473,
    ["JSON-stat 2.0"] = 413,
    JSONPatch = 220,
    Jasmine = 205,
    Jekyll = 206,
    ["Jenkins X Pipelines"] = 207,
    ["Jenkins X Requirements"] = 208,
    ["Jovo Language Models"] = 210,
    ["KSP-AVC"] = 414,
    ["KSP-CKAN"] = 415,
    KrakenD = 223,
    ["LinkML Metamodel"] = 234,
    Liquibase = 480,
    Markdownlint = 483,
    ["MegaLinter configuration"] = 238,
    ["MegaLinter descriptor"] = 239,
    ["Meltano plugin discovery definition"] = 241,
    ["Meltano project definition"] = 240,
    ["Microsoft Band Web Tile"] = 242,
    ["Minecraft Data Pack Advancement"] = 244,
    ["Minecraft Data Pack Biome"] = 245,
    ["Minecraft Data Pack Configured Carver"] = 246,
    ["Minecraft Data Pack Dimension"] = 248,
    ["Minecraft Data Pack Dimension Type"] = 247,
    ["Minecraft Data Pack Item Modifier"] = 249,
    ["Minecraft Data Pack Loot Table"] = 250,
    ["Minecraft Data Pack Metadata"] = 251,
    ["Minecraft Data Pack Predicate"] = 252,
    ["Minecraft Data Pack Recipe"] = 253,
    ["Minecraft Data Pack Template Pool"] = 254,
    ["Minecraft Resourcepack Sounds"] = 255,
    ["Netin Diagnostic System Template"] = 487,
    ["Netlify config schema"] = 260,
    ["Nightwatch.js"] = 261,
    ["OSS Review Toolkit curation"] = 282,
    ["OSS Review Toolkit package configuration"] = 283,
    ["OSS Review Toolkit repository configuration"] = 284,
    ["OSS Review Toolkit resolutions"] = 285,
    Opctl = 436,
    ["OpenWeather Current Weather API"] = 472,
    ["OpenWeather Road Risk API"] = 471,
    ["Ory Hydra configuration"] = 198,
    ["Ory Keto configuration"] = 225,
    ["Ory Kratos configuration"] = 281,
    ["Ory Oathkeeper configuration"] = 273,
    ["Outblocks App configuration"] = 279,
    ["Outblocks database table"] = 280,
    ["Outblocks project configuration"] = 278,
    Packer = 288,
    ["Pipeline component"] = 481,
    ["PocketMine plugin.yml"] = 292,
    Pterodactyl = 519,
    ["Pull Request Labeler"] = 315,
    Qodana = 495,
    ["Quali Torque Blueprint Spec 2"] = 517,
    ["RKE Cluster Configuration JSON Schema"] = 479,
    ["RKE Cluster Configuration YAML Schema"] = 478,
    Ray = 448,
    ["Read the Docs"] = 318,
    ["Red-DiscordBot Cog"] = 319,
    ["Red-DiscordBot Cog Repo"] = 320,
    Renovate = 325,
    RoadRunner = 326,
    SWADL = 370,
    ["Sapphire CLI Config"] = 327,
    ["SauceCTL Configuration"] = 484,
    ["Schema Catalog"] = 340,
    ["Scoop manifest"] = 345,
    ["Semgrep Rule"] = 347,
    ["Serverless Framework Configuration"] = 491,
    ["Settings.paf"] = 349,
    ["Shopware 6 Configuration"] = 492,
    ["Shopware CLI Extension Store Configuration"] = 493,
    ["Shopware CLI Project Store Configuration"] = 494,
    Solidarity = 354,
    ["Source Maps v3"] = 355,
    SpecIF = 356,
    ["Sponge Mixin configuration"] = 357,
    ["StackHawk Scanner Configuration"] = 490,
    ["StackHead CLI config"] = 361,
    ["StackHead module configuration"] = 362,
    ["StackHead project definition"] = 363,
    Stale = 364,
    Starship = 365,
    ["Statamic Blueprint"] = 366,
    ["Stryker Mutator"] = 367,
    ["StyleCop Analyzers Configuration"] = 368,
    ["Swagger API 2.0"] = 371,
    ["Taskfile YAML Schema"] = 474,
    Taurus = 372,
    ["TestEnvironment.json"] = 378,
    Tikibase = 375,
    ["Traefik v2"] = 380,
    ["Traefik v2 File Provider"] = 381,
    Tye = 496,
    ["UI5 Manifest"] = 393,
    ["Ubuntu Server Autoinstall"] = 391,
    ["Uniswap Token List"] = 457,
    Updatecli = 503,
    ["User Journey Map YAML Schema"] = 477,
    V2Ray = 507,
    ["VSCode Code Snippets"] = 90,
    ["VSIX CLI publishing"] = 405,
    ["Vela Pipeline Configuration"] = 397,
    Vercel = 89,
    ["Web App Manifest"] = 409,
    ["Web types"] = 412,
    WebExtensions = 408,
    ["Webman package recipe"] = 513,
    ["Windows Package Manager Installer Manifest"] = 454,
    ["Windows Package Manager Locale Manifest"] = 455,
    ["Windows Package Manager Singleton Manifest"] = 453,
    ["Woodpecker pipeline config"] = 486,
    ["Xstate Machine Schema"] = 501,
    ["Yippee-Ki-JSON configuration YML"] = 459,
    ["angular.json"] = 8,
    ...
    devinit = 461,
    ["docfx.json"] = 128,
    ["docker-compose.yml"] = 460,
    ["dockerd.json"] = 127,
    ["dotnet Release Index manifest"] = 137,
    ["dotnetcli.host.json"] = 138,
    ["drone.json"] = 139,
    ["dss-2.0.0.json"] = 141,
    ["dvc.yaml"] = 142,
    ["ecosystem.json"] = 144,
    eksctl = 145,
    ["electron-builder configuration file."] = 150,
    ["epr-manifest.json"] = 148,
    ["evcc.yaml"] = 151,
    ["fabric.mod.json"] = 155,
    ["first-timers-bot"] = 158,
    fulibWorkflows = 485,
    ["func.yaml"] = 163,
    ["function.json"] = 164,
    ["geojson.json"] = 167,
    ["gitlab-ci"] = 175,
    ["global.json"] = 177,
    ["golangci-lint Configuration"] = 178,
    ["haxelib.json"] = 191,
    helmfile = 450,
    ["host-meta.json"] = 196,
    ["host.json"] = 195,
    ...
    huskyrc = 430,
    ["ide.host.json"] = 199,
    ["imageoptimizer.json"] = 200,
    ["importmap.json"] = 202,
    ["ioBroker JSON UI"] = 203,
    ["ioBroker Package manifest"] = 204,
    ["jsconfig.json"] = 221,
    ["jscpd Configuration Schema"] = 518,
    jsdoc = 447,
    ["k3d.yaml"] = 222,
    ["kustomization.yaml"] = 226,
    ["label-commenter-config.yml"] = 227,
    ["launchsettings.json"] = 228,
    ["lerna.json"] = 229,
    ["lgtm.yml"] = 230,
    ["libman.json"] = 231,
    ["license-report-config.json"] = 232,
    ["linkinator.config.json"] = 233,
    ["local.settings.json"] = 235,
    ["localazy.json"] = 236,
    ["lsdlschema.json"] = 237,
    mboats = 489,
    ["mimetypes.json"] = 243,
    ...
    ["mtad.yaml"] = 433,
    ["mycode.json"] = 258,
    ["napari plugin manifest"] = 259,
    neoload = 442,
    ["nest-cli"] = 264,
    ["ninjs (News in JSON) 1.3"] = 263,
    ["ninjs (News in JSON) 2.0"] = 262,
    ["nlu.json"] = 265,
    ["nodemon.json"] = 267,
    ["noodl.schema.json"] = 488,
    now = 438,
    ["nswag.json"] = 271,
    ntangle = 272,
    ["nuclei-template.yaml"] = 269,
    ["nuget-project.json"] = 270,
    ["ocelot.json"] = 274,
    ["omnisharp.json"] = 275,
    ["openapi.json"] = 276,
    ["openfin.json"] = 277,
    ["package.json"] = 286,
    ["package.manifest"] = 287,
    ["pattern.json"] = 290,
    pgap_yaml_input_reader = 289,
    ["plagiarize-me.yaml"] = 294,
    ["plagiarize.yaml"] = 293,
    ["portman.json"] = 295,
    ["prettierrc.json"] = 300,
    ["prisma.yml"] = 301,
    ["project-1.0.0-beta3.json"] = 303,
    ["project-1.0.0-beta4.json"] = 304,
    ["project-1.0.0-beta5.json"] = 305,
    ["project-1.0.0-beta6.json"] = 306,
    ["project-1.0.0-beta8.json"] = 307,
    ["project-1.0.0-rc1.json"] = 308,
    ["project-1.0.0-rc2.json"] = 309,
    ["project.json"] = 302,
    ["prometheus.json"] = 310,
    ["prometheus.rules.json"] = 311,
    ["proxies.json"] = 312,
    ["publiccode.yml"] = 313,
    ["pubspec.yaml"] = 314,
    ["pyrseas-0.8.json"] = 317,
    ["release drafter"] = 443,
    ["sarif-1.0.0.json"] = 328,
    ["sarif-2.0.0.json"] = 329,
    ["sarif-2.1.0"] = 338,
    ["sarif-2.1.0-rtm.2"] = 330,
    ["sarif-2.1.0-rtm.3"] = 332,
    ["sarif-2.1.0-rtm.4"] = 334,
    ["sarif-2.1.0-rtm.5"] = 336,
    ["sarif-external-property-file-2.1.0"] = 339,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 331,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 333,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 335,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 337,
    ["schema.org - Action"] = 341,
    ["schema.org - ContactPoint"] = 342,
    ["schema.org - Place"] = 343,
    ["schema.org - Thing"] = 344,
    ["semantic-release"] = 346,
    ["servicehub.config.json"] = 422,
    ["servicehub.service.json"] = 421,
    ["settings.job"] = 348,
    ["sfdx-hardis configuration"] = 350,
    ["size-limit configuration"] = 351,
    ["skaffold.yaml"] = 482,
    ["skyuxconfig.json"] = 352,
    snapcraft = 353,
    swcrc = 470,
    taskcat = 439,
    ["template.json"] = 373,
    ["templatsources.json"] = 374,
    ["theme.json"] = 376,
    tmLanguage = 377,
    ["trunk.yaml schema"] = 382,
    ["ts-force-config.json"] = 386,
    ["tsconfig.json"] = 383,
    ["tsd.json"] = 384,
    ["tsdrc.json"] = 385,
    ["tslint.json"] = 387,
    ...
    ["version.json"] = 398,
    ["vim-addon-info"] = 399,
    ["vs-2017.3.host.json"] = 401,
    ["vs-nesting.json"] = 402,
    ["vsls.json"] = 400,
    ["vss-extension.json"] = 406,
    ["webhint.io"] = 514,
    ["webjobpublishsettings.json"] = 411,
    ["webjobs-list.json"] = 410,
    ["xs-app.json"] = 435,
    ["xunit.runner.json"] = 420,
    yamllint = 458,
    zuul = 444,
    ["Žinoma"] = 452
  },
