...
M.json = {
  ...
  index = {
    ...
    AIConfig = 48,
    ["AMX Muse Program Descriptor"] = 1334,
    ["API Builder"] = 1140,
    ["AVA Configuration"] = 1204,
    ...
    ["AWS Copilot Manifest"] = 1373,
    ["AWS SAM CLI Samconfig"] = 322,
    Acton = 1427,
    ["Adobe UXP Manifest"] = 1267,
    ["Aerleon Network & Service Definitions"] = 30,
    ["Aerleon Policy"] = 31,
    ["Agent Permission Policy"] = 1413,
    ["AgentCore CLI"] = 1414,
    ["AgentCtl MCP"] = 1416,
    ["AgentCtl config"] = 1415,
    ["AgentCtl permissions"] = 1417,
    AgentLoopKit = 1418,
    Aider = 1363,
    Air = 33,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1384,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1383,
    ["Airlock Microgateway"] = 49,
    ["Alacritty Configuration"] = 1176,
    ["AlgoVoi Compliance Receipt v1"] = 19,
    ["All Contributors configuration file"] = 1230,
    ...
    ["Application list for a WinUtil"] = 1313,
    ["ArchSmith diagram IR"] = 1456,
    ArchitectFX = 1318,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1382,
    ["Azure IoT Operations connector metadata"] = 1379,
    ...
    Badness = 149,
    ["Barba-CV"] = 103,
    ["Bashly (bashly.yml)"] = 1234,
    ["Bashly Settings (bashly-settings.yml)"] = 1235,
    Bento = 1400,
    ["Better Code Hub"] = 1145,
    ["Better Scripts"] = 192,
    Bigconfig = 158,
    ["Biome Formatter Config"] = 104,
    ["Bitmovin Encoding Template"] = 1327,
    BizTalkServerApplicationSchema = 1111,
    Bleep = 193,
    ["Block Protocol Metadata"] = 190,
    ["Bluebricks blueprint config"] = 1406,
    ["Boyka Framework"] = 171,
    ...
    ["Butane Config"] = 1189,
    C4InterFlow = 1342,
    ["CDK Environment Manager, concrete environment configuration"] = 1366,
    ["CDK Environment Manager, concrete environments definition"] = 1365,
    ["CDK Environment Manager, environment definition"] = 1364,
    ["CGS Card Game Specification (cgs.json)"] = 1272,
    ["CICS TS region tagging"] = 1198,
    ["CICS TS resource import"] = 1199,
    ["CICS TS resource model"] = 1200,
    ["CICS TS resource overrides"] = 1201,
    ["CMake Presets"] = 194,
    ["CNC Codes"] = 218,
    ["CRS WAF test file"] = 1302,
    ["CRS WAF test platform overrides file"] = 1303,
    ...
    ["Caido Proxy Configuration"] = 1442,
    ...
    ["Chamaleon environment"] = 1331,
    ["Chamaleon properties"] = 1332,
    ["Chamaleon template"] = 1330,
    Changepacks = 1393,
    Changesets = 331,
    Changie = 203,
    Charmcraft = 204,
    ...
    ["Claude Code Launch Preview"] = 1455,
    ["Claude Code Plugin Manifest"] = 226,
    ["Claude Code Plugin Marketplace"] = 227,
    ["Claude Code Settings"] = 228,
    ["Clawject config"] = 224,
    ["Cloud Foundry Application Manifest"] = 1284,
    ["Cloud Run Spec v1"] = 1308,
    ...
    Concord = 1301,
    ["Configu .cfgu files"] = 1289,
    ["Configu .configu file"] = 1290,
    Conjure = 217,
    ["Container Structure Test"] = 1125,
    Containerlab = 1154,
    ["Context Passport"] = 2,
    ["Context Reasoning Format (CRF)"] = 215,
    ["Contextive Glossary"] = 1358,
    ContractGuard = 1155,
    Convex = 216,
    ...
    ["Cursor Agent Environment"] = 1411,
    ["Custom Machinery Machine"] = 1273,
    ["Custom Machinery Recipe"] = 1274,
    ...
    ["DonateCaseBetterCasino menu"] = 1335,
    ["Draugr Saga"] = 363,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1242,
    ["EAS config"] = 438,
    ["ECA - Editor Code Assistant"] = 401,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1231,
    ["ESLint Suppressions"] = 443,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1378,
    ["EasyVCR .NET"] = 440,
    ["Eidolon Resource"] = 1319,
    ...
    ["Envelope Team Definition"] = 1426,
    ["Envilder Map File"] = 406,
    ["Erda Pipeline"] = 1280,
    ["Erda Runtime"] = 1281,
    ["Espanso config.yml"] = 1404,
    ["Espanso match.yml"] = 1403,
    Esquio = 426,
    ["Estuary Flow Catalog"] = 1195,
    ["Ethereum ERC1155"] = 1420,
    ["Ethereum ERC721"] = 1419,
    ...
    ["Evolving Resolutive Process notation"] = 1380,
    ["Expo SDK"] = 437,
    ...
    ["GeoJSON.json latest"] = 1193,
    GherKing = 1197,
    ["GitHub Action"] = 481,
    ["GitHub Actions typing"] = 1315,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 1269,
    ...
    ["Google Digital Assetlinks"] = 1359,
    Goreleaser = 517,
    ["Goreleaser Pro"] = 518,
    Goss = 520,
    ["Gradle Build Cache Node"] = 1143,
    ["Gradle Enterprise"] = 1142,
    ...
    HEMTT = 1107,
    ["HULL - Helm Uniform Layer Library"] = 1460,
    Hadolint = 1121,
    Hammerkit = 1153,
    ["Hardware Sentry Configuration"] = 1209,
    ...
    ["Hecate Input Schema"] = 1370,
    ["Helm Chart.lock"] = 281,
    ["Helm Chart.yaml"] = 280,
    ["Helm Unittest Test Suite"] = 282,
    ["Heloisa Assistant Plugins Marketplace"] = 1453,
    ["Hex file"] = 283,
    ...
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1252,
    ["JSON Schema Draft 7"] = 1084,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1253,
    ["JSON Schema Draft 8 (2019-09)"] = 1085,
    ["JSON-API"] = 588,
    ["JSON-e templates"] = 1150,
    ["JSON-stat 2.0"] = 1079,
    JSONPatch = 592,
    ...
    Jsontron = 593,
    ["Jujutsu (jj) VCS config"] = 1372,
    ["KIMMDY config file"] = 604,
    ["KODE/CI build.yaml"] = 1215,
    ["KSP-AVC"] = 1080,
    ["KSP-CKAN"] = 1081,
    ["KSP-NetKAN"] = 1082,
    KSY = 1282,
    ...
    ["Kong DBLess config"] = 1216,
    KrakenD = 608,
    ["Kubri Configuration"] = 616,
    LOOBin = 635,
    ["Lake configuration file"] = 1375,
    ...
    ["Lando (landofile)"] = 130,
    ["LangGraph Platform configuration"] = 1294,
    ["Language configuration"] = 1293,
    Lefthook = 621,
    ...
    ["Madness (madness.yml)"] = 1233,
    ["Mado configuration"] = 642,
    ["Maestro Flow"] = 643,
    ["Mail Servers Configuration"] = 1407,
    ["MapEHR Mapping"] = 644,
    Markdownlint = 1164,
    ["Mason Registry"] = 1167,
    ...
    ["Metadata for a Cinnamon spice"] = 1311,
    ["Metatype Configuration"] = 651,
    ["MetricsHub Configuration"] = 652,
    ["MetricsHub Connector Configuration"] = 653,
    ["Micro Editor Syntax"] = 1243,
    ["Microsoft Band Web Tile"] = 654,
    ["Microsoft RulesEngine workflow rules"] = 1298,
    ["Microsoft RulesEngine workflow rules list"] = 1299,
    ["Minecraft Custom Main Menu Mod"] = 1261,
    ...
    ["MongoDB Atlas Search Index Definition"] = 1214,
    ["Monika Configuration"] = 1212,
    ["Monoweave Configuration"] = 685,
    ["Motif config"] = 1103,
    MultiQC = 1352,
    ["NOX Framework (Service)"] = 713,
    ["Netin Diagnostic System Template"] = 1171,
    ["Netlify config"] = 694,
    ...
    ["Nightwatch.js"] = 705,
    ["Nika workflow"] = 710,
    ["Node.js configuration"] = 1108,
    ["NueJS configuration file"] = 718,
    ["Nuitka Package Config"] = 1275,
    ...
    ["OpenUtau ustx"] = 739,
    ["OpenWeather Current Weather API"] = 1149,
    ["OpenWeather Road Risk API"] = 1148,
    ...
    ["Pipeline component"] = 1162,
    ["Platform.sh application"] = 15,
    ["Platform.sh routes"] = 16,
    ["Platform.sh services"] = 17,
    ["Plex Prerolls"] = 785,
    ["PocketMine plugin.yml"] = 782,
    ["Podman Desktop Extension"] = 1444,
    ["Postman collection"] = 791,
    ["Power Pages Configuration"] = 1369,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1314,
    ...
    Pylock = 1360,
    Pyright = 839,
    ["Python script metadata"] = 1354,
    ["QType AI DSL"] = 842,
    Qgoda = 841,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1436,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1434,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1440,
    ["Qlik Talend Cloud Pipeline - Project"] = 1432,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1435,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1437,
    ["Qlik Talend Cloud Pipeline - Task"] = 1433,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1439,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1438,
    Qodana = 1181,
    ["Qt Creator workspace file"] = 1291,
    ["Quali Torque Blueprint Spec 2"] = 1206,
    ["QueryFirst config file"] = 1225,
    ["QuikRun Configuration"] = 1441,
    ["Qwen Code Settings"] = 1421,
    ["RKE Cluster Configuration JSON"] = 1159,
    ["RKE Cluster Configuration YAML"] = 1158,
    RadioHound = 832,
    ["Raid Profile"] = 1422,
    ["Raid Repo Configuration"] = 1423,
    Railpack = 844,
    Railway = 843,
    ["Rancher Fleet"] = 834,
    ["Rattler-build"] = 845,
    ...
    ["Replit config"] = 860,
    Restate = 1347,
    ["Revel Digital Gadget Definition File"] = 1371,
    RoadRunner = 874,
    ["Robust Station Image"] = 1377,
    Rockcraft = 875,
    ["Roo Coder Custom Modes"] = 876,
    Rubocop = 865,
    ["Rudder techniques"] = 1265,
    Ruff = 866,
    ["Rust Project"] = 867,
    ["Rust toolchain"] = 881,
    ...
    ["Serverless Framework Configuration"] = 1175,
    ["Serverless Workflow"] = 1177,
    ["Settings for a Cinnamon spice"] = 1310,
    ["Settings.paf"] = 915,
    ["Shopware 6 Configuration"] = 1178,
    ["Shopware CLI Extension Store Configuration"] = 1179,
    ["Shopware CLI Project Store Configuration"] = 1180,
    ["Sigma Detection Rule"] = 917,
    ["SigmaCV CV"] = 7,
    ["Sigrid scope configuration file"] = 918,
    ["SkyPilot Task JSON"] = 1266,
    ["Slack app manifest"] = 925,
    ["Slang Server Configuration"] = 1448,
    Snapcraft = 927,
    ...
    StackBlitz = 966,
    ["StackHawk Scanner Configuration"] = 1174,
    Stale = 967,
    Starfish = 968,
    ["Starlake Data Pipeline"] = 1146,
    Starship = 969,
    ...
    ["Tab data for a LinUtil"] = 1317,
    ["Tab list for a LinUtil"] = 1316,
    Tach = 985,
    ["Tach Domain"] = 986,
    Talhelper = 988,
    ["Talisman configuration"] = 989,
    Taplo = 1362,
    ["Taskfile config"] = 1151,
    Taurus = 990,
    Tauticord = 991,
    ["Tekton Pipeline"] = 1390,
    ["Tekton PipelineRun"] = 1391,
    ["Tekton Task"] = 1388,
    ["Tekton TaskRun"] = 1389,
    Telefonistka = 1348,
    ...
    ["Tugboat QA config.yml"] = 1341,
    TunnelHub = 1256,
    Turborepo = 1009,
    Tycho = 1305,
    Tye = 1182,
    ["Tyk Gateway - Open Source v5.7+"] = 1353,
    ["UET BuildConfig.json"] = 1226,
    ["UI5 Manifest"] = 1040,
    ["UNCORS configuration"] = 1045,
    ["UTAM Page Object"] = 1043,
    ["Ubuntu Server Autoinstall"] = 1038,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1345,
    ["Uniswap Token List"] = 1131,
    ["Universal Schedule Format"] = 1046,
    ["Unreal Engine Uplugin"] = 1227,
    ["Unreal Engine Uproject"] = 1228,
    ["UpCloud CLI (upctl) configuration"] = 1346,
    ["Updatecli Compose"] = 1190,
    ["Updatecli Policy Manifest"] = 1191,
    ["Updatecli Policy Metadata"] = 1192,
    Uplift = 1224,
    ["Upsun config"] = 14,
    ["User Journey Map"] = 1156,
    V2Ray = 1196,
    ...
    Vespertide = 1395,
    ["Vespertide Migration"] = 1396,
    ["Vespertide Model"] = 1397,
    ["Viash Component Config"] = 1350,
    ["Viash Package Config"] = 1351,
    Visivo = 1254,
    Vogi = 1060,
    ["WP-CLI"] = 1076,
    Wake = 1343,
    ...
    ["Web types"] = 1075,
    WebExtensions = 1071,
    ["Webman package recipe"] = 1202,
    ["Windows Package Manager Installer Manifest"] = 1128,
    ["Windows Package Manager Locale Manifest"] = 1129,
    ["Windows Package Manager Singleton Manifest"] = 1127,
    ["WireMock CLI import configuration"] = 1326,
    ["WireMock CLI local service configuration"] = 1325,
    ["WireMock message stub mapping"] = 1324,
    ["WireMock stub mapping"] = 1323,
    ["Woodpecker pipeline config"] = 1170,
    ["Wrangler CLI"] = 1077,
    ["XenForo add-on manifest"] = 1078,
    ["Xstate Machine"] = 1188,
    ["Yandex Workflow Language"] = 1312,
    ["Yarn Config (.yarnrc.yml)"] = 1144,
    ["Yippee-Ki-JSON configuration YML"] = 1135,
    ["YouTrack App"] = 1309,
    ["Zarf Package Configuration"] = 1376,
    ["Zerops import file"] = 1297,
    ["Zola Configuration"] = 1387,
    abtop = 35,
    act3 = 1428,
    actionlint = 45,
    ["aerleon.yml"] = 29,
    ["amplify.yml"] = 22,
    ["amxx-builder manifest"] = 1443,
    ["angular.json"] = 50,
    apko = 1259,
    ...
    ["behat.yml"] = 172,
    ["bigquery-table"] = 157,
    ["bioimageio resource description"] = 1276,
    ...
    ["chutzpah.json"] = 314,
    cibuildwheel = 210,
    ["clang-format (.clang-format)"] = 1194,
    ["clang-tidy"] = 289,
    clangd = 288,
    clib = 290,
    ...
    ["crowdin.yml"] = 341,
    crucible = 345,
    ["ctfd-setup configuration file"] = 1333,
    ["custom-elements.json"] = 1246,
    ["cypress.json"] = 346,
    ["dacier.yml"] = 1431,
    ...
    ["gematik health care insurance list"] = 1339,
    ["gematik health care patient list"] = 1336,
    ["gematik health care provider institution list"] = 1338,
    ["gematik health care provider list"] = 1337,
    ["gematik tiger test environment configuration"] = 1340,
    ["gh-dash"] = 479,
    ["gha-doctor"] = 480,
    ["git-cliff"] = 476,
    ["git-town.toml"] = 1385,
    ...
    lychee = 1094,
    ["macro.json"] = 1211,
    ["markdown-link-check"] = 1165,
    maturin = 1166,
    mboats = 1173,
    memnex = 1429,
    ["micro-settings.json"] = 1238,
    ["mimetypes.json"] = 655,
    ["mirrord config"] = 1098,
    ["misata.yaml"] = 1097,
    mise = 1099,
    ...
    ["mkdocs.yml"] = 675,
    ["mockd.yaml"] = 679,
    ["mod.pw.toml (packwiz)"] = 1446,
    ["modelparams.dev Model"] = 682,
    ["models CLI"] = 683,
    ["monospace.yml"] = 684,
    ["moon.yml"] = 1322,
    ["mprocs Configuration file"] = 1292,
    ["mrdocs.yml"] = 677,
    ["mta.yaml"] = 1101,
    ["mtad.yaml"] = 1102,
    ["mycode.json"] = 692,
    ...
    ["plagiarize.yaml"] = 783,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1329,
    ["podbard.yaml"] = 786,
    ["portman.json"] = 789,
    ["prefect.toml"] = 798,
    ["prefect.yaml"] = 799,
    ...
    ["text2confl config"] = 1410,
    ["theme.json"] = 1001,
    ["tizen_workspace.json"] = 1003,
    tldr = 1004,
    ["tm_devices configuration file"] = 1367,
    tmuxinator = 1092,
    tox = 1006,
    ["transcend.yml"] = 1015,
    ...
    ["vtesttree.yaml"] = 1068,
    ["vtestunit.yaml"] = 1069,
    ["warp-keysets.json"] = 1247,
    ["warp-themes.json"] = 1248,
    ["warp-workflows.json"] = 1249,
    ["webhint.io"] = 1203,
    ["webjobpublishsettings.json"] = 1074,
    ["webjobs-list.json"] = 1073,
    ["well-known-fursona"] = 1287,
    ["xs-app.json"] = 1105,
