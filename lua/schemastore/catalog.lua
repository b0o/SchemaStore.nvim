...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 860,
    [".nodehawkrc"] = 524,
    [".npmpackagejsonlintrc"] = 528,
    [".omletrc"] = 1036,
    [".phrase.yml"] = 591,
    [".phraseapp.yml"] = 592,
    [".pmbot.yml"] = 579,
    [".postcssrc"] = 586,
    [".powerpages-web-template-manifest"] = 588,
    [".pre-commit-config.yml"] = 589,
    [".pre-commit-hooks.yml"] = 590,
    [".putout.json"] = 619,
    [".rehyperc"] = 643,
    [".remarkrc"] = 647,
    [".sprite files"] = 734,
    ...
    ["A micro editor config"] = 475,
    ABCInventoryModuleData = 18,
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1081,
    ["API Builder"] = 895,
    ["AVA Configuration"] = 957,
    ...
    ["AWS Copilot Manifest"] = 1120,
    ["AWS SAM CLI Samconfig"] = 224,
    ["Adobe UXP Manifest"] = 1019,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1110,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 929,
    ["All Contributors configuration file"] = 982,
    ...
    ["Application list for a WinUtil"] = 1063,
    ArchitectFX = 1068,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure IoT Operations connector metadata"] = 1126,
    ...
    ["Azure Pipelines"] = 79,
    ["Azure Static Web Apps CLI configuration file"] = 738,
    ["Azure Static Web Apps configuration file"] = 737,
    ["BOSH CPI Config"] = 103,
    ["BOSH Deploy Config"] = 104,
    ["BX CI"] = 123,
    ["Bashly (bashly.yml)"] = 986,
    ["Bashly Settings (bashly-settings.yml)"] = 987,
    ["Better Code Hub"] = 899,
    ["Better Scripts"] = 124,
    Bigconfig = 96,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1074,
    BizTalkServerApplicationSchema = 867,
    Bleep = 125,
    ...
    ["Butane Config"] = 942,
    C4InterFlow = 1089,
    ["CDK Environment Manager, concrete environment configuration"] = 1113,
    ["CDK Environment Manager, concrete environments definition"] = 1112,
    ["CDK Environment Manager, environment definition"] = 1111,
    ["CGS Card Game Specification (cgs.json)"] = 1024,
    ["CICS TS region tagging"] = 951,
    ["CICS TS resource import"] = 952,
    ["CICS TS resource model"] = 953,
    ["CICS TS resource overrides"] = 954,
    ["CMake Presets"] = 126,
    ["CNC Codes"] = 147,
    ["CRS WAF test file"] = 1053,
    ["CRS WAF test platform overrides file"] = 1054,
    ...
    ["Chamaleon environment"] = 1078,
    ["Chamaleon properties"] = 1079,
    ["Chamaleon template"] = 1077,
    Changesets = 233,
    Changie = 135,
    Charmcraft = 136,
    Cheatsheets = 939,
    ...
    ["Clawject config"] = 153,
    ["Cloud Foundry Application Manifest"] = 1035,
    ["Cloud Run Spec v1"] = 1058,
    ...
    Concord = 1052,
    ["Configu .cfgu files"] = 1040,
    ["Configu .configu file"] = 1041,
    Conjure = 146,
    ["Container Structure Test"] = 881,
    Containerlab = 908,
    ["Contextive Glossary"] = 1105,
    Convex = 145,
    ["Crowdsec collection config"] = 243,
    ["Crowdsec parser config"] = 244,
    ["Crowdsec scenario config"] = 245,
    ["CumulusCI Config"] = 152,
    ["Custom Machinery Machine"] = 1025,
    ["Custom Machinery Recipe"] = 1026,
    ...
    ["DataYoga Job"] = 159,
    ["Databricks Asset Bundles"] = 1003,
    ["Datadog Continuous Testing"] = 447,
    ["Datadog Service Definition"] = 448,
    ["Datadog Software Catalog"] = 449,
    ["Datahub Ingestion Recipe"] = 958,
    ...
    ["DonateCaseBetterCasino menu"] = 1082,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 994,
    ["EAS config"] = 309,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 983,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1125,
    ["EasyVCR .NET"] = 310,
    ["Eidolon Resource"] = 1069,
    ...
    ["GeoJSON.json latest"] = 946,
    GherKing = 950,
    ["GitHub Action"] = 340,
    ["GitHub Actions typing"] = 1065,
    ...
    ["Google Digital Assetlinks"] = 1106,
    Goreleaser = 368,
    ["Goreleaser Pro"] = 369,
    Goss = 370,
    ["Gradle Build Cache Node"] = 897,
    ["Gradle Enterprise"] = 896,
    ["Grafana 5.x Dashboard"] = 371,
    ["GraphQL Code Generator"] = 375,
    ["GraphQL Config"] = 374,
    ["GraphQL Mesh"] = 373,
    ["Grunt JSHint task"] = 379,
    ["Grunt Watch task"] = 380,
    ["Grunt base task"] = 381,
    ["Grunt clean task"] = 377,
    ["Grunt copy task"] = 376,
    ["Grunt cssmin task"] = 378,
    HEMTT = 863,
    Hadolint = 877,
    Hammerkit = 907,
    ["Hardware Sentry Configuration"] = 962,
    ["HashiCorp Vault"] = 382,
    Hatch = 878,
    Hayagriva = 384,
    Hayson = 385,
    ["Haystack Pipeline"] = 386,
    ["Hazelcast 5 Configuration"] = 387,
    ["Hecate Input Schema"] = 1117,
    ["Helm Chart.lock"] = 188,
    ["Helm Chart.yaml"] = 187,
    ["Helm Unittest Test Suite"] = 189,
    ["Home Assistant Integration Manifest"] = 388,
    ["Homer dashboard configuration"] = 389,
    Hugo = 938,
    ["Hugo Theme"] = 937,
    ["Hyperfoil benchmark configuration"] = 395,
    ["IBM Zapp document"] = 396,
    ["IBM zCodeFormatSettings"] = 397,
    ["IMG Catapult PSP"] = 402,
    ["IVMS101 by CODE Protocol"] = 1022,
    Infrahub = 404,
    Istanbul = 965,
    ["JDownloader2 crawler multi-rules"] = 414,
    ["JDownloader2 crawler single-rules"] = 413,
    ["JFrog Applications Config"] = 415,
    ["JFrog File Spec"] = 416,
    ["JFrog Pipelines YML DSL"] = 971,
    ["JMeter DSL cli config"] = 417,
    JReleaser = 420,
    ["JSON Document Transform"] = 428,
    ["JSON Feed"] = 429,
    ["JSON Resume"] = 653,
    ["JSON Schema Draft 2020-12"] = 845,
    ["JSON Schema Draft 4"] = 842,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1004,
    ["JSON Schema Draft 7"] = 843,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1005,
    ["JSON Schema Draft 8 (2019-09)"] = 844,
    ["JSON-API"] = 427,
    ["JSON-e templates"] = 904,
    ["JSON-stat 2.0"] = 838,
    JSONPatch = 431,
    ["JSR Package Config (jsr.json)"] = 421,
    Jasmine = 408,
    Jekyll = 409,
    ["Jenkins X Pipelines"] = 410,
    ["Jenkins X Requirements"] = 411,
    Jest = 412,
    Jocker = 418,
    ["Jovo Language Models"] = 419,
    ["Jujutsu (jj) VCS config"] = 1119,
    ["KIMMDY config file"] = 442,
    ["KODE/CI build.yaml"] = 967,
    ["KSP-AVC"] = 839,
    ["KSP-CKAN"] = 840,
    ["KSP-NetKAN"] = 841,
    KSY = 1034,
    ...
    Kas = 434,
    ["Kestra flow file"] = 443,
    ["Keycloak REST API"] = 974,
    ["Knative Functions - func.yaml"] = 329,
    ["Kometa (nightly) config file"] = 445,
    ["Kometa config file"] = 444,
    ["Kong DBLess config"] = 968,
    KrakenD = 446,
    ["Kubri Configuration"] = 453,
    LOOBin = 468,
    ["Lake configuration file"] = 1122,
    ...
    ["Lando (landofile)"] = 75,
    ["LangGraph Platform configuration"] = 1045,
    ["Language configuration"] = 1044,
    Lefthook = 457,
    ["Liferay client-extension.yaml"] = 464,
    ["LinkML Metamodel"] = 466,
    Liquibase = 913,
    ["Liquibase Flow File"] = 914,
    ["Lively Properties"] = 467,
    ["Lobe AI Agent"] = 77,
    Loki = 78,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 507,
    ["MS2Rescore Configuration"] = 510,
    ["Madness (madness.yml)"] = 985,
    ["MapEHR Mapping"] = 474,
    Markdownlint = 917,
    ["Mason Registry"] = 920,
    ["MegaLinter Custom Flavor"] = 477,
    ["MegaLinter configuration"] = 476,
    ["MegaLinter descriptor"] = 478,
    Melange = 1012,
    ["Meltano project definition"] = 479,
    ["Mergify Configuration"] = 511,
    ["Metadata for a Bazel module"] = 480,
    ["Metadata for a Cinnamon spice"] = 1061,
    ["Metatype Configuration"] = 481,
    ["MetricsHub Configuration"] = 482,
    ["MetricsHub Connector Configuration"] = 483,
    ["Micro Editor Syntax"] = 995,
    ["Microsoft Band Web Tile"] = 484,
    ["Microsoft RulesEngine workflow rules"] = 1049,
    ["Microsoft RulesEngine workflow rules list"] = 1050,
    ["Minecraft Custom Main Menu Mod"] = 1013,
    ["Minecraft Data Pack Advancement"] = 486,
    ["Minecraft Data Pack Biome"] = 487,
    ["Minecraft Data Pack Configured Carver"] = 488,
    ["Minecraft Data Pack Damage Type"] = 489,
    ["Minecraft Data Pack Dimension"] = 491,
    ["Minecraft Data Pack Dimension Type"] = 490,
    ["Minecraft Data Pack Item Modifier"] = 492,
    ["Minecraft Data Pack Loot Table"] = 493,
    ["Minecraft Data Pack Metadata"] = 494,
    ["Minecraft Data Pack Predicate"] = 495,
    ["Minecraft Data Pack Recipe"] = 496,
    ["Minecraft Data Pack Tag"] = 497,
    ["Minecraft Data Pack Template Pool"] = 498,
    ["Minecraft Data Pack Trim Material"] = 503,
    ["Minecraft Data Pack Trim Pattern"] = 504,
    ["Minecraft Resource Pack Lang"] = 499,
    ["Minecraft Resource Pack Particle"] = 500,
    ["Minecraft Resource Pack Texture Mcmeta"] = 502,
    ["Minecraft Resourcepack Sounds"] = 501,
    ["Monade CLI Stack Configuration"] = 514,
    ["MongoDB Atlas Search Index Definition"] = 966,
    ["Monika Configuration"] = 964,
    ["Monoweave Configuration"] = 509,
    ["Motif config"] = 859,
    MultiQC = 1099,
    ["NOX Framework (Service)"] = 527,
    ["Netin Diagnostic System Template"] = 924,
    ["Netlify config"] = 517,
    ["Network-as-Code Data Model"] = 518,
    ["Nightwatch.js"] = 520,
    ["Node.js configuration"] = 864,
    ["NueJS configuration file"] = 532,
    ["Nuitka.yaml"] = 1027,
    ["Nullstone config"] = 534,
    ["ONe's changelog entry"] = 548,
    ["ONe's service descriptor"] = 547,
    ["ORT Server repository environment configuration"] = 556,
    ["OSCAL Assessment Plan (AP)"] = 558,
    ["OSCAL Assessment Results (AR)"] = 559,
    ["OSCAL Catalog"] = 560,
    ["OSCAL Component Definition (CDef)"] = 561,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 562,
    ["OSCAL Profile"] = 563,
    ["OSCAL System Security Plan (SSP)"] = 564,
    ["OSS Review Toolkit configuration"] = 565,
    ["OSS Review Toolkit curation"] = 566,
    ["OSS Review Toolkit package configuration"] = 567,
    ["OSS Review Toolkit repository configuration"] = 568,
    ["OSS Review Toolkit resolutions"] = 569,
    ["October CMS columns"] = 538,
    ["October CMS fields"] = 539,
    Okteto = 540,
    Opctl = 862,
    ["Open Data Contract Standard (ODCS)"] = 551,
    ["Open Data Product Standard (ODPS)"] = 552,
    ["Open Know-How"] = 1104,
    ["OpenRewrite Resource"] = 550,
    OpenStatus = 1115,
    ["OpenUtau character yaml"] = 544,
    ["OpenUtau ustx"] = 545,
    ["OpenWeather Current Weather API"] = 903,
    ["OpenWeather Road Risk API"] = 902,
    ["Ory Hydra configuration"] = 394,
    ["Ory Keto configuration"] = 450,
    ["Ory Kratos configuration"] = 557,
    ["Ory Oathkeeper configuration"] = 536,
    ["Outblocks App configuration"] = 554,
    ["Outblocks database table"] = 555,
    ["Outblocks project configuration"] = 553,
    PDM = 575,
    Packer = 572,
    Pantsbuild = 981,
    ["Paper paper-plugin.yml"] = 573,
    ["Pipeline component"] = 915,
    ["Platform.sh application"] = 2,
    ["Platform.sh routes"] = 3,
    ["Platform.sh services"] = 4,
    ["Plex Prerolls"] = 583,
    ["PocketMine plugin.yml"] = 580,
    ["Postman collection"] = 587,
    ["Power Pages Configuration"] = 1116,
    ["Preset list for a WinUtil"] = 1064,
    ["ProActions AI-Kit Configuration"] = 596,
    ["ProActions AI-Kit Configuration for Menus"] = 598,
    ["ProActions AI-Kit Configuration for Sections"] = 600,
    ["ProActions AI-Kit Configuration for Services"] = 597,
    ["ProActions AI-Kit Configuration for Steps"] = 601,
    ["ProActions AI-Kit Configuration for Templates"] = 599,
    ["Problem object RFC9457"] = 1010,
    ["Problem package generators"] = 602,
    Pterodactyl = 961,
    ["Pull Request Labeler"] = 618,
    Pulumi = 626,
    ["PyGTA Config"] = 622,
    PyProject = 627,
    Pylock = 1107,
    Pyright = 628,
    ["Python script metadata"] = 1101,
    ["QType AI DSL"] = 631,
    Qgoda = 630,
    Qodana = 934,
    ["Qt Creator workspace file"] = 1042,
    ["Quali Torque Blueprint Spec 2"] = 959,
    ["QueryFirst config file"] = 977,
    ["RKE Cluster Configuration JSON"] = 912,
    ["RKE Cluster Configuration YAML"] = 911,
    RadioHound = 621,
    Railway = 632,
    ["Rancher Fleet"] = 623,
    ["Rattler-build"] = 633,
    Ray = 876,
    ["Read the Docs"] = 625,
    ["Red-DiscordBot Cog"] = 640,
    ["Red-DiscordBot Cog Repo"] = 641,
    ["Red-DiscordBot Trivia"] = 642,
    ["Render Blueprints"] = 910,
    RenderCV = 655,
    Renovate = 654,
    ["Replit config"] = 648,
    Restate = 1094,
    ["Revel Digital Gadget Definition File"] = 1118,
    RoadRunner = 657,
    ["Robust Station Image"] = 1124,
    ["Roo Coder Custom Modes"] = 659,
    Rubocop = 650,
    ["Rudder techniques"] = 1017,
    Ruff = 651,
    ["Rust Project"] = 652,
    ["Rust toolchain"] = 662,
    ["SDMX data message"] = 688,
    ["SDMX metadata message"] = 687,
    ["SDMX structure message"] = 686,
    ["SIL Kit Participant Configuration"] = 698,
    ["SIL Kit Registry Configuration"] = 699,
    ["SPDX 2.3"] = 735,
    SWADL = 751,
    ["Safebox Config"] = 972,
    ["Sapphire CLI Config"] = 665,
    ["SauceCTL Configuration"] = 921,
    ["Schema Catalog"] = 680,
    ["Scoop manifest"] = 685,
    ["Semantic Data Fabric (SDF) file"] = 689,
    ["Semgrep Rule"] = 691,
    ["Serenity Code Generator (Sergen)"] = 692,
    ["Serverless Framework Configuration"] = 928,
    ["Serverless Workflow"] = 930,
    ["Settings for a Cinnamon spice"] = 1060,
    ["Settings.paf"] = 694,
    ["Shopware 6 Configuration"] = 931,
    ["Shopware CLI Extension Store Configuration"] = 932,
    ["Shopware CLI Project Store Configuration"] = 933,
    ["Sigma Detection Rule"] = 696,
    ["Sigrid scope configuration file"] = 697,
    ["SkyPilot Task JSON"] = 1018,
    ["Slack app manifest"] = 701,
    Solidarity = 706,
    ["Solution filters"] = 707,
    ["Source Maps v3"] = 708,
    Sourcery = 709,
    ["Spack bootstrap.yaml"] = 710,
    ["Spack cdash.yaml"] = 711,
    ["Spack ci.yaml"] = 712,
    ["Spack compilers.yaml"] = 713,
    ["Spack concretizer.yaml"] = 714,
    ["Spack config.yaml"] = 715,
    ["Spack definitions.yaml"] = 716,
    ["Spack develop.yaml"] = 717,
    ["Spack env_vars.yaml"] = 718,
    ["Spack environment"] = 724,
    ["Spack include.yaml"] = 719,
    ["Spack mirrors.yaml"] = 720,
    ["Spack modules.yaml"] = 721,
    ["Spack packages.yaml"] = 722,
    ["Spack repos.yaml"] = 723,
    ["Spack toolchains.yaml"] = 725,
    ["Spack upstreams.yaml"] = 726,
    ["Spack view.yaml"] = 727,
    ["Speakeasy Generation Config File"] = 731,
    ["Speakeasy Lint Configuration File"] = 728,
    ["Speakeasy Test Generation Configuration File"] = 729,
    ["Speakeasy Workflow File"] = 730,
    SpecIF = 732,
    ["Sponge Mixin configuration"] = 733,
    StackBlitz = 739,
    ["StackHawk Scanner Configuration"] = 927,
    Stale = 740,
    Starfish = 741,
    ["Starlake Data Pipeline"] = 900,
    Starship = 742,
    ["Statamic Blueprint"] = 743,
    ["Stella configuration file"] = 744,
    ["Streamlit configuration file"] = 745,
    ["Stryker Mutator"] = 748,
    ["StyleCop Analyzers Configuration"] = 749,
    ["Stylelint (.stylelintrc)"] = 750,
    ["Stylua Config"] = 1108,
    ["Sublime Syntax"] = 973,
    ["Subsquid squid manifest"] = 1020,
    ["Swagger API 2.0"] = 752,
    ["Synadia Connect Component"] = 753,
    TSON = 788,
    TSTyche = 789,
    ["TYPO3 Vendor Bundler config"] = 794,
    ["Tab data for a LinUtil"] = 1067,
    ["Tab list for a LinUtil"] = 1066,
    Tach = 754,
    ["Tach Domain"] = 755,
    Talhelper = 757,
    ["Talisman configuration"] = 758,
    Taplo = 1109,
    ["Taskfile config"] = 905,
    Taurus = 759,
    Tauticord = 760,
    Telefonistka = 1095,
    ["Terrateam config"] = 1121,
    ["TestEnvironment.json"] = 771,
    ["TextMate Grammar"] = 770,
    Threagile = 766,
    ["Tier.run pricing.json"] = 763,
    Tikibase = 764,
    Tombi = 769,
    ["Traefik v2"] = 774,
    ["Traefik v2 File Provider"] = 775,
    ["Traefik v3"] = 776,
    ["Traefik v3 File Provider"] = 777,
    ["Travis CI (.travis.yml)"] = 773,
    Trident = 1091,
    ["TrueScript for *.tscript files"] = 780,
    ["Tugboat QA config.yml"] = 1088,
    TunnelHub = 1008,
    Turborepo = 772,
    Tycho = 1056,
    Tye = 935,
    ["Tyk Gateway - Open Source v5.7+"] = 1100,
    ["Typst Manifest"] = 795,
    ["UET BuildConfig.json"] = 978,
    ["UI5 Manifest"] = 801,
    ["UNCORS configuration"] = 805,
    ["UTAM Page Object"] = 804,
    ["Ubuntu Server Autoinstall"] = 799,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1092,
    ["Uniswap Token List"] = 888,
    ["Universal Schedule Format"] = 806,
    ["Unreal Engine Uplugin"] = 979,
    ["Unreal Engine Uproject"] = 980,
    ["UpCloud CLI (upctl) configuration"] = 1093,
    ["Updatecli Compose"] = 943,
    ["Updatecli Policy Manifest"] = 944,
    ["Updatecli Policy Metadata"] = 945,
    Uplift = 976,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 909,
    V2Ray = 949,
    ["VSCode Code Snippets"] = 208,
    ["VSIX CLI publishing"] = 826,
    Vector = 808,
    ["Vela Pipeline Configuration"] = 811,
    Vercel = 207,
    ["Version Bumper config"] = 816,
    ["Viash Component Config"] = 1097,
    ["Viash Package Config"] = 1098,
    Visivo = 1006,
    ["WP-CLI"] = 836,
    Wake = 1090,
    ["Waku Config"] = 1070,
    ["Web App Manifest"] = 832,
    ["Web types"] = 835,
    WebExtensions = 831,
    ["Webman package recipe"] = 955,
    ["Windows Package Manager Installer Manifest"] = 884,
    ["Windows Package Manager Locale Manifest"] = 885,
    ["Windows Package Manager Singleton Manifest"] = 883,
    Winutil = 886,
    ["WireMock stub mapping"] = 1073,
    ["Woodpecker pipeline config"] = 923,
    ["Wrangler CLI"] = 837,
    ["Xstate Machine"] = 941,
    ["Yandex Workflow Language"] = 1062,
    ["Yarn Config (.yarnrc.yml)"] = 898,
    ["Yippee-Ki-JSON configuration YML"] = 890,
    ["YouTrack App"] = 1059,
    ["Zarf Package Configuration"] = 1123,
    ["Zerops.io config"] = 1047,
    ["Zerops.io import"] = 1048,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 1011,
    ...
    ["behat.yml"] = 106,
    ["bigquery-table"] = 95,
    ["bioimageio resource description"] = 1028,
    ...
    ["crowdin.yml"] = 242,
    ["ctfd-setup configuration file"] = 1080,
    ["custom-elements.json"] = 998,
    ["cypress.json"] = 246,
    ...
    ["gematik health care insurance list"] = 1086,
    ["gematik health care patient list"] = 1083,
    ["gematik health care provider institution list"] = 1085,
    ["gematik health care provider list"] = 1084,
    ["gematik tiger test environment configuration"] = 1087,
    ["gitlab-ci"] = 348,
    ["global.json"] = 364,
    ...
    ["ide.host.json"] = 398,
    ["ifstate.yaml"] = 399,
    ["imageoptimizer.json"] = 400,
    ["importmap.json"] = 403,
    ["ioBroker Configuration"] = 405,
    ["ioBroker JSON UI"] = 406,
    ["ioBroker Package manifest"] = 407,
    ["ize.toml"] = 975,
    ["jsconfig.json"] = 432,
    ["jscpd Configuration"] = 960,
    jsdoc = 875,
    ["k3d.yaml"] = 433,
    ["k9s aliases.yaml"] = 435,
    ["k9s cluster-config.yaml"] = 437,
    ["k9s config.yaml"] = 436,
    ["k9s hotkeys.yaml"] = 438,
    ["k9s plugins.yaml"] = 439,
    ["k9s skin.yaml"] = 440,
    ["k9s views.yaml"] = 441,
    ["kontinuous-config.yaml"] = 452,
    ["kontinuous-values.yaml"] = 451,
    ["kustomization.yaml"] = 454,
    ["label-commenter-config.yml"] = 455,
    ["latexindent configuration"] = 76,
    ["launchsettings.json"] = 456,
    lazydocker = 997,
    lazygit = 996,
    ["lego.json"] = 458,
    ["lerna.json"] = 459,
    ["lgtm.yml"] = 460,
    ["liblab.config.json"] = 461,
    ["libman.json"] = 462,
    ["license-report-config.json"] = 463,
    ["linkinator.config.json"] = 465,
    ["lint-staged (.lintstagedrc)"] = 853,
    ["local.settings.json"] = 470,
    ["localazy.json"] = 471,
    ["lotus.yaml"] = 469,
    ["lsdlschema.json"] = 472,
    ["markdown-link-check"] = 918,
    maturin = 919,
    mboats = 926,
    ["micro-settings.json"] = 990,
    ["mimetypes.json"] = 485,
    ["mirrord config"] = 855,
    mise = 856,
    ["mkdocs.yml"] = 505,
    ["monospace.yml"] = 508,
    ["moon.yml"] = 1072,
    ["mprocs Configuration file"] = 1043,
    ["mrdocs.yml"] = 506,
    ["mta.yaml"] = 857,
    ["mtad.yaml"] = 858,
    ["mycode.json"] = 515,
    nFPM = 519,
    ["napari plugin manifest"] = 516,
    neoload = 870,
    ["nest-cli"] = 522,
    ["ninjs (News in JSON)"] = 521,
    ["nitro.json"] = 869,
    ["nixd configuration"] = 1016,
    ["nlu.json"] = 523,
    ["nodemon.json"] = 525,
    ["noodl config"] = 925,
    ["notebook.mod.json"] = 526,
    now = 865,
    ["npm-badges"] = 529,
    ["nswag.json"] = 533,
    ntangle = 535,
    ["nuclei-template.yaml"] = 530,
    ["nuget-project.json"] = 531,
    ["ocelot.json"] = 537,
    ["omnisharp.json"] = 541,
    ["openapi.json"] = 542,
    ["openfin.json"] = 549,
    ...
    ["ops.yaml"] = 546,
    ["package.json"] = 570,
    ["package.manifest"] = 571,
    ["partial-black.json"] = 107,
    ["pathfinder.yml"] = 574,
    ["pattern.json"] = 577,
    ["petstore-v1.0"] = 970,
    pgap_yaml_input_reader = 576,
    ["pixi.toml"] = 578,
    ["plagiarize-me.yaml"] = 582,
    ["plagiarize.yaml"] = 581,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1076,
    ["podbard.yaml"] = 584,
    ["portman.json"] = 585,
    ["prefect.toml"] = 593,
    ["prettierrc.json"] = 594,
    ["prisma.yml"] = 595,
    ["project-1.0.0-beta3.json"] = 604,
    ["project-1.0.0-beta4.json"] = 605,
    ["project-1.0.0-beta5.json"] = 606,
    ["project-1.0.0-beta6.json"] = 607,
    ["project-1.0.0-beta8.json"] = 608,
    ["project-1.0.0-rc1.json"] = 609,
    ["project-1.0.0-rc2.json"] = 610,
    ["project.json"] = 603,
    ["project.owasp.yaml"] = 611,
    ["prometheus.json"] = 612,
    ["prometheus.rules.json"] = 613,
    ["prometheus.rules.test.json"] = 614,
    ["proxies.json"] = 615,
    ["publiccode.yml"] = 616,
    ["pubspec.yaml"] = 617,
    ["pyrseas-0.8.json"] = 620,
    pytest = 629,
    ["quilt.mod.json"] = 991,
    ["rc3 auth"] = 634,
    ["rc3 collection"] = 635,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 871,
    ["release-please-config.json"] = 644,
    ["release-please-manifest.json"] = 645,
    ["release-plz.toml"] = 646,
    ["renv.lock"] = 656,
    ["rivet.json"] = 1015,
    ["rivet.yaml (legacy)"] = 1014,
    rockcraft = 658,
    runny = 660,
    rustfmt = 661,
    sake = 1103,
    samt = 663,
    samtrc = 664,
    ["sarif-1.0.0.json"] = 666,
    ["sarif-2.0.0.json"] = 667,
    ["sarif-2.1.0"] = 677,
    ["sarif-2.1.0-rtm.2"] = 668,
    ["sarif-2.1.0-rtm.3"] = 670,
    ["sarif-2.1.0-rtm.4"] = 672,
    ["sarif-2.1.0-rtm.5"] = 674,
    ["sarif-2.1.0-rtm.6"] = 675,
    ["sarif-external-property-file-2.1.0"] = 678,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 669,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 671,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 673,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 676,
    ["scalingo.json configuration"] = 679,
    ["schema.org - Action"] = 681,
    ["schema.org - ContactPoint"] = 682,
    ["schema.org - Place"] = 683,
    ["schema.org - Thing"] = 684,
    ["secrethub.yml"] = 993,
    ["semantic-release"] = 690,
    ["servicehub.config.json"] = 848,
    ["servicehub.service.json"] = 847,
    ["settings.job"] = 693,
    ["sfdx-hardis configuration"] = 695,
    ["shard.yml"] = 1031,
    ["size-limit configuration"] = 700,
    ["skaffold.yaml"] = 916,
    ["skyuxconfig.json"] = 702,
    snapcraft = 703,
    ["snowflake-config"] = 704,
    ["snowflake-connections"] = 705,
    ["spicepod.yaml"] = 1051,
    ["sqlc configuration"] = 736,
    ["stripe-app-local.json"] = 747,
    ["stripe-app.json"] = 746,
    swcrc = 901,
    ["task.json"] = 756,
    taskcat = 866,
    ["template.json"] = 761,
    ["templatsources.json"] = 762,
    ["theme.json"] = 765,
    ["tizen_workspace.json"] = 767,
    tldr = 768,
    ["tm_devices configuration file"] = 1114,
    tmuxinator = 851,
    ["transcend.yml"] = 778,
    ["tree-sitter grammar.json"] = 372,
    ["trime.yaml"] = 779,
    ["trunk.yaml"] = 781,
    ["ts-force-config.json"] = 786,
    ["tsconfig.json"] = 782,
    ["tsd.json"] = 783,
    ["tsdoc.json"] = 784,
    ["tsdrc.json"] = 785,
    ...
    ["vega-lite.json"] = 810,
    ["vega.json"] = 809,
    ["venvironment-basic.yaml"] = 813,
    ["venvironment.yaml"] = 812,
    ["venvplus-basic.yaml"] = 815,
    ["venvplus.yaml"] = 814,
    version = 1096,
    ["version.json"] = 817,
    ["vhwdebugger-binding.yaml"] = 819,
    ["vim-addon-info"] = 820,
    ["vs-2017.3.host.json"] = 822,
    ["vs-nesting.json"] = 823,
    ["vsls.json"] = 821,
    ["vss-extension.json"] = 827,
    vtcfg = 1102,
    ["vtesttree.yaml"] = 828,
    ["vtestunit.yaml"] = 829,
    ["warp-keysets.json"] = 999,
    ["warp-themes.json"] = 1000,
    ["warp-workflows.json"] = 1001,
    ["webhint.io"] = 956,
    ["webjobpublishsettings.json"] = 834,
    ["webjobs-list.json"] = 833,
    ["well-known-fursona"] = 1038,
    ["xs-app.json"] = 861,
    ["xunit.runner.json"] = 846,
    yamllint = 889,
    zuul = 872,
    ["Žinoma"] = 882
  },
