...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1074,
    [".nodehawkrc"] = 690,
    [".npmpackagejsonlintrc"] = 695,
    [".omletrc"] = 1255,
    [".phrase.yml"] = 777,
    [".phraseapp.yml"] = 778,
    [".pmbot.yml"] = 762,
    [".postcssrc"] = 771,
    [".powerpages-web-template-manifest"] = 773,
    [".pre-commit-config.yml"] = 774,
    [".pre-commit-hooks.yml"] = 775,
    [".putout.json"] = 811,
    [".rehyperc"] = 836,
    [".remarkrc"] = 840,
    [".sprite files"] = 942,
    ...
    AIConfig = 46,
    ["AMX Muse Program Descriptor"] = 1304,
    ["API Builder"] = 1110,
    ["AVA Configuration"] = 1174,
    ["AWS AppConfig Feature Flags-v1"] = 85,
    ["AWS CDK cdk.json"] = 307,
    ["AWS CloudFormation"] = 308,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 309,
    ["AWS Copilot Manifest"] = 1343,
    ["AWS SAM CLI Samconfig"] = 310,
    Acton = 1394,
    ["Adobe UXP Manifest"] = 1237,
    ["Aerleon Network & Service Definitions"] = 28,
    ["Aerleon Policy"] = 29,
    ["Agent Permission Policy"] = 1383,
    ["AgentCore CLI"] = 1384,
    AgentLoopKit = 1385,
    Aider = 1333,
    Air = 31,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1354,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1353,
    ["Airlock Microgateway"] = 47,
    ["Alacritty Configuration"] = 1146,
    ["AlgoVoi Compliance Receipt v1"] = 17,
    ["All Contributors configuration file"] = 1200,
    ["Amazon S3 bucket CORS"] = 19,
    Anodizer = 504,
    ["Ansible Argument Specs"] = 486,
    ["Ansible Collection Galaxy"] = 493,
    ["Ansible Execution Environment"] = 483,
    ["Ansible Inventory"] = 492,
    ["Ansible Meta"] = 484,
    ["Ansible Meta Runtime"] = 485,
    ["Ansible Navigator Configuration"] = 495,
    ["Ansible Playbook"] = 490,
    ["Ansible Requirements"] = 487,
    ["Ansible Rulebook"] = 491,
    ["Ansible Tasks File"] = 489,
    ["Ansible Vars File"] = 488,
    ["Ansible-lint Configuration"] = 494,
    Any = 1265,
    ...
    ["Application list for a WinUtil"] = 1283,
    ["ArchSmith diagram IR"] = 1419,
    ArchitectFX = 1288,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1352,
    ["Azure IoT Operations connector metadata"] = 1349,
    ...
    ["Azure Pipelines"] = 134,
    ["Azure Static Web Apps CLI configuration file"] = 946,
    ["Azure Static Web Apps configuration file"] = 945,
    BMML = 1371,
    ["BOSH BPM Config"] = 160,
    ["BOSH CPI Config"] = 161,
    ...
    ["Bacon config"] = 11,
    ["Barba-CV"] = 100,
    ["Bashly (bashly.yml)"] = 1204,
    ["Bashly Settings (bashly-settings.yml)"] = 1205,
    Bento = 1370,
    ["Better Code Hub"] = 1115,
    ["Better Scripts"] = 184,
    Bigconfig = 153,
    ["Biome Formatter Config"] = 101,
    ["Bitmovin Encoding Template"] = 1297,
    BizTalkServerApplicationSchema = 1081,
    Bleep = 185,
    ["Block Protocol Metadata"] = 182,
    ["Bluebricks blueprint config"] = 1376,
    ["Boyka Framework"] = 163,
    ...
    ["Butane Config"] = 1159,
    C4InterFlow = 1312,
    ["CDK Environment Manager, concrete environment configuration"] = 1336,
    ["CDK Environment Manager, concrete environments definition"] = 1335,
    ["CDK Environment Manager, environment definition"] = 1334,
    ["CGS Card Game Specification (cgs.json)"] = 1242,
    ["CICS TS region tagging"] = 1168,
    ["CICS TS resource import"] = 1169,
    ["CICS TS resource model"] = 1170,
    ["CICS TS resource overrides"] = 1171,
    ["CMake Presets"] = 186,
    ["CNC Codes"] = 209,
    ["CRS WAF test file"] = 1272,
    ["CRS WAF test platform overrides file"] = 1273,
    ["CSS Comb (.csscomb.json)"] = 337,
    ["CSS Lint (.csslintrc)"] = 338,
    ["CSpell (cspell.json)"] = 336,
    ...
    ["Caido Proxy Configuration"] = 1409,
    ...
    ["Chamaleon environment"] = 1301,
    ["Chamaleon properties"] = 1302,
    ["Chamaleon template"] = 1300,
    Changepacks = 1363,
    Changesets = 319,
    Changie = 195,
    Charmcraft = 196,
    ...
    CodeCV = 115,
    CodeRabbit = 114,
    ["CodeShip Pro services configuration files"] = 289,
    ["CodeShip Pro steps configuration files"] = 290,
    ["Codecov configuration files"] = 288,
    Codex = 280,
    ["Codex Hooks"] = 281,
    ...
    ["Common Catalog Data"] = 298,
    ["Common Package Specification"] = 213,
    Concord = 1271,
    ["Configu .cfgu files"] = 1259,
    ["Configu .configu file"] = 1260,
    Conjure = 208,
    ["Container Structure Test"] = 1095,
    Containerlab = 1124,
    ["Contextive Glossary"] = 1328,
    ContractGuard = 1125,
    Convex = 207,
    ["Crowdsec collection config"] = 330,
    ["Crowdsec parser config"] = 331,
    ["Crowdsec scenario config"] = 332,
    ["CumulusCI Config"] = 214,
    ["Cursor Agent Environment"] = 1381,
    ["Custom Machinery Machine"] = 1243,
    ["Custom Machinery Recipe"] = 1244,
    ["Cycle Stack File"] = 232,
    CycloneDX = 233,
    ["DWP Exchange - catalogue entry"] = 384,
    ["DWP Exchange - gateway"] = 382,
    ["DWP Exchange - meta"] = 383,
    ["Dart Build Config (dart-build.json)"] = 339,
    ["Dart Test Config (dart-test.json)"] = 340,
    ["DashLord Configuration"] = 341,
    ["Data Contract Specification"] = 342,
    ["Data Product Specification"] = 343,
    ["DataYoga Connections"] = 234,
    ["DataYoga Job"] = 235,
    ["Datadog Continuous Testing"] = 593,
    ["Datadog Service Definition"] = 594,
    ["Datadog Software Catalog"] = 595,
    ["Datahub Ingestion Recipe"] = 1175,
    ["Debian Upstream Metadata file"] = 242,
    DebtLens = 243,
    ["Deck config"] = 244,
    ["Declarative Automation Bundles"] = 1221,
    ["DeepMatch deeplinks spec"] = 245,
    ["Dein Config"] = 246,
    ["Deno Config (deno.json)"] = 350,
    ["Dependency cruiser"] = 247,
    ["DeployStack Configuration"] = 248,
    ["Deployah Configuration"] = 1351,
    ["Deployer Recipe"] = 353,
    ["Deta Spacefile"] = 249,
    ["Detekt Config (detekt.yml)"] = 354,
    ["Devbox Config"] = 250,
    ["Devbox Plugin"] = 251,
    Devfile = 381,
    Devup = 1364,
    DipDup = 1274,
    ["Discord Webhook"] = 355,
    ["DocFx Config (docfx.json)"] = 360,
    ["Docker Desktop extension metadata"] = 357,
    ["Docs MCP Manifest"] = 361,
    Dofigen = 362,
    ["Dolittle Artifacts"] = 363,
    ["Dolittle Bounded Context Configuration"] = 364,
    ["Dolittle Event Horizons Configuration"] = 365,
    ["Dolittle Resources Configuration"] = 366,
    ["Dolittle Server Configuration"] = 367,
    ["Dolittle Tenant Map Configuration"] = 369,
    ["Dolittle Tenants Configuration"] = 368,
    ["Dolittle Topology"] = 370,
    ["DonateCaseBetterCasino menu"] = 1305,
    ["Draugr Saga"] = 349,
    ...
    ["Drupal Routing"] = 264,
    ["Drupal Services"] = 266,
    ["Drush site aliases"] = 376,
    ["Dust configuration"] = 379,
    ["Dynamic Bash Aliases (.aliases)"] = 1212,
    ["EAS config"] = 423,
    ["ECA - Editor Code Assistant"] = 386,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1201,
    ["ESLint Suppressions"] = 428,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1348,
    ["EasyVCR .NET"] = 425,
    ["Eidolon Resource"] = 1289,
    ["Elgato Stream Deck"] = 389,
    Elm = 1276,
    ["Embrace Config"] = 1187,
    Emmet = 1277,
    Endurica = 1225,
    ["Enonic XP API descriptor"] = 392,
    ["Enonic XP Admin Extension descriptor"] = 393,
    ["Enonic XP Admin Tool descriptor"] = 394,
    ["Enonic XP Application descriptor"] = 395,
    ["Enonic XP CMS descriptor"] = 396,
    ["Enonic XP Content Type descriptor"] = 397,
    ["Enonic XP Form Fragment descriptor"] = 398,
    ["Enonic XP ID Provider descriptor"] = 399,
    ["Enonic XP Layout descriptor"] = 400,
    ["Enonic XP Macro descriptor"] = 401,
    ["Enonic XP Mixin descriptor"] = 402,
    ["Enonic XP Page descriptor"] = 403,
    ["Enonic XP Part descriptor"] = 404,
    ["Enonic XP Service descriptor"] = 405,
    ["Enonic XP Site descriptor"] = 406,
    ["Enonic XP Style descriptor"] = 407,
    ["Enonic XP Task descriptor"] = 408,
    ["Enonic XP Webapp descriptor"] = 409,
    ["Enterprise Contract Policy Spec"] = 390,
    ["Envelope Team Definition"] = 1393,
    ["Envilder Map File"] = 391,
    ["Erda Pipeline"] = 1250,
    ["Erda Runtime"] = 1251,
    ["Espanso config.yml"] = 1374,
    ["Espanso match.yml"] = 1373,
    Esquio = 411,
    ["Estuary Flow Catalog"] = 1165,
    ["Ethereum ERC1155"] = 1387,
    ["Ethereum ERC721"] = 1386,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 416,
    ["EveryVoice TTS Toolkit Data Configuration"] = 417,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 421,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 420,
    ["EveryVoice TTS Toolkit Text Configuration"] = 418,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 419,
    ["Evolving Resolutive Process notation"] = 1350,
    ["Expo SDK"] = 422,
    ["Expoot app config"] = 424,
    ["F-Droid Data metadata"] = 430,
    ["FasterCI Configuration"] = 135,
    ["Fence configuration"] = 136,
    FiQuS = 434,
    Firebase = 432,
    ["Flatpak Builder Manifest"] = 435,
    ["FlexGet Config"] = 436,
    ["Flow.json Configurations"] = 1247,
    ["Fossa configuration file"] = 443,
    ["Fossa's fossa-deps file"] = 444,
    ["Foundry VTT - Base package Manifest"] = 438,
    ["Foundry VTT - Module Manifest"] = 439,
    ["Foundry VTT - System Data Template"] = 442,
    ["Foundry VTT - System Manifest"] = 440,
    ["Foundry VTT - World Manifest"] = 441,
    ["Foxx Manifest"] = 137,
    ["Freifunk.de Community API"] = 140,
    ["Frogbot Config"] = 141,
    ["G2P Mapping Configuration"] = 451,
    GAMA = 452,
    ["GCP Blueprint Metadata"] = 455,
    Gaspar = 453,
    ["GatewayCore API Gateway"] = 454,
    ["Gemini CLI settings"] = 456,
    ["GeoJSON.json latest"] = 1163,
    GherKing = 1167,
    ["GitHub Action"] = 466,
    ["GitHub Actions typing"] = 1285,
    ["GitHub CLI configuration"] = 467,
    ["GitHub CLI hosts"] = 468,
    ["GitHub Discussion"] = 469,
    ["GitHub Funding"] = 471,
    ["GitHub Issue Template configuration"] = 472,
    ["GitHub Issue Template forms"] = 473,
    ["GitHub Pages Jekyll"] = 474,
    ["GitHub Prompt"] = 470,
    ["GitHub Secret Scanning"] = 475,
    ["GitHub Workflow"] = 476,
    ["GitHub Workflow Template Properties"] = 477,
    ["GitHub automatically generated release notes configuration"] = 478,
    ["GitLab Agent for Kubernetes configuration"] = 1239,
    ["GitLab Duo Workflow"] = 480,
    GitResume = 482,
    GitVersion = 459,
    ["Gitea Issue Template configuration"] = 462,
    ["Gitea Issue Template forms"] = 463,
    Gitleaks = 460,
    ["Gitpod Configuration"] = 481,
    ["Glamour style"] = 457,
    ["GlazeWM settings"] = 1241,
    ["Global Privacy Control"] = 458,
    Goblet = 1220,
    ["Golangci-lint Configuration"] = 497,
    ["Golangci-lint Custom Plugins Configuration"] = 498,
    ["Google Chrome Related Website Sets"] = 433,
    ["Google Cloud Workflows"] = 306,
    ["Google Digital Assetlinks"] = 1329,
    Goreleaser = 502,
    ["Goreleaser Pro"] = 503,
    Goss = 505,
    ["Gradle Build Cache Node"] = 1113,
    ["Gradle Enterprise"] = 1112,
    ["Grafana 5.x Dashboard"] = 506,
    ["GraphQL Code Generator"] = 511,
    ["GraphQL Config"] = 510,
    ["GraphQL Mesh"] = 509,
    ["GroovyLint configuration"] = 512,
    ["Grunt JSHint task"] = 516,
    ["Grunt Watch task"] = 517,
    ["Grunt base task"] = 518,
    ["Grunt clean task"] = 514,
    ["Grunt copy task"] = 513,
    ["Grunt cssmin task"] = 515,
    HEMTT = 1077,
    Hadolint = 1091,
    Hammerkit = 1123,
    ["Hardware Sentry Configuration"] = 1179,
    ["Hashgraph Online Skill Manifest"] = 7,
    ["HashiCorp Vault"] = 519,
    Hatch = 1092,
    Hayson = 521,
    ["Haystack Pipeline"] = 522,
    ["Hazelcast 5 Configuration"] = 523,
    ["Hecate Input Schema"] = 1340,
    ["Helm Chart.lock"] = 268,
    ["Helm Chart.yaml"] = 267,
    ["Helm Unittest Test Suite"] = 269,
    ["Heloisa Assistant Plugins Marketplace"] = 1416,
    ["Hex file"] = 270,
    ["Home Assistant Integration Manifest"] = 525,
    ["Homer dashboard configuration"] = 526,
    ["Hoverfly Simulation"] = 531,
    Hugo = 1155,
    ["Hugo Theme"] = 1154,
    ["Hulak Configuration"] = 534,
    ["Hyperfoil benchmark configuration"] = 533,
    ["IBM Zapp document"] = 535,
    ["IBM zCodeFormatSettings"] = 536,
    ["IMG Catapult PSP"] = 541,
    ["IVMS101 by CODE Protocol"] = 1240,
    ["Infinispan Configuration"] = 543,
    ["Infinispan Server Configuration"] = 544,
    Infrahub = 545,
    Istanbul = 1183,
    ["JDownloader2 crawler multi-rules"] = 559,
    ["JDownloader2 crawler single-rules"] = 558,
    ["JFrog Applications Config"] = 560,
    ["JFrog File Spec"] = 561,
    ["JFrog Pipelines YML DSL"] = 1189,
    ["JMeter DSL cli config"] = 562,
    JReleaser = 565,
    ["JSON Document Transform"] = 573,
    ["JSON Feed"] = 574,
    ["JSON Resume"] = 849,
    ["JSON Schema Draft 2020-12"] = 1057,
    ["JSON Schema Draft 4"] = 1054,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1222,
    ["JSON Schema Draft 7"] = 1055,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1223,
    ["JSON Schema Draft 8 (2019-09)"] = 1056,
    ["JSON-API"] = 572,
    ["JSON-e templates"] = 1120,
    ["JSON-stat 2.0"] = 1050,
    JSONPatch = 576,
    ["JSR Package Config (jsr.json)"] = 566,
    Jarl = 1356,
    Jasmine = 553,
    Jekyll = 554,
    ["Jenkins X Pipelines"] = 555,
    ["Jenkins X Requirements"] = 556,
    Jest = 557,
    Jocker = 563,
    ["Jovo Language Models"] = 564,
    Jsontron = 577,
    ["Jujutsu (jj) VCS config"] = 1342,
    ["KIMMDY config file"] = 588,
    ["KODE/CI build.yaml"] = 1185,
    ["KSP-AVC"] = 1051,
    ["KSP-CKAN"] = 1052,
    ["KSP-NetKAN"] = 1053,
    KSY = 1252,
    KSail = 449,
    ["KYA Manifest"] = 1253,
    ["Karakum configuration file"] = 445,
    Kas = 580,
    ["Kestra flow file"] = 589,
    ["Keycloak REST API"] = 1192,
    ["Knative Functions - func.yaml"] = 446,
    Knip = 447,
    ["Knip JSONC"] = 448,
    ["Knowledge Unit"] = 597,
    ["Kometa (nightly) config file"] = 591,
    ["Kometa config file"] = 590,
    ["Kong DBLess config"] = 1186,
    KrakenD = 592,
    ["Kubri Configuration"] = 600,
    LOOBin = 616,
    ["Lake configuration file"] = 1345,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 311,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 312,
    ["Landing Zone Accelerator on AWS - Global Config"] = 313,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 314,
    ["Landing Zone Accelerator on AWS - Network Config"] = 315,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 316,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 317,
    ["Landing Zone Accelerator on AWS - Security Config"] = 318,
    ["Lando (landofile)"] = 127,
    ["LangGraph Platform configuration"] = 1264,
    ["Language configuration"] = 1263,
    Lefthook = 605,
    ["Liferay client-extension.yaml"] = 612,
    ["LinkML Metamodel"] = 614,
    Liquibase = 1130,
    ["Liquibase Flow File"] = 1131,
    ["Lively Properties"] = 615,
    ["Lobe AI Agent"] = 129,
    Loki = 130,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 659,
    ["MS2Rescore Configuration"] = 667,
    ["MSTest testconfig.json"] = 668,
    ["Madge configuration"] = 622,
    ["Madness (madness.yml)"] = 1203,
    ["Mado configuration"] = 623,
    ["Maestro Flow"] = 624,
    ["Mail Servers Configuration"] = 1377,
    ["MapEHR Mapping"] = 625,
    Markdownlint = 1134,
    ["Mason Registry"] = 1137,
    ["MegaLinter Custom Flavor"] = 628,
    ["MegaLinter configuration"] = 627,
    ["MegaLinter descriptor"] = 629,
    Melange = 1230,
    ["Meltano project definition"] = 630,
    ["Mergify Configuration"] = 669,
    ["Mermaid config"] = 2,
    ["Metadata for a Bazel module"] = 631,
    ["Metadata for a Cinnamon spice"] = 1281,
    ["Metatype Configuration"] = 632,
    ["MetricsHub Configuration"] = 633,
    ["MetricsHub Connector Configuration"] = 634,
    ["Micro Editor Syntax"] = 1213,
    ["Microsoft Band Web Tile"] = 635,
    ["Microsoft RulesEngine workflow rules"] = 1268,
    ["Microsoft RulesEngine workflow rules list"] = 1269,
    ["Minecraft Custom Main Menu Mod"] = 1231,
    ["Minecraft Data Pack Advancement"] = 637,
    ["Minecraft Data Pack Biome"] = 638,
    ["Minecraft Data Pack Configured Carver"] = 639,
    ["Minecraft Data Pack Damage Type"] = 640,
    ["Minecraft Data Pack Dimension"] = 642,
    ["Minecraft Data Pack Dimension Type"] = 641,
    ["Minecraft Data Pack Item Modifier"] = 643,
    ["Minecraft Data Pack Loot Table"] = 644,
    ["Minecraft Data Pack Metadata"] = 645,
    ["Minecraft Data Pack Predicate"] = 646,
    ["Minecraft Data Pack Recipe"] = 647,
    ["Minecraft Data Pack Tag"] = 648,
    ["Minecraft Data Pack Template Pool"] = 649,
    ["Minecraft Data Pack Trim Material"] = 654,
    ["Minecraft Data Pack Trim Pattern"] = 655,
    ["Minecraft Resource Pack Lang"] = 650,
    ["Minecraft Resource Pack Particle"] = 651,
    ["Minecraft Resource Pack Texture Mcmeta"] = 653,
    ["Minecraft Resourcepack Sounds"] = 652,
    ["MockServer Expectation"] = 661,
    ["MockServer Expectations"] = 662,
    ModuleAssembler = 657,
    ["Monade CLI Stack Configuration"] = 672,
    ["MongoDB Atlas Search Index Definition"] = 1184,
    ["Monika Configuration"] = 1182,
    ["Monoweave Configuration"] = 666,
    ["Motif config"] = 1073,
    MultiQC = 1322,
    ["NOX Framework (Service)"] = 694,
    ["Netin Diagnostic System Template"] = 1141,
    ["Netlify config"] = 675,
    ["Network-as-Code Data Model"] = 676,
    ["Next Gen UI Agent A2A Server Configuration"] = 677,
    ["Next Gen UI Agent Configuration"] = 679,
    ["Next Gen UI Agent MCP Server Configuration"] = 678,
    ["Nightwatch.js"] = 686,
    ["Nika workflow"] = 691,
    ["Node.js configuration"] = 1078,
    ["NueJS configuration file"] = 699,
    ["Nuitka Package Config"] = 1245,
    ["Nullstone config"] = 701,
    ["ODGS Data Rules"] = 708,
    ["ODGS Ontology Graph"] = 709,
    ["ODGS Standard Metrics"] = 707,
    ["OKF Graph"] = 1417,
    ["ONe's changelog entry"] = 723,
    ["ONe's service descriptor"] = 722,
    ["ORT Server repository environment configuration"] = 734,
    ["OSCAL Assessment Plan (AP)"] = 736,
    ["OSCAL Assessment Results (AR)"] = 737,
    ["OSCAL Catalog"] = 738,
    ["OSCAL Component Definition (CDef)"] = 739,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 740,
    ["OSCAL Profile"] = 741,
    ["OSCAL System Security Plan (SSP)"] = 742,
    ["OSS Review Toolkit configuration"] = 743,
    ["OSS Review Toolkit curation"] = 744,
    ["OSS Review Toolkit package configuration"] = 745,
    ["OSS Review Toolkit project package manager definition"] = 746,
    ["OSS Review Toolkit repository configuration"] = 747,
    ["OSS Review Toolkit resolutions"] = 748,
    ["October CMS columns"] = 705,
    ["October CMS fields"] = 706,
    ["Oh My Posh"] = 711,
    Okteto = 712,
    ["Ona Tasks and Services"] = 714,
    Opctl = 1076,
    ["Open Data Contract Standard (ODCS)"] = 727,
    ["Open Data Product Standard (ODPS)"] = 728,
    ["Open Know-How"] = 1327,
    ["Open Pentest Format"] = 729,
    OpenDecree = 1391,
    ["OpenDecree Configuration"] = 1392,
    ["OpenRewrite Resource"] = 725,
    OpenSRM = 730,
    OpenStatus = 1338,
    ["OpenTelemetry Declarative Configuration"] = 726,
    ["OpenUtau character yaml"] = 719,
    ["OpenUtau ustx"] = 720,
    ["OpenWeather Current Weather API"] = 1119,
    ["OpenWeather Road Risk API"] = 1118,
    ["Ory Hydra configuration"] = 532,
    ["Ory Keto configuration"] = 596,
    ["Ory Kratos configuration"] = 735,
    ["Ory Oathkeeper configuration"] = 703,
    ["Outblocks App configuration"] = 732,
    ["Outblocks database table"] = 733,
    ["Outblocks project configuration"] = 731,
    PDM = 756,
    POPxf = 768,
    ["POPxf Correlations"] = 769,
    ["PRML manifest"] = 776,
    Packer = 752,
    PactSpec = 753,
    Panache = 754,
    Pantsbuild = 1199,
    ["Paper paper-plugin.yml"] = 755,
    ["Pipeline component"] = 1132,
    ["Platform.sh application"] = 13,
    ["Platform.sh routes"] = 14,
    ["Platform.sh services"] = 15,
    ["Plex Prerolls"] = 766,
    ["PocketMine plugin.yml"] = 763,
    ["Podman Desktop Extension"] = 1411,
    ["Postman collection"] = 772,
    ["Power Pages Configuration"] = 1339,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1284,
    ["ProActions AI-Kit Configuration"] = 784,
    ["ProActions AI-Kit Configuration for Menus"] = 786,
    ["ProActions AI-Kit Configuration for Sections"] = 788,
    ["ProActions AI-Kit Configuration for Services"] = 785,
    ["ProActions AI-Kit Configuration for Steps"] = 789,
    ["ProActions AI-Kit Configuration for Templates"] = 787,
    ["Problem object RFC9457"] = 1228,
    ["Problem package format"] = 790,
    ["Problem package generators"] = 791,
    ["Problem package submissions"] = 792,
    ["Problem package test group metadata"] = 793,
    Pterodactyl = 1178,
    ["Pull Request Labeler"] = 810,
    Pulumi = 818,
    ["PyGTA Config"] = 814,
    PyProject = 819,
    Pylock = 1330,
    Pyright = 820,
    ["Python script metadata"] = 1324,
    ["QType AI DSL"] = 823,
    Qgoda = 822,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1403,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1401,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1407,
    ["Qlik Talend Cloud Pipeline - Project"] = 1399,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1402,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1404,
    ["Qlik Talend Cloud Pipeline - Task"] = 1400,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1406,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1405,
    Qodana = 1151,
    ["Qt Creator workspace file"] = 1261,
    ["Quali Torque Blueprint Spec 2"] = 1176,
    ["QueryFirst config file"] = 1195,
    ["QuikRun Configuration"] = 1408,
    ["Qwen Code Settings"] = 1388,
    ["RKE Cluster Configuration JSON"] = 1129,
    ["RKE Cluster Configuration YAML"] = 1128,
    RadioHound = 813,
    ["Raid Profile"] = 1389,
    ["Raid Repo Configuration"] = 1390,
    Railpack = 825,
    Railway = 824,
    ["Rancher Fleet"] = 815,
    ["Rattler-build"] = 826,
    Ray = 1090,
    ["Read the Docs"] = 817,
    ["Red-DiscordBot Cog"] = 833,
    ["Red-DiscordBot Cog Repo"] = 834,
    ["Red-DiscordBot Trivia"] = 835,
    ["Releasaurus Config"] = 10,
    ReleaseKit = 9,
    ["Render Blueprints"] = 1127,
    RenderCV = 853,
    Renovate = 850,
    ["Renovate global configuration"] = 851,
    ["Renovate inherited configuration"] = 852,
    ["Replit config"] = 841,
    Restate = 1317,
    ["Revel Digital Gadget Definition File"] = 1341,
    RoadRunner = 855,
    ["Robust Station Image"] = 1347,
    Rockcraft = 856,
    ["Roo Coder Custom Modes"] = 857,
    Rubocop = 846,
    ["Rudder techniques"] = 1235,
    Ruff = 847,
    ["Rust Project"] = 848,
    ["Rust toolchain"] = 862,
    ["SDMX data message"] = 889,
    ["SDMX metadata message"] = 888,
    ["SDMX structure message"] = 887,
    ["SIL Kit Participant Configuration"] = 900,
    ["SIL Kit Registry Configuration"] = 901,
    ["SPDX 2.3"] = 943,
    SWADL = 959,
    ["Safebox Config"] = 1190,
    ["Sapphire CLI Config"] = 865,
    ["SauceCTL Configuration"] = 1138,
    Scarb = 885,
    ["Schema Catalog"] = 880,
    ["Scoop manifest"] = 886,
    ["Secure SDLC Evidence Bundle"] = 890,
    ["Semantic Data Fabric (SDF) file"] = 891,
    ["Semgrep Rule"] = 893,
    ["Serenity Code Generator (Sergen)"] = 894,
    ["Serverless Framework Configuration"] = 1145,
    ["Serverless Workflow"] = 1147,
    ["Settings for a Cinnamon spice"] = 1280,
    ["Settings.paf"] = 896,
    ["Shopware 6 Configuration"] = 1148,
    ["Shopware CLI Extension Store Configuration"] = 1149,
    ["Shopware CLI Project Store Configuration"] = 1150,
    ["Sigma Detection Rule"] = 898,
    ["SigmaCV CV"] = 5,
    ["Sigrid scope configuration file"] = 899,
    ["SkyPilot Task JSON"] = 1236,
    ["Slack app manifest"] = 906,
    ["Slang Server Configuration"] = 1415,
    Snapcraft = 908,
    ["Solarxy project config"] = 911,
    Solidarity = 912,
    ["Solution filters"] = 913,
    ["Source Maps v3"] = 914,
    Sourcery = 915,
    ["Spack bootstrap.yaml"] = 916,
    ["Spack cdash.yaml"] = 917,
    ["Spack ci.yaml"] = 918,
    ["Spack compilers.yaml"] = 919,
    ["Spack concretizer.yaml"] = 920,
    ["Spack config.yaml"] = 921,
    ["Spack definitions.yaml"] = 922,
    ["Spack develop.yaml"] = 923,
    ["Spack env_vars.yaml"] = 924,
    ["Spack environment"] = 930,
    ["Spack include.yaml"] = 925,
    ["Spack mirrors.yaml"] = 926,
    ["Spack modules.yaml"] = 927,
    ["Spack packages.yaml"] = 928,
    ["Spack repos.yaml"] = 929,
    ["Spack toolchains.yaml"] = 931,
    ["Spack upstreams.yaml"] = 932,
    ["Spack view.yaml"] = 933,
    ["Speakeasy Generation Config File"] = 937,
    ["Speakeasy Lint Configuration File"] = 934,
    ["Speakeasy Test Generation Configuration File"] = 935,
    ["Speakeasy Workflow File"] = 936,
    SpecIF = 938,
    ["Specmatic Configuration"] = 939,
    ["Specpin spec file"] = 3,
    ["Sponge Mixin configuration"] = 940,
    ["Spotlight Ruleset"] = 941,
    StackBlitz = 947,
    ["StackHawk Scanner Configuration"] = 1144,
    Stale = 948,
    Starfish = 949,
    ["Starlake Data Pipeline"] = 1116,
    Starship = 950,
    ["Statamic Blueprint"] = 951,
    ["Stella configuration file"] = 952,
    ["Streamlit configuration file"] = 953,
    ["Stryker Mutator"] = 956,
    ["StyleCop Analyzers Configuration"] = 957,
    ["Stylelint (.stylelintrc)"] = 958,
    ["Stylua Config"] = 1331,
    ["Sublime Syntax"] = 1191,
    ["Subsquid squid manifest"] = 1238,
    ["Swagger API 2.0"] = 960,
    ["Synadia Connect Component"] = 961,
    TSON = 999,
    TSTyche = 1000,
    ["TYPO3 Vendor Bundler config"] = 1006,
    ["Tab data for a LinUtil"] = 1287,
    ["Tab list for a LinUtil"] = 1286,
    Tach = 962,
    ["Tach Domain"] = 963,
    Talhelper = 965,
    ["Talisman configuration"] = 966,
    Taplo = 1332,
    ["Taskfile config"] = 1121,
    Taurus = 967,
    Tauticord = 968,
    ["Tekton Pipeline"] = 1360,
    ["Tekton PipelineRun"] = 1361,
    ["Tekton Task"] = 1358,
    ["Tekton TaskRun"] = 1359,
    Telefonistka = 1318,
    ["Terrateam config"] = 1344,
    ["TestEnvironment.json"] = 980,
    ["TextMate Grammar"] = 979,
    Threagile = 974,
    ["Tier.run pricing.json"] = 971,
    Tikibase = 972,
    Tombi = 977,
    ["Traefik v2"] = 983,
    ["Traefik v2 File Provider"] = 984,
    ["Traefik v3"] = 985,
    ["Traefik v3 File Provider"] = 986,
    ["Travis CI (.travis.yml)"] = 982,
    Treefmt = 508,
    Trident = 1314,
    Trivy = 989,
    ["TrueScript for *.tscript files"] = 990,
    ["Tugboat QA config.yml"] = 1311,
    TunnelHub = 1226,
    Turborepo = 981,
    Tycho = 1275,
    Tye = 1152,
    ["Tyk Gateway - Open Source v5.7+"] = 1323,
    ["UET BuildConfig.json"] = 1196,
    ["UI5 Manifest"] = 1012,
    ["UNCORS configuration"] = 1017,
    ["UTAM Page Object"] = 1015,
    ["Ubuntu Server Autoinstall"] = 1010,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1315,
    ["Uniswap Token List"] = 1101,
    ["Universal Schedule Format"] = 1018,
    ["Unreal Engine Uplugin"] = 1197,
    ["Unreal Engine Uproject"] = 1198,
    ["UpCloud CLI (upctl) configuration"] = 1316,
    ["Updatecli Compose"] = 1160,
    ["Updatecli Policy Manifest"] = 1161,
    ["Updatecli Policy Metadata"] = 1162,
    Uplift = 1194,
    ["Upsun config"] = 12,
    ["User Journey Map"] = 1126,
    V2Ray = 1166,
    ["VSCode Code Snippets"] = 294,
    ["VSIX CLI publishing"] = 1037,
    Vector = 1020,
    ["Vela Pipeline Configuration"] = 1023,
    Vercel = 293,
    ["Version Bumper config"] = 1026,
    Vespertide = 1365,
    ["Vespertide Migration"] = 1366,
    ["Vespertide Model"] = 1367,
    ["Viash Component Config"] = 1320,
    ["Viash Package Config"] = 1321,
    Visivo = 1224,
    Vogi = 1031,
    ["WP-CLI"] = 1047,
    Wake = 1313,
    ["Waku Config"] = 1290,
    ["Web App Manifest"] = 1043,
    ["Web types"] = 1046,
    WebExtensions = 1042,
    ["Webman package recipe"] = 1172,
    ["Windows Package Manager Installer Manifest"] = 1098,
    ["Windows Package Manager Locale Manifest"] = 1099,
    ["Windows Package Manager Singleton Manifest"] = 1097,
    ["WireMock CLI import configuration"] = 1296,
    ["WireMock CLI local service configuration"] = 1295,
    ["WireMock message stub mapping"] = 1294,
    ["WireMock stub mapping"] = 1293,
    ["Woodpecker pipeline config"] = 1140,
    ["Wrangler CLI"] = 1048,
    ["XenForo add-on manifest"] = 1049,
    ["Xstate Machine"] = 1158,
    ["Yandex Workflow Language"] = 1282,
    ["Yarn Config (.yarnrc.yml)"] = 1114,
    ["Yippee-Ki-JSON configuration YML"] = 1105,
    ["YouTrack App"] = 1279,
    ["Zarf Package Configuration"] = 1346,
    ["Zerops import file"] = 1267,
    ["Zola Configuration"] = 1357,
    abtop = 33,
    act3 = 1395,
    actionlint = 43,
    ["aerleon.yml"] = 27,
    ["amplify.yml"] = 20,
    ["amxx-builder manifest"] = 1410,
    ["angular.json"] = 48,
    apko = 1229,
    ...
    ["behat.yml"] = 164,
    ["bigquery-table"] = 152,
    ["bioimageio resource description"] = 1246,
    ...
    ["cargo-nextest repository configuration"] = 680,
    ["cargo-nextest user configuration"] = 681,
    ["ccmod.json"] = 1291,
    changelogging = 1258,
    ["chezmoi configuration"] = 197,
    ["chisel-slices.json"] = 320,
    ["chrome-extension-locales-messages.json"] = 301,
    ["chutzpah.json"] = 302,
    cibuildwheel = 202,
    ["clang-format (.clang-format)"] = 1164,
    ["clang-tidy"] = 276,
    clangd = 275,
    clib = 277,
    ["cloud-init: cloud-config userdata"] = 279,
    ["cloud-sdk-pipeline-configuration"] = 304,
    ["cloudbuild.json"] = 305,
    cloudify = 278,
    cmakefmt = 220,
    ["cmdx.yaml"] = 113,
    ...
    ["commands.json"] = 297,
    ["commit-check"] = 323,
    ["commitlint (.commitlintrc)"] = 1100,
    ["committed.toml"] = 324,
    ["compile_commands.json"] = 296,
    ["compilerconfig.json"] = 295,
    ["completely.yml"] = 1202,
    ["component-detection-manifest.json"] = 327,
    ["component.json"] = 326,
    ["composer.json"] = 325,
    ["conda-forge"] = 206,
    ["config.yaml"] = 816,
    ["contentmanifest.json"] = 303,
    ["contribute.json"] = 328,
    ["cosmos.config.json"] = 299,
    ["crowdin.yml"] = 329,
    crucible = 333,
    ["ctfd-setup configuration file"] = 1303,
    ["custom-elements.json"] = 1216,
    ["cypress.json"] = 334,
    ["dacier.yml"] = 1398,
    ["datalogic-scan2deploy-android"] = 344,
    ["datalogic-scan2deploy-ce"] = 345,
    ...
    ["ddev-global"] = 346,
    ["ddev-project"] = 347,
    ["debugsettings.json"] = 348,
    ["dependabot-v2.json"] = 352,
    ["dependabot.json"] = 351,
    ["deployed-cli"] = 1157,
    devconcurrent = 252,
    ...
    djlint = 1108,
    ["docker bake"] = 358,
    ["docker sequencer"] = 359,
    ["docker-compose.yml"] = 1106,
    ["dockerd.json"] = 356,
    ["dotnet Release Index manifest"] = 371,
    ["dotnet-tools.json"] = 372,
    ["dotnetcli.host.json"] = 373,
    ["dprint.json"] = 374,
    ["drone.json"] = 375,
    ["dss-2.0.0.json"] = 377,
    ["dstack configuration"] = 378,
    ["dtool dataset metadata"] = 1298,
    ["dvc.yaml"] = 380,
    ["ecosystem.json"] = 385,
    ["editorconfig-checker"] = 387,
    eksctl = 388,
    ["electron-builder configuration file"] = 414,
    ["epr-manifest.json"] = 413,
    ["estampo.toml"] = 412,
    ["evcc.yaml"] = 415,
    ["ezd task runner"] = 426,
    ["fabric.mod.json"] = 429,
    ["first-timers-bot"] = 437,
    ["flagd flag configuration"] = 138,
    ["fly.io Configuration"] = 139,
    fulibWorkflows = 1139,
    ["function.json"] = 450,
    ["gRPC API Gateway & OpenAPI Config"] = 22,
    ["gematik health care insurance list"] = 1309,
    ["gematik health care patient list"] = 1306,
    ["gematik health care provider institution list"] = 1308,
    ["gematik health care provider list"] = 1307,
    ["gematik tiger test environment configuration"] = 1310,
    ["gh-dash"] = 464,
    ["gha-doctor"] = 465,
    ["git-cliff"] = 461,
    ["git-town.toml"] = 1355,
    ["github-settings-as-code"] = 842,
    ["gitlab-ci"] = 479,
    ["global.json"] = 496,
    ["glslint config"] = 1,
    ["go-feature-flag Flag Configuration"] = 500,
    ["gojo.yaml"] = 501,
    gollama = 499,
    ["hassette.toml"] = 524,
    ["haxelib.json"] = 520,
    ...
    ["ide.host.json"] = 537,
    ["ifstate.yaml"] = 538,
    ["imageoptimizer.json"] = 539,
    ["importmap.json"] = 542,
    ["index.toml (packwiz)"] = 1412,
    instant_python_config = 546,
    instant_python_custom_project = 547,
    intlayer = 548,
    ["ioBroker Configuration"] = 549,
    ["ioBroker JSON UI"] = 550,
    ["ioBroker Package manifest"] = 551,
    ["ixpect.conf.yaml"] = 552,
    ["ize.toml"] = 1193,
    ["jsconfig.json"] = 578,
    ["jscpd Configuration"] = 1177,
    jsdoc = 1089,
    ["k3d.yaml"] = 579,
    ["k9s aliases.yaml"] = 581,
    ["k9s cluster-config.yaml"] = 583,
    ["k9s config.yaml"] = 582,
    ["k9s hotkeys.yaml"] = 584,
    ["k9s plugins.yaml"] = 585,
    ["k9s skin.yaml"] = 586,
    ["k9s views.yaml"] = 587,
    ["kind cluster"] = 601,
    ["kontinuous-config.yaml"] = 599,
    ["kontinuous-values.yaml"] = 598,
    ["kustomization.yaml"] = 602,
    ["label-commenter-config.yml"] = 603,
    ["latexindent configuration"] = 128,
    ["launchsettings.json"] = 604,
    lazydocker = 1215,
    lazygit = 1214,
    ["lego.json"] = 606,
    ["lerna.json"] = 607,
    ["lgtm.yml"] = 608,
    ["liblab.config.json"] = 609,
    ["libman.json"] = 610,
    ["license-report-config.json"] = 611,
    ["linkinator.config.json"] = 613,
    ["lint-staged (.lintstagedrc)"] = 1066,
    ["local.settings.json"] = 618,
    ["localazy.json"] = 619,
    ["lotus.yaml"] = 617,
    ["lsd colors"] = 132,
    ["lsd config"] = 131,
    ...
    lychee = 1065,
    ["macro.json"] = 1181,
    ["markdown-link-check"] = 1135,
    maturin = 1136,
    mboats = 1143,
    memnex = 1396,
    ["micro-settings.json"] = 1208,
    ["mimetypes.json"] = 636,
    ["mirrord config"] = 1069,
    ["misata.yaml"] = 1068,
    mise = 1070,
    ["mkdocs.yml"] = 656,
    ["mockd.yaml"] = 660,
    ["mod.pw.toml (packwiz)"] = 1413,
    ["modelparams.dev Model"] = 663,
    ["models CLI"] = 664,
    ["monospace.yml"] = 665,
    ["moon.yml"] = 1292,
    ["mprocs Configuration file"] = 1262,
    ["mrdocs.yml"] = 658,
    ["mta.yaml"] = 1071,
    ["mtad.yaml"] = 1072,
    ["mycode.json"] = 673,
    nFPM = 685,
    ["napari plugin manifest"] = 674,
    neoload = 1084,
    ["nest-cli"] = 688,
    ["nexus-rpc-gen"] = 1382,
    ["nf-core module environment.yml"] = 682,
    ["nf-core module meta.yml"] = 683,
    ["nf-core subworkflow meta.yml"] = 684,
    ["ninjs (News in JSON)"] = 687,
    ["nitro.json"] = 1083,
    ["nixd configuration"] = 1234,
    ["nlu.json"] = 689,
    ["nodemon.json"] = 692,
    ["noodl config"] = 1142,
    ["notebook.mod.json"] = 693,
    now = 1079,
    ["npm-badges"] = 696,
    ["nswag.json"] = 700,
    ntangle = 702,
    ["nuclei-template.yaml"] = 697,
    ["nuget-project.json"] = 698,
    ["ocelot.json"] = 704,
    ogen = 710,
    ["omnisharp.json"] = 713,
    openHAB = 1368,
    ...
    oxfmt = 1378,
    oxlint = 1379,
    ["pack.toml (packwiz)"] = 1414,
    ["package.json"] = 749,
    ["package.manifest"] = 751,
    ["package.yaml"] = 750,
    ["partial-black.json"] = 165,
    ["partial-fastapi.json"] = 166,
    ["partial-pixi.json"] = 761,
    ["partial-scheduled.json"] = 167,
    ["pattern.json"] = 759,
    ["petstore-v1.0"] = 1188,
    pgap_yaml_input_reader = 757,
    pgrls = 758,
    pgxgen = 1372,
    pitcms = 1375,
    ["pixi.toml"] = 760,
    ["plagiarize-me.yaml"] = 765,
    ["plagiarize.yaml"] = 764,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1299,
    ["podbard.yaml"] = 767,
    ["portman.json"] = 770,
    ["prefect.toml"] = 779,
    ["prefect.yaml"] = 780,
    ...
    ["prettierrc.json"] = 782,
    ["prisma.yml"] = 783,
    ["project-1.0.0-beta3.json"] = 795,
    ["project-1.0.0-beta4.json"] = 796,
    ["project-1.0.0-beta5.json"] = 797,
    ["project-1.0.0-beta6.json"] = 798,
    ["project-1.0.0-beta8.json"] = 799,
    ["project-1.0.0-rc1.json"] = 800,
    ["project-1.0.0-rc2.json"] = 801,
    ["project.json"] = 794,
    ["project.owasp.yaml"] = 802,
    ["prometheus-alertmanager.json"] = 806,
    ["prometheus.json"] = 803,
    ["prometheus.rules.json"] = 804,
    ["prometheus.rules.test.json"] = 805,
    ["proxies.json"] = 807,
    ["publiccode.yml"] = 808,
    ["pubspec.yaml"] = 809,
    ["pyrseas-0.8.json"] = 812,
    pytest = 821,
    ["quilt.mod.json"] = 1209,
    ["rc3 auth"] = 827,
    ["rc3 collection"] = 828,
    ...
    ["rc3 settings"] = 832,
    ["registry.yaml"] = 61,
    ["release drafter"] = 1085,
    ["release-hub.json"] = 8,
    ["release-please-config.json"] = 837,
    ["release-please-manifest.json"] = 838,
    ["release-plz.toml"] = 839,
    ["renv.lock"] = 854,
    ["reposets Configuration"] = 843,
    ["reposets Credentials"] = 844,
    ["revola.json"] = 6,
    ["rivet.json"] = 1233,
    ["rivet.yaml (legacy)"] = 1232,
    rumdl = 859,
    runny = 858,
    runspec = 1397,
    rustfmt = 860,
    ...
    samt = 863,
    samtrc = 864,
    ["sarif-1.0.0.json"] = 866,
    ["sarif-2.0.0.json"] = 867,
    ["sarif-2.1.0"] = 877,
    ["sarif-2.1.0-rtm.2"] = 868,
    ["sarif-2.1.0-rtm.3"] = 870,
    ["sarif-2.1.0-rtm.4"] = 872,
    ["sarif-2.1.0-rtm.5"] = 874,
    ["sarif-2.1.0-rtm.6"] = 875,
    ["sarif-external-property-file-2.1.0"] = 878,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 869,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 871,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 873,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 876,
    ["scalingo.json configuration"] = 879,
    ["schema.org - Action"] = 881,
    ["schema.org - ContactPoint"] = 882,
    ["schema.org - Place"] = 883,
    ["schema.org - Thing"] = 884,
    ["secrethub.yml"] = 1211,
    ["semantic-release"] = 892,
    ["servicehub.config.json"] = 1060,
    ["servicehub.service.json"] = 1059,
    ["settings.job"] = 895,
    ["sfdx-hardis configuration"] = 897,
    ["shard.yml"] = 1249,
    ["size-limit configuration"] = 902,
    ["skaffold.yaml"] = 1133,
    ["skill-map plugin extension manifest"] = 903,
    ["skill-map project settings"] = 904,
    ["skill-map provider kind"] = 905,
    ["skyuxconfig.json"] = 907,
    ["snowflake-config"] = 909,
    ["snowflake-connections"] = 910,
    ["spicepod.yaml"] = 1270,
    ["sqlc configuration"] = 944,
    ["stripe-app-local.json"] = 955,
    ["stripe-app.json"] = 954,
    swcrc = 1117,
    ["task.json"] = 964,
    taskcat = 1080,
    ["template.json"] = 969,
    ["templatsources.json"] = 970,
    ["text2confl config"] = 1380,
    ["theme.json"] = 973,
    ["tizen_workspace.json"] = 975,
    tldr = 976,
    ["tm_devices configuration file"] = 1337,
    tmuxinator = 1063,
    tox = 978,
    ["transcend.yml"] = 987,
    ["tree-sitter grammar.json"] = 507,
    ["trime.yaml"] = 988,
    ["trunk.yaml"] = 991,
    ["ts-force-config.json"] = 997,
    tsbuild = 992,
    ["tsconfig.json"] = 993,
    ["tsd.json"] = 994,
    ["tsdoc.json"] = 995,
    ...
    v8r = 1041,
    vcluster = 1256,
    ["vcpkg configuration file"] = 292,
    ["vcpkg manifest file"] = 291,
    ["vega-lite.json"] = 1022,
    ["vega.json"] = 1021,
    ["venvironment.yaml"] = 1024,
    ["venvplus.yaml"] = 1025,
    version = 1319,
    ["version.json"] = 1027,
    ["vhwdebugger-binding.yaml"] = 1029,
    ["vim-addon-info"] = 1030,
    ["vs-2017.3.host.json"] = 1033,
    ["vs-nesting.json"] = 1034,
    ["vsls.json"] = 1032,
    ["vss-extension.json"] = 1038,
    vtcfg = 1325,
    ["vtesttree.yaml"] = 1039,
    ["vtestunit.yaml"] = 1040,
    ["warp-keysets.json"] = 1217,
    ["warp-themes.json"] = 1218,
    ["warp-workflows.json"] = 1219,
    ["webhint.io"] = 1173,
    ["webjobpublishsettings.json"] = 1045,
    ["webjobs-list.json"] = 1044,
    ["well-known-fursona"] = 1257,
    ["xs-app.json"] = 1075,
    ["xunit.runner.json"] = 1058,
    ["yaml-workflow"] = 1420,
    yamlfmt = 1102,
    yamllint = 1103,
    ["yap.json"] = 1104,
