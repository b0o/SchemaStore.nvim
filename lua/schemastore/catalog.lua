...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 915,
    [".nodehawkrc"] = 564,
    [".npmpackagejsonlintrc"] = 568,
    [".omletrc"] = 1094,
    [".phrase.yml"] = 639,
    [".phraseapp.yml"] = 640,
    [".pmbot.yml"] = 625,
    [".postcssrc"] = 634,
    [".powerpages-web-template-manifest"] = 636,
    [".pre-commit-config.yml"] = 637,
    [".pre-commit-hooks.yml"] = 638,
    [".putout.json"] = 672,
    [".rehyperc"] = 697,
    [".remarkrc"] = 701,
    [".sprite files"] = 792,
    ...
    AIConfig = 31,
    ["AMX Muse Program Descriptor"] = 1142,
    ["API Builder"] = 950,
    ["AVA Configuration"] = 1013,
    ["AWS AppConfig Feature Flags-v1"] = 65,
    ["AWS CDK cdk.json"] = 250,
    ["AWS CloudFormation"] = 251,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 252,
    ["AWS Copilot Manifest"] = 1181,
    ["AWS SAM CLI Samconfig"] = 253,
    ["Adobe UXP Manifest"] = 1076,
    ["Aerleon Network & Service Definitions"] = 18,
    ["Aerleon Policy"] = 19,
    Aider = 1171,
    Air = 21,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1192,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1191,
    ["Airlock Microgateway"] = 32,
    ["Alacritty Configuration"] = 985,
    ["All Contributors configuration file"] = 1039,
    ["Ansible Argument Specs"] = 385,
    ["Ansible Collection Galaxy"] = 392,
    ["Ansible Execution Environment"] = 382,
    ["Ansible Inventory"] = 391,
    ["Ansible Meta"] = 383,
    ["Ansible Meta Runtime"] = 384,
    ["Ansible Navigator Configuration"] = 394,
    ["Ansible Playbook"] = 389,
    ["Ansible Requirements"] = 386,
    ["Ansible Rulebook"] = 390,
    ["Ansible Tasks File"] = 388,
    ["Ansible Vars File"] = 387,
    ["Ansible-lint Configuration"] = 393,
    Any = 1104,
    ...
    ["Application list for a WinUtil"] = 1121,
    ArchitectFX = 1126,
    ["Argo CD"] = 51,
    ["Argo Events"] = 52,
    ["Argo Workflows"] = 53,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1190,
    ["Azure IoT Operations connector metadata"] = 1187,
    ...
    ["Azure Pipelines"] = 107,
    ["Azure Static Web Apps CLI configuration file"] = 796,
    ["Azure Static Web Apps configuration file"] = 795,
    ["BOSH CPI Config"] = 131,
    ["BOSH Deploy Config"] = 132,
    ["BX CI"] = 151,
    ["Bacon config"] = 3,
    ["Bashly (bashly.yml)"] = 1043,
    ["Bashly Settings (bashly-settings.yml)"] = 1044,
    Bento = 1208,
    ["Better Code Hub"] = 955,
    ["Better Scripts"] = 152,
    Bigconfig = 124,
    ["Biome Formatter Config"] = 79,
    ["Bitmovin Encoding Template"] = 1135,
    BizTalkServerApplicationSchema = 922,
    Bleep = 153,
    ["Block Protocol Metadata"] = 150,
    ["Boyka Framework"] = 133,
    Briefcase = 928,
    ["Build Info"] = 141,
    Buildkite = 143,
    ["Bukkit plugin.yml"] = 142,
    ["BungeeCord plugin.yml"] = 148,
    ["Butane Config"] = 998,
    C4InterFlow = 1150,
    ["CDK Environment Manager, concrete environment configuration"] = 1174,
    ["CDK Environment Manager, concrete environments definition"] = 1173,
    ["CDK Environment Manager, environment definition"] = 1172,
    ["CGS Card Game Specification (cgs.json)"] = 1081,
    ["CICS TS region tagging"] = 1007,
    ["CICS TS resource import"] = 1008,
    ["CICS TS resource model"] = 1009,
    ["CICS TS resource overrides"] = 1010,
    ["CMake Presets"] = 154,
    ["CNC Codes"] = 175,
    ["CRS WAF test file"] = 1111,
    ["CRS WAF test platform overrides file"] = 1112,
    ["CSS Comb (.csscomb.json)"] = 278,
    ["CSS Lint (.csslintrc)"] = 279,
    ["CSpell (cspell.json)"] = 277,
    ["CVE Record Format"] = 183,
    CWL = 1087,
    ["Cache Warmup config"] = 155,
    ["Calqulus pipeline"] = 156,
    ["Camel YAML DSL"] = 157,
    ["Cannon TOML"] = 158,
    Carafe = 159,
    ["Cargo Make"] = 161,
    ["Cargo Manifest"] = 160,
    ["Catalog Info Backstage"] = 162,
    ["Chamaleon environment"] = 1139,
    ["Chamaleon properties"] = 1140,
    ["Chamaleon template"] = 1138,
    Changepacks = 1201,
    Changesets = 262,
    Changie = 163,
    Charmcraft = 164,
    Cheatsheets = 995,
    ["ChordPro Configuration"] = 165,
    ["Chrome Extension"] = 243,
    ["Chromia Model"] = 166,
    ["Chromia Seeder Module Config"] = 168,
    ["Chromia Seeder Root Config"] = 167,
    ["Cinnamon Spice info.json"] = 87,
    ["CircleCI config.yml"] = 218,
    ["Citation File Format"] = 264,
    CityJSON = 170,
    ["Claude Code Settings"] = 182,
    ["Clawject config"] = 181,
    ["Cloud Foundry Application Manifest"] = 1093,
    ["Cloud Run Spec v1"] = 1116,
    ...
    ["CloudEvents specification"] = 171,
    ["Code Climate"] = 219,
    CodeCV = 91,
    CodeRabbit = 90,
    ["CodeShip Pro services configuration files"] = 232,
    ["CodeShip Pro steps configuration files"] = 233,
    ["Codecov configuration files"] = 231,
    Codex = 227,
    CodifyCLI = 92,
    Codux = 229,
    ["Cog config file"] = 176,
    ["Commandbox Box.json"] = 177,
    ["Commandbox Server.json"] = 178,
    ["Common Catalog Data"] = 241,
    ["Common Package Specification"] = 179,
    Concord = 1110,
    ["Configu .cfgu files"] = 1098,
    ["Configu .configu file"] = 1099,
    Conjure = 174,
    ["Container Structure Test"] = 936,
    Containerlab = 964,
    ["Contextive Glossary"] = 1166,
    Convex = 173,
    ["Crowdsec collection config"] = 272,
    ["Crowdsec parser config"] = 273,
    ["Crowdsec scenario config"] = 274,
    ["CumulusCI Config"] = 180,
    ["Custom Machinery Machine"] = 1082,
    ["Custom Machinery Recipe"] = 1083,
    ["Cycle Stack File"] = 184,
    CycloneDX = 185,
    ["DWP Exchange - catalogue entry"] = 321,
    ["DWP Exchange - gateway"] = 319,
    ["DWP Exchange - meta"] = 320,
    ["Dart Build Config (dart-build.json)"] = 280,
    ["Dart Test Config (dart-test.json)"] = 281,
    ["DashLord Configuration"] = 282,
    ["Data Contract Specification"] = 283,
    ["Data Product Specification"] = 284,
    ["DataYoga Connections"] = 186,
    ["DataYoga Job"] = 187,
    ["Databricks Asset Bundles"] = 1060,
    ["Datadog Continuous Testing"] = 483,
    ["Datadog Service Definition"] = 484,
    ["Datadog Software Catalog"] = 485,
    ["Datahub Ingestion Recipe"] = 1014,
    ["Debian Upstream Metadata file"] = 193,
    ["Deck config"] = 194,
    ["Dein Config"] = 195,
    ["Deno Config (deno.json)"] = 290,
    ["Dependency cruiser"] = 196,
    ["DeployStack Configuration"] = 197,
    ["Deployah Configuration"] = 1189,
    ["Deployer Recipe"] = 293,
    ["Deta Spacefile"] = 198,
    ["Detekt Config (detekt.yml)"] = 294,
    ["Devbox Config"] = 199,
    ["Devbox Plugin"] = 200,
    Devfile = 318,
    Devup = 1202,
    DipDup = 1113,
    ["Discord Webhook"] = 295,
    ["DocFx Config (docfx.json)"] = 299,
    Dofigen = 300,
    ["Dolittle Artifacts"] = 301,
    ["Dolittle Bounded Context Configuration"] = 302,
    ["Dolittle Event Horizons Configuration"] = 303,
    ["Dolittle Resources Configuration"] = 304,
    ["Dolittle Server Configuration"] = 305,
    ["Dolittle Tenant Map Configuration"] = 307,
    ["Dolittle Tenants Configuration"] = 306,
    ["Dolittle Topology"] = 308,
    ["DonateCaseBetterCasino menu"] = 1143,
    ["Drupal Breakpoints"] = 201,
    ["Drupal Config"] = 213,
    ["Drupal Info"] = 202,
    ["Drupal Layouts"] = 203,
    ["Drupal Libraries"] = 204,
    ["Drupal Links Action"] = 205,
    ["Drupal Links Contextual"] = 206,
    ["Drupal Links Menu"] = 207,
    ["Drupal Links Task"] = 208,
    ["Drupal Migration"] = 209,
    ["Drupal Permissions"] = 210,
    ["Drupal Recipe"] = 211,
    ["Drupal Routing"] = 212,
    ["Drupal Services"] = 214,
    ["Drush site aliases"] = 314,
    ["Dynamic Bash Aliases (.aliases)"] = 1051,
    ["EAS config"] = 338,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1040,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1186,
    ["EasyVCR .NET"] = 339,
    ["Eidolon Resource"] = 1127,
    ["Elgato Stream Deck"] = 324,
    Elm = 1115,
    ["Embrace Config"] = 1026,
    Endurica = 1064,
    ["Enterprise Contract Policy Spec"] = 325,
    ["Erda Pipeline"] = 1089,
    ["Erda Runtime"] = 1090,
    ["Espanso config.yml"] = 1211,
    ["Espanso match.yml"] = 1210,
    Esquio = 327,
    ["Estuary Flow Catalog"] = 1004,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 331,
    ["EveryVoice TTS Toolkit Data Configuration"] = 332,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 336,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 335,
    ["EveryVoice TTS Toolkit Text Configuration"] = 333,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 334,
    ["Evolving Resolutive Process notation"] = 1188,
    ["Expo SDK"] = 337,
    ["F-Droid Data metadata"] = 343,
    ["FasterCI Configuration"] = 108,
    FiQuS = 347,
    Firebase = 345,
    ["FlexGet Config"] = 348,
    ["Flow.json Configurations"] = 1086,
    ["Fossa configuration file"] = 355,
    ["Fossa's fossa-deps file"] = 356,
    ["Foundry VTT - Base package Manifest"] = 350,
    ["Foundry VTT - Module Manifest"] = 351,
    ["Foundry VTT - System Data Template"] = 354,
    ["Foundry VTT - System Manifest"] = 352,
    ["Foundry VTT - World Manifest"] = 353,
    ["Foxx Manifest"] = 109,
    ["Freifunk.de Community API"] = 112,
    ["Frogbot Config"] = 113,
    ["G2P Mapping Configuration"] = 362,
    ["GCP Blueprint Metadata"] = 365,
    Gaspar = 363,
    ["GatewayCore API Gateway"] = 364,
    ["Gemini CLI settings"] = 366,
    ["GeoJSON.json latest"] = 1002,
    GherKing = 1006,
    ["GitHub Action"] = 371,
    ["GitHub Actions typing"] = 1123,
    ["GitHub Discussion"] = 372,
    ["GitHub Funding"] = 373,
    ["GitHub Issue Template configuration"] = 374,
    ["GitHub Issue Template forms"] = 375,
    ["GitHub Workflow"] = 376,
    ["GitHub Workflow Template Properties"] = 377,
    ["GitHub automatically generated release notes configuration"] = 378,
    ["GitLab Agent for Kubernetes configuration"] = 1078,
    GitVersion = 368,
    ["Gitea Issue Template configuration"] = 369,
    ["Gitea Issue Template forms"] = 370,
    ["Gitpod Automations"] = 380,
    ["Gitpod Configuration"] = 381,
    ["GlazeWM settings"] = 1080,
    ["Global Privacy Control"] = 367,
    Goblet = 1059,
    ["Golangci-lint Configuration"] = 396,
    ["Golangci-lint Custom Plugins Configuration"] = 397,
    ["Google Chrome Related Website Sets"] = 346,
    ["Google Cloud Workflows"] = 249,
    ["Google Digital Assetlinks"] = 1167,
    Goreleaser = 399,
    ["Goreleaser Pro"] = 400,
    Goss = 401,
    ["Gradle Build Cache Node"] = 953,
    ["Gradle Enterprise"] = 952,
    ["Grafana 5.x Dashboard"] = 402,
    ["GraphQL Code Generator"] = 407,
    ["GraphQL Config"] = 406,
    ["GraphQL Mesh"] = 405,
    ["GroovyLint configuration"] = 408,
    ["Grunt JSHint task"] = 412,
    ["Grunt Watch task"] = 413,
    ["Grunt base task"] = 414,
    ["Grunt clean task"] = 410,
    ["Grunt copy task"] = 409,
    ["Grunt cssmin task"] = 411,
    HEMTT = 918,
    Hadolint = 932,
    Hammerkit = 963,
    ["Hardware Sentry Configuration"] = 1018,
    ["HashiCorp Vault"] = 415,
    Hatch = 933,
    Hayson = 417,
    ["Haystack Pipeline"] = 418,
    ["Hazelcast 5 Configuration"] = 419,
    ["Hecate Input Schema"] = 1178,
    ["Helm Chart.lock"] = 216,
    ["Helm Chart.yaml"] = 215,
    ["Helm Unittest Test Suite"] = 217,
    ["Home Assistant Integration Manifest"] = 420,
    ["Homer dashboard configuration"] = 421,
    Hugo = 994,
    ["Hugo Theme"] = 993,
    ["Hulak Configuration"] = 428,
    ["Hyperfoil benchmark configuration"] = 427,
    ["IBM Zapp document"] = 429,
    ["IBM zCodeFormatSettings"] = 430,
    ["IMG Catapult PSP"] = 435,
    ["IVMS101 by CODE Protocol"] = 1079,
    Infrahub = 437,
    Istanbul = 1022,
    ["JDownloader2 crawler multi-rules"] = 450,
    ["JDownloader2 crawler single-rules"] = 449,
    ["JFrog Applications Config"] = 451,
    ["JFrog File Spec"] = 452,
    ["JFrog Pipelines YML DSL"] = 1028,
    ["JMeter DSL cli config"] = 453,
    JReleaser = 456,
    ["JSON Document Transform"] = 464,
    ["JSON Feed"] = 465,
    ["JSON Resume"] = 707,
    ["JSON Schema Draft 2020-12"] = 900,
    ["JSON Schema Draft 4"] = 897,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1061,
    ["JSON Schema Draft 7"] = 898,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1062,
    ["JSON Schema Draft 8 (2019-09)"] = 899,
    ["JSON-API"] = 463,
    ["JSON-e templates"] = 960,
    ["JSON-stat 2.0"] = 893,
    JSONPatch = 467,
    ["JSR Package Config (jsr.json)"] = 457,
    Jarl = 1194,
    Jasmine = 444,
    Jekyll = 445,
    ["Jenkins X Pipelines"] = 446,
    ["Jenkins X Requirements"] = 447,
    Jest = 448,
    Jocker = 454,
    ["Jovo Language Models"] = 455,
    ["Jujutsu (jj) VCS config"] = 1180,
    ["KIMMDY config file"] = 478,
    ["KODE/CI build.yaml"] = 1024,
    ["KSP-AVC"] = 894,
    ["KSP-CKAN"] = 895,
    ["KSP-NetKAN"] = 896,
    KSY = 1091,
    KSail = 360,
    ["KYA Manifest"] = 1092,
    ["Karakum configuration file"] = 357,
    Kas = 470,
    ["Kestra flow file"] = 479,
    ["Keycloak REST API"] = 1031,
    ["Knative Functions - func.yaml"] = 358,
    Knip = 359,
    ["Kometa (nightly) config file"] = 481,
    ["Kometa config file"] = 480,
    ["Kong DBLess config"] = 1025,
    KrakenD = 482,
    ["Kubri Configuration"] = 489,
    LOOBin = 504,
    ["Lake configuration file"] = 1183,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 254,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 255,
    ["Landing Zone Accelerator on AWS - Global Config"] = 256,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 257,
    ["Landing Zone Accelerator on AWS - Network Config"] = 258,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 259,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 260,
    ["Landing Zone Accelerator on AWS - Security Config"] = 261,
    ["Lando (landofile)"] = 103,
    ["LangGraph Platform configuration"] = 1103,
    ["Language configuration"] = 1102,
    Lefthook = 493,
    ["Liferay client-extension.yaml"] = 500,
    ["LinkML Metamodel"] = 502,
    Liquibase = 969,
    ["Liquibase Flow File"] = 970,
    ["Lively Properties"] = 503,
    ["Lobe AI Agent"] = 105,
    Loki = 106,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 544,
    ["MS2Rescore Configuration"] = 547,
    ["Madness (madness.yml)"] = 1042,
    ["Mado configuration"] = 510,
    ["MapEHR Mapping"] = 511,
    Markdownlint = 973,
    ["Mason Registry"] = 976,
    ["MegaLinter Custom Flavor"] = 514,
    ["MegaLinter configuration"] = 513,
    ["MegaLinter descriptor"] = 515,
    Melange = 1069,
    ["Meltano project definition"] = 516,
    ["Mergify Configuration"] = 548,
    ["Metadata for a Bazel module"] = 517,
    ["Metadata for a Cinnamon spice"] = 1119,
    ["Metatype Configuration"] = 518,
    ["MetricsHub Configuration"] = 519,
    ["MetricsHub Connector Configuration"] = 520,
    ["Micro Editor Syntax"] = 1052,
    ["Microsoft Band Web Tile"] = 521,
    ["Microsoft RulesEngine workflow rules"] = 1107,
    ["Microsoft RulesEngine workflow rules list"] = 1108,
    ["Minecraft Custom Main Menu Mod"] = 1070,
    ["Minecraft Data Pack Advancement"] = 523,
    ["Minecraft Data Pack Biome"] = 524,
    ["Minecraft Data Pack Configured Carver"] = 525,
    ["Minecraft Data Pack Damage Type"] = 526,
    ["Minecraft Data Pack Dimension"] = 528,
    ["Minecraft Data Pack Dimension Type"] = 527,
    ["Minecraft Data Pack Item Modifier"] = 529,
    ["Minecraft Data Pack Loot Table"] = 530,
    ["Minecraft Data Pack Metadata"] = 531,
    ["Minecraft Data Pack Predicate"] = 532,
    ["Minecraft Data Pack Recipe"] = 533,
    ["Minecraft Data Pack Tag"] = 534,
    ["Minecraft Data Pack Template Pool"] = 535,
    ["Minecraft Data Pack Trim Material"] = 540,
    ["Minecraft Data Pack Trim Pattern"] = 541,
    ["Minecraft Resource Pack Lang"] = 536,
    ["Minecraft Resource Pack Particle"] = 537,
    ["Minecraft Resource Pack Texture Mcmeta"] = 539,
    ["Minecraft Resourcepack Sounds"] = 538,
    ["Monade CLI Stack Configuration"] = 551,
    ["MongoDB Atlas Search Index Definition"] = 1023,
    ["Monika Configuration"] = 1021,
    ["Monoweave Configuration"] = 546,
    ["Motif config"] = 914,
    MultiQC = 1160,
    ["NOX Framework (Service)"] = 567,
    ["Netin Diagnostic System Template"] = 980,
    ["Netlify config"] = 554,
    ["Network-as-Code Data Model"] = 555,
    ["Next Gen UI Agent A2A Server Configuration"] = 556,
    ["Next Gen UI Agent Configuration"] = 558,
    ["Next Gen UI Agent MCP Server Configuration"] = 557,
    ["Nightwatch.js"] = 560,
    ["Node.js configuration"] = 919,
    ["NueJS configuration file"] = 572,
    ["Nuitka.yaml"] = 1084,
    ["Nullstone config"] = 574,
    ["ONe's changelog entry"] = 592,
    ["ONe's service descriptor"] = 591,
    ["ORT Server repository environment configuration"] = 601,
    ["OSCAL Assessment Plan (AP)"] = 603,
    ["OSCAL Assessment Results (AR)"] = 604,
    ["OSCAL Catalog"] = 605,
    ["OSCAL Component Definition (CDef)"] = 606,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 607,
    ["OSCAL Profile"] = 608,
    ["OSCAL System Security Plan (SSP)"] = 609,
    ["OSS Review Toolkit configuration"] = 610,
    ["OSS Review Toolkit curation"] = 611,
    ["OSS Review Toolkit package configuration"] = 612,
    ["OSS Review Toolkit repository configuration"] = 613,
    ["OSS Review Toolkit resolutions"] = 614,
    ["October CMS columns"] = 578,
    ["October CMS fields"] = 579,
    ["Oh My Posh"] = 580,
    Okteto = 581,
    ["Ona Automations"] = 583,
    Opctl = 917,
    ["Open Data Contract Standard (ODCS)"] = 595,
    ["Open Data Product Standard (ODPS)"] = 596,
    ["Open Know-How"] = 1165,
    ["OpenRewrite Resource"] = 594,
    OpenSRM = 597,
    OpenStatus = 1176,
    ["OpenUtau character yaml"] = 588,
    ["OpenUtau ustx"] = 589,
    ["OpenWeather Current Weather API"] = 959,
    ["OpenWeather Road Risk API"] = 958,
    ["Ory Hydra configuration"] = 426,
    ["Ory Keto configuration"] = 486,
    ["Ory Kratos configuration"] = 602,
    ["Ory Oathkeeper configuration"] = 576,
    ["Outblocks App configuration"] = 599,
    ["Outblocks database table"] = 600,
    ["Outblocks project configuration"] = 598,
    PDM = 621,
    POPxf = 631,
    ["POPxf Correlations"] = 632,
    Packer = 618,
    Pantsbuild = 1038,
    ["Paper paper-plugin.yml"] = 619,
    ["Pipeline component"] = 971,
    ["Platform.sh application"] = 5,
    ["Platform.sh routes"] = 6,
    ["Platform.sh services"] = 7,
    ["Plex Prerolls"] = 629,
    ["PocketMine plugin.yml"] = 626,
    ["Postman collection"] = 635,
    ["Power Pages Configuration"] = 1177,
    ["Preset list for a WinUtil"] = 1122,
    ["ProActions AI-Kit Configuration"] = 645,
    ["ProActions AI-Kit Configuration for Menus"] = 647,
    ["ProActions AI-Kit Configuration for Sections"] = 649,
    ["ProActions AI-Kit Configuration for Services"] = 646,
    ["ProActions AI-Kit Configuration for Steps"] = 650,
    ["ProActions AI-Kit Configuration for Templates"] = 648,
    ["Problem object RFC9457"] = 1067,
    ["Problem package format"] = 651,
    ["Problem package generators"] = 652,
    ["Problem package submissions"] = 653,
    ["Problem package test group metadata"] = 654,
    Pterodactyl = 1017,
    ["Pull Request Labeler"] = 671,
    Pulumi = 679,
    ["PyGTA Config"] = 675,
    PyProject = 680,
    Pylock = 1168,
    Pyright = 681,
    ["Python script metadata"] = 1162,
    ["QType AI DSL"] = 684,
    Qgoda = 683,
    Qodana = 990,
    ["Qt Creator workspace file"] = 1100,
    ["Quali Torque Blueprint Spec 2"] = 1015,
    ["QueryFirst config file"] = 1034,
    ["RKE Cluster Configuration JSON"] = 968,
    ["RKE Cluster Configuration YAML"] = 967,
    RadioHound = 674,
    Railpack = 686,
    Railway = 685,
    ["Rancher Fleet"] = 676,
    ...
    Ray = 931,
    ["Read the Docs"] = 678,
    ["Red-DiscordBot Cog"] = 694,
    ["Red-DiscordBot Cog Repo"] = 695,
    ["Red-DiscordBot Trivia"] = 696,
    ["Releasaurus Config"] = 2,
    ["Render Blueprints"] = 966,
    RenderCV = 711,
    Renovate = 708,
    ["Renovate global configuration"] = 709,
    ["Renovate inherited configuration"] = 710,
    ["Replit config"] = 702,
    Restate = 1155,
    ["Revel Digital Gadget Definition File"] = 1179,
    RoadRunner = 713,
    ["Robust Station Image"] = 1185,
    Rockcraft = 714,
    ["Roo Coder Custom Modes"] = 715,
    Rubocop = 704,
    ["Rudder techniques"] = 1074,
    Ruff = 705,
    ["Rust Project"] = 706,
    ["Rust toolchain"] = 719,
    ["SDMX data message"] = 745,
    ["SDMX metadata message"] = 744,
    ["SDMX structure message"] = 743,
    ["SIL Kit Participant Configuration"] = 755,
    ["SIL Kit Registry Configuration"] = 756,
    ["SPDX 2.3"] = 793,
    SWADL = 809,
    ["Safebox Config"] = 1029,
    ["Sapphire CLI Config"] = 722,
    ["SauceCTL Configuration"] = 977,
    ["Schema Catalog"] = 737,
    ["Scoop manifest"] = 742,
    ["Semantic Data Fabric (SDF) file"] = 746,
    ["Semgrep Rule"] = 748,
    ["Serenity Code Generator (Sergen)"] = 749,
    ["Serverless Framework Configuration"] = 984,
    ["Serverless Workflow"] = 986,
    ["Settings for a Cinnamon spice"] = 1118,
    ["Settings.paf"] = 751,
    ["Shopware 6 Configuration"] = 987,
    ["Shopware CLI Extension Store Configuration"] = 988,
    ["Shopware CLI Project Store Configuration"] = 989,
    ["Sigma Detection Rule"] = 753,
    ["Sigrid scope configuration file"] = 754,
    ["SkyPilot Task JSON"] = 1075,
    ["Slack app manifest"] = 758,
    Snapcraft = 760,
    Solidarity = 763,
    ["Solution filters"] = 764,
    ["Source Maps v3"] = 765,
    Sourcery = 766,
    ["Spack bootstrap.yaml"] = 767,
    ["Spack cdash.yaml"] = 768,
    ["Spack ci.yaml"] = 769,
    ["Spack compilers.yaml"] = 770,
    ["Spack concretizer.yaml"] = 771,
    ["Spack config.yaml"] = 772,
    ["Spack definitions.yaml"] = 773,
    ["Spack develop.yaml"] = 774,
    ["Spack env_vars.yaml"] = 775,
    ["Spack environment"] = 781,
    ["Spack include.yaml"] = 776,
    ["Spack mirrors.yaml"] = 777,
    ["Spack modules.yaml"] = 778,
    ["Spack packages.yaml"] = 779,
    ["Spack repos.yaml"] = 780,
    ["Spack toolchains.yaml"] = 782,
    ["Spack upstreams.yaml"] = 783,
    ["Spack view.yaml"] = 784,
    ["Speakeasy Generation Config File"] = 788,
    ["Speakeasy Lint Configuration File"] = 785,
    ["Speakeasy Test Generation Configuration File"] = 786,
    ["Speakeasy Workflow File"] = 787,
    SpecIF = 789,
    ["Specmatic Configuration"] = 790,
    ["Sponge Mixin configuration"] = 791,
    StackBlitz = 797,
    ["StackHawk Scanner Configuration"] = 983,
    Stale = 798,
    Starfish = 799,
    ["Starlake Data Pipeline"] = 956,
    Starship = 800,
    ["Statamic Blueprint"] = 801,
    ["Stella configuration file"] = 802,
    ["Streamlit configuration file"] = 803,
    ["Stryker Mutator"] = 806,
    ["StyleCop Analyzers Configuration"] = 807,
    ["Stylelint (.stylelintrc)"] = 808,
    ["Stylua Config"] = 1169,
    ["Sublime Syntax"] = 1030,
    ["Subsquid squid manifest"] = 1077,
    ["Swagger API 2.0"] = 810,
    ["Synadia Connect Component"] = 811,
    TSON = 846,
    TSTyche = 847,
    ["TYPO3 Vendor Bundler config"] = 852,
    ["Tab data for a LinUtil"] = 1125,
    ["Tab list for a LinUtil"] = 1124,
    Tach = 812,
    ["Tach Domain"] = 813,
    Talhelper = 815,
    ["Talisman configuration"] = 816,
    Taplo = 1170,
    ["Taskfile config"] = 961,
    Taurus = 817,
    Tauticord = 818,
    ["Tekton Pipeline"] = 1198,
    ["Tekton PipelineRun"] = 1199,
    ["Tekton Task"] = 1196,
    ["Tekton TaskRun"] = 1197,
    Telefonistka = 1156,
    ["Terrateam config"] = 1182,
    ["TestEnvironment.json"] = 829,
    ["TextMate Grammar"] = 828,
    Threagile = 824,
    ["Tier.run pricing.json"] = 821,
    Tikibase = 822,
    Tombi = 827,
    ["Traefik v2"] = 832,
    ["Traefik v2 File Provider"] = 833,
    ["Traefik v3"] = 834,
    ["Traefik v3 File Provider"] = 835,
    ["Travis CI (.travis.yml)"] = 831,
    Treefmt = 404,
    Trident = 1152,
    ["TrueScript for *.tscript files"] = 838,
    ["Tugboat QA config.yml"] = 1149,
    TunnelHub = 1065,
    Turborepo = 830,
    Tycho = 1114,
    Tye = 991,
    ["Tyk Gateway - Open Source v5.7+"] = 1161,
    ["UET BuildConfig.json"] = 1035,
    ["UI5 Manifest"] = 858,
    ["UNCORS configuration"] = 862,
    ["UTAM Page Object"] = 861,
    ["Ubuntu Server Autoinstall"] = 856,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1153,
    ["Uniswap Token List"] = 943,
    ["Universal Schedule Format"] = 863,
    ["Unreal Engine Uplugin"] = 1036,
    ["Unreal Engine Uproject"] = 1037,
    ["UpCloud CLI (upctl) configuration"] = 1154,
    ["Updatecli Compose"] = 999,
    ["Updatecli Policy Manifest"] = 1000,
    ["Updatecli Policy Metadata"] = 1001,
    Uplift = 1033,
    ["Upsun config"] = 4,
    ["User Journey Map"] = 965,
    V2Ray = 1005,
    ["VSCode Code Snippets"] = 237,
    ["VSIX CLI publishing"] = 881,
    Vector = 865,
    ["Vela Pipeline Configuration"] = 868,
    Vercel = 236,
    ["Version Bumper config"] = 871,
    Vespertide = 1203,
    ["Vespertide Migration"] = 1204,
    ["Vespertide Model"] = 1205,
    ["Viash Component Config"] = 1158,
    ["Viash Package Config"] = 1159,
    Visivo = 1063,
    ["WP-CLI"] = 891,
    Wake = 1151,
    ["Waku Config"] = 1128,
    ["Web App Manifest"] = 887,
    ["Web types"] = 890,
    WebExtensions = 886,
    ["Webman package recipe"] = 1011,
    ["Windows Package Manager Installer Manifest"] = 939,
    ["Windows Package Manager Locale Manifest"] = 940,
    ["Windows Package Manager Singleton Manifest"] = 938,
    Winutil = 941,
    ["WireMock CLI import configuration"] = 1134,
    ["WireMock CLI local service configuration"] = 1133,
    ["WireMock message stub mapping"] = 1132,
    ["WireMock stub mapping"] = 1131,
    ["Woodpecker pipeline config"] = 979,
    ["Wrangler CLI"] = 892,
    ["Xstate Machine"] = 997,
    ["Yandex Workflow Language"] = 1120,
    ["Yarn Config (.yarnrc.yml)"] = 954,
    ["Yippee-Ki-JSON configuration YML"] = 945,
    ["YouTrack App"] = 1117,
    ["Zarf Package Configuration"] = 1184,
    ["Zerops.io config"] = 1105,
    ["Zerops.io import"] = 1106,
    ["Zola Configuration"] = 1195,
    ["aerleon.yml"] = 17,
    ["amplify.yml"] = 10,
    ["angular.json"] = 33,
    apko = 1068,
    ...
    ["babelrc.json"] = 115,
    ["bamboo-spec"] = 118,
    ["bashly-strings.yml"] = 1045,
    ["batect.yml"] = 117,
    ["beef-database-codegen"] = 119,
    ["beef-database-v5-codegen"] = 121,
    ["beef-entity-codegen"] = 120,
    ["beef-entity-v5-codegen"] = 122,
    ["behat.yml"] = 134,
    ["bigquery-table"] = 123,
    ["bioimageio resource description"] = 1085,
    ["bitbucket-pipelines"] = 125,
    bitrise = 126,
    ["bitrise-step"] = 127,
    ["block.json"] = 149,
    ...
    ["bozr.suite.json"] = 136,
    bpkg = 1046,
    ["browser.i18n.json"] = 137,
    ["browsh configuration"] = 138,
    bucklescript = 139,
    ["buf.gen.yaml"] = 82,
    ["buf.lock"] = 83,
    ["buf.plugin.yaml"] = 84,
    ...
    ["build-changelog"] = 140,
    ["bun.lock"] = 145,
    ["bundleconfig.json"] = 146,
    ["bunfig.toml"] = 147,
    ["cargo-mutants-config.yaml"] = 86,
    ["ccmod.json"] = 1129,
    changelogging = 1097,
    ["chisel-slices.json"] = 263,
    ["chrome-extension-locales-messages.json"] = 244,
    ["chutzpah.json"] = 245,
    cibuildwheel = 169,
    ["clang-format (.clang-format)"] = 1003,
    ["clang-tidy"] = 223,
    clangd = 222,
    clib = 224,
    ["cloud-init: cloud-config userdata"] = 226,
    ["cloud-sdk-pipeline-configuration"] = 247,
    ["cloudbuild.json"] = 248,
    cloudify = 225,
    ["cmdx.yaml"] = 89,
    codemagic = 228,
    ["coffeelint.json"] = 265,
    ["commands.json"] = 240,
    ["commitlint (.commitlintrc)"] = 942,
    ["committed.toml"] = 266,
    ["compile_commands.json"] = 239,
    ["compilerconfig.json"] = 238,
    ["completely.yml"] = 1041,
    ["component-detection-manifest.json"] = 269,
    ["component.json"] = 268,
    ["composer.json"] = 267,
    ["conda-forge"] = 172,
    ["config.yaml"] = 677,
    ["contentmanifest.json"] = 246,
    ["contribute.json"] = 270,
    ["cosmos.config.json"] = 242,
    ["crowdin.yml"] = 271,
    ["ctfd-setup configuration file"] = 1141,
    ["custom-elements.json"] = 1055,
    ["cypress.json"] = 275,
    ["datalogic-scan2deploy-android"] = 285,
    ["datalogic-scan2deploy-ce"] = 286,
    ["dbt Dependencies"] = 188,
    ["dbt Packages"] = 190,
    ["dbt Project"] = 189,
    ["dbt Selectors"] = 191,
    ["dbt YAML files"] = 192,
    ["ddev-global"] = 287,
    ["ddev-project"] = 288,
    ["debugsettings.json"] = 289,
    ["dependabot-v2.json"] = 292,
    ["dependabot.json"] = 291,
    ["deployed-cli"] = 996,
    ["devcontainer.json"] = 230,
    devinit = 947,
    ["devspace.yaml"] = 1019,
    djlint = 948,
    ["docker bake"] = 297,
    ["docker sequencer"] = 298,
    ["docker-compose.yml"] = 946,
    ["dockerd.json"] = 296,
    ["dotnet Release Index manifest"] = 309,
    ["dotnet-tools.json"] = 310,
    ["dotnetcli.host.json"] = 311,
    ["dprint.json"] = 312,
    ["drone.json"] = 313,
    ["dss-2.0.0.json"] = 315,
    ["dstack configuration"] = 316,
    ["dtool dataset metadata"] = 1136,
    ["dvc.yaml"] = 317,
    ["ecosystem.json"] = 322,
    eksctl = 323,
    ["electron-builder configuration file"] = 329,
    ["epr-manifest.json"] = 328,
    ["evcc.yaml"] = 330,
    ["ezd task runner"] = 340,
    ["fabric.mod.json"] = 342,
    ["first-timers-bot"] = 349,
    ["flagd flag configuration"] = 110,
    ["fly.io Configuration"] = 111,
    fulibWorkflows = 978,
    ["function.json"] = 361,
    ["gRPC API Gateway & OpenAPI Config"] = 12,
    ["gematik health care insurance list"] = 1147,
    ["gematik health care patient list"] = 1144,
    ["gematik health care provider institution list"] = 1146,
    ["gematik health care provider list"] = 1145,
    ["gematik tiger test environment configuration"] = 1148,
    ["git-town.toml"] = 1193,
    ["gitlab-ci"] = 379,
    ["global.json"] = 395,
    ["go-feature-flag Flag Configuration"] = 398,
    ["haxelib.json"] = 416,
    helmfile = 934,
    helmwave = 935,
    ["host-meta.json"] = 423,
    ...
    ["ide.host.json"] = 431,
    ["ifstate.yaml"] = 432,
    ["imageoptimizer.json"] = 433,
    ["importmap.json"] = 436,
    instant_python_config = 438,
    instant_python_custom_project = 439,
    ["ioBroker Configuration"] = 440,
    ["ioBroker JSON UI"] = 441,
    ["ioBroker Package manifest"] = 442,
    ["ixpect.conf.yaml"] = 443,
    ["ize.toml"] = 1032,
    ["jsconfig.json"] = 468,
    ["jscpd Configuration"] = 1016,
    jsdoc = 930,
    ["k3d.yaml"] = 469,
    ["k9s aliases.yaml"] = 471,
    ["k9s cluster-config.yaml"] = 473,
    ["k9s config.yaml"] = 472,
    ["k9s hotkeys.yaml"] = 474,
    ["k9s plugins.yaml"] = 475,
    ["k9s skin.yaml"] = 476,
    ["k9s views.yaml"] = 477,
    ["kontinuous-config.yaml"] = 488,
    ["kontinuous-values.yaml"] = 487,
    ["kustomization.yaml"] = 490,
    ["label-commenter-config.yml"] = 491,
    ["latexindent configuration"] = 104,
    ["launchsettings.json"] = 492,
    lazydocker = 1054,
    lazygit = 1053,
    ["lego.json"] = 494,
    ["lerna.json"] = 495,
    ["lgtm.yml"] = 496,
    ["liblab.config.json"] = 497,
    ["libman.json"] = 498,
    ["license-report-config.json"] = 499,
    ["linkinator.config.json"] = 501,
    ["lint-staged (.lintstagedrc)"] = 908,
    ["local.settings.json"] = 506,
    ["localazy.json"] = 507,
    ["lotus.yaml"] = 505,
    ["lsdlschema.json"] = 508,
    ["macro.json"] = 1020,
    ["markdown-link-check"] = 974,
    maturin = 975,
    mboats = 982,
    ["micro-settings.json"] = 1047,
    ["mimetypes.json"] = 522,
    ["mirrord config"] = 910,
    mise = 911,
    ["mkdocs.yml"] = 542,
    ["monospace.yml"] = 545,
    ["moon.yml"] = 1130,
    ["mprocs Configuration file"] = 1101,
    ["mrdocs.yml"] = 543,
    ["mta.yaml"] = 912,
    ["mtad.yaml"] = 913,
    ["mycode.json"] = 552,
    nFPM = 559,
    ["napari plugin manifest"] = 553,
    neoload = 925,
    ["nest-cli"] = 562,
    ["ninjs (News in JSON)"] = 561,
    ["nitro.json"] = 924,
    ["nixd configuration"] = 1073,
    ["nlu.json"] = 563,
    ["nodemon.json"] = 565,
    ["noodl config"] = 981,
    ["notebook.mod.json"] = 566,
    now = 920,
    ["npm-badges"] = 569,
    ["nswag.json"] = 573,
    ntangle = 575,
    ["nuclei-template.yaml"] = 570,
    ["nuget-project.json"] = 571,
    ["ocelot.json"] = 577,
    ["omnisharp.json"] = 582,
    openHAB = 1206,
    ["openapi.json"] = 584,
    ...
    ["overlay.json"] = 585,
    ["package.json"] = 615,
    ["package.manifest"] = 617,
    ["package.yaml"] = 616,
    ["partial-black.json"] = 135,
    ["pathfinder.yml"] = 620,
    ["pattern.json"] = 623,
    ["petstore-v1.0"] = 1027,
    pgap_yaml_input_reader = 622,
    pgxgen = 1209,
    ["pixi.toml"] = 624,
    ["plagiarize-me.yaml"] = 628,
    ["plagiarize.yaml"] = 627,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1137,
    ["podbard.yaml"] = 630,
    ["portman.json"] = 633,
    ["prefect.toml"] = 641,
    ["prefect.yaml"] = 642,
    ["prettierrc.json"] = 643,
    ["prisma.yml"] = 644,
    ["project-1.0.0-beta3.json"] = 656,
    ["project-1.0.0-beta4.json"] = 657,
    ["project-1.0.0-beta5.json"] = 658,
    ["project-1.0.0-beta6.json"] = 659,
    ["project-1.0.0-beta8.json"] = 660,
    ["project-1.0.0-rc1.json"] = 661,
    ["project-1.0.0-rc2.json"] = 662,
    ["project.json"] = 655,
    ["project.owasp.yaml"] = 663,
    ["prometheus-alertmanager.json"] = 667,
    ["prometheus.json"] = 664,
    ["prometheus.rules.json"] = 665,
    ["prometheus.rules.test.json"] = 666,
    ["proxies.json"] = 668,
    ["publiccode.yml"] = 669,
    ["pubspec.yaml"] = 670,
    ["pyrseas-0.8.json"] = 673,
    pytest = 682,
    ["quilt.mod.json"] = 1048,
    ["rc3 auth"] = 688,
    ["rc3 collection"] = 689,
    ...
    ["release drafter"] = 926,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 698,
    ["release-please-manifest.json"] = 699,
    ["release-plz.toml"] = 700,
    ["renv.lock"] = 712,
    ["rivet.json"] = 1072,
    ["rivet.yaml (legacy)"] = 1071,
    rumdl = 717,
    runny = 716,
    rustfmt = 718,
    sake = 1164,
    samt = 720,
    samtrc = 721,
    ["sarif-1.0.0.json"] = 723,
    ["sarif-2.0.0.json"] = 724,
    ["sarif-2.1.0"] = 734,
    ["sarif-2.1.0-rtm.2"] = 725,
    ["sarif-2.1.0-rtm.3"] = 727,
    ["sarif-2.1.0-rtm.4"] = 729,
    ["sarif-2.1.0-rtm.5"] = 731,
    ["sarif-2.1.0-rtm.6"] = 732,
    ["sarif-external-property-file-2.1.0"] = 735,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 726,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 728,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 730,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 733,
    ["scalingo.json configuration"] = 736,
    ["schema.org - Action"] = 738,
    ["schema.org - ContactPoint"] = 739,
    ["schema.org - Place"] = 740,
    ["schema.org - Thing"] = 741,
    ["secrethub.yml"] = 1050,
    ["semantic-release"] = 747,
    ["servicehub.config.json"] = 903,
    ["servicehub.service.json"] = 902,
    ["settings.job"] = 750,
    ["sfdx-hardis configuration"] = 752,
    ["shard.yml"] = 1088,
    ["size-limit configuration"] = 757,
    ["skaffold.yaml"] = 972,
    ["skyuxconfig.json"] = 759,
    ["snowflake-config"] = 761,
    ["snowflake-connections"] = 762,
    ["spicepod.yaml"] = 1109,
    ["sqlc configuration"] = 794,
    ["stripe-app-local.json"] = 805,
    ["stripe-app.json"] = 804,
    swcrc = 957,
    ["task.json"] = 814,
    taskcat = 921,
    ["template.json"] = 819,
    ["templatsources.json"] = 820,
    ["theme.json"] = 823,
    ["tizen_workspace.json"] = 825,
    tldr = 826,
    ["tm_devices configuration file"] = 1175,
    tmuxinator = 906,
    ["transcend.yml"] = 836,
    ["tree-sitter grammar.json"] = 403,
    ["trime.yaml"] = 837,
    ["trunk.yaml"] = 839,
    ["ts-force-config.json"] = 844,
    ["tsconfig.json"] = 840,
    ["tsd.json"] = 841,
    ["tsdoc.json"] = 842,
    ["tsdrc.json"] = 843,
    ...
    v8r = 885,
    vcluster = 1095,
    ["vcpkg configuration file"] = 235,
    ["vcpkg manifest file"] = 234,
    ["vega-lite.json"] = 867,
    ["vega.json"] = 866,
    ["venvironment.yaml"] = 869,
    ["venvplus.yaml"] = 870,
    version = 1157,
    ["version.json"] = 872,
    ["vhwdebugger-binding.yaml"] = 874,
    ["vim-addon-info"] = 875,
    ["vs-2017.3.host.json"] = 877,
    ["vs-nesting.json"] = 878,
    ["vsls.json"] = 876,
    ["vss-extension.json"] = 882,
    vtcfg = 1163,
    ["vtesttree.yaml"] = 883,
    ["vtestunit.yaml"] = 884,
    ["warp-keysets.json"] = 1056,
    ["warp-themes.json"] = 1057,
    ["warp-workflows.json"] = 1058,
    ["webhint.io"] = 1012,
    ["webjobpublishsettings.json"] = 889,
    ["webjobs-list.json"] = 888,
    ["well-known-fursona"] = 1096,
    ["xs-app.json"] = 916,
    ["xunit.runner.json"] = 901,
    yamllint = 944,
    zizmor = 1200,
    zuul = 927,
    ["Žinoma"] = 937
