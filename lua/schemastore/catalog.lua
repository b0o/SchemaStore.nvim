...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1000,
    [".nodehawkrc"] = 632,
    [".npmpackagejsonlintrc"] = 636,
    [".omletrc"] = 1181,
    [".phrase.yml"] = 714,
    [".phraseapp.yml"] = 715,
    [".pmbot.yml"] = 699,
    [".postcssrc"] = 708,
    [".powerpages-web-template-manifest"] = 710,
    [".pre-commit-config.yml"] = 711,
    [".pre-commit-hooks.yml"] = 712,
    [".putout.json"] = 748,
    [".rehyperc"] = 773,
    [".remarkrc"] = 777,
    [".sprite files"] = 873,
    ...
    [".vsconfig"] = 963,
    [".vsext"] = 964,
    ["1Password SSH Agent Config"] = 12,
    ["@factorial/drupal-breakpoints-css"] = 20,
    ["A micro editor config"] = 574,
    ABCClinicalDemandForecast = 29,
    ABCInventoryModuleData = 28,
    ABCSupplyPlan = 30,
    ["ACP Attempts"] = 31,
    ["ACP Cache File"] = 32,
    ["ACP Configuration File"] = 33,
    ["ACP Primer"] = 34,
    ["ACP Sync"] = 35,
    ["ACP Variables File"] = 36,
    AIConfig = 37,
    ["AMX Muse Program Descriptor"] = 1230,
    ["API Builder"] = 1036,
    ["AVA Configuration"] = 1100,
    ["AWS AppConfig Feature Flags-v1"] = 71,
    ["AWS CDK cdk.json"] = 277,
    ["AWS CloudFormation"] = 278,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 279,
    ["AWS Copilot Manifest"] = 1269,
    ["AWS SAM CLI Samconfig"] = 280,
    Acton = 1320,
    ["Adobe UXP Manifest"] = 1163,
    ["Aerleon Network & Service Definitions"] = 23,
    ["Aerleon Policy"] = 24,
    ["Agent Permission Policy"] = 1309,
    ["AgentCore CLI"] = 1310,
    AgentLoopKit = 1311,
    Aider = 1259,
    Air = 26,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1280,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1279,
    ["Airlock Microgateway"] = 38,
    ["Alacritty Configuration"] = 1072,
    ["AlgoVoi Compliance Receipt v1"] = 13,
    ["All Contributors configuration file"] = 1126,
    Anodizer = 457,
    ["Ansible Argument Specs"] = 441,
    ["Ansible Collection Galaxy"] = 448,
    ["Ansible Execution Environment"] = 438,
    ["Ansible Inventory"] = 447,
    ["Ansible Meta"] = 439,
    ["Ansible Meta Runtime"] = 440,
    ["Ansible Navigator Configuration"] = 450,
    ["Ansible Playbook"] = 445,
    ["Ansible Requirements"] = 442,
    ["Ansible Rulebook"] = 446,
    ["Ansible Tasks File"] = 444,
    ["Ansible Vars File"] = 443,
    ["Ansible-lint Configuration"] = 449,
    Any = 1191,
    ["AnyWork Automation Configuration"] = 19,
    ["Apollo Router"] = 1037,
    ["App config Spotify Backstage"] = 42,
    ["Applicant Profile Protocol"] = 16,
    ["Application Accelerator"] = 14,
    ["Application list for a WinUtil"] = 1209,
    ArchitectFX = 1214,
    ["Argo CD"] = 57,
    ["Argo Events"] = 58,
    ["Argo Workflows"] = 59,
    AssemblyScript = 62,
    AsyncAPI = 65,
    ["AsyncAPI Tool File"] = 66,
    ["Atmos Manifests"] = 67,
    ["Aurora Agile Meta-Framework"] = 68,
    AutoAPICase = 1136,
    ["Avro Avsc"] = 69,
    ["Awesome Repositories"] = 70,
    ["Azure Container App template for defining an immutable revision"] = 73,
    ["Azure DevOps extension manifest"] = 76,
    ["Azure Device Update for IoT Hub import manifest"] = 74,
    ["Azure Device Update for IoT Hub update manifest"] = 75,
    ["Azure IoT Edge deployment"] = 79,
    ["Azure IoT Edge deployment template"] = 80,
    ["Azure IoT EdgeAgent deployment"] = 77,
    ["Azure IoT EdgeHub deployment"] = 78,
    ["Azure IoT Operations Wasm Graph Config"] = 1278,
    ["Azure IoT Operations connector metadata"] = 1275,
    ["Azure Landing Zones Library archetype definition"] = 84,
    ["Azure Landing Zones Library archetype override"] = 85,
    ["Azure Landing Zones Library architecture definition"] = 83,
    ["Azure Landing Zones Library metadata"] = 81,
    ["Azure Landing Zones Library policy default values"] = 82,
    ["Azure Pipelines"] = 117,
    ["Azure Static Web Apps CLI configuration file"] = 877,
    ["Azure Static Web Apps configuration file"] = 876,
    BMML = 1297,
    ["BOSH BPM Config"] = 143,
    ["BOSH CPI Config"] = 144,
    ["BOSH Deploy Config"] = 145,
    ["BX CI"] = 166,
    ["Bacon config"] = 7,
    ["Barba-CV"] = 86,
    ["Bashly (bashly.yml)"] = 1130,
    ["Bashly Settings (bashly-settings.yml)"] = 1131,
    Bento = 1296,
    ["Better Code Hub"] = 1041,
    ["Better Scripts"] = 167,
    Bigconfig = 136,
    ["Biome Formatter Config"] = 87,
    ["Bitmovin Encoding Template"] = 1223,
    BizTalkServerApplicationSchema = 1007,
    Bleep = 168,
    ["Block Protocol Metadata"] = 165,
    ["Bluebricks blueprint config"] = 1302,
    ["Boyka Framework"] = 146,
    ["Bpod Finite-State Machine"] = 89,
    Briefcase = 1013,
    ["Build Info"] = 156,
    Buildkite = 158,
    ["Bukkit plugin.yml"] = 157,
    ["BungeeCord plugin.yml"] = 163,
    ["Butane Config"] = 1085,
    C4InterFlow = 1238,
    ["CDK Environment Manager, concrete environment configuration"] = 1262,
    ["CDK Environment Manager, concrete environments definition"] = 1261,
    ["CDK Environment Manager, environment definition"] = 1260,
    ["CGS Card Game Specification (cgs.json)"] = 1168,
    ["CICS TS region tagging"] = 1094,
    ["CICS TS resource import"] = 1095,
    ["CICS TS resource model"] = 1096,
    ["CICS TS resource overrides"] = 1097,
    ["CMake Presets"] = 169,
    ["CNC Codes"] = 191,
    ["CRS WAF test file"] = 1198,
    ["CRS WAF test platform overrides file"] = 1199,
    ["CSS Comb (.csscomb.json)"] = 306,
    ["CSS Lint (.csslintrc)"] = 307,
    ["CSpell (cspell.json)"] = 305,
    ["CVE Record Format"] = 203,
    CWL = 1174,
    ["Cache Warmup config"] = 170,
    ["Caido Proxy Configuration"] = 1334,
    ["Calqulus pipeline"] = 171,
    ["Camel YAML DSL"] = 172,
    ["Cannon TOML"] = 173,
    Carafe = 174,
    ["Cargo Make"] = 176,
    ["Cargo Manifest"] = 175,
    ["Catalog Info Backstage"] = 177,
    ["Chamaleon environment"] = 1227,
    ["Chamaleon properties"] = 1228,
    ["Chamaleon template"] = 1226,
    Changepacks = 1289,
    Changesets = 289,
    Changie = 178,
    Charmcraft = 179,
    Cheatsheets = 1082,
    ["ChordPro Configuration"] = 180,
    ["Chrome Extension"] = 270,
    ["Chromia Model"] = 181,
    ["Chromia Seeder Module Config"] = 183,
    ["Chromia Seeder Root Config"] = 182,
    ["Cinnamon Spice info.json"] = 97,
    ["CircleCI config.yml"] = 242,
    ["Citation File Format"] = 291,
    ["Citrus test case"] = 185,
    CityJSON = 186,
    ["Claude Code Keybindings"] = 198,
    ["Claude Code Plugin Manifest"] = 199,
    ["Claude Code Plugin Marketplace"] = 200,
    ["Claude Code Settings"] = 201,
    ["Clawject config"] = 197,
    ["Cloud Foundry Application Manifest"] = 1180,
    ["Cloud Run Spec v1"] = 1204,
    ["Cloud.gov Workshop Configuration"] = 98,
    ["CloudCannon Configuration"] = 103,
    ["CloudCannon Configuration (Collection Structures)"] = 112,
    ["CloudCannon Configuration (Collections)"] = 111,
    ["CloudCannon Configuration (Editables)"] = 110,
    ["CloudCannon Configuration (Inputs)"] = 105,
    ["CloudCannon Configuration (Snippets Definitions)"] = 109,
    ["CloudCannon Configuration (Snippets Imports)"] = 108,
    ["CloudCannon Configuration (Snippets)"] = 107,
    ["CloudCannon Configuration (Structure Value)"] = 106,
    ["CloudCannon Configuration (Structures)"] = 104,
    ["CloudEvents specification"] = 187,
    ["Code Climate"] = 243,
    CodeCV = 101,
    CodeRabbit = 100,
    ["CodeShip Pro services configuration files"] = 259,
    ["CodeShip Pro steps configuration files"] = 260,
    ["Codecov configuration files"] = 258,
    Codex = 251,
    ["Codex Hooks"] = 252,
    ["Codex Skill Metadata"] = 253,
    CodifyCLI = 102,
    Codux = 255,
    ["Cog config file"] = 192,
    ["Commandbox Box.json"] = 193,
    ["Commandbox Server.json"] = 194,
    ["Common Catalog Data"] = 268,
    ["Common Package Specification"] = 195,
    Concord = 1197,
    ["Configu .cfgu files"] = 1185,
    ["Configu .configu file"] = 1186,
    Conjure = 190,
    ["Container Structure Test"] = 1021,
    Containerlab = 1050,
    ["Contextive Glossary"] = 1254,
    ContractGuard = 1051,
    Convex = 189,
    ["Crowdsec collection config"] = 300,
    ["Crowdsec parser config"] = 301,
    ["Crowdsec scenario config"] = 302,
    ["CumulusCI Config"] = 196,
    ["Cursor Agent Environment"] = 1307,
    ["Custom Machinery Machine"] = 1169,
    ["Custom Machinery Recipe"] = 1170,
    ["Cycle Stack File"] = 204,
    CycloneDX = 205,
    ["DWP Exchange - catalogue entry"] = 351,
    ["DWP Exchange - gateway"] = 349,
    ["DWP Exchange - meta"] = 350,
    ["Dart Build Config (dart-build.json)"] = 308,
    ["Dart Test Config (dart-test.json)"] = 309,
    ["DashLord Configuration"] = 310,
    ["Data Contract Specification"] = 311,
    ["Data Product Specification"] = 312,
    ["DataYoga Connections"] = 206,
    ["DataYoga Job"] = 207,
    ["Datadog Continuous Testing"] = 543,
    ["Datadog Service Definition"] = 544,
    ["Datadog Software Catalog"] = 545,
    ["Datahub Ingestion Recipe"] = 1101,
    ["Debian Upstream Metadata file"] = 214,
    DebtLens = 215,
    ["Deck config"] = 216,
    ["Declarative Automation Bundles"] = 1147,
    ["DeepMatch deeplinks spec"] = 217,
    ["Dein Config"] = 218,
    ["Deno Config (deno.json)"] = 318,
    ["Dependency cruiser"] = 219,
    ["DeployStack Configuration"] = 220,
    ["Deployah Configuration"] = 1277,
    ["Deployer Recipe"] = 321,
    ["Deta Spacefile"] = 221,
    ["Detekt Config (detekt.yml)"] = 322,
    ["Devbox Config"] = 222,
    ["Devbox Plugin"] = 223,
    Devfile = 348,
    Devup = 1290,
    DipDup = 1200,
    ["Discord Webhook"] = 323,
    ["DocFx Config (docfx.json)"] = 328,
    ["Docker Desktop extension metadata"] = 325,
    ["Docs MCP Manifest"] = 329,
    Dofigen = 330,
    ["Dolittle Artifacts"] = 331,
    ["Dolittle Bounded Context Configuration"] = 332,
    ["Dolittle Event Horizons Configuration"] = 333,
    ["Dolittle Resources Configuration"] = 334,
    ["Dolittle Server Configuration"] = 335,
    ["Dolittle Tenant Map Configuration"] = 337,
    ["Dolittle Tenants Configuration"] = 336,
    ["Dolittle Topology"] = 338,
    ["DonateCaseBetterCasino menu"] = 1231,
    ["Drupal Breakpoints"] = 224,
    ["Drupal Config"] = 236,
    ["Drupal Info"] = 225,
    ["Drupal Layouts"] = 226,
    ["Drupal Libraries"] = 227,
    ["Drupal Links Action"] = 228,
    ["Drupal Links Contextual"] = 229,
    ["Drupal Links Menu"] = 230,
    ["Drupal Links Task"] = 231,
    ["Drupal Migration"] = 232,
    ["Drupal Permissions"] = 233,
    ["Drupal Recipe"] = 234,
    ["Drupal Routing"] = 235,
    ["Drupal Services"] = 237,
    ["Drush site aliases"] = 344,
    ["Dynamic Bash Aliases (.aliases)"] = 1138,
    ["EAS config"] = 389,
    ["ECA - Editor Code Assistant"] = 353,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1127,
    ["ESLint Suppressions"] = 394,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1274,
    ["EasyVCR .NET"] = 391,
    ["Eidolon Resource"] = 1215,
    ["Elgato Stream Deck"] = 355,
    Elm = 1202,
    ["Embrace Config"] = 1113,
    Emmet = 1203,
    Endurica = 1151,
    ["Enonic XP API descriptor"] = 358,
    ["Enonic XP Admin Extension descriptor"] = 359,
    ["Enonic XP Admin Tool descriptor"] = 360,
    ["Enonic XP Application descriptor"] = 361,
    ["Enonic XP CMS descriptor"] = 362,
    ["Enonic XP Content Type descriptor"] = 363,
    ["Enonic XP Form Fragment descriptor"] = 364,
    ["Enonic XP ID Provider descriptor"] = 365,
    ["Enonic XP Layout descriptor"] = 366,
    ["Enonic XP Macro descriptor"] = 367,
    ["Enonic XP Mixin descriptor"] = 368,
    ["Enonic XP Page descriptor"] = 369,
    ["Enonic XP Part descriptor"] = 370,
    ["Enonic XP Service descriptor"] = 371,
    ["Enonic XP Site descriptor"] = 372,
    ["Enonic XP Style descriptor"] = 373,
    ["Enonic XP Task descriptor"] = 374,
    ["Enonic XP Webapp descriptor"] = 375,
    ["Enterprise Contract Policy Spec"] = 356,
    ["Envelope Team Definition"] = 1319,
    ["Envilder Map File"] = 357,
    ["Erda Pipeline"] = 1176,
    ["Erda Runtime"] = 1177,
    ["Espanso config.yml"] = 1300,
    ["Espanso match.yml"] = 1299,
    Esquio = 377,
    ["Estuary Flow Catalog"] = 1091,
    ["Ethereum ERC1155"] = 1313,
    ["Ethereum ERC721"] = 1312,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 382,
    ["EveryVoice TTS Toolkit Data Configuration"] = 383,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 387,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 386,
    ["EveryVoice TTS Toolkit Text Configuration"] = 384,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 385,
    ["Evolving Resolutive Process notation"] = 1276,
    ["Expo SDK"] = 388,
    ["Expoot app config"] = 390,
    ["F-Droid Data metadata"] = 396,
    ["FasterCI Configuration"] = 118,
    ["Fence configuration"] = 119,
    FiQuS = 400,
    Firebase = 398,
    ["Flatpak Builder Manifest"] = 401,
    ["FlexGet Config"] = 402,
    ["Flow.json Configurations"] = 1173,
    ["Fossa configuration file"] = 409,
    ["Fossa's fossa-deps file"] = 410,
    ["Foundry VTT - Base package Manifest"] = 404,
    ["Foundry VTT - Module Manifest"] = 405,
    ["Foundry VTT - System Data Template"] = 408,
    ["Foundry VTT - System Manifest"] = 406,
    ["Foundry VTT - World Manifest"] = 407,
    ["Foxx Manifest"] = 120,
    ["Freifunk.de Community API"] = 123,
    ["Frogbot Config"] = 124,
    ["G2P Mapping Configuration"] = 416,
    ["GCP Blueprint Metadata"] = 419,
    Gaspar = 417,
    ["GatewayCore API Gateway"] = 418,
    ["Gemini CLI settings"] = 420,
    ["GeoJSON.json latest"] = 1089,
    GherKing = 1093,
    ["GitHub Action"] = 426,
    ["GitHub Actions typing"] = 1211,
    ["GitHub Discussion"] = 427,
    ["GitHub Funding"] = 428,
    ["GitHub Issue Template configuration"] = 429,
    ["GitHub Issue Template forms"] = 430,
    ["GitHub Pages Jekyll"] = 431,
    ["GitHub Workflow"] = 432,
    ["GitHub Workflow Template Properties"] = 433,
    ["GitHub automatically generated release notes configuration"] = 434,
    ["GitLab Agent for Kubernetes configuration"] = 1165,
    GitVersion = 423,
    ["Gitea Issue Template configuration"] = 424,
    ["Gitea Issue Template forms"] = 425,
    ["Gitpod Automations"] = 436,
    ["Gitpod Configuration"] = 437,
    ["Glamour style"] = 421,
    ["GlazeWM settings"] = 1167,
    ["Global Privacy Control"] = 422,
    Goblet = 1146,
    ["Golangci-lint Configuration"] = 452,
    ["Golangci-lint Custom Plugins Configuration"] = 453,
    ["Google Chrome Related Website Sets"] = 399,
    ["Google Cloud Workflows"] = 276,
    ["Google Digital Assetlinks"] = 1255,
    Goreleaser = 455,
    ["Goreleaser Pro"] = 456,
    Goss = 458,
    ["Gradle Build Cache Node"] = 1039,
    ["Gradle Enterprise"] = 1038,
    ["Grafana 5.x Dashboard"] = 459,
    ["GraphQL Code Generator"] = 464,
    ["GraphQL Config"] = 463,
    ["GraphQL Mesh"] = 462,
    ["GroovyLint configuration"] = 465,
    ["Grunt JSHint task"] = 469,
    ["Grunt Watch task"] = 470,
    ["Grunt base task"] = 471,
    ["Grunt clean task"] = 467,
    ["Grunt copy task"] = 466,
    ["Grunt cssmin task"] = 468,
    HEMTT = 1003,
    Hadolint = 1017,
    Hammerkit = 1049,
    ["Hardware Sentry Configuration"] = 1105,
    ["Hashgraph Online Skill Manifest"] = 3,
    ["HashiCorp Vault"] = 472,
    Hatch = 1018,
    Hayson = 474,
    ["Haystack Pipeline"] = 475,
    ["Hazelcast 5 Configuration"] = 476,
    ["Hecate Input Schema"] = 1266,
    ["Helm Chart.lock"] = 239,
    ["Helm Chart.yaml"] = 238,
    ["Helm Unittest Test Suite"] = 240,
    ["Hex file"] = 241,
    ["Home Assistant Integration Manifest"] = 477,
    ["Homer dashboard configuration"] = 478,
    Hugo = 1081,
    ["Hugo Theme"] = 1080,
    ["Hulak Configuration"] = 485,
    ["Hyperfoil benchmark configuration"] = 484,
    ["IBM Zapp document"] = 486,
    ["IBM zCodeFormatSettings"] = 487,
    ["IMG Catapult PSP"] = 492,
    ["IVMS101 by CODE Protocol"] = 1166,
    ["Infinispan Configuration"] = 494,
    ["Infinispan Server Configuration"] = 495,
    Infrahub = 496,
    Istanbul = 1109,
    ["JDownloader2 crawler multi-rules"] = 510,
    ["JDownloader2 crawler single-rules"] = 509,
    ["JFrog Applications Config"] = 511,
    ["JFrog File Spec"] = 512,
    ["JFrog Pipelines YML DSL"] = 1115,
    ["JMeter DSL cli config"] = 513,
    JReleaser = 516,
    ["JSON Document Transform"] = 524,
    ["JSON Feed"] = 525,
    ["JSON Resume"] = 785,
    ["JSON Schema Draft 2020-12"] = 985,
    ["JSON Schema Draft 4"] = 982,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1148,
    ["JSON Schema Draft 7"] = 983,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1149,
    ["JSON Schema Draft 8 (2019-09)"] = 984,
    ["JSON-API"] = 523,
    ["JSON-e templates"] = 1046,
    ["JSON-stat 2.0"] = 978,
    JSONPatch = 527,
    ["JSR Package Config (jsr.json)"] = 517,
    Jarl = 1282,
    Jasmine = 504,
    Jekyll = 505,
    ["Jenkins X Pipelines"] = 506,
    ["Jenkins X Requirements"] = 507,
    Jest = 508,
    Jocker = 514,
    ["Jovo Language Models"] = 515,
    ["Jujutsu (jj) VCS config"] = 1268,
    ["KIMMDY config file"] = 538,
    ["KODE/CI build.yaml"] = 1111,
    ["KSP-AVC"] = 979,
    ["KSP-CKAN"] = 980,
    ["KSP-NetKAN"] = 981,
    KSY = 1178,
    KSail = 414,
    ["KYA Manifest"] = 1179,
    ["Karakum configuration file"] = 411,
    Kas = 530,
    ["Kestra flow file"] = 539,
    ["Keycloak REST API"] = 1118,
    ["Knative Functions - func.yaml"] = 412,
    Knip = 413,
    ["Knowledge Unit"] = 547,
    ["Kometa (nightly) config file"] = 541,
    ["Kometa config file"] = 540,
    ["Kong DBLess config"] = 1112,
    KrakenD = 542,
    ["Kubri Configuration"] = 550,
    LOOBin = 565,
    ["Lake configuration file"] = 1271,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 281,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 282,
    ["Landing Zone Accelerator on AWS - Global Config"] = 283,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 284,
    ["Landing Zone Accelerator on AWS - Network Config"] = 285,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 286,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 287,
    ["Landing Zone Accelerator on AWS - Security Config"] = 288,
    ["Lando (landofile)"] = 113,
    ["LangGraph Platform configuration"] = 1190,
    ["Language configuration"] = 1189,
    Lefthook = 554,
    ["Liferay client-extension.yaml"] = 561,
    ["LinkML Metamodel"] = 563,
    Liquibase = 1056,
    ["Liquibase Flow File"] = 1057,
    ["Lively Properties"] = 564,
    ["Lobe AI Agent"] = 115,
    Loki = 116,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 607,
    ["MS2Rescore Configuration"] = 613,
    ["Madness (madness.yml)"] = 1129,
    ["Mado configuration"] = 571,
    ["Maestro Flow"] = 572,
    ["Mail Servers Configuration"] = 1303,
    ["MapEHR Mapping"] = 573,
    Markdownlint = 1060,
    ["Mason Registry"] = 1063,
    ["MegaLinter Custom Flavor"] = 576,
    ["MegaLinter configuration"] = 575,
    ["MegaLinter descriptor"] = 577,
    Melange = 1156,
    ["Meltano project definition"] = 578,
    ["Mergify Configuration"] = 614,
    ["Metadata for a Bazel module"] = 579,
    ["Metadata for a Cinnamon spice"] = 1207,
    ["Metatype Configuration"] = 580,
    ["MetricsHub Configuration"] = 581,
    ["MetricsHub Connector Configuration"] = 582,
    ["Micro Editor Syntax"] = 1139,
    ["Microsoft Band Web Tile"] = 583,
    ["Microsoft RulesEngine workflow rules"] = 1194,
    ["Microsoft RulesEngine workflow rules list"] = 1195,
    ["Minecraft Custom Main Menu Mod"] = 1157,
    ["Minecraft Data Pack Advancement"] = 585,
    ["Minecraft Data Pack Biome"] = 586,
    ["Minecraft Data Pack Configured Carver"] = 587,
    ["Minecraft Data Pack Damage Type"] = 588,
    ["Minecraft Data Pack Dimension"] = 590,
    ["Minecraft Data Pack Dimension Type"] = 589,
    ["Minecraft Data Pack Item Modifier"] = 591,
    ["Minecraft Data Pack Loot Table"] = 592,
    ["Minecraft Data Pack Metadata"] = 593,
    ["Minecraft Data Pack Predicate"] = 594,
    ["Minecraft Data Pack Recipe"] = 595,
    ["Minecraft Data Pack Tag"] = 596,
    ["Minecraft Data Pack Template Pool"] = 597,
    ["Minecraft Data Pack Trim Material"] = 602,
    ["Minecraft Data Pack Trim Pattern"] = 603,
    ["Minecraft Resource Pack Lang"] = 598,
    ["Minecraft Resource Pack Particle"] = 599,
    ["Minecraft Resource Pack Texture Mcmeta"] = 601,
    ["Minecraft Resourcepack Sounds"] = 600,
    ["MockServer Expectations"] = 609,
    ModuleAssembler = 605,
    ["Monade CLI Stack Configuration"] = 617,
    ["MongoDB Atlas Search Index Definition"] = 1110,
    ["Monika Configuration"] = 1108,
    ["Monoweave Configuration"] = 612,
    ["Motif config"] = 999,
    MultiQC = 1248,
    ["NOX Framework (Service)"] = 635,
    ["Netin Diagnostic System Template"] = 1067,
    ["Netlify config"] = 620,
    ["Network-as-Code Data Model"] = 621,
    ["Next Gen UI Agent A2A Server Configuration"] = 622,
    ["Next Gen UI Agent Configuration"] = 624,
    ["Next Gen UI Agent MCP Server Configuration"] = 623,
    ["Nightwatch.js"] = 628,
    ["Node.js configuration"] = 1004,
    ["NueJS configuration file"] = 640,
    ["Nuitka Package Config"] = 1171,
    ["Nullstone config"] = 642,
    ["ONe's changelog entry"] = 661,
    ["ONe's service descriptor"] = 660,
    ["ORT Server repository environment configuration"] = 671,
    ["OSCAL Assessment Plan (AP)"] = 673,
    ["OSCAL Assessment Results (AR)"] = 674,
    ["OSCAL Catalog"] = 675,
    ["OSCAL Component Definition (CDef)"] = 676,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 677,
    ["OSCAL Profile"] = 678,
    ["OSCAL System Security Plan (SSP)"] = 679,
    ["OSS Review Toolkit configuration"] = 680,
    ["OSS Review Toolkit curation"] = 681,
    ["OSS Review Toolkit package configuration"] = 682,
    ["OSS Review Toolkit project package manager definition"] = 683,
    ["OSS Review Toolkit repository configuration"] = 684,
    ["OSS Review Toolkit resolutions"] = 685,
    ["October CMS columns"] = 646,
    ["October CMS fields"] = 647,
    ["Oh My Posh"] = 649,
    Okteto = 650,
    ["Ona Automations"] = 652,
    Opctl = 1002,
    ["Open Data Contract Standard (ODCS)"] = 665,
    ["Open Data Product Standard (ODPS)"] = 666,
    ["Open Know-How"] = 1253,
    OpenDecree = 1317,
    ["OpenDecree Configuration"] = 1318,
    ["OpenRewrite Resource"] = 663,
    OpenSRM = 667,
    OpenStatus = 1264,
    ["OpenTelemetry Declarative Configuration"] = 664,
    ["OpenUtau character yaml"] = 657,
    ["OpenUtau ustx"] = 658,
    ["OpenWeather Current Weather API"] = 1045,
    ["OpenWeather Road Risk API"] = 1044,
    ["Ory Hydra configuration"] = 483,
    ["Ory Keto configuration"] = 546,
    ["Ory Kratos configuration"] = 672,
    ["Ory Oathkeeper configuration"] = 644,
    ["Outblocks App configuration"] = 669,
    ["Outblocks database table"] = 670,
    ["Outblocks project configuration"] = 668,
    PDM = 693,
    POPxf = 705,
    ["POPxf Correlations"] = 706,
    ["PRML manifest"] = 713,
    Packer = 689,
    PactSpec = 690,
    Panache = 691,
    Pantsbuild = 1125,
    ["Paper paper-plugin.yml"] = 692,
    ["Pipeline component"] = 1058,
    ["Platform.sh application"] = 9,
    ["Platform.sh routes"] = 10,
    ["Platform.sh services"] = 11,
    ["Plex Prerolls"] = 703,
    ["PocketMine plugin.yml"] = 700,
    ["Podman Desktop Extension"] = 1336,
    ["Postman collection"] = 709,
    ["Power Pages Configuration"] = 1265,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1210,
    ["ProActions AI-Kit Configuration"] = 721,
    ["ProActions AI-Kit Configuration for Menus"] = 723,
    ["ProActions AI-Kit Configuration for Sections"] = 725,
    ["ProActions AI-Kit Configuration for Services"] = 722,
    ["ProActions AI-Kit Configuration for Steps"] = 726,
    ["ProActions AI-Kit Configuration for Templates"] = 724,
    ["Problem object RFC9457"] = 1154,
    ["Problem package format"] = 727,
    ["Problem package generators"] = 728,
    ["Problem package submissions"] = 729,
    ["Problem package test group metadata"] = 730,
    Pterodactyl = 1104,
    ["Pull Request Labeler"] = 747,
    Pulumi = 755,
    ["PyGTA Config"] = 751,
    PyProject = 756,
    Pylock = 1256,
    Pyright = 757,
    ["Python script metadata"] = 1250,
    ["QType AI DSL"] = 760,
    Qgoda = 759,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1328,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1326,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1332,
    ["Qlik Talend Cloud Pipeline - Project"] = 1324,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1327,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1329,
    ["Qlik Talend Cloud Pipeline - Task"] = 1325,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1331,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1330,
    Qodana = 1077,
    ["Qt Creator workspace file"] = 1187,
    ["Quali Torque Blueprint Spec 2"] = 1102,
    ["QueryFirst config file"] = 1121,
    ["QuikRun Configuration"] = 1333,
    ["Qwen Code Settings"] = 1314,
    ["RKE Cluster Configuration JSON"] = 1055,
    ["RKE Cluster Configuration YAML"] = 1054,
    RadioHound = 750,
    ["Raid Profile"] = 1315,
    ["Raid Repo Configuration"] = 1316,
    Railpack = 762,
    Railway = 761,
    ["Rancher Fleet"] = 752,
    ["Rattler-build"] = 763,
    Ray = 1016,
    ["Read the Docs"] = 754,
    ["Red-DiscordBot Cog"] = 770,
    ["Red-DiscordBot Cog Repo"] = 771,
    ["Red-DiscordBot Trivia"] = 772,
    ["Releasaurus Config"] = 6,
    ReleaseKit = 5,
    ["Render Blueprints"] = 1053,
    RenderCV = 789,
    Renovate = 786,
    ["Renovate global configuration"] = 787,
    ["Renovate inherited configuration"] = 788,
    ["Replit config"] = 778,
    Restate = 1243,
    ["Revel Digital Gadget Definition File"] = 1267,
    RoadRunner = 791,
    ["Robust Station Image"] = 1273,
    Rockcraft = 792,
    ["Roo Coder Custom Modes"] = 793,
    Rubocop = 782,
    ["Rudder techniques"] = 1161,
    Ruff = 783,
    ["Rust Project"] = 784,
    ["Rust toolchain"] = 798,
    ["SDMX data message"] = 825,
    ["SDMX metadata message"] = 824,
    ["SDMX structure message"] = 823,
    ["SIL Kit Participant Configuration"] = 835,
    ["SIL Kit Registry Configuration"] = 836,
    ["SPDX 2.3"] = 874,
    SWADL = 890,
    ["Safebox Config"] = 1116,
    ["Sapphire CLI Config"] = 801,
    ["SauceCTL Configuration"] = 1064,
    Scarb = 821,
    ["Schema Catalog"] = 816,
    ["Scoop manifest"] = 822,
    ["Semantic Data Fabric (SDF) file"] = 826,
    ["Semgrep Rule"] = 828,
    ["Serenity Code Generator (Sergen)"] = 829,
    ["Serverless Framework Configuration"] = 1071,
    ["Serverless Workflow"] = 1073,
    ["Settings for a Cinnamon spice"] = 1206,
    ["Settings.paf"] = 831,
    ["Shopware 6 Configuration"] = 1074,
    ["Shopware CLI Extension Store Configuration"] = 1075,
    ["Shopware CLI Project Store Configuration"] = 1076,
    ["Sigma Detection Rule"] = 833,
    ["SigmaCV CV"] = 1,
    ["Sigrid scope configuration file"] = 834,
    ["SkyPilot Task JSON"] = 1162,
    ["Slack app manifest"] = 838,
    Snapcraft = 840,
    ["Solarxy project config"] = 843,
    Solidarity = 844,
    ["Solution filters"] = 845,
    ["Source Maps v3"] = 846,
    Sourcery = 847,
    ["Spack bootstrap.yaml"] = 848,
    ["Spack cdash.yaml"] = 849,
    ["Spack ci.yaml"] = 850,
    ["Spack compilers.yaml"] = 851,
    ["Spack concretizer.yaml"] = 852,
    ["Spack config.yaml"] = 853,
    ["Spack definitions.yaml"] = 854,
    ["Spack develop.yaml"] = 855,
    ["Spack env_vars.yaml"] = 856,
    ["Spack environment"] = 862,
    ["Spack include.yaml"] = 857,
    ["Spack mirrors.yaml"] = 858,
    ["Spack modules.yaml"] = 859,
    ["Spack packages.yaml"] = 860,
    ["Spack repos.yaml"] = 861,
    ["Spack toolchains.yaml"] = 863,
    ["Spack upstreams.yaml"] = 864,
    ["Spack view.yaml"] = 865,
    ["Speakeasy Generation Config File"] = 869,
    ["Speakeasy Lint Configuration File"] = 866,
    ["Speakeasy Test Generation Configuration File"] = 867,
    ["Speakeasy Workflow File"] = 868,
    SpecIF = 870,
    ["Specmatic Configuration"] = 871,
    ["Sponge Mixin configuration"] = 872,
    StackBlitz = 878,
    ["StackHawk Scanner Configuration"] = 1070,
    Stale = 879,
    Starfish = 880,
    ["Starlake Data Pipeline"] = 1042,
    Starship = 881,
    ["Statamic Blueprint"] = 882,
    ["Stella configuration file"] = 883,
    ["Streamlit configuration file"] = 884,
    ["Stryker Mutator"] = 887,
    ["StyleCop Analyzers Configuration"] = 888,
    ["Stylelint (.stylelintrc)"] = 889,
    ["Stylua Config"] = 1257,
    ["Sublime Syntax"] = 1117,
    ["Subsquid squid manifest"] = 1164,
    ["Swagger API 2.0"] = 891,
    ["Synadia Connect Component"] = 892,
    TSON = 928,
    TSTyche = 929,
    ["TYPO3 Vendor Bundler config"] = 935,
    ["Tab data for a LinUtil"] = 1213,
    ["Tab list for a LinUtil"] = 1212,
    Tach = 893,
    ["Tach Domain"] = 894,
    Talhelper = 896,
    ["Talisman configuration"] = 897,
    Taplo = 1258,
    ["Taskfile config"] = 1047,
    Taurus = 898,
    Tauticord = 899,
    ["Tekton Pipeline"] = 1286,
    ["Tekton PipelineRun"] = 1287,
    ["Tekton Task"] = 1284,
    ["Tekton TaskRun"] = 1285,
    Telefonistka = 1244,
    ["Terrateam config"] = 1270,
    ["TestEnvironment.json"] = 911,
    ["TextMate Grammar"] = 910,
    Threagile = 905,
    ["Tier.run pricing.json"] = 902,
    Tikibase = 903,
    Tombi = 908,
    ["Traefik v2"] = 914,
    ["Traefik v2 File Provider"] = 915,
    ["Traefik v3"] = 916,
    ["Traefik v3 File Provider"] = 917,
    ["Travis CI (.travis.yml)"] = 913,
    Treefmt = 461,
    Trident = 1240,
    ["TrueScript for *.tscript files"] = 920,
    ["Tugboat QA config.yml"] = 1237,
    TunnelHub = 1152,
    Turborepo = 912,
    Tycho = 1201,
    Tye = 1078,
    ["Tyk Gateway - Open Source v5.7+"] = 1249,
    ["UET BuildConfig.json"] = 1122,
    ["UI5 Manifest"] = 941,
    ["UNCORS configuration"] = 946,
    ["UTAM Page Object"] = 944,
    ["Ubuntu Server Autoinstall"] = 939,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1241,
    ["Uniswap Token List"] = 1027,
    ["Universal Schedule Format"] = 947,
    ["Unreal Engine Uplugin"] = 1123,
    ["Unreal Engine Uproject"] = 1124,
    ["UpCloud CLI (upctl) configuration"] = 1242,
    ["Updatecli Compose"] = 1086,
    ["Updatecli Policy Manifest"] = 1087,
    ["Updatecli Policy Metadata"] = 1088,
    Uplift = 1120,
    ["Upsun config"] = 8,
    ["User Journey Map"] = 1052,
    V2Ray = 1092,
    ["VSCode Code Snippets"] = 264,
    ["VSIX CLI publishing"] = 965,
    Vector = 949,
    ["Vela Pipeline Configuration"] = 952,
    Vercel = 263,
    ["Version Bumper config"] = 955,
    Vespertide = 1291,
    ["Vespertide Migration"] = 1292,
    ["Vespertide Model"] = 1293,
    ["Viash Component Config"] = 1246,
    ["Viash Package Config"] = 1247,
    Visivo = 1150,
    ["WP-CLI"] = 975,
    Wake = 1239,
    ["Waku Config"] = 1216,
    ["Web App Manifest"] = 971,
    ["Web types"] = 974,
    WebExtensions = 970,
    ["Webman package recipe"] = 1098,
    ["Windows Package Manager Installer Manifest"] = 1024,
    ["Windows Package Manager Locale Manifest"] = 1025,
    ["Windows Package Manager Singleton Manifest"] = 1023,
    ["WireMock CLI import configuration"] = 1222,
    ["WireMock CLI local service configuration"] = 1221,
    ["WireMock message stub mapping"] = 1220,
    ["WireMock stub mapping"] = 1219,
    ["Woodpecker pipeline config"] = 1066,
    ["Wrangler CLI"] = 976,
    ["XenForo add-on manifest"] = 977,
    ["Xstate Machine"] = 1084,
    ["Yandex Workflow Language"] = 1208,
    ["Yarn Config (.yarnrc.yml)"] = 1040,
    ["Yippee-Ki-JSON configuration YML"] = 1031,
    ["YouTrack App"] = 1205,
    ["Zarf Package Configuration"] = 1272,
    ["Zerops import file"] = 1193,
    ["Zola Configuration"] = 1283,
    ["aerleon.yml"] = 22,
    ["amplify.yml"] = 15,
    ["amxx-builder manifest"] = 1335,
    ["angular.json"] = 39,
    apko = 1155,
    ["app-definition.yaml"] = 43,
    ["apple-app-site-association"] = 41,
    ["appsettings.StormPetrel.json"] = 48,
    ["appsettings.json"] = 46,
    ["appsscript.json"] = 45,
    ["appveyor.yml"] = 47,
    ["aqua-generate-registry.yaml"] = 50,
    ["aqua-policy.yaml"] = 51,
    ["aqua.yaml"] = 49,
    ["arazzo.json"] = 53,
    ["arb.json"] = 54,
    ["arc.json"] = 56,
    ["architect.yml"] = 55,
    ["artifacthub-repo.yml"] = 60,
    ["asm-lsp"] = 61,
    ["ast-grep rules"] = 64,
    ["ast-grep sgconfig.yml"] = 63,
    ["azure.yaml"] = 72,
    ["babelrc.json"] = 126,
    ["bamboo-spec"] = 130,
    basedpyright = 128,
    ["bashly-strings.yml"] = 1132,
    ["batect.yml"] = 129,
    ["beef-database-codegen"] = 131,
    ["beef-database-v5-codegen"] = 133,
    ["beef-entity-codegen"] = 132,
    ["beef-entity-v5-codegen"] = 134,
    ["behat.yml"] = 147,
    ["bigquery-table"] = 135,
    ["bioimageio resource description"] = 1172,
    ["bitbucket-pipelines"] = 137,
    bitrise = 138,
    ["bitrise-step"] = 139,
    ["block.json"] = 164,
    ["bottom configuration"] = 88,
    ["bower.json"] = 141,
    ["bozr.suite.json"] = 151,
    bpkg = 1133,
    ["browser.i18n.json"] = 152,
    ["browsh configuration"] = 153,
    bucklescript = 154,
    ["buf.gen.yaml"] = 91,
    ["buf.lock"] = 92,
    ["buf.plugin.yaml"] = 93,
    ...
    ["build-changelog"] = 155,
    ["bun.lock"] = 160,
    ["bundleconfig.json"] = 161,
    ["bunfig.toml"] = 162,
    ["cargo-mutants-config.yaml"] = 96,
    ["cargo-nextest repository configuration"] = 625,
    ["cargo-nextest user configuration"] = 626,
    ["ccmod.json"] = 1217,
    changelogging = 1184,
    ["chisel-slices.json"] = 290,
    ["chrome-extension-locales-messages.json"] = 271,
    ["chutzpah.json"] = 272,
    cibuildwheel = 184,
    ["clang-format (.clang-format)"] = 1090,
    ["clang-tidy"] = 247,
    clangd = 246,
    clib = 248,
    ["cloud-init: cloud-config userdata"] = 250,
    ["cloud-sdk-pipeline-configuration"] = 274,
    ["cloudbuild.json"] = 275,
    cloudify = 249,
    cmakefmt = 202,
    ["cmdx.yaml"] = 99,
    ...
    ["commands.json"] = 267,
    ["commit-check"] = 293,
    ["commitlint (.commitlintrc)"] = 1026,
    ["committed.toml"] = 294,
    ["compile_commands.json"] = 266,
    ["compilerconfig.json"] = 265,
    ["completely.yml"] = 1128,
    ["component-detection-manifest.json"] = 297,
    ["component.json"] = 296,
    ["composer.json"] = 295,
    ["conda-forge"] = 188,
    ["config.yaml"] = 753,
    ["contentmanifest.json"] = 273,
    ["contribute.json"] = 298,
    ["cosmos.config.json"] = 269,
    ["crowdin.yml"] = 299,
    ["ctfd-setup configuration file"] = 1229,
    ["custom-elements.json"] = 1142,
    ["cypress.json"] = 303,
    ["dacier.yml"] = 1323,
    ["datalogic-scan2deploy-android"] = 313,
    ["datalogic-scan2deploy-ce"] = 314,
    ["dbt Dependencies"] = 209,
    ["dbt Packages"] = 211,
    ["dbt Project"] = 210,
    ["dbt Selectors"] = 212,
    ["dbt YAML files"] = 213,
    ...
    ["ddev-global"] = 315,
    ["ddev-project"] = 316,
    ["debugsettings.json"] = 317,
    ["dependabot-v2.json"] = 320,
    ["dependabot.json"] = 319,
    ["deployed-cli"] = 1083,
    ["devcontainer-feature.json"] = 257,
    ["devcontainer.json"] = 256,
    devinit = 1033,
    ["devspace.yaml"] = 1106,
    djlint = 1034,
    ["docker bake"] = 326,
    ["docker sequencer"] = 327,
    ["docker-compose.yml"] = 1032,
    ["dockerd.json"] = 324,
    ["dotnet Release Index manifest"] = 339,
    ["dotnet-tools.json"] = 340,
    ["dotnetcli.host.json"] = 341,
    ["dprint.json"] = 342,
    ["drone.json"] = 343,
    ["dss-2.0.0.json"] = 345,
    ["dstack configuration"] = 346,
    ["dtool dataset metadata"] = 1224,
    ["dvc.yaml"] = 347,
    ["ecosystem.json"] = 352,
    eksctl = 354,
    ["electron-builder configuration file"] = 380,
    ["epr-manifest.json"] = 379,
    ["estampo.toml"] = 378,
    ["evcc.yaml"] = 381,
    ["ezd task runner"] = 392,
    ["fabric.mod.json"] = 395,
    ["first-timers-bot"] = 403,
    ["flagd flag configuration"] = 121,
    ["fly.io Configuration"] = 122,
    fulibWorkflows = 1065,
    ["function.json"] = 415,
    ["gRPC API Gateway & OpenAPI Config"] = 17,
    ["gematik health care insurance list"] = 1235,
    ["gematik health care patient list"] = 1232,
    ["gematik health care provider institution list"] = 1234,
    ["gematik health care provider list"] = 1233,
    ["gematik tiger test environment configuration"] = 1236,
    ["git-town.toml"] = 1281,
    ["gitlab-ci"] = 435,
    ["global.json"] = 451,
    ["go-feature-flag Flag Configuration"] = 454,
    ["haxelib.json"] = 473,
    helmfile = 1019,
    helmwave = 1020,
    ["host-meta.json"] = 480,
    ...
    ["ide.host.json"] = 488,
    ["ifstate.yaml"] = 489,
    ["imageoptimizer.json"] = 490,
    ["importmap.json"] = 493,
    instant_python_config = 497,
    instant_python_custom_project = 498,
    intlayer = 499,
    ["ioBroker Configuration"] = 500,
    ["ioBroker JSON UI"] = 501,
    ["ioBroker Package manifest"] = 502,
    ["ixpect.conf.yaml"] = 503,
    ["ize.toml"] = 1119,
    ["jsconfig.json"] = 528,
    ["jscpd Configuration"] = 1103,
    jsdoc = 1015,
    ["k3d.yaml"] = 529,
    ["k9s aliases.yaml"] = 531,
    ["k9s cluster-config.yaml"] = 533,
    ["k9s config.yaml"] = 532,
    ["k9s hotkeys.yaml"] = 534,
    ["k9s plugins.yaml"] = 535,
    ["k9s skin.yaml"] = 536,
    ["k9s views.yaml"] = 537,
    ["kontinuous-config.yaml"] = 549,
    ["kontinuous-values.yaml"] = 548,
    ["kustomization.yaml"] = 551,
    ["label-commenter-config.yml"] = 552,
    ["latexindent configuration"] = 114,
    ["launchsettings.json"] = 553,
    lazydocker = 1141,
    lazygit = 1140,
    ["lego.json"] = 555,
    ["lerna.json"] = 556,
    ["lgtm.yml"] = 557,
    ["liblab.config.json"] = 558,
    ["libman.json"] = 559,
    ["license-report-config.json"] = 560,
    ["linkinator.config.json"] = 562,
    ["lint-staged (.lintstagedrc)"] = 993,
    ["local.settings.json"] = 567,
    ["localazy.json"] = 568,
    ["lotus.yaml"] = 566,
    ["lsdlschema.json"] = 569,
    ["macro.json"] = 1107,
    ["markdown-link-check"] = 1061,
    maturin = 1062,
    mboats = 1069,
    memnex = 1321,
    ["micro-settings.json"] = 1134,
    ["mimetypes.json"] = 584,
    ["mirrord config"] = 995,
    mise = 996,
    ["mkdocs.yml"] = 604,
    ["mockd.yaml"] = 608,
    ["modelparams.dev Model"] = 610,
    ["monospace.yml"] = 611,
    ["moon.yml"] = 1218,
    ["mprocs Configuration file"] = 1188,
    ["mrdocs.yml"] = 606,
    ["mta.yaml"] = 997,
    ["mtad.yaml"] = 998,
    ["mycode.json"] = 618,
    nFPM = 627,
    ["napari plugin manifest"] = 619,
    neoload = 1010,
    ["nest-cli"] = 630,
    ["nexus-rpc-gen"] = 1308,
    ["ninjs (News in JSON)"] = 629,
    ["nitro.json"] = 1009,
    ["nixd configuration"] = 1160,
    ["nlu.json"] = 631,
    ["nodemon.json"] = 633,
    ["noodl config"] = 1068,
    ["notebook.mod.json"] = 634,
    now = 1005,
    ["npm-badges"] = 637,
    ["nswag.json"] = 641,
    ntangle = 643,
    ["nuclei-template.yaml"] = 638,
    ["nuget-project.json"] = 639,
    ["ocelot.json"] = 645,
    ogen = 648,
    ["omnisharp.json"] = 651,
    openHAB = 1294,
    ...
    oxlint = 1305,
    ["package.json"] = 686,
    ["package.manifest"] = 688,
    ["package.yaml"] = 687,
    ["partial-black.json"] = 148,
    ["partial-fastapi.json"] = 149,
    ["partial-pixi.json"] = 698,
    ["partial-scheduled.json"] = 150,
    ["pattern.json"] = 696,
    ["petstore-v1.0"] = 1114,
    pgap_yaml_input_reader = 694,
    pgrls = 695,
    pgxgen = 1298,
    pitcms = 1301,
    ["pixi.toml"] = 697,
    ["plagiarize-me.yaml"] = 702,
    ["plagiarize.yaml"] = 701,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1225,
    ["podbard.yaml"] = 704,
    ["portman.json"] = 707,
    ["prefect.toml"] = 716,
    ["prefect.yaml"] = 717,
    ...
    ["prettierrc.json"] = 719,
    ["prisma.yml"] = 720,
    ["project-1.0.0-beta3.json"] = 732,
    ["project-1.0.0-beta4.json"] = 733,
    ["project-1.0.0-beta5.json"] = 734,
    ["project-1.0.0-beta6.json"] = 735,
    ["project-1.0.0-beta8.json"] = 736,
    ["project-1.0.0-rc1.json"] = 737,
    ["project-1.0.0-rc2.json"] = 738,
    ["project.json"] = 731,
    ["project.owasp.yaml"] = 739,
    ["prometheus-alertmanager.json"] = 743,
    ["prometheus.json"] = 740,
    ["prometheus.rules.json"] = 741,
    ["prometheus.rules.test.json"] = 742,
    ["proxies.json"] = 744,
    ["publiccode.yml"] = 745,
    ["pubspec.yaml"] = 746,
    ["pyrseas-0.8.json"] = 749,
    pytest = 758,
    ["quilt.mod.json"] = 1135,
    ["rc3 auth"] = 764,
    ["rc3 collection"] = 765,
    ...
    ["rc3 settings"] = 769,
    ["registry.yaml"] = 52,
    ["release drafter"] = 1011,
    ["release-hub.json"] = 4,
    ["release-please-config.json"] = 774,
    ["release-please-manifest.json"] = 775,
    ["release-plz.toml"] = 776,
    ["renv.lock"] = 790,
    ["reposets Configuration"] = 779,
    ["reposets Credentials"] = 780,
    ["revola.json"] = 2,
    ["rivet.json"] = 1159,
    ["rivet.yaml (legacy)"] = 1158,
    rumdl = 795,
    runny = 794,
    runspec = 1322,
    rustfmt = 796,
    ...
    samt = 799,
    samtrc = 800,
    ["sarif-1.0.0.json"] = 802,
    ["sarif-2.0.0.json"] = 803,
    ["sarif-2.1.0"] = 813,
    ["sarif-2.1.0-rtm.2"] = 804,
    ["sarif-2.1.0-rtm.3"] = 806,
    ["sarif-2.1.0-rtm.4"] = 808,
    ["sarif-2.1.0-rtm.5"] = 810,
    ["sarif-2.1.0-rtm.6"] = 811,
    ["sarif-external-property-file-2.1.0"] = 814,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 805,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 807,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 809,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 812,
    ["scalingo.json configuration"] = 815,
    ["schema.org - Action"] = 817,
    ["schema.org - ContactPoint"] = 818,
    ["schema.org - Place"] = 819,
    ["schema.org - Thing"] = 820,
    ["secrethub.yml"] = 1137,
    ["semantic-release"] = 827,
    ["servicehub.config.json"] = 988,
    ["servicehub.service.json"] = 987,
    ["settings.job"] = 830,
    ["sfdx-hardis configuration"] = 832,
    ["shard.yml"] = 1175,
    ["size-limit configuration"] = 837,
    ["skaffold.yaml"] = 1059,
    ["skyuxconfig.json"] = 839,
    ["snowflake-config"] = 841,
    ["snowflake-connections"] = 842,
    ["spicepod.yaml"] = 1196,
    ["sqlc configuration"] = 875,
    ["stripe-app-local.json"] = 886,
    ["stripe-app.json"] = 885,
    swcrc = 1043,
    ["task.json"] = 895,
    taskcat = 1006,
    ["template.json"] = 900,
    ["templatsources.json"] = 901,
    ["text2confl config"] = 1306,
    ["theme.json"] = 904,
    ["tizen_workspace.json"] = 906,
    tldr = 907,
    ["tm_devices configuration file"] = 1263,
    tmuxinator = 991,
    tox = 909,
    ["transcend.yml"] = 918,
    ["tree-sitter grammar.json"] = 460,
    ["trime.yaml"] = 919,
    ["trunk.yaml"] = 921,
    ["ts-force-config.json"] = 926,
    ["tsconfig.json"] = 922,
    ["tsd.json"] = 923,
    ["tsdoc.json"] = 924,
    ["tsdrc.json"] = 925,
    ...
    v8r = 969,
    vcluster = 1182,
    ["vcpkg configuration file"] = 262,
    ["vcpkg manifest file"] = 261,
    ["vega-lite.json"] = 951,
    ["vega.json"] = 950,
    ["venvironment.yaml"] = 953,
    ["venvplus.yaml"] = 954,
    version = 1245,
    ["version.json"] = 956,
    ["vhwdebugger-binding.yaml"] = 958,
    ["vim-addon-info"] = 959,
    ["vs-2017.3.host.json"] = 961,
    ["vs-nesting.json"] = 962,
    ["vsls.json"] = 960,
    ["vss-extension.json"] = 966,
    vtcfg = 1251,
    ["vtesttree.yaml"] = 967,
    ["vtestunit.yaml"] = 968,
    ["warp-keysets.json"] = 1143,
    ["warp-themes.json"] = 1144,
    ["warp-workflows.json"] = 1145,
    ["webhint.io"] = 1099,
    ["webjobpublishsettings.json"] = 973,
    ["webjobs-list.json"] = 972,
    ["well-known-fursona"] = 1183,
    ["xs-app.json"] = 1001,
    ["xunit.runner.json"] = 986,
    yamlfmt = 1028,
    yamllint = 1029,
    ["yap.json"] = 1030,
    ["zerops.yml"] = 1192,
