...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 178,
    [".cryproj (generic)"] = 612,
    [".cryproj engine-5.2"] = 607,
    [".cryproj engine-5.3"] = 608,
    [".cryproj engine-5.4"] = 609,
    [".cryproj engine-5.5"] = 610,
    [".cryproj engine-dev"] = 611,
    [".csscomb.json"] = 180,
    [".csslintrc"] = 181,
    [".es6importsorterrc.json"] = 743,
    [".eslintrc"] = 230,
    [".esmrc.json"] = 222,
    [".ffizer.yaml"] = 234,
    [".htmlhintrc"] = 287,
    ...
    [".mtaext"] = 621,
    [".nodehawkrc"] = 388,
    [".npmpackagejsonlintrc"] = 391,
    [".phraseapp.yml"] = 435,
    [".pmbot.yml"] = 424,
    [".postcssrc"] = 430,
    [".powerpages-web-template-manifest"] = 432,
    [".pre-commit-config.yml"] = 433,
    [".pre-commit-hooks.yml"] = 434,
    [".putout.json"] = 454,
    [".rehyperc"] = 466,
    [".remarkrc"] = 467,
    [".sprite files"] = 522,
    ...
    ["<div>RIOTS' studio configuration"] = 591,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 347,
    ["API Builder"] = 653,
    ["AVA Configuration"] = 712,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 685,
    ["All Contributors configuration file"] = 742,
    ...
    ["Azure Pipelines"] = 59,
    ["Azure Static Web Apps CLI configuration file"] = 525,
    ["Azure Static Web Apps configuration file"] = 524,
    ["BX CI"] = 95,
    ["Better Code Hub"] = 657,
    ["Better Scripts"] = 96,
    Bigconfig = 76,
    BizTalkServerApplicationSchema = 627,
    Bleep = 97,
    ...
    ["Butane Config"] = 697,
    ["CICS TS region tagging"] = 706,
    ["CICS TS resource import"] = 707,
    ["CICS TS resource model"] = 708,
    ["CICS TS resource overrides"] = 709,
    ["CMake Presets"] = 98,
    ["CNC Codes"] = 108,
    ...
    ["Databricks Asset Bundles"] = 763,
    ["Datadog Service Definition"] = 326,
    ["Datahub Ingestion Recipe"] = 713,
    ["Dein Config"] = 113,
    Deno = 191,
    ["Deployer Recipe"] = 194,
    ["Deta Spacefile"] = 114,
    ...
    FiQuS = 237,
    Firebase = 235,
    ["Fossa configuration file"] = 244,
    ["Fossa's fossa-deps file"] = 245,
    ["Foundry VTT - Base package Manifest"] = 239,
    ["Foundry VTT - Module Manifest"] = 240,
    ["Foundry VTT - System Data Template"] = 243,
    ["Foundry VTT - System Manifest"] = 241,
    ["Foundry VTT - World Manifest"] = 242,
    ["Foxx Manifest"] = 61,
    ["Freifunk.de Community API"] = 64,
    ["Frogbot Config"] = 65,
    ["G2P Mapping Configuration"] = 249,
    ["GCP Blueprint Metadata"] = 252,
    Gaspar = 250,
    ["GatewayCore API Gateway"] = 251,
    ["GeoJSON.json latest"] = 701,
    GherKing = 705,
    ["GitHub Action"] = 256,
    ["GitHub Discussion"] = 257,
    ["GitHub Funding"] = 258,
    ["GitHub Issue Template configuration"] = 260,
    ["GitHub Workflow"] = 261,
    ["GitHub Workflow Template Properties"] = 262,
    ["GitHub issue forms"] = 259,
    GitVersion = 255,
    ["Gitpod Configuration"] = 264,
    ["Global Privacy Control"] = 253,
    Goblet = 762,
    ...
    ["Goreleaser Pro"] = 269,
    Goss = 270,
    ["Gradle Build Cache Node"] = 655,
    ["Gradle Enterprise"] = 654,
    ["Grafana 5.x Dashboard"] = 271,
    ["GraphQL Code Generator"] = 274,
    ["GraphQL Config"] = 273,
    ["GraphQL Mesh"] = 272,
    ["Grunt JSHint task"] = 278,
    ["Grunt Watch task"] = 279,
    ["Grunt base task"] = 280,
    ["Grunt clean task"] = 276,
    ["Grunt copy task"] = 275,
    ["Grunt cssmin task"] = 277,
    HEMTT = 624,
    Hadolint = 636,
    Hammerkit = 664,
    ["Hardware Sentry Configuration"] = 717,
    Hatch = 637,
    Hayson = 282,
    ["Haystack Pipeline"] = 283,
    ["Hazelcast 5 Configuration"] = 284,
    ["Helm Chart.lock"] = 130,
    ["Helm Chart.yaml"] = 129,
    ["Helm Unittest Test Suite"] = 131,
    Hugo = 693,
    ["IBM Zapp document"] = 289,
    ["IBM zCodeFormatSettings"] = 290,
    ["IMG Catapult PSP"] = 295,
    Istanbul = 720,
    ["JDownloader2 crawler multi-rules"] = 305,
    ["JDownloader2 crawler single-rules"] = 304,
    ["JFrog Applications Config"] = 306,
    ["JFrog File Spec"] = 307,
    ["JFrog Pipelines YML DSL"] = 726,
    ["JMeter DSL cli config"] = 308,
    JReleaser = 310,
    ["JSON Document Transform"] = 317,
    ["JSON Feed"] = 318,
    ["JSON Resume"] = 473,
    ["JSON Schema Draft 2020-12"] = 603,
    ["JSON Schema Draft 4"] = 600,
    ["JSON Schema Draft 7"] = 601,
    ["JSON Schema Draft 7 (unofficial strict)"] = 764,
    ["JSON Schema Draft 8 (2019-09)"] = 602,
    ["JSON-API"] = 316,
    ["JSON-e templates"] = 662,
    ["JSON-stat 2.0"] = 597,
    JSONPatch = 320,
    Jasmine = 300,
    Jekyll = 301,
    ["Jenkins X Pipelines"] = 302,
    ["Jenkins X Requirements"] = 303,
    ["Jovo Language Models"] = 309,
    ["KSP-AVC"] = 598,
    ["KSP-CKAN"] = 599,
    ["Karakum configuration file"] = 246,
    Kas = 323,
    ["Keycloak REST API"] = 734,
    ["Knative Functions - func.yaml"] = 247,
    ["KoDE/CI build.yaml"] = 722,
    ["Kong DBLess config"] = 723,
    KrakenD = 325,
    LOOBin = 342,
    Lefthook = 333,
    ["LinkML Metamodel"] = 340,
    Liquibase = 669,
    ["Liquibase Flow File"] = 670,
    ["Lively Properties"] = 341,
    ["Lobe AI Agent"] = 58,
    ["MLOS Configs"] = 374,
    ["MS2Rescore Configuration"] = 376,
    Markdownlint = 673,
    ["Mason Registry"] = 675,
    ...
    ["Minecraft Data Pack Advancement"] = 354,
    ["Minecraft Data Pack Biome"] = 355,
    ["Minecraft Data Pack Configured Carver"] = 356,
    ["Minecraft Data Pack Damage Type"] = 357,
    ["Minecraft Data Pack Dimension"] = 359,
    ["Minecraft Data Pack Dimension Type"] = 358,
    ["Minecraft Data Pack Item Modifier"] = 360,
    ["Minecraft Data Pack Loot Table"] = 361,
    ["Minecraft Data Pack Metadata"] = 362,
    ["Minecraft Data Pack Predicate"] = 363,
    ["Minecraft Data Pack Recipe"] = 364,
    ["Minecraft Data Pack Tag"] = 365,
    ["Minecraft Data Pack Template Pool"] = 366,
    ["Minecraft Data Pack Trim Material"] = 371,
    ["Minecraft Data Pack Trim Pattern"] = 372,
    ["Minecraft Resource Pack Lang"] = 367,
    ["Minecraft Resource Pack Particle"] = 368,
    ["Minecraft Resource Pack Texture Mcmeta"] = 370,
    ["Minecraft Resourcepack Sounds"] = 369,
    ["MkDocs Configuration 1.0"] = 373,
    ["MongoDB Atlas Search Index Definition"] = 721,
    ["Monika Configuration"] = 719,
    ["Motif config"] = 620,
    ["NOX Framework (Service)"] = 390,
    ["Netin Diagnostic System Template"] = 679,
    ["Netlify config"] = 381,
    ["Nexus-as-Code Data Model"] = 382,
    ["Nightwatch.js"] = 383,
    ["ONe's service descriptor"] = 405,
    ["OSS Review Toolkit configuration"] = 412,
    ["OSS Review Toolkit curation"] = 413,
    ["OSS Review Toolkit package configuration"] = 414,
    ["OSS Review Toolkit repository configuration"] = 415,
    ["OSS Review Toolkit resolutions"] = 416,
    Opctl = 623,
    ["OpenRewrite Resource"] = 407,
    ["OpenUtau character yaml"] = 402,
    ["OpenUtau ustx"] = 403,
    ["OpenWeather Current Weather API"] = 661,
    ["OpenWeather Road Risk API"] = 660,
    ["Ory Hydra configuration"] = 288,
    ["Ory Keto configuration"] = 327,
    ["Ory Kratos configuration"] = 411,
    ["Ory Oathkeeper configuration"] = 397,
    ["Outblocks App configuration"] = 409,
    ["Outblocks database table"] = 410,
    ["Outblocks project configuration"] = 408,
    Packer = 419,
    Pantsbuild = 741,
    ["Paper paper-plugin.yml"] = 420,
    ["Pipeline component"] = 671,
    ["PocketMine plugin.yml"] = 425,
    Poetry = 426,
    ["Postman collection"] = 431,
    ["Problem object RFC9457"] = 768,
    ["Problem package generators"] = 438,
    Pterodactyl = 716,
    ["Pull Request Labeler"] = 453,
    Pulumi = 459,
    PyProject = 460,
    Pyright = 461,
    Qgoda = 462,
    Qodana = 690,
    ["Quali Torque Blueprint Spec 2"] = 714,
    ["QueryFirst config file"] = 737,
    ["RKE Cluster Configuration JSON"] = 668,
    ["RKE Cluster Configuration YAML"] = 667,
    ["Rancher Fleet"] = 456,
    Ray = 635,
    ["Read the Docs"] = 458,
    ["Red-DiscordBot Cog"] = 463,
    ["Red-DiscordBot Cog Repo"] = 464,
    ["Red-DiscordBot Trivia"] = 465,
    RenderCV = 475,
    Renovate = 474,
    ["Replit config"] = 468,
    RoadRunner = 476,
    ...
    ["Rust Project"] = 472,
    ["Rust toolchain"] = 478,
    ["SIL Kit Participant Configuration"] = 510,
    ["SIL Kit Registry Configuration"] = 511,
    SWADL = 535,
    ["Safebox Config"] = 727,
    ["Sapphire CLI Config"] = 481,
    ["SauceCTL Configuration"] = 676,
    ["Schema Catalog"] = 495,
    ["Scoop manifest"] = 500,
    ["Semantic Data Fabric (SDF) file"] = 501,
    ["Semgrep Rule"] = 503,
    ["Serenity Code Generator (Sergen)"] = 504,
    ["Serverless Framework Configuration"] = 684,
    ["Serverless Workflow"] = 686,
    ["Settings.paf"] = 506,
    Setuptools = 507,
    ["Shopware 6 Configuration"] = 687,
    ["Shopware CLI Extension Store Configuration"] = 688,
    ["Shopware CLI Project Store Configuration"] = 689,
    ["Sigrid scope configuration file"] = 509,
    ["Slack app manifest"] = 513,
    Solidarity = 516,
    ["Solution filters"] = 517,
    ["Source Maps v3"] = 518,
    Sourcery = 519,
    SpecIF = 520,
    ["Sponge Mixin configuration"] = 521,
    StackBlitz = 526,
    ["StackHawk Scanner Configuration"] = 683,
    Stale = 527,
    ["Starlake Data Pipeline"] = 658,
    Starship = 528,
    ["Statamic Blueprint"] = 529,
    ["StrmPrivacy Data Connector"] = 731,
    ["StrmPrivacy Data Contract"] = 732,
    ["StrmPrivacy SimpleSchema"] = 729,
    ["StrmPrivacy Stream"] = 730,
    ["StrmPrivacy batch job configuration file"] = 728,
    ["Stryker Mutator"] = 532,
    ["StyleCop Analyzers Configuration"] = 533,
    ["Sublime Syntax"] = 733,
    ["Swagger API 2.0"] = 536,
    TSON = 561,
    TSTyche = 562,
    Talhelper = 538,
    ["Talisman configuration"] = 539,
    ["Taskfile config"] = 663,
    Taurus = 540,
    ["TestEnvironment.json"] = 549,
    ["TextMate Grammar"] = 548,
    ["Tier.run pricing.json"] = 543,
    Tikibase = 544,
    ["Traefik v2"] = 552,
    ["Traefik v2 File Provider"] = 553,
    TunnelHub = 767,
    Turborepo = 550,
    Tye = 691,
    ["UET BuildConfig.json"] = 738,
    ["UI5 Manifest"] = 570,
    ["UTAM Page Object"] = 573,
    ["Ubuntu Server Autoinstall"] = 568,
    ["Uniswap Token List"] = 646,
    ["Unreal Engine Uplugin"] = 739,
    ["Unreal Engine Uproject"] = 740,
    ["Updatecli Compose"] = 698,
    ["Updatecli Policy Manifest"] = 699,
    ["Updatecli Policy Metadata"] = 700,
    Uplift = 736,
    ["User Journey Map"] = 666,
    V2Ray = 704,
    ["VSCode Code Snippets"] = 149,
    ["VSIX CLI publishing"] = 586,
    ["Vela Pipeline Configuration"] = 576,
    Vercel = 148,
    Visivo = 765,
    ["Web App Manifest"] = 593,
    ["Web types"] = 596,
    WebExtensions = 592,
    ["Webman package recipe"] = 710,
    ["Windows Package Manager Installer Manifest"] = 643,
    ["Windows Package Manager Locale Manifest"] = 644,
    ["Windows Package Manager Singleton Manifest"] = 642,
    ["Woodpecker pipeline config"] = 678,
    ["Xstate Machine"] = 696,
    ["Yippee-Ki-JSON configuration YML"] = 648,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    apko = 769,
    ...
    ["bamboo-spec"] = 70,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 747,
    ["bashly-strings.yml"] = 748,
    ["bashly.yml"] = 746,
    ["batect.yml"] = 69,
    ...
    ["gitlab-ci"] = 263,
    ["global.json"] = 265,
    ["go-feature-flag Flag Configuration"] = 267,
    ["golangci-lint Configuration"] = 266,
    ["haxelib.json"] = 281,
    helmfile = 638,
    helmwave = 639,
    ["host-meta.json"] = 286,
    ...
    ["ide.host.json"] = 291,
    ["ifstate.conf"] = 292,
    ["imageoptimizer.json"] = 293,
    ["importmap.json"] = 296,
    ["ioBroker Configuration"] = 297,
    ["ioBroker JSON UI"] = 298,
    ["ioBroker Package manifest"] = 299,
    ["ize.toml"] = 735,
    ["jsconfig.json"] = 321,
    ["jscpd Configuration"] = 715,
    jsdoc = 634,
    ["k3d.yaml"] = 322,
    ["k9s plugin.yml"] = 324,
    ["kontinuous-config.yaml"] = 329,
    ["kontinuous-values.yaml"] = 328,
    ["kustomization.yaml"] = 330,
    ["label-commenter-config.yml"] = 331,
    ["launchsettings.json"] = 332,
    lazydocker = 757,
    lazygit = 756,
    ["lego.json"] = 334,
    ["lerna.json"] = 335,
    ["lgtm.yml"] = 336,
    ["libman.json"] = 337,
    ["license-report-config.json"] = 338,
    ["linkinator.config.json"] = 339,
    ["local.settings.json"] = 344,
    ["localazy.json"] = 345,
    ["lotus.yaml"] = 343,
    ["lsdlschema.json"] = 346,
    ["madness.yml"] = 745,
    ["markdown-lint-check"] = 674,
    mboats = 681,
    ["micro-settings.json"] = 750,
    ["mimetypes.json"] = 353,
    ["mirrord config"] = 617,
    ["monospace.yml"] = 375,
    ["mta.yaml"] = 618,
    ["mtad.yaml"] = 619,
    ["mycode.json"] = 379,
    ["napari plugin manifest"] = 380,
    neoload = 629,
    ["nest-cli"] = 386,
    ["ninjs (News in JSON) 1.3"] = 385,
    ["ninjs (News in JSON) 2.0"] = 384,
    ["nlu.json"] = 387,
    ["nodemon.json"] = 389,
    ["noodl config"] = 680,
    now = 625,
    ...
    ["nswag.json"] = 395,
    ntangle = 396,
    ["nuclei-template.yaml"] = 393,
    ["nuget-project.json"] = 394,
    ["ocelot.json"] = 398,
    ["omnisharp.json"] = 399,
    ["openapi.json"] = 400,
    ["openfin.json"] = 406,
    ...
    ["ops.yaml"] = 404,
    ["package.json"] = 417,
    ["package.manifest"] = 418,
    ["pathfinder.yml"] = 421,
    ["pattern.json"] = 423,
    ["petstore-v1.0"] = 725,
    pgap_yaml_input_reader = 422,
    ["plagiarize-me.yaml"] = 428,
    ["plagiarize.yaml"] = 427,
    ["portman.json"] = 429,
    ["prettierrc.json"] = 436,
    ["prisma.yml"] = 437,
    ["project-1.0.0-beta3.json"] = 440,
    ["project-1.0.0-beta4.json"] = 441,
    ["project-1.0.0-beta5.json"] = 442,
    ["project-1.0.0-beta6.json"] = 443,
    ["project-1.0.0-beta8.json"] = 444,
    ["project-1.0.0-rc1.json"] = 445,
    ["project-1.0.0-rc2.json"] = 446,
    ["project.json"] = 439,
    ["prometheus.json"] = 447,
    ["prometheus.rules.json"] = 448,
    ["prometheus.rules.test.json"] = 449,
    ["proxies.json"] = 450,
    ["publiccode.yml"] = 451,
    ["pubspec.yaml"] = 452,
    ["pyrseas-0.8.json"] = 455,
    ["quilt.mod.json"] = 751,
    ["release drafter"] = 630,
    rtx = 470,
    rustfmt = 477,
    samt = 479,
    samtrc = 480,
    ["sarif-1.0.0.json"] = 482,
    ["sarif-2.0.0.json"] = 483,
    ["sarif-2.1.0"] = 493,
    ["sarif-2.1.0-rtm.2"] = 484,
    ["sarif-2.1.0-rtm.3"] = 486,
    ["sarif-2.1.0-rtm.4"] = 488,
    ["sarif-2.1.0-rtm.5"] = 490,
    ["sarif-2.1.0-rtm.6"] = 491,
    ["sarif-external-property-file-2.1.0"] = 494,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 485,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 487,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 489,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 492,
    ["schema.org - Action"] = 496,
    ["schema.org - ContactPoint"] = 497,
    ["schema.org - Place"] = 498,
    ["schema.org - Thing"] = 499,
    ["scikit-build"] = 682,
    ["secrethub.yml"] = 753,
    ["semantic-release"] = 502,
    ["servicehub.config.json"] = 606,
    ["servicehub.service.json"] = 605,
    ["settings.job"] = 505,
    ["sfdx-hardis configuration"] = 508,
    ["size-limit configuration"] = 512,
    ["skaffold.yaml"] = 672,
    ["skyuxconfig.json"] = 514,
    snapcraft = 515,
    ["sqlc configuration"] = 523,
    ["stripe-app-local.json"] = 531,
    ["stripe-app.json"] = 530,
    swcrc = 659,
    syntax = 755,
    ["task.json"] = 537,
    taskcat = 626,
    ["template.json"] = 541,
    ["templatsources.json"] = 542,
    ["theme.json"] = 545,
    ["tizen_workspace.json"] = 546,
    tldr = 547,
    tmuxinator = 614,
    ["transcend.yml"] = 554,
    ["trunk.yaml"] = 555,
    ["ts-force-config.json"] = 559,
    ["tsconfig.json"] = 556,
    ["tsd.json"] = 557,
    ["tsdrc.json"] = 558,
    ["tslint.json"] = 560,
    ...
    ["vega-lite.json"] = 575,
    ["vega.json"] = 574,
    ["venvironment-basic.yaml"] = 578,
    ["venvironment.yaml"] = 577,
    ["version.json"] = 579,
    ["vim-addon-info"] = 580,
    ["vs-2017.3.host.json"] = 582,
    ["vs-nesting.json"] = 583,
    ["vsls.json"] = 581,
    ["vss-extension.json"] = 587,
    ["vtesttree.yaml"] = 588,
    ["vtestunit.yaml"] = 589,
    ["warp-keysets.json"] = 759,
    ["warp-themes.json"] = 760,
    ["warp-workflows.json"] = 761,
    ["webhint.io"] = 711,
    ["webjobpublishsettings.json"] = 595,
    ["webjobs-list.json"] = 594,
    ["xs-app.json"] = 622,
    ["xunit.runner.json"] = 604,
    yamllint = 647,
    zuul = 631,
    ["Žinoma"] = 641
  },
