...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1109,
    [".nodehawkrc"] = 714,
    [".npmpackagejsonlintrc"] = 719,
    [".omletrc"] = 1290,
    [".phrase.yml"] = 801,
    [".phraseapp.yml"] = 802,
    [".pmbot.yml"] = 786,
    [".postcssrc"] = 795,
    [".powerpages-web-template-manifest"] = 797,
    [".pre-commit-config.yml"] = 798,
    [".pre-commit-hooks.yml"] = 799,
    [".putout.json"] = 835,
    [".rehyperc"] = 860,
    [".remarkrc"] = 864,
    [".sprite files"] = 966,
    ...
    AIConfig = 50,
    ["AMX Muse Program Descriptor"] = 1339,
    ["API Builder"] = 1145,
    ["AVA Configuration"] = 1209,
    ...
    ["AWS Copilot Manifest"] = 1378,
    ["AWS SAM CLI Samconfig"] = 327,
    Acton = 1432,
    ["Adobe UXP Manifest"] = 1272,
    ["Aerleon Network & Service Definitions"] = 30,
    ["Aerleon Policy"] = 31,
    ["Agent Permission Policy"] = 1418,
    ["Agent Run Metrics"] = 32,
    ["AgentCore CLI"] = 1419,
    ["AgentCtl MCP"] = 1421,
    ["AgentCtl config"] = 1420,
    ["AgentCtl permissions"] = 1422,
    AgentLoopKit = 1423,
    Aider = 1368,
    Air = 34,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1389,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1388,
    ["Airlock Microgateway"] = 51,
    ["Alacritty Configuration"] = 1181,
    ["AlgoVoi Compliance Receipt v1"] = 19,
    ["All Contributors configuration file"] = 1235,
    ...
    ["Application list for a WinUtil"] = 1318,
    ["ArchSmith diagram IR"] = 1461,
    ArchitectFX = 1323,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1387,
    ["Azure IoT Operations connector metadata"] = 1384,
    ...
    ["Azure Pipelines"] = 139,
    ["Azure Static Web Apps CLI configuration file"] = 970,
    ["Azure Static Web Apps configuration file"] = 969,
    BMML = 1406,
    ["BOSH BPM Config"] = 167,
    ["BOSH CPI Config"] = 168,
    ...
    Badness = 151,
    ["Barba-CV"] = 105,
    ["Bashly (bashly.yml)"] = 1239,
    ["Bashly Settings (bashly-settings.yml)"] = 1240,
    Bento = 1405,
    ["Better Code Hub"] = 1150,
    ["Better Scripts"] = 194,
    Bigconfig = 160,
    ["Biome Formatter Config"] = 106,
    ["Bitmovin Encoding Template"] = 1332,
    BizTalkServerApplicationSchema = 1116,
    Bleep = 195,
    ["Block Protocol Metadata"] = 192,
    ["Bluebricks blueprint config"] = 1411,
    ["Boyka Framework"] = 173,
    ...
    ["Butane Config"] = 1194,
    C4InterFlow = 1347,
    ["CDK Environment Manager, concrete environment configuration"] = 1371,
    ["CDK Environment Manager, concrete environments definition"] = 1370,
    ["CDK Environment Manager, environment definition"] = 1369,
    ["CGS Card Game Specification (cgs.json)"] = 1277,
    ["CICS TS region tagging"] = 1203,
    ["CICS TS resource import"] = 1204,
    ["CICS TS resource model"] = 1205,
    ["CICS TS resource overrides"] = 1206,
    ["CMake Presets"] = 196,
    ["CNC Codes"] = 223,
    ["CRS WAF test file"] = 1307,
    ["CRS WAF test platform overrides file"] = 1308,
    ...
    ["Caido Proxy Configuration"] = 1447,
    ...
    ["Chamaleon environment"] = 1336,
    ["Chamaleon properties"] = 1337,
    ["Chamaleon template"] = 1335,
    Changepacks = 1398,
    Changesets = 336,
    Changie = 208,
    Charmcraft = 209,
    ...
    ["Claude Code Launch Preview"] = 1460,
    ["Claude Code Plugin Manifest"] = 231,
    ["Claude Code Plugin Marketplace"] = 232,
    ["Claude Code Settings"] = 233,
    ["Clawject config"] = 229,
    ["Cloud Foundry Application Manifest"] = 1289,
    ["Cloud Run Spec v1"] = 1313,
    ...
    Concord = 1306,
    ["Configu .cfgu files"] = 1294,
    ["Configu .configu file"] = 1295,
    Conjure = 222,
    ["Container Structure Test"] = 1130,
    Containerlab = 1159,
    ["Context Passport"] = 2,
    ["Context Reasoning Format (CRF)"] = 220,
    ["Contextive Glossary"] = 1363,
    ContractGuard = 1160,
    Convex = 221,
    ...
    ["Cursor Agent Environment"] = 1416,
    ["Custom Machinery Machine"] = 1278,
    ["Custom Machinery Recipe"] = 1279,
    ...
    ["DonateCaseBetterCasino menu"] = 1340,
    ["Draugr Saga"] = 368,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1247,
    ["EAS config"] = 443,
    ["ECA - Editor Code Assistant"] = 406,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1236,
    ["ESLint Suppressions"] = 448,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1383,
    ["EasyVCR .NET"] = 445,
    ["Eidolon Resource"] = 1324,
    ...
    ["Envelope Team Definition"] = 1431,
    ["Envilder Map File"] = 411,
    ["Erda Pipeline"] = 1285,
    ["Erda Runtime"] = 1286,
    ["Espanso config.yml"] = 1409,
    ["Espanso match.yml"] = 1408,
    Esquio = 431,
    ["Estuary Flow Catalog"] = 1200,
    ["Ethereum ERC1155"] = 1425,
    ["Ethereum ERC721"] = 1424,
    ...
    ["Evolving Resolutive Process notation"] = 1385,
    ["Expo SDK"] = 442,
    ...
    ["GeoJSON.json latest"] = 1198,
    GherKing = 1202,
    ["GitHub Action"] = 486,
    ["GitHub Actions typing"] = 1320,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 1274,
    ...
    ["Google Digital Assetlinks"] = 1364,
    Goreleaser = 522,
    ["Goreleaser Pro"] = 523,
    Goss = 525,
    ["Gradle Build Cache Node"] = 1148,
    ["Gradle Enterprise"] = 1147,
    ...
    HEMTT = 1112,
    ["HULL - Helm Uniform Layer Library"] = 1465,
    Hadolint = 1126,
    Hammerkit = 1158,
    ["Hardware Sentry Configuration"] = 1214,
    ...
    ["Hecate Input Schema"] = 1375,
    ["Helm Chart.lock"] = 286,
    ["Helm Chart.yaml"] = 285,
    ["Helm Unittest Test Suite"] = 287,
    ["Heloisa Assistant Plugins Marketplace"] = 1458,
    ["Hex file"] = 288,
    ...
    ["JFrog File Spec"] = 582,
    ["JFrog Pipelines YML DSL"] = 1224,
    ["JMeter DSL cli config"] = 583,
    JReleaser = 586,
    ["JSON Document Transform"] = 594,
    ["JSON Feed"] = 595,
    ["JSON Resume"] = 873,
    ["JSON Schema Draft 2020-12"] = 1091,
    ["JSON Schema Draft 4"] = 1088,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1257,
    ["JSON Schema Draft 7"] = 1089,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1258,
    ["JSON Schema Draft 8 (2019-09)"] = 1090,
    ["JSON-API"] = 593,
    ["JSON-e templates"] = 1155,
    ["JSON-stat 2.0"] = 1084,
    JSONPatch = 597,
    ...
    Jsontron = 598,
    ["Jujutsu (jj) VCS config"] = 1377,
    ["KIMMDY config file"] = 609,
    ["KODE/CI build.yaml"] = 1220,
    ["KSP-AVC"] = 1085,
    ["KSP-CKAN"] = 1086,
    ["KSP-NetKAN"] = 1087,
    KSY = 1287,
    ...
    ["Kong DBLess config"] = 1221,
    KrakenD = 613,
    ["Kubri Configuration"] = 621,
    LOOBin = 640,
    ["Lake configuration file"] = 1380,
    ...
    ["Lando (landofile)"] = 132,
    ["LangGraph Platform configuration"] = 1299,
    ["Language configuration"] = 1298,
    Lefthook = 626,
    ["Liferay client-extension.yaml"] = 633,
    ["LinkML Metamodel"] = 635,
    ["LiquiLens Evidence Carrier Reference v1"] = 637,
    ["LiquiLens Evidence Carrier v1"] = 636,
    Liquibase = 1165,
    ["Liquibase Flow File"] = 1166,
    ["Lively Properties"] = 639,
    ["Lobe AI Agent"] = 134,
    Loki = 135,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 683,
    ["MS2Rescore Configuration"] = 691,
    ["MSTest testconfig.json"] = 692,
    ["Madge configuration"] = 646,
    ["Madness (madness.yml)"] = 1238,
    ["Mado configuration"] = 647,
    ["Maestro Flow"] = 648,
    ["Mail Servers Configuration"] = 1412,
    ["MapEHR Mapping"] = 649,
    Markdownlint = 1169,
    ["Mason Registry"] = 1172,
    ["MegaLinter Custom Flavor"] = 652,
    ["MegaLinter configuration"] = 651,
    ["MegaLinter descriptor"] = 653,
    Melange = 1265,
    ["Meltano project definition"] = 654,
    ["Mergify Configuration"] = 693,
    ["Mermaid config"] = 4,
    ["Metadata for a Bazel module"] = 655,
    ["Metadata for a Cinnamon spice"] = 1316,
    ["Metatype Configuration"] = 656,
    ["MetricsHub Configuration"] = 657,
    ["MetricsHub Connector Configuration"] = 658,
    ["Micro Editor Syntax"] = 1248,
    ["Microsoft Band Web Tile"] = 659,
    ["Microsoft RulesEngine workflow rules"] = 1303,
    ["Microsoft RulesEngine workflow rules list"] = 1304,
    ["Minecraft Custom Main Menu Mod"] = 1266,
    ["Minecraft Data Pack Advancement"] = 661,
    ["Minecraft Data Pack Biome"] = 662,
    ["Minecraft Data Pack Configured Carver"] = 663,
    ["Minecraft Data Pack Damage Type"] = 664,
    ["Minecraft Data Pack Dimension"] = 666,
    ["Minecraft Data Pack Dimension Type"] = 665,
    ["Minecraft Data Pack Item Modifier"] = 667,
    ["Minecraft Data Pack Loot Table"] = 668,
    ["Minecraft Data Pack Metadata"] = 669,
    ["Minecraft Data Pack Predicate"] = 670,
    ["Minecraft Data Pack Recipe"] = 671,
    ["Minecraft Data Pack Tag"] = 672,
    ["Minecraft Data Pack Template Pool"] = 673,
    ["Minecraft Data Pack Trim Material"] = 678,
    ["Minecraft Data Pack Trim Pattern"] = 679,
    ["Minecraft Resource Pack Lang"] = 674,
    ["Minecraft Resource Pack Particle"] = 675,
    ["Minecraft Resource Pack Texture Mcmeta"] = 677,
    ["Minecraft Resourcepack Sounds"] = 676,
    ["MockServer Expectation"] = 685,
    ["MockServer Expectations"] = 686,
    ModuleAssembler = 681,
    ["Monade CLI Stack Configuration"] = 696,
    ["MongoDB Atlas Search Index Definition"] = 1219,
    ["Monika Configuration"] = 1217,
    ["Monoweave Configuration"] = 690,
    ["Motif config"] = 1108,
    MultiQC = 1357,
    ["NOX Framework (Service)"] = 718,
    ["Netin Diagnostic System Template"] = 1176,
    ["Netlify config"] = 699,
    ["Network-as-Code Data Model"] = 700,
    ["Next Gen UI Agent A2A Server Configuration"] = 701,
    ["Next Gen UI Agent Configuration"] = 703,
    ["Next Gen UI Agent MCP Server Configuration"] = 702,
    ["Nightwatch.js"] = 710,
    ["Nika workflow"] = 715,
    ["Node.js configuration"] = 1113,
    ["NueJS configuration file"] = 723,
    ["Nuitka Package Config"] = 1280,
    ["Nullstone config"] = 725,
    ["ODGS Data Rules"] = 732,
    ["ODGS Ontology Graph"] = 733,
    ["ODGS Standard Metrics"] = 731,
    ["OKF Graph"] = 1459,
    ["ONe's changelog entry"] = 747,
    ["ONe's service descriptor"] = 746,
    ["ORT Server repository environment configuration"] = 758,
    ["OSCAL Assessment Plan (AP)"] = 760,
    ["OSCAL Assessment Results (AR)"] = 761,
    ["OSCAL Catalog"] = 762,
    ["OSCAL Component Definition (CDef)"] = 763,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 764,
    ["OSCAL Profile"] = 765,
    ["OSCAL System Security Plan (SSP)"] = 766,
    ["OSS Review Toolkit configuration"] = 767,
    ["OSS Review Toolkit curation"] = 768,
    ["OSS Review Toolkit package configuration"] = 769,
    ["OSS Review Toolkit project package manager definition"] = 770,
    ["OSS Review Toolkit repository configuration"] = 771,
    ["OSS Review Toolkit resolutions"] = 772,
    ["October CMS columns"] = 729,
    ["October CMS fields"] = 730,
    ["Oh My Posh"] = 735,
    Okteto = 736,
    ["Ona Tasks and Services"] = 738,
    Opctl = 1111,
    ["Open Data Contract Standard (ODCS)"] = 751,
    ["Open Data Product Standard (ODPS)"] = 752,
    ["Open Know-How"] = 1362,
    ["Open Pentest Format"] = 753,
    OpenDecree = 1429,
    ["OpenDecree Configuration"] = 1430,
    ["OpenRewrite Resource"] = 749,
    OpenSRM = 754,
    OpenStatus = 1373,
    ["OpenTelemetry Declarative Configuration"] = 750,
    ["OpenUtau character yaml"] = 743,
    ["OpenUtau ustx"] = 744,
    ["OpenWeather Current Weather API"] = 1154,
    ["OpenWeather Road Risk API"] = 1153,
    ["Ory Hydra configuration"] = 553,
    ["Ory Keto configuration"] = 617,
    ["Ory Kratos configuration"] = 759,
    ["Ory Oathkeeper configuration"] = 727,
    ["Outblocks App configuration"] = 756,
    ["Outblocks database table"] = 757,
    ["Outblocks project configuration"] = 755,
    PDM = 780,
    POPxf = 792,
    ["POPxf Correlations"] = 793,
    ["PRML manifest"] = 800,
    Packer = 776,
    PactSpec = 777,
    Panache = 778,
    Pantsbuild = 1234,
    ["Paper paper-plugin.yml"] = 779,
    ["Pipeline component"] = 1167,
    ["Platform.sh application"] = 15,
    ["Platform.sh routes"] = 16,
    ["Platform.sh services"] = 17,
    ["Plex Prerolls"] = 790,
    ["PocketMine plugin.yml"] = 787,
    ["Podman Desktop Extension"] = 1449,
    ["Postman collection"] = 796,
    ["Power Pages Configuration"] = 1374,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1319,
    ["ProActions AI-Kit Configuration"] = 808,
    ["ProActions AI-Kit Configuration for Menus"] = 810,
    ["ProActions AI-Kit Configuration for Sections"] = 812,
    ["ProActions AI-Kit Configuration for Services"] = 809,
    ["ProActions AI-Kit Configuration for Steps"] = 813,
    ["ProActions AI-Kit Configuration for Templates"] = 811,
    ["Problem object RFC9457"] = 1263,
    ["Problem package format"] = 814,
    ["Problem package generators"] = 815,
    ["Problem package submissions"] = 816,
    ["Problem package test group metadata"] = 817,
    ["Production delivery manifest"] = 1467,
    Pterodactyl = 1213,
    ["Pull Request Labeler"] = 834,
    Pulumi = 842,
    ["PyGTA Config"] = 838,
    PyProject = 843,
    Pylock = 1365,
    Pyright = 844,
    ["Python script metadata"] = 1359,
    ["QType AI DSL"] = 847,
    Qgoda = 846,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1441,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1439,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1445,
    ["Qlik Talend Cloud Pipeline - Project"] = 1437,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1440,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1442,
    ["Qlik Talend Cloud Pipeline - Task"] = 1438,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1444,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1443,
    Qodana = 1186,
    ["Qt Creator workspace file"] = 1296,
    ["Quali Torque Blueprint Spec 2"] = 1211,
    ["QueryFirst config file"] = 1230,
    ["QuikRun Configuration"] = 1446,
    ["Qwen Code Settings"] = 1426,
    ["RKE Cluster Configuration JSON"] = 1164,
    ["RKE Cluster Configuration YAML"] = 1163,
    RadioHound = 837,
    ["Raid Profile"] = 1427,
    ["Raid Repo Configuration"] = 1428,
    Railpack = 849,
    Railway = 848,
    ["Rancher Fleet"] = 839,
    ["Rattler-build"] = 850,
    Ray = 1125,
    ["Read the Docs"] = 841,
    ["Red-DiscordBot Cog"] = 857,
    ["Red-DiscordBot Cog Repo"] = 858,
    ["Red-DiscordBot Trivia"] = 859,
    ["Releasaurus Config"] = 12,
    ReleaseKit = 11,
    ["Render Blueprints"] = 1162,
    RenderCV = 877,
    Renovate = 874,
    ["Renovate global configuration"] = 875,
    ["Renovate inherited configuration"] = 876,
    ["Replit config"] = 865,
    Restate = 1352,
    ["Revel Digital Gadget Definition File"] = 1376,
    RoadRunner = 879,
    ["Robust Station Image"] = 1382,
    Rockcraft = 880,
    ["Roo Coder Custom Modes"] = 881,
    Rubocop = 870,
    ["Rudder techniques"] = 1270,
    Ruff = 871,
    ["Rust Project"] = 872,
    ["Rust toolchain"] = 886,
    ["SDMX data message"] = 913,
    ["SDMX metadata message"] = 912,
    ["SDMX structure message"] = 911,
    ["SIL Kit Participant Configuration"] = 924,
    ["SIL Kit Registry Configuration"] = 925,
    ["SPDX 2.3"] = 967,
    SWADL = 983,
    ["Safebox Config"] = 1225,
    ["Sapphire CLI Config"] = 889,
    ["SauceCTL Configuration"] = 1173,
    Scarb = 909,
    ["Schema Catalog"] = 904,
    ["Scoop manifest"] = 910,
    ["Secure SDLC Evidence Bundle"] = 914,
    ["Semantic Data Fabric (SDF) file"] = 915,
    ["Semgrep Rule"] = 917,
    ["Serenity Code Generator (Sergen)"] = 918,
    ["Serverless Framework Configuration"] = 1180,
    ["Serverless Workflow"] = 1182,
    ["Settings for a Cinnamon spice"] = 1315,
    ["Settings.paf"] = 920,
    ["Shopware 6 Configuration"] = 1183,
    ["Shopware CLI Extension Store Configuration"] = 1184,
    ["Shopware CLI Project Store Configuration"] = 1185,
    ["Sigma Detection Rule"] = 922,
    ["SigmaCV CV"] = 7,
    ["Sigrid scope configuration file"] = 923,
    ["SkyPilot Task JSON"] = 1271,
    ["Slack app manifest"] = 930,
    ["Slang Server Configuration"] = 1453,
    Snapcraft = 932,
    ["Solarxy project config"] = 935,
    Solidarity = 936,
    ["Solution filters"] = 937,
    ["Source Maps v3"] = 938,
    Sourcery = 939,
    ["Spack bootstrap.yaml"] = 940,
    ["Spack cdash.yaml"] = 941,
    ["Spack ci.yaml"] = 942,
    ["Spack compilers.yaml"] = 943,
    ["Spack concretizer.yaml"] = 944,
    ["Spack config.yaml"] = 945,
    ["Spack definitions.yaml"] = 946,
    ["Spack develop.yaml"] = 947,
    ["Spack env_vars.yaml"] = 948,
    ["Spack environment"] = 954,
    ["Spack include.yaml"] = 949,
    ["Spack mirrors.yaml"] = 950,
    ["Spack modules.yaml"] = 951,
    ["Spack packages.yaml"] = 952,
    ["Spack repos.yaml"] = 953,
    ["Spack toolchains.yaml"] = 955,
    ["Spack upstreams.yaml"] = 956,
    ["Spack view.yaml"] = 957,
    ["Speakeasy Generation Config File"] = 961,
    ["Speakeasy Lint Configuration File"] = 958,
    ["Speakeasy Test Generation Configuration File"] = 959,
    ["Speakeasy Workflow File"] = 960,
    SpecIF = 962,
    ["Specmatic Configuration"] = 963,
    ["Specpin spec file"] = 5,
    ["Sponge Mixin configuration"] = 964,
    ["Spotlight Ruleset"] = 965,
    StackBlitz = 971,
    ["StackHawk Scanner Configuration"] = 1179,
    Stale = 972,
    Starfish = 973,
    ["Starlake Data Pipeline"] = 1151,
    Starship = 974,
    ["Statamic Blueprint"] = 975,
    ["Stella configuration file"] = 976,
    ["Streamlit configuration file"] = 977,
    ["Stryker Mutator"] = 980,
    ["StyleCop Analyzers Configuration"] = 981,
    ["Stylelint (.stylelintrc)"] = 982,
    ["Stylua Config"] = 1366,
    ["Sublime Syntax"] = 1226,
    ["Subsquid squid manifest"] = 1273,
    ["Swagger API 2.0"] = 984,
    ["Symfony Routing Configuration"] = 985,
    ["Symfony Serializer Mapping"] = 986,
    ["Symfony Services Configuration"] = 987,
    ["Symfony Validation Mapping"] = 988,
    ["Synadia Connect Component"] = 989,
    TSON = 1032,
    TSTyche = 1033,
    ["TYPO3 Vendor Bundler config"] = 1039,
    ["Tab data for a LinUtil"] = 1322,
    ["Tab list for a LinUtil"] = 1321,
    Tach = 990,
    ["Tach Domain"] = 991,
    Talhelper = 993,
    ["Talisman configuration"] = 994,
    Taplo = 1367,
    ["Taskfile config"] = 1156,
    Taurus = 995,
    Tauticord = 996,
    ["Tekton Pipeline"] = 1395,
    ["Tekton PipelineRun"] = 1396,
    ["Tekton Task"] = 1393,
    ["Tekton TaskRun"] = 1394,
    Telefonistka = 1353,
    ["Terraform PowerShell provider block manifest"] = 999,
    ["Terraform PowerShell provider data source manifest"] = 1000,
    ["Terraform PowerShell provider resource manifest"] = 1001,
    ["Terraform PowerShell provider settings"] = 1002,
    ["Terrateam config"] = 1379,
    ["Tesseract configuration"] = 1003,
    ["TestEnvironment.json"] = 1013,
    ["TextMate Grammar"] = 1012,
    Threagile = 1007,
    ["Tier.run pricing.json"] = 1004,
    Tikibase = 1005,
    Tombi = 1010,
    ["Traefik v2"] = 1016,
    ["Traefik v2 File Provider"] = 1017,
    ["Traefik v3"] = 1018,
    ["Traefik v3 File Provider"] = 1019,
    ["Travis CI (.travis.yml)"] = 1015,
    Treefmt = 528,
    Trident = 1349,
    Trivy = 1022,
    ["TrueScript for *.tscript files"] = 1023,
    ["Tugboat QA config.yml"] = 1346,
    TunnelHub = 1261,
    Turborepo = 1014,
    Tycho = 1310,
    Tye = 1187,
    ["Tyk Gateway - Open Source v5.7+"] = 1358,
    ["UET BuildConfig.json"] = 1231,
    ["UI5 Manifest"] = 1045,
    ["UNCORS configuration"] = 1050,
    ["UTAM Page Object"] = 1048,
    ["Ubuntu Server Autoinstall"] = 1043,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1350,
    ["Uniswap Token List"] = 1136,
    ["Universal Schedule Format"] = 1051,
    ["Unreal Engine Uplugin"] = 1232,
    ["Unreal Engine Uproject"] = 1233,
    ["UpCloud CLI (upctl) configuration"] = 1351,
    ["Updatecli Compose"] = 1195,
    ["Updatecli Policy Manifest"] = 1196,
    ["Updatecli Policy Metadata"] = 1197,
    Uplift = 1229,
    ["Upsun config"] = 14,
    ["User Journey Map"] = 1161,
    V2Ray = 1201,
    ["VSCode Code Snippets"] = 311,
    ["VSIX CLI publishing"] = 1071,
    Vector = 1053,
    ["Vee JSON menu output"] = 1054,
    ["Vela Pipeline Configuration"] = 1057,
    Vercel = 310,
    ["Version Bumper config"] = 1060,
    Vespertide = 1400,
    ["Vespertide Migration"] = 1401,
    ["Vespertide Model"] = 1402,
    ["Viash Component Config"] = 1355,
    ["Viash Package Config"] = 1356,
    Visivo = 1259,
    Vogi = 1065,
    ["WP-CLI"] = 1081,
    Wake = 1348,
    ["Waku Config"] = 1325,
    ["Web App Manifest"] = 1077,
    ["Web types"] = 1080,
    WebExtensions = 1076,
    ["Webman package recipe"] = 1207,
    ["Windows Package Manager Installer Manifest"] = 1133,
    ["Windows Package Manager Locale Manifest"] = 1134,
    ["Windows Package Manager Singleton Manifest"] = 1132,
    ["WireMock CLI import configuration"] = 1331,
    ["WireMock CLI local service configuration"] = 1330,
    ["WireMock message stub mapping"] = 1329,
    ["WireMock stub mapping"] = 1328,
    ["Woodpecker pipeline config"] = 1175,
    ["Wrangler CLI"] = 1082,
    ["XenForo add-on manifest"] = 1083,
    ["Xstate Machine"] = 1193,
    ["Yandex Workflow Language"] = 1317,
    ["Yarn Config (.yarnrc.yml)"] = 1149,
    ["Yippee-Ki-JSON configuration YML"] = 1140,
    ["YouTrack App"] = 1314,
    ["Zarf Package Configuration"] = 1381,
    ["Zerops import file"] = 1302,
    ["Zola Configuration"] = 1392,
    abtop = 36,
    act3 = 1433,
    actionlint = 46,
    ["aerleon.yml"] = 29,
    ...
    ["behat.yml"] = 174,
    ["bigquery-table"] = 159,
    ["bioimageio resource description"] = 1281,
    ...
    ["cargo-nextest repository configuration"] = 704,
    ["cargo-nextest user configuration"] = 705,
    ["ccmod.json"] = 1326,
    ["cfgd Config"] = 1454,
    ["cfgd ConfigSource"] = 1457,
    ["cfgd Module"] = 1455,
    ["cfgd Profile"] = 1456,
    changelogging = 1293,
    ...
    ["chutzpah.json"] = 319,
    cibuildwheel = 215,
    ["clang-format (.clang-format)"] = 1199,
    ["clang-tidy"] = 294,
    clangd = 293,
    clib = 295,
    ...
    ["crowdin.yml"] = 346,
    crucible = 350,
    ["ctfd-setup configuration file"] = 1338,
    ["custom-elements.json"] = 1251,
    ["cypress.json"] = 351,
    ["dacier.yml"] = 1436,
    ...
    ["gematik health care insurance list"] = 1344,
    ["gematik health care patient list"] = 1341,
    ["gematik health care provider institution list"] = 1343,
    ["gematik health care provider list"] = 1342,
    ["gematik tiger test environment configuration"] = 1345,
    ["gh-dash"] = 484,
    ["gha-doctor"] = 485,
    ["git-cliff"] = 481,
    ["git-town.toml"] = 1390,
    ["github-settings-as-code"] = 866,
    ["gitlab-ci"] = 499,
    ["global.json"] = 516,
    ["glslint config"] = 3,
    ...
    ["label-commenter-config.yml"] = 624,
    ["latexindent configuration"] = 133,
    ["launchsettings.json"] = 625,
    lazydocker = 1250,
    lazygit = 1249,
    ["lego.json"] = 627,
    ["lerna.json"] = 628,
    ["lgtm.yml"] = 629,
    ["liblab.config.json"] = 630,
    ["libman.json"] = 631,
    ["license-report-config.json"] = 632,
    ["linkinator.config.json"] = 634,
    ["lint-staged (.lintstagedrc)"] = 1100,
    ["litertlm_manifest.json"] = 638,
    ["local.settings.json"] = 642,
    ["localazy.json"] = 643,
    ["lotus.yaml"] = 641,
    ["lsd colors"] = 137,
    ["lsd config"] = 136,
    ...
    lychee = 1099,
    ["macro.json"] = 1216,
    ["markdown-link-check"] = 1170,
    maturin = 1171,
    mboats = 1178,
    memnex = 1434,
    ["micro-settings.json"] = 1243,
    ["mimetypes.json"] = 660,
    ["mirrord config"] = 1103,
    ["misata.yaml"] = 1102,
    mise = 1104,
    ...
    ["mkdocs.yml"] = 680,
    ["mockd.yaml"] = 684,
    ["mod.pw.toml (packwiz)"] = 1451,
    ["modelparams.dev Model"] = 687,
    ["models CLI"] = 688,
    ["monospace.yml"] = 689,
    ["moon.yml"] = 1327,
    ["mprocs Configuration file"] = 1297,
    ["mrdocs.yml"] = 682,
    ["mta.yaml"] = 1106,
    ["mtad.yaml"] = 1107,
    ["mycode.json"] = 697,
    nFPM = 709,
    ["napari plugin manifest"] = 698,
    neoload = 1119,
    ["nest-cli"] = 712,
    ["nexus-rpc-gen"] = 1417,
    ["nf-core module environment.yml"] = 706,
    ["nf-core module meta.yml"] = 707,
    ["nf-core subworkflow meta.yml"] = 708,
    ["ninjs (News in JSON)"] = 711,
    ["nitro.json"] = 1118,
    ["nixd configuration"] = 1269,
    ["nlu.json"] = 713,
    ["nodemon.json"] = 716,
    ["noodl config"] = 1177,
    ["notebook.mod.json"] = 717,
    now = 1114,
    ["npm-badges"] = 720,
    ["nswag.json"] = 724,
    ntangle = 726,
    ["nuclei-template.yaml"] = 721,
    ["nuget-project.json"] = 722,
    ["ocelot.json"] = 728,
    ogen = 734,
    ["omnisharp.json"] = 737,
    openHAB = 1403,
    ...
    oxfmt = 1413,
    oxlint = 1414,
    ["pack.toml (packwiz)"] = 1452,
    ["package.json"] = 773,
    ["package.manifest"] = 775,
    ["package.yaml"] = 774,
    ["partial-black.json"] = 175,
    ["partial-fastapi.json"] = 176,
    ["partial-pixi.json"] = 785,
    ["partial-scheduled.json"] = 177,
    ["pattern.json"] = 783,
    ["petstore-v1.0"] = 1223,
    pgap_yaml_input_reader = 781,
    pgrls = 782,
    pgxgen = 1407,
    pitcms = 1410,
    ["pixi.toml"] = 784,
    ["plagiarize-me.yaml"] = 789,
    ["plagiarize.yaml"] = 788,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1334,
    ["podbard.yaml"] = 791,
    ["portman.json"] = 794,
    ["prefect.toml"] = 803,
    ["prefect.yaml"] = 804,
    ...
    ["prettierrc.json"] = 806,
    ["prisma.yml"] = 807,
    ["project-1.0.0-beta3.json"] = 819,
    ["project-1.0.0-beta4.json"] = 820,
    ["project-1.0.0-beta5.json"] = 821,
    ["project-1.0.0-beta6.json"] = 822,
    ["project-1.0.0-beta8.json"] = 823,
    ["project-1.0.0-rc1.json"] = 824,
    ["project-1.0.0-rc2.json"] = 825,
    ["project.json"] = 818,
    ["project.owasp.yaml"] = 826,
    ["prometheus-alertmanager.json"] = 830,
    ["prometheus.json"] = 827,
    ["prometheus.rules.json"] = 828,
    ["prometheus.rules.test.json"] = 829,
    ["proxies.json"] = 831,
    ["publiccode.yml"] = 832,
    ["pubspec.yaml"] = 833,
    ["pyrseas-0.8.json"] = 836,
    pytest = 845,
    ["quilt.mod.json"] = 1244,
    ["rc3 auth"] = 851,
    ["rc3 collection"] = 852,
    ...
    ["rc3 settings"] = 856,
    ["registry.yaml"] = 65,
    ["release drafter"] = 1120,
    ["release-hub.json"] = 10,
    ["release-please-config.json"] = 861,
    ["release-please-manifest.json"] = 862,
    ["release-plz.toml"] = 863,
    ["renv.lock"] = 878,
    ["reposets Configuration"] = 867,
    ["reposets Credentials"] = 868,
    ["revola.json"] = 8,
    ["rivet.json"] = 1268,
    ["rivet.yaml (legacy)"] = 1267,
    rumdl = 883,
    runny = 882,
    runspec = 1435,
    rustfmt = 884,
    ...
    samt = 887,
    samtrc = 888,
    ["sarif-1.0.0.json"] = 890,
    ["sarif-2.0.0.json"] = 891,
    ["sarif-2.1.0"] = 901,
    ["sarif-2.1.0-rtm.2"] = 892,
    ["sarif-2.1.0-rtm.3"] = 894,
    ["sarif-2.1.0-rtm.4"] = 896,
    ["sarif-2.1.0-rtm.5"] = 898,
    ["sarif-2.1.0-rtm.6"] = 899,
    ["sarif-external-property-file-2.1.0"] = 902,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 893,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 895,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 897,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 900,
    ["scalingo.json configuration"] = 903,
    ["schema.org - Action"] = 905,
    ["schema.org - ContactPoint"] = 906,
    ["schema.org - Place"] = 907,
    ["schema.org - Thing"] = 908,
    ["secrethub.yml"] = 1246,
    ["semantic-release"] = 916,
    servercn = 1463,
    ["servicehub.config.json"] = 1094,
    ["servicehub.service.json"] = 1093,
    ["settings.job"] = 919,
    ["sfdx-hardis configuration"] = 921,
    ["shard.yml"] = 1284,
    ["size-limit configuration"] = 926,
    ["skaffold.yaml"] = 1168,
    ["skill-map plugin extension manifest"] = 927,
    ["skill-map project settings"] = 928,
    ["skill-map provider kind"] = 929,
    ["skyuxconfig.json"] = 931,
    ["snowflake-config"] = 933,
    ["snowflake-connections"] = 934,
    ["spicepod.yaml"] = 1305,
    ["sqlc configuration"] = 968,
    ["stripe-app-local.json"] = 979,
    ["stripe-app.json"] = 978,
    swcrc = 1152,
    ["task.json"] = 992,
    taskcat = 1115,
    ["template.json"] = 997,
    ["templatsources.json"] = 998,
    ["text2confl config"] = 1415,
    ["theme.json"] = 1006,
    ["tizen_workspace.json"] = 1008,
    tldr = 1009,
    ["tm_devices configuration file"] = 1372,
    tmuxinator = 1097,
    tox = 1011,
    ["transcend.yml"] = 1020,
    ...
    ["vega-lite.json"] = 1056,
    ["vega.json"] = 1055,
    ["venvironment.yaml"] = 1058,
    ["venvplus.yaml"] = 1059,
    version = 1354,
    ["version.json"] = 1061,
    ["vhwdebugger-binding.yaml"] = 1063,
    ["vim-addon-info"] = 1064,
    ["vs-2017.3.host.json"] = 1067,
    ["vs-nesting.json"] = 1068,
    ["vsls.json"] = 1066,
    ["vss-extension.json"] = 1072,
    vtcfg = 1360,
    ["vtesttree.yaml"] = 1073,
    ["vtestunit.yaml"] = 1074,
    ["warp-keysets.json"] = 1252,
    ["warp-themes.json"] = 1253,
    ["warp-workflows.json"] = 1254,
    ["webhint.io"] = 1208,
    ["webjobpublishsettings.json"] = 1079,
    ["webjobs-list.json"] = 1078,
    ["well-known-fursona"] = 1292,
    ["xs-app.json"] = 1110,
    ["xunit.runner.json"] = 1092,
    ["yaml-workflow"] = 1462,
    yamlfmt = 1137,
    yamllint = 1138,
    ["yap.json"] = 1139,
