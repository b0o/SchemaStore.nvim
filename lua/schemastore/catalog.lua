...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 14,
    AIConfig = 15,
    ["AMX Muse Program Descriptor"] = 986,
    ["API Builder"] = 806,
    ["AVA Configuration"] = 866,
    ...
    ["Adobe UXP Manifest"] = 926,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Alacritty Configuration"] = 838,
    ["All Contributors configuration file"] = 891,
    ...
    ["Application list for a WinUtil"] = 969,
    ArchitectFX = 973,
    ["Argo Events"] = 29,
    ["Argo Workflows"] = 30,
    AssemblyScript = 33,
    ...
    ["Azure Pipelines"] = 66,
    ["Azure Static Web Apps CLI configuration file"] = 666,
    ["Azure Static Web Apps configuration file"] = 665,
    ["BOSH Deploy Config"] = 90,
    ["BX CI"] = 108,
    ["Bashly (bashly.yml)"] = 895,
    ["Bashly Settings (bashly-settings.yml)"] = 896,
    ["Better Code Hub"] = 810,
    ["Better Scripts"] = 109,
    Bigconfig = 83,
    ["Biome Formatter Config"] = 53,
    ["Bitmovin Encoding Template"] = 979,
    BizTalkServerApplicationSchema = 779,
    Bleep = 110,
    ...
    ["CICS TS resource model"] = 862,
    ["CICS TS resource overrides"] = 863,
    ["CMake Presets"] = 111,
    ["CNC Codes"] = 126,
    ["CRS WAF test file"] = 959,
    ["CRS WAF test platform overrides file"] = 960,
    ...
    ["Chamaleon environment"] = 983,
    ["Chamaleon properties"] = 984,
    ["Chamaleon template"] = 982,
    Changesets = 208,
    Cheatsheets = 848,
    ...
    CityJSON = 122,
    ["Clawject config"] = 131,
    ["Cloud Foundry Application Manifest"] = 942,
    ["Cloud Run Spec v1"] = 964,
    ...
    Concord = 958,
    ["Configu .cfgu files"] = 947,
    ["Configu .configu file"] = 948,
    Conjure = 125,
    ["Container Structure Test"] = 793,
    Containerlab = 818,
    ["Crowdsec collection config"] = 217,
    ["Crowdsec parser config"] = 218,
    ["Crowdsec scenario config"] = 219,
    ["CumulusCI Config"] = 130,
    ["Custom Machinery Machine"] = 932,
    ["Custom Machinery Recipe"] = 933,
    ...
    ["DonateCaseBetterCasino menu"] = 987,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 903,
    ["EAS config"] = 283,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 892,
    ["EasyVCR .NET"] = 284,
    ["Eidolon Resource"] = 974,
    ...
    ["Goreleaser Pro"] = 342,
    Goss = 343,
    ["Gradle Build Cache Node"] = 808,
    ["Gradle Enterprise"] = 807,
    ...
    Hadolint = 789,
    Hammerkit = 817,
    ["Hardware Sentry Configuration"] = 871,
    Hatch = 790,
    Hayson = 356,
    ...
    ["JFrog File Spec"] = 385,
    ["JFrog Pipelines YML DSL"] = 880,
    ["JMeter DSL cli config"] = 386,
    JReleaser = 388,
    ["JSON Document Transform"] = 396,
    ["JSON Feed"] = 397,
    ["JSON Resume"] = 604,
    ["JSON Schema Draft 2020-12"] = 759,
    ["JSON Schema Draft 4"] = 756,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 913,
    ["JSON Schema Draft 7"] = 757,
    ["JSON Schema Draft 7 (unofficial strict)"] = 914,
    ["JSON Schema Draft 8 (2019-09)"] = 758,
    ["JSON-API"] = 395,
    ["JSON-e templates"] = 815,
    ["JSON-stat 2.0"] = 752,
    JSONPatch = 399,
    ...
    ["Metadata for a Cinnamon spice"] = 967,
    ["Metatype Configuration"] = 447,
    ["MetricsHub Configuration"] = 448,
    ["MetricsHub Connector Configuration"] = 449,
    ["Micro Editor Syntax"] = 904,
    ["Microsoft Band Web Tile"] = 450,
    ["Microsoft RulesEngine workflow rules"] = 955,
    ["Microsoft RulesEngine workflow rules list"] = 956,
    ["Minecraft Custom Main Menu Mod"] = 921,
    ...
    ["MongoDB Atlas Search Index Definition"] = 875,
    ["Monika Configuration"] = 873,
    ["Monoweave Configuration"] = 475,
    ["Motif config"] = 772,
    ["NOX Framework (Service)"] = 492,
    ["Netin Diagnostic System Template"] = 833,
    ["Netlify config"] = 483,
    ...
    ["OpenUtau ustx"] = 510,
    ["OpenWeather Current Weather API"] = 814,
    ["OpenWeather Road Risk API"] = 813,
    ...
    ["Pipeline component"] = 825,
    ["Plex Prerolls"] = 546,
    ["PocketMine plugin.yml"] = 543,
    ["Postman collection"] = 550,
    ["Preset list for a WinUtil"] = 970,
    ["Problem object RFC9457"] = 918,
    ...
    Qgoda = 586,
    Qodana = 843,
    ["Qt Creator workspace file"] = 949,
    ["Quali Torque Blueprint Spec 2"] = 868,
    ["QueryFirst config file"] = 886,
    ["RKE Cluster Configuration JSON"] = 822,
    ["RKE Cluster Configuration YAML"] = 821,
    RadioHound = 578,
    ["Rancher Fleet"] = 580,
    ["Rattler-build"] = 587,
    Ray = 788,
    ["Read the Docs"] = 582,
    ["Red-DiscordBot Cog"] = 594,
    ["Red-DiscordBot Cog Repo"] = 595,
    ["Red-DiscordBot Trivia"] = 596,
    ["Render Blueprints"] = 820,
    RenderCV = 606,
    Renovate = 605,
    ["Replit config"] = 600,
    RoadRunner = 608,
    ["Rudder techniques"] = 924,
    Ruff = 602,
    ["Rust Project"] = 603,
    ["Rust toolchain"] = 612,
    ["SDMX data message"] = 637,
    ["SDMX metadata message"] = 636,
    ["SDMX structure message"] = 635,
    ["SIL Kit Participant Configuration"] = 647,
    ["SIL Kit Registry Configuration"] = 648,
    SWADL = 677,
    ["Safebox Config"] = 881,
    ["Sapphire CLI Config"] = 615,
    ["SauceCTL Configuration"] = 830,
    ["Schema Catalog"] = 629,
    ["Scoop manifest"] = 634,
    ["Semantic Data Fabric (SDF) file"] = 638,
    ["Semgrep Rule"] = 640,
    ["Serenity Code Generator (Sergen)"] = 641,
    ["Serverless Framework Configuration"] = 837,
    ["Serverless Workflow"] = 839,
    ["Settings for a Cinnamon spice"] = 966,
    ["Settings.paf"] = 643,
    ["Shopware 6 Configuration"] = 840,
    ["Shopware CLI Extension Store Configuration"] = 841,
    ["Shopware CLI Project Store Configuration"] = 842,
    ["Sigma Detection Rule"] = 645,
    ["Sigrid scope configuration file"] = 646,
    ["SkyPilot Task JSON"] = 925,
    ["Slack app manifest"] = 650,
    Solidarity = 653,
    ["Solution filters"] = 654,
    ["Source Maps v3"] = 655,
    Sourcery = 656,
    ["Speakeasy Generation Config File"] = 660,
    ["Speakeasy Lint Configuration File"] = 657,
    ["Speakeasy Test Generation Configuration File"] = 658,
    ["Speakeasy Workflow File"] = 659,
    SpecIF = 661,
    ["Sponge Mixin configuration"] = 662,
    StackBlitz = 667,
    ["StackHawk Scanner Configuration"] = 836,
    Stale = 668,
    ["Starlake Data Pipeline"] = 811,
    Starship = 669,
    ["Statamic Blueprint"] = 670,
    ["Stella configuration file"] = 671,
    ["Stryker Mutator"] = 674,
    ["StyleCop Analyzers Configuration"] = 675,
    ["Stylelint (.stylelintrc)"] = 676,
    ["Sublime Syntax"] = 882,
    ["Subsquid squid manifest"] = 927,
    ["Swagger API 2.0"] = 678,
    ["Synadia Connect Component"] = 679,
    TSON = 710,
    TSTyche = 711,
    ["Tab data for a LinUtil"] = 972,
    ["Tab list for a LinUtil"] = 971,
    Talhelper = 681,
    ["Talisman configuration"] = 682,
    ["Taskfile config"] = 816,
    Taurus = 683,
    Tauticord = 684,
    ["TestEnvironment.json"] = 693,
    ["TextMate Grammar"] = 692,
    ["Tier.run pricing.json"] = 687,
    Tikibase = 688,
    ["Traefik v2"] = 696,
    ["Traefik v2 File Provider"] = 697,
    ["Traefik v3"] = 698,
    ["Traefik v3 File Provider"] = 699,
    ["Travis CI (.travis.yml)"] = 695,
    ["TrueScript for *.tscript files"] = 702,
    ["Tugboat QA config.yml"] = 993,
    TunnelHub = 917,
    Turborepo = 694,
    Tycho = 962,
    Tye = 844,
    ["UET BuildConfig.json"] = 887,
    ["UI5 Manifest"] = 720,
    ["UNCORS configuration"] = 724,
    ["UTAM Page Object"] = 723,
    ["Ubuntu Server Autoinstall"] = 718,
    ["Uniswap Token List"] = 799,
    ["Unreal Engine Uplugin"] = 888,
    ["Unreal Engine Uproject"] = 889,
    ["Updatecli Compose"] = 852,
    ["Updatecli Policy Manifest"] = 853,
    ["Updatecli Policy Metadata"] = 854,
    Uplift = 885,
    ["User Journey Map"] = 819,
    V2Ray = 858,
    ["VSCode Code Snippets"] = 183,
    ["VSIX CLI publishing"] = 741,
    ["Vela Pipeline Configuration"] = 728,
    Vercel = 182,
    ...
    ["Web types"] = 750,
    WebExtensions = 746,
    ["Webman package recipe"] = 864,
    ["Windows Package Manager Installer Manifest"] = 796,
    ["Windows Package Manager Locale Manifest"] = 797,
    ["Windows Package Manager Singleton Manifest"] = 795,
    ["WireMock stub mapping"] = 978,
    ["Woodpecker pipeline config"] = 832,
    ["Wrangler CLI"] = 751,
    ["Xstate Machine"] = 850,
    ["Yandex Workflow Language"] = 968,
    ["Yarn Config (.yarnrc.yml)"] = 809,
    ["Yippee-Ki-JSON configuration YML"] = 801,
    ["YouTrack App"] = 965,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 919,
    ...
    ["behat.yml"] = 92,
    ["bigquery-table"] = 82,
    ["bioimageio resource description"] = 935,
    ...
    ["crowdin.yml"] = 216,
    ["ctfd-setup configuration file"] = 985,
    ["custom-elements.json"] = 907,
    ["cypress.json"] = 220,
    ...
    ["gematik health care insurance list"] = 991,
    ["gematik health care patient list"] = 988,
    ["gematik health care provider institution list"] = 990,
    ["gematik health care provider list"] = 989,
    ["gematik tiger test environment configuration"] = 992,
    ["gitlab-ci"] = 322,
    ["global.json"] = 337,
    ...
    ["lint-staged (.lintstagedrc)"] = 767,
    ["local.settings.json"] = 437,
    ["localazy.json"] = 438,
    ["lotus.yaml"] = 436,
    ["lsdlschema.json"] = 439,
    ["markdown-link-check"] = 828,
    mboats = 835,
    ["micro-settings.json"] = 899,
    ["mimetypes.json"] = 451,
    ["mirrord config"] = 768,
    mise = 769,
    ["mkdocs.yml"] = 471,
    ...
    ["plagiarize.yaml"] = 544,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 981,
    ["podbard.yaml"] = 547,
    ["portman.json"] = 548,
    ["prefect.toml"] = 556,
    ["prettierrc.json"] = 557,
    ...
    samt = 613,
    samtrc = 614,
    ["sarif-1.0.0.json"] = 616,
    ["sarif-2.0.0.json"] = 617,
    ["sarif-2.1.0"] = 627,
    ["sarif-2.1.0-rtm.2"] = 618,
    ["sarif-2.1.0-rtm.3"] = 620,
    ["sarif-2.1.0-rtm.4"] = 622,
    ["sarif-2.1.0-rtm.5"] = 624,
    ["sarif-2.1.0-rtm.6"] = 625,
    ["sarif-external-property-file-2.1.0"] = 628,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 619,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 621,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 623,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 626,
    ["schema.org - Action"] = 630,
    ["schema.org - ContactPoint"] = 631,
    ["schema.org - Place"] = 632,
    ["schema.org - Thing"] = 633,
    ["secrethub.yml"] = 902,
    ["semantic-release"] = 639,
    ["servicehub.config.json"] = 762,
    ["servicehub.service.json"] = 761,
    ["settings.job"] = 642,
    ["sfdx-hardis configuration"] = 644,
    ["shard.yml"] = 938,
    ["size-limit configuration"] = 649,
    ["skaffold.yaml"] = 826,
    ["skyuxconfig.json"] = 651,
    snapcraft = 652,
    ["spicepod.yaml"] = 957,
    ["sqlc configuration"] = 664,
    ["stripe-app-local.json"] = 673,
    ["stripe-app.json"] = 672,
    swcrc = 812,
    ["task.json"] = 680,
    taskcat = 778,
    ["template.json"] = 685,
    ["templatsources.json"] = 686,
    ["theme.json"] = 689,
    ["tizen_workspace.json"] = 690,
    tldr = 691,
    tmuxinator = 765,
    ["transcend.yml"] = 700,
    ...
    ["vega-lite.json"] = 727,
    ["vega.json"] = 726,
    ["venvironment-basic.yaml"] = 730,
    ["venvironment.yaml"] = 729,
    ["version.json"] = 732,
    ["vhwdebugger-binding.yaml"] = 734,
    ["vim-addon-info"] = 735,
    ["vs-2017.3.host.json"] = 737,
    ["vs-nesting.json"] = 738,
    ["vsls.json"] = 736,
    ["vss-extension.json"] = 742,
    ["vtesttree.yaml"] = 743,
    ["vtestunit.yaml"] = 744,
    ["warp-keysets.json"] = 908,
    ["warp-themes.json"] = 909,
    ["warp-workflows.json"] = 910,
    ["webhint.io"] = 865,
    ["webjobpublishsettings.json"] = 749,
    ["webjobs-list.json"] = 748,
    ["well-known-fursona"] = 945,
    ["xs-app.json"] = 774,
    ["xunit.runner.json"] = 760,
    yamllint = 800,
    ["zerops.io import file"] = 954,
    ["zerops.yml"] = 953,
    zuul = 784,
    ["Žinoma"] = 794
  },
