...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 752,
    [".nodehawkrc"] = 477,
    [".npmpackagejsonlintrc"] = 481,
    [".omletrc"] = 923,
    [".phrase.yml"] = 541,
    [".phraseapp.yml"] = 542,
    [".pmbot.yml"] = 529,
    [".postcssrc"] = 536,
    [".powerpages-web-template-manifest"] = 538,
    [".pre-commit-config.yml"] = 539,
    [".pre-commit-hooks.yml"] = 540,
    [".putout.json"] = 562,
    [".rehyperc"] = 581,
    [".remarkrc"] = 583,
    [".sprite files"] = 645,
    ...
    ["A micro editor config"] = 432,
    ABCInventoryModuleData = 13,
    ABCSupplyPlan = 14,
    AIConfig = 15,
    ["API Builder"] = 785,
    ["AVA Configuration"] = 845,
    ["AWS AppConfig Feature Flags-v1"] = 38,
    ["AWS CDK cdk.json"] = 191,
    ["AWS CloudFormation"] = 192,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 193,
    ["AWS SAM CLI Samconfig"] = 194,
    ["Adobe UXP Manifest"] = 905,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Alacritty Configuration"] = 817,
    ["All Contributors configuration file"] = 870,
    ["Ansible Argument Specs"] = 320,
    ["Ansible Collection Galaxy"] = 327,
    ["Ansible Execution Environment"] = 317,
    ["Ansible Inventory"] = 326,
    ["Ansible Meta"] = 318,
    ["Ansible Meta Runtime"] = 319,
    ["Ansible Navigator Configuration"] = 329,
    ["Ansible Playbook"] = 324,
    ["Ansible Requirements"] = 321,
    ["Ansible Rulebook"] = 325,
    ["Ansible Tasks File"] = 323,
    ["Ansible Vars File"] = 322,
    ["Ansible-lint Configuration"] = 328,
    Any = 932,
    ["AnyWork Automation Configuration"] = 5,
    ["App config Spotify Backstage"] = 20,
    ["Application Accelerator"] = 2,
    ["Application list for a WinUtil"] = 949,
    ArchitectFX = 953,
    ["Argo Events"] = 28,
    ["Argo Workflows"] = 29,
    AssemblyScript = 32,
    ...
    ["Azure Pipelines"] = 64,
    ["Azure Static Web Apps CLI configuration file"] = 648,
    ["Azure Static Web Apps configuration file"] = 647,
    ["BOSH Deploy Config"] = 88,
    ["BX CI"] = 105,
    ["Bashly (bashly.yml)"] = 874,
    ["Bashly Settings (bashly-settings.yml)"] = 875,
    ["Better Code Hub"] = 789,
    ["Better Scripts"] = 106,
    Bigconfig = 81,
    ["Bitmovin Encoding Template"] = 959,
    BizTalkServerApplicationSchema = 758,
    Bleep = 107,
    ...
    ["Build Info"] = 96,
    Buildkite = 98,
    ["Bukkit plugin.yml"] = 97,
    ["BungeeCord plugin.yml"] = 102,
    ["Butane Config"] = 830,
    ["CGS Custom Card Game (CardGameDef.json)"] = 910,
    ["CICS TS region tagging"] = 839,
    ["CICS TS resource import"] = 840,
    ["CICS TS resource model"] = 841,
    ["CICS TS resource overrides"] = 842,
    ["CMake Presets"] = 108,
    ["CNC Codes"] = 123,
    ["CRS WAF test file"] = 939,
    ["CRS WAF test platform overrides file"] = 940,
    ["CSS Comb (.csscomb.json)"] = 218,
    ["CSS Lint (.csslintrc)"] = 219,
    ["CSpell (cspell.json)"] = 217,
    ["CVE Record Format"] = 129,
    CWL = 916,
    ["Cache Warmup config"] = 109,
    ["Calqulus pipeline"] = 110,
    ["Camel YAML DSL"] = 111,
    ["Cannon TOML"] = 112,
    Carafe = 113,
    ["Cargo Make"] = 115,
    ["Cargo Manifest"] = 114,
    ["Catalog Info Backstage"] = 116,
    Changesets = 203,
    Cheatsheets = 827,
    ["Chrome Extension"] = 184,
    ["Chromia Model"] = 117,
    ["CircleCI config.yml"] = 160,
    ["Citation File Format"] = 205,
    CityJSON = 119,
    ["Clawject config"] = 128,
    ["Cloud Foundry Application Manifest"] = 922,
    ["Cloud Run Spec v1"] = 944,
    ["CloudCannon Configuration"] = 60,
    ["CloudEvents specification"] = 120,
    ["Code Climate"] = 161,
    CodeCV = 58,
    CodeRabbit = 57,
    ["CodeShip Pro services configuration files"] = 173,
    ["CodeShip Pro steps configuration files"] = 174,
    ["Codecov configuration files"] = 172,
    CodifyCLI = 59,
    Codux = 170,
    ["Cog config file"] = 124,
    ["Commandbox Box.json"] = 125,
    ["Commandbox Server.json"] = 126,
    ["Common Catalog Data"] = 182,
    Concord = 938,
    ["Configu .cfgu files"] = 927,
    ["Configu .configu file"] = 928,
    Conjure = 122,
    ["Container Structure Test"] = 772,
    Containerlab = 797,
    ["Crowdsec collection config"] = 212,
    ["Crowdsec parser config"] = 213,
    ["Crowdsec scenario config"] = 214,
    ["CumulusCI Config"] = 127,
    ["Custom Machinery Machine"] = 911,
    ["Custom Machinery Recipe"] = 912,
    ["Cycle Stack File"] = 130,
    ["DWP Exchange - catalogue entry"] = 260,
    ["DWP Exchange - gateway"] = 258,
    ["DWP Exchange - meta"] = 259,
    ["Dart Build Config (dart-build.json)"] = 220,
    ["Dart Test Config (dart-test.json)"] = 221,
    ["DashLord Configuration"] = 222,
    ["Data Contract Specification"] = 223,
    ["Data Product Specification"] = 224,
    ["DataYoga Connections"] = 131,
    ["DataYoga Job"] = 132,
    ["Databricks Asset Bundles"] = 891,
    ["Datadog Service Definition"] = 405,
    ["Datadog Software Catalog"] = 406,
    ["Datahub Ingestion Recipe"] = 846,
    ["Dein Config"] = 138,
    ["Deno Config (deno.json)"] = 230,
    ["Dependency cruiser"] = 139,
    ["Deployer Recipe"] = 233,
    ["Deta Spacefile"] = 140,
    ["Detekt Config (detekt.yml)"] = 234,
    ["Devbox Config"] = 141,
    ["Devbox Plugin"] = 142,
    Devfile = 257,
    DipDup = 941,
    ["Discord Webhook"] = 235,
    ["DocFx Config (docfx.json)"] = 239,
    ["Dolittle Artifacts"] = 240,
    ["Dolittle Bounded Context Configuration"] = 241,
    ["Dolittle Event Horizons Configuration"] = 242,
    ["Dolittle Resources Configuration"] = 243,
    ["Dolittle Server Configuration"] = 244,
    ["Dolittle Tenant Map Configuration"] = 246,
    ["Dolittle Tenants Configuration"] = 245,
    ["Dolittle Topology"] = 247,
    ["Drupal Breakpoints"] = 143,
    ["Drupal Config"] = 155,
    ["Drupal Info"] = 144,
    ["Drupal Layouts"] = 145,
    ["Drupal Libraries"] = 146,
    ["Drupal Links Action"] = 147,
    ["Drupal Links Contextual"] = 148,
    ["Drupal Links Menu"] = 149,
    ["Drupal Links Task"] = 150,
    ["Drupal Migration"] = 151,
    ["Drupal Permissions"] = 152,
    ["Drupal Recipe"] = 153,
    ["Drupal Routing"] = 154,
    ["Drupal Services"] = 156,
    ["Drush site aliases"] = 253,
    ["Dynamic Bash Aliases (.aliases)"] = 882,
    ["EAS config"] = 278,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 871,
    ["EasyVCR .NET"] = 279,
    ["Eidolon Resource"] = 954,
    ["Elgato Stream Deck"] = 263,
    Elm = 943,
    ["Embrace Config"] = 857,
    Endurica = 895,
    ["Enterprise Contract Policy Spec"] = 264,
    ["Erda Pipeline"] = 918,
    ["Erda Runtime"] = 919,
    ["Error pages"] = 268,
    Esquio = 266,
    ["Estuary Flow Catalog"] = 836,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 271,
    ["EveryVoice TTS Toolkit Data Configuration"] = 272,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 276,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 275,
    ["EveryVoice TTS Toolkit Text Configuration"] = 273,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 274,
    ["Expo SDK"] = 277,
    ["F-Droid Data metadata"] = 283,
    ["FasterCI Configuration"] = 65,
    FiQuS = 287,
    Firebase = 285,
    ["Flow.json Configurations"] = 915,
    ["Fossa configuration file"] = 294,
    ["Fossa's fossa-deps file"] = 295,
    ["Foundry VTT - Base package Manifest"] = 289,
    ["Foundry VTT - Module Manifest"] = 290,
    ["Foundry VTT - System Data Template"] = 293,
    ["Foundry VTT - System Manifest"] = 291,
    ["Foundry VTT - World Manifest"] = 292,
    ["Foxx Manifest"] = 66,
    ["Freifunk.de Community API"] = 69,
    ["Frogbot Config"] = 70,
    ["G2P Mapping Configuration"] = 299,
    ["GCP Blueprint Metadata"] = 302,
    Gaspar = 300,
    ["GatewayCore API Gateway"] = 301,
    ["GeoJSON.json latest"] = 834,
    GherKing = 838,
    ["GitHub Action"] = 307,
    ["GitHub Discussion"] = 308,
    ["GitHub Funding"] = 309,
    ["GitHub Issue Template configuration"] = 311,
    ["GitHub Issue Template forms"] = 310,
    ["GitHub Workflow"] = 312,
    ["GitHub Workflow Template Properties"] = 313,
    ["GitHub automatically generated release notes configuration"] = 314,
    ["GitLab Agent for Kubernetes configuration"] = 907,
    GitVersion = 304,
    ["Gitea Issue Template configuration"] = 305,
    ["Gitea Issue Template forms"] = 306,
    ["Gitpod Configuration"] = 316,
    ["GlazeWM settings"] = 909,
    ["Global Privacy Control"] = 303,
    Goblet = 890,
    ["Golangci-lint Configuration"] = 331,
    ["Golangci-lint Custom Plugins Configuration"] = 332,
    ["Google Chrome Related Website Sets"] = 286,
    ["Google Cloud Workflows"] = 190,
    Goreleaser = 334,
    ["Goreleaser Pro"] = 335,
    Goss = 336,
    ["Gradle Build Cache Node"] = 787,
    ["Gradle Enterprise"] = 786,
    ["Grafana 5.x Dashboard"] = 337,
    ["GraphQL Code Generator"] = 341,
    ["GraphQL Config"] = 340,
    ["GraphQL Mesh"] = 339,
    ["Grunt JSHint task"] = 345,
    ["Grunt Watch task"] = 346,
    ["Grunt base task"] = 347,
    ["Grunt clean task"] = 343,
    ["Grunt copy task"] = 342,
    ["Grunt cssmin task"] = 344,
    HEMTT = 755,
    Hadolint = 768,
    Hammerkit = 796,
    ["Hardware Sentry Configuration"] = 850,
    Hatch = 769,
    Hayson = 349,
    ["Haystack Pipeline"] = 350,
    ["Hazelcast 5 Configuration"] = 351,
    ["Helm Chart.lock"] = 158,
    ["Helm Chart.yaml"] = 157,
    ["Helm Unittest Test Suite"] = 159,
    Hugo = 826,
    ["Hugo Theme"] = 825,
    ["Hyperfoil benchmark configuration"] = 357,
    ["IBM Zapp document"] = 358,
    ["IBM zCodeFormatSettings"] = 359,
    ["IMG Catapult PSP"] = 364,
    ["IVMS101 by CODE Protocol"] = 908,
    Infrahub = 366,
    Istanbul = 853,
    ["JDownloader2 crawler multi-rules"] = 375,
    ["JDownloader2 crawler single-rules"] = 374,
    ["JFrog Applications Config"] = 376,
    ["JFrog File Spec"] = 377,
    ["JFrog Pipelines YML DSL"] = 859,
    ["JMeter DSL cli config"] = 378,
    JReleaser = 380,
    ["JSON Document Transform"] = 388,
    ["JSON Feed"] = 389,
    ["JSON Resume"] = 588,
    ["JSON Schema Draft 2020-12"] = 738,
    ["JSON Schema Draft 4"] = 735,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 892,
    ["JSON Schema Draft 7"] = 736,
    ["JSON Schema Draft 7 (unofficial strict)"] = 893,
    ["JSON Schema Draft 8 (2019-09)"] = 737,
    ["JSON-API"] = 387,
    ["JSON-WF"] = 921,
    ["JSON-e templates"] = 794,
    ["JSON-stat 2.0"] = 731,
    JSONPatch = 391,
    ["JSR Package Config (jsr.json)"] = 381,
    Jasmine = 370,
    Jekyll = 371,
    ["Jenkins X Pipelines"] = 372,
    ["Jenkins X Requirements"] = 373,
    ["Jovo Language Models"] = 379,
    ["KIMMDY config file"] = 402,
    ["KSP-AVC"] = 732,
    ["KSP-CKAN"] = 733,
    ["KSP-NetKAN"] = 734,
    KSY = 920,
    ["Karakum configuration file"] = 296,
    Kas = 394,
    ["Kestra flow file"] = 403,
    ["Keycloak REST API"] = 862,
    ["Knative Functions - func.yaml"] = 297,
    ["KoDE/CI build.yaml"] = 855,
    ["Kong DBLess config"] = 856,
    KrakenD = 404,
    ["Kubri Configuration"] = 410,
    LOOBin = 425,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 195,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 196,
    ["Landing Zone Accelerator on AWS - Global Config"] = 197,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 198,
    ["Landing Zone Accelerator on AWS - Network Config"] = 199,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 200,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 201,
    ["Landing Zone Accelerator on AWS - Security Config"] = 202,
    ["Language configuration"] = 931,
    Lefthook = 414,
    ["Liferay client-extension.yaml"] = 421,
    ["LinkML Metamodel"] = 423,
    Liquibase = 802,
    ["Liquibase Flow File"] = 803,
    ["Lively Properties"] = 424,
    ["Lobe AI Agent"] = 62,
    Loki = 63,
    ["MLOS Configs"] = 461,
    ["MS2Rescore Configuration"] = 464,
    ["Madness (madness.yml)"] = 873,
    ["MapEHR Mapping"] = 431,
    Markdownlint = 806,
    ["Mason Registry"] = 808,
    ["MegaLinter configuration"] = 433,
    ["MegaLinter descriptor"] = 434,
    Melange = 899,
    ["Meltano project definition"] = 435,
    ["Mergify Configuration"] = 465,
    ["Metadata for a Bazel module"] = 436,
    ["Metadata for a Cinnamon spice"] = 947,
    ["MetricsHub Configuration"] = 437,
    ["MetricsHub Connector Configuration"] = 438,
    ["Micro Editor Syntax"] = 883,
    ["Microsoft Band Web Tile"] = 439,
    ["Microsoft RulesEngine workflow rules"] = 935,
    ["Microsoft RulesEngine workflow rules list"] = 936,
    ["Minecraft Custom Main Menu Mod"] = 900,
    ["Minecraft Data Pack Advancement"] = 441,
    ["Minecraft Data Pack Biome"] = 442,
    ["Minecraft Data Pack Configured Carver"] = 443,
    ["Minecraft Data Pack Damage Type"] = 444,
    ["Minecraft Data Pack Dimension"] = 446,
    ["Minecraft Data Pack Dimension Type"] = 445,
    ["Minecraft Data Pack Item Modifier"] = 447,
    ["Minecraft Data Pack Loot Table"] = 448,
    ["Minecraft Data Pack Metadata"] = 449,
    ["Minecraft Data Pack Predicate"] = 450,
    ["Minecraft Data Pack Recipe"] = 451,
    ["Minecraft Data Pack Tag"] = 452,
    ["Minecraft Data Pack Template Pool"] = 453,
    ["Minecraft Data Pack Trim Material"] = 458,
    ["Minecraft Data Pack Trim Pattern"] = 459,
    ["Minecraft Resource Pack Lang"] = 454,
    ["Minecraft Resource Pack Particle"] = 455,
    ["Minecraft Resource Pack Texture Mcmeta"] = 457,
    ["Minecraft Resourcepack Sounds"] = 456,
    ["Monade CLI Stack Configuration"] = 468,
    ["MongoDB Atlas Search Index Definition"] = 854,
    ["Monika Configuration"] = 852,
    ["Monoweave Configuration"] = 463,
    ["Motif config"] = 751,
    ["NOX Framework (Service)"] = 480,
    ["Netin Diagnostic System Template"] = 812,
    ["Netlify config"] = 471,
    ["Network-as-Code Data Model"] = 472,
    ["Nightwatch.js"] = 473,
    ["NueJS configuration file"] = 485,
    ["Nuitka.yaml"] = 913,
    ["Nullstone config"] = 487,
    ["ONe's changelog entry"] = 500,
    ["ONe's service descriptor"] = 499,
    ["OSCAL Assessment Plan (AP)"] = 508,
    ["OSCAL Assessment Results (AR)"] = 509,
    ["OSCAL Catalog"] = 510,
    ["OSCAL Component Definition (CDef)"] = 511,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 512,
    ["OSCAL Profile"] = 513,
    ["OSCAL System Security Plan (SSP)"] = 514,
    ["OSS Review Toolkit configuration"] = 515,
    ["OSS Review Toolkit curation"] = 516,
    ["OSS Review Toolkit package configuration"] = 517,
    ["OSS Review Toolkit repository configuration"] = 518,
    ["OSS Review Toolkit resolutions"] = 519,
    ["October CMS columns"] = 491,
    ["October CMS fields"] = 492,
    Opctl = 754,
    ["Open Data Contract Standard (ODCS)"] = 503,
    ["OpenRewrite Resource"] = 502,
    ["OpenUtau character yaml"] = 496,
    ["OpenUtau ustx"] = 497,
    ["OpenWeather Current Weather API"] = 793,
    ["OpenWeather Road Risk API"] = 792,
    ["Ory Hydra configuration"] = 356,
    ["Ory Keto configuration"] = 407,
    ["Ory Kratos configuration"] = 507,
    ["Ory Oathkeeper configuration"] = 489,
    ["Outblocks App configuration"] = 505,
    ["Outblocks database table"] = 506,
    ["Outblocks project configuration"] = 504,
    PDM = 525,
    Packer = 522,
    Pantsbuild = 869,
    ["Paper paper-plugin.yml"] = 523,
    ["Pipeline component"] = 804,
    ["Plex Prerolls"] = 533,
    ["PocketMine plugin.yml"] = 530,
    ["Postman collection"] = 537,
    ["Preset list for a WinUtil"] = 950,
    ["Problem object RFC9457"] = 897,
    ["Problem package generators"] = 546,
    Pterodactyl = 849,
    ["Pull Request Labeler"] = 561,
    Pulumi = 567,
    PyProject = 568,
    Pyright = 569,
    Qgoda = 570,
    Qodana = 822,
    ["Qt Creator workspace file"] = 929,
    ["Quali Torque Blueprint Spec 2"] = 847,
    ["QueryFirst config file"] = 865,
    ["RKE Cluster Configuration JSON"] = 801,
    ["RKE Cluster Configuration YAML"] = 800,
    ["Rancher Fleet"] = 564,
    ["Rattler-build"] = 571,
    Ray = 767,
    ["Read the Docs"] = 566,
    ["Red-DiscordBot Cog"] = 578,
    ["Red-DiscordBot Cog Repo"] = 579,
    ["Red-DiscordBot Trivia"] = 580,
    ["Render Blueprints"] = 799,
    RenderCV = 590,
    Renovate = 589,
    ["Replit config"] = 584,
    RoadRunner = 591,
    ["Rudder techniques"] = 903,
    Ruff = 586,
    ["Rust Project"] = 587,
    ["Rust toolchain"] = 595,
    ["SDMX data message"] = 620,
    ["SDMX metadata message"] = 619,
    ["SDMX structure message"] = 618,
    ["SIL Kit Participant Configuration"] = 630,
    ["SIL Kit Registry Configuration"] = 631,
    SWADL = 659,
    ["Safebox Config"] = 860,
    ["Sapphire CLI Config"] = 598,
    ["SauceCTL Configuration"] = 809,
    ["Schema Catalog"] = 612,
    ["Scoop manifest"] = 617,
    ["Semantic Data Fabric (SDF) file"] = 621,
    ["Semgrep Rule"] = 623,
    ["Serenity Code Generator (Sergen)"] = 624,
    ["Serverless Framework Configuration"] = 816,
    ["Serverless Workflow"] = 818,
    ["Settings for a Cinnamon spice"] = 946,
    ["Settings.paf"] = 626,
    ["Shopware 6 Configuration"] = 819,
    ["Shopware CLI Extension Store Configuration"] = 820,
    ["Shopware CLI Project Store Configuration"] = 821,
    ["Sigma Detection Rule"] = 628,
    ["Sigrid scope configuration file"] = 629,
    ["SkyPilot Task JSON"] = 904,
    ["Slack app manifest"] = 633,
    Solidarity = 636,
    ["Solution filters"] = 637,
    ["Source Maps v3"] = 638,
    Sourcery = 639,
    ["Speakeasy Lint Configuration File"] = 640,
    ["Speakeasy Test Generation Configuration File"] = 641,
    ["Speakeasy Workflow File"] = 642,
    SpecIF = 643,
    ["Sponge Mixin configuration"] = 644,
    StackBlitz = 649,
    ["StackHawk Scanner Configuration"] = 815,
    Stale = 650,
    ["Starlake Data Pipeline"] = 790,
    Starship = 651,
    ["Statamic Blueprint"] = 652,
    ["Stella configuration file"] = 653,
    ["Stryker Mutator"] = 656,
    ["StyleCop Analyzers Configuration"] = 657,
    ["Stylelint (.stylelintrc)"] = 658,
    ["Sublime Syntax"] = 861,
    ["Subsquid squid manifest"] = 906,
    ["Swagger API 2.0"] = 660,
    TSON = 689,
    TSTyche = 690,
    ["Tab data for a LinUtil"] = 952,
    ["Tab list for a LinUtil"] = 951,
    Talhelper = 662,
    ["Talisman configuration"] = 663,
    ["Taskfile config"] = 795,
    Taurus = 664,
    Tauticord = 665,
    ["TestEnvironment.json"] = 674,
    ["TextMate Grammar"] = 673,
    ["Tier.run pricing.json"] = 668,
    Tikibase = 669,
    ["Traefik v2"] = 677,
    ["Traefik v2 File Provider"] = 678,
    ["Travis CI (.travis.yml)"] = 676,
    ["TrueScript for *.tscript files"] = 681,
    TunnelHub = 896,
    Turborepo = 675,
    Tycho = 942,
    Tye = 823,
    ["UET BuildConfig.json"] = 866,
    ["UI5 Manifest"] = 699,
    ["UNCORS configuration"] = 703,
    ["UTAM Page Object"] = 702,
    ["Ubuntu Server Autoinstall"] = 697,
    ["Uniswap Token List"] = 778,
    ["Unreal Engine Uplugin"] = 867,
    ["Unreal Engine Uproject"] = 868,
    ["Updatecli Compose"] = 831,
    ["Updatecli Policy Manifest"] = 832,
    ["Updatecli Policy Metadata"] = 833,
    Uplift = 864,
    ["User Journey Map"] = 798,
    V2Ray = 837,
    ["VSCode Code Snippets"] = 178,
    ["VSIX CLI publishing"] = 720,
    ["Vela Pipeline Configuration"] = 707,
    Vercel = 177,
    ["Version Bumper config"] = 710,
    Visivo = 894,
    ["Waku Config"] = 955,
    ["Web App Manifest"] = 726,
    ["Web types"] = 729,
    WebExtensions = 725,
    ["Webman package recipe"] = 843,
    ["Windows Package Manager Installer Manifest"] = 775,
    ["Windows Package Manager Locale Manifest"] = 776,
    ["Windows Package Manager Singleton Manifest"] = 774,
    ["WireMock stub mapping"] = 958,
    ["Woodpecker pipeline config"] = 811,
    ["Wrangler CLI"] = 730,
    ["Xstate Machine"] = 829,
    ["Yandex Workflow Language"] = 948,
    ["Yarn Config (.yarnrc.yml)"] = 788,
    ["Yippee-Ki-JSON configuration YML"] = 780,
    ["YouTrack App"] = 945,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 898,
    ...
    ["behat.yml"] = 90,
    ["bigquery-table"] = 80,
    ["bioimageio resource description"] = 914,
    ["bitbucket-pipelines"] = 82,
    bitrise = 83,
    ["bitrise-step"] = 84,
    ["block.json"] = 103,
    ["bottom configuration"] = 52,
    ["bower.json"] = 86,
    ["bozr.suite.json"] = 92,
    bpkg = 877,
    ["browser.i18n.json"] = 93,
    ["browsh configuration"] = 94,
    bucklescript = 95,
    ["buf.gen.yaml"] = 54,
    ["buf.plugin.yaml"] = 55,
    ["buf.work.yaml"] = 56,
    ...
    ["ccmod.json"] = 956,
    changelogging = 926,
    ["chisel-slices.json"] = 204,
    ["chrome-extension-locales-messages.json"] = 185,
    ["chutzpah.json"] = 186,
    cibuildwheel = 118,
    ["clang-format (.clang-format)"] = 835,
    ["clang-tidy"] = 165,
    clangd = 164,
    clib = 166,
    ["cloud-init: cloud-config userdata"] = 168,
    ["cloud-sdk-pipeline-configuration"] = 188,
    ["cloudbuild.json"] = 189,
    cloudify = 167,
    codemagic = 169,
    ["coffeelint.json"] = 206,
    ["commands.json"] = 181,
    ["commitlint (.commitlintrc)"] = 777,
    ["compile_commands.json"] = 180,
    ["compilerconfig.json"] = 179,
    ["completely.yml"] = 872,
    ["component-detection-manifest.json"] = 209,
    ["component.json"] = 208,
    ["composer.json"] = 207,
    ["conda-forge"] = 121,
    ["config.yaml"] = 565,
    ["contentmanifest.json"] = 187,
    ["contribute.json"] = 210,
    ["cosmos.config.json"] = 183,
    ["crowdin.yml"] = 211,
    ["custom-elements.json"] = 886,
    ["cypress.json"] = 215,
    ["datalogic-scan2deploy-android"] = 225,
    ["datalogic-scan2deploy-ce"] = 226,
    ["dbt Dependencies"] = 133,
    ["dbt Packages"] = 135,
    ["dbt Project"] = 134,
    ["dbt Selectors"] = 136,
    ["dbt YAML files"] = 137,
    ["ddev-global"] = 227,
    ["ddev-project"] = 228,
    ["debugsettings.json"] = 229,
    ["dependabot-v2.json"] = 232,
    ["dependabot.json"] = 231,
    ["deployed-cli"] = 828,
    ["devcontainer.json"] = 171,
    devinit = 782,
    ["devspace.yaml"] = 851,
    djlint = 783,
    ["docker bake"] = 237,
    ["docker sequencer"] = 238,
    ["docker-compose.yml"] = 781,
    ["dockerd.json"] = 236,
    ["dotnet Release Index manifest"] = 248,
    ["dotnet-tools.json"] = 249,
    ["dotnetcli.host.json"] = 250,
    ["dprint.json"] = 251,
    ["drone.json"] = 252,
    ["dss-2.0.0.json"] = 254,
    ["dstack configuration"] = 255,
    ["dvc.yaml"] = 256,
    ["ecosystem.json"] = 261,
    eksctl = 262,
    ["electron-builder configuration file"] = 269,
    ["epr-manifest.json"] = 267,
    ["evcc.yaml"] = 270,
    ["ezd task runner"] = 280,
    ["fabric.mod.json"] = 282,
    ["first-timers-bot"] = 288,
    ...
    ["gitlab-ci"] = 315,
    ["global.json"] = 330,
    ["go-feature-flag Flag Configuration"] = 333,
    ["haxelib.json"] = 348,
    helmfile = 770,
    helmwave = 771,
    ["host-meta.json"] = 353,
    ...
    ["ide.host.json"] = 360,
    ["ifstate.conf"] = 361,
    ["imageoptimizer.json"] = 362,
    ["importmap.json"] = 365,
    ["ioBroker Configuration"] = 367,
    ["ioBroker JSON UI"] = 368,
    ["ioBroker Package manifest"] = 369,
    ["ize.toml"] = 863,
    ["jsconfig.json"] = 392,
    ["jscpd Configuration"] = 848,
    jsdoc = 766,
    ["k3d.yaml"] = 393,
    ["k9s aliases.yaml"] = 395,
    ["k9s cluster-config.yaml"] = 397,
    ["k9s config.yaml"] = 396,
    ["k9s hotkeys.yaml"] = 398,
    ["k9s plugins.yaml"] = 399,
    ["k9s skin.yaml"] = 400,
    ["k9s views.yaml"] = 401,
    ["kontinuous-config.yaml"] = 409,
    ["kontinuous-values.yaml"] = 408,
    ["kustomization.yaml"] = 411,
    ["label-commenter-config.yml"] = 412,
    ["latexindent configuration"] = 61,
    ["launchsettings.json"] = 413,
    lazydocker = 885,
    lazygit = 884,
    ["lego.json"] = 415,
    ["lerna.json"] = 416,
    ["lgtm.yml"] = 417,
    ["liblab.config.json"] = 418,
    ["libman.json"] = 419,
    ["license-report-config.json"] = 420,
    ["linkinator.config.json"] = 422,
    ["lint-staged (.lintstagedrc)"] = 746,
    ["local.settings.json"] = 427,
    ["localazy.json"] = 428,
    ["lotus.yaml"] = 426,
    ["lsdlschema.json"] = 429,
    ["markdown-link-check"] = 807,
    mboats = 814,
    ["micro-settings.json"] = 878,
    ["mimetypes.json"] = 440,
    ["mirrord config"] = 747,
    mise = 748,
    ["mkdocs.yml"] = 460,
    ["monospace.yml"] = 462,
    ["moon.yml"] = 957,
    ["mprocs Configuration file"] = 930,
    ["mta.yaml"] = 749,
    ["mtad.yaml"] = 750,
    ["mycode.json"] = 469,
    ["napari plugin manifest"] = 470,
    neoload = 761,
    ["nest-cli"] = 475,
    ["ninjs (News in JSON)"] = 474,
    ["nitro.json"] = 760,
    ["nixd configuration"] = 902,
    ["nlu.json"] = 476,
    ["nodemon.json"] = 478,
    ["noodl config"] = 813,
    ["notebook.mod.json"] = 479,
    now = 756,
    ["npm-badges"] = 482,
    ["nswag.json"] = 486,
    ntangle = 488,
    ["nuclei-template.yaml"] = 483,
    ["nuget-project.json"] = 484,
    ["ocelot.json"] = 490,
    ["omnisharp.json"] = 493,
    ["openapi.json"] = 494,
    ["openfin.json"] = 501,
    ...
    ["ops.yaml"] = 498,
    ["package.json"] = 520,
    ["package.manifest"] = 521,
    ["partial-black.json"] = 91,
    ["pathfinder.yml"] = 524,
    ["pattern.json"] = 527,
    ["petstore-v1.0"] = 858,
    pgap_yaml_input_reader = 526,
    ["pixi.toml"] = 528,
    ["plagiarize-me.yaml"] = 532,
    ["plagiarize.yaml"] = 531,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 960,
    ["podbard.yaml"] = 534,
    ["portman.json"] = 535,
    ["prefect.toml"] = 543,
    ["prettierrc.json"] = 544,
    ["prisma.yml"] = 545,
    ["project-1.0.0-beta3.json"] = 548,
    ["project-1.0.0-beta4.json"] = 549,
    ["project-1.0.0-beta5.json"] = 550,
    ["project-1.0.0-beta6.json"] = 551,
    ["project-1.0.0-beta8.json"] = 552,
    ["project-1.0.0-rc1.json"] = 553,
    ["project-1.0.0-rc2.json"] = 554,
    ["project.json"] = 547,
    ["prometheus.json"] = 555,
    ["prometheus.rules.json"] = 556,
    ["prometheus.rules.test.json"] = 557,
    ["proxies.json"] = 558,
    ["publiccode.yml"] = 559,
    ["pubspec.yaml"] = 560,
    ["pyrseas-0.8.json"] = 563,
    ["quilt.mod.json"] = 879,
    ["rc3 auth"] = 572,
    ["rc3 collection"] = 573,
    ["rc3 environment"] = 574,
    ...
    samt = 596,
    samtrc = 597,
    ["sarif-1.0.0.json"] = 599,
    ["sarif-2.0.0.json"] = 600,
    ["sarif-2.1.0"] = 610,
    ["sarif-2.1.0-rtm.2"] = 601,
    ["sarif-2.1.0-rtm.3"] = 603,
    ["sarif-2.1.0-rtm.4"] = 605,
    ["sarif-2.1.0-rtm.5"] = 607,
    ["sarif-2.1.0-rtm.6"] = 608,
    ["sarif-external-property-file-2.1.0"] = 611,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 602,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 604,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 606,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 609,
    ["schema.org - Action"] = 613,
    ["schema.org - ContactPoint"] = 614,
    ["schema.org - Place"] = 615,
    ["schema.org - Thing"] = 616,
    ["secrethub.yml"] = 881,
    ["semantic-release"] = 622,
    ["servicehub.config.json"] = 741,
    ["servicehub.service.json"] = 740,
    ["settings.job"] = 625,
    ["sfdx-hardis configuration"] = 627,
    ["shard.yml"] = 917,
    ["size-limit configuration"] = 632,
    ["skaffold.yaml"] = 805,
    ["skyuxconfig.json"] = 634,
    snapcraft = 635,
    ["spicepod.yaml"] = 937,
    ["sqlc configuration"] = 646,
    ["stripe-app-local.json"] = 655,
    ["stripe-app.json"] = 654,
    swcrc = 791,
    ["task.json"] = 661,
    taskcat = 757,
    ["template.json"] = 666,
    ["templatsources.json"] = 667,
    ["theme.json"] = 670,
    ["tizen_workspace.json"] = 671,
    tldr = 672,
    tmuxinator = 744,
    ["transcend.yml"] = 679,
    ["tree-sitter grammar.json"] = 338,
    ["trime.yaml"] = 680,
    ["trunk.yaml"] = 682,
    ["ts-force-config.json"] = 687,
    ["tsconfig.json"] = 683,
    ["tsd.json"] = 684,
    ["tsdoc.json"] = 685,
    ["tsdrc.json"] = 686,
    ...
    v8r = 724,
    vcluster = 924,
    ["vcpkg configuration file"] = 176,
    ["vcpkg manifest file"] = 175,
    ["vega-lite.json"] = 706,
    ["vega.json"] = 705,
    ["venvironment-basic.yaml"] = 709,
    ["venvironment.yaml"] = 708,
    ["version.json"] = 711,
    ["vhwdebugger-binding.yaml"] = 713,
    ["vim-addon-info"] = 714,
    ["vs-2017.3.host.json"] = 716,
    ["vs-nesting.json"] = 717,
    ["vsls.json"] = 715,
    ["vss-extension.json"] = 721,
    ["vtesttree.yaml"] = 722,
    ["vtestunit.yaml"] = 723,
    ["warp-keysets.json"] = 887,
    ["warp-themes.json"] = 888,
    ["warp-workflows.json"] = 889,
    ["webhint.io"] = 844,
    ["webjobpublishsettings.json"] = 728,
    ["webjobs-list.json"] = 727,
    ["well-known-fursona"] = 925,
    ["xs-app.json"] = 753,
    ["xunit.runner.json"] = 739,
    yamllint = 779,
    ["zerops.io import file"] = 934,
    ["zerops.yml"] = 933,
    zuul = 763,
    ["Žinoma"] = 773
  },
