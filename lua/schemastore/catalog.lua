...
M.json = {
  ...
  index = {
    ...
    ["<div>RIOTS' studio configuration"] = 700,
    ...
    ["Adobe UXP Manifest"] = 885,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Airplane task"] = 17,
    ["Alacritty Configuration"] = 792,
    ["All Contributors configuration file"] = 850,
    ...
    ["BX CI"] = 104,
    ["Bashly (bashly.yml)"] = 854,
    ["Bashly Settings (bashly-settings.yml)"] = 855,
    ["Better Code Hub"] = 764,
    ["Better Scripts"] = 105,
    Bigconfig = 81,
    BizTalkServerApplicationSchema = 734,
    Bleep = 106,
    ...
    ["Butane Config"] = 805,
    ["CGS Custom Card Game (CardGameDef.json)"] = 890,
    ["CICS TS region tagging"] = 814,
    ["CICS TS resource import"] = 815,
    ["CICS TS resource model"] = 816,
    ["CICS TS resource overrides"] = 817,
    ["CMake Presets"] = 107,
    ["CNC Codes"] = 121,
    ["CRS WAF test file"] = 919,
    ["CRS WAF test platform overrides file"] = 920,
    ...
    CityJSON = 117,
    ["Clawject config"] = 126,
    ["Cloud Foundry Application Manifest"] = 902,
    ["Cloud Run Spec v1"] = 924,
    ...
    Concord = 918,
    ["Configu .cfgu files"] = 907,
    ["Configu .configu file"] = 908,
    Conjure = 120,
    ["Container Structure Test"] = 747,
    Containerlab = 772,
    ["Crowdsec collection config"] = 210,
    ["Crowdsec parser config"] = 211,
    ["Crowdsec scenario config"] = 212,
    ["CumulusCI Config"] = 125,
    ["Custom Machinery Machine"] = 891,
    ["Custom Machinery Recipe"] = 892,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 862,
    ["EAS config"] = 276,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 851,
    ...
    ["Goreleaser Pro"] = 333,
    Goss = 334,
    ["Gradle Build Cache Node"] = 762,
    ["Gradle Enterprise"] = 761,
    ...
    Hadolint = 743,
    Hammerkit = 771,
    ["Hardware Sentry Configuration"] = 825,
    Hatch = 744,
    Hayson = 347,
    ...
    ["JFrog File Spec"] = 375,
    ["JFrog Pipelines YML DSL"] = 834,
    ["JMeter DSL cli config"] = 376,
    JReleaser = 378,
    ["JSON Document Transform"] = 386,
    ["JSON Feed"] = 387,
    ["JSON Resume"] = 566,
    ["JSON Schema Draft 2020-12"] = 713,
    ["JSON Schema Draft 4"] = 710,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 872,
    ["JSON Schema Draft 7"] = 711,
    ["JSON Schema Draft 7 (unofficial strict)"] = 873,
    ["JSON Schema Draft 8 (2019-09)"] = 712,
    ["JSON-API"] = 385,
    ["JSON-WF"] = 901,
    ["JSON-e templates"] = 769,
    ["JSON-stat 2.0"] = 707,
    JSONPatch = 389,
    ...
    ["Keycloak REST API"] = 842,
    ["Knative Functions - func.yaml"] = 295,
    ["KoDE/CI build.yaml"] = 830,
    ["Kong DBLess config"] = 831,
    KrakenD = 396,
    ...
    ["Microsoft RulesEngine workflow rules"] = 915,
    ["Microsoft RulesEngine workflow rules list"] = 916,
    ["Minecraft Custom Main Menu Mod"] = 880,
    ...
    ["MongoDB Atlas Search Index Definition"] = 829,
    ["Monika Configuration"] = 827,
    ["Monoweave Configuration"] = 455,
    ["Motif config"] = 727,
    ["NOX Framework (Service)"] = 472,
    ["Netin Diagnostic System Template"] = 787,
    ["Netlify config"] = 463,
    ...
    ["OpenUtau ustx"] = 485,
    ["OpenWeather Current Weather API"] = 768,
    ["OpenWeather Road Risk API"] = 767,
    ...
    ["Pipeline component"] = 779,
    ["PocketMine plugin.yml"] = 511,
    ["Postman collection"] = 516,
    ["Problem object RFC9457"] = 877,
    ...
    Qgoda = 548,
    Qodana = 797,
    ["Qt Creator workspace file"] = 909,
    ["Quali Torque Blueprint Spec 2"] = 822,
    ["QueryFirst config file"] = 845,
    ["RKE Cluster Configuration JSON"] = 776,
    ["RKE Cluster Configuration YAML"] = 775,
    ["Rancher Fleet"] = 542,
    ["Rattler-build"] = 549,
    Ray = 742,
    ["Read the Docs"] = 544,
    ...
    ["Render Blueprints"] = 774,
    RenderCV = 568,
    Renovate = 567,
    ["Replit config"] = 562,
    RoadRunner = 569,
    ["Rudder techniques"] = 883,
    Ruff = 564,
    ["Rust Project"] = 565,
    ["Rust toolchain"] = 573,
    ...
    ["Shopware CLI Project Store Configuration"] = 796,
    Sigma = 606,
    ["Sigrid scope configuration file"] = 607,
    ["SkyPilot Task JSON"] = 884,
    ...
    StackBlitz = 627,
    ["StackHawk Scanner Configuration"] = 790,
    Stale = 628,
    ["Starlake Data Pipeline"] = 765,
    Starship = 629,
    ["Statamic Blueprint"] = 630,
    ["Stella configuration file"] = 631,
    ["StrmPrivacy Data Connector"] = 839,
    ["StrmPrivacy Data Contract"] = 840,
    ["StrmPrivacy SimpleSchema"] = 837,
    ["StrmPrivacy Stream"] = 838,
    ["StrmPrivacy batch job configuration file"] = 836,
    ["Stryker Mutator"] = 634,
    ["StyleCop Analyzers Configuration"] = 635,
    ["Stylelint (.stylelintrc)"] = 636,
    ["Sublime Syntax"] = 841,
    ["Subsquid squid manifest"] = 886,
    ["Swagger API 2.0"] = 638,
    TSON = 665,
    TSTyche = 666,
    Talhelper = 640,
    ...
    Tycho = 922,
    Tye = 798,
    ["UET BuildConfig.json"] = 846,
    ["UI5 Manifest"] = 675,
    ["UNCORS configuration"] = 679,
    ["UTAM Page Object"] = 678,
    ["Ubuntu Server Autoinstall"] = 673,
    ["Uniswap Token List"] = 753,
    ["Unreal Engine Uplugin"] = 847,
    ["Unreal Engine Uproject"] = 848,
    ["Updatecli Compose"] = 806,
    ["Updatecli Policy Manifest"] = 807,
    ["Updatecli Policy Metadata"] = 808,
    Uplift = 844,
    ["User Journey Map"] = 773,
    V2Ray = 812,
    ["VSCode Code Snippets"] = 176,
    ["VSIX CLI publishing"] = 695,
    ["Vela Pipeline Configuration"] = 683,
    Vercel = 175,
    Visivo = 874,
    ["Web App Manifest"] = 702,
    ["Web types"] = 705,
    WebExtensions = 701,
    ["Webman package recipe"] = 818,
    ["Windows Package Manager Installer Manifest"] = 750,
    ["Windows Package Manager Locale Manifest"] = 751,
    ["Windows Package Manager Singleton Manifest"] = 749,
    ...
    ["behat.yml"] = 89,
    ["bigquery-table"] = 80,
    ["bioimageio resource description"] = 894,
    ...
    ["lint-staged (.lintstagedrc)"] = 721,
    ["local.settings.json"] = 419,
    ["localazy.json"] = 420,
    ["lotus.yaml"] = 418,
    ["lsdlschema.json"] = 421,
    ["markdown-link-check"] = 782,
    mboats = 789,
    ["micro-settings.json"] = 858,
    ["mimetypes.json"] = 432,
    ["mirrord config"] = 722,
    mise = 723,
    ["mise-settings"] = 724,
    ...
    ["servicehub.config.json"] = 716,
    ["servicehub.service.json"] = 715,
    ["settings.job"] = 603,
    ...
    ["vega-lite.json"] = 682,
    ["vega.json"] = 681,
    ["venvironment-basic.yaml"] = 685,
    ["venvironment.yaml"] = 684,
    ["version.json"] = 686,
    ["vhwdebugger-binding.yaml"] = 688,
    ["vim-addon-info"] = 689,
    ["vs-2017.3.host.json"] = 691,
    ["vs-nesting.json"] = 692,
    ["vsls.json"] = 690,
    ["vss-extension.json"] = 696,
    ["vtesttree.yaml"] = 697,
    ["vtestunit.yaml"] = 698,
    ["warp-keysets.json"] = 867,
    ["warp-themes.json"] = 868,
    ["warp-workflows.json"] = 869,
    ["webhint.io"] = 819,
    ["webjobpublishsettings.json"] = 704,
    ["webjobs-list.json"] = 703,
    ["well-known-fursona"] = 905,
    ["xs-app.json"] = 729,
    ["xunit.runner.json"] = 714,
    yamllint = 754,
    ["zerops.io import file"] = 914,
    ["zerops.yml"] = 913,
    zuul = 738,
    ["Žinoma"] = 748
  },
