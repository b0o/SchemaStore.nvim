...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 815,
    [".nodehawkrc"] = 509,
    [".npmpackagejsonlintrc"] = 513,
    [".omletrc"] = 991,
    [".phrase.yml"] = 575,
    [".phraseapp.yml"] = 576,
    [".pmbot.yml"] = 563,
    [".postcssrc"] = 570,
    [".powerpages-web-template-manifest"] = 572,
    [".pre-commit-config.yml"] = 573,
    [".pre-commit-hooks.yml"] = 574,
    [".putout.json"] = 603,
    [".rehyperc"] = 626,
    [".remarkrc"] = 630,
    [".sprite files"] = 697,
    ...
    ["A micro editor config"] = 461,
    ABCInventoryModuleData = 18,
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1035,
    ["API Builder"] = 850,
    ["AVA Configuration"] = 912,
    ...
    ["Adobe UXP Manifest"] = 974,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1063,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 884,
    ["All Contributors configuration file"] = 937,
    ...
    ["Application list for a WinUtil"] = 1017,
    ArchitectFX = 1022,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure Pipelines"] = 77,
    ["Azure Static Web Apps CLI configuration file"] = 701,
    ["Azure Static Web Apps configuration file"] = 700,
    ["BOSH Deploy Config"] = 101,
    ["BX CI"] = 119,
    ["Bashly (bashly.yml)"] = 941,
    ["Bashly Settings (bashly-settings.yml)"] = 942,
    ["Better Code Hub"] = 854,
    ["Better Scripts"] = 120,
    Bigconfig = 94,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1028,
    BizTalkServerApplicationSchema = 822,
    Bleep = 121,
    ...
    ["Butane Config"] = 897,
    C4InterFlow = 1043,
    ["CGS Card Game Specification (cgs.json)"] = 979,
    ["CICS TS region tagging"] = 906,
    ["CICS TS resource import"] = 907,
    ["CICS TS resource model"] = 908,
    ["CICS TS resource overrides"] = 909,
    ["CMake Presets"] = 122,
    ["CNC Codes"] = 141,
    ["CRS WAF test file"] = 1007,
    ["CRS WAF test platform overrides file"] = 1008,
    ...
    ["Chamaleon environment"] = 1032,
    ["Chamaleon properties"] = 1033,
    ["Chamaleon template"] = 1031,
    Changesets = 224,
    Charmcraft = 131,
    Cheatsheets = 894,
    ...
    CityJSON = 136,
    ["Clawject config"] = 147,
    ["Cloud Foundry Application Manifest"] = 990,
    ["Cloud Run Spec v1"] = 1012,
    ...
    Concord = 1006,
    ["Configu .cfgu files"] = 995,
    ["Configu .configu file"] = 996,
    Conjure = 140,
    ["Container Structure Test"] = 836,
    Containerlab = 863,
    ["Contextive Glossary"] = 1058,
    Convex = 139,
    ["Crowdsec collection config"] = 234,
    ["Crowdsec parser config"] = 235,
    ["Crowdsec scenario config"] = 236,
    ["CumulusCI Config"] = 146,
    ["Custom Machinery Machine"] = 980,
    ["Custom Machinery Recipe"] = 981,
    ...
    ["DataYoga Job"] = 152,
    ["Databricks Asset Bundles"] = 958,
    ["Datadog Service Definition"] = 434,
    ["Datadog Software Catalog"] = 435,
    ["Datahub Ingestion Recipe"] = 913,
    ["Dein Config"] = 158,
    ...
    ["DonateCaseBetterCasino menu"] = 1036,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 949,
    ["EAS config"] = 300,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 938,
    ["EasyVCR .NET"] = 301,
    ["Eidolon Resource"] = 1023,
    ...
    ["GeoJSON.json latest"] = 901,
    GherKing = 905,
    ["GitHub Action"] = 331,
    ["GitHub Actions typing"] = 1019,
    ...
    ["Google Digital Assetlinks"] = 1059,
    Goreleaser = 359,
    ["Goreleaser Pro"] = 360,
    Goss = 361,
    ["Gradle Build Cache Node"] = 852,
    ["Gradle Enterprise"] = 851,
    ...
    Hadolint = 832,
    Hammerkit = 862,
    ["Hardware Sentry Configuration"] = 917,
    Hatch = 833,
    Hayson = 374,
    ...
    ["Homer dashboard configuration"] = 377,
    Hugo = 893,
    ["Hugo Theme"] = 892,
    ["Hyperfoil benchmark configuration"] = 383,
    ["IBM Zapp document"] = 384,
    ["IBM zCodeFormatSettings"] = 385,
    ["IMG Catapult PSP"] = 390,
    ["IVMS101 by CODE Protocol"] = 977,
    Infrahub = 392,
    Istanbul = 920,
    ["JDownloader2 crawler multi-rules"] = 402,
    ["JDownloader2 crawler single-rules"] = 401,
    ["JFrog Applications Config"] = 403,
    ["JFrog File Spec"] = 404,
    ["JFrog Pipelines YML DSL"] = 926,
    ["JMeter DSL cli config"] = 405,
    JReleaser = 407,
    ["JSON Document Transform"] = 415,
    ["JSON Feed"] = 416,
    ["JSON Resume"] = 635,
    ["JSON Schema Draft 2020-12"] = 801,
    ["JSON Schema Draft 4"] = 798,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 959,
    ["JSON Schema Draft 7"] = 799,
    ["JSON Schema Draft 7 (unofficial strict)"] = 960,
    ["JSON Schema Draft 8 (2019-09)"] = 800,
    ["JSON-API"] = 414,
    ["JSON-e templates"] = 859,
    ["JSON-stat 2.0"] = 794,
    JSONPatch = 418,
    ["JSR Package Config (jsr.json)"] = 408,
    Jasmine = 396,
    Jekyll = 397,
    ["Jenkins X Pipelines"] = 398,
    ["Jenkins X Requirements"] = 399,
    Jest = 400,
    ["Jovo Language Models"] = 406,
    ["KIMMDY config file"] = 429,
    ["KODE/CI build.yaml"] = 922,
    ["KSP-AVC"] = 795,
    ["KSP-CKAN"] = 796,
    ["KSP-NetKAN"] = 797,
    KSY = 989,
    ...
    Kas = 421,
    ["Kestra flow file"] = 430,
    ["Keycloak REST API"] = 929,
    ["Knative Functions - func.yaml"] = 320,
    ["Kometa (nightly) config file"] = 432,
    ["Kometa config file"] = 431,
    ["Kong DBLess config"] = 923,
    KrakenD = 433,
    ["Kubri Configuration"] = 439,
    LOOBin = 454,
    ...
    ["Language configuration"] = 999,
    Lefthook = 443,
    ["Liferay client-extension.yaml"] = 450,
    ["LinkML Metamodel"] = 452,
    Liquibase = 868,
    ["Liquibase Flow File"] = 869,
    ["Lively Properties"] = 453,
    ["Lobe AI Agent"] = 75,
    Loki = 76,
    ["MLOS Configs"] = 492,
    ["MS2Rescore Configuration"] = 495,
    ["Madness (madness.yml)"] = 940,
    ["MapEHR Mapping"] = 460,
    Markdownlint = 872,
    ["Mason Registry"] = 875,
    ["MegaLinter configuration"] = 462,
    ["MegaLinter descriptor"] = 463,
    Melange = 967,
    ["Meltano project definition"] = 464,
    ["Mergify Configuration"] = 496,
    ["Metadata for a Bazel module"] = 465,
    ["Metadata for a Cinnamon spice"] = 1015,
    ["Metatype Configuration"] = 466,
    ["MetricsHub Configuration"] = 467,
    ["MetricsHub Connector Configuration"] = 468,
    ["Micro Editor Syntax"] = 950,
    ["Microsoft Band Web Tile"] = 469,
    ["Microsoft RulesEngine workflow rules"] = 1003,
    ["Microsoft RulesEngine workflow rules list"] = 1004,
    ["Minecraft Custom Main Menu Mod"] = 968,
    ["Minecraft Data Pack Advancement"] = 471,
    ["Minecraft Data Pack Biome"] = 472,
    ["Minecraft Data Pack Configured Carver"] = 473,
    ["Minecraft Data Pack Damage Type"] = 474,
    ["Minecraft Data Pack Dimension"] = 476,
    ["Minecraft Data Pack Dimension Type"] = 475,
    ["Minecraft Data Pack Item Modifier"] = 477,
    ["Minecraft Data Pack Loot Table"] = 478,
    ["Minecraft Data Pack Metadata"] = 479,
    ["Minecraft Data Pack Predicate"] = 480,
    ["Minecraft Data Pack Recipe"] = 481,
    ["Minecraft Data Pack Tag"] = 482,
    ["Minecraft Data Pack Template Pool"] = 483,
    ["Minecraft Data Pack Trim Material"] = 488,
    ["Minecraft Data Pack Trim Pattern"] = 489,
    ["Minecraft Resource Pack Lang"] = 484,
    ["Minecraft Resource Pack Particle"] = 485,
    ["Minecraft Resource Pack Texture Mcmeta"] = 487,
    ["Minecraft Resourcepack Sounds"] = 486,
    ["Monade CLI Stack Configuration"] = 499,
    ["MongoDB Atlas Search Index Definition"] = 921,
    ["Monika Configuration"] = 919,
    ["Monoweave Configuration"] = 494,
    ["Motif config"] = 814,
    MultiQC = 1052,
    ["NOX Framework (Service)"] = 512,
    ["Netin Diagnostic System Template"] = 879,
    ["Netlify config"] = 502,
    ["Network-as-Code Data Model"] = 503,
    ["Nightwatch.js"] = 505,
    ["Node.js configuration"] = 819,
    ["NueJS configuration file"] = 517,
    ["Nuitka.yaml"] = 982,
    ["Nullstone config"] = 519,
    ["ONe's changelog entry"] = 533,
    ["ONe's service descriptor"] = 532,
    ["ORT Server repository environment configuration"] = 540,
    ["OSCAL Assessment Plan (AP)"] = 542,
    ["OSCAL Assessment Results (AR)"] = 543,
    ["OSCAL Catalog"] = 544,
    ["OSCAL Component Definition (CDef)"] = 545,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 546,
    ["OSCAL Profile"] = 547,
    ["OSCAL System Security Plan (SSP)"] = 548,
    ["OSS Review Toolkit configuration"] = 549,
    ["OSS Review Toolkit curation"] = 550,
    ["OSS Review Toolkit package configuration"] = 551,
    ["OSS Review Toolkit repository configuration"] = 552,
    ["OSS Review Toolkit resolutions"] = 553,
    ["October CMS columns"] = 523,
    ["October CMS fields"] = 524,
    Okteto = 525,
    Opctl = 817,
    ["Open Data Contract Standard (ODCS)"] = 536,
    ["Open Know-How"] = 1057,
    ["OpenRewrite Resource"] = 535,
    ["OpenUtau character yaml"] = 529,
    ["OpenUtau ustx"] = 530,
    ["OpenWeather Current Weather API"] = 858,
    ["OpenWeather Road Risk API"] = 857,
    ["Ory Hydra configuration"] = 382,
    ["Ory Keto configuration"] = 436,
    ["Ory Kratos configuration"] = 541,
    ["Ory Oathkeeper configuration"] = 521,
    ["Outblocks App configuration"] = 538,
    ["Outblocks database table"] = 539,
    ["Outblocks project configuration"] = 537,
    PDM = 559,
    Packer = 556,
    Pantsbuild = 936,
    ["Paper paper-plugin.yml"] = 557,
    ["Pipeline component"] = 870,
    ["Platform.sh application"] = 2,
    ["Platform.sh routes"] = 3,
    ["Platform.sh services"] = 4,
    ["Plex Prerolls"] = 567,
    ["PocketMine plugin.yml"] = 564,
    ["Postman collection"] = 571,
    ["Preset list for a WinUtil"] = 1018,
    ["ProActions AI-Kit Configuration"] = 580,
    ["ProActions AI-Kit Configuration for Menus"] = 582,
    ["ProActions AI-Kit Configuration for Sections"] = 584,
    ["ProActions AI-Kit Configuration for Services"] = 581,
    ["ProActions AI-Kit Configuration for Steps"] = 585,
    ["ProActions AI-Kit Configuration for Templates"] = 583,
    ["Problem object RFC9457"] = 965,
    ["Problem package generators"] = 586,
    Pterodactyl = 916,
    ["Pull Request Labeler"] = 602,
    Pulumi = 610,
    ["PyGTA Config"] = 606,
    PyProject = 611,
    Pylock = 1060,
    Pyright = 612,
    ["Python script metadata"] = 1054,
    Qgoda = 614,
    Qodana = 889,
    ["Qt Creator workspace file"] = 997,
    ["Quali Torque Blueprint Spec 2"] = 914,
    ["QueryFirst config file"] = 932,
    ["RKE Cluster Configuration JSON"] = 867,
    ["RKE Cluster Configuration YAML"] = 866,
    RadioHound = 605,
    Railway = 615,
    ["Rancher Fleet"] = 607,
    ["Rattler-build"] = 616,
    Ray = 831,
    ["Read the Docs"] = 609,
    ["Red-DiscordBot Cog"] = 623,
    ["Red-DiscordBot Cog Repo"] = 624,
    ["Red-DiscordBot Trivia"] = 625,
    ["Render Blueprints"] = 865,
    RenderCV = 637,
    Renovate = 636,
    ["Replit config"] = 631,
    Restate = 1047,
    RoadRunner = 639,
    ["Rudder techniques"] = 972,
    Ruff = 633,
    ["Rust Project"] = 634,
    ["Rust toolchain"] = 643,
    ["SDMX data message"] = 669,
    ["SDMX metadata message"] = 668,
    ["SDMX structure message"] = 667,
    ["SIL Kit Participant Configuration"] = 679,
    ["SIL Kit Registry Configuration"] = 680,
    ["SPDX 2.3"] = 698,
    SWADL = 712,
    ["Safebox Config"] = 927,
    ["Sapphire CLI Config"] = 646,
    ["SauceCTL Configuration"] = 876,
    ["Schema Catalog"] = 661,
    ["Scoop manifest"] = 666,
    ["Semantic Data Fabric (SDF) file"] = 670,
    ["Semgrep Rule"] = 672,
    ["Serenity Code Generator (Sergen)"] = 673,
    ["Serverless Framework Configuration"] = 883,
    ["Serverless Workflow"] = 885,
    ["Settings for a Cinnamon spice"] = 1014,
    ["Settings.paf"] = 675,
    ["Shopware 6 Configuration"] = 886,
    ["Shopware CLI Extension Store Configuration"] = 887,
    ["Shopware CLI Project Store Configuration"] = 888,
    ["Sigma Detection Rule"] = 677,
    ["Sigrid scope configuration file"] = 678,
    ["SkyPilot Task JSON"] = 973,
    ["Slack app manifest"] = 682,
    Solidarity = 687,
    ["Solution filters"] = 688,
    ["Source Maps v3"] = 689,
    Sourcery = 690,
    ["Speakeasy Generation Config File"] = 694,
    ["Speakeasy Lint Configuration File"] = 691,
    ["Speakeasy Test Generation Configuration File"] = 692,
    ["Speakeasy Workflow File"] = 693,
    SpecIF = 695,
    ["Sponge Mixin configuration"] = 696,
    StackBlitz = 702,
    ["StackHawk Scanner Configuration"] = 882,
    Stale = 703,
    ["Starlake Data Pipeline"] = 855,
    Starship = 704,
    ["Statamic Blueprint"] = 705,
    ["Stella configuration file"] = 706,
    ["Stryker Mutator"] = 709,
    ["StyleCop Analyzers Configuration"] = 710,
    ["Stylelint (.stylelintrc)"] = 711,
    ["Stylua Config"] = 1061,
    ["Sublime Syntax"] = 928,
    ["Subsquid squid manifest"] = 975,
    ["Swagger API 2.0"] = 713,
    ["Synadia Connect Component"] = 714,
    TSON = 748,
    TSTyche = 749,
    ["Tab data for a LinUtil"] = 1021,
    ["Tab list for a LinUtil"] = 1020,
    Tach = 715,
    ["Tach Domain"] = 716,
    Talhelper = 718,
    ["Talisman configuration"] = 719,
    Taplo = 1062,
    ["Taskfile config"] = 860,
    Taurus = 720,
    Tauticord = 721,
    Telefonistka = 1048,
    ["TestEnvironment.json"] = 731,
    ["TextMate Grammar"] = 730,
    ["Tier.run pricing.json"] = 724,
    Tikibase = 725,
    Tombi = 729,
    ["Traefik v2"] = 734,
    ["Traefik v2 File Provider"] = 735,
    ["Traefik v3"] = 736,
    ["Traefik v3 File Provider"] = 737,
    ["Travis CI (.travis.yml)"] = 733,
    Trident = 1045,
    ["TrueScript for *.tscript files"] = 740,
    ["Tugboat QA config.yml"] = 1042,
    TunnelHub = 963,
    Turborepo = 732,
    Tycho = 1010,
    Tye = 890,
    ["Tyk Gateway - Open Source v5.7+"] = 1053,
    ["Typst Manifest"] = 754,
    ["UET BuildConfig.json"] = 933,
    ["UI5 Manifest"] = 760,
    ["UNCORS configuration"] = 764,
    ["UTAM Page Object"] = 763,
    ["Ubuntu Server Autoinstall"] = 758,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1046,
    ["Uniswap Token List"] = 843,
    ["Universal Schedule Format"] = 765,
    ["Unreal Engine Uplugin"] = 934,
    ["Unreal Engine Uproject"] = 935,
    ["Updatecli Compose"] = 898,
    ["Updatecli Policy Manifest"] = 899,
    ["Updatecli Policy Metadata"] = 900,
    Uplift = 931,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 864,
    V2Ray = 904,
    ["VSCode Code Snippets"] = 199,
    ["VSIX CLI publishing"] = 783,
    Vector = 767,
    ["Vela Pipeline Configuration"] = 770,
    Vercel = 198,
    ["Version Bumper config"] = 773,
    ["Viash Component Config"] = 1050,
    ["Viash Package Config"] = 1051,
    Visivo = 961,
    Wake = 1044,
    ["Waku Config"] = 1024,
    ["Web App Manifest"] = 789,
    ["Web types"] = 792,
    WebExtensions = 788,
    ["Webman package recipe"] = 910,
    ["Windows Package Manager Installer Manifest"] = 839,
    ["Windows Package Manager Locale Manifest"] = 840,
    ["Windows Package Manager Singleton Manifest"] = 838,
    Winutil = 841,
    ["WireMock stub mapping"] = 1027,
    ["Woodpecker pipeline config"] = 878,
    ["Wrangler CLI"] = 793,
    ["Xstate Machine"] = 896,
    ["Yandex Workflow Language"] = 1016,
    ["Yarn Config (.yarnrc.yml)"] = 853,
    ["Yippee-Ki-JSON configuration YML"] = 845,
    ["YouTrack App"] = 1013,
    ["Zerops.io config"] = 1001,
    ["Zerops.io import"] = 1002,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 966,
    ...
    ["behat.yml"] = 103,
    ["bigquery-table"] = 93,
    ["bioimageio resource description"] = 983,
    ...
    ["crowdin.yml"] = 233,
    ["ctfd-setup configuration file"] = 1034,
    ["custom-elements.json"] = 953,
    ["cypress.json"] = 237,
    ...
    ["gematik health care insurance list"] = 1040,
    ["gematik health care patient list"] = 1037,
    ["gematik health care provider institution list"] = 1039,
    ["gematik health care provider list"] = 1038,
    ["gematik tiger test environment configuration"] = 1041,
    ["gitlab-ci"] = 339,
    ["global.json"] = 355,
    ...
    ["ide.host.json"] = 386,
    ["ifstate.conf"] = 387,
    ["imageoptimizer.json"] = 388,
    ["importmap.json"] = 391,
    ["ioBroker Configuration"] = 393,
    ["ioBroker JSON UI"] = 394,
    ["ioBroker Package manifest"] = 395,
    ["ize.toml"] = 930,
    ["jsconfig.json"] = 419,
    ["jscpd Configuration"] = 915,
    jsdoc = 830,
    ["k3d.yaml"] = 420,
    ["k9s aliases.yaml"] = 422,
    ["k9s cluster-config.yaml"] = 424,
    ["k9s config.yaml"] = 423,
    ["k9s hotkeys.yaml"] = 425,
    ["k9s plugins.yaml"] = 426,
    ["k9s skin.yaml"] = 427,
    ["k9s views.yaml"] = 428,
    ["kontinuous-config.yaml"] = 438,
    ["kontinuous-values.yaml"] = 437,
    ["kustomization.yaml"] = 440,
    ["label-commenter-config.yml"] = 441,
    ["latexindent configuration"] = 74,
    ["launchsettings.json"] = 442,
    lazydocker = 952,
    lazygit = 951,
    ["lego.json"] = 444,
    ["lerna.json"] = 445,
    ["lgtm.yml"] = 446,
    ["liblab.config.json"] = 447,
    ["libman.json"] = 448,
    ["license-report-config.json"] = 449,
    ["linkinator.config.json"] = 451,
    ["lint-staged (.lintstagedrc)"] = 809,
    ["local.settings.json"] = 456,
    ["localazy.json"] = 457,
    ["lotus.yaml"] = 455,
    ["lsdlschema.json"] = 458,
    ["markdown-link-check"] = 873,
    maturin = 874,
    mboats = 881,
    ["micro-settings.json"] = 945,
    ["mimetypes.json"] = 470,
    ["mirrord config"] = 810,
    mise = 811,
    ["mkdocs.yml"] = 490,
    ["monospace.yml"] = 493,
    ["moon.yml"] = 1026,
    ["mprocs Configuration file"] = 998,
    ["mrdocs.yml"] = 491,
    ["mta.yaml"] = 812,
    ["mtad.yaml"] = 813,
    ["mycode.json"] = 500,
    nFPM = 504,
    ["napari plugin manifest"] = 501,
    neoload = 825,
    ["nest-cli"] = 507,
    ["ninjs (News in JSON)"] = 506,
    ["nitro.json"] = 824,
    ["nixd configuration"] = 971,
    ["nlu.json"] = 508,
    ["nodemon.json"] = 510,
    ["noodl config"] = 880,
    ["notebook.mod.json"] = 511,
    now = 820,
    ["npm-badges"] = 514,
    ["nswag.json"] = 518,
    ntangle = 520,
    ["nuclei-template.yaml"] = 515,
    ["nuget-project.json"] = 516,
    ["ocelot.json"] = 522,
    ["omnisharp.json"] = 526,
    ["openapi.json"] = 527,
    ["openfin.json"] = 534,
    ...
    ["ops.yaml"] = 531,
    ["package.json"] = 554,
    ["package.manifest"] = 555,
    ["partial-black.json"] = 104,
    ["pathfinder.yml"] = 558,
    ["pattern.json"] = 561,
    ["petstore-v1.0"] = 925,
    pgap_yaml_input_reader = 560,
    ["pixi.toml"] = 562,
    ["plagiarize-me.yaml"] = 566,
    ["plagiarize.yaml"] = 565,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1030,
    ["podbard.yaml"] = 568,
    ["portman.json"] = 569,
    ["prefect.toml"] = 577,
    ["prettierrc.json"] = 578,
    ["prisma.yml"] = 579,
    ["project-1.0.0-beta3.json"] = 588,
    ["project-1.0.0-beta4.json"] = 589,
    ["project-1.0.0-beta5.json"] = 590,
    ["project-1.0.0-beta6.json"] = 591,
    ["project-1.0.0-beta8.json"] = 592,
    ["project-1.0.0-rc1.json"] = 593,
    ["project-1.0.0-rc2.json"] = 594,
    ["project.json"] = 587,
    ["project.owasp.yaml"] = 595,
    ["prometheus.json"] = 596,
    ["prometheus.rules.json"] = 597,
    ["prometheus.rules.test.json"] = 598,
    ["proxies.json"] = 599,
    ["publiccode.yml"] = 600,
    ["pubspec.yaml"] = 601,
    ["pyrseas-0.8.json"] = 604,
    pytest = 613,
    ["quilt.mod.json"] = 946,
    ["rc3 auth"] = 617,
    ["rc3 collection"] = 618,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 826,
    ["release-please-config.json"] = 627,
    ["release-please-manifest.json"] = 628,
    ["release-plz.toml"] = 629,
    ["renv.lock"] = 638,
    ["rivet.json"] = 970,
    ["rivet.yaml (legacy)"] = 969,
    rockcraft = 640,
    runny = 641,
    rustfmt = 642,
    sake = 1056,
    samt = 644,
    samtrc = 645,
    ["sarif-1.0.0.json"] = 647,
    ["sarif-2.0.0.json"] = 648,
    ["sarif-2.1.0"] = 658,
    ["sarif-2.1.0-rtm.2"] = 649,
    ["sarif-2.1.0-rtm.3"] = 651,
    ["sarif-2.1.0-rtm.4"] = 653,
    ["sarif-2.1.0-rtm.5"] = 655,
    ["sarif-2.1.0-rtm.6"] = 656,
    ["sarif-external-property-file-2.1.0"] = 659,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 650,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 652,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 654,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 657,
    ["scalingo.json configuration"] = 660,
    ["schema.org - Action"] = 662,
    ["schema.org - ContactPoint"] = 663,
    ["schema.org - Place"] = 664,
    ["schema.org - Thing"] = 665,
    ["secrethub.yml"] = 948,
    ["semantic-release"] = 671,
    ["servicehub.config.json"] = 804,
    ["servicehub.service.json"] = 803,
    ["settings.job"] = 674,
    ["sfdx-hardis configuration"] = 676,
    ["shard.yml"] = 986,
    ["size-limit configuration"] = 681,
    ["skaffold.yaml"] = 871,
    ["skyuxconfig.json"] = 683,
    snapcraft = 684,
    ["snowflake-config"] = 685,
    ["snowflake-connections"] = 686,
    ["spicepod.yaml"] = 1005,
    ["sqlc configuration"] = 699,
    ["stripe-app-local.json"] = 708,
    ["stripe-app.json"] = 707,
    swcrc = 856,
    ["task.json"] = 717,
    taskcat = 821,
    ["template.json"] = 722,
    ["templatsources.json"] = 723,
    ["theme.json"] = 726,
    ["tizen_workspace.json"] = 727,
    tldr = 728,
    tmuxinator = 807,
    ["transcend.yml"] = 738,
    ...
    ["vega-lite.json"] = 769,
    ["vega.json"] = 768,
    ["venvironment-basic.yaml"] = 772,
    ["venvironment.yaml"] = 771,
    version = 1049,
    ["version.json"] = 774,
    ["vhwdebugger-binding.yaml"] = 776,
    ["vim-addon-info"] = 777,
    ["vs-2017.3.host.json"] = 779,
    ["vs-nesting.json"] = 780,
    ["vsls.json"] = 778,
    ["vss-extension.json"] = 784,
    vtcfg = 1055,
    ["vtesttree.yaml"] = 785,
    ["vtestunit.yaml"] = 786,
    ["warp-keysets.json"] = 954,
    ["warp-themes.json"] = 955,
    ["warp-workflows.json"] = 956,
    ["webhint.io"] = 911,
    ["webjobpublishsettings.json"] = 791,
    ["webjobs-list.json"] = 790,
    ["well-known-fursona"] = 993,
    ["xs-app.json"] = 816,
    ["xunit.runner.json"] = 802,
    yamllint = 844,
    zuul = 827,
    ["Žinoma"] = 837
  },
