...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 199,
    [".cryproj (generic)"] = 673,
    [".cryproj engine-5.2"] = 668,
    [".cryproj engine-5.3"] = 669,
    [".cryproj engine-5.4"] = 670,
    [".cryproj engine-5.5"] = 671,
    [".cryproj engine-dev"] = 672,
    [".eslintrc"] = 255,
    [".esmrc.json"] = 247,
    [".ffizer.yaml"] = 259,
    [".htmlhintrc"] = 316,
    ...
    [".mtaext"] = 684,
    [".nodehawkrc"] = 427,
    [".npmpackagejsonlintrc"] = 431,
    [".omletrc"] = 859,
    [".phrase.yml"] = 477,
    [".phraseapp.yml"] = 478,
    [".pmbot.yml"] = 467,
    [".postcssrc"] = 472,
    [".powerpages-web-template-manifest"] = 474,
    [".pre-commit-config.yml"] = 475,
    [".pre-commit-hooks.yml"] = 476,
    [".putout.json"] = 497,
    [".rehyperc"] = 516,
    [".remarkrc"] = 518,
    [".sprite files"] = 576,
    ...
    ["<div>RIOTS' studio configuration"] = 651,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 381,
    ABCSupplyPlan = 13,
    AIConfig = 14,
    ["API Builder"] = 716,
    ["AVA Configuration"] = 776,
    ...
    ["Adobe UXP Manifest"] = 841,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 15,
    ["Airplane task"] = 16,
    ["Alacritty Configuration"] = 748,
    ["All Contributors configuration file"] = 806,
    ...
    ["Azure Pipelines"] = 68,
    ["Azure Static Web Apps CLI configuration file"] = 579,
    ["Azure Static Web Apps configuration file"] = 578,
    ["BX CI"] = 106,
    ["Bashly (bashly.yml)"] = 810,
    ["Bashly Settings (bashly-settings.yml)"] = 811,
    ["Better Code Hub"] = 720,
    ["Better Scripts"] = 107,
    Bigconfig = 85,
    BizTalkServerApplicationSchema = 690,
    Bleep = 108,
    ...
    ["Butane Config"] = 761,
    ["CGS Custom Card Game (CardGameDef.json)"] = 846,
    ["CICS TS region tagging"] = 770,
    ["CICS TS resource import"] = 771,
    ["CICS TS resource model"] = 772,
    ["CICS TS resource overrides"] = 773,
    ["CMake Presets"] = 109,
    ["CNC Codes"] = 121,
    ...
    CityJSON = 118,
    ["Clawject config"] = 126,
    ["Cloud Foundry Application Manifest"] = 858,
    ["Code Climate"] = 154,
    CodeCV = 64,
    ...
    ["DataYoga Job"] = 130,
    ["Databricks Asset Bundles"] = 827,
    ["Datadog Service Definition"] = 358,
    ["Datahub Ingestion Recipe"] = 777,
    ["Dein Config"] = 132,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 818,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 807,
    ...
    ["Goreleaser Pro"] = 297,
    Goss = 298,
    ["Gradle Build Cache Node"] = 718,
    ["Gradle Enterprise"] = 717,
    ...
    Hadolint = 699,
    Hammerkit = 727,
    ["Hardware Sentry Configuration"] = 781,
    Hatch = 700,
    Hayson = 311,
    ...
    ["IVMS101 by CODE Protocol"] = 844,
    Istanbul = 784,
    ["JDownloader2 crawler multi-rules"] = 335,
    ["JDownloader2 crawler single-rules"] = 334,
    ["JFrog Applications Config"] = 336,
    ["JFrog File Spec"] = 337,
    ["JFrog Pipelines YML DSL"] = 790,
    ["JMeter DSL cli config"] = 338,
    JReleaser = 340,
    ["JSON Document Transform"] = 348,
    ["JSON Feed"] = 349,
    ["JSON Resume"] = 523,
    ["JSON Schema Draft 2020-12"] = 664,
    ["JSON Schema Draft 4"] = 661,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 828,
    ["JSON Schema Draft 7"] = 662,
    ["JSON Schema Draft 7 (unofficial strict)"] = 829,
    ["JSON Schema Draft 8 (2019-09)"] = 663,
    ["JSON-API"] = 347,
    ["JSON-WF"] = 857,
    ["JSON-e templates"] = 725,
    ["JSON-stat 2.0"] = 658,
    JSONPatch = 351,
    ...
    Kas = 354,
    ["Keycloak REST API"] = 798,
    ["Knative Functions - func.yaml"] = 272,
    ["KoDE/CI build.yaml"] = 786,
    ["Kong DBLess config"] = 787,
    KrakenD = 357,
    LOOBin = 376,
    Lefthook = 365,
    ["Liferay client-extension.yaml"] = 372,
    ["LinkML Metamodel"] = 374,
    Liquibase = 733,
    ["Liquibase Flow File"] = 734,
    ["Lively Properties"] = 375,
    ["Lobe AI Agent"] = 66,
    Loki = 67,
    ["MLOS Configs"] = 410,
    ["MS2Rescore Configuration"] = 413,
    ["Madness (madness.yml)"] = 809,
    Markdownlint = 737,
    ["Mason Registry"] = 739,
    ["MegaLinter configuration"] = 382,
    ["MegaLinter descriptor"] = 383,
    Melange = 835,
    ["Meltano plugin discovery definition"] = 385,
    ["Meltano project definition"] = 384,
    ["Mergify Configuration"] = 414,
    ["MetricsHub Configuration"] = 386,
    ["MetricsHub Connector Configuration"] = 387,
    ["Micro Editor Syntax"] = 819,
    ["Microsoft Band Web Tile"] = 388,
    ["Minecraft Custom Main Menu Mod"] = 836,
    ["Minecraft Data Pack Advancement"] = 390,
    ["Minecraft Data Pack Biome"] = 391,
    ["Minecraft Data Pack Configured Carver"] = 392,
    ["Minecraft Data Pack Damage Type"] = 393,
    ["Minecraft Data Pack Dimension"] = 395,
    ["Minecraft Data Pack Dimension Type"] = 394,
    ["Minecraft Data Pack Item Modifier"] = 396,
    ["Minecraft Data Pack Loot Table"] = 397,
    ["Minecraft Data Pack Metadata"] = 398,
    ["Minecraft Data Pack Predicate"] = 399,
    ["Minecraft Data Pack Recipe"] = 400,
    ["Minecraft Data Pack Tag"] = 401,
    ["Minecraft Data Pack Template Pool"] = 402,
    ["Minecraft Data Pack Trim Material"] = 407,
    ["Minecraft Data Pack Trim Pattern"] = 408,
    ["Minecraft Resource Pack Lang"] = 403,
    ["Minecraft Resource Pack Particle"] = 404,
    ["Minecraft Resource Pack Texture Mcmeta"] = 406,
    ["Minecraft Resourcepack Sounds"] = 405,
    ["MkDocs Configuration 1.0"] = 409,
    ["Monade CLI Stack Configuration"] = 417,
    ["MongoDB Atlas Search Index Definition"] = 785,
    ["Monika Configuration"] = 783,
    ["Monoweave Configuration"] = 412,
    ["Motif config"] = 683,
    ["NOX Framework (Service)"] = 430,
    ["Netin Diagnostic System Template"] = 743,
    ["Netlify config"] = 420,
    ["Network-as-Code Data Model"] = 421,
    ["Nightwatch.js"] = 422,
    ["Nuitka.yaml"] = 849,
    ["ONe's changelog entry"] = 446,
    ["ONe's service descriptor"] = 445,
    ["OSS Review Toolkit configuration"] = 453,
    ["OSS Review Toolkit curation"] = 454,
    ["OSS Review Toolkit package configuration"] = 455,
    ["OSS Review Toolkit repository configuration"] = 456,
    ["OSS Review Toolkit resolutions"] = 457,
    Opctl = 686,
    ["OpenRewrite Resource"] = 448,
    ["OpenUtau character yaml"] = 442,
    ["OpenUtau ustx"] = 443,
    ["OpenWeather Current Weather API"] = 724,
    ["OpenWeather Road Risk API"] = 723,
    ["Ory Hydra configuration"] = 317,
    ["Ory Keto configuration"] = 359,
    ["Ory Kratos configuration"] = 452,
    ["Ory Oathkeeper configuration"] = 437,
    ["Outblocks App configuration"] = 450,
    ["Outblocks database table"] = 451,
    ["Outblocks project configuration"] = 449,
    PDM = 463,
    Packer = 460,
    Pantsbuild = 805,
    ["Paper paper-plugin.yml"] = 461,
    ["Pipeline component"] = 735,
    ["PocketMine plugin.yml"] = 468,
    ["Postman collection"] = 473,
    ["Problem object RFC9457"] = 833,
    ["Problem package generators"] = 481,
    Pterodactyl = 780,
    ["Pull Request Labeler"] = 496,
    Pulumi = 502,
    PyProject = 503,
    Pyright = 504,
    Qgoda = 505,
    Qodana = 753,
    ["Quali Torque Blueprint Spec 2"] = 778,
    ["QueryFirst config file"] = 801,
    ["RKE Cluster Configuration JSON"] = 732,
    ["RKE Cluster Configuration YAML"] = 731,
    ["Rancher Fleet"] = 499,
    ["Rattler-build"] = 506,
    Ray = 698,
    ["Read the Docs"] = 501,
    ["Red-DiscordBot Cog"] = 513,
    ["Red-DiscordBot Cog Repo"] = 514,
    ["Red-DiscordBot Trivia"] = 515,
    ["Render Blueprints"] = 730,
    RenderCV = 525,
    Renovate = 524,
    ["Replit config"] = 519,
    RoadRunner = 526,
    ["Rudder techniques"] = 839,
    Ruff = 521,
    ["Rust Project"] = 522,
    ["Rust toolchain"] = 529,
    ["SDMX data message"] = 554,
    ["SDMX metadata message"] = 553,
    ["SDMX structure message"] = 552,
    ["SIL Kit Participant Configuration"] = 564,
    ["SIL Kit Registry Configuration"] = 565,
    SWADL = 590,
    ["Safebox Config"] = 791,
    ["Sapphire CLI Config"] = 532,
    ["SauceCTL Configuration"] = 740,
    ["Schema Catalog"] = 546,
    ["Scoop manifest"] = 551,
    ["Semantic Data Fabric (SDF) file"] = 555,
    ["Semgrep Rule"] = 557,
    ["Serenity Code Generator (Sergen)"] = 558,
    ["Serverless Framework Configuration"] = 747,
    ["Serverless Workflow"] = 749,
    ["Settings.paf"] = 560,
    ["Shopware 6 Configuration"] = 750,
    ["Shopware CLI Extension Store Configuration"] = 751,
    ["Shopware CLI Project Store Configuration"] = 752,
    Sigma = 562,
    ["Sigrid scope configuration file"] = 563,
    ["SkyPilot Task JSON"] = 840,
    ["Slack app manifest"] = 567,
    Solidarity = 570,
    ["Solution filters"] = 571,
    ["Source Maps v3"] = 572,
    Sourcery = 573,
    SpecIF = 574,
    ["Sponge Mixin configuration"] = 575,
    StackBlitz = 580,
    ["StackHawk Scanner Configuration"] = 746,
    Stale = 581,
    ["Starlake Data Pipeline"] = 721,
    Starship = 582,
    ["Statamic Blueprint"] = 583,
    ["Stella configuration file"] = 584,
    ["StrmPrivacy Data Connector"] = 795,
    ["StrmPrivacy Data Contract"] = 796,
    ["StrmPrivacy SimpleSchema"] = 793,
    ["StrmPrivacy Stream"] = 794,
    ["StrmPrivacy batch job configuration file"] = 792,
    ["Stryker Mutator"] = 587,
    ["StyleCop Analyzers Configuration"] = 588,
    ["Stylelint (.stylelintrc)"] = 589,
    ["Sublime Syntax"] = 797,
    ["Subsquid squid manifest"] = 842,
    ["Swagger API 2.0"] = 591,
    TSON = 617,
    TSTyche = 618,
    Talhelper = 593,
    ["Talisman configuration"] = 594,
    ["Taskfile config"] = 726,
    Taurus = 595,
    ["TestEnvironment.json"] = 604,
    ["TextMate Grammar"] = 603,
    ["Tier.run pricing.json"] = 598,
    Tikibase = 599,
    ["Traefik v2"] = 607,
    ["Traefik v2 File Provider"] = 608,
    ["Travis CI (.travis.yml)"] = 606,
    TunnelHub = 832,
    Turborepo = 605,
    Tye = 754,
    ["UET BuildConfig.json"] = 802,
    ["UI5 Manifest"] = 627,
    ["UNCORS configuration"] = 631,
    ["UTAM Page Object"] = 630,
    ["Ubuntu Server Autoinstall"] = 625,
    ["Uniswap Token List"] = 709,
    ["Unreal Engine Uplugin"] = 803,
    ["Unreal Engine Uproject"] = 804,
    ["Updatecli Compose"] = 762,
    ["Updatecli Policy Manifest"] = 763,
    ["Updatecli Policy Metadata"] = 764,
    Uplift = 800,
    ["User Journey Map"] = 729,
    V2Ray = 768,
    ["VSCode Code Snippets"] = 170,
    ["VSIX CLI publishing"] = 646,
    ["Vela Pipeline Configuration"] = 635,
    Vercel = 169,
    Visivo = 830,
    ["Web App Manifest"] = 653,
    ["Web types"] = 656,
    WebExtensions = 652,
    ["Webman package recipe"] = 774,
    ["Windows Package Manager Installer Manifest"] = 706,
    ["Windows Package Manager Locale Manifest"] = 707,
    ["Windows Package Manager Singleton Manifest"] = 705,
    ["Woodpecker pipeline config"] = 742,
    ["Wrangler CLI"] = 657,
    ["Xstate Machine"] = 760,
    ["Yarn Config (.yarnrc.yml)"] = 719,
    ["Yippee-Ki-JSON configuration YML"] = 711,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 834,
    ...
    ["behat.yml"] = 92,
    ["bigquery-table"] = 84,
    ["bioimageio resource description"] = 850,
    ...
    ["ize.toml"] = 799,
    ["jsconfig.json"] = 352,
    ["jscpd Configuration"] = 779,
    jsdoc = 697,
    ["k3d.yaml"] = 353,
    ["k9s plugin.yml"] = 355,
    ["kontinuous-config.yaml"] = 361,
    ["kontinuous-values.yaml"] = 360,
    ["kustomization.yaml"] = 362,
    ["label-commenter-config.yml"] = 363,
    ["latexindent configuration"] = 65,
    ["launchsettings.json"] = 364,
    lazydocker = 821,
    lazygit = 820,
    ["lego.json"] = 366,
    ["lerna.json"] = 367,
    ["lgtm.yml"] = 368,
    ["liblab.config.json"] = 369,
    ["libman.json"] = 370,
    ["license-report-config.json"] = 371,
    ["linkinator.config.json"] = 373,
    ["lint-staged (.lintstagedrc)"] = 677,
    ["local.settings.json"] = 378,
    ["localazy.json"] = 379,
    ["lotus.yaml"] = 377,
    ["lsdlschema.json"] = 380,
    ["markdown-link-check"] = 738,
    mboats = 745,
    ["micro-settings.json"] = 814,
    ["mimetypes.json"] = 389,
    ["mirrord config"] = 678,
    mise = 679,
    ["mise-settings"] = 680,
    ...
    ["mtad.yaml"] = 682,
    ["mycode.json"] = 418,
    ["napari plugin manifest"] = 419,
    neoload = 692,
    ["nest-cli"] = 425,
    ["ninjs (News in JSON) 1.3"] = 424,
    ["ninjs (News in JSON) 2.0"] = 423,
    ["nixd configuration"] = 838,
    ["nlu.json"] = 426,
    ["nodemon.json"] = 428,
    ["noodl config"] = 744,
    ["notebook.mod.json"] = 429,
    now = 688,
    ["npm-badges"] = 432,
    ["nswag.json"] = 435,
    ntangle = 436,
    ["nuclei-template.yaml"] = 433,
    ["nuget-project.json"] = 434,
    ["ocelot.json"] = 438,
    ["omnisharp.json"] = 439,
    ["openapi.json"] = 440,
    ["openfin.json"] = 447,
    ...
    ["ops.yaml"] = 444,
    ["package.json"] = 458,
    ["package.manifest"] = 459,
    ["partial-black.json"] = 93,
    ["pathfinder.yml"] = 462,
    ["pattern.json"] = 465,
    ["petstore-v1.0"] = 789,
    pgap_yaml_input_reader = 464,
    ["pixi.toml"] = 466,
    ["plagiarize-me.yaml"] = 470,
    ["plagiarize.yaml"] = 469,
    ["portman.json"] = 471,
    ["prettierrc.json"] = 479,
    ["prisma.yml"] = 480,
    ["project-1.0.0-beta3.json"] = 483,
    ["project-1.0.0-beta4.json"] = 484,
    ["project-1.0.0-beta5.json"] = 485,
    ["project-1.0.0-beta6.json"] = 486,
    ["project-1.0.0-beta8.json"] = 487,
    ["project-1.0.0-rc1.json"] = 488,
    ["project-1.0.0-rc2.json"] = 489,
    ["project.json"] = 482,
    ["prometheus.json"] = 490,
    ["prometheus.rules.json"] = 491,
    ["prometheus.rules.test.json"] = 492,
    ["proxies.json"] = 493,
    ["publiccode.yml"] = 494,
    ["pubspec.yaml"] = 495,
    ["pyrseas-0.8.json"] = 498,
    ["quilt.mod.json"] = 815,
    ["rc3 auth"] = 507,
    ["rc3 collection"] = 508,
    ["rc3 environment"] = 509,
    ...
    ["rc3 settings"] = 512,
    ["release drafter"] = 693,
    ["release-plz.toml"] = 517,
    ["rivet.yaml"] = 837,
    rockcraft = 527,
    rustfmt = 528,
    samt = 530,
    samtrc = 531,
    ["sarif-1.0.0.json"] = 533,
    ["sarif-2.0.0.json"] = 534,
    ["sarif-2.1.0"] = 544,
    ["sarif-2.1.0-rtm.2"] = 535,
    ["sarif-2.1.0-rtm.3"] = 537,
    ["sarif-2.1.0-rtm.4"] = 539,
    ["sarif-2.1.0-rtm.5"] = 541,
    ["sarif-2.1.0-rtm.6"] = 542,
    ["sarif-external-property-file-2.1.0"] = 545,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 536,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 538,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 540,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 543,
    ["schema.org - Action"] = 547,
    ["schema.org - ContactPoint"] = 548,
    ["schema.org - Place"] = 549,
    ["schema.org - Thing"] = 550,
    ["secrethub.yml"] = 817,
    ["semantic-release"] = 556,
    ["servicehub.config.json"] = 667,
    ["servicehub.service.json"] = 666,
    ["settings.job"] = 559,
    ["sfdx-hardis configuration"] = 561,
    ["shard.yml"] = 853,
    ["size-limit configuration"] = 566,
    ["skaffold.yaml"] = 736,
    ["skyuxconfig.json"] = 568,
    snapcraft = 569,
    ["sqlc configuration"] = 577,
    ["stripe-app-local.json"] = 586,
    ["stripe-app.json"] = 585,
    swcrc = 722,
    ["task.json"] = 592,
    taskcat = 689,
    ["template.json"] = 596,
    ["templatsources.json"] = 597,
    ["theme.json"] = 600,
    ["tizen_workspace.json"] = 601,
    tldr = 602,
    tmuxinator = 675,
    ["transcend.yml"] = 609,
    ...
    ["vega-lite.json"] = 634,
    ["vega.json"] = 633,
    ["venvironment-basic.yaml"] = 637,
    ["venvironment.yaml"] = 636,
    ["version.json"] = 638,
    ["vim-addon-info"] = 640,
    ["vs-2017.3.host.json"] = 642,
    ["vs-nesting.json"] = 643,
    ["vsls.json"] = 641,
    ["vss-extension.json"] = 647,
    ["vtesttree.yaml"] = 648,
    ["vtestunit.yaml"] = 649,
    ["warp-keysets.json"] = 823,
    ["warp-themes.json"] = 824,
    ["warp-workflows.json"] = 825,
    ["webhint.io"] = 775,
    ["webjobpublishsettings.json"] = 655,
    ["webjobs-list.json"] = 654,
    ["well-known-fursona"] = 861,
    ["xs-app.json"] = 685,
    ["xunit.runner.json"] = 665,
    yamllint = 710,
    zuul = 694,
    ["Žinoma"] = 704
  },
