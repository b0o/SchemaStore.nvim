...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 112,
    [".cryproj (generic)"] = 420,
    [".cryproj engine-5.2"] = 415,
    [".cryproj engine-5.3"] = 416,
    [".cryproj engine-5.4"] = 417,
    [".cryproj engine-5.5"] = 418,
    [".cryproj engine-dev"] = 419,
    [".csscomb.json"] = 114,
    [".csslintrc"] = 115,
    [".eslintrc"] = 152,
    [".esmrc.json"] = 145,
    ...
    [".vsext"] = 396,
    [".yarnrc.yml"] = 458,
    ["<div>RIOTS' studio configuration"] = 399,
    ["API Builder"] = 455,
    ["AVA Configuration Schema"] = 504,
    ...
    ["Azure Pipelines"] = 40,
    ["Azure Static Web Apps CLI configuration file"] = 353,
    ["Azure Static Web Apps configuration file"] = 352,
    ["Better Code Hub"] = 460,
    BizTalkServerApplicationSchema = 432,
    ...
    ["Butane config schema"] = 494,
    ["CICS TS resource overrides"] = 501,
    ["CMake Presets"] = 68,
    ["CSR Framework"] = 76,
    ...
    ["Error pages"] = 148,
    Esquio = 146,
    ["Estuary Flow Catalog Schema"] = 498,
    ["Expo SDK"] = 151,
    ...
    Goreleaser = 178,
    ["Goreleaser Pro"] = 179,
    ["Gradle Build Cache Node"] = 457,
    ["Gradle Enterprise"] = 456,
    ...
    ["JSON Feed"] = 216,
    ["JSON Resume"] = 318,
    ["JSON Schema Draft 2020-12"] = 411,
    ["JSON Schema Draft 4"] = 408,
    ["JSON Schema Draft 7"] = 409,
    ["JSON Schema Draft 8"] = 410,
    ...
    ["Netin Diagnostic System Template"] = 479,
    ["Netlify config schema"] = 257,
    ["Nightwatch.js"] = 258,
    ["OSS Review Toolkit package configuration"] = 279,
    ["OSS Review Toolkit repository configuration"] = 280,
    Opctl = 428,
    ["OpenWeather Current Weather API"] = 464,
    ["OpenWeather Road Risk API"] = 463,
    ...
    Packer = 283,
    ["Pipeline component"] = 473,
    ["PocketMine plugin.yml"] = 287,
    ["Pull Request Labeler"] = 309,
    Qodana = 487,
    ["RKE Cluster Configuration JSON Schema"] = 471,
    ["RKE Cluster Configuration YAML Schema"] = 470,
    Ray = 440,
    ["Read the Docs"] = 312,
    ["Red-DiscordBot Cog"] = 313,
    ["Red-DiscordBot Cog Repo"] = 314,
    Renovate = 319,
    RoadRunner = 320,
    SWADL = 362,
    ["Sapphire CLI Config"] = 321,
    ["SauceCTL Configuration"] = 476,
    ["Schema Catalog"] = 334,
    ["Scoop manifest"] = 339,
    ["Semgrep Rule"] = 340,
    ["Serverless Framework Configuration"] = 483,
    ["Settings.paf"] = 342,
    ["Shopware 6 Configuration"] = 484,
    ["Shopware CLI Extension Store Configuration"] = 485,
    ["Shopware CLI Project Store Configuration"] = 486,
    Solidarity = 347,
    ["Source Maps v3"] = 348,
    SpecIF = 349,
    ["Sponge Mixin configuration"] = 350,
    ["StackHawk Scanner Configuration"] = 482,
    ["StackHead CLI config"] = 354,
    ["StackHead module configuration"] = 355,
    ["StackHead project definition"] = 356,
    Stale = 357,
    ["Statamic Blueprint"] = 358,
    ["Stryker Mutator"] = 359,
    ["StyleCop Analyzers Configuration"] = 360,
    ["Swagger API 2.0"] = 363,
    ["Taskfile YAML Schema"] = 466,
    Taurus = 364,
    ["TestEnvironment.json"] = 370,
    Tikibase = 367,
    ["Traefik v2"] = 372,
    ["Traefik v2 File Provider"] = 373,
    Tye = 488,
    ["UI5 Manifest"] = 385,
    ["Ubuntu Server Autoinstall"] = 383,
    ["Uniswap Token List"] = 449,
    Updatecli = 495,
    ["User Journey Map YAML Schema"] = 469,
    V2Ray = 499,
    ["VSCode Code Snippets"] = 90,
    ["VSIX CLI publishing"] = 397,
    ["Vela Pipeline Configuration"] = 389,
    Vercel = 89,
    ["Web App Manifest"] = 401,
    ["Web types"] = 404,
    WebExtensions = 400,
    ["Webman package recipe"] = 502,
    ["Windows Package Manager Installer Manifest"] = 446,
    ["Windows Package Manager Locale Manifest"] = 447,
    ["Windows Package Manager Singleton Manifest"] = 445,
    ["Woodpecker pipeline config"] = 478,
    ["Xstate Machine Schema"] = 493,
    ["Yippee-Ki-JSON configuration YML"] = 451,
    ["angular.json"] = 8,
    ...
    ["openfin.json"] = 274,
    ["package.json"] = 281,
    ["package.manifest"] = 282,
    ["pattern.json"] = 285,
    pgap_yaml_input_reader = 284,
    ["plagiarize-me.yaml"] = 289,
    ["plagiarize.yaml"] = 288,
    ["portman.json"] = 290,
    ["prettierrc.json"] = 294,
    ["prisma.yml"] = 295,
    ["project-1.0.0-beta3.json"] = 297,
    ["project-1.0.0-beta4.json"] = 298,
    ["project-1.0.0-beta5.json"] = 299,
    ["project-1.0.0-beta6.json"] = 300,
    ["project-1.0.0-beta8.json"] = 301,
    ["project-1.0.0-rc1.json"] = 302,
    ["project-1.0.0-rc2.json"] = 303,
    ["project.json"] = 296,
    ["prometheus.json"] = 304,
    ["prometheus.rules.json"] = 305,
    ["proxies.json"] = 306,
    ["publiccode.yml"] = 307,
    ["pubspec.yaml"] = 308,
    ["pyrseas-0.8.json"] = 311,
    ["release drafter"] = 435,
    ["sarif-1.0.0.json"] = 322,
    ["sarif-2.0.0.json"] = 323,
    ["sarif-2.1.0"] = 332,
    ["sarif-2.1.0-rtm.2"] = 324,
    ["sarif-2.1.0-rtm.3"] = 326,
    ["sarif-2.1.0-rtm.4"] = 328,
    ["sarif-2.1.0-rtm.5"] = 330,
    ["sarif-external-property-file-2.1.0"] = 333,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 325,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 327,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 329,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 331,
    ["schema.org - Action"] = 335,
    ["schema.org - ContactPoint"] = 336,
    ["schema.org - Place"] = 337,
    ["schema.org - Thing"] = 338,
    ["service.datadog.yaml"] = 221,
    ["servicehub.config.json"] = 414,
    ["servicehub.service.json"] = 413,
    ["settings.job"] = 341,
    ["sfdx-hardis configuration"] = 343,
    ["size-limit configuration"] = 344,
    ["skaffold.yaml"] = 474,
    ["skyuxconfig.json"] = 345,
    snapcraft = 346,
    swcrc = 462,
    taskcat = 431,
    ["template.json"] = 365,
    ["templatsources.json"] = 366,
    ["theme.json"] = 368,
    tmLanguage = 369,
    ["trunk.yaml schema"] = 374,
    ["ts-force-config.json"] = 378,
    ["tsconfig.json"] = 375,
    ["tsd.json"] = 376,
    ["tsdrc.json"] = 377,
    ["tslint.json"] = 379,
    ...
    ["version.json"] = 390,
    ["vim-addon-info"] = 391,
    ["vs-2017.3.host.json"] = 393,
    ["vs-nesting.json"] = 394,
    ["vsls.json"] = 392,
    ["vss-extension.json"] = 398,
    ["webhint.io"] = 503,
    ["webjobpublishsettings.json"] = 403,
    ["webjobs-list.json"] = 402,
    ["xs-app.json"] = 427,
    ["xunit.runner.json"] = 412,
    yamllint = 450,
    zuul = 436,
    ["Žinoma"] = 444
  },
