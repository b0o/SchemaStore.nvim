...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 932,
    [".nodehawkrc"] = 575,
    [".npmpackagejsonlintrc"] = 579,
    [".omletrc"] = 1111,
    [".phrase.yml"] = 653,
    [".phraseapp.yml"] = 654,
    [".pmbot.yml"] = 639,
    [".postcssrc"] = 648,
    [".powerpages-web-template-manifest"] = 650,
    [".pre-commit-config.yml"] = 651,
    [".pre-commit-hooks.yml"] = 652,
    [".putout.json"] = 687,
    [".rehyperc"] = 712,
    [".remarkrc"] = 716,
    [".sprite files"] = 807,
    ...
    AIConfig = 33,
    ["AMX Muse Program Descriptor"] = 1159,
    ["API Builder"] = 967,
    ["AVA Configuration"] = 1030,
    ["AWS AppConfig Feature Flags-v1"] = 67,
    ["AWS CDK cdk.json"] = 256,
    ["AWS CloudFormation"] = 257,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 258,
    ["AWS Copilot Manifest"] = 1198,
    ["AWS SAM CLI Samconfig"] = 259,
    ["Adobe UXP Manifest"] = 1093,
    ["Aerleon Network & Service Definitions"] = 19,
    ["Aerleon Policy"] = 20,
    Aider = 1188,
    Air = 22,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1209,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1208,
    ["Airlock Microgateway"] = 34,
    ["Alacritty Configuration"] = 1002,
    ["All Contributors configuration file"] = 1056,
    ["Ansible Argument Specs"] = 395,
    ["Ansible Collection Galaxy"] = 402,
    ["Ansible Execution Environment"] = 392,
    ["Ansible Inventory"] = 401,
    ["Ansible Meta"] = 393,
    ["Ansible Meta Runtime"] = 394,
    ["Ansible Navigator Configuration"] = 404,
    ["Ansible Playbook"] = 399,
    ["Ansible Requirements"] = 396,
    ["Ansible Rulebook"] = 400,
    ["Ansible Tasks File"] = 398,
    ["Ansible Vars File"] = 397,
    ["Ansible-lint Configuration"] = 403,
    Any = 1121,
    ...
    ["Application list for a WinUtil"] = 1138,
    ArchitectFX = 1143,
    ["Argo CD"] = 53,
    ["Argo Events"] = 54,
    ["Argo Workflows"] = 55,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1207,
    ["Azure IoT Operations connector metadata"] = 1204,
    ...
    ["Azure Pipelines"] = 109,
    ["Azure Static Web Apps CLI configuration file"] = 811,
    ["Azure Static Web Apps configuration file"] = 810,
    BMML = 1226,
    ["BOSH CPI Config"] = 134,
    ["BOSH Deploy Config"] = 135,
    ["BX CI"] = 154,
    ["Bacon config"] = 4,
    ["Bashly (bashly.yml)"] = 1060,
    ["Bashly Settings (bashly-settings.yml)"] = 1061,
    Bento = 1225,
    ["Better Code Hub"] = 972,
    ["Better Scripts"] = 155,
    Bigconfig = 127,
    ["Biome Formatter Config"] = 81,
    ["Bitmovin Encoding Template"] = 1152,
    BizTalkServerApplicationSchema = 939,
    Bleep = 156,
    ["Block Protocol Metadata"] = 153,
    ["Bluebricks blueprint config"] = 1231,
    ["Boyka Framework"] = 136,
    Briefcase = 945,
    ["Build Info"] = 144,
    Buildkite = 146,
    ...
    ["Butane Config"] = 1015,
    C4InterFlow = 1167,
    ["CDK Environment Manager, concrete environment configuration"] = 1191,
    ["CDK Environment Manager, concrete environments definition"] = 1190,
    ["CDK Environment Manager, environment definition"] = 1189,
    ["CGS Card Game Specification (cgs.json)"] = 1098,
    ["CICS TS region tagging"] = 1024,
    ["CICS TS resource import"] = 1025,
    ["CICS TS resource model"] = 1026,
    ["CICS TS resource overrides"] = 1027,
    ["CMake Presets"] = 157,
    ["CNC Codes"] = 179,
    ["CRS WAF test file"] = 1128,
    ["CRS WAF test platform overrides file"] = 1129,
    ["CSS Comb (.csscomb.json)"] = 284,
    ["CSS Lint (.csslintrc)"] = 285,
    ["CSpell (cspell.json)"] = 283,
    ...
    ["Chamaleon environment"] = 1156,
    ["Chamaleon properties"] = 1157,
    ["Chamaleon template"] = 1155,
    Changepacks = 1218,
    Changesets = 268,
    Changie = 166,
    Charmcraft = 167,
    ...
    CodeCV = 93,
    CodeRabbit = 92,
    ["CodeShip Pro services configuration files"] = 238,
    ["CodeShip Pro steps configuration files"] = 239,
    ["Codecov configuration files"] = 237,
    Codex = 233,
    CodifyCLI = 94,
    Codux = 235,
    ["Cog config file"] = 180,
    ...
    ["Common Catalog Data"] = 247,
    ["Common Package Specification"] = 183,
    Concord = 1127,
    ["Configu .cfgu files"] = 1115,
    ["Configu .configu file"] = 1116,
    Conjure = 178,
    ["Container Structure Test"] = 953,
    Containerlab = 981,
    ["Contextive Glossary"] = 1183,
    Convex = 177,
    ["Crowdsec collection config"] = 278,
    ["Crowdsec parser config"] = 279,
    ["Crowdsec scenario config"] = 280,
    ["CumulusCI Config"] = 184,
    ["Custom Machinery Machine"] = 1099,
    ["Custom Machinery Recipe"] = 1100,
    ["Cycle Stack File"] = 189,
    CycloneDX = 190,
    ["DWP Exchange - catalogue entry"] = 329,
    ["DWP Exchange - gateway"] = 327,
    ["DWP Exchange - meta"] = 328,
    ["Dart Build Config (dart-build.json)"] = 286,
    ["Dart Test Config (dart-test.json)"] = 287,
    ["DashLord Configuration"] = 288,
    ["Data Contract Specification"] = 289,
    ["Data Product Specification"] = 290,
    ["DataYoga Connections"] = 191,
    ["DataYoga Job"] = 192,
    ["Databricks Asset Bundles"] = 1077,
    ["Datadog Continuous Testing"] = 493,
    ["Datadog Service Definition"] = 494,
    ["Datadog Software Catalog"] = 495,
    ["Datahub Ingestion Recipe"] = 1031,
    ["Debian Upstream Metadata file"] = 199,
    ["Deck config"] = 200,
    ["Dein Config"] = 201,
    ["Deno Config (deno.json)"] = 296,
    ["Dependency cruiser"] = 202,
    ["DeployStack Configuration"] = 203,
    ["Deployah Configuration"] = 1206,
    ["Deployer Recipe"] = 299,
    ["Deta Spacefile"] = 204,
    ["Detekt Config (detekt.yml)"] = 300,
    ["Devbox Config"] = 205,
    ["Devbox Plugin"] = 206,
    Devfile = 326,
    Devup = 1219,
    DipDup = 1130,
    ["Discord Webhook"] = 301,
    ["DocFx Config (docfx.json)"] = 306,
    ["Docker Desktop extension metadata"] = 303,
    ["Docs MCP Manifest"] = 307,
    Dofigen = 308,
    ["Dolittle Artifacts"] = 309,
    ["Dolittle Bounded Context Configuration"] = 310,
    ["Dolittle Event Horizons Configuration"] = 311,
    ["Dolittle Resources Configuration"] = 312,
    ["Dolittle Server Configuration"] = 313,
    ["Dolittle Tenant Map Configuration"] = 315,
    ["Dolittle Tenants Configuration"] = 314,
    ["Dolittle Topology"] = 316,
    ["DonateCaseBetterCasino menu"] = 1160,
    ["Drupal Breakpoints"] = 207,
    ["Drupal Config"] = 219,
    ["Drupal Info"] = 208,
    ["Drupal Layouts"] = 209,
    ["Drupal Libraries"] = 210,
    ["Drupal Links Action"] = 211,
    ["Drupal Links Contextual"] = 212,
    ["Drupal Links Menu"] = 213,
    ["Drupal Links Task"] = 214,
    ["Drupal Migration"] = 215,
    ["Drupal Permissions"] = 216,
    ["Drupal Recipe"] = 217,
    ["Drupal Routing"] = 218,
    ["Drupal Services"] = 220,
    ["Drush site aliases"] = 322,
    ["Dynamic Bash Aliases (.aliases)"] = 1068,
    ["EAS config"] = 347,
    ["ECA - Editor Code Assistant"] = 331,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1057,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1203,
    ["EasyVCR .NET"] = 348,
    ["Eidolon Resource"] = 1144,
    ["Elgato Stream Deck"] = 333,
    Elm = 1132,
    ["Embrace Config"] = 1043,
    Endurica = 1081,
    ["Enterprise Contract Policy Spec"] = 334,
    ["Erda Pipeline"] = 1106,
    ["Erda Runtime"] = 1107,
    ["Espanso config.yml"] = 1229,
    ["Espanso match.yml"] = 1228,
    Esquio = 336,
    ["Estuary Flow Catalog"] = 1021,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 340,
    ["EveryVoice TTS Toolkit Data Configuration"] = 341,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 345,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 344,
    ["EveryVoice TTS Toolkit Text Configuration"] = 342,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 343,
    ["Evolving Resolutive Process notation"] = 1205,
    ["Expo SDK"] = 346,
    ["F-Droid Data metadata"] = 352,
    ["FasterCI Configuration"] = 110,
    FiQuS = 356,
    Firebase = 354,
    ["Flatpak Builder Manifest"] = 357,
    ["FlexGet Config"] = 358,
    ["Flow.json Configurations"] = 1103,
    ["Fossa configuration file"] = 365,
    ["Fossa's fossa-deps file"] = 366,
    ["Foundry VTT - Base package Manifest"] = 360,
    ["Foundry VTT - Module Manifest"] = 361,
    ["Foundry VTT - System Data Template"] = 364,
    ["Foundry VTT - System Manifest"] = 362,
    ["Foundry VTT - World Manifest"] = 363,
    ["Foxx Manifest"] = 111,
    ["Freifunk.de Community API"] = 114,
    ["Frogbot Config"] = 115,
    ["G2P Mapping Configuration"] = 372,
    ["GCP Blueprint Metadata"] = 375,
    Gaspar = 373,
    ["GatewayCore API Gateway"] = 374,
    ["Gemini CLI settings"] = 376,
    ["GeoJSON.json latest"] = 1019,
    GherKing = 1023,
    ["GitHub Action"] = 381,
    ["GitHub Actions typing"] = 1140,
    ["GitHub Discussion"] = 382,
    ["GitHub Funding"] = 383,
    ["GitHub Issue Template configuration"] = 384,
    ["GitHub Issue Template forms"] = 385,
    ["GitHub Workflow"] = 386,
    ["GitHub Workflow Template Properties"] = 387,
    ["GitHub automatically generated release notes configuration"] = 388,
    ["GitLab Agent for Kubernetes configuration"] = 1095,
    GitVersion = 378,
    ["Gitea Issue Template configuration"] = 379,
    ["Gitea Issue Template forms"] = 380,
    ["Gitpod Automations"] = 390,
    ["Gitpod Configuration"] = 391,
    ["GlazeWM settings"] = 1097,
    ["Global Privacy Control"] = 377,
    Goblet = 1076,
    ["Golangci-lint Configuration"] = 406,
    ["Golangci-lint Custom Plugins Configuration"] = 407,
    ["Google Chrome Related Website Sets"] = 355,
    ["Google Cloud Workflows"] = 255,
    ["Google Digital Assetlinks"] = 1184,
    Goreleaser = 409,
    ["Goreleaser Pro"] = 410,
    Goss = 411,
    ["Gradle Build Cache Node"] = 970,
    ["Gradle Enterprise"] = 969,
    ["Grafana 5.x Dashboard"] = 412,
    ["GraphQL Code Generator"] = 417,
    ["GraphQL Config"] = 416,
    ["GraphQL Mesh"] = 415,
    ["GroovyLint configuration"] = 418,
    ["Grunt JSHint task"] = 422,
    ["Grunt Watch task"] = 423,
    ["Grunt base task"] = 424,
    ["Grunt clean task"] = 420,
    ["Grunt copy task"] = 419,
    ["Grunt cssmin task"] = 421,
    HEMTT = 935,
    Hadolint = 949,
    Hammerkit = 980,
    ["Hardware Sentry Configuration"] = 1035,
    ["Hashgraph Online Skill Manifest"] = 1,
    ["HashiCorp Vault"] = 425,
    Hatch = 950,
    Hayson = 427,
    ["Haystack Pipeline"] = 428,
    ["Hazelcast 5 Configuration"] = 429,
    ["Hecate Input Schema"] = 1195,
    ["Helm Chart.lock"] = 222,
    ["Helm Chart.yaml"] = 221,
    ["Helm Unittest Test Suite"] = 223,
    ["Home Assistant Integration Manifest"] = 430,
    ["Homer dashboard configuration"] = 431,
    Hugo = 1011,
    ["Hugo Theme"] = 1010,
    ["Hulak Configuration"] = 438,
    ["Hyperfoil benchmark configuration"] = 437,
    ["IBM Zapp document"] = 439,
    ["IBM zCodeFormatSettings"] = 440,
    ["IMG Catapult PSP"] = 445,
    ["IVMS101 by CODE Protocol"] = 1096,
    Infrahub = 447,
    Istanbul = 1039,
    ["JDownloader2 crawler multi-rules"] = 460,
    ["JDownloader2 crawler single-rules"] = 459,
    ["JFrog Applications Config"] = 461,
    ["JFrog File Spec"] = 462,
    ["JFrog Pipelines YML DSL"] = 1045,
    ["JMeter DSL cli config"] = 463,
    JReleaser = 466,
    ["JSON Document Transform"] = 474,
    ["JSON Feed"] = 475,
    ["JSON Resume"] = 722,
    ["JSON Schema Draft 2020-12"] = 917,
    ["JSON Schema Draft 4"] = 914,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1078,
    ["JSON Schema Draft 7"] = 915,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1079,
    ["JSON Schema Draft 8 (2019-09)"] = 916,
    ["JSON-API"] = 473,
    ["JSON-e templates"] = 977,
    ["JSON-stat 2.0"] = 910,
    JSONPatch = 477,
    ["JSR Package Config (jsr.json)"] = 467,
    Jarl = 1211,
    Jasmine = 454,
    Jekyll = 455,
    ["Jenkins X Pipelines"] = 456,
    ["Jenkins X Requirements"] = 457,
    Jest = 458,
    Jocker = 464,
    ["Jovo Language Models"] = 465,
    ["Jujutsu (jj) VCS config"] = 1197,
    ["KIMMDY config file"] = 488,
    ["KODE/CI build.yaml"] = 1041,
    ["KSP-AVC"] = 911,
    ["KSP-CKAN"] = 912,
    ["KSP-NetKAN"] = 913,
    KSY = 1108,
    KSail = 370,
    ["KYA Manifest"] = 1109,
    ["Karakum configuration file"] = 367,
    Kas = 480,
    ["Kestra flow file"] = 489,
    ["Keycloak REST API"] = 1048,
    ["Knative Functions - func.yaml"] = 368,
    Knip = 369,
    ["Kometa (nightly) config file"] = 491,
    ["Kometa config file"] = 490,
    ["Kong DBLess config"] = 1042,
    KrakenD = 492,
    ["Kubri Configuration"] = 499,
    LOOBin = 514,
    ["Lake configuration file"] = 1200,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 260,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 261,
    ["Landing Zone Accelerator on AWS - Global Config"] = 262,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 263,
    ["Landing Zone Accelerator on AWS - Network Config"] = 264,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 265,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 266,
    ["Landing Zone Accelerator on AWS - Security Config"] = 267,
    ["Lando (landofile)"] = 105,
    ["LangGraph Platform configuration"] = 1120,
    ["Language configuration"] = 1119,
    Lefthook = 503,
    ["Liferay client-extension.yaml"] = 510,
    ["LinkML Metamodel"] = 512,
    Liquibase = 986,
    ["Liquibase Flow File"] = 987,
    ["Lively Properties"] = 513,
    ["Lobe AI Agent"] = 107,
    Loki = 108,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 554,
    ["MS2Rescore Configuration"] = 558,
    ["Madness (madness.yml)"] = 1059,
    ["Mado configuration"] = 520,
    ["Mail Servers Configuration"] = 1232,
    ["MapEHR Mapping"] = 521,
    Markdownlint = 990,
    ["Mason Registry"] = 993,
    ["MegaLinter Custom Flavor"] = 524,
    ["MegaLinter configuration"] = 523,
    ["MegaLinter descriptor"] = 525,
    Melange = 1086,
    ["Meltano project definition"] = 526,
    ["Mergify Configuration"] = 559,
    ["Metadata for a Bazel module"] = 527,
    ["Metadata for a Cinnamon spice"] = 1136,
    ["Metatype Configuration"] = 528,
    ["MetricsHub Configuration"] = 529,
    ["MetricsHub Connector Configuration"] = 530,
    ["Micro Editor Syntax"] = 1069,
    ["Microsoft Band Web Tile"] = 531,
    ["Microsoft RulesEngine workflow rules"] = 1124,
    ["Microsoft RulesEngine workflow rules list"] = 1125,
    ["Minecraft Custom Main Menu Mod"] = 1087,
    ["Minecraft Data Pack Advancement"] = 533,
    ["Minecraft Data Pack Biome"] = 534,
    ["Minecraft Data Pack Configured Carver"] = 535,
    ["Minecraft Data Pack Damage Type"] = 536,
    ["Minecraft Data Pack Dimension"] = 538,
    ["Minecraft Data Pack Dimension Type"] = 537,
    ["Minecraft Data Pack Item Modifier"] = 539,
    ["Minecraft Data Pack Loot Table"] = 540,
    ["Minecraft Data Pack Metadata"] = 541,
    ["Minecraft Data Pack Predicate"] = 542,
    ["Minecraft Data Pack Recipe"] = 543,
    ["Minecraft Data Pack Tag"] = 544,
    ["Minecraft Data Pack Template Pool"] = 545,
    ["Minecraft Data Pack Trim Material"] = 550,
    ["Minecraft Data Pack Trim Pattern"] = 551,
    ["Minecraft Resource Pack Lang"] = 546,
    ["Minecraft Resource Pack Particle"] = 547,
    ["Minecraft Resource Pack Texture Mcmeta"] = 549,
    ["Minecraft Resourcepack Sounds"] = 548,
    ["Monade CLI Stack Configuration"] = 562,
    ["MongoDB Atlas Search Index Definition"] = 1040,
    ["Monika Configuration"] = 1038,
    ["Monoweave Configuration"] = 557,
    ["Motif config"] = 931,
    MultiQC = 1177,
    ["NOX Framework (Service)"] = 578,
    ["Netin Diagnostic System Template"] = 997,
    ["Netlify config"] = 565,
    ["Network-as-Code Data Model"] = 566,
    ["Next Gen UI Agent A2A Server Configuration"] = 567,
    ["Next Gen UI Agent Configuration"] = 569,
    ["Next Gen UI Agent MCP Server Configuration"] = 568,
    ["Nightwatch.js"] = 571,
    ["Node.js configuration"] = 936,
    ["NueJS configuration file"] = 583,
    ["Nuitka.yaml"] = 1101,
    ["Nullstone config"] = 585,
    ["ONe's changelog entry"] = 604,
    ["ONe's service descriptor"] = 603,
    ["ORT Server repository environment configuration"] = 614,
    ["OSCAL Assessment Plan (AP)"] = 616,
    ["OSCAL Assessment Results (AR)"] = 617,
    ["OSCAL Catalog"] = 618,
    ["OSCAL Component Definition (CDef)"] = 619,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 620,
    ["OSCAL Profile"] = 621,
    ["OSCAL System Security Plan (SSP)"] = 622,
    ["OSS Review Toolkit configuration"] = 623,
    ["OSS Review Toolkit curation"] = 624,
    ["OSS Review Toolkit package configuration"] = 625,
    ["OSS Review Toolkit repository configuration"] = 626,
    ["OSS Review Toolkit resolutions"] = 627,
    ["October CMS columns"] = 589,
    ["October CMS fields"] = 590,
    ["Oh My Posh"] = 592,
    Okteto = 593,
    ["Ona Automations"] = 595,
    Opctl = 934,
    ["Open Data Contract Standard (ODCS)"] = 608,
    ["Open Data Product Standard (ODPS)"] = 609,
    ["Open Know-How"] = 1182,
    ["OpenRewrite Resource"] = 606,
    OpenSRM = 610,
    OpenStatus = 1193,
    ["OpenTelemetry Declarative Configuration"] = 607,
    ["OpenUtau character yaml"] = 600,
    ["OpenUtau ustx"] = 601,
    ["OpenWeather Current Weather API"] = 976,
    ["OpenWeather Road Risk API"] = 975,
    ["Ory Hydra configuration"] = 436,
    ["Ory Keto configuration"] = 496,
    ["Ory Kratos configuration"] = 615,
    ["Ory Oathkeeper configuration"] = 587,
    ["Outblocks App configuration"] = 612,
    ["Outblocks database table"] = 613,
    ["Outblocks project configuration"] = 611,
    PDM = 634,
    POPxf = 645,
    ["POPxf Correlations"] = 646,
    Packer = 631,
    Pantsbuild = 1055,
    ["Paper paper-plugin.yml"] = 632,
    ["Pipeline component"] = 988,
    ["Platform.sh application"] = 6,
    ["Platform.sh routes"] = 7,
    ["Platform.sh services"] = 8,
    ["Plex Prerolls"] = 643,
    ["PocketMine plugin.yml"] = 640,
    ["Postman collection"] = 649,
    ["Power Pages Configuration"] = 1194,
    ["Preset list for a WinUtil"] = 1139,
    ["ProActions AI-Kit Configuration"] = 660,
    ["ProActions AI-Kit Configuration for Menus"] = 662,
    ["ProActions AI-Kit Configuration for Sections"] = 664,
    ["ProActions AI-Kit Configuration for Services"] = 661,
    ["ProActions AI-Kit Configuration for Steps"] = 665,
    ["ProActions AI-Kit Configuration for Templates"] = 663,
    ["Problem object RFC9457"] = 1084,
    ["Problem package format"] = 666,
    ["Problem package generators"] = 667,
    ["Problem package submissions"] = 668,
    ["Problem package test group metadata"] = 669,
    Pterodactyl = 1034,
    ["Pull Request Labeler"] = 686,
    Pulumi = 694,
    ["PyGTA Config"] = 690,
    PyProject = 695,
    Pylock = 1185,
    Pyright = 696,
    ["Python script metadata"] = 1179,
    ["QType AI DSL"] = 699,
    Qgoda = 698,
    Qodana = 1007,
    ["Qt Creator workspace file"] = 1117,
    ["Quali Torque Blueprint Spec 2"] = 1032,
    ["QueryFirst config file"] = 1051,
    ["RKE Cluster Configuration JSON"] = 985,
    ["RKE Cluster Configuration YAML"] = 984,
    RadioHound = 689,
    Railpack = 701,
    Railway = 700,
    ["Rancher Fleet"] = 691,
    ...
    Ray = 948,
    ["Read the Docs"] = 693,
    ["Red-DiscordBot Cog"] = 709,
    ["Red-DiscordBot Cog Repo"] = 710,
    ["Red-DiscordBot Trivia"] = 711,
    ["Releasaurus Config"] = 3,
    ["Render Blueprints"] = 983,
    RenderCV = 726,
    Renovate = 723,
    ["Renovate global configuration"] = 724,
    ["Renovate inherited configuration"] = 725,
    ["Replit config"] = 717,
    Restate = 1172,
    ["Revel Digital Gadget Definition File"] = 1196,
    RoadRunner = 728,
    ["Robust Station Image"] = 1202,
    Rockcraft = 729,
    ["Roo Coder Custom Modes"] = 730,
    Rubocop = 719,
    ["Rudder techniques"] = 1091,
    Ruff = 720,
    ["Rust Project"] = 721,
    ["Rust toolchain"] = 734,
    ["SDMX data message"] = 760,
    ["SDMX metadata message"] = 759,
    ["SDMX structure message"] = 758,
    ["SIL Kit Participant Configuration"] = 770,
    ["SIL Kit Registry Configuration"] = 771,
    ["SPDX 2.3"] = 808,
    SWADL = 824,
    ["Safebox Config"] = 1046,
    ["Sapphire CLI Config"] = 737,
    ["SauceCTL Configuration"] = 994,
    ["Schema Catalog"] = 752,
    ["Scoop manifest"] = 757,
    ["Semantic Data Fabric (SDF) file"] = 761,
    ["Semgrep Rule"] = 763,
    ["Serenity Code Generator (Sergen)"] = 764,
    ["Serverless Framework Configuration"] = 1001,
    ["Serverless Workflow"] = 1003,
    ["Settings for a Cinnamon spice"] = 1135,
    ["Settings.paf"] = 766,
    ["Shopware 6 Configuration"] = 1004,
    ["Shopware CLI Extension Store Configuration"] = 1005,
    ["Shopware CLI Project Store Configuration"] = 1006,
    ["Sigma Detection Rule"] = 768,
    ["Sigrid scope configuration file"] = 769,
    ["SkyPilot Task JSON"] = 1092,
    ["Slack app manifest"] = 773,
    Snapcraft = 775,
    Solidarity = 778,
    ["Solution filters"] = 779,
    ["Source Maps v3"] = 780,
    Sourcery = 781,
    ["Spack bootstrap.yaml"] = 782,
    ["Spack cdash.yaml"] = 783,
    ["Spack ci.yaml"] = 784,
    ["Spack compilers.yaml"] = 785,
    ["Spack concretizer.yaml"] = 786,
    ["Spack config.yaml"] = 787,
    ["Spack definitions.yaml"] = 788,
    ["Spack develop.yaml"] = 789,
    ["Spack env_vars.yaml"] = 790,
    ["Spack environment"] = 796,
    ["Spack include.yaml"] = 791,
    ["Spack mirrors.yaml"] = 792,
    ["Spack modules.yaml"] = 793,
    ["Spack packages.yaml"] = 794,
    ["Spack repos.yaml"] = 795,
    ["Spack toolchains.yaml"] = 797,
    ["Spack upstreams.yaml"] = 798,
    ["Spack view.yaml"] = 799,
    ["Speakeasy Generation Config File"] = 803,
    ["Speakeasy Lint Configuration File"] = 800,
    ["Speakeasy Test Generation Configuration File"] = 801,
    ["Speakeasy Workflow File"] = 802,
    SpecIF = 804,
    ["Specmatic Configuration"] = 805,
    ["Sponge Mixin configuration"] = 806,
    StackBlitz = 812,
    ["StackHawk Scanner Configuration"] = 1000,
    Stale = 813,
    Starfish = 814,
    ["Starlake Data Pipeline"] = 973,
    Starship = 815,
    ["Statamic Blueprint"] = 816,
    ["Stella configuration file"] = 817,
    ["Streamlit configuration file"] = 818,
    ["Stryker Mutator"] = 821,
    ["StyleCop Analyzers Configuration"] = 822,
    ["Stylelint (.stylelintrc)"] = 823,
    ["Stylua Config"] = 1186,
    ["Sublime Syntax"] = 1047,
    ["Subsquid squid manifest"] = 1094,
    ["Swagger API 2.0"] = 825,
    ["Synadia Connect Component"] = 826,
    TSON = 862,
    TSTyche = 863,
    ["TYPO3 Vendor Bundler config"] = 869,
    ["Tab data for a LinUtil"] = 1142,
    ["Tab list for a LinUtil"] = 1141,
    Tach = 827,
    ["Tach Domain"] = 828,
    Talhelper = 830,
    ["Talisman configuration"] = 831,
    Taplo = 1187,
    ["Taskfile config"] = 978,
    Taurus = 832,
    Tauticord = 833,
    ["Tekton Pipeline"] = 1215,
    ["Tekton PipelineRun"] = 1216,
    ["Tekton Task"] = 1213,
    ["Tekton TaskRun"] = 1214,
    Telefonistka = 1173,
    ["Terrateam config"] = 1199,
    ["TestEnvironment.json"] = 845,
    ["TextMate Grammar"] = 844,
    Threagile = 839,
    ["Tier.run pricing.json"] = 836,
    Tikibase = 837,
    Tombi = 842,
    ["Traefik v2"] = 848,
    ["Traefik v2 File Provider"] = 849,
    ["Traefik v3"] = 850,
    ["Traefik v3 File Provider"] = 851,
    ["Travis CI (.travis.yml)"] = 847,
    Treefmt = 414,
    Trident = 1169,
    ["TrueScript for *.tscript files"] = 854,
    ["Tugboat QA config.yml"] = 1166,
    TunnelHub = 1082,
    Turborepo = 846,
    Tycho = 1131,
    Tye = 1008,
    ["Tyk Gateway - Open Source v5.7+"] = 1178,
    ["UET BuildConfig.json"] = 1052,
    ["UI5 Manifest"] = 875,
    ["UNCORS configuration"] = 879,
    ["UTAM Page Object"] = 878,
    ["Ubuntu Server Autoinstall"] = 873,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1170,
    ["Uniswap Token List"] = 960,
    ["Universal Schedule Format"] = 880,
    ["Unreal Engine Uplugin"] = 1053,
    ["Unreal Engine Uproject"] = 1054,
    ["UpCloud CLI (upctl) configuration"] = 1171,
    ["Updatecli Compose"] = 1016,
    ["Updatecli Policy Manifest"] = 1017,
    ["Updatecli Policy Metadata"] = 1018,
    Uplift = 1050,
    ["Upsun config"] = 5,
    ["User Journey Map"] = 982,
    V2Ray = 1022,
    ["VSCode Code Snippets"] = 243,
    ["VSIX CLI publishing"] = 898,
    Vector = 882,
    ["Vela Pipeline Configuration"] = 885,
    Vercel = 242,
    ["Version Bumper config"] = 888,
    Vespertide = 1220,
    ["Vespertide Migration"] = 1221,
    ["Vespertide Model"] = 1222,
    ["Viash Component Config"] = 1175,
    ["Viash Package Config"] = 1176,
    Visivo = 1080,
    ["WP-CLI"] = 908,
    Wake = 1168,
    ["Waku Config"] = 1145,
    ["Web App Manifest"] = 904,
    ["Web types"] = 907,
    WebExtensions = 903,
    ["Webman package recipe"] = 1028,
    ["Windows Package Manager Installer Manifest"] = 956,
    ["Windows Package Manager Locale Manifest"] = 957,
    ["Windows Package Manager Singleton Manifest"] = 955,
    Winutil = 958,
    ["WireMock CLI import configuration"] = 1151,
    ["WireMock CLI local service configuration"] = 1150,
    ["WireMock message stub mapping"] = 1149,
    ["WireMock stub mapping"] = 1148,
    ["Woodpecker pipeline config"] = 996,
    ["Wrangler CLI"] = 909,
    ["Xstate Machine"] = 1014,
    ["Yandex Workflow Language"] = 1137,
    ["Yarn Config (.yarnrc.yml)"] = 971,
    ["Yippee-Ki-JSON configuration YML"] = 962,
    ["YouTrack App"] = 1134,
    ["Zarf Package Configuration"] = 1201,
    ["Zerops.io config"] = 1122,
    ["Zerops.io import"] = 1123,
    ["Zola Configuration"] = 1212,
    ["aerleon.yml"] = 18,
    ["amplify.yml"] = 11,
    ["angular.json"] = 35,
    apko = 1085,
    ...
    ["behat.yml"] = 137,
    ["bigquery-table"] = 126,
    ["bioimageio resource description"] = 1102,
    ...
    ["ccmod.json"] = 1146,
    changelogging = 1114,
    ["chisel-slices.json"] = 269,
    ["chrome-extension-locales-messages.json"] = 250,
    ["chutzpah.json"] = 251,
    cibuildwheel = 172,
    ["clang-format (.clang-format)"] = 1020,
    ["clang-tidy"] = 229,
    clangd = 228,
    clib = 230,
    ["cloud-init: cloud-config userdata"] = 232,
    ["cloud-sdk-pipeline-configuration"] = 253,
    ["cloudbuild.json"] = 254,
    cloudify = 231,
    ["cmdx.yaml"] = 91,
    codemagic = 234,
    ["coffeelint.json"] = 271,
    ["commands.json"] = 246,
    ["commitlint (.commitlintrc)"] = 959,
    ["committed.toml"] = 272,
    ["compile_commands.json"] = 245,
    ["compilerconfig.json"] = 244,
    ["completely.yml"] = 1058,
    ["component-detection-manifest.json"] = 275,
    ["component.json"] = 274,
    ["composer.json"] = 273,
    ["conda-forge"] = 176,
    ["config.yaml"] = 692,
    ["contentmanifest.json"] = 252,
    ["contribute.json"] = 276,
    ["cosmos.config.json"] = 248,
    ["crowdin.yml"] = 277,
    ["ctfd-setup configuration file"] = 1158,
    ["custom-elements.json"] = 1072,
    ["cypress.json"] = 281,
    ["datalogic-scan2deploy-android"] = 291,
    ["datalogic-scan2deploy-ce"] = 292,
    ...
    ["ddev-global"] = 293,
    ["ddev-project"] = 294,
    ["debugsettings.json"] = 295,
    ["dependabot-v2.json"] = 298,
    ["dependabot.json"] = 297,
    ["deployed-cli"] = 1013,
    ["devcontainer.json"] = 236,
    devinit = 964,
    ["devspace.yaml"] = 1036,
    djlint = 965,
    ["docker bake"] = 304,
    ["docker sequencer"] = 305,
    ["docker-compose.yml"] = 963,
    ["dockerd.json"] = 302,
    ["dotnet Release Index manifest"] = 317,
    ["dotnet-tools.json"] = 318,
    ["dotnetcli.host.json"] = 319,
    ["dprint.json"] = 320,
    ["drone.json"] = 321,
    ["dss-2.0.0.json"] = 323,
    ["dstack configuration"] = 324,
    ["dtool dataset metadata"] = 1153,
    ["dvc.yaml"] = 325,
    ["ecosystem.json"] = 330,
    eksctl = 332,
    ["electron-builder configuration file"] = 338,
    ["epr-manifest.json"] = 337,
    ["evcc.yaml"] = 339,
    ["ezd task runner"] = 349,
    ["fabric.mod.json"] = 351,
    ["first-timers-bot"] = 359,
    ["flagd flag configuration"] = 112,
    ["fly.io Configuration"] = 113,
    fulibWorkflows = 995,
    ["function.json"] = 371,
    ["gRPC API Gateway & OpenAPI Config"] = 13,
    ["gematik health care insurance list"] = 1164,
    ["gematik health care patient list"] = 1161,
    ["gematik health care provider institution list"] = 1163,
    ["gematik health care provider list"] = 1162,
    ["gematik tiger test environment configuration"] = 1165,
    ["git-town.toml"] = 1210,
    ["gitlab-ci"] = 389,
    ["global.json"] = 405,
    ["go-feature-flag Flag Configuration"] = 408,
    ["haxelib.json"] = 426,
    helmfile = 951,
    helmwave = 952,
    ["host-meta.json"] = 433,
    ...
    ["ide.host.json"] = 441,
    ["ifstate.yaml"] = 442,
    ["imageoptimizer.json"] = 443,
    ["importmap.json"] = 446,
    instant_python_config = 448,
    instant_python_custom_project = 449,
    ["ioBroker Configuration"] = 450,
    ["ioBroker JSON UI"] = 451,
    ["ioBroker Package manifest"] = 452,
    ["ixpect.conf.yaml"] = 453,
    ["ize.toml"] = 1049,
    ["jsconfig.json"] = 478,
    ["jscpd Configuration"] = 1033,
    jsdoc = 947,
    ["k3d.yaml"] = 479,
    ["k9s aliases.yaml"] = 481,
    ["k9s cluster-config.yaml"] = 483,
    ["k9s config.yaml"] = 482,
    ["k9s hotkeys.yaml"] = 484,
    ["k9s plugins.yaml"] = 485,
    ["k9s skin.yaml"] = 486,
    ["k9s views.yaml"] = 487,
    ["kontinuous-config.yaml"] = 498,
    ["kontinuous-values.yaml"] = 497,
    ["kustomization.yaml"] = 500,
    ["label-commenter-config.yml"] = 501,
    ["latexindent configuration"] = 106,
    ["launchsettings.json"] = 502,
    lazydocker = 1071,
    lazygit = 1070,
    ["lego.json"] = 504,
    ["lerna.json"] = 505,
    ["lgtm.yml"] = 506,
    ["liblab.config.json"] = 507,
    ["libman.json"] = 508,
    ["license-report-config.json"] = 509,
    ["linkinator.config.json"] = 511,
    ["lint-staged (.lintstagedrc)"] = 925,
    ["local.settings.json"] = 516,
    ["localazy.json"] = 517,
    ["lotus.yaml"] = 515,
    ["lsdlschema.json"] = 518,
    ["macro.json"] = 1037,
    ["markdown-link-check"] = 991,
    maturin = 992,
    mboats = 999,
    ["micro-settings.json"] = 1064,
    ["mimetypes.json"] = 532,
    ["mirrord config"] = 927,
    mise = 928,
    ["mkdocs.yml"] = 552,
    ...
    ["monospace.yml"] = 556,
    ["moon.yml"] = 1147,
    ["mprocs Configuration file"] = 1118,
    ["mrdocs.yml"] = 553,
    ["mta.yaml"] = 929,
    ["mtad.yaml"] = 930,
    ["mycode.json"] = 563,
    nFPM = 570,
    ["napari plugin manifest"] = 564,
    neoload = 942,
    ["nest-cli"] = 573,
    ["ninjs (News in JSON)"] = 572,
    ["nitro.json"] = 941,
    ["nixd configuration"] = 1090,
    ["nlu.json"] = 574,
    ["nodemon.json"] = 576,
    ["noodl config"] = 998,
    ["notebook.mod.json"] = 577,
    now = 937,
    ["npm-badges"] = 580,
    ["nswag.json"] = 584,
    ntangle = 586,
    ["nuclei-template.yaml"] = 581,
    ["nuget-project.json"] = 582,
    ["ocelot.json"] = 588,
    ogen = 591,
    ["omnisharp.json"] = 594,
    openHAB = 1223,
    ...
    oxlint = 1234,
    ["package.json"] = 628,
    ["package.manifest"] = 630,
    ["package.yaml"] = 629,
    ["partial-black.json"] = 138,
    ["partial-pixi.json"] = 638,
    ["pathfinder.yml"] = 633,
    ["pattern.json"] = 636,
    ["petstore-v1.0"] = 1044,
    pgap_yaml_input_reader = 635,
    pgxgen = 1227,
    pitcms = 1230,
    ["pixi.toml"] = 637,
    ["plagiarize-me.yaml"] = 642,
    ["plagiarize.yaml"] = 641,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1154,
    ["podbard.yaml"] = 644,
    ["portman.json"] = 647,
    ["prefect.toml"] = 655,
    ["prefect.yaml"] = 656,
    ...
    ["prettierrc.json"] = 658,
    ["prisma.yml"] = 659,
    ["project-1.0.0-beta3.json"] = 671,
    ["project-1.0.0-beta4.json"] = 672,
    ["project-1.0.0-beta5.json"] = 673,
    ["project-1.0.0-beta6.json"] = 674,
    ["project-1.0.0-beta8.json"] = 675,
    ["project-1.0.0-rc1.json"] = 676,
    ["project-1.0.0-rc2.json"] = 677,
    ["project.json"] = 670,
    ["project.owasp.yaml"] = 678,
    ["prometheus-alertmanager.json"] = 682,
    ["prometheus.json"] = 679,
    ["prometheus.rules.json"] = 680,
    ["prometheus.rules.test.json"] = 681,
    ["proxies.json"] = 683,
    ["publiccode.yml"] = 684,
    ["pubspec.yaml"] = 685,
    ["pyrseas-0.8.json"] = 688,
    pytest = 697,
    ["quilt.mod.json"] = 1065,
    ["rc3 auth"] = 703,
    ["rc3 collection"] = 704,
    ...
    ["release drafter"] = 943,
    ["release-hub.json"] = 2,
    ["release-please-config.json"] = 713,
    ["release-please-manifest.json"] = 714,
    ["release-plz.toml"] = 715,
    ["renv.lock"] = 727,
    ["rivet.json"] = 1089,
    ["rivet.yaml (legacy)"] = 1088,
    rumdl = 732,
    runny = 731,
    rustfmt = 733,
    sake = 1181,
    samt = 735,
    samtrc = 736,
    ["sarif-1.0.0.json"] = 738,
    ["sarif-2.0.0.json"] = 739,
    ["sarif-2.1.0"] = 749,
    ["sarif-2.1.0-rtm.2"] = 740,
    ["sarif-2.1.0-rtm.3"] = 742,
    ["sarif-2.1.0-rtm.4"] = 744,
    ["sarif-2.1.0-rtm.5"] = 746,
    ["sarif-2.1.0-rtm.6"] = 747,
    ["sarif-external-property-file-2.1.0"] = 750,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 741,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 743,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 745,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 748,
    ["scalingo.json configuration"] = 751,
    ["schema.org - Action"] = 753,
    ["schema.org - ContactPoint"] = 754,
    ["schema.org - Place"] = 755,
    ["schema.org - Thing"] = 756,
    ["secrethub.yml"] = 1067,
    ["semantic-release"] = 762,
    ["servicehub.config.json"] = 920,
    ["servicehub.service.json"] = 919,
    ["settings.job"] = 765,
    ["sfdx-hardis configuration"] = 767,
    ["shard.yml"] = 1105,
    ["size-limit configuration"] = 772,
    ["skaffold.yaml"] = 989,
    ["skyuxconfig.json"] = 774,
    ["snowflake-config"] = 776,
    ["snowflake-connections"] = 777,
    ["spicepod.yaml"] = 1126,
    ["sqlc configuration"] = 809,
    ["stripe-app-local.json"] = 820,
    ["stripe-app.json"] = 819,
    swcrc = 974,
    ["task.json"] = 829,
    taskcat = 938,
    ["template.json"] = 834,
    ["templatsources.json"] = 835,
    ["text2confl config"] = 1235,
    ["theme.json"] = 838,
    ["tizen_workspace.json"] = 840,
    tldr = 841,
    ["tm_devices configuration file"] = 1192,
    tmuxinator = 923,
    tox = 843,
    ["transcend.yml"] = 852,
    ["tree-sitter grammar.json"] = 413,
    ["trime.yaml"] = 853,
    ["trunk.yaml"] = 855,
    ["ts-force-config.json"] = 860,
    ["tsconfig.json"] = 856,
    ["tsd.json"] = 857,
    ["tsdoc.json"] = 858,
    ["tsdrc.json"] = 859,
    ...
    v8r = 902,
    vcluster = 1112,
    ["vcpkg configuration file"] = 241,
    ["vcpkg manifest file"] = 240,
    ["vega-lite.json"] = 884,
    ["vega.json"] = 883,
    ["venvironment.yaml"] = 886,
    ["venvplus.yaml"] = 887,
    version = 1174,
    ["version.json"] = 889,
    ["vhwdebugger-binding.yaml"] = 891,
    ["vim-addon-info"] = 892,
    ["vs-2017.3.host.json"] = 894,
    ["vs-nesting.json"] = 895,
    ["vsls.json"] = 893,
    ["vss-extension.json"] = 899,
    vtcfg = 1180,
    ["vtesttree.yaml"] = 900,
    ["vtestunit.yaml"] = 901,
    ["warp-keysets.json"] = 1073,
    ["warp-themes.json"] = 1074,
    ["warp-workflows.json"] = 1075,
    ["webhint.io"] = 1029,
    ["webjobpublishsettings.json"] = 906,
    ["webjobs-list.json"] = 905,
    ["well-known-fursona"] = 1113,
    ["xs-app.json"] = 933,
    ["xunit.runner.json"] = 918,
    yamllint = 961,
    zizmor = 1217,
    zuul = 944,
    ["Žinoma"] = 954
