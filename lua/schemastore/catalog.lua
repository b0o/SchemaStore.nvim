...
M.json = {
  ...
  index = {
    ...
    ["<div>RIOTS' studio configuration"] = 708,
    ...
    ["Adobe UXP Manifest"] = 893,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Airplane task"] = 17,
    ["Alacritty Configuration"] = 800,
    ["All Contributors configuration file"] = 858,
    ...
    ["Application list for a WinUtil"] = 937,
    ["Argo Events"] = 29,
    ["Argo Workflows"] = 30,
    AssemblyScript = 33,
    AsyncAPI = 34,
    ...
    ["BX CI"] = 104,
    ["Bashly (bashly.yml)"] = 862,
    ["Bashly Settings (bashly-settings.yml)"] = 863,
    ["Better Code Hub"] = 772,
    ["Better Scripts"] = 105,
    Bigconfig = 81,
    BizTalkServerApplicationSchema = 742,
    Bleep = 106,
    ...
    ["Butane Config"] = 813,
    ["CGS Custom Card Game (CardGameDef.json)"] = 898,
    ["CICS TS region tagging"] = 822,
    ["CICS TS resource import"] = 823,
    ["CICS TS resource model"] = 824,
    ["CICS TS resource overrides"] = 825,
    ["CMake Presets"] = 107,
    ["CNC Codes"] = 121,
    ["CRS WAF test file"] = 927,
    ["CRS WAF test platform overrides file"] = 928,
    ...
    CityJSON = 117,
    ["Clawject config"] = 126,
    ["Cloud Foundry Application Manifest"] = 910,
    ["Cloud Run Spec v1"] = 932,
    ...
    Concord = 926,
    ["Configu .cfgu files"] = 915,
    ["Configu .configu file"] = 916,
    Conjure = 120,
    ["Container Structure Test"] = 755,
    Containerlab = 780,
    ["Crowdsec collection config"] = 210,
    ["Crowdsec parser config"] = 211,
    ["Crowdsec scenario config"] = 212,
    ["CumulusCI Config"] = 125,
    ["Custom Machinery Machine"] = 899,
    ["Custom Machinery Recipe"] = 900,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 870,
    ["EAS config"] = 276,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 859,
    ...
    ["Goreleaser Pro"] = 333,
    Goss = 334,
    ["Gradle Build Cache Node"] = 770,
    ["Gradle Enterprise"] = 769,
    ...
    Hadolint = 751,
    Hammerkit = 779,
    ["Hardware Sentry Configuration"] = 833,
    Hatch = 752,
    Hayson = 347,
    ...
    ["JFrog File Spec"] = 375,
    ["JFrog Pipelines YML DSL"] = 842,
    ["JMeter DSL cli config"] = 376,
    JReleaser = 378,
    ["JSON Document Transform"] = 386,
    ["JSON Feed"] = 387,
    ["JSON Resume"] = 573,
    ["JSON Schema Draft 2020-12"] = 721,
    ["JSON Schema Draft 4"] = 718,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 880,
    ["JSON Schema Draft 7"] = 719,
    ["JSON Schema Draft 7 (unofficial strict)"] = 881,
    ["JSON Schema Draft 8 (2019-09)"] = 720,
    ["JSON-API"] = 385,
    ["JSON-WF"] = 909,
    ["JSON-e templates"] = 777,
    ["JSON-stat 2.0"] = 715,
    JSONPatch = 389,
    ...
    ["Keycloak REST API"] = 850,
    ["Knative Functions - func.yaml"] = 295,
    ["KoDE/CI build.yaml"] = 838,
    ["Kong DBLess config"] = 839,
    KrakenD = 402,
    ...
    ["Metadata for a Cinnamon spice"] = 935,
    ["MetricsHub Configuration"] = 435,
    ["MetricsHub Connector Configuration"] = 436,
    ["Micro Editor Syntax"] = 871,
    ["Microsoft Band Web Tile"] = 437,
    ["Microsoft RulesEngine workflow rules"] = 923,
    ["Microsoft RulesEngine workflow rules list"] = 924,
    ["Minecraft Custom Main Menu Mod"] = 888,
    ...
    ["MongoDB Atlas Search Index Definition"] = 837,
    ["Monika Configuration"] = 835,
    ["Monoweave Configuration"] = 461,
    ["Motif config"] = 735,
    ["NOX Framework (Service)"] = 478,
    ["Netin Diagnostic System Template"] = 795,
    ["Netlify config"] = 469,
    ...
    ["OpenUtau ustx"] = 491,
    ["OpenWeather Current Weather API"] = 776,
    ["OpenWeather Road Risk API"] = 775,
    ...
    ["Pipeline component"] = 787,
    ["PocketMine plugin.yml"] = 517,
    ["Postman collection"] = 523,
    ["Preset list for a WinUtil"] = 938,
    ["Problem object RFC9457"] = 885,
    ...
    Qgoda = 555,
    Qodana = 805,
    ["Qt Creator workspace file"] = 917,
    ["Quali Torque Blueprint Spec 2"] = 830,
    ["QueryFirst config file"] = 853,
    ["RKE Cluster Configuration JSON"] = 784,
    ["RKE Cluster Configuration YAML"] = 783,
    ["Rancher Fleet"] = 549,
    ["Rattler-build"] = 556,
    Ray = 750,
    ["Read the Docs"] = 551,
    ...
    ["Render Blueprints"] = 782,
    RenderCV = 575,
    Renovate = 574,
    ["Replit config"] = 569,
    RoadRunner = 576,
    ["Rudder techniques"] = 891,
    Ruff = 571,
    ["Rust Project"] = 572,
    ["Rust toolchain"] = 580,
    ...
    ["SauceCTL Configuration"] = 792,
    ["Schema Catalog"] = 597,
    ["Scoop manifest"] = 602,
    ["Semantic Data Fabric (SDF) file"] = 606,
    ["Semgrep Rule"] = 608,
    ["Serenity Code Generator (Sergen)"] = 609,
    ["Serverless Framework Configuration"] = 799,
    ["Serverless Workflow"] = 801,
    ["Settings for a Cinnamon spice"] = 934,
    ["Settings.paf"] = 611,
    ["Shopware 6 Configuration"] = 802,
    ["Shopware CLI Extension Store Configuration"] = 803,
    ["Shopware CLI Project Store Configuration"] = 804,
    Sigma = 613,
    ["Sigrid scope configuration file"] = 614,
    ["SkyPilot Task JSON"] = 892,
    ...
    StackBlitz = 634,
    ["StackHawk Scanner Configuration"] = 798,
    Stale = 635,
    ["Starlake Data Pipeline"] = 773,
    Starship = 636,
    ["Statamic Blueprint"] = 637,
    ["Stella configuration file"] = 638,
    ["StrmPrivacy Data Connector"] = 847,
    ["StrmPrivacy Data Contract"] = 848,
    ["StrmPrivacy SimpleSchema"] = 845,
    ["StrmPrivacy Stream"] = 846,
    ["StrmPrivacy batch job configuration file"] = 844,
    ["Stryker Mutator"] = 641,
    ["StyleCop Analyzers Configuration"] = 642,
    ["Stylelint (.stylelintrc)"] = 643,
    ["Sublime Syntax"] = 849,
    ["Subsquid squid manifest"] = 894,
    ["Swagger API 2.0"] = 645,
    TSON = 673,
    TSTyche = 674,
    ["Tab data for a LinUtil"] = 940,
    ["Tab list for a LinUtil"] = 939,
    Talhelper = 647,
    ["Talisman configuration"] = 648,
    ["Taskfile config"] = 778,
    Taurus = 649,
    ["TestEnvironment.json"] = 658,
    ["TextMate Grammar"] = 657,
    ["Tier.run pricing.json"] = 652,
    Tikibase = 653,
    ["Traefik v2"] = 661,
    ["Traefik v2 File Provider"] = 662,
    ["Travis CI (.travis.yml)"] = 660,
    ["TrueScript for *.tscript files"] = 665,
    TunnelHub = 884,
    Turborepo = 659,
    Tycho = 930,
    Tye = 806,
    ["UET BuildConfig.json"] = 854,
    ["UI5 Manifest"] = 683,
    ["UNCORS configuration"] = 687,
    ["UTAM Page Object"] = 686,
    ["Ubuntu Server Autoinstall"] = 681,
    ["Uniswap Token List"] = 761,
    ["Unreal Engine Uplugin"] = 855,
    ["Unreal Engine Uproject"] = 856,
    ["Updatecli Compose"] = 814,
    ["Updatecli Policy Manifest"] = 815,
    ["Updatecli Policy Metadata"] = 816,
    Uplift = 852,
    ["User Journey Map"] = 781,
    V2Ray = 820,
    ["VSCode Code Snippets"] = 176,
    ["VSIX CLI publishing"] = 703,
    ["Vela Pipeline Configuration"] = 691,
    Vercel = 175,
    Visivo = 882,
    ["Web App Manifest"] = 710,
    ["Web types"] = 713,
    WebExtensions = 709,
    ["Webman package recipe"] = 826,
    ["Windows Package Manager Installer Manifest"] = 758,
    ["Windows Package Manager Locale Manifest"] = 759,
    ["Windows Package Manager Singleton Manifest"] = 757,
    ["Woodpecker pipeline config"] = 794,
    ["Wrangler CLI"] = 714,
    ["Xstate Machine"] = 812,
    ["Yandex Workflow Language"] = 936,
    ["Yarn Config (.yarnrc.yml)"] = 771,
    ["Yippee-Ki-JSON configuration YML"] = 763,
    ["YouTrack App"] = 933,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 18,
    apko = 886,
    ...
    ["behat.yml"] = 89,
    ["bigquery-table"] = 80,
    ["bioimageio resource description"] = 902,
    ...
    ["lint-staged (.lintstagedrc)"] = 729,
    ["local.settings.json"] = 425,
    ["localazy.json"] = 426,
    ["lotus.yaml"] = 424,
    ["lsdlschema.json"] = 427,
    ["markdown-link-check"] = 790,
    mboats = 797,
    ["micro-settings.json"] = 866,
    ["mimetypes.json"] = 438,
    ["mirrord config"] = 730,
    mise = 731,
    ["mise-settings"] = 732,
    ...
    ["servicehub.config.json"] = 724,
    ["servicehub.service.json"] = 723,
    ["settings.job"] = 610,
    ...
    taskcat = 741,
    ["template.json"] = 650,
    ["templatsources.json"] = 651,
    ["theme.json"] = 654,
    ["tizen_workspace.json"] = 655,
    tldr = 656,
    tmuxinator = 727,
    ["transcend.yml"] = 663,
    ...
    ["vega-lite.json"] = 690,
    ["vega.json"] = 689,
    ["venvironment-basic.yaml"] = 693,
    ["venvironment.yaml"] = 692,
    ["version.json"] = 694,
    ["vhwdebugger-binding.yaml"] = 696,
    ["vim-addon-info"] = 697,
    ["vs-2017.3.host.json"] = 699,
    ["vs-nesting.json"] = 700,
    ["vsls.json"] = 698,
    ["vss-extension.json"] = 704,
    ["vtesttree.yaml"] = 705,
    ["vtestunit.yaml"] = 706,
    ["warp-keysets.json"] = 875,
    ["warp-themes.json"] = 876,
    ["warp-workflows.json"] = 877,
    ["webhint.io"] = 827,
    ["webjobpublishsettings.json"] = 712,
    ["webjobs-list.json"] = 711,
    ["well-known-fursona"] = 913,
    ["xs-app.json"] = 737,
    ["xunit.runner.json"] = 722,
    yamllint = 762,
    ["zerops.io import file"] = 922,
    ["zerops.yml"] = 921,
    zuul = 746,
    ["Žinoma"] = 756
  },
