...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 149,
    [".cryproj (generic)"] = 499,
    [".cryproj engine-5.2"] = 494,
    [".cryproj engine-5.3"] = 495,
    [".cryproj engine-5.4"] = 496,
    [".cryproj engine-5.5"] = 497,
    [".cryproj engine-dev"] = 498,
    [".csscomb.json"] = 151,
    [".csslintrc"] = 152,
    [".eslintrc"] = 197,
    [".esmrc.json"] = 189,
    ...
    [".mtaext"] = 508,
    [".nodehawkrc"] = 315,
    [".npmpackagejsonlintrc"] = 318,
    [".phraseapp.yml"] = 352,
    [".pmbot.yml"] = 344,
    [".postcssrc"] = 349,
    [".pre-commit-config.yml"] = 350,
    [".pre-commit-hooks.yml"] = 351,
    [".putout.json"] = 369,
    [".rehyperc"] = 376,
    [".remarkrc"] = 377,
    [".sprite files"] = 420,
    ...
    ["Azure Pipelines"] = 47,
    ["Azure Static Web Apps CLI configuration file"] = 422,
    ["Azure Static Web Apps configuration file"] = 421,
    ["BX CI"] = 80,
    ["Better Code Hub"] = 542,
    ["Better Scripts"] = 81,
    BizTalkServerApplicationSchema = 514,
    ...
    ["Butane Config"] = 580,
    ["CICS TS region tagging"] = 587,
    ["CICS TS resource import"] = 588,
    ["CICS TS resource model"] = 589,
    ["CICS TS resource overrides"] = 590,
    ["CMake Presets"] = 82,
    ...
    ["Datadog Service Definition"] = 270,
    ["Datahub Ingestion Recipe Schema"] = 594,
    ["Deadpendency Config Schema"] = 95,
    ...
    ["Embrace Config Schema"] = 605,
    ["Error pages"] = 192,
    Esquio = 190,
    ["Estuary Flow Catalog Schema"] = 584,
    ["Expo SDK"] = 195,
    ...
    Goreleaser = 223,
    ["Goreleaser Pro"] = 224,
    ["Gradle Build Cache Node"] = 539,
    ["Gradle Enterprise"] = 538,
    ...
    Hadolint = 523,
    Hammerkit = 549,
    ["Hardware Sentry Configuration"] = 598,
    Hayson = 236,
    ...
    Hugo = 576,
    ["Istanbul Schema"] = 601,
    ["JDownloader2 crawler multi-rule schema"] = 254,
    ["JDownloader2 crawler single-rule schema"] = 253,
    ["JFrog File Spec"] = 255,
    ["JFrog Pipelines YML DSL"] = 607,
    ["JSON Document Transform"] = 263,
    ["JSON Feed"] = 264,
    ["JSON Resume"] = 382,
    ["JSON Schema Draft 2020-12"] = 490,
    ["JSON Schema Draft 4"] = 487,
    ["JSON Schema Draft 7"] = 488,
    ["JSON Schema Draft 8"] = 489,
    ...
    ["JSON-API"] = 262,
    ["JSON-e templates"] = 547,
    ["JSON-stat 2.0"] = 484,
    JSONPatch = 266,
    Jasmine = 249,
    Jekyll = 250,
    ["Jenkins X Pipelines"] = 251,
    ["Jenkins X Requirements"] = 252,
    ["Jovo Language Models"] = 256,
    ["KSP-AVC"] = 485,
    ["KSP-CKAN"] = 486,
    ["Keycloak REST API"] = 613,
    ["Knative Functions - func.yaml"] = 207,
    ["KoDE/CI build.yaml"] = 603,
    ["Kong DBLess Schema"] = 604,
    KrakenD = 269,
    ["LinkML Metamodel"] = 281,
    Liquibase = 554,
    ["Liquibase Flow File"] = 555,
    Markdownlint = 558,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 602,
    ["Monika Configuration Schema"] = 600,
    ["Motif config"] = 507,
    ["NOX Framework (Service)"] = 317,
    ["Netin Diagnostic System Template"] = 563,
    ["Netlify config schema"] = 309,
    ["Nightwatch.js"] = 310,
    ["OSS Review Toolkit configuration"] = 334,
    ["OSS Review Toolkit curation"] = 335,
    ["OSS Review Toolkit package configuration"] = 336,
    ["OSS Review Toolkit repository configuration"] = 337,
    ["OSS Review Toolkit resolutions"] = 338,
    Opctl = 510,
    ["OpenWeather Current Weather API"] = 546,
    ["OpenWeather Road Risk API"] = 545,
    ["Ory Hydra configuration"] = 242,
    ["Ory Keto configuration"] = 271,
    ["Ory Kratos configuration"] = 333,
    ["Ory Oathkeeper configuration"] = 324,
    ["Outblocks App configuration"] = 331,
    ["Outblocks database table"] = 332,
    ["Outblocks project configuration"] = 330,
    Packer = 341,
    Pantsbuild = 619,
    ["Pipeline component"] = 556,
    ["PocketMine plugin.yml"] = 345,
    Pterodactyl = 597,
    ["Pull Request Labeler"] = 368,
    Pulumi = 372,
    PyProject = 373,
    Qodana = 573,
    ["Quali Torque Blueprint Spec 2"] = 595,
    ["QueryFirst config file"] = 616,
    ["RKE Cluster Configuration JSON Schema"] = 553,
    ["RKE Cluster Configuration YAML Schema"] = 552,
    Ray = 522,
    ["Read the Docs"] = 371,
    ["Red-DiscordBot Cog"] = 374,
    ["Red-DiscordBot Cog Repo"] = 375,
    Renovate = 383,
    ["Replit schema"] = 378,
    RoadRunner = 384,
    Ruff = 380,
    ["Rust Project"] = 381,
    ["Rust toolchain"] = 386,
    ["SIL Kit Participant Configuration"] = 411,
    SWADL = 431,
    ["Sapphire CLI Config"] = 387,
    ["SauceCTL Configuration"] = 560,
    ["Schema Catalog"] = 400,
    ["Scoop manifest"] = 405,
    ["Semgrep Rule"] = 407,
    ["Serverless Framework Configuration"] = 567,
    ["Serverless Workflow Schema"] = 569,
    ["Settings.paf"] = 409,
    ["Shopware 6 Configuration"] = 570,
    ["Shopware CLI Extension Store Configuration"] = 571,
    ["Shopware CLI Project Store Configuration"] = 572,
    Solidarity = 415,
    ["Solution filters"] = 416,
    ["Source Maps v3"] = 417,
    SpecIF = 418,
    ["Sponge Mixin configuration"] = 419,
    ["StackHawk Scanner Configuration"] = 566,
    Stale = 423,
    Starship = 424,
    ["Statamic Blueprint"] = 425,
    ["StrmPrivacy Data Connector"] = 611,
    ["StrmPrivacy Data Contract"] = 612,
    ["StrmPrivacy SimpleSchema"] = 609,
    ["StrmPrivacy Stream"] = 610,
    ["StrmPrivacy batch job configuration file"] = 608,
    ["Stryker Mutator"] = 428,
    ["StyleCop Analyzers Configuration"] = 429,
    ["Swagger API 2.0"] = 432,
    TSON = 452,
    ["Talisman configuration"] = 433,
    ["Taskfile YAML Schema"] = 548,
    Taurus = 434,
    ["TestEnvironment.json"] = 441,
    Tikibase = 437,
    ["Traefik v2"] = 444,
    ["Traefik v2 File Provider"] = 445,
    Turborepo = 442,
    Tye = 574,
    ["UI5 Manifest"] = 459,
    ["UTAM Page Object"] = 462,
    ["Ubuntu Server Autoinstall"] = 457,
    ["Uniswap Token List"] = 531,
    ["Unreal Engine Uplugin"] = 617,
    ["Unreal Engine Uproject"] = 618,
    Updatecli = 581,
    Uplift = 615,
    ["User Journey Map YAML Schema"] = 551,
    V2Ray = 585,
    ["VSCode Code Snippets"] = 125,
    ["VSIX CLI publishing"] = 475,
    ["Vela Pipeline Configuration"] = 465,
    Vercel = 124,
    ["Web App Manifest"] = 480,
    ["Web types"] = 483,
    WebExtensions = 479,
    ["Webman package recipe"] = 591,
    ["Windows Package Manager Installer Manifest"] = 528,
    ["Windows Package Manager Locale Manifest"] = 529,
    ["Windows Package Manager Singleton Manifest"] = 527,
    ["Woodpecker pipeline config"] = 562,
    ["Xstate Machine Schema"] = 579,
    ["Yippee-Ki-JSON configuration YML"] = 533,
    ["angular.json"] = 11,
    ...
    huskyrc = 502,
    ["ide.host.json"] = 243,
    ["imageoptimizer.json"] = 244,
    ["importmap.json"] = 246,
    ["ioBroker JSON UI"] = 247,
    ["ioBroker Package manifest"] = 248,
    ["ize.toml"] = 614,
    ["jsconfig.json"] = 267,
    ["jscpd Configuration Schema"] = 596,
    jsdoc = 521,
    ["k3d.yaml"] = 268,
    ["kustomization.yaml"] = 272,
    ["label-commenter-config.yml"] = 273,
    ["launchsettings.json"] = 274,
    ["lego.json"] = 275,
    ["lerna.json"] = 276,
    ["lgtm.yml"] = 277,
    ["libman.json"] = 278,
    ["license-report-config.json"] = 279,
    ["linkinator.config.json"] = 280,
    ["local.settings.json"] = 282,
    ["localazy.json"] = 283,
    ["lsdlschema.json"] = 284,
    ["markdown-lint-check"] = 559,
    mboats = 565,
    ["mimetypes.json"] = 291,
    ["mirrord-schema"] = 504,
    ["mta.yaml"] = 505,
    ["mtad.yaml"] = 506,
    ["mycode.json"] = 307,
    ["napari plugin manifest"] = 308,
    neoload = 516,
    ["nest-cli"] = 313,
    ["ninjs (News in JSON) 1.3"] = 312,
    ["ninjs (News in JSON) 2.0"] = 311,
    ["nlu.json"] = 314,
    ["nodemon.json"] = 316,
    ["noodl.schema.json"] = 564,
    now = 512,
    ["npm-badges"] = 319,
    ["nswag.json"] = 322,
    ntangle = 323,
    ["nuclei-template.yaml"] = 320,
    ["nuget-project.json"] = 321,
    ["ocelot.json"] = 325,
    ["omnisharp.json"] = 326,
    ["openapi.json"] = 327,
    ["openfin.json"] = 329,
    ["openrpc.json"] = 328,
    ["package.json"] = 339,
    ["package.manifest"] = 340,
    ["pattern.json"] = 343,
    ["petstore-v1.0"] = 606,
    pgap_yaml_input_reader = 342,
    ["plagiarize-me.yaml"] = 347,
    ["plagiarize.yaml"] = 346,
    ["portman.json"] = 348,
    ["prettierrc.json"] = 353,
    ["prisma.yml"] = 354,
    ["project-1.0.0-beta3.json"] = 356,
    ["project-1.0.0-beta4.json"] = 357,
    ["project-1.0.0-beta5.json"] = 358,
    ["project-1.0.0-beta6.json"] = 359,
    ["project-1.0.0-beta8.json"] = 360,
    ["project-1.0.0-rc1.json"] = 361,
    ["project-1.0.0-rc2.json"] = 362,
    ["project.json"] = 355,
    ["prometheus.json"] = 363,
    ["prometheus.rules.json"] = 364,
    ["proxies.json"] = 365,
    ["publiccode.yml"] = 366,
    ["pubspec.yaml"] = 367,
    ["pyrseas-0.8.json"] = 370,
    ["release drafter"] = 517,
    rustfmt = 385,
    ["sarif-1.0.0.json"] = 388,
    ["sarif-2.0.0.json"] = 389,
    ["sarif-2.1.0"] = 398,
    ["sarif-2.1.0-rtm.2"] = 390,
    ["sarif-2.1.0-rtm.3"] = 392,
    ["sarif-2.1.0-rtm.4"] = 394,
    ["sarif-2.1.0-rtm.5"] = 396,
    ["sarif-external-property-file-2.1.0"] = 399,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 391,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 393,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 395,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 397,
    ["schema.org - Action"] = 401,
    ["schema.org - ContactPoint"] = 402,
    ["schema.org - Place"] = 403,
    ["schema.org - Thing"] = 404,
    ["semantic-release"] = 406,
    ["servicehub.config.json"] = 493,
    ["servicehub.service.json"] = 492,
    ["settings.job"] = 408,
    ["sfdx-hardis configuration"] = 410,
    ["size-limit configuration"] = 412,
    ["skaffold.yaml"] = 557,
    ["skyuxconfig.json"] = 413,
    snapcraft = 414,
    ["stripe-app-local.json"] = 427,
    ["stripe-app.json"] = 426,
    swcrc = 544,
    taskcat = 513,
    ["template.json"] = 435,
    ["templatsources.json"] = 436,
    ["theme.json"] = 438,
    ["tizen_workspace.json"] = 439,
    tmLanguage = 440,
    tmuxinator = 501,
    ["trunk.yaml schema"] = 446,
    ["ts-force-config.json"] = 450,
    ["tsconfig.json"] = 447,
    ["tsd.json"] = 448,
    ["tsdrc.json"] = 449,
    ["tslint.json"] = 451,
    ...
    ["vega-lite.json"] = 464,
    ["vega.json"] = 463,
    ["venvironment-basic.yaml"] = 467,
    ["venvironment.yaml"] = 466,
    ["version.json"] = 468,
    ["vim-addon-info"] = 469,
    ["vs-2017.3.host.json"] = 471,
    ["vs-nesting.json"] = 472,
    ["vsls.json"] = 470,
    ["vss-extension.json"] = 476,
    ["webhint.io"] = 592,
    ["webjobpublishsettings.json"] = 482,
    ["webjobs-list.json"] = 481,
    ["xs-app.json"] = 509,
    ["xunit.runner.json"] = 491,
    yamllint = 532,
    zuul = 518,
    ["Žinoma"] = 526
  },
