...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 998,
    [".nodehawkrc"] = 630,
    [".npmpackagejsonlintrc"] = 634,
    [".omletrc"] = 1179,
    [".phrase.yml"] = 712,
    [".phraseapp.yml"] = 713,
    [".pmbot.yml"] = 697,
    [".postcssrc"] = 706,
    [".powerpages-web-template-manifest"] = 708,
    [".pre-commit-config.yml"] = 709,
    [".pre-commit-hooks.yml"] = 710,
    [".putout.json"] = 746,
    [".rehyperc"] = 771,
    [".remarkrc"] = 775,
    [".sprite files"] = 871,
    ...
    AIConfig = 37,
    ["AMX Muse Program Descriptor"] = 1228,
    ["API Builder"] = 1034,
    ["AVA Configuration"] = 1098,
    ...
    ["AWS Copilot Manifest"] = 1267,
    ["AWS SAM CLI Samconfig"] = 278,
    Acton = 1318,
    ["Adobe UXP Manifest"] = 1161,
    ["Aerleon Network & Service Definitions"] = 23,
    ["Aerleon Policy"] = 24,
    ["Agent Permission Policy"] = 1307,
    ["AgentCore CLI"] = 1308,
    AgentLoopKit = 1309,
    Aider = 1257,
    Air = 26,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1278,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1277,
    ["Airlock Microgateway"] = 38,
    ["Alacritty Configuration"] = 1070,
    ["AlgoVoi Compliance Receipt v1"] = 13,
    ["All Contributors configuration file"] = 1124,
    Anodizer = 455,
    ["Ansible Argument Specs"] = 439,
    ["Ansible Collection Galaxy"] = 446,
    ["Ansible Execution Environment"] = 436,
    ["Ansible Inventory"] = 445,
    ["Ansible Meta"] = 437,
    ["Ansible Meta Runtime"] = 438,
    ["Ansible Navigator Configuration"] = 448,
    ["Ansible Playbook"] = 443,
    ["Ansible Requirements"] = 440,
    ["Ansible Rulebook"] = 444,
    ["Ansible Tasks File"] = 442,
    ["Ansible Vars File"] = 441,
    ["Ansible-lint Configuration"] = 447,
    Any = 1189,
    ...
    ["Application list for a WinUtil"] = 1207,
    ArchitectFX = 1212,
    ["Argo CD"] = 57,
    ["Argo Events"] = 58,
    ["Argo Workflows"] = 59,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1276,
    ["Azure IoT Operations connector metadata"] = 1273,
    ...
    ["Azure Pipelines"] = 117,
    ["Azure Static Web Apps CLI configuration file"] = 875,
    ["Azure Static Web Apps configuration file"] = 874,
    BMML = 1295,
    ["BOSH CPI Config"] = 143,
    ...
    ["Bacon config"] = 7,
    ["Barba-CV"] = 86,
    ["Bashly (bashly.yml)"] = 1128,
    ["Bashly Settings (bashly-settings.yml)"] = 1129,
    Bento = 1294,
    ["Better Code Hub"] = 1039,
    ["Better Scripts"] = 166,
    Bigconfig = 136,
    ["Biome Formatter Config"] = 87,
    ["Bitmovin Encoding Template"] = 1221,
    BizTalkServerApplicationSchema = 1005,
    Bleep = 167,
    ["Block Protocol Metadata"] = 164,
    ["Bluebricks blueprint config"] = 1300,
    ["Boyka Framework"] = 145,
    ...
    ["Butane Config"] = 1083,
    C4InterFlow = 1236,
    ["CDK Environment Manager, concrete environment configuration"] = 1260,
    ["CDK Environment Manager, concrete environments definition"] = 1259,
    ["CDK Environment Manager, environment definition"] = 1258,
    ["CGS Card Game Specification (cgs.json)"] = 1166,
    ["CICS TS region tagging"] = 1092,
    ["CICS TS resource import"] = 1093,
    ["CICS TS resource model"] = 1094,
    ["CICS TS resource overrides"] = 1095,
    ["CMake Presets"] = 168,
    ["CNC Codes"] = 190,
    ["CRS WAF test file"] = 1196,
    ["CRS WAF test platform overrides file"] = 1197,
    ["CSS Comb (.csscomb.json)"] = 304,
    ["CSS Lint (.csslintrc)"] = 305,
    ["CSpell (cspell.json)"] = 303,
    ["CVE Record Format"] = 202,
    CWL = 1172,
    ["Cache Warmup config"] = 169,
    ["Caido Proxy Configuration"] = 1332,
    ...
    ["Chamaleon environment"] = 1225,
    ["Chamaleon properties"] = 1226,
    ["Chamaleon template"] = 1224,
    Changepacks = 1287,
    Changesets = 287,
    Changie = 177,
    Charmcraft = 178,
    ...
    ["Clawject config"] = 196,
    ["Cloud Foundry Application Manifest"] = 1178,
    ["Cloud Run Spec v1"] = 1202,
    ...
    Concord = 1195,
    ["Configu .cfgu files"] = 1183,
    ["Configu .configu file"] = 1184,
    Conjure = 189,
    ["Container Structure Test"] = 1019,
    Containerlab = 1048,
    ["Contextive Glossary"] = 1252,
    ContractGuard = 1049,
    Convex = 188,
    ["Crowdsec collection config"] = 298,
    ["Crowdsec parser config"] = 299,
    ["Crowdsec scenario config"] = 300,
    ["CumulusCI Config"] = 195,
    ["Cursor Agent Environment"] = 1305,
    ["Custom Machinery Machine"] = 1167,
    ["Custom Machinery Recipe"] = 1168,
    ["Cycle Stack File"] = 203,
    CycloneDX = 204,
    ["DWP Exchange - catalogue entry"] = 349,
    ["DWP Exchange - gateway"] = 347,
    ["DWP Exchange - meta"] = 348,
    ["Dart Build Config (dart-build.json)"] = 306,
    ["Dart Test Config (dart-test.json)"] = 307,
    ["DashLord Configuration"] = 308,
    ["Data Contract Specification"] = 309,
    ["Data Product Specification"] = 310,
    ["DataYoga Connections"] = 205,
    ["DataYoga Job"] = 206,
    ["Datadog Continuous Testing"] = 541,
    ["Datadog Service Definition"] = 542,
    ["Datadog Software Catalog"] = 543,
    ["Datahub Ingestion Recipe"] = 1099,
    ["Debian Upstream Metadata file"] = 213,
    ["Deck config"] = 214,
    ["Declarative Automation Bundles"] = 1145,
    ["DeepMatch deeplinks spec"] = 215,
    ["Dein Config"] = 216,
    ["Deno Config (deno.json)"] = 316,
    ["Dependency cruiser"] = 217,
    ["DeployStack Configuration"] = 218,
    ["Deployah Configuration"] = 1275,
    ["Deployer Recipe"] = 319,
    ["Deta Spacefile"] = 219,
    ["Detekt Config (detekt.yml)"] = 320,
    ["Devbox Config"] = 220,
    ["Devbox Plugin"] = 221,
    Devfile = 346,
    Devup = 1288,
    DipDup = 1198,
    ["Discord Webhook"] = 321,
    ["DocFx Config (docfx.json)"] = 326,
    ["Docker Desktop extension metadata"] = 323,
    ["Docs MCP Manifest"] = 327,
    Dofigen = 328,
    ["Dolittle Artifacts"] = 329,
    ["Dolittle Bounded Context Configuration"] = 330,
    ["Dolittle Event Horizons Configuration"] = 331,
    ["Dolittle Resources Configuration"] = 332,
    ["Dolittle Server Configuration"] = 333,
    ["Dolittle Tenant Map Configuration"] = 335,
    ["Dolittle Tenants Configuration"] = 334,
    ["Dolittle Topology"] = 336,
    ["DonateCaseBetterCasino menu"] = 1229,
    ...
    ["Drupal Routing"] = 233,
    ["Drupal Services"] = 235,
    ["Drush site aliases"] = 342,
    ["Dynamic Bash Aliases (.aliases)"] = 1136,
    ["EAS config"] = 387,
    ["ECA - Editor Code Assistant"] = 351,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1125,
    ["ESLint Suppressions"] = 392,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1272,
    ["EasyVCR .NET"] = 389,
    ["Eidolon Resource"] = 1213,
    ["Elgato Stream Deck"] = 353,
    Elm = 1200,
    ["Embrace Config"] = 1111,
    Emmet = 1201,
    Endurica = 1149,
    ["Enonic XP API descriptor"] = 356,
    ["Enonic XP Admin Extension descriptor"] = 357,
    ["Enonic XP Admin Tool descriptor"] = 358,
    ["Enonic XP Application descriptor"] = 359,
    ["Enonic XP CMS descriptor"] = 360,
    ["Enonic XP Content Type descriptor"] = 361,
    ["Enonic XP Form Fragment descriptor"] = 362,
    ["Enonic XP ID Provider descriptor"] = 363,
    ["Enonic XP Layout descriptor"] = 364,
    ["Enonic XP Macro descriptor"] = 365,
    ["Enonic XP Mixin descriptor"] = 366,
    ["Enonic XP Page descriptor"] = 367,
    ["Enonic XP Part descriptor"] = 368,
    ["Enonic XP Service descriptor"] = 369,
    ["Enonic XP Site descriptor"] = 370,
    ["Enonic XP Style descriptor"] = 371,
    ["Enonic XP Task descriptor"] = 372,
    ["Enonic XP Webapp descriptor"] = 373,
    ["Enterprise Contract Policy Spec"] = 354,
    ["Envelope Team Definition"] = 1317,
    ["Envilder Map File"] = 355,
    ["Erda Pipeline"] = 1174,
    ["Erda Runtime"] = 1175,
    ["Espanso config.yml"] = 1298,
    ["Espanso match.yml"] = 1297,
    Esquio = 375,
    ["Estuary Flow Catalog"] = 1089,
    ["Ethereum ERC1155"] = 1311,
    ["Ethereum ERC721"] = 1310,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 380,
    ["EveryVoice TTS Toolkit Data Configuration"] = 381,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 385,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 384,
    ["EveryVoice TTS Toolkit Text Configuration"] = 382,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 383,
    ["Evolving Resolutive Process notation"] = 1274,
    ["Expo SDK"] = 386,
    ["Expoot app config"] = 388,
    ["F-Droid Data metadata"] = 394,
    ["FasterCI Configuration"] = 118,
    ["Fence configuration"] = 119,
    FiQuS = 398,
    Firebase = 396,
    ["Flatpak Builder Manifest"] = 399,
    ["FlexGet Config"] = 400,
    ["Flow.json Configurations"] = 1171,
    ["Fossa configuration file"] = 407,
    ["Fossa's fossa-deps file"] = 408,
    ["Foundry VTT - Base package Manifest"] = 402,
    ["Foundry VTT - Module Manifest"] = 403,
    ["Foundry VTT - System Data Template"] = 406,
    ["Foundry VTT - System Manifest"] = 404,
    ["Foundry VTT - World Manifest"] = 405,
    ["Foxx Manifest"] = 120,
    ["Freifunk.de Community API"] = 123,
    ["Frogbot Config"] = 124,
    ["G2P Mapping Configuration"] = 414,
    ["GCP Blueprint Metadata"] = 417,
    Gaspar = 415,
    ["GatewayCore API Gateway"] = 416,
    ["Gemini CLI settings"] = 418,
    ["GeoJSON.json latest"] = 1087,
    GherKing = 1091,
    ["GitHub Action"] = 424,
    ["GitHub Actions typing"] = 1209,
    ["GitHub Discussion"] = 425,
    ["GitHub Funding"] = 426,
    ["GitHub Issue Template configuration"] = 427,
    ["GitHub Issue Template forms"] = 428,
    ["GitHub Pages Jekyll"] = 429,
    ["GitHub Workflow"] = 430,
    ["GitHub Workflow Template Properties"] = 431,
    ["GitHub automatically generated release notes configuration"] = 432,
    ["GitLab Agent for Kubernetes configuration"] = 1163,
    GitVersion = 421,
    ["Gitea Issue Template configuration"] = 422,
    ["Gitea Issue Template forms"] = 423,
    ["Gitpod Automations"] = 434,
    ["Gitpod Configuration"] = 435,
    ["Glamour style"] = 419,
    ["GlazeWM settings"] = 1165,
    ["Global Privacy Control"] = 420,
    Goblet = 1144,
    ["Golangci-lint Configuration"] = 450,
    ["Golangci-lint Custom Plugins Configuration"] = 451,
    ["Google Chrome Related Website Sets"] = 397,
    ["Google Cloud Workflows"] = 274,
    ["Google Digital Assetlinks"] = 1253,
    Goreleaser = 453,
    ["Goreleaser Pro"] = 454,
    Goss = 456,
    ["Gradle Build Cache Node"] = 1037,
    ["Gradle Enterprise"] = 1036,
    ["Grafana 5.x Dashboard"] = 457,
    ["GraphQL Code Generator"] = 462,
    ["GraphQL Config"] = 461,
    ["GraphQL Mesh"] = 460,
    ["GroovyLint configuration"] = 463,
    ["Grunt JSHint task"] = 467,
    ["Grunt Watch task"] = 468,
    ["Grunt base task"] = 469,
    ["Grunt clean task"] = 465,
    ["Grunt copy task"] = 464,
    ["Grunt cssmin task"] = 466,
    HEMTT = 1001,
    Hadolint = 1015,
    Hammerkit = 1047,
    ["Hardware Sentry Configuration"] = 1103,
    ["Hashgraph Online Skill Manifest"] = 3,
    ["HashiCorp Vault"] = 470,
    Hatch = 1016,
    Hayson = 472,
    ["Haystack Pipeline"] = 473,
    ["Hazelcast 5 Configuration"] = 474,
    ["Hecate Input Schema"] = 1264,
    ["Helm Chart.lock"] = 237,
    ["Helm Chart.yaml"] = 236,
    ["Helm Unittest Test Suite"] = 238,
    ["Hex file"] = 239,
    ["Home Assistant Integration Manifest"] = 475,
    ["Homer dashboard configuration"] = 476,
    Hugo = 1079,
    ["Hugo Theme"] = 1078,
    ["Hulak Configuration"] = 483,
    ["Hyperfoil benchmark configuration"] = 482,
    ["IBM Zapp document"] = 484,
    ["IBM zCodeFormatSettings"] = 485,
    ["IMG Catapult PSP"] = 490,
    ["IVMS101 by CODE Protocol"] = 1164,
    ["Infinispan Configuration"] = 492,
    ["Infinispan Server Configuration"] = 493,
    Infrahub = 494,
    Istanbul = 1107,
    ["JDownloader2 crawler multi-rules"] = 508,
    ["JDownloader2 crawler single-rules"] = 507,
    ["JFrog Applications Config"] = 509,
    ["JFrog File Spec"] = 510,
    ["JFrog Pipelines YML DSL"] = 1113,
    ["JMeter DSL cli config"] = 511,
    JReleaser = 514,
    ["JSON Document Transform"] = 522,
    ["JSON Feed"] = 523,
    ["JSON Resume"] = 783,
    ["JSON Schema Draft 2020-12"] = 983,
    ["JSON Schema Draft 4"] = 980,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1146,
    ["JSON Schema Draft 7"] = 981,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1147,
    ["JSON Schema Draft 8 (2019-09)"] = 982,
    ["JSON-API"] = 521,
    ["JSON-e templates"] = 1044,
    ["JSON-stat 2.0"] = 976,
    JSONPatch = 525,
    ["JSR Package Config (jsr.json)"] = 515,
    Jarl = 1280,
    Jasmine = 502,
    Jekyll = 503,
    ["Jenkins X Pipelines"] = 504,
    ["Jenkins X Requirements"] = 505,
    Jest = 506,
    Jocker = 512,
    ["Jovo Language Models"] = 513,
    ["Jujutsu (jj) VCS config"] = 1266,
    ["KIMMDY config file"] = 536,
    ["KODE/CI build.yaml"] = 1109,
    ["KSP-AVC"] = 977,
    ["KSP-CKAN"] = 978,
    ["KSP-NetKAN"] = 979,
    KSY = 1176,
    KSail = 412,
    ["KYA Manifest"] = 1177,
    ["Karakum configuration file"] = 409,
    Kas = 528,
    ["Kestra flow file"] = 537,
    ["Keycloak REST API"] = 1116,
    ["Knative Functions - func.yaml"] = 410,
    Knip = 411,
    ["Knowledge Unit"] = 545,
    ["Kometa (nightly) config file"] = 539,
    ["Kometa config file"] = 538,
    ["Kong DBLess config"] = 1110,
    KrakenD = 540,
    ["Kubri Configuration"] = 548,
    LOOBin = 563,
    ["Lake configuration file"] = 1269,
    ...
    ["Lando (landofile)"] = 113,
    ["LangGraph Platform configuration"] = 1188,
    ["Language configuration"] = 1187,
    Lefthook = 552,
    ["Liferay client-extension.yaml"] = 559,
    ["LinkML Metamodel"] = 561,
    Liquibase = 1054,
    ["Liquibase Flow File"] = 1055,
    ["Lively Properties"] = 562,
    ["Lobe AI Agent"] = 115,
    Loki = 116,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 605,
    ["MS2Rescore Configuration"] = 611,
    ["Madness (madness.yml)"] = 1127,
    ["Mado configuration"] = 569,
    ["Maestro Flow"] = 570,
    ["Mail Servers Configuration"] = 1301,
    ["MapEHR Mapping"] = 571,
    Markdownlint = 1058,
    ["Mason Registry"] = 1061,
    ["MegaLinter Custom Flavor"] = 574,
    ["MegaLinter configuration"] = 573,
    ["MegaLinter descriptor"] = 575,
    Melange = 1154,
    ["Meltano project definition"] = 576,
    ["Mergify Configuration"] = 612,
    ["Metadata for a Bazel module"] = 577,
    ["Metadata for a Cinnamon spice"] = 1205,
    ["Metatype Configuration"] = 578,
    ["MetricsHub Configuration"] = 579,
    ["MetricsHub Connector Configuration"] = 580,
    ["Micro Editor Syntax"] = 1137,
    ["Microsoft Band Web Tile"] = 581,
    ["Microsoft RulesEngine workflow rules"] = 1192,
    ["Microsoft RulesEngine workflow rules list"] = 1193,
    ["Minecraft Custom Main Menu Mod"] = 1155,
    ["Minecraft Data Pack Advancement"] = 583,
    ["Minecraft Data Pack Biome"] = 584,
    ["Minecraft Data Pack Configured Carver"] = 585,
    ["Minecraft Data Pack Damage Type"] = 586,
    ["Minecraft Data Pack Dimension"] = 588,
    ["Minecraft Data Pack Dimension Type"] = 587,
    ["Minecraft Data Pack Item Modifier"] = 589,
    ["Minecraft Data Pack Loot Table"] = 590,
    ["Minecraft Data Pack Metadata"] = 591,
    ["Minecraft Data Pack Predicate"] = 592,
    ["Minecraft Data Pack Recipe"] = 593,
    ["Minecraft Data Pack Tag"] = 594,
    ["Minecraft Data Pack Template Pool"] = 595,
    ["Minecraft Data Pack Trim Material"] = 600,
    ["Minecraft Data Pack Trim Pattern"] = 601,
    ["Minecraft Resource Pack Lang"] = 596,
    ["Minecraft Resource Pack Particle"] = 597,
    ["Minecraft Resource Pack Texture Mcmeta"] = 599,
    ["Minecraft Resourcepack Sounds"] = 598,
    ["MockServer Expectations"] = 607,
    ModuleAssembler = 603,
    ["Monade CLI Stack Configuration"] = 615,
    ["MongoDB Atlas Search Index Definition"] = 1108,
    ["Monika Configuration"] = 1106,
    ["Monoweave Configuration"] = 610,
    ["Motif config"] = 997,
    MultiQC = 1246,
    ["NOX Framework (Service)"] = 633,
    ["Netin Diagnostic System Template"] = 1065,
    ["Netlify config"] = 618,
    ["Network-as-Code Data Model"] = 619,
    ["Next Gen UI Agent A2A Server Configuration"] = 620,
    ["Next Gen UI Agent Configuration"] = 622,
    ["Next Gen UI Agent MCP Server Configuration"] = 621,
    ["Nightwatch.js"] = 626,
    ["Node.js configuration"] = 1002,
    ["NueJS configuration file"] = 638,
    ["Nuitka Package Config"] = 1169,
    ["Nullstone config"] = 640,
    ["ONe's changelog entry"] = 659,
    ["ONe's service descriptor"] = 658,
    ["ORT Server repository environment configuration"] = 669,
    ["OSCAL Assessment Plan (AP)"] = 671,
    ["OSCAL Assessment Results (AR)"] = 672,
    ["OSCAL Catalog"] = 673,
    ["OSCAL Component Definition (CDef)"] = 674,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 675,
    ["OSCAL Profile"] = 676,
    ["OSCAL System Security Plan (SSP)"] = 677,
    ["OSS Review Toolkit configuration"] = 678,
    ["OSS Review Toolkit curation"] = 679,
    ["OSS Review Toolkit package configuration"] = 680,
    ["OSS Review Toolkit project package manager definition"] = 681,
    ["OSS Review Toolkit repository configuration"] = 682,
    ["OSS Review Toolkit resolutions"] = 683,
    ["October CMS columns"] = 644,
    ["October CMS fields"] = 645,
    ["Oh My Posh"] = 647,
    Okteto = 648,
    ["Ona Automations"] = 650,
    Opctl = 1000,
    ["Open Data Contract Standard (ODCS)"] = 663,
    ["Open Data Product Standard (ODPS)"] = 664,
    ["Open Know-How"] = 1251,
    OpenDecree = 1315,
    ["OpenDecree Configuration"] = 1316,
    ["OpenRewrite Resource"] = 661,
    OpenSRM = 665,
    OpenStatus = 1262,
    ["OpenTelemetry Declarative Configuration"] = 662,
    ["OpenUtau character yaml"] = 655,
    ["OpenUtau ustx"] = 656,
    ["OpenWeather Current Weather API"] = 1043,
    ["OpenWeather Road Risk API"] = 1042,
    ["Ory Hydra configuration"] = 481,
    ["Ory Keto configuration"] = 544,
    ["Ory Kratos configuration"] = 670,
    ["Ory Oathkeeper configuration"] = 642,
    ["Outblocks App configuration"] = 667,
    ["Outblocks database table"] = 668,
    ["Outblocks project configuration"] = 666,
    PDM = 691,
    POPxf = 703,
    ["POPxf Correlations"] = 704,
    ["PRML manifest"] = 711,
    Packer = 687,
    PactSpec = 688,
    Panache = 689,
    Pantsbuild = 1123,
    ["Paper paper-plugin.yml"] = 690,
    ["Pipeline component"] = 1056,
    ["Platform.sh application"] = 9,
    ["Platform.sh routes"] = 10,
    ["Platform.sh services"] = 11,
    ["Plex Prerolls"] = 701,
    ["PocketMine plugin.yml"] = 698,
    ["Podman Desktop Extension"] = 1334,
    ["Postman collection"] = 707,
    ["Power Pages Configuration"] = 1263,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1208,
    ["ProActions AI-Kit Configuration"] = 719,
    ["ProActions AI-Kit Configuration for Menus"] = 721,
    ["ProActions AI-Kit Configuration for Sections"] = 723,
    ["ProActions AI-Kit Configuration for Services"] = 720,
    ["ProActions AI-Kit Configuration for Steps"] = 724,
    ["ProActions AI-Kit Configuration for Templates"] = 722,
    ["Problem object RFC9457"] = 1152,
    ["Problem package format"] = 725,
    ["Problem package generators"] = 726,
    ["Problem package submissions"] = 727,
    ["Problem package test group metadata"] = 728,
    Pterodactyl = 1102,
    ["Pull Request Labeler"] = 745,
    Pulumi = 753,
    ["PyGTA Config"] = 749,
    PyProject = 754,
    Pylock = 1254,
    Pyright = 755,
    ["Python script metadata"] = 1248,
    ["QType AI DSL"] = 758,
    Qgoda = 757,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1326,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1324,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1330,
    ["Qlik Talend Cloud Pipeline - Project"] = 1322,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1325,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1327,
    ["Qlik Talend Cloud Pipeline - Task"] = 1323,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1329,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1328,
    Qodana = 1075,
    ["Qt Creator workspace file"] = 1185,
    ["Quali Torque Blueprint Spec 2"] = 1100,
    ["QueryFirst config file"] = 1119,
    ["QuikRun Configuration"] = 1331,
    ["Qwen Code Settings"] = 1312,
    ["RKE Cluster Configuration JSON"] = 1053,
    ["RKE Cluster Configuration YAML"] = 1052,
    RadioHound = 748,
    ["Raid Profile"] = 1313,
    ["Raid Repo Configuration"] = 1314,
    Railpack = 760,
    Railway = 759,
    ["Rancher Fleet"] = 750,
    ["Rattler-build"] = 761,
    Ray = 1014,
    ["Read the Docs"] = 752,
    ["Red-DiscordBot Cog"] = 768,
    ["Red-DiscordBot Cog Repo"] = 769,
    ["Red-DiscordBot Trivia"] = 770,
    ["Releasaurus Config"] = 6,
    ReleaseKit = 5,
    ["Render Blueprints"] = 1051,
    RenderCV = 787,
    Renovate = 784,
    ["Renovate global configuration"] = 785,
    ["Renovate inherited configuration"] = 786,
    ["Replit config"] = 776,
    Restate = 1241,
    ["Revel Digital Gadget Definition File"] = 1265,
    RoadRunner = 789,
    ["Robust Station Image"] = 1271,
    Rockcraft = 790,
    ["Roo Coder Custom Modes"] = 791,
    Rubocop = 780,
    ["Rudder techniques"] = 1159,
    Ruff = 781,
    ["Rust Project"] = 782,
    ["Rust toolchain"] = 796,
    ["SDMX data message"] = 823,
    ["SDMX metadata message"] = 822,
    ["SDMX structure message"] = 821,
    ["SIL Kit Participant Configuration"] = 833,
    ["SIL Kit Registry Configuration"] = 834,
    ["SPDX 2.3"] = 872,
    SWADL = 888,
    ["Safebox Config"] = 1114,
    ["Sapphire CLI Config"] = 799,
    ["SauceCTL Configuration"] = 1062,
    Scarb = 819,
    ["Schema Catalog"] = 814,
    ["Scoop manifest"] = 820,
    ["Semantic Data Fabric (SDF) file"] = 824,
    ["Semgrep Rule"] = 826,
    ["Serenity Code Generator (Sergen)"] = 827,
    ["Serverless Framework Configuration"] = 1069,
    ["Serverless Workflow"] = 1071,
    ["Settings for a Cinnamon spice"] = 1204,
    ["Settings.paf"] = 829,
    ["Shopware 6 Configuration"] = 1072,
    ["Shopware CLI Extension Store Configuration"] = 1073,
    ["Shopware CLI Project Store Configuration"] = 1074,
    ["Sigma Detection Rule"] = 831,
    ["SigmaCV CV"] = 1,
    ["Sigrid scope configuration file"] = 832,
    ["SkyPilot Task JSON"] = 1160,
    ["Slack app manifest"] = 836,
    Snapcraft = 838,
    ["Solarxy project config"] = 841,
    Solidarity = 842,
    ["Solution filters"] = 843,
    ["Source Maps v3"] = 844,
    Sourcery = 845,
    ["Spack bootstrap.yaml"] = 846,
    ["Spack cdash.yaml"] = 847,
    ["Spack ci.yaml"] = 848,
    ["Spack compilers.yaml"] = 849,
    ["Spack concretizer.yaml"] = 850,
    ["Spack config.yaml"] = 851,
    ["Spack definitions.yaml"] = 852,
    ["Spack develop.yaml"] = 853,
    ["Spack env_vars.yaml"] = 854,
    ["Spack environment"] = 860,
    ["Spack include.yaml"] = 855,
    ["Spack mirrors.yaml"] = 856,
    ["Spack modules.yaml"] = 857,
    ["Spack packages.yaml"] = 858,
    ["Spack repos.yaml"] = 859,
    ["Spack toolchains.yaml"] = 861,
    ["Spack upstreams.yaml"] = 862,
    ["Spack view.yaml"] = 863,
    ["Speakeasy Generation Config File"] = 867,
    ["Speakeasy Lint Configuration File"] = 864,
    ["Speakeasy Test Generation Configuration File"] = 865,
    ["Speakeasy Workflow File"] = 866,
    SpecIF = 868,
    ["Specmatic Configuration"] = 869,
    ["Sponge Mixin configuration"] = 870,
    StackBlitz = 876,
    ["StackHawk Scanner Configuration"] = 1068,
    Stale = 877,
    Starfish = 878,
    ["Starlake Data Pipeline"] = 1040,
    Starship = 879,
    ["Statamic Blueprint"] = 880,
    ["Stella configuration file"] = 881,
    ["Streamlit configuration file"] = 882,
    ["Stryker Mutator"] = 885,
    ["StyleCop Analyzers Configuration"] = 886,
    ["Stylelint (.stylelintrc)"] = 887,
    ["Stylua Config"] = 1255,
    ["Sublime Syntax"] = 1115,
    ["Subsquid squid manifest"] = 1162,
    ["Swagger API 2.0"] = 889,
    ["Synadia Connect Component"] = 890,
    TSON = 926,
    TSTyche = 927,
    ["TYPO3 Vendor Bundler config"] = 933,
    ["Tab data for a LinUtil"] = 1211,
    ["Tab list for a LinUtil"] = 1210,
    Tach = 891,
    ["Tach Domain"] = 892,
    Talhelper = 894,
    ["Talisman configuration"] = 895,
    Taplo = 1256,
    ["Taskfile config"] = 1045,
    Taurus = 896,
    Tauticord = 897,
    ["Tekton Pipeline"] = 1284,
    ["Tekton PipelineRun"] = 1285,
    ["Tekton Task"] = 1282,
    ["Tekton TaskRun"] = 1283,
    Telefonistka = 1242,
    ["Terrateam config"] = 1268,
    ["TestEnvironment.json"] = 909,
    ["TextMate Grammar"] = 908,
    Threagile = 903,
    ["Tier.run pricing.json"] = 900,
    Tikibase = 901,
    Tombi = 906,
    ["Traefik v2"] = 912,
    ["Traefik v2 File Provider"] = 913,
    ["Traefik v3"] = 914,
    ["Traefik v3 File Provider"] = 915,
    ["Travis CI (.travis.yml)"] = 911,
    Treefmt = 459,
    Trident = 1238,
    ["TrueScript for *.tscript files"] = 918,
    ["Tugboat QA config.yml"] = 1235,
    TunnelHub = 1150,
    Turborepo = 910,
    Tycho = 1199,
    Tye = 1076,
    ["Tyk Gateway - Open Source v5.7+"] = 1247,
    ["UET BuildConfig.json"] = 1120,
    ["UI5 Manifest"] = 939,
    ["UNCORS configuration"] = 944,
    ["UTAM Page Object"] = 942,
    ["Ubuntu Server Autoinstall"] = 937,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1239,
    ["Uniswap Token List"] = 1025,
    ["Universal Schedule Format"] = 945,
    ["Unreal Engine Uplugin"] = 1121,
    ["Unreal Engine Uproject"] = 1122,
    ["UpCloud CLI (upctl) configuration"] = 1240,
    ["Updatecli Compose"] = 1084,
    ["Updatecli Policy Manifest"] = 1085,
    ["Updatecli Policy Metadata"] = 1086,
    Uplift = 1118,
    ["Upsun config"] = 8,
    ["User Journey Map"] = 1050,
    V2Ray = 1090,
    ["VSCode Code Snippets"] = 262,
    ["VSIX CLI publishing"] = 963,
    Vector = 947,
    ["Vela Pipeline Configuration"] = 950,
    Vercel = 261,
    ["Version Bumper config"] = 953,
    Vespertide = 1289,
    ["Vespertide Migration"] = 1290,
    ["Vespertide Model"] = 1291,
    ["Viash Component Config"] = 1244,
    ["Viash Package Config"] = 1245,
    Visivo = 1148,
    ["WP-CLI"] = 973,
    Wake = 1237,
    ["Waku Config"] = 1214,
    ["Web App Manifest"] = 969,
    ["Web types"] = 972,
    WebExtensions = 968,
    ["Webman package recipe"] = 1096,
    ["Windows Package Manager Installer Manifest"] = 1022,
    ["Windows Package Manager Locale Manifest"] = 1023,
    ["Windows Package Manager Singleton Manifest"] = 1021,
    ["WireMock CLI import configuration"] = 1220,
    ["WireMock CLI local service configuration"] = 1219,
    ["WireMock message stub mapping"] = 1218,
    ["WireMock stub mapping"] = 1217,
    ["Woodpecker pipeline config"] = 1064,
    ["Wrangler CLI"] = 974,
    ["XenForo add-on manifest"] = 975,
    ["Xstate Machine"] = 1082,
    ["Yandex Workflow Language"] = 1206,
    ["Yarn Config (.yarnrc.yml)"] = 1038,
    ["Yippee-Ki-JSON configuration YML"] = 1029,
    ["YouTrack App"] = 1203,
    ["Zarf Package Configuration"] = 1270,
    ["Zerops import file"] = 1191,
    ["Zola Configuration"] = 1281,
    ["aerleon.yml"] = 22,
    ["amplify.yml"] = 15,
    ["amxx-builder manifest"] = 1333,
    ["angular.json"] = 39,
    apko = 1153,
    ...
    ["behat.yml"] = 146,
    ["bigquery-table"] = 135,
    ["bioimageio resource description"] = 1170,
    ...
    ["cargo-nextest repository configuration"] = 623,
    ["cargo-nextest user configuration"] = 624,
    ["ccmod.json"] = 1215,
    changelogging = 1182,
    ...
    ["chutzpah.json"] = 270,
    cibuildwheel = 183,
    ["clang-format (.clang-format)"] = 1088,
    ["clang-tidy"] = 245,
    clangd = 244,
    clib = 246,
    ...
    ["commands.json"] = 265,
    ["commit-check"] = 291,
    ["commitlint (.commitlintrc)"] = 1024,
    ["committed.toml"] = 292,
    ["compile_commands.json"] = 264,
    ["compilerconfig.json"] = 263,
    ["completely.yml"] = 1126,
    ["component-detection-manifest.json"] = 295,
    ["component.json"] = 294,
    ["composer.json"] = 293,
    ["conda-forge"] = 187,
    ["config.yaml"] = 751,
    ...
    ["crowdin.yml"] = 297,
    ["ctfd-setup configuration file"] = 1227,
    ["custom-elements.json"] = 1140,
    ["cypress.json"] = 301,
    ["dacier.yml"] = 1321,
    ["datalogic-scan2deploy-android"] = 311,
    ["datalogic-scan2deploy-ce"] = 312,
    ...
    ["ddev-global"] = 313,
    ["ddev-project"] = 314,
    ["debugsettings.json"] = 315,
    ["dependabot-v2.json"] = 318,
    ["dependabot.json"] = 317,
    ["deployed-cli"] = 1081,
    ...
    djlint = 1032,
    ["docker bake"] = 324,
    ["docker sequencer"] = 325,
    ["docker-compose.yml"] = 1030,
    ["dockerd.json"] = 322,
    ["dotnet Release Index manifest"] = 337,
    ["dotnet-tools.json"] = 338,
    ["dotnetcli.host.json"] = 339,
    ["dprint.json"] = 340,
    ["drone.json"] = 341,
    ["dss-2.0.0.json"] = 343,
    ["dstack configuration"] = 344,
    ["dtool dataset metadata"] = 1222,
    ["dvc.yaml"] = 345,
    ["ecosystem.json"] = 350,
    eksctl = 352,
    ["electron-builder configuration file"] = 378,
    ["epr-manifest.json"] = 377,
    ["estampo.toml"] = 376,
    ["evcc.yaml"] = 379,
    ["ezd task runner"] = 390,
    ["fabric.mod.json"] = 393,
    ["first-timers-bot"] = 401,
    ["flagd flag configuration"] = 121,
    ["fly.io Configuration"] = 122,
    fulibWorkflows = 1063,
    ["function.json"] = 413,
    ["gRPC API Gateway & OpenAPI Config"] = 17,
    ["gematik health care insurance list"] = 1233,
    ["gematik health care patient list"] = 1230,
    ["gematik health care provider institution list"] = 1232,
    ["gematik health care provider list"] = 1231,
    ["gematik tiger test environment configuration"] = 1234,
    ["git-town.toml"] = 1279,
    ["gitlab-ci"] = 433,
    ["global.json"] = 449,
    ["go-feature-flag Flag Configuration"] = 452,
    ["haxelib.json"] = 471,
    helmfile = 1017,
    helmwave = 1018,
    ["host-meta.json"] = 478,
    ...
    ["ide.host.json"] = 486,
    ["ifstate.yaml"] = 487,
    ["imageoptimizer.json"] = 488,
    ["importmap.json"] = 491,
    instant_python_config = 495,
    instant_python_custom_project = 496,
    intlayer = 497,
    ["ioBroker Configuration"] = 498,
    ["ioBroker JSON UI"] = 499,
    ["ioBroker Package manifest"] = 500,
    ["ixpect.conf.yaml"] = 501,
    ["ize.toml"] = 1117,
    ["jsconfig.json"] = 526,
    ["jscpd Configuration"] = 1101,
    jsdoc = 1013,
    ["k3d.yaml"] = 527,
    ["k9s aliases.yaml"] = 529,
    ["k9s cluster-config.yaml"] = 531,
    ["k9s config.yaml"] = 530,
    ["k9s hotkeys.yaml"] = 532,
    ["k9s plugins.yaml"] = 533,
    ["k9s skin.yaml"] = 534,
    ["k9s views.yaml"] = 535,
    ["kontinuous-config.yaml"] = 547,
    ["kontinuous-values.yaml"] = 546,
    ["kustomization.yaml"] = 549,
    ["label-commenter-config.yml"] = 550,
    ["latexindent configuration"] = 114,
    ["launchsettings.json"] = 551,
    lazydocker = 1139,
    lazygit = 1138,
    ["lego.json"] = 553,
    ["lerna.json"] = 554,
    ["lgtm.yml"] = 555,
    ["liblab.config.json"] = 556,
    ["libman.json"] = 557,
    ["license-report-config.json"] = 558,
    ["linkinator.config.json"] = 560,
    ["lint-staged (.lintstagedrc)"] = 991,
    ["local.settings.json"] = 565,
    ["localazy.json"] = 566,
    ["lotus.yaml"] = 564,
    ["lsdlschema.json"] = 567,
    ["macro.json"] = 1105,
    ["markdown-link-check"] = 1059,
    maturin = 1060,
    mboats = 1067,
    memnex = 1319,
    ["micro-settings.json"] = 1132,
    ["mimetypes.json"] = 582,
    ["mirrord config"] = 993,
    mise = 994,
    ["mkdocs.yml"] = 602,
    ["mockd.yaml"] = 606,
    ["modelparams.dev Model"] = 608,
    ["monospace.yml"] = 609,
    ["moon.yml"] = 1216,
    ["mprocs Configuration file"] = 1186,
    ["mrdocs.yml"] = 604,
    ["mta.yaml"] = 995,
    ["mtad.yaml"] = 996,
    ["mycode.json"] = 616,
    nFPM = 625,
    ["napari plugin manifest"] = 617,
    neoload = 1008,
    ["nest-cli"] = 628,
    ["nexus-rpc-gen"] = 1306,
    ["ninjs (News in JSON)"] = 627,
    ["nitro.json"] = 1007,
    ["nixd configuration"] = 1158,
    ["nlu.json"] = 629,
    ["nodemon.json"] = 631,
    ["noodl config"] = 1066,
    ["notebook.mod.json"] = 632,
    now = 1003,
    ["npm-badges"] = 635,
    ["nswag.json"] = 639,
    ntangle = 641,
    ["nuclei-template.yaml"] = 636,
    ["nuget-project.json"] = 637,
    ["ocelot.json"] = 643,
    ogen = 646,
    ["omnisharp.json"] = 649,
    openHAB = 1292,
    ...
    oxlint = 1303,
    ["package.json"] = 684,
    ["package.manifest"] = 686,
    ["package.yaml"] = 685,
    ["partial-black.json"] = 147,
    ["partial-fastapi.json"] = 148,
    ["partial-pixi.json"] = 696,
    ["partial-scheduled.json"] = 149,
    ["pattern.json"] = 694,
    ["petstore-v1.0"] = 1112,
    pgap_yaml_input_reader = 692,
    pgrls = 693,
    pgxgen = 1296,
    pitcms = 1299,
    ["pixi.toml"] = 695,
    ["plagiarize-me.yaml"] = 700,
    ["plagiarize.yaml"] = 699,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1223,
    ["podbard.yaml"] = 702,
    ["portman.json"] = 705,
    ["prefect.toml"] = 714,
    ["prefect.yaml"] = 715,
    ...
    ["prettierrc.json"] = 717,
    ["prisma.yml"] = 718,
    ["project-1.0.0-beta3.json"] = 730,
    ["project-1.0.0-beta4.json"] = 731,
    ["project-1.0.0-beta5.json"] = 732,
    ["project-1.0.0-beta6.json"] = 733,
    ["project-1.0.0-beta8.json"] = 734,
    ["project-1.0.0-rc1.json"] = 735,
    ["project-1.0.0-rc2.json"] = 736,
    ["project.json"] = 729,
    ["project.owasp.yaml"] = 737,
    ["prometheus-alertmanager.json"] = 741,
    ["prometheus.json"] = 738,
    ["prometheus.rules.json"] = 739,
    ["prometheus.rules.test.json"] = 740,
    ["proxies.json"] = 742,
    ["publiccode.yml"] = 743,
    ["pubspec.yaml"] = 744,
    ["pyrseas-0.8.json"] = 747,
    pytest = 756,
    ["quilt.mod.json"] = 1133,
    ["rc3 auth"] = 762,
    ["rc3 collection"] = 763,
    ...
    ["rc3 settings"] = 767,
    ["registry.yaml"] = 52,
    ["release drafter"] = 1009,
    ["release-hub.json"] = 4,
    ["release-please-config.json"] = 772,
    ["release-please-manifest.json"] = 773,
    ["release-plz.toml"] = 774,
    ["renv.lock"] = 788,
    ["reposets Configuration"] = 777,
    ["reposets Credentials"] = 778,
    ["revola.json"] = 2,
    ["rivet.json"] = 1157,
    ["rivet.yaml (legacy)"] = 1156,
    rumdl = 793,
    runny = 792,
    runspec = 1320,
    rustfmt = 794,
    ...
    samt = 797,
    samtrc = 798,
    ["sarif-1.0.0.json"] = 800,
    ["sarif-2.0.0.json"] = 801,
    ["sarif-2.1.0"] = 811,
    ["sarif-2.1.0-rtm.2"] = 802,
    ["sarif-2.1.0-rtm.3"] = 804,
    ["sarif-2.1.0-rtm.4"] = 806,
    ["sarif-2.1.0-rtm.5"] = 808,
    ["sarif-2.1.0-rtm.6"] = 809,
    ["sarif-external-property-file-2.1.0"] = 812,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 803,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 805,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 807,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 810,
    ["scalingo.json configuration"] = 813,
    ["schema.org - Action"] = 815,
    ["schema.org - ContactPoint"] = 816,
    ["schema.org - Place"] = 817,
    ["schema.org - Thing"] = 818,
    ["secrethub.yml"] = 1135,
    ["semantic-release"] = 825,
    ["servicehub.config.json"] = 986,
    ["servicehub.service.json"] = 985,
    ["settings.job"] = 828,
    ["sfdx-hardis configuration"] = 830,
    ["shard.yml"] = 1173,
    ["size-limit configuration"] = 835,
    ["skaffold.yaml"] = 1057,
    ["skyuxconfig.json"] = 837,
    ["snowflake-config"] = 839,
    ["snowflake-connections"] = 840,
    ["spicepod.yaml"] = 1194,
    ["sqlc configuration"] = 873,
    ["stripe-app-local.json"] = 884,
    ["stripe-app.json"] = 883,
    swcrc = 1041,
    ["task.json"] = 893,
    taskcat = 1004,
    ["template.json"] = 898,
    ["templatsources.json"] = 899,
    ["text2confl config"] = 1304,
    ["theme.json"] = 902,
    ["tizen_workspace.json"] = 904,
    tldr = 905,
    ["tm_devices configuration file"] = 1261,
    tmuxinator = 989,
    tox = 907,
    ["transcend.yml"] = 916,
    ["tree-sitter grammar.json"] = 458,
    ["trime.yaml"] = 917,
    ["trunk.yaml"] = 919,
    ["ts-force-config.json"] = 924,
    ["tsconfig.json"] = 920,
    ["tsd.json"] = 921,
    ["tsdoc.json"] = 922,
    ["tsdrc.json"] = 923,
    ...
    ["vega-lite.json"] = 949,
    ["vega.json"] = 948,
    ["venvironment.yaml"] = 951,
    ["venvplus.yaml"] = 952,
    version = 1243,
    ["version.json"] = 954,
    ["vhwdebugger-binding.yaml"] = 956,
    ["vim-addon-info"] = 957,
    ["vs-2017.3.host.json"] = 959,
    ["vs-nesting.json"] = 960,
    ["vsls.json"] = 958,
    ["vss-extension.json"] = 964,
    vtcfg = 1249,
    ["vtesttree.yaml"] = 965,
    ["vtestunit.yaml"] = 966,
    ["warp-keysets.json"] = 1141,
    ["warp-themes.json"] = 1142,
    ["warp-workflows.json"] = 1143,
    ["webhint.io"] = 1097,
    ["webjobpublishsettings.json"] = 971,
    ["webjobs-list.json"] = 970,
    ["well-known-fursona"] = 1181,
    ["xs-app.json"] = 999,
    ["xunit.runner.json"] = 984,
    yamlfmt = 1026,
    yamllint = 1027,
    ["yap.json"] = 1028,
    ["zerops.yml"] = 1190,
