...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 183,
    [".cryproj (generic)"] = 630,
    [".cryproj engine-5.2"] = 625,
    [".cryproj engine-5.3"] = 626,
    [".cryproj engine-5.4"] = 627,
    [".cryproj engine-5.5"] = 628,
    [".cryproj engine-dev"] = 629,
    [".csscomb.json"] = 185,
    [".csslintrc"] = 186,
    [".es6importsorterrc.json"] = 763,
    [".eslintrc"] = 235,
    [".esmrc.json"] = 227,
    [".ffizer.yaml"] = 239,
    [".htmlhintrc"] = 293,
    ...
    [".mtaext"] = 639,
    [".nodehawkrc"] = 397,
    [".npmpackagejsonlintrc"] = 400,
    [".phraseapp.yml"] = 448,
    [".pmbot.yml"] = 436,
    [".postcssrc"] = 443,
    [".powerpages-web-template-manifest"] = 445,
    [".pre-commit-config.yml"] = 446,
    [".pre-commit-hooks.yml"] = 447,
    [".putout.json"] = 467,
    [".rehyperc"] = 479,
    [".remarkrc"] = 481,
    [".sprite files"] = 538,
    ...
    ["A micro editor config"] = 355,
    AIConfig = 13,
    ["API Builder"] = 671,
    ["AVA Configuration"] = 732,
    ...
    ["Airplane task"] = 15,
    ["Alacritty Configuration"] = 704,
    ["All Contributors configuration file"] = 762,
    ...
    ["Azure Pipelines"] = 61,
    ["Azure Static Web Apps CLI configuration file"] = 541,
    ["Azure Static Web Apps configuration file"] = 540,
    ["BX CI"] = 97,
    ["Better Code Hub"] = 675,
    ["Better Scripts"] = 98,
    Bigconfig = 78,
    BizTalkServerApplicationSchema = 645,
    Bleep = 99,
    ...
    ["Butane Config"] = 717,
    ["CICS TS region tagging"] = 726,
    ["CICS TS resource import"] = 727,
    ["CICS TS resource model"] = 728,
    ["CICS TS resource overrides"] = 729,
    ["CMake Presets"] = 100,
    ["CNC Codes"] = 111,
    ...
    ["Databricks Asset Bundles"] = 783,
    ["Datadog Service Definition"] = 333,
    ["Datahub Ingestion Recipe"] = 733,
    ["Dein Config"] = 117,
    Deno = 196,
    ["Deployer Recipe"] = 199,
    ["Deta Spacefile"] = 118,
    ...
    ["Goreleaser Pro"] = 275,
    Goss = 276,
    ["Gradle Build Cache Node"] = 673,
    ["Gradle Enterprise"] = 672,
    ["Grafana 5.x Dashboard"] = 277,
    ["GraphQL Code Generator"] = 280,
    ["GraphQL Config"] = 279,
    ["GraphQL Mesh"] = 278,
    ["Grunt JSHint task"] = 284,
    ["Grunt Watch task"] = 285,
    ["Grunt base task"] = 286,
    ["Grunt clean task"] = 282,
    ["Grunt copy task"] = 281,
    ["Grunt cssmin task"] = 283,
    HEMTT = 642,
    Hadolint = 654,
    Hammerkit = 682,
    ["Hardware Sentry Configuration"] = 737,
    Hatch = 655,
    Hayson = 288,
    ["Haystack Pipeline"] = 289,
    ["Hazelcast 5 Configuration"] = 290,
    ["Helm Chart.lock"] = 135,
    ["Helm Chart.yaml"] = 134,
    ["Helm Unittest Test Suite"] = 136,
    Hugo = 713,
    ["Hugo Theme"] = 712,
    ["IBM Zapp document"] = 295,
    ["IBM zCodeFormatSettings"] = 296,
    ["IMG Catapult PSP"] = 301,
    Istanbul = 740,
    ["JDownloader2 crawler multi-rules"] = 311,
    ["JDownloader2 crawler single-rules"] = 310,
    ["JFrog Applications Config"] = 312,
    ["JFrog File Spec"] = 313,
    ["JFrog Pipelines YML DSL"] = 746,
    ["JMeter DSL cli config"] = 314,
    JReleaser = 316,
    ["JSON Document Transform"] = 323,
    ["JSON Feed"] = 324,
    ["JSON Resume"] = 487,
    ["JSON Schema Draft 2020-12"] = 621,
    ["JSON Schema Draft 4"] = 618,
    ["JSON Schema Draft 7"] = 619,
    ["JSON Schema Draft 7 (unofficial strict)"] = 784,
    ["JSON Schema Draft 8 (2019-09)"] = 620,
    ["JSON-API"] = 322,
    ["JSON-e templates"] = 680,
    ["JSON-stat 2.0"] = 615,
    JSONPatch = 326,
    Jasmine = 306,
    Jekyll = 307,
    ["Jenkins X Pipelines"] = 308,
    ["Jenkins X Requirements"] = 309,
    ["Jovo Language Models"] = 315,
    ["KIMMDY config file"] = 331,
    ["KSP-AVC"] = 616,
    ["KSP-CKAN"] = 617,
    ["Karakum configuration file"] = 251,
    Kas = 329,
    ["Keycloak REST API"] = 754,
    ["Knative Functions - func.yaml"] = 252,
    ["KoDE/CI build.yaml"] = 742,
    ["Kong DBLess config"] = 743,
    KrakenD = 332,
    LOOBin = 350,
    Lefthook = 340,
    ["Liferay client-extension.yaml"] = 346,
    ["LinkML Metamodel"] = 348,
    Liquibase = 687,
    ["Liquibase Flow File"] = 688,
    ["Lively Properties"] = 349,
    ["Lobe AI Agent"] = 60,
    ["MLOS Configs"] = 382,
    ["MS2Rescore Configuration"] = 384,
    Markdownlint = 691,
    ["Mason Registry"] = 693,
    ["MegaLinter configuration"] = 356,
    ["MegaLinter descriptor"] = 357,
    Melange = 790,
    ["Meltano plugin discovery definition"] = 359,
    ["Meltano project definition"] = 358,
    ["Microsoft Band Web Tile"] = 360,
    ["Minecraft Custom Main Menu Mod"] = 791,
    ["Minecraft Data Pack Advancement"] = 362,
    ["Minecraft Data Pack Biome"] = 363,
    ["Minecraft Data Pack Configured Carver"] = 364,
    ["Minecraft Data Pack Damage Type"] = 365,
    ["Minecraft Data Pack Dimension"] = 367,
    ["Minecraft Data Pack Dimension Type"] = 366,
    ["Minecraft Data Pack Item Modifier"] = 368,
    ["Minecraft Data Pack Loot Table"] = 369,
    ["Minecraft Data Pack Metadata"] = 370,
    ["Minecraft Data Pack Predicate"] = 371,
    ["Minecraft Data Pack Recipe"] = 372,
    ["Minecraft Data Pack Tag"] = 373,
    ["Minecraft Data Pack Template Pool"] = 374,
    ["Minecraft Data Pack Trim Material"] = 379,
    ["Minecraft Data Pack Trim Pattern"] = 380,
    ["Minecraft Resource Pack Lang"] = 375,
    ["Minecraft Resource Pack Particle"] = 376,
    ["Minecraft Resource Pack Texture Mcmeta"] = 378,
    ["Minecraft Resourcepack Sounds"] = 377,
    ["MkDocs Configuration 1.0"] = 381,
    ["MongoDB Atlas Search Index Definition"] = 741,
    ["Monika Configuration"] = 739,
    ["Motif config"] = 638,
    ["NOX Framework (Service)"] = 399,
    ["Netin Diagnostic System Template"] = 697,
    ["Netlify config"] = 390,
    ["Network-as-Code Data Model"] = 391,
    ["Nightwatch.js"] = 392,
    ["ONe's changelog entry"] = 415,
    ["ONe's service descriptor"] = 414,
    ["OSS Review Toolkit configuration"] = 422,
    ["OSS Review Toolkit curation"] = 423,
    ["OSS Review Toolkit package configuration"] = 424,
    ["OSS Review Toolkit repository configuration"] = 425,
    ["OSS Review Toolkit resolutions"] = 426,
    Opctl = 641,
    ["OpenRewrite Resource"] = 417,
    ["OpenUtau character yaml"] = 411,
    ["OpenUtau ustx"] = 412,
    ["OpenWeather Current Weather API"] = 679,
    ["OpenWeather Road Risk API"] = 678,
    ["Ory Hydra configuration"] = 294,
    ["Ory Keto configuration"] = 334,
    ["Ory Kratos configuration"] = 421,
    ["Ory Oathkeeper configuration"] = 406,
    ["Outblocks App configuration"] = 419,
    ["Outblocks database table"] = 420,
    ["Outblocks project configuration"] = 418,
    PDM = 432,
    ["PDM Partial"] = 433,
    Packer = 429,
    Pantsbuild = 761,
    ["Paper paper-plugin.yml"] = 430,
    ["Partial-Setuptools"] = 522,
    ["Partial-poetry"] = 439,
    ["Pipeline component"] = 689,
    ["PocketMine plugin.yml"] = 437,
    Poetry = 438,
    ["Postman collection"] = 444,
    ["Problem object RFC9457"] = 788,
    ["Problem package generators"] = 451,
    Pterodactyl = 736,
    ["Pull Request Labeler"] = 466,
    Pulumi = 472,
    PyProject = 473,
    Pyright = 474,
    Qgoda = 475,
    Qodana = 709,
    ["Quali Torque Blueprint Spec 2"] = 734,
    ["QueryFirst config file"] = 757,
    ["RKE Cluster Configuration JSON"] = 686,
    ["RKE Cluster Configuration YAML"] = 685,
    ["Rancher Fleet"] = 469,
    Ray = 653,
    ["Read the Docs"] = 471,
    ["Red-DiscordBot Cog"] = 476,
    ["Red-DiscordBot Cog Repo"] = 477,
    ["Red-DiscordBot Trivia"] = 478,
    RenderCV = 489,
    Renovate = 488,
    ["Replit config"] = 482,
    RoadRunner = 490,
    ...
    ["Rust Project"] = 486,
    ["Rust toolchain"] = 492,
    ["SIL Kit Participant Configuration"] = 526,
    ["SIL Kit Registry Configuration"] = 527,
    SWADL = 552,
    ["Safebox Config"] = 747,
    ["Sapphire CLI Config"] = 495,
    ["SauceCTL Configuration"] = 694,
    ["Schema Catalog"] = 509,
    ["Scoop manifest"] = 514,
    ["Semantic Data Fabric (SDF) file"] = 515,
    ["Semgrep Rule"] = 517,
    ["Serenity Code Generator (Sergen)"] = 518,
    ["Serverless Framework Configuration"] = 703,
    ["Serverless Workflow"] = 705,
    ["Settings.paf"] = 520,
    Setuptools = 521,
    ["Shopware 6 Configuration"] = 706,
    ["Shopware CLI Extension Store Configuration"] = 707,
    ["Shopware CLI Project Store Configuration"] = 708,
    Sigma = 524,
    ["Sigrid scope configuration file"] = 525,
    ["Slack app manifest"] = 529,
    Solidarity = 532,
    ["Solution filters"] = 533,
    ["Source Maps v3"] = 534,
    Sourcery = 535,
    SpecIF = 536,
    ["Sponge Mixin configuration"] = 537,
    StackBlitz = 542,
    ["StackHawk Scanner Configuration"] = 702,
    Stale = 543,
    ["Starlake Data Pipeline"] = 676,
    Starship = 544,
    ["Statamic Blueprint"] = 545,
    ["Stella configuration file"] = 546,
    ["StrmPrivacy Data Connector"] = 751,
    ["StrmPrivacy Data Contract"] = 752,
    ["StrmPrivacy SimpleSchema"] = 749,
    ["StrmPrivacy Stream"] = 750,
    ["StrmPrivacy batch job configuration file"] = 748,
    ["Stryker Mutator"] = 549,
    ["StyleCop Analyzers Configuration"] = 550,
    ["Sublime Syntax"] = 753,
    ["Swagger API 2.0"] = 553,
    TSON = 578,
    TSTyche = 579,
    Talhelper = 555,
    ["Talisman configuration"] = 556,
    ["Taskfile config"] = 681,
    Taurus = 557,
    ["TestEnvironment.json"] = 566,
    ["TextMate Grammar"] = 565,
    ["Tier.run pricing.json"] = 560,
    Tikibase = 561,
    ["Traefik v2"] = 569,
    ["Traefik v2 File Provider"] = 570,
    TunnelHub = 787,
    Turborepo = 567,
    Tye = 710,
    ["UET BuildConfig.json"] = 758,
    ["UI5 Manifest"] = 587,
    ["UNCORS configuration"] = 591,
    ["UTAM Page Object"] = 590,
    ["Ubuntu Server Autoinstall"] = 585,
    ["Uniswap Token List"] = 664,
    ["Unreal Engine Uplugin"] = 759,
    ["Unreal Engine Uproject"] = 760,
    ["Updatecli Compose"] = 718,
    ["Updatecli Policy Manifest"] = 719,
    ["Updatecli Policy Metadata"] = 720,
    Uplift = 756,
    ["User Journey Map"] = 684,
    V2Ray = 724,
    ...
    ["Web types"] = 614,
    WebExtensions = 610,
    ["Webman package recipe"] = 730,
    ["Windows Package Manager Installer Manifest"] = 661,
    ["Windows Package Manager Locale Manifest"] = 662,
    ["Windows Package Manager Singleton Manifest"] = 660,
    ["Woodpecker pipeline config"] = 696,
    ["Xstate Machine"] = 716,
    ["Yippee-Ki-JSON configuration YML"] = 666,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 16,
    apko = 789,
    ...
    ["bamboo-spec"] = 72,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 767,
    ["bashly-strings.yml"] = 768,
    ["bashly.yml"] = 766,
    ["batect.yml"] = 71,
    ...
    ["ide.host.json"] = 297,
    ["ifstate.conf"] = 298,
    ["imageoptimizer.json"] = 299,
    ["importmap.json"] = 302,
    ["ioBroker Configuration"] = 303,
    ["ioBroker JSON UI"] = 304,
    ["ioBroker Package manifest"] = 305,
    ["ize.toml"] = 755,
    ["jsconfig.json"] = 327,
    ["jscpd Configuration"] = 735,
    jsdoc = 652,
    ["k3d.yaml"] = 328,
    ["k9s plugin.yml"] = 330,
    ["kontinuous-config.yaml"] = 336,
    ["kontinuous-values.yaml"] = 335,
    ["kustomization.yaml"] = 337,
    ["label-commenter-config.yml"] = 338,
    ["launchsettings.json"] = 339,
    lazydocker = 777,
    lazygit = 776,
    ["lego.json"] = 341,
    ["lerna.json"] = 342,
    ["lgtm.yml"] = 343,
    ["libman.json"] = 344,
    ["license-report-config.json"] = 345,
    ["linkinator.config.json"] = 347,
    ["local.settings.json"] = 352,
    ["localazy.json"] = 353,
    ["lotus.yaml"] = 351,
    ["lsdlschema.json"] = 354,
    ["madness.yml"] = 765,
    ["markdown-lint-check"] = 692,
    mboats = 699,
    ["micro-settings.json"] = 770,
    ["mimetypes.json"] = 361,
    ["mirrord config"] = 635,
    ["monospace.yml"] = 383,
    ["mta.yaml"] = 636,
    ...
    ["mycode.json"] = 387,
    mypy = 388,
    ["napari plugin manifest"] = 389,
    neoload = 647,
    ["nest-cli"] = 395,
    ["ninjs (News in JSON) 1.3"] = 394,
    ["ninjs (News in JSON) 2.0"] = 393,
    ["nlu.json"] = 396,
    ["nodemon.json"] = 398,
    ["noodl config"] = 698,
    now = 643,
    ...
    ["nswag.json"] = 404,
    ntangle = 405,
    ["nuclei-template.yaml"] = 402,
    ["nuget-project.json"] = 403,
    ["ocelot.json"] = 407,
    ["omnisharp.json"] = 408,
    ["openapi.json"] = 409,
    ["openfin.json"] = 416,
    ...
    ["ops.yaml"] = 413,
    ["package.json"] = 427,
    ["package.manifest"] = 428,
    ["partial-cibuildwheel"] = 108,
    ["partial-scikit-build"] = 701,
    ["pathfinder.yml"] = 431,
    ["pattern.json"] = 435,
    ["petstore-v1.0"] = 745,
    pgap_yaml_input_reader = 434,
    ["plagiarize-me.yaml"] = 441,
    ["plagiarize.yaml"] = 440,
    ["portman.json"] = 442,
    ["prettierrc.json"] = 449,
    ["prisma.yml"] = 450,
    ["project-1.0.0-beta3.json"] = 453,
    ["project-1.0.0-beta4.json"] = 454,
    ["project-1.0.0-beta5.json"] = 455,
    ["project-1.0.0-beta6.json"] = 456,
    ["project-1.0.0-beta8.json"] = 457,
    ["project-1.0.0-rc1.json"] = 458,
    ["project-1.0.0-rc2.json"] = 459,
    ["project.json"] = 452,
    ["prometheus.json"] = 460,
    ["prometheus.rules.json"] = 461,
    ["prometheus.rules.test.json"] = 462,
    ["proxies.json"] = 463,
    ["publiccode.yml"] = 464,
    ["pubspec.yaml"] = 465,
    ["pyrseas-0.8.json"] = 468,
    ["quilt.mod.json"] = 771,
    ["release drafter"] = 648,
    ...
    samt = 493,
    samtrc = 494,
    ["sarif-1.0.0.json"] = 496,
    ["sarif-2.0.0.json"] = 497,
    ["sarif-2.1.0"] = 507,
    ["sarif-2.1.0-rtm.2"] = 498,
    ["sarif-2.1.0-rtm.3"] = 500,
    ["sarif-2.1.0-rtm.4"] = 502,
    ["sarif-2.1.0-rtm.5"] = 504,
    ["sarif-2.1.0-rtm.6"] = 505,
    ["sarif-external-property-file-2.1.0"] = 508,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 499,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 501,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 503,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 506,
    ["schema.org - Action"] = 510,
    ["schema.org - ContactPoint"] = 511,
    ["schema.org - Place"] = 512,
    ["schema.org - Thing"] = 513,
    ["scikit-build"] = 700,
    ["secrethub.yml"] = 773,
    ["semantic-release"] = 516,
    ["servicehub.config.json"] = 624,
    ["servicehub.service.json"] = 623,
    ["settings.job"] = 519,
    ["sfdx-hardis configuration"] = 523,
    ["size-limit configuration"] = 528,
    ["skaffold.yaml"] = 690,
    ["skyuxconfig.json"] = 530,
    snapcraft = 531,
    ["sqlc configuration"] = 539,
    ["stripe-app-local.json"] = 548,
    ["stripe-app.json"] = 547,
    swcrc = 677,
    syntax = 775,
    ["task.json"] = 554,
    taskcat = 644,
    ["template.json"] = 558,
    ["templatsources.json"] = 559,
    ["theme.json"] = 562,
    ["tizen_workspace.json"] = 563,
    tldr = 564,
    tmuxinator = 632,
    ["transcend.yml"] = 571,
    ["trunk.yaml"] = 572,
    ["ts-force-config.json"] = 576,
    ["tsconfig.json"] = 573,
    ["tsd.json"] = 574,
    ["tsdrc.json"] = 575,
    ["tslint.json"] = 577,
    ...
    ["vtesttree.yaml"] = 606,
    ["vtestunit.yaml"] = 607,
    ["warp-keysets.json"] = 779,
    ["warp-themes.json"] = 780,
    ["warp-workflows.json"] = 781,
    ["webhint.io"] = 731,
    ["webjobpublishsettings.json"] = 613,
    ["webjobs-list.json"] = 612,
    ["xs-app.json"] = 640,
    ["xunit.runner.json"] = 622,
    yamllint = 665,
    zuul = 649,
    ["Žinoma"] = 659
  },
