...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 175,
    [".cryproj (generic)"] = 600,
    [".cryproj engine-5.2"] = 595,
    [".cryproj engine-5.3"] = 596,
    [".cryproj engine-5.4"] = 597,
    [".cryproj engine-5.5"] = 598,
    [".cryproj engine-dev"] = 599,
    [".csscomb.json"] = 177,
    [".csslintrc"] = 178,
    [".es6importsorterrc.json"] = 727,
    [".eslintrc"] = 227,
    [".esmrc.json"] = 219,
    [".ffizer.yaml"] = 231,
    [".htmlhintrc"] = 282,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 672,
    ["All Contributors configuration file"] = 726,
    ...
    ["Better Scripts"] = 96,
    Bigconfig = 76,
    BizTalkServerApplicationSchema = 615,
    Bleep = 97,
    ...
    ["Butane Config"] = 684,
    ["CICS TS region tagging"] = 691,
    ["CICS TS resource import"] = 692,
    ["CICS TS resource model"] = 693,
    ["CICS TS resource overrides"] = 694,
    ["CMake Presets"] = 98,
    ["CNC Codes"] = 108,
    ...
    ["Databricks Asset Bundles"] = 747,
    ["Datadog Service Definition"] = 321,
    ["Datahub Ingestion Recipe"] = 698,
    ["Dein Config"] = 113,
    Deno = 188,
    ["Deployer Recipe"] = 191,
    ["Deta Spacefile"] = 114,
    ...
    ["Goreleaser Pro"] = 264,
    Goss = 265,
    ["Gradle Build Cache Node"] = 642,
    ["Gradle Enterprise"] = 641,
    ...
    Hadolint = 624,
    Hammerkit = 651,
    ["Hardware Sentry Configuration"] = 702,
    Hayson = 277,
    ...
    ["JFrog File Spec"] = 302,
    ["JFrog Pipelines YML DSL"] = 711,
    ["JMeter DSL cli config"] = 303,
    JReleaser = 305,
    ["JSON Document Transform"] = 312,
    ["JSON Feed"] = 313,
    ["JSON Resume"] = 464,
    ["JSON Schema Draft 2020-12"] = 591,
    ["JSON Schema Draft 4"] = 588,
    ["JSON Schema Draft 7"] = 589,
    ["JSON Schema Draft 7 (unofficial strict)"] = 748,
    ["JSON Schema Draft 8 (2019-09)"] = 590,
    ["JSON-API"] = 311,
    ["JSON-e templates"] = 649,
    ["JSON-stat 2.0"] = 585,
    JSONPatch = 315,
    Jasmine = 295,
    Jekyll = 296,
    ...
    Kas = 318,
    ["Keycloak REST API"] = 718,
    ["Knative Functions - func.yaml"] = 242,
    ["KoDE/CI build.yaml"] = 707,
    ["Kong DBLess config"] = 708,
    KrakenD = 320,
    LOOBin = 337,
    Lefthook = 328,
    ["LinkML Metamodel"] = 335,
    Liquibase = 656,
    ["Liquibase Flow File"] = 657,
    ...
    ["MongoDB Atlas Search Index Definition"] = 706,
    ["Monika Configuration"] = 704,
    ["Motif config"] = 608,
    ["NOX Framework (Service)"] = 383,
    ["Netin Diagnostic System Template"] = 666,
    ["Netlify config"] = 374,
    ...
    ["OpenWeather Current Weather API"] = 648,
    ["OpenWeather Road Risk API"] = 647,
    ...
    Qgoda = 453,
    Qodana = 677,
    ["Quali Torque Blueprint Spec 2"] = 699,
    ["QueryFirst config file"] = 721,
    ["RKE Cluster Configuration JSON"] = 655,
    ["RKE Cluster Configuration YAML"] = 654,
    ["Rancher Fleet"] = 447,
    Ray = 623,
    ["Read the Docs"] = 449,
    ...
    ["SauceCTL Configuration"] = 663,
    ["Schema Catalog"] = 485,
    ["Scoop manifest"] = 490,
    ["Semantic Data Fabric (SDF) file"] = 491,
    ["Semgrep Rule"] = 493,
    ["Serenity Code Generator (Sergen)"] = 494,
    ["Serverless Framework Configuration"] = 671,
    ["Serverless Workflow"] = 673,
    ["Settings.paf"] = 496,
    Setuptools = 497,
    ["Shopware 6 Configuration"] = 674,
    ["Shopware CLI Extension Store Configuration"] = 675,
    ["Shopware CLI Project Store Configuration"] = 676,
    ...
    StackBlitz = 516,
    ["StackHawk Scanner Configuration"] = 670,
    Stale = 517,
    ["Starlake Data Pipeline"] = 645,
    Starship = 518,
    ["Statamic Blueprint"] = 519,
    ["StrmPrivacy Data Connector"] = 716,
    ["StrmPrivacy Data Contract"] = 717,
    ["StrmPrivacy SimpleSchema"] = 714,
    ["StrmPrivacy Stream"] = 715,
    ["StrmPrivacy batch job configuration file"] = 713,
    ["Stryker Mutator"] = 522,
    ["StyleCop Analyzers Configuration"] = 523,
    ["Swagger API 2.0"] = 526,
    TSON = 550,
    ["Talisman configuration"] = 528,
    ["Taskfile config"] = 650,
    Taurus = 529,
    ["TestEnvironment.json"] = 538,
    ["TextMate Grammar"] = 537,
    ["Tier.run pricing.json"] = 532,
    Tikibase = 533,
    ["Traefik v2"] = 541,
    ["Traefik v2 File Provider"] = 542,
    Turborepo = 539,
    Tye = 678,
    ["UET BuildConfig.json"] = 722,
    ["UI5 Manifest"] = 558,
    ["UTAM Page Object"] = 561,
    ["Ubuntu Server Autoinstall"] = 556,
    ["Uniswap Token List"] = 633,
    ["Unreal Engine Uplugin"] = 723,
    ["Unreal Engine Uproject"] = 724,
    Updatecli = 685,
    Uplift = 720,
    ["User Journey Map"] = 653,
    V2Ray = 689,
    ["VSCode Code Snippets"] = 146,
    ["VSIX CLI publishing"] = 574,
    ["Vela Pipeline Configuration"] = 564,
    Vercel = 145,
    Visivo = 749,
    ["Web App Manifest"] = 581,
    ["Web types"] = 584,
    WebExtensions = 580,
    ["Webman package recipe"] = 695,
    ["Windows Package Manager Installer Manifest"] = 630,
    ["Windows Package Manager Locale Manifest"] = 631,
    ["Windows Package Manager Singleton Manifest"] = 629,
    ["Woodpecker pipeline config"] = 665,
    ["Xstate Machine"] = 683,
    ["Yippee-Ki-JSON configuration YML"] = 635,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 70,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 731,
    ["bashly-strings.yml"] = 732,
    ["bashly.yml"] = 730,
    ["batect.yml"] = 69,
    ...
    ["lsdlschema.json"] = 341,
    ["madness.yml"] = 729,
    ["markdown-lint-check"] = 661,
    mboats = 668,
    ["micro-settings.json"] = 734,
    ["mimetypes.json"] = 348,
    ["mirrord config"] = 605,
    ["mta.yaml"] = 606,
    ["mtad.yaml"] = 607,
    ...
    ["servicehub.config.json"] = 594,
    ["servicehub.service.json"] = 593,
    ["settings.job"] = 495,
    ...
    taskcat = 614,
    ["template.json"] = 530,
    ["templatsources.json"] = 531,
    ["theme.json"] = 534,
    ["tizen_workspace.json"] = 535,
    tldr = 536,
    tmuxinator = 602,
    ["transcend.yml"] = 543,
    ["trunk.yaml"] = 544,
    ["ts-force-config.json"] = 548,
    ["tsconfig.json"] = 545,
    ["tsd.json"] = 546,
    ["tsdrc.json"] = 547,
    ["tslint.json"] = 549,
    ...
    ["vega-lite.json"] = 563,
    ["vega.json"] = 562,
    ["venvironment-basic.yaml"] = 566,
    ["venvironment.yaml"] = 565,
    ["version.json"] = 567,
    ["vim-addon-info"] = 568,
    ["vs-2017.3.host.json"] = 570,
    ["vs-nesting.json"] = 571,
    ["vsls.json"] = 569,
    ["vss-extension.json"] = 575,
    ["vtesttree.yaml"] = 576,
    ["vtestunit.yaml"] = 577,
    ["warp-keysets.json"] = 743,
    ["warp-themes.json"] = 744,
    ["warp-workflows.json"] = 745,
    ["webhint.io"] = 696,
    ["webjobpublishsettings.json"] = 583,
    ["webjobs-list.json"] = 582,
    ["xs-app.json"] = 610,
    ["xunit.runner.json"] = 592,
    yamllint = 634,
    zuul = 619,
    ["Žinoma"] = 628
  },
