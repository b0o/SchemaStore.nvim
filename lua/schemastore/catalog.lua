...
M.json = {
  ...
  index = {
    ...
    AIConfig = 31,
    ["AMX Muse Program Descriptor"] = 1147,
    ["API Builder"] = 955,
    ["AVA Configuration"] = 1018,
    ...
    ["AWS Copilot Manifest"] = 1186,
    ["AWS SAM CLI Samconfig"] = 255,
    ["Adobe UXP Manifest"] = 1081,
    ["Aerleon Network & Service Definitions"] = 18,
    ["Aerleon Policy"] = 19,
    Aider = 1176,
    Air = 21,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1197,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1196,
    ["Airlock Microgateway"] = 32,
    ["Alacritty Configuration"] = 990,
    ["All Contributors configuration file"] = 1044,
    ...
    ["Application list for a WinUtil"] = 1126,
    ArchitectFX = 1131,
    ["Argo CD"] = 51,
    ["Argo Events"] = 52,
    ["Argo Workflows"] = 53,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1195,
    ["Azure IoT Operations connector metadata"] = 1192,
    ...
    ["BX CI"] = 152,
    ["Bacon config"] = 3,
    ["Bashly (bashly.yml)"] = 1048,
    ["Bashly Settings (bashly-settings.yml)"] = 1049,
    Bento = 1213,
    ["Better Code Hub"] = 960,
    ["Better Scripts"] = 153,
    Bigconfig = 125,
    ["Biome Formatter Config"] = 79,
    ["Bitmovin Encoding Template"] = 1140,
    BizTalkServerApplicationSchema = 927,
    Bleep = 154,
    ["Block Protocol Metadata"] = 151,
    ["Bluebricks blueprint config"] = 1218,
    ["Boyka Framework"] = 134,
    Briefcase = 933,
    ["Build Info"] = 142,
    Buildkite = 144,
    ...
    ["Butane Config"] = 1003,
    C4InterFlow = 1155,
    ["CDK Environment Manager, concrete environment configuration"] = 1179,
    ["CDK Environment Manager, concrete environments definition"] = 1178,
    ["CDK Environment Manager, environment definition"] = 1177,
    ["CGS Card Game Specification (cgs.json)"] = 1086,
    ["CICS TS region tagging"] = 1012,
    ["CICS TS resource import"] = 1013,
    ["CICS TS resource model"] = 1014,
    ["CICS TS resource overrides"] = 1015,
    ["CMake Presets"] = 155,
    ["CNC Codes"] = 176,
    ["CRS WAF test file"] = 1116,
    ["CRS WAF test platform overrides file"] = 1117,
    ...
    ["Chamaleon environment"] = 1144,
    ["Chamaleon properties"] = 1145,
    ["Chamaleon template"] = 1143,
    Changepacks = 1206,
    Changesets = 264,
    Changie = 164,
    Charmcraft = 165,
    ...
    ["Clawject config"] = 182,
    ["Cloud Foundry Application Manifest"] = 1098,
    ["Cloud Run Spec v1"] = 1121,
    ...
    Concord = 1115,
    ["Configu .cfgu files"] = 1103,
    ["Configu .configu file"] = 1104,
    Conjure = 175,
    ["Container Structure Test"] = 941,
    Containerlab = 969,
    ["Contextive Glossary"] = 1171,
    Convex = 174,
    ["Crowdsec collection config"] = 274,
    ["Crowdsec parser config"] = 275,
    ["Crowdsec scenario config"] = 276,
    ["CumulusCI Config"] = 181,
    ["Custom Machinery Machine"] = 1087,
    ["Custom Machinery Recipe"] = 1088,
    ...
    ["DonateCaseBetterCasino menu"] = 1148,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1056,
    ["EAS config"] = 342,
    ["ECA - Editor Code Assistant"] = 326,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1045,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1191,
    ["EasyVCR .NET"] = 343,
    ["Eidolon Resource"] = 1132,
    ...
    ["Erda Pipeline"] = 1094,
    ["Erda Runtime"] = 1095,
    ["Espanso config.yml"] = 1216,
    ["Espanso match.yml"] = 1215,
    Esquio = 331,
    ["Estuary Flow Catalog"] = 1009,
    ...
    ["Evolving Resolutive Process notation"] = 1193,
    ["Expo SDK"] = 341,
    ...
    ["GeoJSON.json latest"] = 1007,
    GherKing = 1011,
    ["GitHub Action"] = 375,
    ["GitHub Actions typing"] = 1128,
    ...
    ["Google Digital Assetlinks"] = 1172,
    Goreleaser = 403,
    ["Goreleaser Pro"] = 404,
    Goss = 405,
    ["Gradle Build Cache Node"] = 958,
    ["Gradle Enterprise"] = 957,
    ...
    Hadolint = 937,
    Hammerkit = 968,
    ["Hardware Sentry Configuration"] = 1023,
    ["HashiCorp Vault"] = 419,
    Hatch = 938,
    Hayson = 421,
    ["Haystack Pipeline"] = 422,
    ["Hazelcast 5 Configuration"] = 423,
    ["Hecate Input Schema"] = 1183,
    ["Helm Chart.lock"] = 218,
    ["Helm Chart.yaml"] = 217,
    ...
    ["JFrog File Spec"] = 456,
    ["JFrog Pipelines YML DSL"] = 1033,
    ["JMeter DSL cli config"] = 457,
    JReleaser = 460,
    ["JSON Document Transform"] = 468,
    ["JSON Feed"] = 469,
    ["JSON Resume"] = 712,
    ["JSON Schema Draft 2020-12"] = 905,
    ["JSON Schema Draft 4"] = 902,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1066,
    ["JSON Schema Draft 7"] = 903,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1067,
    ["JSON Schema Draft 8 (2019-09)"] = 904,
    ["JSON-API"] = 467,
    ["JSON-e templates"] = 965,
    ["JSON-stat 2.0"] = 898,
    JSONPatch = 471,
    ...
    ["Jujutsu (jj) VCS config"] = 1185,
    ["KIMMDY config file"] = 482,
    ["KODE/CI build.yaml"] = 1029,
    ["KSP-AVC"] = 899,
    ["KSP-CKAN"] = 900,
    ["KSP-NetKAN"] = 901,
    KSY = 1096,
    ...
    ["Metadata for a Cinnamon spice"] = 1124,
    ["Metatype Configuration"] = 522,
    ["MetricsHub Configuration"] = 523,
    ["MetricsHub Connector Configuration"] = 524,
    ["Micro Editor Syntax"] = 1057,
    ["Microsoft Band Web Tile"] = 525,
    ["Microsoft RulesEngine workflow rules"] = 1112,
    ["Microsoft RulesEngine workflow rules list"] = 1113,
    ["Minecraft Custom Main Menu Mod"] = 1075,
    ...
    ["MongoDB Atlas Search Index Definition"] = 1028,
    ["Monika Configuration"] = 1026,
    ["Monoweave Configuration"] = 550,
    ["Motif config"] = 919,
    MultiQC = 1165,
    ["NOX Framework (Service)"] = 571,
    ["Netin Diagnostic System Template"] = 985,
    ["Netlify config"] = 558,
    ...
    ["OpenUtau ustx"] = 593,
    ["OpenWeather Current Weather API"] = 964,
    ["OpenWeather Road Risk API"] = 963,
    ...
    ["Power Pages Configuration"] = 1182,
    ["Preset list for a WinUtil"] = 1127,
    ...
    Pylock = 1173,
    Pyright = 686,
    ["Python script metadata"] = 1167,
    ["QType AI DSL"] = 689,
    Qgoda = 688,
    Qodana = 995,
    ["Qt Creator workspace file"] = 1105,
    ["Quali Torque Blueprint Spec 2"] = 1020,
    ["QueryFirst config file"] = 1039,
    ["RKE Cluster Configuration JSON"] = 973,
    ["RKE Cluster Configuration YAML"] = 972,
    RadioHound = 679,
    Railpack = 691,
    Railway = 690,
    ["Rancher Fleet"] = 681,
    ...
    ["Replit config"] = 707,
    Restate = 1160,
    ["Revel Digital Gadget Definition File"] = 1184,
    RoadRunner = 718,
    ["Robust Station Image"] = 1190,
    Rockcraft = 719,
    ["Roo Coder Custom Modes"] = 720,
    Rubocop = 709,
    ["Rudder techniques"] = 1079,
    Ruff = 710,
    ["Rust Project"] = 711,
    ["Rust toolchain"] = 724,
    ...
    ["SauceCTL Configuration"] = 982,
    ["Schema Catalog"] = 742,
    ["Scoop manifest"] = 747,
    ["Semantic Data Fabric (SDF) file"] = 751,
    ["Semgrep Rule"] = 753,
    ["Serenity Code Generator (Sergen)"] = 754,
    ["Serverless Framework Configuration"] = 989,
    ["Serverless Workflow"] = 991,
    ["Settings for a Cinnamon spice"] = 1123,
    ["Settings.paf"] = 756,
    ["Shopware 6 Configuration"] = 992,
    ["Shopware CLI Extension Store Configuration"] = 993,
    ["Shopware CLI Project Store Configuration"] = 994,
    ["Sigma Detection Rule"] = 758,
    ["Sigrid scope configuration file"] = 759,
    ["SkyPilot Task JSON"] = 1080,
    ...
    StackBlitz = 802,
    ["StackHawk Scanner Configuration"] = 988,
    Stale = 803,
    Starfish = 804,
    ["Starlake Data Pipeline"] = 961,
    Starship = 805,
    ...
    ["Stylua Config"] = 1174,
    ["Sublime Syntax"] = 1035,
    ["Subsquid squid manifest"] = 1082,
    ["Swagger API 2.0"] = 815,
    ["Synadia Connect Component"] = 816,
    TSON = 851,
    TSTyche = 852,
    ["TYPO3 Vendor Bundler config"] = 857,
    ["Tab data for a LinUtil"] = 1130,
    ["Tab list for a LinUtil"] = 1129,
    Tach = 817,
    ["Tach Domain"] = 818,
    Talhelper = 820,
    ...
    Taurus = 822,
    Tauticord = 823,
    ["Tekton Pipeline"] = 1203,
    ["Tekton PipelineRun"] = 1204,
    ["Tekton Task"] = 1201,
    ["Tekton TaskRun"] = 1202,
    Telefonistka = 1161,
    ["Terrateam config"] = 1187,
    ["TestEnvironment.json"] = 834,
    ["TextMate Grammar"] = 833,
    Threagile = 829,
    ["Tier.run pricing.json"] = 826,
    Tikibase = 827,
    Tombi = 832,
    ["Traefik v2"] = 837,
    ["Traefik v2 File Provider"] = 838,
    ["Traefik v3"] = 839,
    ["Traefik v3 File Provider"] = 840,
    ["Travis CI (.travis.yml)"] = 836,
    Treefmt = 408,
    Trident = 1157,
    ["TrueScript for *.tscript files"] = 843,
    ["Tugboat QA config.yml"] = 1154,
    TunnelHub = 1070,
    Turborepo = 835,
    Tycho = 1119,
    Tye = 996,
    ["Tyk Gateway - Open Source v5.7+"] = 1166,
    ["UET BuildConfig.json"] = 1040,
    ["UI5 Manifest"] = 863,
    ["UNCORS configuration"] = 867,
    ["UTAM Page Object"] = 866,
    ["Ubuntu Server Autoinstall"] = 861,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1158,
    ["Uniswap Token List"] = 948,
    ["Universal Schedule Format"] = 868,
    ["Unreal Engine Uplugin"] = 1041,
    ["Unreal Engine Uproject"] = 1042,
    ["UpCloud CLI (upctl) configuration"] = 1159,
    ["Updatecli Compose"] = 1004,
    ["Updatecli Policy Manifest"] = 1005,
    ["Updatecli Policy Metadata"] = 1006,
    Uplift = 1038,
    ["Upsun config"] = 4,
    ["User Journey Map"] = 970,
    V2Ray = 1010,
    ["VSCode Code Snippets"] = 239,
    ["VSIX CLI publishing"] = 886,
    Vector = 870,
    ["Vela Pipeline Configuration"] = 873,
    Vercel = 238,
    ["Version Bumper config"] = 876,
    Vespertide = 1208,
    ["Vespertide Migration"] = 1209,
    ["Vespertide Model"] = 1210,
    ["Viash Component Config"] = 1163,
    ["Viash Package Config"] = 1164,
    Visivo = 1068,
    ["WP-CLI"] = 896,
    Wake = 1156,
    ["Waku Config"] = 1133,
    ["Web App Manifest"] = 892,
    ["Web types"] = 895,
    WebExtensions = 891,
    ["Webman package recipe"] = 1016,
    ["Windows Package Manager Installer Manifest"] = 944,
    ["Windows Package Manager Locale Manifest"] = 945,
    ["Windows Package Manager Singleton Manifest"] = 943,
    Winutil = 946,
    ["WireMock CLI import configuration"] = 1139,
    ["WireMock CLI local service configuration"] = 1138,
    ["WireMock message stub mapping"] = 1137,
    ["WireMock stub mapping"] = 1136,
    ["Woodpecker pipeline config"] = 984,
    ["Wrangler CLI"] = 897,
    ["Xstate Machine"] = 1002,
    ["Yandex Workflow Language"] = 1125,
    ["Yarn Config (.yarnrc.yml)"] = 959,
    ["Yippee-Ki-JSON configuration YML"] = 950,
    ["YouTrack App"] = 1122,
    ["Zarf Package Configuration"] = 1189,
    ["Zerops.io config"] = 1110,
    ["Zerops.io import"] = 1111,
    ["Zola Configuration"] = 1200,
    ["aerleon.yml"] = 17,
    ["amplify.yml"] = 10,
    ["angular.json"] = 33,
    apko = 1073,
    ...
    ["behat.yml"] = 135,
    ["bigquery-table"] = 124,
    ["bioimageio resource description"] = 1090,
    ...
    ["chutzpah.json"] = 247,
    cibuildwheel = 170,
    ["clang-format (.clang-format)"] = 1008,
    ["clang-tidy"] = 225,
    clangd = 224,
    clib = 226,
    ...
    ["crowdin.yml"] = 273,
    ["ctfd-setup configuration file"] = 1146,
    ["custom-elements.json"] = 1060,
    ["cypress.json"] = 277,
    ...
    ["gematik health care insurance list"] = 1152,
    ["gematik health care patient list"] = 1149,
    ["gematik health care provider institution list"] = 1151,
    ["gematik health care provider list"] = 1150,
    ["gematik tiger test environment configuration"] = 1153,
    ["git-town.toml"] = 1198,
    ["gitlab-ci"] = 383,
    ["global.json"] = 399,
    ...
    ["lint-staged (.lintstagedrc)"] = 913,
    ["local.settings.json"] = 510,
    ["localazy.json"] = 511,
    ["lotus.yaml"] = 509,
    ["lsdlschema.json"] = 512,
    ["macro.json"] = 1025,
    ["markdown-link-check"] = 979,
    maturin = 980,
    mboats = 987,
    ["micro-settings.json"] = 1052,
    ["mimetypes.json"] = 526,
    ["mirrord config"] = 915,
    mise = 916,
    ["mkdocs.yml"] = 546,
    ["monospace.yml"] = 549,
    ["moon.yml"] = 1135,
    ["mprocs Configuration file"] = 1106,
    ["mrdocs.yml"] = 547,
    ["mta.yaml"] = 917,
    ["mtad.yaml"] = 918,
    ["mycode.json"] = 556,
    ...
    ["plagiarize.yaml"] = 631,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1142,
    ["podbard.yaml"] = 634,
    ["portman.json"] = 637,
    ["prefect.toml"] = 645,
    ["prefect.yaml"] = 646,
    ...
    ["servicehub.config.json"] = 908,
    ["servicehub.service.json"] = 907,
    ["settings.job"] = 755,
    ...
    tldr = 831,
    ["tm_devices configuration file"] = 1180,
    tmuxinator = 911,
    ["transcend.yml"] = 841,
    ["tree-sitter grammar.json"] = 407,
    ["trime.yaml"] = 842,
    ["trunk.yaml"] = 844,
    ["ts-force-config.json"] = 849,
    ["tsconfig.json"] = 845,
    ["tsd.json"] = 846,
    ["tsdoc.json"] = 847,
    ["tsdrc.json"] = 848,
    ...
    ["vega-lite.json"] = 872,
    ["vega.json"] = 871,
    ["venvironment.yaml"] = 874,
    ["venvplus.yaml"] = 875,
    version = 1162,
    ["version.json"] = 877,
    ["vhwdebugger-binding.yaml"] = 879,
    ["vim-addon-info"] = 880,
    ["vs-2017.3.host.json"] = 882,
    ["vs-nesting.json"] = 883,
    ["vsls.json"] = 881,
    ["vss-extension.json"] = 887,
    vtcfg = 1168,
    ["vtesttree.yaml"] = 888,
    ["vtestunit.yaml"] = 889,
    ["warp-keysets.json"] = 1061,
    ["warp-themes.json"] = 1062,
    ["warp-workflows.json"] = 1063,
    ["webhint.io"] = 1017,
    ["webjobpublishsettings.json"] = 894,
    ["webjobs-list.json"] = 893,
    ["well-known-fursona"] = 1101,
    ["xs-app.json"] = 921,
    ["xunit.runner.json"] = 906,
    yamllint = 949,
    zizmor = 1205,
    zuul = 932,
    ["Žinoma"] = 942
