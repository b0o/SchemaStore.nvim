...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 122,
    [".cryproj (generic)"] = 446,
    [".cryproj engine-5.2"] = 441,
    [".cryproj engine-5.3"] = 442,
    [".cryproj engine-5.4"] = 443,
    [".cryproj engine-5.5"] = 444,
    [".cryproj engine-dev"] = 445,
    [".csscomb.json"] = 124,
    [".csslintrc"] = 125,
    [".eslintrc"] = 164,
    [".esmrc.json"] = 157,
    ...
    [".mtaext"] = 453,
    [".nodehawkrc"] = 277,
    [".npmpackagejsonlintrc"] = 279,
    [".phraseapp.yml"] = 311,
    [".pmbot.yml"] = 303,
    [".postcssrc"] = 308,
    [".pre-commit-config.yml"] = 309,
    [".pre-commit-hooks.yml"] = 310,
    [".putout.json"] = 328,
    [".rehyperc"] = 334,
    [".remarkrc"] = 335,
    [".sprite files"] = 374,
    ...
    [".vsext"] = 422,
    [".yarnrc.yml"] = 485,
    ["<div>RIOTS' studio configuration"] = 425,
    ["API Builder"] = 482,
    ["AVA Configuration Schema"] = 534,
    ["AWS CDK cdk.json"] = 110,
    ["AWS CloudFormation"] = 111,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 112,
    ...
    ["Azure Pipelines"] = 41,
    ["Azure Static Web Apps CLI configuration file"] = 376,
    ["Azure Static Web Apps configuration file"] = 375,
    ["BX CI"] = 70,
    ["Better Code Hub"] = 487,
    ["Better Scripts"] = 71,
    BizTalkServerApplicationSchema = 459,
    ...
    ["Butane config schema"] = 521,
    ["CICS TS region tagging"] = 528,
    ["CICS TS resource import"] = 529,
    ["CICS TS resource model"] = 530,
    ["CICS TS resource overrides"] = 531,
    ["CMake Presets"] = 72,
    ...
    Cheatsheets = 518,
    ["Chrome Extension"] = 104,
    ["CircleCI config.yml"] = 87,
    ["Citation File Format"] = 113,
    CityJSON = 79,
    ["Code Climate"] = 88,
    ["Commandbox Box.json"] = 81,
    ["Commandbox Server.json"] = 82,
    ["Common Catalog Schema"] = 102,
    ["Common types for all schemas"] = 1,
    ["Container Structure Test"] = 470,
    Containerlab = 494,
    ["Dart build configuration"] = 126,
    ["Dart test config"] = 127,
    ["DashLord configuration"] = 128,
    ["Datadog Service Definition"] = 235,
    ["Datahub Ingestion Recipe Schema"] = 535,
    ["Dein Config Schema"] = 84,
    Deno = 132,
    ["Deployer Recipe"] = 135,
    Devfile = 154,
    ["Discord Webhook"] = 137,
    ["Dolittle Artifacts"] = 140,
    ["Dolittle Bounded Context Configuration"] = 141,
    ["Dolittle Event Horizons Configuration"] = 142,
    ["Dolittle Resources Configuration"] = 143,
    ["Dolittle Server Configuration"] = 144,
    ["Dolittle Tenant Map Configuration"] = 146,
    ["Dolittle Tenants Configuration"] = 145,
    ["Dolittle Topology"] = 147,
    ["Drush site aliases"] = 151,
    ["Embrace Config Schema"] = 545,
    ["Error pages"] = 160,
    Esquio = 158,
    ["Estuary Flow Catalog Schema"] = 525,
    ["Expo SDK"] = 163,
    ["F-Droid Data metadata"] = 167,
    ["Facets - FSDL - Application"] = 165,
    ["Fossa configuration file"] = 172,
    ["Fossa's fossa-deps file"] = 173,
    ["Foundry VTT - Manifest"] = 170,
    ["Foundry VTT - Template"] = 171,
    ["Foxx Manifest"] = 42,
    ["GatewayCore API Gateway"] = 176,
    ["GeoJSON.json latest"] = 523,
    GherKing = 527,
    ["GitHub Action"] = 180,
    ["GitHub Funding"] = 181,
    ["GitHub Issue Template configuration"] = 183,
    ["GitHub Workflow"] = 184,
    ["GitHub Workflow Template Properties"] = 185,
    ["GitHub issue forms"] = 182,
    GitVersion = 179,
    ["Gitpod Configuration"] = 187,
    ["Global Privacy Control"] = 177,
    ["Google Cloud Workflows"] = 109,
    Goreleaser = 190,
    ["Goreleaser Pro"] = 191,
    ["Gradle Build Cache Node"] = 484,
    ["Gradle Enterprise"] = 483,
    ["Grafana 5.x Dashboard"] = 192,
    ["GraphQL Code Generator"] = 195,
    ["GraphQL Config"] = 194,
    ["GraphQL Mesh"] = 193,
    ["Grunt JSHint task"] = 199,
    ["Grunt Watch task"] = 200,
    ["Grunt base task"] = 201,
    ["Grunt clean task"] = 197,
    ["Grunt copy task"] = 196,
    ["Grunt cssmin task"] = 198,
    HEMTT = 456,
    Hadolint = 468,
    ["Hardware Sentry Configuration"] = 539,
    Hayson = 203,
    ["Haystack Pipeline"] = 204,
    ["Hazelcast 5 Configuration"] = 205,
    ["Helm Chart.lock"] = 86,
    ["Helm Chart.yaml"] = 85,
    Hugo = 517,
    ["Istanbul Schema"] = 542,
    ["JFrog File Spec"] = 220,
    ["JSON Document Transform"] = 228,
    ["JSON Feed"] = 229,
    ["JSON Resume"] = 338,
    ["JSON Schema Draft 2020-12"] = 437,
    ["JSON Schema Draft 4"] = 434,
    ["JSON Schema Draft 7"] = 435,
    ["JSON Schema Draft 8"] = 436,
    ["JSON schema for CodeShip Pro services configuration files"] = 95,
    ["JSON schema for CodeShip Pro steps configuration files"] = 96,
    ["JSON schema for Codecov configuration files"] = 94,
    ["JSON-API"] = 227,
    ["JSON-e templates"] = 492,
    ["JSON-stat 2.0"] = 431,
    JSONPatch = 231,
    Jasmine = 216,
    Jekyll = 217,
    ["Jenkins X Pipelines"] = 218,
    ["Jenkins X Requirements"] = 219,
    ["Jovo Language Models"] = 221,
    ["KSP-AVC"] = 432,
    ["KSP-CKAN"] = 433,
    ["KoDE/CI build.yaml"] = 544,
    KrakenD = 234,
    ["LinkML Metamodel"] = 245,
    Liquibase = 498,
    ["Liquibase Flow File"] = 499,
    Markdownlint = 502,
    ["MegaLinter configuration"] = 249,
    ["MegaLinter descriptor"] = 250,
    ["Meltano plugin discovery definition"] = 252,
    ["Meltano project definition"] = 251,
    ["Microsoft Band Web Tile"] = 253,
    ["Minecraft Data Pack Advancement"] = 255,
    ["Minecraft Data Pack Biome"] = 256,
    ["Minecraft Data Pack Configured Carver"] = 257,
    ["Minecraft Data Pack Dimension"] = 259,
    ["Minecraft Data Pack Dimension Type"] = 258,
    ["Minecraft Data Pack Item Modifier"] = 260,
    ["Minecraft Data Pack Loot Table"] = 261,
    ["Minecraft Data Pack Metadata"] = 262,
    ["Minecraft Data Pack Predicate"] = 263,
    ["Minecraft Data Pack Recipe"] = 264,
    ["Minecraft Data Pack Template Pool"] = 265,
    ["Minecraft Resourcepack Sounds"] = 266,
    ["MongoDB Atlas Search Index Definition Schema"] = 543,
    ["Monika Configuration Schema"] = 541,
    ["Motif config"] = 452,
    ["Netin Diagnostic System Template"] = 506,
    ["Netlify config schema"] = 271,
    ["Nightwatch.js"] = 272,
    ["OSS Review Toolkit curation"] = 294,
    ["OSS Review Toolkit package configuration"] = 295,
    ["OSS Review Toolkit repository configuration"] = 296,
    ["OSS Review Toolkit resolutions"] = 297,
    Opctl = 455,
    ["OpenWeather Current Weather API"] = 491,
    ["OpenWeather Road Risk API"] = 490,
    ["Ory Hydra configuration"] = 209,
    ["Ory Keto configuration"] = 236,
    ["Ory Kratos configuration"] = 293,
    ["Ory Oathkeeper configuration"] = 284,
    ["Outblocks App configuration"] = 291,
    ["Outblocks database table"] = 292,
    ["Outblocks project configuration"] = 290,
    Packer = 300,
    ["Pipeline component"] = 500,
    ["PocketMine plugin.yml"] = 304,
    Pterodactyl = 538,
    ["Pull Request Labeler"] = 327,
    PyProject = 331,
    Qodana = 514,
    ["Quali Torque Blueprint Spec 2"] = 536,
    ["RKE Cluster Configuration JSON Schema"] = 497,
    ["RKE Cluster Configuration YAML Schema"] = 496,
    Ray = 467,
    ["Read the Docs"] = 330,
    ["Red-DiscordBot Cog"] = 332,
    ["Red-DiscordBot Cog Repo"] = 333,
    Renovate = 339,
    ["Replit schema"] = 336,
    RoadRunner = 340,
    ["Rust toolchain"] = 342,
    SWADL = 386,
    ["Sapphire CLI Config"] = 343,
    ["SauceCTL Configuration"] = 503,
    ["Schema Catalog"] = 356,
    ["Scoop manifest"] = 361,
    ["Semgrep Rule"] = 363,
    ["Serverless Framework Configuration"] = 510,
    ["Settings.paf"] = 365,
    ["Shopware 6 Configuration"] = 511,
    ["Shopware CLI Extension Store Configuration"] = 512,
    ["Shopware CLI Project Store Configuration"] = 513,
    Solidarity = 370,
    ["Source Maps v3"] = 371,
    SpecIF = 372,
    ["Sponge Mixin configuration"] = 373,
    ["StackHawk Scanner Configuration"] = 509,
    ["StackHead CLI config"] = 377,
    ["StackHead module configuration"] = 378,
    ["StackHead project definition"] = 379,
    Stale = 380,
    Starship = 381,
    ["Statamic Blueprint"] = 382,
    ["Stryker Mutator"] = 383,
    ["StyleCop Analyzers Configuration"] = 384,
    ["Swagger API 2.0"] = 387,
    ["Talisman configuration"] = 388,
    ["Taskfile YAML Schema"] = 493,
    Taurus = 389,
    ["TestEnvironment.json"] = 395,
    Tikibase = 392,
    ["Traefik v2"] = 397,
    ["Traefik v2 File Provider"] = 398,
    Tye = 515,
    ["UI5 Manifest"] = 410,
    ["UTAM Page Object"] = 412,
    ["Ubuntu Server Autoinstall"] = 408,
    ["Uniswap Token List"] = 476,
    Updatecli = 522,
    ["User Journey Map YAML Schema"] = 495,
    V2Ray = 526,
    ["VSCode Code Snippets"] = 98,
    ["VSIX CLI publishing"] = 423,
    ["Vela Pipeline Configuration"] = 415,
    Vercel = 97,
    ["Web App Manifest"] = 427,
    ["Web types"] = 430,
    WebExtensions = 426,
    ["Webman package recipe"] = 532,
    ["Windows Package Manager Installer Manifest"] = 473,
    ["Windows Package Manager Locale Manifest"] = 474,
    ["Windows Package Manager Singleton Manifest"] = 472,
    ["Woodpecker pipeline config"] = 505,
    ["Xstate Machine Schema"] = 520,
    ["Yippee-Ki-JSON configuration YML"] = 478,
    ["angular.json"] = 8,
    ...
    ["chutzpah.json"] = 105,
    ["cloud-init: cloud-config userdata JSON schema"] = 92,
    ["cloud-sdk-pipeline-config-schema"] = 107,
    ["cloudbuild.json"] = 108,
    cloudify = 91,
    codemagic = 93,
    ["coffeelint.json"] = 114,
    comet = 488,
    ["commands.json"] = 101,
    ["compile_commands.json"] = 100,
    ["compilerconfig.json"] = 99,
    ["component-detection-manifest.json"] = 117,
    ["component.json"] = 116,
    ["composer.json"] = 115,
    ["config.json"] = 118,
    ["contentmanifest.json"] = 106,
    ["contribute.json"] = 119,
    ["cosmos.config.json"] = 103,
    ["crowdin.yml"] = 120,
    cspell = 123,
    ["cypress.json"] = 121,
    ["datalogic-scan2deploy-android"] = 129,
    ["datalogic-scan2deploy-ce"] = 130,
    ["debugsettings.json"] = 131,
    ["dependabot-v2.json"] = 134,
    ["dependabot.json"] = 133,
    ["deployed-cli"] = 519,
    ["detekt.yml"] = 136,
    devinit = 480,
    ...
    ["dockerd.json"] = 138,
    ["dotnet Release Index manifest"] = 148,
    ["dotnetcli.host.json"] = 149,
    ["drone.json"] = 150,
    ["dss-2.0.0.json"] = 152,
    ["dvc.yaml"] = 153,
    ["ecosystem.json"] = 155,
    eksctl = 156,
    ["electron-builder configuration file."] = 161,
    ["epr-manifest.json"] = 159,
    ["evcc.yaml"] = 162,
    ["fabric.mod.json"] = 166,
    ["first-timers-bot"] = 169,
    ["fly.io Schema"] = 43,
    fulibWorkflows = 504,
    ["func.yaml"] = 174,
    ["function.json"] = 175,
    ...
    ["gitlab-ci"] = 186,
    ["global.json"] = 188,
    ["golangci-lint Configuration"] = 189,
    ["haxelib.json"] = 202,
    helmfile = 469,
    ["host-meta.json"] = 207,
    ["host.json"] = 206,
    ...
    huskyrc = 448,
    ["ide.host.json"] = 210,
    ["imageoptimizer.json"] = 211,
    ["importmap.json"] = 213,
    ["ioBroker JSON UI"] = 214,
    ["ioBroker Package manifest"] = 215,
    ["jsconfig.json"] = 232,
    ["jscpd Configuration Schema"] = 537,
    jsdoc = 466,
    ["k3d.yaml"] = 233,
    ["kustomization.yaml"] = 237,
    ["label-commenter-config.yml"] = 238,
    ["launchsettings.json"] = 239,
    ["lerna.json"] = 240,
    ["lgtm.yml"] = 241,
    ["libman.json"] = 242,
    ["license-report-config.json"] = 243,
    ["linkinator.config.json"] = 244,
    ["local.settings.json"] = 246,
    ["localazy.json"] = 247,
    ["lsdlschema.json"] = 248,
    mboats = 508,
    ["mimetypes.json"] = 254,
    ...
    ["mtad.yaml"] = 451,
    ["mycode.json"] = 269,
    ["napari plugin manifest"] = 270,
    neoload = 461,
    ["nest-cli"] = 275,
    ["ninjs (News in JSON) 1.3"] = 274,
    ["ninjs (News in JSON) 2.0"] = 273,
    ["nlu.json"] = 276,
    ["nodemon.json"] = 278,
    ["noodl.schema.json"] = 507,
    now = 457,
    ["nswag.json"] = 282,
    ntangle = 283,
    ["nuclei-template.yaml"] = 280,
    ["nuget-project.json"] = 281,
    ["ocelot.json"] = 285,
    ["omnisharp.json"] = 286,
    ["openapi.json"] = 287,
    ["openfin.json"] = 289,
    ["openrpc.json"] = 288,
    ["package.json"] = 298,
    ["package.manifest"] = 299,
    ["pattern.json"] = 302,
    ["petstore-v1.0"] = 546,
    pgap_yaml_input_reader = 301,
    ["plagiarize-me.yaml"] = 306,
    ["plagiarize.yaml"] = 305,
    ["portman.json"] = 307,
    ["prettierrc.json"] = 312,
    ["prisma.yml"] = 313,
    ["project-1.0.0-beta3.json"] = 315,
    ["project-1.0.0-beta4.json"] = 316,
    ["project-1.0.0-beta5.json"] = 317,
    ["project-1.0.0-beta6.json"] = 318,
    ["project-1.0.0-beta8.json"] = 319,
    ["project-1.0.0-rc1.json"] = 320,
    ["project-1.0.0-rc2.json"] = 321,
    ["project.json"] = 314,
    ["prometheus.json"] = 322,
    ["prometheus.rules.json"] = 323,
    ["proxies.json"] = 324,
    ["publiccode.yml"] = 325,
    ["pubspec.yaml"] = 326,
    ["pyrseas-0.8.json"] = 329,
    ["release drafter"] = 462,
    rustfmt = 341,
    ["sarif-1.0.0.json"] = 344,
    ["sarif-2.0.0.json"] = 345,
    ["sarif-2.1.0"] = 354,
    ["sarif-2.1.0-rtm.2"] = 346,
    ["sarif-2.1.0-rtm.3"] = 348,
    ["sarif-2.1.0-rtm.4"] = 350,
    ["sarif-2.1.0-rtm.5"] = 352,
    ["sarif-external-property-file-2.1.0"] = 355,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 347,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 349,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 351,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 353,
    ["schema.org - Action"] = 357,
    ["schema.org - ContactPoint"] = 358,
    ["schema.org - Place"] = 359,
    ["schema.org - Thing"] = 360,
    ["semantic-release"] = 362,
    ["servicehub.config.json"] = 440,
    ["servicehub.service.json"] = 439,
    ["settings.job"] = 364,
    ["sfdx-hardis configuration"] = 366,
    ["size-limit configuration"] = 367,
    ["skaffold.yaml"] = 501,
    ["skyuxconfig.json"] = 368,
    snapcraft = 369,
    swcrc = 489,
    taskcat = 458,
    ["template.json"] = 390,
    ["templatsources.json"] = 391,
    ["theme.json"] = 393,
    tmLanguage = 394,
    ["trunk.yaml schema"] = 399,
    ["ts-force-config.json"] = 403,
    ["tsconfig.json"] = 400,
    ["tsd.json"] = 401,
    ["tsdrc.json"] = 402,
    ["tslint.json"] = 404,
    ...
    ["version.json"] = 416,
    ["vim-addon-info"] = 417,
    ["vs-2017.3.host.json"] = 419,
    ["vs-nesting.json"] = 420,
    ["vsls.json"] = 418,
    ["vss-extension.json"] = 424,
    ["webhint.io"] = 533,
    ["webjobpublishsettings.json"] = 429,
    ["webjobs-list.json"] = 428,
    ["xs-app.json"] = 454,
    ["xunit.runner.json"] = 438,
    yamllint = 477,
    zuul = 463,
    ["Žinoma"] = 471
  },
  schemas = { {
      ...
      url = "https://raw.githubusercontent.com/thoughtworks/talisman/main/third-party/schema-store-talismanrc.json"
    }, {
