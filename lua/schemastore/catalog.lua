...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 216,
    [".cryproj (generic)"] = 700,
    [".cryproj engine-5.2"] = 695,
    [".cryproj engine-5.3"] = 696,
    [".cryproj engine-5.4"] = 697,
    [".cryproj engine-5.5"] = 698,
    [".cryproj engine-dev"] = 699,
    [".eslintrc"] = 279,
    [".esmrc.json"] = 264,
    [".ffizer.yaml"] = 283,
    [".htmlhintrc"] = 340,
    ...
    [".mtaext"] = 711,
    [".nodehawkrc"] = 453,
    [".npmpackagejsonlintrc"] = 457,
    [".omletrc"] = 886,
    [".phrase.yml"] = 504,
    [".phraseapp.yml"] = 505,
    [".pmbot.yml"] = 494,
    [".postcssrc"] = 499,
    [".powerpages-web-template-manifest"] = 501,
    [".pre-commit-config.yml"] = 502,
    [".pre-commit-hooks.yml"] = 503,
    [".putout.json"] = 524,
    [".rehyperc"] = 543,
    [".remarkrc"] = 545,
    [".sprite files"] = 603,
    ...
    ["<div>RIOTS' studio configuration"] = 678,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 408,
    ABCSupplyPlan = 13,
    AIConfig = 14,
    ["API Builder"] = 743,
    ["AVA Configuration"] = 803,
    ...
    ["Adobe UXP Manifest"] = 868,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 15,
    ["Airplane task"] = 16,
    ["Alacritty Configuration"] = 775,
    ["All Contributors configuration file"] = 833,
    ...
    ["Azure Pipelines"] = 72,
    ["Azure Static Web Apps CLI configuration file"] = 606,
    ["Azure Static Web Apps configuration file"] = 605,
    ["BX CI"] = 110,
    ["Bashly (bashly.yml)"] = 837,
    ["Bashly Settings (bashly-settings.yml)"] = 838,
    ["Better Code Hub"] = 747,
    ["Better Scripts"] = 111,
    Bigconfig = 89,
    BizTalkServerApplicationSchema = 717,
    Bleep = 112,
    ...
    ["Butane Config"] = 788,
    ["CGS Custom Card Game (CardGameDef.json)"] = 873,
    ["CICS TS region tagging"] = 797,
    ["CICS TS resource import"] = 798,
    ["CICS TS resource model"] = 799,
    ["CICS TS resource overrides"] = 800,
    ["CMake Presets"] = 113,
    ["CNC Codes"] = 127,
    ...
    CityJSON = 123,
    ["Clawject config"] = 132,
    ["Cloud Foundry Application Manifest"] = 885,
    ...
    ["Configu .cfgu files"] = 890,
    ["Configu .configu file"] = 891,
    Conjure = 126,
    ["Container Structure Test"] = 730,
    Containerlab = 755,
    ["Crowdsec collection config"] = 212,
    ["Crowdsec parser config"] = 213,
    ["Crowdsec scenario config"] = 214,
    ["CumulusCI Config"] = 131,
    ["Custom Machinery Machine"] = 874,
    ["Custom Machinery Recipe"] = 875,
    ...
    ["DataYoga Job"] = 136,
    ["Databricks Asset Bundles"] = 854,
    ["Datadog Service Definition"] = 384,
    ["Datahub Ingestion Recipe"] = 804,
    ["Dein Config"] = 138,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 845,
    ["EAS config"] = 277,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 834,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 870,
    GitVersion = 303,
    ["Gitea Issue Template configuration"] = 304,
    ["Gitea Issue Template forms"] = 305,
    ["Gitpod Configuration"] = 315,
    ["GlazeWM settings"] = 872,
    ["Global Privacy Control"] = 302,
    Goblet = 853,
    ["Golangci-lint Configuration"] = 317,
    ["Golangci-lint Custom Plugins Configuration"] = 318,
    ["Google Chrome Related Website Sets"] = 285,
    ["Google Cloud Workflows"] = 190,
    Goreleaser = 320,
    ["Goreleaser Pro"] = 321,
    Goss = 322,
    ["Gradle Build Cache Node"] = 745,
    ["Gradle Enterprise"] = 744,
    ["Grafana 5.x Dashboard"] = 323,
    ["GraphQL Code Generator"] = 327,
    ["GraphQL Config"] = 326,
    ["GraphQL Mesh"] = 325,
    ["Grunt JSHint task"] = 331,
    ["Grunt Watch task"] = 332,
    ["Grunt base task"] = 333,
    ["Grunt clean task"] = 329,
    ["Grunt copy task"] = 328,
    ["Grunt cssmin task"] = 330,
    HEMTT = 714,
    Hadolint = 726,
    Hammerkit = 754,
    ["Hardware Sentry Configuration"] = 808,
    Hatch = 727,
    Hayson = 335,
    ["Haystack Pipeline"] = 336,
    ["Hazelcast 5 Configuration"] = 337,
    ["Helm Chart.lock"] = 158,
    ["Helm Chart.yaml"] = 157,
    ["Helm Unittest Test Suite"] = 159,
    Hugo = 784,
    ["Hugo Theme"] = 783,
    ["Hyperfoil benchmark configuration"] = 343,
    ["IBM Zapp document"] = 344,
    ["IBM zCodeFormatSettings"] = 345,
    ["IMG Catapult PSP"] = 350,
    ["IVMS101 by CODE Protocol"] = 871,
    Infrahub = 352,
    Istanbul = 811,
    ["JDownloader2 crawler multi-rules"] = 361,
    ["JDownloader2 crawler single-rules"] = 360,
    ["JFrog Applications Config"] = 362,
    ["JFrog File Spec"] = 363,
    ["JFrog Pipelines YML DSL"] = 817,
    ["JMeter DSL cli config"] = 364,
    JReleaser = 366,
    ["JSON Document Transform"] = 374,
    ["JSON Feed"] = 375,
    ["JSON Resume"] = 550,
    ["JSON Schema Draft 2020-12"] = 691,
    ["JSON Schema Draft 4"] = 688,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 855,
    ["JSON Schema Draft 7"] = 689,
    ["JSON Schema Draft 7 (unofficial strict)"] = 856,
    ["JSON Schema Draft 8 (2019-09)"] = 690,
    ["JSON-API"] = 373,
    ["JSON-WF"] = 884,
    ["JSON-e templates"] = 752,
    ["JSON-stat 2.0"] = 685,
    JSONPatch = 377,
    ["JSR Package Config (jsr.json)"] = 367,
    Jasmine = 356,
    Jekyll = 357,
    ["Jenkins X Pipelines"] = 358,
    ["Jenkins X Requirements"] = 359,
    ["Jovo Language Models"] = 365,
    ["KIMMDY config file"] = 382,
    ["KSP-AVC"] = 686,
    ["KSP-CKAN"] = 687,
    KSY = 883,
    ["Karakum configuration file"] = 295,
    Kas = 380,
    ["Keycloak REST API"] = 825,
    ["Knative Functions - func.yaml"] = 296,
    ["KoDE/CI build.yaml"] = 813,
    ["Kong DBLess config"] = 814,
    KrakenD = 383,
    ["Kubri Configuration"] = 388,
    LOOBin = 403,
    ...
    Lefthook = 392,
    ["Liferay client-extension.yaml"] = 399,
    ["LinkML Metamodel"] = 401,
    Liquibase = 760,
    ["Liquibase Flow File"] = 761,
    ["Lively Properties"] = 402,
    ["Lobe AI Agent"] = 70,
    Loki = 71,
    ["MLOS Configs"] = 437,
    ["MS2Rescore Configuration"] = 440,
    ["Madness (madness.yml)"] = 836,
    Markdownlint = 764,
    ["Mason Registry"] = 766,
    ["MegaLinter configuration"] = 409,
    ["MegaLinter descriptor"] = 410,
    Melange = 862,
    ["Meltano plugin discovery definition"] = 412,
    ["Meltano project definition"] = 411,
    ["Mergify Configuration"] = 441,
    ["MetricsHub Configuration"] = 413,
    ["MetricsHub Connector Configuration"] = 414,
    ["Micro Editor Syntax"] = 846,
    ["Microsoft Band Web Tile"] = 415,
    ["Minecraft Custom Main Menu Mod"] = 863,
    ["Minecraft Data Pack Advancement"] = 417,
    ["Minecraft Data Pack Biome"] = 418,
    ["Minecraft Data Pack Configured Carver"] = 419,
    ["Minecraft Data Pack Damage Type"] = 420,
    ["Minecraft Data Pack Dimension"] = 422,
    ["Minecraft Data Pack Dimension Type"] = 421,
    ["Minecraft Data Pack Item Modifier"] = 423,
    ["Minecraft Data Pack Loot Table"] = 424,
    ["Minecraft Data Pack Metadata"] = 425,
    ["Minecraft Data Pack Predicate"] = 426,
    ["Minecraft Data Pack Recipe"] = 427,
    ["Minecraft Data Pack Tag"] = 428,
    ["Minecraft Data Pack Template Pool"] = 429,
    ["Minecraft Data Pack Trim Material"] = 434,
    ["Minecraft Data Pack Trim Pattern"] = 435,
    ["Minecraft Resource Pack Lang"] = 430,
    ["Minecraft Resource Pack Particle"] = 431,
    ["Minecraft Resource Pack Texture Mcmeta"] = 433,
    ["Minecraft Resourcepack Sounds"] = 432,
    ["Monade CLI Stack Configuration"] = 444,
    ["MongoDB Atlas Search Index Definition"] = 812,
    ["Monika Configuration"] = 810,
    ["Monoweave Configuration"] = 439,
    ["Motif config"] = 710,
    ["NOX Framework (Service)"] = 456,
    ["Netin Diagnostic System Template"] = 770,
    ["Netlify config"] = 447,
    ["Network-as-Code Data Model"] = 448,
    ["Nightwatch.js"] = 449,
    ["Nuitka.yaml"] = 876,
    ["ONe's changelog entry"] = 472,
    ["ONe's service descriptor"] = 471,
    ["OSS Review Toolkit configuration"] = 480,
    ["OSS Review Toolkit curation"] = 481,
    ["OSS Review Toolkit package configuration"] = 482,
    ["OSS Review Toolkit repository configuration"] = 483,
    ["OSS Review Toolkit resolutions"] = 484,
    Opctl = 713,
    ["Open Data Contract Standard (ODCS))"] = 475,
    ["OpenRewrite Resource"] = 474,
    ["OpenUtau character yaml"] = 468,
    ["OpenUtau ustx"] = 469,
    ["OpenWeather Current Weather API"] = 751,
    ["OpenWeather Road Risk API"] = 750,
    ["Ory Hydra configuration"] = 342,
    ["Ory Keto configuration"] = 385,
    ["Ory Kratos configuration"] = 479,
    ["Ory Oathkeeper configuration"] = 463,
    ["Outblocks App configuration"] = 477,
    ["Outblocks database table"] = 478,
    ["Outblocks project configuration"] = 476,
    PDM = 490,
    Packer = 487,
    Pantsbuild = 832,
    ["Paper paper-plugin.yml"] = 488,
    ["Pipeline component"] = 762,
    ["PocketMine plugin.yml"] = 495,
    ["Postman collection"] = 500,
    ["Problem object RFC9457"] = 860,
    ["Problem package generators"] = 508,
    Pterodactyl = 807,
    ["Pull Request Labeler"] = 523,
    Pulumi = 529,
    PyProject = 530,
    Pyright = 531,
    Qgoda = 532,
    Qodana = 780,
    ["Qt Creator workspace file"] = 892,
    ["Quali Torque Blueprint Spec 2"] = 805,
    ["QueryFirst config file"] = 828,
    ["RKE Cluster Configuration JSON"] = 759,
    ["RKE Cluster Configuration YAML"] = 758,
    ["Rancher Fleet"] = 526,
    ["Rattler-build"] = 533,
    Ray = 725,
    ["Read the Docs"] = 528,
    ["Red-DiscordBot Cog"] = 540,
    ["Red-DiscordBot Cog Repo"] = 541,
    ["Red-DiscordBot Trivia"] = 542,
    ["Render Blueprints"] = 757,
    RenderCV = 552,
    Renovate = 551,
    ["Replit config"] = 546,
    RoadRunner = 553,
    ["Rudder techniques"] = 866,
    Ruff = 548,
    ["Rust Project"] = 549,
    ["Rust toolchain"] = 556,
    ["SDMX data message"] = 581,
    ["SDMX metadata message"] = 580,
    ["SDMX structure message"] = 579,
    ["SIL Kit Participant Configuration"] = 591,
    ["SIL Kit Registry Configuration"] = 592,
    SWADL = 617,
    ["Safebox Config"] = 818,
    ["Sapphire CLI Config"] = 559,
    ["SauceCTL Configuration"] = 767,
    ["Schema Catalog"] = 573,
    ["Scoop manifest"] = 578,
    ["Semantic Data Fabric (SDF) file"] = 582,
    ["Semgrep Rule"] = 584,
    ["Serenity Code Generator (Sergen)"] = 585,
    ["Serverless Framework Configuration"] = 774,
    ["Serverless Workflow"] = 776,
    ["Settings.paf"] = 587,
    ["Shopware 6 Configuration"] = 777,
    ["Shopware CLI Extension Store Configuration"] = 778,
    ["Shopware CLI Project Store Configuration"] = 779,
    Sigma = 589,
    ["Sigrid scope configuration file"] = 590,
    ["SkyPilot Task JSON"] = 867,
    ["Slack app manifest"] = 594,
    Solidarity = 597,
    ["Solution filters"] = 598,
    ["Source Maps v3"] = 599,
    Sourcery = 600,
    SpecIF = 601,
    ["Sponge Mixin configuration"] = 602,
    StackBlitz = 607,
    ["StackHawk Scanner Configuration"] = 773,
    Stale = 608,
    ["Starlake Data Pipeline"] = 748,
    Starship = 609,
    ["Statamic Blueprint"] = 610,
    ["Stella configuration file"] = 611,
    ["StrmPrivacy Data Connector"] = 822,
    ["StrmPrivacy Data Contract"] = 823,
    ["StrmPrivacy SimpleSchema"] = 820,
    ["StrmPrivacy Stream"] = 821,
    ["StrmPrivacy batch job configuration file"] = 819,
    ["Stryker Mutator"] = 614,
    ["StyleCop Analyzers Configuration"] = 615,
    ["Stylelint (.stylelintrc)"] = 616,
    ["Sublime Syntax"] = 824,
    ["Subsquid squid manifest"] = 869,
    ["Swagger API 2.0"] = 618,
    TSON = 644,
    TSTyche = 645,
    Talhelper = 620,
    ["Talisman configuration"] = 621,
    ["Taskfile config"] = 753,
    Taurus = 622,
    ["TestEnvironment.json"] = 631,
    ["TextMate Grammar"] = 630,
    ["Tier.run pricing.json"] = 625,
    Tikibase = 626,
    ["Traefik v2"] = 634,
    ["Traefik v2 File Provider"] = 635,
    ["Travis CI (.travis.yml)"] = 633,
    TunnelHub = 859,
    Turborepo = 632,
    Tye = 781,
    ["UET BuildConfig.json"] = 829,
    ["UI5 Manifest"] = 654,
    ["UNCORS configuration"] = 658,
    ["UTAM Page Object"] = 657,
    ["Ubuntu Server Autoinstall"] = 652,
    ["Uniswap Token List"] = 736,
    ["Unreal Engine Uplugin"] = 830,
    ["Unreal Engine Uproject"] = 831,
    ["Updatecli Compose"] = 789,
    ["Updatecli Policy Manifest"] = 790,
    ["Updatecli Policy Metadata"] = 791,
    Uplift = 827,
    ["User Journey Map"] = 756,
    V2Ray = 795,
    ["VSCode Code Snippets"] = 178,
    ["VSIX CLI publishing"] = 673,
    ["Vela Pipeline Configuration"] = 662,
    Vercel = 177,
    Visivo = 857,
    ["Web App Manifest"] = 680,
    ["Web types"] = 683,
    WebExtensions = 679,
    ["Webman package recipe"] = 801,
    ["Windows Package Manager Installer Manifest"] = 733,
    ["Windows Package Manager Locale Manifest"] = 734,
    ["Windows Package Manager Singleton Manifest"] = 732,
    ["Woodpecker pipeline config"] = 769,
    ["Wrangler CLI"] = 684,
    ["Xstate Machine"] = 787,
    ["Yarn Config (.yarnrc.yml)"] = 746,
    ["Yippee-Ki-JSON configuration YML"] = 738,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 861,
    ...
    ["behat.yml"] = 96,
    ["bigquery-table"] = 88,
    ["bioimageio resource description"] = 877,
    ...
    ["gitlab-ci"] = 314,
    ["global.json"] = 316,
    ["go-feature-flag Flag Configuration"] = 319,
    ["haxelib.json"] = 334,
    helmfile = 728,
    helmwave = 729,
    ["host-meta.json"] = 339,
    ...
    ["ide.host.json"] = 346,
    ["ifstate.conf"] = 347,
    ["imageoptimizer.json"] = 348,
    ["importmap.json"] = 351,
    ["ioBroker Configuration"] = 353,
    ["ioBroker JSON UI"] = 354,
    ["ioBroker Package manifest"] = 355,
    ["ize.toml"] = 826,
    ["jsconfig.json"] = 378,
    ["jscpd Configuration"] = 806,
    jsdoc = 724,
    ["k3d.yaml"] = 379,
    ["k9s plugin.yml"] = 381,
    ["kontinuous-config.yaml"] = 387,
    ["kontinuous-values.yaml"] = 386,
    ["kustomization.yaml"] = 389,
    ["label-commenter-config.yml"] = 390,
    ["latexindent configuration"] = 69,
    ["launchsettings.json"] = 391,
    lazydocker = 848,
    lazygit = 847,
    ["lego.json"] = 393,
    ["lerna.json"] = 394,
    ["lgtm.yml"] = 395,
    ["liblab.config.json"] = 396,
    ["libman.json"] = 397,
    ["license-report-config.json"] = 398,
    ["linkinator.config.json"] = 400,
    ["lint-staged (.lintstagedrc)"] = 704,
    ["local.settings.json"] = 405,
    ["localazy.json"] = 406,
    ["lotus.yaml"] = 404,
    ["lsdlschema.json"] = 407,
    ["markdown-link-check"] = 765,
    mboats = 772,
    ["micro-settings.json"] = 841,
    ["mimetypes.json"] = 416,
    ["mirrord config"] = 705,
    mise = 706,
    ["mise-settings"] = 707,
    ["mkdocs.yml"] = 436,
    ["monospace.yml"] = 438,
    ["mprocs Configuration file"] = 893,
    ["mta.yaml"] = 708,
    ["mtad.yaml"] = 709,
    ["mycode.json"] = 445,
    ["napari plugin manifest"] = 446,
    neoload = 719,
    ["nest-cli"] = 451,
    ["ninjs (News in JSON)"] = 450,
    ["nixd configuration"] = 865,
    ["nlu.json"] = 452,
    ["nodemon.json"] = 454,
    ["noodl config"] = 771,
    ["notebook.mod.json"] = 455,
    now = 715,
    ["npm-badges"] = 458,
    ["nswag.json"] = 461,
    ntangle = 462,
    ["nuclei-template.yaml"] = 459,
    ["nuget-project.json"] = 460,
    ["ocelot.json"] = 464,
    ["omnisharp.json"] = 465,
    ["openapi.json"] = 466,
    ["openfin.json"] = 473,
    ...
    ["ops.yaml"] = 470,
    ["package.json"] = 485,
    ["package.manifest"] = 486,
    ["partial-black.json"] = 97,
    ["pathfinder.yml"] = 489,
    ["pattern.json"] = 492,
    ["petstore-v1.0"] = 816,
    pgap_yaml_input_reader = 491,
    ["pixi.toml"] = 493,
    ["plagiarize-me.yaml"] = 497,
    ["plagiarize.yaml"] = 496,
    ["portman.json"] = 498,
    ["prettierrc.json"] = 506,
    ["prisma.yml"] = 507,
    ["project-1.0.0-beta3.json"] = 510,
    ["project-1.0.0-beta4.json"] = 511,
    ["project-1.0.0-beta5.json"] = 512,
    ["project-1.0.0-beta6.json"] = 513,
    ["project-1.0.0-beta8.json"] = 514,
    ["project-1.0.0-rc1.json"] = 515,
    ["project-1.0.0-rc2.json"] = 516,
    ["project.json"] = 509,
    ["prometheus.json"] = 517,
    ["prometheus.rules.json"] = 518,
    ["prometheus.rules.test.json"] = 519,
    ["proxies.json"] = 520,
    ["publiccode.yml"] = 521,
    ["pubspec.yaml"] = 522,
    ["pyrseas-0.8.json"] = 525,
    ["quilt.mod.json"] = 842,
    ["rc3 auth"] = 534,
    ["rc3 collection"] = 535,
    ["rc3 environment"] = 536,
    ...
    ["rc3 settings"] = 539,
    ["release drafter"] = 720,
    ["release-plz.toml"] = 544,
    ["rivet.yaml"] = 864,
    rockcraft = 554,
    rustfmt = 555,
    samt = 557,
    samtrc = 558,
    ["sarif-1.0.0.json"] = 560,
    ["sarif-2.0.0.json"] = 561,
    ["sarif-2.1.0"] = 571,
    ["sarif-2.1.0-rtm.2"] = 562,
    ["sarif-2.1.0-rtm.3"] = 564,
    ["sarif-2.1.0-rtm.4"] = 566,
    ["sarif-2.1.0-rtm.5"] = 568,
    ["sarif-2.1.0-rtm.6"] = 569,
    ["sarif-external-property-file-2.1.0"] = 572,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 563,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 565,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 567,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 570,
    ["schema.org - Action"] = 574,
    ["schema.org - ContactPoint"] = 575,
    ["schema.org - Place"] = 576,
    ["schema.org - Thing"] = 577,
    ["secrethub.yml"] = 844,
    ["semantic-release"] = 583,
    ["servicehub.config.json"] = 694,
    ["servicehub.service.json"] = 693,
    ["settings.job"] = 586,
    ["sfdx-hardis configuration"] = 588,
    ["shard.yml"] = 880,
    ["size-limit configuration"] = 593,
    ["skaffold.yaml"] = 763,
    ["skyuxconfig.json"] = 595,
    snapcraft = 596,
    ["sqlc configuration"] = 604,
    ["stripe-app-local.json"] = 613,
    ["stripe-app.json"] = 612,
    swcrc = 749,
    ["task.json"] = 619,
    taskcat = 716,
    ["template.json"] = 623,
    ["templatsources.json"] = 624,
    ["theme.json"] = 627,
    ["tizen_workspace.json"] = 628,
    tldr = 629,
    tmuxinator = 702,
    ["transcend.yml"] = 636,
    ["tree-sitter grammar.json"] = 324,
    ["trime.yaml"] = 637,
    ["trunk.yaml"] = 638,
    ["ts-force-config.json"] = 642,
    ["tsconfig.json"] = 639,
    ["tsd.json"] = 640,
    ["tsdrc.json"] = 641,
    ["tslint.json"] = 643,
    ...
    ["vega-lite.json"] = 661,
    ["vega.json"] = 660,
    ["venvironment-basic.yaml"] = 664,
    ["venvironment.yaml"] = 663,
    ["version.json"] = 665,
    ["vim-addon-info"] = 667,
    ["vs-2017.3.host.json"] = 669,
    ["vs-nesting.json"] = 670,
    ["vsls.json"] = 668,
    ["vss-extension.json"] = 674,
    ["vtesttree.yaml"] = 675,
    ["vtestunit.yaml"] = 676,
    ["warp-keysets.json"] = 850,
    ["warp-themes.json"] = 851,
    ["warp-workflows.json"] = 852,
    ["webhint.io"] = 802,
    ["webjobpublishsettings.json"] = 682,
    ["webjobs-list.json"] = 681,
    ["well-known-fursona"] = 888,
    ["xs-app.json"] = 712,
