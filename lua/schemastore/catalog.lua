...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 177,
    [".cryproj (generic)"] = 606,
    [".cryproj engine-5.2"] = 601,
    [".cryproj engine-5.3"] = 602,
    [".cryproj engine-5.4"] = 603,
    [".cryproj engine-5.5"] = 604,
    [".cryproj engine-dev"] = 605,
    [".csscomb.json"] = 179,
    [".csslintrc"] = 180,
    [".es6importsorterrc.json"] = 737,
    [".eslintrc"] = 229,
    [".esmrc.json"] = 221,
    [".ffizer.yaml"] = 233,
    [".htmlhintrc"] = 285,
    ...
    [".pmbot.yml"] = 419,
    [".postcssrc"] = 425,
    [".powerpages-web-template-manifest"] = 427,
    [".pre-commit-config.yml"] = 428,
    [".pre-commit-hooks.yml"] = 429,
    [".putout.json"] = 449,
    [".rehyperc"] = 461,
    [".remarkrc"] = 462,
    [".sprite files"] = 517,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 679,
    ["All Contributors configuration file"] = 736,
    ...
    ["Azure Pipelines"] = 59,
    ["Azure Static Web Apps CLI configuration file"] = 520,
    ["Azure Static Web Apps configuration file"] = 519,
    ["BX CI"] = 95,
    ["Better Code Hub"] = 651,
    ["Better Scripts"] = 96,
    Bigconfig = 76,
    BizTalkServerApplicationSchema = 621,
    Bleep = 97,
    ...
    ["Butane Config"] = 691,
    ["CICS TS region tagging"] = 700,
    ["CICS TS resource import"] = 701,
    ["CICS TS resource model"] = 702,
    ["CICS TS resource overrides"] = 703,
    ["CMake Presets"] = 98,
    ["CNC Codes"] = 108,
    ...
    ["Databricks Asset Bundles"] = 757,
    ["Datadog Service Definition"] = 324,
    ["Datahub Ingestion Recipe"] = 707,
    ["Dein Config"] = 113,
    Deno = 190,
    ["Deployer Recipe"] = 193,
    ["Deta Spacefile"] = 114,
    ...
    ["Goreleaser Pro"] = 267,
    Goss = 268,
    ["Gradle Build Cache Node"] = 649,
    ["Gradle Enterprise"] = 648,
    ...
    Hadolint = 630,
    Hammerkit = 658,
    ["Hardware Sentry Configuration"] = 711,
    Hatch = 631,
    Hayson = 280,
    ...
    ["JFrog File Spec"] = 305,
    ["JFrog Pipelines YML DSL"] = 720,
    ["JMeter DSL cli config"] = 306,
    JReleaser = 308,
    ["JSON Document Transform"] = 315,
    ["JSON Feed"] = 316,
    ["JSON Resume"] = 468,
    ["JSON Schema Draft 2020-12"] = 597,
    ["JSON Schema Draft 4"] = 594,
    ["JSON Schema Draft 7"] = 595,
    ["JSON Schema Draft 7 (unofficial strict)"] = 758,
    ["JSON Schema Draft 8 (2019-09)"] = 596,
    ["JSON-API"] = 314,
    ["JSON-e templates"] = 656,
    ["JSON-stat 2.0"] = 591,
    JSONPatch = 318,
    Jasmine = 298,
    Jekyll = 299,
    ...
    Kas = 321,
    ["Keycloak REST API"] = 728,
    ["Knative Functions - func.yaml"] = 245,
    ["KoDE/CI build.yaml"] = 716,
    ["Kong DBLess config"] = 717,
    KrakenD = 323,
    LOOBin = 340,
    Lefthook = 331,
    ["LinkML Metamodel"] = 338,
    Liquibase = 663,
    ["Liquibase Flow File"] = 664,
    ...
    ["MongoDB Atlas Search Index Definition"] = 715,
    ["Monika Configuration"] = 713,
    ["Motif config"] = 614,
    ["NOX Framework (Service)"] = 386,
    ["Netin Diagnostic System Template"] = 673,
    ["Netlify config"] = 377,
    ["Nexus-as-Code Data Model"] = 378,
    ["Nightwatch.js"] = 379,
    ["ONe's service descriptor"] = 400,
    ["OSS Review Toolkit configuration"] = 407,
    ["OSS Review Toolkit curation"] = 408,
    ["OSS Review Toolkit package configuration"] = 409,
    ["OSS Review Toolkit repository configuration"] = 410,
    ["OSS Review Toolkit resolutions"] = 411,
    Opctl = 617,
    ["OpenRewrite Resource"] = 402,
    ["OpenUtau character yaml"] = 398,
    ["OpenWeather Current Weather API"] = 655,
    ["OpenWeather Road Risk API"] = 654,
    ["Ory Hydra configuration"] = 286,
    ["Ory Keto configuration"] = 325,
    ["Ory Kratos configuration"] = 406,
    ["Ory Oathkeeper configuration"] = 393,
    ["Outblocks App configuration"] = 404,
    ["Outblocks database table"] = 405,
    ["Outblocks project configuration"] = 403,
    Packer = 414,
    Pantsbuild = 735,
    ["Paper paper-plugin.yml"] = 415,
    ["Pipeline component"] = 665,
    ["PocketMine plugin.yml"] = 420,
    Poetry = 421,
    ["Postman collection"] = 426,
    ["Problem package generators"] = 433,
    Pterodactyl = 710,
    ["Pull Request Labeler"] = 448,
    Pulumi = 454,
    PyProject = 455,
    Pyright = 456,
    Qgoda = 457,
    Qodana = 684,
    ["Quali Torque Blueprint Spec 2"] = 708,
    ["QueryFirst config file"] = 731,
    ["RKE Cluster Configuration JSON"] = 662,
    ["RKE Cluster Configuration YAML"] = 661,
    ["Rancher Fleet"] = 451,
    Ray = 629,
    ["Read the Docs"] = 453,
    ["Red-DiscordBot Cog"] = 458,
    ["Red-DiscordBot Cog Repo"] = 459,
    ["Red-DiscordBot Trivia"] = 460,
    RenderCV = 470,
    Renovate = 469,
    ["Replit config"] = 463,
    RoadRunner = 471,
    ...
    ["Rust Project"] = 467,
    ["Rust toolchain"] = 473,
    ["SIL Kit Participant Configuration"] = 505,
    ["SIL Kit Registry Configuration"] = 506,
    SWADL = 530,
    ["Safebox Config"] = 721,
    ["Sapphire CLI Config"] = 476,
    ["SauceCTL Configuration"] = 670,
    ["Schema Catalog"] = 490,
    ["Scoop manifest"] = 495,
    ["Semantic Data Fabric (SDF) file"] = 496,
    ["Semgrep Rule"] = 498,
    ["Serenity Code Generator (Sergen)"] = 499,
    ["Serverless Framework Configuration"] = 678,
    ["Serverless Workflow"] = 680,
    ["Settings.paf"] = 501,
    Setuptools = 502,
    ["Shopware 6 Configuration"] = 681,
    ["Shopware CLI Extension Store Configuration"] = 682,
    ["Shopware CLI Project Store Configuration"] = 683,
    ["Sigrid scope configuration file"] = 504,
    ["Slack app manifest"] = 508,
    Solidarity = 511,
    ["Solution filters"] = 512,
    ["Source Maps v3"] = 513,
    Sourcery = 514,
    SpecIF = 515,
    ["Sponge Mixin configuration"] = 516,
    StackBlitz = 521,
    ["StackHawk Scanner Configuration"] = 677,
    Stale = 522,
    ["Starlake Data Pipeline"] = 652,
    Starship = 523,
    ["Statamic Blueprint"] = 524,
    ["StrmPrivacy Data Connector"] = 725,
    ["StrmPrivacy Data Contract"] = 726,
    ["StrmPrivacy SimpleSchema"] = 723,
    ["StrmPrivacy Stream"] = 724,
    ["StrmPrivacy batch job configuration file"] = 722,
    ["Stryker Mutator"] = 527,
    ["StyleCop Analyzers Configuration"] = 528,
    ["Sublime Syntax"] = 727,
    ["Swagger API 2.0"] = 531,
    TSON = 556,
    Talhelper = 533,
    ["Talisman configuration"] = 534,
    ["Taskfile config"] = 657,
    Taurus = 535,
    ["TestEnvironment.json"] = 544,
    ["TextMate Grammar"] = 543,
    ["Tier.run pricing.json"] = 538,
    Tikibase = 539,
    ["Traefik v2"] = 547,
    ...
    ["UI5 Manifest"] = 564,
    ["UTAM Page Object"] = 567,
    ["Ubuntu Server Autoinstall"] = 562,
    ["Uniswap Token List"] = 640,
    ["Unreal Engine Uplugin"] = 733,
    ["Unreal Engine Uproject"] = 734,
    ["Updatecli Compose"] = 692,
    ["Updatecli Policy Manifest"] = 693,
    ["Updatecli Policy Metadata"] = 694,
    Uplift = 730,
    ["User Journey Map"] = 660,
    V2Ray = 698,
    ["VSCode Code Snippets"] = 148,
    ["VSIX CLI publishing"] = 580,
    ["Vela Pipeline Configuration"] = 570,
    Vercel = 147,
    Visivo = 759,
    ["Web App Manifest"] = 587,
    ["Web types"] = 590,
    WebExtensions = 586,
    ["Webman package recipe"] = 704,
    ["Windows Package Manager Installer Manifest"] = 637,
    ["Windows Package Manager Locale Manifest"] = 638,
    ["Windows Package Manager Singleton Manifest"] = 636,
    ["Woodpecker pipeline config"] = 672,
    ["Xstate Machine"] = 690,
    ["Yippee-Ki-JSON configuration YML"] = 642,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 70,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 741,
    ["bashly-strings.yml"] = 742,
    ["bashly.yml"] = 740,
    ["batect.yml"] = 69,
    ...
    ["lsdlschema.json"] = 344,
    ["madness.yml"] = 739,
    ["markdown-lint-check"] = 668,
    mboats = 675,
    ["micro-settings.json"] = 744,
    ["mimetypes.json"] = 351,
    ["mirrord config"] = 611,
    ["mta.yaml"] = 612,
    ["mtad.yaml"] = 613,
    ...
    ["ops.yaml"] = 399,
    ["package.json"] = 412,
    ["package.manifest"] = 413,
    ["pathfinder.yml"] = 416,
    ["pattern.json"] = 418,
    ["petstore-v1.0"] = 719,
    pgap_yaml_input_reader = 417,
    ["plagiarize-me.yaml"] = 423,
    ["plagiarize.yaml"] = 422,
    ["portman.json"] = 424,
    ["prettierrc.json"] = 431,
    ["prisma.yml"] = 432,
    ["project-1.0.0-beta3.json"] = 435,
    ["project-1.0.0-beta4.json"] = 436,
    ["project-1.0.0-beta5.json"] = 437,
    ["project-1.0.0-beta6.json"] = 438,
    ["project-1.0.0-beta8.json"] = 439,
    ["project-1.0.0-rc1.json"] = 440,
    ["project-1.0.0-rc2.json"] = 441,
    ["project.json"] = 434,
    ["prometheus.json"] = 442,
    ["prometheus.rules.json"] = 443,
    ["prometheus.rules.test.json"] = 444,
    ["proxies.json"] = 445,
    ["publiccode.yml"] = 446,
    ["pubspec.yaml"] = 447,
    ["pyrseas-0.8.json"] = 450,
    ["quilt.mod.json"] = 745,
    ["release drafter"] = 624,
    rtx = 465,
    rustfmt = 472,
    samt = 474,
    samtrc = 475,
    ["sarif-1.0.0.json"] = 477,
    ["sarif-2.0.0.json"] = 478,
    ["sarif-2.1.0"] = 488,
    ["sarif-2.1.0-rtm.2"] = 479,
    ["sarif-2.1.0-rtm.3"] = 481,
    ["sarif-2.1.0-rtm.4"] = 483,
    ["sarif-2.1.0-rtm.5"] = 485,
    ["sarif-2.1.0-rtm.6"] = 486,
    ["sarif-external-property-file-2.1.0"] = 489,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 480,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 482,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 484,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 487,
    ["schema.org - Action"] = 491,
    ["schema.org - ContactPoint"] = 492,
    ["schema.org - Place"] = 493,
    ["schema.org - Thing"] = 494,
    ["scikit-build"] = 676,
    ["secrethub.yml"] = 747,
    ["semantic-release"] = 497,
    ["servicehub.config.json"] = 600,
    ["servicehub.service.json"] = 599,
    ["settings.job"] = 500,
    ["sfdx-hardis configuration"] = 503,
    ["size-limit configuration"] = 507,
    ["skaffold.yaml"] = 666,
    ["skyuxconfig.json"] = 509,
    snapcraft = 510,
    ["sqlc configuration"] = 518,
    ["stripe-app-local.json"] = 526,
    ["stripe-app.json"] = 525,
    swcrc = 653,
    syntax = 749,
    ["task.json"] = 532,
    taskcat = 620,
    ["template.json"] = 536,
    ["templatsources.json"] = 537,
    ["theme.json"] = 540,
    ["tizen_workspace.json"] = 541,
    tldr = 542,
    tmuxinator = 608,
    ["transcend.yml"] = 549,
    ["trunk.yaml"] = 550,
    ["ts-force-config.json"] = 554,
    ["tsconfig.json"] = 551,
    ["tsd.json"] = 552,
    ["tsdrc.json"] = 553,
    ["tslint.json"] = 555,
    ...
    ["vega-lite.json"] = 569,
    ["vega.json"] = 568,
    ["venvironment-basic.yaml"] = 572,
    ["venvironment.yaml"] = 571,
    ["version.json"] = 573,
    ["vim-addon-info"] = 574,
    ["vs-2017.3.host.json"] = 576,
    ["vs-nesting.json"] = 577,
    ["vsls.json"] = 575,
    ["vss-extension.json"] = 581,
    ["vtesttree.yaml"] = 582,
    ["vtestunit.yaml"] = 583,
    ["warp-keysets.json"] = 753,
    ["warp-themes.json"] = 754,
    ["warp-workflows.json"] = 755,
    ["webhint.io"] = 705,
    ["webjobpublishsettings.json"] = 589,
    ["webjobs-list.json"] = 588,
    ["xs-app.json"] = 616,
    ["xunit.runner.json"] = 598,
    yamllint = 641,
    zuul = 625,
    ["Žinoma"] = 635
  },
