...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 171,
    [".cryproj (generic)"] = 590,
    [".cryproj engine-5.2"] = 585,
    [".cryproj engine-5.3"] = 586,
    [".cryproj engine-5.4"] = 587,
    [".cryproj engine-5.5"] = 588,
    [".cryproj engine-dev"] = 589,
    [".csscomb.json"] = 173,
    [".csslintrc"] = 174,
    [".es6importsorterrc.json"] = 716,
    [".eslintrc"] = 223,
    [".esmrc.json"] = 215,
    [".ffizer.yaml"] = 227,
    [".htmlhintrc"] = 277,
    ...
    [".mtaext"] = 599,
    [".nodehawkrc"] = 375,
    [".npmpackagejsonlintrc"] = 378,
    [".phraseapp.yml"] = 419,
    [".pmbot.yml"] = 409,
    [".postcssrc"] = 414,
    [".powerpages-web-template-manifest"] = 416,
    [".pre-commit-config.yml"] = 417,
    [".pre-commit-hooks.yml"] = 418,
    [".putout.json"] = 438,
    [".rehyperc"] = 450,
    [".remarkrc"] = 451,
    [".sprite files"] = 504,
    ...
    ["<div>RIOTS' studio configuration"] = 569,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 336,
    ["API Builder"] = 630,
    ["AVA Configuration"] = 686,
    ["AWS CDK cdk.json"] = 155,
    ["AWS CloudFormation"] = 156,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 157,
    ["AWS SAM CLI Samconfig"] = 158,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 13,
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 661,
    ["All Contributors configuration file"] = 715,
    ...
    ["Azure Pipelines"] = 55,
    ["Azure Static Web Apps CLI configuration file"] = 507,
    ["Azure Static Web Apps configuration file"] = 506,
    ["BX CI"] = 91,
    ["Better Code Hub"] = 634,
    ["Better Scripts"] = 92,
    Bigconfig = 72,
    BizTalkServerApplicationSchema = 605,
    Bleep = 93,
    ...
    ["Butane Config"] = 673,
    ["CICS TS region tagging"] = 680,
    ["CICS TS resource import"] = 681,
    ["CICS TS resource model"] = 682,
    ["CICS TS resource overrides"] = 683,
    ["CMake Presets"] = 94,
    ["CNC Codes"] = 104,
    ...
    Cheatsheets = 670,
    ["Chrome Extension"] = 148,
    ["CircleCI config.yml"] = 127,
    ["Citation File Format"] = 160,
    CityJSON = 102,
    ["Code Climate"] = 128,
    CodeCV = 54,
    ["CodeShip Pro services configuration files"] = 139,
    ["CodeShip Pro steps configuration files"] = 140,
    ["Codecov configuration files"] = 138,
    Codux = 136,
    ["Cog config file"] = 105,
    ["Commandbox Box.json"] = 106,
    ["Commandbox Server.json"] = 107,
    ["Common Catalog Data"] = 146,
    ["Common types for all schemas"] = 1,
    Conjure = 103,
    ["Container Structure Test"] = 617,
    Containerlab = 642,
    ["Crowdsec collection config"] = 167,
    ["Crowdsec parser config"] = 168,
    ["Crowdsec scenario config"] = 169,
    ["DWP Exchange - catalogue entry"] = 212,
    ["DWP Exchange - gateway"] = 210,
    ["DWP Exchange - meta"] = 211,
    ["Dart build configuration"] = 175,
    ["Dart test config"] = 176,
    ["DashLord configuration"] = 177,
    ["Data Contract Specification"] = 178,
    ["Databricks Asset Bundles"] = 736,
    ["Datadog Service Definition"] = 315,
    ["Datahub Ingestion Recipe"] = 687,
    ["Dein Config"] = 109,
    Deno = 184,
    ["Deployer Recipe"] = 187,
    ["Deta Spacefile"] = 110,
    Devfile = 209,
    ["Discord Webhook"] = 189,
    ["Dolittle Artifacts"] = 193,
    ["Dolittle Bounded Context Configuration"] = 194,
    ["Dolittle Event Horizons Configuration"] = 195,
    ["Dolittle Resources Configuration"] = 196,
    ["Dolittle Server Configuration"] = 197,
    ["Dolittle Tenant Map Configuration"] = 199,
    ["Dolittle Tenants Configuration"] = 198,
    ["Dolittle Topology"] = 200,
    ["Drupal Breakpoints"] = 111,
    ["Drupal Config"] = 122,
    ["Drupal Info"] = 112,
    ["Drupal Layouts"] = 113,
    ["Drupal Libraries"] = 114,
    ["Drupal Links Action"] = 115,
    ["Drupal Links Contextual"] = 116,
    ["Drupal Links Menu"] = 117,
    ["Drupal Links Task"] = 118,
    ["Drupal Migration"] = 119,
    ["Drupal Permissions"] = 120,
    ["Drupal Routing"] = 121,
    ["Drupal Services"] = 123,
    ["Drush site aliases"] = 205,
    ["Embrace Config"] = 698,
    ["Error pages"] = 218,
    Esquio = 216,
    ["Estuary Flow Catalog"] = 677,
    ["Expo SDK"] = 221,
    ["F-Droid Data metadata"] = 226,
    ["Facets - FSDL - Application"] = 224,
    ["FasterCI Configuration"] = 56,
    Firebase = 228,
    ["Fossa configuration file"] = 235,
    ["Fossa's fossa-deps file"] = 236,
    ["Foundry VTT - Base package Manifest"] = 230,
    ["Foundry VTT - Module Manifest"] = 231,
    ["Foundry VTT - System Data Template"] = 234,
    ["Foundry VTT - System Manifest"] = 232,
    ["Foundry VTT - World Manifest"] = 233,
    ["Foxx Manifest"] = 57,
    ["Freifunk.de Community API"] = 60,
    ["Frogbot Config"] = 61,
    ["G2P Mapping Configuration"] = 240,
    ["GCP Blueprint Metadata"] = 242,
    ["GatewayCore API Gateway"] = 241,
    ["GeoJSON.json latest"] = 675,
    GherKing = 679,
    ["GitHub Action"] = 246,
    ["GitHub Discussion"] = 247,
    ["GitHub Funding"] = 248,
    ["GitHub Issue Template configuration"] = 250,
    ["GitHub Workflow"] = 251,
    ["GitHub Workflow Template Properties"] = 252,
    ["GitHub issue forms"] = 249,
    GitVersion = 245,
    ["Gitpod Configuration"] = 254,
    ["Global Privacy Control"] = 243,
    Goblet = 735,
    ["Google Cloud Workflows"] = 154,
    Goreleaser = 258,
    ["Goreleaser Pro"] = 259,
    Goss = 260,
    ["Gradle Build Cache Node"] = 632,
    ["Gradle Enterprise"] = 631,
    ["Grafana 5.x Dashboard"] = 261,
    ["GraphQL Code Generator"] = 264,
    ["GraphQL Config"] = 263,
    ["GraphQL Mesh"] = 262,
    ["Grunt JSHint task"] = 268,
    ["Grunt Watch task"] = 269,
    ["Grunt base task"] = 270,
    ["Grunt clean task"] = 266,
    ["Grunt copy task"] = 265,
    ["Grunt cssmin task"] = 267,
    HEMTT = 602,
    Hadolint = 614,
    Hammerkit = 641,
    ["Hardware Sentry Configuration"] = 691,
    Hayson = 272,
    ["Haystack Pipeline"] = 273,
    ["Hazelcast 5 Configuration"] = 274,
    ["Helm Chart.lock"] = 125,
    ["Helm Chart.yaml"] = 124,
    ["Helm Unittest Test Suite"] = 126,
    Hugo = 669,
    ["IBM Zapp document"] = 279,
    ["IBM zCodeFormatSettings"] = 280,
    ["IMG Catapult PSP"] = 285,
    Istanbul = 694,
    ["JDownloader2 crawler multi-rules"] = 295,
    ["JDownloader2 crawler single-rules"] = 294,
    ["JFrog Applications Config"] = 296,
    ["JFrog File Spec"] = 297,
    ["JFrog Pipelines YML DSL"] = 700,
    ["JMeter DSL cli config"] = 298,
    JReleaser = 300,
    ["JSON Document Transform"] = 307,
    ["JSON Feed"] = 308,
    ["JSON Resume"] = 457,
    ["JSON Schema Draft 2020-12"] = 581,
    ["JSON Schema Draft 4"] = 578,
    ["JSON Schema Draft 7"] = 579,
    ["JSON Schema Draft 7 (unofficial strict)"] = 737,
    ["JSON Schema Draft 8 (2019-09)"] = 580,
    ["JSON-API"] = 306,
    ["JSON-e templates"] = 639,
    ["JSON-stat 2.0"] = 575,
    JSONPatch = 310,
    Jasmine = 290,
    Jekyll = 291,
    ["Jenkins X Pipelines"] = 292,
    ["Jenkins X Requirements"] = 293,
    ["Jovo Language Models"] = 299,
    ["KSP-AVC"] = 576,
    ["KSP-CKAN"] = 577,
    ["Karakum configuration file"] = 237,
    Kas = 313,
    ["Keycloak REST API"] = 707,
    ["Knative Functions - func.yaml"] = 238,
    ["KoDE/CI build.yaml"] = 696,
    ["Kong DBLess config"] = 697,
    KrakenD = 314,
    LOOBin = 331,
    Lefthook = 322,
    ["LinkML Metamodel"] = 329,
    Liquibase = 646,
    ["Liquibase Flow File"] = 647,
    ["Lively Properties"] = 330,
    ["MS2Rescore Configuration"] = 363,
    Markdownlint = 650,
    ["Mason Registry"] = 652,
    ["MegaLinter configuration"] = 337,
    ["MegaLinter descriptor"] = 338,
    ["Meltano plugin discovery definition"] = 340,
    ["Meltano project definition"] = 339,
    ["Microsoft Band Web Tile"] = 341,
    ["Minecraft Data Pack Advancement"] = 343,
    ["Minecraft Data Pack Biome"] = 344,
    ["Minecraft Data Pack Configured Carver"] = 345,
    ["Minecraft Data Pack Damage Type"] = 346,
    ["Minecraft Data Pack Dimension"] = 348,
    ["Minecraft Data Pack Dimension Type"] = 347,
    ["Minecraft Data Pack Item Modifier"] = 349,
    ["Minecraft Data Pack Loot Table"] = 350,
    ["Minecraft Data Pack Metadata"] = 351,
    ["Minecraft Data Pack Predicate"] = 352,
    ["Minecraft Data Pack Recipe"] = 353,
    ["Minecraft Data Pack Tag"] = 354,
    ["Minecraft Data Pack Template Pool"] = 355,
    ["Minecraft Data Pack Trim Material"] = 360,
    ["Minecraft Data Pack Trim Pattern"] = 361,
    ["Minecraft Resource Pack Lang"] = 356,
    ["Minecraft Resource Pack Particle"] = 357,
    ["Minecraft Resource Pack Texture Mcmeta"] = 359,
    ["Minecraft Resourcepack Sounds"] = 358,
    ["MkDocs Configuration 1.0"] = 362,
    ["MongoDB Atlas Search Index Definition"] = 695,
    ["Monika Configuration"] = 693,
    ["Motif config"] = 598,
    ["NOX Framework (Service)"] = 377,
    ["Netin Diagnostic System Template"] = 656,
    ["Netlify config"] = 368,
    ["Nexus-as-Code Data Model"] = 369,
    ["Nightwatch.js"] = 370,
    ["ONe's service descriptor"] = 390,
    ["OSS Review Toolkit configuration"] = 397,
    ["OSS Review Toolkit curation"] = 398,
    ["OSS Review Toolkit package configuration"] = 399,
    ["OSS Review Toolkit repository configuration"] = 400,
    ["OSS Review Toolkit resolutions"] = 401,
    Opctl = 601,
    ["OpenRewrite Resource"] = 392,
    ["OpenWeather Current Weather API"] = 638,
    ["OpenWeather Road Risk API"] = 637,
    ["Ory Hydra configuration"] = 278,
    ["Ory Keto configuration"] = 316,
    ["Ory Kratos configuration"] = 396,
    ["Ory Oathkeeper configuration"] = 384,
    ["Outblocks App configuration"] = 394,
    ["Outblocks database table"] = 395,
    ["Outblocks project configuration"] = 393,
    Packer = 404,
    Pantsbuild = 714,
    ["Paper paper-plugin.yml"] = 405,
    ["Pipeline component"] = 648,
    ["PocketMine plugin.yml"] = 410,
    ["Postman collection"] = 415,
    ["Problem package generators"] = 422,
    Pterodactyl = 690,
    ["Pull Request Labeler"] = 437,
    Pulumi = 443,
    PyProject = 444,
    Pyright = 445,
    Qgoda = 446,
    Qodana = 666,
    ["Quali Torque Blueprint Spec 2"] = 688,
    ["QueryFirst config file"] = 710,
    ["RKE Cluster Configuration JSON"] = 645,
    ["RKE Cluster Configuration YAML"] = 644,
    ["Rancher Fleet"] = 440,
    Ray = 613,
    ["Read the Docs"] = 442,
    ["Red-DiscordBot Cog"] = 447,
    ["Red-DiscordBot Cog Repo"] = 448,
    ["Red-DiscordBot Trivia"] = 449,
    Renovate = 458,
    ["Replit config"] = 452,
    RoadRunner = 459,
    Ruff = 455,
    ["Rust Project"] = 456,
    ["Rust toolchain"] = 461,
    ["SIL Kit Participant Configuration"] = 492,
    ["SIL Kit Registry Configuration"] = 493,
    SWADL = 516,
    ["Safebox Config"] = 701,
    ["Sapphire CLI Config"] = 464,
    ["SauceCTL Configuration"] = 653,
    ["Schema Catalog"] = 478,
    ["Scoop manifest"] = 483,
    ["Semantic Data Fabric (SDF) file"] = 484,
    ["Semgrep Rule"] = 486,
    ["Serenity Code Generator (Sergen)"] = 487,
    ["Serverless Framework Configuration"] = 660,
    ["Serverless Workflow"] = 662,
    ["Settings.paf"] = 489,
    ["Shopware 6 Configuration"] = 663,
    ["Shopware CLI Extension Store Configuration"] = 664,
    ["Shopware CLI Project Store Configuration"] = 665,
    ["Sigrid scope configuration file"] = 491,
    ["Slack app manifest"] = 495,
    Solidarity = 498,
    ["Solution filters"] = 499,
    ["Source Maps v3"] = 500,
    Sourcery = 501,
    SpecIF = 502,
    ["Sponge Mixin configuration"] = 503,
    ["StackHawk Scanner Configuration"] = 659,
    Stale = 508,
    ["Starlake Data Pipeline"] = 635,
    Starship = 509,
    ["Statamic Blueprint"] = 510,
    ["StrmPrivacy Data Connector"] = 705,
    ["StrmPrivacy Data Contract"] = 706,
    ["StrmPrivacy SimpleSchema"] = 703,
    ["StrmPrivacy Stream"] = 704,
    ["StrmPrivacy batch job configuration file"] = 702,
    ["Stryker Mutator"] = 513,
    ["StyleCop Analyzers Configuration"] = 514,
    ["Swagger API 2.0"] = 517,
    TSON = 541,
    ["Talisman configuration"] = 519,
    ["Taskfile config"] = 640,
    Taurus = 520,
    ["TestEnvironment.json"] = 529,
    ["Tier.run pricing.json"] = 523,
    Tikibase = 524,
    ["Traefik v2"] = 532,
    ["Traefik v2 File Provider"] = 533,
    Turborepo = 530,
    Tye = 667,
    ["UET BuildConfig.json"] = 711,
    ["UI5 Manifest"] = 548,
    ["UTAM Page Object"] = 551,
    ["Ubuntu Server Autoinstall"] = 546,
    ["Uniswap Token List"] = 623,
    ["Unreal Engine Uplugin"] = 712,
    ["Unreal Engine Uproject"] = 713,
    Updatecli = 674,
    Uplift = 709,
    ["User Journey Map"] = 643,
    V2Ray = 678,
    ["VSCode Code Snippets"] = 142,
    ["VSIX CLI publishing"] = 564,
    ["Vela Pipeline Configuration"] = 554,
    Vercel = 141,
    Visivo = 738,
    ["Web App Manifest"] = 571,
    ["Web types"] = 574,
    WebExtensions = 570,
    ["Webman package recipe"] = 684,
    ["Windows Package Manager Installer Manifest"] = 620,
    ["Windows Package Manager Locale Manifest"] = 621,
    ["Windows Package Manager Singleton Manifest"] = 619,
    ["Woodpecker pipeline config"] = 655,
    ["Xstate Machine"] = 672,
    ["Yippee-Ki-JSON configuration YML"] = 625,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 66,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 720,
    ["bashly-strings.yml"] = 721,
    ["bashly.yml"] = 719,
    ["batect.yml"] = 65,
    ...
    ["chisel-slices.json"] = 159,
    ["chrome-extension-locales-messages.json"] = 149,
    ["chutzpah.json"] = 150,
    cibuildwheel = 101,
    clangd = 131,
    clib = 132,
    ["cloud-init: cloud-config userdata"] = 134,
    ["cloud-sdk-pipeline-configuration"] = 152,
    ["cloudbuild.json"] = 153,
    cloudify = 133,
    codemagic = 135,
    ["coffeelint.json"] = 161,
    ["commands.json"] = 145,
    ["compile_commands.json"] = 144,
    ["compilerconfig.json"] = 143,
    ["completely.yml"] = 717,
    ["component-detection-manifest.json"] = 164,
    ["component.json"] = 163,
    ["composer.json"] = 162,
    ["config.yaml"] = 441,
    ["contentmanifest.json"] = 151,
    ["contribute.json"] = 165,
    ["cosmos.config.json"] = 147,
    ["crowdin.yml"] = 166,
    cspell = 172,
    ["custom-elements.json"] = 731,
    ["cypress.json"] = 170,
    ["datalogic-scan2deploy-android"] = 179,
    ["datalogic-scan2deploy-ce"] = 180,
    ["dbt Project"] = 108,
    ["ddev-global"] = 181,
    ["ddev-project"] = 182,
    ["debugsettings.json"] = 183,
    ["dependabot-v2.json"] = 186,
    ["dependabot.json"] = 185,
    ["deployed-cli"] = 671,
    ["detekt.yml"] = 188,
    ["devcontainer.json"] = 137,
    devinit = 627,
    ["devspace.yaml"] = 692,
    djlint = 628,
    ["docfx.json"] = 192,
    ["docker sequencer"] = 191,
    ["docker-compose.yml"] = 626,
    ["dockerd.json"] = 190,
    ["dotnet Release Index manifest"] = 201,
    ["dotnetcli.host.json"] = 202,
    ["dprint.json"] = 203,
    ["drone.json"] = 204,
    ["dss-2.0.0.json"] = 206,
    ["dstack configuration"] = 207,
    ["dvc.yaml"] = 208,
    ["ecosystem.json"] = 213,
    eksctl = 214,
    ["electron-builder configuration file"] = 219,
    ["epr-manifest.json"] = 217,
    ["evcc.yaml"] = 220,
    ["ezd task runner"] = 222,
    ["fabric.mod.json"] = 225,
    ["first-timers-bot"] = 229,
    ...
    ["gitlab-ci"] = 253,
    ["global.json"] = 255,
    ["go-feature-flag Flag Configuration"] = 257,
    ["golangci-lint Configuration"] = 256,
    ["haxelib.json"] = 271,
    helmfile = 615,
    helmwave = 616,
    ["host-meta.json"] = 276,
    ...
    ["ide.host.json"] = 281,
    ["ifstate.conf"] = 282,
    ["imageoptimizer.json"] = 283,
    ["importmap.json"] = 286,
    ["ioBroker Configuration"] = 287,
    ["ioBroker JSON UI"] = 288,
    ["ioBroker Package manifest"] = 289,
    ["ize.toml"] = 708,
    ["jsconfig.json"] = 311,
    ["jscpd Configuration"] = 689,
    jsdoc = 612,
    ["k3d.yaml"] = 312,
    ["kontinuous-config.yaml"] = 318,
    ["kontinuous-values.yaml"] = 317,
    ["kustomization.yaml"] = 319,
    ["label-commenter-config.yml"] = 320,
    ["launchsettings.json"] = 321,
    lazydocker = 730,
    lazygit = 729,
    ["lego.json"] = 323,
    ["lerna.json"] = 324,
    ["lgtm.yml"] = 325,
    ["libman.json"] = 326,
    ["license-report-config.json"] = 327,
    ["linkinator.config.json"] = 328,
    ["local.settings.json"] = 333,
    ["localazy.json"] = 334,
    ["lotus.yaml"] = 332,
    ["lsdlschema.json"] = 335,
    ["madness.yml"] = 718,
    ["markdown-lint-check"] = 651,
    mboats = 658,
    ["micro-settings.json"] = 723,
    ["mimetypes.json"] = 342,
    ["mirrord config"] = 595,
    ["mta.yaml"] = 596,
    ["mtad.yaml"] = 597,
    ["mycode.json"] = 366,
    ["napari plugin manifest"] = 367,
    neoload = 607,
    ["nest-cli"] = 373,
    ["ninjs (News in JSON) 1.3"] = 372,
    ["ninjs (News in JSON) 2.0"] = 371,
    ["nlu.json"] = 374,
    ["nodemon.json"] = 376,
    ["noodl config"] = 657,
    now = 603,
    ...
    ["nswag.json"] = 382,
    ntangle = 383,
    ["nuclei-template.yaml"] = 380,
    ["nuget-project.json"] = 381,
    ["ocelot.json"] = 385,
    ["omnisharp.json"] = 386,
    ["openapi.json"] = 387,
    ["openfin.json"] = 391,
    ...
    ["ops.yaml"] = 389,
    ["package.json"] = 402,
    ["package.manifest"] = 403,
    ["pathfinder.yml"] = 406,
    ["pattern.json"] = 408,
    ["petstore-v1.0"] = 699,
    pgap_yaml_input_reader = 407,
    ["plagiarize-me.yaml"] = 412,
    ["plagiarize.yaml"] = 411,
    ["portman.json"] = 413,
    ["prettierrc.json"] = 420,
    ["prisma.yml"] = 421,
    ["project-1.0.0-beta3.json"] = 424,
    ["project-1.0.0-beta4.json"] = 425,
    ["project-1.0.0-beta5.json"] = 426,
    ["project-1.0.0-beta6.json"] = 427,
    ["project-1.0.0-beta8.json"] = 428,
    ["project-1.0.0-rc1.json"] = 429,
    ["project-1.0.0-rc2.json"] = 430,
    ["project.json"] = 423,
    ["prometheus.json"] = 431,
    ["prometheus.rules.json"] = 432,
    ["prometheus.rules.test.json"] = 433,
    ["proxies.json"] = 434,
    ["publiccode.yml"] = 435,
    ["pubspec.yaml"] = 436,
    ["pyrseas-0.8.json"] = 439,
    ["quilt.mod.json"] = 724,
    ["release drafter"] = 608,
    rtx = 454,
    rustfmt = 460,
    samt = 462,
    samtrc = 463,
    ["sarif-1.0.0.json"] = 465,
    ["sarif-2.0.0.json"] = 466,
    ["sarif-2.1.0"] = 476,
    ["sarif-2.1.0-rtm.2"] = 467,
    ["sarif-2.1.0-rtm.3"] = 469,
    ["sarif-2.1.0-rtm.4"] = 471,
    ["sarif-2.1.0-rtm.5"] = 473,
    ["sarif-2.1.0-rtm.6"] = 474,
    ["sarif-external-property-file-2.1.0"] = 477,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 468,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 470,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 472,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 475,
    ["schema.org - Action"] = 479,
    ["schema.org - ContactPoint"] = 480,
    ["schema.org - Place"] = 481,
    ["schema.org - Thing"] = 482,
    ["secrethub.yml"] = 726,
    ["semantic-release"] = 485,
    ["servicehub.config.json"] = 584,
    ["servicehub.service.json"] = 583,
    ["settings.job"] = 488,
    ["sfdx-hardis configuration"] = 490,
    ["size-limit configuration"] = 494,
    ["skaffold.yaml"] = 649,
    ["skyuxconfig.json"] = 496,
    snapcraft = 497,
    ["sqlc configuration"] = 505,
    ["stripe-app-local.json"] = 512,
    ["stripe-app.json"] = 511,
    swcrc = 636,
    syntax = 728,
    ["task.json"] = 518,
    taskcat = 604,
    ["template.json"] = 521,
    ["templatsources.json"] = 522,
    ["theme.json"] = 525,
    ["tizen_workspace.json"] = 526,
    tldr = 527,
    tmLanguage = 528,
    tmuxinator = 592,
    ["transcend.yml"] = 534,
    ["trunk.yaml"] = 535,
    ["ts-force-config.json"] = 539,
    ["tsconfig.json"] = 536,
    ["tsd.json"] = 537,
    ["tsdrc.json"] = 538,
    ["tslint.json"] = 540,
    ...
    ["vega-lite.json"] = 553,
    ["vega.json"] = 552,
    ["venvironment-basic.yaml"] = 556,
    ["venvironment.yaml"] = 555,
    ["version.json"] = 557,
    ["vim-addon-info"] = 558,
    ["vs-2017.3.host.json"] = 560,
    ["vs-nesting.json"] = 561,
    ["vsls.json"] = 559,
    ["vss-extension.json"] = 565,
    ["vtesttree.yaml"] = 566,
    ["vtestunit.yaml"] = 567,
    ["warp-keysets.json"] = 732,
    ["warp-themes.json"] = 733,
    ["warp-workflows.json"] = 734,
    ["webhint.io"] = 685,
    ["webjobpublishsettings.json"] = 573,
    ["webjobs-list.json"] = 572,
    ["xs-app.json"] = 600,
    ["xunit.runner.json"] = 582,
    yamllint = 624,
    zuul = 609,
    ["Žinoma"] = 618
  },
