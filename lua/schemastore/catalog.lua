...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1047,
    ["API Builder"] = 862,
    ["AVA Configuration"] = 924,
    ...
    ["Adobe UXP Manifest"] = 986,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1075,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 896,
    ["All Contributors configuration file"] = 949,
    ...
    ["Application list for a WinUtil"] = 1029,
    ArchitectFX = 1034,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure Pipelines"] = 78,
    ["Azure Static Web Apps CLI configuration file"] = 710,
    ["Azure Static Web Apps configuration file"] = 709,
    ["BOSH CPI Config"] = 102,
    ["BOSH Deploy Config"] = 103,
    ["BX CI"] = 122,
    ["Bashly (bashly.yml)"] = 953,
    ["Bashly Settings (bashly-settings.yml)"] = 954,
    ["Better Code Hub"] = 866,
    ["Better Scripts"] = 123,
    Bigconfig = 95,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1040,
    BizTalkServerApplicationSchema = 834,
    Bleep = 124,
    ...
    ["Butane Config"] = 909,
    C4InterFlow = 1055,
    ["CDK Environment Manager, concrete environment configuration"] = 1078,
    ["CDK Environment Manager, concrete environments definition"] = 1077,
    ["CDK Environment Manager, environment definition"] = 1076,
    ["CGS Card Game Specification (cgs.json)"] = 991,
    ["CICS TS region tagging"] = 918,
    ["CICS TS resource import"] = 919,
    ["CICS TS resource model"] = 920,
    ["CICS TS resource overrides"] = 921,
    ["CMake Presets"] = 125,
    ["CNC Codes"] = 144,
    ["CRS WAF test file"] = 1019,
    ["CRS WAF test platform overrides file"] = 1020,
    ...
    ["Chamaleon environment"] = 1044,
    ["Chamaleon properties"] = 1045,
    ["Chamaleon template"] = 1043,
    Changesets = 228,
    Charmcraft = 134,
    Cheatsheets = 906,
    ...
    ["Clawject config"] = 150,
    ["Cloud Foundry Application Manifest"] = 1002,
    ["Cloud Run Spec v1"] = 1024,
    ...
    Concord = 1018,
    ["Configu .cfgu files"] = 1007,
    ["Configu .configu file"] = 1008,
    Conjure = 143,
    ["Container Structure Test"] = 848,
    Containerlab = 875,
    ["Contextive Glossary"] = 1070,
    Convex = 142,
    ["Crowdsec collection config"] = 238,
    ["Crowdsec parser config"] = 239,
    ["Crowdsec scenario config"] = 240,
    ["CumulusCI Config"] = 149,
    ["Custom Machinery Machine"] = 992,
    ["Custom Machinery Recipe"] = 993,
    ...
    ["DonateCaseBetterCasino menu"] = 1048,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 961,
    ["EAS config"] = 304,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 950,
    ["EasyVCR .NET"] = 305,
    ["Eidolon Resource"] = 1035,
    ...
    ["GeoJSON.json latest"] = 913,
    GherKing = 917,
    ["GitHub Action"] = 335,
    ["GitHub Actions typing"] = 1031,
    ...
    ["Google Digital Assetlinks"] = 1071,
    Goreleaser = 363,
    ["Goreleaser Pro"] = 364,
    Goss = 365,
    ["Gradle Build Cache Node"] = 864,
    ["Gradle Enterprise"] = 863,
    ...
    Hadolint = 844,
    Hammerkit = 874,
    ["Hardware Sentry Configuration"] = 929,
    Hatch = 845,
    Hayson = 378,
    ["Haystack Pipeline"] = 379,
    ["Hazelcast 5 Configuration"] = 380,
    ["Hecate Input Schema"] = 1082,
    ["Helm Chart.lock"] = 183,
    ["Helm Chart.yaml"] = 182,
    ...
    ["JFrog File Spec"] = 409,
    ["JFrog Pipelines YML DSL"] = 938,
    ["JMeter DSL cli config"] = 410,
    JReleaser = 413,
    ["JSON Document Transform"] = 421,
    ["JSON Feed"] = 422,
    ["JSON Resume"] = 643,
    ["JSON Schema Draft 2020-12"] = 813,
    ["JSON Schema Draft 4"] = 810,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 971,
    ["JSON Schema Draft 7"] = 811,
    ["JSON Schema Draft 7 (unofficial strict)"] = 972,
    ["JSON Schema Draft 8 (2019-09)"] = 812,
    ["JSON-API"] = 420,
    ["JSON-e templates"] = 871,
    ["JSON-stat 2.0"] = 806,
    JSONPatch = 424,
    ...
    ["Metadata for a Cinnamon spice"] = 1027,
    ["Metatype Configuration"] = 472,
    ["MetricsHub Configuration"] = 473,
    ["MetricsHub Connector Configuration"] = 474,
    ["Micro Editor Syntax"] = 962,
    ["Microsoft Band Web Tile"] = 475,
    ["Microsoft RulesEngine workflow rules"] = 1015,
    ["Microsoft RulesEngine workflow rules list"] = 1016,
    ["Minecraft Custom Main Menu Mod"] = 980,
    ...
    ["MongoDB Atlas Search Index Definition"] = 933,
    ["Monika Configuration"] = 931,
    ["Monoweave Configuration"] = 500,
    ["Motif config"] = 826,
    MultiQC = 1064,
    ["NOX Framework (Service)"] = 518,
    ["Netin Diagnostic System Template"] = 891,
    ["Netlify config"] = 508,
    ["Network-as-Code Data Model"] = 509,
    ["Nightwatch.js"] = 511,
    ["Node.js configuration"] = 831,
    ...
    ["OpenUtau ustx"] = 536,
    ["OpenWeather Current Weather API"] = 870,
    ["OpenWeather Road Risk API"] = 869,
    ...
    ["Power Pages Configuration"] = 1081,
    ["Preset list for a WinUtil"] = 1030,
    ...
    Pylock = 1072,
    Pyright = 618,
    ["Python script metadata"] = 1066,
    ["QType AI DSL"] = 621,
    Qgoda = 620,
    Qodana = 901,
    ["Qt Creator workspace file"] = 1009,
    ["Quali Torque Blueprint Spec 2"] = 926,
    ["QueryFirst config file"] = 944,
    ["RKE Cluster Configuration JSON"] = 879,
    ["RKE Cluster Configuration YAML"] = 878,
    RadioHound = 611,
    Railway = 622,
    ["Rancher Fleet"] = 613,
    ["Rattler-build"] = 623,
    Ray = 843,
    ["Read the Docs"] = 615,
    ["Red-DiscordBot Cog"] = 630,
    ["Red-DiscordBot Cog Repo"] = 631,
    ["Red-DiscordBot Trivia"] = 632,
    ["Render Blueprints"] = 877,
    RenderCV = 645,
    Renovate = 644,
    ["Replit config"] = 638,
    Restate = 1059,
    RoadRunner = 647,
    ["Roo Coder Custom Modes"] = 649,
    Rubocop = 640,
    ["Rudder techniques"] = 984,
    Ruff = 641,
    ["Rust Project"] = 642,
    ["Rust toolchain"] = 652,
    ["SDMX data message"] = 678,
    ["SDMX metadata message"] = 677,
    ["SDMX structure message"] = 676,
    ["SIL Kit Participant Configuration"] = 688,
    ["SIL Kit Registry Configuration"] = 689,
    ["SPDX 2.3"] = 707,
    SWADL = 721,
    ["Safebox Config"] = 939,
    ["Sapphire CLI Config"] = 655,
    ["SauceCTL Configuration"] = 888,
    ["Schema Catalog"] = 670,
    ["Scoop manifest"] = 675,
    ["Semantic Data Fabric (SDF) file"] = 679,
    ["Semgrep Rule"] = 681,
    ["Serenity Code Generator (Sergen)"] = 682,
    ["Serverless Framework Configuration"] = 895,
    ["Serverless Workflow"] = 897,
    ["Settings for a Cinnamon spice"] = 1026,
    ["Settings.paf"] = 684,
    ["Shopware 6 Configuration"] = 898,
    ["Shopware CLI Extension Store Configuration"] = 899,
    ["Shopware CLI Project Store Configuration"] = 900,
    ["Sigma Detection Rule"] = 686,
    ["Sigrid scope configuration file"] = 687,
    ["SkyPilot Task JSON"] = 985,
    ["Slack app manifest"] = 691,
    Solidarity = 696,
    ["Solution filters"] = 697,
    ["Source Maps v3"] = 698,
    Sourcery = 699,
    ["Speakeasy Generation Config File"] = 703,
    ["Speakeasy Lint Configuration File"] = 700,
    ["Speakeasy Test Generation Configuration File"] = 701,
    ["Speakeasy Workflow File"] = 702,
    SpecIF = 704,
    ["Sponge Mixin configuration"] = 705,
    StackBlitz = 711,
    ["StackHawk Scanner Configuration"] = 894,
    Stale = 712,
    ["Starlake Data Pipeline"] = 867,
    Starship = 713,
    ["Statamic Blueprint"] = 714,
    ["Stella configuration file"] = 715,
    ["Stryker Mutator"] = 718,
    ["StyleCop Analyzers Configuration"] = 719,
    ["Stylelint (.stylelintrc)"] = 720,
    ["Stylua Config"] = 1073,
    ["Sublime Syntax"] = 940,
    ["Subsquid squid manifest"] = 987,
    ["Swagger API 2.0"] = 722,
    ["Synadia Connect Component"] = 723,
    TSON = 757,
    TSTyche = 758,
    ["TYPO3 Vendor Bundler config"] = 763,
    ["Tab data for a LinUtil"] = 1033,
    ["Tab list for a LinUtil"] = 1032,
    Tach = 724,
    ["Tach Domain"] = 725,
    Talhelper = 727,
    ["Talisman configuration"] = 728,
    Taplo = 1074,
    ["Taskfile config"] = 872,
    Taurus = 729,
    Tauticord = 730,
    Telefonistka = 1060,
    ["TestEnvironment.json"] = 740,
    ["TextMate Grammar"] = 739,
    ["Tier.run pricing.json"] = 733,
    Tikibase = 734,
    Tombi = 738,
    ["Traefik v2"] = 743,
    ["Traefik v2 File Provider"] = 744,
    ["Traefik v3"] = 745,
    ["Traefik v3 File Provider"] = 746,
    ["Travis CI (.travis.yml)"] = 742,
    Trident = 1057,
    ["TrueScript for *.tscript files"] = 749,
    ["Tugboat QA config.yml"] = 1054,
    TunnelHub = 975,
    Turborepo = 741,
    Tycho = 1022,
    Tye = 902,
    ["Tyk Gateway - Open Source v5.7+"] = 1065,
    ["Typst Manifest"] = 764,
    ["UET BuildConfig.json"] = 945,
    ["UI5 Manifest"] = 770,
    ["UNCORS configuration"] = 774,
    ["UTAM Page Object"] = 773,
    ["Ubuntu Server Autoinstall"] = 768,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1058,
    ["Uniswap Token List"] = 855,
    ["Universal Schedule Format"] = 775,
    ["Unreal Engine Uplugin"] = 946,
    ["Unreal Engine Uproject"] = 947,
    ["Updatecli Compose"] = 910,
    ["Updatecli Policy Manifest"] = 911,
    ["Updatecli Policy Metadata"] = 912,
    Uplift = 943,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 876,
    V2Ray = 916,
    ["VSCode Code Snippets"] = 203,
    ["VSIX CLI publishing"] = 795,
    Vector = 777,
    ["Vela Pipeline Configuration"] = 780,
    Vercel = 202,
    ["Version Bumper config"] = 785,
    ["Viash Component Config"] = 1062,
    ["Viash Package Config"] = 1063,
    Visivo = 973,
    Wake = 1056,
    ["Waku Config"] = 1036,
    ["Web App Manifest"] = 801,
    ["Web types"] = 804,
    WebExtensions = 800,
    ["Webman package recipe"] = 922,
    ["Windows Package Manager Installer Manifest"] = 851,
    ["Windows Package Manager Locale Manifest"] = 852,
    ["Windows Package Manager Singleton Manifest"] = 850,
    Winutil = 853,
    ["WireMock stub mapping"] = 1039,
    ["Woodpecker pipeline config"] = 890,
    ["Wrangler CLI"] = 805,
    ["Xstate Machine"] = 908,
    ["Yandex Workflow Language"] = 1028,
    ["Yarn Config (.yarnrc.yml)"] = 865,
    ["Yippee-Ki-JSON configuration YML"] = 857,
    ["YouTrack App"] = 1025,
    ["Zerops.io config"] = 1013,
    ["Zerops.io import"] = 1014,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 978,
    ...
    ["behat.yml"] = 105,
    ["bigquery-table"] = 94,
    ["bioimageio resource description"] = 995,
    ...
    ["crowdin.yml"] = 237,
    ["ctfd-setup configuration file"] = 1046,
    ["custom-elements.json"] = 965,
    ["cypress.json"] = 241,
    ...
    ["gematik health care insurance list"] = 1052,
    ["gematik health care patient list"] = 1049,
    ["gematik health care provider institution list"] = 1051,
    ["gematik health care provider list"] = 1050,
    ["gematik tiger test environment configuration"] = 1053,
    ["gitlab-ci"] = 343,
    ["global.json"] = 359,
    ...
    ["lint-staged (.lintstagedrc)"] = 821,
    ["local.settings.json"] = 462,
    ["localazy.json"] = 463,
    ["lotus.yaml"] = 461,
    ["lsdlschema.json"] = 464,
    ["markdown-link-check"] = 885,
    maturin = 886,
    mboats = 893,
    ["micro-settings.json"] = 957,
    ["mimetypes.json"] = 476,
    ["mirrord config"] = 822,
    mise = 823,
    ["mkdocs.yml"] = 496,
    ["monospace.yml"] = 499,
    ["moon.yml"] = 1038,
    ["mprocs Configuration file"] = 1010,
    ["mrdocs.yml"] = 497,
    ["mta.yaml"] = 824,
    ["mtad.yaml"] = 825,
    ["mycode.json"] = 506,
    ...
    ["plagiarize.yaml"] = 571,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1042,
    ["podbard.yaml"] = 574,
    ["portman.json"] = 575,
    ["prefect.toml"] = 583,
    ["prettierrc.json"] = 584,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 838,
    ["release-please-config.json"] = 634,
    ["release-please-manifest.json"] = 635,
    ["release-plz.toml"] = 636,
    ["renv.lock"] = 646,
    ["rivet.json"] = 982,
    ["rivet.yaml (legacy)"] = 981,
    rockcraft = 648,
    runny = 650,
    rustfmt = 651,
    sake = 1068,
    samt = 653,
    samtrc = 654,
    ["sarif-1.0.0.json"] = 656,
    ["sarif-2.0.0.json"] = 657,
    ["sarif-2.1.0"] = 667,
    ["sarif-2.1.0-rtm.2"] = 658,
    ["sarif-2.1.0-rtm.3"] = 660,
    ["sarif-2.1.0-rtm.4"] = 662,
    ["sarif-2.1.0-rtm.5"] = 664,
    ["sarif-2.1.0-rtm.6"] = 665,
    ["sarif-external-property-file-2.1.0"] = 668,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 659,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 661,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 663,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 666,
    ["scalingo.json configuration"] = 669,
    ["schema.org - Action"] = 671,
    ["schema.org - ContactPoint"] = 672,
    ["schema.org - Place"] = 673,
    ["schema.org - Thing"] = 674,
    ["secrethub.yml"] = 960,
    ["semantic-release"] = 680,
    ["servicehub.config.json"] = 816,
    ["servicehub.service.json"] = 815,
    ["settings.job"] = 683,
    ["sfdx-hardis configuration"] = 685,
    ["shard.yml"] = 998,
    ["size-limit configuration"] = 690,
    ["skaffold.yaml"] = 883,
    ["skyuxconfig.json"] = 692,
    snapcraft = 693,
    ["snowflake-config"] = 694,
    ["snowflake-connections"] = 695,
    ["spicepod.yaml"] = 1017,
    ["sqlc configuration"] = 708,
    ["stripe-app-local.json"] = 717,
    ["stripe-app.json"] = 716,
    swcrc = 868,
    ["task.json"] = 726,
    taskcat = 833,
    ["template.json"] = 731,
    ["templatsources.json"] = 732,
    ["theme.json"] = 735,
    ["tizen_workspace.json"] = 736,
    tldr = 737,
    ["tm_devices configuration file"] = 1079,
    tmuxinator = 819,
    ["transcend.yml"] = 747,
    ["tree-sitter grammar.json"] = 367,
    ["trime.yaml"] = 748,
    ["trunk.yaml"] = 750,
    ["ts-force-config.json"] = 755,
    ["tsconfig.json"] = 751,
    ["tsd.json"] = 752,
    ["tsdoc.json"] = 753,
    ["tsdrc.json"] = 754,
    ...
    ["vega-lite.json"] = 779,
    ["vega.json"] = 778,
    ["venvironment-basic.yaml"] = 782,
    ["venvironment.yaml"] = 781,
    ["venvplus-basic.yaml"] = 784,
    ["venvplus.yaml"] = 783,
    version = 1061,
    ["version.json"] = 786,
    ["vhwdebugger-binding.yaml"] = 788,
    ["vim-addon-info"] = 789,
    ["vs-2017.3.host.json"] = 791,
    ["vs-nesting.json"] = 792,
    ["vsls.json"] = 790,
    ["vss-extension.json"] = 796,
    vtcfg = 1067,
    ["vtesttree.yaml"] = 797,
    ["vtestunit.yaml"] = 798,
    ["warp-keysets.json"] = 966,
    ["warp-themes.json"] = 967,
    ["warp-workflows.json"] = 968,
    ["webhint.io"] = 923,
    ["webjobpublishsettings.json"] = 803,
    ["webjobs-list.json"] = 802,
    ["well-known-fursona"] = 1005,
    ["xs-app.json"] = 828,
    ["xunit.runner.json"] = 814,
    yamllint = 856,
    zuul = 839,
    ["Žinoma"] = 849
  },
