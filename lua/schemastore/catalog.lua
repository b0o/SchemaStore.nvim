...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 15,
    AIConfig = 16,
    ["AMX Muse Program Descriptor"] = 1000,
    ["API Builder"] = 817,
    ["AVA Configuration"] = 879,
    ...
    ["Adobe UXP Manifest"] = 939,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    Air = 12,
    ["Airlock Microgateway"] = 17,
    ["Alacritty Configuration"] = 851,
    ["All Contributors configuration file"] = 904,
    ...
    ["Application list for a WinUtil"] = 982,
    ArchitectFX = 987,
    ["Argo Events"] = 31,
    ["Argo Workflows"] = 32,
    AssemblyScript = 35,
    ...
    ["BX CI"] = 110,
    ["Bashly (bashly.yml)"] = 908,
    ["Bashly Settings (bashly-settings.yml)"] = 909,
    ["Better Code Hub"] = 821,
    ["Better Scripts"] = 111,
    Bigconfig = 85,
    ["Biome Formatter Config"] = 55,
    ["Bitmovin Encoding Template"] = 993,
    BizTalkServerApplicationSchema = 789,
    Bleep = 112,
    ...
    ["Butane Config"] = 864,
    C4InterFlow = 1008,
    ["CGS Card Game Specification (cgs.json)"] = 944,
    ["CICS TS region tagging"] = 873,
    ["CICS TS resource import"] = 874,
    ["CICS TS resource model"] = 875,
    ["CICS TS resource overrides"] = 876,
    ["CMake Presets"] = 113,
    ["CNC Codes"] = 129,
    ["CRS WAF test file"] = 972,
    ["CRS WAF test platform overrides file"] = 973,
    ...
    ["Chamaleon environment"] = 997,
    ["Chamaleon properties"] = 998,
    ["Chamaleon template"] = 996,
    Changesets = 211,
    Charmcraft = 122,
    Cheatsheets = 861,
    ...
    CityJSON = 125,
    ["Clawject config"] = 134,
    ["Cloud Foundry Application Manifest"] = 955,
    ["Cloud Run Spec v1"] = 977,
    ...
    Concord = 971,
    ["Configu .cfgu files"] = 960,
    ["Configu .configu file"] = 961,
    Conjure = 128,
    ["Container Structure Test"] = 803,
    Containerlab = 830,
    ["Crowdsec collection config"] = 220,
    ["Crowdsec parser config"] = 221,
    ["Crowdsec scenario config"] = 222,
    ["CumulusCI Config"] = 133,
    ["Custom Machinery Machine"] = 945,
    ["Custom Machinery Recipe"] = 946,
    ...
    ["DonateCaseBetterCasino menu"] = 1001,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 916,
    ["EAS config"] = 286,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 905,
    ["EasyVCR .NET"] = 287,
    ["Eidolon Resource"] = 988,
    ...
    ["GeoJSON.json latest"] = 868,
    GherKing = 872,
    ["GitHub Action"] = 317,
    ["GitHub Actions typing"] = 984,
    ...
    ["Goreleaser Pro"] = 346,
    Goss = 347,
    ["Gradle Build Cache Node"] = 819,
    ["Gradle Enterprise"] = 818,
    ...
    Hadolint = 799,
    Hammerkit = 829,
    ["Hardware Sentry Configuration"] = 884,
    Hatch = 800,
    Hayson = 360,
    ...
    ["JFrog File Spec"] = 389,
    ["JFrog Pipelines YML DSL"] = 893,
    ["JMeter DSL cli config"] = 390,
    JReleaser = 392,
    ["JSON Document Transform"] = 400,
    ["JSON Feed"] = 401,
    ["JSON Resume"] = 609,
    ["JSON Schema Draft 2020-12"] = 769,
    ["JSON Schema Draft 4"] = 766,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 926,
    ["JSON Schema Draft 7"] = 767,
    ["JSON Schema Draft 7 (unofficial strict)"] = 927,
    ["JSON Schema Draft 8 (2019-09)"] = 768,
    ["JSON-API"] = 399,
    ["JSON-e templates"] = 826,
    ["JSON-stat 2.0"] = 762,
    JSONPatch = 403,
    ...
    ["Metadata for a Cinnamon spice"] = 980,
    ["Metatype Configuration"] = 451,
    ["MetricsHub Configuration"] = 452,
    ["MetricsHub Connector Configuration"] = 453,
    ["Micro Editor Syntax"] = 917,
    ["Microsoft Band Web Tile"] = 454,
    ["Microsoft RulesEngine workflow rules"] = 968,
    ["Microsoft RulesEngine workflow rules list"] = 969,
    ["Minecraft Custom Main Menu Mod"] = 934,
    ...
    ["MongoDB Atlas Search Index Definition"] = 888,
    ["Monika Configuration"] = 886,
    ["Monoweave Configuration"] = 479,
    ["Motif config"] = 782,
    ["NOX Framework (Service)"] = 496,
    ["Netin Diagnostic System Template"] = 846,
    ["Netlify config"] = 487,
    ...
    ["OpenUtau ustx"] = 514,
    ["OpenWeather Current Weather API"] = 825,
    ["OpenWeather Road Risk API"] = 824,
    ...
    ["Pipeline component"] = 837,
    ["Plex Prerolls"] = 550,
    ["PocketMine plugin.yml"] = 547,
    ["Postman collection"] = 554,
    ["Preset list for a WinUtil"] = 983,
    ["Problem object RFC9457"] = 931,
    ...
    Qgoda = 590,
    Qodana = 856,
    ["Qt Creator workspace file"] = 962,
    ["Quali Torque Blueprint Spec 2"] = 881,
    ["QueryFirst config file"] = 899,
    ["RKE Cluster Configuration JSON"] = 834,
    ["RKE Cluster Configuration YAML"] = 833,
    RadioHound = 582,
    Railway = 591,
    ["Rancher Fleet"] = 584,
    ["Rattler-build"] = 592,
    ...
    ["Render Blueprints"] = 832,
    RenderCV = 611,
    Renovate = 610,
    ["Replit config"] = 605,
    Restate = 1011,
    RoadRunner = 613,
    ["Rudder techniques"] = 937,
    Ruff = 607,
    ["Rust Project"] = 608,
    ["Rust toolchain"] = 617,
    ...
    ["SauceCTL Configuration"] = 843,
    ["Schema Catalog"] = 635,
    ["Scoop manifest"] = 640,
    ["Semantic Data Fabric (SDF) file"] = 644,
    ["Semgrep Rule"] = 646,
    ["Serenity Code Generator (Sergen)"] = 647,
    ["Serverless Framework Configuration"] = 850,
    ["Serverless Workflow"] = 852,
    ["Settings for a Cinnamon spice"] = 979,
    ["Settings.paf"] = 649,
    ["Shopware 6 Configuration"] = 853,
    ["Shopware CLI Extension Store Configuration"] = 854,
    ["Shopware CLI Project Store Configuration"] = 855,
    ["Sigma Detection Rule"] = 651,
    ["Sigrid scope configuration file"] = 652,
    ["SkyPilot Task JSON"] = 938,
    ...
    StackBlitz = 674,
    ["StackHawk Scanner Configuration"] = 849,
    Stale = 675,
    ["Starlake Data Pipeline"] = 822,
    Starship = 676,
    ...
    ["Sublime Syntax"] = 895,
    ["Subsquid squid manifest"] = 940,
    ["Swagger API 2.0"] = 685,
    ["Synadia Connect Component"] = 686,
    TSON = 718,
    TSTyche = 719,
    ["Tab data for a LinUtil"] = 986,
    ["Tab list for a LinUtil"] = 985,
    Talhelper = 688,
    ["Talisman configuration"] = 689,
    ["Taskfile config"] = 827,
    Taurus = 690,
    Tauticord = 691,
    Telefonistka = 1012,
    ["TestEnvironment.json"] = 701,
    ["TextMate Grammar"] = 700,
    ["Tier.run pricing.json"] = 694,
    Tikibase = 695,
    Tombi = 699,
    ["Traefik v2"] = 704,
    ["Traefik v2 File Provider"] = 705,
    ["Traefik v3"] = 706,
    ["Traefik v3 File Provider"] = 707,
    ["Travis CI (.travis.yml)"] = 703,
    Trident = 1010,
    ["TrueScript for *.tscript files"] = 710,
    ["Tugboat QA config.yml"] = 1007,
    TunnelHub = 930,
    Turborepo = 702,
    Tycho = 975,
    Tye = 857,
    ...
    ["UTAM Page Object"] = 731,
    ["Ubuntu Server Autoinstall"] = 726,
    ["Uniswap Token List"] = 810,
    ["Universal Schedule Format"] = 733,
    ["Unreal Engine Uplugin"] = 901,
    ["Unreal Engine Uproject"] = 902,
    ["Updatecli Compose"] = 865,
    ["Updatecli Policy Manifest"] = 866,
    ["Updatecli Policy Metadata"] = 867,
    Uplift = 898,
    ["User Journey Map"] = 831,
    V2Ray = 871,
    ["VSCode Code Snippets"] = 186,
    ["VSIX CLI publishing"] = 751,
    Vector = 735,
    ["Vela Pipeline Configuration"] = 738,
    Vercel = 185,
    ["Version Bumper config"] = 741,
    Visivo = 928,
    Wake = 1009,
    ["Waku Config"] = 989,
    ["Web App Manifest"] = 757,
    ["Web types"] = 760,
    WebExtensions = 756,
    ["Webman package recipe"] = 877,
    ["Windows Package Manager Installer Manifest"] = 806,
    ["Windows Package Manager Locale Manifest"] = 807,
    ["Windows Package Manager Singleton Manifest"] = 805,
    Winutil = 808,
    ["WireMock stub mapping"] = 992,
    ["Woodpecker pipeline config"] = 845,
    ["Wrangler CLI"] = 761,
    ["Xstate Machine"] = 863,
    ["Yandex Workflow Language"] = 981,
    ["Yarn Config (.yarnrc.yml)"] = 820,
    ["Yippee-Ki-JSON configuration YML"] = 812,
    ["YouTrack App"] = 978,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 18,
    apko = 932,
    ...
    ["behat.yml"] = 94,
    ["bigquery-table"] = 84,
    ["bioimageio resource description"] = 948,
    ...
    ["crowdin.yml"] = 219,
    ["ctfd-setup configuration file"] = 999,
    ["custom-elements.json"] = 920,
    ["cypress.json"] = 223,
    ...
    ["gematik health care insurance list"] = 1005,
    ["gematik health care patient list"] = 1002,
    ["gematik health care provider institution list"] = 1004,
    ["gematik health care provider list"] = 1003,
    ["gematik tiger test environment configuration"] = 1006,
    ["gitlab-ci"] = 325,
    ["global.json"] = 341,
    ...
    ["lint-staged (.lintstagedrc)"] = 777,
    ["local.settings.json"] = 441,
    ["localazy.json"] = 442,
    ["lotus.yaml"] = 440,
    ["lsdlschema.json"] = 443,
    ["markdown-link-check"] = 840,
    maturin = 841,
    mboats = 848,
    ["micro-settings.json"] = 912,
    ["mimetypes.json"] = 455,
    ["mirrord config"] = 778,
    mise = 779,
    ["mkdocs.yml"] = 475,
    ...
    ["plagiarize.yaml"] = 548,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 995,
    ["podbard.yaml"] = 551,
    ["portman.json"] = 552,
    ["prefect.toml"] = 560,
    ["prettierrc.json"] = 561,
    ...
    ["servicehub.config.json"] = 772,
    ["servicehub.service.json"] = 771,
    ["settings.job"] = 648,
    ...
    taskcat = 788,
    ["template.json"] = 692,
    ["templatsources.json"] = 693,
    ["theme.json"] = 696,
    ["tizen_workspace.json"] = 697,
    tldr = 698,
    tmuxinator = 775,
    ["transcend.yml"] = 708,
    ...
    ["vim-addon-info"] = 745,
    ["vs-2017.3.host.json"] = 747,
    ["vs-nesting.json"] = 748,
    ["vsls.json"] = 746,
    ["vss-extension.json"] = 752,
    ["vtesttree.yaml"] = 753,
    ["vtestunit.yaml"] = 754,
    ["warp-keysets.json"] = 921,
    ["warp-themes.json"] = 922,
    ["warp-workflows.json"] = 923,
    ["webhint.io"] = 878,
    ["webjobpublishsettings.json"] = 759,
    ["webjobs-list.json"] = 758,
    ["well-known-fursona"] = 958,
    ["xs-app.json"] = 784,
    ["xunit.runner.json"] = 770,
    yamllint = 811,
    ["zerops.io import file"] = 967,
    ["zerops.yml"] = 966,
    zuul = 794,
    ["Žinoma"] = 804
  },
