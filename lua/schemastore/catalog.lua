...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 880,
    [".nodehawkrc"] = 537,
    [".npmpackagejsonlintrc"] = 541,
    [".omletrc"] = 1057,
    [".phrase.yml"] = 609,
    [".phraseapp.yml"] = 610,
    [".pmbot.yml"] = 595,
    [".postcssrc"] = 604,
    [".powerpages-web-template-manifest"] = 606,
    [".pre-commit-config.yml"] = 607,
    [".pre-commit-hooks.yml"] = 608,
    [".putout.json"] = 638,
    [".rehyperc"] = 663,
    [".remarkrc"] = 667,
    [".sprite files"] = 756,
    ...
    ["A micro editor config"] = 487,
    ABCInventoryModuleData = 20,
    ABCSupplyPlan = 21,
    AIConfig = 22,
    ["AMX Muse Program Descriptor"] = 1104,
    ["API Builder"] = 915,
    ["AVA Configuration"] = 978,
    ["AWS AppConfig Feature Flags-v1"] = 54,
    ["AWS CDK cdk.json"] = 227,
    ["AWS CloudFormation"] = 228,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 229,
    ["AWS Copilot Manifest"] = 1143,
    ["AWS SAM CLI Samconfig"] = 230,
    ["Adobe UXP Manifest"] = 1040,
    ["Aerleon Network & Service Definitions"] = 15,
    ["Aerleon Policy"] = 16,
    Aider = 1133,
    Air = 18,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1154,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1153,
    ["Airlock Microgateway"] = 23,
    ["Alacritty Configuration"] = 950,
    ["All Contributors configuration file"] = 1003,
    ["Ansible Argument Specs"] = 362,
    ["Ansible Collection Galaxy"] = 369,
    ["Ansible Execution Environment"] = 359,
    ["Ansible Inventory"] = 368,
    ["Ansible Meta"] = 360,
    ["Ansible Meta Runtime"] = 361,
    ["Ansible Navigator Configuration"] = 371,
    ["Ansible Playbook"] = 366,
    ["Ansible Requirements"] = 363,
    ["Ansible Rulebook"] = 367,
    ["Ansible Tasks File"] = 365,
    ["Ansible Vars File"] = 364,
    ["Ansible-lint Configuration"] = 370,
    Any = 1067,
    ["AnyWork Automation Configuration"] = 11,
    ["Apollo Router"] = 916,
    ["App config Spotify Backstage"] = 27,
    ["Application Accelerator"] = 8,
    ["Application list for a WinUtil"] = 1084,
    ArchitectFX = 1089,
    ["Argo CD"] = 41,
    ["Argo Events"] = 42,
    ["Argo Workflows"] = 43,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1152,
    ["Azure IoT Operations connector metadata"] = 1149,
    ...
    ["Azure Pipelines"] = 85,
    ["Azure Static Web Apps CLI configuration file"] = 760,
    ["Azure Static Web Apps configuration file"] = 759,
    ["BOSH CPI Config"] = 109,
    ["BOSH Deploy Config"] = 110,
    ["BX CI"] = 129,
    ["Bacon config"] = 2,
    ["Bashly (bashly.yml)"] = 1007,
    ["Bashly Settings (bashly-settings.yml)"] = 1008,
    ["Better Code Hub"] = 920,
    ["Better Scripts"] = 130,
    Bigconfig = 102,
    ["Biome Formatter Config"] = 68,
    ["Bitmovin Encoding Template"] = 1097,
    BizTalkServerApplicationSchema = 887,
    Bleep = 131,
    ["Block Protocol Metadata"] = 128,
    ["Boyka Framework"] = 111,
    Briefcase = 893,
    ["Build Info"] = 119,
    Buildkite = 121,
    ["Bukkit plugin.yml"] = 120,
    ["BungeeCord plugin.yml"] = 126,
    ["Butane Config"] = 963,
    C4InterFlow = 1112,
    ["CDK Environment Manager, concrete environment configuration"] = 1136,
    ["CDK Environment Manager, concrete environments definition"] = 1135,
    ["CDK Environment Manager, environment definition"] = 1134,
    ["CGS Card Game Specification (cgs.json)"] = 1045,
    ["CICS TS region tagging"] = 972,
    ["CICS TS resource import"] = 973,
    ["CICS TS resource model"] = 974,
    ["CICS TS resource overrides"] = 975,
    ["CMake Presets"] = 132,
    ["CNC Codes"] = 153,
    ["CRS WAF test file"] = 1074,
    ["CRS WAF test platform overrides file"] = 1075,
    ["CSS Comb (.csscomb.json)"] = 255,
    ["CSS Lint (.csslintrc)"] = 256,
    ["CSpell (cspell.json)"] = 254,
    ["CVE Record Format"] = 161,
    CWL = 1051,
    ["Cache Warmup config"] = 133,
    ["Calqulus pipeline"] = 134,
    ["Camel YAML DSL"] = 135,
    ["Cannon TOML"] = 136,
    Carafe = 137,
    ["Cargo Make"] = 139,
    ["Cargo Manifest"] = 138,
    ["Catalog Info Backstage"] = 140,
    ["Chamaleon environment"] = 1101,
    ["Chamaleon properties"] = 1102,
    ["Chamaleon template"] = 1100,
    Changesets = 239,
    Changie = 141,
    Charmcraft = 142,
    Cheatsheets = 960,
    ["ChordPro Configuration"] = 143,
    ["Chrome Extension"] = 220,
    ["Chromia Model"] = 144,
    ["Chromia Seeder Module Config"] = 146,
    ["Chromia Seeder Root Config"] = 145,
    ["Cinnamon Spice info.json"] = 75,
    ["CircleCI config.yml"] = 196,
    ["Citation File Format"] = 241,
    CityJSON = 148,
    ["Claude Code Settings"] = 160,
    ["Clawject config"] = 159,
    ["Cloud Foundry Application Manifest"] = 1056,
    ["Cloud Run Spec v1"] = 1079,
    ["CloudCannon Configuration"] = 80,
    ["CloudEvents specification"] = 149,
    ["Code Climate"] = 197,
    CodeCV = 78,
    CodeRabbit = 77,
    ["CodeShip Pro services configuration files"] = 209,
    ["CodeShip Pro steps configuration files"] = 210,
    ["Codecov configuration files"] = 208,
    CodifyCLI = 79,
    Codux = 206,
    ["Cog config file"] = 154,
    ["Commandbox Box.json"] = 155,
    ["Commandbox Server.json"] = 156,
    ["Common Catalog Data"] = 218,
    ["Common Package Specification"] = 157,
    Concord = 1073,
    ["Configu .cfgu files"] = 1061,
    ["Configu .configu file"] = 1062,
    Conjure = 152,
    ["Container Structure Test"] = 901,
    Containerlab = 929,
    ["Contextive Glossary"] = 1128,
    Convex = 151,
    ["Crowdsec collection config"] = 249,
    ["Crowdsec parser config"] = 250,
    ["Crowdsec scenario config"] = 251,
    ["CumulusCI Config"] = 158,
    ["Custom Machinery Machine"] = 1046,
    ["Custom Machinery Recipe"] = 1047,
    ["Cycle Stack File"] = 162,
    CycloneDX = 163,
    ["DWP Exchange - catalogue entry"] = 298,
    ["DWP Exchange - gateway"] = 296,
    ["DWP Exchange - meta"] = 297,
    ["Dart Build Config (dart-build.json)"] = 257,
    ["Dart Test Config (dart-test.json)"] = 258,
    ["DashLord Configuration"] = 259,
    ["Data Contract Specification"] = 260,
    ["Data Product Specification"] = 261,
    ["DataYoga Connections"] = 164,
    ["DataYoga Job"] = 165,
    ["Databricks Asset Bundles"] = 1024,
    ["Datadog Continuous Testing"] = 458,
    ["Datadog Service Definition"] = 459,
    ["Datadog Software Catalog"] = 460,
    ["Datahub Ingestion Recipe"] = 979,
    ["Debian Upstream Metadata file"] = 171,
    ["Deck config"] = 172,
    ["Dein Config"] = 173,
    ["Deno Config (deno.json)"] = 267,
    ["Dependency cruiser"] = 174,
    ["DeployStack Configuration"] = 175,
    ["Deployah Configuration"] = 1151,
    ["Deployer Recipe"] = 270,
    ["Deta Spacefile"] = 176,
    ["Detekt Config (detekt.yml)"] = 271,
    ["Devbox Config"] = 177,
    ["Devbox Plugin"] = 178,
    Devfile = 295,
    DipDup = 1076,
    ["Discord Webhook"] = 272,
    ["DocFx Config (docfx.json)"] = 276,
    Dofigen = 277,
    ["Dolittle Artifacts"] = 278,
    ["Dolittle Bounded Context Configuration"] = 279,
    ["Dolittle Event Horizons Configuration"] = 280,
    ["Dolittle Resources Configuration"] = 281,
    ["Dolittle Server Configuration"] = 282,
    ["Dolittle Tenant Map Configuration"] = 284,
    ["Dolittle Tenants Configuration"] = 283,
    ["Dolittle Topology"] = 285,
    ["DonateCaseBetterCasino menu"] = 1105,
    ["Drupal Breakpoints"] = 179,
    ["Drupal Config"] = 191,
    ["Drupal Info"] = 180,
    ["Drupal Layouts"] = 181,
    ["Drupal Libraries"] = 182,
    ["Drupal Links Action"] = 183,
    ["Drupal Links Contextual"] = 184,
    ["Drupal Links Menu"] = 185,
    ["Drupal Links Task"] = 186,
    ["Drupal Migration"] = 187,
    ["Drupal Permissions"] = 188,
    ["Drupal Recipe"] = 189,
    ["Drupal Routing"] = 190,
    ["Drupal Services"] = 192,
    ["Drush site aliases"] = 291,
    ["Dynamic Bash Aliases (.aliases)"] = 1015,
    ["EAS config"] = 315,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1004,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1148,
    ["EasyVCR .NET"] = 316,
    ["Eidolon Resource"] = 1090,
    ["Elgato Stream Deck"] = 301,
    Elm = 1078,
    ["Embrace Config"] = 990,
    Endurica = 1028,
    ["Enterprise Contract Policy Spec"] = 302,
    ["Erda Pipeline"] = 1053,
    ["Erda Runtime"] = 1054,
    Esquio = 304,
    ["Estuary Flow Catalog"] = 969,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 308,
    ["EveryVoice TTS Toolkit Data Configuration"] = 309,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 313,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 312,
    ["EveryVoice TTS Toolkit Text Configuration"] = 310,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 311,
    ["Evolving Resolutive Process notation"] = 1150,
    ["Expo SDK"] = 314,
    ["F-Droid Data metadata"] = 320,
    ["FasterCI Configuration"] = 86,
    FiQuS = 324,
    Firebase = 322,
    ["FlexGet Config"] = 325,
    ["Flow.json Configurations"] = 1050,
    ["Fossa configuration file"] = 332,
    ["Fossa's fossa-deps file"] = 333,
    ["Foundry VTT - Base package Manifest"] = 327,
    ["Foundry VTT - Module Manifest"] = 328,
    ["Foundry VTT - System Data Template"] = 331,
    ["Foundry VTT - System Manifest"] = 329,
    ["Foundry VTT - World Manifest"] = 330,
    ["Foxx Manifest"] = 87,
    ["Freifunk.de Community API"] = 90,
    ["Frogbot Config"] = 91,
    ["G2P Mapping Configuration"] = 339,
    ["GCP Blueprint Metadata"] = 342,
    Gaspar = 340,
    ["GatewayCore API Gateway"] = 341,
    ["Gemini CLI settings"] = 343,
    ["GeoJSON.json latest"] = 967,
    GherKing = 971,
    ["GitHub Action"] = 348,
    ["GitHub Actions typing"] = 1086,
    ["GitHub Discussion"] = 349,
    ["GitHub Funding"] = 350,
    ["GitHub Issue Template configuration"] = 351,
    ["GitHub Issue Template forms"] = 352,
    ["GitHub Workflow"] = 353,
    ["GitHub Workflow Template Properties"] = 354,
    ["GitHub automatically generated release notes configuration"] = 355,
    ["GitLab Agent for Kubernetes configuration"] = 1042,
    GitVersion = 345,
    ["Gitea Issue Template configuration"] = 346,
    ["Gitea Issue Template forms"] = 347,
    ["Gitpod Automations"] = 357,
    ["Gitpod Configuration"] = 358,
    ["GlazeWM settings"] = 1044,
    ["Global Privacy Control"] = 344,
    Goblet = 1023,
    ["Golangci-lint Configuration"] = 373,
    ["Golangci-lint Custom Plugins Configuration"] = 374,
    ["Google Chrome Related Website Sets"] = 323,
    ["Google Cloud Workflows"] = 226,
    ["Google Digital Assetlinks"] = 1129,
    Goreleaser = 376,
    ["Goreleaser Pro"] = 377,
    Goss = 378,
    ["Gradle Build Cache Node"] = 918,
    ["Gradle Enterprise"] = 917,
    ["Grafana 5.x Dashboard"] = 379,
    ["GraphQL Code Generator"] = 384,
    ["GraphQL Config"] = 383,
    ["GraphQL Mesh"] = 382,
    ["Grunt JSHint task"] = 388,
    ["Grunt Watch task"] = 389,
    ["Grunt base task"] = 390,
    ["Grunt clean task"] = 386,
    ["Grunt copy task"] = 385,
    ["Grunt cssmin task"] = 387,
    HEMTT = 883,
    Hadolint = 897,
    Hammerkit = 928,
    ["Hardware Sentry Configuration"] = 983,
    ["HashiCorp Vault"] = 391,
    Hatch = 898,
    Hayagriva = 393,
    Hayson = 394,
    ["Haystack Pipeline"] = 395,
    ["Hazelcast 5 Configuration"] = 396,
    ["Hecate Input Schema"] = 1140,
    ["Helm Chart.lock"] = 194,
    ["Helm Chart.yaml"] = 193,
    ["Helm Unittest Test Suite"] = 195,
    ["Home Assistant Integration Manifest"] = 397,
    ["Homer dashboard configuration"] = 398,
    Hugo = 959,
    ["Hugo Theme"] = 958,
    ["Hulak Configuration"] = 405,
    ["Hyperfoil benchmark configuration"] = 404,
    ["IBM Zapp document"] = 406,
    ["IBM zCodeFormatSettings"] = 407,
    ["IMG Catapult PSP"] = 412,
    ["IVMS101 by CODE Protocol"] = 1043,
    Infrahub = 414,
    Istanbul = 986,
    ["JDownloader2 crawler multi-rules"] = 425,
    ["JDownloader2 crawler single-rules"] = 424,
    ["JFrog Applications Config"] = 426,
    ["JFrog File Spec"] = 427,
    ["JFrog Pipelines YML DSL"] = 992,
    ["JMeter DSL cli config"] = 428,
    JReleaser = 431,
    ["JSON Document Transform"] = 439,
    ["JSON Feed"] = 440,
    ["JSON Resume"] = 673,
    ["JSON Schema Draft 2020-12"] = 865,
    ["JSON Schema Draft 4"] = 862,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1025,
    ["JSON Schema Draft 7"] = 863,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1026,
    ["JSON Schema Draft 8 (2019-09)"] = 864,
    ["JSON-API"] = 438,
    ["JSON-e templates"] = 925,
    ["JSON-stat 2.0"] = 858,
    JSONPatch = 442,
    ["JSR Package Config (jsr.json)"] = 432,
    Jarl = 1156,
    Jasmine = 419,
    Jekyll = 420,
    ["Jenkins X Pipelines"] = 421,
    ["Jenkins X Requirements"] = 422,
    Jest = 423,
    Jocker = 429,
    ["Jovo Language Models"] = 430,
    ["Jujutsu (jj) VCS config"] = 1142,
    ["KIMMDY config file"] = 453,
    ["KODE/CI build.yaml"] = 988,
    ["KSP-AVC"] = 859,
    ["KSP-CKAN"] = 860,
    ["KSP-NetKAN"] = 861,
    KSY = 1055,
    KSail = 337,
    ["Karakum configuration file"] = 334,
    Kas = 445,
    ["Kestra flow file"] = 454,
    ["Keycloak REST API"] = 995,
    ["Knative Functions - func.yaml"] = 335,
    Knip = 336,
    ["Kometa (nightly) config file"] = 456,
    ["Kometa config file"] = 455,
    ["Kong DBLess config"] = 989,
    KrakenD = 457,
    ["Kubri Configuration"] = 464,
    LOOBin = 479,
    ["Lake configuration file"] = 1145,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 231,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 232,
    ["Landing Zone Accelerator on AWS - Global Config"] = 233,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 234,
    ["Landing Zone Accelerator on AWS - Network Config"] = 235,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 236,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 237,
    ["Landing Zone Accelerator on AWS - Security Config"] = 238,
    ["Lando (landofile)"] = 81,
    ["LangGraph Platform configuration"] = 1066,
    ["Language configuration"] = 1065,
    Lefthook = 468,
    ["Liferay client-extension.yaml"] = 475,
    ["LinkML Metamodel"] = 477,
    Liquibase = 934,
    ["Liquibase Flow File"] = 935,
    ["Lively Properties"] = 478,
    ["Lobe AI Agent"] = 83,
    Loki = 84,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 519,
    ["MS2Rescore Configuration"] = 522,
    ["Madness (madness.yml)"] = 1006,
    ["Mado configuration"] = 485,
    ["MapEHR Mapping"] = 486,
    Markdownlint = 938,
    ["Mason Registry"] = 941,
    ["MegaLinter Custom Flavor"] = 489,
    ["MegaLinter configuration"] = 488,
    ["MegaLinter descriptor"] = 490,
    Melange = 1033,
    ["Meltano project definition"] = 491,
    ["Mergify Configuration"] = 523,
    ["Metadata for a Bazel module"] = 492,
    ["Metadata for a Cinnamon spice"] = 1082,
    ["Metatype Configuration"] = 493,
    ["MetricsHub Configuration"] = 494,
    ["MetricsHub Connector Configuration"] = 495,
    ["Micro Editor Syntax"] = 1016,
    ["Microsoft Band Web Tile"] = 496,
    ["Microsoft RulesEngine workflow rules"] = 1070,
    ["Microsoft RulesEngine workflow rules list"] = 1071,
    ["Minecraft Custom Main Menu Mod"] = 1034,
    ["Minecraft Data Pack Advancement"] = 498,
    ["Minecraft Data Pack Biome"] = 499,
    ["Minecraft Data Pack Configured Carver"] = 500,
    ["Minecraft Data Pack Damage Type"] = 501,
    ["Minecraft Data Pack Dimension"] = 503,
    ["Minecraft Data Pack Dimension Type"] = 502,
    ["Minecraft Data Pack Item Modifier"] = 504,
    ["Minecraft Data Pack Loot Table"] = 505,
    ["Minecraft Data Pack Metadata"] = 506,
    ["Minecraft Data Pack Predicate"] = 507,
    ["Minecraft Data Pack Recipe"] = 508,
    ["Minecraft Data Pack Tag"] = 509,
    ["Minecraft Data Pack Template Pool"] = 510,
    ["Minecraft Data Pack Trim Material"] = 515,
    ["Minecraft Data Pack Trim Pattern"] = 516,
    ["Minecraft Resource Pack Lang"] = 511,
    ["Minecraft Resource Pack Particle"] = 512,
    ["Minecraft Resource Pack Texture Mcmeta"] = 514,
    ["Minecraft Resourcepack Sounds"] = 513,
    ["Monade CLI Stack Configuration"] = 526,
    ["MongoDB Atlas Search Index Definition"] = 987,
    ["Monika Configuration"] = 985,
    ["Monoweave Configuration"] = 521,
    ["Motif config"] = 879,
    MultiQC = 1122,
    ["NOX Framework (Service)"] = 540,
    ["Netin Diagnostic System Template"] = 945,
    ["Netlify config"] = 529,
    ["Network-as-Code Data Model"] = 530,
    ["Next Gen UI Agent Configuration"] = 531,
    ["Nightwatch.js"] = 533,
    ["Node.js configuration"] = 884,
    ["NueJS configuration file"] = 545,
    ["Nuitka.yaml"] = 1048,
    ["Nullstone config"] = 547,
    ["ONe's changelog entry"] = 563,
    ["ONe's service descriptor"] = 562,
    ["ORT Server repository environment configuration"] = 571,
    ["OSCAL Assessment Plan (AP)"] = 573,
    ["OSCAL Assessment Results (AR)"] = 574,
    ["OSCAL Catalog"] = 575,
    ["OSCAL Component Definition (CDef)"] = 576,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 577,
    ["OSCAL Profile"] = 578,
    ["OSCAL System Security Plan (SSP)"] = 579,
    ["OSS Review Toolkit configuration"] = 580,
    ["OSS Review Toolkit curation"] = 581,
    ["OSS Review Toolkit package configuration"] = 582,
    ["OSS Review Toolkit repository configuration"] = 583,
    ["OSS Review Toolkit resolutions"] = 584,
    ["October CMS columns"] = 551,
    ["October CMS fields"] = 552,
    ["Oh My Posh"] = 553,
    Okteto = 554,
    ["Ona Automations"] = 556,
    Opctl = 882,
    ["Open Data Contract Standard (ODCS)"] = 566,
    ["Open Data Product Standard (ODPS)"] = 567,
    ["Open Know-How"] = 1127,
    ["OpenRewrite Resource"] = 565,
    OpenStatus = 1138,
    ["OpenUtau character yaml"] = 559,
    ["OpenUtau ustx"] = 560,
    ["OpenWeather Current Weather API"] = 924,
    ["OpenWeather Road Risk API"] = 923,
    ["Ory Hydra configuration"] = 403,
    ["Ory Keto configuration"] = 461,
    ["Ory Kratos configuration"] = 572,
    ["Ory Oathkeeper configuration"] = 549,
    ["Outblocks App configuration"] = 569,
    ["Outblocks database table"] = 570,
    ["Outblocks project configuration"] = 568,
    PDM = 591,
    POPxf = 601,
    ["POPxf Correlations"] = 602,
    Packer = 588,
    Pantsbuild = 1002,
    ["Paper paper-plugin.yml"] = 589,
    ["Pipeline component"] = 936,
    ["Platform.sh application"] = 4,
    ["Platform.sh routes"] = 5,
    ["Platform.sh services"] = 6,
    ["Plex Prerolls"] = 599,
    ["PocketMine plugin.yml"] = 596,
    ["Postman collection"] = 605,
    ["Power Pages Configuration"] = 1139,
    ["Preset list for a WinUtil"] = 1085,
    ["ProActions AI-Kit Configuration"] = 614,
    ["ProActions AI-Kit Configuration for Menus"] = 616,
    ["ProActions AI-Kit Configuration for Sections"] = 618,
    ["ProActions AI-Kit Configuration for Services"] = 615,
    ["ProActions AI-Kit Configuration for Steps"] = 619,
    ["ProActions AI-Kit Configuration for Templates"] = 617,
    ["Problem object RFC9457"] = 1031,
    ["Problem package generators"] = 620,
    Pterodactyl = 982,
    ["Pull Request Labeler"] = 637,
    Pulumi = 645,
    ["PyGTA Config"] = 641,
    PyProject = 646,
    Pylock = 1130,
    Pyright = 647,
    ["Python script metadata"] = 1124,
    ["QType AI DSL"] = 650,
    Qgoda = 649,
    Qodana = 955,
    ["Qt Creator workspace file"] = 1063,
    ["Quali Torque Blueprint Spec 2"] = 980,
    ["QueryFirst config file"] = 998,
    ["RKE Cluster Configuration JSON"] = 933,
    ["RKE Cluster Configuration YAML"] = 932,
    RadioHound = 640,
    Railpack = 652,
    Railway = 651,
    ["Rancher Fleet"] = 642,
    ...
    Ray = 896,
    ["Read the Docs"] = 644,
    ["Red-DiscordBot Cog"] = 660,
    ["Red-DiscordBot Cog Repo"] = 661,
    ["Red-DiscordBot Trivia"] = 662,
    ["Render Blueprints"] = 931,
    RenderCV = 675,
    Renovate = 674,
    ["Replit config"] = 668,
    Restate = 1117,
    ["Revel Digital Gadget Definition File"] = 1141,
    RoadRunner = 677,
    ["Robust Station Image"] = 1147,
    Rockcraft = 678,
    ["Roo Coder Custom Modes"] = 679,
    Rubocop = 670,
    ["Rudder techniques"] = 1038,
    Ruff = 671,
    ["Rust Project"] = 672,
    ["Rust toolchain"] = 683,
    ["SDMX data message"] = 709,
    ["SDMX metadata message"] = 708,
    ["SDMX structure message"] = 707,
    ["SIL Kit Participant Configuration"] = 719,
    ["SIL Kit Registry Configuration"] = 720,
    ["SPDX 2.3"] = 757,
    SWADL = 773,
    ["Safebox Config"] = 993,
    ["Sapphire CLI Config"] = 686,
    ["SauceCTL Configuration"] = 942,
    ["Schema Catalog"] = 701,
    ["Scoop manifest"] = 706,
    ["Semantic Data Fabric (SDF) file"] = 710,
    ["Semgrep Rule"] = 712,
    ["Serenity Code Generator (Sergen)"] = 713,
    ["Serverless Framework Configuration"] = 949,
    ["Serverless Workflow"] = 951,
    ["Settings for a Cinnamon spice"] = 1081,
    ["Settings.paf"] = 715,
    ["Shopware 6 Configuration"] = 952,
    ["Shopware CLI Extension Store Configuration"] = 953,
    ["Shopware CLI Project Store Configuration"] = 954,
    ["Sigma Detection Rule"] = 717,
    ["Sigrid scope configuration file"] = 718,
    ["SkyPilot Task JSON"] = 1039,
    ["Slack app manifest"] = 722,
    Snapcraft = 724,
    Solidarity = 727,
    ["Solution filters"] = 728,
    ["Source Maps v3"] = 729,
    Sourcery = 730,
    ["Spack bootstrap.yaml"] = 731,
    ["Spack cdash.yaml"] = 732,
    ["Spack ci.yaml"] = 733,
    ["Spack compilers.yaml"] = 734,
    ["Spack concretizer.yaml"] = 735,
    ["Spack config.yaml"] = 736,
    ["Spack definitions.yaml"] = 737,
    ["Spack develop.yaml"] = 738,
    ["Spack env_vars.yaml"] = 739,
    ["Spack environment"] = 745,
    ["Spack include.yaml"] = 740,
    ["Spack mirrors.yaml"] = 741,
    ["Spack modules.yaml"] = 742,
    ["Spack packages.yaml"] = 743,
    ["Spack repos.yaml"] = 744,
    ["Spack toolchains.yaml"] = 746,
    ["Spack upstreams.yaml"] = 747,
    ["Spack view.yaml"] = 748,
    ["Speakeasy Generation Config File"] = 752,
    ["Speakeasy Lint Configuration File"] = 749,
    ["Speakeasy Test Generation Configuration File"] = 750,
    ["Speakeasy Workflow File"] = 751,
    SpecIF = 753,
    ["Specmatic Configuration"] = 754,
    ["Sponge Mixin configuration"] = 755,
    StackBlitz = 761,
    ["StackHawk Scanner Configuration"] = 948,
    Stale = 762,
    Starfish = 763,
    ["Starlake Data Pipeline"] = 921,
    Starship = 764,
    ["Statamic Blueprint"] = 765,
    ["Stella configuration file"] = 766,
    ["Streamlit configuration file"] = 767,
    ["Stryker Mutator"] = 770,
    ["StyleCop Analyzers Configuration"] = 771,
    ["Stylelint (.stylelintrc)"] = 772,
    ["Stylua Config"] = 1131,
    ["Sublime Syntax"] = 994,
    ["Subsquid squid manifest"] = 1041,
    ["Swagger API 2.0"] = 774,
    ["Synadia Connect Component"] = 775,
    TSON = 810,
    TSTyche = 811,
    ["TYPO3 Vendor Bundler config"] = 816,
    ["Tab data for a LinUtil"] = 1088,
    ["Tab list for a LinUtil"] = 1087,
    Tach = 776,
    ["Tach Domain"] = 777,
    Talhelper = 779,
    ["Talisman configuration"] = 780,
    Taplo = 1132,
    ["Taskfile config"] = 926,
    Taurus = 781,
    Tauticord = 782,
    ["Tekton Pipeline"] = 1160,
    ["Tekton PipelineRun"] = 1161,
    ["Tekton Task"] = 1158,
    ["Tekton TaskRun"] = 1159,
    Telefonistka = 1118,
    ["Terrateam config"] = 1144,
    ["TestEnvironment.json"] = 793,
    ["TextMate Grammar"] = 792,
    Threagile = 788,
    ["Tier.run pricing.json"] = 785,
    Tikibase = 786,
    Tombi = 791,
    ["Traefik v2"] = 796,
    ["Traefik v2 File Provider"] = 797,
    ["Traefik v3"] = 798,
    ["Traefik v3 File Provider"] = 799,
    ["Travis CI (.travis.yml)"] = 795,
    Treefmt = 381,
    Trident = 1114,
    ["TrueScript for *.tscript files"] = 802,
    ["Tugboat QA config.yml"] = 1111,
    TunnelHub = 1029,
    Turborepo = 794,
    Tycho = 1077,
    Tye = 956,
    ["Tyk Gateway - Open Source v5.7+"] = 1123,
    ["Typst Manifest"] = 817,
    ["UET BuildConfig.json"] = 999,
    ["UI5 Manifest"] = 823,
    ["UNCORS configuration"] = 827,
    ["UTAM Page Object"] = 826,
    ["Ubuntu Server Autoinstall"] = 821,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1115,
    ["Uniswap Token List"] = 908,
    ["Universal Schedule Format"] = 828,
    ["Unreal Engine Uplugin"] = 1000,
    ["Unreal Engine Uproject"] = 1001,
    ["UpCloud CLI (upctl) configuration"] = 1116,
    ["Updatecli Compose"] = 964,
    ["Updatecli Policy Manifest"] = 965,
    ["Updatecli Policy Metadata"] = 966,
    Uplift = 997,
    ["Upsun config"] = 3,
    ["User Journey Map"] = 930,
    V2Ray = 970,
    ["VSCode Code Snippets"] = 214,
    ["VSIX CLI publishing"] = 846,
    Vector = 830,
    ["Vela Pipeline Configuration"] = 833,
    Vercel = 213,
    ["Version Bumper config"] = 836,
    ["Viash Component Config"] = 1120,
    ["Viash Package Config"] = 1121,
    Visivo = 1027,
    ["WP-CLI"] = 856,
    Wake = 1113,
    ["Waku Config"] = 1091,
    ["Web App Manifest"] = 852,
    ["Web types"] = 855,
    WebExtensions = 851,
    ["Webman package recipe"] = 976,
    ["Windows Package Manager Installer Manifest"] = 904,
    ["Windows Package Manager Locale Manifest"] = 905,
    ["Windows Package Manager Singleton Manifest"] = 903,
    Winutil = 906,
    ["WireMock CLI import configuration"] = 1096,
    ["WireMock CLI local service configuration"] = 1095,
    ["WireMock stub mapping"] = 1094,
    ["Woodpecker pipeline config"] = 944,
    ["Wrangler CLI"] = 857,
    ["Xstate Machine"] = 962,
    ["Yandex Workflow Language"] = 1083,
    ["Yarn Config (.yarnrc.yml)"] = 919,
    ["Yippee-Ki-JSON configuration YML"] = 910,
    ["YouTrack App"] = 1080,
    ["Zarf Package Configuration"] = 1146,
    ["Zerops.io config"] = 1068,
    ["Zerops.io import"] = 1069,
    ["Zola Configuration"] = 1157,
    ["aerleon.yml"] = 14,
    ["angular.json"] = 24,
    apko = 1032,
    ...
    ["babelrc.json"] = 93,
    ["bamboo-spec"] = 96,
    ["bashly-strings.yml"] = 1009,
    ["batect.yml"] = 95,
    ["beef-database-codegen"] = 97,
    ["beef-database-v5-codegen"] = 99,
    ["beef-entity-codegen"] = 98,
    ["beef-entity-v5-codegen"] = 100,
    ["behat.yml"] = 112,
    ["bigquery-table"] = 101,
    ["bioimageio resource description"] = 1049,
    ["bitbucket-pipelines"] = 103,
    bitrise = 104,
    ["bitrise-step"] = 105,
    ["block.json"] = 127,
    ...
    ["bozr.suite.json"] = 114,
    bpkg = 1010,
    ["browser.i18n.json"] = 115,
    ["browsh configuration"] = 116,
    bucklescript = 117,
    ["buf.gen.yaml"] = 71,
    ["buf.plugin.yaml"] = 72,
    ["buf.work.yaml"] = 73,
    ...
    ["build-changelog"] = 118,
    ["bun.lock"] = 123,
    ["bundleconfig.json"] = 124,
    ["bunfig.toml"] = 125,
    ["cargo-mutants-config.yaml"] = 74,
    ["ccmod.json"] = 1092,
    changelogging = 1060,
    ["chisel-slices.json"] = 240,
    ["chrome-extension-locales-messages.json"] = 221,
    ["chutzpah.json"] = 222,
    cibuildwheel = 147,
    ["clang-format (.clang-format)"] = 968,
    ["clang-tidy"] = 201,
    clangd = 200,
    clib = 202,
    ["cloud-init: cloud-config userdata"] = 204,
    ["cloud-sdk-pipeline-configuration"] = 224,
    ["cloudbuild.json"] = 225,
    cloudify = 203,
    ["cmdx.yaml"] = 76,
    codemagic = 205,
    ["coffeelint.json"] = 242,
    ["commands.json"] = 217,
    ["commitlint (.commitlintrc)"] = 907,
    ["committed.toml"] = 243,
    ["compile_commands.json"] = 216,
    ["compilerconfig.json"] = 215,
    ["completely.yml"] = 1005,
    ["component-detection-manifest.json"] = 246,
    ["component.json"] = 245,
    ["composer.json"] = 244,
    ["conda-forge"] = 150,
    ["config.yaml"] = 643,
    ["contentmanifest.json"] = 223,
    ["contribute.json"] = 247,
    ["cosmos.config.json"] = 219,
    ["crowdin.yml"] = 248,
    ["ctfd-setup configuration file"] = 1103,
    ["custom-elements.json"] = 1019,
    ["cypress.json"] = 252,
    ["datalogic-scan2deploy-android"] = 262,
    ["datalogic-scan2deploy-ce"] = 263,
    ["dbt Dependencies"] = 166,
    ["dbt Packages"] = 168,
    ["dbt Project"] = 167,
    ["dbt Selectors"] = 169,
    ["dbt YAML files"] = 170,
    ["ddev-global"] = 264,
    ["ddev-project"] = 265,
    ["debugsettings.json"] = 266,
    ["dependabot-v2.json"] = 269,
    ["dependabot.json"] = 268,
    ["deployed-cli"] = 961,
    ["devcontainer.json"] = 207,
    devinit = 912,
    ["devspace.yaml"] = 984,
    djlint = 913,
    ["docker bake"] = 274,
    ["docker sequencer"] = 275,
    ["docker-compose.yml"] = 911,
    ["dockerd.json"] = 273,
    ["dotnet Release Index manifest"] = 286,
    ["dotnet-tools.json"] = 287,
    ["dotnetcli.host.json"] = 288,
    ["dprint.json"] = 289,
    ["drone.json"] = 290,
    ["dss-2.0.0.json"] = 292,
    ["dstack configuration"] = 293,
    ["dtool dataset metadata"] = 1098,
    ["dvc.yaml"] = 294,
    ["ecosystem.json"] = 299,
    eksctl = 300,
    ["electron-builder configuration file"] = 306,
    ["epr-manifest.json"] = 305,
    ["evcc.yaml"] = 307,
    ["ezd task runner"] = 317,
    ["fabric.mod.json"] = 319,
    ["first-timers-bot"] = 326,
    ["flagd flag configuration"] = 88,
    ["fly.io Configuration"] = 89,
    fulibWorkflows = 943,
    ["function.json"] = 338,
    ["gRPC API Gateway & OpenAPI Config"] = 9,
    ["gematik health care insurance list"] = 1109,
    ["gematik health care patient list"] = 1106,
    ["gematik health care provider institution list"] = 1108,
    ["gematik health care provider list"] = 1107,
    ["gematik tiger test environment configuration"] = 1110,
    ["git-town.toml"] = 1155,
    ["gitlab-ci"] = 356,
    ["global.json"] = 372,
    ["go-feature-flag Flag Configuration"] = 375,
    ["haxelib.json"] = 392,
    helmfile = 899,
    helmwave = 900,
    ["host-meta.json"] = 400,
    ...
    ["ide.host.json"] = 408,
    ["ifstate.yaml"] = 409,
    ["imageoptimizer.json"] = 410,
    ["importmap.json"] = 413,
    ["ioBroker Configuration"] = 415,
    ["ioBroker JSON UI"] = 416,
    ["ioBroker Package manifest"] = 417,
    ["ixpect.conf.yaml"] = 418,
    ["ize.toml"] = 996,
    ["jsconfig.json"] = 443,
    ["jscpd Configuration"] = 981,
    jsdoc = 895,
    ["k3d.yaml"] = 444,
    ["k9s aliases.yaml"] = 446,
    ["k9s cluster-config.yaml"] = 448,
    ["k9s config.yaml"] = 447,
    ["k9s hotkeys.yaml"] = 449,
    ["k9s plugins.yaml"] = 450,
    ["k9s skin.yaml"] = 451,
    ["k9s views.yaml"] = 452,
    ["kontinuous-config.yaml"] = 463,
    ["kontinuous-values.yaml"] = 462,
    ["kustomization.yaml"] = 465,
    ["label-commenter-config.yml"] = 466,
    ["latexindent configuration"] = 82,
    ["launchsettings.json"] = 467,
    lazydocker = 1018,
    lazygit = 1017,
    ["lego.json"] = 469,
    ["lerna.json"] = 470,
    ["lgtm.yml"] = 471,
    ["liblab.config.json"] = 472,
    ["libman.json"] = 473,
    ["license-report-config.json"] = 474,
    ["linkinator.config.json"] = 476,
    ["lint-staged (.lintstagedrc)"] = 873,
    ["local.settings.json"] = 481,
    ["localazy.json"] = 482,
    ["lotus.yaml"] = 480,
    ["lsdlschema.json"] = 483,
    ["markdown-link-check"] = 939,
    maturin = 940,
    mboats = 947,
    ["micro-settings.json"] = 1011,
    ["mimetypes.json"] = 497,
    ["mirrord config"] = 875,
    mise = 876,
    ["mkdocs.yml"] = 517,
    ["monospace.yml"] = 520,
    ["moon.yml"] = 1093,
    ["mprocs Configuration file"] = 1064,
    ["mrdocs.yml"] = 518,
    ["mta.yaml"] = 877,
    ["mtad.yaml"] = 878,
    ["mycode.json"] = 527,
    nFPM = 532,
    ["napari plugin manifest"] = 528,
    neoload = 890,
    ["nest-cli"] = 535,
    ["ninjs (News in JSON)"] = 534,
    ["nitro.json"] = 889,
    ["nixd configuration"] = 1037,
    ["nlu.json"] = 536,
    ["nodemon.json"] = 538,
    ["noodl config"] = 946,
    ["notebook.mod.json"] = 539,
    now = 885,
    ["npm-badges"] = 542,
    ["nswag.json"] = 546,
    ntangle = 548,
    ["nuclei-template.yaml"] = 543,
    ["nuget-project.json"] = 544,
    ["ocelot.json"] = 550,
    ["omnisharp.json"] = 555,
    ["openapi.json"] = 557,
    ["openfin.json"] = 564,
    ...
    ["ops.yaml"] = 561,
    ["package.json"] = 585,
    ["package.manifest"] = 587,
    ["package.yaml"] = 586,
    ["partial-black.json"] = 113,
    ["pathfinder.yml"] = 590,
    ["pattern.json"] = 593,
    ["petstore-v1.0"] = 991,
    pgap_yaml_input_reader = 592,
    ["pixi.toml"] = 594,
    ["plagiarize-me.yaml"] = 598,
    ["plagiarize.yaml"] = 597,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1099,
    ["podbard.yaml"] = 600,
    ["portman.json"] = 603,
    ["prefect.toml"] = 611,
    ["prettierrc.json"] = 612,
    ["prisma.yml"] = 613,
    ["project-1.0.0-beta3.json"] = 622,
    ["project-1.0.0-beta4.json"] = 623,
    ["project-1.0.0-beta5.json"] = 624,
    ["project-1.0.0-beta6.json"] = 625,
    ["project-1.0.0-beta8.json"] = 626,
    ["project-1.0.0-rc1.json"] = 627,
    ["project-1.0.0-rc2.json"] = 628,
    ["project.json"] = 621,
    ["project.owasp.yaml"] = 629,
    ["prometheus-alertmanager.json"] = 633,
    ["prometheus.json"] = 630,
    ["prometheus.rules.json"] = 631,
    ["prometheus.rules.test.json"] = 632,
    ["proxies.json"] = 634,
    ["publiccode.yml"] = 635,
    ["pubspec.yaml"] = 636,
    ["pyrseas-0.8.json"] = 639,
    pytest = 648,
    ["quilt.mod.json"] = 1012,
    ["rc3 auth"] = 654,
    ["rc3 collection"] = 655,
    ...
    ["release drafter"] = 891,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 664,
    ["release-please-manifest.json"] = 665,
    ["release-plz.toml"] = 666,
    ["renv.lock"] = 676,
    ["rivet.json"] = 1036,
    ["rivet.yaml (legacy)"] = 1035,
    rumdl = 681,
    runny = 680,
    rustfmt = 682,
    sake = 1126,
    samt = 684,
    samtrc = 685,
    ["sarif-1.0.0.json"] = 687,
    ["sarif-2.0.0.json"] = 688,
    ["sarif-2.1.0"] = 698,
    ["sarif-2.1.0-rtm.2"] = 689,
    ["sarif-2.1.0-rtm.3"] = 691,
    ["sarif-2.1.0-rtm.4"] = 693,
    ["sarif-2.1.0-rtm.5"] = 695,
    ["sarif-2.1.0-rtm.6"] = 696,
    ["sarif-external-property-file-2.1.0"] = 699,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 690,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 692,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 694,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 697,
    ["scalingo.json configuration"] = 700,
    ["schema.org - Action"] = 702,
    ["schema.org - ContactPoint"] = 703,
    ["schema.org - Place"] = 704,
    ["schema.org - Thing"] = 705,
    ["secrethub.yml"] = 1014,
    ["semantic-release"] = 711,
    ["servicehub.config.json"] = 868,
    ["servicehub.service.json"] = 867,
    ["settings.job"] = 714,
    ["sfdx-hardis configuration"] = 716,
    ["shard.yml"] = 1052,
    ["size-limit configuration"] = 721,
    ["skaffold.yaml"] = 937,
    ["skyuxconfig.json"] = 723,
    ["snowflake-config"] = 725,
    ["snowflake-connections"] = 726,
    ["spicepod.yaml"] = 1072,
    ["sqlc configuration"] = 758,
    ["stripe-app-local.json"] = 769,
    ["stripe-app.json"] = 768,
    swcrc = 922,
    ["task.json"] = 778,
    taskcat = 886,
    ["template.json"] = 783,
    ["templatsources.json"] = 784,
    ["theme.json"] = 787,
    ["tizen_workspace.json"] = 789,
    tldr = 790,
    ["tm_devices configuration file"] = 1137,
    tmuxinator = 871,
    ["transcend.yml"] = 800,
    ["tree-sitter grammar.json"] = 380,
    ["trime.yaml"] = 801,
    ["trunk.yaml"] = 803,
    ["ts-force-config.json"] = 808,
    ["tsconfig.json"] = 804,
    ["tsd.json"] = 805,
    ["tsdoc.json"] = 806,
    ["tsdrc.json"] = 807,
    ...
    v8r = 850,
    vcluster = 1058,
    ["vcpkg configuration file"] = 212,
    ["vcpkg manifest file"] = 211,
    ["vega-lite.json"] = 832,
    ["vega.json"] = 831,
    ["venvironment.yaml"] = 834,
    ["venvplus.yaml"] = 835,
    version = 1119,
    ["version.json"] = 837,
    ["vhwdebugger-binding.yaml"] = 839,
    ["vim-addon-info"] = 840,
    ["vs-2017.3.host.json"] = 842,
    ["vs-nesting.json"] = 843,
    ["vsls.json"] = 841,
    ["vss-extension.json"] = 847,
    vtcfg = 1125,
    ["vtesttree.yaml"] = 848,
    ["vtestunit.yaml"] = 849,
    ["warp-keysets.json"] = 1020,
    ["warp-themes.json"] = 1021,
    ["warp-workflows.json"] = 1022,
    ["webhint.io"] = 977,
    ["webjobpublishsettings.json"] = 854,
    ["webjobs-list.json"] = 853,
    ["well-known-fursona"] = 1059,
    ["xs-app.json"] = 881,
    ["xunit.runner.json"] = 866,
    yamllint = 909,
    zuul = 892,
    ["Žinoma"] = 902
  },
