...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 97,
    [".cryproj (generic)"] = 393,
    [".cryproj engine-5.2"] = 388,
    [".cryproj engine-5.3"] = 389,
    [".cryproj engine-5.4"] = 390,
    [".cryproj engine-5.5"] = 391,
    [".cryproj engine-dev"] = 392,
    [".csscomb.json"] = 99,
    [".csslintrc"] = 100,
    [".eslintrc"] = 134,
    [".esmrc.json"] = 127,
    ...
    [".mtaext"] = 399,
    [".nodehawkrc"] = 238,
    [".npmpackagejsonlintrc"] = 240,
    [".phraseapp.yml"] = 267,
    [".pmbot.yml"] = 260,
    [".postcssrc"] = 265,
    [".pre-commit-config.yml"] = 266,
    [".putout.json"] = 284,
    [".rehyperc"] = 289,
    [".remarkrc"] = 290,
    [".sprite files"] = 325,
    ...
    [".vsext"] = 369,
    [".yarnrc.yml"] = 431,
    ["<div>RIOTS' studio configuration"] = 372,
    ["API Builder"] = 428,
    ...
    ["Azure Pipelines"] = 32,
    ["Azure Static Web Apps CLI configuration file"] = 327,
    ["Azure Static Web Apps configuration file"] = 326,
    ["Better Code Hub"] = 433,
    BizTalkServerApplicationSchema = 405,
    Briefcase = 410,
    Buildkite = 53,
    ...
    ["Drush site aliases"] = 122,
    ["Eclipse Che Devfile"] = 125,
    ["Error pages"] = 130,
    Esquio = 128,
    ["Expo SDK"] = 133,
    ["F-Droid Data metadata"] = 137,
    ["Facets - FSDL - Application"] = 135,
    ["Fossa configuration file"] = 142,
    ["Foundry VTT - Manifest"] = 140,
    ["Foundry VTT - Template"] = 141,
    ["Foxx Manifest"] = 33,
    ["GatewayCore API Gateway"] = 145,
    ["GitHub Action"] = 149,
    ["GitHub Funding"] = 150,
    ["GitHub Issue Template configuration"] = 152,
    ["GitHub Workflow"] = 153,
    ["GitHub Workflow Template Properties"] = 154,
    ["GitHub issue forms"] = 151,
    GitVersion = 148,
    ["Gitpod Configuration"] = 156,
    ["Global Privacy Control"] = 146,
    ["Google Cloud Workflows"] = 86,
    Goreleaser = 159,
    ["Goreleaser Pro"] = 160,
    ["Gradle Build Cache Node"] = 430,
    ["Gradle Enterprise"] = 429,
    ["Grafana 5.x Dashboard"] = 161,
    ["GraphQL Code Generator"] = 164,
    ["GraphQL Config"] = 163,
    ["GraphQL Mesh"] = 162,
    ["Grunt JSHint task"] = 168,
    ["Grunt Watch task"] = 169,
    ["Grunt base task"] = 170,
    ["Grunt clean task"] = 166,
    ["Grunt copy task"] = 165,
    ["Grunt cssmin task"] = 167,
    HEMTT = 402,
    Hadolint = 414,
    ["Hammerkit YAML Schema"] = 440,
    Hayson = 172,
    ["Hazelcast 5 Configuration"] = 173,
    ["Helm Chart.lock"] = 65,
    ["Helm Chart.yaml"] = 64,
    ["JFrog File Spec"] = 186,
    ["JSON Document Transform"] = 194,
    ["JSON Feed"] = 195,
    ["JSON Resume"] = 292,
    ["JSON Schema Draft 2020-12"] = 384,
    ["JSON Schema Draft 4"] = 381,
    ["JSON Schema Draft 7"] = 382,
    ["JSON Schema Draft 8"] = 383,
    ...
    ["JSON-API"] = 193,
    ["JSON-e templates"] = 438,
    ["JSON-stat 2.0"] = 378,
    JSONPatch = 197,
    ["Jekyll configuration"] = 183,
    ["Jenkins X Pipelines"] = 184,
    ["Jenkins X Requirements"] = 185,
    ["Jovo Language Models"] = 187,
    ["KSP-AVC"] = 379,
    ["KSP-CKAN"] = 380,
    Liquibase = 445,
    ["MegaLinter configuration"] = 211,
    ["MegaLinter descriptor"] = 212,
    ["Meltano plugin discovery definition"] = 214,
    ["Meltano project definition"] = 213,
    ["Microsoft Band Web Tile"] = 215,
    ["Minecraft Data Pack Advancement"] = 217,
    ["Minecraft Data Pack Biome"] = 218,
    ["Minecraft Data Pack Configured Carver"] = 219,
    ["Minecraft Data Pack Dimension"] = 221,
    ["Minecraft Data Pack Dimension Type"] = 220,
    ["Minecraft Data Pack Item Modifier"] = 222,
    ["Minecraft Data Pack Loot Table"] = 223,
    ["Minecraft Data Pack Metadata"] = 224,
    ["Minecraft Data Pack Predicate"] = 225,
    ["Minecraft Data Pack Recipe"] = 226,
    ["Minecraft Data Pack Template Pool"] = 227,
    ["Minecraft Resourcepack Sounds"] = 228,
    ["Netin Diagnostic System Template"] = 452,
    ["Netlify config schema"] = 233,
    ["Nightwatch.js"] = 234,
    ["OSS Review Toolkit repository configuration"] = 254,
    Opctl = 401,
    ["OpenWeather Current Weather API"] = 437,
    ["OpenWeather Road Risk API"] = 436,
    ["Ory Hydra configuration"] = 177,
    ["Ory Keto configuration"] = 200,
    ["Ory Kratos configuration"] = 253,
    ["Ory Oathkeeper configuration"] = 245,
    ["Outblocks App configuration"] = 251,
    ["Outblocks database table"] = 252,
    ["Outblocks project configuration"] = 250,
    Packer = 257,
    ["Pipeline component"] = 446,
    ["PocketMine plugin.yml"] = 261,
    ["Pull Request Labeler"] = 283,
    Qodana = 459,
    ["RKE Cluster Configuration JSON Schema"] = 444,
    ["RKE Cluster Configuration YAML Schema"] = 443,
    Ray = 413,
    ["Read the Docs"] = 286,
    ["Red-DiscordBot Cog"] = 287,
    ["Red-DiscordBot Cog Repo"] = 288,
    Renovate = 293,
    RoadRunner = 294,
    SWADL = 336,
    ["Sapphire CLI Config"] = 295,
    ["SauceCTL Configuration"] = 449,
    ["Schema Catalog"] = 308,
    ["Scoop manifest"] = 313,
    ["Semgrep Rule"] = 314,
    ["Serverless Framework Configuration"] = 456,
    ["Settings.paf"] = 316,
    ["Shopware CLI Extension Store Configuration"] = 457,
    ["Shopware CLI Project Store Configuration"] = 458,
    Solidarity = 321,
    ["Source Maps v3"] = 322,
    SpecIF = 323,
    ["Sponge Mixin configuration"] = 324,
    ["StackHawk Scanner Configuration"] = 455,
    ["StackHead CLI config"] = 328,
    ["StackHead module configuration"] = 329,
    ["StackHead project definition"] = 330,
    Stale = 331,
    ["Statamic Blueprint"] = 332,
    ["Stryker Mutator"] = 333,
    ["StyleCop Analyzers Configuration"] = 334,
    ["Swagger API 2.0"] = 337,
    ["Taskfile YAML Schema"] = 439,
    Taurus = 338,
    ["TestEnvironment.json"] = 343,
    ["Traefik v2"] = 345,
    ["Traefik v2 File Provider"] = 346,
    ["UI5 Manifest"] = 358,
    ["Ubuntu Server Autoinstall"] = 356,
    ["Uniswap Token List"] = 422,
    ["User Journey Map YAML Schema"] = 442,
    ["VSCode Code Snippets"] = 76,
    ["VSIX CLI publishing"] = 370,
    ["Vela Pipeline Configuration"] = 362,
    Vercel = 75,
    ["Web App Manifest"] = 374,
    ["Web types"] = 377,
    WebExtensions = 373,
    ["Windows Package Manager Installer Manifest"] = 419,
    ["Windows Package Manager Locale Manifest"] = 420,
    ["Windows Package Manager Singleton Manifest"] = 418,
    ["Woodpecker pipeline config"] = 451,
    ["Yippee-Ki-JSON configuration YML"] = 424,
    ["angular.json"] = 6,
    ...
    devinit = 426,
    ["docfx.json"] = 111,
    ["docker-compose.yml"] = 425,
    ["dotnetcli.host.json"] = 120,
    ["drone.json"] = 121,
    ["dss-2.0.0.json"] = 123,
    ["dvc.yaml"] = 124,
    ["ecosystem.json"] = 126,
    ["electron-builder configuration file."] = 131,
    ["epr-manifest.json"] = 129,
    ["evcc.yaml"] = 132,
    ["fabric.mod.json"] = 136,
    ["first-timers-bot"] = 139,
    fulibWorkflows = 450,
    ["func.yaml"] = 143,
    ["function.json"] = 144,
    ["geojson.json"] = 147,
    ["gitlab-ci"] = 155,
    ["global.json"] = 157,
    ["golangci-lint Configuration"] = 158,
    ["haxelib.json"] = 171,
    helmfile = 415,
    ["host-meta.json"] = 175,
    ["host.json"] = 174,
    ...
    httpmockrc = 406,
    huskyrc = 395,
    ["imageoptimizer.json"] = 178,
    ["importmap.json"] = 180,
    ["ioBroker JSON UI"] = 181,
    ["ioBroker Package manifest"] = 182,
    ["jsconfig.json"] = 198,
    jsdoc = 412,
    ["k3d.yaml"] = 199,
    ["kustomization.yaml"] = 201,
    ["label-commenter-config.yml"] = 202,
    ["launchsettings.json"] = 203,
    ["lerna.json"] = 204,
    ["lgtm.yml"] = 205,
    ["libman.json"] = 206,
    ["license-report-config.json"] = 207,
    ["local.settings.json"] = 208,
    ["localazy.json"] = 209,
    ["lsdlschema.json"] = 210,
    ["markdownlint.json"] = 448,
    mboats = 454,
    ["mimetypes.json"] = 216,
    ["mta.yaml"] = 397,
    ["mtad.yaml"] = 398,
    ["mycode.json"] = 231,
    ["napari plugin manifest"] = 232,
    neoload = 407,
    ["nest-cli"] = 236,
    ["ninjs (News in JSON)"] = 235,
    ["nlu.json"] = 237,
    ["nodemon.json"] = 239,
    ["noodl.schema.json"] = 453,
    now = 403,
    ["nswag.json"] = 243,
    ntangle = 244,
    ["nuclei-template.yaml"] = 241,
    ["nuget-project.json"] = 242,
    ["ocelot.json"] = 246,
    ["omnisharp.json"] = 247,
    ["openapi.json"] = 248,
    ["openfin.json"] = 249,
    ["package.json"] = 255,
    ["package.manifest"] = 256,
    ["pattern.json"] = 259,
    pgap_yaml_input_reader = 258,
    ["plagiarize-me.yaml"] = 263,
    ["plagiarize.yaml"] = 262,
    ["portman.json"] = 264,
    ["prettierrc.json"] = 268,
    ["prisma.yml"] = 269,
    ["project-1.0.0-beta3.json"] = 271,
    ["project-1.0.0-beta4.json"] = 272,
    ["project-1.0.0-beta5.json"] = 273,
    ["project-1.0.0-beta6.json"] = 274,
    ["project-1.0.0-beta8.json"] = 275,
    ["project-1.0.0-rc1.json"] = 276,
    ["project-1.0.0-rc2.json"] = 277,
    ["project.json"] = 270,
    ["prometheus.json"] = 278,
    ["prometheus.rules.json"] = 279,
    ["proxies.json"] = 280,
    ["publiccode.yml"] = 281,
    ["pubspec.yaml"] = 282,
    ["pyrseas-0.8.json"] = 285,
    ["release drafter"] = 408,
    ["sarif-1.0.0.json"] = 296,
    ["sarif-2.0.0.json"] = 297,
    ["sarif-2.1.0"] = 306,
    ["sarif-2.1.0-rtm.2"] = 298,
    ["sarif-2.1.0-rtm.3"] = 300,
    ["sarif-2.1.0-rtm.4"] = 302,
    ["sarif-2.1.0-rtm.5"] = 304,
    ["sarif-external-property-file-2.1.0"] = 307,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 299,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 301,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 303,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 305,
    ["schema.org - Action"] = 309,
    ["schema.org - ContactPoint"] = 310,
    ["schema.org - Place"] = 311,
    ["schema.org - Thing"] = 312,
    ["servicehub.config.json"] = 387,
    ["servicehub.service.json"] = 386,
    ["settings.job"] = 315,
    ["sfdx-hardis configuration"] = 317,
    ["size-limit configuration"] = 318,
    ["skaffold.yaml"] = 447,
    ["skyuxconfig.json"] = 319,
    snapcraft = 320,
    swcrc = 435,
    taskcat = 404,
    ["template.json"] = 339,
    ["templatsources.json"] = 340,
    ["theme.json"] = 341,
    tmLanguage = 342,
    ["trunk.yaml schema"] = 347,
    ["ts-force-config.json"] = 351,
    ["tsconfig.json"] = 348,
    ["tsd.json"] = 349,
    ["tsdrc.json"] = 350,
    ["tslint.json"] = 352,
    ...
    ["version.json"] = 363,
    ["vim-addon-info"] = 364,
    ["vs-2017.3.host.json"] = 366,
    ["vs-nesting.json"] = 367,
    ["vsls.json"] = 365,
    ["vss-extension.json"] = 371,
    ["webjobpublishsettings.json"] = 376,
    ["webjobs-list.json"] = 375,
    ["xs-app.json"] = 400,
    ["xunit.runner.json"] = 385,
    yamllint = 423,
    zuul = 409,
    ["Žinoma"] = 417
  },
