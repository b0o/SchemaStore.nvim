...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 106,
    [".cryproj (generic)"] = 409,
    [".cryproj engine-5.2"] = 404,
    [".cryproj engine-5.3"] = 405,
    [".cryproj engine-5.4"] = 406,
    [".cryproj engine-5.5"] = 407,
    [".cryproj engine-dev"] = 408,
    [".csscomb.json"] = 108,
    [".csslintrc"] = 109,
    [".eslintrc"] = 145,
    [".esmrc.json"] = 138,
    ...
    [".mtaext"] = 415,
    [".nodehawkrc"] = 254,
    [".npmpackagejsonlintrc"] = 256,
    [".phraseapp.yml"] = 283,
    [".pmbot.yml"] = 276,
    [".postcssrc"] = 281,
    [".pre-commit-config.yml"] = 282,
    [".putout.json"] = 300,
    [".rehyperc"] = 305,
    [".remarkrc"] = 306,
    [".sprite files"] = 341,
    ...
    [".vsext"] = 385,
    [".yarnrc.yml"] = 447,
    ["<div>RIOTS' studio configuration"] = 388,
    ["API Builder"] = 444,
    ["AWS CDK cdk.json"] = 95,
    ["AWS CloudFormation"] = 96,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 97,
    ...
    ["Argo Workflows"] = 29,
    ["Avro Avsc"] = 31,
    ["Azure Device Update for IoT Hub import manifest"] = 32,
    ["Azure Device Update for IoT Hub update manifest"] = 33,
    ["Azure IoT Edge deployment"] = 36,
    ["Azure IoT Edge deployment template"] = 37,
    ["Azure IoT EdgeAgent deployment"] = 34,
    ["Azure IoT EdgeHub deployment"] = 35,
    ["Azure Pipelines"] = 38,
    ["Azure Static Web Apps CLI configuration file"] = 343,
    ["Azure Static Web Apps configuration file"] = 342,
    ["Better Code Hub"] = 449,
    BizTalkServerApplicationSchema = 421,
    ["Block Protocol Metadata"] = 65,
    Briefcase = 426,
    ["Build Info"] = 58,
    Buildkite = 60,
    ["Bukkit plugin.yml"] = 59,
    ["BungeeCord plugin.yml"] = 63,
    ["Butane config schema"] = 482,
    ["CMake Presets"] = 66,
    ["CSR Framework"] = 71,
    ["Camel YAML DSL"] = 67,
    Carafe = 68,
    ["Catalog Info Backstage"] = 69,
    Cheatsheets = 480,
    ["Chrome Extension"] = 89,
    ["CircleCI config.yml"] = 74,
    ["Citation File Format"] = 98,
    CityJSON = 70,
    ["Code Climate"] = 75,
    ["Common types for all schemas"] = 1,
    ["Container Structure Test"] = 432,
    Containerlab = 457,
    ["Dart build configuration"] = 110,
    ["Dart test config"] = 111,
    Deno = 115,
    ["Deployer Recipe"] = 118,
    Devfile = 136,
    ["Discord Webhook"] = 120,
    ["Dolittle Artifacts"] = 122,
    ["Dolittle Bounded Context Configuration"] = 123,
    ["Dolittle Event Horizons Configuration"] = 124,
    ["Dolittle Resources Configuration"] = 125,
    ["Dolittle Server Configuration"] = 126,
    ["Dolittle Tenant Map Configuration"] = 128,
    ["Dolittle Tenants Configuration"] = 127,
    ["Dolittle Topology"] = 129,
    ...
    ["Fossa configuration file"] = 153,
    ["Fossa's fossa-deps file"] = 154,
    ["Foundry VTT - Manifest"] = 151,
    ["Foundry VTT - Template"] = 152,
    ["Foxx Manifest"] = 39,
    ["GatewayCore API Gateway"] = 157,
    ["GeoJSON.json latest"] = 484,
    ["GitHub Action"] = 161,
    ["GitHub Funding"] = 162,
    ["GitHub Issue Template configuration"] = 164,
    ["GitHub Workflow"] = 165,
    ["GitHub Workflow Template Properties"] = 166,
    ["GitHub issue forms"] = 163,
    GitVersion = 160,
    ["Gitpod Configuration"] = 168,
    ["Global Privacy Control"] = 158,
    ["Google Cloud Workflows"] = 94,
    Goreleaser = 171,
    ["Goreleaser Pro"] = 172,
    ["Gradle Build Cache Node"] = 446,
    ["Gradle Enterprise"] = 445,
    ["Grafana 5.x Dashboard"] = 173,
    ["GraphQL Code Generator"] = 176,
    ["GraphQL Config"] = 175,
    ["GraphQL Mesh"] = 174,
    ["Grunt JSHint task"] = 180,
    ["Grunt Watch task"] = 181,
    ["Grunt base task"] = 182,
    ["Grunt clean task"] = 178,
    ["Grunt copy task"] = 177,
    ["Grunt cssmin task"] = 179,
    HEMTT = 418,
    Hadolint = 430,
    ["Hammerkit YAML Schema"] = 456,
    Hayson = 184,
    ["Haystack Pipeline"] = 185,
    ["Hazelcast 5 Configuration"] = 186,
    ["Helm Chart.lock"] = 73,
    ["Helm Chart.yaml"] = 72,
    Hugo = 479,
    ["JFrog File Spec"] = 199,
    ["JSON Document Transform"] = 207,
    ["JSON Feed"] = 208,
    ["JSON Resume"] = 308,
    ["JSON Schema Draft 2020-12"] = 400,
    ["JSON Schema Draft 4"] = 397,
    ["JSON Schema Draft 7"] = 398,
    ["JSON Schema Draft 8"] = 399,
    ["JSON schema for CodeShip Pro services configuration files"] = 81,
    ["JSON schema for CodeShip Pro steps configuration files"] = 82,
    ["JSON schema for Codecov configuration files"] = 80,
    ["JSON-API"] = 206,
    ["JSON-e templates"] = 454,
    ["JSON-stat 2.0"] = 394,
    JSONPatch = 210,
    Jekyll = 196,
    ["Jenkins X Pipelines"] = 197,
    ["Jenkins X Requirements"] = 198,
    ["Jovo Language Models"] = 200,
    ["KSP-AVC"] = 395,
    ["KSP-CKAN"] = 396,
    Liquibase = 461,
    Markdownlint = 464,
    ["MegaLinter configuration"] = 226,
    ["MegaLinter descriptor"] = 227,
    ["Meltano plugin discovery definition"] = 229,
    ["Meltano project definition"] = 228,
    ["Microsoft Band Web Tile"] = 230,
    ["Minecraft Data Pack Advancement"] = 232,
    ["Minecraft Data Pack Biome"] = 233,
    ["Minecraft Data Pack Configured Carver"] = 234,
    ["Minecraft Data Pack Dimension"] = 236,
    ["Minecraft Data Pack Dimension Type"] = 235,
    ["Minecraft Data Pack Item Modifier"] = 237,
    ["Minecraft Data Pack Loot Table"] = 238,
    ["Minecraft Data Pack Metadata"] = 239,
    ["Minecraft Data Pack Predicate"] = 240,
    ["Minecraft Data Pack Recipe"] = 241,
    ["Minecraft Data Pack Template Pool"] = 242,
    ["Minecraft Resourcepack Sounds"] = 243,
    ["Netin Diagnostic System Template"] = 468,
    ["Netlify config schema"] = 248,
    ["Nightwatch.js"] = 249,
    ["OSS Review Toolkit repository configuration"] = 270,
    Opctl = 417,
    ["OpenWeather Current Weather API"] = 453,
    ["OpenWeather Road Risk API"] = 452,
    ["Ory Hydra configuration"] = 190,
    ["Ory Keto configuration"] = 214,
    ["Ory Kratos configuration"] = 269,
    ["Ory Oathkeeper configuration"] = 261,
    ["Outblocks App configuration"] = 267,
    ["Outblocks database table"] = 268,
    ["Outblocks project configuration"] = 266,
    Packer = 273,
    ["Pipeline component"] = 462,
    ["PocketMine plugin.yml"] = 277,
    ["Pull Request Labeler"] = 299,
    Qodana = 476,
    ["RKE Cluster Configuration JSON Schema"] = 460,
    ["RKE Cluster Configuration YAML Schema"] = 459,
    Ray = 429,
    ["Read the Docs"] = 302,
    ["Red-DiscordBot Cog"] = 303,
    ["Red-DiscordBot Cog Repo"] = 304,
    Renovate = 309,
    RoadRunner = 310,
    SWADL = 352,
    ["Sapphire CLI Config"] = 311,
    ["SauceCTL Configuration"] = 465,
    ["Schema Catalog"] = 324,
    ["Scoop manifest"] = 329,
    ["Semgrep Rule"] = 330,
    ["Serverless Framework Configuration"] = 472,
    ["Settings.paf"] = 332,
    ["Shopware 6 Configuration"] = 473,
    ["Shopware CLI Extension Store Configuration"] = 474,
    ["Shopware CLI Project Store Configuration"] = 475,
    Solidarity = 337,
    ["Source Maps v3"] = 338,
    SpecIF = 339,
    ["Sponge Mixin configuration"] = 340,
    ["StackHawk Scanner Configuration"] = 471,
    ["StackHead CLI config"] = 344,
    ["StackHead module configuration"] = 345,
    ["StackHead project definition"] = 346,
    Stale = 347,
    ["Statamic Blueprint"] = 348,
    ["Stryker Mutator"] = 349,
    ["StyleCop Analyzers Configuration"] = 350,
    ["Swagger API 2.0"] = 353,
    ["Taskfile YAML Schema"] = 455,
    Taurus = 354,
    ["TestEnvironment.json"] = 359,
    ["Traefik v2"] = 361,
    ["Traefik v2 File Provider"] = 362,
    Tye = 477,
    ["UI5 Manifest"] = 374,
    ["Ubuntu Server Autoinstall"] = 372,
    ["Uniswap Token List"] = 438,
    Updatecli = 483,
    ["User Journey Map YAML Schema"] = 458,
    ["VSCode Code Snippets"] = 84,
    ["VSIX CLI publishing"] = 386,
    ["Vela Pipeline Configuration"] = 378,
    Vercel = 83,
    ["Web App Manifest"] = 390,
    ["Web types"] = 393,
    WebExtensions = 389,
    ["Windows Package Manager Installer Manifest"] = 435,
    ["Windows Package Manager Locale Manifest"] = 436,
    ["Windows Package Manager Singleton Manifest"] = 434,
    ["Woodpecker pipeline config"] = 467,
    ["Xstate Machine Schema"] = 481,
    ["Yippee-Ki-JSON configuration YML"] = 440,
    ["angular.json"] = 8,
    ...
    ["batect.yml"] = 43,
    ["beau.yml"] = 448,
    ["beef-database-codegen"] = 45,
    ["beef-entity-codegen"] = 46,
    ["behat.yml"] = 54,
    ["bigquery-table"] = 47,
    ["bitbucket-pipelines"] = 48,
    bitrise = 49,
    ["bitrise-step"] = 50,
    ["block.json"] = 64,
    ["bower.json"] = 52,
    ["bozr.suite.json"] = 55,
    ["browser.i18n.json"] = 56,
    bucklescript = 57,
    ["bundleconfig.json"] = 62,
    ["chutzpah.json"] = 90,
    ["cloud-sdk-pipeline-config-schema"] = 92,
    ["cloudbuild.json"] = 93,
    cloudify = 78,
    codemagic = 79,
    ["coffeelint.json"] = 99,
    ...
    ["compilerconfig.json"] = 85,
    ["component.json"] = 101,
    ["composer.json"] = 100,
    ["config.json"] = 102,
    ["contentmanifest.json"] = 91,
    ["contribute.json"] = 103,
    ["cosmos.config.json"] = 88,
    ["crowdin.yml"] = 104,
    cspell = 107,
    ["cypress.json"] = 105,
    ["datalogic-scan2deploy-android"] = 112,
    ["datalogic-scan2deploy-ce"] = 113,
    ["debugsettings.json"] = 114,
    ["dependabot-v2.json"] = 117,
    ["dependabot.json"] = 116,
    ["detekt.yml"] = 119,
    devinit = 442,
    ["docfx.json"] = 121,
    ["docker-compose.yml"] = 441,
    ["dotnet Release Index manifest"] = 130,
    ["dotnetcli.host.json"] = 131,
    ["drone.json"] = 132,
    ["dss-2.0.0.json"] = 134,
    ["dvc.yaml"] = 135,
    ["ecosystem.json"] = 137,
    ["electron-builder configuration file."] = 142,
    ["epr-manifest.json"] = 140,
    ["evcc.yaml"] = 143,
    ["fabric.mod.json"] = 147,
    ["first-timers-bot"] = 150,
    fulibWorkflows = 466,
    ["func.yaml"] = 155,
    ["function.json"] = 156,
    ["geojson.json"] = 159,
    ["gitlab-ci"] = 167,
    ["global.json"] = 169,
    ["golangci-lint Configuration"] = 170,
    ["haxelib.json"] = 183,
    helmfile = 431,
    ["host-meta.json"] = 188,
    ["host.json"] = 187,
    ...
    httpmockrc = 422,
    huskyrc = 411,
    ["imageoptimizer.json"] = 191,
    ["importmap.json"] = 193,
    ["ioBroker JSON UI"] = 194,
    ["ioBroker Package manifest"] = 195,
    ["jsconfig.json"] = 211,
    jsdoc = 428,
    ["k3d.yaml"] = 212,
    ["kustomization.yaml"] = 215,
    ["label-commenter-config.yml"] = 216,
    ["launchsettings.json"] = 217,
    ["lerna.json"] = 218,
    ["lgtm.yml"] = 219,
    ["libman.json"] = 220,
    ["license-report-config.json"] = 221,
    ["linkinator.config.json"] = 222,
    ["local.settings.json"] = 223,
    ["localazy.json"] = 224,
    ["lsdlschema.json"] = 225,
    mboats = 470,
    ["mimetypes.json"] = 231,
    ...
    ["mtad.yaml"] = 414,
    ["mycode.json"] = 246,
    ["napari plugin manifest"] = 247,
    neoload = 423,
    ["nest-cli"] = 252,
    ["ninjs (News in JSON) 1.3"] = 251,
    ["ninjs (News in JSON) 2.0"] = 250,
    ["nlu.json"] = 253,
    ["nodemon.json"] = 255,
    ["noodl.schema.json"] = 469,
    now = 419,
    ["nswag.json"] = 259,
    ntangle = 260,
    ["nuclei-template.yaml"] = 257,
    ["nuget-project.json"] = 258,
    ["ocelot.json"] = 262,
    ["omnisharp.json"] = 263,
    ["openapi.json"] = 264,
    ["openfin.json"] = 265,
    ["package.json"] = 271,
    ["package.manifest"] = 272,
    ["pattern.json"] = 275,
    pgap_yaml_input_reader = 274,
    ["plagiarize-me.yaml"] = 279,
    ["plagiarize.yaml"] = 278,
    ["portman.json"] = 280,
    ["prettierrc.json"] = 284,
    ["prisma.yml"] = 285,
    ["project-1.0.0-beta3.json"] = 287,
    ["project-1.0.0-beta4.json"] = 288,
    ["project-1.0.0-beta5.json"] = 289,
    ["project-1.0.0-beta6.json"] = 290,
    ["project-1.0.0-beta8.json"] = 291,
    ["project-1.0.0-rc1.json"] = 292,
    ["project-1.0.0-rc2.json"] = 293,
    ["project.json"] = 286,
    ["prometheus.json"] = 294,
    ["prometheus.rules.json"] = 295,
    ["proxies.json"] = 296,
    ["publiccode.yml"] = 297,
    ["pubspec.yaml"] = 298,
    ["pyrseas-0.8.json"] = 301,
    ["release drafter"] = 424,
    ["sarif-1.0.0.json"] = 312,
    ["sarif-2.0.0.json"] = 313,
    ["sarif-2.1.0"] = 322,
    ["sarif-2.1.0-rtm.2"] = 314,
    ["sarif-2.1.0-rtm.3"] = 316,
    ["sarif-2.1.0-rtm.4"] = 318,
    ["sarif-2.1.0-rtm.5"] = 320,
    ["sarif-external-property-file-2.1.0"] = 323,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 315,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 317,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 319,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 321,
    ["schema.org - Action"] = 325,
    ["schema.org - ContactPoint"] = 326,
    ["schema.org - Place"] = 327,
    ["schema.org - Thing"] = 328,
    ["service.datadog.yaml"] = 213,
    ["servicehub.config.json"] = 403,
    ["servicehub.service.json"] = 402,
    ["settings.job"] = 331,
    ["sfdx-hardis configuration"] = 333,
    ["size-limit configuration"] = 334,
    ["skaffold.yaml"] = 463,
    ["skyuxconfig.json"] = 335,
    snapcraft = 336,
    swcrc = 451,
    taskcat = 420,
    ["template.json"] = 355,
    ["templatsources.json"] = 356,
    ["theme.json"] = 357,
    tmLanguage = 358,
    ["trunk.yaml schema"] = 363,
    ["ts-force-config.json"] = 367,
    ["tsconfig.json"] = 364,
    ["tsd.json"] = 365,
    ["tsdrc.json"] = 366,
    ["tslint.json"] = 368,
    ...
    ["version.json"] = 379,
    ["vim-addon-info"] = 380,
    ["vs-2017.3.host.json"] = 382,
    ["vs-nesting.json"] = 383,
    ["vsls.json"] = 381,
    ["vss-extension.json"] = 387,
    ["webjobpublishsettings.json"] = 392,
    ["webjobs-list.json"] = 391,
    ["xs-app.json"] = 416,
    ["xunit.runner.json"] = 401,
    yamllint = 439,
    zuul = 425,
    ["Žinoma"] = 433
  },
