...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 175,
    [".cryproj (generic)"] = 596,
    [".cryproj engine-5.2"] = 591,
    [".cryproj engine-5.3"] = 592,
    [".cryproj engine-5.4"] = 593,
    [".cryproj engine-5.5"] = 594,
    [".cryproj engine-dev"] = 595,
    [".csscomb.json"] = 177,
    [".csslintrc"] = 178,
    [".es6importsorterrc.json"] = 723,
    [".eslintrc"] = 227,
    [".esmrc.json"] = 219,
    [".ffizer.yaml"] = 231,
    [".htmlhintrc"] = 282,
    ...
    [".pmbot.yml"] = 415,
    [".postcssrc"] = 420,
    [".powerpages-web-template-manifest"] = 422,
    [".pre-commit-config.yml"] = 423,
    [".pre-commit-hooks.yml"] = 424,
    [".putout.json"] = 444,
    [".rehyperc"] = 456,
    [".remarkrc"] = 457,
    [".sprite files"] = 510,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 668,
    ["All Contributors configuration file"] = 722,
    ...
    ["Azure Pipelines"] = 59,
    ["Azure Static Web Apps CLI configuration file"] = 513,
    ["Azure Static Web Apps configuration file"] = 512,
    ["BX CI"] = 95,
    ["Better Code Hub"] = 640,
    ["Better Scripts"] = 96,
    Bigconfig = 76,
    BizTalkServerApplicationSchema = 611,
    Bleep = 97,
    ...
    ["Butane Config"] = 680,
    ["CICS TS region tagging"] = 687,
    ["CICS TS resource import"] = 688,
    ["CICS TS resource model"] = 689,
    ["CICS TS resource overrides"] = 690,
    ["CMake Presets"] = 98,
    ["CNC Codes"] = 108,
    ...
    ["Databricks Asset Bundles"] = 743,
    ["Datadog Service Definition"] = 321,
    ["Datahub Ingestion Recipe"] = 694,
    ["Dein Config"] = 113,
    Deno = 188,
    ["Deployer Recipe"] = 191,
    ["Deta Spacefile"] = 114,
    ...
    ["Goreleaser Pro"] = 264,
    Goss = 265,
    ["Gradle Build Cache Node"] = 638,
    ["Gradle Enterprise"] = 637,
    ...
    Hadolint = 620,
    Hammerkit = 647,
    ["Hardware Sentry Configuration"] = 698,
    Hayson = 277,
    ...
    ["JFrog File Spec"] = 302,
    ["JFrog Pipelines YML DSL"] = 707,
    ["JMeter DSL cli config"] = 303,
    JReleaser = 305,
    ["JSON Document Transform"] = 312,
    ["JSON Feed"] = 313,
    ["JSON Resume"] = 463,
    ["JSON Schema Draft 2020-12"] = 587,
    ["JSON Schema Draft 4"] = 584,
    ["JSON Schema Draft 7"] = 585,
    ["JSON Schema Draft 7 (unofficial strict)"] = 744,
    ["JSON Schema Draft 8 (2019-09)"] = 586,
    ["JSON-API"] = 311,
    ["JSON-e templates"] = 645,
    ["JSON-stat 2.0"] = 581,
    JSONPatch = 315,
    Jasmine = 295,
    Jekyll = 296,
    ...
    Kas = 318,
    ["Keycloak REST API"] = 714,
    ["Knative Functions - func.yaml"] = 242,
    ["KoDE/CI build.yaml"] = 703,
    ["Kong DBLess config"] = 704,
    KrakenD = 320,
    LOOBin = 337,
    Lefthook = 328,
    ["LinkML Metamodel"] = 335,
    Liquibase = 652,
    ["Liquibase Flow File"] = 653,
    ...
    ["MongoDB Atlas Search Index Definition"] = 702,
    ["Monika Configuration"] = 700,
    ["Motif config"] = 604,
    ["NOX Framework (Service)"] = 383,
    ["Netin Diagnostic System Template"] = 662,
    ["Netlify config"] = 374,
    ...
    ["OpenWeather Current Weather API"] = 644,
    ["OpenWeather Road Risk API"] = 643,
    ...
    ["Pipeline component"] = 654,
    ["PocketMine plugin.yml"] = 416,
    ["Postman collection"] = 421,
    ["Problem package generators"] = 428,
    Pterodactyl = 697,
    ["Pull Request Labeler"] = 443,
    Pulumi = 449,
    PyProject = 450,
    Pyright = 451,
    Qgoda = 452,
    Qodana = 673,
    ["Quali Torque Blueprint Spec 2"] = 695,
    ["QueryFirst config file"] = 717,
    ["RKE Cluster Configuration JSON"] = 651,
    ["RKE Cluster Configuration YAML"] = 650,
    ["Rancher Fleet"] = 446,
    Ray = 619,
    ["Read the Docs"] = 448,
    ["Red-DiscordBot Cog"] = 453,
    ["Red-DiscordBot Cog Repo"] = 454,
    ["Red-DiscordBot Trivia"] = 455,
    Renovate = 464,
    ["Replit config"] = 458,
    RoadRunner = 465,
    Ruff = 461,
    ["Rust Project"] = 462,
    ["Rust toolchain"] = 467,
    ["SIL Kit Participant Configuration"] = 498,
    ["SIL Kit Registry Configuration"] = 499,
    SWADL = 522,
    ["Safebox Config"] = 708,
    ["Sapphire CLI Config"] = 470,
    ["SauceCTL Configuration"] = 659,
    ["Schema Catalog"] = 484,
    ["Scoop manifest"] = 489,
    ["Semantic Data Fabric (SDF) file"] = 490,
    ["Semgrep Rule"] = 492,
    ["Serenity Code Generator (Sergen)"] = 493,
    ["Serverless Framework Configuration"] = 667,
    ["Serverless Workflow"] = 669,
    ["Settings.paf"] = 495,
    ["Shopware 6 Configuration"] = 670,
    ["Shopware CLI Extension Store Configuration"] = 671,
    ["Shopware CLI Project Store Configuration"] = 672,
    ["Sigrid scope configuration file"] = 497,
    ["Slack app manifest"] = 501,
    Solidarity = 504,
    ["Solution filters"] = 505,
    ["Source Maps v3"] = 506,
    Sourcery = 507,
    SpecIF = 508,
    ["Sponge Mixin configuration"] = 509,
    ["StackHawk Scanner Configuration"] = 666,
    Stale = 514,
    ["Starlake Data Pipeline"] = 641,
    Starship = 515,
    ["Statamic Blueprint"] = 516,
    ["StrmPrivacy Data Connector"] = 712,
    ["StrmPrivacy Data Contract"] = 713,
    ["StrmPrivacy SimpleSchema"] = 710,
    ["StrmPrivacy Stream"] = 711,
    ["StrmPrivacy batch job configuration file"] = 709,
    ["Stryker Mutator"] = 519,
    ["StyleCop Analyzers Configuration"] = 520,
    ["Swagger API 2.0"] = 523,
    TSON = 547,
    ["Talisman configuration"] = 525,
    ["Taskfile config"] = 646,
    Taurus = 526,
    ["TestEnvironment.json"] = 535,
    ["TextMate Grammar"] = 534,
    ["Tier.run pricing.json"] = 529,
    Tikibase = 530,
    ["Traefik v2"] = 538,
    ["Traefik v2 File Provider"] = 539,
    Turborepo = 536,
    Tye = 674,
    ["UET BuildConfig.json"] = 718,
    ["UI5 Manifest"] = 554,
    ["UTAM Page Object"] = 557,
    ["Ubuntu Server Autoinstall"] = 552,
    ["Uniswap Token List"] = 629,
    ["Unreal Engine Uplugin"] = 719,
    ["Unreal Engine Uproject"] = 720,
    Updatecli = 681,
    Uplift = 716,
    ["User Journey Map"] = 649,
    V2Ray = 685,
    ["VSCode Code Snippets"] = 146,
    ["VSIX CLI publishing"] = 570,
    ["Vela Pipeline Configuration"] = 560,
    Vercel = 145,
    Visivo = 745,
    ["Web App Manifest"] = 577,
    ["Web types"] = 580,
    WebExtensions = 576,
    ["Webman package recipe"] = 691,
    ["Windows Package Manager Installer Manifest"] = 626,
    ["Windows Package Manager Locale Manifest"] = 627,
    ["Windows Package Manager Singleton Manifest"] = 625,
    ["Woodpecker pipeline config"] = 661,
    ["Xstate Machine"] = 679,
    ["Yippee-Ki-JSON configuration YML"] = 631,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 70,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 727,
    ["bashly-strings.yml"] = 728,
    ["bashly.yml"] = 726,
    ["batect.yml"] = 69,
    ...
    ["lsdlschema.json"] = 341,
    ["madness.yml"] = 725,
    ["markdown-lint-check"] = 657,
    mboats = 664,
    ["micro-settings.json"] = 730,
    ["mimetypes.json"] = 348,
    ["mirrord config"] = 601,
    ["mta.yaml"] = 602,
    ["mtad.yaml"] = 603,
    ...
    ["plagiarize-me.yaml"] = 418,
    ["plagiarize.yaml"] = 417,
    ["portman.json"] = 419,
    ["prettierrc.json"] = 426,
    ["prisma.yml"] = 427,
    ["project-1.0.0-beta3.json"] = 430,
    ["project-1.0.0-beta4.json"] = 431,
    ["project-1.0.0-beta5.json"] = 432,
    ["project-1.0.0-beta6.json"] = 433,
    ["project-1.0.0-beta8.json"] = 434,
    ["project-1.0.0-rc1.json"] = 435,
    ["project-1.0.0-rc2.json"] = 436,
    ["project.json"] = 429,
    ["prometheus.json"] = 437,
    ["prometheus.rules.json"] = 438,
    ["prometheus.rules.test.json"] = 439,
    ["proxies.json"] = 440,
    ["publiccode.yml"] = 441,
    ["pubspec.yaml"] = 442,
    ["pyrseas-0.8.json"] = 445,
    ["quilt.mod.json"] = 731,
    ["release drafter"] = 614,
    rtx = 460,
    rustfmt = 466,
    samt = 468,
    samtrc = 469,
    ["sarif-1.0.0.json"] = 471,
    ["sarif-2.0.0.json"] = 472,
    ["sarif-2.1.0"] = 482,
    ["sarif-2.1.0-rtm.2"] = 473,
    ["sarif-2.1.0-rtm.3"] = 475,
    ["sarif-2.1.0-rtm.4"] = 477,
    ["sarif-2.1.0-rtm.5"] = 479,
    ["sarif-2.1.0-rtm.6"] = 480,
    ["sarif-external-property-file-2.1.0"] = 483,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 474,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 476,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 478,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 481,
    ["schema.org - Action"] = 485,
    ["schema.org - ContactPoint"] = 486,
    ["schema.org - Place"] = 487,
    ["schema.org - Thing"] = 488,
    ["scikit-build"] = 665,
    ["secrethub.yml"] = 733,
    ["semantic-release"] = 491,
    ["servicehub.config.json"] = 590,
    ["servicehub.service.json"] = 589,
    ["settings.job"] = 494,
    ["sfdx-hardis configuration"] = 496,
    ["size-limit configuration"] = 500,
    ["skaffold.yaml"] = 655,
    ["skyuxconfig.json"] = 502,
    snapcraft = 503,
    ["sqlc configuration"] = 511,
    ["stripe-app-local.json"] = 518,
    ["stripe-app.json"] = 517,
    swcrc = 642,
    syntax = 735,
    ["task.json"] = 524,
    taskcat = 610,
    ["template.json"] = 527,
    ["templatsources.json"] = 528,
    ["theme.json"] = 531,
    ["tizen_workspace.json"] = 532,
    tldr = 533,
    tmuxinator = 598,
    ["transcend.yml"] = 540,
    ["trunk.yaml"] = 541,
    ["ts-force-config.json"] = 545,
    ["tsconfig.json"] = 542,
    ["tsd.json"] = 543,
    ["tsdrc.json"] = 544,
    ["tslint.json"] = 546,
    ...
    ["vega-lite.json"] = 559,
    ["vega.json"] = 558,
    ["venvironment-basic.yaml"] = 562,
    ["venvironment.yaml"] = 561,
    ["version.json"] = 563,
    ["vim-addon-info"] = 564,
    ["vs-2017.3.host.json"] = 566,
    ["vs-nesting.json"] = 567,
    ["vsls.json"] = 565,
    ["vss-extension.json"] = 571,
    ["vtesttree.yaml"] = 572,
    ["vtestunit.yaml"] = 573,
    ["warp-keysets.json"] = 739,
    ["warp-themes.json"] = 740,
    ["warp-workflows.json"] = 741,
    ["webhint.io"] = 692,
    ["webjobpublishsettings.json"] = 579,
    ["webjobs-list.json"] = 578,
    ["xs-app.json"] = 606,
    ["xunit.runner.json"] = 588,
    yamllint = 630,
    zuul = 615,
    ["Žinoma"] = 624
  },
