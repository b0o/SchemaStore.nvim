...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 925,
    [".nodehawkrc"] = 572,
    [".npmpackagejsonlintrc"] = 576,
    [".omletrc"] = 1104,
    [".phrase.yml"] = 647,
    [".phraseapp.yml"] = 648,
    [".pmbot.yml"] = 633,
    [".postcssrc"] = 642,
    [".powerpages-web-template-manifest"] = 644,
    [".pre-commit-config.yml"] = 645,
    [".pre-commit-hooks.yml"] = 646,
    [".putout.json"] = 681,
    [".rehyperc"] = 706,
    [".remarkrc"] = 710,
    [".sprite files"] = 801,
    ...
    AIConfig = 31,
    ["AMX Muse Program Descriptor"] = 1152,
    ["API Builder"] = 960,
    ["AVA Configuration"] = 1023,
    ...
    ["AWS Copilot Manifest"] = 1191,
    ["AWS SAM CLI Samconfig"] = 256,
    ["Adobe UXP Manifest"] = 1086,
    ["Aerleon Network & Service Definitions"] = 18,
    ["Aerleon Policy"] = 19,
    Aider = 1181,
    Air = 21,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1202,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1201,
    ["Airlock Microgateway"] = 32,
    ["Alacritty Configuration"] = 995,
    ["All Contributors configuration file"] = 1049,
    ...
    ["Application list for a WinUtil"] = 1131,
    ArchitectFX = 1136,
    ["Argo CD"] = 51,
    ["Argo Events"] = 52,
    ["Argo Workflows"] = 53,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1200,
    ["Azure IoT Operations connector metadata"] = 1197,
    ...
    ["Azure Pipelines"] = 107,
    ["Azure Static Web Apps CLI configuration file"] = 805,
    ["Azure Static Web Apps configuration file"] = 804,
    BMML = 1219,
    ["BOSH CPI Config"] = 132,
    ["BOSH Deploy Config"] = 133,
    ["BX CI"] = 152,
    ["Bacon config"] = 3,
    ["Bashly (bashly.yml)"] = 1053,
    ["Bashly Settings (bashly-settings.yml)"] = 1054,
    Bento = 1218,
    ["Better Code Hub"] = 965,
    ["Better Scripts"] = 153,
    Bigconfig = 125,
    ["Biome Formatter Config"] = 79,
    ["Bitmovin Encoding Template"] = 1145,
    BizTalkServerApplicationSchema = 932,
    Bleep = 154,
    ["Block Protocol Metadata"] = 151,
    ["Bluebricks blueprint config"] = 1224,
    ["Boyka Framework"] = 134,
    Briefcase = 938,
    ["Build Info"] = 142,
    Buildkite = 144,
    ...
    ["Butane Config"] = 1008,
    C4InterFlow = 1160,
    ["CDK Environment Manager, concrete environment configuration"] = 1184,
    ["CDK Environment Manager, concrete environments definition"] = 1183,
    ["CDK Environment Manager, environment definition"] = 1182,
    ["CGS Card Game Specification (cgs.json)"] = 1091,
    ["CICS TS region tagging"] = 1017,
    ["CICS TS resource import"] = 1018,
    ["CICS TS resource model"] = 1019,
    ["CICS TS resource overrides"] = 1020,
    ["CMake Presets"] = 155,
    ["CNC Codes"] = 177,
    ["CRS WAF test file"] = 1121,
    ["CRS WAF test platform overrides file"] = 1122,
    ...
    ["Chamaleon environment"] = 1149,
    ["Chamaleon properties"] = 1150,
    ["Chamaleon template"] = 1148,
    Changepacks = 1211,
    Changesets = 265,
    Changie = 164,
    Charmcraft = 165,
    ...
    ["Clawject config"] = 183,
    ["Cloud Foundry Application Manifest"] = 1103,
    ["Cloud Run Spec v1"] = 1126,
    ...
    Concord = 1120,
    ["Configu .cfgu files"] = 1108,
    ["Configu .configu file"] = 1109,
    Conjure = 176,
    ["Container Structure Test"] = 946,
    Containerlab = 974,
    ["Contextive Glossary"] = 1176,
    Convex = 175,
    ["Crowdsec collection config"] = 275,
    ["Crowdsec parser config"] = 276,
    ["Crowdsec scenario config"] = 277,
    ["CumulusCI Config"] = 182,
    ["Custom Machinery Machine"] = 1092,
    ["Custom Machinery Recipe"] = 1093,
    ...
    ["DonateCaseBetterCasino menu"] = 1153,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1061,
    ["EAS config"] = 344,
    ["ECA - Editor Code Assistant"] = 328,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1050,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1196,
    ["EasyVCR .NET"] = 345,
    ["Eidolon Resource"] = 1137,
    ...
    ["Erda Pipeline"] = 1099,
    ["Erda Runtime"] = 1100,
    ["Espanso config.yml"] = 1222,
    ["Espanso match.yml"] = 1221,
    Esquio = 333,
    ["Estuary Flow Catalog"] = 1014,
    ...
    ["Evolving Resolutive Process notation"] = 1198,
    ["Expo SDK"] = 343,
    ...
    ["GeoJSON.json latest"] = 1012,
    GherKing = 1016,
    ["GitHub Action"] = 378,
    ["GitHub Actions typing"] = 1133,
    ...
    ["Google Digital Assetlinks"] = 1177,
    Goreleaser = 406,
    ["Goreleaser Pro"] = 407,
    Goss = 408,
    ["Gradle Build Cache Node"] = 963,
    ["Gradle Enterprise"] = 962,
    ...
    Hadolint = 942,
    Hammerkit = 973,
    ["Hardware Sentry Configuration"] = 1028,
    ["HashiCorp Vault"] = 422,
    Hatch = 943,
    Hayson = 424,
    ["Haystack Pipeline"] = 425,
    ["Hazelcast 5 Configuration"] = 426,
    ["Hecate Input Schema"] = 1188,
    ["Helm Chart.lock"] = 219,
    ["Helm Chart.yaml"] = 218,
    ...
    ["JFrog File Spec"] = 459,
    ["JFrog Pipelines YML DSL"] = 1038,
    ["JMeter DSL cli config"] = 460,
    JReleaser = 463,
    ["JSON Document Transform"] = 471,
    ["JSON Feed"] = 472,
    ["JSON Resume"] = 716,
    ["JSON Schema Draft 2020-12"] = 910,
    ["JSON Schema Draft 4"] = 907,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1071,
    ["JSON Schema Draft 7"] = 908,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1072,
    ["JSON Schema Draft 8 (2019-09)"] = 909,
    ["JSON-API"] = 470,
    ["JSON-e templates"] = 970,
    ["JSON-stat 2.0"] = 903,
    JSONPatch = 474,
    ...
    ["Jujutsu (jj) VCS config"] = 1190,
    ["KIMMDY config file"] = 485,
    ["KODE/CI build.yaml"] = 1034,
    ["KSP-AVC"] = 904,
    ["KSP-CKAN"] = 905,
    ["KSP-NetKAN"] = 906,
    KSY = 1101,
    ...
    ["Lando (landofile)"] = 103,
    ["LangGraph Platform configuration"] = 1113,
    ["Language configuration"] = 1112,
    Lefthook = 500,
    ["Liferay client-extension.yaml"] = 507,
    ["LinkML Metamodel"] = 509,
    Liquibase = 979,
    ["Liquibase Flow File"] = 980,
    ["Lively Properties"] = 510,
    ["Lobe AI Agent"] = 105,
    Loki = 106,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 551,
    ["MS2Rescore Configuration"] = 555,
    ["Madness (madness.yml)"] = 1052,
    ["Mado configuration"] = 517,
    ["Mail Servers Configuration"] = 1225,
    ["MapEHR Mapping"] = 518,
    Markdownlint = 983,
    ["Mason Registry"] = 986,
    ...
    ["Mergify Configuration"] = 556,
    ["Metadata for a Bazel module"] = 524,
    ["Metadata for a Cinnamon spice"] = 1129,
    ["Metatype Configuration"] = 525,
    ["MetricsHub Configuration"] = 526,
    ["MetricsHub Connector Configuration"] = 527,
    ["Micro Editor Syntax"] = 1062,
    ["Microsoft Band Web Tile"] = 528,
    ["Microsoft RulesEngine workflow rules"] = 1117,
    ["Microsoft RulesEngine workflow rules list"] = 1118,
    ["Minecraft Custom Main Menu Mod"] = 1080,
    ...
    ["Monade CLI Stack Configuration"] = 559,
    ["MongoDB Atlas Search Index Definition"] = 1033,
    ["Monika Configuration"] = 1031,
    ["Monoweave Configuration"] = 554,
    ["Motif config"] = 924,
    MultiQC = 1170,
    ["NOX Framework (Service)"] = 575,
    ["Netin Diagnostic System Template"] = 990,
    ["Netlify config"] = 562,
    ["Network-as-Code Data Model"] = 563,
    ["Next Gen UI Agent A2A Server Configuration"] = 564,
    ["Next Gen UI Agent Configuration"] = 566,
    ["Next Gen UI Agent MCP Server Configuration"] = 565,
    ["Nightwatch.js"] = 568,
    ["Node.js configuration"] = 929,
    ["NueJS configuration file"] = 580,
    ["Nuitka.yaml"] = 1094,
    ["Nullstone config"] = 582,
    ["ONe's changelog entry"] = 600,
    ["ONe's service descriptor"] = 599,
    ["ORT Server repository environment configuration"] = 609,
    ["OSCAL Assessment Plan (AP)"] = 611,
    ["OSCAL Assessment Results (AR)"] = 612,
    ["OSCAL Catalog"] = 613,
    ["OSCAL Component Definition (CDef)"] = 614,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 615,
    ["OSCAL Profile"] = 616,
    ["OSCAL System Security Plan (SSP)"] = 617,
    ["OSS Review Toolkit configuration"] = 618,
    ["OSS Review Toolkit curation"] = 619,
    ["OSS Review Toolkit package configuration"] = 620,
    ["OSS Review Toolkit repository configuration"] = 621,
    ["OSS Review Toolkit resolutions"] = 622,
    ["October CMS columns"] = 586,
    ["October CMS fields"] = 587,
    ["Oh My Posh"] = 588,
    Okteto = 589,
    ["Ona Automations"] = 591,
    Opctl = 927,
    ["Open Data Contract Standard (ODCS)"] = 603,
    ["Open Data Product Standard (ODPS)"] = 604,
    ["Open Know-How"] = 1175,
    ["OpenRewrite Resource"] = 602,
    OpenSRM = 605,
    OpenStatus = 1186,
    ["OpenUtau character yaml"] = 596,
    ["OpenUtau ustx"] = 597,
    ["OpenWeather Current Weather API"] = 969,
    ["OpenWeather Road Risk API"] = 968,
    ["Ory Hydra configuration"] = 433,
    ["Ory Keto configuration"] = 493,
    ["Ory Kratos configuration"] = 610,
    ["Ory Oathkeeper configuration"] = 584,
    ["Outblocks App configuration"] = 607,
    ["Outblocks database table"] = 608,
    ["Outblocks project configuration"] = 606,
    PDM = 629,
    POPxf = 639,
    ["POPxf Correlations"] = 640,
    Packer = 626,
    Pantsbuild = 1048,
    ["Paper paper-plugin.yml"] = 627,
    ["Pipeline component"] = 981,
    ["Platform.sh application"] = 5,
    ["Platform.sh routes"] = 6,
    ["Platform.sh services"] = 7,
    ["Plex Prerolls"] = 637,
    ["PocketMine plugin.yml"] = 634,
    ["Postman collection"] = 643,
    ["Power Pages Configuration"] = 1187,
    ["Preset list for a WinUtil"] = 1132,
    ["ProActions AI-Kit Configuration"] = 654,
    ["ProActions AI-Kit Configuration for Menus"] = 656,
    ["ProActions AI-Kit Configuration for Sections"] = 658,
    ["ProActions AI-Kit Configuration for Services"] = 655,
    ["ProActions AI-Kit Configuration for Steps"] = 659,
    ["ProActions AI-Kit Configuration for Templates"] = 657,
    ["Problem object RFC9457"] = 1077,
    ["Problem package format"] = 660,
    ["Problem package generators"] = 661,
    ["Problem package submissions"] = 662,
    ["Problem package test group metadata"] = 663,
    Pterodactyl = 1027,
    ["Pull Request Labeler"] = 680,
    Pulumi = 688,
    ["PyGTA Config"] = 684,
    PyProject = 689,
    Pylock = 1178,
    Pyright = 690,
    ["Python script metadata"] = 1172,
    ["QType AI DSL"] = 693,
    Qgoda = 692,
    Qodana = 1000,
    ["Qt Creator workspace file"] = 1110,
    ["Quali Torque Blueprint Spec 2"] = 1025,
    ["QueryFirst config file"] = 1044,
    ["RKE Cluster Configuration JSON"] = 978,
    ["RKE Cluster Configuration YAML"] = 977,
    RadioHound = 683,
    Railpack = 695,
    Railway = 694,
    ["Rancher Fleet"] = 685,
    ...
    Ray = 941,
    ["Read the Docs"] = 687,
    ["Red-DiscordBot Cog"] = 703,
    ["Red-DiscordBot Cog Repo"] = 704,
    ["Red-DiscordBot Trivia"] = 705,
    ["Releasaurus Config"] = 2,
    ["Render Blueprints"] = 976,
    RenderCV = 720,
    Renovate = 717,
    ["Renovate global configuration"] = 718,
    ["Renovate inherited configuration"] = 719,
    ["Replit config"] = 711,
    Restate = 1165,
    ["Revel Digital Gadget Definition File"] = 1189,
    RoadRunner = 722,
    ["Robust Station Image"] = 1195,
    Rockcraft = 723,
    ["Roo Coder Custom Modes"] = 724,
    Rubocop = 713,
    ["Rudder techniques"] = 1084,
    Ruff = 714,
    ["Rust Project"] = 715,
    ["Rust toolchain"] = 728,
    ["SDMX data message"] = 754,
    ["SDMX metadata message"] = 753,
    ["SDMX structure message"] = 752,
    ["SIL Kit Participant Configuration"] = 764,
    ["SIL Kit Registry Configuration"] = 765,
    ["SPDX 2.3"] = 802,
    SWADL = 818,
    ["Safebox Config"] = 1039,
    ["Sapphire CLI Config"] = 731,
    ["SauceCTL Configuration"] = 987,
    ["Schema Catalog"] = 746,
    ["Scoop manifest"] = 751,
    ["Semantic Data Fabric (SDF) file"] = 755,
    ["Semgrep Rule"] = 757,
    ["Serenity Code Generator (Sergen)"] = 758,
    ["Serverless Framework Configuration"] = 994,
    ["Serverless Workflow"] = 996,
    ["Settings for a Cinnamon spice"] = 1128,
    ["Settings.paf"] = 760,
    ["Shopware 6 Configuration"] = 997,
    ["Shopware CLI Extension Store Configuration"] = 998,
    ["Shopware CLI Project Store Configuration"] = 999,
    ["Sigma Detection Rule"] = 762,
    ["Sigrid scope configuration file"] = 763,
    ["SkyPilot Task JSON"] = 1085,
    ["Slack app manifest"] = 767,
    Snapcraft = 769,
    Solidarity = 772,
    ["Solution filters"] = 773,
    ["Source Maps v3"] = 774,
    Sourcery = 775,
    ["Spack bootstrap.yaml"] = 776,
    ["Spack cdash.yaml"] = 777,
    ["Spack ci.yaml"] = 778,
    ["Spack compilers.yaml"] = 779,
    ["Spack concretizer.yaml"] = 780,
    ["Spack config.yaml"] = 781,
    ["Spack definitions.yaml"] = 782,
    ["Spack develop.yaml"] = 783,
    ["Spack env_vars.yaml"] = 784,
    ["Spack environment"] = 790,
    ["Spack include.yaml"] = 785,
    ["Spack mirrors.yaml"] = 786,
    ["Spack modules.yaml"] = 787,
    ["Spack packages.yaml"] = 788,
    ["Spack repos.yaml"] = 789,
    ["Spack toolchains.yaml"] = 791,
    ["Spack upstreams.yaml"] = 792,
    ["Spack view.yaml"] = 793,
    ["Speakeasy Generation Config File"] = 797,
    ["Speakeasy Lint Configuration File"] = 794,
    ["Speakeasy Test Generation Configuration File"] = 795,
    ["Speakeasy Workflow File"] = 796,
    SpecIF = 798,
    ["Specmatic Configuration"] = 799,
    ["Sponge Mixin configuration"] = 800,
    StackBlitz = 806,
    ["StackHawk Scanner Configuration"] = 993,
    Stale = 807,
    Starfish = 808,
    ["Starlake Data Pipeline"] = 966,
    Starship = 809,
    ["Statamic Blueprint"] = 810,
    ["Stella configuration file"] = 811,
    ["Streamlit configuration file"] = 812,
    ["Stryker Mutator"] = 815,
    ["StyleCop Analyzers Configuration"] = 816,
    ["Stylelint (.stylelintrc)"] = 817,
    ["Stylua Config"] = 1179,
    ["Sublime Syntax"] = 1040,
    ["Subsquid squid manifest"] = 1087,
    ["Swagger API 2.0"] = 819,
    ["Synadia Connect Component"] = 820,
    TSON = 856,
    TSTyche = 857,
    ["TYPO3 Vendor Bundler config"] = 862,
    ["Tab data for a LinUtil"] = 1135,
    ["Tab list for a LinUtil"] = 1134,
    Tach = 821,
    ["Tach Domain"] = 822,
    Talhelper = 824,
    ["Talisman configuration"] = 825,
    Taplo = 1180,
    ["Taskfile config"] = 971,
    Taurus = 826,
    Tauticord = 827,
    ["Tekton Pipeline"] = 1208,
    ["Tekton PipelineRun"] = 1209,
    ["Tekton Task"] = 1206,
    ["Tekton TaskRun"] = 1207,
    Telefonistka = 1166,
    ["Terrateam config"] = 1192,
    ["TestEnvironment.json"] = 839,
    ["TextMate Grammar"] = 838,
    Threagile = 833,
    ["Tier.run pricing.json"] = 830,
    Tikibase = 831,
    Tombi = 836,
    ["Traefik v2"] = 842,
    ["Traefik v2 File Provider"] = 843,
    ["Traefik v3"] = 844,
    ["Traefik v3 File Provider"] = 845,
    ["Travis CI (.travis.yml)"] = 841,
    Treefmt = 411,
    Trident = 1162,
    ["TrueScript for *.tscript files"] = 848,
    ["Tugboat QA config.yml"] = 1159,
    TunnelHub = 1075,
    Turborepo = 840,
    Tycho = 1124,
    Tye = 1001,
    ["Tyk Gateway - Open Source v5.7+"] = 1171,
    ["UET BuildConfig.json"] = 1045,
    ["UI5 Manifest"] = 868,
    ["UNCORS configuration"] = 872,
    ["UTAM Page Object"] = 871,
    ["Ubuntu Server Autoinstall"] = 866,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1163,
    ["Uniswap Token List"] = 953,
    ["Universal Schedule Format"] = 873,
    ["Unreal Engine Uplugin"] = 1046,
    ["Unreal Engine Uproject"] = 1047,
    ["UpCloud CLI (upctl) configuration"] = 1164,
    ["Updatecli Compose"] = 1009,
    ["Updatecli Policy Manifest"] = 1010,
    ["Updatecli Policy Metadata"] = 1011,
    Uplift = 1043,
    ["Upsun config"] = 4,
    ["User Journey Map"] = 975,
    V2Ray = 1015,
    ["VSCode Code Snippets"] = 240,
    ["VSIX CLI publishing"] = 891,
    Vector = 875,
    ["Vela Pipeline Configuration"] = 878,
    Vercel = 239,
    ["Version Bumper config"] = 881,
    Vespertide = 1213,
    ["Vespertide Migration"] = 1214,
    ["Vespertide Model"] = 1215,
    ["Viash Component Config"] = 1168,
    ["Viash Package Config"] = 1169,
    Visivo = 1073,
    ["WP-CLI"] = 901,
    Wake = 1161,
    ["Waku Config"] = 1138,
    ["Web App Manifest"] = 897,
    ["Web types"] = 900,
    WebExtensions = 896,
    ["Webman package recipe"] = 1021,
    ["Windows Package Manager Installer Manifest"] = 949,
    ["Windows Package Manager Locale Manifest"] = 950,
    ["Windows Package Manager Singleton Manifest"] = 948,
    Winutil = 951,
    ["WireMock CLI import configuration"] = 1144,
    ["WireMock CLI local service configuration"] = 1143,
    ["WireMock message stub mapping"] = 1142,
    ["WireMock stub mapping"] = 1141,
    ["Woodpecker pipeline config"] = 989,
    ["Wrangler CLI"] = 902,
    ["Xstate Machine"] = 1007,
    ["Yandex Workflow Language"] = 1130,
    ["Yarn Config (.yarnrc.yml)"] = 964,
    ["Yippee-Ki-JSON configuration YML"] = 955,
    ["YouTrack App"] = 1127,
    ["Zarf Package Configuration"] = 1194,
    ["Zerops.io config"] = 1115,
    ["Zerops.io import"] = 1116,
    ["Zola Configuration"] = 1205,
    ["aerleon.yml"] = 17,
    ["amplify.yml"] = 10,
    ["angular.json"] = 33,
    apko = 1078,
    ...
    ["behat.yml"] = 135,
    ["bigquery-table"] = 124,
    ["bioimageio resource description"] = 1095,
    ...
    ["chutzpah.json"] = 248,
    cibuildwheel = 170,
    ["clang-format (.clang-format)"] = 1013,
    ["clang-tidy"] = 226,
    clangd = 225,
    clib = 227,
    ...
    ["crowdin.yml"] = 274,
    ["ctfd-setup configuration file"] = 1151,
    ["custom-elements.json"] = 1065,
    ["cypress.json"] = 278,
    ...
    ["gematik health care insurance list"] = 1157,
    ["gematik health care patient list"] = 1154,
    ["gematik health care provider institution list"] = 1156,
    ["gematik health care provider list"] = 1155,
    ["gematik tiger test environment configuration"] = 1158,
    ["git-town.toml"] = 1203,
    ["gitlab-ci"] = 386,
    ["global.json"] = 402,
    ...
    ["lint-staged (.lintstagedrc)"] = 918,
    ["local.settings.json"] = 513,
    ["localazy.json"] = 514,
    ["lotus.yaml"] = 512,
    ["lsdlschema.json"] = 515,
    ["macro.json"] = 1030,
    ["markdown-link-check"] = 984,
    maturin = 985,
    mboats = 992,
    ["micro-settings.json"] = 1057,
    ["mimetypes.json"] = 529,
    ["mirrord config"] = 920,
    mise = 921,
    ["mkdocs.yml"] = 549,
    ...
    ["monospace.yml"] = 553,
    ["moon.yml"] = 1140,
    ["mprocs Configuration file"] = 1111,
    ["mrdocs.yml"] = 550,
    ["mta.yaml"] = 922,
    ["mtad.yaml"] = 923,
    ["mycode.json"] = 560,
    nFPM = 567,
    ["napari plugin manifest"] = 561,
    neoload = 935,
    ["nest-cli"] = 570,
    ["ninjs (News in JSON)"] = 569,
    ["nitro.json"] = 934,
    ["nixd configuration"] = 1083,
    ["nlu.json"] = 571,
    ["nodemon.json"] = 573,
    ["noodl config"] = 991,
    ["notebook.mod.json"] = 574,
    now = 930,
    ["npm-badges"] = 577,
    ["nswag.json"] = 581,
    ntangle = 583,
    ["nuclei-template.yaml"] = 578,
    ["nuget-project.json"] = 579,
    ["ocelot.json"] = 585,
    ["omnisharp.json"] = 590,
    openHAB = 1216,
    ["openapi.json"] = 592,
    ...
    oxlint = 1227,
    ["package.json"] = 623,
    ["package.manifest"] = 625,
    ["package.yaml"] = 624,
    ["partial-black.json"] = 136,
    ["pathfinder.yml"] = 628,
    ["pattern.json"] = 631,
    ["petstore-v1.0"] = 1037,
    pgap_yaml_input_reader = 630,
    pgxgen = 1220,
    pitcms = 1223,
    ["pixi.toml"] = 632,
    ["plagiarize-me.yaml"] = 636,
    ["plagiarize.yaml"] = 635,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1147,
    ["podbard.yaml"] = 638,
    ["portman.json"] = 641,
    ["prefect.toml"] = 649,
    ["prefect.yaml"] = 650,
    ...
    ["prettierrc.json"] = 652,
    ["prisma.yml"] = 653,
    ["project-1.0.0-beta3.json"] = 665,
    ["project-1.0.0-beta4.json"] = 666,
    ["project-1.0.0-beta5.json"] = 667,
    ["project-1.0.0-beta6.json"] = 668,
    ["project-1.0.0-beta8.json"] = 669,
    ["project-1.0.0-rc1.json"] = 670,
    ["project-1.0.0-rc2.json"] = 671,
    ["project.json"] = 664,
    ["project.owasp.yaml"] = 672,
    ["prometheus-alertmanager.json"] = 676,
    ["prometheus.json"] = 673,
    ["prometheus.rules.json"] = 674,
    ["prometheus.rules.test.json"] = 675,
    ["proxies.json"] = 677,
    ["publiccode.yml"] = 678,
    ["pubspec.yaml"] = 679,
    ["pyrseas-0.8.json"] = 682,
    pytest = 691,
    ["quilt.mod.json"] = 1058,
    ["rc3 auth"] = 697,
    ["rc3 collection"] = 698,
    ...
    ["release drafter"] = 936,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 707,
    ["release-please-manifest.json"] = 708,
    ["release-plz.toml"] = 709,
    ["renv.lock"] = 721,
    ["rivet.json"] = 1082,
    ["rivet.yaml (legacy)"] = 1081,
    rumdl = 726,
    runny = 725,
    rustfmt = 727,
    sake = 1174,
    samt = 729,
    samtrc = 730,
    ["sarif-1.0.0.json"] = 732,
    ["sarif-2.0.0.json"] = 733,
    ["sarif-2.1.0"] = 743,
    ["sarif-2.1.0-rtm.2"] = 734,
    ["sarif-2.1.0-rtm.3"] = 736,
    ["sarif-2.1.0-rtm.4"] = 738,
    ["sarif-2.1.0-rtm.5"] = 740,
    ["sarif-2.1.0-rtm.6"] = 741,
    ["sarif-external-property-file-2.1.0"] = 744,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 735,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 737,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 739,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 742,
    ["scalingo.json configuration"] = 745,
    ["schema.org - Action"] = 747,
    ["schema.org - ContactPoint"] = 748,
    ["schema.org - Place"] = 749,
    ["schema.org - Thing"] = 750,
    ["secrethub.yml"] = 1060,
    ["semantic-release"] = 756,
    ["servicehub.config.json"] = 913,
    ["servicehub.service.json"] = 912,
    ["settings.job"] = 759,
    ["sfdx-hardis configuration"] = 761,
    ["shard.yml"] = 1098,
    ["size-limit configuration"] = 766,
    ["skaffold.yaml"] = 982,
    ["skyuxconfig.json"] = 768,
    ["snowflake-config"] = 770,
    ["snowflake-connections"] = 771,
    ["spicepod.yaml"] = 1119,
    ["sqlc configuration"] = 803,
    ["stripe-app-local.json"] = 814,
    ["stripe-app.json"] = 813,
    swcrc = 967,
    ["task.json"] = 823,
    taskcat = 931,
    ...
    tldr = 835,
    ["tm_devices configuration file"] = 1185,
    tmuxinator = 916,
    tox = 837,
    ["transcend.yml"] = 846,
    ...
    ["vega-lite.json"] = 877,
    ["vega.json"] = 876,
    ["venvironment.yaml"] = 879,
    ["venvplus.yaml"] = 880,
    version = 1167,
    ["version.json"] = 882,
    ["vhwdebugger-binding.yaml"] = 884,
    ["vim-addon-info"] = 885,
    ["vs-2017.3.host.json"] = 887,
    ["vs-nesting.json"] = 888,
    ["vsls.json"] = 886,
    ["vss-extension.json"] = 892,
    vtcfg = 1173,
    ["vtesttree.yaml"] = 893,
    ["vtestunit.yaml"] = 894,
    ["warp-keysets.json"] = 1066,
    ["warp-themes.json"] = 1067,
    ["warp-workflows.json"] = 1068,
    ["webhint.io"] = 1022,
    ["webjobpublishsettings.json"] = 899,
    ["webjobs-list.json"] = 898,
    ["well-known-fursona"] = 1106,
    ["xs-app.json"] = 926,
    ["xunit.runner.json"] = 911,
    yamllint = 954,
    zizmor = 1210,
    zuul = 937,
    ["Žinoma"] = 947
