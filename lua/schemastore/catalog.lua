...
M.json = {
  ...
  index = {
    ...
    ["Adobe UXP Manifest"] = 897,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Alacritty Configuration"] = 809,
    ["All Contributors configuration file"] = 862,
    ...
    ["Application list for a WinUtil"] = 941,
    ArchitectFX = 945,
    ["Argo Events"] = 28,
    ["Argo Workflows"] = 29,
    AssemblyScript = 32,
    ...
    ["BX CI"] = 104,
    ["Bashly (bashly.yml)"] = 866,
    ["Bashly Settings (bashly-settings.yml)"] = 867,
    ["Better Code Hub"] = 781,
    ["Better Scripts"] = 105,
    Bigconfig = 80,
    BizTalkServerApplicationSchema = 751,
    Bleep = 106,
    ...
    ["Butane Config"] = 822,
    ["CGS Custom Card Game (CardGameDef.json)"] = 902,
    ["CICS TS region tagging"] = 831,
    ["CICS TS resource import"] = 832,
    ["CICS TS resource model"] = 833,
    ["CICS TS resource overrides"] = 834,
    ["CMake Presets"] = 107,
    ["CNC Codes"] = 121,
    ["CRS WAF test file"] = 931,
    ["CRS WAF test platform overrides file"] = 932,
    ...
    CityJSON = 117,
    ["Clawject config"] = 126,
    ["Cloud Foundry Application Manifest"] = 914,
    ["Cloud Run Spec v1"] = 936,
    ...
    Concord = 930,
    ["Configu .cfgu files"] = 919,
    ["Configu .configu file"] = 920,
    Conjure = 120,
    ["Container Structure Test"] = 764,
    Containerlab = 789,
    ["Crowdsec collection config"] = 210,
    ["Crowdsec parser config"] = 211,
    ["Crowdsec scenario config"] = 212,
    ["CumulusCI Config"] = 125,
    ["Custom Machinery Machine"] = 903,
    ["Custom Machinery Recipe"] = 904,
    ...
    ["Goreleaser Pro"] = 332,
    Goss = 333,
    ["Gradle Build Cache Node"] = 779,
    ["Gradle Enterprise"] = 778,
    ...
    Hadolint = 760,
    Hammerkit = 788,
    ["Hardware Sentry Configuration"] = 842,
    Hatch = 761,
    Hayson = 346,
    ...
    ["JFrog File Spec"] = 374,
    ["JFrog Pipelines YML DSL"] = 851,
    ["JMeter DSL cli config"] = 375,
    JReleaser = 377,
    ["JSON Document Transform"] = 385,
    ["JSON Feed"] = 386,
    ["JSON Resume"] = 581,
    ["JSON Schema Draft 2020-12"] = 730,
    ["JSON Schema Draft 4"] = 727,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 884,
    ["JSON Schema Draft 7"] = 728,
    ["JSON Schema Draft 7 (unofficial strict)"] = 885,
    ["JSON Schema Draft 8 (2019-09)"] = 729,
    ["JSON-API"] = 384,
    ["JSON-WF"] = 913,
    ["JSON-e templates"] = 786,
    ["JSON-stat 2.0"] = 724,
    JSONPatch = 388,
    ...
    ["Keycloak REST API"] = 854,
    ["Knative Functions - func.yaml"] = 294,
    ["KoDE/CI build.yaml"] = 847,
    ["Kong DBLess config"] = 848,
    KrakenD = 401,
    ...
    ["Metadata for a Cinnamon spice"] = 939,
    ["MetricsHub Configuration"] = 433,
    ["MetricsHub Connector Configuration"] = 434,
    ["Micro Editor Syntax"] = 875,
    ["Microsoft Band Web Tile"] = 435,
    ["Microsoft RulesEngine workflow rules"] = 927,
    ["Microsoft RulesEngine workflow rules list"] = 928,
    ["Minecraft Custom Main Menu Mod"] = 892,
    ...
    ["MongoDB Atlas Search Index Definition"] = 846,
    ["Monika Configuration"] = 844,
    ["Monoweave Configuration"] = 459,
    ["Motif config"] = 744,
    ["NOX Framework (Service)"] = 476,
    ["Netin Diagnostic System Template"] = 804,
    ["Netlify config"] = 467,
    ...
    ["Pipeline component"] = 796,
    ["PocketMine plugin.yml"] = 524,
    ["Postman collection"] = 530,
    ["Preset list for a WinUtil"] = 942,
    ["Problem object RFC9457"] = 889,
    ...
    Qgoda = 563,
    Qodana = 814,
    ["Qt Creator workspace file"] = 921,
    ["Quali Torque Blueprint Spec 2"] = 839,
    ["QueryFirst config file"] = 857,
    ["RKE Cluster Configuration JSON"] = 793,
    ["RKE Cluster Configuration YAML"] = 792,
    ["Rancher Fleet"] = 557,
    ["Rattler-build"] = 564,
    Ray = 759,
    ["Read the Docs"] = 559,
    ...
    ["Render Blueprints"] = 791,
    RenderCV = 583,
    Renovate = 582,
    ["Replit config"] = 577,
    RoadRunner = 584,
    ["Rudder techniques"] = 895,
    Ruff = 579,
    ["Rust Project"] = 580,
    ["Rust toolchain"] = 588,
    ...
    ["SauceCTL Configuration"] = 801,
    ["Schema Catalog"] = 605,
    ["Scoop manifest"] = 610,
    ["Semantic Data Fabric (SDF) file"] = 614,
    ["Semgrep Rule"] = 616,
    ["Serenity Code Generator (Sergen)"] = 617,
    ["Serverless Framework Configuration"] = 808,
    ["Serverless Workflow"] = 810,
    ["Settings for a Cinnamon spice"] = 938,
    ["Settings.paf"] = 619,
    ["Shopware 6 Configuration"] = 811,
    ["Shopware CLI Extension Store Configuration"] = 812,
    ["Shopware CLI Project Store Configuration"] = 813,
    ["Sigma Detection Rule"] = 621,
    ["Sigrid scope configuration file"] = 622,
    ["SkyPilot Task JSON"] = 896,
    ...
    StackBlitz = 642,
    ["StackHawk Scanner Configuration"] = 807,
    Stale = 643,
    ["Starlake Data Pipeline"] = 782,
    Starship = 644,
    ...
    ["Sublime Syntax"] = 853,
    ["Subsquid squid manifest"] = 898,
    ["Swagger API 2.0"] = 653,
    TSON = 682,
    TSTyche = 683,
    ["Tab data for a LinUtil"] = 944,
    ["Tab list for a LinUtil"] = 943,
    Talhelper = 655,
    ...
    Tycho = 934,
    Tye = 815,
    ["UET BuildConfig.json"] = 858,
    ["UI5 Manifest"] = 692,
    ["UNCORS configuration"] = 696,
    ["UTAM Page Object"] = 695,
    ["Ubuntu Server Autoinstall"] = 690,
    ["Uniswap Token List"] = 770,
    ["Unreal Engine Uplugin"] = 859,
    ["Unreal Engine Uproject"] = 860,
    ["Updatecli Compose"] = 823,
    ["Updatecli Policy Manifest"] = 824,
    ["Updatecli Policy Metadata"] = 825,
    Uplift = 856,
    ["User Journey Map"] = 790,
    V2Ray = 829,
    ...
    ["Web types"] = 722,
    WebExtensions = 718,
    ["Webman package recipe"] = 835,
    ["Windows Package Manager Installer Manifest"] = 767,
    ["Windows Package Manager Locale Manifest"] = 768,
    ["Windows Package Manager Singleton Manifest"] = 766,
    ["Woodpecker pipeline config"] = 803,
    ["Wrangler CLI"] = 723,
    ["Xstate Machine"] = 821,
    ["Yandex Workflow Language"] = 940,
    ["Yarn Config (.yarnrc.yml)"] = 780,
    ["Yippee-Ki-JSON configuration YML"] = 772,
    ["YouTrack App"] = 937,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 890,
    ...
    ["behat.yml"] = 89,
    ["bigquery-table"] = 79,
    ["bioimageio resource description"] = 906,
    ...
    ["lint-staged (.lintstagedrc)"] = 738,
    ["local.settings.json"] = 424,
    ["localazy.json"] = 425,
    ["lotus.yaml"] = 423,
    ["lsdlschema.json"] = 426,
    ["markdown-link-check"] = 799,
    mboats = 806,
    ["micro-settings.json"] = 870,
    ["mimetypes.json"] = 436,
    ["mirrord config"] = 739,
    mise = 740,
    ["mise-settings"] = 741,
    ...
    ["servicehub.config.json"] = 733,
    ["servicehub.service.json"] = 732,
    ["settings.job"] = 618,
    ...
    ["vtesttree.yaml"] = 715,
    ["vtestunit.yaml"] = 716,
    ["warp-keysets.json"] = 879,
    ["warp-themes.json"] = 880,
    ["warp-workflows.json"] = 881,
    ["webhint.io"] = 836,
    ["webjobpublishsettings.json"] = 721,
    ["webjobs-list.json"] = 720,
    ["well-known-fursona"] = 917,
    ["xs-app.json"] = 746,
    ["xunit.runner.json"] = 731,
    yamllint = 771,
    ["zerops.io import file"] = 926,
    ["zerops.yml"] = 925,
    zuul = 755,
    ["Žinoma"] = 765
  },
