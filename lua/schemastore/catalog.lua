...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 90,
    [".cryproj (generic)"] = 378,
    [".cryproj engine-5.2"] = 373,
    [".cryproj engine-5.3"] = 374,
    [".cryproj engine-5.4"] = 375,
    [".cryproj engine-5.5"] = 376,
    [".cryproj engine-dev"] = 377,
    [".csscomb.json"] = 92,
    [".csslintrc"] = 93,
    [".eslintrc"] = 126,
    [".esmrc.json"] = 120,
    ...
    [".mtaext"] = 384,
    [".nodehawkrc"] = 226,
    [".npmpackagejsonlintrc"] = 228,
    [".phraseapp.yml"] = 255,
    [".pmbot.yml"] = 248,
    [".postcssrc"] = 253,
    [".pre-commit-config.yml"] = 254,
    [".putout.json"] = 272,
    [".rehyperc"] = 277,
    [".remarkrc"] = 278,
    [".sprite files"] = 312,
    ...
    [".vsext"] = 354,
    [".yarnrc.yml"] = 416,
    ["<div>RIOTS' studio configuration"] = 357,
    ["API Builder"] = 413,
    ["AWS CloudFormation"] = 80,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 81,
    ...
    ["Argo Workflows"] = 20,
    ["Avro Avsc"] = 22,
    ["Azure IoT Edge deployment"] = 25,
    ["Azure IoT Edge deployment template"] = 26,
    ["Azure IoT EdgeAgent deployment"] = 23,
    ["Azure IoT EdgeHub deployment"] = 24,
    ["Azure Pipelines"] = 27,
    ["Azure Static Web Apps CLI configuration file"] = 314,
    ["Azure Static Web Apps configuration file"] = 313,
    ["Better Code Hub"] = 418,
    BizTalkServerApplicationSchema = 390,
    Briefcase = 395,
    Buildkite = 48,
    ["Bukkit plugin.yml"] = 47,
    ["BungeeCord plugin.yml"] = 51,
    ["CMake Presets"] = 53,
    ["Camel YAML DSL"] = 54,
    Carafe = 55,
    ["Catalog Info Backstage"] = 56,
    ["Chrome Extension"] = 74,
    ["CircleCI config.yml"] = 60,
    ["Citation File Format"] = 82,
    CityJSON = 57,
    ["Code Climate"] = 61,
    ["Container Structure Test"] = 401,
    Containerlab = 426,
    ["Dart build configuration"] = 94,
    ["Dart test config"] = 95,
    ["Deployer Recipe"] = 101,
    ["Discord Webhook"] = 103,
    ["Dolittle Artifacts"] = 105,
    ["Dolittle Bounded Context Configuration"] = 106,
    ["Dolittle Event Horizons Configuration"] = 107,
    ["Dolittle Resources Configuration"] = 108,
    ["Dolittle Server Configuration"] = 109,
    ["Dolittle Tenant Map Configuration"] = 111,
    ["Dolittle Tenants Configuration"] = 110,
    ["Dolittle Topology"] = 112,
    ["Drush site aliases"] = 115,
    ["Eclipse Che Devfile"] = 118,
    Esquio = 121,
    ["Expo SDK"] = 125,
    ["F-Droid Data metadata"] = 129,
    ["Facets - FSDL - Application"] = 127,
    ["Fossa configuration file"] = 134,
    ["Foundry VTT - Manifest"] = 132,
    ["Foundry VTT - Template"] = 133,
    ["Foxx Manifest"] = 28,
    ["GatewayCore API Gateway"] = 137,
    ["GitHub Action"] = 141,
    ["GitHub Funding"] = 142,
    ["GitHub Issue Template configuration"] = 144,
    ["GitHub Workflow"] = 145,
    ["GitHub Workflow Template Properties"] = 146,
    ["GitHub issue forms"] = 143,
    GitVersion = 140,
    ["Gitpod Configuration"] = 148,
    ["Global Privacy Control"] = 138,
    ["Google Cloud Workflows"] = 79,
    Goreleaser = 151,
    ["Goreleaser Pro"] = 152,
    ["Gradle Build Cache Node"] = 415,
    ["Gradle Enterprise"] = 414,
    ["Grafana 5.x Dashboard"] = 153,
    ["GraphQL Code Generator"] = 156,
    ["GraphQL Config"] = 155,
    ["GraphQL Mesh"] = 154,
    ["Grunt JSHint task"] = 160,
    ["Grunt Watch task"] = 161,
    ["Grunt base task"] = 162,
    ["Grunt clean task"] = 158,
    ["Grunt copy task"] = 157,
    ["Grunt cssmin task"] = 159,
    HEMTT = 387,
    Hadolint = 399,
    ["Hammerkit YAML Schema"] = 425,
    Hayson = 164,
    ["Hazelcast 5 Configuration"] = 165,
    ["Helm Chart.lock"] = 59,
    ["Helm Chart.yaml"] = 58,
    ["JFrog File Spec"] = 177,
    ["JSON Document Transform"] = 185,
    ["JSON Feed"] = 186,
    ["JSON Resume"] = 280,
    ["JSON Schema Draft 2020-12"] = 369,
    ["JSON Schema Draft 4"] = 366,
    ["JSON Schema Draft 7"] = 367,
    ["JSON Schema Draft 8"] = 368,
    ["JSON schema for CodeShip Pro services configuration files"] = 67,
    ["JSON schema for CodeShip Pro steps configuration files"] = 68,
    ["JSON schema for Codecov configuration files"] = 66,
    ["JSON-API"] = 184,
    ["JSON-e templates"] = 423,
    ["JSON-stat 2.0"] = 363,
    JSONPatch = 188,
    ["Jekyll configuration"] = 174,
    ["Jenkins X Pipelines"] = 175,
    ["Jenkins X Requirements"] = 176,
    ["Jovo Language Models"] = 178,
    ["KSP-AVC"] = 364,
    ["KSP-CKAN"] = 365,
    Liquibase = 430,
    ["MegaLinter configuration"] = 202,
    ["MegaLinter descriptor"] = 203,
    ["Microsoft Band Web Tile"] = 204,
    ["Minecraft Data Pack Advancement"] = 206,
    ["Minecraft Data Pack Biome"] = 207,
    ["Minecraft Data Pack Configured Carver"] = 208,
    ["Minecraft Data Pack Dimension"] = 210,
    ["Minecraft Data Pack Dimension Type"] = 209,
    ["Minecraft Data Pack Item Modifier"] = 211,
    ["Minecraft Data Pack Loot Table"] = 212,
    ["Minecraft Data Pack Metadata"] = 213,
    ["Minecraft Data Pack Predicate"] = 214,
    ["Minecraft Data Pack Recipe"] = 215,
    ["Minecraft Data Pack Template Pool"] = 216,
    ["Minecraft Resourcepack Sounds"] = 217,
    ["Netin Diagnostic System Template"] = 437,
    ["Netlify config schema"] = 221,
    ["Nightwatch.js"] = 222,
    ["OSS Review Toolkit repository configuration"] = 242,
    Opctl = 386,
    ["OpenWeather Current Weather API"] = 422,
    ["OpenWeather Road Risk API"] = 421,
    ["Ory Hydra configuration"] = 169,
    ["Ory Keto configuration"] = 191,
    ["Ory Kratos configuration"] = 241,
    ["Ory Oathkeeper configuration"] = 233,
    ["Outblocks App configuration"] = 239,
    ["Outblocks database table"] = 240,
    ["Outblocks project configuration"] = 238,
    Packer = 245,
    ["Pipeline component"] = 431,
    ["PocketMine plugin.yml"] = 249,
    ["Pull Request Labeler"] = 271,
    ["RKE Cluster Configuration JSON Schema"] = 429,
    ["RKE Cluster Configuration YAML Schema"] = 428,
    Ray = 398,
    ["Read the Docs"] = 274,
    ["Red-DiscordBot Сog"] = 275,
    ["Red-DiscordBot Сog Repo"] = 276,
    Renovate = 281,
    RoadRunner = 282,
    SWADL = 322,
    ["Sapphire CLI Config"] = 283,
    ["SauceCTL Configuration"] = 434,
    ["Schema Catalog"] = 296,
    ["Scoop manifest"] = 301,
    ["Semgrep Rule"] = 302,
    Solidarity = 308,
    ["Source Maps v3"] = 309,
    SpecIF = 310,
    ["Sponge Mixin configuration"] = 311,
    ["StackHawk Scanner Configuration"] = 440,
    ["StackHead CLI config"] = 315,
    ["StackHead module configuration"] = 316,
    ["StackHead project definition"] = 317,
    Stale = 318,
    ["Stryker Mutator"] = 319,
    ["StyleCop Analyzers Configuration"] = 320,
    ["Swagger API 2.0"] = 323,
    ["Taskfile YAML Schema"] = 424,
    Taurus = 324,
    ["TestEnvironment.json"] = 329,
    ["Traefik v2"] = 331,
    ["Traefik v2 File Provider"] = 332,
    ["UI5 Manifest"] = 343,
    ["Uniswap Token List"] = 407,
    ["User Journey Map YAML Schema"] = 427,
    ["VSCode Code Snippets"] = 69,
    ["VSIX CLI publishing"] = 355,
    ["Vela Pipeline Configuration"] = 347,
    ["Web App Manifest"] = 359,
    ["Web types"] = 362,
    WebExtensions = 358,
    ["Windows Package Manager Installer Manifest"] = 404,
    ["Windows Package Manager Locale Manifest"] = 405,
    ["Windows Package Manager Singleton Manifest"] = 403,
    ["Woodpecker pipeline config"] = 436,
    ["Yippee-Ki-JSON configuration YML"] = 409,
    ["angular.json"] = 6,
    ["app-definition.yaml"] = 13,
    ["apple-app-site-association"] = 12,
    ["appsettings.json"] = 16,
    ["appsscript.json"] = 15,
    ["appveyor.yml"] = 17,
    ["arc.json"] = 19,
    ...
    ["batect.yml"] = 32,
    ["beau.yml"] = 417,
    ["beef-database-codegen"] = 34,
    ["beef-entity-codegen"] = 35,
    ["behat.yml"] = 43,
    ["bigquery-table"] = 36,
    ["bitbucket-pipelines"] = 37,
    bitrise = 38,
    ["bitrise-step"] = 39,
    ["block.json"] = 52,
    ["bower.json"] = 41,
    ["bozr.suite.json"] = 44,
    ["browser.i18n.json"] = 45,
    bucklescript = 46,
    ["bundleconfig.json"] = 50,
    ["chutzpah.json"] = 75,
    ["cloud-sdk-pipeline-config-schema"] = 77,
    ["cloudbuild.json"] = 78,
    cloudify = 64,
    codemagic = 65,
    ["coffeelint.json"] = 83,
    comet = 419,
    ["commands.json"] = 72,
    ["compile_commands.json"] = 71,
    ["compilerconfig.json"] = 70,
    ["component.json"] = 85,
    ["composer.json"] = 84,
    ["config.json"] = 86,
    ["contentmanifest.json"] = 76,
    ["contribute.json"] = 87,
    ["cosmos.config.json"] = 73,
    ["crowdin.yml"] = 88,
    cspell = 91,
    ["cypress.json"] = 89,
    ["datalogic-scan2deploy-android"] = 96,
    ["datalogic-scan2deploy-ce"] = 97,
    ["debugsettings.json"] = 98,
    ["dependabot-v2.json"] = 100,
    ["dependabot.json"] = 99,
    ["detekt.yml"] = 102,
    devinit = 411,
    ["docfx.json"] = 104,
    ["docker-compose.yml"] = 410,
    ["dotnetcli.host.json"] = 113,
    ["drone.json"] = 114,
    ["dss-2.0.0.json"] = 116,
    ["dvc.yaml"] = 117,
    ["ecosystem.json"] = 119,
    ["electron-builder configuration file."] = 123,
    ["epr-manifest.json"] = 122,
    ["evcc.yaml"] = 124,
    ["fabric.mod.json"] = 128,
    ["first-timers-bot"] = 131,
    fulibWorkflows = 435,
    ["func.yaml"] = 135,
    ["function.json"] = 136,
    ["geojson.json"] = 139,
    ["gitlab-ci"] = 147,
    ["global.json"] = 149,
    ["golangci-lint Configuration"] = 150,
    ["haxelib.json"] = 163,
    helmfile = 400,
    ["host-meta.json"] = 167,
    ["host.json"] = 166,
    ...
    httpmockrc = 391,
    huskyrc = 380,
    ["imageoptimizer.json"] = 170,
    ["ioBroker JSON UI"] = 172,
    ["ioBroker Package manifest"] = 173,
    ["jsconfig.json"] = 189,
    jsdoc = 397,
    ["k3d.yaml"] = 190,
    ["kustomization.yaml"] = 192,
    ["label-commenter-config.yml"] = 193,
    ["launchsettings.json"] = 194,
    ["lerna.json"] = 195,
    ["lgtm.yml"] = 196,
    ["libman.json"] = 197,
    ["license-report-config.json"] = 198,
    ["local.settings.json"] = 199,
    ["localazy.json"] = 200,
    ["lsdlschema.json"] = 201,
    ["markdownlint.json"] = 433,
    mboats = 439,
    ["mimetypes.json"] = 205,
    ["mta.yaml"] = 382,
    ["mtad.yaml"] = 383,
    ...
    neoload = 392,
    ["nest-cli"] = 224,
    ["ninjs (News in JSON)"] = 223,
    ["nlu.json"] = 225,
    ["nodemon.json"] = 227,
    ["noodl.schema.json"] = 438,
    now = 388,
    ["nswag.json"] = 231,
    ntangle = 232,
    ["nuclei-template.yaml"] = 229,
    ["nuget-project.json"] = 230,
    ["ocelot.json"] = 234,
    ["omnisharp.json"] = 235,
    ["openapi.json"] = 236,
    ["openfin.json"] = 237,
    ["package.json"] = 243,
    ["package.manifest"] = 244,
    ["pattern.json"] = 247,
    pgap_yaml_input_reader = 246,
    ["plagiarize-me.yaml"] = 251,
    ["plagiarize.yaml"] = 250,
    ["portman.json"] = 252,
    ["prettierrc.json"] = 256,
    ["prisma.yml"] = 257,
    ["project-1.0.0-beta3.json"] = 259,
    ["project-1.0.0-beta4.json"] = 260,
    ["project-1.0.0-beta5.json"] = 261,
    ["project-1.0.0-beta6.json"] = 262,
    ["project-1.0.0-beta8.json"] = 263,
    ["project-1.0.0-rc1.json"] = 264,
    ["project-1.0.0-rc2.json"] = 265,
    ["project.json"] = 258,
    ["prometheus.json"] = 266,
    ["prometheus.rules.json"] = 267,
    ["proxies.json"] = 268,
    ["publiccode.yml"] = 269,
    ["pubspec.yaml"] = 270,
    ["pyrseas-0.8.json"] = 273,
    ["release drafter"] = 393,
    ["sarif-1.0.0.json"] = 284,
    ["sarif-2.0.0.json"] = 285,
    ["sarif-2.1.0"] = 294,
    ["sarif-2.1.0-rtm.2"] = 286,
    ["sarif-2.1.0-rtm.3"] = 288,
    ["sarif-2.1.0-rtm.4"] = 290,
    ["sarif-2.1.0-rtm.5"] = 292,
    ["sarif-external-property-file-2.1.0"] = 295,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 287,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 289,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 291,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 293,
    ["schema.org - Action"] = 297,
    ["schema.org - ContactPoint"] = 298,
    ["schema.org - Place"] = 299,
    ["schema.org - Thing"] = 300,
    ["servicehub.config.json"] = 372,
    ["servicehub.service.json"] = 371,
    ["settings.job"] = 303,
    ["sfdx-hardis configuration"] = 304,
    ["size-limit configuration"] = 305,
    ["skaffold.yaml"] = 432,
    ["skyuxconfig.json"] = 306,
    snapcraft = 307,
    swcrc = 420,
    taskcat = 389,
    ["template.json"] = 325,
    ["templatsources.json"] = 326,
    ["theme.json"] = 327,
    tmLanguage = 328,
    ["trunk.yaml schema"] = 333,
    ["ts-force-config.json"] = 337,
    ["tsconfig.json"] = 334,
    ["tsd.json"] = 335,
    ["tsdrc.json"] = 336,
    ["tslint.json"] = 338,
    ...
    ["version.json"] = 348,
    ["vim-addon-info"] = 349,
    ["vs-2017.3.host.json"] = 351,
    ["vs-nesting.json"] = 352,
    ["vsls.json"] = 350,
    ["vss-extension.json"] = 356,
    ["webjobpublishsettings.json"] = 361,
    ["webjobs-list.json"] = 360,
    ["xs-app.json"] = 385,
    ["xunit.runner.json"] = 370,
    yamllint = 408,
    zuul = 394,
    ["Žinoma"] = 402
  },
