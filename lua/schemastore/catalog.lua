...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 148,
    [".cryproj (generic)"] = 497,
    [".cryproj engine-5.2"] = 492,
    [".cryproj engine-5.3"] = 493,
    [".cryproj engine-5.4"] = 494,
    [".cryproj engine-5.5"] = 495,
    [".cryproj engine-dev"] = 496,
    [".csscomb.json"] = 150,
    [".csslintrc"] = 151,
    [".eslintrc"] = 196,
    [".esmrc.json"] = 188,
    ...
    ["Better Code Hub"] = 540,
    ["Better Scripts"] = 80,
    BizTalkServerApplicationSchema = 512,
    ...
    ["Butane Config"] = 578,
    ["CICS TS region tagging"] = 585,
    ["CICS TS resource import"] = 586,
    ["CICS TS resource model"] = 587,
    ["CICS TS resource overrides"] = 588,
    ["CMake Presets"] = 81,
    ...
    ["Datahub Ingestion Recipe Schema"] = 592,
    ...
    ["Embrace Config Schema"] = 603,
    ["Error pages"] = 191,
    Esquio = 189,
    ["Estuary Flow Catalog Schema"] = 582,
    ["Expo SDK"] = 194,
    ...
    Goreleaser = 222,
    ["Goreleaser Pro"] = 223,
    ["Gradle Build Cache Node"] = 537,
    ["Gradle Enterprise"] = 536,
    ...
    Hadolint = 521,
    Hammerkit = 547,
    ["Hardware Sentry Configuration"] = 596,
    Hayson = 235,
    ...
    ["JFrog File Spec"] = 254,
    ["JFrog Pipelines YML DSL"] = 605,
    ["JSON Document Transform"] = 262,
    ["JSON Feed"] = 263,
    ["JSON Resume"] = 381,
    ["JSON Schema Draft 2020-12"] = 488,
    ["JSON Schema Draft 4"] = 485,
    ["JSON Schema Draft 7"] = 486,
    ["JSON Schema Draft 8"] = 487,
    ...
    ["KSP-AVC"] = 483,
    ["KSP-CKAN"] = 484,
    ["Keycloak REST API"] = 611,
    ["Knative Functions - func.yaml"] = 206,
    ["KoDE/CI build.yaml"] = 601,
    ["Kong DBLess Schema"] = 602,
    KrakenD = 268,
    ["LinkML Metamodel"] = 280,
    Liquibase = 552,
    ["Liquibase Flow File"] = 553,
    Markdownlint = 556,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 600,
    ["Monika Configuration Schema"] = 598,
    ["Motif config"] = 505,
    ["NOX Framework (Service)"] = 316,
    ["Netin Diagnostic System Template"] = 561,
    ...
    Opctl = 508,
    ["OpenWeather Current Weather API"] = 544,
    ["OpenWeather Road Risk API"] = 543,
    ...
    PyProject = 372,
    Qodana = 571,
    ["Quali Torque Blueprint Spec 2"] = 593,
    ["QueryFirst config file"] = 614,
    ["RKE Cluster Configuration JSON Schema"] = 551,
    ["RKE Cluster Configuration YAML Schema"] = 550,
    Ray = 520,
    ["Read the Docs"] = 370,
    ...
    ["SauceCTL Configuration"] = 558,
    ["Schema Catalog"] = 399,
    ["Scoop manifest"] = 404,
    ["Semgrep Rule"] = 406,
    ["Serverless Framework Configuration"] = 565,
    ["Serverless Workflow Schema"] = 567,
    ["Settings.paf"] = 408,
    ["Shopware 6 Configuration"] = 568,
    ["Shopware CLI Extension Store Configuration"] = 569,
    ["Shopware CLI Project Store Configuration"] = 570,
    Solidarity = 414,
    ["Solution filters"] = 415,
    ["Source Maps v3"] = 416,
    SpecIF = 417,
    ["Sponge Mixin configuration"] = 418,
    ["StackHawk Scanner Configuration"] = 564,
    Stale = 422,
    Starship = 423,
    ["Statamic Blueprint"] = 424,
    ["StrmPrivacy Data Connector"] = 609,
    ["StrmPrivacy Data Contract"] = 610,
    ["StrmPrivacy SimpleSchema"] = 607,
    ["StrmPrivacy Stream"] = 608,
    ["StrmPrivacy batch job configuration file"] = 606,
    ["Stryker Mutator"] = 427,
    ["StyleCop Analyzers Configuration"] = 428,
    ["Swagger API 2.0"] = 431,
    TSON = 451,
    ["Talisman configuration"] = 432,
    ["Taskfile YAML Schema"] = 546,
    Taurus = 433,
    ...
    Tye = 572,
    ["UI5 Manifest"] = 458,
    ["UTAM Page Object"] = 460,
    ["Ubuntu Server Autoinstall"] = 456,
    ["Uniswap Token List"] = 529,
    ["Unreal Engine Uplugin"] = 615,
    ["Unreal Engine Uproject"] = 616,
    Updatecli = 579,
    Uplift = 613,
    ["User Journey Map YAML Schema"] = 549,
    V2Ray = 583,
    ["VSCode Code Snippets"] = 124,
    ["VSIX CLI publishing"] = 473,
    ["Vela Pipeline Configuration"] = 463,
    Vercel = 123,
    ["Web App Manifest"] = 478,
    ["Web types"] = 481,
    WebExtensions = 477,
    ["Webman package recipe"] = 589,
    ["Windows Package Manager Installer Manifest"] = 526,
    ["Windows Package Manager Locale Manifest"] = 527,
    ["Windows Package Manager Singleton Manifest"] = 525,
    ["Woodpecker pipeline config"] = 560,
    ["Xstate Machine Schema"] = 577,
    ["Yippee-Ki-JSON configuration YML"] = 531,
    ["angular.json"] = 11,
    ...
    ["ize.toml"] = 612,
    ["jsconfig.json"] = 266,
    ["jscpd Configuration Schema"] = 594,
    jsdoc = 519,
    ["k3d.yaml"] = 267,
    ...
    ["servicehub.config.json"] = 491,
    ["servicehub.service.json"] = 490,
    ["settings.job"] = 407,
    ...
    ["vega-lite.json"] = 462,
    ["vega.json"] = 461,
    ["venvironment-basic.yaml"] = 465,
    ["venvironment.yaml"] = 464,
    ["version.json"] = 466,
    ["vim-addon-info"] = 467,
    ["vs-2017.3.host.json"] = 469,
    ["vs-nesting.json"] = 470,
    ["vsls.json"] = 468,
    ["vss-extension.json"] = 474,
    ["webhint.io"] = 590,
    ["webjobpublishsettings.json"] = 480,
    ["webjobs-list.json"] = 479,
    ["xs-app.json"] = 507,
    ["xunit.runner.json"] = 489,
    yamllint = 530,
    zuul = 516,
    ["Žinoma"] = 524
  },
