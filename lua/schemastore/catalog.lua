...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 164,
    [".cryproj (generic)"] = 560,
    [".cryproj engine-5.2"] = 555,
    [".cryproj engine-5.3"] = 556,
    [".cryproj engine-5.4"] = 557,
    [".cryproj engine-5.5"] = 558,
    [".cryproj engine-dev"] = 559,
    [".csscomb.json"] = 166,
    [".csslintrc"] = 167,
    [".es6importsorterrc.json"] = 683,
    [".eslintrc"] = 212,
    [".esmrc.json"] = 204,
    [".ffizer.yaml"] = 216,
    [".htmlhintrc"] = 262,
    ...
    [".mtaext"] = 569,
    [".nodehawkrc"] = 354,
    [".npmpackagejsonlintrc"] = 357,
    [".phraseapp.yml"] = 396,
    [".pmbot.yml"] = 386,
    [".postcssrc"] = 391,
    [".powerpages-web-template-manifest"] = 393,
    [".pre-commit-config.yml"] = 394,
    [".pre-commit-hooks.yml"] = 395,
    [".putout.json"] = 414,
    [".rehyperc"] = 424,
    [".remarkrc"] = 425,
    [".sprite files"] = 475,
    ...
    ["<div>RIOTS' studio configuration"] = 539,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config schema"] = 318,
    ["API Builder"] = 598,
    ["AVA Configuration Schema"] = 655,
    ["AWS CDK cdk.json"] = 149,
    ["AWS CloudFormation"] = 150,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 151,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 13,
    ["Airplane task"] = 14,
    ["Alacritty Configuration Schema"] = 630,
    ["All Contributors configuration file"] = 682,
    ...
    ["Azure Pipelines"] = 54,
    ["Azure Static Web Apps CLI configuration file"] = 477,
    ["Azure Static Web Apps configuration file"] = 476,
    ["BX CI"] = 89,
    ["Better Code Hub"] = 603,
    ["Better Scripts"] = 90,
    BizTalkServerApplicationSchema = 575,
    ...
    ["Butane Config"] = 642,
    ["CICS TS region tagging"] = 649,
    ["CICS TS resource import"] = 650,
    ["CICS TS resource model"] = 651,
    ["CICS TS resource overrides"] = 652,
    ["CMake Presets"] = 91,
    ...
    Conjure = 99,
    ["Container Structure Test"] = 586,
    Containerlab = 611,
    ["Crowdsec collection Schema"] = 160,
    ["Crowdsec parser Schema"] = 161,
    ["Crowdsec scenario Schema"] = 162,
    ["DWP Exchange - catalogue entry"] = 201,
    ["DWP Exchange - gateway"] = 199,
    ["DWP Exchange - meta"] = 200,
    ["Dart build configuration"] = 168,
    ["Dart test config"] = 169,
    ["DashLord configuration"] = 170,
    ["Datadog Service Definition"] = 299,
    ["Datahub Ingestion Recipe Schema"] = 656,
    ...
    ["Drush site aliases"] = 194,
    ["Embrace Config Schema"] = 667,
    ["Error pages"] = 207,
    Esquio = 205,
    ["Estuary Flow Catalog Schema"] = 646,
    ["Expo SDK"] = 210,
    ["F-Droid Data metadata"] = 215,
    ["Facets - FSDL - Application"] = 213,
    ["FasterCI Configuration"] = 55,
    Firebase = 217,
    ["Fossa configuration file"] = 224,
    ["Fossa's fossa-deps file"] = 225,
    ["Foundry VTT - Base package Manifest"] = 219,
    ["Foundry VTT - Module Manifest"] = 220,
    ["Foundry VTT - System Data Template"] = 223,
    ["Foundry VTT - System Manifest"] = 221,
    ["Foundry VTT - World Manifest"] = 222,
    ["Foxx Manifest"] = 56,
    ["Freifunk.de Community API"] = 59,
    ["Frogbot Config"] = 60,
    ["GCP Blueprint Metadata"] = 229,
    ["GatewayCore API Gateway"] = 228,
    ["GeoJSON.json latest"] = 644,
    GherKing = 648,
    ["GitHub Action"] = 233,
    ["GitHub Discussion"] = 234,
    ["GitHub Funding"] = 235,
    ["GitHub Issue Template configuration"] = 237,
    ["GitHub Workflow"] = 238,
    ["GitHub Workflow Template Properties"] = 239,
    ["GitHub issue forms"] = 236,
    GitVersion = 232,
    ["Gitpod Configuration"] = 241,
    ["Global Privacy Control"] = 230,
    ["Google Cloud Workflows"] = 148,
    Goreleaser = 244,
    ["Goreleaser Pro"] = 245,
    ["Gradle Build Cache Node"] = 600,
    ["Gradle Enterprise"] = 599,
    ["Grafana 5.x Dashboard"] = 246,
    ["GraphQL Code Generator"] = 249,
    ["GraphQL Config"] = 248,
    ["GraphQL Mesh"] = 247,
    ["Grunt JSHint task"] = 253,
    ["Grunt Watch task"] = 254,
    ["Grunt base task"] = 255,
    ["Grunt clean task"] = 251,
    ["Grunt copy task"] = 250,
    ["Grunt cssmin task"] = 252,
    HEMTT = 572,
    Hadolint = 584,
    Hammerkit = 610,
    ["Hardware Sentry Configuration"] = 660,
    Hayson = 257,
    ["Haystack Pipeline"] = 258,
    ["Hazelcast 5 Configuration"] = 259,
    ["Helm Chart.lock"] = 121,
    ["Helm Chart.yaml"] = 120,
    ["Helm Unittest Test Suite"] = 122,
    Hugo = 638,
    ["IBM Zapp document"] = 264,
    ["IBM zCodeFormatSettings"] = 265,
    ["IMG Catapult PSP"] = 270,
    ["Istanbul Schema"] = 663,
    ["JDownloader2 crawler multi-rule schema"] = 280,
    ["JDownloader2 crawler single-rule schema"] = 279,
    ["JFrog File Spec"] = 281,
    ["JFrog Pipelines YML DSL"] = 669,
    ["JMeter DSL cli config schema"] = 282,
    JReleaser = 284,
    ["JSON Document Transform"] = 291,
    ["JSON Feed"] = 292,
    ["JSON Resume"] = 431,
    ["JSON Schema Draft 2020-12"] = 551,
    ["JSON Schema Draft 4"] = 548,
    ["JSON Schema Draft 7"] = 549,
    ["JSON Schema Draft 8"] = 550,
    ...
    ["JSON-API"] = 290,
    ["JSON-e templates"] = 608,
    ["JSON-stat 2.0"] = 545,
    JSONPatch = 294,
    Jasmine = 275,
    Jekyll = 276,
    ["Jenkins X Pipelines"] = 277,
    ["Jenkins X Requirements"] = 278,
    ["Jovo Language Models"] = 283,
    ["KSP-AVC"] = 546,
    ["KSP-CKAN"] = 547,
    Kas = 297,
    ["Keycloak REST API"] = 675,
    ["Knative Functions - func.yaml"] = 226,
    ["KoDE/CI build.yaml"] = 665,
    ["Kong DBLess Schema"] = 666,
    KrakenD = 298,
    LOOBin = 313,
    ["LinkML Metamodel"] = 311,
    Liquibase = 615,
    ["Liquibase Flow File"] = 616,
    ["Lively Properties"] = 312,
    Markdownlint = 619,
    ["Mason Registry"] = 621,
    ["MegaLinter configuration"] = 319,
    ["MegaLinter descriptor"] = 320,
    ["Meltano plugin discovery definition"] = 322,
    ["Meltano project definition"] = 321,
    ["Microsoft Band Web Tile"] = 323,
    ["Minecraft Data Pack Advancement"] = 325,
    ["Minecraft Data Pack Biome"] = 326,
    ["Minecraft Data Pack Configured Carver"] = 327,
    ["Minecraft Data Pack Damage Type"] = 328,
    ["Minecraft Data Pack Dimension"] = 330,
    ["Minecraft Data Pack Dimension Type"] = 329,
    ["Minecraft Data Pack Item Modifier"] = 331,
    ["Minecraft Data Pack Loot Table"] = 332,
    ["Minecraft Data Pack Metadata"] = 333,
    ["Minecraft Data Pack Predicate"] = 334,
    ["Minecraft Data Pack Recipe"] = 335,
    ["Minecraft Data Pack Tag"] = 336,
    ["Minecraft Data Pack Template Pool"] = 337,
    ["Minecraft Resource Pack Lang"] = 338,
    ["Minecraft Resource Pack Particle"] = 339,
    ["Minecraft Resource Pack Texture Mcmeta"] = 341,
    ["Minecraft Resourcepack Sounds"] = 340,
    ["MkDocs Configuration 1.0"] = 342,
    ["MongoDB Atlas Search Index Definition Schema"] = 664,
    ["Monika Configuration Schema"] = 662,
    ["Motif config"] = 568,
    ["NOX Framework (Service)"] = 356,
    ["Netin Diagnostic System Template"] = 625,
    ["Netlify config schema"] = 347,
    ["Nexus-as-Code schema"] = 348,
    ["Nightwatch.js"] = 349,
    ["ONe's service descriptor"] = 368,
    ["OSS Review Toolkit configuration"] = 375,
    ["OSS Review Toolkit curation"] = 376,
    ["OSS Review Toolkit package configuration"] = 377,
    ["OSS Review Toolkit repository configuration"] = 378,
    ["OSS Review Toolkit resolutions"] = 379,
    Opctl = 571,
    ["OpenRewrite Resource"] = 370,
    ["OpenWeather Current Weather API"] = 607,
    ["OpenWeather Road Risk API"] = 606,
    ["Ory Hydra configuration"] = 263,
    ["Ory Keto configuration"] = 300,
    ["Ory Kratos configuration"] = 374,
    ["Ory Oathkeeper configuration"] = 363,
    ["Outblocks App configuration"] = 372,
    ["Outblocks database table"] = 373,
    ["Outblocks project configuration"] = 371,
    Packer = 382,
    Pantsbuild = 681,
    ["Paper paper-plugin.yml"] = 383,
    ["Pipeline component"] = 617,
    ["PocketMine plugin.yml"] = 387,
    ["Postman collection"] = 392,
    Pterodactyl = 659,
    ["Pull Request Labeler"] = 413,
    Pulumi = 418,
    PyProject = 419,
    Pyright = 420,
    Qodana = 635,
    ["Quali Torque Blueprint Spec 2"] = 657,
    ["QueryFirst config file"] = 678,
    ["RKE Cluster Configuration JSON Schema"] = 614,
    ["RKE Cluster Configuration YAML Schema"] = 613,
    ["Rancher Fleet"] = 416,
    Ray = 583,
    ["Read the Docs"] = 417,
    ["Red-DiscordBot Cog"] = 421,
    ["Red-DiscordBot Cog Repo"] = 422,
    ["Red-DiscordBot Trivia"] = 423,
    Renovate = 432,
    ["Replit schema"] = 426,
    RoadRunner = 433,
    Ruff = 429,
    ["Rust Project"] = 430,
    ["Rust toolchain"] = 435,
    ["SIL Kit Participant Configuration"] = 464,
    SWADL = 486,
    ["Sapphire CLI Config"] = 438,
    ["SauceCTL Configuration"] = 622,
    ["Schema Catalog"] = 451,
    ["Scoop manifest"] = 456,
    ["Semantic Data Fabric (SDF) file"] = 457,
    ["Semgrep Rule"] = 459,
    ["Serenity Code Generator (Sergen)"] = 460,
    ["Serverless Framework Configuration"] = 629,
    ["Serverless Workflow Schema"] = 631,
    ["Settings.paf"] = 462,
    ["Shopware 6 Configuration"] = 632,
    ["Shopware CLI Extension Store Configuration"] = 633,
    ["Shopware CLI Project Store Configuration"] = 634,
    ["Slack app manifest"] = 466,
    Solidarity = 469,
    ["Solution filters"] = 470,
    ["Source Maps v3"] = 471,
    Sourcery = 472,
    SpecIF = 473,
    ["Sponge Mixin configuration"] = 474,
    ["StackHawk Scanner Configuration"] = 628,
    Stale = 478,
    Starship = 479,
    ["Statamic Blueprint"] = 480,
    ["StrmPrivacy Data Connector"] = 673,
    ["StrmPrivacy Data Contract"] = 674,
    ["StrmPrivacy SimpleSchema"] = 671,
    ["StrmPrivacy Stream"] = 672,
    ["StrmPrivacy batch job configuration file"] = 670,
    ["Stryker Mutator"] = 483,
    ["StyleCop Analyzers Configuration"] = 484,
    ["Swagger API 2.0"] = 487,
    TSON = 511,
    ["Talisman configuration"] = 489,
    ["Taskfile YAML Schema"] = 609,
    Taurus = 490,
    ["TestEnvironment.json"] = 499,
    ["Tier.run pricing.json"] = 493,
    Tikibase = 494,
    ["Traefik v2"] = 502,
    ["Traefik v2 File Provider"] = 503,
    Turborepo = 500,
    Tye = 636,
    ["UI5 Manifest"] = 518,
    ["UTAM Page Object"] = 521,
    ["Ubuntu Server Autoinstall"] = 516,
    ["Uniswap Token List"] = 592,
    ["Unreal Engine Uplugin"] = 679,
    ["Unreal Engine Uproject"] = 680,
    Updatecli = 643,
    Uplift = 677,
    ["User Journey Map YAML Schema"] = 612,
    V2Ray = 647,
    ["VSCode Code Snippets"] = 137,
    ["VSIX CLI publishing"] = 534,
    ["Vela Pipeline Configuration"] = 524,
    Vercel = 136,
    ["Web App Manifest"] = 541,
    ["Web types"] = 544,
    WebExtensions = 540,
    ["Webman package recipe"] = 653,
    ["Windows Package Manager Installer Manifest"] = 589,
    ["Windows Package Manager Locale Manifest"] = 590,
    ["Windows Package Manager Singleton Manifest"] = 588,
    ["Woodpecker pipeline config"] = 624,
    ["Xstate Machine Schema"] = 641,
    ["Yippee-Ki-JSON configuration YML"] = 594,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 65,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 686,
    ["bashly-strings.yml"] = 687,
    ["bashly.yml"] = 685,
    ["batect.yml"] = 64,
    ["beau.yml"] = 602,
    ...
    ["cloud-sdk-pipeline-config-schema"] = 146,
    ["cloudbuild.json"] = 147,
    cloudify = 128,
    codemagic = 130,
    ["coffeelint.json"] = 153,
    ...
    ["component-detection-manifest.json"] = 156,
    ["component.json"] = 155,
    ["composer.json"] = 154,
    ["config.json"] = 157,
    ["contentmanifest.json"] = 145,
    ["contribute.json"] = 158,
    ...
    ["drone.json"] = 193,
    ["dss-2.0.0.json"] = 195,
    ["dstack Workflows"] = 196,
    ["dvc.yaml"] = 197,
    ["ecosystem.json"] = 202,
    eksctl = 203,
    ["electron-builder configuration file."] = 208,
    ["epr-manifest.json"] = 206,
    ["evcc.yaml"] = 209,
    ["ezd schema"] = 211,
    ["fabric.mod.json"] = 214,
    ["first-timers-bot"] = 218,
    ...
    ["gitlab-ci"] = 240,
    ["global.json"] = 242,
    ["golangci-lint Configuration"] = 243,
    ["haxelib.json"] = 256,
    helmfile = 585,
    ["host-meta.json"] = 261,
    ["host.json"] = 260,
    ...
    ["ide.host.json"] = 266,
    ["ifstate.conf"] = 267,
    ["imageoptimizer.json"] = 268,
    ["importmap.json"] = 271,
    ["ioBroker Configuration"] = 272,
    ["ioBroker JSON UI"] = 273,
    ["ioBroker Package manifest"] = 274,
    ["ize.toml"] = 676,
    ["jsconfig.json"] = 295,
    ["jscpd Configuration Schema"] = 658,
    jsdoc = 582,
    ["k3d.yaml"] = 296,
    ["kontinuous-values.yaml"] = 301,
    ["kustomization.yaml"] = 302,
    ["label-commenter-config.yml"] = 303,
    ["launchsettings.json"] = 304,
    ["lego.json"] = 305,
    ["lerna.json"] = 306,
    ["lgtm.yml"] = 307,
    ["libman.json"] = 308,
    ["license-report-config.json"] = 309,
    ["linkinator.config.json"] = 310,
    ["local.settings.json"] = 315,
    ["localazy.json"] = 316,
    ["lotus.yaml"] = 314,
    ["lsdlschema.json"] = 317,
    ["madness.yml"] = 684,
    ["markdown-lint-check"] = 620,
    mboats = 627,
    ["micro-settings.json"] = 688,
    ["mimetypes.json"] = 324,
    ["mirrord-schema"] = 565,
    ["mta.yaml"] = 566,
    ["mtad.yaml"] = 567,
    ["mycode.json"] = 345,
    ["napari plugin manifest"] = 346,
    neoload = 577,
    ["nest-cli"] = 352,
    ["ninjs (News in JSON) 1.3"] = 351,
    ["ninjs (News in JSON) 2.0"] = 350,
    ["nlu.json"] = 353,
    ["nodemon.json"] = 355,
    ["noodl.schema.json"] = 626,
    now = 573,
    ["npm-badges"] = 358,
    ["nswag.json"] = 361,
    ntangle = 362,
    ["nuclei-template.yaml"] = 359,
    ["nuget-project.json"] = 360,
    ["ocelot.json"] = 364,
    ["omnisharp.json"] = 365,
    ["openapi.json"] = 366,
    ["openfin.json"] = 369,
    ["openrpc.json"] = 367,
    ["package.json"] = 380,
    ["package.manifest"] = 381,
    ["pattern.json"] = 385,
    ["petstore-v1.0"] = 668,
    pgap_yaml_input_reader = 384,
    ["plagiarize-me.yaml"] = 389,
    ["plagiarize.yaml"] = 388,
    ["portman.json"] = 390,
    ["prettierrc.json"] = 397,
    ["prisma.yml"] = 398,
    ["project-1.0.0-beta3.json"] = 400,
    ["project-1.0.0-beta4.json"] = 401,
    ["project-1.0.0-beta5.json"] = 402,
    ["project-1.0.0-beta6.json"] = 403,
    ["project-1.0.0-beta8.json"] = 404,
    ["project-1.0.0-rc1.json"] = 405,
    ["project-1.0.0-rc2.json"] = 406,
    ["project.json"] = 399,
    ["prometheus.json"] = 407,
    ["prometheus.rules.json"] = 408,
    ["prometheus.rules.test.json"] = 409,
    ["proxies.json"] = 410,
    ["publiccode.yml"] = 411,
    ["pubspec.yaml"] = 412,
    ["pyrseas-0.8.json"] = 415,
    ["quilt.mod.json"] = 689,
    ["release drafter"] = 578,
    rtx = 428,
    rustfmt = 434,
    samt = 436,
    samtrc = 437,
    ["sarif-1.0.0.json"] = 439,
    ["sarif-2.0.0.json"] = 440,
    ["sarif-2.1.0"] = 449,
    ["sarif-2.1.0-rtm.2"] = 441,
    ["sarif-2.1.0-rtm.3"] = 443,
    ["sarif-2.1.0-rtm.4"] = 445,
    ["sarif-2.1.0-rtm.5"] = 447,
    ["sarif-external-property-file-2.1.0"] = 450,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 442,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 444,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 446,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 448,
    ["schema.org - Action"] = 452,
    ["schema.org - ContactPoint"] = 453,
    ["schema.org - Place"] = 454,
    ["schema.org - Thing"] = 455,
    ["semantic-release"] = 458,
    ["servicehub.config.json"] = 554,
    ["servicehub.service.json"] = 553,
    ["settings.job"] = 461,
    ["sfdx-hardis configuration"] = 463,
    ["size-limit configuration"] = 465,
    ["skaffold.yaml"] = 618,
    ["skyuxconfig.json"] = 467,
    snapcraft = 468,
    ["stripe-app-local.json"] = 482,
    ["stripe-app.json"] = 481,
    swcrc = 605,
    ["task.json"] = 488,
    taskcat = 574,
    ["template.json"] = 491,
    ["templatsources.json"] = 492,
    ["theme.json"] = 495,
    ["tizen_workspace.json"] = 496,
    tldr = 497,
    tmLanguage = 498,
    tmuxinator = 562,
    ["transcend.yml"] = 504,
    ["trunk.yaml schema"] = 505,
    ["ts-force-config.json"] = 509,
    ["tsconfig.json"] = 506,
    ["tsd.json"] = 507,
    ["tsdrc.json"] = 508,
    ["tslint.json"] = 510,
    ...
    ["vega-lite.json"] = 523,
    ["vega.json"] = 522,
    ["venvironment-basic.yaml"] = 526,
    ["venvironment.yaml"] = 525,
    ["version.json"] = 527,
    ["vim-addon-info"] = 528,
    ["vs-2017.3.host.json"] = 530,
    ["vs-nesting.json"] = 531,
    ["vsls.json"] = 529,
    ["vss-extension.json"] = 535,
    ["vtesttree.yaml"] = 536,
    ["vtestunit.yaml"] = 537,
    ["webhint.io"] = 654,
    ["webjobpublishsettings.json"] = 543,
    ["webjobs-list.json"] = 542,
    ["xs-app.json"] = 570,
    ["xunit.runner.json"] = 552,
    yamllint = 593,
    zuul = 579,
    ["Žinoma"] = 587
  },
