...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 112,
    [".cryproj (generic)"] = 421,
    [".cryproj engine-5.2"] = 416,
    [".cryproj engine-5.3"] = 417,
    [".cryproj engine-5.4"] = 418,
    [".cryproj engine-5.5"] = 419,
    [".cryproj engine-dev"] = 420,
    [".csscomb.json"] = 114,
    [".csslintrc"] = 115,
    [".eslintrc"] = 152,
    [".esmrc.json"] = 145,
    ...
    [".vsext"] = 397,
    [".yarnrc.yml"] = 459,
    ["<div>RIOTS' studio configuration"] = 400,
    ["API Builder"] = 456,
    ["AVA Configuration Schema"] = 505,
    ...
    ["Azure Pipelines"] = 40,
    ["Azure Static Web Apps CLI configuration file"] = 354,
    ["Azure Static Web Apps configuration file"] = 353,
    ["Better Code Hub"] = 461,
    BizTalkServerApplicationSchema = 433,
    ...
    ["Butane config schema"] = 495,
    ["CICS TS resource overrides"] = 502,
    ["CMake Presets"] = 68,
    ["CSR Framework"] = 76,
    ...
    ["Error pages"] = 148,
    Esquio = 146,
    ["Estuary Flow Catalog Schema"] = 499,
    ["Expo SDK"] = 151,
    ...
    Goreleaser = 178,
    ["Goreleaser Pro"] = 179,
    ["Gradle Build Cache Node"] = 458,
    ["Gradle Enterprise"] = 457,
    ...
    ["JSON Feed"] = 216,
    ["JSON Resume"] = 319,
    ["JSON Schema Draft 2020-12"] = 412,
    ["JSON Schema Draft 4"] = 409,
    ["JSON Schema Draft 7"] = 410,
    ["JSON Schema Draft 8"] = 411,
    ...
    ["Netin Diagnostic System Template"] = 480,
    ...
    Opctl = 429,
    ["OpenWeather Current Weather API"] = 465,
    ["OpenWeather Road Risk API"] = 464,
    ...
    Packer = 284,
    ["Pipeline component"] = 474,
    ["PocketMine plugin.yml"] = 288,
    ["Pull Request Labeler"] = 310,
    Qodana = 488,
    ["RKE Cluster Configuration JSON Schema"] = 472,
    ["RKE Cluster Configuration YAML Schema"] = 471,
    Ray = 441,
    ["Read the Docs"] = 313,
    ["Red-DiscordBot Cog"] = 314,
    ["Red-DiscordBot Cog Repo"] = 315,
    Renovate = 320,
    RoadRunner = 321,
    SWADL = 363,
    ["Sapphire CLI Config"] = 322,
    ["SauceCTL Configuration"] = 477,
    ["Schema Catalog"] = 335,
    ["Scoop manifest"] = 340,
    ["Semgrep Rule"] = 341,
    ["Serverless Framework Configuration"] = 484,
    ["Settings.paf"] = 343,
    ["Shopware 6 Configuration"] = 485,
    ["Shopware CLI Extension Store Configuration"] = 486,
    ["Shopware CLI Project Store Configuration"] = 487,
    Solidarity = 348,
    ["Source Maps v3"] = 349,
    SpecIF = 350,
    ["Sponge Mixin configuration"] = 351,
    ["StackHawk Scanner Configuration"] = 483,
    ["StackHead CLI config"] = 355,
    ["StackHead module configuration"] = 356,
    ["StackHead project definition"] = 357,
    Stale = 358,
    ["Statamic Blueprint"] = 359,
    ["Stryker Mutator"] = 360,
    ["StyleCop Analyzers Configuration"] = 361,
    ["Swagger API 2.0"] = 364,
    ["Taskfile YAML Schema"] = 467,
    Taurus = 365,
    ["TestEnvironment.json"] = 371,
    Tikibase = 368,
    ["Traefik v2"] = 373,
    ["Traefik v2 File Provider"] = 374,
    Tye = 489,
    ["UI5 Manifest"] = 386,
    ["Ubuntu Server Autoinstall"] = 384,
    ["Uniswap Token List"] = 450,
    Updatecli = 496,
    ["User Journey Map YAML Schema"] = 470,
    V2Ray = 500,
    ["VSCode Code Snippets"] = 90,
    ["VSIX CLI publishing"] = 398,
    ["Vela Pipeline Configuration"] = 390,
    Vercel = 89,
    ["Web App Manifest"] = 402,
    ["Web types"] = 405,
    WebExtensions = 401,
    ["Webman package recipe"] = 503,
    ["Windows Package Manager Installer Manifest"] = 447,
    ["Windows Package Manager Locale Manifest"] = 448,
    ["Windows Package Manager Singleton Manifest"] = 446,
    ["Woodpecker pipeline config"] = 479,
    ["Xstate Machine Schema"] = 494,
    ["Yippee-Ki-JSON configuration YML"] = 452,
    ["angular.json"] = 8,
    ...
    ["openfin.json"] = 274,
    ["package.json"] = 282,
    ["package.manifest"] = 283,
    ["pattern.json"] = 286,
    pgap_yaml_input_reader = 285,
    ["plagiarize-me.yaml"] = 290,
    ["plagiarize.yaml"] = 289,
    ["portman.json"] = 291,
    ["prettierrc.json"] = 295,
    ["prisma.yml"] = 296,
    ["project-1.0.0-beta3.json"] = 298,
    ["project-1.0.0-beta4.json"] = 299,
    ["project-1.0.0-beta5.json"] = 300,
    ["project-1.0.0-beta6.json"] = 301,
    ["project-1.0.0-beta8.json"] = 302,
    ["project-1.0.0-rc1.json"] = 303,
    ["project-1.0.0-rc2.json"] = 304,
    ["project.json"] = 297,
    ["prometheus.json"] = 305,
    ["prometheus.rules.json"] = 306,
    ["proxies.json"] = 307,
    ["publiccode.yml"] = 308,
    ["pubspec.yaml"] = 309,
    ["pyrseas-0.8.json"] = 312,
    ["release drafter"] = 436,
    ["sarif-1.0.0.json"] = 323,
    ["sarif-2.0.0.json"] = 324,
    ["sarif-2.1.0"] = 333,
    ["sarif-2.1.0-rtm.2"] = 325,
    ["sarif-2.1.0-rtm.3"] = 327,
    ["sarif-2.1.0-rtm.4"] = 329,
    ["sarif-2.1.0-rtm.5"] = 331,
    ["sarif-external-property-file-2.1.0"] = 334,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 326,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 328,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 330,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 332,
    ["schema.org - Action"] = 336,
    ["schema.org - ContactPoint"] = 337,
    ["schema.org - Place"] = 338,
    ["schema.org - Thing"] = 339,
    ["service.datadog.yaml"] = 221,
    ["servicehub.config.json"] = 415,
    ["servicehub.service.json"] = 414,
    ["settings.job"] = 342,
    ["sfdx-hardis configuration"] = 344,
    ["size-limit configuration"] = 345,
    ["skaffold.yaml"] = 475,
    ["skyuxconfig.json"] = 346,
    snapcraft = 347,
    swcrc = 463,
    taskcat = 432,
    ["template.json"] = 366,
    ["templatsources.json"] = 367,
    ["theme.json"] = 369,
    tmLanguage = 370,
    ["trunk.yaml schema"] = 375,
    ["ts-force-config.json"] = 379,
    ["tsconfig.json"] = 376,
    ["tsd.json"] = 377,
    ["tsdrc.json"] = 378,
    ["tslint.json"] = 380,
    ...
    ["version.json"] = 391,
    ["vim-addon-info"] = 392,
    ["vs-2017.3.host.json"] = 394,
    ["vs-nesting.json"] = 395,
    ["vsls.json"] = 393,
    ["vss-extension.json"] = 399,
    ["webhint.io"] = 504,
    ["webjobpublishsettings.json"] = 404,
    ["webjobs-list.json"] = 403,
    ["xs-app.json"] = 428,
    ["xunit.runner.json"] = 413,
    yamllint = 451,
    zuul = 437,
    ["Žinoma"] = 445
  },
