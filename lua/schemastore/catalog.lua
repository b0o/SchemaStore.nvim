...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 15,
    AIConfig = 16,
    ["AMX Muse Program Descriptor"] = 1011,
    ["API Builder"] = 828,
    ["AVA Configuration"] = 890,
    ...
    ["Adobe UXP Manifest"] = 950,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    Air = 12,
    ["Airlock Microgateway"] = 17,
    ["Alacritty Configuration"] = 862,
    ["All Contributors configuration file"] = 915,
    ...
    ["Application list for a WinUtil"] = 993,
    ArchitectFX = 998,
    ["Argo Events"] = 31,
    ["Argo Workflows"] = 32,
    AssemblyScript = 35,
    ...
    ["Azure Pipelines"] = 68,
    ["Azure Static Web Apps CLI configuration file"] = 681,
    ["Azure Static Web Apps configuration file"] = 680,
    ["BOSH Deploy Config"] = 92,
    ["BX CI"] = 110,
    ["Bashly (bashly.yml)"] = 919,
    ["Bashly Settings (bashly-settings.yml)"] = 920,
    ["Better Code Hub"] = 832,
    ["Better Scripts"] = 111,
    Bigconfig = 85,
    ["Biome Formatter Config"] = 55,
    ["Bitmovin Encoding Template"] = 1004,
    BizTalkServerApplicationSchema = 800,
    Bleep = 112,
    ...
    ["Butane Config"] = 875,
    C4InterFlow = 1019,
    ["CGS Card Game Specification (cgs.json)"] = 955,
    ["CICS TS region tagging"] = 884,
    ["CICS TS resource import"] = 885,
    ["CICS TS resource model"] = 886,
    ["CICS TS resource overrides"] = 887,
    ["CMake Presets"] = 113,
    ["CNC Codes"] = 130,
    ["CRS WAF test file"] = 983,
    ["CRS WAF test platform overrides file"] = 984,
    ...
    ["Chamaleon environment"] = 1008,
    ["Chamaleon properties"] = 1009,
    ["Chamaleon template"] = 1007,
    Changesets = 213,
    Charmcraft = 122,
    Cheatsheets = 872,
    ...
    CityJSON = 125,
    ["Clawject config"] = 136,
    ["Cloud Foundry Application Manifest"] = 966,
    ["Cloud Run Spec v1"] = 988,
    ...
    Concord = 982,
    ["Configu .cfgu files"] = 971,
    ["Configu .configu file"] = 972,
    Conjure = 129,
    ["Container Structure Test"] = 814,
    Containerlab = 841,
    ["Contextive Glossary"] = 1033,
    Convex = 128,
    ["Crowdsec collection config"] = 222,
    ["Crowdsec parser config"] = 223,
    ["Crowdsec scenario config"] = 224,
    ["CumulusCI Config"] = 135,
    ["Custom Machinery Machine"] = 956,
    ["Custom Machinery Recipe"] = 957,
    ...
    ["DonateCaseBetterCasino menu"] = 1012,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 927,
    ["EAS config"] = 288,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 916,
    ["EasyVCR .NET"] = 289,
    ["Eidolon Resource"] = 999,
    ...
    ["GeoJSON.json latest"] = 879,
    GherKing = 883,
    ["GitHub Action"] = 319,
    ["GitHub Actions typing"] = 995,
    ...
    ["Goreleaser Pro"] = 348,
    Goss = 349,
    ["Gradle Build Cache Node"] = 830,
    ["Gradle Enterprise"] = 829,
    ...
    Hadolint = 810,
    Hammerkit = 840,
    ["Hardware Sentry Configuration"] = 895,
    Hatch = 811,
    Hayson = 362,
    ...
    ["JFrog File Spec"] = 392,
    ["JFrog Pipelines YML DSL"] = 904,
    ["JMeter DSL cli config"] = 393,
    JReleaser = 395,
    ["JSON Document Transform"] = 403,
    ["JSON Feed"] = 404,
    ["JSON Resume"] = 615,
    ["JSON Schema Draft 2020-12"] = 779,
    ["JSON Schema Draft 4"] = 776,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 937,
    ["JSON Schema Draft 7"] = 777,
    ["JSON Schema Draft 7 (unofficial strict)"] = 938,
    ["JSON Schema Draft 8 (2019-09)"] = 778,
    ["JSON-API"] = 402,
    ["JSON-e templates"] = 837,
    ["JSON-stat 2.0"] = 772,
    JSONPatch = 406,
    ...
    ["Metadata for a Cinnamon spice"] = 991,
    ["Metatype Configuration"] = 454,
    ["MetricsHub Configuration"] = 455,
    ["MetricsHub Connector Configuration"] = 456,
    ["Micro Editor Syntax"] = 928,
    ["Microsoft Band Web Tile"] = 457,
    ["Microsoft RulesEngine workflow rules"] = 979,
    ["Microsoft RulesEngine workflow rules list"] = 980,
    ["Minecraft Custom Main Menu Mod"] = 945,
    ...
    ["MongoDB Atlas Search Index Definition"] = 899,
    ["Monika Configuration"] = 897,
    ["Monoweave Configuration"] = 482,
    ["Motif config"] = 792,
    MultiQC = 1027,
    ["NOX Framework (Service)"] = 499,
    ["Netin Diagnostic System Template"] = 857,
    ["Netlify config"] = 490,
    ["Network-as-Code Data Model"] = 491,
    ["Nightwatch.js"] = 492,
    ["Node.js configuration"] = 797,
    ...
    ["OpenUtau ustx"] = 517,
    ["OpenWeather Current Weather API"] = 836,
    ["OpenWeather Road Risk API"] = 835,
    ...
    ["Pipeline component"] = 848,
    ["Plex Prerolls"] = 553,
    ["PocketMine plugin.yml"] = 550,
    ["Postman collection"] = 557,
    ["Preset list for a WinUtil"] = 994,
    ["Problem object RFC9457"] = 942,
    ...
    PyProject = 591,
    Pyright = 592,
    ["Python script metadata"] = 1029,
    Qgoda = 594,
    Qodana = 867,
    ["Qt Creator workspace file"] = 973,
    ["Quali Torque Blueprint Spec 2"] = 892,
    ["QueryFirst config file"] = 910,
    ["RKE Cluster Configuration JSON"] = 845,
    ["RKE Cluster Configuration YAML"] = 844,
    RadioHound = 585,
    Railway = 595,
    ["Rancher Fleet"] = 587,
    ["Rattler-build"] = 596,
    ...
    ["Render Blueprints"] = 843,
    RenderCV = 617,
    Renovate = 616,
    ["Replit config"] = 611,
    Restate = 1022,
    RoadRunner = 619,
    ["Rudder techniques"] = 948,
    Ruff = 613,
    ["Rust Project"] = 614,
    ["Rust toolchain"] = 623,
    ["SDMX data message"] = 649,
    ["SDMX metadata message"] = 648,
    ["SDMX structure message"] = 647,
    ["SIL Kit Participant Configuration"] = 659,
    ["SIL Kit Registry Configuration"] = 660,
    ["SPDX 2.3"] = 678,
    SWADL = 692,
    ["Safebox Config"] = 905,
    ["Sapphire CLI Config"] = 626,
    ["SauceCTL Configuration"] = 854,
    ["Schema Catalog"] = 641,
    ["Scoop manifest"] = 646,
    ["Semantic Data Fabric (SDF) file"] = 650,
    ["Semgrep Rule"] = 652,
    ["Serenity Code Generator (Sergen)"] = 653,
    ["Serverless Framework Configuration"] = 861,
    ["Serverless Workflow"] = 863,
    ["Settings for a Cinnamon spice"] = 990,
    ["Settings.paf"] = 655,
    ["Shopware 6 Configuration"] = 864,
    ["Shopware CLI Extension Store Configuration"] = 865,
    ["Shopware CLI Project Store Configuration"] = 866,
    ["Sigma Detection Rule"] = 657,
    ["Sigrid scope configuration file"] = 658,
    ["SkyPilot Task JSON"] = 949,
    ["Slack app manifest"] = 662,
    Solidarity = 667,
    ["Solution filters"] = 668,
    ["Source Maps v3"] = 669,
    Sourcery = 670,
    ["Speakeasy Generation Config File"] = 674,
    ["Speakeasy Lint Configuration File"] = 671,
    ["Speakeasy Test Generation Configuration File"] = 672,
    ["Speakeasy Workflow File"] = 673,
    SpecIF = 675,
    ["Sponge Mixin configuration"] = 676,
    StackBlitz = 682,
    ["StackHawk Scanner Configuration"] = 860,
    Stale = 683,
    ["Starlake Data Pipeline"] = 833,
    Starship = 684,
    ["Statamic Blueprint"] = 685,
    ["Stella configuration file"] = 686,
    ["Stryker Mutator"] = 689,
    ["StyleCop Analyzers Configuration"] = 690,
    ["Stylelint (.stylelintrc)"] = 691,
    ["Sublime Syntax"] = 906,
    ["Subsquid squid manifest"] = 951,
    ["Swagger API 2.0"] = 693,
    ["Synadia Connect Component"] = 694,
    TSON = 728,
    TSTyche = 729,
    ["Tab data for a LinUtil"] = 997,
    ["Tab list for a LinUtil"] = 996,
    Tach = 695,
    ["Tach Domain"] = 696,
    Talhelper = 698,
    ["Talisman configuration"] = 699,
    ["Taskfile config"] = 838,
    Taurus = 700,
    Tauticord = 701,
    Telefonistka = 1023,
    ["TestEnvironment.json"] = 711,
    ["TextMate Grammar"] = 710,
    ["Tier.run pricing.json"] = 704,
    Tikibase = 705,
    Tombi = 709,
    ["Traefik v2"] = 714,
    ["Traefik v2 File Provider"] = 715,
    ["Traefik v3"] = 716,
    ["Traefik v3 File Provider"] = 717,
    ["Travis CI (.travis.yml)"] = 713,
    Trident = 1021,
    ["TrueScript for *.tscript files"] = 720,
    ["Tugboat QA config.yml"] = 1018,
    TunnelHub = 941,
    Turborepo = 712,
    Tycho = 986,
    Tye = 868,
    ["Tyk Gateway - Open Source v5.7+"] = 1028,
    ["UET BuildConfig.json"] = 911,
    ["UI5 Manifest"] = 738,
    ["UNCORS configuration"] = 742,
    ["UTAM Page Object"] = 741,
    ["Ubuntu Server Autoinstall"] = 736,
    ["Uniswap Token List"] = 821,
    ["Universal Schedule Format"] = 743,
    ["Unreal Engine Uplugin"] = 912,
    ["Unreal Engine Uproject"] = 913,
    ["Updatecli Compose"] = 876,
    ["Updatecli Policy Manifest"] = 877,
    ["Updatecli Policy Metadata"] = 878,
    Uplift = 909,
    ["User Journey Map"] = 842,
    V2Ray = 882,
    ["VSCode Code Snippets"] = 188,
    ["VSIX CLI publishing"] = 761,
    Vector = 745,
    ["Vela Pipeline Configuration"] = 748,
    Vercel = 187,
    ["Version Bumper config"] = 751,
    ["Viash Component Config"] = 1025,
    ["Viash Package Config"] = 1026,
    Visivo = 939,
    Wake = 1020,
    ["Waku Config"] = 1000,
    ["Web App Manifest"] = 767,
    ["Web types"] = 770,
    WebExtensions = 766,
    ["Webman package recipe"] = 888,
    ["Windows Package Manager Installer Manifest"] = 817,
    ["Windows Package Manager Locale Manifest"] = 818,
    ["Windows Package Manager Singleton Manifest"] = 816,
    Winutil = 819,
    ["WireMock stub mapping"] = 1003,
    ["Woodpecker pipeline config"] = 856,
    ["Wrangler CLI"] = 771,
    ["Xstate Machine"] = 874,
    ["Yandex Workflow Language"] = 992,
    ["Yarn Config (.yarnrc.yml)"] = 831,
    ["Yippee-Ki-JSON configuration YML"] = 823,
    ["YouTrack App"] = 989,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 18,
    apko = 943,
    ...
    ["behat.yml"] = 94,
    ["bigquery-table"] = 84,
    ["bioimageio resource description"] = 959,
    ...
    ["crowdin.yml"] = 221,
    ["ctfd-setup configuration file"] = 1010,
    ["custom-elements.json"] = 931,
    ["cypress.json"] = 225,
    ...
    ["gematik health care insurance list"] = 1016,
    ["gematik health care patient list"] = 1013,
    ["gematik health care provider institution list"] = 1015,
    ["gematik health care provider list"] = 1014,
    ["gematik tiger test environment configuration"] = 1017,
    ["gitlab-ci"] = 327,
    ["global.json"] = 343,
    ...
    ["lint-staged (.lintstagedrc)"] = 787,
    ["local.settings.json"] = 444,
    ["localazy.json"] = 445,
    ["lotus.yaml"] = 443,
    ["lsdlschema.json"] = 446,
    ["markdown-link-check"] = 851,
    maturin = 852,
    mboats = 859,
    ["micro-settings.json"] = 923,
    ["mimetypes.json"] = 458,
    ["mirrord config"] = 788,
    mise = 789,
    ["mkdocs.yml"] = 478,
    ...
    ["plagiarize.yaml"] = 551,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1006,
    ["podbard.yaml"] = 554,
    ["portman.json"] = 555,
    ["prefect.toml"] = 563,
    ["prettierrc.json"] = 564,
    ...
    ["rc3 settings"] = 602,
    ["release drafter"] = 804,
    ["release-please-config.json"] = 607,
    ["release-please-manifest.json"] = 608,
    ["release-plz.toml"] = 609,
    ["renv.lock"] = 618,
    ["rivet.yaml"] = 946,
    rockcraft = 620,
    runny = 621,
    ...
    samt = 624,
    samtrc = 625,
    ["sarif-1.0.0.json"] = 627,
    ["sarif-2.0.0.json"] = 628,
    ["sarif-2.1.0"] = 638,
    ["sarif-2.1.0-rtm.2"] = 629,
    ["sarif-2.1.0-rtm.3"] = 631,
    ["sarif-2.1.0-rtm.4"] = 633,
    ["sarif-2.1.0-rtm.5"] = 635,
    ["sarif-2.1.0-rtm.6"] = 636,
    ["sarif-external-property-file-2.1.0"] = 639,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 630,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 632,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 634,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 637,
    ["scalingo.json configuration"] = 640,
    ["schema.org - Action"] = 642,
    ["schema.org - ContactPoint"] = 643,
    ["schema.org - Place"] = 644,
    ["schema.org - Thing"] = 645,
    ["secrethub.yml"] = 926,
    ["semantic-release"] = 651,
    ["servicehub.config.json"] = 782,
    ["servicehub.service.json"] = 781,
    ["settings.job"] = 654,
    ["sfdx-hardis configuration"] = 656,
    ["shard.yml"] = 962,
    ["size-limit configuration"] = 661,
    ["skaffold.yaml"] = 849,
    ["skyuxconfig.json"] = 663,
    snapcraft = 664,
    ["snowflake-config"] = 665,
    ["snowflake-connections"] = 666,
    ["spicepod.yaml"] = 981,
    ["sqlc configuration"] = 679,
    ["stripe-app-local.json"] = 688,
    ["stripe-app.json"] = 687,
    swcrc = 834,
    ["task.json"] = 697,
    taskcat = 799,
    ["template.json"] = 702,
    ["templatsources.json"] = 703,
    ["theme.json"] = 706,
    ["tizen_workspace.json"] = 707,
    tldr = 708,
    tmuxinator = 785,
    ["transcend.yml"] = 718,
    ...
    ["vega-lite.json"] = 747,
    ["vega.json"] = 746,
    ["venvironment-basic.yaml"] = 750,
    ["venvironment.yaml"] = 749,
    version = 1024,
    ["version.json"] = 752,
    ["vhwdebugger-binding.yaml"] = 754,
    ["vim-addon-info"] = 755,
    ["vs-2017.3.host.json"] = 757,
    ["vs-nesting.json"] = 758,
    ["vsls.json"] = 756,
    ["vss-extension.json"] = 762,
    vtcfg = 1030,
    ["vtesttree.yaml"] = 763,
    ["vtestunit.yaml"] = 764,
    ["warp-keysets.json"] = 932,
    ["warp-themes.json"] = 933,
    ["warp-workflows.json"] = 934,
    ["webhint.io"] = 889,
    ["webjobpublishsettings.json"] = 769,
    ["webjobs-list.json"] = 768,
    ["well-known-fursona"] = 969,
    ["xs-app.json"] = 794,
    ["xunit.runner.json"] = 780,
    yamllint = 822,
    ["zerops.io import file"] = 978,
    ["zerops.yml"] = 977,
    zuul = 805,
    ["Žinoma"] = 815
  },
