...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1030,
    [".nodehawkrc"] = 656,
    [".npmpackagejsonlintrc"] = 661,
    [".omletrc"] = 1211,
    [".phrase.yml"] = 739,
    [".phraseapp.yml"] = 740,
    [".pmbot.yml"] = 724,
    [".postcssrc"] = 733,
    [".powerpages-web-template-manifest"] = 735,
    [".pre-commit-config.yml"] = 736,
    [".pre-commit-hooks.yml"] = 737,
    [".putout.json"] = 773,
    [".rehyperc"] = 798,
    [".remarkrc"] = 802,
    [".sprite files"] = 900,
    ...
    AIConfig = 45,
    ["AMX Muse Program Descriptor"] = 1260,
    ["API Builder"] = 1066,
    ["AVA Configuration"] = 1130,
    ["AWS AppConfig Feature Flags-v1"] = 79,
    ["AWS CDK cdk.json"] = 286,
    ["AWS CloudFormation"] = 287,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 288,
    ["AWS Copilot Manifest"] = 1299,
    ["AWS SAM CLI Samconfig"] = 289,
    Acton = 1350,
    ["Adobe UXP Manifest"] = 1193,
    ["Aerleon Network & Service Definitions"] = 27,
    ["Aerleon Policy"] = 28,
    ["Agent Permission Policy"] = 1339,
    ["AgentCore CLI"] = 1340,
    AgentLoopKit = 1341,
    Aider = 1289,
    Air = 30,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1310,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1309,
    ["Airlock Microgateway"] = 46,
    ["Alacritty Configuration"] = 1102,
    ["AlgoVoi Compliance Receipt v1"] = 16,
    ["All Contributors configuration file"] = 1156,
    ["Amazon S3 bucket CORS"] = 18,
    Anodizer = 472,
    ["Ansible Argument Specs"] = 455,
    ["Ansible Collection Galaxy"] = 462,
    ["Ansible Execution Environment"] = 452,
    ["Ansible Inventory"] = 461,
    ["Ansible Meta"] = 453,
    ["Ansible Meta Runtime"] = 454,
    ["Ansible Navigator Configuration"] = 464,
    ["Ansible Playbook"] = 459,
    ["Ansible Requirements"] = 456,
    ["Ansible Rulebook"] = 460,
    ["Ansible Tasks File"] = 458,
    ["Ansible Vars File"] = 457,
    ["Ansible-lint Configuration"] = 463,
    Any = 1221,
    ...
    ["Application list for a WinUtil"] = 1239,
    ArchitectFX = 1244,
    ["Argo CD"] = 65,
    ["Argo Events"] = 66,
    ["Argo Workflows"] = 67,
    AssemblyScript = 70,
    AsyncAPI = 73,
    ["AsyncAPI Tool File"] = 74,
    ["Atmos Manifests"] = 75,
    ["Aurora Agile Meta-Framework"] = 76,
    AutoAPICase = 1166,
    ["Avro Avsc"] = 77,
    ["Awesome Repositories"] = 78,
    ["Azure Container App template for defining an immutable revision"] = 81,
    ["Azure DevOps extension manifest"] = 84,
    ["Azure Device Update for IoT Hub import manifest"] = 82,
    ["Azure Device Update for IoT Hub update manifest"] = 83,
    ["Azure IoT Edge deployment"] = 87,
    ["Azure IoT Edge deployment template"] = 88,
    ["Azure IoT EdgeAgent deployment"] = 85,
    ["Azure IoT EdgeHub deployment"] = 86,
    ["Azure IoT Operations Wasm Graph Config"] = 1308,
    ["Azure IoT Operations connector metadata"] = 1305,
    ["Azure Landing Zones Library archetype definition"] = 92,
    ["Azure Landing Zones Library archetype override"] = 93,
    ["Azure Landing Zones Library architecture definition"] = 91,
    ["Azure Landing Zones Library metadata"] = 89,
    ["Azure Landing Zones Library policy default values"] = 90,
    ["Azure Pipelines"] = 125,
    ["Azure Static Web Apps CLI configuration file"] = 904,
    ["Azure Static Web Apps configuration file"] = 903,
    BMML = 1327,
    ["BOSH BPM Config"] = 151,
    ["BOSH CPI Config"] = 152,
    ["BOSH Deploy Config"] = 153,
    ["BX CI"] = 174,
    ["Bacon config"] = 10,
    ["Barba-CV"] = 94,
    ["Bashly (bashly.yml)"] = 1160,
    ["Bashly Settings (bashly-settings.yml)"] = 1161,
    Bento = 1326,
    ["Better Code Hub"] = 1071,
    ["Better Scripts"] = 175,
    Bigconfig = 144,
    ["Biome Formatter Config"] = 95,
    ["Bitmovin Encoding Template"] = 1253,
    BizTalkServerApplicationSchema = 1037,
    Bleep = 176,
    ["Block Protocol Metadata"] = 173,
    ["Bluebricks blueprint config"] = 1332,
    ["Boyka Framework"] = 154,
    ["Bpod Finite-State Machine"] = 97,
    Briefcase = 1043,
    ["Build Info"] = 164,
    Buildkite = 166,
    ["Bukkit plugin.yml"] = 165,
    ["BungeeCord plugin.yml"] = 171,
    ["Burnless SRE config"] = 3,
    ["Butane Config"] = 1115,
    C4InterFlow = 1268,
    ["CDK Environment Manager, concrete environment configuration"] = 1292,
    ["CDK Environment Manager, concrete environments definition"] = 1291,
    ["CDK Environment Manager, environment definition"] = 1290,
    ["CGS Card Game Specification (cgs.json)"] = 1198,
    ["CICS TS region tagging"] = 1124,
    ["CICS TS resource import"] = 1125,
    ["CICS TS resource model"] = 1126,
    ["CICS TS resource overrides"] = 1127,
    ["CMake Presets"] = 177,
    ["CNC Codes"] = 199,
    ["CRS WAF test file"] = 1228,
    ["CRS WAF test platform overrides file"] = 1229,
    ["CSS Comb (.csscomb.json)"] = 315,
    ["CSS Lint (.csslintrc)"] = 316,
    ["CSpell (cspell.json)"] = 314,
    ["CVE Record Format"] = 211,
    CWL = 1204,
    ["Cache Warmup config"] = 178,
    ["Caido Proxy Configuration"] = 1364,
    ["Calqulus pipeline"] = 179,
    ["Camel YAML DSL"] = 180,
    ["Cannon TOML"] = 181,
    Carafe = 182,
    ["Cargo Make"] = 184,
    ["Cargo Manifest"] = 183,
    ["Catalog Info Backstage"] = 185,
    ["Chamaleon environment"] = 1257,
    ["Chamaleon properties"] = 1258,
    ["Chamaleon template"] = 1256,
    Changepacks = 1319,
    Changesets = 298,
    Changie = 186,
    Charmcraft = 187,
    Cheatsheets = 1112,
    ["ChordPro Configuration"] = 188,
    ["Chrome Extension"] = 279,
    ["Chromia Model"] = 189,
    ["Chromia Seeder Module Config"] = 191,
    ["Chromia Seeder Root Config"] = 190,
    ["Cinnamon Spice info.json"] = 105,
    ["CircleCI config.yml"] = 250,
    ["Citation File Format"] = 300,
    ["Citrus test case"] = 193,
    CityJSON = 194,
    ["Claude Code Keybindings"] = 206,
    ["Claude Code Plugin Manifest"] = 207,
    ["Claude Code Plugin Marketplace"] = 208,
    ["Claude Code Settings"] = 209,
    ["Clawject config"] = 205,
    ["Cloud Foundry Application Manifest"] = 1210,
    ["Cloud Run Spec v1"] = 1234,
    ["Cloud.gov Workshop Configuration"] = 106,
    ["CloudCannon Configuration"] = 111,
    ["CloudCannon Configuration (Collection Structures)"] = 120,
    ["CloudCannon Configuration (Collections)"] = 119,
    ["CloudCannon Configuration (Editables)"] = 118,
    ["CloudCannon Configuration (Inputs)"] = 113,
    ["CloudCannon Configuration (Snippets Definitions)"] = 117,
    ["CloudCannon Configuration (Snippets Imports)"] = 116,
    ["CloudCannon Configuration (Snippets)"] = 115,
    ["CloudCannon Configuration (Structure Value)"] = 114,
    ["CloudCannon Configuration (Structures)"] = 112,
    ["CloudEvents specification"] = 195,
    ["Code Climate"] = 251,
    CodeCV = 109,
    CodeRabbit = 108,
    ["CodeShip Pro services configuration files"] = 268,
    ["CodeShip Pro steps configuration files"] = 269,
    ["Codecov configuration files"] = 267,
    Codex = 259,
    ["Codex Hooks"] = 260,
    ["Codex Plugin Manifest"] = 261,
    ["Codex Skill Metadata"] = 262,
    CodifyCLI = 110,
    Codux = 264,
    ["Cog config file"] = 200,
    ["Commandbox Box.json"] = 201,
    ["Commandbox Server.json"] = 202,
    ["Common Catalog Data"] = 277,
    ["Common Package Specification"] = 203,
    Concord = 1227,
    ["Configu .cfgu files"] = 1215,
    ["Configu .configu file"] = 1216,
    Conjure = 198,
    ["Container Structure Test"] = 1051,
    Containerlab = 1080,
    ["Contextive Glossary"] = 1284,
    ContractGuard = 1081,
    Convex = 197,
    ["Crowdsec collection config"] = 309,
    ["Crowdsec parser config"] = 310,
    ["Crowdsec scenario config"] = 311,
    ["CumulusCI Config"] = 204,
    ["Cursor Agent Environment"] = 1337,
    ["Custom Machinery Machine"] = 1199,
    ["Custom Machinery Recipe"] = 1200,
    ["Cycle Stack File"] = 212,
    CycloneDX = 213,
    ["DWP Exchange - catalogue entry"] = 360,
    ["DWP Exchange - gateway"] = 358,
    ["DWP Exchange - meta"] = 359,
    ["Dart Build Config (dart-build.json)"] = 317,
    ["Dart Test Config (dart-test.json)"] = 318,
    ["DashLord Configuration"] = 319,
    ["Data Contract Specification"] = 320,
    ["Data Product Specification"] = 321,
    ["DataYoga Connections"] = 214,
    ["DataYoga Job"] = 215,
    ["Datadog Continuous Testing"] = 559,
    ["Datadog Service Definition"] = 560,
    ["Datadog Software Catalog"] = 561,
    ["Datahub Ingestion Recipe"] = 1131,
    ["Debian Upstream Metadata file"] = 222,
    DebtLens = 223,
    ["Deck config"] = 224,
    ["Declarative Automation Bundles"] = 1177,
    ["DeepMatch deeplinks spec"] = 225,
    ["Dein Config"] = 226,
    ["Deno Config (deno.json)"] = 327,
    ["Dependency cruiser"] = 227,
    ["DeployStack Configuration"] = 228,
    ["Deployah Configuration"] = 1307,
    ["Deployer Recipe"] = 330,
    ["Deta Spacefile"] = 229,
    ["Detekt Config (detekt.yml)"] = 331,
    ["Devbox Config"] = 230,
    ["Devbox Plugin"] = 231,
    Devfile = 357,
    Devup = 1320,
    DipDup = 1230,
    ["Discord Webhook"] = 332,
    ["DocFx Config (docfx.json)"] = 337,
    ["Docker Desktop extension metadata"] = 334,
    ["Docs MCP Manifest"] = 338,
    Dofigen = 339,
    ["Dolittle Artifacts"] = 340,
    ["Dolittle Bounded Context Configuration"] = 341,
    ["Dolittle Event Horizons Configuration"] = 342,
    ["Dolittle Resources Configuration"] = 343,
    ["Dolittle Server Configuration"] = 344,
    ["Dolittle Tenant Map Configuration"] = 346,
    ["Dolittle Tenants Configuration"] = 345,
    ["Dolittle Topology"] = 347,
    ["DonateCaseBetterCasino menu"] = 1261,
    ["Drupal Breakpoints"] = 232,
    ["Drupal Config"] = 244,
    ["Drupal Info"] = 233,
    ["Drupal Layouts"] = 234,
    ["Drupal Libraries"] = 235,
    ["Drupal Links Action"] = 236,
    ["Drupal Links Contextual"] = 237,
    ["Drupal Links Menu"] = 238,
    ["Drupal Links Task"] = 239,
    ["Drupal Migration"] = 240,
    ["Drupal Permissions"] = 241,
    ["Drupal Recipe"] = 242,
    ["Drupal Routing"] = 243,
    ["Drupal Services"] = 245,
    ["Drush site aliases"] = 353,
    ["Dynamic Bash Aliases (.aliases)"] = 1168,
    ["EAS config"] = 399,
    ["ECA - Editor Code Assistant"] = 362,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1157,
    ["ESLint Suppressions"] = 404,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1304,
    ["EasyVCR .NET"] = 401,
    ["Eidolon Resource"] = 1245,
    ["Elgato Stream Deck"] = 365,
    Elm = 1232,
    ["Embrace Config"] = 1143,
    Emmet = 1233,
    Endurica = 1181,
    ["Enonic XP API descriptor"] = 368,
    ["Enonic XP Admin Extension descriptor"] = 369,
    ["Enonic XP Admin Tool descriptor"] = 370,
    ["Enonic XP Application descriptor"] = 371,
    ["Enonic XP CMS descriptor"] = 372,
    ["Enonic XP Content Type descriptor"] = 373,
    ["Enonic XP Form Fragment descriptor"] = 374,
    ["Enonic XP ID Provider descriptor"] = 375,
    ["Enonic XP Layout descriptor"] = 376,
    ["Enonic XP Macro descriptor"] = 377,
    ["Enonic XP Mixin descriptor"] = 378,
    ["Enonic XP Page descriptor"] = 379,
    ["Enonic XP Part descriptor"] = 380,
    ["Enonic XP Service descriptor"] = 381,
    ["Enonic XP Site descriptor"] = 382,
    ["Enonic XP Style descriptor"] = 383,
    ["Enonic XP Task descriptor"] = 384,
    ["Enonic XP Webapp descriptor"] = 385,
    ["Enterprise Contract Policy Spec"] = 366,
    ["Envelope Team Definition"] = 1349,
    ["Envilder Map File"] = 367,
    ["Erda Pipeline"] = 1206,
    ["Erda Runtime"] = 1207,
    ["Espanso config.yml"] = 1330,
    ["Espanso match.yml"] = 1329,
    Esquio = 387,
    ["Estuary Flow Catalog"] = 1121,
    ["Ethereum ERC1155"] = 1343,
    ["Ethereum ERC721"] = 1342,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 392,
    ["EveryVoice TTS Toolkit Data Configuration"] = 393,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 397,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 396,
    ["EveryVoice TTS Toolkit Text Configuration"] = 394,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 395,
    ["Evolving Resolutive Process notation"] = 1306,
    ["Expo SDK"] = 398,
    ["Expoot app config"] = 400,
    ["F-Droid Data metadata"] = 406,
    ["FasterCI Configuration"] = 126,
    ["Fence configuration"] = 127,
    FiQuS = 410,
    Firebase = 408,
    ["Flatpak Builder Manifest"] = 411,
    ["FlexGet Config"] = 412,
    ["Flow.json Configurations"] = 1203,
    ["Fossa configuration file"] = 419,
    ["Fossa's fossa-deps file"] = 420,
    ["Foundry VTT - Base package Manifest"] = 414,
    ["Foundry VTT - Module Manifest"] = 415,
    ["Foundry VTT - System Data Template"] = 418,
    ["Foundry VTT - System Manifest"] = 416,
    ["Foundry VTT - World Manifest"] = 417,
    ["Foxx Manifest"] = 128,
    ["Freifunk.de Community API"] = 131,
    ["Frogbot Config"] = 132,
    ["G2P Mapping Configuration"] = 426,
    GAMA = 427,
    ["GCP Blueprint Metadata"] = 430,
    Gaspar = 428,
    ["GatewayCore API Gateway"] = 429,
    ["Gemini CLI settings"] = 431,
    ["GeoJSON.json latest"] = 1119,
    GherKing = 1123,
    ["GitHub Action"] = 439,
    ["GitHub Actions typing"] = 1241,
    ["GitHub Discussion"] = 440,
    ["GitHub Funding"] = 441,
    ["GitHub Issue Template configuration"] = 442,
    ["GitHub Issue Template forms"] = 443,
    ["GitHub Pages Jekyll"] = 444,
    ["GitHub Workflow"] = 445,
    ["GitHub Workflow Template Properties"] = 446,
    ["GitHub automatically generated release notes configuration"] = 447,
    ["GitLab Agent for Kubernetes configuration"] = 1195,
    GitResume = 451,
    GitVersion = 434,
    ["Gitea Issue Template configuration"] = 437,
    ["Gitea Issue Template forms"] = 438,
    Gitleaks = 435,
    ["Gitpod Automations"] = 449,
    ["Gitpod Configuration"] = 450,
    ["Glamour style"] = 432,
    ["GlazeWM settings"] = 1197,
    ["Global Privacy Control"] = 433,
    Goblet = 1176,
    ["Golangci-lint Configuration"] = 466,
    ["Golangci-lint Custom Plugins Configuration"] = 467,
    ["Google Chrome Related Website Sets"] = 409,
    ["Google Cloud Workflows"] = 285,
    ["Google Digital Assetlinks"] = 1285,
    Goreleaser = 470,
    ["Goreleaser Pro"] = 471,
    Goss = 473,
    ["Gradle Build Cache Node"] = 1069,
    ["Gradle Enterprise"] = 1068,
    ["Grafana 5.x Dashboard"] = 474,
    ["GraphQL Code Generator"] = 479,
    ["GraphQL Config"] = 478,
    ["GraphQL Mesh"] = 477,
    ["GroovyLint configuration"] = 480,
    ["Grunt JSHint task"] = 484,
    ["Grunt Watch task"] = 485,
    ["Grunt base task"] = 486,
    ["Grunt clean task"] = 482,
    ["Grunt copy task"] = 481,
    ["Grunt cssmin task"] = 483,
    HEMTT = 1033,
    Hadolint = 1047,
    Hammerkit = 1079,
    ["Hardware Sentry Configuration"] = 1135,
    ["Hashgraph Online Skill Manifest"] = 6,
    ["HashiCorp Vault"] = 487,
    Hatch = 1048,
    Hayson = 489,
    ["Haystack Pipeline"] = 490,
    ["Hazelcast 5 Configuration"] = 491,
    ["Hecate Input Schema"] = 1296,
    ["Helm Chart.lock"] = 247,
    ["Helm Chart.yaml"] = 246,
    ["Helm Unittest Test Suite"] = 248,
    ["Heloisa Assistant Plugins Marketplace"] = 1371,
    ["Hex file"] = 249,
    ["Home Assistant Integration Manifest"] = 493,
    ["Homer dashboard configuration"] = 494,
    Hugo = 1111,
    ["Hugo Theme"] = 1110,
    ["Hulak Configuration"] = 501,
    ["Hyperfoil benchmark configuration"] = 500,
    ["IBM Zapp document"] = 502,
    ["IBM zCodeFormatSettings"] = 503,
    ["IMG Catapult PSP"] = 508,
    ["IVMS101 by CODE Protocol"] = 1196,
    ["Infinispan Configuration"] = 510,
    ["Infinispan Server Configuration"] = 511,
    Infrahub = 512,
    Istanbul = 1139,
    ["JDownloader2 crawler multi-rules"] = 526,
    ["JDownloader2 crawler single-rules"] = 525,
    ["JFrog Applications Config"] = 527,
    ["JFrog File Spec"] = 528,
    ["JFrog Pipelines YML DSL"] = 1145,
    ["JMeter DSL cli config"] = 529,
    JReleaser = 532,
    ["JSON Document Transform"] = 540,
    ["JSON Feed"] = 541,
    ["JSON Resume"] = 810,
    ["JSON Schema Draft 2020-12"] = 1013,
    ["JSON Schema Draft 4"] = 1010,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1178,
    ["JSON Schema Draft 7"] = 1011,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1179,
    ["JSON Schema Draft 8 (2019-09)"] = 1012,
    ["JSON-API"] = 539,
    ["JSON-e templates"] = 1076,
    ["JSON-stat 2.0"] = 1006,
    JSONPatch = 543,
    ["JSR Package Config (jsr.json)"] = 533,
    Jarl = 1312,
    Jasmine = 520,
    Jekyll = 521,
    ["Jenkins X Pipelines"] = 522,
    ["Jenkins X Requirements"] = 523,
    Jest = 524,
    Jocker = 530,
    ["Jovo Language Models"] = 531,
    ["Jujutsu (jj) VCS config"] = 1298,
    ["KIMMDY config file"] = 554,
    ["KODE/CI build.yaml"] = 1141,
    ["KSP-AVC"] = 1007,
    ["KSP-CKAN"] = 1008,
    ["KSP-NetKAN"] = 1009,
    KSY = 1208,
    KSail = 424,
    ["KYA Manifest"] = 1209,
    ["Karakum configuration file"] = 421,
    Kas = 546,
    ["Kestra flow file"] = 555,
    ["Keycloak REST API"] = 1148,
    ["Knative Functions - func.yaml"] = 422,
    Knip = 423,
    ["Knowledge Unit"] = 563,
    ["Kometa (nightly) config file"] = 557,
    ["Kometa config file"] = 556,
    ["Kong DBLess config"] = 1142,
    KrakenD = 558,
    ["Kubri Configuration"] = 566,
    LOOBin = 582,
    ["Lake configuration file"] = 1301,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 290,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 291,
    ["Landing Zone Accelerator on AWS - Global Config"] = 292,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 293,
    ["Landing Zone Accelerator on AWS - Network Config"] = 294,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 295,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 296,
    ["Landing Zone Accelerator on AWS - Security Config"] = 297,
    ["Lando (landofile)"] = 121,
    ["LangGraph Platform configuration"] = 1220,
    ["Language configuration"] = 1219,
    Lefthook = 571,
    ["Liferay client-extension.yaml"] = 578,
    ["LinkML Metamodel"] = 580,
    Liquibase = 1086,
    ["Liquibase Flow File"] = 1087,
    ["Lively Properties"] = 581,
    ["Lobe AI Agent"] = 123,
    Loki = 124,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 625,
    ["MS2Rescore Configuration"] = 633,
    ["MSTest testconfig.json"] = 634,
    ["Madge configuration"] = 588,
    ["Madness (madness.yml)"] = 1159,
    ["Mado configuration"] = 589,
    ["Maestro Flow"] = 590,
    ["Mail Servers Configuration"] = 1333,
    ["MapEHR Mapping"] = 591,
    Markdownlint = 1090,
    ["Mason Registry"] = 1093,
    ["MegaLinter Custom Flavor"] = 594,
    ["MegaLinter configuration"] = 593,
    ["MegaLinter descriptor"] = 595,
    Melange = 1186,
    ["Meltano project definition"] = 596,
    ["Mergify Configuration"] = 635,
    ["Mermaid config"] = 1,
    ["Metadata for a Bazel module"] = 597,
    ["Metadata for a Cinnamon spice"] = 1237,
    ["Metatype Configuration"] = 598,
    ["MetricsHub Configuration"] = 599,
    ["MetricsHub Connector Configuration"] = 600,
    ["Micro Editor Syntax"] = 1169,
    ["Microsoft Band Web Tile"] = 601,
    ["Microsoft RulesEngine workflow rules"] = 1224,
    ["Microsoft RulesEngine workflow rules list"] = 1225,
    ["Minecraft Custom Main Menu Mod"] = 1187,
    ["Minecraft Data Pack Advancement"] = 603,
    ["Minecraft Data Pack Biome"] = 604,
    ["Minecraft Data Pack Configured Carver"] = 605,
    ["Minecraft Data Pack Damage Type"] = 606,
    ["Minecraft Data Pack Dimension"] = 608,
    ["Minecraft Data Pack Dimension Type"] = 607,
    ["Minecraft Data Pack Item Modifier"] = 609,
    ["Minecraft Data Pack Loot Table"] = 610,
    ["Minecraft Data Pack Metadata"] = 611,
    ["Minecraft Data Pack Predicate"] = 612,
    ["Minecraft Data Pack Recipe"] = 613,
    ["Minecraft Data Pack Tag"] = 614,
    ["Minecraft Data Pack Template Pool"] = 615,
    ["Minecraft Data Pack Trim Material"] = 620,
    ["Minecraft Data Pack Trim Pattern"] = 621,
    ["Minecraft Resource Pack Lang"] = 616,
    ["Minecraft Resource Pack Particle"] = 617,
    ["Minecraft Resource Pack Texture Mcmeta"] = 619,
    ["Minecraft Resourcepack Sounds"] = 618,
    ["MockServer Expectation"] = 627,
    ["MockServer Expectations"] = 628,
    ModuleAssembler = 623,
    ["Monade CLI Stack Configuration"] = 638,
    ["MongoDB Atlas Search Index Definition"] = 1140,
    ["Monika Configuration"] = 1138,
    ["Monoweave Configuration"] = 632,
    ["Motif config"] = 1029,
    MultiQC = 1278,
    ["NOX Framework (Service)"] = 660,
    ["Netin Diagnostic System Template"] = 1097,
    ["Netlify config"] = 641,
    ["Network-as-Code Data Model"] = 642,
    ["Next Gen UI Agent A2A Server Configuration"] = 643,
    ["Next Gen UI Agent Configuration"] = 645,
    ["Next Gen UI Agent MCP Server Configuration"] = 644,
    ["Nightwatch.js"] = 652,
    ["Nika workflow"] = 657,
    ["Node.js configuration"] = 1034,
    ["NueJS configuration file"] = 665,
    ["Nuitka Package Config"] = 1201,
    ["Nullstone config"] = 667,
    ["OKF Graph"] = 1372,
    ["ONe's changelog entry"] = 686,
    ["ONe's service descriptor"] = 685,
    ["ORT Server repository environment configuration"] = 696,
    ["OSCAL Assessment Plan (AP)"] = 698,
    ["OSCAL Assessment Results (AR)"] = 699,
    ["OSCAL Catalog"] = 700,
    ["OSCAL Component Definition (CDef)"] = 701,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 702,
    ["OSCAL Profile"] = 703,
    ["OSCAL System Security Plan (SSP)"] = 704,
    ["OSS Review Toolkit configuration"] = 705,
    ["OSS Review Toolkit curation"] = 706,
    ["OSS Review Toolkit package configuration"] = 707,
    ["OSS Review Toolkit project package manager definition"] = 708,
    ["OSS Review Toolkit repository configuration"] = 709,
    ["OSS Review Toolkit resolutions"] = 710,
    ["October CMS columns"] = 671,
    ["October CMS fields"] = 672,
    ["Oh My Posh"] = 674,
    Okteto = 675,
    ["Ona Automations"] = 677,
    Opctl = 1032,
    ["Open Data Contract Standard (ODCS)"] = 690,
    ["Open Data Product Standard (ODPS)"] = 691,
    ["Open Know-How"] = 1283,
    OpenDecree = 1347,
    ["OpenDecree Configuration"] = 1348,
    ["OpenRewrite Resource"] = 688,
    OpenSRM = 692,
    OpenStatus = 1294,
    ["OpenTelemetry Declarative Configuration"] = 689,
    ["OpenUtau character yaml"] = 682,
    ["OpenUtau ustx"] = 683,
    ["OpenWeather Current Weather API"] = 1075,
    ["OpenWeather Road Risk API"] = 1074,
    ["Ory Hydra configuration"] = 499,
    ["Ory Keto configuration"] = 562,
    ["Ory Kratos configuration"] = 697,
    ["Ory Oathkeeper configuration"] = 669,
    ["Outblocks App configuration"] = 694,
    ["Outblocks database table"] = 695,
    ["Outblocks project configuration"] = 693,
    PDM = 718,
    POPxf = 730,
    ["POPxf Correlations"] = 731,
    ["PRML manifest"] = 738,
    Packer = 714,
    PactSpec = 715,
    Panache = 716,
    Pantsbuild = 1155,
    ["Paper paper-plugin.yml"] = 717,
    ["Pipeline component"] = 1088,
    ["Platform.sh application"] = 12,
    ["Platform.sh routes"] = 13,
    ["Platform.sh services"] = 14,
    ["Plex Prerolls"] = 728,
    ["PocketMine plugin.yml"] = 725,
    ["Podman Desktop Extension"] = 1366,
    ["Postman collection"] = 734,
    ["Power Pages Configuration"] = 1295,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1240,
    ["ProActions AI-Kit Configuration"] = 746,
    ["ProActions AI-Kit Configuration for Menus"] = 748,
    ["ProActions AI-Kit Configuration for Sections"] = 750,
    ["ProActions AI-Kit Configuration for Services"] = 747,
    ["ProActions AI-Kit Configuration for Steps"] = 751,
    ["ProActions AI-Kit Configuration for Templates"] = 749,
    ["Problem object RFC9457"] = 1184,
    ["Problem package format"] = 752,
    ["Problem package generators"] = 753,
    ["Problem package submissions"] = 754,
    ["Problem package test group metadata"] = 755,
    Pterodactyl = 1134,
    ["Pull Request Labeler"] = 772,
    Pulumi = 780,
    ["PyGTA Config"] = 776,
    PyProject = 781,
    Pylock = 1286,
    Pyright = 782,
    ["Python script metadata"] = 1280,
    ["QType AI DSL"] = 785,
    Qgoda = 784,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1358,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1356,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1362,
    ["Qlik Talend Cloud Pipeline - Project"] = 1354,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1357,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1359,
    ["Qlik Talend Cloud Pipeline - Task"] = 1355,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1361,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1360,
    Qodana = 1107,
    ["Qt Creator workspace file"] = 1217,
    ["Quali Torque Blueprint Spec 2"] = 1132,
    ["QueryFirst config file"] = 1151,
    ["QuikRun Configuration"] = 1363,
    ["Qwen Code Settings"] = 1344,
    ["RKE Cluster Configuration JSON"] = 1085,
    ["RKE Cluster Configuration YAML"] = 1084,
    RadioHound = 775,
    ["Raid Profile"] = 1345,
    ["Raid Repo Configuration"] = 1346,
    Railpack = 787,
    Railway = 786,
    ["Rancher Fleet"] = 777,
    ["Rattler-build"] = 788,
    Ray = 1046,
    ["Read the Docs"] = 779,
    ["Red-DiscordBot Cog"] = 795,
    ["Red-DiscordBot Cog Repo"] = 796,
    ["Red-DiscordBot Trivia"] = 797,
    ["Releasaurus Config"] = 9,
    ReleaseKit = 8,
    ["Render Blueprints"] = 1083,
    RenderCV = 814,
    Renovate = 811,
    ["Renovate global configuration"] = 812,
    ["Renovate inherited configuration"] = 813,
    ["Replit config"] = 803,
    Restate = 1273,
    ["Revel Digital Gadget Definition File"] = 1297,
    RoadRunner = 816,
    ["Robust Station Image"] = 1303,
    Rockcraft = 817,
    ["Roo Coder Custom Modes"] = 818,
    Rubocop = 807,
    ["Rudder techniques"] = 1191,
    Ruff = 808,
    ["Rust Project"] = 809,
    ["Rust toolchain"] = 823,
    ["SDMX data message"] = 850,
    ["SDMX metadata message"] = 849,
    ["SDMX structure message"] = 848,
    ["SIL Kit Participant Configuration"] = 861,
    ["SIL Kit Registry Configuration"] = 862,
    ["SPDX 2.3"] = 901,
    SWADL = 917,
    ["Safebox Config"] = 1146,
    ["Sapphire CLI Config"] = 826,
    ["SauceCTL Configuration"] = 1094,
    Scarb = 846,
    ["Schema Catalog"] = 841,
    ["Scoop manifest"] = 847,
    ["Secure SDLC Evidence Bundle"] = 851,
    ["Semantic Data Fabric (SDF) file"] = 852,
    ["Semgrep Rule"] = 854,
    ["Serenity Code Generator (Sergen)"] = 855,
    ["Serverless Framework Configuration"] = 1101,
    ["Serverless Workflow"] = 1103,
    ["Settings for a Cinnamon spice"] = 1236,
    ["Settings.paf"] = 857,
    ["Shopware 6 Configuration"] = 1104,
    ["Shopware CLI Extension Store Configuration"] = 1105,
    ["Shopware CLI Project Store Configuration"] = 1106,
    ["Sigma Detection Rule"] = 859,
    ["SigmaCV CV"] = 4,
    ["Sigrid scope configuration file"] = 860,
    ["SkyPilot Task JSON"] = 1192,
    ["Slack app manifest"] = 864,
    ["Slang Server Configuration"] = 1370,
    Snapcraft = 866,
    ["Solarxy project config"] = 869,
    Solidarity = 870,
    ["Solution filters"] = 871,
    ["Source Maps v3"] = 872,
    Sourcery = 873,
    ["Spack bootstrap.yaml"] = 874,
    ["Spack cdash.yaml"] = 875,
    ["Spack ci.yaml"] = 876,
    ["Spack compilers.yaml"] = 877,
    ["Spack concretizer.yaml"] = 878,
    ["Spack config.yaml"] = 879,
    ["Spack definitions.yaml"] = 880,
    ["Spack develop.yaml"] = 881,
    ["Spack env_vars.yaml"] = 882,
    ["Spack environment"] = 888,
    ["Spack include.yaml"] = 883,
    ["Spack mirrors.yaml"] = 884,
    ["Spack modules.yaml"] = 885,
    ["Spack packages.yaml"] = 886,
    ["Spack repos.yaml"] = 887,
    ["Spack toolchains.yaml"] = 889,
    ["Spack upstreams.yaml"] = 890,
    ["Spack view.yaml"] = 891,
    ["Speakeasy Generation Config File"] = 895,
    ["Speakeasy Lint Configuration File"] = 892,
    ["Speakeasy Test Generation Configuration File"] = 893,
    ["Speakeasy Workflow File"] = 894,
    SpecIF = 896,
    ["Specmatic Configuration"] = 897,
    ["Specpin spec file"] = 2,
    ["Sponge Mixin configuration"] = 898,
    ["Spotlight Ruleset"] = 899,
    StackBlitz = 905,
    ["StackHawk Scanner Configuration"] = 1100,
    Stale = 906,
    Starfish = 907,
    ["Starlake Data Pipeline"] = 1072,
    Starship = 908,
    ["Statamic Blueprint"] = 909,
    ["Stella configuration file"] = 910,
    ["Streamlit configuration file"] = 911,
    ["Stryker Mutator"] = 914,
    ["StyleCop Analyzers Configuration"] = 915,
    ["Stylelint (.stylelintrc)"] = 916,
    ["Stylua Config"] = 1287,
    ["Sublime Syntax"] = 1147,
    ["Subsquid squid manifest"] = 1194,
    ["Swagger API 2.0"] = 918,
    ["Synadia Connect Component"] = 919,
    TSON = 956,
    TSTyche = 957,
    ["TYPO3 Vendor Bundler config"] = 963,
    ["Tab data for a LinUtil"] = 1243,
    ["Tab list for a LinUtil"] = 1242,
    Tach = 920,
    ["Tach Domain"] = 921,
    Talhelper = 923,
    ["Talisman configuration"] = 924,
    Taplo = 1288,
    ["Taskfile config"] = 1077,
    Taurus = 925,
    Tauticord = 926,
    ["Tekton Pipeline"] = 1316,
    ["Tekton PipelineRun"] = 1317,
    ["Tekton Task"] = 1314,
    ["Tekton TaskRun"] = 1315,
    Telefonistka = 1274,
    ["Terrateam config"] = 1300,
    ["TestEnvironment.json"] = 938,
    ["TextMate Grammar"] = 937,
    Threagile = 932,
    ["Tier.run pricing.json"] = 929,
    Tikibase = 930,
    Tombi = 935,
    ["Traefik v2"] = 941,
    ["Traefik v2 File Provider"] = 942,
    ["Traefik v3"] = 943,
    ["Traefik v3 File Provider"] = 944,
    ["Travis CI (.travis.yml)"] = 940,
    Treefmt = 476,
    Trident = 1270,
    Trivy = 947,
    ["TrueScript for *.tscript files"] = 948,
    ["Tugboat QA config.yml"] = 1267,
    TunnelHub = 1182,
    Turborepo = 939,
    Tycho = 1231,
    Tye = 1108,
    ["Tyk Gateway - Open Source v5.7+"] = 1279,
    ["UET BuildConfig.json"] = 1152,
    ["UI5 Manifest"] = 969,
    ["UNCORS configuration"] = 974,
    ["UTAM Page Object"] = 972,
    ["Ubuntu Server Autoinstall"] = 967,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1271,
    ["Uniswap Token List"] = 1057,
    ["Universal Schedule Format"] = 975,
    ["Unreal Engine Uplugin"] = 1153,
    ["Unreal Engine Uproject"] = 1154,
    ["UpCloud CLI (upctl) configuration"] = 1272,
    ["Updatecli Compose"] = 1116,
    ["Updatecli Policy Manifest"] = 1117,
    ["Updatecli Policy Metadata"] = 1118,
    Uplift = 1150,
    ["Upsun config"] = 11,
    ["User Journey Map"] = 1082,
    V2Ray = 1122,
    ["VSCode Code Snippets"] = 273,
    ["VSIX CLI publishing"] = 993,
    Vector = 977,
    ["Vela Pipeline Configuration"] = 980,
    Vercel = 272,
    ["Version Bumper config"] = 983,
    Vespertide = 1321,
    ["Vespertide Migration"] = 1322,
    ["Vespertide Model"] = 1323,
    ["Viash Component Config"] = 1276,
    ["Viash Package Config"] = 1277,
    Visivo = 1180,
    ["WP-CLI"] = 1003,
    Wake = 1269,
    ["Waku Config"] = 1246,
    ["Web App Manifest"] = 999,
    ["Web types"] = 1002,
    WebExtensions = 998,
    ["Webman package recipe"] = 1128,
    ["Windows Package Manager Installer Manifest"] = 1054,
    ["Windows Package Manager Locale Manifest"] = 1055,
    ["Windows Package Manager Singleton Manifest"] = 1053,
    ["WireMock CLI import configuration"] = 1252,
    ["WireMock CLI local service configuration"] = 1251,
    ["WireMock message stub mapping"] = 1250,
    ["WireMock stub mapping"] = 1249,
    ["Woodpecker pipeline config"] = 1096,
    ["Wrangler CLI"] = 1004,
    ["XenForo add-on manifest"] = 1005,
    ["Xstate Machine"] = 1114,
    ["Yandex Workflow Language"] = 1238,
    ["Yarn Config (.yarnrc.yml)"] = 1070,
    ["Yippee-Ki-JSON configuration YML"] = 1061,
    ["YouTrack App"] = 1235,
    ["Zarf Package Configuration"] = 1302,
    ["Zerops import file"] = 1223,
    ["Zola Configuration"] = 1313,
    abtop = 32,
    actionlint = 42,
    ["aerleon.yml"] = 26,
    ["amplify.yml"] = 19,
    ["amxx-builder manifest"] = 1365,
    ["angular.json"] = 47,
    apko = 1185,
    ...
    ["asm-lsp"] = 69,
    ["ast-grep rules"] = 72,
    ["ast-grep sgconfig.yml"] = 71,
    ["azure.yaml"] = 80,
    ["babelrc.json"] = 134,
    ["bamboo-spec"] = 138,
    basedpyright = 136,
    ["bashly-strings.yml"] = 1162,
    ["batect.yml"] = 137,
    ["beef-database-codegen"] = 139,
    ["beef-database-v5-codegen"] = 141,
    ["beef-entity-codegen"] = 140,
    ["beef-entity-v5-codegen"] = 142,
    ["behat.yml"] = 155,
    ["bigquery-table"] = 143,
    ["bioimageio resource description"] = 1202,
    ["bitbucket-pipelines"] = 145,
    bitrise = 146,
    ["bitrise-step"] = 147,
    ["block.json"] = 172,
    ["bottom configuration"] = 96,
    ["bower.json"] = 149,
    ["bozr.suite.json"] = 159,
    bpkg = 1163,
    ["browser.i18n.json"] = 160,
    ["browsh configuration"] = 161,
    bucklescript = 162,
    ["buf.gen.yaml"] = 99,
    ["buf.lock"] = 100,
    ["buf.plugin.yaml"] = 101,
    ...
    ["build-changelog"] = 163,
    ["bun.lock"] = 168,
    ["bundleconfig.json"] = 169,
    ["bunfig.toml"] = 170,
    ["cargo-mutants-config.yaml"] = 104,
    ["cargo-nextest repository configuration"] = 646,
    ["cargo-nextest user configuration"] = 647,
    ["ccmod.json"] = 1247,
    changelogging = 1214,
    ["chisel-slices.json"] = 299,
    ["chrome-extension-locales-messages.json"] = 280,
    ["chutzpah.json"] = 281,
    cibuildwheel = 192,
    ["clang-format (.clang-format)"] = 1120,
    ["clang-tidy"] = 255,
    clangd = 254,
    clib = 256,
    ["cloud-init: cloud-config userdata"] = 258,
    ["cloud-sdk-pipeline-configuration"] = 283,
    ["cloudbuild.json"] = 284,
    cloudify = 257,
    cmakefmt = 210,
    ["cmdx.yaml"] = 107,
    ...
    ["commands.json"] = 276,
    ["commit-check"] = 302,
    ["commitlint (.commitlintrc)"] = 1056,
    ["committed.toml"] = 303,
    ["compile_commands.json"] = 275,
    ["compilerconfig.json"] = 274,
    ["completely.yml"] = 1158,
    ["component-detection-manifest.json"] = 306,
    ["component.json"] = 305,
    ["composer.json"] = 304,
    ["conda-forge"] = 196,
    ["config.yaml"] = 778,
    ["contentmanifest.json"] = 282,
    ["contribute.json"] = 307,
    ["cosmos.config.json"] = 278,
    ["crowdin.yml"] = 308,
    ["ctfd-setup configuration file"] = 1259,
    ["custom-elements.json"] = 1172,
    ["cypress.json"] = 312,
    ["dacier.yml"] = 1353,
    ["datalogic-scan2deploy-android"] = 322,
    ["datalogic-scan2deploy-ce"] = 323,
    ["dbt Dependencies"] = 217,
    ["dbt Packages"] = 219,
    ["dbt Project"] = 218,
    ["dbt Selectors"] = 220,
    ["dbt YAML files"] = 221,
    ...
    ["ddev-global"] = 324,
    ["ddev-project"] = 325,
    ["debugsettings.json"] = 326,
    ["dependabot-v2.json"] = 329,
    ["dependabot.json"] = 328,
    ["deployed-cli"] = 1113,
    ["devcontainer-feature.json"] = 266,
    ["devcontainer.json"] = 265,
    devinit = 1063,
    ["devspace.yaml"] = 1136,
    djlint = 1064,
    ["docker bake"] = 335,
    ["docker sequencer"] = 336,
    ["docker-compose.yml"] = 1062,
    ["dockerd.json"] = 333,
    ["dotnet Release Index manifest"] = 348,
    ["dotnet-tools.json"] = 349,
    ["dotnetcli.host.json"] = 350,
    ["dprint.json"] = 351,
    ["drone.json"] = 352,
    ["dss-2.0.0.json"] = 354,
    ["dstack configuration"] = 355,
    ["dtool dataset metadata"] = 1254,
    ["dvc.yaml"] = 356,
    ["ecosystem.json"] = 361,
    ["editorconfig-checker"] = 363,
    eksctl = 364,
    ["electron-builder configuration file"] = 390,
    ["epr-manifest.json"] = 389,
    ["estampo.toml"] = 388,
    ["evcc.yaml"] = 391,
    ["ezd task runner"] = 402,
    ["fabric.mod.json"] = 405,
    ["first-timers-bot"] = 413,
    ["flagd flag configuration"] = 129,
    ["fly.io Configuration"] = 130,
    fulibWorkflows = 1095,
    ["function.json"] = 425,
    ["gRPC API Gateway & OpenAPI Config"] = 21,
    ["gematik health care insurance list"] = 1265,
    ["gematik health care patient list"] = 1262,
    ["gematik health care provider institution list"] = 1264,
    ["gematik health care provider list"] = 1263,
    ["gematik tiger test environment configuration"] = 1266,
    ["git-cliff"] = 436,
    ["git-town.toml"] = 1311,
    ["gitlab-ci"] = 448,
    ["global.json"] = 465,
    ["go-feature-flag Flag Configuration"] = 469,
    gollama = 468,
    ["hassette.toml"] = 492,
    ["haxelib.json"] = 488,
    helmfile = 1049,
    ...
    ["ide.host.json"] = 504,
    ["ifstate.yaml"] = 505,
    ["imageoptimizer.json"] = 506,
    ["importmap.json"] = 509,
    ["index.toml (packwiz)"] = 1367,
    instant_python_config = 513,
    instant_python_custom_project = 514,
    intlayer = 515,
    ["ioBroker Configuration"] = 516,
    ["ioBroker JSON UI"] = 517,
    ["ioBroker Package manifest"] = 518,
    ["ixpect.conf.yaml"] = 519,
    ["ize.toml"] = 1149,
    ["jsconfig.json"] = 544,
    ["jscpd Configuration"] = 1133,
    jsdoc = 1045,
    ["k3d.yaml"] = 545,
    ["k9s aliases.yaml"] = 547,
    ["k9s cluster-config.yaml"] = 549,
    ["k9s config.yaml"] = 548,
    ["k9s hotkeys.yaml"] = 550,
    ["k9s plugins.yaml"] = 551,
    ["k9s skin.yaml"] = 552,
    ["k9s views.yaml"] = 553,
    ["kind cluster"] = 567,
    ["kontinuous-config.yaml"] = 565,
    ["kontinuous-values.yaml"] = 564,
    ["kustomization.yaml"] = 568,
    ["label-commenter-config.yml"] = 569,
    ["latexindent configuration"] = 122,
    ["launchsettings.json"] = 570,
    lazydocker = 1171,
    lazygit = 1170,
    ["lego.json"] = 572,
    ["lerna.json"] = 573,
    ["lgtm.yml"] = 574,
    ["liblab.config.json"] = 575,
    ["libman.json"] = 576,
    ["license-report-config.json"] = 577,
    ["linkinator.config.json"] = 579,
    ["lint-staged (.lintstagedrc)"] = 1022,
    ["local.settings.json"] = 584,
    ["localazy.json"] = 585,
    ["lotus.yaml"] = 583,
    ["lsdlschema.json"] = 586,
    lychee = 1021,
    ["macro.json"] = 1137,
    ["markdown-link-check"] = 1091,
    maturin = 1092,
    mboats = 1099,
    memnex = 1351,
    ["micro-settings.json"] = 1164,
    ["mimetypes.json"] = 602,
    ["mirrord config"] = 1025,
    ["misata.yaml"] = 1024,
    mise = 1026,
    ["mkdocs.yml"] = 622,
    ["mockd.yaml"] = 626,
    ["mod.pw.toml (packwiz)"] = 1368,
    ["modelparams.dev Model"] = 629,
    ["models CLI"] = 630,
    ["monospace.yml"] = 631,
    ["moon.yml"] = 1248,
    ["mprocs Configuration file"] = 1218,
    ["mrdocs.yml"] = 624,
    ["mta.yaml"] = 1027,
    ["mtad.yaml"] = 1028,
    ["mycode.json"] = 639,
    nFPM = 651,
    ["napari plugin manifest"] = 640,
    neoload = 1040,
    ["nest-cli"] = 654,
    ["nexus-rpc-gen"] = 1338,
    ["nf-core module environment.yml"] = 648,
    ["nf-core module meta.yml"] = 649,
    ["nf-core subworkflow meta.yml"] = 650,
    ["ninjs (News in JSON)"] = 653,
    ["nitro.json"] = 1039,
    ["nixd configuration"] = 1190,
    ["nlu.json"] = 655,
    ["nodemon.json"] = 658,
    ["noodl config"] = 1098,
    ["notebook.mod.json"] = 659,
    now = 1035,
    ["npm-badges"] = 662,
    ["nswag.json"] = 666,
    ntangle = 668,
    ["nuclei-template.yaml"] = 663,
    ["nuget-project.json"] = 664,
    ["ocelot.json"] = 670,
    ogen = 673,
    ["omnisharp.json"] = 676,
    openHAB = 1324,
    ...
    oxfmt = 1334,
    oxlint = 1335,
    ["pack.toml (packwiz)"] = 1369,
    ["package.json"] = 711,
    ["package.manifest"] = 713,
    ["package.yaml"] = 712,
    ["partial-black.json"] = 156,
    ["partial-fastapi.json"] = 157,
    ["partial-pixi.json"] = 723,
    ["partial-scheduled.json"] = 158,
    ["pattern.json"] = 721,
    ["petstore-v1.0"] = 1144,
    pgap_yaml_input_reader = 719,
    pgrls = 720,
    pgxgen = 1328,
    pitcms = 1331,
    ["pixi.toml"] = 722,
    ["plagiarize-me.yaml"] = 727,
    ["plagiarize.yaml"] = 726,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1255,
    ["podbard.yaml"] = 729,
    ["portman.json"] = 732,
    ["prefect.toml"] = 741,
    ["prefect.yaml"] = 742,
    ...
    ["prettierrc.json"] = 744,
    ["prisma.yml"] = 745,
    ["project-1.0.0-beta3.json"] = 757,
    ["project-1.0.0-beta4.json"] = 758,
    ["project-1.0.0-beta5.json"] = 759,
    ["project-1.0.0-beta6.json"] = 760,
    ["project-1.0.0-beta8.json"] = 761,
    ["project-1.0.0-rc1.json"] = 762,
    ["project-1.0.0-rc2.json"] = 763,
    ["project.json"] = 756,
    ["project.owasp.yaml"] = 764,
    ["prometheus-alertmanager.json"] = 768,
    ["prometheus.json"] = 765,
    ["prometheus.rules.json"] = 766,
    ["prometheus.rules.test.json"] = 767,
    ["proxies.json"] = 769,
    ["publiccode.yml"] = 770,
    ["pubspec.yaml"] = 771,
    ["pyrseas-0.8.json"] = 774,
    pytest = 783,
    ["quilt.mod.json"] = 1165,
    ["rc3 auth"] = 789,
    ["rc3 collection"] = 790,
    ...
    ["rc3 settings"] = 794,
    ["registry.yaml"] = 60,
    ["release drafter"] = 1041,
    ["release-hub.json"] = 7,
    ["release-please-config.json"] = 799,
    ["release-please-manifest.json"] = 800,
    ["release-plz.toml"] = 801,
    ["renv.lock"] = 815,
    ["reposets Configuration"] = 804,
    ["reposets Credentials"] = 805,
    ["revola.json"] = 5,
    ["rivet.json"] = 1189,
    ["rivet.yaml (legacy)"] = 1188,
    rumdl = 820,
    runny = 819,
    runspec = 1352,
    rustfmt = 821,
    ...
    samt = 824,
    samtrc = 825,
    ["sarif-1.0.0.json"] = 827,
    ["sarif-2.0.0.json"] = 828,
    ["sarif-2.1.0"] = 838,
    ["sarif-2.1.0-rtm.2"] = 829,
    ["sarif-2.1.0-rtm.3"] = 831,
    ["sarif-2.1.0-rtm.4"] = 833,
    ["sarif-2.1.0-rtm.5"] = 835,
    ["sarif-2.1.0-rtm.6"] = 836,
    ["sarif-external-property-file-2.1.0"] = 839,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 830,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 832,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 834,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 837,
    ["scalingo.json configuration"] = 840,
    ["schema.org - Action"] = 842,
    ["schema.org - ContactPoint"] = 843,
    ["schema.org - Place"] = 844,
    ["schema.org - Thing"] = 845,
    ["secrethub.yml"] = 1167,
    ["semantic-release"] = 853,
    ["servicehub.config.json"] = 1016,
    ["servicehub.service.json"] = 1015,
    ["settings.job"] = 856,
    ["sfdx-hardis configuration"] = 858,
    ["shard.yml"] = 1205,
    ["size-limit configuration"] = 863,
    ["skaffold.yaml"] = 1089,
    ["skyuxconfig.json"] = 865,
    ["snowflake-config"] = 867,
    ["snowflake-connections"] = 868,
    ["spicepod.yaml"] = 1226,
    ["sqlc configuration"] = 902,
    ["stripe-app-local.json"] = 913,
    ["stripe-app.json"] = 912,
    swcrc = 1073,
    ["task.json"] = 922,
    taskcat = 1036,
    ["template.json"] = 927,
    ["templatsources.json"] = 928,
    ["text2confl config"] = 1336,
    ["theme.json"] = 931,
    ["tizen_workspace.json"] = 933,
    tldr = 934,
    ["tm_devices configuration file"] = 1293,
    tmuxinator = 1019,
    tox = 936,
    ["transcend.yml"] = 945,
    ["tree-sitter grammar.json"] = 475,
    ["trime.yaml"] = 946,
    ["trunk.yaml"] = 949,
    ["ts-force-config.json"] = 954,
    ["tsconfig.json"] = 950,
    ["tsd.json"] = 951,
    ["tsdoc.json"] = 952,
    ["tsdrc.json"] = 953,
    ...
    v8r = 997,
    vcluster = 1212,
    ["vcpkg configuration file"] = 271,
    ["vcpkg manifest file"] = 270,
    ["vega-lite.json"] = 979,
    ["vega.json"] = 978,
    ["venvironment.yaml"] = 981,
    ["venvplus.yaml"] = 982,
    version = 1275,
    ["version.json"] = 984,
    ["vhwdebugger-binding.yaml"] = 986,
    ["vim-addon-info"] = 987,
    ["vs-2017.3.host.json"] = 989,
    ["vs-nesting.json"] = 990,
    ["vsls.json"] = 988,
    ["vss-extension.json"] = 994,
    vtcfg = 1281,
    ["vtesttree.yaml"] = 995,
    ["vtestunit.yaml"] = 996,
    ["warp-keysets.json"] = 1173,
    ["warp-themes.json"] = 1174,
    ["warp-workflows.json"] = 1175,
    ["webhint.io"] = 1129,
    ["webjobpublishsettings.json"] = 1001,
    ["webjobs-list.json"] = 1000,
    ["well-known-fursona"] = 1213,
    ["xs-app.json"] = 1031,
    ["xunit.runner.json"] = 1014,
    yamlfmt = 1058,
    yamllint = 1059,
    ["yap.json"] = 1060,
    ["zerops.yml"] = 1222,
