...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 767,
    [".nodehawkrc"] = 487,
    [".npmpackagejsonlintrc"] = 491,
    [".omletrc"] = 937,
    [".phrase.yml"] = 552,
    [".phraseapp.yml"] = 553,
    [".pmbot.yml"] = 540,
    [".postcssrc"] = 547,
    [".powerpages-web-template-manifest"] = 549,
    [".pre-commit-config.yml"] = 550,
    [".pre-commit-hooks.yml"] = 551,
    [".putout.json"] = 573,
    [".rehyperc"] = 594,
    [".remarkrc"] = 596,
    [".sprite files"] = 659,
    ...
    ABCSupplyPlan = 14,
    AIConfig = 15,
    ["AMX Muse Program Descriptor"] = 980,
    ["API Builder"] = 800,
    ["AVA Configuration"] = 860,
    ...
    ["Adobe UXP Manifest"] = 920,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Alacritty Configuration"] = 832,
    ["All Contributors configuration file"] = 885,
    ...
    ["Application list for a WinUtil"] = 963,
    ArchitectFX = 967,
    ["Argo Events"] = 29,
    ["Argo Workflows"] = 30,
    AssemblyScript = 33,
    ...
    ["Azure Pipelines"] = 66,
    ["Azure Static Web Apps CLI configuration file"] = 662,
    ["Azure Static Web Apps configuration file"] = 661,
    ["BOSH Deploy Config"] = 90,
    ["BX CI"] = 108,
    ["Bashly (bashly.yml)"] = 889,
    ["Bashly Settings (bashly-settings.yml)"] = 890,
    ["Better Code Hub"] = 804,
    ["Better Scripts"] = 109,
    Bigconfig = 83,
    ["Biome Formatter Config"] = 53,
    ["Bitmovin Encoding Template"] = 973,
    BizTalkServerApplicationSchema = 773,
    Bleep = 110,
    ...
    ["Butane Config"] = 845,
    ["CGS Custom Card Game (CardGameDef.json)"] = 925,
    ["CICS TS region tagging"] = 854,
    ["CICS TS resource import"] = 855,
    ["CICS TS resource model"] = 856,
    ["CICS TS resource overrides"] = 857,
    ["CMake Presets"] = 111,
    ["CNC Codes"] = 126,
    ["CRS WAF test file"] = 953,
    ["CRS WAF test platform overrides file"] = 954,
    ...
    ["Chamaleon environment"] = 977,
    ["Chamaleon properties"] = 978,
    ["Chamaleon template"] = 976,
    Changesets = 208,
    Cheatsheets = 842,
    ...
    CityJSON = 122,
    ["Clawject config"] = 131,
    ["Cloud Foundry Application Manifest"] = 936,
    ["Cloud Run Spec v1"] = 958,
    ...
    Concord = 952,
    ["Configu .cfgu files"] = 941,
    ["Configu .configu file"] = 942,
    Conjure = 125,
    ["Container Structure Test"] = 787,
    Containerlab = 812,
    ["Crowdsec collection config"] = 217,
    ["Crowdsec parser config"] = 218,
    ["Crowdsec scenario config"] = 219,
    ["CumulusCI Config"] = 130,
    ["Custom Machinery Machine"] = 926,
    ["Custom Machinery Recipe"] = 927,
    ...
    ["DonateCaseBetterCasino menu"] = 981,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 897,
    ["EAS config"] = 283,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 886,
    ["EasyVCR .NET"] = 284,
    ["Eidolon Resource"] = 968,
    ...
    ["Goreleaser Pro"] = 341,
    Goss = 342,
    ["Gradle Build Cache Node"] = 802,
    ["Gradle Enterprise"] = 801,
    ...
    Hadolint = 783,
    Hammerkit = 811,
    ["Hardware Sentry Configuration"] = 865,
    Hatch = 784,
    Hayson = 355,
    ...
    ["JFrog File Spec"] = 384,
    ["JFrog Pipelines YML DSL"] = 874,
    ["JMeter DSL cli config"] = 385,
    JReleaser = 387,
    ["JSON Document Transform"] = 395,
    ["JSON Feed"] = 396,
    ["JSON Resume"] = 601,
    ["JSON Schema Draft 2020-12"] = 753,
    ["JSON Schema Draft 4"] = 750,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 907,
    ["JSON Schema Draft 7"] = 751,
    ["JSON Schema Draft 7 (unofficial strict)"] = 908,
    ["JSON Schema Draft 8 (2019-09)"] = 752,
    ["JSON-API"] = 394,
    ["JSON-e templates"] = 809,
    ["JSON-stat 2.0"] = 746,
    JSONPatch = 398,
    ...
    ["Language configuration"] = 945,
    Lefthook = 423,
    ["Liferay client-extension.yaml"] = 430,
    ["LinkML Metamodel"] = 432,
    Liquibase = 817,
    ["Liquibase Flow File"] = 818,
    ["Lively Properties"] = 433,
    ["Lobe AI Agent"] = 64,
    Loki = 65,
    ["MLOS Configs"] = 471,
    ["MS2Rescore Configuration"] = 474,
    ["Madness (madness.yml)"] = 888,
    ["MapEHR Mapping"] = 440,
    Markdownlint = 821,
    ["Mason Registry"] = 823,
    ...
    ["Mergify Configuration"] = 475,
    ["Metadata for a Bazel module"] = 445,
    ["Metadata for a Cinnamon spice"] = 961,
    ["Metatype Configuration"] = 446,
    ["MetricsHub Configuration"] = 447,
    ["MetricsHub Connector Configuration"] = 448,
    ["Micro Editor Syntax"] = 898,
    ["Microsoft Band Web Tile"] = 449,
    ["Microsoft RulesEngine workflow rules"] = 949,
    ["Microsoft RulesEngine workflow rules list"] = 950,
    ["Minecraft Custom Main Menu Mod"] = 915,
    ...
    ["Monade CLI Stack Configuration"] = 478,
    ["MongoDB Atlas Search Index Definition"] = 869,
    ["Monika Configuration"] = 867,
    ["Monoweave Configuration"] = 473,
    ["Motif config"] = 766,
    ["NOX Framework (Service)"] = 490,
    ["Netin Diagnostic System Template"] = 827,
    ["Netlify config"] = 481,
    ["Network-as-Code Data Model"] = 482,
    ["Nightwatch.js"] = 483,
    ["NueJS configuration file"] = 495,
    ["Nuitka.yaml"] = 928,
    ["Nullstone config"] = 497,
    ["ONe's changelog entry"] = 511,
    ["ONe's service descriptor"] = 510,
    ["OSCAL Assessment Plan (AP)"] = 519,
    ["OSCAL Assessment Results (AR)"] = 520,
    ["OSCAL Catalog"] = 521,
    ["OSCAL Component Definition (CDef)"] = 522,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 523,
    ["OSCAL Profile"] = 524,
    ["OSCAL System Security Plan (SSP)"] = 525,
    ["OSS Review Toolkit configuration"] = 526,
    ["OSS Review Toolkit curation"] = 527,
    ["OSS Review Toolkit package configuration"] = 528,
    ["OSS Review Toolkit repository configuration"] = 529,
    ["OSS Review Toolkit resolutions"] = 530,
    ["October CMS columns"] = 501,
    ["October CMS fields"] = 502,
    Okteto = 503,
    Opctl = 769,
    ["Open Data Contract Standard (ODCS)"] = 514,
    ["OpenRewrite Resource"] = 513,
    ["OpenUtau character yaml"] = 507,
    ["OpenUtau ustx"] = 508,
    ["OpenWeather Current Weather API"] = 808,
    ["OpenWeather Road Risk API"] = 807,
    ["Ory Hydra configuration"] = 362,
    ["Ory Keto configuration"] = 416,
    ["Ory Kratos configuration"] = 518,
    ["Ory Oathkeeper configuration"] = 499,
    ["Outblocks App configuration"] = 516,
    ["Outblocks database table"] = 517,
    ["Outblocks project configuration"] = 515,
    PDM = 536,
    Packer = 533,
    Pantsbuild = 884,
    ["Paper paper-plugin.yml"] = 534,
    ["Pipeline component"] = 819,
    ["Plex Prerolls"] = 544,
    ["PocketMine plugin.yml"] = 541,
    ["Postman collection"] = 548,
    ["Preset list for a WinUtil"] = 964,
    ["Problem object RFC9457"] = 912,
    ["Problem package generators"] = 557,
    Pterodactyl = 864,
    ["Pull Request Labeler"] = 572,
    Pulumi = 580,
    ["PyGTA Config"] = 576,
    PyProject = 581,
    Pyright = 582,
    Qgoda = 583,
    Qodana = 837,
    ["Qt Creator workspace file"] = 943,
    ["Quali Torque Blueprint Spec 2"] = 862,
    ["QueryFirst config file"] = 880,
    ["RKE Cluster Configuration JSON"] = 816,
    ["RKE Cluster Configuration YAML"] = 815,
    RadioHound = 575,
    ["Rancher Fleet"] = 577,
    ["Rattler-build"] = 584,
    Ray = 782,
    ["Read the Docs"] = 579,
    ["Red-DiscordBot Cog"] = 591,
    ["Red-DiscordBot Cog Repo"] = 592,
    ["Red-DiscordBot Trivia"] = 593,
    ["Render Blueprints"] = 814,
    RenderCV = 603,
    Renovate = 602,
    ["Replit config"] = 597,
    RoadRunner = 605,
    ["Rudder techniques"] = 918,
    Ruff = 599,
    ["Rust Project"] = 600,
    ["Rust toolchain"] = 609,
    ["SDMX data message"] = 634,
    ["SDMX metadata message"] = 633,
    ["SDMX structure message"] = 632,
    ["SIL Kit Participant Configuration"] = 644,
    ["SIL Kit Registry Configuration"] = 645,
    SWADL = 673,
    ["Safebox Config"] = 875,
    ["Sapphire CLI Config"] = 612,
    ["SauceCTL Configuration"] = 824,
    ["Schema Catalog"] = 626,
    ["Scoop manifest"] = 631,
    ["Semantic Data Fabric (SDF) file"] = 635,
    ["Semgrep Rule"] = 637,
    ["Serenity Code Generator (Sergen)"] = 638,
    ["Serverless Framework Configuration"] = 831,
    ["Serverless Workflow"] = 833,
    ["Settings for a Cinnamon spice"] = 960,
    ["Settings.paf"] = 640,
    ["Shopware 6 Configuration"] = 834,
    ["Shopware CLI Extension Store Configuration"] = 835,
    ["Shopware CLI Project Store Configuration"] = 836,
    ["Sigma Detection Rule"] = 642,
    ["Sigrid scope configuration file"] = 643,
    ["SkyPilot Task JSON"] = 919,
    ["Slack app manifest"] = 647,
    Solidarity = 650,
    ["Solution filters"] = 651,
    ["Source Maps v3"] = 652,
    Sourcery = 653,
    ["Speakeasy Lint Configuration File"] = 654,
    ["Speakeasy Test Generation Configuration File"] = 655,
    ["Speakeasy Workflow File"] = 656,
    SpecIF = 657,
    ["Sponge Mixin configuration"] = 658,
    StackBlitz = 663,
    ["StackHawk Scanner Configuration"] = 830,
    Stale = 664,
    ["Starlake Data Pipeline"] = 805,
    Starship = 665,
    ["Statamic Blueprint"] = 666,
    ["Stella configuration file"] = 667,
    ["Stryker Mutator"] = 670,
    ["StyleCop Analyzers Configuration"] = 671,
    ["Stylelint (.stylelintrc)"] = 672,
    ["Sublime Syntax"] = 876,
    ["Subsquid squid manifest"] = 921,
    ["Swagger API 2.0"] = 674,
    ["Synadia Connect Component"] = 675,
    TSON = 704,
    TSTyche = 705,
    ["Tab data for a LinUtil"] = 966,
    ["Tab list for a LinUtil"] = 965,
    Talhelper = 677,
    ["Talisman configuration"] = 678,
    ["Taskfile config"] = 810,
    Taurus = 679,
    Tauticord = 680,
    ["TestEnvironment.json"] = 689,
    ["TextMate Grammar"] = 688,
    ["Tier.run pricing.json"] = 683,
    Tikibase = 684,
    ["Traefik v2"] = 692,
    ["Traefik v2 File Provider"] = 693,
    ["Travis CI (.travis.yml)"] = 691,
    ["TrueScript for *.tscript files"] = 696,
    TunnelHub = 911,
    Turborepo = 690,
    Tycho = 956,
    Tye = 838,
    ["UET BuildConfig.json"] = 881,
    ["UI5 Manifest"] = 714,
    ["UNCORS configuration"] = 718,
    ["UTAM Page Object"] = 717,
    ["Ubuntu Server Autoinstall"] = 712,
    ["Uniswap Token List"] = 793,
    ["Unreal Engine Uplugin"] = 882,
    ["Unreal Engine Uproject"] = 883,
    ["Updatecli Compose"] = 846,
    ["Updatecli Policy Manifest"] = 847,
    ["Updatecli Policy Metadata"] = 848,
    Uplift = 879,
    ["User Journey Map"] = 813,
    V2Ray = 852,
    ["VSCode Code Snippets"] = 183,
    ["VSIX CLI publishing"] = 735,
    ["Vela Pipeline Configuration"] = 722,
    Vercel = 182,
    ["Version Bumper config"] = 725,
    Visivo = 909,
    ["Waku Config"] = 969,
    ["Web App Manifest"] = 741,
    ["Web types"] = 744,
    WebExtensions = 740,
    ["Webman package recipe"] = 858,
    ["Windows Package Manager Installer Manifest"] = 790,
    ["Windows Package Manager Locale Manifest"] = 791,
    ["Windows Package Manager Singleton Manifest"] = 789,
    ["WireMock stub mapping"] = 972,
    ["Woodpecker pipeline config"] = 826,
    ["Wrangler CLI"] = 745,
    ["Xstate Machine"] = 844,
    ["Yandex Workflow Language"] = 962,
    ["Yarn Config (.yarnrc.yml)"] = 803,
    ["Yippee-Ki-JSON configuration YML"] = 795,
    ["YouTrack App"] = 959,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 913,
    ...
    ["behat.yml"] = 92,
    ["bigquery-table"] = 82,
    ["bioimageio resource description"] = 929,
    ...
    ["crowdin.yml"] = 216,
    ["ctfd-setup configuration file"] = 979,
    ["custom-elements.json"] = 901,
    ["cypress.json"] = 220,
    ...
    ["gematik health care insurance list"] = 985,
    ["gematik health care patient list"] = 982,
    ["gematik health care provider institution list"] = 984,
    ["gematik health care provider list"] = 983,
    ["gitlab-ci"] = 321,
    ["global.json"] = 336,
    ...
    ["lint-staged (.lintstagedrc)"] = 761,
    ["local.settings.json"] = 436,
    ["localazy.json"] = 437,
    ["lotus.yaml"] = 435,
    ["lsdlschema.json"] = 438,
    ["markdown-link-check"] = 822,
    mboats = 829,
    ["micro-settings.json"] = 893,
    ["mimetypes.json"] = 450,
    ["mirrord config"] = 762,
    mise = 763,
    ["mkdocs.yml"] = 470,
    ["monospace.yml"] = 472,
    ["moon.yml"] = 971,
    ["mprocs Configuration file"] = 944,
    ["mta.yaml"] = 764,
    ["mtad.yaml"] = 765,
    ["mycode.json"] = 479,
    ["napari plugin manifest"] = 480,
    neoload = 776,
    ["nest-cli"] = 485,
    ["ninjs (News in JSON)"] = 484,
    ["nitro.json"] = 775,
    ["nixd configuration"] = 917,
    ["nlu.json"] = 486,
    ["nodemon.json"] = 488,
    ["noodl config"] = 828,
    ["notebook.mod.json"] = 489,
    now = 771,
    ["npm-badges"] = 492,
    ["nswag.json"] = 496,
    ntangle = 498,
    ["nuclei-template.yaml"] = 493,
    ["nuget-project.json"] = 494,
    ["ocelot.json"] = 500,
    ["omnisharp.json"] = 504,
    ["openapi.json"] = 505,
    ["openfin.json"] = 512,
    ...
    ["ops.yaml"] = 509,
    ["package.json"] = 531,
    ["package.manifest"] = 532,
    ["partial-black.json"] = 93,
    ["pathfinder.yml"] = 535,
    ["pattern.json"] = 538,
    ["petstore-v1.0"] = 873,
    pgap_yaml_input_reader = 537,
    ["pixi.toml"] = 539,
    ["plagiarize-me.yaml"] = 543,
    ["plagiarize.yaml"] = 542,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 975,
    ["podbard.yaml"] = 545,
    ["portman.json"] = 546,
    ["prefect.toml"] = 554,
    ["prettierrc.json"] = 555,
    ["prisma.yml"] = 556,
    ["project-1.0.0-beta3.json"] = 559,
    ["project-1.0.0-beta4.json"] = 560,
    ["project-1.0.0-beta5.json"] = 561,
    ["project-1.0.0-beta6.json"] = 562,
    ["project-1.0.0-beta8.json"] = 563,
    ["project-1.0.0-rc1.json"] = 564,
    ["project-1.0.0-rc2.json"] = 565,
    ["project.json"] = 558,
    ["prometheus.json"] = 566,
    ["prometheus.rules.json"] = 567,
    ["prometheus.rules.test.json"] = 568,
    ["proxies.json"] = 569,
    ["publiccode.yml"] = 570,
    ["pubspec.yaml"] = 571,
    ["pyrseas-0.8.json"] = 574,
    ["quilt.mod.json"] = 894,
    ["rc3 auth"] = 585,
    ["rc3 collection"] = 586,
    ["rc3 environment"] = 587,
    ...
    samt = 610,
    samtrc = 611,
    ["sarif-1.0.0.json"] = 613,
    ["sarif-2.0.0.json"] = 614,
    ["sarif-2.1.0"] = 624,
    ["sarif-2.1.0-rtm.2"] = 615,
    ["sarif-2.1.0-rtm.3"] = 617,
    ["sarif-2.1.0-rtm.4"] = 619,
    ["sarif-2.1.0-rtm.5"] = 621,
    ["sarif-2.1.0-rtm.6"] = 622,
    ["sarif-external-property-file-2.1.0"] = 625,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 616,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 618,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 620,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 623,
    ["schema.org - Action"] = 627,
    ["schema.org - ContactPoint"] = 628,
    ["schema.org - Place"] = 629,
    ["schema.org - Thing"] = 630,
    ["secrethub.yml"] = 896,
    ["semantic-release"] = 636,
    ["servicehub.config.json"] = 756,
    ["servicehub.service.json"] = 755,
    ["settings.job"] = 639,
    ["sfdx-hardis configuration"] = 641,
    ["shard.yml"] = 932,
    ["size-limit configuration"] = 646,
    ["skaffold.yaml"] = 820,
    ["skyuxconfig.json"] = 648,
    snapcraft = 649,
    ["spicepod.yaml"] = 951,
    ["sqlc configuration"] = 660,
    ["stripe-app-local.json"] = 669,
    ["stripe-app.json"] = 668,
    swcrc = 806,
    ["task.json"] = 676,
    taskcat = 772,
    ["template.json"] = 681,
    ["templatsources.json"] = 682,
    ["theme.json"] = 685,
    ["tizen_workspace.json"] = 686,
    tldr = 687,
    tmuxinator = 759,
    ["transcend.yml"] = 694,
    ...
    ["vega-lite.json"] = 721,
    ["vega.json"] = 720,
    ["venvironment-basic.yaml"] = 724,
    ["venvironment.yaml"] = 723,
    ["version.json"] = 726,
    ["vhwdebugger-binding.yaml"] = 728,
    ["vim-addon-info"] = 729,
    ["vs-2017.3.host.json"] = 731,
    ["vs-nesting.json"] = 732,
    ["vsls.json"] = 730,
    ["vss-extension.json"] = 736,
    ["vtesttree.yaml"] = 737,
    ["vtestunit.yaml"] = 738,
    ["warp-keysets.json"] = 902,
    ["warp-themes.json"] = 903,
    ["warp-workflows.json"] = 904,
    ["webhint.io"] = 859,
    ["webjobpublishsettings.json"] = 743,
    ["webjobs-list.json"] = 742,
    ["well-known-fursona"] = 939,
    ["xs-app.json"] = 768,
    ["xunit.runner.json"] = 754,
    yamllint = 794,
    ["zerops.io import file"] = 948,
    ["zerops.yml"] = 947,
    zuul = 778,
    ["Žinoma"] = 788
  },
