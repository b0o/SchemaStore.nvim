...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 135,
    [".cryproj (generic)"] = 460,
    [".cryproj engine-5.2"] = 455,
    [".cryproj engine-5.3"] = 456,
    [".cryproj engine-5.4"] = 457,
    [".cryproj engine-5.5"] = 458,
    [".cryproj engine-dev"] = 459,
    [".csscomb.json"] = 137,
    [".csslintrc"] = 138,
    [".eslintrc"] = 177,
    [".esmrc.json"] = 170,
    ...
    [".mtaext"] = 467,
    [".nodehawkrc"] = 290,
    [".npmpackagejsonlintrc"] = 292,
    [".phraseapp.yml"] = 324,
    [".pmbot.yml"] = 316,
    [".postcssrc"] = 321,
    [".pre-commit-config.yml"] = 322,
    [".pre-commit-hooks.yml"] = 323,
    [".putout.json"] = 341,
    [".rehyperc"] = 347,
    [".remarkrc"] = 348,
    [".sprite files"] = 387,
    ...
    [".vsext"] = 436,
    [".yarnrc.yml"] = 499,
    ["<div>RIOTS' studio configuration"] = 439,
    ["API Builder"] = 496,
    ["AVA Configuration Schema"] = 550,
    ...
    ["Azure Pipelines"] = 41,
    ["Azure Static Web Apps CLI configuration file"] = 389,
    ["Azure Static Web Apps configuration file"] = 388,
    ["BX CI"] = 70,
    ["Better Code Hub"] = 501,
    ["Better Scripts"] = 71,
    BizTalkServerApplicationSchema = 473,
    ...
    ["Butane config schema"] = 537,
    ["CICS TS region tagging"] = 544,
    ["CICS TS resource import"] = 545,
    ["CICS TS resource model"] = 546,
    ["CICS TS resource overrides"] = 547,
    ["CMake Presets"] = 72,
    ...
    ["Container Structure Test"] = 484,
    Containerlab = 508,
    ["Dart build configuration"] = 139,
    ["Dart test config"] = 140,
    ["DashLord configuration"] = 141,
    ["Datadog Service Definition"] = 248,
    ["Datahub Ingestion Recipe Schema"] = 551,
    ["Dein Config Schema"] = 84,
    Deno = 145,
    ["Deployer Recipe"] = 148,
    Devfile = 167,
    ["Discord Webhook"] = 150,
    ["Dolittle Artifacts"] = 153,
    ["Dolittle Bounded Context Configuration"] = 154,
    ["Dolittle Event Horizons Configuration"] = 155,
    ["Dolittle Resources Configuration"] = 156,
    ["Dolittle Server Configuration"] = 157,
    ["Dolittle Tenant Map Configuration"] = 159,
    ["Dolittle Tenants Configuration"] = 158,
    ["Dolittle Topology"] = 160,
    ...
    ["Drush site aliases"] = 164,
    ["Embrace Config Schema"] = 562,
    ["Error pages"] = 173,
    Esquio = 171,
    ["Estuary Flow Catalog Schema"] = 541,
    ["Expo SDK"] = 176,
    ["F-Droid Data metadata"] = 180,
    ["Facets - FSDL - Application"] = 178,
    ["Fossa configuration file"] = 185,
    ["Fossa's fossa-deps file"] = 186,
    ["Foundry VTT - Manifest"] = 183,
    ["Foundry VTT - Template"] = 184,
    ["Foxx Manifest"] = 42,
    ["GatewayCore API Gateway"] = 189,
    ["GeoJSON.json latest"] = 539,
    GherKing = 543,
    ["GitHub Action"] = 193,
    ["GitHub Funding"] = 194,
    ["GitHub Issue Template configuration"] = 196,
    ["GitHub Workflow"] = 197,
    ["GitHub Workflow Template Properties"] = 198,
    ["GitHub issue forms"] = 195,
    GitVersion = 192,
    ["Gitpod Configuration"] = 200,
    ["Global Privacy Control"] = 190,
    ["Google Cloud Workflows"] = 122,
    Goreleaser = 203,
    ["Goreleaser Pro"] = 204,
    ["Gradle Build Cache Node"] = 498,
    ["Gradle Enterprise"] = 497,
    ["Grafana 5.x Dashboard"] = 205,
    ["GraphQL Code Generator"] = 208,
    ["GraphQL Config"] = 207,
    ["GraphQL Mesh"] = 206,
    ["Grunt JSHint task"] = 212,
    ["Grunt Watch task"] = 213,
    ["Grunt base task"] = 214,
    ["Grunt clean task"] = 210,
    ["Grunt copy task"] = 209,
    ["Grunt cssmin task"] = 211,
    HEMTT = 470,
    Hadolint = 482,
    ["Hardware Sentry Configuration"] = 555,
    Hayson = 216,
    ["Haystack Pipeline"] = 217,
    ["Hazelcast 5 Configuration"] = 218,
    ["Helm Chart.lock"] = 99,
    ["Helm Chart.yaml"] = 98,
    Hugo = 533,
    ["Istanbul Schema"] = 558,
    ["JFrog File Spec"] = 233,
    ["JSON Document Transform"] = 241,
    ["JSON Feed"] = 242,
    ["JSON Resume"] = 351,
    ["JSON Schema Draft 2020-12"] = 451,
    ["JSON Schema Draft 4"] = 448,
    ["JSON Schema Draft 7"] = 449,
    ["JSON Schema Draft 8"] = 450,
    ...
    ["JSON-API"] = 240,
    ["JSON-e templates"] = 506,
    ["JSON-stat 2.0"] = 445,
    JSONPatch = 244,
    Jasmine = 229,
    Jekyll = 230,
    ["Jenkins X Pipelines"] = 231,
    ["Jenkins X Requirements"] = 232,
    ["Jovo Language Models"] = 234,
    ["KSP-AVC"] = 446,
    ["KSP-CKAN"] = 447,
    ["KoDE/CI build.yaml"] = 560,
    ["Kong DBLess Schema"] = 561,
    KrakenD = 247,
    ["LinkML Metamodel"] = 258,
    Liquibase = 512,
    ["Liquibase Flow File"] = 513,
    Markdownlint = 516,
    ["MegaLinter configuration"] = 262,
    ["MegaLinter descriptor"] = 263,
    ["Meltano plugin discovery definition"] = 265,
    ["Meltano project definition"] = 264,
    ["Microsoft Band Web Tile"] = 266,
    ["Minecraft Data Pack Advancement"] = 268,
    ["Minecraft Data Pack Biome"] = 269,
    ["Minecraft Data Pack Configured Carver"] = 270,
    ["Minecraft Data Pack Dimension"] = 272,
    ["Minecraft Data Pack Dimension Type"] = 271,
    ["Minecraft Data Pack Item Modifier"] = 273,
    ["Minecraft Data Pack Loot Table"] = 274,
    ["Minecraft Data Pack Metadata"] = 275,
    ["Minecraft Data Pack Predicate"] = 276,
    ["Minecraft Data Pack Recipe"] = 277,
    ["Minecraft Data Pack Template Pool"] = 278,
    ["Minecraft Resourcepack Sounds"] = 279,
    ["MongoDB Atlas Search Index Definition Schema"] = 559,
    ["Monika Configuration Schema"] = 557,
    ["Motif config"] = 466,
    ["Netin Diagnostic System Template"] = 521,
    ["Netlify config schema"] = 284,
    ["Nightwatch.js"] = 285,
    ["OSS Review Toolkit curation"] = 307,
    ["OSS Review Toolkit package configuration"] = 308,
    ["OSS Review Toolkit repository configuration"] = 309,
    ["OSS Review Toolkit resolutions"] = 310,
    Opctl = 469,
    ["OpenWeather Current Weather API"] = 505,
    ["OpenWeather Road Risk API"] = 504,
    ["Ory Hydra configuration"] = 222,
    ["Ory Keto configuration"] = 249,
    ["Ory Kratos configuration"] = 306,
    ["Ory Oathkeeper configuration"] = 297,
    ["Outblocks App configuration"] = 304,
    ["Outblocks database table"] = 305,
    ["Outblocks project configuration"] = 303,
    Packer = 313,
    ["Pipeline component"] = 514,
    ["PocketMine plugin.yml"] = 317,
    Pterodactyl = 554,
    ["Pull Request Labeler"] = 340,
    PyProject = 344,
    Qodana = 530,
    ["Quali Torque Blueprint Spec 2"] = 552,
    ["RKE Cluster Configuration JSON Schema"] = 511,
    ["RKE Cluster Configuration YAML Schema"] = 510,
    Ray = 481,
    ["Read the Docs"] = 343,
    ["Red-DiscordBot Cog"] = 345,
    ["Red-DiscordBot Cog Repo"] = 346,
    Renovate = 352,
    ["Replit schema"] = 349,
    RoadRunner = 353,
    ["Rust toolchain"] = 355,
    SWADL = 399,
    ["Sapphire CLI Config"] = 356,
    ["SauceCTL Configuration"] = 518,
    ["Schema Catalog"] = 369,
    ["Scoop manifest"] = 374,
    ["Semgrep Rule"] = 376,
    ["Serverless Framework Configuration"] = 525,
    ["Serverless Workflow Schema"] = 526,
    ["Settings.paf"] = 378,
    ["Shopware 6 Configuration"] = 527,
    ["Shopware CLI Extension Store Configuration"] = 528,
    ["Shopware CLI Project Store Configuration"] = 529,
    Solidarity = 383,
    ["Source Maps v3"] = 384,
    SpecIF = 385,
    ["Sponge Mixin configuration"] = 386,
    ["StackHawk Scanner Configuration"] = 524,
    ["StackHead CLI config"] = 390,
    ["StackHead module configuration"] = 391,
    ["StackHead project definition"] = 392,
    Stale = 393,
    Starship = 394,
    ["Statamic Blueprint"] = 395,
    ["Stryker Mutator"] = 396,
    ["StyleCop Analyzers Configuration"] = 397,
    ["Swagger API 2.0"] = 400,
    ["Talisman configuration"] = 401,
    ["Taskfile YAML Schema"] = 507,
    Taurus = 402,
    ["TestEnvironment.json"] = 408,
    Tikibase = 405,
    ["Traefik v2"] = 411,
    ["Traefik v2 File Provider"] = 412,
    Turborepo = 409,
    Tye = 531,
    ["UI5 Manifest"] = 424,
    ["UTAM Page Object"] = 426,
    ["Ubuntu Server Autoinstall"] = 422,
    ["Uniswap Token List"] = 490,
    Updatecli = 538,
    ["User Journey Map YAML Schema"] = 509,
    V2Ray = 542,
    ["VSCode Code Snippets"] = 111,
    ["VSIX CLI publishing"] = 437,
    ["Vela Pipeline Configuration"] = 429,
    Vercel = 110,
    ["Web App Manifest"] = 441,
    ["Web types"] = 444,
    WebExtensions = 440,
    ["Webman package recipe"] = 548,
    ["Windows Package Manager Installer Manifest"] = 487,
    ["Windows Package Manager Locale Manifest"] = 488,
    ["Windows Package Manager Singleton Manifest"] = 486,
    ["Woodpecker pipeline config"] = 520,
    ["Xstate Machine Schema"] = 536,
    ["Yippee-Ki-JSON configuration YML"] = 492,
    ["angular.json"] = 8,
    ...
    ["devspace.yaml"] = 556,
    ["docfx.json"] = 152,
    ["docker-compose.yml"] = 493,
    ["dockerd.json"] = 151,
    ["dotnet Release Index manifest"] = 161,
    ["dotnetcli.host.json"] = 162,
    ["drone.json"] = 163,
    ["dss-2.0.0.json"] = 165,
    ["dvc.yaml"] = 166,
    ["ecosystem.json"] = 168,
    eksctl = 169,
    ["electron-builder configuration file."] = 174,
    ["epr-manifest.json"] = 172,
    ["evcc.yaml"] = 175,
    ["fabric.mod.json"] = 179,
    ["first-timers-bot"] = 182,
    ["fly.io Schema"] = 43,
    fulibWorkflows = 519,
    ["func.yaml"] = 187,
    ["function.json"] = 188,
    ...
    ["gitlab-ci"] = 199,
    ["global.json"] = 201,
    ["golangci-lint Configuration"] = 202,
    ["haxelib.json"] = 215,
    helmfile = 483,
    ["host-meta.json"] = 220,
    ["host.json"] = 219,
    ...
    huskyrc = 462,
    ["ide.host.json"] = 223,
    ["imageoptimizer.json"] = 224,
    ["importmap.json"] = 226,
    ["ioBroker JSON UI"] = 227,
    ["ioBroker Package manifest"] = 228,
    ["jsconfig.json"] = 245,
    ["jscpd Configuration Schema"] = 553,
    jsdoc = 480,
    ["k3d.yaml"] = 246,
    ["kustomization.yaml"] = 250,
    ["label-commenter-config.yml"] = 251,
    ["launchsettings.json"] = 252,
    ["lerna.json"] = 253,
    ["lgtm.yml"] = 254,
    ["libman.json"] = 255,
    ["license-report-config.json"] = 256,
    ["linkinator.config.json"] = 257,
    ["local.settings.json"] = 259,
    ["localazy.json"] = 260,
    ["lsdlschema.json"] = 261,
    ["markdown-lint-check"] = 517,
    mboats = 523,
    ["mimetypes.json"] = 267,
    ["mta.yaml"] = 464,
    ["mtad.yaml"] = 465,
    ["mycode.json"] = 282,
    ["napari plugin manifest"] = 283,
    neoload = 475,
    ["nest-cli"] = 288,
    ["ninjs (News in JSON) 1.3"] = 287,
    ["ninjs (News in JSON) 2.0"] = 286,
    ["nlu.json"] = 289,
    ["nodemon.json"] = 291,
    ["noodl.schema.json"] = 522,
    now = 471,
    ["nswag.json"] = 295,
    ntangle = 296,
    ["nuclei-template.yaml"] = 293,
    ["nuget-project.json"] = 294,
    ["ocelot.json"] = 298,
    ["omnisharp.json"] = 299,
    ["openapi.json"] = 300,
    ["openfin.json"] = 302,
    ["openrpc.json"] = 301,
    ["package.json"] = 311,
    ["package.manifest"] = 312,
    ["pattern.json"] = 315,
    ["petstore-v1.0"] = 563,
    pgap_yaml_input_reader = 314,
    ["plagiarize-me.yaml"] = 319,
    ["plagiarize.yaml"] = 318,
    ["portman.json"] = 320,
    ["prettierrc.json"] = 325,
    ["prisma.yml"] = 326,
    ["project-1.0.0-beta3.json"] = 328,
    ["project-1.0.0-beta4.json"] = 329,
    ["project-1.0.0-beta5.json"] = 330,
    ["project-1.0.0-beta6.json"] = 331,
    ["project-1.0.0-beta8.json"] = 332,
    ["project-1.0.0-rc1.json"] = 333,
    ["project-1.0.0-rc2.json"] = 334,
    ["project.json"] = 327,
    ["prometheus.json"] = 335,
    ["prometheus.rules.json"] = 336,
    ["proxies.json"] = 337,
    ["publiccode.yml"] = 338,
    ["pubspec.yaml"] = 339,
    ["pyrseas-0.8.json"] = 342,
    ["release drafter"] = 476,
    rustfmt = 354,
    ["sarif-1.0.0.json"] = 357,
    ["sarif-2.0.0.json"] = 358,
    ["sarif-2.1.0"] = 367,
    ["sarif-2.1.0-rtm.2"] = 359,
    ["sarif-2.1.0-rtm.3"] = 361,
    ["sarif-2.1.0-rtm.4"] = 363,
    ["sarif-2.1.0-rtm.5"] = 365,
    ["sarif-external-property-file-2.1.0"] = 368,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 360,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 362,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 364,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 366,
    ["schema.org - Action"] = 370,
    ["schema.org - ContactPoint"] = 371,
    ["schema.org - Place"] = 372,
    ["schema.org - Thing"] = 373,
    ["semantic-release"] = 375,
    ["servicehub.config.json"] = 454,
    ["servicehub.service.json"] = 453,
    ["settings.job"] = 377,
    ["sfdx-hardis configuration"] = 379,
    ["size-limit configuration"] = 380,
    ["skaffold.yaml"] = 515,
    ["skyuxconfig.json"] = 381,
    snapcraft = 382,
    swcrc = 503,
    taskcat = 472,
    ["template.json"] = 403,
    ["templatsources.json"] = 404,
    ["theme.json"] = 406,
    tmLanguage = 407,
    ["trunk.yaml schema"] = 413,
    ["ts-force-config.json"] = 417,
    ["tsconfig.json"] = 414,
    ["tsd.json"] = 415,
    ["tsdrc.json"] = 416,
    ["tslint.json"] = 418,
    ...
    ["version.json"] = 430,
    ["vim-addon-info"] = 431,
    ["vs-2017.3.host.json"] = 433,
    ["vs-nesting.json"] = 434,
    ["vsls.json"] = 432,
    ["vss-extension.json"] = 438,
    ["webhint.io"] = 549,
    ["webjobpublishsettings.json"] = 443,
    ["webjobs-list.json"] = 442,
    ["xs-app.json"] = 468,
    ["xunit.runner.json"] = 452,
    yamllint = 491,
    zuul = 477,
    ["Žinoma"] = 485
  },
