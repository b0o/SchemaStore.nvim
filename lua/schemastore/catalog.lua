...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 165,
    [".cryproj (generic)"] = 569,
    [".cryproj engine-5.2"] = 564,
    [".cryproj engine-5.3"] = 565,
    [".cryproj engine-5.4"] = 566,
    [".cryproj engine-5.5"] = 567,
    [".cryproj engine-dev"] = 568,
    [".csscomb.json"] = 167,
    [".csslintrc"] = 168,
    [".es6importsorterrc.json"] = 696,
    [".eslintrc"] = 214,
    [".esmrc.json"] = 206,
    [".ffizer.yaml"] = 218,
    [".htmlhintrc"] = 265,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration Schema"] = 641,
    ["All Contributors configuration file"] = 695,
    ...
    ["Azure Pipelines"] = 54,
    ["Azure Static Web Apps CLI configuration file"] = 486,
    ["Azure Static Web Apps configuration file"] = 485,
    ["BX CI"] = 89,
    ["Better Code Hub"] = 614,
    ["Better Scripts"] = 90,
    BizTalkServerApplicationSchema = 584,
    ...
    ["Butane Config"] = 653,
    ["CICS TS region tagging"] = 660,
    ["CICS TS resource import"] = 661,
    ["CICS TS resource model"] = 662,
    ["CICS TS resource overrides"] = 663,
    ["CMake Presets"] = 91,
    ...
    ["Datahub Ingestion Recipe Schema"] = 667,
    ...
    ["Embrace Config Schema"] = 678,
    ["Error pages"] = 209,
    Esquio = 207,
    ["Estuary Flow Catalog Schema"] = 657,
    ["Expo SDK"] = 212,
    ...
    Goreleaser = 247,
    ["Goreleaser Pro"] = 248,
    ["Gradle Build Cache Node"] = 611,
    ["Gradle Enterprise"] = 610,
    ...
    Hadolint = 593,
    Hammerkit = 621,
    ["Hardware Sentry Configuration"] = 671,
    Hayson = 260,
    ...
    ["JFrog File Spec"] = 284,
    ["JFrog Pipelines YML DSL"] = 680,
    ["JMeter DSL cli config schema"] = 285,
    JReleaser = 287,
    ["JSON Document Transform"] = 294,
    ["JSON Feed"] = 295,
    ["JSON Resume"] = 438,
    ["JSON Schema Draft 2020-12"] = 560,
    ["JSON Schema Draft 4"] = 557,
    ["JSON Schema Draft 7"] = 558,
    ["JSON Schema Draft 8"] = 559,
    ...
    Kas = 300,
    ["Keycloak REST API"] = 687,
    ["Knative Functions - func.yaml"] = 229,
    ["KoDE/CI build.yaml"] = 676,
    ["Kong DBLess Schema"] = 677,
    KrakenD = 301,
    LOOBin = 317,
    Lefthook = 308,
    ["LinkML Metamodel"] = 315,
    Liquibase = 626,
    ["Liquibase Flow File"] = 627,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 675,
    ["Monika Configuration Schema"] = 673,
    ["Motif config"] = 577,
    ["NOX Framework (Service)"] = 362,
    ["Netin Diagnostic System Template"] = 636,
    ...
    ["OpenWeather Current Weather API"] = 618,
    ["OpenWeather Road Risk API"] = 617,
    ...
    Pyright = 427,
    Qodana = 646,
    ["Quali Torque Blueprint Spec 2"] = 668,
    ["QueryFirst config file"] = 690,
    ["RKE Cluster Configuration JSON Schema"] = 625,
    ["RKE Cluster Configuration YAML Schema"] = 624,
    ["Rancher Fleet"] = 423,
    Ray = 592,
    ["Read the Docs"] = 424,
    ...
    ["Rust Project"] = 437,
    ["Rust toolchain"] = 442,
    ["SIL Kit Participant Configuration"] = 472,
    ["SIL Kit Registry Configuration"] = 473,
    SWADL = 495,
    ["Safebox Config Schema"] = 681,
    ["Sapphire CLI Config"] = 445,
    ["SauceCTL Configuration"] = 633,
    ["Schema Catalog"] = 458,
    ["Scoop manifest"] = 463,
    ["Semantic Data Fabric (SDF) file"] = 464,
    ["Semgrep Rule"] = 466,
    ["Serenity Code Generator (Sergen)"] = 467,
    ["Serverless Framework Configuration"] = 640,
    ["Serverless Workflow Schema"] = 642,
    ["Settings.paf"] = 469,
    ["Shopware 6 Configuration"] = 643,
    ["Shopware CLI Extension Store Configuration"] = 644,
    ["Shopware CLI Project Store Configuration"] = 645,
    ["Sigrid scope configuration file"] = 471,
    ["Slack app manifest"] = 475,
    Solidarity = 478,
    ["Solution filters"] = 479,
    ["Source Maps v3"] = 480,
    Sourcery = 481,
    SpecIF = 482,
    ["Sponge Mixin configuration"] = 483,
    ["StackHawk Scanner Configuration"] = 639,
    Stale = 487,
    Starship = 488,
    ["Statamic Blueprint"] = 489,
    ["StrmPrivacy Data Connector"] = 685,
    ["StrmPrivacy Data Contract"] = 686,
    ["StrmPrivacy SimpleSchema"] = 683,
    ["StrmPrivacy Stream"] = 684,
    ["StrmPrivacy batch job configuration file"] = 682,
    ["Stryker Mutator"] = 492,
    ["StyleCop Analyzers Configuration"] = 493,
    ["Swagger API 2.0"] = 496,
    TSON = 520,
    ["Talisman configuration"] = 498,
    ["Taskfile YAML Schema"] = 620,
    Taurus = 499,
    ["TestEnvironment.json"] = 508,
    ["Tier.run pricing.json"] = 502,
    Tikibase = 503,
    ["Traefik v2"] = 511,
    ["Traefik v2 File Provider"] = 512,
    Turborepo = 509,
    Tye = 647,
    ["UET BuildConfig.json"] = 691,
    ["UI5 Manifest"] = 527,
    ["UTAM Page Object"] = 530,
    ["Ubuntu Server Autoinstall"] = 525,
    ["Uniswap Token List"] = 602,
    ["Unreal Engine Uplugin"] = 692,
    ["Unreal Engine Uproject"] = 693,
    Updatecli = 654,
    Uplift = 689,
    ["User Journey Map YAML Schema"] = 623,
    V2Ray = 658,
    ["VSCode Code Snippets"] = 137,
    ["VSIX CLI publishing"] = 543,
    ["Vela Pipeline Configuration"] = 533,
    Vercel = 136,
    ["Web App Manifest"] = 550,
    ["Web types"] = 553,
    WebExtensions = 549,
    ["Webman package recipe"] = 664,
    ["Windows Package Manager Installer Manifest"] = 599,
    ["Windows Package Manager Locale Manifest"] = 600,
    ["Windows Package Manager Singleton Manifest"] = 598,
    ["Woodpecker pipeline config"] = 635,
    ["Xstate Machine Schema"] = 652,
    ["Yippee-Ki-JSON configuration YML"] = 604,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 65,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 700,
    ["bashly-strings.yml"] = 701,
    ["bashly.yml"] = 699,
    ["batect.yml"] = 64,
    ["beau.yml"] = 613,
    ...
    ["ize.toml"] = 688,
    ["jsconfig.json"] = 298,
    ["jscpd Configuration Schema"] = 669,
    jsdoc = 591,
    ["k3d.yaml"] = 299,
    ...
    ["lsdlschema.json"] = 321,
    ["madness.yml"] = 698,
    ["markdown-lint-check"] = 631,
    mboats = 638,
    ["micro-settings.json"] = 702,
    ["mimetypes.json"] = 328,
    ["mirrord-schema"] = 574,
    ["mta.yaml"] = 575,
    ["mtad.yaml"] = 576,
    ...
    ["sarif-external-property-file-2.1.0"] = 457,
    ...
    ["sarif-external-property-file-2.1.0-rtm.5"] = 455,
    ["schema.org - Action"] = 459,
    ["schema.org - ContactPoint"] = 460,
    ["schema.org - Place"] = 461,
    ["schema.org - Thing"] = 462,
    ["secrethub.yml"] = 705,
    ["semantic-release"] = 465,
    ["servicehub.config.json"] = 563,
    ["servicehub.service.json"] = 562,
    ["settings.job"] = 468,
    ["sfdx-hardis configuration"] = 470,
    ["size-limit configuration"] = 474,
    ["skaffold.yaml"] = 629,
    ["skyuxconfig.json"] = 476,
    snapcraft = 477,
    ["stripe-app-local.json"] = 491,
    ["stripe-app.json"] = 490,
    swcrc = 616,
    syntax = 707,
    ["task.json"] = 497,
    taskcat = 583,
    ["template.json"] = 500,
    ["templatsources.json"] = 501,
    ["theme.json"] = 504,
    ["tizen_workspace.json"] = 505,
    tldr = 506,
    tmLanguage = 507,
    tmuxinator = 571,
    ["transcend.yml"] = 513,
    ["trunk.yaml schema"] = 514,
    ["ts-force-config.json"] = 518,
    ["tsconfig.json"] = 515,
    ["tsd.json"] = 516,
    ["tsdrc.json"] = 517,
    ["tslint.json"] = 519,
    ...
    ["vega-lite.json"] = 532,
    ["vega.json"] = 531,
    ["venvironment-basic.yaml"] = 535,
    ["venvironment.yaml"] = 534,
    ["version.json"] = 536,
    ["vim-addon-info"] = 537,
    ["vs-2017.3.host.json"] = 539,
    ["vs-nesting.json"] = 540,
    ["vsls.json"] = 538,
    ["vss-extension.json"] = 544,
    ["vtesttree.yaml"] = 545,
    ["vtestunit.yaml"] = 546,
    ["webhint.io"] = 665,
    ["webjobpublishsettings.json"] = 552,
    ["webjobs-list.json"] = 551,
    ["xs-app.json"] = 579,
    ["xunit.runner.json"] = 561,
    yamllint = 603,
    zuul = 588,
    ["Žinoma"] = 597
  },
