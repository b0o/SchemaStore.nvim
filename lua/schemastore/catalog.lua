...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 162,
    [".cryproj (generic)"] = 556,
    [".cryproj engine-5.2"] = 551,
    [".cryproj engine-5.3"] = 552,
    [".cryproj engine-5.4"] = 553,
    [".cryproj engine-5.5"] = 554,
    [".cryproj engine-dev"] = 555,
    [".csscomb.json"] = 164,
    [".csslintrc"] = 165,
    [".es6importsorterrc.json"] = 679,
    [".eslintrc"] = 210,
    [".esmrc.json"] = 202,
    [".ffizer.yaml"] = 214,
    [".htmlhintrc"] = 259,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration Schema"] = 626,
    ["All Contributors configuration file"] = 678,
    ...
    ["Azure Pipelines"] = 52,
    ["Azure Static Web Apps CLI configuration file"] = 473,
    ["Azure Static Web Apps configuration file"] = 472,
    ["BX CI"] = 87,
    ["Better Code Hub"] = 599,
    ["Better Scripts"] = 88,
    BizTalkServerApplicationSchema = 571,
    ...
    ["Butane Config"] = 638,
    ["CICS TS region tagging"] = 645,
    ["CICS TS resource import"] = 646,
    ["CICS TS resource model"] = 647,
    ["CICS TS resource overrides"] = 648,
    ["CMake Presets"] = 89,
    ...
    ["Datahub Ingestion Recipe Schema"] = 652,
    ...
    ["Embrace Config Schema"] = 663,
    ["Error pages"] = 205,
    Esquio = 203,
    ["Estuary Flow Catalog Schema"] = 642,
    ["Expo SDK"] = 208,
    ...
    Goreleaser = 241,
    ["Goreleaser Pro"] = 242,
    ["Gradle Build Cache Node"] = 596,
    ["Gradle Enterprise"] = 595,
    ...
    Hadolint = 580,
    Hammerkit = 606,
    ["Hardware Sentry Configuration"] = 656,
    Hayson = 254,
    ...
    ["JFrog File Spec"] = 278,
    ["JFrog Pipelines YML DSL"] = 665,
    ["JMeter DSL cli config schema"] = 279,
    JReleaser = 281,
    ["JSON Document Transform"] = 288,
    ["JSON Feed"] = 289,
    ["JSON Resume"] = 427,
    ["JSON Schema Draft 2020-12"] = 547,
    ["JSON Schema Draft 4"] = 544,
    ["JSON Schema Draft 7"] = 545,
    ["JSON Schema Draft 8"] = 546,
    ...
    ["KSP-CKAN"] = 543,
    Kas = 294,
    ["Keycloak REST API"] = 671,
    ["Knative Functions - func.yaml"] = 223,
    ["KoDE/CI build.yaml"] = 661,
    ["Kong DBLess Schema"] = 662,
    KrakenD = 295,
    LOOBin = 310,
    ["LinkML Metamodel"] = 308,
    Liquibase = 611,
    ["Liquibase Flow File"] = 612,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 660,
    ["Monika Configuration Schema"] = 658,
    ["Motif config"] = 564,
    ["NOX Framework (Service)"] = 353,
    ["Netin Diagnostic System Template"] = 621,
    ...
    ["OpenWeather Current Weather API"] = 603,
    ["OpenWeather Road Risk API"] = 602,
    ...
    ["Pipeline component"] = 613,
    ["PocketMine plugin.yml"] = 384,
    ["Postman collection"] = 389,
    Pterodactyl = 655,
    ["Pull Request Labeler"] = 409,
    Pulumi = 414,
    PyProject = 415,
    Pyright = 416,
    Qodana = 631,
    ["Quali Torque Blueprint Spec 2"] = 653,
    ["QueryFirst config file"] = 674,
    ["RKE Cluster Configuration JSON Schema"] = 610,
    ["RKE Cluster Configuration YAML Schema"] = 609,
    ["Rancher Fleet"] = 412,
    Ray = 579,
    ["Read the Docs"] = 413,
    ["Red-DiscordBot Cog"] = 417,
    ["Red-DiscordBot Cog Repo"] = 418,
    ["Red-DiscordBot Trivia"] = 419,
    Renovate = 428,
    ["Replit schema"] = 422,
    RoadRunner = 429,
    Ruff = 425,
    ["Rust Project"] = 426,
    ["Rust toolchain"] = 431,
    ["SIL Kit Participant Configuration"] = 460,
    SWADL = 482,
    ["Sapphire CLI Config"] = 434,
    ["SauceCTL Configuration"] = 618,
    ["Schema Catalog"] = 447,
    ["Scoop manifest"] = 452,
    ["Semantic Data Fabric (SDF) file"] = 453,
    ["Semgrep Rule"] = 455,
    ["Serenity Code Generator (Sergen)"] = 456,
    ["Serverless Framework Configuration"] = 625,
    ["Serverless Workflow Schema"] = 627,
    ["Settings.paf"] = 458,
    ["Shopware 6 Configuration"] = 628,
    ["Shopware CLI Extension Store Configuration"] = 629,
    ["Shopware CLI Project Store Configuration"] = 630,
    ["Slack app manifest"] = 462,
    Solidarity = 465,
    ["Solution filters"] = 466,
    ["Source Maps v3"] = 467,
    Sourcery = 468,
    SpecIF = 469,
    ["Sponge Mixin configuration"] = 470,
    ["StackHawk Scanner Configuration"] = 624,
    Stale = 474,
    Starship = 475,
    ["Statamic Blueprint"] = 476,
    ["StrmPrivacy Data Connector"] = 669,
    ["StrmPrivacy Data Contract"] = 670,
    ["StrmPrivacy SimpleSchema"] = 667,
    ["StrmPrivacy Stream"] = 668,
    ["StrmPrivacy batch job configuration file"] = 666,
    ["Stryker Mutator"] = 479,
    ["StyleCop Analyzers Configuration"] = 480,
    ["Swagger API 2.0"] = 483,
    TSON = 507,
    ["Talisman configuration"] = 485,
    ["Taskfile YAML Schema"] = 605,
    Taurus = 486,
    ["TestEnvironment.json"] = 495,
    ["Tier.run pricing.json"] = 489,
    Tikibase = 490,
    ["Traefik v2"] = 498,
    ["Traefik v2 File Provider"] = 499,
    Turborepo = 496,
    Tye = 632,
    ["UI5 Manifest"] = 514,
    ["UTAM Page Object"] = 517,
    ["Ubuntu Server Autoinstall"] = 512,
    ["Uniswap Token List"] = 588,
    ["Unreal Engine Uplugin"] = 675,
    ["Unreal Engine Uproject"] = 676,
    Updatecli = 639,
    Uplift = 673,
    ["User Journey Map YAML Schema"] = 608,
    V2Ray = 643,
    ["VSCode Code Snippets"] = 135,
    ["VSIX CLI publishing"] = 530,
    ["Vela Pipeline Configuration"] = 520,
    Vercel = 134,
    ["Web App Manifest"] = 537,
    ["Web types"] = 540,
    WebExtensions = 536,
    ["Webman package recipe"] = 649,
    ["Windows Package Manager Installer Manifest"] = 585,
    ["Windows Package Manager Locale Manifest"] = 586,
    ["Windows Package Manager Singleton Manifest"] = 584,
    ["Woodpecker pipeline config"] = 620,
    ["Xstate Machine Schema"] = 637,
    ["Yippee-Ki-JSON configuration YML"] = 590,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 63,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 681,
    ["bashly-strings.yml"] = 682,
    ["bashly.yml"] = 680,
    ["batect.yml"] = 62,
    ["beau.yml"] = 598,
    ...
    ["ize.toml"] = 672,
    ["jsconfig.json"] = 292,
    ["jscpd Configuration Schema"] = 654,
    jsdoc = 578,
    ["k3d.yaml"] = 293,
    ...
    ["lotus.yaml"] = 311,
    ["lsdlschema.json"] = 314,
    ["markdown-lint-check"] = 616,
    mboats = 623,
    ["micro-settings.json"] = 683,
    ["mimetypes.json"] = 321,
    ["mirrord-schema"] = 561,
    ["mta.yaml"] = 562,
    ["mtad.yaml"] = 563,
    ...
    samt = 432,
    samtrc = 433,
    ["sarif-1.0.0.json"] = 435,
    ["sarif-2.0.0.json"] = 436,
    ["sarif-2.1.0"] = 445,
    ["sarif-2.1.0-rtm.2"] = 437,
    ["sarif-2.1.0-rtm.3"] = 439,
    ["sarif-2.1.0-rtm.4"] = 441,
    ["sarif-2.1.0-rtm.5"] = 443,
    ["sarif-external-property-file-2.1.0"] = 446,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 438,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 440,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 442,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 444,
    ["schema.org - Action"] = 448,
    ["schema.org - ContactPoint"] = 449,
    ["schema.org - Place"] = 450,
    ["schema.org - Thing"] = 451,
    ["semantic-release"] = 454,
    ["servicehub.config.json"] = 550,
    ["servicehub.service.json"] = 549,
    ["settings.job"] = 457,
    ["sfdx-hardis configuration"] = 459,
    ["size-limit configuration"] = 461,
    ["skaffold.yaml"] = 614,
    ["skyuxconfig.json"] = 463,
    snapcraft = 464,
    ["stripe-app-local.json"] = 478,
    ["stripe-app.json"] = 477,
    swcrc = 601,
    ["task.json"] = 484,
    taskcat = 570,
    ["template.json"] = 487,
    ["templatsources.json"] = 488,
    ["theme.json"] = 491,
    ["tizen_workspace.json"] = 492,
    tldr = 493,
    tmLanguage = 494,
    tmuxinator = 558,
    ["transcend.yml"] = 500,
    ["trunk.yaml schema"] = 501,
    ["ts-force-config.json"] = 505,
    ["tsconfig.json"] = 502,
    ["tsd.json"] = 503,
    ["tsdrc.json"] = 504,
    ["tslint.json"] = 506,
    ...
    ["vega-lite.json"] = 519,
    ["vega.json"] = 518,
    ["venvironment-basic.yaml"] = 522,
    ["venvironment.yaml"] = 521,
    ["version.json"] = 523,
    ["vim-addon-info"] = 524,
    ["vs-2017.3.host.json"] = 526,
    ["vs-nesting.json"] = 527,
    ["vsls.json"] = 525,
    ["vss-extension.json"] = 531,
    ["vtesttree.yaml"] = 532,
    ["vtestunit.yaml"] = 533,
    ["webhint.io"] = 650,
    ["webjobpublishsettings.json"] = 539,
    ["webjobs-list.json"] = 538,
    ["xs-app.json"] = 566,
    ["xunit.runner.json"] = 548,
    yamllint = 589,
    zuul = 575,
    ["Žinoma"] = 583
  },
