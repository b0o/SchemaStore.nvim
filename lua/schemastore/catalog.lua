...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1108,
    [".nodehawkrc"] = 713,
    [".npmpackagejsonlintrc"] = 718,
    [".omletrc"] = 1289,
    [".phrase.yml"] = 800,
    [".phraseapp.yml"] = 801,
    [".pmbot.yml"] = 785,
    [".postcssrc"] = 794,
    [".powerpages-web-template-manifest"] = 796,
    [".pre-commit-config.yml"] = 797,
    [".pre-commit-hooks.yml"] = 798,
    [".putout.json"] = 834,
    [".rehyperc"] = 859,
    [".remarkrc"] = 863,
    [".sprite files"] = 965,
    ...
    AIConfig = 50,
    ["AMX Muse Program Descriptor"] = 1338,
    ["API Builder"] = 1144,
    ["AVA Configuration"] = 1208,
    ["AWS AppConfig Feature Flags-v1"] = 90,
    ["AWS CDK cdk.json"] = 323,
    ["AWS CloudFormation"] = 324,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 325,
    ["AWS Copilot Manifest"] = 1377,
    ["AWS SAM CLI Samconfig"] = 326,
    Acton = 1431,
    ["Adobe UXP Manifest"] = 1271,
    ["Aerleon Network & Service Definitions"] = 30,
    ["Aerleon Policy"] = 31,
    ["Agent Permission Policy"] = 1417,
    ["Agent Run Metrics"] = 32,
    ["AgentCore CLI"] = 1418,
    ["AgentCtl MCP"] = 1420,
    ["AgentCtl config"] = 1419,
    ["AgentCtl permissions"] = 1421,
    AgentLoopKit = 1422,
    Aider = 1367,
    Air = 34,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1388,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1387,
    ["Airlock Microgateway"] = 51,
    ["Alacritty Configuration"] = 1180,
    ["AlgoVoi Compliance Receipt v1"] = 19,
    ["All Contributors configuration file"] = 1234,
    ["Amazon S3 bucket CORS"] = 21,
    Ameba = 1,
    Anodizer = 523,
    ["Ansible Argument Specs"] = 505,
    ["Ansible Collection Galaxy"] = 512,
    ["Ansible Execution Environment"] = 502,
    ["Ansible Inventory"] = 511,
    ["Ansible Meta"] = 503,
    ["Ansible Meta Runtime"] = 504,
    ["Ansible Navigator Configuration"] = 514,
    ["Ansible Playbook"] = 509,
    ["Ansible Requirements"] = 506,
    ["Ansible Rulebook"] = 510,
    ["Ansible Tasks File"] = 508,
    ["Ansible Vars File"] = 507,
    ["Ansible-lint Configuration"] = 513,
    Any = 1299,
    ...
    ["Application list for a WinUtil"] = 1317,
    ["ArchSmith diagram IR"] = 1460,
    ArchitectFX = 1322,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1386,
    ["Azure IoT Operations connector metadata"] = 1383,
    ...
    ["Azure Pipelines"] = 139,
    ["Azure Static Web Apps CLI configuration file"] = 969,
    ["Azure Static Web Apps configuration file"] = 968,
    BMML = 1405,
    ["BOSH BPM Config"] = 167,
    ["BOSH CPI Config"] = 168,
    ...
    Badness = 151,
    ["Barba-CV"] = 105,
    ["Bashly (bashly.yml)"] = 1238,
    ["Bashly Settings (bashly-settings.yml)"] = 1239,
    Bento = 1404,
    ["Better Code Hub"] = 1149,
    ["Better Scripts"] = 194,
    Bigconfig = 160,
    ["Biome Formatter Config"] = 106,
    ["Bitmovin Encoding Template"] = 1331,
    BizTalkServerApplicationSchema = 1115,
    Bleep = 195,
    ["Block Protocol Metadata"] = 192,
    ["Bluebricks blueprint config"] = 1410,
    ["Boyka Framework"] = 173,
    ...
    ["Butane Config"] = 1193,
    C4InterFlow = 1346,
    ["CDK Environment Manager, concrete environment configuration"] = 1370,
    ["CDK Environment Manager, concrete environments definition"] = 1369,
    ["CDK Environment Manager, environment definition"] = 1368,
    ["CGS Card Game Specification (cgs.json)"] = 1276,
    ["CICS TS region tagging"] = 1202,
    ["CICS TS resource import"] = 1203,
    ["CICS TS resource model"] = 1204,
    ["CICS TS resource overrides"] = 1205,
    ["CMake Presets"] = 196,
    ["CNC Codes"] = 222,
    ["CRS WAF test file"] = 1306,
    ["CRS WAF test platform overrides file"] = 1307,
    ["CSS Comb (.csscomb.json)"] = 353,
    ["CSS Lint (.csslintrc)"] = 354,
    ["CSpell (cspell.json)"] = 352,
    ["CVE Record Format"] = 234,
    ["CVX achievements.yaml"] = 240,
    ["CVX competencies.yaml"] = 239,
    ["CVX config.yaml"] = 243,
    ["CVX education.yaml"] = 238,
    ["CVX experience.yaml"] = 237,
    ["CVX keywords.yaml"] = 242,
    ["CVX layout"] = 244,
    ["CVX personal.yaml"] = 235,
    ["CVX referees.yaml"] = 241,
    ["CVX summary.yaml"] = 236,
    CWL = 1282,
    ["Cache Warmup config"] = 197,
    ["Caido Proxy Configuration"] = 1446,
    ...
    ["Cargo Make"] = 205,
    ["Cargo Manifest"] = 204,
    ["Catalog Info Backstage"] = 206,
    ["Chamaleon environment"] = 1335,
    ["Chamaleon properties"] = 1336,
    ["Chamaleon template"] = 1334,
    Changepacks = 1397,
    Changesets = 335,
    Changie = 207,
    Charmcraft = 208,
    Cheatsheets = 1190,
    ["ChordPro Configuration"] = 210,
    ["Chrome Extension"] = 316,
    ["Chromia Model"] = 211,
    ["Chromia Seeder Module Config"] = 213,
    ["Chromia Seeder Root Config"] = 212,
    ["Cinnamon Spice info.json"] = 116,
    ["CircleCI config.yml"] = 288,
    ["Citation File Format"] = 337,
    ["Citrus test case"] = 215,
    CityJSON = 216,
    ["Claude Code Keybindings"] = 229,
    ["Claude Code Launch Preview"] = 1459,
    ["Claude Code Plugin Manifest"] = 230,
    ["Claude Code Plugin Marketplace"] = 231,
    ["Claude Code Settings"] = 232,
    ["Clawject config"] = 228,
    ["Cloud Foundry Application Manifest"] = 1288,
    ["Cloud Run Spec v1"] = 1312,
    ...
    ["CloudEvents specification"] = 217,
    ["Code Climate"] = 289,
    CodeCV = 120,
    CodeRabbit = 119,
    ["Codecov configuration files"] = 306,
    Codex = 297,
    ["Codex Hooks"] = 298,
    ["Codex Plugin Manifest"] = 299,
    ["Codex Skill Metadata"] = 300,
    CodifyCLI = 121,
    Codux = 302,
    ["Cog config file"] = 223,
    ["Commandbox Box.json"] = 224,
    ["Commandbox Server.json"] = 225,
    ["Common Catalog Data"] = 314,
    ["Common Package Specification"] = 226,
    Concord = 1305,
    ["Configu .cfgu files"] = 1293,
    ["Configu .configu file"] = 1294,
    Conjure = 221,
    ["Container Structure Test"] = 1129,
    Containerlab = 1158,
    ["Context Passport"] = 2,
    ["Context Reasoning Format (CRF)"] = 219,
    ["Contextive Glossary"] = 1362,
    ContractGuard = 1159,
    Convex = 220,
    ["Crowdsec collection config"] = 346,
    ["Crowdsec parser config"] = 347,
    ["Crowdsec scenario config"] = 348,
    ["CumulusCI Config"] = 227,
    ["Cursor Agent Environment"] = 1415,
    ["Custom Machinery Machine"] = 1277,
    ["Custom Machinery Recipe"] = 1278,
    ["Cycle Stack File"] = 245,
    CycloneDX = 246,
    ["DWP Exchange - catalogue entry"] = 403,
    ["DWP Exchange - gateway"] = 401,
    ["DWP Exchange - meta"] = 402,
    ["Dagger module"] = 355,
    ["Dark Factory consumer config"] = 247,
    ["Dart Build Config (dart-build.json)"] = 356,
    ["Dart Test Config (dart-test.json)"] = 357,
    ["DashLord Configuration"] = 358,
    ["Data Contract Specification"] = 359,
    ["Data Product Specification"] = 360,
    ["DataYoga Connections"] = 248,
    ["DataYoga Job"] = 249,
    ["Datadog Continuous Testing"] = 613,
    ["Datadog Service Definition"] = 614,
    ["Datadog Software Catalog"] = 615,
    ["Datahub Ingestion Recipe"] = 1209,
    ["Debian Upstream Metadata file"] = 256,
    DebtLens = 257,
    ["Decision Reasoning Format (DRF)"] = 258,
    ["Deck config"] = 259,
    ["Declarative Automation Bundles"] = 1255,
    ["DeepMatch deeplinks spec"] = 260,
    ["Defakto CI"] = 1467,
    ["Dein Config"] = 261,
    ["Deno Config (deno.json)"] = 369,
    ["Dependency cruiser"] = 262,
    ["DeployStack Configuration"] = 263,
    ["Deployah Configuration"] = 1385,
    ["Deployer Recipe"] = 372,
    ["Design Tokens Community Group format"] = 264,
    ["Design Tokens Community Group resolver"] = 265,
    ["Deta Spacefile"] = 266,
    ["Detekt Config (detekt.yml)"] = 373,
    ["Devbox Config"] = 267,
    ["Devbox Plugin"] = 268,
    Devfile = 400,
    Devup = 1398,
    DipDup = 1308,
    ["Discord Webhook"] = 374,
    ["DocFx Config (docfx.json)"] = 379,
    ["Docker Desktop extension metadata"] = 376,
    ["Docs MCP Manifest"] = 380,
    Dofigen = 381,
    ["Dolittle Artifacts"] = 382,
    ["Dolittle Bounded Context Configuration"] = 383,
    ["Dolittle Event Horizons Configuration"] = 384,
    ["Dolittle Resources Configuration"] = 385,
    ["Dolittle Server Configuration"] = 386,
    ["Dolittle Tenant Map Configuration"] = 388,
    ["Dolittle Tenants Configuration"] = 387,
    ["Dolittle Topology"] = 389,
    ["DonateCaseBetterCasino menu"] = 1339,
    ["Draugr Saga"] = 367,
    ["Draugr Saga fragment"] = 368,
    ["Drupal Breakpoints"] = 270,
    ["Drupal Config"] = 282,
    ["Drupal Info"] = 271,
    ["Drupal Layouts"] = 272,
    ["Drupal Libraries"] = 273,
    ["Drupal Links Action"] = 274,
    ["Drupal Links Contextual"] = 275,
    ["Drupal Links Menu"] = 276,
    ["Drupal Links Task"] = 277,
    ["Drupal Migration"] = 278,
    ["Drupal Permissions"] = 279,
    ["Drupal Recipe"] = 280,
    ["Drupal Routing"] = 281,
    ["Drupal Services"] = 283,
    ["Drush site aliases"] = 395,
    ["Dust configuration"] = 398,
    ["Dynamic Bash Aliases (.aliases)"] = 1246,
    ["EAS config"] = 442,
    ["ECA - Editor Code Assistant"] = 405,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1235,
    ["ESLint Suppressions"] = 447,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1382,
    ["EasyVCR .NET"] = 444,
    ["Eidolon Resource"] = 1323,
    ["Elgato Stream Deck"] = 408,
    Elm = 1310,
    ["Embrace Config"] = 1221,
    Emmet = 1311,
    Endurica = 1259,
    ["Enonic XP API descriptor"] = 411,
    ["Enonic XP Admin Extension descriptor"] = 412,
    ["Enonic XP Admin Tool descriptor"] = 413,
    ["Enonic XP Application descriptor"] = 414,
    ["Enonic XP CMS descriptor"] = 415,
    ["Enonic XP Content Type descriptor"] = 416,
    ["Enonic XP Form Fragment descriptor"] = 417,
    ["Enonic XP ID Provider descriptor"] = 418,
    ["Enonic XP Layout descriptor"] = 419,
    ["Enonic XP Macro descriptor"] = 420,
    ["Enonic XP Mixin descriptor"] = 421,
    ["Enonic XP Page descriptor"] = 422,
    ["Enonic XP Part descriptor"] = 423,
    ["Enonic XP Service descriptor"] = 424,
    ["Enonic XP Site descriptor"] = 425,
    ["Enonic XP Style descriptor"] = 426,
    ["Enonic XP Task descriptor"] = 427,
    ["Enonic XP Webapp descriptor"] = 428,
    ["Enterprise Contract Policy Spec"] = 409,
    ["Envelope Team Definition"] = 1430,
    ["Envilder Map File"] = 410,
    ["Erda Pipeline"] = 1284,
    ["Erda Runtime"] = 1285,
    ["Espanso config.yml"] = 1408,
    ["Espanso match.yml"] = 1407,
    Esquio = 430,
    ["Estuary Flow Catalog"] = 1199,
    ["Ethereum ERC1155"] = 1424,
    ["Ethereum ERC721"] = 1423,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 435,
    ["EveryVoice TTS Toolkit Data Configuration"] = 436,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 440,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 439,
    ["EveryVoice TTS Toolkit Text Configuration"] = 437,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 438,
    ["Evolving Resolutive Process notation"] = 1384,
    ["Expo SDK"] = 441,
    ["Expoot app config"] = 443,
    ["F-Droid Data metadata"] = 449,
    ["FasterCI Configuration"] = 140,
    Fatou = 141,
    ["Fence configuration"] = 142,
    FiQuS = 453,
    Firebase = 451,
    ["Flatpak Builder Manifest"] = 454,
    ["FlexGet Config"] = 455,
    ["Flow.json Configurations"] = 1281,
    ["Fossa configuration file"] = 462,
    ["Fossa's fossa-deps file"] = 463,
    ["Foundry VTT - Base package Manifest"] = 457,
    ["Foundry VTT - Module Manifest"] = 458,
    ["Foundry VTT - System Data Template"] = 461,
    ["Foundry VTT - System Manifest"] = 459,
    ["Foundry VTT - World Manifest"] = 460,
    ["Foxx Manifest"] = 143,
    ["Freifunk.de Community API"] = 146,
    ["Frogbot Config"] = 147,
    ["G2P Mapping Configuration"] = 470,
    GAMA = 471,
    ["GCP Blueprint Metadata"] = 474,
    Gaspar = 472,
    ["GatewayCore API Gateway"] = 473,
    ["Gemini CLI settings"] = 475,
    ["GeoJSON.json latest"] = 1197,
    GherKing = 1201,
    ["GitHub Action"] = 485,
    ["GitHub Actions typing"] = 1319,
    ["GitHub CLI configuration"] = 486,
    ["GitHub CLI hosts"] = 487,
    ["GitHub Discussion"] = 488,
    ["GitHub Funding"] = 490,
    ["GitHub Issue Template configuration"] = 491,
    ["GitHub Issue Template forms"] = 492,
    ["GitHub Pages Jekyll"] = 493,
    ["GitHub Prompt"] = 489,
    ["GitHub Secret Scanning"] = 494,
    ["GitHub Workflow"] = 495,
    ["GitHub Workflow Template Properties"] = 496,
    ["GitHub automatically generated release notes configuration"] = 497,
    ["GitLab Agent for Kubernetes configuration"] = 1273,
    ["GitLab Duo Workflow"] = 499,
    GitResume = 501,
    GitVersion = 478,
    ["Gitea Issue Template configuration"] = 481,
    ["Gitea Issue Template forms"] = 482,
    Gitleaks = 479,
    ["Gitpod Configuration"] = 500,
    ["Glamour style"] = 476,
    ["GlazeWM settings"] = 1275,
    ["Global Privacy Control"] = 477,
    Goblet = 1254,
    ["Golangci-lint Configuration"] = 516,
    ["Golangci-lint Custom Plugins Configuration"] = 517,
    ["Google Chrome Related Website Sets"] = 452,
    ["Google Cloud Workflows"] = 322,
    ["Google Digital Assetlinks"] = 1363,
    Goreleaser = 521,
    ["Goreleaser Pro"] = 522,
    Goss = 524,
    ["Gradle Build Cache Node"] = 1147,
    ["Gradle Enterprise"] = 1146,
    ["Grafana 5.x Dashboard"] = 525,
    ["GraphQL Code Generator"] = 530,
    ["GraphQL Config"] = 529,
    ["GraphQL Mesh"] = 528,
    ["GroovyLint configuration"] = 531,
    ["Grunt JSHint task"] = 535,
    ["Grunt Watch task"] = 536,
    ["Grunt base task"] = 537,
    ["Grunt clean task"] = 533,
    ["Grunt copy task"] = 532,
    ["Grunt cssmin task"] = 534,
    HEMTT = 1111,
    ["HULL - Helm Uniform Layer Library"] = 1464,
    Hadolint = 1125,
    Hammerkit = 1157,
    ["Hardware Sentry Configuration"] = 1213,
    ["Hashgraph Online Skill Manifest"] = 9,
    ["HashiCorp Vault"] = 538,
    Hatch = 1126,
    Hayson = 541,
    ["Haystack Pipeline"] = 542,
    ["Hazelcast 5 Configuration"] = 543,
    ["Hecate Input Schema"] = 1374,
    ["Helm Chart.lock"] = 285,
    ["Helm Chart.yaml"] = 284,
    ["Helm Unittest Test Suite"] = 286,
    ["Heloisa Assistant Plugins Marketplace"] = 1457,
    ["Hex file"] = 287,
    ["Home Assistant Integration Manifest"] = 545,
    ["Homer dashboard configuration"] = 546,
    ["Hoverfly Simulation"] = 551,
    Hugo = 1189,
    ["Hugo Theme"] = 1188,
    ["Hulak Configuration"] = 554,
    ["Hyperfoil benchmark configuration"] = 553,
    ["IBM Zapp document"] = 555,
    ["IBM zCodeFormatSettings"] = 556,
    ["IMG Catapult PSP"] = 561,
    ["IVMS101 by CODE Protocol"] = 1274,
    ["Infinispan Configuration"] = 563,
    ["Infinispan Server Configuration"] = 564,
    Infrahub = 565,
    Istanbul = 1217,
    ["JDownloader2 crawler multi-rules"] = 579,
    ["JDownloader2 crawler single-rules"] = 578,
    ["JFrog Applications Config"] = 580,
    ["JFrog File Spec"] = 581,
    ["JFrog Pipelines YML DSL"] = 1223,
    ["JMeter DSL cli config"] = 582,
    JReleaser = 585,
    ["JSON Document Transform"] = 593,
    ["JSON Feed"] = 594,
    ["JSON Resume"] = 872,
    ["JSON Schema Draft 2020-12"] = 1090,
    ["JSON Schema Draft 4"] = 1087,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1256,
    ["JSON Schema Draft 7"] = 1088,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1257,
    ["JSON Schema Draft 8 (2019-09)"] = 1089,
    ["JSON-API"] = 592,
    ["JSON-e templates"] = 1154,
    ["JSON-stat 2.0"] = 1083,
    JSONPatch = 596,
    ["JSR Package Config (jsr.json)"] = 586,
    Jarl = 1390,
    Jasmine = 573,
    Jekyll = 574,
    ["Jenkins X Pipelines"] = 575,
    ["Jenkins X Requirements"] = 576,
    Jest = 577,
    Jocker = 583,
    ["Jovo Language Models"] = 584,
    Jsontron = 597,
    ["Jujutsu (jj) VCS config"] = 1376,
    ["KIMMDY config file"] = 608,
    ["KODE/CI build.yaml"] = 1219,
    ["KSP-AVC"] = 1084,
    ["KSP-CKAN"] = 1085,
    ["KSP-NetKAN"] = 1086,
    KSY = 1286,
    KSail = 468,
    ["KYA Manifest"] = 1287,
    ["Karakum configuration file"] = 464,
    Kas = 600,
    ["Kestra flow file"] = 609,
    ["Keycloak REST API"] = 1226,
    ["Knative Functions - func.yaml"] = 465,
    Knip = 466,
    ["Knip JSONC"] = 467,
    ["Knowledge Unit"] = 617,
    ["Kometa (nightly) config file"] = 611,
    ["Kometa config file"] = 610,
    ["Kong DBLess config"] = 1220,
    KrakenD = 612,
    ["Kubri Configuration"] = 620,
    LOOBin = 639,
    ["Lake configuration file"] = 1379,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 327,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 328,
    ["Landing Zone Accelerator on AWS - Global Config"] = 329,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 330,
    ["Landing Zone Accelerator on AWS - Network Config"] = 331,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 332,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 333,
    ["Landing Zone Accelerator on AWS - Security Config"] = 334,
    ["Lando (landofile)"] = 132,
    ["LangGraph Platform configuration"] = 1298,
    ["Language configuration"] = 1297,
    Lefthook = 625,
    ["Liferay client-extension.yaml"] = 632,
    ["LinkML Metamodel"] = 634,
    ["LiquiLens Evidence Carrier Reference v1"] = 636,
    ["LiquiLens Evidence Carrier v1"] = 635,
    Liquibase = 1164,
    ["Liquibase Flow File"] = 1165,
    ["Lively Properties"] = 638,
    ["Lobe AI Agent"] = 134,
    Loki = 135,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 682,
    ["MS2Rescore Configuration"] = 690,
    ["MSTest testconfig.json"] = 691,
    ["Madge configuration"] = 645,
    ["Madness (madness.yml)"] = 1237,
    ["Mado configuration"] = 646,
    ["Maestro Flow"] = 647,
    ["Mail Servers Configuration"] = 1411,
    ["MapEHR Mapping"] = 648,
    Markdownlint = 1168,
    ["Mason Registry"] = 1171,
    ["MegaLinter Custom Flavor"] = 651,
    ["MegaLinter configuration"] = 650,
    ["MegaLinter descriptor"] = 652,
    Melange = 1264,
    ["Meltano project definition"] = 653,
    ["Mergify Configuration"] = 692,
    ["Mermaid config"] = 4,
    ["Metadata for a Bazel module"] = 654,
    ["Metadata for a Cinnamon spice"] = 1315,
    ["Metatype Configuration"] = 655,
    ["MetricsHub Configuration"] = 656,
    ["MetricsHub Connector Configuration"] = 657,
    ["Micro Editor Syntax"] = 1247,
    ["Microsoft Band Web Tile"] = 658,
    ["Microsoft RulesEngine workflow rules"] = 1302,
    ["Microsoft RulesEngine workflow rules list"] = 1303,
    ["Minecraft Custom Main Menu Mod"] = 1265,
    ["Minecraft Data Pack Advancement"] = 660,
    ["Minecraft Data Pack Biome"] = 661,
    ["Minecraft Data Pack Configured Carver"] = 662,
    ["Minecraft Data Pack Damage Type"] = 663,
    ["Minecraft Data Pack Dimension"] = 665,
    ["Minecraft Data Pack Dimension Type"] = 664,
    ["Minecraft Data Pack Item Modifier"] = 666,
    ["Minecraft Data Pack Loot Table"] = 667,
    ["Minecraft Data Pack Metadata"] = 668,
    ["Minecraft Data Pack Predicate"] = 669,
    ["Minecraft Data Pack Recipe"] = 670,
    ["Minecraft Data Pack Tag"] = 671,
    ["Minecraft Data Pack Template Pool"] = 672,
    ["Minecraft Data Pack Trim Material"] = 677,
    ["Minecraft Data Pack Trim Pattern"] = 678,
    ["Minecraft Resource Pack Lang"] = 673,
    ["Minecraft Resource Pack Particle"] = 674,
    ["Minecraft Resource Pack Texture Mcmeta"] = 676,
    ["Minecraft Resourcepack Sounds"] = 675,
    ["MockServer Expectation"] = 684,
    ["MockServer Expectations"] = 685,
    ModuleAssembler = 680,
    ["Monade CLI Stack Configuration"] = 695,
    ["MongoDB Atlas Search Index Definition"] = 1218,
    ["Monika Configuration"] = 1216,
    ["Monoweave Configuration"] = 689,
    ["Motif config"] = 1107,
    MultiQC = 1356,
    ["NOX Framework (Service)"] = 717,
    ["Netin Diagnostic System Template"] = 1175,
    ["Netlify config"] = 698,
    ["Network-as-Code Data Model"] = 699,
    ["Next Gen UI Agent A2A Server Configuration"] = 700,
    ["Next Gen UI Agent Configuration"] = 702,
    ["Next Gen UI Agent MCP Server Configuration"] = 701,
    ["Nightwatch.js"] = 709,
    ["Nika workflow"] = 714,
    ["Node.js configuration"] = 1112,
    ["NueJS configuration file"] = 722,
    ["Nuitka Package Config"] = 1279,
    ["Nullstone config"] = 724,
    ["ODGS Data Rules"] = 731,
    ["ODGS Ontology Graph"] = 732,
    ["ODGS Standard Metrics"] = 730,
    ["OKF Graph"] = 1458,
    ["ONe's changelog entry"] = 746,
    ["ONe's service descriptor"] = 745,
    ["ORT Server repository environment configuration"] = 757,
    ["OSCAL Assessment Plan (AP)"] = 759,
    ["OSCAL Assessment Results (AR)"] = 760,
    ["OSCAL Catalog"] = 761,
    ["OSCAL Component Definition (CDef)"] = 762,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 763,
    ["OSCAL Profile"] = 764,
    ["OSCAL System Security Plan (SSP)"] = 765,
    ["OSS Review Toolkit configuration"] = 766,
    ["OSS Review Toolkit curation"] = 767,
    ["OSS Review Toolkit package configuration"] = 768,
    ["OSS Review Toolkit project package manager definition"] = 769,
    ["OSS Review Toolkit repository configuration"] = 770,
    ["OSS Review Toolkit resolutions"] = 771,
    ["October CMS columns"] = 728,
    ["October CMS fields"] = 729,
    ["Oh My Posh"] = 734,
    Okteto = 735,
    ["Ona Tasks and Services"] = 737,
    Opctl = 1110,
    ["Open Data Contract Standard (ODCS)"] = 750,
    ["Open Data Product Standard (ODPS)"] = 751,
    ["Open Know-How"] = 1361,
    ["Open Pentest Format"] = 752,
    OpenDecree = 1428,
    ["OpenDecree Configuration"] = 1429,
    ["OpenRewrite Resource"] = 748,
    OpenSRM = 753,
    OpenStatus = 1372,
    ["OpenTelemetry Declarative Configuration"] = 749,
    ["OpenUtau character yaml"] = 742,
    ["OpenUtau ustx"] = 743,
    ["OpenWeather Current Weather API"] = 1153,
    ["OpenWeather Road Risk API"] = 1152,
    ["Ory Hydra configuration"] = 552,
    ["Ory Keto configuration"] = 616,
    ["Ory Kratos configuration"] = 758,
    ["Ory Oathkeeper configuration"] = 726,
    ["Outblocks App configuration"] = 755,
    ["Outblocks database table"] = 756,
    ["Outblocks project configuration"] = 754,
    PDM = 779,
    POPxf = 791,
    ["POPxf Correlations"] = 792,
    ["PRML manifest"] = 799,
    Packer = 775,
    PactSpec = 776,
    Panache = 777,
    Pantsbuild = 1233,
    ["Paper paper-plugin.yml"] = 778,
    ["Pipeline component"] = 1166,
    ["Platform.sh application"] = 15,
    ["Platform.sh routes"] = 16,
    ["Platform.sh services"] = 17,
    ["Plex Prerolls"] = 789,
    ["PocketMine plugin.yml"] = 786,
    ["Podman Desktop Extension"] = 1448,
    ["Postman collection"] = 795,
    ["Power Pages Configuration"] = 1373,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1318,
    ["ProActions AI-Kit Configuration"] = 807,
    ["ProActions AI-Kit Configuration for Menus"] = 809,
    ["ProActions AI-Kit Configuration for Sections"] = 811,
    ["ProActions AI-Kit Configuration for Services"] = 808,
    ["ProActions AI-Kit Configuration for Steps"] = 812,
    ["ProActions AI-Kit Configuration for Templates"] = 810,
    ["Problem object RFC9457"] = 1262,
    ["Problem package format"] = 813,
    ["Problem package generators"] = 814,
    ["Problem package submissions"] = 815,
    ["Problem package test group metadata"] = 816,
    ["Production delivery manifest"] = 1466,
    Pterodactyl = 1212,
    ["Pull Request Labeler"] = 833,
    Pulumi = 841,
    ["PyGTA Config"] = 837,
    PyProject = 842,
    Pylock = 1364,
    Pyright = 843,
    ["Python script metadata"] = 1358,
    ["QType AI DSL"] = 846,
    Qgoda = 845,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1440,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1438,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1444,
    ["Qlik Talend Cloud Pipeline - Project"] = 1436,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1439,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1441,
    ["Qlik Talend Cloud Pipeline - Task"] = 1437,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1443,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1442,
    Qodana = 1185,
    ["Qt Creator workspace file"] = 1295,
    ["Quali Torque Blueprint Spec 2"] = 1210,
    ["QueryFirst config file"] = 1229,
    ["QuikRun Configuration"] = 1445,
    ["Qwen Code Settings"] = 1425,
    ["RKE Cluster Configuration JSON"] = 1163,
    ["RKE Cluster Configuration YAML"] = 1162,
    RadioHound = 836,
    ["Raid Profile"] = 1426,
    ["Raid Repo Configuration"] = 1427,
    Railpack = 848,
    Railway = 847,
    ["Rancher Fleet"] = 838,
    ["Rattler-build"] = 849,
    Ray = 1124,
    ["Read the Docs"] = 840,
    ["Red-DiscordBot Cog"] = 856,
    ["Red-DiscordBot Cog Repo"] = 857,
    ["Red-DiscordBot Trivia"] = 858,
    ["Releasaurus Config"] = 12,
    ReleaseKit = 11,
    ["Render Blueprints"] = 1161,
    RenderCV = 876,
    Renovate = 873,
    ["Renovate global configuration"] = 874,
    ["Renovate inherited configuration"] = 875,
    ["Replit config"] = 864,
    Restate = 1351,
    ["Revel Digital Gadget Definition File"] = 1375,
    RoadRunner = 878,
    ["Robust Station Image"] = 1381,
    Rockcraft = 879,
    ["Roo Coder Custom Modes"] = 880,
    Rubocop = 869,
    ["Rudder techniques"] = 1269,
    Ruff = 870,
    ["Rust Project"] = 871,
    ["Rust toolchain"] = 885,
    ["SDMX data message"] = 912,
    ["SDMX metadata message"] = 911,
    ["SDMX structure message"] = 910,
    ["SIL Kit Participant Configuration"] = 923,
    ["SIL Kit Registry Configuration"] = 924,
    ["SPDX 2.3"] = 966,
    SWADL = 982,
    ["Safebox Config"] = 1224,
    ["Sapphire CLI Config"] = 888,
    ["SauceCTL Configuration"] = 1172,
    Scarb = 908,
    ["Schema Catalog"] = 903,
    ["Scoop manifest"] = 909,
    ["Secure SDLC Evidence Bundle"] = 913,
    ["Semantic Data Fabric (SDF) file"] = 914,
    ["Semgrep Rule"] = 916,
    ["Serenity Code Generator (Sergen)"] = 917,
    ["Serverless Framework Configuration"] = 1179,
    ["Serverless Workflow"] = 1181,
    ["Settings for a Cinnamon spice"] = 1314,
    ["Settings.paf"] = 919,
    ["Shopware 6 Configuration"] = 1182,
    ["Shopware CLI Extension Store Configuration"] = 1183,
    ["Shopware CLI Project Store Configuration"] = 1184,
    ["Sigma Detection Rule"] = 921,
    ["SigmaCV CV"] = 7,
    ["Sigrid scope configuration file"] = 922,
    ["SkyPilot Task JSON"] = 1270,
    ["Slack app manifest"] = 929,
    ["Slang Server Configuration"] = 1452,
    Snapcraft = 931,
    ["Solarxy project config"] = 934,
    Solidarity = 935,
    ["Solution filters"] = 936,
    ["Source Maps v3"] = 937,
    Sourcery = 938,
    ["Spack bootstrap.yaml"] = 939,
    ["Spack cdash.yaml"] = 940,
    ["Spack ci.yaml"] = 941,
    ["Spack compilers.yaml"] = 942,
    ["Spack concretizer.yaml"] = 943,
    ["Spack config.yaml"] = 944,
    ["Spack definitions.yaml"] = 945,
    ["Spack develop.yaml"] = 946,
    ["Spack env_vars.yaml"] = 947,
    ["Spack environment"] = 953,
    ["Spack include.yaml"] = 948,
    ["Spack mirrors.yaml"] = 949,
    ["Spack modules.yaml"] = 950,
    ["Spack packages.yaml"] = 951,
    ["Spack repos.yaml"] = 952,
    ["Spack toolchains.yaml"] = 954,
    ["Spack upstreams.yaml"] = 955,
    ["Spack view.yaml"] = 956,
    ["Speakeasy Generation Config File"] = 960,
    ["Speakeasy Lint Configuration File"] = 957,
    ["Speakeasy Test Generation Configuration File"] = 958,
    ["Speakeasy Workflow File"] = 959,
    SpecIF = 961,
    ["Specmatic Configuration"] = 962,
    ["Specpin spec file"] = 5,
    ["Sponge Mixin configuration"] = 963,
    ["Spotlight Ruleset"] = 964,
    StackBlitz = 970,
    ["StackHawk Scanner Configuration"] = 1178,
    Stale = 971,
    Starfish = 972,
    ["Starlake Data Pipeline"] = 1150,
    Starship = 973,
    ["Statamic Blueprint"] = 974,
    ["Stella configuration file"] = 975,
    ["Streamlit configuration file"] = 976,
    ["Stryker Mutator"] = 979,
    ["StyleCop Analyzers Configuration"] = 980,
    ["Stylelint (.stylelintrc)"] = 981,
    ["Stylua Config"] = 1365,
    ["Sublime Syntax"] = 1225,
    ["Subsquid squid manifest"] = 1272,
    ["Swagger API 2.0"] = 983,
    ["Symfony Routing Configuration"] = 984,
    ["Symfony Serializer Mapping"] = 985,
    ["Symfony Services Configuration"] = 986,
    ["Symfony Validation Mapping"] = 987,
    ["Synadia Connect Component"] = 988,
    TSON = 1031,
    TSTyche = 1032,
    ["TYPO3 Vendor Bundler config"] = 1038,
    ["Tab data for a LinUtil"] = 1321,
    ["Tab list for a LinUtil"] = 1320,
    Tach = 989,
    ["Tach Domain"] = 990,
    Talhelper = 992,
    ["Talisman configuration"] = 993,
    Taplo = 1366,
    ["Taskfile config"] = 1155,
    Taurus = 994,
    Tauticord = 995,
    ["Tekton Pipeline"] = 1394,
    ["Tekton PipelineRun"] = 1395,
    ["Tekton Task"] = 1392,
    ["Tekton TaskRun"] = 1393,
    Telefonistka = 1352,
    ["Terraform PowerShell provider block manifest"] = 998,
    ["Terraform PowerShell provider data source manifest"] = 999,
    ["Terraform PowerShell provider resource manifest"] = 1000,
    ["Terraform PowerShell provider settings"] = 1001,
    ["Terrateam config"] = 1378,
    ["Tesseract configuration"] = 1002,
    ["TestEnvironment.json"] = 1012,
    ["TextMate Grammar"] = 1011,
    Threagile = 1006,
    ["Tier.run pricing.json"] = 1003,
    Tikibase = 1004,
    Tombi = 1009,
    ["Traefik v2"] = 1015,
    ["Traefik v2 File Provider"] = 1016,
    ["Traefik v3"] = 1017,
    ["Traefik v3 File Provider"] = 1018,
    ["Travis CI (.travis.yml)"] = 1014,
    Treefmt = 527,
    Trident = 1348,
    Trivy = 1021,
    ["TrueScript for *.tscript files"] = 1022,
    ["Tugboat QA config.yml"] = 1345,
    TunnelHub = 1260,
    Turborepo = 1013,
    Tycho = 1309,
    Tye = 1186,
    ["Tyk Gateway - Open Source v5.7+"] = 1357,
    ["UET BuildConfig.json"] = 1230,
    ["UI5 Manifest"] = 1044,
    ["UNCORS configuration"] = 1049,
    ["UTAM Page Object"] = 1047,
    ["Ubuntu Server Autoinstall"] = 1042,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1349,
    ["Uniswap Token List"] = 1135,
    ["Universal Schedule Format"] = 1050,
    ["Unreal Engine Uplugin"] = 1231,
    ["Unreal Engine Uproject"] = 1232,
    ["UpCloud CLI (upctl) configuration"] = 1350,
    ["Updatecli Compose"] = 1194,
    ["Updatecli Policy Manifest"] = 1195,
    ["Updatecli Policy Metadata"] = 1196,
    Uplift = 1228,
    ["Upsun config"] = 14,
    ["User Journey Map"] = 1160,
    V2Ray = 1200,
    ["VSCode Code Snippets"] = 310,
    ["VSIX CLI publishing"] = 1070,
    Vector = 1052,
    ["Vee JSON menu output"] = 1053,
    ["Vela Pipeline Configuration"] = 1056,
    Vercel = 309,
    ["Version Bumper config"] = 1059,
    Vespertide = 1399,
    ["Vespertide Migration"] = 1400,
    ["Vespertide Model"] = 1401,
    ["Viash Component Config"] = 1354,
    ["Viash Package Config"] = 1355,
    Visivo = 1258,
    Vogi = 1064,
    ["WP-CLI"] = 1080,
    Wake = 1347,
    ["Waku Config"] = 1324,
    ["Web App Manifest"] = 1076,
    ["Web types"] = 1079,
    WebExtensions = 1075,
    ["Webman package recipe"] = 1206,
    ["Windows Package Manager Installer Manifest"] = 1132,
    ["Windows Package Manager Locale Manifest"] = 1133,
    ["Windows Package Manager Singleton Manifest"] = 1131,
    ["WireMock CLI import configuration"] = 1330,
    ["WireMock CLI local service configuration"] = 1329,
    ["WireMock message stub mapping"] = 1328,
    ["WireMock stub mapping"] = 1327,
    ["Woodpecker pipeline config"] = 1174,
    ["Wrangler CLI"] = 1081,
    ["XenForo add-on manifest"] = 1082,
    ["Xstate Machine"] = 1192,
    ["Yandex Workflow Language"] = 1316,
    ["Yarn Config (.yarnrc.yml)"] = 1148,
    ["Yippee-Ki-JSON configuration YML"] = 1139,
    ["YouTrack App"] = 1313,
    ["Zarf Package Configuration"] = 1380,
    ["Zerops import file"] = 1301,
    ["Zola Configuration"] = 1391,
    abtop = 36,
    act3 = 1432,
    actionlint = 46,
    ["aerleon.yml"] = 29,
    ...
    ["behat.yml"] = 174,
    ["bigquery-table"] = 159,
    ["bioimageio resource description"] = 1280,
    ...
    ["cargo-nextest repository configuration"] = 703,
    ["cargo-nextest user configuration"] = 704,
    ["ccmod.json"] = 1325,
    ["cfgd Config"] = 1453,
    ["cfgd ConfigSource"] = 1456,
    ["cfgd Module"] = 1454,
    ["cfgd Profile"] = 1455,
    changelogging = 1292,
    ["chezmoi configuration"] = 209,
    ["chisel-slices.json"] = 336,
    ["chrome-extension-locales-messages.json"] = 317,
    ["chutzpah.json"] = 318,
    cibuildwheel = 214,
    ["clang-format (.clang-format)"] = 1198,
    ["clang-tidy"] = 293,
    clangd = 292,
    clib = 294,
    ["cloud-init: cloud-config userdata"] = 296,
    ["cloud-sdk-pipeline-configuration"] = 320,
    ["cloudbuild.json"] = 321,
    cloudify = 295,
    cmakefmt = 233,
    ["cmdx.yaml"] = 118,
    ...
    ["commands.json"] = 313,
    ["commit-check"] = 339,
    ["commitlint (.commitlintrc)"] = 1134,
    ["committed.toml"] = 340,
    ["compile_commands.json"] = 312,
    ["compilerconfig.json"] = 311,
    ["completely.yml"] = 1236,
    ["component-detection-manifest.json"] = 343,
    ["component.json"] = 342,
    ["composer.json"] = 341,
    ["conda-forge"] = 218,
    ["config.yaml"] = 839,
    ["contentmanifest.json"] = 319,
    ["contribute.json"] = 344,
    ["cosmos.config.json"] = 315,
    ["crowdin.yml"] = 345,
    crucible = 349,
    ["ctfd-setup configuration file"] = 1337,
    ["custom-elements.json"] = 1250,
    ["cypress.json"] = 350,
    ["dacier.yml"] = 1435,
    ["datalogic-scan2deploy-android"] = 361,
    ["datalogic-scan2deploy-ce"] = 362,
    datavzrd = 363,
    ["dbt Dependencies"] = 251,
    ["dbt Packages"] = 253,
    ["dbt Project"] = 252,
    ["dbt Selectors"] = 254,
    ["dbt YAML files"] = 255,
    ...
    ["ddev-global"] = 364,
    ["ddev-project"] = 365,
    ["debugsettings.json"] = 366,
    ["dependabot-v2.json"] = 371,
    ["dependabot.json"] = 370,
    ["deployed-cli"] = 1191,
    devconcurrent = 269,
    ["devcontainer-feature.json"] = 304,
    ["devcontainer.json"] = 303,
    devinit = 1141,
    ["devspace.yaml"] = 1214,
    djlint = 1142,
    ["docker bake"] = 377,
    ["docker sequencer"] = 378,
    ["docker-compose.yml"] = 1140,
    ["dockerd.json"] = 375,
    ["dotnet Release Index manifest"] = 390,
    ["dotnet-tools.json"] = 391,
    ["dotnetcli.host.json"] = 392,
    ["dprint.json"] = 393,
    ["drone.json"] = 394,
    ["dss-2.0.0.json"] = 396,
    ["dstack configuration"] = 397,
    ["dtool dataset metadata"] = 1332,
    ["dvc.yaml"] = 399,
    ["ecosystem.json"] = 404,
    ["editorconfig-checker"] = 406,
    eksctl = 407,
    ["electron-builder configuration file"] = 433,
    ["epr-manifest.json"] = 432,
    ["estampo.toml"] = 431,
    ["evcc.yaml"] = 434,
    ["ezd task runner"] = 445,
    ["fabric.mod.json"] = 448,
    ["first-timers-bot"] = 456,
    ["flagd flag configuration"] = 144,
    ["fly.io Configuration"] = 145,
    fulibWorkflows = 1173,
    ["function.json"] = 469,
    ["gRPC API Gateway & OpenAPI Config"] = 24,
    ["gematik health care insurance list"] = 1343,
    ["gematik health care patient list"] = 1340,
    ["gematik health care provider institution list"] = 1342,
    ["gematik health care provider list"] = 1341,
    ["gematik tiger test environment configuration"] = 1344,
    ["gh-dash"] = 483,
    ["gha-doctor"] = 484,
    ["git-cliff"] = 480,
    ["git-town.toml"] = 1389,
    ["github-settings-as-code"] = 865,
    ["gitlab-ci"] = 498,
    ["global.json"] = 515,
    ["glslint config"] = 3,
    ["go-feature-flag Flag Configuration"] = 519,
    ["gojo.yaml"] = 520,
    gollama = 518,
    ["hassette.toml"] = 544,
    ["haxelib.json"] = 539,
    ...
    ["ide.host.json"] = 557,
    ["ifstate.yaml"] = 558,
    ["imageoptimizer.json"] = 559,
    ["importmap.json"] = 562,
    ["index.toml (packwiz)"] = 1449,
    instant_python_config = 566,
    instant_python_custom_project = 567,
    intlayer = 568,
    ["ioBroker Configuration"] = 569,
    ["ioBroker JSON UI"] = 570,
    ["ioBroker Package manifest"] = 571,
    ["ixpect.conf.yaml"] = 572,
    ["ize.toml"] = 1227,
    ["jsconfig.json"] = 598,
    ["jscpd Configuration"] = 1211,
    jsdoc = 1123,
    ["k3d.yaml"] = 599,
    ["k9s aliases.yaml"] = 601,
    ["k9s cluster-config.yaml"] = 603,
    ["k9s config.yaml"] = 602,
    ["k9s hotkeys.yaml"] = 604,
    ["k9s plugins.yaml"] = 605,
    ["k9s skin.yaml"] = 606,
    ["k9s views.yaml"] = 607,
    ["kind cluster"] = 621,
    ["kontinuous-config.yaml"] = 619,
    ["kontinuous-values.yaml"] = 618,
    ["kustomization.yaml"] = 622,
    ["label-commenter-config.yml"] = 623,
    ["latexindent configuration"] = 133,
    ["launchsettings.json"] = 624,
    lazydocker = 1249,
    lazygit = 1248,
    ["lego.json"] = 626,
    ["lerna.json"] = 627,
    ["lgtm.yml"] = 628,
    ["liblab.config.json"] = 629,
    ["libman.json"] = 630,
    ["license-report-config.json"] = 631,
    ["linkinator.config.json"] = 633,
    ["lint-staged (.lintstagedrc)"] = 1099,
    ["litertlm_manifest.json"] = 637,
    ["local.settings.json"] = 641,
    ["localazy.json"] = 642,
    ["lotus.yaml"] = 640,
    ["lsd colors"] = 137,
    ["lsd config"] = 136,
    ...
    lychee = 1098,
    ["macro.json"] = 1215,
    ["markdown-link-check"] = 1169,
    maturin = 1170,
    mboats = 1177,
    memnex = 1433,
    ["micro-settings.json"] = 1242,
    ["mimetypes.json"] = 659,
    ["mirrord config"] = 1102,
    ["misata.yaml"] = 1101,
    mise = 1103,
    ...
    ["mkdocs.yml"] = 679,
    ["mockd.yaml"] = 683,
    ["mod.pw.toml (packwiz)"] = 1450,
    ["modelparams.dev Model"] = 686,
    ["models CLI"] = 687,
    ["monospace.yml"] = 688,
    ["moon.yml"] = 1326,
    ["mprocs Configuration file"] = 1296,
    ["mrdocs.yml"] = 681,
    ["mta.yaml"] = 1105,
    ["mtad.yaml"] = 1106,
    ["mycode.json"] = 696,
    nFPM = 708,
    ["napari plugin manifest"] = 697,
    neoload = 1118,
    ["nest-cli"] = 711,
    ["nexus-rpc-gen"] = 1416,
    ["nf-core module environment.yml"] = 705,
    ["nf-core module meta.yml"] = 706,
    ["nf-core subworkflow meta.yml"] = 707,
    ["ninjs (News in JSON)"] = 710,
    ["nitro.json"] = 1117,
    ["nixd configuration"] = 1268,
    ["nlu.json"] = 712,
    ["nodemon.json"] = 715,
    ["noodl config"] = 1176,
    ["notebook.mod.json"] = 716,
    now = 1113,
    ["npm-badges"] = 719,
    ["nswag.json"] = 723,
    ntangle = 725,
    ["nuclei-template.yaml"] = 720,
    ["nuget-project.json"] = 721,
    ["ocelot.json"] = 727,
    ogen = 733,
    ["omnisharp.json"] = 736,
    openHAB = 1402,
    ...
    oxfmt = 1412,
    oxlint = 1413,
    ["pack.toml (packwiz)"] = 1451,
    ["package.json"] = 772,
    ["package.manifest"] = 774,
    ["package.yaml"] = 773,
    ["partial-black.json"] = 175,
    ["partial-fastapi.json"] = 176,
    ["partial-pixi.json"] = 784,
    ["partial-scheduled.json"] = 177,
    ["pattern.json"] = 782,
    ["petstore-v1.0"] = 1222,
    pgap_yaml_input_reader = 780,
    pgrls = 781,
    pgxgen = 1406,
    pitcms = 1409,
    ["pixi.toml"] = 783,
    ["plagiarize-me.yaml"] = 788,
    ["plagiarize.yaml"] = 787,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1333,
    ["podbard.yaml"] = 790,
    ["portman.json"] = 793,
    ["prefect.toml"] = 802,
    ["prefect.yaml"] = 803,
    ...
    ["prettierrc.json"] = 805,
    ["prisma.yml"] = 806,
    ["project-1.0.0-beta3.json"] = 818,
    ["project-1.0.0-beta4.json"] = 819,
    ["project-1.0.0-beta5.json"] = 820,
    ["project-1.0.0-beta6.json"] = 821,
    ["project-1.0.0-beta8.json"] = 822,
    ["project-1.0.0-rc1.json"] = 823,
    ["project-1.0.0-rc2.json"] = 824,
    ["project.json"] = 817,
    ["project.owasp.yaml"] = 825,
    ["prometheus-alertmanager.json"] = 829,
    ["prometheus.json"] = 826,
    ["prometheus.rules.json"] = 827,
    ["prometheus.rules.test.json"] = 828,
    ["proxies.json"] = 830,
    ["publiccode.yml"] = 831,
    ["pubspec.yaml"] = 832,
    ["pyrseas-0.8.json"] = 835,
    pytest = 844,
    ["quilt.mod.json"] = 1243,
    ["rc3 auth"] = 850,
    ["rc3 collection"] = 851,
    ...
    ["rc3 settings"] = 855,
    ["registry.yaml"] = 65,
    ["release drafter"] = 1119,
    ["release-hub.json"] = 10,
    ["release-please-config.json"] = 860,
    ["release-please-manifest.json"] = 861,
    ["release-plz.toml"] = 862,
    ["renv.lock"] = 877,
    ["reposets Configuration"] = 866,
    ["reposets Credentials"] = 867,
    ["revola.json"] = 8,
    ["rivet.json"] = 1267,
    ["rivet.yaml (legacy)"] = 1266,
    rumdl = 882,
    runny = 881,
    runspec = 1434,
    rustfmt = 883,
    ...
    samt = 886,
    samtrc = 887,
    ["sarif-1.0.0.json"] = 889,
    ["sarif-2.0.0.json"] = 890,
    ["sarif-2.1.0"] = 900,
    ["sarif-2.1.0-rtm.2"] = 891,
    ["sarif-2.1.0-rtm.3"] = 893,
    ["sarif-2.1.0-rtm.4"] = 895,
    ["sarif-2.1.0-rtm.5"] = 897,
    ["sarif-2.1.0-rtm.6"] = 898,
    ["sarif-external-property-file-2.1.0"] = 901,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 892,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 894,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 896,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 899,
    ["scalingo.json configuration"] = 902,
    ["schema.org - Action"] = 904,
    ["schema.org - ContactPoint"] = 905,
    ["schema.org - Place"] = 906,
    ["schema.org - Thing"] = 907,
    ["secrethub.yml"] = 1245,
    ["semantic-release"] = 915,
    servercn = 1462,
    ["servicehub.config.json"] = 1093,
    ["servicehub.service.json"] = 1092,
    ["settings.job"] = 918,
    ["sfdx-hardis configuration"] = 920,
    ["shard.yml"] = 1283,
    ["size-limit configuration"] = 925,
    ["skaffold.yaml"] = 1167,
    ["skill-map plugin extension manifest"] = 926,
    ["skill-map project settings"] = 927,
    ["skill-map provider kind"] = 928,
    ["skyuxconfig.json"] = 930,
    ["snowflake-config"] = 932,
    ["snowflake-connections"] = 933,
    ["spicepod.yaml"] = 1304,
    ["sqlc configuration"] = 967,
    ["stripe-app-local.json"] = 978,
    ["stripe-app.json"] = 977,
    swcrc = 1151,
    ["task.json"] = 991,
    taskcat = 1114,
    ["template.json"] = 996,
    ["templatsources.json"] = 997,
    ["text2confl config"] = 1414,
    ["theme.json"] = 1005,
    ["tizen_workspace.json"] = 1007,
    tldr = 1008,
    ["tm_devices configuration file"] = 1371,
    tmuxinator = 1096,
    tox = 1010,
    ["transcend.yml"] = 1019,
    ["tree-sitter grammar.json"] = 526,
    ["trime.yaml"] = 1020,
    ["trunk.yaml"] = 1023,
    ["ts-force-config.json"] = 1029,
    tsbuild = 1024,
    ["tsconfig.json"] = 1025,
    ["tsd.json"] = 1026,
    ["tsdoc.json"] = 1027,
    ...
    v8r = 1074,
    vcluster = 1290,
    ["vcpkg configuration file"] = 308,
    ["vcpkg manifest file"] = 307,
    ["vega-lite.json"] = 1055,
    ["vega.json"] = 1054,
    ["venvironment.yaml"] = 1057,
    ["venvplus.yaml"] = 1058,
    version = 1353,
    ["version.json"] = 1060,
    ["vhwdebugger-binding.yaml"] = 1062,
    ["vim-addon-info"] = 1063,
    ["vs-2017.3.host.json"] = 1066,
    ["vs-nesting.json"] = 1067,
    ["vsls.json"] = 1065,
    ["vss-extension.json"] = 1071,
    vtcfg = 1359,
    ["vtesttree.yaml"] = 1072,
    ["vtestunit.yaml"] = 1073,
    ["warp-keysets.json"] = 1251,
    ["warp-themes.json"] = 1252,
    ["warp-workflows.json"] = 1253,
    ["webhint.io"] = 1207,
    ["webjobpublishsettings.json"] = 1078,
    ["webjobs-list.json"] = 1077,
    ["well-known-fursona"] = 1291,
    ["xs-app.json"] = 1109,
    ["xunit.runner.json"] = 1091,
    ["yaml-workflow"] = 1461,
    yamlfmt = 1136,
    yamllint = 1137,
    ["yap.json"] = 1138,
