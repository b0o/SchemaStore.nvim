...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 762,
    [".nodehawkrc"] = 485,
    [".npmpackagejsonlintrc"] = 489,
    [".omletrc"] = 933,
    [".phrase.yml"] = 550,
    [".phraseapp.yml"] = 551,
    [".pmbot.yml"] = 538,
    [".postcssrc"] = 545,
    [".powerpages-web-template-manifest"] = 547,
    [".pre-commit-config.yml"] = 548,
    [".pre-commit-hooks.yml"] = 549,
    [".putout.json"] = 571,
    [".rehyperc"] = 590,
    [".remarkrc"] = 592,
    [".sprite files"] = 655,
    ...
    ABCSupplyPlan = 14,
    AIConfig = 15,
    ["AMX Muse Program Descriptor"] = 975,
    ["API Builder"] = 795,
    ["AVA Configuration"] = 855,
    ...
    ["Adobe UXP Manifest"] = 915,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Alacritty Configuration"] = 827,
    ["All Contributors configuration file"] = 880,
    ...
    ["Application list for a WinUtil"] = 959,
    ArchitectFX = 963,
    ["Argo Events"] = 29,
    ["Argo Workflows"] = 30,
    AssemblyScript = 33,
    ...
    ["Azure Pipelines"] = 66,
    ["Azure Static Web Apps CLI configuration file"] = 658,
    ["Azure Static Web Apps configuration file"] = 657,
    ["BOSH Deploy Config"] = 90,
    ["BX CI"] = 107,
    ["Bashly (bashly.yml)"] = 884,
    ["Bashly Settings (bashly-settings.yml)"] = 885,
    ["Better Code Hub"] = 799,
    ["Better Scripts"] = 108,
    Bigconfig = 83,
    ["Biome Formatter Config"] = 53,
    ["Bitmovin Encoding Template"] = 969,
    BizTalkServerApplicationSchema = 768,
    Bleep = 109,
    ...
    ["Butane Config"] = 840,
    ["CGS Custom Card Game (CardGameDef.json)"] = 920,
    ["CICS TS region tagging"] = 849,
    ["CICS TS resource import"] = 850,
    ["CICS TS resource model"] = 851,
    ["CICS TS resource overrides"] = 852,
    ["CMake Presets"] = 110,
    ["CNC Codes"] = 125,
    ["CRS WAF test file"] = 949,
    ["CRS WAF test platform overrides file"] = 950,
    ...
    ["Chamaleon environment"] = 973,
    ["Chamaleon template"] = 972,
    Changesets = 207,
    Cheatsheets = 837,
    ...
    CityJSON = 121,
    ["Clawject config"] = 130,
    ["Cloud Foundry Application Manifest"] = 932,
    ["Cloud Run Spec v1"] = 954,
    ...
    Concord = 948,
    ["Configu .cfgu files"] = 937,
    ["Configu .configu file"] = 938,
    Conjure = 124,
    ["Container Structure Test"] = 782,
    Containerlab = 807,
    ["Crowdsec collection config"] = 216,
    ["Crowdsec parser config"] = 217,
    ["Crowdsec scenario config"] = 218,
    ["CumulusCI Config"] = 129,
    ["Custom Machinery Machine"] = 921,
    ["Custom Machinery Recipe"] = 922,
    ...
    ["DonateCaseBetterCasino menu"] = 976,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 892,
    ["EAS config"] = 282,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 881,
    ["EasyVCR .NET"] = 283,
    ["Eidolon Resource"] = 964,
    ...
    ["Goreleaser Pro"] = 340,
    Goss = 341,
    ["Gradle Build Cache Node"] = 797,
    ["Gradle Enterprise"] = 796,
    ...
    Hadolint = 778,
    Hammerkit = 806,
    ["Hardware Sentry Configuration"] = 860,
    Hatch = 779,
    Hayson = 354,
    ...
    ["JFrog File Spec"] = 383,
    ["JFrog Pipelines YML DSL"] = 869,
    ["JMeter DSL cli config"] = 384,
    JReleaser = 386,
    ["JSON Document Transform"] = 394,
    ["JSON Feed"] = 395,
    ["JSON Resume"] = 597,
    ["JSON Schema Draft 2020-12"] = 748,
    ["JSON Schema Draft 4"] = 745,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 902,
    ["JSON Schema Draft 7"] = 746,
    ["JSON Schema Draft 7 (unofficial strict)"] = 903,
    ["JSON Schema Draft 8 (2019-09)"] = 747,
    ["JSON-API"] = 393,
    ["JSON-WF"] = 931,
    ["JSON-e templates"] = 804,
    ["JSON-stat 2.0"] = 741,
    JSONPatch = 397,
    ...
    ["Language configuration"] = 941,
    Lefthook = 422,
    ["Liferay client-extension.yaml"] = 429,
    ["LinkML Metamodel"] = 431,
    Liquibase = 812,
    ["Liquibase Flow File"] = 813,
    ["Lively Properties"] = 432,
    ["Lobe AI Agent"] = 64,
    Loki = 65,
    ["MLOS Configs"] = 469,
    ["MS2Rescore Configuration"] = 472,
    ["Madness (madness.yml)"] = 883,
    ["MapEHR Mapping"] = 439,
    Markdownlint = 816,
    ["Mason Registry"] = 818,
    ...
    ["Mergify Configuration"] = 473,
    ["Metadata for a Bazel module"] = 444,
    ["Metadata for a Cinnamon spice"] = 957,
    ["MetricsHub Configuration"] = 445,
    ["MetricsHub Connector Configuration"] = 446,
    ["Micro Editor Syntax"] = 893,
    ["Microsoft Band Web Tile"] = 447,
    ["Microsoft RulesEngine workflow rules"] = 945,
    ["Microsoft RulesEngine workflow rules list"] = 946,
    ["Minecraft Custom Main Menu Mod"] = 910,
    ["Minecraft Data Pack Advancement"] = 449,
    ["Minecraft Data Pack Biome"] = 450,
    ["Minecraft Data Pack Configured Carver"] = 451,
    ["Minecraft Data Pack Damage Type"] = 452,
    ["Minecraft Data Pack Dimension"] = 454,
    ["Minecraft Data Pack Dimension Type"] = 453,
    ["Minecraft Data Pack Item Modifier"] = 455,
    ["Minecraft Data Pack Loot Table"] = 456,
    ["Minecraft Data Pack Metadata"] = 457,
    ["Minecraft Data Pack Predicate"] = 458,
    ["Minecraft Data Pack Recipe"] = 459,
    ["Minecraft Data Pack Tag"] = 460,
    ["Minecraft Data Pack Template Pool"] = 461,
    ["Minecraft Data Pack Trim Material"] = 466,
    ["Minecraft Data Pack Trim Pattern"] = 467,
    ["Minecraft Resource Pack Lang"] = 462,
    ["Minecraft Resource Pack Particle"] = 463,
    ["Minecraft Resource Pack Texture Mcmeta"] = 465,
    ["Minecraft Resourcepack Sounds"] = 464,
    ["Monade CLI Stack Configuration"] = 476,
    ["MongoDB Atlas Search Index Definition"] = 864,
    ["Monika Configuration"] = 862,
    ["Monoweave Configuration"] = 471,
    ["Motif config"] = 761,
    ["NOX Framework (Service)"] = 488,
    ["Netin Diagnostic System Template"] = 822,
    ["Netlify config"] = 479,
    ["Network-as-Code Data Model"] = 480,
    ["Nightwatch.js"] = 481,
    ["NueJS configuration file"] = 493,
    ["Nuitka.yaml"] = 923,
    ["Nullstone config"] = 495,
    ["ONe's changelog entry"] = 509,
    ["ONe's service descriptor"] = 508,
    ["OSCAL Assessment Plan (AP)"] = 517,
    ["OSCAL Assessment Results (AR)"] = 518,
    ["OSCAL Catalog"] = 519,
    ["OSCAL Component Definition (CDef)"] = 520,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 521,
    ["OSCAL Profile"] = 522,
    ["OSCAL System Security Plan (SSP)"] = 523,
    ["OSS Review Toolkit configuration"] = 524,
    ["OSS Review Toolkit curation"] = 525,
    ["OSS Review Toolkit package configuration"] = 526,
    ["OSS Review Toolkit repository configuration"] = 527,
    ["OSS Review Toolkit resolutions"] = 528,
    ["October CMS columns"] = 499,
    ["October CMS fields"] = 500,
    Okteto = 501,
    Opctl = 764,
    ["Open Data Contract Standard (ODCS)"] = 512,
    ["OpenRewrite Resource"] = 511,
    ["OpenUtau character yaml"] = 505,
    ["OpenUtau ustx"] = 506,
    ["OpenWeather Current Weather API"] = 803,
    ["OpenWeather Road Risk API"] = 802,
    ["Ory Hydra configuration"] = 361,
    ["Ory Keto configuration"] = 415,
    ["Ory Kratos configuration"] = 516,
    ["Ory Oathkeeper configuration"] = 497,
    ["Outblocks App configuration"] = 514,
    ["Outblocks database table"] = 515,
    ["Outblocks project configuration"] = 513,
    PDM = 534,
    Packer = 531,
    Pantsbuild = 879,
    ["Paper paper-plugin.yml"] = 532,
    ["Pipeline component"] = 814,
    ["Plex Prerolls"] = 542,
    ["PocketMine plugin.yml"] = 539,
    ["Postman collection"] = 546,
    ["Preset list for a WinUtil"] = 960,
    ["Problem object RFC9457"] = 907,
    ["Problem package generators"] = 555,
    Pterodactyl = 859,
    ["Pull Request Labeler"] = 570,
    Pulumi = 576,
    PyProject = 577,
    Pyright = 578,
    Qgoda = 579,
    Qodana = 832,
    ["Qt Creator workspace file"] = 939,
    ["Quali Torque Blueprint Spec 2"] = 857,
    ["QueryFirst config file"] = 875,
    ["RKE Cluster Configuration JSON"] = 811,
    ["RKE Cluster Configuration YAML"] = 810,
    ["Rancher Fleet"] = 573,
    ["Rattler-build"] = 580,
    Ray = 777,
    ["Read the Docs"] = 575,
    ["Red-DiscordBot Cog"] = 587,
    ["Red-DiscordBot Cog Repo"] = 588,
    ["Red-DiscordBot Trivia"] = 589,
    ["Render Blueprints"] = 809,
    RenderCV = 599,
    Renovate = 598,
    ["Replit config"] = 593,
    RoadRunner = 601,
    ["Rudder techniques"] = 913,
    Ruff = 595,
    ["Rust Project"] = 596,
    ["Rust toolchain"] = 605,
    ["SDMX data message"] = 630,
    ["SDMX metadata message"] = 629,
    ["SDMX structure message"] = 628,
    ["SIL Kit Participant Configuration"] = 640,
    ["SIL Kit Registry Configuration"] = 641,
    SWADL = 669,
    ["Safebox Config"] = 870,
    ["Sapphire CLI Config"] = 608,
    ["SauceCTL Configuration"] = 819,
    ["Schema Catalog"] = 622,
    ["Scoop manifest"] = 627,
    ["Semantic Data Fabric (SDF) file"] = 631,
    ["Semgrep Rule"] = 633,
    ["Serenity Code Generator (Sergen)"] = 634,
    ["Serverless Framework Configuration"] = 826,
    ["Serverless Workflow"] = 828,
    ["Settings for a Cinnamon spice"] = 956,
    ["Settings.paf"] = 636,
    ["Shopware 6 Configuration"] = 829,
    ["Shopware CLI Extension Store Configuration"] = 830,
    ["Shopware CLI Project Store Configuration"] = 831,
    ["Sigma Detection Rule"] = 638,
    ["Sigrid scope configuration file"] = 639,
    ["SkyPilot Task JSON"] = 914,
    ["Slack app manifest"] = 643,
    Solidarity = 646,
    ["Solution filters"] = 647,
    ["Source Maps v3"] = 648,
    Sourcery = 649,
    ["Speakeasy Lint Configuration File"] = 650,
    ["Speakeasy Test Generation Configuration File"] = 651,
    ["Speakeasy Workflow File"] = 652,
    SpecIF = 653,
    ["Sponge Mixin configuration"] = 654,
    StackBlitz = 659,
    ["StackHawk Scanner Configuration"] = 825,
    Stale = 660,
    ["Starlake Data Pipeline"] = 800,
    Starship = 661,
    ["Statamic Blueprint"] = 662,
    ["Stella configuration file"] = 663,
    ["Stryker Mutator"] = 666,
    ["StyleCop Analyzers Configuration"] = 667,
    ["Stylelint (.stylelintrc)"] = 668,
    ["Sublime Syntax"] = 871,
    ["Subsquid squid manifest"] = 916,
    ["Swagger API 2.0"] = 670,
    TSON = 699,
    TSTyche = 700,
    ["Tab data for a LinUtil"] = 962,
    ["Tab list for a LinUtil"] = 961,
    Talhelper = 672,
    ["Talisman configuration"] = 673,
    ["Taskfile config"] = 805,
    Taurus = 674,
    Tauticord = 675,
    ["TestEnvironment.json"] = 684,
    ["TextMate Grammar"] = 683,
    ["Tier.run pricing.json"] = 678,
    Tikibase = 679,
    ["Traefik v2"] = 687,
    ["Traefik v2 File Provider"] = 688,
    ["Travis CI (.travis.yml)"] = 686,
    ["TrueScript for *.tscript files"] = 691,
    TunnelHub = 906,
    Turborepo = 685,
    Tycho = 952,
    Tye = 833,
    ["UET BuildConfig.json"] = 876,
    ["UI5 Manifest"] = 709,
    ["UNCORS configuration"] = 713,
    ["UTAM Page Object"] = 712,
    ["Ubuntu Server Autoinstall"] = 707,
    ["Uniswap Token List"] = 788,
    ["Unreal Engine Uplugin"] = 877,
    ["Unreal Engine Uproject"] = 878,
    ["Updatecli Compose"] = 841,
    ["Updatecli Policy Manifest"] = 842,
    ["Updatecli Policy Metadata"] = 843,
    Uplift = 874,
    ["User Journey Map"] = 808,
    V2Ray = 847,
    ["VSCode Code Snippets"] = 182,
    ["VSIX CLI publishing"] = 730,
    ["Vela Pipeline Configuration"] = 717,
    Vercel = 181,
    ["Version Bumper config"] = 720,
    Visivo = 904,
    ["Waku Config"] = 965,
    ["Web App Manifest"] = 736,
    ["Web types"] = 739,
    WebExtensions = 735,
    ["Webman package recipe"] = 853,
    ["Windows Package Manager Installer Manifest"] = 785,
    ["Windows Package Manager Locale Manifest"] = 786,
    ["Windows Package Manager Singleton Manifest"] = 784,
    ["WireMock stub mapping"] = 968,
    ["Woodpecker pipeline config"] = 821,
    ["Wrangler CLI"] = 740,
    ["Xstate Machine"] = 839,
    ["Yandex Workflow Language"] = 958,
    ["Yarn Config (.yarnrc.yml)"] = 798,
    ["Yippee-Ki-JSON configuration YML"] = 790,
    ["YouTrack App"] = 955,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 908,
    ...
    ["behat.yml"] = 92,
    ["bigquery-table"] = 82,
    ["bioimageio resource description"] = 924,
    ...
    ["crowdin.yml"] = 215,
    ["ctfd-setup configuration file"] = 974,
    ["custom-elements.json"] = 896,
    ["cypress.json"] = 219,
    ...
    ["lint-staged (.lintstagedrc)"] = 756,
    ["local.settings.json"] = 435,
    ["localazy.json"] = 436,
    ["lotus.yaml"] = 434,
    ["lsdlschema.json"] = 437,
    ["markdown-link-check"] = 817,
    mboats = 824,
    ["micro-settings.json"] = 888,
    ["mimetypes.json"] = 448,
    ["mirrord config"] = 757,
    mise = 758,
    ["mkdocs.yml"] = 468,
    ["monospace.yml"] = 470,
    ["moon.yml"] = 967,
    ["mprocs Configuration file"] = 940,
    ["mta.yaml"] = 759,
    ["mtad.yaml"] = 760,
    ["mycode.json"] = 477,
    ["napari plugin manifest"] = 478,
    neoload = 771,
    ["nest-cli"] = 483,
    ["ninjs (News in JSON)"] = 482,
    ["nitro.json"] = 770,
    ["nixd configuration"] = 912,
    ["nlu.json"] = 484,
    ["nodemon.json"] = 486,
    ["noodl config"] = 823,
    ["notebook.mod.json"] = 487,
    now = 766,
    ["npm-badges"] = 490,
    ["nswag.json"] = 494,
    ntangle = 496,
    ["nuclei-template.yaml"] = 491,
    ["nuget-project.json"] = 492,
    ["ocelot.json"] = 498,
    ["omnisharp.json"] = 502,
    ["openapi.json"] = 503,
    ["openfin.json"] = 510,
    ...
    ["ops.yaml"] = 507,
    ["package.json"] = 529,
    ["package.manifest"] = 530,
    ["partial-black.json"] = 93,
    ["pathfinder.yml"] = 533,
    ["pattern.json"] = 536,
    ["petstore-v1.0"] = 868,
    pgap_yaml_input_reader = 535,
    ["pixi.toml"] = 537,
    ["plagiarize-me.yaml"] = 541,
    ["plagiarize.yaml"] = 540,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 971,
    ["podbard.yaml"] = 543,
    ["portman.json"] = 544,
    ["prefect.toml"] = 552,
    ["prettierrc.json"] = 553,
    ["prisma.yml"] = 554,
    ["project-1.0.0-beta3.json"] = 557,
    ["project-1.0.0-beta4.json"] = 558,
    ["project-1.0.0-beta5.json"] = 559,
    ["project-1.0.0-beta6.json"] = 560,
    ["project-1.0.0-beta8.json"] = 561,
    ["project-1.0.0-rc1.json"] = 562,
    ["project-1.0.0-rc2.json"] = 563,
    ["project.json"] = 556,
    ["prometheus.json"] = 564,
    ["prometheus.rules.json"] = 565,
    ["prometheus.rules.test.json"] = 566,
    ["proxies.json"] = 567,
    ["publiccode.yml"] = 568,
    ["pubspec.yaml"] = 569,
    ["pyrseas-0.8.json"] = 572,
    ["quilt.mod.json"] = 889,
    ["rc3 auth"] = 581,
    ["rc3 collection"] = 582,
    ["rc3 environment"] = 583,
    ...
    samt = 606,
    samtrc = 607,
    ["sarif-1.0.0.json"] = 609,
    ["sarif-2.0.0.json"] = 610,
    ["sarif-2.1.0"] = 620,
    ["sarif-2.1.0-rtm.2"] = 611,
    ["sarif-2.1.0-rtm.3"] = 613,
    ["sarif-2.1.0-rtm.4"] = 615,
    ["sarif-2.1.0-rtm.5"] = 617,
    ["sarif-2.1.0-rtm.6"] = 618,
    ["sarif-external-property-file-2.1.0"] = 621,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 612,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 614,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 616,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 619,
    ["schema.org - Action"] = 623,
    ["schema.org - ContactPoint"] = 624,
    ["schema.org - Place"] = 625,
    ["schema.org - Thing"] = 626,
    ["secrethub.yml"] = 891,
    ["semantic-release"] = 632,
    ["servicehub.config.json"] = 751,
    ["servicehub.service.json"] = 750,
    ["settings.job"] = 635,
    ["sfdx-hardis configuration"] = 637,
    ["shard.yml"] = 927,
    ["size-limit configuration"] = 642,
    ["skaffold.yaml"] = 815,
    ["skyuxconfig.json"] = 644,
    snapcraft = 645,
    ["spicepod.yaml"] = 947,
    ["sqlc configuration"] = 656,
    ["stripe-app-local.json"] = 665,
    ["stripe-app.json"] = 664,
    swcrc = 801,
    ["task.json"] = 671,
    taskcat = 767,
    ["template.json"] = 676,
    ["templatsources.json"] = 677,
    ["theme.json"] = 680,
    ["tizen_workspace.json"] = 681,
    tldr = 682,
    tmuxinator = 754,
    ["transcend.yml"] = 689,
    ...
    ["vega-lite.json"] = 716,
    ["vega.json"] = 715,
    ["venvironment-basic.yaml"] = 719,
    ["venvironment.yaml"] = 718,
    ["version.json"] = 721,
    ["vhwdebugger-binding.yaml"] = 723,
    ["vim-addon-info"] = 724,
    ["vs-2017.3.host.json"] = 726,
    ["vs-nesting.json"] = 727,
    ["vsls.json"] = 725,
    ["vss-extension.json"] = 731,
    ["vtesttree.yaml"] = 732,
    ["vtestunit.yaml"] = 733,
    ["warp-keysets.json"] = 897,
    ["warp-themes.json"] = 898,
    ["warp-workflows.json"] = 899,
    ["webhint.io"] = 854,
    ["webjobpublishsettings.json"] = 738,
    ["webjobs-list.json"] = 737,
    ["well-known-fursona"] = 935,
    ["xs-app.json"] = 763,
    ["xunit.runner.json"] = 749,
    yamllint = 789,
    ["zerops.io import file"] = 944,
    ["zerops.yml"] = 943,
    zuul = 773,
    ["Žinoma"] = 783
  },
