...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 97,
    [".cryproj (generic)"] = 392,
    [".cryproj engine-5.2"] = 387,
    [".cryproj engine-5.3"] = 388,
    [".cryproj engine-5.4"] = 389,
    [".cryproj engine-5.5"] = 390,
    [".cryproj engine-dev"] = 391,
    [".csscomb.json"] = 99,
    [".csslintrc"] = 100,
    [".eslintrc"] = 134,
    [".esmrc.json"] = 127,
    ...
    [".vsext"] = 368,
    [".yarnrc.yml"] = 430,
    ["<div>RIOTS' studio configuration"] = 371,
    ["API Builder"] = 427,
    ...
    ["Better Code Hub"] = 432,
    BizTalkServerApplicationSchema = 404,
    Briefcase = 409,
    Buildkite = 53,
    ...
    Goreleaser = 159,
    ["Goreleaser Pro"] = 160,
    ["Gradle Build Cache Node"] = 429,
    ["Gradle Enterprise"] = 428,
    ...
    ["JSON Feed"] = 195,
    ["JSON Resume"] = 292,
    ["JSON Schema Draft 2020-12"] = 383,
    ["JSON Schema Draft 4"] = 380,
    ["JSON Schema Draft 7"] = 381,
    ["JSON Schema Draft 8"] = 382,
    ...
    ["Netin Diagnostic System Template"] = 451,
    ["Netlify config schema"] = 233,
    ["Nightwatch.js"] = 234,
    ["OSS Review Toolkit repository configuration"] = 254,
    Opctl = 400,
    ["OpenWeather Current Weather API"] = 436,
    ["OpenWeather Road Risk API"] = 435,
    ...
    Packer = 257,
    ["Pipeline component"] = 445,
    ["PocketMine plugin.yml"] = 261,
    ["Pull Request Labeler"] = 283,
    Qodana = 458,
    ["RKE Cluster Configuration JSON Schema"] = 443,
    ["RKE Cluster Configuration YAML Schema"] = 442,
    Ray = 412,
    ["Read the Docs"] = 286,
    ...
    ["SauceCTL Configuration"] = 448,
    ["Schema Catalog"] = 308,
    ["Scoop manifest"] = 313,
    ["Semgrep Rule"] = 314,
    ["Serverless Framework Configuration"] = 455,
    ["Settings.paf"] = 316,
    ["Shopware CLI Extension Store Configuration"] = 456,
    ["Shopware CLI Project Store Configuration"] = 457,
    Solidarity = 321,
    ["Source Maps v3"] = 322,
    SpecIF = 323,
    ["Sponge Mixin configuration"] = 324,
    ["StackHawk Scanner Configuration"] = 454,
    ...
    ["Swagger API 2.0"] = 337,
    ["Taskfile YAML Schema"] = 438,
    Taurus = 338,
    ["TestEnvironment.json"] = 343,
    ["Traefik v2"] = 345,
    ["Traefik v2 File Provider"] = 346,
    ["UI5 Manifest"] = 357,
    ["Uniswap Token List"] = 421,
    ["User Journey Map YAML Schema"] = 441,
    ["VSCode Code Snippets"] = 76,
    ["VSIX CLI publishing"] = 369,
    ["Vela Pipeline Configuration"] = 361,
    Vercel = 75,
    ["Web App Manifest"] = 373,
    ["Web types"] = 376,
    WebExtensions = 372,
    ["Windows Package Manager Installer Manifest"] = 418,
    ["Windows Package Manager Locale Manifest"] = 419,
    ["Windows Package Manager Singleton Manifest"] = 417,
    ["Woodpecker pipeline config"] = 450,
    ["Yippee-Ki-JSON configuration YML"] = 423,
    ["angular.json"] = 6,
    ...
    ["servicehub.config.json"] = 386,
    ["servicehub.service.json"] = 385,
    ["settings.job"] = 315,
    ...
    ["version.json"] = 362,
    ["vim-addon-info"] = 363,
    ["vs-2017.3.host.json"] = 365,
    ["vs-nesting.json"] = 366,
    ["vsls.json"] = 364,
    ["vss-extension.json"] = 370,
    ["webjobpublishsettings.json"] = 375,
    ["webjobs-list.json"] = 374,
    ["xs-app.json"] = 399,
    ["xunit.runner.json"] = 384,
    yamllint = 422,
    zuul = 408,
    ["Žinoma"] = 416
  },
