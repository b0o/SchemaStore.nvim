...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 154,
    [".cryproj (generic)"] = 518,
    [".cryproj engine-5.2"] = 513,
    [".cryproj engine-5.3"] = 514,
    [".cryproj engine-5.4"] = 515,
    [".cryproj engine-5.5"] = 516,
    [".cryproj engine-dev"] = 517,
    [".csscomb.json"] = 156,
    [".csslintrc"] = 157,
    [".eslintrc"] = 202,
    [".esmrc.json"] = 194,
    ...
    [".mtaext"] = 527,
    [".nodehawkrc"] = 327,
    [".npmpackagejsonlintrc"] = 330,
    [".phraseapp.yml"] = 365,
    [".pmbot.yml"] = 357,
    [".postcssrc"] = 362,
    [".pre-commit-config.yml"] = 363,
    [".pre-commit-hooks.yml"] = 364,
    [".putout.json"] = 382,
    [".rehyperc"] = 390,
    [".remarkrc"] = 391,
    [".sprite files"] = 437,
    ...
    ["Azure Pipelines"] = 48,
    ["Azure Static Web Apps CLI configuration file"] = 439,
    ["Azure Static Web Apps configuration file"] = 438,
    ["BX CI"] = 83,
    ["Better Code Hub"] = 561,
    ["Better Scripts"] = 84,
    BizTalkServerApplicationSchema = 533,
    ...
    ["Butane Config"] = 599,
    ["CICS TS region tagging"] = 606,
    ["CICS TS resource import"] = 607,
    ["CICS TS resource model"] = 608,
    ["CICS TS resource overrides"] = 609,
    ["CMake Presets"] = 85,
    ...
    ["Datahub Ingestion Recipe Schema"] = 613,
    ...
    ["Embrace Config Schema"] = 624,
    ["Error pages"] = 197,
    Esquio = 195,
    ["Estuary Flow Catalog Schema"] = 603,
    ["Expo SDK"] = 200,
    ...
    Goreleaser = 228,
    ["Goreleaser Pro"] = 229,
    ["Gradle Build Cache Node"] = 558,
    ["Gradle Enterprise"] = 557,
    ...
    Hadolint = 542,
    Hammerkit = 568,
    ["Hardware Sentry Configuration"] = 617,
    Hayson = 241,
    ...
    ["JFrog File Spec"] = 261,
    ["JFrog Pipelines YML DSL"] = 626,
    ["JMeter DSL cli config schema"] = 262,
    ["JSON Document Transform"] = 270,
    ["JSON Feed"] = 271,
    ["JSON Resume"] = 396,
    ["JSON Schema Draft 2020-12"] = 509,
    ["JSON Schema Draft 4"] = 506,
    ["JSON Schema Draft 7"] = 507,
    ["JSON Schema Draft 8"] = 508,
    ...
    ["KSP-AVC"] = 504,
    ["KSP-CKAN"] = 505,
    ["Keycloak REST API"] = 632,
    ["Knative Functions - func.yaml"] = 212,
    ["KoDE/CI build.yaml"] = 622,
    ["Kong DBLess Schema"] = 623,
    KrakenD = 276,
    ["LinkML Metamodel"] = 289,
    Liquibase = 573,
    ["Liquibase Flow File"] = 574,
    ...
    ["Minecraft Resource Pack Particle"] = 314,
    ["Minecraft Resourcepack Sounds"] = 315,
    ["MkDocs Configuration 1.0"] = 316,
    ["MongoDB Atlas Search Index Definition Schema"] = 621,
    ["Monika Configuration Schema"] = 619,
    ["Motif config"] = 526,
    ["NOX Framework (Service)"] = 329,
    ["Netin Diagnostic System Template"] = 582,
    ["Netlify config schema"] = 321,
    ["Nightwatch.js"] = 322,
    ["OSS Review Toolkit configuration"] = 347,
    ["OSS Review Toolkit curation"] = 348,
    ["OSS Review Toolkit package configuration"] = 349,
    ["OSS Review Toolkit repository configuration"] = 350,
    ["OSS Review Toolkit resolutions"] = 351,
    Opctl = 529,
    ["OpenRewrite Resource"] = 342,
    ["OpenWeather Current Weather API"] = 565,
    ["OpenWeather Road Risk API"] = 564,
    ["Ory Hydra configuration"] = 247,
    ["Ory Keto configuration"] = 278,
    ["Ory Kratos configuration"] = 346,
    ["Ory Oathkeeper configuration"] = 336,
    ["Outblocks App configuration"] = 344,
    ["Outblocks database table"] = 345,
    ["Outblocks project configuration"] = 343,
    Packer = 354,
    Pantsbuild = 638,
    ["Pipeline component"] = 575,
    ["PocketMine plugin.yml"] = 358,
    Pterodactyl = 616,
    ["Pull Request Labeler"] = 381,
    Pulumi = 386,
    PyProject = 387,
    Qodana = 592,
    ["Quali Torque Blueprint Spec 2"] = 614,
    ["QueryFirst config file"] = 635,
    ["RKE Cluster Configuration JSON Schema"] = 572,
    ["RKE Cluster Configuration YAML Schema"] = 571,
    ["Rancher Fleet"] = 384,
    Ray = 541,
    ["Read the Docs"] = 385,
    ["Red-DiscordBot Cog"] = 388,
    ["Red-DiscordBot Cog Repo"] = 389,
    Renovate = 397,
    ["Replit schema"] = 392,
    RoadRunner = 398,
    Ruff = 394,
    ["Rust Project"] = 395,
    ["Rust toolchain"] = 400,
    ["SIL Kit Participant Configuration"] = 426,
    SWADL = 448,
    ["Sapphire CLI Config"] = 401,
    ["SauceCTL Configuration"] = 579,
    ["Schema Catalog"] = 414,
    ["Scoop manifest"] = 419,
    ["Semgrep Rule"] = 421,
    ["Serenity Code Generator (Sergen)"] = 422,
    ["Serverless Framework Configuration"] = 586,
    ["Serverless Workflow Schema"] = 588,
    ["Settings.paf"] = 424,
    ["Shopware 6 Configuration"] = 589,
    ["Shopware CLI Extension Store Configuration"] = 590,
    ["Shopware CLI Project Store Configuration"] = 591,
    ["Slack app manifest"] = 428,
    Solidarity = 431,
    ["Solution filters"] = 432,
    ["Source Maps v3"] = 433,
    Sourcery = 434,
    SpecIF = 435,
    ["Sponge Mixin configuration"] = 436,
    ["StackHawk Scanner Configuration"] = 585,
    Stale = 440,
    Starship = 441,
    ["Statamic Blueprint"] = 442,
    ["StrmPrivacy Data Connector"] = 630,
    ["StrmPrivacy Data Contract"] = 631,
    ["StrmPrivacy SimpleSchema"] = 628,
    ["StrmPrivacy Stream"] = 629,
    ["StrmPrivacy batch job configuration file"] = 627,
    ["Stryker Mutator"] = 445,
    ["StyleCop Analyzers Configuration"] = 446,
    ["Swagger API 2.0"] = 449,
    TSON = 471,
    ["Talisman configuration"] = 450,
    ["Taskfile YAML Schema"] = 567,
    Taurus = 451,
    ["TestEnvironment.json"] = 459,
    ["Tier.run pricing.json"] = 454,
    Tikibase = 455,
    ["Traefik v2"] = 462,
    ["Traefik v2 File Provider"] = 463,
    Turborepo = 460,
    Tye = 593,
    ["UI5 Manifest"] = 478,
    ["UTAM Page Object"] = 481,
    ["Ubuntu Server Autoinstall"] = 476,
    ["Uniswap Token List"] = 550,
    ["Unreal Engine Uplugin"] = 636,
    ["Unreal Engine Uproject"] = 637,
    Updatecli = 600,
    Uplift = 634,
    ["User Journey Map YAML Schema"] = 570,
    V2Ray = 604,
    ["VSCode Code Snippets"] = 130,
    ["VSIX CLI publishing"] = 494,
    ["Vela Pipeline Configuration"] = 484,
    Vercel = 129,
    ["Web App Manifest"] = 499,
    ["Web types"] = 502,
    WebExtensions = 498,
    ["Webman package recipe"] = 610,
    ["Windows Package Manager Installer Manifest"] = 547,
    ["Windows Package Manager Locale Manifest"] = 548,
    ["Windows Package Manager Singleton Manifest"] = 546,
    ["Woodpecker pipeline config"] = 581,
    ["Xstate Machine Schema"] = 598,
    ["Yippee-Ki-JSON configuration YML"] = 552,
    ["angular.json"] = 11,
    ...
    ["ize.toml"] = 633,
    ["jsconfig.json"] = 274,
    ["jscpd Configuration Schema"] = 615,
    jsdoc = 540,
    ["k3d.yaml"] = 275,
    ...
    ["mtad.yaml"] = 525,
    ["mycode.json"] = 319,
    ["napari plugin manifest"] = 320,
    neoload = 535,
    ["nest-cli"] = 325,
    ["ninjs (News in JSON) 1.3"] = 324,
    ["ninjs (News in JSON) 2.0"] = 323,
    ["nlu.json"] = 326,
    ["nodemon.json"] = 328,
    ["noodl.schema.json"] = 583,
    now = 531,
    ["npm-badges"] = 331,
    ["nswag.json"] = 334,
    ntangle = 335,
    ["nuclei-template.yaml"] = 332,
    ["nuget-project.json"] = 333,
    ["ocelot.json"] = 337,
    ["omnisharp.json"] = 338,
    ["openapi.json"] = 339,
    ["openfin.json"] = 341,
    ["openrpc.json"] = 340,
    ["package.json"] = 352,
    ["package.manifest"] = 353,
    ["pattern.json"] = 356,
    ["petstore-v1.0"] = 625,
    pgap_yaml_input_reader = 355,
    ["plagiarize-me.yaml"] = 360,
    ["plagiarize.yaml"] = 359,
    ["portman.json"] = 361,
    ["prettierrc.json"] = 366,
    ["prisma.yml"] = 367,
    ["project-1.0.0-beta3.json"] = 369,
    ["project-1.0.0-beta4.json"] = 370,
    ["project-1.0.0-beta5.json"] = 371,
    ["project-1.0.0-beta6.json"] = 372,
    ["project-1.0.0-beta8.json"] = 373,
    ["project-1.0.0-rc1.json"] = 374,
    ["project-1.0.0-rc2.json"] = 375,
    ["project.json"] = 368,
    ["prometheus.json"] = 376,
    ["prometheus.rules.json"] = 377,
    ["proxies.json"] = 378,
    ["publiccode.yml"] = 379,
    ["pubspec.yaml"] = 380,
    ["pyrseas-0.8.json"] = 383,
    ["release drafter"] = 536,
    rustfmt = 399,
    ["sarif-1.0.0.json"] = 402,
    ["sarif-2.0.0.json"] = 403,
    ["sarif-2.1.0"] = 412,
    ["sarif-2.1.0-rtm.2"] = 404,
    ["sarif-2.1.0-rtm.3"] = 406,
    ["sarif-2.1.0-rtm.4"] = 408,
    ["sarif-2.1.0-rtm.5"] = 410,
    ["sarif-external-property-file-2.1.0"] = 413,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 405,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 407,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 409,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 411,
    ["schema.org - Action"] = 415,
    ["schema.org - ContactPoint"] = 416,
    ["schema.org - Place"] = 417,
    ["schema.org - Thing"] = 418,
    ["semantic-release"] = 420,
    ["servicehub.config.json"] = 512,
    ["servicehub.service.json"] = 511,
    ["settings.job"] = 423,
    ["sfdx-hardis configuration"] = 425,
    ["size-limit configuration"] = 427,
    ["skaffold.yaml"] = 576,
    ["skyuxconfig.json"] = 429,
    snapcraft = 430,
    ["stripe-app-local.json"] = 444,
    ["stripe-app.json"] = 443,
    swcrc = 563,
    taskcat = 532,
    ["template.json"] = 452,
    ["templatsources.json"] = 453,
    ["theme.json"] = 456,
    ["tizen_workspace.json"] = 457,
    tmLanguage = 458,
    tmuxinator = 520,
    ["transcend.yml"] = 464,
    ["trunk.yaml schema"] = 465,
    ["ts-force-config.json"] = 469,
    ["tsconfig.json"] = 466,
    ["tsd.json"] = 467,
    ["tsdrc.json"] = 468,
    ["tslint.json"] = 470,
    ...
    ["vega-lite.json"] = 483,
    ["vega.json"] = 482,
    ["venvironment-basic.yaml"] = 486,
    ["venvironment.yaml"] = 485,
    ["version.json"] = 487,
    ["vim-addon-info"] = 488,
    ["vs-2017.3.host.json"] = 490,
    ["vs-nesting.json"] = 491,
    ["vsls.json"] = 489,
    ["vss-extension.json"] = 495,
    ["webhint.io"] = 611,
    ["webjobpublishsettings.json"] = 501,
    ["webjobs-list.json"] = 500,
    ["xs-app.json"] = 528,
    ["xunit.runner.json"] = 510,
    yamllint = 551,
    zuul = 537,
    ["Žinoma"] = 545
  },
