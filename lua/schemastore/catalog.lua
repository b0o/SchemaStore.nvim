...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 172,
    [".cryproj (generic)"] = 592,
    [".cryproj engine-5.2"] = 587,
    [".cryproj engine-5.3"] = 588,
    [".cryproj engine-5.4"] = 589,
    [".cryproj engine-5.5"] = 590,
    [".cryproj engine-dev"] = 591,
    [".csscomb.json"] = 174,
    [".csslintrc"] = 175,
    [".es6importsorterrc.json"] = 718,
    [".eslintrc"] = 224,
    [".esmrc.json"] = 216,
    [".ffizer.yaml"] = 228,
    [".htmlhintrc"] = 279,
    ...
    [".mtaext"] = 601,
    [".nodehawkrc"] = 377,
    [".npmpackagejsonlintrc"] = 380,
    [".phraseapp.yml"] = 421,
    [".pmbot.yml"] = 411,
    [".postcssrc"] = 416,
    [".powerpages-web-template-manifest"] = 418,
    [".pre-commit-config.yml"] = 419,
    [".pre-commit-hooks.yml"] = 420,
    [".putout.json"] = 440,
    [".rehyperc"] = 452,
    [".remarkrc"] = 453,
    [".sprite files"] = 506,
    ...
    ["<div>RIOTS' studio configuration"] = 571,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 338,
    ["API Builder"] = 632,
    ["AVA Configuration"] = 688,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 663,
    ["All Contributors configuration file"] = 717,
    ...
    ["Azure Pipelines"] = 56,
    ["Azure Static Web Apps CLI configuration file"] = 509,
    ["Azure Static Web Apps configuration file"] = 508,
    ["BX CI"] = 92,
    ["Better Code Hub"] = 636,
    ["Better Scripts"] = 93,
    Bigconfig = 73,
    BizTalkServerApplicationSchema = 607,
    Bleep = 94,
    ...
    ["Butane Config"] = 675,
    ["CICS TS region tagging"] = 682,
    ["CICS TS resource import"] = 683,
    ["CICS TS resource model"] = 684,
    ["CICS TS resource overrides"] = 685,
    ["CMake Presets"] = 95,
    ["CNC Codes"] = 105,
    ...
    ["Databricks Asset Bundles"] = 738,
    ["Datadog Service Definition"] = 317,
    ["Datahub Ingestion Recipe"] = 689,
    ["Dein Config"] = 110,
    Deno = 185,
    ["Deployer Recipe"] = 188,
    ["Deta Spacefile"] = 111,
    ...
    ["Goreleaser Pro"] = 261,
    Goss = 262,
    ["Gradle Build Cache Node"] = 634,
    ["Gradle Enterprise"] = 633,
    ...
    Hadolint = 616,
    Hammerkit = 643,
    ["Hardware Sentry Configuration"] = 693,
    Hayson = 274,
    ...
    ["JFrog File Spec"] = 299,
    ["JFrog Pipelines YML DSL"] = 702,
    ["JMeter DSL cli config"] = 300,
    JReleaser = 302,
    ["JSON Document Transform"] = 309,
    ["JSON Feed"] = 310,
    ["JSON Resume"] = 459,
    ["JSON Schema Draft 2020-12"] = 583,
    ["JSON Schema Draft 4"] = 580,
    ["JSON Schema Draft 7"] = 581,
    ["JSON Schema Draft 7 (unofficial strict)"] = 739,
    ["JSON Schema Draft 8 (2019-09)"] = 582,
    ["JSON-API"] = 308,
    ["JSON-e templates"] = 641,
    ["JSON-stat 2.0"] = 577,
    JSONPatch = 312,
    Jasmine = 292,
    Jekyll = 293,
    ...
    Kas = 315,
    ["Keycloak REST API"] = 709,
    ["Knative Functions - func.yaml"] = 239,
    ["KoDE/CI build.yaml"] = 698,
    ["Kong DBLess config"] = 699,
    KrakenD = 316,
    LOOBin = 333,
    Lefthook = 324,
    ["LinkML Metamodel"] = 331,
    Liquibase = 648,
    ["Liquibase Flow File"] = 649,
    ["Lively Properties"] = 332,
    ["Lobe AI Agent"] = 55,
    ["MS2Rescore Configuration"] = 365,
    Markdownlint = 652,
    ["Mason Registry"] = 654,
    ["MegaLinter configuration"] = 339,
    ["MegaLinter descriptor"] = 340,
    ["Meltano plugin discovery definition"] = 342,
    ["Meltano project definition"] = 341,
    ["Microsoft Band Web Tile"] = 343,
    ["Minecraft Data Pack Advancement"] = 345,
    ["Minecraft Data Pack Biome"] = 346,
    ["Minecraft Data Pack Configured Carver"] = 347,
    ["Minecraft Data Pack Damage Type"] = 348,
    ["Minecraft Data Pack Dimension"] = 350,
    ["Minecraft Data Pack Dimension Type"] = 349,
    ["Minecraft Data Pack Item Modifier"] = 351,
    ["Minecraft Data Pack Loot Table"] = 352,
    ["Minecraft Data Pack Metadata"] = 353,
    ["Minecraft Data Pack Predicate"] = 354,
    ["Minecraft Data Pack Recipe"] = 355,
    ["Minecraft Data Pack Tag"] = 356,
    ["Minecraft Data Pack Template Pool"] = 357,
    ["Minecraft Data Pack Trim Material"] = 362,
    ["Minecraft Data Pack Trim Pattern"] = 363,
    ["Minecraft Resource Pack Lang"] = 358,
    ["Minecraft Resource Pack Particle"] = 359,
    ["Minecraft Resource Pack Texture Mcmeta"] = 361,
    ["Minecraft Resourcepack Sounds"] = 360,
    ["MkDocs Configuration 1.0"] = 364,
    ["MongoDB Atlas Search Index Definition"] = 697,
    ["Monika Configuration"] = 695,
    ["Motif config"] = 600,
    ["NOX Framework (Service)"] = 379,
    ["Netin Diagnostic System Template"] = 658,
    ["Netlify config"] = 370,
    ["Nexus-as-Code Data Model"] = 371,
    ["Nightwatch.js"] = 372,
    ["ONe's service descriptor"] = 392,
    ["OSS Review Toolkit configuration"] = 399,
    ["OSS Review Toolkit curation"] = 400,
    ["OSS Review Toolkit package configuration"] = 401,
    ["OSS Review Toolkit repository configuration"] = 402,
    ["OSS Review Toolkit resolutions"] = 403,
    Opctl = 603,
    ["OpenRewrite Resource"] = 394,
    ["OpenWeather Current Weather API"] = 640,
    ["OpenWeather Road Risk API"] = 639,
    ["Ory Hydra configuration"] = 280,
    ["Ory Keto configuration"] = 318,
    ["Ory Kratos configuration"] = 398,
    ["Ory Oathkeeper configuration"] = 386,
    ["Outblocks App configuration"] = 396,
    ["Outblocks database table"] = 397,
    ["Outblocks project configuration"] = 395,
    Packer = 406,
    Pantsbuild = 716,
    ["Paper paper-plugin.yml"] = 407,
    ["Pipeline component"] = 650,
    ["PocketMine plugin.yml"] = 412,
    ["Postman collection"] = 417,
    ["Problem package generators"] = 424,
    Pterodactyl = 692,
    ["Pull Request Labeler"] = 439,
    Pulumi = 445,
    PyProject = 446,
    Pyright = 447,
    Qgoda = 448,
    Qodana = 668,
    ["Quali Torque Blueprint Spec 2"] = 690,
    ["QueryFirst config file"] = 712,
    ["RKE Cluster Configuration JSON"] = 647,
    ["RKE Cluster Configuration YAML"] = 646,
    ["Rancher Fleet"] = 442,
    Ray = 615,
    ["Read the Docs"] = 444,
    ["Red-DiscordBot Cog"] = 449,
    ["Red-DiscordBot Cog Repo"] = 450,
    ["Red-DiscordBot Trivia"] = 451,
    Renovate = 460,
    ["Replit config"] = 454,
    RoadRunner = 461,
    Ruff = 457,
    ["Rust Project"] = 458,
    ["Rust toolchain"] = 463,
    ["SIL Kit Participant Configuration"] = 494,
    ["SIL Kit Registry Configuration"] = 495,
    SWADL = 518,
    ["Safebox Config"] = 703,
    ["Sapphire CLI Config"] = 466,
    ["SauceCTL Configuration"] = 655,
    ["Schema Catalog"] = 480,
    ["Scoop manifest"] = 485,
    ["Semantic Data Fabric (SDF) file"] = 486,
    ["Semgrep Rule"] = 488,
    ["Serenity Code Generator (Sergen)"] = 489,
    ["Serverless Framework Configuration"] = 662,
    ["Serverless Workflow"] = 664,
    ["Settings.paf"] = 491,
    ["Shopware 6 Configuration"] = 665,
    ["Shopware CLI Extension Store Configuration"] = 666,
    ["Shopware CLI Project Store Configuration"] = 667,
    ["Sigrid scope configuration file"] = 493,
    ["Slack app manifest"] = 497,
    Solidarity = 500,
    ["Solution filters"] = 501,
    ["Source Maps v3"] = 502,
    Sourcery = 503,
    SpecIF = 504,
    ["Sponge Mixin configuration"] = 505,
    ["StackHawk Scanner Configuration"] = 661,
    Stale = 510,
    ["Starlake Data Pipeline"] = 637,
    Starship = 511,
    ["Statamic Blueprint"] = 512,
    ["StrmPrivacy Data Connector"] = 707,
    ["StrmPrivacy Data Contract"] = 708,
    ["StrmPrivacy SimpleSchema"] = 705,
    ["StrmPrivacy Stream"] = 706,
    ["StrmPrivacy batch job configuration file"] = 704,
    ["Stryker Mutator"] = 515,
    ["StyleCop Analyzers Configuration"] = 516,
    ["Swagger API 2.0"] = 519,
    TSON = 543,
    ["Talisman configuration"] = 521,
    ["Taskfile config"] = 642,
    Taurus = 522,
    ["TestEnvironment.json"] = 531,
    ["Tier.run pricing.json"] = 525,
    Tikibase = 526,
    ["Traefik v2"] = 534,
    ["Traefik v2 File Provider"] = 535,
    Turborepo = 532,
    Tye = 669,
    ["UET BuildConfig.json"] = 713,
    ["UI5 Manifest"] = 550,
    ["UTAM Page Object"] = 553,
    ["Ubuntu Server Autoinstall"] = 548,
    ["Uniswap Token List"] = 625,
    ["Unreal Engine Uplugin"] = 714,
    ["Unreal Engine Uproject"] = 715,
    Updatecli = 676,
    Uplift = 711,
    ["User Journey Map"] = 645,
    V2Ray = 680,
    ["VSCode Code Snippets"] = 143,
    ["VSIX CLI publishing"] = 566,
    ["Vela Pipeline Configuration"] = 556,
    Vercel = 142,
    Visivo = 740,
    ["Web App Manifest"] = 573,
    ["Web types"] = 576,
    WebExtensions = 572,
    ["Webman package recipe"] = 686,
    ["Windows Package Manager Installer Manifest"] = 622,
    ["Windows Package Manager Locale Manifest"] = 623,
    ["Windows Package Manager Singleton Manifest"] = 621,
    ["Woodpecker pipeline config"] = 657,
    ["Xstate Machine"] = 674,
    ["Yippee-Ki-JSON configuration YML"] = 627,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 67,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 722,
    ["bashly-strings.yml"] = 723,
    ["bashly.yml"] = 721,
    ["batect.yml"] = 66,
    ...
    ["ize.toml"] = 710,
    ["jsconfig.json"] = 313,
    ["jscpd Configuration"] = 691,
    jsdoc = 614,
    ["k3d.yaml"] = 314,
    ["kontinuous-config.yaml"] = 320,
    ["kontinuous-values.yaml"] = 319,
    ["kustomization.yaml"] = 321,
    ["label-commenter-config.yml"] = 322,
    ["launchsettings.json"] = 323,
    lazydocker = 732,
    lazygit = 731,
    ["lego.json"] = 325,
    ["lerna.json"] = 326,
    ["lgtm.yml"] = 327,
    ["libman.json"] = 328,
    ["license-report-config.json"] = 329,
    ["linkinator.config.json"] = 330,
    ["local.settings.json"] = 335,
    ["localazy.json"] = 336,
    ["lotus.yaml"] = 334,
    ["lsdlschema.json"] = 337,
    ["madness.yml"] = 720,
    ["markdown-lint-check"] = 653,
    mboats = 660,
    ["micro-settings.json"] = 725,
    ["mimetypes.json"] = 344,
    ["mirrord config"] = 597,
    ["mta.yaml"] = 598,
    ["mtad.yaml"] = 599,
    ["mycode.json"] = 368,
    ["napari plugin manifest"] = 369,
    neoload = 609,
    ["nest-cli"] = 375,
    ["ninjs (News in JSON) 1.3"] = 374,
    ["ninjs (News in JSON) 2.0"] = 373,
    ["nlu.json"] = 376,
    ["nodemon.json"] = 378,
    ["noodl config"] = 659,
    now = 605,
    ...
    ["nswag.json"] = 384,
    ntangle = 385,
    ["nuclei-template.yaml"] = 382,
    ["nuget-project.json"] = 383,
    ["ocelot.json"] = 387,
    ["omnisharp.json"] = 388,
    ["openapi.json"] = 389,
    ["openfin.json"] = 393,
    ...
    ["ops.yaml"] = 391,
    ["package.json"] = 404,
    ["package.manifest"] = 405,
    ["pathfinder.yml"] = 408,
    ["pattern.json"] = 410,
    ["petstore-v1.0"] = 701,
    pgap_yaml_input_reader = 409,
    ["plagiarize-me.yaml"] = 414,
    ["plagiarize.yaml"] = 413,
    ["portman.json"] = 415,
    ["prettierrc.json"] = 422,
    ["prisma.yml"] = 423,
    ["project-1.0.0-beta3.json"] = 426,
    ["project-1.0.0-beta4.json"] = 427,
    ["project-1.0.0-beta5.json"] = 428,
    ["project-1.0.0-beta6.json"] = 429,
    ["project-1.0.0-beta8.json"] = 430,
    ["project-1.0.0-rc1.json"] = 431,
    ["project-1.0.0-rc2.json"] = 432,
    ["project.json"] = 425,
    ["prometheus.json"] = 433,
    ["prometheus.rules.json"] = 434,
    ["prometheus.rules.test.json"] = 435,
    ["proxies.json"] = 436,
    ["publiccode.yml"] = 437,
    ["pubspec.yaml"] = 438,
    ["pyrseas-0.8.json"] = 441,
    ["quilt.mod.json"] = 726,
    ["release drafter"] = 610,
    rtx = 456,
    rustfmt = 462,
    samt = 464,
    samtrc = 465,
    ["sarif-1.0.0.json"] = 467,
    ["sarif-2.0.0.json"] = 468,
    ["sarif-2.1.0"] = 478,
    ["sarif-2.1.0-rtm.2"] = 469,
    ["sarif-2.1.0-rtm.3"] = 471,
    ["sarif-2.1.0-rtm.4"] = 473,
    ["sarif-2.1.0-rtm.5"] = 475,
    ["sarif-2.1.0-rtm.6"] = 476,
    ["sarif-external-property-file-2.1.0"] = 479,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 470,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 472,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 474,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 477,
    ["schema.org - Action"] = 481,
    ["schema.org - ContactPoint"] = 482,
    ["schema.org - Place"] = 483,
    ["schema.org - Thing"] = 484,
    ["secrethub.yml"] = 728,
    ["semantic-release"] = 487,
    ["servicehub.config.json"] = 586,
    ["servicehub.service.json"] = 585,
    ["settings.job"] = 490,
    ["sfdx-hardis configuration"] = 492,
    ["size-limit configuration"] = 496,
    ["skaffold.yaml"] = 651,
    ["skyuxconfig.json"] = 498,
    snapcraft = 499,
    ["sqlc configuration"] = 507,
    ["stripe-app-local.json"] = 514,
    ["stripe-app.json"] = 513,
    swcrc = 638,
    syntax = 730,
    ["task.json"] = 520,
    taskcat = 606,
    ["template.json"] = 523,
    ["templatsources.json"] = 524,
    ["theme.json"] = 527,
    ["tizen_workspace.json"] = 528,
    tldr = 529,
    tmLanguage = 530,
    tmuxinator = 594,
    ["transcend.yml"] = 536,
    ["trunk.yaml"] = 537,
    ["ts-force-config.json"] = 541,
    ["tsconfig.json"] = 538,
    ["tsd.json"] = 539,
    ["tsdrc.json"] = 540,
    ["tslint.json"] = 542,
    ...
    ["vega-lite.json"] = 555,
    ["vega.json"] = 554,
    ["venvironment-basic.yaml"] = 558,
    ["venvironment.yaml"] = 557,
    ["version.json"] = 559,
    ["vim-addon-info"] = 560,
    ["vs-2017.3.host.json"] = 562,
    ["vs-nesting.json"] = 563,
    ["vsls.json"] = 561,
    ["vss-extension.json"] = 567,
    ["vtesttree.yaml"] = 568,
    ["vtestunit.yaml"] = 569,
    ["warp-keysets.json"] = 734,
    ["warp-themes.json"] = 735,
    ["warp-workflows.json"] = 736,
    ["webhint.io"] = 687,
    ["webjobpublishsettings.json"] = 575,
    ["webjobs-list.json"] = 574,
    ["xs-app.json"] = 602,
    ["xunit.runner.json"] = 584,
    yamllint = 626,
    zuul = 611,
    ["Žinoma"] = 620
  },
