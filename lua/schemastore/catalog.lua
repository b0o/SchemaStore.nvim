...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 168,
    [".cryproj (generic)"] = 587,
    [".cryproj engine-5.2"] = 582,
    [".cryproj engine-5.3"] = 583,
    [".cryproj engine-5.4"] = 584,
    [".cryproj engine-5.5"] = 585,
    [".cryproj engine-dev"] = 586,
    [".csscomb.json"] = 170,
    [".csslintrc"] = 171,
    [".es6importsorterrc.json"] = 713,
    [".eslintrc"] = 220,
    [".esmrc.json"] = 212,
    [".ffizer.yaml"] = 224,
    [".htmlhintrc"] = 274,
    ...
    [".mtaext"] = 596,
    [".nodehawkrc"] = 372,
    [".npmpackagejsonlintrc"] = 375,
    [".phraseapp.yml"] = 416,
    [".pmbot.yml"] = 406,
    [".postcssrc"] = 411,
    [".powerpages-web-template-manifest"] = 413,
    [".pre-commit-config.yml"] = 414,
    [".pre-commit-hooks.yml"] = 415,
    [".putout.json"] = 435,
    [".rehyperc"] = 447,
    [".remarkrc"] = 448,
    [".sprite files"] = 501,
    ...
    ["<div>RIOTS' studio configuration"] = 566,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 333,
    ["API Builder"] = 627,
    ["AVA Configuration"] = 683,
    ["AWS CDK cdk.json"] = 152,
    ["AWS CloudFormation"] = 153,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 154,
    ["AWS SAM CLI Samconfig"] = 155,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 13,
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 658,
    ["All Contributors configuration file"] = 712,
    ...
    ["Azure Pipelines"] = 54,
    ["Azure Static Web Apps CLI configuration file"] = 504,
    ["Azure Static Web Apps configuration file"] = 503,
    ["BX CI"] = 89,
    ["Better Code Hub"] = 631,
    ["Better Scripts"] = 90,
    BizTalkServerApplicationSchema = 602,
    Bleep = 91,
    ["Block Protocol Metadata"] = 88,
    Briefcase = 607,
    ["Build Info"] = 81,
    Buildkite = 83,
    ["Bukkit plugin.yml"] = 82,
    ["BungeeCord plugin.yml"] = 86,
    ["Butane Config"] = 670,
    ["CICS TS region tagging"] = 677,
    ["CICS TS resource import"] = 678,
    ["CICS TS resource model"] = 679,
    ["CICS TS resource overrides"] = 680,
    ["CMake Presets"] = 92,
    ["CNC Codes"] = 101,
    ["Calqulus pipeline"] = 93,
    ["Camel YAML DSL"] = 94,
    Carafe = 95,
    ["Cargo Make"] = 97,
    ["Cargo Manifest"] = 96,
    ["Catalog Info Backstage"] = 98,
    Cheatsheets = 667,
    ["Chrome Extension"] = 145,
    ["CircleCI config.yml"] = 124,
    ["Citation File Format"] = 157,
    CityJSON = 99,
    ["Code Climate"] = 125,
    CodeCV = 53,
    ["CodeShip Pro services configuration files"] = 136,
    ["CodeShip Pro steps configuration files"] = 137,
    ["Codecov configuration files"] = 135,
    Codux = 133,
    ["Cog config file"] = 102,
    ["Commandbox Box.json"] = 103,
    ["Commandbox Server.json"] = 104,
    ["Common Catalog Data"] = 143,
    ["Common types for all schemas"] = 1,
    Conjure = 100,
    ["Container Structure Test"] = 614,
    Containerlab = 639,
    ["Crowdsec collection config"] = 164,
    ["Crowdsec parser config"] = 165,
    ["Crowdsec scenario config"] = 166,
    ["DWP Exchange - catalogue entry"] = 209,
    ["DWP Exchange - gateway"] = 207,
    ["DWP Exchange - meta"] = 208,
    ["Dart build configuration"] = 172,
    ["Dart test config"] = 173,
    ["DashLord configuration"] = 174,
    ["Data Contract Specification"] = 175,
    ["Databricks Asset Bundles"] = 733,
    ["Datadog Service Definition"] = 312,
    ["Datahub Ingestion Recipe"] = 684,
    ["Dein Config"] = 106,
    Deno = 181,
    ["Deployer Recipe"] = 184,
    ["Deta Spacefile"] = 107,
    Devfile = 206,
    ["Discord Webhook"] = 186,
    ["Dolittle Artifacts"] = 190,
    ["Dolittle Bounded Context Configuration"] = 191,
    ["Dolittle Event Horizons Configuration"] = 192,
    ["Dolittle Resources Configuration"] = 193,
    ["Dolittle Server Configuration"] = 194,
    ["Dolittle Tenant Map Configuration"] = 196,
    ["Dolittle Tenants Configuration"] = 195,
    ["Dolittle Topology"] = 197,
    ["Drupal Breakpoints"] = 108,
    ["Drupal Config"] = 119,
    ["Drupal Info"] = 109,
    ["Drupal Layouts"] = 110,
    ["Drupal Libraries"] = 111,
    ["Drupal Links Action"] = 112,
    ["Drupal Links Contextual"] = 113,
    ["Drupal Links Menu"] = 114,
    ["Drupal Links Task"] = 115,
    ["Drupal Migration"] = 116,
    ["Drupal Permissions"] = 117,
    ["Drupal Routing"] = 118,
    ["Drupal Services"] = 120,
    ["Drush site aliases"] = 202,
    ["Embrace Config"] = 695,
    ["Error pages"] = 215,
    Esquio = 213,
    ["Estuary Flow Catalog"] = 674,
    ["Expo SDK"] = 218,
    ["F-Droid Data metadata"] = 223,
    ["Facets - FSDL - Application"] = 221,
    ["FasterCI Configuration"] = 55,
    Firebase = 225,
    ["Fossa configuration file"] = 232,
    ["Fossa's fossa-deps file"] = 233,
    ["Foundry VTT - Base package Manifest"] = 227,
    ["Foundry VTT - Module Manifest"] = 228,
    ["Foundry VTT - System Data Template"] = 231,
    ["Foundry VTT - System Manifest"] = 229,
    ["Foundry VTT - World Manifest"] = 230,
    ["Foxx Manifest"] = 56,
    ["Freifunk.de Community API"] = 59,
    ["Frogbot Config"] = 60,
    ["G2P Mapping Configuration"] = 237,
    ["GCP Blueprint Metadata"] = 239,
    ["GatewayCore API Gateway"] = 238,
    ["GeoJSON.json latest"] = 672,
    GherKing = 676,
    ["GitHub Action"] = 243,
    ["GitHub Discussion"] = 244,
    ["GitHub Funding"] = 245,
    ["GitHub Issue Template configuration"] = 247,
    ["GitHub Workflow"] = 248,
    ["GitHub Workflow Template Properties"] = 249,
    ["GitHub issue forms"] = 246,
    GitVersion = 242,
    ["Gitpod Configuration"] = 251,
    ["Global Privacy Control"] = 240,
    Goblet = 732,
    ["Google Cloud Workflows"] = 151,
    Goreleaser = 255,
    ["Goreleaser Pro"] = 256,
    Goss = 257,
    ["Gradle Build Cache Node"] = 629,
    ["Gradle Enterprise"] = 628,
    ["Grafana 5.x Dashboard"] = 258,
    ["GraphQL Code Generator"] = 261,
    ["GraphQL Config"] = 260,
    ["GraphQL Mesh"] = 259,
    ["Grunt JSHint task"] = 265,
    ["Grunt Watch task"] = 266,
    ["Grunt base task"] = 267,
    ["Grunt clean task"] = 263,
    ["Grunt copy task"] = 262,
    ["Grunt cssmin task"] = 264,
    HEMTT = 599,
    Hadolint = 611,
    Hammerkit = 638,
    ["Hardware Sentry Configuration"] = 688,
    Hayson = 269,
    ["Haystack Pipeline"] = 270,
    ["Hazelcast 5 Configuration"] = 271,
    ["Helm Chart.lock"] = 122,
    ["Helm Chart.yaml"] = 121,
    ["Helm Unittest Test Suite"] = 123,
    Hugo = 666,
    ["IBM Zapp document"] = 276,
    ["IBM zCodeFormatSettings"] = 277,
    ["IMG Catapult PSP"] = 282,
    Istanbul = 691,
    ["JDownloader2 crawler multi-rules"] = 292,
    ["JDownloader2 crawler single-rules"] = 291,
    ["JFrog Applications Config"] = 293,
    ["JFrog File Spec"] = 294,
    ["JFrog Pipelines YML DSL"] = 697,
    ["JMeter DSL cli config"] = 295,
    JReleaser = 297,
    ["JSON Document Transform"] = 304,
    ["JSON Feed"] = 305,
    ["JSON Resume"] = 454,
    ["JSON Schema Draft 2020-12"] = 578,
    ["JSON Schema Draft 4"] = 575,
    ["JSON Schema Draft 7"] = 576,
    ["JSON Schema Draft 7 (unofficial strict)"] = 734,
    ["JSON Schema Draft 8 (2019-09)"] = 577,
    ["JSON-API"] = 303,
    ["JSON-e templates"] = 636,
    ["JSON-stat 2.0"] = 572,
    JSONPatch = 307,
    Jasmine = 287,
    Jekyll = 288,
    ["Jenkins X Pipelines"] = 289,
    ["Jenkins X Requirements"] = 290,
    ["Jovo Language Models"] = 296,
    ["KSP-AVC"] = 573,
    ["KSP-CKAN"] = 574,
    ["Karakum configuration file"] = 234,
    Kas = 310,
    ["Keycloak REST API"] = 704,
    ["Knative Functions - func.yaml"] = 235,
    ["KoDE/CI build.yaml"] = 693,
    ["Kong DBLess config"] = 694,
    KrakenD = 311,
    LOOBin = 328,
    Lefthook = 319,
    ["LinkML Metamodel"] = 326,
    Liquibase = 643,
    ["Liquibase Flow File"] = 644,
    ["Lively Properties"] = 327,
    ["MS2Rescore Configuration"] = 360,
    Markdownlint = 647,
    ["Mason Registry"] = 649,
    ["MegaLinter configuration"] = 334,
    ["MegaLinter descriptor"] = 335,
    ["Meltano plugin discovery definition"] = 337,
    ["Meltano project definition"] = 336,
    ["Microsoft Band Web Tile"] = 338,
    ["Minecraft Data Pack Advancement"] = 340,
    ["Minecraft Data Pack Biome"] = 341,
    ["Minecraft Data Pack Configured Carver"] = 342,
    ["Minecraft Data Pack Damage Type"] = 343,
    ["Minecraft Data Pack Dimension"] = 345,
    ["Minecraft Data Pack Dimension Type"] = 344,
    ["Minecraft Data Pack Item Modifier"] = 346,
    ["Minecraft Data Pack Loot Table"] = 347,
    ["Minecraft Data Pack Metadata"] = 348,
    ["Minecraft Data Pack Predicate"] = 349,
    ["Minecraft Data Pack Recipe"] = 350,
    ["Minecraft Data Pack Tag"] = 351,
    ["Minecraft Data Pack Template Pool"] = 352,
    ["Minecraft Data Pack Trim Material"] = 357,
    ["Minecraft Data Pack Trim Pattern"] = 358,
    ["Minecraft Resource Pack Lang"] = 353,
    ["Minecraft Resource Pack Particle"] = 354,
    ["Minecraft Resource Pack Texture Mcmeta"] = 356,
    ["Minecraft Resourcepack Sounds"] = 355,
    ["MkDocs Configuration 1.0"] = 359,
    ["MongoDB Atlas Search Index Definition"] = 692,
    ["Monika Configuration"] = 690,
    ["Motif config"] = 595,
    ["NOX Framework (Service)"] = 374,
    ["Netin Diagnostic System Template"] = 653,
    ["Netlify config"] = 365,
    ["Nexus-as-Code Data Model"] = 366,
    ["Nightwatch.js"] = 367,
    ["ONe's service descriptor"] = 387,
    ["OSS Review Toolkit configuration"] = 394,
    ["OSS Review Toolkit curation"] = 395,
    ["OSS Review Toolkit package configuration"] = 396,
    ["OSS Review Toolkit repository configuration"] = 397,
    ["OSS Review Toolkit resolutions"] = 398,
    Opctl = 598,
    ["OpenRewrite Resource"] = 389,
    ["OpenWeather Current Weather API"] = 635,
    ["OpenWeather Road Risk API"] = 634,
    ["Ory Hydra configuration"] = 275,
    ["Ory Keto configuration"] = 313,
    ["Ory Kratos configuration"] = 393,
    ["Ory Oathkeeper configuration"] = 381,
    ["Outblocks App configuration"] = 391,
    ["Outblocks database table"] = 392,
    ["Outblocks project configuration"] = 390,
    Packer = 401,
    Pantsbuild = 711,
    ["Paper paper-plugin.yml"] = 402,
    ["Pipeline component"] = 645,
    ["PocketMine plugin.yml"] = 407,
    ["Postman collection"] = 412,
    ["Problem package generators"] = 419,
    Pterodactyl = 687,
    ["Pull Request Labeler"] = 434,
    Pulumi = 440,
    PyProject = 441,
    Pyright = 442,
    Qgoda = 443,
    Qodana = 663,
    ["Quali Torque Blueprint Spec 2"] = 685,
    ["QueryFirst config file"] = 707,
    ["RKE Cluster Configuration JSON"] = 642,
    ["RKE Cluster Configuration YAML"] = 641,
    ["Rancher Fleet"] = 437,
    Ray = 610,
    ["Read the Docs"] = 439,
    ["Red-DiscordBot Cog"] = 444,
    ["Red-DiscordBot Cog Repo"] = 445,
    ["Red-DiscordBot Trivia"] = 446,
    Renovate = 455,
    ["Replit config"] = 449,
    RoadRunner = 456,
    Ruff = 452,
    ["Rust Project"] = 453,
    ["Rust toolchain"] = 458,
    ["SIL Kit Participant Configuration"] = 489,
    ["SIL Kit Registry Configuration"] = 490,
    SWADL = 513,
    ["Safebox Config"] = 698,
    ["Sapphire CLI Config"] = 461,
    ["SauceCTL Configuration"] = 650,
    ["Schema Catalog"] = 475,
    ["Scoop manifest"] = 480,
    ["Semantic Data Fabric (SDF) file"] = 481,
    ["Semgrep Rule"] = 483,
    ["Serenity Code Generator (Sergen)"] = 484,
    ["Serverless Framework Configuration"] = 657,
    ["Serverless Workflow"] = 659,
    ["Settings.paf"] = 486,
    ["Shopware 6 Configuration"] = 660,
    ["Shopware CLI Extension Store Configuration"] = 661,
    ["Shopware CLI Project Store Configuration"] = 662,
    ["Sigrid scope configuration file"] = 488,
    ["Slack app manifest"] = 492,
    Solidarity = 495,
    ["Solution filters"] = 496,
    ["Source Maps v3"] = 497,
    Sourcery = 498,
    SpecIF = 499,
    ["Sponge Mixin configuration"] = 500,
    ["StackHawk Scanner Configuration"] = 656,
    Stale = 505,
    ["Starlake Data Pipeline"] = 632,
    Starship = 506,
    ["Statamic Blueprint"] = 507,
    ["StrmPrivacy Data Connector"] = 702,
    ["StrmPrivacy Data Contract"] = 703,
    ["StrmPrivacy SimpleSchema"] = 700,
    ["StrmPrivacy Stream"] = 701,
    ["StrmPrivacy batch job configuration file"] = 699,
    ["Stryker Mutator"] = 510,
    ["StyleCop Analyzers Configuration"] = 511,
    ["Swagger API 2.0"] = 514,
    TSON = 538,
    ["Talisman configuration"] = 516,
    ["Taskfile config"] = 637,
    Taurus = 517,
    ["TestEnvironment.json"] = 526,
    ["Tier.run pricing.json"] = 520,
    Tikibase = 521,
    ["Traefik v2"] = 529,
    ["Traefik v2 File Provider"] = 530,
    Turborepo = 527,
    Tye = 664,
    ["UET BuildConfig.json"] = 708,
    ["UI5 Manifest"] = 545,
    ["UTAM Page Object"] = 548,
    ["Ubuntu Server Autoinstall"] = 543,
    ["Uniswap Token List"] = 620,
    ["Unreal Engine Uplugin"] = 709,
    ["Unreal Engine Uproject"] = 710,
    Updatecli = 671,
    Uplift = 706,
    ["User Journey Map"] = 640,
    V2Ray = 675,
    ["VSCode Code Snippets"] = 139,
    ["VSIX CLI publishing"] = 561,
    ["Vela Pipeline Configuration"] = 551,
    Vercel = 138,
    Visivo = 735,
    ["Web App Manifest"] = 568,
    ["Web types"] = 571,
    WebExtensions = 567,
    ["Webman package recipe"] = 681,
    ["Windows Package Manager Installer Manifest"] = 617,
    ["Windows Package Manager Locale Manifest"] = 618,
    ["Windows Package Manager Singleton Manifest"] = 616,
    ["Woodpecker pipeline config"] = 652,
    ["Xstate Machine"] = 669,
    ["Yippee-Ki-JSON configuration YML"] = 622,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 65,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 717,
    ["bashly-strings.yml"] = 718,
    ["bashly.yml"] = 716,
    ["batect.yml"] = 64,
    ...
    ["bozr.suite.json"] = 78,
    bpkg = 719,
    ["browser.i18n.json"] = 79,
    bucklescript = 80,
    ["bundleconfig.json"] = 85,
    ["chisel-slices.json"] = 156,
    ["chrome-extension-locales-messages.json"] = 146,
    ["chutzpah.json"] = 147,
    clangd = 128,
    clib = 129,
    ["cloud-init: cloud-config userdata"] = 131,
    ["cloud-sdk-pipeline-configuration"] = 149,
    ["cloudbuild.json"] = 150,
    cloudify = 130,
    codemagic = 132,
    ["coffeelint.json"] = 158,
    ["commands.json"] = 142,
    ["compile_commands.json"] = 141,
    ["compilerconfig.json"] = 140,
    ["completely.yml"] = 714,
    ["component-detection-manifest.json"] = 161,
    ["component.json"] = 160,
    ["composer.json"] = 159,
    ["config.yaml"] = 438,
    ["contentmanifest.json"] = 148,
    ["contribute.json"] = 162,
    ["cosmos.config.json"] = 144,
    ["crowdin.yml"] = 163,
    cspell = 169,
    ["custom-elements.json"] = 728,
    ["cypress.json"] = 167,
    ["datalogic-scan2deploy-android"] = 176,
    ["datalogic-scan2deploy-ce"] = 177,
    ["dbt Project"] = 105,
    ["ddev-global"] = 178,
    ["ddev-project"] = 179,
    ["debugsettings.json"] = 180,
    ["dependabot-v2.json"] = 183,
    ["dependabot.json"] = 182,
    ["deployed-cli"] = 668,
    ["detekt.yml"] = 185,
    ["devcontainer.json"] = 134,
    devinit = 624,
    ["devspace.yaml"] = 689,
    djlint = 625,
    ["docfx.json"] = 189,
    ["docker sequencer"] = 188,
    ["docker-compose.yml"] = 623,
    ["dockerd.json"] = 187,
    ["dotnet Release Index manifest"] = 198,
    ["dotnetcli.host.json"] = 199,
    ["dprint.json"] = 200,
    ["drone.json"] = 201,
    ["dss-2.0.0.json"] = 203,
    ["dstack configuration"] = 204,
    ["dvc.yaml"] = 205,
    ["ecosystem.json"] = 210,
    eksctl = 211,
    ["electron-builder configuration file"] = 216,
    ["epr-manifest.json"] = 214,
    ["evcc.yaml"] = 217,
    ["ezd task runner"] = 219,
    ["fabric.mod.json"] = 222,
    ["first-timers-bot"] = 226,
    ...
    ["gitlab-ci"] = 250,
    ["global.json"] = 252,
    ["go-feature-flag Flag Configuration"] = 254,
    ["golangci-lint Configuration"] = 253,
    ["haxelib.json"] = 268,
    helmfile = 612,
    helmwave = 613,
    ["host-meta.json"] = 273,
    ...
    ["ide.host.json"] = 278,
    ["ifstate.conf"] = 279,
    ["imageoptimizer.json"] = 280,
    ["importmap.json"] = 283,
    ["ioBroker Configuration"] = 284,
    ["ioBroker JSON UI"] = 285,
    ["ioBroker Package manifest"] = 286,
    ["ize.toml"] = 705,
    ["jsconfig.json"] = 308,
    ["jscpd Configuration"] = 686,
    jsdoc = 609,
    ["k3d.yaml"] = 309,
    ["kontinuous-config.yaml"] = 315,
    ["kontinuous-values.yaml"] = 314,
    ["kustomization.yaml"] = 316,
    ["label-commenter-config.yml"] = 317,
    ["launchsettings.json"] = 318,
    lazydocker = 727,
    lazygit = 726,
    ["lego.json"] = 320,
    ["lerna.json"] = 321,
    ["lgtm.yml"] = 322,
    ["libman.json"] = 323,
    ["license-report-config.json"] = 324,
    ["linkinator.config.json"] = 325,
    ["local.settings.json"] = 330,
    ["localazy.json"] = 331,
    ["lotus.yaml"] = 329,
    ["lsdlschema.json"] = 332,
    ["madness.yml"] = 715,
    ["markdown-lint-check"] = 648,
    mboats = 655,
    ["micro-settings.json"] = 720,
    ["mimetypes.json"] = 339,
    ["mirrord config"] = 592,
    ["mta.yaml"] = 593,
    ["mtad.yaml"] = 594,
    ["mycode.json"] = 363,
    ["napari plugin manifest"] = 364,
    neoload = 604,
    ["nest-cli"] = 370,
    ["ninjs (News in JSON) 1.3"] = 369,
    ["ninjs (News in JSON) 2.0"] = 368,
    ["nlu.json"] = 371,
    ["nodemon.json"] = 373,
    ["noodl config"] = 654,
    now = 600,
    ...
    ["nswag.json"] = 379,
    ntangle = 380,
    ["nuclei-template.yaml"] = 377,
    ["nuget-project.json"] = 378,
    ["ocelot.json"] = 382,
    ["omnisharp.json"] = 383,
    ["openapi.json"] = 384,
    ["openfin.json"] = 388,
    ...
    ["ops.yaml"] = 386,
    ["package.json"] = 399,
    ["package.manifest"] = 400,
    ["pathfinder.yml"] = 403,
    ["pattern.json"] = 405,
    ["petstore-v1.0"] = 696,
    pgap_yaml_input_reader = 404,
    ["plagiarize-me.yaml"] = 409,
    ["plagiarize.yaml"] = 408,
    ["portman.json"] = 410,
    ["prettierrc.json"] = 417,
    ["prisma.yml"] = 418,
    ["project-1.0.0-beta3.json"] = 421,
    ["project-1.0.0-beta4.json"] = 422,
    ["project-1.0.0-beta5.json"] = 423,
    ["project-1.0.0-beta6.json"] = 424,
    ["project-1.0.0-beta8.json"] = 425,
    ["project-1.0.0-rc1.json"] = 426,
    ["project-1.0.0-rc2.json"] = 427,
    ["project.json"] = 420,
    ["prometheus.json"] = 428,
    ["prometheus.rules.json"] = 429,
    ["prometheus.rules.test.json"] = 430,
    ["proxies.json"] = 431,
    ["publiccode.yml"] = 432,
    ["pubspec.yaml"] = 433,
    ["pyrseas-0.8.json"] = 436,
    ["quilt.mod.json"] = 721,
    ["release drafter"] = 605,
    rtx = 451,
    rustfmt = 457,
    samt = 459,
    samtrc = 460,
    ["sarif-1.0.0.json"] = 462,
    ["sarif-2.0.0.json"] = 463,
    ["sarif-2.1.0"] = 473,
    ["sarif-2.1.0-rtm.2"] = 464,
    ["sarif-2.1.0-rtm.3"] = 466,
    ["sarif-2.1.0-rtm.4"] = 468,
    ["sarif-2.1.0-rtm.5"] = 470,
    ["sarif-2.1.0-rtm.6"] = 471,
    ["sarif-external-property-file-2.1.0"] = 474,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 465,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 467,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 469,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 472,
    ["schema.org - Action"] = 476,
    ["schema.org - ContactPoint"] = 477,
    ["schema.org - Place"] = 478,
    ["schema.org - Thing"] = 479,
    ["secrethub.yml"] = 723,
    ["semantic-release"] = 482,
    ["servicehub.config.json"] = 581,
    ["servicehub.service.json"] = 580,
    ["settings.job"] = 485,
    ["sfdx-hardis configuration"] = 487,
    ["size-limit configuration"] = 491,
    ["skaffold.yaml"] = 646,
    ["skyuxconfig.json"] = 493,
    snapcraft = 494,
    ["sqlc configuration"] = 502,
    ["stripe-app-local.json"] = 509,
    ["stripe-app.json"] = 508,
    swcrc = 633,
    syntax = 725,
    ["task.json"] = 515,
    taskcat = 601,
    ["template.json"] = 518,
    ["templatsources.json"] = 519,
    ["theme.json"] = 522,
    ["tizen_workspace.json"] = 523,
    tldr = 524,
    tmLanguage = 525,
    tmuxinator = 589,
    ["transcend.yml"] = 531,
    ["trunk.yaml"] = 532,
    ["ts-force-config.json"] = 536,
    ["tsconfig.json"] = 533,
    ["tsd.json"] = 534,
    ["tsdrc.json"] = 535,
    ["tslint.json"] = 537,
    ...
    ["vega-lite.json"] = 550,
    ["vega.json"] = 549,
    ["venvironment-basic.yaml"] = 553,
    ["venvironment.yaml"] = 552,
    ["version.json"] = 554,
    ["vim-addon-info"] = 555,
    ["vs-2017.3.host.json"] = 557,
    ["vs-nesting.json"] = 558,
    ["vsls.json"] = 556,
    ["vss-extension.json"] = 562,
    ["vtesttree.yaml"] = 563,
    ["vtestunit.yaml"] = 564,
    ["warp-keysets.json"] = 729,
    ["warp-themes.json"] = 730,
    ["warp-workflows.json"] = 731,
    ["webhint.io"] = 682,
    ["webjobpublishsettings.json"] = 570,
    ["webjobs-list.json"] = 569,
    ["xs-app.json"] = 597,
    ["xunit.runner.json"] = 579,
    yamllint = 621,
    zuul = 606,
    ["Žinoma"] = 615
  },
