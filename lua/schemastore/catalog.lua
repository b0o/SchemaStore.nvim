...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 790,
    [".nodehawkrc"] = 495,
    [".npmpackagejsonlintrc"] = 499,
    [".omletrc"] = 963,
    [".phrase.yml"] = 560,
    [".phraseapp.yml"] = 561,
    [".pmbot.yml"] = 548,
    [".postcssrc"] = 555,
    [".powerpages-web-template-manifest"] = 557,
    [".pre-commit-config.yml"] = 558,
    [".pre-commit-hooks.yml"] = 559,
    [".putout.json"] = 582,
    [".rehyperc"] = 605,
    [".remarkrc"] = 607,
    [".sprite files"] = 674,
    ...
    ["A micro editor config"] = 448,
    ABCInventoryModuleData = 14,
    ABCSupplyPlan = 15,
    AIConfig = 16,
    ["AMX Muse Program Descriptor"] = 1007,
    ["API Builder"] = 824,
    ["AVA Configuration"] = 886,
    ...
    ["Adobe UXP Manifest"] = 946,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    Air = 12,
    ["Airlock Microgateway"] = 17,
    ["Alacritty Configuration"] = 858,
    ["All Contributors configuration file"] = 911,
    ...
    ["Application list for a WinUtil"] = 989,
    ArchitectFX = 994,
    ["Argo Events"] = 31,
    ["Argo Workflows"] = 32,
    AssemblyScript = 35,
    ...
    ["Azure Pipelines"] = 68,
    ["Azure Static Web Apps CLI configuration file"] = 678,
    ["Azure Static Web Apps configuration file"] = 677,
    ["BOSH Deploy Config"] = 92,
    ["BX CI"] = 110,
    ["Bashly (bashly.yml)"] = 915,
    ["Bashly Settings (bashly-settings.yml)"] = 916,
    ["Better Code Hub"] = 828,
    ["Better Scripts"] = 111,
    Bigconfig = 85,
    ["Biome Formatter Config"] = 55,
    ["Bitmovin Encoding Template"] = 1000,
    BizTalkServerApplicationSchema = 796,
    Bleep = 112,
    ...
    ["Butane Config"] = 871,
    C4InterFlow = 1015,
    ["CGS Card Game Specification (cgs.json)"] = 951,
    ["CICS TS region tagging"] = 880,
    ["CICS TS resource import"] = 881,
    ["CICS TS resource model"] = 882,
    ["CICS TS resource overrides"] = 883,
    ["CMake Presets"] = 113,
    ["CNC Codes"] = 129,
    ["CRS WAF test file"] = 979,
    ["CRS WAF test platform overrides file"] = 980,
    ...
    ["Chamaleon environment"] = 1004,
    ["Chamaleon properties"] = 1005,
    ["Chamaleon template"] = 1003,
    Changesets = 212,
    Charmcraft = 122,
    Cheatsheets = 868,
    ...
    CityJSON = 125,
    ["Clawject config"] = 135,
    ["Cloud Foundry Application Manifest"] = 962,
    ["Cloud Run Spec v1"] = 984,
    ...
    Concord = 978,
    ["Configu .cfgu files"] = 967,
    ["Configu .configu file"] = 968,
    Conjure = 128,
    ...
    ["Custom Machinery Machine"] = 952,
    ["Custom Machinery Recipe"] = 953,
    ...
    ["DataYoga Job"] = 140,
    ["Databricks Asset Bundles"] = 932,
    ["Datadog Service Definition"] = 421,
    ["Datadog Software Catalog"] = 422,
    ["Datahub Ingestion Recipe"] = 887,
    ["Dein Config"] = 146,
    ...
    ["DonateCaseBetterCasino menu"] = 1008,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 923,
    ["EAS config"] = 287,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 912,
    ["EasyVCR .NET"] = 288,
    ["Eidolon Resource"] = 995,
    ...
    ["GeoJSON.json latest"] = 875,
    GherKing = 879,
    ["GitHub Action"] = 318,
    ["GitHub Actions typing"] = 991,
    ...
    ["Goreleaser Pro"] = 347,
    Goss = 348,
    ["Gradle Build Cache Node"] = 826,
    ["Gradle Enterprise"] = 825,
    ...
    Hadolint = 806,
    Hammerkit = 836,
    ["Hardware Sentry Configuration"] = 891,
    Hatch = 807,
    Hayson = 361,
    ...
    ["Homer dashboard configuration"] = 364,
    Hugo = 867,
    ["Hugo Theme"] = 866,
    ["Hyperfoil benchmark configuration"] = 370,
    ["IBM Zapp document"] = 371,
    ["IBM zCodeFormatSettings"] = 372,
    ["IMG Catapult PSP"] = 377,
    ["IVMS101 by CODE Protocol"] = 949,
    Infrahub = 379,
    Istanbul = 894,
    ["JDownloader2 crawler multi-rules"] = 389,
    ["JDownloader2 crawler single-rules"] = 388,
    ["JFrog Applications Config"] = 390,
    ["JFrog File Spec"] = 391,
    ["JFrog Pipelines YML DSL"] = 900,
    ["JMeter DSL cli config"] = 392,
    JReleaser = 394,
    ["JSON Document Transform"] = 402,
    ["JSON Feed"] = 403,
    ["JSON Resume"] = 612,
    ["JSON Schema Draft 2020-12"] = 776,
    ["JSON Schema Draft 4"] = 773,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 933,
    ["JSON Schema Draft 7"] = 774,
    ["JSON Schema Draft 7 (unofficial strict)"] = 934,
    ["JSON Schema Draft 8 (2019-09)"] = 775,
    ["JSON-API"] = 401,
    ["JSON-e templates"] = 833,
    ["JSON-stat 2.0"] = 769,
    JSONPatch = 405,
    ["JSR Package Config (jsr.json)"] = 395,
    Jasmine = 383,
    Jekyll = 384,
    ["Jenkins X Pipelines"] = 385,
    ["Jenkins X Requirements"] = 386,
    Jest = 387,
    ["Jovo Language Models"] = 393,
    ["KIMMDY config file"] = 416,
    ["KODE/CI build.yaml"] = 896,
    ["KSP-AVC"] = 770,
    ["KSP-CKAN"] = 771,
    ["KSP-NetKAN"] = 772,
    KSY = 961,
    ...
    Kas = 408,
    ["Kestra flow file"] = 417,
    ["Keycloak REST API"] = 903,
    ["Knative Functions - func.yaml"] = 307,
    ["Kometa (nightly) config file"] = 419,
    ["Kometa config file"] = 418,
    ["Kong DBLess config"] = 897,
    KrakenD = 420,
    ["Kubri Configuration"] = 426,
    LOOBin = 441,
    ...
    ["Language configuration"] = 971,
    Lefthook = 430,
    ["Liferay client-extension.yaml"] = 437,
    ["LinkML Metamodel"] = 439,
    Liquibase = 842,
    ["Liquibase Flow File"] = 843,
    ["Lively Properties"] = 440,
    ["Lobe AI Agent"] = 66,
    Loki = 67,
    ["MLOS Configs"] = 479,
    ["MS2Rescore Configuration"] = 482,
    ["Madness (madness.yml)"] = 914,
    ["MapEHR Mapping"] = 447,
    Markdownlint = 846,
    ["Mason Registry"] = 849,
    ["MegaLinter configuration"] = 449,
    ["MegaLinter descriptor"] = 450,
    Melange = 940,
    ["Meltano project definition"] = 451,
    ["Mergify Configuration"] = 483,
    ["Metadata for a Bazel module"] = 452,
    ["Metadata for a Cinnamon spice"] = 987,
    ["Metatype Configuration"] = 453,
    ["MetricsHub Configuration"] = 454,
    ["MetricsHub Connector Configuration"] = 455,
    ["Micro Editor Syntax"] = 924,
    ["Microsoft Band Web Tile"] = 456,
    ["Microsoft RulesEngine workflow rules"] = 975,
    ["Microsoft RulesEngine workflow rules list"] = 976,
    ["Minecraft Custom Main Menu Mod"] = 941,
    ["Minecraft Data Pack Advancement"] = 458,
    ["Minecraft Data Pack Biome"] = 459,
    ["Minecraft Data Pack Configured Carver"] = 460,
    ["Minecraft Data Pack Damage Type"] = 461,
    ["Minecraft Data Pack Dimension"] = 463,
    ["Minecraft Data Pack Dimension Type"] = 462,
    ["Minecraft Data Pack Item Modifier"] = 464,
    ["Minecraft Data Pack Loot Table"] = 465,
    ["Minecraft Data Pack Metadata"] = 466,
    ["Minecraft Data Pack Predicate"] = 467,
    ["Minecraft Data Pack Recipe"] = 468,
    ["Minecraft Data Pack Tag"] = 469,
    ["Minecraft Data Pack Template Pool"] = 470,
    ["Minecraft Data Pack Trim Material"] = 475,
    ["Minecraft Data Pack Trim Pattern"] = 476,
    ["Minecraft Resource Pack Lang"] = 471,
    ["Minecraft Resource Pack Particle"] = 472,
    ["Minecraft Resource Pack Texture Mcmeta"] = 474,
    ["Minecraft Resourcepack Sounds"] = 473,
    ["Monade CLI Stack Configuration"] = 486,
    ["MongoDB Atlas Search Index Definition"] = 895,
    ["Monika Configuration"] = 893,
    ["Monoweave Configuration"] = 481,
    ["Motif config"] = 789,
    MultiQC = 1023,
    ["NOX Framework (Service)"] = 498,
    ["Netin Diagnostic System Template"] = 853,
    ["Netlify config"] = 489,
    ["Network-as-Code Data Model"] = 490,
    ["Nightwatch.js"] = 491,
    ["NueJS configuration file"] = 503,
    ["Nuitka.yaml"] = 954,
    ["Nullstone config"] = 505,
    ["ONe's changelog entry"] = 519,
    ["ONe's service descriptor"] = 518,
    ["OSCAL Assessment Plan (AP)"] = 527,
    ["OSCAL Assessment Results (AR)"] = 528,
    ["OSCAL Catalog"] = 529,
    ["OSCAL Component Definition (CDef)"] = 530,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 531,
    ["OSCAL Profile"] = 532,
    ["OSCAL System Security Plan (SSP)"] = 533,
    ["OSS Review Toolkit configuration"] = 534,
    ["OSS Review Toolkit curation"] = 535,
    ["OSS Review Toolkit package configuration"] = 536,
    ["OSS Review Toolkit repository configuration"] = 537,
    ["OSS Review Toolkit resolutions"] = 538,
    ["October CMS columns"] = 509,
    ["October CMS fields"] = 510,
    Okteto = 511,
    Opctl = 792,
    ...
    ["OpenUtau ustx"] = 516,
    ["OpenWeather Current Weather API"] = 832,
    ["OpenWeather Road Risk API"] = 831,
    ["Ory Hydra configuration"] = 369,
    ["Ory Keto configuration"] = 423,
    ["Ory Kratos configuration"] = 526,
    ["Ory Oathkeeper configuration"] = 507,
    ["Outblocks App configuration"] = 524,
    ["Outblocks database table"] = 525,
    ["Outblocks project configuration"] = 523,
    PDM = 544,
    Packer = 541,
    Pantsbuild = 910,
    ["Paper paper-plugin.yml"] = 542,
    ["Pipeline component"] = 844,
    ["Plex Prerolls"] = 552,
    ["PocketMine plugin.yml"] = 549,
    ["Postman collection"] = 556,
    ["Preset list for a WinUtil"] = 990,
    ["Problem object RFC9457"] = 938,
    ["Problem package generators"] = 565,
    Pterodactyl = 890,
    ["Pull Request Labeler"] = 581,
    Pulumi = 589,
    ["PyGTA Config"] = 585,
    PyProject = 590,
    Pyright = 591,
    ["Python script metadata"] = 1025,
    Qgoda = 593,
    Qodana = 863,
    ["Qt Creator workspace file"] = 969,
    ["Quali Torque Blueprint Spec 2"] = 888,
    ["QueryFirst config file"] = 906,
    ["RKE Cluster Configuration JSON"] = 841,
    ["RKE Cluster Configuration YAML"] = 840,
    RadioHound = 584,
    Railway = 594,
    ["Rancher Fleet"] = 586,
    ["Rattler-build"] = 595,
    Ray = 805,
    ["Read the Docs"] = 588,
    ["Red-DiscordBot Cog"] = 602,
    ["Red-DiscordBot Cog Repo"] = 603,
    ["Red-DiscordBot Trivia"] = 604,
    ["Render Blueprints"] = 839,
    RenderCV = 614,
    Renovate = 613,
    ["Replit config"] = 608,
    Restate = 1018,
    RoadRunner = 616,
    ["Rudder techniques"] = 944,
    Ruff = 610,
    ["Rust Project"] = 611,
    ["Rust toolchain"] = 620,
    ["SDMX data message"] = 646,
    ["SDMX metadata message"] = 645,
    ["SDMX structure message"] = 644,
    ["SIL Kit Participant Configuration"] = 656,
    ["SIL Kit Registry Configuration"] = 657,
    ["SPDX 2.3"] = 675,
    SWADL = 689,
    ["Safebox Config"] = 901,
    ["Sapphire CLI Config"] = 623,
    ["SauceCTL Configuration"] = 850,
    ["Schema Catalog"] = 638,
    ["Scoop manifest"] = 643,
    ["Semantic Data Fabric (SDF) file"] = 647,
    ["Semgrep Rule"] = 649,
    ["Serenity Code Generator (Sergen)"] = 650,
    ["Serverless Framework Configuration"] = 857,
    ["Serverless Workflow"] = 859,
    ["Settings for a Cinnamon spice"] = 986,
    ["Settings.paf"] = 652,
    ["Shopware 6 Configuration"] = 860,
    ["Shopware CLI Extension Store Configuration"] = 861,
    ["Shopware CLI Project Store Configuration"] = 862,
    ["Sigma Detection Rule"] = 654,
    ["Sigrid scope configuration file"] = 655,
    ["SkyPilot Task JSON"] = 945,
    ["Slack app manifest"] = 659,
    Solidarity = 664,
    ["Solution filters"] = 665,
    ["Source Maps v3"] = 666,
    Sourcery = 667,
    ["Speakeasy Generation Config File"] = 671,
    ["Speakeasy Lint Configuration File"] = 668,
    ["Speakeasy Test Generation Configuration File"] = 669,
    ["Speakeasy Workflow File"] = 670,
    SpecIF = 672,
    ["Sponge Mixin configuration"] = 673,
    StackBlitz = 679,
    ["StackHawk Scanner Configuration"] = 856,
    Stale = 680,
    ["Starlake Data Pipeline"] = 829,
    Starship = 681,
    ["Statamic Blueprint"] = 682,
    ["Stella configuration file"] = 683,
    ["Stryker Mutator"] = 686,
    ["StyleCop Analyzers Configuration"] = 687,
    ["Stylelint (.stylelintrc)"] = 688,
    ["Sublime Syntax"] = 902,
    ["Subsquid squid manifest"] = 947,
    ["Swagger API 2.0"] = 690,
    ["Synadia Connect Component"] = 691,
    TSON = 725,
    TSTyche = 726,
    ["Tab data for a LinUtil"] = 993,
    ["Tab list for a LinUtil"] = 992,
    Tach = 692,
    ["Tach Domain"] = 693,
    Talhelper = 695,
    ["Talisman configuration"] = 696,
    ["Taskfile config"] = 834,
    Taurus = 697,
    Tauticord = 698,
    Telefonistka = 1019,
    ["TestEnvironment.json"] = 708,
    ["TextMate Grammar"] = 707,
    ["Tier.run pricing.json"] = 701,
    Tikibase = 702,
    Tombi = 706,
    ["Traefik v2"] = 711,
    ["Traefik v2 File Provider"] = 712,
    ["Traefik v3"] = 713,
    ["Traefik v3 File Provider"] = 714,
    ["Travis CI (.travis.yml)"] = 710,
    Trident = 1017,
    ["TrueScript for *.tscript files"] = 717,
    ["Tugboat QA config.yml"] = 1014,
    TunnelHub = 937,
    Turborepo = 709,
    Tycho = 982,
    Tye = 864,
    ["Tyk Gateway - Open Source v5.7+"] = 1024,
    ["UET BuildConfig.json"] = 907,
    ["UI5 Manifest"] = 735,
    ["UNCORS configuration"] = 739,
    ["UTAM Page Object"] = 738,
    ["Ubuntu Server Autoinstall"] = 733,
    ["Uniswap Token List"] = 817,
    ["Universal Schedule Format"] = 740,
    ["Unreal Engine Uplugin"] = 908,
    ["Unreal Engine Uproject"] = 909,
    ["Updatecli Compose"] = 872,
    ["Updatecli Policy Manifest"] = 873,
    ["Updatecli Policy Metadata"] = 874,
    Uplift = 905,
    ["User Journey Map"] = 838,
    V2Ray = 878,
    ["VSCode Code Snippets"] = 187,
    ["VSIX CLI publishing"] = 758,
    Vector = 742,
    ["Vela Pipeline Configuration"] = 745,
    Vercel = 186,
    ["Version Bumper config"] = 748,
    ["Viash Component Config"] = 1021,
    ["Viash Package Config"] = 1022,
    Visivo = 935,
    Wake = 1016,
    ["Waku Config"] = 996,
    ["Web App Manifest"] = 764,
    ["Web types"] = 767,
    WebExtensions = 763,
    ["Webman package recipe"] = 884,
    ["Windows Package Manager Installer Manifest"] = 813,
    ["Windows Package Manager Locale Manifest"] = 814,
    ["Windows Package Manager Singleton Manifest"] = 812,
    Winutil = 815,
    ["WireMock stub mapping"] = 999,
    ["Woodpecker pipeline config"] = 852,
    ["Wrangler CLI"] = 768,
    ["Xstate Machine"] = 870,
    ["Yandex Workflow Language"] = 988,
    ["Yarn Config (.yarnrc.yml)"] = 827,
    ["Yippee-Ki-JSON configuration YML"] = 819,
    ["YouTrack App"] = 985,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 18,
    apko = 939,
    ...
    ["behat.yml"] = 94,
    ["bigquery-table"] = 84,
    ["bioimageio resource description"] = 955,
    ...
    ["crowdin.yml"] = 220,
    ["ctfd-setup configuration file"] = 1006,
    ["custom-elements.json"] = 927,
    ["cypress.json"] = 224,
    ...
    ["gematik health care insurance list"] = 1012,
    ["gematik health care patient list"] = 1009,
    ["gematik health care provider institution list"] = 1011,
    ["gematik health care provider list"] = 1010,
    ["gematik tiger test environment configuration"] = 1013,
    ["gitlab-ci"] = 326,
    ["global.json"] = 342,
    ...
    ["ide.host.json"] = 373,
    ["ifstate.conf"] = 374,
    ["imageoptimizer.json"] = 375,
    ["importmap.json"] = 378,
    ["ioBroker Configuration"] = 380,
    ["ioBroker JSON UI"] = 381,
    ["ioBroker Package manifest"] = 382,
    ["ize.toml"] = 904,
    ["jsconfig.json"] = 406,
    ["jscpd Configuration"] = 889,
    jsdoc = 804,
    ["k3d.yaml"] = 407,
    ["k9s aliases.yaml"] = 409,
    ["k9s cluster-config.yaml"] = 411,
    ["k9s config.yaml"] = 410,
    ["k9s hotkeys.yaml"] = 412,
    ["k9s plugins.yaml"] = 413,
    ["k9s skin.yaml"] = 414,
    ["k9s views.yaml"] = 415,
    ["kontinuous-config.yaml"] = 425,
    ["kontinuous-values.yaml"] = 424,
    ["kustomization.yaml"] = 427,
    ["label-commenter-config.yml"] = 428,
    ["latexindent configuration"] = 65,
    ["launchsettings.json"] = 429,
    lazydocker = 926,
    lazygit = 925,
    ["lego.json"] = 431,
    ["lerna.json"] = 432,
    ["lgtm.yml"] = 433,
    ["liblab.config.json"] = 434,
    ["libman.json"] = 435,
    ["license-report-config.json"] = 436,
    ["linkinator.config.json"] = 438,
    ["lint-staged (.lintstagedrc)"] = 784,
    ["local.settings.json"] = 443,
    ["localazy.json"] = 444,
    ["lotus.yaml"] = 442,
    ["lsdlschema.json"] = 445,
    ["markdown-link-check"] = 847,
    maturin = 848,
    mboats = 855,
    ["micro-settings.json"] = 919,
    ["mimetypes.json"] = 457,
    ["mirrord config"] = 785,
    mise = 786,
    ["mkdocs.yml"] = 477,
    ["monospace.yml"] = 480,
    ["moon.yml"] = 998,
    ["mprocs Configuration file"] = 970,
    ["mrdocs.yml"] = 478,
    ["mta.yaml"] = 787,
    ["mtad.yaml"] = 788,
    ["mycode.json"] = 487,
    ["napari plugin manifest"] = 488,
    neoload = 799,
    ["nest-cli"] = 493,
    ["ninjs (News in JSON)"] = 492,
    ["nitro.json"] = 798,
    ["nixd configuration"] = 943,
    ["nlu.json"] = 494,
    ["nodemon.json"] = 496,
    ["noodl config"] = 854,
    ["notebook.mod.json"] = 497,
    now = 794,
    ["npm-badges"] = 500,
    ["nswag.json"] = 504,
    ntangle = 506,
    ["nuclei-template.yaml"] = 501,
    ["nuget-project.json"] = 502,
    ["ocelot.json"] = 508,
    ["omnisharp.json"] = 512,
    ["openapi.json"] = 513,
    ["openfin.json"] = 520,
    ...
    ["ops.yaml"] = 517,
    ["package.json"] = 539,
    ["package.manifest"] = 540,
    ["partial-black.json"] = 95,
    ["pathfinder.yml"] = 543,
    ["pattern.json"] = 546,
    ["petstore-v1.0"] = 899,
    pgap_yaml_input_reader = 545,
    ["pixi.toml"] = 547,
    ["plagiarize-me.yaml"] = 551,
    ["plagiarize.yaml"] = 550,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1002,
    ["podbard.yaml"] = 553,
    ["portman.json"] = 554,
    ["prefect.toml"] = 562,
    ["prettierrc.json"] = 563,
    ["prisma.yml"] = 564,
    ["project-1.0.0-beta3.json"] = 567,
    ["project-1.0.0-beta4.json"] = 568,
    ["project-1.0.0-beta5.json"] = 569,
    ["project-1.0.0-beta6.json"] = 570,
    ["project-1.0.0-beta8.json"] = 571,
    ["project-1.0.0-rc1.json"] = 572,
    ["project-1.0.0-rc2.json"] = 573,
    ["project.json"] = 566,
    ["project.owasp.yaml"] = 574,
    ["prometheus.json"] = 575,
    ["prometheus.rules.json"] = 576,
    ["prometheus.rules.test.json"] = 577,
    ["proxies.json"] = 578,
    ["publiccode.yml"] = 579,
    ["pubspec.yaml"] = 580,
    ["pyrseas-0.8.json"] = 583,
    pytest = 592,
    ["quilt.mod.json"] = 920,
    ["rc3 auth"] = 596,
    ["rc3 collection"] = 597,
    ...
    samt = 621,
    samtrc = 622,
    ["sarif-1.0.0.json"] = 624,
    ["sarif-2.0.0.json"] = 625,
    ["sarif-2.1.0"] = 635,
    ["sarif-2.1.0-rtm.2"] = 626,
    ["sarif-2.1.0-rtm.3"] = 628,
    ["sarif-2.1.0-rtm.4"] = 630,
    ["sarif-2.1.0-rtm.5"] = 632,
    ["sarif-2.1.0-rtm.6"] = 633,
    ["sarif-external-property-file-2.1.0"] = 636,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 627,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 629,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 631,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 634,
    ["scalingo.json configuration"] = 637,
    ["schema.org - Action"] = 639,
    ["schema.org - ContactPoint"] = 640,
    ["schema.org - Place"] = 641,
    ["schema.org - Thing"] = 642,
    ["secrethub.yml"] = 922,
    ["semantic-release"] = 648,
    ["servicehub.config.json"] = 779,
    ["servicehub.service.json"] = 778,
    ["settings.job"] = 651,
    ["sfdx-hardis configuration"] = 653,
    ["shard.yml"] = 958,
    ["size-limit configuration"] = 658,
    ["skaffold.yaml"] = 845,
    ["skyuxconfig.json"] = 660,
    snapcraft = 661,
    ["snowflake-config"] = 662,
    ["snowflake-connections"] = 663,
    ["spicepod.yaml"] = 977,
    ["sqlc configuration"] = 676,
    ["stripe-app-local.json"] = 685,
    ["stripe-app.json"] = 684,
    swcrc = 830,
    ["task.json"] = 694,
    taskcat = 795,
    ["template.json"] = 699,
    ["templatsources.json"] = 700,
    ["theme.json"] = 703,
    ["tizen_workspace.json"] = 704,
    tldr = 705,
    tmuxinator = 782,
    ["transcend.yml"] = 715,
    ...
    ["vega-lite.json"] = 744,
    ["vega.json"] = 743,
    ["venvironment-basic.yaml"] = 747,
    ["venvironment.yaml"] = 746,
    version = 1020,
    ["version.json"] = 749,
    ["vhwdebugger-binding.yaml"] = 751,
    ["vim-addon-info"] = 752,
    ["vs-2017.3.host.json"] = 754,
    ["vs-nesting.json"] = 755,
    ["vsls.json"] = 753,
    ["vss-extension.json"] = 759,
    vtcfg = 1026,
    ["vtesttree.yaml"] = 760,
    ["vtestunit.yaml"] = 761,
    ["warp-keysets.json"] = 928,
    ["warp-themes.json"] = 929,
    ["warp-workflows.json"] = 930,
    ["webhint.io"] = 885,
    ["webjobpublishsettings.json"] = 766,
    ["webjobs-list.json"] = 765,
    ["well-known-fursona"] = 965,
    ["xs-app.json"] = 791,
    ["xunit.runner.json"] = 777,
    yamllint = 818,
    ["zerops.io import file"] = 974,
    ["zerops.yml"] = 973,
    zuul = 801,
    ["Žinoma"] = 811
  },
