...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 158,
    [".cryproj (generic)"] = 546,
    [".cryproj engine-5.2"] = 541,
    [".cryproj engine-5.3"] = 542,
    [".cryproj engine-5.4"] = 543,
    [".cryproj engine-5.5"] = 544,
    [".cryproj engine-dev"] = 545,
    [".csscomb.json"] = 160,
    [".csslintrc"] = 161,
    [".es6importsorterrc.json"] = 669,
    [".eslintrc"] = 206,
    [".esmrc.json"] = 198,
    [".ffizer.yaml"] = 210,
    [".htmlhintrc"] = 254,
    ...
    ["Azure Pipelines"] = 48,
    ["Azure Static Web Apps CLI configuration file"] = 463,
    ["Azure Static Web Apps configuration file"] = 462,
    ["BX CI"] = 83,
    ["Better Code Hub"] = 589,
    ["Better Scripts"] = 84,
    BizTalkServerApplicationSchema = 561,
    ...
    ["Butane Config"] = 628,
    ["CICS TS region tagging"] = 635,
    ["CICS TS resource import"] = 636,
    ["CICS TS resource model"] = 637,
    ["CICS TS resource overrides"] = 638,
    ["CMake Presets"] = 85,
    ...
    ["Datahub Ingestion Recipe Schema"] = 642,
    ...
    ["Embrace Config Schema"] = 653,
    ["Error pages"] = 201,
    Esquio = 199,
    ["Estuary Flow Catalog Schema"] = 632,
    ["Expo SDK"] = 204,
    ...
    Goreleaser = 236,
    ["Goreleaser Pro"] = 237,
    ["Gradle Build Cache Node"] = 586,
    ["Gradle Enterprise"] = 585,
    ...
    Hadolint = 570,
    Hammerkit = 596,
    ["Hardware Sentry Configuration"] = 646,
    Hayson = 249,
    ...
    ["JFrog File Spec"] = 273,
    ["JFrog Pipelines YML DSL"] = 655,
    ["JMeter DSL cli config schema"] = 274,
    JReleaser = 276,
    ["JSON Document Transform"] = 283,
    ["JSON Feed"] = 284,
    ["JSON Resume"] = 419,
    ["JSON Schema Draft 2020-12"] = 537,
    ["JSON Schema Draft 4"] = 534,
    ["JSON Schema Draft 7"] = 535,
    ["JSON Schema Draft 8"] = 536,
    ...
    ["KSP-CKAN"] = 533,
    Kas = 289,
    ["Keycloak REST API"] = 661,
    ["Knative Functions - func.yaml"] = 219,
    ["KoDE/CI build.yaml"] = 651,
    ["Kong DBLess Schema"] = 652,
    KrakenD = 290,
    LOOBin = 305,
    ["LinkML Metamodel"] = 303,
    Liquibase = 601,
    ["Liquibase Flow File"] = 602,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 650,
    ["Monika Configuration Schema"] = 648,
    ["Motif config"] = 554,
    ["NOX Framework (Service)"] = 347,
    ["Netin Diagnostic System Template"] = 611,
    ...
    ["OpenWeather Current Weather API"] = 593,
    ["OpenWeather Road Risk API"] = 592,
    ...
    Pyright = 408,
    Qodana = 621,
    ["Quali Torque Blueprint Spec 2"] = 643,
    ["QueryFirst config file"] = 664,
    ["RKE Cluster Configuration JSON Schema"] = 600,
    ["RKE Cluster Configuration YAML Schema"] = 599,
    ["Rancher Fleet"] = 404,
    Ray = 569,
    ["Read the Docs"] = 405,
    ...
    ["Rust Project"] = 418,
    ["Rust toolchain"] = 423,
    ["SIL Kit Participant Configuration"] = 450,
    SWADL = 472,
    ["Sapphire CLI Config"] = 424,
    ["SauceCTL Configuration"] = 608,
    ["Schema Catalog"] = 437,
    ["Scoop manifest"] = 442,
    ["Semantic Data Fabric (SDF) file"] = 443,
    ["Semgrep Rule"] = 445,
    ["Serenity Code Generator (Sergen)"] = 446,
    ["Serverless Framework Configuration"] = 615,
    ["Serverless Workflow Schema"] = 617,
    ["Settings.paf"] = 448,
    ["Shopware 6 Configuration"] = 618,
    ["Shopware CLI Extension Store Configuration"] = 619,
    ["Shopware CLI Project Store Configuration"] = 620,
    ["Slack app manifest"] = 452,
    Solidarity = 455,
    ["Solution filters"] = 456,
    ["Source Maps v3"] = 457,
    Sourcery = 458,
    SpecIF = 459,
    ["Sponge Mixin configuration"] = 460,
    ["StackHawk Scanner Configuration"] = 614,
    Stale = 464,
    Starship = 465,
    ["Statamic Blueprint"] = 466,
    ["StrmPrivacy Data Connector"] = 659,
    ["StrmPrivacy Data Contract"] = 660,
    ["StrmPrivacy SimpleSchema"] = 657,
    ["StrmPrivacy Stream"] = 658,
    ["StrmPrivacy batch job configuration file"] = 656,
    ["Stryker Mutator"] = 469,
    ["StyleCop Analyzers Configuration"] = 470,
    ["Swagger API 2.0"] = 473,
    TSON = 497,
    ["Talisman configuration"] = 475,
    ["Taskfile YAML Schema"] = 595,
    Taurus = 476,
    ["TestEnvironment.json"] = 485,
    ["Tier.run pricing.json"] = 479,
    Tikibase = 480,
    ["Traefik v2"] = 488,
    ["Traefik v2 File Provider"] = 489,
    Turborepo = 486,
    Tye = 622,
    ["UI5 Manifest"] = 504,
    ["UTAM Page Object"] = 507,
    ["Ubuntu Server Autoinstall"] = 502,
    ["Uniswap Token List"] = 578,
    ["Unreal Engine Uplugin"] = 665,
    ["Unreal Engine Uproject"] = 666,
    Updatecli = 629,
    Uplift = 663,
    ["User Journey Map YAML Schema"] = 598,
    V2Ray = 633,
    ["VSCode Code Snippets"] = 131,
    ["VSIX CLI publishing"] = 520,
    ["Vela Pipeline Configuration"] = 510,
    Vercel = 130,
    ["Web App Manifest"] = 527,
    ["Web types"] = 530,
    WebExtensions = 526,
    ["Webman package recipe"] = 639,
    ["Windows Package Manager Installer Manifest"] = 575,
    ["Windows Package Manager Locale Manifest"] = 576,
    ["Windows Package Manager Singleton Manifest"] = 574,
    ["Woodpecker pipeline config"] = 610,
    ["Xstate Machine Schema"] = 627,
    ["Yippee-Ki-JSON configuration YML"] = 580,
    ["angular.json"] = 11,
    ...
    ["bamboo-spec"] = 59,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 671,
    ["bashly-strings.yml"] = 672,
    ["bashly.yml"] = 670,
    ["batect.yml"] = 58,
    ["beau.yml"] = 588,
    ...
    ["ize.toml"] = 662,
    ["jsconfig.json"] = 287,
    ["jscpd Configuration Schema"] = 644,
    jsdoc = 568,
    ["k3d.yaml"] = 288,
    ...
    rtx = 416,
    rustfmt = 422,
    ["sarif-1.0.0.json"] = 425,
    ["sarif-2.0.0.json"] = 426,
    ["sarif-2.1.0"] = 435,
    ["sarif-2.1.0-rtm.2"] = 427,
    ["sarif-2.1.0-rtm.3"] = 429,
    ["sarif-2.1.0-rtm.4"] = 431,
    ["sarif-2.1.0-rtm.5"] = 433,
    ["sarif-external-property-file-2.1.0"] = 436,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 428,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 430,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 432,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 434,
    ["schema.org - Action"] = 438,
    ["schema.org - ContactPoint"] = 439,
    ["schema.org - Place"] = 440,
    ["schema.org - Thing"] = 441,
    ["semantic-release"] = 444,
    ["servicehub.config.json"] = 540,
    ["servicehub.service.json"] = 539,
    ["settings.job"] = 447,
    ["sfdx-hardis configuration"] = 449,
    ["size-limit configuration"] = 451,
    ["skaffold.yaml"] = 604,
    ["skyuxconfig.json"] = 453,
    snapcraft = 454,
    ["stripe-app-local.json"] = 468,
    ["stripe-app.json"] = 467,
    swcrc = 591,
    ["task.json"] = 474,
    taskcat = 560,
    ["template.json"] = 477,
    ["templatsources.json"] = 478,
    ["theme.json"] = 481,
    ["tizen_workspace.json"] = 482,
    tldr = 483,
    tmLanguage = 484,
    tmuxinator = 548,
    ["transcend.yml"] = 490,
    ["trunk.yaml schema"] = 491,
    ["ts-force-config.json"] = 495,
    ["tsconfig.json"] = 492,
    ["tsd.json"] = 493,
    ["tsdrc.json"] = 494,
    ["tslint.json"] = 496,
    ...
    ["vega-lite.json"] = 509,
    ["vega.json"] = 508,
    ["venvironment-basic.yaml"] = 512,
    ["venvironment.yaml"] = 511,
    ["version.json"] = 513,
    ["vim-addon-info"] = 514,
    ["vs-2017.3.host.json"] = 516,
    ["vs-nesting.json"] = 517,
    ["vsls.json"] = 515,
    ["vss-extension.json"] = 521,
    ["vtesttree.yaml"] = 522,
    ["vtestunit.yaml"] = 523,
    ["webhint.io"] = 640,
    ["webjobpublishsettings.json"] = 529,
    ["webjobs-list.json"] = 528,
    ["xs-app.json"] = 556,
    ["xunit.runner.json"] = 538,
    yamllint = 579,
    zuul = 565,
    ["Žinoma"] = 573
  },
