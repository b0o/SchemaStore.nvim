...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 103,
    [".cryproj (generic)"] = 403,
    [".cryproj engine-5.2"] = 398,
    [".cryproj engine-5.3"] = 399,
    [".cryproj engine-5.4"] = 400,
    [".cryproj engine-5.5"] = 401,
    [".cryproj engine-dev"] = 402,
    [".csscomb.json"] = 105,
    [".csslintrc"] = 106,
    [".eslintrc"] = 141,
    [".esmrc.json"] = 134,
    ...
    [".mtaext"] = 409,
    [".nodehawkrc"] = 248,
    [".npmpackagejsonlintrc"] = 250,
    [".phraseapp.yml"] = 277,
    [".pmbot.yml"] = 270,
    [".postcssrc"] = 275,
    [".pre-commit-config.yml"] = 276,
    [".putout.json"] = 294,
    [".rehyperc"] = 299,
    [".remarkrc"] = 300,
    [".sprite files"] = 335,
    ...
    [".vsext"] = 379,
    [".yarnrc.yml"] = 441,
    ["<div>RIOTS' studio configuration"] = 382,
    ["API Builder"] = 438,
    ["AWS CloudFormation"] = 93,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 94,
    ["Airlock Microgateway"] = 5,
    ["Ansible Collection Galaxy"] = 16,
    ["Ansible Execution Environment"] = 8,
    ["Ansible Inventory"] = 15,
    ["Ansible Meta"] = 9,
    ["Ansible Meta Runtime"] = 10,
    ["Ansible Navigator Configuration"] = 18,
    ["Ansible Playbook"] = 14,
    ["Ansible Requirements"] = 11,
    ["Ansible Tasks File"] = 13,
    ["Ansible Vars File"] = 12,
    ["Ansible-lint Configuration"] = 17,
    ["AnyWork Automation Configuration"] = 1,
    ["Argo Workflows"] = 27,
    ["Avro Avsc"] = 29,
    ["Azure Device Update for IoT Hub import manifest"] = 30,
    ["Azure Device Update for IoT Hub update manifest"] = 31,
    ["Azure IoT Edge deployment"] = 34,
    ["Azure IoT Edge deployment template"] = 35,
    ["Azure IoT EdgeAgent deployment"] = 32,
    ["Azure IoT EdgeHub deployment"] = 33,
    ["Azure Pipelines"] = 36,
    ["Azure Static Web Apps CLI configuration file"] = 337,
    ["Azure Static Web Apps configuration file"] = 336,
    ["Better Code Hub"] = 443,
    BizTalkServerApplicationSchema = 415,
    ["Block Protocol Metadata"] = 63,
    Briefcase = 420,
    ["Build Info"] = 56,
    Buildkite = 58,
    ["Bukkit plugin.yml"] = 57,
    ["BungeeCord plugin.yml"] = 61,
    ["CMake Presets"] = 64,
    ["CSR Framework"] = 69,
    ["Camel YAML DSL"] = 65,
    Carafe = 66,
    ["Catalog Info Backstage"] = 67,
    Cheatsheets = 473,
    ["Chrome Extension"] = 87,
    ["CircleCI config.yml"] = 72,
    ["Citation File Format"] = 95,
    CityJSON = 68,
    ["Code Climate"] = 73,
    ["Container Structure Test"] = 426,
    Containerlab = 451,
    ["Dart build configuration"] = 107,
    ["Dart test config"] = 108,
    ["Deployer Recipe"] = 114,
    Devfile = 132,
    ["Discord Webhook"] = 116,
    ["Dolittle Artifacts"] = 118,
    ["Dolittle Bounded Context Configuration"] = 119,
    ["Dolittle Event Horizons Configuration"] = 120,
    ["Dolittle Resources Configuration"] = 121,
    ["Dolittle Server Configuration"] = 122,
    ["Dolittle Tenant Map Configuration"] = 124,
    ["Dolittle Tenants Configuration"] = 123,
    ["Dolittle Topology"] = 125,
    ["Drush site aliases"] = 129,
    ["Error pages"] = 137,
    Esquio = 135,
    ["Expo SDK"] = 140,
    ["F-Droid Data metadata"] = 144,
    ["Facets - FSDL - Application"] = 142,
    ["Fossa configuration file"] = 149,
    ["Fossa's fossa-deps file"] = 150,
    ["Foundry VTT - Manifest"] = 147,
    ["Foundry VTT - Template"] = 148,
    ["Foxx Manifest"] = 37,
    ["GatewayCore API Gateway"] = 153,
    ["GitHub Action"] = 157,
    ["GitHub Funding"] = 158,
    ["GitHub Issue Template configuration"] = 160,
    ["GitHub Workflow"] = 161,
    ["GitHub Workflow Template Properties"] = 162,
    ["GitHub issue forms"] = 159,
    GitVersion = 156,
    ["Gitpod Configuration"] = 164,
    ["Global Privacy Control"] = 154,
    ["Google Cloud Workflows"] = 92,
    Goreleaser = 167,
    ["Goreleaser Pro"] = 168,
    ["Gradle Build Cache Node"] = 440,
    ["Gradle Enterprise"] = 439,
    ["Grafana 5.x Dashboard"] = 169,
    ["GraphQL Code Generator"] = 172,
    ["GraphQL Config"] = 171,
    ["GraphQL Mesh"] = 170,
    ["Grunt JSHint task"] = 176,
    ["Grunt Watch task"] = 177,
    ["Grunt base task"] = 178,
    ["Grunt clean task"] = 174,
    ["Grunt copy task"] = 173,
    ["Grunt cssmin task"] = 175,
    HEMTT = 412,
    Hadolint = 424,
    ["Hammerkit YAML Schema"] = 450,
    Hayson = 180,
    ["Haystack Pipeline"] = 181,
    ["Hazelcast 5 Configuration"] = 182,
    ["Helm Chart.lock"] = 71,
    ["Helm Chart.yaml"] = 70,
    ["JFrog File Spec"] = 195,
    ["JSON Document Transform"] = 203,
    ["JSON Feed"] = 204,
    ["JSON Resume"] = 302,
    ["JSON Schema Draft 2020-12"] = 394,
    ["JSON Schema Draft 4"] = 391,
    ["JSON Schema Draft 7"] = 392,
    ["JSON Schema Draft 8"] = 393,
    ["JSON schema for CodeShip Pro services configuration files"] = 79,
    ["JSON schema for CodeShip Pro steps configuration files"] = 80,
    ["JSON schema for Codecov configuration files"] = 78,
    ["JSON-API"] = 202,
    ["JSON-e templates"] = 448,
    ["JSON-stat 2.0"] = 388,
    JSONPatch = 206,
    Jekyll = 192,
    ["Jenkins X Pipelines"] = 193,
    ["Jenkins X Requirements"] = 194,
    ["Jovo Language Models"] = 196,
    ["KSP-AVC"] = 389,
    ["KSP-CKAN"] = 390,
    Liquibase = 455,
    ["MegaLinter configuration"] = 220,
    ["MegaLinter descriptor"] = 221,
    ["Meltano plugin discovery definition"] = 223,
    ["Meltano project definition"] = 222,
    ["Microsoft Band Web Tile"] = 224,
    ["Minecraft Data Pack Advancement"] = 226,
    ["Minecraft Data Pack Biome"] = 227,
    ["Minecraft Data Pack Configured Carver"] = 228,
    ["Minecraft Data Pack Dimension"] = 230,
    ["Minecraft Data Pack Dimension Type"] = 229,
    ["Minecraft Data Pack Item Modifier"] = 231,
    ["Minecraft Data Pack Loot Table"] = 232,
    ["Minecraft Data Pack Metadata"] = 233,
    ["Minecraft Data Pack Predicate"] = 234,
    ["Minecraft Data Pack Recipe"] = 235,
    ["Minecraft Data Pack Template Pool"] = 236,
    ["Minecraft Resourcepack Sounds"] = 237,
    ["Netin Diagnostic System Template"] = 462,
    ["Netlify config schema"] = 242,
    ["Nightwatch.js"] = 243,
    ["OSS Review Toolkit repository configuration"] = 264,
    Opctl = 411,
    ["OpenWeather Current Weather API"] = 447,
    ["OpenWeather Road Risk API"] = 446,
    ["Ory Hydra configuration"] = 186,
    ["Ory Keto configuration"] = 209,
    ["Ory Kratos configuration"] = 263,
    ["Ory Oathkeeper configuration"] = 255,
    ["Outblocks App configuration"] = 261,
    ["Outblocks database table"] = 262,
    ["Outblocks project configuration"] = 260,
    Packer = 267,
    ["Pipeline component"] = 456,
    ["PocketMine plugin.yml"] = 271,
    ["Pull Request Labeler"] = 293,
    Qodana = 470,
    ["RKE Cluster Configuration JSON Schema"] = 454,
    ["RKE Cluster Configuration YAML Schema"] = 453,
    Ray = 423,
    ["Read the Docs"] = 296,
    ["Red-DiscordBot Cog"] = 297,
    ["Red-DiscordBot Cog Repo"] = 298,
    Renovate = 303,
    RoadRunner = 304,
    SWADL = 346,
    ["Sapphire CLI Config"] = 305,
    ["SauceCTL Configuration"] = 459,
    ["Schema Catalog"] = 318,
    ["Scoop manifest"] = 323,
    ["Semgrep Rule"] = 324,
    ["Serverless Framework Configuration"] = 466,
    ["Settings.paf"] = 326,
    ["Shopware 6 Configuration"] = 467,
    ["Shopware CLI Extension Store Configuration"] = 468,
    ["Shopware CLI Project Store Configuration"] = 469,
    Solidarity = 331,
    ["Source Maps v3"] = 332,
    SpecIF = 333,
    ["Sponge Mixin configuration"] = 334,
    ["StackHawk Scanner Configuration"] = 465,
    ["StackHead CLI config"] = 338,
    ["StackHead module configuration"] = 339,
    ["StackHead project definition"] = 340,
    Stale = 341,
    ["Statamic Blueprint"] = 342,
    ["Stryker Mutator"] = 343,
    ["StyleCop Analyzers Configuration"] = 344,
    ["Swagger API 2.0"] = 347,
    ["Taskfile YAML Schema"] = 449,
    Taurus = 348,
    ["TestEnvironment.json"] = 353,
    ["Traefik v2"] = 355,
    ["Traefik v2 File Provider"] = 356,
    Tye = 471,
    ["UI5 Manifest"] = 368,
    ["Ubuntu Server Autoinstall"] = 366,
    ["Uniswap Token List"] = 432,
    ["User Journey Map YAML Schema"] = 452,
    ["VSCode Code Snippets"] = 82,
    ["VSIX CLI publishing"] = 380,
    ["Vela Pipeline Configuration"] = 372,
    Vercel = 81,
    ["Web App Manifest"] = 384,
    ["Web types"] = 387,
    WebExtensions = 383,
    ["Windows Package Manager Installer Manifest"] = 429,
    ["Windows Package Manager Locale Manifest"] = 430,
    ["Windows Package Manager Singleton Manifest"] = 428,
    ["Woodpecker pipeline config"] = 461,
    ["Yippee-Ki-JSON configuration YML"] = 434,
    ["angular.json"] = 6,
    ["app-definition.yaml"] = 20,
    ...
    ["arc.json"] = 26,
    ["architect.yml"] = 25,
    ["artifacthub-repo.yml"] = 28,
    ["babelrc.json"] = 39,
    ["bamboo-spec"] = 42,
    ["batect.yml"] = 41,
    ["beau.yml"] = 442,
    ["beef-database-codegen"] = 43,
    ["beef-entity-codegen"] = 44,
    ["behat.yml"] = 52,
    ["bigquery-table"] = 45,
    ["bitbucket-pipelines"] = 46,
    bitrise = 47,
    ["bitrise-step"] = 48,
    ["block.json"] = 62,
    ["bower.json"] = 50,
    ["bozr.suite.json"] = 53,
    ["browser.i18n.json"] = 54,
    bucklescript = 55,
    ["bundleconfig.json"] = 60,
    ["chutzpah.json"] = 88,
    ["cloud-sdk-pipeline-config-schema"] = 90,
    ["cloudbuild.json"] = 91,
    cloudify = 76,
    codemagic = 77,
    ["coffeelint.json"] = 96,
    comet = 444,
    ["commands.json"] = 85,
    ["compile_commands.json"] = 84,
    ["compilerconfig.json"] = 83,
    ["component.json"] = 98,
    ["composer.json"] = 97,
    ["config.json"] = 99,
    ["contentmanifest.json"] = 89,
    ["contribute.json"] = 100,
    ["cosmos.config.json"] = 86,
    ["crowdin.yml"] = 101,
    cspell = 104,
    ["cypress.json"] = 102,
    ["datalogic-scan2deploy-android"] = 109,
    ["datalogic-scan2deploy-ce"] = 110,
    ["debugsettings.json"] = 111,
    ["dependabot-v2.json"] = 113,
    ["dependabot.json"] = 112,
    ["detekt.yml"] = 115,
    devinit = 436,
    ["docfx.json"] = 117,
    ["docker-compose.yml"] = 435,
    ["dotnet Release Index manifest"] = 126,
    ["dotnetcli.host.json"] = 127,
    ["drone.json"] = 128,
    ["dss-2.0.0.json"] = 130,
    ["dvc.yaml"] = 131,
    ["ecosystem.json"] = 133,
    ["electron-builder configuration file."] = 138,
    ["epr-manifest.json"] = 136,
    ["evcc.yaml"] = 139,
    ["fabric.mod.json"] = 143,
    ["first-timers-bot"] = 146,
    fulibWorkflows = 460,
    ["func.yaml"] = 151,
    ["function.json"] = 152,
    ["geojson.json"] = 155,
    ["gitlab-ci"] = 163,
    ["global.json"] = 165,
    ["golangci-lint Configuration"] = 166,
    ["haxelib.json"] = 179,
    helmfile = 425,
    ["host-meta.json"] = 184,
    ["host.json"] = 183,
    ...
    httpmockrc = 416,
    huskyrc = 405,
    ["imageoptimizer.json"] = 187,
    ["importmap.json"] = 189,
    ["ioBroker JSON UI"] = 190,
    ["ioBroker Package manifest"] = 191,
    ["jsconfig.json"] = 207,
    jsdoc = 422,
    ["k3d.yaml"] = 208,
    ["kustomization.yaml"] = 210,
    ["label-commenter-config.yml"] = 211,
    ["launchsettings.json"] = 212,
    ["lerna.json"] = 213,
    ["lgtm.yml"] = 214,
    ["libman.json"] = 215,
    ["license-report-config.json"] = 216,
    ["local.settings.json"] = 217,
    ["localazy.json"] = 218,
    ["lsdlschema.json"] = 219,
    ["markdownlint.json"] = 458,
    mboats = 464,
    ["mimetypes.json"] = 225,
    ["mta.yaml"] = 407,
    ["mtad.yaml"] = 408,
    ["mycode.json"] = 240,
    ["napari plugin manifest"] = 241,
    neoload = 417,
    ["nest-cli"] = 246,
    ["ninjs (News in JSON) 1.3"] = 245,
    ["ninjs (News in JSON) 2.0"] = 244,
    ["nlu.json"] = 247,
    ["nodemon.json"] = 249,
    ["noodl.schema.json"] = 463,
    now = 413,
    ["nswag.json"] = 253,
    ntangle = 254,
    ["nuclei-template.yaml"] = 251,
    ["nuget-project.json"] = 252,
    ["ocelot.json"] = 256,
    ["omnisharp.json"] = 257,
    ["openapi.json"] = 258,
    ["openfin.json"] = 259,
    ["package.json"] = 265,
    ["package.manifest"] = 266,
    ["pattern.json"] = 269,
    pgap_yaml_input_reader = 268,
    ["plagiarize-me.yaml"] = 273,
    ["plagiarize.yaml"] = 272,
    ["portman.json"] = 274,
    ["prettierrc.json"] = 278,
    ["prisma.yml"] = 279,
    ["project-1.0.0-beta3.json"] = 281,
    ["project-1.0.0-beta4.json"] = 282,
    ["project-1.0.0-beta5.json"] = 283,
    ["project-1.0.0-beta6.json"] = 284,
    ["project-1.0.0-beta8.json"] = 285,
    ["project-1.0.0-rc1.json"] = 286,
    ["project-1.0.0-rc2.json"] = 287,
    ["project.json"] = 280,
    ["prometheus.json"] = 288,
    ["prometheus.rules.json"] = 289,
    ["proxies.json"] = 290,
    ["publiccode.yml"] = 291,
    ["pubspec.yaml"] = 292,
    ["pyrseas-0.8.json"] = 295,
    ["release drafter"] = 418,
    ["sarif-1.0.0.json"] = 306,
    ["sarif-2.0.0.json"] = 307,
    ["sarif-2.1.0"] = 316,
    ["sarif-2.1.0-rtm.2"] = 308,
    ["sarif-2.1.0-rtm.3"] = 310,
    ["sarif-2.1.0-rtm.4"] = 312,
    ["sarif-2.1.0-rtm.5"] = 314,
    ["sarif-external-property-file-2.1.0"] = 317,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 309,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 311,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 313,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 315,
    ["schema.org - Action"] = 319,
    ["schema.org - ContactPoint"] = 320,
    ["schema.org - Place"] = 321,
    ["schema.org - Thing"] = 322,
    ["servicehub.config.json"] = 397,
    ["servicehub.service.json"] = 396,
    ["settings.job"] = 325,
    ["sfdx-hardis configuration"] = 327,
    ["size-limit configuration"] = 328,
    ["skaffold.yaml"] = 457,
    ["skyuxconfig.json"] = 329,
    snapcraft = 330,
    swcrc = 445,
    taskcat = 414,
    ["template.json"] = 349,
    ["templatsources.json"] = 350,
    ["theme.json"] = 351,
    tmLanguage = 352,
    ["trunk.yaml schema"] = 357,
    ["ts-force-config.json"] = 361,
    ["tsconfig.json"] = 358,
    ["tsd.json"] = 359,
    ["tsdrc.json"] = 360,
    ["tslint.json"] = 362,
    ...
    ["version.json"] = 373,
    ["vim-addon-info"] = 374,
    ["vs-2017.3.host.json"] = 376,
    ["vs-nesting.json"] = 377,
    ["vsls.json"] = 375,
    ["vss-extension.json"] = 381,
    ["webjobpublishsettings.json"] = 386,
    ["webjobs-list.json"] = 385,
    ["xs-app.json"] = 410,
    ["xunit.runner.json"] = 395,
    yamllint = 433,
    zuul = 419,
    ["Žinoma"] = 427
  },
