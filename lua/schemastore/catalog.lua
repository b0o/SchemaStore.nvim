...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 104,
    [".cryproj (generic)"] = 404,
    [".cryproj engine-5.2"] = 399,
    [".cryproj engine-5.3"] = 400,
    [".cryproj engine-5.4"] = 401,
    [".cryproj engine-5.5"] = 402,
    [".cryproj engine-dev"] = 403,
    [".csscomb.json"] = 106,
    [".csslintrc"] = 107,
    [".eslintrc"] = 142,
    [".esmrc.json"] = 135,
    ...
    [".mtaext"] = 410,
    [".nodehawkrc"] = 249,
    [".npmpackagejsonlintrc"] = 251,
    [".phraseapp.yml"] = 278,
    [".pmbot.yml"] = 271,
    [".postcssrc"] = 276,
    [".pre-commit-config.yml"] = 277,
    [".putout.json"] = 295,
    [".rehyperc"] = 300,
    [".remarkrc"] = 301,
    [".sprite files"] = 336,
    ...
    [".vsext"] = 380,
    [".yarnrc.yml"] = 442,
    ["<div>RIOTS' studio configuration"] = 383,
    ["API Builder"] = 439,
    ["AWS CloudFormation"] = 94,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 95,
    ["Airlock Microgateway"] = 6,
    ["Ansible Collection Galaxy"] = 17,
    ["Ansible Execution Environment"] = 9,
    ["Ansible Inventory"] = 16,
    ["Ansible Meta"] = 10,
    ["Ansible Meta Runtime"] = 11,
    ["Ansible Navigator Configuration"] = 19,
    ["Ansible Playbook"] = 15,
    ["Ansible Requirements"] = 12,
    ["Ansible Tasks File"] = 14,
    ["Ansible Vars File"] = 13,
    ["Ansible-lint Configuration"] = 18,
    ["AnyWork Automation Configuration"] = 2,
    ["Argo Workflows"] = 28,
    ["Avro Avsc"] = 30,
    ["Azure Device Update for IoT Hub import manifest"] = 31,
    ["Azure Device Update for IoT Hub update manifest"] = 32,
    ["Azure IoT Edge deployment"] = 35,
    ["Azure IoT Edge deployment template"] = 36,
    ["Azure IoT EdgeAgent deployment"] = 33,
    ["Azure IoT EdgeHub deployment"] = 34,
    ["Azure Pipelines"] = 37,
    ["Azure Static Web Apps CLI configuration file"] = 338,
    ["Azure Static Web Apps configuration file"] = 337,
    ["Better Code Hub"] = 444,
    BizTalkServerApplicationSchema = 416,
    ["Block Protocol Metadata"] = 64,
    Briefcase = 421,
    ["Build Info"] = 57,
    Buildkite = 59,
    ["Bukkit plugin.yml"] = 58,
    ["BungeeCord plugin.yml"] = 62,
    ["CMake Presets"] = 65,
    ["CSR Framework"] = 70,
    ["Camel YAML DSL"] = 66,
    Carafe = 67,
    ["Catalog Info Backstage"] = 68,
    Cheatsheets = 474,
    ["Chrome Extension"] = 88,
    ["CircleCI config.yml"] = 73,
    ["Citation File Format"] = 96,
    CityJSON = 69,
    ["Code Climate"] = 74,
    ["Common types for all schemas"] = 1,
    ["Container Structure Test"] = 427,
    Containerlab = 452,
    ["Dart build configuration"] = 108,
    ["Dart test config"] = 109,
    ["Deployer Recipe"] = 115,
    Devfile = 133,
    ["Discord Webhook"] = 117,
    ["Dolittle Artifacts"] = 119,
    ["Dolittle Bounded Context Configuration"] = 120,
    ["Dolittle Event Horizons Configuration"] = 121,
    ["Dolittle Resources Configuration"] = 122,
    ["Dolittle Server Configuration"] = 123,
    ["Dolittle Tenant Map Configuration"] = 125,
    ["Dolittle Tenants Configuration"] = 124,
    ["Dolittle Topology"] = 126,
    ["Drush site aliases"] = 130,
    ["Error pages"] = 138,
    Esquio = 136,
    ["Expo SDK"] = 141,
    ["F-Droid Data metadata"] = 145,
    ["Facets - FSDL - Application"] = 143,
    ["Fossa configuration file"] = 150,
    ["Fossa's fossa-deps file"] = 151,
    ["Foundry VTT - Manifest"] = 148,
    ["Foundry VTT - Template"] = 149,
    ["Foxx Manifest"] = 38,
    ["GatewayCore API Gateway"] = 154,
    ["GitHub Action"] = 158,
    ["GitHub Funding"] = 159,
    ["GitHub Issue Template configuration"] = 161,
    ["GitHub Workflow"] = 162,
    ["GitHub Workflow Template Properties"] = 163,
    ["GitHub issue forms"] = 160,
    GitVersion = 157,
    ["Gitpod Configuration"] = 165,
    ["Global Privacy Control"] = 155,
    ["Google Cloud Workflows"] = 93,
    Goreleaser = 168,
    ["Goreleaser Pro"] = 169,
    ["Gradle Build Cache Node"] = 441,
    ["Gradle Enterprise"] = 440,
    ["Grafana 5.x Dashboard"] = 170,
    ["GraphQL Code Generator"] = 173,
    ["GraphQL Config"] = 172,
    ["GraphQL Mesh"] = 171,
    ["Grunt JSHint task"] = 177,
    ["Grunt Watch task"] = 178,
    ["Grunt base task"] = 179,
    ["Grunt clean task"] = 175,
    ["Grunt copy task"] = 174,
    ["Grunt cssmin task"] = 176,
    HEMTT = 413,
    Hadolint = 425,
    ["Hammerkit YAML Schema"] = 451,
    Hayson = 181,
    ["Haystack Pipeline"] = 182,
    ["Hazelcast 5 Configuration"] = 183,
    ["Helm Chart.lock"] = 72,
    ["Helm Chart.yaml"] = 71,
    ["JFrog File Spec"] = 196,
    ["JSON Document Transform"] = 204,
    ["JSON Feed"] = 205,
    ["JSON Resume"] = 303,
    ["JSON Schema Draft 2020-12"] = 395,
    ["JSON Schema Draft 4"] = 392,
    ["JSON Schema Draft 7"] = 393,
    ["JSON Schema Draft 8"] = 394,
    ["JSON schema for CodeShip Pro services configuration files"] = 80,
    ["JSON schema for CodeShip Pro steps configuration files"] = 81,
    ["JSON schema for Codecov configuration files"] = 79,
    ["JSON-API"] = 203,
    ["JSON-e templates"] = 449,
    ["JSON-stat 2.0"] = 389,
    JSONPatch = 207,
    Jekyll = 193,
    ["Jenkins X Pipelines"] = 194,
    ["Jenkins X Requirements"] = 195,
    ["Jovo Language Models"] = 197,
    ["KSP-AVC"] = 390,
    ["KSP-CKAN"] = 391,
    Liquibase = 456,
    ["MegaLinter configuration"] = 221,
    ["MegaLinter descriptor"] = 222,
    ["Meltano plugin discovery definition"] = 224,
    ["Meltano project definition"] = 223,
    ["Microsoft Band Web Tile"] = 225,
    ["Minecraft Data Pack Advancement"] = 227,
    ["Minecraft Data Pack Biome"] = 228,
    ["Minecraft Data Pack Configured Carver"] = 229,
    ["Minecraft Data Pack Dimension"] = 231,
    ["Minecraft Data Pack Dimension Type"] = 230,
    ["Minecraft Data Pack Item Modifier"] = 232,
    ["Minecraft Data Pack Loot Table"] = 233,
    ["Minecraft Data Pack Metadata"] = 234,
    ["Minecraft Data Pack Predicate"] = 235,
    ["Minecraft Data Pack Recipe"] = 236,
    ["Minecraft Data Pack Template Pool"] = 237,
    ["Minecraft Resourcepack Sounds"] = 238,
    ["Netin Diagnostic System Template"] = 463,
    ["Netlify config schema"] = 243,
    ["Nightwatch.js"] = 244,
    ["OSS Review Toolkit repository configuration"] = 265,
    Opctl = 412,
    ["OpenWeather Current Weather API"] = 448,
    ["OpenWeather Road Risk API"] = 447,
    ["Ory Hydra configuration"] = 187,
    ["Ory Keto configuration"] = 210,
    ["Ory Kratos configuration"] = 264,
    ["Ory Oathkeeper configuration"] = 256,
    ["Outblocks App configuration"] = 262,
    ["Outblocks database table"] = 263,
    ["Outblocks project configuration"] = 261,
    Packer = 268,
    ["Pipeline component"] = 457,
    ["PocketMine plugin.yml"] = 272,
    ["Pull Request Labeler"] = 294,
    Qodana = 471,
    ["RKE Cluster Configuration JSON Schema"] = 455,
    ["RKE Cluster Configuration YAML Schema"] = 454,
    Ray = 424,
    ["Read the Docs"] = 297,
    ["Red-DiscordBot Cog"] = 298,
    ["Red-DiscordBot Cog Repo"] = 299,
    Renovate = 304,
    RoadRunner = 305,
    SWADL = 347,
    ["Sapphire CLI Config"] = 306,
    ["SauceCTL Configuration"] = 460,
    ["Schema Catalog"] = 319,
    ["Scoop manifest"] = 324,
    ["Semgrep Rule"] = 325,
    ["Serverless Framework Configuration"] = 467,
    ["Settings.paf"] = 327,
    ["Shopware 6 Configuration"] = 468,
    ["Shopware CLI Extension Store Configuration"] = 469,
    ["Shopware CLI Project Store Configuration"] = 470,
    Solidarity = 332,
    ["Source Maps v3"] = 333,
    SpecIF = 334,
    ["Sponge Mixin configuration"] = 335,
    ["StackHawk Scanner Configuration"] = 466,
    ["StackHead CLI config"] = 339,
    ["StackHead module configuration"] = 340,
    ["StackHead project definition"] = 341,
    Stale = 342,
    ["Statamic Blueprint"] = 343,
    ["Stryker Mutator"] = 344,
    ["StyleCop Analyzers Configuration"] = 345,
    ["Swagger API 2.0"] = 348,
    ["Taskfile YAML Schema"] = 450,
    Taurus = 349,
    ["TestEnvironment.json"] = 354,
    ["Traefik v2"] = 356,
    ["Traefik v2 File Provider"] = 357,
    Tye = 472,
    ["UI5 Manifest"] = 369,
    ["Ubuntu Server Autoinstall"] = 367,
    ["Uniswap Token List"] = 433,
    ["User Journey Map YAML Schema"] = 453,
    ["VSCode Code Snippets"] = 83,
    ["VSIX CLI publishing"] = 381,
    ["Vela Pipeline Configuration"] = 373,
    Vercel = 82,
    ["Web App Manifest"] = 385,
    ["Web types"] = 388,
    WebExtensions = 384,
    ["Windows Package Manager Installer Manifest"] = 430,
    ["Windows Package Manager Locale Manifest"] = 431,
    ["Windows Package Manager Singleton Manifest"] = 429,
    ["Woodpecker pipeline config"] = 462,
    ["Yippee-Ki-JSON configuration YML"] = 435,
    ["angular.json"] = 7,
    ...
    ["arc.json"] = 27,
    ["architect.yml"] = 26,
    ["artifacthub-repo.yml"] = 29,
    ["babelrc.json"] = 40,
    ["bamboo-spec"] = 43,
    ["batect.yml"] = 42,
    ["beau.yml"] = 443,
    ["beef-database-codegen"] = 44,
    ["beef-entity-codegen"] = 45,
    ["behat.yml"] = 53,
    ["bigquery-table"] = 46,
    ["bitbucket-pipelines"] = 47,
    bitrise = 48,
    ["bitrise-step"] = 49,
    ["block.json"] = 63,
    ["bower.json"] = 51,
    ["bozr.suite.json"] = 54,
    ["browser.i18n.json"] = 55,
    bucklescript = 56,
    ["bundleconfig.json"] = 61,
    ["chutzpah.json"] = 89,
    ["cloud-sdk-pipeline-config-schema"] = 91,
    ["cloudbuild.json"] = 92,
    cloudify = 77,
    codemagic = 78,
    ["coffeelint.json"] = 97,
    comet = 445,
    ["commands.json"] = 86,
    ["compile_commands.json"] = 85,
    ["compilerconfig.json"] = 84,
    ["component.json"] = 99,
    ["composer.json"] = 98,
    ["config.json"] = 100,
    ["contentmanifest.json"] = 90,
    ["contribute.json"] = 101,
    ["cosmos.config.json"] = 87,
    ["crowdin.yml"] = 102,
    cspell = 105,
    ["cypress.json"] = 103,
    ["datalogic-scan2deploy-android"] = 110,
    ["datalogic-scan2deploy-ce"] = 111,
    ["debugsettings.json"] = 112,
    ["dependabot-v2.json"] = 114,
    ["dependabot.json"] = 113,
    ["detekt.yml"] = 116,
    devinit = 437,
    ["docfx.json"] = 118,
    ["docker-compose.yml"] = 436,
    ["dotnet Release Index manifest"] = 127,
    ["dotnetcli.host.json"] = 128,
    ["drone.json"] = 129,
    ["dss-2.0.0.json"] = 131,
    ["dvc.yaml"] = 132,
    ["ecosystem.json"] = 134,
    ["electron-builder configuration file."] = 139,
    ["epr-manifest.json"] = 137,
    ["evcc.yaml"] = 140,
    ["fabric.mod.json"] = 144,
    ["first-timers-bot"] = 147,
    fulibWorkflows = 461,
    ["func.yaml"] = 152,
    ["function.json"] = 153,
    ["geojson.json"] = 156,
    ["gitlab-ci"] = 164,
    ["global.json"] = 166,
    ["golangci-lint Configuration"] = 167,
    ["haxelib.json"] = 180,
    helmfile = 426,
    ["host-meta.json"] = 185,
    ["host.json"] = 184,
    ...
    httpmockrc = 417,
    huskyrc = 406,
    ["imageoptimizer.json"] = 188,
    ["importmap.json"] = 190,
    ["ioBroker JSON UI"] = 191,
    ["ioBroker Package manifest"] = 192,
    ["jsconfig.json"] = 208,
    jsdoc = 423,
    ["k3d.yaml"] = 209,
    ["kustomization.yaml"] = 211,
    ["label-commenter-config.yml"] = 212,
    ["launchsettings.json"] = 213,
    ["lerna.json"] = 214,
    ["lgtm.yml"] = 215,
    ["libman.json"] = 216,
    ["license-report-config.json"] = 217,
    ["local.settings.json"] = 218,
    ["localazy.json"] = 219,
    ["lsdlschema.json"] = 220,
    ["markdownlint.json"] = 459,
    mboats = 465,
    ["mimetypes.json"] = 226,
    ["mta.yaml"] = 408,
    ["mtad.yaml"] = 409,
    ["mycode.json"] = 241,
    ["napari plugin manifest"] = 242,
    neoload = 418,
    ["nest-cli"] = 247,
    ["ninjs (News in JSON) 1.3"] = 246,
    ["ninjs (News in JSON) 2.0"] = 245,
    ["nlu.json"] = 248,
    ["nodemon.json"] = 250,
    ["noodl.schema.json"] = 464,
    now = 414,
    ["nswag.json"] = 254,
    ntangle = 255,
    ["nuclei-template.yaml"] = 252,
    ["nuget-project.json"] = 253,
    ["ocelot.json"] = 257,
    ["omnisharp.json"] = 258,
    ["openapi.json"] = 259,
    ["openfin.json"] = 260,
    ["package.json"] = 266,
    ["package.manifest"] = 267,
    ["pattern.json"] = 270,
    pgap_yaml_input_reader = 269,
    ["plagiarize-me.yaml"] = 274,
    ["plagiarize.yaml"] = 273,
    ["portman.json"] = 275,
    ["prettierrc.json"] = 279,
    ["prisma.yml"] = 280,
    ["project-1.0.0-beta3.json"] = 282,
    ["project-1.0.0-beta4.json"] = 283,
    ["project-1.0.0-beta5.json"] = 284,
    ["project-1.0.0-beta6.json"] = 285,
    ["project-1.0.0-beta8.json"] = 286,
    ["project-1.0.0-rc1.json"] = 287,
    ["project-1.0.0-rc2.json"] = 288,
    ["project.json"] = 281,
    ["prometheus.json"] = 289,
    ["prometheus.rules.json"] = 290,
    ["proxies.json"] = 291,
    ["publiccode.yml"] = 292,
    ["pubspec.yaml"] = 293,
    ["pyrseas-0.8.json"] = 296,
    ["release drafter"] = 419,
    ["sarif-1.0.0.json"] = 307,
    ["sarif-2.0.0.json"] = 308,
    ["sarif-2.1.0"] = 317,
    ["sarif-2.1.0-rtm.2"] = 309,
    ["sarif-2.1.0-rtm.3"] = 311,
    ["sarif-2.1.0-rtm.4"] = 313,
    ["sarif-2.1.0-rtm.5"] = 315,
    ["sarif-external-property-file-2.1.0"] = 318,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 310,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 312,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 314,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 316,
    ["schema.org - Action"] = 320,
    ["schema.org - ContactPoint"] = 321,
    ["schema.org - Place"] = 322,
    ["schema.org - Thing"] = 323,
    ["servicehub.config.json"] = 398,
    ["servicehub.service.json"] = 397,
    ["settings.job"] = 326,
    ["sfdx-hardis configuration"] = 328,
    ["size-limit configuration"] = 329,
    ["skaffold.yaml"] = 458,
    ["skyuxconfig.json"] = 330,
    snapcraft = 331,
    swcrc = 446,
    taskcat = 415,
    ["template.json"] = 350,
    ["templatsources.json"] = 351,
    ["theme.json"] = 352,
    tmLanguage = 353,
    ["trunk.yaml schema"] = 358,
    ["ts-force-config.json"] = 362,
    ["tsconfig.json"] = 359,
    ["tsd.json"] = 360,
    ["tsdrc.json"] = 361,
    ["tslint.json"] = 363,
    ...
    ["version.json"] = 374,
    ["vim-addon-info"] = 375,
    ["vs-2017.3.host.json"] = 377,
    ["vs-nesting.json"] = 378,
    ["vsls.json"] = 376,
    ["vss-extension.json"] = 382,
    ["webjobpublishsettings.json"] = 387,
    ["webjobs-list.json"] = 386,
    ["xs-app.json"] = 411,
    ["xunit.runner.json"] = 396,
    yamllint = 434,
    zuul = 420,
    ["Žinoma"] = 428
  },
