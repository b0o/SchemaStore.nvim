...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 195,
    [".cryproj (generic)"] = 658,
    [".cryproj engine-5.2"] = 653,
    [".cryproj engine-5.3"] = 654,
    [".cryproj engine-5.4"] = 655,
    [".cryproj engine-5.5"] = 656,
    [".cryproj engine-dev"] = 657,
    [".eslintrc"] = 250,
    [".esmrc.json"] = 242,
    [".ffizer.yaml"] = 254,
    [".htmlhintrc"] = 310,
    ...
    [".mtaext"] = 669,
    [".nodehawkrc"] = 420,
    [".npmpackagejsonlintrc"] = 423,
    [".phrase.yml"] = 469,
    [".phraseapp.yml"] = 470,
    [".pmbot.yml"] = 459,
    [".postcssrc"] = 464,
    [".powerpages-web-template-manifest"] = 466,
    [".pre-commit-config.yml"] = 467,
    [".pre-commit-hooks.yml"] = 468,
    [".putout.json"] = 489,
    [".rehyperc"] = 502,
    [".remarkrc"] = 504,
    [".sprite files"] = 562,
    ...
    ["<div>RIOTS' studio configuration"] = 636,
    ["@factorial/drupal-breakpoints-css"] = 5,
    ["A micro editor config"] = 374,
    AIConfig = 12,
    ["API Builder"] = 701,
    ["AVA Configuration"] = 761,
    ...
    ["Adobe UXP Manifest"] = 826,
    ["Aerleon Network & Service Definitions"] = 8,
    ["Aerleon Policy"] = 9,
    ["Airlock Microgateway"] = 13,
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 733,
    ["All Contributors configuration file"] = 791,
    ...
    ["Azure Pipelines"] = 65,
    ["Azure Static Web Apps CLI configuration file"] = 565,
    ["Azure Static Web Apps configuration file"] = 564,
    ["BX CI"] = 103,
    ["Bashly (bashly.yml)"] = 795,
    ["Bashly Settings (bashly-settings.yml)"] = 796,
    ["Better Code Hub"] = 705,
    ["Better Scripts"] = 104,
    Bigconfig = 82,
    BizTalkServerApplicationSchema = 675,
    Bleep = 105,
    ...
    ["Butane Config"] = 746,
    ["CGS Custom Card Game (CardGameDef.json)"] = 831,
    ["CICS TS region tagging"] = 755,
    ["CICS TS resource import"] = 756,
    ["CICS TS resource model"] = 757,
    ["CICS TS resource overrides"] = 758,
    ["CMake Presets"] = 106,
    ["CNC Codes"] = 118,
    ...
    Conjure = 117,
    ["Container Structure Test"] = 688,
    Containerlab = 713,
    ["Crowdsec collection config"] = 191,
    ["Crowdsec parser config"] = 192,
    ["Crowdsec scenario config"] = 193,
    ["CumulusCI Config"] = 122,
    ["Custom Machinery Machine"] = 832,
    ["Custom Machinery Recipe"] = 833,
    ["Cycle Stack File"] = 124,
    ["DWP Exchange - catalogue entry"] = 237,
    ["DWP Exchange - gateway"] = 235,
    ["DWP Exchange - meta"] = 236,
    ...
    ["DataYoga Job"] = 126,
    ["Databricks Asset Bundles"] = 812,
    ["Datadog Service Definition"] = 351,
    ["Datahub Ingestion Recipe"] = 762,
    ["Dein Config"] = 128,
    ["Deno Config (deno.json)"] = 208,
    ["Dependency cruiser"] = 129,
    ["Deployer Recipe"] = 211,
    ["Deta Spacefile"] = 130,
    ["Detekt Config (detekt.yml)"] = 212,
    ["Devbox Config"] = 131,
    ["Devbox Plugin"] = 132,
    Devfile = 234,
    ["Discord Webhook"] = 213,
    ["DocFx Config (docfx.json)"] = 216,
    ["Dolittle Artifacts"] = 217,
    ["Dolittle Bounded Context Configuration"] = 218,
    ["Dolittle Event Horizons Configuration"] = 219,
    ["Dolittle Resources Configuration"] = 220,
    ["Dolittle Server Configuration"] = 221,
    ["Dolittle Tenant Map Configuration"] = 223,
    ["Dolittle Tenants Configuration"] = 222,
    ["Dolittle Topology"] = 224,
    ...
    ["Drupal Routing"] = 143,
    ["Drupal Services"] = 145,
    ["Drush site aliases"] = 230,
    ["Dynamic Bash Aliases (.aliases)"] = 803,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 792,
    ["Elgato Stream Deck"] = 240,
    ["Embrace Config"] = 773,
    Endurica = 816,
    ["Enterprise Contract Policy Spec"] = 241,
    ["Erda Pipeline"] = 839,
    ["Erda Runtime"] = 840,
    ["Error pages"] = 245,
    Esquio = 243,
    ["Estuary Flow Catalog"] = 752,
    ["Expo SDK"] = 248,
    ["F-Droid Data metadata"] = 253,
    ["Facets - FSDL - Application"] = 251,
    ["FasterCI Configuration"] = 66,
    FiQuS = 257,
    Firebase = 255,
    ["Flow.json Configurations"] = 836,
    ["Fossa configuration file"] = 264,
    ["Fossa's fossa-deps file"] = 265,
    ["Foundry VTT - Base package Manifest"] = 259,
    ["Foundry VTT - Module Manifest"] = 260,
    ["Foundry VTT - System Data Template"] = 263,
    ["Foundry VTT - System Manifest"] = 261,
    ["Foundry VTT - World Manifest"] = 262,
    ["Foxx Manifest"] = 67,
    ["Freifunk.de Community API"] = 70,
    ["Frogbot Config"] = 71,
    ["G2P Mapping Configuration"] = 269,
    ["GCP Blueprint Metadata"] = 272,
    Gaspar = 270,
    ["GatewayCore API Gateway"] = 271,
    ["GeoJSON.json latest"] = 750,
    GherKing = 754,
    ["GitHub Action"] = 277,
    ["GitHub Discussion"] = 278,
    ["GitHub Funding"] = 279,
    ["GitHub Issue Template configuration"] = 281,
    ["GitHub Issue Template forms"] = 280,
    ["GitHub Workflow"] = 282,
    ["GitHub Workflow Template Properties"] = 283,
    ["GitLab Agent for Kubernetes configuration"] = 828,
    GitVersion = 274,
    ["Gitea Issue Template configuration"] = 275,
    ["Gitea Issue Template forms"] = 276,
    ["Gitpod Configuration"] = 285,
    ["GlazeWM settings"] = 830,
    ["Global Privacy Control"] = 273,
    Goblet = 811,
    ["Golangci-lint Configuration"] = 287,
    ["Golangci-lint Custom Plugins Configuration"] = 288,
    ["Google Chrome Related Website Sets"] = 256,
    ["Google Cloud Workflows"] = 178,
    Goreleaser = 290,
    ["Goreleaser Pro"] = 291,
    Goss = 292,
    ["Gradle Build Cache Node"] = 703,
    ["Gradle Enterprise"] = 702,
    ["Grafana 5.x Dashboard"] = 293,
    ["GraphQL Code Generator"] = 297,
    ["GraphQL Config"] = 296,
    ["GraphQL Mesh"] = 295,
    ["Grunt JSHint task"] = 301,
    ["Grunt Watch task"] = 302,
    ["Grunt base task"] = 303,
    ["Grunt clean task"] = 299,
    ["Grunt copy task"] = 298,
    ["Grunt cssmin task"] = 300,
    HEMTT = 672,
    Hadolint = 684,
    Hammerkit = 712,
    ["Hardware Sentry Configuration"] = 766,
    Hatch = 685,
    Hayson = 305,
    ["Haystack Pipeline"] = 306,
    ["Hazelcast 5 Configuration"] = 307,
    ["Helm Chart.lock"] = 147,
    ["Helm Chart.yaml"] = 146,
    ["Helm Unittest Test Suite"] = 148,
    Hugo = 742,
    ["Hugo Theme"] = 741,
    ["IBM Zapp document"] = 312,
    ["IBM zCodeFormatSettings"] = 313,
    ["IMG Catapult PSP"] = 318,
    ["IVMS101 by CODE Protocol"] = 829,
    Istanbul = 769,
    ["JDownloader2 crawler multi-rules"] = 328,
    ["JDownloader2 crawler single-rules"] = 327,
    ["JFrog Applications Config"] = 329,
    ["JFrog File Spec"] = 330,
    ["JFrog Pipelines YML DSL"] = 775,
    ["JMeter DSL cli config"] = 331,
    JReleaser = 333,
    ["JSON Document Transform"] = 341,
    ["JSON Feed"] = 342,
    ["JSON Resume"] = 509,
    ["JSON Schema Draft 2020-12"] = 649,
    ["JSON Schema Draft 4"] = 646,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 813,
    ["JSON Schema Draft 7"] = 647,
    ...
    ["JSON-stat 2.0"] = 643,
    JSONPatch = 344,
    ["JSR Package Config (jsr.json)"] = 334,
    Jasmine = 323,
    Jekyll = 324,
    ["Jenkins X Pipelines"] = 325,
    ["Jenkins X Requirements"] = 326,
    ["Jovo Language Models"] = 332,
    ["KIMMDY config file"] = 349,
    ["KSP-AVC"] = 644,
    ["KSP-CKAN"] = 645,
    KSY = 841,
    ["Karakum configuration file"] = 266,
    Kas = 347,
    ["Keycloak REST API"] = 783,
    ["Knative Functions - func.yaml"] = 267,
    ["KoDE/CI build.yaml"] = 771,
    ["Kong DBLess config"] = 772,
    KrakenD = 350,
    LOOBin = 369,
    Lefthook = 358,
    ["Liferay client-extension.yaml"] = 365,
    ["LinkML Metamodel"] = 367,
    Liquibase = 718,
    ["Liquibase Flow File"] = 719,
    ["Lively Properties"] = 368,
    ["Lobe AI Agent"] = 64,
    ["MLOS Configs"] = 403,
    ["MS2Rescore Configuration"] = 406,
    ["Madness (madness.yml)"] = 794,
    Markdownlint = 722,
    ["Mason Registry"] = 724,
    ["MegaLinter configuration"] = 375,
    ["MegaLinter descriptor"] = 376,
    Melange = 820,
    ["Meltano plugin discovery definition"] = 378,
    ["Meltano project definition"] = 377,
    ["Mergify Configuration"] = 407,
    ["MetricsHub Configuration"] = 379,
    ["MetricsHub Connector Configuration"] = 380,
    ["Micro Editor Syntax"] = 804,
    ["Microsoft Band Web Tile"] = 381,
    ["Minecraft Custom Main Menu Mod"] = 821,
    ["Minecraft Data Pack Advancement"] = 383,
    ["Minecraft Data Pack Biome"] = 384,
    ["Minecraft Data Pack Configured Carver"] = 385,
    ["Minecraft Data Pack Damage Type"] = 386,
    ["Minecraft Data Pack Dimension"] = 388,
    ["Minecraft Data Pack Dimension Type"] = 387,
    ["Minecraft Data Pack Item Modifier"] = 389,
    ["Minecraft Data Pack Loot Table"] = 390,
    ["Minecraft Data Pack Metadata"] = 391,
    ["Minecraft Data Pack Predicate"] = 392,
    ["Minecraft Data Pack Recipe"] = 393,
    ["Minecraft Data Pack Tag"] = 394,
    ["Minecraft Data Pack Template Pool"] = 395,
    ["Minecraft Data Pack Trim Material"] = 400,
    ["Minecraft Data Pack Trim Pattern"] = 401,
    ["Minecraft Resource Pack Lang"] = 396,
    ["Minecraft Resource Pack Particle"] = 397,
    ["Minecraft Resource Pack Texture Mcmeta"] = 399,
    ["Minecraft Resourcepack Sounds"] = 398,
    ["MkDocs Configuration 1.0"] = 402,
    ["Monade CLI Stack Configuration"] = 410,
    ["MongoDB Atlas Search Index Definition"] = 770,
    ["Monika Configuration"] = 768,
    ["Monoweave Configuration"] = 405,
    ["Motif config"] = 668,
    ["NOX Framework (Service)"] = 422,
    ["Netin Diagnostic System Template"] = 728,
    ["Netlify config"] = 413,
    ["Network-as-Code Data Model"] = 414,
    ["Nightwatch.js"] = 415,
    ["Nuitka.yaml"] = 834,
    ["ONe's changelog entry"] = 438,
    ["ONe's service descriptor"] = 437,
    ["OSS Review Toolkit configuration"] = 445,
    ["OSS Review Toolkit curation"] = 446,
    ["OSS Review Toolkit package configuration"] = 447,
    ["OSS Review Toolkit repository configuration"] = 448,
    ["OSS Review Toolkit resolutions"] = 449,
    Opctl = 671,
    ["OpenRewrite Resource"] = 440,
    ["OpenUtau character yaml"] = 434,
    ["OpenUtau ustx"] = 435,
    ["OpenWeather Current Weather API"] = 709,
    ["OpenWeather Road Risk API"] = 708,
    ["Ory Hydra configuration"] = 311,
    ["Ory Keto configuration"] = 352,
    ["Ory Kratos configuration"] = 444,
    ["Ory Oathkeeper configuration"] = 429,
    ["Outblocks App configuration"] = 442,
    ["Outblocks database table"] = 443,
    ["Outblocks project configuration"] = 441,
    PDM = 455,
    Packer = 452,
    Pantsbuild = 790,
    ["Paper paper-plugin.yml"] = 453,
    ["Pipeline component"] = 720,
    ["PocketMine plugin.yml"] = 460,
    ["Postman collection"] = 465,
    ["Problem object RFC9457"] = 818,
    ["Problem package generators"] = 473,
    Pterodactyl = 765,
    ["Pull Request Labeler"] = 488,
    Pulumi = 494,
    PyProject = 495,
    Pyright = 496,
    Qgoda = 497,
    Qodana = 738,
    ["Quali Torque Blueprint Spec 2"] = 763,
    ["QueryFirst config file"] = 786,
    ["RKE Cluster Configuration JSON"] = 717,
    ["RKE Cluster Configuration YAML"] = 716,
    ["Rancher Fleet"] = 491,
    ["Rattler-build"] = 498,
    Ray = 683,
    ["Read the Docs"] = 493,
    ["Red-DiscordBot Cog"] = 499,
    ["Red-DiscordBot Cog Repo"] = 500,
    ["Red-DiscordBot Trivia"] = 501,
    ["Render Blueprints"] = 715,
    RenderCV = 511,
    Renovate = 510,
    ["Replit config"] = 505,
    RoadRunner = 512,
    ["Rudder techniques"] = 824,
    Ruff = 507,
    ["Rust Project"] = 508,
    ["Rust toolchain"] = 515,
    ["SDMX data message"] = 540,
    ["SDMX metadata message"] = 539,
    ["SDMX structure message"] = 538,
    ["SIL Kit Participant Configuration"] = 550,
    ["SIL Kit Registry Configuration"] = 551,
    SWADL = 576,
    ["Safebox Config"] = 776,
    ["Sapphire CLI Config"] = 518,
    ["SauceCTL Configuration"] = 725,
    ["Schema Catalog"] = 532,
    ["Scoop manifest"] = 537,
    ["Semantic Data Fabric (SDF) file"] = 541,
    ["Semgrep Rule"] = 543,
    ["Serenity Code Generator (Sergen)"] = 544,
    ["Serverless Framework Configuration"] = 732,
    ["Serverless Workflow"] = 734,
    ["Settings.paf"] = 546,
    ["Shopware 6 Configuration"] = 735,
    ["Shopware CLI Extension Store Configuration"] = 736,
    ["Shopware CLI Project Store Configuration"] = 737,
    Sigma = 548,
    ["Sigrid scope configuration file"] = 549,
    ["SkyPilot Task JSON"] = 825,
    ["Slack app manifest"] = 553,
    Solidarity = 556,
    ["Solution filters"] = 557,
    ["Source Maps v3"] = 558,
    Sourcery = 559,
    SpecIF = 560,
    ["Sponge Mixin configuration"] = 561,
    StackBlitz = 566,
    ["StackHawk Scanner Configuration"] = 731,
    Stale = 567,
    ["Starlake Data Pipeline"] = 706,
    Starship = 568,
    ["Statamic Blueprint"] = 569,
    ["Stella configuration file"] = 570,
    ["StrmPrivacy Data Connector"] = 780,
    ["StrmPrivacy Data Contract"] = 781,
    ["StrmPrivacy SimpleSchema"] = 778,
    ["StrmPrivacy Stream"] = 779,
    ["StrmPrivacy batch job configuration file"] = 777,
    ["Stryker Mutator"] = 573,
    ["StyleCop Analyzers Configuration"] = 574,
    ["Stylelint (.stylelintrc)"] = 575,
    ["Sublime Syntax"] = 782,
    ["Subsquid squid manifest"] = 827,
    ["Swagger API 2.0"] = 577,
    TSON = 603,
    TSTyche = 604,
    Talhelper = 579,
    ["Talisman configuration"] = 580,
    ["Taskfile config"] = 711,
    Taurus = 581,
    ["TestEnvironment.json"] = 590,
    ["TextMate Grammar"] = 589,
    ["Tier.run pricing.json"] = 584,
    Tikibase = 585,
    ["Traefik v2"] = 593,
    ["Traefik v2 File Provider"] = 594,
    ["Travis CI (.travis.yml)"] = 592,
    TunnelHub = 817,
    Turborepo = 591,
    Tye = 739,
    ["UET BuildConfig.json"] = 787,
    ["UI5 Manifest"] = 613,
    ["UNCORS configuration"] = 617,
    ["UTAM Page Object"] = 616,
    ["Ubuntu Server Autoinstall"] = 611,
    ["Uniswap Token List"] = 694,
    ["Unreal Engine Uplugin"] = 788,
    ["Unreal Engine Uproject"] = 789,
    ["Updatecli Compose"] = 747,
    ["Updatecli Policy Manifest"] = 748,
    ["Updatecli Policy Metadata"] = 749,
    Uplift = 785,
    ["User Journey Map"] = 714,
    V2Ray = 753,
    ["VSCode Code Snippets"] = 166,
    ["VSIX CLI publishing"] = 631,
    ["Vela Pipeline Configuration"] = 620,
    Vercel = 165,
    Visivo = 815,
    ["Web App Manifest"] = 638,
    ["Web types"] = 641,
    WebExtensions = 637,
    ["Webman package recipe"] = 759,
    ["Windows Package Manager Installer Manifest"] = 691,
    ["Windows Package Manager Locale Manifest"] = 692,
    ["Windows Package Manager Singleton Manifest"] = 690,
    ["Woodpecker pipeline config"] = 727,
    ["Wrangler CLI"] = 642,
    ["Xstate Machine"] = 745,
    ["Yarn Config (.yarnrc.yml)"] = 704,
    ["Yippee-Ki-JSON configuration YML"] = 696,
    ["aerleon.yml"] = 7,
    ["angular.json"] = 15,
    apko = 819,
    ...
    ["behat.yml"] = 89,
    ["bigquery-table"] = 81,
    ["bioimageio resource description"] = 835,
    ...
    ["crowdin.yml"] = 190,
    ["custom-elements.json"] = 807,
    ["cypress.json"] = 194,
    ["datalogic-scan2deploy-android"] = 203,
    ["datalogic-scan2deploy-ce"] = 204,
    ["dbt Project"] = 127,
    ["ddev-global"] = 205,
    ["ddev-project"] = 206,
    ["debugsettings.json"] = 207,
    ["dependabot-v2.json"] = 210,
    ["dependabot.json"] = 209,
    ["deployed-cli"] = 744,
    ...
    ["devspace.yaml"] = 767,
    djlint = 699,
    ["docker sequencer"] = 215,
    ["docker-compose.yml"] = 697,
    ["dockerd.json"] = 214,
    ["dotnet Release Index manifest"] = 225,
    ["dotnet-tools.json"] = 226,
    ["dotnetcli.host.json"] = 227,
    ["dprint.json"] = 228,
    ["drone.json"] = 229,
    ["dss-2.0.0.json"] = 231,
    ["dstack configuration"] = 232,
    ["dvc.yaml"] = 233,
    ["ecosystem.json"] = 238,
    eksctl = 239,
    ["electron-builder configuration file"] = 246,
    ["epr-manifest.json"] = 244,
    ["evcc.yaml"] = 247,
    ["ezd task runner"] = 249,
    ["fabric.mod.json"] = 252,
    ["first-timers-bot"] = 258,
    ...
    ["gitlab-ci"] = 284,
    ["global.json"] = 286,
    ["go-feature-flag Flag Configuration"] = 289,
    ["haxelib.json"] = 304,
    helmfile = 686,
    helmwave = 687,
    ["host-meta.json"] = 309,
    ...
    ["ide.host.json"] = 314,
    ["ifstate.conf"] = 315,
    ["imageoptimizer.json"] = 316,
    ["importmap.json"] = 319,
    ["ioBroker Configuration"] = 320,
    ["ioBroker JSON UI"] = 321,
    ["ioBroker Package manifest"] = 322,
    ["ize.toml"] = 784,
    ["jsconfig.json"] = 345,
    ["jscpd Configuration"] = 764,
    jsdoc = 682,
    ["k3d.yaml"] = 346,
    ["k9s plugin.yml"] = 348,
    ["kontinuous-config.yaml"] = 354,
    ["kontinuous-values.yaml"] = 353,
    ["kustomization.yaml"] = 355,
    ["label-commenter-config.yml"] = 356,
    ["latexindent configuration"] = 63,
    ["launchsettings.json"] = 357,
    lazydocker = 806,
    lazygit = 805,
    ["lego.json"] = 359,
    ["lerna.json"] = 360,
    ["lgtm.yml"] = 361,
    ["liblab.config.json"] = 362,
    ["libman.json"] = 363,
    ["license-report-config.json"] = 364,
    ["linkinator.config.json"] = 366,
    ["lint-staged (.lintstagedrc)"] = 662,
    ["local.settings.json"] = 371,
    ["localazy.json"] = 372,
    ["lotus.yaml"] = 370,
    ["lsdlschema.json"] = 373,
    ["markdown-link-check"] = 723,
    mboats = 730,
    ["micro-settings.json"] = 799,
    ["mimetypes.json"] = 382,
    ["mirrord config"] = 663,
    mise = 664,
    ["mise-settings"] = 665,
    ...
    ["mtad.yaml"] = 667,
    ["mycode.json"] = 411,
    ["napari plugin manifest"] = 412,
    neoload = 677,
    ["nest-cli"] = 418,
    ["ninjs (News in JSON) 1.3"] = 417,
    ["ninjs (News in JSON) 2.0"] = 416,
    ["nixd configuration"] = 823,
    ["nlu.json"] = 419,
    ["nodemon.json"] = 421,
    ["noodl config"] = 729,
    now = 673,
    ...
    ["nswag.json"] = 427,
    ntangle = 428,
    ["nuclei-template.yaml"] = 425,
    ["nuget-project.json"] = 426,
    ["ocelot.json"] = 430,
    ["omnisharp.json"] = 431,
    ["openapi.json"] = 432,
    ["openfin.json"] = 439,
    ...
    ["ops.yaml"] = 436,
    ["package.json"] = 450,
    ["package.manifest"] = 451,
    ["partial-black.json"] = 90,
    ["pathfinder.yml"] = 454,
    ["pattern.json"] = 457,
    ["petstore-v1.0"] = 774,
    pgap_yaml_input_reader = 456,
    ["pixi.toml"] = 458,
    ["plagiarize-me.yaml"] = 462,
    ["plagiarize.yaml"] = 461,
    ["portman.json"] = 463,
    ["prettierrc.json"] = 471,
    ["prisma.yml"] = 472,
    ["project-1.0.0-beta3.json"] = 475,
    ["project-1.0.0-beta4.json"] = 476,
    ["project-1.0.0-beta5.json"] = 477,
    ["project-1.0.0-beta6.json"] = 478,
    ["project-1.0.0-beta8.json"] = 479,
    ["project-1.0.0-rc1.json"] = 480,
    ["project-1.0.0-rc2.json"] = 481,
    ["project.json"] = 474,
    ["prometheus.json"] = 482,
    ["prometheus.rules.json"] = 483,
    ["prometheus.rules.test.json"] = 484,
    ["proxies.json"] = 485,
    ["publiccode.yml"] = 486,
    ["pubspec.yaml"] = 487,
    ["pyrseas-0.8.json"] = 490,
    ["quilt.mod.json"] = 800,
    ["release drafter"] = 678,
    ["release-plz.toml"] = 503,
    ["rivet.yaml"] = 822,
    rockcraft = 513,
    rustfmt = 514,
    samt = 516,
    samtrc = 517,
    ["sarif-1.0.0.json"] = 519,
    ["sarif-2.0.0.json"] = 520,
    ["sarif-2.1.0"] = 530,
    ["sarif-2.1.0-rtm.2"] = 521,
    ["sarif-2.1.0-rtm.3"] = 523,
    ["sarif-2.1.0-rtm.4"] = 525,
    ["sarif-2.1.0-rtm.5"] = 527,
    ["sarif-2.1.0-rtm.6"] = 528,
    ["sarif-external-property-file-2.1.0"] = 531,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 522,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 524,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 526,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 529,
    ["schema.org - Action"] = 533,
    ["schema.org - ContactPoint"] = 534,
    ["schema.org - Place"] = 535,
    ["schema.org - Thing"] = 536,
    ["secrethub.yml"] = 802,
    ["semantic-release"] = 542,
    ["servicehub.config.json"] = 652,
    ["servicehub.service.json"] = 651,
    ["settings.job"] = 545,
    ["sfdx-hardis configuration"] = 547,
    ["shard.yml"] = 838,
    ["size-limit configuration"] = 552,
    ["skaffold.yaml"] = 721,
    ["skyuxconfig.json"] = 554,
    snapcraft = 555,
    ["sqlc configuration"] = 563,
    ["stripe-app-local.json"] = 572,
    ["stripe-app.json"] = 571,
    swcrc = 707,
    ["task.json"] = 578,
    taskcat = 674,
    ["template.json"] = 582,
    ["templatsources.json"] = 583,
    ["theme.json"] = 586,
    ["tizen_workspace.json"] = 587,
    tldr = 588,
    tmuxinator = 660,
    ["transcend.yml"] = 595,
    ["tree-sitter grammar.json"] = 294,
    ["trime.yaml"] = 596,
    ["trunk.yaml"] = 597,
    ["ts-force-config.json"] = 601,
    ["tsconfig.json"] = 598,
    ["tsd.json"] = 599,
    ["tsdrc.json"] = 600,
    ["tslint.json"] = 602,
    ...
    ["vega-lite.json"] = 619,
    ["vega.json"] = 618,
    ["venvironment-basic.yaml"] = 622,
    ["venvironment.yaml"] = 621,
    ["version.json"] = 623,
    ["vim-addon-info"] = 625,
    ["vs-2017.3.host.json"] = 627,
    ["vs-nesting.json"] = 628,
    ["vsls.json"] = 626,
    ["vss-extension.json"] = 632,
    ["vtesttree.yaml"] = 633,
    ["vtestunit.yaml"] = 634,
    ["warp-keysets.json"] = 808,
    ["warp-themes.json"] = 809,
    ["warp-workflows.json"] = 810,
    ["webhint.io"] = 760,
    ["webjobpublishsettings.json"] = 640,
    ["webjobs-list.json"] = 639,
    ["xs-app.json"] = 670,
    ["xunit.runner.json"] = 650,
    yamllint = 695,
    zuul = 679,
    ["Žinoma"] = 689
  },
