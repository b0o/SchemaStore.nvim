...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 105,
    [".cryproj (generic)"] = 407,
    [".cryproj engine-5.2"] = 402,
    [".cryproj engine-5.3"] = 403,
    [".cryproj engine-5.4"] = 404,
    [".cryproj engine-5.5"] = 405,
    [".cryproj engine-dev"] = 406,
    [".csscomb.json"] = 107,
    [".csslintrc"] = 108,
    [".eslintrc"] = 144,
    [".esmrc.json"] = 137,
    ...
    [".mtaext"] = 413,
    [".nodehawkrc"] = 252,
    [".npmpackagejsonlintrc"] = 254,
    [".phraseapp.yml"] = 281,
    [".pmbot.yml"] = 274,
    [".postcssrc"] = 279,
    [".pre-commit-config.yml"] = 280,
    [".putout.json"] = 298,
    [".rehyperc"] = 303,
    [".remarkrc"] = 304,
    [".sprite files"] = 339,
    ...
    [".vsext"] = 383,
    [".yarnrc.yml"] = 445,
    ["<div>RIOTS' studio configuration"] = 386,
    ["API Builder"] = 442,
    ...
    ["Azure Pipelines"] = 38,
    ["Azure Static Web Apps CLI configuration file"] = 341,
    ["Azure Static Web Apps configuration file"] = 340,
    ["Better Code Hub"] = 447,
    BizTalkServerApplicationSchema = 419,
    ...
    Devfile = 135,
    ["Discord Webhook"] = 119,
    ["Dolittle Artifacts"] = 121,
    ["Dolittle Bounded Context Configuration"] = 122,
    ["Dolittle Event Horizons Configuration"] = 123,
    ["Dolittle Resources Configuration"] = 124,
    ["Dolittle Server Configuration"] = 125,
    ["Dolittle Tenant Map Configuration"] = 127,
    ["Dolittle Tenants Configuration"] = 126,
    ["Dolittle Topology"] = 128,
    ["Drush site aliases"] = 132,
    ["Error pages"] = 140,
    Esquio = 138,
    ["Expo SDK"] = 143,
    ["F-Droid Data metadata"] = 147,
    ["Facets - FSDL - Application"] = 145,
    ["Fossa configuration file"] = 152,
    ["Fossa's fossa-deps file"] = 153,
    ["Foundry VTT - Manifest"] = 150,
    ["Foundry VTT - Template"] = 151,
    ["Foxx Manifest"] = 39,
    ["GatewayCore API Gateway"] = 156,
    ["GitHub Action"] = 160,
    ["GitHub Funding"] = 161,
    ["GitHub Issue Template configuration"] = 163,
    ["GitHub Workflow"] = 164,
    ["GitHub Workflow Template Properties"] = 165,
    ["GitHub issue forms"] = 162,
    GitVersion = 159,
    ["Gitpod Configuration"] = 167,
    ["Global Privacy Control"] = 157,
    ["Google Cloud Workflows"] = 94,
    Goreleaser = 170,
    ["Goreleaser Pro"] = 171,
    ["Gradle Build Cache Node"] = 444,
    ["Gradle Enterprise"] = 443,
    ["Grafana 5.x Dashboard"] = 172,
    ["GraphQL Code Generator"] = 175,
    ["GraphQL Config"] = 174,
    ["GraphQL Mesh"] = 173,
    ["Grunt JSHint task"] = 179,
    ["Grunt Watch task"] = 180,
    ["Grunt base task"] = 181,
    ["Grunt clean task"] = 177,
    ["Grunt copy task"] = 176,
    ["Grunt cssmin task"] = 178,
    HEMTT = 416,
    Hadolint = 428,
    ["Hammerkit YAML Schema"] = 454,
    Hayson = 183,
    ["Haystack Pipeline"] = 184,
    ["Hazelcast 5 Configuration"] = 185,
    ["Helm Chart.lock"] = 73,
    ["Helm Chart.yaml"] = 72,
    Hugo = 477,
    ["JFrog File Spec"] = 198,
    ["JSON Document Transform"] = 206,
    ["JSON Feed"] = 207,
    ["JSON Resume"] = 306,
    ["JSON Schema Draft 2020-12"] = 398,
    ["JSON Schema Draft 4"] = 395,
    ["JSON Schema Draft 7"] = 396,
    ["JSON Schema Draft 8"] = 397,
    ...
    ["JSON-API"] = 205,
    ["JSON-e templates"] = 452,
    ["JSON-stat 2.0"] = 392,
    JSONPatch = 209,
    Jekyll = 195,
    ["Jenkins X Pipelines"] = 196,
    ["Jenkins X Requirements"] = 197,
    ["Jovo Language Models"] = 199,
    ["KSP-AVC"] = 393,
    ["KSP-CKAN"] = 394,
    Liquibase = 459,
    ...
    ["Meltano project definition"] = 226,
    ["Microsoft Band Web Tile"] = 228,
    ["Minecraft Data Pack Advancement"] = 230,
    ["Minecraft Data Pack Biome"] = 231,
    ["Minecraft Data Pack Configured Carver"] = 232,
    ["Minecraft Data Pack Dimension"] = 234,
    ["Minecraft Data Pack Dimension Type"] = 233,
    ["Minecraft Data Pack Item Modifier"] = 235,
    ["Minecraft Data Pack Loot Table"] = 236,
    ["Minecraft Data Pack Metadata"] = 237,
    ["Minecraft Data Pack Predicate"] = 238,
    ["Minecraft Data Pack Recipe"] = 239,
    ["Minecraft Data Pack Template Pool"] = 240,
    ["Minecraft Resourcepack Sounds"] = 241,
    ["Netin Diagnostic System Template"] = 466,
    ["Netlify config schema"] = 246,
    ["Nightwatch.js"] = 247,
    ["OSS Review Toolkit repository configuration"] = 268,
    Opctl = 415,
    ["OpenWeather Current Weather API"] = 451,
    ["OpenWeather Road Risk API"] = 450,
    ["Ory Hydra configuration"] = 189,
    ["Ory Keto configuration"] = 213,
    ["Ory Kratos configuration"] = 267,
    ["Ory Oathkeeper configuration"] = 259,
    ["Outblocks App configuration"] = 265,
    ["Outblocks database table"] = 266,
    ["Outblocks project configuration"] = 264,
    Packer = 271,
    ["Pipeline component"] = 460,
    ["PocketMine plugin.yml"] = 275,
    ["Pull Request Labeler"] = 297,
    Qodana = 474,
    ["RKE Cluster Configuration JSON Schema"] = 458,
    ["RKE Cluster Configuration YAML Schema"] = 457,
    Ray = 427,
    ["Read the Docs"] = 300,
    ["Red-DiscordBot Cog"] = 301,
    ["Red-DiscordBot Cog Repo"] = 302,
    Renovate = 307,
    RoadRunner = 308,
    SWADL = 350,
    ["Sapphire CLI Config"] = 309,
    ["SauceCTL Configuration"] = 463,
    ["Schema Catalog"] = 322,
    ["Scoop manifest"] = 327,
    ["Semgrep Rule"] = 328,
    ["Serverless Framework Configuration"] = 470,
    ["Settings.paf"] = 330,
    ["Shopware 6 Configuration"] = 471,
    ["Shopware CLI Extension Store Configuration"] = 472,
    ["Shopware CLI Project Store Configuration"] = 473,
    Solidarity = 335,
    ["Source Maps v3"] = 336,
    SpecIF = 337,
    ["Sponge Mixin configuration"] = 338,
    ["StackHawk Scanner Configuration"] = 469,
    ["StackHead CLI config"] = 342,
    ["StackHead module configuration"] = 343,
    ["StackHead project definition"] = 344,
    Stale = 345,
    ["Statamic Blueprint"] = 346,
    ["Stryker Mutator"] = 347,
    ["StyleCop Analyzers Configuration"] = 348,
    ["Swagger API 2.0"] = 351,
    ["Taskfile YAML Schema"] = 453,
    Taurus = 352,
    ["TestEnvironment.json"] = 357,
    ["Traefik v2"] = 359,
    ["Traefik v2 File Provider"] = 360,
    Tye = 475,
    ["UI5 Manifest"] = 372,
    ["Ubuntu Server Autoinstall"] = 370,
    ["Uniswap Token List"] = 436,
    ["User Journey Map YAML Schema"] = 456,
    ["VSCode Code Snippets"] = 84,
    ["VSIX CLI publishing"] = 384,
    ["Vela Pipeline Configuration"] = 376,
    Vercel = 83,
    ["Web App Manifest"] = 388,
    ["Web types"] = 391,
    WebExtensions = 387,
    ["Windows Package Manager Installer Manifest"] = 433,
    ["Windows Package Manager Locale Manifest"] = 434,
    ["Windows Package Manager Singleton Manifest"] = 432,
    ["Woodpecker pipeline config"] = 465,
    ["Yippee-Ki-JSON configuration YML"] = 438,
    ["angular.json"] = 8,
    ...
    ["dependabot-v2.json"] = 116,
    ["dependabot.json"] = 115,
    ["detekt.yml"] = 118,
    devinit = 440,
    ["docfx.json"] = 120,
    ["docker-compose.yml"] = 439,
    ["dotnet Release Index manifest"] = 129,
    ["dotnetcli.host.json"] = 130,
    ["drone.json"] = 131,
    ["dss-2.0.0.json"] = 133,
    ["dvc.yaml"] = 134,
    ["ecosystem.json"] = 136,
    ["electron-builder configuration file."] = 141,
    ["epr-manifest.json"] = 139,
    ["evcc.yaml"] = 142,
    ["fabric.mod.json"] = 146,
    ["first-timers-bot"] = 149,
    fulibWorkflows = 464,
    ["func.yaml"] = 154,
    ["function.json"] = 155,
    ["geojson.json"] = 158,
    ["gitlab-ci"] = 166,
    ["global.json"] = 168,
    ["golangci-lint Configuration"] = 169,
    ["haxelib.json"] = 182,
    helmfile = 429,
    ["host-meta.json"] = 187,
    ["host.json"] = 186,
    ...
    httpmockrc = 420,
    huskyrc = 409,
    ["imageoptimizer.json"] = 190,
    ["importmap.json"] = 192,
    ["ioBroker JSON UI"] = 193,
    ["ioBroker Package manifest"] = 194,
    ["jsconfig.json"] = 210,
    jsdoc = 426,
    ["k3d.yaml"] = 211,
    ["kustomization.yaml"] = 214,
    ["label-commenter-config.yml"] = 215,
    ["launchsettings.json"] = 216,
    ["lerna.json"] = 217,
    ["lgtm.yml"] = 218,
    ["libman.json"] = 219,
    ["license-report-config.json"] = 220,
    ...
    ["mtad.yaml"] = 412,
    ["mycode.json"] = 244,
    ["napari plugin manifest"] = 245,
    neoload = 421,
    ["nest-cli"] = 250,
    ["ninjs (News in JSON) 1.3"] = 249,
    ["ninjs (News in JSON) 2.0"] = 248,
    ["nlu.json"] = 251,
    ["nodemon.json"] = 253,
    ["noodl.schema.json"] = 467,
    now = 417,
    ["nswag.json"] = 257,
    ntangle = 258,
    ["nuclei-template.yaml"] = 255,
    ["nuget-project.json"] = 256,
    ["ocelot.json"] = 260,
    ["omnisharp.json"] = 261,
    ["openapi.json"] = 262,
    ["openfin.json"] = 263,
    ["package.json"] = 269,
    ["package.manifest"] = 270,
    ["pattern.json"] = 273,
    pgap_yaml_input_reader = 272,
    ["plagiarize-me.yaml"] = 277,
    ["plagiarize.yaml"] = 276,
    ["portman.json"] = 278,
    ["prettierrc.json"] = 282,
    ["prisma.yml"] = 283,
    ["project-1.0.0-beta3.json"] = 285,
    ["project-1.0.0-beta4.json"] = 286,
    ["project-1.0.0-beta5.json"] = 287,
    ["project-1.0.0-beta6.json"] = 288,
    ["project-1.0.0-beta8.json"] = 289,
    ["project-1.0.0-rc1.json"] = 290,
    ["project-1.0.0-rc2.json"] = 291,
    ["project.json"] = 284,
    ["prometheus.json"] = 292,
    ["prometheus.rules.json"] = 293,
    ["proxies.json"] = 294,
    ["publiccode.yml"] = 295,
    ["pubspec.yaml"] = 296,
    ["pyrseas-0.8.json"] = 299,
    ["release drafter"] = 422,
    ["sarif-1.0.0.json"] = 310,
    ["sarif-2.0.0.json"] = 311,
    ["sarif-2.1.0"] = 320,
    ["sarif-2.1.0-rtm.2"] = 312,
    ["sarif-2.1.0-rtm.3"] = 314,
    ["sarif-2.1.0-rtm.4"] = 316,
    ["sarif-2.1.0-rtm.5"] = 318,
    ["sarif-external-property-file-2.1.0"] = 321,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 313,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 315,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 317,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 319,
    ["schema.org - Action"] = 323,
    ["schema.org - ContactPoint"] = 324,
    ["schema.org - Place"] = 325,
    ["schema.org - Thing"] = 326,
    ["service.datadog.yaml"] = 212,
    ["servicehub.config.json"] = 401,
    ["servicehub.service.json"] = 400,
    ["settings.job"] = 329,
    ["sfdx-hardis configuration"] = 331,
    ["size-limit configuration"] = 332,
    ["skaffold.yaml"] = 461,
    ["skyuxconfig.json"] = 333,
    snapcraft = 334,
    swcrc = 449,
    taskcat = 418,
    ["template.json"] = 353,
    ["templatsources.json"] = 354,
    ["theme.json"] = 355,
    tmLanguage = 356,
    ["trunk.yaml schema"] = 361,
    ["ts-force-config.json"] = 365,
    ["tsconfig.json"] = 362,
    ["tsd.json"] = 363,
    ["tsdrc.json"] = 364,
    ["tslint.json"] = 366,
    ...
    ["version.json"] = 377,
    ["vim-addon-info"] = 378,
    ["vs-2017.3.host.json"] = 380,
    ["vs-nesting.json"] = 381,
    ["vsls.json"] = 379,
    ["vss-extension.json"] = 385,
    ["webjobpublishsettings.json"] = 390,
    ["webjobs-list.json"] = 389,
    ["xs-app.json"] = 414,
    ["xunit.runner.json"] = 399,
    yamllint = 437,
    zuul = 423,
    ["Žinoma"] = 431
  },
