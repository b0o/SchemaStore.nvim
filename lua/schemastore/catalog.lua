...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 799,
    [".nodehawkrc"] = 501,
    [".npmpackagejsonlintrc"] = 505,
    [".omletrc"] = 973,
    [".phrase.yml"] = 566,
    [".phraseapp.yml"] = 567,
    [".pmbot.yml"] = 554,
    [".postcssrc"] = 561,
    [".powerpages-web-template-manifest"] = 563,
    [".pre-commit-config.yml"] = 564,
    [".pre-commit-hooks.yml"] = 565,
    [".putout.json"] = 588,
    [".rehyperc"] = 611,
    [".remarkrc"] = 615,
    [".sprite files"] = 682,
    ...
    ["A micro editor config"] = 454,
    ABCInventoryModuleData = 14,
    ABCSupplyPlan = 15,
    AIConfig = 16,
    ["AMX Muse Program Descriptor"] = 1017,
    ["API Builder"] = 834,
    ["AVA Configuration"] = 896,
    ["AWS AppConfig Feature Flags-v1"] = 45,
    ["AWS CDK cdk.json"] = 205,
    ["AWS CloudFormation"] = 206,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 207,
    ["AWS SAM CLI Samconfig"] = 208,
    ["Adobe UXP Manifest"] = 956,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    Air = 12,
    ["Airlock Microgateway"] = 17,
    ["Alacritty Configuration"] = 868,
    ["All Contributors configuration file"] = 921,
    ["Ansible Argument Specs"] = 338,
    ["Ansible Collection Galaxy"] = 345,
    ["Ansible Execution Environment"] = 335,
    ["Ansible Inventory"] = 344,
    ["Ansible Meta"] = 336,
    ["Ansible Meta Runtime"] = 337,
    ["Ansible Navigator Configuration"] = 347,
    ["Ansible Playbook"] = 342,
    ["Ansible Requirements"] = 339,
    ["Ansible Rulebook"] = 343,
    ["Ansible Tasks File"] = 341,
    ["Ansible Vars File"] = 340,
    ["Ansible-lint Configuration"] = 346,
    Any = 982,
    ["AnyWork Automation Configuration"] = 5,
    ["App config Spotify Backstage"] = 21,
    ["Application Accelerator"] = 2,
    ["Application list for a WinUtil"] = 999,
    ArchitectFX = 1004,
    ["Argo Events"] = 35,
    ["Argo Workflows"] = 36,
    AssemblyScript = 39,
    AsyncAPI = 40,
    ["AsyncAPI Tool File"] = 41,
    ["Atmos Manifests"] = 42,
    ["Aurora Agile Meta-Framework"] = 43,
    AutoAPICase = 931,
    ["Avro Avsc"] = 44,
    ["Azure Container App template for defining an immutable revision"] = 46,
    ...
    ["Azure Landing Zones Library archetype definition"] = 57,
    ["Azure Landing Zones Library archetype override"] = 58,
    ["Azure Landing Zones Library architecture definition"] = 56,
    ["Azure Landing Zones Library metadata"] = 54,
    ["Azure Landing Zones Library policy default values"] = 55,
    ["Azure Pipelines"] = 72,
    ["Azure Static Web Apps CLI configuration file"] = 686,
    ["Azure Static Web Apps configuration file"] = 685,
    ["BOSH Deploy Config"] = 96,
    ["BX CI"] = 114,
    ["Bashly (bashly.yml)"] = 925,
    ["Bashly Settings (bashly-settings.yml)"] = 926,
    ["Better Code Hub"] = 838,
    ["Better Scripts"] = 115,
    Bigconfig = 89,
    ["Biome Formatter Config"] = 59,
    ["Bitmovin Encoding Template"] = 1010,
    BizTalkServerApplicationSchema = 806,
    Bleep = 116,
    ["Block Protocol Metadata"] = 113,
    ["Boyka Framework"] = 97,
    Briefcase = 812,
    ["Build Info"] = 104,
    Buildkite = 106,
    ["Bukkit plugin.yml"] = 105,
    ["BungeeCord plugin.yml"] = 111,
    ["Butane Config"] = 881,
    C4InterFlow = 1025,
    ["CGS Card Game Specification (cgs.json)"] = 961,
    ["CICS TS region tagging"] = 890,
    ["CICS TS resource import"] = 891,
    ["CICS TS resource model"] = 892,
    ["CICS TS resource overrides"] = 893,
    ["CMake Presets"] = 117,
    ["CNC Codes"] = 134,
    ["CRS WAF test file"] = 989,
    ["CRS WAF test platform overrides file"] = 990,
    ["CSS Comb (.csscomb.json)"] = 233,
    ["CSS Lint (.csslintrc)"] = 234,
    ["CSpell (cspell.json)"] = 232,
    ["CVE Record Format"] = 141,
    CWL = 967,
    ["Cache Warmup config"] = 118,
    ["Calqulus pipeline"] = 119,
    ["Camel YAML DSL"] = 120,
    ["Cannon TOML"] = 121,
    Carafe = 122,
    ["Cargo Make"] = 124,
    ["Cargo Manifest"] = 123,
    ["Catalog Info Backstage"] = 125,
    ["Chamaleon environment"] = 1014,
    ["Chamaleon properties"] = 1015,
    ["Chamaleon template"] = 1013,
    Changesets = 217,
    Charmcraft = 126,
    Cheatsheets = 878,
    ["Chrome Extension"] = 198,
    ["Chromia Model"] = 127,
    ["CircleCI config.yml"] = 174,
    ["Citation File Format"] = 219,
    CityJSON = 129,
    ["Clawject config"] = 140,
    ["Cloud Foundry Application Manifest"] = 972,
    ["Cloud Run Spec v1"] = 994,
    ["CloudCannon Configuration"] = 68,
    ["CloudEvents specification"] = 130,
    ["Code Climate"] = 175,
    CodeCV = 66,
    CodeRabbit = 65,
    ["CodeShip Pro services configuration files"] = 187,
    ["CodeShip Pro steps configuration files"] = 188,
    ["Codecov configuration files"] = 186,
    CodifyCLI = 67,
    Codux = 184,
    ["Cog config file"] = 135,
    ["Commandbox Box.json"] = 136,
    ["Commandbox Server.json"] = 137,
    ["Common Catalog Data"] = 196,
    ["Common Package Specification"] = 138,
    Concord = 988,
    ["Configu .cfgu files"] = 977,
    ["Configu .configu file"] = 978,
    Conjure = 133,
    ["Container Structure Test"] = 820,
    Containerlab = 847,
    ["Contextive Glossary"] = 1039,
    Convex = 132,
    ["Crowdsec collection config"] = 227,
    ["Crowdsec parser config"] = 228,
    ["Crowdsec scenario config"] = 229,
    ["CumulusCI Config"] = 139,
    ["Custom Machinery Machine"] = 962,
    ["Custom Machinery Recipe"] = 963,
    ["Cycle Stack File"] = 142,
    CycloneDX = 143,
    ["DWP Exchange - catalogue entry"] = 276,
    ["DWP Exchange - gateway"] = 274,
    ["DWP Exchange - meta"] = 275,
    ["Dart Build Config (dart-build.json)"] = 235,
    ["Dart Test Config (dart-test.json)"] = 236,
    ["DashLord Configuration"] = 237,
    ["Data Contract Specification"] = 238,
    ["Data Product Specification"] = 239,
    ["DataYoga Connections"] = 144,
    ["DataYoga Job"] = 145,
    ["Databricks Asset Bundles"] = 942,
    ["Datadog Service Definition"] = 427,
    ["Datadog Software Catalog"] = 428,
    ["Datahub Ingestion Recipe"] = 897,
    ["Dein Config"] = 151,
    ["Deno Config (deno.json)"] = 245,
    ["Dependency cruiser"] = 152,
    ["DeployStack Configuration"] = 153,
    ["Deployer Recipe"] = 248,
    ["Deta Spacefile"] = 154,
    ["Detekt Config (detekt.yml)"] = 249,
    ["Devbox Config"] = 155,
    ["Devbox Plugin"] = 156,
    Devfile = 273,
    DipDup = 991,
    ["Discord Webhook"] = 250,
    ["DocFx Config (docfx.json)"] = 254,
    Dofigen = 255,
    ["Dolittle Artifacts"] = 256,
    ["Dolittle Bounded Context Configuration"] = 257,
    ["Dolittle Event Horizons Configuration"] = 258,
    ["Dolittle Resources Configuration"] = 259,
    ["Dolittle Server Configuration"] = 260,
    ["Dolittle Tenant Map Configuration"] = 262,
    ["Dolittle Tenants Configuration"] = 261,
    ["Dolittle Topology"] = 263,
    ["DonateCaseBetterCasino menu"] = 1018,
    ["Drupal Breakpoints"] = 157,
    ["Drupal Config"] = 169,
    ["Drupal Info"] = 158,
    ["Drupal Layouts"] = 159,
    ["Drupal Libraries"] = 160,
    ["Drupal Links Action"] = 161,
    ["Drupal Links Contextual"] = 162,
    ["Drupal Links Menu"] = 163,
    ["Drupal Links Task"] = 164,
    ["Drupal Migration"] = 165,
    ["Drupal Permissions"] = 166,
    ["Drupal Recipe"] = 167,
    ["Drupal Routing"] = 168,
    ["Drupal Services"] = 170,
    ["Drush site aliases"] = 269,
    ["Dynamic Bash Aliases (.aliases)"] = 933,
    ["EAS config"] = 293,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 922,
    ["EasyVCR .NET"] = 294,
    ["Eidolon Resource"] = 1005,
    ["Elgato Stream Deck"] = 279,
    Elm = 993,
    ["Embrace Config"] = 908,
    Endurica = 946,
    ["Enterprise Contract Policy Spec"] = 280,
    ["Erda Pipeline"] = 969,
    ["Erda Runtime"] = 970,
    Esquio = 282,
    ["Estuary Flow Catalog"] = 887,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 286,
    ["EveryVoice TTS Toolkit Data Configuration"] = 287,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 291,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 290,
    ["EveryVoice TTS Toolkit Text Configuration"] = 288,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 289,
    ["Expo SDK"] = 292,
    ["F-Droid Data metadata"] = 298,
    ["FasterCI Configuration"] = 73,
    FiQuS = 302,
    Firebase = 300,
    ["FlexGet Config"] = 303,
    ["Flow.json Configurations"] = 966,
    ["Fossa configuration file"] = 310,
    ["Fossa's fossa-deps file"] = 311,
    ["Foundry VTT - Base package Manifest"] = 305,
    ["Foundry VTT - Module Manifest"] = 306,
    ["Foundry VTT - System Data Template"] = 309,
    ["Foundry VTT - System Manifest"] = 307,
    ["Foundry VTT - World Manifest"] = 308,
    ["Foxx Manifest"] = 74,
    ["Freifunk.de Community API"] = 77,
    ["Frogbot Config"] = 78,
    ["G2P Mapping Configuration"] = 316,
    ["GCP Blueprint Metadata"] = 319,
    Gaspar = 317,
    ["GatewayCore API Gateway"] = 318,
    ["GeoJSON.json latest"] = 885,
    GherKing = 889,
    ["GitHub Action"] = 324,
    ["GitHub Actions typing"] = 1001,
    ["GitHub Discussion"] = 325,
    ["GitHub Funding"] = 326,
    ["GitHub Issue Template configuration"] = 327,
    ["GitHub Issue Template forms"] = 328,
    ["GitHub Workflow"] = 329,
    ["GitHub Workflow Template Properties"] = 330,
    ["GitHub automatically generated release notes configuration"] = 331,
    ["GitLab Agent for Kubernetes configuration"] = 958,
    GitVersion = 321,
    ["Gitea Issue Template configuration"] = 322,
    ["Gitea Issue Template forms"] = 323,
    ["Gitpod Automations"] = 333,
    ["Gitpod Configuration"] = 334,
    ["GlazeWM settings"] = 960,
    ["Global Privacy Control"] = 320,
    Goblet = 941,
    ["Golangci-lint Configuration"] = 349,
    ["Golangci-lint Custom Plugins Configuration"] = 350,
    ["Google Chrome Related Website Sets"] = 301,
    ["Google Cloud Workflows"] = 204,
    ["Google Digital Assetlinks"] = 1040,
    Goreleaser = 352,
    ["Goreleaser Pro"] = 353,
    Goss = 354,
    ["Gradle Build Cache Node"] = 836,
    ["Gradle Enterprise"] = 835,
    ["Grafana 5.x Dashboard"] = 355,
    ["GraphQL Code Generator"] = 359,
    ["GraphQL Config"] = 358,
    ["GraphQL Mesh"] = 357,
    ["Grunt JSHint task"] = 363,
    ["Grunt Watch task"] = 364,
    ["Grunt base task"] = 365,
    ["Grunt clean task"] = 361,
    ["Grunt copy task"] = 360,
    ["Grunt cssmin task"] = 362,
    HEMTT = 802,
    Hadolint = 816,
    Hammerkit = 846,
    ["Hardware Sentry Configuration"] = 901,
    Hatch = 817,
    Hayson = 367,
    ["Haystack Pipeline"] = 368,
    ["Hazelcast 5 Configuration"] = 369,
    ["Helm Chart.lock"] = 172,
    ["Helm Chart.yaml"] = 171,
    ["Helm Unittest Test Suite"] = 173,
    ["Homer dashboard configuration"] = 370,
    Hugo = 877,
    ["Hugo Theme"] = 876,
    ["Hyperfoil benchmark configuration"] = 376,
    ["IBM Zapp document"] = 377,
    ["IBM zCodeFormatSettings"] = 378,
    ["IMG Catapult PSP"] = 383,
    ["IVMS101 by CODE Protocol"] = 959,
    Infrahub = 385,
    Istanbul = 904,
    ["JDownloader2 crawler multi-rules"] = 395,
    ["JDownloader2 crawler single-rules"] = 394,
    ["JFrog Applications Config"] = 396,
    ["JFrog File Spec"] = 397,
    ["JFrog Pipelines YML DSL"] = 910,
    ["JMeter DSL cli config"] = 398,
    JReleaser = 400,
    ["JSON Document Transform"] = 408,
    ["JSON Feed"] = 409,
    ["JSON Resume"] = 620,
    ["JSON Schema Draft 2020-12"] = 785,
    ["JSON Schema Draft 4"] = 782,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 943,
    ["JSON Schema Draft 7"] = 783,
    ["JSON Schema Draft 7 (unofficial strict)"] = 944,
    ["JSON Schema Draft 8 (2019-09)"] = 784,
    ["JSON-API"] = 407,
    ["JSON-e templates"] = 843,
    ["JSON-stat 2.0"] = 778,
    JSONPatch = 411,
    ["JSR Package Config (jsr.json)"] = 401,
    Jasmine = 389,
    Jekyll = 390,
    ["Jenkins X Pipelines"] = 391,
    ["Jenkins X Requirements"] = 392,
    Jest = 393,
    ["Jovo Language Models"] = 399,
    ["KIMMDY config file"] = 422,
    ["KODE/CI build.yaml"] = 906,
    ["KSP-AVC"] = 779,
    ["KSP-CKAN"] = 780,
    ["KSP-NetKAN"] = 781,
    KSY = 971,
    KSail = 314,
    ["Karakum configuration file"] = 312,
    Kas = 414,
    ["Kestra flow file"] = 423,
    ["Keycloak REST API"] = 913,
    ["Knative Functions - func.yaml"] = 313,
    ["Kometa (nightly) config file"] = 425,
    ["Kometa config file"] = 424,
    ["Kong DBLess config"] = 907,
    KrakenD = 426,
    ["Kubri Configuration"] = 432,
    LOOBin = 447,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 209,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 210,
    ["Landing Zone Accelerator on AWS - Global Config"] = 211,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 212,
    ["Landing Zone Accelerator on AWS - Network Config"] = 213,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 214,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 215,
    ["Landing Zone Accelerator on AWS - Security Config"] = 216,
    ["Language configuration"] = 981,
    Lefthook = 436,
    ["Liferay client-extension.yaml"] = 443,
    ["LinkML Metamodel"] = 445,
    Liquibase = 852,
    ["Liquibase Flow File"] = 853,
    ["Lively Properties"] = 446,
    ["Lobe AI Agent"] = 70,
    Loki = 71,
    ["MLOS Configs"] = 485,
    ["MS2Rescore Configuration"] = 488,
    ["Madness (madness.yml)"] = 924,
    ["MapEHR Mapping"] = 453,
    Markdownlint = 856,
    ["Mason Registry"] = 859,
    ["MegaLinter configuration"] = 455,
    ["MegaLinter descriptor"] = 456,
    Melange = 950,
    ["Meltano project definition"] = 457,
    ["Mergify Configuration"] = 489,
    ["Metadata for a Bazel module"] = 458,
    ["Metadata for a Cinnamon spice"] = 997,
    ["Metatype Configuration"] = 459,
    ["MetricsHub Configuration"] = 460,
    ["MetricsHub Connector Configuration"] = 461,
    ["Micro Editor Syntax"] = 934,
    ["Microsoft Band Web Tile"] = 462,
    ["Microsoft RulesEngine workflow rules"] = 985,
    ["Microsoft RulesEngine workflow rules list"] = 986,
    ["Minecraft Custom Main Menu Mod"] = 951,
    ["Minecraft Data Pack Advancement"] = 464,
    ["Minecraft Data Pack Biome"] = 465,
    ["Minecraft Data Pack Configured Carver"] = 466,
    ["Minecraft Data Pack Damage Type"] = 467,
    ["Minecraft Data Pack Dimension"] = 469,
    ["Minecraft Data Pack Dimension Type"] = 468,
    ["Minecraft Data Pack Item Modifier"] = 470,
    ["Minecraft Data Pack Loot Table"] = 471,
    ["Minecraft Data Pack Metadata"] = 472,
    ["Minecraft Data Pack Predicate"] = 473,
    ["Minecraft Data Pack Recipe"] = 474,
    ["Minecraft Data Pack Tag"] = 475,
    ["Minecraft Data Pack Template Pool"] = 476,
    ["Minecraft Data Pack Trim Material"] = 481,
    ["Minecraft Data Pack Trim Pattern"] = 482,
    ["Minecraft Resource Pack Lang"] = 477,
    ["Minecraft Resource Pack Particle"] = 478,
    ["Minecraft Resource Pack Texture Mcmeta"] = 480,
    ["Minecraft Resourcepack Sounds"] = 479,
    ["Monade CLI Stack Configuration"] = 492,
    ["MongoDB Atlas Search Index Definition"] = 905,
    ["Monika Configuration"] = 903,
    ["Monoweave Configuration"] = 487,
    ["Motif config"] = 798,
    MultiQC = 1033,
    ["NOX Framework (Service)"] = 504,
    ["Netin Diagnostic System Template"] = 863,
    ["Netlify config"] = 495,
    ["Network-as-Code Data Model"] = 496,
    ["Nightwatch.js"] = 497,
    ["Node.js configuration"] = 803,
    ["NueJS configuration file"] = 509,
    ["Nuitka.yaml"] = 964,
    ["Nullstone config"] = 511,
    ["ONe's changelog entry"] = 525,
    ["ONe's service descriptor"] = 524,
    ["OSCAL Assessment Plan (AP)"] = 533,
    ["OSCAL Assessment Results (AR)"] = 534,
    ["OSCAL Catalog"] = 535,
    ["OSCAL Component Definition (CDef)"] = 536,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 537,
    ["OSCAL Profile"] = 538,
    ["OSCAL System Security Plan (SSP)"] = 539,
    ["OSS Review Toolkit configuration"] = 540,
    ["OSS Review Toolkit curation"] = 541,
    ["OSS Review Toolkit package configuration"] = 542,
    ["OSS Review Toolkit repository configuration"] = 543,
    ["OSS Review Toolkit resolutions"] = 544,
    ["October CMS columns"] = 515,
    ["October CMS fields"] = 516,
    Okteto = 517,
    Opctl = 801,
    ["Open Data Contract Standard (ODCS)"] = 528,
    ["Open Know-How"] = 1038,
    ["OpenRewrite Resource"] = 527,
    ["OpenUtau character yaml"] = 521,
    ["OpenUtau ustx"] = 522,
    ["OpenWeather Current Weather API"] = 842,
    ["OpenWeather Road Risk API"] = 841,
    ["Ory Hydra configuration"] = 375,
    ["Ory Keto configuration"] = 429,
    ["Ory Kratos configuration"] = 532,
    ["Ory Oathkeeper configuration"] = 513,
    ["Outblocks App configuration"] = 530,
    ["Outblocks database table"] = 531,
    ["Outblocks project configuration"] = 529,
    PDM = 550,
    Packer = 547,
    Pantsbuild = 920,
    ["Paper paper-plugin.yml"] = 548,
    ["Pipeline component"] = 854,
    ["Plex Prerolls"] = 558,
    ["PocketMine plugin.yml"] = 555,
    ["Postman collection"] = 562,
    ["Preset list for a WinUtil"] = 1000,
    ["Problem object RFC9457"] = 948,
    ["Problem package generators"] = 571,
    Pterodactyl = 900,
    ["Pull Request Labeler"] = 587,
    Pulumi = 595,
    ["PyGTA Config"] = 591,
    PyProject = 596,
    Pylock = 1041,
    ...
    Qgoda = 599,
    Qodana = 873,
    ["Qt Creator workspace file"] = 979,
    ["Quali Torque Blueprint Spec 2"] = 898,
    ["QueryFirst config file"] = 916,
    ["RKE Cluster Configuration JSON"] = 851,
    ["RKE Cluster Configuration YAML"] = 850,
    RadioHound = 590,
    Railway = 600,
    ["Rancher Fleet"] = 592,
    ["Rattler-build"] = 601,
    Ray = 815,
    ["Read the Docs"] = 594,
    ["Red-DiscordBot Cog"] = 608,
    ["Red-DiscordBot Cog Repo"] = 609,
    ["Red-DiscordBot Trivia"] = 610,
    ["Render Blueprints"] = 849,
    RenderCV = 622,
    Renovate = 621,
    ["Replit config"] = 616,
    Restate = 1028,
    RoadRunner = 624,
    ["Rudder techniques"] = 954,
    Ruff = 618,
    ["Rust Project"] = 619,
    ["Rust toolchain"] = 628,
    ["SDMX data message"] = 654,
    ["SDMX metadata message"] = 653,
    ["SDMX structure message"] = 652,
    ["SIL Kit Participant Configuration"] = 664,
    ["SIL Kit Registry Configuration"] = 665,
    ["SPDX 2.3"] = 683,
    SWADL = 697,
    ["Safebox Config"] = 911,
    ["Sapphire CLI Config"] = 631,
    ["SauceCTL Configuration"] = 860,
    ["Schema Catalog"] = 646,
    ["Scoop manifest"] = 651,
    ["Semantic Data Fabric (SDF) file"] = 655,
    ["Semgrep Rule"] = 657,
    ["Serenity Code Generator (Sergen)"] = 658,
    ["Serverless Framework Configuration"] = 867,
    ["Serverless Workflow"] = 869,
    ["Settings for a Cinnamon spice"] = 996,
    ["Settings.paf"] = 660,
    ["Shopware 6 Configuration"] = 870,
    ["Shopware CLI Extension Store Configuration"] = 871,
    ["Shopware CLI Project Store Configuration"] = 872,
    ["Sigma Detection Rule"] = 662,
    ["Sigrid scope configuration file"] = 663,
    ["SkyPilot Task JSON"] = 955,
    ["Slack app manifest"] = 667,
    Solidarity = 672,
    ["Solution filters"] = 673,
    ["Source Maps v3"] = 674,
    Sourcery = 675,
    ["Speakeasy Generation Config File"] = 679,
    ["Speakeasy Lint Configuration File"] = 676,
    ["Speakeasy Test Generation Configuration File"] = 677,
    ["Speakeasy Workflow File"] = 678,
    SpecIF = 680,
    ["Sponge Mixin configuration"] = 681,
    StackBlitz = 687,
    ["StackHawk Scanner Configuration"] = 866,
    Stale = 688,
    ["Starlake Data Pipeline"] = 839,
    Starship = 689,
    ["Statamic Blueprint"] = 690,
    ["Stella configuration file"] = 691,
    ["Stryker Mutator"] = 694,
    ["StyleCop Analyzers Configuration"] = 695,
    ["Stylelint (.stylelintrc)"] = 696,
    ["Sublime Syntax"] = 912,
    ["Subsquid squid manifest"] = 957,
    ["Swagger API 2.0"] = 698,
    ["Synadia Connect Component"] = 699,
    TSON = 733,
    TSTyche = 734,
    ["Tab data for a LinUtil"] = 1003,
    ["Tab list for a LinUtil"] = 1002,
    Tach = 700,
    ["Tach Domain"] = 701,
    Talhelper = 703,
    ["Talisman configuration"] = 704,
    ["Taskfile config"] = 844,
    Taurus = 705,
    Tauticord = 706,
    Telefonistka = 1029,
    ["TestEnvironment.json"] = 716,
    ["TextMate Grammar"] = 715,
    ["Tier.run pricing.json"] = 709,
    Tikibase = 710,
    Tombi = 714,
    ["Traefik v2"] = 719,
    ["Traefik v2 File Provider"] = 720,
    ["Traefik v3"] = 721,
    ["Traefik v3 File Provider"] = 722,
    ["Travis CI (.travis.yml)"] = 718,
    Trident = 1027,
    ["TrueScript for *.tscript files"] = 725,
    ["Tugboat QA config.yml"] = 1024,
    TunnelHub = 947,
    Turborepo = 717,
    Tycho = 992,
    Tye = 874,
    ["Tyk Gateway - Open Source v5.7+"] = 1034,
    ["UET BuildConfig.json"] = 917,
    ["UI5 Manifest"] = 744,
    ["UNCORS configuration"] = 748,
    ["UTAM Page Object"] = 747,
    ["Ubuntu Server Autoinstall"] = 742,
    ["Uniswap Token List"] = 827,
    ["Universal Schedule Format"] = 749,
    ["Unreal Engine Uplugin"] = 918,
    ["Unreal Engine Uproject"] = 919,
    ["Updatecli Compose"] = 882,
    ["Updatecli Policy Manifest"] = 883,
    ["Updatecli Policy Metadata"] = 884,
    Uplift = 915,
    ["User Journey Map"] = 848,
    V2Ray = 888,
    ["VSCode Code Snippets"] = 192,
    ["VSIX CLI publishing"] = 767,
    Vector = 751,
    ["Vela Pipeline Configuration"] = 754,
    Vercel = 191,
    ["Version Bumper config"] = 757,
    ["Viash Component Config"] = 1031,
    ["Viash Package Config"] = 1032,
    Visivo = 945,
    Wake = 1026,
    ["Waku Config"] = 1006,
    ["Web App Manifest"] = 773,
    ["Web types"] = 776,
    WebExtensions = 772,
    ["Webman package recipe"] = 894,
    ["Windows Package Manager Installer Manifest"] = 823,
    ["Windows Package Manager Locale Manifest"] = 824,
    ["Windows Package Manager Singleton Manifest"] = 822,
    Winutil = 825,
    ["WireMock stub mapping"] = 1009,
    ["Woodpecker pipeline config"] = 862,
    ["Wrangler CLI"] = 777,
    ["Xstate Machine"] = 880,
    ["Yandex Workflow Language"] = 998,
    ["Yarn Config (.yarnrc.yml)"] = 837,
    ["Yippee-Ki-JSON configuration YML"] = 829,
    ["YouTrack App"] = 995,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 18,
    apko = 949,
    ...
    ["arc.json"] = 34,
    ["architect.yml"] = 33,
    ["artifacthub-repo.yml"] = 37,
    ["asm-lsp"] = 38,
    ["babelrc.json"] = 80,
    ["bamboo-spec"] = 83,
    ["bashly-strings.yml"] = 927,
    ["batect.yml"] = 82,
    ["beef-database-codegen"] = 84,
    ["beef-database-v5-codegen"] = 86,
    ["beef-entity-codegen"] = 85,
    ["beef-entity-v5-codegen"] = 87,
    ["behat.yml"] = 98,
    ["bigquery-table"] = 88,
    ["bioimageio resource description"] = 965,
    ["bitbucket-pipelines"] = 90,
    bitrise = 91,
    ["bitrise-step"] = 92,
    ["block.json"] = 112,
    ["bottom configuration"] = 60,
    ["bower.json"] = 94,
    ["bozr.suite.json"] = 100,
    bpkg = 928,
    ["browser.i18n.json"] = 101,
    ["browsh configuration"] = 102,
    bucklescript = 103,
    ["buf.gen.yaml"] = 62,
    ["buf.plugin.yaml"] = 63,
    ["buf.work.yaml"] = 64,
    ["buf.yaml"] = 61,
    ["bun.lock"] = 108,
    ["bundleconfig.json"] = 109,
    ["bunfig.toml"] = 110,
    ["ccmod.json"] = 1007,
    changelogging = 976,
    ["chisel-slices.json"] = 218,
    ["chrome-extension-locales-messages.json"] = 199,
    ["chutzpah.json"] = 200,
    cibuildwheel = 128,
    ["clang-format (.clang-format)"] = 886,
    ["clang-tidy"] = 179,
    clangd = 178,
    clib = 180,
    ["cloud-init: cloud-config userdata"] = 182,
    ["cloud-sdk-pipeline-configuration"] = 202,
    ["cloudbuild.json"] = 203,
    cloudify = 181,
    codemagic = 183,
    ["coffeelint.json"] = 220,
    ["commands.json"] = 195,
    ["commitlint (.commitlintrc)"] = 826,
    ["committed.toml"] = 221,
    ["compile_commands.json"] = 194,
    ["compilerconfig.json"] = 193,
    ["completely.yml"] = 923,
    ["component-detection-manifest.json"] = 224,
    ["component.json"] = 223,
    ["composer.json"] = 222,
    ["conda-forge"] = 131,
    ["config.yaml"] = 593,
    ["contentmanifest.json"] = 201,
    ["contribute.json"] = 225,
    ["cosmos.config.json"] = 197,
    ["crowdin.yml"] = 226,
    ["ctfd-setup configuration file"] = 1016,
    ["custom-elements.json"] = 937,
    ["cypress.json"] = 230,
    ["datalogic-scan2deploy-android"] = 240,
    ["datalogic-scan2deploy-ce"] = 241,
    ["dbt Dependencies"] = 146,
    ["dbt Packages"] = 148,
    ["dbt Project"] = 147,
    ["dbt Selectors"] = 149,
    ["dbt YAML files"] = 150,
    ["ddev-global"] = 242,
    ["ddev-project"] = 243,
    ["debugsettings.json"] = 244,
    ["dependabot-v2.json"] = 247,
    ["dependabot.json"] = 246,
    ["deployed-cli"] = 879,
    ["devcontainer.json"] = 185,
    devinit = 831,
    ["devspace.yaml"] = 902,
    djlint = 832,
    ["docker bake"] = 252,
    ["docker sequencer"] = 253,
    ["docker-compose.yml"] = 830,
    ["dockerd.json"] = 251,
    ["dotnet Release Index manifest"] = 264,
    ["dotnet-tools.json"] = 265,
    ["dotnetcli.host.json"] = 266,
    ["dprint.json"] = 267,
    ["drone.json"] = 268,
    ["dss-2.0.0.json"] = 270,
    ["dstack configuration"] = 271,
    ["dtool dataset metadata"] = 1011,
    ["dvc.yaml"] = 272,
    ["ecosystem.json"] = 277,
    eksctl = 278,
    ["electron-builder configuration file"] = 284,
    ["epr-manifest.json"] = 283,
    ["evcc.yaml"] = 285,
    ["ezd task runner"] = 295,
    ["fabric.mod.json"] = 297,
    ["first-timers-bot"] = 304,
    ["flagd flag configuration"] = 75,
    ["fly.io Configuration"] = 76,
    fulibWorkflows = 861,
    ["function.json"] = 315,
    ["gRPC API Gateway & OpenAPI Config"] = 3,
    ["gematik health care insurance list"] = 1022,
    ["gematik health care patient list"] = 1019,
    ["gematik health care provider institution list"] = 1021,
    ["gematik health care provider list"] = 1020,
    ["gematik tiger test environment configuration"] = 1023,
    ["gitlab-ci"] = 332,
    ["global.json"] = 348,
    ["go-feature-flag Flag Configuration"] = 351,
    ["haxelib.json"] = 366,
    helmfile = 818,
    helmwave = 819,
    ["host-meta.json"] = 372,
    ...
    ["ide.host.json"] = 379,
    ["ifstate.conf"] = 380,
    ["imageoptimizer.json"] = 381,
    ["importmap.json"] = 384,
    ["ioBroker Configuration"] = 386,
    ["ioBroker JSON UI"] = 387,
    ["ioBroker Package manifest"] = 388,
    ["ize.toml"] = 914,
    ["jsconfig.json"] = 412,
    ["jscpd Configuration"] = 899,
    jsdoc = 814,
    ["k3d.yaml"] = 413,
    ["k9s aliases.yaml"] = 415,
    ["k9s cluster-config.yaml"] = 417,
    ["k9s config.yaml"] = 416,
    ["k9s hotkeys.yaml"] = 418,
    ["k9s plugins.yaml"] = 419,
    ["k9s skin.yaml"] = 420,
    ["k9s views.yaml"] = 421,
    ["kontinuous-config.yaml"] = 431,
    ["kontinuous-values.yaml"] = 430,
    ["kustomization.yaml"] = 433,
    ["label-commenter-config.yml"] = 434,
    ["latexindent configuration"] = 69,
    ["launchsettings.json"] = 435,
    lazydocker = 936,
    lazygit = 935,
    ["lego.json"] = 437,
    ["lerna.json"] = 438,
    ["lgtm.yml"] = 439,
    ["liblab.config.json"] = 440,
    ["libman.json"] = 441,
    ["license-report-config.json"] = 442,
    ["linkinator.config.json"] = 444,
    ["lint-staged (.lintstagedrc)"] = 793,
    ["local.settings.json"] = 449,
    ["localazy.json"] = 450,
    ["lotus.yaml"] = 448,
    ["lsdlschema.json"] = 451,
    ["markdown-link-check"] = 857,
    maturin = 858,
    mboats = 865,
    ["micro-settings.json"] = 929,
    ["mimetypes.json"] = 463,
    ["mirrord config"] = 794,
    mise = 795,
    ["mkdocs.yml"] = 483,
    ["monospace.yml"] = 486,
    ["moon.yml"] = 1008,
    ["mprocs Configuration file"] = 980,
    ["mrdocs.yml"] = 484,
    ["mta.yaml"] = 796,
    ["mtad.yaml"] = 797,
    ["mycode.json"] = 493,
    ["napari plugin manifest"] = 494,
    neoload = 809,
    ["nest-cli"] = 499,
    ["ninjs (News in JSON)"] = 498,
    ["nitro.json"] = 808,
    ["nixd configuration"] = 953,
    ["nlu.json"] = 500,
    ["nodemon.json"] = 502,
    ["noodl config"] = 864,
    ["notebook.mod.json"] = 503,
    now = 804,
    ["npm-badges"] = 506,
    ["nswag.json"] = 510,
    ntangle = 512,
    ["nuclei-template.yaml"] = 507,
    ["nuget-project.json"] = 508,
    ["ocelot.json"] = 514,
    ["omnisharp.json"] = 518,
    ["openapi.json"] = 519,
    ["openfin.json"] = 526,
    ...
    ["ops.yaml"] = 523,
    ["package.json"] = 545,
    ["package.manifest"] = 546,
    ["partial-black.json"] = 99,
    ["pathfinder.yml"] = 549,
    ["pattern.json"] = 552,
    ["petstore-v1.0"] = 909,
    pgap_yaml_input_reader = 551,
    ["pixi.toml"] = 553,
    ["plagiarize-me.yaml"] = 557,
    ["plagiarize.yaml"] = 556,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1012,
    ["podbard.yaml"] = 559,
    ["portman.json"] = 560,
    ["prefect.toml"] = 568,
    ["prettierrc.json"] = 569,
    ["prisma.yml"] = 570,
    ["project-1.0.0-beta3.json"] = 573,
    ["project-1.0.0-beta4.json"] = 574,
    ["project-1.0.0-beta5.json"] = 575,
    ["project-1.0.0-beta6.json"] = 576,
    ["project-1.0.0-beta8.json"] = 577,
    ["project-1.0.0-rc1.json"] = 578,
    ["project-1.0.0-rc2.json"] = 579,
    ["project.json"] = 572,
    ["project.owasp.yaml"] = 580,
    ["prometheus.json"] = 581,
    ["prometheus.rules.json"] = 582,
    ["prometheus.rules.test.json"] = 583,
    ["proxies.json"] = 584,
    ["publiccode.yml"] = 585,
    ["pubspec.yaml"] = 586,
    ["pyrseas-0.8.json"] = 589,
    pytest = 598,
    ["quilt.mod.json"] = 930,
    ["rc3 auth"] = 602,
    ["rc3 collection"] = 603,
    ...
    ["registry.yaml"] = 31,
    ["release drafter"] = 810,
    ["release-please-config.json"] = 612,
    ["release-please-manifest.json"] = 613,
    ["release-plz.toml"] = 614,
    ["renv.lock"] = 623,
    ["rivet.yaml"] = 952,
    rockcraft = 625,
    runny = 626,
    ...
    samt = 629,
    samtrc = 630,
    ["sarif-1.0.0.json"] = 632,
    ["sarif-2.0.0.json"] = 633,
    ["sarif-2.1.0"] = 643,
    ["sarif-2.1.0-rtm.2"] = 634,
    ["sarif-2.1.0-rtm.3"] = 636,
    ["sarif-2.1.0-rtm.4"] = 638,
    ["sarif-2.1.0-rtm.5"] = 640,
    ["sarif-2.1.0-rtm.6"] = 641,
    ["sarif-external-property-file-2.1.0"] = 644,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 635,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 637,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 639,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 642,
    ["scalingo.json configuration"] = 645,
    ["schema.org - Action"] = 647,
    ["schema.org - ContactPoint"] = 648,
    ["schema.org - Place"] = 649,
    ["schema.org - Thing"] = 650,
    ["secrethub.yml"] = 932,
    ["semantic-release"] = 656,
    ["servicehub.config.json"] = 788,
    ["servicehub.service.json"] = 787,
    ["settings.job"] = 659,
    ["sfdx-hardis configuration"] = 661,
    ["shard.yml"] = 968,
    ["size-limit configuration"] = 666,
    ["skaffold.yaml"] = 855,
    ["skyuxconfig.json"] = 668,
    snapcraft = 669,
    ["snowflake-config"] = 670,
    ["snowflake-connections"] = 671,
    ["spicepod.yaml"] = 987,
    ["sqlc configuration"] = 684,
    ["stripe-app-local.json"] = 693,
    ["stripe-app.json"] = 692,
    swcrc = 840,
    ["task.json"] = 702,
    taskcat = 805,
    ["template.json"] = 707,
    ["templatsources.json"] = 708,
    ["theme.json"] = 711,
    ["tizen_workspace.json"] = 712,
    tldr = 713,
    tmuxinator = 791,
    ["transcend.yml"] = 723,
    ["tree-sitter grammar.json"] = 356,
    ["trime.yaml"] = 724,
    ["trunk.yaml"] = 726,
    ["ts-force-config.json"] = 731,
    ["tsconfig.json"] = 727,
    ["tsd.json"] = 728,
    ["tsdoc.json"] = 729,
    ["tsdrc.json"] = 730,
    ...
    v8r = 771,
    vcluster = 974,
    ["vcpkg configuration file"] = 190,
    ["vcpkg manifest file"] = 189,
    ["vega-lite.json"] = 753,
    ["vega.json"] = 752,
    ["venvironment-basic.yaml"] = 756,
    ["venvironment.yaml"] = 755,
    version = 1030,
    ["version.json"] = 758,
    ["vhwdebugger-binding.yaml"] = 760,
    ["vim-addon-info"] = 761,
    ["vs-2017.3.host.json"] = 763,
    ["vs-nesting.json"] = 764,
    ["vsls.json"] = 762,
    ["vss-extension.json"] = 768,
    vtcfg = 1036,
    ["vtesttree.yaml"] = 769,
    ["vtestunit.yaml"] = 770,
    ["warp-keysets.json"] = 938,
    ["warp-themes.json"] = 939,
    ["warp-workflows.json"] = 940,
    ["webhint.io"] = 895,
    ["webjobpublishsettings.json"] = 775,
    ["webjobs-list.json"] = 774,
    ["well-known-fursona"] = 975,
    ["xs-app.json"] = 800,
    ["xunit.runner.json"] = 786,
    yamllint = 828,
    ["zerops.io import file"] = 984,
    ["zerops.yml"] = 983,
    zuul = 811,
    ["Žinoma"] = 821
  },
