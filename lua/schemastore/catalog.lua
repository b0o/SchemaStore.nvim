...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1005,
    [".nodehawkrc"] = 637,
    [".npmpackagejsonlintrc"] = 641,
    [".omletrc"] = 1186,
    [".phrase.yml"] = 719,
    [".phraseapp.yml"] = 720,
    [".pmbot.yml"] = 704,
    [".postcssrc"] = 713,
    [".powerpages-web-template-manifest"] = 715,
    [".pre-commit-config.yml"] = 716,
    [".pre-commit-hooks.yml"] = 717,
    [".putout.json"] = 753,
    [".rehyperc"] = 778,
    [".remarkrc"] = 782,
    [".sprite files"] = 878,
    ...
    AIConfig = 39,
    ["AMX Muse Program Descriptor"] = 1235,
    ["API Builder"] = 1041,
    ["AVA Configuration"] = 1105,
    ["AWS AppConfig Feature Flags-v1"] = 73,
    ["AWS CDK cdk.json"] = 279,
    ["AWS CloudFormation"] = 280,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 281,
    ["AWS Copilot Manifest"] = 1274,
    ["AWS SAM CLI Samconfig"] = 282,
    Acton = 1325,
    ["Adobe UXP Manifest"] = 1168,
    ["Aerleon Network & Service Definitions"] = 24,
    ["Aerleon Policy"] = 25,
    ["Agent Permission Policy"] = 1314,
    ["AgentCore CLI"] = 1315,
    AgentLoopKit = 1316,
    Aider = 1264,
    Air = 27,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1285,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1284,
    ["Airlock Microgateway"] = 40,
    ["Alacritty Configuration"] = 1077,
    ["AlgoVoi Compliance Receipt v1"] = 14,
    ["All Contributors configuration file"] = 1131,
    Anodizer = 459,
    ["Ansible Argument Specs"] = 443,
    ["Ansible Collection Galaxy"] = 450,
    ["Ansible Execution Environment"] = 440,
    ["Ansible Inventory"] = 449,
    ["Ansible Meta"] = 441,
    ["Ansible Meta Runtime"] = 442,
    ["Ansible Navigator Configuration"] = 452,
    ["Ansible Playbook"] = 447,
    ["Ansible Requirements"] = 444,
    ["Ansible Rulebook"] = 448,
    ["Ansible Tasks File"] = 446,
    ["Ansible Vars File"] = 445,
    ["Ansible-lint Configuration"] = 451,
    Any = 1196,
    ...
    ["Application list for a WinUtil"] = 1214,
    ArchitectFX = 1219,
    ["Argo CD"] = 59,
    ["Argo Events"] = 60,
    ["Argo Workflows"] = 61,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1283,
    ["Azure IoT Operations connector metadata"] = 1280,
    ...
    ["Azure Pipelines"] = 119,
    ["Azure Static Web Apps CLI configuration file"] = 882,
    ["Azure Static Web Apps configuration file"] = 881,
    BMML = 1302,
    ["BOSH BPM Config"] = 145,
    ["BOSH CPI Config"] = 146,
    ...
    ["Bacon config"] = 8,
    ["Barba-CV"] = 88,
    ["Bashly (bashly.yml)"] = 1135,
    ["Bashly Settings (bashly-settings.yml)"] = 1136,
    Bento = 1301,
    ["Better Code Hub"] = 1046,
    ["Better Scripts"] = 169,
    Bigconfig = 138,
    ["Biome Formatter Config"] = 89,
    ["Bitmovin Encoding Template"] = 1228,
    BizTalkServerApplicationSchema = 1012,
    Bleep = 170,
    ["Block Protocol Metadata"] = 167,
    ["Bluebricks blueprint config"] = 1307,
    ["Boyka Framework"] = 148,
    ...
    ["Butane Config"] = 1090,
    C4InterFlow = 1243,
    ["CDK Environment Manager, concrete environment configuration"] = 1267,
    ["CDK Environment Manager, concrete environments definition"] = 1266,
    ["CDK Environment Manager, environment definition"] = 1265,
    ["CGS Card Game Specification (cgs.json)"] = 1173,
    ["CICS TS region tagging"] = 1099,
    ["CICS TS resource import"] = 1100,
    ["CICS TS resource model"] = 1101,
    ["CICS TS resource overrides"] = 1102,
    ["CMake Presets"] = 171,
    ["CNC Codes"] = 193,
    ["CRS WAF test file"] = 1203,
    ["CRS WAF test platform overrides file"] = 1204,
    ["CSS Comb (.csscomb.json)"] = 308,
    ["CSS Lint (.csslintrc)"] = 309,
    ["CSpell (cspell.json)"] = 307,
    ["CVE Record Format"] = 205,
    CWL = 1179,
    ["Cache Warmup config"] = 172,
    ["Caido Proxy Configuration"] = 1339,
    ...
    ["Chamaleon environment"] = 1232,
    ["Chamaleon properties"] = 1233,
    ["Chamaleon template"] = 1231,
    Changepacks = 1294,
    Changesets = 291,
    Changie = 180,
    Charmcraft = 181,
    ...
    ["Clawject config"] = 199,
    ["Cloud Foundry Application Manifest"] = 1185,
    ["Cloud Run Spec v1"] = 1209,
    ...
    CodeCV = 103,
    CodeRabbit = 102,
    ["CodeShip Pro services configuration files"] = 261,
    ["CodeShip Pro steps configuration files"] = 262,
    ["Codecov configuration files"] = 260,
    Codex = 253,
    ["Codex Hooks"] = 254,
    ["Codex Skill Metadata"] = 255,
    CodifyCLI = 104,
    Codux = 257,
    ["Cog config file"] = 194,
    ["Commandbox Box.json"] = 195,
    ["Commandbox Server.json"] = 196,
    ["Common Catalog Data"] = 270,
    ["Common Package Specification"] = 197,
    Concord = 1202,
    ["Configu .cfgu files"] = 1190,
    ["Configu .configu file"] = 1191,
    Conjure = 192,
    ["Container Structure Test"] = 1026,
    Containerlab = 1055,
    ["Contextive Glossary"] = 1259,
    ContractGuard = 1056,
    Convex = 191,
    ["Crowdsec collection config"] = 302,
    ["Crowdsec parser config"] = 303,
    ["Crowdsec scenario config"] = 304,
    ["CumulusCI Config"] = 198,
    ["Cursor Agent Environment"] = 1312,
    ["Custom Machinery Machine"] = 1174,
    ["Custom Machinery Recipe"] = 1175,
    ["Cycle Stack File"] = 206,
    CycloneDX = 207,
    ["DWP Exchange - catalogue entry"] = 353,
    ["DWP Exchange - gateway"] = 351,
    ["DWP Exchange - meta"] = 352,
    ["Dart Build Config (dart-build.json)"] = 310,
    ["Dart Test Config (dart-test.json)"] = 311,
    ["DashLord Configuration"] = 312,
    ["Data Contract Specification"] = 313,
    ["Data Product Specification"] = 314,
    ["DataYoga Connections"] = 208,
    ["DataYoga Job"] = 209,
    ["Datadog Continuous Testing"] = 545,
    ["Datadog Service Definition"] = 546,
    ["Datadog Software Catalog"] = 547,
    ["Datahub Ingestion Recipe"] = 1106,
    ["Debian Upstream Metadata file"] = 216,
    DebtLens = 217,
    ["Deck config"] = 218,
    ["Declarative Automation Bundles"] = 1152,
    ["DeepMatch deeplinks spec"] = 219,
    ["Dein Config"] = 220,
    ["Deno Config (deno.json)"] = 320,
    ["Dependency cruiser"] = 221,
    ["DeployStack Configuration"] = 222,
    ["Deployah Configuration"] = 1282,
    ["Deployer Recipe"] = 323,
    ["Deta Spacefile"] = 223,
    ["Detekt Config (detekt.yml)"] = 324,
    ["Devbox Config"] = 224,
    ["Devbox Plugin"] = 225,
    Devfile = 350,
    Devup = 1295,
    DipDup = 1205,
    ["Discord Webhook"] = 325,
    ["DocFx Config (docfx.json)"] = 330,
    ["Docker Desktop extension metadata"] = 327,
    ["Docs MCP Manifest"] = 331,
    Dofigen = 332,
    ["Dolittle Artifacts"] = 333,
    ["Dolittle Bounded Context Configuration"] = 334,
    ["Dolittle Event Horizons Configuration"] = 335,
    ["Dolittle Resources Configuration"] = 336,
    ["Dolittle Server Configuration"] = 337,
    ["Dolittle Tenant Map Configuration"] = 339,
    ["Dolittle Tenants Configuration"] = 338,
    ["Dolittle Topology"] = 340,
    ["DonateCaseBetterCasino menu"] = 1236,
    ...
    ["Drupal Routing"] = 237,
    ["Drupal Services"] = 239,
    ["Drush site aliases"] = 346,
    ["Dynamic Bash Aliases (.aliases)"] = 1143,
    ["EAS config"] = 391,
    ["ECA - Editor Code Assistant"] = 355,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1132,
    ["ESLint Suppressions"] = 396,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1279,
    ["EasyVCR .NET"] = 393,
    ["Eidolon Resource"] = 1220,
    ["Elgato Stream Deck"] = 357,
    Elm = 1207,
    ["Embrace Config"] = 1118,
    Emmet = 1208,
    Endurica = 1156,
    ["Enonic XP API descriptor"] = 360,
    ["Enonic XP Admin Extension descriptor"] = 361,
    ["Enonic XP Admin Tool descriptor"] = 362,
    ["Enonic XP Application descriptor"] = 363,
    ["Enonic XP CMS descriptor"] = 364,
    ["Enonic XP Content Type descriptor"] = 365,
    ["Enonic XP Form Fragment descriptor"] = 366,
    ["Enonic XP ID Provider descriptor"] = 367,
    ["Enonic XP Layout descriptor"] = 368,
    ["Enonic XP Macro descriptor"] = 369,
    ["Enonic XP Mixin descriptor"] = 370,
    ["Enonic XP Page descriptor"] = 371,
    ["Enonic XP Part descriptor"] = 372,
    ["Enonic XP Service descriptor"] = 373,
    ["Enonic XP Site descriptor"] = 374,
    ["Enonic XP Style descriptor"] = 375,
    ["Enonic XP Task descriptor"] = 376,
    ["Enonic XP Webapp descriptor"] = 377,
    ["Enterprise Contract Policy Spec"] = 358,
    ["Envelope Team Definition"] = 1324,
    ["Envilder Map File"] = 359,
    ["Erda Pipeline"] = 1181,
    ["Erda Runtime"] = 1182,
    ["Espanso config.yml"] = 1305,
    ["Espanso match.yml"] = 1304,
    Esquio = 379,
    ["Estuary Flow Catalog"] = 1096,
    ["Ethereum ERC1155"] = 1318,
    ["Ethereum ERC721"] = 1317,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 384,
    ["EveryVoice TTS Toolkit Data Configuration"] = 385,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 389,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 388,
    ["EveryVoice TTS Toolkit Text Configuration"] = 386,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 387,
    ["Evolving Resolutive Process notation"] = 1281,
    ["Expo SDK"] = 390,
    ["Expoot app config"] = 392,
    ["F-Droid Data metadata"] = 398,
    ["FasterCI Configuration"] = 120,
    ["Fence configuration"] = 121,
    FiQuS = 402,
    Firebase = 400,
    ["Flatpak Builder Manifest"] = 403,
    ["FlexGet Config"] = 404,
    ["Flow.json Configurations"] = 1178,
    ["Fossa configuration file"] = 411,
    ["Fossa's fossa-deps file"] = 412,
    ["Foundry VTT - Base package Manifest"] = 406,
    ["Foundry VTT - Module Manifest"] = 407,
    ["Foundry VTT - System Data Template"] = 410,
    ["Foundry VTT - System Manifest"] = 408,
    ["Foundry VTT - World Manifest"] = 409,
    ["Foxx Manifest"] = 122,
    ["Freifunk.de Community API"] = 125,
    ["Frogbot Config"] = 126,
    ["G2P Mapping Configuration"] = 418,
    ["GCP Blueprint Metadata"] = 421,
    Gaspar = 419,
    ["GatewayCore API Gateway"] = 420,
    ["Gemini CLI settings"] = 422,
    ["GeoJSON.json latest"] = 1094,
    GherKing = 1098,
    ["GitHub Action"] = 428,
    ["GitHub Actions typing"] = 1216,
    ["GitHub Discussion"] = 429,
    ["GitHub Funding"] = 430,
    ["GitHub Issue Template configuration"] = 431,
    ["GitHub Issue Template forms"] = 432,
    ["GitHub Pages Jekyll"] = 433,
    ["GitHub Workflow"] = 434,
    ["GitHub Workflow Template Properties"] = 435,
    ["GitHub automatically generated release notes configuration"] = 436,
    ["GitLab Agent for Kubernetes configuration"] = 1170,
    GitVersion = 425,
    ["Gitea Issue Template configuration"] = 426,
    ["Gitea Issue Template forms"] = 427,
    ["Gitpod Automations"] = 438,
    ["Gitpod Configuration"] = 439,
    ["Glamour style"] = 423,
    ["GlazeWM settings"] = 1172,
    ["Global Privacy Control"] = 424,
    Goblet = 1151,
    ["Golangci-lint Configuration"] = 454,
    ["Golangci-lint Custom Plugins Configuration"] = 455,
    ["Google Chrome Related Website Sets"] = 401,
    ["Google Cloud Workflows"] = 278,
    ["Google Digital Assetlinks"] = 1260,
    Goreleaser = 457,
    ["Goreleaser Pro"] = 458,
    Goss = 460,
    ["Gradle Build Cache Node"] = 1044,
    ["Gradle Enterprise"] = 1043,
    ["Grafana 5.x Dashboard"] = 461,
    ["GraphQL Code Generator"] = 466,
    ["GraphQL Config"] = 465,
    ["GraphQL Mesh"] = 464,
    ["GroovyLint configuration"] = 467,
    ["Grunt JSHint task"] = 471,
    ["Grunt Watch task"] = 472,
    ["Grunt base task"] = 473,
    ["Grunt clean task"] = 469,
    ["Grunt copy task"] = 468,
    ["Grunt cssmin task"] = 470,
    HEMTT = 1008,
    Hadolint = 1022,
    Hammerkit = 1054,
    ["Hardware Sentry Configuration"] = 1110,
    ["Hashgraph Online Skill Manifest"] = 4,
    ["HashiCorp Vault"] = 474,
    Hatch = 1023,
    Hayson = 476,
    ["Haystack Pipeline"] = 477,
    ["Hazelcast 5 Configuration"] = 478,
    ["Hecate Input Schema"] = 1271,
    ["Helm Chart.lock"] = 241,
    ["Helm Chart.yaml"] = 240,
    ["Helm Unittest Test Suite"] = 242,
    ["Hex file"] = 243,
    ["Home Assistant Integration Manifest"] = 479,
    ["Homer dashboard configuration"] = 480,
    Hugo = 1086,
    ["Hugo Theme"] = 1085,
    ["Hulak Configuration"] = 487,
    ["Hyperfoil benchmark configuration"] = 486,
    ["IBM Zapp document"] = 488,
    ["IBM zCodeFormatSettings"] = 489,
    ["IMG Catapult PSP"] = 494,
    ["IVMS101 by CODE Protocol"] = 1171,
    ["Infinispan Configuration"] = 496,
    ["Infinispan Server Configuration"] = 497,
    Infrahub = 498,
    Istanbul = 1114,
    ["JDownloader2 crawler multi-rules"] = 512,
    ["JDownloader2 crawler single-rules"] = 511,
    ["JFrog Applications Config"] = 513,
    ["JFrog File Spec"] = 514,
    ["JFrog Pipelines YML DSL"] = 1120,
    ["JMeter DSL cli config"] = 515,
    JReleaser = 518,
    ["JSON Document Transform"] = 526,
    ["JSON Feed"] = 527,
    ["JSON Resume"] = 790,
    ["JSON Schema Draft 2020-12"] = 990,
    ["JSON Schema Draft 4"] = 987,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1153,
    ["JSON Schema Draft 7"] = 988,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1154,
    ["JSON Schema Draft 8 (2019-09)"] = 989,
    ["JSON-API"] = 525,
    ["JSON-e templates"] = 1051,
    ["JSON-stat 2.0"] = 983,
    JSONPatch = 529,
    ["JSR Package Config (jsr.json)"] = 519,
    Jarl = 1287,
    Jasmine = 506,
    Jekyll = 507,
    ["Jenkins X Pipelines"] = 508,
    ["Jenkins X Requirements"] = 509,
    Jest = 510,
    Jocker = 516,
    ["Jovo Language Models"] = 517,
    ["Jujutsu (jj) VCS config"] = 1273,
    ["KIMMDY config file"] = 540,
    ["KODE/CI build.yaml"] = 1116,
    ["KSP-AVC"] = 984,
    ["KSP-CKAN"] = 985,
    ["KSP-NetKAN"] = 986,
    KSY = 1183,
    KSail = 416,
    ["KYA Manifest"] = 1184,
    ["Karakum configuration file"] = 413,
    Kas = 532,
    ["Kestra flow file"] = 541,
    ["Keycloak REST API"] = 1123,
    ["Knative Functions - func.yaml"] = 414,
    Knip = 415,
    ["Knowledge Unit"] = 549,
    ["Kometa (nightly) config file"] = 543,
    ["Kometa config file"] = 542,
    ["Kong DBLess config"] = 1117,
    KrakenD = 544,
    ["Kubri Configuration"] = 552,
    LOOBin = 567,
    ["Lake configuration file"] = 1276,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 283,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 284,
    ["Landing Zone Accelerator on AWS - Global Config"] = 285,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 286,
    ["Landing Zone Accelerator on AWS - Network Config"] = 287,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 288,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 289,
    ["Landing Zone Accelerator on AWS - Security Config"] = 290,
    ["Lando (landofile)"] = 115,
    ["LangGraph Platform configuration"] = 1195,
    ["Language configuration"] = 1194,
    Lefthook = 556,
    ["Liferay client-extension.yaml"] = 563,
    ["LinkML Metamodel"] = 565,
    Liquibase = 1061,
    ["Liquibase Flow File"] = 1062,
    ["Lively Properties"] = 566,
    ["Lobe AI Agent"] = 117,
    Loki = 118,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 609,
    ["MS2Rescore Configuration"] = 615,
    ["Madness (madness.yml)"] = 1134,
    ["Mado configuration"] = 573,
    ["Maestro Flow"] = 574,
    ["Mail Servers Configuration"] = 1308,
    ["MapEHR Mapping"] = 575,
    Markdownlint = 1065,
    ["Mason Registry"] = 1068,
    ["MegaLinter Custom Flavor"] = 578,
    ["MegaLinter configuration"] = 577,
    ["MegaLinter descriptor"] = 579,
    Melange = 1161,
    ["Meltano project definition"] = 580,
    ["Mergify Configuration"] = 616,
    ["Metadata for a Bazel module"] = 581,
    ["Metadata for a Cinnamon spice"] = 1212,
    ["Metatype Configuration"] = 582,
    ["MetricsHub Configuration"] = 583,
    ["MetricsHub Connector Configuration"] = 584,
    ["Micro Editor Syntax"] = 1144,
    ["Microsoft Band Web Tile"] = 585,
    ["Microsoft RulesEngine workflow rules"] = 1199,
    ["Microsoft RulesEngine workflow rules list"] = 1200,
    ["Minecraft Custom Main Menu Mod"] = 1162,
    ["Minecraft Data Pack Advancement"] = 587,
    ["Minecraft Data Pack Biome"] = 588,
    ["Minecraft Data Pack Configured Carver"] = 589,
    ["Minecraft Data Pack Damage Type"] = 590,
    ["Minecraft Data Pack Dimension"] = 592,
    ["Minecraft Data Pack Dimension Type"] = 591,
    ["Minecraft Data Pack Item Modifier"] = 593,
    ["Minecraft Data Pack Loot Table"] = 594,
    ["Minecraft Data Pack Metadata"] = 595,
    ["Minecraft Data Pack Predicate"] = 596,
    ["Minecraft Data Pack Recipe"] = 597,
    ["Minecraft Data Pack Tag"] = 598,
    ["Minecraft Data Pack Template Pool"] = 599,
    ["Minecraft Data Pack Trim Material"] = 604,
    ["Minecraft Data Pack Trim Pattern"] = 605,
    ["Minecraft Resource Pack Lang"] = 600,
    ["Minecraft Resource Pack Particle"] = 601,
    ["Minecraft Resource Pack Texture Mcmeta"] = 603,
    ["Minecraft Resourcepack Sounds"] = 602,
    ["MockServer Expectations"] = 611,
    ModuleAssembler = 607,
    ["Monade CLI Stack Configuration"] = 619,
    ["MongoDB Atlas Search Index Definition"] = 1115,
    ["Monika Configuration"] = 1113,
    ["Monoweave Configuration"] = 614,
    ["Motif config"] = 1004,
    MultiQC = 1253,
    ["NOX Framework (Service)"] = 640,
    ["Netin Diagnostic System Template"] = 1072,
    ["Netlify config"] = 622,
    ["Network-as-Code Data Model"] = 623,
    ["Next Gen UI Agent A2A Server Configuration"] = 624,
    ["Next Gen UI Agent Configuration"] = 626,
    ["Next Gen UI Agent MCP Server Configuration"] = 625,
    ["Nightwatch.js"] = 633,
    ["Node.js configuration"] = 1009,
    ["NueJS configuration file"] = 645,
    ["Nuitka Package Config"] = 1176,
    ["Nullstone config"] = 647,
    ["ONe's changelog entry"] = 666,
    ["ONe's service descriptor"] = 665,
    ["ORT Server repository environment configuration"] = 676,
    ["OSCAL Assessment Plan (AP)"] = 678,
    ["OSCAL Assessment Results (AR)"] = 679,
    ["OSCAL Catalog"] = 680,
    ["OSCAL Component Definition (CDef)"] = 681,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 682,
    ["OSCAL Profile"] = 683,
    ["OSCAL System Security Plan (SSP)"] = 684,
    ["OSS Review Toolkit configuration"] = 685,
    ["OSS Review Toolkit curation"] = 686,
    ["OSS Review Toolkit package configuration"] = 687,
    ["OSS Review Toolkit project package manager definition"] = 688,
    ["OSS Review Toolkit repository configuration"] = 689,
    ["OSS Review Toolkit resolutions"] = 690,
    ["October CMS columns"] = 651,
    ["October CMS fields"] = 652,
    ["Oh My Posh"] = 654,
    Okteto = 655,
    ["Ona Automations"] = 657,
    Opctl = 1007,
    ["Open Data Contract Standard (ODCS)"] = 670,
    ["Open Data Product Standard (ODPS)"] = 671,
    ["Open Know-How"] = 1258,
    OpenDecree = 1322,
    ["OpenDecree Configuration"] = 1323,
    ["OpenRewrite Resource"] = 668,
    OpenSRM = 672,
    OpenStatus = 1269,
    ["OpenTelemetry Declarative Configuration"] = 669,
    ["OpenUtau character yaml"] = 662,
    ["OpenUtau ustx"] = 663,
    ["OpenWeather Current Weather API"] = 1050,
    ["OpenWeather Road Risk API"] = 1049,
    ["Ory Hydra configuration"] = 485,
    ["Ory Keto configuration"] = 548,
    ["Ory Kratos configuration"] = 677,
    ["Ory Oathkeeper configuration"] = 649,
    ["Outblocks App configuration"] = 674,
    ["Outblocks database table"] = 675,
    ["Outblocks project configuration"] = 673,
    PDM = 698,
    POPxf = 710,
    ["POPxf Correlations"] = 711,
    ["PRML manifest"] = 718,
    Packer = 694,
    PactSpec = 695,
    Panache = 696,
    Pantsbuild = 1130,
    ["Paper paper-plugin.yml"] = 697,
    ["Pipeline component"] = 1063,
    ["Platform.sh application"] = 10,
    ["Platform.sh routes"] = 11,
    ["Platform.sh services"] = 12,
    ["Plex Prerolls"] = 708,
    ["PocketMine plugin.yml"] = 705,
    ["Podman Desktop Extension"] = 1341,
    ["Postman collection"] = 714,
    ["Power Pages Configuration"] = 1270,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1215,
    ["ProActions AI-Kit Configuration"] = 726,
    ["ProActions AI-Kit Configuration for Menus"] = 728,
    ["ProActions AI-Kit Configuration for Sections"] = 730,
    ["ProActions AI-Kit Configuration for Services"] = 727,
    ["ProActions AI-Kit Configuration for Steps"] = 731,
    ["ProActions AI-Kit Configuration for Templates"] = 729,
    ["Problem object RFC9457"] = 1159,
    ["Problem package format"] = 732,
    ["Problem package generators"] = 733,
    ["Problem package submissions"] = 734,
    ["Problem package test group metadata"] = 735,
    Pterodactyl = 1109,
    ["Pull Request Labeler"] = 752,
    Pulumi = 760,
    ["PyGTA Config"] = 756,
    PyProject = 761,
    Pylock = 1261,
    Pyright = 762,
    ["Python script metadata"] = 1255,
    ["QType AI DSL"] = 765,
    Qgoda = 764,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1333,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1331,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1337,
    ["Qlik Talend Cloud Pipeline - Project"] = 1329,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1332,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1334,
    ["Qlik Talend Cloud Pipeline - Task"] = 1330,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1336,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1335,
    Qodana = 1082,
    ["Qt Creator workspace file"] = 1192,
    ["Quali Torque Blueprint Spec 2"] = 1107,
    ["QueryFirst config file"] = 1126,
    ["QuikRun Configuration"] = 1338,
    ["Qwen Code Settings"] = 1319,
    ["RKE Cluster Configuration JSON"] = 1060,
    ["RKE Cluster Configuration YAML"] = 1059,
    RadioHound = 755,
    ["Raid Profile"] = 1320,
    ["Raid Repo Configuration"] = 1321,
    Railpack = 767,
    Railway = 766,
    ["Rancher Fleet"] = 757,
    ["Rattler-build"] = 768,
    Ray = 1021,
    ["Read the Docs"] = 759,
    ["Red-DiscordBot Cog"] = 775,
    ["Red-DiscordBot Cog Repo"] = 776,
    ["Red-DiscordBot Trivia"] = 777,
    ["Releasaurus Config"] = 7,
    ReleaseKit = 6,
    ["Render Blueprints"] = 1058,
    RenderCV = 794,
    Renovate = 791,
    ["Renovate global configuration"] = 792,
    ["Renovate inherited configuration"] = 793,
    ["Replit config"] = 783,
    Restate = 1248,
    ["Revel Digital Gadget Definition File"] = 1272,
    RoadRunner = 796,
    ["Robust Station Image"] = 1278,
    Rockcraft = 797,
    ["Roo Coder Custom Modes"] = 798,
    Rubocop = 787,
    ["Rudder techniques"] = 1166,
    Ruff = 788,
    ["Rust Project"] = 789,
    ["Rust toolchain"] = 803,
    ["SDMX data message"] = 830,
    ["SDMX metadata message"] = 829,
    ["SDMX structure message"] = 828,
    ["SIL Kit Participant Configuration"] = 840,
    ["SIL Kit Registry Configuration"] = 841,
    ["SPDX 2.3"] = 879,
    SWADL = 895,
    ["Safebox Config"] = 1121,
    ["Sapphire CLI Config"] = 806,
    ["SauceCTL Configuration"] = 1069,
    Scarb = 826,
    ["Schema Catalog"] = 821,
    ["Scoop manifest"] = 827,
    ["Semantic Data Fabric (SDF) file"] = 831,
    ["Semgrep Rule"] = 833,
    ["Serenity Code Generator (Sergen)"] = 834,
    ["Serverless Framework Configuration"] = 1076,
    ["Serverless Workflow"] = 1078,
    ["Settings for a Cinnamon spice"] = 1211,
    ["Settings.paf"] = 836,
    ["Shopware 6 Configuration"] = 1079,
    ["Shopware CLI Extension Store Configuration"] = 1080,
    ["Shopware CLI Project Store Configuration"] = 1081,
    ["Sigma Detection Rule"] = 838,
    ["SigmaCV CV"] = 2,
    ["Sigrid scope configuration file"] = 839,
    ["SkyPilot Task JSON"] = 1167,
    ["Slack app manifest"] = 843,
    ["Slang Server Configuration"] = 1342,
    Snapcraft = 845,
    ["Solarxy project config"] = 848,
    Solidarity = 849,
    ["Solution filters"] = 850,
    ["Source Maps v3"] = 851,
    Sourcery = 852,
    ["Spack bootstrap.yaml"] = 853,
    ["Spack cdash.yaml"] = 854,
    ["Spack ci.yaml"] = 855,
    ["Spack compilers.yaml"] = 856,
    ["Spack concretizer.yaml"] = 857,
    ["Spack config.yaml"] = 858,
    ["Spack definitions.yaml"] = 859,
    ["Spack develop.yaml"] = 860,
    ["Spack env_vars.yaml"] = 861,
    ["Spack environment"] = 867,
    ["Spack include.yaml"] = 862,
    ["Spack mirrors.yaml"] = 863,
    ["Spack modules.yaml"] = 864,
    ["Spack packages.yaml"] = 865,
    ["Spack repos.yaml"] = 866,
    ["Spack toolchains.yaml"] = 868,
    ["Spack upstreams.yaml"] = 869,
    ["Spack view.yaml"] = 870,
    ["Speakeasy Generation Config File"] = 874,
    ["Speakeasy Lint Configuration File"] = 871,
    ["Speakeasy Test Generation Configuration File"] = 872,
    ["Speakeasy Workflow File"] = 873,
    SpecIF = 875,
    ["Specmatic Configuration"] = 876,
    ["Sponge Mixin configuration"] = 877,
    StackBlitz = 883,
    ["StackHawk Scanner Configuration"] = 1075,
    Stale = 884,
    Starfish = 885,
    ["Starlake Data Pipeline"] = 1047,
    Starship = 886,
    ["Statamic Blueprint"] = 887,
    ["Stella configuration file"] = 888,
    ["Streamlit configuration file"] = 889,
    ["Stryker Mutator"] = 892,
    ["StyleCop Analyzers Configuration"] = 893,
    ["Stylelint (.stylelintrc)"] = 894,
    ["Stylua Config"] = 1262,
    ["Sublime Syntax"] = 1122,
    ["Subsquid squid manifest"] = 1169,
    ["Swagger API 2.0"] = 896,
    ["Synadia Connect Component"] = 897,
    TSON = 933,
    TSTyche = 934,
    ["TYPO3 Vendor Bundler config"] = 940,
    ["Tab data for a LinUtil"] = 1218,
    ["Tab list for a LinUtil"] = 1217,
    Tach = 898,
    ["Tach Domain"] = 899,
    Talhelper = 901,
    ["Talisman configuration"] = 902,
    Taplo = 1263,
    ["Taskfile config"] = 1052,
    Taurus = 903,
    Tauticord = 904,
    ["Tekton Pipeline"] = 1291,
    ["Tekton PipelineRun"] = 1292,
    ["Tekton Task"] = 1289,
    ["Tekton TaskRun"] = 1290,
    Telefonistka = 1249,
    ["Terrateam config"] = 1275,
    ["TestEnvironment.json"] = 916,
    ["TextMate Grammar"] = 915,
    Threagile = 910,
    ["Tier.run pricing.json"] = 907,
    Tikibase = 908,
    Tombi = 913,
    ["Traefik v2"] = 919,
    ["Traefik v2 File Provider"] = 920,
    ["Traefik v3"] = 921,
    ["Traefik v3 File Provider"] = 922,
    ["Travis CI (.travis.yml)"] = 918,
    Treefmt = 463,
    Trident = 1245,
    ["TrueScript for *.tscript files"] = 925,
    ["Tugboat QA config.yml"] = 1242,
    TunnelHub = 1157,
    Turborepo = 917,
    Tycho = 1206,
    Tye = 1083,
    ["Tyk Gateway - Open Source v5.7+"] = 1254,
    ["UET BuildConfig.json"] = 1127,
    ["UI5 Manifest"] = 946,
    ["UNCORS configuration"] = 951,
    ["UTAM Page Object"] = 949,
    ["Ubuntu Server Autoinstall"] = 944,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1246,
    ["Uniswap Token List"] = 1032,
    ["Universal Schedule Format"] = 952,
    ["Unreal Engine Uplugin"] = 1128,
    ["Unreal Engine Uproject"] = 1129,
    ["UpCloud CLI (upctl) configuration"] = 1247,
    ["Updatecli Compose"] = 1091,
    ["Updatecli Policy Manifest"] = 1092,
    ["Updatecli Policy Metadata"] = 1093,
    Uplift = 1125,
    ["Upsun config"] = 9,
    ["User Journey Map"] = 1057,
    V2Ray = 1097,
    ["VSCode Code Snippets"] = 266,
    ["VSIX CLI publishing"] = 970,
    Vector = 954,
    ["Vela Pipeline Configuration"] = 957,
    Vercel = 265,
    ["Version Bumper config"] = 960,
    Vespertide = 1296,
    ["Vespertide Migration"] = 1297,
    ["Vespertide Model"] = 1298,
    ["Viash Component Config"] = 1251,
    ["Viash Package Config"] = 1252,
    Visivo = 1155,
    ["WP-CLI"] = 980,
    Wake = 1244,
    ["Waku Config"] = 1221,
    ["Web App Manifest"] = 976,
    ["Web types"] = 979,
    WebExtensions = 975,
    ["Webman package recipe"] = 1103,
    ["Windows Package Manager Installer Manifest"] = 1029,
    ["Windows Package Manager Locale Manifest"] = 1030,
    ["Windows Package Manager Singleton Manifest"] = 1028,
    ["WireMock CLI import configuration"] = 1227,
    ["WireMock CLI local service configuration"] = 1226,
    ["WireMock message stub mapping"] = 1225,
    ["WireMock stub mapping"] = 1224,
    ["Woodpecker pipeline config"] = 1071,
    ["Wrangler CLI"] = 981,
    ["XenForo add-on manifest"] = 982,
    ["Xstate Machine"] = 1089,
    ["Yandex Workflow Language"] = 1213,
    ["Yarn Config (.yarnrc.yml)"] = 1045,
    ["Yippee-Ki-JSON configuration YML"] = 1036,
    ["YouTrack App"] = 1210,
    ["Zarf Package Configuration"] = 1277,
    ["Zerops import file"] = 1198,
    ["Zola Configuration"] = 1288,
    actionlint = 38,
    ["aerleon.yml"] = 23,
    ["amplify.yml"] = 16,
    ["amxx-builder manifest"] = 1340,
    ["angular.json"] = 41,
    apko = 1160,
    ...
    ["behat.yml"] = 149,
    ["bigquery-table"] = 137,
    ["bioimageio resource description"] = 1177,
    ...
    ["cargo-nextest repository configuration"] = 627,
    ["cargo-nextest user configuration"] = 628,
    ["ccmod.json"] = 1222,
    changelogging = 1189,
    ["chisel-slices.json"] = 292,
    ["chrome-extension-locales-messages.json"] = 273,
    ["chutzpah.json"] = 274,
    cibuildwheel = 186,
    ["clang-format (.clang-format)"] = 1095,
    ["clang-tidy"] = 249,
    clangd = 248,
    clib = 250,
    ["cloud-init: cloud-config userdata"] = 252,
    ["cloud-sdk-pipeline-configuration"] = 276,
    ["cloudbuild.json"] = 277,
    cloudify = 251,
    cmakefmt = 204,
    ["cmdx.yaml"] = 101,
    ...
    ["commands.json"] = 269,
    ["commit-check"] = 295,
    ["commitlint (.commitlintrc)"] = 1031,
    ["committed.toml"] = 296,
    ["compile_commands.json"] = 268,
    ["compilerconfig.json"] = 267,
    ["completely.yml"] = 1133,
    ["component-detection-manifest.json"] = 299,
    ["component.json"] = 298,
    ["composer.json"] = 297,
    ["conda-forge"] = 190,
    ["config.yaml"] = 758,
    ["contentmanifest.json"] = 275,
    ["contribute.json"] = 300,
    ["cosmos.config.json"] = 271,
    ["crowdin.yml"] = 301,
    ["ctfd-setup configuration file"] = 1234,
    ["custom-elements.json"] = 1147,
    ["cypress.json"] = 305,
    ["dacier.yml"] = 1328,
    ["datalogic-scan2deploy-android"] = 315,
    ["datalogic-scan2deploy-ce"] = 316,
    ...
    ["ddev-global"] = 317,
    ["ddev-project"] = 318,
    ["debugsettings.json"] = 319,
    ["dependabot-v2.json"] = 322,
    ["dependabot.json"] = 321,
    ["deployed-cli"] = 1088,
    ["devcontainer-feature.json"] = 259,
    ["devcontainer.json"] = 258,
    devinit = 1038,
    ["devspace.yaml"] = 1111,
    djlint = 1039,
    ["docker bake"] = 328,
    ["docker sequencer"] = 329,
    ["docker-compose.yml"] = 1037,
    ["dockerd.json"] = 326,
    ["dotnet Release Index manifest"] = 341,
    ["dotnet-tools.json"] = 342,
    ["dotnetcli.host.json"] = 343,
    ["dprint.json"] = 344,
    ["drone.json"] = 345,
    ["dss-2.0.0.json"] = 347,
    ["dstack configuration"] = 348,
    ["dtool dataset metadata"] = 1229,
    ["dvc.yaml"] = 349,
    ["ecosystem.json"] = 354,
    eksctl = 356,
    ["electron-builder configuration file"] = 382,
    ["epr-manifest.json"] = 381,
    ["estampo.toml"] = 380,
    ["evcc.yaml"] = 383,
    ["ezd task runner"] = 394,
    ["fabric.mod.json"] = 397,
    ["first-timers-bot"] = 405,
    ["flagd flag configuration"] = 123,
    ["fly.io Configuration"] = 124,
    fulibWorkflows = 1070,
    ["function.json"] = 417,
    ["gRPC API Gateway & OpenAPI Config"] = 18,
    ["gematik health care insurance list"] = 1240,
    ["gematik health care patient list"] = 1237,
    ["gematik health care provider institution list"] = 1239,
    ["gematik health care provider list"] = 1238,
    ["gematik tiger test environment configuration"] = 1241,
    ["git-town.toml"] = 1286,
    ["gitlab-ci"] = 437,
    ["global.json"] = 453,
    ["go-feature-flag Flag Configuration"] = 456,
    ["haxelib.json"] = 475,
    helmfile = 1024,
    helmwave = 1025,
    ["host-meta.json"] = 482,
    ...
    ["ide.host.json"] = 490,
    ["ifstate.yaml"] = 491,
    ["imageoptimizer.json"] = 492,
    ["importmap.json"] = 495,
    instant_python_config = 499,
    instant_python_custom_project = 500,
    intlayer = 501,
    ["ioBroker Configuration"] = 502,
    ["ioBroker JSON UI"] = 503,
    ["ioBroker Package manifest"] = 504,
    ["ixpect.conf.yaml"] = 505,
    ["ize.toml"] = 1124,
    ["jsconfig.json"] = 530,
    ["jscpd Configuration"] = 1108,
    jsdoc = 1020,
    ["k3d.yaml"] = 531,
    ["k9s aliases.yaml"] = 533,
    ["k9s cluster-config.yaml"] = 535,
    ["k9s config.yaml"] = 534,
    ["k9s hotkeys.yaml"] = 536,
    ["k9s plugins.yaml"] = 537,
    ["k9s skin.yaml"] = 538,
    ["k9s views.yaml"] = 539,
    ["kontinuous-config.yaml"] = 551,
    ["kontinuous-values.yaml"] = 550,
    ["kustomization.yaml"] = 553,
    ["label-commenter-config.yml"] = 554,
    ["latexindent configuration"] = 116,
    ["launchsettings.json"] = 555,
    lazydocker = 1146,
    lazygit = 1145,
    ["lego.json"] = 557,
    ["lerna.json"] = 558,
    ["lgtm.yml"] = 559,
    ["liblab.config.json"] = 560,
    ["libman.json"] = 561,
    ["license-report-config.json"] = 562,
    ["linkinator.config.json"] = 564,
    ["lint-staged (.lintstagedrc)"] = 998,
    ["local.settings.json"] = 569,
    ["localazy.json"] = 570,
    ["lotus.yaml"] = 568,
    ["lsdlschema.json"] = 571,
    ["macro.json"] = 1112,
    ["markdown-link-check"] = 1066,
    maturin = 1067,
    mboats = 1074,
    memnex = 1326,
    ["micro-settings.json"] = 1139,
    ["mimetypes.json"] = 586,
    ["mirrord config"] = 1000,
    mise = 1001,
    ["mkdocs.yml"] = 606,
    ["mockd.yaml"] = 610,
    ["modelparams.dev Model"] = 612,
    ["monospace.yml"] = 613,
    ["moon.yml"] = 1223,
    ["mprocs Configuration file"] = 1193,
    ["mrdocs.yml"] = 608,
    ["mta.yaml"] = 1002,
    ["mtad.yaml"] = 1003,
    ["mycode.json"] = 620,
    nFPM = 632,
    ["napari plugin manifest"] = 621,
    neoload = 1015,
    ["nest-cli"] = 635,
    ["nexus-rpc-gen"] = 1313,
    ["nf-core module environment.yml"] = 629,
    ["nf-core module meta.yml"] = 630,
    ["nf-core subworkflow meta.yml"] = 631,
    ["ninjs (News in JSON)"] = 634,
    ["nitro.json"] = 1014,
    ["nixd configuration"] = 1165,
    ["nlu.json"] = 636,
    ["nodemon.json"] = 638,
    ["noodl config"] = 1073,
    ["notebook.mod.json"] = 639,
    now = 1010,
    ["npm-badges"] = 642,
    ["nswag.json"] = 646,
    ntangle = 648,
    ["nuclei-template.yaml"] = 643,
    ["nuget-project.json"] = 644,
    ["ocelot.json"] = 650,
    ogen = 653,
    ["omnisharp.json"] = 656,
    openHAB = 1299,
    ...
    oxlint = 1310,
    ["package.json"] = 691,
    ["package.manifest"] = 693,
    ["package.yaml"] = 692,
    ["partial-black.json"] = 150,
    ["partial-fastapi.json"] = 151,
    ["partial-pixi.json"] = 703,
    ["partial-scheduled.json"] = 152,
    ["pattern.json"] = 701,
    ["petstore-v1.0"] = 1119,
    pgap_yaml_input_reader = 699,
    pgrls = 700,
    pgxgen = 1303,
    pitcms = 1306,
    ["pixi.toml"] = 702,
    ["plagiarize-me.yaml"] = 707,
    ["plagiarize.yaml"] = 706,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1230,
    ["podbard.yaml"] = 709,
    ["portman.json"] = 712,
    ["prefect.toml"] = 721,
    ["prefect.yaml"] = 722,
    ...
    ["prettierrc.json"] = 724,
    ["prisma.yml"] = 725,
    ["project-1.0.0-beta3.json"] = 737,
    ["project-1.0.0-beta4.json"] = 738,
    ["project-1.0.0-beta5.json"] = 739,
    ["project-1.0.0-beta6.json"] = 740,
    ["project-1.0.0-beta8.json"] = 741,
    ["project-1.0.0-rc1.json"] = 742,
    ["project-1.0.0-rc2.json"] = 743,
    ["project.json"] = 736,
    ["project.owasp.yaml"] = 744,
    ["prometheus-alertmanager.json"] = 748,
    ["prometheus.json"] = 745,
    ["prometheus.rules.json"] = 746,
    ["prometheus.rules.test.json"] = 747,
    ["proxies.json"] = 749,
    ["publiccode.yml"] = 750,
    ["pubspec.yaml"] = 751,
    ["pyrseas-0.8.json"] = 754,
    pytest = 763,
    ["quilt.mod.json"] = 1140,
    ["rc3 auth"] = 769,
    ["rc3 collection"] = 770,
    ...
    ["rc3 settings"] = 774,
    ["registry.yaml"] = 54,
    ["release drafter"] = 1016,
    ["release-hub.json"] = 5,
    ["release-please-config.json"] = 779,
    ["release-please-manifest.json"] = 780,
    ["release-plz.toml"] = 781,
    ["renv.lock"] = 795,
    ["reposets Configuration"] = 784,
    ["reposets Credentials"] = 785,
    ["revola.json"] = 3,
    ["rivet.json"] = 1164,
    ["rivet.yaml (legacy)"] = 1163,
    rumdl = 800,
    runny = 799,
    runspec = 1327,
    rustfmt = 801,
    ...
    samt = 804,
    samtrc = 805,
    ["sarif-1.0.0.json"] = 807,
    ["sarif-2.0.0.json"] = 808,
    ["sarif-2.1.0"] = 818,
    ["sarif-2.1.0-rtm.2"] = 809,
    ["sarif-2.1.0-rtm.3"] = 811,
    ["sarif-2.1.0-rtm.4"] = 813,
    ["sarif-2.1.0-rtm.5"] = 815,
    ["sarif-2.1.0-rtm.6"] = 816,
    ["sarif-external-property-file-2.1.0"] = 819,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 810,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 812,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 814,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 817,
    ["scalingo.json configuration"] = 820,
    ["schema.org - Action"] = 822,
    ["schema.org - ContactPoint"] = 823,
    ["schema.org - Place"] = 824,
    ["schema.org - Thing"] = 825,
    ["secrethub.yml"] = 1142,
    ["semantic-release"] = 832,
    ["servicehub.config.json"] = 993,
    ["servicehub.service.json"] = 992,
    ["settings.job"] = 835,
    ["sfdx-hardis configuration"] = 837,
    ["shard.yml"] = 1180,
    ["size-limit configuration"] = 842,
    ["skaffold.yaml"] = 1064,
    ["skyuxconfig.json"] = 844,
    ["snowflake-config"] = 846,
    ["snowflake-connections"] = 847,
    ["spicepod.yaml"] = 1201,
    ["sqlc configuration"] = 880,
    ["stripe-app-local.json"] = 891,
    ["stripe-app.json"] = 890,
    swcrc = 1048,
    ["task.json"] = 900,
    taskcat = 1011,
    ["template.json"] = 905,
    ["templatsources.json"] = 906,
    ["text2confl config"] = 1311,
    ["theme.json"] = 909,
    ["tizen_workspace.json"] = 911,
    tldr = 912,
    ["tm_devices configuration file"] = 1268,
    tmuxinator = 996,
    tox = 914,
    ["transcend.yml"] = 923,
    ["tree-sitter grammar.json"] = 462,
    ["trime.yaml"] = 924,
    ["trunk.yaml"] = 926,
    ["ts-force-config.json"] = 931,
    ["tsconfig.json"] = 927,
    ["tsd.json"] = 928,
    ["tsdoc.json"] = 929,
    ["tsdrc.json"] = 930,
    ...
    v8r = 974,
    vcluster = 1187,
    ["vcpkg configuration file"] = 264,
    ["vcpkg manifest file"] = 263,
    ["vega-lite.json"] = 956,
    ["vega.json"] = 955,
    ["venvironment.yaml"] = 958,
    ["venvplus.yaml"] = 959,
    version = 1250,
    ["version.json"] = 961,
    ["vhwdebugger-binding.yaml"] = 963,
    ["vim-addon-info"] = 964,
    ["vs-2017.3.host.json"] = 966,
    ["vs-nesting.json"] = 967,
    ["vsls.json"] = 965,
    ["vss-extension.json"] = 971,
    vtcfg = 1256,
    ["vtesttree.yaml"] = 972,
    ["vtestunit.yaml"] = 973,
    ["warp-keysets.json"] = 1148,
    ["warp-themes.json"] = 1149,
    ["warp-workflows.json"] = 1150,
    ["webhint.io"] = 1104,
    ["webjobpublishsettings.json"] = 978,
    ["webjobs-list.json"] = 977,
    ["well-known-fursona"] = 1188,
    ["xs-app.json"] = 1006,
    ["xunit.runner.json"] = 991,
    yamlfmt = 1033,
    yamllint = 1034,
    ["yap.json"] = 1035,
    ["zerops.yml"] = 1197,
