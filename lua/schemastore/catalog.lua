...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1080,
    ["API Builder"] = 894,
    ["AVA Configuration"] = 956,
    ...
    ["AWS Copilot Manifest"] = 1119,
    ["AWS SAM CLI Samconfig"] = 224,
    ["Adobe UXP Manifest"] = 1018,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1109,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 928,
    ["All Contributors configuration file"] = 981,
    ...
    ["Application list for a WinUtil"] = 1062,
    ArchitectFX = 1067,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["BX CI"] = 123,
    ["Bashly (bashly.yml)"] = 985,
    ["Bashly Settings (bashly-settings.yml)"] = 986,
    ["Better Code Hub"] = 898,
    ["Better Scripts"] = 124,
    Bigconfig = 96,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1073,
    BizTalkServerApplicationSchema = 866,
    Bleep = 125,
    ...
    ["Butane Config"] = 941,
    C4InterFlow = 1088,
    ["CDK Environment Manager, concrete environment configuration"] = 1112,
    ["CDK Environment Manager, concrete environments definition"] = 1111,
    ["CDK Environment Manager, environment definition"] = 1110,
    ["CGS Card Game Specification (cgs.json)"] = 1023,
    ["CICS TS region tagging"] = 950,
    ["CICS TS resource import"] = 951,
    ["CICS TS resource model"] = 952,
    ["CICS TS resource overrides"] = 953,
    ["CMake Presets"] = 126,
    ["CNC Codes"] = 147,
    ["CRS WAF test file"] = 1052,
    ["CRS WAF test platform overrides file"] = 1053,
    ...
    ["Chamaleon environment"] = 1077,
    ["Chamaleon properties"] = 1078,
    ["Chamaleon template"] = 1076,
    Changesets = 233,
    Changie = 135,
    Charmcraft = 136,
    Cheatsheets = 938,
    ...
    ["Clawject config"] = 153,
    ["Cloud Foundry Application Manifest"] = 1034,
    ["Cloud Run Spec v1"] = 1057,
    ...
    Concord = 1051,
    ["Configu .cfgu files"] = 1039,
    ["Configu .configu file"] = 1040,
    Conjure = 146,
    ["Container Structure Test"] = 880,
    Containerlab = 907,
    ["Contextive Glossary"] = 1104,
    Convex = 145,
    ["Crowdsec collection config"] = 243,
    ["Crowdsec parser config"] = 244,
    ["Crowdsec scenario config"] = 245,
    ["CumulusCI Config"] = 152,
    ["Custom Machinery Machine"] = 1024,
    ["Custom Machinery Recipe"] = 1025,
    ...
    ["DonateCaseBetterCasino menu"] = 1081,
    ...
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1124,
    ["EasyVCR .NET"] = 310,
    ...
    ["GeoJSON.json latest"] = 945,
    GherKing = 949,
    ["GitHub Action"] = 340,
    ["GitHub Actions typing"] = 1064,
    ...
    ["Google Digital Assetlinks"] = 1105,
    Goreleaser = 368,
    ["Goreleaser Pro"] = 369,
    Goss = 370,
    ["Gradle Build Cache Node"] = 896,
    ["Gradle Enterprise"] = 895,
    ...
    Hadolint = 876,
    Hammerkit = 906,
    ["Hardware Sentry Configuration"] = 961,
    ["HashiCorp Vault"] = 382,
    Hatch = 877,
    Hayagriva = 384,
    Hayson = 385,
    ...
    ["JFrog File Spec"] = 416,
    ["JFrog Pipelines YML DSL"] = 970,
    ["JMeter DSL cli config"] = 417,
    JReleaser = 420,
    ["JSON Document Transform"] = 428,
    ["JSON Feed"] = 429,
    ["JSON Resume"] = 653,
    ["JSON Schema Draft 2020-12"] = 844,
    ["JSON Schema Draft 4"] = 841,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1003,
    ["JSON Schema Draft 7"] = 842,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1004,
    ["JSON Schema Draft 8 (2019-09)"] = 843,
    ["JSON-API"] = 427,
    ["JSON-e templates"] = 903,
    ["JSON-stat 2.0"] = 837,
    JSONPatch = 431,
    ...
    ["Jujutsu (jj) VCS config"] = 1118,
    ["KIMMDY config file"] = 442,
    ["KODE/CI build.yaml"] = 966,
    ["KSP-AVC"] = 838,
    ["KSP-CKAN"] = 839,
    ["KSP-NetKAN"] = 840,
    KSY = 1033,
    ...
    ["Metadata for a Cinnamon spice"] = 1060,
    ["Metatype Configuration"] = 481,
    ["MetricsHub Configuration"] = 482,
    ["MetricsHub Connector Configuration"] = 483,
    ["Micro Editor Syntax"] = 994,
    ["Microsoft Band Web Tile"] = 484,
    ["Microsoft RulesEngine workflow rules"] = 1048,
    ["Microsoft RulesEngine workflow rules list"] = 1049,
    ["Minecraft Custom Main Menu Mod"] = 1012,
    ...
    ["MongoDB Atlas Search Index Definition"] = 965,
    ["Monika Configuration"] = 963,
    ["Monoweave Configuration"] = 509,
    ["Motif config"] = 858,
    MultiQC = 1098,
    ["NOX Framework (Service)"] = 527,
    ["Netin Diagnostic System Template"] = 923,
    ["Netlify config"] = 517,
    ["Network-as-Code Data Model"] = 518,
    ["Nightwatch.js"] = 520,
    ["Node.js configuration"] = 863,
    ...
    ["OpenUtau ustx"] = 545,
    ["OpenWeather Current Weather API"] = 902,
    ["OpenWeather Road Risk API"] = 901,
    ...
    ["Power Pages Configuration"] = 1115,
    ["Preset list for a WinUtil"] = 1063,
    ...
    Pylock = 1106,
    Pyright = 628,
    ["Python script metadata"] = 1100,
    ["QType AI DSL"] = 631,
    Qgoda = 630,
    Qodana = 933,
    ["Qt Creator workspace file"] = 1041,
    ["Quali Torque Blueprint Spec 2"] = 958,
    ["QueryFirst config file"] = 976,
    ["RKE Cluster Configuration JSON"] = 911,
    ["RKE Cluster Configuration YAML"] = 910,
    RadioHound = 621,
    Railway = 632,
    ["Rancher Fleet"] = 623,
    ["Rattler-build"] = 633,
    ...
    ["Render Blueprints"] = 909,
    RenderCV = 655,
    Renovate = 654,
    ["Replit config"] = 648,
    Restate = 1093,
    ["Revel Digital Gadget Definition File"] = 1117,
    RoadRunner = 657,
    ["Robust Station Image"] = 1123,
    ...
    ["SauceCTL Configuration"] = 920,
    ["Schema Catalog"] = 680,
    ["Scoop manifest"] = 685,
    ["Semantic Data Fabric (SDF) file"] = 689,
    ["Semgrep Rule"] = 691,
    ["Serenity Code Generator (Sergen)"] = 692,
    ["Serverless Framework Configuration"] = 927,
    ["Serverless Workflow"] = 929,
    ["Settings for a Cinnamon spice"] = 1059,
    ["Settings.paf"] = 694,
    ["Shopware 6 Configuration"] = 930,
    ["Shopware CLI Extension Store Configuration"] = 931,
    ["Shopware CLI Project Store Configuration"] = 932,
    ["Sigma Detection Rule"] = 696,
    ["Sigrid scope configuration file"] = 697,
    ["SkyPilot Task JSON"] = 1017,
    ...
    StackBlitz = 739,
    ["StackHawk Scanner Configuration"] = 926,
    Stale = 740,
    ["Starlake Data Pipeline"] = 899,
    Starship = 741,
    ["Statamic Blueprint"] = 742,
    ["Stella configuration file"] = 743,
    ["Streamlit configuration file"] = 744,
    ["Stryker Mutator"] = 747,
    ["StyleCop Analyzers Configuration"] = 748,
    ["Stylelint (.stylelintrc)"] = 749,
    ["Stylua Config"] = 1107,
    ["Sublime Syntax"] = 972,
    ["Subsquid squid manifest"] = 1019,
    ["Swagger API 2.0"] = 751,
    ["Synadia Connect Component"] = 752,
    TSON = 787,
    TSTyche = 788,
    ["TYPO3 Vendor Bundler config"] = 793,
    ["Tab data for a LinUtil"] = 1066,
    ["Tab list for a LinUtil"] = 1065,
    Tach = 753,
    ["Tach Domain"] = 754,
    Talhelper = 756,
    ["Talisman configuration"] = 757,
    Taplo = 1108,
    ["Taskfile config"] = 904,
    Taurus = 758,
    Tauticord = 759,
    Telefonistka = 1094,
    ["Terrateam config"] = 1120,
    ["TestEnvironment.json"] = 770,
    ["TextMate Grammar"] = 769,
    Threagile = 765,
    ["Tier.run pricing.json"] = 762,
    Tikibase = 763,
    Tombi = 768,
    ["Traefik v2"] = 773,
    ["Traefik v2 File Provider"] = 774,
    ["Traefik v3"] = 775,
    ["Traefik v3 File Provider"] = 776,
    ["Travis CI (.travis.yml)"] = 772,
    Trident = 1090,
    ["TrueScript for *.tscript files"] = 779,
    ["Tugboat QA config.yml"] = 1087,
    TunnelHub = 1007,
    Turborepo = 771,
    Tycho = 1055,
    Tye = 934,
    ["Tyk Gateway - Open Source v5.7+"] = 1099,
    ["Typst Manifest"] = 794,
    ["UET BuildConfig.json"] = 977,
    ["UI5 Manifest"] = 800,
    ["UNCORS configuration"] = 804,
    ["UTAM Page Object"] = 803,
    ["Ubuntu Server Autoinstall"] = 798,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1091,
    ["Uniswap Token List"] = 887,
    ["Universal Schedule Format"] = 805,
    ["Unreal Engine Uplugin"] = 978,
    ["Unreal Engine Uproject"] = 979,
    ["UpCloud CLI (upctl) configuration"] = 1092,
    ["Updatecli Compose"] = 942,
    ["Updatecli Policy Manifest"] = 943,
    ["Updatecli Policy Metadata"] = 944,
    Uplift = 975,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 908,
    V2Ray = 948,
    ["VSCode Code Snippets"] = 208,
    ["VSIX CLI publishing"] = 825,
    Vector = 807,
    ["Vela Pipeline Configuration"] = 810,
    Vercel = 207,
    ["Version Bumper config"] = 815,
    ["Viash Component Config"] = 1096,
    ["Viash Package Config"] = 1097,
    Visivo = 1005,
    ["WP-CLI"] = 835,
    Wake = 1089,
    ["Waku Config"] = 1069,
    ["Web App Manifest"] = 831,
    ["Web types"] = 834,
    WebExtensions = 830,
    ["Webman package recipe"] = 954,
    ["Windows Package Manager Installer Manifest"] = 883,
    ["Windows Package Manager Locale Manifest"] = 884,
    ["Windows Package Manager Singleton Manifest"] = 882,
    Winutil = 885,
    ["WireMock stub mapping"] = 1072,
    ["Woodpecker pipeline config"] = 922,
    ["Wrangler CLI"] = 836,
    ["Xstate Machine"] = 940,
    ["Yandex Workflow Language"] = 1061,
    ["Yarn Config (.yarnrc.yml)"] = 897,
    ["Yippee-Ki-JSON configuration YML"] = 889,
    ["YouTrack App"] = 1058,
    ["Zarf Package Configuration"] = 1122,
    ["Zerops.io config"] = 1046,
    ["Zerops.io import"] = 1047,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 1010,
    ...
    ["behat.yml"] = 106,
    ["bigquery-table"] = 95,
    ["bioimageio resource description"] = 1027,
    ...
    ["crowdin.yml"] = 242,
    ["ctfd-setup configuration file"] = 1079,
    ["custom-elements.json"] = 997,
    ["cypress.json"] = 246,
    ...
    ["gematik health care insurance list"] = 1085,
    ["gematik health care patient list"] = 1082,
    ["gematik health care provider institution list"] = 1084,
    ["gematik health care provider list"] = 1083,
    ["gematik tiger test environment configuration"] = 1086,
    ["gitlab-ci"] = 348,
    ["global.json"] = 364,
    ...
    ["lint-staged (.lintstagedrc)"] = 852,
    ["local.settings.json"] = 470,
    ["localazy.json"] = 471,
    ["lotus.yaml"] = 469,
    ["lsdlschema.json"] = 472,
    ["markdown-link-check"] = 917,
    maturin = 918,
    mboats = 925,
    ["micro-settings.json"] = 989,
    ["mimetypes.json"] = 485,
    ["mirrord config"] = 854,
    mise = 855,
    ["mkdocs.yml"] = 505,
    ["monospace.yml"] = 508,
    ["moon.yml"] = 1071,
    ["mprocs Configuration file"] = 1042,
    ["mrdocs.yml"] = 506,
    ["mta.yaml"] = 856,
    ["mtad.yaml"] = 857,
    ["mycode.json"] = 515,
    ...
    ["plagiarize.yaml"] = 581,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1075,
    ["podbard.yaml"] = 584,
    ["portman.json"] = 585,
    ["prefect.toml"] = 593,
    ["prettierrc.json"] = 594,
    ...
    ["servicehub.config.json"] = 847,
    ["servicehub.service.json"] = 846,
    ["settings.job"] = 693,
    ...
    ["stripe-app-local.json"] = 746,
    ["stripe-app.json"] = 745,
    swcrc = 900,
    ["task.json"] = 755,
    taskcat = 865,
    ["template.json"] = 760,
    ["templatsources.json"] = 761,
    ["theme.json"] = 764,
    ["tizen_workspace.json"] = 766,
    tldr = 767,
    ["tm_devices configuration file"] = 1113,
    tmuxinator = 850,
    ["transcend.yml"] = 777,
    ["tree-sitter grammar.json"] = 372,
    ["trime.yaml"] = 778,
    ["trunk.yaml"] = 780,
    ["ts-force-config.json"] = 785,
    ["tsconfig.json"] = 781,
    ["tsd.json"] = 782,
    ["tsdoc.json"] = 783,
    ["tsdrc.json"] = 784,
    ...
    ["vega-lite.json"] = 809,
    ["vega.json"] = 808,
    ["venvironment-basic.yaml"] = 812,
    ["venvironment.yaml"] = 811,
    ["venvplus-basic.yaml"] = 814,
    ["venvplus.yaml"] = 813,
    version = 1095,
    ["version.json"] = 816,
    ["vhwdebugger-binding.yaml"] = 818,
    ["vim-addon-info"] = 819,
    ["vs-2017.3.host.json"] = 821,
    ["vs-nesting.json"] = 822,
    ["vsls.json"] = 820,
    ["vss-extension.json"] = 826,
    vtcfg = 1101,
    ["vtesttree.yaml"] = 827,
    ["vtestunit.yaml"] = 828,
    ["warp-keysets.json"] = 998,
    ["warp-themes.json"] = 999,
    ["warp-workflows.json"] = 1000,
    ["webhint.io"] = 955,
    ["webjobpublishsettings.json"] = 833,
    ["webjobs-list.json"] = 832,
    ["well-known-fursona"] = 1037,
    ["xs-app.json"] = 860,
    ["xunit.runner.json"] = 845,
    yamllint = 888,
    zuul = 871,
    ["Žinoma"] = 881
  },
