...
M.json = {
  ...
  index = {
    ...
    AIConfig = 34,
    ["AMX Muse Program Descriptor"] = 1164,
    ["API Builder"] = 972,
    ["AVA Configuration"] = 1035,
    ...
    ["AWS Copilot Manifest"] = 1203,
    ["AWS SAM CLI Samconfig"] = 263,
    ["Adobe UXP Manifest"] = 1098,
    ["Aerleon Network & Service Definitions"] = 20,
    ["Aerleon Policy"] = 21,
    ["AgentCore CLI"] = 1243,
    Aider = 1193,
    Air = 23,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1214,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1213,
    ["Airlock Microgateway"] = 35,
    ["Alacritty Configuration"] = 1007,
    ["All Contributors configuration file"] = 1061,
    ...
    ["Application list for a WinUtil"] = 1143,
    ArchitectFX = 1148,
    ["Argo CD"] = 54,
    ["Argo Events"] = 55,
    ["Argo Workflows"] = 56,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1212,
    ["Azure IoT Operations connector metadata"] = 1209,
    ...
    ["Azure Pipelines"] = 112,
    ["Azure Static Web Apps CLI configuration file"] = 816,
    ["Azure Static Web Apps configuration file"] = 815,
    BMML = 1231,
    ["BOSH CPI Config"] = 137,
    ...
    ["Bacon config"] = 5,
    ["Barba-CV"] = 83,
    ["Bashly (bashly.yml)"] = 1065,
    ["Bashly Settings (bashly-settings.yml)"] = 1066,
    Bento = 1230,
    ["Better Code Hub"] = 977,
    ["Better Scripts"] = 158,
    Bigconfig = 130,
    ["Biome Formatter Config"] = 84,
    ["Bitmovin Encoding Template"] = 1157,
    BizTalkServerApplicationSchema = 944,
    Bleep = 159,
    ["Block Protocol Metadata"] = 156,
    ["Bluebricks blueprint config"] = 1236,
    ["Boyka Framework"] = 139,
    Briefcase = 950,
    ["Build Info"] = 147,
    Buildkite = 149,
    ...
    ["Butane Config"] = 1020,
    C4InterFlow = 1172,
    ["CDK Environment Manager, concrete environment configuration"] = 1196,
    ["CDK Environment Manager, concrete environments definition"] = 1195,
    ["CDK Environment Manager, environment definition"] = 1194,
    ["CGS Card Game Specification (cgs.json)"] = 1103,
    ["CICS TS region tagging"] = 1029,
    ["CICS TS resource import"] = 1030,
    ["CICS TS resource model"] = 1031,
    ["CICS TS resource overrides"] = 1032,
    ["CMake Presets"] = 160,
    ["CNC Codes"] = 182,
    ["CRS WAF test file"] = 1133,
    ["CRS WAF test platform overrides file"] = 1134,
    ...
    ["Chamaleon environment"] = 1161,
    ["Chamaleon properties"] = 1162,
    ["Chamaleon template"] = 1160,
    Changepacks = 1223,
    Changesets = 272,
    Changie = 169,
    Charmcraft = 170,
    ...
    ["Clawject config"] = 188,
    ["Cloud Foundry Application Manifest"] = 1115,
    ["Cloud Run Spec v1"] = 1138,
    ...
    Concord = 1132,
    ["Configu .cfgu files"] = 1120,
    ["Configu .configu file"] = 1121,
    Conjure = 181,
    ["Container Structure Test"] = 958,
    Containerlab = 986,
    ["Contextive Glossary"] = 1188,
    Convex = 180,
    ["Crowdsec collection config"] = 282,
    ["Crowdsec parser config"] = 283,
    ["Crowdsec scenario config"] = 284,
    ["CumulusCI Config"] = 187,
    ["Cursor Agent Environment"] = 1241,
    ["Custom Machinery Machine"] = 1104,
    ["Custom Machinery Recipe"] = 1105,
    ...
    ["DonateCaseBetterCasino menu"] = 1165,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1073,
    ["EAS config"] = 351,
    ["ECA - Editor Code Assistant"] = 335,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1062,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1208,
    ["EasyVCR .NET"] = 352,
    ["Eidolon Resource"] = 1149,
    ...
    ["Erda Pipeline"] = 1111,
    ["Erda Runtime"] = 1112,
    ["Espanso config.yml"] = 1234,
    ["Espanso match.yml"] = 1233,
    Esquio = 340,
    ["Estuary Flow Catalog"] = 1026,
    ["Ethereum ERC1155"] = 1245,
    ["Ethereum ERC721"] = 1244,
    ...
    ["Evolving Resolutive Process notation"] = 1210,
    ["Expo SDK"] = 350,
    ...
    ["GeoJSON.json latest"] = 1024,
    GherKing = 1028,
    ["GitHub Action"] = 385,
    ["GitHub Actions typing"] = 1145,
    ...
    ["Google Digital Assetlinks"] = 1189,
    Goreleaser = 413,
    ["Goreleaser Pro"] = 414,
    Goss = 415,
    ["Gradle Build Cache Node"] = 975,
    ["Gradle Enterprise"] = 974,
    ...
    Hadolint = 954,
    Hammerkit = 985,
    ["Hardware Sentry Configuration"] = 1040,
    ...
    ["JFrog File Spec"] = 466,
    ["JFrog Pipelines YML DSL"] = 1050,
    ["JMeter DSL cli config"] = 467,
    JReleaser = 470,
    ["JSON Document Transform"] = 478,
    ["JSON Feed"] = 479,
    ["JSON Resume"] = 727,
    ["JSON Schema Draft 2020-12"] = 922,
    ["JSON Schema Draft 4"] = 919,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1083,
    ["JSON Schema Draft 7"] = 920,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1084,
    ["JSON Schema Draft 8 (2019-09)"] = 921,
    ["JSON-API"] = 477,
    ["JSON-e templates"] = 982,
    ["JSON-stat 2.0"] = 915,
    JSONPatch = 481,
    ...
    ["Jujutsu (jj) VCS config"] = 1202,
    ["KIMMDY config file"] = 492,
    ["KODE/CI build.yaml"] = 1046,
    ["KSP-AVC"] = 916,
    ["KSP-CKAN"] = 917,
    ["KSP-NetKAN"] = 918,
    KSY = 1113,
    ...
    ["Metadata for a Cinnamon spice"] = 1141,
    ["Metatype Configuration"] = 533,
    ["MetricsHub Configuration"] = 534,
    ["MetricsHub Connector Configuration"] = 535,
    ["Micro Editor Syntax"] = 1074,
    ["Microsoft Band Web Tile"] = 536,
    ["Microsoft RulesEngine workflow rules"] = 1129,
    ["Microsoft RulesEngine workflow rules list"] = 1130,
    ["Minecraft Custom Main Menu Mod"] = 1092,
    ...
    ["MongoDB Atlas Search Index Definition"] = 1045,
    ["Monika Configuration"] = 1043,
    ["Monoweave Configuration"] = 563,
    ["Motif config"] = 936,
    MultiQC = 1182,
    ["NOX Framework (Service)"] = 584,
    ["Netin Diagnostic System Template"] = 1002,
    ["Netlify config"] = 571,
    ...
    ["OpenUtau ustx"] = 607,
    ["OpenWeather Current Weather API"] = 981,
    ["OpenWeather Road Risk API"] = 980,
    ...
    ["Power Pages Configuration"] = 1199,
    ["Preset list for a WinUtil"] = 1144,
    ...
    Pylock = 1190,
    Pyright = 701,
    ["Python script metadata"] = 1184,
    ["QType AI DSL"] = 704,
    Qgoda = 703,
    Qodana = 1012,
    ["Qt Creator workspace file"] = 1122,
    ["Quali Torque Blueprint Spec 2"] = 1037,
    ["QueryFirst config file"] = 1056,
    ["RKE Cluster Configuration JSON"] = 990,
    ["RKE Cluster Configuration YAML"] = 989,
    RadioHound = 694,
    Railpack = 706,
    Railway = 705,
    ["Rancher Fleet"] = 696,
    ...
    ["Replit config"] = 722,
    Restate = 1177,
    ["Revel Digital Gadget Definition File"] = 1201,
    RoadRunner = 733,
    ["Robust Station Image"] = 1207,
    Rockcraft = 734,
    ["Roo Coder Custom Modes"] = 735,
    Rubocop = 724,
    ["Rudder techniques"] = 1096,
    Ruff = 725,
    ["Rust Project"] = 726,
    ["Rust toolchain"] = 739,
    ["SDMX data message"] = 765,
    ["SDMX metadata message"] = 764,
    ["SDMX structure message"] = 763,
    ["SIL Kit Participant Configuration"] = 775,
    ["SIL Kit Registry Configuration"] = 776,
    ["SPDX 2.3"] = 813,
    SWADL = 829,
    ["Safebox Config"] = 1051,
    ["Sapphire CLI Config"] = 742,
    ["SauceCTL Configuration"] = 999,
    ["Schema Catalog"] = 757,
    ["Scoop manifest"] = 762,
    ["Semantic Data Fabric (SDF) file"] = 766,
    ["Semgrep Rule"] = 768,
    ["Serenity Code Generator (Sergen)"] = 769,
    ["Serverless Framework Configuration"] = 1006,
    ["Serverless Workflow"] = 1008,
    ["Settings for a Cinnamon spice"] = 1140,
    ["Settings.paf"] = 771,
    ["Shopware 6 Configuration"] = 1009,
    ["Shopware CLI Extension Store Configuration"] = 1010,
    ["Shopware CLI Project Store Configuration"] = 1011,
    ["Sigma Detection Rule"] = 773,
    ["Sigrid scope configuration file"] = 774,
    ["SkyPilot Task JSON"] = 1097,
    ["Slack app manifest"] = 778,
    Snapcraft = 780,
    Solidarity = 783,
    ["Solution filters"] = 784,
    ["Source Maps v3"] = 785,
    Sourcery = 786,
    ["Spack bootstrap.yaml"] = 787,
    ["Spack cdash.yaml"] = 788,
    ["Spack ci.yaml"] = 789,
    ["Spack compilers.yaml"] = 790,
    ["Spack concretizer.yaml"] = 791,
    ["Spack config.yaml"] = 792,
    ["Spack definitions.yaml"] = 793,
    ["Spack develop.yaml"] = 794,
    ["Spack env_vars.yaml"] = 795,
    ["Spack environment"] = 801,
    ["Spack include.yaml"] = 796,
    ["Spack mirrors.yaml"] = 797,
    ["Spack modules.yaml"] = 798,
    ["Spack packages.yaml"] = 799,
    ["Spack repos.yaml"] = 800,
    ["Spack toolchains.yaml"] = 802,
    ["Spack upstreams.yaml"] = 803,
    ["Spack view.yaml"] = 804,
    ["Speakeasy Generation Config File"] = 808,
    ["Speakeasy Lint Configuration File"] = 805,
    ["Speakeasy Test Generation Configuration File"] = 806,
    ["Speakeasy Workflow File"] = 807,
    SpecIF = 809,
    ["Specmatic Configuration"] = 810,
    ["Sponge Mixin configuration"] = 811,
    StackBlitz = 817,
    ["StackHawk Scanner Configuration"] = 1005,
    Stale = 818,
    Starfish = 819,
    ["Starlake Data Pipeline"] = 978,
    Starship = 820,
    ["Statamic Blueprint"] = 821,
    ["Stella configuration file"] = 822,
    ["Streamlit configuration file"] = 823,
    ["Stryker Mutator"] = 826,
    ["StyleCop Analyzers Configuration"] = 827,
    ["Stylelint (.stylelintrc)"] = 828,
    ["Stylua Config"] = 1191,
    ["Sublime Syntax"] = 1052,
    ["Subsquid squid manifest"] = 1099,
    ["Swagger API 2.0"] = 830,
    ["Synadia Connect Component"] = 831,
    TSON = 867,
    TSTyche = 868,
    ["TYPO3 Vendor Bundler config"] = 874,
    ["Tab data for a LinUtil"] = 1147,
    ["Tab list for a LinUtil"] = 1146,
    Tach = 832,
    ["Tach Domain"] = 833,
    Talhelper = 835,
    ["Talisman configuration"] = 836,
    Taplo = 1192,
    ["Taskfile config"] = 983,
    Taurus = 837,
    Tauticord = 838,
    ["Tekton Pipeline"] = 1220,
    ["Tekton PipelineRun"] = 1221,
    ["Tekton Task"] = 1218,
    ["Tekton TaskRun"] = 1219,
    Telefonistka = 1178,
    ["Terrateam config"] = 1204,
    ["TestEnvironment.json"] = 850,
    ["TextMate Grammar"] = 849,
    Threagile = 844,
    ["Tier.run pricing.json"] = 841,
    Tikibase = 842,
    Tombi = 847,
    ["Traefik v2"] = 853,
    ["Traefik v2 File Provider"] = 854,
    ["Traefik v3"] = 855,
    ["Traefik v3 File Provider"] = 856,
    ["Travis CI (.travis.yml)"] = 852,
    Treefmt = 418,
    Trident = 1174,
    ["TrueScript for *.tscript files"] = 859,
    ["Tugboat QA config.yml"] = 1171,
    TunnelHub = 1087,
    Turborepo = 851,
    Tycho = 1136,
    Tye = 1013,
    ["Tyk Gateway - Open Source v5.7+"] = 1183,
    ["UET BuildConfig.json"] = 1057,
    ["UI5 Manifest"] = 880,
    ["UNCORS configuration"] = 884,
    ["UTAM Page Object"] = 883,
    ["Ubuntu Server Autoinstall"] = 878,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1175,
    ["Uniswap Token List"] = 965,
    ["Universal Schedule Format"] = 885,
    ["Unreal Engine Uplugin"] = 1058,
    ["Unreal Engine Uproject"] = 1059,
    ["UpCloud CLI (upctl) configuration"] = 1176,
    ["Updatecli Compose"] = 1021,
    ["Updatecli Policy Manifest"] = 1022,
    ["Updatecli Policy Metadata"] = 1023,
    Uplift = 1055,
    ["Upsun config"] = 6,
    ["User Journey Map"] = 987,
    V2Ray = 1027,
    ["VSCode Code Snippets"] = 247,
    ["VSIX CLI publishing"] = 903,
    Vector = 887,
    ["Vela Pipeline Configuration"] = 890,
    Vercel = 246,
    ["Version Bumper config"] = 893,
    Vespertide = 1225,
    ["Vespertide Migration"] = 1226,
    ["Vespertide Model"] = 1227,
    ["Viash Component Config"] = 1180,
    ["Viash Package Config"] = 1181,
    Visivo = 1085,
    ["WP-CLI"] = 913,
    Wake = 1173,
    ["Waku Config"] = 1150,
    ["Web App Manifest"] = 909,
    ["Web types"] = 912,
    WebExtensions = 908,
    ["Webman package recipe"] = 1033,
    ["Windows Package Manager Installer Manifest"] = 961,
    ["Windows Package Manager Locale Manifest"] = 962,
    ["Windows Package Manager Singleton Manifest"] = 960,
    Winutil = 963,
    ["WireMock CLI import configuration"] = 1156,
    ["WireMock CLI local service configuration"] = 1155,
    ["WireMock message stub mapping"] = 1154,
    ["WireMock stub mapping"] = 1153,
    ["Woodpecker pipeline config"] = 1001,
    ["Wrangler CLI"] = 914,
    ["Xstate Machine"] = 1019,
    ["Yandex Workflow Language"] = 1142,
    ["Yarn Config (.yarnrc.yml)"] = 976,
    ["Yippee-Ki-JSON configuration YML"] = 967,
    ["YouTrack App"] = 1139,
    ["Zarf Package Configuration"] = 1206,
    ["Zerops.io config"] = 1127,
    ["Zerops.io import"] = 1128,
    ["Zola Configuration"] = 1217,
    ["aerleon.yml"] = 19,
    ["amplify.yml"] = 12,
    ["angular.json"] = 36,
    apko = 1090,
    ...
    ["behat.yml"] = 140,
    ["bigquery-table"] = 129,
    ["bioimageio resource description"] = 1107,
    ...
    ["chutzpah.json"] = 255,
    cibuildwheel = 175,
    ["clang-format (.clang-format)"] = 1025,
    ["clang-tidy"] = 233,
    clangd = 232,
    clib = 234,
    ...
    ["crowdin.yml"] = 281,
    ["ctfd-setup configuration file"] = 1163,
    ["custom-elements.json"] = 1077,
    ["cypress.json"] = 285,
    ...
    ["gematik health care insurance list"] = 1169,
    ["gematik health care patient list"] = 1166,
    ["gematik health care provider institution list"] = 1168,
    ["gematik health care provider list"] = 1167,
    ["gematik tiger test environment configuration"] = 1170,
    ["git-town.toml"] = 1215,
    ["gitlab-ci"] = 393,
    ["global.json"] = 409,
    ...
    ["lint-staged (.lintstagedrc)"] = 930,
    ["local.settings.json"] = 520,
    ["localazy.json"] = 521,
    ["lotus.yaml"] = 519,
    ["lsdlschema.json"] = 522,
    ["macro.json"] = 1042,
    ["markdown-link-check"] = 996,
    maturin = 997,
    mboats = 1004,
    ["micro-settings.json"] = 1069,
    ["mimetypes.json"] = 537,
    ["mirrord config"] = 932,
    mise = 933,
    ["mkdocs.yml"] = 557,
    ...
    ["monospace.yml"] = 562,
    ["moon.yml"] = 1152,
    ["mprocs Configuration file"] = 1123,
    ["mrdocs.yml"] = 559,
    ["mta.yaml"] = 934,
    ["mtad.yaml"] = 935,
    ["mycode.json"] = 569,
    ...
    ["plagiarize.yaml"] = 646,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1159,
    ["podbard.yaml"] = 649,
    ["portman.json"] = 652,
    ["prefect.toml"] = 660,
    ["prefect.yaml"] = 661,
    ...
    ["secrethub.yml"] = 1072,
    ["semantic-release"] = 767,
    ["servicehub.config.json"] = 925,
    ["servicehub.service.json"] = 924,
    ["settings.job"] = 770,
    ["sfdx-hardis configuration"] = 772,
    ["shard.yml"] = 1110,
    ["size-limit configuration"] = 777,
    ["skaffold.yaml"] = 994,
    ["skyuxconfig.json"] = 779,
    ["snowflake-config"] = 781,
    ["snowflake-connections"] = 782,
    ["spicepod.yaml"] = 1131,
    ["sqlc configuration"] = 814,
    ["stripe-app-local.json"] = 825,
    ["stripe-app.json"] = 824,
    swcrc = 979,
    ["task.json"] = 834,
    taskcat = 943,
    ["template.json"] = 839,
    ["templatsources.json"] = 840,
    ["text2confl config"] = 1240,
    ["theme.json"] = 843,
    ["tizen_workspace.json"] = 845,
    tldr = 846,
    ["tm_devices configuration file"] = 1197,
    tmuxinator = 928,
    tox = 848,
    ["transcend.yml"] = 857,
    ...
    ["vega-lite.json"] = 889,
    ["vega.json"] = 888,
    ["venvironment.yaml"] = 891,
    ["venvplus.yaml"] = 892,
    version = 1179,
    ["version.json"] = 894,
    ["vhwdebugger-binding.yaml"] = 896,
    ["vim-addon-info"] = 897,
    ["vs-2017.3.host.json"] = 899,
    ["vs-nesting.json"] = 900,
    ["vsls.json"] = 898,
    ["vss-extension.json"] = 904,
    vtcfg = 1185,
    ["vtesttree.yaml"] = 905,
    ["vtestunit.yaml"] = 906,
    ["warp-keysets.json"] = 1078,
    ["warp-themes.json"] = 1079,
    ["warp-workflows.json"] = 1080,
    ["webhint.io"] = 1034,
    ["webjobpublishsettings.json"] = 911,
    ["webjobs-list.json"] = 910,
    ["well-known-fursona"] = 1118,
    ["xs-app.json"] = 938,
    ["xunit.runner.json"] = 923,
    yamllint = 966,
    zizmor = 1222,
    zuul = 949,
    ["Žinoma"] = 959
