...
M.json = {
  ...
  index = {
    ...
    ["<div>RIOTS' studio configuration"] = 698,
    ...
    ["Adobe UXP Manifest"] = 883,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Airplane task"] = 17,
    ["Alacritty Configuration"] = 790,
    ["All Contributors configuration file"] = 848,
    ...
    ["BX CI"] = 104,
    ["Bashly (bashly.yml)"] = 852,
    ["Bashly Settings (bashly-settings.yml)"] = 853,
    ["Better Code Hub"] = 762,
    ["Better Scripts"] = 105,
    Bigconfig = 81,
    BizTalkServerApplicationSchema = 732,
    Bleep = 106,
    ...
    ["Butane Config"] = 803,
    ["CGS Custom Card Game (CardGameDef.json)"] = 888,
    ["CICS TS region tagging"] = 812,
    ["CICS TS resource import"] = 813,
    ["CICS TS resource model"] = 814,
    ["CICS TS resource overrides"] = 815,
    ["CMake Presets"] = 107,
    ["CNC Codes"] = 121,
    ["CRS WAF test file"] = 917,
    ["CRS WAF test platform overrides file"] = 918,
    ...
    CityJSON = 117,
    ["Clawject config"] = 126,
    ["Cloud Foundry Application Manifest"] = 900,
    ["Cloud Run Spec v1"] = 922,
    ...
    Concord = 916,
    ["Configu .cfgu files"] = 905,
    ["Configu .configu file"] = 906,
    Conjure = 120,
    ["Container Structure Test"] = 745,
    Containerlab = 770,
    ["Crowdsec collection config"] = 210,
    ["Crowdsec parser config"] = 211,
    ["Crowdsec scenario config"] = 212,
    ["CumulusCI Config"] = 125,
    ["Custom Machinery Machine"] = 889,
    ["Custom Machinery Recipe"] = 890,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 860,
    ["EAS config"] = 276,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 849,
    ...
    ["Goreleaser Pro"] = 333,
    Goss = 334,
    ["Gradle Build Cache Node"] = 760,
    ["Gradle Enterprise"] = 759,
    ...
    Hadolint = 741,
    Hammerkit = 769,
    ["Hardware Sentry Configuration"] = 823,
    Hatch = 742,
    Hayson = 347,
    ...
    ["JFrog File Spec"] = 375,
    ["JFrog Pipelines YML DSL"] = 832,
    ["JMeter DSL cli config"] = 376,
    JReleaser = 378,
    ["JSON Document Transform"] = 386,
    ["JSON Feed"] = 387,
    ["JSON Resume"] = 566,
    ["JSON Schema Draft 2020-12"] = 711,
    ["JSON Schema Draft 4"] = 708,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 870,
    ["JSON Schema Draft 7"] = 709,
    ["JSON Schema Draft 7 (unofficial strict)"] = 871,
    ["JSON Schema Draft 8 (2019-09)"] = 710,
    ["JSON-API"] = 385,
    ["JSON-WF"] = 899,
    ["JSON-e templates"] = 767,
    ["JSON-stat 2.0"] = 705,
    JSONPatch = 389,
    ...
    ["Keycloak REST API"] = 840,
    ["Knative Functions - func.yaml"] = 295,
    ["KoDE/CI build.yaml"] = 828,
    ["Kong DBLess config"] = 829,
    KrakenD = 396,
    ...
    ["Micro Editor Syntax"] = 861,
    ["Microsoft Band Web Tile"] = 431,
    ["Microsoft RulesEngine workflow rules"] = 913,
    ["Microsoft RulesEngine workflow rules list"] = 914,
    ["Minecraft Custom Main Menu Mod"] = 878,
    ...
    ["MongoDB Atlas Search Index Definition"] = 827,
    ["Monika Configuration"] = 825,
    ["Monoweave Configuration"] = 455,
    ["Motif config"] = 725,
    ["NOX Framework (Service)"] = 472,
    ["Netin Diagnostic System Template"] = 785,
    ["Netlify config"] = 463,
    ...
    ["OpenUtau ustx"] = 485,
    ["OpenWeather Current Weather API"] = 766,
    ["OpenWeather Road Risk API"] = 765,
    ...
    ["Pipeline component"] = 777,
    ["PocketMine plugin.yml"] = 511,
    ["Postman collection"] = 516,
    ["Problem object RFC9457"] = 875,
    ...
    Qgoda = 548,
    Qodana = 795,
    ["Qt Creator workspace file"] = 907,
    ["Quali Torque Blueprint Spec 2"] = 820,
    ["QueryFirst config file"] = 843,
    ["RKE Cluster Configuration JSON"] = 774,
    ["RKE Cluster Configuration YAML"] = 773,
    ["Rancher Fleet"] = 542,
    ["Rattler-build"] = 549,
    Ray = 740,
    ["Read the Docs"] = 544,
    ...
    ["Render Blueprints"] = 772,
    RenderCV = 568,
    Renovate = 567,
    ["Replit config"] = 562,
    RoadRunner = 569,
    ["Rudder techniques"] = 881,
    Ruff = 564,
    ["Rust Project"] = 565,
    ["Rust toolchain"] = 573,
    ...
    ["SauceCTL Configuration"] = 782,
    ["Schema Catalog"] = 590,
    ["Scoop manifest"] = 595,
    ["Semantic Data Fabric (SDF) file"] = 599,
    ["Semgrep Rule"] = 601,
    ["Serenity Code Generator (Sergen)"] = 602,
    ["Serverless Framework Configuration"] = 789,
    ["Serverless Workflow"] = 791,
    ["Settings.paf"] = 604,
    ["Shopware 6 Configuration"] = 792,
    ["Shopware CLI Extension Store Configuration"] = 793,
    ["Shopware CLI Project Store Configuration"] = 794,
    Sigma = 606,
    ["Sigrid scope configuration file"] = 607,
    ["SkyPilot Task JSON"] = 882,
    ...
    StackBlitz = 627,
    ["StackHawk Scanner Configuration"] = 788,
    Stale = 628,
    ["Starlake Data Pipeline"] = 763,
    Starship = 629,
    ["Statamic Blueprint"] = 630,
    ["Stella configuration file"] = 631,
    ["StrmPrivacy Data Connector"] = 837,
    ["StrmPrivacy Data Contract"] = 838,
    ["StrmPrivacy SimpleSchema"] = 835,
    ["StrmPrivacy Stream"] = 836,
    ["StrmPrivacy batch job configuration file"] = 834,
    ["Stryker Mutator"] = 634,
    ["StyleCop Analyzers Configuration"] = 635,
    ["Stylelint (.stylelintrc)"] = 636,
    ["Sublime Syntax"] = 839,
    ["Subsquid squid manifest"] = 884,
    ["Swagger API 2.0"] = 638,
    TSON = 664,
    TSTyche = 665,
    Talhelper = 640,
    ...
    Tycho = 920,
    Tye = 796,
    ["UET BuildConfig.json"] = 844,
    ["UI5 Manifest"] = 674,
    ["UNCORS configuration"] = 678,
    ["UTAM Page Object"] = 677,
    ["Ubuntu Server Autoinstall"] = 672,
    ["Uniswap Token List"] = 751,
    ["Unreal Engine Uplugin"] = 845,
    ["Unreal Engine Uproject"] = 846,
    ["Updatecli Compose"] = 804,
    ["Updatecli Policy Manifest"] = 805,
    ["Updatecli Policy Metadata"] = 806,
    Uplift = 842,
    ["User Journey Map"] = 771,
    V2Ray = 810,
    ["VSCode Code Snippets"] = 176,
    ["VSIX CLI publishing"] = 693,
    ["Vela Pipeline Configuration"] = 682,
    Vercel = 175,
    Visivo = 872,
    ["Web App Manifest"] = 700,
    ["Web types"] = 703,
    WebExtensions = 699,
    ["Webman package recipe"] = 816,
    ["Windows Package Manager Installer Manifest"] = 748,
    ["Windows Package Manager Locale Manifest"] = 749,
    ["Windows Package Manager Singleton Manifest"] = 747,
    ...
    ["behat.yml"] = 89,
    ["bigquery-table"] = 80,
    ["bioimageio resource description"] = 892,
    ...
    ["lint-staged (.lintstagedrc)"] = 719,
    ["local.settings.json"] = 419,
    ["localazy.json"] = 420,
    ["lotus.yaml"] = 418,
    ["lsdlschema.json"] = 421,
    ["markdown-link-check"] = 780,
    mboats = 787,
    ["micro-settings.json"] = 856,
    ["mimetypes.json"] = 432,
    ["mirrord config"] = 720,
    mise = 721,
    ["mise-settings"] = 722,
    ...
    ["servicehub.config.json"] = 714,
    ["servicehub.service.json"] = 713,
    ["settings.job"] = 603,
    ...
    ["version.json"] = 685,
    ["vim-addon-info"] = 687,
    ["vs-2017.3.host.json"] = 689,
    ["vs-nesting.json"] = 690,
    ["vsls.json"] = 688,
    ["vss-extension.json"] = 694,
    ["vtesttree.yaml"] = 695,
    ["vtestunit.yaml"] = 696,
    ["warp-keysets.json"] = 865,
    ["warp-themes.json"] = 866,
    ["warp-workflows.json"] = 867,
    ["webhint.io"] = 817,
    ["webjobpublishsettings.json"] = 702,
    ["webjobs-list.json"] = 701,
    ["well-known-fursona"] = 903,
    ["xs-app.json"] = 727,
    ["xunit.runner.json"] = 712,
    yamllint = 752,
    ["zerops.io import file"] = 912,
    ["zerops.yml"] = 911,
    zuul = 736,
    ["Žinoma"] = 746
  },
