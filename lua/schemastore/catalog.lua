...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 149,
    [".cryproj (generic)"] = 503,
    [".cryproj engine-5.2"] = 498,
    [".cryproj engine-5.3"] = 499,
    [".cryproj engine-5.4"] = 500,
    [".cryproj engine-5.5"] = 501,
    [".cryproj engine-dev"] = 502,
    [".csscomb.json"] = 151,
    [".csslintrc"] = 152,
    [".eslintrc"] = 197,
    [".esmrc.json"] = 189,
    ...
    [".mtaext"] = 512,
    [".nodehawkrc"] = 318,
    [".npmpackagejsonlintrc"] = 321,
    [".phraseapp.yml"] = 355,
    [".pmbot.yml"] = 347,
    [".postcssrc"] = 352,
    [".pre-commit-config.yml"] = 353,
    [".pre-commit-hooks.yml"] = 354,
    [".putout.json"] = 372,
    [".rehyperc"] = 380,
    [".remarkrc"] = 381,
    [".sprite files"] = 424,
    ...
    [".vsext"] = 478,
    [".yarnrc.yml"] = 544,
    ["<div>RIOTS' studio configuration"] = 482,
    ["@factorial/drupal-breakpoints-css"] = 5,
    ["A micro editor config schema"] = 287,
    ["API Builder"] = 541,
    ["AVA Configuration Schema"] = 597,
    ["AWS CDK cdk.json"] = 137,
    ["AWS CloudFormation"] = 138,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 139,
    ["Airlock Microgateway"] = 9,
    ["Airplane task"] = 10,
    ["Alacritty Configuration Schema"] = 572,
    ["All Contributors configuration file"] = 624,
    ...
    ["Azure Pipelines"] = 47,
    ["Azure Static Web Apps CLI configuration file"] = 426,
    ["Azure Static Web Apps configuration file"] = 425,
    ["BX CI"] = 81,
    ["Better Code Hub"] = 546,
    ["Better Scripts"] = 82,
    BizTalkServerApplicationSchema = 518,
    ...
    ["Butane Config"] = 584,
    ["CICS TS region tagging"] = 591,
    ["CICS TS resource import"] = 592,
    ["CICS TS resource model"] = 593,
    ["CICS TS resource overrides"] = 594,
    ["CMake Presets"] = 83,
    ...
    ["Citation File Format"] = 140,
    CityJSON = 90,
    ["Code Climate"] = 113,
    CodeCV = 46,
    Codux = 120,
    ["Commandbox Box.json"] = 93,
    ["Commandbox Server.json"] = 94,
    ["Common Catalog Schema"] = 129,
    ["Common types for all schemas"] = 1,
    Conjure = 91,
    ["Container Structure Test"] = 529,
    Containerlab = 554,
    ["DWP Exchange - catalogue entry"] = 186,
    ["DWP Exchange - gateway"] = 184,
    ["DWP Exchange - meta"] = 185,
    ["Dart build configuration"] = 153,
    ["Dart test config"] = 154,
    ["DashLord configuration"] = 155,
    ["Datadog Service Definition"] = 271,
    ["Datahub Ingestion Recipe Schema"] = 598,
    ["Dein Config Schema"] = 96,
    Deno = 159,
    ["Deployer Recipe"] = 162,
    Devfile = 183,
    ["Discord Webhook"] = 164,
    ["Dolittle Artifacts"] = 168,
    ["Dolittle Bounded Context Configuration"] = 169,
    ["Dolittle Event Horizons Configuration"] = 170,
    ["Dolittle Resources Configuration"] = 171,
    ["Dolittle Server Configuration"] = 172,
    ["Dolittle Tenant Map Configuration"] = 174,
    ["Dolittle Tenants Configuration"] = 173,
    ["Dolittle Topology"] = 175,
    ["Drupal Breakpoints Schema"] = 97,
    ["Drupal Config Schema"] = 108,
    ["Drupal Info Schema"] = 98,
    ["Drupal Layouts Schema"] = 99,
    ["Drupal Libraries Schema"] = 100,
    ["Drupal Links Action Schema"] = 101,
    ["Drupal Links Contextual Schema"] = 102,
    ["Drupal Links Menu Schema"] = 103,
    ["Drupal Links Task Schema"] = 104,
    ["Drupal Migration Schema"] = 105,
    ["Drupal Permissions Schema"] = 106,
    ["Drupal Routing Schema"] = 107,
    ["Drupal Services Schema"] = 109,
    ["Drush site aliases"] = 179,
    ["Embrace Config Schema"] = 609,
    ["Error pages"] = 192,
    Esquio = 190,
    ["Estuary Flow Catalog Schema"] = 588,
    ["Expo SDK"] = 195,
    ["F-Droid Data metadata"] = 200,
    ["Facets - FSDL - Application"] = 198,
    ["Fossa configuration file"] = 205,
    ["Fossa's fossa-deps file"] = 206,
    ["Foundry VTT - Manifest"] = 203,
    ["Foundry VTT - Template"] = 204,
    ["Foxx Manifest"] = 48,
    ["Freifunk.de Community API"] = 51,
    ["Frogbot Config"] = 52,
    ["GatewayCore API Gateway"] = 209,
    ["GeoJSON.json latest"] = 586,
    GherKing = 590,
    ["GitHub Action"] = 213,
    ["GitHub Funding"] = 214,
    ["GitHub Issue Template configuration"] = 216,
    ["GitHub Workflow"] = 217,
    ["GitHub Workflow Template Properties"] = 218,
    ["GitHub issue forms"] = 215,
    GitVersion = 212,
    ["Gitpod Configuration"] = 220,
    ["Global Privacy Control"] = 210,
    ["Google Cloud Workflows"] = 136,
    Goreleaser = 223,
    ["Goreleaser Pro"] = 224,
    ["Gradle Build Cache Node"] = 543,
    ["Gradle Enterprise"] = 542,
    ["Grafana 5.x Dashboard"] = 225,
    ["GraphQL Code Generator"] = 228,
    ["GraphQL Config"] = 227,
    ["GraphQL Mesh"] = 226,
    ["Grunt JSHint task"] = 232,
    ["Grunt Watch task"] = 233,
    ["Grunt base task"] = 234,
    ["Grunt clean task"] = 230,
    ["Grunt copy task"] = 229,
    ["Grunt cssmin task"] = 231,
    HEMTT = 515,
    Hadolint = 527,
    Hammerkit = 553,
    ["Hardware Sentry Configuration"] = 602,
    Hayson = 236,
    ["Haystack Pipeline"] = 237,
    ["Hazelcast 5 Configuration"] = 238,
    ["Helm Chart.lock"] = 111,
    ["Helm Chart.yaml"] = 110,
    Hugo = 580,
    ["Istanbul Schema"] = 605,
    ["JDownloader2 crawler multi-rule schema"] = 255,
    ["JDownloader2 crawler single-rule schema"] = 254,
    ["JFrog File Spec"] = 256,
    ["JFrog Pipelines YML DSL"] = 611,
    ["JSON Document Transform"] = 264,
    ["JSON Feed"] = 265,
    ["JSON Resume"] = 386,
    ["JSON Schema Draft 2020-12"] = 494,
    ["JSON Schema Draft 4"] = 491,
    ["JSON Schema Draft 7"] = 492,
    ["JSON Schema Draft 8"] = 493,
    ["JSON schema for CodeShip Pro services configuration files"] = 122,
    ["JSON schema for CodeShip Pro steps configuration files"] = 123,
    ["JSON schema for Codecov configuration files"] = 121,
    ["JSON-API"] = 263,
    ["JSON-e templates"] = 551,
    ["JSON-stat 2.0"] = 488,
    JSONPatch = 267,
    Jasmine = 250,
    Jekyll = 251,
    ["Jenkins X Pipelines"] = 252,
    ["Jenkins X Requirements"] = 253,
    ["Jovo Language Models"] = 257,
    ["KSP-AVC"] = 489,
    ["KSP-CKAN"] = 490,
    ["Keycloak REST API"] = 617,
    ["Knative Functions - func.yaml"] = 207,
    ["KoDE/CI build.yaml"] = 607,
    ["Kong DBLess Schema"] = 608,
    KrakenD = 270,
    ["LinkML Metamodel"] = 282,
    Liquibase = 558,
    ["Liquibase Flow File"] = 559,
    ["Lively Properties"] = 283,
    Markdownlint = 562,
    ["MegaLinter configuration"] = 288,
    ["MegaLinter descriptor"] = 289,
    ["Meltano plugin discovery definition"] = 291,
    ["Meltano project definition"] = 290,
    ["Microsoft Band Web Tile"] = 292,
    ["Minecraft Data Pack Advancement"] = 294,
    ["Minecraft Data Pack Biome"] = 295,
    ["Minecraft Data Pack Configured Carver"] = 296,
    ["Minecraft Data Pack Dimension"] = 298,
    ["Minecraft Data Pack Dimension Type"] = 297,
    ["Minecraft Data Pack Item Modifier"] = 299,
    ["Minecraft Data Pack Loot Table"] = 300,
    ["Minecraft Data Pack Metadata"] = 301,
    ["Minecraft Data Pack Predicate"] = 302,
    ["Minecraft Data Pack Recipe"] = 303,
    ["Minecraft Data Pack Tag"] = 304,
    ["Minecraft Data Pack Template Pool"] = 305,
    ["Minecraft Resourcepack Sounds"] = 306,
    ["MkDocs Configuration 1.0"] = 307,
    ["MongoDB Atlas Search Index Definition Schema"] = 606,
    ["Monika Configuration Schema"] = 604,
    ["Motif config"] = 511,
    ["NOX Framework (Service)"] = 320,
    ["Netin Diagnostic System Template"] = 567,
    ["Netlify config schema"] = 312,
    ["Nightwatch.js"] = 313,
    ["OSS Review Toolkit configuration"] = 337,
    ["OSS Review Toolkit curation"] = 338,
    ["OSS Review Toolkit package configuration"] = 339,
    ["OSS Review Toolkit repository configuration"] = 340,
    ["OSS Review Toolkit resolutions"] = 341,
    Opctl = 514,
    ["OpenWeather Current Weather API"] = 550,
    ["OpenWeather Road Risk API"] = 549,
    ["Ory Hydra configuration"] = 242,
    ["Ory Keto configuration"] = 272,
    ["Ory Kratos configuration"] = 336,
    ["Ory Oathkeeper configuration"] = 327,
    ["Outblocks App configuration"] = 334,
    ["Outblocks database table"] = 335,
    ["Outblocks project configuration"] = 333,
    Packer = 344,
    Pantsbuild = 623,
    ["Pipeline component"] = 560,
    ["PocketMine plugin.yml"] = 348,
    Pterodactyl = 601,
    ["Pull Request Labeler"] = 371,
    Pulumi = 376,
    PyProject = 377,
    Qodana = 577,
    ["Quali Torque Blueprint Spec 2"] = 599,
    ["QueryFirst config file"] = 620,
    ["RKE Cluster Configuration JSON Schema"] = 557,
    ["RKE Cluster Configuration YAML Schema"] = 556,
    ["Rancher Fleet"] = 374,
    Ray = 526,
    ["Read the Docs"] = 375,
    ["Red-DiscordBot Cog"] = 378,
    ["Red-DiscordBot Cog Repo"] = 379,
    Renovate = 387,
    ["Replit schema"] = 382,
    RoadRunner = 388,
    Ruff = 384,
    ["Rust Project"] = 385,
    ["Rust toolchain"] = 390,
    ["SIL Kit Participant Configuration"] = 415,
    SWADL = 435,
    ["Sapphire CLI Config"] = 391,
    ["SauceCTL Configuration"] = 564,
    ["Schema Catalog"] = 404,
    ["Scoop manifest"] = 409,
    ["Semgrep Rule"] = 411,
    ["Serverless Framework Configuration"] = 571,
    ["Serverless Workflow Schema"] = 573,
    ["Settings.paf"] = 413,
    ["Shopware 6 Configuration"] = 574,
    ["Shopware CLI Extension Store Configuration"] = 575,
    ["Shopware CLI Project Store Configuration"] = 576,
    Solidarity = 419,
    ["Solution filters"] = 420,
    ["Source Maps v3"] = 421,
    SpecIF = 422,
    ["Sponge Mixin configuration"] = 423,
    ["StackHawk Scanner Configuration"] = 570,
    Stale = 427,
    Starship = 428,
    ["Statamic Blueprint"] = 429,
    ["StrmPrivacy Data Connector"] = 615,
    ["StrmPrivacy Data Contract"] = 616,
    ["StrmPrivacy SimpleSchema"] = 613,
    ["StrmPrivacy Stream"] = 614,
    ["StrmPrivacy batch job configuration file"] = 612,
    ["Stryker Mutator"] = 432,
    ["StyleCop Analyzers Configuration"] = 433,
    ["Swagger API 2.0"] = 436,
    TSON = 456,
    ["Talisman configuration"] = 437,
    ["Taskfile YAML Schema"] = 552,
    Taurus = 438,
    ["TestEnvironment.json"] = 445,
    Tikibase = 441,
    ["Traefik v2"] = 448,
    ["Traefik v2 File Provider"] = 449,
    Turborepo = 446,
    Tye = 578,
    ["UI5 Manifest"] = 463,
    ["UTAM Page Object"] = 466,
    ["Ubuntu Server Autoinstall"] = 461,
    ["Uniswap Token List"] = 535,
    ["Unreal Engine Uplugin"] = 621,
    ["Unreal Engine Uproject"] = 622,
    Updatecli = 585,
    Uplift = 619,
    ["User Journey Map YAML Schema"] = 555,
    V2Ray = 589,
    ["VSCode Code Snippets"] = 125,
    ["VSIX CLI publishing"] = 479,
    ["Vela Pipeline Configuration"] = 469,
    Vercel = 124,
    ["Web App Manifest"] = 484,
    ["Web types"] = 487,
    WebExtensions = 483,
    ["Webman package recipe"] = 595,
    ["Windows Package Manager Installer Manifest"] = 532,
    ["Windows Package Manager Locale Manifest"] = 533,
    ["Windows Package Manager Singleton Manifest"] = 531,
    ["Woodpecker pipeline config"] = 566,
    ["Xstate Machine Schema"] = 583,
    ["Yippee-Ki-JSON configuration YML"] = 537,
    ["angular.json"] = 11,
    ...
    ["chutzpah.json"] = 132,
    clangd = 116,
    ["cloud-init: cloud-config userdata JSON schema"] = 118,
    ["cloud-sdk-pipeline-config-schema"] = 134,
    ["cloudbuild.json"] = 135,
    cloudify = 117,
    codemagic = 119,
    ["coffeelint.json"] = 141,
    comet = 547,
    ["commands.json"] = 128,
    ["compile_commands.json"] = 127,
    ["compilerconfig.json"] = 126,
    ["component-detection-manifest.json"] = 144,
    ["component.json"] = 143,
    ["composer.json"] = 142,
    ["config.json"] = 145,
    ["contentmanifest.json"] = 133,
    ["contribute.json"] = 146,
    ["cosmos.config.json"] = 130,
    ["crowdin.yml"] = 147,
    cspell = 150,
    ["cypress.json"] = 148,
    ["datalogic-scan2deploy-android"] = 156,
    ["datalogic-scan2deploy-ce"] = 157,
    ["dbt Project"] = 95,
    ["debugsettings.json"] = 158,
    ["dependabot-v2.json"] = 161,
    ["dependabot.json"] = 160,
    ["deployed-cli"] = 582,
    ["detekt.yml"] = 163,
    devinit = 539,
    ["devspace.yaml"] = 603,
    ["docfx.json"] = 167,
    ["docker-compose.yml"] = 538,
    ["docker-seq schema"] = 166,
    ["dockerd.json"] = 165,
    ["dotnet Release Index manifest"] = 176,
    ["dotnetcli.host.json"] = 177,
    ["drone.json"] = 178,
    ["dss-2.0.0.json"] = 180,
    ["dstack Workflows"] = 181,
    ["dvc.yaml"] = 182,
    ["ecosystem.json"] = 187,
    eksctl = 188,
    ["electron-builder configuration file."] = 193,
    ["epr-manifest.json"] = 191,
    ["evcc.yaml"] = 194,
    ["ezd schema"] = 196,
    ["fabric.mod.json"] = 199,
    ["first-timers-bot"] = 202,
    ...
    ["gitlab-ci"] = 219,
    ["global.json"] = 221,
    ["golangci-lint Configuration"] = 222,
    ["haxelib.json"] = 235,
    helmfile = 528,
    ["host-meta.json"] = 240,
    ["host.json"] = 239,
    ...
    ["ide.host.json"] = 243,
    ["ifstate.conf"] = 244,
    ["imageoptimizer.json"] = 245,
    ["importmap.json"] = 247,
    ["ioBroker JSON UI"] = 248,
    ["ioBroker Package manifest"] = 249,
    ["ize.toml"] = 618,
    ["jsconfig.json"] = 268,
    ["jscpd Configuration Schema"] = 600,
    jsdoc = 525,
    ["k3d.yaml"] = 269,
    ["kustomization.yaml"] = 273,
    ["label-commenter-config.yml"] = 274,
    ["launchsettings.json"] = 275,
    ["lego.json"] = 276,
    ["lerna.json"] = 277,
    ["lgtm.yml"] = 278,
    ["libman.json"] = 279,
    ["license-report-config.json"] = 280,
    ["linkinator.config.json"] = 281,
    ["local.settings.json"] = 284,
    ["localazy.json"] = 285,
    ["lsdlschema.json"] = 286,
    ["markdown-lint-check"] = 563,
    mboats = 569,
    ["mimetypes.json"] = 293,
    ["mirrord-schema"] = 508,
    ["mta.yaml"] = 509,
    ["mtad.yaml"] = 510,
    ["mycode.json"] = 310,
    ["napari plugin manifest"] = 311,
    neoload = 520,
    ["nest-cli"] = 316,
    ["ninjs (News in JSON) 1.3"] = 315,
    ["ninjs (News in JSON) 2.0"] = 314,
    ["nlu.json"] = 317,
    ["nodemon.json"] = 319,
    ["noodl.schema.json"] = 568,
    now = 516,
    ["npm-badges"] = 322,
    ["nswag.json"] = 325,
    ntangle = 326,
    ["nuclei-template.yaml"] = 323,
    ["nuget-project.json"] = 324,
    ["ocelot.json"] = 328,
    ["omnisharp.json"] = 329,
    ["openapi.json"] = 330,
    ["openfin.json"] = 332,
    ["openrpc.json"] = 331,
    ["package.json"] = 342,
    ["package.manifest"] = 343,
    ["pattern.json"] = 346,
    ["petstore-v1.0"] = 610,
    pgap_yaml_input_reader = 345,
    ["plagiarize-me.yaml"] = 350,
    ["plagiarize.yaml"] = 349,
    ["portman.json"] = 351,
    ["prettierrc.json"] = 356,
    ["prisma.yml"] = 357,
    ["project-1.0.0-beta3.json"] = 359,
    ["project-1.0.0-beta4.json"] = 360,
    ["project-1.0.0-beta5.json"] = 361,
    ["project-1.0.0-beta6.json"] = 362,
    ["project-1.0.0-beta8.json"] = 363,
    ["project-1.0.0-rc1.json"] = 364,
    ["project-1.0.0-rc2.json"] = 365,
    ["project.json"] = 358,
    ["prometheus.json"] = 366,
    ["prometheus.rules.json"] = 367,
    ["proxies.json"] = 368,
    ["publiccode.yml"] = 369,
    ["pubspec.yaml"] = 370,
    ["pyrseas-0.8.json"] = 373,
    ["release drafter"] = 521,
    rustfmt = 389,
    ["sarif-1.0.0.json"] = 392,
    ["sarif-2.0.0.json"] = 393,
    ["sarif-2.1.0"] = 402,
    ["sarif-2.1.0-rtm.2"] = 394,
    ["sarif-2.1.0-rtm.3"] = 396,
    ["sarif-2.1.0-rtm.4"] = 398,
    ["sarif-2.1.0-rtm.5"] = 400,
    ["sarif-external-property-file-2.1.0"] = 403,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 395,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 397,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 399,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 401,
    ["schema.org - Action"] = 405,
    ["schema.org - ContactPoint"] = 406,
    ["schema.org - Place"] = 407,
    ["schema.org - Thing"] = 408,
    ["semantic-release"] = 410,
    ["servicehub.config.json"] = 497,
    ["servicehub.service.json"] = 496,
    ["settings.job"] = 412,
    ["sfdx-hardis configuration"] = 414,
    ["size-limit configuration"] = 416,
    ["skaffold.yaml"] = 561,
    ["skyuxconfig.json"] = 417,
    snapcraft = 418,
    ["stripe-app-local.json"] = 431,
    ["stripe-app.json"] = 430,
    swcrc = 548,
    taskcat = 517,
    ["template.json"] = 439,
    ["templatsources.json"] = 440,
    ["theme.json"] = 442,
    ["tizen_workspace.json"] = 443,
    tmLanguage = 444,
    tmuxinator = 505,
    ["trunk.yaml schema"] = 450,
    ["ts-force-config.json"] = 454,
    ["tsconfig.json"] = 451,
    ["tsd.json"] = 452,
    ["tsdrc.json"] = 453,
    ["tslint.json"] = 455,
    ...
    ["vega-lite.json"] = 468,
    ["vega.json"] = 467,
    ["venvironment-basic.yaml"] = 471,
    ["venvironment.yaml"] = 470,
    ["version.json"] = 472,
    ["vim-addon-info"] = 473,
    ["vs-2017.3.host.json"] = 475,
    ["vs-nesting.json"] = 476,
    ["vsls.json"] = 474,
    ["vss-extension.json"] = 480,
    ["webhint.io"] = 596,
    ["webjobpublishsettings.json"] = 486,
    ["webjobs-list.json"] = 485,
    ["xs-app.json"] = 513,
    ["xunit.runner.json"] = 495,
    yamllint = 536,
    zuul = 522,
    ["Žinoma"] = 530
  },
