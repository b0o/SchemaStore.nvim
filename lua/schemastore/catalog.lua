...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 110,
    [".cryproj (generic)"] = 414,
    [".cryproj engine-5.2"] = 409,
    [".cryproj engine-5.3"] = 410,
    [".cryproj engine-5.4"] = 411,
    [".cryproj engine-5.5"] = 412,
    [".cryproj engine-dev"] = 413,
    [".csscomb.json"] = 112,
    [".csslintrc"] = 113,
    [".eslintrc"] = 149,
    [".esmrc.json"] = 142,
    ...
    [".mtaext"] = 420,
    [".nodehawkrc"] = 259,
    [".npmpackagejsonlintrc"] = 261,
    [".phraseapp.yml"] = 288,
    [".pmbot.yml"] = 281,
    [".postcssrc"] = 286,
    [".pre-commit-config.yml"] = 287,
    [".putout.json"] = 305,
    [".rehyperc"] = 310,
    [".remarkrc"] = 311,
    [".sprite files"] = 346,
    ...
    [".vsext"] = 390,
    [".yarnrc.yml"] = 452,
    ["<div>RIOTS' studio configuration"] = 393,
    ["API Builder"] = 449,
    ["AWS CDK cdk.json"] = 99,
    ["AWS CloudFormation"] = 100,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 101,
    ...
    ["Azure Pipelines"] = 40,
    ["Azure Static Web Apps CLI configuration file"] = 348,
    ["Azure Static Web Apps configuration file"] = 347,
    ["Better Code Hub"] = 454,
    BizTalkServerApplicationSchema = 426,
    ...
    ["Citation File Format"] = 102,
    CityJSON = 72,
    ["Code Climate"] = 79,
    ["Commandbox Box.json"] = 73,
    ["Commandbox Server.json"] = 74,
    ["Common types for all schemas"] = 1,
    ["Container Structure Test"] = 437,
    Containerlab = 462,
    ["Dart build configuration"] = 114,
    ["Dart test config"] = 115,
    Deno = 119,
    ["Deployer Recipe"] = 122,
    Devfile = 140,
    ["Discord Webhook"] = 124,
    ["Dolittle Artifacts"] = 126,
    ["Dolittle Bounded Context Configuration"] = 127,
    ["Dolittle Event Horizons Configuration"] = 128,
    ["Dolittle Resources Configuration"] = 129,
    ["Dolittle Server Configuration"] = 130,
    ["Dolittle Tenant Map Configuration"] = 132,
    ["Dolittle Tenants Configuration"] = 131,
    ["Dolittle Topology"] = 133,
    ["Drush site aliases"] = 137,
    ["Error pages"] = 145,
    Esquio = 143,
    ["Estuary Flow Catalog Schema"] = 492,
    ["Expo SDK"] = 148,
    ["F-Droid Data metadata"] = 152,
    ["Facets - FSDL - Application"] = 150,
    ["Fossa configuration file"] = 157,
    ["Fossa's fossa-deps file"] = 158,
    ["Foundry VTT - Manifest"] = 155,
    ["Foundry VTT - Template"] = 156,
    ["Foxx Manifest"] = 41,
    ["GatewayCore API Gateway"] = 161,
    ["GeoJSON.json latest"] = 490,
    ["GitHub Action"] = 165,
    ["GitHub Funding"] = 166,
    ["GitHub Issue Template configuration"] = 168,
    ["GitHub Workflow"] = 169,
    ["GitHub Workflow Template Properties"] = 170,
    ["GitHub issue forms"] = 167,
    GitVersion = 164,
    ["Gitpod Configuration"] = 172,
    ["Global Privacy Control"] = 162,
    ["Google Cloud Workflows"] = 98,
    Goreleaser = 175,
    ["Goreleaser Pro"] = 176,
    ["Gradle Build Cache Node"] = 451,
    ["Gradle Enterprise"] = 450,
    ["Grafana 5.x Dashboard"] = 177,
    ["GraphQL Code Generator"] = 180,
    ["GraphQL Config"] = 179,
    ["GraphQL Mesh"] = 178,
    ["Grunt JSHint task"] = 184,
    ["Grunt Watch task"] = 185,
    ["Grunt base task"] = 186,
    ["Grunt clean task"] = 182,
    ["Grunt copy task"] = 181,
    ["Grunt cssmin task"] = 183,
    HEMTT = 423,
    Hadolint = 435,
    ["Hammerkit YAML Schema"] = 461,
    Hayson = 188,
    ["Haystack Pipeline"] = 189,
    ["Hazelcast 5 Configuration"] = 190,
    ["Helm Chart.lock"] = 77,
    ["Helm Chart.yaml"] = 76,
    Hugo = 484,
    ["JFrog File Spec"] = 204,
    ["JSON Document Transform"] = 212,
    ["JSON Feed"] = 213,
    ["JSON Resume"] = 313,
    ["JSON Schema Draft 2020-12"] = 405,
    ["JSON Schema Draft 4"] = 402,
    ["JSON Schema Draft 7"] = 403,
    ["JSON Schema Draft 8"] = 404,
    ["JSON schema for CodeShip Pro services configuration files"] = 85,
    ["JSON schema for CodeShip Pro steps configuration files"] = 86,
    ["JSON schema for Codecov configuration files"] = 84,
    ["JSON-API"] = 211,
    ["JSON-e templates"] = 459,
    ["JSON-stat 2.0"] = 399,
    JSONPatch = 215,
    Jekyll = 201,
    ["Jenkins X Pipelines"] = 202,
    ["Jenkins X Requirements"] = 203,
    ["Jovo Language Models"] = 205,
    ["KSP-AVC"] = 400,
    ["KSP-CKAN"] = 401,
    Liquibase = 466,
    Markdownlint = 469,
    ["MegaLinter configuration"] = 231,
    ["MegaLinter descriptor"] = 232,
    ["Meltano plugin discovery definition"] = 234,
    ["Meltano project definition"] = 233,
    ["Microsoft Band Web Tile"] = 235,
    ["Minecraft Data Pack Advancement"] = 237,
    ["Minecraft Data Pack Biome"] = 238,
    ["Minecraft Data Pack Configured Carver"] = 239,
    ["Minecraft Data Pack Dimension"] = 241,
    ["Minecraft Data Pack Dimension Type"] = 240,
    ["Minecraft Data Pack Item Modifier"] = 242,
    ["Minecraft Data Pack Loot Table"] = 243,
    ["Minecraft Data Pack Metadata"] = 244,
    ["Minecraft Data Pack Predicate"] = 245,
    ["Minecraft Data Pack Recipe"] = 246,
    ["Minecraft Data Pack Template Pool"] = 247,
    ["Minecraft Resourcepack Sounds"] = 248,
    ["Netin Diagnostic System Template"] = 473,
    ["Netlify config schema"] = 253,
    ["Nightwatch.js"] = 254,
    ["OSS Review Toolkit repository configuration"] = 275,
    Opctl = 422,
    ["OpenWeather Current Weather API"] = 458,
    ["OpenWeather Road Risk API"] = 457,
    ["Ory Hydra configuration"] = 194,
    ["Ory Keto configuration"] = 219,
    ["Ory Kratos configuration"] = 274,
    ["Ory Oathkeeper configuration"] = 266,
    ["Outblocks App configuration"] = 272,
    ["Outblocks database table"] = 273,
    ["Outblocks project configuration"] = 271,
    Packer = 278,
    ["Pipeline component"] = 467,
    ["PocketMine plugin.yml"] = 282,
    ["Pull Request Labeler"] = 304,
    Qodana = 481,
    ["RKE Cluster Configuration JSON Schema"] = 465,
    ["RKE Cluster Configuration YAML Schema"] = 464,
    Ray = 434,
    ["Read the Docs"] = 307,
    ["Red-DiscordBot Cog"] = 308,
    ["Red-DiscordBot Cog Repo"] = 309,
    Renovate = 314,
    RoadRunner = 315,
    SWADL = 357,
    ["Sapphire CLI Config"] = 316,
    ["SauceCTL Configuration"] = 470,
    ["Schema Catalog"] = 329,
    ["Scoop manifest"] = 334,
    ["Semgrep Rule"] = 335,
    ["Serverless Framework Configuration"] = 477,
    ["Settings.paf"] = 337,
    ["Shopware 6 Configuration"] = 478,
    ["Shopware CLI Extension Store Configuration"] = 479,
    ["Shopware CLI Project Store Configuration"] = 480,
    Solidarity = 342,
    ["Source Maps v3"] = 343,
    SpecIF = 344,
    ["Sponge Mixin configuration"] = 345,
    ["StackHawk Scanner Configuration"] = 476,
    ["StackHead CLI config"] = 349,
    ["StackHead module configuration"] = 350,
    ["StackHead project definition"] = 351,
    Stale = 352,
    ["Statamic Blueprint"] = 353,
    ["Stryker Mutator"] = 354,
    ["StyleCop Analyzers Configuration"] = 355,
    ["Swagger API 2.0"] = 358,
    ["Taskfile YAML Schema"] = 460,
    Taurus = 359,
    ["TestEnvironment.json"] = 364,
    ["Traefik v2"] = 366,
    ["Traefik v2 File Provider"] = 367,
    Tye = 482,
    ["UI5 Manifest"] = 379,
    ["Ubuntu Server Autoinstall"] = 377,
    ["Uniswap Token List"] = 443,
    Updatecli = 489,
    ["User Journey Map YAML Schema"] = 463,
    V2Ray = 493,
    ["VSCode Code Snippets"] = 88,
    ["VSIX CLI publishing"] = 391,
    ["Vela Pipeline Configuration"] = 383,
    Vercel = 87,
    ["Web App Manifest"] = 395,
    ["Web types"] = 398,
    WebExtensions = 394,
    ["Windows Package Manager Installer Manifest"] = 440,
    ["Windows Package Manager Locale Manifest"] = 441,
    ["Windows Package Manager Singleton Manifest"] = 439,
    ["Woodpecker pipeline config"] = 472,
    ["Xstate Machine Schema"] = 487,
    ["Yippee-Ki-JSON configuration YML"] = 445,
    ["angular.json"] = 8,
    ...
    ["chutzpah.json"] = 94,
    ["cloud-sdk-pipeline-config-schema"] = 96,
    ["cloudbuild.json"] = 97,
    cloudify = 82,
    codemagic = 83,
    ["coffeelint.json"] = 103,
    comet = 455,
    ["commands.json"] = 91,
    ["compile_commands.json"] = 90,
    ["compilerconfig.json"] = 89,
    ["component.json"] = 105,
    ["composer.json"] = 104,
    ["config.json"] = 106,
    ["contentmanifest.json"] = 95,
    ["contribute.json"] = 107,
    ["cosmos.config.json"] = 92,
    ["crowdin.yml"] = 108,
    cspell = 111,
    ["cypress.json"] = 109,
    ["datalogic-scan2deploy-android"] = 116,
    ["datalogic-scan2deploy-ce"] = 117,
    ["debugsettings.json"] = 118,
    ["dependabot-v2.json"] = 121,
    ["dependabot.json"] = 120,
    ["deployed-cli"] = 486,
    ["detekt.yml"] = 123,
    devinit = 447,
    ["docfx.json"] = 125,
    ["docker-compose.yml"] = 446,
    ["dotnet Release Index manifest"] = 134,
    ["dotnetcli.host.json"] = 135,
    ["drone.json"] = 136,
    ["dss-2.0.0.json"] = 138,
    ["dvc.yaml"] = 139,
    ["ecosystem.json"] = 141,
    ["electron-builder configuration file."] = 146,
    ["epr-manifest.json"] = 144,
    ["evcc.yaml"] = 147,
    ["fabric.mod.json"] = 151,
    ["first-timers-bot"] = 154,
    fulibWorkflows = 471,
    ["func.yaml"] = 159,
    ["function.json"] = 160,
    ["geojson.json"] = 163,
    ["gitlab-ci"] = 171,
    ["global.json"] = 173,
    ["golangci-lint Configuration"] = 174,
    ["haxelib.json"] = 187,
    helmfile = 436,
    ["host-meta.json"] = 192,
    ["host.json"] = 191,
    ...
    huskyrc = 416,
    ["ide.host.json"] = 195,
    ["imageoptimizer.json"] = 196,
    ["importmap.json"] = 198,
    ["ioBroker JSON UI"] = 199,
    ["ioBroker Package manifest"] = 200,
    ["jsconfig.json"] = 216,
    jsdoc = 433,
    ["k3d.yaml"] = 217,
    ["kustomization.yaml"] = 220,
    ["label-commenter-config.yml"] = 221,
    ["launchsettings.json"] = 222,
    ["lerna.json"] = 223,
    ["lgtm.yml"] = 224,
    ["libman.json"] = 225,
    ["license-report-config.json"] = 226,
    ["linkinator.config.json"] = 227,
    ["local.settings.json"] = 228,
    ["localazy.json"] = 229,
    ["lsdlschema.json"] = 230,
    mboats = 475,
    ["mimetypes.json"] = 236,
    ...
    ["mtad.yaml"] = 419,
    ["mycode.json"] = 251,
    ["napari plugin manifest"] = 252,
    neoload = 428,
    ["nest-cli"] = 257,
    ["ninjs (News in JSON) 1.3"] = 256,
    ["ninjs (News in JSON) 2.0"] = 255,
    ["nlu.json"] = 258,
    ["nodemon.json"] = 260,
    ["noodl.schema.json"] = 474,
    now = 424,
    ["nswag.json"] = 264,
    ntangle = 265,
    ["nuclei-template.yaml"] = 262,
    ["nuget-project.json"] = 263,
    ["ocelot.json"] = 267,
    ["omnisharp.json"] = 268,
    ["openapi.json"] = 269,
    ["openfin.json"] = 270,
    ["package.json"] = 276,
    ["package.manifest"] = 277,
    ["pattern.json"] = 280,
    pgap_yaml_input_reader = 279,
    ["plagiarize-me.yaml"] = 284,
    ["plagiarize.yaml"] = 283,
    ["portman.json"] = 285,
    ["prettierrc.json"] = 289,
    ["prisma.yml"] = 290,
    ["project-1.0.0-beta3.json"] = 292,
    ["project-1.0.0-beta4.json"] = 293,
    ["project-1.0.0-beta5.json"] = 294,
    ["project-1.0.0-beta6.json"] = 295,
    ["project-1.0.0-beta8.json"] = 296,
    ["project-1.0.0-rc1.json"] = 297,
    ["project-1.0.0-rc2.json"] = 298,
    ["project.json"] = 291,
    ["prometheus.json"] = 299,
    ["prometheus.rules.json"] = 300,
    ["proxies.json"] = 301,
    ["publiccode.yml"] = 302,
    ["pubspec.yaml"] = 303,
    ["pyrseas-0.8.json"] = 306,
    ["release drafter"] = 429,
    ["sarif-1.0.0.json"] = 317,
    ["sarif-2.0.0.json"] = 318,
    ["sarif-2.1.0"] = 327,
    ["sarif-2.1.0-rtm.2"] = 319,
    ["sarif-2.1.0-rtm.3"] = 321,
    ["sarif-2.1.0-rtm.4"] = 323,
    ["sarif-2.1.0-rtm.5"] = 325,
    ["sarif-external-property-file-2.1.0"] = 328,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 320,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 322,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 324,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 326,
    ["schema.org - Action"] = 330,
    ["schema.org - ContactPoint"] = 331,
    ["schema.org - Place"] = 332,
    ["schema.org - Thing"] = 333,
    ["service.datadog.yaml"] = 218,
    ["servicehub.config.json"] = 408,
    ["servicehub.service.json"] = 407,
    ["settings.job"] = 336,
    ["sfdx-hardis configuration"] = 338,
    ["size-limit configuration"] = 339,
    ["skaffold.yaml"] = 468,
    ["skyuxconfig.json"] = 340,
    snapcraft = 341,
    swcrc = 456,
    taskcat = 425,
    ["template.json"] = 360,
    ["templatsources.json"] = 361,
    ["theme.json"] = 362,
    tmLanguage = 363,
    ["trunk.yaml schema"] = 368,
    ["ts-force-config.json"] = 372,
    ["tsconfig.json"] = 369,
    ["tsd.json"] = 370,
    ["tsdrc.json"] = 371,
    ["tslint.json"] = 373,
    ...
    ["version.json"] = 384,
    ["vim-addon-info"] = 385,
    ["vs-2017.3.host.json"] = 387,
    ["vs-nesting.json"] = 388,
    ["vsls.json"] = 386,
    ["vss-extension.json"] = 392,
    ["webjobpublishsettings.json"] = 397,
    ["webjobs-list.json"] = 396,
    ["xs-app.json"] = 421,
    ["xunit.runner.json"] = 406,
    yamllint = 444,
    zuul = 430,
    ["Žinoma"] = 438
  },
