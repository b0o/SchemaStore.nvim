...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 191,
    [".cryproj (generic)"] = 646,
    [".cryproj engine-5.2"] = 641,
    [".cryproj engine-5.3"] = 642,
    [".cryproj engine-5.4"] = 643,
    [".cryproj engine-5.5"] = 644,
    [".cryproj engine-dev"] = 645,
    [".eslintrc"] = 246,
    [".esmrc.json"] = 238,
    [".ffizer.yaml"] = 250,
    [".htmlhintrc"] = 305,
    ...
    [".mtaext"] = 657,
    [".nodehawkrc"] = 414,
    [".npmpackagejsonlintrc"] = 417,
    [".phraseapp.yml"] = 462,
    [".pmbot.yml"] = 452,
    [".postcssrc"] = 457,
    [".powerpages-web-template-manifest"] = 459,
    [".pre-commit-config.yml"] = 460,
    [".pre-commit-hooks.yml"] = 461,
    [".putout.json"] = 481,
    [".rehyperc"] = 493,
    [".remarkrc"] = 495,
    [".sprite files"] = 550,
    ...
    ["<div>RIOTS' studio configuration"] = 624,
    ["@factorial/drupal-breakpoints-css"] = 4,
    ["A micro editor config"] = 369,
    AIConfig = 11,
    ["API Builder"] = 689,
    ["AVA Configuration"] = 748,
    ["AWS CDK cdk.json"] = 175,
    ["AWS CloudFormation"] = 176,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 177,
    ["AWS SAM CLI Samconfig"] = 178,
    ["Adobe UXP Manifest"] = 813,
    ["Aerleon Network & Service Definitions"] = 7,
    ["Aerleon Policy"] = 8,
    ["Airlock Microgateway"] = 12,
    ["Airplane task"] = 13,
    ["Alacritty Configuration"] = 720,
    ["All Contributors configuration file"] = 778,
    ...
    ["Azure Pipelines"] = 64,
    ["Azure Static Web Apps CLI configuration file"] = 553,
    ["Azure Static Web Apps configuration file"] = 552,
    ["BX CI"] = 102,
    ["Bashly (bashly.yml)"] = 782,
    ["Bashly Settings (bashly-settings.yml)"] = 783,
    ["Better Code Hub"] = 693,
    ["Better Scripts"] = 103,
    Bigconfig = 81,
    BizTalkServerApplicationSchema = 663,
    Bleep = 104,
    ...
    ["Butane Config"] = 733,
    ["CGS Custom Card Game (CardGameDef.json)"] = 818,
    ["CICS TS region tagging"] = 742,
    ["CICS TS resource import"] = 743,
    ["CICS TS resource model"] = 744,
    ["CICS TS resource overrides"] = 745,
    ["CMake Presets"] = 105,
    ["CNC Codes"] = 116,
    ["CSS Comb (.csscomb.json)"] = 193,
    ["CSS Lint (.csslintrc)"] = 194,
    ["CSpell (cspell.json)"] = 192,
    ...
    Cheatsheets = 730,
    ["Chrome Extension"] = 168,
    ["Chromia Model"] = 112,
    ["CircleCI config.yml"] = 145,
    ["Citation File Format"] = 180,
    CityJSON = 114,
    ["Code Climate"] = 146,
    CodeCV = 61,
    ["CodeShip Pro services configuration files"] = 157,
    ["CodeShip Pro steps configuration files"] = 158,
    ["Codecov configuration files"] = 156,
    Codux = 154,
    ["Cog config file"] = 117,
    ["Commandbox Box.json"] = 118,
    ["Commandbox Server.json"] = 119,
    ["Common Catalog Data"] = 166,
    Conjure = 115,
    ["Container Structure Test"] = 676,
    Containerlab = 701,
    ["Crowdsec collection config"] = 187,
    ["Crowdsec parser config"] = 188,
    ["Crowdsec scenario config"] = 189,
    ["CumulusCI Config"] = 120,
    ["Custom Machinery Machine"] = 819,
    ["Custom Machinery Recipe"] = 820,
    ["DWP Exchange - catalogue entry"] = 233,
    ["DWP Exchange - gateway"] = 231,
    ["DWP Exchange - meta"] = 232,
    ["Dart Build Config (dart-build.json)"] = 195,
    ["Dart Test Config (dart-test.json)"] = 196,
    ["DashLord Configuration"] = 197,
    ["Data Contract Specification"] = 198,
    ["DataYoga Connections"] = 121,
    ["DataYoga Job"] = 122,
    ["Databricks Asset Bundles"] = 799,
    ["Datadog Service Definition"] = 346,
    ["Datahub Ingestion Recipe"] = 749,
    ["Dein Config"] = 124,
    ["Deno Config (deno.json)"] = 204,
    ["Dependency cruiser"] = 125,
    ["Deployer Recipe"] = 207,
    ["Deta Spacefile"] = 126,
    ["Detekt Config (detekt.yml)"] = 208,
    ["Devbox Config"] = 127,
    ["Devbox Plugin"] = 128,
    Devfile = 230,
    ["Discord Webhook"] = 209,
    ["DocFx Config (docfx.json)"] = 212,
    ["Dolittle Artifacts"] = 213,
    ["Dolittle Bounded Context Configuration"] = 214,
    ["Dolittle Event Horizons Configuration"] = 215,
    ["Dolittle Resources Configuration"] = 216,
    ["Dolittle Server Configuration"] = 217,
    ["Dolittle Tenant Map Configuration"] = 219,
    ["Dolittle Tenants Configuration"] = 218,
    ["Dolittle Topology"] = 220,
    ["Drupal Breakpoints"] = 129,
    ["Drupal Config"] = 140,
    ["Drupal Info"] = 130,
    ["Drupal Layouts"] = 131,
    ["Drupal Libraries"] = 132,
    ["Drupal Links Action"] = 133,
    ["Drupal Links Contextual"] = 134,
    ["Drupal Links Menu"] = 135,
    ["Drupal Links Task"] = 136,
    ["Drupal Migration"] = 137,
    ["Drupal Permissions"] = 138,
    ["Drupal Routing"] = 139,
    ["Drupal Services"] = 141,
    ["Drush site aliases"] = 226,
    ["Dynamic Bash Aliases (.aliases)"] = 790,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 779,
    ["Elgato Stream Deck"] = 236,
    ["Embrace Config"] = 760,
    Endurica = 803,
    ["Enterprise Contract Policy Spec"] = 237,
    ["Error pages"] = 241,
    Esquio = 239,
    ["Estuary Flow Catalog"] = 739,
    ["Expo SDK"] = 244,
    ["F-Droid Data metadata"] = 249,
    ["Facets - FSDL - Application"] = 247,
    ["FasterCI Configuration"] = 65,
    FiQuS = 253,
    Firebase = 251,
    ["Fossa configuration file"] = 260,
    ["Fossa's fossa-deps file"] = 261,
    ["Foundry VTT - Base package Manifest"] = 255,
    ["Foundry VTT - Module Manifest"] = 256,
    ["Foundry VTT - System Data Template"] = 259,
    ["Foundry VTT - System Manifest"] = 257,
    ["Foundry VTT - World Manifest"] = 258,
    ["Foxx Manifest"] = 66,
    ["Freifunk.de Community API"] = 69,
    ["Frogbot Config"] = 70,
    ["G2P Mapping Configuration"] = 265,
    ["GCP Blueprint Metadata"] = 268,
    Gaspar = 266,
    ["GatewayCore API Gateway"] = 267,
    ["GeoJSON.json latest"] = 737,
    GherKing = 741,
    ["GitHub Action"] = 272,
    ["GitHub Discussion"] = 273,
    ["GitHub Funding"] = 274,
    ["GitHub Issue Template configuration"] = 276,
    ["GitHub Issue Template forms"] = 275,
    ["GitHub Workflow"] = 277,
    ["GitHub Workflow Template Properties"] = 278,
    ["GitLab Agent for Kubernetes configuration"] = 815,
    GitVersion = 270,
    ["Gitea Issue Template forms"] = 271,
    ["Gitpod Configuration"] = 280,
    ["GlazeWM settings"] = 817,
    ["Global Privacy Control"] = 269,
    Goblet = 798,
    ["Golangci-lint Configuration"] = 282,
    ["Golangci-lint Custom Plugins Configuration"] = 283,
    ["Google Chrome Related Website Sets"] = 252,
    ["Google Cloud Workflows"] = 174,
    Goreleaser = 285,
    ["Goreleaser Pro"] = 286,
    Goss = 287,
    ["Gradle Build Cache Node"] = 691,
    ["Gradle Enterprise"] = 690,
    ["Grafana 5.x Dashboard"] = 288,
    ["GraphQL Code Generator"] = 292,
    ["GraphQL Config"] = 291,
    ["GraphQL Mesh"] = 290,
    ["Grunt JSHint task"] = 296,
    ["Grunt Watch task"] = 297,
    ["Grunt base task"] = 298,
    ["Grunt clean task"] = 294,
    ["Grunt copy task"] = 293,
    ["Grunt cssmin task"] = 295,
    HEMTT = 660,
    Hadolint = 672,
    Hammerkit = 700,
    ["Hardware Sentry Configuration"] = 753,
    Hatch = 673,
    Hayson = 300,
    ["Haystack Pipeline"] = 301,
    ["Hazelcast 5 Configuration"] = 302,
    ["Helm Chart.lock"] = 143,
    ["Helm Chart.yaml"] = 142,
    ["Helm Unittest Test Suite"] = 144,
    Hugo = 729,
    ["Hugo Theme"] = 728,
    ["IBM Zapp document"] = 307,
    ["IBM zCodeFormatSettings"] = 308,
    ["IMG Catapult PSP"] = 313,
    ["IVMS101 by CODE Protocol"] = 816,
    Istanbul = 756,
    ["JDownloader2 crawler multi-rules"] = 323,
    ["JDownloader2 crawler single-rules"] = 322,
    ["JFrog Applications Config"] = 324,
    ["JFrog File Spec"] = 325,
    ["JFrog Pipelines YML DSL"] = 762,
    ["JMeter DSL cli config"] = 326,
    JReleaser = 328,
    ["JSON Document Transform"] = 336,
    ["JSON Feed"] = 337,
    ["JSON Resume"] = 500,
    ["JSON Schema Draft 2020-12"] = 637,
    ["JSON Schema Draft 4"] = 634,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 800,
    ["JSON Schema Draft 7"] = 635,
    ["JSON Schema Draft 7 (unofficial strict)"] = 801,
    ["JSON Schema Draft 8 (2019-09)"] = 636,
    ["JSON-API"] = 335,
    ["JSON-e templates"] = 698,
    ["JSON-stat 2.0"] = 631,
    JSONPatch = 339,
    ["JSR Package Config (jsr.json)"] = 329,
    Jasmine = 318,
    Jekyll = 319,
    ["Jenkins X Pipelines"] = 320,
    ["Jenkins X Requirements"] = 321,
    ["Jovo Language Models"] = 327,
    ["KIMMDY config file"] = 344,
    ["KSP-AVC"] = 632,
    ["KSP-CKAN"] = 633,
    ["Karakum configuration file"] = 262,
    Kas = 342,
    ["Keycloak REST API"] = 770,
    ["Knative Functions - func.yaml"] = 263,
    ["KoDE/CI build.yaml"] = 758,
    ["Kong DBLess config"] = 759,
    KrakenD = 345,
    LOOBin = 364,
    Lefthook = 353,
    ["Liferay client-extension.yaml"] = 360,
    ["LinkML Metamodel"] = 362,
    Liquibase = 705,
    ["Liquibase Flow File"] = 706,
    ["Lively Properties"] = 363,
    ["Lobe AI Agent"] = 63,
    ["MLOS Configs"] = 398,
    ["MS2Rescore Configuration"] = 401,
    ["Madness (madness.yml)"] = 781,
    Markdownlint = 709,
    ["Mason Registry"] = 711,
    ["MegaLinter configuration"] = 370,
    ["MegaLinter descriptor"] = 371,
    Melange = 807,
    ["Meltano plugin discovery definition"] = 373,
    ["Meltano project definition"] = 372,
    ["MetricsHub Configuration"] = 374,
    ["MetricsHub Connector Configuration"] = 375,
    ["Micro Editor Syntax"] = 791,
    ["Microsoft Band Web Tile"] = 376,
    ["Minecraft Custom Main Menu Mod"] = 808,
    ["Minecraft Data Pack Advancement"] = 378,
    ["Minecraft Data Pack Biome"] = 379,
    ["Minecraft Data Pack Configured Carver"] = 380,
    ["Minecraft Data Pack Damage Type"] = 381,
    ["Minecraft Data Pack Dimension"] = 383,
    ["Minecraft Data Pack Dimension Type"] = 382,
    ["Minecraft Data Pack Item Modifier"] = 384,
    ["Minecraft Data Pack Loot Table"] = 385,
    ["Minecraft Data Pack Metadata"] = 386,
    ["Minecraft Data Pack Predicate"] = 387,
    ["Minecraft Data Pack Recipe"] = 388,
    ["Minecraft Data Pack Tag"] = 389,
    ["Minecraft Data Pack Template Pool"] = 390,
    ["Minecraft Data Pack Trim Material"] = 395,
    ["Minecraft Data Pack Trim Pattern"] = 396,
    ["Minecraft Resource Pack Lang"] = 391,
    ["Minecraft Resource Pack Particle"] = 392,
    ["Minecraft Resource Pack Texture Mcmeta"] = 394,
    ["Minecraft Resourcepack Sounds"] = 393,
    ["MkDocs Configuration 1.0"] = 397,
    ["Monade CLI Stack Configuration"] = 404,
    ["MongoDB Atlas Search Index Definition"] = 757,
    ["Monika Configuration"] = 755,
    ["Monoweave Configuration"] = 400,
    ["Motif config"] = 656,
    ["NOX Framework (Service)"] = 416,
    ["Netin Diagnostic System Template"] = 715,
    ["Netlify config"] = 407,
    ["Network-as-Code Data Model"] = 408,
    ["Nightwatch.js"] = 409,
    ["Nuitka.yaml"] = 821,
    ["ONe's changelog entry"] = 432,
    ["ONe's service descriptor"] = 431,
    ["OSS Review Toolkit configuration"] = 439,
    ["OSS Review Toolkit curation"] = 440,
    ["OSS Review Toolkit package configuration"] = 441,
    ["OSS Review Toolkit repository configuration"] = 442,
    ["OSS Review Toolkit resolutions"] = 443,
    Opctl = 659,
    ["OpenRewrite Resource"] = 434,
    ["OpenUtau character yaml"] = 428,
    ["OpenUtau ustx"] = 429,
    ["OpenWeather Current Weather API"] = 697,
    ["OpenWeather Road Risk API"] = 696,
    ["Ory Hydra configuration"] = 306,
    ["Ory Keto configuration"] = 347,
    ["Ory Kratos configuration"] = 438,
    ["Ory Oathkeeper configuration"] = 423,
    ["Outblocks App configuration"] = 436,
    ["Outblocks database table"] = 437,
    ["Outblocks project configuration"] = 435,
    PDM = 449,
    Packer = 446,
    Pantsbuild = 777,
    ["Paper paper-plugin.yml"] = 447,
    ["Pipeline component"] = 707,
    ["PocketMine plugin.yml"] = 453,
    ["Postman collection"] = 458,
    ["Problem object RFC9457"] = 805,
    ["Problem package generators"] = 465,
    Pterodactyl = 752,
    ["Pull Request Labeler"] = 480,
    Pulumi = 486,
    PyProject = 487,
    Pyright = 488,
    Qgoda = 489,
    Qodana = 725,
    ["Quali Torque Blueprint Spec 2"] = 750,
    ["QueryFirst config file"] = 773,
    ["RKE Cluster Configuration JSON"] = 704,
    ["RKE Cluster Configuration YAML"] = 703,
    ["Rancher Fleet"] = 483,
    Ray = 671,
    ["Read the Docs"] = 485,
    ["Red-DiscordBot Cog"] = 490,
    ["Red-DiscordBot Cog Repo"] = 491,
    ["Red-DiscordBot Trivia"] = 492,
    RenderCV = 502,
    Renovate = 501,
    ["Replit config"] = 496,
    RoadRunner = 503,
    ["Rudder techniques"] = 811,
    Ruff = 498,
    ["Rust Project"] = 499,
    ["Rust toolchain"] = 506,
    ["SIL Kit Participant Configuration"] = 538,
    ["SIL Kit Registry Configuration"] = 539,
    SWADL = 564,
    ["Safebox Config"] = 763,
    ["Sapphire CLI Config"] = 509,
    ["SauceCTL Configuration"] = 712,
    ["Schema Catalog"] = 523,
    ["Scoop manifest"] = 528,
    ["Semantic Data Fabric (SDF) file"] = 529,
    ["Semgrep Rule"] = 531,
    ["Serenity Code Generator (Sergen)"] = 532,
    ["Serverless Framework Configuration"] = 719,
    ["Serverless Workflow"] = 721,
    ["Settings.paf"] = 534,
    ["Shopware 6 Configuration"] = 722,
    ["Shopware CLI Extension Store Configuration"] = 723,
    ["Shopware CLI Project Store Configuration"] = 724,
    Sigma = 536,
    ["Sigrid scope configuration file"] = 537,
    ["SkyPilot Task JSON"] = 812,
    ["Slack app manifest"] = 541,
    Solidarity = 544,
    ["Solution filters"] = 545,
    ["Source Maps v3"] = 546,
    Sourcery = 547,
    SpecIF = 548,
    ["Sponge Mixin configuration"] = 549,
    StackBlitz = 554,
    ["StackHawk Scanner Configuration"] = 718,
    Stale = 555,
    ["Starlake Data Pipeline"] = 694,
    Starship = 556,
    ["Statamic Blueprint"] = 557,
    ["Stella configuration file"] = 558,
    ["StrmPrivacy Data Connector"] = 767,
    ["StrmPrivacy Data Contract"] = 768,
    ["StrmPrivacy SimpleSchema"] = 765,
    ["StrmPrivacy Stream"] = 766,
    ["StrmPrivacy batch job configuration file"] = 764,
    ["Stryker Mutator"] = 561,
    ["StyleCop Analyzers Configuration"] = 562,
    ["Stylelint (.stylelintrc)"] = 563,
    ["Sublime Syntax"] = 769,
    ["Subsquid squid manifest"] = 814,
    ["Swagger API 2.0"] = 565,
    TSON = 591,
    TSTyche = 592,
    Talhelper = 567,
    ["Talisman configuration"] = 568,
    ["Taskfile config"] = 699,
    Taurus = 569,
    ["TestEnvironment.json"] = 578,
    ["TextMate Grammar"] = 577,
    ["Tier.run pricing.json"] = 572,
    Tikibase = 573,
    ["Traefik v2"] = 581,
    ["Traefik v2 File Provider"] = 582,
    ["Travis CI (.travis.yml)"] = 580,
    TunnelHub = 804,
    Turborepo = 579,
    Tye = 726,
    ["UET BuildConfig.json"] = 774,
    ["UI5 Manifest"] = 601,
    ["UNCORS configuration"] = 605,
    ["UTAM Page Object"] = 604,
    ["Ubuntu Server Autoinstall"] = 599,
    ["Uniswap Token List"] = 682,
    ["Unreal Engine Uplugin"] = 775,
    ["Unreal Engine Uproject"] = 776,
    ["Updatecli Compose"] = 734,
    ["Updatecli Policy Manifest"] = 735,
    ["Updatecli Policy Metadata"] = 736,
    Uplift = 772,
    ["User Journey Map"] = 702,
    V2Ray = 740,
    ["VSCode Code Snippets"] = 162,
    ["VSIX CLI publishing"] = 619,
    ["Vela Pipeline Configuration"] = 608,
    Vercel = 161,
    Visivo = 802,
    ["Web App Manifest"] = 626,
    ["Web types"] = 629,
    WebExtensions = 625,
    ["Webman package recipe"] = 746,
    ["Windows Package Manager Installer Manifest"] = 679,
    ["Windows Package Manager Locale Manifest"] = 680,
    ["Windows Package Manager Singleton Manifest"] = 678,
    ["Woodpecker pipeline config"] = 714,
    ["Wrangler CLI"] = 630,
    ["Xstate Machine"] = 732,
    ["Yarn Config (.yarnrc.yml)"] = 692,
    ["Yippee-Ki-JSON configuration YML"] = 684,
    ["aerleon.yml"] = 6,
    ["angular.json"] = 14,
    apko = 806,
    ...
    ["behat.yml"] = 88,
    ["bigquery-table"] = 80,
    ["bioimageio resource description"] = 822,
    ...
    ["chisel-slices.json"] = 179,
    ["chrome-extension-locales-messages.json"] = 169,
    ["chutzpah.json"] = 170,
    cibuildwheel = 113,
    ["clang-format (.clang-format)"] = 738,
    clangd = 149,
    clib = 150,
    ["cloud-init: cloud-config userdata"] = 152,
    ["cloud-sdk-pipeline-configuration"] = 172,
    ["cloudbuild.json"] = 173,
    cloudify = 151,
    codemagic = 153,
    ["coffeelint.json"] = 181,
    ["commands.json"] = 165,
    ["commitlint (.commitlintrc)"] = 681,
    ["compile_commands.json"] = 164,
    ["compilerconfig.json"] = 163,
    ["completely.yml"] = 780,
    ["component-detection-manifest.json"] = 184,
    ["component.json"] = 183,
    ["composer.json"] = 182,
    ["config.yaml"] = 484,
    ["contentmanifest.json"] = 171,
    ["contribute.json"] = 185,
    ["cosmos.config.json"] = 167,
    ["crowdin.yml"] = 186,
    ["custom-elements.json"] = 794,
    ["cypress.json"] = 190,
    ["datalogic-scan2deploy-android"] = 199,
    ["datalogic-scan2deploy-ce"] = 200,
    ["dbt Project"] = 123,
    ["ddev-global"] = 201,
    ["ddev-project"] = 202,
    ["debugsettings.json"] = 203,
    ["dependabot-v2.json"] = 206,
    ["dependabot.json"] = 205,
    ["deployed-cli"] = 731,
    ["devcontainer.json"] = 155,
    devinit = 686,
    ["devspace.yaml"] = 754,
    djlint = 687,
    ["docker sequencer"] = 211,
    ["docker-compose.yml"] = 685,
    ["dockerd.json"] = 210,
    ["dotnet Release Index manifest"] = 221,
    ["dotnet-tools.json"] = 222,
    ["dotnetcli.host.json"] = 223,
    ["dprint.json"] = 224,
    ["drone.json"] = 225,
    ["dss-2.0.0.json"] = 227,
    ["dstack configuration"] = 228,
    ["dvc.yaml"] = 229,
    ["ecosystem.json"] = 234,
    eksctl = 235,
    ["electron-builder configuration file"] = 242,
    ["epr-manifest.json"] = 240,
    ["evcc.yaml"] = 243,
    ["ezd task runner"] = 245,
    ["fabric.mod.json"] = 248,
    ["first-timers-bot"] = 254,
    ...
    ["gitlab-ci"] = 279,
    ["global.json"] = 281,
    ["go-feature-flag Flag Configuration"] = 284,
    ["haxelib.json"] = 299,
    helmfile = 674,
    helmwave = 675,
    ["host-meta.json"] = 304,
    ...
    ["ide.host.json"] = 309,
    ["ifstate.conf"] = 310,
    ["imageoptimizer.json"] = 311,
    ["importmap.json"] = 314,
    ["ioBroker Configuration"] = 315,
    ["ioBroker JSON UI"] = 316,
    ["ioBroker Package manifest"] = 317,
    ["ize.toml"] = 771,
    ["jsconfig.json"] = 340,
    ["jscpd Configuration"] = 751,
    jsdoc = 670,
    ["k3d.yaml"] = 341,
    ["k9s plugin.yml"] = 343,
    ["kontinuous-config.yaml"] = 349,
    ["kontinuous-values.yaml"] = 348,
    ["kustomization.yaml"] = 350,
    ["label-commenter-config.yml"] = 351,
    ["latexindent configuration"] = 62,
    ["launchsettings.json"] = 352,
    lazydocker = 793,
    lazygit = 792,
    ["lego.json"] = 354,
    ["lerna.json"] = 355,
    ["lgtm.yml"] = 356,
    ["liblab.config.json"] = 357,
    ["libman.json"] = 358,
    ["license-report-config.json"] = 359,
    ["linkinator.config.json"] = 361,
    ["lint-staged (.lintstagedrc)"] = 650,
    ["local.settings.json"] = 366,
    ["localazy.json"] = 367,
    ["lotus.yaml"] = 365,
    ["lsdlschema.json"] = 368,
    ["markdown-lint-check"] = 710,
    mboats = 717,
    ["micro-settings.json"] = 786,
    ["mimetypes.json"] = 377,
    ["mirrord config"] = 651,
    mise = 652,
    ["mise-settings"] = 653,
    ...
    ["mtad.yaml"] = 655,
    ["mycode.json"] = 405,
    ["napari plugin manifest"] = 406,
    neoload = 665,
    ["nest-cli"] = 412,
    ["ninjs (News in JSON) 1.3"] = 411,
    ["ninjs (News in JSON) 2.0"] = 410,
    ["nixd configuration"] = 810,
    ["nlu.json"] = 413,
    ["nodemon.json"] = 415,
    ["noodl config"] = 716,
    now = 661,
    ...
    ["nswag.json"] = 421,
    ntangle = 422,
    ["nuclei-template.yaml"] = 419,
    ["nuget-project.json"] = 420,
    ["ocelot.json"] = 424,
    ["omnisharp.json"] = 425,
    ["openapi.json"] = 426,
    ["openfin.json"] = 433,
    ...
    ["ops.yaml"] = 430,
    ["package.json"] = 444,
    ["package.manifest"] = 445,
    ["partial-black.json"] = 89,
    ["pathfinder.yml"] = 448,
    ["pattern.json"] = 451,
    ["petstore-v1.0"] = 761,
    pgap_yaml_input_reader = 450,
    ["plagiarize-me.yaml"] = 455,
    ["plagiarize.yaml"] = 454,
    ["portman.json"] = 456,
    ["prettierrc.json"] = 463,
    ["prisma.yml"] = 464,
    ["project-1.0.0-beta3.json"] = 467,
    ["project-1.0.0-beta4.json"] = 468,
    ["project-1.0.0-beta5.json"] = 469,
    ["project-1.0.0-beta6.json"] = 470,
    ["project-1.0.0-beta8.json"] = 471,
    ["project-1.0.0-rc1.json"] = 472,
    ["project-1.0.0-rc2.json"] = 473,
    ["project.json"] = 466,
    ["prometheus.json"] = 474,
    ["prometheus.rules.json"] = 475,
    ["prometheus.rules.test.json"] = 476,
    ["proxies.json"] = 477,
    ["publiccode.yml"] = 478,
    ["pubspec.yaml"] = 479,
    ["pyrseas-0.8.json"] = 482,
    ["quilt.mod.json"] = 787,
    ["release drafter"] = 666,
    ["release-plz.toml"] = 494,
    ["rivet.yaml"] = 809,
    rockcraft = 504,
    rustfmt = 505,
    samt = 507,
    samtrc = 508,
    ["sarif-1.0.0.json"] = 510,
    ["sarif-2.0.0.json"] = 511,
    ["sarif-2.1.0"] = 521,
    ["sarif-2.1.0-rtm.2"] = 512,
    ["sarif-2.1.0-rtm.3"] = 514,
    ["sarif-2.1.0-rtm.4"] = 516,
    ["sarif-2.1.0-rtm.5"] = 518,
    ["sarif-2.1.0-rtm.6"] = 519,
    ["sarif-external-property-file-2.1.0"] = 522,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 513,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 515,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 517,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 520,
    ["schema.org - Action"] = 524,
    ["schema.org - ContactPoint"] = 525,
    ["schema.org - Place"] = 526,
    ["schema.org - Thing"] = 527,
    ["secrethub.yml"] = 789,
    ["semantic-release"] = 530,
    ["servicehub.config.json"] = 640,
    ["servicehub.service.json"] = 639,
    ["settings.job"] = 533,
    ["sfdx-hardis configuration"] = 535,
    ["size-limit configuration"] = 540,
    ["skaffold.yaml"] = 708,
    ["skyuxconfig.json"] = 542,
    snapcraft = 543,
    ["sqlc configuration"] = 551,
    ["stripe-app-local.json"] = 560,
    ["stripe-app.json"] = 559,
    swcrc = 695,
    ["task.json"] = 566,
    taskcat = 662,
    ["template.json"] = 570,
    ["templatsources.json"] = 571,
    ["theme.json"] = 574,
    ["tizen_workspace.json"] = 575,
    tldr = 576,
    tmuxinator = 648,
    ["transcend.yml"] = 583,
    ["tree-sitter grammar.json"] = 289,
    ["trime.yaml"] = 584,
    ["trunk.yaml"] = 585,
    ["ts-force-config.json"] = 589,
    ["tsconfig.json"] = 586,
    ["tsd.json"] = 587,
    ["tsdrc.json"] = 588,
    ["tslint.json"] = 590,
    ...
    ["typingsrc.json"] = 598,
    ["typo3.json"] = 596,
    ["ui5-workspace.yaml"] = 603,
    ["ui5.yaml"] = 602,
    unist = 727,
    ["up.json"] = 600,
    v8r = 623,
    ["vcpkg configuration file"] = 160,
    ["vcpkg manifest file"] = 159,
    ["vega-lite.json"] = 607,
    ["vega.json"] = 606,
    ["venvironment-basic.yaml"] = 610,
    ["venvironment.yaml"] = 609,
    ["version.json"] = 611,
    ["vim-addon-info"] = 613,
    ["vs-2017.3.host.json"] = 615,
    ["vs-nesting.json"] = 616,
    ["vsls.json"] = 614,
    ["vss-extension.json"] = 620,
    ["vtesttree.yaml"] = 621,
    ["vtestunit.yaml"] = 622,
    ["warp-keysets.json"] = 795,
    ["warp-themes.json"] = 796,
    ["warp-workflows.json"] = 797,
    ["webhint.io"] = 747,
    ["webjobpublishsettings.json"] = 628,
    ["webjobs-list.json"] = 627,
    ["xs-app.json"] = 658,
    ["xunit.runner.json"] = 638,
    yamllint = 683,
    zuul = 667,
    ["Žinoma"] = 677
  },
