...
M.json = {
  ...
  index = {
    ...
    AIConfig = 29,
    ["AMX Muse Program Descriptor"] = 1131,
    ["API Builder"] = 941,
    ["AVA Configuration"] = 1004,
    ...
    ["AWS Copilot Manifest"] = 1170,
    ["AWS SAM CLI Samconfig"] = 248,
    ["Adobe UXP Manifest"] = 1067,
    ["Aerleon Network & Service Definitions"] = 16,
    ["Aerleon Policy"] = 17,
    Aider = 1160,
    Air = 19,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1181,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1180,
    ["Airlock Microgateway"] = 30,
    ["Alacritty Configuration"] = 976,
    ["All Contributors configuration file"] = 1030,
    ...
    ["Application list for a WinUtil"] = 1111,
    ArchitectFX = 1116,
    ["Argo CD"] = 49,
    ["Argo Events"] = 50,
    ["Argo Workflows"] = 51,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1179,
    ["Azure IoT Operations connector metadata"] = 1176,
    ...
    ["Azure Pipelines"] = 103,
    ["Azure Static Web Apps CLI configuration file"] = 786,
    ["Azure Static Web Apps configuration file"] = 785,
    ["BOSH CPI Config"] = 127,
    ["BOSH Deploy Config"] = 128,
    ["BX CI"] = 147,
    ["Bacon config"] = 3,
    ["Bashly (bashly.yml)"] = 1034,
    ["Bashly Settings (bashly-settings.yml)"] = 1035,
    ["Better Code Hub"] = 946,
    ["Better Scripts"] = 148,
    Bigconfig = 120,
    ["Biome Formatter Config"] = 76,
    ["Bitmovin Encoding Template"] = 1124,
    BizTalkServerApplicationSchema = 913,
    Bleep = 149,
    ...
    ["Butane Config"] = 989,
    C4InterFlow = 1139,
    ["CDK Environment Manager, concrete environment configuration"] = 1163,
    ["CDK Environment Manager, concrete environments definition"] = 1162,
    ["CDK Environment Manager, environment definition"] = 1161,
    ["CGS Card Game Specification (cgs.json)"] = 1072,
    ["CICS TS region tagging"] = 998,
    ["CICS TS resource import"] = 999,
    ["CICS TS resource model"] = 1000,
    ["CICS TS resource overrides"] = 1001,
    ["CMake Presets"] = 150,
    ["CNC Codes"] = 171,
    ["CRS WAF test file"] = 1101,
    ["CRS WAF test platform overrides file"] = 1102,
    ...
    ["Chamaleon environment"] = 1128,
    ["Chamaleon properties"] = 1129,
    ["Chamaleon template"] = 1127,
    Changepacks = 1190,
    Changesets = 257,
    Changie = 159,
    Charmcraft = 160,
    ...
    ["Clawject config"] = 177,
    ["Cloud Foundry Application Manifest"] = 1083,
    ["Cloud Run Spec v1"] = 1106,
    ...
    Concord = 1100,
    ["Configu .cfgu files"] = 1088,
    ["Configu .configu file"] = 1089,
    Conjure = 170,
    ["Container Structure Test"] = 927,
    Containerlab = 955,
    ["Contextive Glossary"] = 1155,
    Convex = 169,
    ["Crowdsec collection config"] = 267,
    ["Crowdsec parser config"] = 268,
    ["Crowdsec scenario config"] = 269,
    ["CumulusCI Config"] = 176,
    ["Custom Machinery Machine"] = 1073,
    ["Custom Machinery Recipe"] = 1074,
    ...
    ["DonateCaseBetterCasino menu"] = 1132,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1042,
    ["EAS config"] = 333,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1031,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1175,
    ["EasyVCR .NET"] = 334,
    ["Eidolon Resource"] = 1117,
    ...
    ["Evolving Resolutive Process notation"] = 1177,
    ["Expo SDK"] = 332,
    ...
    ["GeoJSON.json latest"] = 993,
    GherKing = 997,
    ["GitHub Action"] = 366,
    ["GitHub Actions typing"] = 1113,
    ...
    ["Google Digital Assetlinks"] = 1156,
    Goreleaser = 394,
    ["Goreleaser Pro"] = 395,
    Goss = 396,
    ["Gradle Build Cache Node"] = 944,
    ["Gradle Enterprise"] = 943,
    ...
    Hadolint = 923,
    Hammerkit = 954,
    ["Hardware Sentry Configuration"] = 1009,
    ["HashiCorp Vault"] = 410,
    Hatch = 924,
    Hayagriva = 412,
    Hayson = 413,
    ...
    ["JFrog File Spec"] = 448,
    ["JFrog Pipelines YML DSL"] = 1019,
    ["JMeter DSL cli config"] = 449,
    JReleaser = 452,
    ["JSON Document Transform"] = 460,
    ["JSON Feed"] = 461,
    ["JSON Resume"] = 699,
    ["JSON Schema Draft 2020-12"] = 891,
    ["JSON Schema Draft 4"] = 888,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1052,
    ["JSON Schema Draft 7"] = 889,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1053,
    ["JSON Schema Draft 8 (2019-09)"] = 890,
    ["JSON-API"] = 459,
    ["JSON-e templates"] = 951,
    ["JSON-stat 2.0"] = 884,
    JSONPatch = 463,
    ...
    ["Jujutsu (jj) VCS config"] = 1169,
    ["KIMMDY config file"] = 474,
    ["KODE/CI build.yaml"] = 1015,
    ["KSP-AVC"] = 885,
    ["KSP-CKAN"] = 886,
    ["KSP-NetKAN"] = 887,
    KSY = 1082,
    ...
    ["Metadata for a Cinnamon spice"] = 1109,
    ["Metatype Configuration"] = 514,
    ["MetricsHub Configuration"] = 515,
    ["MetricsHub Connector Configuration"] = 516,
    ["Micro Editor Syntax"] = 1043,
    ["Microsoft Band Web Tile"] = 517,
    ["Microsoft RulesEngine workflow rules"] = 1097,
    ["Microsoft RulesEngine workflow rules list"] = 1098,
    ["Minecraft Custom Main Menu Mod"] = 1061,
    ...
    ["MongoDB Atlas Search Index Definition"] = 1014,
    ["Monika Configuration"] = 1012,
    ["Monoweave Configuration"] = 542,
    ["Motif config"] = 905,
    MultiQC = 1149,
    ["NOX Framework (Service)"] = 563,
    ["Netin Diagnostic System Template"] = 971,
    ["Netlify config"] = 550,
    ...
    ["OpenUtau ustx"] = 585,
    ["OpenWeather Current Weather API"] = 950,
    ["OpenWeather Road Risk API"] = 949,
    ...
    ["Power Pages Configuration"] = 1166,
    ["Preset list for a WinUtil"] = 1112,
    ...
    ["Problem object RFC9457"] = 1058,
    ["Problem package generators"] = 646,
    Pterodactyl = 1008,
    ["Pull Request Labeler"] = 663,
    Pulumi = 671,
    ["PyGTA Config"] = 667,
    PyProject = 672,
    Pylock = 1157,
    Pyright = 673,
    ["Python script metadata"] = 1151,
    ["QType AI DSL"] = 676,
    Qgoda = 675,
    Qodana = 981,
    ["Qt Creator workspace file"] = 1090,
    ["Quali Torque Blueprint Spec 2"] = 1006,
    ["QueryFirst config file"] = 1025,
    ["RKE Cluster Configuration JSON"] = 959,
    ["RKE Cluster Configuration YAML"] = 958,
    RadioHound = 666,
    Railpack = 678,
    Railway = 677,
    ["Rancher Fleet"] = 668,
    ...
    Ray = 922,
    ["Read the Docs"] = 670,
    ["Red-DiscordBot Cog"] = 686,
    ["Red-DiscordBot Cog Repo"] = 687,
    ["Red-DiscordBot Trivia"] = 688,
    ["Releasaurus Config"] = 2,
    ["Render Blueprints"] = 957,
    RenderCV = 701,
    Renovate = 700,
    ["Replit config"] = 694,
    Restate = 1144,
    ["Revel Digital Gadget Definition File"] = 1168,
    RoadRunner = 703,
    ["Robust Station Image"] = 1174,
    Rockcraft = 704,
    ["Roo Coder Custom Modes"] = 705,
    Rubocop = 696,
    ["Rudder techniques"] = 1065,
    Ruff = 697,
    ["Rust Project"] = 698,
    ["Rust toolchain"] = 709,
    ["SDMX data message"] = 735,
    ["SDMX metadata message"] = 734,
    ["SDMX structure message"] = 733,
    ["SIL Kit Participant Configuration"] = 745,
    ["SIL Kit Registry Configuration"] = 746,
    ["SPDX 2.3"] = 783,
    SWADL = 799,
    ["Safebox Config"] = 1020,
    ["Sapphire CLI Config"] = 712,
    ["SauceCTL Configuration"] = 968,
    ["Schema Catalog"] = 727,
    ["Scoop manifest"] = 732,
    ["Semantic Data Fabric (SDF) file"] = 736,
    ["Semgrep Rule"] = 738,
    ["Serenity Code Generator (Sergen)"] = 739,
    ["Serverless Framework Configuration"] = 975,
    ["Serverless Workflow"] = 977,
    ["Settings for a Cinnamon spice"] = 1108,
    ["Settings.paf"] = 741,
    ["Shopware 6 Configuration"] = 978,
    ["Shopware CLI Extension Store Configuration"] = 979,
    ["Shopware CLI Project Store Configuration"] = 980,
    ["Sigma Detection Rule"] = 743,
    ["Sigrid scope configuration file"] = 744,
    ["SkyPilot Task JSON"] = 1066,
    ["Slack app manifest"] = 748,
    Snapcraft = 750,
    Solidarity = 753,
    ["Solution filters"] = 754,
    ["Source Maps v3"] = 755,
    Sourcery = 756,
    ["Spack bootstrap.yaml"] = 757,
    ["Spack cdash.yaml"] = 758,
    ["Spack ci.yaml"] = 759,
    ["Spack compilers.yaml"] = 760,
    ["Spack concretizer.yaml"] = 761,
    ["Spack config.yaml"] = 762,
    ["Spack definitions.yaml"] = 763,
    ["Spack develop.yaml"] = 764,
    ["Spack env_vars.yaml"] = 765,
    ["Spack environment"] = 771,
    ["Spack include.yaml"] = 766,
    ["Spack mirrors.yaml"] = 767,
    ["Spack modules.yaml"] = 768,
    ["Spack packages.yaml"] = 769,
    ["Spack repos.yaml"] = 770,
    ["Spack toolchains.yaml"] = 772,
    ["Spack upstreams.yaml"] = 773,
    ["Spack view.yaml"] = 774,
    ["Speakeasy Generation Config File"] = 778,
    ["Speakeasy Lint Configuration File"] = 775,
    ["Speakeasy Test Generation Configuration File"] = 776,
    ["Speakeasy Workflow File"] = 777,
    SpecIF = 779,
    ["Specmatic Configuration"] = 780,
    ["Sponge Mixin configuration"] = 781,
    StackBlitz = 787,
    ["StackHawk Scanner Configuration"] = 974,
    Stale = 788,
    Starfish = 789,
    ["Starlake Data Pipeline"] = 947,
    Starship = 790,
    ["Statamic Blueprint"] = 791,
    ["Stella configuration file"] = 792,
    ["Streamlit configuration file"] = 793,
    ["Stryker Mutator"] = 796,
    ["StyleCop Analyzers Configuration"] = 797,
    ["Stylelint (.stylelintrc)"] = 798,
    ["Stylua Config"] = 1158,
    ["Sublime Syntax"] = 1021,
    ["Subsquid squid manifest"] = 1068,
    ["Swagger API 2.0"] = 800,
    ["Synadia Connect Component"] = 801,
    TSON = 836,
    TSTyche = 837,
    ["TYPO3 Vendor Bundler config"] = 842,
    ["Tab data for a LinUtil"] = 1115,
    ["Tab list for a LinUtil"] = 1114,
    Tach = 802,
    ["Tach Domain"] = 803,
    Talhelper = 805,
    ["Talisman configuration"] = 806,
    Taplo = 1159,
    ["Taskfile config"] = 952,
    Taurus = 807,
    Tauticord = 808,
    ["Tekton Pipeline"] = 1187,
    ["Tekton PipelineRun"] = 1188,
    ["Tekton Task"] = 1185,
    ["Tekton TaskRun"] = 1186,
    Telefonistka = 1145,
    ["Terrateam config"] = 1171,
    ["TestEnvironment.json"] = 819,
    ["TextMate Grammar"] = 818,
    Threagile = 814,
    ["Tier.run pricing.json"] = 811,
    Tikibase = 812,
    Tombi = 817,
    ["Traefik v2"] = 822,
    ["Traefik v2 File Provider"] = 823,
    ["Traefik v3"] = 824,
    ["Traefik v3 File Provider"] = 825,
    ["Travis CI (.travis.yml)"] = 821,
    Treefmt = 399,
    Trident = 1141,
    ["TrueScript for *.tscript files"] = 828,
    ["Tugboat QA config.yml"] = 1138,
    TunnelHub = 1056,
    Turborepo = 820,
    Tycho = 1104,
    Tye = 982,
    ["Tyk Gateway - Open Source v5.7+"] = 1150,
    ["Typst Manifest"] = 843,
    ["UET BuildConfig.json"] = 1026,
    ["UI5 Manifest"] = 849,
    ["UNCORS configuration"] = 853,
    ["UTAM Page Object"] = 852,
    ["Ubuntu Server Autoinstall"] = 847,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1142,
    ["Uniswap Token List"] = 934,
    ["Universal Schedule Format"] = 854,
    ["Unreal Engine Uplugin"] = 1027,
    ["Unreal Engine Uproject"] = 1028,
    ["UpCloud CLI (upctl) configuration"] = 1143,
    ["Updatecli Compose"] = 990,
    ["Updatecli Policy Manifest"] = 991,
    ["Updatecli Policy Metadata"] = 992,
    Uplift = 1024,
    ["Upsun config"] = 4,
    ["User Journey Map"] = 956,
    V2Ray = 996,
    ["VSCode Code Snippets"] = 232,
    ["VSIX CLI publishing"] = 872,
    Vector = 856,
    ["Vela Pipeline Configuration"] = 859,
    Vercel = 231,
    ["Version Bumper config"] = 862,
    Vespertide = 1192,
    ["Vespertide Migration"] = 1193,
    ["Vespertide Model"] = 1194,
    ["Viash Component Config"] = 1147,
    ["Viash Package Config"] = 1148,
    Visivo = 1054,
    ["WP-CLI"] = 882,
    Wake = 1140,
    ["Waku Config"] = 1118,
    ["Web App Manifest"] = 878,
    ["Web types"] = 881,
    WebExtensions = 877,
    ["Webman package recipe"] = 1002,
    ["Windows Package Manager Installer Manifest"] = 930,
    ["Windows Package Manager Locale Manifest"] = 931,
    ["Windows Package Manager Singleton Manifest"] = 929,
    Winutil = 932,
    ["WireMock CLI import configuration"] = 1123,
    ["WireMock CLI local service configuration"] = 1122,
    ["WireMock stub mapping"] = 1121,
    ["Woodpecker pipeline config"] = 970,
    ["Wrangler CLI"] = 883,
    ["Xstate Machine"] = 988,
    ["Yandex Workflow Language"] = 1110,
    ["Yarn Config (.yarnrc.yml)"] = 945,
    ["Yippee-Ki-JSON configuration YML"] = 936,
    ["YouTrack App"] = 1107,
    ["Zarf Package Configuration"] = 1173,
    ["Zerops.io config"] = 1095,
    ["Zerops.io import"] = 1096,
    ["Zola Configuration"] = 1184,
    ["aerleon.yml"] = 15,
    ["angular.json"] = 31,
    apko = 1059,
    ...
    ["behat.yml"] = 130,
    ["bigquery-table"] = 119,
    ["bioimageio resource description"] = 1076,
    ...
    ["crowdin.yml"] = 266,
    ["ctfd-setup configuration file"] = 1130,
    ["custom-elements.json"] = 1046,
    ["cypress.json"] = 270,
    ...
    ["gematik health care insurance list"] = 1136,
    ["gematik health care patient list"] = 1133,
    ["gematik health care provider institution list"] = 1135,
    ["gematik health care provider list"] = 1134,
    ["gematik tiger test environment configuration"] = 1137,
    ["git-town.toml"] = 1182,
    ["gitlab-ci"] = 374,
    ["global.json"] = 390,
    ...
    ["lint-staged (.lintstagedrc)"] = 899,
    ["local.settings.json"] = 502,
    ["localazy.json"] = 503,
    ["lotus.yaml"] = 501,
    ["lsdlschema.json"] = 504,
    ["macro.json"] = 1011,
    ["markdown-link-check"] = 965,
    maturin = 966,
    mboats = 973,
    ["micro-settings.json"] = 1038,
    ["mimetypes.json"] = 518,
    ["mirrord config"] = 901,
    mise = 902,
    ["mkdocs.yml"] = 538,
    ["monospace.yml"] = 541,
    ["moon.yml"] = 1120,
    ["mprocs Configuration file"] = 1091,
    ["mrdocs.yml"] = 539,
    ["mta.yaml"] = 903,
    ["mtad.yaml"] = 904,
    ["mycode.json"] = 548,
    ...
    ["plagiarize.yaml"] = 622,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1126,
    ["podbard.yaml"] = 625,
    ["portman.json"] = 628,
    ["prefect.toml"] = 636,
    ["prefect.yaml"] = 637,
    ["prettierrc.json"] = 638,
    ["prisma.yml"] = 639,
    ["project-1.0.0-beta3.json"] = 648,
    ["project-1.0.0-beta4.json"] = 649,
    ["project-1.0.0-beta5.json"] = 650,
    ["project-1.0.0-beta6.json"] = 651,
    ["project-1.0.0-beta8.json"] = 652,
    ["project-1.0.0-rc1.json"] = 653,
    ["project-1.0.0-rc2.json"] = 654,
    ["project.json"] = 647,
    ["project.owasp.yaml"] = 655,
    ["prometheus-alertmanager.json"] = 659,
    ["prometheus.json"] = 656,
    ["prometheus.rules.json"] = 657,
    ["prometheus.rules.test.json"] = 658,
    ["proxies.json"] = 660,
    ["publiccode.yml"] = 661,
    ["pubspec.yaml"] = 662,
    ["pyrseas-0.8.json"] = 665,
    pytest = 674,
    ["quilt.mod.json"] = 1039,
    ["rc3 auth"] = 680,
    ["rc3 collection"] = 681,
    ...
    ["release drafter"] = 917,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 690,
    ["release-please-manifest.json"] = 691,
    ["release-plz.toml"] = 692,
    ["renv.lock"] = 702,
    ["rivet.json"] = 1063,
    ["rivet.yaml (legacy)"] = 1062,
    rumdl = 707,
    runny = 706,
    rustfmt = 708,
    sake = 1153,
    samt = 710,
    samtrc = 711,
    ["sarif-1.0.0.json"] = 713,
    ["sarif-2.0.0.json"] = 714,
    ["sarif-2.1.0"] = 724,
    ["sarif-2.1.0-rtm.2"] = 715,
    ["sarif-2.1.0-rtm.3"] = 717,
    ["sarif-2.1.0-rtm.4"] = 719,
    ["sarif-2.1.0-rtm.5"] = 721,
    ["sarif-2.1.0-rtm.6"] = 722,
    ["sarif-external-property-file-2.1.0"] = 725,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 716,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 718,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 720,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 723,
    ["scalingo.json configuration"] = 726,
    ["schema.org - Action"] = 728,
    ["schema.org - ContactPoint"] = 729,
    ["schema.org - Place"] = 730,
    ["schema.org - Thing"] = 731,
    ["secrethub.yml"] = 1041,
    ["semantic-release"] = 737,
    ["servicehub.config.json"] = 894,
    ["servicehub.service.json"] = 893,
    ["settings.job"] = 740,
    ["sfdx-hardis configuration"] = 742,
    ["shard.yml"] = 1079,
    ["size-limit configuration"] = 747,
    ["skaffold.yaml"] = 963,
    ["skyuxconfig.json"] = 749,
    ["snowflake-config"] = 751,
    ["snowflake-connections"] = 752,
    ["spicepod.yaml"] = 1099,
    ["sqlc configuration"] = 784,
    ["stripe-app-local.json"] = 795,
    ["stripe-app.json"] = 794,
    swcrc = 948,
    ["task.json"] = 804,
    taskcat = 912,
    ["template.json"] = 809,
    ["templatsources.json"] = 810,
    ["theme.json"] = 813,
    ["tizen_workspace.json"] = 815,
    tldr = 816,
    ["tm_devices configuration file"] = 1164,
    tmuxinator = 897,
    ["transcend.yml"] = 826,
    ["tree-sitter grammar.json"] = 398,
    ["trime.yaml"] = 827,
    ["trunk.yaml"] = 829,
    ["ts-force-config.json"] = 834,
    ["tsconfig.json"] = 830,
    ["tsd.json"] = 831,
    ["tsdoc.json"] = 832,
    ["tsdrc.json"] = 833,
    ...
    ["vega-lite.json"] = 858,
    ["vega.json"] = 857,
    ["venvironment.yaml"] = 860,
    ["venvplus.yaml"] = 861,
    version = 1146,
    ["version.json"] = 863,
    ["vhwdebugger-binding.yaml"] = 865,
    ["vim-addon-info"] = 866,
    ["vs-2017.3.host.json"] = 868,
    ["vs-nesting.json"] = 869,
    ["vsls.json"] = 867,
    ["vss-extension.json"] = 873,
    vtcfg = 1152,
    ["vtesttree.yaml"] = 874,
    ["vtestunit.yaml"] = 875,
    ["warp-keysets.json"] = 1047,
    ["warp-themes.json"] = 1048,
    ["warp-workflows.json"] = 1049,
    ["webhint.io"] = 1003,
    ["webjobpublishsettings.json"] = 880,
    ["webjobs-list.json"] = 879,
    ["well-known-fursona"] = 1086,
    ["xs-app.json"] = 907,
    ["xunit.runner.json"] = 892,
    yamllint = 935,
    zizmor = 1189,
    zuul = 918,
    ["Žinoma"] = 928
