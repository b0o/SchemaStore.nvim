...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 112,
    [".cryproj (generic)"] = 423,
    [".cryproj engine-5.2"] = 418,
    [".cryproj engine-5.3"] = 419,
    [".cryproj engine-5.4"] = 420,
    [".cryproj engine-5.5"] = 421,
    [".cryproj engine-dev"] = 422,
    [".csscomb.json"] = 114,
    [".csslintrc"] = 115,
    [".eslintrc"] = 152,
    [".esmrc.json"] = 145,
    ...
    [".mtaext"] = 429,
    [".nodehawkrc"] = 263,
    [".npmpackagejsonlintrc"] = 265,
    [".phraseapp.yml"] = 295,
    [".pmbot.yml"] = 288,
    [".postcssrc"] = 293,
    [".pre-commit-config.yml"] = 294,
    [".putout.json"] = 312,
    [".rehyperc"] = 317,
    [".remarkrc"] = 318,
    [".sprite files"] = 354,
    ...
    [".vsext"] = 399,
    [".yarnrc.yml"] = 461,
    ["<div>RIOTS' studio configuration"] = 402,
    ["API Builder"] = 458,
    ["AVA Configuration Schema"] = 507,
    ...
    ["Azure Pipelines"] = 40,
    ["Azure Static Web Apps CLI configuration file"] = 356,
    ["Azure Static Web Apps configuration file"] = 355,
    ["Better Code Hub"] = 463,
    BizTalkServerApplicationSchema = 435,
    ...
    ["Butane config schema"] = 497,
    ["CICS TS resource overrides"] = 504,
    ["CMake Presets"] = 68,
    ["CSR Framework"] = 76,
    ...
    ["Error pages"] = 148,
    Esquio = 146,
    ["Estuary Flow Catalog Schema"] = 501,
    ["Expo SDK"] = 151,
    ...
    Goreleaser = 178,
    ["Goreleaser Pro"] = 179,
    ["Gradle Build Cache Node"] = 460,
    ["Gradle Enterprise"] = 459,
    ...
    ["JSON Feed"] = 216,
    ["JSON Resume"] = 320,
    ["JSON Schema Draft 2020-12"] = 414,
    ["JSON Schema Draft 4"] = 411,
    ["JSON Schema Draft 7"] = 412,
    ["JSON Schema Draft 8"] = 413,
    ...
    ["KSP-AVC"] = 409,
    ["KSP-CKAN"] = 410,
    ["LinkML Metamodel"] = 231,
    Liquibase = 475,
    Markdownlint = 478,
    ["MegaLinter configuration"] = 235,
    ["MegaLinter descriptor"] = 236,
    ["Meltano plugin discovery definition"] = 238,
    ["Meltano project definition"] = 237,
    ["Microsoft Band Web Tile"] = 239,
    ["Minecraft Data Pack Advancement"] = 241,
    ["Minecraft Data Pack Biome"] = 242,
    ["Minecraft Data Pack Configured Carver"] = 243,
    ["Minecraft Data Pack Dimension"] = 245,
    ["Minecraft Data Pack Dimension Type"] = 244,
    ["Minecraft Data Pack Item Modifier"] = 246,
    ["Minecraft Data Pack Loot Table"] = 247,
    ["Minecraft Data Pack Metadata"] = 248,
    ["Minecraft Data Pack Predicate"] = 249,
    ["Minecraft Data Pack Recipe"] = 250,
    ["Minecraft Data Pack Template Pool"] = 251,
    ["Minecraft Resourcepack Sounds"] = 252,
    ["Netin Diagnostic System Template"] = 482,
    ["Netlify config schema"] = 257,
    ["Nightwatch.js"] = 258,
    ["OSS Review Toolkit curation"] = 279,
    ["OSS Review Toolkit package configuration"] = 280,
    ["OSS Review Toolkit repository configuration"] = 281,
    ["OSS Review Toolkit resolutions"] = 282,
    Opctl = 431,
    ["OpenWeather Current Weather API"] = 467,
    ["OpenWeather Road Risk API"] = 466,
    ["Ory Hydra configuration"] = 197,
    ["Ory Keto configuration"] = 222,
    ["Ory Kratos configuration"] = 278,
    ["Ory Oathkeeper configuration"] = 270,
    ["Outblocks App configuration"] = 276,
    ["Outblocks database table"] = 277,
    ["Outblocks project configuration"] = 275,
    Packer = 285,
    ["Pipeline component"] = 476,
    ["PocketMine plugin.yml"] = 289,
    ["Pull Request Labeler"] = 311,
    Qodana = 490,
    ["RKE Cluster Configuration JSON Schema"] = 474,
    ["RKE Cluster Configuration YAML Schema"] = 473,
    Ray = 443,
    ["Read the Docs"] = 314,
    ["Red-DiscordBot Cog"] = 315,
    ["Red-DiscordBot Cog Repo"] = 316,
    Renovate = 321,
    RoadRunner = 322,
    SWADL = 365,
    ["Sapphire CLI Config"] = 323,
    ["SauceCTL Configuration"] = 479,
    ["Schema Catalog"] = 336,
    ["Scoop manifest"] = 341,
    ["Semantic Release"] = 342,
    ["Semgrep Rule"] = 343,
    ["Serverless Framework Configuration"] = 486,
    ["Settings.paf"] = 345,
    ["Shopware 6 Configuration"] = 487,
    ["Shopware CLI Extension Store Configuration"] = 488,
    ["Shopware CLI Project Store Configuration"] = 489,
    Solidarity = 350,
    ["Source Maps v3"] = 351,
    SpecIF = 352,
    ["Sponge Mixin configuration"] = 353,
    ["StackHawk Scanner Configuration"] = 485,
    ["StackHead CLI config"] = 357,
    ["StackHead module configuration"] = 358,
    ["StackHead project definition"] = 359,
    Stale = 360,
    ["Statamic Blueprint"] = 361,
    ["Stryker Mutator"] = 362,
    ["StyleCop Analyzers Configuration"] = 363,
    ["Swagger API 2.0"] = 366,
    ["Taskfile YAML Schema"] = 469,
    Taurus = 367,
    ["TestEnvironment.json"] = 373,
    Tikibase = 370,
    ["Traefik v2"] = 375,
    ["Traefik v2 File Provider"] = 376,
    Tye = 491,
    ["UI5 Manifest"] = 388,
    ["Ubuntu Server Autoinstall"] = 386,
    ["Uniswap Token List"] = 452,
    Updatecli = 498,
    ["User Journey Map YAML Schema"] = 472,
    V2Ray = 502,
    ["VSCode Code Snippets"] = 90,
    ["VSIX CLI publishing"] = 400,
    ["Vela Pipeline Configuration"] = 392,
    Vercel = 89,
    ["Web App Manifest"] = 404,
    ["Web types"] = 407,
    WebExtensions = 403,
    ["Webman package recipe"] = 505,
    ["Windows Package Manager Installer Manifest"] = 449,
    ["Windows Package Manager Locale Manifest"] = 450,
    ["Windows Package Manager Singleton Manifest"] = 448,
    ["Woodpecker pipeline config"] = 481,
    ["Xstate Machine Schema"] = 496,
    ["Yippee-Ki-JSON configuration YML"] = 454,
    ["angular.json"] = 8,
    ...
    jsdoc = 442,
    ["k3d.yaml"] = 220,
    ["kustomization.yaml"] = 223,
    ["label-commenter-config.yml"] = 224,
    ["launchsettings.json"] = 225,
    ["lerna.json"] = 226,
    ["lgtm.yml"] = 227,
    ["libman.json"] = 228,
    ["license-report-config.json"] = 229,
    ["linkinator.config.json"] = 230,
    ["local.settings.json"] = 232,
    ["localazy.json"] = 233,
    ["lsdlschema.json"] = 234,
    mboats = 484,
    ["mimetypes.json"] = 240,
    ...
    ["mtad.yaml"] = 428,
    ["mycode.json"] = 255,
    ["napari plugin manifest"] = 256,
    neoload = 437,
    ["nest-cli"] = 261,
    ["ninjs (News in JSON) 1.3"] = 260,
    ["ninjs (News in JSON) 2.0"] = 259,
    ["nlu.json"] = 262,
    ["nodemon.json"] = 264,
    ["noodl.schema.json"] = 483,
    now = 433,
    ["nswag.json"] = 268,
    ntangle = 269,
    ["nuclei-template.yaml"] = 266,
    ["nuget-project.json"] = 267,
    ["ocelot.json"] = 271,
    ["omnisharp.json"] = 272,
    ["openapi.json"] = 273,
    ["openfin.json"] = 274,
    ["package.json"] = 283,
    ["package.manifest"] = 284,
    ["pattern.json"] = 287,
    pgap_yaml_input_reader = 286,
    ["plagiarize-me.yaml"] = 291,
    ["plagiarize.yaml"] = 290,
    ["portman.json"] = 292,
    ["prettierrc.json"] = 296,
    ["prisma.yml"] = 297,
    ["project-1.0.0-beta3.json"] = 299,
    ["project-1.0.0-beta4.json"] = 300,
    ["project-1.0.0-beta5.json"] = 301,
    ["project-1.0.0-beta6.json"] = 302,
    ["project-1.0.0-beta8.json"] = 303,
    ["project-1.0.0-rc1.json"] = 304,
    ["project-1.0.0-rc2.json"] = 305,
    ["project.json"] = 298,
    ["prometheus.json"] = 306,
    ["prometheus.rules.json"] = 307,
    ["proxies.json"] = 308,
    ["publiccode.yml"] = 309,
    ["pubspec.yaml"] = 310,
    ["pyrseas-0.8.json"] = 313,
    ["release drafter"] = 438,
    ["sarif-1.0.0.json"] = 324,
    ["sarif-2.0.0.json"] = 325,
    ["sarif-2.1.0"] = 334,
    ["sarif-2.1.0-rtm.2"] = 326,
    ["sarif-2.1.0-rtm.3"] = 328,
    ["sarif-2.1.0-rtm.4"] = 330,
    ["sarif-2.1.0-rtm.5"] = 332,
    ["sarif-external-property-file-2.1.0"] = 335,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 327,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 329,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 331,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 333,
    ["schema.org - Action"] = 337,
    ["schema.org - ContactPoint"] = 338,
    ["schema.org - Place"] = 339,
    ["schema.org - Thing"] = 340,
    ["service.datadog.yaml"] = 221,
    ["servicehub.config.json"] = 417,
    ["servicehub.service.json"] = 416,
    ["settings.job"] = 344,
    ["sfdx-hardis configuration"] = 346,
    ["size-limit configuration"] = 347,
    ["skaffold.yaml"] = 477,
    ["skyuxconfig.json"] = 348,
    snapcraft = 349,
    swcrc = 465,
    taskcat = 434,
    ["template.json"] = 368,
    ["templatsources.json"] = 369,
    ["theme.json"] = 371,
    tmLanguage = 372,
    ["trunk.yaml schema"] = 377,
    ["ts-force-config.json"] = 381,
    ["tsconfig.json"] = 378,
    ["tsd.json"] = 379,
    ["tsdrc.json"] = 380,
    ["tslint.json"] = 382,
    ...
    ["version.json"] = 393,
    ["vim-addon-info"] = 394,
    ["vs-2017.3.host.json"] = 396,
    ["vs-nesting.json"] = 397,
    ["vsls.json"] = 395,
    ["vss-extension.json"] = 401,
    ["webhint.io"] = 506,
    ["webjobpublishsettings.json"] = 406,
    ["webjobs-list.json"] = 405,
    ["xs-app.json"] = 430,
    ["xunit.runner.json"] = 415,
    yamllint = 453,
    zuul = 439,
    ["Žinoma"] = 447
  },
