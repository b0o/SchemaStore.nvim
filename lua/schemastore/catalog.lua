...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 96,
    [".cryproj (generic)"] = 388,
    [".cryproj engine-5.2"] = 383,
    [".cryproj engine-5.3"] = 384,
    [".cryproj engine-5.4"] = 385,
    [".cryproj engine-5.5"] = 386,
    [".cryproj engine-dev"] = 387,
    [".csscomb.json"] = 98,
    [".csslintrc"] = 99,
    [".eslintrc"] = 132,
    [".esmrc.json"] = 126,
    ...
    [".mtaext"] = 394,
    [".nodehawkrc"] = 236,
    [".npmpackagejsonlintrc"] = 238,
    [".phraseapp.yml"] = 265,
    [".pmbot.yml"] = 258,
    [".postcssrc"] = 263,
    [".pre-commit-config.yml"] = 264,
    [".putout.json"] = 282,
    [".rehyperc"] = 287,
    [".remarkrc"] = 288,
    [".sprite files"] = 322,
    ...
    [".vsext"] = 364,
    [".yarnrc.yml"] = 426,
    ["<div>RIOTS' studio configuration"] = 367,
    ["API Builder"] = 423,
    ...
    ["Azure Pipelines"] = 32,
    ["Azure Static Web Apps CLI configuration file"] = 324,
    ["Azure Static Web Apps configuration file"] = 323,
    ["Better Code Hub"] = 428,
    BizTalkServerApplicationSchema = 400,
    Briefcase = 405,
    Buildkite = 53,
    ...
    ["Citation File Format"] = 88,
    CityJSON = 62,
    ["Code Climate"] = 66,
    ["Container Structure Test"] = 411,
    Containerlab = 436,
    ["Dart build configuration"] = 100,
    ["Dart test config"] = 101,
    ["Deployer Recipe"] = 107,
    ["Discord Webhook"] = 109,
    ["Dolittle Artifacts"] = 111,
    ["Dolittle Bounded Context Configuration"] = 112,
    ["Dolittle Event Horizons Configuration"] = 113,
    ["Dolittle Resources Configuration"] = 114,
    ["Dolittle Server Configuration"] = 115,
    ["Dolittle Tenant Map Configuration"] = 117,
    ["Dolittle Tenants Configuration"] = 116,
    ["Dolittle Topology"] = 118,
    ["Drush site aliases"] = 121,
    ["Eclipse Che Devfile"] = 124,
    Esquio = 127,
    ["Expo SDK"] = 131,
    ["F-Droid Data metadata"] = 135,
    ["Facets - FSDL - Application"] = 133,
    ["Fossa configuration file"] = 140,
    ["Foundry VTT - Manifest"] = 138,
    ["Foundry VTT - Template"] = 139,
    ["Foxx Manifest"] = 33,
    ["GatewayCore API Gateway"] = 143,
    ["GitHub Action"] = 147,
    ["GitHub Funding"] = 148,
    ["GitHub Issue Template configuration"] = 150,
    ["GitHub Workflow"] = 151,
    ["GitHub Workflow Template Properties"] = 152,
    ["GitHub issue forms"] = 149,
    GitVersion = 146,
    ["Gitpod Configuration"] = 154,
    ["Global Privacy Control"] = 144,
    ["Google Cloud Workflows"] = 85,
    Goreleaser = 157,
    ["Goreleaser Pro"] = 158,
    ["Gradle Build Cache Node"] = 425,
    ["Gradle Enterprise"] = 424,
    ["Grafana 5.x Dashboard"] = 159,
    ["GraphQL Code Generator"] = 162,
    ["GraphQL Config"] = 161,
    ["GraphQL Mesh"] = 160,
    ["Grunt JSHint task"] = 166,
    ["Grunt Watch task"] = 167,
    ["Grunt base task"] = 168,
    ["Grunt clean task"] = 164,
    ["Grunt copy task"] = 163,
    ["Grunt cssmin task"] = 165,
    HEMTT = 397,
    Hadolint = 409,
    ["Hammerkit YAML Schema"] = 435,
    Hayson = 170,
    ["Hazelcast 5 Configuration"] = 171,
    ["Helm Chart.lock"] = 64,
    ["Helm Chart.yaml"] = 63,
    ["JFrog File Spec"] = 184,
    ["JSON Document Transform"] = 192,
    ["JSON Feed"] = 193,
    ["JSON Resume"] = 290,
    ["JSON Schema Draft 2020-12"] = 379,
    ["JSON Schema Draft 4"] = 376,
    ["JSON Schema Draft 7"] = 377,
    ["JSON Schema Draft 8"] = 378,
    ...
    ["JSON-API"] = 191,
    ["JSON-e templates"] = 433,
    ["JSON-stat 2.0"] = 373,
    JSONPatch = 195,
    ["Jekyll configuration"] = 181,
    ["Jenkins X Pipelines"] = 182,
    ["Jenkins X Requirements"] = 183,
    ["Jovo Language Models"] = 185,
    ["KSP-AVC"] = 374,
    ["KSP-CKAN"] = 375,
    Liquibase = 440,
    ["MegaLinter configuration"] = 209,
    ["MegaLinter descriptor"] = 210,
    ["Meltano plugin discovery definition"] = 212,
    ["Meltano project definition"] = 211,
    ["Microsoft Band Web Tile"] = 213,
    ["Minecraft Data Pack Advancement"] = 215,
    ["Minecraft Data Pack Biome"] = 216,
    ["Minecraft Data Pack Configured Carver"] = 217,
    ["Minecraft Data Pack Dimension"] = 219,
    ["Minecraft Data Pack Dimension Type"] = 218,
    ["Minecraft Data Pack Item Modifier"] = 220,
    ["Minecraft Data Pack Loot Table"] = 221,
    ["Minecraft Data Pack Metadata"] = 222,
    ["Minecraft Data Pack Predicate"] = 223,
    ["Minecraft Data Pack Recipe"] = 224,
    ["Minecraft Data Pack Template Pool"] = 225,
    ["Minecraft Resourcepack Sounds"] = 226,
    ["Netin Diagnostic System Template"] = 447,
    ["Netlify config schema"] = 231,
    ["Nightwatch.js"] = 232,
    ["OSS Review Toolkit repository configuration"] = 252,
    Opctl = 396,
    ["OpenWeather Current Weather API"] = 432,
    ["OpenWeather Road Risk API"] = 431,
    ["Ory Hydra configuration"] = 175,
    ["Ory Keto configuration"] = 198,
    ["Ory Kratos configuration"] = 251,
    ["Ory Oathkeeper configuration"] = 243,
    ["Outblocks App configuration"] = 249,
    ["Outblocks database table"] = 250,
    ["Outblocks project configuration"] = 248,
    Packer = 255,
    ["Pipeline component"] = 441,
    ["PocketMine plugin.yml"] = 259,
    ["Pull Request Labeler"] = 281,
    ["RKE Cluster Configuration JSON Schema"] = 439,
    ["RKE Cluster Configuration YAML Schema"] = 438,
    Ray = 408,
    ["Read the Docs"] = 284,
    ["Red-DiscordBot Сog"] = 285,
    ["Red-DiscordBot Сog Repo"] = 286,
    Renovate = 291,
    RoadRunner = 292,
    SWADL = 332,
    ["Sapphire CLI Config"] = 293,
    ["SauceCTL Configuration"] = 444,
    ["Schema Catalog"] = 306,
    ["Scoop manifest"] = 311,
    ["Semgrep Rule"] = 312,
    ["Serverless Framework Configuration"] = 451,
    ["Shopware CLI Extension Store Configuration"] = 452,
    Solidarity = 318,
    ["Source Maps v3"] = 319,
    SpecIF = 320,
    ["Sponge Mixin configuration"] = 321,
    ["StackHawk Scanner Configuration"] = 450,
    ["StackHead CLI config"] = 325,
    ["StackHead module configuration"] = 326,
    ["StackHead project definition"] = 327,
    Stale = 328,
    ["Stryker Mutator"] = 329,
    ["StyleCop Analyzers Configuration"] = 330,
    ["Swagger API 2.0"] = 333,
    ["Taskfile YAML Schema"] = 434,
    Taurus = 334,
    ["TestEnvironment.json"] = 339,
    ["Traefik v2"] = 341,
    ["Traefik v2 File Provider"] = 342,
    ["UI5 Manifest"] = 353,
    ["Uniswap Token List"] = 417,
    ["User Journey Map YAML Schema"] = 437,
    ["VSCode Code Snippets"] = 75,
    ["VSIX CLI publishing"] = 365,
    ["Vela Pipeline Configuration"] = 357,
    Vercel = 74,
    ["Web App Manifest"] = 369,
    ["Web types"] = 372,
    WebExtensions = 368,
    ["Windows Package Manager Installer Manifest"] = 414,
    ["Windows Package Manager Locale Manifest"] = 415,
    ["Windows Package Manager Singleton Manifest"] = 413,
    ["Woodpecker pipeline config"] = 446,
    ["Yippee-Ki-JSON configuration YML"] = 419,
    ["angular.json"] = 6,
    ...
    ["chutzpah.json"] = 81,
    ["cloud-sdk-pipeline-config-schema"] = 83,
    ["cloudbuild.json"] = 84,
    cloudify = 69,
    codemagic = 70,
    ["coffeelint.json"] = 89,
    comet = 429,
    ["commands.json"] = 78,
    ["compile_commands.json"] = 77,
    ["compilerconfig.json"] = 76,
    ["component.json"] = 91,
    ["composer.json"] = 90,
    ["config.json"] = 92,
    ["contentmanifest.json"] = 82,
    ["contribute.json"] = 93,
    ["cosmos.config.json"] = 79,
    ["crowdin.yml"] = 94,
    cspell = 97,
    ["cypress.json"] = 95,
    ["datalogic-scan2deploy-android"] = 102,
    ["datalogic-scan2deploy-ce"] = 103,
    ["debugsettings.json"] = 104,
    ["dependabot-v2.json"] = 106,
    ["dependabot.json"] = 105,
    ["detekt.yml"] = 108,
    devinit = 421,
    ["docfx.json"] = 110,
    ["docker-compose.yml"] = 420,
    ["dotnetcli.host.json"] = 119,
    ["drone.json"] = 120,
    ["dss-2.0.0.json"] = 122,
    ["dvc.yaml"] = 123,
    ["ecosystem.json"] = 125,
    ["electron-builder configuration file."] = 129,
    ["epr-manifest.json"] = 128,
    ["evcc.yaml"] = 130,
    ["fabric.mod.json"] = 134,
    ["first-timers-bot"] = 137,
    fulibWorkflows = 445,
    ["func.yaml"] = 141,
    ["function.json"] = 142,
    ["geojson.json"] = 145,
    ["gitlab-ci"] = 153,
    ["global.json"] = 155,
    ["golangci-lint Configuration"] = 156,
    ["haxelib.json"] = 169,
    helmfile = 410,
    ["host-meta.json"] = 173,
    ["host.json"] = 172,
    ...
    httpmockrc = 401,
    huskyrc = 390,
    ["imageoptimizer.json"] = 176,
    ["importmap.json"] = 178,
    ["ioBroker JSON UI"] = 179,
    ["ioBroker Package manifest"] = 180,
    ["jsconfig.json"] = 196,
    jsdoc = 407,
    ["k3d.yaml"] = 197,
    ["kustomization.yaml"] = 199,
    ["label-commenter-config.yml"] = 200,
    ["launchsettings.json"] = 201,
    ["lerna.json"] = 202,
    ["lgtm.yml"] = 203,
    ["libman.json"] = 204,
    ["license-report-config.json"] = 205,
    ["local.settings.json"] = 206,
    ["localazy.json"] = 207,
    ["lsdlschema.json"] = 208,
    ["markdownlint.json"] = 443,
    mboats = 449,
    ["mimetypes.json"] = 214,
    ["mta.yaml"] = 392,
    ["mtad.yaml"] = 393,
    ["mycode.json"] = 229,
    ["napari plugin manifest"] = 230,
    neoload = 402,
    ["nest-cli"] = 234,
    ["ninjs (News in JSON)"] = 233,
    ["nlu.json"] = 235,
    ["nodemon.json"] = 237,
    ["noodl.schema.json"] = 448,
    now = 398,
    ["nswag.json"] = 241,
    ntangle = 242,
    ["nuclei-template.yaml"] = 239,
    ["nuget-project.json"] = 240,
    ["ocelot.json"] = 244,
    ["omnisharp.json"] = 245,
    ["openapi.json"] = 246,
    ["openfin.json"] = 247,
    ["package.json"] = 253,
    ["package.manifest"] = 254,
    ["pattern.json"] = 257,
    pgap_yaml_input_reader = 256,
    ["plagiarize-me.yaml"] = 261,
    ["plagiarize.yaml"] = 260,
    ["portman.json"] = 262,
    ["prettierrc.json"] = 266,
    ["prisma.yml"] = 267,
    ["project-1.0.0-beta3.json"] = 269,
    ["project-1.0.0-beta4.json"] = 270,
    ["project-1.0.0-beta5.json"] = 271,
    ["project-1.0.0-beta6.json"] = 272,
    ["project-1.0.0-beta8.json"] = 273,
    ["project-1.0.0-rc1.json"] = 274,
    ["project-1.0.0-rc2.json"] = 275,
    ["project.json"] = 268,
    ["prometheus.json"] = 276,
    ["prometheus.rules.json"] = 277,
    ["proxies.json"] = 278,
    ["publiccode.yml"] = 279,
    ["pubspec.yaml"] = 280,
    ["pyrseas-0.8.json"] = 283,
    ["release drafter"] = 403,
    ["sarif-1.0.0.json"] = 294,
    ["sarif-2.0.0.json"] = 295,
    ["sarif-2.1.0"] = 304,
    ["sarif-2.1.0-rtm.2"] = 296,
    ["sarif-2.1.0-rtm.3"] = 298,
    ["sarif-2.1.0-rtm.4"] = 300,
    ["sarif-2.1.0-rtm.5"] = 302,
    ["sarif-external-property-file-2.1.0"] = 305,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 297,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 299,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 301,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 303,
    ["schema.org - Action"] = 307,
    ["schema.org - ContactPoint"] = 308,
    ["schema.org - Place"] = 309,
    ["schema.org - Thing"] = 310,
    ["servicehub.config.json"] = 382,
    ["servicehub.service.json"] = 381,
    ["settings.job"] = 313,
    ["sfdx-hardis configuration"] = 314,
    ["size-limit configuration"] = 315,
    ["skaffold.yaml"] = 442,
    ["skyuxconfig.json"] = 316,
    snapcraft = 317,
    swcrc = 430,
    taskcat = 399,
    ["template.json"] = 335,
    ["templatsources.json"] = 336,
    ["theme.json"] = 337,
    tmLanguage = 338,
    ["trunk.yaml schema"] = 343,
    ["ts-force-config.json"] = 347,
    ["tsconfig.json"] = 344,
    ["tsd.json"] = 345,
    ["tsdrc.json"] = 346,
    ["tslint.json"] = 348,
    ...
    ["version.json"] = 358,
    ["vim-addon-info"] = 359,
    ["vs-2017.3.host.json"] = 361,
    ["vs-nesting.json"] = 362,
    ["vsls.json"] = 360,
    ["vss-extension.json"] = 366,
    ["webjobpublishsettings.json"] = 371,
    ["webjobs-list.json"] = 370,
    ["xs-app.json"] = 395,
    ["xunit.runner.json"] = 380,
    yamllint = 418,
    zuul = 404,
    ["Žinoma"] = 412
  },
