...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 102,
    [".cryproj (generic)"] = 402,
    [".cryproj engine-5.2"] = 397,
    [".cryproj engine-5.3"] = 398,
    [".cryproj engine-5.4"] = 399,
    [".cryproj engine-5.5"] = 400,
    [".cryproj engine-dev"] = 401,
    [".csscomb.json"] = 104,
    [".csslintrc"] = 105,
    [".eslintrc"] = 140,
    [".esmrc.json"] = 133,
    ...
    [".mtaext"] = 408,
    [".nodehawkrc"] = 247,
    [".npmpackagejsonlintrc"] = 249,
    [".phraseapp.yml"] = 276,
    [".pmbot.yml"] = 269,
    [".postcssrc"] = 274,
    [".pre-commit-config.yml"] = 275,
    [".putout.json"] = 293,
    [".rehyperc"] = 298,
    [".remarkrc"] = 299,
    [".sprite files"] = 334,
    ...
    [".vsext"] = 378,
    [".yarnrc.yml"] = 440,
    ["<div>RIOTS' studio configuration"] = 381,
    ["API Builder"] = 437,
    ...
    ["Azure Pipelines"] = 36,
    ["Azure Static Web Apps CLI configuration file"] = 336,
    ["Azure Static Web Apps configuration file"] = 335,
    ["Better Code Hub"] = 442,
    BizTalkServerApplicationSchema = 414,
    ...
    ["Fossa's fossa-deps file"] = 149,
    ["Foundry VTT - Manifest"] = 146,
    ["Foundry VTT - Template"] = 147,
    ["Foxx Manifest"] = 37,
    ["GatewayCore API Gateway"] = 152,
    ["GitHub Action"] = 156,
    ["GitHub Funding"] = 157,
    ["GitHub Issue Template configuration"] = 159,
    ["GitHub Workflow"] = 160,
    ["GitHub Workflow Template Properties"] = 161,
    ["GitHub issue forms"] = 158,
    GitVersion = 155,
    ["Gitpod Configuration"] = 163,
    ["Global Privacy Control"] = 153,
    ["Google Cloud Workflows"] = 91,
    Goreleaser = 166,
    ["Goreleaser Pro"] = 167,
    ["Gradle Build Cache Node"] = 439,
    ["Gradle Enterprise"] = 438,
    ["Grafana 5.x Dashboard"] = 168,
    ["GraphQL Code Generator"] = 171,
    ["GraphQL Config"] = 170,
    ["GraphQL Mesh"] = 169,
    ["Grunt JSHint task"] = 175,
    ["Grunt Watch task"] = 176,
    ["Grunt base task"] = 177,
    ["Grunt clean task"] = 173,
    ["Grunt copy task"] = 172,
    ["Grunt cssmin task"] = 174,
    HEMTT = 411,
    Hadolint = 423,
    ["Hammerkit YAML Schema"] = 449,
    Hayson = 179,
    ["Haystack Pipeline"] = 180,
    ["Hazelcast 5 Configuration"] = 181,
    ["Helm Chart.lock"] = 70,
    ["Helm Chart.yaml"] = 69,
    ["JFrog File Spec"] = 194,
    ["JSON Document Transform"] = 202,
    ["JSON Feed"] = 203,
    ["JSON Resume"] = 301,
    ["JSON Schema Draft 2020-12"] = 393,
    ["JSON Schema Draft 4"] = 390,
    ["JSON Schema Draft 7"] = 391,
    ["JSON Schema Draft 8"] = 392,
    ...
    ["KSP-CKAN"] = 389,
    Liquibase = 454,
    ["MegaLinter configuration"] = 219,
    ["MegaLinter descriptor"] = 220,
    ["Meltano plugin discovery definition"] = 222,
    ["Meltano project definition"] = 221,
    ["Microsoft Band Web Tile"] = 223,
    ["Minecraft Data Pack Advancement"] = 225,
    ["Minecraft Data Pack Biome"] = 226,
    ["Minecraft Data Pack Configured Carver"] = 227,
    ["Minecraft Data Pack Dimension"] = 229,
    ["Minecraft Data Pack Dimension Type"] = 228,
    ["Minecraft Data Pack Item Modifier"] = 230,
    ["Minecraft Data Pack Loot Table"] = 231,
    ["Minecraft Data Pack Metadata"] = 232,
    ["Minecraft Data Pack Predicate"] = 233,
    ["Minecraft Data Pack Recipe"] = 234,
    ["Minecraft Data Pack Template Pool"] = 235,
    ["Minecraft Resourcepack Sounds"] = 236,
    ["Netin Diagnostic System Template"] = 461,
    ["Netlify config schema"] = 241,
    ["Nightwatch.js"] = 242,
    ["OSS Review Toolkit repository configuration"] = 263,
    Opctl = 410,
    ["OpenWeather Current Weather API"] = 446,
    ["OpenWeather Road Risk API"] = 445,
    ["Ory Hydra configuration"] = 185,
    ["Ory Keto configuration"] = 208,
    ["Ory Kratos configuration"] = 262,
    ["Ory Oathkeeper configuration"] = 254,
    ["Outblocks App configuration"] = 260,
    ["Outblocks database table"] = 261,
    ["Outblocks project configuration"] = 259,
    Packer = 266,
    ["Pipeline component"] = 455,
    ["PocketMine plugin.yml"] = 270,
    ["Pull Request Labeler"] = 292,
    Qodana = 468,
    ["RKE Cluster Configuration JSON Schema"] = 453,
    ["RKE Cluster Configuration YAML Schema"] = 452,
    Ray = 422,
    ["Read the Docs"] = 295,
    ["Red-DiscordBot Cog"] = 296,
    ["Red-DiscordBot Cog Repo"] = 297,
    Renovate = 302,
    RoadRunner = 303,
    SWADL = 345,
    ["Sapphire CLI Config"] = 304,
    ["SauceCTL Configuration"] = 458,
    ["Schema Catalog"] = 317,
    ["Scoop manifest"] = 322,
    ["Semgrep Rule"] = 323,
    ["Serverless Framework Configuration"] = 465,
    ["Settings.paf"] = 325,
    ["Shopware CLI Extension Store Configuration"] = 466,
    ["Shopware CLI Project Store Configuration"] = 467,
    Solidarity = 330,
    ["Source Maps v3"] = 331,
    SpecIF = 332,
    ["Sponge Mixin configuration"] = 333,
    ["StackHawk Scanner Configuration"] = 464,
    ["StackHead CLI config"] = 337,
    ["StackHead module configuration"] = 338,
    ["StackHead project definition"] = 339,
    Stale = 340,
    ["Statamic Blueprint"] = 341,
    ["Stryker Mutator"] = 342,
    ["StyleCop Analyzers Configuration"] = 343,
    ["Swagger API 2.0"] = 346,
    ["Taskfile YAML Schema"] = 448,
    Taurus = 347,
    ["TestEnvironment.json"] = 352,
    ["Traefik v2"] = 354,
    ["Traefik v2 File Provider"] = 355,
    Tye = 469,
    ["UI5 Manifest"] = 367,
    ["Ubuntu Server Autoinstall"] = 365,
    ["Uniswap Token List"] = 431,
    ["User Journey Map YAML Schema"] = 451,
    ["VSCode Code Snippets"] = 81,
    ["VSIX CLI publishing"] = 379,
    ["Vela Pipeline Configuration"] = 371,
    Vercel = 80,
    ["Web App Manifest"] = 383,
    ["Web types"] = 386,
    WebExtensions = 382,
    ["Windows Package Manager Installer Manifest"] = 428,
    ["Windows Package Manager Locale Manifest"] = 429,
    ["Windows Package Manager Singleton Manifest"] = 427,
    ["Woodpecker pipeline config"] = 460,
    ["Yippee-Ki-JSON configuration YML"] = 433,
    ["angular.json"] = 6,
    ...
    ["gitlab-ci"] = 162,
    ["global.json"] = 164,
    ["golangci-lint Configuration"] = 165,
    ["haxelib.json"] = 178,
    helmfile = 424,
    ["host-meta.json"] = 183,
    ["host.json"] = 182,
    ...
    httpmockrc = 415,
    huskyrc = 404,
    ["imageoptimizer.json"] = 186,
    ["importmap.json"] = 188,
    ["ioBroker JSON UI"] = 189,
    ["ioBroker Package manifest"] = 190,
    ["jsconfig.json"] = 206,
    jsdoc = 421,
    ["k3d.yaml"] = 207,
    ["kustomization.yaml"] = 209,
    ["label-commenter-config.yml"] = 210,
    ["launchsettings.json"] = 211,
    ["lerna.json"] = 212,
    ["lgtm.yml"] = 213,
    ["libman.json"] = 214,
    ["license-report-config.json"] = 215,
    ["local.settings.json"] = 216,
    ["localazy.json"] = 217,
    ["lsdlschema.json"] = 218,
    ["markdownlint.json"] = 457,
    mboats = 463,
    ["mimetypes.json"] = 224,
    ["mta.yaml"] = 406,
    ["mtad.yaml"] = 407,
    ["mycode.json"] = 239,
    ["napari plugin manifest"] = 240,
    neoload = 416,
    ["nest-cli"] = 245,
    ["ninjs (News in JSON) 1.3"] = 244,
    ["ninjs (News in JSON) 2.0"] = 243,
    ["nlu.json"] = 246,
    ["nodemon.json"] = 248,
    ["noodl.schema.json"] = 462,
    now = 412,
    ["nswag.json"] = 252,
    ntangle = 253,
    ["nuclei-template.yaml"] = 250,
    ["nuget-project.json"] = 251,
    ["ocelot.json"] = 255,
    ["omnisharp.json"] = 256,
    ["openapi.json"] = 257,
    ["openfin.json"] = 258,
    ["package.json"] = 264,
    ["package.manifest"] = 265,
    ["pattern.json"] = 268,
    pgap_yaml_input_reader = 267,
    ["plagiarize-me.yaml"] = 272,
    ["plagiarize.yaml"] = 271,
    ["portman.json"] = 273,
    ["prettierrc.json"] = 277,
    ["prisma.yml"] = 278,
    ["project-1.0.0-beta3.json"] = 280,
    ["project-1.0.0-beta4.json"] = 281,
    ["project-1.0.0-beta5.json"] = 282,
    ["project-1.0.0-beta6.json"] = 283,
    ["project-1.0.0-beta8.json"] = 284,
    ["project-1.0.0-rc1.json"] = 285,
    ["project-1.0.0-rc2.json"] = 286,
    ["project.json"] = 279,
    ["prometheus.json"] = 287,
    ["prometheus.rules.json"] = 288,
    ["proxies.json"] = 289,
    ["publiccode.yml"] = 290,
    ["pubspec.yaml"] = 291,
    ["pyrseas-0.8.json"] = 294,
    ["release drafter"] = 417,
    ["sarif-1.0.0.json"] = 305,
    ["sarif-2.0.0.json"] = 306,
    ["sarif-2.1.0"] = 315,
    ["sarif-2.1.0-rtm.2"] = 307,
    ["sarif-2.1.0-rtm.3"] = 309,
    ["sarif-2.1.0-rtm.4"] = 311,
    ["sarif-2.1.0-rtm.5"] = 313,
    ["sarif-external-property-file-2.1.0"] = 316,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 308,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 310,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 312,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 314,
    ["schema.org - Action"] = 318,
    ["schema.org - ContactPoint"] = 319,
    ["schema.org - Place"] = 320,
    ["schema.org - Thing"] = 321,
    ["servicehub.config.json"] = 396,
    ["servicehub.service.json"] = 395,
    ["settings.job"] = 324,
    ["sfdx-hardis configuration"] = 326,
    ["size-limit configuration"] = 327,
    ["skaffold.yaml"] = 456,
    ["skyuxconfig.json"] = 328,
    snapcraft = 329,
    swcrc = 444,
    taskcat = 413,
    ["template.json"] = 348,
    ["templatsources.json"] = 349,
    ["theme.json"] = 350,
    tmLanguage = 351,
    ["trunk.yaml schema"] = 356,
    ["ts-force-config.json"] = 360,
    ["tsconfig.json"] = 357,
    ["tsd.json"] = 358,
    ["tsdrc.json"] = 359,
    ["tslint.json"] = 361,
    ...
    ["version.json"] = 372,
    ["vim-addon-info"] = 373,
    ["vs-2017.3.host.json"] = 375,
    ["vs-nesting.json"] = 376,
    ["vsls.json"] = 374,
    ["vss-extension.json"] = 380,
    ["webjobpublishsettings.json"] = 385,
    ["webjobs-list.json"] = 384,
    ["xs-app.json"] = 409,
    ["xunit.runner.json"] = 394,
    yamllint = 432,
    zuul = 418,
    ["Žinoma"] = 426
  },
