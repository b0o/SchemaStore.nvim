...
M.json = {
  ...
  index = {
    ...
    [".pmbot.yml"] = 635,
    [".postcssrc"] = 644,
    [".powerpages-web-template-manifest"] = 646,
    [".pre-commit-config.yml"] = 647,
    [".pre-commit-hooks.yml"] = 648,
    [".putout.json"] = 683,
    [".rehyperc"] = 708,
    [".remarkrc"] = 712,
    [".sprite files"] = 803,
    ...
    AIConfig = 32,
    ["AMX Muse Program Descriptor"] = 1154,
    ["API Builder"] = 962,
    ["AVA Configuration"] = 1025,
    ...
    ["AWS Copilot Manifest"] = 1193,
    ["AWS SAM CLI Samconfig"] = 257,
    ["Adobe UXP Manifest"] = 1088,
    ["Aerleon Network & Service Definitions"] = 18,
    ["Aerleon Policy"] = 19,
    Aider = 1183,
    Air = 21,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1204,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1203,
    ["Airlock Microgateway"] = 33,
    ["Alacritty Configuration"] = 997,
    ["All Contributors configuration file"] = 1051,
    ...
    ["Application list for a WinUtil"] = 1133,
    ArchitectFX = 1138,
    ["Argo CD"] = 52,
    ["Argo Events"] = 53,
    ["Argo Workflows"] = 54,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1202,
    ["Azure IoT Operations connector metadata"] = 1199,
    ...
    ["Azure Pipelines"] = 108,
    ["Azure Static Web Apps CLI configuration file"] = 807,
    ["Azure Static Web Apps configuration file"] = 806,
    BMML = 1221,
    ["BOSH CPI Config"] = 133,
    ["BOSH Deploy Config"] = 134,
    ["BX CI"] = 153,
    ["Bacon config"] = 3,
    ["Bashly (bashly.yml)"] = 1055,
    ["Bashly Settings (bashly-settings.yml)"] = 1056,
    Bento = 1220,
    ["Better Code Hub"] = 967,
    ["Better Scripts"] = 154,
    Bigconfig = 126,
    ["Biome Formatter Config"] = 80,
    ["Bitmovin Encoding Template"] = 1147,
    BizTalkServerApplicationSchema = 934,
    Bleep = 155,
    ["Block Protocol Metadata"] = 152,
    ["Bluebricks blueprint config"] = 1226,
    ["Boyka Framework"] = 135,
    Briefcase = 940,
    ["Build Info"] = 143,
    Buildkite = 145,
    ...
    ["Butane Config"] = 1010,
    C4InterFlow = 1162,
    ["CDK Environment Manager, concrete environment configuration"] = 1186,
    ["CDK Environment Manager, concrete environments definition"] = 1185,
    ["CDK Environment Manager, environment definition"] = 1184,
    ["CGS Card Game Specification (cgs.json)"] = 1093,
    ["CICS TS region tagging"] = 1019,
    ["CICS TS resource import"] = 1020,
    ["CICS TS resource model"] = 1021,
    ["CICS TS resource overrides"] = 1022,
    ["CMake Presets"] = 156,
    ["CNC Codes"] = 178,
    ["CRS WAF test file"] = 1123,
    ["CRS WAF test platform overrides file"] = 1124,
    ...
    ["Chamaleon environment"] = 1151,
    ["Chamaleon properties"] = 1152,
    ["Chamaleon template"] = 1150,
    Changepacks = 1213,
    Changesets = 266,
    Changie = 165,
    Charmcraft = 166,
    ...
    ["Clawject config"] = 184,
    ["Cloud Foundry Application Manifest"] = 1105,
    ["Cloud Run Spec v1"] = 1128,
    ...
    Concord = 1122,
    ["Configu .cfgu files"] = 1110,
    ["Configu .configu file"] = 1111,
    Conjure = 177,
    ["Container Structure Test"] = 948,
    Containerlab = 976,
    ["Contextive Glossary"] = 1178,
    Convex = 176,
    ["Crowdsec collection config"] = 276,
    ["Crowdsec parser config"] = 277,
    ["Crowdsec scenario config"] = 278,
    ["CumulusCI Config"] = 183,
    ["Custom Machinery Machine"] = 1094,
    ["Custom Machinery Recipe"] = 1095,
    ...
    ["DonateCaseBetterCasino menu"] = 1155,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1063,
    ["EAS config"] = 345,
    ["ECA - Editor Code Assistant"] = 329,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1052,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1198,
    ["EasyVCR .NET"] = 346,
    ["Eidolon Resource"] = 1139,
    ...
    ["Erda Pipeline"] = 1101,
    ["Erda Runtime"] = 1102,
    ["Espanso config.yml"] = 1224,
    ["Espanso match.yml"] = 1223,
    Esquio = 334,
    ["Estuary Flow Catalog"] = 1016,
    ...
    ["Evolving Resolutive Process notation"] = 1200,
    ["Expo SDK"] = 344,
    ...
    ["GeoJSON.json latest"] = 1014,
    GherKing = 1018,
    ["GitHub Action"] = 379,
    ["GitHub Actions typing"] = 1135,
    ...
    ["Google Digital Assetlinks"] = 1179,
    Goreleaser = 407,
    ["Goreleaser Pro"] = 408,
    Goss = 409,
    ["Gradle Build Cache Node"] = 965,
    ["Gradle Enterprise"] = 964,
    ...
    Hadolint = 944,
    Hammerkit = 975,
    ["Hardware Sentry Configuration"] = 1030,
    ["HashiCorp Vault"] = 423,
    Hatch = 945,
    Hayson = 425,
    ["Haystack Pipeline"] = 426,
    ["Hazelcast 5 Configuration"] = 427,
    ["Hecate Input Schema"] = 1190,
    ["Helm Chart.lock"] = 220,
    ["Helm Chart.yaml"] = 219,
    ...
    ["JFrog File Spec"] = 460,
    ["JFrog Pipelines YML DSL"] = 1040,
    ["JMeter DSL cli config"] = 461,
    JReleaser = 464,
    ["JSON Document Transform"] = 472,
    ["JSON Feed"] = 473,
    ["JSON Resume"] = 718,
    ["JSON Schema Draft 2020-12"] = 912,
    ["JSON Schema Draft 4"] = 909,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1073,
    ["JSON Schema Draft 7"] = 910,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1074,
    ["JSON Schema Draft 8 (2019-09)"] = 911,
    ["JSON-API"] = 471,
    ["JSON-e templates"] = 972,
    ["JSON-stat 2.0"] = 905,
    JSONPatch = 475,
    ...
    ["Jujutsu (jj) VCS config"] = 1192,
    ["KIMMDY config file"] = 486,
    ["KODE/CI build.yaml"] = 1036,
    ["KSP-AVC"] = 906,
    ["KSP-CKAN"] = 907,
    ["KSP-NetKAN"] = 908,
    KSY = 1103,
    ...
    ["Metadata for a Cinnamon spice"] = 1131,
    ["Metatype Configuration"] = 526,
    ["MetricsHub Configuration"] = 527,
    ["MetricsHub Connector Configuration"] = 528,
    ["Micro Editor Syntax"] = 1064,
    ["Microsoft Band Web Tile"] = 529,
    ["Microsoft RulesEngine workflow rules"] = 1119,
    ["Microsoft RulesEngine workflow rules list"] = 1120,
    ["Minecraft Custom Main Menu Mod"] = 1082,
    ...
    ["MongoDB Atlas Search Index Definition"] = 1035,
    ["Monika Configuration"] = 1033,
    ["Monoweave Configuration"] = 555,
    ["Motif config"] = 926,
    MultiQC = 1172,
    ["NOX Framework (Service)"] = 576,
    ["Netin Diagnostic System Template"] = 992,
    ["Netlify config"] = 563,
    ...
    ["Nightwatch.js"] = 569,
    ["Node.js configuration"] = 931,
    ["NueJS configuration file"] = 581,
    ["Nuitka.yaml"] = 1096,
    ["Nullstone config"] = 583,
    ["ONe's changelog entry"] = 601,
    ["ONe's service descriptor"] = 600,
    ["ORT Server repository environment configuration"] = 611,
    ["OSCAL Assessment Plan (AP)"] = 613,
    ["OSCAL Assessment Results (AR)"] = 614,
    ["OSCAL Catalog"] = 615,
    ["OSCAL Component Definition (CDef)"] = 616,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 617,
    ["OSCAL Profile"] = 618,
    ["OSCAL System Security Plan (SSP)"] = 619,
    ["OSS Review Toolkit configuration"] = 620,
    ["OSS Review Toolkit curation"] = 621,
    ["OSS Review Toolkit package configuration"] = 622,
    ["OSS Review Toolkit repository configuration"] = 623,
    ["OSS Review Toolkit resolutions"] = 624,
    ...
    ["Ona Automations"] = 592,
    Opctl = 929,
    ["Open Data Contract Standard (ODCS)"] = 605,
    ["Open Data Product Standard (ODPS)"] = 606,
    ["Open Know-How"] = 1177,
    ["OpenRewrite Resource"] = 603,
    OpenSRM = 607,
    OpenStatus = 1188,
    ["OpenTelemetry Declarative Configuration"] = 604,
    ["OpenUtau character yaml"] = 597,
    ["OpenUtau ustx"] = 598,
    ["OpenWeather Current Weather API"] = 971,
    ["OpenWeather Road Risk API"] = 970,
    ["Ory Hydra configuration"] = 434,
    ["Ory Keto configuration"] = 494,
    ["Ory Kratos configuration"] = 612,
    ["Ory Oathkeeper configuration"] = 585,
    ["Outblocks App configuration"] = 609,
    ["Outblocks database table"] = 610,
    ["Outblocks project configuration"] = 608,
    PDM = 631,
    POPxf = 641,
    ["POPxf Correlations"] = 642,
    Packer = 628,
    Pantsbuild = 1050,
    ["Paper paper-plugin.yml"] = 629,
    ["Pipeline component"] = 983,
    ["Platform.sh application"] = 5,
    ["Platform.sh routes"] = 6,
    ["Platform.sh services"] = 7,
    ["Plex Prerolls"] = 639,
    ["PocketMine plugin.yml"] = 636,
    ["Postman collection"] = 645,
    ["Power Pages Configuration"] = 1189,
    ["Preset list for a WinUtil"] = 1134,
    ["ProActions AI-Kit Configuration"] = 656,
    ["ProActions AI-Kit Configuration for Menus"] = 658,
    ["ProActions AI-Kit Configuration for Sections"] = 660,
    ["ProActions AI-Kit Configuration for Services"] = 657,
    ["ProActions AI-Kit Configuration for Steps"] = 661,
    ["ProActions AI-Kit Configuration for Templates"] = 659,
    ["Problem object RFC9457"] = 1079,
    ["Problem package format"] = 662,
    ["Problem package generators"] = 663,
    ["Problem package submissions"] = 664,
    ["Problem package test group metadata"] = 665,
    Pterodactyl = 1029,
    ["Pull Request Labeler"] = 682,
    Pulumi = 690,
    ["PyGTA Config"] = 686,
    PyProject = 691,
    Pylock = 1180,
    Pyright = 692,
    ["Python script metadata"] = 1174,
    ["QType AI DSL"] = 695,
    Qgoda = 694,
    Qodana = 1002,
    ["Qt Creator workspace file"] = 1112,
    ["Quali Torque Blueprint Spec 2"] = 1027,
    ["QueryFirst config file"] = 1046,
    ["RKE Cluster Configuration JSON"] = 980,
    ["RKE Cluster Configuration YAML"] = 979,
    RadioHound = 685,
    Railpack = 697,
    Railway = 696,
    ["Rancher Fleet"] = 687,
    ...
    Ray = 943,
    ["Read the Docs"] = 689,
    ["Red-DiscordBot Cog"] = 705,
    ["Red-DiscordBot Cog Repo"] = 706,
    ["Red-DiscordBot Trivia"] = 707,
    ["Releasaurus Config"] = 2,
    ["Render Blueprints"] = 978,
    RenderCV = 722,
    Renovate = 719,
    ["Renovate global configuration"] = 720,
    ["Renovate inherited configuration"] = 721,
    ["Replit config"] = 713,
    Restate = 1167,
    ["Revel Digital Gadget Definition File"] = 1191,
    RoadRunner = 724,
    ["Robust Station Image"] = 1197,
    Rockcraft = 725,
    ["Roo Coder Custom Modes"] = 726,
    Rubocop = 715,
    ["Rudder techniques"] = 1086,
    Ruff = 716,
    ["Rust Project"] = 717,
    ["Rust toolchain"] = 730,
    ["SDMX data message"] = 756,
    ["SDMX metadata message"] = 755,
    ["SDMX structure message"] = 754,
    ["SIL Kit Participant Configuration"] = 766,
    ["SIL Kit Registry Configuration"] = 767,
    ["SPDX 2.3"] = 804,
    SWADL = 820,
    ["Safebox Config"] = 1041,
    ["Sapphire CLI Config"] = 733,
    ["SauceCTL Configuration"] = 989,
    ["Schema Catalog"] = 748,
    ["Scoop manifest"] = 753,
    ["Semantic Data Fabric (SDF) file"] = 757,
    ["Semgrep Rule"] = 759,
    ["Serenity Code Generator (Sergen)"] = 760,
    ["Serverless Framework Configuration"] = 996,
    ["Serverless Workflow"] = 998,
    ["Settings for a Cinnamon spice"] = 1130,
    ["Settings.paf"] = 762,
    ["Shopware 6 Configuration"] = 999,
    ["Shopware CLI Extension Store Configuration"] = 1000,
    ["Shopware CLI Project Store Configuration"] = 1001,
    ["Sigma Detection Rule"] = 764,
    ["Sigrid scope configuration file"] = 765,
    ["SkyPilot Task JSON"] = 1087,
    ["Slack app manifest"] = 769,
    Snapcraft = 771,
    Solidarity = 774,
    ["Solution filters"] = 775,
    ["Source Maps v3"] = 776,
    Sourcery = 777,
    ["Spack bootstrap.yaml"] = 778,
    ["Spack cdash.yaml"] = 779,
    ["Spack ci.yaml"] = 780,
    ["Spack compilers.yaml"] = 781,
    ["Spack concretizer.yaml"] = 782,
    ["Spack config.yaml"] = 783,
    ["Spack definitions.yaml"] = 784,
    ["Spack develop.yaml"] = 785,
    ["Spack env_vars.yaml"] = 786,
    ["Spack environment"] = 792,
    ["Spack include.yaml"] = 787,
    ["Spack mirrors.yaml"] = 788,
    ["Spack modules.yaml"] = 789,
    ["Spack packages.yaml"] = 790,
    ["Spack repos.yaml"] = 791,
    ["Spack toolchains.yaml"] = 793,
    ["Spack upstreams.yaml"] = 794,
    ["Spack view.yaml"] = 795,
    ["Speakeasy Generation Config File"] = 799,
    ["Speakeasy Lint Configuration File"] = 796,
    ["Speakeasy Test Generation Configuration File"] = 797,
    ["Speakeasy Workflow File"] = 798,
    SpecIF = 800,
    ["Specmatic Configuration"] = 801,
    ["Sponge Mixin configuration"] = 802,
    StackBlitz = 808,
    ["StackHawk Scanner Configuration"] = 995,
    Stale = 809,
    Starfish = 810,
    ["Starlake Data Pipeline"] = 968,
    Starship = 811,
    ["Statamic Blueprint"] = 812,
    ["Stella configuration file"] = 813,
    ["Streamlit configuration file"] = 814,
    ["Stryker Mutator"] = 817,
    ["StyleCop Analyzers Configuration"] = 818,
    ["Stylelint (.stylelintrc)"] = 819,
    ["Stylua Config"] = 1181,
    ["Sublime Syntax"] = 1042,
    ["Subsquid squid manifest"] = 1089,
    ["Swagger API 2.0"] = 821,
    ["Synadia Connect Component"] = 822,
    TSON = 858,
    TSTyche = 859,
    ["TYPO3 Vendor Bundler config"] = 864,
    ["Tab data for a LinUtil"] = 1137,
    ["Tab list for a LinUtil"] = 1136,
    Tach = 823,
    ["Tach Domain"] = 824,
    Talhelper = 826,
    ["Talisman configuration"] = 827,
    Taplo = 1182,
    ["Taskfile config"] = 973,
    Taurus = 828,
    Tauticord = 829,
    ["Tekton Pipeline"] = 1210,
    ["Tekton PipelineRun"] = 1211,
    ["Tekton Task"] = 1208,
    ["Tekton TaskRun"] = 1209,
    Telefonistka = 1168,
    ["Terrateam config"] = 1194,
    ["TestEnvironment.json"] = 841,
    ["TextMate Grammar"] = 840,
    Threagile = 835,
    ["Tier.run pricing.json"] = 832,
    Tikibase = 833,
    Tombi = 838,
    ["Traefik v2"] = 844,
    ["Traefik v2 File Provider"] = 845,
    ["Traefik v3"] = 846,
    ["Traefik v3 File Provider"] = 847,
    ["Travis CI (.travis.yml)"] = 843,
    Treefmt = 412,
    Trident = 1164,
    ["TrueScript for *.tscript files"] = 850,
    ["Tugboat QA config.yml"] = 1161,
    TunnelHub = 1077,
    Turborepo = 842,
    Tycho = 1126,
    Tye = 1003,
    ["Tyk Gateway - Open Source v5.7+"] = 1173,
    ["UET BuildConfig.json"] = 1047,
    ["UI5 Manifest"] = 870,
    ["UNCORS configuration"] = 874,
    ["UTAM Page Object"] = 873,
    ["Ubuntu Server Autoinstall"] = 868,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1165,
    ["Uniswap Token List"] = 955,
    ["Universal Schedule Format"] = 875,
    ["Unreal Engine Uplugin"] = 1048,
    ["Unreal Engine Uproject"] = 1049,
    ["UpCloud CLI (upctl) configuration"] = 1166,
    ["Updatecli Compose"] = 1011,
    ["Updatecli Policy Manifest"] = 1012,
    ["Updatecli Policy Metadata"] = 1013,
    Uplift = 1045,
    ["Upsun config"] = 4,
    ["User Journey Map"] = 977,
    V2Ray = 1017,
    ["VSCode Code Snippets"] = 241,
    ["VSIX CLI publishing"] = 893,
    Vector = 877,
    ["Vela Pipeline Configuration"] = 880,
    Vercel = 240,
    ["Version Bumper config"] = 883,
    Vespertide = 1215,
    ["Vespertide Migration"] = 1216,
    ["Vespertide Model"] = 1217,
    ["Viash Component Config"] = 1170,
    ["Viash Package Config"] = 1171,
    Visivo = 1075,
    ["WP-CLI"] = 903,
    Wake = 1163,
    ["Waku Config"] = 1140,
    ["Web App Manifest"] = 899,
    ["Web types"] = 902,
    WebExtensions = 898,
    ["Webman package recipe"] = 1023,
    ["Windows Package Manager Installer Manifest"] = 951,
    ["Windows Package Manager Locale Manifest"] = 952,
    ["Windows Package Manager Singleton Manifest"] = 950,
    Winutil = 953,
    ["WireMock CLI import configuration"] = 1146,
    ["WireMock CLI local service configuration"] = 1145,
    ["WireMock message stub mapping"] = 1144,
    ["WireMock stub mapping"] = 1143,
    ["Woodpecker pipeline config"] = 991,
    ["Wrangler CLI"] = 904,
    ["Xstate Machine"] = 1009,
    ["Yandex Workflow Language"] = 1132,
    ["Yarn Config (.yarnrc.yml)"] = 966,
    ["Yippee-Ki-JSON configuration YML"] = 957,
    ["YouTrack App"] = 1129,
    ["Zarf Package Configuration"] = 1196,
    ["Zerops.io config"] = 1117,
    ["Zerops.io import"] = 1118,
    ["Zola Configuration"] = 1207,
    ["aerleon.yml"] = 17,
    ["amplify.yml"] = 10,
    ["angular.json"] = 34,
    apko = 1080,
    ...
    ["behat.yml"] = 136,
    ["bigquery-table"] = 125,
    ["bioimageio resource description"] = 1097,
    ...
    ["chutzpah.json"] = 249,
    cibuildwheel = 171,
    ["clang-format (.clang-format)"] = 1015,
    ["clang-tidy"] = 227,
    clangd = 226,
    clib = 228,
    ...
    ["crowdin.yml"] = 275,
    ["ctfd-setup configuration file"] = 1153,
    ["custom-elements.json"] = 1067,
    ["cypress.json"] = 279,
    ...
    ["gematik health care insurance list"] = 1159,
    ["gematik health care patient list"] = 1156,
    ["gematik health care provider institution list"] = 1158,
    ["gematik health care provider list"] = 1157,
    ["gematik tiger test environment configuration"] = 1160,
    ["git-town.toml"] = 1205,
    ["gitlab-ci"] = 387,
    ["global.json"] = 403,
    ...
    ["lint-staged (.lintstagedrc)"] = 920,
    ["local.settings.json"] = 514,
    ["localazy.json"] = 515,
    ["lotus.yaml"] = 513,
    ["lsdlschema.json"] = 516,
    ["macro.json"] = 1032,
    ["markdown-link-check"] = 986,
    maturin = 987,
    mboats = 994,
    ["micro-settings.json"] = 1059,
    ["mimetypes.json"] = 530,
    ["mirrord config"] = 922,
    mise = 923,
    ["mkdocs.yml"] = 550,
    ...
    ["monospace.yml"] = 554,
    ["moon.yml"] = 1142,
    ["mprocs Configuration file"] = 1113,
    ["mrdocs.yml"] = 551,
    ["mta.yaml"] = 924,
    ["mtad.yaml"] = 925,
    ["mycode.json"] = 561,
    ...
    oxlint = 1229,
    ["package.json"] = 625,
    ["package.manifest"] = 627,
    ["package.yaml"] = 626,
    ["partial-black.json"] = 137,
    ["pathfinder.yml"] = 630,
    ["pattern.json"] = 633,
    ["petstore-v1.0"] = 1039,
    pgap_yaml_input_reader = 632,
    pgxgen = 1222,
    pitcms = 1225,
    ["pixi.toml"] = 634,
    ["plagiarize-me.yaml"] = 638,
    ["plagiarize.yaml"] = 637,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1149,
    ["podbard.yaml"] = 640,
    ["portman.json"] = 643,
    ["prefect.toml"] = 651,
    ["prefect.yaml"] = 652,
    ...
    ["prettierrc.json"] = 654,
    ["prisma.yml"] = 655,
    ["project-1.0.0-beta3.json"] = 667,
    ["project-1.0.0-beta4.json"] = 668,
    ["project-1.0.0-beta5.json"] = 669,
    ["project-1.0.0-beta6.json"] = 670,
    ["project-1.0.0-beta8.json"] = 671,
    ["project-1.0.0-rc1.json"] = 672,
    ["project-1.0.0-rc2.json"] = 673,
    ["project.json"] = 666,
    ["project.owasp.yaml"] = 674,
    ["prometheus-alertmanager.json"] = 678,
    ["prometheus.json"] = 675,
    ["prometheus.rules.json"] = 676,
    ["prometheus.rules.test.json"] = 677,
    ["proxies.json"] = 679,
    ["publiccode.yml"] = 680,
    ["pubspec.yaml"] = 681,
    ["pyrseas-0.8.json"] = 684,
    pytest = 693,
    ["quilt.mod.json"] = 1060,
    ["rc3 auth"] = 699,
    ["rc3 collection"] = 700,
    ...
    ["release drafter"] = 938,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 709,
    ["release-please-manifest.json"] = 710,
    ["release-plz.toml"] = 711,
    ["renv.lock"] = 723,
    ["rivet.json"] = 1084,
    ["rivet.yaml (legacy)"] = 1083,
    rumdl = 728,
    runny = 727,
    rustfmt = 729,
    sake = 1176,
    samt = 731,
    samtrc = 732,
    ["sarif-1.0.0.json"] = 734,
    ["sarif-2.0.0.json"] = 735,
    ["sarif-2.1.0"] = 745,
    ["sarif-2.1.0-rtm.2"] = 736,
    ["sarif-2.1.0-rtm.3"] = 738,
    ["sarif-2.1.0-rtm.4"] = 740,
    ["sarif-2.1.0-rtm.5"] = 742,
    ["sarif-2.1.0-rtm.6"] = 743,
    ["sarif-external-property-file-2.1.0"] = 746,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 737,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 739,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 741,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 744,
    ["scalingo.json configuration"] = 747,
    ["schema.org - Action"] = 749,
    ["schema.org - ContactPoint"] = 750,
    ["schema.org - Place"] = 751,
    ["schema.org - Thing"] = 752,
    ["secrethub.yml"] = 1062,
    ["semantic-release"] = 758,
    ["servicehub.config.json"] = 915,
    ["servicehub.service.json"] = 914,
    ["settings.job"] = 761,
    ["sfdx-hardis configuration"] = 763,
    ["shard.yml"] = 1100,
    ["size-limit configuration"] = 768,
    ["skaffold.yaml"] = 984,
    ["skyuxconfig.json"] = 770,
    ["snowflake-config"] = 772,
    ["snowflake-connections"] = 773,
    ["spicepod.yaml"] = 1121,
    ["sqlc configuration"] = 805,
    ["stripe-app-local.json"] = 816,
    ["stripe-app.json"] = 815,
    swcrc = 969,
    ["task.json"] = 825,
    taskcat = 933,
    ["template.json"] = 830,
    ["templatsources.json"] = 831,
    ["text2confl config"] = 1230,
    ["theme.json"] = 834,
    ["tizen_workspace.json"] = 836,
    tldr = 837,
    ["tm_devices configuration file"] = 1187,
    tmuxinator = 918,
    tox = 839,
    ["transcend.yml"] = 848,
    ...
    ["vega-lite.json"] = 879,
    ["vega.json"] = 878,
    ["venvironment.yaml"] = 881,
    ["venvplus.yaml"] = 882,
    version = 1169,
    ["version.json"] = 884,
    ["vhwdebugger-binding.yaml"] = 886,
    ["vim-addon-info"] = 887,
    ["vs-2017.3.host.json"] = 889,
    ["vs-nesting.json"] = 890,
    ["vsls.json"] = 888,
    ["vss-extension.json"] = 894,
    vtcfg = 1175,
    ["vtesttree.yaml"] = 895,
    ["vtestunit.yaml"] = 896,
    ["warp-keysets.json"] = 1068,
    ["warp-themes.json"] = 1069,
    ["warp-workflows.json"] = 1070,
    ["webhint.io"] = 1024,
    ["webjobpublishsettings.json"] = 901,
    ["webjobs-list.json"] = 900,
    ["well-known-fursona"] = 1108,
    ["xs-app.json"] = 928,
    ["xunit.runner.json"] = 913,
    yamllint = 956,
    zizmor = 1212,
    zuul = 939,
    ["Žinoma"] = 949
