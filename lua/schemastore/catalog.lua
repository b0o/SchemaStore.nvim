...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1029,
    [".nodehawkrc"] = 655,
    [".npmpackagejsonlintrc"] = 660,
    [".omletrc"] = 1210,
    [".phrase.yml"] = 738,
    [".phraseapp.yml"] = 739,
    [".pmbot.yml"] = 723,
    [".postcssrc"] = 732,
    [".powerpages-web-template-manifest"] = 734,
    [".pre-commit-config.yml"] = 735,
    [".pre-commit-hooks.yml"] = 736,
    [".putout.json"] = 772,
    [".rehyperc"] = 797,
    [".remarkrc"] = 801,
    [".sprite files"] = 899,
    ...
    AIConfig = 45,
    ["AMX Muse Program Descriptor"] = 1259,
    ["API Builder"] = 1065,
    ["AVA Configuration"] = 1129,
    ...
    ["AWS Copilot Manifest"] = 1298,
    ["AWS SAM CLI Samconfig"] = 289,
    Acton = 1349,
    ["Adobe UXP Manifest"] = 1192,
    ["Aerleon Network & Service Definitions"] = 27,
    ["Aerleon Policy"] = 28,
    ["Agent Permission Policy"] = 1338,
    ["AgentCore CLI"] = 1339,
    AgentLoopKit = 1340,
    Aider = 1288,
    Air = 30,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1309,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1308,
    ["Airlock Microgateway"] = 46,
    ["Alacritty Configuration"] = 1101,
    ["AlgoVoi Compliance Receipt v1"] = 16,
    ["All Contributors configuration file"] = 1155,
    ...
    ["Application list for a WinUtil"] = 1238,
    ArchitectFX = 1243,
    ["Argo CD"] = 65,
    ["Argo Events"] = 66,
    ["Argo Workflows"] = 67,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1307,
    ["Azure IoT Operations connector metadata"] = 1304,
    ...
    ["Azure Pipelines"] = 125,
    ["Azure Static Web Apps CLI configuration file"] = 903,
    ["Azure Static Web Apps configuration file"] = 902,
    BMML = 1326,
    ["BOSH BPM Config"] = 151,
    ["BOSH CPI Config"] = 152,
    ...
    ["Bacon config"] = 10,
    ["Barba-CV"] = 94,
    ["Bashly (bashly.yml)"] = 1159,
    ["Bashly Settings (bashly-settings.yml)"] = 1160,
    Bento = 1325,
    ["Better Code Hub"] = 1070,
    ["Better Scripts"] = 175,
    Bigconfig = 144,
    ["Biome Formatter Config"] = 95,
    ["Bitmovin Encoding Template"] = 1252,
    BizTalkServerApplicationSchema = 1036,
    Bleep = 176,
    ["Block Protocol Metadata"] = 173,
    ["Bluebricks blueprint config"] = 1331,
    ["Boyka Framework"] = 154,
    ...
    ["Butane Config"] = 1114,
    C4InterFlow = 1267,
    ["CDK Environment Manager, concrete environment configuration"] = 1291,
    ["CDK Environment Manager, concrete environments definition"] = 1290,
    ["CDK Environment Manager, environment definition"] = 1289,
    ["CGS Card Game Specification (cgs.json)"] = 1197,
    ["CICS TS region tagging"] = 1123,
    ["CICS TS resource import"] = 1124,
    ["CICS TS resource model"] = 1125,
    ["CICS TS resource overrides"] = 1126,
    ["CMake Presets"] = 177,
    ["CNC Codes"] = 199,
    ["CRS WAF test file"] = 1227,
    ["CRS WAF test platform overrides file"] = 1228,
    ...
    ["Caido Proxy Configuration"] = 1363,
    ...
    ["Chamaleon environment"] = 1256,
    ["Chamaleon properties"] = 1257,
    ["Chamaleon template"] = 1255,
    Changepacks = 1318,
    Changesets = 298,
    Changie = 186,
    Charmcraft = 187,
    ...
    ["Clawject config"] = 205,
    ["Cloud Foundry Application Manifest"] = 1209,
    ["Cloud Run Spec v1"] = 1233,
    ...
    Concord = 1226,
    ["Configu .cfgu files"] = 1214,
    ["Configu .configu file"] = 1215,
    Conjure = 198,
    ["Container Structure Test"] = 1050,
    Containerlab = 1079,
    ["Contextive Glossary"] = 1283,
    ContractGuard = 1080,
    Convex = 197,
    ...
    ["Cursor Agent Environment"] = 1336,
    ["Custom Machinery Machine"] = 1198,
    ["Custom Machinery Recipe"] = 1199,
    ...
    ["DonateCaseBetterCasino menu"] = 1260,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1167,
    ["EAS config"] = 399,
    ["ECA - Editor Code Assistant"] = 362,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1156,
    ["ESLint Suppressions"] = 404,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1303,
    ["EasyVCR .NET"] = 401,
    ["Eidolon Resource"] = 1244,
    ...
    ["Envelope Team Definition"] = 1348,
    ["Envilder Map File"] = 367,
    ["Erda Pipeline"] = 1205,
    ["Erda Runtime"] = 1206,
    ["Espanso config.yml"] = 1329,
    ["Espanso match.yml"] = 1328,
    Esquio = 387,
    ["Estuary Flow Catalog"] = 1120,
    ["Ethereum ERC1155"] = 1342,
    ["Ethereum ERC721"] = 1341,
    ...
    ["Evolving Resolutive Process notation"] = 1305,
    ["Expo SDK"] = 398,
    ...
    ["GeoJSON.json latest"] = 1118,
    GherKing = 1122,
    ["GitHub Action"] = 439,
    ["GitHub Actions typing"] = 1240,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 1194,
    GitResume = 451,
    GitVersion = 434,
    ...
    ["Google Digital Assetlinks"] = 1284,
    Goreleaser = 470,
    ["Goreleaser Pro"] = 471,
    Goss = 473,
    ["Gradle Build Cache Node"] = 1068,
    ["Gradle Enterprise"] = 1067,
    ...
    Hadolint = 1046,
    Hammerkit = 1078,
    ["Hardware Sentry Configuration"] = 1134,
    ...
    ["Hecate Input Schema"] = 1295,
    ["Helm Chart.lock"] = 247,
    ["Helm Chart.yaml"] = 246,
    ["Helm Unittest Test Suite"] = 248,
    ["Heloisa Assistant Plugins Marketplace"] = 1370,
    ["Hex file"] = 249,
    ...
    ["JFrog File Spec"] = 528,
    ["JFrog Pipelines YML DSL"] = 1144,
    ["JMeter DSL cli config"] = 529,
    JReleaser = 532,
    ["JSON Document Transform"] = 540,
    ["JSON Feed"] = 541,
    ["JSON Resume"] = 809,
    ["JSON Schema Draft 2020-12"] = 1012,
    ["JSON Schema Draft 4"] = 1009,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1177,
    ["JSON Schema Draft 7"] = 1010,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1178,
    ["JSON Schema Draft 8 (2019-09)"] = 1011,
    ["JSON-API"] = 539,
    ["JSON-e templates"] = 1075,
    ["JSON-stat 2.0"] = 1005,
    JSONPatch = 543,
    ...
    ["Jujutsu (jj) VCS config"] = 1297,
    ["KIMMDY config file"] = 554,
    ["KODE/CI build.yaml"] = 1140,
    ["KSP-AVC"] = 1006,
    ["KSP-CKAN"] = 1007,
    ["KSP-NetKAN"] = 1008,
    KSY = 1207,
    ...
    ["Lando (landofile)"] = 121,
    ["LangGraph Platform configuration"] = 1219,
    ["Language configuration"] = 1218,
    Lefthook = 571,
    ["Liferay client-extension.yaml"] = 578,
    ["LinkML Metamodel"] = 580,
    Liquibase = 1085,
    ["Liquibase Flow File"] = 1086,
    ["Lively Properties"] = 581,
    ["Lobe AI Agent"] = 123,
    Loki = 124,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 625,
    ["MS2Rescore Configuration"] = 632,
    ["MSTest testconfig.json"] = 633,
    ["Madge configuration"] = 588,
    ["Madness (madness.yml)"] = 1158,
    ["Mado configuration"] = 589,
    ["Maestro Flow"] = 590,
    ["Mail Servers Configuration"] = 1332,
    ["MapEHR Mapping"] = 591,
    Markdownlint = 1089,
    ["Mason Registry"] = 1092,
    ...
    ["Mergify Configuration"] = 634,
    ["Mermaid config"] = 1,
    ["Metadata for a Bazel module"] = 597,
    ["Metadata for a Cinnamon spice"] = 1236,
    ["Metatype Configuration"] = 598,
    ["MetricsHub Configuration"] = 599,
    ["MetricsHub Connector Configuration"] = 600,
    ["Micro Editor Syntax"] = 1168,
    ["Microsoft Band Web Tile"] = 601,
    ["Microsoft RulesEngine workflow rules"] = 1223,
    ["Microsoft RulesEngine workflow rules list"] = 1224,
    ["Minecraft Custom Main Menu Mod"] = 1186,
    ...
    ["MockServer Expectations"] = 627,
    ModuleAssembler = 623,
    ["Monade CLI Stack Configuration"] = 637,
    ["MongoDB Atlas Search Index Definition"] = 1139,
    ["Monika Configuration"] = 1137,
    ["Monoweave Configuration"] = 631,
    ["Motif config"] = 1028,
    MultiQC = 1277,
    ["NOX Framework (Service)"] = 659,
    ["Netin Diagnostic System Template"] = 1096,
    ["Netlify config"] = 640,
    ["Network-as-Code Data Model"] = 641,
    ["Next Gen UI Agent A2A Server Configuration"] = 642,
    ["Next Gen UI Agent Configuration"] = 644,
    ["Next Gen UI Agent MCP Server Configuration"] = 643,
    ["Nightwatch.js"] = 651,
    ["Nika workflow"] = 656,
    ["Node.js configuration"] = 1033,
    ["NueJS configuration file"] = 664,
    ["Nuitka Package Config"] = 1200,
    ["Nullstone config"] = 666,
    ["OKF Graph"] = 1371,
    ["ONe's changelog entry"] = 685,
    ["ONe's service descriptor"] = 684,
    ["ORT Server repository environment configuration"] = 695,
    ["OSCAL Assessment Plan (AP)"] = 697,
    ["OSCAL Assessment Results (AR)"] = 698,
    ["OSCAL Catalog"] = 699,
    ["OSCAL Component Definition (CDef)"] = 700,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 701,
    ["OSCAL Profile"] = 702,
    ["OSCAL System Security Plan (SSP)"] = 703,
    ["OSS Review Toolkit configuration"] = 704,
    ["OSS Review Toolkit curation"] = 705,
    ["OSS Review Toolkit package configuration"] = 706,
    ["OSS Review Toolkit project package manager definition"] = 707,
    ["OSS Review Toolkit repository configuration"] = 708,
    ["OSS Review Toolkit resolutions"] = 709,
    ["October CMS columns"] = 670,
    ["October CMS fields"] = 671,
    ["Oh My Posh"] = 673,
    Okteto = 674,
    ["Ona Automations"] = 676,
    Opctl = 1031,
    ["Open Data Contract Standard (ODCS)"] = 689,
    ["Open Data Product Standard (ODPS)"] = 690,
    ["Open Know-How"] = 1282,
    OpenDecree = 1346,
    ["OpenDecree Configuration"] = 1347,
    ["OpenRewrite Resource"] = 687,
    OpenSRM = 691,
    OpenStatus = 1293,
    ["OpenTelemetry Declarative Configuration"] = 688,
    ["OpenUtau character yaml"] = 681,
    ["OpenUtau ustx"] = 682,
    ["OpenWeather Current Weather API"] = 1074,
    ["OpenWeather Road Risk API"] = 1073,
    ["Ory Hydra configuration"] = 499,
    ["Ory Keto configuration"] = 562,
    ["Ory Kratos configuration"] = 696,
    ["Ory Oathkeeper configuration"] = 668,
    ["Outblocks App configuration"] = 693,
    ["Outblocks database table"] = 694,
    ["Outblocks project configuration"] = 692,
    PDM = 717,
    POPxf = 729,
    ["POPxf Correlations"] = 730,
    ["PRML manifest"] = 737,
    Packer = 713,
    PactSpec = 714,
    Panache = 715,
    Pantsbuild = 1154,
    ["Paper paper-plugin.yml"] = 716,
    ["Pipeline component"] = 1087,
    ["Platform.sh application"] = 12,
    ["Platform.sh routes"] = 13,
    ["Platform.sh services"] = 14,
    ["Plex Prerolls"] = 727,
    ["PocketMine plugin.yml"] = 724,
    ["Podman Desktop Extension"] = 1365,
    ["Postman collection"] = 733,
    ["Power Pages Configuration"] = 1294,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1239,
    ["ProActions AI-Kit Configuration"] = 745,
    ["ProActions AI-Kit Configuration for Menus"] = 747,
    ["ProActions AI-Kit Configuration for Sections"] = 749,
    ["ProActions AI-Kit Configuration for Services"] = 746,
    ["ProActions AI-Kit Configuration for Steps"] = 750,
    ["ProActions AI-Kit Configuration for Templates"] = 748,
    ["Problem object RFC9457"] = 1183,
    ["Problem package format"] = 751,
    ["Problem package generators"] = 752,
    ["Problem package submissions"] = 753,
    ["Problem package test group metadata"] = 754,
    Pterodactyl = 1133,
    ["Pull Request Labeler"] = 771,
    Pulumi = 779,
    ["PyGTA Config"] = 775,
    PyProject = 780,
    Pylock = 1285,
    Pyright = 781,
    ["Python script metadata"] = 1279,
    ["QType AI DSL"] = 784,
    Qgoda = 783,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1357,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1355,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1361,
    ["Qlik Talend Cloud Pipeline - Project"] = 1353,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1356,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1358,
    ["Qlik Talend Cloud Pipeline - Task"] = 1354,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1360,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1359,
    Qodana = 1106,
    ["Qt Creator workspace file"] = 1216,
    ["Quali Torque Blueprint Spec 2"] = 1131,
    ["QueryFirst config file"] = 1150,
    ["QuikRun Configuration"] = 1362,
    ["Qwen Code Settings"] = 1343,
    ["RKE Cluster Configuration JSON"] = 1084,
    ["RKE Cluster Configuration YAML"] = 1083,
    RadioHound = 774,
    ["Raid Profile"] = 1344,
    ["Raid Repo Configuration"] = 1345,
    Railpack = 786,
    Railway = 785,
    ["Rancher Fleet"] = 776,
    ["Rattler-build"] = 787,
    Ray = 1045,
    ["Read the Docs"] = 778,
    ["Red-DiscordBot Cog"] = 794,
    ["Red-DiscordBot Cog Repo"] = 795,
    ["Red-DiscordBot Trivia"] = 796,
    ["Releasaurus Config"] = 9,
    ReleaseKit = 8,
    ["Render Blueprints"] = 1082,
    RenderCV = 813,
    Renovate = 810,
    ["Renovate global configuration"] = 811,
    ["Renovate inherited configuration"] = 812,
    ["Replit config"] = 802,
    Restate = 1272,
    ["Revel Digital Gadget Definition File"] = 1296,
    RoadRunner = 815,
    ["Robust Station Image"] = 1302,
    Rockcraft = 816,
    ["Roo Coder Custom Modes"] = 817,
    Rubocop = 806,
    ["Rudder techniques"] = 1190,
    Ruff = 807,
    ["Rust Project"] = 808,
    ["Rust toolchain"] = 822,
    ["SDMX data message"] = 849,
    ["SDMX metadata message"] = 848,
    ["SDMX structure message"] = 847,
    ["SIL Kit Participant Configuration"] = 860,
    ["SIL Kit Registry Configuration"] = 861,
    ["SPDX 2.3"] = 900,
    SWADL = 916,
    ["Safebox Config"] = 1145,
    ["Sapphire CLI Config"] = 825,
    ["SauceCTL Configuration"] = 1093,
    Scarb = 845,
    ["Schema Catalog"] = 840,
    ["Scoop manifest"] = 846,
    ["Secure SDLC Evidence Bundle"] = 850,
    ["Semantic Data Fabric (SDF) file"] = 851,
    ["Semgrep Rule"] = 853,
    ["Serenity Code Generator (Sergen)"] = 854,
    ["Serverless Framework Configuration"] = 1100,
    ["Serverless Workflow"] = 1102,
    ["Settings for a Cinnamon spice"] = 1235,
    ["Settings.paf"] = 856,
    ["Shopware 6 Configuration"] = 1103,
    ["Shopware CLI Extension Store Configuration"] = 1104,
    ["Shopware CLI Project Store Configuration"] = 1105,
    ["Sigma Detection Rule"] = 858,
    ["SigmaCV CV"] = 4,
    ["Sigrid scope configuration file"] = 859,
    ["SkyPilot Task JSON"] = 1191,
    ["Slack app manifest"] = 863,
    ["Slang Server Configuration"] = 1369,
    Snapcraft = 865,
    ["Solarxy project config"] = 868,
    Solidarity = 869,
    ["Solution filters"] = 870,
    ["Source Maps v3"] = 871,
    Sourcery = 872,
    ["Spack bootstrap.yaml"] = 873,
    ["Spack cdash.yaml"] = 874,
    ["Spack ci.yaml"] = 875,
    ["Spack compilers.yaml"] = 876,
    ["Spack concretizer.yaml"] = 877,
    ["Spack config.yaml"] = 878,
    ["Spack definitions.yaml"] = 879,
    ["Spack develop.yaml"] = 880,
    ["Spack env_vars.yaml"] = 881,
    ["Spack environment"] = 887,
    ["Spack include.yaml"] = 882,
    ["Spack mirrors.yaml"] = 883,
    ["Spack modules.yaml"] = 884,
    ["Spack packages.yaml"] = 885,
    ["Spack repos.yaml"] = 886,
    ["Spack toolchains.yaml"] = 888,
    ["Spack upstreams.yaml"] = 889,
    ["Spack view.yaml"] = 890,
    ["Speakeasy Generation Config File"] = 894,
    ["Speakeasy Lint Configuration File"] = 891,
    ["Speakeasy Test Generation Configuration File"] = 892,
    ["Speakeasy Workflow File"] = 893,
    SpecIF = 895,
    ["Specmatic Configuration"] = 896,
    ["Specpin spec file"] = 2,
    ["Sponge Mixin configuration"] = 897,
    ["Spotlight Ruleset"] = 898,
    StackBlitz = 904,
    ["StackHawk Scanner Configuration"] = 1099,
    Stale = 905,
    Starfish = 906,
    ["Starlake Data Pipeline"] = 1071,
    Starship = 907,
    ["Statamic Blueprint"] = 908,
    ["Stella configuration file"] = 909,
    ["Streamlit configuration file"] = 910,
    ["Stryker Mutator"] = 913,
    ["StyleCop Analyzers Configuration"] = 914,
    ["Stylelint (.stylelintrc)"] = 915,
    ["Stylua Config"] = 1286,
    ["Sublime Syntax"] = 1146,
    ["Subsquid squid manifest"] = 1193,
    ["Swagger API 2.0"] = 917,
    ["Synadia Connect Component"] = 918,
    TSON = 955,
    TSTyche = 956,
    ["TYPO3 Vendor Bundler config"] = 962,
    ["Tab data for a LinUtil"] = 1242,
    ["Tab list for a LinUtil"] = 1241,
    Tach = 919,
    ["Tach Domain"] = 920,
    Talhelper = 922,
    ["Talisman configuration"] = 923,
    Taplo = 1287,
    ["Taskfile config"] = 1076,
    Taurus = 924,
    Tauticord = 925,
    ["Tekton Pipeline"] = 1315,
    ["Tekton PipelineRun"] = 1316,
    ["Tekton Task"] = 1313,
    ["Tekton TaskRun"] = 1314,
    Telefonistka = 1273,
    ["Terrateam config"] = 1299,
    ["TestEnvironment.json"] = 937,
    ["TextMate Grammar"] = 936,
    Threagile = 931,
    ["Tier.run pricing.json"] = 928,
    Tikibase = 929,
    Tombi = 934,
    ["Traefik v2"] = 940,
    ["Traefik v2 File Provider"] = 941,
    ["Traefik v3"] = 942,
    ["Traefik v3 File Provider"] = 943,
    ["Travis CI (.travis.yml)"] = 939,
    Treefmt = 476,
    Trident = 1269,
    Trivy = 946,
    ["TrueScript for *.tscript files"] = 947,
    ["Tugboat QA config.yml"] = 1266,
    TunnelHub = 1181,
    Turborepo = 938,
    Tycho = 1230,
    Tye = 1107,
    ["Tyk Gateway - Open Source v5.7+"] = 1278,
    ["UET BuildConfig.json"] = 1151,
    ["UI5 Manifest"] = 968,
    ["UNCORS configuration"] = 973,
    ["UTAM Page Object"] = 971,
    ["Ubuntu Server Autoinstall"] = 966,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1270,
    ["Uniswap Token List"] = 1056,
    ["Universal Schedule Format"] = 974,
    ["Unreal Engine Uplugin"] = 1152,
    ["Unreal Engine Uproject"] = 1153,
    ["UpCloud CLI (upctl) configuration"] = 1271,
    ["Updatecli Compose"] = 1115,
    ["Updatecli Policy Manifest"] = 1116,
    ["Updatecli Policy Metadata"] = 1117,
    Uplift = 1149,
    ["Upsun config"] = 11,
    ["User Journey Map"] = 1081,
    V2Ray = 1121,
    ["VSCode Code Snippets"] = 273,
    ["VSIX CLI publishing"] = 992,
    Vector = 976,
    ["Vela Pipeline Configuration"] = 979,
    Vercel = 272,
    ["Version Bumper config"] = 982,
    Vespertide = 1320,
    ["Vespertide Migration"] = 1321,
    ["Vespertide Model"] = 1322,
    ["Viash Component Config"] = 1275,
    ["Viash Package Config"] = 1276,
    Visivo = 1179,
    ["WP-CLI"] = 1002,
    Wake = 1268,
    ["Waku Config"] = 1245,
    ["Web App Manifest"] = 998,
    ["Web types"] = 1001,
    WebExtensions = 997,
    ["Webman package recipe"] = 1127,
    ["Windows Package Manager Installer Manifest"] = 1053,
    ["Windows Package Manager Locale Manifest"] = 1054,
    ["Windows Package Manager Singleton Manifest"] = 1052,
    ["WireMock CLI import configuration"] = 1251,
    ["WireMock CLI local service configuration"] = 1250,
    ["WireMock message stub mapping"] = 1249,
    ["WireMock stub mapping"] = 1248,
    ["Woodpecker pipeline config"] = 1095,
    ["Wrangler CLI"] = 1003,
    ["XenForo add-on manifest"] = 1004,
    ["Xstate Machine"] = 1113,
    ["Yandex Workflow Language"] = 1237,
    ["Yarn Config (.yarnrc.yml)"] = 1069,
    ["Yippee-Ki-JSON configuration YML"] = 1060,
    ["YouTrack App"] = 1234,
    ["Zarf Package Configuration"] = 1301,
    ["Zerops import file"] = 1222,
    ["Zola Configuration"] = 1312,
    abtop = 32,
    actionlint = 42,
    ["aerleon.yml"] = 26,
    ["amplify.yml"] = 19,
    ["amxx-builder manifest"] = 1364,
    ["angular.json"] = 47,
    apko = 1184,
    ...
    ["behat.yml"] = 155,
    ["bigquery-table"] = 143,
    ["bioimageio resource description"] = 1201,
    ...
    ["cargo-nextest repository configuration"] = 645,
    ["cargo-nextest user configuration"] = 646,
    ["ccmod.json"] = 1246,
    changelogging = 1213,
    ...
    ["chutzpah.json"] = 281,
    cibuildwheel = 192,
    ["clang-format (.clang-format)"] = 1119,
    ["clang-tidy"] = 255,
    clangd = 254,
    clib = 256,
    ...
    ["crowdin.yml"] = 308,
    ["ctfd-setup configuration file"] = 1258,
    ["custom-elements.json"] = 1171,
    ["cypress.json"] = 312,
    ["dacier.yml"] = 1352,
    ...
    ["gematik health care insurance list"] = 1264,
    ["gematik health care patient list"] = 1261,
    ["gematik health care provider institution list"] = 1263,
    ["gematik health care provider list"] = 1262,
    ["gematik tiger test environment configuration"] = 1265,
    ["git-cliff"] = 436,
    ["git-town.toml"] = 1310,
    ["gitlab-ci"] = 448,
    ["global.json"] = 465,
    ...
    lychee = 1020,
    ["macro.json"] = 1136,
    ["markdown-link-check"] = 1090,
    maturin = 1091,
    mboats = 1098,
    memnex = 1350,
    ["micro-settings.json"] = 1163,
    ["mimetypes.json"] = 602,
    ["mirrord config"] = 1024,
    ["misata.yaml"] = 1023,
    mise = 1025,
    ["mkdocs.yml"] = 622,
    ["mockd.yaml"] = 626,
    ["mod.pw.toml (packwiz)"] = 1367,
    ["modelparams.dev Model"] = 628,
    ["models CLI"] = 629,
    ["monospace.yml"] = 630,
    ["moon.yml"] = 1247,
    ["mprocs Configuration file"] = 1217,
    ["mrdocs.yml"] = 624,
    ["mta.yaml"] = 1026,
    ["mtad.yaml"] = 1027,
    ["mycode.json"] = 638,
    nFPM = 650,
    ["napari plugin manifest"] = 639,
    neoload = 1039,
    ["nest-cli"] = 653,
    ["nexus-rpc-gen"] = 1337,
    ["nf-core module environment.yml"] = 647,
    ["nf-core module meta.yml"] = 648,
    ["nf-core subworkflow meta.yml"] = 649,
    ["ninjs (News in JSON)"] = 652,
    ["nitro.json"] = 1038,
    ["nixd configuration"] = 1189,
    ["nlu.json"] = 654,
    ["nodemon.json"] = 657,
    ["noodl config"] = 1097,
    ["notebook.mod.json"] = 658,
    now = 1034,
    ["npm-badges"] = 661,
    ["nswag.json"] = 665,
    ntangle = 667,
    ["nuclei-template.yaml"] = 662,
    ["nuget-project.json"] = 663,
    ["ocelot.json"] = 669,
    ogen = 672,
    ["omnisharp.json"] = 675,
    openHAB = 1323,
    ...
    oxfmt = 1333,
    oxlint = 1334,
    ["pack.toml (packwiz)"] = 1368,
    ["package.json"] = 710,
    ["package.manifest"] = 712,
    ["package.yaml"] = 711,
    ["partial-black.json"] = 156,
    ["partial-fastapi.json"] = 157,
    ["partial-pixi.json"] = 722,
    ["partial-scheduled.json"] = 158,
    ["pattern.json"] = 720,
    ["petstore-v1.0"] = 1143,
    pgap_yaml_input_reader = 718,
    pgrls = 719,
    pgxgen = 1327,
    pitcms = 1330,
    ["pixi.toml"] = 721,
    ["plagiarize-me.yaml"] = 726,
    ["plagiarize.yaml"] = 725,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1254,
    ["podbard.yaml"] = 728,
    ["portman.json"] = 731,
    ["prefect.toml"] = 740,
    ["prefect.yaml"] = 741,
    ...
    ["prettierrc.json"] = 743,
    ["prisma.yml"] = 744,
    ["project-1.0.0-beta3.json"] = 756,
    ["project-1.0.0-beta4.json"] = 757,
    ["project-1.0.0-beta5.json"] = 758,
    ["project-1.0.0-beta6.json"] = 759,
    ["project-1.0.0-beta8.json"] = 760,
    ["project-1.0.0-rc1.json"] = 761,
    ["project-1.0.0-rc2.json"] = 762,
    ["project.json"] = 755,
    ["project.owasp.yaml"] = 763,
    ["prometheus-alertmanager.json"] = 767,
    ["prometheus.json"] = 764,
    ["prometheus.rules.json"] = 765,
    ["prometheus.rules.test.json"] = 766,
    ["proxies.json"] = 768,
    ["publiccode.yml"] = 769,
    ["pubspec.yaml"] = 770,
    ["pyrseas-0.8.json"] = 773,
    pytest = 782,
    ["quilt.mod.json"] = 1164,
    ["rc3 auth"] = 788,
    ["rc3 collection"] = 789,
    ...
    ["rc3 settings"] = 793,
    ["registry.yaml"] = 60,
    ["release drafter"] = 1040,
    ["release-hub.json"] = 7,
    ["release-please-config.json"] = 798,
    ["release-please-manifest.json"] = 799,
    ["release-plz.toml"] = 800,
    ["renv.lock"] = 814,
    ["reposets Configuration"] = 803,
    ["reposets Credentials"] = 804,
    ["revola.json"] = 5,
    ["rivet.json"] = 1188,
    ["rivet.yaml (legacy)"] = 1187,
    rumdl = 819,
    runny = 818,
    runspec = 1351,
    rustfmt = 820,
    ...
    samt = 823,
    samtrc = 824,
    ["sarif-1.0.0.json"] = 826,
    ["sarif-2.0.0.json"] = 827,
    ["sarif-2.1.0"] = 837,
    ["sarif-2.1.0-rtm.2"] = 828,
    ["sarif-2.1.0-rtm.3"] = 830,
    ["sarif-2.1.0-rtm.4"] = 832,
    ["sarif-2.1.0-rtm.5"] = 834,
    ["sarif-2.1.0-rtm.6"] = 835,
    ["sarif-external-property-file-2.1.0"] = 838,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 829,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 831,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 833,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 836,
    ["scalingo.json configuration"] = 839,
    ["schema.org - Action"] = 841,
    ["schema.org - ContactPoint"] = 842,
    ["schema.org - Place"] = 843,
    ["schema.org - Thing"] = 844,
    ["secrethub.yml"] = 1166,
    ["semantic-release"] = 852,
    ["servicehub.config.json"] = 1015,
    ["servicehub.service.json"] = 1014,
    ["settings.job"] = 855,
    ["sfdx-hardis configuration"] = 857,
    ["shard.yml"] = 1204,
    ["size-limit configuration"] = 862,
    ["skaffold.yaml"] = 1088,
    ["skyuxconfig.json"] = 864,
    ["snowflake-config"] = 866,
    ["snowflake-connections"] = 867,
    ["spicepod.yaml"] = 1225,
    ["sqlc configuration"] = 901,
    ["stripe-app-local.json"] = 912,
    ["stripe-app.json"] = 911,
    swcrc = 1072,
    ["task.json"] = 921,
    taskcat = 1035,
    ["template.json"] = 926,
    ["templatsources.json"] = 927,
    ["text2confl config"] = 1335,
    ["theme.json"] = 930,
    ["tizen_workspace.json"] = 932,
    tldr = 933,
    ["tm_devices configuration file"] = 1292,
    tmuxinator = 1018,
    tox = 935,
    ["transcend.yml"] = 944,
    ...
    ["vega-lite.json"] = 978,
    ["vega.json"] = 977,
    ["venvironment.yaml"] = 980,
    ["venvplus.yaml"] = 981,
    version = 1274,
    ["version.json"] = 983,
    ["vhwdebugger-binding.yaml"] = 985,
    ["vim-addon-info"] = 986,
    ["vs-2017.3.host.json"] = 988,
    ["vs-nesting.json"] = 989,
    ["vsls.json"] = 987,
    ["vss-extension.json"] = 993,
    vtcfg = 1280,
    ["vtesttree.yaml"] = 994,
    ["vtestunit.yaml"] = 995,
    ["warp-keysets.json"] = 1172,
    ["warp-themes.json"] = 1173,
    ["warp-workflows.json"] = 1174,
    ["webhint.io"] = 1128,
    ["webjobpublishsettings.json"] = 1000,
    ["webjobs-list.json"] = 999,
    ["well-known-fursona"] = 1212,
    ["xs-app.json"] = 1030,
    ["xunit.runner.json"] = 1013,
    yamlfmt = 1057,
    yamllint = 1058,
    ["yap.json"] = 1059,
    ["zerops.yml"] = 1221,
