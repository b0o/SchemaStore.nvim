...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 935,
    [".nodehawkrc"] = 578,
    [".npmpackagejsonlintrc"] = 582,
    [".omletrc"] = 1114,
    [".phrase.yml"] = 656,
    [".phraseapp.yml"] = 657,
    [".pmbot.yml"] = 642,
    [".postcssrc"] = 651,
    [".powerpages-web-template-manifest"] = 653,
    [".pre-commit-config.yml"] = 654,
    [".pre-commit-hooks.yml"] = 655,
    [".putout.json"] = 690,
    [".rehyperc"] = 715,
    [".remarkrc"] = 719,
    [".sprite files"] = 810,
    ...
    AIConfig = 33,
    ["AMX Muse Program Descriptor"] = 1162,
    ["API Builder"] = 970,
    ["AVA Configuration"] = 1033,
    ["AWS AppConfig Feature Flags-v1"] = 67,
    ["AWS CDK cdk.json"] = 258,
    ["AWS CloudFormation"] = 259,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 260,
    ["AWS Copilot Manifest"] = 1201,
    ["AWS SAM CLI Samconfig"] = 261,
    ...
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1211,
    ["Airlock Microgateway"] = 34,
    ["Alacritty Configuration"] = 1005,
    ["All Contributors configuration file"] = 1059,
    ["Ansible Argument Specs"] = 397,
    ["Ansible Collection Galaxy"] = 404,
    ["Ansible Execution Environment"] = 394,
    ["Ansible Inventory"] = 403,
    ["Ansible Meta"] = 395,
    ["Ansible Meta Runtime"] = 396,
    ["Ansible Navigator Configuration"] = 406,
    ["Ansible Playbook"] = 401,
    ["Ansible Requirements"] = 398,
    ["Ansible Rulebook"] = 402,
    ["Ansible Tasks File"] = 400,
    ["Ansible Vars File"] = 399,
    ["Ansible-lint Configuration"] = 405,
    Any = 1124,
    ...
    ["Application list for a WinUtil"] = 1141,
    ArchitectFX = 1146,
    ["Argo CD"] = 53,
    ["Argo Events"] = 54,
    ["Argo Workflows"] = 55,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1210,
    ["Azure IoT Operations connector metadata"] = 1207,
    ...
    ["Azure Pipelines"] = 110,
    ["Azure Static Web Apps CLI configuration file"] = 814,
    ["Azure Static Web Apps configuration file"] = 813,
    BMML = 1229,
    ["BOSH CPI Config"] = 135,
    ["BOSH Deploy Config"] = 136,
    ["BX CI"] = 155,
    ["Bacon config"] = 4,
    ["Barba-CV"] = 81,
    ["Bashly (bashly.yml)"] = 1063,
    ["Bashly Settings (bashly-settings.yml)"] = 1064,
    Bento = 1228,
    ["Better Code Hub"] = 975,
    ["Better Scripts"] = 156,
    Bigconfig = 128,
    ["Biome Formatter Config"] = 82,
    ["Bitmovin Encoding Template"] = 1155,
    BizTalkServerApplicationSchema = 942,
    Bleep = 157,
    ["Block Protocol Metadata"] = 154,
    ["Bluebricks blueprint config"] = 1234,
    ["Boyka Framework"] = 137,
    Briefcase = 948,
    ["Build Info"] = 145,
    Buildkite = 147,
    ["Bukkit plugin.yml"] = 146,
    ["BungeeCord plugin.yml"] = 152,
    ["Butane Config"] = 1018,
    C4InterFlow = 1170,
    ["CDK Environment Manager, concrete environment configuration"] = 1194,
    ["CDK Environment Manager, concrete environments definition"] = 1193,
    ["CDK Environment Manager, environment definition"] = 1192,
    ["CGS Card Game Specification (cgs.json)"] = 1101,
    ["CICS TS region tagging"] = 1027,
    ["CICS TS resource import"] = 1028,
    ["CICS TS resource model"] = 1029,
    ["CICS TS resource overrides"] = 1030,
    ["CMake Presets"] = 158,
    ["CNC Codes"] = 180,
    ["CRS WAF test file"] = 1131,
    ["CRS WAF test platform overrides file"] = 1132,
    ["CSS Comb (.csscomb.json)"] = 286,
    ["CSS Lint (.csslintrc)"] = 287,
    ["CSpell (cspell.json)"] = 285,
    ["CVE Record Format"] = 189,
    CWL = 1107,
    ["Cache Warmup config"] = 159,
    ["Calqulus pipeline"] = 160,
    ["Camel YAML DSL"] = 161,
    ["Cannon TOML"] = 162,
    Carafe = 163,
    ["Cargo Make"] = 165,
    ["Cargo Manifest"] = 164,
    ["Catalog Info Backstage"] = 166,
    ["Chamaleon environment"] = 1159,
    ["Chamaleon properties"] = 1160,
    ["Chamaleon template"] = 1158,
    Changepacks = 1221,
    Changesets = 270,
    Changie = 167,
    Charmcraft = 168,
    Cheatsheets = 1015,
    ["ChordPro Configuration"] = 169,
    ["Chrome Extension"] = 251,
    ["Chromia Model"] = 170,
    ["Chromia Seeder Module Config"] = 172,
    ["Chromia Seeder Root Config"] = 171,
    ["Cinnamon Spice info.json"] = 90,
    ["CircleCI config.yml"] = 226,
    ["Citation File Format"] = 272,
    ["Citrus test case"] = 174,
    CityJSON = 175,
    ["Claude Code Keybindings"] = 187,
    ["Claude Code Settings"] = 188,
    ["Clawject config"] = 186,
    ["Cloud Foundry Application Manifest"] = 1113,
    ["Cloud Run Spec v1"] = 1136,
    ["Cloud.gov Workshop Configuration"] = 91,
    ["CloudCannon Configuration"] = 96,
    ["CloudCannon Configuration (Collection Structures)"] = 105,
    ["CloudCannon Configuration (Collections)"] = 104,
    ["CloudCannon Configuration (Editables)"] = 103,
    ["CloudCannon Configuration (Inputs)"] = 98,
    ["CloudCannon Configuration (Snippets Definitions)"] = 102,
    ["CloudCannon Configuration (Snippets Imports)"] = 101,
    ["CloudCannon Configuration (Snippets)"] = 100,
    ["CloudCannon Configuration (Structure Value)"] = 99,
    ["CloudCannon Configuration (Structures)"] = 97,
    ["CloudEvents specification"] = 176,
    ["Code Climate"] = 227,
    CodeCV = 94,
    CodeRabbit = 93,
    ["CodeShip Pro services configuration files"] = 240,
    ["CodeShip Pro steps configuration files"] = 241,
    ["Codecov configuration files"] = 239,
    Codex = 235,
    CodifyCLI = 95,
    Codux = 237,
    ["Cog config file"] = 181,
    ["Commandbox Box.json"] = 182,
    ["Commandbox Server.json"] = 183,
    ["Common Catalog Data"] = 249,
    ["Common Package Specification"] = 184,
    Concord = 1130,
    ["Configu .cfgu files"] = 1118,
    ["Configu .configu file"] = 1119,
    Conjure = 179,
    ["Container Structure Test"] = 956,
    Containerlab = 984,
    ["Contextive Glossary"] = 1186,
    Convex = 178,
    ["Crowdsec collection config"] = 280,
    ["Crowdsec parser config"] = 281,
    ["Crowdsec scenario config"] = 282,
    ["CumulusCI Config"] = 185,
    ["Cursor Agent Environment"] = 1239,
    ["Custom Machinery Machine"] = 1102,
    ["Custom Machinery Recipe"] = 1103,
    ["Cycle Stack File"] = 190,
    CycloneDX = 191,
    ["DWP Exchange - catalogue entry"] = 331,
    ["DWP Exchange - gateway"] = 329,
    ["DWP Exchange - meta"] = 330,
    ["Dart Build Config (dart-build.json)"] = 288,
    ["Dart Test Config (dart-test.json)"] = 289,
    ["DashLord Configuration"] = 290,
    ["Data Contract Specification"] = 291,
    ["Data Product Specification"] = 292,
    ["DataYoga Connections"] = 192,
    ["DataYoga Job"] = 193,
    ["Databricks Asset Bundles"] = 1080,
    ["Datadog Continuous Testing"] = 495,
    ["Datadog Service Definition"] = 496,
    ["Datadog Software Catalog"] = 497,
    ["Datahub Ingestion Recipe"] = 1034,
    ["Debian Upstream Metadata file"] = 200,
    ["Deck config"] = 201,
    ["DeepMatch deeplinks spec"] = 202,
    ["Dein Config"] = 203,
    ["Deno Config (deno.json)"] = 298,
    ["Dependency cruiser"] = 204,
    ["DeployStack Configuration"] = 205,
    ["Deployah Configuration"] = 1209,
    ["Deployer Recipe"] = 301,
    ["Deta Spacefile"] = 206,
    ["Detekt Config (detekt.yml)"] = 302,
    ["Devbox Config"] = 207,
    ["Devbox Plugin"] = 208,
    Devfile = 328,
    Devup = 1222,
    DipDup = 1133,
    ["Discord Webhook"] = 303,
    ["DocFx Config (docfx.json)"] = 308,
    ["Docker Desktop extension metadata"] = 305,
    ["Docs MCP Manifest"] = 309,
    Dofigen = 310,
    ["Dolittle Artifacts"] = 311,
    ["Dolittle Bounded Context Configuration"] = 312,
    ["Dolittle Event Horizons Configuration"] = 313,
    ["Dolittle Resources Configuration"] = 314,
    ["Dolittle Server Configuration"] = 315,
    ["Dolittle Tenant Map Configuration"] = 317,
    ["Dolittle Tenants Configuration"] = 316,
    ["Dolittle Topology"] = 318,
    ["DonateCaseBetterCasino menu"] = 1163,
    ["Drupal Breakpoints"] = 209,
    ["Drupal Config"] = 221,
    ["Drupal Info"] = 210,
    ["Drupal Layouts"] = 211,
    ["Drupal Libraries"] = 212,
    ["Drupal Links Action"] = 213,
    ["Drupal Links Contextual"] = 214,
    ["Drupal Links Menu"] = 215,
    ["Drupal Links Task"] = 216,
    ["Drupal Migration"] = 217,
    ["Drupal Permissions"] = 218,
    ["Drupal Recipe"] = 219,
    ["Drupal Routing"] = 220,
    ["Drupal Services"] = 222,
    ["Drush site aliases"] = 324,
    ["Dynamic Bash Aliases (.aliases)"] = 1071,
    ["EAS config"] = 349,
    ["ECA - Editor Code Assistant"] = 333,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1060,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1206,
    ["EasyVCR .NET"] = 350,
    ["Eidolon Resource"] = 1147,
    ["Elgato Stream Deck"] = 335,
    Elm = 1135,
    ["Embrace Config"] = 1046,
    Endurica = 1084,
    ["Enterprise Contract Policy Spec"] = 336,
    ["Erda Pipeline"] = 1109,
    ["Erda Runtime"] = 1110,
    ["Espanso config.yml"] = 1232,
    ["Espanso match.yml"] = 1231,
    Esquio = 338,
    ["Estuary Flow Catalog"] = 1024,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 342,
    ["EveryVoice TTS Toolkit Data Configuration"] = 343,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 347,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 346,
    ["EveryVoice TTS Toolkit Text Configuration"] = 344,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 345,
    ["Evolving Resolutive Process notation"] = 1208,
    ["Expo SDK"] = 348,
    ["F-Droid Data metadata"] = 354,
    ["FasterCI Configuration"] = 111,
    FiQuS = 358,
    Firebase = 356,
    ["Flatpak Builder Manifest"] = 359,
    ["FlexGet Config"] = 360,
    ["Flow.json Configurations"] = 1106,
    ["Fossa configuration file"] = 367,
    ["Fossa's fossa-deps file"] = 368,
    ["Foundry VTT - Base package Manifest"] = 362,
    ["Foundry VTT - Module Manifest"] = 363,
    ["Foundry VTT - System Data Template"] = 366,
    ["Foundry VTT - System Manifest"] = 364,
    ["Foundry VTT - World Manifest"] = 365,
    ["Foxx Manifest"] = 112,
    ["Freifunk.de Community API"] = 115,
    ["Frogbot Config"] = 116,
    ["G2P Mapping Configuration"] = 374,
    ["GCP Blueprint Metadata"] = 377,
    Gaspar = 375,
    ["GatewayCore API Gateway"] = 376,
    ["Gemini CLI settings"] = 378,
    ["GeoJSON.json latest"] = 1022,
    GherKing = 1026,
    ["GitHub Action"] = 383,
    ["GitHub Actions typing"] = 1143,
    ["GitHub Discussion"] = 384,
    ["GitHub Funding"] = 385,
    ["GitHub Issue Template configuration"] = 386,
    ["GitHub Issue Template forms"] = 387,
    ["GitHub Workflow"] = 388,
    ["GitHub Workflow Template Properties"] = 389,
    ["GitHub automatically generated release notes configuration"] = 390,
    ["GitLab Agent for Kubernetes configuration"] = 1098,
    GitVersion = 380,
    ["Gitea Issue Template configuration"] = 381,
    ["Gitea Issue Template forms"] = 382,
    ["Gitpod Automations"] = 392,
    ["Gitpod Configuration"] = 393,
    ["GlazeWM settings"] = 1100,
    ["Global Privacy Control"] = 379,
    Goblet = 1079,
    ["Golangci-lint Configuration"] = 408,
    ["Golangci-lint Custom Plugins Configuration"] = 409,
    ["Google Chrome Related Website Sets"] = 357,
    ["Google Cloud Workflows"] = 257,
    ["Google Digital Assetlinks"] = 1187,
    Goreleaser = 411,
    ["Goreleaser Pro"] = 412,
    Goss = 413,
    ["Gradle Build Cache Node"] = 973,
    ["Gradle Enterprise"] = 972,
    ["Grafana 5.x Dashboard"] = 414,
    ["GraphQL Code Generator"] = 419,
    ["GraphQL Config"] = 418,
    ["GraphQL Mesh"] = 417,
    ["GroovyLint configuration"] = 420,
    ["Grunt JSHint task"] = 424,
    ["Grunt Watch task"] = 425,
    ["Grunt base task"] = 426,
    ["Grunt clean task"] = 422,
    ["Grunt copy task"] = 421,
    ["Grunt cssmin task"] = 423,
    HEMTT = 938,
    Hadolint = 952,
    Hammerkit = 983,
    ["Hardware Sentry Configuration"] = 1038,
    ["Hashgraph Online Skill Manifest"] = 1,
    ["HashiCorp Vault"] = 427,
    Hatch = 953,
    Hayson = 429,
    ["Haystack Pipeline"] = 430,
    ["Hazelcast 5 Configuration"] = 431,
    ["Hecate Input Schema"] = 1198,
    ["Helm Chart.lock"] = 224,
    ["Helm Chart.yaml"] = 223,
    ["Helm Unittest Test Suite"] = 225,
    ["Home Assistant Integration Manifest"] = 432,
    ["Homer dashboard configuration"] = 433,
    Hugo = 1014,
    ["Hugo Theme"] = 1013,
    ["Hulak Configuration"] = 440,
    ["Hyperfoil benchmark configuration"] = 439,
    ["IBM Zapp document"] = 441,
    ["IBM zCodeFormatSettings"] = 442,
    ["IMG Catapult PSP"] = 447,
    ["IVMS101 by CODE Protocol"] = 1099,
    Infrahub = 449,
    Istanbul = 1042,
    ["JDownloader2 crawler multi-rules"] = 462,
    ["JDownloader2 crawler single-rules"] = 461,
    ["JFrog Applications Config"] = 463,
    ["JFrog File Spec"] = 464,
    ["JFrog Pipelines YML DSL"] = 1048,
    ["JMeter DSL cli config"] = 465,
    JReleaser = 468,
    ["JSON Document Transform"] = 476,
    ["JSON Feed"] = 477,
    ["JSON Resume"] = 725,
    ["JSON Schema Draft 2020-12"] = 920,
    ["JSON Schema Draft 4"] = 917,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1081,
    ["JSON Schema Draft 7"] = 918,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1082,
    ["JSON Schema Draft 8 (2019-09)"] = 919,
    ["JSON-API"] = 475,
    ["JSON-e templates"] = 980,
    ["JSON-stat 2.0"] = 913,
    JSONPatch = 479,
    ["JSR Package Config (jsr.json)"] = 469,
    Jarl = 1214,
    Jasmine = 456,
    Jekyll = 457,
    ["Jenkins X Pipelines"] = 458,
    ["Jenkins X Requirements"] = 459,
    Jest = 460,
    Jocker = 466,
    ["Jovo Language Models"] = 467,
    ["Jujutsu (jj) VCS config"] = 1200,
    ["KIMMDY config file"] = 490,
    ["KODE/CI build.yaml"] = 1044,
    ["KSP-AVC"] = 914,
    ["KSP-CKAN"] = 915,
    ["KSP-NetKAN"] = 916,
    KSY = 1111,
    KSail = 372,
    ["KYA Manifest"] = 1112,
    ["Karakum configuration file"] = 369,
    Kas = 482,
    ["Kestra flow file"] = 491,
    ["Keycloak REST API"] = 1051,
    ["Knative Functions - func.yaml"] = 370,
    Knip = 371,
    ["Kometa (nightly) config file"] = 493,
    ["Kometa config file"] = 492,
    ["Kong DBLess config"] = 1045,
    KrakenD = 494,
    ["Kubri Configuration"] = 501,
    LOOBin = 516,
    ["Lake configuration file"] = 1203,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 262,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 263,
    ["Landing Zone Accelerator on AWS - Global Config"] = 264,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 265,
    ["Landing Zone Accelerator on AWS - Network Config"] = 266,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 267,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 268,
    ["Landing Zone Accelerator on AWS - Security Config"] = 269,
    ["Lando (landofile)"] = 106,
    ["LangGraph Platform configuration"] = 1123,
    ["Language configuration"] = 1122,
    Lefthook = 505,
    ["Liferay client-extension.yaml"] = 512,
    ["LinkML Metamodel"] = 514,
    Liquibase = 989,
    ["Liquibase Flow File"] = 990,
    ["Lively Properties"] = 515,
    ["Lobe AI Agent"] = 108,
    Loki = 109,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 557,
    ["MS2Rescore Configuration"] = 561,
    ["Madness (madness.yml)"] = 1062,
    ["Mado configuration"] = 522,
    ["Maestro Flow"] = 523,
    ["Mail Servers Configuration"] = 1235,
    ["MapEHR Mapping"] = 524,
    Markdownlint = 993,
    ["Mason Registry"] = 996,
    ["MegaLinter Custom Flavor"] = 527,
    ["MegaLinter configuration"] = 526,
    ["MegaLinter descriptor"] = 528,
    Melange = 1089,
    ["Meltano project definition"] = 529,
    ["Mergify Configuration"] = 562,
    ["Metadata for a Bazel module"] = 530,
    ["Metadata for a Cinnamon spice"] = 1139,
    ["Metatype Configuration"] = 531,
    ["MetricsHub Configuration"] = 532,
    ["MetricsHub Connector Configuration"] = 533,
    ["Micro Editor Syntax"] = 1072,
    ["Microsoft Band Web Tile"] = 534,
    ["Microsoft RulesEngine workflow rules"] = 1127,
    ["Microsoft RulesEngine workflow rules list"] = 1128,
    ["Minecraft Custom Main Menu Mod"] = 1090,
    ["Minecraft Data Pack Advancement"] = 536,
    ["Minecraft Data Pack Biome"] = 537,
    ["Minecraft Data Pack Configured Carver"] = 538,
    ["Minecraft Data Pack Damage Type"] = 539,
    ["Minecraft Data Pack Dimension"] = 541,
    ["Minecraft Data Pack Dimension Type"] = 540,
    ["Minecraft Data Pack Item Modifier"] = 542,
    ["Minecraft Data Pack Loot Table"] = 543,
    ["Minecraft Data Pack Metadata"] = 544,
    ["Minecraft Data Pack Predicate"] = 545,
    ["Minecraft Data Pack Recipe"] = 546,
    ["Minecraft Data Pack Tag"] = 547,
    ["Minecraft Data Pack Template Pool"] = 548,
    ["Minecraft Data Pack Trim Material"] = 553,
    ["Minecraft Data Pack Trim Pattern"] = 554,
    ["Minecraft Resource Pack Lang"] = 549,
    ["Minecraft Resource Pack Particle"] = 550,
    ["Minecraft Resource Pack Texture Mcmeta"] = 552,
    ["Minecraft Resourcepack Sounds"] = 551,
    ["Monade CLI Stack Configuration"] = 565,
    ["MongoDB Atlas Search Index Definition"] = 1043,
    ["Monika Configuration"] = 1041,
    ["Monoweave Configuration"] = 560,
    ["Motif config"] = 934,
    MultiQC = 1180,
    ["NOX Framework (Service)"] = 581,
    ["Netin Diagnostic System Template"] = 1000,
    ["Netlify config"] = 568,
    ["Network-as-Code Data Model"] = 569,
    ["Next Gen UI Agent A2A Server Configuration"] = 570,
    ["Next Gen UI Agent Configuration"] = 572,
    ["Next Gen UI Agent MCP Server Configuration"] = 571,
    ["Nightwatch.js"] = 574,
    ["Node.js configuration"] = 939,
    ["NueJS configuration file"] = 586,
    ["Nuitka.yaml"] = 1104,
    ["Nullstone config"] = 588,
    ["ONe's changelog entry"] = 607,
    ["ONe's service descriptor"] = 606,
    ["ORT Server repository environment configuration"] = 617,
    ["OSCAL Assessment Plan (AP)"] = 619,
    ["OSCAL Assessment Results (AR)"] = 620,
    ["OSCAL Catalog"] = 621,
    ["OSCAL Component Definition (CDef)"] = 622,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 623,
    ["OSCAL Profile"] = 624,
    ["OSCAL System Security Plan (SSP)"] = 625,
    ["OSS Review Toolkit configuration"] = 626,
    ["OSS Review Toolkit curation"] = 627,
    ["OSS Review Toolkit package configuration"] = 628,
    ["OSS Review Toolkit repository configuration"] = 629,
    ["OSS Review Toolkit resolutions"] = 630,
    ["October CMS columns"] = 592,
    ["October CMS fields"] = 593,
    ["Oh My Posh"] = 595,
    Okteto = 596,
    ["Ona Automations"] = 598,
    Opctl = 937,
    ["Open Data Contract Standard (ODCS)"] = 611,
    ["Open Data Product Standard (ODPS)"] = 612,
    ["Open Know-How"] = 1185,
    ["OpenRewrite Resource"] = 609,
    OpenSRM = 613,
    OpenStatus = 1196,
    ["OpenTelemetry Declarative Configuration"] = 610,
    ["OpenUtau character yaml"] = 603,
    ["OpenUtau ustx"] = 604,
    ["OpenWeather Current Weather API"] = 979,
    ["OpenWeather Road Risk API"] = 978,
    ["Ory Hydra configuration"] = 438,
    ["Ory Keto configuration"] = 498,
    ["Ory Kratos configuration"] = 618,
    ["Ory Oathkeeper configuration"] = 590,
    ["Outblocks App configuration"] = 615,
    ["Outblocks database table"] = 616,
    ["Outblocks project configuration"] = 614,
    PDM = 637,
    POPxf = 648,
    ["POPxf Correlations"] = 649,
    Packer = 634,
    Pantsbuild = 1058,
    ["Paper paper-plugin.yml"] = 635,
    ["Pipeline component"] = 991,
    ["Platform.sh application"] = 6,
    ["Platform.sh routes"] = 7,
    ["Platform.sh services"] = 8,
    ["Plex Prerolls"] = 646,
    ["PocketMine plugin.yml"] = 643,
    ["Postman collection"] = 652,
    ["Power Pages Configuration"] = 1197,
    ["Preset list for a WinUtil"] = 1142,
    ["ProActions AI-Kit Configuration"] = 663,
    ["ProActions AI-Kit Configuration for Menus"] = 665,
    ["ProActions AI-Kit Configuration for Sections"] = 667,
    ["ProActions AI-Kit Configuration for Services"] = 664,
    ["ProActions AI-Kit Configuration for Steps"] = 668,
    ["ProActions AI-Kit Configuration for Templates"] = 666,
    ["Problem object RFC9457"] = 1087,
    ["Problem package format"] = 669,
    ["Problem package generators"] = 670,
    ["Problem package submissions"] = 671,
    ["Problem package test group metadata"] = 672,
    Pterodactyl = 1037,
    ["Pull Request Labeler"] = 689,
    Pulumi = 697,
    ["PyGTA Config"] = 693,
    PyProject = 698,
    Pylock = 1188,
    Pyright = 699,
    ["Python script metadata"] = 1182,
    ["QType AI DSL"] = 702,
    Qgoda = 701,
    Qodana = 1010,
    ["Qt Creator workspace file"] = 1120,
    ["Quali Torque Blueprint Spec 2"] = 1035,
    ["QueryFirst config file"] = 1054,
    ["RKE Cluster Configuration JSON"] = 988,
    ["RKE Cluster Configuration YAML"] = 987,
    RadioHound = 692,
    Railpack = 704,
    Railway = 703,
    ["Rancher Fleet"] = 694,
    ...
    Ray = 951,
    ["Read the Docs"] = 696,
    ["Red-DiscordBot Cog"] = 712,
    ["Red-DiscordBot Cog Repo"] = 713,
    ["Red-DiscordBot Trivia"] = 714,
    ["Releasaurus Config"] = 3,
    ["Render Blueprints"] = 986,
    RenderCV = 729,
    Renovate = 726,
    ["Renovate global configuration"] = 727,
    ["Renovate inherited configuration"] = 728,
    ["Replit config"] = 720,
    Restate = 1175,
    ["Revel Digital Gadget Definition File"] = 1199,
    RoadRunner = 731,
    ["Robust Station Image"] = 1205,
    Rockcraft = 732,
    ["Roo Coder Custom Modes"] = 733,
    Rubocop = 722,
    ["Rudder techniques"] = 1094,
    Ruff = 723,
    ["Rust Project"] = 724,
    ["Rust toolchain"] = 737,
    ["SDMX data message"] = 763,
    ["SDMX metadata message"] = 762,
    ["SDMX structure message"] = 761,
    ["SIL Kit Participant Configuration"] = 773,
    ["SIL Kit Registry Configuration"] = 774,
    ["SPDX 2.3"] = 811,
    SWADL = 827,
    ["Safebox Config"] = 1049,
    ["Sapphire CLI Config"] = 740,
    ["SauceCTL Configuration"] = 997,
    ["Schema Catalog"] = 755,
    ["Scoop manifest"] = 760,
    ["Semantic Data Fabric (SDF) file"] = 764,
    ["Semgrep Rule"] = 766,
    ["Serenity Code Generator (Sergen)"] = 767,
    ["Serverless Framework Configuration"] = 1004,
    ["Serverless Workflow"] = 1006,
    ["Settings for a Cinnamon spice"] = 1138,
    ["Settings.paf"] = 769,
    ["Shopware 6 Configuration"] = 1007,
    ["Shopware CLI Extension Store Configuration"] = 1008,
    ["Shopware CLI Project Store Configuration"] = 1009,
    ["Sigma Detection Rule"] = 771,
    ["Sigrid scope configuration file"] = 772,
    ["SkyPilot Task JSON"] = 1095,
    ["Slack app manifest"] = 776,
    Snapcraft = 778,
    Solidarity = 781,
    ["Solution filters"] = 782,
    ["Source Maps v3"] = 783,
    Sourcery = 784,
    ["Spack bootstrap.yaml"] = 785,
    ["Spack cdash.yaml"] = 786,
    ["Spack ci.yaml"] = 787,
    ["Spack compilers.yaml"] = 788,
    ["Spack concretizer.yaml"] = 789,
    ["Spack config.yaml"] = 790,
    ["Spack definitions.yaml"] = 791,
    ["Spack develop.yaml"] = 792,
    ["Spack env_vars.yaml"] = 793,
    ["Spack environment"] = 799,
    ["Spack include.yaml"] = 794,
    ["Spack mirrors.yaml"] = 795,
    ["Spack modules.yaml"] = 796,
    ["Spack packages.yaml"] = 797,
    ["Spack repos.yaml"] = 798,
    ["Spack toolchains.yaml"] = 800,
    ["Spack upstreams.yaml"] = 801,
    ["Spack view.yaml"] = 802,
    ["Speakeasy Generation Config File"] = 806,
    ["Speakeasy Lint Configuration File"] = 803,
    ["Speakeasy Test Generation Configuration File"] = 804,
    ["Speakeasy Workflow File"] = 805,
    SpecIF = 807,
    ["Specmatic Configuration"] = 808,
    ["Sponge Mixin configuration"] = 809,
    StackBlitz = 815,
    ["StackHawk Scanner Configuration"] = 1003,
    Stale = 816,
    Starfish = 817,
    ["Starlake Data Pipeline"] = 976,
    Starship = 818,
    ["Statamic Blueprint"] = 819,
    ["Stella configuration file"] = 820,
    ["Streamlit configuration file"] = 821,
    ["Stryker Mutator"] = 824,
    ["StyleCop Analyzers Configuration"] = 825,
    ["Stylelint (.stylelintrc)"] = 826,
    ["Stylua Config"] = 1189,
    ["Sublime Syntax"] = 1050,
    ["Subsquid squid manifest"] = 1097,
    ["Swagger API 2.0"] = 828,
    ["Synadia Connect Component"] = 829,
    TSON = 865,
    TSTyche = 866,
    ["TYPO3 Vendor Bundler config"] = 872,
    ["Tab data for a LinUtil"] = 1145,
    ["Tab list for a LinUtil"] = 1144,
    Tach = 830,
    ["Tach Domain"] = 831,
    Talhelper = 833,
    ["Talisman configuration"] = 834,
    Taplo = 1190,
    ["Taskfile config"] = 981,
    Taurus = 835,
    Tauticord = 836,
    ["Tekton Pipeline"] = 1218,
    ["Tekton PipelineRun"] = 1219,
    ["Tekton Task"] = 1216,
    ["Tekton TaskRun"] = 1217,
    Telefonistka = 1176,
    ["Terrateam config"] = 1202,
    ["TestEnvironment.json"] = 848,
    ["TextMate Grammar"] = 847,
    Threagile = 842,
    ["Tier.run pricing.json"] = 839,
    Tikibase = 840,
    Tombi = 845,
    ["Traefik v2"] = 851,
    ["Traefik v2 File Provider"] = 852,
    ["Traefik v3"] = 853,
    ["Traefik v3 File Provider"] = 854,
    ["Travis CI (.travis.yml)"] = 850,
    Treefmt = 416,
    Trident = 1172,
    ["TrueScript for *.tscript files"] = 857,
    ["Tugboat QA config.yml"] = 1169,
    TunnelHub = 1085,
    Turborepo = 849,
    Tycho = 1134,
    Tye = 1011,
    ["Tyk Gateway - Open Source v5.7+"] = 1181,
    ["UET BuildConfig.json"] = 1055,
    ["UI5 Manifest"] = 878,
    ["UNCORS configuration"] = 882,
    ["UTAM Page Object"] = 881,
    ["Ubuntu Server Autoinstall"] = 876,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1173,
    ["Uniswap Token List"] = 963,
    ["Universal Schedule Format"] = 883,
    ["Unreal Engine Uplugin"] = 1056,
    ["Unreal Engine Uproject"] = 1057,
    ["UpCloud CLI (upctl) configuration"] = 1174,
    ["Updatecli Compose"] = 1019,
    ["Updatecli Policy Manifest"] = 1020,
    ["Updatecli Policy Metadata"] = 1021,
    Uplift = 1053,
    ["Upsun config"] = 5,
    ["User Journey Map"] = 985,
    V2Ray = 1025,
    ["VSCode Code Snippets"] = 245,
    ["VSIX CLI publishing"] = 901,
    Vector = 885,
    ["Vela Pipeline Configuration"] = 888,
    Vercel = 244,
    ["Version Bumper config"] = 891,
    Vespertide = 1223,
    ["Vespertide Migration"] = 1224,
    ["Vespertide Model"] = 1225,
    ["Viash Component Config"] = 1178,
    ["Viash Package Config"] = 1179,
    Visivo = 1083,
    ["WP-CLI"] = 911,
    Wake = 1171,
    ["Waku Config"] = 1148,
    ["Web App Manifest"] = 907,
    ["Web types"] = 910,
    WebExtensions = 906,
    ["Webman package recipe"] = 1031,
    ["Windows Package Manager Installer Manifest"] = 959,
    ["Windows Package Manager Locale Manifest"] = 960,
    ["Windows Package Manager Singleton Manifest"] = 958,
    Winutil = 961,
    ["WireMock CLI import configuration"] = 1154,
    ["WireMock CLI local service configuration"] = 1153,
    ["WireMock message stub mapping"] = 1152,
    ["WireMock stub mapping"] = 1151,
    ["Woodpecker pipeline config"] = 999,
    ["Wrangler CLI"] = 912,
    ["Xstate Machine"] = 1017,
    ["Yandex Workflow Language"] = 1140,
    ["Yarn Config (.yarnrc.yml)"] = 974,
    ["Yippee-Ki-JSON configuration YML"] = 965,
    ["YouTrack App"] = 1137,
    ["Zarf Package Configuration"] = 1204,
    ["Zerops.io config"] = 1125,
    ["Zerops.io import"] = 1126,
    ["Zola Configuration"] = 1215,
    ["aerleon.yml"] = 18,
    ["amplify.yml"] = 11,
    ["angular.json"] = 35,
    apko = 1088,
    ...
    ["bamboo-spec"] = 122,
    basedpyright = 120,
    ["bashly-strings.yml"] = 1065,
    ["batect.yml"] = 121,
    ["beef-database-codegen"] = 123,
    ["beef-database-v5-codegen"] = 125,
    ["beef-entity-codegen"] = 124,
    ["beef-entity-v5-codegen"] = 126,
    ["behat.yml"] = 138,
    ["bigquery-table"] = 127,
    ["bioimageio resource description"] = 1105,
    ["bitbucket-pipelines"] = 129,
    bitrise = 130,
    ["bitrise-step"] = 131,
    ["block.json"] = 153,
    ["bottom configuration"] = 83,
    ["bower.json"] = 133,
    ["bozr.suite.json"] = 140,
    bpkg = 1066,
    ["browser.i18n.json"] = 141,
    ["browsh configuration"] = 142,
    bucklescript = 143,
    ["buf.gen.yaml"] = 85,
    ["buf.lock"] = 86,
    ["buf.plugin.yaml"] = 87,
    ...
    ["build-changelog"] = 144,
    ["bun.lock"] = 149,
    ["bundleconfig.json"] = 150,
    ["bunfig.toml"] = 151,
    ["cargo-mutants-config.yaml"] = 89,
    ["ccmod.json"] = 1149,
    changelogging = 1117,
    ["chisel-slices.json"] = 271,
    ["chrome-extension-locales-messages.json"] = 252,
    ["chutzpah.json"] = 253,
    cibuildwheel = 173,
    ["clang-format (.clang-format)"] = 1023,
    ["clang-tidy"] = 231,
    clangd = 230,
    clib = 232,
    ["cloud-init: cloud-config userdata"] = 234,
    ["cloud-sdk-pipeline-configuration"] = 255,
    ["cloudbuild.json"] = 256,
    cloudify = 233,
    ["cmdx.yaml"] = 92,
    codemagic = 236,
    ["coffeelint.json"] = 273,
    ["commands.json"] = 248,
    ["commitlint (.commitlintrc)"] = 962,
    ["committed.toml"] = 274,
    ["compile_commands.json"] = 247,
    ["compilerconfig.json"] = 246,
    ["completely.yml"] = 1061,
    ["component-detection-manifest.json"] = 277,
    ["component.json"] = 276,
    ["composer.json"] = 275,
    ["conda-forge"] = 177,
    ["config.yaml"] = 695,
    ["contentmanifest.json"] = 254,
    ["contribute.json"] = 278,
    ["cosmos.config.json"] = 250,
    ["crowdin.yml"] = 279,
    ["ctfd-setup configuration file"] = 1161,
    ["custom-elements.json"] = 1075,
    ["cypress.json"] = 283,
    ["datalogic-scan2deploy-android"] = 293,
    ["datalogic-scan2deploy-ce"] = 294,
    ["dbt Dependencies"] = 195,
    ["dbt Packages"] = 197,
    ["dbt Project"] = 196,
    ["dbt Selectors"] = 198,
    ["dbt YAML files"] = 199,
    ...
    ["ddev-global"] = 295,
    ["ddev-project"] = 296,
    ["debugsettings.json"] = 297,
    ["dependabot-v2.json"] = 300,
    ["dependabot.json"] = 299,
    ["deployed-cli"] = 1016,
    ["devcontainer.json"] = 238,
    devinit = 967,
    ["devspace.yaml"] = 1039,
    djlint = 968,
    ["docker bake"] = 306,
    ["docker sequencer"] = 307,
    ["docker-compose.yml"] = 966,
    ["dockerd.json"] = 304,
    ["dotnet Release Index manifest"] = 319,
    ["dotnet-tools.json"] = 320,
    ["dotnetcli.host.json"] = 321,
    ["dprint.json"] = 322,
    ["drone.json"] = 323,
    ["dss-2.0.0.json"] = 325,
    ["dstack configuration"] = 326,
    ["dtool dataset metadata"] = 1156,
    ["dvc.yaml"] = 327,
    ["ecosystem.json"] = 332,
    eksctl = 334,
    ["electron-builder configuration file"] = 340,
    ["epr-manifest.json"] = 339,
    ["evcc.yaml"] = 341,
    ["ezd task runner"] = 351,
    ["fabric.mod.json"] = 353,
    ["first-timers-bot"] = 361,
    ["flagd flag configuration"] = 113,
    ["fly.io Configuration"] = 114,
    fulibWorkflows = 998,
    ["function.json"] = 373,
    ["gRPC API Gateway & OpenAPI Config"] = 13,
    ["gematik health care insurance list"] = 1167,
    ["gematik health care patient list"] = 1164,
    ["gematik health care provider institution list"] = 1166,
    ["gematik health care provider list"] = 1165,
    ["gematik tiger test environment configuration"] = 1168,
    ["git-town.toml"] = 1213,
    ["gitlab-ci"] = 391,
    ["global.json"] = 407,
    ["go-feature-flag Flag Configuration"] = 410,
    ["haxelib.json"] = 428,
    helmfile = 954,
    helmwave = 955,
    ["host-meta.json"] = 435,
    ...
    ["ide.host.json"] = 443,
    ["ifstate.yaml"] = 444,
    ["imageoptimizer.json"] = 445,
    ["importmap.json"] = 448,
    instant_python_config = 450,
    instant_python_custom_project = 451,
    ["ioBroker Configuration"] = 452,
    ["ioBroker JSON UI"] = 453,
    ["ioBroker Package manifest"] = 454,
    ["ixpect.conf.yaml"] = 455,
    ["ize.toml"] = 1052,
    ["jsconfig.json"] = 480,
    ["jscpd Configuration"] = 1036,
    jsdoc = 950,
    ["k3d.yaml"] = 481,
    ["k9s aliases.yaml"] = 483,
    ["k9s cluster-config.yaml"] = 485,
    ["k9s config.yaml"] = 484,
    ["k9s hotkeys.yaml"] = 486,
    ["k9s plugins.yaml"] = 487,
    ["k9s skin.yaml"] = 488,
    ["k9s views.yaml"] = 489,
    ["kontinuous-config.yaml"] = 500,
    ["kontinuous-values.yaml"] = 499,
    ["kustomization.yaml"] = 502,
    ["label-commenter-config.yml"] = 503,
    ["latexindent configuration"] = 107,
    ["launchsettings.json"] = 504,
    lazydocker = 1074,
    lazygit = 1073,
    ["lego.json"] = 506,
    ["lerna.json"] = 507,
    ["lgtm.yml"] = 508,
    ["liblab.config.json"] = 509,
    ["libman.json"] = 510,
    ["license-report-config.json"] = 511,
    ["linkinator.config.json"] = 513,
    ["lint-staged (.lintstagedrc)"] = 928,
    ["local.settings.json"] = 518,
    ["localazy.json"] = 519,
    ["lotus.yaml"] = 517,
    ["lsdlschema.json"] = 520,
    ["macro.json"] = 1040,
    ["markdown-link-check"] = 994,
    maturin = 995,
    mboats = 1002,
    ["micro-settings.json"] = 1067,
    ["mimetypes.json"] = 535,
    ["mirrord config"] = 930,
    mise = 931,
    ["mkdocs.yml"] = 555,
    ...
    ["monospace.yml"] = 559,
    ["moon.yml"] = 1150,
    ["mprocs Configuration file"] = 1121,
    ["mrdocs.yml"] = 556,
    ["mta.yaml"] = 932,
    ["mtad.yaml"] = 933,
    ["mycode.json"] = 566,
    nFPM = 573,
    ["napari plugin manifest"] = 567,
    neoload = 945,
    ["nest-cli"] = 576,
    ["ninjs (News in JSON)"] = 575,
    ["nitro.json"] = 944,
    ["nixd configuration"] = 1093,
    ["nlu.json"] = 577,
    ["nodemon.json"] = 579,
    ["noodl config"] = 1001,
    ["notebook.mod.json"] = 580,
    now = 940,
    ["npm-badges"] = 583,
    ["nswag.json"] = 587,
    ntangle = 589,
    ["nuclei-template.yaml"] = 584,
    ["nuget-project.json"] = 585,
    ["ocelot.json"] = 591,
    ogen = 594,
    ["omnisharp.json"] = 597,
    openHAB = 1226,
    ...
    oxlint = 1237,
    ["package.json"] = 631,
    ["package.manifest"] = 633,
    ["package.yaml"] = 632,
    ["partial-black.json"] = 139,
    ["partial-pixi.json"] = 641,
    ["pathfinder.yml"] = 636,
    ["pattern.json"] = 639,
    ["petstore-v1.0"] = 1047,
    pgap_yaml_input_reader = 638,
    pgxgen = 1230,
    pitcms = 1233,
    ["pixi.toml"] = 640,
    ["plagiarize-me.yaml"] = 645,
    ["plagiarize.yaml"] = 644,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1157,
    ["podbard.yaml"] = 647,
    ["portman.json"] = 650,
    ["prefect.toml"] = 658,
    ["prefect.yaml"] = 659,
    ...
    ["prettierrc.json"] = 661,
    ["prisma.yml"] = 662,
    ["project-1.0.0-beta3.json"] = 674,
    ["project-1.0.0-beta4.json"] = 675,
    ["project-1.0.0-beta5.json"] = 676,
    ["project-1.0.0-beta6.json"] = 677,
    ["project-1.0.0-beta8.json"] = 678,
    ["project-1.0.0-rc1.json"] = 679,
    ["project-1.0.0-rc2.json"] = 680,
    ["project.json"] = 673,
    ["project.owasp.yaml"] = 681,
    ["prometheus-alertmanager.json"] = 685,
    ["prometheus.json"] = 682,
    ["prometheus.rules.json"] = 683,
    ["prometheus.rules.test.json"] = 684,
    ["proxies.json"] = 686,
    ["publiccode.yml"] = 687,
    ["pubspec.yaml"] = 688,
    ["pyrseas-0.8.json"] = 691,
    pytest = 700,
    ["quilt.mod.json"] = 1068,
    ["rc3 auth"] = 706,
    ["rc3 collection"] = 707,
    ...
    ["release drafter"] = 946,
    ["release-hub.json"] = 2,
    ["release-please-config.json"] = 716,
    ["release-please-manifest.json"] = 717,
    ["release-plz.toml"] = 718,
    ["renv.lock"] = 730,
    ["rivet.json"] = 1092,
    ["rivet.yaml (legacy)"] = 1091,
    rumdl = 735,
    runny = 734,
    rustfmt = 736,
    sake = 1184,
    samt = 738,
    samtrc = 739,
    ["sarif-1.0.0.json"] = 741,
    ["sarif-2.0.0.json"] = 742,
    ["sarif-2.1.0"] = 752,
    ["sarif-2.1.0-rtm.2"] = 743,
    ["sarif-2.1.0-rtm.3"] = 745,
    ["sarif-2.1.0-rtm.4"] = 747,
    ["sarif-2.1.0-rtm.5"] = 749,
    ["sarif-2.1.0-rtm.6"] = 750,
    ["sarif-external-property-file-2.1.0"] = 753,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 744,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 746,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 748,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 751,
    ["scalingo.json configuration"] = 754,
    ["schema.org - Action"] = 756,
    ["schema.org - ContactPoint"] = 757,
    ["schema.org - Place"] = 758,
    ["schema.org - Thing"] = 759,
    ["secrethub.yml"] = 1070,
    ["semantic-release"] = 765,
    ["servicehub.config.json"] = 923,
    ["servicehub.service.json"] = 922,
    ["settings.job"] = 768,
    ["sfdx-hardis configuration"] = 770,
    ["shard.yml"] = 1108,
    ["size-limit configuration"] = 775,
    ["skaffold.yaml"] = 992,
    ["skyuxconfig.json"] = 777,
    ["snowflake-config"] = 779,
    ["snowflake-connections"] = 780,
    ["spicepod.yaml"] = 1129,
    ["sqlc configuration"] = 812,
    ["stripe-app-local.json"] = 823,
    ["stripe-app.json"] = 822,
    swcrc = 977,
    ["task.json"] = 832,
    taskcat = 941,
    ["template.json"] = 837,
    ["templatsources.json"] = 838,
    ["text2confl config"] = 1238,
    ["theme.json"] = 841,
    ["tizen_workspace.json"] = 843,
    tldr = 844,
    ["tm_devices configuration file"] = 1195,
    tmuxinator = 926,
    tox = 846,
    ["transcend.yml"] = 855,
    ["tree-sitter grammar.json"] = 415,
    ["trime.yaml"] = 856,
    ["trunk.yaml"] = 858,
    ["ts-force-config.json"] = 863,
    ["tsconfig.json"] = 859,
    ["tsd.json"] = 860,
    ["tsdoc.json"] = 861,
    ["tsdrc.json"] = 862,
    ...
    v8r = 905,
    vcluster = 1115,
    ["vcpkg configuration file"] = 243,
    ["vcpkg manifest file"] = 242,
    ["vega-lite.json"] = 887,
    ["vega.json"] = 886,
    ["venvironment.yaml"] = 889,
    ["venvplus.yaml"] = 890,
    version = 1177,
    ["version.json"] = 892,
    ["vhwdebugger-binding.yaml"] = 894,
    ["vim-addon-info"] = 895,
    ["vs-2017.3.host.json"] = 897,
    ["vs-nesting.json"] = 898,
    ["vsls.json"] = 896,
    ["vss-extension.json"] = 902,
    vtcfg = 1183,
    ["vtesttree.yaml"] = 903,
    ["vtestunit.yaml"] = 904,
    ["warp-keysets.json"] = 1076,
    ["warp-themes.json"] = 1077,
    ["warp-workflows.json"] = 1078,
    ["webhint.io"] = 1032,
    ["webjobpublishsettings.json"] = 909,
    ["webjobs-list.json"] = 908,
    ["well-known-fursona"] = 1116,
    ["xs-app.json"] = 936,
    ["xunit.runner.json"] = 921,
    yamllint = 964,
    zizmor = 1220,
    zuul = 947,
    ["Žinoma"] = 957
