...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 107,
    [".cryproj (generic)"] = 411,
    [".cryproj engine-5.2"] = 406,
    [".cryproj engine-5.3"] = 407,
    [".cryproj engine-5.4"] = 408,
    [".cryproj engine-5.5"] = 409,
    [".cryproj engine-dev"] = 410,
    [".csscomb.json"] = 109,
    [".csslintrc"] = 110,
    [".eslintrc"] = 146,
    [".esmrc.json"] = 139,
    ...
    [".mtaext"] = 417,
    [".nodehawkrc"] = 256,
    [".npmpackagejsonlintrc"] = 258,
    [".phraseapp.yml"] = 285,
    [".pmbot.yml"] = 278,
    [".postcssrc"] = 283,
    [".pre-commit-config.yml"] = 284,
    [".putout.json"] = 302,
    [".rehyperc"] = 307,
    [".remarkrc"] = 308,
    [".sprite files"] = 343,
    ...
    [".vsext"] = 387,
    [".yarnrc.yml"] = 449,
    ["<div>RIOTS' studio configuration"] = 390,
    ["API Builder"] = 446,
    ["AWS CDK cdk.json"] = 96,
    ["AWS CloudFormation"] = 97,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 98,
    ...
    AssemblyScript = 31,
    ["Avro Avsc"] = 32,
    ["Azure Device Update for IoT Hub import manifest"] = 33,
    ["Azure Device Update for IoT Hub update manifest"] = 34,
    ["Azure IoT Edge deployment"] = 37,
    ["Azure IoT Edge deployment template"] = 38,
    ["Azure IoT EdgeAgent deployment"] = 35,
    ["Azure IoT EdgeHub deployment"] = 36,
    ["Azure Pipelines"] = 39,
    ["Azure Static Web Apps CLI configuration file"] = 345,
    ["Azure Static Web Apps configuration file"] = 344,
    ["Better Code Hub"] = 451,
    BizTalkServerApplicationSchema = 423,
    ["Block Protocol Metadata"] = 66,
    Briefcase = 428,
    ["Build Info"] = 59,
    Buildkite = 61,
    ["Bukkit plugin.yml"] = 60,
    ["BungeeCord plugin.yml"] = 64,
    ["Butane config schema"] = 485,
    ["CMake Presets"] = 67,
    ["CSR Framework"] = 72,
    ["Camel YAML DSL"] = 68,
    Carafe = 69,
    ["Catalog Info Backstage"] = 70,
    Cheatsheets = 482,
    ["Chrome Extension"] = 90,
    ["CircleCI config.yml"] = 75,
    ["Citation File Format"] = 99,
    CityJSON = 71,
    ["Code Climate"] = 76,
    ["Common types for all schemas"] = 1,
    ["Container Structure Test"] = 434,
    Containerlab = 459,
    ["Dart build configuration"] = 111,
    ["Dart test config"] = 112,
    Deno = 116,
    ["Deployer Recipe"] = 119,
    Devfile = 137,
    ["Discord Webhook"] = 121,
    ["Dolittle Artifacts"] = 123,
    ["Dolittle Bounded Context Configuration"] = 124,
    ["Dolittle Event Horizons Configuration"] = 125,
    ["Dolittle Resources Configuration"] = 126,
    ["Dolittle Server Configuration"] = 127,
    ["Dolittle Tenant Map Configuration"] = 129,
    ["Dolittle Tenants Configuration"] = 128,
    ["Dolittle Topology"] = 130,
    ["Drush site aliases"] = 134,
    ["Error pages"] = 142,
    Esquio = 140,
    ["Estuary Flow Catalog Schema"] = 489,
    ["Expo SDK"] = 145,
    ["F-Droid Data metadata"] = 149,
    ["Facets - FSDL - Application"] = 147,
    ["Fossa configuration file"] = 154,
    ["Fossa's fossa-deps file"] = 155,
    ["Foundry VTT - Manifest"] = 152,
    ["Foundry VTT - Template"] = 153,
    ["Foxx Manifest"] = 40,
    ["GatewayCore API Gateway"] = 158,
    ["GeoJSON.json latest"] = 487,
    ["GitHub Action"] = 162,
    ["GitHub Funding"] = 163,
    ["GitHub Issue Template configuration"] = 165,
    ["GitHub Workflow"] = 166,
    ["GitHub Workflow Template Properties"] = 167,
    ["GitHub issue forms"] = 164,
    GitVersion = 161,
    ["Gitpod Configuration"] = 169,
    ["Global Privacy Control"] = 159,
    ["Google Cloud Workflows"] = 95,
    Goreleaser = 172,
    ["Goreleaser Pro"] = 173,
    ["Gradle Build Cache Node"] = 448,
    ["Gradle Enterprise"] = 447,
    ["Grafana 5.x Dashboard"] = 174,
    ["GraphQL Code Generator"] = 177,
    ["GraphQL Config"] = 176,
    ["GraphQL Mesh"] = 175,
    ["Grunt JSHint task"] = 181,
    ["Grunt Watch task"] = 182,
    ["Grunt base task"] = 183,
    ["Grunt clean task"] = 179,
    ["Grunt copy task"] = 178,
    ["Grunt cssmin task"] = 180,
    HEMTT = 420,
    Hadolint = 432,
    ["Hammerkit YAML Schema"] = 458,
    Hayson = 185,
    ["Haystack Pipeline"] = 186,
    ["Hazelcast 5 Configuration"] = 187,
    ["Helm Chart.lock"] = 74,
    ["Helm Chart.yaml"] = 73,
    Hugo = 481,
    ["JFrog File Spec"] = 201,
    ["JSON Document Transform"] = 209,
    ["JSON Feed"] = 210,
    ["JSON Resume"] = 310,
    ["JSON Schema Draft 2020-12"] = 402,
    ["JSON Schema Draft 4"] = 399,
    ["JSON Schema Draft 7"] = 400,
    ["JSON Schema Draft 8"] = 401,
    ["JSON schema for CodeShip Pro services configuration files"] = 82,
    ["JSON schema for CodeShip Pro steps configuration files"] = 83,
    ["JSON schema for Codecov configuration files"] = 81,
    ["JSON-API"] = 208,
    ["JSON-e templates"] = 456,
    ["JSON-stat 2.0"] = 396,
    JSONPatch = 212,
    Jekyll = 198,
    ["Jenkins X Pipelines"] = 199,
    ["Jenkins X Requirements"] = 200,
    ["Jovo Language Models"] = 202,
    ["KSP-AVC"] = 397,
    ["KSP-CKAN"] = 398,
    Liquibase = 463,
    Markdownlint = 466,
    ["MegaLinter configuration"] = 228,
    ["MegaLinter descriptor"] = 229,
    ["Meltano plugin discovery definition"] = 231,
    ["Meltano project definition"] = 230,
    ["Microsoft Band Web Tile"] = 232,
    ["Minecraft Data Pack Advancement"] = 234,
    ["Minecraft Data Pack Biome"] = 235,
    ["Minecraft Data Pack Configured Carver"] = 236,
    ["Minecraft Data Pack Dimension"] = 238,
    ["Minecraft Data Pack Dimension Type"] = 237,
    ["Minecraft Data Pack Item Modifier"] = 239,
    ["Minecraft Data Pack Loot Table"] = 240,
    ["Minecraft Data Pack Metadata"] = 241,
    ["Minecraft Data Pack Predicate"] = 242,
    ["Minecraft Data Pack Recipe"] = 243,
    ["Minecraft Data Pack Template Pool"] = 244,
    ["Minecraft Resourcepack Sounds"] = 245,
    ["Netin Diagnostic System Template"] = 470,
    ["Netlify config schema"] = 250,
    ["Nightwatch.js"] = 251,
    ["OSS Review Toolkit repository configuration"] = 272,
    Opctl = 419,
    ["OpenWeather Current Weather API"] = 455,
    ["OpenWeather Road Risk API"] = 454,
    ["Ory Hydra configuration"] = 191,
    ["Ory Keto configuration"] = 216,
    ["Ory Kratos configuration"] = 271,
    ["Ory Oathkeeper configuration"] = 263,
    ["Outblocks App configuration"] = 269,
    ["Outblocks database table"] = 270,
    ["Outblocks project configuration"] = 268,
    Packer = 275,
    ["Pipeline component"] = 464,
    ["PocketMine plugin.yml"] = 279,
    ["Pull Request Labeler"] = 301,
    Qodana = 478,
    ["RKE Cluster Configuration JSON Schema"] = 462,
    ["RKE Cluster Configuration YAML Schema"] = 461,
    Ray = 431,
    ["Read the Docs"] = 304,
    ["Red-DiscordBot Cog"] = 305,
    ["Red-DiscordBot Cog Repo"] = 306,
    Renovate = 311,
    RoadRunner = 312,
    SWADL = 354,
    ["Sapphire CLI Config"] = 313,
    ["SauceCTL Configuration"] = 467,
    ["Schema Catalog"] = 326,
    ["Scoop manifest"] = 331,
    ["Semgrep Rule"] = 332,
    ["Serverless Framework Configuration"] = 474,
    ["Settings.paf"] = 334,
    ["Shopware 6 Configuration"] = 475,
    ["Shopware CLI Extension Store Configuration"] = 476,
    ["Shopware CLI Project Store Configuration"] = 477,
    Solidarity = 339,
    ["Source Maps v3"] = 340,
    SpecIF = 341,
    ["Sponge Mixin configuration"] = 342,
    ["StackHawk Scanner Configuration"] = 473,
    ["StackHead CLI config"] = 346,
    ["StackHead module configuration"] = 347,
    ["StackHead project definition"] = 348,
    Stale = 349,
    ["Statamic Blueprint"] = 350,
    ["Stryker Mutator"] = 351,
    ["StyleCop Analyzers Configuration"] = 352,
    ["Swagger API 2.0"] = 355,
    ["Taskfile YAML Schema"] = 457,
    Taurus = 356,
    ["TestEnvironment.json"] = 361,
    ["Traefik v2"] = 363,
    ["Traefik v2 File Provider"] = 364,
    Tye = 479,
    ["UI5 Manifest"] = 376,
    ["Ubuntu Server Autoinstall"] = 374,
    ["Uniswap Token List"] = 440,
    Updatecli = 486,
    ["User Journey Map YAML Schema"] = 460,
    V2Ray = 490,
    ["VSCode Code Snippets"] = 85,
    ["VSIX CLI publishing"] = 388,
    ["Vela Pipeline Configuration"] = 380,
    Vercel = 84,
    ["Web App Manifest"] = 392,
    ["Web types"] = 395,
    WebExtensions = 391,
    ["Windows Package Manager Installer Manifest"] = 437,
    ["Windows Package Manager Locale Manifest"] = 438,
    ["Windows Package Manager Singleton Manifest"] = 436,
    ["Woodpecker pipeline config"] = 469,
    ["Xstate Machine Schema"] = 484,
    ["Yippee-Ki-JSON configuration YML"] = 442,
    ["angular.json"] = 8,
    ...
    ["batect.yml"] = 44,
    ["beau.yml"] = 450,
    ["beef-database-codegen"] = 46,
    ["beef-entity-codegen"] = 47,
    ["behat.yml"] = 55,
    ["bigquery-table"] = 48,
    ["bitbucket-pipelines"] = 49,
    bitrise = 50,
    ["bitrise-step"] = 51,
    ["block.json"] = 65,
    ["bower.json"] = 53,
    ["bozr.suite.json"] = 56,
    ["browser.i18n.json"] = 57,
    bucklescript = 58,
    ["bundleconfig.json"] = 63,
    ["chutzpah.json"] = 91,
    ["cloud-sdk-pipeline-config-schema"] = 93,
    ["cloudbuild.json"] = 94,
    cloudify = 79,
    codemagic = 80,
    ["coffeelint.json"] = 100,
    ...
    ["compilerconfig.json"] = 86,
    ["component.json"] = 102,
    ["composer.json"] = 101,
    ["config.json"] = 103,
    ["contentmanifest.json"] = 92,
    ["contribute.json"] = 104,
    ["cosmos.config.json"] = 89,
    ["crowdin.yml"] = 105,
    cspell = 108,
    ["cypress.json"] = 106,
    ["datalogic-scan2deploy-android"] = 113,
    ["datalogic-scan2deploy-ce"] = 114,
    ["debugsettings.json"] = 115,
    ["dependabot-v2.json"] = 118,
    ["dependabot.json"] = 117,
    ["deployed-cli"] = 483,
    ["detekt.yml"] = 120,
    devinit = 444,
    ...
    ["dotnet Release Index manifest"] = 131,
    ["dotnetcli.host.json"] = 132,
    ["drone.json"] = 133,
    ["dss-2.0.0.json"] = 135,
    ["dvc.yaml"] = 136,
    ["ecosystem.json"] = 138,
    ["electron-builder configuration file."] = 143,
    ["epr-manifest.json"] = 141,
    ["evcc.yaml"] = 144,
    ["fabric.mod.json"] = 148,
    ["first-timers-bot"] = 151,
    fulibWorkflows = 468,
    ["func.yaml"] = 156,
    ["function.json"] = 157,
    ["geojson.json"] = 160,
    ["gitlab-ci"] = 168,
    ["global.json"] = 170,
    ["golangci-lint Configuration"] = 171,
    ["haxelib.json"] = 184,
    helmfile = 433,
    ["host-meta.json"] = 189,
    ["host.json"] = 188,
    ...
    huskyrc = 413,
    ["ide.host.json"] = 192,
    ["imageoptimizer.json"] = 193,
    ["importmap.json"] = 195,
    ["ioBroker JSON UI"] = 196,
    ["ioBroker Package manifest"] = 197,
    ["jsconfig.json"] = 213,
    jsdoc = 430,
    ["k3d.yaml"] = 214,
    ["kustomization.yaml"] = 217,
    ["label-commenter-config.yml"] = 218,
    ["launchsettings.json"] = 219,
    ["lerna.json"] = 220,
    ["lgtm.yml"] = 221,
    ["libman.json"] = 222,
    ["license-report-config.json"] = 223,
    ["linkinator.config.json"] = 224,
    ["local.settings.json"] = 225,
    ["localazy.json"] = 226,
    ["lsdlschema.json"] = 227,
    mboats = 472,
    ["mimetypes.json"] = 233,
    ...
    ["mtad.yaml"] = 416,
    ["mycode.json"] = 248,
    ["napari plugin manifest"] = 249,
    neoload = 425,
    ["nest-cli"] = 254,
    ["ninjs (News in JSON) 1.3"] = 253,
    ["ninjs (News in JSON) 2.0"] = 252,
    ["nlu.json"] = 255,
    ["nodemon.json"] = 257,
    ["noodl.schema.json"] = 471,
    now = 421,
    ["nswag.json"] = 261,
    ntangle = 262,
    ["nuclei-template.yaml"] = 259,
    ["nuget-project.json"] = 260,
    ["ocelot.json"] = 264,
    ["omnisharp.json"] = 265,
    ["openapi.json"] = 266,
    ["openfin.json"] = 267,
    ["package.json"] = 273,
    ["package.manifest"] = 274,
    ["pattern.json"] = 277,
    pgap_yaml_input_reader = 276,
    ["plagiarize-me.yaml"] = 281,
    ["plagiarize.yaml"] = 280,
    ["portman.json"] = 282,
    ["prettierrc.json"] = 286,
    ["prisma.yml"] = 287,
    ["project-1.0.0-beta3.json"] = 289,
    ["project-1.0.0-beta4.json"] = 290,
    ["project-1.0.0-beta5.json"] = 291,
    ["project-1.0.0-beta6.json"] = 292,
    ["project-1.0.0-beta8.json"] = 293,
    ["project-1.0.0-rc1.json"] = 294,
    ["project-1.0.0-rc2.json"] = 295,
    ["project.json"] = 288,
    ["prometheus.json"] = 296,
    ["prometheus.rules.json"] = 297,
    ["proxies.json"] = 298,
    ["publiccode.yml"] = 299,
    ["pubspec.yaml"] = 300,
    ["pyrseas-0.8.json"] = 303,
    ["release drafter"] = 426,
    ["sarif-1.0.0.json"] = 314,
    ["sarif-2.0.0.json"] = 315,
    ["sarif-2.1.0"] = 324,
    ["sarif-2.1.0-rtm.2"] = 316,
    ["sarif-2.1.0-rtm.3"] = 318,
    ["sarif-2.1.0-rtm.4"] = 320,
    ["sarif-2.1.0-rtm.5"] = 322,
    ["sarif-external-property-file-2.1.0"] = 325,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 317,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 319,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 321,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 323,
    ["schema.org - Action"] = 327,
    ["schema.org - ContactPoint"] = 328,
    ["schema.org - Place"] = 329,
    ["schema.org - Thing"] = 330,
    ["service.datadog.yaml"] = 215,
    ["servicehub.config.json"] = 405,
    ["servicehub.service.json"] = 404,
    ["settings.job"] = 333,
    ["sfdx-hardis configuration"] = 335,
    ["size-limit configuration"] = 336,
    ["skaffold.yaml"] = 465,
    ["skyuxconfig.json"] = 337,
    snapcraft = 338,
    swcrc = 453,
    taskcat = 422,
    ["template.json"] = 357,
    ["templatsources.json"] = 358,
    ["theme.json"] = 359,
    tmLanguage = 360,
    ["trunk.yaml schema"] = 365,
    ["ts-force-config.json"] = 369,
    ["tsconfig.json"] = 366,
    ["tsd.json"] = 367,
    ["tsdrc.json"] = 368,
    ["tslint.json"] = 370,
    ...
    ["version.json"] = 381,
    ["vim-addon-info"] = 382,
    ["vs-2017.3.host.json"] = 384,
    ["vs-nesting.json"] = 385,
    ["vsls.json"] = 383,
    ["vss-extension.json"] = 389,
    ["webjobpublishsettings.json"] = 394,
    ["webjobs-list.json"] = 393,
    ["xs-app.json"] = 418,
    ["xunit.runner.json"] = 403,
    yamllint = 441,
    zuul = 427,
    ["Žinoma"] = 435
  },
