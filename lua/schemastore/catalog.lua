...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 158,
    [".cryproj (generic)"] = 548,
    [".cryproj engine-5.2"] = 543,
    [".cryproj engine-5.3"] = 544,
    [".cryproj engine-5.4"] = 545,
    [".cryproj engine-5.5"] = 546,
    [".cryproj engine-dev"] = 547,
    [".csscomb.json"] = 160,
    [".csslintrc"] = 161,
    [".es6importsorterrc.json"] = 671,
    [".eslintrc"] = 206,
    [".esmrc.json"] = 198,
    [".ffizer.yaml"] = 210,
    [".htmlhintrc"] = 254,
    ...
    [".mtaext"] = 557,
    [".nodehawkrc"] = 345,
    [".npmpackagejsonlintrc"] = 348,
    [".phraseapp.yml"] = 385,
    [".pmbot.yml"] = 376,
    [".postcssrc"] = 381,
    [".powerpages-web-template-manifest"] = 382,
    [".pre-commit-config.yml"] = 383,
    [".pre-commit-hooks.yml"] = 384,
    [".putout.json"] = 402,
    [".rehyperc"] = 412,
    [".remarkrc"] = 413,
    [".sprite files"] = 463,
    ...
    [".vsext"] = 521,
    [".yarnrc.yml"] = 589,
    ["<div>RIOTS' studio configuration"] = 527,
    ["@factorial/drupal-breakpoints-css"] = 5,
    ["A micro editor config schema"] = 310,
    ["API Builder"] = 586,
    ["AVA Configuration Schema"] = 643,
    ["AWS CDK cdk.json"] = 143,
    ["AWS CloudFormation"] = 144,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 145,
    ["Airlock Microgateway"] = 9,
    ["Airplane task"] = 10,
    ["Alacritty Configuration Schema"] = 618,
    ["All Contributors configuration file"] = 670,
    ...
    ["Azure Pipelines"] = 48,
    ["Azure Static Web Apps CLI configuration file"] = 465,
    ["Azure Static Web Apps configuration file"] = 464,
    ["BX CI"] = 83,
    ["Better Code Hub"] = 591,
    ["Better Scripts"] = 84,
    BizTalkServerApplicationSchema = 563,
    ...
    ["Butane Config"] = 630,
    ["CICS TS region tagging"] = 637,
    ["CICS TS resource import"] = 638,
    ["CICS TS resource model"] = 639,
    ["CICS TS resource overrides"] = 640,
    ["CMake Presets"] = 85,
    ...
    ["Datadog Service Definition"] = 291,
    ["Datahub Ingestion Recipe Schema"] = 644,
    ...
    ["Embrace Config Schema"] = 655,
    ["Error pages"] = 201,
    Esquio = 199,
    ["Estuary Flow Catalog Schema"] = 634,
    ["Expo SDK"] = 204,
    ...
    ["GeoJSON.json latest"] = 632,
    GherKing = 636,
    ["GitHub Action"] = 225,
    ["GitHub Discussion"] = 226,
    ["GitHub Funding"] = 227,
    ["GitHub Issue Template configuration"] = 229,
    ["GitHub Workflow"] = 230,
    ["GitHub Workflow Template Properties"] = 231,
    ["GitHub issue forms"] = 228,
    GitVersion = 224,
    ["Gitpod Configuration"] = 233,
    ["Global Privacy Control"] = 222,
    ["Google Cloud Workflows"] = 142,
    Goreleaser = 236,
    ["Goreleaser Pro"] = 237,
    ["Gradle Build Cache Node"] = 588,
    ["Gradle Enterprise"] = 587,
    ["Grafana 5.x Dashboard"] = 238,
    ["GraphQL Code Generator"] = 241,
    ["GraphQL Config"] = 240,
    ["GraphQL Mesh"] = 239,
    ["Grunt JSHint task"] = 245,
    ["Grunt Watch task"] = 246,
    ["Grunt base task"] = 247,
    ["Grunt clean task"] = 243,
    ["Grunt copy task"] = 242,
    ["Grunt cssmin task"] = 244,
    HEMTT = 560,
    Hadolint = 572,
    Hammerkit = 598,
    ["Hardware Sentry Configuration"] = 648,
    Hayson = 249,
    ["Haystack Pipeline"] = 250,
    ["Hazelcast 5 Configuration"] = 251,
    ["Helm Chart.lock"] = 115,
    ["Helm Chart.yaml"] = 114,
    ["Helm Unittest Test Suite"] = 116,
    Hugo = 626,
    ["IBM Zapp document"] = 256,
    ["IBM zCodeFormatSettings"] = 257,
    ["IMG Catapult PSP"] = 262,
    ["Istanbul Schema"] = 651,
    ["JDownloader2 crawler multi-rule schema"] = 272,
    ["JDownloader2 crawler single-rule schema"] = 271,
    ["JFrog File Spec"] = 273,
    ["JFrog Pipelines YML DSL"] = 657,
    ["JMeter DSL cli config schema"] = 274,
    JReleaser = 276,
    ["JSON Document Transform"] = 283,
    ["JSON Feed"] = 284,
    ["JSON Resume"] = 419,
    ["JSON Schema Draft 2020-12"] = 539,
    ["JSON Schema Draft 4"] = 536,
    ["JSON Schema Draft 7"] = 537,
    ["JSON Schema Draft 8"] = 538,
    ...
    ["JSON-API"] = 282,
    ["JSON-e templates"] = 596,
    ["JSON-stat 2.0"] = 533,
    JSONPatch = 286,
    Jasmine = 267,
    Jekyll = 268,
    ["Jenkins X Pipelines"] = 269,
    ["Jenkins X Requirements"] = 270,
    ["Jovo Language Models"] = 275,
    ["KSP-AVC"] = 534,
    ["KSP-CKAN"] = 535,
    Kas = 289,
    ["Keycloak REST API"] = 663,
    ["Knative Functions - func.yaml"] = 219,
    ["KoDE/CI build.yaml"] = 653,
    ["Kong DBLess Schema"] = 654,
    KrakenD = 290,
    LOOBin = 305,
    ["LinkML Metamodel"] = 303,
    Liquibase = 603,
    ["Liquibase Flow File"] = 604,
    ["Lively Properties"] = 304,
    Markdownlint = 607,
    ["Mason Registry"] = 609,
    ["MegaLinter configuration"] = 311,
    ["MegaLinter descriptor"] = 312,
    ["Meltano plugin discovery definition"] = 314,
    ["Meltano project definition"] = 313,
    ["Microsoft Band Web Tile"] = 315,
    ["Minecraft Data Pack Advancement"] = 317,
    ["Minecraft Data Pack Biome"] = 318,
    ["Minecraft Data Pack Configured Carver"] = 319,
    ["Minecraft Data Pack Damage Type"] = 320,
    ["Minecraft Data Pack Dimension"] = 322,
    ["Minecraft Data Pack Dimension Type"] = 321,
    ["Minecraft Data Pack Item Modifier"] = 323,
    ["Minecraft Data Pack Loot Table"] = 324,
    ["Minecraft Data Pack Metadata"] = 325,
    ["Minecraft Data Pack Predicate"] = 326,
    ["Minecraft Data Pack Recipe"] = 327,
    ["Minecraft Data Pack Tag"] = 328,
    ["Minecraft Data Pack Template Pool"] = 329,
    ["Minecraft Resource Pack Lang"] = 330,
    ["Minecraft Resource Pack Particle"] = 331,
    ["Minecraft Resource Pack Texture Mcmeta"] = 333,
    ["Minecraft Resourcepack Sounds"] = 332,
    ["MkDocs Configuration 1.0"] = 334,
    ["MongoDB Atlas Search Index Definition Schema"] = 652,
    ["Monika Configuration Schema"] = 650,
    ["Motif config"] = 556,
    ["NOX Framework (Service)"] = 347,
    ["Netin Diagnostic System Template"] = 613,
    ["Netlify config schema"] = 339,
    ["Nightwatch.js"] = 340,
    ["ONe's service descriptor"] = 359,
    ["OSS Review Toolkit configuration"] = 366,
    ["OSS Review Toolkit curation"] = 367,
    ["OSS Review Toolkit package configuration"] = 368,
    ["OSS Review Toolkit repository configuration"] = 369,
    ["OSS Review Toolkit resolutions"] = 370,
    Opctl = 559,
    ["OpenRewrite Resource"] = 361,
    ["OpenWeather Current Weather API"] = 595,
    ["OpenWeather Road Risk API"] = 594,
    ["Ory Hydra configuration"] = 255,
    ["Ory Keto configuration"] = 292,
    ["Ory Kratos configuration"] = 365,
    ["Ory Oathkeeper configuration"] = 354,
    ["Outblocks App configuration"] = 363,
    ["Outblocks database table"] = 364,
    ["Outblocks project configuration"] = 362,
    Packer = 373,
    Pantsbuild = 669,
    ["Pipeline component"] = 605,
    ["PocketMine plugin.yml"] = 377,
    Pterodactyl = 647,
    ["Pull Request Labeler"] = 401,
    Pulumi = 406,
    PyProject = 407,
    Pyright = 408,
    Qodana = 623,
    ["Quali Torque Blueprint Spec 2"] = 645,
    ["QueryFirst config file"] = 666,
    ["RKE Cluster Configuration JSON Schema"] = 602,
    ["RKE Cluster Configuration YAML Schema"] = 601,
    ["Rancher Fleet"] = 404,
    Ray = 571,
    ["Read the Docs"] = 405,
    ["Red-DiscordBot Cog"] = 409,
    ["Red-DiscordBot Cog Repo"] = 410,
    ["Red-DiscordBot Trivia"] = 411,
    Renovate = 420,
    ["Replit schema"] = 414,
    RoadRunner = 421,
    Ruff = 417,
    ["Rust Project"] = 418,
    ["Rust toolchain"] = 423,
    ["SIL Kit Participant Configuration"] = 452,
    SWADL = 474,
    ["Sapphire CLI Config"] = 426,
    ["SauceCTL Configuration"] = 610,
    ["Schema Catalog"] = 439,
    ["Scoop manifest"] = 444,
    ["Semantic Data Fabric (SDF) file"] = 445,
    ["Semgrep Rule"] = 447,
    ["Serenity Code Generator (Sergen)"] = 448,
    ["Serverless Framework Configuration"] = 617,
    ["Serverless Workflow Schema"] = 619,
    ["Settings.paf"] = 450,
    ["Shopware 6 Configuration"] = 620,
    ["Shopware CLI Extension Store Configuration"] = 621,
    ["Shopware CLI Project Store Configuration"] = 622,
    ["Slack app manifest"] = 454,
    Solidarity = 457,
    ["Solution filters"] = 458,
    ["Source Maps v3"] = 459,
    Sourcery = 460,
    SpecIF = 461,
    ["Sponge Mixin configuration"] = 462,
    ["StackHawk Scanner Configuration"] = 616,
    Stale = 466,
    Starship = 467,
    ["Statamic Blueprint"] = 468,
    ["StrmPrivacy Data Connector"] = 661,
    ["StrmPrivacy Data Contract"] = 662,
    ["StrmPrivacy SimpleSchema"] = 659,
    ["StrmPrivacy Stream"] = 660,
    ["StrmPrivacy batch job configuration file"] = 658,
    ["Stryker Mutator"] = 471,
    ["StyleCop Analyzers Configuration"] = 472,
    ["Swagger API 2.0"] = 475,
    TSON = 499,
    ["Talisman configuration"] = 477,
    ["Taskfile YAML Schema"] = 597,
    Taurus = 478,
    ["TestEnvironment.json"] = 487,
    ["Tier.run pricing.json"] = 481,
    Tikibase = 482,
    ["Traefik v2"] = 490,
    ["Traefik v2 File Provider"] = 491,
    Turborepo = 488,
    Tye = 624,
    ["UI5 Manifest"] = 506,
    ["UTAM Page Object"] = 509,
    ["Ubuntu Server Autoinstall"] = 504,
    ["Uniswap Token List"] = 580,
    ["Unreal Engine Uplugin"] = 667,
    ["Unreal Engine Uproject"] = 668,
    Updatecli = 631,
    Uplift = 665,
    ["User Journey Map YAML Schema"] = 600,
    V2Ray = 635,
    ["VSCode Code Snippets"] = 131,
    ["VSIX CLI publishing"] = 522,
    ["Vela Pipeline Configuration"] = 512,
    Vercel = 130,
    ["Web App Manifest"] = 529,
    ["Web types"] = 532,
    WebExtensions = 528,
    ["Webman package recipe"] = 641,
    ["Windows Package Manager Installer Manifest"] = 577,
    ["Windows Package Manager Locale Manifest"] = 578,
    ["Windows Package Manager Singleton Manifest"] = 576,
    ["Woodpecker pipeline config"] = 612,
    ["Xstate Machine Schema"] = 629,
    ["Yippee-Ki-JSON configuration YML"] = 582,
    ["angular.json"] = 11,
    ...
    ["bamboo-spec"] = 59,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 673,
    ["bashly-strings.yml"] = 674,
    ["bashly.yml"] = 672,
    ["batect.yml"] = 58,
    ["beau.yml"] = 590,
    ...
    ["gitlab-ci"] = 232,
    ["global.json"] = 234,
    ["golangci-lint Configuration"] = 235,
    ["haxelib.json"] = 248,
    helmfile = 573,
    ["host-meta.json"] = 253,
    ["host.json"] = 252,
    ...
    ["ide.host.json"] = 258,
    ["ifstate.conf"] = 259,
    ["imageoptimizer.json"] = 260,
    ["importmap.json"] = 263,
    ["ioBroker Configuration"] = 264,
    ["ioBroker JSON UI"] = 265,
    ["ioBroker Package manifest"] = 266,
    ["ize.toml"] = 664,
    ["jsconfig.json"] = 287,
    ["jscpd Configuration Schema"] = 646,
    jsdoc = 570,
    ["k3d.yaml"] = 288,
    ["kontinuous-values.yaml"] = 293,
    ["kustomization.yaml"] = 294,
    ["label-commenter-config.yml"] = 295,
    ["launchsettings.json"] = 296,
    ["lego.json"] = 297,
    ["lerna.json"] = 298,
    ["lgtm.yml"] = 299,
    ["libman.json"] = 300,
    ["license-report-config.json"] = 301,
    ["linkinator.config.json"] = 302,
    ["local.settings.json"] = 307,
    ["localazy.json"] = 308,
    ["lotus.yaml"] = 306,
    ["lsdlschema.json"] = 309,
    ["markdown-lint-check"] = 608,
    mboats = 615,
    ["micro-settings.json"] = 675,
    ["mimetypes.json"] = 316,
    ["mirrord-schema"] = 553,
    ["mta.yaml"] = 554,
    ["mtad.yaml"] = 555,
    ...
    neoload = 565,
    ["nest-cli"] = 343,
    ["ninjs (News in JSON) 1.3"] = 342,
    ["ninjs (News in JSON) 2.0"] = 341,
    ["nlu.json"] = 344,
    ["nodemon.json"] = 346,
    ["noodl.schema.json"] = 614,
    now = 561,
    ["npm-badges"] = 349,
    ["nswag.json"] = 352,
    ntangle = 353,
    ["nuclei-template.yaml"] = 350,
    ["nuget-project.json"] = 351,
    ["ocelot.json"] = 355,
    ["omnisharp.json"] = 356,
    ["openapi.json"] = 357,
    ["openfin.json"] = 360,
    ["openrpc.json"] = 358,
    ["package.json"] = 371,
    ["package.manifest"] = 372,
    ["pattern.json"] = 375,
    ["petstore-v1.0"] = 656,
    pgap_yaml_input_reader = 374,
    ["plagiarize-me.yaml"] = 379,
    ["plagiarize.yaml"] = 378,
    ["portman.json"] = 380,
    ["prettierrc.json"] = 386,
    ["prisma.yml"] = 387,
    ["project-1.0.0-beta3.json"] = 389,
    ["project-1.0.0-beta4.json"] = 390,
    ["project-1.0.0-beta5.json"] = 391,
    ["project-1.0.0-beta6.json"] = 392,
    ["project-1.0.0-beta8.json"] = 393,
    ["project-1.0.0-rc1.json"] = 394,
    ["project-1.0.0-rc2.json"] = 395,
    ["project.json"] = 388,
    ["prometheus.json"] = 396,
    ["prometheus.rules.json"] = 397,
    ["proxies.json"] = 398,
    ["publiccode.yml"] = 399,
    ["pubspec.yaml"] = 400,
    ["pyrseas-0.8.json"] = 403,
    ["quilt.mod.json"] = 676,
    ["release drafter"] = 566,
    rtx = 416,
    rustfmt = 422,
    samt = 424,
    samtrc = 425,
    ["sarif-1.0.0.json"] = 427,
    ["sarif-2.0.0.json"] = 428,
    ["sarif-2.1.0"] = 437,
    ["sarif-2.1.0-rtm.2"] = 429,
    ["sarif-2.1.0-rtm.3"] = 431,
    ["sarif-2.1.0-rtm.4"] = 433,
    ["sarif-2.1.0-rtm.5"] = 435,
    ["sarif-external-property-file-2.1.0"] = 438,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 430,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 432,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 434,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 436,
    ["schema.org - Action"] = 440,
    ["schema.org - ContactPoint"] = 441,
    ["schema.org - Place"] = 442,
    ["schema.org - Thing"] = 443,
    ["semantic-release"] = 446,
    ["servicehub.config.json"] = 542,
    ["servicehub.service.json"] = 541,
    ["settings.job"] = 449,
    ["sfdx-hardis configuration"] = 451,
    ["size-limit configuration"] = 453,
    ["skaffold.yaml"] = 606,
    ["skyuxconfig.json"] = 455,
    snapcraft = 456,
    ["stripe-app-local.json"] = 470,
    ["stripe-app.json"] = 469,
    swcrc = 593,
    ["task.json"] = 476,
    taskcat = 562,
    ["template.json"] = 479,
    ["templatsources.json"] = 480,
    ["theme.json"] = 483,
    ["tizen_workspace.json"] = 484,
    tldr = 485,
    tmLanguage = 486,
    tmuxinator = 550,
    ["transcend.yml"] = 492,
    ["trunk.yaml schema"] = 493,
    ["ts-force-config.json"] = 497,
    ["tsconfig.json"] = 494,
    ["tsd.json"] = 495,
    ["tsdrc.json"] = 496,
    ["tslint.json"] = 498,
    ...
    ["vega-lite.json"] = 511,
    ["vega.json"] = 510,
    ["venvironment-basic.yaml"] = 514,
    ["venvironment.yaml"] = 513,
    ["version.json"] = 515,
    ["vim-addon-info"] = 516,
    ["vs-2017.3.host.json"] = 518,
    ["vs-nesting.json"] = 519,
    ["vsls.json"] = 517,
    ["vss-extension.json"] = 523,
    ["vtesttree.yaml"] = 524,
    ["vtestunit.yaml"] = 525,
    ["webhint.io"] = 642,
    ["webjobpublishsettings.json"] = 531,
    ["webjobs-list.json"] = 530,
    ["xs-app.json"] = 558,
    ["xunit.runner.json"] = 540,
    yamllint = 581,
    zuul = 567,
    ["Žinoma"] = 575
  },
