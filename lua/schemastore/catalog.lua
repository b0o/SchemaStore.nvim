...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 91,
    [".cryproj (generic)"] = 379,
    [".cryproj engine-5.2"] = 374,
    [".cryproj engine-5.3"] = 375,
    [".cryproj engine-5.4"] = 376,
    [".cryproj engine-5.5"] = 377,
    [".cryproj engine-dev"] = 378,
    [".csscomb.json"] = 93,
    [".csslintrc"] = 94,
    [".eslintrc"] = 127,
    [".esmrc.json"] = 121,
    ...
    [".mtaext"] = 385,
    [".nodehawkrc"] = 227,
    [".npmpackagejsonlintrc"] = 229,
    [".phraseapp.yml"] = 256,
    [".pmbot.yml"] = 249,
    [".postcssrc"] = 254,
    [".pre-commit-config.yml"] = 255,
    [".putout.json"] = 273,
    [".rehyperc"] = 278,
    [".remarkrc"] = 279,
    [".sprite files"] = 313,
    ...
    [".vsext"] = 355,
    [".yarnrc.yml"] = 417,
    ["<div>RIOTS' studio configuration"] = 358,
    ["API Builder"] = 414,
    ...
    ["Azure Pipelines"] = 28,
    ["Azure Static Web Apps CLI configuration file"] = 315,
    ["Azure Static Web Apps configuration file"] = 314,
    ["Better Code Hub"] = 419,
    BizTalkServerApplicationSchema = 391,
    Briefcase = 396,
    Buildkite = 49,
    ...
    Goreleaser = 152,
    ["Goreleaser Pro"] = 153,
    ["Gradle Build Cache Node"] = 416,
    ["Gradle Enterprise"] = 415,
    ...
    ["JSON Feed"] = 187,
    ["JSON Resume"] = 281,
    ["JSON Schema Draft 2020-12"] = 370,
    ["JSON Schema Draft 4"] = 367,
    ["JSON Schema Draft 7"] = 368,
    ["JSON Schema Draft 8"] = 369,
    ...
    ["Netin Diagnostic System Template"] = 438,
    ["Netlify config schema"] = 222,
    ["Nightwatch.js"] = 223,
    ["OSS Review Toolkit repository configuration"] = 243,
    Opctl = 387,
    ["OpenWeather Current Weather API"] = 423,
    ["OpenWeather Road Risk API"] = 422,
    ["Ory Hydra configuration"] = 170,
    ["Ory Keto configuration"] = 192,
    ["Ory Kratos configuration"] = 242,
    ["Ory Oathkeeper configuration"] = 234,
    ["Outblocks App configuration"] = 240,
    ["Outblocks database table"] = 241,
    ["Outblocks project configuration"] = 239,
    Packer = 246,
    ["Pipeline component"] = 432,
    ["PocketMine plugin.yml"] = 250,
    ["Pull Request Labeler"] = 272,
    ["RKE Cluster Configuration JSON Schema"] = 430,
    ["RKE Cluster Configuration YAML Schema"] = 429,
    Ray = 399,
    ["Read the Docs"] = 275,
    ["Red-DiscordBot Сog"] = 276,
    ["Red-DiscordBot Сog Repo"] = 277,
    Renovate = 282,
    RoadRunner = 283,
    SWADL = 323,
    ["Sapphire CLI Config"] = 284,
    ["SauceCTL Configuration"] = 435,
    ["Schema Catalog"] = 297,
    ["Scoop manifest"] = 302,
    ["Semgrep Rule"] = 303,
    ["Serverless Framework Configuration"] = 442,
    Solidarity = 309,
    ["Source Maps v3"] = 310,
    SpecIF = 311,
    ["Sponge Mixin configuration"] = 312,
    ["StackHawk Scanner Configuration"] = 441,
    ["StackHead CLI config"] = 316,
    ["StackHead module configuration"] = 317,
    ["StackHead project definition"] = 318,
    Stale = 319,
    ["Stryker Mutator"] = 320,
    ["StyleCop Analyzers Configuration"] = 321,
    ["Swagger API 2.0"] = 324,
    ["Taskfile YAML Schema"] = 425,
    Taurus = 325,
    ["TestEnvironment.json"] = 330,
    ["Traefik v2"] = 332,
    ["Traefik v2 File Provider"] = 333,
    ["UI5 Manifest"] = 344,
    ["Uniswap Token List"] = 408,
    ["User Journey Map YAML Schema"] = 428,
    ["VSCode Code Snippets"] = 70,
    ["VSIX CLI publishing"] = 356,
    ["Vela Pipeline Configuration"] = 348,
    ["Web App Manifest"] = 360,
    ["Web types"] = 363,
    WebExtensions = 359,
    ["Windows Package Manager Installer Manifest"] = 405,
    ["Windows Package Manager Locale Manifest"] = 406,
    ["Windows Package Manager Singleton Manifest"] = 404,
    ["Woodpecker pipeline config"] = 437,
    ["Yippee-Ki-JSON configuration YML"] = 410,
    ["angular.json"] = 6,
    ...
    neoload = 393,
    ["nest-cli"] = 225,
    ["ninjs (News in JSON)"] = 224,
    ["nlu.json"] = 226,
    ["nodemon.json"] = 228,
    ["noodl.schema.json"] = 439,
    now = 389,
    ["nswag.json"] = 232,
    ntangle = 233,
    ["nuclei-template.yaml"] = 230,
    ["nuget-project.json"] = 231,
    ["ocelot.json"] = 235,
    ["omnisharp.json"] = 236,
    ["openapi.json"] = 237,
    ["openfin.json"] = 238,
    ["package.json"] = 244,
    ["package.manifest"] = 245,
    ["pattern.json"] = 248,
    pgap_yaml_input_reader = 247,
    ["plagiarize-me.yaml"] = 252,
    ["plagiarize.yaml"] = 251,
    ["portman.json"] = 253,
    ["prettierrc.json"] = 257,
    ["prisma.yml"] = 258,
    ["project-1.0.0-beta3.json"] = 260,
    ["project-1.0.0-beta4.json"] = 261,
    ["project-1.0.0-beta5.json"] = 262,
    ["project-1.0.0-beta6.json"] = 263,
    ["project-1.0.0-beta8.json"] = 264,
    ["project-1.0.0-rc1.json"] = 265,
    ["project-1.0.0-rc2.json"] = 266,
    ["project.json"] = 259,
    ["prometheus.json"] = 267,
    ["prometheus.rules.json"] = 268,
    ["proxies.json"] = 269,
    ["publiccode.yml"] = 270,
    ["pubspec.yaml"] = 271,
    ["pyrseas-0.8.json"] = 274,
    ["release drafter"] = 394,
    ["sarif-1.0.0.json"] = 285,
    ["sarif-2.0.0.json"] = 286,
    ["sarif-2.1.0"] = 295,
    ["sarif-2.1.0-rtm.2"] = 287,
    ["sarif-2.1.0-rtm.3"] = 289,
    ["sarif-2.1.0-rtm.4"] = 291,
    ["sarif-2.1.0-rtm.5"] = 293,
    ["sarif-external-property-file-2.1.0"] = 296,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 288,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 290,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 292,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 294,
    ["schema.org - Action"] = 298,
    ["schema.org - ContactPoint"] = 299,
    ["schema.org - Place"] = 300,
    ["schema.org - Thing"] = 301,
    ["servicehub.config.json"] = 373,
    ["servicehub.service.json"] = 372,
    ["settings.job"] = 304,
    ["sfdx-hardis configuration"] = 305,
    ["size-limit configuration"] = 306,
    ["skaffold.yaml"] = 433,
    ["skyuxconfig.json"] = 307,
    snapcraft = 308,
    swcrc = 421,
    taskcat = 390,
    ["template.json"] = 326,
    ["templatsources.json"] = 327,
    ["theme.json"] = 328,
    tmLanguage = 329,
    ["trunk.yaml schema"] = 334,
    ["ts-force-config.json"] = 338,
    ["tsconfig.json"] = 335,
    ["tsd.json"] = 336,
    ["tsdrc.json"] = 337,
    ["tslint.json"] = 339,
    ...
    ["version.json"] = 349,
    ["vim-addon-info"] = 350,
    ["vs-2017.3.host.json"] = 352,
    ["vs-nesting.json"] = 353,
    ["vsls.json"] = 351,
    ["vss-extension.json"] = 357,
    ["webjobpublishsettings.json"] = 362,
    ["webjobs-list.json"] = 361,
    ["xs-app.json"] = 386,
    ["xunit.runner.json"] = 371,
    yamllint = 409,
    zuul = 395,
    ["Žinoma"] = 403
  },
