...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 819,
    [".nodehawkrc"] = 510,
    [".npmpackagejsonlintrc"] = 514,
    [".omletrc"] = 995,
    [".phrase.yml"] = 576,
    [".phraseapp.yml"] = 577,
    [".pmbot.yml"] = 564,
    [".postcssrc"] = 571,
    [".powerpages-web-template-manifest"] = 573,
    [".pre-commit-config.yml"] = 574,
    [".pre-commit-hooks.yml"] = 575,
    [".putout.json"] = 604,
    [".rehyperc"] = 627,
    [".remarkrc"] = 631,
    [".sprite files"] = 699,
    ...
    ["A micro editor config"] = 462,
    ABCInventoryModuleData = 18,
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1039,
    ["API Builder"] = 854,
    ["AVA Configuration"] = 916,
    ["AWS AppConfig Feature Flags-v1"] = 49,
    ["AWS CDK cdk.json"] = 212,
    ["AWS CloudFormation"] = 213,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 214,
    ["AWS SAM CLI Samconfig"] = 215,
    ["Adobe UXP Manifest"] = 978,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1067,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 888,
    ["All Contributors configuration file"] = 941,
    ["Ansible Argument Specs"] = 345,
    ["Ansible Collection Galaxy"] = 352,
    ["Ansible Execution Environment"] = 342,
    ["Ansible Inventory"] = 351,
    ["Ansible Meta"] = 343,
    ["Ansible Meta Runtime"] = 344,
    ["Ansible Navigator Configuration"] = 354,
    ["Ansible Playbook"] = 349,
    ["Ansible Requirements"] = 346,
    ["Ansible Rulebook"] = 350,
    ["Ansible Tasks File"] = 348,
    ["Ansible Vars File"] = 347,
    ["Ansible-lint Configuration"] = 353,
    Any = 1004,
    ["AnyWork Automation Configuration"] = 9,
    ["App config Spotify Backstage"] = 25,
    ["Application Accelerator"] = 6,
    ["Application list for a WinUtil"] = 1021,
    ArchitectFX = 1026,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure Pipelines"] = 77,
    ["Azure Static Web Apps CLI configuration file"] = 703,
    ["Azure Static Web Apps configuration file"] = 702,
    ["BOSH Deploy Config"] = 101,
    ["BX CI"] = 119,
    ["Bashly (bashly.yml)"] = 945,
    ["Bashly Settings (bashly-settings.yml)"] = 946,
    ["Better Code Hub"] = 858,
    ["Better Scripts"] = 120,
    Bigconfig = 94,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1032,
    BizTalkServerApplicationSchema = 826,
    Bleep = 121,
    ["Block Protocol Metadata"] = 118,
    ["Boyka Framework"] = 102,
    Briefcase = 832,
    ["Build Info"] = 109,
    Buildkite = 111,
    ["Bukkit plugin.yml"] = 110,
    ["BungeeCord plugin.yml"] = 116,
    ["Butane Config"] = 901,
    C4InterFlow = 1047,
    ["CDK Environment Manager, concrete environment configuration"] = 1070,
    ["CDK Environment Manager, concrete environments definition"] = 1069,
    ["CDK Environment Manager, environment definition"] = 1068,
    ["CGS Card Game Specification (cgs.json)"] = 983,
    ["CICS TS region tagging"] = 910,
    ["CICS TS resource import"] = 911,
    ["CICS TS resource model"] = 912,
    ["CICS TS resource overrides"] = 913,
    ["CMake Presets"] = 122,
    ["CNC Codes"] = 141,
    ["CRS WAF test file"] = 1011,
    ["CRS WAF test platform overrides file"] = 1012,
    ["CSS Comb (.csscomb.json)"] = 240,
    ["CSS Lint (.csslintrc)"] = 241,
    ["CSpell (cspell.json)"] = 239,
    ["CVE Record Format"] = 148,
    CWL = 989,
    ["Cache Warmup config"] = 123,
    ["Calqulus pipeline"] = 124,
    ["Camel YAML DSL"] = 125,
    ["Cannon TOML"] = 126,
    Carafe = 127,
    ["Cargo Make"] = 129,
    ["Cargo Manifest"] = 128,
    ["Catalog Info Backstage"] = 130,
    ["Chamaleon environment"] = 1036,
    ["Chamaleon properties"] = 1037,
    ["Chamaleon template"] = 1035,
    Changesets = 224,
    Charmcraft = 131,
    Cheatsheets = 898,
    ["Chrome Extension"] = 205,
    ["Chromia Model"] = 132,
    ["Chromia Seeder Module Config"] = 134,
    ["Chromia Seeder Root Config"] = 133,
    ["Cinnamon Spice info.json"] = 69,
    ["CircleCI config.yml"] = 181,
    ["Citation File Format"] = 226,
    CityJSON = 136,
    ["Clawject config"] = 147,
    ["Cloud Foundry Application Manifest"] = 994,
    ["Cloud Run Spec v1"] = 1016,
    ["CloudCannon Configuration"] = 73,
    ["CloudEvents specification"] = 137,
    ["Code Climate"] = 182,
    CodeCV = 71,
    CodeRabbit = 70,
    ["CodeShip Pro services configuration files"] = 194,
    ["CodeShip Pro steps configuration files"] = 195,
    ["Codecov configuration files"] = 193,
    CodifyCLI = 72,
    Codux = 191,
    ["Cog config file"] = 142,
    ["Commandbox Box.json"] = 143,
    ["Commandbox Server.json"] = 144,
    ["Common Catalog Data"] = 203,
    ["Common Package Specification"] = 145,
    Concord = 1010,
    ["Configu .cfgu files"] = 999,
    ["Configu .configu file"] = 1000,
    Conjure = 140,
    ["Container Structure Test"] = 840,
    Containerlab = 867,
    ["Contextive Glossary"] = 1062,
    Convex = 139,
    ["Crowdsec collection config"] = 234,
    ["Crowdsec parser config"] = 235,
    ["Crowdsec scenario config"] = 236,
    ["CumulusCI Config"] = 146,
    ["Custom Machinery Machine"] = 984,
    ["Custom Machinery Recipe"] = 985,
    ["Cycle Stack File"] = 149,
    CycloneDX = 150,
    ["DWP Exchange - catalogue entry"] = 283,
    ["DWP Exchange - gateway"] = 281,
    ["DWP Exchange - meta"] = 282,
    ["Dart Build Config (dart-build.json)"] = 242,
    ["Dart Test Config (dart-test.json)"] = 243,
    ["DashLord Configuration"] = 244,
    ["Data Contract Specification"] = 245,
    ["Data Product Specification"] = 246,
    ["DataYoga Connections"] = 151,
    ["DataYoga Job"] = 152,
    ["Databricks Asset Bundles"] = 962,
    ["Datadog Service Definition"] = 435,
    ["Datadog Software Catalog"] = 436,
    ["Datahub Ingestion Recipe"] = 917,
    ["Dein Config"] = 158,
    ["Deno Config (deno.json)"] = 252,
    ["Dependency cruiser"] = 159,
    ["DeployStack Configuration"] = 160,
    ["Deployer Recipe"] = 255,
    ["Deta Spacefile"] = 161,
    ["Detekt Config (detekt.yml)"] = 256,
    ["Devbox Config"] = 162,
    ["Devbox Plugin"] = 163,
    Devfile = 280,
    DipDup = 1013,
    ["Discord Webhook"] = 257,
    ["DocFx Config (docfx.json)"] = 261,
    Dofigen = 262,
    ["Dolittle Artifacts"] = 263,
    ["Dolittle Bounded Context Configuration"] = 264,
    ["Dolittle Event Horizons Configuration"] = 265,
    ["Dolittle Resources Configuration"] = 266,
    ["Dolittle Server Configuration"] = 267,
    ["Dolittle Tenant Map Configuration"] = 269,
    ["Dolittle Tenants Configuration"] = 268,
    ["Dolittle Topology"] = 270,
    ["DonateCaseBetterCasino menu"] = 1040,
    ["Drupal Breakpoints"] = 164,
    ["Drupal Config"] = 176,
    ["Drupal Info"] = 165,
    ["Drupal Layouts"] = 166,
    ["Drupal Libraries"] = 167,
    ["Drupal Links Action"] = 168,
    ["Drupal Links Contextual"] = 169,
    ["Drupal Links Menu"] = 170,
    ["Drupal Links Task"] = 171,
    ["Drupal Migration"] = 172,
    ["Drupal Permissions"] = 173,
    ["Drupal Recipe"] = 174,
    ["Drupal Routing"] = 175,
    ["Drupal Services"] = 177,
    ["Drush site aliases"] = 276,
    ["Dynamic Bash Aliases (.aliases)"] = 953,
    ["EAS config"] = 300,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 942,
    ["EasyVCR .NET"] = 301,
    ["Eidolon Resource"] = 1027,
    ["Elgato Stream Deck"] = 286,
    Elm = 1015,
    ["Embrace Config"] = 928,
    Endurica = 966,
    ["Enterprise Contract Policy Spec"] = 287,
    ["Erda Pipeline"] = 991,
    ["Erda Runtime"] = 992,
    Esquio = 289,
    ["Estuary Flow Catalog"] = 907,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 293,
    ["EveryVoice TTS Toolkit Data Configuration"] = 294,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 298,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 297,
    ["EveryVoice TTS Toolkit Text Configuration"] = 295,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 296,
    ["Expo SDK"] = 299,
    ["F-Droid Data metadata"] = 305,
    ["FasterCI Configuration"] = 78,
    FiQuS = 309,
    Firebase = 307,
    ["FlexGet Config"] = 310,
    ["Flow.json Configurations"] = 988,
    ["Fossa configuration file"] = 317,
    ["Fossa's fossa-deps file"] = 318,
    ["Foundry VTT - Base package Manifest"] = 312,
    ["Foundry VTT - Module Manifest"] = 313,
    ["Foundry VTT - System Data Template"] = 316,
    ["Foundry VTT - System Manifest"] = 314,
    ["Foundry VTT - World Manifest"] = 315,
    ["Foxx Manifest"] = 79,
    ["Freifunk.de Community API"] = 82,
    ["Frogbot Config"] = 83,
    ["G2P Mapping Configuration"] = 323,
    ["GCP Blueprint Metadata"] = 326,
    Gaspar = 324,
    ["GatewayCore API Gateway"] = 325,
    ["GeoJSON.json latest"] = 905,
    GherKing = 909,
    ["GitHub Action"] = 331,
    ["GitHub Actions typing"] = 1023,
    ["GitHub Discussion"] = 332,
    ["GitHub Funding"] = 333,
    ["GitHub Issue Template configuration"] = 334,
    ["GitHub Issue Template forms"] = 335,
    ["GitHub Workflow"] = 336,
    ["GitHub Workflow Template Properties"] = 337,
    ["GitHub automatically generated release notes configuration"] = 338,
    ["GitLab Agent for Kubernetes configuration"] = 980,
    GitVersion = 328,
    ["Gitea Issue Template configuration"] = 329,
    ["Gitea Issue Template forms"] = 330,
    ["Gitpod Automations"] = 340,
    ["Gitpod Configuration"] = 341,
    ["GlazeWM settings"] = 982,
    ["Global Privacy Control"] = 327,
    Goblet = 961,
    ["Golangci-lint Configuration"] = 356,
    ["Golangci-lint Custom Plugins Configuration"] = 357,
    ["Google Chrome Related Website Sets"] = 308,
    ["Google Cloud Workflows"] = 211,
    ["Google Digital Assetlinks"] = 1063,
    Goreleaser = 359,
    ["Goreleaser Pro"] = 360,
    Goss = 361,
    ["Gradle Build Cache Node"] = 856,
    ["Gradle Enterprise"] = 855,
    ["Grafana 5.x Dashboard"] = 362,
    ["GraphQL Code Generator"] = 366,
    ["GraphQL Config"] = 365,
    ["GraphQL Mesh"] = 364,
    ["Grunt JSHint task"] = 370,
    ["Grunt Watch task"] = 371,
    ["Grunt base task"] = 372,
    ["Grunt clean task"] = 368,
    ["Grunt copy task"] = 367,
    ["Grunt cssmin task"] = 369,
    HEMTT = 822,
    Hadolint = 836,
    Hammerkit = 866,
    ["Hardware Sentry Configuration"] = 921,
    Hatch = 837,
    Hayson = 374,
    ["Haystack Pipeline"] = 375,
    ["Hazelcast 5 Configuration"] = 376,
    ["Helm Chart.lock"] = 179,
    ["Helm Chart.yaml"] = 178,
    ["Helm Unittest Test Suite"] = 180,
    ["Home Assistant Integration Manifest"] = 377,
    ["Homer dashboard configuration"] = 378,
    Hugo = 897,
    ["Hugo Theme"] = 896,
    ["Hyperfoil benchmark configuration"] = 384,
    ["IBM Zapp document"] = 385,
    ["IBM zCodeFormatSettings"] = 386,
    ["IMG Catapult PSP"] = 391,
    ["IVMS101 by CODE Protocol"] = 981,
    Infrahub = 393,
    Istanbul = 924,
    ["JDownloader2 crawler multi-rules"] = 403,
    ["JDownloader2 crawler single-rules"] = 402,
    ["JFrog Applications Config"] = 404,
    ["JFrog File Spec"] = 405,
    ["JFrog Pipelines YML DSL"] = 930,
    ["JMeter DSL cli config"] = 406,
    JReleaser = 408,
    ["JSON Document Transform"] = 416,
    ["JSON Feed"] = 417,
    ["JSON Resume"] = 636,
    ["JSON Schema Draft 2020-12"] = 805,
    ["JSON Schema Draft 4"] = 802,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 963,
    ["JSON Schema Draft 7"] = 803,
    ["JSON Schema Draft 7 (unofficial strict)"] = 964,
    ["JSON Schema Draft 8 (2019-09)"] = 804,
    ["JSON-API"] = 415,
    ["JSON-e templates"] = 863,
    ["JSON-stat 2.0"] = 798,
    JSONPatch = 419,
    ["JSR Package Config (jsr.json)"] = 409,
    Jasmine = 397,
    Jekyll = 398,
    ["Jenkins X Pipelines"] = 399,
    ["Jenkins X Requirements"] = 400,
    Jest = 401,
    ["Jovo Language Models"] = 407,
    ["KIMMDY config file"] = 430,
    ["KODE/CI build.yaml"] = 926,
    ["KSP-AVC"] = 799,
    ["KSP-CKAN"] = 800,
    ["KSP-NetKAN"] = 801,
    KSY = 993,
    KSail = 321,
    ["Karakum configuration file"] = 319,
    Kas = 422,
    ["Kestra flow file"] = 431,
    ["Keycloak REST API"] = 933,
    ["Knative Functions - func.yaml"] = 320,
    ["Kometa (nightly) config file"] = 433,
    ["Kometa config file"] = 432,
    ["Kong DBLess config"] = 927,
    KrakenD = 434,
    ["Kubri Configuration"] = 440,
    LOOBin = 455,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 216,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 217,
    ["Landing Zone Accelerator on AWS - Global Config"] = 218,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 219,
    ["Landing Zone Accelerator on AWS - Network Config"] = 220,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 221,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 222,
    ["Landing Zone Accelerator on AWS - Security Config"] = 223,
    ["Language configuration"] = 1003,
    Lefthook = 444,
    ["Liferay client-extension.yaml"] = 451,
    ["LinkML Metamodel"] = 453,
    Liquibase = 872,
    ["Liquibase Flow File"] = 873,
    ["Lively Properties"] = 454,
    ["Lobe AI Agent"] = 75,
    Loki = 76,
    ["MLOS Configs"] = 493,
    ["MS2Rescore Configuration"] = 496,
    ["Madness (madness.yml)"] = 944,
    ["MapEHR Mapping"] = 461,
    Markdownlint = 876,
    ["Mason Registry"] = 879,
    ["MegaLinter configuration"] = 463,
    ["MegaLinter descriptor"] = 464,
    Melange = 971,
    ["Meltano project definition"] = 465,
    ["Mergify Configuration"] = 497,
    ["Metadata for a Bazel module"] = 466,
    ["Metadata for a Cinnamon spice"] = 1019,
    ["Metatype Configuration"] = 467,
    ["MetricsHub Configuration"] = 468,
    ["MetricsHub Connector Configuration"] = 469,
    ["Micro Editor Syntax"] = 954,
    ["Microsoft Band Web Tile"] = 470,
    ["Microsoft RulesEngine workflow rules"] = 1007,
    ["Microsoft RulesEngine workflow rules list"] = 1008,
    ["Minecraft Custom Main Menu Mod"] = 972,
    ["Minecraft Data Pack Advancement"] = 472,
    ["Minecraft Data Pack Biome"] = 473,
    ["Minecraft Data Pack Configured Carver"] = 474,
    ["Minecraft Data Pack Damage Type"] = 475,
    ["Minecraft Data Pack Dimension"] = 477,
    ["Minecraft Data Pack Dimension Type"] = 476,
    ["Minecraft Data Pack Item Modifier"] = 478,
    ["Minecraft Data Pack Loot Table"] = 479,
    ["Minecraft Data Pack Metadata"] = 480,
    ["Minecraft Data Pack Predicate"] = 481,
    ["Minecraft Data Pack Recipe"] = 482,
    ["Minecraft Data Pack Tag"] = 483,
    ["Minecraft Data Pack Template Pool"] = 484,
    ["Minecraft Data Pack Trim Material"] = 489,
    ["Minecraft Data Pack Trim Pattern"] = 490,
    ["Minecraft Resource Pack Lang"] = 485,
    ["Minecraft Resource Pack Particle"] = 486,
    ["Minecraft Resource Pack Texture Mcmeta"] = 488,
    ["Minecraft Resourcepack Sounds"] = 487,
    ["Monade CLI Stack Configuration"] = 500,
    ["MongoDB Atlas Search Index Definition"] = 925,
    ["Monika Configuration"] = 923,
    ["Monoweave Configuration"] = 495,
    ["Motif config"] = 818,
    MultiQC = 1056,
    ["NOX Framework (Service)"] = 513,
    ["Netin Diagnostic System Template"] = 883,
    ["Netlify config"] = 503,
    ["Network-as-Code Data Model"] = 504,
    ["Nightwatch.js"] = 506,
    ["Node.js configuration"] = 823,
    ["NueJS configuration file"] = 518,
    ["Nuitka.yaml"] = 986,
    ["Nullstone config"] = 520,
    ["ONe's changelog entry"] = 534,
    ["ONe's service descriptor"] = 533,
    ["ORT Server repository environment configuration"] = 541,
    ["OSCAL Assessment Plan (AP)"] = 543,
    ["OSCAL Assessment Results (AR)"] = 544,
    ["OSCAL Catalog"] = 545,
    ["OSCAL Component Definition (CDef)"] = 546,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 547,
    ["OSCAL Profile"] = 548,
    ["OSCAL System Security Plan (SSP)"] = 549,
    ["OSS Review Toolkit configuration"] = 550,
    ["OSS Review Toolkit curation"] = 551,
    ["OSS Review Toolkit package configuration"] = 552,
    ["OSS Review Toolkit repository configuration"] = 553,
    ["OSS Review Toolkit resolutions"] = 554,
    ["October CMS columns"] = 524,
    ["October CMS fields"] = 525,
    Okteto = 526,
    Opctl = 821,
    ["Open Data Contract Standard (ODCS)"] = 537,
    ["Open Know-How"] = 1061,
    ["OpenRewrite Resource"] = 536,
    ["OpenUtau character yaml"] = 530,
    ["OpenUtau ustx"] = 531,
    ["OpenWeather Current Weather API"] = 862,
    ["OpenWeather Road Risk API"] = 861,
    ["Ory Hydra configuration"] = 383,
    ["Ory Keto configuration"] = 437,
    ["Ory Kratos configuration"] = 542,
    ["Ory Oathkeeper configuration"] = 522,
    ["Outblocks App configuration"] = 539,
    ["Outblocks database table"] = 540,
    ["Outblocks project configuration"] = 538,
    PDM = 560,
    Packer = 557,
    Pantsbuild = 940,
    ["Paper paper-plugin.yml"] = 558,
    ["Pipeline component"] = 874,
    ["Platform.sh application"] = 2,
    ["Platform.sh routes"] = 3,
    ["Platform.sh services"] = 4,
    ["Plex Prerolls"] = 568,
    ["PocketMine plugin.yml"] = 565,
    ["Postman collection"] = 572,
    ["Preset list for a WinUtil"] = 1022,
    ["ProActions AI-Kit Configuration"] = 581,
    ["ProActions AI-Kit Configuration for Menus"] = 583,
    ["ProActions AI-Kit Configuration for Sections"] = 585,
    ["ProActions AI-Kit Configuration for Services"] = 582,
    ["ProActions AI-Kit Configuration for Steps"] = 586,
    ["ProActions AI-Kit Configuration for Templates"] = 584,
    ["Problem object RFC9457"] = 969,
    ["Problem package generators"] = 587,
    Pterodactyl = 920,
    ["Pull Request Labeler"] = 603,
    Pulumi = 611,
    ["PyGTA Config"] = 607,
    PyProject = 612,
    Pylock = 1064,
    Pyright = 613,
    ["Python script metadata"] = 1058,
    Qgoda = 615,
    Qodana = 893,
    ["Qt Creator workspace file"] = 1001,
    ["Quali Torque Blueprint Spec 2"] = 918,
    ["QueryFirst config file"] = 936,
    ["RKE Cluster Configuration JSON"] = 871,
    ["RKE Cluster Configuration YAML"] = 870,
    RadioHound = 606,
    Railway = 616,
    ["Rancher Fleet"] = 608,
    ["Rattler-build"] = 617,
    Ray = 835,
    ["Read the Docs"] = 610,
    ["Red-DiscordBot Cog"] = 624,
    ["Red-DiscordBot Cog Repo"] = 625,
    ["Red-DiscordBot Trivia"] = 626,
    ["Render Blueprints"] = 869,
    RenderCV = 638,
    Renovate = 637,
    ["Replit config"] = 632,
    Restate = 1051,
    RoadRunner = 640,
    ["Roo Coder Custom Modes"] = 642,
    ["Rudder techniques"] = 976,
    Ruff = 634,
    ["Rust Project"] = 635,
    ["Rust toolchain"] = 645,
    ["SDMX data message"] = 671,
    ["SDMX metadata message"] = 670,
    ["SDMX structure message"] = 669,
    ["SIL Kit Participant Configuration"] = 681,
    ["SIL Kit Registry Configuration"] = 682,
    ["SPDX 2.3"] = 700,
    SWADL = 714,
    ["Safebox Config"] = 931,
    ["Sapphire CLI Config"] = 648,
    ["SauceCTL Configuration"] = 880,
    ["Schema Catalog"] = 663,
    ["Scoop manifest"] = 668,
    ["Semantic Data Fabric (SDF) file"] = 672,
    ["Semgrep Rule"] = 674,
    ["Serenity Code Generator (Sergen)"] = 675,
    ["Serverless Framework Configuration"] = 887,
    ["Serverless Workflow"] = 889,
    ["Settings for a Cinnamon spice"] = 1018,
    ["Settings.paf"] = 677,
    ["Shopware 6 Configuration"] = 890,
    ["Shopware CLI Extension Store Configuration"] = 891,
    ["Shopware CLI Project Store Configuration"] = 892,
    ["Sigma Detection Rule"] = 679,
    ["Sigrid scope configuration file"] = 680,
    ["SkyPilot Task JSON"] = 977,
    ["Slack app manifest"] = 684,
    Solidarity = 689,
    ["Solution filters"] = 690,
    ["Source Maps v3"] = 691,
    Sourcery = 692,
    ["Speakeasy Generation Config File"] = 696,
    ["Speakeasy Lint Configuration File"] = 693,
    ["Speakeasy Test Generation Configuration File"] = 694,
    ["Speakeasy Workflow File"] = 695,
    SpecIF = 697,
    ["Sponge Mixin configuration"] = 698,
    StackBlitz = 704,
    ["StackHawk Scanner Configuration"] = 886,
    Stale = 705,
    ["Starlake Data Pipeline"] = 859,
    Starship = 706,
    ["Statamic Blueprint"] = 707,
    ["Stella configuration file"] = 708,
    ["Stryker Mutator"] = 711,
    ["StyleCop Analyzers Configuration"] = 712,
    ["Stylelint (.stylelintrc)"] = 713,
    ["Stylua Config"] = 1065,
    ["Sublime Syntax"] = 932,
    ["Subsquid squid manifest"] = 979,
    ["Swagger API 2.0"] = 715,
    ["Synadia Connect Component"] = 716,
    TSON = 750,
    TSTyche = 751,
    ["Tab data for a LinUtil"] = 1025,
    ["Tab list for a LinUtil"] = 1024,
    Tach = 717,
    ["Tach Domain"] = 718,
    Talhelper = 720,
    ["Talisman configuration"] = 721,
    Taplo = 1066,
    ["Taskfile config"] = 864,
    Taurus = 722,
    Tauticord = 723,
    Telefonistka = 1052,
    ["TestEnvironment.json"] = 733,
    ["TextMate Grammar"] = 732,
    ["Tier.run pricing.json"] = 726,
    Tikibase = 727,
    Tombi = 731,
    ["Traefik v2"] = 736,
    ["Traefik v2 File Provider"] = 737,
    ["Traefik v3"] = 738,
    ["Traefik v3 File Provider"] = 739,
    ["Travis CI (.travis.yml)"] = 735,
    Trident = 1049,
    ["TrueScript for *.tscript files"] = 742,
    ["Tugboat QA config.yml"] = 1046,
    TunnelHub = 967,
    Turborepo = 734,
    Tycho = 1014,
    Tye = 894,
    ["Tyk Gateway - Open Source v5.7+"] = 1057,
    ["Typst Manifest"] = 756,
    ["UET BuildConfig.json"] = 937,
    ["UI5 Manifest"] = 762,
    ["UNCORS configuration"] = 766,
    ["UTAM Page Object"] = 765,
    ["Ubuntu Server Autoinstall"] = 760,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1050,
    ["Uniswap Token List"] = 847,
    ["Universal Schedule Format"] = 767,
    ["Unreal Engine Uplugin"] = 938,
    ["Unreal Engine Uproject"] = 939,
    ["Updatecli Compose"] = 902,
    ["Updatecli Policy Manifest"] = 903,
    ["Updatecli Policy Metadata"] = 904,
    Uplift = 935,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 868,
    V2Ray = 908,
    ["VSCode Code Snippets"] = 199,
    ["VSIX CLI publishing"] = 787,
    Vector = 769,
    ["Vela Pipeline Configuration"] = 772,
    Vercel = 198,
    ["Version Bumper config"] = 777,
    ["Viash Component Config"] = 1054,
    ["Viash Package Config"] = 1055,
    Visivo = 965,
    Wake = 1048,
    ["Waku Config"] = 1028,
    ["Web App Manifest"] = 793,
    ["Web types"] = 796,
    WebExtensions = 792,
    ["Webman package recipe"] = 914,
    ["Windows Package Manager Installer Manifest"] = 843,
    ["Windows Package Manager Locale Manifest"] = 844,
    ["Windows Package Manager Singleton Manifest"] = 842,
    Winutil = 845,
    ["WireMock stub mapping"] = 1031,
    ["Woodpecker pipeline config"] = 882,
    ["Wrangler CLI"] = 797,
    ["Xstate Machine"] = 900,
    ["Yandex Workflow Language"] = 1020,
    ["Yarn Config (.yarnrc.yml)"] = 857,
    ["Yippee-Ki-JSON configuration YML"] = 849,
    ["YouTrack App"] = 1017,
    ["Zerops.io config"] = 1005,
    ["Zerops.io import"] = 1006,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 970,
    ...
    ["behat.yml"] = 103,
    ["bigquery-table"] = 93,
    ["bioimageio resource description"] = 987,
    ...
    ["buf.yaml"] = 65,
    ["bun.lock"] = 113,
    ["bundleconfig.json"] = 114,
    ["bunfig.toml"] = 115,
    ["ccmod.json"] = 1029,
    changelogging = 998,
    ["chisel-slices.json"] = 225,
    ["chrome-extension-locales-messages.json"] = 206,
    ["chutzpah.json"] = 207,
    cibuildwheel = 135,
    ["clang-format (.clang-format)"] = 906,
    ["clang-tidy"] = 186,
    clangd = 185,
    clib = 187,
    ["cloud-init: cloud-config userdata"] = 189,
    ["cloud-sdk-pipeline-configuration"] = 209,
    ["cloudbuild.json"] = 210,
    cloudify = 188,
    codemagic = 190,
    ["coffeelint.json"] = 227,
    ["commands.json"] = 202,
    ["commitlint (.commitlintrc)"] = 846,
    ["committed.toml"] = 228,
    ["compile_commands.json"] = 201,
    ["compilerconfig.json"] = 200,
    ["completely.yml"] = 943,
    ["component-detection-manifest.json"] = 231,
    ["component.json"] = 230,
    ["composer.json"] = 229,
    ["conda-forge"] = 138,
    ["config.yaml"] = 609,
    ["contentmanifest.json"] = 208,
    ["contribute.json"] = 232,
    ["cosmos.config.json"] = 204,
    ["crowdin.yml"] = 233,
    ["ctfd-setup configuration file"] = 1038,
    ["custom-elements.json"] = 957,
    ["cypress.json"] = 237,
    ["datalogic-scan2deploy-android"] = 247,
    ["datalogic-scan2deploy-ce"] = 248,
    ["dbt Dependencies"] = 153,
    ["dbt Packages"] = 155,
    ["dbt Project"] = 154,
    ["dbt Selectors"] = 156,
    ["dbt YAML files"] = 157,
    ["ddev-global"] = 249,
    ["ddev-project"] = 250,
    ["debugsettings.json"] = 251,
    ["dependabot-v2.json"] = 254,
    ["dependabot.json"] = 253,
    ["deployed-cli"] = 899,
    ["devcontainer.json"] = 192,
    devinit = 851,
    ["devspace.yaml"] = 922,
    djlint = 852,
    ["docker bake"] = 259,
    ["docker sequencer"] = 260,
    ["docker-compose.yml"] = 850,
    ["dockerd.json"] = 258,
    ["dotnet Release Index manifest"] = 271,
    ["dotnet-tools.json"] = 272,
    ["dotnetcli.host.json"] = 273,
    ["dprint.json"] = 274,
    ["drone.json"] = 275,
    ["dss-2.0.0.json"] = 277,
    ["dstack configuration"] = 278,
    ["dtool dataset metadata"] = 1033,
    ["dvc.yaml"] = 279,
    ["ecosystem.json"] = 284,
    eksctl = 285,
    ["electron-builder configuration file"] = 291,
    ["epr-manifest.json"] = 290,
    ["evcc.yaml"] = 292,
    ["ezd task runner"] = 302,
    ["fabric.mod.json"] = 304,
    ["first-timers-bot"] = 311,
    ["flagd flag configuration"] = 80,
    ["fly.io Configuration"] = 81,
    fulibWorkflows = 881,
    ["function.json"] = 322,
    ["gRPC API Gateway & OpenAPI Config"] = 7,
    ["gematik health care insurance list"] = 1044,
    ["gematik health care patient list"] = 1041,
    ["gematik health care provider institution list"] = 1043,
    ["gematik health care provider list"] = 1042,
    ["gematik tiger test environment configuration"] = 1045,
    ["gitlab-ci"] = 339,
    ["global.json"] = 355,
    ["go-feature-flag Flag Configuration"] = 358,
    ["haxelib.json"] = 373,
    helmfile = 838,
    helmwave = 839,
    ["host-meta.json"] = 380,
    ...
    ["ide.host.json"] = 387,
    ["ifstate.conf"] = 388,
    ["imageoptimizer.json"] = 389,
    ["importmap.json"] = 392,
    ["ioBroker Configuration"] = 394,
    ["ioBroker JSON UI"] = 395,
    ["ioBroker Package manifest"] = 396,
    ["ize.toml"] = 934,
    ["jsconfig.json"] = 420,
    ["jscpd Configuration"] = 919,
    jsdoc = 834,
    ["k3d.yaml"] = 421,
    ["k9s aliases.yaml"] = 423,
    ["k9s cluster-config.yaml"] = 425,
    ["k9s config.yaml"] = 424,
    ["k9s hotkeys.yaml"] = 426,
    ["k9s plugins.yaml"] = 427,
    ["k9s skin.yaml"] = 428,
    ["k9s views.yaml"] = 429,
    ["kontinuous-config.yaml"] = 439,
    ["kontinuous-values.yaml"] = 438,
    ["kustomization.yaml"] = 441,
    ["label-commenter-config.yml"] = 442,
    ["latexindent configuration"] = 74,
    ["launchsettings.json"] = 443,
    lazydocker = 956,
    lazygit = 955,
    ["lego.json"] = 445,
    ["lerna.json"] = 446,
    ["lgtm.yml"] = 447,
    ["liblab.config.json"] = 448,
    ["libman.json"] = 449,
    ["license-report-config.json"] = 450,
    ["linkinator.config.json"] = 452,
    ["lint-staged (.lintstagedrc)"] = 813,
    ["local.settings.json"] = 457,
    ["localazy.json"] = 458,
    ["lotus.yaml"] = 456,
    ["lsdlschema.json"] = 459,
    ["markdown-link-check"] = 877,
    maturin = 878,
    mboats = 885,
    ["micro-settings.json"] = 949,
    ["mimetypes.json"] = 471,
    ["mirrord config"] = 814,
    mise = 815,
    ["mkdocs.yml"] = 491,
    ["monospace.yml"] = 494,
    ["moon.yml"] = 1030,
    ["mprocs Configuration file"] = 1002,
    ["mrdocs.yml"] = 492,
    ["mta.yaml"] = 816,
    ["mtad.yaml"] = 817,
    ["mycode.json"] = 501,
    nFPM = 505,
    ["napari plugin manifest"] = 502,
    neoload = 829,
    ["nest-cli"] = 508,
    ["ninjs (News in JSON)"] = 507,
    ["nitro.json"] = 828,
    ["nixd configuration"] = 975,
    ["nlu.json"] = 509,
    ["nodemon.json"] = 511,
    ["noodl config"] = 884,
    ["notebook.mod.json"] = 512,
    now = 824,
    ["npm-badges"] = 515,
    ["nswag.json"] = 519,
    ntangle = 521,
    ["nuclei-template.yaml"] = 516,
    ["nuget-project.json"] = 517,
    ["ocelot.json"] = 523,
    ["omnisharp.json"] = 527,
    ["openapi.json"] = 528,
    ["openfin.json"] = 535,
    ...
    ["ops.yaml"] = 532,
    ["package.json"] = 555,
    ["package.manifest"] = 556,
    ["partial-black.json"] = 104,
    ["pathfinder.yml"] = 559,
    ["pattern.json"] = 562,
    ["petstore-v1.0"] = 929,
    pgap_yaml_input_reader = 561,
    ["pixi.toml"] = 563,
    ["plagiarize-me.yaml"] = 567,
    ["plagiarize.yaml"] = 566,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1034,
    ["podbard.yaml"] = 569,
    ["portman.json"] = 570,
    ["prefect.toml"] = 578,
    ["prettierrc.json"] = 579,
    ["prisma.yml"] = 580,
    ["project-1.0.0-beta3.json"] = 589,
    ["project-1.0.0-beta4.json"] = 590,
    ["project-1.0.0-beta5.json"] = 591,
    ["project-1.0.0-beta6.json"] = 592,
    ["project-1.0.0-beta8.json"] = 593,
    ["project-1.0.0-rc1.json"] = 594,
    ["project-1.0.0-rc2.json"] = 595,
    ["project.json"] = 588,
    ["project.owasp.yaml"] = 596,
    ["prometheus.json"] = 597,
    ["prometheus.rules.json"] = 598,
    ["prometheus.rules.test.json"] = 599,
    ["proxies.json"] = 600,
    ["publiccode.yml"] = 601,
    ["pubspec.yaml"] = 602,
    ["pyrseas-0.8.json"] = 605,
    pytest = 614,
    ["quilt.mod.json"] = 950,
    ["rc3 auth"] = 618,
    ["rc3 collection"] = 619,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 830,
    ["release-please-config.json"] = 628,
    ["release-please-manifest.json"] = 629,
    ["release-plz.toml"] = 630,
    ["renv.lock"] = 639,
    ["rivet.json"] = 974,
    ["rivet.yaml (legacy)"] = 973,
    rockcraft = 641,
    runny = 643,
    rustfmt = 644,
    sake = 1060,
    samt = 646,
    samtrc = 647,
    ["sarif-1.0.0.json"] = 649,
    ["sarif-2.0.0.json"] = 650,
    ["sarif-2.1.0"] = 660,
    ["sarif-2.1.0-rtm.2"] = 651,
    ["sarif-2.1.0-rtm.3"] = 653,
    ["sarif-2.1.0-rtm.4"] = 655,
    ["sarif-2.1.0-rtm.5"] = 657,
    ["sarif-2.1.0-rtm.6"] = 658,
    ["sarif-external-property-file-2.1.0"] = 661,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 652,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 654,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 656,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 659,
    ["scalingo.json configuration"] = 662,
    ["schema.org - Action"] = 664,
    ["schema.org - ContactPoint"] = 665,
    ["schema.org - Place"] = 666,
    ["schema.org - Thing"] = 667,
    ["secrethub.yml"] = 952,
    ["semantic-release"] = 673,
    ["servicehub.config.json"] = 808,
    ["servicehub.service.json"] = 807,
    ["settings.job"] = 676,
    ["sfdx-hardis configuration"] = 678,
    ["shard.yml"] = 990,
    ["size-limit configuration"] = 683,
    ["skaffold.yaml"] = 875,
    ["skyuxconfig.json"] = 685,
    snapcraft = 686,
    ["snowflake-config"] = 687,
    ["snowflake-connections"] = 688,
    ["spicepod.yaml"] = 1009,
    ["sqlc configuration"] = 701,
    ["stripe-app-local.json"] = 710,
    ["stripe-app.json"] = 709,
    swcrc = 860,
    ["task.json"] = 719,
    taskcat = 825,
    ["template.json"] = 724,
    ["templatsources.json"] = 725,
    ["theme.json"] = 728,
    ["tizen_workspace.json"] = 729,
    tldr = 730,
    ["tm_devices configuration file"] = 1071,
    tmuxinator = 811,
    ["transcend.yml"] = 740,
    ["tree-sitter grammar.json"] = 363,
    ["trime.yaml"] = 741,
    ["trunk.yaml"] = 743,
    ["ts-force-config.json"] = 748,
    ["tsconfig.json"] = 744,
    ["tsd.json"] = 745,
    ["tsdoc.json"] = 746,
    ["tsdrc.json"] = 747,
    ...
    v8r = 791,
    vcluster = 996,
    ["vcpkg configuration file"] = 197,
    ["vcpkg manifest file"] = 196,
    ["vega-lite.json"] = 771,
    ["vega.json"] = 770,
    ["venvironment-basic.yaml"] = 774,
    ["venvironment.yaml"] = 773,
    ["venvplus-basic.yaml"] = 776,
    ["venvplus.yaml"] = 775,
    version = 1053,
    ["version.json"] = 778,
    ["vhwdebugger-binding.yaml"] = 780,
    ["vim-addon-info"] = 781,
    ["vs-2017.3.host.json"] = 783,
    ["vs-nesting.json"] = 784,
    ["vsls.json"] = 782,
    ["vss-extension.json"] = 788,
    vtcfg = 1059,
    ["vtesttree.yaml"] = 789,
    ["vtestunit.yaml"] = 790,
    ["warp-keysets.json"] = 958,
    ["warp-themes.json"] = 959,
    ["warp-workflows.json"] = 960,
    ["webhint.io"] = 915,
    ["webjobpublishsettings.json"] = 795,
    ["webjobs-list.json"] = 794,
    ["well-known-fursona"] = 997,
    ["xs-app.json"] = 820,
    ["xunit.runner.json"] = 806,
    yamllint = 848,
    zuul = 831,
    ["Žinoma"] = 841
  },
