...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 924,
    [".nodehawkrc"] = 571,
    [".npmpackagejsonlintrc"] = 575,
    [".omletrc"] = 1103,
    [".phrase.yml"] = 646,
    [".phraseapp.yml"] = 647,
    [".pmbot.yml"] = 632,
    [".postcssrc"] = 641,
    [".powerpages-web-template-manifest"] = 643,
    [".pre-commit-config.yml"] = 644,
    [".pre-commit-hooks.yml"] = 645,
    [".putout.json"] = 680,
    [".rehyperc"] = 705,
    [".remarkrc"] = 709,
    [".sprite files"] = 800,
    ...
    AIConfig = 31,
    ["AMX Muse Program Descriptor"] = 1151,
    ["API Builder"] = 959,
    ["AVA Configuration"] = 1022,
    ["AWS AppConfig Feature Flags-v1"] = 65,
    ["AWS CDK cdk.json"] = 253,
    ["AWS CloudFormation"] = 254,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 255,
    ["AWS Copilot Manifest"] = 1190,
    ["AWS SAM CLI Samconfig"] = 256,
    ["Adobe UXP Manifest"] = 1085,
    ["Aerleon Network & Service Definitions"] = 18,
    ["Aerleon Policy"] = 19,
    Aider = 1180,
    Air = 21,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1201,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1200,
    ["Airlock Microgateway"] = 32,
    ["Alacritty Configuration"] = 994,
    ["All Contributors configuration file"] = 1048,
    ["Ansible Argument Specs"] = 392,
    ["Ansible Collection Galaxy"] = 399,
    ["Ansible Execution Environment"] = 389,
    ["Ansible Inventory"] = 398,
    ["Ansible Meta"] = 390,
    ["Ansible Meta Runtime"] = 391,
    ["Ansible Navigator Configuration"] = 401,
    ["Ansible Playbook"] = 396,
    ["Ansible Requirements"] = 393,
    ["Ansible Rulebook"] = 397,
    ["Ansible Tasks File"] = 395,
    ["Ansible Vars File"] = 394,
    ["Ansible-lint Configuration"] = 400,
    Any = 1113,
    ...
    ["Application list for a WinUtil"] = 1130,
    ArchitectFX = 1135,
    ["Argo CD"] = 51,
    ["Argo Events"] = 52,
    ["Argo Workflows"] = 53,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1199,
    ["Azure IoT Operations connector metadata"] = 1196,
    ...
    ["Azure Pipelines"] = 107,
    ["Azure Static Web Apps CLI configuration file"] = 804,
    ["Azure Static Web Apps configuration file"] = 803,
    BMML = 1218,
    ["BOSH CPI Config"] = 132,
    ["BOSH Deploy Config"] = 133,
    ["BX CI"] = 152,
    ["Bacon config"] = 3,
    ["Bashly (bashly.yml)"] = 1052,
    ["Bashly Settings (bashly-settings.yml)"] = 1053,
    Bento = 1217,
    ["Better Code Hub"] = 964,
    ["Better Scripts"] = 153,
    Bigconfig = 125,
    ["Biome Formatter Config"] = 79,
    ["Bitmovin Encoding Template"] = 1144,
    BizTalkServerApplicationSchema = 931,
    Bleep = 154,
    ["Block Protocol Metadata"] = 151,
    ["Bluebricks blueprint config"] = 1223,
    ["Boyka Framework"] = 134,
    Briefcase = 937,
    ["Build Info"] = 142,
    Buildkite = 144,
    ...
    ["Butane Config"] = 1007,
    C4InterFlow = 1159,
    ["CDK Environment Manager, concrete environment configuration"] = 1183,
    ["CDK Environment Manager, concrete environments definition"] = 1182,
    ["CDK Environment Manager, environment definition"] = 1181,
    ["CGS Card Game Specification (cgs.json)"] = 1090,
    ["CICS TS region tagging"] = 1016,
    ["CICS TS resource import"] = 1017,
    ["CICS TS resource model"] = 1018,
    ["CICS TS resource overrides"] = 1019,
    ["CMake Presets"] = 155,
    ["CNC Codes"] = 177,
    ["CRS WAF test file"] = 1120,
    ["CRS WAF test platform overrides file"] = 1121,
    ["CSS Comb (.csscomb.json)"] = 281,
    ["CSS Lint (.csslintrc)"] = 282,
    ["CSpell (cspell.json)"] = 280,
    ["CVE Record Format"] = 186,
    CWL = 1096,
    ...
    ["Chamaleon environment"] = 1148,
    ["Chamaleon properties"] = 1149,
    ["Chamaleon template"] = 1147,
    Changepacks = 1210,
    Changesets = 265,
    Changie = 164,
    Charmcraft = 165,
    ...
    ["Chrome Extension"] = 246,
    ["Chromia Model"] = 167,
    ["Chromia Seeder Module Config"] = 169,
    ["Chromia Seeder Root Config"] = 168,
    ["Cinnamon Spice info.json"] = 87,
    ["CircleCI config.yml"] = 221,
    ["Citation File Format"] = 267,
    ["Citrus test case"] = 171,
    CityJSON = 172,
    ["Claude Code Keybindings"] = 184,
    ["Claude Code Settings"] = 185,
    ["Clawject config"] = 183,
    ["Cloud Foundry Application Manifest"] = 1102,
    ["Cloud Run Spec v1"] = 1125,
    ...
    ["CloudEvents specification"] = 173,
    ["Code Climate"] = 222,
    CodeCV = 91,
    CodeRabbit = 90,
    ["CodeShip Pro services configuration files"] = 235,
    ["CodeShip Pro steps configuration files"] = 236,
    ["Codecov configuration files"] = 234,
    Codex = 230,
    CodifyCLI = 92,
    Codux = 232,
    ["Cog config file"] = 178,
    ["Commandbox Box.json"] = 179,
    ["Commandbox Server.json"] = 180,
    ["Common Catalog Data"] = 244,
    ["Common Package Specification"] = 181,
    Concord = 1119,
    ["Configu .cfgu files"] = 1107,
    ["Configu .configu file"] = 1108,
    Conjure = 176,
    ["Container Structure Test"] = 945,
    Containerlab = 973,
    ["Contextive Glossary"] = 1175,
    Convex = 175,
    ["Crowdsec collection config"] = 275,
    ["Crowdsec parser config"] = 276,
    ["Crowdsec scenario config"] = 277,
    ["CumulusCI Config"] = 182,
    ["Custom Machinery Machine"] = 1091,
    ["Custom Machinery Recipe"] = 1092,
    ["Cycle Stack File"] = 187,
    CycloneDX = 188,
    ["DWP Exchange - catalogue entry"] = 326,
    ["DWP Exchange - gateway"] = 324,
    ["DWP Exchange - meta"] = 325,
    ["Dart Build Config (dart-build.json)"] = 283,
    ["Dart Test Config (dart-test.json)"] = 284,
    ["DashLord Configuration"] = 285,
    ["Data Contract Specification"] = 286,
    ["Data Product Specification"] = 287,
    ["DataYoga Connections"] = 189,
    ["DataYoga Job"] = 190,
    ["Databricks Asset Bundles"] = 1069,
    ["Datadog Continuous Testing"] = 490,
    ["Datadog Service Definition"] = 491,
    ["Datadog Software Catalog"] = 492,
    ["Datahub Ingestion Recipe"] = 1023,
    ["Debian Upstream Metadata file"] = 196,
    ["Deck config"] = 197,
    ["Dein Config"] = 198,
    ["Deno Config (deno.json)"] = 293,
    ["Dependency cruiser"] = 199,
    ["DeployStack Configuration"] = 200,
    ["Deployah Configuration"] = 1198,
    ["Deployer Recipe"] = 296,
    ["Deta Spacefile"] = 201,
    ["Detekt Config (detekt.yml)"] = 297,
    ["Devbox Config"] = 202,
    ["Devbox Plugin"] = 203,
    Devfile = 323,
    Devup = 1211,
    DipDup = 1122,
    ["Discord Webhook"] = 298,
    ["DocFx Config (docfx.json)"] = 303,
    ["Docker Desktop extension metadata"] = 300,
    ["Docs MCP Manifest"] = 304,
    Dofigen = 305,
    ["Dolittle Artifacts"] = 306,
    ["Dolittle Bounded Context Configuration"] = 307,
    ["Dolittle Event Horizons Configuration"] = 308,
    ["Dolittle Resources Configuration"] = 309,
    ["Dolittle Server Configuration"] = 310,
    ["Dolittle Tenant Map Configuration"] = 312,
    ["Dolittle Tenants Configuration"] = 311,
    ["Dolittle Topology"] = 313,
    ["DonateCaseBetterCasino menu"] = 1152,
    ["Drupal Breakpoints"] = 204,
    ["Drupal Config"] = 216,
    ["Drupal Info"] = 205,
    ["Drupal Layouts"] = 206,
    ["Drupal Libraries"] = 207,
    ["Drupal Links Action"] = 208,
    ["Drupal Links Contextual"] = 209,
    ["Drupal Links Menu"] = 210,
    ["Drupal Links Task"] = 211,
    ["Drupal Migration"] = 212,
    ["Drupal Permissions"] = 213,
    ["Drupal Recipe"] = 214,
    ["Drupal Routing"] = 215,
    ["Drupal Services"] = 217,
    ["Drush site aliases"] = 319,
    ["Dynamic Bash Aliases (.aliases)"] = 1060,
    ["EAS config"] = 344,
    ["ECA - Editor Code Assistant"] = 328,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1049,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1195,
    ["EasyVCR .NET"] = 345,
    ["Eidolon Resource"] = 1136,
    ["Elgato Stream Deck"] = 330,
    Elm = 1124,
    ["Embrace Config"] = 1035,
    Endurica = 1073,
    ["Enterprise Contract Policy Spec"] = 331,
    ["Erda Pipeline"] = 1098,
    ["Erda Runtime"] = 1099,
    ["Espanso config.yml"] = 1221,
    ["Espanso match.yml"] = 1220,
    Esquio = 333,
    ["Estuary Flow Catalog"] = 1013,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 337,
    ["EveryVoice TTS Toolkit Data Configuration"] = 338,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 342,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 341,
    ["EveryVoice TTS Toolkit Text Configuration"] = 339,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 340,
    ["Evolving Resolutive Process notation"] = 1197,
    ["Expo SDK"] = 343,
    ["F-Droid Data metadata"] = 349,
    ["FasterCI Configuration"] = 108,
    FiQuS = 353,
    Firebase = 351,
    ["Flatpak Builder Manifest"] = 354,
    ["FlexGet Config"] = 355,
    ["Flow.json Configurations"] = 1095,
    ["Fossa configuration file"] = 362,
    ["Fossa's fossa-deps file"] = 363,
    ["Foundry VTT - Base package Manifest"] = 357,
    ["Foundry VTT - Module Manifest"] = 358,
    ["Foundry VTT - System Data Template"] = 361,
    ["Foundry VTT - System Manifest"] = 359,
    ["Foundry VTT - World Manifest"] = 360,
    ["Foxx Manifest"] = 109,
    ["Freifunk.de Community API"] = 112,
    ["Frogbot Config"] = 113,
    ["G2P Mapping Configuration"] = 369,
    ["GCP Blueprint Metadata"] = 372,
    Gaspar = 370,
    ["GatewayCore API Gateway"] = 371,
    ["Gemini CLI settings"] = 373,
    ["GeoJSON.json latest"] = 1011,
    GherKing = 1015,
    ["GitHub Action"] = 378,
    ["GitHub Actions typing"] = 1132,
    ["GitHub Discussion"] = 379,
    ["GitHub Funding"] = 380,
    ["GitHub Issue Template configuration"] = 381,
    ["GitHub Issue Template forms"] = 382,
    ["GitHub Workflow"] = 383,
    ["GitHub Workflow Template Properties"] = 384,
    ["GitHub automatically generated release notes configuration"] = 385,
    ["GitLab Agent for Kubernetes configuration"] = 1087,
    GitVersion = 375,
    ["Gitea Issue Template configuration"] = 376,
    ["Gitea Issue Template forms"] = 377,
    ["Gitpod Automations"] = 387,
    ["Gitpod Configuration"] = 388,
    ["GlazeWM settings"] = 1089,
    ["Global Privacy Control"] = 374,
    Goblet = 1068,
    ["Golangci-lint Configuration"] = 403,
    ["Golangci-lint Custom Plugins Configuration"] = 404,
    ["Google Chrome Related Website Sets"] = 352,
    ["Google Cloud Workflows"] = 252,
    ["Google Digital Assetlinks"] = 1176,
    Goreleaser = 406,
    ["Goreleaser Pro"] = 407,
    Goss = 408,
    ["Gradle Build Cache Node"] = 962,
    ["Gradle Enterprise"] = 961,
    ["Grafana 5.x Dashboard"] = 409,
    ["GraphQL Code Generator"] = 414,
    ["GraphQL Config"] = 413,
    ["GraphQL Mesh"] = 412,
    ["GroovyLint configuration"] = 415,
    ["Grunt JSHint task"] = 419,
    ["Grunt Watch task"] = 420,
    ["Grunt base task"] = 421,
    ["Grunt clean task"] = 417,
    ["Grunt copy task"] = 416,
    ["Grunt cssmin task"] = 418,
    HEMTT = 927,
    Hadolint = 941,
    Hammerkit = 972,
    ["Hardware Sentry Configuration"] = 1027,
    ["HashiCorp Vault"] = 422,
    Hatch = 942,
    Hayson = 424,
    ["Haystack Pipeline"] = 425,
    ["Hazelcast 5 Configuration"] = 426,
    ["Hecate Input Schema"] = 1187,
    ["Helm Chart.lock"] = 219,
    ["Helm Chart.yaml"] = 218,
    ["Helm Unittest Test Suite"] = 220,
    ["Home Assistant Integration Manifest"] = 427,
    ["Homer dashboard configuration"] = 428,
    Hugo = 1003,
    ["Hugo Theme"] = 1002,
    ["Hulak Configuration"] = 435,
    ["Hyperfoil benchmark configuration"] = 434,
    ["IBM Zapp document"] = 436,
    ["IBM zCodeFormatSettings"] = 437,
    ["IMG Catapult PSP"] = 442,
    ["IVMS101 by CODE Protocol"] = 1088,
    Infrahub = 444,
    Istanbul = 1031,
    ["JDownloader2 crawler multi-rules"] = 457,
    ["JDownloader2 crawler single-rules"] = 456,
    ["JFrog Applications Config"] = 458,
    ["JFrog File Spec"] = 459,
    ["JFrog Pipelines YML DSL"] = 1037,
    ["JMeter DSL cli config"] = 460,
    JReleaser = 463,
    ["JSON Document Transform"] = 471,
    ["JSON Feed"] = 472,
    ["JSON Resume"] = 715,
    ["JSON Schema Draft 2020-12"] = 909,
    ["JSON Schema Draft 4"] = 906,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1070,
    ["JSON Schema Draft 7"] = 907,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1071,
    ["JSON Schema Draft 8 (2019-09)"] = 908,
    ["JSON-API"] = 470,
    ["JSON-e templates"] = 969,
    ["JSON-stat 2.0"] = 902,
    JSONPatch = 474,
    ["JSR Package Config (jsr.json)"] = 464,
    Jarl = 1203,
    Jasmine = 451,
    Jekyll = 452,
    ["Jenkins X Pipelines"] = 453,
    ["Jenkins X Requirements"] = 454,
    Jest = 455,
    Jocker = 461,
    ["Jovo Language Models"] = 462,
    ["Jujutsu (jj) VCS config"] = 1189,
    ["KIMMDY config file"] = 485,
    ["KODE/CI build.yaml"] = 1033,
    ["KSP-AVC"] = 903,
    ["KSP-CKAN"] = 904,
    ["KSP-NetKAN"] = 905,
    KSY = 1100,
    KSail = 367,
    ["KYA Manifest"] = 1101,
    ["Karakum configuration file"] = 364,
    Kas = 477,
    ["Kestra flow file"] = 486,
    ["Keycloak REST API"] = 1040,
    ["Knative Functions - func.yaml"] = 365,
    Knip = 366,
    ["Kometa (nightly) config file"] = 488,
    ["Kometa config file"] = 487,
    ["Kong DBLess config"] = 1034,
    KrakenD = 489,
    ["Kubri Configuration"] = 496,
    LOOBin = 511,
    ["Lake configuration file"] = 1192,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 257,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 258,
    ["Landing Zone Accelerator on AWS - Global Config"] = 259,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 260,
    ["Landing Zone Accelerator on AWS - Network Config"] = 261,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 262,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 263,
    ["Landing Zone Accelerator on AWS - Security Config"] = 264,
    ["Lando (landofile)"] = 103,
    ["LangGraph Platform configuration"] = 1112,
    ["Language configuration"] = 1111,
    Lefthook = 500,
    ["Liferay client-extension.yaml"] = 507,
    ["LinkML Metamodel"] = 509,
    Liquibase = 978,
    ["Liquibase Flow File"] = 979,
    ["Lively Properties"] = 510,
    ["Lobe AI Agent"] = 105,
    Loki = 106,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 551,
    ["MS2Rescore Configuration"] = 554,
    ["Madness (madness.yml)"] = 1051,
    ["Mado configuration"] = 517,
    ["Mail Servers Configuration"] = 1224,
    ["MapEHR Mapping"] = 518,
    Markdownlint = 982,
    ["Mason Registry"] = 985,
    ["MegaLinter Custom Flavor"] = 521,
    ["MegaLinter configuration"] = 520,
    ["MegaLinter descriptor"] = 522,
    Melange = 1078,
    ["Meltano project definition"] = 523,
    ["Mergify Configuration"] = 555,
    ["Metadata for a Bazel module"] = 524,
    ["Metadata for a Cinnamon spice"] = 1128,
    ["Metatype Configuration"] = 525,
    ["MetricsHub Configuration"] = 526,
    ["MetricsHub Connector Configuration"] = 527,
    ["Micro Editor Syntax"] = 1061,
    ["Microsoft Band Web Tile"] = 528,
    ["Microsoft RulesEngine workflow rules"] = 1116,
    ["Microsoft RulesEngine workflow rules list"] = 1117,
    ["Minecraft Custom Main Menu Mod"] = 1079,
    ["Minecraft Data Pack Advancement"] = 530,
    ["Minecraft Data Pack Biome"] = 531,
    ["Minecraft Data Pack Configured Carver"] = 532,
    ["Minecraft Data Pack Damage Type"] = 533,
    ["Minecraft Data Pack Dimension"] = 535,
    ["Minecraft Data Pack Dimension Type"] = 534,
    ["Minecraft Data Pack Item Modifier"] = 536,
    ["Minecraft Data Pack Loot Table"] = 537,
    ["Minecraft Data Pack Metadata"] = 538,
    ["Minecraft Data Pack Predicate"] = 539,
    ["Minecraft Data Pack Recipe"] = 540,
    ["Minecraft Data Pack Tag"] = 541,
    ["Minecraft Data Pack Template Pool"] = 542,
    ["Minecraft Data Pack Trim Material"] = 547,
    ["Minecraft Data Pack Trim Pattern"] = 548,
    ["Minecraft Resource Pack Lang"] = 543,
    ["Minecraft Resource Pack Particle"] = 544,
    ["Minecraft Resource Pack Texture Mcmeta"] = 546,
    ["Minecraft Resourcepack Sounds"] = 545,
    ["Monade CLI Stack Configuration"] = 558,
    ["MongoDB Atlas Search Index Definition"] = 1032,
    ["Monika Configuration"] = 1030,
    ["Monoweave Configuration"] = 553,
    ["Motif config"] = 923,
    MultiQC = 1169,
    ["NOX Framework (Service)"] = 574,
    ["Netin Diagnostic System Template"] = 989,
    ["Netlify config"] = 561,
    ["Network-as-Code Data Model"] = 562,
    ["Next Gen UI Agent A2A Server Configuration"] = 563,
    ["Next Gen UI Agent Configuration"] = 565,
    ["Next Gen UI Agent MCP Server Configuration"] = 564,
    ["Nightwatch.js"] = 567,
    ["Node.js configuration"] = 928,
    ["NueJS configuration file"] = 579,
    ["Nuitka.yaml"] = 1093,
    ["Nullstone config"] = 581,
    ["ONe's changelog entry"] = 599,
    ["ONe's service descriptor"] = 598,
    ["ORT Server repository environment configuration"] = 608,
    ["OSCAL Assessment Plan (AP)"] = 610,
    ["OSCAL Assessment Results (AR)"] = 611,
    ["OSCAL Catalog"] = 612,
    ["OSCAL Component Definition (CDef)"] = 613,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 614,
    ["OSCAL Profile"] = 615,
    ["OSCAL System Security Plan (SSP)"] = 616,
    ["OSS Review Toolkit configuration"] = 617,
    ["OSS Review Toolkit curation"] = 618,
    ["OSS Review Toolkit package configuration"] = 619,
    ["OSS Review Toolkit repository configuration"] = 620,
    ["OSS Review Toolkit resolutions"] = 621,
    ["October CMS columns"] = 585,
    ["October CMS fields"] = 586,
    ["Oh My Posh"] = 587,
    Okteto = 588,
    ["Ona Automations"] = 590,
    Opctl = 926,
    ["Open Data Contract Standard (ODCS)"] = 602,
    ["Open Data Product Standard (ODPS)"] = 603,
    ["Open Know-How"] = 1174,
    ["OpenRewrite Resource"] = 601,
    OpenSRM = 604,
    OpenStatus = 1185,
    ["OpenUtau character yaml"] = 595,
    ["OpenUtau ustx"] = 596,
    ["OpenWeather Current Weather API"] = 968,
    ["OpenWeather Road Risk API"] = 967,
    ["Ory Hydra configuration"] = 433,
    ["Ory Keto configuration"] = 493,
    ["Ory Kratos configuration"] = 609,
    ["Ory Oathkeeper configuration"] = 583,
    ["Outblocks App configuration"] = 606,
    ["Outblocks database table"] = 607,
    ["Outblocks project configuration"] = 605,
    PDM = 628,
    POPxf = 638,
    ["POPxf Correlations"] = 639,
    Packer = 625,
    Pantsbuild = 1047,
    ["Paper paper-plugin.yml"] = 626,
    ["Pipeline component"] = 980,
    ["Platform.sh application"] = 5,
    ["Platform.sh routes"] = 6,
    ["Platform.sh services"] = 7,
    ["Plex Prerolls"] = 636,
    ["PocketMine plugin.yml"] = 633,
    ["Postman collection"] = 642,
    ["Power Pages Configuration"] = 1186,
    ["Preset list for a WinUtil"] = 1131,
    ["ProActions AI-Kit Configuration"] = 653,
    ["ProActions AI-Kit Configuration for Menus"] = 655,
    ["ProActions AI-Kit Configuration for Sections"] = 657,
    ["ProActions AI-Kit Configuration for Services"] = 654,
    ["ProActions AI-Kit Configuration for Steps"] = 658,
    ["ProActions AI-Kit Configuration for Templates"] = 656,
    ["Problem object RFC9457"] = 1076,
    ["Problem package format"] = 659,
    ["Problem package generators"] = 660,
    ["Problem package submissions"] = 661,
    ["Problem package test group metadata"] = 662,
    Pterodactyl = 1026,
    ["Pull Request Labeler"] = 679,
    Pulumi = 687,
    ["PyGTA Config"] = 683,
    PyProject = 688,
    Pylock = 1177,
    Pyright = 689,
    ["Python script metadata"] = 1171,
    ["QType AI DSL"] = 692,
    Qgoda = 691,
    Qodana = 999,
    ["Qt Creator workspace file"] = 1109,
    ["Quali Torque Blueprint Spec 2"] = 1024,
    ["QueryFirst config file"] = 1043,
    ["RKE Cluster Configuration JSON"] = 977,
    ["RKE Cluster Configuration YAML"] = 976,
    RadioHound = 682,
    Railpack = 694,
    Railway = 693,
    ["Rancher Fleet"] = 684,
    ...
    Ray = 940,
    ["Read the Docs"] = 686,
    ["Red-DiscordBot Cog"] = 702,
    ["Red-DiscordBot Cog Repo"] = 703,
    ["Red-DiscordBot Trivia"] = 704,
    ["Releasaurus Config"] = 2,
    ["Render Blueprints"] = 975,
    RenderCV = 719,
    Renovate = 716,
    ["Renovate global configuration"] = 717,
    ["Renovate inherited configuration"] = 718,
    ["Replit config"] = 710,
    Restate = 1164,
    ["Revel Digital Gadget Definition File"] = 1188,
    RoadRunner = 721,
    ["Robust Station Image"] = 1194,
    Rockcraft = 722,
    ["Roo Coder Custom Modes"] = 723,
    Rubocop = 712,
    ["Rudder techniques"] = 1083,
    Ruff = 713,
    ["Rust Project"] = 714,
    ["Rust toolchain"] = 727,
    ["SDMX data message"] = 753,
    ["SDMX metadata message"] = 752,
    ["SDMX structure message"] = 751,
    ["SIL Kit Participant Configuration"] = 763,
    ["SIL Kit Registry Configuration"] = 764,
    ["SPDX 2.3"] = 801,
    SWADL = 817,
    ["Safebox Config"] = 1038,
    ["Sapphire CLI Config"] = 730,
    ["SauceCTL Configuration"] = 986,
    ["Schema Catalog"] = 745,
    ["Scoop manifest"] = 750,
    ["Semantic Data Fabric (SDF) file"] = 754,
    ["Semgrep Rule"] = 756,
    ["Serenity Code Generator (Sergen)"] = 757,
    ["Serverless Framework Configuration"] = 993,
    ["Serverless Workflow"] = 995,
    ["Settings for a Cinnamon spice"] = 1127,
    ["Settings.paf"] = 759,
    ["Shopware 6 Configuration"] = 996,
    ["Shopware CLI Extension Store Configuration"] = 997,
    ["Shopware CLI Project Store Configuration"] = 998,
    ["Sigma Detection Rule"] = 761,
    ["Sigrid scope configuration file"] = 762,
    ["SkyPilot Task JSON"] = 1084,
    ["Slack app manifest"] = 766,
    Snapcraft = 768,
    Solidarity = 771,
    ["Solution filters"] = 772,
    ["Source Maps v3"] = 773,
    Sourcery = 774,
    ["Spack bootstrap.yaml"] = 775,
    ["Spack cdash.yaml"] = 776,
    ["Spack ci.yaml"] = 777,
    ["Spack compilers.yaml"] = 778,
    ["Spack concretizer.yaml"] = 779,
    ["Spack config.yaml"] = 780,
    ["Spack definitions.yaml"] = 781,
    ["Spack develop.yaml"] = 782,
    ["Spack env_vars.yaml"] = 783,
    ["Spack environment"] = 789,
    ["Spack include.yaml"] = 784,
    ["Spack mirrors.yaml"] = 785,
    ["Spack modules.yaml"] = 786,
    ["Spack packages.yaml"] = 787,
    ["Spack repos.yaml"] = 788,
    ["Spack toolchains.yaml"] = 790,
    ["Spack upstreams.yaml"] = 791,
    ["Spack view.yaml"] = 792,
    ["Speakeasy Generation Config File"] = 796,
    ["Speakeasy Lint Configuration File"] = 793,
    ["Speakeasy Test Generation Configuration File"] = 794,
    ["Speakeasy Workflow File"] = 795,
    SpecIF = 797,
    ["Specmatic Configuration"] = 798,
    ["Sponge Mixin configuration"] = 799,
    StackBlitz = 805,
    ["StackHawk Scanner Configuration"] = 992,
    Stale = 806,
    Starfish = 807,
    ["Starlake Data Pipeline"] = 965,
    Starship = 808,
    ["Statamic Blueprint"] = 809,
    ["Stella configuration file"] = 810,
    ["Streamlit configuration file"] = 811,
    ["Stryker Mutator"] = 814,
    ["StyleCop Analyzers Configuration"] = 815,
    ["Stylelint (.stylelintrc)"] = 816,
    ["Stylua Config"] = 1178,
    ["Sublime Syntax"] = 1039,
    ["Subsquid squid manifest"] = 1086,
    ["Swagger API 2.0"] = 818,
    ["Synadia Connect Component"] = 819,
    TSON = 855,
    TSTyche = 856,
    ["TYPO3 Vendor Bundler config"] = 861,
    ["Tab data for a LinUtil"] = 1134,
    ["Tab list for a LinUtil"] = 1133,
    Tach = 820,
    ["Tach Domain"] = 821,
    Talhelper = 823,
    ["Talisman configuration"] = 824,
    Taplo = 1179,
    ["Taskfile config"] = 970,
    Taurus = 825,
    Tauticord = 826,
    ["Tekton Pipeline"] = 1207,
    ["Tekton PipelineRun"] = 1208,
    ["Tekton Task"] = 1205,
    ["Tekton TaskRun"] = 1206,
    Telefonistka = 1165,
    ["Terrateam config"] = 1191,
    ["TestEnvironment.json"] = 838,
    ["TextMate Grammar"] = 837,
    Threagile = 832,
    ["Tier.run pricing.json"] = 829,
    Tikibase = 830,
    Tombi = 835,
    ["Traefik v2"] = 841,
    ["Traefik v2 File Provider"] = 842,
    ["Traefik v3"] = 843,
    ["Traefik v3 File Provider"] = 844,
    ["Travis CI (.travis.yml)"] = 840,
    Treefmt = 411,
    Trident = 1161,
    ["TrueScript for *.tscript files"] = 847,
    ["Tugboat QA config.yml"] = 1158,
    TunnelHub = 1074,
    Turborepo = 839,
    Tycho = 1123,
    Tye = 1000,
    ["Tyk Gateway - Open Source v5.7+"] = 1170,
    ["UET BuildConfig.json"] = 1044,
    ["UI5 Manifest"] = 867,
    ["UNCORS configuration"] = 871,
    ["UTAM Page Object"] = 870,
    ["Ubuntu Server Autoinstall"] = 865,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1162,
    ["Uniswap Token List"] = 952,
    ["Universal Schedule Format"] = 872,
    ["Unreal Engine Uplugin"] = 1045,
    ["Unreal Engine Uproject"] = 1046,
    ["UpCloud CLI (upctl) configuration"] = 1163,
    ["Updatecli Compose"] = 1008,
    ["Updatecli Policy Manifest"] = 1009,
    ["Updatecli Policy Metadata"] = 1010,
    Uplift = 1042,
    ["Upsun config"] = 4,
    ["User Journey Map"] = 974,
    V2Ray = 1014,
    ["VSCode Code Snippets"] = 240,
    ["VSIX CLI publishing"] = 890,
    Vector = 874,
    ["Vela Pipeline Configuration"] = 877,
    Vercel = 239,
    ["Version Bumper config"] = 880,
    Vespertide = 1212,
    ["Vespertide Migration"] = 1213,
    ["Vespertide Model"] = 1214,
    ["Viash Component Config"] = 1167,
    ["Viash Package Config"] = 1168,
    Visivo = 1072,
    ["WP-CLI"] = 900,
    Wake = 1160,
    ["Waku Config"] = 1137,
    ["Web App Manifest"] = 896,
    ["Web types"] = 899,
    WebExtensions = 895,
    ["Webman package recipe"] = 1020,
    ["Windows Package Manager Installer Manifest"] = 948,
    ["Windows Package Manager Locale Manifest"] = 949,
    ["Windows Package Manager Singleton Manifest"] = 947,
    Winutil = 950,
    ["WireMock CLI import configuration"] = 1143,
    ["WireMock CLI local service configuration"] = 1142,
    ["WireMock message stub mapping"] = 1141,
    ["WireMock stub mapping"] = 1140,
    ["Woodpecker pipeline config"] = 988,
    ["Wrangler CLI"] = 901,
    ["Xstate Machine"] = 1006,
    ["Yandex Workflow Language"] = 1129,
    ["Yarn Config (.yarnrc.yml)"] = 963,
    ["Yippee-Ki-JSON configuration YML"] = 954,
    ["YouTrack App"] = 1126,
    ["Zarf Package Configuration"] = 1193,
    ["Zerops.io config"] = 1114,
    ["Zerops.io import"] = 1115,
    ["Zola Configuration"] = 1204,
    ["aerleon.yml"] = 17,
    ["amplify.yml"] = 10,
    ["angular.json"] = 33,
    apko = 1077,
    ...
    ["behat.yml"] = 135,
    ["bigquery-table"] = 124,
    ["bioimageio resource description"] = 1094,
    ...
    ["ccmod.json"] = 1138,
    changelogging = 1106,
    ["chisel-slices.json"] = 266,
    ["chrome-extension-locales-messages.json"] = 247,
    ["chutzpah.json"] = 248,
    cibuildwheel = 170,
    ["clang-format (.clang-format)"] = 1012,
    ["clang-tidy"] = 226,
    clangd = 225,
    clib = 227,
    ["cloud-init: cloud-config userdata"] = 229,
    ["cloud-sdk-pipeline-configuration"] = 250,
    ["cloudbuild.json"] = 251,
    cloudify = 228,
    ["cmdx.yaml"] = 89,
    codemagic = 231,
    ["coffeelint.json"] = 268,
    ["commands.json"] = 243,
    ["commitlint (.commitlintrc)"] = 951,
    ["committed.toml"] = 269,
    ["compile_commands.json"] = 242,
    ["compilerconfig.json"] = 241,
    ["completely.yml"] = 1050,
    ["component-detection-manifest.json"] = 272,
    ["component.json"] = 271,
    ["composer.json"] = 270,
    ["conda-forge"] = 174,
    ["config.yaml"] = 685,
    ["contentmanifest.json"] = 249,
    ["contribute.json"] = 273,
    ["cosmos.config.json"] = 245,
    ["crowdin.yml"] = 274,
    ["ctfd-setup configuration file"] = 1150,
    ["custom-elements.json"] = 1064,
    ["cypress.json"] = 278,
    ["datalogic-scan2deploy-android"] = 288,
    ["datalogic-scan2deploy-ce"] = 289,
    ["dbt Dependencies"] = 191,
    ["dbt Packages"] = 193,
    ["dbt Project"] = 192,
    ["dbt Selectors"] = 194,
    ["dbt YAML files"] = 195,
    ["ddev-global"] = 290,
    ["ddev-project"] = 291,
    ["debugsettings.json"] = 292,
    ["dependabot-v2.json"] = 295,
    ["dependabot.json"] = 294,
    ["deployed-cli"] = 1005,
    ["devcontainer.json"] = 233,
    devinit = 956,
    ["devspace.yaml"] = 1028,
    djlint = 957,
    ["docker bake"] = 301,
    ["docker sequencer"] = 302,
    ["docker-compose.yml"] = 955,
    ["dockerd.json"] = 299,
    ["dotnet Release Index manifest"] = 314,
    ["dotnet-tools.json"] = 315,
    ["dotnetcli.host.json"] = 316,
    ["dprint.json"] = 317,
    ["drone.json"] = 318,
    ["dss-2.0.0.json"] = 320,
    ["dstack configuration"] = 321,
    ["dtool dataset metadata"] = 1145,
    ["dvc.yaml"] = 322,
    ["ecosystem.json"] = 327,
    eksctl = 329,
    ["electron-builder configuration file"] = 335,
    ["epr-manifest.json"] = 334,
    ["evcc.yaml"] = 336,
    ["ezd task runner"] = 346,
    ["fabric.mod.json"] = 348,
    ["first-timers-bot"] = 356,
    ["flagd flag configuration"] = 110,
    ["fly.io Configuration"] = 111,
    fulibWorkflows = 987,
    ["function.json"] = 368,
    ["gRPC API Gateway & OpenAPI Config"] = 12,
    ["gematik health care insurance list"] = 1156,
    ["gematik health care patient list"] = 1153,
    ["gematik health care provider institution list"] = 1155,
    ["gematik health care provider list"] = 1154,
    ["gematik tiger test environment configuration"] = 1157,
    ["git-town.toml"] = 1202,
    ["gitlab-ci"] = 386,
    ["global.json"] = 402,
    ["go-feature-flag Flag Configuration"] = 405,
    ["haxelib.json"] = 423,
    helmfile = 943,
    helmwave = 944,
    ["host-meta.json"] = 430,
    ...
    ["ide.host.json"] = 438,
    ["ifstate.yaml"] = 439,
    ["imageoptimizer.json"] = 440,
    ["importmap.json"] = 443,
    instant_python_config = 445,
    instant_python_custom_project = 446,
    ["ioBroker Configuration"] = 447,
    ["ioBroker JSON UI"] = 448,
    ["ioBroker Package manifest"] = 449,
    ["ixpect.conf.yaml"] = 450,
    ["ize.toml"] = 1041,
    ["jsconfig.json"] = 475,
    ["jscpd Configuration"] = 1025,
    jsdoc = 939,
    ["k3d.yaml"] = 476,
    ["k9s aliases.yaml"] = 478,
    ["k9s cluster-config.yaml"] = 480,
    ["k9s config.yaml"] = 479,
    ["k9s hotkeys.yaml"] = 481,
    ["k9s plugins.yaml"] = 482,
    ["k9s skin.yaml"] = 483,
    ["k9s views.yaml"] = 484,
    ["kontinuous-config.yaml"] = 495,
    ["kontinuous-values.yaml"] = 494,
    ["kustomization.yaml"] = 497,
    ["label-commenter-config.yml"] = 498,
    ["latexindent configuration"] = 104,
    ["launchsettings.json"] = 499,
    lazydocker = 1063,
    lazygit = 1062,
    ["lego.json"] = 501,
    ["lerna.json"] = 502,
    ["lgtm.yml"] = 503,
    ["liblab.config.json"] = 504,
    ["libman.json"] = 505,
    ["license-report-config.json"] = 506,
    ["linkinator.config.json"] = 508,
    ["lint-staged (.lintstagedrc)"] = 917,
    ["local.settings.json"] = 513,
    ["localazy.json"] = 514,
    ["lotus.yaml"] = 512,
    ["lsdlschema.json"] = 515,
    ["macro.json"] = 1029,
    ["markdown-link-check"] = 983,
    maturin = 984,
    mboats = 991,
    ["micro-settings.json"] = 1056,
    ["mimetypes.json"] = 529,
    ["mirrord config"] = 919,
    mise = 920,
    ["mkdocs.yml"] = 549,
    ["monospace.yml"] = 552,
    ["moon.yml"] = 1139,
    ["mprocs Configuration file"] = 1110,
    ["mrdocs.yml"] = 550,
    ["mta.yaml"] = 921,
    ["mtad.yaml"] = 922,
    ["mycode.json"] = 559,
    nFPM = 566,
    ["napari plugin manifest"] = 560,
    neoload = 934,
    ["nest-cli"] = 569,
    ["ninjs (News in JSON)"] = 568,
    ["nitro.json"] = 933,
    ["nixd configuration"] = 1082,
    ["nlu.json"] = 570,
    ["nodemon.json"] = 572,
    ["noodl config"] = 990,
    ["notebook.mod.json"] = 573,
    now = 929,
    ["npm-badges"] = 576,
    ["nswag.json"] = 580,
    ntangle = 582,
    ["nuclei-template.yaml"] = 577,
    ["nuget-project.json"] = 578,
    ["ocelot.json"] = 584,
    ["omnisharp.json"] = 589,
    openHAB = 1215,
    ["openapi.json"] = 591,
    ...
    oxlint = 1226,
    ["package.json"] = 622,
    ["package.manifest"] = 624,
    ["package.yaml"] = 623,
    ["partial-black.json"] = 136,
    ["pathfinder.yml"] = 627,
    ["pattern.json"] = 630,
    ["petstore-v1.0"] = 1036,
    pgap_yaml_input_reader = 629,
    pgxgen = 1219,
    pitcms = 1222,
    ["pixi.toml"] = 631,
    ["plagiarize-me.yaml"] = 635,
    ["plagiarize.yaml"] = 634,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1146,
    ["podbard.yaml"] = 637,
    ["portman.json"] = 640,
    ["prefect.toml"] = 648,
    ["prefect.yaml"] = 649,
    ...
    ["prettierrc.json"] = 651,
    ["prisma.yml"] = 652,
    ["project-1.0.0-beta3.json"] = 664,
    ["project-1.0.0-beta4.json"] = 665,
    ["project-1.0.0-beta5.json"] = 666,
    ["project-1.0.0-beta6.json"] = 667,
    ["project-1.0.0-beta8.json"] = 668,
    ["project-1.0.0-rc1.json"] = 669,
    ["project-1.0.0-rc2.json"] = 670,
    ["project.json"] = 663,
    ["project.owasp.yaml"] = 671,
    ["prometheus-alertmanager.json"] = 675,
    ["prometheus.json"] = 672,
    ["prometheus.rules.json"] = 673,
    ["prometheus.rules.test.json"] = 674,
    ["proxies.json"] = 676,
    ["publiccode.yml"] = 677,
    ["pubspec.yaml"] = 678,
    ["pyrseas-0.8.json"] = 681,
    pytest = 690,
    ["quilt.mod.json"] = 1057,
    ["rc3 auth"] = 696,
    ["rc3 collection"] = 697,
    ...
    ["release drafter"] = 935,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 706,
    ["release-please-manifest.json"] = 707,
    ["release-plz.toml"] = 708,
    ["renv.lock"] = 720,
    ["rivet.json"] = 1081,
    ["rivet.yaml (legacy)"] = 1080,
    rumdl = 725,
    runny = 724,
    rustfmt = 726,
    sake = 1173,
    samt = 728,
    samtrc = 729,
    ["sarif-1.0.0.json"] = 731,
    ["sarif-2.0.0.json"] = 732,
    ["sarif-2.1.0"] = 742,
    ["sarif-2.1.0-rtm.2"] = 733,
    ["sarif-2.1.0-rtm.3"] = 735,
    ["sarif-2.1.0-rtm.4"] = 737,
    ["sarif-2.1.0-rtm.5"] = 739,
    ["sarif-2.1.0-rtm.6"] = 740,
    ["sarif-external-property-file-2.1.0"] = 743,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 734,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 736,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 738,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 741,
    ["scalingo.json configuration"] = 744,
    ["schema.org - Action"] = 746,
    ["schema.org - ContactPoint"] = 747,
    ["schema.org - Place"] = 748,
    ["schema.org - Thing"] = 749,
    ["secrethub.yml"] = 1059,
    ["semantic-release"] = 755,
    ["servicehub.config.json"] = 912,
    ["servicehub.service.json"] = 911,
    ["settings.job"] = 758,
    ["sfdx-hardis configuration"] = 760,
    ["shard.yml"] = 1097,
    ["size-limit configuration"] = 765,
    ["skaffold.yaml"] = 981,
    ["skyuxconfig.json"] = 767,
    ["snowflake-config"] = 769,
    ["snowflake-connections"] = 770,
    ["spicepod.yaml"] = 1118,
    ["sqlc configuration"] = 802,
    ["stripe-app-local.json"] = 813,
    ["stripe-app.json"] = 812,
    swcrc = 966,
    ["task.json"] = 822,
    taskcat = 930,
    ["template.json"] = 827,
    ["templatsources.json"] = 828,
    ["theme.json"] = 831,
    ["tizen_workspace.json"] = 833,
    tldr = 834,
    ["tm_devices configuration file"] = 1184,
    tmuxinator = 915,
    tox = 836,
    ["transcend.yml"] = 845,
    ["tree-sitter grammar.json"] = 410,
    ["trime.yaml"] = 846,
    ["trunk.yaml"] = 848,
    ["ts-force-config.json"] = 853,
    ["tsconfig.json"] = 849,
    ["tsd.json"] = 850,
    ["tsdoc.json"] = 851,
    ["tsdrc.json"] = 852,
    ...
    v8r = 894,
    vcluster = 1104,
    ["vcpkg configuration file"] = 238,
    ["vcpkg manifest file"] = 237,
    ["vega-lite.json"] = 876,
    ["vega.json"] = 875,
    ["venvironment.yaml"] = 878,
    ["venvplus.yaml"] = 879,
    version = 1166,
    ["version.json"] = 881,
    ["vhwdebugger-binding.yaml"] = 883,
    ["vim-addon-info"] = 884,
    ["vs-2017.3.host.json"] = 886,
    ["vs-nesting.json"] = 887,
    ["vsls.json"] = 885,
    ["vss-extension.json"] = 891,
    vtcfg = 1172,
    ["vtesttree.yaml"] = 892,
    ["vtestunit.yaml"] = 893,
    ["warp-keysets.json"] = 1065,
    ["warp-themes.json"] = 1066,
    ["warp-workflows.json"] = 1067,
    ["webhint.io"] = 1021,
    ["webjobpublishsettings.json"] = 898,
    ["webjobs-list.json"] = 897,
    ["well-known-fursona"] = 1105,
    ["xs-app.json"] = 925,
    ["xunit.runner.json"] = 910,
    yamllint = 953,
    zizmor = 1209,
    zuul = 936,
    ["Žinoma"] = 946
