...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 158,
    [".cryproj (generic)"] = 533,
    [".cryproj engine-5.2"] = 528,
    [".cryproj engine-5.3"] = 529,
    [".cryproj engine-5.4"] = 530,
    [".cryproj engine-5.5"] = 531,
    [".cryproj engine-dev"] = 532,
    [".csscomb.json"] = 160,
    [".csslintrc"] = 161,
    [".eslintrc"] = 206,
    [".esmrc.json"] = 198,
    ...
    [".mtaext"] = 542,
    [".nodehawkrc"] = 339,
    [".npmpackagejsonlintrc"] = 342,
    [".phraseapp.yml"] = 377,
    [".pmbot.yml"] = 369,
    [".postcssrc"] = 374,
    [".pre-commit-config.yml"] = 375,
    [".pre-commit-hooks.yml"] = 376,
    [".putout.json"] = 394,
    [".rehyperc"] = 403,
    [".remarkrc"] = 404,
    [".sprite files"] = 451,
    ...
    [".vsext"] = 508,
    [".yarnrc.yml"] = 574,
    ["<div>RIOTS' studio configuration"] = 512,
    ["@factorial/drupal-breakpoints-css"] = 5,
    ["A micro editor config schema"] = 304,
    ["API Builder"] = 571,
    ["AVA Configuration Schema"] = 627,
    ["AWS CDK cdk.json"] = 143,
    ["AWS CloudFormation"] = 144,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 145,
    ["Airlock Microgateway"] = 9,
    ["Airplane task"] = 10,
    ["Alacritty Configuration Schema"] = 602,
    ["All Contributors configuration file"] = 654,
    ...
    ["Azure Pipelines"] = 48,
    ["Azure Static Web Apps CLI configuration file"] = 453,
    ["Azure Static Web Apps configuration file"] = 452,
    ["BX CI"] = 83,
    ["Better Code Hub"] = 576,
    ["Better Scripts"] = 84,
    BizTalkServerApplicationSchema = 548,
    ...
    ["Butane Config"] = 614,
    ["CICS TS region tagging"] = 621,
    ["CICS TS resource import"] = 622,
    ["CICS TS resource model"] = 623,
    ["CICS TS resource overrides"] = 624,
    ["CMake Presets"] = 85,
    ...
    ["Datahub Ingestion Recipe Schema"] = 628,
    ...
    ["Embrace Config Schema"] = 639,
    ["Error pages"] = 201,
    Esquio = 199,
    ["Estuary Flow Catalog Schema"] = 618,
    ["Expo SDK"] = 204,
    ...
    Goreleaser = 233,
    ["Goreleaser Pro"] = 234,
    ["Gradle Build Cache Node"] = 573,
    ["Gradle Enterprise"] = 572,
    ...
    Hadolint = 557,
    Hammerkit = 583,
    ["Hardware Sentry Configuration"] = 632,
    Hayson = 246,
    ...
    ["JFrog File Spec"] = 270,
    ["JFrog Pipelines YML DSL"] = 641,
    ["JMeter DSL cli config schema"] = 271,
    ["JSON Document Transform"] = 279,
    ["JSON Feed"] = 280,
    ["JSON Resume"] = 410,
    ["JSON Schema Draft 2020-12"] = 524,
    ["JSON Schema Draft 4"] = 521,
    ["JSON Schema Draft 7"] = 522,
    ["JSON Schema Draft 8"] = 523,
    ...
    ["KSP-CKAN"] = 520,
    Kas = 285,
    ["Keycloak REST API"] = 647,
    ["Knative Functions - func.yaml"] = 216,
    ["KoDE/CI build.yaml"] = 637,
    ["Kong DBLess Schema"] = 638,
    KrakenD = 286,
    ["LinkML Metamodel"] = 299,
    Liquibase = 588,
    ["Liquibase Flow File"] = 589,
    ["Lively Properties"] = 300,
    Markdownlint = 592,
    ["MegaLinter configuration"] = 305,
    ["MegaLinter descriptor"] = 306,
    ["Meltano plugin discovery definition"] = 308,
    ["Meltano project definition"] = 307,
    ["Microsoft Band Web Tile"] = 309,
    ["Minecraft Data Pack Advancement"] = 311,
    ["Minecraft Data Pack Biome"] = 312,
    ["Minecraft Data Pack Configured Carver"] = 313,
    ["Minecraft Data Pack Damage Type"] = 314,
    ["Minecraft Data Pack Dimension"] = 316,
    ["Minecraft Data Pack Dimension Type"] = 315,
    ["Minecraft Data Pack Item Modifier"] = 317,
    ["Minecraft Data Pack Loot Table"] = 318,
    ["Minecraft Data Pack Metadata"] = 319,
    ["Minecraft Data Pack Predicate"] = 320,
    ["Minecraft Data Pack Recipe"] = 321,
    ["Minecraft Data Pack Tag"] = 322,
    ["Minecraft Data Pack Template Pool"] = 323,
    ["Minecraft Resource Pack Lang"] = 324,
    ["Minecraft Resource Pack Particle"] = 325,
    ["Minecraft Resource Pack Texture Mcmeta"] = 327,
    ["Minecraft Resourcepack Sounds"] = 326,
    ["MkDocs Configuration 1.0"] = 328,
    ["MongoDB Atlas Search Index Definition Schema"] = 636,
    ["Monika Configuration Schema"] = 634,
    ["Motif config"] = 541,
    ["NOX Framework (Service)"] = 341,
    ["Netin Diagnostic System Template"] = 597,
    ["Netlify config schema"] = 333,
    ["Nightwatch.js"] = 334,
    ["OSS Review Toolkit configuration"] = 359,
    ["OSS Review Toolkit curation"] = 360,
    ["OSS Review Toolkit package configuration"] = 361,
    ["OSS Review Toolkit repository configuration"] = 362,
    ["OSS Review Toolkit resolutions"] = 363,
    Opctl = 544,
    ["OpenRewrite Resource"] = 354,
    ["OpenWeather Current Weather API"] = 580,
    ["OpenWeather Road Risk API"] = 579,
    ["Ory Hydra configuration"] = 252,
    ["Ory Keto configuration"] = 288,
    ["Ory Kratos configuration"] = 358,
    ["Ory Oathkeeper configuration"] = 348,
    ["Outblocks App configuration"] = 356,
    ["Outblocks database table"] = 357,
    ["Outblocks project configuration"] = 355,
    Packer = 366,
    Pantsbuild = 653,
    ["Pipeline component"] = 590,
    ["PocketMine plugin.yml"] = 370,
    Pterodactyl = 631,
    ["Pull Request Labeler"] = 393,
    Pulumi = 398,
    PyProject = 399,
    Qodana = 607,
    ["Quali Torque Blueprint Spec 2"] = 629,
    ["QueryFirst config file"] = 650,
    ["RKE Cluster Configuration JSON Schema"] = 587,
    ["RKE Cluster Configuration YAML Schema"] = 586,
    ["Rancher Fleet"] = 396,
    Ray = 556,
    ["Read the Docs"] = 397,
    ["Red-DiscordBot Cog"] = 400,
    ["Red-DiscordBot Cog Repo"] = 401,
    ["Red-DiscordBot Trivia"] = 402,
    Renovate = 411,
    ["Replit schema"] = 405,
    RoadRunner = 412,
    Ruff = 408,
    ["Rust Project"] = 409,
    ["Rust toolchain"] = 414,
    ["SIL Kit Participant Configuration"] = 440,
    SWADL = 462,
    ["Sapphire CLI Config"] = 415,
    ["SauceCTL Configuration"] = 594,
    ["Schema Catalog"] = 428,
    ["Scoop manifest"] = 433,
    ["Semgrep Rule"] = 435,
    ["Serenity Code Generator (Sergen)"] = 436,
    ["Serverless Framework Configuration"] = 601,
    ["Serverless Workflow Schema"] = 603,
    ["Settings.paf"] = 438,
    ["Shopware 6 Configuration"] = 604,
    ["Shopware CLI Extension Store Configuration"] = 605,
    ["Shopware CLI Project Store Configuration"] = 606,
    ["Slack app manifest"] = 442,
    Solidarity = 445,
    ["Solution filters"] = 446,
    ["Source Maps v3"] = 447,
    Sourcery = 448,
    SpecIF = 449,
    ["Sponge Mixin configuration"] = 450,
    ["StackHawk Scanner Configuration"] = 600,
    Stale = 454,
    Starship = 455,
    ["Statamic Blueprint"] = 456,
    ["StrmPrivacy Data Connector"] = 645,
    ["StrmPrivacy Data Contract"] = 646,
    ["StrmPrivacy SimpleSchema"] = 643,
    ["StrmPrivacy Stream"] = 644,
    ["StrmPrivacy batch job configuration file"] = 642,
    ["Stryker Mutator"] = 459,
    ["StyleCop Analyzers Configuration"] = 460,
    ["Swagger API 2.0"] = 463,
    TSON = 486,
    ["Talisman configuration"] = 465,
    ["Taskfile YAML Schema"] = 582,
    Taurus = 466,
    ["TestEnvironment.json"] = 474,
    ["Tier.run pricing.json"] = 469,
    Tikibase = 470,
    ["Traefik v2"] = 477,
    ["Traefik v2 File Provider"] = 478,
    Turborepo = 475,
    Tye = 608,
    ["UI5 Manifest"] = 493,
    ["UTAM Page Object"] = 496,
    ["Ubuntu Server Autoinstall"] = 491,
    ["Uniswap Token List"] = 565,
    ["Unreal Engine Uplugin"] = 651,
    ["Unreal Engine Uproject"] = 652,
    Updatecli = 615,
    Uplift = 649,
    ["User Journey Map YAML Schema"] = 585,
    V2Ray = 619,
    ["VSCode Code Snippets"] = 131,
    ["VSIX CLI publishing"] = 509,
    ["Vela Pipeline Configuration"] = 499,
    Vercel = 130,
    ["Web App Manifest"] = 514,
    ["Web types"] = 517,
    WebExtensions = 513,
    ["Webman package recipe"] = 625,
    ["Windows Package Manager Installer Manifest"] = 562,
    ["Windows Package Manager Locale Manifest"] = 563,
    ["Windows Package Manager Singleton Manifest"] = 561,
    ["Woodpecker pipeline config"] = 596,
    ["Xstate Machine Schema"] = 613,
    ["Yippee-Ki-JSON configuration YML"] = 567,
    ["angular.json"] = 11,
    ...
    ["ize.toml"] = 648,
    ["jsconfig.json"] = 283,
    ["jscpd Configuration Schema"] = 630,
    jsdoc = 555,
    ["k3d.yaml"] = 284,
    ...
    ["local.settings.json"] = 301,
    ["localazy.json"] = 302,
    ["lsdlschema.json"] = 303,
    ["markdown-lint-check"] = 593,
    mboats = 599,
    ["mimetypes.json"] = 310,
    ["mirrord-schema"] = 538,
    ["mta.yaml"] = 539,
    ["mtad.yaml"] = 540,
    ["mycode.json"] = 331,
    ["napari plugin manifest"] = 332,
    neoload = 550,
    ["nest-cli"] = 337,
    ["ninjs (News in JSON) 1.3"] = 336,
    ["ninjs (News in JSON) 2.0"] = 335,
    ["nlu.json"] = 338,
    ["nodemon.json"] = 340,
    ["noodl.schema.json"] = 598,
    now = 546,
    ["npm-badges"] = 343,
    ["nswag.json"] = 346,
    ntangle = 347,
    ["nuclei-template.yaml"] = 344,
    ["nuget-project.json"] = 345,
    ["ocelot.json"] = 349,
    ["omnisharp.json"] = 350,
    ["openapi.json"] = 351,
    ["openfin.json"] = 353,
    ["openrpc.json"] = 352,
    ["package.json"] = 364,
    ["package.manifest"] = 365,
    ["pattern.json"] = 368,
    ["petstore-v1.0"] = 640,
    pgap_yaml_input_reader = 367,
    ["plagiarize-me.yaml"] = 372,
    ["plagiarize.yaml"] = 371,
    ["portman.json"] = 373,
    ["prettierrc.json"] = 378,
    ["prisma.yml"] = 379,
    ["project-1.0.0-beta3.json"] = 381,
    ["project-1.0.0-beta4.json"] = 382,
    ["project-1.0.0-beta5.json"] = 383,
    ["project-1.0.0-beta6.json"] = 384,
    ["project-1.0.0-beta8.json"] = 385,
    ["project-1.0.0-rc1.json"] = 386,
    ["project-1.0.0-rc2.json"] = 387,
    ["project.json"] = 380,
    ["prometheus.json"] = 388,
    ["prometheus.rules.json"] = 389,
    ["proxies.json"] = 390,
    ["publiccode.yml"] = 391,
    ["pubspec.yaml"] = 392,
    ["pyrseas-0.8.json"] = 395,
    ["release drafter"] = 551,
    rtx = 407,
    rustfmt = 413,
    ["sarif-1.0.0.json"] = 416,
    ["sarif-2.0.0.json"] = 417,
    ["sarif-2.1.0"] = 426,
    ["sarif-2.1.0-rtm.2"] = 418,
    ["sarif-2.1.0-rtm.3"] = 420,
    ["sarif-2.1.0-rtm.4"] = 422,
    ["sarif-2.1.0-rtm.5"] = 424,
    ["sarif-external-property-file-2.1.0"] = 427,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 419,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 421,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 423,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 425,
    ["schema.org - Action"] = 429,
    ["schema.org - ContactPoint"] = 430,
    ["schema.org - Place"] = 431,
    ["schema.org - Thing"] = 432,
    ["semantic-release"] = 434,
    ["servicehub.config.json"] = 527,
    ["servicehub.service.json"] = 526,
    ["settings.job"] = 437,
    ["sfdx-hardis configuration"] = 439,
    ["size-limit configuration"] = 441,
    ["skaffold.yaml"] = 591,
    ["skyuxconfig.json"] = 443,
    snapcraft = 444,
    ["stripe-app-local.json"] = 458,
    ["stripe-app.json"] = 457,
    swcrc = 578,
    ["task.json"] = 464,
    taskcat = 547,
    ["template.json"] = 467,
    ["templatsources.json"] = 468,
    ["theme.json"] = 471,
    ["tizen_workspace.json"] = 472,
    tmLanguage = 473,
    tmuxinator = 535,
    ["transcend.yml"] = 479,
    ["trunk.yaml schema"] = 480,
    ["ts-force-config.json"] = 484,
    ["tsconfig.json"] = 481,
    ["tsd.json"] = 482,
    ["tsdrc.json"] = 483,
    ["tslint.json"] = 485,
    ...
    ["vega-lite.json"] = 498,
    ["vega.json"] = 497,
    ["venvironment-basic.yaml"] = 501,
    ["venvironment.yaml"] = 500,
    ["version.json"] = 502,
    ["vim-addon-info"] = 503,
    ["vs-2017.3.host.json"] = 505,
    ["vs-nesting.json"] = 506,
    ["vsls.json"] = 504,
    ["vss-extension.json"] = 510,
    ["webhint.io"] = 626,
    ["webjobpublishsettings.json"] = 516,
    ["webjobs-list.json"] = 515,
    ["xs-app.json"] = 543,
    ["xunit.runner.json"] = 525,
    yamllint = 566,
    zuul = 552,
    ["Žinoma"] = 560
  },
