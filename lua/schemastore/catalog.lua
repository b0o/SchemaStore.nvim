...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 141,
    [".cryproj (generic)"] = 478,
    [".cryproj engine-5.2"] = 473,
    [".cryproj engine-5.3"] = 474,
    [".cryproj engine-5.4"] = 475,
    [".cryproj engine-5.5"] = 476,
    [".cryproj engine-dev"] = 477,
    [".csscomb.json"] = 143,
    [".csslintrc"] = 144,
    [".eslintrc"] = 185,
    [".esmrc.json"] = 177,
    ...
    [".vsext"] = 453,
    [".yarnrc.yml"] = 519,
    ["<div>RIOTS' studio configuration"] = 457,
    ["@factorial/drupal-breakpoints-css"] = 3,
    ["API Builder"] = 516,
    ["AVA Configuration Schema"] = 570,
    ...
    ["Better Code Hub"] = 521,
    ["Better Scripts"] = 75,
    BizTalkServerApplicationSchema = 493,
    ...
    ["Butane Config"] = 557,
    ["CICS TS region tagging"] = 564,
    ["CICS TS resource import"] = 565,
    ["CICS TS resource model"] = 566,
    ["CICS TS resource overrides"] = 567,
    ["CMake Presets"] = 76,
    ...
    ["Embrace Config Schema"] = 582,
    ["Error pages"] = 180,
    Esquio = 178,
    ["Estuary Flow Catalog Schema"] = 561,
    ["Expo SDK"] = 183,
    ...
    Goreleaser = 211,
    ["Goreleaser Pro"] = 212,
    ["Gradle Build Cache Node"] = 518,
    ["Gradle Enterprise"] = 517,
    ...
    HEMTT = 490,
    Hadolint = 502,
    ["Hardware Sentry Configuration"] = 575,
    Hayson = 224,
    ...
    ["JFrog File Spec"] = 243,
    ["JFrog Pipelines YML DSL"] = 584,
    ["JSON Document Transform"] = 251,
    ["JSON Feed"] = 252,
    ["JSON Resume"] = 363,
    ["JSON Schema Draft 2020-12"] = 469,
    ["JSON Schema Draft 4"] = 466,
    ["JSON Schema Draft 7"] = 467,
    ["JSON Schema Draft 8"] = 468,
    ...
    ["KSP-AVC"] = 464,
    ["KSP-CKAN"] = 465,
    ["Keycloak REST API"] = 586,
    ["Knative Functions - func.yaml"] = 195,
    ["KoDE/CI build.yaml"] = 580,
    ["Kong DBLess Schema"] = 581,
    KrakenD = 257,
    ["LinkML Metamodel"] = 268,
    Liquibase = 532,
    ["Liquibase Flow File"] = 533,
    Markdownlint = 536,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 579,
    ["Monika Configuration Schema"] = 577,
    ["Motif config"] = 486,
    ["Netin Diagnostic System Template"] = 541,
    ...
    Opctl = 489,
    ["OpenWeather Current Weather API"] = 525,
    ["OpenWeather Road Risk API"] = 524,
    ...
    Packer = 325,
    ["Pipeline component"] = 534,
    ["PocketMine plugin.yml"] = 329,
    Pterodactyl = 574,
    ["Pull Request Labeler"] = 352,
    PyProject = 356,
    Qodana = 550,
    ["Quali Torque Blueprint Spec 2"] = 572,
    ["QueryFirst config file"] = 589,
    ["RKE Cluster Configuration JSON Schema"] = 531,
    ["RKE Cluster Configuration YAML Schema"] = 530,
    Ray = 501,
    ["Read the Docs"] = 355,
    ...
    ["SauceCTL Configuration"] = 538,
    ["Schema Catalog"] = 381,
    ["Scoop manifest"] = 386,
    ["Semgrep Rule"] = 388,
    ["Serverless Framework Configuration"] = 545,
    ["Serverless Workflow Schema"] = 546,
    ["Settings.paf"] = 390,
    ["Shopware 6 Configuration"] = 547,
    ["Shopware CLI Extension Store Configuration"] = 548,
    ["Shopware CLI Project Store Configuration"] = 549,
    Solidarity = 396,
    ["Solution filters"] = 397,
    ["Source Maps v3"] = 398,
    SpecIF = 399,
    ["Sponge Mixin configuration"] = 400,
    ["StackHawk Scanner Configuration"] = 544,
    Stale = 404,
    Starship = 405,
    ["Statamic Blueprint"] = 406,
    ["StrmPrivacy batch job configuration file"] = 585,
    ["Stryker Mutator"] = 409,
    ["StyleCop Analyzers Configuration"] = 410,
    ["Swagger API 2.0"] = 413,
    TSON = 433,
    ["Talisman configuration"] = 414,
    ["Taskfile YAML Schema"] = 527,
    Taurus = 415,
    ["TestEnvironment.json"] = 422,
    Tikibase = 418,
    ["Traefik v2"] = 425,
    ["Traefik v2 File Provider"] = 426,
    Turborepo = 423,
    Tye = 551,
    ["UI5 Manifest"] = 439,
    ["UTAM Page Object"] = 441,
    ["Ubuntu Server Autoinstall"] = 437,
    ["Uniswap Token List"] = 510,
    Updatecli = 558,
    Uplift = 588,
    ["User Journey Map YAML Schema"] = 529,
    V2Ray = 562,
    ["VSCode Code Snippets"] = 117,
    ["VSIX CLI publishing"] = 454,
    ["Vela Pipeline Configuration"] = 444,
    Vercel = 116,
    ["Web App Manifest"] = 459,
    ["Web types"] = 462,
    WebExtensions = 458,
    ["Webman package recipe"] = 568,
    ["Windows Package Manager Installer Manifest"] = 507,
    ["Windows Package Manager Locale Manifest"] = 508,
    ["Windows Package Manager Singleton Manifest"] = 506,
    ["Woodpecker pipeline config"] = 540,
    ["Xstate Machine Schema"] = 556,
    ["Yippee-Ki-JSON configuration YML"] = 512,
    ["angular.json"] = 9,
    ...
    ["ize.toml"] = 587,
    ["jsconfig.json"] = 255,
    ["jscpd Configuration Schema"] = 573,
    jsdoc = 500,
    ["k3d.yaml"] = 256,
    ...
    ["servicehub.config.json"] = 472,
    ["servicehub.service.json"] = 471,
    ["settings.job"] = 389,
    ...
    snapcraft = 395,
    ["stripe-app-local.json"] = 408,
    ["stripe-app.json"] = 407,
    swcrc = 523,
    taskcat = 492,
    ["template.json"] = 416,
    ["templatsources.json"] = 417,
    ["theme.json"] = 419,
    ["tizen_workspace.json"] = 420,
    tmLanguage = 421,
    tmuxinator = 480,
    ["trunk.yaml schema"] = 427,
    ["ts-force-config.json"] = 431,
    ["tsconfig.json"] = 428,
    ["tsd.json"] = 429,
    ["tsdrc.json"] = 430,
    ["tslint.json"] = 432,
    ...
    ["vega-lite.json"] = 443,
    ["vega.json"] = 442,
    ["venvironment-basic.yaml"] = 446,
    ["venvironment.yaml"] = 445,
    ["version.json"] = 447,
    ["vim-addon-info"] = 448,
    ["vs-2017.3.host.json"] = 450,
    ["vs-nesting.json"] = 451,
    ["vsls.json"] = 449,
    ["vss-extension.json"] = 455,
    ["webhint.io"] = 569,
    ["webjobpublishsettings.json"] = 461,
    ["webjobs-list.json"] = 460,
    ["xs-app.json"] = 488,
    ["xunit.runner.json"] = 470,
    yamllint = 511,
    zuul = 497,
    ["Žinoma"] = 505
  },
