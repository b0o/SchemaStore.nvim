...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 200,
    [".cryproj (generic)"] = 675,
    [".cryproj engine-5.2"] = 670,
    [".cryproj engine-5.3"] = 671,
    [".cryproj engine-5.4"] = 672,
    [".cryproj engine-5.5"] = 673,
    [".cryproj engine-dev"] = 674,
    [".eslintrc"] = 256,
    [".esmrc.json"] = 248,
    [".ffizer.yaml"] = 260,
    [".htmlhintrc"] = 317,
    ...
    [".mtaext"] = 686,
    [".nodehawkrc"] = 429,
    [".npmpackagejsonlintrc"] = 433,
    [".omletrc"] = 861,
    [".phrase.yml"] = 479,
    [".phraseapp.yml"] = 480,
    [".pmbot.yml"] = 469,
    [".postcssrc"] = 474,
    [".powerpages-web-template-manifest"] = 476,
    [".pre-commit-config.yml"] = 477,
    [".pre-commit-hooks.yml"] = 478,
    [".putout.json"] = 499,
    [".rehyperc"] = 518,
    [".remarkrc"] = 520,
    [".sprite files"] = 578,
    ...
    ["<div>RIOTS' studio configuration"] = 653,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 384,
    ABCSupplyPlan = 13,
    AIConfig = 14,
    ["API Builder"] = 718,
    ["AVA Configuration"] = 778,
    ...
    ["Adobe UXP Manifest"] = 843,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 15,
    ["Airplane task"] = 16,
    ["Alacritty Configuration"] = 750,
    ["All Contributors configuration file"] = 808,
    ...
    ["Azure Pipelines"] = 68,
    ["Azure Static Web Apps CLI configuration file"] = 581,
    ["Azure Static Web Apps configuration file"] = 580,
    ["BX CI"] = 106,
    ["Bashly (bashly.yml)"] = 812,
    ["Bashly Settings (bashly-settings.yml)"] = 813,
    ["Better Code Hub"] = 722,
    ["Better Scripts"] = 107,
    Bigconfig = 85,
    BizTalkServerApplicationSchema = 692,
    Bleep = 108,
    ...
    ["Butane Config"] = 763,
    ["CGS Custom Card Game (CardGameDef.json)"] = 848,
    ["CICS TS region tagging"] = 772,
    ["CICS TS resource import"] = 773,
    ["CICS TS resource model"] = 774,
    ["CICS TS resource overrides"] = 775,
    ["CMake Presets"] = 109,
    ["CNC Codes"] = 121,
    ["CSS Comb (.csscomb.json)"] = 202,
    ["CSS Lint (.csslintrc)"] = 203,
    ["CSpell (cspell.json)"] = 201,
    ...
    ["Citation File Format"] = 189,
    CityJSON = 118,
    ["Clawject config"] = 126,
    ["Cloud Foundry Application Manifest"] = 860,
    ["Code Climate"] = 154,
    CodeCV = 64,
    ...
    Conjure = 120,
    ["Container Structure Test"] = 705,
    Containerlab = 730,
    ["Crowdsec collection config"] = 196,
    ["Crowdsec parser config"] = 197,
    ["Crowdsec scenario config"] = 198,
    ["CumulusCI Config"] = 125,
    ["Custom Machinery Machine"] = 849,
    ["Custom Machinery Recipe"] = 850,
    ["Cycle Stack File"] = 128,
    ["DWP Exchange - catalogue entry"] = 243,
    ["DWP Exchange - gateway"] = 241,
    ["DWP Exchange - meta"] = 242,
    ["Dart Build Config (dart-build.json)"] = 204,
    ["Dart Test Config (dart-test.json)"] = 205,
    ["DashLord Configuration"] = 206,
    ["Data Contract Specification"] = 207,
    ["Data Product Specification"] = 208,
    ["DataYoga Connections"] = 129,
    ["DataYoga Job"] = 130,
    ["Databricks Asset Bundles"] = 829,
    ["Datadog Service Definition"] = 360,
    ["Datahub Ingestion Recipe"] = 779,
    ["Dein Config"] = 132,
    ["Deno Config (deno.json)"] = 214,
    ["Dependency cruiser"] = 133,
    ["Deployer Recipe"] = 217,
    ["Deta Spacefile"] = 134,
    ["Detekt Config (detekt.yml)"] = 218,
    ["Devbox Config"] = 135,
    ["Devbox Plugin"] = 136,
    Devfile = 240,
    ["Discord Webhook"] = 219,
    ["DocFx Config (docfx.json)"] = 222,
    ["Dolittle Artifacts"] = 223,
    ["Dolittle Bounded Context Configuration"] = 224,
    ["Dolittle Event Horizons Configuration"] = 225,
    ["Dolittle Resources Configuration"] = 226,
    ["Dolittle Server Configuration"] = 227,
    ["Dolittle Tenant Map Configuration"] = 229,
    ["Dolittle Tenants Configuration"] = 228,
    ["Dolittle Topology"] = 230,
    ...
    ["Drupal Routing"] = 147,
    ["Drupal Services"] = 149,
    ["Drush site aliases"] = 236,
    ["Dynamic Bash Aliases (.aliases)"] = 820,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 809,
    ["Elgato Stream Deck"] = 246,
    ["Embrace Config"] = 790,
    Endurica = 833,
    ["Enterprise Contract Policy Spec"] = 247,
    ["Erda Pipeline"] = 856,
    ["Erda Runtime"] = 857,
    ["Error pages"] = 251,
    Esquio = 249,
    ["Estuary Flow Catalog"] = 769,
    ["Expo SDK"] = 254,
    ["F-Droid Data metadata"] = 259,
    ["Facets - FSDL - Application"] = 257,
    ["FasterCI Configuration"] = 69,
    FiQuS = 263,
    Firebase = 261,
    ["Flow.json Configurations"] = 853,
    ["Fossa configuration file"] = 270,
    ["Fossa's fossa-deps file"] = 271,
    ["Foundry VTT - Base package Manifest"] = 265,
    ["Foundry VTT - Module Manifest"] = 266,
    ["Foundry VTT - System Data Template"] = 269,
    ["Foundry VTT - System Manifest"] = 267,
    ["Foundry VTT - World Manifest"] = 268,
    ["Foxx Manifest"] = 70,
    ["Freifunk.de Community API"] = 73,
    ["Frogbot Config"] = 74,
    ["G2P Mapping Configuration"] = 275,
    ["GCP Blueprint Metadata"] = 278,
    Gaspar = 276,
    ["GatewayCore API Gateway"] = 277,
    ["GeoJSON.json latest"] = 767,
    GherKing = 771,
    ["GitHub Action"] = 283,
    ["GitHub Discussion"] = 284,
    ["GitHub Funding"] = 285,
    ["GitHub Issue Template configuration"] = 287,
    ["GitHub Issue Template forms"] = 286,
    ["GitHub Workflow"] = 288,
    ["GitHub Workflow Template Properties"] = 289,
    ["GitHub automatically generated release notes configuration"] = 290,
    ["GitLab Agent for Kubernetes configuration"] = 845,
    GitVersion = 280,
    ["Gitea Issue Template configuration"] = 281,
    ["Gitea Issue Template forms"] = 282,
    ["Gitpod Configuration"] = 292,
    ["GlazeWM settings"] = 847,
    ["Global Privacy Control"] = 279,
    Goblet = 828,
    ["Golangci-lint Configuration"] = 294,
    ["Golangci-lint Custom Plugins Configuration"] = 295,
    ["Google Chrome Related Website Sets"] = 262,
    ["Google Cloud Workflows"] = 183,
    Goreleaser = 297,
    ["Goreleaser Pro"] = 298,
    Goss = 299,
    ["Gradle Build Cache Node"] = 720,
    ["Gradle Enterprise"] = 719,
    ["Grafana 5.x Dashboard"] = 300,
    ["GraphQL Code Generator"] = 304,
    ["GraphQL Config"] = 303,
    ["GraphQL Mesh"] = 302,
    ["Grunt JSHint task"] = 308,
    ["Grunt Watch task"] = 309,
    ["Grunt base task"] = 310,
    ["Grunt clean task"] = 306,
    ["Grunt copy task"] = 305,
    ["Grunt cssmin task"] = 307,
    HEMTT = 689,
    Hadolint = 701,
    Hammerkit = 729,
    ["Hardware Sentry Configuration"] = 783,
    Hatch = 702,
    Hayson = 312,
    ["Haystack Pipeline"] = 313,
    ["Hazelcast 5 Configuration"] = 314,
    ["Helm Chart.lock"] = 151,
    ["Helm Chart.yaml"] = 150,
    ["Helm Unittest Test Suite"] = 152,
    Hugo = 759,
    ["Hugo Theme"] = 758,
    ["Hyperfoil benchmark configuration"] = 319,
    ["IBM Zapp document"] = 320,
    ["IBM zCodeFormatSettings"] = 321,
    ["IMG Catapult PSP"] = 326,
    ["IVMS101 by CODE Protocol"] = 846,
    Infrahub = 328,
    Istanbul = 786,
    ["JDownloader2 crawler multi-rules"] = 337,
    ["JDownloader2 crawler single-rules"] = 336,
    ["JFrog Applications Config"] = 338,
    ["JFrog File Spec"] = 339,
    ["JFrog Pipelines YML DSL"] = 792,
    ["JMeter DSL cli config"] = 340,
    JReleaser = 342,
    ["JSON Document Transform"] = 350,
    ["JSON Feed"] = 351,
    ["JSON Resume"] = 525,
    ["JSON Schema Draft 2020-12"] = 666,
    ["JSON Schema Draft 4"] = 663,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 830,
    ["JSON Schema Draft 7"] = 664,
    ["JSON Schema Draft 7 (unofficial strict)"] = 831,
    ["JSON Schema Draft 8 (2019-09)"] = 665,
    ["JSON-API"] = 349,
    ["JSON-WF"] = 859,
    ["JSON-e templates"] = 727,
    ["JSON-stat 2.0"] = 660,
    JSONPatch = 353,
    ["JSR Package Config (jsr.json)"] = 343,
    Jasmine = 332,
    Jekyll = 333,
    ["Jenkins X Pipelines"] = 334,
    ["Jenkins X Requirements"] = 335,
    ["Jovo Language Models"] = 341,
    ["KIMMDY config file"] = 358,
    ["KSP-AVC"] = 661,
    ["KSP-CKAN"] = 662,
    KSY = 858,
    ["Karakum configuration file"] = 272,
    Kas = 356,
    ["Keycloak REST API"] = 800,
    ["Knative Functions - func.yaml"] = 273,
    ["KoDE/CI build.yaml"] = 788,
    ["Kong DBLess config"] = 789,
    KrakenD = 359,
    ["Kubri Configuration"] = 364,
    LOOBin = 379,
    Lefthook = 368,
    ["Liferay client-extension.yaml"] = 375,
    ["LinkML Metamodel"] = 377,
    Liquibase = 735,
    ["Liquibase Flow File"] = 736,
    ["Lively Properties"] = 378,
    ["Lobe AI Agent"] = 66,
    Loki = 67,
    ["MLOS Configs"] = 413,
    ["MS2Rescore Configuration"] = 416,
    ["Madness (madness.yml)"] = 811,
    Markdownlint = 739,
    ["Mason Registry"] = 741,
    ["MegaLinter configuration"] = 385,
    ["MegaLinter descriptor"] = 386,
    Melange = 837,
    ["Meltano plugin discovery definition"] = 388,
    ["Meltano project definition"] = 387,
    ["Mergify Configuration"] = 417,
    ["MetricsHub Configuration"] = 389,
    ["MetricsHub Connector Configuration"] = 390,
    ["Micro Editor Syntax"] = 821,
    ["Microsoft Band Web Tile"] = 391,
    ["Minecraft Custom Main Menu Mod"] = 838,
    ["Minecraft Data Pack Advancement"] = 393,
    ["Minecraft Data Pack Biome"] = 394,
    ["Minecraft Data Pack Configured Carver"] = 395,
    ["Minecraft Data Pack Damage Type"] = 396,
    ["Minecraft Data Pack Dimension"] = 398,
    ["Minecraft Data Pack Dimension Type"] = 397,
    ["Minecraft Data Pack Item Modifier"] = 399,
    ["Minecraft Data Pack Loot Table"] = 400,
    ["Minecraft Data Pack Metadata"] = 401,
    ["Minecraft Data Pack Predicate"] = 402,
    ["Minecraft Data Pack Recipe"] = 403,
    ["Minecraft Data Pack Tag"] = 404,
    ["Minecraft Data Pack Template Pool"] = 405,
    ["Minecraft Data Pack Trim Material"] = 410,
    ["Minecraft Data Pack Trim Pattern"] = 411,
    ["Minecraft Resource Pack Lang"] = 406,
    ["Minecraft Resource Pack Particle"] = 407,
    ["Minecraft Resource Pack Texture Mcmeta"] = 409,
    ["Minecraft Resourcepack Sounds"] = 408,
    ["MkDocs Configuration 1.0"] = 412,
    ["Monade CLI Stack Configuration"] = 420,
    ["MongoDB Atlas Search Index Definition"] = 787,
    ["Monika Configuration"] = 785,
    ["Monoweave Configuration"] = 415,
    ["Motif config"] = 685,
    ["NOX Framework (Service)"] = 432,
    ["Netin Diagnostic System Template"] = 745,
    ["Netlify config"] = 423,
    ["Network-as-Code Data Model"] = 424,
    ["Nightwatch.js"] = 425,
    ["Nuitka.yaml"] = 851,
    ["ONe's changelog entry"] = 448,
    ["ONe's service descriptor"] = 447,
    ["OSS Review Toolkit configuration"] = 455,
    ["OSS Review Toolkit curation"] = 456,
    ["OSS Review Toolkit package configuration"] = 457,
    ["OSS Review Toolkit repository configuration"] = 458,
    ["OSS Review Toolkit resolutions"] = 459,
    Opctl = 688,
    ["OpenRewrite Resource"] = 450,
    ["OpenUtau character yaml"] = 444,
    ["OpenUtau ustx"] = 445,
    ["OpenWeather Current Weather API"] = 726,
    ["OpenWeather Road Risk API"] = 725,
    ["Ory Hydra configuration"] = 318,
    ["Ory Keto configuration"] = 361,
    ["Ory Kratos configuration"] = 454,
    ["Ory Oathkeeper configuration"] = 439,
    ["Outblocks App configuration"] = 452,
    ["Outblocks database table"] = 453,
    ["Outblocks project configuration"] = 451,
    PDM = 465,
    Packer = 462,
    Pantsbuild = 807,
    ["Paper paper-plugin.yml"] = 463,
    ["Pipeline component"] = 737,
    ["PocketMine plugin.yml"] = 470,
    ["Postman collection"] = 475,
    ["Problem object RFC9457"] = 835,
    ["Problem package generators"] = 483,
    Pterodactyl = 782,
    ["Pull Request Labeler"] = 498,
    Pulumi = 504,
    PyProject = 505,
    Pyright = 506,
    Qgoda = 507,
    Qodana = 755,
    ["Quali Torque Blueprint Spec 2"] = 780,
    ["QueryFirst config file"] = 803,
    ["RKE Cluster Configuration JSON"] = 734,
    ["RKE Cluster Configuration YAML"] = 733,
    ["Rancher Fleet"] = 501,
    ["Rattler-build"] = 508,
    Ray = 700,
    ["Read the Docs"] = 503,
    ["Red-DiscordBot Cog"] = 515,
    ["Red-DiscordBot Cog Repo"] = 516,
    ["Red-DiscordBot Trivia"] = 517,
    ["Render Blueprints"] = 732,
    RenderCV = 527,
    Renovate = 526,
    ["Replit config"] = 521,
    RoadRunner = 528,
    ["Rudder techniques"] = 841,
    Ruff = 523,
    ["Rust Project"] = 524,
    ["Rust toolchain"] = 531,
    ["SDMX data message"] = 556,
    ["SDMX metadata message"] = 555,
    ["SDMX structure message"] = 554,
    ["SIL Kit Participant Configuration"] = 566,
    ["SIL Kit Registry Configuration"] = 567,
    SWADL = 592,
    ["Safebox Config"] = 793,
    ["Sapphire CLI Config"] = 534,
    ["SauceCTL Configuration"] = 742,
    ["Schema Catalog"] = 548,
    ["Scoop manifest"] = 553,
    ["Semantic Data Fabric (SDF) file"] = 557,
    ["Semgrep Rule"] = 559,
    ["Serenity Code Generator (Sergen)"] = 560,
    ["Serverless Framework Configuration"] = 749,
    ["Serverless Workflow"] = 751,
    ["Settings.paf"] = 562,
    ["Shopware 6 Configuration"] = 752,
    ["Shopware CLI Extension Store Configuration"] = 753,
    ["Shopware CLI Project Store Configuration"] = 754,
    Sigma = 564,
    ["Sigrid scope configuration file"] = 565,
    ["SkyPilot Task JSON"] = 842,
    ["Slack app manifest"] = 569,
    Solidarity = 572,
    ["Solution filters"] = 573,
    ["Source Maps v3"] = 574,
    Sourcery = 575,
    SpecIF = 576,
    ["Sponge Mixin configuration"] = 577,
    StackBlitz = 582,
    ["StackHawk Scanner Configuration"] = 748,
    Stale = 583,
    ["Starlake Data Pipeline"] = 723,
    Starship = 584,
    ["Statamic Blueprint"] = 585,
    ["Stella configuration file"] = 586,
    ["StrmPrivacy Data Connector"] = 797,
    ["StrmPrivacy Data Contract"] = 798,
    ["StrmPrivacy SimpleSchema"] = 795,
    ["StrmPrivacy Stream"] = 796,
    ["StrmPrivacy batch job configuration file"] = 794,
    ["Stryker Mutator"] = 589,
    ["StyleCop Analyzers Configuration"] = 590,
    ["Stylelint (.stylelintrc)"] = 591,
    ["Sublime Syntax"] = 799,
    ["Subsquid squid manifest"] = 844,
    ["Swagger API 2.0"] = 593,
    TSON = 619,
    TSTyche = 620,
    Talhelper = 595,
    ["Talisman configuration"] = 596,
    ["Taskfile config"] = 728,
    Taurus = 597,
    ["TestEnvironment.json"] = 606,
    ["TextMate Grammar"] = 605,
    ["Tier.run pricing.json"] = 600,
    Tikibase = 601,
    ["Traefik v2"] = 609,
    ["Traefik v2 File Provider"] = 610,
    ["Travis CI (.travis.yml)"] = 608,
    TunnelHub = 834,
    Turborepo = 607,
    Tye = 756,
    ["UET BuildConfig.json"] = 804,
    ["UI5 Manifest"] = 629,
    ["UNCORS configuration"] = 633,
    ["UTAM Page Object"] = 632,
    ["Ubuntu Server Autoinstall"] = 627,
    ["Uniswap Token List"] = 711,
    ["Unreal Engine Uplugin"] = 805,
    ["Unreal Engine Uproject"] = 806,
    ["Updatecli Compose"] = 764,
    ["Updatecli Policy Manifest"] = 765,
    ["Updatecli Policy Metadata"] = 766,
    Uplift = 802,
    ["User Journey Map"] = 731,
    V2Ray = 770,
    ["VSCode Code Snippets"] = 171,
    ["VSIX CLI publishing"] = 648,
    ["Vela Pipeline Configuration"] = 637,
    Vercel = 170,
    Visivo = 832,
    ["Web App Manifest"] = 655,
    ["Web types"] = 658,
    WebExtensions = 654,
    ["Webman package recipe"] = 776,
    ["Windows Package Manager Installer Manifest"] = 708,
    ["Windows Package Manager Locale Manifest"] = 709,
    ["Windows Package Manager Singleton Manifest"] = 707,
    ["Woodpecker pipeline config"] = 744,
    ["Wrangler CLI"] = 659,
    ["Xstate Machine"] = 762,
    ["Yarn Config (.yarnrc.yml)"] = 721,
    ["Yippee-Ki-JSON configuration YML"] = 713,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 836,
    ...
    ["behat.yml"] = 92,
    ["bigquery-table"] = 84,
    ["bioimageio resource description"] = 852,
    ...
    changelogging = 864,
    ["chisel-slices.json"] = 188,
    ["chrome-extension-locales-messages.json"] = 178,
    ["chutzpah.json"] = 179,
    cibuildwheel = 117,
    ["clang-format (.clang-format)"] = 768,
    ["clang-tidy"] = 158,
    clangd = 157,
    clib = 159,
    ...
    ["coffeelint.json"] = 190,
    ["commands.json"] = 174,
    ["commitlint (.commitlintrc)"] = 710,
    ["compile_commands.json"] = 173,
    ["compilerconfig.json"] = 172,
    ["completely.yml"] = 810,
    ["component-detection-manifest.json"] = 193,
    ["component.json"] = 192,
    ["composer.json"] = 191,
    ["conda-forge"] = 119,
    ["config.yaml"] = 502,
    ...
    ["crowdin.yml"] = 195,
    ["custom-elements.json"] = 824,
    ["cypress.json"] = 199,
    ["datalogic-scan2deploy-android"] = 209,
    ["datalogic-scan2deploy-ce"] = 210,
    ["dbt Project"] = 131,
    ["ddev-global"] = 211,
    ["ddev-project"] = 212,
    ["debugsettings.json"] = 213,
    ["dependabot-v2.json"] = 216,
    ["dependabot.json"] = 215,
    ["deployed-cli"] = 761,
    ...
    ["devspace.yaml"] = 784,
    djlint = 716,
    ["docker sequencer"] = 221,
    ["docker-compose.yml"] = 714,
    ["dockerd.json"] = 220,
    ["dotnet Release Index manifest"] = 231,
    ["dotnet-tools.json"] = 232,
    ["dotnetcli.host.json"] = 233,
    ["dprint.json"] = 234,
    ["drone.json"] = 235,
    ["dss-2.0.0.json"] = 237,
    ["dstack configuration"] = 238,
    ["dvc.yaml"] = 239,
    ["ecosystem.json"] = 244,
    eksctl = 245,
    ["electron-builder configuration file"] = 252,
    ["epr-manifest.json"] = 250,
    ["evcc.yaml"] = 253,
    ["ezd task runner"] = 255,
    ["fabric.mod.json"] = 258,
    ["first-timers-bot"] = 264,
    ...
    ["gitlab-ci"] = 291,
    ["global.json"] = 293,
    ["go-feature-flag Flag Configuration"] = 296,
    ["haxelib.json"] = 311,
    helmfile = 703,
    helmwave = 704,
    ["host-meta.json"] = 316,
    ...
    ["ide.host.json"] = 322,
    ["ifstate.conf"] = 323,
    ["imageoptimizer.json"] = 324,
    ["importmap.json"] = 327,
    ["ioBroker Configuration"] = 329,
    ["ioBroker JSON UI"] = 330,
    ["ioBroker Package manifest"] = 331,
    ["ize.toml"] = 801,
    ["jsconfig.json"] = 354,
    ["jscpd Configuration"] = 781,
    jsdoc = 699,
    ["k3d.yaml"] = 355,
    ["k9s plugin.yml"] = 357,
    ["kontinuous-config.yaml"] = 363,
    ["kontinuous-values.yaml"] = 362,
    ["kustomization.yaml"] = 365,
    ["label-commenter-config.yml"] = 366,
    ["latexindent configuration"] = 65,
    ["launchsettings.json"] = 367,
    lazydocker = 823,
    lazygit = 822,
    ["lego.json"] = 369,
    ["lerna.json"] = 370,
    ["lgtm.yml"] = 371,
    ["liblab.config.json"] = 372,
    ["libman.json"] = 373,
    ["license-report-config.json"] = 374,
    ["linkinator.config.json"] = 376,
    ["lint-staged (.lintstagedrc)"] = 679,
    ["local.settings.json"] = 381,
    ["localazy.json"] = 382,
    ["lotus.yaml"] = 380,
    ["lsdlschema.json"] = 383,
    ["markdown-link-check"] = 740,
    mboats = 747,
    ["micro-settings.json"] = 816,
    ["mimetypes.json"] = 392,
    ["mirrord config"] = 680,
    mise = 681,
    ["mise-settings"] = 682,
    ...
    ["mtad.yaml"] = 684,
    ["mycode.json"] = 421,
    ["napari plugin manifest"] = 422,
    neoload = 694,
    ["nest-cli"] = 427,
    ["ninjs (News in JSON)"] = 426,
    ["nixd configuration"] = 840,
    ["nlu.json"] = 428,
    ["nodemon.json"] = 430,
    ["noodl config"] = 746,
    ["notebook.mod.json"] = 431,
    now = 690,
    ["npm-badges"] = 434,
    ["nswag.json"] = 437,
    ntangle = 438,
    ["nuclei-template.yaml"] = 435,
    ["nuget-project.json"] = 436,
    ["ocelot.json"] = 440,
    ["omnisharp.json"] = 441,
    ["openapi.json"] = 442,
    ["openfin.json"] = 449,
    ...
    ["ops.yaml"] = 446,
    ["package.json"] = 460,
    ["package.manifest"] = 461,
    ["partial-black.json"] = 93,
    ["pathfinder.yml"] = 464,
    ["pattern.json"] = 467,
    ["petstore-v1.0"] = 791,
    pgap_yaml_input_reader = 466,
    ["pixi.toml"] = 468,
    ["plagiarize-me.yaml"] = 472,
    ["plagiarize.yaml"] = 471,
    ["portman.json"] = 473,
    ["prettierrc.json"] = 481,
    ["prisma.yml"] = 482,
    ["project-1.0.0-beta3.json"] = 485,
    ["project-1.0.0-beta4.json"] = 486,
    ["project-1.0.0-beta5.json"] = 487,
    ["project-1.0.0-beta6.json"] = 488,
    ["project-1.0.0-beta8.json"] = 489,
    ["project-1.0.0-rc1.json"] = 490,
    ["project-1.0.0-rc2.json"] = 491,
    ["project.json"] = 484,
    ["prometheus.json"] = 492,
    ["prometheus.rules.json"] = 493,
    ["prometheus.rules.test.json"] = 494,
    ["proxies.json"] = 495,
    ["publiccode.yml"] = 496,
    ["pubspec.yaml"] = 497,
    ["pyrseas-0.8.json"] = 500,
    ["quilt.mod.json"] = 817,
    ["rc3 auth"] = 509,
    ["rc3 collection"] = 510,
    ["rc3 environment"] = 511,
    ...
    ["rc3 settings"] = 514,
    ["release drafter"] = 695,
    ["release-plz.toml"] = 519,
    ["rivet.yaml"] = 839,
    rockcraft = 529,
    rustfmt = 530,
    samt = 532,
    samtrc = 533,
    ["sarif-1.0.0.json"] = 535,
    ["sarif-2.0.0.json"] = 536,
    ["sarif-2.1.0"] = 546,
    ["sarif-2.1.0-rtm.2"] = 537,
    ["sarif-2.1.0-rtm.3"] = 539,
    ["sarif-2.1.0-rtm.4"] = 541,
    ["sarif-2.1.0-rtm.5"] = 543,
    ["sarif-2.1.0-rtm.6"] = 544,
    ["sarif-external-property-file-2.1.0"] = 547,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 538,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 540,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 542,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 545,
    ["schema.org - Action"] = 549,
    ["schema.org - ContactPoint"] = 550,
    ["schema.org - Place"] = 551,
    ["schema.org - Thing"] = 552,
    ["secrethub.yml"] = 819,
    ["semantic-release"] = 558,
    ["servicehub.config.json"] = 669,
    ["servicehub.service.json"] = 668,
    ["settings.job"] = 561,
    ["sfdx-hardis configuration"] = 563,
    ["shard.yml"] = 855,
    ["size-limit configuration"] = 568,
    ["skaffold.yaml"] = 738,
    ["skyuxconfig.json"] = 570,
    snapcraft = 571,
    ["sqlc configuration"] = 579,
    ["stripe-app-local.json"] = 588,
    ["stripe-app.json"] = 587,
    swcrc = 724,
    ["task.json"] = 594,
    taskcat = 691,
    ["template.json"] = 598,
    ["templatsources.json"] = 599,
    ["theme.json"] = 602,
    ["tizen_workspace.json"] = 603,
    tldr = 604,
    tmuxinator = 677,
    ["transcend.yml"] = 611,
    ["tree-sitter grammar.json"] = 301,
    ["trime.yaml"] = 612,
    ["trunk.yaml"] = 613,
    ["ts-force-config.json"] = 617,
    ["tsconfig.json"] = 614,
    ["tsd.json"] = 615,
    ["tsdrc.json"] = 616,
    ["tslint.json"] = 618,
    ...
    ["vega-lite.json"] = 636,
    ["vega.json"] = 635,
    ["venvironment-basic.yaml"] = 639,
    ["venvironment.yaml"] = 638,
    ["version.json"] = 640,
    ["vim-addon-info"] = 642,
    ["vs-2017.3.host.json"] = 644,
    ["vs-nesting.json"] = 645,
    ["vsls.json"] = 643,
    ["vss-extension.json"] = 649,
    ["vtesttree.yaml"] = 650,
    ["vtestunit.yaml"] = 651,
    ["warp-keysets.json"] = 825,
    ["warp-themes.json"] = 826,
    ["warp-workflows.json"] = 827,
    ["webhint.io"] = 777,
    ["webjobpublishsettings.json"] = 657,
    ["webjobs-list.json"] = 656,
    ["well-known-fursona"] = 863,
    ["xs-app.json"] = 687,
    ["xunit.runner.json"] = 667,
    yamllint = 712,
    zuul = 696,
    ["Žinoma"] = 706
  },
