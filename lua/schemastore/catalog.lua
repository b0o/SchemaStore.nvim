...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 191,
    [".cryproj (generic)"] = 643,
    [".cryproj engine-5.2"] = 638,
    [".cryproj engine-5.3"] = 639,
    [".cryproj engine-5.4"] = 640,
    [".cryproj engine-5.5"] = 641,
    [".cryproj engine-dev"] = 642,
    [".eslintrc"] = 246,
    [".esmrc.json"] = 238,
    [".ffizer.yaml"] = 250,
    [".htmlhintrc"] = 304,
    ...
    [".mtaext"] = 654,
    [".nodehawkrc"] = 412,
    [".npmpackagejsonlintrc"] = 415,
    [".phraseapp.yml"] = 460,
    [".pmbot.yml"] = 450,
    [".postcssrc"] = 455,
    [".powerpages-web-template-manifest"] = 457,
    [".pre-commit-config.yml"] = 458,
    [".pre-commit-hooks.yml"] = 459,
    [".putout.json"] = 479,
    [".rehyperc"] = 491,
    [".remarkrc"] = 493,
    [".sprite files"] = 548,
    ...
    ["<div>RIOTS' studio configuration"] = 621,
    ["@factorial/drupal-breakpoints-css"] = 4,
    ["A micro editor config"] = 368,
    AIConfig = 11,
    ["API Builder"] = 686,
    ["AVA Configuration"] = 745,
    ...
    ["Adobe UXP Manifest"] = 810,
    ["Aerleon Network & Service Definitions"] = 7,
    ["Aerleon Policy"] = 8,
    ["Airlock Microgateway"] = 12,
    ["Airplane task"] = 13,
    ["Alacritty Configuration"] = 717,
    ["All Contributors configuration file"] = 775,
    ...
    ["Azure Pipelines"] = 64,
    ["Azure Static Web Apps CLI configuration file"] = 551,
    ["Azure Static Web Apps configuration file"] = 550,
    ["BX CI"] = 102,
    ["Bashly (bashly.yml)"] = 779,
    ["Bashly Settings (bashly-settings.yml)"] = 780,
    ["Better Code Hub"] = 690,
    ["Better Scripts"] = 103,
    Bigconfig = 81,
    BizTalkServerApplicationSchema = 660,
    Bleep = 104,
    ...
    ["Butane Config"] = 730,
    ["CGS Custom Card Game (CardGameDef.json)"] = 815,
    ["CICS TS region tagging"] = 739,
    ["CICS TS resource import"] = 740,
    ["CICS TS resource model"] = 741,
    ["CICS TS resource overrides"] = 742,
    ["CMake Presets"] = 105,
    ["CNC Codes"] = 116,
    ...
    ["DataYoga Job"] = 122,
    ["Databricks Asset Bundles"] = 796,
    ["Datadog Service Definition"] = 345,
    ["Datahub Ingestion Recipe"] = 746,
    ["Dein Config"] = 124,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 787,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 776,
    ...
    ["GeoJSON.json latest"] = 734,
    GherKing = 738,
    ["GitHub Action"] = 271,
    ["GitHub Discussion"] = 272,
    ["GitHub Funding"] = 273,
    ["GitHub Issue Template configuration"] = 275,
    ["GitHub Workflow"] = 276,
    ["GitHub Workflow Template Properties"] = 277,
    ["GitHub issue forms"] = 274,
    ["GitLab Agent for Kubernetes configuration"] = 812,
    GitVersion = 270,
    ["Gitpod Configuration"] = 279,
    ["GlazeWM settings"] = 814,
    ["Global Privacy Control"] = 269,
    Goblet = 795,
    ["Golangci-lint Configuration"] = 281,
    ["Golangci-lint Custom Plugins Configuration"] = 282,
    ["Google Chrome Related Website Sets"] = 252,
    ["Google Cloud Workflows"] = 174,
    Goreleaser = 284,
    ["Goreleaser Pro"] = 285,
    Goss = 286,
    ["Gradle Build Cache Node"] = 688,
    ["Gradle Enterprise"] = 687,
    ["Grafana 5.x Dashboard"] = 287,
    ["GraphQL Code Generator"] = 291,
    ["GraphQL Config"] = 290,
    ["GraphQL Mesh"] = 289,
    ["Grunt JSHint task"] = 295,
    ["Grunt Watch task"] = 296,
    ["Grunt base task"] = 297,
    ["Grunt clean task"] = 293,
    ["Grunt copy task"] = 292,
    ["Grunt cssmin task"] = 294,
    HEMTT = 657,
    Hadolint = 669,
    Hammerkit = 697,
    ["Hardware Sentry Configuration"] = 750,
    Hatch = 670,
    Hayson = 299,
    ["Haystack Pipeline"] = 300,
    ["Hazelcast 5 Configuration"] = 301,
    ["Helm Chart.lock"] = 143,
    ["Helm Chart.yaml"] = 142,
    ["Helm Unittest Test Suite"] = 144,
    Hugo = 726,
    ["Hugo Theme"] = 725,
    ["IBM Zapp document"] = 306,
    ["IBM zCodeFormatSettings"] = 307,
    ["IMG Catapult PSP"] = 312,
    ["IVMS101 by CODE Protocol"] = 813,
    Istanbul = 753,
    ["JDownloader2 crawler multi-rules"] = 322,
    ["JDownloader2 crawler single-rules"] = 321,
    ["JFrog Applications Config"] = 323,
    ["JFrog File Spec"] = 324,
    ["JFrog Pipelines YML DSL"] = 759,
    ["JMeter DSL cli config"] = 325,
    JReleaser = 327,
    ["JSON Document Transform"] = 335,
    ["JSON Feed"] = 336,
    ["JSON Resume"] = 498,
    ["JSON Schema Draft 2020-12"] = 634,
    ["JSON Schema Draft 4"] = 631,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 797,
    ["JSON Schema Draft 7"] = 632,
    ["JSON Schema Draft 7 (unofficial strict)"] = 798,
    ["JSON Schema Draft 8 (2019-09)"] = 633,
    ["JSON-API"] = 334,
    ["JSON-e templates"] = 695,
    ["JSON-stat 2.0"] = 628,
    JSONPatch = 338,
    ["JSR Package Config (jsr.json)"] = 328,
    Jasmine = 317,
    Jekyll = 318,
    ["Jenkins X Pipelines"] = 319,
    ["Jenkins X Requirements"] = 320,
    ["Jovo Language Models"] = 326,
    ["KIMMDY config file"] = 343,
    ["KSP-AVC"] = 629,
    ["KSP-CKAN"] = 630,
    ["Karakum configuration file"] = 262,
    Kas = 341,
    ["Keycloak REST API"] = 767,
    ["Knative Functions - func.yaml"] = 263,
    ["KoDE/CI build.yaml"] = 755,
    ["Kong DBLess config"] = 756,
    KrakenD = 344,
    LOOBin = 363,
    Lefthook = 352,
    ["Liferay client-extension.yaml"] = 359,
    ["LinkML Metamodel"] = 361,
    Liquibase = 702,
    ["Liquibase Flow File"] = 703,
    ["Lively Properties"] = 362,
    ["Lobe AI Agent"] = 63,
    ["MLOS Configs"] = 397,
    ["MS2Rescore Configuration"] = 400,
    ["Madness (madness.yml)"] = 778,
    Markdownlint = 706,
    ["Mason Registry"] = 708,
    ["MegaLinter configuration"] = 369,
    ["MegaLinter descriptor"] = 370,
    Melange = 804,
    ["Meltano plugin discovery definition"] = 372,
    ["Meltano project definition"] = 371,
    ["MetricsHub Configuration"] = 373,
    ["MetricsHub Connector Configuration"] = 374,
    ["Micro Editor Syntax"] = 788,
    ["Microsoft Band Web Tile"] = 375,
    ["Minecraft Custom Main Menu Mod"] = 805,
    ["Minecraft Data Pack Advancement"] = 377,
    ["Minecraft Data Pack Biome"] = 378,
    ["Minecraft Data Pack Configured Carver"] = 379,
    ["Minecraft Data Pack Damage Type"] = 380,
    ["Minecraft Data Pack Dimension"] = 382,
    ["Minecraft Data Pack Dimension Type"] = 381,
    ["Minecraft Data Pack Item Modifier"] = 383,
    ["Minecraft Data Pack Loot Table"] = 384,
    ["Minecraft Data Pack Metadata"] = 385,
    ["Minecraft Data Pack Predicate"] = 386,
    ["Minecraft Data Pack Recipe"] = 387,
    ["Minecraft Data Pack Tag"] = 388,
    ["Minecraft Data Pack Template Pool"] = 389,
    ["Minecraft Data Pack Trim Material"] = 394,
    ["Minecraft Data Pack Trim Pattern"] = 395,
    ["Minecraft Resource Pack Lang"] = 390,
    ["Minecraft Resource Pack Particle"] = 391,
    ["Minecraft Resource Pack Texture Mcmeta"] = 393,
    ["Minecraft Resourcepack Sounds"] = 392,
    ["MkDocs Configuration 1.0"] = 396,
    ["MongoDB Atlas Search Index Definition"] = 754,
    ["Monika Configuration"] = 752,
    ["Monoweave Configuration"] = 399,
    ["Motif config"] = 653,
    ["NOX Framework (Service)"] = 414,
    ["Netin Diagnostic System Template"] = 712,
    ["Netlify config"] = 405,
    ["Network-as-Code Data Model"] = 406,
    ["Nightwatch.js"] = 407,
    ["Nuitka.yaml"] = 818,
    ["ONe's changelog entry"] = 430,
    ["ONe's service descriptor"] = 429,
    ["OSS Review Toolkit configuration"] = 437,
    ["OSS Review Toolkit curation"] = 438,
    ["OSS Review Toolkit package configuration"] = 439,
    ["OSS Review Toolkit repository configuration"] = 440,
    ["OSS Review Toolkit resolutions"] = 441,
    Opctl = 656,
    ["OpenRewrite Resource"] = 432,
    ["OpenUtau character yaml"] = 426,
    ["OpenUtau ustx"] = 427,
    ["OpenWeather Current Weather API"] = 694,
    ["OpenWeather Road Risk API"] = 693,
    ["Ory Hydra configuration"] = 305,
    ["Ory Keto configuration"] = 346,
    ["Ory Kratos configuration"] = 436,
    ["Ory Oathkeeper configuration"] = 421,
    ["Outblocks App configuration"] = 434,
    ["Outblocks database table"] = 435,
    ["Outblocks project configuration"] = 433,
    PDM = 447,
    Packer = 444,
    Pantsbuild = 774,
    ["Paper paper-plugin.yml"] = 445,
    ["Pipeline component"] = 704,
    ["PocketMine plugin.yml"] = 451,
    ["Postman collection"] = 456,
    ["Problem object RFC9457"] = 802,
    ["Problem package generators"] = 463,
    Pterodactyl = 749,
    ["Pull Request Labeler"] = 478,
    Pulumi = 484,
    PyProject = 485,
    Pyright = 486,
    Qgoda = 487,
    Qodana = 722,
    ["Quali Torque Blueprint Spec 2"] = 747,
    ["QueryFirst config file"] = 770,
    ["RKE Cluster Configuration JSON"] = 701,
    ["RKE Cluster Configuration YAML"] = 700,
    ["Rancher Fleet"] = 481,
    Ray = 668,
    ["Read the Docs"] = 483,
    ["Red-DiscordBot Cog"] = 488,
    ["Red-DiscordBot Cog Repo"] = 489,
    ["Red-DiscordBot Trivia"] = 490,
    RenderCV = 500,
    Renovate = 499,
    ["Replit config"] = 494,
    RoadRunner = 501,
    ["Rudder techniques"] = 808,
    Ruff = 496,
    ["Rust Project"] = 497,
    ["Rust toolchain"] = 504,
    ["SIL Kit Participant Configuration"] = 536,
    ["SIL Kit Registry Configuration"] = 537,
    SWADL = 562,
    ["Safebox Config"] = 760,
    ["Sapphire CLI Config"] = 507,
    ["SauceCTL Configuration"] = 709,
    ["Schema Catalog"] = 521,
    ["Scoop manifest"] = 526,
    ["Semantic Data Fabric (SDF) file"] = 527,
    ["Semgrep Rule"] = 529,
    ["Serenity Code Generator (Sergen)"] = 530,
    ["Serverless Framework Configuration"] = 716,
    ["Serverless Workflow"] = 718,
    ["Settings.paf"] = 532,
    ["Shopware 6 Configuration"] = 719,
    ["Shopware CLI Extension Store Configuration"] = 720,
    ["Shopware CLI Project Store Configuration"] = 721,
    Sigma = 534,
    ["Sigrid scope configuration file"] = 535,
    ["SkyPilot Task JSON"] = 809,
    ["Slack app manifest"] = 539,
    Solidarity = 542,
    ["Solution filters"] = 543,
    ["Source Maps v3"] = 544,
    Sourcery = 545,
    SpecIF = 546,
    ["Sponge Mixin configuration"] = 547,
    StackBlitz = 552,
    ["StackHawk Scanner Configuration"] = 715,
    Stale = 553,
    ["Starlake Data Pipeline"] = 691,
    Starship = 554,
    ["Statamic Blueprint"] = 555,
    ["Stella configuration file"] = 556,
    ["StrmPrivacy Data Connector"] = 764,
    ["StrmPrivacy Data Contract"] = 765,
    ["StrmPrivacy SimpleSchema"] = 762,
    ["StrmPrivacy Stream"] = 763,
    ["StrmPrivacy batch job configuration file"] = 761,
    ["Stryker Mutator"] = 559,
    ["StyleCop Analyzers Configuration"] = 560,
    ["Stylelint (.stylelintrc)"] = 561,
    ["Sublime Syntax"] = 766,
    ["Subsquid squid manifest"] = 811,
    ["Swagger API 2.0"] = 563,
    TSON = 588,
    TSTyche = 589,
    Talhelper = 565,
    ["Talisman configuration"] = 566,
    ["Taskfile config"] = 696,
    Taurus = 567,
    ["TestEnvironment.json"] = 576,
    ["TextMate Grammar"] = 575,
    ["Tier.run pricing.json"] = 570,
    Tikibase = 571,
    ["Traefik v2"] = 579,
    ["Traefik v2 File Provider"] = 580,
    ["Travis CI (.travis.yml)"] = 578,
    TunnelHub = 801,
    Turborepo = 577,
    Tye = 723,
    ["UET BuildConfig.json"] = 771,
    ["UI5 Manifest"] = 598,
    ["UNCORS configuration"] = 602,
    ["UTAM Page Object"] = 601,
    ["Ubuntu Server Autoinstall"] = 596,
    ["Uniswap Token List"] = 679,
    ["Unreal Engine Uplugin"] = 772,
    ["Unreal Engine Uproject"] = 773,
    ["Updatecli Compose"] = 731,
    ["Updatecli Policy Manifest"] = 732,
    ["Updatecli Policy Metadata"] = 733,
    Uplift = 769,
    ["User Journey Map"] = 699,
    V2Ray = 737,
    ["VSCode Code Snippets"] = 162,
    ["VSIX CLI publishing"] = 616,
    ["Vela Pipeline Configuration"] = 605,
    Vercel = 161,
    Visivo = 799,
    ["Web App Manifest"] = 623,
    ["Web types"] = 626,
    WebExtensions = 622,
    ["Webman package recipe"] = 743,
    ["Windows Package Manager Installer Manifest"] = 676,
    ["Windows Package Manager Locale Manifest"] = 677,
    ["Windows Package Manager Singleton Manifest"] = 675,
    ["Woodpecker pipeline config"] = 711,
    ["Wrangler CLI"] = 627,
    ["Xstate Machine"] = 729,
    ["Yarn Config (.yarnrc.yml)"] = 689,
    ["Yippee-Ki-JSON configuration YML"] = 681,
    ["aerleon.yml"] = 6,
    ["angular.json"] = 14,
    apko = 803,
    ...
    ["gitlab-ci"] = 278,
    ["global.json"] = 280,
    ["go-feature-flag Flag Configuration"] = 283,
    ["haxelib.json"] = 298,
    helmfile = 671,
    helmwave = 672,
    ["host-meta.json"] = 303,
    ...
    ["ide.host.json"] = 308,
    ["ifstate.conf"] = 309,
    ["imageoptimizer.json"] = 310,
    ["importmap.json"] = 313,
    ["ioBroker Configuration"] = 314,
    ["ioBroker JSON UI"] = 315,
    ["ioBroker Package manifest"] = 316,
    ["ize.toml"] = 768,
    ["jsconfig.json"] = 339,
    ["jscpd Configuration"] = 748,
    jsdoc = 667,
    ["k3d.yaml"] = 340,
    ["k9s plugin.yml"] = 342,
    ["kontinuous-config.yaml"] = 348,
    ["kontinuous-values.yaml"] = 347,
    ["kustomization.yaml"] = 349,
    ["label-commenter-config.yml"] = 350,
    ["latexindent configuration"] = 62,
    ["launchsettings.json"] = 351,
    lazydocker = 790,
    lazygit = 789,
    ["lego.json"] = 353,
    ["lerna.json"] = 354,
    ["lgtm.yml"] = 355,
    ["liblab.config.json"] = 356,
    ["libman.json"] = 357,
    ["license-report-config.json"] = 358,
    ["linkinator.config.json"] = 360,
    ["lint-staged (.lintstagedrc)"] = 647,
    ["local.settings.json"] = 365,
    ["localazy.json"] = 366,
    ["lotus.yaml"] = 364,
    ["lsdlschema.json"] = 367,
    ["markdown-lint-check"] = 707,
    mboats = 714,
    ["micro-settings.json"] = 783,
    ["mimetypes.json"] = 376,
    ["mirrord config"] = 648,
    mise = 649,
    ["mise-settings"] = 650,
    ...
    ["mtad.yaml"] = 652,
    ["mycode.json"] = 403,
    ["napari plugin manifest"] = 404,
    neoload = 662,
    ["nest-cli"] = 410,
    ["ninjs (News in JSON) 1.3"] = 409,
    ["ninjs (News in JSON) 2.0"] = 408,
    ["nixd configuration"] = 807,
    ["nlu.json"] = 411,
    ["nodemon.json"] = 413,
    ["noodl config"] = 713,
    now = 658,
    ...
    ["nswag.json"] = 419,
    ntangle = 420,
    ["nuclei-template.yaml"] = 417,
    ["nuget-project.json"] = 418,
    ["ocelot.json"] = 422,
    ["omnisharp.json"] = 423,
    ["openapi.json"] = 424,
    ["openfin.json"] = 431,
    ...
    ["ops.yaml"] = 428,
    ["package.json"] = 442,
    ["package.manifest"] = 443,
    ["partial-black.json"] = 89,
    ["pathfinder.yml"] = 446,
    ["pattern.json"] = 449,
    ["petstore-v1.0"] = 758,
    pgap_yaml_input_reader = 448,
    ["plagiarize-me.yaml"] = 453,
    ["plagiarize.yaml"] = 452,
    ["portman.json"] = 454,
    ["prettierrc.json"] = 461,
    ["prisma.yml"] = 462,
    ["project-1.0.0-beta3.json"] = 465,
    ["project-1.0.0-beta4.json"] = 466,
    ["project-1.0.0-beta5.json"] = 467,
    ["project-1.0.0-beta6.json"] = 468,
    ["project-1.0.0-beta8.json"] = 469,
    ["project-1.0.0-rc1.json"] = 470,
    ["project-1.0.0-rc2.json"] = 471,
    ["project.json"] = 464,
    ["prometheus.json"] = 472,
    ["prometheus.rules.json"] = 473,
    ["prometheus.rules.test.json"] = 474,
    ["proxies.json"] = 475,
    ["publiccode.yml"] = 476,
    ["pubspec.yaml"] = 477,
    ["pyrseas-0.8.json"] = 480,
    ["quilt.mod.json"] = 784,
    ["release drafter"] = 663,
    ["release-plz.toml"] = 492,
    ["rivet.yaml"] = 806,
    rockcraft = 502,
    rustfmt = 503,
    samt = 505,
    samtrc = 506,
    ["sarif-1.0.0.json"] = 508,
    ["sarif-2.0.0.json"] = 509,
    ["sarif-2.1.0"] = 519,
    ["sarif-2.1.0-rtm.2"] = 510,
    ["sarif-2.1.0-rtm.3"] = 512,
    ["sarif-2.1.0-rtm.4"] = 514,
    ["sarif-2.1.0-rtm.5"] = 516,
    ["sarif-2.1.0-rtm.6"] = 517,
    ["sarif-external-property-file-2.1.0"] = 520,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 511,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 513,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 515,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 518,
    ["schema.org - Action"] = 522,
    ["schema.org - ContactPoint"] = 523,
    ["schema.org - Place"] = 524,
    ["schema.org - Thing"] = 525,
    ["secrethub.yml"] = 786,
    ["semantic-release"] = 528,
    ["servicehub.config.json"] = 637,
    ["servicehub.service.json"] = 636,
    ["settings.job"] = 531,
    ["sfdx-hardis configuration"] = 533,
    ["size-limit configuration"] = 538,
    ["skaffold.yaml"] = 705,
    ["skyuxconfig.json"] = 540,
    snapcraft = 541,
    ["sqlc configuration"] = 549,
    ["stripe-app-local.json"] = 558,
    ["stripe-app.json"] = 557,
    swcrc = 692,
    ["task.json"] = 564,
    taskcat = 659,
    ["template.json"] = 568,
    ["templatsources.json"] = 569,
    ["theme.json"] = 572,
    ["tizen_workspace.json"] = 573,
    tldr = 574,
    tmuxinator = 645,
    ["transcend.yml"] = 581,
    ["tree-sitter grammar.json"] = 288,
    ["trunk.yaml"] = 582,
    ["ts-force-config.json"] = 586,
    ["tsconfig.json"] = 583,
    ["tsd.json"] = 584,
    ["tsdrc.json"] = 585,
    ["tslint.json"] = 587,
    ...
    ["vega-lite.json"] = 604,
    ["vega.json"] = 603,
    ["venvironment-basic.yaml"] = 607,
    ["venvironment.yaml"] = 606,
    ["version.json"] = 608,
    ["vim-addon-info"] = 610,
    ["vs-2017.3.host.json"] = 612,
    ["vs-nesting.json"] = 613,
    ["vsls.json"] = 611,
    ["vss-extension.json"] = 617,
    ["vtesttree.yaml"] = 618,
    ["vtestunit.yaml"] = 619,
    ["warp-keysets.json"] = 792,
    ["warp-themes.json"] = 793,
    ["warp-workflows.json"] = 794,
    ["webhint.io"] = 744,
    ["webjobpublishsettings.json"] = 625,
    ["webjobs-list.json"] = 624,
    ["xs-app.json"] = 655,
    ["xunit.runner.json"] = 635,
    yamllint = 680,
    zuul = 664,
    ["Žinoma"] = 674
  },
