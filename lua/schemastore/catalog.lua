...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 120,
    [".cryproj (generic)"] = 444,
    [".cryproj engine-5.2"] = 439,
    [".cryproj engine-5.3"] = 440,
    [".cryproj engine-5.4"] = 441,
    [".cryproj engine-5.5"] = 442,
    [".cryproj engine-dev"] = 443,
    [".csscomb.json"] = 122,
    [".csslintrc"] = 123,
    [".eslintrc"] = 162,
    [".esmrc.json"] = 155,
    ...
    [".mtaext"] = 451,
    [".nodehawkrc"] = 275,
    [".npmpackagejsonlintrc"] = 277,
    [".phraseapp.yml"] = 309,
    [".pmbot.yml"] = 301,
    [".postcssrc"] = 306,
    [".pre-commit-config.yml"] = 307,
    [".pre-commit-hooks.yml"] = 308,
    [".putout.json"] = 326,
    [".rehyperc"] = 332,
    [".remarkrc"] = 333,
    [".sprite files"] = 372,
    ...
    [".vsext"] = 420,
    [".yarnrc.yml"] = 483,
    ["<div>RIOTS' studio configuration"] = 423,
    ["API Builder"] = 480,
    ["AVA Configuration Schema"] = 531,
    ["AWS CDK cdk.json"] = 108,
    ["AWS CloudFormation"] = 109,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 110,
    ...
    ["Azure Pipelines"] = 41,
    ["Azure Static Web Apps CLI configuration file"] = 374,
    ["Azure Static Web Apps configuration file"] = 373,
    ["BX CI"] = 70,
    ["Better Code Hub"] = 485,
    BizTalkServerApplicationSchema = 457,
    ...
    ["Butane config schema"] = 518,
    ["CICS TS region tagging"] = 525,
    ["CICS TS resource import"] = 526,
    ["CICS TS resource model"] = 527,
    ["CICS TS resource overrides"] = 528,
    ["CMake Presets"] = 71,
    ["CNC Codes JSON Schema"] = 79,
    ["CSR Framework"] = 82,
    ["Calqulus pipeline"] = 72,
    ["Camel YAML DSL"] = 73,
    Carafe = 74,
    ["Cargo Config Schema"] = 75,
    ["Cargo Make"] = 76,
    ["Catalog Info Backstage"] = 77,
    Cheatsheets = 515,
    ["Chrome Extension"] = 102,
    ["CircleCI config.yml"] = 86,
    ["Citation File Format"] = 111,
    CityJSON = 78,
    ["Code Climate"] = 87,
    ["Commandbox Box.json"] = 80,
    ["Commandbox Server.json"] = 81,
    ["Common types for all schemas"] = 1,
    ["Container Structure Test"] = 468,
    Containerlab = 492,
    ["Dart build configuration"] = 124,
    ["Dart test config"] = 125,
    ["DashLord configuration"] = 126,
    ["Datadog Service Definition"] = 233,
    ["Datahub Ingestion Recipe Schema"] = 532,
    ["Dein Config Schema"] = 83,
    Deno = 130,
    ["Deployer Recipe"] = 133,
    Devfile = 152,
    ["Discord Webhook"] = 135,
    ["Dolittle Artifacts"] = 138,
    ["Dolittle Bounded Context Configuration"] = 139,
    ["Dolittle Event Horizons Configuration"] = 140,
    ["Dolittle Resources Configuration"] = 141,
    ["Dolittle Server Configuration"] = 142,
    ["Dolittle Tenant Map Configuration"] = 144,
    ["Dolittle Tenants Configuration"] = 143,
    ["Dolittle Topology"] = 145,
    ["Drush site aliases"] = 149,
    ["Embrace Config Schema"] = 542,
    ["Error pages"] = 158,
    Esquio = 156,
    ["Estuary Flow Catalog Schema"] = 522,
    ["Expo SDK"] = 161,
    ["F-Droid Data metadata"] = 165,
    ["Facets - FSDL - Application"] = 163,
    ["Fossa configuration file"] = 170,
    ["Fossa's fossa-deps file"] = 171,
    ["Foundry VTT - Manifest"] = 168,
    ["Foundry VTT - Template"] = 169,
    ["Foxx Manifest"] = 42,
    ["GatewayCore API Gateway"] = 174,
    ["GeoJSON.json latest"] = 520,
    GherKing = 524,
    ["GitHub Action"] = 178,
    ["GitHub Funding"] = 179,
    ["GitHub Issue Template configuration"] = 181,
    ["GitHub Workflow"] = 182,
    ["GitHub Workflow Template Properties"] = 183,
    ["GitHub issue forms"] = 180,
    GitVersion = 177,
    ["Gitpod Configuration"] = 185,
    ["Global Privacy Control"] = 175,
    ["Google Cloud Workflows"] = 107,
    Goreleaser = 188,
    ["Goreleaser Pro"] = 189,
    ["Gradle Build Cache Node"] = 482,
    ["Gradle Enterprise"] = 481,
    ["Grafana 5.x Dashboard"] = 190,
    ["GraphQL Code Generator"] = 193,
    ["GraphQL Config"] = 192,
    ["GraphQL Mesh"] = 191,
    ["Grunt JSHint task"] = 197,
    ["Grunt Watch task"] = 198,
    ["Grunt base task"] = 199,
    ["Grunt clean task"] = 195,
    ["Grunt copy task"] = 194,
    ["Grunt cssmin task"] = 196,
    HEMTT = 454,
    Hadolint = 466,
    ["Hardware Sentry Configuration"] = 536,
    Hayson = 201,
    ["Haystack Pipeline"] = 202,
    ["Hazelcast 5 Configuration"] = 203,
    ["Helm Chart.lock"] = 85,
    ["Helm Chart.yaml"] = 84,
    Hugo = 514,
    ["Istanbul Schema"] = 539,
    ["JFrog File Spec"] = 218,
    ["JSON Document Transform"] = 226,
    ["JSON Feed"] = 227,
    ["JSON Resume"] = 336,
    ["JSON Schema Draft 2020-12"] = 435,
    ["JSON Schema Draft 4"] = 432,
    ["JSON Schema Draft 7"] = 433,
    ["JSON Schema Draft 8"] = 434,
    ["JSON schema for CodeShip Pro services configuration files"] = 94,
    ["JSON schema for CodeShip Pro steps configuration files"] = 95,
    ["JSON schema for Codecov configuration files"] = 93,
    ["JSON-API"] = 225,
    ["JSON-e templates"] = 490,
    ["JSON-stat 2.0"] = 429,
    JSONPatch = 229,
    Jasmine = 214,
    Jekyll = 215,
    ["Jenkins X Pipelines"] = 216,
    ["Jenkins X Requirements"] = 217,
    ["Jovo Language Models"] = 219,
    ["KSP-AVC"] = 430,
    ["KSP-CKAN"] = 431,
    ["KoDE/CI build.yaml"] = 541,
    KrakenD = 232,
    ["LinkML Metamodel"] = 243,
    Liquibase = 496,
    Markdownlint = 499,
    ["MegaLinter configuration"] = 247,
    ["MegaLinter descriptor"] = 248,
    ["Meltano plugin discovery definition"] = 250,
    ["Meltano project definition"] = 249,
    ["Microsoft Band Web Tile"] = 251,
    ["Minecraft Data Pack Advancement"] = 253,
    ["Minecraft Data Pack Biome"] = 254,
    ["Minecraft Data Pack Configured Carver"] = 255,
    ["Minecraft Data Pack Dimension"] = 257,
    ["Minecraft Data Pack Dimension Type"] = 256,
    ["Minecraft Data Pack Item Modifier"] = 258,
    ["Minecraft Data Pack Loot Table"] = 259,
    ["Minecraft Data Pack Metadata"] = 260,
    ["Minecraft Data Pack Predicate"] = 261,
    ["Minecraft Data Pack Recipe"] = 262,
    ["Minecraft Data Pack Template Pool"] = 263,
    ["Minecraft Resourcepack Sounds"] = 264,
    ["MongoDB Atlas Search Index Definition Schema"] = 540,
    ["Monika Configuration Schema"] = 538,
    ["Motif config"] = 450,
    ["Netin Diagnostic System Template"] = 503,
    ["Netlify config schema"] = 269,
    ["Nightwatch.js"] = 270,
    ["OSS Review Toolkit curation"] = 292,
    ["OSS Review Toolkit package configuration"] = 293,
    ["OSS Review Toolkit repository configuration"] = 294,
    ["OSS Review Toolkit resolutions"] = 295,
    Opctl = 453,
    ["OpenWeather Current Weather API"] = 489,
    ["OpenWeather Road Risk API"] = 488,
    ["Ory Hydra configuration"] = 207,
    ["Ory Keto configuration"] = 234,
    ["Ory Kratos configuration"] = 291,
    ["Ory Oathkeeper configuration"] = 282,
    ["Outblocks App configuration"] = 289,
    ["Outblocks database table"] = 290,
    ["Outblocks project configuration"] = 288,
    Packer = 298,
    ["Pipeline component"] = 497,
    ["PocketMine plugin.yml"] = 302,
    Pterodactyl = 535,
    ["Pull Request Labeler"] = 325,
    PyProject = 329,
    Qodana = 511,
    ["Quali Torque Blueprint Spec 2"] = 533,
    ["RKE Cluster Configuration JSON Schema"] = 495,
    ["RKE Cluster Configuration YAML Schema"] = 494,
    Ray = 465,
    ["Read the Docs"] = 328,
    ["Red-DiscordBot Cog"] = 330,
    ["Red-DiscordBot Cog Repo"] = 331,
    Renovate = 337,
    ["Replit schema"] = 334,
    RoadRunner = 338,
    ["Rust toolchain"] = 340,
    SWADL = 384,
    ["Sapphire CLI Config"] = 341,
    ["SauceCTL Configuration"] = 500,
    ["Schema Catalog"] = 354,
    ["Scoop manifest"] = 359,
    ["Semgrep Rule"] = 361,
    ["Serverless Framework Configuration"] = 507,
    ["Settings.paf"] = 363,
    ["Shopware 6 Configuration"] = 508,
    ["Shopware CLI Extension Store Configuration"] = 509,
    ["Shopware CLI Project Store Configuration"] = 510,
    Solidarity = 368,
    ["Source Maps v3"] = 369,
    SpecIF = 370,
    ["Sponge Mixin configuration"] = 371,
    ["StackHawk Scanner Configuration"] = 506,
    ["StackHead CLI config"] = 375,
    ["StackHead module configuration"] = 376,
    ["StackHead project definition"] = 377,
    Stale = 378,
    Starship = 379,
    ["Statamic Blueprint"] = 380,
    ["Stryker Mutator"] = 381,
    ["StyleCop Analyzers Configuration"] = 382,
    ["Swagger API 2.0"] = 385,
    ["Talisman configuration"] = 386,
    ["Taskfile YAML Schema"] = 491,
    Taurus = 387,
    ["TestEnvironment.json"] = 393,
    Tikibase = 390,
    ["Traefik v2"] = 395,
    ["Traefik v2 File Provider"] = 396,
    Tye = 512,
    ["UI5 Manifest"] = 408,
    ["UTAM Page Object"] = 410,
    ["Ubuntu Server Autoinstall"] = 406,
    ["Uniswap Token List"] = 474,
    Updatecli = 519,
    ["User Journey Map YAML Schema"] = 493,
    V2Ray = 523,
    ["VSCode Code Snippets"] = 97,
    ["VSIX CLI publishing"] = 421,
    ["Vela Pipeline Configuration"] = 413,
    Vercel = 96,
    ["Web App Manifest"] = 425,
    ["Web types"] = 428,
    WebExtensions = 424,
    ["Webman package recipe"] = 529,
    ["Windows Package Manager Installer Manifest"] = 471,
    ["Windows Package Manager Locale Manifest"] = 472,
    ["Windows Package Manager Singleton Manifest"] = 470,
    ["Woodpecker pipeline config"] = 502,
    ["Xstate Machine Schema"] = 517,
    ["Yippee-Ki-JSON configuration YML"] = 476,
    ["angular.json"] = 8,
    ...
    ["chutzpah.json"] = 103,
    ["cloud-init: cloud-config userdata JSON schema"] = 91,
    ["cloud-sdk-pipeline-config-schema"] = 105,
    ["cloudbuild.json"] = 106,
    cloudify = 90,
    codemagic = 92,
    ["coffeelint.json"] = 112,
    comet = 486,
    ["commands.json"] = 100,
    ["compile_commands.json"] = 99,
    ["compilerconfig.json"] = 98,
    ["component-detection-manifest.json"] = 115,
    ["component.json"] = 114,
    ["composer.json"] = 113,
    ["config.json"] = 116,
    ["contentmanifest.json"] = 104,
    ["contribute.json"] = 117,
    ["cosmos.config.json"] = 101,
    ["crowdin.yml"] = 118,
    cspell = 121,
    ["cypress.json"] = 119,
    ["datalogic-scan2deploy-android"] = 127,
    ["datalogic-scan2deploy-ce"] = 128,
    ["debugsettings.json"] = 129,
    ["dependabot-v2.json"] = 132,
    ["dependabot.json"] = 131,
    ["deployed-cli"] = 516,
    ["detekt.yml"] = 134,
    devinit = 478,
    ["devspace.yaml"] = 537,
    ["docfx.json"] = 137,
    ["docker-compose.yml"] = 477,
    ["dockerd.json"] = 136,
    ["dotnet Release Index manifest"] = 146,
    ["dotnetcli.host.json"] = 147,
    ["drone.json"] = 148,
    ["dss-2.0.0.json"] = 150,
    ["dvc.yaml"] = 151,
    ["ecosystem.json"] = 153,
    eksctl = 154,
    ["electron-builder configuration file."] = 159,
    ["epr-manifest.json"] = 157,
    ["evcc.yaml"] = 160,
    ["fabric.mod.json"] = 164,
    ["first-timers-bot"] = 167,
    ["fly.io Schema"] = 43,
    fulibWorkflows = 501,
    ["func.yaml"] = 172,
    ["function.json"] = 173,
    ...
    ["gitlab-ci"] = 184,
    ["global.json"] = 186,
    ["golangci-lint Configuration"] = 187,
    ["haxelib.json"] = 200,
    helmfile = 467,
    ["host-meta.json"] = 205,
    ["host.json"] = 204,
    ...
    huskyrc = 446,
    ["ide.host.json"] = 208,
    ["imageoptimizer.json"] = 209,
    ["importmap.json"] = 211,
    ["ioBroker JSON UI"] = 212,
    ["ioBroker Package manifest"] = 213,
    ["jsconfig.json"] = 230,
    ["jscpd Configuration Schema"] = 534,
    jsdoc = 464,
    ["k3d.yaml"] = 231,
    ["kustomization.yaml"] = 235,
    ["label-commenter-config.yml"] = 236,
    ["launchsettings.json"] = 237,
    ["lerna.json"] = 238,
    ["lgtm.yml"] = 239,
    ["libman.json"] = 240,
    ["license-report-config.json"] = 241,
    ["linkinator.config.json"] = 242,
    ["local.settings.json"] = 244,
    ["localazy.json"] = 245,
    ["lsdlschema.json"] = 246,
    mboats = 505,
    ["mimetypes.json"] = 252,
    ...
    ["mtad.yaml"] = 449,
    ["mycode.json"] = 267,
    ["napari plugin manifest"] = 268,
    neoload = 459,
    ["nest-cli"] = 273,
    ["ninjs (News in JSON) 1.3"] = 272,
    ["ninjs (News in JSON) 2.0"] = 271,
    ["nlu.json"] = 274,
    ["nodemon.json"] = 276,
    ["noodl.schema.json"] = 504,
    now = 455,
    ["nswag.json"] = 280,
    ntangle = 281,
    ["nuclei-template.yaml"] = 278,
    ["nuget-project.json"] = 279,
    ["ocelot.json"] = 283,
    ["omnisharp.json"] = 284,
    ["openapi.json"] = 285,
    ["openfin.json"] = 287,
    ["openrpc.json"] = 286,
    ["package.json"] = 296,
    ["package.manifest"] = 297,
    ["pattern.json"] = 300,
    ["petstore-v1.0"] = 543,
    pgap_yaml_input_reader = 299,
    ["plagiarize-me.yaml"] = 304,
    ["plagiarize.yaml"] = 303,
    ["portman.json"] = 305,
    ["prettierrc.json"] = 310,
    ["prisma.yml"] = 311,
    ["project-1.0.0-beta3.json"] = 313,
    ["project-1.0.0-beta4.json"] = 314,
    ["project-1.0.0-beta5.json"] = 315,
    ["project-1.0.0-beta6.json"] = 316,
    ["project-1.0.0-beta8.json"] = 317,
    ["project-1.0.0-rc1.json"] = 318,
    ["project-1.0.0-rc2.json"] = 319,
    ["project.json"] = 312,
    ["prometheus.json"] = 320,
    ["prometheus.rules.json"] = 321,
    ["proxies.json"] = 322,
    ["publiccode.yml"] = 323,
    ["pubspec.yaml"] = 324,
    ["pyrseas-0.8.json"] = 327,
    ["release drafter"] = 460,
    rustfmt = 339,
    ["sarif-1.0.0.json"] = 342,
    ["sarif-2.0.0.json"] = 343,
    ["sarif-2.1.0"] = 352,
    ["sarif-2.1.0-rtm.2"] = 344,
    ["sarif-2.1.0-rtm.3"] = 346,
    ["sarif-2.1.0-rtm.4"] = 348,
    ["sarif-2.1.0-rtm.5"] = 350,
    ["sarif-external-property-file-2.1.0"] = 353,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 345,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 347,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 349,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 351,
    ["schema.org - Action"] = 355,
    ["schema.org - ContactPoint"] = 356,
    ["schema.org - Place"] = 357,
    ["schema.org - Thing"] = 358,
    ["semantic-release"] = 360,
    ["servicehub.config.json"] = 438,
    ["servicehub.service.json"] = 437,
    ["settings.job"] = 362,
    ["sfdx-hardis configuration"] = 364,
    ["size-limit configuration"] = 365,
    ["skaffold.yaml"] = 498,
    ["skyuxconfig.json"] = 366,
    snapcraft = 367,
    swcrc = 487,
    taskcat = 456,
    ["template.json"] = 388,
    ["templatsources.json"] = 389,
    ["theme.json"] = 391,
    tmLanguage = 392,
    ["trunk.yaml schema"] = 397,
    ["ts-force-config.json"] = 401,
    ["tsconfig.json"] = 398,
    ["tsd.json"] = 399,
    ["tsdrc.json"] = 400,
    ["tslint.json"] = 402,
    ...
    ["version.json"] = 414,
    ["vim-addon-info"] = 415,
    ["vs-2017.3.host.json"] = 417,
    ["vs-nesting.json"] = 418,
    ["vsls.json"] = 416,
    ["vss-extension.json"] = 422,
    ["webhint.io"] = 530,
    ["webjobpublishsettings.json"] = 427,
    ["webjobs-list.json"] = 426,
    ["xs-app.json"] = 452,
    ["xunit.runner.json"] = 436,
    yamllint = 475,
    zuul = 461,
    ["Žinoma"] = 469
  },
