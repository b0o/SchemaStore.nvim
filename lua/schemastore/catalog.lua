...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 139,
    [".cryproj (generic)"] = 475,
    [".cryproj engine-5.2"] = 470,
    [".cryproj engine-5.3"] = 471,
    [".cryproj engine-5.4"] = 472,
    [".cryproj engine-5.5"] = 473,
    [".cryproj engine-dev"] = 474,
    [".csscomb.json"] = 141,
    [".csslintrc"] = 142,
    [".eslintrc"] = 183,
    [".esmrc.json"] = 175,
    ...
    [".pmbot.yml"] = 326,
    [".postcssrc"] = 331,
    [".pre-commit-config.yml"] = 332,
    [".pre-commit-hooks.yml"] = 333,
    [".putout.json"] = 351,
    [".rehyperc"] = 357,
    [".remarkrc"] = 358,
    [".sprite files"] = 399,
    ...
    [".vsext"] = 450,
    [".yarnrc.yml"] = 515,
    ["<div>RIOTS' studio configuration"] = 454,
    ["@factorial/drupal-breakpoints-css"] = 3,
    ["API Builder"] = 512,
    ["AVA Configuration Schema"] = 566,
    ...
    ["Azure Pipelines"] = 43,
    ["Azure Static Web Apps CLI configuration file"] = 401,
    ["Azure Static Web Apps configuration file"] = 400,
    ["BX CI"] = 72,
    ["Better Code Hub"] = 517,
    ["Better Scripts"] = 73,
    BizTalkServerApplicationSchema = 489,
    ...
    ["Butane Config"] = 553,
    ["CICS TS region tagging"] = 560,
    ["CICS TS resource import"] = 561,
    ["CICS TS resource model"] = 562,
    ["CICS TS resource overrides"] = 563,
    ["CMake Presets"] = 74,
    ...
    ["Embrace Config Schema"] = 578,
    ["Error pages"] = 178,
    Esquio = 176,
    ["Estuary Flow Catalog Schema"] = 557,
    ["Expo SDK"] = 181,
    ...
    Goreleaser = 209,
    ["Goreleaser Pro"] = 210,
    ["Gradle Build Cache Node"] = 514,
    ["Gradle Enterprise"] = 513,
    ...
    HEMTT = 486,
    Hadolint = 498,
    ["Hardware Sentry Configuration"] = 571,
    Hayson = 222,
    ...
    ["JFrog File Spec"] = 241,
    ["JFrog Pipelines YML DSL"] = 580,
    ["JSON Document Transform"] = 249,
    ["JSON Feed"] = 250,
    ["JSON Resume"] = 361,
    ["JSON Schema Draft 2020-12"] = 466,
    ["JSON Schema Draft 4"] = 463,
    ["JSON Schema Draft 7"] = 464,
    ["JSON Schema Draft 8"] = 465,
    ...
    ["KSP-AVC"] = 461,
    ["KSP-CKAN"] = 462,
    ["Keycloak REST API"] = 582,
    ["Knative Functions - func.yaml"] = 193,
    ["KoDE/CI build.yaml"] = 576,
    ["Kong DBLess Schema"] = 577,
    KrakenD = 255,
    ["LinkML Metamodel"] = 266,
    Liquibase = 528,
    ["Liquibase Flow File"] = 529,
    Markdownlint = 532,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 575,
    ["Monika Configuration Schema"] = 573,
    ["Motif config"] = 482,
    ["Netin Diagnostic System Template"] = 537,
    ["Netlify config schema"] = 292,
    ["Nightwatch.js"] = 293,
    ["OSS Review Toolkit configuration"] = 316,
    ["OSS Review Toolkit curation"] = 317,
    ["OSS Review Toolkit package configuration"] = 318,
    ["OSS Review Toolkit repository configuration"] = 319,
    ["OSS Review Toolkit resolutions"] = 320,
    Opctl = 485,
    ["OpenWeather Current Weather API"] = 521,
    ["OpenWeather Road Risk API"] = 520,
    ["Ory Hydra configuration"] = 228,
    ["Ory Keto configuration"] = 257,
    ["Ory Kratos configuration"] = 315,
    ["Ory Oathkeeper configuration"] = 306,
    ["Outblocks App configuration"] = 313,
    ["Outblocks database table"] = 314,
    ["Outblocks project configuration"] = 312,
    Packer = 323,
    ["Pipeline component"] = 530,
    ["PocketMine plugin.yml"] = 327,
    Pterodactyl = 570,
    ["Pull Request Labeler"] = 350,
    PyProject = 354,
    Qodana = 546,
    ["Quali Torque Blueprint Spec 2"] = 568,
    ["QueryFirst config file"] = 585,
    ["RKE Cluster Configuration JSON Schema"] = 527,
    ["RKE Cluster Configuration YAML Schema"] = 526,
    Ray = 497,
    ["Read the Docs"] = 353,
    ["Red-DiscordBot Cog"] = 355,
    ["Red-DiscordBot Cog Repo"] = 356,
    Renovate = 362,
    ["Replit schema"] = 359,
    RoadRunner = 363,
    ["Rust toolchain"] = 365,
    ["SIL Kit Participant Configuration"] = 390,
    SWADL = 409,
    ["Sapphire CLI Config"] = 366,
    ["SauceCTL Configuration"] = 534,
    ["Schema Catalog"] = 379,
    ["Scoop manifest"] = 384,
    ["Semgrep Rule"] = 386,
    ["Serverless Framework Configuration"] = 541,
    ["Serverless Workflow Schema"] = 542,
    ["Settings.paf"] = 388,
    ["Shopware 6 Configuration"] = 543,
    ["Shopware CLI Extension Store Configuration"] = 544,
    ["Shopware CLI Project Store Configuration"] = 545,
    Solidarity = 394,
    ["Solution filters"] = 395,
    ["Source Maps v3"] = 396,
    SpecIF = 397,
    ["Sponge Mixin configuration"] = 398,
    ["StackHawk Scanner Configuration"] = 540,
    Stale = 402,
    Starship = 403,
    ["Statamic Blueprint"] = 404,
    ["StrmPrivacy batch job configuration file"] = 581,
    ["Stryker Mutator"] = 406,
    ["StyleCop Analyzers Configuration"] = 407,
    ["Swagger API 2.0"] = 410,
    TSON = 430,
    ["Talisman configuration"] = 411,
    ["Taskfile YAML Schema"] = 523,
    Taurus = 412,
    ...
    ["Uniswap Token List"] = 506,
    Updatecli = 554,
    Uplift = 584,
    ["User Journey Map YAML Schema"] = 525,
    V2Ray = 558,
    ["VSCode Code Snippets"] = 115,
    ["VSIX CLI publishing"] = 451,
    ["Vela Pipeline Configuration"] = 441,
    Vercel = 114,
    ["Web App Manifest"] = 456,
    ["Web types"] = 459,
    WebExtensions = 455,
    ["Webman package recipe"] = 564,
    ["Windows Package Manager Installer Manifest"] = 503,
    ["Windows Package Manager Locale Manifest"] = 504,
    ["Windows Package Manager Singleton Manifest"] = 502,
    ["Woodpecker pipeline config"] = 536,
    ["Xstate Machine Schema"] = 552,
    ["Yippee-Ki-JSON configuration YML"] = 508,
    ["angular.json"] = 9,
    ...
    ["ize.toml"] = 583,
    ["jsconfig.json"] = 253,
    ["jscpd Configuration Schema"] = 569,
    jsdoc = 496,
    ["k3d.yaml"] = 254,
    ...
    ["nlu.json"] = 297,
    ["nodemon.json"] = 299,
    ["noodl.schema.json"] = 538,
    now = 487,
    ["npm-badges"] = 301,
    ["nswag.json"] = 304,
    ntangle = 305,
    ["nuclei-template.yaml"] = 302,
    ["nuget-project.json"] = 303,
    ["ocelot.json"] = 307,
    ["omnisharp.json"] = 308,
    ["openapi.json"] = 309,
    ["openfin.json"] = 311,
    ["openrpc.json"] = 310,
    ["package.json"] = 321,
    ["package.manifest"] = 322,
    ["pattern.json"] = 325,
    ["petstore-v1.0"] = 579,
    pgap_yaml_input_reader = 324,
    ["plagiarize-me.yaml"] = 329,
    ["plagiarize.yaml"] = 328,
    ["portman.json"] = 330,
    ["prettierrc.json"] = 335,
    ["prisma.yml"] = 336,
    ["project-1.0.0-beta3.json"] = 338,
    ["project-1.0.0-beta4.json"] = 339,
    ["project-1.0.0-beta5.json"] = 340,
    ["project-1.0.0-beta6.json"] = 341,
    ["project-1.0.0-beta8.json"] = 342,
    ["project-1.0.0-rc1.json"] = 343,
    ["project-1.0.0-rc2.json"] = 344,
    ["project.json"] = 337,
    ["prometheus.json"] = 345,
    ["prometheus.rules.json"] = 346,
    ["proxies.json"] = 347,
    ["publiccode.yml"] = 348,
    ["pubspec.yaml"] = 349,
    ["pyrseas-0.8.json"] = 352,
    ["release drafter"] = 492,
    rustfmt = 364,
    ["sarif-1.0.0.json"] = 367,
    ["sarif-2.0.0.json"] = 368,
    ["sarif-2.1.0"] = 377,
    ["sarif-2.1.0-rtm.2"] = 369,
    ["sarif-2.1.0-rtm.3"] = 371,
    ["sarif-2.1.0-rtm.4"] = 373,
    ["sarif-2.1.0-rtm.5"] = 375,
    ["sarif-external-property-file-2.1.0"] = 378,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 370,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 372,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 374,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 376,
    ["schema.org - Action"] = 380,
    ["schema.org - ContactPoint"] = 381,
    ["schema.org - Place"] = 382,
    ["schema.org - Thing"] = 383,
    ["semantic-release"] = 385,
    ["servicehub.config.json"] = 469,
    ["servicehub.service.json"] = 468,
    ["settings.job"] = 387,
    ["sfdx-hardis configuration"] = 389,
    ["size-limit configuration"] = 391,
    ["skaffold.yaml"] = 531,
    ["skyuxconfig.json"] = 392,
    snapcraft = 393,
    ["stripe-app.json"] = 405,
    swcrc = 519,
    taskcat = 488,
    ...
    ["webhint.io"] = 565,
    ["webjobpublishsettings.json"] = 458,
    ["webjobs-list.json"] = 457,
    ["xs-app.json"] = 484,
    ["xunit.runner.json"] = 467,
    yamllint = 507,
    zuul = 493,
    ["Žinoma"] = 501
  },
