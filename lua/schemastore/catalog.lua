...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 204,
    [".cryproj (generic)"] = 704,
    [".cryproj engine-5.2"] = 699,
    [".cryproj engine-5.3"] = 700,
    [".cryproj engine-5.4"] = 701,
    [".cryproj engine-5.5"] = 702,
    [".cryproj engine-dev"] = 703,
    [".eslintrc"] = 267,
    [".esmrc.json"] = 252,
    [".ffizer.yaml"] = 271,
    [".htmlhintrc"] = 341,
    ...
    ["Adobe UXP Manifest"] = 872,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 15,
    ["Airplane task"] = 16,
    ["Alacritty Configuration"] = 779,
    ["All Contributors configuration file"] = 837,
    ...
    ["Azure Pipelines"] = 59,
    ["Azure Static Web Apps CLI configuration file"] = 610,
    ["Azure Static Web Apps configuration file"] = 609,
    ["BX CI"] = 98,
    ["Bashly (bashly.yml)"] = 841,
    ["Bashly Settings (bashly-settings.yml)"] = 842,
    ["Better Code Hub"] = 751,
    ["Better Scripts"] = 99,
    Bigconfig = 76,
    BizTalkServerApplicationSchema = 721,
    Bleep = 100,
    ...
    ["Butane Config"] = 792,
    ["CGS Custom Card Game (CardGameDef.json)"] = 877,
    ["CICS TS region tagging"] = 801,
    ["CICS TS resource import"] = 802,
    ["CICS TS resource model"] = 803,
    ...
    CityJSON = 111,
    ["Clawject config"] = 120,
    ["Cloud Foundry Application Manifest"] = 889,
    ...
    Concord = 905,
    ["Configu .cfgu files"] = 894,
    ["Configu .configu file"] = 895,
    Conjure = 114,
    ["Container Structure Test"] = 734,
    Containerlab = 759,
    ["Crowdsec collection config"] = 200,
    ["Crowdsec parser config"] = 201,
    ["Crowdsec scenario config"] = 202,
    ["CumulusCI Config"] = 119,
    ["Custom Machinery Machine"] = 878,
    ["Custom Machinery Recipe"] = 879,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 849,
    ["EAS config"] = 265,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 838,
    ...
    ["Goreleaser Pro"] = 322,
    Goss = 323,
    ["Gradle Build Cache Node"] = 749,
    ["Gradle Enterprise"] = 748,
    ...
    Hadolint = 730,
    Hammerkit = 758,
    ["Hardware Sentry Configuration"] = 812,
    Hatch = 731,
    Hayson = 336,
    ...
    ["JFrog File Spec"] = 364,
    ["JFrog Pipelines YML DSL"] = 821,
    ["JMeter DSL cli config"] = 365,
    JReleaser = 367,
    ["JSON Document Transform"] = 375,
    ["JSON Feed"] = 376,
    ["JSON Resume"] = 553,
    ["JSON Schema Draft 2020-12"] = 695,
    ["JSON Schema Draft 4"] = 692,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 859,
    ["JSON Schema Draft 7"] = 693,
    ["JSON Schema Draft 7 (unofficial strict)"] = 860,
    ["JSON Schema Draft 8 (2019-09)"] = 694,
    ["JSON-API"] = 374,
    ["JSON-WF"] = 888,
    ["JSON-e templates"] = 756,
    ["JSON-stat 2.0"] = 689,
    JSONPatch = 378,
    ...
    Kas = 381,
    ["Keycloak REST API"] = 829,
    ["Knative Functions - func.yaml"] = 284,
    ["KoDE/CI build.yaml"] = 817,
    ["Kong DBLess config"] = 818,
    KrakenD = 384,
    ...
    ["Micro Editor Syntax"] = 850,
    ["Microsoft Band Web Tile"] = 418,
    ["Microsoft RulesEngine workflow rules"] = 902,
    ["Microsoft RulesEngine workflow rules list"] = 903,
    ["Minecraft Custom Main Menu Mod"] = 867,
    ...
    ["MongoDB Atlas Search Index Definition"] = 816,
    ["Monika Configuration"] = 814,
    ["Monoweave Configuration"] = 442,
    ["Motif config"] = 714,
    ["NOX Framework (Service)"] = 459,
    ["Netin Diagnostic System Template"] = 774,
    ["Netlify config"] = 450,
    ...
    ["OpenUtau ustx"] = 472,
    ["OpenWeather Current Weather API"] = 755,
    ["OpenWeather Road Risk API"] = 754,
    ...
    ["Pipeline component"] = 766,
    ["PocketMine plugin.yml"] = 498,
    ["Postman collection"] = 503,
    ["Problem object RFC9457"] = 864,
    ...
    Qgoda = 535,
    Qodana = 784,
    ["Qt Creator workspace file"] = 896,
    ["Quali Torque Blueprint Spec 2"] = 809,
    ["QueryFirst config file"] = 832,
    ["RKE Cluster Configuration JSON"] = 763,
    ["RKE Cluster Configuration YAML"] = 762,
    ["Rancher Fleet"] = 529,
    ["Rattler-build"] = 536,
    Ray = 729,
    ["Read the Docs"] = 531,
    ...
    ["Render Blueprints"] = 761,
    RenderCV = 555,
    Renovate = 554,
    ["Replit config"] = 549,
    RoadRunner = 556,
    ["Rudder techniques"] = 870,
    Ruff = 551,
    ["Rust Project"] = 552,
    ["Rust toolchain"] = 560,
    ["SDMX data message"] = 585,
    ["SDMX metadata message"] = 584,
    ["SDMX structure message"] = 583,
    ["SIL Kit Participant Configuration"] = 595,
    ["SIL Kit Registry Configuration"] = 596,
    SWADL = 621,
    ["Safebox Config"] = 822,
    ["Sapphire CLI Config"] = 563,
    ["SauceCTL Configuration"] = 771,
    ["Schema Catalog"] = 577,
    ["Scoop manifest"] = 582,
    ["Semantic Data Fabric (SDF) file"] = 586,
    ["Semgrep Rule"] = 588,
    ["Serenity Code Generator (Sergen)"] = 589,
    ["Serverless Framework Configuration"] = 778,
    ["Serverless Workflow"] = 780,
    ["Settings.paf"] = 591,
    ["Shopware 6 Configuration"] = 781,
    ["Shopware CLI Extension Store Configuration"] = 782,
    ["Shopware CLI Project Store Configuration"] = 783,
    Sigma = 593,
    ["Sigrid scope configuration file"] = 594,
    ["SkyPilot Task JSON"] = 871,
    ["Slack app manifest"] = 598,
    Solidarity = 601,
    ["Solution filters"] = 602,
    ["Source Maps v3"] = 603,
    Sourcery = 604,
    SpecIF = 605,
    ["Sponge Mixin configuration"] = 606,
    StackBlitz = 611,
    ["StackHawk Scanner Configuration"] = 777,
    Stale = 612,
    ["Starlake Data Pipeline"] = 752,
    Starship = 613,
    ["Statamic Blueprint"] = 614,
    ["Stella configuration file"] = 615,
    ["StrmPrivacy Data Connector"] = 826,
    ["StrmPrivacy Data Contract"] = 827,
    ["StrmPrivacy SimpleSchema"] = 824,
    ["StrmPrivacy Stream"] = 825,
    ["StrmPrivacy batch job configuration file"] = 823,
    ["Stryker Mutator"] = 618,
    ["StyleCop Analyzers Configuration"] = 619,
    ["Stylelint (.stylelintrc)"] = 620,
    ["Sublime Syntax"] = 828,
    ["Subsquid squid manifest"] = 873,
    ["Swagger API 2.0"] = 622,
    TSON = 648,
    TSTyche = 649,
    Talhelper = 624,
    ["Talisman configuration"] = 625,
    ["Taskfile config"] = 757,
    Taurus = 626,
    ["TestEnvironment.json"] = 635,
    ["TextMate Grammar"] = 634,
    ["Tier.run pricing.json"] = 629,
    Tikibase = 630,
    ["Traefik v2"] = 638,
    ["Traefik v2 File Provider"] = 639,
    ...
    ["UI5 Manifest"] = 658,
    ["UNCORS configuration"] = 662,
    ["UTAM Page Object"] = 661,
    ["Ubuntu Server Autoinstall"] = 656,
    ["Uniswap Token List"] = 740,
    ["Unreal Engine Uplugin"] = 834,
    ["Unreal Engine Uproject"] = 835,
    ["Updatecli Compose"] = 793,
    ["Updatecli Policy Manifest"] = 794,
    ["Updatecli Policy Metadata"] = 795,
    Uplift = 831,
    ["User Journey Map"] = 760,
    V2Ray = 799,
    ["VSCode Code Snippets"] = 166,
    ["VSIX CLI publishing"] = 677,
    ["Vela Pipeline Configuration"] = 666,
    Vercel = 165,
    Visivo = 861,
    ["Web App Manifest"] = 684,
    ["Web types"] = 687,
    WebExtensions = 683,
    ["Webman package recipe"] = 805,
    ["Windows Package Manager Installer Manifest"] = 737,
    ["Windows Package Manager Locale Manifest"] = 738,
    ["Windows Package Manager Singleton Manifest"] = 736,
    ["Woodpecker pipeline config"] = 773,
    ["Wrangler CLI"] = 688,
    ["Xstate Machine"] = 791,
    ["Yarn Config (.yarnrc.yml)"] = 750,
    ["Yippee-Ki-JSON configuration YML"] = 742,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 865,
    ...
    ["behat.yml"] = 84,
    ["bigquery-table"] = 75,
    ["bioimageio resource description"] = 881,
    ...
    ["lint-staged (.lintstagedrc)"] = 708,
    ["local.settings.json"] = 407,
    ["localazy.json"] = 408,
    ["lotus.yaml"] = 406,
    ["lsdlschema.json"] = 409,
    ["markdown-link-check"] = 769,
    mboats = 776,
    ["micro-settings.json"] = 845,
    ["mimetypes.json"] = 419,
    ["mirrord config"] = 709,
    mise = 710,
    ["mise-settings"] = 711,
    ...
    samt = 561,
    samtrc = 562,
    ["sarif-1.0.0.json"] = 564,
    ["sarif-2.0.0.json"] = 565,
    ["sarif-2.1.0"] = 575,
    ["sarif-2.1.0-rtm.2"] = 566,
    ["sarif-2.1.0-rtm.3"] = 568,
    ["sarif-2.1.0-rtm.4"] = 570,
    ["sarif-2.1.0-rtm.5"] = 572,
    ["sarif-2.1.0-rtm.6"] = 573,
    ["sarif-external-property-file-2.1.0"] = 576,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 567,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 569,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 571,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 574,
    ["schema.org - Action"] = 578,
    ["schema.org - ContactPoint"] = 579,
    ["schema.org - Place"] = 580,
    ["schema.org - Thing"] = 581,
    ["secrethub.yml"] = 848,
    ["semantic-release"] = 587,
    ["servicehub.config.json"] = 698,
    ["servicehub.service.json"] = 697,
    ["settings.job"] = 590,
    ["sfdx-hardis configuration"] = 592,
    ["shard.yml"] = 884,
    ["size-limit configuration"] = 597,
    ["skaffold.yaml"] = 767,
    ["skyuxconfig.json"] = 599,
    snapcraft = 600,
    ["spicepod.yaml"] = 904,
    ["sqlc configuration"] = 608,
    ["stripe-app-local.json"] = 617,
    ["stripe-app.json"] = 616,
    swcrc = 753,
    ["task.json"] = 623,
    taskcat = 720,
    ["template.json"] = 627,
    ["templatsources.json"] = 628,
    ["theme.json"] = 631,
    ["tizen_workspace.json"] = 632,
    tldr = 633,
    tmuxinator = 706,
    ["transcend.yml"] = 640,
    ...
    ["vega-lite.json"] = 665,
    ["vega.json"] = 664,
    ["venvironment-basic.yaml"] = 668,
    ["venvironment.yaml"] = 667,
    ["version.json"] = 669,
    ["vim-addon-info"] = 671,
    ["vs-2017.3.host.json"] = 673,
    ["vs-nesting.json"] = 674,
    ["vsls.json"] = 672,
    ["vss-extension.json"] = 678,
    ["vtesttree.yaml"] = 679,
    ["vtestunit.yaml"] = 680,
    ["warp-keysets.json"] = 854,
    ["warp-themes.json"] = 855,
    ["warp-workflows.json"] = 856,
    ["webhint.io"] = 806,
    ["webjobpublishsettings.json"] = 686,
    ["webjobs-list.json"] = 685,
    ["well-known-fursona"] = 892,
    ["xs-app.json"] = 716,
    ["xunit.runner.json"] = 696,
    yamllint = 741,
    ["zerops.io import file"] = 901,
    ["zerops.yml"] = 900,
    zuul = 725,
    ["Žinoma"] = 735
  },
