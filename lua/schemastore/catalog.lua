...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 878,
    [".nodehawkrc"] = 536,
    [".npmpackagejsonlintrc"] = 540,
    [".omletrc"] = 1055,
    [".phrase.yml"] = 607,
    [".phraseapp.yml"] = 608,
    [".pmbot.yml"] = 593,
    [".postcssrc"] = 602,
    [".powerpages-web-template-manifest"] = 604,
    [".pre-commit-config.yml"] = 605,
    [".pre-commit-hooks.yml"] = 606,
    [".putout.json"] = 636,
    [".rehyperc"] = 661,
    [".remarkrc"] = 665,
    [".sprite files"] = 754,
    ...
    ["A micro editor config"] = 486,
    ABCInventoryModuleData = 20,
    ABCSupplyPlan = 21,
    AIConfig = 22,
    ["AMX Muse Program Descriptor"] = 1102,
    ["API Builder"] = 913,
    ["AVA Configuration"] = 976,
    ["AWS AppConfig Feature Flags-v1"] = 53,
    ["AWS CDK cdk.json"] = 226,
    ["AWS CloudFormation"] = 227,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 228,
    ["AWS Copilot Manifest"] = 1141,
    ["AWS SAM CLI Samconfig"] = 229,
    ["Adobe UXP Manifest"] = 1038,
    ["Aerleon Network & Service Definitions"] = 15,
    ["Aerleon Policy"] = 16,
    Aider = 1131,
    Air = 18,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1152,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1151,
    ["Airlock Microgateway"] = 23,
    ["Alacritty Configuration"] = 948,
    ["All Contributors configuration file"] = 1001,
    ["Ansible Argument Specs"] = 361,
    ["Ansible Collection Galaxy"] = 368,
    ["Ansible Execution Environment"] = 358,
    ["Ansible Inventory"] = 367,
    ["Ansible Meta"] = 359,
    ["Ansible Meta Runtime"] = 360,
    ["Ansible Navigator Configuration"] = 370,
    ["Ansible Playbook"] = 365,
    ["Ansible Requirements"] = 362,
    ["Ansible Rulebook"] = 366,
    ["Ansible Tasks File"] = 364,
    ["Ansible Vars File"] = 363,
    ["Ansible-lint Configuration"] = 369,
    Any = 1065,
    ["AnyWork Automation Configuration"] = 11,
    ["Apollo Router"] = 914,
    ["App config Spotify Backstage"] = 27,
    ["Application Accelerator"] = 8,
    ["Application list for a WinUtil"] = 1082,
    ArchitectFX = 1087,
    ["Argo Events"] = 41,
    ["Argo Workflows"] = 42,
    AssemblyScript = 45,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1150,
    ["Azure IoT Operations connector metadata"] = 1147,
    ...
    ["Azure Pipelines"] = 84,
    ["Azure Static Web Apps CLI configuration file"] = 758,
    ["Azure Static Web Apps configuration file"] = 757,
    ["BOSH CPI Config"] = 108,
    ["BOSH Deploy Config"] = 109,
    ["BX CI"] = 128,
    ["Bacon config"] = 2,
    ["Bashly (bashly.yml)"] = 1005,
    ["Bashly Settings (bashly-settings.yml)"] = 1006,
    ["Better Code Hub"] = 918,
    ["Better Scripts"] = 129,
    Bigconfig = 101,
    ["Biome Formatter Config"] = 67,
    ["Bitmovin Encoding Template"] = 1095,
    BizTalkServerApplicationSchema = 885,
    Bleep = 130,
    ["Block Protocol Metadata"] = 127,
    ["Boyka Framework"] = 110,
    Briefcase = 891,
    ["Build Info"] = 118,
    Buildkite = 120,
    ["Bukkit plugin.yml"] = 119,
    ["BungeeCord plugin.yml"] = 125,
    ["Butane Config"] = 961,
    C4InterFlow = 1110,
    ["CDK Environment Manager, concrete environment configuration"] = 1134,
    ["CDK Environment Manager, concrete environments definition"] = 1133,
    ["CDK Environment Manager, environment definition"] = 1132,
    ["CGS Card Game Specification (cgs.json)"] = 1043,
    ["CICS TS region tagging"] = 970,
    ["CICS TS resource import"] = 971,
    ["CICS TS resource model"] = 972,
    ["CICS TS resource overrides"] = 973,
    ["CMake Presets"] = 131,
    ["CNC Codes"] = 152,
    ["CRS WAF test file"] = 1072,
    ["CRS WAF test platform overrides file"] = 1073,
    ["CSS Comb (.csscomb.json)"] = 254,
    ["CSS Lint (.csslintrc)"] = 255,
    ["CSpell (cspell.json)"] = 253,
    ["CVE Record Format"] = 160,
    CWL = 1049,
    ["Cache Warmup config"] = 132,
    ["Calqulus pipeline"] = 133,
    ["Camel YAML DSL"] = 134,
    ["Cannon TOML"] = 135,
    Carafe = 136,
    ["Cargo Make"] = 138,
    ["Cargo Manifest"] = 137,
    ["Catalog Info Backstage"] = 139,
    ["Chamaleon environment"] = 1099,
    ["Chamaleon properties"] = 1100,
    ["Chamaleon template"] = 1098,
    Changesets = 238,
    Changie = 140,
    Charmcraft = 141,
    Cheatsheets = 958,
    ["ChordPro Configuration"] = 142,
    ["Chrome Extension"] = 219,
    ["Chromia Model"] = 143,
    ["Chromia Seeder Module Config"] = 145,
    ["Chromia Seeder Root Config"] = 144,
    ["Cinnamon Spice info.json"] = 74,
    ["CircleCI config.yml"] = 195,
    ["Citation File Format"] = 240,
    CityJSON = 147,
    ["Claude Code Settings"] = 159,
    ["Clawject config"] = 158,
    ["Cloud Foundry Application Manifest"] = 1054,
    ["Cloud Run Spec v1"] = 1077,
    ["CloudCannon Configuration"] = 79,
    ["CloudEvents specification"] = 148,
    ["Code Climate"] = 196,
    CodeCV = 77,
    CodeRabbit = 76,
    ["CodeShip Pro services configuration files"] = 208,
    ["CodeShip Pro steps configuration files"] = 209,
    ["Codecov configuration files"] = 207,
    CodifyCLI = 78,
    Codux = 205,
    ["Cog config file"] = 153,
    ["Commandbox Box.json"] = 154,
    ["Commandbox Server.json"] = 155,
    ["Common Catalog Data"] = 217,
    ["Common Package Specification"] = 156,
    Concord = 1071,
    ["Configu .cfgu files"] = 1059,
    ["Configu .configu file"] = 1060,
    Conjure = 151,
    ["Container Structure Test"] = 899,
    Containerlab = 927,
    ["Contextive Glossary"] = 1126,
    Convex = 150,
    ["Crowdsec collection config"] = 248,
    ["Crowdsec parser config"] = 249,
    ["Crowdsec scenario config"] = 250,
    ["CumulusCI Config"] = 157,
    ["Custom Machinery Machine"] = 1044,
    ["Custom Machinery Recipe"] = 1045,
    ["Cycle Stack File"] = 161,
    CycloneDX = 162,
    ["DWP Exchange - catalogue entry"] = 297,
    ["DWP Exchange - gateway"] = 295,
    ["DWP Exchange - meta"] = 296,
    ["Dart Build Config (dart-build.json)"] = 256,
    ["Dart Test Config (dart-test.json)"] = 257,
    ["DashLord Configuration"] = 258,
    ["Data Contract Specification"] = 259,
    ["Data Product Specification"] = 260,
    ["DataYoga Connections"] = 163,
    ["DataYoga Job"] = 164,
    ["Databricks Asset Bundles"] = 1022,
    ["Datadog Continuous Testing"] = 457,
    ["Datadog Service Definition"] = 458,
    ["Datadog Software Catalog"] = 459,
    ["Datahub Ingestion Recipe"] = 977,
    ["Debian Upstream Metadata file"] = 170,
    ["Deck config"] = 171,
    ["Dein Config"] = 172,
    ["Deno Config (deno.json)"] = 266,
    ["Dependency cruiser"] = 173,
    ["DeployStack Configuration"] = 174,
    ["Deployah Configuration"] = 1149,
    ["Deployer Recipe"] = 269,
    ["Deta Spacefile"] = 175,
    ["Detekt Config (detekt.yml)"] = 270,
    ["Devbox Config"] = 176,
    ["Devbox Plugin"] = 177,
    Devfile = 294,
    DipDup = 1074,
    ["Discord Webhook"] = 271,
    ["DocFx Config (docfx.json)"] = 275,
    Dofigen = 276,
    ["Dolittle Artifacts"] = 277,
    ["Dolittle Bounded Context Configuration"] = 278,
    ["Dolittle Event Horizons Configuration"] = 279,
    ["Dolittle Resources Configuration"] = 280,
    ["Dolittle Server Configuration"] = 281,
    ["Dolittle Tenant Map Configuration"] = 283,
    ["Dolittle Tenants Configuration"] = 282,
    ["Dolittle Topology"] = 284,
    ["DonateCaseBetterCasino menu"] = 1103,
    ["Drupal Breakpoints"] = 178,
    ["Drupal Config"] = 190,
    ["Drupal Info"] = 179,
    ["Drupal Layouts"] = 180,
    ["Drupal Libraries"] = 181,
    ["Drupal Links Action"] = 182,
    ["Drupal Links Contextual"] = 183,
    ["Drupal Links Menu"] = 184,
    ["Drupal Links Task"] = 185,
    ["Drupal Migration"] = 186,
    ["Drupal Permissions"] = 187,
    ["Drupal Recipe"] = 188,
    ["Drupal Routing"] = 189,
    ["Drupal Services"] = 191,
    ["Drush site aliases"] = 290,
    ["Dynamic Bash Aliases (.aliases)"] = 1013,
    ["EAS config"] = 314,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1002,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1146,
    ["EasyVCR .NET"] = 315,
    ["Eidolon Resource"] = 1088,
    ["Elgato Stream Deck"] = 300,
    Elm = 1076,
    ["Embrace Config"] = 988,
    Endurica = 1026,
    ["Enterprise Contract Policy Spec"] = 301,
    ["Erda Pipeline"] = 1051,
    ["Erda Runtime"] = 1052,
    Esquio = 303,
    ["Estuary Flow Catalog"] = 967,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 307,
    ["EveryVoice TTS Toolkit Data Configuration"] = 308,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 312,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 311,
    ["EveryVoice TTS Toolkit Text Configuration"] = 309,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 310,
    ["Evolving Resolutive Process notation"] = 1148,
    ["Expo SDK"] = 313,
    ["F-Droid Data metadata"] = 319,
    ["FasterCI Configuration"] = 85,
    FiQuS = 323,
    Firebase = 321,
    ["FlexGet Config"] = 324,
    ["Flow.json Configurations"] = 1048,
    ["Fossa configuration file"] = 331,
    ["Fossa's fossa-deps file"] = 332,
    ["Foundry VTT - Base package Manifest"] = 326,
    ["Foundry VTT - Module Manifest"] = 327,
    ["Foundry VTT - System Data Template"] = 330,
    ["Foundry VTT - System Manifest"] = 328,
    ["Foundry VTT - World Manifest"] = 329,
    ["Foxx Manifest"] = 86,
    ["Freifunk.de Community API"] = 89,
    ["Frogbot Config"] = 90,
    ["G2P Mapping Configuration"] = 338,
    ["GCP Blueprint Metadata"] = 341,
    Gaspar = 339,
    ["GatewayCore API Gateway"] = 340,
    ["Gemini CLI settings"] = 342,
    ["GeoJSON.json latest"] = 965,
    GherKing = 969,
    ["GitHub Action"] = 347,
    ["GitHub Actions typing"] = 1084,
    ["GitHub Discussion"] = 348,
    ["GitHub Funding"] = 349,
    ["GitHub Issue Template configuration"] = 350,
    ["GitHub Issue Template forms"] = 351,
    ["GitHub Workflow"] = 352,
    ["GitHub Workflow Template Properties"] = 353,
    ["GitHub automatically generated release notes configuration"] = 354,
    ["GitLab Agent for Kubernetes configuration"] = 1040,
    GitVersion = 344,
    ["Gitea Issue Template configuration"] = 345,
    ["Gitea Issue Template forms"] = 346,
    ["Gitpod Automations"] = 356,
    ["Gitpod Configuration"] = 357,
    ["GlazeWM settings"] = 1042,
    ["Global Privacy Control"] = 343,
    Goblet = 1021,
    ["Golangci-lint Configuration"] = 372,
    ["Golangci-lint Custom Plugins Configuration"] = 373,
    ["Google Chrome Related Website Sets"] = 322,
    ["Google Cloud Workflows"] = 225,
    ["Google Digital Assetlinks"] = 1127,
    Goreleaser = 375,
    ["Goreleaser Pro"] = 376,
    Goss = 377,
    ["Gradle Build Cache Node"] = 916,
    ["Gradle Enterprise"] = 915,
    ["Grafana 5.x Dashboard"] = 378,
    ["GraphQL Code Generator"] = 383,
    ["GraphQL Config"] = 382,
    ["GraphQL Mesh"] = 381,
    ["Grunt JSHint task"] = 387,
    ["Grunt Watch task"] = 388,
    ["Grunt base task"] = 389,
    ["Grunt clean task"] = 385,
    ["Grunt copy task"] = 384,
    ["Grunt cssmin task"] = 386,
    HEMTT = 881,
    Hadolint = 895,
    Hammerkit = 926,
    ["Hardware Sentry Configuration"] = 981,
    ["HashiCorp Vault"] = 390,
    Hatch = 896,
    Hayagriva = 392,
    Hayson = 393,
    ["Haystack Pipeline"] = 394,
    ["Hazelcast 5 Configuration"] = 395,
    ["Hecate Input Schema"] = 1138,
    ["Helm Chart.lock"] = 193,
    ["Helm Chart.yaml"] = 192,
    ["Helm Unittest Test Suite"] = 194,
    ["Home Assistant Integration Manifest"] = 396,
    ["Homer dashboard configuration"] = 397,
    Hugo = 957,
    ["Hugo Theme"] = 956,
    ["Hulak Configuration"] = 404,
    ["Hyperfoil benchmark configuration"] = 403,
    ["IBM Zapp document"] = 405,
    ["IBM zCodeFormatSettings"] = 406,
    ["IMG Catapult PSP"] = 411,
    ["IVMS101 by CODE Protocol"] = 1041,
    Infrahub = 413,
    Istanbul = 984,
    ["JDownloader2 crawler multi-rules"] = 424,
    ["JDownloader2 crawler single-rules"] = 423,
    ["JFrog Applications Config"] = 425,
    ["JFrog File Spec"] = 426,
    ["JFrog Pipelines YML DSL"] = 990,
    ["JMeter DSL cli config"] = 427,
    JReleaser = 430,
    ["JSON Document Transform"] = 438,
    ["JSON Feed"] = 439,
    ["JSON Resume"] = 671,
    ["JSON Schema Draft 2020-12"] = 863,
    ["JSON Schema Draft 4"] = 860,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1023,
    ["JSON Schema Draft 7"] = 861,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1024,
    ["JSON Schema Draft 8 (2019-09)"] = 862,
    ["JSON-API"] = 437,
    ["JSON-e templates"] = 923,
    ["JSON-stat 2.0"] = 856,
    JSONPatch = 441,
    ["JSR Package Config (jsr.json)"] = 431,
    Jarl = 1154,
    Jasmine = 418,
    Jekyll = 419,
    ["Jenkins X Pipelines"] = 420,
    ["Jenkins X Requirements"] = 421,
    Jest = 422,
    Jocker = 428,
    ["Jovo Language Models"] = 429,
    ["Jujutsu (jj) VCS config"] = 1140,
    ["KIMMDY config file"] = 452,
    ["KODE/CI build.yaml"] = 986,
    ["KSP-AVC"] = 857,
    ["KSP-CKAN"] = 858,
    ["KSP-NetKAN"] = 859,
    KSY = 1053,
    KSail = 336,
    ["Karakum configuration file"] = 333,
    Kas = 444,
    ["Kestra flow file"] = 453,
    ["Keycloak REST API"] = 993,
    ["Knative Functions - func.yaml"] = 334,
    Knip = 335,
    ["Kometa (nightly) config file"] = 455,
    ["Kometa config file"] = 454,
    ["Kong DBLess config"] = 987,
    KrakenD = 456,
    ["Kubri Configuration"] = 463,
    LOOBin = 478,
    ["Lake configuration file"] = 1143,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 230,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 231,
    ["Landing Zone Accelerator on AWS - Global Config"] = 232,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 233,
    ["Landing Zone Accelerator on AWS - Network Config"] = 234,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 235,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 236,
    ["Landing Zone Accelerator on AWS - Security Config"] = 237,
    ["Lando (landofile)"] = 80,
    ["LangGraph Platform configuration"] = 1064,
    ["Language configuration"] = 1063,
    Lefthook = 467,
    ["Liferay client-extension.yaml"] = 474,
    ["LinkML Metamodel"] = 476,
    Liquibase = 932,
    ["Liquibase Flow File"] = 933,
    ["Lively Properties"] = 477,
    ["Lobe AI Agent"] = 82,
    Loki = 83,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 518,
    ["MS2Rescore Configuration"] = 521,
    ["Madness (madness.yml)"] = 1004,
    ["Mado configuration"] = 484,
    ["MapEHR Mapping"] = 485,
    Markdownlint = 936,
    ["Mason Registry"] = 939,
    ["MegaLinter Custom Flavor"] = 488,
    ["MegaLinter configuration"] = 487,
    ["MegaLinter descriptor"] = 489,
    Melange = 1031,
    ["Meltano project definition"] = 490,
    ["Mergify Configuration"] = 522,
    ["Metadata for a Bazel module"] = 491,
    ["Metadata for a Cinnamon spice"] = 1080,
    ["Metatype Configuration"] = 492,
    ["MetricsHub Configuration"] = 493,
    ["MetricsHub Connector Configuration"] = 494,
    ["Micro Editor Syntax"] = 1014,
    ["Microsoft Band Web Tile"] = 495,
    ["Microsoft RulesEngine workflow rules"] = 1068,
    ["Microsoft RulesEngine workflow rules list"] = 1069,
    ["Minecraft Custom Main Menu Mod"] = 1032,
    ["Minecraft Data Pack Advancement"] = 497,
    ["Minecraft Data Pack Biome"] = 498,
    ["Minecraft Data Pack Configured Carver"] = 499,
    ["Minecraft Data Pack Damage Type"] = 500,
    ["Minecraft Data Pack Dimension"] = 502,
    ["Minecraft Data Pack Dimension Type"] = 501,
    ["Minecraft Data Pack Item Modifier"] = 503,
    ["Minecraft Data Pack Loot Table"] = 504,
    ["Minecraft Data Pack Metadata"] = 505,
    ["Minecraft Data Pack Predicate"] = 506,
    ["Minecraft Data Pack Recipe"] = 507,
    ["Minecraft Data Pack Tag"] = 508,
    ["Minecraft Data Pack Template Pool"] = 509,
    ["Minecraft Data Pack Trim Material"] = 514,
    ["Minecraft Data Pack Trim Pattern"] = 515,
    ["Minecraft Resource Pack Lang"] = 510,
    ["Minecraft Resource Pack Particle"] = 511,
    ["Minecraft Resource Pack Texture Mcmeta"] = 513,
    ["Minecraft Resourcepack Sounds"] = 512,
    ["Monade CLI Stack Configuration"] = 525,
    ["MongoDB Atlas Search Index Definition"] = 985,
    ["Monika Configuration"] = 983,
    ["Monoweave Configuration"] = 520,
    ["Motif config"] = 877,
    MultiQC = 1120,
    ["NOX Framework (Service)"] = 539,
    ["Netin Diagnostic System Template"] = 943,
    ["Netlify config"] = 528,
    ["Network-as-Code Data Model"] = 529,
    ["Next Gen UI Agent Configuration"] = 530,
    ["Nightwatch.js"] = 532,
    ["Node.js configuration"] = 882,
    ["NueJS configuration file"] = 544,
    ["Nuitka.yaml"] = 1046,
    ["Nullstone config"] = 546,
    ["ONe's changelog entry"] = 561,
    ["ONe's service descriptor"] = 560,
    ["ORT Server repository environment configuration"] = 569,
    ["OSCAL Assessment Plan (AP)"] = 571,
    ["OSCAL Assessment Results (AR)"] = 572,
    ["OSCAL Catalog"] = 573,
    ["OSCAL Component Definition (CDef)"] = 574,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 575,
    ["OSCAL Profile"] = 576,
    ["OSCAL System Security Plan (SSP)"] = 577,
    ["OSS Review Toolkit configuration"] = 578,
    ["OSS Review Toolkit curation"] = 579,
    ["OSS Review Toolkit package configuration"] = 580,
    ["OSS Review Toolkit repository configuration"] = 581,
    ["OSS Review Toolkit resolutions"] = 582,
    ["October CMS columns"] = 550,
    ["October CMS fields"] = 551,
    Okteto = 552,
    ["Ona Automations"] = 554,
    Opctl = 880,
    ["Open Data Contract Standard (ODCS)"] = 564,
    ["Open Data Product Standard (ODPS)"] = 565,
    ["Open Know-How"] = 1125,
    ["OpenRewrite Resource"] = 563,
    OpenStatus = 1136,
    ["OpenUtau character yaml"] = 557,
    ["OpenUtau ustx"] = 558,
    ["OpenWeather Current Weather API"] = 922,
    ["OpenWeather Road Risk API"] = 921,
    ["Ory Hydra configuration"] = 402,
    ["Ory Keto configuration"] = 460,
    ["Ory Kratos configuration"] = 570,
    ["Ory Oathkeeper configuration"] = 548,
    ["Outblocks App configuration"] = 567,
    ["Outblocks database table"] = 568,
    ["Outblocks project configuration"] = 566,
    PDM = 589,
    POPxf = 599,
    ["POPxf Correlations"] = 600,
    Packer = 586,
    Pantsbuild = 1000,
    ["Paper paper-plugin.yml"] = 587,
    ["Pipeline component"] = 934,
    ["Platform.sh application"] = 4,
    ["Platform.sh routes"] = 5,
    ["Platform.sh services"] = 6,
    ["Plex Prerolls"] = 597,
    ["PocketMine plugin.yml"] = 594,
    ["Postman collection"] = 603,
    ["Power Pages Configuration"] = 1137,
    ["Preset list for a WinUtil"] = 1083,
    ["ProActions AI-Kit Configuration"] = 612,
    ["ProActions AI-Kit Configuration for Menus"] = 614,
    ["ProActions AI-Kit Configuration for Sections"] = 616,
    ["ProActions AI-Kit Configuration for Services"] = 613,
    ["ProActions AI-Kit Configuration for Steps"] = 617,
    ["ProActions AI-Kit Configuration for Templates"] = 615,
    ["Problem object RFC9457"] = 1029,
    ["Problem package generators"] = 618,
    Pterodactyl = 980,
    ["Pull Request Labeler"] = 635,
    Pulumi = 643,
    ["PyGTA Config"] = 639,
    PyProject = 644,
    Pylock = 1128,
    Pyright = 645,
    ["Python script metadata"] = 1122,
    ["QType AI DSL"] = 648,
    Qgoda = 647,
    Qodana = 953,
    ["Qt Creator workspace file"] = 1061,
    ["Quali Torque Blueprint Spec 2"] = 978,
    ["QueryFirst config file"] = 996,
    ["RKE Cluster Configuration JSON"] = 931,
    ["RKE Cluster Configuration YAML"] = 930,
    RadioHound = 638,
    Railpack = 650,
    Railway = 649,
    ["Rancher Fleet"] = 640,
    ...
    Ray = 894,
    ["Read the Docs"] = 642,
    ["Red-DiscordBot Cog"] = 658,
    ["Red-DiscordBot Cog Repo"] = 659,
    ["Red-DiscordBot Trivia"] = 660,
    ["Render Blueprints"] = 929,
    RenderCV = 673,
    Renovate = 672,
    ["Replit config"] = 666,
    Restate = 1115,
    ["Revel Digital Gadget Definition File"] = 1139,
    RoadRunner = 675,
    ["Robust Station Image"] = 1145,
    Rockcraft = 676,
    ["Roo Coder Custom Modes"] = 677,
    Rubocop = 668,
    ["Rudder techniques"] = 1036,
    Ruff = 669,
    ["Rust Project"] = 670,
    ["Rust toolchain"] = 681,
    ["SDMX data message"] = 707,
    ["SDMX metadata message"] = 706,
    ["SDMX structure message"] = 705,
    ["SIL Kit Participant Configuration"] = 717,
    ["SIL Kit Registry Configuration"] = 718,
    ["SPDX 2.3"] = 755,
    SWADL = 771,
    ["Safebox Config"] = 991,
    ["Sapphire CLI Config"] = 684,
    ["SauceCTL Configuration"] = 940,
    ["Schema Catalog"] = 699,
    ["Scoop manifest"] = 704,
    ["Semantic Data Fabric (SDF) file"] = 708,
    ["Semgrep Rule"] = 710,
    ["Serenity Code Generator (Sergen)"] = 711,
    ["Serverless Framework Configuration"] = 947,
    ["Serverless Workflow"] = 949,
    ["Settings for a Cinnamon spice"] = 1079,
    ["Settings.paf"] = 713,
    ["Shopware 6 Configuration"] = 950,
    ["Shopware CLI Extension Store Configuration"] = 951,
    ["Shopware CLI Project Store Configuration"] = 952,
    ["Sigma Detection Rule"] = 715,
    ["Sigrid scope configuration file"] = 716,
    ["SkyPilot Task JSON"] = 1037,
    ["Slack app manifest"] = 720,
    Snapcraft = 722,
    Solidarity = 725,
    ["Solution filters"] = 726,
    ["Source Maps v3"] = 727,
    Sourcery = 728,
    ["Spack bootstrap.yaml"] = 729,
    ["Spack cdash.yaml"] = 730,
    ["Spack ci.yaml"] = 731,
    ["Spack compilers.yaml"] = 732,
    ["Spack concretizer.yaml"] = 733,
    ["Spack config.yaml"] = 734,
    ["Spack definitions.yaml"] = 735,
    ["Spack develop.yaml"] = 736,
    ["Spack env_vars.yaml"] = 737,
    ["Spack environment"] = 743,
    ["Spack include.yaml"] = 738,
    ["Spack mirrors.yaml"] = 739,
    ["Spack modules.yaml"] = 740,
    ["Spack packages.yaml"] = 741,
    ["Spack repos.yaml"] = 742,
    ["Spack toolchains.yaml"] = 744,
    ["Spack upstreams.yaml"] = 745,
    ["Spack view.yaml"] = 746,
    ["Speakeasy Generation Config File"] = 750,
    ["Speakeasy Lint Configuration File"] = 747,
    ["Speakeasy Test Generation Configuration File"] = 748,
    ["Speakeasy Workflow File"] = 749,
    SpecIF = 751,
    ["Specmatic Configuration"] = 752,
    ["Sponge Mixin configuration"] = 753,
    StackBlitz = 759,
    ["StackHawk Scanner Configuration"] = 946,
    Stale = 760,
    Starfish = 761,
    ["Starlake Data Pipeline"] = 919,
    Starship = 762,
    ["Statamic Blueprint"] = 763,
    ["Stella configuration file"] = 764,
    ["Streamlit configuration file"] = 765,
    ["Stryker Mutator"] = 768,
    ["StyleCop Analyzers Configuration"] = 769,
    ["Stylelint (.stylelintrc)"] = 770,
    ["Stylua Config"] = 1129,
    ["Sublime Syntax"] = 992,
    ["Subsquid squid manifest"] = 1039,
    ["Swagger API 2.0"] = 772,
    ["Synadia Connect Component"] = 773,
    TSON = 808,
    TSTyche = 809,
    ["TYPO3 Vendor Bundler config"] = 814,
    ["Tab data for a LinUtil"] = 1086,
    ["Tab list for a LinUtil"] = 1085,
    Tach = 774,
    ["Tach Domain"] = 775,
    Talhelper = 777,
    ["Talisman configuration"] = 778,
    Taplo = 1130,
    ["Taskfile config"] = 924,
    Taurus = 779,
    Tauticord = 780,
    Telefonistka = 1116,
    ["Terrateam config"] = 1142,
    ["TestEnvironment.json"] = 791,
    ["TextMate Grammar"] = 790,
    Threagile = 786,
    ["Tier.run pricing.json"] = 783,
    Tikibase = 784,
    Tombi = 789,
    ["Traefik v2"] = 794,
    ["Traefik v2 File Provider"] = 795,
    ["Traefik v3"] = 796,
    ["Traefik v3 File Provider"] = 797,
    ["Travis CI (.travis.yml)"] = 793,
    Treefmt = 380,
    Trident = 1112,
    ["TrueScript for *.tscript files"] = 800,
    ["Tugboat QA config.yml"] = 1109,
    TunnelHub = 1027,
    Turborepo = 792,
    Tycho = 1075,
    Tye = 954,
    ["Tyk Gateway - Open Source v5.7+"] = 1121,
    ["Typst Manifest"] = 815,
    ["UET BuildConfig.json"] = 997,
    ["UI5 Manifest"] = 821,
    ["UNCORS configuration"] = 825,
    ["UTAM Page Object"] = 824,
    ["Ubuntu Server Autoinstall"] = 819,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1113,
    ["Uniswap Token List"] = 906,
    ["Universal Schedule Format"] = 826,
    ["Unreal Engine Uplugin"] = 998,
    ["Unreal Engine Uproject"] = 999,
    ["UpCloud CLI (upctl) configuration"] = 1114,
    ["Updatecli Compose"] = 962,
    ["Updatecli Policy Manifest"] = 963,
    ["Updatecli Policy Metadata"] = 964,
    Uplift = 995,
    ["Upsun config"] = 3,
    ["User Journey Map"] = 928,
    V2Ray = 968,
    ["VSCode Code Snippets"] = 213,
    ["VSIX CLI publishing"] = 844,
    Vector = 828,
    ["Vela Pipeline Configuration"] = 831,
    Vercel = 212,
    ["Version Bumper config"] = 834,
    ["Viash Component Config"] = 1118,
    ["Viash Package Config"] = 1119,
    Visivo = 1025,
    ["WP-CLI"] = 854,
    Wake = 1111,
    ["Waku Config"] = 1089,
    ["Web App Manifest"] = 850,
    ["Web types"] = 853,
    WebExtensions = 849,
    ["Webman package recipe"] = 974,
    ["Windows Package Manager Installer Manifest"] = 902,
    ["Windows Package Manager Locale Manifest"] = 903,
    ["Windows Package Manager Singleton Manifest"] = 901,
    Winutil = 904,
    ["WireMock CLI import configuration"] = 1094,
    ["WireMock CLI local service configuration"] = 1093,
    ["WireMock stub mapping"] = 1092,
    ["Woodpecker pipeline config"] = 942,
    ["Wrangler CLI"] = 855,
    ["Xstate Machine"] = 960,
    ["Yandex Workflow Language"] = 1081,
    ["Yarn Config (.yarnrc.yml)"] = 917,
    ["Yippee-Ki-JSON configuration YML"] = 908,
    ["YouTrack App"] = 1078,
    ["Zarf Package Configuration"] = 1144,
    ["Zerops.io config"] = 1066,
    ["Zerops.io import"] = 1067,
    ["Zola Configuration"] = 1155,
    ["aerleon.yml"] = 14,
    ["angular.json"] = 24,
    apko = 1030,
    ...
    ["babelrc.json"] = 92,
    ["bamboo-spec"] = 95,
    ["bashly-strings.yml"] = 1007,
    ["batect.yml"] = 94,
    ["beef-database-codegen"] = 96,
    ["beef-database-v5-codegen"] = 98,
    ["beef-entity-codegen"] = 97,
    ["beef-entity-v5-codegen"] = 99,
    ["behat.yml"] = 111,
    ["bigquery-table"] = 100,
    ["bioimageio resource description"] = 1047,
    ["bitbucket-pipelines"] = 102,
    bitrise = 103,
    ["bitrise-step"] = 104,
    ["block.json"] = 126,
    ...
    ["bozr.suite.json"] = 113,
    bpkg = 1008,
    ["browser.i18n.json"] = 114,
    ["browsh configuration"] = 115,
    bucklescript = 116,
    ["buf.gen.yaml"] = 70,
    ["buf.plugin.yaml"] = 71,
    ["buf.work.yaml"] = 72,
    ...
    ["build-changelog"] = 117,
    ["bun.lock"] = 122,
    ["bundleconfig.json"] = 123,
    ["bunfig.toml"] = 124,
    ["cargo-mutants-config.yaml"] = 73,
    ["ccmod.json"] = 1090,
    changelogging = 1058,
    ["chisel-slices.json"] = 239,
    ["chrome-extension-locales-messages.json"] = 220,
    ["chutzpah.json"] = 221,
    cibuildwheel = 146,
    ["clang-format (.clang-format)"] = 966,
    ["clang-tidy"] = 200,
    clangd = 199,
    clib = 201,
    ["cloud-init: cloud-config userdata"] = 203,
    ["cloud-sdk-pipeline-configuration"] = 223,
    ["cloudbuild.json"] = 224,
    cloudify = 202,
    ["cmdx.yaml"] = 75,
    codemagic = 204,
    ["coffeelint.json"] = 241,
    ["commands.json"] = 216,
    ["commitlint (.commitlintrc)"] = 905,
    ["committed.toml"] = 242,
    ["compile_commands.json"] = 215,
    ["compilerconfig.json"] = 214,
    ["completely.yml"] = 1003,
    ["component-detection-manifest.json"] = 245,
    ["component.json"] = 244,
    ["composer.json"] = 243,
    ["conda-forge"] = 149,
    ["config.yaml"] = 641,
    ["contentmanifest.json"] = 222,
    ["contribute.json"] = 246,
    ["cosmos.config.json"] = 218,
    ["crowdin.yml"] = 247,
    ["ctfd-setup configuration file"] = 1101,
    ["custom-elements.json"] = 1017,
    ["cypress.json"] = 251,
    ["datalogic-scan2deploy-android"] = 261,
    ["datalogic-scan2deploy-ce"] = 262,
    ["dbt Dependencies"] = 165,
    ["dbt Packages"] = 167,
    ["dbt Project"] = 166,
    ["dbt Selectors"] = 168,
    ["dbt YAML files"] = 169,
    ["ddev-global"] = 263,
    ["ddev-project"] = 264,
    ["debugsettings.json"] = 265,
    ["dependabot-v2.json"] = 268,
    ["dependabot.json"] = 267,
    ["deployed-cli"] = 959,
    ["devcontainer.json"] = 206,
    devinit = 910,
    ["devspace.yaml"] = 982,
    djlint = 911,
    ["docker bake"] = 273,
    ["docker sequencer"] = 274,
    ["docker-compose.yml"] = 909,
    ["dockerd.json"] = 272,
    ["dotnet Release Index manifest"] = 285,
    ["dotnet-tools.json"] = 286,
    ["dotnetcli.host.json"] = 287,
    ["dprint.json"] = 288,
    ["drone.json"] = 289,
    ["dss-2.0.0.json"] = 291,
    ["dstack configuration"] = 292,
    ["dtool dataset metadata"] = 1096,
    ["dvc.yaml"] = 293,
    ["ecosystem.json"] = 298,
    eksctl = 299,
    ["electron-builder configuration file"] = 305,
    ["epr-manifest.json"] = 304,
    ["evcc.yaml"] = 306,
    ["ezd task runner"] = 316,
    ["fabric.mod.json"] = 318,
    ["first-timers-bot"] = 325,
    ["flagd flag configuration"] = 87,
    ["fly.io Configuration"] = 88,
    fulibWorkflows = 941,
    ["function.json"] = 337,
    ["gRPC API Gateway & OpenAPI Config"] = 9,
    ["gematik health care insurance list"] = 1107,
    ["gematik health care patient list"] = 1104,
    ["gematik health care provider institution list"] = 1106,
    ["gematik health care provider list"] = 1105,
    ["gematik tiger test environment configuration"] = 1108,
    ["git-town.toml"] = 1153,
    ["gitlab-ci"] = 355,
    ["global.json"] = 371,
    ["go-feature-flag Flag Configuration"] = 374,
    ["haxelib.json"] = 391,
    helmfile = 897,
    helmwave = 898,
    ["host-meta.json"] = 399,
    ...
    ["ide.host.json"] = 407,
    ["ifstate.yaml"] = 408,
    ["imageoptimizer.json"] = 409,
    ["importmap.json"] = 412,
    ["ioBroker Configuration"] = 414,
    ["ioBroker JSON UI"] = 415,
    ["ioBroker Package manifest"] = 416,
    ["ixpect.conf.yaml"] = 417,
    ["ize.toml"] = 994,
    ["jsconfig.json"] = 442,
    ["jscpd Configuration"] = 979,
    jsdoc = 893,
    ["k3d.yaml"] = 443,
    ["k9s aliases.yaml"] = 445,
    ["k9s cluster-config.yaml"] = 447,
    ["k9s config.yaml"] = 446,
    ["k9s hotkeys.yaml"] = 448,
    ["k9s plugins.yaml"] = 449,
    ["k9s skin.yaml"] = 450,
    ["k9s views.yaml"] = 451,
    ["kontinuous-config.yaml"] = 462,
    ["kontinuous-values.yaml"] = 461,
    ["kustomization.yaml"] = 464,
    ["label-commenter-config.yml"] = 465,
    ["latexindent configuration"] = 81,
    ["launchsettings.json"] = 466,
    lazydocker = 1016,
    lazygit = 1015,
    ["lego.json"] = 468,
    ["lerna.json"] = 469,
    ["lgtm.yml"] = 470,
    ["liblab.config.json"] = 471,
    ["libman.json"] = 472,
    ["license-report-config.json"] = 473,
    ["linkinator.config.json"] = 475,
    ["lint-staged (.lintstagedrc)"] = 871,
    ["local.settings.json"] = 480,
    ["localazy.json"] = 481,
    ["lotus.yaml"] = 479,
    ["lsdlschema.json"] = 482,
    ["markdown-link-check"] = 937,
    maturin = 938,
    mboats = 945,
    ["micro-settings.json"] = 1009,
    ["mimetypes.json"] = 496,
    ["mirrord config"] = 873,
    mise = 874,
    ["mkdocs.yml"] = 516,
    ["monospace.yml"] = 519,
    ["moon.yml"] = 1091,
    ["mprocs Configuration file"] = 1062,
    ["mrdocs.yml"] = 517,
    ["mta.yaml"] = 875,
    ["mtad.yaml"] = 876,
    ["mycode.json"] = 526,
    nFPM = 531,
    ["napari plugin manifest"] = 527,
    neoload = 888,
    ["nest-cli"] = 534,
    ["ninjs (News in JSON)"] = 533,
    ["nitro.json"] = 887,
    ["nixd configuration"] = 1035,
    ["nlu.json"] = 535,
    ["nodemon.json"] = 537,
    ["noodl config"] = 944,
    ["notebook.mod.json"] = 538,
    now = 883,
    ["npm-badges"] = 541,
    ["nswag.json"] = 545,
    ntangle = 547,
    ["nuclei-template.yaml"] = 542,
    ["nuget-project.json"] = 543,
    ["ocelot.json"] = 549,
    ["omnisharp.json"] = 553,
    ["openapi.json"] = 555,
    ["openfin.json"] = 562,
    ...
    ["ops.yaml"] = 559,
    ["package.json"] = 583,
    ["package.manifest"] = 585,
    ["package.yaml"] = 584,
    ["partial-black.json"] = 112,
    ["pathfinder.yml"] = 588,
    ["pattern.json"] = 591,
    ["petstore-v1.0"] = 989,
    pgap_yaml_input_reader = 590,
    ["pixi.toml"] = 592,
    ["plagiarize-me.yaml"] = 596,
    ["plagiarize.yaml"] = 595,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1097,
    ["podbard.yaml"] = 598,
    ["portman.json"] = 601,
    ["prefect.toml"] = 609,
    ["prettierrc.json"] = 610,
    ["prisma.yml"] = 611,
    ["project-1.0.0-beta3.json"] = 620,
    ["project-1.0.0-beta4.json"] = 621,
    ["project-1.0.0-beta5.json"] = 622,
    ["project-1.0.0-beta6.json"] = 623,
    ["project-1.0.0-beta8.json"] = 624,
    ["project-1.0.0-rc1.json"] = 625,
    ["project-1.0.0-rc2.json"] = 626,
    ["project.json"] = 619,
    ["project.owasp.yaml"] = 627,
    ["prometheus-alertmanager.json"] = 631,
    ["prometheus.json"] = 628,
    ["prometheus.rules.json"] = 629,
    ["prometheus.rules.test.json"] = 630,
    ["proxies.json"] = 632,
    ["publiccode.yml"] = 633,
    ["pubspec.yaml"] = 634,
    ["pyrseas-0.8.json"] = 637,
    pytest = 646,
    ["quilt.mod.json"] = 1010,
    ["rc3 auth"] = 652,
    ["rc3 collection"] = 653,
    ...
    ["release drafter"] = 889,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 662,
    ["release-please-manifest.json"] = 663,
    ["release-plz.toml"] = 664,
    ["renv.lock"] = 674,
    ["rivet.json"] = 1034,
    ["rivet.yaml (legacy)"] = 1033,
    rumdl = 679,
    runny = 678,
    rustfmt = 680,
    sake = 1124,
    samt = 682,
    samtrc = 683,
    ["sarif-1.0.0.json"] = 685,
    ["sarif-2.0.0.json"] = 686,
    ["sarif-2.1.0"] = 696,
    ["sarif-2.1.0-rtm.2"] = 687,
    ["sarif-2.1.0-rtm.3"] = 689,
    ["sarif-2.1.0-rtm.4"] = 691,
    ["sarif-2.1.0-rtm.5"] = 693,
    ["sarif-2.1.0-rtm.6"] = 694,
    ["sarif-external-property-file-2.1.0"] = 697,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 688,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 690,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 692,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 695,
    ["scalingo.json configuration"] = 698,
    ["schema.org - Action"] = 700,
    ["schema.org - ContactPoint"] = 701,
    ["schema.org - Place"] = 702,
    ["schema.org - Thing"] = 703,
    ["secrethub.yml"] = 1012,
    ["semantic-release"] = 709,
    ["servicehub.config.json"] = 866,
    ["servicehub.service.json"] = 865,
    ["settings.job"] = 712,
    ["sfdx-hardis configuration"] = 714,
    ["shard.yml"] = 1050,
    ["size-limit configuration"] = 719,
    ["skaffold.yaml"] = 935,
    ["skyuxconfig.json"] = 721,
    ["snowflake-config"] = 723,
    ["snowflake-connections"] = 724,
    ["spicepod.yaml"] = 1070,
    ["sqlc configuration"] = 756,
    ["stripe-app-local.json"] = 767,
    ["stripe-app.json"] = 766,
    swcrc = 920,
    ["task.json"] = 776,
    taskcat = 884,
    ["template.json"] = 781,
    ["templatsources.json"] = 782,
    ["theme.json"] = 785,
    ["tizen_workspace.json"] = 787,
    tldr = 788,
    ["tm_devices configuration file"] = 1135,
    tmuxinator = 869,
    ["transcend.yml"] = 798,
    ["tree-sitter grammar.json"] = 379,
    ["trime.yaml"] = 799,
    ["trunk.yaml"] = 801,
    ["ts-force-config.json"] = 806,
    ["tsconfig.json"] = 802,
    ["tsd.json"] = 803,
    ["tsdoc.json"] = 804,
    ["tsdrc.json"] = 805,
    ...
    v8r = 848,
    vcluster = 1056,
    ["vcpkg configuration file"] = 211,
    ["vcpkg manifest file"] = 210,
    ["vega-lite.json"] = 830,
    ["vega.json"] = 829,
    ["venvironment.yaml"] = 832,
    ["venvplus.yaml"] = 833,
    version = 1117,
    ["version.json"] = 835,
    ["vhwdebugger-binding.yaml"] = 837,
    ["vim-addon-info"] = 838,
    ["vs-2017.3.host.json"] = 840,
    ["vs-nesting.json"] = 841,
    ["vsls.json"] = 839,
    ["vss-extension.json"] = 845,
    vtcfg = 1123,
    ["vtesttree.yaml"] = 846,
    ["vtestunit.yaml"] = 847,
    ["warp-keysets.json"] = 1018,
    ["warp-themes.json"] = 1019,
    ["warp-workflows.json"] = 1020,
    ["webhint.io"] = 975,
    ["webjobpublishsettings.json"] = 852,
    ["webjobs-list.json"] = 851,
    ["well-known-fursona"] = 1057,
    ["xs-app.json"] = 879,
    ["xunit.runner.json"] = 864,
    yamllint = 907,
    zuul = 890,
    ["Žinoma"] = 900
  },
