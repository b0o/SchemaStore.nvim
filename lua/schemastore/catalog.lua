...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 766,
    [".nodehawkrc"] = 486,
    [".npmpackagejsonlintrc"] = 490,
    [".omletrc"] = 936,
    [".phrase.yml"] = 551,
    [".phraseapp.yml"] = 552,
    [".pmbot.yml"] = 539,
    [".postcssrc"] = 546,
    [".powerpages-web-template-manifest"] = 548,
    [".pre-commit-config.yml"] = 549,
    [".pre-commit-hooks.yml"] = 550,
    [".putout.json"] = 572,
    [".rehyperc"] = 593,
    [".remarkrc"] = 595,
    [".sprite files"] = 658,
    ...
    ["A micro editor config"] = 440,
    ABCInventoryModuleData = 13,
    ABCSupplyPlan = 14,
    AIConfig = 15,
    ["AMX Muse Program Descriptor"] = 979,
    ["API Builder"] = 799,
    ["AVA Configuration"] = 859,
    ["AWS AppConfig Feature Flags-v1"] = 39,
    ["AWS CDK cdk.json"] = 195,
    ["AWS CloudFormation"] = 196,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 197,
    ["AWS SAM CLI Samconfig"] = 198,
    ["Adobe UXP Manifest"] = 919,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Alacritty Configuration"] = 831,
    ["All Contributors configuration file"] = 884,
    ["Ansible Argument Specs"] = 325,
    ["Ansible Collection Galaxy"] = 332,
    ["Ansible Execution Environment"] = 322,
    ["Ansible Inventory"] = 331,
    ["Ansible Meta"] = 323,
    ["Ansible Meta Runtime"] = 324,
    ["Ansible Navigator Configuration"] = 334,
    ["Ansible Playbook"] = 329,
    ["Ansible Requirements"] = 326,
    ["Ansible Rulebook"] = 330,
    ["Ansible Tasks File"] = 328,
    ["Ansible Vars File"] = 327,
    ["Ansible-lint Configuration"] = 333,
    Any = 945,
    ["AnyWork Automation Configuration"] = 5,
    ["App config Spotify Backstage"] = 20,
    ["Application Accelerator"] = 2,
    ["Application list for a WinUtil"] = 962,
    ArchitectFX = 966,
    ["Argo Events"] = 29,
    ["Argo Workflows"] = 30,
    AssemblyScript = 33,
    ...
    ["Azure Pipelines"] = 66,
    ["Azure Static Web Apps CLI configuration file"] = 661,
    ["Azure Static Web Apps configuration file"] = 660,
    ["BOSH Deploy Config"] = 90,
    ["BX CI"] = 107,
    ["Bashly (bashly.yml)"] = 888,
    ["Bashly Settings (bashly-settings.yml)"] = 889,
    ["Better Code Hub"] = 803,
    ["Better Scripts"] = 108,
    Bigconfig = 83,
    ["Biome Formatter Config"] = 53,
    ["Bitmovin Encoding Template"] = 972,
    BizTalkServerApplicationSchema = 772,
    Bleep = 109,
    ["Block Protocol Metadata"] = 106,
    ["Boyka Framework"] = 91,
    Briefcase = 778,
    ["Build Info"] = 98,
    Buildkite = 100,
    ["Bukkit plugin.yml"] = 99,
    ["BungeeCord plugin.yml"] = 104,
    ["Butane Config"] = 844,
    ["CGS Custom Card Game (CardGameDef.json)"] = 924,
    ["CICS TS region tagging"] = 853,
    ["CICS TS resource import"] = 854,
    ["CICS TS resource model"] = 855,
    ["CICS TS resource overrides"] = 856,
    ["CMake Presets"] = 110,
    ["CNC Codes"] = 125,
    ["CRS WAF test file"] = 952,
    ["CRS WAF test platform overrides file"] = 953,
    ["CSS Comb (.csscomb.json)"] = 222,
    ["CSS Lint (.csslintrc)"] = 223,
    ["CSpell (cspell.json)"] = 221,
    ["CVE Record Format"] = 131,
    CWL = 930,
    ["Cache Warmup config"] = 111,
    ["Calqulus pipeline"] = 112,
    ["Camel YAML DSL"] = 113,
    ["Cannon TOML"] = 114,
    Carafe = 115,
    ["Cargo Make"] = 117,
    ["Cargo Manifest"] = 116,
    ["Catalog Info Backstage"] = 118,
    ["Chamaleon environment"] = 976,
    ["Chamaleon properties"] = 977,
    ["Chamaleon template"] = 975,
    Changesets = 207,
    Cheatsheets = 841,
    ["Chrome Extension"] = 188,
    ["Chromia Model"] = 119,
    ["CircleCI config.yml"] = 164,
    ["Citation File Format"] = 209,
    CityJSON = 121,
    ["Clawject config"] = 130,
    ["Cloud Foundry Application Manifest"] = 935,
    ["Cloud Run Spec v1"] = 957,
    ["CloudCannon Configuration"] = 62,
    ["CloudEvents specification"] = 122,
    ["Code Climate"] = 165,
    CodeCV = 60,
    CodeRabbit = 59,
    ["CodeShip Pro services configuration files"] = 177,
    ["CodeShip Pro steps configuration files"] = 178,
    ["Codecov configuration files"] = 176,
    CodifyCLI = 61,
    Codux = 174,
    ["Cog config file"] = 126,
    ["Commandbox Box.json"] = 127,
    ["Commandbox Server.json"] = 128,
    ["Common Catalog Data"] = 186,
    Concord = 951,
    ["Configu .cfgu files"] = 940,
    ["Configu .configu file"] = 941,
    Conjure = 124,
    ["Container Structure Test"] = 786,
    Containerlab = 811,
    ["Crowdsec collection config"] = 216,
    ["Crowdsec parser config"] = 217,
    ["Crowdsec scenario config"] = 218,
    ["CumulusCI Config"] = 129,
    ["Custom Machinery Machine"] = 925,
    ["Custom Machinery Recipe"] = 926,
    ["Cycle Stack File"] = 132,
    CycloneDX = 133,
    ["DWP Exchange - catalogue entry"] = 265,
    ["DWP Exchange - gateway"] = 263,
    ["DWP Exchange - meta"] = 264,
    ["Dart Build Config (dart-build.json)"] = 224,
    ["Dart Test Config (dart-test.json)"] = 225,
    ["DashLord Configuration"] = 226,
    ["Data Contract Specification"] = 227,
    ["Data Product Specification"] = 228,
    ["DataYoga Connections"] = 134,
    ["DataYoga Job"] = 135,
    ["Databricks Asset Bundles"] = 905,
    ["Datadog Service Definition"] = 413,
    ["Datadog Software Catalog"] = 414,
    ["Datahub Ingestion Recipe"] = 860,
    ["Dein Config"] = 141,
    ["Deno Config (deno.json)"] = 234,
    ["Dependency cruiser"] = 142,
    ["DeployStack Configuration"] = 143,
    ["Deployer Recipe"] = 237,
    ["Deta Spacefile"] = 144,
    ["Detekt Config (detekt.yml)"] = 238,
    ["Devbox Config"] = 145,
    ["Devbox Plugin"] = 146,
    Devfile = 262,
    DipDup = 954,
    ["Discord Webhook"] = 239,
    ["DocFx Config (docfx.json)"] = 243,
    Dofigen = 244,
    ["Dolittle Artifacts"] = 245,
    ["Dolittle Bounded Context Configuration"] = 246,
    ["Dolittle Event Horizons Configuration"] = 247,
    ["Dolittle Resources Configuration"] = 248,
    ["Dolittle Server Configuration"] = 249,
    ["Dolittle Tenant Map Configuration"] = 251,
    ["Dolittle Tenants Configuration"] = 250,
    ["Dolittle Topology"] = 252,
    ["DonateCaseBetterCasino menu"] = 980,
    ["Drupal Breakpoints"] = 147,
    ["Drupal Config"] = 159,
    ["Drupal Info"] = 148,
    ["Drupal Layouts"] = 149,
    ["Drupal Libraries"] = 150,
    ["Drupal Links Action"] = 151,
    ["Drupal Links Contextual"] = 152,
    ["Drupal Links Menu"] = 153,
    ["Drupal Links Task"] = 154,
    ["Drupal Migration"] = 155,
    ["Drupal Permissions"] = 156,
    ["Drupal Recipe"] = 157,
    ["Drupal Routing"] = 158,
    ["Drupal Services"] = 160,
    ["Drush site aliases"] = 258,
    ["Dynamic Bash Aliases (.aliases)"] = 896,
    ["EAS config"] = 282,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 885,
    ["EasyVCR .NET"] = 283,
    ["Eidolon Resource"] = 967,
    ["Elgato Stream Deck"] = 268,
    Elm = 956,
    ["Embrace Config"] = 871,
    Endurica = 909,
    ["Enterprise Contract Policy Spec"] = 269,
    ["Erda Pipeline"] = 932,
    ["Erda Runtime"] = 933,
    Esquio = 271,
    ["Estuary Flow Catalog"] = 850,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 275,
    ["EveryVoice TTS Toolkit Data Configuration"] = 276,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 280,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 279,
    ["EveryVoice TTS Toolkit Text Configuration"] = 277,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 278,
    ["Expo SDK"] = 281,
    ["F-Droid Data metadata"] = 287,
    ["FasterCI Configuration"] = 67,
    FiQuS = 291,
    Firebase = 289,
    ["Flow.json Configurations"] = 929,
    ["Fossa configuration file"] = 298,
    ["Fossa's fossa-deps file"] = 299,
    ["Foundry VTT - Base package Manifest"] = 293,
    ["Foundry VTT - Module Manifest"] = 294,
    ["Foundry VTT - System Data Template"] = 297,
    ["Foundry VTT - System Manifest"] = 295,
    ["Foundry VTT - World Manifest"] = 296,
    ["Foxx Manifest"] = 68,
    ["Freifunk.de Community API"] = 71,
    ["Frogbot Config"] = 72,
    ["G2P Mapping Configuration"] = 304,
    ["GCP Blueprint Metadata"] = 307,
    Gaspar = 305,
    ["GatewayCore API Gateway"] = 306,
    ["GeoJSON.json latest"] = 848,
    GherKing = 852,
    ["GitHub Action"] = 312,
    ["GitHub Discussion"] = 313,
    ["GitHub Funding"] = 314,
    ["GitHub Issue Template configuration"] = 315,
    ["GitHub Issue Template forms"] = 316,
    ["GitHub Workflow"] = 317,
    ["GitHub Workflow Template Properties"] = 318,
    ["GitHub automatically generated release notes configuration"] = 319,
    ["GitLab Agent for Kubernetes configuration"] = 921,
    GitVersion = 309,
    ["Gitea Issue Template configuration"] = 310,
    ["Gitea Issue Template forms"] = 311,
    ["Gitpod Configuration"] = 321,
    ["GlazeWM settings"] = 923,
    ["Global Privacy Control"] = 308,
    Goblet = 904,
    ["Golangci-lint Configuration"] = 336,
    ["Golangci-lint Custom Plugins Configuration"] = 337,
    ["Google Chrome Related Website Sets"] = 290,
    ["Google Cloud Workflows"] = 194,
    Goreleaser = 339,
    ["Goreleaser Pro"] = 340,
    Goss = 341,
    ["Gradle Build Cache Node"] = 801,
    ["Gradle Enterprise"] = 800,
    ["Grafana 5.x Dashboard"] = 342,
    ["GraphQL Code Generator"] = 346,
    ["GraphQL Config"] = 345,
    ["GraphQL Mesh"] = 344,
    ["Grunt JSHint task"] = 350,
    ["Grunt Watch task"] = 351,
    ["Grunt base task"] = 352,
    ["Grunt clean task"] = 348,
    ["Grunt copy task"] = 347,
    ["Grunt cssmin task"] = 349,
    HEMTT = 769,
    Hadolint = 782,
    Hammerkit = 810,
    ["Hardware Sentry Configuration"] = 864,
    Hatch = 783,
    Hayson = 354,
    ["Haystack Pipeline"] = 355,
    ["Hazelcast 5 Configuration"] = 356,
    ["Helm Chart.lock"] = 162,
    ["Helm Chart.yaml"] = 161,
    ["Helm Unittest Test Suite"] = 163,
    Hugo = 840,
    ["Hugo Theme"] = 839,
    ["Hyperfoil benchmark configuration"] = 362,
    ["IBM Zapp document"] = 363,
    ["IBM zCodeFormatSettings"] = 364,
    ["IMG Catapult PSP"] = 369,
    ["IVMS101 by CODE Protocol"] = 922,
    Infrahub = 371,
    Istanbul = 867,
    ["JDownloader2 crawler multi-rules"] = 381,
    ["JDownloader2 crawler single-rules"] = 380,
    ["JFrog Applications Config"] = 382,
    ["JFrog File Spec"] = 383,
    ["JFrog Pipelines YML DSL"] = 873,
    ["JMeter DSL cli config"] = 384,
    JReleaser = 386,
    ["JSON Document Transform"] = 394,
    ["JSON Feed"] = 395,
    ["JSON Resume"] = 600,
    ["JSON Schema Draft 2020-12"] = 752,
    ["JSON Schema Draft 4"] = 749,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 906,
    ["JSON Schema Draft 7"] = 750,
    ["JSON Schema Draft 7 (unofficial strict)"] = 907,
    ["JSON Schema Draft 8 (2019-09)"] = 751,
    ["JSON-API"] = 393,
    ["JSON-e templates"] = 808,
    ["JSON-stat 2.0"] = 745,
    JSONPatch = 397,
    ["JSR Package Config (jsr.json)"] = 387,
    Jasmine = 375,
    Jekyll = 376,
    ["Jenkins X Pipelines"] = 377,
    ["Jenkins X Requirements"] = 378,
    Jest = 379,
    ["Jovo Language Models"] = 385,
    ["KIMMDY config file"] = 408,
    ["KODE/CI build.yaml"] = 869,
    ["KSP-AVC"] = 746,
    ["KSP-CKAN"] = 747,
    ["KSP-NetKAN"] = 748,
    KSY = 934,
    KSail = 302,
    ["Karakum configuration file"] = 300,
    Kas = 400,
    ["Kestra flow file"] = 409,
    ["Keycloak REST API"] = 876,
    ["Knative Functions - func.yaml"] = 301,
    ["Kometa (nightly) config file"] = 411,
    ["Kometa config file"] = 410,
    ["Kong DBLess config"] = 870,
    KrakenD = 412,
    ["Kubri Configuration"] = 418,
    LOOBin = 433,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 199,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 200,
    ["Landing Zone Accelerator on AWS - Global Config"] = 201,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 202,
    ["Landing Zone Accelerator on AWS - Network Config"] = 203,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 204,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 205,
    ["Landing Zone Accelerator on AWS - Security Config"] = 206,
    ["Language configuration"] = 944,
    Lefthook = 422,
    ["Liferay client-extension.yaml"] = 429,
    ["LinkML Metamodel"] = 431,
    Liquibase = 816,
    ["Liquibase Flow File"] = 817,
    ["Lively Properties"] = 432,
    ["Lobe AI Agent"] = 64,
    Loki = 65,
    ["MLOS Configs"] = 470,
    ["MS2Rescore Configuration"] = 473,
    ["Madness (madness.yml)"] = 887,
    ["MapEHR Mapping"] = 439,
    Markdownlint = 820,
    ["Mason Registry"] = 822,
    ["MegaLinter configuration"] = 441,
    ["MegaLinter descriptor"] = 442,
    Melange = 913,
    ["Meltano project definition"] = 443,
    ["Mergify Configuration"] = 474,
    ["Metadata for a Bazel module"] = 444,
    ["Metadata for a Cinnamon spice"] = 960,
    ["Metatype Configuration"] = 445,
    ["MetricsHub Configuration"] = 446,
    ["MetricsHub Connector Configuration"] = 447,
    ["Micro Editor Syntax"] = 897,
    ["Microsoft Band Web Tile"] = 448,
    ["Microsoft RulesEngine workflow rules"] = 948,
    ["Microsoft RulesEngine workflow rules list"] = 949,
    ["Minecraft Custom Main Menu Mod"] = 914,
    ["Minecraft Data Pack Advancement"] = 450,
    ["Minecraft Data Pack Biome"] = 451,
    ["Minecraft Data Pack Configured Carver"] = 452,
    ["Minecraft Data Pack Damage Type"] = 453,
    ["Minecraft Data Pack Dimension"] = 455,
    ["Minecraft Data Pack Dimension Type"] = 454,
    ["Minecraft Data Pack Item Modifier"] = 456,
    ["Minecraft Data Pack Loot Table"] = 457,
    ["Minecraft Data Pack Metadata"] = 458,
    ["Minecraft Data Pack Predicate"] = 459,
    ["Minecraft Data Pack Recipe"] = 460,
    ["Minecraft Data Pack Tag"] = 461,
    ["Minecraft Data Pack Template Pool"] = 462,
    ["Minecraft Data Pack Trim Material"] = 467,
    ["Minecraft Data Pack Trim Pattern"] = 468,
    ["Minecraft Resource Pack Lang"] = 463,
    ["Minecraft Resource Pack Particle"] = 464,
    ["Minecraft Resource Pack Texture Mcmeta"] = 466,
    ["Minecraft Resourcepack Sounds"] = 465,
    ["Monade CLI Stack Configuration"] = 477,
    ["MongoDB Atlas Search Index Definition"] = 868,
    ["Monika Configuration"] = 866,
    ["Monoweave Configuration"] = 472,
    ["Motif config"] = 765,
    ["NOX Framework (Service)"] = 489,
    ["Netin Diagnostic System Template"] = 826,
    ["Netlify config"] = 480,
    ["Network-as-Code Data Model"] = 481,
    ["Nightwatch.js"] = 482,
    ["NueJS configuration file"] = 494,
    ["Nuitka.yaml"] = 927,
    ["Nullstone config"] = 496,
    ["ONe's changelog entry"] = 510,
    ["ONe's service descriptor"] = 509,
    ["OSCAL Assessment Plan (AP)"] = 518,
    ["OSCAL Assessment Results (AR)"] = 519,
    ["OSCAL Catalog"] = 520,
    ["OSCAL Component Definition (CDef)"] = 521,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 522,
    ["OSCAL Profile"] = 523,
    ["OSCAL System Security Plan (SSP)"] = 524,
    ["OSS Review Toolkit configuration"] = 525,
    ["OSS Review Toolkit curation"] = 526,
    ["OSS Review Toolkit package configuration"] = 527,
    ["OSS Review Toolkit repository configuration"] = 528,
    ["OSS Review Toolkit resolutions"] = 529,
    ["October CMS columns"] = 500,
    ["October CMS fields"] = 501,
    Okteto = 502,
    Opctl = 768,
    ["Open Data Contract Standard (ODCS)"] = 513,
    ["OpenRewrite Resource"] = 512,
    ["OpenUtau character yaml"] = 506,
    ["OpenUtau ustx"] = 507,
    ["OpenWeather Current Weather API"] = 807,
    ["OpenWeather Road Risk API"] = 806,
    ["Ory Hydra configuration"] = 361,
    ["Ory Keto configuration"] = 415,
    ["Ory Kratos configuration"] = 517,
    ["Ory Oathkeeper configuration"] = 498,
    ["Outblocks App configuration"] = 515,
    ["Outblocks database table"] = 516,
    ["Outblocks project configuration"] = 514,
    PDM = 535,
    Packer = 532,
    Pantsbuild = 883,
    ["Paper paper-plugin.yml"] = 533,
    ["Pipeline component"] = 818,
    ["Plex Prerolls"] = 543,
    ["PocketMine plugin.yml"] = 540,
    ["Postman collection"] = 547,
    ["Preset list for a WinUtil"] = 963,
    ["Problem object RFC9457"] = 911,
    ["Problem package generators"] = 556,
    Pterodactyl = 863,
    ["Pull Request Labeler"] = 571,
    Pulumi = 579,
    ["PyGTA Config"] = 575,
    PyProject = 580,
    Pyright = 581,
    Qgoda = 582,
    Qodana = 836,
    ["Qt Creator workspace file"] = 942,
    ["Quali Torque Blueprint Spec 2"] = 861,
    ["QueryFirst config file"] = 879,
    ["RKE Cluster Configuration JSON"] = 815,
    ["RKE Cluster Configuration YAML"] = 814,
    RadioHound = 574,
    ["Rancher Fleet"] = 576,
    ["Rattler-build"] = 583,
    Ray = 781,
    ["Read the Docs"] = 578,
    ["Red-DiscordBot Cog"] = 590,
    ["Red-DiscordBot Cog Repo"] = 591,
    ["Red-DiscordBot Trivia"] = 592,
    ["Render Blueprints"] = 813,
    RenderCV = 602,
    Renovate = 601,
    ["Replit config"] = 596,
    RoadRunner = 604,
    ["Rudder techniques"] = 917,
    Ruff = 598,
    ["Rust Project"] = 599,
    ["Rust toolchain"] = 608,
    ["SDMX data message"] = 633,
    ["SDMX metadata message"] = 632,
    ["SDMX structure message"] = 631,
    ["SIL Kit Participant Configuration"] = 643,
    ["SIL Kit Registry Configuration"] = 644,
    SWADL = 672,
    ["Safebox Config"] = 874,
    ["Sapphire CLI Config"] = 611,
    ["SauceCTL Configuration"] = 823,
    ["Schema Catalog"] = 625,
    ["Scoop manifest"] = 630,
    ["Semantic Data Fabric (SDF) file"] = 634,
    ["Semgrep Rule"] = 636,
    ["Serenity Code Generator (Sergen)"] = 637,
    ["Serverless Framework Configuration"] = 830,
    ["Serverless Workflow"] = 832,
    ["Settings for a Cinnamon spice"] = 959,
    ["Settings.paf"] = 639,
    ["Shopware 6 Configuration"] = 833,
    ["Shopware CLI Extension Store Configuration"] = 834,
    ["Shopware CLI Project Store Configuration"] = 835,
    ["Sigma Detection Rule"] = 641,
    ["Sigrid scope configuration file"] = 642,
    ["SkyPilot Task JSON"] = 918,
    ["Slack app manifest"] = 646,
    Solidarity = 649,
    ["Solution filters"] = 650,
    ["Source Maps v3"] = 651,
    Sourcery = 652,
    ["Speakeasy Lint Configuration File"] = 653,
    ["Speakeasy Test Generation Configuration File"] = 654,
    ["Speakeasy Workflow File"] = 655,
    SpecIF = 656,
    ["Sponge Mixin configuration"] = 657,
    StackBlitz = 662,
    ["StackHawk Scanner Configuration"] = 829,
    Stale = 663,
    ["Starlake Data Pipeline"] = 804,
    Starship = 664,
    ["Statamic Blueprint"] = 665,
    ["Stella configuration file"] = 666,
    ["Stryker Mutator"] = 669,
    ["StyleCop Analyzers Configuration"] = 670,
    ["Stylelint (.stylelintrc)"] = 671,
    ["Sublime Syntax"] = 875,
    ["Subsquid squid manifest"] = 920,
    ["Swagger API 2.0"] = 673,
    ["Synadia Connect Component"] = 674,
    TSON = 703,
    TSTyche = 704,
    ["Tab data for a LinUtil"] = 965,
    ["Tab list for a LinUtil"] = 964,
    Talhelper = 676,
    ["Talisman configuration"] = 677,
    ["Taskfile config"] = 809,
    Taurus = 678,
    Tauticord = 679,
    ["TestEnvironment.json"] = 688,
    ["TextMate Grammar"] = 687,
    ["Tier.run pricing.json"] = 682,
    Tikibase = 683,
    ["Traefik v2"] = 691,
    ["Traefik v2 File Provider"] = 692,
    ["Travis CI (.travis.yml)"] = 690,
    ["TrueScript for *.tscript files"] = 695,
    TunnelHub = 910,
    Turborepo = 689,
    Tycho = 955,
    Tye = 837,
    ["UET BuildConfig.json"] = 880,
    ["UI5 Manifest"] = 713,
    ["UNCORS configuration"] = 717,
    ["UTAM Page Object"] = 716,
    ["Ubuntu Server Autoinstall"] = 711,
    ["Uniswap Token List"] = 792,
    ["Unreal Engine Uplugin"] = 881,
    ["Unreal Engine Uproject"] = 882,
    ["Updatecli Compose"] = 845,
    ["Updatecli Policy Manifest"] = 846,
    ["Updatecli Policy Metadata"] = 847,
    Uplift = 878,
    ["User Journey Map"] = 812,
    V2Ray = 851,
    ["VSCode Code Snippets"] = 182,
    ["VSIX CLI publishing"] = 734,
    ["Vela Pipeline Configuration"] = 721,
    Vercel = 181,
    ["Version Bumper config"] = 724,
    Visivo = 908,
    ["Waku Config"] = 968,
    ["Web App Manifest"] = 740,
    ["Web types"] = 743,
    WebExtensions = 739,
    ["Webman package recipe"] = 857,
    ["Windows Package Manager Installer Manifest"] = 789,
    ["Windows Package Manager Locale Manifest"] = 790,
    ["Windows Package Manager Singleton Manifest"] = 788,
    ["WireMock stub mapping"] = 971,
    ["Woodpecker pipeline config"] = 825,
    ["Wrangler CLI"] = 744,
    ["Xstate Machine"] = 843,
    ["Yandex Workflow Language"] = 961,
    ["Yarn Config (.yarnrc.yml)"] = 802,
    ["Yippee-Ki-JSON configuration YML"] = 794,
    ["YouTrack App"] = 958,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 912,
    ...
    ["behat.yml"] = 92,
    ["bigquery-table"] = 82,
    ["bioimageio resource description"] = 928,
    ...
    ["ccmod.json"] = 969,
    changelogging = 939,
    ["chisel-slices.json"] = 208,
    ["chrome-extension-locales-messages.json"] = 189,
    ["chutzpah.json"] = 190,
    cibuildwheel = 120,
    ["clang-format (.clang-format)"] = 849,
    ["clang-tidy"] = 169,
    clangd = 168,
    clib = 170,
    ["cloud-init: cloud-config userdata"] = 172,
    ["cloud-sdk-pipeline-configuration"] = 192,
    ["cloudbuild.json"] = 193,
    cloudify = 171,
    codemagic = 173,
    ["coffeelint.json"] = 210,
    ["commands.json"] = 185,
    ["commitlint (.commitlintrc)"] = 791,
    ["compile_commands.json"] = 184,
    ["compilerconfig.json"] = 183,
    ["completely.yml"] = 886,
    ["component-detection-manifest.json"] = 213,
    ["component.json"] = 212,
    ["composer.json"] = 211,
    ["conda-forge"] = 123,
    ["config.yaml"] = 577,
    ["contentmanifest.json"] = 191,
    ["contribute.json"] = 214,
    ["cosmos.config.json"] = 187,
    ["crowdin.yml"] = 215,
    ["ctfd-setup configuration file"] = 978,
    ["custom-elements.json"] = 900,
    ["cypress.json"] = 219,
    ["datalogic-scan2deploy-android"] = 229,
    ["datalogic-scan2deploy-ce"] = 230,
    ["dbt Dependencies"] = 136,
    ["dbt Packages"] = 138,
    ["dbt Project"] = 137,
    ["dbt Selectors"] = 139,
    ["dbt YAML files"] = 140,
    ["ddev-global"] = 231,
    ["ddev-project"] = 232,
    ["debugsettings.json"] = 233,
    ["dependabot-v2.json"] = 236,
    ["dependabot.json"] = 235,
    ["deployed-cli"] = 842,
    ["devcontainer.json"] = 175,
    devinit = 796,
    ["devspace.yaml"] = 865,
    djlint = 797,
    ["docker bake"] = 241,
    ["docker sequencer"] = 242,
    ["docker-compose.yml"] = 795,
    ["dockerd.json"] = 240,
    ["dotnet Release Index manifest"] = 253,
    ["dotnet-tools.json"] = 254,
    ["dotnetcli.host.json"] = 255,
    ["dprint.json"] = 256,
    ["drone.json"] = 257,
    ["dss-2.0.0.json"] = 259,
    ["dstack configuration"] = 260,
    ["dtool dataset metadata"] = 973,
    ["dvc.yaml"] = 261,
    ["ecosystem.json"] = 266,
    eksctl = 267,
    ["electron-builder configuration file"] = 273,
    ["epr-manifest.json"] = 272,
    ["evcc.yaml"] = 274,
    ["ezd task runner"] = 284,
    ["fabric.mod.json"] = 286,
    ["first-timers-bot"] = 292,
    ["flagd flag configuration"] = 69,
    ["fly.io Configuration"] = 70,
    fulibWorkflows = 824,
    ["function.json"] = 303,
    ["gRPC API Gateway & OpenAPI Config"] = 3,
    ["gematik health care insurance list"] = 984,
    ["gematik health care patient list"] = 981,
    ["gematik health care provider institution list"] = 983,
    ["gematik health care provider list"] = 982,
    ["gitlab-ci"] = 320,
    ["global.json"] = 335,
    ...
    ["ide.host.json"] = 365,
    ["ifstate.conf"] = 366,
    ["imageoptimizer.json"] = 367,
    ["importmap.json"] = 370,
    ["ioBroker Configuration"] = 372,
    ["ioBroker JSON UI"] = 373,
    ["ioBroker Package manifest"] = 374,
    ["ize.toml"] = 877,
    ["jsconfig.json"] = 398,
    ["jscpd Configuration"] = 862,
    jsdoc = 780,
    ["k3d.yaml"] = 399,
    ["k9s aliases.yaml"] = 401,
    ["k9s cluster-config.yaml"] = 403,
    ["k9s config.yaml"] = 402,
    ["k9s hotkeys.yaml"] = 404,
    ["k9s plugins.yaml"] = 405,
    ["k9s skin.yaml"] = 406,
    ["k9s views.yaml"] = 407,
    ["kontinuous-config.yaml"] = 417,
    ["kontinuous-values.yaml"] = 416,
    ["kustomization.yaml"] = 419,
    ["label-commenter-config.yml"] = 420,
    ["latexindent configuration"] = 63,
    ["launchsettings.json"] = 421,
    lazydocker = 899,
    lazygit = 898,
    ["lego.json"] = 423,
    ["lerna.json"] = 424,
    ["lgtm.yml"] = 425,
    ["liblab.config.json"] = 426,
    ["libman.json"] = 427,
    ["license-report-config.json"] = 428,
    ["linkinator.config.json"] = 430,
    ["lint-staged (.lintstagedrc)"] = 760,
    ["local.settings.json"] = 435,
    ["localazy.json"] = 436,
    ["lotus.yaml"] = 434,
    ["lsdlschema.json"] = 437,
    ["markdown-link-check"] = 821,
    mboats = 828,
    ["micro-settings.json"] = 892,
    ["mimetypes.json"] = 449,
    ["mirrord config"] = 761,
    mise = 762,
    ["mkdocs.yml"] = 469,
    ["monospace.yml"] = 471,
    ["moon.yml"] = 970,
    ["mprocs Configuration file"] = 943,
    ["mta.yaml"] = 763,
    ["mtad.yaml"] = 764,
    ["mycode.json"] = 478,
    ["napari plugin manifest"] = 479,
    neoload = 775,
    ["nest-cli"] = 484,
    ["ninjs (News in JSON)"] = 483,
    ["nitro.json"] = 774,
    ["nixd configuration"] = 916,
    ["nlu.json"] = 485,
    ["nodemon.json"] = 487,
    ["noodl config"] = 827,
    ["notebook.mod.json"] = 488,
    now = 770,
    ["npm-badges"] = 491,
    ["nswag.json"] = 495,
    ntangle = 497,
    ["nuclei-template.yaml"] = 492,
    ["nuget-project.json"] = 493,
    ["ocelot.json"] = 499,
    ["omnisharp.json"] = 503,
    ["openapi.json"] = 504,
    ["openfin.json"] = 511,
    ...
    ["ops.yaml"] = 508,
    ["package.json"] = 530,
    ["package.manifest"] = 531,
    ["partial-black.json"] = 93,
    ["pathfinder.yml"] = 534,
    ["pattern.json"] = 537,
    ["petstore-v1.0"] = 872,
    pgap_yaml_input_reader = 536,
    ["pixi.toml"] = 538,
    ["plagiarize-me.yaml"] = 542,
    ["plagiarize.yaml"] = 541,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 974,
    ["podbard.yaml"] = 544,
    ["portman.json"] = 545,
    ["prefect.toml"] = 553,
    ["prettierrc.json"] = 554,
    ["prisma.yml"] = 555,
    ["project-1.0.0-beta3.json"] = 558,
    ["project-1.0.0-beta4.json"] = 559,
    ["project-1.0.0-beta5.json"] = 560,
    ["project-1.0.0-beta6.json"] = 561,
    ["project-1.0.0-beta8.json"] = 562,
    ["project-1.0.0-rc1.json"] = 563,
    ["project-1.0.0-rc2.json"] = 564,
    ["project.json"] = 557,
    ["prometheus.json"] = 565,
    ["prometheus.rules.json"] = 566,
    ["prometheus.rules.test.json"] = 567,
    ["proxies.json"] = 568,
    ["publiccode.yml"] = 569,
    ["pubspec.yaml"] = 570,
    ["pyrseas-0.8.json"] = 573,
    ["quilt.mod.json"] = 893,
    ["rc3 auth"] = 584,
    ["rc3 collection"] = 585,
    ["rc3 environment"] = 586,
    ...
    samt = 609,
    samtrc = 610,
    ["sarif-1.0.0.json"] = 612,
    ["sarif-2.0.0.json"] = 613,
    ["sarif-2.1.0"] = 623,
    ["sarif-2.1.0-rtm.2"] = 614,
    ["sarif-2.1.0-rtm.3"] = 616,
    ["sarif-2.1.0-rtm.4"] = 618,
    ["sarif-2.1.0-rtm.5"] = 620,
    ["sarif-2.1.0-rtm.6"] = 621,
    ["sarif-external-property-file-2.1.0"] = 624,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 615,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 617,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 619,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 622,
    ["schema.org - Action"] = 626,
    ["schema.org - ContactPoint"] = 627,
    ["schema.org - Place"] = 628,
    ["schema.org - Thing"] = 629,
    ["secrethub.yml"] = 895,
    ["semantic-release"] = 635,
    ["servicehub.config.json"] = 755,
    ["servicehub.service.json"] = 754,
    ["settings.job"] = 638,
    ["sfdx-hardis configuration"] = 640,
    ["shard.yml"] = 931,
    ["size-limit configuration"] = 645,
    ["skaffold.yaml"] = 819,
    ["skyuxconfig.json"] = 647,
    snapcraft = 648,
    ["spicepod.yaml"] = 950,
    ["sqlc configuration"] = 659,
    ["stripe-app-local.json"] = 668,
    ["stripe-app.json"] = 667,
    swcrc = 805,
    ["task.json"] = 675,
    taskcat = 771,
    ["template.json"] = 680,
    ["templatsources.json"] = 681,
    ["theme.json"] = 684,
    ["tizen_workspace.json"] = 685,
    tldr = 686,
    tmuxinator = 758,
    ["transcend.yml"] = 693,
    ["tree-sitter grammar.json"] = 343,
    ["trime.yaml"] = 694,
    ["trunk.yaml"] = 696,
    ["ts-force-config.json"] = 701,
    ["tsconfig.json"] = 697,
    ["tsd.json"] = 698,
    ["tsdoc.json"] = 699,
    ["tsdrc.json"] = 700,
    ...
    v8r = 738,
    vcluster = 937,
    ["vcpkg configuration file"] = 180,
    ["vcpkg manifest file"] = 179,
    ["vega-lite.json"] = 720,
    ["vega.json"] = 719,
    ["venvironment-basic.yaml"] = 723,
    ["venvironment.yaml"] = 722,
    ["version.json"] = 725,
    ["vhwdebugger-binding.yaml"] = 727,
    ["vim-addon-info"] = 728,
    ["vs-2017.3.host.json"] = 730,
    ["vs-nesting.json"] = 731,
    ["vsls.json"] = 729,
    ["vss-extension.json"] = 735,
    ["vtesttree.yaml"] = 736,
    ["vtestunit.yaml"] = 737,
    ["warp-keysets.json"] = 901,
    ["warp-themes.json"] = 902,
    ["warp-workflows.json"] = 903,
    ["webhint.io"] = 858,
    ["webjobpublishsettings.json"] = 742,
    ["webjobs-list.json"] = 741,
    ["well-known-fursona"] = 938,
    ["xs-app.json"] = 767,
    ["xunit.runner.json"] = 753,
    yamllint = 793,
    ["zerops.io import file"] = 947,
    ["zerops.yml"] = 946,
    zuul = 777,
    ["Žinoma"] = 787
  },
