...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 208,
    [".cryproj (generic)"] = 712,
    [".cryproj engine-5.2"] = 707,
    [".cryproj engine-5.3"] = 708,
    [".cryproj engine-5.4"] = 709,
    [".cryproj engine-5.5"] = 710,
    [".cryproj engine-dev"] = 711,
    [".eslintrc"] = 272,
    [".esmrc.json"] = 257,
    [".ffizer.yaml"] = 276,
    [".htmlhintrc"] = 346,
    ...
    ["<div>RIOTS' studio configuration"] = 690,
    ...
    ["Azure Pipelines"] = 59,
    ["Azure Static Web Apps CLI configuration file"] = 618,
    ["Azure Static Web Apps configuration file"] = 617,
    ["BX CI"] = 98,
    ...
    ["JSON Feed"] = 381,
    ["JSON Resume"] = 558,
    ["JSON Schema Draft 2020-12"] = 703,
    ["JSON Schema Draft 4"] = 700,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 867,
    ["JSON Schema Draft 7"] = 701,
    ["JSON Schema Draft 7 (unofficial strict)"] = 868,
    ["JSON Schema Draft 8 (2019-09)"] = 702,
    ["JSON-API"] = 379,
    ["JSON-WF"] = 896,
    ...
    ["Source Maps v3"] = 608,
    Sourcery = 609,
    ["Speakeasy Lint Configuration File"] = 610,
    ["Speakeasy Test Generation Configuration File"] = 611,
    ["Speakeasy Workflow File"] = 612,
    SpecIF = 613,
    ["Sponge Mixin configuration"] = 614,
    StackBlitz = 619,
    ["StackHawk Scanner Configuration"] = 785,
    Stale = 620,
    ["Starlake Data Pipeline"] = 760,
    Starship = 621,
    ["Statamic Blueprint"] = 622,
    ["Stella configuration file"] = 623,
    ...
    ["Stryker Mutator"] = 626,
    ["StyleCop Analyzers Configuration"] = 627,
    ["Stylelint (.stylelintrc)"] = 628,
    ["Sublime Syntax"] = 836,
    ...
    TSTyche = 657,
    Talhelper = 632,
    ["Talisman configuration"] = 633,
    ["Taskfile config"] = 765,
    Taurus = 634,
    ["TestEnvironment.json"] = 643,
    ["TextMate Grammar"] = 642,
    ["Tier.run pricing.json"] = 637,
    Tikibase = 638,
    ["Traefik v2"] = 646,
    ["Traefik v2 File Provider"] = 647,
    ["Travis CI (.travis.yml)"] = 645,
    TunnelHub = 871,
    Turborepo = 644,
    Tycho = 917,
    Tye = 793,
    ...
    ["UI5 Manifest"] = 666,
    ["UNCORS configuration"] = 670,
    ["UTAM Page Object"] = 669,
    ["Ubuntu Server Autoinstall"] = 664,
    ...
    ["VSIX CLI publishing"] = 685,
    ["Vela Pipeline Configuration"] = 674,
    Vercel = 169,
    Visivo = 869,
    ["Web App Manifest"] = 692,
    ["Web types"] = 695,
    WebExtensions = 691,
    ...
    ["servicehub.config.json"] = 706,
    ["servicehub.service.json"] = 705,
    ["settings.job"] = 595,
    ...
    snapcraft = 605,
    ["spicepod.yaml"] = 912,
    ["sqlc configuration"] = 616,
    ["stripe-app-local.json"] = 625,
    ["stripe-app.json"] = 624,
    swcrc = 761,
    ["task.json"] = 631,
    taskcat = 728,
    ["template.json"] = 635,
    ["templatsources.json"] = 636,
    ["theme.json"] = 639,
    ["tizen_workspace.json"] = 640,
    tldr = 641,
    tmuxinator = 714,
    ["transcend.yml"] = 648,
    ...
    ["vega-lite.json"] = 673,
    ["vega.json"] = 672,
    ["venvironment-basic.yaml"] = 676,
    ["venvironment.yaml"] = 675,
    ["version.json"] = 677,
    ["vim-addon-info"] = 679,
    ["vs-2017.3.host.json"] = 681,
    ["vs-nesting.json"] = 682,
    ["vsls.json"] = 680,
    ["vss-extension.json"] = 686,
    ["vtesttree.yaml"] = 687,
    ["vtestunit.yaml"] = 688,
    ...
    ["webhint.io"] = 814,
    ["webjobpublishsettings.json"] = 694,
    ["webjobs-list.json"] = 693,
    ["well-known-fursona"] = 900,
    ["xs-app.json"] = 724,
    ["xunit.runner.json"] = 704,
    yamllint = 749,
