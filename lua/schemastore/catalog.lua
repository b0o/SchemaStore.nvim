...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 962,
    [".nodehawkrc"] = 599,
    [".npmpackagejsonlintrc"] = 603,
    [".omletrc"] = 1141,
    [".phrase.yml"] = 678,
    [".phraseapp.yml"] = 679,
    [".pmbot.yml"] = 663,
    [".postcssrc"] = 672,
    [".powerpages-web-template-manifest"] = 674,
    [".pre-commit-config.yml"] = 675,
    [".pre-commit-hooks.yml"] = 676,
    [".putout.json"] = 712,
    [".rehyperc"] = 737,
    [".remarkrc"] = 741,
    [".sprite files"] = 836,
    ...
    AIConfig = 35,
    ["AMX Muse Program Descriptor"] = 1189,
    ["API Builder"] = 997,
    ["AVA Configuration"] = 1060,
    ...
    ["AWS Copilot Manifest"] = 1228,
    ["AWS SAM CLI Samconfig"] = 273,
    Acton = 1278,
    ["Adobe UXP Manifest"] = 1123,
    ["Aerleon Network & Service Definitions"] = 21,
    ["Aerleon Policy"] = 22,
    ["Agent Permission Policy"] = 1268,
    ["AgentCore CLI"] = 1269,
    Aider = 1218,
    Air = 24,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1239,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1238,
    ["Airlock Microgateway"] = 36,
    ["Alacritty Configuration"] = 1032,
    ["All Contributors configuration file"] = 1086,
    ...
    ["Application list for a WinUtil"] = 1168,
    ArchitectFX = 1173,
    ["Argo CD"] = 55,
    ["Argo Events"] = 56,
    ["Argo Workflows"] = 57,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1237,
    ["Azure IoT Operations connector metadata"] = 1234,
    ...
    ["Azure Pipelines"] = 115,
    ["Azure Static Web Apps CLI configuration file"] = 840,
    ["Azure Static Web Apps configuration file"] = 839,
    BMML = 1256,
    ["BOSH CPI Config"] = 141,
    ...
    ["Bacon config"] = 6,
    ["Barba-CV"] = 84,
    ["Bashly (bashly.yml)"] = 1090,
    ["Bashly Settings (bashly-settings.yml)"] = 1091,
    Bento = 1255,
    ["Better Code Hub"] = 1002,
    ["Better Scripts"] = 164,
    Bigconfig = 134,
    ["Biome Formatter Config"] = 85,
    ["Bitmovin Encoding Template"] = 1182,
    BizTalkServerApplicationSchema = 969,
    Bleep = 165,
    ["Block Protocol Metadata"] = 162,
    ["Bluebricks blueprint config"] = 1261,
    ["Boyka Framework"] = 143,
    ...
    ["Butane Config"] = 1045,
    C4InterFlow = 1197,
    ["CDK Environment Manager, concrete environment configuration"] = 1221,
    ["CDK Environment Manager, concrete environments definition"] = 1220,
    ["CDK Environment Manager, environment definition"] = 1219,
    ["CGS Card Game Specification (cgs.json)"] = 1128,
    ["CICS TS region tagging"] = 1054,
    ["CICS TS resource import"] = 1055,
    ["CICS TS resource model"] = 1056,
    ["CICS TS resource overrides"] = 1057,
    ["CMake Presets"] = 166,
    ["CNC Codes"] = 188,
    ["CRS WAF test file"] = 1158,
    ["CRS WAF test platform overrides file"] = 1159,
    ...
    ["Chamaleon environment"] = 1186,
    ["Chamaleon properties"] = 1187,
    ["Chamaleon template"] = 1185,
    Changepacks = 1248,
    Changesets = 282,
    Changie = 175,
    Charmcraft = 176,
    ...
    ["Clawject config"] = 194,
    ["Cloud Foundry Application Manifest"] = 1140,
    ["Cloud Run Spec v1"] = 1163,
    ...
    Concord = 1157,
    ["Configu .cfgu files"] = 1145,
    ["Configu .configu file"] = 1146,
    Conjure = 187,
    ["Container Structure Test"] = 983,
    Containerlab = 1011,
    ["Contextive Glossary"] = 1213,
    Convex = 186,
    ["Crowdsec collection config"] = 292,
    ["Crowdsec parser config"] = 293,
    ["Crowdsec scenario config"] = 294,
    ["CumulusCI Config"] = 193,
    ["Cursor Agent Environment"] = 1266,
    ["Custom Machinery Machine"] = 1129,
    ["Custom Machinery Recipe"] = 1130,
    ...
    ["DonateCaseBetterCasino menu"] = 1190,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1098,
    ["EAS config"] = 363,
    ["ECA - Editor Code Assistant"] = 345,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1087,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1233,
    ["EasyVCR .NET"] = 365,
    ["Eidolon Resource"] = 1174,
    ["Elgato Stream Deck"] = 347,
    Elm = 1162,
    ["Embrace Config"] = 1073,
    Endurica = 1111,
    ["Enterprise Contract Policy Spec"] = 348,
    ["Envelope Team Definition"] = 1277,
    ["Envilder Map File"] = 349,
    ["Erda Pipeline"] = 1136,
    ["Erda Runtime"] = 1137,
    ["Espanso config.yml"] = 1259,
    ["Espanso match.yml"] = 1258,
    Esquio = 351,
    ["Estuary Flow Catalog"] = 1051,
    ["Ethereum ERC1155"] = 1271,
    ["Ethereum ERC721"] = 1270,
    ...
    ["Evolving Resolutive Process notation"] = 1235,
    ["Expo SDK"] = 362,
    ...
    ["GeoJSON.json latest"] = 1049,
    GherKing = 1053,
    ["GitHub Action"] = 398,
    ["GitHub Actions typing"] = 1170,
    ...
    ["Google Digital Assetlinks"] = 1214,
    Goreleaser = 427,
    ["Goreleaser Pro"] = 428,
    Goss = 429,
    ["Gradle Build Cache Node"] = 1000,
    ["Gradle Enterprise"] = 999,
    ...
    Hadolint = 979,
    Hammerkit = 1010,
    ["Hardware Sentry Configuration"] = 1065,
    ...
    ["JFrog File Spec"] = 480,
    ["JFrog Pipelines YML DSL"] = 1075,
    ["JMeter DSL cli config"] = 481,
    JReleaser = 484,
    ["JSON Document Transform"] = 492,
    ["JSON Feed"] = 493,
    ["JSON Resume"] = 749,
    ["JSON Schema Draft 2020-12"] = 947,
    ["JSON Schema Draft 4"] = 944,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1108,
    ["JSON Schema Draft 7"] = 945,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1109,
    ["JSON Schema Draft 8 (2019-09)"] = 946,
    ["JSON-API"] = 491,
    ["JSON-e templates"] = 1007,
    ["JSON-stat 2.0"] = 940,
    JSONPatch = 495,
    ...
    ["Jujutsu (jj) VCS config"] = 1227,
    ["KIMMDY config file"] = 506,
    ["KODE/CI build.yaml"] = 1071,
    ["KSP-AVC"] = 941,
    ["KSP-CKAN"] = 942,
    ["KSP-NetKAN"] = 943,
    KSY = 1138,
    ...
    ["Metadata for a Cinnamon spice"] = 1166,
    ["Metatype Configuration"] = 548,
    ["MetricsHub Configuration"] = 549,
    ["MetricsHub Connector Configuration"] = 550,
    ["Micro Editor Syntax"] = 1099,
    ["Microsoft Band Web Tile"] = 551,
    ["Microsoft RulesEngine workflow rules"] = 1154,
    ["Microsoft RulesEngine workflow rules list"] = 1155,
    ["Minecraft Custom Main Menu Mod"] = 1117,
    ...
    ["MongoDB Atlas Search Index Definition"] = 1070,
    ["Monika Configuration"] = 1068,
    ["Monoweave Configuration"] = 579,
    ["Motif config"] = 961,
    MultiQC = 1207,
    ["NOX Framework (Service)"] = 602,
    ["Netin Diagnostic System Template"] = 1027,
    ["Netlify config"] = 587,
    ...
    ["Nightwatch.js"] = 595,
    ["Node.js configuration"] = 966,
    ["NueJS configuration file"] = 607,
    ["Nuitka.yaml"] = 1131,
    ["Nullstone config"] = 609,
    ["ONe's changelog entry"] = 628,
    ["ONe's service descriptor"] = 627,
    ["ORT Server repository environment configuration"] = 638,
    ["OSCAL Assessment Plan (AP)"] = 640,
    ["OSCAL Assessment Results (AR)"] = 641,
    ["OSCAL Catalog"] = 642,
    ["OSCAL Component Definition (CDef)"] = 643,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 644,
    ["OSCAL Profile"] = 645,
    ["OSCAL System Security Plan (SSP)"] = 646,
    ["OSS Review Toolkit configuration"] = 647,
    ["OSS Review Toolkit curation"] = 648,
    ["OSS Review Toolkit package configuration"] = 649,
    ["OSS Review Toolkit repository configuration"] = 650,
    ["OSS Review Toolkit resolutions"] = 651,
    ["October CMS columns"] = 613,
    ["October CMS fields"] = 614,
    ["Oh My Posh"] = 616,
    Okteto = 617,
    ["Ona Automations"] = 619,
    Opctl = 964,
    ["Open Data Contract Standard (ODCS)"] = 632,
    ["Open Data Product Standard (ODPS)"] = 633,
    ["Open Know-How"] = 1212,
    OpenDecree = 1275,
    ["OpenDecree Configuration"] = 1276,
    ["OpenRewrite Resource"] = 630,
    OpenSRM = 634,
    OpenStatus = 1223,
    ["OpenTelemetry Declarative Configuration"] = 631,
    ["OpenUtau character yaml"] = 624,
    ["OpenUtau ustx"] = 625,
    ["OpenWeather Current Weather API"] = 1006,
    ["OpenWeather Road Risk API"] = 1005,
    ["Ory Hydra configuration"] = 454,
    ["Ory Keto configuration"] = 514,
    ["Ory Kratos configuration"] = 639,
    ["Ory Oathkeeper configuration"] = 611,
    ["Outblocks App configuration"] = 636,
    ["Outblocks database table"] = 637,
    ["Outblocks project configuration"] = 635,
    PDM = 658,
    POPxf = 669,
    ["POPxf Correlations"] = 670,
    ["PRML manifest"] = 677,
    Packer = 655,
    PactSpec = 656,
    Pantsbuild = 1085,
    ["Paper paper-plugin.yml"] = 657,
    ["Pipeline component"] = 1018,
    ["Platform.sh application"] = 8,
    ["Platform.sh routes"] = 9,
    ["Platform.sh services"] = 10,
    ["Plex Prerolls"] = 667,
    ["PocketMine plugin.yml"] = 664,
    ["Postman collection"] = 673,
    ["Power Pages Configuration"] = 1224,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1169,
    ["ProActions AI-Kit Configuration"] = 685,
    ["ProActions AI-Kit Configuration for Menus"] = 687,
    ["ProActions AI-Kit Configuration for Sections"] = 689,
    ["ProActions AI-Kit Configuration for Services"] = 686,
    ["ProActions AI-Kit Configuration for Steps"] = 690,
    ["ProActions AI-Kit Configuration for Templates"] = 688,
    ["Problem object RFC9457"] = 1114,
    ["Problem package format"] = 691,
    ["Problem package generators"] = 692,
    ["Problem package submissions"] = 693,
    ["Problem package test group metadata"] = 694,
    Pterodactyl = 1064,
    ["Pull Request Labeler"] = 711,
    Pulumi = 719,
    ["PyGTA Config"] = 715,
    PyProject = 720,
    Pylock = 1215,
    Pyright = 721,
    ["Python script metadata"] = 1209,
    ["QType AI DSL"] = 724,
    Qgoda = 723,
    Qodana = 1037,
    ["Qt Creator workspace file"] = 1147,
    ["Quali Torque Blueprint Spec 2"] = 1062,
    ["QueryFirst config file"] = 1081,
    ["Qwen Code Settings"] = 1272,
    ["RKE Cluster Configuration JSON"] = 1015,
    ["RKE Cluster Configuration YAML"] = 1014,
    RadioHound = 714,
    ["Raid Profile"] = 1273,
    ["Raid Repo Configuration"] = 1274,
    Railpack = 726,
    Railway = 725,
    ["Rancher Fleet"] = 716,
    ["Rattler-build"] = 727,
    Ray = 978,
    ["Read the Docs"] = 718,
    ["Red-DiscordBot Cog"] = 734,
    ["Red-DiscordBot Cog Repo"] = 735,
    ["Red-DiscordBot Trivia"] = 736,
    ["Releasaurus Config"] = 5,
    ReleaseKit = 4,
    ["Render Blueprints"] = 1013,
    RenderCV = 753,
    Renovate = 750,
    ["Renovate global configuration"] = 751,
    ["Renovate inherited configuration"] = 752,
    ["Replit config"] = 742,
    Restate = 1202,
    ["Revel Digital Gadget Definition File"] = 1226,
    RoadRunner = 755,
    ["Robust Station Image"] = 1232,
    Rockcraft = 756,
    ["Roo Coder Custom Modes"] = 757,
    Rubocop = 746,
    ["Rudder techniques"] = 1121,
    Ruff = 747,
    ["Rust Project"] = 748,
    ["Rust toolchain"] = 762,
    ["SDMX data message"] = 789,
    ["SDMX metadata message"] = 788,
    ["SDMX structure message"] = 787,
    ["SIL Kit Participant Configuration"] = 799,
    ["SIL Kit Registry Configuration"] = 800,
    ["SPDX 2.3"] = 837,
    SWADL = 853,
    ["Safebox Config"] = 1076,
    ["Sapphire CLI Config"] = 765,
    ["SauceCTL Configuration"] = 1024,
    Scarb = 785,
    ["Schema Catalog"] = 780,
    ["Scoop manifest"] = 786,
    ["Semantic Data Fabric (SDF) file"] = 790,
    ["Semgrep Rule"] = 792,
    ["Serenity Code Generator (Sergen)"] = 793,
    ["Serverless Framework Configuration"] = 1031,
    ["Serverless Workflow"] = 1033,
    ["Settings for a Cinnamon spice"] = 1165,
    ["Settings.paf"] = 795,
    ["Shopware 6 Configuration"] = 1034,
    ["Shopware CLI Extension Store Configuration"] = 1035,
    ["Shopware CLI Project Store Configuration"] = 1036,
    ["Sigma Detection Rule"] = 797,
    ["Sigrid scope configuration file"] = 798,
    ["SkyPilot Task JSON"] = 1122,
    ["Slack app manifest"] = 802,
    Snapcraft = 804,
    Solidarity = 807,
    ["Solution filters"] = 808,
    ["Source Maps v3"] = 809,
    Sourcery = 810,
    ["Spack bootstrap.yaml"] = 811,
    ["Spack cdash.yaml"] = 812,
    ["Spack ci.yaml"] = 813,
    ["Spack compilers.yaml"] = 814,
    ["Spack concretizer.yaml"] = 815,
    ["Spack config.yaml"] = 816,
    ["Spack definitions.yaml"] = 817,
    ["Spack develop.yaml"] = 818,
    ["Spack env_vars.yaml"] = 819,
    ["Spack environment"] = 825,
    ["Spack include.yaml"] = 820,
    ["Spack mirrors.yaml"] = 821,
    ["Spack modules.yaml"] = 822,
    ["Spack packages.yaml"] = 823,
    ["Spack repos.yaml"] = 824,
    ["Spack toolchains.yaml"] = 826,
    ["Spack upstreams.yaml"] = 827,
    ["Spack view.yaml"] = 828,
    ["Speakeasy Generation Config File"] = 832,
    ["Speakeasy Lint Configuration File"] = 829,
    ["Speakeasy Test Generation Configuration File"] = 830,
    ["Speakeasy Workflow File"] = 831,
    SpecIF = 833,
    ["Specmatic Configuration"] = 834,
    ["Sponge Mixin configuration"] = 835,
    StackBlitz = 841,
    ["StackHawk Scanner Configuration"] = 1030,
    Stale = 842,
    Starfish = 843,
    ["Starlake Data Pipeline"] = 1003,
    Starship = 844,
    ["Statamic Blueprint"] = 845,
    ["Stella configuration file"] = 846,
    ["Streamlit configuration file"] = 847,
    ["Stryker Mutator"] = 850,
    ["StyleCop Analyzers Configuration"] = 851,
    ["Stylelint (.stylelintrc)"] = 852,
    ["Stylua Config"] = 1216,
    ["Sublime Syntax"] = 1077,
    ["Subsquid squid manifest"] = 1124,
    ["Swagger API 2.0"] = 854,
    ["Synadia Connect Component"] = 855,
    TSON = 891,
    TSTyche = 892,
    ["TYPO3 Vendor Bundler config"] = 898,
    ["Tab data for a LinUtil"] = 1172,
    ["Tab list for a LinUtil"] = 1171,
    Tach = 856,
    ["Tach Domain"] = 857,
    Talhelper = 859,
    ["Talisman configuration"] = 860,
    Taplo = 1217,
    ["Taskfile config"] = 1008,
    Taurus = 861,
    Tauticord = 862,
    ["Tekton Pipeline"] = 1245,
    ["Tekton PipelineRun"] = 1246,
    ["Tekton Task"] = 1243,
    ["Tekton TaskRun"] = 1244,
    Telefonistka = 1203,
    ["Terrateam config"] = 1229,
    ["TestEnvironment.json"] = 874,
    ["TextMate Grammar"] = 873,
    Threagile = 868,
    ["Tier.run pricing.json"] = 865,
    Tikibase = 866,
    Tombi = 871,
    ["Traefik v2"] = 877,
    ["Traefik v2 File Provider"] = 878,
    ["Traefik v3"] = 879,
    ["Traefik v3 File Provider"] = 880,
    ["Travis CI (.travis.yml)"] = 876,
    Treefmt = 432,
    Trident = 1199,
    ["TrueScript for *.tscript files"] = 883,
    ["Tugboat QA config.yml"] = 1196,
    TunnelHub = 1112,
    Turborepo = 875,
    Tycho = 1161,
    Tye = 1038,
    ["Tyk Gateway - Open Source v5.7+"] = 1208,
    ["UET BuildConfig.json"] = 1082,
    ["UI5 Manifest"] = 904,
    ["UNCORS configuration"] = 908,
    ["UTAM Page Object"] = 907,
    ["Ubuntu Server Autoinstall"] = 902,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1200,
    ["Uniswap Token List"] = 989,
    ["Universal Schedule Format"] = 909,
    ["Unreal Engine Uplugin"] = 1083,
    ["Unreal Engine Uproject"] = 1084,
    ["UpCloud CLI (upctl) configuration"] = 1201,
    ["Updatecli Compose"] = 1046,
    ["Updatecli Policy Manifest"] = 1047,
    ["Updatecli Policy Metadata"] = 1048,
    Uplift = 1080,
    ["Upsun config"] = 7,
    ["User Journey Map"] = 1012,
    V2Ray = 1052,
    ["VSCode Code Snippets"] = 257,
    ["VSIX CLI publishing"] = 927,
    Vector = 911,
    ["Vela Pipeline Configuration"] = 914,
    Vercel = 256,
    ["Version Bumper config"] = 917,
    Vespertide = 1250,
    ["Vespertide Migration"] = 1251,
    ["Vespertide Model"] = 1252,
    ["Viash Component Config"] = 1205,
    ["Viash Package Config"] = 1206,
    Visivo = 1110,
    ["WP-CLI"] = 937,
    Wake = 1198,
    ["Waku Config"] = 1175,
    ["Web App Manifest"] = 933,
    ["Web types"] = 936,
    WebExtensions = 932,
    ["Webman package recipe"] = 1058,
    ["Windows Package Manager Installer Manifest"] = 986,
    ["Windows Package Manager Locale Manifest"] = 987,
    ["Windows Package Manager Singleton Manifest"] = 985,
    ["WireMock CLI import configuration"] = 1181,
    ["WireMock CLI local service configuration"] = 1180,
    ["WireMock message stub mapping"] = 1179,
    ["WireMock stub mapping"] = 1178,
    ["Woodpecker pipeline config"] = 1026,
    ["Wrangler CLI"] = 938,
    ["XenForo add-on manifest"] = 939,
    ["Xstate Machine"] = 1044,
    ["Yandex Workflow Language"] = 1167,
    ["Yarn Config (.yarnrc.yml)"] = 1001,
    ["Yippee-Ki-JSON configuration YML"] = 992,
    ["YouTrack App"] = 1164,
    ["Zarf Package Configuration"] = 1231,
    ["Zerops import file"] = 1153,
    ["Zola Configuration"] = 1242,
    ["aerleon.yml"] = 20,
    ["amplify.yml"] = 13,
    ["angular.json"] = 37,
    apko = 1115,
    ...
    ["behat.yml"] = 144,
    ["bigquery-table"] = 133,
    ["bioimageio resource description"] = 1132,
    ...
    ["cargo-nextest repository configuration"] = 592,
    ["cargo-nextest user configuration"] = 593,
    ["ccmod.json"] = 1176,
    changelogging = 1144,
    ...
    ["chutzpah.json"] = 265,
    cibuildwheel = 181,
    ["clang-format (.clang-format)"] = 1050,
    ["clang-tidy"] = 242,
    clangd = 241,
    clib = 243,
    ...
    ["gematik health care insurance list"] = 1194,
    ["gematik health care patient list"] = 1191,
    ["gematik health care provider institution list"] = 1193,
    ["gematik health care provider list"] = 1192,
    ["gematik tiger test environment configuration"] = 1195,
    ["git-town.toml"] = 1240,
    ["gitlab-ci"] = 407,
    ["global.json"] = 423,
    ...
    ["lint-staged (.lintstagedrc)"] = 955,
    ["local.settings.json"] = 535,
    ["localazy.json"] = 536,
    ["lotus.yaml"] = 534,
    ["lsdlschema.json"] = 537,
    ["macro.json"] = 1067,
    ["markdown-link-check"] = 1021,
    maturin = 1022,
    mboats = 1029,
    memnex = 1279,
    ["micro-settings.json"] = 1094,
    ["mimetypes.json"] = 552,
    ["mirrord config"] = 957,
    mise = 958,
    ["mkdocs.yml"] = 572,
    ...
    ["monospace.yml"] = 578,
    ["moon.yml"] = 1177,
    ["mprocs Configuration file"] = 1148,
    ["mrdocs.yml"] = 574,
    ["mta.yaml"] = 959,
    ["mtad.yaml"] = 960,
    ["mycode.json"] = 585,
    ...
    ["nest-cli"] = 597,
    ["nexus-rpc-gen"] = 1267,
    ["ninjs (News in JSON)"] = 596,
    ["nitro.json"] = 971,
    ["nixd configuration"] = 1120,
    ["nlu.json"] = 598,
    ["nodemon.json"] = 600,
    ["noodl config"] = 1028,
    ["notebook.mod.json"] = 601,
    now = 967,
    ["npm-badges"] = 604,
    ["nswag.json"] = 608,
    ntangle = 610,
    ["nuclei-template.yaml"] = 605,
    ["nuget-project.json"] = 606,
    ["ocelot.json"] = 612,
    ogen = 615,
    ["omnisharp.json"] = 618,
    openHAB = 1253,
    ...
    oxlint = 1264,
    ["package.json"] = 652,
    ["package.manifest"] = 654,
    ["package.yaml"] = 653,
    ["partial-black.json"] = 145,
    ["partial-fastapi.json"] = 146,
    ["partial-pixi.json"] = 662,
    ["partial-scheduled.json"] = 147,
    ["pattern.json"] = 660,
    ["petstore-v1.0"] = 1074,
    pgap_yaml_input_reader = 659,
    pgxgen = 1257,
    pitcms = 1260,
    ["pixi.toml"] = 661,
    ["plagiarize-me.yaml"] = 666,
    ["plagiarize.yaml"] = 665,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1184,
    ["podbard.yaml"] = 668,
    ["portman.json"] = 671,
    ["prefect.toml"] = 680,
    ["prefect.yaml"] = 681,
    ...
    ["prettierrc.json"] = 683,
    ["prisma.yml"] = 684,
    ["project-1.0.0-beta3.json"] = 696,
    ["project-1.0.0-beta4.json"] = 697,
    ["project-1.0.0-beta5.json"] = 698,
    ["project-1.0.0-beta6.json"] = 699,
    ["project-1.0.0-beta8.json"] = 700,
    ["project-1.0.0-rc1.json"] = 701,
    ["project-1.0.0-rc2.json"] = 702,
    ["project.json"] = 695,
    ["project.owasp.yaml"] = 703,
    ["prometheus-alertmanager.json"] = 707,
    ["prometheus.json"] = 704,
    ["prometheus.rules.json"] = 705,
    ["prometheus.rules.test.json"] = 706,
    ["proxies.json"] = 708,
    ["publiccode.yml"] = 709,
    ["pubspec.yaml"] = 710,
    ["pyrseas-0.8.json"] = 713,
    pytest = 722,
    ["quilt.mod.json"] = 1095,
    ["rc3 auth"] = 728,
    ["rc3 collection"] = 729,
    ...
    ["release drafter"] = 973,
    ["release-hub.json"] = 3,
    ["release-please-config.json"] = 738,
    ["release-please-manifest.json"] = 739,
    ["release-plz.toml"] = 740,
    ["renv.lock"] = 754,
    ["reposets Configuration"] = 743,
    ["reposets Credentials"] = 744,
    ["revola.json"] = 1,
    ["rivet.json"] = 1119,
    ...
    samt = 763,
    samtrc = 764,
    ["sarif-1.0.0.json"] = 766,
    ["sarif-2.0.0.json"] = 767,
    ["sarif-2.1.0"] = 777,
    ["sarif-2.1.0-rtm.2"] = 768,
    ["sarif-2.1.0-rtm.3"] = 770,
    ["sarif-2.1.0-rtm.4"] = 772,
    ["sarif-2.1.0-rtm.5"] = 774,
    ["sarif-2.1.0-rtm.6"] = 775,
    ["sarif-external-property-file-2.1.0"] = 778,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 769,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 771,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 773,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 776,
    ["scalingo.json configuration"] = 779,
    ["schema.org - Action"] = 781,
    ["schema.org - ContactPoint"] = 782,
    ["schema.org - Place"] = 783,
    ["schema.org - Thing"] = 784,
    ["secrethub.yml"] = 1097,
    ["semantic-release"] = 791,
    ["servicehub.config.json"] = 950,
    ["servicehub.service.json"] = 949,
    ["settings.job"] = 794,
    ["sfdx-hardis configuration"] = 796,
    ["shard.yml"] = 1135,
    ["size-limit configuration"] = 801,
    ["skaffold.yaml"] = 1019,
    ["skyuxconfig.json"] = 803,
    ["snowflake-config"] = 805,
    ["snowflake-connections"] = 806,
    ["spicepod.yaml"] = 1156,
    ["sqlc configuration"] = 838,
    ["stripe-app-local.json"] = 849,
    ["stripe-app.json"] = 848,
    swcrc = 1004,
    ["task.json"] = 858,
    taskcat = 968,
    ["template.json"] = 863,
    ["templatsources.json"] = 864,
    ["text2confl config"] = 1265,
    ["theme.json"] = 867,
    ["tizen_workspace.json"] = 869,
    tldr = 870,
    ["tm_devices configuration file"] = 1222,
    tmuxinator = 953,
    tox = 872,
    ["transcend.yml"] = 881,
    ...
    ["vega-lite.json"] = 913,
    ["vega.json"] = 912,
    ["venvironment.yaml"] = 915,
    ["venvplus.yaml"] = 916,
    version = 1204,
    ["version.json"] = 918,
    ["vhwdebugger-binding.yaml"] = 920,
    ["vim-addon-info"] = 921,
    ["vs-2017.3.host.json"] = 923,
    ["vs-nesting.json"] = 924,
    ["vsls.json"] = 922,
    ["vss-extension.json"] = 928,
    vtcfg = 1210,
    ["vtesttree.yaml"] = 929,
    ["vtestunit.yaml"] = 930,
    ["warp-keysets.json"] = 1103,
    ["warp-themes.json"] = 1104,
    ["warp-workflows.json"] = 1105,
    ["webhint.io"] = 1059,
    ["webjobpublishsettings.json"] = 935,
    ["webjobs-list.json"] = 934,
    ["well-known-fursona"] = 1143,
    ["xs-app.json"] = 963,
    ["xunit.runner.json"] = 948,
    yamlfmt = 990,
    yamllint = 991,
    ["zerops.yml"] = 1152,
    zizmor = 1247,
