...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 893,
    [".nodehawkrc"] = 550,
    [".npmpackagejsonlintrc"] = 554,
    [".omletrc"] = 1070,
    [".phrase.yml"] = 622,
    [".phraseapp.yml"] = 623,
    [".pmbot.yml"] = 608,
    [".postcssrc"] = 617,
    [".powerpages-web-template-manifest"] = 619,
    [".pre-commit-config.yml"] = 620,
    [".pre-commit-hooks.yml"] = 621,
    [".putout.json"] = 651,
    [".rehyperc"] = 676,
    [".remarkrc"] = 680,
    [".sprite files"] = 769,
    ...
    ABCSupplyPlan = 21,
    AIConfig = 22,
    ["AMX Muse Program Descriptor"] = 1117,
    ["API Builder"] = 928,
    ["AVA Configuration"] = 991,
    ...
    ["AWS Copilot Manifest"] = 1156,
    ["AWS SAM CLI Samconfig"] = 240,
    ["Adobe UXP Manifest"] = 1053,
    ["Aerleon Network & Service Definitions"] = 15,
    ["Aerleon Policy"] = 16,
    Aider = 1146,
    Air = 18,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1167,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1166,
    ["Airlock Microgateway"] = 23,
    ["Alacritty Configuration"] = 963,
    ["All Contributors configuration file"] = 1016,
    ...
    ["Application list for a WinUtil"] = 1097,
    ArchitectFX = 1102,
    ["Argo CD"] = 41,
    ["Argo Events"] = 42,
    ["Argo Workflows"] = 43,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1165,
    ["Azure IoT Operations connector metadata"] = 1162,
    ...
    ["Azure Pipelines"] = 95,
    ["Azure Static Web Apps CLI configuration file"] = 773,
    ["Azure Static Web Apps configuration file"] = 772,
    ["BOSH CPI Config"] = 119,
    ["BOSH Deploy Config"] = 120,
    ["BX CI"] = 139,
    ["Bacon config"] = 2,
    ["Bashly (bashly.yml)"] = 1020,
    ["Bashly Settings (bashly-settings.yml)"] = 1021,
    ["Better Code Hub"] = 933,
    ["Better Scripts"] = 140,
    Bigconfig = 112,
    ["Biome Formatter Config"] = 68,
    ["Bitmovin Encoding Template"] = 1110,
    BizTalkServerApplicationSchema = 900,
    Bleep = 141,
    ...
    ["Butane Config"] = 976,
    C4InterFlow = 1125,
    ["CDK Environment Manager, concrete environment configuration"] = 1149,
    ["CDK Environment Manager, concrete environments definition"] = 1148,
    ["CDK Environment Manager, environment definition"] = 1147,
    ["CGS Card Game Specification (cgs.json)"] = 1058,
    ["CICS TS region tagging"] = 985,
    ["CICS TS resource import"] = 986,
    ["CICS TS resource model"] = 987,
    ["CICS TS resource overrides"] = 988,
    ["CMake Presets"] = 142,
    ["CNC Codes"] = 163,
    ["CRS WAF test file"] = 1087,
    ["CRS WAF test platform overrides file"] = 1088,
    ...
    ["Chamaleon environment"] = 1114,
    ["Chamaleon properties"] = 1115,
    ["Chamaleon template"] = 1113,
    Changesets = 249,
    Changie = 151,
    Charmcraft = 152,
    Cheatsheets = 973,
    ...
    ["Clawject config"] = 169,
    ["Cloud Foundry Application Manifest"] = 1069,
    ["Cloud Run Spec v1"] = 1092,
    ...
    Concord = 1086,
    ["Configu .cfgu files"] = 1074,
    ["Configu .configu file"] = 1075,
    Conjure = 162,
    ["Container Structure Test"] = 914,
    Containerlab = 942,
    ["Contextive Glossary"] = 1141,
    Convex = 161,
    ["Crowdsec collection config"] = 259,
    ["Crowdsec parser config"] = 260,
    ["Crowdsec scenario config"] = 261,
    ["CumulusCI Config"] = 168,
    ["Custom Machinery Machine"] = 1059,
    ["Custom Machinery Recipe"] = 1060,
    ...
    ["DonateCaseBetterCasino menu"] = 1118,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1028,
    ["EAS config"] = 325,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1017,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1161,
    ["EasyVCR .NET"] = 326,
    ["Eidolon Resource"] = 1103,
    ...
    ["Evolving Resolutive Process notation"] = 1163,
    ["Expo SDK"] = 324,
    ...
    ["GeoJSON.json latest"] = 980,
    GherKing = 984,
    ["GitHub Action"] = 358,
    ["GitHub Actions typing"] = 1099,
    ...
    ["Google Digital Assetlinks"] = 1142,
    Goreleaser = 386,
    ["Goreleaser Pro"] = 387,
    Goss = 388,
    ["Gradle Build Cache Node"] = 931,
    ["Gradle Enterprise"] = 930,
    ...
    Hadolint = 910,
    Hammerkit = 941,
    ["Hardware Sentry Configuration"] = 996,
    ["HashiCorp Vault"] = 402,
    Hatch = 911,
    Hayagriva = 404,
    Hayson = 405,
    ...
    ["JFrog File Spec"] = 440,
    ["JFrog Pipelines YML DSL"] = 1005,
    ["JMeter DSL cli config"] = 441,
    JReleaser = 444,
    ["JSON Document Transform"] = 452,
    ["JSON Feed"] = 453,
    ["JSON Resume"] = 686,
    ["JSON Schema Draft 2020-12"] = 878,
    ["JSON Schema Draft 4"] = 875,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1038,
    ["JSON Schema Draft 7"] = 876,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1039,
    ["JSON Schema Draft 8 (2019-09)"] = 877,
    ["JSON-API"] = 451,
    ["JSON-e templates"] = 938,
    ["JSON-stat 2.0"] = 871,
    JSONPatch = 455,
    ...
    ["Jujutsu (jj) VCS config"] = 1155,
    ["KIMMDY config file"] = 466,
    ["KODE/CI build.yaml"] = 1001,
    ["KSP-AVC"] = 872,
    ["KSP-CKAN"] = 873,
    ["KSP-NetKAN"] = 874,
    KSY = 1068,
    ...
    ["Metadata for a Cinnamon spice"] = 1095,
    ["Metatype Configuration"] = 506,
    ["MetricsHub Configuration"] = 507,
    ["MetricsHub Connector Configuration"] = 508,
    ["Micro Editor Syntax"] = 1029,
    ["Microsoft Band Web Tile"] = 509,
    ["Microsoft RulesEngine workflow rules"] = 1083,
    ["Microsoft RulesEngine workflow rules list"] = 1084,
    ["Minecraft Custom Main Menu Mod"] = 1047,
    ...
    ["MongoDB Atlas Search Index Definition"] = 1000,
    ["Monika Configuration"] = 998,
    ["Monoweave Configuration"] = 534,
    ["Motif config"] = 892,
    MultiQC = 1135,
    ["NOX Framework (Service)"] = 553,
    ["Netin Diagnostic System Template"] = 958,
    ["Netlify config"] = 542,
    ["Network-as-Code Data Model"] = 543,
    ["Next Gen UI Agent Configuration"] = 544,
    ["Nightwatch.js"] = 546,
    ["Node.js configuration"] = 897,
    ["NueJS configuration file"] = 558,
    ["Nuitka.yaml"] = 1061,
    ["Nullstone config"] = 560,
    ["ONe's changelog entry"] = 576,
    ["ONe's service descriptor"] = 575,
    ["ORT Server repository environment configuration"] = 584,
    ["OSCAL Assessment Plan (AP)"] = 586,
    ["OSCAL Assessment Results (AR)"] = 587,
    ["OSCAL Catalog"] = 588,
    ["OSCAL Component Definition (CDef)"] = 589,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 590,
    ["OSCAL Profile"] = 591,
    ["OSCAL System Security Plan (SSP)"] = 592,
    ["OSS Review Toolkit configuration"] = 593,
    ["OSS Review Toolkit curation"] = 594,
    ["OSS Review Toolkit package configuration"] = 595,
    ["OSS Review Toolkit repository configuration"] = 596,
    ["OSS Review Toolkit resolutions"] = 597,
    ["October CMS columns"] = 564,
    ["October CMS fields"] = 565,
    ["Oh My Posh"] = 566,
    Okteto = 567,
    ["Ona Automations"] = 569,
    Opctl = 895,
    ["Open Data Contract Standard (ODCS)"] = 579,
    ["Open Data Product Standard (ODPS)"] = 580,
    ["Open Know-How"] = 1140,
    ["OpenRewrite Resource"] = 578,
    OpenStatus = 1151,
    ["OpenUtau character yaml"] = 572,
    ["OpenUtau ustx"] = 573,
    ["OpenWeather Current Weather API"] = 937,
    ["OpenWeather Road Risk API"] = 936,
    ["Ory Hydra configuration"] = 414,
    ["Ory Keto configuration"] = 474,
    ["Ory Kratos configuration"] = 585,
    ["Ory Oathkeeper configuration"] = 562,
    ["Outblocks App configuration"] = 582,
    ["Outblocks database table"] = 583,
    ["Outblocks project configuration"] = 581,
    PDM = 604,
    POPxf = 614,
    ["POPxf Correlations"] = 615,
    Packer = 601,
    Pantsbuild = 1015,
    ["Paper paper-plugin.yml"] = 602,
    ["Pipeline component"] = 949,
    ["Platform.sh application"] = 4,
    ["Platform.sh routes"] = 5,
    ["Platform.sh services"] = 6,
    ["Plex Prerolls"] = 612,
    ["PocketMine plugin.yml"] = 609,
    ["Postman collection"] = 618,
    ["Power Pages Configuration"] = 1152,
    ["Preset list for a WinUtil"] = 1098,
    ["ProActions AI-Kit Configuration"] = 627,
    ["ProActions AI-Kit Configuration for Menus"] = 629,
    ["ProActions AI-Kit Configuration for Sections"] = 631,
    ["ProActions AI-Kit Configuration for Services"] = 628,
    ["ProActions AI-Kit Configuration for Steps"] = 632,
    ["ProActions AI-Kit Configuration for Templates"] = 630,
    ["Problem object RFC9457"] = 1044,
    ["Problem package generators"] = 633,
    Pterodactyl = 995,
    ["Pull Request Labeler"] = 650,
    Pulumi = 658,
    ["PyGTA Config"] = 654,
    PyProject = 659,
    Pylock = 1143,
    Pyright = 660,
    ["Python script metadata"] = 1137,
    ["QType AI DSL"] = 663,
    Qgoda = 662,
    Qodana = 968,
    ["Qt Creator workspace file"] = 1076,
    ["Quali Torque Blueprint Spec 2"] = 993,
    ["QueryFirst config file"] = 1011,
    ["RKE Cluster Configuration JSON"] = 946,
    ["RKE Cluster Configuration YAML"] = 945,
    RadioHound = 653,
    Railpack = 665,
    Railway = 664,
    ["Rancher Fleet"] = 655,
    ...
    Ray = 909,
    ["Read the Docs"] = 657,
    ["Red-DiscordBot Cog"] = 673,
    ["Red-DiscordBot Cog Repo"] = 674,
    ["Red-DiscordBot Trivia"] = 675,
    ["Render Blueprints"] = 944,
    RenderCV = 688,
    Renovate = 687,
    ["Replit config"] = 681,
    Restate = 1130,
    ["Revel Digital Gadget Definition File"] = 1154,
    RoadRunner = 690,
    ["Robust Station Image"] = 1160,
    Rockcraft = 691,
    ["Roo Coder Custom Modes"] = 692,
    Rubocop = 683,
    ["Rudder techniques"] = 1051,
    Ruff = 684,
    ["Rust Project"] = 685,
    ["Rust toolchain"] = 696,
    ["SDMX data message"] = 722,
    ["SDMX metadata message"] = 721,
    ["SDMX structure message"] = 720,
    ["SIL Kit Participant Configuration"] = 732,
    ["SIL Kit Registry Configuration"] = 733,
    ["SPDX 2.3"] = 770,
    SWADL = 786,
    ["Safebox Config"] = 1006,
    ["Sapphire CLI Config"] = 699,
    ["SauceCTL Configuration"] = 955,
    ["Schema Catalog"] = 714,
    ["Scoop manifest"] = 719,
    ["Semantic Data Fabric (SDF) file"] = 723,
    ["Semgrep Rule"] = 725,
    ["Serenity Code Generator (Sergen)"] = 726,
    ["Serverless Framework Configuration"] = 962,
    ["Serverless Workflow"] = 964,
    ["Settings for a Cinnamon spice"] = 1094,
    ["Settings.paf"] = 728,
    ["Shopware 6 Configuration"] = 965,
    ["Shopware CLI Extension Store Configuration"] = 966,
    ["Shopware CLI Project Store Configuration"] = 967,
    ["Sigma Detection Rule"] = 730,
    ["Sigrid scope configuration file"] = 731,
    ["SkyPilot Task JSON"] = 1052,
    ["Slack app manifest"] = 735,
    Snapcraft = 737,
    Solidarity = 740,
    ["Solution filters"] = 741,
    ["Source Maps v3"] = 742,
    Sourcery = 743,
    ["Spack bootstrap.yaml"] = 744,
    ["Spack cdash.yaml"] = 745,
    ["Spack ci.yaml"] = 746,
    ["Spack compilers.yaml"] = 747,
    ["Spack concretizer.yaml"] = 748,
    ["Spack config.yaml"] = 749,
    ["Spack definitions.yaml"] = 750,
    ["Spack develop.yaml"] = 751,
    ["Spack env_vars.yaml"] = 752,
    ["Spack environment"] = 758,
    ["Spack include.yaml"] = 753,
    ["Spack mirrors.yaml"] = 754,
    ["Spack modules.yaml"] = 755,
    ["Spack packages.yaml"] = 756,
    ["Spack repos.yaml"] = 757,
    ["Spack toolchains.yaml"] = 759,
    ["Spack upstreams.yaml"] = 760,
    ["Spack view.yaml"] = 761,
    ["Speakeasy Generation Config File"] = 765,
    ["Speakeasy Lint Configuration File"] = 762,
    ["Speakeasy Test Generation Configuration File"] = 763,
    ["Speakeasy Workflow File"] = 764,
    SpecIF = 766,
    ["Specmatic Configuration"] = 767,
    ["Sponge Mixin configuration"] = 768,
    StackBlitz = 774,
    ["StackHawk Scanner Configuration"] = 961,
    Stale = 775,
    Starfish = 776,
    ["Starlake Data Pipeline"] = 934,
    Starship = 777,
    ["Statamic Blueprint"] = 778,
    ["Stella configuration file"] = 779,
    ["Streamlit configuration file"] = 780,
    ["Stryker Mutator"] = 783,
    ["StyleCop Analyzers Configuration"] = 784,
    ["Stylelint (.stylelintrc)"] = 785,
    ["Stylua Config"] = 1144,
    ["Sublime Syntax"] = 1007,
    ["Subsquid squid manifest"] = 1054,
    ["Swagger API 2.0"] = 787,
    ["Synadia Connect Component"] = 788,
    TSON = 823,
    TSTyche = 824,
    ["TYPO3 Vendor Bundler config"] = 829,
    ["Tab data for a LinUtil"] = 1101,
    ["Tab list for a LinUtil"] = 1100,
    Tach = 789,
    ["Tach Domain"] = 790,
    Talhelper = 792,
    ["Talisman configuration"] = 793,
    Taplo = 1145,
    ["Taskfile config"] = 939,
    Taurus = 794,
    Tauticord = 795,
    ["Tekton Pipeline"] = 1173,
    ["Tekton PipelineRun"] = 1174,
    ["Tekton Task"] = 1171,
    ["Tekton TaskRun"] = 1172,
    Telefonistka = 1131,
    ["Terrateam config"] = 1157,
    ["TestEnvironment.json"] = 806,
    ["TextMate Grammar"] = 805,
    Threagile = 801,
    ["Tier.run pricing.json"] = 798,
    Tikibase = 799,
    Tombi = 804,
    ["Traefik v2"] = 809,
    ["Traefik v2 File Provider"] = 810,
    ["Traefik v3"] = 811,
    ["Traefik v3 File Provider"] = 812,
    ["Travis CI (.travis.yml)"] = 808,
    Treefmt = 391,
    Trident = 1127,
    ["TrueScript for *.tscript files"] = 815,
    ["Tugboat QA config.yml"] = 1124,
    TunnelHub = 1042,
    Turborepo = 807,
    Tycho = 1090,
    Tye = 969,
    ["Tyk Gateway - Open Source v5.7+"] = 1136,
    ["Typst Manifest"] = 830,
    ["UET BuildConfig.json"] = 1012,
    ["UI5 Manifest"] = 836,
    ["UNCORS configuration"] = 840,
    ["UTAM Page Object"] = 839,
    ["Ubuntu Server Autoinstall"] = 834,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1128,
    ["Uniswap Token List"] = 921,
    ["Universal Schedule Format"] = 841,
    ["Unreal Engine Uplugin"] = 1013,
    ["Unreal Engine Uproject"] = 1014,
    ["UpCloud CLI (upctl) configuration"] = 1129,
    ["Updatecli Compose"] = 977,
    ["Updatecli Policy Manifest"] = 978,
    ["Updatecli Policy Metadata"] = 979,
    Uplift = 1010,
    ["Upsun config"] = 3,
    ["User Journey Map"] = 943,
    V2Ray = 983,
    ["VSCode Code Snippets"] = 224,
    ["VSIX CLI publishing"] = 859,
    Vector = 843,
    ["Vela Pipeline Configuration"] = 846,
    Vercel = 223,
    ["Version Bumper config"] = 849,
    ["Viash Component Config"] = 1133,
    ["Viash Package Config"] = 1134,
    Visivo = 1040,
    ["WP-CLI"] = 869,
    Wake = 1126,
    ["Waku Config"] = 1104,
    ["Web App Manifest"] = 865,
    ["Web types"] = 868,
    WebExtensions = 864,
    ["Webman package recipe"] = 989,
    ["Windows Package Manager Installer Manifest"] = 917,
    ["Windows Package Manager Locale Manifest"] = 918,
    ["Windows Package Manager Singleton Manifest"] = 916,
    Winutil = 919,
    ["WireMock CLI import configuration"] = 1109,
    ["WireMock CLI local service configuration"] = 1108,
    ["WireMock stub mapping"] = 1107,
    ["Woodpecker pipeline config"] = 957,
    ["Wrangler CLI"] = 870,
    ["Xstate Machine"] = 975,
    ["Yandex Workflow Language"] = 1096,
    ["Yarn Config (.yarnrc.yml)"] = 932,
    ["Yippee-Ki-JSON configuration YML"] = 923,
    ["YouTrack App"] = 1093,
    ["Zarf Package Configuration"] = 1159,
    ["Zerops.io config"] = 1081,
    ["Zerops.io import"] = 1082,
    ["Zola Configuration"] = 1170,
    ["aerleon.yml"] = 14,
    ["angular.json"] = 24,
    apko = 1045,
    ...
    ["behat.yml"] = 122,
    ["bigquery-table"] = 111,
    ["bioimageio resource description"] = 1062,
    ...
    ["crowdin.yml"] = 258,
    ["ctfd-setup configuration file"] = 1116,
    ["custom-elements.json"] = 1032,
    ["cypress.json"] = 262,
    ...
    ["gematik health care insurance list"] = 1122,
    ["gematik health care patient list"] = 1119,
    ["gematik health care provider institution list"] = 1121,
    ["gematik health care provider list"] = 1120,
    ["gematik tiger test environment configuration"] = 1123,
    ["git-town.toml"] = 1168,
    ["gitlab-ci"] = 366,
    ["global.json"] = 382,
    ...
    ["lint-staged (.lintstagedrc)"] = 886,
    ["local.settings.json"] = 494,
    ["localazy.json"] = 495,
    ["lotus.yaml"] = 493,
    ["lsdlschema.json"] = 496,
    ["markdown-link-check"] = 952,
    maturin = 953,
    mboats = 960,
    ["micro-settings.json"] = 1024,
    ["mimetypes.json"] = 510,
    ["mirrord config"] = 888,
    mise = 889,
    ["mkdocs.yml"] = 530,
    ["monospace.yml"] = 533,
    ["moon.yml"] = 1106,
    ["mprocs Configuration file"] = 1077,
    ["mrdocs.yml"] = 531,
    ["mta.yaml"] = 890,
    ["mtad.yaml"] = 891,
    ["mycode.json"] = 540,
    ...
    neoload = 903,
    ["nest-cli"] = 548,
    ["ninjs (News in JSON)"] = 547,
    ["nitro.json"] = 902,
    ["nixd configuration"] = 1050,
    ["nlu.json"] = 549,
    ["nodemon.json"] = 551,
    ["noodl config"] = 959,
    ["notebook.mod.json"] = 552,
    now = 898,
    ["npm-badges"] = 555,
    ["nswag.json"] = 559,
    ntangle = 561,
    ["nuclei-template.yaml"] = 556,
    ["nuget-project.json"] = 557,
    ["ocelot.json"] = 563,
    ["omnisharp.json"] = 568,
    ["openapi.json"] = 570,
    ["openfin.json"] = 577,
    ...
    ["ops.yaml"] = 574,
    ["package.json"] = 598,
    ["package.manifest"] = 600,
    ["package.yaml"] = 599,
    ["partial-black.json"] = 123,
    ["pathfinder.yml"] = 603,
    ["pattern.json"] = 606,
    ["petstore-v1.0"] = 1004,
    pgap_yaml_input_reader = 605,
    ["pixi.toml"] = 607,
    ["plagiarize-me.yaml"] = 611,
    ["plagiarize.yaml"] = 610,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1112,
    ["podbard.yaml"] = 613,
    ["portman.json"] = 616,
    ["prefect.toml"] = 624,
    ["prettierrc.json"] = 625,
    ["prisma.yml"] = 626,
    ["project-1.0.0-beta3.json"] = 635,
    ["project-1.0.0-beta4.json"] = 636,
    ["project-1.0.0-beta5.json"] = 637,
    ["project-1.0.0-beta6.json"] = 638,
    ["project-1.0.0-beta8.json"] = 639,
    ["project-1.0.0-rc1.json"] = 640,
    ["project-1.0.0-rc2.json"] = 641,
    ["project.json"] = 634,
    ["project.owasp.yaml"] = 642,
    ["prometheus-alertmanager.json"] = 646,
    ["prometheus.json"] = 643,
    ["prometheus.rules.json"] = 644,
    ["prometheus.rules.test.json"] = 645,
    ["proxies.json"] = 647,
    ["publiccode.yml"] = 648,
    ["pubspec.yaml"] = 649,
    ["pyrseas-0.8.json"] = 652,
    pytest = 661,
    ["quilt.mod.json"] = 1025,
    ["rc3 auth"] = 667,
    ["rc3 collection"] = 668,
    ...
    ["release drafter"] = 904,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 677,
    ["release-please-manifest.json"] = 678,
    ["release-plz.toml"] = 679,
    ["renv.lock"] = 689,
    ["rivet.json"] = 1049,
    ["rivet.yaml (legacy)"] = 1048,
    rumdl = 694,
    runny = 693,
    rustfmt = 695,
    sake = 1139,
    samt = 697,
    samtrc = 698,
    ["sarif-1.0.0.json"] = 700,
    ["sarif-2.0.0.json"] = 701,
    ["sarif-2.1.0"] = 711,
    ["sarif-2.1.0-rtm.2"] = 702,
    ["sarif-2.1.0-rtm.3"] = 704,
    ["sarif-2.1.0-rtm.4"] = 706,
    ["sarif-2.1.0-rtm.5"] = 708,
    ["sarif-2.1.0-rtm.6"] = 709,
    ["sarif-external-property-file-2.1.0"] = 712,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 703,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 705,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 707,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 710,
    ["scalingo.json configuration"] = 713,
    ["schema.org - Action"] = 715,
    ["schema.org - ContactPoint"] = 716,
    ["schema.org - Place"] = 717,
    ["schema.org - Thing"] = 718,
    ["secrethub.yml"] = 1027,
    ["semantic-release"] = 724,
    ["servicehub.config.json"] = 881,
    ["servicehub.service.json"] = 880,
    ["settings.job"] = 727,
    ["sfdx-hardis configuration"] = 729,
    ["shard.yml"] = 1065,
    ["size-limit configuration"] = 734,
    ["skaffold.yaml"] = 950,
    ["skyuxconfig.json"] = 736,
    ["snowflake-config"] = 738,
    ["snowflake-connections"] = 739,
    ["spicepod.yaml"] = 1085,
    ["sqlc configuration"] = 771,
    ["stripe-app-local.json"] = 782,
    ["stripe-app.json"] = 781,
    swcrc = 935,
    ["task.json"] = 791,
    taskcat = 899,
    ["template.json"] = 796,
    ["templatsources.json"] = 797,
    ["theme.json"] = 800,
    ["tizen_workspace.json"] = 802,
    tldr = 803,
    ["tm_devices configuration file"] = 1150,
    tmuxinator = 884,
    ["transcend.yml"] = 813,
    ["tree-sitter grammar.json"] = 390,
    ["trime.yaml"] = 814,
    ["trunk.yaml"] = 816,
    ["ts-force-config.json"] = 821,
    ["tsconfig.json"] = 817,
    ["tsd.json"] = 818,
    ["tsdoc.json"] = 819,
    ["tsdrc.json"] = 820,
    ...
    ["vega-lite.json"] = 845,
    ["vega.json"] = 844,
    ["venvironment.yaml"] = 847,
    ["venvplus.yaml"] = 848,
    version = 1132,
    ["version.json"] = 850,
    ["vhwdebugger-binding.yaml"] = 852,
    ["vim-addon-info"] = 853,
    ["vs-2017.3.host.json"] = 855,
    ["vs-nesting.json"] = 856,
    ["vsls.json"] = 854,
    ["vss-extension.json"] = 860,
    vtcfg = 1138,
    ["vtesttree.yaml"] = 861,
    ["vtestunit.yaml"] = 862,
    ["warp-keysets.json"] = 1033,
    ["warp-themes.json"] = 1034,
    ["warp-workflows.json"] = 1035,
    ["webhint.io"] = 990,
    ["webjobpublishsettings.json"] = 867,
    ["webjobs-list.json"] = 866,
    ["well-known-fursona"] = 1072,
    ["xs-app.json"] = 894,
    ["xunit.runner.json"] = 879,
    yamllint = 922,
    zuul = 905,
    ["Žinoma"] = 915
  },
