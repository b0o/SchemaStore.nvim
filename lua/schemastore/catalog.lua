...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 164,
    [".cryproj (generic)"] = 571,
    [".cryproj engine-5.2"] = 566,
    [".cryproj engine-5.3"] = 567,
    [".cryproj engine-5.4"] = 568,
    [".cryproj engine-5.5"] = 569,
    [".cryproj engine-dev"] = 570,
    [".csscomb.json"] = 166,
    [".csslintrc"] = 167,
    [".es6importsorterrc.json"] = 698,
    [".eslintrc"] = 213,
    [".esmrc.json"] = 205,
    [".ffizer.yaml"] = 217,
    [".htmlhintrc"] = 264,
    ...
    [".mtaext"] = 580,
    [".nodehawkrc"] = 359,
    [".npmpackagejsonlintrc"] = 362,
    [".phraseapp.yml"] = 402,
    [".pmbot.yml"] = 392,
    [".postcssrc"] = 397,
    [".powerpages-web-template-manifest"] = 399,
    [".pre-commit-config.yml"] = 400,
    [".pre-commit-hooks.yml"] = 401,
    [".putout.json"] = 420,
    [".rehyperc"] = 431,
    [".remarkrc"] = 432,
    [".sprite files"] = 485,
    ...
    ["<div>RIOTS' studio configuration"] = 550,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config schema"] = 321,
    ["API Builder"] = 611,
    ["AVA Configuration Schema"] = 668,
    ["AWS CDK cdk.json"] = 150,
    ["AWS CloudFormation"] = 151,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 152,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 13,
    ["Airplane task"] = 14,
    ["Alacritty Configuration Schema"] = 643,
    ["All Contributors configuration file"] = 697,
    ...
    ["Azure Pipelines"] = 54,
    ["Azure Static Web Apps CLI configuration file"] = 487,
    ["Azure Static Web Apps configuration file"] = 486,
    ["BX CI"] = 89,
    ["Better Code Hub"] = 616,
    ["Better Scripts"] = 90,
    BizTalkServerApplicationSchema = 586,
    ...
    ["Butane Config"] = 655,
    ["CICS TS region tagging"] = 662,
    ["CICS TS resource import"] = 663,
    ["CICS TS resource model"] = 664,
    ["CICS TS resource overrides"] = 665,
    ["CMake Presets"] = 91,
    ...
    ["Common Catalog Schema"] = 141,
    ["Common types for all schemas"] = 1,
    Conjure = 99,
    ["Container Structure Test"] = 598,
    Containerlab = 624,
    ["Crowdsec collection Schema"] = 160,
    ["Crowdsec parser Schema"] = 161,
    ["Crowdsec scenario Schema"] = 162,
    ["DWP Exchange - catalogue entry"] = 202,
    ["DWP Exchange - gateway"] = 200,
    ["DWP Exchange - meta"] = 201,
    ["Dart build configuration"] = 168,
    ["Dart test config"] = 169,
    ["DashLord configuration"] = 170,
    ["Datadog Service Definition"] = 301,
    ["Datahub Ingestion Recipe Schema"] = 669,
    ...
    Devfile = 199,
    ["Discord Webhook"] = 179,
    ["Dolittle Artifacts"] = 183,
    ["Dolittle Bounded Context Configuration"] = 184,
    ["Dolittle Event Horizons Configuration"] = 185,
    ["Dolittle Resources Configuration"] = 186,
    ["Dolittle Server Configuration"] = 187,
    ["Dolittle Tenant Map Configuration"] = 189,
    ["Dolittle Tenants Configuration"] = 188,
    ["Dolittle Topology"] = 190,
    ...
    ["Drush site aliases"] = 195,
    ["Embrace Config Schema"] = 680,
    ["Error pages"] = 208,
    Esquio = 206,
    ["Estuary Flow Catalog Schema"] = 659,
    ["Expo SDK"] = 211,
    ["F-Droid Data metadata"] = 216,
    ["Facets - FSDL - Application"] = 214,
    ["FasterCI Configuration"] = 55,
    Firebase = 218,
    ["Fossa configuration file"] = 225,
    ["Fossa's fossa-deps file"] = 226,
    ["Foundry VTT - Base package Manifest"] = 220,
    ["Foundry VTT - Module Manifest"] = 221,
    ["Foundry VTT - System Data Template"] = 224,
    ["Foundry VTT - System Manifest"] = 222,
    ["Foundry VTT - World Manifest"] = 223,
    ["Foxx Manifest"] = 56,
    ["Freifunk.de Community API"] = 59,
    ["Frogbot Config"] = 60,
    ["GCP Blueprint Metadata"] = 231,
    ["GatewayCore API Gateway"] = 230,
    ["GeoJSON.json latest"] = 657,
    GherKing = 661,
    ["GitHub Action"] = 235,
    ["GitHub Discussion"] = 236,
    ["GitHub Funding"] = 237,
    ["GitHub Issue Template configuration"] = 239,
    ["GitHub Workflow"] = 240,
    ["GitHub Workflow Template Properties"] = 241,
    ["GitHub issue forms"] = 238,
    GitVersion = 234,
    ["Gitpod Configuration"] = 243,
    ["Global Privacy Control"] = 232,
    ["Google Cloud Workflows"] = 149,
    Goreleaser = 246,
    ["Goreleaser Pro"] = 247,
    ["Gradle Build Cache Node"] = 613,
    ["Gradle Enterprise"] = 612,
    ["Grafana 5.x Dashboard"] = 248,
    ["GraphQL Code Generator"] = 251,
    ["GraphQL Config"] = 250,
    ["GraphQL Mesh"] = 249,
    ["Grunt JSHint task"] = 255,
    ["Grunt Watch task"] = 256,
    ["Grunt base task"] = 257,
    ["Grunt clean task"] = 253,
    ["Grunt copy task"] = 252,
    ["Grunt cssmin task"] = 254,
    HEMTT = 583,
    Hadolint = 595,
    Hammerkit = 623,
    ["Hardware Sentry Configuration"] = 673,
    Hayson = 259,
    ["Haystack Pipeline"] = 260,
    ["Hazelcast 5 Configuration"] = 261,
    ["Helm Chart.lock"] = 121,
    ["Helm Chart.yaml"] = 120,
    ["Helm Unittest Test Suite"] = 122,
    Hugo = 651,
    ["IBM Zapp document"] = 266,
    ["IBM zCodeFormatSettings"] = 267,
    ["IMG Catapult PSP"] = 272,
    ["Istanbul Schema"] = 676,
    ["JDownloader2 crawler multi-rule schema"] = 282,
    ["JDownloader2 crawler single-rule schema"] = 281,
    ["JFrog File Spec"] = 283,
    ["JFrog Pipelines YML DSL"] = 682,
    ["JMeter DSL cli config schema"] = 284,
    JReleaser = 286,
    ["JSON Document Transform"] = 293,
    ["JSON Feed"] = 294,
    ["JSON Resume"] = 438,
    ["JSON Schema Draft 2020-12"] = 562,
    ["JSON Schema Draft 4"] = 559,
    ["JSON Schema Draft 7"] = 560,
    ["JSON Schema Draft 8"] = 561,
    ["JSON schema for CodeShip Pro services configuration files"] = 134,
    ["JSON schema for CodeShip Pro steps configuration files"] = 135,
    ["JSON schema for Codecov configuration files"] = 133,
    ["JSON-API"] = 292,
    ["JSON-e templates"] = 621,
    ["JSON-stat 2.0"] = 556,
    JSONPatch = 296,
    Jasmine = 277,
    Jekyll = 278,
    ["Jenkins X Pipelines"] = 279,
    ["Jenkins X Requirements"] = 280,
    ["Jovo Language Models"] = 285,
    ["KSP-AVC"] = 557,
    ["KSP-CKAN"] = 558,
    ["Karakum configuration file"] = 227,
    Kas = 299,
    ["Keycloak REST API"] = 689,
    ["Knative Functions - func.yaml"] = 228,
    ["KoDE/CI build.yaml"] = 678,
    ["Kong DBLess Schema"] = 679,
    KrakenD = 300,
    LOOBin = 316,
    Lefthook = 307,
    ["LinkML Metamodel"] = 314,
    Liquibase = 628,
    ["Liquibase Flow File"] = 629,
    ["Lively Properties"] = 315,
    Markdownlint = 632,
    ["Mason Registry"] = 634,
    ["MegaLinter configuration"] = 322,
    ["MegaLinter descriptor"] = 323,
    ["Meltano plugin discovery definition"] = 325,
    ["Meltano project definition"] = 324,
    ["Microsoft Band Web Tile"] = 326,
    ["Minecraft Data Pack Advancement"] = 328,
    ["Minecraft Data Pack Biome"] = 329,
    ["Minecraft Data Pack Configured Carver"] = 330,
    ["Minecraft Data Pack Damage Type"] = 331,
    ["Minecraft Data Pack Dimension"] = 333,
    ["Minecraft Data Pack Dimension Type"] = 332,
    ["Minecraft Data Pack Item Modifier"] = 334,
    ["Minecraft Data Pack Loot Table"] = 335,
    ["Minecraft Data Pack Metadata"] = 336,
    ["Minecraft Data Pack Predicate"] = 337,
    ["Minecraft Data Pack Recipe"] = 338,
    ["Minecraft Data Pack Tag"] = 339,
    ["Minecraft Data Pack Template Pool"] = 340,
    ["Minecraft Data Pack Trim Material"] = 345,
    ["Minecraft Data Pack Trim Pattern"] = 346,
    ["Minecraft Resource Pack Lang"] = 341,
    ["Minecraft Resource Pack Particle"] = 342,
    ["Minecraft Resource Pack Texture Mcmeta"] = 344,
    ["Minecraft Resourcepack Sounds"] = 343,
    ["MkDocs Configuration 1.0"] = 347,
    ["MongoDB Atlas Search Index Definition Schema"] = 677,
    ["Monika Configuration Schema"] = 675,
    ["Motif config"] = 579,
    ["NOX Framework (Service)"] = 361,
    ["Netin Diagnostic System Template"] = 638,
    ["Netlify config schema"] = 352,
    ["Nexus-as-Code schema"] = 353,
    ["Nightwatch.js"] = 354,
    ["ONe's service descriptor"] = 374,
    ["OSS Review Toolkit configuration"] = 381,
    ["OSS Review Toolkit curation"] = 382,
    ["OSS Review Toolkit package configuration"] = 383,
    ["OSS Review Toolkit repository configuration"] = 384,
    ["OSS Review Toolkit resolutions"] = 385,
    Opctl = 582,
    ["OpenRewrite Resource"] = 376,
    ["OpenWeather Current Weather API"] = 620,
    ["OpenWeather Road Risk API"] = 619,
    ["Ory Hydra configuration"] = 265,
    ["Ory Keto configuration"] = 302,
    ["Ory Kratos configuration"] = 380,
    ["Ory Oathkeeper configuration"] = 368,
    ["Outblocks App configuration"] = 378,
    ["Outblocks database table"] = 379,
    ["Outblocks project configuration"] = 377,
    Packer = 388,
    Pantsbuild = 696,
    ["Paper paper-plugin.yml"] = 389,
    ["Pipeline component"] = 630,
    ["PocketMine plugin.yml"] = 393,
    ["Postman collection"] = 398,
    Pterodactyl = 672,
    ["Pull Request Labeler"] = 419,
    Pulumi = 425,
    PyProject = 426,
    Pyright = 427,
    Qodana = 648,
    ["Quali Torque Blueprint Spec 2"] = 670,
    ["QueryFirst config file"] = 692,
    ["RKE Cluster Configuration JSON Schema"] = 627,
    ["RKE Cluster Configuration YAML Schema"] = 626,
    ["Rancher Fleet"] = 422,
    Ray = 594,
    ["Read the Docs"] = 424,
    ["Red-DiscordBot Cog"] = 428,
    ["Red-DiscordBot Cog Repo"] = 429,
    ["Red-DiscordBot Trivia"] = 430,
    Renovate = 439,
    ["Replit schema"] = 433,
    RoadRunner = 440,
    Ruff = 436,
    ["Rust Project"] = 437,
    ["Rust toolchain"] = 442,
    ["SIL Kit Participant Configuration"] = 473,
    ["SIL Kit Registry Configuration"] = 474,
    SWADL = 496,
    ["Safebox Config Schema"] = 683,
    ["Sapphire CLI Config"] = 445,
    ["SauceCTL Configuration"] = 635,
    ["Schema Catalog"] = 459,
    ["Scoop manifest"] = 464,
    ["Semantic Data Fabric (SDF) file"] = 465,
    ["Semgrep Rule"] = 467,
    ["Serenity Code Generator (Sergen)"] = 468,
    ["Serverless Framework Configuration"] = 642,
    ["Serverless Workflow Schema"] = 644,
    ["Settings.paf"] = 470,
    ["Shopware 6 Configuration"] = 645,
    ["Shopware CLI Extension Store Configuration"] = 646,
    ["Shopware CLI Project Store Configuration"] = 647,
    ["Sigrid scope configuration file"] = 472,
    ["Slack app manifest"] = 476,
    Solidarity = 479,
    ["Solution filters"] = 480,
    ["Source Maps v3"] = 481,
    Sourcery = 482,
    SpecIF = 483,
    ["Sponge Mixin configuration"] = 484,
    ["StackHawk Scanner Configuration"] = 641,
    Stale = 488,
    Starship = 489,
    ["Statamic Blueprint"] = 490,
    ["StrmPrivacy Data Connector"] = 687,
    ["StrmPrivacy Data Contract"] = 688,
    ["StrmPrivacy SimpleSchema"] = 685,
    ["StrmPrivacy Stream"] = 686,
    ["StrmPrivacy batch job configuration file"] = 684,
    ["Stryker Mutator"] = 493,
    ["StyleCop Analyzers Configuration"] = 494,
    ["Swagger API 2.0"] = 497,
    TSON = 522,
    ["Talisman configuration"] = 499,
    ["Taskfile YAML Schema"] = 622,
    Taurus = 500,
    ["TestEnvironment.json"] = 509,
    ["Tier.run pricing.json"] = 503,
    Tikibase = 504,
    ["Traefik v2"] = 512,
    ["Traefik v2 File Provider"] = 513,
    Turborepo = 510,
    Tye = 649,
    ["UET BuildConfig.json"] = 693,
    ["UI5 Manifest"] = 529,
    ["UTAM Page Object"] = 532,
    ["Ubuntu Server Autoinstall"] = 527,
    ["Uniswap Token List"] = 604,
    ["Unreal Engine Uplugin"] = 694,
    ["Unreal Engine Uproject"] = 695,
    Updatecli = 656,
    Uplift = 691,
    ["User Journey Map YAML Schema"] = 625,
    V2Ray = 660,
    ["VSCode Code Snippets"] = 137,
    ["VSIX CLI publishing"] = 545,
    ["Vela Pipeline Configuration"] = 535,
    Vercel = 136,
    ["Web App Manifest"] = 552,
    ["Web types"] = 555,
    WebExtensions = 551,
    ["Webman package recipe"] = 666,
    ["Windows Package Manager Installer Manifest"] = 601,
    ["Windows Package Manager Locale Manifest"] = 602,
    ["Windows Package Manager Singleton Manifest"] = 600,
    ["Woodpecker pipeline config"] = 637,
    ["Xstate Machine Schema"] = 654,
    ["Yippee-Ki-JSON configuration YML"] = 606,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 65,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 702,
    ["bashly-strings.yml"] = 703,
    ["bashly.yml"] = 701,
    ["batect.yml"] = 64,
    ["beau.yml"] = 615,
    ...
    ["chrome-extension-locales-messages.json"] = 144,
    ["chutzpah.json"] = 145,
    clangd = 127,
    ["cloud-init: cloud-config userdata JSON schema"] = 129,
    ["cloud-sdk-pipeline-config-schema"] = 147,
    ["cloudbuild.json"] = 148,
    cloudify = 128,
    codemagic = 130,
    ["coffeelint.json"] = 154,
    comet = 617,
    ["commands.json"] = 140,
    ["compile_commands.json"] = 139,
    ["compilerconfig.json"] = 138,
    ["completely.yml"] = 699,
    ["component-detection-manifest.json"] = 157,
    ["component.json"] = 156,
    ["composer.json"] = 155,
    ["config.yaml"] = 423,
    ...
    cspell = 165,
    ["cypress.json"] = 163,
    ["datalogic-scan2deploy-android"] = 171,
    ["datalogic-scan2deploy-ce"] = 172,
    ["dbt Project"] = 104,
    ["debugsettings.json"] = 173,
    ["dependabot-v2.json"] = 176,
    ["dependabot.json"] = 175,
    ["deployed-cli"] = 653,
    ["detekt.yml"] = 178,
    ["devcontainer.json"] = 132,
    devinit = 608,
    ["devspace.yaml"] = 674,
    djlint = 609,
    ["docfx.json"] = 182,
    ["docker-compose.yml"] = 607,
    ["docker-seq schema"] = 181,
    ["dockerd.json"] = 180,
    ["dotnet Release Index manifest"] = 191,
    ["dotnetcli.host.json"] = 192,
    ["dprint.json"] = 193,
    ["drone.json"] = 194,
    ["dss-2.0.0.json"] = 196,
    ["dstack configuration"] = 197,
    ["dvc.yaml"] = 198,
    ["ecosystem.json"] = 203,
    eksctl = 204,
    ["electron-builder configuration file."] = 209,
    ["epr-manifest.json"] = 207,
    ["evcc.yaml"] = 210,
    ["ezd schema"] = 212,
    ["fabric.mod.json"] = 215,
    ["first-timers-bot"] = 219,
    ...
    ["gitlab-ci"] = 242,
    ["global.json"] = 244,
    ["golangci-lint Configuration"] = 245,
    ["haxelib.json"] = 258,
    helmfile = 596,
    helmwave = 597,
    ["host-meta.json"] = 263,
    ...
    ["ide.host.json"] = 268,
    ["ifstate.conf"] = 269,
    ["imageoptimizer.json"] = 270,
    ["importmap.json"] = 273,
    ["ioBroker Configuration"] = 274,
    ["ioBroker JSON UI"] = 275,
    ["ioBroker Package manifest"] = 276,
    ["ize.toml"] = 690,
    ["jsconfig.json"] = 297,
    ["jscpd Configuration Schema"] = 671,
    jsdoc = 593,
    ["k3d.yaml"] = 298,
    ["kontinuous-values.yaml"] = 303,
    ...
    ["lgtm.yml"] = 310,
    ["libman.json"] = 311,
    ["license-report-config.json"] = 312,
    ["linkinator.config.json"] = 313,
    ["local.settings.json"] = 318,
    ["localazy.json"] = 319,
    ["lotus.yaml"] = 317,
    ["lsdlschema.json"] = 320,
    ["madness.yml"] = 700,
    ["markdown-lint-check"] = 633,
    mboats = 640,
    ["micro-settings.json"] = 705,
    ["mimetypes.json"] = 327,
    ["mirrord-schema"] = 576,
    ["mta.yaml"] = 577,
    ["mtad.yaml"] = 578,
    ["mycode.json"] = 350,
    ["napari plugin manifest"] = 351,
    neoload = 588,
    ["nest-cli"] = 357,
    ["ninjs (News in JSON) 1.3"] = 356,
    ["ninjs (News in JSON) 2.0"] = 355,
    ["nlu.json"] = 358,
    ["nodemon.json"] = 360,
    ["noodl.schema.json"] = 639,
    now = 584,
    ["npm-badges"] = 363,
    ["nswag.json"] = 366,
    ntangle = 367,
    ["nuclei-template.yaml"] = 364,
    ["nuget-project.json"] = 365,
    ["ocelot.json"] = 369,
    ["omnisharp.json"] = 370,
    ["openapi.json"] = 371,
    ["openfin.json"] = 375,
    ...
    ["ops.yaml"] = 373,
    ["package.json"] = 386,
    ["package.manifest"] = 387,
    ["pattern.json"] = 391,
    ["petstore-v1.0"] = 681,
    pgap_yaml_input_reader = 390,
    ["plagiarize-me.yaml"] = 395,
    ["plagiarize.yaml"] = 394,
    ["portman.json"] = 396,
    ["prettierrc.json"] = 403,
    ["prisma.yml"] = 404,
    ["project-1.0.0-beta3.json"] = 406,
    ["project-1.0.0-beta4.json"] = 407,
    ["project-1.0.0-beta5.json"] = 408,
    ["project-1.0.0-beta6.json"] = 409,
    ["project-1.0.0-beta8.json"] = 410,
    ["project-1.0.0-rc1.json"] = 411,
    ["project-1.0.0-rc2.json"] = 412,
    ["project.json"] = 405,
    ["prometheus.json"] = 413,
    ["prometheus.rules.json"] = 414,
    ["prometheus.rules.test.json"] = 415,
    ["proxies.json"] = 416,
    ["publiccode.yml"] = 417,
    ["pubspec.yaml"] = 418,
    ["pyrseas-0.8.json"] = 421,
    ["quilt.mod.json"] = 706,
    ["release drafter"] = 589,
    rtx = 435,
    rustfmt = 441,
    samt = 443,
    samtrc = 444,
    ["sarif-1.0.0.json"] = 446,
    ["sarif-2.0.0.json"] = 447,
    ["sarif-2.1.0"] = 457,
    ["sarif-2.1.0-rtm.2"] = 448,
    ["sarif-2.1.0-rtm.3"] = 450,
    ["sarif-2.1.0-rtm.4"] = 452,
    ["sarif-2.1.0-rtm.5"] = 454,
    ["sarif-2.1.0-rtm.6"] = 455,
    ["sarif-external-property-file-2.1.0"] = 458,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 449,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 451,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 453,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 456,
    ["schema.org - Action"] = 460,
    ["schema.org - ContactPoint"] = 461,
    ["schema.org - Place"] = 462,
    ["schema.org - Thing"] = 463,
    ["secrethub.yml"] = 708,
    ["semantic-release"] = 466,
    ["servicehub.config.json"] = 565,
    ["servicehub.service.json"] = 564,
    ["settings.job"] = 469,
    ["sfdx-hardis configuration"] = 471,
    ["size-limit configuration"] = 475,
    ["skaffold.yaml"] = 631,
    ["skyuxconfig.json"] = 477,
    snapcraft = 478,
    ["stripe-app-local.json"] = 492,
    ["stripe-app.json"] = 491,
    swcrc = 618,
    syntax = 710,
    ["task.json"] = 498,
    taskcat = 585,
    ["template.json"] = 501,
    ["templatsources.json"] = 502,
    ["theme.json"] = 505,
    ["tizen_workspace.json"] = 506,
    tldr = 507,
    tmLanguage = 508,
    tmuxinator = 573,
    ["transcend-pathfinder.yml"] = 515,
    ["transcend.yml"] = 514,
    ["trunk.yaml schema"] = 516,
    ["ts-force-config.json"] = 520,
    ["tsconfig.json"] = 517,
    ["tsd.json"] = 518,
    ["tsdrc.json"] = 519,
    ["tslint.json"] = 521,
    ...
    ["vega-lite.json"] = 534,
    ["vega.json"] = 533,
    ["venvironment-basic.yaml"] = 537,
    ["venvironment.yaml"] = 536,
    ["version.json"] = 538,
    ["vim-addon-info"] = 539,
    ["vs-2017.3.host.json"] = 541,
    ["vs-nesting.json"] = 542,
    ["vsls.json"] = 540,
    ["vss-extension.json"] = 546,
    ["vtesttree.yaml"] = 547,
    ["vtestunit.yaml"] = 548,
    ["webhint.io"] = 667,
    ["webjobpublishsettings.json"] = 554,
    ["webjobs-list.json"] = 553,
    ["xs-app.json"] = 581,
    ["xunit.runner.json"] = 563,
    yamllint = 605,
    zuul = 590,
    ["Žinoma"] = 599
  },
  schemas = { {
      ...
      url = "https://docs.gradle.com/enterprise/admin/schema/gradle-enterprise-config-schema-7.json",
      versions = {
