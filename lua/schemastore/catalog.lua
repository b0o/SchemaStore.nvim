...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 105,
    [".cryproj (generic)"] = 406,
    [".cryproj engine-5.2"] = 401,
    [".cryproj engine-5.3"] = 402,
    [".cryproj engine-5.4"] = 403,
    [".cryproj engine-5.5"] = 404,
    [".cryproj engine-dev"] = 405,
    [".csscomb.json"] = 107,
    [".csslintrc"] = 108,
    [".eslintrc"] = 143,
    [".esmrc.json"] = 136,
    ...
    [".mtaext"] = 412,
    [".nodehawkrc"] = 251,
    [".npmpackagejsonlintrc"] = 253,
    [".phraseapp.yml"] = 280,
    [".pmbot.yml"] = 273,
    [".postcssrc"] = 278,
    [".pre-commit-config.yml"] = 279,
    [".putout.json"] = 297,
    [".rehyperc"] = 302,
    [".remarkrc"] = 303,
    [".sprite files"] = 338,
    ...
    [".vsext"] = 382,
    [".yarnrc.yml"] = 444,
    ["<div>RIOTS' studio configuration"] = 385,
    ["API Builder"] = 441,
    ["AWS CloudFormation"] = 95,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 96,
    ...
    ["Azure Pipelines"] = 38,
    ["Azure Static Web Apps CLI configuration file"] = 340,
    ["Azure Static Web Apps configuration file"] = 339,
    ["Better Code Hub"] = 446,
    BizTalkServerApplicationSchema = 418,
    ...
    ["Citation File Format"] = 97,
    CityJSON = 70,
    ["Code Climate"] = 75,
    ["Common types for all schemas"] = 1,
    ["Container Structure Test"] = 429,
    Containerlab = 454,
    ["Dart build configuration"] = 109,
    ["Dart test config"] = 110,
    ["Deployer Recipe"] = 116,
    Devfile = 134,
    ["Discord Webhook"] = 118,
    ["Dolittle Artifacts"] = 120,
    ["Dolittle Bounded Context Configuration"] = 121,
    ["Dolittle Event Horizons Configuration"] = 122,
    ["Dolittle Resources Configuration"] = 123,
    ["Dolittle Server Configuration"] = 124,
    ["Dolittle Tenant Map Configuration"] = 126,
    ["Dolittle Tenants Configuration"] = 125,
    ["Dolittle Topology"] = 127,
    ["Drush site aliases"] = 131,
    ["Error pages"] = 139,
    Esquio = 137,
    ["Expo SDK"] = 142,
    ["F-Droid Data metadata"] = 146,
    ["Facets - FSDL - Application"] = 144,
    ["Fossa configuration file"] = 151,
    ["Fossa's fossa-deps file"] = 152,
    ["Foundry VTT - Manifest"] = 149,
    ["Foundry VTT - Template"] = 150,
    ["Foxx Manifest"] = 39,
    ["GatewayCore API Gateway"] = 155,
    ["GitHub Action"] = 159,
    ["GitHub Funding"] = 160,
    ["GitHub Issue Template configuration"] = 162,
    ["GitHub Workflow"] = 163,
    ["GitHub Workflow Template Properties"] = 164,
    ["GitHub issue forms"] = 161,
    GitVersion = 158,
    ["Gitpod Configuration"] = 166,
    ["Global Privacy Control"] = 156,
    ["Google Cloud Workflows"] = 94,
    Goreleaser = 169,
    ["Goreleaser Pro"] = 170,
    ["Gradle Build Cache Node"] = 443,
    ["Gradle Enterprise"] = 442,
    ["Grafana 5.x Dashboard"] = 171,
    ["GraphQL Code Generator"] = 174,
    ["GraphQL Config"] = 173,
    ["GraphQL Mesh"] = 172,
    ["Grunt JSHint task"] = 178,
    ["Grunt Watch task"] = 179,
    ["Grunt base task"] = 180,
    ["Grunt clean task"] = 176,
    ["Grunt copy task"] = 175,
    ["Grunt cssmin task"] = 177,
    HEMTT = 415,
    Hadolint = 427,
    ["Hammerkit YAML Schema"] = 453,
    Hayson = 182,
    ["Haystack Pipeline"] = 183,
    ["Hazelcast 5 Configuration"] = 184,
    ["Helm Chart.lock"] = 73,
    ["Helm Chart.yaml"] = 72,
    Hugo = 476,
    ["JFrog File Spec"] = 197,
    ["JSON Document Transform"] = 205,
    ["JSON Feed"] = 206,
    ["JSON Resume"] = 305,
    ["JSON Schema Draft 2020-12"] = 397,
    ["JSON Schema Draft 4"] = 394,
    ["JSON Schema Draft 7"] = 395,
    ["JSON Schema Draft 8"] = 396,
    ...
    ["JSON-API"] = 204,
    ["JSON-e templates"] = 451,
    ["JSON-stat 2.0"] = 391,
    JSONPatch = 208,
    Jekyll = 194,
    ["Jenkins X Pipelines"] = 195,
    ["Jenkins X Requirements"] = 196,
    ["Jovo Language Models"] = 198,
    ["KSP-AVC"] = 392,
    ["KSP-CKAN"] = 393,
    Liquibase = 458,
    ["MegaLinter configuration"] = 223,
    ["MegaLinter descriptor"] = 224,
    ["Meltano plugin discovery definition"] = 226,
    ["Meltano project definition"] = 225,
    ["Microsoft Band Web Tile"] = 227,
    ["Minecraft Data Pack Advancement"] = 229,
    ["Minecraft Data Pack Biome"] = 230,
    ["Minecraft Data Pack Configured Carver"] = 231,
    ["Minecraft Data Pack Dimension"] = 233,
    ["Minecraft Data Pack Dimension Type"] = 232,
    ["Minecraft Data Pack Item Modifier"] = 234,
    ["Minecraft Data Pack Loot Table"] = 235,
    ["Minecraft Data Pack Metadata"] = 236,
    ["Minecraft Data Pack Predicate"] = 237,
    ["Minecraft Data Pack Recipe"] = 238,
    ["Minecraft Data Pack Template Pool"] = 239,
    ["Minecraft Resourcepack Sounds"] = 240,
    ["Netin Diagnostic System Template"] = 465,
    ["Netlify config schema"] = 245,
    ["Nightwatch.js"] = 246,
    ["OSS Review Toolkit repository configuration"] = 267,
    Opctl = 414,
    ["OpenWeather Current Weather API"] = 450,
    ["OpenWeather Road Risk API"] = 449,
    ["Ory Hydra configuration"] = 188,
    ["Ory Keto configuration"] = 212,
    ["Ory Kratos configuration"] = 266,
    ["Ory Oathkeeper configuration"] = 258,
    ["Outblocks App configuration"] = 264,
    ["Outblocks database table"] = 265,
    ["Outblocks project configuration"] = 263,
    Packer = 270,
    ["Pipeline component"] = 459,
    ["PocketMine plugin.yml"] = 274,
    ["Pull Request Labeler"] = 296,
    Qodana = 473,
    ["RKE Cluster Configuration JSON Schema"] = 457,
    ["RKE Cluster Configuration YAML Schema"] = 456,
    Ray = 426,
    ["Read the Docs"] = 299,
    ["Red-DiscordBot Cog"] = 300,
    ["Red-DiscordBot Cog Repo"] = 301,
    Renovate = 306,
    RoadRunner = 307,
    SWADL = 349,
    ["Sapphire CLI Config"] = 308,
    ["SauceCTL Configuration"] = 462,
    ["Schema Catalog"] = 321,
    ["Scoop manifest"] = 326,
    ["Semgrep Rule"] = 327,
    ["Serverless Framework Configuration"] = 469,
    ["Settings.paf"] = 329,
    ["Shopware 6 Configuration"] = 470,
    ["Shopware CLI Extension Store Configuration"] = 471,
    ["Shopware CLI Project Store Configuration"] = 472,
    Solidarity = 334,
    ["Source Maps v3"] = 335,
    SpecIF = 336,
    ["Sponge Mixin configuration"] = 337,
    ["StackHawk Scanner Configuration"] = 468,
    ["StackHead CLI config"] = 341,
    ["StackHead module configuration"] = 342,
    ["StackHead project definition"] = 343,
    Stale = 344,
    ["Statamic Blueprint"] = 345,
    ["Stryker Mutator"] = 346,
    ["StyleCop Analyzers Configuration"] = 347,
    ["Swagger API 2.0"] = 350,
    ["Taskfile YAML Schema"] = 452,
    Taurus = 351,
    ["TestEnvironment.json"] = 356,
    ["Traefik v2"] = 358,
    ["Traefik v2 File Provider"] = 359,
    Tye = 474,
    ["UI5 Manifest"] = 371,
    ["Ubuntu Server Autoinstall"] = 369,
    ["Uniswap Token List"] = 435,
    ["User Journey Map YAML Schema"] = 455,
    ["VSCode Code Snippets"] = 84,
    ["VSIX CLI publishing"] = 383,
    ["Vela Pipeline Configuration"] = 375,
    Vercel = 83,
    ["Web App Manifest"] = 387,
    ["Web types"] = 390,
    WebExtensions = 386,
    ["Windows Package Manager Installer Manifest"] = 432,
    ["Windows Package Manager Locale Manifest"] = 433,
    ["Windows Package Manager Singleton Manifest"] = 431,
    ["Woodpecker pipeline config"] = 464,
    ["Yippee-Ki-JSON configuration YML"] = 437,
    ["angular.json"] = 8,
    ...
    cspell = 106,
    ["cypress.json"] = 104,
    ["datalogic-scan2deploy-android"] = 111,
    ["datalogic-scan2deploy-ce"] = 112,
    ["debugsettings.json"] = 113,
    ["dependabot-v2.json"] = 115,
    ["dependabot.json"] = 114,
    ["detekt.yml"] = 117,
    devinit = 439,
    ["docfx.json"] = 119,
    ["docker-compose.yml"] = 438,
    ["dotnet Release Index manifest"] = 128,
    ["dotnetcli.host.json"] = 129,
    ["drone.json"] = 130,
    ["dss-2.0.0.json"] = 132,
    ["dvc.yaml"] = 133,
    ["ecosystem.json"] = 135,
    ["electron-builder configuration file."] = 140,
    ["epr-manifest.json"] = 138,
    ["evcc.yaml"] = 141,
    ["fabric.mod.json"] = 145,
    ["first-timers-bot"] = 148,
    fulibWorkflows = 463,
    ["func.yaml"] = 153,
    ["function.json"] = 154,
    ["geojson.json"] = 157,
    ["gitlab-ci"] = 165,
    ["global.json"] = 167,
    ["golangci-lint Configuration"] = 168,
    ["haxelib.json"] = 181,
    helmfile = 428,
    ["host-meta.json"] = 186,
    ["host.json"] = 185,
    ...
    httpmockrc = 419,
    huskyrc = 408,
    ["imageoptimizer.json"] = 189,
    ["importmap.json"] = 191,
    ["ioBroker JSON UI"] = 192,
    ["ioBroker Package manifest"] = 193,
    ["jsconfig.json"] = 209,
    jsdoc = 425,
    ["k3d.yaml"] = 210,
    ["kustomization.yaml"] = 213,
    ["label-commenter-config.yml"] = 214,
    ["launchsettings.json"] = 215,
    ["lerna.json"] = 216,
    ["lgtm.yml"] = 217,
    ["libman.json"] = 218,
    ["license-report-config.json"] = 219,
    ["local.settings.json"] = 220,
    ["localazy.json"] = 221,
    ["lsdlschema.json"] = 222,
    ["markdownlint.json"] = 461,
    mboats = 467,
    ["mimetypes.json"] = 228,
    ["mta.yaml"] = 410,
    ["mtad.yaml"] = 411,
    ["mycode.json"] = 243,
    ["napari plugin manifest"] = 244,
    neoload = 420,
    ["nest-cli"] = 249,
    ["ninjs (News in JSON) 1.3"] = 248,
    ["ninjs (News in JSON) 2.0"] = 247,
    ["nlu.json"] = 250,
    ["nodemon.json"] = 252,
    ["noodl.schema.json"] = 466,
    now = 416,
    ["nswag.json"] = 256,
    ntangle = 257,
    ["nuclei-template.yaml"] = 254,
    ["nuget-project.json"] = 255,
    ["ocelot.json"] = 259,
    ["omnisharp.json"] = 260,
    ["openapi.json"] = 261,
    ["openfin.json"] = 262,
    ["package.json"] = 268,
    ["package.manifest"] = 269,
    ["pattern.json"] = 272,
    pgap_yaml_input_reader = 271,
    ["plagiarize-me.yaml"] = 276,
    ["plagiarize.yaml"] = 275,
    ["portman.json"] = 277,
    ["prettierrc.json"] = 281,
    ["prisma.yml"] = 282,
    ["project-1.0.0-beta3.json"] = 284,
    ["project-1.0.0-beta4.json"] = 285,
    ["project-1.0.0-beta5.json"] = 286,
    ["project-1.0.0-beta6.json"] = 287,
    ["project-1.0.0-beta8.json"] = 288,
    ["project-1.0.0-rc1.json"] = 289,
    ["project-1.0.0-rc2.json"] = 290,
    ["project.json"] = 283,
    ["prometheus.json"] = 291,
    ["prometheus.rules.json"] = 292,
    ["proxies.json"] = 293,
    ["publiccode.yml"] = 294,
    ["pubspec.yaml"] = 295,
    ["pyrseas-0.8.json"] = 298,
    ["release drafter"] = 421,
    ["sarif-1.0.0.json"] = 309,
    ["sarif-2.0.0.json"] = 310,
    ["sarif-2.1.0"] = 319,
    ["sarif-2.1.0-rtm.2"] = 311,
    ["sarif-2.1.0-rtm.3"] = 313,
    ["sarif-2.1.0-rtm.4"] = 315,
    ["sarif-2.1.0-rtm.5"] = 317,
    ["sarif-external-property-file-2.1.0"] = 320,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 312,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 314,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 316,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 318,
    ["schema.org - Action"] = 322,
    ["schema.org - ContactPoint"] = 323,
    ["schema.org - Place"] = 324,
    ["schema.org - Thing"] = 325,
    ["service.datadog.yaml"] = 211,
    ["servicehub.config.json"] = 400,
    ["servicehub.service.json"] = 399,
    ["settings.job"] = 328,
    ["sfdx-hardis configuration"] = 330,
    ["size-limit configuration"] = 331,
    ["skaffold.yaml"] = 460,
    ["skyuxconfig.json"] = 332,
    snapcraft = 333,
    swcrc = 448,
    taskcat = 417,
    ["template.json"] = 352,
    ["templatsources.json"] = 353,
    ["theme.json"] = 354,
    tmLanguage = 355,
    ["trunk.yaml schema"] = 360,
    ["ts-force-config.json"] = 364,
    ["tsconfig.json"] = 361,
    ["tsd.json"] = 362,
    ["tsdrc.json"] = 363,
    ["tslint.json"] = 365,
    ...
    ["version.json"] = 376,
    ["vim-addon-info"] = 377,
    ["vs-2017.3.host.json"] = 379,
    ["vs-nesting.json"] = 380,
    ["vsls.json"] = 378,
    ["vss-extension.json"] = 384,
    ["webjobpublishsettings.json"] = 389,
    ["webjobs-list.json"] = 388,
    ["xs-app.json"] = 413,
    ["xunit.runner.json"] = 398,
    yamllint = 436,
    zuul = 422,
    ["Žinoma"] = 430
  },
