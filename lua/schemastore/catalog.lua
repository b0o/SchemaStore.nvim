...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 938,
    [".nodehawkrc"] = 581,
    [".npmpackagejsonlintrc"] = 585,
    [".omletrc"] = 1117,
    [".phrase.yml"] = 658,
    [".phraseapp.yml"] = 659,
    [".pmbot.yml"] = 644,
    [".postcssrc"] = 653,
    [".powerpages-web-template-manifest"] = 655,
    [".pre-commit-config.yml"] = 656,
    [".pre-commit-hooks.yml"] = 657,
    [".putout.json"] = 692,
    [".rehyperc"] = 717,
    [".remarkrc"] = 721,
    [".sprite files"] = 813,
    ...
    AIConfig = 34,
    ["AMX Muse Program Descriptor"] = 1165,
    ["API Builder"] = 973,
    ["AVA Configuration"] = 1036,
    ["AWS AppConfig Feature Flags-v1"] = 68,
    ["AWS CDK cdk.json"] = 260,
    ["AWS CloudFormation"] = 261,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 262,
    ["AWS Copilot Manifest"] = 1204,
    ["AWS SAM CLI Samconfig"] = 263,
    ["Adobe UXP Manifest"] = 1099,
    ["Aerleon Network & Service Definitions"] = 20,
    ["Aerleon Policy"] = 21,
    ["AgentCore CLI"] = 1244,
    Aider = 1194,
    Air = 23,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1215,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1214,
    ["Airlock Microgateway"] = 35,
    ["Alacritty Configuration"] = 1008,
    ["All Contributors configuration file"] = 1062,
    ["Ansible Argument Specs"] = 399,
    ["Ansible Collection Galaxy"] = 406,
    ["Ansible Execution Environment"] = 396,
    ["Ansible Inventory"] = 405,
    ["Ansible Meta"] = 397,
    ["Ansible Meta Runtime"] = 398,
    ["Ansible Navigator Configuration"] = 408,
    ["Ansible Playbook"] = 403,
    ["Ansible Requirements"] = 400,
    ["Ansible Rulebook"] = 404,
    ["Ansible Tasks File"] = 402,
    ["Ansible Vars File"] = 401,
    ["Ansible-lint Configuration"] = 407,
    Any = 1127,
    ...
    ["Application list for a WinUtil"] = 1144,
    ArchitectFX = 1149,
    ["Argo CD"] = 54,
    ["Argo Events"] = 55,
    ["Argo Workflows"] = 56,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1213,
    ["Azure IoT Operations connector metadata"] = 1210,
    ...
    ["Azure Pipelines"] = 112,
    ["Azure Static Web Apps CLI configuration file"] = 817,
    ["Azure Static Web Apps configuration file"] = 816,
    BMML = 1232,
    ["BOSH CPI Config"] = 137,
    ["BOSH Deploy Config"] = 138,
    ["BX CI"] = 157,
    ["Bacon config"] = 5,
    ["Barba-CV"] = 83,
    ["Bashly (bashly.yml)"] = 1066,
    ["Bashly Settings (bashly-settings.yml)"] = 1067,
    Bento = 1231,
    ["Better Code Hub"] = 978,
    ["Better Scripts"] = 158,
    Bigconfig = 130,
    ["Biome Formatter Config"] = 84,
    ["Bitmovin Encoding Template"] = 1158,
    BizTalkServerApplicationSchema = 945,
    Bleep = 159,
    ["Block Protocol Metadata"] = 156,
    ["Bluebricks blueprint config"] = 1237,
    ["Boyka Framework"] = 139,
    Briefcase = 951,
    ["Build Info"] = 147,
    Buildkite = 149,
    ["Bukkit plugin.yml"] = 148,
    ["BungeeCord plugin.yml"] = 154,
    ["Butane Config"] = 1021,
    C4InterFlow = 1173,
    ["CDK Environment Manager, concrete environment configuration"] = 1197,
    ["CDK Environment Manager, concrete environments definition"] = 1196,
    ["CDK Environment Manager, environment definition"] = 1195,
    ["CGS Card Game Specification (cgs.json)"] = 1104,
    ["CICS TS region tagging"] = 1030,
    ["CICS TS resource import"] = 1031,
    ["CICS TS resource model"] = 1032,
    ["CICS TS resource overrides"] = 1033,
    ["CMake Presets"] = 160,
    ["CNC Codes"] = 182,
    ["CRS WAF test file"] = 1134,
    ["CRS WAF test platform overrides file"] = 1135,
    ["CSS Comb (.csscomb.json)"] = 288,
    ["CSS Lint (.csslintrc)"] = 289,
    ["CSpell (cspell.json)"] = 287,
    ["CVE Record Format"] = 191,
    CWL = 1110,
    ["Cache Warmup config"] = 161,
    ["Calqulus pipeline"] = 162,
    ["Camel YAML DSL"] = 163,
    ["Cannon TOML"] = 164,
    Carafe = 165,
    ["Cargo Make"] = 167,
    ["Cargo Manifest"] = 166,
    ["Catalog Info Backstage"] = 168,
    ["Chamaleon environment"] = 1162,
    ["Chamaleon properties"] = 1163,
    ["Chamaleon template"] = 1161,
    Changepacks = 1224,
    Changesets = 272,
    Changie = 169,
    Charmcraft = 170,
    Cheatsheets = 1018,
    ["ChordPro Configuration"] = 171,
    ["Chrome Extension"] = 253,
    ["Chromia Model"] = 172,
    ["Chromia Seeder Module Config"] = 174,
    ["Chromia Seeder Root Config"] = 173,
    ["Cinnamon Spice info.json"] = 92,
    ["CircleCI config.yml"] = 228,
    ["Citation File Format"] = 274,
    ["Citrus test case"] = 176,
    CityJSON = 177,
    ["Claude Code Keybindings"] = 189,
    ["Claude Code Settings"] = 190,
    ["Clawject config"] = 188,
    ["Cloud Foundry Application Manifest"] = 1116,
    ["Cloud Run Spec v1"] = 1139,
    ["Cloud.gov Workshop Configuration"] = 93,
    ["CloudCannon Configuration"] = 98,
    ["CloudCannon Configuration (Collection Structures)"] = 107,
    ["CloudCannon Configuration (Collections)"] = 106,
    ["CloudCannon Configuration (Editables)"] = 105,
    ["CloudCannon Configuration (Inputs)"] = 100,
    ["CloudCannon Configuration (Snippets Definitions)"] = 104,
    ["CloudCannon Configuration (Snippets Imports)"] = 103,
    ["CloudCannon Configuration (Snippets)"] = 102,
    ["CloudCannon Configuration (Structure Value)"] = 101,
    ["CloudCannon Configuration (Structures)"] = 99,
    ["CloudEvents specification"] = 178,
    ["Code Climate"] = 229,
    CodeCV = 96,
    CodeRabbit = 95,
    ["CodeShip Pro services configuration files"] = 242,
    ["CodeShip Pro steps configuration files"] = 243,
    ["Codecov configuration files"] = 241,
    Codex = 237,
    CodifyCLI = 97,
    Codux = 239,
    ["Cog config file"] = 183,
    ["Commandbox Box.json"] = 184,
    ["Commandbox Server.json"] = 185,
    ["Common Catalog Data"] = 251,
    ["Common Package Specification"] = 186,
    Concord = 1133,
    ["Configu .cfgu files"] = 1121,
    ["Configu .configu file"] = 1122,
    Conjure = 181,
    ["Container Structure Test"] = 959,
    Containerlab = 987,
    ["Contextive Glossary"] = 1189,
    Convex = 180,
    ["Crowdsec collection config"] = 282,
    ["Crowdsec parser config"] = 283,
    ["Crowdsec scenario config"] = 284,
    ["CumulusCI Config"] = 187,
    ["Cursor Agent Environment"] = 1242,
    ["Custom Machinery Machine"] = 1105,
    ["Custom Machinery Recipe"] = 1106,
    ["Cycle Stack File"] = 192,
    CycloneDX = 193,
    ["DWP Exchange - catalogue entry"] = 333,
    ["DWP Exchange - gateway"] = 331,
    ["DWP Exchange - meta"] = 332,
    ["Dart Build Config (dart-build.json)"] = 290,
    ["Dart Test Config (dart-test.json)"] = 291,
    ["DashLord Configuration"] = 292,
    ["Data Contract Specification"] = 293,
    ["Data Product Specification"] = 294,
    ["DataYoga Connections"] = 194,
    ["DataYoga Job"] = 195,
    ["Databricks Asset Bundles"] = 1083,
    ["Datadog Continuous Testing"] = 497,
    ["Datadog Service Definition"] = 498,
    ["Datadog Software Catalog"] = 499,
    ["Datahub Ingestion Recipe"] = 1037,
    ["Debian Upstream Metadata file"] = 202,
    ["Deck config"] = 203,
    ["DeepMatch deeplinks spec"] = 204,
    ["Dein Config"] = 205,
    ["Deno Config (deno.json)"] = 300,
    ["Dependency cruiser"] = 206,
    ["DeployStack Configuration"] = 207,
    ["Deployah Configuration"] = 1212,
    ["Deployer Recipe"] = 303,
    ["Deta Spacefile"] = 208,
    ["Detekt Config (detekt.yml)"] = 304,
    ["Devbox Config"] = 209,
    ["Devbox Plugin"] = 210,
    Devfile = 330,
    Devup = 1225,
    DipDup = 1136,
    ["Discord Webhook"] = 305,
    ["DocFx Config (docfx.json)"] = 310,
    ["Docker Desktop extension metadata"] = 307,
    ["Docs MCP Manifest"] = 311,
    Dofigen = 312,
    ["Dolittle Artifacts"] = 313,
    ["Dolittle Bounded Context Configuration"] = 314,
    ["Dolittle Event Horizons Configuration"] = 315,
    ["Dolittle Resources Configuration"] = 316,
    ["Dolittle Server Configuration"] = 317,
    ["Dolittle Tenant Map Configuration"] = 319,
    ["Dolittle Tenants Configuration"] = 318,
    ["Dolittle Topology"] = 320,
    ["DonateCaseBetterCasino menu"] = 1166,
    ["Drupal Breakpoints"] = 211,
    ["Drupal Config"] = 223,
    ["Drupal Info"] = 212,
    ["Drupal Layouts"] = 213,
    ["Drupal Libraries"] = 214,
    ["Drupal Links Action"] = 215,
    ["Drupal Links Contextual"] = 216,
    ["Drupal Links Menu"] = 217,
    ["Drupal Links Task"] = 218,
    ["Drupal Migration"] = 219,
    ["Drupal Permissions"] = 220,
    ["Drupal Recipe"] = 221,
    ["Drupal Routing"] = 222,
    ["Drupal Services"] = 224,
    ["Drush site aliases"] = 326,
    ["Dynamic Bash Aliases (.aliases)"] = 1074,
    ["EAS config"] = 351,
    ["ECA - Editor Code Assistant"] = 335,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1063,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1209,
    ["EasyVCR .NET"] = 352,
    ["Eidolon Resource"] = 1150,
    ["Elgato Stream Deck"] = 337,
    Elm = 1138,
    ["Embrace Config"] = 1049,
    Endurica = 1087,
    ["Enterprise Contract Policy Spec"] = 338,
    ["Erda Pipeline"] = 1112,
    ["Erda Runtime"] = 1113,
    ["Espanso config.yml"] = 1235,
    ["Espanso match.yml"] = 1234,
    Esquio = 340,
    ["Estuary Flow Catalog"] = 1027,
    ["Ethereum ERC1155"] = 1246,
    ["Ethereum ERC721"] = 1245,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 344,
    ["EveryVoice TTS Toolkit Data Configuration"] = 345,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 349,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 348,
    ["EveryVoice TTS Toolkit Text Configuration"] = 346,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 347,
    ["Evolving Resolutive Process notation"] = 1211,
    ["Expo SDK"] = 350,
    ["F-Droid Data metadata"] = 356,
    ["FasterCI Configuration"] = 113,
    FiQuS = 360,
    Firebase = 358,
    ["Flatpak Builder Manifest"] = 361,
    ["FlexGet Config"] = 362,
    ["Flow.json Configurations"] = 1109,
    ["Fossa configuration file"] = 369,
    ["Fossa's fossa-deps file"] = 370,
    ["Foundry VTT - Base package Manifest"] = 364,
    ["Foundry VTT - Module Manifest"] = 365,
    ["Foundry VTT - System Data Template"] = 368,
    ["Foundry VTT - System Manifest"] = 366,
    ["Foundry VTT - World Manifest"] = 367,
    ["Foxx Manifest"] = 114,
    ["Freifunk.de Community API"] = 117,
    ["Frogbot Config"] = 118,
    ["G2P Mapping Configuration"] = 376,
    ["GCP Blueprint Metadata"] = 379,
    Gaspar = 377,
    ["GatewayCore API Gateway"] = 378,
    ["Gemini CLI settings"] = 380,
    ["GeoJSON.json latest"] = 1025,
    GherKing = 1029,
    ["GitHub Action"] = 385,
    ["GitHub Actions typing"] = 1146,
    ["GitHub Discussion"] = 386,
    ["GitHub Funding"] = 387,
    ["GitHub Issue Template configuration"] = 388,
    ["GitHub Issue Template forms"] = 389,
    ["GitHub Workflow"] = 390,
    ["GitHub Workflow Template Properties"] = 391,
    ["GitHub automatically generated release notes configuration"] = 392,
    ["GitLab Agent for Kubernetes configuration"] = 1101,
    GitVersion = 382,
    ["Gitea Issue Template configuration"] = 383,
    ["Gitea Issue Template forms"] = 384,
    ["Gitpod Automations"] = 394,
    ["Gitpod Configuration"] = 395,
    ["GlazeWM settings"] = 1103,
    ["Global Privacy Control"] = 381,
    Goblet = 1082,
    ["Golangci-lint Configuration"] = 410,
    ["Golangci-lint Custom Plugins Configuration"] = 411,
    ["Google Chrome Related Website Sets"] = 359,
    ["Google Cloud Workflows"] = 259,
    ["Google Digital Assetlinks"] = 1190,
    Goreleaser = 413,
    ["Goreleaser Pro"] = 414,
    Goss = 415,
    ["Gradle Build Cache Node"] = 976,
    ["Gradle Enterprise"] = 975,
    ["Grafana 5.x Dashboard"] = 416,
    ["GraphQL Code Generator"] = 421,
    ["GraphQL Config"] = 420,
    ["GraphQL Mesh"] = 419,
    ["GroovyLint configuration"] = 422,
    ["Grunt JSHint task"] = 426,
    ["Grunt Watch task"] = 427,
    ["Grunt base task"] = 428,
    ["Grunt clean task"] = 424,
    ["Grunt copy task"] = 423,
    ["Grunt cssmin task"] = 425,
    HEMTT = 941,
    Hadolint = 955,
    Hammerkit = 986,
    ["Hardware Sentry Configuration"] = 1041,
    ["Hashgraph Online Skill Manifest"] = 1,
    ["HashiCorp Vault"] = 429,
    Hatch = 956,
    Hayson = 431,
    ["Haystack Pipeline"] = 432,
    ["Hazelcast 5 Configuration"] = 433,
    ["Hecate Input Schema"] = 1201,
    ["Helm Chart.lock"] = 226,
    ["Helm Chart.yaml"] = 225,
    ["Helm Unittest Test Suite"] = 227,
    ["Home Assistant Integration Manifest"] = 434,
    ["Homer dashboard configuration"] = 435,
    Hugo = 1017,
    ["Hugo Theme"] = 1016,
    ["Hulak Configuration"] = 442,
    ["Hyperfoil benchmark configuration"] = 441,
    ["IBM Zapp document"] = 443,
    ["IBM zCodeFormatSettings"] = 444,
    ["IMG Catapult PSP"] = 449,
    ["IVMS101 by CODE Protocol"] = 1102,
    Infrahub = 451,
    Istanbul = 1045,
    ["JDownloader2 crawler multi-rules"] = 464,
    ["JDownloader2 crawler single-rules"] = 463,
    ["JFrog Applications Config"] = 465,
    ["JFrog File Spec"] = 466,
    ["JFrog Pipelines YML DSL"] = 1051,
    ["JMeter DSL cli config"] = 467,
    JReleaser = 470,
    ["JSON Document Transform"] = 478,
    ["JSON Feed"] = 479,
    ["JSON Resume"] = 727,
    ["JSON Schema Draft 2020-12"] = 923,
    ["JSON Schema Draft 4"] = 920,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1084,
    ["JSON Schema Draft 7"] = 921,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1085,
    ["JSON Schema Draft 8 (2019-09)"] = 922,
    ["JSON-API"] = 477,
    ["JSON-e templates"] = 983,
    ["JSON-stat 2.0"] = 916,
    JSONPatch = 481,
    ["JSR Package Config (jsr.json)"] = 471,
    Jarl = 1217,
    Jasmine = 458,
    Jekyll = 459,
    ["Jenkins X Pipelines"] = 460,
    ["Jenkins X Requirements"] = 461,
    Jest = 462,
    Jocker = 468,
    ["Jovo Language Models"] = 469,
    ["Jujutsu (jj) VCS config"] = 1203,
    ["KIMMDY config file"] = 492,
    ["KODE/CI build.yaml"] = 1047,
    ["KSP-AVC"] = 917,
    ["KSP-CKAN"] = 918,
    ["KSP-NetKAN"] = 919,
    KSY = 1114,
    KSail = 374,
    ["KYA Manifest"] = 1115,
    ["Karakum configuration file"] = 371,
    Kas = 484,
    ["Kestra flow file"] = 493,
    ["Keycloak REST API"] = 1054,
    ["Knative Functions - func.yaml"] = 372,
    Knip = 373,
    ["Kometa (nightly) config file"] = 495,
    ["Kometa config file"] = 494,
    ["Kong DBLess config"] = 1048,
    KrakenD = 496,
    ["Kubri Configuration"] = 503,
    LOOBin = 518,
    ["Lake configuration file"] = 1206,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 264,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 265,
    ["Landing Zone Accelerator on AWS - Global Config"] = 266,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 267,
    ["Landing Zone Accelerator on AWS - Network Config"] = 268,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 269,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 270,
    ["Landing Zone Accelerator on AWS - Security Config"] = 271,
    ["Lando (landofile)"] = 108,
    ["LangGraph Platform configuration"] = 1126,
    ["Language configuration"] = 1125,
    Lefthook = 507,
    ["Liferay client-extension.yaml"] = 514,
    ["LinkML Metamodel"] = 516,
    Liquibase = 992,
    ["Liquibase Flow File"] = 993,
    ["Lively Properties"] = 517,
    ["Lobe AI Agent"] = 110,
    Loki = 111,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 560,
    ["MS2Rescore Configuration"] = 564,
    ["Madness (madness.yml)"] = 1065,
    ["Mado configuration"] = 524,
    ["Maestro Flow"] = 525,
    ["Mail Servers Configuration"] = 1238,
    ["MapEHR Mapping"] = 526,
    Markdownlint = 996,
    ["Mason Registry"] = 999,
    ["MegaLinter Custom Flavor"] = 529,
    ["MegaLinter configuration"] = 528,
    ["MegaLinter descriptor"] = 530,
    Melange = 1092,
    ["Meltano project definition"] = 531,
    ["Mergify Configuration"] = 565,
    ["Metadata for a Bazel module"] = 532,
    ["Metadata for a Cinnamon spice"] = 1142,
    ["Metatype Configuration"] = 533,
    ["MetricsHub Configuration"] = 534,
    ["MetricsHub Connector Configuration"] = 535,
    ["Micro Editor Syntax"] = 1075,
    ["Microsoft Band Web Tile"] = 536,
    ["Microsoft RulesEngine workflow rules"] = 1130,
    ["Microsoft RulesEngine workflow rules list"] = 1131,
    ["Minecraft Custom Main Menu Mod"] = 1093,
    ["Minecraft Data Pack Advancement"] = 538,
    ["Minecraft Data Pack Biome"] = 539,
    ["Minecraft Data Pack Configured Carver"] = 540,
    ["Minecraft Data Pack Damage Type"] = 541,
    ["Minecraft Data Pack Dimension"] = 543,
    ["Minecraft Data Pack Dimension Type"] = 542,
    ["Minecraft Data Pack Item Modifier"] = 544,
    ["Minecraft Data Pack Loot Table"] = 545,
    ["Minecraft Data Pack Metadata"] = 546,
    ["Minecraft Data Pack Predicate"] = 547,
    ["Minecraft Data Pack Recipe"] = 548,
    ["Minecraft Data Pack Tag"] = 549,
    ["Minecraft Data Pack Template Pool"] = 550,
    ["Minecraft Data Pack Trim Material"] = 555,
    ["Minecraft Data Pack Trim Pattern"] = 556,
    ["Minecraft Resource Pack Lang"] = 551,
    ["Minecraft Resource Pack Particle"] = 552,
    ["Minecraft Resource Pack Texture Mcmeta"] = 554,
    ["Minecraft Resourcepack Sounds"] = 553,
    ModuleAssembler = 558,
    ["Monade CLI Stack Configuration"] = 568,
    ["MongoDB Atlas Search Index Definition"] = 1046,
    ["Monika Configuration"] = 1044,
    ["Monoweave Configuration"] = 563,
    ["Motif config"] = 937,
    MultiQC = 1183,
    ["NOX Framework (Service)"] = 584,
    ["Netin Diagnostic System Template"] = 1003,
    ["Netlify config"] = 571,
    ["Network-as-Code Data Model"] = 572,
    ["Next Gen UI Agent A2A Server Configuration"] = 573,
    ["Next Gen UI Agent Configuration"] = 575,
    ["Next Gen UI Agent MCP Server Configuration"] = 574,
    ["Nightwatch.js"] = 577,
    ["Node.js configuration"] = 942,
    ["NueJS configuration file"] = 589,
    ["Nuitka.yaml"] = 1107,
    ["Nullstone config"] = 591,
    ["ONe's changelog entry"] = 610,
    ["ONe's service descriptor"] = 609,
    ["ORT Server repository environment configuration"] = 620,
    ["OSCAL Assessment Plan (AP)"] = 622,
    ["OSCAL Assessment Results (AR)"] = 623,
    ["OSCAL Catalog"] = 624,
    ["OSCAL Component Definition (CDef)"] = 625,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 626,
    ["OSCAL Profile"] = 627,
    ["OSCAL System Security Plan (SSP)"] = 628,
    ["OSS Review Toolkit configuration"] = 629,
    ["OSS Review Toolkit curation"] = 630,
    ["OSS Review Toolkit package configuration"] = 631,
    ["OSS Review Toolkit repository configuration"] = 632,
    ["OSS Review Toolkit resolutions"] = 633,
    ["October CMS columns"] = 595,
    ["October CMS fields"] = 596,
    ["Oh My Posh"] = 598,
    Okteto = 599,
    ["Ona Automations"] = 601,
    Opctl = 940,
    ["Open Data Contract Standard (ODCS)"] = 614,
    ["Open Data Product Standard (ODPS)"] = 615,
    ["Open Know-How"] = 1188,
    ["OpenRewrite Resource"] = 612,
    OpenSRM = 616,
    OpenStatus = 1199,
    ["OpenTelemetry Declarative Configuration"] = 613,
    ["OpenUtau character yaml"] = 606,
    ["OpenUtau ustx"] = 607,
    ["OpenWeather Current Weather API"] = 982,
    ["OpenWeather Road Risk API"] = 981,
    ["Ory Hydra configuration"] = 440,
    ["Ory Keto configuration"] = 500,
    ["Ory Kratos configuration"] = 621,
    ["Ory Oathkeeper configuration"] = 593,
    ["Outblocks App configuration"] = 618,
    ["Outblocks database table"] = 619,
    ["Outblocks project configuration"] = 617,
    PDM = 639,
    POPxf = 650,
    ["POPxf Correlations"] = 651,
    Packer = 637,
    Pantsbuild = 1061,
    ["Paper paper-plugin.yml"] = 638,
    ["Pipeline component"] = 994,
    ["Platform.sh application"] = 7,
    ["Platform.sh routes"] = 8,
    ["Platform.sh services"] = 9,
    ["Plex Prerolls"] = 648,
    ["PocketMine plugin.yml"] = 645,
    ["Postman collection"] = 654,
    ["Power Pages Configuration"] = 1200,
    ["Preset list for a WinUtil"] = 1145,
    ["ProActions AI-Kit Configuration"] = 665,
    ["ProActions AI-Kit Configuration for Menus"] = 667,
    ["ProActions AI-Kit Configuration for Sections"] = 669,
    ["ProActions AI-Kit Configuration for Services"] = 666,
    ["ProActions AI-Kit Configuration for Steps"] = 670,
    ["ProActions AI-Kit Configuration for Templates"] = 668,
    ["Problem object RFC9457"] = 1090,
    ["Problem package format"] = 671,
    ["Problem package generators"] = 672,
    ["Problem package submissions"] = 673,
    ["Problem package test group metadata"] = 674,
    Pterodactyl = 1040,
    ["Pull Request Labeler"] = 691,
    Pulumi = 699,
    ["PyGTA Config"] = 695,
    PyProject = 700,
    Pylock = 1191,
    Pyright = 701,
    ["Python script metadata"] = 1185,
    ["QType AI DSL"] = 704,
    Qgoda = 703,
    Qodana = 1013,
    ["Qt Creator workspace file"] = 1123,
    ["Quali Torque Blueprint Spec 2"] = 1038,
    ["QueryFirst config file"] = 1057,
    ["RKE Cluster Configuration JSON"] = 991,
    ["RKE Cluster Configuration YAML"] = 990,
    RadioHound = 694,
    Railpack = 706,
    Railway = 705,
    ["Rancher Fleet"] = 696,
    ...
    Ray = 954,
    ["Read the Docs"] = 698,
    ["Red-DiscordBot Cog"] = 714,
    ["Red-DiscordBot Cog Repo"] = 715,
    ["Red-DiscordBot Trivia"] = 716,
    ["Releasaurus Config"] = 4,
    ReleaseKit = 3,
    ["Render Blueprints"] = 989,
    RenderCV = 731,
    Renovate = 728,
    ["Renovate global configuration"] = 729,
    ["Renovate inherited configuration"] = 730,
    ["Replit config"] = 722,
    Restate = 1178,
    ["Revel Digital Gadget Definition File"] = 1202,
    RoadRunner = 733,
    ["Robust Station Image"] = 1208,
    Rockcraft = 734,
    ["Roo Coder Custom Modes"] = 735,
    Rubocop = 724,
    ["Rudder techniques"] = 1097,
    Ruff = 725,
    ["Rust Project"] = 726,
    ["Rust toolchain"] = 739,
    ["SDMX data message"] = 766,
    ["SDMX metadata message"] = 765,
    ["SDMX structure message"] = 764,
    ["SIL Kit Participant Configuration"] = 776,
    ["SIL Kit Registry Configuration"] = 777,
    ["SPDX 2.3"] = 814,
    SWADL = 830,
    ["Safebox Config"] = 1052,
    ["Sapphire CLI Config"] = 742,
    ["SauceCTL Configuration"] = 1000,
    Scarb = 762,
    ["Schema Catalog"] = 757,
    ["Scoop manifest"] = 763,
    ["Semantic Data Fabric (SDF) file"] = 767,
    ["Semgrep Rule"] = 769,
    ["Serenity Code Generator (Sergen)"] = 770,
    ["Serverless Framework Configuration"] = 1007,
    ["Serverless Workflow"] = 1009,
    ["Settings for a Cinnamon spice"] = 1141,
    ["Settings.paf"] = 772,
    ["Shopware 6 Configuration"] = 1010,
    ["Shopware CLI Extension Store Configuration"] = 1011,
    ["Shopware CLI Project Store Configuration"] = 1012,
    ["Sigma Detection Rule"] = 774,
    ["Sigrid scope configuration file"] = 775,
    ["SkyPilot Task JSON"] = 1098,
    ["Slack app manifest"] = 779,
    Snapcraft = 781,
    Solidarity = 784,
    ["Solution filters"] = 785,
    ["Source Maps v3"] = 786,
    Sourcery = 787,
    ["Spack bootstrap.yaml"] = 788,
    ["Spack cdash.yaml"] = 789,
    ["Spack ci.yaml"] = 790,
    ["Spack compilers.yaml"] = 791,
    ["Spack concretizer.yaml"] = 792,
    ["Spack config.yaml"] = 793,
    ["Spack definitions.yaml"] = 794,
    ["Spack develop.yaml"] = 795,
    ["Spack env_vars.yaml"] = 796,
    ["Spack environment"] = 802,
    ["Spack include.yaml"] = 797,
    ["Spack mirrors.yaml"] = 798,
    ["Spack modules.yaml"] = 799,
    ["Spack packages.yaml"] = 800,
    ["Spack repos.yaml"] = 801,
    ["Spack toolchains.yaml"] = 803,
    ["Spack upstreams.yaml"] = 804,
    ["Spack view.yaml"] = 805,
    ["Speakeasy Generation Config File"] = 809,
    ["Speakeasy Lint Configuration File"] = 806,
    ["Speakeasy Test Generation Configuration File"] = 807,
    ["Speakeasy Workflow File"] = 808,
    SpecIF = 810,
    ["Specmatic Configuration"] = 811,
    ["Sponge Mixin configuration"] = 812,
    StackBlitz = 818,
    ["StackHawk Scanner Configuration"] = 1006,
    Stale = 819,
    Starfish = 820,
    ["Starlake Data Pipeline"] = 979,
    Starship = 821,
    ["Statamic Blueprint"] = 822,
    ["Stella configuration file"] = 823,
    ["Streamlit configuration file"] = 824,
    ["Stryker Mutator"] = 827,
    ["StyleCop Analyzers Configuration"] = 828,
    ["Stylelint (.stylelintrc)"] = 829,
    ["Stylua Config"] = 1192,
    ["Sublime Syntax"] = 1053,
    ["Subsquid squid manifest"] = 1100,
    ["Swagger API 2.0"] = 831,
    ["Synadia Connect Component"] = 832,
    TSON = 868,
    TSTyche = 869,
    ["TYPO3 Vendor Bundler config"] = 875,
    ["Tab data for a LinUtil"] = 1148,
    ["Tab list for a LinUtil"] = 1147,
    Tach = 833,
    ["Tach Domain"] = 834,
    Talhelper = 836,
    ["Talisman configuration"] = 837,
    Taplo = 1193,
    ["Taskfile config"] = 984,
    Taurus = 838,
    Tauticord = 839,
    ["Tekton Pipeline"] = 1221,
    ["Tekton PipelineRun"] = 1222,
    ["Tekton Task"] = 1219,
    ["Tekton TaskRun"] = 1220,
    Telefonistka = 1179,
    ["Terrateam config"] = 1205,
    ["TestEnvironment.json"] = 851,
    ["TextMate Grammar"] = 850,
    Threagile = 845,
    ["Tier.run pricing.json"] = 842,
    Tikibase = 843,
    Tombi = 848,
    ["Traefik v2"] = 854,
    ["Traefik v2 File Provider"] = 855,
    ["Traefik v3"] = 856,
    ["Traefik v3 File Provider"] = 857,
    ["Travis CI (.travis.yml)"] = 853,
    Treefmt = 418,
    Trident = 1175,
    ["TrueScript for *.tscript files"] = 860,
    ["Tugboat QA config.yml"] = 1172,
    TunnelHub = 1088,
    Turborepo = 852,
    Tycho = 1137,
    Tye = 1014,
    ["Tyk Gateway - Open Source v5.7+"] = 1184,
    ["UET BuildConfig.json"] = 1058,
    ["UI5 Manifest"] = 881,
    ["UNCORS configuration"] = 885,
    ["UTAM Page Object"] = 884,
    ["Ubuntu Server Autoinstall"] = 879,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1176,
    ["Uniswap Token List"] = 966,
    ["Universal Schedule Format"] = 886,
    ["Unreal Engine Uplugin"] = 1059,
    ["Unreal Engine Uproject"] = 1060,
    ["UpCloud CLI (upctl) configuration"] = 1177,
    ["Updatecli Compose"] = 1022,
    ["Updatecli Policy Manifest"] = 1023,
    ["Updatecli Policy Metadata"] = 1024,
    Uplift = 1056,
    ["Upsun config"] = 6,
    ["User Journey Map"] = 988,
    V2Ray = 1028,
    ["VSCode Code Snippets"] = 247,
    ["VSIX CLI publishing"] = 904,
    Vector = 888,
    ["Vela Pipeline Configuration"] = 891,
    Vercel = 246,
    ["Version Bumper config"] = 894,
    Vespertide = 1226,
    ["Vespertide Migration"] = 1227,
    ["Vespertide Model"] = 1228,
    ["Viash Component Config"] = 1181,
    ["Viash Package Config"] = 1182,
    Visivo = 1086,
    ["WP-CLI"] = 914,
    Wake = 1174,
    ["Waku Config"] = 1151,
    ["Web App Manifest"] = 910,
    ["Web types"] = 913,
    WebExtensions = 909,
    ["Webman package recipe"] = 1034,
    ["Windows Package Manager Installer Manifest"] = 962,
    ["Windows Package Manager Locale Manifest"] = 963,
    ["Windows Package Manager Singleton Manifest"] = 961,
    Winutil = 964,
    ["WireMock CLI import configuration"] = 1157,
    ["WireMock CLI local service configuration"] = 1156,
    ["WireMock message stub mapping"] = 1155,
    ["WireMock stub mapping"] = 1154,
    ["Woodpecker pipeline config"] = 1002,
    ["Wrangler CLI"] = 915,
    ["Xstate Machine"] = 1020,
    ["Yandex Workflow Language"] = 1143,
    ["Yarn Config (.yarnrc.yml)"] = 977,
    ["Yippee-Ki-JSON configuration YML"] = 968,
    ["YouTrack App"] = 1140,
    ["Zarf Package Configuration"] = 1207,
    ["Zerops.io config"] = 1128,
    ["Zerops.io import"] = 1129,
    ["Zola Configuration"] = 1218,
    ["aerleon.yml"] = 19,
    ["amplify.yml"] = 12,
    ["angular.json"] = 36,
    apko = 1091,
    ...
    ["bamboo-spec"] = 124,
    basedpyright = 122,
    ["bashly-strings.yml"] = 1068,
    ["batect.yml"] = 123,
    ["beef-database-codegen"] = 125,
    ["beef-database-v5-codegen"] = 127,
    ["beef-entity-codegen"] = 126,
    ["beef-entity-v5-codegen"] = 128,
    ["behat.yml"] = 140,
    ["bigquery-table"] = 129,
    ["bioimageio resource description"] = 1108,
    ["bitbucket-pipelines"] = 131,
    bitrise = 132,
    ["bitrise-step"] = 133,
    ["block.json"] = 155,
    ...
    ["bozr.suite.json"] = 142,
    bpkg = 1069,
    ["browser.i18n.json"] = 143,
    ["browsh configuration"] = 144,
    bucklescript = 145,
    ["buf.gen.yaml"] = 87,
    ["buf.lock"] = 88,
    ["buf.plugin.yaml"] = 89,
    ...
    ["build-changelog"] = 146,
    ["bun.lock"] = 151,
    ["bundleconfig.json"] = 152,
    ["bunfig.toml"] = 153,
    ["cargo-mutants-config.yaml"] = 91,
    ["ccmod.json"] = 1152,
    changelogging = 1120,
    ["chisel-slices.json"] = 273,
    ["chrome-extension-locales-messages.json"] = 254,
    ["chutzpah.json"] = 255,
    cibuildwheel = 175,
    ["clang-format (.clang-format)"] = 1026,
    ["clang-tidy"] = 233,
    clangd = 232,
    clib = 234,
    ["cloud-init: cloud-config userdata"] = 236,
    ["cloud-sdk-pipeline-configuration"] = 257,
    ["cloudbuild.json"] = 258,
    cloudify = 235,
    ["cmdx.yaml"] = 94,
    codemagic = 238,
    ["coffeelint.json"] = 275,
    ["commands.json"] = 250,
    ["commitlint (.commitlintrc)"] = 965,
    ["committed.toml"] = 276,
    ["compile_commands.json"] = 249,
    ["compilerconfig.json"] = 248,
    ["completely.yml"] = 1064,
    ["component-detection-manifest.json"] = 279,
    ["component.json"] = 278,
    ["composer.json"] = 277,
    ["conda-forge"] = 179,
    ["config.yaml"] = 697,
    ["contentmanifest.json"] = 256,
    ["contribute.json"] = 280,
    ["cosmos.config.json"] = 252,
    ["crowdin.yml"] = 281,
    ["ctfd-setup configuration file"] = 1164,
    ["custom-elements.json"] = 1078,
    ["cypress.json"] = 285,
    ["datalogic-scan2deploy-android"] = 295,
    ["datalogic-scan2deploy-ce"] = 296,
    ["dbt Dependencies"] = 197,
    ["dbt Packages"] = 199,
    ["dbt Project"] = 198,
    ["dbt Selectors"] = 200,
    ["dbt YAML files"] = 201,
    ...
    ["ddev-global"] = 297,
    ["ddev-project"] = 298,
    ["debugsettings.json"] = 299,
    ["dependabot-v2.json"] = 302,
    ["dependabot.json"] = 301,
    ["deployed-cli"] = 1019,
    ["devcontainer.json"] = 240,
    devinit = 970,
    ["devspace.yaml"] = 1042,
    djlint = 971,
    ["docker bake"] = 308,
    ["docker sequencer"] = 309,
    ["docker-compose.yml"] = 969,
    ["dockerd.json"] = 306,
    ["dotnet Release Index manifest"] = 321,
    ["dotnet-tools.json"] = 322,
    ["dotnetcli.host.json"] = 323,
    ["dprint.json"] = 324,
    ["drone.json"] = 325,
    ["dss-2.0.0.json"] = 327,
    ["dstack configuration"] = 328,
    ["dtool dataset metadata"] = 1159,
    ["dvc.yaml"] = 329,
    ["ecosystem.json"] = 334,
    eksctl = 336,
    ["electron-builder configuration file"] = 342,
    ["epr-manifest.json"] = 341,
    ["evcc.yaml"] = 343,
    ["ezd task runner"] = 353,
    ["fabric.mod.json"] = 355,
    ["first-timers-bot"] = 363,
    ["flagd flag configuration"] = 115,
    ["fly.io Configuration"] = 116,
    fulibWorkflows = 1001,
    ["function.json"] = 375,
    ["gRPC API Gateway & OpenAPI Config"] = 14,
    ["gematik health care insurance list"] = 1170,
    ["gematik health care patient list"] = 1167,
    ["gematik health care provider institution list"] = 1169,
    ["gematik health care provider list"] = 1168,
    ["gematik tiger test environment configuration"] = 1171,
    ["git-town.toml"] = 1216,
    ["gitlab-ci"] = 393,
    ["global.json"] = 409,
    ["go-feature-flag Flag Configuration"] = 412,
    ["haxelib.json"] = 430,
    helmfile = 957,
    helmwave = 958,
    ["host-meta.json"] = 437,
    ...
    ["ide.host.json"] = 445,
    ["ifstate.yaml"] = 446,
    ["imageoptimizer.json"] = 447,
    ["importmap.json"] = 450,
    instant_python_config = 452,
    instant_python_custom_project = 453,
    ["ioBroker Configuration"] = 454,
    ["ioBroker JSON UI"] = 455,
    ["ioBroker Package manifest"] = 456,
    ["ixpect.conf.yaml"] = 457,
    ["ize.toml"] = 1055,
    ["jsconfig.json"] = 482,
    ["jscpd Configuration"] = 1039,
    jsdoc = 953,
    ["k3d.yaml"] = 483,
    ["k9s aliases.yaml"] = 485,
    ["k9s cluster-config.yaml"] = 487,
    ["k9s config.yaml"] = 486,
    ["k9s hotkeys.yaml"] = 488,
    ["k9s plugins.yaml"] = 489,
    ["k9s skin.yaml"] = 490,
    ["k9s views.yaml"] = 491,
    ["kontinuous-config.yaml"] = 502,
    ["kontinuous-values.yaml"] = 501,
    ["kustomization.yaml"] = 504,
    ["label-commenter-config.yml"] = 505,
    ["latexindent configuration"] = 109,
    ["launchsettings.json"] = 506,
    lazydocker = 1077,
    lazygit = 1076,
    ["lego.json"] = 508,
    ["lerna.json"] = 509,
    ["lgtm.yml"] = 510,
    ["liblab.config.json"] = 511,
    ["libman.json"] = 512,
    ["license-report-config.json"] = 513,
    ["linkinator.config.json"] = 515,
    ["lint-staged (.lintstagedrc)"] = 931,
    ["local.settings.json"] = 520,
    ["localazy.json"] = 521,
    ["lotus.yaml"] = 519,
    ["lsdlschema.json"] = 522,
    ["macro.json"] = 1043,
    ["markdown-link-check"] = 997,
    maturin = 998,
    mboats = 1005,
    ["micro-settings.json"] = 1070,
    ["mimetypes.json"] = 537,
    ["mirrord config"] = 933,
    mise = 934,
    ["mkdocs.yml"] = 557,
    ...
    ["monospace.yml"] = 562,
    ["moon.yml"] = 1153,
    ["mprocs Configuration file"] = 1124,
    ["mrdocs.yml"] = 559,
    ["mta.yaml"] = 935,
    ["mtad.yaml"] = 936,
    ["mycode.json"] = 569,
    nFPM = 576,
    ["napari plugin manifest"] = 570,
    neoload = 948,
    ["nest-cli"] = 579,
    ["nexus-rpc-gen"] = 1243,
    ["ninjs (News in JSON)"] = 578,
    ["nitro.json"] = 947,
    ["nixd configuration"] = 1096,
    ["nlu.json"] = 580,
    ["nodemon.json"] = 582,
    ["noodl config"] = 1004,
    ["notebook.mod.json"] = 583,
    now = 943,
    ["npm-badges"] = 586,
    ["nswag.json"] = 590,
    ntangle = 592,
    ["nuclei-template.yaml"] = 587,
    ["nuget-project.json"] = 588,
    ["ocelot.json"] = 594,
    ogen = 597,
    ["omnisharp.json"] = 600,
    openHAB = 1229,
    ...
    oxlint = 1240,
    ["package.json"] = 634,
    ["package.manifest"] = 636,
    ["package.yaml"] = 635,
    ["partial-black.json"] = 141,
    ["partial-pixi.json"] = 643,
    ["pattern.json"] = 641,
    ["petstore-v1.0"] = 1050,
    pgap_yaml_input_reader = 640,
    pgxgen = 1233,
    pitcms = 1236,
    ["pixi.toml"] = 642,
    ["plagiarize-me.yaml"] = 647,
    ["plagiarize.yaml"] = 646,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1160,
    ["podbard.yaml"] = 649,
    ["portman.json"] = 652,
    ["prefect.toml"] = 660,
    ["prefect.yaml"] = 661,
    ...
    ["prettierrc.json"] = 663,
    ["prisma.yml"] = 664,
    ["project-1.0.0-beta3.json"] = 676,
    ["project-1.0.0-beta4.json"] = 677,
    ["project-1.0.0-beta5.json"] = 678,
    ["project-1.0.0-beta6.json"] = 679,
    ["project-1.0.0-beta8.json"] = 680,
    ["project-1.0.0-rc1.json"] = 681,
    ["project-1.0.0-rc2.json"] = 682,
    ["project.json"] = 675,
    ["project.owasp.yaml"] = 683,
    ["prometheus-alertmanager.json"] = 687,
    ["prometheus.json"] = 684,
    ["prometheus.rules.json"] = 685,
    ["prometheus.rules.test.json"] = 686,
    ["proxies.json"] = 688,
    ["publiccode.yml"] = 689,
    ["pubspec.yaml"] = 690,
    ["pyrseas-0.8.json"] = 693,
    pytest = 702,
    ["quilt.mod.json"] = 1071,
    ["rc3 auth"] = 708,
    ["rc3 collection"] = 709,
    ...
    ["release drafter"] = 949,
    ["release-hub.json"] = 2,
    ["release-please-config.json"] = 718,
    ["release-please-manifest.json"] = 719,
    ["release-plz.toml"] = 720,
    ["renv.lock"] = 732,
    ["rivet.json"] = 1095,
    ["rivet.yaml (legacy)"] = 1094,
    rumdl = 737,
    runny = 736,
    rustfmt = 738,
    sake = 1187,
    samt = 740,
    samtrc = 741,
    ["sarif-1.0.0.json"] = 743,
    ["sarif-2.0.0.json"] = 744,
    ["sarif-2.1.0"] = 754,
    ["sarif-2.1.0-rtm.2"] = 745,
    ["sarif-2.1.0-rtm.3"] = 747,
    ["sarif-2.1.0-rtm.4"] = 749,
    ["sarif-2.1.0-rtm.5"] = 751,
    ["sarif-2.1.0-rtm.6"] = 752,
    ["sarif-external-property-file-2.1.0"] = 755,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 746,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 748,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 750,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 753,
    ["scalingo.json configuration"] = 756,
    ["schema.org - Action"] = 758,
    ["schema.org - ContactPoint"] = 759,
    ["schema.org - Place"] = 760,
    ["schema.org - Thing"] = 761,
    ["secrethub.yml"] = 1073,
    ["semantic-release"] = 768,
    ["servicehub.config.json"] = 926,
    ["servicehub.service.json"] = 925,
    ["settings.job"] = 771,
    ["sfdx-hardis configuration"] = 773,
    ["shard.yml"] = 1111,
    ["size-limit configuration"] = 778,
    ["skaffold.yaml"] = 995,
    ["skyuxconfig.json"] = 780,
    ["snowflake-config"] = 782,
    ["snowflake-connections"] = 783,
    ["spicepod.yaml"] = 1132,
    ["sqlc configuration"] = 815,
    ["stripe-app-local.json"] = 826,
    ["stripe-app.json"] = 825,
    swcrc = 980,
    ["task.json"] = 835,
    taskcat = 944,
    ["template.json"] = 840,
    ["templatsources.json"] = 841,
    ["text2confl config"] = 1241,
    ["theme.json"] = 844,
    ["tizen_workspace.json"] = 846,
    tldr = 847,
    ["tm_devices configuration file"] = 1198,
    tmuxinator = 929,
    tox = 849,
    ["transcend.yml"] = 858,
    ["tree-sitter grammar.json"] = 417,
    ["trime.yaml"] = 859,
    ["trunk.yaml"] = 861,
    ["ts-force-config.json"] = 866,
    ["tsconfig.json"] = 862,
    ["tsd.json"] = 863,
    ["tsdoc.json"] = 864,
    ["tsdrc.json"] = 865,
    ...
    v8r = 908,
    vcluster = 1118,
    ["vcpkg configuration file"] = 245,
    ["vcpkg manifest file"] = 244,
    ["vega-lite.json"] = 890,
    ["vega.json"] = 889,
    ["venvironment.yaml"] = 892,
    ["venvplus.yaml"] = 893,
    version = 1180,
    ["version.json"] = 895,
    ["vhwdebugger-binding.yaml"] = 897,
    ["vim-addon-info"] = 898,
    ["vs-2017.3.host.json"] = 900,
    ["vs-nesting.json"] = 901,
    ["vsls.json"] = 899,
    ["vss-extension.json"] = 905,
    vtcfg = 1186,
    ["vtesttree.yaml"] = 906,
    ["vtestunit.yaml"] = 907,
    ["warp-keysets.json"] = 1079,
    ["warp-themes.json"] = 1080,
    ["warp-workflows.json"] = 1081,
    ["webhint.io"] = 1035,
    ["webjobpublishsettings.json"] = 912,
    ["webjobs-list.json"] = 911,
    ["well-known-fursona"] = 1119,
    ["xs-app.json"] = 939,
    ["xunit.runner.json"] = 924,
    yamllint = 967,
    zizmor = 1223,
    zuul = 950,
    ["Žinoma"] = 960
