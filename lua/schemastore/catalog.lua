...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 165,
    [".cryproj (generic)"] = 566,
    [".cryproj engine-5.2"] = 561,
    [".cryproj engine-5.3"] = 562,
    [".cryproj engine-5.4"] = 563,
    [".cryproj engine-5.5"] = 564,
    [".cryproj engine-dev"] = 565,
    [".csscomb.json"] = 167,
    [".csslintrc"] = 168,
    [".es6importsorterrc.json"] = 693,
    [".eslintrc"] = 214,
    [".esmrc.json"] = 206,
    [".ffizer.yaml"] = 218,
    [".htmlhintrc"] = 264,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration Schema"] = 638,
    ["All Contributors configuration file"] = 692,
    ...
    ["Azure Pipelines"] = 54,
    ["Azure Static Web Apps CLI configuration file"] = 483,
    ["Azure Static Web Apps configuration file"] = 482,
    ["BX CI"] = 89,
    ["Better Code Hub"] = 611,
    ["Better Scripts"] = 90,
    BizTalkServerApplicationSchema = 581,
    ...
    ["Butane Config"] = 650,
    ["CICS TS region tagging"] = 657,
    ["CICS TS resource import"] = 658,
    ["CICS TS resource model"] = 659,
    ["CICS TS resource overrides"] = 660,
    ["CMake Presets"] = 91,
    ...
    ["Datahub Ingestion Recipe Schema"] = 664,
    ...
    ["Embrace Config Schema"] = 675,
    ["Error pages"] = 209,
    Esquio = 207,
    ["Estuary Flow Catalog Schema"] = 654,
    ["Expo SDK"] = 212,
    ...
    Goreleaser = 246,
    ["Goreleaser Pro"] = 247,
    ["Gradle Build Cache Node"] = 608,
    ["Gradle Enterprise"] = 607,
    ...
    Hadolint = 590,
    Hammerkit = 618,
    ["Hardware Sentry Configuration"] = 668,
    Hayson = 259,
    ...
    ["JFrog File Spec"] = 283,
    ["JFrog Pipelines YML DSL"] = 677,
    ["JMeter DSL cli config schema"] = 284,
    JReleaser = 286,
    ["JSON Document Transform"] = 293,
    ["JSON Feed"] = 294,
    ["JSON Resume"] = 436,
    ["JSON Schema Draft 2020-12"] = 557,
    ["JSON Schema Draft 4"] = 554,
    ["JSON Schema Draft 7"] = 555,
    ["JSON Schema Draft 8"] = 556,
    ...
    ["KSP-CKAN"] = 553,
    Kas = 299,
    ["Keycloak REST API"] = 684,
    ["Knative Functions - func.yaml"] = 228,
    ["KoDE/CI build.yaml"] = 673,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 672,
    ["Monika Configuration Schema"] = 670,
    ["Motif config"] = 574,
    ["NOX Framework (Service)"] = 361,
    ["Netin Diagnostic System Template"] = 633,
    ...
    ["OpenWeather Current Weather API"] = 615,
    ["OpenWeather Road Risk API"] = 614,
    ...
    Pyright = 425,
    Qodana = 643,
    ["Quali Torque Blueprint Spec 2"] = 665,
    ["QueryFirst config file"] = 687,
    ["RKE Cluster Configuration JSON Schema"] = 622,
    ["RKE Cluster Configuration YAML Schema"] = 621,
    ["Rancher Fleet"] = 421,
    Ray = 589,
    ["Read the Docs"] = 422,
    ...
    ["Rust Project"] = 435,
    ["Rust toolchain"] = 440,
    ["SIL Kit Participant Configuration"] = 469,
    ["SIL Kit Registry Configuration"] = 470,
    SWADL = 492,
    ["Safebox Config Schema"] = 678,
    ["Sapphire CLI Config"] = 443,
    ["SauceCTL Configuration"] = 630,
    ["Schema Catalog"] = 456,
    ["Scoop manifest"] = 461,
    ["Semantic Data Fabric (SDF) file"] = 462,
    ["Semgrep Rule"] = 464,
    ["Serenity Code Generator (Sergen)"] = 465,
    ["Serverless Framework Configuration"] = 637,
    ["Serverless Workflow Schema"] = 639,
    ["Settings.paf"] = 467,
    ["Shopware 6 Configuration"] = 640,
    ["Shopware CLI Extension Store Configuration"] = 641,
    ["Shopware CLI Project Store Configuration"] = 642,
    ["Slack app manifest"] = 472,
    Solidarity = 475,
    ["Solution filters"] = 476,
    ["Source Maps v3"] = 477,
    Sourcery = 478,
    SpecIF = 479,
    ["Sponge Mixin configuration"] = 480,
    ["StackHawk Scanner Configuration"] = 636,
    Stale = 484,
    Starship = 485,
    ["Statamic Blueprint"] = 486,
    ["StrmPrivacy Data Connector"] = 682,
    ["StrmPrivacy Data Contract"] = 683,
    ["StrmPrivacy SimpleSchema"] = 680,
    ["StrmPrivacy Stream"] = 681,
    ["StrmPrivacy batch job configuration file"] = 679,
    ["Stryker Mutator"] = 489,
    ["StyleCop Analyzers Configuration"] = 490,
    ["Swagger API 2.0"] = 493,
    TSON = 517,
    ["Talisman configuration"] = 495,
    ["Taskfile YAML Schema"] = 617,
    Taurus = 496,
    ["TestEnvironment.json"] = 505,
    ["Tier.run pricing.json"] = 499,
    Tikibase = 500,
    ["Traefik v2"] = 508,
    ["Traefik v2 File Provider"] = 509,
    Turborepo = 506,
    Tye = 644,
    ["UET BuildConfig.json"] = 688,
    ["UI5 Manifest"] = 524,
    ["UTAM Page Object"] = 527,
    ["Ubuntu Server Autoinstall"] = 522,
    ["Uniswap Token List"] = 599,
    ["Unreal Engine Uplugin"] = 689,
    ["Unreal Engine Uproject"] = 690,
    Updatecli = 651,
    Uplift = 686,
    ["User Journey Map YAML Schema"] = 620,
    V2Ray = 655,
    ["VSCode Code Snippets"] = 137,
    ["VSIX CLI publishing"] = 540,
    ["Vela Pipeline Configuration"] = 530,
    Vercel = 136,
    ["Web App Manifest"] = 547,
    ["Web types"] = 550,
    WebExtensions = 546,
    ["Webman package recipe"] = 661,
    ["Windows Package Manager Installer Manifest"] = 596,
    ["Windows Package Manager Locale Manifest"] = 597,
    ["Windows Package Manager Singleton Manifest"] = 595,
    ["Woodpecker pipeline config"] = 632,
    ["Xstate Machine Schema"] = 649,
    ["Yippee-Ki-JSON configuration YML"] = 601,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 65,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 697,
    ["bashly-strings.yml"] = 698,
    ["bashly.yml"] = 696,
    ["batect.yml"] = 64,
    ["beau.yml"] = 610,
    ...
    ["ize.toml"] = 685,
    ["jsconfig.json"] = 297,
    ["jscpd Configuration Schema"] = 666,
    jsdoc = 588,
    ["k3d.yaml"] = 298,
    ...
    ["lsdlschema.json"] = 320,
    ["madness.yml"] = 695,
    ["markdown-lint-check"] = 628,
    mboats = 635,
    ["micro-settings.json"] = 699,
    ["mimetypes.json"] = 327,
    ["mirrord-schema"] = 571,
    ["mta.yaml"] = 572,
    ["mtad.yaml"] = 573,
    ...
    ["servicehub.config.json"] = 560,
    ["servicehub.service.json"] = 559,
    ["settings.job"] = 466,
    ["sfdx-hardis configuration"] = 468,
    ["size-limit configuration"] = 471,
    ["skaffold.yaml"] = 626,
    ["skyuxconfig.json"] = 473,
    snapcraft = 474,
    ["stripe-app-local.json"] = 488,
    ["stripe-app.json"] = 487,
    swcrc = 613,
    ["task.json"] = 494,
    taskcat = 580,
    ["template.json"] = 497,
    ["templatsources.json"] = 498,
    ["theme.json"] = 501,
    ["tizen_workspace.json"] = 502,
    tldr = 503,
    tmLanguage = 504,
    tmuxinator = 568,
    ["transcend.yml"] = 510,
    ["trunk.yaml schema"] = 511,
    ["ts-force-config.json"] = 515,
    ["tsconfig.json"] = 512,
    ["tsd.json"] = 513,
    ["tsdrc.json"] = 514,
    ["tslint.json"] = 516,
    ...
    ["vega-lite.json"] = 529,
    ["vega.json"] = 528,
    ["venvironment-basic.yaml"] = 532,
    ["venvironment.yaml"] = 531,
    ["version.json"] = 533,
    ["vim-addon-info"] = 534,
    ["vs-2017.3.host.json"] = 536,
    ["vs-nesting.json"] = 537,
    ["vsls.json"] = 535,
    ["vss-extension.json"] = 541,
    ["vtesttree.yaml"] = 542,
    ["vtestunit.yaml"] = 543,
    ["webhint.io"] = 662,
    ["webjobpublishsettings.json"] = 549,
    ["webjobs-list.json"] = 548,
    ["xs-app.json"] = 576,
    ["xunit.runner.json"] = 558,
    yamllint = 600,
    zuul = 585,
    ["Žinoma"] = 594
  },
