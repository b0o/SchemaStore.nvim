...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1036,
    ["API Builder"] = 851,
    ["AVA Configuration"] = 913,
    ...
    ["Adobe UXP Manifest"] = 975,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1064,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 885,
    ["All Contributors configuration file"] = 938,
    ...
    ["Application list for a WinUtil"] = 1018,
    ArchitectFX = 1023,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["BX CI"] = 119,
    ["Bashly (bashly.yml)"] = 942,
    ["Bashly Settings (bashly-settings.yml)"] = 943,
    ["Better Code Hub"] = 855,
    ["Better Scripts"] = 120,
    Bigconfig = 94,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1029,
    BizTalkServerApplicationSchema = 823,
    Bleep = 121,
    ...
    ["Butane Config"] = 898,
    C4InterFlow = 1044,
    ["CGS Card Game Specification (cgs.json)"] = 980,
    ["CICS TS region tagging"] = 907,
    ["CICS TS resource import"] = 908,
    ["CICS TS resource model"] = 909,
    ["CICS TS resource overrides"] = 910,
    ["CMake Presets"] = 122,
    ["CNC Codes"] = 141,
    ["CRS WAF test file"] = 1008,
    ["CRS WAF test platform overrides file"] = 1009,
    ...
    ["Chamaleon environment"] = 1033,
    ["Chamaleon properties"] = 1034,
    ["Chamaleon template"] = 1032,
    Changesets = 224,
    Charmcraft = 131,
    Cheatsheets = 895,
    ...
    CityJSON = 136,
    ["Clawject config"] = 147,
    ["Cloud Foundry Application Manifest"] = 991,
    ["Cloud Run Spec v1"] = 1013,
    ...
    Concord = 1007,
    ["Configu .cfgu files"] = 996,
    ["Configu .configu file"] = 997,
    Conjure = 140,
    ["Container Structure Test"] = 837,
    Containerlab = 864,
    ["Contextive Glossary"] = 1059,
    Convex = 139,
    ["Crowdsec collection config"] = 234,
    ["Crowdsec parser config"] = 235,
    ["Crowdsec scenario config"] = 236,
    ["CumulusCI Config"] = 146,
    ["Custom Machinery Machine"] = 981,
    ["Custom Machinery Recipe"] = 982,
    ...
    ["DonateCaseBetterCasino menu"] = 1037,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 950,
    ["EAS config"] = 300,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 939,
    ["EasyVCR .NET"] = 301,
    ["Eidolon Resource"] = 1024,
    ...
    ["GeoJSON.json latest"] = 902,
    GherKing = 906,
    ["GitHub Action"] = 331,
    ["GitHub Actions typing"] = 1020,
    ...
    ["Google Digital Assetlinks"] = 1060,
    Goreleaser = 359,
    ["Goreleaser Pro"] = 360,
    Goss = 361,
    ["Gradle Build Cache Node"] = 853,
    ["Gradle Enterprise"] = 852,
    ...
    Hadolint = 833,
    Hammerkit = 863,
    ["Hardware Sentry Configuration"] = 918,
    Hatch = 834,
    Hayson = 374,
    ...
    ["JFrog File Spec"] = 405,
    ["JFrog Pipelines YML DSL"] = 927,
    ["JMeter DSL cli config"] = 406,
    JReleaser = 408,
    ["JSON Document Transform"] = 416,
    ["JSON Feed"] = 417,
    ["JSON Resume"] = 636,
    ["JSON Schema Draft 2020-12"] = 802,
    ["JSON Schema Draft 4"] = 799,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 960,
    ["JSON Schema Draft 7"] = 800,
    ["JSON Schema Draft 7 (unofficial strict)"] = 961,
    ["JSON Schema Draft 8 (2019-09)"] = 801,
    ["JSON-API"] = 415,
    ["JSON-e templates"] = 860,
    ["JSON-stat 2.0"] = 795,
    JSONPatch = 419,
    ...
    ["Metadata for a Cinnamon spice"] = 1016,
    ["Metatype Configuration"] = 467,
    ["MetricsHub Configuration"] = 468,
    ["MetricsHub Connector Configuration"] = 469,
    ["Micro Editor Syntax"] = 951,
    ["Microsoft Band Web Tile"] = 470,
    ["Microsoft RulesEngine workflow rules"] = 1004,
    ["Microsoft RulesEngine workflow rules list"] = 1005,
    ["Minecraft Custom Main Menu Mod"] = 969,
    ...
    ["MongoDB Atlas Search Index Definition"] = 922,
    ["Monika Configuration"] = 920,
    ["Monoweave Configuration"] = 495,
    ["Motif config"] = 815,
    MultiQC = 1053,
    ["NOX Framework (Service)"] = 513,
    ["Netin Diagnostic System Template"] = 880,
    ["Netlify config"] = 503,
    ["Network-as-Code Data Model"] = 504,
    ["Nightwatch.js"] = 506,
    ["Node.js configuration"] = 820,
    ...
    ["OpenUtau ustx"] = 531,
    ["OpenWeather Current Weather API"] = 859,
    ["OpenWeather Road Risk API"] = 858,
    ...
    ["Preset list for a WinUtil"] = 1019,
    ...
    Pylock = 1061,
    Pyright = 613,
    ["Python script metadata"] = 1055,
    Qgoda = 615,
    Qodana = 890,
    ["Qt Creator workspace file"] = 998,
    ["Quali Torque Blueprint Spec 2"] = 915,
    ["QueryFirst config file"] = 933,
    ["RKE Cluster Configuration JSON"] = 868,
    ["RKE Cluster Configuration YAML"] = 867,
    RadioHound = 606,
    Railway = 616,
    ["Rancher Fleet"] = 608,
    ["Rattler-build"] = 617,
    ...
    ["Render Blueprints"] = 866,
    RenderCV = 638,
    Renovate = 637,
    ["Replit config"] = 632,
    Restate = 1048,
    RoadRunner = 640,
    ["Rudder techniques"] = 973,
    Ruff = 634,
    ["Rust Project"] = 635,
    ["Rust toolchain"] = 644,
    ...
    ["SauceCTL Configuration"] = 877,
    ["Schema Catalog"] = 662,
    ["Scoop manifest"] = 667,
    ["Semantic Data Fabric (SDF) file"] = 671,
    ["Semgrep Rule"] = 673,
    ["Serenity Code Generator (Sergen)"] = 674,
    ["Serverless Framework Configuration"] = 884,
    ["Serverless Workflow"] = 886,
    ["Settings for a Cinnamon spice"] = 1015,
    ["Settings.paf"] = 676,
    ["Shopware 6 Configuration"] = 887,
    ["Shopware CLI Extension Store Configuration"] = 888,
    ["Shopware CLI Project Store Configuration"] = 889,
    ["Sigma Detection Rule"] = 678,
    ["Sigrid scope configuration file"] = 679,
    ["SkyPilot Task JSON"] = 974,
    ...
    StackBlitz = 703,
    ["StackHawk Scanner Configuration"] = 883,
    Stale = 704,
    ["Starlake Data Pipeline"] = 856,
    Starship = 705,
    ...
    ["Stylua Config"] = 1062,
    ["Sublime Syntax"] = 929,
    ["Subsquid squid manifest"] = 976,
    ["Swagger API 2.0"] = 714,
    ["Synadia Connect Component"] = 715,
    TSON = 749,
    TSTyche = 750,
    ["Tab data for a LinUtil"] = 1022,
    ["Tab list for a LinUtil"] = 1021,
    Tach = 716,
    ["Tach Domain"] = 717,
    Talhelper = 719,
    ...
    ["Tugboat QA config.yml"] = 1043,
    TunnelHub = 964,
    Turborepo = 733,
    Tycho = 1011,
    Tye = 891,
    ["Tyk Gateway - Open Source v5.7+"] = 1054,
    ["Typst Manifest"] = 755,
    ["UET BuildConfig.json"] = 934,
    ["UI5 Manifest"] = 761,
    ["UNCORS configuration"] = 765,
    ["UTAM Page Object"] = 764,
    ["Ubuntu Server Autoinstall"] = 759,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1047,
    ["Uniswap Token List"] = 844,
    ["Universal Schedule Format"] = 766,
    ["Unreal Engine Uplugin"] = 935,
    ["Unreal Engine Uproject"] = 936,
    ["Updatecli Compose"] = 899,
    ["Updatecli Policy Manifest"] = 900,
    ["Updatecli Policy Metadata"] = 901,
    Uplift = 932,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 865,
    V2Ray = 905,
    ["VSCode Code Snippets"] = 199,
    ["VSIX CLI publishing"] = 784,
    Vector = 768,
    ["Vela Pipeline Configuration"] = 771,
    Vercel = 198,
    ["Version Bumper config"] = 774,
    ["Viash Component Config"] = 1051,
    ["Viash Package Config"] = 1052,
    Visivo = 962,
    Wake = 1045,
    ["Waku Config"] = 1025,
    ["Web App Manifest"] = 790,
    ["Web types"] = 793,
    WebExtensions = 789,
    ["Webman package recipe"] = 911,
    ["Windows Package Manager Installer Manifest"] = 840,
    ["Windows Package Manager Locale Manifest"] = 841,
    ["Windows Package Manager Singleton Manifest"] = 839,
    Winutil = 842,
    ["WireMock stub mapping"] = 1028,
    ["Woodpecker pipeline config"] = 879,
    ["Wrangler CLI"] = 794,
    ["Xstate Machine"] = 897,
    ["Yandex Workflow Language"] = 1017,
    ["Yarn Config (.yarnrc.yml)"] = 854,
    ["Yippee-Ki-JSON configuration YML"] = 846,
    ["YouTrack App"] = 1014,
    ["Zerops.io config"] = 1002,
    ["Zerops.io import"] = 1003,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 967,
    ...
    ["behat.yml"] = 103,
    ["bigquery-table"] = 93,
    ["bioimageio resource description"] = 984,
    ...
    ["crowdin.yml"] = 233,
    ["ctfd-setup configuration file"] = 1035,
    ["custom-elements.json"] = 954,
    ["cypress.json"] = 237,
    ...
    ["gematik health care insurance list"] = 1041,
    ["gematik health care patient list"] = 1038,
    ["gematik health care provider institution list"] = 1040,
    ["gematik health care provider list"] = 1039,
    ["gematik tiger test environment configuration"] = 1042,
    ["gitlab-ci"] = 339,
    ["global.json"] = 355,
    ...
    ["lint-staged (.lintstagedrc)"] = 810,
    ["local.settings.json"] = 457,
    ["localazy.json"] = 458,
    ["lotus.yaml"] = 456,
    ["lsdlschema.json"] = 459,
    ["markdown-link-check"] = 874,
    maturin = 875,
    mboats = 882,
    ["micro-settings.json"] = 946,
    ["mimetypes.json"] = 471,
    ["mirrord config"] = 811,
    mise = 812,
    ["mkdocs.yml"] = 491,
    ...
    ["plagiarize.yaml"] = 566,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1031,
    ["podbard.yaml"] = 569,
    ["portman.json"] = 570,
    ["prefect.toml"] = 578,
    ["prettierrc.json"] = 579,
    ...
    ["servicehub.config.json"] = 805,
    ["servicehub.service.json"] = 804,
    ["settings.job"] = 675,
    ...
    version = 1050,
    ["version.json"] = 775,
    ["vhwdebugger-binding.yaml"] = 777,
    ["vim-addon-info"] = 778,
    ["vs-2017.3.host.json"] = 780,
    ["vs-nesting.json"] = 781,
    ["vsls.json"] = 779,
    ["vss-extension.json"] = 785,
    vtcfg = 1056,
    ["vtesttree.yaml"] = 786,
    ["vtestunit.yaml"] = 787,
    ["warp-keysets.json"] = 955,
    ["warp-themes.json"] = 956,
    ["warp-workflows.json"] = 957,
    ["webhint.io"] = 912,
    ["webjobpublishsettings.json"] = 792,
    ["webjobs-list.json"] = 791,
    ["well-known-fursona"] = 994,
    ["xs-app.json"] = 817,
    ["xunit.runner.json"] = 803,
    yamllint = 845,
    zuul = 828,
    ["Žinoma"] = 838
  },
