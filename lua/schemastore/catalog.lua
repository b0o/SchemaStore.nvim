...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 866,
    [".nodehawkrc"] = 529,
    [".npmpackagejsonlintrc"] = 533,
    [".omletrc"] = 1042,
    [".phrase.yml"] = 597,
    [".phraseapp.yml"] = 598,
    [".pmbot.yml"] = 585,
    [".postcssrc"] = 592,
    [".powerpages-web-template-manifest"] = 594,
    [".pre-commit-config.yml"] = 595,
    [".pre-commit-hooks.yml"] = 596,
    [".putout.json"] = 625,
    [".rehyperc"] = 649,
    [".remarkrc"] = 653,
    [".sprite files"] = 740,
    ...
    ["A micro editor config"] = 480,
    ABCInventoryModuleData = 18,
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1087,
    ["API Builder"] = 901,
    ["AVA Configuration"] = 963,
    ...
    ["AWS Copilot Manifest"] = 1126,
    ["AWS SAM CLI Samconfig"] = 226,
    ["Adobe UXP Manifest"] = 1025,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1116,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 935,
    ["All Contributors configuration file"] = 988,
    ...
    ["Application list for a WinUtil"] = 1069,
    ArchitectFX = 1074,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure IoT Operations connector metadata"] = 1132,
    ...
    ["Azure Pipelines"] = 81,
    ["Azure Static Web Apps CLI configuration file"] = 744,
    ["Azure Static Web Apps configuration file"] = 743,
    ["BOSH CPI Config"] = 105,
    ["BOSH Deploy Config"] = 106,
    ["BX CI"] = 125,
    ["Bashly (bashly.yml)"] = 992,
    ["Bashly Settings (bashly-settings.yml)"] = 993,
    ["Better Code Hub"] = 905,
    ["Better Scripts"] = 126,
    Bigconfig = 98,
    ["Biome Formatter Config"] = 65,
    ["Bitmovin Encoding Template"] = 1080,
    BizTalkServerApplicationSchema = 873,
    Bleep = 127,
    ...
    ["Butane Config"] = 948,
    C4InterFlow = 1095,
    ["CDK Environment Manager, concrete environment configuration"] = 1119,
    ["CDK Environment Manager, concrete environments definition"] = 1118,
    ["CDK Environment Manager, environment definition"] = 1117,
    ["CGS Card Game Specification (cgs.json)"] = 1030,
    ["CICS TS region tagging"] = 957,
    ["CICS TS resource import"] = 958,
    ["CICS TS resource model"] = 959,
    ["CICS TS resource overrides"] = 960,
    ["CMake Presets"] = 128,
    ["CNC Codes"] = 149,
    ["CRS WAF test file"] = 1059,
    ["CRS WAF test platform overrides file"] = 1060,
    ...
    ["Chamaleon environment"] = 1084,
    ["Chamaleon properties"] = 1085,
    ["Chamaleon template"] = 1083,
    Changesets = 235,
    Changie = 137,
    Charmcraft = 138,
    Cheatsheets = 945,
    ...
    ["Clawject config"] = 155,
    ["Cloud Foundry Application Manifest"] = 1041,
    ["Cloud Run Spec v1"] = 1064,
    ...
    Concord = 1058,
    ["Configu .cfgu files"] = 1046,
    ["Configu .configu file"] = 1047,
    Conjure = 148,
    ["Container Structure Test"] = 887,
    Containerlab = 914,
    ["Contextive Glossary"] = 1111,
    Convex = 147,
    ["Crowdsec collection config"] = 245,
    ["Crowdsec parser config"] = 246,
    ["Crowdsec scenario config"] = 247,
    ["CumulusCI Config"] = 154,
    ["Custom Machinery Machine"] = 1031,
    ["Custom Machinery Recipe"] = 1032,
    ...
    ["DataYoga Job"] = 161,
    ["Databricks Asset Bundles"] = 1009,
    ["Datadog Continuous Testing"] = 451,
    ["Datadog Service Definition"] = 452,
    ["Datadog Software Catalog"] = 453,
    ["Datahub Ingestion Recipe"] = 964,
    ...
    ["DonateCaseBetterCasino menu"] = 1088,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1000,
    ["EAS config"] = 311,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 989,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1131,
    ["EasyVCR .NET"] = 312,
    ["Eidolon Resource"] = 1075,
    ...
    ["Evolving Resolutive Process notation"] = 1133,
    ["Expo SDK"] = 310,
    ...
    ["GeoJSON.json latest"] = 952,
    GherKing = 956,
    ["GitHub Action"] = 342,
    ["GitHub Actions typing"] = 1071,
    ...
    ["Google Digital Assetlinks"] = 1112,
    Goreleaser = 370,
    ["Goreleaser Pro"] = 371,
    Goss = 372,
    ["Gradle Build Cache Node"] = 903,
    ["Gradle Enterprise"] = 902,
    ...
    Hadolint = 883,
    Hammerkit = 913,
    ["Hardware Sentry Configuration"] = 968,
    ["HashiCorp Vault"] = 385,
    Hatch = 884,
    Hayagriva = 387,
    Hayson = 388,
    ...
    ["IVMS101 by CODE Protocol"] = 1028,
    Infrahub = 408,
    Istanbul = 971,
    ["JDownloader2 crawler multi-rules"] = 418,
    ["JDownloader2 crawler single-rules"] = 417,
    ["JFrog Applications Config"] = 419,
    ["JFrog File Spec"] = 420,
    ["JFrog Pipelines YML DSL"] = 977,
    ["JMeter DSL cli config"] = 421,
    JReleaser = 424,
    ["JSON Document Transform"] = 432,
    ["JSON Feed"] = 433,
    ["JSON Resume"] = 659,
    ["JSON Schema Draft 2020-12"] = 851,
    ["JSON Schema Draft 4"] = 848,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1010,
    ["JSON Schema Draft 7"] = 849,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1011,
    ["JSON Schema Draft 8 (2019-09)"] = 850,
    ["JSON-API"] = 431,
    ["JSON-e templates"] = 910,
    ["JSON-stat 2.0"] = 844,
    JSONPatch = 435,
    ["JSR Package Config (jsr.json)"] = 425,
    Jasmine = 412,
    Jekyll = 413,
    ["Jenkins X Pipelines"] = 414,
    ["Jenkins X Requirements"] = 415,
    Jest = 416,
    Jocker = 422,
    ["Jovo Language Models"] = 423,
    ["Jujutsu (jj) VCS config"] = 1125,
    ["KIMMDY config file"] = 446,
    ["KODE/CI build.yaml"] = 973,
    ["KSP-AVC"] = 845,
    ["KSP-CKAN"] = 846,
    ["KSP-NetKAN"] = 847,
    KSY = 1040,
    ...
    Kas = 438,
    ["Kestra flow file"] = 447,
    ["Keycloak REST API"] = 980,
    ["Knative Functions - func.yaml"] = 331,
    ["Kometa (nightly) config file"] = 449,
    ["Kometa config file"] = 448,
    ["Kong DBLess config"] = 974,
    KrakenD = 450,
    ["Kubri Configuration"] = 457,
    LOOBin = 472,
    ["Lake configuration file"] = 1128,
    ...
    ["Lando (landofile)"] = 77,
    ["LangGraph Platform configuration"] = 1051,
    ["Language configuration"] = 1050,
    Lefthook = 461,
    ["Liferay client-extension.yaml"] = 468,
    ["LinkML Metamodel"] = 470,
    Liquibase = 919,
    ["Liquibase Flow File"] = 920,
    ["Lively Properties"] = 471,
    ["Lobe AI Agent"] = 79,
    Loki = 80,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 512,
    ["MS2Rescore Configuration"] = 515,
    ["Madness (madness.yml)"] = 991,
    ["Mado configuration"] = 478,
    ["MapEHR Mapping"] = 479,
    Markdownlint = 923,
    ["Mason Registry"] = 926,
    ["MegaLinter Custom Flavor"] = 482,
    ["MegaLinter configuration"] = 481,
    ["MegaLinter descriptor"] = 483,
    Melange = 1018,
    ["Meltano project definition"] = 484,
    ["Mergify Configuration"] = 516,
    ["Metadata for a Bazel module"] = 485,
    ["Metadata for a Cinnamon spice"] = 1067,
    ["Metatype Configuration"] = 486,
    ["MetricsHub Configuration"] = 487,
    ["MetricsHub Connector Configuration"] = 488,
    ["Micro Editor Syntax"] = 1001,
    ["Microsoft Band Web Tile"] = 489,
    ["Microsoft RulesEngine workflow rules"] = 1055,
    ["Microsoft RulesEngine workflow rules list"] = 1056,
    ["Minecraft Custom Main Menu Mod"] = 1019,
    ["Minecraft Data Pack Advancement"] = 491,
    ["Minecraft Data Pack Biome"] = 492,
    ["Minecraft Data Pack Configured Carver"] = 493,
    ["Minecraft Data Pack Damage Type"] = 494,
    ["Minecraft Data Pack Dimension"] = 496,
    ["Minecraft Data Pack Dimension Type"] = 495,
    ["Minecraft Data Pack Item Modifier"] = 497,
    ["Minecraft Data Pack Loot Table"] = 498,
    ["Minecraft Data Pack Metadata"] = 499,
    ["Minecraft Data Pack Predicate"] = 500,
    ["Minecraft Data Pack Recipe"] = 501,
    ["Minecraft Data Pack Tag"] = 502,
    ["Minecraft Data Pack Template Pool"] = 503,
    ["Minecraft Data Pack Trim Material"] = 508,
    ["Minecraft Data Pack Trim Pattern"] = 509,
    ["Minecraft Resource Pack Lang"] = 504,
    ["Minecraft Resource Pack Particle"] = 505,
    ["Minecraft Resource Pack Texture Mcmeta"] = 507,
    ["Minecraft Resourcepack Sounds"] = 506,
    ["Monade CLI Stack Configuration"] = 519,
    ["MongoDB Atlas Search Index Definition"] = 972,
    ["Monika Configuration"] = 970,
    ["Monoweave Configuration"] = 514,
    ["Motif config"] = 865,
    MultiQC = 1105,
    ["NOX Framework (Service)"] = 532,
    ["Netin Diagnostic System Template"] = 930,
    ["Netlify config"] = 522,
    ["Network-as-Code Data Model"] = 523,
    ["Nightwatch.js"] = 525,
    ["Node.js configuration"] = 870,
    ["NueJS configuration file"] = 537,
    ["Nuitka.yaml"] = 1033,
    ["Nullstone config"] = 539,
    ["ONe's changelog entry"] = 554,
    ["ONe's service descriptor"] = 553,
    ["ORT Server repository environment configuration"] = 562,
    ["OSCAL Assessment Plan (AP)"] = 564,
    ["OSCAL Assessment Results (AR)"] = 565,
    ["OSCAL Catalog"] = 566,
    ["OSCAL Component Definition (CDef)"] = 567,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 568,
    ["OSCAL Profile"] = 569,
    ["OSCAL System Security Plan (SSP)"] = 570,
    ["OSS Review Toolkit configuration"] = 571,
    ["OSS Review Toolkit curation"] = 572,
    ["OSS Review Toolkit package configuration"] = 573,
    ["OSS Review Toolkit repository configuration"] = 574,
    ["OSS Review Toolkit resolutions"] = 575,
    ["October CMS columns"] = 543,
    ["October CMS fields"] = 544,
    Okteto = 545,
    ["Ona Automations"] = 547,
    Opctl = 868,
    ["Open Data Contract Standard (ODCS)"] = 557,
    ["Open Data Product Standard (ODPS)"] = 558,
    ["Open Know-How"] = 1110,
    ["OpenRewrite Resource"] = 556,
    OpenStatus = 1121,
    ["OpenUtau character yaml"] = 550,
    ["OpenUtau ustx"] = 551,
    ["OpenWeather Current Weather API"] = 909,
    ["OpenWeather Road Risk API"] = 908,
    ["Ory Hydra configuration"] = 397,
    ["Ory Keto configuration"] = 454,
    ["Ory Kratos configuration"] = 563,
    ["Ory Oathkeeper configuration"] = 541,
    ["Outblocks App configuration"] = 560,
    ["Outblocks database table"] = 561,
    ["Outblocks project configuration"] = 559,
    PDM = 581,
    Packer = 578,
    Pantsbuild = 987,
    ["Paper paper-plugin.yml"] = 579,
    ["Pipeline component"] = 921,
    ["Platform.sh application"] = 2,
    ["Platform.sh routes"] = 3,
    ["Platform.sh services"] = 4,
    ["Plex Prerolls"] = 589,
    ["PocketMine plugin.yml"] = 586,
    ["Postman collection"] = 593,
    ["Power Pages Configuration"] = 1122,
    ["Preset list for a WinUtil"] = 1070,
    ["ProActions AI-Kit Configuration"] = 602,
    ["ProActions AI-Kit Configuration for Menus"] = 604,
    ["ProActions AI-Kit Configuration for Sections"] = 606,
    ["ProActions AI-Kit Configuration for Services"] = 603,
    ["ProActions AI-Kit Configuration for Steps"] = 607,
    ["ProActions AI-Kit Configuration for Templates"] = 605,
    ["Problem object RFC9457"] = 1016,
    ["Problem package generators"] = 608,
    Pterodactyl = 967,
    ["Pull Request Labeler"] = 624,
    Pulumi = 632,
    ["PyGTA Config"] = 628,
    PyProject = 633,
    Pylock = 1113,
    Pyright = 634,
    ["Python script metadata"] = 1107,
    ["QType AI DSL"] = 637,
    Qgoda = 636,
    Qodana = 940,
    ["Qt Creator workspace file"] = 1048,
    ["Quali Torque Blueprint Spec 2"] = 965,
    ["QueryFirst config file"] = 983,
    ["RKE Cluster Configuration JSON"] = 918,
    ["RKE Cluster Configuration YAML"] = 917,
    RadioHound = 627,
    Railway = 638,
    ["Rancher Fleet"] = 629,
    ["Rattler-build"] = 639,
    Ray = 882,
    ["Read the Docs"] = 631,
    ["Red-DiscordBot Cog"] = 646,
    ["Red-DiscordBot Cog Repo"] = 647,
    ["Red-DiscordBot Trivia"] = 648,
    ["Render Blueprints"] = 916,
    RenderCV = 661,
    Renovate = 660,
    ["Replit config"] = 654,
    Restate = 1100,
    ["Revel Digital Gadget Definition File"] = 1124,
    RoadRunner = 663,
    ["Robust Station Image"] = 1130,
    ["Roo Coder Custom Modes"] = 665,
    Rubocop = 656,
    ["Rudder techniques"] = 1023,
    Ruff = 657,
    ["Rust Project"] = 658,
    ["Rust toolchain"] = 668,
    ["SDMX data message"] = 694,
    ["SDMX metadata message"] = 693,
    ["SDMX structure message"] = 692,
    ["SIL Kit Participant Configuration"] = 704,
    ["SIL Kit Registry Configuration"] = 705,
    ["SPDX 2.3"] = 741,
    SWADL = 757,
    ["Safebox Config"] = 978,
    ["Sapphire CLI Config"] = 671,
    ["SauceCTL Configuration"] = 927,
    ["Schema Catalog"] = 686,
    ["Scoop manifest"] = 691,
    ["Semantic Data Fabric (SDF) file"] = 695,
    ["Semgrep Rule"] = 697,
    ["Serenity Code Generator (Sergen)"] = 698,
    ["Serverless Framework Configuration"] = 934,
    ["Serverless Workflow"] = 936,
    ["Settings for a Cinnamon spice"] = 1066,
    ["Settings.paf"] = 700,
    ["Shopware 6 Configuration"] = 937,
    ["Shopware CLI Extension Store Configuration"] = 938,
    ["Shopware CLI Project Store Configuration"] = 939,
    ["Sigma Detection Rule"] = 702,
    ["Sigrid scope configuration file"] = 703,
    ["SkyPilot Task JSON"] = 1024,
    ["Slack app manifest"] = 707,
    Solidarity = 712,
    ["Solution filters"] = 713,
    ["Source Maps v3"] = 714,
    Sourcery = 715,
    ["Spack bootstrap.yaml"] = 716,
    ["Spack cdash.yaml"] = 717,
    ["Spack ci.yaml"] = 718,
    ["Spack compilers.yaml"] = 719,
    ["Spack concretizer.yaml"] = 720,
    ["Spack config.yaml"] = 721,
    ["Spack definitions.yaml"] = 722,
    ["Spack develop.yaml"] = 723,
    ["Spack env_vars.yaml"] = 724,
    ["Spack environment"] = 730,
    ["Spack include.yaml"] = 725,
    ["Spack mirrors.yaml"] = 726,
    ["Spack modules.yaml"] = 727,
    ["Spack packages.yaml"] = 728,
    ["Spack repos.yaml"] = 729,
    ["Spack toolchains.yaml"] = 731,
    ["Spack upstreams.yaml"] = 732,
    ["Spack view.yaml"] = 733,
    ["Speakeasy Generation Config File"] = 737,
    ["Speakeasy Lint Configuration File"] = 734,
    ["Speakeasy Test Generation Configuration File"] = 735,
    ["Speakeasy Workflow File"] = 736,
    SpecIF = 738,
    ["Sponge Mixin configuration"] = 739,
    StackBlitz = 745,
    ["StackHawk Scanner Configuration"] = 933,
    Stale = 746,
    Starfish = 747,
    ["Starlake Data Pipeline"] = 906,
    Starship = 748,
    ["Statamic Blueprint"] = 749,
    ["Stella configuration file"] = 750,
    ["Streamlit configuration file"] = 751,
    ["Stryker Mutator"] = 754,
    ["StyleCop Analyzers Configuration"] = 755,
    ["Stylelint (.stylelintrc)"] = 756,
    ["Stylua Config"] = 1114,
    ["Sublime Syntax"] = 979,
    ["Subsquid squid manifest"] = 1026,
    ["Swagger API 2.0"] = 758,
    ["Synadia Connect Component"] = 759,
    TSON = 794,
    TSTyche = 795,
    ["TYPO3 Vendor Bundler config"] = 800,
    ["Tab data for a LinUtil"] = 1073,
    ["Tab list for a LinUtil"] = 1072,
    Tach = 760,
    ["Tach Domain"] = 761,
    Talhelper = 763,
    ["Talisman configuration"] = 764,
    Taplo = 1115,
    ["Taskfile config"] = 911,
    Taurus = 765,
    Tauticord = 766,
    Telefonistka = 1101,
    ["Terrateam config"] = 1127,
    ["TestEnvironment.json"] = 777,
    ["TextMate Grammar"] = 776,
    Threagile = 772,
    ["Tier.run pricing.json"] = 769,
    Tikibase = 770,
    Tombi = 775,
    ["Traefik v2"] = 780,
    ["Traefik v2 File Provider"] = 781,
    ["Traefik v3"] = 782,
    ["Traefik v3 File Provider"] = 783,
    ["Travis CI (.travis.yml)"] = 779,
    Treefmt = 375,
    Trident = 1097,
    ["TrueScript for *.tscript files"] = 786,
    ["Tugboat QA config.yml"] = 1094,
    TunnelHub = 1014,
    Turborepo = 778,
    Tycho = 1062,
    Tye = 941,
    ["Tyk Gateway - Open Source v5.7+"] = 1106,
    ["Typst Manifest"] = 801,
    ["UET BuildConfig.json"] = 984,
    ["UI5 Manifest"] = 807,
    ["UNCORS configuration"] = 811,
    ["UTAM Page Object"] = 810,
    ["Ubuntu Server Autoinstall"] = 805,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1098,
    ["Uniswap Token List"] = 894,
    ["Universal Schedule Format"] = 812,
    ["Unreal Engine Uplugin"] = 985,
    ["Unreal Engine Uproject"] = 986,
    ["UpCloud CLI (upctl) configuration"] = 1099,
    ["Updatecli Compose"] = 949,
    ["Updatecli Policy Manifest"] = 950,
    ["Updatecli Policy Metadata"] = 951,
    Uplift = 982,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 915,
    V2Ray = 955,
    ["VSCode Code Snippets"] = 210,
    ["VSIX CLI publishing"] = 832,
    Vector = 814,
    ["Vela Pipeline Configuration"] = 817,
    Vercel = 209,
    ["Version Bumper config"] = 822,
    ["Viash Component Config"] = 1103,
    ["Viash Package Config"] = 1104,
    Visivo = 1012,
    ["WP-CLI"] = 842,
    Wake = 1096,
    ["Waku Config"] = 1076,
    ["Web App Manifest"] = 838,
    ["Web types"] = 841,
    WebExtensions = 837,
    ["Webman package recipe"] = 961,
    ["Windows Package Manager Installer Manifest"] = 890,
    ["Windows Package Manager Locale Manifest"] = 891,
    ["Windows Package Manager Singleton Manifest"] = 889,
    Winutil = 892,
    ["WireMock stub mapping"] = 1079,
    ["Woodpecker pipeline config"] = 929,
    ["Wrangler CLI"] = 843,
    ["Xstate Machine"] = 947,
    ["Yandex Workflow Language"] = 1068,
    ["Yarn Config (.yarnrc.yml)"] = 904,
    ["Yippee-Ki-JSON configuration YML"] = 896,
    ["YouTrack App"] = 1065,
    ["Zarf Package Configuration"] = 1129,
    ["Zerops.io config"] = 1053,
    ["Zerops.io import"] = 1054,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 1017,
    ...
    ["behat.yml"] = 108,
    ["bigquery-table"] = 97,
    ["bioimageio resource description"] = 1034,
    ...
    ["crowdin.yml"] = 244,
    ["ctfd-setup configuration file"] = 1086,
    ["custom-elements.json"] = 1004,
    ["cypress.json"] = 248,
    ...
    ["gematik health care insurance list"] = 1092,
    ["gematik health care patient list"] = 1089,
    ["gematik health care provider institution list"] = 1091,
    ["gematik health care provider list"] = 1090,
    ["gematik tiger test environment configuration"] = 1093,
    ["gitlab-ci"] = 350,
    ["global.json"] = 366,
    ...
    ["ize.toml"] = 981,
    ["jsconfig.json"] = 436,
    ["jscpd Configuration"] = 966,
    jsdoc = 881,
    ["k3d.yaml"] = 437,
    ["k9s aliases.yaml"] = 439,
    ["k9s cluster-config.yaml"] = 441,
    ["k9s config.yaml"] = 440,
    ["k9s hotkeys.yaml"] = 442,
    ["k9s plugins.yaml"] = 443,
    ["k9s skin.yaml"] = 444,
    ["k9s views.yaml"] = 445,
    ["kontinuous-config.yaml"] = 456,
    ["kontinuous-values.yaml"] = 455,
    ["kustomization.yaml"] = 458,
    ["label-commenter-config.yml"] = 459,
    ["latexindent configuration"] = 78,
    ["launchsettings.json"] = 460,
    lazydocker = 1003,
    lazygit = 1002,
    ["lego.json"] = 462,
    ["lerna.json"] = 463,
    ["lgtm.yml"] = 464,
    ["liblab.config.json"] = 465,
    ["libman.json"] = 466,
    ["license-report-config.json"] = 467,
    ["linkinator.config.json"] = 469,
    ["lint-staged (.lintstagedrc)"] = 859,
    ["local.settings.json"] = 474,
    ["localazy.json"] = 475,
    ["lotus.yaml"] = 473,
    ["lsdlschema.json"] = 476,
    ["markdown-link-check"] = 924,
    maturin = 925,
    mboats = 932,
    ["micro-settings.json"] = 996,
    ["mimetypes.json"] = 490,
    ["mirrord config"] = 861,
    mise = 862,
    ["mkdocs.yml"] = 510,
    ["monospace.yml"] = 513,
    ["moon.yml"] = 1078,
    ["mprocs Configuration file"] = 1049,
    ["mrdocs.yml"] = 511,
    ["mta.yaml"] = 863,
    ["mtad.yaml"] = 864,
    ["mycode.json"] = 520,
    nFPM = 524,
    ["napari plugin manifest"] = 521,
    neoload = 876,
    ["nest-cli"] = 527,
    ["ninjs (News in JSON)"] = 526,
    ["nitro.json"] = 875,
    ["nixd configuration"] = 1022,
    ["nlu.json"] = 528,
    ["nodemon.json"] = 530,
    ["noodl config"] = 931,
    ["notebook.mod.json"] = 531,
    now = 871,
    ["npm-badges"] = 534,
    ["nswag.json"] = 538,
    ntangle = 540,
    ["nuclei-template.yaml"] = 535,
    ["nuget-project.json"] = 536,
    ["ocelot.json"] = 542,
    ["omnisharp.json"] = 546,
    ["openapi.json"] = 548,
    ["openfin.json"] = 555,
    ...
    ["ops.yaml"] = 552,
    ["package.json"] = 576,
    ["package.manifest"] = 577,
    ["partial-black.json"] = 109,
    ["pathfinder.yml"] = 580,
    ["pattern.json"] = 583,
    ["petstore-v1.0"] = 976,
    pgap_yaml_input_reader = 582,
    ["pixi.toml"] = 584,
    ["plagiarize-me.yaml"] = 588,
    ["plagiarize.yaml"] = 587,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1082,
    ["podbard.yaml"] = 590,
    ["portman.json"] = 591,
    ["prefect.toml"] = 599,
    ["prettierrc.json"] = 600,
    ["prisma.yml"] = 601,
    ["project-1.0.0-beta3.json"] = 610,
    ["project-1.0.0-beta4.json"] = 611,
    ["project-1.0.0-beta5.json"] = 612,
    ["project-1.0.0-beta6.json"] = 613,
    ["project-1.0.0-beta8.json"] = 614,
    ["project-1.0.0-rc1.json"] = 615,
    ["project-1.0.0-rc2.json"] = 616,
    ["project.json"] = 609,
    ["project.owasp.yaml"] = 617,
    ["prometheus.json"] = 618,
    ["prometheus.rules.json"] = 619,
    ["prometheus.rules.test.json"] = 620,
    ["proxies.json"] = 621,
    ["publiccode.yml"] = 622,
    ["pubspec.yaml"] = 623,
    ["pyrseas-0.8.json"] = 626,
    pytest = 635,
    ["quilt.mod.json"] = 997,
    ["rc3 auth"] = 640,
    ["rc3 collection"] = 641,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 877,
    ["release-please-config.json"] = 650,
    ["release-please-manifest.json"] = 651,
    ["release-plz.toml"] = 652,
    ["renv.lock"] = 662,
    ["rivet.json"] = 1021,
    ["rivet.yaml (legacy)"] = 1020,
    rockcraft = 664,
    runny = 666,
    rustfmt = 667,
    sake = 1109,
    samt = 669,
    samtrc = 670,
    ["sarif-1.0.0.json"] = 672,
    ["sarif-2.0.0.json"] = 673,
    ["sarif-2.1.0"] = 683,
    ["sarif-2.1.0-rtm.2"] = 674,
    ["sarif-2.1.0-rtm.3"] = 676,
    ["sarif-2.1.0-rtm.4"] = 678,
    ["sarif-2.1.0-rtm.5"] = 680,
    ["sarif-2.1.0-rtm.6"] = 681,
    ["sarif-external-property-file-2.1.0"] = 684,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 675,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 677,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 679,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 682,
    ["scalingo.json configuration"] = 685,
    ["schema.org - Action"] = 687,
    ["schema.org - ContactPoint"] = 688,
    ["schema.org - Place"] = 689,
    ["schema.org - Thing"] = 690,
    ["secrethub.yml"] = 999,
    ["semantic-release"] = 696,
    ["servicehub.config.json"] = 854,
    ["servicehub.service.json"] = 853,
    ["settings.job"] = 699,
    ["sfdx-hardis configuration"] = 701,
    ["shard.yml"] = 1037,
    ["size-limit configuration"] = 706,
    ["skaffold.yaml"] = 922,
    ["skyuxconfig.json"] = 708,
    snapcraft = 709,
    ["snowflake-config"] = 710,
    ["snowflake-connections"] = 711,
    ["spicepod.yaml"] = 1057,
    ["sqlc configuration"] = 742,
    ["stripe-app-local.json"] = 753,
    ["stripe-app.json"] = 752,
    swcrc = 907,
    ["task.json"] = 762,
    taskcat = 872,
    ["template.json"] = 767,
    ["templatsources.json"] = 768,
    ["theme.json"] = 771,
    ["tizen_workspace.json"] = 773,
    tldr = 774,
    ["tm_devices configuration file"] = 1120,
    tmuxinator = 857,
    ["transcend.yml"] = 784,
    ["tree-sitter grammar.json"] = 374,
    ["trime.yaml"] = 785,
    ["trunk.yaml"] = 787,
    ["ts-force-config.json"] = 792,
    ["tsconfig.json"] = 788,
    ["tsd.json"] = 789,
    ["tsdoc.json"] = 790,
    ["tsdrc.json"] = 791,
    ...
    ["vega-lite.json"] = 816,
    ["vega.json"] = 815,
    ["venvironment-basic.yaml"] = 819,
    ["venvironment.yaml"] = 818,
    ["venvplus-basic.yaml"] = 821,
    ["venvplus.yaml"] = 820,
    version = 1102,
    ["version.json"] = 823,
    ["vhwdebugger-binding.yaml"] = 825,
    ["vim-addon-info"] = 826,
    ["vs-2017.3.host.json"] = 828,
    ["vs-nesting.json"] = 829,
    ["vsls.json"] = 827,
    ["vss-extension.json"] = 833,
    vtcfg = 1108,
    ["vtesttree.yaml"] = 834,
    ["vtestunit.yaml"] = 835,
    ["warp-keysets.json"] = 1005,
    ["warp-themes.json"] = 1006,
    ["warp-workflows.json"] = 1007,
    ["webhint.io"] = 962,
    ["webjobpublishsettings.json"] = 840,
    ["webjobs-list.json"] = 839,
    ["well-known-fursona"] = 1044,
    ["xs-app.json"] = 867,
    ["xunit.runner.json"] = 852,
    yamllint = 895,
    zuul = 878,
    ["Žinoma"] = 888
  },
