...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 143,
    [".cryproj (generic)"] = 486,
    [".cryproj engine-5.2"] = 481,
    [".cryproj engine-5.3"] = 482,
    [".cryproj engine-5.4"] = 483,
    [".cryproj engine-5.5"] = 484,
    [".cryproj engine-dev"] = 485,
    [".csscomb.json"] = 145,
    [".csslintrc"] = 146,
    [".eslintrc"] = 191,
    [".esmrc.json"] = 183,
    ...
    [".mtaext"] = 495,
    [".nodehawkrc"] = 307,
    [".npmpackagejsonlintrc"] = 309,
    [".phraseapp.yml"] = 343,
    [".pmbot.yml"] = 335,
    [".postcssrc"] = 340,
    [".pre-commit-config.yml"] = 341,
    [".pre-commit-hooks.yml"] = 342,
    [".putout.json"] = 360,
    [".rehyperc"] = 366,
    [".remarkrc"] = 367,
    [".sprite files"] = 409,
    ...
    [".vsext"] = 461,
    [".yarnrc.yml"] = 527,
    ["<div>RIOTS' studio configuration"] = 465,
    ["@factorial/drupal-breakpoints-css"] = 4,
    ["API Builder"] = 524,
    ["AVA Configuration Schema"] = 579,
    ["AWS CDK cdk.json"] = 131,
    ["AWS CloudFormation"] = 132,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 133,
    ["Airlock Microgateway"] = 8,
    ["Airplane task"] = 9,
    ["Alacritty Configuration Schema"] = 554,
    ["Ansible Argument Specs"] = 15,
    ["Ansible Collection Galaxy"] = 21,
    ["Ansible Execution Environment"] = 12,
    ["Ansible Inventory"] = 20,
    ["Ansible Meta"] = 13,
    ["Ansible Meta Runtime"] = 14,
    ["Ansible Navigator Configuration"] = 23,
    ["Ansible Playbook"] = 19,
    ["Ansible Requirements"] = 16,
    ["Ansible Tasks File"] = 18,
    ["Ansible Vars File"] = 17,
    ["Ansible-lint Configuration"] = 22,
    ...
    AsyncAPI = 36,
    ["Avro Avsc"] = 37,
    ["Azure Device Update for IoT Hub import manifest"] = 38,
    ["Azure Device Update for IoT Hub update manifest"] = 39,
    ["Azure IoT Edge deployment"] = 42,
    ["Azure IoT Edge deployment template"] = 43,
    ["Azure IoT EdgeAgent deployment"] = 40,
    ["Azure IoT EdgeHub deployment"] = 41,
    ["Azure Pipelines"] = 44,
    ["Azure Static Web Apps CLI configuration file"] = 411,
    ["Azure Static Web Apps configuration file"] = 410,
    ["BX CI"] = 75,
    ["Better Code Hub"] = 529,
    ["Better Scripts"] = 76,
    BizTalkServerApplicationSchema = 501,
    ["Block Protocol Metadata"] = 74,
    Briefcase = 506,
    ["Build Info"] = 67,
    Buildkite = 69,
    ["Bukkit plugin.yml"] = 68,
    ["BungeeCord plugin.yml"] = 72,
    ["Butane Config"] = 566,
    ["CICS TS region tagging"] = 573,
    ["CICS TS resource import"] = 574,
    ["CICS TS resource model"] = 575,
    ["CICS TS resource overrides"] = 576,
    ["CMake Presets"] = 77,
    ["CNC Codes JSON Schema"] = 86,
    ["CSR Framework"] = 89,
    ["Calqulus pipeline"] = 78,
    ["Camel YAML DSL"] = 79,
    Carafe = 80,
    ["Cargo Config Schema"] = 81,
    ["Cargo Make"] = 82,
    ["Catalog Info Backstage"] = 83,
    Cheatsheets = 563,
    ["Chrome Extension"] = 125,
    ["CircleCI config.yml"] = 107,
    ["Citation File Format"] = 134,
    CityJSON = 84,
    ["Code Climate"] = 108,
    Codux = 114,
    ["Commandbox Box.json"] = 87,
    ["Commandbox Server.json"] = 88,
    ["Common Catalog Schema"] = 123,
    ["Common types for all schemas"] = 1,
    Conjure = 85,
    ["Container Structure Test"] = 512,
    Containerlab = 536,
    ["DWP Exchange - catalogue entry"] = 180,
    ["DWP Exchange - gateway"] = 178,
    ["DWP Exchange - meta"] = 179,
    ["Dart build configuration"] = 147,
    ["Dart test config"] = 148,
    ["DashLord configuration"] = 149,
    ["Datadog Service Definition"] = 264,
    ["Datahub Ingestion Recipe Schema"] = 580,
    ["Deadpendency Config Schema"] = 90,
    ["Dein Config Schema"] = 91,
    Deno = 153,
    ["Deployer Recipe"] = 156,
    Devfile = 177,
    ["Discord Webhook"] = 158,
    ["Dolittle Artifacts"] = 162,
    ["Dolittle Bounded Context Configuration"] = 163,
    ["Dolittle Event Horizons Configuration"] = 164,
    ["Dolittle Resources Configuration"] = 165,
    ["Dolittle Server Configuration"] = 166,
    ["Dolittle Tenant Map Configuration"] = 168,
    ["Dolittle Tenants Configuration"] = 167,
    ["Dolittle Topology"] = 169,
    ["Drupal Breakpoints Schema"] = 92,
    ["Drupal Config Schema"] = 103,
    ["Drupal Info Schema"] = 93,
    ["Drupal Layouts Schema"] = 94,
    ["Drupal Libraries Schema"] = 95,
    ["Drupal Links Action Schema"] = 96,
    ["Drupal Links Contextual Schema"] = 97,
    ["Drupal Links Menu Schema"] = 98,
    ["Drupal Links Task Schema"] = 99,
    ["Drupal Migration Schema"] = 100,
    ["Drupal Permissions Schema"] = 101,
    ["Drupal Routing Schema"] = 102,
    ["Drupal Services Schema"] = 104,
    ["Drush site aliases"] = 173,
    ["Embrace Config Schema"] = 591,
    ["Error pages"] = 186,
    Esquio = 184,
    ["Estuary Flow Catalog Schema"] = 570,
    ["Expo SDK"] = 189,
    ["F-Droid Data metadata"] = 194,
    ["Facets - FSDL - Application"] = 192,
    ["Fossa configuration file"] = 199,
    ["Fossa's fossa-deps file"] = 200,
    ["Foundry VTT - Manifest"] = 197,
    ["Foundry VTT - Template"] = 198,
    ["Foxx Manifest"] = 45,
    ["GatewayCore API Gateway"] = 203,
    ["GeoJSON.json latest"] = 568,
    GherKing = 572,
    ["GitHub Action"] = 207,
    ["GitHub Funding"] = 208,
    ["GitHub Issue Template configuration"] = 210,
    ["GitHub Workflow"] = 211,
    ["GitHub Workflow Template Properties"] = 212,
    ["GitHub issue forms"] = 209,
    GitVersion = 206,
    ["Gitpod Configuration"] = 214,
    ["Global Privacy Control"] = 204,
    ["Google Cloud Workflows"] = 130,
    Goreleaser = 217,
    ["Goreleaser Pro"] = 218,
    ["Gradle Build Cache Node"] = 526,
    ["Gradle Enterprise"] = 525,
    ["Grafana 5.x Dashboard"] = 219,
    ["GraphQL Code Generator"] = 222,
    ["GraphQL Config"] = 221,
    ["GraphQL Mesh"] = 220,
    ["Grunt JSHint task"] = 226,
    ["Grunt Watch task"] = 227,
    ["Grunt base task"] = 228,
    ["Grunt clean task"] = 224,
    ["Grunt copy task"] = 223,
    ["Grunt cssmin task"] = 225,
    HEMTT = 498,
    Hadolint = 510,
    ["Hardware Sentry Configuration"] = 584,
    Hayson = 230,
    ["Haystack Pipeline"] = 231,
    ["Hazelcast 5 Configuration"] = 232,
    ["Helm Chart.lock"] = 106,
    ["Helm Chart.yaml"] = 105,
    Hugo = 562,
    ["Istanbul Schema"] = 587,
    ["JDownloader2 crawler multi-rule schema"] = 248,
    ["JDownloader2 crawler single-rule schema"] = 247,
    ["JFrog File Spec"] = 249,
    ["JFrog Pipelines YML DSL"] = 593,
    ["JSON Document Transform"] = 257,
    ["JSON Feed"] = 258,
    ["JSON Resume"] = 371,
    ["JSON Schema Draft 2020-12"] = 477,
    ["JSON Schema Draft 4"] = 474,
    ["JSON Schema Draft 7"] = 475,
    ["JSON Schema Draft 8"] = 476,
    ["JSON schema for CodeShip Pro services configuration files"] = 116,
    ["JSON schema for CodeShip Pro steps configuration files"] = 117,
    ["JSON schema for Codecov configuration files"] = 115,
    ["JSON-API"] = 256,
    ["JSON-e templates"] = 534,
    ["JSON-stat 2.0"] = 471,
    JSONPatch = 260,
    Jasmine = 243,
    Jekyll = 244,
    ["Jenkins X Pipelines"] = 245,
    ["Jenkins X Requirements"] = 246,
    ["Jovo Language Models"] = 250,
    ["KSP-AVC"] = 472,
    ["KSP-CKAN"] = 473,
    ["Keycloak REST API"] = 599,
    ["Knative Functions - func.yaml"] = 201,
    ["KoDE/CI build.yaml"] = 589,
    ["Kong DBLess Schema"] = 590,
    KrakenD = 263,
    ["LinkML Metamodel"] = 275,
    Liquibase = 540,
    ["Liquibase Flow File"] = 541,
    Markdownlint = 544,
    ["MegaLinter configuration"] = 279,
    ["MegaLinter descriptor"] = 280,
    ["Meltano plugin discovery definition"] = 282,
    ["Meltano project definition"] = 281,
    ["Microsoft Band Web Tile"] = 283,
    ["Minecraft Data Pack Advancement"] = 285,
    ["Minecraft Data Pack Biome"] = 286,
    ["Minecraft Data Pack Configured Carver"] = 287,
    ["Minecraft Data Pack Dimension"] = 289,
    ["Minecraft Data Pack Dimension Type"] = 288,
    ["Minecraft Data Pack Item Modifier"] = 290,
    ["Minecraft Data Pack Loot Table"] = 291,
    ["Minecraft Data Pack Metadata"] = 292,
    ["Minecraft Data Pack Predicate"] = 293,
    ["Minecraft Data Pack Recipe"] = 294,
    ["Minecraft Data Pack Template Pool"] = 295,
    ["Minecraft Resourcepack Sounds"] = 296,
    ["MongoDB Atlas Search Index Definition Schema"] = 588,
    ["Monika Configuration Schema"] = 586,
    ["Motif config"] = 494,
    ["Netin Diagnostic System Template"] = 549,
    ["Netlify config schema"] = 301,
    ["Nightwatch.js"] = 302,
    ["OSS Review Toolkit configuration"] = 325,
    ["OSS Review Toolkit curation"] = 326,
    ["OSS Review Toolkit package configuration"] = 327,
    ["OSS Review Toolkit repository configuration"] = 328,
    ["OSS Review Toolkit resolutions"] = 329,
    Opctl = 497,
    ["OpenWeather Current Weather API"] = 533,
    ["OpenWeather Road Risk API"] = 532,
    ["Ory Hydra configuration"] = 236,
    ["Ory Keto configuration"] = 265,
    ["Ory Kratos configuration"] = 324,
    ["Ory Oathkeeper configuration"] = 315,
    ["Outblocks App configuration"] = 322,
    ["Outblocks database table"] = 323,
    ["Outblocks project configuration"] = 321,
    Packer = 332,
    ["Pipeline component"] = 542,
    ["PocketMine plugin.yml"] = 336,
    Pterodactyl = 583,
    ["Pull Request Labeler"] = 359,
    PyProject = 363,
    Qodana = 559,
    ["Quali Torque Blueprint Spec 2"] = 581,
    ["QueryFirst config file"] = 602,
    ["RKE Cluster Configuration JSON Schema"] = 539,
    ["RKE Cluster Configuration YAML Schema"] = 538,
    Ray = 509,
    ["Read the Docs"] = 362,
    ["Red-DiscordBot Cog"] = 364,
    ["Red-DiscordBot Cog Repo"] = 365,
    Renovate = 372,
    ["Replit schema"] = 368,
    RoadRunner = 373,
    ["Rust Project"] = 370,
    ["Rust toolchain"] = 375,
    ["SIL Kit Participant Configuration"] = 400,
    SWADL = 420,
    ["Sapphire CLI Config"] = 376,
    ["SauceCTL Configuration"] = 546,
    ["Schema Catalog"] = 389,
    ["Scoop manifest"] = 394,
    ["Semgrep Rule"] = 396,
    ["Serverless Framework Configuration"] = 553,
    ["Serverless Workflow Schema"] = 555,
    ["Settings.paf"] = 398,
    ["Shopware 6 Configuration"] = 556,
    ["Shopware CLI Extension Store Configuration"] = 557,
    ["Shopware CLI Project Store Configuration"] = 558,
    Solidarity = 404,
    ["Solution filters"] = 405,
    ["Source Maps v3"] = 406,
    SpecIF = 407,
    ["Sponge Mixin configuration"] = 408,
    ["StackHawk Scanner Configuration"] = 552,
    Stale = 412,
    Starship = 413,
    ["Statamic Blueprint"] = 414,
    ["StrmPrivacy Data Connector"] = 597,
    ["StrmPrivacy Data Contract"] = 598,
    ["StrmPrivacy SimpleSchema"] = 595,
    ["StrmPrivacy Stream"] = 596,
    ["StrmPrivacy batch job configuration file"] = 594,
    ["Stryker Mutator"] = 417,
    ["StyleCop Analyzers Configuration"] = 418,
    ["Swagger API 2.0"] = 421,
    TSON = 441,
    ["Talisman configuration"] = 422,
    ["Taskfile YAML Schema"] = 535,
    Taurus = 423,
    ["TestEnvironment.json"] = 430,
    Tikibase = 426,
    ["Traefik v2"] = 433,
    ["Traefik v2 File Provider"] = 434,
    Turborepo = 431,
    Tye = 560,
    ["UI5 Manifest"] = 447,
    ["UTAM Page Object"] = 449,
    ["Ubuntu Server Autoinstall"] = 445,
    ["Uniswap Token List"] = 518,
    ["Unreal Engine Uplugin"] = 603,
    ["Unreal Engine Uproject"] = 604,
    Updatecli = 567,
    Uplift = 601,
    ["User Journey Map YAML Schema"] = 537,
    V2Ray = 571,
    ["VSCode Code Snippets"] = 119,
    ["VSIX CLI publishing"] = 462,
    ["Vela Pipeline Configuration"] = 452,
    Vercel = 118,
    ["Web App Manifest"] = 467,
    ["Web types"] = 470,
    WebExtensions = 466,
    ["Webman package recipe"] = 577,
    ["Windows Package Manager Installer Manifest"] = 515,
    ["Windows Package Manager Locale Manifest"] = 516,
    ["Windows Package Manager Singleton Manifest"] = 514,
    ["Woodpecker pipeline config"] = 548,
    ["Xstate Machine Schema"] = 565,
    ["Yippee-Ki-JSON configuration YML"] = 520,
    ["angular.json"] = 10,
    ["app-definition.yaml"] = 25,
    ...
    ["arc.json"] = 31,
    ["architect.yml"] = 30,
    ["artifacthub-repo.yml"] = 34,
    ["babelrc.json"] = 48,
    ["bamboo-spec"] = 51,
    ["base-04"] = 2,
    ["batect.yml"] = 50,
    ["beau.yml"] = 528,
    ["beef-database-codegen"] = 52,
    ["beef-database-v5-codegen"] = 54,
    ["beef-entity-codegen"] = 53,
    ["beef-entity-v5-codegen"] = 55,
    ["behat.yml"] = 63,
    ["bigquery-table"] = 56,
    ["bitbucket-pipelines"] = 57,
    bitrise = 58,
    ["bitrise-step"] = 59,
    ["block.json"] = 73,
    ["bower.json"] = 61,
    ["bozr.suite.json"] = 64,
    ["browser.i18n.json"] = 65,
    bucklescript = 66,
    ["bundleconfig.json"] = 71,
    ["chutzpah.json"] = 126,
    ["cloud-init: cloud-config userdata JSON schema"] = 112,
    ["cloud-sdk-pipeline-config-schema"] = 128,
    ["cloudbuild.json"] = 129,
    cloudify = 111,
    codemagic = 113,
    ["coffeelint.json"] = 135,
    comet = 530,
    ["commands.json"] = 122,
    ["compile_commands.json"] = 121,
    ["compilerconfig.json"] = 120,
    ["component-detection-manifest.json"] = 138,
    ["component.json"] = 137,
    ["composer.json"] = 136,
    ["config.json"] = 139,
    ["contentmanifest.json"] = 127,
    ["contribute.json"] = 140,
    ["cosmos.config.json"] = 124,
    ["crowdin.yml"] = 141,
    cspell = 144,
    ["cypress.json"] = 142,
    ["datalogic-scan2deploy-android"] = 150,
    ["datalogic-scan2deploy-ce"] = 151,
    ["debugsettings.json"] = 152,
    ["dependabot-v2.json"] = 155,
    ["dependabot.json"] = 154,
    ["deployed-cli"] = 564,
    ["detekt.yml"] = 157,
    devinit = 522,
    ["devspace.yaml"] = 585,
    ["docfx.json"] = 161,
    ["docker-compose.yml"] = 521,
    ["docker-seq schema"] = 160,
    ["dockerd.json"] = 159,
    ["dotnet Release Index manifest"] = 170,
    ["dotnetcli.host.json"] = 171,
    ["drone.json"] = 172,
    ["dss-2.0.0.json"] = 174,
    ["dstack Workflows"] = 175,
    ["dvc.yaml"] = 176,
    ["ecosystem.json"] = 181,
    eksctl = 182,
    ["electron-builder configuration file."] = 187,
    ["epr-manifest.json"] = 185,
    ["evcc.yaml"] = 188,
    ["ezd schema"] = 190,
    ["fabric.mod.json"] = 193,
    ["first-timers-bot"] = 196,
    ["fly.io Schema"] = 46,
    fulibWorkflows = 547,
    ["function.json"] = 202,
    ["geojson.json"] = 205,
    ["gitlab-ci"] = 213,
    ["global.json"] = 215,
    ["golangci-lint Configuration"] = 216,
    ["haxelib.json"] = 229,
    helmfile = 511,
    ["host-meta.json"] = 234,
    ["host.json"] = 233,
    ...
    huskyrc = 489,
    ["ide.host.json"] = 237,
    ["imageoptimizer.json"] = 238,
    ["importmap.json"] = 240,
    ["ioBroker JSON UI"] = 241,
    ["ioBroker Package manifest"] = 242,
    ["ize.toml"] = 600,
    ["jsconfig.json"] = 261,
    ["jscpd Configuration Schema"] = 582,
    jsdoc = 508,
    ["k3d.yaml"] = 262,
    ["kustomization.yaml"] = 266,
    ["label-commenter-config.yml"] = 267,
    ["launchsettings.json"] = 268,
    ["lego.json"] = 269,
    ["lerna.json"] = 270,
    ["lgtm.yml"] = 271,
    ["libman.json"] = 272,
    ["license-report-config.json"] = 273,
    ["linkinator.config.json"] = 274,
    ["local.settings.json"] = 276,
    ["localazy.json"] = 277,
    ["lsdlschema.json"] = 278,
    ["markdown-lint-check"] = 545,
    mboats = 551,
    ["mimetypes.json"] = 284,
    ["mirrord-schema"] = 491,
    ["mta.yaml"] = 492,
    ["mtad.yaml"] = 493,
    ["mycode.json"] = 299,
    ["napari plugin manifest"] = 300,
    neoload = 503,
    ["nest-cli"] = 305,
    ["ninjs (News in JSON) 1.3"] = 304,
    ["ninjs (News in JSON) 2.0"] = 303,
    ["nlu.json"] = 306,
    ["nodemon.json"] = 308,
    ["noodl.schema.json"] = 550,
    now = 499,
    ["npm-badges"] = 310,
    ["nswag.json"] = 313,
    ntangle = 314,
    ["nuclei-template.yaml"] = 311,
    ["nuget-project.json"] = 312,
    ["ocelot.json"] = 316,
    ["omnisharp.json"] = 317,
    ["openapi.json"] = 318,
    ["openfin.json"] = 320,
    ["openrpc.json"] = 319,
    ["package.json"] = 330,
    ["package.manifest"] = 331,
    ["pattern.json"] = 334,
    ["petstore-v1.0"] = 592,
    pgap_yaml_input_reader = 333,
    ["plagiarize-me.yaml"] = 338,
    ["plagiarize.yaml"] = 337,
    ["portman.json"] = 339,
    ["prettierrc.json"] = 344,
    ["prisma.yml"] = 345,
    ["project-1.0.0-beta3.json"] = 347,
    ["project-1.0.0-beta4.json"] = 348,
    ["project-1.0.0-beta5.json"] = 349,
    ["project-1.0.0-beta6.json"] = 350,
    ["project-1.0.0-beta8.json"] = 351,
    ["project-1.0.0-rc1.json"] = 352,
    ["project-1.0.0-rc2.json"] = 353,
    ["project.json"] = 346,
    ["prometheus.json"] = 354,
    ["prometheus.rules.json"] = 355,
    ["proxies.json"] = 356,
    ["publiccode.yml"] = 357,
    ["pubspec.yaml"] = 358,
    ["pyrseas-0.8.json"] = 361,
    ["release drafter"] = 504,
    rustfmt = 374,
    ["sarif-1.0.0.json"] = 377,
    ["sarif-2.0.0.json"] = 378,
    ["sarif-2.1.0"] = 387,
    ["sarif-2.1.0-rtm.2"] = 379,
    ["sarif-2.1.0-rtm.3"] = 381,
    ["sarif-2.1.0-rtm.4"] = 383,
    ["sarif-2.1.0-rtm.5"] = 385,
    ["sarif-external-property-file-2.1.0"] = 388,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 380,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 382,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 384,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 386,
    ["schema.org - Action"] = 390,
    ["schema.org - ContactPoint"] = 391,
    ["schema.org - Place"] = 392,
    ["schema.org - Thing"] = 393,
    ["semantic-release"] = 395,
    ["servicehub.config.json"] = 480,
    ["servicehub.service.json"] = 479,
    ["settings.job"] = 397,
    ["sfdx-hardis configuration"] = 399,
    ["size-limit configuration"] = 401,
    ["skaffold.yaml"] = 543,
    ["skyuxconfig.json"] = 402,
    snapcraft = 403,
    ["stripe-app-local.json"] = 416,
    ["stripe-app.json"] = 415,
    swcrc = 531,
    taskcat = 500,
    ["template.json"] = 424,
    ["templatsources.json"] = 425,
    ["theme.json"] = 427,
    ["tizen_workspace.json"] = 428,
    tmLanguage = 429,
    tmuxinator = 488,
    ["trunk.yaml schema"] = 435,
    ["ts-force-config.json"] = 439,
    ["tsconfig.json"] = 436,
    ["tsd.json"] = 437,
    ["tsdrc.json"] = 438,
    ["tslint.json"] = 440,
    ...
    ["vega-lite.json"] = 451,
    ["vega.json"] = 450,
    ["venvironment-basic.yaml"] = 454,
    ["venvironment.yaml"] = 453,
    ["version.json"] = 455,
    ["vim-addon-info"] = 456,
    ["vs-2017.3.host.json"] = 458,
    ["vs-nesting.json"] = 459,
    ["vsls.json"] = 457,
    ["vss-extension.json"] = 463,
    ["webhint.io"] = 578,
    ["webjobpublishsettings.json"] = 469,
    ["webjobs-list.json"] = 468,
    ["xs-app.json"] = 496,
    ["xunit.runner.json"] = 478,
    yamllint = 519,
    zuul = 505,
    ["Žinoma"] = 513
  },
