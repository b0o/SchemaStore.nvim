...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 820,
    [".nodehawkrc"] = 511,
    [".npmpackagejsonlintrc"] = 515,
    [".omletrc"] = 996,
    [".phrase.yml"] = 577,
    [".phraseapp.yml"] = 578,
    [".pmbot.yml"] = 565,
    [".postcssrc"] = 572,
    [".powerpages-web-template-manifest"] = 574,
    [".pre-commit-config.yml"] = 575,
    [".pre-commit-hooks.yml"] = 576,
    [".putout.json"] = 605,
    [".rehyperc"] = 628,
    [".remarkrc"] = 632,
    [".sprite files"] = 700,
    ...
    ["A micro editor config"] = 463,
    ABCInventoryModuleData = 18,
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1040,
    ["API Builder"] = 855,
    ["AVA Configuration"] = 917,
    ["AWS AppConfig Feature Flags-v1"] = 49,
    ["AWS CDK cdk.json"] = 213,
    ["AWS CloudFormation"] = 214,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 215,
    ["AWS SAM CLI Samconfig"] = 216,
    ["Adobe UXP Manifest"] = 979,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1068,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 889,
    ["All Contributors configuration file"] = 942,
    ["Ansible Argument Specs"] = 346,
    ["Ansible Collection Galaxy"] = 353,
    ["Ansible Execution Environment"] = 343,
    ["Ansible Inventory"] = 352,
    ["Ansible Meta"] = 344,
    ["Ansible Meta Runtime"] = 345,
    ["Ansible Navigator Configuration"] = 355,
    ["Ansible Playbook"] = 350,
    ["Ansible Requirements"] = 347,
    ["Ansible Rulebook"] = 351,
    ["Ansible Tasks File"] = 349,
    ["Ansible Vars File"] = 348,
    ["Ansible-lint Configuration"] = 354,
    Any = 1005,
    ["AnyWork Automation Configuration"] = 9,
    ["App config Spotify Backstage"] = 25,
    ["Application Accelerator"] = 6,
    ["Application list for a WinUtil"] = 1022,
    ArchitectFX = 1027,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure Pipelines"] = 77,
    ["Azure Static Web Apps CLI configuration file"] = 704,
    ["Azure Static Web Apps configuration file"] = 703,
    ["BOSH Deploy Config"] = 101,
    ["BX CI"] = 120,
    ["Bashly (bashly.yml)"] = 946,
    ["Bashly Settings (bashly-settings.yml)"] = 947,
    ["Better Code Hub"] = 859,
    ["Better Scripts"] = 121,
    Bigconfig = 94,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1033,
    BizTalkServerApplicationSchema = 827,
    Bleep = 122,
    ["Block Protocol Metadata"] = 119,
    ["Boyka Framework"] = 102,
    Briefcase = 833,
    ["Build Info"] = 110,
    Buildkite = 112,
    ["Bukkit plugin.yml"] = 111,
    ["BungeeCord plugin.yml"] = 117,
    ["Butane Config"] = 902,
    C4InterFlow = 1048,
    ["CDK Environment Manager, concrete environment configuration"] = 1071,
    ["CDK Environment Manager, concrete environments definition"] = 1070,
    ["CDK Environment Manager, environment definition"] = 1069,
    ["CGS Card Game Specification (cgs.json)"] = 984,
    ["CICS TS region tagging"] = 911,
    ["CICS TS resource import"] = 912,
    ["CICS TS resource model"] = 913,
    ["CICS TS resource overrides"] = 914,
    ["CMake Presets"] = 123,
    ["CNC Codes"] = 142,
    ["CRS WAF test file"] = 1012,
    ["CRS WAF test platform overrides file"] = 1013,
    ["CSS Comb (.csscomb.json)"] = 241,
    ["CSS Lint (.csslintrc)"] = 242,
    ["CSpell (cspell.json)"] = 240,
    ["CVE Record Format"] = 149,
    CWL = 990,
    ["Cache Warmup config"] = 124,
    ["Calqulus pipeline"] = 125,
    ["Camel YAML DSL"] = 126,
    ["Cannon TOML"] = 127,
    Carafe = 128,
    ["Cargo Make"] = 130,
    ["Cargo Manifest"] = 129,
    ["Catalog Info Backstage"] = 131,
    ["Chamaleon environment"] = 1037,
    ["Chamaleon properties"] = 1038,
    ["Chamaleon template"] = 1036,
    Changesets = 225,
    Charmcraft = 132,
    Cheatsheets = 899,
    ["Chrome Extension"] = 206,
    ["Chromia Model"] = 133,
    ["Chromia Seeder Module Config"] = 135,
    ["Chromia Seeder Root Config"] = 134,
    ["Cinnamon Spice info.json"] = 69,
    ["CircleCI config.yml"] = 182,
    ["Citation File Format"] = 227,
    CityJSON = 137,
    ["Clawject config"] = 148,
    ["Cloud Foundry Application Manifest"] = 995,
    ["Cloud Run Spec v1"] = 1017,
    ["CloudCannon Configuration"] = 73,
    ["CloudEvents specification"] = 138,
    ["Code Climate"] = 183,
    CodeCV = 71,
    CodeRabbit = 70,
    ["CodeShip Pro services configuration files"] = 195,
    ["CodeShip Pro steps configuration files"] = 196,
    ["Codecov configuration files"] = 194,
    CodifyCLI = 72,
    Codux = 192,
    ["Cog config file"] = 143,
    ["Commandbox Box.json"] = 144,
    ["Commandbox Server.json"] = 145,
    ["Common Catalog Data"] = 204,
    ["Common Package Specification"] = 146,
    Concord = 1011,
    ["Configu .cfgu files"] = 1000,
    ["Configu .configu file"] = 1001,
    Conjure = 141,
    ["Container Structure Test"] = 841,
    Containerlab = 868,
    ["Contextive Glossary"] = 1063,
    Convex = 140,
    ["Crowdsec collection config"] = 235,
    ["Crowdsec parser config"] = 236,
    ["Crowdsec scenario config"] = 237,
    ["CumulusCI Config"] = 147,
    ["Custom Machinery Machine"] = 985,
    ["Custom Machinery Recipe"] = 986,
    ["Cycle Stack File"] = 150,
    CycloneDX = 151,
    ["DWP Exchange - catalogue entry"] = 284,
    ["DWP Exchange - gateway"] = 282,
    ["DWP Exchange - meta"] = 283,
    ["Dart Build Config (dart-build.json)"] = 243,
    ["Dart Test Config (dart-test.json)"] = 244,
    ["DashLord Configuration"] = 245,
    ["Data Contract Specification"] = 246,
    ["Data Product Specification"] = 247,
    ["DataYoga Connections"] = 152,
    ["DataYoga Job"] = 153,
    ["Databricks Asset Bundles"] = 963,
    ["Datadog Service Definition"] = 436,
    ["Datadog Software Catalog"] = 437,
    ["Datahub Ingestion Recipe"] = 918,
    ["Dein Config"] = 159,
    ["Deno Config (deno.json)"] = 253,
    ["Dependency cruiser"] = 160,
    ["DeployStack Configuration"] = 161,
    ["Deployer Recipe"] = 256,
    ["Deta Spacefile"] = 162,
    ["Detekt Config (detekt.yml)"] = 257,
    ["Devbox Config"] = 163,
    ["Devbox Plugin"] = 164,
    Devfile = 281,
    DipDup = 1014,
    ["Discord Webhook"] = 258,
    ["DocFx Config (docfx.json)"] = 262,
    Dofigen = 263,
    ["Dolittle Artifacts"] = 264,
    ["Dolittle Bounded Context Configuration"] = 265,
    ["Dolittle Event Horizons Configuration"] = 266,
    ["Dolittle Resources Configuration"] = 267,
    ["Dolittle Server Configuration"] = 268,
    ["Dolittle Tenant Map Configuration"] = 270,
    ["Dolittle Tenants Configuration"] = 269,
    ["Dolittle Topology"] = 271,
    ["DonateCaseBetterCasino menu"] = 1041,
    ["Drupal Breakpoints"] = 165,
    ["Drupal Config"] = 177,
    ["Drupal Info"] = 166,
    ["Drupal Layouts"] = 167,
    ["Drupal Libraries"] = 168,
    ["Drupal Links Action"] = 169,
    ["Drupal Links Contextual"] = 170,
    ["Drupal Links Menu"] = 171,
    ["Drupal Links Task"] = 172,
    ["Drupal Migration"] = 173,
    ["Drupal Permissions"] = 174,
    ["Drupal Recipe"] = 175,
    ["Drupal Routing"] = 176,
    ["Drupal Services"] = 178,
    ["Drush site aliases"] = 277,
    ["Dynamic Bash Aliases (.aliases)"] = 954,
    ["EAS config"] = 301,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 943,
    ["EasyVCR .NET"] = 302,
    ["Eidolon Resource"] = 1028,
    ["Elgato Stream Deck"] = 287,
    Elm = 1016,
    ["Embrace Config"] = 929,
    Endurica = 967,
    ["Enterprise Contract Policy Spec"] = 288,
    ["Erda Pipeline"] = 992,
    ["Erda Runtime"] = 993,
    Esquio = 290,
    ["Estuary Flow Catalog"] = 908,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 294,
    ["EveryVoice TTS Toolkit Data Configuration"] = 295,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 299,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 298,
    ["EveryVoice TTS Toolkit Text Configuration"] = 296,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 297,
    ["Expo SDK"] = 300,
    ["F-Droid Data metadata"] = 306,
    ["FasterCI Configuration"] = 78,
    FiQuS = 310,
    Firebase = 308,
    ["FlexGet Config"] = 311,
    ["Flow.json Configurations"] = 989,
    ["Fossa configuration file"] = 318,
    ["Fossa's fossa-deps file"] = 319,
    ["Foundry VTT - Base package Manifest"] = 313,
    ["Foundry VTT - Module Manifest"] = 314,
    ["Foundry VTT - System Data Template"] = 317,
    ["Foundry VTT - System Manifest"] = 315,
    ["Foundry VTT - World Manifest"] = 316,
    ["Foxx Manifest"] = 79,
    ["Freifunk.de Community API"] = 82,
    ["Frogbot Config"] = 83,
    ["G2P Mapping Configuration"] = 324,
    ["GCP Blueprint Metadata"] = 327,
    Gaspar = 325,
    ["GatewayCore API Gateway"] = 326,
    ["GeoJSON.json latest"] = 906,
    GherKing = 910,
    ["GitHub Action"] = 332,
    ["GitHub Actions typing"] = 1024,
    ["GitHub Discussion"] = 333,
    ["GitHub Funding"] = 334,
    ["GitHub Issue Template configuration"] = 335,
    ["GitHub Issue Template forms"] = 336,
    ["GitHub Workflow"] = 337,
    ["GitHub Workflow Template Properties"] = 338,
    ["GitHub automatically generated release notes configuration"] = 339,
    ["GitLab Agent for Kubernetes configuration"] = 981,
    GitVersion = 329,
    ["Gitea Issue Template configuration"] = 330,
    ["Gitea Issue Template forms"] = 331,
    ["Gitpod Automations"] = 341,
    ["Gitpod Configuration"] = 342,
    ["GlazeWM settings"] = 983,
    ["Global Privacy Control"] = 328,
    Goblet = 962,
    ["Golangci-lint Configuration"] = 357,
    ["Golangci-lint Custom Plugins Configuration"] = 358,
    ["Google Chrome Related Website Sets"] = 309,
    ["Google Cloud Workflows"] = 212,
    ["Google Digital Assetlinks"] = 1064,
    Goreleaser = 360,
    ["Goreleaser Pro"] = 361,
    Goss = 362,
    ["Gradle Build Cache Node"] = 857,
    ["Gradle Enterprise"] = 856,
    ["Grafana 5.x Dashboard"] = 363,
    ["GraphQL Code Generator"] = 367,
    ["GraphQL Config"] = 366,
    ["GraphQL Mesh"] = 365,
    ["Grunt JSHint task"] = 371,
    ["Grunt Watch task"] = 372,
    ["Grunt base task"] = 373,
    ["Grunt clean task"] = 369,
    ["Grunt copy task"] = 368,
    ["Grunt cssmin task"] = 370,
    HEMTT = 823,
    Hadolint = 837,
    Hammerkit = 867,
    ["Hardware Sentry Configuration"] = 922,
    Hatch = 838,
    Hayson = 375,
    ["Haystack Pipeline"] = 376,
    ["Hazelcast 5 Configuration"] = 377,
    ["Helm Chart.lock"] = 180,
    ["Helm Chart.yaml"] = 179,
    ["Helm Unittest Test Suite"] = 181,
    ["Home Assistant Integration Manifest"] = 378,
    ["Homer dashboard configuration"] = 379,
    Hugo = 898,
    ["Hugo Theme"] = 897,
    ["Hyperfoil benchmark configuration"] = 385,
    ["IBM Zapp document"] = 386,
    ["IBM zCodeFormatSettings"] = 387,
    ["IMG Catapult PSP"] = 392,
    ["IVMS101 by CODE Protocol"] = 982,
    Infrahub = 394,
    Istanbul = 925,
    ["JDownloader2 crawler multi-rules"] = 404,
    ["JDownloader2 crawler single-rules"] = 403,
    ["JFrog Applications Config"] = 405,
    ["JFrog File Spec"] = 406,
    ["JFrog Pipelines YML DSL"] = 931,
    ["JMeter DSL cli config"] = 407,
    JReleaser = 409,
    ["JSON Document Transform"] = 417,
    ["JSON Feed"] = 418,
    ["JSON Resume"] = 637,
    ["JSON Schema Draft 2020-12"] = 806,
    ["JSON Schema Draft 4"] = 803,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 964,
    ["JSON Schema Draft 7"] = 804,
    ["JSON Schema Draft 7 (unofficial strict)"] = 965,
    ["JSON Schema Draft 8 (2019-09)"] = 805,
    ["JSON-API"] = 416,
    ["JSON-e templates"] = 864,
    ["JSON-stat 2.0"] = 799,
    JSONPatch = 420,
    ["JSR Package Config (jsr.json)"] = 410,
    Jasmine = 398,
    Jekyll = 399,
    ["Jenkins X Pipelines"] = 400,
    ["Jenkins X Requirements"] = 401,
    Jest = 402,
    ["Jovo Language Models"] = 408,
    ["KIMMDY config file"] = 431,
    ["KODE/CI build.yaml"] = 927,
    ["KSP-AVC"] = 800,
    ["KSP-CKAN"] = 801,
    ["KSP-NetKAN"] = 802,
    KSY = 994,
    KSail = 322,
    ["Karakum configuration file"] = 320,
    Kas = 423,
    ["Kestra flow file"] = 432,
    ["Keycloak REST API"] = 934,
    ["Knative Functions - func.yaml"] = 321,
    ["Kometa (nightly) config file"] = 434,
    ["Kometa config file"] = 433,
    ["Kong DBLess config"] = 928,
    KrakenD = 435,
    ["Kubri Configuration"] = 441,
    LOOBin = 456,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 217,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 218,
    ["Landing Zone Accelerator on AWS - Global Config"] = 219,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 220,
    ["Landing Zone Accelerator on AWS - Network Config"] = 221,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 222,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 223,
    ["Landing Zone Accelerator on AWS - Security Config"] = 224,
    ["Language configuration"] = 1004,
    Lefthook = 445,
    ["Liferay client-extension.yaml"] = 452,
    ["LinkML Metamodel"] = 454,
    Liquibase = 873,
    ["Liquibase Flow File"] = 874,
    ["Lively Properties"] = 455,
    ["Lobe AI Agent"] = 75,
    Loki = 76,
    ["MLOS Configs"] = 494,
    ["MS2Rescore Configuration"] = 497,
    ["Madness (madness.yml)"] = 945,
    ["MapEHR Mapping"] = 462,
    Markdownlint = 877,
    ["Mason Registry"] = 880,
    ["MegaLinter configuration"] = 464,
    ["MegaLinter descriptor"] = 465,
    Melange = 972,
    ["Meltano project definition"] = 466,
    ["Mergify Configuration"] = 498,
    ["Metadata for a Bazel module"] = 467,
    ["Metadata for a Cinnamon spice"] = 1020,
    ["Metatype Configuration"] = 468,
    ["MetricsHub Configuration"] = 469,
    ["MetricsHub Connector Configuration"] = 470,
    ["Micro Editor Syntax"] = 955,
    ["Microsoft Band Web Tile"] = 471,
    ["Microsoft RulesEngine workflow rules"] = 1008,
    ["Microsoft RulesEngine workflow rules list"] = 1009,
    ["Minecraft Custom Main Menu Mod"] = 973,
    ["Minecraft Data Pack Advancement"] = 473,
    ["Minecraft Data Pack Biome"] = 474,
    ["Minecraft Data Pack Configured Carver"] = 475,
    ["Minecraft Data Pack Damage Type"] = 476,
    ["Minecraft Data Pack Dimension"] = 478,
    ["Minecraft Data Pack Dimension Type"] = 477,
    ["Minecraft Data Pack Item Modifier"] = 479,
    ["Minecraft Data Pack Loot Table"] = 480,
    ["Minecraft Data Pack Metadata"] = 481,
    ["Minecraft Data Pack Predicate"] = 482,
    ["Minecraft Data Pack Recipe"] = 483,
    ["Minecraft Data Pack Tag"] = 484,
    ["Minecraft Data Pack Template Pool"] = 485,
    ["Minecraft Data Pack Trim Material"] = 490,
    ["Minecraft Data Pack Trim Pattern"] = 491,
    ["Minecraft Resource Pack Lang"] = 486,
    ["Minecraft Resource Pack Particle"] = 487,
    ["Minecraft Resource Pack Texture Mcmeta"] = 489,
    ["Minecraft Resourcepack Sounds"] = 488,
    ["Monade CLI Stack Configuration"] = 501,
    ["MongoDB Atlas Search Index Definition"] = 926,
    ["Monika Configuration"] = 924,
    ["Monoweave Configuration"] = 496,
    ["Motif config"] = 819,
    MultiQC = 1057,
    ["NOX Framework (Service)"] = 514,
    ["Netin Diagnostic System Template"] = 884,
    ["Netlify config"] = 504,
    ["Network-as-Code Data Model"] = 505,
    ["Nightwatch.js"] = 507,
    ["Node.js configuration"] = 824,
    ["NueJS configuration file"] = 519,
    ["Nuitka.yaml"] = 987,
    ["Nullstone config"] = 521,
    ["ONe's changelog entry"] = 535,
    ["ONe's service descriptor"] = 534,
    ["ORT Server repository environment configuration"] = 542,
    ["OSCAL Assessment Plan (AP)"] = 544,
    ["OSCAL Assessment Results (AR)"] = 545,
    ["OSCAL Catalog"] = 546,
    ["OSCAL Component Definition (CDef)"] = 547,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 548,
    ["OSCAL Profile"] = 549,
    ["OSCAL System Security Plan (SSP)"] = 550,
    ["OSS Review Toolkit configuration"] = 551,
    ["OSS Review Toolkit curation"] = 552,
    ["OSS Review Toolkit package configuration"] = 553,
    ["OSS Review Toolkit repository configuration"] = 554,
    ["OSS Review Toolkit resolutions"] = 555,
    ["October CMS columns"] = 525,
    ["October CMS fields"] = 526,
    Okteto = 527,
    Opctl = 822,
    ["Open Data Contract Standard (ODCS)"] = 538,
    ["Open Know-How"] = 1062,
    ["OpenRewrite Resource"] = 537,
    ["OpenUtau character yaml"] = 531,
    ["OpenUtau ustx"] = 532,
    ["OpenWeather Current Weather API"] = 863,
    ["OpenWeather Road Risk API"] = 862,
    ["Ory Hydra configuration"] = 384,
    ["Ory Keto configuration"] = 438,
    ["Ory Kratos configuration"] = 543,
    ["Ory Oathkeeper configuration"] = 523,
    ["Outblocks App configuration"] = 540,
    ["Outblocks database table"] = 541,
    ["Outblocks project configuration"] = 539,
    PDM = 561,
    Packer = 558,
    Pantsbuild = 941,
    ["Paper paper-plugin.yml"] = 559,
    ["Pipeline component"] = 875,
    ["Platform.sh application"] = 2,
    ["Platform.sh routes"] = 3,
    ["Platform.sh services"] = 4,
    ["Plex Prerolls"] = 569,
    ["PocketMine plugin.yml"] = 566,
    ["Postman collection"] = 573,
    ["Preset list for a WinUtil"] = 1023,
    ["ProActions AI-Kit Configuration"] = 582,
    ["ProActions AI-Kit Configuration for Menus"] = 584,
    ["ProActions AI-Kit Configuration for Sections"] = 586,
    ["ProActions AI-Kit Configuration for Services"] = 583,
    ["ProActions AI-Kit Configuration for Steps"] = 587,
    ["ProActions AI-Kit Configuration for Templates"] = 585,
    ["Problem object RFC9457"] = 970,
    ["Problem package generators"] = 588,
    Pterodactyl = 921,
    ["Pull Request Labeler"] = 604,
    Pulumi = 612,
    ["PyGTA Config"] = 608,
    PyProject = 613,
    Pylock = 1065,
    Pyright = 614,
    ["Python script metadata"] = 1059,
    Qgoda = 616,
    Qodana = 894,
    ["Qt Creator workspace file"] = 1002,
    ["Quali Torque Blueprint Spec 2"] = 919,
    ["QueryFirst config file"] = 937,
    ["RKE Cluster Configuration JSON"] = 872,
    ["RKE Cluster Configuration YAML"] = 871,
    RadioHound = 607,
    Railway = 617,
    ["Rancher Fleet"] = 609,
    ["Rattler-build"] = 618,
    Ray = 836,
    ["Read the Docs"] = 611,
    ["Red-DiscordBot Cog"] = 625,
    ["Red-DiscordBot Cog Repo"] = 626,
    ["Red-DiscordBot Trivia"] = 627,
    ["Render Blueprints"] = 870,
    RenderCV = 639,
    Renovate = 638,
    ["Replit config"] = 633,
    Restate = 1052,
    RoadRunner = 641,
    ["Roo Coder Custom Modes"] = 643,
    ["Rudder techniques"] = 977,
    Ruff = 635,
    ["Rust Project"] = 636,
    ["Rust toolchain"] = 646,
    ["SDMX data message"] = 672,
    ["SDMX metadata message"] = 671,
    ["SDMX structure message"] = 670,
    ["SIL Kit Participant Configuration"] = 682,
    ["SIL Kit Registry Configuration"] = 683,
    ["SPDX 2.3"] = 701,
    SWADL = 715,
    ["Safebox Config"] = 932,
    ["Sapphire CLI Config"] = 649,
    ["SauceCTL Configuration"] = 881,
    ["Schema Catalog"] = 664,
    ["Scoop manifest"] = 669,
    ["Semantic Data Fabric (SDF) file"] = 673,
    ["Semgrep Rule"] = 675,
    ["Serenity Code Generator (Sergen)"] = 676,
    ["Serverless Framework Configuration"] = 888,
    ["Serverless Workflow"] = 890,
    ["Settings for a Cinnamon spice"] = 1019,
    ["Settings.paf"] = 678,
    ["Shopware 6 Configuration"] = 891,
    ["Shopware CLI Extension Store Configuration"] = 892,
    ["Shopware CLI Project Store Configuration"] = 893,
    ["Sigma Detection Rule"] = 680,
    ["Sigrid scope configuration file"] = 681,
    ["SkyPilot Task JSON"] = 978,
    ["Slack app manifest"] = 685,
    Solidarity = 690,
    ["Solution filters"] = 691,
    ["Source Maps v3"] = 692,
    Sourcery = 693,
    ["Speakeasy Generation Config File"] = 697,
    ["Speakeasy Lint Configuration File"] = 694,
    ["Speakeasy Test Generation Configuration File"] = 695,
    ["Speakeasy Workflow File"] = 696,
    SpecIF = 698,
    ["Sponge Mixin configuration"] = 699,
    StackBlitz = 705,
    ["StackHawk Scanner Configuration"] = 887,
    Stale = 706,
    ["Starlake Data Pipeline"] = 860,
    Starship = 707,
    ["Statamic Blueprint"] = 708,
    ["Stella configuration file"] = 709,
    ["Stryker Mutator"] = 712,
    ["StyleCop Analyzers Configuration"] = 713,
    ["Stylelint (.stylelintrc)"] = 714,
    ["Stylua Config"] = 1066,
    ["Sublime Syntax"] = 933,
    ["Subsquid squid manifest"] = 980,
    ["Swagger API 2.0"] = 716,
    ["Synadia Connect Component"] = 717,
    TSON = 751,
    TSTyche = 752,
    ["Tab data for a LinUtil"] = 1026,
    ["Tab list for a LinUtil"] = 1025,
    Tach = 718,
    ["Tach Domain"] = 719,
    Talhelper = 721,
    ["Talisman configuration"] = 722,
    Taplo = 1067,
    ["Taskfile config"] = 865,
    Taurus = 723,
    Tauticord = 724,
    Telefonistka = 1053,
    ["TestEnvironment.json"] = 734,
    ["TextMate Grammar"] = 733,
    ["Tier.run pricing.json"] = 727,
    Tikibase = 728,
    Tombi = 732,
    ["Traefik v2"] = 737,
    ["Traefik v2 File Provider"] = 738,
    ["Traefik v3"] = 739,
    ["Traefik v3 File Provider"] = 740,
    ["Travis CI (.travis.yml)"] = 736,
    Trident = 1050,
    ["TrueScript for *.tscript files"] = 743,
    ["Tugboat QA config.yml"] = 1047,
    TunnelHub = 968,
    Turborepo = 735,
    Tycho = 1015,
    Tye = 895,
    ["Tyk Gateway - Open Source v5.7+"] = 1058,
    ["Typst Manifest"] = 757,
    ["UET BuildConfig.json"] = 938,
    ["UI5 Manifest"] = 763,
    ["UNCORS configuration"] = 767,
    ["UTAM Page Object"] = 766,
    ["Ubuntu Server Autoinstall"] = 761,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1051,
    ["Uniswap Token List"] = 848,
    ["Universal Schedule Format"] = 768,
    ["Unreal Engine Uplugin"] = 939,
    ["Unreal Engine Uproject"] = 940,
    ["Updatecli Compose"] = 903,
    ["Updatecli Policy Manifest"] = 904,
    ["Updatecli Policy Metadata"] = 905,
    Uplift = 936,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 869,
    V2Ray = 909,
    ["VSCode Code Snippets"] = 200,
    ["VSIX CLI publishing"] = 788,
    Vector = 770,
    ["Vela Pipeline Configuration"] = 773,
    Vercel = 199,
    ["Version Bumper config"] = 778,
    ["Viash Component Config"] = 1055,
    ["Viash Package Config"] = 1056,
    Visivo = 966,
    Wake = 1049,
    ["Waku Config"] = 1029,
    ["Web App Manifest"] = 794,
    ["Web types"] = 797,
    WebExtensions = 793,
    ["Webman package recipe"] = 915,
    ["Windows Package Manager Installer Manifest"] = 844,
    ["Windows Package Manager Locale Manifest"] = 845,
    ["Windows Package Manager Singleton Manifest"] = 843,
    Winutil = 846,
    ["WireMock stub mapping"] = 1032,
    ["Woodpecker pipeline config"] = 883,
    ["Wrangler CLI"] = 798,
    ["Xstate Machine"] = 901,
    ["Yandex Workflow Language"] = 1021,
    ["Yarn Config (.yarnrc.yml)"] = 858,
    ["Yippee-Ki-JSON configuration YML"] = 850,
    ["YouTrack App"] = 1018,
    ["Zerops.io config"] = 1006,
    ["Zerops.io import"] = 1007,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 971,
    ...
    ["babelrc.json"] = 85,
    ["bamboo-spec"] = 88,
    ["bashly-strings.yml"] = 948,
    ["batect.yml"] = 87,
    ["beef-database-codegen"] = 89,
    ["beef-database-v5-codegen"] = 91,
    ["beef-entity-codegen"] = 90,
    ["beef-entity-v5-codegen"] = 92,
    ["behat.yml"] = 103,
    ["bigquery-table"] = 93,
    ["bioimageio resource description"] = 988,
    ["bitbucket-pipelines"] = 95,
    bitrise = 96,
    ["bitrise-step"] = 97,
    ["block.json"] = 118,
    ...
    ["bozr.suite.json"] = 105,
    bpkg = 949,
    ["browser.i18n.json"] = 106,
    ["browsh configuration"] = 107,
    bucklescript = 108,
    ["buf.gen.yaml"] = 66,
    ["buf.plugin.yaml"] = 67,
    ["buf.work.yaml"] = 68,
    ...
    ["build-changelog"] = 109,
    ["bun.lock"] = 114,
    ["bundleconfig.json"] = 115,
    ["bunfig.toml"] = 116,
    ["ccmod.json"] = 1030,
    changelogging = 999,
    ["chisel-slices.json"] = 226,
    ["chrome-extension-locales-messages.json"] = 207,
    ["chutzpah.json"] = 208,
    cibuildwheel = 136,
    ["clang-format (.clang-format)"] = 907,
    ["clang-tidy"] = 187,
    clangd = 186,
    clib = 188,
    ["cloud-init: cloud-config userdata"] = 190,
    ["cloud-sdk-pipeline-configuration"] = 210,
    ["cloudbuild.json"] = 211,
    cloudify = 189,
    codemagic = 191,
    ["coffeelint.json"] = 228,
    ["commands.json"] = 203,
    ["commitlint (.commitlintrc)"] = 847,
    ["committed.toml"] = 229,
    ["compile_commands.json"] = 202,
    ["compilerconfig.json"] = 201,
    ["completely.yml"] = 944,
    ["component-detection-manifest.json"] = 232,
    ["component.json"] = 231,
    ["composer.json"] = 230,
    ["conda-forge"] = 139,
    ["config.yaml"] = 610,
    ["contentmanifest.json"] = 209,
    ["contribute.json"] = 233,
    ["cosmos.config.json"] = 205,
    ["crowdin.yml"] = 234,
    ["ctfd-setup configuration file"] = 1039,
    ["custom-elements.json"] = 958,
    ["cypress.json"] = 238,
    ["datalogic-scan2deploy-android"] = 248,
    ["datalogic-scan2deploy-ce"] = 249,
    ["dbt Dependencies"] = 154,
    ["dbt Packages"] = 156,
    ["dbt Project"] = 155,
    ["dbt Selectors"] = 157,
    ["dbt YAML files"] = 158,
    ["ddev-global"] = 250,
    ["ddev-project"] = 251,
    ["debugsettings.json"] = 252,
    ["dependabot-v2.json"] = 255,
    ["dependabot.json"] = 254,
    ["deployed-cli"] = 900,
    ["devcontainer.json"] = 193,
    devinit = 852,
    ["devspace.yaml"] = 923,
    djlint = 853,
    ["docker bake"] = 260,
    ["docker sequencer"] = 261,
    ["docker-compose.yml"] = 851,
    ["dockerd.json"] = 259,
    ["dotnet Release Index manifest"] = 272,
    ["dotnet-tools.json"] = 273,
    ["dotnetcli.host.json"] = 274,
    ["dprint.json"] = 275,
    ["drone.json"] = 276,
    ["dss-2.0.0.json"] = 278,
    ["dstack configuration"] = 279,
    ["dtool dataset metadata"] = 1034,
    ["dvc.yaml"] = 280,
    ["ecosystem.json"] = 285,
    eksctl = 286,
    ["electron-builder configuration file"] = 292,
    ["epr-manifest.json"] = 291,
    ["evcc.yaml"] = 293,
    ["ezd task runner"] = 303,
    ["fabric.mod.json"] = 305,
    ["first-timers-bot"] = 312,
    ["flagd flag configuration"] = 80,
    ["fly.io Configuration"] = 81,
    fulibWorkflows = 882,
    ["function.json"] = 323,
    ["gRPC API Gateway & OpenAPI Config"] = 7,
    ["gematik health care insurance list"] = 1045,
    ["gematik health care patient list"] = 1042,
    ["gematik health care provider institution list"] = 1044,
    ["gematik health care provider list"] = 1043,
    ["gematik tiger test environment configuration"] = 1046,
    ["gitlab-ci"] = 340,
    ["global.json"] = 356,
    ["go-feature-flag Flag Configuration"] = 359,
    ["haxelib.json"] = 374,
    helmfile = 839,
    helmwave = 840,
    ["host-meta.json"] = 381,
    ...
    ["ide.host.json"] = 388,
    ["ifstate.conf"] = 389,
    ["imageoptimizer.json"] = 390,
    ["importmap.json"] = 393,
    ["ioBroker Configuration"] = 395,
    ["ioBroker JSON UI"] = 396,
    ["ioBroker Package manifest"] = 397,
    ["ize.toml"] = 935,
    ["jsconfig.json"] = 421,
    ["jscpd Configuration"] = 920,
    jsdoc = 835,
    ["k3d.yaml"] = 422,
    ["k9s aliases.yaml"] = 424,
    ["k9s cluster-config.yaml"] = 426,
    ["k9s config.yaml"] = 425,
    ["k9s hotkeys.yaml"] = 427,
    ["k9s plugins.yaml"] = 428,
    ["k9s skin.yaml"] = 429,
    ["k9s views.yaml"] = 430,
    ["kontinuous-config.yaml"] = 440,
    ["kontinuous-values.yaml"] = 439,
    ["kustomization.yaml"] = 442,
    ["label-commenter-config.yml"] = 443,
    ["latexindent configuration"] = 74,
    ["launchsettings.json"] = 444,
    lazydocker = 957,
    lazygit = 956,
    ["lego.json"] = 446,
    ["lerna.json"] = 447,
    ["lgtm.yml"] = 448,
    ["liblab.config.json"] = 449,
    ["libman.json"] = 450,
    ["license-report-config.json"] = 451,
    ["linkinator.config.json"] = 453,
    ["lint-staged (.lintstagedrc)"] = 814,
    ["local.settings.json"] = 458,
    ["localazy.json"] = 459,
    ["lotus.yaml"] = 457,
    ["lsdlschema.json"] = 460,
    ["markdown-link-check"] = 878,
    maturin = 879,
    mboats = 886,
    ["micro-settings.json"] = 950,
    ["mimetypes.json"] = 472,
    ["mirrord config"] = 815,
    mise = 816,
    ["mkdocs.yml"] = 492,
    ["monospace.yml"] = 495,
    ["moon.yml"] = 1031,
    ["mprocs Configuration file"] = 1003,
    ["mrdocs.yml"] = 493,
    ["mta.yaml"] = 817,
    ["mtad.yaml"] = 818,
    ["mycode.json"] = 502,
    nFPM = 506,
    ["napari plugin manifest"] = 503,
    neoload = 830,
    ["nest-cli"] = 509,
    ["ninjs (News in JSON)"] = 508,
    ["nitro.json"] = 829,
    ["nixd configuration"] = 976,
    ["nlu.json"] = 510,
    ["nodemon.json"] = 512,
    ["noodl config"] = 885,
    ["notebook.mod.json"] = 513,
    now = 825,
    ["npm-badges"] = 516,
    ["nswag.json"] = 520,
    ntangle = 522,
    ["nuclei-template.yaml"] = 517,
    ["nuget-project.json"] = 518,
    ["ocelot.json"] = 524,
    ["omnisharp.json"] = 528,
    ["openapi.json"] = 529,
    ["openfin.json"] = 536,
    ...
    ["ops.yaml"] = 533,
    ["package.json"] = 556,
    ["package.manifest"] = 557,
    ["partial-black.json"] = 104,
    ["pathfinder.yml"] = 560,
    ["pattern.json"] = 563,
    ["petstore-v1.0"] = 930,
    pgap_yaml_input_reader = 562,
    ["pixi.toml"] = 564,
    ["plagiarize-me.yaml"] = 568,
    ["plagiarize.yaml"] = 567,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1035,
    ["podbard.yaml"] = 570,
    ["portman.json"] = 571,
    ["prefect.toml"] = 579,
    ["prettierrc.json"] = 580,
    ["prisma.yml"] = 581,
    ["project-1.0.0-beta3.json"] = 590,
    ["project-1.0.0-beta4.json"] = 591,
    ["project-1.0.0-beta5.json"] = 592,
    ["project-1.0.0-beta6.json"] = 593,
    ["project-1.0.0-beta8.json"] = 594,
    ["project-1.0.0-rc1.json"] = 595,
    ["project-1.0.0-rc2.json"] = 596,
    ["project.json"] = 589,
    ["project.owasp.yaml"] = 597,
    ["prometheus.json"] = 598,
    ["prometheus.rules.json"] = 599,
    ["prometheus.rules.test.json"] = 600,
    ["proxies.json"] = 601,
    ["publiccode.yml"] = 602,
    ["pubspec.yaml"] = 603,
    ["pyrseas-0.8.json"] = 606,
    pytest = 615,
    ["quilt.mod.json"] = 951,
    ["rc3 auth"] = 619,
    ["rc3 collection"] = 620,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 831,
    ["release-please-config.json"] = 629,
    ["release-please-manifest.json"] = 630,
    ["release-plz.toml"] = 631,
    ["renv.lock"] = 640,
    ["rivet.json"] = 975,
    ["rivet.yaml (legacy)"] = 974,
    rockcraft = 642,
    runny = 644,
    rustfmt = 645,
    sake = 1061,
    samt = 647,
    samtrc = 648,
    ["sarif-1.0.0.json"] = 650,
    ["sarif-2.0.0.json"] = 651,
    ["sarif-2.1.0"] = 661,
    ["sarif-2.1.0-rtm.2"] = 652,
    ["sarif-2.1.0-rtm.3"] = 654,
    ["sarif-2.1.0-rtm.4"] = 656,
    ["sarif-2.1.0-rtm.5"] = 658,
    ["sarif-2.1.0-rtm.6"] = 659,
    ["sarif-external-property-file-2.1.0"] = 662,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 653,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 655,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 657,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 660,
    ["scalingo.json configuration"] = 663,
    ["schema.org - Action"] = 665,
    ["schema.org - ContactPoint"] = 666,
    ["schema.org - Place"] = 667,
    ["schema.org - Thing"] = 668,
    ["secrethub.yml"] = 953,
    ["semantic-release"] = 674,
    ["servicehub.config.json"] = 809,
    ["servicehub.service.json"] = 808,
    ["settings.job"] = 677,
    ["sfdx-hardis configuration"] = 679,
    ["shard.yml"] = 991,
    ["size-limit configuration"] = 684,
    ["skaffold.yaml"] = 876,
    ["skyuxconfig.json"] = 686,
    snapcraft = 687,
    ["snowflake-config"] = 688,
    ["snowflake-connections"] = 689,
    ["spicepod.yaml"] = 1010,
    ["sqlc configuration"] = 702,
    ["stripe-app-local.json"] = 711,
    ["stripe-app.json"] = 710,
    swcrc = 861,
    ["task.json"] = 720,
    taskcat = 826,
    ["template.json"] = 725,
    ["templatsources.json"] = 726,
    ["theme.json"] = 729,
    ["tizen_workspace.json"] = 730,
    tldr = 731,
    ["tm_devices configuration file"] = 1072,
    tmuxinator = 812,
    ["transcend.yml"] = 741,
    ["tree-sitter grammar.json"] = 364,
    ["trime.yaml"] = 742,
    ["trunk.yaml"] = 744,
    ["ts-force-config.json"] = 749,
    ["tsconfig.json"] = 745,
    ["tsd.json"] = 746,
    ["tsdoc.json"] = 747,
    ["tsdrc.json"] = 748,
    ...
    v8r = 792,
    vcluster = 997,
    ["vcpkg configuration file"] = 198,
    ["vcpkg manifest file"] = 197,
    ["vega-lite.json"] = 772,
    ["vega.json"] = 771,
    ["venvironment-basic.yaml"] = 775,
    ["venvironment.yaml"] = 774,
    ["venvplus-basic.yaml"] = 777,
    ["venvplus.yaml"] = 776,
    version = 1054,
    ["version.json"] = 779,
    ["vhwdebugger-binding.yaml"] = 781,
    ["vim-addon-info"] = 782,
    ["vs-2017.3.host.json"] = 784,
    ["vs-nesting.json"] = 785,
    ["vsls.json"] = 783,
    ["vss-extension.json"] = 789,
    vtcfg = 1060,
    ["vtesttree.yaml"] = 790,
    ["vtestunit.yaml"] = 791,
    ["warp-keysets.json"] = 959,
    ["warp-themes.json"] = 960,
    ["warp-workflows.json"] = 961,
    ["webhint.io"] = 916,
    ["webjobpublishsettings.json"] = 796,
    ["webjobs-list.json"] = 795,
    ["well-known-fursona"] = 998,
    ["xs-app.json"] = 821,
    ["xunit.runner.json"] = 807,
    yamllint = 849,
    zuul = 832,
    ["Žinoma"] = 842
  },
