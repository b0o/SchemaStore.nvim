...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 854,
    [".nodehawkrc"] = 521,
    [".npmpackagejsonlintrc"] = 525,
    [".omletrc"] = 1030,
    [".phrase.yml"] = 588,
    [".phraseapp.yml"] = 589,
    [".pmbot.yml"] = 576,
    [".postcssrc"] = 583,
    [".powerpages-web-template-manifest"] = 585,
    [".pre-commit-config.yml"] = 586,
    [".pre-commit-hooks.yml"] = 587,
    [".putout.json"] = 616,
    [".rehyperc"] = 640,
    [".remarkrc"] = 644,
    [".sprite files"] = 731,
    ...
    ["A micro editor config"] = 472,
    ABCInventoryModuleData = 18,
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1075,
    ["API Builder"] = 889,
    ["AVA Configuration"] = 951,
    ["AWS AppConfig Feature Flags-v1"] = 49,
    ["AWS CDK cdk.json"] = 219,
    ["AWS CloudFormation"] = 220,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 221,
    ["AWS Copilot Manifest"] = 1113,
    ["AWS SAM CLI Samconfig"] = 222,
    ["Adobe UXP Manifest"] = 1013,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1104,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 923,
    ["All Contributors configuration file"] = 976,
    ["Ansible Argument Specs"] = 352,
    ["Ansible Collection Galaxy"] = 359,
    ["Ansible Execution Environment"] = 349,
    ["Ansible Inventory"] = 358,
    ["Ansible Meta"] = 350,
    ["Ansible Meta Runtime"] = 351,
    ["Ansible Navigator Configuration"] = 361,
    ["Ansible Playbook"] = 356,
    ["Ansible Requirements"] = 353,
    ["Ansible Rulebook"] = 357,
    ["Ansible Tasks File"] = 355,
    ["Ansible Vars File"] = 354,
    ["Ansible-lint Configuration"] = 360,
    Any = 1040,
    ["AnyWork Automation Configuration"] = 9,
    ["App config Spotify Backstage"] = 25,
    ["Application Accelerator"] = 6,
    ["Application list for a WinUtil"] = 1057,
    ArchitectFX = 1062,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure Pipelines"] = 79,
    ["Azure Static Web Apps CLI configuration file"] = 735,
    ["Azure Static Web Apps configuration file"] = 734,
    ["BOSH CPI Config"] = 103,
    ["BOSH Deploy Config"] = 104,
    ["BX CI"] = 123,
    ["Bashly (bashly.yml)"] = 980,
    ["Bashly Settings (bashly-settings.yml)"] = 981,
    ["Better Code Hub"] = 893,
    ["Better Scripts"] = 124,
    Bigconfig = 96,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1068,
    BizTalkServerApplicationSchema = 861,
    Bleep = 125,
    ...
    ["Butane Config"] = 936,
    C4InterFlow = 1083,
    ["CDK Environment Manager, concrete environment configuration"] = 1107,
    ["CDK Environment Manager, concrete environments definition"] = 1106,
    ["CDK Environment Manager, environment definition"] = 1105,
    ["CGS Card Game Specification (cgs.json)"] = 1018,
    ["CICS TS region tagging"] = 945,
    ["CICS TS resource import"] = 946,
    ["CICS TS resource model"] = 947,
    ["CICS TS resource overrides"] = 948,
    ["CMake Presets"] = 126,
    ["CNC Codes"] = 147,
    ["CRS WAF test file"] = 1047,
    ["CRS WAF test platform overrides file"] = 1048,
    ["CSS Comb (.csscomb.json)"] = 247,
    ["CSS Lint (.csslintrc)"] = 248,
    ["CSpell (cspell.json)"] = 246,
    ...
    ["Chamaleon environment"] = 1072,
    ["Chamaleon properties"] = 1073,
    ["Chamaleon template"] = 1071,
    Changesets = 231,
    Changie = 135,
    Charmcraft = 136,
    Cheatsheets = 933,
    ["ChordPro Configuration"] = 137,
    ["Chrome Extension"] = 212,
    ["Chromia Model"] = 138,
    ["Chromia Seeder Module Config"] = 140,
    ["Chromia Seeder Root Config"] = 139,
    ["Cinnamon Spice info.json"] = 70,
    ["CircleCI config.yml"] = 188,
    ["Citation File Format"] = 233,
    CityJSON = 142,
    ["Claude Code Settings"] = 154,
    ["Clawject config"] = 153,
    ["Cloud Foundry Application Manifest"] = 1029,
    ["Cloud Run Spec v1"] = 1052,
    ["CloudCannon Configuration"] = 74,
    ["CloudEvents specification"] = 143,
    ["Code Climate"] = 189,
    CodeCV = 72,
    CodeRabbit = 71,
    ["CodeShip Pro services configuration files"] = 201,
    ["CodeShip Pro steps configuration files"] = 202,
    ["Codecov configuration files"] = 200,
    CodifyCLI = 73,
    Codux = 198,
    ["Cog config file"] = 148,
    ["Commandbox Box.json"] = 149,
    ["Commandbox Server.json"] = 150,
    ["Common Catalog Data"] = 210,
    ["Common Package Specification"] = 151,
    Concord = 1046,
    ["Configu .cfgu files"] = 1034,
    ["Configu .configu file"] = 1035,
    Conjure = 146,
    ["Container Structure Test"] = 875,
    Containerlab = 902,
    ["Contextive Glossary"] = 1099,
    Convex = 145,
    ["Crowdsec collection config"] = 241,
    ["Crowdsec parser config"] = 242,
    ["Crowdsec scenario config"] = 243,
    ["CumulusCI Config"] = 152,
    ["Custom Machinery Machine"] = 1019,
    ["Custom Machinery Recipe"] = 1020,
    ["Cycle Stack File"] = 156,
    CycloneDX = 157,
    ["DWP Exchange - catalogue entry"] = 290,
    ["DWP Exchange - gateway"] = 288,
    ["DWP Exchange - meta"] = 289,
    ["Dart Build Config (dart-build.json)"] = 249,
    ["Dart Test Config (dart-test.json)"] = 250,
    ["DashLord Configuration"] = 251,
    ["Data Contract Specification"] = 252,
    ["Data Product Specification"] = 253,
    ["DataYoga Connections"] = 158,
    ["DataYoga Job"] = 159,
    ["Databricks Asset Bundles"] = 997,
    ["Datadog Continuous Testing"] = 444,
    ["Datadog Service Definition"] = 445,
    ["Datadog Software Catalog"] = 446,
    ["Datahub Ingestion Recipe"] = 952,
    ["Dein Config"] = 165,
    ["Deno Config (deno.json)"] = 259,
    ["Dependency cruiser"] = 166,
    ["DeployStack Configuration"] = 167,
    ["Deployer Recipe"] = 262,
    ["Deta Spacefile"] = 168,
    ["Detekt Config (detekt.yml)"] = 263,
    ["Devbox Config"] = 169,
    ["Devbox Plugin"] = 170,
    Devfile = 287,
    DipDup = 1049,
    ["Discord Webhook"] = 264,
    ["DocFx Config (docfx.json)"] = 268,
    Dofigen = 269,
    ["Dolittle Artifacts"] = 270,
    ["Dolittle Bounded Context Configuration"] = 271,
    ["Dolittle Event Horizons Configuration"] = 272,
    ["Dolittle Resources Configuration"] = 273,
    ["Dolittle Server Configuration"] = 274,
    ["Dolittle Tenant Map Configuration"] = 276,
    ["Dolittle Tenants Configuration"] = 275,
    ["Dolittle Topology"] = 277,
    ["DonateCaseBetterCasino menu"] = 1076,
    ["Drupal Breakpoints"] = 171,
    ["Drupal Config"] = 183,
    ["Drupal Info"] = 172,
    ["Drupal Layouts"] = 173,
    ["Drupal Libraries"] = 174,
    ["Drupal Links Action"] = 175,
    ["Drupal Links Contextual"] = 176,
    ["Drupal Links Menu"] = 177,
    ["Drupal Links Task"] = 178,
    ["Drupal Migration"] = 179,
    ["Drupal Permissions"] = 180,
    ["Drupal Recipe"] = 181,
    ["Drupal Routing"] = 182,
    ["Drupal Services"] = 184,
    ["Drush site aliases"] = 283,
    ["Dynamic Bash Aliases (.aliases)"] = 988,
    ["EAS config"] = 307,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 977,
    ["EasyVCR .NET"] = 308,
    ["Eidolon Resource"] = 1063,
    ["Elgato Stream Deck"] = 293,
    Elm = 1051,
    ["Embrace Config"] = 963,
    Endurica = 1001,
    ["Enterprise Contract Policy Spec"] = 294,
    ["Erda Pipeline"] = 1026,
    ["Erda Runtime"] = 1027,
    Esquio = 296,
    ["Estuary Flow Catalog"] = 942,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 300,
    ["EveryVoice TTS Toolkit Data Configuration"] = 301,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 305,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 304,
    ["EveryVoice TTS Toolkit Text Configuration"] = 302,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 303,
    ["Expo SDK"] = 306,
    ["F-Droid Data metadata"] = 312,
    ["FasterCI Configuration"] = 80,
    FiQuS = 316,
    Firebase = 314,
    ["FlexGet Config"] = 317,
    ["Flow.json Configurations"] = 1023,
    ["Fossa configuration file"] = 324,
    ["Fossa's fossa-deps file"] = 325,
    ["Foundry VTT - Base package Manifest"] = 319,
    ["Foundry VTT - Module Manifest"] = 320,
    ["Foundry VTT - System Data Template"] = 323,
    ["Foundry VTT - System Manifest"] = 321,
    ["Foundry VTT - World Manifest"] = 322,
    ["Foxx Manifest"] = 81,
    ["Freifunk.de Community API"] = 84,
    ["Frogbot Config"] = 85,
    ["G2P Mapping Configuration"] = 330,
    ["GCP Blueprint Metadata"] = 333,
    Gaspar = 331,
    ["GatewayCore API Gateway"] = 332,
    ["GeoJSON.json latest"] = 940,
    GherKing = 944,
    ["GitHub Action"] = 338,
    ["GitHub Actions typing"] = 1059,
    ["GitHub Discussion"] = 339,
    ["GitHub Funding"] = 340,
    ["GitHub Issue Template configuration"] = 341,
    ["GitHub Issue Template forms"] = 342,
    ["GitHub Workflow"] = 343,
    ["GitHub Workflow Template Properties"] = 344,
    ["GitHub automatically generated release notes configuration"] = 345,
    ["GitLab Agent for Kubernetes configuration"] = 1015,
    GitVersion = 335,
    ["Gitea Issue Template configuration"] = 336,
    ["Gitea Issue Template forms"] = 337,
    ["Gitpod Automations"] = 347,
    ["Gitpod Configuration"] = 348,
    ["GlazeWM settings"] = 1017,
    ["Global Privacy Control"] = 334,
    Goblet = 996,
    ["Golangci-lint Configuration"] = 363,
    ["Golangci-lint Custom Plugins Configuration"] = 364,
    ["Google Chrome Related Website Sets"] = 315,
    ["Google Cloud Workflows"] = 218,
    ["Google Digital Assetlinks"] = 1100,
    Goreleaser = 366,
    ["Goreleaser Pro"] = 367,
    Goss = 368,
    ["Gradle Build Cache Node"] = 891,
    ["Gradle Enterprise"] = 890,
    ["Grafana 5.x Dashboard"] = 369,
    ["GraphQL Code Generator"] = 373,
    ["GraphQL Config"] = 372,
    ["GraphQL Mesh"] = 371,
    ["Grunt JSHint task"] = 377,
    ["Grunt Watch task"] = 378,
    ["Grunt base task"] = 379,
    ["Grunt clean task"] = 375,
    ["Grunt copy task"] = 374,
    ["Grunt cssmin task"] = 376,
    HEMTT = 857,
    Hadolint = 871,
    Hammerkit = 901,
    ["Hardware Sentry Configuration"] = 956,
    ["HashiCorp Vault"] = 380,
    Hatch = 872,
    Hayson = 382,
    ["Haystack Pipeline"] = 383,
    ["Hazelcast 5 Configuration"] = 384,
    ["Hecate Input Schema"] = 1111,
    ["Helm Chart.lock"] = 186,
    ["Helm Chart.yaml"] = 185,
    ["Helm Unittest Test Suite"] = 187,
    ["Home Assistant Integration Manifest"] = 385,
    ["Homer dashboard configuration"] = 386,
    Hugo = 932,
    ["Hugo Theme"] = 931,
    ["Hyperfoil benchmark configuration"] = 392,
    ["IBM Zapp document"] = 393,
    ["IBM zCodeFormatSettings"] = 394,
    ["IMG Catapult PSP"] = 399,
    ["IVMS101 by CODE Protocol"] = 1016,
    Infrahub = 401,
    Istanbul = 959,
    ["JDownloader2 crawler multi-rules"] = 411,
    ["JDownloader2 crawler single-rules"] = 410,
    ["JFrog Applications Config"] = 412,
    ["JFrog File Spec"] = 413,
    ["JFrog Pipelines YML DSL"] = 965,
    ["JMeter DSL cli config"] = 414,
    JReleaser = 417,
    ["JSON Document Transform"] = 425,
    ["JSON Feed"] = 426,
    ["JSON Resume"] = 650,
    ["JSON Schema Draft 2020-12"] = 840,
    ["JSON Schema Draft 4"] = 837,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 998,
    ["JSON Schema Draft 7"] = 838,
    ["JSON Schema Draft 7 (unofficial strict)"] = 999,
    ["JSON Schema Draft 8 (2019-09)"] = 839,
    ["JSON-API"] = 424,
    ["JSON-e templates"] = 898,
    ["JSON-stat 2.0"] = 833,
    JSONPatch = 428,
    ["JSR Package Config (jsr.json)"] = 418,
    Jasmine = 405,
    Jekyll = 406,
    ["Jenkins X Pipelines"] = 407,
    ["Jenkins X Requirements"] = 408,
    Jest = 409,
    Jocker = 415,
    ["Jovo Language Models"] = 416,
    ["Jujutsu (jj) VCS config"] = 1112,
    ["KIMMDY config file"] = 439,
    ["KODE/CI build.yaml"] = 961,
    ["KSP-AVC"] = 834,
    ["KSP-CKAN"] = 835,
    ["KSP-NetKAN"] = 836,
    KSY = 1028,
    KSail = 328,
    ["Karakum configuration file"] = 326,
    Kas = 431,
    ["Kestra flow file"] = 440,
    ["Keycloak REST API"] = 968,
    ["Knative Functions - func.yaml"] = 327,
    ["Kometa (nightly) config file"] = 442,
    ["Kometa config file"] = 441,
    ["Kong DBLess config"] = 962,
    KrakenD = 443,
    ["Kubri Configuration"] = 450,
    LOOBin = 465,
    ["Lake configuration file"] = 1115,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 223,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 224,
    ["Landing Zone Accelerator on AWS - Global Config"] = 225,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 226,
    ["Landing Zone Accelerator on AWS - Network Config"] = 227,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 228,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 229,
    ["Landing Zone Accelerator on AWS - Security Config"] = 230,
    ["Lando (landofile)"] = 75,
    ["LangGraph Platform configuration"] = 1039,
    ["Language configuration"] = 1038,
    Lefthook = 454,
    ["Liferay client-extension.yaml"] = 461,
    ["LinkML Metamodel"] = 463,
    Liquibase = 907,
    ["Liquibase Flow File"] = 908,
    ["Lively Properties"] = 464,
    ["Lobe AI Agent"] = 77,
    Loki = 78,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 504,
    ["MS2Rescore Configuration"] = 507,
    ["Madness (madness.yml)"] = 979,
    ["MapEHR Mapping"] = 471,
    Markdownlint = 911,
    ["Mason Registry"] = 914,
    ["MegaLinter Custom Flavor"] = 474,
    ["MegaLinter configuration"] = 473,
    ["MegaLinter descriptor"] = 475,
    Melange = 1006,
    ["Meltano project definition"] = 476,
    ["Mergify Configuration"] = 508,
    ["Metadata for a Bazel module"] = 477,
    ["Metadata for a Cinnamon spice"] = 1055,
    ["Metatype Configuration"] = 478,
    ["MetricsHub Configuration"] = 479,
    ["MetricsHub Connector Configuration"] = 480,
    ["Micro Editor Syntax"] = 989,
    ["Microsoft Band Web Tile"] = 481,
    ["Microsoft RulesEngine workflow rules"] = 1043,
    ["Microsoft RulesEngine workflow rules list"] = 1044,
    ["Minecraft Custom Main Menu Mod"] = 1007,
    ["Minecraft Data Pack Advancement"] = 483,
    ["Minecraft Data Pack Biome"] = 484,
    ["Minecraft Data Pack Configured Carver"] = 485,
    ["Minecraft Data Pack Damage Type"] = 486,
    ["Minecraft Data Pack Dimension"] = 488,
    ["Minecraft Data Pack Dimension Type"] = 487,
    ["Minecraft Data Pack Item Modifier"] = 489,
    ["Minecraft Data Pack Loot Table"] = 490,
    ["Minecraft Data Pack Metadata"] = 491,
    ["Minecraft Data Pack Predicate"] = 492,
    ["Minecraft Data Pack Recipe"] = 493,
    ["Minecraft Data Pack Tag"] = 494,
    ["Minecraft Data Pack Template Pool"] = 495,
    ["Minecraft Data Pack Trim Material"] = 500,
    ["Minecraft Data Pack Trim Pattern"] = 501,
    ["Minecraft Resource Pack Lang"] = 496,
    ["Minecraft Resource Pack Particle"] = 497,
    ["Minecraft Resource Pack Texture Mcmeta"] = 499,
    ["Minecraft Resourcepack Sounds"] = 498,
    ["Monade CLI Stack Configuration"] = 511,
    ["MongoDB Atlas Search Index Definition"] = 960,
    ["Monika Configuration"] = 958,
    ["Monoweave Configuration"] = 506,
    ["Motif config"] = 853,
    MultiQC = 1093,
    ["NOX Framework (Service)"] = 524,
    ["Netin Diagnostic System Template"] = 918,
    ["Netlify config"] = 514,
    ["Network-as-Code Data Model"] = 515,
    ["Nightwatch.js"] = 517,
    ["Node.js configuration"] = 858,
    ["NueJS configuration file"] = 529,
    ["Nuitka.yaml"] = 1021,
    ["Nullstone config"] = 531,
    ["ONe's changelog entry"] = 545,
    ["ONe's service descriptor"] = 544,
    ["ORT Server repository environment configuration"] = 553,
    ["OSCAL Assessment Plan (AP)"] = 555,
    ["OSCAL Assessment Results (AR)"] = 556,
    ["OSCAL Catalog"] = 557,
    ["OSCAL Component Definition (CDef)"] = 558,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 559,
    ["OSCAL Profile"] = 560,
    ["OSCAL System Security Plan (SSP)"] = 561,
    ["OSS Review Toolkit configuration"] = 562,
    ["OSS Review Toolkit curation"] = 563,
    ["OSS Review Toolkit package configuration"] = 564,
    ["OSS Review Toolkit repository configuration"] = 565,
    ["OSS Review Toolkit resolutions"] = 566,
    ["October CMS columns"] = 535,
    ["October CMS fields"] = 536,
    Okteto = 537,
    Opctl = 856,
    ["Open Data Contract Standard (ODCS)"] = 548,
    ["Open Data Product Standard (ODPS)"] = 549,
    ["Open Know-How"] = 1098,
    ["OpenRewrite Resource"] = 547,
    OpenStatus = 1109,
    ["OpenUtau character yaml"] = 541,
    ["OpenUtau ustx"] = 542,
    ["OpenWeather Current Weather API"] = 897,
    ["OpenWeather Road Risk API"] = 896,
    ["Ory Hydra configuration"] = 391,
    ["Ory Keto configuration"] = 447,
    ["Ory Kratos configuration"] = 554,
    ["Ory Oathkeeper configuration"] = 533,
    ["Outblocks App configuration"] = 551,
    ["Outblocks database table"] = 552,
    ["Outblocks project configuration"] = 550,
    PDM = 572,
    Packer = 569,
    Pantsbuild = 975,
    ["Paper paper-plugin.yml"] = 570,
    ["Pipeline component"] = 909,
    ["Platform.sh application"] = 2,
    ["Platform.sh routes"] = 3,
    ["Platform.sh services"] = 4,
    ["Plex Prerolls"] = 580,
    ["PocketMine plugin.yml"] = 577,
    ["Postman collection"] = 584,
    ["Power Pages Configuration"] = 1110,
    ["Preset list for a WinUtil"] = 1058,
    ["ProActions AI-Kit Configuration"] = 593,
    ["ProActions AI-Kit Configuration for Menus"] = 595,
    ["ProActions AI-Kit Configuration for Sections"] = 597,
    ["ProActions AI-Kit Configuration for Services"] = 594,
    ["ProActions AI-Kit Configuration for Steps"] = 598,
    ["ProActions AI-Kit Configuration for Templates"] = 596,
    ["Problem object RFC9457"] = 1004,
    ["Problem package generators"] = 599,
    Pterodactyl = 955,
    ["Pull Request Labeler"] = 615,
    Pulumi = 623,
    ["PyGTA Config"] = 619,
    PyProject = 624,
    Pylock = 1101,
    Pyright = 625,
    ["Python script metadata"] = 1095,
    ["QType AI DSL"] = 628,
    Qgoda = 627,
    Qodana = 928,
    ["Qt Creator workspace file"] = 1036,
    ["Quali Torque Blueprint Spec 2"] = 953,
    ["QueryFirst config file"] = 971,
    ["RKE Cluster Configuration JSON"] = 906,
    ["RKE Cluster Configuration YAML"] = 905,
    RadioHound = 618,
    Railway = 629,
    ["Rancher Fleet"] = 620,
    ["Rattler-build"] = 630,
    Ray = 870,
    ["Read the Docs"] = 622,
    ["Red-DiscordBot Cog"] = 637,
    ["Red-DiscordBot Cog Repo"] = 638,
    ["Red-DiscordBot Trivia"] = 639,
    ["Render Blueprints"] = 904,
    RenderCV = 652,
    Renovate = 651,
    ["Replit config"] = 645,
    Restate = 1088,
    RoadRunner = 654,
    ["Roo Coder Custom Modes"] = 656,
    Rubocop = 647,
    ["Rudder techniques"] = 1011,
    Ruff = 648,
    ["Rust Project"] = 649,
    ["Rust toolchain"] = 659,
    ["SDMX data message"] = 685,
    ["SDMX metadata message"] = 684,
    ["SDMX structure message"] = 683,
    ["SIL Kit Participant Configuration"] = 695,
    ["SIL Kit Registry Configuration"] = 696,
    ["SPDX 2.3"] = 732,
    SWADL = 746,
    ["Safebox Config"] = 966,
    ["Sapphire CLI Config"] = 662,
    ["SauceCTL Configuration"] = 915,
    ["Schema Catalog"] = 677,
    ["Scoop manifest"] = 682,
    ["Semantic Data Fabric (SDF) file"] = 686,
    ["Semgrep Rule"] = 688,
    ["Serenity Code Generator (Sergen)"] = 689,
    ["Serverless Framework Configuration"] = 922,
    ["Serverless Workflow"] = 924,
    ["Settings for a Cinnamon spice"] = 1054,
    ["Settings.paf"] = 691,
    ["Shopware 6 Configuration"] = 925,
    ["Shopware CLI Extension Store Configuration"] = 926,
    ["Shopware CLI Project Store Configuration"] = 927,
    ["Sigma Detection Rule"] = 693,
    ["Sigrid scope configuration file"] = 694,
    ["SkyPilot Task JSON"] = 1012,
    ["Slack app manifest"] = 698,
    Solidarity = 703,
    ["Solution filters"] = 704,
    ["Source Maps v3"] = 705,
    Sourcery = 706,
    ["Spack bootstrap.yaml"] = 707,
    ["Spack cdash.yaml"] = 708,
    ["Spack ci.yaml"] = 709,
    ["Spack compilers.yaml"] = 710,
    ["Spack concretizer.yaml"] = 711,
    ["Spack config.yaml"] = 712,
    ["Spack definitions.yaml"] = 713,
    ["Spack develop.yaml"] = 714,
    ["Spack env_vars.yaml"] = 715,
    ["Spack environment"] = 721,
    ["Spack include.yaml"] = 716,
    ["Spack mirrors.yaml"] = 717,
    ["Spack modules.yaml"] = 718,
    ["Spack packages.yaml"] = 719,
    ["Spack repos.yaml"] = 720,
    ["Spack toolchains.yaml"] = 722,
    ["Spack upstreams.yaml"] = 723,
    ["Spack view.yaml"] = 724,
    ["Speakeasy Generation Config File"] = 728,
    ["Speakeasy Lint Configuration File"] = 725,
    ["Speakeasy Test Generation Configuration File"] = 726,
    ["Speakeasy Workflow File"] = 727,
    SpecIF = 729,
    ["Sponge Mixin configuration"] = 730,
    StackBlitz = 736,
    ["StackHawk Scanner Configuration"] = 921,
    Stale = 737,
    ["Starlake Data Pipeline"] = 894,
    Starship = 738,
    ["Statamic Blueprint"] = 739,
    ["Stella configuration file"] = 740,
    ["Stryker Mutator"] = 743,
    ["StyleCop Analyzers Configuration"] = 744,
    ["Stylelint (.stylelintrc)"] = 745,
    ["Stylua Config"] = 1102,
    ["Sublime Syntax"] = 967,
    ["Subsquid squid manifest"] = 1014,
    ["Swagger API 2.0"] = 747,
    ["Synadia Connect Component"] = 748,
    TSON = 783,
    TSTyche = 784,
    ["TYPO3 Vendor Bundler config"] = 789,
    ["Tab data for a LinUtil"] = 1061,
    ["Tab list for a LinUtil"] = 1060,
    Tach = 749,
    ["Tach Domain"] = 750,
    Talhelper = 752,
    ["Talisman configuration"] = 753,
    Taplo = 1103,
    ["Taskfile config"] = 899,
    Taurus = 754,
    Tauticord = 755,
    Telefonistka = 1089,
    ["Terrateam config"] = 1114,
    ["TestEnvironment.json"] = 766,
    ["TextMate Grammar"] = 765,
    Threagile = 761,
    ["Tier.run pricing.json"] = 758,
    Tikibase = 759,
    Tombi = 764,
    ["Traefik v2"] = 769,
    ["Traefik v2 File Provider"] = 770,
    ["Traefik v3"] = 771,
    ["Traefik v3 File Provider"] = 772,
    ["Travis CI (.travis.yml)"] = 768,
    Trident = 1085,
    ["TrueScript for *.tscript files"] = 775,
    ["Tugboat QA config.yml"] = 1082,
    TunnelHub = 1002,
    Turborepo = 767,
    Tycho = 1050,
    Tye = 929,
    ["Tyk Gateway - Open Source v5.7+"] = 1094,
    ["Typst Manifest"] = 790,
    ["UET BuildConfig.json"] = 972,
    ["UI5 Manifest"] = 796,
    ["UNCORS configuration"] = 800,
    ["UTAM Page Object"] = 799,
    ["Ubuntu Server Autoinstall"] = 794,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1086,
    ["Uniswap Token List"] = 882,
    ["Universal Schedule Format"] = 801,
    ["Unreal Engine Uplugin"] = 973,
    ["Unreal Engine Uproject"] = 974,
    ["UpCloud CLI (upctl) configuration"] = 1087,
    ["Updatecli Compose"] = 937,
    ["Updatecli Policy Manifest"] = 938,
    ["Updatecli Policy Metadata"] = 939,
    Uplift = 970,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 903,
    V2Ray = 943,
    ["VSCode Code Snippets"] = 206,
    ["VSIX CLI publishing"] = 821,
    Vector = 803,
    ["Vela Pipeline Configuration"] = 806,
    Vercel = 205,
    ["Version Bumper config"] = 811,
    ["Viash Component Config"] = 1091,
    ["Viash Package Config"] = 1092,
    Visivo = 1000,
    ["WP-CLI"] = 831,
    Wake = 1084,
    ["Waku Config"] = 1064,
    ["Web App Manifest"] = 827,
    ["Web types"] = 830,
    WebExtensions = 826,
    ["Webman package recipe"] = 949,
    ["Windows Package Manager Installer Manifest"] = 878,
    ["Windows Package Manager Locale Manifest"] = 879,
    ["Windows Package Manager Singleton Manifest"] = 877,
    Winutil = 880,
    ["WireMock stub mapping"] = 1067,
    ["Woodpecker pipeline config"] = 917,
    ["Wrangler CLI"] = 832,
    ["Xstate Machine"] = 935,
    ["Yandex Workflow Language"] = 1056,
    ["Yarn Config (.yarnrc.yml)"] = 892,
    ["Yippee-Ki-JSON configuration YML"] = 884,
    ["YouTrack App"] = 1053,
    ["Zerops.io config"] = 1041,
    ["Zerops.io import"] = 1042,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 1005,
    ...
    ["behat.yml"] = 106,
    ["bigquery-table"] = 95,
    ["bioimageio resource description"] = 1022,
    ...
    ["ccmod.json"] = 1065,
    changelogging = 1033,
    ["chisel-slices.json"] = 232,
    ["chrome-extension-locales-messages.json"] = 213,
    ["chutzpah.json"] = 214,
    cibuildwheel = 141,
    ["clang-format (.clang-format)"] = 941,
    ["clang-tidy"] = 193,
    clangd = 192,
    clib = 194,
    ["cloud-init: cloud-config userdata"] = 196,
    ["cloud-sdk-pipeline-configuration"] = 216,
    ["cloudbuild.json"] = 217,
    cloudify = 195,
    codemagic = 197,
    ["coffeelint.json"] = 234,
    ["commands.json"] = 209,
    ["commitlint (.commitlintrc)"] = 881,
    ["committed.toml"] = 235,
    ["compile_commands.json"] = 208,
    ["compilerconfig.json"] = 207,
    ["completely.yml"] = 978,
    ["component-detection-manifest.json"] = 238,
    ["component.json"] = 237,
    ["composer.json"] = 236,
    ["conda-forge"] = 144,
    ["config.yaml"] = 621,
    ["contentmanifest.json"] = 215,
    ["contribute.json"] = 239,
    ["cosmos.config.json"] = 211,
    ["crowdin.yml"] = 240,
    ["ctfd-setup configuration file"] = 1074,
    ["custom-elements.json"] = 992,
    ["cypress.json"] = 244,
    ["datalogic-scan2deploy-android"] = 254,
    ["datalogic-scan2deploy-ce"] = 255,
    ...
    ["ddev-global"] = 256,
    ["ddev-project"] = 257,
    ["debugsettings.json"] = 258,
    ["dependabot-v2.json"] = 261,
    ["dependabot.json"] = 260,
    ["deployed-cli"] = 934,
    ["devcontainer.json"] = 199,
    devinit = 886,
    ["devspace.yaml"] = 957,
    djlint = 887,
    ["docker bake"] = 266,
    ["docker sequencer"] = 267,
    ["docker-compose.yml"] = 885,
    ["dockerd.json"] = 265,
    ["dotnet Release Index manifest"] = 278,
    ["dotnet-tools.json"] = 279,
    ["dotnetcli.host.json"] = 280,
    ["dprint.json"] = 281,
    ["drone.json"] = 282,
    ["dss-2.0.0.json"] = 284,
    ["dstack configuration"] = 285,
    ["dtool dataset metadata"] = 1069,
    ["dvc.yaml"] = 286,
    ["ecosystem.json"] = 291,
    eksctl = 292,
    ["electron-builder configuration file"] = 298,
    ["epr-manifest.json"] = 297,
    ["evcc.yaml"] = 299,
    ["ezd task runner"] = 309,
    ["fabric.mod.json"] = 311,
    ["first-timers-bot"] = 318,
    ["flagd flag configuration"] = 82,
    ["fly.io Configuration"] = 83,
    fulibWorkflows = 916,
    ["function.json"] = 329,
    ["gRPC API Gateway & OpenAPI Config"] = 7,
    ["gematik health care insurance list"] = 1080,
    ["gematik health care patient list"] = 1077,
    ["gematik health care provider institution list"] = 1079,
    ["gematik health care provider list"] = 1078,
    ["gematik tiger test environment configuration"] = 1081,
    ["gitlab-ci"] = 346,
    ["global.json"] = 362,
    ["go-feature-flag Flag Configuration"] = 365,
    ["haxelib.json"] = 381,
    helmfile = 873,
    helmwave = 874,
    ["host-meta.json"] = 388,
    ...
    ["ide.host.json"] = 395,
    ["ifstate.conf"] = 396,
    ["imageoptimizer.json"] = 397,
    ["importmap.json"] = 400,
    ["ioBroker Configuration"] = 402,
    ["ioBroker JSON UI"] = 403,
    ["ioBroker Package manifest"] = 404,
    ["ize.toml"] = 969,
    ["jsconfig.json"] = 429,
    ["jscpd Configuration"] = 954,
    jsdoc = 869,
    ["k3d.yaml"] = 430,
    ["k9s aliases.yaml"] = 432,
    ["k9s cluster-config.yaml"] = 434,
    ["k9s config.yaml"] = 433,
    ["k9s hotkeys.yaml"] = 435,
    ["k9s plugins.yaml"] = 436,
    ["k9s skin.yaml"] = 437,
    ["k9s views.yaml"] = 438,
    ["kontinuous-config.yaml"] = 449,
    ["kontinuous-values.yaml"] = 448,
    ["kustomization.yaml"] = 451,
    ["label-commenter-config.yml"] = 452,
    ["latexindent configuration"] = 76,
    ["launchsettings.json"] = 453,
    lazydocker = 991,
    lazygit = 990,
    ["lego.json"] = 455,
    ["lerna.json"] = 456,
    ["lgtm.yml"] = 457,
    ["liblab.config.json"] = 458,
    ["libman.json"] = 459,
    ["license-report-config.json"] = 460,
    ["linkinator.config.json"] = 462,
    ["lint-staged (.lintstagedrc)"] = 848,
    ["local.settings.json"] = 467,
    ["localazy.json"] = 468,
    ["lotus.yaml"] = 466,
    ["lsdlschema.json"] = 469,
    ["markdown-link-check"] = 912,
    maturin = 913,
    mboats = 920,
    ["micro-settings.json"] = 984,
    ["mimetypes.json"] = 482,
    ["mirrord config"] = 849,
    mise = 850,
    ["mkdocs.yml"] = 502,
    ["monospace.yml"] = 505,
    ["moon.yml"] = 1066,
    ["mprocs Configuration file"] = 1037,
    ["mrdocs.yml"] = 503,
    ["mta.yaml"] = 851,
    ["mtad.yaml"] = 852,
    ["mycode.json"] = 512,
    nFPM = 516,
    ["napari plugin manifest"] = 513,
    neoload = 864,
    ["nest-cli"] = 519,
    ["ninjs (News in JSON)"] = 518,
    ["nitro.json"] = 863,
    ["nixd configuration"] = 1010,
    ["nlu.json"] = 520,
    ["nodemon.json"] = 522,
    ["noodl config"] = 919,
    ["notebook.mod.json"] = 523,
    now = 859,
    ["npm-badges"] = 526,
    ["nswag.json"] = 530,
    ntangle = 532,
    ["nuclei-template.yaml"] = 527,
    ["nuget-project.json"] = 528,
    ["ocelot.json"] = 534,
    ["omnisharp.json"] = 538,
    ["openapi.json"] = 539,
    ["openfin.json"] = 546,
    ...
    ["ops.yaml"] = 543,
    ["package.json"] = 567,
    ["package.manifest"] = 568,
    ["partial-black.json"] = 107,
    ["pathfinder.yml"] = 571,
    ["pattern.json"] = 574,
    ["petstore-v1.0"] = 964,
    pgap_yaml_input_reader = 573,
    ["pixi.toml"] = 575,
    ["plagiarize-me.yaml"] = 579,
    ["plagiarize.yaml"] = 578,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1070,
    ["podbard.yaml"] = 581,
    ["portman.json"] = 582,
    ["prefect.toml"] = 590,
    ["prettierrc.json"] = 591,
    ["prisma.yml"] = 592,
    ["project-1.0.0-beta3.json"] = 601,
    ["project-1.0.0-beta4.json"] = 602,
    ["project-1.0.0-beta5.json"] = 603,
    ["project-1.0.0-beta6.json"] = 604,
    ["project-1.0.0-beta8.json"] = 605,
    ["project-1.0.0-rc1.json"] = 606,
    ["project-1.0.0-rc2.json"] = 607,
    ["project.json"] = 600,
    ["project.owasp.yaml"] = 608,
    ["prometheus.json"] = 609,
    ["prometheus.rules.json"] = 610,
    ["prometheus.rules.test.json"] = 611,
    ["proxies.json"] = 612,
    ["publiccode.yml"] = 613,
    ["pubspec.yaml"] = 614,
    ["pyrseas-0.8.json"] = 617,
    pytest = 626,
    ["quilt.mod.json"] = 985,
    ["rc3 auth"] = 631,
    ["rc3 collection"] = 632,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 865,
    ["release-please-config.json"] = 641,
    ["release-please-manifest.json"] = 642,
    ["release-plz.toml"] = 643,
    ["renv.lock"] = 653,
    ["rivet.json"] = 1009,
    ["rivet.yaml (legacy)"] = 1008,
    rockcraft = 655,
    runny = 657,
    rustfmt = 658,
    sake = 1097,
    samt = 660,
    samtrc = 661,
    ["sarif-1.0.0.json"] = 663,
    ["sarif-2.0.0.json"] = 664,
    ["sarif-2.1.0"] = 674,
    ["sarif-2.1.0-rtm.2"] = 665,
    ["sarif-2.1.0-rtm.3"] = 667,
    ["sarif-2.1.0-rtm.4"] = 669,
    ["sarif-2.1.0-rtm.5"] = 671,
    ["sarif-2.1.0-rtm.6"] = 672,
    ["sarif-external-property-file-2.1.0"] = 675,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 666,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 668,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 670,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 673,
    ["scalingo.json configuration"] = 676,
    ["schema.org - Action"] = 678,
    ["schema.org - ContactPoint"] = 679,
    ["schema.org - Place"] = 680,
    ["schema.org - Thing"] = 681,
    ["secrethub.yml"] = 987,
    ["semantic-release"] = 687,
    ["servicehub.config.json"] = 843,
    ["servicehub.service.json"] = 842,
    ["settings.job"] = 690,
    ["sfdx-hardis configuration"] = 692,
    ["shard.yml"] = 1025,
    ["size-limit configuration"] = 697,
    ["skaffold.yaml"] = 910,
    ["skyuxconfig.json"] = 699,
    snapcraft = 700,
    ["snowflake-config"] = 701,
    ["snowflake-connections"] = 702,
    ["spicepod.yaml"] = 1045,
    ["sqlc configuration"] = 733,
    ["stripe-app-local.json"] = 742,
    ["stripe-app.json"] = 741,
    swcrc = 895,
    ["task.json"] = 751,
    taskcat = 860,
    ["template.json"] = 756,
    ["templatsources.json"] = 757,
    ["theme.json"] = 760,
    ["tizen_workspace.json"] = 762,
    tldr = 763,
    ["tm_devices configuration file"] = 1108,
    tmuxinator = 846,
    ["transcend.yml"] = 773,
    ["tree-sitter grammar.json"] = 370,
    ["trime.yaml"] = 774,
    ["trunk.yaml"] = 776,
    ["ts-force-config.json"] = 781,
    ["tsconfig.json"] = 777,
    ["tsd.json"] = 778,
    ["tsdoc.json"] = 779,
    ["tsdrc.json"] = 780,
    ...
    v8r = 825,
    vcluster = 1031,
    ["vcpkg configuration file"] = 204,
    ["vcpkg manifest file"] = 203,
    ["vega-lite.json"] = 805,
    ["vega.json"] = 804,
    ["venvironment-basic.yaml"] = 808,
    ["venvironment.yaml"] = 807,
    ["venvplus-basic.yaml"] = 810,
    ["venvplus.yaml"] = 809,
    version = 1090,
    ["version.json"] = 812,
    ["vhwdebugger-binding.yaml"] = 814,
    ["vim-addon-info"] = 815,
    ["vs-2017.3.host.json"] = 817,
    ["vs-nesting.json"] = 818,
    ["vsls.json"] = 816,
    ["vss-extension.json"] = 822,
    vtcfg = 1096,
    ["vtesttree.yaml"] = 823,
    ["vtestunit.yaml"] = 824,
    ["warp-keysets.json"] = 993,
    ["warp-themes.json"] = 994,
    ["warp-workflows.json"] = 995,
    ["webhint.io"] = 950,
    ["webjobpublishsettings.json"] = 829,
    ["webjobs-list.json"] = 828,
    ["well-known-fursona"] = 1032,
    ["xs-app.json"] = 855,
    ["xunit.runner.json"] = 841,
    yamllint = 883,
    zuul = 866,
    ["Žinoma"] = 876
  },
