...
M.json = {
  ...
  index = {
    ...
    ["Adobe UXP Manifest"] = 807,
    ["Aerleon Network & Service Definitions"] = 7,
    ["Aerleon Policy"] = 8,
    ["Airlock Microgateway"] = 12,
    ["Airplane task"] = 13,
    ["Alacritty Configuration"] = 714,
    ["All Contributors configuration file"] = 772,
    ...
    ["Azure Pipelines"] = 64,
    ["Azure Static Web Apps CLI configuration file"] = 548,
    ["Azure Static Web Apps configuration file"] = 547,
    ["BX CI"] = 102,
    ["Bashly (bashly.yml)"] = 776,
    ["Bashly Settings (bashly-settings.yml)"] = 777,
    ["Better Code Hub"] = 687,
    ["Better Scripts"] = 103,
    Bigconfig = 81,
    ...
    ["Butane Config"] = 727,
    ["CGS Custom Card Game (CardGameDef.json)"] = 812,
    ["CICS TS region tagging"] = 736,
    ["CICS TS resource import"] = 737,
    ["CICS TS resource model"] = 738,
    ["CICS TS resource overrides"] = 739,
    ["CMake Presets"] = 105,
    ["CNC Codes"] = 116,
    ...
    ["Custom Machinery Machine"] = 813,
    ["Custom Machinery Recipe"] = 814,
    ...
    ["Databricks Asset Bundles"] = 793,
    ["Datadog Service Definition"] = 343,
    ["Datahub Ingestion Recipe"] = 743,
    ["Dein Config"] = 122,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 784,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 773,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 809,
    GitVersion = 268,
    ["Gitpod Configuration"] = 277,
    ["GlazeWM settings"] = 811,
    ...
    Hadolint = 666,
    Hammerkit = 694,
    ["Hardware Sentry Configuration"] = 747,
    Hatch = 667,
    Hayson = 297,
    ...
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 794,
    ...
    Kas = 339,
    ["Keycloak REST API"] = 764,
    ["Knative Functions - func.yaml"] = 261,
    ["KoDE/CI build.yaml"] = 752,
    ["Kong DBLess config"] = 753,
    KrakenD = 342,
    LOOBin = 361,
    Lefthook = 350,
    ...
    ["Lobe AI Agent"] = 63,
    ["MLOS Configs"] = 395,
    ["MS2Rescore Configuration"] = 397,
    ["Madness (madness.yml)"] = 775,
    Markdownlint = 703,
    ["Mason Registry"] = 705,
    ...
    ["MongoDB Atlas Search Index Definition"] = 751,
    ["Monika Configuration"] = 749,
    ["Motif config"] = 650,
    ...
    Qgoda = 484,
    Qodana = 719,
    ["Quali Torque Blueprint Spec 2"] = 744,
    ["QueryFirst config file"] = 767,
    ...
    ["Rust Project"] = 494,
    ["Rust toolchain"] = 501,
    ["SIL Kit Participant Configuration"] = 533,
    ["SIL Kit Registry Configuration"] = 534,
    SWADL = 559,
    ["Safebox Config"] = 757,
    ...
    ["Serverless Framework Configuration"] = 713,
    ["Serverless Workflow"] = 715,
    ["Settings.paf"] = 529,
    ["Shopware 6 Configuration"] = 716,
    ["Shopware CLI Extension Store Configuration"] = 717,
    ["Shopware CLI Project Store Configuration"] = 718,
    Sigma = 531,
    ["Sigrid scope configuration file"] = 532,
    ["SkyPilot Task JSON"] = 806,
    ["Slack app manifest"] = 536,
    Solidarity = 539,
    ["Solution filters"] = 540,
    ["Source Maps v3"] = 541,
    Sourcery = 542,
    SpecIF = 543,
    ["Sponge Mixin configuration"] = 544,
    StackBlitz = 549,
    ["StackHawk Scanner Configuration"] = 712,
    Stale = 550,
    ["Starlake Data Pipeline"] = 688,
    Starship = 551,
    ["Statamic Blueprint"] = 552,
    ["Stella configuration file"] = 553,
    ["StrmPrivacy Data Connector"] = 761,
    ["StrmPrivacy Data Contract"] = 762,
    ["StrmPrivacy SimpleSchema"] = 759,
    ["StrmPrivacy Stream"] = 760,
    ["StrmPrivacy batch job configuration file"] = 758,
    ["Stryker Mutator"] = 556,
    ["StyleCop Analyzers Configuration"] = 557,
    ["Stylelint (.stylelintrc)"] = 558,
    ["Sublime Syntax"] = 763,
    ["Subsquid squid manifest"] = 808,
    ["Swagger API 2.0"] = 560,
    TSON = 585,
    TSTyche = 586,
    Talhelper = 562,
    ["Talisman configuration"] = 563,
    ["Taskfile config"] = 693,
    Taurus = 564,
    ["TestEnvironment.json"] = 573,
    ["TextMate Grammar"] = 572,
    ["Tier.run pricing.json"] = 567,
    Tikibase = 568,
    ["Traefik v2"] = 576,
    ["Traefik v2 File Provider"] = 577,
    ["Travis CI (.travis.yml)"] = 575,
    TunnelHub = 798,
    Turborepo = 574,
    Tye = 720,
    ["UET BuildConfig.json"] = 768,
    ["UI5 Manifest"] = 595,
    ["UNCORS configuration"] = 599,
    ["UTAM Page Object"] = 598,
    ["Ubuntu Server Autoinstall"] = 593,
    ["Uniswap Token List"] = 676,
    ["Unreal Engine Uplugin"] = 769,
    ["Unreal Engine Uproject"] = 770,
    ["Updatecli Compose"] = 728,
    ["Updatecli Policy Manifest"] = 729,
    ["Updatecli Policy Metadata"] = 730,
    Uplift = 766,
    ["User Journey Map"] = 696,
    V2Ray = 734,
    ["VSCode Code Snippets"] = 160,
    ["VSIX CLI publishing"] = 613,
    ["Vela Pipeline Configuration"] = 602,
    Vercel = 159,
    Visivo = 796,
    ["Web App Manifest"] = 620,
    ["Web types"] = 623,
    WebExtensions = 619,
    ["Webman package recipe"] = 740,
    ...
    ["settings.job"] = 528,
    ["sfdx-hardis configuration"] = 530,
    ["size-limit configuration"] = 535,
    ["skaffold.yaml"] = 702,
    ["skyuxconfig.json"] = 537,
    snapcraft = 538,
    ["sqlc configuration"] = 546,
    ["stripe-app-local.json"] = 555,
    ["stripe-app.json"] = 554,
    swcrc = 689,
    ["task.json"] = 561,
    taskcat = 656,
    ["template.json"] = 565,
    ["templatsources.json"] = 566,
    ["theme.json"] = 569,
    ["tizen_workspace.json"] = 570,
    tldr = 571,
    tmuxinator = 642,
    ["transcend.yml"] = 578,
    ["tree-sitter grammar.json"] = 286,
    ["trunk.yaml"] = 579,
    ["ts-force-config.json"] = 583,
    ["tsconfig.json"] = 580,
    ["tsd.json"] = 581,
    ["tsdrc.json"] = 582,
    ["tslint.json"] = 584,
    ...
    ["vega-lite.json"] = 601,
    ["vega.json"] = 600,
    ["venvironment-basic.yaml"] = 604,
    ["venvironment.yaml"] = 603,
    ["version.json"] = 605,
    ["vim-addon-info"] = 607,
    ...
    ["vtesttree.yaml"] = 615,
    ["vtestunit.yaml"] = 616,
    ["warp-keysets.json"] = 789,
    ["warp-themes.json"] = 790,
    ["warp-workflows.json"] = 791,
    ["webhint.io"] = 741,
