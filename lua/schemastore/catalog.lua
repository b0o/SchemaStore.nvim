...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 185,
    [".cryproj (generic)"] = 635,
    [".cryproj engine-5.2"] = 630,
    [".cryproj engine-5.3"] = 631,
    [".cryproj engine-5.4"] = 632,
    [".cryproj engine-5.5"] = 633,
    [".cryproj engine-dev"] = 634,
    [".csscomb.json"] = 187,
    [".csslintrc"] = 188,
    [".es6importsorterrc.json"] = 770,
    [".eslintrc"] = 237,
    [".esmrc.json"] = 229,
    [".ffizer.yaml"] = 241,
    [".htmlhintrc"] = 297,
    ...
    [".mtaext"] = 646,
    [".nodehawkrc"] = 402,
    [".npmpackagejsonlintrc"] = 405,
    [".phraseapp.yml"] = 453,
    [".pmbot.yml"] = 441,
    [".postcssrc"] = 448,
    [".powerpages-web-template-manifest"] = 450,
    [".pre-commit-config.yml"] = 451,
    [".pre-commit-hooks.yml"] = 452,
    [".putout.json"] = 472,
    [".rehyperc"] = 484,
    [".remarkrc"] = 486,
    [".sprite files"] = 542,
    ...
    ["<div>RIOTS' studio configuration"] = 614,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 360,
    AIConfig = 13,
    ["API Builder"] = 678,
    ["AVA Configuration"] = 739,
    ["AWS CDK cdk.json"] = 169,
    ["AWS CloudFormation"] = 170,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 171,
    ["AWS SAM CLI Samconfig"] = 172,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 14,
    ["Airplane task"] = 15,
    ["Alacritty Configuration"] = 711,
    ["All Contributors configuration file"] = 769,
    ...
    ["Azure Pipelines"] = 63,
    ["Azure Static Web Apps CLI configuration file"] = 545,
    ["Azure Static Web Apps configuration file"] = 544,
    ["BX CI"] = 99,
    ["Better Code Hub"] = 682,
    ["Better Scripts"] = 100,
    Bigconfig = 80,
    BizTalkServerApplicationSchema = 652,
    Bleep = 101,
    ...
    ["Butane Config"] = 724,
    ["CICS TS region tagging"] = 733,
    ["CICS TS resource import"] = 734,
    ["CICS TS resource model"] = 735,
    ["CICS TS resource overrides"] = 736,
    ["CMake Presets"] = 102,
    ["CNC Codes"] = 113,
    ...
    Cheatsheets = 721,
    ["Chrome Extension"] = 162,
    ["CircleCI config.yml"] = 139,
    ["Citation File Format"] = 174,
    CityJSON = 111,
    ["Code Climate"] = 140,
    CodeCV = 60,
    ["CodeShip Pro services configuration files"] = 151,
    ["CodeShip Pro steps configuration files"] = 152,
    ["Codecov configuration files"] = 150,
    Codux = 148,
    ["Cog config file"] = 114,
    ["Commandbox Box.json"] = 115,
    ["Commandbox Server.json"] = 116,
    ["Common Catalog Data"] = 160,
    ["Common types for all schemas"] = 1,
    Conjure = 112,
    ["Container Structure Test"] = 665,
    Containerlab = 690,
    ["Crowdsec collection config"] = 181,
    ["Crowdsec parser config"] = 182,
    ["Crowdsec scenario config"] = 183,
    ["CumulusCI Config"] = 117,
    ["DWP Exchange - catalogue entry"] = 226,
    ["DWP Exchange - gateway"] = 224,
    ["DWP Exchange - meta"] = 225,
    ["Dart build configuration"] = 189,
    ["Dart test config"] = 190,
    ["DashLord configuration"] = 191,
    ["Data Contract Specification"] = 192,
    ["Databricks Asset Bundles"] = 790,
    ["Datadog Service Definition"] = 337,
    ["Datahub Ingestion Recipe"] = 740,
    ["Dein Config"] = 119,
    Deno = 198,
    ["Deployer Recipe"] = 201,
    ["Deta Spacefile"] = 120,
    ...
    Devfile = 223,
    ["Discord Webhook"] = 203,
    ["Dolittle Artifacts"] = 207,
    ["Dolittle Bounded Context Configuration"] = 208,
    ["Dolittle Event Horizons Configuration"] = 209,
    ["Dolittle Resources Configuration"] = 210,
    ["Dolittle Server Configuration"] = 211,
    ["Dolittle Tenant Map Configuration"] = 213,
    ["Dolittle Tenants Configuration"] = 212,
    ["Dolittle Topology"] = 214,
    ["Drupal Breakpoints"] = 123,
    ["Drupal Config"] = 134,
    ["Drupal Info"] = 124,
    ["Drupal Layouts"] = 125,
    ["Drupal Libraries"] = 126,
    ["Drupal Links Action"] = 127,
    ["Drupal Links Contextual"] = 128,
    ["Drupal Links Menu"] = 129,
    ["Drupal Links Task"] = 130,
    ["Drupal Migration"] = 131,
    ["Drupal Permissions"] = 132,
    ["Drupal Routing"] = 133,
    ["Drupal Services"] = 135,
    ["Drush site aliases"] = 219,
    ["Embrace Config"] = 751,
    Endurica = 793,
    ["Error pages"] = 232,
    Esquio = 230,
    ["Estuary Flow Catalog"] = 730,
    ["Expo SDK"] = 235,
    ["F-Droid Data metadata"] = 240,
    ["Facets - FSDL - Application"] = 238,
    ["FasterCI Configuration"] = 64,
    FiQuS = 244,
    Firebase = 242,
    ["Fossa configuration file"] = 251,
    ["Fossa's fossa-deps file"] = 252,
    ["Foundry VTT - Base package Manifest"] = 246,
    ["Foundry VTT - Module Manifest"] = 247,
    ["Foundry VTT - System Data Template"] = 250,
    ["Foundry VTT - System Manifest"] = 248,
    ["Foundry VTT - World Manifest"] = 249,
    ["Foxx Manifest"] = 65,
    ["Freifunk.de Community API"] = 68,
    ["Frogbot Config"] = 69,
    ["Fusion resource pack metadata"] = 256,
    ["Fusion texture metadata"] = 257,
    ["G2P Mapping Configuration"] = 258,
    ["GCP Blueprint Metadata"] = 261,
    Gaspar = 259,
    ["GatewayCore API Gateway"] = 260,
    ["GeoJSON.json latest"] = 728,
    GherKing = 732,
    ["GitHub Action"] = 265,
    ...
    ["Global Privacy Control"] = 262,
    Goblet = 789,
    ["Google Chrome Related Website Sets"] = 243,
    ["Google Cloud Workflows"] = 168,
    Gorder = 277,
    Goreleaser = 278,
    ["Goreleaser Pro"] = 279,
    Goss = 280,
    ["Gradle Build Cache Node"] = 680,
    ["Gradle Enterprise"] = 679,
    ...
    Hadolint = 661,
    Hammerkit = 689,
    ["Hardware Sentry Configuration"] = 744,
    Hatch = 662,
    Hayson = 292,
    ...
    ["JFrog File Spec"] = 317,
    ["JFrog Pipelines YML DSL"] = 753,
    ["JMeter DSL cli config"] = 318,
    JReleaser = 320,
    ["JSON Document Transform"] = 327,
    ["JSON Feed"] = 328,
    ["JSON Resume"] = 491,
    ["JSON Schema Draft 2020-12"] = 626,
    ["JSON Schema Draft 4"] = 623,
    ["JSON Schema Draft 7"] = 624,
    ["JSON Schema Draft 7 (unofficial strict)"] = 791,
    ["JSON Schema Draft 8 (2019-09)"] = 625,
    ["JSON-API"] = 326,
    ["JSON-e templates"] = 687,
    ["JSON-stat 2.0"] = 620,
    JSONPatch = 330,
    Jasmine = 310,
    Jekyll = 311,
    ...
    ["KSP-AVC"] = 621,
    ["KSP-CKAN"] = 622,
    ["Karakum configuration file"] = 253,
    Kas = 333,
    ["Keycloak REST API"] = 761,
    ["Knative Functions - func.yaml"] = 254,
    ["KoDE/CI build.yaml"] = 749,
    ["Kong DBLess config"] = 750,
    KrakenD = 336,
    LOOBin = 355,
    Lefthook = 344,
    ...
    ["Minecraft Custom Main Menu Mod"] = 798,
    ...
    ["MongoDB Atlas Search Index Definition"] = 748,
    ["Monika Configuration"] = 746,
    ["Motif config"] = 645,
    ["NOX Framework (Service)"] = 404,
    ["Netin Diagnostic System Template"] = 704,
    ["Netlify config"] = 395,
    ["Network-as-Code Data Model"] = 396,
    ["Nightwatch.js"] = 397,
    ["ONe's changelog entry"] = 420,
    ["ONe's service descriptor"] = 419,
    ["OSS Review Toolkit configuration"] = 427,
    ["OSS Review Toolkit curation"] = 428,
    ["OSS Review Toolkit package configuration"] = 429,
    ["OSS Review Toolkit repository configuration"] = 430,
    ["OSS Review Toolkit resolutions"] = 431,
    Opctl = 648,
    ["OpenRewrite Resource"] = 422,
    ["OpenUtau character yaml"] = 416,
    ["OpenUtau ustx"] = 417,
    ["OpenWeather Current Weather API"] = 686,
    ["OpenWeather Road Risk API"] = 685,
    ["Ory Hydra configuration"] = 298,
    ["Ory Keto configuration"] = 338,
    ["Ory Kratos configuration"] = 426,
    ["Ory Oathkeeper configuration"] = 411,
    ["Outblocks App configuration"] = 424,
    ["Outblocks database table"] = 425,
    ["Outblocks project configuration"] = 423,
    PDM = 437,
    ["PDM Partial"] = 438,
    Packer = 434,
    Pantsbuild = 768,
    ["Paper paper-plugin.yml"] = 435,
    ["Partial-Setuptools"] = 526,
    ["Partial-poetry"] = 444,
    ["Pipeline component"] = 696,
    ["PocketMine plugin.yml"] = 442,
    Poetry = 443,
    ["Postman collection"] = 449,
    ["Problem object RFC9457"] = 795,
    ["Problem package generators"] = 456,
    Pterodactyl = 743,
    ["Pull Request Labeler"] = 471,
    Pulumi = 477,
    PyProject = 478,
    Pyright = 479,
    Qgoda = 480,
    Qodana = 716,
    ["Quali Torque Blueprint Spec 2"] = 741,
    ["QueryFirst config file"] = 764,
    ["RKE Cluster Configuration JSON"] = 693,
    ["RKE Cluster Configuration YAML"] = 692,
    ["Rancher Fleet"] = 474,
    Ray = 660,
    ["Read the Docs"] = 476,
    ["Red-DiscordBot Cog"] = 481,
    ["Red-DiscordBot Cog Repo"] = 482,
    ["Red-DiscordBot Trivia"] = 483,
    RenderCV = 493,
    Renovate = 492,
    ["Replit config"] = 487,
    RoadRunner = 494,
    ["Rudder techniques"] = 800,
    Ruff = 489,
    ["Rust Project"] = 490,
    ["Rust toolchain"] = 496,
    ["SIL Kit Participant Configuration"] = 530,
    ["SIL Kit Registry Configuration"] = 531,
    SWADL = 556,
    ["Safebox Config"] = 754,
    ["Sapphire CLI Config"] = 499,
    ["SauceCTL Configuration"] = 701,
    ["Schema Catalog"] = 513,
    ["Scoop manifest"] = 518,
    ["Semantic Data Fabric (SDF) file"] = 519,
    ["Semgrep Rule"] = 521,
    ["Serenity Code Generator (Sergen)"] = 522,
    ["Serverless Framework Configuration"] = 710,
    ["Serverless Workflow"] = 712,
    ["Settings.paf"] = 524,
    Setuptools = 525,
    ["Shopware 6 Configuration"] = 713,
    ["Shopware CLI Extension Store Configuration"] = 714,
    ["Shopware CLI Project Store Configuration"] = 715,
    Sigma = 528,
    ["Sigrid scope configuration file"] = 529,
    ["SkyPilot Task JSON"] = 801,
    ["Slack app manifest"] = 533,
    Solidarity = 536,
    ["Solution filters"] = 537,
    ["Source Maps v3"] = 538,
    Sourcery = 539,
    SpecIF = 540,
    ["Sponge Mixin configuration"] = 541,
    StackBlitz = 546,
    ["StackHawk Scanner Configuration"] = 709,
    Stale = 547,
    ["Starlake Data Pipeline"] = 683,
    Starship = 548,
    ["Statamic Blueprint"] = 549,
    ["Stella configuration file"] = 550,
    ["StrmPrivacy Data Connector"] = 758,
    ["StrmPrivacy Data Contract"] = 759,
    ["StrmPrivacy SimpleSchema"] = 756,
    ["StrmPrivacy Stream"] = 757,
    ["StrmPrivacy batch job configuration file"] = 755,
    ["Stryker Mutator"] = 553,
    ["StyleCop Analyzers Configuration"] = 554,
    ["Sublime Syntax"] = 760,
    ["Swagger API 2.0"] = 557,
    TSON = 582,
    TSTyche = 583,
    Talhelper = 559,
    ["Talisman configuration"] = 560,
    ["Taskfile config"] = 688,
    Taurus = 561,
    ["TestEnvironment.json"] = 570,
    ["TextMate Grammar"] = 569,
    ["Tier.run pricing.json"] = 564,
    Tikibase = 565,
    ["Traefik v2"] = 573,
    ["Traefik v2 File Provider"] = 574,
    TunnelHub = 794,
    Turborepo = 571,
    Tye = 717,
    ["UET BuildConfig.json"] = 765,
    ["UI5 Manifest"] = 592,
    ["UNCORS configuration"] = 596,
    ["UTAM Page Object"] = 595,
    ["Ubuntu Server Autoinstall"] = 590,
    ["Uniswap Token List"] = 671,
    ["Unreal Engine Uplugin"] = 766,
    ["Unreal Engine Uproject"] = 767,
    ["Updatecli Compose"] = 725,
    ["Updatecli Policy Manifest"] = 726,
    ["Updatecli Policy Metadata"] = 727,
    Uplift = 763,
    ["User Journey Map"] = 691,
    V2Ray = 731,
    ["VSCode Code Snippets"] = 156,
    ["VSIX CLI publishing"] = 609,
    ["Vela Pipeline Configuration"] = 599,
    Vercel = 155,
    Visivo = 792,
    ["Web App Manifest"] = 616,
    ["Web types"] = 619,
    WebExtensions = 615,
    ["Webman package recipe"] = 737,
    ["Windows Package Manager Installer Manifest"] = 668,
    ["Windows Package Manager Locale Manifest"] = 669,
    ["Windows Package Manager Singleton Manifest"] = 667,
    ["Woodpecker pipeline config"] = 703,
    ["Xstate Machine"] = 723,
    ["Yippee-Ki-JSON configuration YML"] = 673,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 16,
    apko = 796,
    ...
    ["bamboo-spec"] = 74,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 774,
    ["bashly-strings.yml"] = 775,
    ["bashly.yml"] = 773,
    ["batect.yml"] = 73,
    ...
    ["chisel-slices.json"] = 173,
    ["chrome-extension-locales-messages.json"] = 163,
    ["chutzpah.json"] = 164,
    cibuildwheel = 109,
    clangd = 143,
    clib = 144,
    ["cloud-init: cloud-config userdata"] = 146,
    ["cloud-sdk-pipeline-configuration"] = 166,
    ["cloudbuild.json"] = 167,
    cloudify = 145,
    codemagic = 147,
    ["coffeelint.json"] = 175,
    ["commands.json"] = 159,
    ["compile_commands.json"] = 158,
    ["compilerconfig.json"] = 157,
    ["completely.yml"] = 771,
    ["component-detection-manifest.json"] = 178,
    ["component.json"] = 177,
    ["composer.json"] = 176,
    ["config.yaml"] = 475,
    ["contentmanifest.json"] = 165,
    ["contribute.json"] = 179,
    ["cosmos.config.json"] = 161,
    ["crowdin.yml"] = 180,
    cspell = 186,
    ["custom-elements.json"] = 785,
    ["cypress.json"] = 184,
    ["datalogic-scan2deploy-android"] = 193,
    ["datalogic-scan2deploy-ce"] = 194,
    ["dbt Project"] = 118,
    ["ddev-global"] = 195,
    ["ddev-project"] = 196,
    ["debugsettings.json"] = 197,
    ["dependabot-v2.json"] = 200,
    ["dependabot.json"] = 199,
    ["deployed-cli"] = 722,
    ["detekt.yml"] = 202,
    ["devcontainer.json"] = 149,
    devinit = 675,
    ["devspace.yaml"] = 745,
    djlint = 676,
    ["docfx.json"] = 206,
    ["docker sequencer"] = 205,
    ["docker-compose.yml"] = 674,
    ["dockerd.json"] = 204,
    ["dotnet Release Index manifest"] = 215,
    ["dotnetcli.host.json"] = 216,
    ["dprint.json"] = 217,
    ["drone.json"] = 218,
    ["dss-2.0.0.json"] = 220,
    ["dstack configuration"] = 221,
    ["dvc.yaml"] = 222,
    ["ecosystem.json"] = 227,
    eksctl = 228,
    ["electron-builder configuration file"] = 233,
    ["epr-manifest.json"] = 231,
    ["evcc.yaml"] = 234,
    ["ezd task runner"] = 236,
    ["fabric.mod.json"] = 239,
    ["first-timers-bot"] = 245,
    ...
    ["lsdlschema.json"] = 359,
    ["madness.yml"] = 772,
    ["markdown-lint-check"] = 699,
    mboats = 706,
    ["micro-settings.json"] = 777,
    ["mimetypes.json"] = 366,
    ["mirrord config"] = 640,
    mise = 641,
    ["mise-settings"] = 642,
    ...
    ["mycode.json"] = 392,
    mypy = 393,
    ["napari plugin manifest"] = 394,
    neoload = 654,
    ["nest-cli"] = 400,
    ["ninjs (News in JSON) 1.3"] = 399,
    ["ninjs (News in JSON) 2.0"] = 398,
    ["nlu.json"] = 401,
    ["nodemon.json"] = 403,
    ["noodl config"] = 705,
    now = 650,
    ...
    ["nswag.json"] = 409,
    ntangle = 410,
    ["nuclei-template.yaml"] = 407,
    ["nuget-project.json"] = 408,
    ["ocelot.json"] = 412,
    ["omnisharp.json"] = 413,
    ["openapi.json"] = 414,
    ["openfin.json"] = 421,
    ...
    ["ops.yaml"] = 418,
    ["package.json"] = 432,
    ["package.manifest"] = 433,
    ["partial-cibuildwheel"] = 110,
    ["partial-scikit-build"] = 708,
    ["pathfinder.yml"] = 436,
    ["pattern.json"] = 440,
    ["petstore-v1.0"] = 752,
    pgap_yaml_input_reader = 439,
    ["plagiarize-me.yaml"] = 446,
    ["plagiarize.yaml"] = 445,
    ["portman.json"] = 447,
    ["prettierrc.json"] = 454,
    ["prisma.yml"] = 455,
    ["project-1.0.0-beta3.json"] = 458,
    ["project-1.0.0-beta4.json"] = 459,
    ["project-1.0.0-beta5.json"] = 460,
    ["project-1.0.0-beta6.json"] = 461,
    ["project-1.0.0-beta8.json"] = 462,
    ["project-1.0.0-rc1.json"] = 463,
    ["project-1.0.0-rc2.json"] = 464,
    ["project.json"] = 457,
    ["prometheus.json"] = 465,
    ["prometheus.rules.json"] = 466,
    ["prometheus.rules.test.json"] = 467,
    ["proxies.json"] = 468,
    ["publiccode.yml"] = 469,
    ["pubspec.yaml"] = 470,
    ["pyrseas-0.8.json"] = 473,
    ["quilt.mod.json"] = 778,
    ["release drafter"] = 655,
    ["release-plz.toml"] = 485,
    ["rivet.yaml"] = 799,
    rustfmt = 495,
    samt = 497,
    samtrc = 498,
    ["sarif-1.0.0.json"] = 500,
    ["sarif-2.0.0.json"] = 501,
    ["sarif-2.1.0"] = 511,
    ["sarif-2.1.0-rtm.2"] = 502,
    ["sarif-2.1.0-rtm.3"] = 504,
    ["sarif-2.1.0-rtm.4"] = 506,
    ["sarif-2.1.0-rtm.5"] = 508,
    ["sarif-2.1.0-rtm.6"] = 509,
    ["sarif-external-property-file-2.1.0"] = 512,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 503,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 505,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 507,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 510,
    ["schema.org - Action"] = 514,
    ["schema.org - ContactPoint"] = 515,
    ["schema.org - Place"] = 516,
    ["schema.org - Thing"] = 517,
    ["scikit-build"] = 707,
    ["secrethub.yml"] = 780,
    ["semantic-release"] = 520,
    ["servicehub.config.json"] = 629,
    ["servicehub.service.json"] = 628,
    ["settings.job"] = 523,
    ["sfdx-hardis configuration"] = 527,
    ["size-limit configuration"] = 532,
    ["skaffold.yaml"] = 697,
    ["skyuxconfig.json"] = 534,
    snapcraft = 535,
    ["sqlc configuration"] = 543,
    ["stripe-app-local.json"] = 552,
    ["stripe-app.json"] = 551,
    swcrc = 684,
    syntax = 782,
    ["task.json"] = 558,
    taskcat = 651,
    ["template.json"] = 562,
    ["templatsources.json"] = 563,
    ["theme.json"] = 566,
    ["tizen_workspace.json"] = 567,
    tldr = 568,
    tmuxinator = 637,
    ["transcend.yml"] = 575,
    ["trunk.yaml"] = 576,
    ["ts-force-config.json"] = 580,
    ["tsconfig.json"] = 577,
    ["tsd.json"] = 578,
    ["tsdrc.json"] = 579,
    ["tslint.json"] = 581,
    ...
    ["typingsrc.json"] = 589,
    ["typo3.json"] = 587,
    ["ui5-workspace.yaml"] = 594,
    ["ui5.yaml"] = 593,
    unist = 718,
    ["up.json"] = 591,
    v8r = 613,
    ["vcpkg configuration file"] = 154,
    ["vcpkg manifest file"] = 153,
    ["vega-lite.json"] = 598,
    ["vega.json"] = 597,
    ["venvironment-basic.yaml"] = 601,
    ["venvironment.yaml"] = 600,
    ["version.json"] = 602,
    ["vim-addon-info"] = 603,
    ["vs-2017.3.host.json"] = 605,
    ["vs-nesting.json"] = 606,
    ["vsls.json"] = 604,
    ["vss-extension.json"] = 610,
    ["vtesttree.yaml"] = 611,
    ["vtestunit.yaml"] = 612,
    ["warp-keysets.json"] = 786,
    ["warp-themes.json"] = 787,
    ["warp-workflows.json"] = 788,
    ["webhint.io"] = 738,
    ["webjobpublishsettings.json"] = 618,
    ["webjobs-list.json"] = 617,
    ["xs-app.json"] = 647,
    ["xunit.runner.json"] = 627,
    yamllint = 672,
    zuul = 656,
    ["Žinoma"] = 666
  },
