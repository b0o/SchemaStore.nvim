...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1115,
    [".nodehawkrc"] = 719,
    [".npmpackagejsonlintrc"] = 724,
    [".omletrc"] = 1296,
    [".phrase.yml"] = 806,
    [".phraseapp.yml"] = 807,
    [".pmbot.yml"] = 791,
    [".postcssrc"] = 800,
    [".powerpages-web-template-manifest"] = 802,
    [".pre-commit-config.yml"] = 803,
    [".pre-commit-hooks.yml"] = 804,
    [".putout.json"] = 841,
    [".rehyperc"] = 866,
    [".remarkrc"] = 870,
    [".sprite files"] = 972,
    ...
    AIConfig = 50,
    ["AMX Muse Program Descriptor"] = 1345,
    ["API Builder"] = 1151,
    ["AVA Configuration"] = 1215,
    ["AWS AppConfig Feature Flags-v1"] = 90,
    ["AWS CDK cdk.json"] = 324,
    ["AWS CloudFormation"] = 325,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 326,
    ["AWS Copilot Manifest"] = 1384,
    ["AWS SAM CLI Samconfig"] = 327,
    Acton = 1438,
    ["Adobe UXP Manifest"] = 1278,
    ["Aerleon Network & Service Definitions"] = 30,
    ["Aerleon Policy"] = 31,
    ["Agent Permission Policy"] = 1424,
    ["Agent Run Metrics"] = 32,
    ["AgentCore CLI"] = 1425,
    ["AgentCtl MCP"] = 1427,
    ["AgentCtl config"] = 1426,
    ["AgentCtl permissions"] = 1428,
    AgentLoopKit = 1429,
    Aider = 1374,
    Air = 34,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1395,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1394,
    ["Airlock Microgateway"] = 51,
    ["Alacritty Configuration"] = 1187,
    ["AlgoVoi Compliance Receipt v1"] = 19,
    ["All Contributors configuration file"] = 1241,
    ["Amazon S3 bucket CORS"] = 21,
    Ameba = 1,
    Anodizer = 525,
    ["Ansible Argument Specs"] = 507,
    ["Ansible Collection Galaxy"] = 514,
    ["Ansible Execution Environment"] = 504,
    ["Ansible Inventory"] = 513,
    ["Ansible Meta"] = 505,
    ["Ansible Meta Runtime"] = 506,
    ["Ansible Navigator Configuration"] = 516,
    ["Ansible Playbook"] = 511,
    ["Ansible Requirements"] = 508,
    ["Ansible Rulebook"] = 512,
    ["Ansible Tasks File"] = 510,
    ["Ansible Vars File"] = 509,
    ["Ansible-lint Configuration"] = 515,
    Any = 1306,
    ...
    ["Application list for a WinUtil"] = 1324,
    ["ArchSmith diagram IR"] = 1467,
    ArchitectFX = 1329,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1393,
    ["Azure IoT Operations connector metadata"] = 1390,
    ...
    ["Azure Pipelines"] = 139,
    ["Azure Static Web Apps CLI configuration file"] = 976,
    ["Azure Static Web Apps configuration file"] = 975,
    BMML = 1412,
    ["BOSH BPM Config"] = 167,
    ["BOSH CPI Config"] = 168,
    ...
    Badness = 151,
    ["Barba-CV"] = 105,
    ["Bashly (bashly.yml)"] = 1245,
    ["Bashly Settings (bashly-settings.yml)"] = 1246,
    Bento = 1411,
    ["Better Code Hub"] = 1156,
    ["Better Scripts"] = 194,
    Bigconfig = 160,
    ["Biome Formatter Config"] = 106,
    ["Bitmovin Encoding Template"] = 1338,
    BizTalkServerApplicationSchema = 1122,
    Bleep = 195,
    ["Block Protocol Metadata"] = 192,
    ["Bluebricks blueprint config"] = 1417,
    ["Boyka Framework"] = 173,
    ["Bpod Finite-State Machine"] = 108,
    Briefcase = 1128,
    ["Build Info"] = 183,
    Buildkite = 185,
    ["Bukkit plugin.yml"] = 184,
    ["BungeeCord plugin.yml"] = 190,
    ["Burnless SRE config"] = 6,
    ["Butane Config"] = 1200,
    C4InterFlow = 1353,
    ["CDK Environment Manager, concrete environment configuration"] = 1377,
    ["CDK Environment Manager, concrete environments definition"] = 1376,
    ["CDK Environment Manager, environment definition"] = 1375,
    ["CGS Card Game Specification (cgs.json)"] = 1283,
    ["CICS TS region tagging"] = 1209,
    ["CICS TS resource import"] = 1210,
    ["CICS TS resource model"] = 1211,
    ["CICS TS resource overrides"] = 1212,
    ["CMake Presets"] = 196,
    ["CNC Codes"] = 223,
    ["CRS WAF test file"] = 1313,
    ["CRS WAF test platform overrides file"] = 1314,
    ["CSS Comb (.csscomb.json)"] = 354,
    ["CSS Lint (.csslintrc)"] = 355,
    ["CSpell (cspell.json)"] = 353,
    ["CVE Record Format"] = 235,
    ["CVX achievements.yaml"] = 241,
    ["CVX competencies.yaml"] = 240,
    ["CVX config.yaml"] = 244,
    ["CVX education.yaml"] = 239,
    ["CVX experience.yaml"] = 238,
    ["CVX keywords.yaml"] = 243,
    ["CVX layout"] = 245,
    ["CVX personal.yaml"] = 236,
    ["CVX referees.yaml"] = 242,
    ["CVX summary.yaml"] = 237,
    CWL = 1289,
    ["Cache Warmup config"] = 197,
    ["Caido Proxy Configuration"] = 1453,
    ["Calqulus pipeline"] = 198,
    ["Camel YAML DSL"] = 199,
    ["Cannon TOML"] = 200,
    ["CanvasXpress cxplot"] = 201,
    ["CanvasXpress figure"] = 202,
    Carafe = 203,
    ["Cargo Config"] = 204,
    ["Cargo Make"] = 206,
    ["Cargo Manifest"] = 205,
    ["Catalog Info Backstage"] = 207,
    ["Chamaleon environment"] = 1342,
    ["Chamaleon properties"] = 1343,
    ["Chamaleon template"] = 1341,
    Changepacks = 1404,
    Changesets = 336,
    Changie = 208,
    Charmcraft = 209,
    Cheatsheets = 1197,
    ["ChordPro Configuration"] = 211,
    ["Chrome Extension"] = 317,
    ["Chromia Model"] = 212,
    ["Chromia Seeder Module Config"] = 214,
    ["Chromia Seeder Root Config"] = 213,
    ["Cinnamon Spice info.json"] = 116,
    ["CircleCI config.yml"] = 289,
    ["Citation File Format"] = 338,
    ["Citrus test case"] = 216,
    CityJSON = 217,
    ["Claude Code Keybindings"] = 230,
    ["Claude Code Launch Preview"] = 1466,
    ["Claude Code Plugin Manifest"] = 231,
    ["Claude Code Plugin Marketplace"] = 232,
    ["Claude Code Settings"] = 233,
    ["Clawject config"] = 229,
    ["Cloud Foundry Application Manifest"] = 1295,
    ["Cloud Run Spec v1"] = 1319,
    ...
    ["CloudEvents specification"] = 218,
    ["Code Climate"] = 290,
    CodeCV = 120,
    CodeRabbit = 119,
    ["Codecov configuration files"] = 307,
    Codex = 298,
    ["Codex Hooks"] = 299,
    ["Codex Plugin Manifest"] = 300,
    ["Codex Skill Metadata"] = 301,
    CodifyCLI = 121,
    Codux = 303,
    ["Cog config file"] = 224,
    ["Commandbox Box.json"] = 225,
    ["Commandbox Server.json"] = 226,
    ["Common Catalog Data"] = 315,
    ["Common Package Specification"] = 227,
    Concord = 1312,
    ["Configu .cfgu files"] = 1300,
    ["Configu .configu file"] = 1301,
    Conjure = 222,
    ["Container Structure Test"] = 1136,
    Containerlab = 1165,
    ["Context Passport"] = 2,
    ["Context Reasoning Format (CRF)"] = 220,
    ["Contextive Glossary"] = 1369,
    ContractGuard = 1166,
    Convex = 221,
    ["Crowdsec collection config"] = 347,
    ["Crowdsec parser config"] = 348,
    ["Crowdsec scenario config"] = 349,
    ["CumulusCI Config"] = 228,
    ["Cursor Agent Environment"] = 1422,
    ["Custom Machinery Machine"] = 1284,
    ["Custom Machinery Recipe"] = 1285,
    ["Cycle Stack File"] = 246,
    CycloneDX = 247,
    ["DWP Exchange - catalogue entry"] = 404,
    ["DWP Exchange - gateway"] = 402,
    ["DWP Exchange - meta"] = 403,
    ["Dagger module"] = 356,
    ["Dark Factory consumer config"] = 248,
    ["Dart Build Config (dart-build.json)"] = 357,
    ["Dart Test Config (dart-test.json)"] = 358,
    ["DashLord Configuration"] = 359,
    ["Data Contract Specification"] = 360,
    ["Data Product Specification"] = 361,
    ["DataYoga Connections"] = 249,
    ["DataYoga Job"] = 250,
    ["Datadog Continuous Testing"] = 615,
    ["Datadog Service Definition"] = 616,
    ["Datadog Software Catalog"] = 617,
    ["Datahub Ingestion Recipe"] = 1216,
    ["Debian Upstream Metadata file"] = 257,
    DebtLens = 258,
    ["Decision Reasoning Format (DRF)"] = 259,
    ["Deck config"] = 260,
    ["Declarative Automation Bundles"] = 1262,
    ["DeepMatch deeplinks spec"] = 261,
    ["Defakto CI"] = 1474,
    ["Dein Config"] = 262,
    ["Deno Config (deno.json)"] = 370,
    ["Dependency cruiser"] = 263,
    ["DeployStack Configuration"] = 264,
    ["Deployah Configuration"] = 1392,
    ["Deployer Recipe"] = 373,
    ["Design Tokens Community Group format"] = 265,
    ["Design Tokens Community Group resolver"] = 266,
    ["Deta Spacefile"] = 267,
    ["Detekt Config (detekt.yml)"] = 374,
    ["Devbox Config"] = 268,
    ["Devbox Plugin"] = 269,
    Devfile = 401,
    Devup = 1405,
    DipDup = 1315,
    ["Discord Webhook"] = 375,
    ["DocFx Config (docfx.json)"] = 380,
    ["Docker Desktop extension metadata"] = 377,
    ["Docs MCP Manifest"] = 381,
    Dofigen = 382,
    ["Dolittle Artifacts"] = 383,
    ["Dolittle Bounded Context Configuration"] = 384,
    ["Dolittle Event Horizons Configuration"] = 385,
    ["Dolittle Resources Configuration"] = 386,
    ["Dolittle Server Configuration"] = 387,
    ["Dolittle Tenant Map Configuration"] = 389,
    ["Dolittle Tenants Configuration"] = 388,
    ["Dolittle Topology"] = 390,
    ["DonateCaseBetterCasino menu"] = 1346,
    ["Draugr Saga"] = 368,
    ["Draugr Saga fragment"] = 369,
    ["Drupal Breakpoints"] = 271,
    ["Drupal Config"] = 283,
    ["Drupal Info"] = 272,
    ["Drupal Layouts"] = 273,
    ["Drupal Libraries"] = 274,
    ["Drupal Links Action"] = 275,
    ["Drupal Links Contextual"] = 276,
    ["Drupal Links Menu"] = 277,
    ["Drupal Links Task"] = 278,
    ["Drupal Migration"] = 279,
    ["Drupal Permissions"] = 280,
    ["Drupal Recipe"] = 281,
    ["Drupal Routing"] = 282,
    ["Drupal Services"] = 284,
    ["Drush site aliases"] = 396,
    ["Dust configuration"] = 399,
    ["Dynamic Bash Aliases (.aliases)"] = 1253,
    ["EAS config"] = 443,
    ["ECA - Editor Code Assistant"] = 406,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1242,
    ["ESLint Suppressions"] = 448,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1389,
    ["EasyVCR .NET"] = 445,
    ["Eidolon Resource"] = 1330,
    ["Elgato Stream Deck"] = 409,
    Elm = 1317,
    ["Embrace Config"] = 1228,
    Emmet = 1318,
    Endurica = 1266,
    ["Enonic XP API descriptor"] = 412,
    ["Enonic XP Admin Extension descriptor"] = 413,
    ["Enonic XP Admin Tool descriptor"] = 414,
    ["Enonic XP Application descriptor"] = 415,
    ["Enonic XP CMS descriptor"] = 416,
    ["Enonic XP Content Type descriptor"] = 417,
    ["Enonic XP Form Fragment descriptor"] = 418,
    ["Enonic XP ID Provider descriptor"] = 419,
    ["Enonic XP Layout descriptor"] = 420,
    ["Enonic XP Macro descriptor"] = 421,
    ["Enonic XP Mixin descriptor"] = 422,
    ["Enonic XP Page descriptor"] = 423,
    ["Enonic XP Part descriptor"] = 424,
    ["Enonic XP Service descriptor"] = 425,
    ["Enonic XP Site descriptor"] = 426,
    ["Enonic XP Style descriptor"] = 427,
    ["Enonic XP Task descriptor"] = 428,
    ["Enonic XP Webapp descriptor"] = 429,
    ["Enterprise Contract Policy Spec"] = 410,
    ["Envelope Team Definition"] = 1437,
    ["Envilder Map File"] = 411,
    ["Erda Pipeline"] = 1291,
    ["Erda Runtime"] = 1292,
    ["Espanso config.yml"] = 1415,
    ["Espanso match.yml"] = 1414,
    Esquio = 431,
    ["Estuary Flow Catalog"] = 1206,
    ["Ethereum ERC1155"] = 1431,
    ["Ethereum ERC721"] = 1430,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 436,
    ["EveryVoice TTS Toolkit Data Configuration"] = 437,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 441,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 440,
    ["EveryVoice TTS Toolkit Text Configuration"] = 438,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 439,
    ["Evolving Resolutive Process notation"] = 1391,
    ["Expo SDK"] = 442,
    ["Expoot app config"] = 444,
    ["F-Droid Data metadata"] = 450,
    ["FasterCI Configuration"] = 140,
    Fatou = 141,
    ["Fence configuration"] = 142,
    FiQuS = 454,
    Firebase = 452,
    ["Flatpak Builder Manifest"] = 455,
    ["FlexGet Config"] = 456,
    ["Flow.json Configurations"] = 1288,
    ["Fossa configuration file"] = 463,
    ["Fossa's fossa-deps file"] = 464,
    ["Foundry VTT - Base package Manifest"] = 458,
    ["Foundry VTT - Module Manifest"] = 459,
    ["Foundry VTT - System Data Template"] = 462,
    ["Foundry VTT - System Manifest"] = 460,
    ["Foundry VTT - World Manifest"] = 461,
    ["Foxx Manifest"] = 143,
    ["Freifunk.de Community API"] = 146,
    ["Frogbot Config"] = 147,
    ["G2P Mapping Configuration"] = 472,
    GAMA = 473,
    ["GCP Blueprint Metadata"] = 476,
    Gaspar = 474,
    ["GatewayCore API Gateway"] = 475,
    ["Gemini CLI settings"] = 477,
    ["GeoJSON.json latest"] = 1204,
    GherKing = 1208,
    ["GitHub Action"] = 487,
    ["GitHub Actions typing"] = 1326,
    ["GitHub CLI configuration"] = 488,
    ["GitHub CLI hosts"] = 489,
    ["GitHub Discussion"] = 490,
    ["GitHub Funding"] = 492,
    ["GitHub Issue Template configuration"] = 493,
    ["GitHub Issue Template forms"] = 494,
    ["GitHub Pages Jekyll"] = 495,
    ["GitHub Prompt"] = 491,
    ["GitHub Secret Scanning"] = 496,
    ["GitHub Workflow"] = 497,
    ["GitHub Workflow Template Properties"] = 498,
    ["GitHub automatically generated release notes configuration"] = 499,
    ["GitLab Agent for Kubernetes configuration"] = 1280,
    ["GitLab Duo Workflow"] = 501,
    GitResume = 503,
    GitVersion = 480,
    ["Gitea Issue Template configuration"] = 483,
    ["Gitea Issue Template forms"] = 484,
    Gitleaks = 481,
    ["Gitpod Configuration"] = 502,
    ["Glamour style"] = 478,
    ["GlazeWM settings"] = 1282,
    ["Global Privacy Control"] = 479,
    Goblet = 1261,
    ["Golangci-lint Configuration"] = 518,
    ["Golangci-lint Custom Plugins Configuration"] = 519,
    ["Google Chrome Related Website Sets"] = 453,
    ["Google Cloud Workflows"] = 323,
    ["Google Digital Assetlinks"] = 1370,
    Goreleaser = 523,
    ["Goreleaser Pro"] = 524,
    Goss = 526,
    ["Gradle Build Cache Node"] = 1154,
    ["Gradle Enterprise"] = 1153,
    ["Grafana 5.x Dashboard"] = 527,
    ["GraphQL Code Generator"] = 532,
    ["GraphQL Config"] = 531,
    ["GraphQL Mesh"] = 530,
    ["GroovyLint configuration"] = 533,
    ["Grunt JSHint task"] = 537,
    ["Grunt Watch task"] = 538,
    ["Grunt base task"] = 539,
    ["Grunt clean task"] = 535,
    ["Grunt copy task"] = 534,
    ["Grunt cssmin task"] = 536,
    HEMTT = 1118,
    ["HULL - Helm Uniform Layer Library"] = 1471,
    Hadolint = 1132,
    Hammerkit = 1164,
    ["Hardware Sentry Configuration"] = 1220,
    ["Hashgraph Online Skill Manifest"] = 9,
    ["HashiCorp Vault"] = 540,
    Hatch = 1133,
    Hayson = 543,
    ["Haystack Pipeline"] = 544,
    ["Hazelcast 5 Configuration"] = 545,
    ["Hecate Input Schema"] = 1381,
    ["Helm Chart.lock"] = 286,
    ["Helm Chart.yaml"] = 285,
    ["Helm Unittest Test Suite"] = 287,
    ["Heloisa Assistant Plugins Marketplace"] = 1464,
    ["Hex file"] = 288,
    ["Home Assistant Integration Manifest"] = 547,
    ["Homer dashboard configuration"] = 548,
    ["Hoverfly Simulation"] = 553,
    Hugo = 1196,
    ["Hugo Theme"] = 1195,
    ["Hulak Configuration"] = 556,
    ["Hyperfoil benchmark configuration"] = 555,
    ["IBM Zapp document"] = 557,
    ["IBM zCodeFormatSettings"] = 558,
    ["IMG Catapult PSP"] = 563,
    ["IVMS101 by CODE Protocol"] = 1281,
    ["Infinispan Configuration"] = 565,
    ["Infinispan Server Configuration"] = 566,
    Infrahub = 567,
    Istanbul = 1224,
    ["JDownloader2 crawler multi-rules"] = 581,
    ["JDownloader2 crawler single-rules"] = 580,
    ["JFrog Applications Config"] = 582,
    ["JFrog File Spec"] = 583,
    ["JFrog Pipelines YML DSL"] = 1230,
    ["JMeter DSL cli config"] = 584,
    JReleaser = 587,
    ["JSON Document Transform"] = 595,
    ["JSON Feed"] = 596,
    ["JSON Resume"] = 879,
    ["JSON Schema Draft 2020-12"] = 1097,
    ["JSON Schema Draft 4"] = 1094,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1263,
    ["JSON Schema Draft 7"] = 1095,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1264,
    ["JSON Schema Draft 8 (2019-09)"] = 1096,
    ["JSON-API"] = 594,
    ["JSON-e templates"] = 1161,
    ["JSON-stat 2.0"] = 1090,
    JSONPatch = 598,
    ["JSR Package Config (jsr.json)"] = 588,
    Jarl = 1397,
    Jasmine = 575,
    Jekyll = 576,
    ["Jenkins X Pipelines"] = 577,
    ["Jenkins X Requirements"] = 578,
    Jest = 579,
    Jocker = 585,
    ["Jovo Language Models"] = 586,
    Jsontron = 599,
    ["Jujutsu (jj) VCS config"] = 1383,
    ["KIMMDY config file"] = 610,
    ["KODE/CI build.yaml"] = 1226,
    ["KSP-AVC"] = 1091,
    ["KSP-CKAN"] = 1092,
    ["KSP-NetKAN"] = 1093,
    KSY = 1293,
    KSail = 470,
    ["KYA Manifest"] = 1294,
    ["Karakum configuration file"] = 465,
    Kas = 602,
    ["Kestra flow file"] = 611,
    ["Keycloak REST API"] = 1233,
    ["Knative Functions - func.yaml"] = 467,
    Knip = 468,
    ["Knip JSONC"] = 469,
    ["Knowledge Unit"] = 619,
    ["Kometa (nightly) config file"] = 613,
    ["Kometa config file"] = 612,
    ["Kong DBLess config"] = 1227,
    KrakenD = 614,
    ["Kubri Configuration"] = 622,
    LOOBin = 643,
    ["Lake configuration file"] = 1386,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 328,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 329,
    ["Landing Zone Accelerator on AWS - Global Config"] = 330,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 331,
    ["Landing Zone Accelerator on AWS - Network Config"] = 332,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 333,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 334,
    ["Landing Zone Accelerator on AWS - Security Config"] = 335,
    ["Lando (landofile)"] = 132,
    ["LangGraph Platform configuration"] = 1305,
    ["Language configuration"] = 1304,
    Lefthook = 629,
    ["Liferay client-extension.yaml"] = 636,
    ["LinkML Metamodel"] = 638,
    ["LiquiLens Evidence Carrier Reference v1"] = 640,
    ["LiquiLens Evidence Carrier v1"] = 639,
    Liquibase = 1171,
    ["Liquibase Flow File"] = 1172,
    ["Lively Properties"] = 642,
    ["Lobe AI Agent"] = 134,
    Loki = 135,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 688,
    ["MS2Rescore Configuration"] = 696,
    ["MSTest testconfig.json"] = 697,
    ["Madge configuration"] = 649,
    ["Madness (madness.yml)"] = 1244,
    ["Mado configuration"] = 650,
    ["Maestro Flow"] = 651,
    ["Mail Servers Configuration"] = 1418,
    ["MapEHR Mapping"] = 652,
    Markdownlint = 1175,
    ["Mason Registry"] = 1178,
    ["MegaLinter Custom Flavor"] = 657,
    ["MegaLinter configuration"] = 656,
    ["MegaLinter descriptor"] = 658,
    Melange = 1271,
    ["Meltano project definition"] = 659,
    ["Mergify Configuration"] = 698,
    ["Mermaid config"] = 4,
    ["Metadata for a Bazel module"] = 660,
    ["Metadata for a Cinnamon spice"] = 1322,
    ["Metatype Configuration"] = 661,
    ["MetricsHub Configuration"] = 662,
    ["MetricsHub Connector Configuration"] = 663,
    ["Micro Editor Syntax"] = 1254,
    ["Microsoft Band Web Tile"] = 664,
    ["Microsoft RulesEngine workflow rules"] = 1309,
    ["Microsoft RulesEngine workflow rules list"] = 1310,
    ["Minecraft Custom Main Menu Mod"] = 1272,
    ["Minecraft Data Pack Advancement"] = 666,
    ["Minecraft Data Pack Biome"] = 667,
    ["Minecraft Data Pack Configured Carver"] = 668,
    ["Minecraft Data Pack Damage Type"] = 669,
    ["Minecraft Data Pack Dimension"] = 671,
    ["Minecraft Data Pack Dimension Type"] = 670,
    ["Minecraft Data Pack Item Modifier"] = 672,
    ["Minecraft Data Pack Loot Table"] = 673,
    ["Minecraft Data Pack Metadata"] = 674,
    ["Minecraft Data Pack Predicate"] = 675,
    ["Minecraft Data Pack Recipe"] = 676,
    ["Minecraft Data Pack Tag"] = 677,
    ["Minecraft Data Pack Template Pool"] = 678,
    ["Minecraft Data Pack Trim Material"] = 683,
    ["Minecraft Data Pack Trim Pattern"] = 684,
    ["Minecraft Resource Pack Lang"] = 679,
    ["Minecraft Resource Pack Particle"] = 680,
    ["Minecraft Resource Pack Texture Mcmeta"] = 682,
    ["Minecraft Resourcepack Sounds"] = 681,
    ["MockServer Expectation"] = 690,
    ["MockServer Expectations"] = 691,
    ModuleAssembler = 686,
    ["Monade CLI Stack Configuration"] = 701,
    ["MongoDB Atlas Search Index Definition"] = 1225,
    ["Monika Configuration"] = 1223,
    ["Monoweave Configuration"] = 695,
    ["Motif config"] = 1114,
    MultiQC = 1363,
    ["NOX Framework (Service)"] = 723,
    ["Netin Diagnostic System Template"] = 1182,
    ["Netlify config"] = 704,
    ["Network-as-Code Data Model"] = 705,
    ["Next Gen UI Agent A2A Server Configuration"] = 706,
    ["Next Gen UI Agent Configuration"] = 708,
    ["Next Gen UI Agent MCP Server Configuration"] = 707,
    ["Nightwatch.js"] = 715,
    ["Nika workflow"] = 720,
    ["Node.js configuration"] = 1119,
    ["NueJS configuration file"] = 728,
    ["Nuitka Package Config"] = 1286,
    ["Nullstone config"] = 730,
    ["ODGS Data Rules"] = 737,
    ["ODGS Ontology Graph"] = 738,
    ["ODGS Standard Metrics"] = 736,
    ["OKF Graph"] = 1465,
    ["ONe's changelog entry"] = 752,
    ["ONe's service descriptor"] = 751,
    ["ORT Server repository environment configuration"] = 763,
    ["OSCAL Assessment Plan (AP)"] = 765,
    ["OSCAL Assessment Results (AR)"] = 766,
    ["OSCAL Catalog"] = 767,
    ["OSCAL Component Definition (CDef)"] = 768,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 769,
    ["OSCAL Profile"] = 770,
    ["OSCAL System Security Plan (SSP)"] = 771,
    ["OSS Review Toolkit configuration"] = 772,
    ["OSS Review Toolkit curation"] = 773,
    ["OSS Review Toolkit package configuration"] = 774,
    ["OSS Review Toolkit project package manager definition"] = 775,
    ["OSS Review Toolkit repository configuration"] = 776,
    ["OSS Review Toolkit resolutions"] = 777,
    ["October CMS columns"] = 734,
    ["October CMS fields"] = 735,
    ["Oh My Posh"] = 740,
    Okteto = 741,
    ["Ona Tasks and Services"] = 743,
    Opctl = 1117,
    ["Open Data Contract Standard (ODCS)"] = 756,
    ["Open Data Product Standard (ODPS)"] = 757,
    ["Open Know-How"] = 1368,
    ["Open Pentest Format"] = 758,
    OpenDecree = 1435,
    ["OpenDecree Configuration"] = 1436,
    ["OpenRewrite Resource"] = 754,
    OpenSRM = 759,
    OpenStatus = 1379,
    ["OpenTelemetry Declarative Configuration"] = 755,
    ["OpenUtau character yaml"] = 748,
    ["OpenUtau ustx"] = 749,
    ["OpenWeather Current Weather API"] = 1160,
    ["OpenWeather Road Risk API"] = 1159,
    ["Ory Hydra configuration"] = 554,
    ["Ory Keto configuration"] = 618,
    ["Ory Kratos configuration"] = 764,
    ["Ory Oathkeeper configuration"] = 732,
    ["Outblocks App configuration"] = 761,
    ["Outblocks database table"] = 762,
    ["Outblocks project configuration"] = 760,
    PDM = 785,
    POPxf = 797,
    ["POPxf Correlations"] = 798,
    ["PRML manifest"] = 805,
    Packer = 781,
    PactSpec = 782,
    Panache = 783,
    Pantsbuild = 1240,
    ["Paper paper-plugin.yml"] = 784,
    ["Pipeline component"] = 1173,
    ["Platform.sh application"] = 15,
    ["Platform.sh routes"] = 16,
    ["Platform.sh services"] = 17,
    ["Plex Prerolls"] = 795,
    ["PocketMine plugin.yml"] = 792,
    ["Podman Desktop Extension"] = 1455,
    ["Postman collection"] = 801,
    ["Power Pages Configuration"] = 1380,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1325,
    ["ProActions AI-Kit Configuration"] = 813,
    ["ProActions AI-Kit Configuration for Menus"] = 815,
    ["ProActions AI-Kit Configuration for Sections"] = 817,
    ["ProActions AI-Kit Configuration for Services"] = 814,
    ["ProActions AI-Kit Configuration for Steps"] = 818,
    ["ProActions AI-Kit Configuration for Templates"] = 816,
    ["Problem object RFC9457"] = 1269,
    ["Problem package format"] = 819,
    ["Problem package generators"] = 820,
    ["Problem package submissions"] = 821,
    ["Problem package test group metadata"] = 822,
    ["Production delivery manifest"] = 1473,
    Promtail = 836,
    Pterodactyl = 1219,
    ["Pull Request Labeler"] = 840,
    Pulumi = 848,
    ["PyGTA Config"] = 844,
    PyProject = 849,
    Pylock = 1371,
    Pyright = 850,
    ["Python script metadata"] = 1365,
    ["QType AI DSL"] = 853,
    Qgoda = 852,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1447,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1445,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1451,
    ["Qlik Talend Cloud Pipeline - Project"] = 1443,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1446,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1448,
    ["Qlik Talend Cloud Pipeline - Task"] = 1444,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1450,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1449,
    Qodana = 1192,
    ["Qt Creator workspace file"] = 1302,
    ["Quali Torque Blueprint Spec 2"] = 1217,
    ["QueryFirst config file"] = 1236,
    ["QuikRun Configuration"] = 1452,
    ["Qwen Code Settings"] = 1432,
    ["RKE Cluster Configuration JSON"] = 1170,
    ["RKE Cluster Configuration YAML"] = 1169,
    RadioHound = 843,
    ["Raid Profile"] = 1433,
    ["Raid Repo Configuration"] = 1434,
    Railpack = 855,
    Railway = 854,
    ["Rancher Fleet"] = 845,
    ["Rattler-build"] = 856,
    Ray = 1131,
    ["Read the Docs"] = 847,
    ["Red-DiscordBot Cog"] = 863,
    ["Red-DiscordBot Cog Repo"] = 864,
    ["Red-DiscordBot Trivia"] = 865,
    ["Releasaurus Config"] = 12,
    ReleaseKit = 11,
    ["Render Blueprints"] = 1168,
    RenderCV = 883,
    Renovate = 880,
    ["Renovate global configuration"] = 881,
    ["Renovate inherited configuration"] = 882,
    ["Replit config"] = 871,
    Restate = 1358,
    ["Revel Digital Gadget Definition File"] = 1382,
    RoadRunner = 885,
    ["Robust Station Image"] = 1388,
    Rockcraft = 886,
    ["Roo Coder Custom Modes"] = 887,
    Rubocop = 876,
    ["Rudder techniques"] = 1276,
    Ruff = 877,
    ["Rust Project"] = 878,
    ["Rust toolchain"] = 892,
    ["SDMX data message"] = 919,
    ["SDMX metadata message"] = 918,
    ["SDMX structure message"] = 917,
    ["SIL Kit Participant Configuration"] = 930,
    ["SIL Kit Registry Configuration"] = 931,
    ["SPDX 2.3"] = 973,
    SWADL = 989,
    ["Safebox Config"] = 1231,
    ["Sapphire CLI Config"] = 895,
    ["SauceCTL Configuration"] = 1179,
    Scarb = 915,
    ["Schema Catalog"] = 910,
    ["Scoop manifest"] = 916,
    ["Secure SDLC Evidence Bundle"] = 920,
    ["Semantic Data Fabric (SDF) file"] = 921,
    ["Semgrep Rule"] = 923,
    ["Serenity Code Generator (Sergen)"] = 924,
    ["Serverless Framework Configuration"] = 1186,
    ["Serverless Workflow"] = 1188,
    ["Settings for a Cinnamon spice"] = 1321,
    ["Settings.paf"] = 926,
    ["Shopware 6 Configuration"] = 1189,
    ["Shopware CLI Extension Store Configuration"] = 1190,
    ["Shopware CLI Project Store Configuration"] = 1191,
    ["Sigma Detection Rule"] = 928,
    ["SigmaCV CV"] = 7,
    ["Sigrid scope configuration file"] = 929,
    ["SkyPilot Task JSON"] = 1277,
    ["Slack app manifest"] = 936,
    ["Slang Server Configuration"] = 1459,
    Snapcraft = 938,
    ["Solarxy project config"] = 941,
    Solidarity = 942,
    ["Solution filters"] = 943,
    ["Source Maps v3"] = 944,
    Sourcery = 945,
    ["Spack bootstrap.yaml"] = 946,
    ["Spack cdash.yaml"] = 947,
    ["Spack ci.yaml"] = 948,
    ["Spack compilers.yaml"] = 949,
    ["Spack concretizer.yaml"] = 950,
    ["Spack config.yaml"] = 951,
    ["Spack definitions.yaml"] = 952,
    ["Spack develop.yaml"] = 953,
    ["Spack env_vars.yaml"] = 954,
    ["Spack environment"] = 960,
    ["Spack include.yaml"] = 955,
    ["Spack mirrors.yaml"] = 956,
    ["Spack modules.yaml"] = 957,
    ["Spack packages.yaml"] = 958,
    ["Spack repos.yaml"] = 959,
    ["Spack toolchains.yaml"] = 961,
    ["Spack upstreams.yaml"] = 962,
    ["Spack view.yaml"] = 963,
    ["Speakeasy Generation Config File"] = 967,
    ["Speakeasy Lint Configuration File"] = 964,
    ["Speakeasy Test Generation Configuration File"] = 965,
    ["Speakeasy Workflow File"] = 966,
    SpecIF = 968,
    ["Specmatic Configuration"] = 969,
    ["Specpin spec file"] = 5,
    ["Sponge Mixin configuration"] = 970,
    ["Spotlight Ruleset"] = 971,
    StackBlitz = 977,
    ["StackHawk Scanner Configuration"] = 1185,
    Stale = 978,
    Starfish = 979,
    ["Starlake Data Pipeline"] = 1157,
    Starship = 980,
    ["Statamic Blueprint"] = 981,
    ["Stella configuration file"] = 982,
    ["Streamlit configuration file"] = 983,
    ["Stryker Mutator"] = 986,
    ["StyleCop Analyzers Configuration"] = 987,
    ["Stylelint (.stylelintrc)"] = 988,
    ["Stylua Config"] = 1372,
    ["Sublime Syntax"] = 1232,
    ["Subsquid squid manifest"] = 1279,
    ["Swagger API 2.0"] = 990,
    ["Symfony Routing Configuration"] = 991,
    ["Symfony Serializer Mapping"] = 992,
    ["Symfony Services Configuration"] = 993,
    ["Symfony Validation Mapping"] = 994,
    ["Synadia Connect Component"] = 995,
    TSON = 1038,
    TSTyche = 1039,
    ["TYPO3 Vendor Bundler config"] = 1045,
    ["Tab data for a LinUtil"] = 1328,
    ["Tab list for a LinUtil"] = 1327,
    Tach = 996,
    ["Tach Domain"] = 997,
    Talhelper = 999,
    ["Talisman configuration"] = 1000,
    Taplo = 1373,
    ["Taskfile config"] = 1162,
    Taurus = 1001,
    Tauticord = 1002,
    ["Tekton Pipeline"] = 1401,
    ["Tekton PipelineRun"] = 1402,
    ["Tekton Task"] = 1399,
    ["Tekton TaskRun"] = 1400,
    Telefonistka = 1359,
    ["Terraform PowerShell provider block manifest"] = 1005,
    ["Terraform PowerShell provider data source manifest"] = 1006,
    ["Terraform PowerShell provider resource manifest"] = 1007,
    ["Terraform PowerShell provider settings"] = 1008,
    ["Terrateam config"] = 1385,
    ["Tesseract configuration"] = 1009,
    ["TestEnvironment.json"] = 1019,
    ["TextMate Grammar"] = 1018,
    Threagile = 1013,
    ["Tier.run pricing.json"] = 1010,
    Tikibase = 1011,
    Tombi = 1016,
    ["Traefik v2"] = 1022,
    ["Traefik v2 File Provider"] = 1023,
    ["Traefik v3"] = 1024,
    ["Traefik v3 File Provider"] = 1025,
    ["Travis CI (.travis.yml)"] = 1021,
    Treefmt = 529,
    Trident = 1355,
    Trivy = 1028,
    ["TrueScript for *.tscript files"] = 1029,
    ["Tugboat QA config.yml"] = 1352,
    TunnelHub = 1267,
    Turborepo = 1020,
    Tycho = 1316,
    Tye = 1193,
    ["Tyk Gateway - Open Source v5.7+"] = 1364,
    ["UET BuildConfig.json"] = 1237,
    ["UI5 Manifest"] = 1051,
    ["UNCORS configuration"] = 1056,
    ["UTAM Page Object"] = 1054,
    ["Ubuntu Server Autoinstall"] = 1049,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1356,
    ["Uniswap Token List"] = 1142,
    ["Universal Schedule Format"] = 1057,
    ["Unreal Engine Uplugin"] = 1238,
    ["Unreal Engine Uproject"] = 1239,
    ["UpCloud CLI (upctl) configuration"] = 1357,
    ["Updatecli Compose"] = 1201,
    ["Updatecli Policy Manifest"] = 1202,
    ["Updatecli Policy Metadata"] = 1203,
    Uplift = 1235,
    ["Upsun config"] = 14,
    ["User Journey Map"] = 1167,
    V2Ray = 1207,
    ["VSCode Code Snippets"] = 311,
    ["VSIX CLI publishing"] = 1077,
    Vector = 1059,
    ["Vee JSON menu output"] = 1060,
    ["Vela Pipeline Configuration"] = 1063,
    Vercel = 310,
    ["Version Bumper config"] = 1066,
    Vespertide = 1406,
    ["Vespertide Migration"] = 1407,
    ["Vespertide Model"] = 1408,
    ["Viash Component Config"] = 1361,
    ["Viash Package Config"] = 1362,
    Visivo = 1265,
    Vogi = 1071,
    ["WP-CLI"] = 1087,
    Wake = 1354,
    ["Waku Config"] = 1331,
    ["Web App Manifest"] = 1083,
    ["Web types"] = 1086,
    WebExtensions = 1082,
    ["Webman package recipe"] = 1213,
    ["Windows Package Manager Installer Manifest"] = 1139,
    ["Windows Package Manager Locale Manifest"] = 1140,
    ["Windows Package Manager Singleton Manifest"] = 1138,
    ["WireMock CLI import configuration"] = 1337,
    ["WireMock CLI local service configuration"] = 1336,
    ["WireMock message stub mapping"] = 1335,
    ["WireMock stub mapping"] = 1334,
    ["Woodpecker pipeline config"] = 1181,
    ["Wrangler CLI"] = 1088,
    ["XenForo add-on manifest"] = 1089,
    ["Xstate Machine"] = 1199,
    ["Yandex Workflow Language"] = 1323,
    ["Yarn Config (.yarnrc.yml)"] = 1155,
    ["Yippee-Ki-JSON configuration YML"] = 1146,
    ["YouTrack App"] = 1320,
    ["Zarf Package Configuration"] = 1387,
    ["Zerops import file"] = 1308,
    ["Zola Configuration"] = 1398,
    abtop = 36,
    act3 = 1439,
    actionlint = 46,
    ["aerleon.yml"] = 29,
    ...
    ["behat.yml"] = 174,
    ["bigquery-table"] = 159,
    ["bioimageio resource description"] = 1287,
    ...
    ["bozr.suite.json"] = 178,
    bpkg = 1248,
    ["browser.i18n.json"] = 179,
    ["browsh configuration"] = 180,
    bucklescript = 181,
    ["buf.gen.yaml"] = 110,
    ["buf.lock"] = 111,
    ["buf.plugin.yaml"] = 112,
    ...
    ["build-changelog"] = 182,
    ["bun.lock"] = 187,
    ["bundleconfig.json"] = 188,
    ["bunfig.toml"] = 189,
    ["cargo-mutants-config.yaml"] = 115,
    ["cargo-nextest repository configuration"] = 709,
    ["cargo-nextest user configuration"] = 710,
    ["ccmod.json"] = 1332,
    ["cfgd Config"] = 1460,
    ["cfgd ConfigSource"] = 1463,
    ["cfgd Module"] = 1461,
    ["cfgd Profile"] = 1462,
    changelogging = 1299,
    ["chezmoi configuration"] = 210,
    ["chisel-slices.json"] = 337,
    ["chrome-extension-locales-messages.json"] = 318,
    ["chutzpah.json"] = 319,
    cibuildwheel = 215,
    ["clang-format (.clang-format)"] = 1205,
    ["clang-tidy"] = 294,
    clangd = 293,
    clib = 295,
    ["cloud-init: cloud-config userdata"] = 297,
    ["cloud-sdk-pipeline-configuration"] = 321,
    ["cloudbuild.json"] = 322,
    cloudify = 296,
    cmakefmt = 234,
    ["cmdx.yaml"] = 118,
    ...
    ["commands.json"] = 314,
    ["commit-check"] = 340,
    ["commitlint (.commitlintrc)"] = 1141,
    ["committed.toml"] = 341,
    ["compile_commands.json"] = 313,
    ["compilerconfig.json"] = 312,
    ["completely.yml"] = 1243,
    ["component-detection-manifest.json"] = 344,
    ["component.json"] = 343,
    ["composer.json"] = 342,
    ["conda-forge"] = 219,
    ["config.yaml"] = 846,
    ["contentmanifest.json"] = 320,
    ["contribute.json"] = 345,
    ["cosmos.config.json"] = 316,
    ["crowdin.yml"] = 346,
    crucible = 350,
    ["ctfd-setup configuration file"] = 1344,
    ["custom-elements.json"] = 1257,
    ["cypress.json"] = 351,
    ["dacier.yml"] = 1442,
    ["datalogic-scan2deploy-android"] = 362,
    ["datalogic-scan2deploy-ce"] = 363,
    datavzrd = 364,
    ["dbt Dependencies"] = 252,
    ["dbt Packages"] = 254,
    ["dbt Project"] = 253,
    ["dbt Selectors"] = 255,
    ["dbt YAML files"] = 256,
    ...
    ["ddev-global"] = 365,
    ["ddev-project"] = 366,
    ["debugsettings.json"] = 367,
    ["dependabot-v2.json"] = 372,
    ["dependabot.json"] = 371,
    ["deployed-cli"] = 1198,
    devconcurrent = 270,
    ["devcontainer-feature.json"] = 305,
    ["devcontainer.json"] = 304,
    devinit = 1148,
    ["devspace.yaml"] = 1221,
    djlint = 1149,
    ["docker bake"] = 378,
    ["docker sequencer"] = 379,
    ["docker-compose.yml"] = 1147,
    ["dockerd.json"] = 376,
    ["dotnet Release Index manifest"] = 391,
    ["dotnet-tools.json"] = 392,
    ["dotnetcli.host.json"] = 393,
    ["dprint.json"] = 394,
    ["drone.json"] = 395,
    ["dss-2.0.0.json"] = 397,
    ["dstack configuration"] = 398,
    ["dtool dataset metadata"] = 1339,
    ["dvc.yaml"] = 400,
    ["ecosystem.json"] = 405,
    ["editorconfig-checker"] = 407,
    eksctl = 408,
    ["electron-builder configuration file"] = 434,
    ["epr-manifest.json"] = 433,
    ["estampo.toml"] = 432,
    ["evcc.yaml"] = 435,
    ["ezd task runner"] = 446,
    ["fabric.mod.json"] = 449,
    ["first-timers-bot"] = 457,
    ["flagd flag configuration"] = 144,
    ["fly.io Configuration"] = 145,
    fulibWorkflows = 1180,
    ["function.json"] = 471,
    ["gRPC API Gateway & OpenAPI Config"] = 24,
    ["gematik health care insurance list"] = 1350,
    ["gematik health care patient list"] = 1347,
    ["gematik health care provider institution list"] = 1349,
    ["gematik health care provider list"] = 1348,
    ["gematik tiger test environment configuration"] = 1351,
    ["gh-dash"] = 485,
    ["gha-doctor"] = 486,
    ["git-cliff"] = 482,
    ["git-town.toml"] = 1396,
    ["github-settings-as-code"] = 872,
    ["gitlab-ci"] = 500,
    ["global.json"] = 517,
    ["glslint config"] = 3,
    ["go-feature-flag Flag Configuration"] = 521,
    ["gojo.yaml"] = 522,
    gollama = 520,
    ["hassette.toml"] = 546,
    ["haxelib.json"] = 541,
    ...
    ["ide.host.json"] = 559,
    ["ifstate.yaml"] = 560,
    ["imageoptimizer.json"] = 561,
    ["importmap.json"] = 564,
    ["index.toml (packwiz)"] = 1456,
    instant_python_config = 568,
    instant_python_custom_project = 569,
    intlayer = 570,
    ["ioBroker Configuration"] = 571,
    ["ioBroker JSON UI"] = 572,
    ["ioBroker Package manifest"] = 573,
    ["ixpect.conf.yaml"] = 574,
    ["ize.toml"] = 1234,
    ["jsconfig.json"] = 600,
    ["jscpd Configuration"] = 1218,
    jsdoc = 1130,
    ["k3d.yaml"] = 601,
    ["k9s aliases.yaml"] = 603,
    ["k9s cluster-config.yaml"] = 605,
    ["k9s config.yaml"] = 604,
    ["k9s hotkeys.yaml"] = 606,
    ["k9s plugins.yaml"] = 607,
    ["k9s skin.yaml"] = 608,
    ["k9s views.yaml"] = 609,
    ["kind cluster"] = 623,
    ["klin.json"] = 466,
    ["kontinuous-config.yaml"] = 621,
    ["kontinuous-values.yaml"] = 620,
    ["kustomization.yaml"] = 624,
    ["label-commenter-config.yml"] = 627,
    ["latexindent configuration"] = 133,
    ["launchsettings.json"] = 628,
    lazydocker = 1256,
    lazygit = 1255,
    ["lego.json"] = 630,
    ["lerna.json"] = 631,
    ["lgtm.yml"] = 632,
    ["liblab.config.json"] = 633,
    ["libman.json"] = 634,
    ["license-report-config.json"] = 635,
    ["linkinator.config.json"] = 637,
    ["lint-staged (.lintstagedrc)"] = 1106,
    ["litertlm_manifest.json"] = 641,
    ["local.settings.json"] = 645,
    ["localazy.json"] = 646,
    ["lotus.yaml"] = 644,
    ["lsd colors"] = 137,
    ["lsd config"] = 136,
    ...
    lychee = 1105,
    ["macro.json"] = 1222,
    ["markdown-link-check"] = 1176,
    maturin = 1177,
    mboats = 1184,
    ["mcdreforged.linked_directory_plugin.json"] = 654,
    ["mcdreforged.plugin.json"] = 653,
    memnex = 1440,
    ["micro-settings.json"] = 1249,
    ["mimetypes.json"] = 665,
    ["mirrord config"] = 1109,
    ["misata.yaml"] = 1108,
    mise = 1110,
    ...
    ["mkdocs.yml"] = 685,
    ["mockd.yaml"] = 689,
    ["mod.pw.toml (packwiz)"] = 1457,
    ["modelparams.dev Model"] = 692,
    ["models CLI"] = 693,
    ["monospace.yml"] = 694,
    ["moon.yml"] = 1333,
    ["mprocs Configuration file"] = 1303,
    ["mrdocs.yml"] = 687,
    ["mta.yaml"] = 1112,
    ["mtad.yaml"] = 1113,
    ["mycode.json"] = 702,
    nFPM = 714,
    ["napari plugin manifest"] = 703,
    neoload = 1125,
    ["nest-cli"] = 717,
    ["nexus-rpc-gen"] = 1423,
    ["nf-core module environment.yml"] = 711,
    ["nf-core module meta.yml"] = 712,
    ["nf-core subworkflow meta.yml"] = 713,
    ["ninjs (News in JSON)"] = 716,
    ["nitro.json"] = 1124,
    ["nixd configuration"] = 1275,
    ["nlu.json"] = 718,
    ["nodemon.json"] = 721,
    ["noodl config"] = 1183,
    ["notebook.mod.json"] = 722,
    now = 1120,
    ["npm-badges"] = 725,
    ["nswag.json"] = 729,
    ntangle = 731,
    ["nuclei-template.yaml"] = 726,
    ["nuget-project.json"] = 727,
    ["ocelot.json"] = 733,
    ogen = 739,
    ["omnisharp.json"] = 742,
    openHAB = 1409,
    ...
    oxfmt = 1419,
    oxlint = 1420,
    ["pack.toml (packwiz)"] = 1458,
    ["package.json"] = 778,
    ["package.manifest"] = 780,
    ["package.yaml"] = 779,
    ["partial-black.json"] = 175,
    ["partial-fastapi.json"] = 176,
    ["partial-pixi.json"] = 790,
    ["partial-scheduled.json"] = 177,
    ["pattern.json"] = 788,
    ["petstore-v1.0"] = 1229,
    pgap_yaml_input_reader = 786,
    pgrls = 787,
    pgxgen = 1413,
    pitcms = 1416,
    ["pixi.toml"] = 789,
    ["plagiarize-me.yaml"] = 794,
    ["plagiarize.yaml"] = 793,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1340,
    ["podbard.yaml"] = 796,
    ["portman.json"] = 799,
    ["prefect.toml"] = 808,
    ["prefect.yaml"] = 809,
    ...
    ["prettierrc.json"] = 811,
    ["prisma.yml"] = 812,
    ["project-1.0.0-beta3.json"] = 824,
    ["project-1.0.0-beta4.json"] = 825,
    ["project-1.0.0-beta5.json"] = 826,
    ["project-1.0.0-beta6.json"] = 827,
    ["project-1.0.0-beta8.json"] = 828,
    ["project-1.0.0-rc1.json"] = 829,
    ["project-1.0.0-rc2.json"] = 830,
    ["project.json"] = 823,
    ["project.owasp.yaml"] = 831,
    ["prometheus-alertmanager.json"] = 835,
    ["prometheus.json"] = 832,
    ["prometheus.rules.json"] = 833,
    ["prometheus.rules.test.json"] = 834,
    ["proxies.json"] = 837,
    ["publiccode.yml"] = 838,
    ["pubspec.yaml"] = 839,
    ["pyrseas-0.8.json"] = 842,
    pytest = 851,
    ["quilt.mod.json"] = 1250,
    ["rc3 auth"] = 857,
    ["rc3 collection"] = 858,
    ...
    ["rc3 settings"] = 862,
    ["registry.yaml"] = 65,
    ["release drafter"] = 1126,
    ["release-hub.json"] = 10,
    ["release-please-config.json"] = 867,
    ["release-please-manifest.json"] = 868,
    ["release-plz.toml"] = 869,
    ["renv.lock"] = 884,
    ["replacement-transformer.yaml"] = 625,
    ["reposets Configuration"] = 873,
    ["reposets Credentials"] = 874,
    ["revola.json"] = 8,
    ["rivet.json"] = 1274,
    ["rivet.yaml (legacy)"] = 1273,
    rumdl = 889,
    runny = 888,
    runspec = 1441,
    rustfmt = 890,
    ...
    samt = 893,
    samtrc = 894,
    ["sarif-1.0.0.json"] = 896,
    ["sarif-2.0.0.json"] = 897,
    ["sarif-2.1.0"] = 907,
    ["sarif-2.1.0-rtm.2"] = 898,
    ["sarif-2.1.0-rtm.3"] = 900,
    ["sarif-2.1.0-rtm.4"] = 902,
    ["sarif-2.1.0-rtm.5"] = 904,
    ["sarif-2.1.0-rtm.6"] = 905,
    ["sarif-external-property-file-2.1.0"] = 908,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 899,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 901,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 903,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 906,
    ["scalingo.json configuration"] = 909,
    ["schema.org - Action"] = 911,
    ["schema.org - ContactPoint"] = 912,
    ["schema.org - Place"] = 913,
    ["schema.org - Thing"] = 914,
    ["secrethub.yml"] = 1252,
    ["semantic-release"] = 922,
    servercn = 1469,
    ["servicehub.config.json"] = 1100,
    ["servicehub.service.json"] = 1099,
    ["settings.job"] = 925,
    ["sfdx-hardis configuration"] = 927,
    ["shard.yml"] = 1290,
    ["size-limit configuration"] = 932,
    ["skaffold.yaml"] = 1174,
    ["skill-map plugin extension manifest"] = 933,
    ["skill-map project settings"] = 934,
    ["skill-map provider kind"] = 935,
    ["skyuxconfig.json"] = 937,
    ["snowflake-config"] = 939,
    ["snowflake-connections"] = 940,
    ["spicepod.yaml"] = 1311,
    ["sqlc configuration"] = 974,
    ["stripe-app-local.json"] = 985,
    ["stripe-app.json"] = 984,
    swcrc = 1158,
    ["task.json"] = 998,
    taskcat = 1121,
    ["template.json"] = 1003,
    ["templatsources.json"] = 1004,
    ["text2confl config"] = 1421,
    ["theme.json"] = 1012,
    ["tizen_workspace.json"] = 1014,
    tldr = 1015,
    ["tm_devices configuration file"] = 1378,
    tmuxinator = 1103,
    tox = 1017,
    ["transcend.yml"] = 1026,
    ["tree-sitter grammar.json"] = 528,
    ["trime.yaml"] = 1027,
    ["trunk.yaml"] = 1030,
    ["ts-force-config.json"] = 1036,
    tsbuild = 1031,
    ["tsconfig.json"] = 1032,
    ["tsd.json"] = 1033,
    ["tsdoc.json"] = 1034,
    ...
    uv = 1058,
    v8r = 1081,
    ["value-add-transformer.yaml"] = 626,
    vcluster = 1297,
    ["vcpkg configuration file"] = 309,
    ["vcpkg manifest file"] = 308,
    ["vega-lite.json"] = 1062,
    ["vega.json"] = 1061,
    ["venvironment.yaml"] = 1064,
    ["venvplus.yaml"] = 1065,
    version = 1360,
    ["version.json"] = 1067,
    ...
    ["vtesttree.yaml"] = 1079,
    ["vtestunit.yaml"] = 1080,
    ["warp-keysets.json"] = 1258,
    ["warp-themes.json"] = 1259,
    ["warp-workflows.json"] = 1260,
    ["webhint.io"] = 1214,
    ["webjobpublishsettings.json"] = 1085,
    ["webjobs-list.json"] = 1084,
    ["well-known-fursona"] = 1298,
    ["xs-app.json"] = 1116,
    ["xunit.runner.json"] = 1098,
    ["yaml-workflow"] = 1468,
    yamlfmt = 1143,
    yamllint = 1144,
    ["yap.json"] = 1145,
