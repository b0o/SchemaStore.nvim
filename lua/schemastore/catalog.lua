...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 758,
    [".nodehawkrc"] = 481,
    [".npmpackagejsonlintrc"] = 485,
    [".omletrc"] = 929,
    [".phrase.yml"] = 546,
    [".phraseapp.yml"] = 547,
    [".pmbot.yml"] = 534,
    [".postcssrc"] = 541,
    [".powerpages-web-template-manifest"] = 543,
    [".pre-commit-config.yml"] = 544,
    [".pre-commit-hooks.yml"] = 545,
    [".putout.json"] = 567,
    [".rehyperc"] = 586,
    [".remarkrc"] = 588,
    [".sprite files"] = 651,
    ...
    ["A micro editor config"] = 436,
    ABCInventoryModuleData = 13,
    ABCSupplyPlan = 14,
    AIConfig = 15,
    ["API Builder"] = 791,
    ["AVA Configuration"] = 851,
    ...
    ["Adobe UXP Manifest"] = 911,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Alacritty Configuration"] = 823,
    ["All Contributors configuration file"] = 876,
    ["Ansible Argument Specs"] = 323,
    ["Ansible Collection Galaxy"] = 330,
    ["Ansible Execution Environment"] = 320,
    ["Ansible Inventory"] = 329,
    ["Ansible Meta"] = 321,
    ["Ansible Meta Runtime"] = 322,
    ["Ansible Navigator Configuration"] = 332,
    ["Ansible Playbook"] = 327,
    ["Ansible Requirements"] = 324,
    ["Ansible Rulebook"] = 328,
    ["Ansible Tasks File"] = 326,
    ["Ansible Vars File"] = 325,
    ["Ansible-lint Configuration"] = 331,
    Any = 938,
    ["AnyWork Automation Configuration"] = 5,
    ["App config Spotify Backstage"] = 20,
    ["Application Accelerator"] = 2,
    ["Application list for a WinUtil"] = 955,
    ArchitectFX = 959,
    ["Argo Events"] = 29,
    ["Argo Workflows"] = 30,
    AssemblyScript = 33,
    ...
    ["Azure Pipelines"] = 66,
    ["Azure Static Web Apps CLI configuration file"] = 654,
    ["Azure Static Web Apps configuration file"] = 653,
    ["BOSH Deploy Config"] = 90,
    ["BX CI"] = 107,
    ["Bashly (bashly.yml)"] = 880,
    ["Bashly Settings (bashly-settings.yml)"] = 881,
    ["Better Code Hub"] = 795,
    ["Better Scripts"] = 108,
    Bigconfig = 83,
    ["Biome Formatter Config"] = 53,
    ["Bitmovin Encoding Template"] = 965,
    BizTalkServerApplicationSchema = 764,
    Bleep = 109,
    ...
    ["Butane Config"] = 836,
    ["CGS Custom Card Game (CardGameDef.json)"] = 916,
    ["CICS TS region tagging"] = 845,
    ["CICS TS resource import"] = 846,
    ["CICS TS resource model"] = 847,
    ["CICS TS resource overrides"] = 848,
    ["CMake Presets"] = 110,
    ["CNC Codes"] = 125,
    ["CRS WAF test file"] = 945,
    ["CRS WAF test platform overrides file"] = 946,
    ...
    ["Chamaleon environment"] = 969,
    ["Chamaleon template"] = 968,
    Changesets = 205,
    Cheatsheets = 833,
    ...
    CityJSON = 121,
    ["Clawject config"] = 130,
    ["Cloud Foundry Application Manifest"] = 928,
    ["Cloud Run Spec v1"] = 950,
    ...
    Concord = 944,
    ["Configu .cfgu files"] = 933,
    ["Configu .configu file"] = 934,
    Conjure = 124,
    ["Container Structure Test"] = 778,
    Containerlab = 803,
    ["Crowdsec collection config"] = 214,
    ["Crowdsec parser config"] = 215,
    ["Crowdsec scenario config"] = 216,
    ["CumulusCI Config"] = 129,
    ["Custom Machinery Machine"] = 917,
    ["Custom Machinery Recipe"] = 918,
    ...
    ["DataYoga Job"] = 134,
    ["Databricks Asset Bundles"] = 897,
    ["Datadog Service Definition"] = 409,
    ["Datadog Software Catalog"] = 410,
    ["Datahub Ingestion Recipe"] = 852,
    ["Dein Config"] = 140,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 888,
    ["EAS config"] = 281,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 877,
    ["EasyVCR .NET"] = 282,
    ["Eidolon Resource"] = 960,
    ...
    ["Frogbot Config"] = 72,
    ["G2P Mapping Configuration"] = 302,
    ["GCP Blueprint Metadata"] = 305,
    Gaspar = 303,
    ["GatewayCore API Gateway"] = 304,
    ["GeoJSON.json latest"] = 840,
    GherKing = 844,
    ["GitHub Action"] = 310,
    ["GitHub Discussion"] = 311,
    ["GitHub Funding"] = 312,
    ["GitHub Issue Template configuration"] = 313,
    ["GitHub Issue Template forms"] = 314,
    ["GitHub Workflow"] = 315,
    ["GitHub Workflow Template Properties"] = 316,
    ["GitHub automatically generated release notes configuration"] = 317,
    ["GitLab Agent for Kubernetes configuration"] = 913,
    GitVersion = 307,
    ["Gitea Issue Template configuration"] = 308,
    ["Gitea Issue Template forms"] = 309,
    ["Gitpod Configuration"] = 319,
    ["GlazeWM settings"] = 915,
    ["Global Privacy Control"] = 306,
    Goblet = 896,
    ["Golangci-lint Configuration"] = 334,
    ["Golangci-lint Custom Plugins Configuration"] = 335,
    ["Google Chrome Related Website Sets"] = 289,
    ["Google Cloud Workflows"] = 192,
    Goreleaser = 337,
    ["Goreleaser Pro"] = 338,
    Goss = 339,
    ["Gradle Build Cache Node"] = 793,
    ["Gradle Enterprise"] = 792,
    ["Grafana 5.x Dashboard"] = 340,
    ["GraphQL Code Generator"] = 344,
    ["GraphQL Config"] = 343,
    ["GraphQL Mesh"] = 342,
    ["Grunt JSHint task"] = 348,
    ["Grunt Watch task"] = 349,
    ["Grunt base task"] = 350,
    ["Grunt clean task"] = 346,
    ["Grunt copy task"] = 345,
    ["Grunt cssmin task"] = 347,
    HEMTT = 761,
    Hadolint = 774,
    Hammerkit = 802,
    ["Hardware Sentry Configuration"] = 856,
    Hatch = 775,
    Hayson = 352,
    ["Haystack Pipeline"] = 353,
    ["Hazelcast 5 Configuration"] = 354,
    ["Helm Chart.lock"] = 160,
    ["Helm Chart.yaml"] = 159,
    ["Helm Unittest Test Suite"] = 161,
    Hugo = 832,
    ["Hugo Theme"] = 831,
    ["Hyperfoil benchmark configuration"] = 360,
    ["IBM Zapp document"] = 361,
    ["IBM zCodeFormatSettings"] = 362,
    ["IMG Catapult PSP"] = 367,
    ["IVMS101 by CODE Protocol"] = 914,
    Infrahub = 369,
    Istanbul = 859,
    ["JDownloader2 crawler multi-rules"] = 379,
    ["JDownloader2 crawler single-rules"] = 378,
    ["JFrog Applications Config"] = 380,
    ["JFrog File Spec"] = 381,
    ["JFrog Pipelines YML DSL"] = 865,
    ["JMeter DSL cli config"] = 382,
    JReleaser = 384,
    ["JSON Document Transform"] = 392,
    ["JSON Feed"] = 393,
    ["JSON Resume"] = 593,
    ["JSON Schema Draft 2020-12"] = 744,
    ["JSON Schema Draft 4"] = 741,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 898,
    ["JSON Schema Draft 7"] = 742,
    ["JSON Schema Draft 7 (unofficial strict)"] = 899,
    ["JSON Schema Draft 8 (2019-09)"] = 743,
    ["JSON-API"] = 391,
    ["JSON-WF"] = 927,
    ["JSON-e templates"] = 800,
    ["JSON-stat 2.0"] = 737,
    JSONPatch = 395,
    ["JSR Package Config (jsr.json)"] = 385,
    Jasmine = 373,
    Jekyll = 374,
    ["Jenkins X Pipelines"] = 375,
    ["Jenkins X Requirements"] = 376,
    Jest = 377,
    ["Jovo Language Models"] = 383,
    ["KIMMDY config file"] = 406,
    ["KSP-AVC"] = 738,
    ["KSP-CKAN"] = 739,
    ["KSP-NetKAN"] = 740,
    KSY = 926,
    ...
    Kas = 398,
    ["Kestra flow file"] = 407,
    ["Keycloak REST API"] = 868,
    ["Knative Functions - func.yaml"] = 300,
    ["KoDE/CI build.yaml"] = 861,
    ["Kong DBLess config"] = 862,
    KrakenD = 408,
    ["Kubri Configuration"] = 414,
    LOOBin = 429,
    ...
    ["Language configuration"] = 937,
    Lefthook = 418,
    ["Liferay client-extension.yaml"] = 425,
    ["LinkML Metamodel"] = 427,
    Liquibase = 808,
    ["Liquibase Flow File"] = 809,
    ["Lively Properties"] = 428,
    ["Lobe AI Agent"] = 64,
    Loki = 65,
    ["MLOS Configs"] = 465,
    ["MS2Rescore Configuration"] = 468,
    ["Madness (madness.yml)"] = 879,
    ["MapEHR Mapping"] = 435,
    Markdownlint = 812,
    ["Mason Registry"] = 814,
    ["MegaLinter configuration"] = 437,
    ["MegaLinter descriptor"] = 438,
    Melange = 905,
    ["Meltano project definition"] = 439,
    ["Mergify Configuration"] = 469,
    ["Metadata for a Bazel module"] = 440,
    ["Metadata for a Cinnamon spice"] = 953,
    ["MetricsHub Configuration"] = 441,
    ["MetricsHub Connector Configuration"] = 442,
    ["Micro Editor Syntax"] = 889,
    ["Microsoft Band Web Tile"] = 443,
    ["Microsoft RulesEngine workflow rules"] = 941,
    ["Microsoft RulesEngine workflow rules list"] = 942,
    ["Minecraft Custom Main Menu Mod"] = 906,
    ["Minecraft Data Pack Advancement"] = 445,
    ["Minecraft Data Pack Biome"] = 446,
    ["Minecraft Data Pack Configured Carver"] = 447,
    ["Minecraft Data Pack Damage Type"] = 448,
    ["Minecraft Data Pack Dimension"] = 450,
    ["Minecraft Data Pack Dimension Type"] = 449,
    ["Minecraft Data Pack Item Modifier"] = 451,
    ["Minecraft Data Pack Loot Table"] = 452,
    ["Minecraft Data Pack Metadata"] = 453,
    ["Minecraft Data Pack Predicate"] = 454,
    ["Minecraft Data Pack Recipe"] = 455,
    ["Minecraft Data Pack Tag"] = 456,
    ["Minecraft Data Pack Template Pool"] = 457,
    ["Minecraft Data Pack Trim Material"] = 462,
    ["Minecraft Data Pack Trim Pattern"] = 463,
    ["Minecraft Resource Pack Lang"] = 458,
    ["Minecraft Resource Pack Particle"] = 459,
    ["Minecraft Resource Pack Texture Mcmeta"] = 461,
    ["Minecraft Resourcepack Sounds"] = 460,
    ["Monade CLI Stack Configuration"] = 472,
    ["MongoDB Atlas Search Index Definition"] = 860,
    ["Monika Configuration"] = 858,
    ["Monoweave Configuration"] = 467,
    ["Motif config"] = 757,
    ["NOX Framework (Service)"] = 484,
    ["Netin Diagnostic System Template"] = 818,
    ["Netlify config"] = 475,
    ["Network-as-Code Data Model"] = 476,
    ["Nightwatch.js"] = 477,
    ["NueJS configuration file"] = 489,
    ["Nuitka.yaml"] = 919,
    ["Nullstone config"] = 491,
    ["ONe's changelog entry"] = 505,
    ["ONe's service descriptor"] = 504,
    ["OSCAL Assessment Plan (AP)"] = 513,
    ["OSCAL Assessment Results (AR)"] = 514,
    ["OSCAL Catalog"] = 515,
    ["OSCAL Component Definition (CDef)"] = 516,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 517,
    ["OSCAL Profile"] = 518,
    ["OSCAL System Security Plan (SSP)"] = 519,
    ["OSS Review Toolkit configuration"] = 520,
    ["OSS Review Toolkit curation"] = 521,
    ["OSS Review Toolkit package configuration"] = 522,
    ["OSS Review Toolkit repository configuration"] = 523,
    ["OSS Review Toolkit resolutions"] = 524,
    ["October CMS columns"] = 495,
    ["October CMS fields"] = 496,
    Okteto = 497,
    Opctl = 760,
    ["Open Data Contract Standard (ODCS)"] = 508,
    ["OpenRewrite Resource"] = 507,
    ["OpenUtau character yaml"] = 501,
    ["OpenUtau ustx"] = 502,
    ["OpenWeather Current Weather API"] = 799,
    ["OpenWeather Road Risk API"] = 798,
    ["Ory Hydra configuration"] = 359,
    ["Ory Keto configuration"] = 411,
    ["Ory Kratos configuration"] = 512,
    ["Ory Oathkeeper configuration"] = 493,
    ["Outblocks App configuration"] = 510,
    ["Outblocks database table"] = 511,
    ["Outblocks project configuration"] = 509,
    PDM = 530,
    Packer = 527,
    Pantsbuild = 875,
    ["Paper paper-plugin.yml"] = 528,
    ["Pipeline component"] = 810,
    ["Plex Prerolls"] = 538,
    ["PocketMine plugin.yml"] = 535,
    ["Postman collection"] = 542,
    ["Preset list for a WinUtil"] = 956,
    ["Problem object RFC9457"] = 903,
    ["Problem package generators"] = 551,
    Pterodactyl = 855,
    ["Pull Request Labeler"] = 566,
    Pulumi = 572,
    PyProject = 573,
    Pyright = 574,
    Qgoda = 575,
    Qodana = 828,
    ["Qt Creator workspace file"] = 935,
    ["Quali Torque Blueprint Spec 2"] = 853,
    ["QueryFirst config file"] = 871,
    ["RKE Cluster Configuration JSON"] = 807,
    ["RKE Cluster Configuration YAML"] = 806,
    ["Rancher Fleet"] = 569,
    ["Rattler-build"] = 576,
    Ray = 773,
    ["Read the Docs"] = 571,
    ["Red-DiscordBot Cog"] = 583,
    ["Red-DiscordBot Cog Repo"] = 584,
    ["Red-DiscordBot Trivia"] = 585,
    ["Render Blueprints"] = 805,
    RenderCV = 595,
    Renovate = 594,
    ["Replit config"] = 589,
    RoadRunner = 597,
    ["Rudder techniques"] = 909,
    Ruff = 591,
    ["Rust Project"] = 592,
    ["Rust toolchain"] = 601,
    ["SDMX data message"] = 626,
    ["SDMX metadata message"] = 625,
    ["SDMX structure message"] = 624,
    ["SIL Kit Participant Configuration"] = 636,
    ["SIL Kit Registry Configuration"] = 637,
    SWADL = 665,
    ["Safebox Config"] = 866,
    ["Sapphire CLI Config"] = 604,
    ["SauceCTL Configuration"] = 815,
    ["Schema Catalog"] = 618,
    ["Scoop manifest"] = 623,
    ["Semantic Data Fabric (SDF) file"] = 627,
    ["Semgrep Rule"] = 629,
    ["Serenity Code Generator (Sergen)"] = 630,
    ["Serverless Framework Configuration"] = 822,
    ["Serverless Workflow"] = 824,
    ["Settings for a Cinnamon spice"] = 952,
    ["Settings.paf"] = 632,
    ["Shopware 6 Configuration"] = 825,
    ["Shopware CLI Extension Store Configuration"] = 826,
    ["Shopware CLI Project Store Configuration"] = 827,
    ["Sigma Detection Rule"] = 634,
    ["Sigrid scope configuration file"] = 635,
    ["SkyPilot Task JSON"] = 910,
    ["Slack app manifest"] = 639,
    Solidarity = 642,
    ["Solution filters"] = 643,
    ["Source Maps v3"] = 644,
    Sourcery = 645,
    ["Speakeasy Lint Configuration File"] = 646,
    ["Speakeasy Test Generation Configuration File"] = 647,
    ["Speakeasy Workflow File"] = 648,
    SpecIF = 649,
    ["Sponge Mixin configuration"] = 650,
    StackBlitz = 655,
    ["StackHawk Scanner Configuration"] = 821,
    Stale = 656,
    ["Starlake Data Pipeline"] = 796,
    Starship = 657,
    ["Statamic Blueprint"] = 658,
    ["Stella configuration file"] = 659,
    ["Stryker Mutator"] = 662,
    ["StyleCop Analyzers Configuration"] = 663,
    ["Stylelint (.stylelintrc)"] = 664,
    ["Sublime Syntax"] = 867,
    ["Subsquid squid manifest"] = 912,
    ["Swagger API 2.0"] = 666,
    TSON = 695,
    TSTyche = 696,
    ["Tab data for a LinUtil"] = 958,
    ["Tab list for a LinUtil"] = 957,
    Talhelper = 668,
    ["Talisman configuration"] = 669,
    ["Taskfile config"] = 801,
    Taurus = 670,
    Tauticord = 671,
    ["TestEnvironment.json"] = 680,
    ["TextMate Grammar"] = 679,
    ["Tier.run pricing.json"] = 674,
    Tikibase = 675,
    ["Traefik v2"] = 683,
    ["Traefik v2 File Provider"] = 684,
    ["Travis CI (.travis.yml)"] = 682,
    ["TrueScript for *.tscript files"] = 687,
    TunnelHub = 902,
    Turborepo = 681,
    Tycho = 948,
    Tye = 829,
    ["UET BuildConfig.json"] = 872,
    ["UI5 Manifest"] = 705,
    ["UNCORS configuration"] = 709,
    ["UTAM Page Object"] = 708,
    ["Ubuntu Server Autoinstall"] = 703,
    ["Uniswap Token List"] = 784,
    ["Unreal Engine Uplugin"] = 873,
    ["Unreal Engine Uproject"] = 874,
    ["Updatecli Compose"] = 837,
    ["Updatecli Policy Manifest"] = 838,
    ["Updatecli Policy Metadata"] = 839,
    Uplift = 870,
    ["User Journey Map"] = 804,
    V2Ray = 843,
    ["VSCode Code Snippets"] = 180,
    ["VSIX CLI publishing"] = 726,
    ["Vela Pipeline Configuration"] = 713,
    Vercel = 179,
    ["Version Bumper config"] = 716,
    Visivo = 900,
    ["Waku Config"] = 961,
    ["Web App Manifest"] = 732,
    ["Web types"] = 735,
    WebExtensions = 731,
    ["Webman package recipe"] = 849,
    ["Windows Package Manager Installer Manifest"] = 781,
    ["Windows Package Manager Locale Manifest"] = 782,
    ["Windows Package Manager Singleton Manifest"] = 780,
    ["WireMock stub mapping"] = 964,
    ["Woodpecker pipeline config"] = 817,
    ["Wrangler CLI"] = 736,
    ["Xstate Machine"] = 835,
    ["Yandex Workflow Language"] = 954,
    ["Yarn Config (.yarnrc.yml)"] = 794,
    ["Yippee-Ki-JSON configuration YML"] = 786,
    ["YouTrack App"] = 951,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 904,
    ...
    ["behat.yml"] = 92,
    ["bigquery-table"] = 82,
    ["bioimageio resource description"] = 920,
    ...
    ["crowdin.yml"] = 213,
    ["ctfd-setup configuration file"] = 970,
    ["custom-elements.json"] = 892,
    ["cypress.json"] = 217,
    ...
    ["gitlab-ci"] = 318,
    ["global.json"] = 333,
    ["go-feature-flag Flag Configuration"] = 336,
    ["haxelib.json"] = 351,
    helmfile = 776,
    helmwave = 777,
    ["host-meta.json"] = 356,
    ...
    ["ide.host.json"] = 363,
    ["ifstate.conf"] = 364,
    ["imageoptimizer.json"] = 365,
    ["importmap.json"] = 368,
    ["ioBroker Configuration"] = 370,
    ["ioBroker JSON UI"] = 371,
    ["ioBroker Package manifest"] = 372,
    ["ize.toml"] = 869,
    ["jsconfig.json"] = 396,
    ["jscpd Configuration"] = 854,
    jsdoc = 772,
    ["k3d.yaml"] = 397,
    ["k9s aliases.yaml"] = 399,
    ["k9s cluster-config.yaml"] = 401,
    ["k9s config.yaml"] = 400,
    ["k9s hotkeys.yaml"] = 402,
    ["k9s plugins.yaml"] = 403,
    ["k9s skin.yaml"] = 404,
    ["k9s views.yaml"] = 405,
    ["kontinuous-config.yaml"] = 413,
    ["kontinuous-values.yaml"] = 412,
    ["kustomization.yaml"] = 415,
    ["label-commenter-config.yml"] = 416,
    ["latexindent configuration"] = 63,
    ["launchsettings.json"] = 417,
    lazydocker = 891,
    lazygit = 890,
    ["lego.json"] = 419,
    ["lerna.json"] = 420,
    ["lgtm.yml"] = 421,
    ["liblab.config.json"] = 422,
    ["libman.json"] = 423,
    ["license-report-config.json"] = 424,
    ["linkinator.config.json"] = 426,
    ["lint-staged (.lintstagedrc)"] = 752,
    ["local.settings.json"] = 431,
    ["localazy.json"] = 432,
    ["lotus.yaml"] = 430,
    ["lsdlschema.json"] = 433,
    ["markdown-link-check"] = 813,
    mboats = 820,
    ["micro-settings.json"] = 884,
    ["mimetypes.json"] = 444,
    ["mirrord config"] = 753,
    mise = 754,
    ["mkdocs.yml"] = 464,
    ["monospace.yml"] = 466,
    ["moon.yml"] = 963,
    ["mprocs Configuration file"] = 936,
    ["mta.yaml"] = 755,
    ["mtad.yaml"] = 756,
    ["mycode.json"] = 473,
    ["napari plugin manifest"] = 474,
    neoload = 767,
    ["nest-cli"] = 479,
    ["ninjs (News in JSON)"] = 478,
    ["nitro.json"] = 766,
    ["nixd configuration"] = 908,
    ["nlu.json"] = 480,
    ["nodemon.json"] = 482,
    ["noodl config"] = 819,
    ["notebook.mod.json"] = 483,
    now = 762,
    ["npm-badges"] = 486,
    ["nswag.json"] = 490,
    ntangle = 492,
    ["nuclei-template.yaml"] = 487,
    ["nuget-project.json"] = 488,
    ["ocelot.json"] = 494,
    ["omnisharp.json"] = 498,
    ["openapi.json"] = 499,
    ["openfin.json"] = 506,
    ...
    ["ops.yaml"] = 503,
    ["package.json"] = 525,
    ["package.manifest"] = 526,
    ["partial-black.json"] = 93,
    ["pathfinder.yml"] = 529,
    ["pattern.json"] = 532,
    ["petstore-v1.0"] = 864,
    pgap_yaml_input_reader = 531,
    ["pixi.toml"] = 533,
    ["plagiarize-me.yaml"] = 537,
    ["plagiarize.yaml"] = 536,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 967,
    ["podbard.yaml"] = 539,
    ["portman.json"] = 540,
    ["prefect.toml"] = 548,
    ["prettierrc.json"] = 549,
    ["prisma.yml"] = 550,
    ["project-1.0.0-beta3.json"] = 553,
    ["project-1.0.0-beta4.json"] = 554,
    ["project-1.0.0-beta5.json"] = 555,
    ["project-1.0.0-beta6.json"] = 556,
    ["project-1.0.0-beta8.json"] = 557,
    ["project-1.0.0-rc1.json"] = 558,
    ["project-1.0.0-rc2.json"] = 559,
    ["project.json"] = 552,
    ["prometheus.json"] = 560,
    ["prometheus.rules.json"] = 561,
    ["prometheus.rules.test.json"] = 562,
    ["proxies.json"] = 563,
    ["publiccode.yml"] = 564,
    ["pubspec.yaml"] = 565,
    ["pyrseas-0.8.json"] = 568,
    ["quilt.mod.json"] = 885,
    ["rc3 auth"] = 577,
    ["rc3 collection"] = 578,
    ["rc3 environment"] = 579,
    ...
    samt = 602,
    samtrc = 603,
    ["sarif-1.0.0.json"] = 605,
    ["sarif-2.0.0.json"] = 606,
    ["sarif-2.1.0"] = 616,
    ["sarif-2.1.0-rtm.2"] = 607,
    ["sarif-2.1.0-rtm.3"] = 609,
    ["sarif-2.1.0-rtm.4"] = 611,
    ["sarif-2.1.0-rtm.5"] = 613,
    ["sarif-2.1.0-rtm.6"] = 614,
    ["sarif-external-property-file-2.1.0"] = 617,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 608,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 610,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 612,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 615,
    ["schema.org - Action"] = 619,
    ["schema.org - ContactPoint"] = 620,
    ["schema.org - Place"] = 621,
    ["schema.org - Thing"] = 622,
    ["secrethub.yml"] = 887,
    ["semantic-release"] = 628,
    ["servicehub.config.json"] = 747,
    ["servicehub.service.json"] = 746,
    ["settings.job"] = 631,
    ["sfdx-hardis configuration"] = 633,
    ["shard.yml"] = 923,
    ["size-limit configuration"] = 638,
    ["skaffold.yaml"] = 811,
    ["skyuxconfig.json"] = 640,
    snapcraft = 641,
    ["spicepod.yaml"] = 943,
    ["sqlc configuration"] = 652,
    ["stripe-app-local.json"] = 661,
    ["stripe-app.json"] = 660,
    swcrc = 797,
    ["task.json"] = 667,
    taskcat = 763,
    ["template.json"] = 672,
    ["templatsources.json"] = 673,
    ["theme.json"] = 676,
    ["tizen_workspace.json"] = 677,
    tldr = 678,
    tmuxinator = 750,
    ["transcend.yml"] = 685,
    ["tree-sitter grammar.json"] = 341,
    ["trime.yaml"] = 686,
    ["trunk.yaml"] = 688,
    ["ts-force-config.json"] = 693,
    ["tsconfig.json"] = 689,
    ["tsd.json"] = 690,
    ["tsdoc.json"] = 691,
    ["tsdrc.json"] = 692,
    ...
    ["vega-lite.json"] = 712,
    ["vega.json"] = 711,
    ["venvironment-basic.yaml"] = 715,
    ["venvironment.yaml"] = 714,
    ["version.json"] = 717,
    ["vhwdebugger-binding.yaml"] = 719,
    ["vim-addon-info"] = 720,
    ["vs-2017.3.host.json"] = 722,
    ["vs-nesting.json"] = 723,
    ["vsls.json"] = 721,
    ["vss-extension.json"] = 727,
    ["vtesttree.yaml"] = 728,
    ["vtestunit.yaml"] = 729,
    ["warp-keysets.json"] = 893,
    ["warp-themes.json"] = 894,
    ["warp-workflows.json"] = 895,
    ["webhint.io"] = 850,
    ["webjobpublishsettings.json"] = 734,
    ["webjobs-list.json"] = 733,
    ["well-known-fursona"] = 931,
    ["xs-app.json"] = 759,
    ["xunit.runner.json"] = 745,
    yamllint = 785,
    ["zerops.io import file"] = 940,
    ["zerops.yml"] = 939,
    zuul = 769,
    ["Žinoma"] = 779
  },
