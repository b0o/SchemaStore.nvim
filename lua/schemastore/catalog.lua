...
M.json = {
  ...
  index = {
    ...
    AIConfig = 35,
    ["AMX Muse Program Descriptor"] = 1207,
    ["API Builder"] = 1015,
    ["AVA Configuration"] = 1078,
    ...
    ["AWS Copilot Manifest"] = 1246,
    ["AWS SAM CLI Samconfig"] = 273,
    Acton = 1296,
    ["Adobe UXP Manifest"] = 1141,
    ["Aerleon Network & Service Definitions"] = 21,
    ["Aerleon Policy"] = 22,
    ["Agent Permission Policy"] = 1286,
    ["AgentCore CLI"] = 1287,
    Aider = 1236,
    Air = 24,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1257,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1256,
    ["Airlock Microgateway"] = 36,
    ["Alacritty Configuration"] = 1050,
    ["All Contributors configuration file"] = 1104,
    ...
    ["Application list for a WinUtil"] = 1186,
    ArchitectFX = 1191,
    ["Argo CD"] = 55,
    ["Argo Events"] = 56,
    ["Argo Workflows"] = 57,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1255,
    ["Azure IoT Operations connector metadata"] = 1252,
    ...
    ["Azure Pipelines"] = 115,
    ["Azure Static Web Apps CLI configuration file"] = 858,
    ["Azure Static Web Apps configuration file"] = 857,
    BMML = 1274,
    ["BOSH CPI Config"] = 141,
    ...
    ["Bacon config"] = 6,
    ["Barba-CV"] = 84,
    ["Bashly (bashly.yml)"] = 1108,
    ["Bashly Settings (bashly-settings.yml)"] = 1109,
    Bento = 1273,
    ["Better Code Hub"] = 1020,
    ["Better Scripts"] = 164,
    Bigconfig = 134,
    ["Biome Formatter Config"] = 85,
    ["Bitmovin Encoding Template"] = 1200,
    BizTalkServerApplicationSchema = 987,
    Bleep = 165,
    ["Block Protocol Metadata"] = 162,
    ["Bluebricks blueprint config"] = 1279,
    ["Boyka Framework"] = 143,
    ...
    ["Butane Config"] = 1063,
    C4InterFlow = 1215,
    ["CDK Environment Manager, concrete environment configuration"] = 1239,
    ["CDK Environment Manager, concrete environments definition"] = 1238,
    ["CDK Environment Manager, environment definition"] = 1237,
    ["CGS Card Game Specification (cgs.json)"] = 1146,
    ["CICS TS region tagging"] = 1072,
    ["CICS TS resource import"] = 1073,
    ["CICS TS resource model"] = 1074,
    ["CICS TS resource overrides"] = 1075,
    ["CMake Presets"] = 166,
    ["CNC Codes"] = 188,
    ["CRS WAF test file"] = 1176,
    ["CRS WAF test platform overrides file"] = 1177,
    ...
    ["Chamaleon environment"] = 1204,
    ["Chamaleon properties"] = 1205,
    ["Chamaleon template"] = 1203,
    Changepacks = 1266,
    Changesets = 282,
    Changie = 175,
    Charmcraft = 176,
    ...
    ["Clawject config"] = 194,
    ["Cloud Foundry Application Manifest"] = 1158,
    ["Cloud Run Spec v1"] = 1181,
    ...
    Concord = 1175,
    ["Configu .cfgu files"] = 1163,
    ["Configu .configu file"] = 1164,
    Conjure = 187,
    ["Container Structure Test"] = 1001,
    Containerlab = 1029,
    ["Contextive Glossary"] = 1231,
    Convex = 186,
    ["Crowdsec collection config"] = 292,
    ["Crowdsec parser config"] = 293,
    ["Crowdsec scenario config"] = 294,
    ["CumulusCI Config"] = 193,
    ["Cursor Agent Environment"] = 1284,
    ["Custom Machinery Machine"] = 1147,
    ["Custom Machinery Recipe"] = 1148,
    ...
    ["DonateCaseBetterCasino menu"] = 1208,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1116,
    ["EAS config"] = 381,
    ["ECA - Editor Code Assistant"] = 345,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1105,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1251,
    ["EasyVCR .NET"] = 383,
    ["Eidolon Resource"] = 1192,
    ...
    ["Envelope Team Definition"] = 1295,
    ["Envilder Map File"] = 349,
    ["Erda Pipeline"] = 1154,
    ["Erda Runtime"] = 1155,
    ["Espanso config.yml"] = 1277,
    ["Espanso match.yml"] = 1276,
    Esquio = 369,
    ["Estuary Flow Catalog"] = 1069,
    ["Ethereum ERC1155"] = 1289,
    ["Ethereum ERC721"] = 1288,
    ...
    ["Evolving Resolutive Process notation"] = 1253,
    ["Expo SDK"] = 380,
    ...
    ["GeoJSON.json latest"] = 1067,
    GherKing = 1071,
    ["GitHub Action"] = 416,
    ["GitHub Actions typing"] = 1188,
    ...
    ["Google Digital Assetlinks"] = 1232,
    Goreleaser = 445,
    ["Goreleaser Pro"] = 446,
    Goss = 447,
    ["Gradle Build Cache Node"] = 1018,
    ["Gradle Enterprise"] = 1017,
    ...
    Hadolint = 997,
    Hammerkit = 1028,
    ["Hardware Sentry Configuration"] = 1083,
    ...
    ["JFrog File Spec"] = 498,
    ["JFrog Pipelines YML DSL"] = 1093,
    ["JMeter DSL cli config"] = 499,
    JReleaser = 502,
    ["JSON Document Transform"] = 510,
    ["JSON Feed"] = 511,
    ["JSON Resume"] = 767,
    ["JSON Schema Draft 2020-12"] = 965,
    ["JSON Schema Draft 4"] = 962,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1126,
    ["JSON Schema Draft 7"] = 963,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1127,
    ["JSON Schema Draft 8 (2019-09)"] = 964,
    ["JSON-API"] = 509,
    ["JSON-e templates"] = 1025,
    ["JSON-stat 2.0"] = 958,
    JSONPatch = 513,
    ...
    ["Jujutsu (jj) VCS config"] = 1245,
    ["KIMMDY config file"] = 524,
    ["KODE/CI build.yaml"] = 1089,
    ["KSP-AVC"] = 959,
    ["KSP-CKAN"] = 960,
    ["KSP-NetKAN"] = 961,
    KSY = 1156,
    ...
    ["Metadata for a Cinnamon spice"] = 1184,
    ["Metatype Configuration"] = 566,
    ["MetricsHub Configuration"] = 567,
    ["MetricsHub Connector Configuration"] = 568,
    ["Micro Editor Syntax"] = 1117,
    ["Microsoft Band Web Tile"] = 569,
    ["Microsoft RulesEngine workflow rules"] = 1172,
    ["Microsoft RulesEngine workflow rules list"] = 1173,
    ["Minecraft Custom Main Menu Mod"] = 1135,
    ...
    ["MongoDB Atlas Search Index Definition"] = 1088,
    ["Monika Configuration"] = 1086,
    ["Monoweave Configuration"] = 597,
    ["Motif config"] = 979,
    MultiQC = 1225,
    ["NOX Framework (Service)"] = 620,
    ["Netin Diagnostic System Template"] = 1045,
    ["Netlify config"] = 605,
    ...
    ["OpenUtau ustx"] = 643,
    ["OpenWeather Current Weather API"] = 1024,
    ["OpenWeather Road Risk API"] = 1023,
    ...
    ["Power Pages Configuration"] = 1242,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1187,
    ...
    Pylock = 1233,
    Pyright = 739,
    ["Python script metadata"] = 1227,
    ["QType AI DSL"] = 742,
    Qgoda = 741,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1304,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1302,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1308,
    ["Qlik Talend Cloud Pipeline - Project"] = 1300,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1303,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1305,
    ["Qlik Talend Cloud Pipeline - Task"] = 1301,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1307,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1306,
    Qodana = 1055,
    ["Qt Creator workspace file"] = 1165,
    ["Quali Torque Blueprint Spec 2"] = 1080,
    ["QueryFirst config file"] = 1099,
    ["Qwen Code Settings"] = 1290,
    ["RKE Cluster Configuration JSON"] = 1033,
    ["RKE Cluster Configuration YAML"] = 1032,
    RadioHound = 732,
    ["Raid Profile"] = 1291,
    ["Raid Repo Configuration"] = 1292,
    Railpack = 744,
    Railway = 743,
    ["Rancher Fleet"] = 734,
    ["Rattler-build"] = 745,
    ...
    ["Replit config"] = 760,
    Restate = 1220,
    ["Revel Digital Gadget Definition File"] = 1244,
    RoadRunner = 773,
    ["Robust Station Image"] = 1250,
    Rockcraft = 774,
    ["Roo Coder Custom Modes"] = 775,
    Rubocop = 764,
    ["Rudder techniques"] = 1139,
    Ruff = 765,
    ["Rust Project"] = 766,
    ["Rust toolchain"] = 780,
    ...
    ["Serverless Framework Configuration"] = 1049,
    ["Serverless Workflow"] = 1051,
    ["Settings for a Cinnamon spice"] = 1183,
    ["Settings.paf"] = 813,
    ["Shopware 6 Configuration"] = 1052,
    ["Shopware CLI Extension Store Configuration"] = 1053,
    ["Shopware CLI Project Store Configuration"] = 1054,
    ["Sigma Detection Rule"] = 815,
    ["Sigrid scope configuration file"] = 816,
    ["SkyPilot Task JSON"] = 1140,
    ["Slack app manifest"] = 820,
    Snapcraft = 822,
    Solidarity = 825,
    ["Solution filters"] = 826,
    ["Source Maps v3"] = 827,
    Sourcery = 828,
    ["Spack bootstrap.yaml"] = 829,
    ["Spack cdash.yaml"] = 830,
    ["Spack ci.yaml"] = 831,
    ["Spack compilers.yaml"] = 832,
    ["Spack concretizer.yaml"] = 833,
    ["Spack config.yaml"] = 834,
    ["Spack definitions.yaml"] = 835,
    ["Spack develop.yaml"] = 836,
    ["Spack env_vars.yaml"] = 837,
    ["Spack environment"] = 843,
    ["Spack include.yaml"] = 838,
    ["Spack mirrors.yaml"] = 839,
    ["Spack modules.yaml"] = 840,
    ["Spack packages.yaml"] = 841,
    ["Spack repos.yaml"] = 842,
    ["Spack toolchains.yaml"] = 844,
    ["Spack upstreams.yaml"] = 845,
    ["Spack view.yaml"] = 846,
    ["Speakeasy Generation Config File"] = 850,
    ["Speakeasy Lint Configuration File"] = 847,
    ["Speakeasy Test Generation Configuration File"] = 848,
    ["Speakeasy Workflow File"] = 849,
    SpecIF = 851,
    ["Specmatic Configuration"] = 852,
    ["Sponge Mixin configuration"] = 853,
    StackBlitz = 859,
    ["StackHawk Scanner Configuration"] = 1048,
    Stale = 860,
    Starfish = 861,
    ["Starlake Data Pipeline"] = 1021,
    Starship = 862,
    ["Statamic Blueprint"] = 863,
    ["Stella configuration file"] = 864,
    ["Streamlit configuration file"] = 865,
    ["Stryker Mutator"] = 868,
    ["StyleCop Analyzers Configuration"] = 869,
    ["Stylelint (.stylelintrc)"] = 870,
    ["Stylua Config"] = 1234,
    ["Sublime Syntax"] = 1095,
    ["Subsquid squid manifest"] = 1142,
    ["Swagger API 2.0"] = 872,
    ["Synadia Connect Component"] = 873,
    TSON = 909,
    TSTyche = 910,
    ["TYPO3 Vendor Bundler config"] = 916,
    ["Tab data for a LinUtil"] = 1190,
    ["Tab list for a LinUtil"] = 1189,
    Tach = 874,
    ["Tach Domain"] = 875,
    Talhelper = 877,
    ["Talisman configuration"] = 878,
    Taplo = 1235,
    ["Taskfile config"] = 1026,
    Taurus = 879,
    Tauticord = 880,
    ["Tekton Pipeline"] = 1263,
    ["Tekton PipelineRun"] = 1264,
    ["Tekton Task"] = 1261,
    ["Tekton TaskRun"] = 1262,
    Telefonistka = 1221,
    ["Terrateam config"] = 1247,
    ["TestEnvironment.json"] = 892,
    ["TextMate Grammar"] = 891,
    Threagile = 886,
    ["Tier.run pricing.json"] = 883,
    Tikibase = 884,
    Tombi = 889,
    ["Traefik v2"] = 895,
    ["Traefik v2 File Provider"] = 896,
    ["Traefik v3"] = 897,
    ["Traefik v3 File Provider"] = 898,
    ["Travis CI (.travis.yml)"] = 894,
    Treefmt = 450,
    Trident = 1217,
    ["TrueScript for *.tscript files"] = 901,
    ["Tugboat QA config.yml"] = 1214,
    TunnelHub = 1130,
    Turborepo = 893,
    Tycho = 1179,
    Tye = 1056,
    ["Tyk Gateway - Open Source v5.7+"] = 1226,
    ["UET BuildConfig.json"] = 1100,
    ["UI5 Manifest"] = 922,
    ["UNCORS configuration"] = 926,
    ["UTAM Page Object"] = 925,
    ["Ubuntu Server Autoinstall"] = 920,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1218,
    ["Uniswap Token List"] = 1007,
    ["Universal Schedule Format"] = 927,
    ["Unreal Engine Uplugin"] = 1101,
    ["Unreal Engine Uproject"] = 1102,
    ["UpCloud CLI (upctl) configuration"] = 1219,
    ["Updatecli Compose"] = 1064,
    ["Updatecli Policy Manifest"] = 1065,
    ["Updatecli Policy Metadata"] = 1066,
    Uplift = 1098,
    ["Upsun config"] = 7,
    ["User Journey Map"] = 1030,
    V2Ray = 1070,
    ["VSCode Code Snippets"] = 257,
    ["VSIX CLI publishing"] = 945,
    Vector = 929,
    ["Vela Pipeline Configuration"] = 932,
    Vercel = 256,
    ["Version Bumper config"] = 935,
    Vespertide = 1268,
    ["Vespertide Migration"] = 1269,
    ["Vespertide Model"] = 1270,
    ["Viash Component Config"] = 1223,
    ["Viash Package Config"] = 1224,
    Visivo = 1128,
    ["WP-CLI"] = 955,
    Wake = 1216,
    ["Waku Config"] = 1193,
    ["Web App Manifest"] = 951,
    ["Web types"] = 954,
    WebExtensions = 950,
    ["Webman package recipe"] = 1076,
    ["Windows Package Manager Installer Manifest"] = 1004,
    ["Windows Package Manager Locale Manifest"] = 1005,
    ["Windows Package Manager Singleton Manifest"] = 1003,
    ["WireMock CLI import configuration"] = 1199,
    ["WireMock CLI local service configuration"] = 1198,
    ["WireMock message stub mapping"] = 1197,
    ["WireMock stub mapping"] = 1196,
    ["Woodpecker pipeline config"] = 1044,
    ["Wrangler CLI"] = 956,
    ["XenForo add-on manifest"] = 957,
    ["Xstate Machine"] = 1062,
    ["Yandex Workflow Language"] = 1185,
    ["Yarn Config (.yarnrc.yml)"] = 1019,
    ["Yippee-Ki-JSON configuration YML"] = 1010,
    ["YouTrack App"] = 1182,
    ["Zarf Package Configuration"] = 1249,
    ["Zerops import file"] = 1171,
    ["Zola Configuration"] = 1260,
    ["aerleon.yml"] = 20,
    ["amplify.yml"] = 13,
    ["angular.json"] = 37,
    apko = 1133,
    ...
    ["behat.yml"] = 144,
    ["bigquery-table"] = 133,
    ["bioimageio resource description"] = 1150,
    ...
    ["chutzpah.json"] = 265,
    cibuildwheel = 181,
    ["clang-format (.clang-format)"] = 1068,
    ["clang-tidy"] = 242,
    clangd = 241,
    clib = 243,
    ...
    ["crowdin.yml"] = 291,
    ["ctfd-setup configuration file"] = 1206,
    ["custom-elements.json"] = 1120,
    ["cypress.json"] = 295,
    ["dacier.yml"] = 1299,
    ...
    ["gematik health care insurance list"] = 1212,
    ["gematik health care patient list"] = 1209,
    ["gematik health care provider institution list"] = 1211,
    ["gematik health care provider list"] = 1210,
    ["gematik tiger test environment configuration"] = 1213,
    ["git-town.toml"] = 1258,
    ["gitlab-ci"] = 425,
    ["global.json"] = 441,
    ...
    ["lint-staged (.lintstagedrc)"] = 973,
    ["local.settings.json"] = 553,
    ["localazy.json"] = 554,
    ["lotus.yaml"] = 552,
    ["lsdlschema.json"] = 555,
    ["macro.json"] = 1085,
    ["markdown-link-check"] = 1039,
    maturin = 1040,
    mboats = 1047,
    memnex = 1297,
    ["micro-settings.json"] = 1112,
    ["mimetypes.json"] = 570,
    ["mirrord config"] = 975,
    mise = 976,
    ["mkdocs.yml"] = 590,
    ...
    ["monospace.yml"] = 596,
    ["moon.yml"] = 1195,
    ["mprocs Configuration file"] = 1166,
    ["mrdocs.yml"] = 592,
    ["mta.yaml"] = 977,
    ["mtad.yaml"] = 978,
    ["mycode.json"] = 603,
    ...
    ["plagiarize.yaml"] = 683,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1202,
    ["podbard.yaml"] = 686,
    ["portman.json"] = 689,
    ["prefect.toml"] = 698,
    ["prefect.yaml"] = 699,
    ...
    ["servicehub.config.json"] = 968,
    ["servicehub.service.json"] = 967,
    ["settings.job"] = 812,
    ...
    ["spicepod.yaml"] = 1174,
    ["sqlc configuration"] = 856,
    ["stripe-app-local.json"] = 867,
    ["stripe-app.json"] = 866,
    swcrc = 1022,
    ["task.json"] = 876,
    taskcat = 986,
    ["template.json"] = 881,
    ["templatsources.json"] = 882,
    ["text2confl config"] = 1283,
    ["theme.json"] = 885,
    ["tizen_workspace.json"] = 887,
    tldr = 888,
    ["tm_devices configuration file"] = 1240,
    tmuxinator = 971,
    tox = 890,
    ["transcend.yml"] = 899,
    ...
    ["vega-lite.json"] = 931,
    ["vega.json"] = 930,
    ["venvironment.yaml"] = 933,
    ["venvplus.yaml"] = 934,
    version = 1222,
    ["version.json"] = 936,
    ["vhwdebugger-binding.yaml"] = 938,
    ["vim-addon-info"] = 939,
    ["vs-2017.3.host.json"] = 941,
    ["vs-nesting.json"] = 942,
    ["vsls.json"] = 940,
    ["vss-extension.json"] = 946,
    vtcfg = 1228,
    ["vtesttree.yaml"] = 947,
    ["vtestunit.yaml"] = 948,
    ["warp-keysets.json"] = 1121,
    ["warp-themes.json"] = 1122,
    ["warp-workflows.json"] = 1123,
    ["webhint.io"] = 1077,
    ["webjobpublishsettings.json"] = 953,
    ["webjobs-list.json"] = 952,
    ["well-known-fursona"] = 1161,
    ["xs-app.json"] = 981,
    ["xunit.runner.json"] = 966,
    yamlfmt = 1008,
    yamllint = 1009,
    ["zerops.yml"] = 1170,
    zizmor = 1265,
