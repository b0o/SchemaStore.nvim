...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 135,
    [".cryproj (generic)"] = 464,
    [".cryproj engine-5.2"] = 459,
    [".cryproj engine-5.3"] = 460,
    [".cryproj engine-5.4"] = 461,
    [".cryproj engine-5.5"] = 462,
    [".cryproj engine-dev"] = 463,
    [".csscomb.json"] = 137,
    [".csslintrc"] = 138,
    [".eslintrc"] = 179,
    [".esmrc.json"] = 171,
    ...
    [".vsext"] = 440,
    [".yarnrc.yml"] = 504,
    ["<div>RIOTS' studio configuration"] = 443,
    ["API Builder"] = 501,
    ["AVA Configuration Schema"] = 555,
    ...
    ["Azure Pipelines"] = 41,
    ["Azure Static Web Apps CLI configuration file"] = 391,
    ["Azure Static Web Apps configuration file"] = 390,
    ["BX CI"] = 70,
    ["Better Code Hub"] = 506,
    ["Better Scripts"] = 71,
    BizTalkServerApplicationSchema = 478,
    ...
    ["Butane config schema"] = 542,
    ["CICS TS region tagging"] = 549,
    ["CICS TS resource import"] = 550,
    ["CICS TS resource model"] = 551,
    ["CICS TS resource overrides"] = 552,
    ["CMake Presets"] = 72,
    ...
    ["Embrace Config Schema"] = 567,
    ["Error pages"] = 174,
    Esquio = 172,
    ["Estuary Flow Catalog Schema"] = 546,
    ["Expo SDK"] = 177,
    ...
    Goreleaser = 205,
    ["Goreleaser Pro"] = 206,
    ["Gradle Build Cache Node"] = 503,
    ["Gradle Enterprise"] = 502,
    ...
    HEMTT = 475,
    Hadolint = 487,
    ["Hardware Sentry Configuration"] = 560,
    Hayson = 218,
    ...
    ["JSON Feed"] = 244,
    ["JSON Resume"] = 353,
    ["JSON Schema Draft 2020-12"] = 455,
    ["JSON Schema Draft 4"] = 452,
    ["JSON Schema Draft 7"] = 453,
    ["JSON Schema Draft 8"] = 454,
    ...
    ["KSP-AVC"] = 450,
    ["KSP-CKAN"] = 451,
    ["KoDE/CI build.yaml"] = 565,
    ["Kong DBLess Schema"] = 566,
    KrakenD = 249,
    ["LinkML Metamodel"] = 260,
    Liquibase = 517,
    ["Liquibase Flow File"] = 518,
    Markdownlint = 521,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 564,
    ["Monika Configuration Schema"] = 562,
    ["Motif config"] = 471,
    ["Netin Diagnostic System Template"] = 526,
    ...
    Opctl = 474,
    ["OpenWeather Current Weather API"] = 510,
    ["OpenWeather Road Risk API"] = 509,
    ...
    Packer = 315,
    ["Pipeline component"] = 519,
    ["PocketMine plugin.yml"] = 319,
    Pterodactyl = 559,
    ["Pull Request Labeler"] = 342,
    PyProject = 346,
    Qodana = 535,
    ["Quali Torque Blueprint Spec 2"] = 557,
    ["RKE Cluster Configuration JSON Schema"] = 516,
    ["RKE Cluster Configuration YAML Schema"] = 515,
    Ray = 486,
    ["Read the Docs"] = 345,
    ...
    ["SauceCTL Configuration"] = 523,
    ["Schema Catalog"] = 371,
    ["Scoop manifest"] = 376,
    ["Semgrep Rule"] = 378,
    ["Serverless Framework Configuration"] = 530,
    ["Serverless Workflow Schema"] = 531,
    ["Settings.paf"] = 380,
    ["Shopware 6 Configuration"] = 532,
    ["Shopware CLI Extension Store Configuration"] = 533,
    ["Shopware CLI Project Store Configuration"] = 534,
    Solidarity = 385,
    ["Source Maps v3"] = 386,
    SpecIF = 387,
    ["Sponge Mixin configuration"] = 388,
    ["StackHawk Scanner Configuration"] = 529,
    ["StackHead CLI config"] = 392,
    ["StackHead module configuration"] = 393,
    ["StackHead project definition"] = 394,
    Stale = 395,
    Starship = 396,
    ["Statamic Blueprint"] = 397,
    ["Stryker Mutator"] = 399,
    ["StyleCop Analyzers Configuration"] = 400,
    ["Swagger API 2.0"] = 403,
    ["Talisman configuration"] = 404,
    ["Taskfile YAML Schema"] = 512,
    Taurus = 405,
    ["TestEnvironment.json"] = 412,
    Tikibase = 408,
    ["Traefik v2"] = 415,
    ["Traefik v2 File Provider"] = 416,
    Turborepo = 413,
    Tye = 536,
    ["UI5 Manifest"] = 428,
    ["UTAM Page Object"] = 430,
    ["Ubuntu Server Autoinstall"] = 426,
    ["Uniswap Token List"] = 495,
    Updatecli = 543,
    ["User Journey Map YAML Schema"] = 514,
    V2Ray = 547,
    ["VSCode Code Snippets"] = 111,
    ["VSIX CLI publishing"] = 441,
    ["Vela Pipeline Configuration"] = 433,
    Vercel = 110,
    ["Web App Manifest"] = 445,
    ["Web types"] = 448,
    WebExtensions = 444,
    ["Webman package recipe"] = 553,
    ["Windows Package Manager Installer Manifest"] = 492,
    ["Windows Package Manager Locale Manifest"] = 493,
    ["Windows Package Manager Singleton Manifest"] = 491,
    ["Woodpecker pipeline config"] = 525,
    ["Xstate Machine Schema"] = 541,
    ["Yippee-Ki-JSON configuration YML"] = 497,
    ["angular.json"] = 8,
    ...
    ["jsconfig.json"] = 247,
    ["jscpd Configuration Schema"] = 558,
    jsdoc = 485,
    ["k3d.yaml"] = 248,
    ...
    ["servicehub.config.json"] = 458,
    ["servicehub.service.json"] = 457,
    ["settings.job"] = 379,
    ...
    taskcat = 477,
    ["template.json"] = 406,
    ["templatsources.json"] = 407,
    ["theme.json"] = 409,
    ["tizen_workspace.json"] = 410,
    tmLanguage = 411,
    tmuxinator = 466,
    ["trunk.yaml schema"] = 417,
    ["ts-force-config.json"] = 421,
    ["tsconfig.json"] = 418,
    ["tsd.json"] = 419,
    ["tsdrc.json"] = 420,
    ["tslint.json"] = 422,
    ...
    ["version.json"] = 434,
    ["vim-addon-info"] = 435,
    ["vs-2017.3.host.json"] = 437,
    ["vs-nesting.json"] = 438,
    ["vsls.json"] = 436,
    ["vss-extension.json"] = 442,
    ["webhint.io"] = 554,
    ["webjobpublishsettings.json"] = 447,
    ["webjobs-list.json"] = 446,
    ["xs-app.json"] = 473,
    ["xunit.runner.json"] = 456,
    yamllint = 496,
    zuul = 482,
    ["Žinoma"] = 490
  },
