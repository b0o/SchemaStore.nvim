...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 158,
    [".cryproj (generic)"] = 543,
    [".cryproj engine-5.2"] = 538,
    [".cryproj engine-5.3"] = 539,
    [".cryproj engine-5.4"] = 540,
    [".cryproj engine-5.5"] = 541,
    [".cryproj engine-dev"] = 542,
    [".csscomb.json"] = 160,
    [".csslintrc"] = 161,
    [".es6importsorterrc.json"] = 666,
    [".eslintrc"] = 206,
    [".esmrc.json"] = 198,
    [".ffizer.yaml"] = 210,
    [".htmlhintrc"] = 254,
    ...
    [".mtaext"] = 552,
    [".nodehawkrc"] = 344,
    [".npmpackagejsonlintrc"] = 347,
    [".phraseapp.yml"] = 383,
    [".pmbot.yml"] = 374,
    [".postcssrc"] = 379,
    [".powerpages-web-template-manifest"] = 380,
    [".pre-commit-config.yml"] = 381,
    [".pre-commit-hooks.yml"] = 382,
    [".putout.json"] = 400,
    [".rehyperc"] = 409,
    [".remarkrc"] = 410,
    [".sprite files"] = 458,
    ...
    [".vsext"] = 516,
    [".yarnrc.yml"] = 584,
    ["<div>RIOTS' studio configuration"] = 522,
    ["@factorial/drupal-breakpoints-css"] = 5,
    ["A micro editor config schema"] = 309,
    ["API Builder"] = 581,
    ["AVA Configuration Schema"] = 638,
    ["AWS CDK cdk.json"] = 143,
    ["AWS CloudFormation"] = 144,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 145,
    ["Airlock Microgateway"] = 9,
    ["Airplane task"] = 10,
    ["Alacritty Configuration Schema"] = 613,
    ["All Contributors configuration file"] = 665,
    ...
    ["Azure Pipelines"] = 48,
    ["Azure Static Web Apps CLI configuration file"] = 460,
    ["Azure Static Web Apps configuration file"] = 459,
    ["BX CI"] = 83,
    ["Better Code Hub"] = 586,
    ["Better Scripts"] = 84,
    BizTalkServerApplicationSchema = 558,
    ...
    ["Butane Config"] = 625,
    ["CICS TS region tagging"] = 632,
    ["CICS TS resource import"] = 633,
    ["CICS TS resource model"] = 634,
    ["CICS TS resource overrides"] = 635,
    ["CMake Presets"] = 85,
    ...
    ["Datadog Service Definition"] = 290,
    ["Datahub Ingestion Recipe Schema"] = 639,
    ...
    ["Embrace Config Schema"] = 650,
    ["Error pages"] = 201,
    Esquio = 199,
    ["Estuary Flow Catalog Schema"] = 629,
    ["Expo SDK"] = 204,
    ...
    Goreleaser = 236,
    ["Goreleaser Pro"] = 237,
    ["Gradle Build Cache Node"] = 583,
    ["Gradle Enterprise"] = 582,
    ...
    Hadolint = 567,
    Hammerkit = 593,
    ["Hardware Sentry Configuration"] = 643,
    Hayson = 249,
    ...
    ["JFrog File Spec"] = 273,
    ["JFrog Pipelines YML DSL"] = 652,
    ["JMeter DSL cli config schema"] = 274,
    ["JSON Document Transform"] = 282,
    ["JSON Feed"] = 283,
    ["JSON Resume"] = 416,
    ["JSON Schema Draft 2020-12"] = 534,
    ["JSON Schema Draft 4"] = 531,
    ["JSON Schema Draft 7"] = 532,
    ["JSON Schema Draft 8"] = 533,
    ...
    ["KSP-CKAN"] = 530,
    Kas = 288,
    ["Keycloak REST API"] = 658,
    ["Knative Functions - func.yaml"] = 219,
    ["KoDE/CI build.yaml"] = 648,
    ["Kong DBLess Schema"] = 649,
    KrakenD = 289,
    LOOBin = 304,
    ["LinkML Metamodel"] = 302,
    Liquibase = 598,
    ["Liquibase Flow File"] = 599,
    ["Lively Properties"] = 303,
    Markdownlint = 602,
    ["Mason Registry"] = 604,
    ["MegaLinter configuration"] = 310,
    ["MegaLinter descriptor"] = 311,
    ["Meltano plugin discovery definition"] = 313,
    ["Meltano project definition"] = 312,
    ["Microsoft Band Web Tile"] = 314,
    ["Minecraft Data Pack Advancement"] = 316,
    ["Minecraft Data Pack Biome"] = 317,
    ["Minecraft Data Pack Configured Carver"] = 318,
    ["Minecraft Data Pack Damage Type"] = 319,
    ["Minecraft Data Pack Dimension"] = 321,
    ["Minecraft Data Pack Dimension Type"] = 320,
    ["Minecraft Data Pack Item Modifier"] = 322,
    ["Minecraft Data Pack Loot Table"] = 323,
    ["Minecraft Data Pack Metadata"] = 324,
    ["Minecraft Data Pack Predicate"] = 325,
    ["Minecraft Data Pack Recipe"] = 326,
    ["Minecraft Data Pack Tag"] = 327,
    ["Minecraft Data Pack Template Pool"] = 328,
    ["Minecraft Resource Pack Lang"] = 329,
    ["Minecraft Resource Pack Particle"] = 330,
    ["Minecraft Resource Pack Texture Mcmeta"] = 332,
    ["Minecraft Resourcepack Sounds"] = 331,
    ["MkDocs Configuration 1.0"] = 333,
    ["MongoDB Atlas Search Index Definition Schema"] = 647,
    ["Monika Configuration Schema"] = 645,
    ["Motif config"] = 551,
    ["NOX Framework (Service)"] = 346,
    ["Netin Diagnostic System Template"] = 608,
    ["Netlify config schema"] = 338,
    ["Nightwatch.js"] = 339,
    ["OSS Review Toolkit configuration"] = 364,
    ["OSS Review Toolkit curation"] = 365,
    ["OSS Review Toolkit package configuration"] = 366,
    ["OSS Review Toolkit repository configuration"] = 367,
    ["OSS Review Toolkit resolutions"] = 368,
    Opctl = 554,
    ["OpenRewrite Resource"] = 359,
    ["OpenWeather Current Weather API"] = 590,
    ["OpenWeather Road Risk API"] = 589,
    ["Ory Hydra configuration"] = 255,
    ["Ory Keto configuration"] = 291,
    ["Ory Kratos configuration"] = 363,
    ["Ory Oathkeeper configuration"] = 353,
    ["Outblocks App configuration"] = 361,
    ["Outblocks database table"] = 362,
    ["Outblocks project configuration"] = 360,
    Packer = 371,
    Pantsbuild = 664,
    ["Pipeline component"] = 600,
    ["PocketMine plugin.yml"] = 375,
    Pterodactyl = 642,
    ["Pull Request Labeler"] = 399,
    Pulumi = 404,
    PyProject = 405,
    Qodana = 618,
    ["Quali Torque Blueprint Spec 2"] = 640,
    ["QueryFirst config file"] = 661,
    ["RKE Cluster Configuration JSON Schema"] = 597,
    ["RKE Cluster Configuration YAML Schema"] = 596,
    ["Rancher Fleet"] = 402,
    Ray = 566,
    ["Read the Docs"] = 403,
    ["Red-DiscordBot Cog"] = 406,
    ["Red-DiscordBot Cog Repo"] = 407,
    ["Red-DiscordBot Trivia"] = 408,
    Renovate = 417,
    ["Replit schema"] = 411,
    RoadRunner = 418,
    Ruff = 414,
    ["Rust Project"] = 415,
    ["Rust toolchain"] = 420,
    ["SIL Kit Participant Configuration"] = 447,
    SWADL = 469,
    ["Sapphire CLI Config"] = 421,
    ["SauceCTL Configuration"] = 605,
    ["Schema Catalog"] = 434,
    ["Scoop manifest"] = 439,
    ["Semantic Data Fabric (SDF) file"] = 440,
    ["Semgrep Rule"] = 442,
    ["Serenity Code Generator (Sergen)"] = 443,
    ["Serverless Framework Configuration"] = 612,
    ["Serverless Workflow Schema"] = 614,
    ["Settings.paf"] = 445,
    ["Shopware 6 Configuration"] = 615,
    ["Shopware CLI Extension Store Configuration"] = 616,
    ["Shopware CLI Project Store Configuration"] = 617,
    ["Slack app manifest"] = 449,
    Solidarity = 452,
    ["Solution filters"] = 453,
    ["Source Maps v3"] = 454,
    Sourcery = 455,
    SpecIF = 456,
    ["Sponge Mixin configuration"] = 457,
    ["StackHawk Scanner Configuration"] = 611,
    Stale = 461,
    Starship = 462,
    ["Statamic Blueprint"] = 463,
    ["StrmPrivacy Data Connector"] = 656,
    ["StrmPrivacy Data Contract"] = 657,
    ["StrmPrivacy SimpleSchema"] = 654,
    ["StrmPrivacy Stream"] = 655,
    ["StrmPrivacy batch job configuration file"] = 653,
    ["Stryker Mutator"] = 466,
    ["StyleCop Analyzers Configuration"] = 467,
    ["Swagger API 2.0"] = 470,
    TSON = 494,
    ["Talisman configuration"] = 472,
    ["Taskfile YAML Schema"] = 592,
    Taurus = 473,
    ["TestEnvironment.json"] = 482,
    ["Tier.run pricing.json"] = 476,
    Tikibase = 477,
    ["Traefik v2"] = 485,
    ["Traefik v2 File Provider"] = 486,
    Turborepo = 483,
    Tye = 619,
    ["UI5 Manifest"] = 501,
    ["UTAM Page Object"] = 504,
    ["Ubuntu Server Autoinstall"] = 499,
    ["Uniswap Token List"] = 575,
    ["Unreal Engine Uplugin"] = 662,
    ["Unreal Engine Uproject"] = 663,
    Updatecli = 626,
    Uplift = 660,
    ["User Journey Map YAML Schema"] = 595,
    V2Ray = 630,
    ["VSCode Code Snippets"] = 131,
    ["VSIX CLI publishing"] = 517,
    ["Vela Pipeline Configuration"] = 507,
    Vercel = 130,
    ["Web App Manifest"] = 524,
    ["Web types"] = 527,
    WebExtensions = 523,
    ["Webman package recipe"] = 636,
    ["Windows Package Manager Installer Manifest"] = 572,
    ["Windows Package Manager Locale Manifest"] = 573,
    ["Windows Package Manager Singleton Manifest"] = 571,
    ["Woodpecker pipeline config"] = 607,
    ["Xstate Machine Schema"] = 624,
    ["Yippee-Ki-JSON configuration YML"] = 577,
    ["angular.json"] = 11,
    ...
    ["bamboo-spec"] = 59,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 668,
    ["bashly-strings.yml"] = 669,
    ["bashly.yml"] = 667,
    ["batect.yml"] = 58,
    ["beau.yml"] = 585,
    ...
    ["ize.toml"] = 659,
    ["jsconfig.json"] = 286,
    ["jscpd Configuration Schema"] = 641,
    jsdoc = 565,
    ["k3d.yaml"] = 287,
    ["kontinuous-values.yaml"] = 292,
    ["kustomization.yaml"] = 293,
    ["label-commenter-config.yml"] = 294,
    ["launchsettings.json"] = 295,
    ["lego.json"] = 296,
    ["lerna.json"] = 297,
    ["lgtm.yml"] = 298,
    ["libman.json"] = 299,
    ["license-report-config.json"] = 300,
    ["linkinator.config.json"] = 301,
    ["local.settings.json"] = 306,
    ["localazy.json"] = 307,
    ["lotus.yaml"] = 305,
    ["lsdlschema.json"] = 308,
    ["markdown-lint-check"] = 603,
    mboats = 610,
    ["mimetypes.json"] = 315,
    ["mirrord-schema"] = 548,
    ["mta.yaml"] = 549,
    ["mtad.yaml"] = 550,
    ["mycode.json"] = 336,
    ["napari plugin manifest"] = 337,
    neoload = 560,
    ["nest-cli"] = 342,
    ["ninjs (News in JSON) 1.3"] = 341,
    ["ninjs (News in JSON) 2.0"] = 340,
    ["nlu.json"] = 343,
    ["nodemon.json"] = 345,
    ["noodl.schema.json"] = 609,
    now = 556,
    ["npm-badges"] = 348,
    ["nswag.json"] = 351,
    ntangle = 352,
    ["nuclei-template.yaml"] = 349,
    ["nuget-project.json"] = 350,
    ["ocelot.json"] = 354,
    ["omnisharp.json"] = 355,
    ["openapi.json"] = 356,
    ["openfin.json"] = 358,
    ["openrpc.json"] = 357,
    ["package.json"] = 369,
    ["package.manifest"] = 370,
    ["pattern.json"] = 373,
    ["petstore-v1.0"] = 651,
    pgap_yaml_input_reader = 372,
    ["plagiarize-me.yaml"] = 377,
    ["plagiarize.yaml"] = 376,
    ["portman.json"] = 378,
    ["prettierrc.json"] = 384,
    ["prisma.yml"] = 385,
    ["project-1.0.0-beta3.json"] = 387,
    ["project-1.0.0-beta4.json"] = 388,
    ["project-1.0.0-beta5.json"] = 389,
    ["project-1.0.0-beta6.json"] = 390,
    ["project-1.0.0-beta8.json"] = 391,
    ["project-1.0.0-rc1.json"] = 392,
    ["project-1.0.0-rc2.json"] = 393,
    ["project.json"] = 386,
    ["prometheus.json"] = 394,
    ["prometheus.rules.json"] = 395,
    ["proxies.json"] = 396,
    ["publiccode.yml"] = 397,
    ["pubspec.yaml"] = 398,
    ["pyrseas-0.8.json"] = 401,
    ["release drafter"] = 561,
    rtx = 413,
    rustfmt = 419,
    ["sarif-1.0.0.json"] = 422,
    ["sarif-2.0.0.json"] = 423,
    ["sarif-2.1.0"] = 432,
    ["sarif-2.1.0-rtm.2"] = 424,
    ["sarif-2.1.0-rtm.3"] = 426,
    ["sarif-2.1.0-rtm.4"] = 428,
    ["sarif-2.1.0-rtm.5"] = 430,
    ["sarif-external-property-file-2.1.0"] = 433,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 425,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 427,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 429,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 431,
    ["schema.org - Action"] = 435,
    ["schema.org - ContactPoint"] = 436,
    ["schema.org - Place"] = 437,
    ["schema.org - Thing"] = 438,
    ["semantic-release"] = 441,
    ["servicehub.config.json"] = 537,
    ["servicehub.service.json"] = 536,
    ["settings.job"] = 444,
    ["sfdx-hardis configuration"] = 446,
    ["size-limit configuration"] = 448,
    ["skaffold.yaml"] = 601,
    ["skyuxconfig.json"] = 450,
    snapcraft = 451,
    ["stripe-app-local.json"] = 465,
    ["stripe-app.json"] = 464,
    swcrc = 588,
    ["task.json"] = 471,
    taskcat = 557,
    ["template.json"] = 474,
    ["templatsources.json"] = 475,
    ["theme.json"] = 478,
    ["tizen_workspace.json"] = 479,
    tldr = 480,
    tmLanguage = 481,
    tmuxinator = 545,
    ["transcend.yml"] = 487,
    ["trunk.yaml schema"] = 488,
    ["ts-force-config.json"] = 492,
    ["tsconfig.json"] = 489,
    ["tsd.json"] = 490,
    ["tsdrc.json"] = 491,
    ["tslint.json"] = 493,
    ...
    ["vega-lite.json"] = 506,
    ["vega.json"] = 505,
    ["venvironment-basic.yaml"] = 509,
    ["venvironment.yaml"] = 508,
    ["version.json"] = 510,
    ["vim-addon-info"] = 511,
    ["vs-2017.3.host.json"] = 513,
    ["vs-nesting.json"] = 514,
    ["vsls.json"] = 512,
    ["vss-extension.json"] = 518,
    ["vtesttree.yaml"] = 519,
    ["vtestunit.yaml"] = 520,
    ["webhint.io"] = 637,
    ["webjobpublishsettings.json"] = 526,
    ["webjobs-list.json"] = 525,
    ["xs-app.json"] = 553,
    ["xunit.runner.json"] = 535,
    yamllint = 576,
    zuul = 562,
    ["Žinoma"] = 570
  },
