...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1102,
    [".nodehawkrc"] = 708,
    [".npmpackagejsonlintrc"] = 713,
    [".omletrc"] = 1283,
    [".phrase.yml"] = 795,
    [".phraseapp.yml"] = 796,
    [".pmbot.yml"] = 780,
    [".postcssrc"] = 789,
    [".powerpages-web-template-manifest"] = 791,
    [".pre-commit-config.yml"] = 792,
    [".pre-commit-hooks.yml"] = 793,
    [".putout.json"] = 829,
    [".rehyperc"] = 854,
    [".remarkrc"] = 858,
    [".sprite files"] = 960,
    ...
    AIConfig = 48,
    ["AMX Muse Program Descriptor"] = 1332,
    ["API Builder"] = 1138,
    ["AVA Configuration"] = 1202,
    ["AWS AppConfig Feature Flags-v1"] = 88,
    ["AWS CDK cdk.json"] = 319,
    ["AWS CloudFormation"] = 320,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 321,
    ["AWS Copilot Manifest"] = 1371,
    ["AWS SAM CLI Samconfig"] = 322,
    Acton = 1425,
    ["Adobe UXP Manifest"] = 1265,
    ["Aerleon Network & Service Definitions"] = 30,
    ["Aerleon Policy"] = 31,
    ["Agent Permission Policy"] = 1411,
    ["AgentCore CLI"] = 1412,
    ["AgentCtl MCP"] = 1414,
    ["AgentCtl config"] = 1413,
    ["AgentCtl permissions"] = 1415,
    AgentLoopKit = 1416,
    Aider = 1361,
    Air = 33,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1382,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1381,
    ["Airlock Microgateway"] = 49,
    ["Alacritty Configuration"] = 1174,
    ["AlgoVoi Compliance Receipt v1"] = 19,
    ["All Contributors configuration file"] = 1228,
    ["Amazon S3 bucket CORS"] = 21,
    Ameba = 1,
    Anodizer = 519,
    ["Ansible Argument Specs"] = 501,
    ["Ansible Collection Galaxy"] = 508,
    ["Ansible Execution Environment"] = 498,
    ["Ansible Inventory"] = 507,
    ["Ansible Meta"] = 499,
    ["Ansible Meta Runtime"] = 500,
    ["Ansible Navigator Configuration"] = 510,
    ["Ansible Playbook"] = 505,
    ["Ansible Requirements"] = 502,
    ["Ansible Rulebook"] = 506,
    ["Ansible Tasks File"] = 504,
    ["Ansible Vars File"] = 503,
    ["Ansible-lint Configuration"] = 509,
    Any = 1293,
    ...
    ["Application list for a WinUtil"] = 1311,
    ["ArchSmith diagram IR"] = 1454,
    ArchitectFX = 1316,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1380,
    ["Azure IoT Operations connector metadata"] = 1377,
    ...
    ["Azure Pipelines"] = 137,
    ["Azure Static Web Apps CLI configuration file"] = 964,
    ["Azure Static Web Apps configuration file"] = 963,
    BMML = 1399,
    ["BOSH BPM Config"] = 165,
    ["BOSH CPI Config"] = 166,
    ...
    Badness = 149,
    ["Barba-CV"] = 103,
    ["Bashly (bashly.yml)"] = 1232,
    ["Bashly Settings (bashly-settings.yml)"] = 1233,
    Bento = 1398,
    ["Better Code Hub"] = 1143,
    ["Better Scripts"] = 192,
    Bigconfig = 158,
    ["Biome Formatter Config"] = 104,
    ["Bitmovin Encoding Template"] = 1325,
    BizTalkServerApplicationSchema = 1109,
    Bleep = 193,
    ["Block Protocol Metadata"] = 190,
    ["Bluebricks blueprint config"] = 1404,
    ["Boyka Framework"] = 171,
    ...
    ["Butane Config"] = 1187,
    C4InterFlow = 1340,
    ["CDK Environment Manager, concrete environment configuration"] = 1364,
    ["CDK Environment Manager, concrete environments definition"] = 1363,
    ["CDK Environment Manager, environment definition"] = 1362,
    ["CGS Card Game Specification (cgs.json)"] = 1270,
    ["CICS TS region tagging"] = 1196,
    ["CICS TS resource import"] = 1197,
    ["CICS TS resource model"] = 1198,
    ["CICS TS resource overrides"] = 1199,
    ["CMake Presets"] = 194,
    ["CNC Codes"] = 218,
    ["CRS WAF test file"] = 1300,
    ["CRS WAF test platform overrides file"] = 1301,
    ["CSS Comb (.csscomb.json)"] = 349,
    ["CSS Lint (.csslintrc)"] = 350,
    ["CSpell (cspell.json)"] = 348,
    ...
    ["Caido Proxy Configuration"] = 1440,
    ...
    ["Chamaleon environment"] = 1329,
    ["Chamaleon properties"] = 1330,
    ["Chamaleon template"] = 1328,
    Changepacks = 1391,
    Changesets = 331,
    Changie = 203,
    Charmcraft = 204,
    ...
    ["Common Catalog Data"] = 310,
    ["Common Package Specification"] = 222,
    Concord = 1299,
    ["Configu .cfgu files"] = 1287,
    ["Configu .configu file"] = 1288,
    Conjure = 217,
    ["Container Structure Test"] = 1123,
    Containerlab = 1152,
    ["Context Passport"] = 2,
    ["Context Reasoning Format (CRF)"] = 215,
    ["Contextive Glossary"] = 1356,
    ContractGuard = 1153,
    Convex = 216,
    ["Crowdsec collection config"] = 342,
    ["Crowdsec parser config"] = 343,
    ["Crowdsec scenario config"] = 344,
    ["CumulusCI Config"] = 223,
    ["Cursor Agent Environment"] = 1409,
    ["Custom Machinery Machine"] = 1271,
    ["Custom Machinery Recipe"] = 1272,
    ["Cycle Stack File"] = 241,
    CycloneDX = 242,
    ["DWP Exchange - catalogue entry"] = 399,
    ["DWP Exchange - gateway"] = 397,
    ["DWP Exchange - meta"] = 398,
    ["Dagger module"] = 351,
    ["Dark Factory consumer config"] = 243,
    ["Dart Build Config (dart-build.json)"] = 352,
    ["Dart Test Config (dart-test.json)"] = 353,
    ["DashLord Configuration"] = 354,
    ["Data Contract Specification"] = 355,
    ["Data Product Specification"] = 356,
    ["DataYoga Connections"] = 244,
    ["DataYoga Job"] = 245,
    ["Datadog Continuous Testing"] = 608,
    ["Datadog Service Definition"] = 609,
    ["Datadog Software Catalog"] = 610,
    ["Datahub Ingestion Recipe"] = 1203,
    ["Debian Upstream Metadata file"] = 252,
    DebtLens = 253,
    ["Decision Reasoning Format (DRF)"] = 254,
    ["Deck config"] = 255,
    ["Declarative Automation Bundles"] = 1249,
    ["DeepMatch deeplinks spec"] = 256,
    ["Defakto CI"] = 1461,
    ["Dein Config"] = 257,
    ["Deno Config (deno.json)"] = 365,
    ["Dependency cruiser"] = 258,
    ["DeployStack Configuration"] = 259,
    ["Deployah Configuration"] = 1379,
    ["Deployer Recipe"] = 368,
    ["Design Tokens Community Group format"] = 260,
    ["Design Tokens Community Group resolver"] = 261,
    ["Deta Spacefile"] = 262,
    ["Detekt Config (detekt.yml)"] = 369,
    ["Devbox Config"] = 263,
    ["Devbox Plugin"] = 264,
    Devfile = 396,
    Devup = 1392,
    DipDup = 1302,
    ["Discord Webhook"] = 370,
    ["DocFx Config (docfx.json)"] = 375,
    ["Docker Desktop extension metadata"] = 372,
    ["Docs MCP Manifest"] = 376,
    Dofigen = 377,
    ["Dolittle Artifacts"] = 378,
    ["Dolittle Bounded Context Configuration"] = 379,
    ["Dolittle Event Horizons Configuration"] = 380,
    ["Dolittle Resources Configuration"] = 381,
    ["Dolittle Server Configuration"] = 382,
    ["Dolittle Tenant Map Configuration"] = 384,
    ["Dolittle Tenants Configuration"] = 383,
    ["Dolittle Topology"] = 385,
    ["DonateCaseBetterCasino menu"] = 1333,
    ["Draugr Saga"] = 363,
    ["Draugr Saga fragment"] = 364,
    ...
    ["Drupal Routing"] = 277,
    ["Drupal Services"] = 279,
    ["Drush site aliases"] = 391,
    ["Dust configuration"] = 394,
    ["Dynamic Bash Aliases (.aliases)"] = 1240,
    ["EAS config"] = 438,
    ["ECA - Editor Code Assistant"] = 401,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1229,
    ["ESLint Suppressions"] = 443,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1376,
    ["EasyVCR .NET"] = 440,
    ["Eidolon Resource"] = 1317,
    ["Elgato Stream Deck"] = 404,
    Elm = 1304,
    ["Embrace Config"] = 1215,
    Emmet = 1305,
    Endurica = 1253,
    ["Enonic XP API descriptor"] = 407,
    ["Enonic XP Admin Extension descriptor"] = 408,
    ["Enonic XP Admin Tool descriptor"] = 409,
    ["Enonic XP Application descriptor"] = 410,
    ["Enonic XP CMS descriptor"] = 411,
    ["Enonic XP Content Type descriptor"] = 412,
    ["Enonic XP Form Fragment descriptor"] = 413,
    ["Enonic XP ID Provider descriptor"] = 414,
    ["Enonic XP Layout descriptor"] = 415,
    ["Enonic XP Macro descriptor"] = 416,
    ["Enonic XP Mixin descriptor"] = 417,
    ["Enonic XP Page descriptor"] = 418,
    ["Enonic XP Part descriptor"] = 419,
    ["Enonic XP Service descriptor"] = 420,
    ["Enonic XP Site descriptor"] = 421,
    ["Enonic XP Style descriptor"] = 422,
    ["Enonic XP Task descriptor"] = 423,
    ["Enonic XP Webapp descriptor"] = 424,
    ["Enterprise Contract Policy Spec"] = 405,
    ["Envelope Team Definition"] = 1424,
    ["Envilder Map File"] = 406,
    ["Erda Pipeline"] = 1278,
    ["Erda Runtime"] = 1279,
    ["Espanso config.yml"] = 1402,
    ["Espanso match.yml"] = 1401,
    Esquio = 426,
    ["Estuary Flow Catalog"] = 1193,
    ["Ethereum ERC1155"] = 1418,
    ["Ethereum ERC721"] = 1417,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 431,
    ["EveryVoice TTS Toolkit Data Configuration"] = 432,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 436,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 435,
    ["EveryVoice TTS Toolkit Text Configuration"] = 433,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 434,
    ["Evolving Resolutive Process notation"] = 1378,
    ["Expo SDK"] = 437,
    ["Expoot app config"] = 439,
    ["F-Droid Data metadata"] = 445,
    ["FasterCI Configuration"] = 138,
    Fatou = 139,
    ["Fence configuration"] = 140,
    FiQuS = 449,
    Firebase = 447,
    ["Flatpak Builder Manifest"] = 450,
    ["FlexGet Config"] = 451,
    ["Flow.json Configurations"] = 1275,
    ["Fossa configuration file"] = 458,
    ["Fossa's fossa-deps file"] = 459,
    ["Foundry VTT - Base package Manifest"] = 453,
    ["Foundry VTT - Module Manifest"] = 454,
    ["Foundry VTT - System Data Template"] = 457,
    ["Foundry VTT - System Manifest"] = 455,
    ["Foundry VTT - World Manifest"] = 456,
    ["Foxx Manifest"] = 141,
    ["Freifunk.de Community API"] = 144,
    ["Frogbot Config"] = 145,
    ["G2P Mapping Configuration"] = 466,
    GAMA = 467,
    ["GCP Blueprint Metadata"] = 470,
    Gaspar = 468,
    ["GatewayCore API Gateway"] = 469,
    ["Gemini CLI settings"] = 471,
    ["GeoJSON.json latest"] = 1191,
    GherKing = 1195,
    ["GitHub Action"] = 481,
    ["GitHub Actions typing"] = 1313,
    ["GitHub CLI configuration"] = 482,
    ["GitHub CLI hosts"] = 483,
    ["GitHub Discussion"] = 484,
    ["GitHub Funding"] = 486,
    ["GitHub Issue Template configuration"] = 487,
    ["GitHub Issue Template forms"] = 488,
    ["GitHub Pages Jekyll"] = 489,
    ["GitHub Prompt"] = 485,
    ["GitHub Secret Scanning"] = 490,
    ["GitHub Workflow"] = 491,
    ["GitHub Workflow Template Properties"] = 492,
    ["GitHub automatically generated release notes configuration"] = 493,
    ["GitLab Agent for Kubernetes configuration"] = 1267,
    ["GitLab Duo Workflow"] = 495,
    GitResume = 497,
    GitVersion = 474,
    ["Gitea Issue Template configuration"] = 477,
    ["Gitea Issue Template forms"] = 478,
    Gitleaks = 475,
    ["Gitpod Configuration"] = 496,
    ["Glamour style"] = 472,
    ["GlazeWM settings"] = 1269,
    ["Global Privacy Control"] = 473,
    Goblet = 1248,
    ["Golangci-lint Configuration"] = 512,
    ["Golangci-lint Custom Plugins Configuration"] = 513,
    ["Google Chrome Related Website Sets"] = 448,
    ["Google Cloud Workflows"] = 318,
    ["Google Digital Assetlinks"] = 1357,
    Goreleaser = 517,
    ["Goreleaser Pro"] = 518,
    Goss = 520,
    ["Gradle Build Cache Node"] = 1141,
    ["Gradle Enterprise"] = 1140,
    ["Grafana 5.x Dashboard"] = 521,
    ["GraphQL Code Generator"] = 526,
    ["GraphQL Config"] = 525,
    ["GraphQL Mesh"] = 524,
    ["GroovyLint configuration"] = 527,
    ["Grunt JSHint task"] = 531,
    ["Grunt Watch task"] = 532,
    ["Grunt base task"] = 533,
    ["Grunt clean task"] = 529,
    ["Grunt copy task"] = 528,
    ["Grunt cssmin task"] = 530,
    HEMTT = 1105,
    ["HULL - Helm Uniform Layer Library"] = 1458,
    Hadolint = 1119,
    Hammerkit = 1151,
    ["Hardware Sentry Configuration"] = 1207,
    ["Hashgraph Online Skill Manifest"] = 9,
    ["HashiCorp Vault"] = 534,
    Hatch = 1120,
    Hayson = 536,
    ["Haystack Pipeline"] = 537,
    ["Hazelcast 5 Configuration"] = 538,
    ["Hecate Input Schema"] = 1368,
    ["Helm Chart.lock"] = 281,
    ["Helm Chart.yaml"] = 280,
    ["Helm Unittest Test Suite"] = 282,
    ["Heloisa Assistant Plugins Marketplace"] = 1451,
    ["Hex file"] = 283,
    ["Home Assistant Integration Manifest"] = 540,
    ["Homer dashboard configuration"] = 541,
    ["Hoverfly Simulation"] = 546,
    Hugo = 1183,
    ["Hugo Theme"] = 1182,
    ["Hulak Configuration"] = 549,
    ["Hyperfoil benchmark configuration"] = 548,
    ["IBM Zapp document"] = 550,
    ["IBM zCodeFormatSettings"] = 551,
    ["IMG Catapult PSP"] = 556,
    ["IVMS101 by CODE Protocol"] = 1268,
    ["Infinispan Configuration"] = 558,
    ["Infinispan Server Configuration"] = 559,
    Infrahub = 560,
    Istanbul = 1211,
    ["JDownloader2 crawler multi-rules"] = 574,
    ["JDownloader2 crawler single-rules"] = 573,
    ["JFrog Applications Config"] = 575,
    ["JFrog File Spec"] = 576,
    ["JFrog Pipelines YML DSL"] = 1217,
    ["JMeter DSL cli config"] = 577,
    JReleaser = 580,
    ["JSON Document Transform"] = 588,
    ["JSON Feed"] = 589,
    ["JSON Resume"] = 867,
    ["JSON Schema Draft 2020-12"] = 1085,
    ["JSON Schema Draft 4"] = 1082,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1250,
    ["JSON Schema Draft 7"] = 1083,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1251,
    ["JSON Schema Draft 8 (2019-09)"] = 1084,
    ["JSON-API"] = 587,
    ["JSON-e templates"] = 1148,
    ["JSON-stat 2.0"] = 1078,
    JSONPatch = 591,
    ["JSR Package Config (jsr.json)"] = 581,
    Jarl = 1384,
    Jasmine = 568,
    Jekyll = 569,
    ["Jenkins X Pipelines"] = 570,
    ["Jenkins X Requirements"] = 571,
    Jest = 572,
    Jocker = 578,
    ["Jovo Language Models"] = 579,
    Jsontron = 592,
    ["Jujutsu (jj) VCS config"] = 1370,
    ["KIMMDY config file"] = 603,
    ["KODE/CI build.yaml"] = 1213,
    ["KSP-AVC"] = 1079,
    ["KSP-CKAN"] = 1080,
    ["KSP-NetKAN"] = 1081,
    KSY = 1280,
    KSail = 464,
    ["KYA Manifest"] = 1281,
    ["Karakum configuration file"] = 460,
    Kas = 595,
    ["Kestra flow file"] = 604,
    ["Keycloak REST API"] = 1220,
    ["Knative Functions - func.yaml"] = 461,
    Knip = 462,
    ["Knip JSONC"] = 463,
    ["Knowledge Unit"] = 612,
    ["Kometa (nightly) config file"] = 606,
    ["Kometa config file"] = 605,
    ["Kong DBLess config"] = 1214,
    KrakenD = 607,
    ["Kubri Configuration"] = 615,
    LOOBin = 634,
    ["Lake configuration file"] = 1373,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 323,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 324,
    ["Landing Zone Accelerator on AWS - Global Config"] = 325,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 326,
    ["Landing Zone Accelerator on AWS - Network Config"] = 327,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 328,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 329,
    ["Landing Zone Accelerator on AWS - Security Config"] = 330,
    ["Lando (landofile)"] = 130,
    ["LangGraph Platform configuration"] = 1292,
    ["Language configuration"] = 1291,
    Lefthook = 620,
    ["Liferay client-extension.yaml"] = 627,
    ["LinkML Metamodel"] = 629,
    ["LiquiLens Evidence Carrier Reference v1"] = 631,
    ["LiquiLens Evidence Carrier v1"] = 630,
    Liquibase = 1158,
    ["Liquibase Flow File"] = 1159,
    ["Lively Properties"] = 633,
    ["Lobe AI Agent"] = 132,
    Loki = 133,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 677,
    ["MS2Rescore Configuration"] = 685,
    ["MSTest testconfig.json"] = 686,
    ["Madge configuration"] = 640,
    ["Madness (madness.yml)"] = 1231,
    ["Mado configuration"] = 641,
    ["Maestro Flow"] = 642,
    ["Mail Servers Configuration"] = 1405,
    ["MapEHR Mapping"] = 643,
    Markdownlint = 1162,
    ["Mason Registry"] = 1165,
    ["MegaLinter Custom Flavor"] = 646,
    ["MegaLinter configuration"] = 645,
    ["MegaLinter descriptor"] = 647,
    Melange = 1258,
    ["Meltano project definition"] = 648,
    ["Mergify Configuration"] = 687,
    ["Mermaid config"] = 4,
    ["Metadata for a Bazel module"] = 649,
    ["Metadata for a Cinnamon spice"] = 1309,
    ["Metatype Configuration"] = 650,
    ["MetricsHub Configuration"] = 651,
    ["MetricsHub Connector Configuration"] = 652,
    ["Micro Editor Syntax"] = 1241,
    ["Microsoft Band Web Tile"] = 653,
    ["Microsoft RulesEngine workflow rules"] = 1296,
    ["Microsoft RulesEngine workflow rules list"] = 1297,
    ["Minecraft Custom Main Menu Mod"] = 1259,
    ["Minecraft Data Pack Advancement"] = 655,
    ["Minecraft Data Pack Biome"] = 656,
    ["Minecraft Data Pack Configured Carver"] = 657,
    ["Minecraft Data Pack Damage Type"] = 658,
    ["Minecraft Data Pack Dimension"] = 660,
    ["Minecraft Data Pack Dimension Type"] = 659,
    ["Minecraft Data Pack Item Modifier"] = 661,
    ["Minecraft Data Pack Loot Table"] = 662,
    ["Minecraft Data Pack Metadata"] = 663,
    ["Minecraft Data Pack Predicate"] = 664,
    ["Minecraft Data Pack Recipe"] = 665,
    ["Minecraft Data Pack Tag"] = 666,
    ["Minecraft Data Pack Template Pool"] = 667,
    ["Minecraft Data Pack Trim Material"] = 672,
    ["Minecraft Data Pack Trim Pattern"] = 673,
    ["Minecraft Resource Pack Lang"] = 668,
    ["Minecraft Resource Pack Particle"] = 669,
    ["Minecraft Resource Pack Texture Mcmeta"] = 671,
    ["Minecraft Resourcepack Sounds"] = 670,
    ["MockServer Expectation"] = 679,
    ["MockServer Expectations"] = 680,
    ModuleAssembler = 675,
    ["Monade CLI Stack Configuration"] = 690,
    ["MongoDB Atlas Search Index Definition"] = 1212,
    ["Monika Configuration"] = 1210,
    ["Monoweave Configuration"] = 684,
    ["Motif config"] = 1101,
    MultiQC = 1350,
    ["NOX Framework (Service)"] = 712,
    ["Netin Diagnostic System Template"] = 1169,
    ["Netlify config"] = 693,
    ["Network-as-Code Data Model"] = 694,
    ["Next Gen UI Agent A2A Server Configuration"] = 695,
    ["Next Gen UI Agent Configuration"] = 697,
    ["Next Gen UI Agent MCP Server Configuration"] = 696,
    ["Nightwatch.js"] = 704,
    ["Nika workflow"] = 709,
    ["Node.js configuration"] = 1106,
    ["NueJS configuration file"] = 717,
    ["Nuitka Package Config"] = 1273,
    ["Nullstone config"] = 719,
    ["ODGS Data Rules"] = 726,
    ["ODGS Ontology Graph"] = 727,
    ["ODGS Standard Metrics"] = 725,
    ["OKF Graph"] = 1452,
    ["ONe's changelog entry"] = 741,
    ["ONe's service descriptor"] = 740,
    ["ORT Server repository environment configuration"] = 752,
    ["OSCAL Assessment Plan (AP)"] = 754,
    ["OSCAL Assessment Results (AR)"] = 755,
    ["OSCAL Catalog"] = 756,
    ["OSCAL Component Definition (CDef)"] = 757,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 758,
    ["OSCAL Profile"] = 759,
    ["OSCAL System Security Plan (SSP)"] = 760,
    ["OSS Review Toolkit configuration"] = 761,
    ["OSS Review Toolkit curation"] = 762,
    ["OSS Review Toolkit package configuration"] = 763,
    ["OSS Review Toolkit project package manager definition"] = 764,
    ["OSS Review Toolkit repository configuration"] = 765,
    ["OSS Review Toolkit resolutions"] = 766,
    ["October CMS columns"] = 723,
    ["October CMS fields"] = 724,
    ["Oh My Posh"] = 729,
    Okteto = 730,
    ["Ona Tasks and Services"] = 732,
    Opctl = 1104,
    ["Open Data Contract Standard (ODCS)"] = 745,
    ["Open Data Product Standard (ODPS)"] = 746,
    ["Open Know-How"] = 1355,
    ["Open Pentest Format"] = 747,
    OpenDecree = 1422,
    ["OpenDecree Configuration"] = 1423,
    ["OpenRewrite Resource"] = 743,
    OpenSRM = 748,
    OpenStatus = 1366,
    ["OpenTelemetry Declarative Configuration"] = 744,
    ["OpenUtau character yaml"] = 737,
    ["OpenUtau ustx"] = 738,
    ["OpenWeather Current Weather API"] = 1147,
    ["OpenWeather Road Risk API"] = 1146,
    ["Ory Hydra configuration"] = 547,
    ["Ory Keto configuration"] = 611,
    ["Ory Kratos configuration"] = 753,
    ["Ory Oathkeeper configuration"] = 721,
    ["Outblocks App configuration"] = 750,
    ["Outblocks database table"] = 751,
    ["Outblocks project configuration"] = 749,
    PDM = 774,
    POPxf = 786,
    ["POPxf Correlations"] = 787,
    ["PRML manifest"] = 794,
    Packer = 770,
    PactSpec = 771,
    Panache = 772,
    Pantsbuild = 1227,
    ["Paper paper-plugin.yml"] = 773,
    ["Pipeline component"] = 1160,
    ["Platform.sh application"] = 15,
    ["Platform.sh routes"] = 16,
    ["Platform.sh services"] = 17,
    ["Plex Prerolls"] = 784,
    ["PocketMine plugin.yml"] = 781,
    ["Podman Desktop Extension"] = 1442,
    ["Postman collection"] = 790,
    ["Power Pages Configuration"] = 1367,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1312,
    ["ProActions AI-Kit Configuration"] = 802,
    ["ProActions AI-Kit Configuration for Menus"] = 804,
    ["ProActions AI-Kit Configuration for Sections"] = 806,
    ["ProActions AI-Kit Configuration for Services"] = 803,
    ["ProActions AI-Kit Configuration for Steps"] = 807,
    ["ProActions AI-Kit Configuration for Templates"] = 805,
    ["Problem object RFC9457"] = 1256,
    ["Problem package format"] = 808,
    ["Problem package generators"] = 809,
    ["Problem package submissions"] = 810,
    ["Problem package test group metadata"] = 811,
    ["Production delivery manifest"] = 1460,
    Pterodactyl = 1206,
    ["Pull Request Labeler"] = 828,
    Pulumi = 836,
    ["PyGTA Config"] = 832,
    PyProject = 837,
    Pylock = 1358,
    Pyright = 838,
    ["Python script metadata"] = 1352,
    ["QType AI DSL"] = 841,
    Qgoda = 840,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1434,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1432,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1438,
    ["Qlik Talend Cloud Pipeline - Project"] = 1430,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1433,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1435,
    ["Qlik Talend Cloud Pipeline - Task"] = 1431,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1437,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1436,
    Qodana = 1179,
    ["Qt Creator workspace file"] = 1289,
    ["Quali Torque Blueprint Spec 2"] = 1204,
    ["QueryFirst config file"] = 1223,
    ["QuikRun Configuration"] = 1439,
    ["Qwen Code Settings"] = 1419,
    ["RKE Cluster Configuration JSON"] = 1157,
    ["RKE Cluster Configuration YAML"] = 1156,
    RadioHound = 831,
    ["Raid Profile"] = 1420,
    ["Raid Repo Configuration"] = 1421,
    Railpack = 843,
    Railway = 842,
    ["Rancher Fleet"] = 833,
    ["Rattler-build"] = 844,
    Ray = 1118,
    ["Read the Docs"] = 835,
    ["Red-DiscordBot Cog"] = 851,
    ["Red-DiscordBot Cog Repo"] = 852,
    ["Red-DiscordBot Trivia"] = 853,
    ["Releasaurus Config"] = 12,
    ReleaseKit = 11,
    ["Render Blueprints"] = 1155,
    RenderCV = 871,
    Renovate = 868,
    ["Renovate global configuration"] = 869,
    ["Renovate inherited configuration"] = 870,
    ["Replit config"] = 859,
    Restate = 1345,
    ["Revel Digital Gadget Definition File"] = 1369,
    RoadRunner = 873,
    ["Robust Station Image"] = 1375,
    Rockcraft = 874,
    ["Roo Coder Custom Modes"] = 875,
    Rubocop = 864,
    ["Rudder techniques"] = 1263,
    Ruff = 865,
    ["Rust Project"] = 866,
    ["Rust toolchain"] = 880,
    ["SDMX data message"] = 907,
    ["SDMX metadata message"] = 906,
    ["SDMX structure message"] = 905,
    ["SIL Kit Participant Configuration"] = 918,
    ["SIL Kit Registry Configuration"] = 919,
    ["SPDX 2.3"] = 961,
    SWADL = 977,
    ["Safebox Config"] = 1218,
    ["Sapphire CLI Config"] = 883,
    ["SauceCTL Configuration"] = 1166,
    Scarb = 903,
    ["Schema Catalog"] = 898,
    ["Scoop manifest"] = 904,
    ["Secure SDLC Evidence Bundle"] = 908,
    ["Semantic Data Fabric (SDF) file"] = 909,
    ["Semgrep Rule"] = 911,
    ["Serenity Code Generator (Sergen)"] = 912,
    ["Serverless Framework Configuration"] = 1173,
    ["Serverless Workflow"] = 1175,
    ["Settings for a Cinnamon spice"] = 1308,
    ["Settings.paf"] = 914,
    ["Shopware 6 Configuration"] = 1176,
    ["Shopware CLI Extension Store Configuration"] = 1177,
    ["Shopware CLI Project Store Configuration"] = 1178,
    ["Sigma Detection Rule"] = 916,
    ["SigmaCV CV"] = 7,
    ["Sigrid scope configuration file"] = 917,
    ["SkyPilot Task JSON"] = 1264,
    ["Slack app manifest"] = 924,
    ["Slang Server Configuration"] = 1446,
    Snapcraft = 926,
    ["Solarxy project config"] = 929,
    Solidarity = 930,
    ["Solution filters"] = 931,
    ["Source Maps v3"] = 932,
    Sourcery = 933,
    ["Spack bootstrap.yaml"] = 934,
    ["Spack cdash.yaml"] = 935,
    ["Spack ci.yaml"] = 936,
    ["Spack compilers.yaml"] = 937,
    ["Spack concretizer.yaml"] = 938,
    ["Spack config.yaml"] = 939,
    ["Spack definitions.yaml"] = 940,
    ["Spack develop.yaml"] = 941,
    ["Spack env_vars.yaml"] = 942,
    ["Spack environment"] = 948,
    ["Spack include.yaml"] = 943,
    ["Spack mirrors.yaml"] = 944,
    ["Spack modules.yaml"] = 945,
    ["Spack packages.yaml"] = 946,
    ["Spack repos.yaml"] = 947,
    ["Spack toolchains.yaml"] = 949,
    ["Spack upstreams.yaml"] = 950,
    ["Spack view.yaml"] = 951,
    ["Speakeasy Generation Config File"] = 955,
    ["Speakeasy Lint Configuration File"] = 952,
    ["Speakeasy Test Generation Configuration File"] = 953,
    ["Speakeasy Workflow File"] = 954,
    SpecIF = 956,
    ["Specmatic Configuration"] = 957,
    ["Specpin spec file"] = 5,
    ["Sponge Mixin configuration"] = 958,
    ["Spotlight Ruleset"] = 959,
    StackBlitz = 965,
    ["StackHawk Scanner Configuration"] = 1172,
    Stale = 966,
    Starfish = 967,
    ["Starlake Data Pipeline"] = 1144,
    Starship = 968,
    ["Statamic Blueprint"] = 969,
    ["Stella configuration file"] = 970,
    ["Streamlit configuration file"] = 971,
    ["Stryker Mutator"] = 974,
    ["StyleCop Analyzers Configuration"] = 975,
    ["Stylelint (.stylelintrc)"] = 976,
    ["Stylua Config"] = 1359,
    ["Sublime Syntax"] = 1219,
    ["Subsquid squid manifest"] = 1266,
    ["Swagger API 2.0"] = 978,
    ["Symfony Routing Configuration"] = 979,
    ["Symfony Serializer Mapping"] = 980,
    ["Symfony Services Configuration"] = 981,
    ["Symfony Validation Mapping"] = 982,
    ["Synadia Connect Component"] = 983,
    TSON = 1026,
    TSTyche = 1027,
    ["TYPO3 Vendor Bundler config"] = 1033,
    ["Tab data for a LinUtil"] = 1315,
    ["Tab list for a LinUtil"] = 1314,
    Tach = 984,
    ["Tach Domain"] = 985,
    Talhelper = 987,
    ["Talisman configuration"] = 988,
    Taplo = 1360,
    ["Taskfile config"] = 1149,
    Taurus = 989,
    Tauticord = 990,
    ["Tekton Pipeline"] = 1388,
    ["Tekton PipelineRun"] = 1389,
    ["Tekton Task"] = 1386,
    ["Tekton TaskRun"] = 1387,
    Telefonistka = 1346,
    ["Terraform PowerShell provider block manifest"] = 993,
    ["Terraform PowerShell provider data source manifest"] = 994,
    ["Terraform PowerShell provider resource manifest"] = 995,
    ["Terraform PowerShell provider settings"] = 996,
    ["Terrateam config"] = 1372,
    ["Tesseract configuration"] = 997,
    ["TestEnvironment.json"] = 1007,
    ["TextMate Grammar"] = 1006,
    Threagile = 1001,
    ["Tier.run pricing.json"] = 998,
    Tikibase = 999,
    Tombi = 1004,
    ["Traefik v2"] = 1010,
    ["Traefik v2 File Provider"] = 1011,
    ["Traefik v3"] = 1012,
    ["Traefik v3 File Provider"] = 1013,
    ["Travis CI (.travis.yml)"] = 1009,
    Treefmt = 523,
    Trident = 1342,
    Trivy = 1016,
    ["TrueScript for *.tscript files"] = 1017,
    ["Tugboat QA config.yml"] = 1339,
    TunnelHub = 1254,
    Turborepo = 1008,
    Tycho = 1303,
    Tye = 1180,
    ["Tyk Gateway - Open Source v5.7+"] = 1351,
    ["UET BuildConfig.json"] = 1224,
    ["UI5 Manifest"] = 1039,
    ["UNCORS configuration"] = 1044,
    ["UTAM Page Object"] = 1042,
    ["Ubuntu Server Autoinstall"] = 1037,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1343,
    ["Uniswap Token List"] = 1129,
    ["Universal Schedule Format"] = 1045,
    ["Unreal Engine Uplugin"] = 1225,
    ["Unreal Engine Uproject"] = 1226,
    ["UpCloud CLI (upctl) configuration"] = 1344,
    ["Updatecli Compose"] = 1188,
    ["Updatecli Policy Manifest"] = 1189,
    ["Updatecli Policy Metadata"] = 1190,
    Uplift = 1222,
    ["Upsun config"] = 14,
    ["User Journey Map"] = 1154,
    V2Ray = 1194,
    ["VSCode Code Snippets"] = 306,
    ["VSIX CLI publishing"] = 1065,
    Vector = 1047,
    ["Vee JSON menu output"] = 1048,
    ["Vela Pipeline Configuration"] = 1051,
    Vercel = 305,
    ["Version Bumper config"] = 1054,
    Vespertide = 1393,
    ["Vespertide Migration"] = 1394,
    ["Vespertide Model"] = 1395,
    ["Viash Component Config"] = 1348,
    ["Viash Package Config"] = 1349,
    Visivo = 1252,
    Vogi = 1059,
    ["WP-CLI"] = 1075,
    Wake = 1341,
    ["Waku Config"] = 1318,
    ["Web App Manifest"] = 1071,
    ["Web types"] = 1074,
    WebExtensions = 1070,
    ["Webman package recipe"] = 1200,
    ["Windows Package Manager Installer Manifest"] = 1126,
    ["Windows Package Manager Locale Manifest"] = 1127,
    ["Windows Package Manager Singleton Manifest"] = 1125,
    ["WireMock CLI import configuration"] = 1324,
    ["WireMock CLI local service configuration"] = 1323,
    ["WireMock message stub mapping"] = 1322,
    ["WireMock stub mapping"] = 1321,
    ["Woodpecker pipeline config"] = 1168,
    ["Wrangler CLI"] = 1076,
    ["XenForo add-on manifest"] = 1077,
    ["Xstate Machine"] = 1186,
    ["Yandex Workflow Language"] = 1310,
    ["Yarn Config (.yarnrc.yml)"] = 1142,
    ["Yippee-Ki-JSON configuration YML"] = 1133,
    ["YouTrack App"] = 1307,
    ["Zarf Package Configuration"] = 1374,
    ["Zerops import file"] = 1295,
    ["Zola Configuration"] = 1385,
    abtop = 35,
    act3 = 1426,
    actionlint = 45,
    ["aerleon.yml"] = 29,
    ["amplify.yml"] = 22,
    ["amxx-builder manifest"] = 1441,
    ["angular.json"] = 50,
    apko = 1257,
    ...
    ["behat.yml"] = 172,
    ["bigquery-table"] = 157,
    ["bioimageio resource description"] = 1274,
    ...
    ["cargo-nextest repository configuration"] = 698,
    ["cargo-nextest user configuration"] = 699,
    ["ccmod.json"] = 1319,
    ["cfgd Config"] = 1447,
    ["cfgd ConfigSource"] = 1450,
    ["cfgd Module"] = 1448,
    ["cfgd Profile"] = 1449,
    changelogging = 1286,
    ["chezmoi configuration"] = 205,
    ["chisel-slices.json"] = 332,
    ["chrome-extension-locales-messages.json"] = 313,
    ["chutzpah.json"] = 314,
    cibuildwheel = 210,
    ["clang-format (.clang-format)"] = 1192,
    ["clang-tidy"] = 289,
    clangd = 288,
    clib = 290,
    ["cloud-init: cloud-config userdata"] = 292,
    ["cloud-sdk-pipeline-configuration"] = 316,
    ["cloudbuild.json"] = 317,
    cloudify = 291,
    cmakefmt = 229,
    ["cmdx.yaml"] = 116,
    ...
    ["commands.json"] = 309,
    ["commit-check"] = 335,
    ["commitlint (.commitlintrc)"] = 1128,
    ["committed.toml"] = 336,
    ["compile_commands.json"] = 308,
    ["compilerconfig.json"] = 307,
    ["completely.yml"] = 1230,
    ["component-detection-manifest.json"] = 339,
    ["component.json"] = 338,
    ["composer.json"] = 337,
    ["conda-forge"] = 214,
    ["config.yaml"] = 834,
    ["contentmanifest.json"] = 315,
    ["contribute.json"] = 340,
    ["cosmos.config.json"] = 311,
    ["crowdin.yml"] = 341,
    crucible = 345,
    ["ctfd-setup configuration file"] = 1331,
    ["custom-elements.json"] = 1244,
    ["cypress.json"] = 346,
    ["dacier.yml"] = 1429,
    ["datalogic-scan2deploy-android"] = 357,
    ["datalogic-scan2deploy-ce"] = 358,
    datavzrd = 359,
    ...
    ["ddev-global"] = 360,
    ["ddev-project"] = 361,
    ["debugsettings.json"] = 362,
    ["dependabot-v2.json"] = 367,
    ["dependabot.json"] = 366,
    ["deployed-cli"] = 1185,
    devconcurrent = 265,
    ...
    djlint = 1136,
    ["docker bake"] = 373,
    ["docker sequencer"] = 374,
    ["docker-compose.yml"] = 1134,
    ["dockerd.json"] = 371,
    ["dotnet Release Index manifest"] = 386,
    ["dotnet-tools.json"] = 387,
    ["dotnetcli.host.json"] = 388,
    ["dprint.json"] = 389,
    ["drone.json"] = 390,
    ["dss-2.0.0.json"] = 392,
    ["dstack configuration"] = 393,
    ["dtool dataset metadata"] = 1326,
    ["dvc.yaml"] = 395,
    ["ecosystem.json"] = 400,
    ["editorconfig-checker"] = 402,
    eksctl = 403,
    ["electron-builder configuration file"] = 429,
    ["epr-manifest.json"] = 428,
    ["estampo.toml"] = 427,
    ["evcc.yaml"] = 430,
    ["ezd task runner"] = 441,
    ["fabric.mod.json"] = 444,
    ["first-timers-bot"] = 452,
    ["flagd flag configuration"] = 142,
    ["fly.io Configuration"] = 143,
    fulibWorkflows = 1167,
    ["function.json"] = 465,
    ["gRPC API Gateway & OpenAPI Config"] = 24,
    ["gematik health care insurance list"] = 1337,
    ["gematik health care patient list"] = 1334,
    ["gematik health care provider institution list"] = 1336,
    ["gematik health care provider list"] = 1335,
    ["gematik tiger test environment configuration"] = 1338,
    ["gh-dash"] = 479,
    ["gha-doctor"] = 480,
    ["git-cliff"] = 476,
    ["git-town.toml"] = 1383,
    ["github-settings-as-code"] = 860,
    ["gitlab-ci"] = 494,
    ["global.json"] = 511,
    ["glslint config"] = 3,
    ["go-feature-flag Flag Configuration"] = 515,
    ["gojo.yaml"] = 516,
    gollama = 514,
    ["hassette.toml"] = 539,
    ["haxelib.json"] = 535,
    ...
    ["ide.host.json"] = 552,
    ["ifstate.yaml"] = 553,
    ["imageoptimizer.json"] = 554,
    ["importmap.json"] = 557,
    ["index.toml (packwiz)"] = 1443,
    instant_python_config = 561,
    instant_python_custom_project = 562,
    intlayer = 563,
    ["ioBroker Configuration"] = 564,
    ["ioBroker JSON UI"] = 565,
    ["ioBroker Package manifest"] = 566,
    ["ixpect.conf.yaml"] = 567,
    ["ize.toml"] = 1221,
    ["jsconfig.json"] = 593,
    ["jscpd Configuration"] = 1205,
    jsdoc = 1117,
    ["k3d.yaml"] = 594,
    ["k9s aliases.yaml"] = 596,
    ["k9s cluster-config.yaml"] = 598,
    ["k9s config.yaml"] = 597,
    ["k9s hotkeys.yaml"] = 599,
    ["k9s plugins.yaml"] = 600,
    ["k9s skin.yaml"] = 601,
    ["k9s views.yaml"] = 602,
    ["kind cluster"] = 616,
    ["kontinuous-config.yaml"] = 614,
    ["kontinuous-values.yaml"] = 613,
    ["kustomization.yaml"] = 617,
    ["label-commenter-config.yml"] = 618,
    ["latexindent configuration"] = 131,
    ["launchsettings.json"] = 619,
    lazydocker = 1243,
    lazygit = 1242,
    ["lego.json"] = 621,
    ["lerna.json"] = 622,
    ["lgtm.yml"] = 623,
    ["liblab.config.json"] = 624,
    ["libman.json"] = 625,
    ["license-report-config.json"] = 626,
    ["linkinator.config.json"] = 628,
    ["lint-staged (.lintstagedrc)"] = 1094,
    ["litertlm_manifest.json"] = 632,
    ["local.settings.json"] = 636,
    ["localazy.json"] = 637,
    ["lotus.yaml"] = 635,
    ["lsd colors"] = 135,
    ["lsd config"] = 134,
    ...
    lychee = 1093,
    ["macro.json"] = 1209,
    ["markdown-link-check"] = 1163,
    maturin = 1164,
    mboats = 1171,
    memnex = 1427,
    ["micro-settings.json"] = 1236,
    ["mimetypes.json"] = 654,
    ["mirrord config"] = 1097,
    ["misata.yaml"] = 1096,
    mise = 1098,
    ["mkdocs.yml"] = 674,
    ["mockd.yaml"] = 678,
    ["mod.pw.toml (packwiz)"] = 1444,
    ["modelparams.dev Model"] = 681,
    ["models CLI"] = 682,
    ["monospace.yml"] = 683,
    ["moon.yml"] = 1320,
    ["mprocs Configuration file"] = 1290,
    ["mrdocs.yml"] = 676,
    ["mta.yaml"] = 1099,
    ["mtad.yaml"] = 1100,
    ["mycode.json"] = 691,
    nFPM = 703,
    ["napari plugin manifest"] = 692,
    neoload = 1112,
    ["nest-cli"] = 706,
    ["nexus-rpc-gen"] = 1410,
    ["nf-core module environment.yml"] = 700,
    ["nf-core module meta.yml"] = 701,
    ["nf-core subworkflow meta.yml"] = 702,
    ["ninjs (News in JSON)"] = 705,
    ["nitro.json"] = 1111,
    ["nixd configuration"] = 1262,
    ["nlu.json"] = 707,
    ["nodemon.json"] = 710,
    ["noodl config"] = 1170,
    ["notebook.mod.json"] = 711,
    now = 1107,
    ["npm-badges"] = 714,
    ["nswag.json"] = 718,
    ntangle = 720,
    ["nuclei-template.yaml"] = 715,
    ["nuget-project.json"] = 716,
    ["ocelot.json"] = 722,
    ogen = 728,
    ["omnisharp.json"] = 731,
    openHAB = 1396,
    ...
    oxfmt = 1406,
    oxlint = 1407,
    ["pack.toml (packwiz)"] = 1445,
    ["package.json"] = 767,
    ["package.manifest"] = 769,
    ["package.yaml"] = 768,
    ["partial-black.json"] = 173,
    ["partial-fastapi.json"] = 174,
    ["partial-pixi.json"] = 779,
    ["partial-scheduled.json"] = 175,
    ["pattern.json"] = 777,
    ["petstore-v1.0"] = 1216,
    pgap_yaml_input_reader = 775,
    pgrls = 776,
    pgxgen = 1400,
    pitcms = 1403,
    ["pixi.toml"] = 778,
    ["plagiarize-me.yaml"] = 783,
    ["plagiarize.yaml"] = 782,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1327,
    ["podbard.yaml"] = 785,
    ["portman.json"] = 788,
    ["prefect.toml"] = 797,
    ["prefect.yaml"] = 798,
    ...
    ["prettierrc.json"] = 800,
    ["prisma.yml"] = 801,
    ["project-1.0.0-beta3.json"] = 813,
    ["project-1.0.0-beta4.json"] = 814,
    ["project-1.0.0-beta5.json"] = 815,
    ["project-1.0.0-beta6.json"] = 816,
    ["project-1.0.0-beta8.json"] = 817,
    ["project-1.0.0-rc1.json"] = 818,
    ["project-1.0.0-rc2.json"] = 819,
    ["project.json"] = 812,
    ["project.owasp.yaml"] = 820,
    ["prometheus-alertmanager.json"] = 824,
    ["prometheus.json"] = 821,
    ["prometheus.rules.json"] = 822,
    ["prometheus.rules.test.json"] = 823,
    ["proxies.json"] = 825,
    ["publiccode.yml"] = 826,
    ["pubspec.yaml"] = 827,
    ["pyrseas-0.8.json"] = 830,
    pytest = 839,
    ["quilt.mod.json"] = 1237,
    ["rc3 auth"] = 845,
    ["rc3 collection"] = 846,
    ...
    ["rc3 settings"] = 850,
    ["registry.yaml"] = 63,
    ["release drafter"] = 1113,
    ["release-hub.json"] = 10,
    ["release-please-config.json"] = 855,
    ["release-please-manifest.json"] = 856,
    ["release-plz.toml"] = 857,
    ["renv.lock"] = 872,
    ["reposets Configuration"] = 861,
    ["reposets Credentials"] = 862,
    ["revola.json"] = 8,
    ["rivet.json"] = 1261,
    ["rivet.yaml (legacy)"] = 1260,
    rumdl = 877,
    runny = 876,
    runspec = 1428,
    rustfmt = 878,
    ...
    samt = 881,
    samtrc = 882,
    ["sarif-1.0.0.json"] = 884,
    ["sarif-2.0.0.json"] = 885,
    ["sarif-2.1.0"] = 895,
    ["sarif-2.1.0-rtm.2"] = 886,
    ["sarif-2.1.0-rtm.3"] = 888,
    ["sarif-2.1.0-rtm.4"] = 890,
    ["sarif-2.1.0-rtm.5"] = 892,
    ["sarif-2.1.0-rtm.6"] = 893,
    ["sarif-external-property-file-2.1.0"] = 896,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 887,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 889,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 891,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 894,
    ["scalingo.json configuration"] = 897,
    ["schema.org - Action"] = 899,
    ["schema.org - ContactPoint"] = 900,
    ["schema.org - Place"] = 901,
    ["schema.org - Thing"] = 902,
    ["secrethub.yml"] = 1239,
    ["semantic-release"] = 910,
    servercn = 1456,
    ["servicehub.config.json"] = 1088,
    ["servicehub.service.json"] = 1087,
    ["settings.job"] = 913,
    ["sfdx-hardis configuration"] = 915,
    ["shard.yml"] = 1277,
    ["size-limit configuration"] = 920,
    ["skaffold.yaml"] = 1161,
    ["skill-map plugin extension manifest"] = 921,
    ["skill-map project settings"] = 922,
    ["skill-map provider kind"] = 923,
    ["skyuxconfig.json"] = 925,
    ["snowflake-config"] = 927,
    ["snowflake-connections"] = 928,
    ["spicepod.yaml"] = 1298,
    ["sqlc configuration"] = 962,
    ["stripe-app-local.json"] = 973,
    ["stripe-app.json"] = 972,
    swcrc = 1145,
    ["task.json"] = 986,
    taskcat = 1108,
    ["template.json"] = 991,
    ["templatsources.json"] = 992,
    ["text2confl config"] = 1408,
    ["theme.json"] = 1000,
    ["tizen_workspace.json"] = 1002,
    tldr = 1003,
    ["tm_devices configuration file"] = 1365,
    tmuxinator = 1091,
    tox = 1005,
    ["transcend.yml"] = 1014,
    ["tree-sitter grammar.json"] = 522,
    ["trime.yaml"] = 1015,
    ["trunk.yaml"] = 1018,
    ["ts-force-config.json"] = 1024,
    tsbuild = 1019,
    ["tsconfig.json"] = 1020,
    ["tsd.json"] = 1021,
    ["tsdoc.json"] = 1022,
    ...
    v8r = 1069,
    vcluster = 1284,
    ["vcpkg configuration file"] = 304,
    ["vcpkg manifest file"] = 303,
    ["vega-lite.json"] = 1050,
    ["vega.json"] = 1049,
    ["venvironment.yaml"] = 1052,
    ["venvplus.yaml"] = 1053,
    version = 1347,
    ["version.json"] = 1055,
    ["vhwdebugger-binding.yaml"] = 1057,
    ["vim-addon-info"] = 1058,
    ["vs-2017.3.host.json"] = 1061,
    ["vs-nesting.json"] = 1062,
    ["vsls.json"] = 1060,
    ["vss-extension.json"] = 1066,
    vtcfg = 1353,
    ["vtesttree.yaml"] = 1067,
    ["vtestunit.yaml"] = 1068,
    ["warp-keysets.json"] = 1245,
    ["warp-themes.json"] = 1246,
    ["warp-workflows.json"] = 1247,
    ["webhint.io"] = 1201,
    ["webjobpublishsettings.json"] = 1073,
    ["webjobs-list.json"] = 1072,
    ["well-known-fursona"] = 1285,
    ["xs-app.json"] = 1103,
    ["xunit.runner.json"] = 1086,
    ["yaml-workflow"] = 1455,
    yamlfmt = 1130,
    yamllint = 1131,
    ["yap.json"] = 1132,
