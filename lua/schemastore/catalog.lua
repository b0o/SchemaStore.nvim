...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 170,
    [".cryproj (generic)"] = 589,
    [".cryproj engine-5.2"] = 584,
    [".cryproj engine-5.3"] = 585,
    [".cryproj engine-5.4"] = 586,
    [".cryproj engine-5.5"] = 587,
    [".cryproj engine-dev"] = 588,
    [".csscomb.json"] = 172,
    [".csslintrc"] = 173,
    [".es6importsorterrc.json"] = 715,
    [".eslintrc"] = 222,
    [".esmrc.json"] = 214,
    [".ffizer.yaml"] = 226,
    [".htmlhintrc"] = 276,
    ...
    [".mtaext"] = 598,
    [".nodehawkrc"] = 374,
    [".npmpackagejsonlintrc"] = 377,
    [".phraseapp.yml"] = 418,
    [".pmbot.yml"] = 408,
    [".postcssrc"] = 413,
    [".powerpages-web-template-manifest"] = 415,
    [".pre-commit-config.yml"] = 416,
    [".pre-commit-hooks.yml"] = 417,
    [".putout.json"] = 437,
    [".rehyperc"] = 449,
    [".remarkrc"] = 450,
    [".sprite files"] = 503,
    ...
    ["<div>RIOTS' studio configuration"] = 568,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 335,
    ["API Builder"] = 629,
    ["AVA Configuration"] = 685,
    ["AWS CDK cdk.json"] = 154,
    ["AWS CloudFormation"] = 155,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 156,
    ["AWS SAM CLI Samconfig"] = 157,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 13,
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 660,
    ["All Contributors configuration file"] = 714,
    ...
    ["Azure Pipelines"] = 55,
    ["Azure Static Web Apps CLI configuration file"] = 506,
    ["Azure Static Web Apps configuration file"] = 505,
    ["BX CI"] = 91,
    ["Better Code Hub"] = 633,
    ["Better Scripts"] = 92,
    Bigconfig = 72,
    BizTalkServerApplicationSchema = 604,
    Bleep = 93,
    ["Block Protocol Metadata"] = 90,
    Briefcase = 609,
    ["Build Info"] = 83,
    Buildkite = 85,
    ["Bukkit plugin.yml"] = 84,
    ["BungeeCord plugin.yml"] = 88,
    ["Butane Config"] = 672,
    ["CICS TS region tagging"] = 679,
    ["CICS TS resource import"] = 680,
    ["CICS TS resource model"] = 681,
    ["CICS TS resource overrides"] = 682,
    ["CMake Presets"] = 94,
    ["CNC Codes"] = 103,
    ["Calqulus pipeline"] = 95,
    ["Camel YAML DSL"] = 96,
    Carafe = 97,
    ["Cargo Make"] = 99,
    ["Cargo Manifest"] = 98,
    ["Catalog Info Backstage"] = 100,
    Cheatsheets = 669,
    ["Chrome Extension"] = 147,
    ["CircleCI config.yml"] = 126,
    ["Citation File Format"] = 159,
    CityJSON = 101,
    ["Code Climate"] = 127,
    CodeCV = 54,
    ["CodeShip Pro services configuration files"] = 138,
    ["CodeShip Pro steps configuration files"] = 139,
    ["Codecov configuration files"] = 137,
    Codux = 135,
    ["Cog config file"] = 104,
    ["Commandbox Box.json"] = 105,
    ["Commandbox Server.json"] = 106,
    ["Common Catalog Data"] = 145,
    ["Common types for all schemas"] = 1,
    Conjure = 102,
    ["Container Structure Test"] = 616,
    Containerlab = 641,
    ["Crowdsec collection config"] = 166,
    ["Crowdsec parser config"] = 167,
    ["Crowdsec scenario config"] = 168,
    ["DWP Exchange - catalogue entry"] = 211,
    ["DWP Exchange - gateway"] = 209,
    ["DWP Exchange - meta"] = 210,
    ["Dart build configuration"] = 174,
    ["Dart test config"] = 175,
    ["DashLord configuration"] = 176,
    ["Data Contract Specification"] = 177,
    ["Databricks Asset Bundles"] = 735,
    ["Datadog Service Definition"] = 314,
    ["Datahub Ingestion Recipe"] = 686,
    ["Dein Config"] = 108,
    Deno = 183,
    ["Deployer Recipe"] = 186,
    ["Deta Spacefile"] = 109,
    Devfile = 208,
    ["Discord Webhook"] = 188,
    ["Dolittle Artifacts"] = 192,
    ["Dolittle Bounded Context Configuration"] = 193,
    ["Dolittle Event Horizons Configuration"] = 194,
    ["Dolittle Resources Configuration"] = 195,
    ["Dolittle Server Configuration"] = 196,
    ["Dolittle Tenant Map Configuration"] = 198,
    ["Dolittle Tenants Configuration"] = 197,
    ["Dolittle Topology"] = 199,
    ["Drupal Breakpoints"] = 110,
    ["Drupal Config"] = 121,
    ["Drupal Info"] = 111,
    ["Drupal Layouts"] = 112,
    ["Drupal Libraries"] = 113,
    ["Drupal Links Action"] = 114,
    ["Drupal Links Contextual"] = 115,
    ["Drupal Links Menu"] = 116,
    ["Drupal Links Task"] = 117,
    ["Drupal Migration"] = 118,
    ["Drupal Permissions"] = 119,
    ["Drupal Routing"] = 120,
    ["Drupal Services"] = 122,
    ["Drush site aliases"] = 204,
    ["Embrace Config"] = 697,
    ["Error pages"] = 217,
    Esquio = 215,
    ["Estuary Flow Catalog"] = 676,
    ["Expo SDK"] = 220,
    ["F-Droid Data metadata"] = 225,
    ["Facets - FSDL - Application"] = 223,
    ["FasterCI Configuration"] = 56,
    Firebase = 227,
    ["Fossa configuration file"] = 234,
    ["Fossa's fossa-deps file"] = 235,
    ["Foundry VTT - Base package Manifest"] = 229,
    ["Foundry VTT - Module Manifest"] = 230,
    ["Foundry VTT - System Data Template"] = 233,
    ["Foundry VTT - System Manifest"] = 231,
    ["Foundry VTT - World Manifest"] = 232,
    ["Foxx Manifest"] = 57,
    ["Freifunk.de Community API"] = 60,
    ["Frogbot Config"] = 61,
    ["G2P Mapping Configuration"] = 239,
    ["GCP Blueprint Metadata"] = 241,
    ["GatewayCore API Gateway"] = 240,
    ["GeoJSON.json latest"] = 674,
    GherKing = 678,
    ["GitHub Action"] = 245,
    ["GitHub Discussion"] = 246,
    ["GitHub Funding"] = 247,
    ["GitHub Issue Template configuration"] = 249,
    ["GitHub Workflow"] = 250,
    ["GitHub Workflow Template Properties"] = 251,
    ["GitHub issue forms"] = 248,
    GitVersion = 244,
    ["Gitpod Configuration"] = 253,
    ["Global Privacy Control"] = 242,
    Goblet = 734,
    ["Google Cloud Workflows"] = 153,
    Goreleaser = 257,
    ["Goreleaser Pro"] = 258,
    Goss = 259,
    ["Gradle Build Cache Node"] = 631,
    ["Gradle Enterprise"] = 630,
    ["Grafana 5.x Dashboard"] = 260,
    ["GraphQL Code Generator"] = 263,
    ["GraphQL Config"] = 262,
    ["GraphQL Mesh"] = 261,
    ["Grunt JSHint task"] = 267,
    ["Grunt Watch task"] = 268,
    ["Grunt base task"] = 269,
    ["Grunt clean task"] = 265,
    ["Grunt copy task"] = 264,
    ["Grunt cssmin task"] = 266,
    HEMTT = 601,
    Hadolint = 613,
    Hammerkit = 640,
    ["Hardware Sentry Configuration"] = 690,
    Hayson = 271,
    ["Haystack Pipeline"] = 272,
    ["Hazelcast 5 Configuration"] = 273,
    ["Helm Chart.lock"] = 124,
    ["Helm Chart.yaml"] = 123,
    ["Helm Unittest Test Suite"] = 125,
    Hugo = 668,
    ["IBM Zapp document"] = 278,
    ["IBM zCodeFormatSettings"] = 279,
    ["IMG Catapult PSP"] = 284,
    Istanbul = 693,
    ["JDownloader2 crawler multi-rules"] = 294,
    ["JDownloader2 crawler single-rules"] = 293,
    ["JFrog Applications Config"] = 295,
    ["JFrog File Spec"] = 296,
    ["JFrog Pipelines YML DSL"] = 699,
    ["JMeter DSL cli config"] = 297,
    JReleaser = 299,
    ["JSON Document Transform"] = 306,
    ["JSON Feed"] = 307,
    ["JSON Resume"] = 456,
    ["JSON Schema Draft 2020-12"] = 580,
    ["JSON Schema Draft 4"] = 577,
    ["JSON Schema Draft 7"] = 578,
    ["JSON Schema Draft 7 (unofficial strict)"] = 736,
    ["JSON Schema Draft 8 (2019-09)"] = 579,
    ["JSON-API"] = 305,
    ["JSON-e templates"] = 638,
    ["JSON-stat 2.0"] = 574,
    JSONPatch = 309,
    Jasmine = 289,
    Jekyll = 290,
    ["Jenkins X Pipelines"] = 291,
    ["Jenkins X Requirements"] = 292,
    ["Jovo Language Models"] = 298,
    ["KSP-AVC"] = 575,
    ["KSP-CKAN"] = 576,
    ["Karakum configuration file"] = 236,
    Kas = 312,
    ["Keycloak REST API"] = 706,
    ["Knative Functions - func.yaml"] = 237,
    ["KoDE/CI build.yaml"] = 695,
    ["Kong DBLess config"] = 696,
    KrakenD = 313,
    LOOBin = 330,
    Lefthook = 321,
    ["LinkML Metamodel"] = 328,
    Liquibase = 645,
    ["Liquibase Flow File"] = 646,
    ["Lively Properties"] = 329,
    ["MS2Rescore Configuration"] = 362,
    Markdownlint = 649,
    ["Mason Registry"] = 651,
    ["MegaLinter configuration"] = 336,
    ["MegaLinter descriptor"] = 337,
    ["Meltano plugin discovery definition"] = 339,
    ["Meltano project definition"] = 338,
    ["Microsoft Band Web Tile"] = 340,
    ["Minecraft Data Pack Advancement"] = 342,
    ["Minecraft Data Pack Biome"] = 343,
    ["Minecraft Data Pack Configured Carver"] = 344,
    ["Minecraft Data Pack Damage Type"] = 345,
    ["Minecraft Data Pack Dimension"] = 347,
    ["Minecraft Data Pack Dimension Type"] = 346,
    ["Minecraft Data Pack Item Modifier"] = 348,
    ["Minecraft Data Pack Loot Table"] = 349,
    ["Minecraft Data Pack Metadata"] = 350,
    ["Minecraft Data Pack Predicate"] = 351,
    ["Minecraft Data Pack Recipe"] = 352,
    ["Minecraft Data Pack Tag"] = 353,
    ["Minecraft Data Pack Template Pool"] = 354,
    ["Minecraft Data Pack Trim Material"] = 359,
    ["Minecraft Data Pack Trim Pattern"] = 360,
    ["Minecraft Resource Pack Lang"] = 355,
    ["Minecraft Resource Pack Particle"] = 356,
    ["Minecraft Resource Pack Texture Mcmeta"] = 358,
    ["Minecraft Resourcepack Sounds"] = 357,
    ["MkDocs Configuration 1.0"] = 361,
    ["MongoDB Atlas Search Index Definition"] = 694,
    ["Monika Configuration"] = 692,
    ["Motif config"] = 597,
    ["NOX Framework (Service)"] = 376,
    ["Netin Diagnostic System Template"] = 655,
    ["Netlify config"] = 367,
    ["Nexus-as-Code Data Model"] = 368,
    ["Nightwatch.js"] = 369,
    ["ONe's service descriptor"] = 389,
    ["OSS Review Toolkit configuration"] = 396,
    ["OSS Review Toolkit curation"] = 397,
    ["OSS Review Toolkit package configuration"] = 398,
    ["OSS Review Toolkit repository configuration"] = 399,
    ["OSS Review Toolkit resolutions"] = 400,
    Opctl = 600,
    ["OpenRewrite Resource"] = 391,
    ["OpenWeather Current Weather API"] = 637,
    ["OpenWeather Road Risk API"] = 636,
    ["Ory Hydra configuration"] = 277,
    ["Ory Keto configuration"] = 315,
    ["Ory Kratos configuration"] = 395,
    ["Ory Oathkeeper configuration"] = 383,
    ["Outblocks App configuration"] = 393,
    ["Outblocks database table"] = 394,
    ["Outblocks project configuration"] = 392,
    Packer = 403,
    Pantsbuild = 713,
    ["Paper paper-plugin.yml"] = 404,
    ["Pipeline component"] = 647,
    ["PocketMine plugin.yml"] = 409,
    ["Postman collection"] = 414,
    ["Problem package generators"] = 421,
    Pterodactyl = 689,
    ["Pull Request Labeler"] = 436,
    Pulumi = 442,
    PyProject = 443,
    Pyright = 444,
    Qgoda = 445,
    Qodana = 665,
    ["Quali Torque Blueprint Spec 2"] = 687,
    ["QueryFirst config file"] = 709,
    ["RKE Cluster Configuration JSON"] = 644,
    ["RKE Cluster Configuration YAML"] = 643,
    ["Rancher Fleet"] = 439,
    Ray = 612,
    ["Read the Docs"] = 441,
    ["Red-DiscordBot Cog"] = 446,
    ["Red-DiscordBot Cog Repo"] = 447,
    ["Red-DiscordBot Trivia"] = 448,
    Renovate = 457,
    ["Replit config"] = 451,
    RoadRunner = 458,
    Ruff = 454,
    ["Rust Project"] = 455,
    ["Rust toolchain"] = 460,
    ["SIL Kit Participant Configuration"] = 491,
    ["SIL Kit Registry Configuration"] = 492,
    SWADL = 515,
    ["Safebox Config"] = 700,
    ["Sapphire CLI Config"] = 463,
    ["SauceCTL Configuration"] = 652,
    ["Schema Catalog"] = 477,
    ["Scoop manifest"] = 482,
    ["Semantic Data Fabric (SDF) file"] = 483,
    ["Semgrep Rule"] = 485,
    ["Serenity Code Generator (Sergen)"] = 486,
    ["Serverless Framework Configuration"] = 659,
    ["Serverless Workflow"] = 661,
    ["Settings.paf"] = 488,
    ["Shopware 6 Configuration"] = 662,
    ["Shopware CLI Extension Store Configuration"] = 663,
    ["Shopware CLI Project Store Configuration"] = 664,
    ["Sigrid scope configuration file"] = 490,
    ["Slack app manifest"] = 494,
    Solidarity = 497,
    ["Solution filters"] = 498,
    ["Source Maps v3"] = 499,
    Sourcery = 500,
    SpecIF = 501,
    ["Sponge Mixin configuration"] = 502,
    ["StackHawk Scanner Configuration"] = 658,
    Stale = 507,
    ["Starlake Data Pipeline"] = 634,
    Starship = 508,
    ["Statamic Blueprint"] = 509,
    ["StrmPrivacy Data Connector"] = 704,
    ["StrmPrivacy Data Contract"] = 705,
    ["StrmPrivacy SimpleSchema"] = 702,
    ["StrmPrivacy Stream"] = 703,
    ["StrmPrivacy batch job configuration file"] = 701,
    ["Stryker Mutator"] = 512,
    ["StyleCop Analyzers Configuration"] = 513,
    ["Swagger API 2.0"] = 516,
    TSON = 540,
    ["Talisman configuration"] = 518,
    ["Taskfile config"] = 639,
    Taurus = 519,
    ["TestEnvironment.json"] = 528,
    ["Tier.run pricing.json"] = 522,
    Tikibase = 523,
    ["Traefik v2"] = 531,
    ["Traefik v2 File Provider"] = 532,
    Turborepo = 529,
    Tye = 666,
    ["UET BuildConfig.json"] = 710,
    ["UI5 Manifest"] = 547,
    ["UTAM Page Object"] = 550,
    ["Ubuntu Server Autoinstall"] = 545,
    ["Uniswap Token List"] = 622,
    ["Unreal Engine Uplugin"] = 711,
    ["Unreal Engine Uproject"] = 712,
    Updatecli = 673,
    Uplift = 708,
    ["User Journey Map"] = 642,
    V2Ray = 677,
    ["VSCode Code Snippets"] = 141,
    ["VSIX CLI publishing"] = 563,
    ["Vela Pipeline Configuration"] = 553,
    Vercel = 140,
    Visivo = 737,
    ["Web App Manifest"] = 570,
    ["Web types"] = 573,
    WebExtensions = 569,
    ["Webman package recipe"] = 683,
    ["Windows Package Manager Installer Manifest"] = 619,
    ["Windows Package Manager Locale Manifest"] = 620,
    ["Windows Package Manager Singleton Manifest"] = 618,
    ["Woodpecker pipeline config"] = 654,
    ["Xstate Machine"] = 671,
    ["Yippee-Ki-JSON configuration YML"] = 624,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 66,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 719,
    ["bashly-strings.yml"] = 720,
    ["bashly.yml"] = 718,
    ["batect.yml"] = 65,
    ["beef-database-codegen"] = 67,
    ["beef-database-v5-codegen"] = 69,
    ["beef-entity-codegen"] = 68,
    ["beef-entity-v5-codegen"] = 70,
    ["behat.yml"] = 79,
    ["bigquery-table"] = 71,
    ["bitbucket-pipelines"] = 73,
    bitrise = 74,
    ["bitrise-step"] = 75,
    ["block.json"] = 89,
    ["bower.json"] = 77,
    ["bozr.suite.json"] = 80,
    bpkg = 721,
    ["browser.i18n.json"] = 81,
    bucklescript = 82,
    ["bundleconfig.json"] = 87,
    ["chisel-slices.json"] = 158,
    ["chrome-extension-locales-messages.json"] = 148,
    ["chutzpah.json"] = 149,
    clangd = 130,
    clib = 131,
    ["cloud-init: cloud-config userdata"] = 133,
    ["cloud-sdk-pipeline-configuration"] = 151,
    ["cloudbuild.json"] = 152,
    cloudify = 132,
    codemagic = 134,
    ["coffeelint.json"] = 160,
    ["commands.json"] = 144,
    ["compile_commands.json"] = 143,
    ["compilerconfig.json"] = 142,
    ["completely.yml"] = 716,
    ["component-detection-manifest.json"] = 163,
    ["component.json"] = 162,
    ["composer.json"] = 161,
    ["config.yaml"] = 440,
    ["contentmanifest.json"] = 150,
    ["contribute.json"] = 164,
    ["cosmos.config.json"] = 146,
    ["crowdin.yml"] = 165,
    cspell = 171,
    ["custom-elements.json"] = 730,
    ["cypress.json"] = 169,
    ["datalogic-scan2deploy-android"] = 178,
    ["datalogic-scan2deploy-ce"] = 179,
    ["dbt Project"] = 107,
    ["ddev-global"] = 180,
    ["ddev-project"] = 181,
    ["debugsettings.json"] = 182,
    ["dependabot-v2.json"] = 185,
    ["dependabot.json"] = 184,
    ["deployed-cli"] = 670,
    ["detekt.yml"] = 187,
    ["devcontainer.json"] = 136,
    devinit = 626,
    ["devspace.yaml"] = 691,
    djlint = 627,
    ["docfx.json"] = 191,
    ["docker sequencer"] = 190,
    ["docker-compose.yml"] = 625,
    ["dockerd.json"] = 189,
    ["dotnet Release Index manifest"] = 200,
    ["dotnetcli.host.json"] = 201,
    ["dprint.json"] = 202,
    ["drone.json"] = 203,
    ["dss-2.0.0.json"] = 205,
    ["dstack configuration"] = 206,
    ["dvc.yaml"] = 207,
    ["ecosystem.json"] = 212,
    eksctl = 213,
    ["electron-builder configuration file"] = 218,
    ["epr-manifest.json"] = 216,
    ["evcc.yaml"] = 219,
    ["ezd task runner"] = 221,
    ["fabric.mod.json"] = 224,
    ["first-timers-bot"] = 228,
    ["flagd flag configuration"] = 58,
    ["fly.io Configuration"] = 59,
    fulibWorkflows = 653,
    ["function.json"] = 238,
    ["geojson.json"] = 243,
    ["gitlab-ci"] = 252,
    ["global.json"] = 254,
    ["go-feature-flag Flag Configuration"] = 256,
    ["golangci-lint Configuration"] = 255,
    ["haxelib.json"] = 270,
    helmfile = 614,
    helmwave = 615,
    ["host-meta.json"] = 275,
    ...
    ["ide.host.json"] = 280,
    ["ifstate.conf"] = 281,
    ["imageoptimizer.json"] = 282,
    ["importmap.json"] = 285,
    ["ioBroker Configuration"] = 286,
    ["ioBroker JSON UI"] = 287,
    ["ioBroker Package manifest"] = 288,
    ["ize.toml"] = 707,
    ["jsconfig.json"] = 310,
    ["jscpd Configuration"] = 688,
    jsdoc = 611,
    ["k3d.yaml"] = 311,
    ["kontinuous-config.yaml"] = 317,
    ["kontinuous-values.yaml"] = 316,
    ["kustomization.yaml"] = 318,
    ["label-commenter-config.yml"] = 319,
    ["launchsettings.json"] = 320,
    lazydocker = 729,
    lazygit = 728,
    ["lego.json"] = 322,
    ["lerna.json"] = 323,
    ["lgtm.yml"] = 324,
    ["libman.json"] = 325,
    ["license-report-config.json"] = 326,
    ["linkinator.config.json"] = 327,
    ["local.settings.json"] = 332,
    ["localazy.json"] = 333,
    ["lotus.yaml"] = 331,
    ["lsdlschema.json"] = 334,
    ["madness.yml"] = 717,
    ["markdown-lint-check"] = 650,
    mboats = 657,
    ["micro-settings.json"] = 722,
    ["mimetypes.json"] = 341,
    ["mirrord config"] = 594,
    ["mta.yaml"] = 595,
    ["mtad.yaml"] = 596,
    ["mycode.json"] = 365,
    ["napari plugin manifest"] = 366,
    neoload = 606,
    ["nest-cli"] = 372,
    ["ninjs (News in JSON) 1.3"] = 371,
    ["ninjs (News in JSON) 2.0"] = 370,
    ["nlu.json"] = 373,
    ["nodemon.json"] = 375,
    ["noodl config"] = 656,
    now = 602,
    ...
    ["nswag.json"] = 381,
    ntangle = 382,
    ["nuclei-template.yaml"] = 379,
    ["nuget-project.json"] = 380,
    ["ocelot.json"] = 384,
    ["omnisharp.json"] = 385,
    ["openapi.json"] = 386,
    ["openfin.json"] = 390,
    ...
    ["ops.yaml"] = 388,
    ["package.json"] = 401,
    ["package.manifest"] = 402,
    ["pathfinder.yml"] = 405,
    ["pattern.json"] = 407,
    ["petstore-v1.0"] = 698,
    pgap_yaml_input_reader = 406,
    ["plagiarize-me.yaml"] = 411,
    ["plagiarize.yaml"] = 410,
    ["portman.json"] = 412,
    ["prettierrc.json"] = 419,
    ["prisma.yml"] = 420,
    ["project-1.0.0-beta3.json"] = 423,
    ["project-1.0.0-beta4.json"] = 424,
    ["project-1.0.0-beta5.json"] = 425,
    ["project-1.0.0-beta6.json"] = 426,
    ["project-1.0.0-beta8.json"] = 427,
    ["project-1.0.0-rc1.json"] = 428,
    ["project-1.0.0-rc2.json"] = 429,
    ["project.json"] = 422,
    ["prometheus.json"] = 430,
    ["prometheus.rules.json"] = 431,
    ["prometheus.rules.test.json"] = 432,
    ["proxies.json"] = 433,
    ["publiccode.yml"] = 434,
    ["pubspec.yaml"] = 435,
    ["pyrseas-0.8.json"] = 438,
    ["quilt.mod.json"] = 723,
    ["release drafter"] = 607,
    rtx = 453,
    rustfmt = 459,
    samt = 461,
    samtrc = 462,
    ["sarif-1.0.0.json"] = 464,
    ["sarif-2.0.0.json"] = 465,
    ["sarif-2.1.0"] = 475,
    ["sarif-2.1.0-rtm.2"] = 466,
    ["sarif-2.1.0-rtm.3"] = 468,
    ["sarif-2.1.0-rtm.4"] = 470,
    ["sarif-2.1.0-rtm.5"] = 472,
    ["sarif-2.1.0-rtm.6"] = 473,
    ["sarif-external-property-file-2.1.0"] = 476,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 467,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 469,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 471,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 474,
    ["schema.org - Action"] = 478,
    ["schema.org - ContactPoint"] = 479,
    ["schema.org - Place"] = 480,
    ["schema.org - Thing"] = 481,
    ["secrethub.yml"] = 725,
    ["semantic-release"] = 484,
    ["servicehub.config.json"] = 583,
    ["servicehub.service.json"] = 582,
    ["settings.job"] = 487,
    ["sfdx-hardis configuration"] = 489,
    ["size-limit configuration"] = 493,
    ["skaffold.yaml"] = 648,
    ["skyuxconfig.json"] = 495,
    snapcraft = 496,
    ["sqlc configuration"] = 504,
    ["stripe-app-local.json"] = 511,
    ["stripe-app.json"] = 510,
    swcrc = 635,
    syntax = 727,
    ["task.json"] = 517,
    taskcat = 603,
    ["template.json"] = 520,
    ["templatsources.json"] = 521,
    ["theme.json"] = 524,
    ["tizen_workspace.json"] = 525,
    tldr = 526,
    tmLanguage = 527,
    tmuxinator = 591,
    ["transcend.yml"] = 533,
    ["trunk.yaml"] = 534,
    ["ts-force-config.json"] = 538,
    ["tsconfig.json"] = 535,
    ["tsd.json"] = 536,
    ["tsdrc.json"] = 537,
    ["tslint.json"] = 539,
    ...
    ["vega-lite.json"] = 552,
    ["vega.json"] = 551,
    ["venvironment-basic.yaml"] = 555,
    ["venvironment.yaml"] = 554,
    ["version.json"] = 556,
    ["vim-addon-info"] = 557,
    ["vs-2017.3.host.json"] = 559,
    ["vs-nesting.json"] = 560,
    ["vsls.json"] = 558,
    ["vss-extension.json"] = 564,
    ["vtesttree.yaml"] = 565,
    ["vtestunit.yaml"] = 566,
    ["warp-keysets.json"] = 731,
    ["warp-themes.json"] = 732,
    ["warp-workflows.json"] = 733,
    ["webhint.io"] = 684,
    ["webjobpublishsettings.json"] = 572,
    ["webjobs-list.json"] = 571,
    ["xs-app.json"] = 599,
    ["xunit.runner.json"] = 581,
    yamllint = 623,
    zuul = 608,
    ["Žinoma"] = 617
  },
