...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 942,
    [".nodehawkrc"] = 584,
    [".npmpackagejsonlintrc"] = 588,
    [".omletrc"] = 1121,
    [".phrase.yml"] = 662,
    [".phraseapp.yml"] = 663,
    [".pmbot.yml"] = 648,
    [".postcssrc"] = 657,
    [".powerpages-web-template-manifest"] = 659,
    [".pre-commit-config.yml"] = 660,
    [".pre-commit-hooks.yml"] = 661,
    [".putout.json"] = 696,
    [".rehyperc"] = 721,
    [".remarkrc"] = 725,
    [".sprite files"] = 817,
    ...
    AIConfig = 34,
    ["AMX Muse Program Descriptor"] = 1169,
    ["API Builder"] = 977,
    ["AVA Configuration"] = 1040,
    ...
    ["AWS Copilot Manifest"] = 1208,
    ["AWS SAM CLI Samconfig"] = 266,
    ["Adobe UXP Manifest"] = 1103,
    ["Aerleon Network & Service Definitions"] = 20,
    ["Aerleon Policy"] = 21,
    ["AgentCore CLI"] = 1248,
    Aider = 1198,
    Air = 23,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1219,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1218,
    ["Airlock Microgateway"] = 35,
    ["Alacritty Configuration"] = 1012,
    ["All Contributors configuration file"] = 1066,
    ...
    ["Application list for a WinUtil"] = 1148,
    ArchitectFX = 1153,
    ["Argo CD"] = 54,
    ["Argo Events"] = 55,
    ["Argo Workflows"] = 56,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1217,
    ["Azure IoT Operations connector metadata"] = 1214,
    ...
    ["Azure Pipelines"] = 113,
    ["Azure Static Web Apps CLI configuration file"] = 821,
    ["Azure Static Web Apps configuration file"] = 820,
    BMML = 1236,
    ["BOSH CPI Config"] = 139,
    ...
    ["Bacon config"] = 5,
    ["Barba-CV"] = 83,
    ["Bashly (bashly.yml)"] = 1070,
    ["Bashly Settings (bashly-settings.yml)"] = 1071,
    Bento = 1235,
    ["Better Code Hub"] = 982,
    ["Better Scripts"] = 160,
    Bigconfig = 132,
    ["Biome Formatter Config"] = 84,
    ["Bitmovin Encoding Template"] = 1162,
    BizTalkServerApplicationSchema = 949,
    Bleep = 161,
    ["Block Protocol Metadata"] = 158,
    ["Bluebricks blueprint config"] = 1241,
    ["Boyka Framework"] = 141,
    Briefcase = 955,
    ["Build Info"] = 149,
    Buildkite = 151,
    ...
    ["Butane Config"] = 1025,
    C4InterFlow = 1177,
    ["CDK Environment Manager, concrete environment configuration"] = 1201,
    ["CDK Environment Manager, concrete environments definition"] = 1200,
    ["CDK Environment Manager, environment definition"] = 1199,
    ["CGS Card Game Specification (cgs.json)"] = 1108,
    ["CICS TS region tagging"] = 1034,
    ["CICS TS resource import"] = 1035,
    ["CICS TS resource model"] = 1036,
    ["CICS TS resource overrides"] = 1037,
    ["CMake Presets"] = 162,
    ["CNC Codes"] = 184,
    ["CRS WAF test file"] = 1138,
    ["CRS WAF test platform overrides file"] = 1139,
    ...
    ["Chamaleon environment"] = 1166,
    ["Chamaleon properties"] = 1167,
    ["Chamaleon template"] = 1165,
    Changepacks = 1228,
    Changesets = 275,
    Changie = 171,
    Charmcraft = 172,
    ...
    ["Clawject config"] = 190,
    ["Cloud Foundry Application Manifest"] = 1120,
    ["Cloud Run Spec v1"] = 1143,
    ...
    Concord = 1137,
    ["Configu .cfgu files"] = 1125,
    ["Configu .configu file"] = 1126,
    Conjure = 183,
    ["Container Structure Test"] = 963,
    Containerlab = 991,
    ["Contextive Glossary"] = 1193,
    Convex = 182,
    ["Crowdsec collection config"] = 285,
    ["Crowdsec parser config"] = 286,
    ["Crowdsec scenario config"] = 287,
    ["CumulusCI Config"] = 189,
    ["Cursor Agent Environment"] = 1246,
    ["Custom Machinery Machine"] = 1109,
    ["Custom Machinery Recipe"] = 1110,
    ...
    ["DonateCaseBetterCasino menu"] = 1170,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1078,
    ["EAS config"] = 354,
    ["ECA - Editor Code Assistant"] = 338,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1067,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1213,
    ["EasyVCR .NET"] = 355,
    ["Eidolon Resource"] = 1154,
    ...
    ["Erda Pipeline"] = 1116,
    ["Erda Runtime"] = 1117,
    ["Espanso config.yml"] = 1239,
    ["Espanso match.yml"] = 1238,
    Esquio = 343,
    ["Estuary Flow Catalog"] = 1031,
    ["Ethereum ERC1155"] = 1250,
    ["Ethereum ERC721"] = 1249,
    ...
    ["Evolving Resolutive Process notation"] = 1215,
    ["Expo SDK"] = 353,
    ...
    ["GeoJSON.json latest"] = 1029,
    GherKing = 1033,
    ["GitHub Action"] = 388,
    ["GitHub Actions typing"] = 1150,
    ...
    ["Google Digital Assetlinks"] = 1194,
    Goreleaser = 416,
    ["Goreleaser Pro"] = 417,
    Goss = 418,
    ["Gradle Build Cache Node"] = 980,
    ["Gradle Enterprise"] = 979,
    ...
    Hadolint = 959,
    Hammerkit = 990,
    ["Hardware Sentry Configuration"] = 1045,
    ...
    ["JFrog File Spec"] = 469,
    ["JFrog Pipelines YML DSL"] = 1055,
    ["JMeter DSL cli config"] = 470,
    JReleaser = 473,
    ["JSON Document Transform"] = 481,
    ["JSON Feed"] = 482,
    ["JSON Resume"] = 731,
    ["JSON Schema Draft 2020-12"] = 927,
    ["JSON Schema Draft 4"] = 924,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1088,
    ["JSON Schema Draft 7"] = 925,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1089,
    ["JSON Schema Draft 8 (2019-09)"] = 926,
    ["JSON-API"] = 480,
    ["JSON-e templates"] = 987,
    ["JSON-stat 2.0"] = 920,
    JSONPatch = 484,
    ...
    ["Jujutsu (jj) VCS config"] = 1207,
    ["KIMMDY config file"] = 495,
    ["KODE/CI build.yaml"] = 1051,
    ["KSP-AVC"] = 921,
    ["KSP-CKAN"] = 922,
    ["KSP-NetKAN"] = 923,
    KSY = 1118,
    ...
    ["Keycloak REST API"] = 1058,
    ["Knative Functions - func.yaml"] = 375,
    Knip = 376,
    ["Kometa (nightly) config file"] = 498,
    ["Kometa config file"] = 497,
    ["Kong DBLess config"] = 1052,
    KrakenD = 499,
    ["Kubri Configuration"] = 506,
    LOOBin = 521,
    ["Lake configuration file"] = 1210,
    ...
    ["Lando (landofile)"] = 109,
    ["LangGraph Platform configuration"] = 1130,
    ["Language configuration"] = 1129,
    Lefthook = 510,
    ["Liferay client-extension.yaml"] = 517,
    ["LinkML Metamodel"] = 519,
    Liquibase = 996,
    ["Liquibase Flow File"] = 997,
    ["Lively Properties"] = 520,
    ["Lobe AI Agent"] = 111,
    Loki = 112,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 563,
    ["MS2Rescore Configuration"] = 567,
    ["Madness (madness.yml)"] = 1069,
    ["Mado configuration"] = 527,
    ["Maestro Flow"] = 528,
    ["Mail Servers Configuration"] = 1242,
    ["MapEHR Mapping"] = 529,
    Markdownlint = 1000,
    ["Mason Registry"] = 1003,
    ["MegaLinter Custom Flavor"] = 532,
    ["MegaLinter configuration"] = 531,
    ["MegaLinter descriptor"] = 533,
    Melange = 1096,
    ["Meltano project definition"] = 534,
    ["Mergify Configuration"] = 568,
    ["Metadata for a Bazel module"] = 535,
    ["Metadata for a Cinnamon spice"] = 1146,
    ["Metatype Configuration"] = 536,
    ["MetricsHub Configuration"] = 537,
    ["MetricsHub Connector Configuration"] = 538,
    ["Micro Editor Syntax"] = 1079,
    ["Microsoft Band Web Tile"] = 539,
    ["Microsoft RulesEngine workflow rules"] = 1134,
    ["Microsoft RulesEngine workflow rules list"] = 1135,
    ["Minecraft Custom Main Menu Mod"] = 1097,
    ["Minecraft Data Pack Advancement"] = 541,
    ["Minecraft Data Pack Biome"] = 542,
    ["Minecraft Data Pack Configured Carver"] = 543,
    ["Minecraft Data Pack Damage Type"] = 544,
    ["Minecraft Data Pack Dimension"] = 546,
    ["Minecraft Data Pack Dimension Type"] = 545,
    ["Minecraft Data Pack Item Modifier"] = 547,
    ["Minecraft Data Pack Loot Table"] = 548,
    ["Minecraft Data Pack Metadata"] = 549,
    ["Minecraft Data Pack Predicate"] = 550,
    ["Minecraft Data Pack Recipe"] = 551,
    ["Minecraft Data Pack Tag"] = 552,
    ["Minecraft Data Pack Template Pool"] = 553,
    ["Minecraft Data Pack Trim Material"] = 558,
    ["Minecraft Data Pack Trim Pattern"] = 559,
    ["Minecraft Resource Pack Lang"] = 554,
    ["Minecraft Resource Pack Particle"] = 555,
    ["Minecraft Resource Pack Texture Mcmeta"] = 557,
    ["Minecraft Resourcepack Sounds"] = 556,
    ModuleAssembler = 561,
    ["Monade CLI Stack Configuration"] = 571,
    ["MongoDB Atlas Search Index Definition"] = 1050,
    ["Monika Configuration"] = 1048,
    ["Monoweave Configuration"] = 566,
    ["Motif config"] = 941,
    MultiQC = 1187,
    ["NOX Framework (Service)"] = 587,
    ["Netin Diagnostic System Template"] = 1007,
    ["Netlify config"] = 574,
    ["Network-as-Code Data Model"] = 575,
    ["Next Gen UI Agent A2A Server Configuration"] = 576,
    ["Next Gen UI Agent Configuration"] = 578,
    ["Next Gen UI Agent MCP Server Configuration"] = 577,
    ["Nightwatch.js"] = 580,
    ["Node.js configuration"] = 946,
    ["NueJS configuration file"] = 592,
    ["Nuitka.yaml"] = 1111,
    ["Nullstone config"] = 594,
    ["ONe's changelog entry"] = 613,
    ["ONe's service descriptor"] = 612,
    ["ORT Server repository environment configuration"] = 623,
    ["OSCAL Assessment Plan (AP)"] = 625,
    ["OSCAL Assessment Results (AR)"] = 626,
    ["OSCAL Catalog"] = 627,
    ["OSCAL Component Definition (CDef)"] = 628,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 629,
    ["OSCAL Profile"] = 630,
    ["OSCAL System Security Plan (SSP)"] = 631,
    ["OSS Review Toolkit configuration"] = 632,
    ["OSS Review Toolkit curation"] = 633,
    ["OSS Review Toolkit package configuration"] = 634,
    ["OSS Review Toolkit repository configuration"] = 635,
    ["OSS Review Toolkit resolutions"] = 636,
    ["October CMS columns"] = 598,
    ["October CMS fields"] = 599,
    ["Oh My Posh"] = 601,
    Okteto = 602,
    ["Ona Automations"] = 604,
    Opctl = 944,
    ["Open Data Contract Standard (ODCS)"] = 617,
    ["Open Data Product Standard (ODPS)"] = 618,
    ["Open Know-How"] = 1192,
    ["OpenRewrite Resource"] = 615,
    OpenSRM = 619,
    OpenStatus = 1203,
    ["OpenTelemetry Declarative Configuration"] = 616,
    ["OpenUtau character yaml"] = 609,
    ["OpenUtau ustx"] = 610,
    ["OpenWeather Current Weather API"] = 986,
    ["OpenWeather Road Risk API"] = 985,
    ["Ory Hydra configuration"] = 443,
    ["Ory Keto configuration"] = 503,
    ["Ory Kratos configuration"] = 624,
    ["Ory Oathkeeper configuration"] = 596,
    ["Outblocks App configuration"] = 621,
    ["Outblocks database table"] = 622,
    ["Outblocks project configuration"] = 620,
    PDM = 643,
    POPxf = 654,
    ["POPxf Correlations"] = 655,
    Packer = 640,
    PactSpec = 641,
    Pantsbuild = 1065,
    ["Paper paper-plugin.yml"] = 642,
    ["Pipeline component"] = 998,
    ["Platform.sh application"] = 7,
    ["Platform.sh routes"] = 8,
    ["Platform.sh services"] = 9,
    ["Plex Prerolls"] = 652,
    ["PocketMine plugin.yml"] = 649,
    ["Postman collection"] = 658,
    ["Power Pages Configuration"] = 1204,
    ["Preset list for a WinUtil"] = 1149,
    ["ProActions AI-Kit Configuration"] = 669,
    ["ProActions AI-Kit Configuration for Menus"] = 671,
    ["ProActions AI-Kit Configuration for Sections"] = 673,
    ["ProActions AI-Kit Configuration for Services"] = 670,
    ["ProActions AI-Kit Configuration for Steps"] = 674,
    ["ProActions AI-Kit Configuration for Templates"] = 672,
    ["Problem object RFC9457"] = 1094,
    ["Problem package format"] = 675,
    ["Problem package generators"] = 676,
    ["Problem package submissions"] = 677,
    ["Problem package test group metadata"] = 678,
    Pterodactyl = 1044,
    ["Pull Request Labeler"] = 695,
    Pulumi = 703,
    ["PyGTA Config"] = 699,
    PyProject = 704,
    Pylock = 1195,
    Pyright = 705,
    ["Python script metadata"] = 1189,
    ["QType AI DSL"] = 708,
    Qgoda = 707,
    Qodana = 1017,
    ["Qt Creator workspace file"] = 1127,
    ["Quali Torque Blueprint Spec 2"] = 1042,
    ["QueryFirst config file"] = 1061,
    ["Qwen Code Settings"] = 1251,
    ["RKE Cluster Configuration JSON"] = 995,
    ["RKE Cluster Configuration YAML"] = 994,
    RadioHound = 698,
    ["Raid Profile"] = 1252,
    ["Raid Repo Configuration"] = 1253,
    Railpack = 710,
    Railway = 709,
    ["Rancher Fleet"] = 700,
    ["Rattler-build"] = 711,
    Ray = 958,
    ["Read the Docs"] = 702,
    ["Red-DiscordBot Cog"] = 718,
    ["Red-DiscordBot Cog Repo"] = 719,
    ["Red-DiscordBot Trivia"] = 720,
    ["Releasaurus Config"] = 4,
    ReleaseKit = 3,
    ["Render Blueprints"] = 993,
    RenderCV = 735,
    Renovate = 732,
    ["Renovate global configuration"] = 733,
    ["Renovate inherited configuration"] = 734,
    ["Replit config"] = 726,
    Restate = 1182,
    ["Revel Digital Gadget Definition File"] = 1206,
    RoadRunner = 737,
    ["Robust Station Image"] = 1212,
    Rockcraft = 738,
    ["Roo Coder Custom Modes"] = 739,
    Rubocop = 728,
    ["Rudder techniques"] = 1101,
    Ruff = 729,
    ["Rust Project"] = 730,
    ["Rust toolchain"] = 743,
    ["SDMX data message"] = 770,
    ["SDMX metadata message"] = 769,
    ["SDMX structure message"] = 768,
    ["SIL Kit Participant Configuration"] = 780,
    ["SIL Kit Registry Configuration"] = 781,
    ["SPDX 2.3"] = 818,
    SWADL = 834,
    ["Safebox Config"] = 1056,
    ["Sapphire CLI Config"] = 746,
    ["SauceCTL Configuration"] = 1004,
    Scarb = 766,
    ["Schema Catalog"] = 761,
    ["Scoop manifest"] = 767,
    ["Semantic Data Fabric (SDF) file"] = 771,
    ["Semgrep Rule"] = 773,
    ["Serenity Code Generator (Sergen)"] = 774,
    ["Serverless Framework Configuration"] = 1011,
    ["Serverless Workflow"] = 1013,
    ["Settings for a Cinnamon spice"] = 1145,
    ["Settings.paf"] = 776,
    ["Shopware 6 Configuration"] = 1014,
    ["Shopware CLI Extension Store Configuration"] = 1015,
    ["Shopware CLI Project Store Configuration"] = 1016,
    ["Sigma Detection Rule"] = 778,
    ["Sigrid scope configuration file"] = 779,
    ["SkyPilot Task JSON"] = 1102,
    ["Slack app manifest"] = 783,
    Snapcraft = 785,
    Solidarity = 788,
    ["Solution filters"] = 789,
    ["Source Maps v3"] = 790,
    Sourcery = 791,
    ["Spack bootstrap.yaml"] = 792,
    ["Spack cdash.yaml"] = 793,
    ["Spack ci.yaml"] = 794,
    ["Spack compilers.yaml"] = 795,
    ["Spack concretizer.yaml"] = 796,
    ["Spack config.yaml"] = 797,
    ["Spack definitions.yaml"] = 798,
    ["Spack develop.yaml"] = 799,
    ["Spack env_vars.yaml"] = 800,
    ["Spack environment"] = 806,
    ["Spack include.yaml"] = 801,
    ["Spack mirrors.yaml"] = 802,
    ["Spack modules.yaml"] = 803,
    ["Spack packages.yaml"] = 804,
    ["Spack repos.yaml"] = 805,
    ["Spack toolchains.yaml"] = 807,
    ["Spack upstreams.yaml"] = 808,
    ["Spack view.yaml"] = 809,
    ["Speakeasy Generation Config File"] = 813,
    ["Speakeasy Lint Configuration File"] = 810,
    ["Speakeasy Test Generation Configuration File"] = 811,
    ["Speakeasy Workflow File"] = 812,
    SpecIF = 814,
    ["Specmatic Configuration"] = 815,
    ["Sponge Mixin configuration"] = 816,
    StackBlitz = 822,
    ["StackHawk Scanner Configuration"] = 1010,
    Stale = 823,
    Starfish = 824,
    ["Starlake Data Pipeline"] = 983,
    Starship = 825,
    ["Statamic Blueprint"] = 826,
    ["Stella configuration file"] = 827,
    ["Streamlit configuration file"] = 828,
    ["Stryker Mutator"] = 831,
    ["StyleCop Analyzers Configuration"] = 832,
    ["Stylelint (.stylelintrc)"] = 833,
    ["Stylua Config"] = 1196,
    ["Sublime Syntax"] = 1057,
    ["Subsquid squid manifest"] = 1104,
    ["Swagger API 2.0"] = 835,
    ["Synadia Connect Component"] = 836,
    TSON = 872,
    TSTyche = 873,
    ["TYPO3 Vendor Bundler config"] = 879,
    ["Tab data for a LinUtil"] = 1152,
    ["Tab list for a LinUtil"] = 1151,
    Tach = 837,
    ["Tach Domain"] = 838,
    Talhelper = 840,
    ["Talisman configuration"] = 841,
    Taplo = 1197,
    ["Taskfile config"] = 988,
    Taurus = 842,
    Tauticord = 843,
    ["Tekton Pipeline"] = 1225,
    ["Tekton PipelineRun"] = 1226,
    ["Tekton Task"] = 1223,
    ["Tekton TaskRun"] = 1224,
    Telefonistka = 1183,
    ["Terrateam config"] = 1209,
    ["TestEnvironment.json"] = 855,
    ["TextMate Grammar"] = 854,
    Threagile = 849,
    ["Tier.run pricing.json"] = 846,
    Tikibase = 847,
    Tombi = 852,
    ["Traefik v2"] = 858,
    ["Traefik v2 File Provider"] = 859,
    ["Traefik v3"] = 860,
    ["Traefik v3 File Provider"] = 861,
    ["Travis CI (.travis.yml)"] = 857,
    Treefmt = 421,
    Trident = 1179,
    ["TrueScript for *.tscript files"] = 864,
    ["Tugboat QA config.yml"] = 1176,
    TunnelHub = 1092,
    Turborepo = 856,
    Tycho = 1141,
    Tye = 1018,
    ["Tyk Gateway - Open Source v5.7+"] = 1188,
    ["UET BuildConfig.json"] = 1062,
    ["UI5 Manifest"] = 885,
    ["UNCORS configuration"] = 889,
    ["UTAM Page Object"] = 888,
    ["Ubuntu Server Autoinstall"] = 883,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1180,
    ["Uniswap Token List"] = 970,
    ["Universal Schedule Format"] = 890,
    ["Unreal Engine Uplugin"] = 1063,
    ["Unreal Engine Uproject"] = 1064,
    ["UpCloud CLI (upctl) configuration"] = 1181,
    ["Updatecli Compose"] = 1026,
    ["Updatecli Policy Manifest"] = 1027,
    ["Updatecli Policy Metadata"] = 1028,
    Uplift = 1060,
    ["Upsun config"] = 6,
    ["User Journey Map"] = 992,
    V2Ray = 1032,
    ["VSCode Code Snippets"] = 250,
    ["VSIX CLI publishing"] = 908,
    Vector = 892,
    ["Vela Pipeline Configuration"] = 895,
    Vercel = 249,
    ["Version Bumper config"] = 898,
    Vespertide = 1230,
    ["Vespertide Migration"] = 1231,
    ["Vespertide Model"] = 1232,
    ["Viash Component Config"] = 1185,
    ["Viash Package Config"] = 1186,
    Visivo = 1090,
    ["WP-CLI"] = 918,
    Wake = 1178,
    ["Waku Config"] = 1155,
    ["Web App Manifest"] = 914,
    ["Web types"] = 917,
    WebExtensions = 913,
    ["Webman package recipe"] = 1038,
    ["Windows Package Manager Installer Manifest"] = 966,
    ["Windows Package Manager Locale Manifest"] = 967,
    ["Windows Package Manager Singleton Manifest"] = 965,
    Winutil = 968,
    ["WireMock CLI import configuration"] = 1161,
    ["WireMock CLI local service configuration"] = 1160,
    ["WireMock message stub mapping"] = 1159,
    ["WireMock stub mapping"] = 1158,
    ["Woodpecker pipeline config"] = 1006,
    ["Wrangler CLI"] = 919,
    ["Xstate Machine"] = 1024,
    ["Yandex Workflow Language"] = 1147,
    ["Yarn Config (.yarnrc.yml)"] = 981,
    ["Yippee-Ki-JSON configuration YML"] = 972,
    ["YouTrack App"] = 1144,
    ["Zarf Package Configuration"] = 1211,
    ["Zerops.io config"] = 1132,
    ["Zerops.io import"] = 1133,
    ["Zola Configuration"] = 1222,
    ["aerleon.yml"] = 19,
    ["amplify.yml"] = 12,
    ["angular.json"] = 36,
    apko = 1095,
    ...
    ["behat.yml"] = 142,
    ["bigquery-table"] = 131,
    ["bioimageio resource description"] = 1112,
    ...
    ["chutzpah.json"] = 258,
    cibuildwheel = 177,
    ["clang-format (.clang-format)"] = 1030,
    ["clang-tidy"] = 236,
    clangd = 235,
    clib = 237,
    ...
    ["crowdin.yml"] = 284,
    ["ctfd-setup configuration file"] = 1168,
    ["custom-elements.json"] = 1082,
    ["cypress.json"] = 288,
    ...
    ["gematik health care insurance list"] = 1174,
    ["gematik health care patient list"] = 1171,
    ["gematik health care provider institution list"] = 1173,
    ["gematik health care provider list"] = 1172,
    ["gematik tiger test environment configuration"] = 1175,
    ["git-town.toml"] = 1220,
    ["gitlab-ci"] = 396,
    ["global.json"] = 412,
    ...
    ["k9s skin.yaml"] = 493,
    ["k9s views.yaml"] = 494,
    ["kontinuous-config.yaml"] = 505,
    ["kontinuous-values.yaml"] = 504,
    ["kustomization.yaml"] = 507,
    ["label-commenter-config.yml"] = 508,
    ["latexindent configuration"] = 110,
    ["launchsettings.json"] = 509,
    lazydocker = 1081,
    lazygit = 1080,
    ["lego.json"] = 511,
    ["lerna.json"] = 512,
    ["lgtm.yml"] = 513,
    ["liblab.config.json"] = 514,
    ["libman.json"] = 515,
    ["license-report-config.json"] = 516,
    ["linkinator.config.json"] = 518,
    ["lint-staged (.lintstagedrc)"] = 935,
    ["local.settings.json"] = 523,
    ["localazy.json"] = 524,
    ["lotus.yaml"] = 522,
    ["lsdlschema.json"] = 525,
    ["macro.json"] = 1047,
    ["markdown-link-check"] = 1001,
    maturin = 1002,
    mboats = 1009,
    ["micro-settings.json"] = 1074,
    ["mimetypes.json"] = 540,
    ["mirrord config"] = 937,
    mise = 938,
    ["mkdocs.yml"] = 560,
    ...
    ["monospace.yml"] = 565,
    ["moon.yml"] = 1157,
    ["mprocs Configuration file"] = 1128,
    ["mrdocs.yml"] = 562,
    ["mta.yaml"] = 939,
    ["mtad.yaml"] = 940,
    ["mycode.json"] = 572,
    nFPM = 579,
    ["napari plugin manifest"] = 573,
    neoload = 952,
    ["nest-cli"] = 582,
    ["nexus-rpc-gen"] = 1247,
    ["ninjs (News in JSON)"] = 581,
    ["nitro.json"] = 951,
    ["nixd configuration"] = 1100,
    ["nlu.json"] = 583,
    ["nodemon.json"] = 585,
    ["noodl config"] = 1008,
    ["notebook.mod.json"] = 586,
    now = 947,
    ["npm-badges"] = 589,
    ["nswag.json"] = 593,
    ntangle = 595,
    ["nuclei-template.yaml"] = 590,
    ["nuget-project.json"] = 591,
    ["ocelot.json"] = 597,
    ogen = 600,
    ["omnisharp.json"] = 603,
    openHAB = 1233,
    ...
    oxlint = 1244,
    ["package.json"] = 637,
    ["package.manifest"] = 639,
    ["package.yaml"] = 638,
    ["partial-black.json"] = 143,
    ["partial-pixi.json"] = 647,
    ["pattern.json"] = 645,
    ["petstore-v1.0"] = 1054,
    pgap_yaml_input_reader = 644,
    pgxgen = 1237,
    pitcms = 1240,
    ["pixi.toml"] = 646,
    ["plagiarize-me.yaml"] = 651,
    ["plagiarize.yaml"] = 650,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1164,
    ["podbard.yaml"] = 653,
    ["portman.json"] = 656,
    ["prefect.toml"] = 664,
    ["prefect.yaml"] = 665,
    ...
    ["prettierrc.json"] = 667,
    ["prisma.yml"] = 668,
    ["project-1.0.0-beta3.json"] = 680,
    ["project-1.0.0-beta4.json"] = 681,
    ["project-1.0.0-beta5.json"] = 682,
    ["project-1.0.0-beta6.json"] = 683,
    ["project-1.0.0-beta8.json"] = 684,
    ["project-1.0.0-rc1.json"] = 685,
    ["project-1.0.0-rc2.json"] = 686,
    ["project.json"] = 679,
    ["project.owasp.yaml"] = 687,
    ["prometheus-alertmanager.json"] = 691,
    ["prometheus.json"] = 688,
    ["prometheus.rules.json"] = 689,
    ["prometheus.rules.test.json"] = 690,
    ["proxies.json"] = 692,
    ["publiccode.yml"] = 693,
    ["pubspec.yaml"] = 694,
    ["pyrseas-0.8.json"] = 697,
    pytest = 706,
    ["quilt.mod.json"] = 1075,
    ["rc3 auth"] = 712,
    ["rc3 collection"] = 713,
    ...
    ["release drafter"] = 953,
    ["release-hub.json"] = 2,
    ["release-please-config.json"] = 722,
    ["release-please-manifest.json"] = 723,
    ["release-plz.toml"] = 724,
    ["renv.lock"] = 736,
    ["rivet.json"] = 1099,
    ["rivet.yaml (legacy)"] = 1098,
    rumdl = 741,
    runny = 740,
    rustfmt = 742,
    sake = 1191,
    samt = 744,
    samtrc = 745,
    ["sarif-1.0.0.json"] = 747,
    ["sarif-2.0.0.json"] = 748,
    ["sarif-2.1.0"] = 758,
    ["sarif-2.1.0-rtm.2"] = 749,
    ["sarif-2.1.0-rtm.3"] = 751,
    ["sarif-2.1.0-rtm.4"] = 753,
    ["sarif-2.1.0-rtm.5"] = 755,
    ["sarif-2.1.0-rtm.6"] = 756,
    ["sarif-external-property-file-2.1.0"] = 759,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 750,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 752,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 754,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 757,
    ["scalingo.json configuration"] = 760,
    ["schema.org - Action"] = 762,
    ["schema.org - ContactPoint"] = 763,
    ["schema.org - Place"] = 764,
    ["schema.org - Thing"] = 765,
    ["secrethub.yml"] = 1077,
    ["semantic-release"] = 772,
    ["servicehub.config.json"] = 930,
    ["servicehub.service.json"] = 929,
    ["settings.job"] = 775,
    ["sfdx-hardis configuration"] = 777,
    ["shard.yml"] = 1115,
    ["size-limit configuration"] = 782,
    ["skaffold.yaml"] = 999,
    ["skyuxconfig.json"] = 784,
    ["snowflake-config"] = 786,
    ["snowflake-connections"] = 787,
    ["spicepod.yaml"] = 1136,
    ["sqlc configuration"] = 819,
    ["stripe-app-local.json"] = 830,
    ["stripe-app.json"] = 829,
    swcrc = 984,
    ["task.json"] = 839,
    taskcat = 948,
    ["template.json"] = 844,
    ["templatsources.json"] = 845,
    ["text2confl config"] = 1245,
    ["theme.json"] = 848,
    ["tizen_workspace.json"] = 850,
    tldr = 851,
    ["tm_devices configuration file"] = 1202,
    tmuxinator = 933,
    tox = 853,
    ["transcend.yml"] = 862,
    ...
    ["vega-lite.json"] = 894,
    ["vega.json"] = 893,
    ["venvironment.yaml"] = 896,
    ["venvplus.yaml"] = 897,
    version = 1184,
    ["version.json"] = 899,
    ["vhwdebugger-binding.yaml"] = 901,
    ["vim-addon-info"] = 902,
    ["vs-2017.3.host.json"] = 904,
    ["vs-nesting.json"] = 905,
    ["vsls.json"] = 903,
    ["vss-extension.json"] = 909,
    vtcfg = 1190,
    ["vtesttree.yaml"] = 910,
    ["vtestunit.yaml"] = 911,
    ["warp-keysets.json"] = 1083,
    ["warp-themes.json"] = 1084,
    ["warp-workflows.json"] = 1085,
    ["webhint.io"] = 1039,
    ["webjobpublishsettings.json"] = 916,
    ["webjobs-list.json"] = 915,
    ["well-known-fursona"] = 1123,
    ["xs-app.json"] = 943,
    ["xunit.runner.json"] = 928,
    yamllint = 971,
    zizmor = 1227,
    zuul = 954,
    ["Žinoma"] = 964
