...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 165,
    [".cryproj (generic)"] = 570,
    [".cryproj engine-5.2"] = 565,
    [".cryproj engine-5.3"] = 566,
    [".cryproj engine-5.4"] = 567,
    [".cryproj engine-5.5"] = 568,
    [".cryproj engine-dev"] = 569,
    [".csscomb.json"] = 167,
    [".csslintrc"] = 168,
    [".es6importsorterrc.json"] = 697,
    [".eslintrc"] = 214,
    [".esmrc.json"] = 206,
    [".ffizer.yaml"] = 218,
    [".htmlhintrc"] = 265,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration Schema"] = 642,
    ["All Contributors configuration file"] = 696,
    ...
    ["Better Code Hub"] = 615,
    ["Better Scripts"] = 90,
    BizTalkServerApplicationSchema = 585,
    ...
    ["Butane Config"] = 654,
    ["CICS TS region tagging"] = 661,
    ["CICS TS resource import"] = 662,
    ["CICS TS resource model"] = 663,
    ["CICS TS resource overrides"] = 664,
    ["CMake Presets"] = 91,
    ...
    ["Datahub Ingestion Recipe Schema"] = 668,
    ...
    ["Embrace Config Schema"] = 679,
    ["Error pages"] = 209,
    Esquio = 207,
    ["Estuary Flow Catalog Schema"] = 658,
    ["Expo SDK"] = 212,
    ...
    Goreleaser = 247,
    ["Goreleaser Pro"] = 248,
    ["Gradle Build Cache Node"] = 612,
    ["Gradle Enterprise"] = 611,
    ...
    Hadolint = 594,
    Hammerkit = 622,
    ["Hardware Sentry Configuration"] = 672,
    Hayson = 260,
    ...
    ["JFrog File Spec"] = 284,
    ["JFrog Pipelines YML DSL"] = 681,
    ["JMeter DSL cli config schema"] = 285,
    JReleaser = 287,
    ["JSON Document Transform"] = 294,
    ["JSON Feed"] = 295,
    ["JSON Resume"] = 439,
    ["JSON Schema Draft 2020-12"] = 561,
    ["JSON Schema Draft 4"] = 558,
    ["JSON Schema Draft 7"] = 559,
    ["JSON Schema Draft 8"] = 560,
    ...
    Kas = 300,
    ["Keycloak REST API"] = 688,
    ["Knative Functions - func.yaml"] = 229,
    ["KoDE/CI build.yaml"] = 677,
    ["Kong DBLess Schema"] = 678,
    KrakenD = 301,
    LOOBin = 317,
    Lefthook = 308,
    ["LinkML Metamodel"] = 315,
    Liquibase = 627,
    ["Liquibase Flow File"] = 628,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 676,
    ["Monika Configuration Schema"] = 674,
    ["Motif config"] = 578,
    ["NOX Framework (Service)"] = 362,
    ["Netin Diagnostic System Template"] = 637,
    ...
    ["OpenWeather Current Weather API"] = 619,
    ["OpenWeather Road Risk API"] = 618,
    ...
    Pyright = 428,
    Qodana = 647,
    ["Quali Torque Blueprint Spec 2"] = 669,
    ["QueryFirst config file"] = 691,
    ["RKE Cluster Configuration JSON Schema"] = 626,
    ["RKE Cluster Configuration YAML Schema"] = 625,
    ["Rancher Fleet"] = 423,
    Ray = 593,
    ["Read the Docs"] = 425,
    ...
    SWADL = 496,
    ["Safebox Config Schema"] = 682,
    ["Sapphire CLI Config"] = 446,
    ["SauceCTL Configuration"] = 634,
    ["Schema Catalog"] = 459,
    ["Scoop manifest"] = 464,
    ["Semantic Data Fabric (SDF) file"] = 465,
    ["Semgrep Rule"] = 467,
    ["Serenity Code Generator (Sergen)"] = 468,
    ["Serverless Framework Configuration"] = 641,
    ["Serverless Workflow Schema"] = 643,
    ["Settings.paf"] = 470,
    ["Shopware 6 Configuration"] = 644,
    ["Shopware CLI Extension Store Configuration"] = 645,
    ["Shopware CLI Project Store Configuration"] = 646,
    ...
    ["StackHawk Scanner Configuration"] = 640,
    Stale = 488,
    Starship = 489,
    ["Statamic Blueprint"] = 490,
    ["StrmPrivacy Data Connector"] = 686,
    ["StrmPrivacy Data Contract"] = 687,
    ["StrmPrivacy SimpleSchema"] = 684,
    ["StrmPrivacy Stream"] = 685,
    ["StrmPrivacy batch job configuration file"] = 683,
    ["Stryker Mutator"] = 493,
    ["StyleCop Analyzers Configuration"] = 494,
    ["Swagger API 2.0"] = 497,
    TSON = 521,
    ["Talisman configuration"] = 499,
    ["Taskfile YAML Schema"] = 621,
    Taurus = 500,
    ...
    Turborepo = 510,
    Tye = 648,
    ["UET BuildConfig.json"] = 692,
    ["UI5 Manifest"] = 528,
    ["UTAM Page Object"] = 531,
    ["Ubuntu Server Autoinstall"] = 526,
    ["Uniswap Token List"] = 603,
    ["Unreal Engine Uplugin"] = 693,
    ["Unreal Engine Uproject"] = 694,
    Updatecli = 655,
    Uplift = 690,
    ["User Journey Map YAML Schema"] = 624,
    V2Ray = 659,
    ["VSCode Code Snippets"] = 137,
    ["VSIX CLI publishing"] = 544,
    ["Vela Pipeline Configuration"] = 534,
    Vercel = 136,
    ["Web App Manifest"] = 551,
    ["Web types"] = 554,
    WebExtensions = 550,
    ["Webman package recipe"] = 665,
    ["Windows Package Manager Installer Manifest"] = 600,
    ["Windows Package Manager Locale Manifest"] = 601,
    ["Windows Package Manager Singleton Manifest"] = 599,
    ["Woodpecker pipeline config"] = 636,
    ["Xstate Machine Schema"] = 653,
    ["Yippee-Ki-JSON configuration YML"] = 605,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 65,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 701,
    ["bashly-strings.yml"] = 702,
    ["bashly.yml"] = 700,
    ["batect.yml"] = 64,
    ["beau.yml"] = 614,
    ...
    ["ize.toml"] = 689,
    ["jsconfig.json"] = 298,
    ["jscpd Configuration Schema"] = 670,
    jsdoc = 592,
    ["k3d.yaml"] = 299,
    ...
    ["lsdlschema.json"] = 321,
    ["madness.yml"] = 699,
    ["markdown-lint-check"] = 632,
    mboats = 639,
    ["micro-settings.json"] = 703,
    ["mimetypes.json"] = 328,
    ["mirrord-schema"] = 575,
    ["mta.yaml"] = 576,
    ["mtad.yaml"] = 577,
    ...
    ["servicehub.config.json"] = 564,
    ["servicehub.service.json"] = 563,
    ["settings.job"] = 469,
    ...
    tmuxinator = 572,
    ["transcend.yml"] = 514,
    ["trunk.yaml schema"] = 515,
    ["ts-force-config.json"] = 519,
    ["tsconfig.json"] = 516,
    ["tsd.json"] = 517,
    ["tsdrc.json"] = 518,
    ["tslint.json"] = 520,
    ...
    ["vega-lite.json"] = 533,
    ["vega.json"] = 532,
    ["venvironment-basic.yaml"] = 536,
    ["venvironment.yaml"] = 535,
    ["version.json"] = 537,
    ["vim-addon-info"] = 538,
    ["vs-2017.3.host.json"] = 540,
    ["vs-nesting.json"] = 541,
    ["vsls.json"] = 539,
    ["vss-extension.json"] = 545,
    ["vtesttree.yaml"] = 546,
    ["vtestunit.yaml"] = 547,
    ["webhint.io"] = 666,
    ["webjobpublishsettings.json"] = 553,
    ["webjobs-list.json"] = 552,
    ["xs-app.json"] = 580,
    ["xunit.runner.json"] = 562,
    yamllint = 604,
    zuul = 589,
    ["Žinoma"] = 598
  },
