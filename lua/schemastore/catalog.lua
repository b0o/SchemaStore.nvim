...
M.json = {
  ...
  index = {
    ...
    [".pmbot.yml"] = 524,
    [".postcssrc"] = 530,
    [".powerpages-web-template-manifest"] = 532,
    [".pre-commit-config.yml"] = 533,
    [".pre-commit-hooks.yml"] = 534,
    [".putout.json"] = 555,
    [".rehyperc"] = 574,
    [".remarkrc"] = 576,
    [".sprite files"] = 638,
    ...
    ["<div>RIOTS' studio configuration"] = 718,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 430,
    ABCInventoryModuleData = 13,
    ABCSupplyPlan = 14,
    AIConfig = 15,
    ["API Builder"] = 778,
    ["AVA Configuration"] = 838,
    ["AWS AppConfig Feature Flags-v1"] = 39,
    ["AWS CDK cdk.json"] = 190,
    ["AWS CloudFormation"] = 191,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 192,
    ["AWS SAM CLI Samconfig"] = 193,
    ["Adobe UXP Manifest"] = 898,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Airplane task"] = 17,
    ["Alacritty Configuration"] = 810,
    ["All Contributors configuration file"] = 863,
    ["Ansible Argument Specs"] = 319,
    ["Ansible Collection Galaxy"] = 326,
    ["Ansible Execution Environment"] = 316,
    ["Ansible Inventory"] = 325,
    ["Ansible Meta"] = 317,
    ["Ansible Meta Runtime"] = 318,
    ["Ansible Navigator Configuration"] = 328,
    ["Ansible Playbook"] = 323,
    ["Ansible Requirements"] = 320,
    ["Ansible Rulebook"] = 324,
    ["Ansible Tasks File"] = 322,
    ["Ansible Vars File"] = 321,
    ["Ansible-lint Configuration"] = 327,
    Any = 925,
    ["AnyWork Automation Configuration"] = 5,
    ["App config Spotify Backstage"] = 21,
    ["Application Accelerator"] = 2,
    ["Application list for a WinUtil"] = 942,
    ArchitectFX = 946,
    ["Argo Events"] = 29,
    ["Argo Workflows"] = 30,
    AssemblyScript = 33,
    ...
    ["Azure Pipelines"] = 64,
    ["Azure Static Web Apps CLI configuration file"] = 641,
    ["Azure Static Web Apps configuration file"] = 640,
    ["BOSH Deploy Config"] = 88,
    ["BX CI"] = 105,
    ["Bashly (bashly.yml)"] = 867,
    ["Bashly Settings (bashly-settings.yml)"] = 868,
    ["Better Code Hub"] = 782,
    ["Better Scripts"] = 106,
    Bigconfig = 81,
    BizTalkServerApplicationSchema = 752,
    Bleep = 107,
    ...
    ["Butane Config"] = 823,
    ["CGS Custom Card Game (CardGameDef.json)"] = 903,
    ["CICS TS region tagging"] = 832,
    ["CICS TS resource import"] = 833,
    ["CICS TS resource model"] = 834,
    ["CICS TS resource overrides"] = 835,
    ["CMake Presets"] = 108,
    ["CNC Codes"] = 122,
    ["CRS WAF test file"] = 932,
    ["CRS WAF test platform overrides file"] = 933,
    ["CSS Comb (.csscomb.json)"] = 217,
    ["CSS Lint (.csslintrc)"] = 218,
    ["CSpell (cspell.json)"] = 216,
    ["CVE Record Format"] = 128,
    CWL = 909,
    ...
    ["Cargo Make"] = 114,
    ["Cargo Manifest"] = 113,
    ["Catalog Info Backstage"] = 115,
    Changesets = 202,
    Cheatsheets = 820,
    ["Chrome Extension"] = 183,
    ["Chromia Model"] = 116,
    ["CircleCI config.yml"] = 159,
    ["Citation File Format"] = 204,
    CityJSON = 118,
    ["Clawject config"] = 127,
    ["Cloud Foundry Application Manifest"] = 915,
    ["Cloud Run Spec v1"] = 937,
    ["CloudEvents specification"] = 119,
    ["Code Climate"] = 160,
    CodeCV = 59,
    CodeRabbit = 58,
    ["CodeShip Pro services configuration files"] = 172,
    ["CodeShip Pro steps configuration files"] = 173,
    ["Codecov configuration files"] = 171,
    CodifyCLI = 60,
    Codux = 169,
    ["Cog config file"] = 123,
    ["Commandbox Box.json"] = 124,
    ["Commandbox Server.json"] = 125,
    ["Common Catalog Data"] = 181,
    Concord = 931,
    ["Configu .cfgu files"] = 920,
    ["Configu .configu file"] = 921,
    Conjure = 121,
    ["Container Structure Test"] = 765,
    Containerlab = 790,
    ["Crowdsec collection config"] = 211,
    ["Crowdsec parser config"] = 212,
    ["Crowdsec scenario config"] = 213,
    ["CumulusCI Config"] = 126,
    ["Custom Machinery Machine"] = 904,
    ["Custom Machinery Recipe"] = 905,
    ["Cycle Stack File"] = 129,
    ["DWP Exchange - catalogue entry"] = 259,
    ["DWP Exchange - gateway"] = 257,
    ["DWP Exchange - meta"] = 258,
    ["Dart Build Config (dart-build.json)"] = 219,
    ["Dart Test Config (dart-test.json)"] = 220,
    ["DashLord Configuration"] = 221,
    ["Data Contract Specification"] = 222,
    ["Data Product Specification"] = 223,
    ["DataYoga Connections"] = 130,
    ["DataYoga Job"] = 131,
    ["Databricks Asset Bundles"] = 884,
    ["Datadog Service Definition"] = 404,
    ["Datadog Software Catalog"] = 405,
    ["Datahub Ingestion Recipe"] = 839,
    ["Dein Config"] = 137,
    ["Deno Config (deno.json)"] = 229,
    ["Dependency cruiser"] = 138,
    ["Deployer Recipe"] = 232,
    ["Deta Spacefile"] = 139,
    ["Detekt Config (detekt.yml)"] = 233,
    ["Devbox Config"] = 140,
    ["Devbox Plugin"] = 141,
    Devfile = 256,
    DipDup = 934,
    ["Discord Webhook"] = 234,
    ["DocFx Config (docfx.json)"] = 238,
    ["Dolittle Artifacts"] = 239,
    ["Dolittle Bounded Context Configuration"] = 240,
    ["Dolittle Event Horizons Configuration"] = 241,
    ["Dolittle Resources Configuration"] = 242,
    ["Dolittle Server Configuration"] = 243,
    ["Dolittle Tenant Map Configuration"] = 245,
    ["Dolittle Tenants Configuration"] = 244,
    ["Dolittle Topology"] = 246,
    ["Drupal Breakpoints"] = 142,
    ["Drupal Config"] = 154,
    ["Drupal Info"] = 143,
    ["Drupal Layouts"] = 144,
    ["Drupal Libraries"] = 145,
    ["Drupal Links Action"] = 146,
    ["Drupal Links Contextual"] = 147,
    ["Drupal Links Menu"] = 148,
    ["Drupal Links Task"] = 149,
    ["Drupal Migration"] = 150,
    ["Drupal Permissions"] = 151,
    ["Drupal Recipe"] = 152,
    ["Drupal Routing"] = 153,
    ["Drupal Services"] = 155,
    ["Drush site aliases"] = 252,
    ["Dynamic Bash Aliases (.aliases)"] = 875,
    ["EAS config"] = 277,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 864,
    ["Eidolon Resource"] = 947,
    ["Elgato Stream Deck"] = 262,
    Elm = 936,
    ["Embrace Config"] = 850,
    Endurica = 888,
    ["Enterprise Contract Policy Spec"] = 263,
    ["Erda Pipeline"] = 911,
    ["Erda Runtime"] = 912,
    ["Error pages"] = 267,
    Esquio = 265,
    ["Estuary Flow Catalog"] = 829,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 270,
    ["EveryVoice TTS Toolkit Data Configuration"] = 271,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 275,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 274,
    ["EveryVoice TTS Toolkit Text Configuration"] = 272,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 273,
    ["Expo SDK"] = 276,
    ["F-Droid Data metadata"] = 282,
    ["Facets - FSDL - Application"] = 280,
    ["FasterCI Configuration"] = 65,
    FiQuS = 286,
    Firebase = 284,
    ["Flow.json Configurations"] = 908,
    ["Fossa configuration file"] = 293,
    ["Fossa's fossa-deps file"] = 294,
    ["Foundry VTT - Base package Manifest"] = 288,
    ["Foundry VTT - Module Manifest"] = 289,
    ["Foundry VTT - System Data Template"] = 292,
    ["Foundry VTT - System Manifest"] = 290,
    ["Foundry VTT - World Manifest"] = 291,
    ["Foxx Manifest"] = 66,
    ["Freifunk.de Community API"] = 69,
    ["Frogbot Config"] = 70,
    ["G2P Mapping Configuration"] = 298,
    ["GCP Blueprint Metadata"] = 301,
    Gaspar = 299,
    ["GatewayCore API Gateway"] = 300,
    ["GeoJSON.json latest"] = 827,
    GherKing = 831,
    ["GitHub Action"] = 306,
    ["GitHub Discussion"] = 307,
    ["GitHub Funding"] = 308,
    ["GitHub Issue Template configuration"] = 310,
    ["GitHub Issue Template forms"] = 309,
    ["GitHub Workflow"] = 311,
    ["GitHub Workflow Template Properties"] = 312,
    ["GitHub automatically generated release notes configuration"] = 313,
    ["GitLab Agent for Kubernetes configuration"] = 900,
    GitVersion = 303,
    ["Gitea Issue Template configuration"] = 304,
    ["Gitea Issue Template forms"] = 305,
    ["Gitpod Configuration"] = 315,
    ["GlazeWM settings"] = 902,
    ["Global Privacy Control"] = 302,
    Goblet = 883,
    ["Golangci-lint Configuration"] = 330,
    ["Golangci-lint Custom Plugins Configuration"] = 331,
    ["Google Chrome Related Website Sets"] = 285,
    ["Google Cloud Workflows"] = 189,
    Goreleaser = 333,
    ["Goreleaser Pro"] = 334,
    Goss = 335,
    ["Gradle Build Cache Node"] = 780,
    ["Gradle Enterprise"] = 779,
    ["Grafana 5.x Dashboard"] = 336,
    ["GraphQL Code Generator"] = 340,
    ["GraphQL Config"] = 339,
    ["GraphQL Mesh"] = 338,
    ["Grunt JSHint task"] = 344,
    ["Grunt Watch task"] = 345,
    ["Grunt base task"] = 346,
    ["Grunt clean task"] = 342,
    ["Grunt copy task"] = 341,
    ["Grunt cssmin task"] = 343,
    HEMTT = 749,
    Hadolint = 761,
    Hammerkit = 789,
    ["Hardware Sentry Configuration"] = 843,
    Hatch = 762,
    Hayson = 348,
    ["Haystack Pipeline"] = 349,
    ["Hazelcast 5 Configuration"] = 350,
    ["Helm Chart.lock"] = 157,
    ["Helm Chart.yaml"] = 156,
    ["Helm Unittest Test Suite"] = 158,
    Hugo = 819,
    ["Hugo Theme"] = 818,
    ["Hyperfoil benchmark configuration"] = 356,
    ["IBM Zapp document"] = 357,
    ["IBM zCodeFormatSettings"] = 358,
    ["IMG Catapult PSP"] = 363,
    ["IVMS101 by CODE Protocol"] = 901,
    Infrahub = 365,
    Istanbul = 846,
    ["JDownloader2 crawler multi-rules"] = 374,
    ["JDownloader2 crawler single-rules"] = 373,
    ["JFrog Applications Config"] = 375,
    ["JFrog File Spec"] = 376,
    ["JFrog Pipelines YML DSL"] = 852,
    ["JMeter DSL cli config"] = 377,
    JReleaser = 379,
    ["JSON Document Transform"] = 387,
    ["JSON Feed"] = 388,
    ["JSON Resume"] = 581,
    ["JSON Schema Draft 2020-12"] = 731,
    ["JSON Schema Draft 4"] = 728,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 885,
    ["JSON Schema Draft 7"] = 729,
    ["JSON Schema Draft 7 (unofficial strict)"] = 886,
    ["JSON Schema Draft 8 (2019-09)"] = 730,
    ["JSON-API"] = 386,
    ["JSON-WF"] = 914,
    ["JSON-e templates"] = 787,
    ["JSON-stat 2.0"] = 725,
    JSONPatch = 390,
    ["JSR Package Config (jsr.json)"] = 380,
    Jasmine = 369,
    Jekyll = 370,
    ["Jenkins X Pipelines"] = 371,
    ["Jenkins X Requirements"] = 372,
    ["Jovo Language Models"] = 378,
    ["KIMMDY config file"] = 401,
    ["KSP-AVC"] = 726,
    ["KSP-CKAN"] = 727,
    KSY = 913,
    ["Karakum configuration file"] = 295,
    Kas = 393,
    ["Kestra flow file"] = 402,
    ["Keycloak REST API"] = 855,
    ["Knative Functions - func.yaml"] = 296,
    ["KoDE/CI build.yaml"] = 848,
    ["Kong DBLess config"] = 849,
    KrakenD = 403,
    ["Kubri Configuration"] = 409,
    LOOBin = 424,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 194,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 195,
    ["Landing Zone Accelerator on AWS - Global Config"] = 196,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 197,
    ["Landing Zone Accelerator on AWS - Network Config"] = 198,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 199,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 200,
    ["Landing Zone Accelerator on AWS - Security Config"] = 201,
    ["Language configuration"] = 924,
    Lefthook = 413,
    ["Liferay client-extension.yaml"] = 420,
    ["LinkML Metamodel"] = 422,
    Liquibase = 795,
    ["Liquibase Flow File"] = 796,
    ["Lively Properties"] = 423,
    ["Lobe AI Agent"] = 62,
    Loki = 63,
    ["MLOS Configs"] = 460,
    ["MS2Rescore Configuration"] = 463,
    ["Madness (madness.yml)"] = 866,
    ["MapEHR Mapping"] = 429,
    Markdownlint = 799,
    ["Mason Registry"] = 801,
    ["MegaLinter configuration"] = 431,
    ["MegaLinter descriptor"] = 432,
    Melange = 892,
    ["Meltano plugin discovery definition"] = 434,
    ["Meltano project definition"] = 433,
    ["Mergify Configuration"] = 464,
    ["Metadata for a Bazel module"] = 435,
    ["Metadata for a Cinnamon spice"] = 940,
    ["MetricsHub Configuration"] = 436,
    ["MetricsHub Connector Configuration"] = 437,
    ["Micro Editor Syntax"] = 876,
    ["Microsoft Band Web Tile"] = 438,
    ["Microsoft RulesEngine workflow rules"] = 928,
    ["Microsoft RulesEngine workflow rules list"] = 929,
    ["Minecraft Custom Main Menu Mod"] = 893,
    ...
    ["MongoDB Atlas Search Index Definition"] = 847,
    ["Monika Configuration"] = 845,
    ["Monoweave Configuration"] = 462,
    ["Motif config"] = 745,
    ["NOX Framework (Service)"] = 479,
    ["Netin Diagnostic System Template"] = 805,
    ["Netlify config"] = 470,
    ["Network-as-Code Data Model"] = 471,
    ["Nightwatch.js"] = 472,
    ["Nuitka.yaml"] = 906,
    ["ONe's changelog entry"] = 495,
    ["ONe's service descriptor"] = 494,
    ["OSCAL Assessment Plan (AP)"] = 503,
    ["OSCAL Assessment Results (AR)"] = 504,
    ["OSCAL Catalog"] = 505,
    ["OSCAL Component Definition (CDef)"] = 506,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 507,
    ["OSCAL Profile"] = 508,
    ["OSCAL System Security Plan (SSP)"] = 509,
    ["OSS Review Toolkit configuration"] = 510,
    ["OSS Review Toolkit curation"] = 511,
    ["OSS Review Toolkit package configuration"] = 512,
    ["OSS Review Toolkit repository configuration"] = 513,
    ["OSS Review Toolkit resolutions"] = 514,
    Opctl = 748,
    ["Open Data Contract Standard (ODCS))"] = 498,
    ["OpenRewrite Resource"] = 497,
    ["OpenUtau character yaml"] = 491,
    ["OpenUtau ustx"] = 492,
    ["OpenWeather Current Weather API"] = 786,
    ["OpenWeather Road Risk API"] = 785,
    ["Ory Hydra configuration"] = 355,
    ["Ory Keto configuration"] = 406,
    ["Ory Kratos configuration"] = 502,
    ["Ory Oathkeeper configuration"] = 486,
    ["Outblocks App configuration"] = 500,
    ["Outblocks database table"] = 501,
    ["Outblocks project configuration"] = 499,
    PDM = 520,
    Packer = 517,
    Pantsbuild = 862,
    ["Paper paper-plugin.yml"] = 518,
    ["Pipeline component"] = 797,
    ["PocketMine plugin.yml"] = 525,
    ["Postman collection"] = 531,
    ["Preset list for a WinUtil"] = 943,
    ["Problem object RFC9457"] = 890,
    ["Problem package generators"] = 539,
    Pterodactyl = 842,
    ["Pull Request Labeler"] = 554,
    Pulumi = 560,
    PyProject = 561,
    Pyright = 562,
    Qgoda = 563,
    Qodana = 815,
    ["Qt Creator workspace file"] = 922,
    ["Quali Torque Blueprint Spec 2"] = 840,
    ["QueryFirst config file"] = 858,
    ["RKE Cluster Configuration JSON"] = 794,
    ["RKE Cluster Configuration YAML"] = 793,
    ["Rancher Fleet"] = 557,
    ["Rattler-build"] = 564,
    Ray = 760,
    ["Read the Docs"] = 559,
    ["Red-DiscordBot Cog"] = 571,
    ["Red-DiscordBot Cog Repo"] = 572,
    ["Red-DiscordBot Trivia"] = 573,
    ["Render Blueprints"] = 792,
    RenderCV = 583,
    Renovate = 582,
    ["Replit config"] = 577,
    RoadRunner = 584,
    ["Rudder techniques"] = 896,
    Ruff = 579,
    ["Rust Project"] = 580,
    ["Rust toolchain"] = 588,
    ["SDMX data message"] = 613,
    ["SDMX metadata message"] = 612,
    ["SDMX structure message"] = 611,
    ["SIL Kit Participant Configuration"] = 623,
    ["SIL Kit Registry Configuration"] = 624,
    SWADL = 652,
    ["Safebox Config"] = 853,
    ["Sapphire CLI Config"] = 591,
    ["SauceCTL Configuration"] = 802,
    ["Schema Catalog"] = 605,
    ["Scoop manifest"] = 610,
    ["Semantic Data Fabric (SDF) file"] = 614,
    ["Semgrep Rule"] = 616,
    ["Serenity Code Generator (Sergen)"] = 617,
    ["Serverless Framework Configuration"] = 809,
    ["Serverless Workflow"] = 811,
    ["Settings for a Cinnamon spice"] = 939,
    ["Settings.paf"] = 619,
    ["Shopware 6 Configuration"] = 812,
    ["Shopware CLI Extension Store Configuration"] = 813,
    ["Shopware CLI Project Store Configuration"] = 814,
    ["Sigma Detection Rule"] = 621,
    ["Sigrid scope configuration file"] = 622,
    ["SkyPilot Task JSON"] = 897,
    ["Slack app manifest"] = 626,
    Solidarity = 629,
    ["Solution filters"] = 630,
    ["Source Maps v3"] = 631,
    Sourcery = 632,
    ["Speakeasy Lint Configuration File"] = 633,
    ["Speakeasy Test Generation Configuration File"] = 634,
    ["Speakeasy Workflow File"] = 635,
    SpecIF = 636,
    ["Sponge Mixin configuration"] = 637,
    StackBlitz = 642,
    ["StackHawk Scanner Configuration"] = 808,
    Stale = 643,
    ["Starlake Data Pipeline"] = 783,
    Starship = 644,
    ["Statamic Blueprint"] = 645,
    ["Stella configuration file"] = 646,
    ["Stryker Mutator"] = 649,
    ["StyleCop Analyzers Configuration"] = 650,
    ["Stylelint (.stylelintrc)"] = 651,
    ["Sublime Syntax"] = 854,
    ["Subsquid squid manifest"] = 899,
    ["Swagger API 2.0"] = 653,
    TSON = 682,
    TSTyche = 683,
    ["Tab data for a LinUtil"] = 945,
    ["Tab list for a LinUtil"] = 944,
    Talhelper = 655,
    ["Talisman configuration"] = 656,
    ["Taskfile config"] = 788,
    Taurus = 657,
    Tauticord = 658,
    ["TestEnvironment.json"] = 667,
    ["TextMate Grammar"] = 666,
    ["Tier.run pricing.json"] = 661,
    Tikibase = 662,
    ["Traefik v2"] = 670,
    ["Traefik v2 File Provider"] = 671,
    ["Travis CI (.travis.yml)"] = 669,
    ["TrueScript for *.tscript files"] = 674,
    TunnelHub = 889,
    Turborepo = 668,
    Tycho = 935,
    Tye = 816,
    ["UET BuildConfig.json"] = 859,
    ["UI5 Manifest"] = 692,
    ["UNCORS configuration"] = 696,
    ["UTAM Page Object"] = 695,
    ["Ubuntu Server Autoinstall"] = 690,
    ["Uniswap Token List"] = 771,
    ["Unreal Engine Uplugin"] = 860,
    ["Unreal Engine Uproject"] = 861,
    ["Updatecli Compose"] = 824,
    ["Updatecli Policy Manifest"] = 825,
    ["Updatecli Policy Metadata"] = 826,
    Uplift = 857,
    ["User Journey Map"] = 791,
    V2Ray = 830,
    ["VSCode Code Snippets"] = 177,
    ["VSIX CLI publishing"] = 713,
    ["Vela Pipeline Configuration"] = 700,
    Vercel = 176,
    ["Version Bumper config"] = 703,
    Visivo = 887,
    ["Waku Config"] = 948,
    ["Web App Manifest"] = 720,
    ["Web types"] = 723,
    WebExtensions = 719,
    ["Webman package recipe"] = 836,
    ["Windows Package Manager Installer Manifest"] = 768,
    ["Windows Package Manager Locale Manifest"] = 769,
    ["Windows Package Manager Singleton Manifest"] = 767,
    ["Woodpecker pipeline config"] = 804,
    ["Wrangler CLI"] = 724,
    ["Xstate Machine"] = 822,
    ["Yandex Workflow Language"] = 941,
    ["Yarn Config (.yarnrc.yml)"] = 781,
    ["Yippee-Ki-JSON configuration YML"] = 773,
    ["YouTrack App"] = 938,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 18,
    apko = 891,
    ...
    ["behat.yml"] = 90,
    ["bigquery-table"] = 80,
    ["bioimageio resource description"] = 907,
    ...
    ["chutzpah.json"] = 185,
    cibuildwheel = 117,
    ["clang-format (.clang-format)"] = 828,
    ["clang-tidy"] = 164,
    clangd = 163,
    clib = 165,
    ["cloud-init: cloud-config userdata"] = 167,
    ["cloud-sdk-pipeline-configuration"] = 187,
    ["cloudbuild.json"] = 188,
    cloudify = 166,
    codemagic = 168,
    ["coffeelint.json"] = 205,
    ["commands.json"] = 180,
    ["commitlint (.commitlintrc)"] = 770,
    ["compile_commands.json"] = 179,
    ["compilerconfig.json"] = 178,
    ["completely.yml"] = 865,
    ["component-detection-manifest.json"] = 208,
    ["component.json"] = 207,
    ["composer.json"] = 206,
    ["conda-forge"] = 120,
    ["config.yaml"] = 558,
    ["contentmanifest.json"] = 186,
    ["contribute.json"] = 209,
    ["cosmos.config.json"] = 182,
    ["crowdin.yml"] = 210,
    ["custom-elements.json"] = 879,
    ["cypress.json"] = 214,
    ["datalogic-scan2deploy-android"] = 224,
    ["datalogic-scan2deploy-ce"] = 225,
    ["dbt Dependencies"] = 132,
    ["dbt Packages"] = 134,
    ["dbt Project"] = 133,
    ["dbt Selectors"] = 135,
    ["dbt YAML files"] = 136,
    ["ddev-global"] = 226,
    ["ddev-project"] = 227,
    ["debugsettings.json"] = 228,
    ["dependabot-v2.json"] = 231,
    ["dependabot.json"] = 230,
    ["deployed-cli"] = 821,
    ["devcontainer.json"] = 170,
    devinit = 775,
    ["devspace.yaml"] = 844,
    djlint = 776,
    ["docker bake"] = 236,
    ["docker sequencer"] = 237,
    ["docker-compose.yml"] = 774,
    ["dockerd.json"] = 235,
    ["dotnet Release Index manifest"] = 247,
    ["dotnet-tools.json"] = 248,
    ["dotnetcli.host.json"] = 249,
    ["dprint.json"] = 250,
    ["drone.json"] = 251,
    ["dss-2.0.0.json"] = 253,
    ["dstack configuration"] = 254,
    ["dvc.yaml"] = 255,
    ["ecosystem.json"] = 260,
    eksctl = 261,
    ["electron-builder configuration file"] = 268,
    ["epr-manifest.json"] = 266,
    ["evcc.yaml"] = 269,
    ["ezd task runner"] = 278,
    ["fabric.mod.json"] = 281,
    ["first-timers-bot"] = 287,
    ...
    ["gitlab-ci"] = 314,
    ["global.json"] = 329,
    ["go-feature-flag Flag Configuration"] = 332,
    ["haxelib.json"] = 347,
    helmfile = 763,
    helmwave = 764,
    ["host-meta.json"] = 352,
    ...
    ["ide.host.json"] = 359,
    ["ifstate.conf"] = 360,
    ["imageoptimizer.json"] = 361,
    ["importmap.json"] = 364,
    ["ioBroker Configuration"] = 366,
    ["ioBroker JSON UI"] = 367,
    ["ioBroker Package manifest"] = 368,
    ["ize.toml"] = 856,
    ["jsconfig.json"] = 391,
    ["jscpd Configuration"] = 841,
    jsdoc = 759,
    ["k3d.yaml"] = 392,
    ["k9s aliases.yaml"] = 394,
    ["k9s cluster-config.yaml"] = 396,
    ["k9s config.yaml"] = 395,
    ["k9s hotkeys.yaml"] = 397,
    ["k9s plugins.yaml"] = 398,
    ["k9s skin.yaml"] = 399,
    ["k9s views.yaml"] = 400,
    ["kontinuous-config.yaml"] = 408,
    ["kontinuous-values.yaml"] = 407,
    ["kustomization.yaml"] = 410,
    ["label-commenter-config.yml"] = 411,
    ["latexindent configuration"] = 61,
    ["launchsettings.json"] = 412,
    lazydocker = 878,
    lazygit = 877,
    ["lego.json"] = 414,
    ["lerna.json"] = 415,
    ["lgtm.yml"] = 416,
    ["liblab.config.json"] = 417,
    ["libman.json"] = 418,
    ["license-report-config.json"] = 419,
    ["linkinator.config.json"] = 421,
    ["lint-staged (.lintstagedrc)"] = 739,
    ["local.settings.json"] = 426,
    ["localazy.json"] = 427,
    ["lotus.yaml"] = 425,
    ["lsdlschema.json"] = 428,
    ["markdown-link-check"] = 800,
    mboats = 807,
    ["micro-settings.json"] = 871,
    ["mimetypes.json"] = 439,
    ["mirrord config"] = 740,
    mise = 741,
    ["mise-settings"] = 742,
    ...
    ["ops.yaml"] = 493,
    ["package.json"] = 515,
    ["package.manifest"] = 516,
    ["partial-black.json"] = 91,
    ["pathfinder.yml"] = 519,
    ["pattern.json"] = 522,
    ["petstore-v1.0"] = 851,
    pgap_yaml_input_reader = 521,
    ["pixi.toml"] = 523,
    ["plagiarize-me.yaml"] = 527,
    ["plagiarize.yaml"] = 526,
    ["podbard.yaml"] = 528,
    ["portman.json"] = 529,
    ["prettierrc.json"] = 537,
    ["prisma.yml"] = 538,
    ["project-1.0.0-beta3.json"] = 541,
    ["project-1.0.0-beta4.json"] = 542,
    ["project-1.0.0-beta5.json"] = 543,
    ["project-1.0.0-beta6.json"] = 544,
    ["project-1.0.0-beta8.json"] = 545,
    ["project-1.0.0-rc1.json"] = 546,
    ["project-1.0.0-rc2.json"] = 547,
    ["project.json"] = 540,
    ["prometheus.json"] = 548,
    ["prometheus.rules.json"] = 549,
    ["prometheus.rules.test.json"] = 550,
    ["proxies.json"] = 551,
    ["publiccode.yml"] = 552,
    ["pubspec.yaml"] = 553,
    ["pyrseas-0.8.json"] = 556,
    ["quilt.mod.json"] = 872,
    ["rc3 auth"] = 565,
    ["rc3 collection"] = 566,
    ["rc3 environment"] = 567,
    ...
    samt = 589,
    samtrc = 590,
    ["sarif-1.0.0.json"] = 592,
    ["sarif-2.0.0.json"] = 593,
    ["sarif-2.1.0"] = 603,
    ["sarif-2.1.0-rtm.2"] = 594,
    ["sarif-2.1.0-rtm.3"] = 596,
    ["sarif-2.1.0-rtm.4"] = 598,
    ["sarif-2.1.0-rtm.5"] = 600,
    ["sarif-2.1.0-rtm.6"] = 601,
    ["sarif-external-property-file-2.1.0"] = 604,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 595,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 597,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 599,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 602,
    ["schema.org - Action"] = 606,
    ["schema.org - ContactPoint"] = 607,
    ["schema.org - Place"] = 608,
    ["schema.org - Thing"] = 609,
    ["secrethub.yml"] = 874,
    ["semantic-release"] = 615,
    ["servicehub.config.json"] = 734,
    ["servicehub.service.json"] = 733,
    ["settings.job"] = 618,
    ["sfdx-hardis configuration"] = 620,
    ["shard.yml"] = 910,
    ["size-limit configuration"] = 625,
    ["skaffold.yaml"] = 798,
    ["skyuxconfig.json"] = 627,
    snapcraft = 628,
    ["spicepod.yaml"] = 930,
    ["sqlc configuration"] = 639,
    ["stripe-app-local.json"] = 648,
    ["stripe-app.json"] = 647,
    swcrc = 784,
    ["task.json"] = 654,
    taskcat = 751,
    ["template.json"] = 659,
    ["templatsources.json"] = 660,
    ["theme.json"] = 663,
    ["tizen_workspace.json"] = 664,
    tldr = 665,
    tmuxinator = 737,
    ["transcend.yml"] = 672,
    ["tree-sitter grammar.json"] = 337,
    ["trime.yaml"] = 673,
    ["trunk.yaml"] = 675,
    ["ts-force-config.json"] = 680,
    ["tsconfig.json"] = 676,
    ["tsd.json"] = 677,
    ["tsdoc.json"] = 678,
    ["tsdrc.json"] = 679,
    ...
    v8r = 717,
    vcluster = 917,
    ["vcpkg configuration file"] = 175,
    ["vcpkg manifest file"] = 174,
    ["vega-lite.json"] = 699,
    ["vega.json"] = 698,
    ["venvironment-basic.yaml"] = 702,
    ["venvironment.yaml"] = 701,
    ["version.json"] = 704,
    ["vhwdebugger-binding.yaml"] = 706,
    ["vim-addon-info"] = 707,
    ["vs-2017.3.host.json"] = 709,
    ["vs-nesting.json"] = 710,
    ["vsls.json"] = 708,
    ["vss-extension.json"] = 714,
    ["vtesttree.yaml"] = 715,
    ["vtestunit.yaml"] = 716,
    ["warp-keysets.json"] = 880,
    ["warp-themes.json"] = 881,
    ["warp-workflows.json"] = 882,
    ["webhint.io"] = 837,
    ["webjobpublishsettings.json"] = 722,
    ["webjobs-list.json"] = 721,
    ["well-known-fursona"] = 918,
    ["xs-app.json"] = 747,
    ["xunit.runner.json"] = 732,
    yamllint = 772,
    ["zerops.io import file"] = 927,
    ["zerops.yml"] = 926,
    zuul = 756,
    ["Žinoma"] = 766
  },
