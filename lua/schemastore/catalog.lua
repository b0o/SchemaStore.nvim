...
M.json = {
  ...
  index = {
    ...
    [".pmbot.yml"] = 638,
    [".postcssrc"] = 647,
    [".powerpages-web-template-manifest"] = 649,
    [".pre-commit-config.yml"] = 650,
    [".pre-commit-hooks.yml"] = 651,
    [".putout.json"] = 686,
    [".rehyperc"] = 711,
    [".remarkrc"] = 715,
    [".sprite files"] = 806,
    ...
    AIConfig = 33,
    ["AMX Muse Program Descriptor"] = 1158,
    ["API Builder"] = 966,
    ["AVA Configuration"] = 1029,
    ...
    ["AWS Copilot Manifest"] = 1197,
    ["AWS SAM CLI Samconfig"] = 258,
    ["Adobe UXP Manifest"] = 1092,
    ["Aerleon Network & Service Definitions"] = 19,
    ["Aerleon Policy"] = 20,
    Aider = 1187,
    Air = 22,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1208,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1207,
    ["Airlock Microgateway"] = 34,
    ["Alacritty Configuration"] = 1001,
    ["All Contributors configuration file"] = 1055,
    ...
    ["Application list for a WinUtil"] = 1137,
    ArchitectFX = 1142,
    ["Argo CD"] = 53,
    ["Argo Events"] = 54,
    ["Argo Workflows"] = 55,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1206,
    ["Azure IoT Operations connector metadata"] = 1203,
    ...
    ["Azure Pipelines"] = 109,
    ["Azure Static Web Apps CLI configuration file"] = 810,
    ["Azure Static Web Apps configuration file"] = 809,
    BMML = 1225,
    ["BOSH CPI Config"] = 134,
    ["BOSH Deploy Config"] = 135,
    ["BX CI"] = 154,
    ["Bacon config"] = 4,
    ["Bashly (bashly.yml)"] = 1059,
    ["Bashly Settings (bashly-settings.yml)"] = 1060,
    Bento = 1224,
    ["Better Code Hub"] = 971,
    ["Better Scripts"] = 155,
    Bigconfig = 127,
    ["Biome Formatter Config"] = 81,
    ["Bitmovin Encoding Template"] = 1151,
    BizTalkServerApplicationSchema = 938,
    Bleep = 156,
    ["Block Protocol Metadata"] = 153,
    ["Bluebricks blueprint config"] = 1230,
    ["Boyka Framework"] = 136,
    Briefcase = 944,
    ["Build Info"] = 144,
    Buildkite = 146,
    ...
    ["Butane Config"] = 1014,
    C4InterFlow = 1166,
    ["CDK Environment Manager, concrete environment configuration"] = 1190,
    ["CDK Environment Manager, concrete environments definition"] = 1189,
    ["CDK Environment Manager, environment definition"] = 1188,
    ["CGS Card Game Specification (cgs.json)"] = 1097,
    ["CICS TS region tagging"] = 1023,
    ["CICS TS resource import"] = 1024,
    ["CICS TS resource model"] = 1025,
    ["CICS TS resource overrides"] = 1026,
    ["CMake Presets"] = 157,
    ["CNC Codes"] = 179,
    ["CRS WAF test file"] = 1127,
    ["CRS WAF test platform overrides file"] = 1128,
    ...
    ["Chamaleon environment"] = 1155,
    ["Chamaleon properties"] = 1156,
    ["Chamaleon template"] = 1154,
    Changepacks = 1217,
    Changesets = 267,
    Changie = 166,
    Charmcraft = 167,
    ...
    ["Clawject config"] = 185,
    ["Cloud Foundry Application Manifest"] = 1109,
    ["Cloud Run Spec v1"] = 1132,
    ...
    Concord = 1126,
    ["Configu .cfgu files"] = 1114,
    ["Configu .configu file"] = 1115,
    Conjure = 178,
    ["Container Structure Test"] = 952,
    Containerlab = 980,
    ["Contextive Glossary"] = 1182,
    Convex = 177,
    ["Crowdsec collection config"] = 277,
    ["Crowdsec parser config"] = 278,
    ["Crowdsec scenario config"] = 279,
    ["CumulusCI Config"] = 184,
    ["Custom Machinery Machine"] = 1098,
    ["Custom Machinery Recipe"] = 1099,
    ...
    ["DonateCaseBetterCasino menu"] = 1159,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1067,
    ["EAS config"] = 346,
    ["ECA - Editor Code Assistant"] = 330,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1056,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1202,
    ["EasyVCR .NET"] = 347,
    ["Eidolon Resource"] = 1143,
    ...
    ["Erda Pipeline"] = 1105,
    ["Erda Runtime"] = 1106,
    ["Espanso config.yml"] = 1228,
    ["Espanso match.yml"] = 1227,
    Esquio = 335,
    ["Estuary Flow Catalog"] = 1020,
    ...
    ["Evolving Resolutive Process notation"] = 1204,
    ["Expo SDK"] = 345,
    ...
    ["GeoJSON.json latest"] = 1018,
    GherKing = 1022,
    ["GitHub Action"] = 380,
    ["GitHub Actions typing"] = 1139,
    ...
    ["Google Digital Assetlinks"] = 1183,
    Goreleaser = 408,
    ["Goreleaser Pro"] = 409,
    Goss = 410,
    ["Gradle Build Cache Node"] = 969,
    ["Gradle Enterprise"] = 968,
    ...
    Hadolint = 948,
    Hammerkit = 979,
    ["Hardware Sentry Configuration"] = 1034,
    ...
    ["JFrog File Spec"] = 461,
    ["JFrog Pipelines YML DSL"] = 1044,
    ["JMeter DSL cli config"] = 462,
    JReleaser = 465,
    ["JSON Document Transform"] = 473,
    ["JSON Feed"] = 474,
    ["JSON Resume"] = 721,
    ["JSON Schema Draft 2020-12"] = 916,
    ["JSON Schema Draft 4"] = 913,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1077,
    ["JSON Schema Draft 7"] = 914,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1078,
    ["JSON Schema Draft 8 (2019-09)"] = 915,
    ["JSON-API"] = 472,
    ["JSON-e templates"] = 976,
    ["JSON-stat 2.0"] = 909,
    JSONPatch = 476,
    ...
    ["Jujutsu (jj) VCS config"] = 1196,
    ["KIMMDY config file"] = 487,
    ["KODE/CI build.yaml"] = 1040,
    ["KSP-AVC"] = 910,
    ["KSP-CKAN"] = 911,
    ["KSP-NetKAN"] = 912,
    KSY = 1107,
    ...
    ["Metadata for a Cinnamon spice"] = 1135,
    ["Metatype Configuration"] = 527,
    ["MetricsHub Configuration"] = 528,
    ["MetricsHub Connector Configuration"] = 529,
    ["Micro Editor Syntax"] = 1068,
    ["Microsoft Band Web Tile"] = 530,
    ["Microsoft RulesEngine workflow rules"] = 1123,
    ["Microsoft RulesEngine workflow rules list"] = 1124,
    ["Minecraft Custom Main Menu Mod"] = 1086,
    ...
    ["MongoDB Atlas Search Index Definition"] = 1039,
    ["Monika Configuration"] = 1037,
    ["Monoweave Configuration"] = 556,
    ["Motif config"] = 930,
    MultiQC = 1176,
    ["NOX Framework (Service)"] = 577,
    ["Netin Diagnostic System Template"] = 996,
    ["Netlify config"] = 564,
    ...
    ["OpenUtau ustx"] = 600,
    ["OpenWeather Current Weather API"] = 975,
    ["OpenWeather Road Risk API"] = 974,
    ...
    PDM = 633,
    POPxf = 644,
    ["POPxf Correlations"] = 645,
    Packer = 630,
    Pantsbuild = 1054,
    ["Paper paper-plugin.yml"] = 631,
    ["Pipeline component"] = 987,
    ["Platform.sh application"] = 6,
    ["Platform.sh routes"] = 7,
    ["Platform.sh services"] = 8,
    ["Plex Prerolls"] = 642,
    ["PocketMine plugin.yml"] = 639,
    ["Postman collection"] = 648,
    ["Power Pages Configuration"] = 1193,
    ["Preset list for a WinUtil"] = 1138,
    ["ProActions AI-Kit Configuration"] = 659,
    ["ProActions AI-Kit Configuration for Menus"] = 661,
    ["ProActions AI-Kit Configuration for Sections"] = 663,
    ["ProActions AI-Kit Configuration for Services"] = 660,
    ["ProActions AI-Kit Configuration for Steps"] = 664,
    ["ProActions AI-Kit Configuration for Templates"] = 662,
    ["Problem object RFC9457"] = 1083,
    ["Problem package format"] = 665,
    ["Problem package generators"] = 666,
    ["Problem package submissions"] = 667,
    ["Problem package test group metadata"] = 668,
    Pterodactyl = 1033,
    ["Pull Request Labeler"] = 685,
    Pulumi = 693,
    ["PyGTA Config"] = 689,
    PyProject = 694,
    Pylock = 1184,
    Pyright = 695,
    ["Python script metadata"] = 1178,
    ["QType AI DSL"] = 698,
    Qgoda = 697,
    Qodana = 1006,
    ["Qt Creator workspace file"] = 1116,
    ["Quali Torque Blueprint Spec 2"] = 1031,
    ["QueryFirst config file"] = 1050,
    ["RKE Cluster Configuration JSON"] = 984,
    ["RKE Cluster Configuration YAML"] = 983,
    RadioHound = 688,
    Railpack = 700,
    Railway = 699,
    ["Rancher Fleet"] = 690,
    ...
    Ray = 947,
    ["Read the Docs"] = 692,
    ["Red-DiscordBot Cog"] = 708,
    ["Red-DiscordBot Cog Repo"] = 709,
    ["Red-DiscordBot Trivia"] = 710,
    ["Releasaurus Config"] = 3,
    ["Render Blueprints"] = 982,
    RenderCV = 725,
    Renovate = 722,
    ["Renovate global configuration"] = 723,
    ["Renovate inherited configuration"] = 724,
    ["Replit config"] = 716,
    Restate = 1171,
    ["Revel Digital Gadget Definition File"] = 1195,
    RoadRunner = 727,
    ["Robust Station Image"] = 1201,
    Rockcraft = 728,
    ["Roo Coder Custom Modes"] = 729,
    Rubocop = 718,
    ["Rudder techniques"] = 1090,
    Ruff = 719,
    ["Rust Project"] = 720,
    ["Rust toolchain"] = 733,
    ["SDMX data message"] = 759,
    ["SDMX metadata message"] = 758,
    ["SDMX structure message"] = 757,
    ["SIL Kit Participant Configuration"] = 769,
    ["SIL Kit Registry Configuration"] = 770,
    ["SPDX 2.3"] = 807,
    SWADL = 823,
    ["Safebox Config"] = 1045,
    ["Sapphire CLI Config"] = 736,
    ["SauceCTL Configuration"] = 993,
    ["Schema Catalog"] = 751,
    ["Scoop manifest"] = 756,
    ["Semantic Data Fabric (SDF) file"] = 760,
    ["Semgrep Rule"] = 762,
    ["Serenity Code Generator (Sergen)"] = 763,
    ["Serverless Framework Configuration"] = 1000,
    ["Serverless Workflow"] = 1002,
    ["Settings for a Cinnamon spice"] = 1134,
    ["Settings.paf"] = 765,
    ["Shopware 6 Configuration"] = 1003,
    ["Shopware CLI Extension Store Configuration"] = 1004,
    ["Shopware CLI Project Store Configuration"] = 1005,
    ["Sigma Detection Rule"] = 767,
    ["Sigrid scope configuration file"] = 768,
    ["SkyPilot Task JSON"] = 1091,
    ["Slack app manifest"] = 772,
    Snapcraft = 774,
    Solidarity = 777,
    ["Solution filters"] = 778,
    ["Source Maps v3"] = 779,
    Sourcery = 780,
    ["Spack bootstrap.yaml"] = 781,
    ["Spack cdash.yaml"] = 782,
    ["Spack ci.yaml"] = 783,
    ["Spack compilers.yaml"] = 784,
    ["Spack concretizer.yaml"] = 785,
    ["Spack config.yaml"] = 786,
    ["Spack definitions.yaml"] = 787,
    ["Spack develop.yaml"] = 788,
    ["Spack env_vars.yaml"] = 789,
    ["Spack environment"] = 795,
    ["Spack include.yaml"] = 790,
    ["Spack mirrors.yaml"] = 791,
    ["Spack modules.yaml"] = 792,
    ["Spack packages.yaml"] = 793,
    ["Spack repos.yaml"] = 794,
    ["Spack toolchains.yaml"] = 796,
    ["Spack upstreams.yaml"] = 797,
    ["Spack view.yaml"] = 798,
    ["Speakeasy Generation Config File"] = 802,
    ["Speakeasy Lint Configuration File"] = 799,
    ["Speakeasy Test Generation Configuration File"] = 800,
    ["Speakeasy Workflow File"] = 801,
    SpecIF = 803,
    ["Specmatic Configuration"] = 804,
    ["Sponge Mixin configuration"] = 805,
    StackBlitz = 811,
    ["StackHawk Scanner Configuration"] = 999,
    Stale = 812,
    Starfish = 813,
    ["Starlake Data Pipeline"] = 972,
    Starship = 814,
    ["Statamic Blueprint"] = 815,
    ["Stella configuration file"] = 816,
    ["Streamlit configuration file"] = 817,
    ["Stryker Mutator"] = 820,
    ["StyleCop Analyzers Configuration"] = 821,
    ["Stylelint (.stylelintrc)"] = 822,
    ["Stylua Config"] = 1185,
    ["Sublime Syntax"] = 1046,
    ["Subsquid squid manifest"] = 1093,
    ["Swagger API 2.0"] = 824,
    ["Synadia Connect Component"] = 825,
    TSON = 861,
    TSTyche = 862,
    ["TYPO3 Vendor Bundler config"] = 868,
    ["Tab data for a LinUtil"] = 1141,
    ["Tab list for a LinUtil"] = 1140,
    Tach = 826,
    ["Tach Domain"] = 827,
    Talhelper = 829,
    ["Talisman configuration"] = 830,
    Taplo = 1186,
    ["Taskfile config"] = 977,
    Taurus = 831,
    Tauticord = 832,
    ["Tekton Pipeline"] = 1214,
    ["Tekton PipelineRun"] = 1215,
    ["Tekton Task"] = 1212,
    ["Tekton TaskRun"] = 1213,
    Telefonistka = 1172,
    ["Terrateam config"] = 1198,
    ["TestEnvironment.json"] = 844,
    ["TextMate Grammar"] = 843,
    Threagile = 838,
    ["Tier.run pricing.json"] = 835,
    Tikibase = 836,
    Tombi = 841,
    ["Traefik v2"] = 847,
    ["Traefik v2 File Provider"] = 848,
    ["Traefik v3"] = 849,
    ["Traefik v3 File Provider"] = 850,
    ["Travis CI (.travis.yml)"] = 846,
    Treefmt = 413,
    Trident = 1168,
    ["TrueScript for *.tscript files"] = 853,
    ["Tugboat QA config.yml"] = 1165,
    TunnelHub = 1081,
    Turborepo = 845,
    Tycho = 1130,
    Tye = 1007,
    ["Tyk Gateway - Open Source v5.7+"] = 1177,
    ["UET BuildConfig.json"] = 1051,
    ["UI5 Manifest"] = 874,
    ["UNCORS configuration"] = 878,
    ["UTAM Page Object"] = 877,
    ["Ubuntu Server Autoinstall"] = 872,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1169,
    ["Uniswap Token List"] = 959,
    ["Universal Schedule Format"] = 879,
    ["Unreal Engine Uplugin"] = 1052,
    ["Unreal Engine Uproject"] = 1053,
    ["UpCloud CLI (upctl) configuration"] = 1170,
    ["Updatecli Compose"] = 1015,
    ["Updatecli Policy Manifest"] = 1016,
    ["Updatecli Policy Metadata"] = 1017,
    Uplift = 1049,
    ["Upsun config"] = 5,
    ["User Journey Map"] = 981,
    V2Ray = 1021,
    ["VSCode Code Snippets"] = 242,
    ["VSIX CLI publishing"] = 897,
    Vector = 881,
    ["Vela Pipeline Configuration"] = 884,
    Vercel = 241,
    ["Version Bumper config"] = 887,
    Vespertide = 1219,
    ["Vespertide Migration"] = 1220,
    ["Vespertide Model"] = 1221,
    ["Viash Component Config"] = 1174,
    ["Viash Package Config"] = 1175,
    Visivo = 1079,
    ["WP-CLI"] = 907,
    Wake = 1167,
    ["Waku Config"] = 1144,
    ["Web App Manifest"] = 903,
    ["Web types"] = 906,
    WebExtensions = 902,
    ["Webman package recipe"] = 1027,
    ["Windows Package Manager Installer Manifest"] = 955,
    ["Windows Package Manager Locale Manifest"] = 956,
    ["Windows Package Manager Singleton Manifest"] = 954,
    Winutil = 957,
    ["WireMock CLI import configuration"] = 1150,
    ["WireMock CLI local service configuration"] = 1149,
    ["WireMock message stub mapping"] = 1148,
    ["WireMock stub mapping"] = 1147,
    ["Woodpecker pipeline config"] = 995,
    ["Wrangler CLI"] = 908,
    ["Xstate Machine"] = 1013,
    ["Yandex Workflow Language"] = 1136,
    ["Yarn Config (.yarnrc.yml)"] = 970,
    ["Yippee-Ki-JSON configuration YML"] = 961,
    ["YouTrack App"] = 1133,
    ["Zarf Package Configuration"] = 1200,
    ["Zerops.io config"] = 1121,
    ["Zerops.io import"] = 1122,
    ["Zola Configuration"] = 1211,
    ["aerleon.yml"] = 18,
    ["amplify.yml"] = 11,
    ["angular.json"] = 35,
    apko = 1084,
    ...
    ["behat.yml"] = 137,
    ["bigquery-table"] = 126,
    ["bioimageio resource description"] = 1101,
    ...
    ["chutzpah.json"] = 250,
    cibuildwheel = 172,
    ["clang-format (.clang-format)"] = 1019,
    ["clang-tidy"] = 228,
    clangd = 227,
    clib = 229,
    ...
    ["crowdin.yml"] = 276,
    ["ctfd-setup configuration file"] = 1157,
    ["custom-elements.json"] = 1071,
    ["cypress.json"] = 280,
    ...
    ["gematik health care insurance list"] = 1163,
    ["gematik health care patient list"] = 1160,
    ["gematik health care provider institution list"] = 1162,
    ["gematik health care provider list"] = 1161,
    ["gematik tiger test environment configuration"] = 1164,
    ["git-town.toml"] = 1209,
    ["gitlab-ci"] = 388,
    ["global.json"] = 404,
    ...
    ["lint-staged (.lintstagedrc)"] = 924,
    ["local.settings.json"] = 515,
    ["localazy.json"] = 516,
    ["lotus.yaml"] = 514,
    ["lsdlschema.json"] = 517,
    ["macro.json"] = 1036,
    ["markdown-link-check"] = 990,
    maturin = 991,
    mboats = 998,
    ["micro-settings.json"] = 1063,
    ["mimetypes.json"] = 531,
    ["mirrord config"] = 926,
    mise = 927,
    ["mkdocs.yml"] = 551,
    ...
    ["monospace.yml"] = 555,
    ["moon.yml"] = 1146,
    ["mprocs Configuration file"] = 1117,
    ["mrdocs.yml"] = 552,
    ["mta.yaml"] = 928,
    ["mtad.yaml"] = 929,
    ["mycode.json"] = 562,
    ...
    pitcms = 1229,
    ["pixi.toml"] = 636,
    ["plagiarize-me.yaml"] = 641,
    ["plagiarize.yaml"] = 640,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1153,
    ["podbard.yaml"] = 643,
    ["portman.json"] = 646,
    ["prefect.toml"] = 654,
    ["prefect.yaml"] = 655,
    ...
    ["prettierrc.json"] = 657,
    ["prisma.yml"] = 658,
    ["project-1.0.0-beta3.json"] = 670,
    ["project-1.0.0-beta4.json"] = 671,
    ["project-1.0.0-beta5.json"] = 672,
    ["project-1.0.0-beta6.json"] = 673,
    ["project-1.0.0-beta8.json"] = 674,
    ["project-1.0.0-rc1.json"] = 675,
    ["project-1.0.0-rc2.json"] = 676,
    ["project.json"] = 669,
    ["project.owasp.yaml"] = 677,
    ["prometheus-alertmanager.json"] = 681,
    ["prometheus.json"] = 678,
    ["prometheus.rules.json"] = 679,
    ["prometheus.rules.test.json"] = 680,
    ["proxies.json"] = 682,
    ["publiccode.yml"] = 683,
    ["pubspec.yaml"] = 684,
    ["pyrseas-0.8.json"] = 687,
    pytest = 696,
    ["quilt.mod.json"] = 1064,
    ["rc3 auth"] = 702,
    ["rc3 collection"] = 703,
    ...
    ["release drafter"] = 942,
    ["release-hub.json"] = 2,
    ["release-please-config.json"] = 712,
    ["release-please-manifest.json"] = 713,
    ["release-plz.toml"] = 714,
    ["renv.lock"] = 726,
    ["rivet.json"] = 1088,
    ["rivet.yaml (legacy)"] = 1087,
    rumdl = 731,
    runny = 730,
    rustfmt = 732,
    sake = 1180,
    samt = 734,
    samtrc = 735,
    ["sarif-1.0.0.json"] = 737,
    ["sarif-2.0.0.json"] = 738,
    ["sarif-2.1.0"] = 748,
    ["sarif-2.1.0-rtm.2"] = 739,
    ["sarif-2.1.0-rtm.3"] = 741,
    ["sarif-2.1.0-rtm.4"] = 743,
    ["sarif-2.1.0-rtm.5"] = 745,
    ["sarif-2.1.0-rtm.6"] = 746,
    ["sarif-external-property-file-2.1.0"] = 749,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 740,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 742,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 744,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 747,
    ["scalingo.json configuration"] = 750,
    ["schema.org - Action"] = 752,
    ["schema.org - ContactPoint"] = 753,
    ["schema.org - Place"] = 754,
    ["schema.org - Thing"] = 755,
    ["secrethub.yml"] = 1066,
    ["semantic-release"] = 761,
    ["servicehub.config.json"] = 919,
    ["servicehub.service.json"] = 918,
    ["settings.job"] = 764,
    ["sfdx-hardis configuration"] = 766,
    ["shard.yml"] = 1104,
    ["size-limit configuration"] = 771,
    ["skaffold.yaml"] = 988,
    ["skyuxconfig.json"] = 773,
    ["snowflake-config"] = 775,
    ["snowflake-connections"] = 776,
    ["spicepod.yaml"] = 1125,
    ["sqlc configuration"] = 808,
    ["stripe-app-local.json"] = 819,
    ["stripe-app.json"] = 818,
    swcrc = 973,
    ["task.json"] = 828,
    taskcat = 937,
    ["template.json"] = 833,
    ["templatsources.json"] = 834,
    ["text2confl config"] = 1234,
    ["theme.json"] = 837,
    ["tizen_workspace.json"] = 839,
    tldr = 840,
    ["tm_devices configuration file"] = 1191,
    tmuxinator = 922,
    tox = 842,
    ["transcend.yml"] = 851,
    ...
    ["vega-lite.json"] = 883,
    ["vega.json"] = 882,
    ["venvironment.yaml"] = 885,
    ["venvplus.yaml"] = 886,
    version = 1173,
    ["version.json"] = 888,
    ["vhwdebugger-binding.yaml"] = 890,
    ["vim-addon-info"] = 891,
    ["vs-2017.3.host.json"] = 893,
    ["vs-nesting.json"] = 894,
    ["vsls.json"] = 892,
    ["vss-extension.json"] = 898,
    vtcfg = 1179,
    ["vtesttree.yaml"] = 899,
    ["vtestunit.yaml"] = 900,
    ["warp-keysets.json"] = 1072,
    ["warp-themes.json"] = 1073,
    ["warp-workflows.json"] = 1074,
    ["webhint.io"] = 1028,
    ["webjobpublishsettings.json"] = 905,
    ["webjobs-list.json"] = 904,
    ["well-known-fursona"] = 1112,
    ["xs-app.json"] = 932,
    ["xunit.runner.json"] = 917,
    yamllint = 960,
    zizmor = 1216,
    zuul = 943,
    ["Žinoma"] = 953
