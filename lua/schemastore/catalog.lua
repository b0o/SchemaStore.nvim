...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 183,
    [".cryproj (generic)"] = 629,
    [".cryproj engine-5.2"] = 624,
    [".cryproj engine-5.3"] = 625,
    [".cryproj engine-5.4"] = 626,
    [".cryproj engine-5.5"] = 627,
    [".cryproj engine-dev"] = 628,
    [".csscomb.json"] = 185,
    [".csslintrc"] = 186,
    [".es6importsorterrc.json"] = 762,
    [".eslintrc"] = 235,
    [".esmrc.json"] = 227,
    [".ffizer.yaml"] = 239,
    [".htmlhintrc"] = 292,
    ...
    [".mtaext"] = 638,
    [".nodehawkrc"] = 396,
    [".npmpackagejsonlintrc"] = 399,
    [".phraseapp.yml"] = 447,
    [".pmbot.yml"] = 435,
    [".postcssrc"] = 442,
    [".powerpages-web-template-manifest"] = 444,
    [".pre-commit-config.yml"] = 445,
    [".pre-commit-hooks.yml"] = 446,
    [".putout.json"] = 466,
    [".rehyperc"] = 478,
    [".remarkrc"] = 480,
    [".sprite files"] = 537,
    ...
    ["<div>RIOTS' studio configuration"] = 608,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 354,
    AIConfig = 13,
    ["API Builder"] = 670,
    ["AVA Configuration"] = 731,
    ...
    ["Airplane task"] = 15,
    ["Alacritty Configuration"] = 703,
    ["All Contributors configuration file"] = 761,
    ...
    ["Better Scripts"] = 98,
    Bigconfig = 78,
    BizTalkServerApplicationSchema = 644,
    Bleep = 99,
    ...
    ["Butane Config"] = 716,
    ["CICS TS region tagging"] = 725,
    ["CICS TS resource import"] = 726,
    ["CICS TS resource model"] = 727,
    ["CICS TS resource overrides"] = 728,
    ["CMake Presets"] = 100,
    ["CNC Codes"] = 111,
    ...
    ["Databricks Asset Bundles"] = 782,
    ["Datadog Service Definition"] = 332,
    ["Datahub Ingestion Recipe"] = 732,
    ["Dein Config"] = 117,
    Deno = 196,
    ["Deployer Recipe"] = 199,
    ["Deta Spacefile"] = 118,
    ...
    ["Frogbot Config"] = 67,
    ["G2P Mapping Configuration"] = 254,
    ["GCP Blueprint Metadata"] = 257,
    Gaspar = 255,
    ["GatewayCore API Gateway"] = 256,
    ["GeoJSON.json latest"] = 720,
    GherKing = 724,
    ["GitHub Action"] = 261,
    ["GitHub Discussion"] = 262,
    ["GitHub Funding"] = 263,
    ["GitHub Issue Template configuration"] = 265,
    ["GitHub Workflow"] = 266,
    ["GitHub Workflow Template Properties"] = 267,
    ["GitHub issue forms"] = 264,
    GitVersion = 260,
    ["Gitpod Configuration"] = 269,
    ["Global Privacy Control"] = 258,
    Goblet = 781,
    ...
    ["Goreleaser Pro"] = 274,
    Goss = 275,
    ["Gradle Build Cache Node"] = 672,
    ["Gradle Enterprise"] = 671,
    ["Grafana 5.x Dashboard"] = 276,
    ["GraphQL Code Generator"] = 279,
    ["GraphQL Config"] = 278,
    ["GraphQL Mesh"] = 277,
    ["Grunt JSHint task"] = 283,
    ["Grunt Watch task"] = 284,
    ["Grunt base task"] = 285,
    ["Grunt clean task"] = 281,
    ["Grunt copy task"] = 280,
    ["Grunt cssmin task"] = 282,
    HEMTT = 641,
    Hadolint = 653,
    Hammerkit = 681,
    ["Hardware Sentry Configuration"] = 736,
    Hatch = 654,
    Hayson = 287,
    ["Haystack Pipeline"] = 288,
    ["Hazelcast 5 Configuration"] = 289,
    ["Helm Chart.lock"] = 135,
    ["Helm Chart.yaml"] = 134,
    ["Helm Unittest Test Suite"] = 136,
    Hugo = 712,
    ["Hugo Theme"] = 711,
    ["IBM Zapp document"] = 294,
    ["IBM zCodeFormatSettings"] = 295,
    ["IMG Catapult PSP"] = 300,
    Istanbul = 739,
    ["JDownloader2 crawler multi-rules"] = 310,
    ["JDownloader2 crawler single-rules"] = 309,
    ["JFrog Applications Config"] = 311,
    ["JFrog File Spec"] = 312,
    ["JFrog Pipelines YML DSL"] = 745,
    ["JMeter DSL cli config"] = 313,
    JReleaser = 315,
    ["JSON Document Transform"] = 322,
    ["JSON Feed"] = 323,
    ["JSON Resume"] = 486,
    ["JSON Schema Draft 2020-12"] = 620,
    ["JSON Schema Draft 4"] = 617,
    ["JSON Schema Draft 7"] = 618,
    ["JSON Schema Draft 7 (unofficial strict)"] = 783,
    ["JSON Schema Draft 8 (2019-09)"] = 619,
    ["JSON-API"] = 321,
    ["JSON-e templates"] = 679,
    ["JSON-stat 2.0"] = 614,
    JSONPatch = 325,
    Jasmine = 305,
    Jekyll = 306,
    ["Jenkins X Pipelines"] = 307,
    ["Jenkins X Requirements"] = 308,
    ["Jovo Language Models"] = 314,
    ["KIMMDY config file"] = 330,
    ["KSP-AVC"] = 615,
    ["KSP-CKAN"] = 616,
    ["Karakum configuration file"] = 251,
    Kas = 328,
    ["Keycloak REST API"] = 753,
    ["Knative Functions - func.yaml"] = 252,
    ["KoDE/CI build.yaml"] = 741,
    ["Kong DBLess config"] = 742,
    KrakenD = 331,
    LOOBin = 349,
    Lefthook = 339,
    ["Liferay client-extension.yaml"] = 345,
    ["LinkML Metamodel"] = 347,
    Liquibase = 686,
    ["Liquibase Flow File"] = 687,
    ["Lively Properties"] = 348,
    ["Lobe AI Agent"] = 60,
    ["MLOS Configs"] = 381,
    ["MS2Rescore Configuration"] = 383,
    Markdownlint = 690,
    ["Mason Registry"] = 692,
    ["MegaLinter configuration"] = 355,
    ["MegaLinter descriptor"] = 356,
    Melange = 789,
    ["Meltano plugin discovery definition"] = 358,
    ["Meltano project definition"] = 357,
    ["Microsoft Band Web Tile"] = 359,
    ["Minecraft Custom Main Menu Mod"] = 790,
    ["Minecraft Data Pack Advancement"] = 361,
    ["Minecraft Data Pack Biome"] = 362,
    ["Minecraft Data Pack Configured Carver"] = 363,
    ["Minecraft Data Pack Damage Type"] = 364,
    ["Minecraft Data Pack Dimension"] = 366,
    ["Minecraft Data Pack Dimension Type"] = 365,
    ["Minecraft Data Pack Item Modifier"] = 367,
    ["Minecraft Data Pack Loot Table"] = 368,
    ["Minecraft Data Pack Metadata"] = 369,
    ["Minecraft Data Pack Predicate"] = 370,
    ["Minecraft Data Pack Recipe"] = 371,
    ["Minecraft Data Pack Tag"] = 372,
    ["Minecraft Data Pack Template Pool"] = 373,
    ["Minecraft Data Pack Trim Material"] = 378,
    ["Minecraft Data Pack Trim Pattern"] = 379,
    ["Minecraft Resource Pack Lang"] = 374,
    ["Minecraft Resource Pack Particle"] = 375,
    ["Minecraft Resource Pack Texture Mcmeta"] = 377,
    ["Minecraft Resourcepack Sounds"] = 376,
    ["MkDocs Configuration 1.0"] = 380,
    ["MongoDB Atlas Search Index Definition"] = 740,
    ["Monika Configuration"] = 738,
    ["Motif config"] = 637,
    ["NOX Framework (Service)"] = 398,
    ["Netin Diagnostic System Template"] = 696,
    ["Netlify config"] = 389,
    ["Network-as-Code Data Model"] = 390,
    ["Nightwatch.js"] = 391,
    ["ONe's changelog entry"] = 414,
    ["ONe's service descriptor"] = 413,
    ["OSS Review Toolkit configuration"] = 421,
    ["OSS Review Toolkit curation"] = 422,
    ["OSS Review Toolkit package configuration"] = 423,
    ["OSS Review Toolkit repository configuration"] = 424,
    ["OSS Review Toolkit resolutions"] = 425,
    Opctl = 640,
    ["OpenRewrite Resource"] = 416,
    ["OpenUtau character yaml"] = 410,
    ["OpenUtau ustx"] = 411,
    ["OpenWeather Current Weather API"] = 678,
    ["OpenWeather Road Risk API"] = 677,
    ["Ory Hydra configuration"] = 293,
    ["Ory Keto configuration"] = 333,
    ["Ory Kratos configuration"] = 420,
    ["Ory Oathkeeper configuration"] = 405,
    ["Outblocks App configuration"] = 418,
    ["Outblocks database table"] = 419,
    ["Outblocks project configuration"] = 417,
    PDM = 431,
    ["PDM Partial"] = 432,
    Packer = 428,
    Pantsbuild = 760,
    ["Paper paper-plugin.yml"] = 429,
    ["Partial-Setuptools"] = 521,
    ["Partial-poetry"] = 438,
    ["Pipeline component"] = 688,
    ["PocketMine plugin.yml"] = 436,
    Poetry = 437,
    ["Postman collection"] = 443,
    ["Problem object RFC9457"] = 787,
    ["Problem package generators"] = 450,
    Pterodactyl = 735,
    ["Pull Request Labeler"] = 465,
    Pulumi = 471,
    PyProject = 472,
    Pyright = 473,
    Qgoda = 474,
    Qodana = 708,
    ["Quali Torque Blueprint Spec 2"] = 733,
    ["QueryFirst config file"] = 756,
    ["RKE Cluster Configuration JSON"] = 685,
    ["RKE Cluster Configuration YAML"] = 684,
    ["Rancher Fleet"] = 468,
    Ray = 652,
    ["Read the Docs"] = 470,
    ["Red-DiscordBot Cog"] = 475,
    ["Red-DiscordBot Cog Repo"] = 476,
    ["Red-DiscordBot Trivia"] = 477,
    RenderCV = 488,
    Renovate = 487,
    ["Replit config"] = 481,
    RoadRunner = 489,
    ...
    SWADL = 551,
    ["Safebox Config"] = 746,
    ["Sapphire CLI Config"] = 494,
    ["SauceCTL Configuration"] = 693,
    ["Schema Catalog"] = 508,
    ["Scoop manifest"] = 513,
    ["Semantic Data Fabric (SDF) file"] = 514,
    ["Semgrep Rule"] = 516,
    ["Serenity Code Generator (Sergen)"] = 517,
    ["Serverless Framework Configuration"] = 702,
    ["Serverless Workflow"] = 704,
    ["Settings.paf"] = 519,
    Setuptools = 520,
    ["Shopware 6 Configuration"] = 705,
    ["Shopware CLI Extension Store Configuration"] = 706,
    ["Shopware CLI Project Store Configuration"] = 707,
    Sigma = 523,
    ...
    StackBlitz = 541,
    ["StackHawk Scanner Configuration"] = 701,
    Stale = 542,
    ["Starlake Data Pipeline"] = 675,
    Starship = 543,
    ["Statamic Blueprint"] = 544,
    ["Stella configuration file"] = 545,
    ["StrmPrivacy Data Connector"] = 750,
    ["StrmPrivacy Data Contract"] = 751,
    ["StrmPrivacy SimpleSchema"] = 748,
    ["StrmPrivacy Stream"] = 749,
    ["StrmPrivacy batch job configuration file"] = 747,
    ["Stryker Mutator"] = 548,
    ...
    Turborepo = 566,
    Tye = 709,
    ["UET BuildConfig.json"] = 757,
    ["UI5 Manifest"] = 586,
    ["UNCORS configuration"] = 590,
    ["UTAM Page Object"] = 589,
    ["Ubuntu Server Autoinstall"] = 584,
    ["Uniswap Token List"] = 663,
    ["Unreal Engine Uplugin"] = 758,
    ["Unreal Engine Uproject"] = 759,
    ["Updatecli Compose"] = 717,
    ["Updatecli Policy Manifest"] = 718,
    ["Updatecli Policy Metadata"] = 719,
    Uplift = 755,
    ["User Journey Map"] = 683,
    V2Ray = 723,
    ["VSCode Code Snippets"] = 154,
    ["VSIX CLI publishing"] = 603,
    ["Vela Pipeline Configuration"] = 593,
    Vercel = 153,
    Visivo = 784,
    ["Web App Manifest"] = 610,
    ["Web types"] = 613,
    WebExtensions = 609,
    ["Webman package recipe"] = 729,
    ["Windows Package Manager Installer Manifest"] = 660,
    ["Windows Package Manager Locale Manifest"] = 661,
    ["Windows Package Manager Singleton Manifest"] = 659,
    ["Woodpecker pipeline config"] = 695,
    ["Xstate Machine"] = 715,
    ["Yippee-Ki-JSON configuration YML"] = 665,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 16,
    apko = 788,
    ...
    ["bamboo-spec"] = 72,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 766,
    ["bashly-strings.yml"] = 767,
    ["bashly.yml"] = 765,
    ["batect.yml"] = 71,
    ...
    ["gitlab-ci"] = 268,
    ["global.json"] = 270,
    ["go-feature-flag Flag Configuration"] = 272,
    ["golangci-lint Configuration"] = 271,
    ["haxelib.json"] = 286,
    helmfile = 655,
    helmwave = 656,
    ["host-meta.json"] = 291,
    ...
    ["ide.host.json"] = 296,
    ["ifstate.conf"] = 297,
    ["imageoptimizer.json"] = 298,
    ["importmap.json"] = 301,
    ["ioBroker Configuration"] = 302,
    ["ioBroker JSON UI"] = 303,
    ["ioBroker Package manifest"] = 304,
    ["ize.toml"] = 754,
    ["jsconfig.json"] = 326,
    ["jscpd Configuration"] = 734,
    jsdoc = 651,
    ["k3d.yaml"] = 327,
    ["k9s plugin.yml"] = 329,
    ["kontinuous-config.yaml"] = 335,
    ["kontinuous-values.yaml"] = 334,
    ["kustomization.yaml"] = 336,
    ["label-commenter-config.yml"] = 337,
    ["launchsettings.json"] = 338,
    lazydocker = 776,
    lazygit = 775,
    ["lego.json"] = 340,
    ["lerna.json"] = 341,
    ["lgtm.yml"] = 342,
    ["libman.json"] = 343,
    ["license-report-config.json"] = 344,
    ["linkinator.config.json"] = 346,
    ["local.settings.json"] = 351,
    ["localazy.json"] = 352,
    ["lotus.yaml"] = 350,
    ["lsdlschema.json"] = 353,
    ["madness.yml"] = 764,
    ["markdown-lint-check"] = 691,
    mboats = 698,
    ["micro-settings.json"] = 769,
    ["mimetypes.json"] = 360,
    ["mirrord config"] = 634,
    ["monospace.yml"] = 382,
    ["mta.yaml"] = 635,
    ...
    ["mycode.json"] = 386,
    mypy = 387,
    ["napari plugin manifest"] = 388,
    neoload = 646,
    ["nest-cli"] = 394,
    ["ninjs (News in JSON) 1.3"] = 393,
    ["ninjs (News in JSON) 2.0"] = 392,
    ["nlu.json"] = 395,
    ["nodemon.json"] = 397,
    ["noodl config"] = 697,
    now = 642,
    ...
    ["nswag.json"] = 403,
    ntangle = 404,
    ["nuclei-template.yaml"] = 401,
    ["nuget-project.json"] = 402,
    ["ocelot.json"] = 406,
    ["omnisharp.json"] = 407,
    ["openapi.json"] = 408,
    ["openfin.json"] = 415,
    ...
    ["ops.yaml"] = 412,
    ["package.json"] = 426,
    ["package.manifest"] = 427,
    ["partial-cibuildwheel"] = 108,
    ["partial-scikit-build"] = 700,
    ["pathfinder.yml"] = 430,
    ["pattern.json"] = 434,
    ["petstore-v1.0"] = 744,
    pgap_yaml_input_reader = 433,
    ["plagiarize-me.yaml"] = 440,
    ["plagiarize.yaml"] = 439,
    ["portman.json"] = 441,
    ["prettierrc.json"] = 448,
    ["prisma.yml"] = 449,
    ["project-1.0.0-beta3.json"] = 452,
    ["project-1.0.0-beta4.json"] = 453,
    ["project-1.0.0-beta5.json"] = 454,
    ["project-1.0.0-beta6.json"] = 455,
    ["project-1.0.0-beta8.json"] = 456,
    ["project-1.0.0-rc1.json"] = 457,
    ["project-1.0.0-rc2.json"] = 458,
    ["project.json"] = 451,
    ["prometheus.json"] = 459,
    ["prometheus.rules.json"] = 460,
    ["prometheus.rules.test.json"] = 461,
    ["proxies.json"] = 462,
    ["publiccode.yml"] = 463,
    ["pubspec.yaml"] = 464,
    ["pyrseas-0.8.json"] = 467,
    ["quilt.mod.json"] = 770,
    ["release drafter"] = 647,
    ["release-plz.toml"] = 479,
    rtx = 483,
    rustfmt = 490,
    samt = 492,
    samtrc = 493,
    ["sarif-1.0.0.json"] = 495,
    ["sarif-2.0.0.json"] = 496,
    ["sarif-2.1.0"] = 506,
    ["sarif-2.1.0-rtm.2"] = 497,
    ["sarif-2.1.0-rtm.3"] = 499,
    ["sarif-2.1.0-rtm.4"] = 501,
    ["sarif-2.1.0-rtm.5"] = 503,
    ["sarif-2.1.0-rtm.6"] = 504,
    ["sarif-external-property-file-2.1.0"] = 507,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 498,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 500,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 502,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 505,
    ["schema.org - Action"] = 509,
    ["schema.org - ContactPoint"] = 510,
    ["schema.org - Place"] = 511,
    ["schema.org - Thing"] = 512,
    ["scikit-build"] = 699,
    ["secrethub.yml"] = 772,
    ["semantic-release"] = 515,
    ["servicehub.config.json"] = 623,
    ["servicehub.service.json"] = 622,
    ["settings.job"] = 518,
    ...
    ["vega-lite.json"] = 592,
    ["vega.json"] = 591,
    ["venvironment-basic.yaml"] = 595,
    ["venvironment.yaml"] = 594,
    ["version.json"] = 596,
    ["vim-addon-info"] = 597,
    ["vs-2017.3.host.json"] = 599,
    ["vs-nesting.json"] = 600,
    ["vsls.json"] = 598,
    ["vss-extension.json"] = 604,
    ["vtesttree.yaml"] = 605,
    ["vtestunit.yaml"] = 606,
    ["warp-keysets.json"] = 778,
    ["warp-themes.json"] = 779,
    ["warp-workflows.json"] = 780,
    ["webhint.io"] = 730,
    ["webjobpublishsettings.json"] = 612,
    ["webjobs-list.json"] = 611,
    ["xs-app.json"] = 639,
    ["xunit.runner.json"] = 621,
    yamllint = 664,
    zuul = 648,
    ["Žinoma"] = 658
  },
