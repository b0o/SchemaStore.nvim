...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1045,
    ["API Builder"] = 860,
    ["AVA Configuration"] = 922,
    ...
    ["Adobe UXP Manifest"] = 984,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1073,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 894,
    ["All Contributors configuration file"] = 947,
    ...
    ["Application list for a WinUtil"] = 1027,
    ArchitectFX = 1032,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure Pipelines"] = 78,
    ["Azure Static Web Apps CLI configuration file"] = 708,
    ["Azure Static Web Apps configuration file"] = 707,
    ["BOSH CPI Config"] = 102,
    ["BOSH Deploy Config"] = 103,
    ["BX CI"] = 122,
    ["Bashly (bashly.yml)"] = 951,
    ["Bashly Settings (bashly-settings.yml)"] = 952,
    ["Better Code Hub"] = 864,
    ["Better Scripts"] = 123,
    Bigconfig = 95,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1038,
    BizTalkServerApplicationSchema = 832,
    Bleep = 124,
    ...
    ["Butane Config"] = 907,
    C4InterFlow = 1053,
    ["CDK Environment Manager, concrete environment configuration"] = 1076,
    ["CDK Environment Manager, concrete environments definition"] = 1075,
    ["CDK Environment Manager, environment definition"] = 1074,
    ["CGS Card Game Specification (cgs.json)"] = 989,
    ["CICS TS region tagging"] = 916,
    ["CICS TS resource import"] = 917,
    ["CICS TS resource model"] = 918,
    ["CICS TS resource overrides"] = 919,
    ["CMake Presets"] = 125,
    ["CNC Codes"] = 144,
    ["CRS WAF test file"] = 1017,
    ["CRS WAF test platform overrides file"] = 1018,
    ...
    ["Chamaleon environment"] = 1042,
    ["Chamaleon properties"] = 1043,
    ["Chamaleon template"] = 1041,
    Changesets = 228,
    Charmcraft = 134,
    Cheatsheets = 904,
    ...
    ["Clawject config"] = 150,
    ["Cloud Foundry Application Manifest"] = 1000,
    ["Cloud Run Spec v1"] = 1022,
    ...
    Concord = 1016,
    ["Configu .cfgu files"] = 1005,
    ["Configu .configu file"] = 1006,
    Conjure = 143,
    ["Container Structure Test"] = 846,
    Containerlab = 873,
    ["Contextive Glossary"] = 1068,
    Convex = 142,
    ["Crowdsec collection config"] = 238,
    ["Crowdsec parser config"] = 239,
    ["Crowdsec scenario config"] = 240,
    ["CumulusCI Config"] = 149,
    ["Custom Machinery Machine"] = 990,
    ["Custom Machinery Recipe"] = 991,
    ...
    ["DonateCaseBetterCasino menu"] = 1046,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 959,
    ["EAS config"] = 304,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 948,
    ["EasyVCR .NET"] = 305,
    ["Eidolon Resource"] = 1033,
    ...
    ["GeoJSON.json latest"] = 911,
    GherKing = 915,
    ["GitHub Action"] = 335,
    ["GitHub Actions typing"] = 1029,
    ...
    ["Google Digital Assetlinks"] = 1069,
    Goreleaser = 363,
    ["Goreleaser Pro"] = 364,
    Goss = 365,
    ["Gradle Build Cache Node"] = 862,
    ["Gradle Enterprise"] = 861,
    ...
    Hadolint = 842,
    Hammerkit = 872,
    ["Hardware Sentry Configuration"] = 927,
    Hatch = 843,
    Hayson = 378,
    ["Haystack Pipeline"] = 379,
    ["Hazelcast 5 Configuration"] = 380,
    ["Hecate Input Schema"] = 1080,
    ["Helm Chart.lock"] = 183,
    ["Helm Chart.yaml"] = 182,
    ...
    ["JFrog File Spec"] = 409,
    ["JFrog Pipelines YML DSL"] = 936,
    ["JMeter DSL cli config"] = 410,
    JReleaser = 413,
    ["JSON Document Transform"] = 421,
    ["JSON Feed"] = 422,
    ["JSON Resume"] = 641,
    ["JSON Schema Draft 2020-12"] = 811,
    ["JSON Schema Draft 4"] = 808,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 969,
    ["JSON Schema Draft 7"] = 809,
    ["JSON Schema Draft 7 (unofficial strict)"] = 970,
    ["JSON Schema Draft 8 (2019-09)"] = 810,
    ["JSON-API"] = 420,
    ["JSON-e templates"] = 869,
    ["JSON-stat 2.0"] = 804,
    JSONPatch = 424,
    ...
    ["Metadata for a Cinnamon spice"] = 1025,
    ["Metatype Configuration"] = 472,
    ["MetricsHub Configuration"] = 473,
    ["MetricsHub Connector Configuration"] = 474,
    ["Micro Editor Syntax"] = 960,
    ["Microsoft Band Web Tile"] = 475,
    ["Microsoft RulesEngine workflow rules"] = 1013,
    ["Microsoft RulesEngine workflow rules list"] = 1014,
    ["Minecraft Custom Main Menu Mod"] = 978,
    ...
    ["MongoDB Atlas Search Index Definition"] = 931,
    ["Monika Configuration"] = 929,
    ["Monoweave Configuration"] = 500,
    ["Motif config"] = 824,
    MultiQC = 1062,
    ["NOX Framework (Service)"] = 518,
    ["Netin Diagnostic System Template"] = 889,
    ["Netlify config"] = 508,
    ["Network-as-Code Data Model"] = 509,
    ["Nightwatch.js"] = 511,
    ["Node.js configuration"] = 829,
    ...
    ["OpenUtau ustx"] = 536,
    ["OpenWeather Current Weather API"] = 868,
    ["OpenWeather Road Risk API"] = 867,
    ...
    ["Power Pages Configuration"] = 1079,
    ["Preset list for a WinUtil"] = 1028,
    ...
    Pylock = 1070,
    Pyright = 618,
    ["Python script metadata"] = 1064,
    Qgoda = 620,
    Qodana = 899,
    ["Qt Creator workspace file"] = 1007,
    ["Quali Torque Blueprint Spec 2"] = 924,
    ["QueryFirst config file"] = 942,
    ["RKE Cluster Configuration JSON"] = 877,
    ["RKE Cluster Configuration YAML"] = 876,
    RadioHound = 611,
    Railway = 621,
    ["Rancher Fleet"] = 613,
    ["Rattler-build"] = 622,
    ...
    ["Render Blueprints"] = 875,
    RenderCV = 643,
    Renovate = 642,
    ["Replit config"] = 637,
    Restate = 1057,
    RoadRunner = 645,
    ["Roo Coder Custom Modes"] = 647,
    ["Rudder techniques"] = 982,
    Ruff = 639,
    ["Rust Project"] = 640,
    ["Rust toolchain"] = 650,
    ["SDMX data message"] = 676,
    ["SDMX metadata message"] = 675,
    ["SDMX structure message"] = 674,
    ["SIL Kit Participant Configuration"] = 686,
    ["SIL Kit Registry Configuration"] = 687,
    ["SPDX 2.3"] = 705,
    SWADL = 719,
    ["Safebox Config"] = 937,
    ["Sapphire CLI Config"] = 653,
    ["SauceCTL Configuration"] = 886,
    ["Schema Catalog"] = 668,
    ["Scoop manifest"] = 673,
    ["Semantic Data Fabric (SDF) file"] = 677,
    ["Semgrep Rule"] = 679,
    ["Serenity Code Generator (Sergen)"] = 680,
    ["Serverless Framework Configuration"] = 893,
    ["Serverless Workflow"] = 895,
    ["Settings for a Cinnamon spice"] = 1024,
    ["Settings.paf"] = 682,
    ["Shopware 6 Configuration"] = 896,
    ["Shopware CLI Extension Store Configuration"] = 897,
    ["Shopware CLI Project Store Configuration"] = 898,
    ["Sigma Detection Rule"] = 684,
    ["Sigrid scope configuration file"] = 685,
    ["SkyPilot Task JSON"] = 983,
    ["Slack app manifest"] = 689,
    Solidarity = 694,
    ["Solution filters"] = 695,
    ["Source Maps v3"] = 696,
    Sourcery = 697,
    ["Speakeasy Generation Config File"] = 701,
    ["Speakeasy Lint Configuration File"] = 698,
    ["Speakeasy Test Generation Configuration File"] = 699,
    ["Speakeasy Workflow File"] = 700,
    SpecIF = 702,
    ["Sponge Mixin configuration"] = 703,
    StackBlitz = 709,
    ["StackHawk Scanner Configuration"] = 892,
    Stale = 710,
    ["Starlake Data Pipeline"] = 865,
    Starship = 711,
    ["Statamic Blueprint"] = 712,
    ["Stella configuration file"] = 713,
    ["Stryker Mutator"] = 716,
    ["StyleCop Analyzers Configuration"] = 717,
    ["Stylelint (.stylelintrc)"] = 718,
    ["Stylua Config"] = 1071,
    ["Sublime Syntax"] = 938,
    ["Subsquid squid manifest"] = 985,
    ["Swagger API 2.0"] = 720,
    ["Synadia Connect Component"] = 721,
    TSON = 755,
    TSTyche = 756,
    ["TYPO3 Vendor Bundler config"] = 761,
    ["Tab data for a LinUtil"] = 1031,
    ["Tab list for a LinUtil"] = 1030,
    Tach = 722,
    ["Tach Domain"] = 723,
    Talhelper = 725,
    ["Talisman configuration"] = 726,
    Taplo = 1072,
    ["Taskfile config"] = 870,
    Taurus = 727,
    Tauticord = 728,
    Telefonistka = 1058,
    ["TestEnvironment.json"] = 738,
    ["TextMate Grammar"] = 737,
    ["Tier.run pricing.json"] = 731,
    Tikibase = 732,
    Tombi = 736,
    ["Traefik v2"] = 741,
    ["Traefik v2 File Provider"] = 742,
    ["Traefik v3"] = 743,
    ["Traefik v3 File Provider"] = 744,
    ["Travis CI (.travis.yml)"] = 740,
    Trident = 1055,
    ["TrueScript for *.tscript files"] = 747,
    ["Tugboat QA config.yml"] = 1052,
    TunnelHub = 973,
    Turborepo = 739,
    Tycho = 1020,
    Tye = 900,
    ["Tyk Gateway - Open Source v5.7+"] = 1063,
    ["Typst Manifest"] = 762,
    ["UET BuildConfig.json"] = 943,
    ["UI5 Manifest"] = 768,
    ["UNCORS configuration"] = 772,
    ["UTAM Page Object"] = 771,
    ["Ubuntu Server Autoinstall"] = 766,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1056,
    ["Uniswap Token List"] = 853,
    ["Universal Schedule Format"] = 773,
    ["Unreal Engine Uplugin"] = 944,
    ["Unreal Engine Uproject"] = 945,
    ["Updatecli Compose"] = 908,
    ["Updatecli Policy Manifest"] = 909,
    ["Updatecli Policy Metadata"] = 910,
    Uplift = 941,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 874,
    V2Ray = 914,
    ["VSCode Code Snippets"] = 203,
    ["VSIX CLI publishing"] = 793,
    Vector = 775,
    ["Vela Pipeline Configuration"] = 778,
    Vercel = 202,
    ["Version Bumper config"] = 783,
    ["Viash Component Config"] = 1060,
    ["Viash Package Config"] = 1061,
    Visivo = 971,
    Wake = 1054,
    ["Waku Config"] = 1034,
    ["Web App Manifest"] = 799,
    ["Web types"] = 802,
    WebExtensions = 798,
    ["Webman package recipe"] = 920,
    ["Windows Package Manager Installer Manifest"] = 849,
    ["Windows Package Manager Locale Manifest"] = 850,
    ["Windows Package Manager Singleton Manifest"] = 848,
    Winutil = 851,
    ["WireMock stub mapping"] = 1037,
    ["Woodpecker pipeline config"] = 888,
    ["Wrangler CLI"] = 803,
    ["Xstate Machine"] = 906,
    ["Yandex Workflow Language"] = 1026,
    ["Yarn Config (.yarnrc.yml)"] = 863,
    ["Yippee-Ki-JSON configuration YML"] = 855,
    ["YouTrack App"] = 1023,
    ["Zerops.io config"] = 1011,
    ["Zerops.io import"] = 1012,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 976,
    ...
    ["behat.yml"] = 105,
    ["bigquery-table"] = 94,
    ["bioimageio resource description"] = 993,
    ...
    ["crowdin.yml"] = 237,
    ["ctfd-setup configuration file"] = 1044,
    ["custom-elements.json"] = 963,
    ["cypress.json"] = 241,
    ...
    ["gematik health care insurance list"] = 1050,
    ["gematik health care patient list"] = 1047,
    ["gematik health care provider institution list"] = 1049,
    ["gematik health care provider list"] = 1048,
    ["gematik tiger test environment configuration"] = 1051,
    ["gitlab-ci"] = 343,
    ["global.json"] = 359,
    ...
    ["lint-staged (.lintstagedrc)"] = 819,
    ["local.settings.json"] = 462,
    ["localazy.json"] = 463,
    ["lotus.yaml"] = 461,
    ["lsdlschema.json"] = 464,
    ["markdown-link-check"] = 883,
    maturin = 884,
    mboats = 891,
    ["micro-settings.json"] = 955,
    ["mimetypes.json"] = 476,
    ["mirrord config"] = 820,
    mise = 821,
    ["mkdocs.yml"] = 496,
    ["monospace.yml"] = 499,
    ["moon.yml"] = 1036,
    ["mprocs Configuration file"] = 1008,
    ["mrdocs.yml"] = 497,
    ["mta.yaml"] = 822,
    ["mtad.yaml"] = 823,
    ["mycode.json"] = 506,
    ...
    ["plagiarize.yaml"] = 571,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1040,
    ["podbard.yaml"] = 574,
    ["portman.json"] = 575,
    ["prefect.toml"] = 583,
    ["prettierrc.json"] = 584,
    ...
    samt = 651,
    samtrc = 652,
    ["sarif-1.0.0.json"] = 654,
    ["sarif-2.0.0.json"] = 655,
    ["sarif-2.1.0"] = 665,
    ["sarif-2.1.0-rtm.2"] = 656,
    ["sarif-2.1.0-rtm.3"] = 658,
    ["sarif-2.1.0-rtm.4"] = 660,
    ["sarif-2.1.0-rtm.5"] = 662,
    ["sarif-2.1.0-rtm.6"] = 663,
    ["sarif-external-property-file-2.1.0"] = 666,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 657,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 659,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 661,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 664,
    ["scalingo.json configuration"] = 667,
    ["schema.org - Action"] = 669,
    ["schema.org - ContactPoint"] = 670,
    ["schema.org - Place"] = 671,
    ["schema.org - Thing"] = 672,
    ["secrethub.yml"] = 958,
    ["semantic-release"] = 678,
    ["servicehub.config.json"] = 814,
    ["servicehub.service.json"] = 813,
    ["settings.job"] = 681,
    ["sfdx-hardis configuration"] = 683,
    ["shard.yml"] = 996,
    ["size-limit configuration"] = 688,
    ["skaffold.yaml"] = 881,
    ["skyuxconfig.json"] = 690,
    snapcraft = 691,
    ["snowflake-config"] = 692,
    ["snowflake-connections"] = 693,
    ["spicepod.yaml"] = 1015,
    ["sqlc configuration"] = 706,
    ["stripe-app-local.json"] = 715,
    ["stripe-app.json"] = 714,
    swcrc = 866,
    ["task.json"] = 724,
    taskcat = 831,
    ["template.json"] = 729,
    ["templatsources.json"] = 730,
    ["theme.json"] = 733,
    ["tizen_workspace.json"] = 734,
    tldr = 735,
    ["tm_devices configuration file"] = 1077,
    tmuxinator = 817,
    ["transcend.yml"] = 745,
    ["tree-sitter grammar.json"] = 367,
    ["trime.yaml"] = 746,
    ["trunk.yaml"] = 748,
    ["ts-force-config.json"] = 753,
    ["tsconfig.json"] = 749,
    ["tsd.json"] = 750,
    ["tsdoc.json"] = 751,
    ["tsdrc.json"] = 752,
    ...
    ["vega-lite.json"] = 777,
    ["vega.json"] = 776,
    ["venvironment-basic.yaml"] = 780,
    ["venvironment.yaml"] = 779,
    ["venvplus-basic.yaml"] = 782,
    ["venvplus.yaml"] = 781,
    version = 1059,
    ["version.json"] = 784,
    ["vhwdebugger-binding.yaml"] = 786,
    ["vim-addon-info"] = 787,
    ["vs-2017.3.host.json"] = 789,
    ["vs-nesting.json"] = 790,
    ["vsls.json"] = 788,
    ["vss-extension.json"] = 794,
    vtcfg = 1065,
    ["vtesttree.yaml"] = 795,
    ["vtestunit.yaml"] = 796,
    ["warp-keysets.json"] = 964,
    ["warp-themes.json"] = 965,
    ["warp-workflows.json"] = 966,
    ["webhint.io"] = 921,
    ["webjobpublishsettings.json"] = 801,
    ["webjobs-list.json"] = 800,
    ["well-known-fursona"] = 1003,
    ["xs-app.json"] = 826,
    ["xunit.runner.json"] = 812,
    yamllint = 854,
    zuul = 837,
    ["Žinoma"] = 847
  },
