...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 111,
    [".cryproj (generic)"] = 417,
    [".cryproj engine-5.2"] = 412,
    [".cryproj engine-5.3"] = 413,
    [".cryproj engine-5.4"] = 414,
    [".cryproj engine-5.5"] = 415,
    [".cryproj engine-dev"] = 416,
    [".csscomb.json"] = 113,
    [".csslintrc"] = 114,
    [".eslintrc"] = 150,
    [".esmrc.json"] = 143,
    ...
    [".mtaext"] = 423,
    [".nodehawkrc"] = 261,
    [".npmpackagejsonlintrc"] = 263,
    [".phraseapp.yml"] = 290,
    [".pmbot.yml"] = 283,
    [".postcssrc"] = 288,
    [".pre-commit-config.yml"] = 289,
    [".putout.json"] = 307,
    [".rehyperc"] = 312,
    [".remarkrc"] = 313,
    [".sprite files"] = 348,
    ...
    [".vsext"] = 393,
    [".yarnrc.yml"] = 455,
    ["<div>RIOTS' studio configuration"] = 396,
    ["API Builder"] = 452,
    ...
    ["Azure Pipelines"] = 40,
    ["Azure Static Web Apps CLI configuration file"] = 350,
    ["Azure Static Web Apps configuration file"] = 349,
    ["Better Code Hub"] = 457,
    BizTalkServerApplicationSchema = 429,
    ...
    ["Error pages"] = 146,
    Esquio = 144,
    ["Estuary Flow Catalog Schema"] = 495,
    ["Expo SDK"] = 149,
    ...
    Goreleaser = 176,
    ["Goreleaser Pro"] = 177,
    ["Gradle Build Cache Node"] = 454,
    ["Gradle Enterprise"] = 453,
    ...
    ["JSON Feed"] = 214,
    ["JSON Resume"] = 315,
    ["JSON Schema Draft 2020-12"] = 408,
    ["JSON Schema Draft 4"] = 405,
    ["JSON Schema Draft 7"] = 406,
    ["JSON Schema Draft 8"] = 407,
    ...
    ["KSP-AVC"] = 403,
    ["KSP-CKAN"] = 404,
    ["LinkML Metamodel"] = 229,
    Liquibase = 469,
    Markdownlint = 472,
    ["MegaLinter configuration"] = 233,
    ["MegaLinter descriptor"] = 234,
    ["Meltano plugin discovery definition"] = 236,
    ["Meltano project definition"] = 235,
    ["Microsoft Band Web Tile"] = 237,
    ["Minecraft Data Pack Advancement"] = 239,
    ["Minecraft Data Pack Biome"] = 240,
    ["Minecraft Data Pack Configured Carver"] = 241,
    ["Minecraft Data Pack Dimension"] = 243,
    ["Minecraft Data Pack Dimension Type"] = 242,
    ["Minecraft Data Pack Item Modifier"] = 244,
    ["Minecraft Data Pack Loot Table"] = 245,
    ["Minecraft Data Pack Metadata"] = 246,
    ["Minecraft Data Pack Predicate"] = 247,
    ["Minecraft Data Pack Recipe"] = 248,
    ["Minecraft Data Pack Template Pool"] = 249,
    ["Minecraft Resourcepack Sounds"] = 250,
    ["Netin Diagnostic System Template"] = 476,
    ["Netlify config schema"] = 255,
    ["Nightwatch.js"] = 256,
    ["OSS Review Toolkit repository configuration"] = 277,
    Opctl = 425,
    ["OpenWeather Current Weather API"] = 461,
    ["OpenWeather Road Risk API"] = 460,
    ["Ory Hydra configuration"] = 195,
    ["Ory Keto configuration"] = 220,
    ["Ory Kratos configuration"] = 276,
    ["Ory Oathkeeper configuration"] = 268,
    ["Outblocks App configuration"] = 274,
    ["Outblocks database table"] = 275,
    ["Outblocks project configuration"] = 273,
    Packer = 280,
    ["Pipeline component"] = 470,
    ["PocketMine plugin.yml"] = 284,
    ["Pull Request Labeler"] = 306,
    Qodana = 484,
    ["RKE Cluster Configuration JSON Schema"] = 468,
    ["RKE Cluster Configuration YAML Schema"] = 467,
    Ray = 437,
    ["Read the Docs"] = 309,
    ["Red-DiscordBot Cog"] = 310,
    ["Red-DiscordBot Cog Repo"] = 311,
    Renovate = 316,
    RoadRunner = 317,
    SWADL = 359,
    ["Sapphire CLI Config"] = 318,
    ["SauceCTL Configuration"] = 473,
    ["Schema Catalog"] = 331,
    ["Scoop manifest"] = 336,
    ["Semgrep Rule"] = 337,
    ["Serverless Framework Configuration"] = 480,
    ["Settings.paf"] = 339,
    ["Shopware 6 Configuration"] = 481,
    ["Shopware CLI Extension Store Configuration"] = 482,
    ["Shopware CLI Project Store Configuration"] = 483,
    Solidarity = 344,
    ["Source Maps v3"] = 345,
    SpecIF = 346,
    ["Sponge Mixin configuration"] = 347,
    ["StackHawk Scanner Configuration"] = 479,
    ["StackHead CLI config"] = 351,
    ["StackHead module configuration"] = 352,
    ["StackHead project definition"] = 353,
    Stale = 354,
    ["Statamic Blueprint"] = 355,
    ["Stryker Mutator"] = 356,
    ["StyleCop Analyzers Configuration"] = 357,
    ["Swagger API 2.0"] = 360,
    ["Taskfile YAML Schema"] = 463,
    Taurus = 361,
    ["TestEnvironment.json"] = 367,
    Tikibase = 364,
    ["Traefik v2"] = 369,
    ["Traefik v2 File Provider"] = 370,
    Tye = 485,
    ["UI5 Manifest"] = 382,
    ["Ubuntu Server Autoinstall"] = 380,
    ["Uniswap Token List"] = 446,
    Updatecli = 492,
    ["User Journey Map YAML Schema"] = 466,
    V2Ray = 496,
    ["VSCode Code Snippets"] = 89,
    ["VSIX CLI publishing"] = 394,
    ["Vela Pipeline Configuration"] = 386,
    Vercel = 88,
    ...
    ["Woodpecker pipeline config"] = 475,
    ["Xstate Machine Schema"] = 490,
    ["Yippee-Ki-JSON configuration YML"] = 448,
    ["angular.json"] = 8,
    ...
    ["mtad.yaml"] = 422,
    ["mycode.json"] = 253,
    ["napari plugin manifest"] = 254,
    neoload = 431,
    ["nest-cli"] = 259,
    ["ninjs (News in JSON) 1.3"] = 258,
    ["ninjs (News in JSON) 2.0"] = 257,
    ["nlu.json"] = 260,
    ["nodemon.json"] = 262,
    ["noodl.schema.json"] = 477,
    now = 427,
    ["nswag.json"] = 266,
    ntangle = 267,
    ["nuclei-template.yaml"] = 264,
    ["nuget-project.json"] = 265,
    ["ocelot.json"] = 269,
    ["omnisharp.json"] = 270,
    ["openapi.json"] = 271,
    ["openfin.json"] = 272,
    ["package.json"] = 278,
    ["package.manifest"] = 279,
    ["pattern.json"] = 282,
    pgap_yaml_input_reader = 281,
    ["plagiarize-me.yaml"] = 286,
    ["plagiarize.yaml"] = 285,
    ["portman.json"] = 287,
    ["prettierrc.json"] = 291,
    ["prisma.yml"] = 292,
    ["project-1.0.0-beta3.json"] = 294,
    ["project-1.0.0-beta4.json"] = 295,
    ["project-1.0.0-beta5.json"] = 296,
    ["project-1.0.0-beta6.json"] = 297,
    ["project-1.0.0-beta8.json"] = 298,
    ["project-1.0.0-rc1.json"] = 299,
    ["project-1.0.0-rc2.json"] = 300,
    ["project.json"] = 293,
    ["prometheus.json"] = 301,
    ["prometheus.rules.json"] = 302,
    ["proxies.json"] = 303,
    ["publiccode.yml"] = 304,
    ["pubspec.yaml"] = 305,
    ["pyrseas-0.8.json"] = 308,
    ["release drafter"] = 432,
    ["sarif-1.0.0.json"] = 319,
    ["sarif-2.0.0.json"] = 320,
    ["sarif-2.1.0"] = 329,
    ["sarif-2.1.0-rtm.2"] = 321,
    ["sarif-2.1.0-rtm.3"] = 323,
    ["sarif-2.1.0-rtm.4"] = 325,
    ["sarif-2.1.0-rtm.5"] = 327,
    ["sarif-external-property-file-2.1.0"] = 330,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 322,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 324,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 326,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 328,
    ["schema.org - Action"] = 332,
    ["schema.org - ContactPoint"] = 333,
    ["schema.org - Place"] = 334,
    ["schema.org - Thing"] = 335,
    ["service.datadog.yaml"] = 219,
    ["servicehub.config.json"] = 411,
    ["servicehub.service.json"] = 410,
    ["settings.job"] = 338,
    ["sfdx-hardis configuration"] = 340,
    ["size-limit configuration"] = 341,
    ["skaffold.yaml"] = 471,
    ["skyuxconfig.json"] = 342,
    snapcraft = 343,
    swcrc = 459,
    taskcat = 428,
    ["template.json"] = 362,
    ["templatsources.json"] = 363,
    ["theme.json"] = 365,
    tmLanguage = 366,
    ["trunk.yaml schema"] = 371,
    ["ts-force-config.json"] = 375,
    ["tsconfig.json"] = 372,
    ["tsd.json"] = 373,
    ["tsdrc.json"] = 374,
    ["tslint.json"] = 376,
    ...
    ["version.json"] = 387,
    ["vim-addon-info"] = 388,
    ["vs-2017.3.host.json"] = 390,
    ["vs-nesting.json"] = 391,
    ["vsls.json"] = 389,
    ["vss-extension.json"] = 395,
    ["webjobpublishsettings.json"] = 400,
    ["webjobs-list.json"] = 399,
    ["xs-app.json"] = 424,
    ["xunit.runner.json"] = 409,
    yamllint = 447,
    zuul = 433,
    ["Žinoma"] = 441
  },
