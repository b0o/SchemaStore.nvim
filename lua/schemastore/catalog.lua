...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 193,
    [".cryproj (generic)"] = 654,
    [".cryproj engine-5.2"] = 649,
    [".cryproj engine-5.3"] = 650,
    [".cryproj engine-5.4"] = 651,
    [".cryproj engine-5.5"] = 652,
    [".cryproj engine-dev"] = 653,
    [".eslintrc"] = 248,
    [".esmrc.json"] = 240,
    [".ffizer.yaml"] = 252,
    [".htmlhintrc"] = 307,
    ...
    [".mtaext"] = 665,
    [".nodehawkrc"] = 416,
    [".npmpackagejsonlintrc"] = 419,
    [".phrase.yml"] = 465,
    [".phraseapp.yml"] = 466,
    [".pmbot.yml"] = 455,
    [".postcssrc"] = 460,
    [".powerpages-web-template-manifest"] = 462,
    [".pre-commit-config.yml"] = 463,
    [".pre-commit-hooks.yml"] = 464,
    [".putout.json"] = 485,
    [".rehyperc"] = 498,
    [".remarkrc"] = 500,
    [".sprite files"] = 558,
    ...
    ["<div>RIOTS' studio configuration"] = 632,
    ["@factorial/drupal-breakpoints-css"] = 4,
    ["A micro editor config"] = 371,
    AIConfig = 11,
    ["API Builder"] = 697,
    ["AVA Configuration"] = 757,
    ...
    ["Adobe UXP Manifest"] = 822,
    ["Aerleon Network & Service Definitions"] = 7,
    ["Aerleon Policy"] = 8,
    ["Airlock Microgateway"] = 12,
    ["Airplane task"] = 13,
    ["Alacritty Configuration"] = 729,
    ["All Contributors configuration file"] = 787,
    ...
    ["Azure Pipelines"] = 64,
    ["Azure Static Web Apps CLI configuration file"] = 561,
    ["Azure Static Web Apps configuration file"] = 560,
    ["BX CI"] = 102,
    ["Bashly (bashly.yml)"] = 791,
    ["Bashly Settings (bashly-settings.yml)"] = 792,
    ["Better Code Hub"] = 701,
    ["Better Scripts"] = 103,
    Bigconfig = 81,
    BizTalkServerApplicationSchema = 671,
    Bleep = 104,
    ...
    ["Butane Config"] = 742,
    ["CGS Custom Card Game (CardGameDef.json)"] = 827,
    ["CICS TS region tagging"] = 751,
    ["CICS TS resource import"] = 752,
    ["CICS TS resource model"] = 753,
    ["CICS TS resource overrides"] = 754,
    ["CMake Presets"] = 105,
    ["CNC Codes"] = 117,
    ...
    ["DataYoga Job"] = 124,
    ["Databricks Asset Bundles"] = 808,
    ["Datadog Service Definition"] = 348,
    ["Datahub Ingestion Recipe"] = 758,
    ["Dein Config"] = 126,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 799,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 788,
    ...
    ["GeoJSON.json latest"] = 746,
    GherKing = 750,
    ["GitHub Action"] = 274,
    ["GitHub Discussion"] = 275,
    ["GitHub Funding"] = 276,
    ["GitHub Issue Template configuration"] = 278,
    ["GitHub Issue Template forms"] = 277,
    ["GitHub Workflow"] = 279,
    ["GitHub Workflow Template Properties"] = 280,
    ["GitLab Agent for Kubernetes configuration"] = 824,
    GitVersion = 272,
    ["Gitea Issue Template forms"] = 273,
    ["Gitpod Configuration"] = 282,
    ["GlazeWM settings"] = 826,
    ["Global Privacy Control"] = 271,
    Goblet = 807,
    ["Golangci-lint Configuration"] = 284,
    ["Golangci-lint Custom Plugins Configuration"] = 285,
    ["Google Chrome Related Website Sets"] = 254,
    ["Google Cloud Workflows"] = 176,
    Goreleaser = 287,
    ["Goreleaser Pro"] = 288,
    Goss = 289,
    ["Gradle Build Cache Node"] = 699,
    ["Gradle Enterprise"] = 698,
    ["Grafana 5.x Dashboard"] = 290,
    ["GraphQL Code Generator"] = 294,
    ["GraphQL Config"] = 293,
    ["GraphQL Mesh"] = 292,
    ["Grunt JSHint task"] = 298,
    ["Grunt Watch task"] = 299,
    ["Grunt base task"] = 300,
    ["Grunt clean task"] = 296,
    ["Grunt copy task"] = 295,
    ["Grunt cssmin task"] = 297,
    HEMTT = 668,
    Hadolint = 680,
    Hammerkit = 708,
    ["Hardware Sentry Configuration"] = 762,
    Hatch = 681,
    Hayson = 302,
    ["Haystack Pipeline"] = 303,
    ["Hazelcast 5 Configuration"] = 304,
    ["Helm Chart.lock"] = 145,
    ["Helm Chart.yaml"] = 144,
    ["Helm Unittest Test Suite"] = 146,
    Hugo = 738,
    ["Hugo Theme"] = 737,
    ["IBM Zapp document"] = 309,
    ["IBM zCodeFormatSettings"] = 310,
    ["IMG Catapult PSP"] = 315,
    ["IVMS101 by CODE Protocol"] = 825,
    Istanbul = 765,
    ["JDownloader2 crawler multi-rules"] = 325,
    ["JDownloader2 crawler single-rules"] = 324,
    ["JFrog Applications Config"] = 326,
    ["JFrog File Spec"] = 327,
    ["JFrog Pipelines YML DSL"] = 771,
    ["JMeter DSL cli config"] = 328,
    JReleaser = 330,
    ["JSON Document Transform"] = 338,
    ["JSON Feed"] = 339,
    ["JSON Resume"] = 505,
    ["JSON Schema Draft 2020-12"] = 645,
    ["JSON Schema Draft 4"] = 642,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 809,
    ["JSON Schema Draft 7"] = 643,
    ["JSON Schema Draft 7 (unofficial strict)"] = 810,
    ["JSON Schema Draft 8 (2019-09)"] = 644,
    ["JSON-API"] = 337,
    ["JSON-e templates"] = 706,
    ["JSON-stat 2.0"] = 639,
    JSONPatch = 341,
    ["JSR Package Config (jsr.json)"] = 331,
    Jasmine = 320,
    Jekyll = 321,
    ["Jenkins X Pipelines"] = 322,
    ["Jenkins X Requirements"] = 323,
    ["Jovo Language Models"] = 329,
    ...
    Kas = 344,
    ["Keycloak REST API"] = 779,
    ["Knative Functions - func.yaml"] = 265,
    ["KoDE/CI build.yaml"] = 767,
    ["Kong DBLess config"] = 768,
    KrakenD = 347,
    LOOBin = 366,
    Lefthook = 355,
    ["Liferay client-extension.yaml"] = 362,
    ["LinkML Metamodel"] = 364,
    Liquibase = 714,
    ["Liquibase Flow File"] = 715,
    ["Lively Properties"] = 365,
    ["Lobe AI Agent"] = 63,
    ["MLOS Configs"] = 400,
    ["MS2Rescore Configuration"] = 403,
    ["Madness (madness.yml)"] = 790,
    Markdownlint = 718,
    ["Mason Registry"] = 720,
    ["MegaLinter configuration"] = 372,
    ["MegaLinter descriptor"] = 373,
    Melange = 816,
    ["Meltano plugin discovery definition"] = 375,
    ["Meltano project definition"] = 374,
    ["MetricsHub Configuration"] = 376,
    ["MetricsHub Connector Configuration"] = 377,
    ["Micro Editor Syntax"] = 800,
    ["Microsoft Band Web Tile"] = 378,
    ["Minecraft Custom Main Menu Mod"] = 817,
    ["Minecraft Data Pack Advancement"] = 380,
    ["Minecraft Data Pack Biome"] = 381,
    ["Minecraft Data Pack Configured Carver"] = 382,
    ["Minecraft Data Pack Damage Type"] = 383,
    ["Minecraft Data Pack Dimension"] = 385,
    ["Minecraft Data Pack Dimension Type"] = 384,
    ["Minecraft Data Pack Item Modifier"] = 386,
    ["Minecraft Data Pack Loot Table"] = 387,
    ["Minecraft Data Pack Metadata"] = 388,
    ["Minecraft Data Pack Predicate"] = 389,
    ["Minecraft Data Pack Recipe"] = 390,
    ["Minecraft Data Pack Tag"] = 391,
    ["Minecraft Data Pack Template Pool"] = 392,
    ["Minecraft Data Pack Trim Material"] = 397,
    ["Minecraft Data Pack Trim Pattern"] = 398,
    ["Minecraft Resource Pack Lang"] = 393,
    ["Minecraft Resource Pack Particle"] = 394,
    ["Minecraft Resource Pack Texture Mcmeta"] = 396,
    ["Minecraft Resourcepack Sounds"] = 395,
    ["MkDocs Configuration 1.0"] = 399,
    ["Monade CLI Stack Configuration"] = 406,
    ["MongoDB Atlas Search Index Definition"] = 766,
    ["Monika Configuration"] = 764,
    ["Monoweave Configuration"] = 402,
    ["Motif config"] = 664,
    ["NOX Framework (Service)"] = 418,
    ["Netin Diagnostic System Template"] = 724,
    ["Netlify config"] = 409,
    ["Network-as-Code Data Model"] = 410,
    ["Nightwatch.js"] = 411,
    ["Nuitka.yaml"] = 830,
    ["ONe's changelog entry"] = 434,
    ["ONe's service descriptor"] = 433,
    ["OSS Review Toolkit configuration"] = 441,
    ["OSS Review Toolkit curation"] = 442,
    ["OSS Review Toolkit package configuration"] = 443,
    ["OSS Review Toolkit repository configuration"] = 444,
    ["OSS Review Toolkit resolutions"] = 445,
    Opctl = 667,
    ["OpenRewrite Resource"] = 436,
    ["OpenUtau character yaml"] = 430,
    ["OpenUtau ustx"] = 431,
    ["OpenWeather Current Weather API"] = 705,
    ["OpenWeather Road Risk API"] = 704,
    ["Ory Hydra configuration"] = 308,
    ["Ory Keto configuration"] = 349,
    ["Ory Kratos configuration"] = 440,
    ["Ory Oathkeeper configuration"] = 425,
    ["Outblocks App configuration"] = 438,
    ["Outblocks database table"] = 439,
    ["Outblocks project configuration"] = 437,
    PDM = 451,
    Packer = 448,
    Pantsbuild = 786,
    ["Paper paper-plugin.yml"] = 449,
    ["Pipeline component"] = 716,
    ["PocketMine plugin.yml"] = 456,
    ["Postman collection"] = 461,
    ["Problem object RFC9457"] = 814,
    ["Problem package generators"] = 469,
    Pterodactyl = 761,
    ["Pull Request Labeler"] = 484,
    Pulumi = 490,
    PyProject = 491,
    Pyright = 492,
    Qgoda = 493,
    Qodana = 734,
    ["Quali Torque Blueprint Spec 2"] = 759,
    ["QueryFirst config file"] = 782,
    ["RKE Cluster Configuration JSON"] = 713,
    ["RKE Cluster Configuration YAML"] = 712,
    ["Rancher Fleet"] = 487,
    ["Rattler-build"] = 494,
    Ray = 679,
    ["Read the Docs"] = 489,
    ["Red-DiscordBot Cog"] = 495,
    ["Red-DiscordBot Cog Repo"] = 496,
    ["Red-DiscordBot Trivia"] = 497,
    ["Render Blueprints"] = 711,
    RenderCV = 507,
    Renovate = 506,
    ["Replit config"] = 501,
    RoadRunner = 508,
    ["Rudder techniques"] = 820,
    Ruff = 503,
    ["Rust Project"] = 504,
    ["Rust toolchain"] = 511,
    ["SDMX data message"] = 536,
    ["SDMX metadata message"] = 535,
    ["SDMX structure message"] = 534,
    ["SIL Kit Participant Configuration"] = 546,
    ["SIL Kit Registry Configuration"] = 547,
    SWADL = 572,
    ["Safebox Config"] = 772,
    ["Sapphire CLI Config"] = 514,
    ["SauceCTL Configuration"] = 721,
    ["Schema Catalog"] = 528,
    ["Scoop manifest"] = 533,
    ["Semantic Data Fabric (SDF) file"] = 537,
    ["Semgrep Rule"] = 539,
    ["Serenity Code Generator (Sergen)"] = 540,
    ["Serverless Framework Configuration"] = 728,
    ["Serverless Workflow"] = 730,
    ["Settings.paf"] = 542,
    ["Shopware 6 Configuration"] = 731,
    ["Shopware CLI Extension Store Configuration"] = 732,
    ["Shopware CLI Project Store Configuration"] = 733,
    Sigma = 544,
    ["Sigrid scope configuration file"] = 545,
    ["SkyPilot Task JSON"] = 821,
    ["Slack app manifest"] = 549,
    Solidarity = 552,
    ["Solution filters"] = 553,
    ["Source Maps v3"] = 554,
    Sourcery = 555,
    SpecIF = 556,
    ["Sponge Mixin configuration"] = 557,
    StackBlitz = 562,
    ["StackHawk Scanner Configuration"] = 727,
    Stale = 563,
    ["Starlake Data Pipeline"] = 702,
    Starship = 564,
    ["Statamic Blueprint"] = 565,
    ["Stella configuration file"] = 566,
    ["StrmPrivacy Data Connector"] = 776,
    ["StrmPrivacy Data Contract"] = 777,
    ["StrmPrivacy SimpleSchema"] = 774,
    ["StrmPrivacy Stream"] = 775,
    ["StrmPrivacy batch job configuration file"] = 773,
    ["Stryker Mutator"] = 569,
    ["StyleCop Analyzers Configuration"] = 570,
    ["Stylelint (.stylelintrc)"] = 571,
    ["Sublime Syntax"] = 778,
    ["Subsquid squid manifest"] = 823,
    ["Swagger API 2.0"] = 573,
    TSON = 599,
    TSTyche = 600,
    Talhelper = 575,
    ["Talisman configuration"] = 576,
    ["Taskfile config"] = 707,
    Taurus = 577,
    ["TestEnvironment.json"] = 586,
    ["TextMate Grammar"] = 585,
    ["Tier.run pricing.json"] = 580,
    Tikibase = 581,
    ["Traefik v2"] = 589,
    ["Traefik v2 File Provider"] = 590,
    ["Travis CI (.travis.yml)"] = 588,
    TunnelHub = 813,
    Turborepo = 587,
    Tye = 735,
    ["UET BuildConfig.json"] = 783,
    ["UI5 Manifest"] = 609,
    ["UNCORS configuration"] = 613,
    ["UTAM Page Object"] = 612,
    ["Ubuntu Server Autoinstall"] = 607,
    ["Uniswap Token List"] = 690,
    ["Unreal Engine Uplugin"] = 784,
    ["Unreal Engine Uproject"] = 785,
    ["Updatecli Compose"] = 743,
    ["Updatecli Policy Manifest"] = 744,
    ["Updatecli Policy Metadata"] = 745,
    Uplift = 781,
    ["User Journey Map"] = 710,
    V2Ray = 749,
    ["VSCode Code Snippets"] = 164,
    ["VSIX CLI publishing"] = 627,
    ["Vela Pipeline Configuration"] = 616,
    Vercel = 163,
    Visivo = 811,
    ["Web App Manifest"] = 634,
    ["Web types"] = 637,
    WebExtensions = 633,
    ["Webman package recipe"] = 755,
    ["Windows Package Manager Installer Manifest"] = 687,
    ["Windows Package Manager Locale Manifest"] = 688,
    ["Windows Package Manager Singleton Manifest"] = 686,
    ["Woodpecker pipeline config"] = 723,
    ["Wrangler CLI"] = 638,
    ["Xstate Machine"] = 741,
    ["Yarn Config (.yarnrc.yml)"] = 700,
    ["Yippee-Ki-JSON configuration YML"] = 692,
    ["aerleon.yml"] = 6,
    ["angular.json"] = 14,
    apko = 815,
    ...
    ["behat.yml"] = 88,
    ["bigquery-table"] = 80,
    ["bioimageio resource description"] = 831,
    ...
    ["gitlab-ci"] = 281,
    ["global.json"] = 283,
    ["go-feature-flag Flag Configuration"] = 286,
    ["haxelib.json"] = 301,
    helmfile = 682,
    helmwave = 683,
    ["host-meta.json"] = 306,
    ...
    ["ide.host.json"] = 311,
    ["ifstate.conf"] = 312,
    ["imageoptimizer.json"] = 313,
    ["importmap.json"] = 316,
    ["ioBroker Configuration"] = 317,
    ["ioBroker JSON UI"] = 318,
    ["ioBroker Package manifest"] = 319,
    ["ize.toml"] = 780,
    ["jsconfig.json"] = 342,
    ["jscpd Configuration"] = 760,
    jsdoc = 678,
    ["k3d.yaml"] = 343,
    ["k9s plugin.yml"] = 345,
    ["kontinuous-config.yaml"] = 351,
    ["kontinuous-values.yaml"] = 350,
    ["kustomization.yaml"] = 352,
    ["label-commenter-config.yml"] = 353,
    ["latexindent configuration"] = 62,
    ["launchsettings.json"] = 354,
    lazydocker = 802,
    lazygit = 801,
    ["lego.json"] = 356,
    ["lerna.json"] = 357,
    ["lgtm.yml"] = 358,
    ["liblab.config.json"] = 359,
    ["libman.json"] = 360,
    ["license-report-config.json"] = 361,
    ["linkinator.config.json"] = 363,
    ["lint-staged (.lintstagedrc)"] = 658,
    ["local.settings.json"] = 368,
    ["localazy.json"] = 369,
    ["lotus.yaml"] = 367,
    ["lsdlschema.json"] = 370,
    ["markdown-link-check"] = 719,
    mboats = 726,
    ["micro-settings.json"] = 795,
    ["mimetypes.json"] = 379,
    ["mirrord config"] = 659,
    mise = 660,
    ["mise-settings"] = 661,
    ...
    ["mtad.yaml"] = 663,
    ["mycode.json"] = 407,
    ["napari plugin manifest"] = 408,
    neoload = 673,
    ["nest-cli"] = 414,
    ["ninjs (News in JSON) 1.3"] = 413,
    ["ninjs (News in JSON) 2.0"] = 412,
    ["nixd configuration"] = 819,
    ["nlu.json"] = 415,
    ["nodemon.json"] = 417,
    ["noodl config"] = 725,
    now = 669,
    ...
    ["nswag.json"] = 423,
    ntangle = 424,
    ["nuclei-template.yaml"] = 421,
    ["nuget-project.json"] = 422,
    ["ocelot.json"] = 426,
    ["omnisharp.json"] = 427,
    ["openapi.json"] = 428,
    ["openfin.json"] = 435,
    ...
    ["ops.yaml"] = 432,
    ["package.json"] = 446,
    ["package.manifest"] = 447,
    ["partial-black.json"] = 89,
    ["pathfinder.yml"] = 450,
    ["pattern.json"] = 453,
    ["petstore-v1.0"] = 770,
    pgap_yaml_input_reader = 452,
    ["pixi.toml"] = 454,
    ["plagiarize-me.yaml"] = 458,
    ["plagiarize.yaml"] = 457,
    ["portman.json"] = 459,
    ["prettierrc.json"] = 467,
    ["prisma.yml"] = 468,
    ["project-1.0.0-beta3.json"] = 471,
    ["project-1.0.0-beta4.json"] = 472,
    ["project-1.0.0-beta5.json"] = 473,
    ["project-1.0.0-beta6.json"] = 474,
    ["project-1.0.0-beta8.json"] = 475,
    ["project-1.0.0-rc1.json"] = 476,
    ["project-1.0.0-rc2.json"] = 477,
    ["project.json"] = 470,
    ["prometheus.json"] = 478,
    ["prometheus.rules.json"] = 479,
    ["prometheus.rules.test.json"] = 480,
    ["proxies.json"] = 481,
    ["publiccode.yml"] = 482,
    ["pubspec.yaml"] = 483,
    ["pyrseas-0.8.json"] = 486,
    ["quilt.mod.json"] = 796,
    ["release drafter"] = 674,
    ["release-plz.toml"] = 499,
    ["rivet.yaml"] = 818,
    rockcraft = 509,
    rustfmt = 510,
    samt = 512,
    samtrc = 513,
    ["sarif-1.0.0.json"] = 515,
    ["sarif-2.0.0.json"] = 516,
    ["sarif-2.1.0"] = 526,
    ["sarif-2.1.0-rtm.2"] = 517,
    ["sarif-2.1.0-rtm.3"] = 519,
    ["sarif-2.1.0-rtm.4"] = 521,
    ["sarif-2.1.0-rtm.5"] = 523,
    ["sarif-2.1.0-rtm.6"] = 524,
    ["sarif-external-property-file-2.1.0"] = 527,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 518,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 520,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 522,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 525,
    ["schema.org - Action"] = 529,
    ["schema.org - ContactPoint"] = 530,
    ["schema.org - Place"] = 531,
    ["schema.org - Thing"] = 532,
    ["secrethub.yml"] = 798,
    ["semantic-release"] = 538,
    ["servicehub.config.json"] = 648,
    ["servicehub.service.json"] = 647,
    ["settings.job"] = 541,
    ["sfdx-hardis configuration"] = 543,
    ["shard.yml"] = 834,
    ["size-limit configuration"] = 548,
    ["skaffold.yaml"] = 717,
    ["skyuxconfig.json"] = 550,
    snapcraft = 551,
    ["sqlc configuration"] = 559,
    ["stripe-app-local.json"] = 568,
    ["stripe-app.json"] = 567,
    swcrc = 703,
    ["task.json"] = 574,
    taskcat = 670,
    ["template.json"] = 578,
    ["templatsources.json"] = 579,
    ["theme.json"] = 582,
    ["tizen_workspace.json"] = 583,
    tldr = 584,
    tmuxinator = 656,
    ["transcend.yml"] = 591,
    ["tree-sitter grammar.json"] = 291,
    ["trime.yaml"] = 592,
    ["trunk.yaml"] = 593,
    ["ts-force-config.json"] = 597,
    ["tsconfig.json"] = 594,
    ["tsd.json"] = 595,
    ["tsdrc.json"] = 596,
    ["tslint.json"] = 598,
    ...
    ["vega-lite.json"] = 615,
    ["vega.json"] = 614,
    ["venvironment-basic.yaml"] = 618,
    ["venvironment.yaml"] = 617,
    ["version.json"] = 619,
    ["vim-addon-info"] = 621,
    ["vs-2017.3.host.json"] = 623,
    ["vs-nesting.json"] = 624,
    ["vsls.json"] = 622,
    ["vss-extension.json"] = 628,
    ["vtesttree.yaml"] = 629,
    ["vtestunit.yaml"] = 630,
    ["warp-keysets.json"] = 804,
    ["warp-themes.json"] = 805,
    ["warp-workflows.json"] = 806,
    ["webhint.io"] = 756,
    ["webjobpublishsettings.json"] = 636,
    ["webjobs-list.json"] = 635,
    ["xs-app.json"] = 666,
    ["xunit.runner.json"] = 646,
    yamllint = 691,
    zuul = 675,
    ["Žinoma"] = 685
  },
