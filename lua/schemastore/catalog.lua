...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 21,
    AIConfig = 22,
    ["AMX Muse Program Descriptor"] = 1120,
    ["API Builder"] = 930,
    ...
    ["AWS Copilot Manifest"] = 1159,
    ["AWS SAM CLI Samconfig"] = 240,
    ["Adobe UXP Manifest"] = 1056,
    ["Aerleon Network & Service Definitions"] = 15,
    ["Aerleon Policy"] = 16,
    Aider = 1149,
    Air = 18,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1170,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1169,
    ["Airlock Microgateway"] = 23,
    ["Alacritty Configuration"] = 965,
    ["All Contributors configuration file"] = 1019,
    ...
    ["Application list for a WinUtil"] = 1100,
    ArchitectFX = 1105,
    ["Argo CD"] = 41,
    ["Argo Events"] = 42,
    ["Argo Workflows"] = 43,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1168,
    ["Azure IoT Operations connector metadata"] = 1165,
    ...
    ["BX CI"] = 139,
    ["Bacon config"] = 2,
    ["Bashly (bashly.yml)"] = 1023,
    ["Bashly Settings (bashly-settings.yml)"] = 1024,
    ["Better Code Hub"] = 935,
    ["Better Scripts"] = 140,
    Bigconfig = 112,
    ["Biome Formatter Config"] = 68,
    ["Bitmovin Encoding Template"] = 1113,
    ...
    ["Butane Config"] = 978,
    C4InterFlow = 1128,
    ["CDK Environment Manager, concrete environment configuration"] = 1152,
    ["CDK Environment Manager, concrete environments definition"] = 1151,
    ["CDK Environment Manager, environment definition"] = 1150,
    ["CGS Card Game Specification (cgs.json)"] = 1061,
    ...
    ["CMake Presets"] = 142,
    ["CNC Codes"] = 163,
    ["CRS WAF test file"] = 1090,
    ["CRS WAF test platform overrides file"] = 1091,
    ...
    ["Chamaleon environment"] = 1117,
    ["Chamaleon properties"] = 1118,
    ["Chamaleon template"] = 1116,
    Changesets = 249,
    Changie = 151,
    Charmcraft = 152,
    Cheatsheets = 975,
    ...
    ["Clawject config"] = 169,
    ["Cloud Foundry Application Manifest"] = 1072,
    ["Cloud Run Spec v1"] = 1095,
    ...
    ["DonateCaseBetterCasino menu"] = 1121,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1031,
    ["EAS config"] = 325,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1020,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1164,
    ["EasyVCR .NET"] = 326,
    ["Eidolon Resource"] = 1106,
    ...
    ["Evolving Resolutive Process notation"] = 1166,
    ["Expo SDK"] = 324,
    ...
    ["Google Digital Assetlinks"] = 1145,
    Goreleaser = 386,
    ["Goreleaser Pro"] = 387,
    Goss = 388,
    ...
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1041,
    ["JSON Schema Draft 7"] = 878,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1042,
    ...
    ["Jujutsu (jj) VCS config"] = 1158,
    ["KIMMDY config file"] = 466,
    ["KODE/CI build.yaml"] = 1004,
    ["KSP-AVC"] = 874,
    ["KSP-CKAN"] = 875,
    ["KSP-NetKAN"] = 876,
    KSY = 1071,
    ...
    ["Lando (landofile)"] = 91,
    ["LangGraph Platform configuration"] = 1082,
    ["Language configuration"] = 1081,
    Lefthook = 481,
    ...
    ["Metadata for a Cinnamon spice"] = 1098,
    ["Metatype Configuration"] = 506,
    ["MetricsHub Configuration"] = 507,
    ["MetricsHub Connector Configuration"] = 508,
    ["Micro Editor Syntax"] = 1032,
    ["Microsoft Band Web Tile"] = 509,
    ["Microsoft RulesEngine workflow rules"] = 1086,
    ["Microsoft RulesEngine workflow rules list"] = 1087,
    ["Minecraft Custom Main Menu Mod"] = 1050,
    ...
    ["MongoDB Atlas Search Index Definition"] = 1003,
    ["Monika Configuration"] = 1001,
    ...
    ["Power Pages Configuration"] = 1155,
    ["Preset list for a WinUtil"] = 1101,
    ...
    Pylock = 1146,
    Pyright = 662,
    ["Python script metadata"] = 1140,
    ["QType AI DSL"] = 665,
    Qgoda = 664,
    Qodana = 970,
    ["Qt Creator workspace file"] = 1079,
    ["Quali Torque Blueprint Spec 2"] = 995,
    ["QueryFirst config file"] = 1014,
    ...
    ["Replit config"] = 683,
    Restate = 1133,
    ["Revel Digital Gadget Definition File"] = 1157,
    RoadRunner = 692,
    ["Robust Station Image"] = 1163,
    Rockcraft = 693,
    ["Roo Coder Custom Modes"] = 694,
    Rubocop = 685,
    ["Rudder techniques"] = 1054,
    Ruff = 686,
    ["Rust Project"] = 687,
    ["Rust toolchain"] = 698,
    ...
    ["Settings for a Cinnamon spice"] = 1097,
    ["Settings.paf"] = 730,
    ...
    ["Stylua Config"] = 1147,
    ["Sublime Syntax"] = 1010,
    ["Subsquid squid manifest"] = 1057,
    ["Swagger API 2.0"] = 789,
    ["Synadia Connect Component"] = 790,
    TSON = 825,
    TSTyche = 826,
    ["TYPO3 Vendor Bundler config"] = 831,
    ["Tab data for a LinUtil"] = 1104,
    ["Tab list for a LinUtil"] = 1103,
    Tach = 791,
    ["Tach Domain"] = 792,
    Talhelper = 794,
    ...
    Taurus = 796,
    Tauticord = 797,
    ["Tekton Pipeline"] = 1176,
    ["Tekton PipelineRun"] = 1177,
    ["Tekton Task"] = 1174,
    ["Tekton TaskRun"] = 1175,
    Telefonistka = 1134,
    ["Terrateam config"] = 1160,
    ...
    ["Tugboat QA config.yml"] = 1127,
    TunnelHub = 1045,
    Turborepo = 809,
    Tycho = 1093,
    Tye = 971,
    ["Tyk Gateway - Open Source v5.7+"] = 1139,
    ["Typst Manifest"] = 832,
    ["UET BuildConfig.json"] = 1015,
    ["UI5 Manifest"] = 838,
    ["UNCORS configuration"] = 842,
    ["UTAM Page Object"] = 841,
    ["Ubuntu Server Autoinstall"] = 836,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1131,
    ["Uniswap Token List"] = 923,
    ["Universal Schedule Format"] = 843,
    ["Unreal Engine Uplugin"] = 1016,
    ["Unreal Engine Uproject"] = 1017,
    ["UpCloud CLI (upctl) configuration"] = 1132,
    ...
    ["Viash Component Config"] = 1136,
    ["Viash Package Config"] = 1137,
    Visivo = 1043,
    ["WP-CLI"] = 871,
    Wake = 1129,
    ["Waku Config"] = 1107,
    ...
    Winutil = 921,
    ["WireMock CLI import configuration"] = 1112,
    ["WireMock CLI local service configuration"] = 1111,
    ["WireMock stub mapping"] = 1110,
    ["Woodpecker pipeline config"] = 959,
    ["Wrangler CLI"] = 872,
    ["Xstate Machine"] = 977,
    ["Yandex Workflow Language"] = 1099,
    ["Yarn Config (.yarnrc.yml)"] = 934,
    ["Yippee-Ki-JSON configuration YML"] = 925,
    ["YouTrack App"] = 1096,
    ["Zarf Package Configuration"] = 1162,
    ["Zerops.io config"] = 1084,
    ["Zerops.io import"] = 1085,
    ["Zola Configuration"] = 1173,
    ["aerleon.yml"] = 14,
    ["angular.json"] = 24,
    apko = 1048,
    ...
    ["behat.yml"] = 122,
    ["bigquery-table"] = 111,
    ["bioimageio resource description"] = 1065,
    ...
    ["crowdin.yml"] = 258,
    ["ctfd-setup configuration file"] = 1119,
    ["custom-elements.json"] = 1035,
    ["cypress.json"] = 262,
    ...
    ["gematik health care insurance list"] = 1125,
    ["gematik health care patient list"] = 1122,
    ["gematik health care provider institution list"] = 1124,
    ["gematik health care provider list"] = 1123,
    ["gematik tiger test environment configuration"] = 1126,
    ["git-town.toml"] = 1171,
    ["gitlab-ci"] = 366,
    ["global.json"] = 382,
    ...
    ["monospace.yml"] = 533,
    ["moon.yml"] = 1109,
    ["mprocs Configuration file"] = 1080,
    ["mrdocs.yml"] = 531,
    ["mta.yaml"] = 892,
    ["mtad.yaml"] = 893,
    ["mycode.json"] = 540,
    ...
    ["plagiarize.yaml"] = 612,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1115,
    ["podbard.yaml"] = 615,
    ["portman.json"] = 618,
    ["prefect.toml"] = 626,
    ["prettierrc.json"] = 627,
    ...
    tldr = 805,
    ["tm_devices configuration file"] = 1153,
    tmuxinator = 886,
    ["transcend.yml"] = 815,
    ...
    ["vtesttree.yaml"] = 863,
    ["vtestunit.yaml"] = 864,
    ["warp-keysets.json"] = 1036,
    ["warp-themes.json"] = 1037,
    ["warp-workflows.json"] = 1038,
    ["webhint.io"] = 992,
    ["webjobpublishsettings.json"] = 869,
    ["webjobs-list.json"] = 868,
    ["well-known-fursona"] = 1075,
    ["xs-app.json"] = 896,
