...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 798,
    [".nodehawkrc"] = 500,
    [".npmpackagejsonlintrc"] = 504,
    [".omletrc"] = 972,
    [".phrase.yml"] = 565,
    [".phraseapp.yml"] = 566,
    [".pmbot.yml"] = 553,
    [".postcssrc"] = 560,
    [".powerpages-web-template-manifest"] = 562,
    [".pre-commit-config.yml"] = 563,
    [".pre-commit-hooks.yml"] = 564,
    [".putout.json"] = 587,
    [".rehyperc"] = 610,
    [".remarkrc"] = 614,
    [".sprite files"] = 681,
    ...
    ["A micro editor config"] = 453,
    ABCInventoryModuleData = 14,
    ABCSupplyPlan = 15,
    AIConfig = 16,
    ["AMX Muse Program Descriptor"] = 1016,
    ["API Builder"] = 833,
    ["AVA Configuration"] = 895,
    ["AWS AppConfig Feature Flags-v1"] = 44,
    ["AWS CDK cdk.json"] = 204,
    ["AWS CloudFormation"] = 205,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 206,
    ["AWS SAM CLI Samconfig"] = 207,
    ["Adobe UXP Manifest"] = 955,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    Air = 12,
    ["Airlock Microgateway"] = 17,
    ["Alacritty Configuration"] = 867,
    ["All Contributors configuration file"] = 920,
    ["Ansible Argument Specs"] = 337,
    ["Ansible Collection Galaxy"] = 344,
    ["Ansible Execution Environment"] = 334,
    ["Ansible Inventory"] = 343,
    ["Ansible Meta"] = 335,
    ["Ansible Meta Runtime"] = 336,
    ["Ansible Navigator Configuration"] = 346,
    ["Ansible Playbook"] = 341,
    ["Ansible Requirements"] = 338,
    ["Ansible Rulebook"] = 342,
    ["Ansible Tasks File"] = 340,
    ["Ansible Vars File"] = 339,
    ["Ansible-lint Configuration"] = 345,
    Any = 981,
    ["AnyWork Automation Configuration"] = 5,
    ["App config Spotify Backstage"] = 21,
    ["Application Accelerator"] = 2,
    ["Application list for a WinUtil"] = 998,
    ArchitectFX = 1003,
    ["Argo Events"] = 34,
    ["Argo Workflows"] = 35,
    AssemblyScript = 38,
    AsyncAPI = 39,
    ["AsyncAPI Tool File"] = 40,
    ["Atmos Manifests"] = 41,
    ["Aurora Agile Meta-Framework"] = 42,
    AutoAPICase = 930,
    ["Avro Avsc"] = 43,
    ["Azure Container App template for defining an immutable revision"] = 45,
    ["Azure DevOps extension manifest"] = 48,
    ["Azure Device Update for IoT Hub import manifest"] = 46,
    ["Azure Device Update for IoT Hub update manifest"] = 47,
    ["Azure IoT Edge deployment"] = 51,
    ["Azure IoT Edge deployment template"] = 52,
    ["Azure IoT EdgeAgent deployment"] = 49,
    ["Azure IoT EdgeHub deployment"] = 50,
    ["Azure Landing Zones Library archetype definition"] = 56,
    ["Azure Landing Zones Library archetype override"] = 57,
    ["Azure Landing Zones Library architecture definition"] = 55,
    ["Azure Landing Zones Library metadata"] = 53,
    ["Azure Landing Zones Library policy default values"] = 54,
    ["Azure Pipelines"] = 71,
    ["Azure Static Web Apps CLI configuration file"] = 685,
    ["Azure Static Web Apps configuration file"] = 684,
    ["BOSH Deploy Config"] = 95,
    ["BX CI"] = 113,
    ["Bashly (bashly.yml)"] = 924,
    ["Bashly Settings (bashly-settings.yml)"] = 925,
    ["Better Code Hub"] = 837,
    ["Better Scripts"] = 114,
    Bigconfig = 88,
    ["Biome Formatter Config"] = 58,
    ["Bitmovin Encoding Template"] = 1009,
    BizTalkServerApplicationSchema = 805,
    Bleep = 115,
    ["Block Protocol Metadata"] = 112,
    ["Boyka Framework"] = 96,
    Briefcase = 811,
    ["Build Info"] = 103,
    Buildkite = 105,
    ["Bukkit plugin.yml"] = 104,
    ["BungeeCord plugin.yml"] = 110,
    ["Butane Config"] = 880,
    C4InterFlow = 1024,
    ["CGS Card Game Specification (cgs.json)"] = 960,
    ["CICS TS region tagging"] = 889,
    ["CICS TS resource import"] = 890,
    ["CICS TS resource model"] = 891,
    ["CICS TS resource overrides"] = 892,
    ["CMake Presets"] = 116,
    ["CNC Codes"] = 133,
    ["CRS WAF test file"] = 988,
    ["CRS WAF test platform overrides file"] = 989,
    ["CSS Comb (.csscomb.json)"] = 232,
    ["CSS Lint (.csslintrc)"] = 233,
    ["CSpell (cspell.json)"] = 231,
    ["CVE Record Format"] = 140,
    CWL = 966,
    ["Cache Warmup config"] = 117,
    ["Calqulus pipeline"] = 118,
    ["Camel YAML DSL"] = 119,
    ["Cannon TOML"] = 120,
    Carafe = 121,
    ["Cargo Make"] = 123,
    ["Cargo Manifest"] = 122,
    ["Catalog Info Backstage"] = 124,
    ["Chamaleon environment"] = 1013,
    ["Chamaleon properties"] = 1014,
    ["Chamaleon template"] = 1012,
    Changesets = 216,
    Charmcraft = 125,
    Cheatsheets = 877,
    ["Chrome Extension"] = 197,
    ["Chromia Model"] = 126,
    ["CircleCI config.yml"] = 173,
    ["Citation File Format"] = 218,
    CityJSON = 128,
    ["Clawject config"] = 139,
    ["Cloud Foundry Application Manifest"] = 971,
    ["Cloud Run Spec v1"] = 993,
    ["CloudCannon Configuration"] = 67,
    ["CloudEvents specification"] = 129,
    ["Code Climate"] = 174,
    CodeCV = 65,
    CodeRabbit = 64,
    ["CodeShip Pro services configuration files"] = 186,
    ["CodeShip Pro steps configuration files"] = 187,
    ["Codecov configuration files"] = 185,
    CodifyCLI = 66,
    Codux = 183,
    ["Cog config file"] = 134,
    ["Commandbox Box.json"] = 135,
    ["Commandbox Server.json"] = 136,
    ["Common Catalog Data"] = 195,
    ["Common Package Specification"] = 137,
    Concord = 987,
    ["Configu .cfgu files"] = 976,
    ["Configu .configu file"] = 977,
    Conjure = 132,
    ["Container Structure Test"] = 819,
    Containerlab = 846,
    ["Contextive Glossary"] = 1038,
    Convex = 131,
    ["Crowdsec collection config"] = 226,
    ["Crowdsec parser config"] = 227,
    ["Crowdsec scenario config"] = 228,
    ["CumulusCI Config"] = 138,
    ["Custom Machinery Machine"] = 961,
    ["Custom Machinery Recipe"] = 962,
    ["Cycle Stack File"] = 141,
    CycloneDX = 142,
    ["DWP Exchange - catalogue entry"] = 275,
    ["DWP Exchange - gateway"] = 273,
    ["DWP Exchange - meta"] = 274,
    ["Dart Build Config (dart-build.json)"] = 234,
    ["Dart Test Config (dart-test.json)"] = 235,
    ["DashLord Configuration"] = 236,
    ["Data Contract Specification"] = 237,
    ["Data Product Specification"] = 238,
    ["DataYoga Connections"] = 143,
    ["DataYoga Job"] = 144,
    ["Databricks Asset Bundles"] = 941,
    ["Datadog Service Definition"] = 426,
    ["Datadog Software Catalog"] = 427,
    ["Datahub Ingestion Recipe"] = 896,
    ["Dein Config"] = 150,
    ["Deno Config (deno.json)"] = 244,
    ["Dependency cruiser"] = 151,
    ["DeployStack Configuration"] = 152,
    ["Deployer Recipe"] = 247,
    ["Deta Spacefile"] = 153,
    ["Detekt Config (detekt.yml)"] = 248,
    ["Devbox Config"] = 154,
    ["Devbox Plugin"] = 155,
    Devfile = 272,
    DipDup = 990,
    ["Discord Webhook"] = 249,
    ["DocFx Config (docfx.json)"] = 253,
    Dofigen = 254,
    ["Dolittle Artifacts"] = 255,
    ["Dolittle Bounded Context Configuration"] = 256,
    ["Dolittle Event Horizons Configuration"] = 257,
    ["Dolittle Resources Configuration"] = 258,
    ["Dolittle Server Configuration"] = 259,
    ["Dolittle Tenant Map Configuration"] = 261,
    ["Dolittle Tenants Configuration"] = 260,
    ["Dolittle Topology"] = 262,
    ["DonateCaseBetterCasino menu"] = 1017,
    ["Drupal Breakpoints"] = 156,
    ["Drupal Config"] = 168,
    ["Drupal Info"] = 157,
    ["Drupal Layouts"] = 158,
    ["Drupal Libraries"] = 159,
    ["Drupal Links Action"] = 160,
    ["Drupal Links Contextual"] = 161,
    ["Drupal Links Menu"] = 162,
    ["Drupal Links Task"] = 163,
    ["Drupal Migration"] = 164,
    ["Drupal Permissions"] = 165,
    ["Drupal Recipe"] = 166,
    ["Drupal Routing"] = 167,
    ["Drupal Services"] = 169,
    ["Drush site aliases"] = 268,
    ["Dynamic Bash Aliases (.aliases)"] = 932,
    ["EAS config"] = 292,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 921,
    ["EasyVCR .NET"] = 293,
    ["Eidolon Resource"] = 1004,
    ["Elgato Stream Deck"] = 278,
    Elm = 992,
    ["Embrace Config"] = 907,
    Endurica = 945,
    ["Enterprise Contract Policy Spec"] = 279,
    ["Erda Pipeline"] = 968,
    ["Erda Runtime"] = 969,
    Esquio = 281,
    ["Estuary Flow Catalog"] = 886,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 285,
    ["EveryVoice TTS Toolkit Data Configuration"] = 286,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 290,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 289,
    ["EveryVoice TTS Toolkit Text Configuration"] = 287,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 288,
    ["Expo SDK"] = 291,
    ["F-Droid Data metadata"] = 297,
    ["FasterCI Configuration"] = 72,
    FiQuS = 301,
    Firebase = 299,
    ["FlexGet Config"] = 302,
    ["Flow.json Configurations"] = 965,
    ["Fossa configuration file"] = 309,
    ["Fossa's fossa-deps file"] = 310,
    ["Foundry VTT - Base package Manifest"] = 304,
    ["Foundry VTT - Module Manifest"] = 305,
    ["Foundry VTT - System Data Template"] = 308,
    ["Foundry VTT - System Manifest"] = 306,
    ["Foundry VTT - World Manifest"] = 307,
    ["Foxx Manifest"] = 73,
    ["Freifunk.de Community API"] = 76,
    ["Frogbot Config"] = 77,
    ["G2P Mapping Configuration"] = 315,
    ["GCP Blueprint Metadata"] = 318,
    Gaspar = 316,
    ["GatewayCore API Gateway"] = 317,
    ["GeoJSON.json latest"] = 884,
    GherKing = 888,
    ["GitHub Action"] = 323,
    ["GitHub Actions typing"] = 1000,
    ["GitHub Discussion"] = 324,
    ["GitHub Funding"] = 325,
    ["GitHub Issue Template configuration"] = 326,
    ["GitHub Issue Template forms"] = 327,
    ["GitHub Workflow"] = 328,
    ["GitHub Workflow Template Properties"] = 329,
    ["GitHub automatically generated release notes configuration"] = 330,
    ["GitLab Agent for Kubernetes configuration"] = 957,
    GitVersion = 320,
    ["Gitea Issue Template configuration"] = 321,
    ["Gitea Issue Template forms"] = 322,
    ["Gitpod Automations"] = 332,
    ["Gitpod Configuration"] = 333,
    ["GlazeWM settings"] = 959,
    ["Global Privacy Control"] = 319,
    Goblet = 940,
    ["Golangci-lint Configuration"] = 348,
    ["Golangci-lint Custom Plugins Configuration"] = 349,
    ["Google Chrome Related Website Sets"] = 300,
    ["Google Cloud Workflows"] = 203,
    ["Google Digital Assetlinks"] = 1039,
    Goreleaser = 351,
    ["Goreleaser Pro"] = 352,
    Goss = 353,
    ["Gradle Build Cache Node"] = 835,
    ["Gradle Enterprise"] = 834,
    ["Grafana 5.x Dashboard"] = 354,
    ["GraphQL Code Generator"] = 358,
    ["GraphQL Config"] = 357,
    ["GraphQL Mesh"] = 356,
    ["Grunt JSHint task"] = 362,
    ["Grunt Watch task"] = 363,
    ["Grunt base task"] = 364,
    ["Grunt clean task"] = 360,
    ["Grunt copy task"] = 359,
    ["Grunt cssmin task"] = 361,
    HEMTT = 801,
    Hadolint = 815,
    Hammerkit = 845,
    ["Hardware Sentry Configuration"] = 900,
    Hatch = 816,
    Hayson = 366,
    ["Haystack Pipeline"] = 367,
    ["Hazelcast 5 Configuration"] = 368,
    ["Helm Chart.lock"] = 171,
    ["Helm Chart.yaml"] = 170,
    ["Helm Unittest Test Suite"] = 172,
    ["Homer dashboard configuration"] = 369,
    Hugo = 876,
    ["Hugo Theme"] = 875,
    ["Hyperfoil benchmark configuration"] = 375,
    ["IBM Zapp document"] = 376,
    ["IBM zCodeFormatSettings"] = 377,
    ["IMG Catapult PSP"] = 382,
    ["IVMS101 by CODE Protocol"] = 958,
    Infrahub = 384,
    Istanbul = 903,
    ["JDownloader2 crawler multi-rules"] = 394,
    ["JDownloader2 crawler single-rules"] = 393,
    ["JFrog Applications Config"] = 395,
    ["JFrog File Spec"] = 396,
    ["JFrog Pipelines YML DSL"] = 909,
    ["JMeter DSL cli config"] = 397,
    JReleaser = 399,
    ["JSON Document Transform"] = 407,
    ["JSON Feed"] = 408,
    ["JSON Resume"] = 619,
    ["JSON Schema Draft 2020-12"] = 784,
    ["JSON Schema Draft 4"] = 781,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 942,
    ["JSON Schema Draft 7"] = 782,
    ["JSON Schema Draft 7 (unofficial strict)"] = 943,
    ["JSON Schema Draft 8 (2019-09)"] = 783,
    ["JSON-API"] = 406,
    ["JSON-e templates"] = 842,
    ["JSON-stat 2.0"] = 777,
    JSONPatch = 410,
    ["JSR Package Config (jsr.json)"] = 400,
    Jasmine = 388,
    Jekyll = 389,
    ["Jenkins X Pipelines"] = 390,
    ["Jenkins X Requirements"] = 391,
    Jest = 392,
    ["Jovo Language Models"] = 398,
    ["KIMMDY config file"] = 421,
    ["KODE/CI build.yaml"] = 905,
    ["KSP-AVC"] = 778,
    ["KSP-CKAN"] = 779,
    ["KSP-NetKAN"] = 780,
    KSY = 970,
    KSail = 313,
    ["Karakum configuration file"] = 311,
    Kas = 413,
    ["Kestra flow file"] = 422,
    ["Keycloak REST API"] = 912,
    ["Knative Functions - func.yaml"] = 312,
    ["Kometa (nightly) config file"] = 424,
    ["Kometa config file"] = 423,
    ["Kong DBLess config"] = 906,
    KrakenD = 425,
    ["Kubri Configuration"] = 431,
    LOOBin = 446,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 208,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 209,
    ["Landing Zone Accelerator on AWS - Global Config"] = 210,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 211,
    ["Landing Zone Accelerator on AWS - Network Config"] = 212,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 213,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 214,
    ["Landing Zone Accelerator on AWS - Security Config"] = 215,
    ["Language configuration"] = 980,
    Lefthook = 435,
    ["Liferay client-extension.yaml"] = 442,
    ["LinkML Metamodel"] = 444,
    Liquibase = 851,
    ["Liquibase Flow File"] = 852,
    ["Lively Properties"] = 445,
    ["Lobe AI Agent"] = 69,
    Loki = 70,
    ["MLOS Configs"] = 484,
    ["MS2Rescore Configuration"] = 487,
    ["Madness (madness.yml)"] = 923,
    ["MapEHR Mapping"] = 452,
    Markdownlint = 855,
    ["Mason Registry"] = 858,
    ["MegaLinter configuration"] = 454,
    ["MegaLinter descriptor"] = 455,
    Melange = 949,
    ["Meltano project definition"] = 456,
    ["Mergify Configuration"] = 488,
    ["Metadata for a Bazel module"] = 457,
    ["Metadata for a Cinnamon spice"] = 996,
    ["Metatype Configuration"] = 458,
    ["MetricsHub Configuration"] = 459,
    ["MetricsHub Connector Configuration"] = 460,
    ["Micro Editor Syntax"] = 933,
    ["Microsoft Band Web Tile"] = 461,
    ["Microsoft RulesEngine workflow rules"] = 984,
    ["Microsoft RulesEngine workflow rules list"] = 985,
    ["Minecraft Custom Main Menu Mod"] = 950,
    ["Minecraft Data Pack Advancement"] = 463,
    ["Minecraft Data Pack Biome"] = 464,
    ["Minecraft Data Pack Configured Carver"] = 465,
    ["Minecraft Data Pack Damage Type"] = 466,
    ["Minecraft Data Pack Dimension"] = 468,
    ["Minecraft Data Pack Dimension Type"] = 467,
    ["Minecraft Data Pack Item Modifier"] = 469,
    ["Minecraft Data Pack Loot Table"] = 470,
    ["Minecraft Data Pack Metadata"] = 471,
    ["Minecraft Data Pack Predicate"] = 472,
    ["Minecraft Data Pack Recipe"] = 473,
    ["Minecraft Data Pack Tag"] = 474,
    ["Minecraft Data Pack Template Pool"] = 475,
    ["Minecraft Data Pack Trim Material"] = 480,
    ["Minecraft Data Pack Trim Pattern"] = 481,
    ["Minecraft Resource Pack Lang"] = 476,
    ["Minecraft Resource Pack Particle"] = 477,
    ["Minecraft Resource Pack Texture Mcmeta"] = 479,
    ["Minecraft Resourcepack Sounds"] = 478,
    ["Monade CLI Stack Configuration"] = 491,
    ["MongoDB Atlas Search Index Definition"] = 904,
    ["Monika Configuration"] = 902,
    ["Monoweave Configuration"] = 486,
    ["Motif config"] = 797,
    MultiQC = 1032,
    ["NOX Framework (Service)"] = 503,
    ["Netin Diagnostic System Template"] = 862,
    ["Netlify config"] = 494,
    ["Network-as-Code Data Model"] = 495,
    ["Nightwatch.js"] = 496,
    ["Node.js configuration"] = 802,
    ["NueJS configuration file"] = 508,
    ["Nuitka.yaml"] = 963,
    ["Nullstone config"] = 510,
    ["ONe's changelog entry"] = 524,
    ["ONe's service descriptor"] = 523,
    ["OSCAL Assessment Plan (AP)"] = 532,
    ["OSCAL Assessment Results (AR)"] = 533,
    ["OSCAL Catalog"] = 534,
    ["OSCAL Component Definition (CDef)"] = 535,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 536,
    ["OSCAL Profile"] = 537,
    ["OSCAL System Security Plan (SSP)"] = 538,
    ["OSS Review Toolkit configuration"] = 539,
    ["OSS Review Toolkit curation"] = 540,
    ["OSS Review Toolkit package configuration"] = 541,
    ["OSS Review Toolkit repository configuration"] = 542,
    ["OSS Review Toolkit resolutions"] = 543,
    ["October CMS columns"] = 514,
    ["October CMS fields"] = 515,
    Okteto = 516,
    Opctl = 800,
    ["Open Data Contract Standard (ODCS)"] = 527,
    ["Open Know-How"] = 1037,
    ["OpenRewrite Resource"] = 526,
    ["OpenUtau character yaml"] = 520,
    ["OpenUtau ustx"] = 521,
    ["OpenWeather Current Weather API"] = 841,
    ["OpenWeather Road Risk API"] = 840,
    ["Ory Hydra configuration"] = 374,
    ["Ory Keto configuration"] = 428,
    ["Ory Kratos configuration"] = 531,
    ["Ory Oathkeeper configuration"] = 512,
    ["Outblocks App configuration"] = 529,
    ["Outblocks database table"] = 530,
    ["Outblocks project configuration"] = 528,
    PDM = 549,
    Packer = 546,
    Pantsbuild = 919,
    ["Paper paper-plugin.yml"] = 547,
    ["Pipeline component"] = 853,
    ["Plex Prerolls"] = 557,
    ["PocketMine plugin.yml"] = 554,
    ["Postman collection"] = 561,
    ["Preset list for a WinUtil"] = 999,
    ["Problem object RFC9457"] = 947,
    ["Problem package generators"] = 570,
    Pterodactyl = 899,
    ["Pull Request Labeler"] = 586,
    Pulumi = 594,
    ["PyGTA Config"] = 590,
    PyProject = 595,
    Pyright = 596,
    ["Python script metadata"] = 1034,
    Qgoda = 598,
    Qodana = 872,
    ["Qt Creator workspace file"] = 978,
    ["Quali Torque Blueprint Spec 2"] = 897,
    ["QueryFirst config file"] = 915,
    ["RKE Cluster Configuration JSON"] = 850,
    ["RKE Cluster Configuration YAML"] = 849,
    RadioHound = 589,
    Railway = 599,
    ["Rancher Fleet"] = 591,
    ["Rattler-build"] = 600,
    Ray = 814,
    ["Read the Docs"] = 593,
    ["Red-DiscordBot Cog"] = 607,
    ["Red-DiscordBot Cog Repo"] = 608,
    ["Red-DiscordBot Trivia"] = 609,
    ["Render Blueprints"] = 848,
    RenderCV = 621,
    Renovate = 620,
    ["Replit config"] = 615,
    Restate = 1027,
    RoadRunner = 623,
    ["Rudder techniques"] = 953,
    Ruff = 617,
    ["Rust Project"] = 618,
    ["Rust toolchain"] = 627,
    ["SDMX data message"] = 653,
    ["SDMX metadata message"] = 652,
    ["SDMX structure message"] = 651,
    ["SIL Kit Participant Configuration"] = 663,
    ["SIL Kit Registry Configuration"] = 664,
    ["SPDX 2.3"] = 682,
    SWADL = 696,
    ["Safebox Config"] = 910,
    ["Sapphire CLI Config"] = 630,
    ["SauceCTL Configuration"] = 859,
    ["Schema Catalog"] = 645,
    ["Scoop manifest"] = 650,
    ["Semantic Data Fabric (SDF) file"] = 654,
    ["Semgrep Rule"] = 656,
    ["Serenity Code Generator (Sergen)"] = 657,
    ["Serverless Framework Configuration"] = 866,
    ["Serverless Workflow"] = 868,
    ["Settings for a Cinnamon spice"] = 995,
    ["Settings.paf"] = 659,
    ["Shopware 6 Configuration"] = 869,
    ["Shopware CLI Extension Store Configuration"] = 870,
    ["Shopware CLI Project Store Configuration"] = 871,
    ["Sigma Detection Rule"] = 661,
    ["Sigrid scope configuration file"] = 662,
    ["SkyPilot Task JSON"] = 954,
    ["Slack app manifest"] = 666,
    Solidarity = 671,
    ["Solution filters"] = 672,
    ["Source Maps v3"] = 673,
    Sourcery = 674,
    ["Speakeasy Generation Config File"] = 678,
    ["Speakeasy Lint Configuration File"] = 675,
    ["Speakeasy Test Generation Configuration File"] = 676,
    ["Speakeasy Workflow File"] = 677,
    SpecIF = 679,
    ["Sponge Mixin configuration"] = 680,
    StackBlitz = 686,
    ["StackHawk Scanner Configuration"] = 865,
    Stale = 687,
    ["Starlake Data Pipeline"] = 838,
    Starship = 688,
    ["Statamic Blueprint"] = 689,
    ["Stella configuration file"] = 690,
    ["Stryker Mutator"] = 693,
    ["StyleCop Analyzers Configuration"] = 694,
    ["Stylelint (.stylelintrc)"] = 695,
    ["Sublime Syntax"] = 911,
    ["Subsquid squid manifest"] = 956,
    ["Swagger API 2.0"] = 697,
    ["Synadia Connect Component"] = 698,
    TSON = 732,
    TSTyche = 733,
    ["Tab data for a LinUtil"] = 1002,
    ["Tab list for a LinUtil"] = 1001,
    Tach = 699,
    ["Tach Domain"] = 700,
    Talhelper = 702,
    ["Talisman configuration"] = 703,
    ["Taskfile config"] = 843,
    Taurus = 704,
    Tauticord = 705,
    Telefonistka = 1028,
    ["TestEnvironment.json"] = 715,
    ["TextMate Grammar"] = 714,
    ["Tier.run pricing.json"] = 708,
    Tikibase = 709,
    Tombi = 713,
    ["Traefik v2"] = 718,
    ["Traefik v2 File Provider"] = 719,
    ["Traefik v3"] = 720,
    ["Traefik v3 File Provider"] = 721,
    ["Travis CI (.travis.yml)"] = 717,
    Trident = 1026,
    ["TrueScript for *.tscript files"] = 724,
    ["Tugboat QA config.yml"] = 1023,
    TunnelHub = 946,
    Turborepo = 716,
    Tycho = 991,
    Tye = 873,
    ["Tyk Gateway - Open Source v5.7+"] = 1033,
    ["UET BuildConfig.json"] = 916,
    ["UI5 Manifest"] = 743,
    ["UNCORS configuration"] = 747,
    ["UTAM Page Object"] = 746,
    ["Ubuntu Server Autoinstall"] = 741,
    ["Uniswap Token List"] = 826,
    ["Universal Schedule Format"] = 748,
    ["Unreal Engine Uplugin"] = 917,
    ["Unreal Engine Uproject"] = 918,
    ["Updatecli Compose"] = 881,
    ["Updatecli Policy Manifest"] = 882,
    ["Updatecli Policy Metadata"] = 883,
    Uplift = 914,
    ["User Journey Map"] = 847,
    V2Ray = 887,
    ["VSCode Code Snippets"] = 191,
    ["VSIX CLI publishing"] = 766,
    Vector = 750,
    ["Vela Pipeline Configuration"] = 753,
    Vercel = 190,
    ["Version Bumper config"] = 756,
    ["Viash Component Config"] = 1030,
    ["Viash Package Config"] = 1031,
    Visivo = 944,
    Wake = 1025,
    ["Waku Config"] = 1005,
    ["Web App Manifest"] = 772,
    ["Web types"] = 775,
    WebExtensions = 771,
    ["Webman package recipe"] = 893,
    ["Windows Package Manager Installer Manifest"] = 822,
    ["Windows Package Manager Locale Manifest"] = 823,
    ["Windows Package Manager Singleton Manifest"] = 821,
    Winutil = 824,
    ["WireMock stub mapping"] = 1008,
    ["Woodpecker pipeline config"] = 861,
    ["Wrangler CLI"] = 776,
    ["Xstate Machine"] = 879,
    ["Yandex Workflow Language"] = 997,
    ["Yarn Config (.yarnrc.yml)"] = 836,
    ["Yippee-Ki-JSON configuration YML"] = 828,
    ["YouTrack App"] = 994,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 18,
    apko = 948,
    ...
    ["appsscript.json"] = 24,
    ["appveyor.yml"] = 26,
    ["aqua-generate-registry.yaml"] = 29,
    ["aqua-policy.yaml"] = 30,
    ["aqua.yaml"] = 28,
    ["arb.json"] = 31,
    ["arc.json"] = 33,
    ["architect.yml"] = 32,
    ["artifacthub-repo.yml"] = 36,
    ["asm-lsp"] = 37,
    ["babelrc.json"] = 79,
    ["bamboo-spec"] = 82,
    ["bashly-strings.yml"] = 926,
    ["batect.yml"] = 81,
    ["beef-database-codegen"] = 83,
    ["beef-database-v5-codegen"] = 85,
    ["beef-entity-codegen"] = 84,
    ["beef-entity-v5-codegen"] = 86,
    ["behat.yml"] = 97,
    ["bigquery-table"] = 87,
    ["bioimageio resource description"] = 964,
    ["bitbucket-pipelines"] = 89,
    bitrise = 90,
    ["bitrise-step"] = 91,
    ["block.json"] = 111,
    ["bottom configuration"] = 59,
    ["bower.json"] = 93,
    ["bozr.suite.json"] = 99,
    bpkg = 927,
    ["browser.i18n.json"] = 100,
    ["browsh configuration"] = 101,
    bucklescript = 102,
    ["buf.gen.yaml"] = 61,
    ["buf.plugin.yaml"] = 62,
    ["buf.work.yaml"] = 63,
    ["buf.yaml"] = 60,
    ["bun.lock"] = 107,
    ["bundleconfig.json"] = 108,
    ["bunfig.toml"] = 109,
    ["ccmod.json"] = 1006,
    changelogging = 975,
    ["chisel-slices.json"] = 217,
    ["chrome-extension-locales-messages.json"] = 198,
    ["chutzpah.json"] = 199,
    cibuildwheel = 127,
    ["clang-format (.clang-format)"] = 885,
    ["clang-tidy"] = 178,
    clangd = 177,
    clib = 179,
    ["cloud-init: cloud-config userdata"] = 181,
    ["cloud-sdk-pipeline-configuration"] = 201,
    ["cloudbuild.json"] = 202,
    cloudify = 180,
    codemagic = 182,
    ["coffeelint.json"] = 219,
    ["commands.json"] = 194,
    ["commitlint (.commitlintrc)"] = 825,
    ["committed.toml"] = 220,
    ["compile_commands.json"] = 193,
    ["compilerconfig.json"] = 192,
    ["completely.yml"] = 922,
    ["component-detection-manifest.json"] = 223,
    ["component.json"] = 222,
    ["composer.json"] = 221,
    ["conda-forge"] = 130,
    ["config.yaml"] = 592,
    ["contentmanifest.json"] = 200,
    ["contribute.json"] = 224,
    ["cosmos.config.json"] = 196,
    ["crowdin.yml"] = 225,
    ["ctfd-setup configuration file"] = 1015,
    ["custom-elements.json"] = 936,
    ["cypress.json"] = 229,
    ["datalogic-scan2deploy-android"] = 239,
    ["datalogic-scan2deploy-ce"] = 240,
    ["dbt Dependencies"] = 145,
    ["dbt Packages"] = 147,
    ["dbt Project"] = 146,
    ["dbt Selectors"] = 148,
    ["dbt YAML files"] = 149,
    ["ddev-global"] = 241,
    ["ddev-project"] = 242,
    ["debugsettings.json"] = 243,
    ["dependabot-v2.json"] = 246,
    ["dependabot.json"] = 245,
    ["deployed-cli"] = 878,
    ["devcontainer.json"] = 184,
    devinit = 830,
    ["devspace.yaml"] = 901,
    djlint = 831,
    ["docker bake"] = 251,
    ["docker sequencer"] = 252,
    ["docker-compose.yml"] = 829,
    ["dockerd.json"] = 250,
    ["dotnet Release Index manifest"] = 263,
    ["dotnet-tools.json"] = 264,
    ["dotnetcli.host.json"] = 265,
    ["dprint.json"] = 266,
    ["drone.json"] = 267,
    ["dss-2.0.0.json"] = 269,
    ["dstack configuration"] = 270,
    ["dtool dataset metadata"] = 1010,
    ["dvc.yaml"] = 271,
    ["ecosystem.json"] = 276,
    eksctl = 277,
    ["electron-builder configuration file"] = 283,
    ["epr-manifest.json"] = 282,
    ["evcc.yaml"] = 284,
    ["ezd task runner"] = 294,
    ["fabric.mod.json"] = 296,
    ["first-timers-bot"] = 303,
    ["flagd flag configuration"] = 74,
    ["fly.io Configuration"] = 75,
    fulibWorkflows = 860,
    ["function.json"] = 314,
    ["gRPC API Gateway & OpenAPI Config"] = 3,
    ["gematik health care insurance list"] = 1021,
    ["gematik health care patient list"] = 1018,
    ["gematik health care provider institution list"] = 1020,
    ["gematik health care provider list"] = 1019,
    ["gematik tiger test environment configuration"] = 1022,
    ["gitlab-ci"] = 331,
    ["global.json"] = 347,
    ["go-feature-flag Flag Configuration"] = 350,
    ["haxelib.json"] = 365,
    helmfile = 817,
    helmwave = 818,
    ["host-meta.json"] = 371,
    ...
    ["ide.host.json"] = 378,
    ["ifstate.conf"] = 379,
    ["imageoptimizer.json"] = 380,
    ["importmap.json"] = 383,
    ["ioBroker Configuration"] = 385,
    ["ioBroker JSON UI"] = 386,
    ["ioBroker Package manifest"] = 387,
    ["ize.toml"] = 913,
    ["jsconfig.json"] = 411,
    ["jscpd Configuration"] = 898,
    jsdoc = 813,
    ["k3d.yaml"] = 412,
    ["k9s aliases.yaml"] = 414,
    ["k9s cluster-config.yaml"] = 416,
    ["k9s config.yaml"] = 415,
    ["k9s hotkeys.yaml"] = 417,
    ["k9s plugins.yaml"] = 418,
    ["k9s skin.yaml"] = 419,
    ["k9s views.yaml"] = 420,
    ["kontinuous-config.yaml"] = 430,
    ["kontinuous-values.yaml"] = 429,
    ["kustomization.yaml"] = 432,
    ["label-commenter-config.yml"] = 433,
    ["latexindent configuration"] = 68,
    ["launchsettings.json"] = 434,
    lazydocker = 935,
    lazygit = 934,
    ["lego.json"] = 436,
    ["lerna.json"] = 437,
    ["lgtm.yml"] = 438,
    ["liblab.config.json"] = 439,
    ["libman.json"] = 440,
    ["license-report-config.json"] = 441,
    ["linkinator.config.json"] = 443,
    ["lint-staged (.lintstagedrc)"] = 792,
    ["local.settings.json"] = 448,
    ["localazy.json"] = 449,
    ["lotus.yaml"] = 447,
    ["lsdlschema.json"] = 450,
    ["markdown-link-check"] = 856,
    maturin = 857,
    mboats = 864,
    ["micro-settings.json"] = 928,
    ["mimetypes.json"] = 462,
    ["mirrord config"] = 793,
    mise = 794,
    ["mkdocs.yml"] = 482,
    ["monospace.yml"] = 485,
    ["moon.yml"] = 1007,
    ["mprocs Configuration file"] = 979,
    ["mrdocs.yml"] = 483,
    ["mta.yaml"] = 795,
    ["mtad.yaml"] = 796,
    ["mycode.json"] = 492,
    ["napari plugin manifest"] = 493,
    neoload = 808,
    ["nest-cli"] = 498,
    ["ninjs (News in JSON)"] = 497,
    ["nitro.json"] = 807,
    ["nixd configuration"] = 952,
    ["nlu.json"] = 499,
    ["nodemon.json"] = 501,
    ["noodl config"] = 863,
    ["notebook.mod.json"] = 502,
    now = 803,
    ["npm-badges"] = 505,
    ["nswag.json"] = 509,
    ntangle = 511,
    ["nuclei-template.yaml"] = 506,
    ["nuget-project.json"] = 507,
    ["ocelot.json"] = 513,
    ["omnisharp.json"] = 517,
    ["openapi.json"] = 518,
    ["openfin.json"] = 525,
    ...
    ["ops.yaml"] = 522,
    ["package.json"] = 544,
    ["package.manifest"] = 545,
    ["partial-black.json"] = 98,
    ["pathfinder.yml"] = 548,
    ["pattern.json"] = 551,
    ["petstore-v1.0"] = 908,
    pgap_yaml_input_reader = 550,
    ["pixi.toml"] = 552,
    ["plagiarize-me.yaml"] = 556,
    ["plagiarize.yaml"] = 555,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1011,
    ["podbard.yaml"] = 558,
    ["portman.json"] = 559,
    ["prefect.toml"] = 567,
    ["prettierrc.json"] = 568,
    ["prisma.yml"] = 569,
    ["project-1.0.0-beta3.json"] = 572,
    ["project-1.0.0-beta4.json"] = 573,
    ["project-1.0.0-beta5.json"] = 574,
    ["project-1.0.0-beta6.json"] = 575,
    ["project-1.0.0-beta8.json"] = 576,
    ["project-1.0.0-rc1.json"] = 577,
    ["project-1.0.0-rc2.json"] = 578,
    ["project.json"] = 571,
    ["project.owasp.yaml"] = 579,
    ["prometheus.json"] = 580,
    ["prometheus.rules.json"] = 581,
    ["prometheus.rules.test.json"] = 582,
    ["proxies.json"] = 583,
    ["publiccode.yml"] = 584,
    ["pubspec.yaml"] = 585,
    ["pyrseas-0.8.json"] = 588,
    pytest = 597,
    ["quilt.mod.json"] = 929,
    ["rc3 auth"] = 601,
    ["rc3 collection"] = 602,
    ...
    ["rc3 settings"] = 606,
    ["release drafter"] = 809,
    ["release-please-config.json"] = 611,
    ["release-please-manifest.json"] = 612,
    ["release-plz.toml"] = 613,
    ["renv.lock"] = 622,
    ["rivet.yaml"] = 951,
    rockcraft = 624,
    runny = 625,
    ...
    samt = 628,
    samtrc = 629,
    ["sarif-1.0.0.json"] = 631,
    ["sarif-2.0.0.json"] = 632,
    ["sarif-2.1.0"] = 642,
    ["sarif-2.1.0-rtm.2"] = 633,
    ["sarif-2.1.0-rtm.3"] = 635,
    ["sarif-2.1.0-rtm.4"] = 637,
    ["sarif-2.1.0-rtm.5"] = 639,
    ["sarif-2.1.0-rtm.6"] = 640,
    ["sarif-external-property-file-2.1.0"] = 643,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 634,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 636,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 638,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 641,
    ["scalingo.json configuration"] = 644,
    ["schema.org - Action"] = 646,
    ["schema.org - ContactPoint"] = 647,
    ["schema.org - Place"] = 648,
    ["schema.org - Thing"] = 649,
    ["secrethub.yml"] = 931,
    ["semantic-release"] = 655,
    ["servicehub.config.json"] = 787,
    ["servicehub.service.json"] = 786,
    ["settings.job"] = 658,
    ["sfdx-hardis configuration"] = 660,
    ["shard.yml"] = 967,
    ["size-limit configuration"] = 665,
    ["skaffold.yaml"] = 854,
    ["skyuxconfig.json"] = 667,
    snapcraft = 668,
    ["snowflake-config"] = 669,
    ["snowflake-connections"] = 670,
    ["spicepod.yaml"] = 986,
    ["sqlc configuration"] = 683,
    ["stripe-app-local.json"] = 692,
    ["stripe-app.json"] = 691,
    swcrc = 839,
    ["task.json"] = 701,
    taskcat = 804,
    ["template.json"] = 706,
    ["templatsources.json"] = 707,
    ["theme.json"] = 710,
    ["tizen_workspace.json"] = 711,
    tldr = 712,
    tmuxinator = 790,
    ["transcend.yml"] = 722,
    ["tree-sitter grammar.json"] = 355,
    ["trime.yaml"] = 723,
    ["trunk.yaml"] = 725,
    ["ts-force-config.json"] = 730,
    ["tsconfig.json"] = 726,
    ["tsd.json"] = 727,
    ["tsdoc.json"] = 728,
    ["tsdrc.json"] = 729,
    ...
    v8r = 770,
    vcluster = 973,
    ["vcpkg configuration file"] = 189,
    ["vcpkg manifest file"] = 188,
    ["vega-lite.json"] = 752,
    ["vega.json"] = 751,
    ["venvironment-basic.yaml"] = 755,
    ["venvironment.yaml"] = 754,
    version = 1029,
    ["version.json"] = 757,
    ["vhwdebugger-binding.yaml"] = 759,
    ["vim-addon-info"] = 760,
    ["vs-2017.3.host.json"] = 762,
    ["vs-nesting.json"] = 763,
    ["vsls.json"] = 761,
    ["vss-extension.json"] = 767,
    vtcfg = 1035,
    ["vtesttree.yaml"] = 768,
    ["vtestunit.yaml"] = 769,
    ["warp-keysets.json"] = 937,
    ["warp-themes.json"] = 938,
    ["warp-workflows.json"] = 939,
    ["webhint.io"] = 894,
    ["webjobpublishsettings.json"] = 774,
    ["webjobs-list.json"] = 773,
    ["well-known-fursona"] = 974,
    ["xs-app.json"] = 799,
    ["xunit.runner.json"] = 785,
    yamllint = 827,
    ["zerops.io import file"] = 983,
    ["zerops.yml"] = 982,
    zuul = 810,
    ["Žinoma"] = 820
  },
