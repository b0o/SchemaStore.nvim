...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1092,
    ["API Builder"] = 906,
    ["AVA Configuration"] = 968,
    ...
    ["AWS Copilot Manifest"] = 1131,
    ["AWS SAM CLI Samconfig"] = 226,
    ["Adobe UXP Manifest"] = 1030,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1121,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 940,
    ["All Contributors configuration file"] = 993,
    ...
    ["Application list for a WinUtil"] = 1074,
    ArchitectFX = 1079,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1140,
    ["Azure IoT Operations connector metadata"] = 1137,
    ...
    ["Azure Pipelines"] = 81,
    ["Azure Static Web Apps CLI configuration file"] = 749,
    ["Azure Static Web Apps configuration file"] = 748,
    ["BOSH CPI Config"] = 105,
    ["BOSH Deploy Config"] = 106,
    ["BX CI"] = 125,
    ["Bashly (bashly.yml)"] = 997,
    ["Bashly Settings (bashly-settings.yml)"] = 998,
    ["Better Code Hub"] = 910,
    ["Better Scripts"] = 126,
    Bigconfig = 98,
    ["Biome Formatter Config"] = 65,
    ["Bitmovin Encoding Template"] = 1085,
    BizTalkServerApplicationSchema = 878,
    Bleep = 127,
    ...
    ["Butane Config"] = 953,
    C4InterFlow = 1100,
    ["CDK Environment Manager, concrete environment configuration"] = 1124,
    ["CDK Environment Manager, concrete environments definition"] = 1123,
    ["CDK Environment Manager, environment definition"] = 1122,
    ["CGS Card Game Specification (cgs.json)"] = 1035,
    ["CICS TS region tagging"] = 962,
    ["CICS TS resource import"] = 963,
    ["CICS TS resource model"] = 964,
    ["CICS TS resource overrides"] = 965,
    ["CMake Presets"] = 128,
    ["CNC Codes"] = 149,
    ["CRS WAF test file"] = 1064,
    ["CRS WAF test platform overrides file"] = 1065,
    ...
    ["Chamaleon environment"] = 1089,
    ["Chamaleon properties"] = 1090,
    ["Chamaleon template"] = 1088,
    Changesets = 235,
    Changie = 137,
    Charmcraft = 138,
    Cheatsheets = 950,
    ...
    ["Clawject config"] = 155,
    ["Cloud Foundry Application Manifest"] = 1046,
    ["Cloud Run Spec v1"] = 1069,
    ...
    Concord = 1063,
    ["Configu .cfgu files"] = 1051,
    ["Configu .configu file"] = 1052,
    Conjure = 148,
    ["Container Structure Test"] = 892,
    Containerlab = 919,
    ["Contextive Glossary"] = 1116,
    Convex = 147,
    ["Crowdsec collection config"] = 245,
    ["Crowdsec parser config"] = 246,
    ["Crowdsec scenario config"] = 247,
    ["CumulusCI Config"] = 154,
    ["Custom Machinery Machine"] = 1036,
    ["Custom Machinery Recipe"] = 1037,
    ...
    ["DonateCaseBetterCasino menu"] = 1093,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1005,
    ["EAS config"] = 311,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 994,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1136,
    ["EasyVCR .NET"] = 312,
    ["Eidolon Resource"] = 1080,
    ...
    ["Evolving Resolutive Process notation"] = 1138,
    ["Expo SDK"] = 310,
    ...
    ["GeoJSON.json latest"] = 957,
    GherKing = 961,
    ["GitHub Action"] = 342,
    ["GitHub Actions typing"] = 1076,
    ...
    ["Google Digital Assetlinks"] = 1117,
    Goreleaser = 370,
    ["Goreleaser Pro"] = 371,
    Goss = 372,
    ["Gradle Build Cache Node"] = 908,
    ["Gradle Enterprise"] = 907,
    ...
    Hadolint = 888,
    Hammerkit = 918,
    ["Hardware Sentry Configuration"] = 973,
    ["HashiCorp Vault"] = 385,
    Hatch = 889,
    Hayagriva = 387,
    Hayson = 388,
    ...
    ["JFrog File Spec"] = 421,
    ["JFrog Pipelines YML DSL"] = 982,
    ["JMeter DSL cli config"] = 422,
    JReleaser = 425,
    ["JSON Document Transform"] = 433,
    ["JSON Feed"] = 434,
    ["JSON Resume"] = 662,
    ["JSON Schema Draft 2020-12"] = 856,
    ["JSON Schema Draft 4"] = 853,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1015,
    ["JSON Schema Draft 7"] = 854,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1016,
    ["JSON Schema Draft 8 (2019-09)"] = 855,
    ["JSON-API"] = 432,
    ["JSON-e templates"] = 915,
    ["JSON-stat 2.0"] = 849,
    JSONPatch = 436,
    ...
    ["Jujutsu (jj) VCS config"] = 1130,
    ["KIMMDY config file"] = 447,
    ["KODE/CI build.yaml"] = 978,
    ["KSP-AVC"] = 850,
    ["KSP-CKAN"] = 851,
    ["KSP-NetKAN"] = 852,
    KSY = 1045,
    ...
    ["Metadata for a Cinnamon spice"] = 1072,
    ["Metatype Configuration"] = 487,
    ["MetricsHub Configuration"] = 488,
    ["MetricsHub Connector Configuration"] = 489,
    ["Micro Editor Syntax"] = 1006,
    ["Microsoft Band Web Tile"] = 490,
    ["Microsoft RulesEngine workflow rules"] = 1060,
    ["Microsoft RulesEngine workflow rules list"] = 1061,
    ["Minecraft Custom Main Menu Mod"] = 1024,
    ...
    ["MongoDB Atlas Search Index Definition"] = 977,
    ["Monika Configuration"] = 975,
    ["Monoweave Configuration"] = 515,
    ["Motif config"] = 870,
    MultiQC = 1110,
    ["NOX Framework (Service)"] = 534,
    ["Netin Diagnostic System Template"] = 935,
    ["Netlify config"] = 523,
    ["Network-as-Code Data Model"] = 524,
    ["Next Gen UI Agent Configuration"] = 525,
    ["Nightwatch.js"] = 527,
    ["Node.js configuration"] = 875,
    ...
    ["OpenUtau ustx"] = 553,
    ["OpenWeather Current Weather API"] = 914,
    ["OpenWeather Road Risk API"] = 913,
    ...
    ["Power Pages Configuration"] = 1127,
    ["Preset list for a WinUtil"] = 1075,
    ...
    ["Problem object RFC9457"] = 1021,
    ["Problem package generators"] = 611,
    Pterodactyl = 972,
    ["Pull Request Labeler"] = 627,
    Pulumi = 635,
    ["PyGTA Config"] = 631,
    PyProject = 636,
    Pylock = 1118,
    Pyright = 637,
    ["Python script metadata"] = 1112,
    ["QType AI DSL"] = 640,
    Qgoda = 639,
    Qodana = 945,
    ["Qt Creator workspace file"] = 1053,
    ["Quali Torque Blueprint Spec 2"] = 970,
    ["QueryFirst config file"] = 988,
    ["RKE Cluster Configuration JSON"] = 923,
    ["RKE Cluster Configuration YAML"] = 922,
    RadioHound = 630,
    Railway = 641,
    ["Rancher Fleet"] = 632,
    ["Rattler-build"] = 642,
    Ray = 887,
    ["Read the Docs"] = 634,
    ["Red-DiscordBot Cog"] = 649,
    ["Red-DiscordBot Cog Repo"] = 650,
    ["Red-DiscordBot Trivia"] = 651,
    ["Render Blueprints"] = 921,
    RenderCV = 664,
    Renovate = 663,
    ["Replit config"] = 657,
    Restate = 1105,
    ...
    ["Rust Project"] = 661,
    ["Rust toolchain"] = 672,
    ["SDMX data message"] = 698,
    ["SDMX metadata message"] = 697,
    ["SDMX structure message"] = 696,
    ["SIL Kit Participant Configuration"] = 708,
    ["SIL Kit Registry Configuration"] = 709,
    ["SPDX 2.3"] = 746,
    SWADL = 762,
    ["Safebox Config"] = 983,
    ["Sapphire CLI Config"] = 675,
    ["SauceCTL Configuration"] = 932,
    ["Schema Catalog"] = 690,
    ["Scoop manifest"] = 695,
    ["Semantic Data Fabric (SDF) file"] = 699,
    ["Semgrep Rule"] = 701,
    ["Serenity Code Generator (Sergen)"] = 702,
    ["Serverless Framework Configuration"] = 939,
    ["Serverless Workflow"] = 941,
    ["Settings for a Cinnamon spice"] = 1071,
    ["Settings.paf"] = 704,
    ["Shopware 6 Configuration"] = 942,
    ["Shopware CLI Extension Store Configuration"] = 943,
    ["Shopware CLI Project Store Configuration"] = 944,
    ["Sigma Detection Rule"] = 706,
    ...
    ["Source Maps v3"] = 718,
    Sourcery = 719,
    ["Spack bootstrap.yaml"] = 720,
    ["Spack cdash.yaml"] = 721,
    ["Spack ci.yaml"] = 722,
    ["Spack compilers.yaml"] = 723,
    ["Spack concretizer.yaml"] = 724,
    ["Spack config.yaml"] = 725,
    ["Spack definitions.yaml"] = 726,
    ["Spack develop.yaml"] = 727,
    ["Spack env_vars.yaml"] = 728,
    ["Spack environment"] = 734,
    ["Spack include.yaml"] = 729,
    ["Spack mirrors.yaml"] = 730,
    ["Spack modules.yaml"] = 731,
    ["Spack packages.yaml"] = 732,
    ["Spack repos.yaml"] = 733,
    ["Spack toolchains.yaml"] = 735,
    ["Spack upstreams.yaml"] = 736,
    ["Spack view.yaml"] = 737,
    ["Speakeasy Generation Config File"] = 741,
    ["Speakeasy Lint Configuration File"] = 738,
    ["Speakeasy Test Generation Configuration File"] = 739,
    ["Speakeasy Workflow File"] = 740,
    SpecIF = 742,
    ["Specmatic Configuration"] = 743,
    ["Sponge Mixin configuration"] = 744,
    StackBlitz = 750,
    ["StackHawk Scanner Configuration"] = 938,
    Stale = 751,
    Starfish = 752,
    ["Starlake Data Pipeline"] = 911,
    Starship = 753,
    ["Statamic Blueprint"] = 754,
    ["Stella configuration file"] = 755,
    ["Streamlit configuration file"] = 756,
    ["Stryker Mutator"] = 759,
    ["StyleCop Analyzers Configuration"] = 760,
    ["Stylelint (.stylelintrc)"] = 761,
    ["Stylua Config"] = 1119,
    ["Sublime Syntax"] = 984,
    ["Subsquid squid manifest"] = 1031,
    ["Swagger API 2.0"] = 763,
    ["Synadia Connect Component"] = 764,
    TSON = 799,
    TSTyche = 800,
    ["TYPO3 Vendor Bundler config"] = 805,
    ["Tab data for a LinUtil"] = 1078,
    ["Tab list for a LinUtil"] = 1077,
    Tach = 765,
    ["Tach Domain"] = 766,
    Talhelper = 768,
    ["Talisman configuration"] = 769,
    Taplo = 1120,
    ["Taskfile config"] = 916,
    Taurus = 770,
    Tauticord = 771,
    Telefonistka = 1106,
    ["Terrateam config"] = 1132,
    ["TestEnvironment.json"] = 782,
    ["TextMate Grammar"] = 781,
    Threagile = 777,
    ["Tier.run pricing.json"] = 774,
    Tikibase = 775,
    Tombi = 780,
    ["Traefik v2"] = 785,
    ["Traefik v2 File Provider"] = 786,
    ["Traefik v3"] = 787,
    ["Traefik v3 File Provider"] = 788,
    ["Travis CI (.travis.yml)"] = 784,
    Treefmt = 375,
    Trident = 1102,
    ["TrueScript for *.tscript files"] = 791,
    ["Tugboat QA config.yml"] = 1099,
    TunnelHub = 1019,
    Turborepo = 783,
    Tycho = 1067,
    Tye = 946,
    ["Tyk Gateway - Open Source v5.7+"] = 1111,
    ["Typst Manifest"] = 806,
    ["UET BuildConfig.json"] = 989,
    ["UI5 Manifest"] = 812,
    ["UNCORS configuration"] = 816,
    ["UTAM Page Object"] = 815,
    ["Ubuntu Server Autoinstall"] = 810,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1103,
    ["Uniswap Token List"] = 899,
    ["Universal Schedule Format"] = 817,
    ["Unreal Engine Uplugin"] = 990,
    ["Unreal Engine Uproject"] = 991,
    ["UpCloud CLI (upctl) configuration"] = 1104,
    ["Updatecli Compose"] = 954,
    ["Updatecli Policy Manifest"] = 955,
    ["Updatecli Policy Metadata"] = 956,
    Uplift = 987,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 920,
    V2Ray = 960,
    ["VSCode Code Snippets"] = 210,
    ["VSIX CLI publishing"] = 837,
    Vector = 819,
    ["Vela Pipeline Configuration"] = 822,
    Vercel = 209,
    ["Version Bumper config"] = 827,
    ["Viash Component Config"] = 1108,
    ["Viash Package Config"] = 1109,
    Visivo = 1017,
    ["WP-CLI"] = 847,
    Wake = 1101,
    ["Waku Config"] = 1081,
    ["Web App Manifest"] = 843,
    ["Web types"] = 846,
    WebExtensions = 842,
    ["Webman package recipe"] = 966,
    ["Windows Package Manager Installer Manifest"] = 895,
    ["Windows Package Manager Locale Manifest"] = 896,
    ["Windows Package Manager Singleton Manifest"] = 894,
    Winutil = 897,
    ["WireMock stub mapping"] = 1084,
    ["Woodpecker pipeline config"] = 934,
    ["Wrangler CLI"] = 848,
    ["Xstate Machine"] = 952,
    ["Yandex Workflow Language"] = 1073,
    ["Yarn Config (.yarnrc.yml)"] = 909,
    ["Yippee-Ki-JSON configuration YML"] = 901,
    ["YouTrack App"] = 1070,
    ["Zarf Package Configuration"] = 1134,
    ["Zerops.io config"] = 1058,
    ["Zerops.io import"] = 1059,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 1022,
    ...
    ["behat.yml"] = 108,
    ["bigquery-table"] = 97,
    ["bioimageio resource description"] = 1039,
    ...
    ["crowdin.yml"] = 244,
    ["ctfd-setup configuration file"] = 1091,
    ["custom-elements.json"] = 1009,
    ["cypress.json"] = 248,
    ...
    ["gematik health care insurance list"] = 1097,
    ["gematik health care patient list"] = 1094,
    ["gematik health care provider institution list"] = 1096,
    ["gematik health care provider list"] = 1095,
    ["gematik tiger test environment configuration"] = 1098,
    ["gitlab-ci"] = 350,
    ["global.json"] = 366,
    ...
    ["lint-staged (.lintstagedrc)"] = 864,
    ["local.settings.json"] = 475,
    ["localazy.json"] = 476,
    ["lotus.yaml"] = 474,
    ["lsdlschema.json"] = 477,
    ["markdown-link-check"] = 929,
    maturin = 930,
    mboats = 937,
    ["micro-settings.json"] = 1001,
    ["mimetypes.json"] = 491,
    ["mirrord config"] = 866,
    mise = 867,
    ["mkdocs.yml"] = 511,
    ["monospace.yml"] = 514,
    ["moon.yml"] = 1083,
    ["mprocs Configuration file"] = 1054,
    ["mrdocs.yml"] = 512,
    ["mta.yaml"] = 868,
    ["mtad.yaml"] = 869,
    ["mycode.json"] = 521,
    ...
    ["plagiarize.yaml"] = 590,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1087,
    ["podbard.yaml"] = 593,
    ["portman.json"] = 594,
    ["prefect.toml"] = 602,
    ["prettierrc.json"] = 603,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 882,
    ["release-please-config.json"] = 653,
    ["release-please-manifest.json"] = 654,
    ["release-plz.toml"] = 655,
    ["renv.lock"] = 665,
    ["rivet.json"] = 1026,
    ...
    samt = 673,
    samtrc = 674,
    ["sarif-1.0.0.json"] = 676,
    ["sarif-2.0.0.json"] = 677,
    ["sarif-2.1.0"] = 687,
    ["sarif-2.1.0-rtm.2"] = 678,
    ["sarif-2.1.0-rtm.3"] = 680,
    ["sarif-2.1.0-rtm.4"] = 682,
    ["sarif-2.1.0-rtm.5"] = 684,
    ["sarif-2.1.0-rtm.6"] = 685,
    ["sarif-external-property-file-2.1.0"] = 688,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 679,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 681,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 683,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 686,
    ["scalingo.json configuration"] = 689,
    ["schema.org - Action"] = 691,
    ["schema.org - ContactPoint"] = 692,
    ["schema.org - Place"] = 693,
    ["schema.org - Thing"] = 694,
    ["secrethub.yml"] = 1004,
    ["semantic-release"] = 700,
    ["servicehub.config.json"] = 859,
    ["servicehub.service.json"] = 858,
    ["settings.job"] = 703,
    ["sfdx-hardis configuration"] = 705,
    ["shard.yml"] = 1042,
    ...
    ["spicepod.yaml"] = 1062,
    ["sqlc configuration"] = 747,
    ["stripe-app-local.json"] = 758,
    ["stripe-app.json"] = 757,
    swcrc = 912,
    ["task.json"] = 767,
    taskcat = 877,
    ["template.json"] = 772,
    ["templatsources.json"] = 773,
    ["theme.json"] = 776,
    ["tizen_workspace.json"] = 778,
    tldr = 779,
    ["tm_devices configuration file"] = 1125,
    tmuxinator = 862,
    ["transcend.yml"] = 789,
    ["tree-sitter grammar.json"] = 374,
    ["trime.yaml"] = 790,
    ["trunk.yaml"] = 792,
    ["ts-force-config.json"] = 797,
    ["tsconfig.json"] = 793,
    ["tsd.json"] = 794,
    ["tsdoc.json"] = 795,
    ["tsdrc.json"] = 796,
    ...
    ["vega-lite.json"] = 821,
    ["vega.json"] = 820,
    ["venvironment-basic.yaml"] = 824,
    ["venvironment.yaml"] = 823,
    ["venvplus-basic.yaml"] = 826,
    ["venvplus.yaml"] = 825,
    version = 1107,
    ["version.json"] = 828,
    ["vhwdebugger-binding.yaml"] = 830,
    ["vim-addon-info"] = 831,
    ["vs-2017.3.host.json"] = 833,
    ["vs-nesting.json"] = 834,
    ["vsls.json"] = 832,
    ["vss-extension.json"] = 838,
    vtcfg = 1113,
    ["vtesttree.yaml"] = 839,
    ["vtestunit.yaml"] = 840,
    ["warp-keysets.json"] = 1010,
    ["warp-themes.json"] = 1011,
    ["warp-workflows.json"] = 1012,
    ["webhint.io"] = 967,
    ["webjobpublishsettings.json"] = 845,
    ["webjobs-list.json"] = 844,
    ["well-known-fursona"] = 1049,
    ["xs-app.json"] = 872,
    ["xunit.runner.json"] = 857,
    yamllint = 900,
    zuul = 883,
    ["Žinoma"] = 893
  },
