...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 178,
    [".cryproj (generic)"] = 615,
    [".cryproj engine-5.2"] = 610,
    [".cryproj engine-5.3"] = 611,
    [".cryproj engine-5.4"] = 612,
    [".cryproj engine-5.5"] = 613,
    [".cryproj engine-dev"] = 614,
    [".csscomb.json"] = 180,
    [".csslintrc"] = 181,
    [".es6importsorterrc.json"] = 746,
    [".eslintrc"] = 230,
    [".esmrc.json"] = 222,
    [".ffizer.yaml"] = 234,
    [".htmlhintrc"] = 287,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 688,
    ["All Contributors configuration file"] = 745,
    ...
    ["Better Scripts"] = 96,
    Bigconfig = 76,
    BizTalkServerApplicationSchema = 630,
    Bleep = 97,
    ...
    ["Butane Config"] = 700,
    ["CICS TS region tagging"] = 709,
    ["CICS TS resource import"] = 710,
    ["CICS TS resource model"] = 711,
    ["CICS TS resource overrides"] = 712,
    ["CMake Presets"] = 98,
    ["CNC Codes"] = 108,
    ...
    ["Databricks Asset Bundles"] = 766,
    ["Datadog Service Definition"] = 326,
    ["Datahub Ingestion Recipe"] = 716,
    ["Dein Config"] = 113,
    Deno = 191,
    ["Deployer Recipe"] = 194,
    ["Deta Spacefile"] = 114,
    ...
    ["Goreleaser Pro"] = 269,
    Goss = 270,
    ["Gradle Build Cache Node"] = 658,
    ["Gradle Enterprise"] = 657,
    ...
    Hadolint = 639,
    Hammerkit = 667,
    ["Hardware Sentry Configuration"] = 720,
    Hatch = 640,
    Hayson = 282,
    ...
    ["JFrog File Spec"] = 307,
    ["JFrog Pipelines YML DSL"] = 729,
    ["JMeter DSL cli config"] = 308,
    JReleaser = 310,
    ["JSON Document Transform"] = 317,
    ["JSON Feed"] = 318,
    ["JSON Resume"] = 474,
    ["JSON Schema Draft 2020-12"] = 606,
    ["JSON Schema Draft 4"] = 603,
    ["JSON Schema Draft 7"] = 604,
    ["JSON Schema Draft 7 (unofficial strict)"] = 767,
    ["JSON Schema Draft 8 (2019-09)"] = 605,
    ["JSON-API"] = 316,
    ["JSON-e templates"] = 665,
    ["JSON-stat 2.0"] = 600,
    JSONPatch = 320,
    Jasmine = 300,
    Jekyll = 301,
    ...
    Kas = 323,
    ["Keycloak REST API"] = 737,
    ["Knative Functions - func.yaml"] = 247,
    ["KoDE/CI build.yaml"] = 725,
    ["Kong DBLess config"] = 726,
    KrakenD = 325,
    LOOBin = 343,
    Lefthook = 333,
    ...
    ["MongoDB Atlas Search Index Definition"] = 724,
    ["Monika Configuration"] = 722,
    ["Motif config"] = 623,
    ...
    ["OpenUtau ustx"] = 404,
    ["OpenWeather Current Weather API"] = 664,
    ["OpenWeather Road Risk API"] = 663,
    ...
    ["Pipeline component"] = 674,
    ["PocketMine plugin.yml"] = 426,
    Poetry = 427,
    ["Postman collection"] = 432,
    ["Problem object RFC9457"] = 771,
    ...
    Qgoda = 463,
    Qodana = 693,
    ["Quali Torque Blueprint Spec 2"] = 717,
    ["QueryFirst config file"] = 740,
    ["RKE Cluster Configuration JSON"] = 671,
    ["RKE Cluster Configuration YAML"] = 670,
    ["Rancher Fleet"] = 457,
    Ray = 638,
    ["Read the Docs"] = 459,
    ...
    ["SauceCTL Configuration"] = 679,
    ["Schema Catalog"] = 496,
    ["Scoop manifest"] = 501,
    ["Semantic Data Fabric (SDF) file"] = 502,
    ["Semgrep Rule"] = 504,
    ["Serenity Code Generator (Sergen)"] = 505,
    ["Serverless Framework Configuration"] = 687,
    ["Serverless Workflow"] = 689,
    ["Settings.paf"] = 507,
    Setuptools = 508,
    ["Shopware 6 Configuration"] = 690,
    ["Shopware CLI Extension Store Configuration"] = 691,
    ["Shopware CLI Project Store Configuration"] = 692,
    ...
    StackBlitz = 527,
    ["StackHawk Scanner Configuration"] = 686,
    Stale = 528,
    ["Starlake Data Pipeline"] = 661,
    Starship = 529,
    ["Statamic Blueprint"] = 530,
    ["Stella configuration file"] = 531,
    ["StrmPrivacy Data Connector"] = 734,
    ["StrmPrivacy Data Contract"] = 735,
    ["StrmPrivacy SimpleSchema"] = 732,
    ["StrmPrivacy Stream"] = 733,
    ["StrmPrivacy batch job configuration file"] = 731,
    ["Stryker Mutator"] = 534,
    ...
    Turborepo = 552,
    Tye = 694,
    ["UET BuildConfig.json"] = 741,
    ["UI5 Manifest"] = 572,
    ["UNCORS configuration"] = 576,
    ["UTAM Page Object"] = 575,
    ["Ubuntu Server Autoinstall"] = 570,
    ["Uniswap Token List"] = 649,
    ["Unreal Engine Uplugin"] = 742,
    ["Unreal Engine Uproject"] = 743,
    ["Updatecli Compose"] = 701,
    ["Updatecli Policy Manifest"] = 702,
    ["Updatecli Policy Metadata"] = 703,
    Uplift = 739,
    ["User Journey Map"] = 669,
    V2Ray = 707,
    ["VSCode Code Snippets"] = 149,
    ["VSIX CLI publishing"] = 589,
    ["Vela Pipeline Configuration"] = 579,
    Vercel = 148,
    Visivo = 768,
    ["Web App Manifest"] = 596,
    ["Web types"] = 599,
    WebExtensions = 595,
    ["Webman package recipe"] = 713,
    ["Windows Package Manager Installer Manifest"] = 646,
    ["Windows Package Manager Locale Manifest"] = 647,
    ["Windows Package Manager Singleton Manifest"] = 645,
    ["Woodpecker pipeline config"] = 681,
    ["Xstate Machine"] = 699,
    ["Yippee-Ki-JSON configuration YML"] = 651,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    apko = 772,
    ...
    ["bamboo-spec"] = 70,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 750,
    ["bashly-strings.yml"] = 751,
    ["bashly.yml"] = 749,
    ["batect.yml"] = 69,
    ...
    ["lsdlschema.json"] = 347,
    ["madness.yml"] = 748,
    ["markdown-lint-check"] = 677,
    mboats = 684,
    ["micro-settings.json"] = 753,
    ["mimetypes.json"] = 354,
    ["mirrord config"] = 620,
    ["monospace.yml"] = 376,
    ["mta.yaml"] = 621,
    ...
    ["servicehub.config.json"] = 609,
    ["servicehub.service.json"] = 608,
    ["settings.job"] = 506,
    ...
    ["vega-lite.json"] = 578,
    ["vega.json"] = 577,
    ["venvironment-basic.yaml"] = 581,
    ["venvironment.yaml"] = 580,
    ["version.json"] = 582,
    ["vim-addon-info"] = 583,
    ["vs-2017.3.host.json"] = 585,
    ["vs-nesting.json"] = 586,
    ["vsls.json"] = 584,
    ["vss-extension.json"] = 590,
    ["vtesttree.yaml"] = 591,
    ["vtestunit.yaml"] = 592,
    ["warp-keysets.json"] = 762,
    ["warp-themes.json"] = 763,
    ["warp-workflows.json"] = 764,
    ["webhint.io"] = 714,
    ["webjobpublishsettings.json"] = 598,
    ["webjobs-list.json"] = 597,
    ["xs-app.json"] = 625,
    ["xunit.runner.json"] = 607,
    yamllint = 650,
    zuul = 634,
    ["Žinoma"] = 644
  },
