...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 940,
    [".nodehawkrc"] = 582,
    [".npmpackagejsonlintrc"] = 586,
    [".omletrc"] = 1119,
    [".phrase.yml"] = 660,
    [".phraseapp.yml"] = 661,
    [".pmbot.yml"] = 646,
    [".postcssrc"] = 655,
    [".powerpages-web-template-manifest"] = 657,
    [".pre-commit-config.yml"] = 658,
    [".pre-commit-hooks.yml"] = 659,
    [".putout.json"] = 694,
    [".rehyperc"] = 719,
    [".remarkrc"] = 723,
    [".sprite files"] = 815,
    ...
    AIConfig = 34,
    ["AMX Muse Program Descriptor"] = 1167,
    ["API Builder"] = 975,
    ["AVA Configuration"] = 1038,
    ["AWS AppConfig Feature Flags-v1"] = 68,
    ["AWS CDK cdk.json"] = 261,
    ["AWS CloudFormation"] = 262,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 263,
    ["AWS Copilot Manifest"] = 1206,
    ["AWS SAM CLI Samconfig"] = 264,
    ["Adobe UXP Manifest"] = 1101,
    ["Aerleon Network & Service Definitions"] = 20,
    ["Aerleon Policy"] = 21,
    ["AgentCore CLI"] = 1246,
    Aider = 1196,
    Air = 23,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1217,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1216,
    ["Airlock Microgateway"] = 35,
    ["Alacritty Configuration"] = 1010,
    ["All Contributors configuration file"] = 1064,
    ["Ansible Argument Specs"] = 400,
    ["Ansible Collection Galaxy"] = 407,
    ["Ansible Execution Environment"] = 397,
    ["Ansible Inventory"] = 406,
    ["Ansible Meta"] = 398,
    ["Ansible Meta Runtime"] = 399,
    ["Ansible Navigator Configuration"] = 409,
    ["Ansible Playbook"] = 404,
    ["Ansible Requirements"] = 401,
    ["Ansible Rulebook"] = 405,
    ["Ansible Tasks File"] = 403,
    ["Ansible Vars File"] = 402,
    ["Ansible-lint Configuration"] = 408,
    Any = 1129,
    ...
    ["Application list for a WinUtil"] = 1146,
    ArchitectFX = 1151,
    ["Argo CD"] = 54,
    ["Argo Events"] = 55,
    ["Argo Workflows"] = 56,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1215,
    ["Azure IoT Operations connector metadata"] = 1212,
    ...
    ["Azure Pipelines"] = 112,
    ["Azure Static Web Apps CLI configuration file"] = 819,
    ["Azure Static Web Apps configuration file"] = 818,
    BMML = 1234,
    ["BOSH CPI Config"] = 137,
    ...
    ["Bacon config"] = 5,
    ["Barba-CV"] = 83,
    ["Bashly (bashly.yml)"] = 1068,
    ["Bashly Settings (bashly-settings.yml)"] = 1069,
    Bento = 1233,
    ["Better Code Hub"] = 980,
    ["Better Scripts"] = 158,
    Bigconfig = 130,
    ["Biome Formatter Config"] = 84,
    ["Bitmovin Encoding Template"] = 1160,
    BizTalkServerApplicationSchema = 947,
    Bleep = 159,
    ["Block Protocol Metadata"] = 156,
    ["Bluebricks blueprint config"] = 1239,
    ["Boyka Framework"] = 139,
    Briefcase = 953,
    ["Build Info"] = 147,
    Buildkite = 149,
    ...
    ["Butane Config"] = 1023,
    C4InterFlow = 1175,
    ["CDK Environment Manager, concrete environment configuration"] = 1199,
    ["CDK Environment Manager, concrete environments definition"] = 1198,
    ["CDK Environment Manager, environment definition"] = 1197,
    ["CGS Card Game Specification (cgs.json)"] = 1106,
    ["CICS TS region tagging"] = 1032,
    ["CICS TS resource import"] = 1033,
    ["CICS TS resource model"] = 1034,
    ["CICS TS resource overrides"] = 1035,
    ["CMake Presets"] = 160,
    ["CNC Codes"] = 182,
    ["CRS WAF test file"] = 1136,
    ["CRS WAF test platform overrides file"] = 1137,
    ["CSS Comb (.csscomb.json)"] = 289,
    ["CSS Lint (.csslintrc)"] = 290,
    ["CSpell (cspell.json)"] = 288,
    ["CVE Record Format"] = 192,
    CWL = 1112,
    ...
    ["Chamaleon environment"] = 1164,
    ["Chamaleon properties"] = 1165,
    ["Chamaleon template"] = 1163,
    Changepacks = 1226,
    Changesets = 273,
    Changie = 169,
    Charmcraft = 170,
    ...
    CodeCV = 96,
    CodeRabbit = 95,
    ["CodeShip Pro services configuration files"] = 243,
    ["CodeShip Pro steps configuration files"] = 244,
    ["Codecov configuration files"] = 242,
    Codex = 238,
    CodifyCLI = 97,
    Codux = 240,
    ["Cog config file"] = 183,
    ...
    ["Common Catalog Data"] = 252,
    ["Common Package Specification"] = 186,
    Concord = 1135,
    ["Configu .cfgu files"] = 1123,
    ["Configu .configu file"] = 1124,
    Conjure = 181,
    ["Container Structure Test"] = 961,
    Containerlab = 989,
    ["Contextive Glossary"] = 1191,
    Convex = 180,
    ["Crowdsec collection config"] = 283,
    ["Crowdsec parser config"] = 284,
    ["Crowdsec scenario config"] = 285,
    ["CumulusCI Config"] = 187,
    ["Cursor Agent Environment"] = 1244,
    ["Custom Machinery Machine"] = 1107,
    ["Custom Machinery Recipe"] = 1108,
    ["Cycle Stack File"] = 193,
    CycloneDX = 194,
    ["DWP Exchange - catalogue entry"] = 334,
    ["DWP Exchange - gateway"] = 332,
    ["DWP Exchange - meta"] = 333,
    ["Dart Build Config (dart-build.json)"] = 291,
    ["Dart Test Config (dart-test.json)"] = 292,
    ["DashLord Configuration"] = 293,
    ["Data Contract Specification"] = 294,
    ["Data Product Specification"] = 295,
    ["DataYoga Connections"] = 195,
    ["DataYoga Job"] = 196,
    ["Databricks Asset Bundles"] = 1085,
    ["Datadog Continuous Testing"] = 498,
    ["Datadog Service Definition"] = 499,
    ["Datadog Software Catalog"] = 500,
    ["Datahub Ingestion Recipe"] = 1039,
    ["Debian Upstream Metadata file"] = 203,
    ["Deck config"] = 204,
    ["DeepMatch deeplinks spec"] = 205,
    ["Dein Config"] = 206,
    ["Deno Config (deno.json)"] = 301,
    ["Dependency cruiser"] = 207,
    ["DeployStack Configuration"] = 208,
    ["Deployah Configuration"] = 1214,
    ["Deployer Recipe"] = 304,
    ["Deta Spacefile"] = 209,
    ["Detekt Config (detekt.yml)"] = 305,
    ["Devbox Config"] = 210,
    ["Devbox Plugin"] = 211,
    Devfile = 331,
    Devup = 1227,
    DipDup = 1138,
    ["Discord Webhook"] = 306,
    ["DocFx Config (docfx.json)"] = 311,
    ["Docker Desktop extension metadata"] = 308,
    ["Docs MCP Manifest"] = 312,
    Dofigen = 313,
    ["Dolittle Artifacts"] = 314,
    ["Dolittle Bounded Context Configuration"] = 315,
    ["Dolittle Event Horizons Configuration"] = 316,
    ["Dolittle Resources Configuration"] = 317,
    ["Dolittle Server Configuration"] = 318,
    ["Dolittle Tenant Map Configuration"] = 320,
    ["Dolittle Tenants Configuration"] = 319,
    ["Dolittle Topology"] = 321,
    ["DonateCaseBetterCasino menu"] = 1168,
    ["Drupal Breakpoints"] = 212,
    ["Drupal Config"] = 224,
    ["Drupal Info"] = 213,
    ["Drupal Layouts"] = 214,
    ["Drupal Libraries"] = 215,
    ["Drupal Links Action"] = 216,
    ["Drupal Links Contextual"] = 217,
    ["Drupal Links Menu"] = 218,
    ["Drupal Links Task"] = 219,
    ["Drupal Migration"] = 220,
    ["Drupal Permissions"] = 221,
    ["Drupal Recipe"] = 222,
    ["Drupal Routing"] = 223,
    ["Drupal Services"] = 225,
    ["Drush site aliases"] = 327,
    ["Dynamic Bash Aliases (.aliases)"] = 1076,
    ["EAS config"] = 352,
    ["ECA - Editor Code Assistant"] = 336,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1065,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1211,
    ["EasyVCR .NET"] = 353,
    ["Eidolon Resource"] = 1152,
    ["Elgato Stream Deck"] = 338,
    Elm = 1140,
    ["Embrace Config"] = 1051,
    Endurica = 1089,
    ["Enterprise Contract Policy Spec"] = 339,
    ["Erda Pipeline"] = 1114,
    ["Erda Runtime"] = 1115,
    ["Espanso config.yml"] = 1237,
    ["Espanso match.yml"] = 1236,
    Esquio = 341,
    ["Estuary Flow Catalog"] = 1029,
    ["Ethereum ERC1155"] = 1248,
    ["Ethereum ERC721"] = 1247,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 345,
    ["EveryVoice TTS Toolkit Data Configuration"] = 346,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 350,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 349,
    ["EveryVoice TTS Toolkit Text Configuration"] = 347,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 348,
    ["Evolving Resolutive Process notation"] = 1213,
    ["Expo SDK"] = 351,
    ["F-Droid Data metadata"] = 357,
    ["FasterCI Configuration"] = 113,
    FiQuS = 361,
    Firebase = 359,
    ["Flatpak Builder Manifest"] = 362,
    ["FlexGet Config"] = 363,
    ["Flow.json Configurations"] = 1111,
    ["Fossa configuration file"] = 370,
    ["Fossa's fossa-deps file"] = 371,
    ["Foundry VTT - Base package Manifest"] = 365,
    ["Foundry VTT - Module Manifest"] = 366,
    ["Foundry VTT - System Data Template"] = 369,
    ["Foundry VTT - System Manifest"] = 367,
    ["Foundry VTT - World Manifest"] = 368,
    ["Foxx Manifest"] = 114,
    ["Freifunk.de Community API"] = 117,
    ["Frogbot Config"] = 118,
    ["G2P Mapping Configuration"] = 377,
    ["GCP Blueprint Metadata"] = 380,
    Gaspar = 378,
    ["GatewayCore API Gateway"] = 379,
    ["Gemini CLI settings"] = 381,
    ["GeoJSON.json latest"] = 1027,
    GherKing = 1031,
    ["GitHub Action"] = 386,
    ["GitHub Actions typing"] = 1148,
    ["GitHub Discussion"] = 387,
    ["GitHub Funding"] = 388,
    ["GitHub Issue Template configuration"] = 389,
    ["GitHub Issue Template forms"] = 390,
    ["GitHub Workflow"] = 391,
    ["GitHub Workflow Template Properties"] = 392,
    ["GitHub automatically generated release notes configuration"] = 393,
    ["GitLab Agent for Kubernetes configuration"] = 1103,
    GitVersion = 383,
    ["Gitea Issue Template configuration"] = 384,
    ["Gitea Issue Template forms"] = 385,
    ["Gitpod Automations"] = 395,
    ["Gitpod Configuration"] = 396,
    ["GlazeWM settings"] = 1105,
    ["Global Privacy Control"] = 382,
    Goblet = 1084,
    ["Golangci-lint Configuration"] = 411,
    ["Golangci-lint Custom Plugins Configuration"] = 412,
    ["Google Chrome Related Website Sets"] = 360,
    ["Google Cloud Workflows"] = 260,
    ["Google Digital Assetlinks"] = 1192,
    Goreleaser = 414,
    ["Goreleaser Pro"] = 415,
    Goss = 416,
    ["Gradle Build Cache Node"] = 978,
    ["Gradle Enterprise"] = 977,
    ["Grafana 5.x Dashboard"] = 417,
    ["GraphQL Code Generator"] = 422,
    ["GraphQL Config"] = 421,
    ["GraphQL Mesh"] = 420,
    ["GroovyLint configuration"] = 423,
    ["Grunt JSHint task"] = 427,
    ["Grunt Watch task"] = 428,
    ["Grunt base task"] = 429,
    ["Grunt clean task"] = 425,
    ["Grunt copy task"] = 424,
    ["Grunt cssmin task"] = 426,
    HEMTT = 943,
    Hadolint = 957,
    Hammerkit = 988,
    ["Hardware Sentry Configuration"] = 1043,
    ["Hashgraph Online Skill Manifest"] = 1,
    ["HashiCorp Vault"] = 430,
    Hatch = 958,
    Hayson = 432,
    ["Haystack Pipeline"] = 433,
    ["Hazelcast 5 Configuration"] = 434,
    ["Hecate Input Schema"] = 1203,
    ["Helm Chart.lock"] = 227,
    ["Helm Chart.yaml"] = 226,
    ["Helm Unittest Test Suite"] = 228,
    ["Home Assistant Integration Manifest"] = 435,
    ["Homer dashboard configuration"] = 436,
    Hugo = 1019,
    ["Hugo Theme"] = 1018,
    ["Hulak Configuration"] = 443,
    ["Hyperfoil benchmark configuration"] = 442,
    ["IBM Zapp document"] = 444,
    ["IBM zCodeFormatSettings"] = 445,
    ["IMG Catapult PSP"] = 450,
    ["IVMS101 by CODE Protocol"] = 1104,
    Infrahub = 452,
    Istanbul = 1047,
    ["JDownloader2 crawler multi-rules"] = 465,
    ["JDownloader2 crawler single-rules"] = 464,
    ["JFrog Applications Config"] = 466,
    ["JFrog File Spec"] = 467,
    ["JFrog Pipelines YML DSL"] = 1053,
    ["JMeter DSL cli config"] = 468,
    JReleaser = 471,
    ["JSON Document Transform"] = 479,
    ["JSON Feed"] = 480,
    ["JSON Resume"] = 729,
    ["JSON Schema Draft 2020-12"] = 925,
    ["JSON Schema Draft 4"] = 922,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1086,
    ["JSON Schema Draft 7"] = 923,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1087,
    ["JSON Schema Draft 8 (2019-09)"] = 924,
    ["JSON-API"] = 478,
    ["JSON-e templates"] = 985,
    ["JSON-stat 2.0"] = 918,
    JSONPatch = 482,
    ["JSR Package Config (jsr.json)"] = 472,
    Jarl = 1219,
    Jasmine = 459,
    Jekyll = 460,
    ["Jenkins X Pipelines"] = 461,
    ["Jenkins X Requirements"] = 462,
    Jest = 463,
    Jocker = 469,
    ["Jovo Language Models"] = 470,
    ["Jujutsu (jj) VCS config"] = 1205,
    ["KIMMDY config file"] = 493,
    ["KODE/CI build.yaml"] = 1049,
    ["KSP-AVC"] = 919,
    ["KSP-CKAN"] = 920,
    ["KSP-NetKAN"] = 921,
    KSY = 1116,
    KSail = 375,
    ["KYA Manifest"] = 1117,
    ["Karakum configuration file"] = 372,
    Kas = 485,
    ["Kestra flow file"] = 494,
    ["Keycloak REST API"] = 1056,
    ["Knative Functions - func.yaml"] = 373,
    Knip = 374,
    ["Kometa (nightly) config file"] = 496,
    ["Kometa config file"] = 495,
    ["Kong DBLess config"] = 1050,
    KrakenD = 497,
    ["Kubri Configuration"] = 504,
    LOOBin = 519,
    ["Lake configuration file"] = 1208,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 265,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 266,
    ["Landing Zone Accelerator on AWS - Global Config"] = 267,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 268,
    ["Landing Zone Accelerator on AWS - Network Config"] = 269,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 270,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 271,
    ["Landing Zone Accelerator on AWS - Security Config"] = 272,
    ["Lando (landofile)"] = 108,
    ["LangGraph Platform configuration"] = 1128,
    ["Language configuration"] = 1127,
    Lefthook = 508,
    ["Liferay client-extension.yaml"] = 515,
    ["LinkML Metamodel"] = 517,
    Liquibase = 994,
    ["Liquibase Flow File"] = 995,
    ["Lively Properties"] = 518,
    ["Lobe AI Agent"] = 110,
    Loki = 111,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 561,
    ["MS2Rescore Configuration"] = 565,
    ["Madness (madness.yml)"] = 1067,
    ["Mado configuration"] = 525,
    ["Maestro Flow"] = 526,
    ["Mail Servers Configuration"] = 1240,
    ["MapEHR Mapping"] = 527,
    Markdownlint = 998,
    ["Mason Registry"] = 1001,
    ["MegaLinter Custom Flavor"] = 530,
    ["MegaLinter configuration"] = 529,
    ["MegaLinter descriptor"] = 531,
    Melange = 1094,
    ["Meltano project definition"] = 532,
    ["Mergify Configuration"] = 566,
    ["Metadata for a Bazel module"] = 533,
    ["Metadata for a Cinnamon spice"] = 1144,
    ["Metatype Configuration"] = 534,
    ["MetricsHub Configuration"] = 535,
    ["MetricsHub Connector Configuration"] = 536,
    ["Micro Editor Syntax"] = 1077,
    ["Microsoft Band Web Tile"] = 537,
    ["Microsoft RulesEngine workflow rules"] = 1132,
    ["Microsoft RulesEngine workflow rules list"] = 1133,
    ["Minecraft Custom Main Menu Mod"] = 1095,
    ["Minecraft Data Pack Advancement"] = 539,
    ["Minecraft Data Pack Biome"] = 540,
    ["Minecraft Data Pack Configured Carver"] = 541,
    ["Minecraft Data Pack Damage Type"] = 542,
    ["Minecraft Data Pack Dimension"] = 544,
    ["Minecraft Data Pack Dimension Type"] = 543,
    ["Minecraft Data Pack Item Modifier"] = 545,
    ["Minecraft Data Pack Loot Table"] = 546,
    ["Minecraft Data Pack Metadata"] = 547,
    ["Minecraft Data Pack Predicate"] = 548,
    ["Minecraft Data Pack Recipe"] = 549,
    ["Minecraft Data Pack Tag"] = 550,
    ["Minecraft Data Pack Template Pool"] = 551,
    ["Minecraft Data Pack Trim Material"] = 556,
    ["Minecraft Data Pack Trim Pattern"] = 557,
    ["Minecraft Resource Pack Lang"] = 552,
    ["Minecraft Resource Pack Particle"] = 553,
    ["Minecraft Resource Pack Texture Mcmeta"] = 555,
    ["Minecraft Resourcepack Sounds"] = 554,
    ModuleAssembler = 559,
    ["Monade CLI Stack Configuration"] = 569,
    ["MongoDB Atlas Search Index Definition"] = 1048,
    ["Monika Configuration"] = 1046,
    ["Monoweave Configuration"] = 564,
    ["Motif config"] = 939,
    MultiQC = 1185,
    ["NOX Framework (Service)"] = 585,
    ["Netin Diagnostic System Template"] = 1005,
    ["Netlify config"] = 572,
    ["Network-as-Code Data Model"] = 573,
    ["Next Gen UI Agent A2A Server Configuration"] = 574,
    ["Next Gen UI Agent Configuration"] = 576,
    ["Next Gen UI Agent MCP Server Configuration"] = 575,
    ["Nightwatch.js"] = 578,
    ["Node.js configuration"] = 944,
    ["NueJS configuration file"] = 590,
    ["Nuitka.yaml"] = 1109,
    ["Nullstone config"] = 592,
    ["ONe's changelog entry"] = 611,
    ["ONe's service descriptor"] = 610,
    ["ORT Server repository environment configuration"] = 621,
    ["OSCAL Assessment Plan (AP)"] = 623,
    ["OSCAL Assessment Results (AR)"] = 624,
    ["OSCAL Catalog"] = 625,
    ["OSCAL Component Definition (CDef)"] = 626,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 627,
    ["OSCAL Profile"] = 628,
    ["OSCAL System Security Plan (SSP)"] = 629,
    ["OSS Review Toolkit configuration"] = 630,
    ["OSS Review Toolkit curation"] = 631,
    ["OSS Review Toolkit package configuration"] = 632,
    ["OSS Review Toolkit repository configuration"] = 633,
    ["OSS Review Toolkit resolutions"] = 634,
    ["October CMS columns"] = 596,
    ["October CMS fields"] = 597,
    ["Oh My Posh"] = 599,
    Okteto = 600,
    ["Ona Automations"] = 602,
    Opctl = 942,
    ["Open Data Contract Standard (ODCS)"] = 615,
    ["Open Data Product Standard (ODPS)"] = 616,
    ["Open Know-How"] = 1190,
    ["OpenRewrite Resource"] = 613,
    OpenSRM = 617,
    OpenStatus = 1201,
    ["OpenTelemetry Declarative Configuration"] = 614,
    ["OpenUtau character yaml"] = 607,
    ["OpenUtau ustx"] = 608,
    ["OpenWeather Current Weather API"] = 984,
    ["OpenWeather Road Risk API"] = 983,
    ["Ory Hydra configuration"] = 441,
    ["Ory Keto configuration"] = 501,
    ["Ory Kratos configuration"] = 622,
    ["Ory Oathkeeper configuration"] = 594,
    ["Outblocks App configuration"] = 619,
    ["Outblocks database table"] = 620,
    ["Outblocks project configuration"] = 618,
    PDM = 641,
    POPxf = 652,
    ["POPxf Correlations"] = 653,
    Packer = 638,
    PactSpec = 639,
    Pantsbuild = 1063,
    ["Paper paper-plugin.yml"] = 640,
    ["Pipeline component"] = 996,
    ["Platform.sh application"] = 7,
    ["Platform.sh routes"] = 8,
    ["Platform.sh services"] = 9,
    ["Plex Prerolls"] = 650,
    ["PocketMine plugin.yml"] = 647,
    ["Postman collection"] = 656,
    ["Power Pages Configuration"] = 1202,
    ["Preset list for a WinUtil"] = 1147,
    ["ProActions AI-Kit Configuration"] = 667,
    ["ProActions AI-Kit Configuration for Menus"] = 669,
    ["ProActions AI-Kit Configuration for Sections"] = 671,
    ["ProActions AI-Kit Configuration for Services"] = 668,
    ["ProActions AI-Kit Configuration for Steps"] = 672,
    ["ProActions AI-Kit Configuration for Templates"] = 670,
    ["Problem object RFC9457"] = 1092,
    ["Problem package format"] = 673,
    ["Problem package generators"] = 674,
    ["Problem package submissions"] = 675,
    ["Problem package test group metadata"] = 676,
    Pterodactyl = 1042,
    ["Pull Request Labeler"] = 693,
    Pulumi = 701,
    ["PyGTA Config"] = 697,
    PyProject = 702,
    Pylock = 1193,
    Pyright = 703,
    ["Python script metadata"] = 1187,
    ["QType AI DSL"] = 706,
    Qgoda = 705,
    Qodana = 1015,
    ...
    Ray = 956,
    ["Read the Docs"] = 700,
    ["Red-DiscordBot Cog"] = 716,
    ["Red-DiscordBot Cog Repo"] = 717,
    ["Red-DiscordBot Trivia"] = 718,
    ["Releasaurus Config"] = 4,
    ReleaseKit = 3,
    ["Render Blueprints"] = 991,
    RenderCV = 733,
    Renovate = 730,
    ["Renovate global configuration"] = 731,
    ["Renovate inherited configuration"] = 732,
    ["Replit config"] = 724,
    Restate = 1180,
    ["Revel Digital Gadget Definition File"] = 1204,
    RoadRunner = 735,
    ["Robust Station Image"] = 1210,
    Rockcraft = 736,
    ["Roo Coder Custom Modes"] = 737,
    Rubocop = 726,
    ["Rudder techniques"] = 1099,
    Ruff = 727,
    ["Rust Project"] = 728,
    ["Rust toolchain"] = 741,
    ["SDMX data message"] = 768,
    ["SDMX metadata message"] = 767,
    ["SDMX structure message"] = 766,
    ["SIL Kit Participant Configuration"] = 778,
    ["SIL Kit Registry Configuration"] = 779,
    ["SPDX 2.3"] = 816,
    SWADL = 832,
    ["Safebox Config"] = 1054,
    ["Sapphire CLI Config"] = 744,
    ["SauceCTL Configuration"] = 1002,
    Scarb = 764,
    ["Schema Catalog"] = 759,
    ["Scoop manifest"] = 765,
    ["Semantic Data Fabric (SDF) file"] = 769,
    ["Semgrep Rule"] = 771,
    ["Serenity Code Generator (Sergen)"] = 772,
    ["Serverless Framework Configuration"] = 1009,
    ["Serverless Workflow"] = 1011,
    ["Settings for a Cinnamon spice"] = 1143,
    ["Settings.paf"] = 774,
    ["Shopware 6 Configuration"] = 1012,
    ["Shopware CLI Extension Store Configuration"] = 1013,
    ["Shopware CLI Project Store Configuration"] = 1014,
    ["Sigma Detection Rule"] = 776,
    ["Sigrid scope configuration file"] = 777,
    ["SkyPilot Task JSON"] = 1100,
    ["Slack app manifest"] = 781,
    Snapcraft = 783,
    Solidarity = 786,
    ["Solution filters"] = 787,
    ["Source Maps v3"] = 788,
    Sourcery = 789,
    ["Spack bootstrap.yaml"] = 790,
    ["Spack cdash.yaml"] = 791,
    ["Spack ci.yaml"] = 792,
    ["Spack compilers.yaml"] = 793,
    ["Spack concretizer.yaml"] = 794,
    ["Spack config.yaml"] = 795,
    ["Spack definitions.yaml"] = 796,
    ["Spack develop.yaml"] = 797,
    ["Spack env_vars.yaml"] = 798,
    ["Spack environment"] = 804,
    ["Spack include.yaml"] = 799,
    ["Spack mirrors.yaml"] = 800,
    ["Spack modules.yaml"] = 801,
    ["Spack packages.yaml"] = 802,
    ["Spack repos.yaml"] = 803,
    ["Spack toolchains.yaml"] = 805,
    ["Spack upstreams.yaml"] = 806,
    ["Spack view.yaml"] = 807,
    ["Speakeasy Generation Config File"] = 811,
    ["Speakeasy Lint Configuration File"] = 808,
    ["Speakeasy Test Generation Configuration File"] = 809,
    ["Speakeasy Workflow File"] = 810,
    SpecIF = 812,
    ["Specmatic Configuration"] = 813,
    ["Sponge Mixin configuration"] = 814,
    StackBlitz = 820,
    ["StackHawk Scanner Configuration"] = 1008,
    Stale = 821,
    Starfish = 822,
    ["Starlake Data Pipeline"] = 981,
    Starship = 823,
    ["Statamic Blueprint"] = 824,
    ["Stella configuration file"] = 825,
    ["Streamlit configuration file"] = 826,
    ["Stryker Mutator"] = 829,
    ["StyleCop Analyzers Configuration"] = 830,
    ["Stylelint (.stylelintrc)"] = 831,
    ["Stylua Config"] = 1194,
    ["Sublime Syntax"] = 1055,
    ["Subsquid squid manifest"] = 1102,
    ["Swagger API 2.0"] = 833,
    ["Synadia Connect Component"] = 834,
    TSON = 870,
    TSTyche = 871,
    ["TYPO3 Vendor Bundler config"] = 877,
    ["Tab data for a LinUtil"] = 1150,
    ["Tab list for a LinUtil"] = 1149,
    Tach = 835,
    ["Tach Domain"] = 836,
    Talhelper = 838,
    ["Talisman configuration"] = 839,
    Taplo = 1195,
    ["Taskfile config"] = 986,
    Taurus = 840,
    Tauticord = 841,
    ["Tekton Pipeline"] = 1223,
    ["Tekton PipelineRun"] = 1224,
    ["Tekton Task"] = 1221,
    ["Tekton TaskRun"] = 1222,
    Telefonistka = 1181,
    ["Terrateam config"] = 1207,
    ["TestEnvironment.json"] = 853,
    ["TextMate Grammar"] = 852,
    Threagile = 847,
    ["Tier.run pricing.json"] = 844,
    Tikibase = 845,
    Tombi = 850,
    ["Traefik v2"] = 856,
    ["Traefik v2 File Provider"] = 857,
    ["Traefik v3"] = 858,
    ["Traefik v3 File Provider"] = 859,
    ["Travis CI (.travis.yml)"] = 855,
    Treefmt = 419,
    Trident = 1177,
    ["TrueScript for *.tscript files"] = 862,
    ["Tugboat QA config.yml"] = 1174,
    TunnelHub = 1090,
    Turborepo = 854,
    Tycho = 1139,
    Tye = 1016,
    ["Tyk Gateway - Open Source v5.7+"] = 1186,
    ["UET BuildConfig.json"] = 1060,
    ["UI5 Manifest"] = 883,
    ["UNCORS configuration"] = 887,
    ["UTAM Page Object"] = 886,
    ["Ubuntu Server Autoinstall"] = 881,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1178,
    ["Uniswap Token List"] = 968,
    ["Universal Schedule Format"] = 888,
    ["Unreal Engine Uplugin"] = 1061,
    ["Unreal Engine Uproject"] = 1062,
    ["UpCloud CLI (upctl) configuration"] = 1179,
    ["Updatecli Compose"] = 1024,
    ["Updatecli Policy Manifest"] = 1025,
    ["Updatecli Policy Metadata"] = 1026,
    Uplift = 1058,
    ["Upsun config"] = 6,
    ["User Journey Map"] = 990,
    V2Ray = 1030,
    ["VSCode Code Snippets"] = 248,
    ["VSIX CLI publishing"] = 906,
    Vector = 890,
    ["Vela Pipeline Configuration"] = 893,
    Vercel = 247,
    ["Version Bumper config"] = 896,
    Vespertide = 1228,
    ["Vespertide Migration"] = 1229,
    ["Vespertide Model"] = 1230,
    ["Viash Component Config"] = 1183,
    ["Viash Package Config"] = 1184,
    Visivo = 1088,
    ["WP-CLI"] = 916,
    Wake = 1176,
    ["Waku Config"] = 1153,
    ["Web App Manifest"] = 912,
    ["Web types"] = 915,
    WebExtensions = 911,
    ["Webman package recipe"] = 1036,
    ["Windows Package Manager Installer Manifest"] = 964,
    ["Windows Package Manager Locale Manifest"] = 965,
    ["Windows Package Manager Singleton Manifest"] = 963,
    Winutil = 966,
    ["WireMock CLI import configuration"] = 1159,
    ["WireMock CLI local service configuration"] = 1158,
    ["WireMock message stub mapping"] = 1157,
    ["WireMock stub mapping"] = 1156,
    ["Woodpecker pipeline config"] = 1004,
    ["Wrangler CLI"] = 917,
    ["Xstate Machine"] = 1022,
    ["Yandex Workflow Language"] = 1145,
    ["Yarn Config (.yarnrc.yml)"] = 979,
    ["Yippee-Ki-JSON configuration YML"] = 970,
    ["YouTrack App"] = 1142,
    ["Zarf Package Configuration"] = 1209,
    ["Zerops.io config"] = 1130,
    ["Zerops.io import"] = 1131,
    ["Zola Configuration"] = 1220,
    ["aerleon.yml"] = 19,
    ["amplify.yml"] = 12,
    ["angular.json"] = 36,
    apko = 1093,
    ...
    ["behat.yml"] = 140,
    ["bigquery-table"] = 129,
    ["bioimageio resource description"] = 1110,
    ...
    ["ccmod.json"] = 1154,
    changelogging = 1122,
    ["chisel-slices.json"] = 274,
    ["chrome-extension-locales-messages.json"] = 255,
    ["chutzpah.json"] = 256,
    cibuildwheel = 175,
    ["clang-format (.clang-format)"] = 1028,
    ["clang-tidy"] = 234,
    clangd = 233,
    clib = 235,
    ["cloud-init: cloud-config userdata"] = 237,
    ["cloud-sdk-pipeline-configuration"] = 258,
    ["cloudbuild.json"] = 259,
    cloudify = 236,
    cmakefmt = 191,
    ["cmdx.yaml"] = 94,
    ...
    ["coffeelint.json"] = 276,
    ["commands.json"] = 251,
    ["commitlint (.commitlintrc)"] = 967,
    ["committed.toml"] = 277,
    ["compile_commands.json"] = 250,
    ["compilerconfig.json"] = 249,
    ["completely.yml"] = 1066,
    ["component-detection-manifest.json"] = 280,
    ["component.json"] = 279,
    ["composer.json"] = 278,
    ["conda-forge"] = 179,
    ["config.yaml"] = 699,
    ["contentmanifest.json"] = 257,
    ["contribute.json"] = 281,
    ["cosmos.config.json"] = 253,
    ["crowdin.yml"] = 282,
    ["ctfd-setup configuration file"] = 1166,
    ["custom-elements.json"] = 1080,
    ["cypress.json"] = 286,
    ["datalogic-scan2deploy-android"] = 296,
    ["datalogic-scan2deploy-ce"] = 297,
    ["dbt Dependencies"] = 198,
    ["dbt Packages"] = 200,
    ["dbt Project"] = 199,
    ["dbt Selectors"] = 201,
    ["dbt YAML files"] = 202,
    ...
    ["ddev-global"] = 298,
    ["ddev-project"] = 299,
    ["debugsettings.json"] = 300,
    ["dependabot-v2.json"] = 303,
    ["dependabot.json"] = 302,
    ["deployed-cli"] = 1021,
    ["devcontainer.json"] = 241,
    devinit = 972,
    ["devspace.yaml"] = 1044,
    djlint = 973,
    ["docker bake"] = 309,
    ["docker sequencer"] = 310,
    ["docker-compose.yml"] = 971,
    ["dockerd.json"] = 307,
    ["dotnet Release Index manifest"] = 322,
    ["dotnet-tools.json"] = 323,
    ["dotnetcli.host.json"] = 324,
    ["dprint.json"] = 325,
    ["drone.json"] = 326,
    ["dss-2.0.0.json"] = 328,
    ["dstack configuration"] = 329,
    ["dtool dataset metadata"] = 1161,
    ["dvc.yaml"] = 330,
    ["ecosystem.json"] = 335,
    eksctl = 337,
    ["electron-builder configuration file"] = 343,
    ["epr-manifest.json"] = 342,
    ["evcc.yaml"] = 344,
    ["ezd task runner"] = 354,
    ["fabric.mod.json"] = 356,
    ["first-timers-bot"] = 364,
    ["flagd flag configuration"] = 115,
    ["fly.io Configuration"] = 116,
    fulibWorkflows = 1003,
    ["function.json"] = 376,
    ["gRPC API Gateway & OpenAPI Config"] = 14,
    ["gematik health care insurance list"] = 1172,
    ["gematik health care patient list"] = 1169,
    ["gematik health care provider institution list"] = 1171,
    ["gematik health care provider list"] = 1170,
    ["gematik tiger test environment configuration"] = 1173,
    ["git-town.toml"] = 1218,
    ["gitlab-ci"] = 394,
    ["global.json"] = 410,
    ["go-feature-flag Flag Configuration"] = 413,
    ["haxelib.json"] = 431,
    helmfile = 959,
    helmwave = 960,
    ["host-meta.json"] = 438,
    ...
    ["ide.host.json"] = 446,
    ["ifstate.yaml"] = 447,
    ["imageoptimizer.json"] = 448,
    ["importmap.json"] = 451,
    instant_python_config = 453,
    instant_python_custom_project = 454,
    ["ioBroker Configuration"] = 455,
    ["ioBroker JSON UI"] = 456,
    ["ioBroker Package manifest"] = 457,
    ["ixpect.conf.yaml"] = 458,
    ["ize.toml"] = 1057,
    ["jsconfig.json"] = 483,
    ["jscpd Configuration"] = 1041,
    jsdoc = 955,
    ["k3d.yaml"] = 484,
    ["k9s aliases.yaml"] = 486,
    ["k9s cluster-config.yaml"] = 488,
    ["k9s config.yaml"] = 487,
    ["k9s hotkeys.yaml"] = 489,
    ["k9s plugins.yaml"] = 490,
    ["k9s skin.yaml"] = 491,
    ["k9s views.yaml"] = 492,
    ["kontinuous-config.yaml"] = 503,
    ["kontinuous-values.yaml"] = 502,
    ["kustomization.yaml"] = 505,
    ["label-commenter-config.yml"] = 506,
    ["latexindent configuration"] = 109,
    ["launchsettings.json"] = 507,
    lazydocker = 1079,
    lazygit = 1078,
    ["lego.json"] = 509,
    ["lerna.json"] = 510,
    ["lgtm.yml"] = 511,
    ["liblab.config.json"] = 512,
    ["libman.json"] = 513,
    ["license-report-config.json"] = 514,
    ["linkinator.config.json"] = 516,
    ["lint-staged (.lintstagedrc)"] = 933,
    ["local.settings.json"] = 521,
    ["localazy.json"] = 522,
    ["lotus.yaml"] = 520,
    ["lsdlschema.json"] = 523,
    ["macro.json"] = 1045,
    ["markdown-link-check"] = 999,
    maturin = 1000,
    mboats = 1007,
    ["micro-settings.json"] = 1072,
    ["mimetypes.json"] = 538,
    ["mirrord config"] = 935,
    mise = 936,
    ["mkdocs.yml"] = 558,
    ...
    ["monospace.yml"] = 563,
    ["moon.yml"] = 1155,
    ["mprocs Configuration file"] = 1126,
    ["mrdocs.yml"] = 560,
    ["mta.yaml"] = 937,
    ["mtad.yaml"] = 938,
    ["mycode.json"] = 570,
    nFPM = 577,
    ["napari plugin manifest"] = 571,
    neoload = 950,
    ["nest-cli"] = 580,
    ["nexus-rpc-gen"] = 1245,
    ["ninjs (News in JSON)"] = 579,
    ["nitro.json"] = 949,
    ["nixd configuration"] = 1098,
    ["nlu.json"] = 581,
    ["nodemon.json"] = 583,
    ["noodl config"] = 1006,
    ["notebook.mod.json"] = 584,
    now = 945,
    ["npm-badges"] = 587,
    ["nswag.json"] = 591,
    ntangle = 593,
    ["nuclei-template.yaml"] = 588,
    ["nuget-project.json"] = 589,
    ["ocelot.json"] = 595,
    ogen = 598,
    ["omnisharp.json"] = 601,
    openHAB = 1231,
    ...
    oxlint = 1242,
    ["package.json"] = 635,
    ["package.manifest"] = 637,
    ["package.yaml"] = 636,
    ["partial-black.json"] = 141,
    ["partial-pixi.json"] = 645,
    ["pattern.json"] = 643,
    ["petstore-v1.0"] = 1052,
    pgap_yaml_input_reader = 642,
    pgxgen = 1235,
    pitcms = 1238,
    ["pixi.toml"] = 644,
    ["plagiarize-me.yaml"] = 649,
    ["plagiarize.yaml"] = 648,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1162,
    ["podbard.yaml"] = 651,
    ["portman.json"] = 654,
    ["prefect.toml"] = 662,
    ["prefect.yaml"] = 663,
    ...
    ["prettierrc.json"] = 665,
    ["prisma.yml"] = 666,
    ["project-1.0.0-beta3.json"] = 678,
    ["project-1.0.0-beta4.json"] = 679,
    ["project-1.0.0-beta5.json"] = 680,
    ["project-1.0.0-beta6.json"] = 681,
    ["project-1.0.0-beta8.json"] = 682,
    ["project-1.0.0-rc1.json"] = 683,
    ["project-1.0.0-rc2.json"] = 684,
    ["project.json"] = 677,
    ["project.owasp.yaml"] = 685,
    ["prometheus-alertmanager.json"] = 689,
    ["prometheus.json"] = 686,
    ["prometheus.rules.json"] = 687,
    ["prometheus.rules.test.json"] = 688,
    ["proxies.json"] = 690,
    ["publiccode.yml"] = 691,
    ["pubspec.yaml"] = 692,
    ["pyrseas-0.8.json"] = 695,
    pytest = 704,
    ["quilt.mod.json"] = 1073,
    ["rc3 auth"] = 710,
    ["rc3 collection"] = 711,
    ...
    ["release drafter"] = 951,
    ["release-hub.json"] = 2,
    ["release-please-config.json"] = 720,
    ["release-please-manifest.json"] = 721,
    ["release-plz.toml"] = 722,
    ["renv.lock"] = 734,
    ["rivet.json"] = 1097,
    ["rivet.yaml (legacy)"] = 1096,
    rumdl = 739,
    runny = 738,
    rustfmt = 740,
    sake = 1189,
    samt = 742,
    samtrc = 743,
    ["sarif-1.0.0.json"] = 745,
    ["sarif-2.0.0.json"] = 746,
    ["sarif-2.1.0"] = 756,
    ["sarif-2.1.0-rtm.2"] = 747,
    ["sarif-2.1.0-rtm.3"] = 749,
    ["sarif-2.1.0-rtm.4"] = 751,
    ["sarif-2.1.0-rtm.5"] = 753,
    ["sarif-2.1.0-rtm.6"] = 754,
    ["sarif-external-property-file-2.1.0"] = 757,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 748,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 750,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 752,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 755,
    ["scalingo.json configuration"] = 758,
    ["schema.org - Action"] = 760,
    ["schema.org - ContactPoint"] = 761,
    ["schema.org - Place"] = 762,
    ["schema.org - Thing"] = 763,
    ["secrethub.yml"] = 1075,
    ["semantic-release"] = 770,
    ["servicehub.config.json"] = 928,
    ["servicehub.service.json"] = 927,
    ["settings.job"] = 773,
    ["sfdx-hardis configuration"] = 775,
    ["shard.yml"] = 1113,
    ["size-limit configuration"] = 780,
    ["skaffold.yaml"] = 997,
    ["skyuxconfig.json"] = 782,
    ["snowflake-config"] = 784,
    ["snowflake-connections"] = 785,
    ["spicepod.yaml"] = 1134,
    ["sqlc configuration"] = 817,
    ["stripe-app-local.json"] = 828,
    ["stripe-app.json"] = 827,
    swcrc = 982,
    ["task.json"] = 837,
    taskcat = 946,
    ["template.json"] = 842,
    ["templatsources.json"] = 843,
    ["text2confl config"] = 1243,
    ["theme.json"] = 846,
    ["tizen_workspace.json"] = 848,
    tldr = 849,
    ["tm_devices configuration file"] = 1200,
    tmuxinator = 931,
    tox = 851,
    ["transcend.yml"] = 860,
    ["tree-sitter grammar.json"] = 418,
    ["trime.yaml"] = 861,
    ["trunk.yaml"] = 863,
    ["ts-force-config.json"] = 868,
    ["tsconfig.json"] = 864,
    ["tsd.json"] = 865,
    ["tsdoc.json"] = 866,
    ["tsdrc.json"] = 867,
    ...
    v8r = 910,
    vcluster = 1120,
    ["vcpkg configuration file"] = 246,
    ["vcpkg manifest file"] = 245,
    ["vega-lite.json"] = 892,
    ["vega.json"] = 891,
    ["venvironment.yaml"] = 894,
    ["venvplus.yaml"] = 895,
    version = 1182,
    ["version.json"] = 897,
    ["vhwdebugger-binding.yaml"] = 899,
    ["vim-addon-info"] = 900,
    ["vs-2017.3.host.json"] = 902,
    ["vs-nesting.json"] = 903,
    ["vsls.json"] = 901,
    ["vss-extension.json"] = 907,
    vtcfg = 1188,
    ["vtesttree.yaml"] = 908,
    ["vtestunit.yaml"] = 909,
    ["warp-keysets.json"] = 1081,
    ["warp-themes.json"] = 1082,
    ["warp-workflows.json"] = 1083,
    ["webhint.io"] = 1037,
    ["webjobpublishsettings.json"] = 914,
    ["webjobs-list.json"] = 913,
    ["well-known-fursona"] = 1121,
    ["xs-app.json"] = 941,
    ["xunit.runner.json"] = 926,
    yamllint = 969,
    zizmor = 1225,
    zuul = 952,
    ["Žinoma"] = 962
