...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1100,
    [".nodehawkrc"] = 706,
    [".npmpackagejsonlintrc"] = 711,
    [".omletrc"] = 1281,
    [".phrase.yml"] = 793,
    [".phraseapp.yml"] = 794,
    [".pmbot.yml"] = 778,
    [".postcssrc"] = 787,
    [".powerpages-web-template-manifest"] = 789,
    [".pre-commit-config.yml"] = 790,
    [".pre-commit-hooks.yml"] = 791,
    [".putout.json"] = 827,
    [".rehyperc"] = 852,
    [".remarkrc"] = 856,
    [".sprite files"] = 958,
    ...
    AIConfig = 48,
    ["AMX Muse Program Descriptor"] = 1330,
    ["API Builder"] = 1136,
    ["AVA Configuration"] = 1200,
    ...
    ["AWS Copilot Manifest"] = 1369,
    ["AWS SAM CLI Samconfig"] = 322,
    Acton = 1423,
    ["Adobe UXP Manifest"] = 1263,
    ["Aerleon Network & Service Definitions"] = 30,
    ["Aerleon Policy"] = 31,
    ["Agent Permission Policy"] = 1409,
    ["AgentCore CLI"] = 1410,
    ["AgentCtl MCP"] = 1412,
    ["AgentCtl config"] = 1411,
    ["AgentCtl permissions"] = 1413,
    AgentLoopKit = 1414,
    Aider = 1359,
    Air = 33,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1380,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1379,
    ["Airlock Microgateway"] = 49,
    ["Alacritty Configuration"] = 1172,
    ["AlgoVoi Compliance Receipt v1"] = 19,
    ["All Contributors configuration file"] = 1226,
    ["Amazon S3 bucket CORS"] = 21,
    Ameba = 1,
    Anodizer = 518,
    ["Ansible Argument Specs"] = 500,
    ["Ansible Collection Galaxy"] = 507,
    ["Ansible Execution Environment"] = 497,
    ["Ansible Inventory"] = 506,
    ["Ansible Meta"] = 498,
    ["Ansible Meta Runtime"] = 499,
    ["Ansible Navigator Configuration"] = 509,
    ["Ansible Playbook"] = 504,
    ["Ansible Requirements"] = 501,
    ["Ansible Rulebook"] = 505,
    ["Ansible Tasks File"] = 503,
    ["Ansible Vars File"] = 502,
    ["Ansible-lint Configuration"] = 508,
    Any = 1291,
    ...
    ["Application list for a WinUtil"] = 1309,
    ["ArchSmith diagram IR"] = 1452,
    ArchitectFX = 1314,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1378,
    ["Azure IoT Operations connector metadata"] = 1375,
    ...
    ["Azure Pipelines"] = 137,
    ["Azure Static Web Apps CLI configuration file"] = 962,
    ["Azure Static Web Apps configuration file"] = 961,
    BMML = 1397,
    ["BOSH BPM Config"] = 165,
    ["BOSH CPI Config"] = 166,
    ...
    Badness = 149,
    ["Barba-CV"] = 103,
    ["Bashly (bashly.yml)"] = 1230,
    ["Bashly Settings (bashly-settings.yml)"] = 1231,
    Bento = 1396,
    ["Better Code Hub"] = 1141,
    ["Better Scripts"] = 192,
    Bigconfig = 158,
    ["Biome Formatter Config"] = 104,
    ["Bitmovin Encoding Template"] = 1323,
    BizTalkServerApplicationSchema = 1107,
    Bleep = 193,
    ["Block Protocol Metadata"] = 190,
    ["Bluebricks blueprint config"] = 1402,
    ["Boyka Framework"] = 171,
    ...
    ["Butane Config"] = 1185,
    C4InterFlow = 1338,
    ["CDK Environment Manager, concrete environment configuration"] = 1362,
    ["CDK Environment Manager, concrete environments definition"] = 1361,
    ["CDK Environment Manager, environment definition"] = 1360,
    ["CGS Card Game Specification (cgs.json)"] = 1268,
    ["CICS TS region tagging"] = 1194,
    ["CICS TS resource import"] = 1195,
    ["CICS TS resource model"] = 1196,
    ["CICS TS resource overrides"] = 1197,
    ["CMake Presets"] = 194,
    ["CNC Codes"] = 217,
    ["CRS WAF test file"] = 1298,
    ["CRS WAF test platform overrides file"] = 1299,
    ["CSS Comb (.csscomb.json)"] = 349,
    ["CSS Lint (.csslintrc)"] = 350,
    ["CSpell (cspell.json)"] = 348,
    ["CVE Record Format"] = 229,
    ["CVX achievements.yaml"] = 235,
    ["CVX competencies.yaml"] = 234,
    ["CVX config.yaml"] = 238,
    ["CVX education.yaml"] = 233,
    ["CVX experience.yaml"] = 232,
    ["CVX keywords.yaml"] = 237,
    ["CVX layout"] = 239,
    ["CVX personal.yaml"] = 230,
    ["CVX referees.yaml"] = 236,
    ["CVX summary.yaml"] = 231,
    CWL = 1274,
    ["Cache Warmup config"] = 195,
    ["Caido Proxy Configuration"] = 1438,
    ...
    ["Chamaleon environment"] = 1327,
    ["Chamaleon properties"] = 1328,
    ["Chamaleon template"] = 1326,
    Changepacks = 1389,
    Changesets = 331,
    Changie = 203,
    Charmcraft = 204,
    ...
    CityJSON = 212,
    ["Claude Code Keybindings"] = 224,
    ["Claude Code Launch Preview"] = 1451,
    ["Claude Code Plugin Manifest"] = 225,
    ["Claude Code Plugin Marketplace"] = 226,
    ["Claude Code Settings"] = 227,
    ["Clawject config"] = 223,
    ["Cloud Foundry Application Manifest"] = 1280,
    ["Cloud Run Spec v1"] = 1304,
    ...
    CodeCV = 118,
    CodeRabbit = 117,
    ["CodeShip Pro services configuration files"] = 301,
    ["CodeShip Pro steps configuration files"] = 302,
    ["Codecov configuration files"] = 300,
    Codex = 291,
    ["Codex Hooks"] = 292,
    ["Codex Plugin Manifest"] = 293,
    ["Codex Skill Metadata"] = 294,
    CodifyCLI = 119,
    Codux = 296,
    ["Cog config file"] = 218,
    ["Commandbox Box.json"] = 219,
    ["Commandbox Server.json"] = 220,
    ["Common Catalog Data"] = 310,
    ["Common Package Specification"] = 221,
    Concord = 1297,
    ["Configu .cfgu files"] = 1285,
    ["Configu .configu file"] = 1286,
    Conjure = 216,
    ["Container Structure Test"] = 1121,
    Containerlab = 1150,
    ["Context Passport"] = 2,
    ["Contextive Glossary"] = 1354,
    ContractGuard = 1151,
    Convex = 215,
    ["Crowdsec collection config"] = 342,
    ["Crowdsec parser config"] = 343,
    ["Crowdsec scenario config"] = 344,
    ["CumulusCI Config"] = 222,
    ["Cursor Agent Environment"] = 1407,
    ["Custom Machinery Machine"] = 1269,
    ["Custom Machinery Recipe"] = 1270,
    ["Cycle Stack File"] = 240,
    CycloneDX = 241,
    ["DWP Exchange - catalogue entry"] = 398,
    ["DWP Exchange - gateway"] = 396,
    ["DWP Exchange - meta"] = 397,
    ["Dagger module"] = 351,
    ["Dark Factory consumer config"] = 242,
    ...
    ["DataYoga Connections"] = 243,
    ["DataYoga Job"] = 244,
    ["Datadog Continuous Testing"] = 607,
    ["Datadog Service Definition"] = 608,
    ["Datadog Software Catalog"] = 609,
    ["Datahub Ingestion Recipe"] = 1201,
    ["Debian Upstream Metadata file"] = 251,
    DebtLens = 252,
    ["Deck config"] = 253,
    ["Declarative Automation Bundles"] = 1247,
    ["DeepMatch deeplinks spec"] = 254,
    ["Dein Config"] = 255,
    ["Deno Config (deno.json)"] = 364,
    ["Dependency cruiser"] = 256,
    ["DeployStack Configuration"] = 257,
    ["Deployah Configuration"] = 1377,
    ["Deployer Recipe"] = 367,
    ["Design Tokens Community Group format"] = 258,
    ["Design Tokens Community Group resolver"] = 259,
    ["Deta Spacefile"] = 260,
    ["Detekt Config (detekt.yml)"] = 368,
    ["Devbox Config"] = 261,
    ["Devbox Plugin"] = 262,
    Devfile = 395,
    Devup = 1390,
    DipDup = 1300,
    ["Discord Webhook"] = 369,
    ["DocFx Config (docfx.json)"] = 374,
    ["Docker Desktop extension metadata"] = 371,
    ["Docs MCP Manifest"] = 375,
    Dofigen = 376,
    ["Dolittle Artifacts"] = 377,
    ["Dolittle Bounded Context Configuration"] = 378,
    ["Dolittle Event Horizons Configuration"] = 379,
    ["Dolittle Resources Configuration"] = 380,
    ["Dolittle Server Configuration"] = 381,
    ["Dolittle Tenant Map Configuration"] = 383,
    ["Dolittle Tenants Configuration"] = 382,
    ["Dolittle Topology"] = 384,
    ["DonateCaseBetterCasino menu"] = 1331,
    ["Draugr Saga"] = 362,
    ["Draugr Saga fragment"] = 363,
    ["Drupal Breakpoints"] = 264,
    ["Drupal Config"] = 276,
    ["Drupal Info"] = 265,
    ["Drupal Layouts"] = 266,
    ["Drupal Libraries"] = 267,
    ["Drupal Links Action"] = 268,
    ["Drupal Links Contextual"] = 269,
    ["Drupal Links Menu"] = 270,
    ["Drupal Links Task"] = 271,
    ["Drupal Migration"] = 272,
    ["Drupal Permissions"] = 273,
    ["Drupal Recipe"] = 274,
    ["Drupal Routing"] = 275,
    ["Drupal Services"] = 277,
    ["Drush site aliases"] = 390,
    ["Dust configuration"] = 393,
    ["Dynamic Bash Aliases (.aliases)"] = 1238,
    ["EAS config"] = 437,
    ["ECA - Editor Code Assistant"] = 400,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1227,
    ["ESLint Suppressions"] = 442,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1374,
    ["EasyVCR .NET"] = 439,
    ["Eidolon Resource"] = 1315,
    ["Elgato Stream Deck"] = 403,
    Elm = 1302,
    ["Embrace Config"] = 1213,
    Emmet = 1303,
    Endurica = 1251,
    ["Enonic XP API descriptor"] = 406,
    ["Enonic XP Admin Extension descriptor"] = 407,
    ["Enonic XP Admin Tool descriptor"] = 408,
    ["Enonic XP Application descriptor"] = 409,
    ["Enonic XP CMS descriptor"] = 410,
    ["Enonic XP Content Type descriptor"] = 411,
    ["Enonic XP Form Fragment descriptor"] = 412,
    ["Enonic XP ID Provider descriptor"] = 413,
    ["Enonic XP Layout descriptor"] = 414,
    ["Enonic XP Macro descriptor"] = 415,
    ["Enonic XP Mixin descriptor"] = 416,
    ["Enonic XP Page descriptor"] = 417,
    ["Enonic XP Part descriptor"] = 418,
    ["Enonic XP Service descriptor"] = 419,
    ["Enonic XP Site descriptor"] = 420,
    ["Enonic XP Style descriptor"] = 421,
    ["Enonic XP Task descriptor"] = 422,
    ["Enonic XP Webapp descriptor"] = 423,
    ["Enterprise Contract Policy Spec"] = 404,
    ["Envelope Team Definition"] = 1422,
    ["Envilder Map File"] = 405,
    ["Erda Pipeline"] = 1276,
    ["Erda Runtime"] = 1277,
    ["Espanso config.yml"] = 1400,
    ["Espanso match.yml"] = 1399,
    Esquio = 425,
    ["Estuary Flow Catalog"] = 1191,
    ["Ethereum ERC1155"] = 1416,
    ["Ethereum ERC721"] = 1415,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 430,
    ["EveryVoice TTS Toolkit Data Configuration"] = 431,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 435,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 434,
    ["EveryVoice TTS Toolkit Text Configuration"] = 432,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 433,
    ["Evolving Resolutive Process notation"] = 1376,
    ["Expo SDK"] = 436,
    ["Expoot app config"] = 438,
    ["F-Droid Data metadata"] = 444,
    ["FasterCI Configuration"] = 138,
    Fatou = 139,
    ["Fence configuration"] = 140,
    FiQuS = 448,
    Firebase = 446,
    ["Flatpak Builder Manifest"] = 449,
    ["FlexGet Config"] = 450,
    ["Flow.json Configurations"] = 1273,
    ["Fossa configuration file"] = 457,
    ["Fossa's fossa-deps file"] = 458,
    ["Foundry VTT - Base package Manifest"] = 452,
    ["Foundry VTT - Module Manifest"] = 453,
    ["Foundry VTT - System Data Template"] = 456,
    ["Foundry VTT - System Manifest"] = 454,
    ["Foundry VTT - World Manifest"] = 455,
    ["Foxx Manifest"] = 141,
    ["Freifunk.de Community API"] = 144,
    ["Frogbot Config"] = 145,
    ["G2P Mapping Configuration"] = 465,
    GAMA = 466,
    ["GCP Blueprint Metadata"] = 469,
    Gaspar = 467,
    ["GatewayCore API Gateway"] = 468,
    ["Gemini CLI settings"] = 470,
    ["GeoJSON.json latest"] = 1189,
    GherKing = 1193,
    ["GitHub Action"] = 480,
    ["GitHub Actions typing"] = 1311,
    ["GitHub CLI configuration"] = 481,
    ["GitHub CLI hosts"] = 482,
    ["GitHub Discussion"] = 483,
    ["GitHub Funding"] = 485,
    ["GitHub Issue Template configuration"] = 486,
    ["GitHub Issue Template forms"] = 487,
    ["GitHub Pages Jekyll"] = 488,
    ["GitHub Prompt"] = 484,
    ["GitHub Secret Scanning"] = 489,
    ["GitHub Workflow"] = 490,
    ["GitHub Workflow Template Properties"] = 491,
    ["GitHub automatically generated release notes configuration"] = 492,
    ["GitLab Agent for Kubernetes configuration"] = 1265,
    ["GitLab Duo Workflow"] = 494,
    GitResume = 496,
    GitVersion = 473,
    ["Gitea Issue Template configuration"] = 476,
    ["Gitea Issue Template forms"] = 477,
    Gitleaks = 474,
    ["Gitpod Configuration"] = 495,
    ["Glamour style"] = 471,
    ["GlazeWM settings"] = 1267,
    ["Global Privacy Control"] = 472,
    Goblet = 1246,
    ["Golangci-lint Configuration"] = 511,
    ["Golangci-lint Custom Plugins Configuration"] = 512,
    ["Google Chrome Related Website Sets"] = 447,
    ["Google Cloud Workflows"] = 318,
    ["Google Digital Assetlinks"] = 1355,
    Goreleaser = 516,
    ["Goreleaser Pro"] = 517,
    Goss = 519,
    ["Gradle Build Cache Node"] = 1139,
    ["Gradle Enterprise"] = 1138,
    ["Grafana 5.x Dashboard"] = 520,
    ["GraphQL Code Generator"] = 525,
    ["GraphQL Config"] = 524,
    ["GraphQL Mesh"] = 523,
    ["GroovyLint configuration"] = 526,
    ["Grunt JSHint task"] = 530,
    ["Grunt Watch task"] = 531,
    ["Grunt base task"] = 532,
    ["Grunt clean task"] = 528,
    ["Grunt copy task"] = 527,
    ["Grunt cssmin task"] = 529,
    HEMTT = 1103,
    Hadolint = 1117,
    Hammerkit = 1149,
    ["Hardware Sentry Configuration"] = 1205,
    ["Hashgraph Online Skill Manifest"] = 9,
    ["HashiCorp Vault"] = 533,
    Hatch = 1118,
    Hayson = 535,
    ["Haystack Pipeline"] = 536,
    ["Hazelcast 5 Configuration"] = 537,
    ["Hecate Input Schema"] = 1366,
    ["Helm Chart.lock"] = 279,
    ["Helm Chart.yaml"] = 278,
    ["Helm Unittest Test Suite"] = 280,
    ["Heloisa Assistant Plugins Marketplace"] = 1449,
    ["Hex file"] = 281,
    ["Home Assistant Integration Manifest"] = 539,
    ["Homer dashboard configuration"] = 540,
    ["Hoverfly Simulation"] = 545,
    Hugo = 1181,
    ["Hugo Theme"] = 1180,
    ["Hulak Configuration"] = 548,
    ["Hyperfoil benchmark configuration"] = 547,
    ["IBM Zapp document"] = 549,
    ["IBM zCodeFormatSettings"] = 550,
    ["IMG Catapult PSP"] = 555,
    ["IVMS101 by CODE Protocol"] = 1266,
    ["Infinispan Configuration"] = 557,
    ["Infinispan Server Configuration"] = 558,
    Infrahub = 559,
    Istanbul = 1209,
    ["JDownloader2 crawler multi-rules"] = 573,
    ["JDownloader2 crawler single-rules"] = 572,
    ["JFrog Applications Config"] = 574,
    ["JFrog File Spec"] = 575,
    ["JFrog Pipelines YML DSL"] = 1215,
    ["JMeter DSL cli config"] = 576,
    JReleaser = 579,
    ["JSON Document Transform"] = 587,
    ["JSON Feed"] = 588,
    ["JSON Resume"] = 865,
    ["JSON Schema Draft 2020-12"] = 1083,
    ["JSON Schema Draft 4"] = 1080,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1248,
    ["JSON Schema Draft 7"] = 1081,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1249,
    ["JSON Schema Draft 8 (2019-09)"] = 1082,
    ["JSON-API"] = 586,
    ["JSON-e templates"] = 1146,
    ["JSON-stat 2.0"] = 1076,
    JSONPatch = 590,
    ["JSR Package Config (jsr.json)"] = 580,
    Jarl = 1382,
    Jasmine = 567,
    Jekyll = 568,
    ["Jenkins X Pipelines"] = 569,
    ["Jenkins X Requirements"] = 570,
    Jest = 571,
    Jocker = 577,
    ["Jovo Language Models"] = 578,
    Jsontron = 591,
    ["Jujutsu (jj) VCS config"] = 1368,
    ["KIMMDY config file"] = 602,
    ["KODE/CI build.yaml"] = 1211,
    ["KSP-AVC"] = 1077,
    ["KSP-CKAN"] = 1078,
    ["KSP-NetKAN"] = 1079,
    KSY = 1278,
    KSail = 463,
    ["KYA Manifest"] = 1279,
    ["Karakum configuration file"] = 459,
    Kas = 594,
    ["Kestra flow file"] = 603,
    ["Keycloak REST API"] = 1218,
    ["Knative Functions - func.yaml"] = 460,
    Knip = 461,
    ["Knip JSONC"] = 462,
    ["Knowledge Unit"] = 611,
    ["Kometa (nightly) config file"] = 605,
    ["Kometa config file"] = 604,
    ["Kong DBLess config"] = 1212,
    KrakenD = 606,
    ["Kubri Configuration"] = 614,
    LOOBin = 632,
    ["Lake configuration file"] = 1371,
    ...
    ["Lando (landofile)"] = 130,
    ["LangGraph Platform configuration"] = 1290,
    ["Language configuration"] = 1289,
    Lefthook = 619,
    ["Liferay client-extension.yaml"] = 626,
    ["LinkML Metamodel"] = 628,
    ["LiquiLens Evidence Carrier Reference v1"] = 630,
    ["LiquiLens Evidence Carrier v1"] = 629,
    Liquibase = 1156,
    ["Liquibase Flow File"] = 1157,
    ["Lively Properties"] = 631,
    ["Lobe AI Agent"] = 132,
    Loki = 133,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 675,
    ["MS2Rescore Configuration"] = 683,
    ["MSTest testconfig.json"] = 684,
    ["Madge configuration"] = 638,
    ["Madness (madness.yml)"] = 1229,
    ["Mado configuration"] = 639,
    ["Maestro Flow"] = 640,
    ["Mail Servers Configuration"] = 1403,
    ["MapEHR Mapping"] = 641,
    Markdownlint = 1160,
    ["Mason Registry"] = 1163,
    ["MegaLinter Custom Flavor"] = 644,
    ["MegaLinter configuration"] = 643,
    ["MegaLinter descriptor"] = 645,
    Melange = 1256,
    ["Meltano project definition"] = 646,
    ["Mergify Configuration"] = 685,
    ["Mermaid config"] = 4,
    ["Metadata for a Bazel module"] = 647,
    ["Metadata for a Cinnamon spice"] = 1307,
    ["Metatype Configuration"] = 648,
    ["MetricsHub Configuration"] = 649,
    ["MetricsHub Connector Configuration"] = 650,
    ["Micro Editor Syntax"] = 1239,
    ["Microsoft Band Web Tile"] = 651,
    ["Microsoft RulesEngine workflow rules"] = 1294,
    ["Microsoft RulesEngine workflow rules list"] = 1295,
    ["Minecraft Custom Main Menu Mod"] = 1257,
    ["Minecraft Data Pack Advancement"] = 653,
    ["Minecraft Data Pack Biome"] = 654,
    ["Minecraft Data Pack Configured Carver"] = 655,
    ["Minecraft Data Pack Damage Type"] = 656,
    ["Minecraft Data Pack Dimension"] = 658,
    ["Minecraft Data Pack Dimension Type"] = 657,
    ["Minecraft Data Pack Item Modifier"] = 659,
    ["Minecraft Data Pack Loot Table"] = 660,
    ["Minecraft Data Pack Metadata"] = 661,
    ["Minecraft Data Pack Predicate"] = 662,
    ["Minecraft Data Pack Recipe"] = 663,
    ["Minecraft Data Pack Tag"] = 664,
    ["Minecraft Data Pack Template Pool"] = 665,
    ["Minecraft Data Pack Trim Material"] = 670,
    ["Minecraft Data Pack Trim Pattern"] = 671,
    ["Minecraft Resource Pack Lang"] = 666,
    ["Minecraft Resource Pack Particle"] = 667,
    ["Minecraft Resource Pack Texture Mcmeta"] = 669,
    ["Minecraft Resourcepack Sounds"] = 668,
    ["MockServer Expectation"] = 677,
    ["MockServer Expectations"] = 678,
    ModuleAssembler = 673,
    ["Monade CLI Stack Configuration"] = 688,
    ["MongoDB Atlas Search Index Definition"] = 1210,
    ["Monika Configuration"] = 1208,
    ["Monoweave Configuration"] = 682,
    ["Motif config"] = 1099,
    MultiQC = 1348,
    ["NOX Framework (Service)"] = 710,
    ["Netin Diagnostic System Template"] = 1167,
    ["Netlify config"] = 691,
    ["Network-as-Code Data Model"] = 692,
    ["Next Gen UI Agent A2A Server Configuration"] = 693,
    ["Next Gen UI Agent Configuration"] = 695,
    ["Next Gen UI Agent MCP Server Configuration"] = 694,
    ["Nightwatch.js"] = 702,
    ["Nika workflow"] = 707,
    ["Node.js configuration"] = 1104,
    ["NueJS configuration file"] = 715,
    ["Nuitka Package Config"] = 1271,
    ["Nullstone config"] = 717,
    ["ODGS Data Rules"] = 724,
    ["ODGS Ontology Graph"] = 725,
    ["ODGS Standard Metrics"] = 723,
    ["OKF Graph"] = 1450,
    ["ONe's changelog entry"] = 739,
    ["ONe's service descriptor"] = 738,
    ["ORT Server repository environment configuration"] = 750,
    ["OSCAL Assessment Plan (AP)"] = 752,
    ["OSCAL Assessment Results (AR)"] = 753,
    ["OSCAL Catalog"] = 754,
    ["OSCAL Component Definition (CDef)"] = 755,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 756,
    ["OSCAL Profile"] = 757,
    ["OSCAL System Security Plan (SSP)"] = 758,
    ["OSS Review Toolkit configuration"] = 759,
    ["OSS Review Toolkit curation"] = 760,
    ["OSS Review Toolkit package configuration"] = 761,
    ["OSS Review Toolkit project package manager definition"] = 762,
    ["OSS Review Toolkit repository configuration"] = 763,
    ["OSS Review Toolkit resolutions"] = 764,
    ["October CMS columns"] = 721,
    ["October CMS fields"] = 722,
    ["Oh My Posh"] = 727,
    Okteto = 728,
    ["Ona Tasks and Services"] = 730,
    Opctl = 1102,
    ["Open Data Contract Standard (ODCS)"] = 743,
    ["Open Data Product Standard (ODPS)"] = 744,
    ["Open Know-How"] = 1353,
    ["Open Pentest Format"] = 745,
    OpenDecree = 1420,
    ["OpenDecree Configuration"] = 1421,
    ["OpenRewrite Resource"] = 741,
    OpenSRM = 746,
    OpenStatus = 1364,
    ["OpenTelemetry Declarative Configuration"] = 742,
    ["OpenUtau character yaml"] = 735,
    ["OpenUtau ustx"] = 736,
    ["OpenWeather Current Weather API"] = 1145,
    ["OpenWeather Road Risk API"] = 1144,
    ["Ory Hydra configuration"] = 546,
    ["Ory Keto configuration"] = 610,
    ["Ory Kratos configuration"] = 751,
    ["Ory Oathkeeper configuration"] = 719,
    ["Outblocks App configuration"] = 748,
    ["Outblocks database table"] = 749,
    ["Outblocks project configuration"] = 747,
    PDM = 772,
    POPxf = 784,
    ["POPxf Correlations"] = 785,
    ["PRML manifest"] = 792,
    Packer = 768,
    PactSpec = 769,
    Panache = 770,
    Pantsbuild = 1225,
    ["Paper paper-plugin.yml"] = 771,
    ["Pipeline component"] = 1158,
    ["Platform.sh application"] = 15,
    ["Platform.sh routes"] = 16,
    ["Platform.sh services"] = 17,
    ["Plex Prerolls"] = 782,
    ["PocketMine plugin.yml"] = 779,
    ["Podman Desktop Extension"] = 1440,
    ["Postman collection"] = 788,
    ["Power Pages Configuration"] = 1365,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1310,
    ["ProActions AI-Kit Configuration"] = 800,
    ["ProActions AI-Kit Configuration for Menus"] = 802,
    ["ProActions AI-Kit Configuration for Sections"] = 804,
    ["ProActions AI-Kit Configuration for Services"] = 801,
    ["ProActions AI-Kit Configuration for Steps"] = 805,
    ["ProActions AI-Kit Configuration for Templates"] = 803,
    ["Problem object RFC9457"] = 1254,
    ["Problem package format"] = 806,
    ["Problem package generators"] = 807,
    ["Problem package submissions"] = 808,
    ["Problem package test group metadata"] = 809,
    Pterodactyl = 1204,
    ["Pull Request Labeler"] = 826,
    Pulumi = 834,
    ["PyGTA Config"] = 830,
    PyProject = 835,
    Pylock = 1356,
    Pyright = 836,
    ["Python script metadata"] = 1350,
    ["QType AI DSL"] = 839,
    Qgoda = 838,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1432,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1430,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1436,
    ["Qlik Talend Cloud Pipeline - Project"] = 1428,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1431,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1433,
    ["Qlik Talend Cloud Pipeline - Task"] = 1429,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1435,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1434,
    Qodana = 1177,
    ["Qt Creator workspace file"] = 1287,
    ["Quali Torque Blueprint Spec 2"] = 1202,
    ["QueryFirst config file"] = 1221,
    ["QuikRun Configuration"] = 1437,
    ["Qwen Code Settings"] = 1417,
    ["RKE Cluster Configuration JSON"] = 1155,
    ["RKE Cluster Configuration YAML"] = 1154,
    RadioHound = 829,
    ["Raid Profile"] = 1418,
    ["Raid Repo Configuration"] = 1419,
    Railpack = 841,
    Railway = 840,
    ["Rancher Fleet"] = 831,
    ["Rattler-build"] = 842,
    Ray = 1116,
    ["Read the Docs"] = 833,
    ["Red-DiscordBot Cog"] = 849,
    ["Red-DiscordBot Cog Repo"] = 850,
    ["Red-DiscordBot Trivia"] = 851,
    ["Releasaurus Config"] = 12,
    ReleaseKit = 11,
    ["Render Blueprints"] = 1153,
    RenderCV = 869,
    Renovate = 866,
    ["Renovate global configuration"] = 867,
    ["Renovate inherited configuration"] = 868,
    ["Replit config"] = 857,
    Restate = 1343,
    ["Revel Digital Gadget Definition File"] = 1367,
    RoadRunner = 871,
    ["Robust Station Image"] = 1373,
    Rockcraft = 872,
    ["Roo Coder Custom Modes"] = 873,
    Rubocop = 862,
    ["Rudder techniques"] = 1261,
    Ruff = 863,
    ["Rust Project"] = 864,
    ["Rust toolchain"] = 878,
    ["SDMX data message"] = 905,
    ["SDMX metadata message"] = 904,
    ["SDMX structure message"] = 903,
    ["SIL Kit Participant Configuration"] = 916,
    ["SIL Kit Registry Configuration"] = 917,
    ["SPDX 2.3"] = 959,
    SWADL = 975,
    ["Safebox Config"] = 1216,
    ["Sapphire CLI Config"] = 881,
    ["SauceCTL Configuration"] = 1164,
    Scarb = 901,
    ["Schema Catalog"] = 896,
    ["Scoop manifest"] = 902,
    ["Secure SDLC Evidence Bundle"] = 906,
    ["Semantic Data Fabric (SDF) file"] = 907,
    ["Semgrep Rule"] = 909,
    ["Serenity Code Generator (Sergen)"] = 910,
    ["Serverless Framework Configuration"] = 1171,
    ["Serverless Workflow"] = 1173,
    ["Settings for a Cinnamon spice"] = 1306,
    ["Settings.paf"] = 912,
    ["Shopware 6 Configuration"] = 1174,
    ["Shopware CLI Extension Store Configuration"] = 1175,
    ["Shopware CLI Project Store Configuration"] = 1176,
    ["Sigma Detection Rule"] = 914,
    ["SigmaCV CV"] = 7,
    ["Sigrid scope configuration file"] = 915,
    ["SkyPilot Task JSON"] = 1262,
    ["Slack app manifest"] = 922,
    ["Slang Server Configuration"] = 1444,
    Snapcraft = 924,
    ["Solarxy project config"] = 927,
    Solidarity = 928,
    ["Solution filters"] = 929,
    ["Source Maps v3"] = 930,
    Sourcery = 931,
    ["Spack bootstrap.yaml"] = 932,
    ["Spack cdash.yaml"] = 933,
    ["Spack ci.yaml"] = 934,
    ["Spack compilers.yaml"] = 935,
    ["Spack concretizer.yaml"] = 936,
    ["Spack config.yaml"] = 937,
    ["Spack definitions.yaml"] = 938,
    ["Spack develop.yaml"] = 939,
    ["Spack env_vars.yaml"] = 940,
    ["Spack environment"] = 946,
    ["Spack include.yaml"] = 941,
    ["Spack mirrors.yaml"] = 942,
    ["Spack modules.yaml"] = 943,
    ["Spack packages.yaml"] = 944,
    ["Spack repos.yaml"] = 945,
    ["Spack toolchains.yaml"] = 947,
    ["Spack upstreams.yaml"] = 948,
    ["Spack view.yaml"] = 949,
    ["Speakeasy Generation Config File"] = 953,
    ["Speakeasy Lint Configuration File"] = 950,
    ["Speakeasy Test Generation Configuration File"] = 951,
    ["Speakeasy Workflow File"] = 952,
    SpecIF = 954,
    ["Specmatic Configuration"] = 955,
    ["Specpin spec file"] = 5,
    ["Sponge Mixin configuration"] = 956,
    ["Spotlight Ruleset"] = 957,
    StackBlitz = 963,
    ["StackHawk Scanner Configuration"] = 1170,
    Stale = 964,
    Starfish = 965,
    ["Starlake Data Pipeline"] = 1142,
    Starship = 966,
    ["Statamic Blueprint"] = 967,
    ["Stella configuration file"] = 968,
    ["Streamlit configuration file"] = 969,
    ["Stryker Mutator"] = 972,
    ["StyleCop Analyzers Configuration"] = 973,
    ["Stylelint (.stylelintrc)"] = 974,
    ["Stylua Config"] = 1357,
    ["Sublime Syntax"] = 1217,
    ["Subsquid squid manifest"] = 1264,
    ["Swagger API 2.0"] = 976,
    ["Symfony Routing Configuration"] = 977,
    ["Symfony Serializer Mapping"] = 978,
    ["Symfony Services Configuration"] = 979,
    ["Symfony Validation Mapping"] = 980,
    ["Synadia Connect Component"] = 981,
    TSON = 1024,
    TSTyche = 1025,
    ["TYPO3 Vendor Bundler config"] = 1031,
    ["Tab data for a LinUtil"] = 1313,
    ["Tab list for a LinUtil"] = 1312,
    Tach = 982,
    ["Tach Domain"] = 983,
    Talhelper = 985,
    ["Talisman configuration"] = 986,
    Taplo = 1358,
    ["Taskfile config"] = 1147,
    Taurus = 987,
    Tauticord = 988,
    ["Tekton Pipeline"] = 1386,
    ["Tekton PipelineRun"] = 1387,
    ["Tekton Task"] = 1384,
    ["Tekton TaskRun"] = 1385,
    Telefonistka = 1344,
    ["Terraform PowerShell provider block manifest"] = 991,
    ["Terraform PowerShell provider data source manifest"] = 992,
    ["Terraform PowerShell provider resource manifest"] = 993,
    ["Terraform PowerShell provider settings"] = 994,
    ["Terrateam config"] = 1370,
    ["Tesseract configuration"] = 995,
    ["TestEnvironment.json"] = 1005,
    ["TextMate Grammar"] = 1004,
    Threagile = 999,
    ["Tier.run pricing.json"] = 996,
    Tikibase = 997,
    Tombi = 1002,
    ["Traefik v2"] = 1008,
    ["Traefik v2 File Provider"] = 1009,
    ["Traefik v3"] = 1010,
    ["Traefik v3 File Provider"] = 1011,
    ["Travis CI (.travis.yml)"] = 1007,
    Treefmt = 522,
    Trident = 1340,
    Trivy = 1014,
    ["TrueScript for *.tscript files"] = 1015,
    ["Tugboat QA config.yml"] = 1337,
    TunnelHub = 1252,
    Turborepo = 1006,
    Tycho = 1301,
    Tye = 1178,
    ["Tyk Gateway - Open Source v5.7+"] = 1349,
    ["UET BuildConfig.json"] = 1222,
    ["UI5 Manifest"] = 1037,
    ["UNCORS configuration"] = 1042,
    ["UTAM Page Object"] = 1040,
    ["Ubuntu Server Autoinstall"] = 1035,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1341,
    ["Uniswap Token List"] = 1127,
    ["Universal Schedule Format"] = 1043,
    ["Unreal Engine Uplugin"] = 1223,
    ["Unreal Engine Uproject"] = 1224,
    ["UpCloud CLI (upctl) configuration"] = 1342,
    ["Updatecli Compose"] = 1186,
    ["Updatecli Policy Manifest"] = 1187,
    ["Updatecli Policy Metadata"] = 1188,
    Uplift = 1220,
    ["Upsun config"] = 14,
    ["User Journey Map"] = 1152,
    V2Ray = 1192,
    ["VSCode Code Snippets"] = 306,
    ["VSIX CLI publishing"] = 1063,
    Vector = 1045,
    ["Vee JSON menu output"] = 1046,
    ["Vela Pipeline Configuration"] = 1049,
    Vercel = 305,
    ["Version Bumper config"] = 1052,
    Vespertide = 1391,
    ["Vespertide Migration"] = 1392,
    ["Vespertide Model"] = 1393,
    ["Viash Component Config"] = 1346,
    ["Viash Package Config"] = 1347,
    Visivo = 1250,
    Vogi = 1057,
    ["WP-CLI"] = 1073,
    Wake = 1339,
    ["Waku Config"] = 1316,
    ["Web App Manifest"] = 1069,
    ["Web types"] = 1072,
    WebExtensions = 1068,
    ["Webman package recipe"] = 1198,
    ["Windows Package Manager Installer Manifest"] = 1124,
    ["Windows Package Manager Locale Manifest"] = 1125,
    ["Windows Package Manager Singleton Manifest"] = 1123,
    ["WireMock CLI import configuration"] = 1322,
    ["WireMock CLI local service configuration"] = 1321,
    ["WireMock message stub mapping"] = 1320,
    ["WireMock stub mapping"] = 1319,
    ["Woodpecker pipeline config"] = 1166,
    ["Wrangler CLI"] = 1074,
    ["XenForo add-on manifest"] = 1075,
    ["Xstate Machine"] = 1184,
    ["Yandex Workflow Language"] = 1308,
    ["Yarn Config (.yarnrc.yml)"] = 1140,
    ["Yippee-Ki-JSON configuration YML"] = 1131,
    ["YouTrack App"] = 1305,
    ["Zarf Package Configuration"] = 1372,
    ["Zerops import file"] = 1293,
    ["Zola Configuration"] = 1383,
    abtop = 35,
    act3 = 1424,
    actionlint = 45,
    ["aerleon.yml"] = 29,
    ["amplify.yml"] = 22,
    ["amxx-builder manifest"] = 1439,
    ["angular.json"] = 50,
    apko = 1255,
    ...
    ["behat.yml"] = 172,
    ["bigquery-table"] = 157,
    ["bioimageio resource description"] = 1272,
    ...
    ["cargo-nextest repository configuration"] = 696,
    ["cargo-nextest user configuration"] = 697,
    ["ccmod.json"] = 1317,
    ["cfgd Config"] = 1445,
    ["cfgd ConfigSource"] = 1448,
    ["cfgd Module"] = 1446,
    ["cfgd Profile"] = 1447,
    changelogging = 1284,
    ...
    ["chutzpah.json"] = 314,
    cibuildwheel = 210,
    ["clang-format (.clang-format)"] = 1190,
    ["clang-tidy"] = 287,
    clangd = 286,
    clib = 288,
    ["cloud-init: cloud-config userdata"] = 290,
    ...
    ["crowdin.yml"] = 341,
    crucible = 345,
    ["ctfd-setup configuration file"] = 1329,
    ["custom-elements.json"] = 1242,
    ["cypress.json"] = 346,
    ["dacier.yml"] = 1427,
    ["datalogic-scan2deploy-android"] = 357,
    ["datalogic-scan2deploy-ce"] = 358,
    ["dbt Dependencies"] = 246,
    ["dbt Packages"] = 248,
    ["dbt Project"] = 247,
    ["dbt Selectors"] = 249,
    ["dbt YAML files"] = 250,
    ...
    ["ddev-global"] = 359,
    ["ddev-project"] = 360,
    ["debugsettings.json"] = 361,
    ["dependabot-v2.json"] = 366,
    ["dependabot.json"] = 365,
    ["deployed-cli"] = 1183,
    devconcurrent = 263,
    ["devcontainer-feature.json"] = 298,
    ["devcontainer.json"] = 297,
    devinit = 1133,
    ["devspace.yaml"] = 1206,
    djlint = 1134,
    ["docker bake"] = 372,
    ["docker sequencer"] = 373,
    ["docker-compose.yml"] = 1132,
    ["dockerd.json"] = 370,
    ["dotnet Release Index manifest"] = 385,
    ["dotnet-tools.json"] = 386,
    ["dotnetcli.host.json"] = 387,
    ["dprint.json"] = 388,
    ["drone.json"] = 389,
    ["dss-2.0.0.json"] = 391,
    ["dstack configuration"] = 392,
    ["dtool dataset metadata"] = 1324,
    ["dvc.yaml"] = 394,
    ["ecosystem.json"] = 399,
    ["editorconfig-checker"] = 401,
    eksctl = 402,
    ["electron-builder configuration file"] = 428,
    ["epr-manifest.json"] = 427,
    ["estampo.toml"] = 426,
    ["evcc.yaml"] = 429,
    ["ezd task runner"] = 440,
    ["fabric.mod.json"] = 443,
    ["first-timers-bot"] = 451,
    ["flagd flag configuration"] = 142,
    ["fly.io Configuration"] = 143,
    fulibWorkflows = 1165,
    ["function.json"] = 464,
    ["gRPC API Gateway & OpenAPI Config"] = 24,
    ["gematik health care insurance list"] = 1335,
    ["gematik health care patient list"] = 1332,
    ["gematik health care provider institution list"] = 1334,
    ["gematik health care provider list"] = 1333,
    ["gematik tiger test environment configuration"] = 1336,
    ["gh-dash"] = 478,
    ["gha-doctor"] = 479,
    ["git-cliff"] = 475,
    ["git-town.toml"] = 1381,
    ["github-settings-as-code"] = 858,
    ["gitlab-ci"] = 493,
    ["global.json"] = 510,
    ["glslint config"] = 3,
    ["go-feature-flag Flag Configuration"] = 514,
    ["gojo.yaml"] = 515,
    gollama = 513,
    ["hassette.toml"] = 538,
    ["haxelib.json"] = 534,
    ...
    ["ide.host.json"] = 551,
    ["ifstate.yaml"] = 552,
    ["imageoptimizer.json"] = 553,
    ["importmap.json"] = 556,
    ["index.toml (packwiz)"] = 1441,
    instant_python_config = 560,
    instant_python_custom_project = 561,
    intlayer = 562,
    ["ioBroker Configuration"] = 563,
    ["ioBroker JSON UI"] = 564,
    ["ioBroker Package manifest"] = 565,
    ["ixpect.conf.yaml"] = 566,
    ["ize.toml"] = 1219,
    ["jsconfig.json"] = 592,
    ["jscpd Configuration"] = 1203,
    jsdoc = 1115,
    ["k3d.yaml"] = 593,
    ["k9s aliases.yaml"] = 595,
    ["k9s cluster-config.yaml"] = 597,
    ["k9s config.yaml"] = 596,
    ["k9s hotkeys.yaml"] = 598,
    ["k9s plugins.yaml"] = 599,
    ["k9s skin.yaml"] = 600,
    ["k9s views.yaml"] = 601,
    ["kind cluster"] = 615,
    ["kontinuous-config.yaml"] = 613,
    ["kontinuous-values.yaml"] = 612,
    ["kustomization.yaml"] = 616,
    ["label-commenter-config.yml"] = 617,
    ...
    ["lerna.json"] = 621,
    ["lgtm.yml"] = 622,
    ["liblab.config.json"] = 623,
    ["libman.json"] = 624,
    ["license-report-config.json"] = 625,
    ["linkinator.config.json"] = 627,
    ["lint-staged (.lintstagedrc)"] = 1092,
    ["local.settings.json"] = 634,
    ["localazy.json"] = 635,
    ["lotus.yaml"] = 633,
    ["lsd colors"] = 135,
    ["lsd config"] = 134,
    ...
    lychee = 1091,
    ["macro.json"] = 1207,
    ["markdown-link-check"] = 1161,
    maturin = 1162,
    mboats = 1169,
    memnex = 1425,
    ["micro-settings.json"] = 1234,
    ["mimetypes.json"] = 652,
    ["mirrord config"] = 1095,
    ["misata.yaml"] = 1094,
    mise = 1096,
    ["mkdocs.yml"] = 672,
    ["mockd.yaml"] = 676,
    ["mod.pw.toml (packwiz)"] = 1442,
    ["modelparams.dev Model"] = 679,
    ["models CLI"] = 680,
    ["monospace.yml"] = 681,
    ["moon.yml"] = 1318,
    ["mprocs Configuration file"] = 1288,
    ["mrdocs.yml"] = 674,
    ["mta.yaml"] = 1097,
    ["mtad.yaml"] = 1098,
    ["mycode.json"] = 689,
    nFPM = 701,
    ["napari plugin manifest"] = 690,
    neoload = 1110,
    ["nest-cli"] = 704,
    ["nexus-rpc-gen"] = 1408,
    ["nf-core module environment.yml"] = 698,
    ["nf-core module meta.yml"] = 699,
    ["nf-core subworkflow meta.yml"] = 700,
    ["ninjs (News in JSON)"] = 703,
    ["nitro.json"] = 1109,
    ["nixd configuration"] = 1260,
    ["nlu.json"] = 705,
    ["nodemon.json"] = 708,
    ["noodl config"] = 1168,
    ["notebook.mod.json"] = 709,
    now = 1105,
    ["npm-badges"] = 712,
    ["nswag.json"] = 716,
    ntangle = 718,
    ["nuclei-template.yaml"] = 713,
    ["nuget-project.json"] = 714,
    ["ocelot.json"] = 720,
    ogen = 726,
    ["omnisharp.json"] = 729,
    openHAB = 1394,
    ...
    oxfmt = 1404,
    oxlint = 1405,
    ["pack.toml (packwiz)"] = 1443,
    ["package.json"] = 765,
    ["package.manifest"] = 767,
    ["package.yaml"] = 766,
    ["partial-black.json"] = 173,
    ["partial-fastapi.json"] = 174,
    ["partial-pixi.json"] = 777,
    ["partial-scheduled.json"] = 175,
    ["pattern.json"] = 775,
    ["petstore-v1.0"] = 1214,
    pgap_yaml_input_reader = 773,
    pgrls = 774,
    pgxgen = 1398,
    pitcms = 1401,
    ["pixi.toml"] = 776,
    ["plagiarize-me.yaml"] = 781,
    ["plagiarize.yaml"] = 780,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1325,
    ["podbard.yaml"] = 783,
    ["portman.json"] = 786,
    ["prefect.toml"] = 795,
    ["prefect.yaml"] = 796,
    ...
    ["prettierrc.json"] = 798,
    ["prisma.yml"] = 799,
    ["project-1.0.0-beta3.json"] = 811,
    ["project-1.0.0-beta4.json"] = 812,
    ["project-1.0.0-beta5.json"] = 813,
    ["project-1.0.0-beta6.json"] = 814,
    ["project-1.0.0-beta8.json"] = 815,
    ["project-1.0.0-rc1.json"] = 816,
    ["project-1.0.0-rc2.json"] = 817,
    ["project.json"] = 810,
    ["project.owasp.yaml"] = 818,
    ["prometheus-alertmanager.json"] = 822,
    ["prometheus.json"] = 819,
    ["prometheus.rules.json"] = 820,
    ["prometheus.rules.test.json"] = 821,
    ["proxies.json"] = 823,
    ["publiccode.yml"] = 824,
    ["pubspec.yaml"] = 825,
    ["pyrseas-0.8.json"] = 828,
    pytest = 837,
    ["quilt.mod.json"] = 1235,
    ["rc3 auth"] = 843,
    ["rc3 collection"] = 844,
    ...
    ["rc3 settings"] = 848,
    ["registry.yaml"] = 63,
    ["release drafter"] = 1111,
    ["release-hub.json"] = 10,
    ["release-please-config.json"] = 853,
    ["release-please-manifest.json"] = 854,
    ["release-plz.toml"] = 855,
    ["renv.lock"] = 870,
    ["reposets Configuration"] = 859,
    ["reposets Credentials"] = 860,
    ["revola.json"] = 8,
    ["rivet.json"] = 1259,
    ["rivet.yaml (legacy)"] = 1258,
    rumdl = 875,
    runny = 874,
    runspec = 1426,
    rustfmt = 876,
    ...
    samt = 879,
    samtrc = 880,
    ["sarif-1.0.0.json"] = 882,
    ["sarif-2.0.0.json"] = 883,
    ["sarif-2.1.0"] = 893,
    ["sarif-2.1.0-rtm.2"] = 884,
    ["sarif-2.1.0-rtm.3"] = 886,
    ["sarif-2.1.0-rtm.4"] = 888,
    ["sarif-2.1.0-rtm.5"] = 890,
    ["sarif-2.1.0-rtm.6"] = 891,
    ["sarif-external-property-file-2.1.0"] = 894,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 885,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 887,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 889,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 892,
    ["scalingo.json configuration"] = 895,
    ["schema.org - Action"] = 897,
    ["schema.org - ContactPoint"] = 898,
    ["schema.org - Place"] = 899,
    ["schema.org - Thing"] = 900,
    ["secrethub.yml"] = 1237,
    ["semantic-release"] = 908,
    servercn = 1454,
    ["servicehub.config.json"] = 1086,
    ["servicehub.service.json"] = 1085,
    ["settings.job"] = 911,
    ["sfdx-hardis configuration"] = 913,
    ["shard.yml"] = 1275,
    ["size-limit configuration"] = 918,
    ["skaffold.yaml"] = 1159,
    ["skill-map plugin extension manifest"] = 919,
    ["skill-map project settings"] = 920,
    ["skill-map provider kind"] = 921,
    ["skyuxconfig.json"] = 923,
    ["snowflake-config"] = 925,
    ["snowflake-connections"] = 926,
    ["spicepod.yaml"] = 1296,
    ["sqlc configuration"] = 960,
    ["stripe-app-local.json"] = 971,
    ["stripe-app.json"] = 970,
    swcrc = 1143,
    ["task.json"] = 984,
    taskcat = 1106,
    ["template.json"] = 989,
    ["templatsources.json"] = 990,
    ["text2confl config"] = 1406,
    ["theme.json"] = 998,
    ["tizen_workspace.json"] = 1000,
    tldr = 1001,
    ["tm_devices configuration file"] = 1363,
    tmuxinator = 1089,
    tox = 1003,
    ["transcend.yml"] = 1012,
    ["tree-sitter grammar.json"] = 521,
    ["trime.yaml"] = 1013,
    ["trunk.yaml"] = 1016,
    ["ts-force-config.json"] = 1022,
    tsbuild = 1017,
    ["tsconfig.json"] = 1018,
    ["tsd.json"] = 1019,
    ["tsdoc.json"] = 1020,
    ...
    ["vega-lite.json"] = 1048,
    ["vega.json"] = 1047,
    ["venvironment.yaml"] = 1050,
    ["venvplus.yaml"] = 1051,
    version = 1345,
    ["version.json"] = 1053,
    ["vhwdebugger-binding.yaml"] = 1055,
    ["vim-addon-info"] = 1056,
    ["vs-2017.3.host.json"] = 1059,
    ["vs-nesting.json"] = 1060,
    ["vsls.json"] = 1058,
    ["vss-extension.json"] = 1064,
    vtcfg = 1351,
    ["vtesttree.yaml"] = 1065,
    ["vtestunit.yaml"] = 1066,
    ["warp-keysets.json"] = 1243,
    ["warp-themes.json"] = 1244,
    ["warp-workflows.json"] = 1245,
    ["webhint.io"] = 1199,
    ["webjobpublishsettings.json"] = 1071,
    ["webjobs-list.json"] = 1070,
    ["well-known-fursona"] = 1283,
    ["xs-app.json"] = 1101,
    ["xunit.runner.json"] = 1084,
    ["yaml-workflow"] = 1453,
    yamlfmt = 1128,
    yamllint = 1129,
    ["yap.json"] = 1130,
