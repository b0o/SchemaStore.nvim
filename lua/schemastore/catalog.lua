...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 102,
    [".cryproj (generic)"] = 401,
    [".cryproj engine-5.2"] = 396,
    [".cryproj engine-5.3"] = 397,
    [".cryproj engine-5.4"] = 398,
    [".cryproj engine-5.5"] = 399,
    [".cryproj engine-dev"] = 400,
    [".csscomb.json"] = 104,
    [".csslintrc"] = 105,
    [".eslintrc"] = 140,
    [".esmrc.json"] = 133,
    ...
    [".mtaext"] = 407,
    [".nodehawkrc"] = 246,
    [".npmpackagejsonlintrc"] = 248,
    [".phraseapp.yml"] = 275,
    [".pmbot.yml"] = 268,
    [".postcssrc"] = 273,
    [".pre-commit-config.yml"] = 274,
    [".putout.json"] = 292,
    [".rehyperc"] = 297,
    [".remarkrc"] = 298,
    [".sprite files"] = 333,
    ...
    [".vsext"] = 377,
    [".yarnrc.yml"] = 439,
    ["<div>RIOTS' studio configuration"] = 380,
    ["API Builder"] = 436,
    ["AWS CloudFormation"] = 92,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 93,
    ...
    ["Azure Pipelines"] = 36,
    ["Azure Static Web Apps CLI configuration file"] = 335,
    ["Azure Static Web Apps configuration file"] = 334,
    ["Better Code Hub"] = 441,
    BizTalkServerApplicationSchema = 413,
    ["Block Protocol Metadata"] = 62,
    Briefcase = 418,
    Buildkite = 57,
    ...
    CityJSON = 67,
    ["Code Climate"] = 72,
    ["Container Structure Test"] = 424,
    Containerlab = 449,
    ["Dart build configuration"] = 106,
    ["Dart test config"] = 107,
    ["Deployer Recipe"] = 113,
    Devfile = 131,
    ["Discord Webhook"] = 115,
    ["Dolittle Artifacts"] = 117,
    ["Dolittle Bounded Context Configuration"] = 118,
    ["Dolittle Event Horizons Configuration"] = 119,
    ["Dolittle Resources Configuration"] = 120,
    ["Dolittle Server Configuration"] = 121,
    ["Dolittle Tenant Map Configuration"] = 123,
    ["Dolittle Tenants Configuration"] = 122,
    ["Dolittle Topology"] = 124,
    ["Drush site aliases"] = 128,
    ["Error pages"] = 136,
    Esquio = 134,
    ["Expo SDK"] = 139,
    ["F-Droid Data metadata"] = 143,
    ["Facets - FSDL - Application"] = 141,
    ["Fossa configuration file"] = 148,
    ["Foundry VTT - Manifest"] = 146,
    ["Foundry VTT - Template"] = 147,
    ["Foxx Manifest"] = 37,
    ["GatewayCore API Gateway"] = 151,
    ["GitHub Action"] = 155,
    ["GitHub Funding"] = 156,
    ["GitHub Issue Template configuration"] = 158,
    ["GitHub Workflow"] = 159,
    ["GitHub Workflow Template Properties"] = 160,
    ["GitHub issue forms"] = 157,
    GitVersion = 154,
    ["Gitpod Configuration"] = 162,
    ["Global Privacy Control"] = 152,
    ["Google Cloud Workflows"] = 91,
    Goreleaser = 165,
    ["Goreleaser Pro"] = 166,
    ["Gradle Build Cache Node"] = 438,
    ["Gradle Enterprise"] = 437,
    ["Grafana 5.x Dashboard"] = 167,
    ["GraphQL Code Generator"] = 170,
    ["GraphQL Config"] = 169,
    ["GraphQL Mesh"] = 168,
    ["Grunt JSHint task"] = 174,
    ["Grunt Watch task"] = 175,
    ["Grunt base task"] = 176,
    ["Grunt clean task"] = 172,
    ["Grunt copy task"] = 171,
    ["Grunt cssmin task"] = 173,
    HEMTT = 410,
    Hadolint = 422,
    ["Hammerkit YAML Schema"] = 448,
    Hayson = 178,
    ["Haystack Pipeline"] = 179,
    ["Hazelcast 5 Configuration"] = 180,
    ["Helm Chart.lock"] = 70,
    ["Helm Chart.yaml"] = 69,
    ["JFrog File Spec"] = 193,
    ["JSON Document Transform"] = 201,
    ["JSON Feed"] = 202,
    ["JSON Resume"] = 300,
    ["JSON Schema Draft 2020-12"] = 392,
    ["JSON Schema Draft 4"] = 389,
    ["JSON Schema Draft 7"] = 390,
    ["JSON Schema Draft 8"] = 391,
    ["JSON schema for CodeShip Pro services configuration files"] = 78,
    ["JSON schema for CodeShip Pro steps configuration files"] = 79,
    ["JSON schema for Codecov configuration files"] = 77,
    ["JSON-API"] = 200,
    ["JSON-e templates"] = 446,
    ["JSON-stat 2.0"] = 386,
    JSONPatch = 204,
    ["Jekyll configuration"] = 190,
    ["Jenkins X Pipelines"] = 191,
    ["Jenkins X Requirements"] = 192,
    ["Jovo Language Models"] = 194,
    ["KSP-AVC"] = 387,
    ["KSP-CKAN"] = 388,
    Liquibase = 453,
    ["MegaLinter configuration"] = 218,
    ["MegaLinter descriptor"] = 219,
    ["Meltano plugin discovery definition"] = 221,
    ["Meltano project definition"] = 220,
    ["Microsoft Band Web Tile"] = 222,
    ["Minecraft Data Pack Advancement"] = 224,
    ["Minecraft Data Pack Biome"] = 225,
    ["Minecraft Data Pack Configured Carver"] = 226,
    ["Minecraft Data Pack Dimension"] = 228,
    ["Minecraft Data Pack Dimension Type"] = 227,
    ["Minecraft Data Pack Item Modifier"] = 229,
    ["Minecraft Data Pack Loot Table"] = 230,
    ["Minecraft Data Pack Metadata"] = 231,
    ["Minecraft Data Pack Predicate"] = 232,
    ["Minecraft Data Pack Recipe"] = 233,
    ["Minecraft Data Pack Template Pool"] = 234,
    ["Minecraft Resourcepack Sounds"] = 235,
    ["Netin Diagnostic System Template"] = 460,
    ["Netlify config schema"] = 240,
    ["Nightwatch.js"] = 241,
    ["OSS Review Toolkit repository configuration"] = 262,
    Opctl = 409,
    ["OpenWeather Current Weather API"] = 445,
    ["OpenWeather Road Risk API"] = 444,
    ["Ory Hydra configuration"] = 184,
    ["Ory Keto configuration"] = 207,
    ["Ory Kratos configuration"] = 261,
    ["Ory Oathkeeper configuration"] = 253,
    ["Outblocks App configuration"] = 259,
    ["Outblocks database table"] = 260,
    ["Outblocks project configuration"] = 258,
    Packer = 265,
    ["Pipeline component"] = 454,
    ["PocketMine plugin.yml"] = 269,
    ["Pull Request Labeler"] = 291,
    Qodana = 467,
    ["RKE Cluster Configuration JSON Schema"] = 452,
    ["RKE Cluster Configuration YAML Schema"] = 451,
    Ray = 421,
    ["Read the Docs"] = 294,
    ["Red-DiscordBot Cog"] = 295,
    ["Red-DiscordBot Cog Repo"] = 296,
    Renovate = 301,
    RoadRunner = 302,
    SWADL = 344,
    ["Sapphire CLI Config"] = 303,
    ["SauceCTL Configuration"] = 457,
    ["Schema Catalog"] = 316,
    ["Scoop manifest"] = 321,
    ["Semgrep Rule"] = 322,
    ["Serverless Framework Configuration"] = 464,
    ["Settings.paf"] = 324,
    ["Shopware CLI Extension Store Configuration"] = 465,
    ["Shopware CLI Project Store Configuration"] = 466,
    Solidarity = 329,
    ["Source Maps v3"] = 330,
    SpecIF = 331,
    ["Sponge Mixin configuration"] = 332,
    ["StackHawk Scanner Configuration"] = 463,
    ["StackHead CLI config"] = 336,
    ["StackHead module configuration"] = 337,
    ["StackHead project definition"] = 338,
    Stale = 339,
    ["Statamic Blueprint"] = 340,
    ["Stryker Mutator"] = 341,
    ["StyleCop Analyzers Configuration"] = 342,
    ["Swagger API 2.0"] = 345,
    ["Taskfile YAML Schema"] = 447,
    Taurus = 346,
    ["TestEnvironment.json"] = 351,
    ["Traefik v2"] = 353,
    ["Traefik v2 File Provider"] = 354,
    Tye = 468,
    ["UI5 Manifest"] = 366,
    ["Ubuntu Server Autoinstall"] = 364,
    ["Uniswap Token List"] = 430,
    ["User Journey Map YAML Schema"] = 450,
    ["VSCode Code Snippets"] = 81,
    ["VSIX CLI publishing"] = 378,
    ["Vela Pipeline Configuration"] = 370,
    Vercel = 80,
    ["Web App Manifest"] = 382,
    ["Web types"] = 385,
    WebExtensions = 381,
    ["Windows Package Manager Installer Manifest"] = 427,
    ["Windows Package Manager Locale Manifest"] = 428,
    ["Windows Package Manager Singleton Manifest"] = 426,
    ["Woodpecker pipeline config"] = 459,
    ["Yippee-Ki-JSON configuration YML"] = 432,
    ["angular.json"] = 6,
    ...
    ["chutzpah.json"] = 87,
    ["cloud-sdk-pipeline-config-schema"] = 89,
    ["cloudbuild.json"] = 90,
    cloudify = 75,
    codemagic = 76,
    ["coffeelint.json"] = 95,
    comet = 442,
    ["commands.json"] = 84,
    ["compile_commands.json"] = 83,
    ["compilerconfig.json"] = 82,
    ["component.json"] = 97,
    ["composer.json"] = 96,
    ["config.json"] = 98,
    ["contentmanifest.json"] = 88,
    ["contribute.json"] = 99,
    ["cosmos.config.json"] = 85,
    ["crowdin.yml"] = 100,
    cspell = 103,
    ["cypress.json"] = 101,
    ["datalogic-scan2deploy-android"] = 108,
    ["datalogic-scan2deploy-ce"] = 109,
    ["debugsettings.json"] = 110,
    ["dependabot-v2.json"] = 112,
    ["dependabot.json"] = 111,
    ["detekt.yml"] = 114,
    devinit = 434,
    ["docfx.json"] = 116,
    ["docker-compose.yml"] = 433,
    ["dotnet Release Index manifest"] = 125,
    ["dotnetcli.host.json"] = 126,
    ["drone.json"] = 127,
    ["dss-2.0.0.json"] = 129,
    ["dvc.yaml"] = 130,
    ["ecosystem.json"] = 132,
    ["electron-builder configuration file."] = 137,
    ["epr-manifest.json"] = 135,
    ["evcc.yaml"] = 138,
    ["fabric.mod.json"] = 142,
    ["first-timers-bot"] = 145,
    fulibWorkflows = 458,
    ["func.yaml"] = 149,
    ["function.json"] = 150,
    ["geojson.json"] = 153,
    ["gitlab-ci"] = 161,
    ["global.json"] = 163,
    ["golangci-lint Configuration"] = 164,
    ["haxelib.json"] = 177,
    helmfile = 423,
    ["host-meta.json"] = 182,
    ["host.json"] = 181,
    ...
    httpmockrc = 414,
    huskyrc = 403,
    ["imageoptimizer.json"] = 185,
    ["importmap.json"] = 187,
    ["ioBroker JSON UI"] = 188,
    ["ioBroker Package manifest"] = 189,
    ["jsconfig.json"] = 205,
    jsdoc = 420,
    ["k3d.yaml"] = 206,
    ["kustomization.yaml"] = 208,
    ["label-commenter-config.yml"] = 209,
    ["launchsettings.json"] = 210,
    ["lerna.json"] = 211,
    ["lgtm.yml"] = 212,
    ["libman.json"] = 213,
    ["license-report-config.json"] = 214,
    ["local.settings.json"] = 215,
    ["localazy.json"] = 216,
    ["lsdlschema.json"] = 217,
    ["markdownlint.json"] = 456,
    mboats = 462,
    ["mimetypes.json"] = 223,
    ["mta.yaml"] = 405,
    ["mtad.yaml"] = 406,
    ["mycode.json"] = 238,
    ["napari plugin manifest"] = 239,
    neoload = 415,
    ["nest-cli"] = 244,
    ["ninjs (News in JSON) 1.3"] = 243,
    ["ninjs (News in JSON) 2.0"] = 242,
    ["nlu.json"] = 245,
    ["nodemon.json"] = 247,
    ["noodl.schema.json"] = 461,
    now = 411,
    ["nswag.json"] = 251,
    ntangle = 252,
    ["nuclei-template.yaml"] = 249,
    ["nuget-project.json"] = 250,
    ["ocelot.json"] = 254,
    ["omnisharp.json"] = 255,
    ["openapi.json"] = 256,
    ["openfin.json"] = 257,
    ["package.json"] = 263,
    ["package.manifest"] = 264,
    ["pattern.json"] = 267,
    pgap_yaml_input_reader = 266,
    ["plagiarize-me.yaml"] = 271,
    ["plagiarize.yaml"] = 270,
    ["portman.json"] = 272,
    ["prettierrc.json"] = 276,
    ["prisma.yml"] = 277,
    ["project-1.0.0-beta3.json"] = 279,
    ["project-1.0.0-beta4.json"] = 280,
    ["project-1.0.0-beta5.json"] = 281,
    ["project-1.0.0-beta6.json"] = 282,
    ["project-1.0.0-beta8.json"] = 283,
    ["project-1.0.0-rc1.json"] = 284,
    ["project-1.0.0-rc2.json"] = 285,
    ["project.json"] = 278,
    ["prometheus.json"] = 286,
    ["prometheus.rules.json"] = 287,
    ["proxies.json"] = 288,
    ["publiccode.yml"] = 289,
    ["pubspec.yaml"] = 290,
    ["pyrseas-0.8.json"] = 293,
    ["release drafter"] = 416,
    ["sarif-1.0.0.json"] = 304,
    ["sarif-2.0.0.json"] = 305,
    ["sarif-2.1.0"] = 314,
    ["sarif-2.1.0-rtm.2"] = 306,
    ["sarif-2.1.0-rtm.3"] = 308,
    ["sarif-2.1.0-rtm.4"] = 310,
    ["sarif-2.1.0-rtm.5"] = 312,
    ["sarif-external-property-file-2.1.0"] = 315,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 307,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 309,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 311,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 313,
    ["schema.org - Action"] = 317,
    ["schema.org - ContactPoint"] = 318,
    ["schema.org - Place"] = 319,
    ["schema.org - Thing"] = 320,
    ["servicehub.config.json"] = 395,
    ["servicehub.service.json"] = 394,
    ["settings.job"] = 323,
    ["sfdx-hardis configuration"] = 325,
    ["size-limit configuration"] = 326,
    ["skaffold.yaml"] = 455,
    ["skyuxconfig.json"] = 327,
    snapcraft = 328,
    swcrc = 443,
    taskcat = 412,
    ["template.json"] = 347,
    ["templatsources.json"] = 348,
    ["theme.json"] = 349,
    tmLanguage = 350,
    ["trunk.yaml schema"] = 355,
    ["ts-force-config.json"] = 359,
    ["tsconfig.json"] = 356,
    ["tsd.json"] = 357,
    ["tsdrc.json"] = 358,
    ["tslint.json"] = 360,
    ...
    ["version.json"] = 371,
    ["vim-addon-info"] = 372,
    ["vs-2017.3.host.json"] = 374,
    ["vs-nesting.json"] = 375,
    ["vsls.json"] = 373,
    ["vss-extension.json"] = 379,
    ["webjobpublishsettings.json"] = 384,
    ["webjobs-list.json"] = 383,
    ["xs-app.json"] = 408,
    ["xunit.runner.json"] = 393,
    yamllint = 431,
    zuul = 417,
    ["Žinoma"] = 425
  },
