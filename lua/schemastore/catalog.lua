...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 108,
    [".cryproj (generic)"] = 412,
    [".cryproj engine-5.2"] = 407,
    [".cryproj engine-5.3"] = 408,
    [".cryproj engine-5.4"] = 409,
    [".cryproj engine-5.5"] = 410,
    [".cryproj engine-dev"] = 411,
    [".csscomb.json"] = 110,
    [".csslintrc"] = 111,
    [".eslintrc"] = 147,
    [".esmrc.json"] = 140,
    ...
    [".mtaext"] = 418,
    [".nodehawkrc"] = 257,
    [".npmpackagejsonlintrc"] = 259,
    [".phraseapp.yml"] = 286,
    [".pmbot.yml"] = 279,
    [".postcssrc"] = 284,
    [".pre-commit-config.yml"] = 285,
    [".putout.json"] = 303,
    [".rehyperc"] = 308,
    [".remarkrc"] = 309,
    [".sprite files"] = 344,
    ...
    [".vsext"] = 388,
    [".yarnrc.yml"] = 450,
    ["<div>RIOTS' studio configuration"] = 391,
    ["API Builder"] = 447,
    ["AWS CDK cdk.json"] = 97,
    ["AWS CloudFormation"] = 98,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 99,
    ...
    ["Azure Pipelines"] = 40,
    ["Azure Static Web Apps CLI configuration file"] = 346,
    ["Azure Static Web Apps configuration file"] = 345,
    ["Better Code Hub"] = 452,
    BizTalkServerApplicationSchema = 424,
    ...
    ["Container Structure Test"] = 435,
    Containerlab = 460,
    ["Dart build configuration"] = 112,
    ["Dart test config"] = 113,
    Deno = 117,
    ["Deployer Recipe"] = 120,
    Devfile = 138,
    ["Discord Webhook"] = 122,
    ["Dolittle Artifacts"] = 124,
    ["Dolittle Bounded Context Configuration"] = 125,
    ["Dolittle Event Horizons Configuration"] = 126,
    ["Dolittle Resources Configuration"] = 127,
    ["Dolittle Server Configuration"] = 128,
    ["Dolittle Tenant Map Configuration"] = 130,
    ["Dolittle Tenants Configuration"] = 129,
    ["Dolittle Topology"] = 131,
    ["Drush site aliases"] = 135,
    ["Error pages"] = 143,
    Esquio = 141,
    ["Estuary Flow Catalog Schema"] = 490,
    ["Expo SDK"] = 146,
    ["F-Droid Data metadata"] = 150,
    ["Facets - FSDL - Application"] = 148,
    ["Fossa configuration file"] = 155,
    ["Fossa's fossa-deps file"] = 156,
    ["Foundry VTT - Manifest"] = 153,
    ["Foundry VTT - Template"] = 154,
    ["Foxx Manifest"] = 41,
    ["GatewayCore API Gateway"] = 159,
    ["GeoJSON.json latest"] = 488,
    ["GitHub Action"] = 163,
    ["GitHub Funding"] = 164,
    ["GitHub Issue Template configuration"] = 166,
    ["GitHub Workflow"] = 167,
    ["GitHub Workflow Template Properties"] = 168,
    ["GitHub issue forms"] = 165,
    GitVersion = 162,
    ["Gitpod Configuration"] = 170,
    ["Global Privacy Control"] = 160,
    ["Google Cloud Workflows"] = 96,
    Goreleaser = 173,
    ["Goreleaser Pro"] = 174,
    ["Gradle Build Cache Node"] = 449,
    ["Gradle Enterprise"] = 448,
    ["Grafana 5.x Dashboard"] = 175,
    ["GraphQL Code Generator"] = 178,
    ["GraphQL Config"] = 177,
    ["GraphQL Mesh"] = 176,
    ["Grunt JSHint task"] = 182,
    ["Grunt Watch task"] = 183,
    ["Grunt base task"] = 184,
    ["Grunt clean task"] = 180,
    ["Grunt copy task"] = 179,
    ["Grunt cssmin task"] = 181,
    HEMTT = 421,
    Hadolint = 433,
    ["Hammerkit YAML Schema"] = 459,
    Hayson = 186,
    ["Haystack Pipeline"] = 187,
    ["Hazelcast 5 Configuration"] = 188,
    ["Helm Chart.lock"] = 75,
    ["Helm Chart.yaml"] = 74,
    Hugo = 482,
    ["JFrog File Spec"] = 202,
    ["JSON Document Transform"] = 210,
    ["JSON Feed"] = 211,
    ["JSON Resume"] = 311,
    ["JSON Schema Draft 2020-12"] = 403,
    ["JSON Schema Draft 4"] = 400,
    ["JSON Schema Draft 7"] = 401,
    ["JSON Schema Draft 8"] = 402,
    ["JSON schema for CodeShip Pro services configuration files"] = 83,
    ["JSON schema for CodeShip Pro steps configuration files"] = 84,
    ["JSON schema for Codecov configuration files"] = 82,
    ["JSON-API"] = 209,
    ["JSON-e templates"] = 457,
    ["JSON-stat 2.0"] = 397,
    JSONPatch = 213,
    Jekyll = 199,
    ["Jenkins X Pipelines"] = 200,
    ["Jenkins X Requirements"] = 201,
    ["Jovo Language Models"] = 203,
    ["KSP-AVC"] = 398,
    ["KSP-CKAN"] = 399,
    Liquibase = 464,
    Markdownlint = 467,
    ["MegaLinter configuration"] = 229,
    ["MegaLinter descriptor"] = 230,
    ["Meltano plugin discovery definition"] = 232,
    ["Meltano project definition"] = 231,
    ["Microsoft Band Web Tile"] = 233,
    ["Minecraft Data Pack Advancement"] = 235,
    ["Minecraft Data Pack Biome"] = 236,
    ["Minecraft Data Pack Configured Carver"] = 237,
    ["Minecraft Data Pack Dimension"] = 239,
    ["Minecraft Data Pack Dimension Type"] = 238,
    ["Minecraft Data Pack Item Modifier"] = 240,
    ["Minecraft Data Pack Loot Table"] = 241,
    ["Minecraft Data Pack Metadata"] = 242,
    ["Minecraft Data Pack Predicate"] = 243,
    ["Minecraft Data Pack Recipe"] = 244,
    ["Minecraft Data Pack Template Pool"] = 245,
    ["Minecraft Resourcepack Sounds"] = 246,
    ["Netin Diagnostic System Template"] = 471,
    ["Netlify config schema"] = 251,
    ["Nightwatch.js"] = 252,
    ["OSS Review Toolkit repository configuration"] = 273,
    Opctl = 420,
    ["OpenWeather Current Weather API"] = 456,
    ["OpenWeather Road Risk API"] = 455,
    ["Ory Hydra configuration"] = 192,
    ["Ory Keto configuration"] = 217,
    ["Ory Kratos configuration"] = 272,
    ["Ory Oathkeeper configuration"] = 264,
    ["Outblocks App configuration"] = 270,
    ["Outblocks database table"] = 271,
    ["Outblocks project configuration"] = 269,
    Packer = 276,
    ["Pipeline component"] = 465,
    ["PocketMine plugin.yml"] = 280,
    ["Pull Request Labeler"] = 302,
    Qodana = 479,
    ["RKE Cluster Configuration JSON Schema"] = 463,
    ["RKE Cluster Configuration YAML Schema"] = 462,
    Ray = 432,
    ["Read the Docs"] = 305,
    ["Red-DiscordBot Cog"] = 306,
    ["Red-DiscordBot Cog Repo"] = 307,
    Renovate = 312,
    RoadRunner = 313,
    SWADL = 355,
    ["Sapphire CLI Config"] = 314,
    ["SauceCTL Configuration"] = 468,
    ["Schema Catalog"] = 327,
    ["Scoop manifest"] = 332,
    ["Semgrep Rule"] = 333,
    ["Serverless Framework Configuration"] = 475,
    ["Settings.paf"] = 335,
    ["Shopware 6 Configuration"] = 476,
    ["Shopware CLI Extension Store Configuration"] = 477,
    ["Shopware CLI Project Store Configuration"] = 478,
    Solidarity = 340,
    ["Source Maps v3"] = 341,
    SpecIF = 342,
    ["Sponge Mixin configuration"] = 343,
    ["StackHawk Scanner Configuration"] = 474,
    ["StackHead CLI config"] = 347,
    ["StackHead module configuration"] = 348,
    ["StackHead project definition"] = 349,
    Stale = 350,
    ["Statamic Blueprint"] = 351,
    ["Stryker Mutator"] = 352,
    ["StyleCop Analyzers Configuration"] = 353,
    ["Swagger API 2.0"] = 356,
    ["Taskfile YAML Schema"] = 458,
    Taurus = 357,
    ["TestEnvironment.json"] = 362,
    ["Traefik v2"] = 364,
    ["Traefik v2 File Provider"] = 365,
    Tye = 480,
    ["UI5 Manifest"] = 377,
    ["Ubuntu Server Autoinstall"] = 375,
    ["Uniswap Token List"] = 441,
    Updatecli = 487,
    ["User Journey Map YAML Schema"] = 461,
    V2Ray = 491,
    ["VSCode Code Snippets"] = 86,
    ["VSIX CLI publishing"] = 389,
    ["Vela Pipeline Configuration"] = 381,
    Vercel = 85,
    ["Web App Manifest"] = 393,
    ["Web types"] = 396,
    WebExtensions = 392,
    ["Windows Package Manager Installer Manifest"] = 438,
    ["Windows Package Manager Locale Manifest"] = 439,
    ["Windows Package Manager Singleton Manifest"] = 437,
    ["Woodpecker pipeline config"] = 470,
    ["Xstate Machine Schema"] = 485,
    ["Yippee-Ki-JSON configuration YML"] = 443,
    ["angular.json"] = 8,
    ...
    ["chutzpah.json"] = 92,
    ["cloud-sdk-pipeline-config-schema"] = 94,
    ["cloudbuild.json"] = 95,
    cloudify = 80,
    codemagic = 81,
    ["coffeelint.json"] = 101,
    comet = 453,
    ["commands.json"] = 89,
    ["compile_commands.json"] = 88,
    ["compilerconfig.json"] = 87,
    ["component.json"] = 103,
    ["composer.json"] = 102,
    ["config.json"] = 104,
    ["contentmanifest.json"] = 93,
    ["contribute.json"] = 105,
    ["cosmos.config.json"] = 90,
    ["crowdin.yml"] = 106,
    cspell = 109,
    ["cypress.json"] = 107,
    ["datalogic-scan2deploy-android"] = 114,
    ["datalogic-scan2deploy-ce"] = 115,
    ["debugsettings.json"] = 116,
    ["dependabot-v2.json"] = 119,
    ["dependabot.json"] = 118,
    ["deployed-cli"] = 484,
    ["detekt.yml"] = 121,
    devinit = 445,
    ["docfx.json"] = 123,
    ["docker-compose.yml"] = 444,
    ["dotnet Release Index manifest"] = 132,
    ["dotnetcli.host.json"] = 133,
    ["drone.json"] = 134,
    ["dss-2.0.0.json"] = 136,
    ["dvc.yaml"] = 137,
    ["ecosystem.json"] = 139,
    ["electron-builder configuration file."] = 144,
    ["epr-manifest.json"] = 142,
    ["evcc.yaml"] = 145,
    ["fabric.mod.json"] = 149,
    ["first-timers-bot"] = 152,
    fulibWorkflows = 469,
    ["func.yaml"] = 157,
    ["function.json"] = 158,
    ["geojson.json"] = 161,
    ["gitlab-ci"] = 169,
    ["global.json"] = 171,
    ["golangci-lint Configuration"] = 172,
    ["haxelib.json"] = 185,
    helmfile = 434,
    ["host-meta.json"] = 190,
    ["host.json"] = 189,
    ...
    huskyrc = 414,
    ["ide.host.json"] = 193,
    ["imageoptimizer.json"] = 194,
    ["importmap.json"] = 196,
    ["ioBroker JSON UI"] = 197,
    ["ioBroker Package manifest"] = 198,
    ["jsconfig.json"] = 214,
    jsdoc = 431,
    ["k3d.yaml"] = 215,
    ["kustomization.yaml"] = 218,
    ["label-commenter-config.yml"] = 219,
    ["launchsettings.json"] = 220,
    ["lerna.json"] = 221,
    ["lgtm.yml"] = 222,
    ["libman.json"] = 223,
    ["license-report-config.json"] = 224,
    ["linkinator.config.json"] = 225,
    ["local.settings.json"] = 226,
    ["localazy.json"] = 227,
    ["lsdlschema.json"] = 228,
    mboats = 473,
    ["mimetypes.json"] = 234,
    ...
    ["mtad.yaml"] = 417,
    ["mycode.json"] = 249,
    ["napari plugin manifest"] = 250,
    neoload = 426,
    ["nest-cli"] = 255,
    ["ninjs (News in JSON) 1.3"] = 254,
    ["ninjs (News in JSON) 2.0"] = 253,
    ["nlu.json"] = 256,
    ["nodemon.json"] = 258,
    ["noodl.schema.json"] = 472,
    now = 422,
    ["nswag.json"] = 262,
    ntangle = 263,
    ["nuclei-template.yaml"] = 260,
    ["nuget-project.json"] = 261,
    ["ocelot.json"] = 265,
    ["omnisharp.json"] = 266,
    ["openapi.json"] = 267,
    ["openfin.json"] = 268,
    ["package.json"] = 274,
    ["package.manifest"] = 275,
    ["pattern.json"] = 278,
    pgap_yaml_input_reader = 277,
    ["plagiarize-me.yaml"] = 282,
    ["plagiarize.yaml"] = 281,
    ["portman.json"] = 283,
    ["prettierrc.json"] = 287,
    ["prisma.yml"] = 288,
    ["project-1.0.0-beta3.json"] = 290,
    ["project-1.0.0-beta4.json"] = 291,
    ["project-1.0.0-beta5.json"] = 292,
    ["project-1.0.0-beta6.json"] = 293,
    ["project-1.0.0-beta8.json"] = 294,
    ["project-1.0.0-rc1.json"] = 295,
    ["project-1.0.0-rc2.json"] = 296,
    ["project.json"] = 289,
    ["prometheus.json"] = 297,
    ["prometheus.rules.json"] = 298,
    ["proxies.json"] = 299,
    ["publiccode.yml"] = 300,
    ["pubspec.yaml"] = 301,
    ["pyrseas-0.8.json"] = 304,
    ["release drafter"] = 427,
    ["sarif-1.0.0.json"] = 315,
    ["sarif-2.0.0.json"] = 316,
    ["sarif-2.1.0"] = 325,
    ["sarif-2.1.0-rtm.2"] = 317,
    ["sarif-2.1.0-rtm.3"] = 319,
    ["sarif-2.1.0-rtm.4"] = 321,
    ["sarif-2.1.0-rtm.5"] = 323,
    ["sarif-external-property-file-2.1.0"] = 326,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 318,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 320,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 322,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 324,
    ["schema.org - Action"] = 328,
    ["schema.org - ContactPoint"] = 329,
    ["schema.org - Place"] = 330,
    ["schema.org - Thing"] = 331,
    ["service.datadog.yaml"] = 216,
    ["servicehub.config.json"] = 406,
    ["servicehub.service.json"] = 405,
    ["settings.job"] = 334,
    ["sfdx-hardis configuration"] = 336,
    ["size-limit configuration"] = 337,
    ["skaffold.yaml"] = 466,
    ["skyuxconfig.json"] = 338,
    snapcraft = 339,
    swcrc = 454,
    taskcat = 423,
    ["template.json"] = 358,
    ["templatsources.json"] = 359,
    ["theme.json"] = 360,
    tmLanguage = 361,
    ["trunk.yaml schema"] = 366,
    ["ts-force-config.json"] = 370,
    ["tsconfig.json"] = 367,
    ["tsd.json"] = 368,
    ["tsdrc.json"] = 369,
    ["tslint.json"] = 371,
    ...
    ["version.json"] = 382,
    ["vim-addon-info"] = 383,
    ["vs-2017.3.host.json"] = 385,
    ["vs-nesting.json"] = 386,
    ["vsls.json"] = 384,
    ["vss-extension.json"] = 390,
    ["webjobpublishsettings.json"] = 395,
    ["webjobs-list.json"] = 394,
    ["xs-app.json"] = 419,
    ["xunit.runner.json"] = 404,
    yamllint = 442,
    zuul = 428,
    ["Žinoma"] = 436
  },
