...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 187,
    [".cryproj (generic)"] = 640,
    [".cryproj engine-5.2"] = 635,
    [".cryproj engine-5.3"] = 636,
    [".cryproj engine-5.4"] = 637,
    [".cryproj engine-5.5"] = 638,
    [".cryproj engine-dev"] = 639,
    [".csscomb.json"] = 189,
    [".csslintrc"] = 190,
    [".es6importsorterrc.json"] = 775,
    [".eslintrc"] = 240,
    [".esmrc.json"] = 232,
    [".ffizer.yaml"] = 245,
    [".htmlhintrc"] = 301,
    ...
    [".pmbot.yml"] = 445,
    [".postcssrc"] = 452,
    [".powerpages-web-template-manifest"] = 454,
    [".pre-commit-config.yml"] = 455,
    [".pre-commit-hooks.yml"] = 456,
    [".putout.json"] = 476,
    [".rehyperc"] = 489,
    [".remarkrc"] = 491,
    [".sprite files"] = 547,
    ...
    ["Better Scripts"] = 102,
    Bigconfig = 82,
    BizTalkServerApplicationSchema = 657,
    Bleep = 103,
    ...
    ["Expo SDK"] = 238,
    ["F-Droid Data metadata"] = 244,
    ["Facets - FSDL - Application"] = 242,
    ["FasterCI Configuration"] = 66,
    FiQuS = 248,
    Firebase = 246,
    ["Fossa configuration file"] = 255,
    ["Fossa's fossa-deps file"] = 256,
    ["Foundry VTT - Base package Manifest"] = 250,
    ["Foundry VTT - Module Manifest"] = 251,
    ["Foundry VTT - System Data Template"] = 254,
    ["Foundry VTT - System Manifest"] = 252,
    ["Foundry VTT - World Manifest"] = 253,
    ["Foxx Manifest"] = 67,
    ["Freifunk.de Community API"] = 70,
    ["Frogbot Config"] = 71,
    ["Fusion resource pack metadata"] = 260,
    ["Fusion texture metadata"] = 261,
    ...
    Goblet = 794,
    ["Google Chrome Related Website Sets"] = 247,
    ["Google Cloud Workflows"] = 170,
    Gorder = 281,
    Goreleaser = 282,
    ["Goreleaser Pro"] = 283,
    Goss = 284,
    ["Gradle Build Cache Node"] = 685,
    ["Gradle Enterprise"] = 684,
    ...
    ["JSON Feed"] = 332,
    ["JSON Resume"] = 496,
    ["JSON Schema Draft 2020-12"] = 631,
    ["JSON Schema Draft 4"] = 628,
    ["JSON Schema Draft 7"] = 629,
    ["JSON Schema Draft 7 (unofficial strict)"] = 796,
    ["JSON Schema Draft 8 (2019-09)"] = 630,
    ["JSON-API"] = 330,
    ["JSON-e templates"] = 692,
    ["JSON-stat 2.0"] = 625,
    JSONPatch = 334,
    Jasmine = 314,
    Jekyll = 315,
    ...
    ["KSP-AVC"] = 626,
    ["KSP-CKAN"] = 627,
    ["Karakum configuration file"] = 257,
    Kas = 337,
    ["Keycloak REST API"] = 766,
    ["Knative Functions - func.yaml"] = 258,
    ...
    Liquibase = 699,
    ["Liquibase Flow File"] = 700,
    ["Lively Properties"] = 358,
    ["Lobe AI Agent"] = 64,
    ["MLOS Configs"] = 391,
    ["MS2Rescore Configuration"] = 393,
    Markdownlint = 703,
    ["Mason Registry"] = 705,
    ...
    ["Microsoft Band Web Tile"] = 369,
    ["Minecraft Custom Main Menu Mod"] = 803,
    ["Minecraft Data Pack Advancement"] = 371,
    ["Minecraft Data Pack Biome"] = 372,
    ["Minecraft Data Pack Configured Carver"] = 373,
    ["Minecraft Data Pack Damage Type"] = 374,
    ["Minecraft Data Pack Dimension"] = 376,
    ["Minecraft Data Pack Dimension Type"] = 375,
    ["Minecraft Data Pack Item Modifier"] = 377,
    ["Minecraft Data Pack Loot Table"] = 378,
    ["Minecraft Data Pack Metadata"] = 379,
    ["Minecraft Data Pack Predicate"] = 380,
    ["Minecraft Data Pack Recipe"] = 381,
    ["Minecraft Data Pack Tag"] = 382,
    ["Minecraft Data Pack Template Pool"] = 383,
    ["Minecraft Data Pack Trim Material"] = 388,
    ["Minecraft Data Pack Trim Pattern"] = 389,
    ["Minecraft Resource Pack Lang"] = 384,
    ["Minecraft Resource Pack Particle"] = 385,
    ["Minecraft Resource Pack Texture Mcmeta"] = 387,
    ["Minecraft Resourcepack Sounds"] = 386,
    ["MkDocs Configuration 1.0"] = 390,
    ["MongoDB Atlas Search Index Definition"] = 753,
    ["Monika Configuration"] = 751,
    ["Motif config"] = 650,
    ["NOX Framework (Service)"] = 408,
    ["Netin Diagnostic System Template"] = 709,
    ["Netlify config"] = 399,
    ...
    ["OpenUtau ustx"] = 421,
    ["OpenWeather Current Weather API"] = 691,
    ["OpenWeather Road Risk API"] = 690,
    ...
    ["Partial-Setuptools"] = 531,
    ["Partial-poetry"] = 448,
    ["Pipeline component"] = 701,
    ["PocketMine plugin.yml"] = 446,
    Poetry = 447,
    ["Postman collection"] = 453,
    ["Problem object RFC9457"] = 800,
    ["Problem package generators"] = 460,
    Pterodactyl = 748,
    ["Pull Request Labeler"] = 475,
    Pulumi = 481,
    PyProject = 482,
    Pyright = 483,
    ["Pyright Partial"] = 484,
    ...
    ["RKE Cluster Configuration JSON"] = 698,
    ["RKE Cluster Configuration YAML"] = 697,
    ["Rancher Fleet"] = 478,
    Ray = 665,
    ["Read the Docs"] = 480,
    ...
    SWADL = 561,
    ["Safebox Config"] = 759,
    ["Sapphire CLI Config"] = 504,
    ["SauceCTL Configuration"] = 706,
    ["Schema Catalog"] = 518,
    ["Scoop manifest"] = 523,
    ["Semantic Data Fabric (SDF) file"] = 524,
    ["Semgrep Rule"] = 526,
    ["Serenity Code Generator (Sergen)"] = 527,
    ...
    ["Windows Package Manager Installer Manifest"] = 673,
    ["Windows Package Manager Locale Manifest"] = 674,
    ["Windows Package Manager Singleton Manifest"] = 672,
    ["Woodpecker pipeline config"] = 708,
    ["Xstate Machine"] = 728,
    ["Yippee-Ki-JSON configuration YML"] = 678,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 16,
    apko = 801,
    ...
    ["partial-scikit-build"] = 713,
    ["pathfinder.yml"] = 440,
    ["pattern.json"] = 444,
    ["petstore-v1.0"] = 757,
    pgap_yaml_input_reader = 443,
    ["plagiarize-me.yaml"] = 450,
    ["plagiarize.yaml"] = 449,
    ["portman.json"] = 451,
    ["prettierrc.json"] = 458,
    ["prisma.yml"] = 459,
    ["project-1.0.0-beta3.json"] = 462,
    ["project-1.0.0-beta4.json"] = 463,
    ["project-1.0.0-beta5.json"] = 464,
    ["project-1.0.0-beta6.json"] = 465,
    ["project-1.0.0-beta8.json"] = 466,
    ["project-1.0.0-rc1.json"] = 467,
    ["project-1.0.0-rc2.json"] = 468,
    ["project.json"] = 461,
    ["prometheus.json"] = 469,
    ["prometheus.rules.json"] = 470,
    ["prometheus.rules.test.json"] = 471,
    ["proxies.json"] = 472,
    ["publiccode.yml"] = 473,
    ["pubspec.yaml"] = 474,
    ["pyrseas-0.8.json"] = 477,
    ["quilt.mod.json"] = 783,
    ["release drafter"] = 660,
    ...
    samt = 502,
    samtrc = 503,
    ["sarif-1.0.0.json"] = 505,
    ["sarif-2.0.0.json"] = 506,
    ["sarif-2.1.0"] = 516,
    ["sarif-2.1.0-rtm.2"] = 507,
    ["sarif-2.1.0-rtm.3"] = 509,
    ["sarif-2.1.0-rtm.4"] = 511,
    ["sarif-2.1.0-rtm.5"] = 513,
    ["sarif-2.1.0-rtm.6"] = 514,
    ["sarif-external-property-file-2.1.0"] = 517,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 508,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 510,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 512,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 515,
    ["schema.org - Action"] = 519,
    ["schema.org - ContactPoint"] = 520,
    ["schema.org - Place"] = 521,
    ["schema.org - Thing"] = 522,
    ["scikit-build"] = 712,
    ["secrethub.yml"] = 785,
    ["semantic-release"] = 525,
    ["servicehub.config.json"] = 634,
    ["servicehub.service.json"] = 633,
    ["settings.job"] = 528,
