...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 782,
    [".nodehawkrc"] = 492,
    [".npmpackagejsonlintrc"] = 496,
    [".omletrc"] = 955,
    [".phrase.yml"] = 557,
    [".phraseapp.yml"] = 558,
    [".pmbot.yml"] = 545,
    [".postcssrc"] = 552,
    [".powerpages-web-template-manifest"] = 554,
    [".pre-commit-config.yml"] = 555,
    [".pre-commit-hooks.yml"] = 556,
    [".putout.json"] = 579,
    [".rehyperc"] = 601,
    [".remarkrc"] = 603,
    [".sprite files"] = 668,
    ...
    ["A micro editor config"] = 445,
    ABCInventoryModuleData = 14,
    ABCSupplyPlan = 15,
    AIConfig = 16,
    ["AMX Muse Program Descriptor"] = 999,
    ["API Builder"] = 816,
    ["AVA Configuration"] = 878,
    ["AWS AppConfig Feature Flags-v1"] = 40,
    ["AWS CDK cdk.json"] = 198,
    ["AWS CloudFormation"] = 199,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 200,
    ["AWS SAM CLI Samconfig"] = 201,
    ["Adobe UXP Manifest"] = 938,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    Air = 12,
    ["Airlock Microgateway"] = 17,
    ["Alacritty Configuration"] = 850,
    ["All Contributors configuration file"] = 903,
    ["Ansible Argument Specs"] = 330,
    ["Ansible Collection Galaxy"] = 337,
    ["Ansible Execution Environment"] = 327,
    ["Ansible Inventory"] = 336,
    ["Ansible Meta"] = 328,
    ["Ansible Meta Runtime"] = 329,
    ["Ansible Navigator Configuration"] = 339,
    ["Ansible Playbook"] = 334,
    ["Ansible Requirements"] = 331,
    ["Ansible Rulebook"] = 335,
    ["Ansible Tasks File"] = 333,
    ["Ansible Vars File"] = 332,
    ["Ansible-lint Configuration"] = 338,
    Any = 964,
    ["AnyWork Automation Configuration"] = 5,
    ["App config Spotify Backstage"] = 21,
    ["Application Accelerator"] = 2,
    ["Application list for a WinUtil"] = 981,
    ArchitectFX = 986,
    ["Argo Events"] = 30,
    ["Argo Workflows"] = 31,
    AssemblyScript = 34,
    AsyncAPI = 35,
    ["AsyncAPI Tool File"] = 36,
    ["Atmos Manifests"] = 37,
    ["Aurora Agile Meta-Framework"] = 38,
    AutoAPICase = 913,
    ["Avro Avsc"] = 39,
    ["Azure Container App template for defining an immutable revision"] = 41,
    ["Azure DevOps extension manifest"] = 44,
    ["Azure Device Update for IoT Hub import manifest"] = 42,
    ["Azure Device Update for IoT Hub update manifest"] = 43,
    ["Azure IoT Edge deployment"] = 47,
    ["Azure IoT Edge deployment template"] = 48,
    ["Azure IoT EdgeAgent deployment"] = 45,
    ["Azure IoT EdgeHub deployment"] = 46,
    ["Azure Landing Zones Library archetype definition"] = 52,
    ["Azure Landing Zones Library archetype override"] = 53,
    ["Azure Landing Zones Library architecture definition"] = 51,
    ["Azure Landing Zones Library metadata"] = 49,
    ["Azure Landing Zones Library policy default values"] = 50,
    ["Azure Pipelines"] = 67,
    ["Azure Static Web Apps CLI configuration file"] = 672,
    ["Azure Static Web Apps configuration file"] = 671,
    ["BOSH Deploy Config"] = 91,
    ["BX CI"] = 109,
    ["Bashly (bashly.yml)"] = 907,
    ["Bashly Settings (bashly-settings.yml)"] = 908,
    ["Better Code Hub"] = 820,
    ["Better Scripts"] = 110,
    Bigconfig = 84,
    ["Biome Formatter Config"] = 54,
    ["Bitmovin Encoding Template"] = 992,
    BizTalkServerApplicationSchema = 788,
    Bleep = 111,
    ["Block Protocol Metadata"] = 108,
    ["Boyka Framework"] = 92,
    Briefcase = 794,
    ["Build Info"] = 99,
    Buildkite = 101,
    ["Bukkit plugin.yml"] = 100,
    ["BungeeCord plugin.yml"] = 106,
    ["Butane Config"] = 863,
    C4InterFlow = 1007,
    ["CGS Card Game Specification (cgs.json)"] = 943,
    ["CICS TS region tagging"] = 872,
    ["CICS TS resource import"] = 873,
    ["CICS TS resource model"] = 874,
    ["CICS TS resource overrides"] = 875,
    ["CMake Presets"] = 112,
    ["CNC Codes"] = 128,
    ["CRS WAF test file"] = 971,
    ["CRS WAF test platform overrides file"] = 972,
    ["CSS Comb (.csscomb.json)"] = 225,
    ["CSS Lint (.csslintrc)"] = 226,
    ["CSpell (cspell.json)"] = 224,
    ["CVE Record Format"] = 134,
    CWL = 949,
    ["Cache Warmup config"] = 113,
    ["Calqulus pipeline"] = 114,
    ["Camel YAML DSL"] = 115,
    ["Cannon TOML"] = 116,
    Carafe = 117,
    ["Cargo Make"] = 119,
    ["Cargo Manifest"] = 118,
    ["Catalog Info Backstage"] = 120,
    ["Chamaleon environment"] = 996,
    ["Chamaleon properties"] = 997,
    ["Chamaleon template"] = 995,
    Changesets = 210,
    Charmcraft = 121,
    Cheatsheets = 860,
    ["Chrome Extension"] = 191,
    ["Chromia Model"] = 122,
    ["CircleCI config.yml"] = 167,
    ["Citation File Format"] = 212,
    CityJSON = 124,
    ["Clawject config"] = 133,
    ["Cloud Foundry Application Manifest"] = 954,
    ["Cloud Run Spec v1"] = 976,
    ["CloudCannon Configuration"] = 63,
    ["CloudEvents specification"] = 125,
    ["Code Climate"] = 168,
    CodeCV = 61,
    CodeRabbit = 60,
    ["CodeShip Pro services configuration files"] = 180,
    ["CodeShip Pro steps configuration files"] = 181,
    ["Codecov configuration files"] = 179,
    CodifyCLI = 62,
    Codux = 177,
    ["Cog config file"] = 129,
    ["Commandbox Box.json"] = 130,
    ["Commandbox Server.json"] = 131,
    ["Common Catalog Data"] = 189,
    Concord = 970,
    ["Configu .cfgu files"] = 959,
    ["Configu .configu file"] = 960,
    Conjure = 127,
    ["Container Structure Test"] = 802,
    Containerlab = 829,
    ["Crowdsec collection config"] = 219,
    ["Crowdsec parser config"] = 220,
    ["Crowdsec scenario config"] = 221,
    ["CumulusCI Config"] = 132,
    ["Custom Machinery Machine"] = 944,
    ["Custom Machinery Recipe"] = 945,
    ["Cycle Stack File"] = 135,
    CycloneDX = 136,
    ["DWP Exchange - catalogue entry"] = 268,
    ["DWP Exchange - gateway"] = 266,
    ["DWP Exchange - meta"] = 267,
    ["Dart Build Config (dart-build.json)"] = 227,
    ["Dart Test Config (dart-test.json)"] = 228,
    ["DashLord Configuration"] = 229,
    ["Data Contract Specification"] = 230,
    ["Data Product Specification"] = 231,
    ["DataYoga Connections"] = 137,
    ["DataYoga Job"] = 138,
    ["Databricks Asset Bundles"] = 924,
    ["Datadog Service Definition"] = 418,
    ["Datadog Software Catalog"] = 419,
    ["Datahub Ingestion Recipe"] = 879,
    ["Dein Config"] = 144,
    ["Deno Config (deno.json)"] = 237,
    ["Dependency cruiser"] = 145,
    ["DeployStack Configuration"] = 146,
    ["Deployer Recipe"] = 240,
    ["Deta Spacefile"] = 147,
    ["Detekt Config (detekt.yml)"] = 241,
    ["Devbox Config"] = 148,
    ["Devbox Plugin"] = 149,
    Devfile = 265,
    DipDup = 973,
    ["Discord Webhook"] = 242,
    ["DocFx Config (docfx.json)"] = 246,
    Dofigen = 247,
    ["Dolittle Artifacts"] = 248,
    ["Dolittle Bounded Context Configuration"] = 249,
    ["Dolittle Event Horizons Configuration"] = 250,
    ["Dolittle Resources Configuration"] = 251,
    ["Dolittle Server Configuration"] = 252,
    ["Dolittle Tenant Map Configuration"] = 254,
    ["Dolittle Tenants Configuration"] = 253,
    ["Dolittle Topology"] = 255,
    ["DonateCaseBetterCasino menu"] = 1000,
    ["Drupal Breakpoints"] = 150,
    ["Drupal Config"] = 162,
    ["Drupal Info"] = 151,
    ["Drupal Layouts"] = 152,
    ["Drupal Libraries"] = 153,
    ["Drupal Links Action"] = 154,
    ["Drupal Links Contextual"] = 155,
    ["Drupal Links Menu"] = 156,
    ["Drupal Links Task"] = 157,
    ["Drupal Migration"] = 158,
    ["Drupal Permissions"] = 159,
    ["Drupal Recipe"] = 160,
    ["Drupal Routing"] = 161,
    ["Drupal Services"] = 163,
    ["Drush site aliases"] = 261,
    ["Dynamic Bash Aliases (.aliases)"] = 915,
    ["EAS config"] = 285,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 904,
    ["EasyVCR .NET"] = 286,
    ["Eidolon Resource"] = 987,
    ["Elgato Stream Deck"] = 271,
    Elm = 975,
    ["Embrace Config"] = 890,
    Endurica = 928,
    ["Enterprise Contract Policy Spec"] = 272,
    ["Erda Pipeline"] = 951,
    ["Erda Runtime"] = 952,
    Esquio = 274,
    ["Estuary Flow Catalog"] = 869,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 278,
    ["EveryVoice TTS Toolkit Data Configuration"] = 279,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 283,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 282,
    ["EveryVoice TTS Toolkit Text Configuration"] = 280,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 281,
    ["Expo SDK"] = 284,
    ["F-Droid Data metadata"] = 290,
    ["FasterCI Configuration"] = 68,
    FiQuS = 294,
    Firebase = 292,
    ["FlexGet Config"] = 295,
    ["Flow.json Configurations"] = 948,
    ["Fossa configuration file"] = 302,
    ["Fossa's fossa-deps file"] = 303,
    ["Foundry VTT - Base package Manifest"] = 297,
    ["Foundry VTT - Module Manifest"] = 298,
    ["Foundry VTT - System Data Template"] = 301,
    ["Foundry VTT - System Manifest"] = 299,
    ["Foundry VTT - World Manifest"] = 300,
    ["Foxx Manifest"] = 69,
    ["Freifunk.de Community API"] = 72,
    ["Frogbot Config"] = 73,
    ["G2P Mapping Configuration"] = 308,
    ["GCP Blueprint Metadata"] = 311,
    Gaspar = 309,
    ["GatewayCore API Gateway"] = 310,
    ["GeoJSON.json latest"] = 867,
    GherKing = 871,
    ["GitHub Action"] = 316,
    ["GitHub Actions typing"] = 983,
    ["GitHub Discussion"] = 317,
    ["GitHub Funding"] = 318,
    ["GitHub Issue Template configuration"] = 319,
    ["GitHub Issue Template forms"] = 320,
    ["GitHub Workflow"] = 321,
    ["GitHub Workflow Template Properties"] = 322,
    ["GitHub automatically generated release notes configuration"] = 323,
    ["GitLab Agent for Kubernetes configuration"] = 940,
    GitVersion = 313,
    ["Gitea Issue Template configuration"] = 314,
    ["Gitea Issue Template forms"] = 315,
    ["Gitpod Automations"] = 325,
    ["Gitpod Configuration"] = 326,
    ["GlazeWM settings"] = 942,
    ["Global Privacy Control"] = 312,
    Goblet = 923,
    ["Golangci-lint Configuration"] = 341,
    ["Golangci-lint Custom Plugins Configuration"] = 342,
    ["Google Chrome Related Website Sets"] = 293,
    ["Google Cloud Workflows"] = 197,
    Goreleaser = 344,
    ["Goreleaser Pro"] = 345,
    Goss = 346,
    ["Gradle Build Cache Node"] = 818,
    ["Gradle Enterprise"] = 817,
    ["Grafana 5.x Dashboard"] = 347,
    ["GraphQL Code Generator"] = 351,
    ["GraphQL Config"] = 350,
    ["GraphQL Mesh"] = 349,
    ["Grunt JSHint task"] = 355,
    ["Grunt Watch task"] = 356,
    ["Grunt base task"] = 357,
    ["Grunt clean task"] = 353,
    ["Grunt copy task"] = 352,
    ["Grunt cssmin task"] = 354,
    HEMTT = 785,
    Hadolint = 798,
    Hammerkit = 828,
    ["Hardware Sentry Configuration"] = 883,
    Hatch = 799,
    Hayson = 359,
    ["Haystack Pipeline"] = 360,
    ["Hazelcast 5 Configuration"] = 361,
    ["Helm Chart.lock"] = 165,
    ["Helm Chart.yaml"] = 164,
    ["Helm Unittest Test Suite"] = 166,
    Hugo = 859,
    ["Hugo Theme"] = 858,
    ["Hyperfoil benchmark configuration"] = 367,
    ["IBM Zapp document"] = 368,
    ["IBM zCodeFormatSettings"] = 369,
    ["IMG Catapult PSP"] = 374,
    ["IVMS101 by CODE Protocol"] = 941,
    Infrahub = 376,
    Istanbul = 886,
    ["JDownloader2 crawler multi-rules"] = 386,
    ["JDownloader2 crawler single-rules"] = 385,
    ["JFrog Applications Config"] = 387,
    ["JFrog File Spec"] = 388,
    ["JFrog Pipelines YML DSL"] = 892,
    ["JMeter DSL cli config"] = 389,
    JReleaser = 391,
    ["JSON Document Transform"] = 399,
    ["JSON Feed"] = 400,
    ["JSON Resume"] = 608,
    ["JSON Schema Draft 2020-12"] = 768,
    ["JSON Schema Draft 4"] = 765,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 925,
    ["JSON Schema Draft 7"] = 766,
    ["JSON Schema Draft 7 (unofficial strict)"] = 926,
    ["JSON Schema Draft 8 (2019-09)"] = 767,
    ["JSON-API"] = 398,
    ["JSON-e templates"] = 825,
    ["JSON-stat 2.0"] = 761,
    JSONPatch = 402,
    ["JSR Package Config (jsr.json)"] = 392,
    Jasmine = 380,
    Jekyll = 381,
    ["Jenkins X Pipelines"] = 382,
    ["Jenkins X Requirements"] = 383,
    Jest = 384,
    ["Jovo Language Models"] = 390,
    ["KIMMDY config file"] = 413,
    ["KODE/CI build.yaml"] = 888,
    ["KSP-AVC"] = 762,
    ["KSP-CKAN"] = 763,
    ["KSP-NetKAN"] = 764,
    KSY = 953,
    KSail = 306,
    ["Karakum configuration file"] = 304,
    Kas = 405,
    ["Kestra flow file"] = 414,
    ["Keycloak REST API"] = 895,
    ["Knative Functions - func.yaml"] = 305,
    ["Kometa (nightly) config file"] = 416,
    ["Kometa config file"] = 415,
    ["Kong DBLess config"] = 889,
    KrakenD = 417,
    ["Kubri Configuration"] = 423,
    LOOBin = 438,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 202,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 203,
    ["Landing Zone Accelerator on AWS - Global Config"] = 204,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 205,
    ["Landing Zone Accelerator on AWS - Network Config"] = 206,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 207,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 208,
    ["Landing Zone Accelerator on AWS - Security Config"] = 209,
    ["Language configuration"] = 963,
    Lefthook = 427,
    ["Liferay client-extension.yaml"] = 434,
    ["LinkML Metamodel"] = 436,
    Liquibase = 834,
    ["Liquibase Flow File"] = 835,
    ["Lively Properties"] = 437,
    ["Lobe AI Agent"] = 65,
    Loki = 66,
    ["MLOS Configs"] = 476,
    ["MS2Rescore Configuration"] = 479,
    ["Madness (madness.yml)"] = 906,
    ["MapEHR Mapping"] = 444,
    Markdownlint = 838,
    ["Mason Registry"] = 841,
    ["MegaLinter configuration"] = 446,
    ["MegaLinter descriptor"] = 447,
    Melange = 932,
    ["Meltano project definition"] = 448,
    ["Mergify Configuration"] = 480,
    ["Metadata for a Bazel module"] = 449,
    ["Metadata for a Cinnamon spice"] = 979,
    ["Metatype Configuration"] = 450,
    ["MetricsHub Configuration"] = 451,
    ["MetricsHub Connector Configuration"] = 452,
    ["Micro Editor Syntax"] = 916,
    ["Microsoft Band Web Tile"] = 453,
    ["Microsoft RulesEngine workflow rules"] = 967,
    ["Microsoft RulesEngine workflow rules list"] = 968,
    ["Minecraft Custom Main Menu Mod"] = 933,
    ["Minecraft Data Pack Advancement"] = 455,
    ["Minecraft Data Pack Biome"] = 456,
    ["Minecraft Data Pack Configured Carver"] = 457,
    ["Minecraft Data Pack Damage Type"] = 458,
    ["Minecraft Data Pack Dimension"] = 460,
    ["Minecraft Data Pack Dimension Type"] = 459,
    ["Minecraft Data Pack Item Modifier"] = 461,
    ["Minecraft Data Pack Loot Table"] = 462,
    ["Minecraft Data Pack Metadata"] = 463,
    ["Minecraft Data Pack Predicate"] = 464,
    ["Minecraft Data Pack Recipe"] = 465,
    ["Minecraft Data Pack Tag"] = 466,
    ["Minecraft Data Pack Template Pool"] = 467,
    ["Minecraft Data Pack Trim Material"] = 472,
    ["Minecraft Data Pack Trim Pattern"] = 473,
    ["Minecraft Resource Pack Lang"] = 468,
    ["Minecraft Resource Pack Particle"] = 469,
    ["Minecraft Resource Pack Texture Mcmeta"] = 471,
    ["Minecraft Resourcepack Sounds"] = 470,
    ["Monade CLI Stack Configuration"] = 483,
    ["MongoDB Atlas Search Index Definition"] = 887,
    ["Monika Configuration"] = 885,
    ["Monoweave Configuration"] = 478,
    ["Motif config"] = 781,
    ["NOX Framework (Service)"] = 495,
    ["Netin Diagnostic System Template"] = 845,
    ["Netlify config"] = 486,
    ["Network-as-Code Data Model"] = 487,
    ["Nightwatch.js"] = 488,
    ["NueJS configuration file"] = 500,
    ["Nuitka.yaml"] = 946,
    ["Nullstone config"] = 502,
    ["ONe's changelog entry"] = 516,
    ["ONe's service descriptor"] = 515,
    ["OSCAL Assessment Plan (AP)"] = 524,
    ["OSCAL Assessment Results (AR)"] = 525,
    ["OSCAL Catalog"] = 526,
    ["OSCAL Component Definition (CDef)"] = 527,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 528,
    ["OSCAL Profile"] = 529,
    ["OSCAL System Security Plan (SSP)"] = 530,
    ["OSS Review Toolkit configuration"] = 531,
    ["OSS Review Toolkit curation"] = 532,
    ["OSS Review Toolkit package configuration"] = 533,
    ["OSS Review Toolkit repository configuration"] = 534,
    ["OSS Review Toolkit resolutions"] = 535,
    ["October CMS columns"] = 506,
    ["October CMS fields"] = 507,
    Okteto = 508,
    Opctl = 784,
    ["Open Data Contract Standard (ODCS)"] = 519,
    ["OpenRewrite Resource"] = 518,
    ["OpenUtau character yaml"] = 512,
    ["OpenUtau ustx"] = 513,
    ["OpenWeather Current Weather API"] = 824,
    ["OpenWeather Road Risk API"] = 823,
    ["Ory Hydra configuration"] = 366,
    ["Ory Keto configuration"] = 420,
    ["Ory Kratos configuration"] = 523,
    ["Ory Oathkeeper configuration"] = 504,
    ["Outblocks App configuration"] = 521,
    ["Outblocks database table"] = 522,
    ["Outblocks project configuration"] = 520,
    PDM = 541,
    Packer = 538,
    Pantsbuild = 902,
    ["Paper paper-plugin.yml"] = 539,
    ["Pipeline component"] = 836,
    ["Plex Prerolls"] = 549,
    ["PocketMine plugin.yml"] = 546,
    ["Postman collection"] = 553,
    ["Preset list for a WinUtil"] = 982,
    ["Problem object RFC9457"] = 930,
    ["Problem package generators"] = 562,
    Pterodactyl = 882,
    ["Pull Request Labeler"] = 578,
    Pulumi = 586,
    ["PyGTA Config"] = 582,
    PyProject = 587,
    Pyright = 588,
    Qgoda = 589,
    Qodana = 855,
    ["Qt Creator workspace file"] = 961,
    ["Quali Torque Blueprint Spec 2"] = 880,
    ["QueryFirst config file"] = 898,
    ["RKE Cluster Configuration JSON"] = 833,
    ["RKE Cluster Configuration YAML"] = 832,
    RadioHound = 581,
    Railway = 590,
    ["Rancher Fleet"] = 583,
    ["Rattler-build"] = 591,
    Ray = 797,
    ["Read the Docs"] = 585,
    ["Red-DiscordBot Cog"] = 598,
    ["Red-DiscordBot Cog Repo"] = 599,
    ["Red-DiscordBot Trivia"] = 600,
    ["Render Blueprints"] = 831,
    RenderCV = 610,
    Renovate = 609,
    ["Replit config"] = 604,
    Restate = 1010,
    RoadRunner = 612,
    ["Rudder techniques"] = 936,
    Ruff = 606,
    ["Rust Project"] = 607,
    ["Rust toolchain"] = 616,
    ["SDMX data message"] = 642,
    ["SDMX metadata message"] = 641,
    ["SDMX structure message"] = 640,
    ["SIL Kit Participant Configuration"] = 652,
    ["SIL Kit Registry Configuration"] = 653,
    ["SPDX 2.3"] = 669,
    SWADL = 683,
    ["Safebox Config"] = 893,
    ["Sapphire CLI Config"] = 619,
    ["SauceCTL Configuration"] = 842,
    ["Schema Catalog"] = 634,
    ["Scoop manifest"] = 639,
    ["Semantic Data Fabric (SDF) file"] = 643,
    ["Semgrep Rule"] = 645,
    ["Serenity Code Generator (Sergen)"] = 646,
    ["Serverless Framework Configuration"] = 849,
    ["Serverless Workflow"] = 851,
    ["Settings for a Cinnamon spice"] = 978,
    ["Settings.paf"] = 648,
    ["Shopware 6 Configuration"] = 852,
    ["Shopware CLI Extension Store Configuration"] = 853,
    ["Shopware CLI Project Store Configuration"] = 854,
    ["Sigma Detection Rule"] = 650,
    ["Sigrid scope configuration file"] = 651,
    ["SkyPilot Task JSON"] = 937,
    ["Slack app manifest"] = 655,
    Solidarity = 658,
    ["Solution filters"] = 659,
    ["Source Maps v3"] = 660,
    Sourcery = 661,
    ["Speakeasy Generation Config File"] = 665,
    ["Speakeasy Lint Configuration File"] = 662,
    ["Speakeasy Test Generation Configuration File"] = 663,
    ["Speakeasy Workflow File"] = 664,
    SpecIF = 666,
    ["Sponge Mixin configuration"] = 667,
    StackBlitz = 673,
    ["StackHawk Scanner Configuration"] = 848,
    Stale = 674,
    ["Starlake Data Pipeline"] = 821,
    Starship = 675,
    ["Statamic Blueprint"] = 676,
    ["Stella configuration file"] = 677,
    ["Stryker Mutator"] = 680,
    ["StyleCop Analyzers Configuration"] = 681,
    ["Stylelint (.stylelintrc)"] = 682,
    ["Sublime Syntax"] = 894,
    ["Subsquid squid manifest"] = 939,
    ["Swagger API 2.0"] = 684,
    ["Synadia Connect Component"] = 685,
    TSON = 717,
    TSTyche = 718,
    ["Tab data for a LinUtil"] = 985,
    ["Tab list for a LinUtil"] = 984,
    Talhelper = 687,
    ["Talisman configuration"] = 688,
    ["Taskfile config"] = 826,
    Taurus = 689,
    Tauticord = 690,
    Telefonistka = 1011,
    ["TestEnvironment.json"] = 700,
    ["TextMate Grammar"] = 699,
    ["Tier.run pricing.json"] = 693,
    Tikibase = 694,
    Tombi = 698,
    ["Traefik v2"] = 703,
    ["Traefik v2 File Provider"] = 704,
    ["Traefik v3"] = 705,
    ["Traefik v3 File Provider"] = 706,
    ["Travis CI (.travis.yml)"] = 702,
    Trident = 1009,
    ["TrueScript for *.tscript files"] = 709,
    ["Tugboat QA config.yml"] = 1006,
    TunnelHub = 929,
    Turborepo = 701,
    Tycho = 974,
    Tye = 856,
    ["UET BuildConfig.json"] = 899,
    ["UI5 Manifest"] = 727,
    ["UNCORS configuration"] = 731,
    ["UTAM Page Object"] = 730,
    ["Ubuntu Server Autoinstall"] = 725,
    ["Uniswap Token List"] = 809,
    ["Universal Schedule Format"] = 732,
    ["Unreal Engine Uplugin"] = 900,
    ["Unreal Engine Uproject"] = 901,
    ["Updatecli Compose"] = 864,
    ["Updatecli Policy Manifest"] = 865,
    ["Updatecli Policy Metadata"] = 866,
    Uplift = 897,
    ["User Journey Map"] = 830,
    V2Ray = 870,
    ["VSCode Code Snippets"] = 185,
    ["VSIX CLI publishing"] = 750,
    Vector = 734,
    ["Vela Pipeline Configuration"] = 737,
    Vercel = 184,
    ["Version Bumper config"] = 740,
    Visivo = 927,
    Wake = 1008,
    ["Waku Config"] = 988,
    ["Web App Manifest"] = 756,
    ["Web types"] = 759,
    WebExtensions = 755,
    ["Webman package recipe"] = 876,
    ["Windows Package Manager Installer Manifest"] = 805,
    ["Windows Package Manager Locale Manifest"] = 806,
    ["Windows Package Manager Singleton Manifest"] = 804,
    Winutil = 807,
    ["WireMock stub mapping"] = 991,
    ["Woodpecker pipeline config"] = 844,
    ["Wrangler CLI"] = 760,
    ["Xstate Machine"] = 862,
    ["Yandex Workflow Language"] = 980,
    ["Yarn Config (.yarnrc.yml)"] = 819,
    ["Yippee-Ki-JSON configuration YML"] = 811,
    ["YouTrack App"] = 977,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 18,
    apko = 931,
    ...
    ["arc.json"] = 29,
    ["architect.yml"] = 28,
    ["artifacthub-repo.yml"] = 32,
    ["asm-lsp"] = 33,
    ["babelrc.json"] = 75,
    ["bamboo-spec"] = 78,
    ["bashly-strings.yml"] = 909,
    ["batect.yml"] = 77,
    ["beef-database-codegen"] = 79,
    ["beef-database-v5-codegen"] = 81,
    ["beef-entity-codegen"] = 80,
    ["beef-entity-v5-codegen"] = 82,
    ["behat.yml"] = 93,
    ["bigquery-table"] = 83,
    ["bioimageio resource description"] = 947,
    ["bitbucket-pipelines"] = 85,
    bitrise = 86,
    ["bitrise-step"] = 87,
    ["block.json"] = 107,
    ["bottom configuration"] = 55,
    ["bower.json"] = 89,
    ["bozr.suite.json"] = 95,
    bpkg = 910,
    ["browser.i18n.json"] = 96,
    ["browsh configuration"] = 97,
    bucklescript = 98,
    ["buf.gen.yaml"] = 57,
    ["buf.plugin.yaml"] = 58,
    ["buf.work.yaml"] = 59,
    ["buf.yaml"] = 56,
    ["bun.lock"] = 103,
    ["bundleconfig.json"] = 104,
    ["bunfig.toml"] = 105,
    ["ccmod.json"] = 989,
    changelogging = 958,
    ["chisel-slices.json"] = 211,
    ["chrome-extension-locales-messages.json"] = 192,
    ["chutzpah.json"] = 193,
    cibuildwheel = 123,
    ["clang-format (.clang-format)"] = 868,
    ["clang-tidy"] = 172,
    clangd = 171,
    clib = 173,
    ["cloud-init: cloud-config userdata"] = 175,
    ["cloud-sdk-pipeline-configuration"] = 195,
    ["cloudbuild.json"] = 196,
    cloudify = 174,
    codemagic = 176,
    ["coffeelint.json"] = 213,
    ["commands.json"] = 188,
    ["commitlint (.commitlintrc)"] = 808,
    ["compile_commands.json"] = 187,
    ["compilerconfig.json"] = 186,
    ["completely.yml"] = 905,
    ["component-detection-manifest.json"] = 216,
    ["component.json"] = 215,
    ["composer.json"] = 214,
    ["conda-forge"] = 126,
    ["config.yaml"] = 584,
    ["contentmanifest.json"] = 194,
    ["contribute.json"] = 217,
    ["cosmos.config.json"] = 190,
    ["crowdin.yml"] = 218,
    ["ctfd-setup configuration file"] = 998,
    ["custom-elements.json"] = 919,
    ["cypress.json"] = 222,
    ["datalogic-scan2deploy-android"] = 232,
    ["datalogic-scan2deploy-ce"] = 233,
    ["dbt Dependencies"] = 139,
    ["dbt Packages"] = 141,
    ["dbt Project"] = 140,
    ["dbt Selectors"] = 142,
    ["dbt YAML files"] = 143,
    ["ddev-global"] = 234,
    ["ddev-project"] = 235,
    ["debugsettings.json"] = 236,
    ["dependabot-v2.json"] = 239,
    ["dependabot.json"] = 238,
    ["deployed-cli"] = 861,
    ["devcontainer.json"] = 178,
    devinit = 813,
    ["devspace.yaml"] = 884,
    djlint = 814,
    ["docker bake"] = 244,
    ["docker sequencer"] = 245,
    ["docker-compose.yml"] = 812,
    ["dockerd.json"] = 243,
    ["dotnet Release Index manifest"] = 256,
    ["dotnet-tools.json"] = 257,
    ["dotnetcli.host.json"] = 258,
    ["dprint.json"] = 259,
    ["drone.json"] = 260,
    ["dss-2.0.0.json"] = 262,
    ["dstack configuration"] = 263,
    ["dtool dataset metadata"] = 993,
    ["dvc.yaml"] = 264,
    ["ecosystem.json"] = 269,
    eksctl = 270,
    ["electron-builder configuration file"] = 276,
    ["epr-manifest.json"] = 275,
    ["evcc.yaml"] = 277,
    ["ezd task runner"] = 287,
    ["fabric.mod.json"] = 289,
    ["first-timers-bot"] = 296,
    ["flagd flag configuration"] = 70,
    ["fly.io Configuration"] = 71,
    fulibWorkflows = 843,
    ["function.json"] = 307,
    ["gRPC API Gateway & OpenAPI Config"] = 3,
    ["gematik health care insurance list"] = 1004,
    ["gematik health care patient list"] = 1001,
    ["gematik health care provider institution list"] = 1003,
    ["gematik health care provider list"] = 1002,
    ["gematik tiger test environment configuration"] = 1005,
    ["gitlab-ci"] = 324,
    ["global.json"] = 340,
    ["go-feature-flag Flag Configuration"] = 343,
    ["haxelib.json"] = 358,
    helmfile = 800,
    helmwave = 801,
    ["host-meta.json"] = 363,
    ...
    ["ide.host.json"] = 370,
    ["ifstate.conf"] = 371,
    ["imageoptimizer.json"] = 372,
    ["importmap.json"] = 375,
    ["ioBroker Configuration"] = 377,
    ["ioBroker JSON UI"] = 378,
    ["ioBroker Package manifest"] = 379,
    ["ize.toml"] = 896,
    ["jsconfig.json"] = 403,
    ["jscpd Configuration"] = 881,
    jsdoc = 796,
    ["k3d.yaml"] = 404,
    ["k9s aliases.yaml"] = 406,
    ["k9s cluster-config.yaml"] = 408,
    ["k9s config.yaml"] = 407,
    ["k9s hotkeys.yaml"] = 409,
    ["k9s plugins.yaml"] = 410,
    ["k9s skin.yaml"] = 411,
    ["k9s views.yaml"] = 412,
    ["kontinuous-config.yaml"] = 422,
    ["kontinuous-values.yaml"] = 421,
    ["kustomization.yaml"] = 424,
    ["label-commenter-config.yml"] = 425,
    ["latexindent configuration"] = 64,
    ["launchsettings.json"] = 426,
    lazydocker = 918,
    lazygit = 917,
    ["lego.json"] = 428,
    ["lerna.json"] = 429,
    ["lgtm.yml"] = 430,
    ["liblab.config.json"] = 431,
    ["libman.json"] = 432,
    ["license-report-config.json"] = 433,
    ["linkinator.config.json"] = 435,
    ["lint-staged (.lintstagedrc)"] = 776,
    ["local.settings.json"] = 440,
    ["localazy.json"] = 441,
    ["lotus.yaml"] = 439,
    ["lsdlschema.json"] = 442,
    ["markdown-link-check"] = 839,
    maturin = 840,
    mboats = 847,
    ["micro-settings.json"] = 911,
    ["mimetypes.json"] = 454,
    ["mirrord config"] = 777,
    mise = 778,
    ["mkdocs.yml"] = 474,
    ["monospace.yml"] = 477,
    ["moon.yml"] = 990,
    ["mprocs Configuration file"] = 962,
    ["mrdocs.yml"] = 475,
    ["mta.yaml"] = 779,
    ["mtad.yaml"] = 780,
    ["mycode.json"] = 484,
    ["napari plugin manifest"] = 485,
    neoload = 791,
    ["nest-cli"] = 490,
    ["ninjs (News in JSON)"] = 489,
    ["nitro.json"] = 790,
    ["nixd configuration"] = 935,
    ["nlu.json"] = 491,
    ["nodemon.json"] = 493,
    ["noodl config"] = 846,
    ["notebook.mod.json"] = 494,
    now = 786,
    ["npm-badges"] = 497,
    ["nswag.json"] = 501,
    ntangle = 503,
    ["nuclei-template.yaml"] = 498,
    ["nuget-project.json"] = 499,
    ["ocelot.json"] = 505,
    ["omnisharp.json"] = 509,
    ["openapi.json"] = 510,
    ["openfin.json"] = 517,
    ...
    ["ops.yaml"] = 514,
    ["package.json"] = 536,
    ["package.manifest"] = 537,
    ["partial-black.json"] = 94,
    ["pathfinder.yml"] = 540,
    ["pattern.json"] = 543,
    ["petstore-v1.0"] = 891,
    pgap_yaml_input_reader = 542,
    ["pixi.toml"] = 544,
    ["plagiarize-me.yaml"] = 548,
    ["plagiarize.yaml"] = 547,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 994,
    ["podbard.yaml"] = 550,
    ["portman.json"] = 551,
    ["prefect.toml"] = 559,
    ["prettierrc.json"] = 560,
    ["prisma.yml"] = 561,
    ["project-1.0.0-beta3.json"] = 564,
    ["project-1.0.0-beta4.json"] = 565,
    ["project-1.0.0-beta5.json"] = 566,
    ["project-1.0.0-beta6.json"] = 567,
    ["project-1.0.0-beta8.json"] = 568,
    ["project-1.0.0-rc1.json"] = 569,
    ["project-1.0.0-rc2.json"] = 570,
    ["project.json"] = 563,
    ["project.owasp.yaml"] = 571,
    ["prometheus.json"] = 572,
    ["prometheus.rules.json"] = 573,
    ["prometheus.rules.test.json"] = 574,
    ["proxies.json"] = 575,
    ["publiccode.yml"] = 576,
    ["pubspec.yaml"] = 577,
    ["pyrseas-0.8.json"] = 580,
    ["quilt.mod.json"] = 912,
    ["rc3 auth"] = 592,
    ["rc3 collection"] = 593,
    ["rc3 environment"] = 594,
    ...
    samt = 617,
    samtrc = 618,
    ["sarif-1.0.0.json"] = 620,
    ["sarif-2.0.0.json"] = 621,
    ["sarif-2.1.0"] = 631,
    ["sarif-2.1.0-rtm.2"] = 622,
    ["sarif-2.1.0-rtm.3"] = 624,
    ["sarif-2.1.0-rtm.4"] = 626,
    ["sarif-2.1.0-rtm.5"] = 628,
    ["sarif-2.1.0-rtm.6"] = 629,
    ["sarif-external-property-file-2.1.0"] = 632,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 623,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 625,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 627,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 630,
    ["scalingo.json configuration"] = 633,
    ["schema.org - Action"] = 635,
    ["schema.org - ContactPoint"] = 636,
    ["schema.org - Place"] = 637,
    ["schema.org - Thing"] = 638,
    ["secrethub.yml"] = 914,
    ["semantic-release"] = 644,
    ["servicehub.config.json"] = 771,
    ["servicehub.service.json"] = 770,
    ["settings.job"] = 647,
    ["sfdx-hardis configuration"] = 649,
    ["shard.yml"] = 950,
    ["size-limit configuration"] = 654,
    ["skaffold.yaml"] = 837,
    ["skyuxconfig.json"] = 656,
    snapcraft = 657,
    ["spicepod.yaml"] = 969,
    ["sqlc configuration"] = 670,
    ["stripe-app-local.json"] = 679,
    ["stripe-app.json"] = 678,
    swcrc = 822,
    ["task.json"] = 686,
    taskcat = 787,
    ["template.json"] = 691,
    ["templatsources.json"] = 692,
    ["theme.json"] = 695,
    ["tizen_workspace.json"] = 696,
    tldr = 697,
    tmuxinator = 774,
    ["transcend.yml"] = 707,
    ["tree-sitter grammar.json"] = 348,
    ["trime.yaml"] = 708,
    ["trunk.yaml"] = 710,
    ["ts-force-config.json"] = 715,
    ["tsconfig.json"] = 711,
    ["tsd.json"] = 712,
    ["tsdoc.json"] = 713,
    ["tsdrc.json"] = 714,
    ...
    v8r = 754,
    vcluster = 956,
    ["vcpkg configuration file"] = 183,
    ["vcpkg manifest file"] = 182,
    ["vega-lite.json"] = 736,
    ["vega.json"] = 735,
    ["venvironment-basic.yaml"] = 739,
    ["venvironment.yaml"] = 738,
    ["version.json"] = 741,
    ["vhwdebugger-binding.yaml"] = 743,
    ["vim-addon-info"] = 744,
    ["vs-2017.3.host.json"] = 746,
    ["vs-nesting.json"] = 747,
    ["vsls.json"] = 745,
    ["vss-extension.json"] = 751,
    ["vtesttree.yaml"] = 752,
    ["vtestunit.yaml"] = 753,
    ["warp-keysets.json"] = 920,
    ["warp-themes.json"] = 921,
    ["warp-workflows.json"] = 922,
    ["webhint.io"] = 877,
    ["webjobpublishsettings.json"] = 758,
    ["webjobs-list.json"] = 757,
    ["well-known-fursona"] = 957,
    ["xs-app.json"] = 783,
    ["xunit.runner.json"] = 769,
    yamllint = 810,
    ["zerops.io import file"] = 966,
    ["zerops.yml"] = 965,
    zuul = 793,
    ["Žinoma"] = 803
  },
