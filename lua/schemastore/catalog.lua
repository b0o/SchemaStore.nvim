...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 851,
    [".nodehawkrc"] = 519,
    [".npmpackagejsonlintrc"] = 523,
    [".omletrc"] = 1027,
    [".phrase.yml"] = 586,
    [".phraseapp.yml"] = 587,
    [".pmbot.yml"] = 574,
    [".postcssrc"] = 581,
    [".powerpages-web-template-manifest"] = 583,
    [".pre-commit-config.yml"] = 584,
    [".pre-commit-hooks.yml"] = 585,
    [".putout.json"] = 614,
    [".rehyperc"] = 638,
    [".remarkrc"] = 642,
    [".sprite files"] = 729,
    ...
    ["A micro editor config"] = 470,
    ABCInventoryModuleData = 18,
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1072,
    ["API Builder"] = 886,
    ["AVA Configuration"] = 948,
    ...
    ["AWS Copilot Manifest"] = 1110,
    ["AWS SAM CLI Samconfig"] = 220,
    ["Adobe UXP Manifest"] = 1010,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1101,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 920,
    ["All Contributors configuration file"] = 973,
    ["Ansible Argument Specs"] = 350,
    ["Ansible Collection Galaxy"] = 357,
    ["Ansible Execution Environment"] = 347,
    ["Ansible Inventory"] = 356,
    ["Ansible Meta"] = 348,
    ["Ansible Meta Runtime"] = 349,
    ["Ansible Navigator Configuration"] = 359,
    ["Ansible Playbook"] = 354,
    ["Ansible Requirements"] = 351,
    ["Ansible Rulebook"] = 355,
    ["Ansible Tasks File"] = 353,
    ["Ansible Vars File"] = 352,
    ["Ansible-lint Configuration"] = 358,
    Any = 1037,
    ["AnyWork Automation Configuration"] = 9,
    ["App config Spotify Backstage"] = 25,
    ["Application Accelerator"] = 6,
    ["Application list for a WinUtil"] = 1054,
    ArchitectFX = 1059,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure Pipelines"] = 79,
    ["Azure Static Web Apps CLI configuration file"] = 733,
    ["Azure Static Web Apps configuration file"] = 732,
    ["BOSH CPI Config"] = 103,
    ["BOSH Deploy Config"] = 104,
    ["BX CI"] = 123,
    ["Bashly (bashly.yml)"] = 977,
    ["Bashly Settings (bashly-settings.yml)"] = 978,
    ["Better Code Hub"] = 890,
    ["Better Scripts"] = 124,
    Bigconfig = 96,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1065,
    BizTalkServerApplicationSchema = 858,
    Bleep = 125,
    ...
    ["Butane Config"] = 933,
    C4InterFlow = 1080,
    ["CDK Environment Manager, concrete environment configuration"] = 1104,
    ["CDK Environment Manager, concrete environments definition"] = 1103,
    ["CDK Environment Manager, environment definition"] = 1102,
    ["CGS Card Game Specification (cgs.json)"] = 1015,
    ["CICS TS region tagging"] = 942,
    ["CICS TS resource import"] = 943,
    ["CICS TS resource model"] = 944,
    ["CICS TS resource overrides"] = 945,
    ["CMake Presets"] = 126,
    ["CNC Codes"] = 145,
    ["CRS WAF test file"] = 1044,
    ["CRS WAF test platform overrides file"] = 1045,
    ["CSS Comb (.csscomb.json)"] = 245,
    ["CSS Lint (.csslintrc)"] = 246,
    ["CSpell (cspell.json)"] = 244,
    ["CVE Record Format"] = 153,
    CWL = 1021,
    ...
    ["Chamaleon environment"] = 1069,
    ["Chamaleon properties"] = 1070,
    ["Chamaleon template"] = 1068,
    Changesets = 229,
    Charmcraft = 135,
    Cheatsheets = 930,
    ["Chrome Extension"] = 210,
    ["Chromia Model"] = 136,
    ["Chromia Seeder Module Config"] = 138,
    ["Chromia Seeder Root Config"] = 137,
    ["Cinnamon Spice info.json"] = 70,
    ["CircleCI config.yml"] = 186,
    ["Citation File Format"] = 231,
    CityJSON = 140,
    ["Claude Code Settings"] = 152,
    ["Clawject config"] = 151,
    ["Cloud Foundry Application Manifest"] = 1026,
    ["Cloud Run Spec v1"] = 1049,
    ["CloudCannon Configuration"] = 74,
    ["CloudEvents specification"] = 141,
    ["Code Climate"] = 187,
    CodeCV = 72,
    CodeRabbit = 71,
    ["CodeShip Pro services configuration files"] = 199,
    ["CodeShip Pro steps configuration files"] = 200,
    ["Codecov configuration files"] = 198,
    CodifyCLI = 73,
    Codux = 196,
    ["Cog config file"] = 146,
    ["Commandbox Box.json"] = 147,
    ["Commandbox Server.json"] = 148,
    ["Common Catalog Data"] = 208,
    ["Common Package Specification"] = 149,
    Concord = 1043,
    ["Configu .cfgu files"] = 1031,
    ["Configu .configu file"] = 1032,
    Conjure = 144,
    ["Container Structure Test"] = 872,
    Containerlab = 899,
    ["Contextive Glossary"] = 1096,
    Convex = 143,
    ["Crowdsec collection config"] = 239,
    ["Crowdsec parser config"] = 240,
    ["Crowdsec scenario config"] = 241,
    ["CumulusCI Config"] = 150,
    ["Custom Machinery Machine"] = 1016,
    ["Custom Machinery Recipe"] = 1017,
    ["Cycle Stack File"] = 154,
    CycloneDX = 155,
    ["DWP Exchange - catalogue entry"] = 288,
    ["DWP Exchange - gateway"] = 286,
    ["DWP Exchange - meta"] = 287,
    ["Dart Build Config (dart-build.json)"] = 247,
    ["Dart Test Config (dart-test.json)"] = 248,
    ["DashLord Configuration"] = 249,
    ["Data Contract Specification"] = 250,
    ["Data Product Specification"] = 251,
    ["DataYoga Connections"] = 156,
    ["DataYoga Job"] = 157,
    ["Databricks Asset Bundles"] = 994,
    ["Datadog Continuous Testing"] = 442,
    ["Datadog Service Definition"] = 443,
    ["Datadog Software Catalog"] = 444,
    ["Datahub Ingestion Recipe"] = 949,
    ["Dein Config"] = 163,
    ["Deno Config (deno.json)"] = 257,
    ["Dependency cruiser"] = 164,
    ["DeployStack Configuration"] = 165,
    ["Deployer Recipe"] = 260,
    ["Deta Spacefile"] = 166,
    ["Detekt Config (detekt.yml)"] = 261,
    ["Devbox Config"] = 167,
    ["Devbox Plugin"] = 168,
    Devfile = 285,
    DipDup = 1046,
    ["Discord Webhook"] = 262,
    ["DocFx Config (docfx.json)"] = 266,
    Dofigen = 267,
    ["Dolittle Artifacts"] = 268,
    ["Dolittle Bounded Context Configuration"] = 269,
    ["Dolittle Event Horizons Configuration"] = 270,
    ["Dolittle Resources Configuration"] = 271,
    ["Dolittle Server Configuration"] = 272,
    ["Dolittle Tenant Map Configuration"] = 274,
    ["Dolittle Tenants Configuration"] = 273,
    ["Dolittle Topology"] = 275,
    ["DonateCaseBetterCasino menu"] = 1073,
    ["Drupal Breakpoints"] = 169,
    ["Drupal Config"] = 181,
    ["Drupal Info"] = 170,
    ["Drupal Layouts"] = 171,
    ["Drupal Libraries"] = 172,
    ["Drupal Links Action"] = 173,
    ["Drupal Links Contextual"] = 174,
    ["Drupal Links Menu"] = 175,
    ["Drupal Links Task"] = 176,
    ["Drupal Migration"] = 177,
    ["Drupal Permissions"] = 178,
    ["Drupal Recipe"] = 179,
    ["Drupal Routing"] = 180,
    ["Drupal Services"] = 182,
    ["Drush site aliases"] = 281,
    ["Dynamic Bash Aliases (.aliases)"] = 985,
    ["EAS config"] = 305,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 974,
    ["EasyVCR .NET"] = 306,
    ["Eidolon Resource"] = 1060,
    ["Elgato Stream Deck"] = 291,
    Elm = 1048,
    ["Embrace Config"] = 960,
    Endurica = 998,
    ["Enterprise Contract Policy Spec"] = 292,
    ["Erda Pipeline"] = 1023,
    ["Erda Runtime"] = 1024,
    Esquio = 294,
    ["Estuary Flow Catalog"] = 939,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 298,
    ["EveryVoice TTS Toolkit Data Configuration"] = 299,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 303,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 302,
    ["EveryVoice TTS Toolkit Text Configuration"] = 300,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 301,
    ["Expo SDK"] = 304,
    ["F-Droid Data metadata"] = 310,
    ["FasterCI Configuration"] = 80,
    FiQuS = 314,
    Firebase = 312,
    ["FlexGet Config"] = 315,
    ["Flow.json Configurations"] = 1020,
    ["Fossa configuration file"] = 322,
    ["Fossa's fossa-deps file"] = 323,
    ["Foundry VTT - Base package Manifest"] = 317,
    ["Foundry VTT - Module Manifest"] = 318,
    ["Foundry VTT - System Data Template"] = 321,
    ["Foundry VTT - System Manifest"] = 319,
    ["Foundry VTT - World Manifest"] = 320,
    ["Foxx Manifest"] = 81,
    ["Freifunk.de Community API"] = 84,
    ["Frogbot Config"] = 85,
    ["G2P Mapping Configuration"] = 328,
    ["GCP Blueprint Metadata"] = 331,
    Gaspar = 329,
    ["GatewayCore API Gateway"] = 330,
    ["GeoJSON.json latest"] = 937,
    GherKing = 941,
    ["GitHub Action"] = 336,
    ["GitHub Actions typing"] = 1056,
    ["GitHub Discussion"] = 337,
    ["GitHub Funding"] = 338,
    ["GitHub Issue Template configuration"] = 339,
    ["GitHub Issue Template forms"] = 340,
    ["GitHub Workflow"] = 341,
    ["GitHub Workflow Template Properties"] = 342,
    ["GitHub automatically generated release notes configuration"] = 343,
    ["GitLab Agent for Kubernetes configuration"] = 1012,
    GitVersion = 333,
    ["Gitea Issue Template configuration"] = 334,
    ["Gitea Issue Template forms"] = 335,
    ["Gitpod Automations"] = 345,
    ["Gitpod Configuration"] = 346,
    ["GlazeWM settings"] = 1014,
    ["Global Privacy Control"] = 332,
    Goblet = 993,
    ["Golangci-lint Configuration"] = 361,
    ["Golangci-lint Custom Plugins Configuration"] = 362,
    ["Google Chrome Related Website Sets"] = 313,
    ["Google Cloud Workflows"] = 216,
    ["Google Digital Assetlinks"] = 1097,
    Goreleaser = 364,
    ["Goreleaser Pro"] = 365,
    Goss = 366,
    ["Gradle Build Cache Node"] = 888,
    ["Gradle Enterprise"] = 887,
    ["Grafana 5.x Dashboard"] = 367,
    ["GraphQL Code Generator"] = 371,
    ["GraphQL Config"] = 370,
    ["GraphQL Mesh"] = 369,
    ["Grunt JSHint task"] = 375,
    ["Grunt Watch task"] = 376,
    ["Grunt base task"] = 377,
    ["Grunt clean task"] = 373,
    ["Grunt copy task"] = 372,
    ["Grunt cssmin task"] = 374,
    HEMTT = 854,
    Hadolint = 868,
    Hammerkit = 898,
    ["Hardware Sentry Configuration"] = 953,
    ["HashiCorp Vault"] = 378,
    Hatch = 869,
    Hayson = 380,
    ["Haystack Pipeline"] = 381,
    ["Hazelcast 5 Configuration"] = 382,
    ["Hecate Input Schema"] = 1108,
    ["Helm Chart.lock"] = 184,
    ["Helm Chart.yaml"] = 183,
    ["Helm Unittest Test Suite"] = 185,
    ["Home Assistant Integration Manifest"] = 383,
    ["Homer dashboard configuration"] = 384,
    Hugo = 929,
    ["Hugo Theme"] = 928,
    ["Hyperfoil benchmark configuration"] = 390,
    ["IBM Zapp document"] = 391,
    ["IBM zCodeFormatSettings"] = 392,
    ["IMG Catapult PSP"] = 397,
    ["IVMS101 by CODE Protocol"] = 1013,
    Infrahub = 399,
    Istanbul = 956,
    ["JDownloader2 crawler multi-rules"] = 409,
    ["JDownloader2 crawler single-rules"] = 408,
    ["JFrog Applications Config"] = 410,
    ["JFrog File Spec"] = 411,
    ["JFrog Pipelines YML DSL"] = 962,
    ["JMeter DSL cli config"] = 412,
    JReleaser = 415,
    ["JSON Document Transform"] = 423,
    ["JSON Feed"] = 424,
    ["JSON Resume"] = 648,
    ["JSON Schema Draft 2020-12"] = 837,
    ["JSON Schema Draft 4"] = 834,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 995,
    ["JSON Schema Draft 7"] = 835,
    ["JSON Schema Draft 7 (unofficial strict)"] = 996,
    ["JSON Schema Draft 8 (2019-09)"] = 836,
    ["JSON-API"] = 422,
    ["JSON-e templates"] = 895,
    ["JSON-stat 2.0"] = 830,
    JSONPatch = 426,
    ["JSR Package Config (jsr.json)"] = 416,
    Jasmine = 403,
    Jekyll = 404,
    ["Jenkins X Pipelines"] = 405,
    ["Jenkins X Requirements"] = 406,
    Jest = 407,
    Jocker = 413,
    ["Jovo Language Models"] = 414,
    ["Jujutsu (jj) VCS config"] = 1109,
    ["KIMMDY config file"] = 437,
    ["KODE/CI build.yaml"] = 958,
    ["KSP-AVC"] = 831,
    ["KSP-CKAN"] = 832,
    ["KSP-NetKAN"] = 833,
    KSY = 1025,
    KSail = 326,
    ["Karakum configuration file"] = 324,
    Kas = 429,
    ["Kestra flow file"] = 438,
    ["Keycloak REST API"] = 965,
    ["Knative Functions - func.yaml"] = 325,
    ["Kometa (nightly) config file"] = 440,
    ["Kometa config file"] = 439,
    ["Kong DBLess config"] = 959,
    KrakenD = 441,
    ["Kubri Configuration"] = 448,
    LOOBin = 463,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 221,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 222,
    ["Landing Zone Accelerator on AWS - Global Config"] = 223,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 224,
    ["Landing Zone Accelerator on AWS - Network Config"] = 225,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 226,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 227,
    ["Landing Zone Accelerator on AWS - Security Config"] = 228,
    ["Lando (landofile)"] = 75,
    ["LangGraph Platform configuration"] = 1036,
    ["Language configuration"] = 1035,
    Lefthook = 452,
    ["Liferay client-extension.yaml"] = 459,
    ["LinkML Metamodel"] = 461,
    Liquibase = 904,
    ["Liquibase Flow File"] = 905,
    ["Lively Properties"] = 462,
    ["Lobe AI Agent"] = 77,
    Loki = 78,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 502,
    ["MS2Rescore Configuration"] = 505,
    ["Madness (madness.yml)"] = 976,
    ["MapEHR Mapping"] = 469,
    Markdownlint = 908,
    ["Mason Registry"] = 911,
    ["MegaLinter Custom Flavor"] = 472,
    ["MegaLinter configuration"] = 471,
    ["MegaLinter descriptor"] = 473,
    Melange = 1003,
    ["Meltano project definition"] = 474,
    ["Mergify Configuration"] = 506,
    ["Metadata for a Bazel module"] = 475,
    ["Metadata for a Cinnamon spice"] = 1052,
    ["Metatype Configuration"] = 476,
    ["MetricsHub Configuration"] = 477,
    ["MetricsHub Connector Configuration"] = 478,
    ["Micro Editor Syntax"] = 986,
    ["Microsoft Band Web Tile"] = 479,
    ["Microsoft RulesEngine workflow rules"] = 1040,
    ["Microsoft RulesEngine workflow rules list"] = 1041,
    ["Minecraft Custom Main Menu Mod"] = 1004,
    ["Minecraft Data Pack Advancement"] = 481,
    ["Minecraft Data Pack Biome"] = 482,
    ["Minecraft Data Pack Configured Carver"] = 483,
    ["Minecraft Data Pack Damage Type"] = 484,
    ["Minecraft Data Pack Dimension"] = 486,
    ["Minecraft Data Pack Dimension Type"] = 485,
    ["Minecraft Data Pack Item Modifier"] = 487,
    ["Minecraft Data Pack Loot Table"] = 488,
    ["Minecraft Data Pack Metadata"] = 489,
    ["Minecraft Data Pack Predicate"] = 490,
    ["Minecraft Data Pack Recipe"] = 491,
    ["Minecraft Data Pack Tag"] = 492,
    ["Minecraft Data Pack Template Pool"] = 493,
    ["Minecraft Data Pack Trim Material"] = 498,
    ["Minecraft Data Pack Trim Pattern"] = 499,
    ["Minecraft Resource Pack Lang"] = 494,
    ["Minecraft Resource Pack Particle"] = 495,
    ["Minecraft Resource Pack Texture Mcmeta"] = 497,
    ["Minecraft Resourcepack Sounds"] = 496,
    ["Monade CLI Stack Configuration"] = 509,
    ["MongoDB Atlas Search Index Definition"] = 957,
    ["Monika Configuration"] = 955,
    ["Monoweave Configuration"] = 504,
    ["Motif config"] = 850,
    MultiQC = 1090,
    ["NOX Framework (Service)"] = 522,
    ["Netin Diagnostic System Template"] = 915,
    ["Netlify config"] = 512,
    ["Network-as-Code Data Model"] = 513,
    ["Nightwatch.js"] = 515,
    ["Node.js configuration"] = 855,
    ["NueJS configuration file"] = 527,
    ["Nuitka.yaml"] = 1018,
    ["Nullstone config"] = 529,
    ["ONe's changelog entry"] = 543,
    ["ONe's service descriptor"] = 542,
    ["ORT Server repository environment configuration"] = 551,
    ["OSCAL Assessment Plan (AP)"] = 553,
    ["OSCAL Assessment Results (AR)"] = 554,
    ["OSCAL Catalog"] = 555,
    ["OSCAL Component Definition (CDef)"] = 556,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 557,
    ["OSCAL Profile"] = 558,
    ["OSCAL System Security Plan (SSP)"] = 559,
    ["OSS Review Toolkit configuration"] = 560,
    ["OSS Review Toolkit curation"] = 561,
    ["OSS Review Toolkit package configuration"] = 562,
    ["OSS Review Toolkit repository configuration"] = 563,
    ["OSS Review Toolkit resolutions"] = 564,
    ["October CMS columns"] = 533,
    ["October CMS fields"] = 534,
    Okteto = 535,
    Opctl = 853,
    ["Open Data Contract Standard (ODCS)"] = 546,
    ["Open Data Product Standard (ODPS)"] = 547,
    ["Open Know-How"] = 1095,
    ["OpenRewrite Resource"] = 545,
    OpenStatus = 1106,
    ["OpenUtau character yaml"] = 539,
    ["OpenUtau ustx"] = 540,
    ["OpenWeather Current Weather API"] = 894,
    ["OpenWeather Road Risk API"] = 893,
    ["Ory Hydra configuration"] = 389,
    ["Ory Keto configuration"] = 445,
    ["Ory Kratos configuration"] = 552,
    ["Ory Oathkeeper configuration"] = 531,
    ["Outblocks App configuration"] = 549,
    ["Outblocks database table"] = 550,
    ["Outblocks project configuration"] = 548,
    PDM = 570,
    Packer = 567,
    Pantsbuild = 972,
    ["Paper paper-plugin.yml"] = 568,
    ["Pipeline component"] = 906,
    ["Platform.sh application"] = 2,
    ["Platform.sh routes"] = 3,
    ["Platform.sh services"] = 4,
    ["Plex Prerolls"] = 578,
    ["PocketMine plugin.yml"] = 575,
    ["Postman collection"] = 582,
    ["Power Pages Configuration"] = 1107,
    ["Preset list for a WinUtil"] = 1055,
    ["ProActions AI-Kit Configuration"] = 591,
    ["ProActions AI-Kit Configuration for Menus"] = 593,
    ["ProActions AI-Kit Configuration for Sections"] = 595,
    ["ProActions AI-Kit Configuration for Services"] = 592,
    ["ProActions AI-Kit Configuration for Steps"] = 596,
    ["ProActions AI-Kit Configuration for Templates"] = 594,
    ["Problem object RFC9457"] = 1001,
    ["Problem package generators"] = 597,
    Pterodactyl = 952,
    ["Pull Request Labeler"] = 613,
    Pulumi = 621,
    ["PyGTA Config"] = 617,
    PyProject = 622,
    Pylock = 1098,
    Pyright = 623,
    ["Python script metadata"] = 1092,
    ["QType AI DSL"] = 626,
    Qgoda = 625,
    Qodana = 925,
    ["Qt Creator workspace file"] = 1033,
    ["Quali Torque Blueprint Spec 2"] = 950,
    ["QueryFirst config file"] = 968,
    ["RKE Cluster Configuration JSON"] = 903,
    ["RKE Cluster Configuration YAML"] = 902,
    RadioHound = 616,
    Railway = 627,
    ["Rancher Fleet"] = 618,
    ["Rattler-build"] = 628,
    Ray = 867,
    ["Read the Docs"] = 620,
    ["Red-DiscordBot Cog"] = 635,
    ["Red-DiscordBot Cog Repo"] = 636,
    ["Red-DiscordBot Trivia"] = 637,
    ["Render Blueprints"] = 901,
    RenderCV = 650,
    Renovate = 649,
    ["Replit config"] = 643,
    Restate = 1085,
    RoadRunner = 652,
    ["Roo Coder Custom Modes"] = 654,
    Rubocop = 645,
    ["Rudder techniques"] = 1008,
    Ruff = 646,
    ["Rust Project"] = 647,
    ["Rust toolchain"] = 657,
    ["SDMX data message"] = 683,
    ["SDMX metadata message"] = 682,
    ["SDMX structure message"] = 681,
    ["SIL Kit Participant Configuration"] = 693,
    ["SIL Kit Registry Configuration"] = 694,
    ["SPDX 2.3"] = 730,
    SWADL = 744,
    ["Safebox Config"] = 963,
    ["Sapphire CLI Config"] = 660,
    ["SauceCTL Configuration"] = 912,
    ["Schema Catalog"] = 675,
    ["Scoop manifest"] = 680,
    ["Semantic Data Fabric (SDF) file"] = 684,
    ["Semgrep Rule"] = 686,
    ["Serenity Code Generator (Sergen)"] = 687,
    ["Serverless Framework Configuration"] = 919,
    ["Serverless Workflow"] = 921,
    ["Settings for a Cinnamon spice"] = 1051,
    ["Settings.paf"] = 689,
    ["Shopware 6 Configuration"] = 922,
    ["Shopware CLI Extension Store Configuration"] = 923,
    ["Shopware CLI Project Store Configuration"] = 924,
    ["Sigma Detection Rule"] = 691,
    ["Sigrid scope configuration file"] = 692,
    ["SkyPilot Task JSON"] = 1009,
    ["Slack app manifest"] = 696,
    Solidarity = 701,
    ["Solution filters"] = 702,
    ["Source Maps v3"] = 703,
    Sourcery = 704,
    ["Spack bootstrap.yaml"] = 705,
    ["Spack cdash.yaml"] = 706,
    ["Spack ci.yaml"] = 707,
    ["Spack compilers.yaml"] = 708,
    ["Spack concretizer.yaml"] = 709,
    ["Spack config.yaml"] = 710,
    ["Spack definitions.yaml"] = 711,
    ["Spack develop.yaml"] = 712,
    ["Spack env_vars.yaml"] = 713,
    ["Spack environment"] = 719,
    ["Spack include.yaml"] = 714,
    ["Spack mirrors.yaml"] = 715,
    ["Spack modules.yaml"] = 716,
    ["Spack packages.yaml"] = 717,
    ["Spack repos.yaml"] = 718,
    ["Spack toolchains.yaml"] = 720,
    ["Spack upstreams.yaml"] = 721,
    ["Spack view.yaml"] = 722,
    ["Speakeasy Generation Config File"] = 726,
    ["Speakeasy Lint Configuration File"] = 723,
    ["Speakeasy Test Generation Configuration File"] = 724,
    ["Speakeasy Workflow File"] = 725,
    SpecIF = 727,
    ["Sponge Mixin configuration"] = 728,
    StackBlitz = 734,
    ["StackHawk Scanner Configuration"] = 918,
    Stale = 735,
    ["Starlake Data Pipeline"] = 891,
    Starship = 736,
    ["Statamic Blueprint"] = 737,
    ["Stella configuration file"] = 738,
    ["Stryker Mutator"] = 741,
    ["StyleCop Analyzers Configuration"] = 742,
    ["Stylelint (.stylelintrc)"] = 743,
    ["Stylua Config"] = 1099,
    ["Sublime Syntax"] = 964,
    ["Subsquid squid manifest"] = 1011,
    ["Swagger API 2.0"] = 745,
    ["Synadia Connect Component"] = 746,
    TSON = 780,
    TSTyche = 781,
    ["TYPO3 Vendor Bundler config"] = 786,
    ["Tab data for a LinUtil"] = 1058,
    ["Tab list for a LinUtil"] = 1057,
    Tach = 747,
    ["Tach Domain"] = 748,
    Talhelper = 750,
    ["Talisman configuration"] = 751,
    Taplo = 1100,
    ["Taskfile config"] = 896,
    Taurus = 752,
    Tauticord = 753,
    Telefonistka = 1086,
    ["TestEnvironment.json"] = 763,
    ["TextMate Grammar"] = 762,
    ["Tier.run pricing.json"] = 756,
    Tikibase = 757,
    Tombi = 761,
    ["Traefik v2"] = 766,
    ["Traefik v2 File Provider"] = 767,
    ["Traefik v3"] = 768,
    ["Traefik v3 File Provider"] = 769,
    ["Travis CI (.travis.yml)"] = 765,
    Trident = 1082,
    ["TrueScript for *.tscript files"] = 772,
    ["Tugboat QA config.yml"] = 1079,
    TunnelHub = 999,
    Turborepo = 764,
    Tycho = 1047,
    Tye = 926,
    ["Tyk Gateway - Open Source v5.7+"] = 1091,
    ["Typst Manifest"] = 787,
    ["UET BuildConfig.json"] = 969,
    ["UI5 Manifest"] = 793,
    ["UNCORS configuration"] = 797,
    ["UTAM Page Object"] = 796,
    ["Ubuntu Server Autoinstall"] = 791,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1083,
    ["Uniswap Token List"] = 879,
    ["Universal Schedule Format"] = 798,
    ["Unreal Engine Uplugin"] = 970,
    ["Unreal Engine Uproject"] = 971,
    ["UpCloud CLI (upctl) configuration"] = 1084,
    ["Updatecli Compose"] = 934,
    ["Updatecli Policy Manifest"] = 935,
    ["Updatecli Policy Metadata"] = 936,
    Uplift = 967,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 900,
    V2Ray = 940,
    ["VSCode Code Snippets"] = 204,
    ["VSIX CLI publishing"] = 818,
    Vector = 800,
    ["Vela Pipeline Configuration"] = 803,
    Vercel = 203,
    ["Version Bumper config"] = 808,
    ["Viash Component Config"] = 1088,
    ["Viash Package Config"] = 1089,
    Visivo = 997,
    ["WP-CLI"] = 828,
    Wake = 1081,
    ["Waku Config"] = 1061,
    ["Web App Manifest"] = 824,
    ["Web types"] = 827,
    WebExtensions = 823,
    ["Webman package recipe"] = 946,
    ["Windows Package Manager Installer Manifest"] = 875,
    ["Windows Package Manager Locale Manifest"] = 876,
    ["Windows Package Manager Singleton Manifest"] = 874,
    Winutil = 877,
    ["WireMock stub mapping"] = 1064,
    ["Woodpecker pipeline config"] = 914,
    ["Wrangler CLI"] = 829,
    ["Xstate Machine"] = 932,
    ["Yandex Workflow Language"] = 1053,
    ["Yarn Config (.yarnrc.yml)"] = 889,
    ["Yippee-Ki-JSON configuration YML"] = 881,
    ["YouTrack App"] = 1050,
    ["Zerops.io config"] = 1038,
    ["Zerops.io import"] = 1039,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 1002,
    ...
    ["behat.yml"] = 106,
    ["bigquery-table"] = 95,
    ["bioimageio resource description"] = 1019,
    ...
    ["ccmod.json"] = 1062,
    changelogging = 1030,
    ["chisel-slices.json"] = 230,
    ["chrome-extension-locales-messages.json"] = 211,
    ["chutzpah.json"] = 212,
    cibuildwheel = 139,
    ["clang-format (.clang-format)"] = 938,
    ["clang-tidy"] = 191,
    clangd = 190,
    clib = 192,
    ["cloud-init: cloud-config userdata"] = 194,
    ["cloud-sdk-pipeline-configuration"] = 214,
    ["cloudbuild.json"] = 215,
    cloudify = 193,
    codemagic = 195,
    ["coffeelint.json"] = 232,
    ["commands.json"] = 207,
    ["commitlint (.commitlintrc)"] = 878,
    ["committed.toml"] = 233,
    ["compile_commands.json"] = 206,
    ["compilerconfig.json"] = 205,
    ["completely.yml"] = 975,
    ["component-detection-manifest.json"] = 236,
    ["component.json"] = 235,
    ["composer.json"] = 234,
    ["conda-forge"] = 142,
    ["config.yaml"] = 619,
    ["contentmanifest.json"] = 213,
    ["contribute.json"] = 237,
    ["cosmos.config.json"] = 209,
    ["crowdin.yml"] = 238,
    ["ctfd-setup configuration file"] = 1071,
    ["custom-elements.json"] = 989,
    ["cypress.json"] = 242,
    ["datalogic-scan2deploy-android"] = 252,
    ["datalogic-scan2deploy-ce"] = 253,
    ["dbt Dependencies"] = 158,
    ["dbt Packages"] = 160,
    ["dbt Project"] = 159,
    ["dbt Selectors"] = 161,
    ["dbt YAML files"] = 162,
    ["ddev-global"] = 254,
    ["ddev-project"] = 255,
    ["debugsettings.json"] = 256,
    ["dependabot-v2.json"] = 259,
    ["dependabot.json"] = 258,
    ["deployed-cli"] = 931,
    ["devcontainer.json"] = 197,
    devinit = 883,
    ["devspace.yaml"] = 954,
    djlint = 884,
    ["docker bake"] = 264,
    ["docker sequencer"] = 265,
    ["docker-compose.yml"] = 882,
    ["dockerd.json"] = 263,
    ["dotnet Release Index manifest"] = 276,
    ["dotnet-tools.json"] = 277,
    ["dotnetcli.host.json"] = 278,
    ["dprint.json"] = 279,
    ["drone.json"] = 280,
    ["dss-2.0.0.json"] = 282,
    ["dstack configuration"] = 283,
    ["dtool dataset metadata"] = 1066,
    ["dvc.yaml"] = 284,
    ["ecosystem.json"] = 289,
    eksctl = 290,
    ["electron-builder configuration file"] = 296,
    ["epr-manifest.json"] = 295,
    ["evcc.yaml"] = 297,
    ["ezd task runner"] = 307,
    ["fabric.mod.json"] = 309,
    ["first-timers-bot"] = 316,
    ["flagd flag configuration"] = 82,
    ["fly.io Configuration"] = 83,
    fulibWorkflows = 913,
    ["function.json"] = 327,
    ["gRPC API Gateway & OpenAPI Config"] = 7,
    ["gematik health care insurance list"] = 1077,
    ["gematik health care patient list"] = 1074,
    ["gematik health care provider institution list"] = 1076,
    ["gematik health care provider list"] = 1075,
    ["gematik tiger test environment configuration"] = 1078,
    ["gitlab-ci"] = 344,
    ["global.json"] = 360,
    ["go-feature-flag Flag Configuration"] = 363,
    ["haxelib.json"] = 379,
    helmfile = 870,
    helmwave = 871,
    ["host-meta.json"] = 386,
    ...
    ["ide.host.json"] = 393,
    ["ifstate.conf"] = 394,
    ["imageoptimizer.json"] = 395,
    ["importmap.json"] = 398,
    ["ioBroker Configuration"] = 400,
    ["ioBroker JSON UI"] = 401,
    ["ioBroker Package manifest"] = 402,
    ["ize.toml"] = 966,
    ["jsconfig.json"] = 427,
    ["jscpd Configuration"] = 951,
    jsdoc = 866,
    ["k3d.yaml"] = 428,
    ["k9s aliases.yaml"] = 430,
    ["k9s cluster-config.yaml"] = 432,
    ["k9s config.yaml"] = 431,
    ["k9s hotkeys.yaml"] = 433,
    ["k9s plugins.yaml"] = 434,
    ["k9s skin.yaml"] = 435,
    ["k9s views.yaml"] = 436,
    ["kontinuous-config.yaml"] = 447,
    ["kontinuous-values.yaml"] = 446,
    ["kustomization.yaml"] = 449,
    ["label-commenter-config.yml"] = 450,
    ["latexindent configuration"] = 76,
    ["launchsettings.json"] = 451,
    lazydocker = 988,
    lazygit = 987,
    ["lego.json"] = 453,
    ["lerna.json"] = 454,
    ["lgtm.yml"] = 455,
    ["liblab.config.json"] = 456,
    ["libman.json"] = 457,
    ["license-report-config.json"] = 458,
    ["linkinator.config.json"] = 460,
    ["lint-staged (.lintstagedrc)"] = 845,
    ["local.settings.json"] = 465,
    ["localazy.json"] = 466,
    ["lotus.yaml"] = 464,
    ["lsdlschema.json"] = 467,
    ["markdown-link-check"] = 909,
    maturin = 910,
    mboats = 917,
    ["micro-settings.json"] = 981,
    ["mimetypes.json"] = 480,
    ["mirrord config"] = 846,
    mise = 847,
    ["mkdocs.yml"] = 500,
    ["monospace.yml"] = 503,
    ["moon.yml"] = 1063,
    ["mprocs Configuration file"] = 1034,
    ["mrdocs.yml"] = 501,
    ["mta.yaml"] = 848,
    ["mtad.yaml"] = 849,
    ["mycode.json"] = 510,
    nFPM = 514,
    ["napari plugin manifest"] = 511,
    neoload = 861,
    ["nest-cli"] = 517,
    ["ninjs (News in JSON)"] = 516,
    ["nitro.json"] = 860,
    ["nixd configuration"] = 1007,
    ["nlu.json"] = 518,
    ["nodemon.json"] = 520,
    ["noodl config"] = 916,
    ["notebook.mod.json"] = 521,
    now = 856,
    ["npm-badges"] = 524,
    ["nswag.json"] = 528,
    ntangle = 530,
    ["nuclei-template.yaml"] = 525,
    ["nuget-project.json"] = 526,
    ["ocelot.json"] = 532,
    ["omnisharp.json"] = 536,
    ["openapi.json"] = 537,
    ["openfin.json"] = 544,
    ...
    ["ops.yaml"] = 541,
    ["package.json"] = 565,
    ["package.manifest"] = 566,
    ["partial-black.json"] = 107,
    ["pathfinder.yml"] = 569,
    ["pattern.json"] = 572,
    ["petstore-v1.0"] = 961,
    pgap_yaml_input_reader = 571,
    ["pixi.toml"] = 573,
    ["plagiarize-me.yaml"] = 577,
    ["plagiarize.yaml"] = 576,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1067,
    ["podbard.yaml"] = 579,
    ["portman.json"] = 580,
    ["prefect.toml"] = 588,
    ["prettierrc.json"] = 589,
    ["prisma.yml"] = 590,
    ["project-1.0.0-beta3.json"] = 599,
    ["project-1.0.0-beta4.json"] = 600,
    ["project-1.0.0-beta5.json"] = 601,
    ["project-1.0.0-beta6.json"] = 602,
    ["project-1.0.0-beta8.json"] = 603,
    ["project-1.0.0-rc1.json"] = 604,
    ["project-1.0.0-rc2.json"] = 605,
    ["project.json"] = 598,
    ["project.owasp.yaml"] = 606,
    ["prometheus.json"] = 607,
    ["prometheus.rules.json"] = 608,
    ["prometheus.rules.test.json"] = 609,
    ["proxies.json"] = 610,
    ["publiccode.yml"] = 611,
    ["pubspec.yaml"] = 612,
    ["pyrseas-0.8.json"] = 615,
    pytest = 624,
    ["quilt.mod.json"] = 982,
    ["rc3 auth"] = 629,
    ["rc3 collection"] = 630,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 862,
    ["release-please-config.json"] = 639,
    ["release-please-manifest.json"] = 640,
    ["release-plz.toml"] = 641,
    ["renv.lock"] = 651,
    ["rivet.json"] = 1006,
    ["rivet.yaml (legacy)"] = 1005,
    rockcraft = 653,
    runny = 655,
    rustfmt = 656,
    sake = 1094,
    samt = 658,
    samtrc = 659,
    ["sarif-1.0.0.json"] = 661,
    ["sarif-2.0.0.json"] = 662,
    ["sarif-2.1.0"] = 672,
    ["sarif-2.1.0-rtm.2"] = 663,
    ["sarif-2.1.0-rtm.3"] = 665,
    ["sarif-2.1.0-rtm.4"] = 667,
    ["sarif-2.1.0-rtm.5"] = 669,
    ["sarif-2.1.0-rtm.6"] = 670,
    ["sarif-external-property-file-2.1.0"] = 673,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 664,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 666,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 668,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 671,
    ["scalingo.json configuration"] = 674,
    ["schema.org - Action"] = 676,
    ["schema.org - ContactPoint"] = 677,
    ["schema.org - Place"] = 678,
    ["schema.org - Thing"] = 679,
    ["secrethub.yml"] = 984,
    ["semantic-release"] = 685,
    ["servicehub.config.json"] = 840,
    ["servicehub.service.json"] = 839,
    ["settings.job"] = 688,
    ["sfdx-hardis configuration"] = 690,
    ["shard.yml"] = 1022,
    ["size-limit configuration"] = 695,
    ["skaffold.yaml"] = 907,
    ["skyuxconfig.json"] = 697,
    snapcraft = 698,
    ["snowflake-config"] = 699,
    ["snowflake-connections"] = 700,
    ["spicepod.yaml"] = 1042,
    ["sqlc configuration"] = 731,
    ["stripe-app-local.json"] = 740,
    ["stripe-app.json"] = 739,
    swcrc = 892,
    ["task.json"] = 749,
    taskcat = 857,
    ["template.json"] = 754,
    ["templatsources.json"] = 755,
    ["theme.json"] = 758,
    ["tizen_workspace.json"] = 759,
    tldr = 760,
    ["tm_devices configuration file"] = 1105,
    tmuxinator = 843,
    ["transcend.yml"] = 770,
    ["tree-sitter grammar.json"] = 368,
    ["trime.yaml"] = 771,
    ["trunk.yaml"] = 773,
    ["ts-force-config.json"] = 778,
    ["tsconfig.json"] = 774,
    ["tsd.json"] = 775,
    ["tsdoc.json"] = 776,
    ["tsdrc.json"] = 777,
    ...
    v8r = 822,
    vcluster = 1028,
    ["vcpkg configuration file"] = 202,
    ["vcpkg manifest file"] = 201,
    ["vega-lite.json"] = 802,
    ["vega.json"] = 801,
    ["venvironment-basic.yaml"] = 805,
    ["venvironment.yaml"] = 804,
    ["venvplus-basic.yaml"] = 807,
    ["venvplus.yaml"] = 806,
    version = 1087,
    ["version.json"] = 809,
    ["vhwdebugger-binding.yaml"] = 811,
    ["vim-addon-info"] = 812,
    ["vs-2017.3.host.json"] = 814,
    ["vs-nesting.json"] = 815,
    ["vsls.json"] = 813,
    ["vss-extension.json"] = 819,
    vtcfg = 1093,
    ["vtesttree.yaml"] = 820,
    ["vtestunit.yaml"] = 821,
    ["warp-keysets.json"] = 990,
    ["warp-themes.json"] = 991,
    ["warp-workflows.json"] = 992,
    ["webhint.io"] = 947,
    ["webjobpublishsettings.json"] = 826,
    ["webjobs-list.json"] = 825,
    ["well-known-fursona"] = 1029,
    ["xs-app.json"] = 852,
    ["xunit.runner.json"] = 838,
    yamllint = 880,
    zuul = 863,
    ["Žinoma"] = 873
  },
