...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 923,
    [".nodehawkrc"] = 570,
    [".npmpackagejsonlintrc"] = 574,
    [".omletrc"] = 1102,
    [".phrase.yml"] = 645,
    [".phraseapp.yml"] = 646,
    [".pmbot.yml"] = 631,
    [".postcssrc"] = 640,
    [".powerpages-web-template-manifest"] = 642,
    [".pre-commit-config.yml"] = 643,
    [".pre-commit-hooks.yml"] = 644,
    [".putout.json"] = 679,
    [".rehyperc"] = 704,
    [".remarkrc"] = 708,
    [".sprite files"] = 799,
    ...
    AIConfig = 31,
    ["AMX Muse Program Descriptor"] = 1150,
    ["API Builder"] = 958,
    ["AVA Configuration"] = 1021,
    ...
    ["AWS Copilot Manifest"] = 1189,
    ["AWS SAM CLI Samconfig"] = 255,
    ["Adobe UXP Manifest"] = 1084,
    ["Aerleon Network & Service Definitions"] = 18,
    ["Aerleon Policy"] = 19,
    Aider = 1179,
    Air = 21,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1200,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1199,
    ["Airlock Microgateway"] = 32,
    ["Alacritty Configuration"] = 993,
    ["All Contributors configuration file"] = 1047,
    ["Ansible Argument Specs"] = 391,
    ["Ansible Collection Galaxy"] = 398,
    ["Ansible Execution Environment"] = 388,
    ["Ansible Inventory"] = 397,
    ["Ansible Meta"] = 389,
    ["Ansible Meta Runtime"] = 390,
    ["Ansible Navigator Configuration"] = 400,
    ["Ansible Playbook"] = 395,
    ["Ansible Requirements"] = 392,
    ["Ansible Rulebook"] = 396,
    ["Ansible Tasks File"] = 394,
    ["Ansible Vars File"] = 393,
    ["Ansible-lint Configuration"] = 399,
    Any = 1112,
    ...
    ["Application list for a WinUtil"] = 1129,
    ArchitectFX = 1134,
    ["Argo CD"] = 51,
    ["Argo Events"] = 52,
    ["Argo Workflows"] = 53,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1198,
    ["Azure IoT Operations connector metadata"] = 1195,
    ...
    ["Azure Pipelines"] = 107,
    ["Azure Static Web Apps CLI configuration file"] = 803,
    ["Azure Static Web Apps configuration file"] = 802,
    BMML = 1217,
    ["BOSH CPI Config"] = 132,
    ["BOSH Deploy Config"] = 133,
    ["BX CI"] = 152,
    ["Bacon config"] = 3,
    ["Bashly (bashly.yml)"] = 1051,
    ["Bashly Settings (bashly-settings.yml)"] = 1052,
    Bento = 1216,
    ["Better Code Hub"] = 963,
    ["Better Scripts"] = 153,
    Bigconfig = 125,
    ["Biome Formatter Config"] = 79,
    ["Bitmovin Encoding Template"] = 1143,
    BizTalkServerApplicationSchema = 930,
    Bleep = 154,
    ["Block Protocol Metadata"] = 151,
    ["Bluebricks blueprint config"] = 1222,
    ["Boyka Framework"] = 134,
    Briefcase = 936,
    ["Build Info"] = 142,
    Buildkite = 144,
    ...
    ["Butane Config"] = 1006,
    C4InterFlow = 1158,
    ["CDK Environment Manager, concrete environment configuration"] = 1182,
    ["CDK Environment Manager, concrete environments definition"] = 1181,
    ["CDK Environment Manager, environment definition"] = 1180,
    ["CGS Card Game Specification (cgs.json)"] = 1089,
    ["CICS TS region tagging"] = 1015,
    ["CICS TS resource import"] = 1016,
    ["CICS TS resource model"] = 1017,
    ["CICS TS resource overrides"] = 1018,
    ["CMake Presets"] = 155,
    ["CNC Codes"] = 176,
    ["CRS WAF test file"] = 1119,
    ["CRS WAF test platform overrides file"] = 1120,
    ...
    ["Chamaleon environment"] = 1147,
    ["Chamaleon properties"] = 1148,
    ["Chamaleon template"] = 1146,
    Changepacks = 1209,
    Changesets = 264,
    Changie = 164,
    Charmcraft = 165,
    ...
    ["Clawject config"] = 182,
    ["Cloud Foundry Application Manifest"] = 1101,
    ["Cloud Run Spec v1"] = 1124,
    ...
    Concord = 1118,
    ["Configu .cfgu files"] = 1106,
    ["Configu .configu file"] = 1107,
    Conjure = 175,
    ["Container Structure Test"] = 944,
    Containerlab = 972,
    ["Contextive Glossary"] = 1174,
    Convex = 174,
    ["Crowdsec collection config"] = 274,
    ["Crowdsec parser config"] = 275,
    ["Crowdsec scenario config"] = 276,
    ["CumulusCI Config"] = 181,
    ["Custom Machinery Machine"] = 1090,
    ["Custom Machinery Recipe"] = 1091,
    ["Cycle Stack File"] = 186,
    CycloneDX = 187,
    ["DWP Exchange - catalogue entry"] = 325,
    ["DWP Exchange - gateway"] = 323,
    ["DWP Exchange - meta"] = 324,
    ...
    ["DataYoga Job"] = 189,
    ["Databricks Asset Bundles"] = 1068,
    ["Datadog Continuous Testing"] = 489,
    ["Datadog Service Definition"] = 490,
    ["Datadog Software Catalog"] = 491,
    ["Datahub Ingestion Recipe"] = 1022,
    ...
    ["Docs MCP Manifest"] = 303,
    Dofigen = 304,
    ["Dolittle Artifacts"] = 305,
    ["Dolittle Bounded Context Configuration"] = 306,
    ["Dolittle Event Horizons Configuration"] = 307,
    ["Dolittle Resources Configuration"] = 308,
    ["Dolittle Server Configuration"] = 309,
    ["Dolittle Tenant Map Configuration"] = 311,
    ["Dolittle Tenants Configuration"] = 310,
    ["Dolittle Topology"] = 312,
    ["DonateCaseBetterCasino menu"] = 1151,
    ...
    ["Drupal Routing"] = 214,
    ["Drupal Services"] = 216,
    ["Drush site aliases"] = 318,
    ["Dynamic Bash Aliases (.aliases)"] = 1059,
    ["EAS config"] = 343,
    ["ECA - Editor Code Assistant"] = 327,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1048,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1194,
    ["EasyVCR .NET"] = 344,
    ["Eidolon Resource"] = 1135,
    ["Elgato Stream Deck"] = 329,
    Elm = 1123,
    ["Embrace Config"] = 1034,
    Endurica = 1072,
    ["Enterprise Contract Policy Spec"] = 330,
    ["Erda Pipeline"] = 1097,
    ["Erda Runtime"] = 1098,
    ["Espanso config.yml"] = 1220,
    ["Espanso match.yml"] = 1219,
    Esquio = 332,
    ["Estuary Flow Catalog"] = 1012,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 336,
    ["EveryVoice TTS Toolkit Data Configuration"] = 337,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 341,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 340,
    ["EveryVoice TTS Toolkit Text Configuration"] = 338,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 339,
    ["Evolving Resolutive Process notation"] = 1196,
    ["Expo SDK"] = 342,
    ["F-Droid Data metadata"] = 348,
    ["FasterCI Configuration"] = 108,
    FiQuS = 352,
    Firebase = 350,
    ["Flatpak Builder Manifest"] = 353,
    ["FlexGet Config"] = 354,
    ["Flow.json Configurations"] = 1094,
    ["Fossa configuration file"] = 361,
    ["Fossa's fossa-deps file"] = 362,
    ["Foundry VTT - Base package Manifest"] = 356,
    ["Foundry VTT - Module Manifest"] = 357,
    ["Foundry VTT - System Data Template"] = 360,
    ["Foundry VTT - System Manifest"] = 358,
    ["Foundry VTT - World Manifest"] = 359,
    ["Foxx Manifest"] = 109,
    ["Freifunk.de Community API"] = 112,
    ["Frogbot Config"] = 113,
    ["G2P Mapping Configuration"] = 368,
    ["GCP Blueprint Metadata"] = 371,
    Gaspar = 369,
    ["GatewayCore API Gateway"] = 370,
    ["Gemini CLI settings"] = 372,
    ["GeoJSON.json latest"] = 1010,
    GherKing = 1014,
    ["GitHub Action"] = 377,
    ["GitHub Actions typing"] = 1131,
    ["GitHub Discussion"] = 378,
    ["GitHub Funding"] = 379,
    ["GitHub Issue Template configuration"] = 380,
    ["GitHub Issue Template forms"] = 381,
    ["GitHub Workflow"] = 382,
    ["GitHub Workflow Template Properties"] = 383,
    ["GitHub automatically generated release notes configuration"] = 384,
    ["GitLab Agent for Kubernetes configuration"] = 1086,
    GitVersion = 374,
    ["Gitea Issue Template configuration"] = 375,
    ["Gitea Issue Template forms"] = 376,
    ["Gitpod Automations"] = 386,
    ["Gitpod Configuration"] = 387,
    ["GlazeWM settings"] = 1088,
    ["Global Privacy Control"] = 373,
    Goblet = 1067,
    ["Golangci-lint Configuration"] = 402,
    ["Golangci-lint Custom Plugins Configuration"] = 403,
    ["Google Chrome Related Website Sets"] = 351,
    ["Google Cloud Workflows"] = 251,
    ["Google Digital Assetlinks"] = 1175,
    Goreleaser = 405,
    ["Goreleaser Pro"] = 406,
    Goss = 407,
    ["Gradle Build Cache Node"] = 961,
    ["Gradle Enterprise"] = 960,
    ["Grafana 5.x Dashboard"] = 408,
    ["GraphQL Code Generator"] = 413,
    ["GraphQL Config"] = 412,
    ["GraphQL Mesh"] = 411,
    ["GroovyLint configuration"] = 414,
    ["Grunt JSHint task"] = 418,
    ["Grunt Watch task"] = 419,
    ["Grunt base task"] = 420,
    ["Grunt clean task"] = 416,
    ["Grunt copy task"] = 415,
    ["Grunt cssmin task"] = 417,
    HEMTT = 926,
    Hadolint = 940,
    Hammerkit = 971,
    ["Hardware Sentry Configuration"] = 1026,
    ["HashiCorp Vault"] = 421,
    Hatch = 941,
    Hayson = 423,
    ["Haystack Pipeline"] = 424,
    ["Hazelcast 5 Configuration"] = 425,
    ["Hecate Input Schema"] = 1186,
    ["Helm Chart.lock"] = 218,
    ["Helm Chart.yaml"] = 217,
    ["Helm Unittest Test Suite"] = 219,
    ["Home Assistant Integration Manifest"] = 426,
    ["Homer dashboard configuration"] = 427,
    Hugo = 1002,
    ["Hugo Theme"] = 1001,
    ["Hulak Configuration"] = 434,
    ["Hyperfoil benchmark configuration"] = 433,
    ["IBM Zapp document"] = 435,
    ["IBM zCodeFormatSettings"] = 436,
    ["IMG Catapult PSP"] = 441,
    ["IVMS101 by CODE Protocol"] = 1087,
    Infrahub = 443,
    Istanbul = 1030,
    ["JDownloader2 crawler multi-rules"] = 456,
    ["JDownloader2 crawler single-rules"] = 455,
    ["JFrog Applications Config"] = 457,
    ["JFrog File Spec"] = 458,
    ["JFrog Pipelines YML DSL"] = 1036,
    ["JMeter DSL cli config"] = 459,
    JReleaser = 462,
    ["JSON Document Transform"] = 470,
    ["JSON Feed"] = 471,
    ["JSON Resume"] = 714,
    ["JSON Schema Draft 2020-12"] = 908,
    ["JSON Schema Draft 4"] = 905,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1069,
    ["JSON Schema Draft 7"] = 906,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1070,
    ["JSON Schema Draft 8 (2019-09)"] = 907,
    ["JSON-API"] = 469,
    ["JSON-e templates"] = 968,
    ["JSON-stat 2.0"] = 901,
    JSONPatch = 473,
    ["JSR Package Config (jsr.json)"] = 463,
    Jarl = 1202,
    Jasmine = 450,
    Jekyll = 451,
    ["Jenkins X Pipelines"] = 452,
    ["Jenkins X Requirements"] = 453,
    Jest = 454,
    Jocker = 460,
    ["Jovo Language Models"] = 461,
    ["Jujutsu (jj) VCS config"] = 1188,
    ["KIMMDY config file"] = 484,
    ["KODE/CI build.yaml"] = 1032,
    ["KSP-AVC"] = 902,
    ["KSP-CKAN"] = 903,
    ["KSP-NetKAN"] = 904,
    KSY = 1099,
    KSail = 366,
    ["KYA Manifest"] = 1100,
    ["Karakum configuration file"] = 363,
    Kas = 476,
    ["Kestra flow file"] = 485,
    ["Keycloak REST API"] = 1039,
    ["Knative Functions - func.yaml"] = 364,
    Knip = 365,
    ["Kometa (nightly) config file"] = 487,
    ["Kometa config file"] = 486,
    ["Kong DBLess config"] = 1033,
    KrakenD = 488,
    ["Kubri Configuration"] = 495,
    LOOBin = 510,
    ["Lake configuration file"] = 1191,
    ...
    ["Lando (landofile)"] = 103,
    ["LangGraph Platform configuration"] = 1111,
    ["Language configuration"] = 1110,
    Lefthook = 499,
    ["Liferay client-extension.yaml"] = 506,
    ["LinkML Metamodel"] = 508,
    Liquibase = 977,
    ["Liquibase Flow File"] = 978,
    ["Lively Properties"] = 509,
    ["Lobe AI Agent"] = 105,
    Loki = 106,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 550,
    ["MS2Rescore Configuration"] = 553,
    ["Madness (madness.yml)"] = 1050,
    ["Mado configuration"] = 516,
    ["Mail Servers Configuration"] = 1223,
    ["MapEHR Mapping"] = 517,
    Markdownlint = 981,
    ["Mason Registry"] = 984,
    ["MegaLinter Custom Flavor"] = 520,
    ["MegaLinter configuration"] = 519,
    ["MegaLinter descriptor"] = 521,
    Melange = 1077,
    ["Meltano project definition"] = 522,
    ["Mergify Configuration"] = 554,
    ["Metadata for a Bazel module"] = 523,
    ["Metadata for a Cinnamon spice"] = 1127,
    ["Metatype Configuration"] = 524,
    ["MetricsHub Configuration"] = 525,
    ["MetricsHub Connector Configuration"] = 526,
    ["Micro Editor Syntax"] = 1060,
    ["Microsoft Band Web Tile"] = 527,
    ["Microsoft RulesEngine workflow rules"] = 1115,
    ["Microsoft RulesEngine workflow rules list"] = 1116,
    ["Minecraft Custom Main Menu Mod"] = 1078,
    ["Minecraft Data Pack Advancement"] = 529,
    ["Minecraft Data Pack Biome"] = 530,
    ["Minecraft Data Pack Configured Carver"] = 531,
    ["Minecraft Data Pack Damage Type"] = 532,
    ["Minecraft Data Pack Dimension"] = 534,
    ["Minecraft Data Pack Dimension Type"] = 533,
    ["Minecraft Data Pack Item Modifier"] = 535,
    ["Minecraft Data Pack Loot Table"] = 536,
    ["Minecraft Data Pack Metadata"] = 537,
    ["Minecraft Data Pack Predicate"] = 538,
    ["Minecraft Data Pack Recipe"] = 539,
    ["Minecraft Data Pack Tag"] = 540,
    ["Minecraft Data Pack Template Pool"] = 541,
    ["Minecraft Data Pack Trim Material"] = 546,
    ["Minecraft Data Pack Trim Pattern"] = 547,
    ["Minecraft Resource Pack Lang"] = 542,
    ["Minecraft Resource Pack Particle"] = 543,
    ["Minecraft Resource Pack Texture Mcmeta"] = 545,
    ["Minecraft Resourcepack Sounds"] = 544,
    ["Monade CLI Stack Configuration"] = 557,
    ["MongoDB Atlas Search Index Definition"] = 1031,
    ["Monika Configuration"] = 1029,
    ["Monoweave Configuration"] = 552,
    ["Motif config"] = 922,
    MultiQC = 1168,
    ["NOX Framework (Service)"] = 573,
    ["Netin Diagnostic System Template"] = 988,
    ["Netlify config"] = 560,
    ["Network-as-Code Data Model"] = 561,
    ["Next Gen UI Agent A2A Server Configuration"] = 562,
    ["Next Gen UI Agent Configuration"] = 564,
    ["Next Gen UI Agent MCP Server Configuration"] = 563,
    ["Nightwatch.js"] = 566,
    ["Node.js configuration"] = 927,
    ["NueJS configuration file"] = 578,
    ["Nuitka.yaml"] = 1092,
    ["Nullstone config"] = 580,
    ["ONe's changelog entry"] = 598,
    ["ONe's service descriptor"] = 597,
    ["ORT Server repository environment configuration"] = 607,
    ["OSCAL Assessment Plan (AP)"] = 609,
    ["OSCAL Assessment Results (AR)"] = 610,
    ["OSCAL Catalog"] = 611,
    ["OSCAL Component Definition (CDef)"] = 612,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 613,
    ["OSCAL Profile"] = 614,
    ["OSCAL System Security Plan (SSP)"] = 615,
    ["OSS Review Toolkit configuration"] = 616,
    ["OSS Review Toolkit curation"] = 617,
    ["OSS Review Toolkit package configuration"] = 618,
    ["OSS Review Toolkit repository configuration"] = 619,
    ["OSS Review Toolkit resolutions"] = 620,
    ["October CMS columns"] = 584,
    ["October CMS fields"] = 585,
    ["Oh My Posh"] = 586,
    Okteto = 587,
    ["Ona Automations"] = 589,
    Opctl = 925,
    ["Open Data Contract Standard (ODCS)"] = 601,
    ["Open Data Product Standard (ODPS)"] = 602,
    ["Open Know-How"] = 1173,
    ["OpenRewrite Resource"] = 600,
    OpenSRM = 603,
    OpenStatus = 1184,
    ["OpenUtau character yaml"] = 594,
    ["OpenUtau ustx"] = 595,
    ["OpenWeather Current Weather API"] = 967,
    ["OpenWeather Road Risk API"] = 966,
    ["Ory Hydra configuration"] = 432,
    ["Ory Keto configuration"] = 492,
    ["Ory Kratos configuration"] = 608,
    ["Ory Oathkeeper configuration"] = 582,
    ["Outblocks App configuration"] = 605,
    ["Outblocks database table"] = 606,
    ["Outblocks project configuration"] = 604,
    PDM = 627,
    POPxf = 637,
    ["POPxf Correlations"] = 638,
    Packer = 624,
    Pantsbuild = 1046,
    ["Paper paper-plugin.yml"] = 625,
    ["Pipeline component"] = 979,
    ["Platform.sh application"] = 5,
    ["Platform.sh routes"] = 6,
    ["Platform.sh services"] = 7,
    ["Plex Prerolls"] = 635,
    ["PocketMine plugin.yml"] = 632,
    ["Postman collection"] = 641,
    ["Power Pages Configuration"] = 1185,
    ["Preset list for a WinUtil"] = 1130,
    ["ProActions AI-Kit Configuration"] = 652,
    ["ProActions AI-Kit Configuration for Menus"] = 654,
    ["ProActions AI-Kit Configuration for Sections"] = 656,
    ["ProActions AI-Kit Configuration for Services"] = 653,
    ["ProActions AI-Kit Configuration for Steps"] = 657,
    ["ProActions AI-Kit Configuration for Templates"] = 655,
    ["Problem object RFC9457"] = 1075,
    ["Problem package format"] = 658,
    ["Problem package generators"] = 659,
    ["Problem package submissions"] = 660,
    ["Problem package test group metadata"] = 661,
    Pterodactyl = 1025,
    ["Pull Request Labeler"] = 678,
    Pulumi = 686,
    ["PyGTA Config"] = 682,
    PyProject = 687,
    Pylock = 1176,
    Pyright = 688,
    ["Python script metadata"] = 1170,
    ["QType AI DSL"] = 691,
    Qgoda = 690,
    Qodana = 998,
    ["Qt Creator workspace file"] = 1108,
    ["Quali Torque Blueprint Spec 2"] = 1023,
    ["QueryFirst config file"] = 1042,
    ["RKE Cluster Configuration JSON"] = 976,
    ["RKE Cluster Configuration YAML"] = 975,
    RadioHound = 681,
    Railpack = 693,
    Railway = 692,
    ["Rancher Fleet"] = 683,
    ...
    Ray = 939,
    ["Read the Docs"] = 685,
    ["Red-DiscordBot Cog"] = 701,
    ["Red-DiscordBot Cog Repo"] = 702,
    ["Red-DiscordBot Trivia"] = 703,
    ["Releasaurus Config"] = 2,
    ["Render Blueprints"] = 974,
    RenderCV = 718,
    Renovate = 715,
    ["Renovate global configuration"] = 716,
    ["Renovate inherited configuration"] = 717,
    ["Replit config"] = 709,
    Restate = 1163,
    ["Revel Digital Gadget Definition File"] = 1187,
    RoadRunner = 720,
    ["Robust Station Image"] = 1193,
    Rockcraft = 721,
    ["Roo Coder Custom Modes"] = 722,
    Rubocop = 711,
    ["Rudder techniques"] = 1082,
    Ruff = 712,
    ["Rust Project"] = 713,
    ["Rust toolchain"] = 726,
    ["SDMX data message"] = 752,
    ["SDMX metadata message"] = 751,
    ["SDMX structure message"] = 750,
    ["SIL Kit Participant Configuration"] = 762,
    ["SIL Kit Registry Configuration"] = 763,
    ["SPDX 2.3"] = 800,
    SWADL = 816,
    ["Safebox Config"] = 1037,
    ["Sapphire CLI Config"] = 729,
    ["SauceCTL Configuration"] = 985,
    ["Schema Catalog"] = 744,
    ["Scoop manifest"] = 749,
    ["Semantic Data Fabric (SDF) file"] = 753,
    ["Semgrep Rule"] = 755,
    ["Serenity Code Generator (Sergen)"] = 756,
    ["Serverless Framework Configuration"] = 992,
    ["Serverless Workflow"] = 994,
    ["Settings for a Cinnamon spice"] = 1126,
    ["Settings.paf"] = 758,
    ["Shopware 6 Configuration"] = 995,
    ["Shopware CLI Extension Store Configuration"] = 996,
    ["Shopware CLI Project Store Configuration"] = 997,
    ["Sigma Detection Rule"] = 760,
    ["Sigrid scope configuration file"] = 761,
    ["SkyPilot Task JSON"] = 1083,
    ["Slack app manifest"] = 765,
    Snapcraft = 767,
    Solidarity = 770,
    ["Solution filters"] = 771,
    ["Source Maps v3"] = 772,
    Sourcery = 773,
    ["Spack bootstrap.yaml"] = 774,
    ["Spack cdash.yaml"] = 775,
    ["Spack ci.yaml"] = 776,
    ["Spack compilers.yaml"] = 777,
    ["Spack concretizer.yaml"] = 778,
    ["Spack config.yaml"] = 779,
    ["Spack definitions.yaml"] = 780,
    ["Spack develop.yaml"] = 781,
    ["Spack env_vars.yaml"] = 782,
    ["Spack environment"] = 788,
    ["Spack include.yaml"] = 783,
    ["Spack mirrors.yaml"] = 784,
    ["Spack modules.yaml"] = 785,
    ["Spack packages.yaml"] = 786,
    ["Spack repos.yaml"] = 787,
    ["Spack toolchains.yaml"] = 789,
    ["Spack upstreams.yaml"] = 790,
    ["Spack view.yaml"] = 791,
    ["Speakeasy Generation Config File"] = 795,
    ["Speakeasy Lint Configuration File"] = 792,
    ["Speakeasy Test Generation Configuration File"] = 793,
    ["Speakeasy Workflow File"] = 794,
    SpecIF = 796,
    ["Specmatic Configuration"] = 797,
    ["Sponge Mixin configuration"] = 798,
    StackBlitz = 804,
    ["StackHawk Scanner Configuration"] = 991,
    Stale = 805,
    Starfish = 806,
    ["Starlake Data Pipeline"] = 964,
    Starship = 807,
    ["Statamic Blueprint"] = 808,
    ["Stella configuration file"] = 809,
    ["Streamlit configuration file"] = 810,
    ["Stryker Mutator"] = 813,
    ["StyleCop Analyzers Configuration"] = 814,
    ["Stylelint (.stylelintrc)"] = 815,
    ["Stylua Config"] = 1177,
    ["Sublime Syntax"] = 1038,
    ["Subsquid squid manifest"] = 1085,
    ["Swagger API 2.0"] = 817,
    ["Synadia Connect Component"] = 818,
    TSON = 854,
    TSTyche = 855,
    ["TYPO3 Vendor Bundler config"] = 860,
    ["Tab data for a LinUtil"] = 1133,
    ["Tab list for a LinUtil"] = 1132,
    Tach = 819,
    ["Tach Domain"] = 820,
    Talhelper = 822,
    ["Talisman configuration"] = 823,
    Taplo = 1178,
    ["Taskfile config"] = 969,
    Taurus = 824,
    Tauticord = 825,
    ["Tekton Pipeline"] = 1206,
    ["Tekton PipelineRun"] = 1207,
    ["Tekton Task"] = 1204,
    ["Tekton TaskRun"] = 1205,
    Telefonistka = 1164,
    ["Terrateam config"] = 1190,
    ["TestEnvironment.json"] = 837,
    ["TextMate Grammar"] = 836,
    Threagile = 831,
    ["Tier.run pricing.json"] = 828,
    Tikibase = 829,
    Tombi = 834,
    ["Traefik v2"] = 840,
    ["Traefik v2 File Provider"] = 841,
    ["Traefik v3"] = 842,
    ["Traefik v3 File Provider"] = 843,
    ["Travis CI (.travis.yml)"] = 839,
    Treefmt = 410,
    Trident = 1160,
    ["TrueScript for *.tscript files"] = 846,
    ["Tugboat QA config.yml"] = 1157,
    TunnelHub = 1073,
    Turborepo = 838,
    Tycho = 1122,
    Tye = 999,
    ["Tyk Gateway - Open Source v5.7+"] = 1169,
    ["UET BuildConfig.json"] = 1043,
    ["UI5 Manifest"] = 866,
    ["UNCORS configuration"] = 870,
    ["UTAM Page Object"] = 869,
    ["Ubuntu Server Autoinstall"] = 864,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1161,
    ["Uniswap Token List"] = 951,
    ["Universal Schedule Format"] = 871,
    ["Unreal Engine Uplugin"] = 1044,
    ["Unreal Engine Uproject"] = 1045,
    ["UpCloud CLI (upctl) configuration"] = 1162,
    ["Updatecli Compose"] = 1007,
    ["Updatecli Policy Manifest"] = 1008,
    ["Updatecli Policy Metadata"] = 1009,
    Uplift = 1041,
    ["Upsun config"] = 4,
    ["User Journey Map"] = 973,
    V2Ray = 1013,
    ["VSCode Code Snippets"] = 239,
    ["VSIX CLI publishing"] = 889,
    Vector = 873,
    ["Vela Pipeline Configuration"] = 876,
    Vercel = 238,
    ["Version Bumper config"] = 879,
    Vespertide = 1211,
    ["Vespertide Migration"] = 1212,
    ["Vespertide Model"] = 1213,
    ["Viash Component Config"] = 1166,
    ["Viash Package Config"] = 1167,
    Visivo = 1071,
    ["WP-CLI"] = 899,
    Wake = 1159,
    ["Waku Config"] = 1136,
    ["Web App Manifest"] = 895,
    ["Web types"] = 898,
    WebExtensions = 894,
    ["Webman package recipe"] = 1019,
    ["Windows Package Manager Installer Manifest"] = 947,
    ["Windows Package Manager Locale Manifest"] = 948,
    ["Windows Package Manager Singleton Manifest"] = 946,
    Winutil = 949,
    ["WireMock CLI import configuration"] = 1142,
    ["WireMock CLI local service configuration"] = 1141,
    ["WireMock message stub mapping"] = 1140,
    ["WireMock stub mapping"] = 1139,
    ["Woodpecker pipeline config"] = 987,
    ["Wrangler CLI"] = 900,
    ["Xstate Machine"] = 1005,
    ["Yandex Workflow Language"] = 1128,
    ["Yarn Config (.yarnrc.yml)"] = 962,
    ["Yippee-Ki-JSON configuration YML"] = 953,
    ["YouTrack App"] = 1125,
    ["Zarf Package Configuration"] = 1192,
    ["Zerops.io config"] = 1113,
    ["Zerops.io import"] = 1114,
    ["Zola Configuration"] = 1203,
    ["aerleon.yml"] = 17,
    ["amplify.yml"] = 10,
    ["angular.json"] = 33,
    apko = 1076,
    ...
    ["behat.yml"] = 135,
    ["bigquery-table"] = 124,
    ["bioimageio resource description"] = 1093,
    ...
    ["chutzpah.json"] = 247,
    cibuildwheel = 170,
    ["clang-format (.clang-format)"] = 1011,
    ["clang-tidy"] = 225,
    clangd = 224,
    clib = 226,
    ...
    ["crowdin.yml"] = 273,
    ["ctfd-setup configuration file"] = 1149,
    ["custom-elements.json"] = 1063,
    ["cypress.json"] = 277,
    ...
    ["dockerd.json"] = 298,
    ["dotnet Release Index manifest"] = 313,
    ["dotnet-tools.json"] = 314,
    ["dotnetcli.host.json"] = 315,
    ["dprint.json"] = 316,
    ["drone.json"] = 317,
    ["dss-2.0.0.json"] = 319,
    ["dstack configuration"] = 320,
    ["dtool dataset metadata"] = 1144,
    ["dvc.yaml"] = 321,
    ["ecosystem.json"] = 326,
    eksctl = 328,
    ["electron-builder configuration file"] = 334,
    ["epr-manifest.json"] = 333,
    ["evcc.yaml"] = 335,
    ["ezd task runner"] = 345,
    ["fabric.mod.json"] = 347,
    ["first-timers-bot"] = 355,
    ["flagd flag configuration"] = 110,
    ["fly.io Configuration"] = 111,
    fulibWorkflows = 986,
    ["function.json"] = 367,
    ["gRPC API Gateway & OpenAPI Config"] = 12,
    ["gematik health care insurance list"] = 1155,
    ["gematik health care patient list"] = 1152,
    ["gematik health care provider institution list"] = 1154,
    ["gematik health care provider list"] = 1153,
    ["gematik tiger test environment configuration"] = 1156,
    ["git-town.toml"] = 1201,
    ["gitlab-ci"] = 385,
    ["global.json"] = 401,
    ["go-feature-flag Flag Configuration"] = 404,
    ["haxelib.json"] = 422,
    helmfile = 942,
    helmwave = 943,
    ["host-meta.json"] = 429,
    ...
    ["ide.host.json"] = 437,
    ["ifstate.yaml"] = 438,
    ["imageoptimizer.json"] = 439,
    ["importmap.json"] = 442,
    instant_python_config = 444,
    instant_python_custom_project = 445,
    ["ioBroker Configuration"] = 446,
    ["ioBroker JSON UI"] = 447,
    ["ioBroker Package manifest"] = 448,
    ["ixpect.conf.yaml"] = 449,
    ["ize.toml"] = 1040,
    ["jsconfig.json"] = 474,
    ["jscpd Configuration"] = 1024,
    jsdoc = 938,
    ["k3d.yaml"] = 475,
    ["k9s aliases.yaml"] = 477,
    ["k9s cluster-config.yaml"] = 479,
    ["k9s config.yaml"] = 478,
    ["k9s hotkeys.yaml"] = 480,
    ["k9s plugins.yaml"] = 481,
    ["k9s skin.yaml"] = 482,
    ["k9s views.yaml"] = 483,
    ["kontinuous-config.yaml"] = 494,
    ["kontinuous-values.yaml"] = 493,
    ["kustomization.yaml"] = 496,
    ["label-commenter-config.yml"] = 497,
    ["latexindent configuration"] = 104,
    ["launchsettings.json"] = 498,
    lazydocker = 1062,
    lazygit = 1061,
    ["lego.json"] = 500,
    ["lerna.json"] = 501,
    ["lgtm.yml"] = 502,
    ["liblab.config.json"] = 503,
    ["libman.json"] = 504,
    ["license-report-config.json"] = 505,
    ["linkinator.config.json"] = 507,
    ["lint-staged (.lintstagedrc)"] = 916,
    ["local.settings.json"] = 512,
    ["localazy.json"] = 513,
    ["lotus.yaml"] = 511,
    ["lsdlschema.json"] = 514,
    ["macro.json"] = 1028,
    ["markdown-link-check"] = 982,
    maturin = 983,
    mboats = 990,
    ["micro-settings.json"] = 1055,
    ["mimetypes.json"] = 528,
    ["mirrord config"] = 918,
    mise = 919,
    ["mkdocs.yml"] = 548,
    ["monospace.yml"] = 551,
    ["moon.yml"] = 1138,
    ["mprocs Configuration file"] = 1109,
    ["mrdocs.yml"] = 549,
    ["mta.yaml"] = 920,
    ["mtad.yaml"] = 921,
    ["mycode.json"] = 558,
    nFPM = 565,
    ["napari plugin manifest"] = 559,
    neoload = 933,
    ["nest-cli"] = 568,
    ["ninjs (News in JSON)"] = 567,
    ["nitro.json"] = 932,
    ["nixd configuration"] = 1081,
    ["nlu.json"] = 569,
    ["nodemon.json"] = 571,
    ["noodl config"] = 989,
    ["notebook.mod.json"] = 572,
    now = 928,
    ["npm-badges"] = 575,
    ["nswag.json"] = 579,
    ntangle = 581,
    ["nuclei-template.yaml"] = 576,
    ["nuget-project.json"] = 577,
    ["ocelot.json"] = 583,
    ["omnisharp.json"] = 588,
    openHAB = 1214,
    ["openapi.json"] = 590,
    ...
    oxlint = 1225,
    ["package.json"] = 621,
    ["package.manifest"] = 623,
    ["package.yaml"] = 622,
    ["partial-black.json"] = 136,
    ["pathfinder.yml"] = 626,
    ["pattern.json"] = 629,
    ["petstore-v1.0"] = 1035,
    pgap_yaml_input_reader = 628,
    pgxgen = 1218,
    pitcms = 1221,
    ["pixi.toml"] = 630,
    ["plagiarize-me.yaml"] = 634,
    ["plagiarize.yaml"] = 633,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1145,
    ["podbard.yaml"] = 636,
    ["portman.json"] = 639,
    ["prefect.toml"] = 647,
    ["prefect.yaml"] = 648,
    ...
    ["prettierrc.json"] = 650,
    ["prisma.yml"] = 651,
    ["project-1.0.0-beta3.json"] = 663,
    ["project-1.0.0-beta4.json"] = 664,
    ["project-1.0.0-beta5.json"] = 665,
    ["project-1.0.0-beta6.json"] = 666,
    ["project-1.0.0-beta8.json"] = 667,
    ["project-1.0.0-rc1.json"] = 668,
    ["project-1.0.0-rc2.json"] = 669,
    ["project.json"] = 662,
    ["project.owasp.yaml"] = 670,
    ["prometheus-alertmanager.json"] = 674,
    ["prometheus.json"] = 671,
    ["prometheus.rules.json"] = 672,
    ["prometheus.rules.test.json"] = 673,
    ["proxies.json"] = 675,
    ["publiccode.yml"] = 676,
    ["pubspec.yaml"] = 677,
    ["pyrseas-0.8.json"] = 680,
    pytest = 689,
    ["quilt.mod.json"] = 1056,
    ["rc3 auth"] = 695,
    ["rc3 collection"] = 696,
    ...
    ["release drafter"] = 934,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 705,
    ["release-please-manifest.json"] = 706,
    ["release-plz.toml"] = 707,
    ["renv.lock"] = 719,
    ["rivet.json"] = 1080,
    ["rivet.yaml (legacy)"] = 1079,
    rumdl = 724,
    runny = 723,
    rustfmt = 725,
    sake = 1172,
    samt = 727,
    samtrc = 728,
    ["sarif-1.0.0.json"] = 730,
    ["sarif-2.0.0.json"] = 731,
    ["sarif-2.1.0"] = 741,
    ["sarif-2.1.0-rtm.2"] = 732,
    ["sarif-2.1.0-rtm.3"] = 734,
    ["sarif-2.1.0-rtm.4"] = 736,
    ["sarif-2.1.0-rtm.5"] = 738,
    ["sarif-2.1.0-rtm.6"] = 739,
    ["sarif-external-property-file-2.1.0"] = 742,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 733,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 735,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 737,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 740,
    ["scalingo.json configuration"] = 743,
    ["schema.org - Action"] = 745,
    ["schema.org - ContactPoint"] = 746,
    ["schema.org - Place"] = 747,
    ["schema.org - Thing"] = 748,
    ["secrethub.yml"] = 1058,
    ["semantic-release"] = 754,
    ["servicehub.config.json"] = 911,
    ["servicehub.service.json"] = 910,
    ["settings.job"] = 757,
    ["sfdx-hardis configuration"] = 759,
    ["shard.yml"] = 1096,
    ["size-limit configuration"] = 764,
    ["skaffold.yaml"] = 980,
    ["skyuxconfig.json"] = 766,
    ["snowflake-config"] = 768,
    ["snowflake-connections"] = 769,
    ["spicepod.yaml"] = 1117,
    ["sqlc configuration"] = 801,
    ["stripe-app-local.json"] = 812,
    ["stripe-app.json"] = 811,
    swcrc = 965,
    ["task.json"] = 821,
    taskcat = 929,
    ["template.json"] = 826,
    ["templatsources.json"] = 827,
    ["theme.json"] = 830,
    ["tizen_workspace.json"] = 832,
    tldr = 833,
    ["tm_devices configuration file"] = 1183,
    tmuxinator = 914,
    tox = 835,
    ["transcend.yml"] = 844,
    ["tree-sitter grammar.json"] = 409,
    ["trime.yaml"] = 845,
    ["trunk.yaml"] = 847,
    ["ts-force-config.json"] = 852,
    ["tsconfig.json"] = 848,
    ["tsd.json"] = 849,
    ["tsdoc.json"] = 850,
    ["tsdrc.json"] = 851,
    ...
    ["vega-lite.json"] = 875,
    ["vega.json"] = 874,
    ["venvironment.yaml"] = 877,
    ["venvplus.yaml"] = 878,
    version = 1165,
    ["version.json"] = 880,
    ["vhwdebugger-binding.yaml"] = 882,
    ["vim-addon-info"] = 883,
    ["vs-2017.3.host.json"] = 885,
    ["vs-nesting.json"] = 886,
    ["vsls.json"] = 884,
    ["vss-extension.json"] = 890,
    vtcfg = 1171,
    ["vtesttree.yaml"] = 891,
    ["vtestunit.yaml"] = 892,
    ["warp-keysets.json"] = 1064,
    ["warp-themes.json"] = 1065,
    ["warp-workflows.json"] = 1066,
    ["webhint.io"] = 1020,
    ["webjobpublishsettings.json"] = 897,
    ["webjobs-list.json"] = 896,
    ["well-known-fursona"] = 1104,
    ["xs-app.json"] = 924,
    ["xunit.runner.json"] = 909,
    yamllint = 952,
    zizmor = 1208,
    zuul = 935,
    ["Žinoma"] = 945
