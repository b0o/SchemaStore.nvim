...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1027,
    [".nodehawkrc"] = 653,
    [".npmpackagejsonlintrc"] = 658,
    [".omletrc"] = 1208,
    [".phrase.yml"] = 736,
    [".phraseapp.yml"] = 737,
    [".pmbot.yml"] = 721,
    [".postcssrc"] = 730,
    [".powerpages-web-template-manifest"] = 732,
    [".pre-commit-config.yml"] = 733,
    [".pre-commit-hooks.yml"] = 734,
    [".putout.json"] = 770,
    [".rehyperc"] = 795,
    [".remarkrc"] = 799,
    [".sprite files"] = 897,
    ...
    AIConfig = 45,
    ["AMX Muse Program Descriptor"] = 1257,
    ["API Builder"] = 1063,
    ["AVA Configuration"] = 1127,
    ...
    ["AWS Copilot Manifest"] = 1296,
    ["AWS SAM CLI Samconfig"] = 289,
    Acton = 1347,
    ["Adobe UXP Manifest"] = 1190,
    ["Aerleon Network & Service Definitions"] = 27,
    ["Aerleon Policy"] = 28,
    ["Agent Permission Policy"] = 1336,
    ["AgentCore CLI"] = 1337,
    AgentLoopKit = 1338,
    Aider = 1286,
    Air = 30,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1307,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1306,
    ["Airlock Microgateway"] = 46,
    ["Alacritty Configuration"] = 1099,
    ["AlgoVoi Compliance Receipt v1"] = 16,
    ["All Contributors configuration file"] = 1153,
    ["Amazon S3 bucket CORS"] = 18,
    Anodizer = 471,
    ["Ansible Argument Specs"] = 454,
    ["Ansible Collection Galaxy"] = 461,
    ["Ansible Execution Environment"] = 451,
    ["Ansible Inventory"] = 460,
    ["Ansible Meta"] = 452,
    ["Ansible Meta Runtime"] = 453,
    ["Ansible Navigator Configuration"] = 463,
    ["Ansible Playbook"] = 458,
    ["Ansible Requirements"] = 455,
    ["Ansible Rulebook"] = 459,
    ["Ansible Tasks File"] = 457,
    ["Ansible Vars File"] = 456,
    ["Ansible-lint Configuration"] = 462,
    Any = 1218,
    ...
    ["Application list for a WinUtil"] = 1236,
    ArchitectFX = 1241,
    ["Argo CD"] = 65,
    ["Argo Events"] = 66,
    ["Argo Workflows"] = 67,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1305,
    ["Azure IoT Operations connector metadata"] = 1302,
    ...
    ["Azure Pipelines"] = 125,
    ["Azure Static Web Apps CLI configuration file"] = 901,
    ["Azure Static Web Apps configuration file"] = 900,
    BMML = 1324,
    ["BOSH BPM Config"] = 151,
    ["BOSH CPI Config"] = 152,
    ...
    ["Bacon config"] = 10,
    ["Barba-CV"] = 94,
    ["Bashly (bashly.yml)"] = 1157,
    ["Bashly Settings (bashly-settings.yml)"] = 1158,
    Bento = 1323,
    ["Better Code Hub"] = 1068,
    ["Better Scripts"] = 175,
    Bigconfig = 144,
    ["Biome Formatter Config"] = 95,
    ["Bitmovin Encoding Template"] = 1250,
    BizTalkServerApplicationSchema = 1034,
    Bleep = 176,
    ["Block Protocol Metadata"] = 173,
    ["Bluebricks blueprint config"] = 1329,
    ["Boyka Framework"] = 154,
    ...
    ["Butane Config"] = 1112,
    C4InterFlow = 1265,
    ["CDK Environment Manager, concrete environment configuration"] = 1289,
    ["CDK Environment Manager, concrete environments definition"] = 1288,
    ["CDK Environment Manager, environment definition"] = 1287,
    ["CGS Card Game Specification (cgs.json)"] = 1195,
    ["CICS TS region tagging"] = 1121,
    ["CICS TS resource import"] = 1122,
    ["CICS TS resource model"] = 1123,
    ["CICS TS resource overrides"] = 1124,
    ["CMake Presets"] = 177,
    ["CNC Codes"] = 199,
    ["CRS WAF test file"] = 1225,
    ["CRS WAF test platform overrides file"] = 1226,
    ...
    ["Caido Proxy Configuration"] = 1361,
    ...
    ["Chamaleon environment"] = 1254,
    ["Chamaleon properties"] = 1255,
    ["Chamaleon template"] = 1253,
    Changepacks = 1316,
    Changesets = 298,
    Changie = 186,
    Charmcraft = 187,
    ...
    ["Clawject config"] = 205,
    ["Cloud Foundry Application Manifest"] = 1207,
    ["Cloud Run Spec v1"] = 1231,
    ...
    Concord = 1224,
    ["Configu .cfgu files"] = 1212,
    ["Configu .configu file"] = 1213,
    Conjure = 198,
    ["Container Structure Test"] = 1048,
    Containerlab = 1077,
    ["Contextive Glossary"] = 1281,
    ContractGuard = 1078,
    Convex = 197,
    ...
    ["Cursor Agent Environment"] = 1334,
    ["Custom Machinery Machine"] = 1196,
    ["Custom Machinery Recipe"] = 1197,
    ...
    ["DataYoga Job"] = 215,
    ["Datadog Continuous Testing"] = 558,
    ["Datadog Service Definition"] = 559,
    ["Datadog Software Catalog"] = 560,
    ["Datahub Ingestion Recipe"] = 1128,
    ["Debian Upstream Metadata file"] = 222,
    DebtLens = 223,
    ["Deck config"] = 224,
    ["Declarative Automation Bundles"] = 1174,
    ["DeepMatch deeplinks spec"] = 225,
    ["Dein Config"] = 226,
    ["Deno Config (deno.json)"] = 327,
    ["Dependency cruiser"] = 227,
    ["DeployStack Configuration"] = 228,
    ["Deployah Configuration"] = 1304,
    ["Deployer Recipe"] = 330,
    ["Deta Spacefile"] = 229,
    ...
    ["DonateCaseBetterCasino menu"] = 1258,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1165,
    ["EAS config"] = 398,
    ["ECA - Editor Code Assistant"] = 362,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1154,
    ["ESLint Suppressions"] = 403,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1301,
    ["EasyVCR .NET"] = 400,
    ["Eidolon Resource"] = 1242,
    ["Elgato Stream Deck"] = 364,
    Elm = 1229,
    ["Embrace Config"] = 1140,
    Emmet = 1230,
    Endurica = 1178,
    ["Enonic XP API descriptor"] = 367,
    ["Enonic XP Admin Extension descriptor"] = 368,
    ["Enonic XP Admin Tool descriptor"] = 369,
    ["Enonic XP Application descriptor"] = 370,
    ["Enonic XP CMS descriptor"] = 371,
    ["Enonic XP Content Type descriptor"] = 372,
    ["Enonic XP Form Fragment descriptor"] = 373,
    ["Enonic XP ID Provider descriptor"] = 374,
    ["Enonic XP Layout descriptor"] = 375,
    ["Enonic XP Macro descriptor"] = 376,
    ["Enonic XP Mixin descriptor"] = 377,
    ["Enonic XP Page descriptor"] = 378,
    ["Enonic XP Part descriptor"] = 379,
    ["Enonic XP Service descriptor"] = 380,
    ["Enonic XP Site descriptor"] = 381,
    ["Enonic XP Style descriptor"] = 382,
    ["Enonic XP Task descriptor"] = 383,
    ["Enonic XP Webapp descriptor"] = 384,
    ["Enterprise Contract Policy Spec"] = 365,
    ["Envelope Team Definition"] = 1346,
    ["Envilder Map File"] = 366,
    ["Erda Pipeline"] = 1203,
    ["Erda Runtime"] = 1204,
    ["Espanso config.yml"] = 1327,
    ["Espanso match.yml"] = 1326,
    Esquio = 386,
    ["Estuary Flow Catalog"] = 1118,
    ["Ethereum ERC1155"] = 1340,
    ["Ethereum ERC721"] = 1339,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 391,
    ["EveryVoice TTS Toolkit Data Configuration"] = 392,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 396,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 395,
    ["EveryVoice TTS Toolkit Text Configuration"] = 393,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 394,
    ["Evolving Resolutive Process notation"] = 1303,
    ["Expo SDK"] = 397,
    ["Expoot app config"] = 399,
    ["F-Droid Data metadata"] = 405,
    ["FasterCI Configuration"] = 126,
    ["Fence configuration"] = 127,
    FiQuS = 409,
    Firebase = 407,
    ["Flatpak Builder Manifest"] = 410,
    ["FlexGet Config"] = 411,
    ["Flow.json Configurations"] = 1200,
    ["Fossa configuration file"] = 418,
    ["Fossa's fossa-deps file"] = 419,
    ["Foundry VTT - Base package Manifest"] = 413,
    ["Foundry VTT - Module Manifest"] = 414,
    ["Foundry VTT - System Data Template"] = 417,
    ["Foundry VTT - System Manifest"] = 415,
    ["Foundry VTT - World Manifest"] = 416,
    ["Foxx Manifest"] = 128,
    ["Freifunk.de Community API"] = 131,
    ["Frogbot Config"] = 132,
    ["G2P Mapping Configuration"] = 425,
    GAMA = 426,
    ["GCP Blueprint Metadata"] = 429,
    Gaspar = 427,
    ["GatewayCore API Gateway"] = 428,
    ["Gemini CLI settings"] = 430,
    ["GeoJSON.json latest"] = 1116,
    GherKing = 1120,
    ["GitHub Action"] = 438,
    ["GitHub Actions typing"] = 1238,
    ["GitHub Discussion"] = 439,
    ["GitHub Funding"] = 440,
    ["GitHub Issue Template configuration"] = 441,
    ["GitHub Issue Template forms"] = 442,
    ["GitHub Pages Jekyll"] = 443,
    ["GitHub Workflow"] = 444,
    ["GitHub Workflow Template Properties"] = 445,
    ["GitHub automatically generated release notes configuration"] = 446,
    ["GitLab Agent for Kubernetes configuration"] = 1192,
    GitResume = 450,
    GitVersion = 433,
    ["Gitea Issue Template configuration"] = 436,
    ["Gitea Issue Template forms"] = 437,
    Gitleaks = 434,
    ["Gitpod Automations"] = 448,
    ["Gitpod Configuration"] = 449,
    ["Glamour style"] = 431,
    ["GlazeWM settings"] = 1194,
    ["Global Privacy Control"] = 432,
    Goblet = 1173,
    ["Golangci-lint Configuration"] = 465,
    ["Golangci-lint Custom Plugins Configuration"] = 466,
    ["Google Chrome Related Website Sets"] = 408,
    ["Google Cloud Workflows"] = 285,
    ["Google Digital Assetlinks"] = 1282,
    Goreleaser = 469,
    ["Goreleaser Pro"] = 470,
    Goss = 472,
    ["Gradle Build Cache Node"] = 1066,
    ["Gradle Enterprise"] = 1065,
    ["Grafana 5.x Dashboard"] = 473,
    ["GraphQL Code Generator"] = 478,
    ["GraphQL Config"] = 477,
    ["GraphQL Mesh"] = 476,
    ["GroovyLint configuration"] = 479,
    ["Grunt JSHint task"] = 483,
    ["Grunt Watch task"] = 484,
    ["Grunt base task"] = 485,
    ["Grunt clean task"] = 481,
    ["Grunt copy task"] = 480,
    ["Grunt cssmin task"] = 482,
    HEMTT = 1030,
    Hadolint = 1044,
    Hammerkit = 1076,
    ["Hardware Sentry Configuration"] = 1132,
    ["Hashgraph Online Skill Manifest"] = 6,
    ["HashiCorp Vault"] = 486,
    Hatch = 1045,
    Hayson = 488,
    ["Haystack Pipeline"] = 489,
    ["Hazelcast 5 Configuration"] = 490,
    ["Hecate Input Schema"] = 1293,
    ["Helm Chart.lock"] = 247,
    ["Helm Chart.yaml"] = 246,
    ["Helm Unittest Test Suite"] = 248,
    ["Hex file"] = 249,
    ["Home Assistant Integration Manifest"] = 492,
    ["Homer dashboard configuration"] = 493,
    Hugo = 1108,
    ["Hugo Theme"] = 1107,
    ["Hulak Configuration"] = 500,
    ["Hyperfoil benchmark configuration"] = 499,
    ["IBM Zapp document"] = 501,
    ["IBM zCodeFormatSettings"] = 502,
    ["IMG Catapult PSP"] = 507,
    ["IVMS101 by CODE Protocol"] = 1193,
    ["Infinispan Configuration"] = 509,
    ["Infinispan Server Configuration"] = 510,
    Infrahub = 511,
    Istanbul = 1136,
    ["JDownloader2 crawler multi-rules"] = 525,
    ["JDownloader2 crawler single-rules"] = 524,
    ["JFrog Applications Config"] = 526,
    ["JFrog File Spec"] = 527,
    ["JFrog Pipelines YML DSL"] = 1142,
    ["JMeter DSL cli config"] = 528,
    JReleaser = 531,
    ["JSON Document Transform"] = 539,
    ["JSON Feed"] = 540,
    ["JSON Resume"] = 807,
    ["JSON Schema Draft 2020-12"] = 1010,
    ["JSON Schema Draft 4"] = 1007,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1175,
    ["JSON Schema Draft 7"] = 1008,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1176,
    ["JSON Schema Draft 8 (2019-09)"] = 1009,
    ["JSON-API"] = 538,
    ["JSON-e templates"] = 1073,
    ["JSON-stat 2.0"] = 1003,
    JSONPatch = 542,
    ["JSR Package Config (jsr.json)"] = 532,
    Jarl = 1309,
    Jasmine = 519,
    Jekyll = 520,
    ["Jenkins X Pipelines"] = 521,
    ["Jenkins X Requirements"] = 522,
    Jest = 523,
    Jocker = 529,
    ["Jovo Language Models"] = 530,
    ["Jujutsu (jj) VCS config"] = 1295,
    ["KIMMDY config file"] = 553,
    ["KODE/CI build.yaml"] = 1138,
    ["KSP-AVC"] = 1004,
    ["KSP-CKAN"] = 1005,
    ["KSP-NetKAN"] = 1006,
    KSY = 1205,
    KSail = 423,
    ["KYA Manifest"] = 1206,
    ["Karakum configuration file"] = 420,
    Kas = 545,
    ["Kestra flow file"] = 554,
    ["Keycloak REST API"] = 1145,
    ["Knative Functions - func.yaml"] = 421,
    Knip = 422,
    ["Knowledge Unit"] = 562,
    ["Kometa (nightly) config file"] = 556,
    ["Kometa config file"] = 555,
    ["Kong DBLess config"] = 1139,
    KrakenD = 557,
    ["Kubri Configuration"] = 565,
    LOOBin = 580,
    ["Lake configuration file"] = 1298,
    ...
    ["Lando (landofile)"] = 121,
    ["LangGraph Platform configuration"] = 1217,
    ["Language configuration"] = 1216,
    Lefthook = 569,
    ["Liferay client-extension.yaml"] = 576,
    ["LinkML Metamodel"] = 578,
    Liquibase = 1083,
    ["Liquibase Flow File"] = 1084,
    ["Lively Properties"] = 579,
    ["Lobe AI Agent"] = 123,
    Loki = 124,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 623,
    ["MS2Rescore Configuration"] = 630,
    ["MSTest testconfig.json"] = 631,
    ["Madge configuration"] = 586,
    ["Madness (madness.yml)"] = 1156,
    ["Mado configuration"] = 587,
    ["Maestro Flow"] = 588,
    ["Mail Servers Configuration"] = 1330,
    ["MapEHR Mapping"] = 589,
    Markdownlint = 1087,
    ["Mason Registry"] = 1090,
    ["MegaLinter Custom Flavor"] = 592,
    ["MegaLinter configuration"] = 591,
    ["MegaLinter descriptor"] = 593,
    Melange = 1183,
    ["Meltano project definition"] = 594,
    ["Mergify Configuration"] = 632,
    ["Mermaid config"] = 1,
    ["Metadata for a Bazel module"] = 595,
    ["Metadata for a Cinnamon spice"] = 1234,
    ["Metatype Configuration"] = 596,
    ["MetricsHub Configuration"] = 597,
    ["MetricsHub Connector Configuration"] = 598,
    ["Micro Editor Syntax"] = 1166,
    ["Microsoft Band Web Tile"] = 599,
    ["Microsoft RulesEngine workflow rules"] = 1221,
    ["Microsoft RulesEngine workflow rules list"] = 1222,
    ["Minecraft Custom Main Menu Mod"] = 1184,
    ["Minecraft Data Pack Advancement"] = 601,
    ["Minecraft Data Pack Biome"] = 602,
    ["Minecraft Data Pack Configured Carver"] = 603,
    ["Minecraft Data Pack Damage Type"] = 604,
    ["Minecraft Data Pack Dimension"] = 606,
    ["Minecraft Data Pack Dimension Type"] = 605,
    ["Minecraft Data Pack Item Modifier"] = 607,
    ["Minecraft Data Pack Loot Table"] = 608,
    ["Minecraft Data Pack Metadata"] = 609,
    ["Minecraft Data Pack Predicate"] = 610,
    ["Minecraft Data Pack Recipe"] = 611,
    ["Minecraft Data Pack Tag"] = 612,
    ["Minecraft Data Pack Template Pool"] = 613,
    ["Minecraft Data Pack Trim Material"] = 618,
    ["Minecraft Data Pack Trim Pattern"] = 619,
    ["Minecraft Resource Pack Lang"] = 614,
    ["Minecraft Resource Pack Particle"] = 615,
    ["Minecraft Resource Pack Texture Mcmeta"] = 617,
    ["Minecraft Resourcepack Sounds"] = 616,
    ["MockServer Expectations"] = 625,
    ModuleAssembler = 621,
    ["Monade CLI Stack Configuration"] = 635,
    ["MongoDB Atlas Search Index Definition"] = 1137,
    ["Monika Configuration"] = 1135,
    ["Monoweave Configuration"] = 629,
    ["Motif config"] = 1026,
    MultiQC = 1275,
    ["NOX Framework (Service)"] = 657,
    ["Netin Diagnostic System Template"] = 1094,
    ["Netlify config"] = 638,
    ["Network-as-Code Data Model"] = 639,
    ["Next Gen UI Agent A2A Server Configuration"] = 640,
    ["Next Gen UI Agent Configuration"] = 642,
    ["Next Gen UI Agent MCP Server Configuration"] = 641,
    ["Nightwatch.js"] = 649,
    ["Nika workflow"] = 654,
    ["Node.js configuration"] = 1031,
    ["NueJS configuration file"] = 662,
    ["Nuitka Package Config"] = 1198,
    ["Nullstone config"] = 664,
    ["OKF Graph"] = 1368,
    ["ONe's changelog entry"] = 683,
    ["ONe's service descriptor"] = 682,
    ["ORT Server repository environment configuration"] = 693,
    ["OSCAL Assessment Plan (AP)"] = 695,
    ["OSCAL Assessment Results (AR)"] = 696,
    ["OSCAL Catalog"] = 697,
    ["OSCAL Component Definition (CDef)"] = 698,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 699,
    ["OSCAL Profile"] = 700,
    ["OSCAL System Security Plan (SSP)"] = 701,
    ["OSS Review Toolkit configuration"] = 702,
    ["OSS Review Toolkit curation"] = 703,
    ["OSS Review Toolkit package configuration"] = 704,
    ["OSS Review Toolkit project package manager definition"] = 705,
    ["OSS Review Toolkit repository configuration"] = 706,
    ["OSS Review Toolkit resolutions"] = 707,
    ["October CMS columns"] = 668,
    ["October CMS fields"] = 669,
    ["Oh My Posh"] = 671,
    Okteto = 672,
    ["Ona Automations"] = 674,
    Opctl = 1029,
    ["Open Data Contract Standard (ODCS)"] = 687,
    ["Open Data Product Standard (ODPS)"] = 688,
    ["Open Know-How"] = 1280,
    OpenDecree = 1344,
    ["OpenDecree Configuration"] = 1345,
    ["OpenRewrite Resource"] = 685,
    OpenSRM = 689,
    OpenStatus = 1291,
    ["OpenTelemetry Declarative Configuration"] = 686,
    ["OpenUtau character yaml"] = 679,
    ["OpenUtau ustx"] = 680,
    ["OpenWeather Current Weather API"] = 1072,
    ["OpenWeather Road Risk API"] = 1071,
    ["Ory Hydra configuration"] = 498,
    ["Ory Keto configuration"] = 561,
    ["Ory Kratos configuration"] = 694,
    ["Ory Oathkeeper configuration"] = 666,
    ["Outblocks App configuration"] = 691,
    ["Outblocks database table"] = 692,
    ["Outblocks project configuration"] = 690,
    PDM = 715,
    POPxf = 727,
    ["POPxf Correlations"] = 728,
    ["PRML manifest"] = 735,
    Packer = 711,
    PactSpec = 712,
    Panache = 713,
    Pantsbuild = 1152,
    ["Paper paper-plugin.yml"] = 714,
    ["Pipeline component"] = 1085,
    ["Platform.sh application"] = 12,
    ["Platform.sh routes"] = 13,
    ["Platform.sh services"] = 14,
    ["Plex Prerolls"] = 725,
    ["PocketMine plugin.yml"] = 722,
    ["Podman Desktop Extension"] = 1363,
    ["Postman collection"] = 731,
    ["Power Pages Configuration"] = 1292,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1237,
    ["ProActions AI-Kit Configuration"] = 743,
    ["ProActions AI-Kit Configuration for Menus"] = 745,
    ["ProActions AI-Kit Configuration for Sections"] = 747,
    ["ProActions AI-Kit Configuration for Services"] = 744,
    ["ProActions AI-Kit Configuration for Steps"] = 748,
    ["ProActions AI-Kit Configuration for Templates"] = 746,
    ["Problem object RFC9457"] = 1181,
    ["Problem package format"] = 749,
    ["Problem package generators"] = 750,
    ["Problem package submissions"] = 751,
    ["Problem package test group metadata"] = 752,
    Pterodactyl = 1131,
    ["Pull Request Labeler"] = 769,
    Pulumi = 777,
    ["PyGTA Config"] = 773,
    PyProject = 778,
    Pylock = 1283,
    Pyright = 779,
    ["Python script metadata"] = 1277,
    ["QType AI DSL"] = 782,
    Qgoda = 781,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1355,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1353,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1359,
    ["Qlik Talend Cloud Pipeline - Project"] = 1351,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1354,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1356,
    ["Qlik Talend Cloud Pipeline - Task"] = 1352,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1358,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1357,
    Qodana = 1104,
    ["Qt Creator workspace file"] = 1214,
    ["Quali Torque Blueprint Spec 2"] = 1129,
    ["QueryFirst config file"] = 1148,
    ["QuikRun Configuration"] = 1360,
    ["Qwen Code Settings"] = 1341,
    ["RKE Cluster Configuration JSON"] = 1082,
    ["RKE Cluster Configuration YAML"] = 1081,
    RadioHound = 772,
    ["Raid Profile"] = 1342,
    ["Raid Repo Configuration"] = 1343,
    Railpack = 784,
    Railway = 783,
    ["Rancher Fleet"] = 774,
    ["Rattler-build"] = 785,
    Ray = 1043,
    ["Read the Docs"] = 776,
    ["Red-DiscordBot Cog"] = 792,
    ["Red-DiscordBot Cog Repo"] = 793,
    ["Red-DiscordBot Trivia"] = 794,
    ["Releasaurus Config"] = 9,
    ReleaseKit = 8,
    ["Render Blueprints"] = 1080,
    RenderCV = 811,
    Renovate = 808,
    ["Renovate global configuration"] = 809,
    ["Renovate inherited configuration"] = 810,
    ["Replit config"] = 800,
    Restate = 1270,
    ["Revel Digital Gadget Definition File"] = 1294,
    RoadRunner = 813,
    ["Robust Station Image"] = 1300,
    Rockcraft = 814,
    ["Roo Coder Custom Modes"] = 815,
    Rubocop = 804,
    ["Rudder techniques"] = 1188,
    Ruff = 805,
    ["Rust Project"] = 806,
    ["Rust toolchain"] = 820,
    ["SDMX data message"] = 847,
    ["SDMX metadata message"] = 846,
    ["SDMX structure message"] = 845,
    ["SIL Kit Participant Configuration"] = 858,
    ["SIL Kit Registry Configuration"] = 859,
    ["SPDX 2.3"] = 898,
    SWADL = 914,
    ["Safebox Config"] = 1143,
    ["Sapphire CLI Config"] = 823,
    ["SauceCTL Configuration"] = 1091,
    Scarb = 843,
    ["Schema Catalog"] = 838,
    ["Scoop manifest"] = 844,
    ["Secure SDLC Evidence Bundle"] = 848,
    ["Semantic Data Fabric (SDF) file"] = 849,
    ["Semgrep Rule"] = 851,
    ["Serenity Code Generator (Sergen)"] = 852,
    ["Serverless Framework Configuration"] = 1098,
    ["Serverless Workflow"] = 1100,
    ["Settings for a Cinnamon spice"] = 1233,
    ["Settings.paf"] = 854,
    ["Shopware 6 Configuration"] = 1101,
    ["Shopware CLI Extension Store Configuration"] = 1102,
    ["Shopware CLI Project Store Configuration"] = 1103,
    ["Sigma Detection Rule"] = 856,
    ["SigmaCV CV"] = 4,
    ["Sigrid scope configuration file"] = 857,
    ["SkyPilot Task JSON"] = 1189,
    ["Slack app manifest"] = 861,
    ["Slang Server Configuration"] = 1367,
    Snapcraft = 863,
    ["Solarxy project config"] = 866,
    Solidarity = 867,
    ["Solution filters"] = 868,
    ["Source Maps v3"] = 869,
    Sourcery = 870,
    ["Spack bootstrap.yaml"] = 871,
    ["Spack cdash.yaml"] = 872,
    ["Spack ci.yaml"] = 873,
    ["Spack compilers.yaml"] = 874,
    ["Spack concretizer.yaml"] = 875,
    ["Spack config.yaml"] = 876,
    ["Spack definitions.yaml"] = 877,
    ["Spack develop.yaml"] = 878,
    ["Spack env_vars.yaml"] = 879,
    ["Spack environment"] = 885,
    ["Spack include.yaml"] = 880,
    ["Spack mirrors.yaml"] = 881,
    ["Spack modules.yaml"] = 882,
    ["Spack packages.yaml"] = 883,
    ["Spack repos.yaml"] = 884,
    ["Spack toolchains.yaml"] = 886,
    ["Spack upstreams.yaml"] = 887,
    ["Spack view.yaml"] = 888,
    ["Speakeasy Generation Config File"] = 892,
    ["Speakeasy Lint Configuration File"] = 889,
    ["Speakeasy Test Generation Configuration File"] = 890,
    ["Speakeasy Workflow File"] = 891,
    SpecIF = 893,
    ["Specmatic Configuration"] = 894,
    ["Specpin spec file"] = 2,
    ["Sponge Mixin configuration"] = 895,
    ["Spotlight Ruleset"] = 896,
    StackBlitz = 902,
    ["StackHawk Scanner Configuration"] = 1097,
    Stale = 903,
    Starfish = 904,
    ["Starlake Data Pipeline"] = 1069,
    Starship = 905,
    ["Statamic Blueprint"] = 906,
    ["Stella configuration file"] = 907,
    ["Streamlit configuration file"] = 908,
    ["Stryker Mutator"] = 911,
    ["StyleCop Analyzers Configuration"] = 912,
    ["Stylelint (.stylelintrc)"] = 913,
    ["Stylua Config"] = 1284,
    ["Sublime Syntax"] = 1144,
    ["Subsquid squid manifest"] = 1191,
    ["Swagger API 2.0"] = 915,
    ["Synadia Connect Component"] = 916,
    TSON = 953,
    TSTyche = 954,
    ["TYPO3 Vendor Bundler config"] = 960,
    ["Tab data for a LinUtil"] = 1240,
    ["Tab list for a LinUtil"] = 1239,
    Tach = 917,
    ["Tach Domain"] = 918,
    Talhelper = 920,
    ["Talisman configuration"] = 921,
    Taplo = 1285,
    ["Taskfile config"] = 1074,
    Taurus = 922,
    Tauticord = 923,
    ["Tekton Pipeline"] = 1313,
    ["Tekton PipelineRun"] = 1314,
    ["Tekton Task"] = 1311,
    ["Tekton TaskRun"] = 1312,
    Telefonistka = 1271,
    ["Terrateam config"] = 1297,
    ["TestEnvironment.json"] = 935,
    ["TextMate Grammar"] = 934,
    Threagile = 929,
    ["Tier.run pricing.json"] = 926,
    Tikibase = 927,
    Tombi = 932,
    ["Traefik v2"] = 938,
    ["Traefik v2 File Provider"] = 939,
    ["Traefik v3"] = 940,
    ["Traefik v3 File Provider"] = 941,
    ["Travis CI (.travis.yml)"] = 937,
    Treefmt = 475,
    Trident = 1267,
    Trivy = 944,
    ["TrueScript for *.tscript files"] = 945,
    ["Tugboat QA config.yml"] = 1264,
    TunnelHub = 1179,
    Turborepo = 936,
    Tycho = 1228,
    Tye = 1105,
    ["Tyk Gateway - Open Source v5.7+"] = 1276,
    ["UET BuildConfig.json"] = 1149,
    ["UI5 Manifest"] = 966,
    ["UNCORS configuration"] = 971,
    ["UTAM Page Object"] = 969,
    ["Ubuntu Server Autoinstall"] = 964,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1268,
    ["Uniswap Token List"] = 1054,
    ["Universal Schedule Format"] = 972,
    ["Unreal Engine Uplugin"] = 1150,
    ["Unreal Engine Uproject"] = 1151,
    ["UpCloud CLI (upctl) configuration"] = 1269,
    ["Updatecli Compose"] = 1113,
    ["Updatecli Policy Manifest"] = 1114,
    ["Updatecli Policy Metadata"] = 1115,
    Uplift = 1147,
    ["Upsun config"] = 11,
    ["User Journey Map"] = 1079,
    V2Ray = 1119,
    ["VSCode Code Snippets"] = 273,
    ["VSIX CLI publishing"] = 990,
    Vector = 974,
    ["Vela Pipeline Configuration"] = 977,
    Vercel = 272,
    ["Version Bumper config"] = 980,
    Vespertide = 1318,
    ["Vespertide Migration"] = 1319,
    ["Vespertide Model"] = 1320,
    ["Viash Component Config"] = 1273,
    ["Viash Package Config"] = 1274,
    Visivo = 1177,
    ["WP-CLI"] = 1000,
    Wake = 1266,
    ["Waku Config"] = 1243,
    ["Web App Manifest"] = 996,
    ["Web types"] = 999,
    WebExtensions = 995,
    ["Webman package recipe"] = 1125,
    ["Windows Package Manager Installer Manifest"] = 1051,
    ["Windows Package Manager Locale Manifest"] = 1052,
    ["Windows Package Manager Singleton Manifest"] = 1050,
    ["WireMock CLI import configuration"] = 1249,
    ["WireMock CLI local service configuration"] = 1248,
    ["WireMock message stub mapping"] = 1247,
    ["WireMock stub mapping"] = 1246,
    ["Woodpecker pipeline config"] = 1093,
    ["Wrangler CLI"] = 1001,
    ["XenForo add-on manifest"] = 1002,
    ["Xstate Machine"] = 1111,
    ["Yandex Workflow Language"] = 1235,
    ["Yarn Config (.yarnrc.yml)"] = 1067,
    ["Yippee-Ki-JSON configuration YML"] = 1058,
    ["YouTrack App"] = 1232,
    ["Zarf Package Configuration"] = 1299,
    ["Zerops import file"] = 1220,
    ["Zola Configuration"] = 1310,
    abtop = 32,
    actionlint = 42,
    ["aerleon.yml"] = 26,
    ["amplify.yml"] = 19,
    ["amxx-builder manifest"] = 1362,
    ["angular.json"] = 47,
    apko = 1182,
    ...
    ["behat.yml"] = 155,
    ["bigquery-table"] = 143,
    ["bioimageio resource description"] = 1199,
    ...
    ["cargo-nextest repository configuration"] = 643,
    ["cargo-nextest user configuration"] = 644,
    ["ccmod.json"] = 1244,
    changelogging = 1211,
    ...
    ["chutzpah.json"] = 281,
    cibuildwheel = 192,
    ["clang-format (.clang-format)"] = 1117,
    ["clang-tidy"] = 255,
    clangd = 254,
    clib = 256,
    ...
    ["crowdin.yml"] = 308,
    ["ctfd-setup configuration file"] = 1256,
    ["custom-elements.json"] = 1169,
    ["cypress.json"] = 312,
    ["dacier.yml"] = 1350,
    ...
    ["dtool dataset metadata"] = 1251,
    ["dvc.yaml"] = 356,
    ["ecosystem.json"] = 361,
    eksctl = 363,
    ["electron-builder configuration file"] = 389,
    ["epr-manifest.json"] = 388,
    ["estampo.toml"] = 387,
    ["evcc.yaml"] = 390,
    ["ezd task runner"] = 401,
    ["fabric.mod.json"] = 404,
    ["first-timers-bot"] = 412,
    ["flagd flag configuration"] = 129,
    ["fly.io Configuration"] = 130,
    fulibWorkflows = 1092,
    ["function.json"] = 424,
    ["gRPC API Gateway & OpenAPI Config"] = 21,
    ["gematik health care insurance list"] = 1262,
    ["gematik health care patient list"] = 1259,
    ["gematik health care provider institution list"] = 1261,
    ["gematik health care provider list"] = 1260,
    ["gematik tiger test environment configuration"] = 1263,
    ["git-cliff"] = 435,
    ["git-town.toml"] = 1308,
    ["gitlab-ci"] = 447,
    ["global.json"] = 464,
    ["go-feature-flag Flag Configuration"] = 468,
    gollama = 467,
    ["hassette.toml"] = 491,
    ["haxelib.json"] = 487,
    helmfile = 1046,
    ...
    ["ide.host.json"] = 503,
    ["ifstate.yaml"] = 504,
    ["imageoptimizer.json"] = 505,
    ["importmap.json"] = 508,
    ["index.toml (packwiz)"] = 1364,
    instant_python_config = 512,
    instant_python_custom_project = 513,
    intlayer = 514,
    ["ioBroker Configuration"] = 515,
    ["ioBroker JSON UI"] = 516,
    ["ioBroker Package manifest"] = 517,
    ["ixpect.conf.yaml"] = 518,
    ["ize.toml"] = 1146,
    ["jsconfig.json"] = 543,
    ["jscpd Configuration"] = 1130,
    jsdoc = 1042,
    ["k3d.yaml"] = 544,
    ["k9s aliases.yaml"] = 546,
    ["k9s cluster-config.yaml"] = 548,
    ["k9s config.yaml"] = 547,
    ["k9s hotkeys.yaml"] = 549,
    ["k9s plugins.yaml"] = 550,
    ["k9s skin.yaml"] = 551,
    ["k9s views.yaml"] = 552,
    ["kontinuous-config.yaml"] = 564,
    ["kontinuous-values.yaml"] = 563,
    ["kustomization.yaml"] = 566,
    ["label-commenter-config.yml"] = 567,
    ["latexindent configuration"] = 122,
    ["launchsettings.json"] = 568,
    lazydocker = 1168,
    lazygit = 1167,
    ["lego.json"] = 570,
    ["lerna.json"] = 571,
    ["lgtm.yml"] = 572,
    ["liblab.config.json"] = 573,
    ["libman.json"] = 574,
    ["license-report-config.json"] = 575,
    ["linkinator.config.json"] = 577,
    ["lint-staged (.lintstagedrc)"] = 1019,
    ["local.settings.json"] = 582,
    ["localazy.json"] = 583,
    ["lotus.yaml"] = 581,
    ["lsdlschema.json"] = 584,
    lychee = 1018,
    ["macro.json"] = 1134,
    ["markdown-link-check"] = 1088,
    maturin = 1089,
    mboats = 1096,
    memnex = 1348,
    ["micro-settings.json"] = 1161,
    ["mimetypes.json"] = 600,
    ["mirrord config"] = 1022,
    ["misata.yaml"] = 1021,
    mise = 1023,
    ["mkdocs.yml"] = 620,
    ["mockd.yaml"] = 624,
    ["mod.pw.toml (packwiz)"] = 1365,
    ["modelparams.dev Model"] = 626,
    ["models CLI"] = 627,
    ["monospace.yml"] = 628,
    ["moon.yml"] = 1245,
    ["mprocs Configuration file"] = 1215,
    ["mrdocs.yml"] = 622,
    ["mta.yaml"] = 1024,
    ["mtad.yaml"] = 1025,
    ["mycode.json"] = 636,
    nFPM = 648,
    ["napari plugin manifest"] = 637,
    neoload = 1037,
    ["nest-cli"] = 651,
    ["nexus-rpc-gen"] = 1335,
    ["nf-core module environment.yml"] = 645,
    ["nf-core module meta.yml"] = 646,
    ["nf-core subworkflow meta.yml"] = 647,
    ["ninjs (News in JSON)"] = 650,
    ["nitro.json"] = 1036,
    ["nixd configuration"] = 1187,
    ["nlu.json"] = 652,
    ["nodemon.json"] = 655,
    ["noodl config"] = 1095,
    ["notebook.mod.json"] = 656,
    now = 1032,
    ["npm-badges"] = 659,
    ["nswag.json"] = 663,
    ntangle = 665,
    ["nuclei-template.yaml"] = 660,
    ["nuget-project.json"] = 661,
    ["ocelot.json"] = 667,
    ogen = 670,
    ["omnisharp.json"] = 673,
    openHAB = 1321,
    ...
    oxfmt = 1331,
    oxlint = 1332,
    ["pack.toml (packwiz)"] = 1366,
    ["package.json"] = 708,
    ["package.manifest"] = 710,
    ["package.yaml"] = 709,
    ["partial-black.json"] = 156,
    ["partial-fastapi.json"] = 157,
    ["partial-pixi.json"] = 720,
    ["partial-scheduled.json"] = 158,
    ["pattern.json"] = 718,
    ["petstore-v1.0"] = 1141,
    pgap_yaml_input_reader = 716,
    pgrls = 717,
    pgxgen = 1325,
    pitcms = 1328,
    ["pixi.toml"] = 719,
    ["plagiarize-me.yaml"] = 724,
    ["plagiarize.yaml"] = 723,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1252,
    ["podbard.yaml"] = 726,
    ["portman.json"] = 729,
    ["prefect.toml"] = 738,
    ["prefect.yaml"] = 739,
    ...
    ["prettierrc.json"] = 741,
    ["prisma.yml"] = 742,
    ["project-1.0.0-beta3.json"] = 754,
    ["project-1.0.0-beta4.json"] = 755,
    ["project-1.0.0-beta5.json"] = 756,
    ["project-1.0.0-beta6.json"] = 757,
    ["project-1.0.0-beta8.json"] = 758,
    ["project-1.0.0-rc1.json"] = 759,
    ["project-1.0.0-rc2.json"] = 760,
    ["project.json"] = 753,
    ["project.owasp.yaml"] = 761,
    ["prometheus-alertmanager.json"] = 765,
    ["prometheus.json"] = 762,
    ["prometheus.rules.json"] = 763,
    ["prometheus.rules.test.json"] = 764,
    ["proxies.json"] = 766,
    ["publiccode.yml"] = 767,
    ["pubspec.yaml"] = 768,
    ["pyrseas-0.8.json"] = 771,
    pytest = 780,
    ["quilt.mod.json"] = 1162,
    ["rc3 auth"] = 786,
    ["rc3 collection"] = 787,
    ...
    ["rc3 settings"] = 791,
    ["registry.yaml"] = 60,
    ["release drafter"] = 1038,
    ["release-hub.json"] = 7,
    ["release-please-config.json"] = 796,
    ["release-please-manifest.json"] = 797,
    ["release-plz.toml"] = 798,
    ["renv.lock"] = 812,
    ["reposets Configuration"] = 801,
    ["reposets Credentials"] = 802,
    ["revola.json"] = 5,
    ["rivet.json"] = 1186,
    ["rivet.yaml (legacy)"] = 1185,
    rumdl = 817,
    runny = 816,
    runspec = 1349,
    rustfmt = 818,
    ...
    samt = 821,
    samtrc = 822,
    ["sarif-1.0.0.json"] = 824,
    ["sarif-2.0.0.json"] = 825,
    ["sarif-2.1.0"] = 835,
    ["sarif-2.1.0-rtm.2"] = 826,
    ["sarif-2.1.0-rtm.3"] = 828,
    ["sarif-2.1.0-rtm.4"] = 830,
    ["sarif-2.1.0-rtm.5"] = 832,
    ["sarif-2.1.0-rtm.6"] = 833,
    ["sarif-external-property-file-2.1.0"] = 836,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 827,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 829,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 831,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 834,
    ["scalingo.json configuration"] = 837,
    ["schema.org - Action"] = 839,
    ["schema.org - ContactPoint"] = 840,
    ["schema.org - Place"] = 841,
    ["schema.org - Thing"] = 842,
    ["secrethub.yml"] = 1164,
    ["semantic-release"] = 850,
    ["servicehub.config.json"] = 1013,
    ["servicehub.service.json"] = 1012,
    ["settings.job"] = 853,
    ["sfdx-hardis configuration"] = 855,
    ["shard.yml"] = 1202,
    ["size-limit configuration"] = 860,
    ["skaffold.yaml"] = 1086,
    ["skyuxconfig.json"] = 862,
    ["snowflake-config"] = 864,
    ["snowflake-connections"] = 865,
    ["spicepod.yaml"] = 1223,
    ["sqlc configuration"] = 899,
    ["stripe-app-local.json"] = 910,
    ["stripe-app.json"] = 909,
    swcrc = 1070,
    ["task.json"] = 919,
    taskcat = 1033,
    ["template.json"] = 924,
    ["templatsources.json"] = 925,
    ["text2confl config"] = 1333,
    ["theme.json"] = 928,
    ["tizen_workspace.json"] = 930,
    tldr = 931,
    ["tm_devices configuration file"] = 1290,
    tmuxinator = 1016,
    tox = 933,
    ["transcend.yml"] = 942,
    ["tree-sitter grammar.json"] = 474,
    ["trime.yaml"] = 943,
    ["trunk.yaml"] = 946,
    ["ts-force-config.json"] = 951,
    ["tsconfig.json"] = 947,
    ["tsd.json"] = 948,
    ["tsdoc.json"] = 949,
    ["tsdrc.json"] = 950,
    ...
    ["vega-lite.json"] = 976,
    ["vega.json"] = 975,
    ["venvironment.yaml"] = 978,
    ["venvplus.yaml"] = 979,
    version = 1272,
    ["version.json"] = 981,
    ["vhwdebugger-binding.yaml"] = 983,
    ["vim-addon-info"] = 984,
    ["vs-2017.3.host.json"] = 986,
    ["vs-nesting.json"] = 987,
    ["vsls.json"] = 985,
    ["vss-extension.json"] = 991,
    vtcfg = 1278,
    ["vtesttree.yaml"] = 992,
    ["vtestunit.yaml"] = 993,
    ["warp-keysets.json"] = 1170,
    ["warp-themes.json"] = 1171,
    ["warp-workflows.json"] = 1172,
    ["webhint.io"] = 1126,
    ["webjobpublishsettings.json"] = 998,
    ["webjobs-list.json"] = 997,
    ["well-known-fursona"] = 1210,
    ["xs-app.json"] = 1028,
    ["xunit.runner.json"] = 1011,
    yamlfmt = 1055,
    yamllint = 1056,
    ["yap.json"] = 1057,
    ["zerops.yml"] = 1219,
