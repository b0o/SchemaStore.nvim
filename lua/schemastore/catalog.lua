...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 165,
    [".cryproj (generic)"] = 572,
    [".cryproj engine-5.2"] = 567,
    [".cryproj engine-5.3"] = 568,
    [".cryproj engine-5.4"] = 569,
    [".cryproj engine-5.5"] = 570,
    [".cryproj engine-dev"] = 571,
    [".csscomb.json"] = 167,
    [".csslintrc"] = 168,
    [".es6importsorterrc.json"] = 699,
    [".eslintrc"] = 214,
    [".esmrc.json"] = 206,
    [".ffizer.yaml"] = 218,
    [".htmlhintrc"] = 265,
    ...
    [".mtaext"] = 581,
    [".nodehawkrc"] = 360,
    [".npmpackagejsonlintrc"] = 363,
    [".phraseapp.yml"] = 403,
    [".pmbot.yml"] = 393,
    [".postcssrc"] = 398,
    [".powerpages-web-template-manifest"] = 400,
    [".pre-commit-config.yml"] = 401,
    [".pre-commit-hooks.yml"] = 402,
    [".putout.json"] = 421,
    [".rehyperc"] = 432,
    [".remarkrc"] = 433,
    [".sprite files"] = 486,
    ...
    ["<div>RIOTS' studio configuration"] = 551,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config schema"] = 322,
    ["API Builder"] = 612,
    ["AVA Configuration Schema"] = 669,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration Schema"] = 644,
    ["All Contributors configuration file"] = 698,
    ...
    ["Azure Pipelines"] = 54,
    ["Azure Static Web Apps CLI configuration file"] = 488,
    ["Azure Static Web Apps configuration file"] = 487,
    ["BX CI"] = 89,
    ["Better Code Hub"] = 617,
    ["Better Scripts"] = 90,
    BizTalkServerApplicationSchema = 587,
    ...
    ["Butane Config"] = 656,
    ["CICS TS region tagging"] = 663,
    ["CICS TS resource import"] = 664,
    ["CICS TS resource model"] = 665,
    ["CICS TS resource overrides"] = 666,
    ["CMake Presets"] = 91,
    ...
    Conjure = 99,
    ["Container Structure Test"] = 599,
    Containerlab = 625,
    ["Crowdsec collection Schema"] = 161,
    ["Crowdsec parser Schema"] = 162,
    ["Crowdsec scenario Schema"] = 163,
    ["DWP Exchange - catalogue entry"] = 203,
    ["DWP Exchange - gateway"] = 201,
    ["DWP Exchange - meta"] = 202,
    ["Dart build configuration"] = 169,
    ["Dart test config"] = 170,
    ["DashLord configuration"] = 171,
    ["Datadog Service Definition"] = 302,
    ["Datahub Ingestion Recipe Schema"] = 670,
    ...
    Devfile = 200,
    ["Discord Webhook"] = 180,
    ["Dolittle Artifacts"] = 184,
    ["Dolittle Bounded Context Configuration"] = 185,
    ["Dolittle Event Horizons Configuration"] = 186,
    ["Dolittle Resources Configuration"] = 187,
    ["Dolittle Server Configuration"] = 188,
    ["Dolittle Tenant Map Configuration"] = 190,
    ["Dolittle Tenants Configuration"] = 189,
    ["Dolittle Topology"] = 191,
    ...
    ["Drush site aliases"] = 196,
    ["Embrace Config Schema"] = 681,
    ["Error pages"] = 209,
    Esquio = 207,
    ["Estuary Flow Catalog Schema"] = 660,
    ["Expo SDK"] = 212,
    ["F-Droid Data metadata"] = 217,
    ["Facets - FSDL - Application"] = 215,
    ["FasterCI Configuration"] = 55,
    Firebase = 219,
    ["Fossa configuration file"] = 226,
    ["Fossa's fossa-deps file"] = 227,
    ["Foundry VTT - Base package Manifest"] = 221,
    ["Foundry VTT - Module Manifest"] = 222,
    ["Foundry VTT - System Data Template"] = 225,
    ["Foundry VTT - System Manifest"] = 223,
    ["Foundry VTT - World Manifest"] = 224,
    ["Foxx Manifest"] = 56,
    ["Freifunk.de Community API"] = 59,
    ["Frogbot Config"] = 60,
    ["GCP Blueprint Metadata"] = 232,
    ["GatewayCore API Gateway"] = 231,
    ["GeoJSON.json latest"] = 658,
    GherKing = 662,
    ["GitHub Action"] = 236,
    ["GitHub Discussion"] = 237,
    ["GitHub Funding"] = 238,
    ["GitHub Issue Template configuration"] = 240,
    ["GitHub Workflow"] = 241,
    ["GitHub Workflow Template Properties"] = 242,
    ["GitHub issue forms"] = 239,
    GitVersion = 235,
    ["Gitpod Configuration"] = 244,
    ["Global Privacy Control"] = 233,
    ["Google Cloud Workflows"] = 149,
    Goreleaser = 247,
    ["Goreleaser Pro"] = 248,
    ["Gradle Build Cache Node"] = 614,
    ["Gradle Enterprise"] = 613,
    ["Grafana 5.x Dashboard"] = 249,
    ["GraphQL Code Generator"] = 252,
    ["GraphQL Config"] = 251,
    ["GraphQL Mesh"] = 250,
    ["Grunt JSHint task"] = 256,
    ["Grunt Watch task"] = 257,
    ["Grunt base task"] = 258,
    ["Grunt clean task"] = 254,
    ["Grunt copy task"] = 253,
    ["Grunt cssmin task"] = 255,
    HEMTT = 584,
    Hadolint = 596,
    Hammerkit = 624,
    ["Hardware Sentry Configuration"] = 674,
    Hayson = 260,
    ["Haystack Pipeline"] = 261,
    ["Hazelcast 5 Configuration"] = 262,
    ["Helm Chart.lock"] = 121,
    ["Helm Chart.yaml"] = 120,
    ["Helm Unittest Test Suite"] = 122,
    Hugo = 652,
    ["IBM Zapp document"] = 267,
    ["IBM zCodeFormatSettings"] = 268,
    ["IMG Catapult PSP"] = 273,
    ["Istanbul Schema"] = 677,
    ["JDownloader2 crawler multi-rule schema"] = 283,
    ["JDownloader2 crawler single-rule schema"] = 282,
    ["JFrog File Spec"] = 284,
    ["JFrog Pipelines YML DSL"] = 683,
    ["JMeter DSL cli config schema"] = 285,
    JReleaser = 287,
    ["JSON Document Transform"] = 294,
    ["JSON Feed"] = 295,
    ["JSON Resume"] = 439,
    ["JSON Schema Draft 2020-12"] = 563,
    ["JSON Schema Draft 4"] = 560,
    ["JSON Schema Draft 7"] = 561,
    ["JSON Schema Draft 8"] = 562,
    ...
    ["JSON-API"] = 293,
    ["JSON-e templates"] = 622,
    ["JSON-stat 2.0"] = 557,
    JSONPatch = 297,
    Jasmine = 278,
    Jekyll = 279,
    ["Jenkins X Pipelines"] = 280,
    ["Jenkins X Requirements"] = 281,
    ["Jovo Language Models"] = 286,
    ["KSP-AVC"] = 558,
    ["KSP-CKAN"] = 559,
    ["Karakum configuration file"] = 228,
    Kas = 300,
    ["Keycloak REST API"] = 690,
    ["Knative Functions - func.yaml"] = 229,
    ["KoDE/CI build.yaml"] = 679,
    ["Kong DBLess Schema"] = 680,
    KrakenD = 301,
    LOOBin = 317,
    Lefthook = 308,
    ["LinkML Metamodel"] = 315,
    Liquibase = 629,
    ["Liquibase Flow File"] = 630,
    ["Lively Properties"] = 316,
    Markdownlint = 633,
    ["Mason Registry"] = 635,
    ["MegaLinter configuration"] = 323,
    ["MegaLinter descriptor"] = 324,
    ["Meltano plugin discovery definition"] = 326,
    ["Meltano project definition"] = 325,
    ["Microsoft Band Web Tile"] = 327,
    ["Minecraft Data Pack Advancement"] = 329,
    ["Minecraft Data Pack Biome"] = 330,
    ["Minecraft Data Pack Configured Carver"] = 331,
    ["Minecraft Data Pack Damage Type"] = 332,
    ["Minecraft Data Pack Dimension"] = 334,
    ["Minecraft Data Pack Dimension Type"] = 333,
    ["Minecraft Data Pack Item Modifier"] = 335,
    ["Minecraft Data Pack Loot Table"] = 336,
    ["Minecraft Data Pack Metadata"] = 337,
    ["Minecraft Data Pack Predicate"] = 338,
    ["Minecraft Data Pack Recipe"] = 339,
    ["Minecraft Data Pack Tag"] = 340,
    ["Minecraft Data Pack Template Pool"] = 341,
    ["Minecraft Data Pack Trim Material"] = 346,
    ["Minecraft Data Pack Trim Pattern"] = 347,
    ["Minecraft Resource Pack Lang"] = 342,
    ["Minecraft Resource Pack Particle"] = 343,
    ["Minecraft Resource Pack Texture Mcmeta"] = 345,
    ["Minecraft Resourcepack Sounds"] = 344,
    ["MkDocs Configuration 1.0"] = 348,
    ["MongoDB Atlas Search Index Definition Schema"] = 678,
    ["Monika Configuration Schema"] = 676,
    ["Motif config"] = 580,
    ["NOX Framework (Service)"] = 362,
    ["Netin Diagnostic System Template"] = 639,
    ["Netlify config schema"] = 353,
    ["Nexus-as-Code schema"] = 354,
    ["Nightwatch.js"] = 355,
    ["ONe's service descriptor"] = 375,
    ["OSS Review Toolkit configuration"] = 382,
    ["OSS Review Toolkit curation"] = 383,
    ["OSS Review Toolkit package configuration"] = 384,
    ["OSS Review Toolkit repository configuration"] = 385,
    ["OSS Review Toolkit resolutions"] = 386,
    Opctl = 583,
    ["OpenRewrite Resource"] = 377,
    ["OpenWeather Current Weather API"] = 621,
    ["OpenWeather Road Risk API"] = 620,
    ["Ory Hydra configuration"] = 266,
    ["Ory Keto configuration"] = 303,
    ["Ory Kratos configuration"] = 381,
    ["Ory Oathkeeper configuration"] = 369,
    ["Outblocks App configuration"] = 379,
    ["Outblocks database table"] = 380,
    ["Outblocks project configuration"] = 378,
    Packer = 389,
    Pantsbuild = 697,
    ["Paper paper-plugin.yml"] = 390,
    ["Pipeline component"] = 631,
    ["PocketMine plugin.yml"] = 394,
    ["Postman collection"] = 399,
    Pterodactyl = 673,
    ["Pull Request Labeler"] = 420,
    Pulumi = 426,
    PyProject = 427,
    Pyright = 428,
    Qodana = 649,
    ["Quali Torque Blueprint Spec 2"] = 671,
    ["QueryFirst config file"] = 693,
    ["RKE Cluster Configuration JSON Schema"] = 628,
    ["RKE Cluster Configuration YAML Schema"] = 627,
    ["Rancher Fleet"] = 423,
    Ray = 595,
    ["Read the Docs"] = 425,
    ["Red-DiscordBot Cog"] = 429,
    ["Red-DiscordBot Cog Repo"] = 430,
    ["Red-DiscordBot Trivia"] = 431,
    Renovate = 440,
    ["Replit schema"] = 434,
    RoadRunner = 441,
    Ruff = 437,
    ["Rust Project"] = 438,
    ["Rust toolchain"] = 443,
    ["SIL Kit Participant Configuration"] = 474,
    ["SIL Kit Registry Configuration"] = 475,
    SWADL = 497,
    ["Safebox Config Schema"] = 684,
    ["Sapphire CLI Config"] = 446,
    ["SauceCTL Configuration"] = 636,
    ["Schema Catalog"] = 460,
    ["Scoop manifest"] = 465,
    ["Semantic Data Fabric (SDF) file"] = 466,
    ["Semgrep Rule"] = 468,
    ["Serenity Code Generator (Sergen)"] = 469,
    ["Serverless Framework Configuration"] = 643,
    ["Serverless Workflow Schema"] = 645,
    ["Settings.paf"] = 471,
    ["Shopware 6 Configuration"] = 646,
    ["Shopware CLI Extension Store Configuration"] = 647,
    ["Shopware CLI Project Store Configuration"] = 648,
    ["Sigrid scope configuration file"] = 473,
    ["Slack app manifest"] = 477,
    Solidarity = 480,
    ["Solution filters"] = 481,
    ["Source Maps v3"] = 482,
    Sourcery = 483,
    SpecIF = 484,
    ["Sponge Mixin configuration"] = 485,
    ["StackHawk Scanner Configuration"] = 642,
    Stale = 489,
    Starship = 490,
    ["Statamic Blueprint"] = 491,
    ["StrmPrivacy Data Connector"] = 688,
    ["StrmPrivacy Data Contract"] = 689,
    ["StrmPrivacy SimpleSchema"] = 686,
    ["StrmPrivacy Stream"] = 687,
    ["StrmPrivacy batch job configuration file"] = 685,
    ["Stryker Mutator"] = 494,
    ["StyleCop Analyzers Configuration"] = 495,
    ["Swagger API 2.0"] = 498,
    TSON = 523,
    ["Talisman configuration"] = 500,
    ["Taskfile YAML Schema"] = 623,
    Taurus = 501,
    ["TestEnvironment.json"] = 510,
    ["Tier.run pricing.json"] = 504,
    Tikibase = 505,
    ["Traefik v2"] = 513,
    ["Traefik v2 File Provider"] = 514,
    Turborepo = 511,
    Tye = 650,
    ["UET BuildConfig.json"] = 694,
    ["UI5 Manifest"] = 530,
    ["UTAM Page Object"] = 533,
    ["Ubuntu Server Autoinstall"] = 528,
    ["Uniswap Token List"] = 605,
    ["Unreal Engine Uplugin"] = 695,
    ["Unreal Engine Uproject"] = 696,
    Updatecli = 657,
    Uplift = 692,
    ["User Journey Map YAML Schema"] = 626,
    V2Ray = 661,
    ["VSCode Code Snippets"] = 137,
    ["VSIX CLI publishing"] = 546,
    ["Vela Pipeline Configuration"] = 536,
    Vercel = 136,
    ["Web App Manifest"] = 553,
    ["Web types"] = 556,
    WebExtensions = 552,
    ["Webman package recipe"] = 667,
    ["Windows Package Manager Installer Manifest"] = 602,
    ["Windows Package Manager Locale Manifest"] = 603,
    ["Windows Package Manager Singleton Manifest"] = 601,
    ["Woodpecker pipeline config"] = 638,
    ["Xstate Machine Schema"] = 655,
    ["Yippee-Ki-JSON configuration YML"] = 607,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 65,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 703,
    ["bashly-strings.yml"] = 704,
    ["bashly.yml"] = 702,
    ["batect.yml"] = 64,
    ["beau.yml"] = 616,
    ...
    cspell = 166,
    ["cypress.json"] = 164,
    ["datalogic-scan2deploy-android"] = 172,
    ["datalogic-scan2deploy-ce"] = 173,
    ["dbt Project"] = 104,
    ["debugsettings.json"] = 174,
    ["dependabot-v2.json"] = 177,
    ["dependabot.json"] = 176,
    ["deployed-cli"] = 654,
    ["detekt.yml"] = 179,
    ...
    djlint = 610,
    ["docfx.json"] = 183,
    ["docker-compose.yml"] = 608,
    ["docker-seq schema"] = 182,
    ["dockerd.json"] = 181,
    ["dotnet Release Index manifest"] = 192,
    ["dotnetcli.host.json"] = 193,
    ["dprint.json"] = 194,
    ["drone.json"] = 195,
    ["dss-2.0.0.json"] = 197,
    ...
    ["ecosystem.json"] = 204,
    eksctl = 205,
    ["electron-builder configuration file."] = 210,
    ["epr-manifest.json"] = 208,
    ["evcc.yaml"] = 211,
    ["ezd schema"] = 213,
    ["fabric.mod.json"] = 216,
    ["first-timers-bot"] = 220,
    ...
    ["gitlab-ci"] = 243,
    ["global.json"] = 245,
    ["golangci-lint Configuration"] = 246,
    ["haxelib.json"] = 259,
    helmfile = 597,
    helmwave = 598,
    ["host-meta.json"] = 264,
    ...
    ["ide.host.json"] = 269,
    ["ifstate.conf"] = 270,
    ["imageoptimizer.json"] = 271,
    ["importmap.json"] = 274,
    ["ioBroker Configuration"] = 275,
    ["ioBroker JSON UI"] = 276,
    ["ioBroker Package manifest"] = 277,
    ["ize.toml"] = 691,
    ["jsconfig.json"] = 298,
    ["jscpd Configuration Schema"] = 672,
    jsdoc = 594,
    ["k3d.yaml"] = 299,
    ["kontinuous-values.yaml"] = 304,
    ...
    ["lgtm.yml"] = 311,
    ["libman.json"] = 312,
    ["license-report-config.json"] = 313,
    ["linkinator.config.json"] = 314,
    ["local.settings.json"] = 319,
    ["localazy.json"] = 320,
    ["lotus.yaml"] = 318,
    ["lsdlschema.json"] = 321,
    ["madness.yml"] = 701,
    ["markdown-lint-check"] = 634,
    mboats = 641,
    ["micro-settings.json"] = 706,
    ["mimetypes.json"] = 328,
    ["mirrord-schema"] = 577,
    ["mta.yaml"] = 578,
    ["mtad.yaml"] = 579,
    ["mycode.json"] = 351,
    ["napari plugin manifest"] = 352,
    neoload = 589,
    ["nest-cli"] = 358,
    ["ninjs (News in JSON) 1.3"] = 357,
    ["ninjs (News in JSON) 2.0"] = 356,
    ["nlu.json"] = 359,
    ["nodemon.json"] = 361,
    ["noodl.schema.json"] = 640,
    now = 585,
    ["npm-badges"] = 364,
    ["nswag.json"] = 367,
    ntangle = 368,
    ["nuclei-template.yaml"] = 365,
    ["nuget-project.json"] = 366,
    ["ocelot.json"] = 370,
    ["omnisharp.json"] = 371,
    ["openapi.json"] = 372,
    ["openfin.json"] = 376,
    ...
    ["ops.yaml"] = 374,
    ["package.json"] = 387,
    ["package.manifest"] = 388,
    ["pattern.json"] = 392,
    ["petstore-v1.0"] = 682,
    pgap_yaml_input_reader = 391,
    ["plagiarize-me.yaml"] = 396,
    ["plagiarize.yaml"] = 395,
    ["portman.json"] = 397,
    ["prettierrc.json"] = 404,
    ["prisma.yml"] = 405,
    ["project-1.0.0-beta3.json"] = 407,
    ["project-1.0.0-beta4.json"] = 408,
    ["project-1.0.0-beta5.json"] = 409,
    ["project-1.0.0-beta6.json"] = 410,
    ["project-1.0.0-beta8.json"] = 411,
    ["project-1.0.0-rc1.json"] = 412,
    ["project-1.0.0-rc2.json"] = 413,
    ["project.json"] = 406,
    ["prometheus.json"] = 414,
    ["prometheus.rules.json"] = 415,
    ["prometheus.rules.test.json"] = 416,
    ["proxies.json"] = 417,
    ["publiccode.yml"] = 418,
    ["pubspec.yaml"] = 419,
    ["pyrseas-0.8.json"] = 422,
    ["quilt.mod.json"] = 707,
    ["release drafter"] = 590,
    rtx = 436,
    rustfmt = 442,
    samt = 444,
    samtrc = 445,
    ["sarif-1.0.0.json"] = 447,
    ["sarif-2.0.0.json"] = 448,
    ["sarif-2.1.0"] = 458,
    ["sarif-2.1.0-rtm.2"] = 449,
    ["sarif-2.1.0-rtm.3"] = 451,
    ["sarif-2.1.0-rtm.4"] = 453,
    ["sarif-2.1.0-rtm.5"] = 455,
    ["sarif-2.1.0-rtm.6"] = 456,
    ["sarif-external-property-file-2.1.0"] = 459,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 450,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 452,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 454,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 457,
    ["schema.org - Action"] = 461,
    ["schema.org - ContactPoint"] = 462,
    ["schema.org - Place"] = 463,
    ["schema.org - Thing"] = 464,
    ["secrethub.yml"] = 709,
    ["semantic-release"] = 467,
    ["servicehub.config.json"] = 566,
    ["servicehub.service.json"] = 565,
    ["settings.job"] = 470,
    ["sfdx-hardis configuration"] = 472,
    ["size-limit configuration"] = 476,
    ["skaffold.yaml"] = 632,
    ["skyuxconfig.json"] = 478,
    snapcraft = 479,
    ["stripe-app-local.json"] = 493,
    ["stripe-app.json"] = 492,
    swcrc = 619,
    syntax = 711,
    ["task.json"] = 499,
    taskcat = 586,
    ["template.json"] = 502,
    ["templatsources.json"] = 503,
    ["theme.json"] = 506,
    ["tizen_workspace.json"] = 507,
    tldr = 508,
    tmLanguage = 509,
    tmuxinator = 574,
    ["transcend-pathfinder.yml"] = 516,
    ["transcend.yml"] = 515,
    ["trunk.yaml schema"] = 517,
    ["ts-force-config.json"] = 521,
    ["tsconfig.json"] = 518,
    ["tsd.json"] = 519,
    ["tsdrc.json"] = 520,
    ["tslint.json"] = 522,
    ...
    ["vega-lite.json"] = 535,
    ["vega.json"] = 534,
    ["venvironment-basic.yaml"] = 538,
    ["venvironment.yaml"] = 537,
    ["version.json"] = 539,
    ["vim-addon-info"] = 540,
    ["vs-2017.3.host.json"] = 542,
    ["vs-nesting.json"] = 543,
    ["vsls.json"] = 541,
    ["vss-extension.json"] = 547,
    ["vtesttree.yaml"] = 548,
    ["vtestunit.yaml"] = 549,
    ["webhint.io"] = 668,
    ["webjobpublishsettings.json"] = 555,
    ["webjobs-list.json"] = 554,
    ["xs-app.json"] = 582,
    ["xunit.runner.json"] = 564,
    yamllint = 606,
    zuul = 591,
    ["Žinoma"] = 600
  },
