...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 943,
    [".nodehawkrc"] = 585,
    [".npmpackagejsonlintrc"] = 589,
    [".omletrc"] = 1122,
    [".phrase.yml"] = 663,
    [".phraseapp.yml"] = 664,
    [".pmbot.yml"] = 649,
    [".postcssrc"] = 658,
    [".powerpages-web-template-manifest"] = 660,
    [".pre-commit-config.yml"] = 661,
    [".pre-commit-hooks.yml"] = 662,
    [".putout.json"] = 697,
    [".rehyperc"] = 722,
    [".remarkrc"] = 726,
    [".sprite files"] = 818,
    ...
    AIConfig = 34,
    ["AMX Muse Program Descriptor"] = 1170,
    ["API Builder"] = 978,
    ["AVA Configuration"] = 1041,
    ["AWS AppConfig Feature Flags-v1"] = 68,
    ["AWS CDK cdk.json"] = 263,
    ["AWS CloudFormation"] = 264,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 265,
    ["AWS Copilot Manifest"] = 1209,
    ["AWS SAM CLI Samconfig"] = 266,
    ["Adobe UXP Manifest"] = 1104,
    ["Aerleon Network & Service Definitions"] = 20,
    ["Aerleon Policy"] = 21,
    ["AgentCore CLI"] = 1249,
    Aider = 1199,
    Air = 23,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1220,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1219,
    ["Airlock Microgateway"] = 35,
    ["Alacritty Configuration"] = 1013,
    ["All Contributors configuration file"] = 1067,
    ["Ansible Argument Specs"] = 402,
    ["Ansible Collection Galaxy"] = 409,
    ["Ansible Execution Environment"] = 399,
    ["Ansible Inventory"] = 408,
    ["Ansible Meta"] = 400,
    ["Ansible Meta Runtime"] = 401,
    ["Ansible Navigator Configuration"] = 411,
    ["Ansible Playbook"] = 406,
    ["Ansible Requirements"] = 403,
    ["Ansible Rulebook"] = 407,
    ["Ansible Tasks File"] = 405,
    ["Ansible Vars File"] = 404,
    ["Ansible-lint Configuration"] = 410,
    Any = 1132,
    ...
    ["Application list for a WinUtil"] = 1149,
    ArchitectFX = 1154,
    ["Argo CD"] = 54,
    ["Argo Events"] = 55,
    ["Argo Workflows"] = 56,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1218,
    ["Azure IoT Operations connector metadata"] = 1215,
    ...
    ["Azure Pipelines"] = 113,
    ["Azure Static Web Apps CLI configuration file"] = 822,
    ["Azure Static Web Apps configuration file"] = 821,
    BMML = 1237,
    ["BOSH CPI Config"] = 139,
    ...
    ["Bacon config"] = 5,
    ["Barba-CV"] = 83,
    ["Bashly (bashly.yml)"] = 1071,
    ["Bashly Settings (bashly-settings.yml)"] = 1072,
    Bento = 1236,
    ["Better Code Hub"] = 983,
    ["Better Scripts"] = 160,
    Bigconfig = 132,
    ["Biome Formatter Config"] = 84,
    ["Bitmovin Encoding Template"] = 1163,
    BizTalkServerApplicationSchema = 950,
    Bleep = 161,
    ["Block Protocol Metadata"] = 158,
    ["Bluebricks blueprint config"] = 1242,
    ["Boyka Framework"] = 141,
    Briefcase = 956,
    ["Build Info"] = 149,
    Buildkite = 151,
    ["Bukkit plugin.yml"] = 150,
    ["BungeeCord plugin.yml"] = 156,
    ["Butane Config"] = 1026,
    C4InterFlow = 1178,
    ["CDK Environment Manager, concrete environment configuration"] = 1202,
    ["CDK Environment Manager, concrete environments definition"] = 1201,
    ["CDK Environment Manager, environment definition"] = 1200,
    ["CGS Card Game Specification (cgs.json)"] = 1109,
    ["CICS TS region tagging"] = 1035,
    ["CICS TS resource import"] = 1036,
    ["CICS TS resource model"] = 1037,
    ["CICS TS resource overrides"] = 1038,
    ["CMake Presets"] = 162,
    ["CNC Codes"] = 184,
    ["CRS WAF test file"] = 1139,
    ["CRS WAF test platform overrides file"] = 1140,
    ["CSS Comb (.csscomb.json)"] = 291,
    ["CSS Lint (.csslintrc)"] = 292,
    ["CSpell (cspell.json)"] = 290,
    ["CVE Record Format"] = 194,
    CWL = 1115,
    ["Cache Warmup config"] = 163,
    ["Calqulus pipeline"] = 164,
    ["Camel YAML DSL"] = 165,
    ["Cannon TOML"] = 166,
    Carafe = 167,
    ["Cargo Make"] = 169,
    ["Cargo Manifest"] = 168,
    ["Catalog Info Backstage"] = 170,
    ["Chamaleon environment"] = 1167,
    ["Chamaleon properties"] = 1168,
    ["Chamaleon template"] = 1166,
    Changepacks = 1229,
    Changesets = 275,
    Changie = 171,
    Charmcraft = 172,
    Cheatsheets = 1023,
    ["ChordPro Configuration"] = 173,
    ["Chrome Extension"] = 256,
    ["Chromia Model"] = 174,
    ["Chromia Seeder Module Config"] = 176,
    ["Chromia Seeder Root Config"] = 175,
    ["Cinnamon Spice info.json"] = 93,
    ["CircleCI config.yml"] = 231,
    ["Citation File Format"] = 277,
    ["Citrus test case"] = 178,
    CityJSON = 179,
    ["Claude Code Keybindings"] = 191,
    ["Claude Code Settings"] = 192,
    ["Clawject config"] = 190,
    ["Cloud Foundry Application Manifest"] = 1121,
    ["Cloud Run Spec v1"] = 1144,
    ...
    ["CloudEvents specification"] = 180,
    ["Code Climate"] = 232,
    CodeCV = 97,
    CodeRabbit = 96,
    ["CodeShip Pro services configuration files"] = 245,
    ["CodeShip Pro steps configuration files"] = 246,
    ["Codecov configuration files"] = 244,
    Codex = 240,
    CodifyCLI = 98,
    Codux = 242,
    ["Cog config file"] = 185,
    ["Commandbox Box.json"] = 186,
    ["Commandbox Server.json"] = 187,
    ["Common Catalog Data"] = 254,
    ["Common Package Specification"] = 188,
    Concord = 1138,
    ["Configu .cfgu files"] = 1126,
    ["Configu .configu file"] = 1127,
    Conjure = 183,
    ["Container Structure Test"] = 964,
    Containerlab = 992,
    ["Contextive Glossary"] = 1194,
    Convex = 182,
    ["Crowdsec collection config"] = 285,
    ["Crowdsec parser config"] = 286,
    ["Crowdsec scenario config"] = 287,
    ["CumulusCI Config"] = 189,
    ["Cursor Agent Environment"] = 1247,
    ["Custom Machinery Machine"] = 1110,
    ["Custom Machinery Recipe"] = 1111,
    ["Cycle Stack File"] = 195,
    CycloneDX = 196,
    ["DWP Exchange - catalogue entry"] = 336,
    ["DWP Exchange - gateway"] = 334,
    ["DWP Exchange - meta"] = 335,
    ["Dart Build Config (dart-build.json)"] = 293,
    ["Dart Test Config (dart-test.json)"] = 294,
    ["DashLord Configuration"] = 295,
    ["Data Contract Specification"] = 296,
    ["Data Product Specification"] = 297,
    ["DataYoga Connections"] = 197,
    ["DataYoga Job"] = 198,
    ["Databricks Asset Bundles"] = 1088,
    ["Datadog Continuous Testing"] = 500,
    ["Datadog Service Definition"] = 501,
    ["Datadog Software Catalog"] = 502,
    ["Datahub Ingestion Recipe"] = 1042,
    ["Debian Upstream Metadata file"] = 205,
    ["Deck config"] = 206,
    ["DeepMatch deeplinks spec"] = 207,
    ["Dein Config"] = 208,
    ["Deno Config (deno.json)"] = 303,
    ["Dependency cruiser"] = 209,
    ["DeployStack Configuration"] = 210,
    ["Deployah Configuration"] = 1217,
    ["Deployer Recipe"] = 306,
    ["Deta Spacefile"] = 211,
    ["Detekt Config (detekt.yml)"] = 307,
    ["Devbox Config"] = 212,
    ["Devbox Plugin"] = 213,
    Devfile = 333,
    Devup = 1230,
    DipDup = 1141,
    ["Discord Webhook"] = 308,
    ["DocFx Config (docfx.json)"] = 313,
    ["Docker Desktop extension metadata"] = 310,
    ["Docs MCP Manifest"] = 314,
    Dofigen = 315,
    ["Dolittle Artifacts"] = 316,
    ["Dolittle Bounded Context Configuration"] = 317,
    ["Dolittle Event Horizons Configuration"] = 318,
    ["Dolittle Resources Configuration"] = 319,
    ["Dolittle Server Configuration"] = 320,
    ["Dolittle Tenant Map Configuration"] = 322,
    ["Dolittle Tenants Configuration"] = 321,
    ["Dolittle Topology"] = 323,
    ["DonateCaseBetterCasino menu"] = 1171,
    ["Drupal Breakpoints"] = 214,
    ["Drupal Config"] = 226,
    ["Drupal Info"] = 215,
    ["Drupal Layouts"] = 216,
    ["Drupal Libraries"] = 217,
    ["Drupal Links Action"] = 218,
    ["Drupal Links Contextual"] = 219,
    ["Drupal Links Menu"] = 220,
    ["Drupal Links Task"] = 221,
    ["Drupal Migration"] = 222,
    ["Drupal Permissions"] = 223,
    ["Drupal Recipe"] = 224,
    ["Drupal Routing"] = 225,
    ["Drupal Services"] = 227,
    ["Drush site aliases"] = 329,
    ["Dynamic Bash Aliases (.aliases)"] = 1079,
    ["EAS config"] = 354,
    ["ECA - Editor Code Assistant"] = 338,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1068,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1214,
    ["EasyVCR .NET"] = 355,
    ["Eidolon Resource"] = 1155,
    ["Elgato Stream Deck"] = 340,
    Elm = 1143,
    ["Embrace Config"] = 1054,
    Endurica = 1092,
    ["Enterprise Contract Policy Spec"] = 341,
    ["Erda Pipeline"] = 1117,
    ["Erda Runtime"] = 1118,
    ["Espanso config.yml"] = 1240,
    ["Espanso match.yml"] = 1239,
    Esquio = 343,
    ["Estuary Flow Catalog"] = 1032,
    ["Ethereum ERC1155"] = 1251,
    ["Ethereum ERC721"] = 1250,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 347,
    ["EveryVoice TTS Toolkit Data Configuration"] = 348,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 352,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 351,
    ["EveryVoice TTS Toolkit Text Configuration"] = 349,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 350,
    ["Evolving Resolutive Process notation"] = 1216,
    ["Expo SDK"] = 353,
    ["F-Droid Data metadata"] = 359,
    ["FasterCI Configuration"] = 114,
    ["Fence configuration"] = 115,
    FiQuS = 363,
    Firebase = 361,
    ["Flatpak Builder Manifest"] = 364,
    ["FlexGet Config"] = 365,
    ["Flow.json Configurations"] = 1114,
    ["Fossa configuration file"] = 372,
    ["Fossa's fossa-deps file"] = 373,
    ["Foundry VTT - Base package Manifest"] = 367,
    ["Foundry VTT - Module Manifest"] = 368,
    ["Foundry VTT - System Data Template"] = 371,
    ["Foundry VTT - System Manifest"] = 369,
    ["Foundry VTT - World Manifest"] = 370,
    ["Foxx Manifest"] = 116,
    ["Freifunk.de Community API"] = 119,
    ["Frogbot Config"] = 120,
    ["G2P Mapping Configuration"] = 379,
    ["GCP Blueprint Metadata"] = 382,
    Gaspar = 380,
    ["GatewayCore API Gateway"] = 381,
    ["Gemini CLI settings"] = 383,
    ["GeoJSON.json latest"] = 1030,
    GherKing = 1034,
    ["GitHub Action"] = 388,
    ["GitHub Actions typing"] = 1151,
    ["GitHub Discussion"] = 389,
    ["GitHub Funding"] = 390,
    ["GitHub Issue Template configuration"] = 391,
    ["GitHub Issue Template forms"] = 392,
    ["GitHub Workflow"] = 393,
    ["GitHub Workflow Template Properties"] = 394,
    ["GitHub automatically generated release notes configuration"] = 395,
    ["GitLab Agent for Kubernetes configuration"] = 1106,
    GitVersion = 385,
    ["Gitea Issue Template configuration"] = 386,
    ["Gitea Issue Template forms"] = 387,
    ["Gitpod Automations"] = 397,
    ["Gitpod Configuration"] = 398,
    ["GlazeWM settings"] = 1108,
    ["Global Privacy Control"] = 384,
    Goblet = 1087,
    ["Golangci-lint Configuration"] = 413,
    ["Golangci-lint Custom Plugins Configuration"] = 414,
    ["Google Chrome Related Website Sets"] = 362,
    ["Google Cloud Workflows"] = 262,
    ["Google Digital Assetlinks"] = 1195,
    Goreleaser = 416,
    ["Goreleaser Pro"] = 417,
    Goss = 418,
    ["Gradle Build Cache Node"] = 981,
    ["Gradle Enterprise"] = 980,
    ["Grafana 5.x Dashboard"] = 419,
    ["GraphQL Code Generator"] = 424,
    ["GraphQL Config"] = 423,
    ["GraphQL Mesh"] = 422,
    ["GroovyLint configuration"] = 425,
    ["Grunt JSHint task"] = 429,
    ["Grunt Watch task"] = 430,
    ["Grunt base task"] = 431,
    ["Grunt clean task"] = 427,
    ["Grunt copy task"] = 426,
    ["Grunt cssmin task"] = 428,
    HEMTT = 946,
    Hadolint = 960,
    Hammerkit = 991,
    ["Hardware Sentry Configuration"] = 1046,
    ["Hashgraph Online Skill Manifest"] = 1,
    ["HashiCorp Vault"] = 432,
    Hatch = 961,
    Hayson = 434,
    ["Haystack Pipeline"] = 435,
    ["Hazelcast 5 Configuration"] = 436,
    ["Hecate Input Schema"] = 1206,
    ["Helm Chart.lock"] = 229,
    ["Helm Chart.yaml"] = 228,
    ["Helm Unittest Test Suite"] = 230,
    ["Home Assistant Integration Manifest"] = 437,
    ["Homer dashboard configuration"] = 438,
    Hugo = 1022,
    ["Hugo Theme"] = 1021,
    ["Hulak Configuration"] = 445,
    ["Hyperfoil benchmark configuration"] = 444,
    ["IBM Zapp document"] = 446,
    ["IBM zCodeFormatSettings"] = 447,
    ["IMG Catapult PSP"] = 452,
    ["IVMS101 by CODE Protocol"] = 1107,
    Infrahub = 454,
    Istanbul = 1050,
    ["JDownloader2 crawler multi-rules"] = 467,
    ["JDownloader2 crawler single-rules"] = 466,
    ["JFrog Applications Config"] = 468,
    ["JFrog File Spec"] = 469,
    ["JFrog Pipelines YML DSL"] = 1056,
    ["JMeter DSL cli config"] = 470,
    JReleaser = 473,
    ["JSON Document Transform"] = 481,
    ["JSON Feed"] = 482,
    ["JSON Resume"] = 732,
    ["JSON Schema Draft 2020-12"] = 928,
    ["JSON Schema Draft 4"] = 925,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1089,
    ["JSON Schema Draft 7"] = 926,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1090,
    ["JSON Schema Draft 8 (2019-09)"] = 927,
    ["JSON-API"] = 480,
    ["JSON-e templates"] = 988,
    ["JSON-stat 2.0"] = 921,
    JSONPatch = 484,
    ["JSR Package Config (jsr.json)"] = 474,
    Jarl = 1222,
    Jasmine = 461,
    Jekyll = 462,
    ["Jenkins X Pipelines"] = 463,
    ["Jenkins X Requirements"] = 464,
    Jest = 465,
    Jocker = 471,
    ["Jovo Language Models"] = 472,
    ["Jujutsu (jj) VCS config"] = 1208,
    ["KIMMDY config file"] = 495,
    ["KODE/CI build.yaml"] = 1052,
    ["KSP-AVC"] = 922,
    ["KSP-CKAN"] = 923,
    ["KSP-NetKAN"] = 924,
    KSY = 1119,
    KSail = 377,
    ["KYA Manifest"] = 1120,
    ["Karakum configuration file"] = 374,
    Kas = 487,
    ["Kestra flow file"] = 496,
    ["Keycloak REST API"] = 1059,
    ["Knative Functions - func.yaml"] = 375,
    Knip = 376,
    ["Knowledge Unit"] = 504,
    ["Kometa (nightly) config file"] = 498,
    ["Kometa config file"] = 497,
    ["Kong DBLess config"] = 1053,
    KrakenD = 499,
    ["Kubri Configuration"] = 507,
    LOOBin = 522,
    ["Lake configuration file"] = 1211,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 267,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 268,
    ["Landing Zone Accelerator on AWS - Global Config"] = 269,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 270,
    ["Landing Zone Accelerator on AWS - Network Config"] = 271,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 272,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 273,
    ["Landing Zone Accelerator on AWS - Security Config"] = 274,
    ["Lando (landofile)"] = 109,
    ["LangGraph Platform configuration"] = 1131,
    ["Language configuration"] = 1130,
    Lefthook = 511,
    ["Liferay client-extension.yaml"] = 518,
    ["LinkML Metamodel"] = 520,
    Liquibase = 997,
    ["Liquibase Flow File"] = 998,
    ["Lively Properties"] = 521,
    ["Lobe AI Agent"] = 111,
    Loki = 112,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 564,
    ["MS2Rescore Configuration"] = 568,
    ["Madness (madness.yml)"] = 1070,
    ["Mado configuration"] = 528,
    ["Maestro Flow"] = 529,
    ["Mail Servers Configuration"] = 1243,
    ["MapEHR Mapping"] = 530,
    Markdownlint = 1001,
    ["Mason Registry"] = 1004,
    ["MegaLinter Custom Flavor"] = 533,
    ["MegaLinter configuration"] = 532,
    ["MegaLinter descriptor"] = 534,
    Melange = 1097,
    ["Meltano project definition"] = 535,
    ["Mergify Configuration"] = 569,
    ["Metadata for a Bazel module"] = 536,
    ["Metadata for a Cinnamon spice"] = 1147,
    ["Metatype Configuration"] = 537,
    ["MetricsHub Configuration"] = 538,
    ["MetricsHub Connector Configuration"] = 539,
    ["Micro Editor Syntax"] = 1080,
    ["Microsoft Band Web Tile"] = 540,
    ["Microsoft RulesEngine workflow rules"] = 1135,
    ["Microsoft RulesEngine workflow rules list"] = 1136,
    ["Minecraft Custom Main Menu Mod"] = 1098,
    ["Minecraft Data Pack Advancement"] = 542,
    ["Minecraft Data Pack Biome"] = 543,
    ["Minecraft Data Pack Configured Carver"] = 544,
    ["Minecraft Data Pack Damage Type"] = 545,
    ["Minecraft Data Pack Dimension"] = 547,
    ["Minecraft Data Pack Dimension Type"] = 546,
    ["Minecraft Data Pack Item Modifier"] = 548,
    ["Minecraft Data Pack Loot Table"] = 549,
    ["Minecraft Data Pack Metadata"] = 550,
    ["Minecraft Data Pack Predicate"] = 551,
    ["Minecraft Data Pack Recipe"] = 552,
    ["Minecraft Data Pack Tag"] = 553,
    ["Minecraft Data Pack Template Pool"] = 554,
    ["Minecraft Data Pack Trim Material"] = 559,
    ["Minecraft Data Pack Trim Pattern"] = 560,
    ["Minecraft Resource Pack Lang"] = 555,
    ["Minecraft Resource Pack Particle"] = 556,
    ["Minecraft Resource Pack Texture Mcmeta"] = 558,
    ["Minecraft Resourcepack Sounds"] = 557,
    ModuleAssembler = 562,
    ["Monade CLI Stack Configuration"] = 572,
    ["MongoDB Atlas Search Index Definition"] = 1051,
    ["Monika Configuration"] = 1049,
    ["Monoweave Configuration"] = 567,
    ["Motif config"] = 942,
    MultiQC = 1188,
    ["NOX Framework (Service)"] = 588,
    ["Netin Diagnostic System Template"] = 1008,
    ["Netlify config"] = 575,
    ["Network-as-Code Data Model"] = 576,
    ["Next Gen UI Agent A2A Server Configuration"] = 577,
    ["Next Gen UI Agent Configuration"] = 579,
    ["Next Gen UI Agent MCP Server Configuration"] = 578,
    ["Nightwatch.js"] = 581,
    ["Node.js configuration"] = 947,
    ["NueJS configuration file"] = 593,
    ["Nuitka.yaml"] = 1112,
    ["Nullstone config"] = 595,
    ["ONe's changelog entry"] = 614,
    ["ONe's service descriptor"] = 613,
    ["ORT Server repository environment configuration"] = 624,
    ["OSCAL Assessment Plan (AP)"] = 626,
    ["OSCAL Assessment Results (AR)"] = 627,
    ["OSCAL Catalog"] = 628,
    ["OSCAL Component Definition (CDef)"] = 629,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 630,
    ["OSCAL Profile"] = 631,
    ["OSCAL System Security Plan (SSP)"] = 632,
    ["OSS Review Toolkit configuration"] = 633,
    ["OSS Review Toolkit curation"] = 634,
    ["OSS Review Toolkit package configuration"] = 635,
    ["OSS Review Toolkit repository configuration"] = 636,
    ["OSS Review Toolkit resolutions"] = 637,
    ["October CMS columns"] = 599,
    ["October CMS fields"] = 600,
    ["Oh My Posh"] = 602,
    Okteto = 603,
    ["Ona Automations"] = 605,
    Opctl = 945,
    ["Open Data Contract Standard (ODCS)"] = 618,
    ["Open Data Product Standard (ODPS)"] = 619,
    ["Open Know-How"] = 1193,
    ["OpenRewrite Resource"] = 616,
    OpenSRM = 620,
    OpenStatus = 1204,
    ["OpenTelemetry Declarative Configuration"] = 617,
    ["OpenUtau character yaml"] = 610,
    ["OpenUtau ustx"] = 611,
    ["OpenWeather Current Weather API"] = 987,
    ["OpenWeather Road Risk API"] = 986,
    ["Ory Hydra configuration"] = 443,
    ["Ory Keto configuration"] = 503,
    ["Ory Kratos configuration"] = 625,
    ["Ory Oathkeeper configuration"] = 597,
    ["Outblocks App configuration"] = 622,
    ["Outblocks database table"] = 623,
    ["Outblocks project configuration"] = 621,
    PDM = 644,
    POPxf = 655,
    ["POPxf Correlations"] = 656,
    Packer = 641,
    PactSpec = 642,
    Pantsbuild = 1066,
    ["Paper paper-plugin.yml"] = 643,
    ["Pipeline component"] = 999,
    ["Platform.sh application"] = 7,
    ["Platform.sh routes"] = 8,
    ["Platform.sh services"] = 9,
    ["Plex Prerolls"] = 653,
    ["PocketMine plugin.yml"] = 650,
    ["Postman collection"] = 659,
    ["Power Pages Configuration"] = 1205,
    ["Preset list for a WinUtil"] = 1150,
    ["ProActions AI-Kit Configuration"] = 670,
    ["ProActions AI-Kit Configuration for Menus"] = 672,
    ["ProActions AI-Kit Configuration for Sections"] = 674,
    ["ProActions AI-Kit Configuration for Services"] = 671,
    ["ProActions AI-Kit Configuration for Steps"] = 675,
    ["ProActions AI-Kit Configuration for Templates"] = 673,
    ["Problem object RFC9457"] = 1095,
    ["Problem package format"] = 676,
    ["Problem package generators"] = 677,
    ["Problem package submissions"] = 678,
    ["Problem package test group metadata"] = 679,
    Pterodactyl = 1045,
    ["Pull Request Labeler"] = 696,
    Pulumi = 704,
    ["PyGTA Config"] = 700,
    PyProject = 705,
    Pylock = 1196,
    Pyright = 706,
    ["Python script metadata"] = 1190,
    ["QType AI DSL"] = 709,
    Qgoda = 708,
    Qodana = 1018,
    ["Qt Creator workspace file"] = 1128,
    ["Quali Torque Blueprint Spec 2"] = 1043,
    ["QueryFirst config file"] = 1062,
    ["Qwen Code Settings"] = 1252,
    ["RKE Cluster Configuration JSON"] = 996,
    ["RKE Cluster Configuration YAML"] = 995,
    RadioHound = 699,
    ["Raid Profile"] = 1253,
    ["Raid Repo Configuration"] = 1254,
    Railpack = 711,
    Railway = 710,
    ["Rancher Fleet"] = 701,
    ["Rattler-build"] = 712,
    Ray = 959,
    ["Read the Docs"] = 703,
    ["Red-DiscordBot Cog"] = 719,
    ["Red-DiscordBot Cog Repo"] = 720,
    ["Red-DiscordBot Trivia"] = 721,
    ["Releasaurus Config"] = 4,
    ReleaseKit = 3,
    ["Render Blueprints"] = 994,
    RenderCV = 736,
    Renovate = 733,
    ["Renovate global configuration"] = 734,
    ["Renovate inherited configuration"] = 735,
    ["Replit config"] = 727,
    Restate = 1183,
    ["Revel Digital Gadget Definition File"] = 1207,
    RoadRunner = 738,
    ["Robust Station Image"] = 1213,
    Rockcraft = 739,
    ["Roo Coder Custom Modes"] = 740,
    Rubocop = 729,
    ["Rudder techniques"] = 1102,
    Ruff = 730,
    ["Rust Project"] = 731,
    ["Rust toolchain"] = 744,
    ["SDMX data message"] = 771,
    ["SDMX metadata message"] = 770,
    ["SDMX structure message"] = 769,
    ["SIL Kit Participant Configuration"] = 781,
    ["SIL Kit Registry Configuration"] = 782,
    ["SPDX 2.3"] = 819,
    SWADL = 835,
    ["Safebox Config"] = 1057,
    ["Sapphire CLI Config"] = 747,
    ["SauceCTL Configuration"] = 1005,
    Scarb = 767,
    ["Schema Catalog"] = 762,
    ["Scoop manifest"] = 768,
    ["Semantic Data Fabric (SDF) file"] = 772,
    ["Semgrep Rule"] = 774,
    ["Serenity Code Generator (Sergen)"] = 775,
    ["Serverless Framework Configuration"] = 1012,
    ["Serverless Workflow"] = 1014,
    ["Settings for a Cinnamon spice"] = 1146,
    ["Settings.paf"] = 777,
    ["Shopware 6 Configuration"] = 1015,
    ["Shopware CLI Extension Store Configuration"] = 1016,
    ["Shopware CLI Project Store Configuration"] = 1017,
    ["Sigma Detection Rule"] = 779,
    ["Sigrid scope configuration file"] = 780,
    ["SkyPilot Task JSON"] = 1103,
    ["Slack app manifest"] = 784,
    Snapcraft = 786,
    Solidarity = 789,
    ["Solution filters"] = 790,
    ["Source Maps v3"] = 791,
    Sourcery = 792,
    ["Spack bootstrap.yaml"] = 793,
    ["Spack cdash.yaml"] = 794,
    ["Spack ci.yaml"] = 795,
    ["Spack compilers.yaml"] = 796,
    ["Spack concretizer.yaml"] = 797,
    ["Spack config.yaml"] = 798,
    ["Spack definitions.yaml"] = 799,
    ["Spack develop.yaml"] = 800,
    ["Spack env_vars.yaml"] = 801,
    ["Spack environment"] = 807,
    ["Spack include.yaml"] = 802,
    ["Spack mirrors.yaml"] = 803,
    ["Spack modules.yaml"] = 804,
    ["Spack packages.yaml"] = 805,
    ["Spack repos.yaml"] = 806,
    ["Spack toolchains.yaml"] = 808,
    ["Spack upstreams.yaml"] = 809,
    ["Spack view.yaml"] = 810,
    ["Speakeasy Generation Config File"] = 814,
    ["Speakeasy Lint Configuration File"] = 811,
    ["Speakeasy Test Generation Configuration File"] = 812,
    ["Speakeasy Workflow File"] = 813,
    SpecIF = 815,
    ["Specmatic Configuration"] = 816,
    ["Sponge Mixin configuration"] = 817,
    StackBlitz = 823,
    ["StackHawk Scanner Configuration"] = 1011,
    Stale = 824,
    Starfish = 825,
    ["Starlake Data Pipeline"] = 984,
    Starship = 826,
    ["Statamic Blueprint"] = 827,
    ["Stella configuration file"] = 828,
    ["Streamlit configuration file"] = 829,
    ["Stryker Mutator"] = 832,
    ["StyleCop Analyzers Configuration"] = 833,
    ["Stylelint (.stylelintrc)"] = 834,
    ["Stylua Config"] = 1197,
    ["Sublime Syntax"] = 1058,
    ["Subsquid squid manifest"] = 1105,
    ["Swagger API 2.0"] = 836,
    ["Synadia Connect Component"] = 837,
    TSON = 873,
    TSTyche = 874,
    ["TYPO3 Vendor Bundler config"] = 880,
    ["Tab data for a LinUtil"] = 1153,
    ["Tab list for a LinUtil"] = 1152,
    Tach = 838,
    ["Tach Domain"] = 839,
    Talhelper = 841,
    ["Talisman configuration"] = 842,
    Taplo = 1198,
    ["Taskfile config"] = 989,
    Taurus = 843,
    Tauticord = 844,
    ["Tekton Pipeline"] = 1226,
    ["Tekton PipelineRun"] = 1227,
    ["Tekton Task"] = 1224,
    ["Tekton TaskRun"] = 1225,
    Telefonistka = 1184,
    ["Terrateam config"] = 1210,
    ["TestEnvironment.json"] = 856,
    ["TextMate Grammar"] = 855,
    Threagile = 850,
    ["Tier.run pricing.json"] = 847,
    Tikibase = 848,
    Tombi = 853,
    ["Traefik v2"] = 859,
    ["Traefik v2 File Provider"] = 860,
    ["Traefik v3"] = 861,
    ["Traefik v3 File Provider"] = 862,
    ["Travis CI (.travis.yml)"] = 858,
    Treefmt = 421,
    Trident = 1180,
    ["TrueScript for *.tscript files"] = 865,
    ["Tugboat QA config.yml"] = 1177,
    TunnelHub = 1093,
    Turborepo = 857,
    Tycho = 1142,
    Tye = 1019,
    ["Tyk Gateway - Open Source v5.7+"] = 1189,
    ["UET BuildConfig.json"] = 1063,
    ["UI5 Manifest"] = 886,
    ["UNCORS configuration"] = 890,
    ["UTAM Page Object"] = 889,
    ["Ubuntu Server Autoinstall"] = 884,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1181,
    ["Uniswap Token List"] = 971,
    ["Universal Schedule Format"] = 891,
    ["Unreal Engine Uplugin"] = 1064,
    ["Unreal Engine Uproject"] = 1065,
    ["UpCloud CLI (upctl) configuration"] = 1182,
    ["Updatecli Compose"] = 1027,
    ["Updatecli Policy Manifest"] = 1028,
    ["Updatecli Policy Metadata"] = 1029,
    Uplift = 1061,
    ["Upsun config"] = 6,
    ["User Journey Map"] = 993,
    V2Ray = 1033,
    ["VSCode Code Snippets"] = 250,
    ["VSIX CLI publishing"] = 909,
    Vector = 893,
    ["Vela Pipeline Configuration"] = 896,
    Vercel = 249,
    ["Version Bumper config"] = 899,
    Vespertide = 1231,
    ["Vespertide Migration"] = 1232,
    ["Vespertide Model"] = 1233,
    ["Viash Component Config"] = 1186,
    ["Viash Package Config"] = 1187,
    Visivo = 1091,
    ["WP-CLI"] = 919,
    Wake = 1179,
    ["Waku Config"] = 1156,
    ["Web App Manifest"] = 915,
    ["Web types"] = 918,
    WebExtensions = 914,
    ["Webman package recipe"] = 1039,
    ["Windows Package Manager Installer Manifest"] = 967,
    ["Windows Package Manager Locale Manifest"] = 968,
    ["Windows Package Manager Singleton Manifest"] = 966,
    Winutil = 969,
    ["WireMock CLI import configuration"] = 1162,
    ["WireMock CLI local service configuration"] = 1161,
    ["WireMock message stub mapping"] = 1160,
    ["WireMock stub mapping"] = 1159,
    ["Woodpecker pipeline config"] = 1007,
    ["Wrangler CLI"] = 920,
    ["Xstate Machine"] = 1025,
    ["Yandex Workflow Language"] = 1148,
    ["Yarn Config (.yarnrc.yml)"] = 982,
    ["Yippee-Ki-JSON configuration YML"] = 973,
    ["YouTrack App"] = 1145,
    ["Zarf Package Configuration"] = 1212,
    ["Zerops.io config"] = 1133,
    ["Zerops.io import"] = 1134,
    ["Zola Configuration"] = 1223,
    ["aerleon.yml"] = 19,
    ["amplify.yml"] = 12,
    ["angular.json"] = 36,
    apko = 1096,
    ...
    ["behat.yml"] = 142,
    ["bigquery-table"] = 131,
    ["bioimageio resource description"] = 1113,
    ...
    ["bozr.suite.json"] = 144,
    bpkg = 1074,
    ["browser.i18n.json"] = 145,
    ["browsh configuration"] = 146,
    bucklescript = 147,
    ["buf.gen.yaml"] = 87,
    ["buf.lock"] = 88,
    ["buf.plugin.yaml"] = 89,
    ...
    ["build-changelog"] = 148,
    ["bun.lock"] = 153,
    ["bundleconfig.json"] = 154,
    ["bunfig.toml"] = 155,
    ["cargo-mutants-config.yaml"] = 92,
    ["ccmod.json"] = 1157,
    changelogging = 1125,
    ["chisel-slices.json"] = 276,
    ["chrome-extension-locales-messages.json"] = 257,
    ["chutzpah.json"] = 258,
    cibuildwheel = 177,
    ["clang-format (.clang-format)"] = 1031,
    ["clang-tidy"] = 236,
    clangd = 235,
    clib = 237,
    ["cloud-init: cloud-config userdata"] = 239,
    ["cloud-sdk-pipeline-configuration"] = 260,
    ["cloudbuild.json"] = 261,
    cloudify = 238,
    cmakefmt = 193,
    ["cmdx.yaml"] = 95,
    ...
    ["coffeelint.json"] = 278,
    ["commands.json"] = 253,
    ["commitlint (.commitlintrc)"] = 970,
    ["committed.toml"] = 279,
    ["compile_commands.json"] = 252,
    ["compilerconfig.json"] = 251,
    ["completely.yml"] = 1069,
    ["component-detection-manifest.json"] = 282,
    ["component.json"] = 281,
    ["composer.json"] = 280,
    ["conda-forge"] = 181,
    ["config.yaml"] = 702,
    ["contentmanifest.json"] = 259,
    ["contribute.json"] = 283,
    ["cosmos.config.json"] = 255,
    ["crowdin.yml"] = 284,
    ["ctfd-setup configuration file"] = 1169,
    ["custom-elements.json"] = 1083,
    ["cypress.json"] = 288,
    ["datalogic-scan2deploy-android"] = 298,
    ["datalogic-scan2deploy-ce"] = 299,
    ["dbt Dependencies"] = 200,
    ["dbt Packages"] = 202,
    ["dbt Project"] = 201,
    ["dbt Selectors"] = 203,
    ["dbt YAML files"] = 204,
    ...
    ["ddev-global"] = 300,
    ["ddev-project"] = 301,
    ["debugsettings.json"] = 302,
    ["dependabot-v2.json"] = 305,
    ["dependabot.json"] = 304,
    ["deployed-cli"] = 1024,
    ["devcontainer.json"] = 243,
    devinit = 975,
    ["devspace.yaml"] = 1047,
    djlint = 976,
    ["docker bake"] = 311,
    ["docker sequencer"] = 312,
    ["docker-compose.yml"] = 974,
    ["dockerd.json"] = 309,
    ["dotnet Release Index manifest"] = 324,
    ["dotnet-tools.json"] = 325,
    ["dotnetcli.host.json"] = 326,
    ["dprint.json"] = 327,
    ["drone.json"] = 328,
    ["dss-2.0.0.json"] = 330,
    ["dstack configuration"] = 331,
    ["dtool dataset metadata"] = 1164,
    ["dvc.yaml"] = 332,
    ["ecosystem.json"] = 337,
    eksctl = 339,
    ["electron-builder configuration file"] = 345,
    ["epr-manifest.json"] = 344,
    ["evcc.yaml"] = 346,
    ["ezd task runner"] = 356,
    ["fabric.mod.json"] = 358,
    ["first-timers-bot"] = 366,
    ["flagd flag configuration"] = 117,
    ["fly.io Configuration"] = 118,
    fulibWorkflows = 1006,
    ["function.json"] = 378,
    ["gRPC API Gateway & OpenAPI Config"] = 14,
    ["gematik health care insurance list"] = 1175,
    ["gematik health care patient list"] = 1172,
    ["gematik health care provider institution list"] = 1174,
    ["gematik health care provider list"] = 1173,
    ["gematik tiger test environment configuration"] = 1176,
    ["git-town.toml"] = 1221,
    ["gitlab-ci"] = 396,
    ["global.json"] = 412,
    ["go-feature-flag Flag Configuration"] = 415,
    ["haxelib.json"] = 433,
    helmfile = 962,
    helmwave = 963,
    ["host-meta.json"] = 440,
    ...
    ["ide.host.json"] = 448,
    ["ifstate.yaml"] = 449,
    ["imageoptimizer.json"] = 450,
    ["importmap.json"] = 453,
    instant_python_config = 455,
    instant_python_custom_project = 456,
    ["ioBroker Configuration"] = 457,
    ["ioBroker JSON UI"] = 458,
    ["ioBroker Package manifest"] = 459,
    ["ixpect.conf.yaml"] = 460,
    ["ize.toml"] = 1060,
    ["jsconfig.json"] = 485,
    ["jscpd Configuration"] = 1044,
    jsdoc = 958,
    ["k3d.yaml"] = 486,
    ["k9s aliases.yaml"] = 488,
    ["k9s cluster-config.yaml"] = 490,
    ["k9s config.yaml"] = 489,
    ["k9s hotkeys.yaml"] = 491,
    ["k9s plugins.yaml"] = 492,
    ["k9s skin.yaml"] = 493,
    ["k9s views.yaml"] = 494,
    ["kontinuous-config.yaml"] = 506,
    ["kontinuous-values.yaml"] = 505,
    ["kustomization.yaml"] = 508,
    ["label-commenter-config.yml"] = 509,
    ["latexindent configuration"] = 110,
    ["launchsettings.json"] = 510,
    lazydocker = 1082,
    lazygit = 1081,
    ["lego.json"] = 512,
    ["lerna.json"] = 513,
    ["lgtm.yml"] = 514,
    ["liblab.config.json"] = 515,
    ["libman.json"] = 516,
    ["license-report-config.json"] = 517,
    ["linkinator.config.json"] = 519,
    ["lint-staged (.lintstagedrc)"] = 936,
    ["local.settings.json"] = 524,
    ["localazy.json"] = 525,
    ["lotus.yaml"] = 523,
    ["lsdlschema.json"] = 526,
    ["macro.json"] = 1048,
    ["markdown-link-check"] = 1002,
    maturin = 1003,
    mboats = 1010,
    ["micro-settings.json"] = 1075,
    ["mimetypes.json"] = 541,
    ["mirrord config"] = 938,
    mise = 939,
    ["mkdocs.yml"] = 561,
    ...
    ["monospace.yml"] = 566,
    ["moon.yml"] = 1158,
    ["mprocs Configuration file"] = 1129,
    ["mrdocs.yml"] = 563,
    ["mta.yaml"] = 940,
    ["mtad.yaml"] = 941,
    ["mycode.json"] = 573,
    nFPM = 580,
    ["napari plugin manifest"] = 574,
    neoload = 953,
    ["nest-cli"] = 583,
    ["nexus-rpc-gen"] = 1248,
    ["ninjs (News in JSON)"] = 582,
    ["nitro.json"] = 952,
    ["nixd configuration"] = 1101,
    ["nlu.json"] = 584,
    ["nodemon.json"] = 586,
    ["noodl config"] = 1009,
    ["notebook.mod.json"] = 587,
    now = 948,
    ["npm-badges"] = 590,
    ["nswag.json"] = 594,
    ntangle = 596,
    ["nuclei-template.yaml"] = 591,
    ["nuget-project.json"] = 592,
    ["ocelot.json"] = 598,
    ogen = 601,
    ["omnisharp.json"] = 604,
    openHAB = 1234,
    ...
    oxlint = 1245,
    ["package.json"] = 638,
    ["package.manifest"] = 640,
    ["package.yaml"] = 639,
    ["partial-black.json"] = 143,
    ["partial-pixi.json"] = 648,
    ["pattern.json"] = 646,
    ["petstore-v1.0"] = 1055,
    pgap_yaml_input_reader = 645,
    pgxgen = 1238,
    pitcms = 1241,
    ["pixi.toml"] = 647,
    ["plagiarize-me.yaml"] = 652,
    ["plagiarize.yaml"] = 651,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1165,
    ["podbard.yaml"] = 654,
    ["portman.json"] = 657,
    ["prefect.toml"] = 665,
    ["prefect.yaml"] = 666,
    ...
    ["prettierrc.json"] = 668,
    ["prisma.yml"] = 669,
    ["project-1.0.0-beta3.json"] = 681,
    ["project-1.0.0-beta4.json"] = 682,
    ["project-1.0.0-beta5.json"] = 683,
    ["project-1.0.0-beta6.json"] = 684,
    ["project-1.0.0-beta8.json"] = 685,
    ["project-1.0.0-rc1.json"] = 686,
    ["project-1.0.0-rc2.json"] = 687,
    ["project.json"] = 680,
    ["project.owasp.yaml"] = 688,
    ["prometheus-alertmanager.json"] = 692,
    ["prometheus.json"] = 689,
    ["prometheus.rules.json"] = 690,
    ["prometheus.rules.test.json"] = 691,
    ["proxies.json"] = 693,
    ["publiccode.yml"] = 694,
    ["pubspec.yaml"] = 695,
    ["pyrseas-0.8.json"] = 698,
    pytest = 707,
    ["quilt.mod.json"] = 1076,
    ["rc3 auth"] = 713,
    ["rc3 collection"] = 714,
    ...
    ["release drafter"] = 954,
    ["release-hub.json"] = 2,
    ["release-please-config.json"] = 723,
    ["release-please-manifest.json"] = 724,
    ["release-plz.toml"] = 725,
    ["renv.lock"] = 737,
    ["rivet.json"] = 1100,
    ["rivet.yaml (legacy)"] = 1099,
    rumdl = 742,
    runny = 741,
    rustfmt = 743,
    sake = 1192,
    samt = 745,
    samtrc = 746,
    ["sarif-1.0.0.json"] = 748,
    ["sarif-2.0.0.json"] = 749,
    ["sarif-2.1.0"] = 759,
    ["sarif-2.1.0-rtm.2"] = 750,
    ["sarif-2.1.0-rtm.3"] = 752,
    ["sarif-2.1.0-rtm.4"] = 754,
    ["sarif-2.1.0-rtm.5"] = 756,
    ["sarif-2.1.0-rtm.6"] = 757,
    ["sarif-external-property-file-2.1.0"] = 760,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 751,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 753,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 755,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 758,
    ["scalingo.json configuration"] = 761,
    ["schema.org - Action"] = 763,
    ["schema.org - ContactPoint"] = 764,
    ["schema.org - Place"] = 765,
    ["schema.org - Thing"] = 766,
    ["secrethub.yml"] = 1078,
    ["semantic-release"] = 773,
    ["servicehub.config.json"] = 931,
    ["servicehub.service.json"] = 930,
    ["settings.job"] = 776,
    ["sfdx-hardis configuration"] = 778,
    ["shard.yml"] = 1116,
    ["size-limit configuration"] = 783,
    ["skaffold.yaml"] = 1000,
    ["skyuxconfig.json"] = 785,
    ["snowflake-config"] = 787,
    ["snowflake-connections"] = 788,
    ["spicepod.yaml"] = 1137,
    ["sqlc configuration"] = 820,
    ["stripe-app-local.json"] = 831,
    ["stripe-app.json"] = 830,
    swcrc = 985,
    ["task.json"] = 840,
    taskcat = 949,
    ["template.json"] = 845,
    ["templatsources.json"] = 846,
    ["text2confl config"] = 1246,
    ["theme.json"] = 849,
    ["tizen_workspace.json"] = 851,
    tldr = 852,
    ["tm_devices configuration file"] = 1203,
    tmuxinator = 934,
    tox = 854,
    ["transcend.yml"] = 863,
    ["tree-sitter grammar.json"] = 420,
    ["trime.yaml"] = 864,
    ["trunk.yaml"] = 866,
    ["ts-force-config.json"] = 871,
    ["tsconfig.json"] = 867,
    ["tsd.json"] = 868,
    ["tsdoc.json"] = 869,
    ["tsdrc.json"] = 870,
    ...
    v8r = 913,
    vcluster = 1123,
    ["vcpkg configuration file"] = 248,
    ["vcpkg manifest file"] = 247,
    ["vega-lite.json"] = 895,
    ["vega.json"] = 894,
    ["venvironment.yaml"] = 897,
    ["venvplus.yaml"] = 898,
    version = 1185,
    ["version.json"] = 900,
    ["vhwdebugger-binding.yaml"] = 902,
    ["vim-addon-info"] = 903,
    ["vs-2017.3.host.json"] = 905,
    ["vs-nesting.json"] = 906,
    ["vsls.json"] = 904,
    ["vss-extension.json"] = 910,
    vtcfg = 1191,
    ["vtesttree.yaml"] = 911,
    ["vtestunit.yaml"] = 912,
    ["warp-keysets.json"] = 1084,
    ["warp-themes.json"] = 1085,
    ["warp-workflows.json"] = 1086,
    ["webhint.io"] = 1040,
    ["webjobpublishsettings.json"] = 917,
    ["webjobs-list.json"] = 916,
    ["well-known-fursona"] = 1124,
    ["xs-app.json"] = 944,
    ["xunit.runner.json"] = 929,
    yamllint = 972,
    zizmor = 1228,
    zuul = 955,
    ["Žinoma"] = 965
