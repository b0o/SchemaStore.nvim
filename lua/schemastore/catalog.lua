...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 135,
    [".cryproj (generic)"] = 459,
    [".cryproj engine-5.2"] = 454,
    [".cryproj engine-5.3"] = 455,
    [".cryproj engine-5.4"] = 456,
    [".cryproj engine-5.5"] = 457,
    [".cryproj engine-dev"] = 458,
    [".csscomb.json"] = 137,
    [".csslintrc"] = 138,
    [".eslintrc"] = 177,
    [".esmrc.json"] = 170,
    ...
    [".vsext"] = 435,
    [".yarnrc.yml"] = 498,
    ["<div>RIOTS' studio configuration"] = 438,
    ["API Builder"] = 495,
    ["AVA Configuration Schema"] = 548,
    ...
    ["Better Code Hub"] = 500,
    ["Better Scripts"] = 71,
    BizTalkServerApplicationSchema = 472,
    ...
    ["Butane config schema"] = 535,
    ["CICS TS region tagging"] = 542,
    ["CICS TS resource import"] = 543,
    ["CICS TS resource model"] = 544,
    ["CICS TS resource overrides"] = 545,
    ["CMake Presets"] = 72,
    ...
    ["Embrace Config Schema"] = 560,
    ["Error pages"] = 173,
    Esquio = 171,
    ["Estuary Flow Catalog Schema"] = 539,
    ["Expo SDK"] = 176,
    ...
    Goreleaser = 203,
    ["Goreleaser Pro"] = 204,
    ["Gradle Build Cache Node"] = 497,
    ["Gradle Enterprise"] = 496,
    ...
    HEMTT = 469,
    Hadolint = 481,
    ["Hardware Sentry Configuration"] = 553,
    Hayson = 216,
    ...
    ["JSON Feed"] = 242,
    ["JSON Resume"] = 351,
    ["JSON Schema Draft 2020-12"] = 450,
    ["JSON Schema Draft 4"] = 447,
    ["JSON Schema Draft 7"] = 448,
    ["JSON Schema Draft 8"] = 449,
    ...
    ["KSP-AVC"] = 445,
    ["KSP-CKAN"] = 446,
    ["KoDE/CI build.yaml"] = 558,
    ["Kong DBLess Schema"] = 559,
    KrakenD = 247,
    ["LinkML Metamodel"] = 258,
    Liquibase = 511,
    ["Liquibase Flow File"] = 512,
    Markdownlint = 515,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 557,
    ["Monika Configuration Schema"] = 555,
    ["Motif config"] = 465,
    ["Netin Diagnostic System Template"] = 520,
    ...
    Opctl = 468,
    ["OpenWeather Current Weather API"] = 504,
    ["OpenWeather Road Risk API"] = 503,
    ...
    Packer = 313,
    ["Pipeline component"] = 513,
    ["PocketMine plugin.yml"] = 317,
    Pterodactyl = 552,
    ["Pull Request Labeler"] = 340,
    PyProject = 344,
    Qodana = 528,
    ["Quali Torque Blueprint Spec 2"] = 550,
    ["RKE Cluster Configuration JSON Schema"] = 510,
    ["RKE Cluster Configuration YAML Schema"] = 509,
    Ray = 480,
    ["Read the Docs"] = 343,
    ...
    ["SauceCTL Configuration"] = 517,
    ["Schema Catalog"] = 369,
    ["Scoop manifest"] = 374,
    ["Semgrep Rule"] = 376,
    ["Serverless Framework Configuration"] = 524,
    ["Settings.paf"] = 378,
    ["Shopware 6 Configuration"] = 525,
    ["Shopware CLI Extension Store Configuration"] = 526,
    ["Shopware CLI Project Store Configuration"] = 527,
    Solidarity = 383,
    ["Source Maps v3"] = 384,
    SpecIF = 385,
    ["Sponge Mixin configuration"] = 386,
    ["StackHawk Scanner Configuration"] = 523,
    ...
    ["Taskfile YAML Schema"] = 506,
    Taurus = 402,
    ["TestEnvironment.json"] = 408,
    Tikibase = 405,
    ["Traefik v2"] = 410,
    ["Traefik v2 File Provider"] = 411,
    Tye = 529,
    ["UI5 Manifest"] = 423,
    ["UTAM Page Object"] = 425,
    ["Ubuntu Server Autoinstall"] = 421,
    ["Uniswap Token List"] = 489,
    Updatecli = 536,
    ["User Journey Map YAML Schema"] = 508,
    V2Ray = 540,
    ["VSCode Code Snippets"] = 111,
    ["VSIX CLI publishing"] = 436,
    ["Vela Pipeline Configuration"] = 428,
    Vercel = 110,
    ["Web App Manifest"] = 440,
    ["Web types"] = 443,
    WebExtensions = 439,
    ["Webman package recipe"] = 546,
    ["Windows Package Manager Installer Manifest"] = 486,
    ["Windows Package Manager Locale Manifest"] = 487,
    ["Windows Package Manager Singleton Manifest"] = 485,
    ["Woodpecker pipeline config"] = 519,
    ["Xstate Machine Schema"] = 534,
    ["Yippee-Ki-JSON configuration YML"] = 491,
    ["angular.json"] = 8,
    ...
    ["jsconfig.json"] = 245,
    ["jscpd Configuration Schema"] = 551,
    jsdoc = 479,
    ["k3d.yaml"] = 246,
    ...
    ["servicehub.config.json"] = 453,
    ["servicehub.service.json"] = 452,
    ["settings.job"] = 377,
    ...
    ["theme.json"] = 406,
    tmLanguage = 407,
    ["trunk.yaml schema"] = 412,
    ["ts-force-config.json"] = 416,
    ["tsconfig.json"] = 413,
    ["tsd.json"] = 414,
    ["tsdrc.json"] = 415,
    ["tslint.json"] = 417,
    ...
    ["version.json"] = 429,
    ["vim-addon-info"] = 430,
    ["vs-2017.3.host.json"] = 432,
    ["vs-nesting.json"] = 433,
    ["vsls.json"] = 431,
    ["vss-extension.json"] = 437,
    ["webhint.io"] = 547,
    ["webjobpublishsettings.json"] = 442,
    ["webjobs-list.json"] = 441,
    ["xs-app.json"] = 467,
    ["xunit.runner.json"] = 451,
    yamllint = 490,
    zuul = 476,
    ["Žinoma"] = 484
  },
