...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 167,
    [".cryproj (generic)"] = 580,
    [".cryproj engine-5.2"] = 575,
    [".cryproj engine-5.3"] = 576,
    [".cryproj engine-5.4"] = 577,
    [".cryproj engine-5.5"] = 578,
    [".cryproj engine-dev"] = 579,
    [".csscomb.json"] = 169,
    [".csslintrc"] = 170,
    [".es6importsorterrc.json"] = 707,
    [".eslintrc"] = 218,
    [".esmrc.json"] = 210,
    [".ffizer.yaml"] = 222,
    [".htmlhintrc"] = 270,
    ...
    [".mtaext"] = 589,
    [".nodehawkrc"] = 366,
    [".npmpackagejsonlintrc"] = 369,
    [".phraseapp.yml"] = 410,
    [".pmbot.yml"] = 400,
    [".postcssrc"] = 405,
    [".powerpages-web-template-manifest"] = 407,
    [".pre-commit-config.yml"] = 408,
    [".pre-commit-hooks.yml"] = 409,
    [".putout.json"] = 429,
    [".rehyperc"] = 440,
    [".remarkrc"] = 441,
    [".sprite files"] = 494,
    ...
    ["<div>RIOTS' studio configuration"] = 559,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config schema"] = 328,
    ["API Builder"] = 620,
    ["AVA Configuration Schema"] = 677,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration Schema"] = 652,
    ["All Contributors configuration file"] = 706,
    ...
    ["Azure Pipelines"] = 54,
    ["Azure Static Web Apps CLI configuration file"] = 497,
    ["Azure Static Web Apps configuration file"] = 496,
    ["BX CI"] = 89,
    ["Better Code Hub"] = 625,
    ["Better Scripts"] = 90,
    BizTalkServerApplicationSchema = 595,
    ...
    ["Butane Config"] = 664,
    ["CICS TS region tagging"] = 671,
    ["CICS TS resource import"] = 672,
    ["CICS TS resource model"] = 673,
    ["CICS TS resource overrides"] = 674,
    ["CMake Presets"] = 91,
    ...
    ["Datadog Service Definition"] = 307,
    ["Datahub Ingestion Recipe Schema"] = 678,
    ...
    ["Dolittle Bounded Context Configuration"] = 189,
    ["Dolittle Event Horizons Configuration"] = 190,
    ["Dolittle Resources Configuration"] = 191,
    ["Dolittle Server Configuration"] = 192,
    ...
    ["Embrace Config Schema"] = 689,
    ["Error pages"] = 213,
    Esquio = 211,
    ["Estuary Flow Catalog Schema"] = 668,
    ["Expo SDK"] = 216,
    ["F-Droid Data metadata"] = 221,
    ["Facets - FSDL - Application"] = 219,
    ["FasterCI Configuration"] = 55,
    Firebase = 223,
    ["Fossa configuration file"] = 230,
    ["Fossa's fossa-deps file"] = 231,
    ["Foundry VTT - Base package Manifest"] = 225,
    ["Foundry VTT - Module Manifest"] = 226,
    ["Foundry VTT - System Data Template"] = 229,
    ["Foundry VTT - System Manifest"] = 227,
    ["Foundry VTT - World Manifest"] = 228,
    ["Foxx Manifest"] = 56,
    ["Freifunk.de Community API"] = 59,
    ["Frogbot Config"] = 60,
    ["GCP Blueprint Metadata"] = 236,
    ["GatewayCore API Gateway"] = 235,
    ["GeoJSON.json latest"] = 666,
    GherKing = 670,
    ["GitHub Action"] = 240,
    ["GitHub Discussion"] = 241,
    ["GitHub Funding"] = 242,
    ["GitHub Issue Template configuration"] = 244,
    ["GitHub Workflow"] = 245,
    ["GitHub Workflow Template Properties"] = 246,
    ["GitHub issue forms"] = 243,
    GitVersion = 239,
    ["Gitpod Configuration"] = 248,
    ["Global Privacy Control"] = 237,
    ["Google Cloud Workflows"] = 150,
    Goreleaser = 251,
    ["Goreleaser Pro"] = 252,
    Goss = 253,
    ["Gradle Build Cache Node"] = 622,
    ["Gradle Enterprise"] = 621,
    ["Grafana 5.x Dashboard"] = 254,
    ["GraphQL Code Generator"] = 257,
    ["GraphQL Config"] = 256,
    ["GraphQL Mesh"] = 255,
    ["Grunt JSHint task"] = 261,
    ["Grunt Watch task"] = 262,
    ["Grunt base task"] = 263,
    ["Grunt clean task"] = 259,
    ["Grunt copy task"] = 258,
    ["Grunt cssmin task"] = 260,
    HEMTT = 592,
    Hadolint = 604,
    Hammerkit = 632,
    ["Hardware Sentry Configuration"] = 682,
    Hayson = 265,
    ["Haystack Pipeline"] = 266,
    ["Hazelcast 5 Configuration"] = 267,
    ["Helm Chart.lock"] = 121,
    ["Helm Chart.yaml"] = 120,
    ["Helm Unittest Test Suite"] = 122,
    Hugo = 660,
    ["IBM Zapp document"] = 272,
    ["IBM zCodeFormatSettings"] = 273,
    ["IMG Catapult PSP"] = 278,
    ["Istanbul Schema"] = 685,
    ["JDownloader2 crawler multi-rule schema"] = 288,
    ["JDownloader2 crawler single-rule schema"] = 287,
    ["JFrog File Spec"] = 289,
    ["JFrog Pipelines YML DSL"] = 691,
    ["JMeter DSL cli config schema"] = 290,
    JReleaser = 292,
    ["JSON Document Transform"] = 299,
    ["JSON Feed"] = 300,
    ["JSON Resume"] = 447,
    ["JSON Schema Draft 2020-12"] = 571,
    ["JSON Schema Draft 4"] = 568,
    ["JSON Schema Draft 7"] = 569,
    ["JSON Schema Draft 8"] = 570,
    ...
    ["JSON-API"] = 298,
    ["JSON-e templates"] = 630,
    ["JSON-stat 2.0"] = 565,
    JSONPatch = 302,
    Jasmine = 283,
    Jekyll = 284,
    ["Jenkins X Pipelines"] = 285,
    ["Jenkins X Requirements"] = 286,
    ["Jovo Language Models"] = 291,
    ["KSP-AVC"] = 566,
    ["KSP-CKAN"] = 567,
    ["Karakum configuration file"] = 232,
    Kas = 305,
    ["Keycloak REST API"] = 698,
    ["Knative Functions - func.yaml"] = 233,
    ["KoDE/CI build.yaml"] = 687,
    ["Kong DBLess Schema"] = 688,
    KrakenD = 306,
    LOOBin = 323,
    Lefthook = 314,
    ["LinkML Metamodel"] = 321,
    Liquibase = 637,
    ["Liquibase Flow File"] = 638,
    ["Lively Properties"] = 322,
    Markdownlint = 641,
    ["Mason Registry"] = 643,
    ["MegaLinter configuration"] = 329,
    ["MegaLinter descriptor"] = 330,
    ["Meltano plugin discovery definition"] = 332,
    ["Meltano project definition"] = 331,
    ["Microsoft Band Web Tile"] = 333,
    ["Minecraft Data Pack Advancement"] = 335,
    ["Minecraft Data Pack Biome"] = 336,
    ["Minecraft Data Pack Configured Carver"] = 337,
    ["Minecraft Data Pack Damage Type"] = 338,
    ["Minecraft Data Pack Dimension"] = 340,
    ["Minecraft Data Pack Dimension Type"] = 339,
    ["Minecraft Data Pack Item Modifier"] = 341,
    ["Minecraft Data Pack Loot Table"] = 342,
    ["Minecraft Data Pack Metadata"] = 343,
    ["Minecraft Data Pack Predicate"] = 344,
    ["Minecraft Data Pack Recipe"] = 345,
    ["Minecraft Data Pack Tag"] = 346,
    ["Minecraft Data Pack Template Pool"] = 347,
    ["Minecraft Data Pack Trim Material"] = 352,
    ["Minecraft Data Pack Trim Pattern"] = 353,
    ["Minecraft Resource Pack Lang"] = 348,
    ["Minecraft Resource Pack Particle"] = 349,
    ["Minecraft Resource Pack Texture Mcmeta"] = 351,
    ["Minecraft Resourcepack Sounds"] = 350,
    ["MkDocs Configuration 1.0"] = 354,
    ["MongoDB Atlas Search Index Definition Schema"] = 686,
    ["Monika Configuration Schema"] = 684,
    ["Motif config"] = 588,
    ["NOX Framework (Service)"] = 368,
    ["Netin Diagnostic System Template"] = 647,
    ["Netlify config schema"] = 359,
    ["Nexus-as-Code schema"] = 360,
    ["Nightwatch.js"] = 361,
    ["ONe's service descriptor"] = 381,
    ["OSS Review Toolkit configuration"] = 388,
    ["OSS Review Toolkit curation"] = 389,
    ["OSS Review Toolkit package configuration"] = 390,
    ["OSS Review Toolkit repository configuration"] = 391,
    ["OSS Review Toolkit resolutions"] = 392,
    Opctl = 591,
    ["OpenRewrite Resource"] = 383,
    ["OpenWeather Current Weather API"] = 629,
    ["OpenWeather Road Risk API"] = 628,
    ["Ory Hydra configuration"] = 271,
    ["Ory Keto configuration"] = 308,
    ["Ory Kratos configuration"] = 387,
    ["Ory Oathkeeper configuration"] = 375,
    ["Outblocks App configuration"] = 385,
    ["Outblocks database table"] = 386,
    ["Outblocks project configuration"] = 384,
    Packer = 395,
    Pantsbuild = 705,
    ["Paper paper-plugin.yml"] = 396,
    ["Pipeline component"] = 639,
    ["PocketMine plugin.yml"] = 401,
    ["Postman collection"] = 406,
    ["Problem package generators"] = 413,
    Pterodactyl = 681,
    ["Pull Request Labeler"] = 428,
    Pulumi = 434,
    PyProject = 435,
    Pyright = 436,
    Qodana = 657,
    ["Quali Torque Blueprint Spec 2"] = 679,
    ["QueryFirst config file"] = 701,
    ["RKE Cluster Configuration JSON Schema"] = 636,
    ["RKE Cluster Configuration YAML Schema"] = 635,
    ["Rancher Fleet"] = 431,
    Ray = 603,
    ["Read the Docs"] = 433,
    ["Red-DiscordBot Cog"] = 437,
    ["Red-DiscordBot Cog Repo"] = 438,
    ["Red-DiscordBot Trivia"] = 439,
    Renovate = 448,
    ["Replit schema"] = 442,
    RoadRunner = 449,
    Ruff = 445,
    ["Rust Project"] = 446,
    ["Rust toolchain"] = 451,
    ["SIL Kit Participant Configuration"] = 482,
    ["SIL Kit Registry Configuration"] = 483,
    SWADL = 506,
    ["Safebox Config Schema"] = 692,
    ["Sapphire CLI Config"] = 454,
    ["SauceCTL Configuration"] = 644,
    ["Schema Catalog"] = 468,
    ["Scoop manifest"] = 473,
    ["Semantic Data Fabric (SDF) file"] = 474,
    ["Semgrep Rule"] = 476,
    ["Serenity Code Generator (Sergen)"] = 477,
    ["Serverless Framework Configuration"] = 651,
    ["Serverless Workflow Schema"] = 653,
    ["Settings.paf"] = 479,
    ["Shopware 6 Configuration"] = 654,
    ["Shopware CLI Extension Store Configuration"] = 655,
    ["Shopware CLI Project Store Configuration"] = 656,
    ["Sigrid scope configuration file"] = 481,
    ["Slack app manifest"] = 485,
    Solidarity = 488,
    ["Solution filters"] = 489,
    ["Source Maps v3"] = 490,
    Sourcery = 491,
    SpecIF = 492,
    ["Sponge Mixin configuration"] = 493,
    ["StackHawk Scanner Configuration"] = 650,
    Stale = 498,
    Starship = 499,
    ["Statamic Blueprint"] = 500,
    ["StrmPrivacy Data Connector"] = 696,
    ["StrmPrivacy Data Contract"] = 697,
    ["StrmPrivacy SimpleSchema"] = 694,
    ["StrmPrivacy Stream"] = 695,
    ["StrmPrivacy batch job configuration file"] = 693,
    ["Stryker Mutator"] = 503,
    ["StyleCop Analyzers Configuration"] = 504,
    ["Swagger API 2.0"] = 507,
    TSON = 531,
    ["Talisman configuration"] = 509,
    ["Taskfile YAML Schema"] = 631,
    Taurus = 510,
    ["TestEnvironment.json"] = 519,
    ["Tier.run pricing.json"] = 513,
    Tikibase = 514,
    ["Traefik v2"] = 522,
    ["Traefik v2 File Provider"] = 523,
    Turborepo = 520,
    Tye = 658,
    ["UET BuildConfig.json"] = 702,
    ["UI5 Manifest"] = 538,
    ["UTAM Page Object"] = 541,
    ["Ubuntu Server Autoinstall"] = 536,
    ["Uniswap Token List"] = 613,
    ["Unreal Engine Uplugin"] = 703,
    ["Unreal Engine Uproject"] = 704,
    Updatecli = 665,
    Uplift = 700,
    ["User Journey Map YAML Schema"] = 634,
    V2Ray = 669,
    ["VSCode Code Snippets"] = 138,
    ["VSIX CLI publishing"] = 554,
    ["Vela Pipeline Configuration"] = 544,
    Vercel = 137,
    ["Web App Manifest"] = 561,
    ["Web types"] = 564,
    WebExtensions = 560,
    ["Webman package recipe"] = 675,
    ["Windows Package Manager Installer Manifest"] = 610,
    ["Windows Package Manager Locale Manifest"] = 611,
    ["Windows Package Manager Singleton Manifest"] = 609,
    ["Woodpecker pipeline config"] = 646,
    ["Xstate Machine Schema"] = 663,
    ["Yippee-Ki-JSON configuration YML"] = 615,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 65,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 711,
    ["bashly-strings.yml"] = 712,
    ["bashly.yml"] = 710,
    ["batect.yml"] = 64,
    ["beau.yml"] = 624,
    ...
    ["ddev-global"] = 176,
    ["ddev-project"] = 177,
    ["debugsettings.json"] = 178,
    ["dependabot-v2.json"] = 181,
    ["dependabot.json"] = 180,
    ["deployed-cli"] = 662,
    ["detekt.yml"] = 183,
    ...
    ["gitlab-ci"] = 247,
    ["global.json"] = 249,
    ["golangci-lint Configuration"] = 250,
    ["haxelib.json"] = 264,
    helmfile = 605,
    helmwave = 606,
    ["host-meta.json"] = 269,
    ...
    ["ide.host.json"] = 274,
    ["ifstate.conf"] = 275,
    ["imageoptimizer.json"] = 276,
    ["importmap.json"] = 279,
    ["ioBroker Configuration"] = 280,
    ["ioBroker JSON UI"] = 281,
    ["ioBroker Package manifest"] = 282,
    ["ize.toml"] = 699,
    ["jsconfig.json"] = 303,
    ["jscpd Configuration Schema"] = 680,
    jsdoc = 602,
    ["k3d.yaml"] = 304,
    ["kontinuous-config.yaml"] = 310,
    ["kontinuous-values.yaml"] = 309,
    ["kustomization.yaml"] = 311,
    ["label-commenter-config.yml"] = 312,
    ["launchsettings.json"] = 313,
    lazydocker = 721,
    lazygit = 720,
    ["lego.json"] = 315,
    ["lerna.json"] = 316,
    ["lgtm.yml"] = 317,
    ["libman.json"] = 318,
    ["license-report-config.json"] = 319,
    ["linkinator.config.json"] = 320,
    ["local.settings.json"] = 325,
    ["localazy.json"] = 326,
    ["lotus.yaml"] = 324,
    ["lsdlschema.json"] = 327,
    ["madness.yml"] = 709,
    ["markdown-lint-check"] = 642,
    mboats = 649,
    ["micro-settings.json"] = 714,
    ["mimetypes.json"] = 334,
    ["mirrord-schema"] = 585,
    ["mta.yaml"] = 586,
    ["mtad.yaml"] = 587,
    ["mycode.json"] = 357,
    ["napari plugin manifest"] = 358,
    neoload = 597,
    ["nest-cli"] = 364,
    ["ninjs (News in JSON) 1.3"] = 363,
    ["ninjs (News in JSON) 2.0"] = 362,
    ["nlu.json"] = 365,
    ["nodemon.json"] = 367,
    ["noodl.schema.json"] = 648,
    now = 593,
    ["npm-badges"] = 370,
    ["nswag.json"] = 373,
    ntangle = 374,
    ["nuclei-template.yaml"] = 371,
    ["nuget-project.json"] = 372,
    ["ocelot.json"] = 376,
    ["omnisharp.json"] = 377,
    ["openapi.json"] = 378,
    ["openfin.json"] = 382,
    ...
    ["ops.yaml"] = 380,
    ["package.json"] = 393,
    ["package.manifest"] = 394,
    ["pathfinder.yml"] = 397,
    ["pattern.json"] = 399,
    ["petstore-v1.0"] = 690,
    pgap_yaml_input_reader = 398,
    ["plagiarize-me.yaml"] = 403,
    ["plagiarize.yaml"] = 402,
    ["portman.json"] = 404,
    ["prettierrc.json"] = 411,
    ["prisma.yml"] = 412,
    ["project-1.0.0-beta3.json"] = 415,
    ["project-1.0.0-beta4.json"] = 416,
    ["project-1.0.0-beta5.json"] = 417,
    ["project-1.0.0-beta6.json"] = 418,
    ["project-1.0.0-beta8.json"] = 419,
    ["project-1.0.0-rc1.json"] = 420,
    ["project-1.0.0-rc2.json"] = 421,
    ["project.json"] = 414,
    ["prometheus.json"] = 422,
    ["prometheus.rules.json"] = 423,
    ["prometheus.rules.test.json"] = 424,
    ["proxies.json"] = 425,
    ["publiccode.yml"] = 426,
    ["pubspec.yaml"] = 427,
    ["pyrseas-0.8.json"] = 430,
    ["quilt.mod.json"] = 715,
    ["release drafter"] = 598,
    rtx = 444,
    rustfmt = 450,
    samt = 452,
    samtrc = 453,
    ["sarif-1.0.0.json"] = 455,
    ["sarif-2.0.0.json"] = 456,
    ["sarif-2.1.0"] = 466,
    ["sarif-2.1.0-rtm.2"] = 457,
    ["sarif-2.1.0-rtm.3"] = 459,
    ["sarif-2.1.0-rtm.4"] = 461,
    ["sarif-2.1.0-rtm.5"] = 463,
    ["sarif-2.1.0-rtm.6"] = 464,
    ["sarif-external-property-file-2.1.0"] = 467,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 458,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 460,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 462,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 465,
    ["schema.org - Action"] = 469,
    ["schema.org - ContactPoint"] = 470,
    ["schema.org - Place"] = 471,
    ["schema.org - Thing"] = 472,
    ["secrethub.yml"] = 717,
    ["semantic-release"] = 475,
    ["servicehub.config.json"] = 574,
    ["servicehub.service.json"] = 573,
    ["settings.job"] = 478,
    ["sfdx-hardis configuration"] = 480,
    ["size-limit configuration"] = 484,
    ["skaffold.yaml"] = 640,
    ["skyuxconfig.json"] = 486,
    snapcraft = 487,
    ["sqlc configuration"] = 495,
    ["stripe-app-local.json"] = 502,
    ["stripe-app.json"] = 501,
    swcrc = 627,
    syntax = 719,
    ["task.json"] = 508,
    taskcat = 594,
    ["template.json"] = 511,
    ["templatsources.json"] = 512,
    ["theme.json"] = 515,
    ["tizen_workspace.json"] = 516,
    tldr = 517,
    tmLanguage = 518,
    tmuxinator = 582,
    ["transcend.yml"] = 524,
    ["trunk.yaml schema"] = 525,
    ["ts-force-config.json"] = 529,
    ["tsconfig.json"] = 526,
    ["tsd.json"] = 527,
    ["tsdrc.json"] = 528,
    ["tslint.json"] = 530,
    ...
    ["vega-lite.json"] = 543,
    ["vega.json"] = 542,
    ["venvironment-basic.yaml"] = 546,
    ["venvironment.yaml"] = 545,
    ["version.json"] = 547,
    ["vim-addon-info"] = 548,
    ["vs-2017.3.host.json"] = 550,
    ["vs-nesting.json"] = 551,
    ["vsls.json"] = 549,
    ["vss-extension.json"] = 555,
    ["vtesttree.yaml"] = 556,
    ["vtestunit.yaml"] = 557,
    ["webhint.io"] = 676,
    ["webjobpublishsettings.json"] = 563,
    ["webjobs-list.json"] = 562,
    ["xs-app.json"] = 590,
    ["xunit.runner.json"] = 572,
    yamllint = 614,
    zuul = 599,
    ["Žinoma"] = 608
  },
