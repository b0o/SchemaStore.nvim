...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 216,
    [".cryproj (generic)"] = 701,
    [".cryproj engine-5.2"] = 696,
    [".cryproj engine-5.3"] = 697,
    [".cryproj engine-5.4"] = 698,
    [".cryproj engine-5.5"] = 699,
    [".cryproj engine-dev"] = 700,
    [".eslintrc"] = 279,
    [".esmrc.json"] = 264,
    [".ffizer.yaml"] = 283,
    [".htmlhintrc"] = 340,
    ...
    [".mtaext"] = 712,
    [".nodehawkrc"] = 454,
    [".npmpackagejsonlintrc"] = 458,
    [".omletrc"] = 887,
    [".phrase.yml"] = 505,
    [".phraseapp.yml"] = 506,
    [".pmbot.yml"] = 495,
    [".postcssrc"] = 500,
    [".powerpages-web-template-manifest"] = 502,
    [".pre-commit-config.yml"] = 503,
    [".pre-commit-hooks.yml"] = 504,
    [".putout.json"] = 525,
    [".rehyperc"] = 544,
    [".remarkrc"] = 546,
    [".sprite files"] = 604,
    ...
    ["<div>RIOTS' studio configuration"] = 679,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 409,
    ABCSupplyPlan = 13,
    AIConfig = 14,
    ["API Builder"] = 744,
    ["AVA Configuration"] = 804,
    ...
    ["Adobe UXP Manifest"] = 869,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 15,
    ["Airplane task"] = 16,
    ["Alacritty Configuration"] = 776,
    ["All Contributors configuration file"] = 834,
    ...
    ["Azure Pipelines"] = 72,
    ["Azure Static Web Apps CLI configuration file"] = 607,
    ["Azure Static Web Apps configuration file"] = 606,
    ["BX CI"] = 110,
    ["Bashly (bashly.yml)"] = 838,
    ["Bashly Settings (bashly-settings.yml)"] = 839,
    ["Better Code Hub"] = 748,
    ["Better Scripts"] = 111,
    Bigconfig = 89,
    BizTalkServerApplicationSchema = 718,
    Bleep = 112,
    ...
    ["Butane Config"] = 789,
    ["CGS Custom Card Game (CardGameDef.json)"] = 874,
    ["CICS TS region tagging"] = 798,
    ["CICS TS resource import"] = 799,
    ["CICS TS resource model"] = 800,
    ["CICS TS resource overrides"] = 801,
    ["CMake Presets"] = 113,
    ["CNC Codes"] = 127,
    ...
    CityJSON = 123,
    ["Clawject config"] = 132,
    ["Cloud Foundry Application Manifest"] = 886,
    ...
    ["DataYoga Job"] = 136,
    ["Databricks Asset Bundles"] = 855,
    ["Datadog Service Definition"] = 384,
    ["Datadog Software Catalog"] = 385,
    ["Datahub Ingestion Recipe"] = 805,
    ["Dein Config"] = 138,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 846,
    ["EAS config"] = 277,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 835,
    ...
    ["Goreleaser Pro"] = 321,
    Goss = 322,
    ["Gradle Build Cache Node"] = 746,
    ["Gradle Enterprise"] = 745,
    ...
    Hadolint = 727,
    Hammerkit = 755,
    ["Hardware Sentry Configuration"] = 809,
    Hatch = 728,
    Hayson = 335,
    ...
    ["JFrog File Spec"] = 363,
    ["JFrog Pipelines YML DSL"] = 818,
    ["JMeter DSL cli config"] = 364,
    JReleaser = 366,
    ["JSON Document Transform"] = 374,
    ["JSON Feed"] = 375,
    ["JSON Resume"] = 551,
    ["JSON Schema Draft 2020-12"] = 692,
    ["JSON Schema Draft 4"] = 689,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 856,
    ["JSON Schema Draft 7"] = 690,
    ["JSON Schema Draft 7 (unofficial strict)"] = 857,
    ["JSON Schema Draft 8 (2019-09)"] = 691,
    ["JSON-API"] = 373,
    ["JSON-WF"] = 885,
    ["JSON-e templates"] = 753,
    ["JSON-stat 2.0"] = 686,
    JSONPatch = 377,
    ...
    Kas = 380,
    ["Keycloak REST API"] = 826,
    ["Knative Functions - func.yaml"] = 296,
    ["KoDE/CI build.yaml"] = 814,
    ["Kong DBLess config"] = 815,
    KrakenD = 383,
    ["Kubri Configuration"] = 389,
    LOOBin = 404,
    ...
    ["Language configuration"] = 895,
    Lefthook = 393,
    ["Liferay client-extension.yaml"] = 400,
    ["LinkML Metamodel"] = 402,
    Liquibase = 761,
    ["Liquibase Flow File"] = 762,
    ["Lively Properties"] = 403,
    ["Lobe AI Agent"] = 70,
    Loki = 71,
    ["MLOS Configs"] = 438,
    ["MS2Rescore Configuration"] = 441,
    ["Madness (madness.yml)"] = 837,
    Markdownlint = 765,
    ["Mason Registry"] = 767,
    ["MegaLinter configuration"] = 410,
    ["MegaLinter descriptor"] = 411,
    Melange = 863,
    ["Meltano plugin discovery definition"] = 413,
    ["Meltano project definition"] = 412,
    ["Mergify Configuration"] = 442,
    ["MetricsHub Configuration"] = 414,
    ...
    ["Minecraft Data Pack Configured Carver"] = 420,
    ["Minecraft Data Pack Damage Type"] = 421,
    ["Minecraft Data Pack Dimension"] = 423,
    ["Minecraft Data Pack Dimension Type"] = 422,
    ["Minecraft Data Pack Item Modifier"] = 424,
    ["Minecraft Data Pack Loot Table"] = 425,
    ["Minecraft Data Pack Metadata"] = 426,
    ["Minecraft Data Pack Predicate"] = 427,
    ["Minecraft Data Pack Recipe"] = 428,
    ["Minecraft Data Pack Tag"] = 429,
    ["Minecraft Data Pack Template Pool"] = 430,
    ["Minecraft Data Pack Trim Material"] = 435,
    ["Minecraft Data Pack Trim Pattern"] = 436,
    ["Minecraft Resource Pack Lang"] = 431,
    ["Minecraft Resource Pack Particle"] = 432,
    ["Minecraft Resource Pack Texture Mcmeta"] = 434,
    ["Minecraft Resourcepack Sounds"] = 433,
    ["Monade CLI Stack Configuration"] = 445,
    ["MongoDB Atlas Search Index Definition"] = 813,
    ["Monika Configuration"] = 811,
    ["Monoweave Configuration"] = 440,
    ["Motif config"] = 711,
    ["NOX Framework (Service)"] = 457,
    ["Netin Diagnostic System Template"] = 771,
    ["Netlify config"] = 448,
    ["Network-as-Code Data Model"] = 449,
    ["Nightwatch.js"] = 450,
    ["Nuitka.yaml"] = 877,
    ["ONe's changelog entry"] = 473,
    ["ONe's service descriptor"] = 472,
    ["OSS Review Toolkit configuration"] = 481,
    ["OSS Review Toolkit curation"] = 482,
    ["OSS Review Toolkit package configuration"] = 483,
    ["OSS Review Toolkit repository configuration"] = 484,
    ["OSS Review Toolkit resolutions"] = 485,
    Opctl = 714,
    ["Open Data Contract Standard (ODCS))"] = 476,
    ["OpenRewrite Resource"] = 475,
    ["OpenUtau character yaml"] = 469,
    ["OpenUtau ustx"] = 470,
    ["OpenWeather Current Weather API"] = 752,
    ["OpenWeather Road Risk API"] = 751,
    ["Ory Hydra configuration"] = 342,
    ["Ory Keto configuration"] = 386,
    ["Ory Kratos configuration"] = 480,
    ["Ory Oathkeeper configuration"] = 464,
    ["Outblocks App configuration"] = 478,
    ["Outblocks database table"] = 479,
    ["Outblocks project configuration"] = 477,
    PDM = 491,
    Packer = 488,
    Pantsbuild = 833,
    ["Paper paper-plugin.yml"] = 489,
    ["Pipeline component"] = 763,
    ["PocketMine plugin.yml"] = 496,
    ["Postman collection"] = 501,
    ["Problem object RFC9457"] = 861,
    ["Problem package generators"] = 509,
    Pterodactyl = 808,
    ["Pull Request Labeler"] = 524,
    Pulumi = 530,
    PyProject = 531,
    Pyright = 532,
    Qgoda = 533,
    Qodana = 781,
    ["Qt Creator workspace file"] = 893,
    ["Quali Torque Blueprint Spec 2"] = 806,
    ["QueryFirst config file"] = 829,
    ["RKE Cluster Configuration JSON"] = 760,
    ["RKE Cluster Configuration YAML"] = 759,
    ["Rancher Fleet"] = 527,
    ["Rattler-build"] = 534,
    Ray = 726,
    ["Read the Docs"] = 529,
    ["Red-DiscordBot Cog"] = 541,
    ["Red-DiscordBot Cog Repo"] = 542,
    ["Red-DiscordBot Trivia"] = 543,
    ["Render Blueprints"] = 758,
    RenderCV = 553,
    Renovate = 552,
    ["Replit config"] = 547,
    RoadRunner = 554,
    ["Rudder techniques"] = 867,
    Ruff = 549,
    ["Rust Project"] = 550,
    ["Rust toolchain"] = 557,
    ["SDMX data message"] = 582,
    ["SDMX metadata message"] = 581,
    ["SDMX structure message"] = 580,
    ["SIL Kit Participant Configuration"] = 592,
    ["SIL Kit Registry Configuration"] = 593,
    SWADL = 618,
    ["Safebox Config"] = 819,
    ["Sapphire CLI Config"] = 560,
    ["SauceCTL Configuration"] = 768,
    ["Schema Catalog"] = 574,
    ["Scoop manifest"] = 579,
    ["Semantic Data Fabric (SDF) file"] = 583,
    ["Semgrep Rule"] = 585,
    ["Serenity Code Generator (Sergen)"] = 586,
    ["Serverless Framework Configuration"] = 775,
    ["Serverless Workflow"] = 777,
    ["Settings.paf"] = 588,
    ["Shopware 6 Configuration"] = 778,
    ["Shopware CLI Extension Store Configuration"] = 779,
    ["Shopware CLI Project Store Configuration"] = 780,
    Sigma = 590,
    ["Sigrid scope configuration file"] = 591,
    ["SkyPilot Task JSON"] = 868,
    ["Slack app manifest"] = 595,
    Solidarity = 598,
    ["Solution filters"] = 599,
    ["Source Maps v3"] = 600,
    Sourcery = 601,
    SpecIF = 602,
    ["Sponge Mixin configuration"] = 603,
    StackBlitz = 608,
    ["StackHawk Scanner Configuration"] = 774,
    Stale = 609,
    ["Starlake Data Pipeline"] = 749,
    Starship = 610,
    ["Statamic Blueprint"] = 611,
    ["Stella configuration file"] = 612,
    ["StrmPrivacy Data Connector"] = 823,
    ["StrmPrivacy Data Contract"] = 824,
    ["StrmPrivacy SimpleSchema"] = 821,
    ["StrmPrivacy Stream"] = 822,
    ["StrmPrivacy batch job configuration file"] = 820,
    ["Stryker Mutator"] = 615,
    ["StyleCop Analyzers Configuration"] = 616,
    ["Stylelint (.stylelintrc)"] = 617,
    ["Sublime Syntax"] = 825,
    ["Subsquid squid manifest"] = 870,
    ["Swagger API 2.0"] = 619,
    TSON = 645,
    TSTyche = 646,
    Talhelper = 621,
    ["Talisman configuration"] = 622,
    ["Taskfile config"] = 754,
    Taurus = 623,
    ["TestEnvironment.json"] = 632,
    ["TextMate Grammar"] = 631,
    ["Tier.run pricing.json"] = 626,
    Tikibase = 627,
    ["Traefik v2"] = 635,
    ["Traefik v2 File Provider"] = 636,
    ["Travis CI (.travis.yml)"] = 634,
    TunnelHub = 860,
    Turborepo = 633,
    Tye = 782,
    ["UET BuildConfig.json"] = 830,
    ["UI5 Manifest"] = 655,
    ["UNCORS configuration"] = 659,
    ["UTAM Page Object"] = 658,
    ["Ubuntu Server Autoinstall"] = 653,
    ["Uniswap Token List"] = 737,
    ["Unreal Engine Uplugin"] = 831,
    ["Unreal Engine Uproject"] = 832,
    ["Updatecli Compose"] = 790,
    ["Updatecli Policy Manifest"] = 791,
    ["Updatecli Policy Metadata"] = 792,
    Uplift = 828,
    ["User Journey Map"] = 757,
    V2Ray = 796,
    ["VSCode Code Snippets"] = 178,
    ["VSIX CLI publishing"] = 674,
    ["Vela Pipeline Configuration"] = 663,
    Vercel = 177,
    Visivo = 858,
    ["Web App Manifest"] = 681,
    ["Web types"] = 684,
    WebExtensions = 680,
    ["Webman package recipe"] = 802,
    ["Windows Package Manager Installer Manifest"] = 734,
    ["Windows Package Manager Locale Manifest"] = 735,
    ["Windows Package Manager Singleton Manifest"] = 733,
    ["Woodpecker pipeline config"] = 770,
    ["Wrangler CLI"] = 685,
    ["Xstate Machine"] = 788,
    ["Yarn Config (.yarnrc.yml)"] = 747,
    ["Yippee-Ki-JSON configuration YML"] = 739,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 862,
    ...
    ["behat.yml"] = 96,
    ["bigquery-table"] = 88,
    ["bioimageio resource description"] = 878,
    ...
    ["ize.toml"] = 827,
    ["jsconfig.json"] = 378,
    ["jscpd Configuration"] = 807,
    jsdoc = 725,
    ["k3d.yaml"] = 379,
    ["k9s plugin.yml"] = 381,
    ["kontinuous-config.yaml"] = 388,
    ["kontinuous-values.yaml"] = 387,
    ["kustomization.yaml"] = 390,
    ["label-commenter-config.yml"] = 391,
    ["latexindent configuration"] = 69,
    ["launchsettings.json"] = 392,
    lazydocker = 849,
    lazygit = 848,
    ["lego.json"] = 394,
    ["lerna.json"] = 395,
    ["lgtm.yml"] = 396,
    ["liblab.config.json"] = 397,
    ["libman.json"] = 398,
    ["license-report-config.json"] = 399,
    ["linkinator.config.json"] = 401,
    ["lint-staged (.lintstagedrc)"] = 705,
    ["local.settings.json"] = 406,
    ["localazy.json"] = 407,
    ["lotus.yaml"] = 405,
    ["lsdlschema.json"] = 408,
    ["markdown-link-check"] = 766,
    mboats = 773,
    ["micro-settings.json"] = 842,
    ["mimetypes.json"] = 417,
    ["mirrord config"] = 706,
    mise = 707,
    ["mise-settings"] = 708,
    ["mkdocs.yml"] = 437,
    ["monospace.yml"] = 439,
    ["mprocs Configuration file"] = 894,
    ["mta.yaml"] = 709,
    ["mtad.yaml"] = 710,
    ["mycode.json"] = 446,
    ["napari plugin manifest"] = 447,
    neoload = 720,
    ["nest-cli"] = 452,
    ["ninjs (News in JSON)"] = 451,
    ["nixd configuration"] = 866,
    ["nlu.json"] = 453,
    ["nodemon.json"] = 455,
    ["noodl config"] = 772,
    ["notebook.mod.json"] = 456,
    now = 716,
    ["npm-badges"] = 459,
    ["nswag.json"] = 462,
    ntangle = 463,
    ["nuclei-template.yaml"] = 460,
    ["nuget-project.json"] = 461,
    ["ocelot.json"] = 465,
    ["omnisharp.json"] = 466,
    ["openapi.json"] = 467,
    ["openfin.json"] = 474,
    ...
    ["ops.yaml"] = 471,
    ["package.json"] = 486,
    ["package.manifest"] = 487,
    ["partial-black.json"] = 97,
    ["pathfinder.yml"] = 490,
    ["pattern.json"] = 493,
    ["petstore-v1.0"] = 817,
    pgap_yaml_input_reader = 492,
    ["pixi.toml"] = 494,
    ["plagiarize-me.yaml"] = 498,
    ["plagiarize.yaml"] = 497,
    ["portman.json"] = 499,
    ["prettierrc.json"] = 507,
    ["prisma.yml"] = 508,
    ["project-1.0.0-beta3.json"] = 511,
    ["project-1.0.0-beta4.json"] = 512,
    ["project-1.0.0-beta5.json"] = 513,
    ["project-1.0.0-beta6.json"] = 514,
    ["project-1.0.0-beta8.json"] = 515,
    ["project-1.0.0-rc1.json"] = 516,
    ["project-1.0.0-rc2.json"] = 517,
    ["project.json"] = 510,
    ["prometheus.json"] = 518,
    ["prometheus.rules.json"] = 519,
    ["prometheus.rules.test.json"] = 520,
    ["proxies.json"] = 521,
    ["publiccode.yml"] = 522,
    ["pubspec.yaml"] = 523,
    ["pyrseas-0.8.json"] = 526,
    ["quilt.mod.json"] = 843,
    ["rc3 auth"] = 535,
    ["rc3 collection"] = 536,
    ["rc3 environment"] = 537,
    ...
    ["rc3 settings"] = 540,
    ["release drafter"] = 721,
    ["release-plz.toml"] = 545,
    ["rivet.yaml"] = 865,
    rockcraft = 555,
    rustfmt = 556,
    samt = 558,
    samtrc = 559,
    ["sarif-1.0.0.json"] = 561,
    ["sarif-2.0.0.json"] = 562,
    ["sarif-2.1.0"] = 572,
    ["sarif-2.1.0-rtm.2"] = 563,
    ["sarif-2.1.0-rtm.3"] = 565,
    ["sarif-2.1.0-rtm.4"] = 567,
    ["sarif-2.1.0-rtm.5"] = 569,
    ["sarif-2.1.0-rtm.6"] = 570,
    ["sarif-external-property-file-2.1.0"] = 573,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 564,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 566,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 568,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 571,
    ["schema.org - Action"] = 575,
    ["schema.org - ContactPoint"] = 576,
    ["schema.org - Place"] = 577,
    ["schema.org - Thing"] = 578,
    ["secrethub.yml"] = 845,
    ["semantic-release"] = 584,
    ["servicehub.config.json"] = 695,
    ["servicehub.service.json"] = 694,
    ["settings.job"] = 587,
    ["sfdx-hardis configuration"] = 589,
    ["shard.yml"] = 881,
    ["size-limit configuration"] = 594,
    ["skaffold.yaml"] = 764,
    ...
    taskcat = 717,
    ["template.json"] = 624,
    ["templatsources.json"] = 625,
    ["theme.json"] = 628,
    ["tizen_workspace.json"] = 629,
    tldr = 630,
    tmuxinator = 703,
    ["transcend.yml"] = 637,
    ...
    ["vega-lite.json"] = 662,
    ["vega.json"] = 661,
    ["venvironment-basic.yaml"] = 665,
    ["venvironment.yaml"] = 664,
    ["version.json"] = 666,
    ["vim-addon-info"] = 668,
    ["vs-2017.3.host.json"] = 670,
    ["vs-nesting.json"] = 671,
    ["vsls.json"] = 669,
    ["vss-extension.json"] = 675,
    ["vtesttree.yaml"] = 676,
    ["vtestunit.yaml"] = 677,
    ["warp-keysets.json"] = 851,
    ["warp-themes.json"] = 852,
    ["warp-workflows.json"] = 853,
    ["webhint.io"] = 803,
    ["webjobpublishsettings.json"] = 683,
    ["webjobs-list.json"] = 682,
    ["well-known-fursona"] = 889,
    ["xs-app.json"] = 713,
    ["xunit.runner.json"] = 693,
    yamllint = 738,
    ["zerops.io import file"] = 898,
    ["zerops.yml"] = 897,
    zuul = 722,
    ["Žinoma"] = 732
  },
