...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 151,
    [".cryproj (generic)"] = 506,
    [".cryproj engine-5.2"] = 501,
    [".cryproj engine-5.3"] = 502,
    [".cryproj engine-5.4"] = 503,
    [".cryproj engine-5.5"] = 504,
    [".cryproj engine-dev"] = 505,
    [".csscomb.json"] = 153,
    [".csslintrc"] = 154,
    [".eslintrc"] = 199,
    [".esmrc.json"] = 191,
    ...
    [".mtaext"] = 515,
    [".nodehawkrc"] = 320,
    [".npmpackagejsonlintrc"] = 323,
    [".phraseapp.yml"] = 357,
    [".pmbot.yml"] = 349,
    [".postcssrc"] = 354,
    [".pre-commit-config.yml"] = 355,
    [".pre-commit-hooks.yml"] = 356,
    [".putout.json"] = 374,
    [".rehyperc"] = 382,
    [".remarkrc"] = 383,
    [".sprite files"] = 426,
    ...
    [".vsext"] = 481,
    [".yarnrc.yml"] = 547,
    ["<div>RIOTS' studio configuration"] = 485,
    ["@factorial/drupal-breakpoints-css"] = 5,
    ["A micro editor config schema"] = 289,
    ["API Builder"] = 544,
    ["AVA Configuration Schema"] = 600,
    ["AWS CDK cdk.json"] = 139,
    ["AWS CloudFormation"] = 140,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 141,
    ["Airlock Microgateway"] = 9,
    ["Airplane task"] = 10,
    ["Alacritty Configuration Schema"] = 575,
    ["All Contributors configuration file"] = 627,
    ...
    ["Azure Pipelines"] = 47,
    ["Azure Static Web Apps CLI configuration file"] = 428,
    ["Azure Static Web Apps configuration file"] = 427,
    ["BX CI"] = 81,
    ["Better Code Hub"] = 549,
    ["Better Scripts"] = 82,
    BizTalkServerApplicationSchema = 521,
    ["Block Protocol Metadata"] = 80,
    Briefcase = 526,
    ["Build Info"] = 73,
    Buildkite = 75,
    ["Bukkit plugin.yml"] = 74,
    ["BungeeCord plugin.yml"] = 78,
    ["Butane Config"] = 587,
    ["CICS TS region tagging"] = 594,
    ["CICS TS resource import"] = 595,
    ["CICS TS resource model"] = 596,
    ["CICS TS resource overrides"] = 597,
    ["CMake Presets"] = 83,
    ["CNC Codes JSON Schema"] = 92,
    ["Calqulus pipeline"] = 84,
    ["Camel YAML DSL"] = 85,
    Carafe = 86,
    ["Cargo Config Schema"] = 87,
    ["Cargo Make"] = 88,
    ["Catalog Info Backstage"] = 89,
    Cheatsheets = 584,
    ["Chrome Extension"] = 133,
    ["CircleCI config.yml"] = 114,
    ["Citation File Format"] = 142,
    CityJSON = 90,
    ["Code Climate"] = 115,
    CodeCV = 46,
    Codux = 122,
    ["Cog config file"] = 93,
    ["Commandbox Box.json"] = 94,
    ["Commandbox Server.json"] = 95,
    ["Common Catalog Schema"] = 131,
    ["Common types for all schemas"] = 1,
    Conjure = 91,
    ["Container Structure Test"] = 532,
    Containerlab = 557,
    ["DWP Exchange - catalogue entry"] = 188,
    ["DWP Exchange - gateway"] = 186,
    ["DWP Exchange - meta"] = 187,
    ["Dart build configuration"] = 155,
    ["Dart test config"] = 156,
    ["DashLord configuration"] = 157,
    ["Datadog Service Definition"] = 273,
    ["Datahub Ingestion Recipe Schema"] = 601,
    ["Dein Config Schema"] = 97,
    Deno = 161,
    ["Deployer Recipe"] = 164,
    Devfile = 185,
    ["Discord Webhook"] = 166,
    ["Dolittle Artifacts"] = 170,
    ["Dolittle Bounded Context Configuration"] = 171,
    ["Dolittle Event Horizons Configuration"] = 172,
    ["Dolittle Resources Configuration"] = 173,
    ["Dolittle Server Configuration"] = 174,
    ["Dolittle Tenant Map Configuration"] = 176,
    ["Dolittle Tenants Configuration"] = 175,
    ["Dolittle Topology"] = 177,
    ["Drupal Breakpoints Schema"] = 98,
    ["Drupal Config Schema"] = 109,
    ["Drupal Info Schema"] = 99,
    ["Drupal Layouts Schema"] = 100,
    ["Drupal Libraries Schema"] = 101,
    ["Drupal Links Action Schema"] = 102,
    ["Drupal Links Contextual Schema"] = 103,
    ["Drupal Links Menu Schema"] = 104,
    ["Drupal Links Task Schema"] = 105,
    ["Drupal Migration Schema"] = 106,
    ["Drupal Permissions Schema"] = 107,
    ["Drupal Routing Schema"] = 108,
    ["Drupal Services Schema"] = 110,
    ["Drush site aliases"] = 181,
    ["Embrace Config Schema"] = 612,
    ["Error pages"] = 194,
    Esquio = 192,
    ["Estuary Flow Catalog Schema"] = 591,
    ["Expo SDK"] = 197,
    ["F-Droid Data metadata"] = 202,
    ["Facets - FSDL - Application"] = 200,
    ["Fossa configuration file"] = 207,
    ["Fossa's fossa-deps file"] = 208,
    ["Foundry VTT - Manifest"] = 205,
    ["Foundry VTT - Template"] = 206,
    ["Foxx Manifest"] = 48,
    ["Freifunk.de Community API"] = 51,
    ["Frogbot Config"] = 52,
    ["GatewayCore API Gateway"] = 211,
    ["GeoJSON.json latest"] = 589,
    GherKing = 593,
    ["GitHub Action"] = 215,
    ["GitHub Funding"] = 216,
    ["GitHub Issue Template configuration"] = 218,
    ["GitHub Workflow"] = 219,
    ["GitHub Workflow Template Properties"] = 220,
    ["GitHub issue forms"] = 217,
    GitVersion = 214,
    ["Gitpod Configuration"] = 222,
    ["Global Privacy Control"] = 212,
    ["Google Cloud Workflows"] = 138,
    Goreleaser = 225,
    ["Goreleaser Pro"] = 226,
    ["Gradle Build Cache Node"] = 546,
    ["Gradle Enterprise"] = 545,
    ["Grafana 5.x Dashboard"] = 227,
    ["GraphQL Code Generator"] = 230,
    ["GraphQL Config"] = 229,
    ["GraphQL Mesh"] = 228,
    ["Grunt JSHint task"] = 234,
    ["Grunt Watch task"] = 235,
    ["Grunt base task"] = 236,
    ["Grunt clean task"] = 232,
    ["Grunt copy task"] = 231,
    ["Grunt cssmin task"] = 233,
    HEMTT = 518,
    Hadolint = 530,
    Hammerkit = 556,
    ["Hardware Sentry Configuration"] = 605,
    Hayson = 238,
    ["Haystack Pipeline"] = 239,
    ["Hazelcast 5 Configuration"] = 240,
    ["Helm Chart.lock"] = 112,
    ["Helm Chart.yaml"] = 111,
    ["Helm Unittest Test Suite"] = 113,
    Hugo = 583,
    ["Istanbul Schema"] = 608,
    ["JDownloader2 crawler multi-rule schema"] = 257,
    ["JDownloader2 crawler single-rule schema"] = 256,
    ["JFrog File Spec"] = 258,
    ["JFrog Pipelines YML DSL"] = 614,
    ["JSON Document Transform"] = 266,
    ["JSON Feed"] = 267,
    ["JSON Resume"] = 388,
    ["JSON Schema Draft 2020-12"] = 497,
    ["JSON Schema Draft 4"] = 494,
    ["JSON Schema Draft 7"] = 495,
    ["JSON Schema Draft 8"] = 496,
    ["JSON schema for CodeShip Pro services configuration files"] = 124,
    ["JSON schema for CodeShip Pro steps configuration files"] = 125,
    ["JSON schema for Codecov configuration files"] = 123,
    ["JSON-API"] = 265,
    ["JSON-e templates"] = 554,
    ["JSON-stat 2.0"] = 491,
    JSONPatch = 269,
    Jasmine = 252,
    Jekyll = 253,
    ["Jenkins X Pipelines"] = 254,
    ["Jenkins X Requirements"] = 255,
    ["Jovo Language Models"] = 259,
    ["KSP-AVC"] = 492,
    ["KSP-CKAN"] = 493,
    ["Keycloak REST API"] = 620,
    ["Knative Functions - func.yaml"] = 209,
    ["KoDE/CI build.yaml"] = 610,
    ["Kong DBLess Schema"] = 611,
    KrakenD = 272,
    ["LinkML Metamodel"] = 284,
    Liquibase = 561,
    ["Liquibase Flow File"] = 562,
    ["Lively Properties"] = 285,
    Markdownlint = 565,
    ["MegaLinter configuration"] = 290,
    ["MegaLinter descriptor"] = 291,
    ["Meltano plugin discovery definition"] = 293,
    ["Meltano project definition"] = 292,
    ["Microsoft Band Web Tile"] = 294,
    ["Minecraft Data Pack Advancement"] = 296,
    ["Minecraft Data Pack Biome"] = 297,
    ["Minecraft Data Pack Configured Carver"] = 298,
    ["Minecraft Data Pack Dimension"] = 300,
    ["Minecraft Data Pack Dimension Type"] = 299,
    ["Minecraft Data Pack Item Modifier"] = 301,
    ["Minecraft Data Pack Loot Table"] = 302,
    ["Minecraft Data Pack Metadata"] = 303,
    ["Minecraft Data Pack Predicate"] = 304,
    ["Minecraft Data Pack Recipe"] = 305,
    ["Minecraft Data Pack Tag"] = 306,
    ["Minecraft Data Pack Template Pool"] = 307,
    ["Minecraft Resourcepack Sounds"] = 308,
    ["MkDocs Configuration 1.0"] = 309,
    ["MongoDB Atlas Search Index Definition Schema"] = 609,
    ["Monika Configuration Schema"] = 607,
    ["Motif config"] = 514,
    ["NOX Framework (Service)"] = 322,
    ["Netin Diagnostic System Template"] = 570,
    ["Netlify config schema"] = 314,
    ["Nightwatch.js"] = 315,
    ["OSS Review Toolkit configuration"] = 339,
    ["OSS Review Toolkit curation"] = 340,
    ["OSS Review Toolkit package configuration"] = 341,
    ["OSS Review Toolkit repository configuration"] = 342,
    ["OSS Review Toolkit resolutions"] = 343,
    Opctl = 517,
    ["OpenWeather Current Weather API"] = 553,
    ["OpenWeather Road Risk API"] = 552,
    ["Ory Hydra configuration"] = 244,
    ["Ory Keto configuration"] = 274,
    ["Ory Kratos configuration"] = 338,
    ["Ory Oathkeeper configuration"] = 329,
    ["Outblocks App configuration"] = 336,
    ["Outblocks database table"] = 337,
    ["Outblocks project configuration"] = 335,
    Packer = 346,
    Pantsbuild = 626,
    ["Pipeline component"] = 563,
    ["PocketMine plugin.yml"] = 350,
    Pterodactyl = 604,
    ["Pull Request Labeler"] = 373,
    Pulumi = 378,
    PyProject = 379,
    Qodana = 580,
    ["Quali Torque Blueprint Spec 2"] = 602,
    ["QueryFirst config file"] = 623,
    ["RKE Cluster Configuration JSON Schema"] = 560,
    ["RKE Cluster Configuration YAML Schema"] = 559,
    ["Rancher Fleet"] = 376,
    Ray = 529,
    ["Read the Docs"] = 377,
    ["Red-DiscordBot Cog"] = 380,
    ["Red-DiscordBot Cog Repo"] = 381,
    Renovate = 389,
    ["Replit schema"] = 384,
    RoadRunner = 390,
    Ruff = 386,
    ["Rust Project"] = 387,
    ["Rust toolchain"] = 392,
    ["SIL Kit Participant Configuration"] = 417,
    SWADL = 437,
    ["Sapphire CLI Config"] = 393,
    ["SauceCTL Configuration"] = 567,
    ["Schema Catalog"] = 406,
    ["Scoop manifest"] = 411,
    ["Semgrep Rule"] = 413,
    ["Serverless Framework Configuration"] = 574,
    ["Serverless Workflow Schema"] = 576,
    ["Settings.paf"] = 415,
    ["Shopware 6 Configuration"] = 577,
    ["Shopware CLI Extension Store Configuration"] = 578,
    ["Shopware CLI Project Store Configuration"] = 579,
    Solidarity = 421,
    ["Solution filters"] = 422,
    ["Source Maps v3"] = 423,
    SpecIF = 424,
    ["Sponge Mixin configuration"] = 425,
    ["StackHawk Scanner Configuration"] = 573,
    Stale = 429,
    Starship = 430,
    ["Statamic Blueprint"] = 431,
    ["StrmPrivacy Data Connector"] = 618,
    ["StrmPrivacy Data Contract"] = 619,
    ["StrmPrivacy SimpleSchema"] = 616,
    ["StrmPrivacy Stream"] = 617,
    ["StrmPrivacy batch job configuration file"] = 615,
    ["Stryker Mutator"] = 434,
    ["StyleCop Analyzers Configuration"] = 435,
    ["Swagger API 2.0"] = 438,
    TSON = 459,
    ["Talisman configuration"] = 439,
    ["Taskfile YAML Schema"] = 555,
    Taurus = 440,
    ["TestEnvironment.json"] = 448,
    ["Tier.run pricing.json"] = 443,
    Tikibase = 444,
    ["Traefik v2"] = 451,
    ["Traefik v2 File Provider"] = 452,
    Turborepo = 449,
    Tye = 581,
    ["UI5 Manifest"] = 466,
    ["UTAM Page Object"] = 469,
    ["Ubuntu Server Autoinstall"] = 464,
    ["Uniswap Token List"] = 538,
    ["Unreal Engine Uplugin"] = 624,
    ["Unreal Engine Uproject"] = 625,
    Updatecli = 588,
    Uplift = 622,
    ["User Journey Map YAML Schema"] = 558,
    V2Ray = 592,
    ["VSCode Code Snippets"] = 127,
    ["VSIX CLI publishing"] = 482,
    ["Vela Pipeline Configuration"] = 472,
    Vercel = 126,
    ["Web App Manifest"] = 487,
    ["Web types"] = 490,
    WebExtensions = 486,
    ["Webman package recipe"] = 598,
    ["Windows Package Manager Installer Manifest"] = 535,
    ["Windows Package Manager Locale Manifest"] = 536,
    ["Windows Package Manager Singleton Manifest"] = 534,
    ["Woodpecker pipeline config"] = 569,
    ["Xstate Machine Schema"] = 586,
    ["Yippee-Ki-JSON configuration YML"] = 540,
    ["angular.json"] = 11,
    ...
    ["batect.yml"] = 56,
    ["beau.yml"] = 548,
    ["beef-database-codegen"] = 58,
    ["beef-database-v5-codegen"] = 60,
    ["beef-entity-codegen"] = 59,
    ["beef-entity-v5-codegen"] = 61,
    ["behat.yml"] = 69,
    ["bigquery-table"] = 62,
    ["bitbucket-pipelines"] = 63,
    bitrise = 64,
    ["bitrise-step"] = 65,
    ["block.json"] = 79,
    ["bower.json"] = 67,
    ["bozr.suite.json"] = 70,
    ["browser.i18n.json"] = 71,
    bucklescript = 72,
    ["bundleconfig.json"] = 77,
    ["chutzpah.json"] = 134,
    clangd = 118,
    ["cloud-init: cloud-config userdata JSON schema"] = 120,
    ["cloud-sdk-pipeline-config-schema"] = 136,
    ["cloudbuild.json"] = 137,
    cloudify = 119,
    codemagic = 121,
    ["coffeelint.json"] = 143,
    comet = 550,
    ["commands.json"] = 130,
    ["compile_commands.json"] = 129,
    ["compilerconfig.json"] = 128,
    ["component-detection-manifest.json"] = 146,
    ["component.json"] = 145,
    ["composer.json"] = 144,
    ["config.json"] = 147,
    ["contentmanifest.json"] = 135,
    ["contribute.json"] = 148,
    ["cosmos.config.json"] = 132,
    ["crowdin.yml"] = 149,
    cspell = 152,
    ["cypress.json"] = 150,
    ["datalogic-scan2deploy-android"] = 158,
    ["datalogic-scan2deploy-ce"] = 159,
    ["dbt Project"] = 96,
    ["debugsettings.json"] = 160,
    ["dependabot-v2.json"] = 163,
    ["dependabot.json"] = 162,
    ["deployed-cli"] = 585,
    ["detekt.yml"] = 165,
    devinit = 542,
    ["devspace.yaml"] = 606,
    ["docfx.json"] = 169,
    ["docker-compose.yml"] = 541,
    ["docker-seq schema"] = 168,
    ["dockerd.json"] = 167,
    ["dotnet Release Index manifest"] = 178,
    ["dotnetcli.host.json"] = 179,
    ["drone.json"] = 180,
    ["dss-2.0.0.json"] = 182,
    ["dstack Workflows"] = 183,
    ["dvc.yaml"] = 184,
    ["ecosystem.json"] = 189,
    eksctl = 190,
    ["electron-builder configuration file."] = 195,
    ["epr-manifest.json"] = 193,
    ["evcc.yaml"] = 196,
    ["ezd schema"] = 198,
    ["fabric.mod.json"] = 201,
    ["first-timers-bot"] = 204,
    ["flagd flag configuration"] = 49,
    ["fly.io Schema"] = 50,
    fulibWorkflows = 568,
    ["function.json"] = 210,
    ["geojson.json"] = 213,
    ["gitlab-ci"] = 221,
    ["global.json"] = 223,
    ["golangci-lint Configuration"] = 224,
    ["haxelib.json"] = 237,
    helmfile = 531,
    ["host-meta.json"] = 242,
    ["host.json"] = 241,
    ...
    ["ide.host.json"] = 245,
    ["ifstate.conf"] = 246,
    ["imageoptimizer.json"] = 247,
    ["importmap.json"] = 249,
    ["ioBroker JSON UI"] = 250,
    ["ioBroker Package manifest"] = 251,
    ["ize.toml"] = 621,
    ["jsconfig.json"] = 270,
    ["jscpd Configuration Schema"] = 603,
    jsdoc = 528,
    ["k3d.yaml"] = 271,
    ["kustomization.yaml"] = 275,
    ["label-commenter-config.yml"] = 276,
    ["launchsettings.json"] = 277,
    ["lego.json"] = 278,
    ["lerna.json"] = 279,
    ["lgtm.yml"] = 280,
    ["libman.json"] = 281,
    ["license-report-config.json"] = 282,
    ["linkinator.config.json"] = 283,
    ["local.settings.json"] = 286,
    ["localazy.json"] = 287,
    ["lsdlschema.json"] = 288,
    ["markdown-lint-check"] = 566,
    mboats = 572,
    ["mimetypes.json"] = 295,
    ["mirrord-schema"] = 511,
    ["mta.yaml"] = 512,
    ["mtad.yaml"] = 513,
    ["mycode.json"] = 312,
    ["napari plugin manifest"] = 313,
    neoload = 523,
    ["nest-cli"] = 318,
    ["ninjs (News in JSON) 1.3"] = 317,
    ["ninjs (News in JSON) 2.0"] = 316,
    ["nlu.json"] = 319,
    ["nodemon.json"] = 321,
    ["noodl.schema.json"] = 571,
    now = 519,
    ["npm-badges"] = 324,
    ["nswag.json"] = 327,
    ntangle = 328,
    ["nuclei-template.yaml"] = 325,
    ["nuget-project.json"] = 326,
    ["ocelot.json"] = 330,
    ["omnisharp.json"] = 331,
    ["openapi.json"] = 332,
    ["openfin.json"] = 334,
    ["openrpc.json"] = 333,
    ["package.json"] = 344,
    ["package.manifest"] = 345,
    ["pattern.json"] = 348,
    ["petstore-v1.0"] = 613,
    pgap_yaml_input_reader = 347,
    ["plagiarize-me.yaml"] = 352,
    ["plagiarize.yaml"] = 351,
    ["portman.json"] = 353,
    ["prettierrc.json"] = 358,
    ["prisma.yml"] = 359,
    ["project-1.0.0-beta3.json"] = 361,
    ["project-1.0.0-beta4.json"] = 362,
    ["project-1.0.0-beta5.json"] = 363,
    ["project-1.0.0-beta6.json"] = 364,
    ["project-1.0.0-beta8.json"] = 365,
    ["project-1.0.0-rc1.json"] = 366,
    ["project-1.0.0-rc2.json"] = 367,
    ["project.json"] = 360,
    ["prometheus.json"] = 368,
    ["prometheus.rules.json"] = 369,
    ["proxies.json"] = 370,
    ["publiccode.yml"] = 371,
    ["pubspec.yaml"] = 372,
    ["pyrseas-0.8.json"] = 375,
    ["release drafter"] = 524,
    rustfmt = 391,
    ["sarif-1.0.0.json"] = 394,
    ["sarif-2.0.0.json"] = 395,
    ["sarif-2.1.0"] = 404,
    ["sarif-2.1.0-rtm.2"] = 396,
    ["sarif-2.1.0-rtm.3"] = 398,
    ["sarif-2.1.0-rtm.4"] = 400,
    ["sarif-2.1.0-rtm.5"] = 402,
    ["sarif-external-property-file-2.1.0"] = 405,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 397,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 399,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 401,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 403,
    ["schema.org - Action"] = 407,
    ["schema.org - ContactPoint"] = 408,
    ["schema.org - Place"] = 409,
    ["schema.org - Thing"] = 410,
    ["semantic-release"] = 412,
    ["servicehub.config.json"] = 500,
    ["servicehub.service.json"] = 499,
    ["settings.job"] = 414,
    ["sfdx-hardis configuration"] = 416,
    ["size-limit configuration"] = 418,
    ["skaffold.yaml"] = 564,
    ["skyuxconfig.json"] = 419,
    snapcraft = 420,
    ["stripe-app-local.json"] = 433,
    ["stripe-app.json"] = 432,
    swcrc = 551,
    taskcat = 520,
    ["template.json"] = 441,
    ["templatsources.json"] = 442,
    ["theme.json"] = 445,
    ["tizen_workspace.json"] = 446,
    tmLanguage = 447,
    tmuxinator = 508,
    ["trunk.yaml schema"] = 453,
    ["ts-force-config.json"] = 457,
    ["tsconfig.json"] = 454,
    ["tsd.json"] = 455,
    ["tsdrc.json"] = 456,
    ["tslint.json"] = 458,
    ...
    ["vega-lite.json"] = 471,
    ["vega.json"] = 470,
    ["venvironment-basic.yaml"] = 474,
    ["venvironment.yaml"] = 473,
    ["version.json"] = 475,
    ["vim-addon-info"] = 476,
    ["vs-2017.3.host.json"] = 478,
    ["vs-nesting.json"] = 479,
    ["vsls.json"] = 477,
    ["vss-extension.json"] = 483,
    ["webhint.io"] = 599,
    ["webjobpublishsettings.json"] = 489,
    ["webjobs-list.json"] = 488,
    ["xs-app.json"] = 516,
    ["xunit.runner.json"] = 498,
    yamllint = 539,
    zuul = 525,
    ["Žinoma"] = 533
  },
