...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 158,
    [".cryproj (generic)"] = 542,
    [".cryproj engine-5.2"] = 537,
    [".cryproj engine-5.3"] = 538,
    [".cryproj engine-5.4"] = 539,
    [".cryproj engine-5.5"] = 540,
    [".cryproj engine-dev"] = 541,
    [".csscomb.json"] = 160,
    [".csslintrc"] = 161,
    [".es6importsorterrc.json"] = 665,
    [".eslintrc"] = 206,
    [".esmrc.json"] = 198,
    [".ffizer.yaml"] = 210,
    [".htmlhintrc"] = 254,
    ...
    ["Azure Pipelines"] = 48,
    ["Azure Static Web Apps CLI configuration file"] = 459,
    ["Azure Static Web Apps configuration file"] = 458,
    ["BX CI"] = 83,
    ["Better Code Hub"] = 585,
    ["Better Scripts"] = 84,
    BizTalkServerApplicationSchema = 557,
    ...
    ["Butane Config"] = 624,
    ["CICS TS region tagging"] = 631,
    ["CICS TS resource import"] = 632,
    ["CICS TS resource model"] = 633,
    ["CICS TS resource overrides"] = 634,
    ["CMake Presets"] = 85,
    ...
    ["Datahub Ingestion Recipe Schema"] = 638,
    ...
    ["Embrace Config Schema"] = 649,
    ["Error pages"] = 201,
    Esquio = 199,
    ["Estuary Flow Catalog Schema"] = 628,
    ["Expo SDK"] = 204,
    ...
    Goreleaser = 236,
    ["Goreleaser Pro"] = 237,
    ["Gradle Build Cache Node"] = 582,
    ["Gradle Enterprise"] = 581,
    ...
    Hadolint = 566,
    Hammerkit = 592,
    ["Hardware Sentry Configuration"] = 642,
    Hayson = 249,
    ...
    ["JFrog File Spec"] = 273,
    ["JFrog Pipelines YML DSL"] = 651,
    ["JMeter DSL cli config schema"] = 274,
    ["JSON Document Transform"] = 282,
    ["JSON Feed"] = 283,
    ["JSON Resume"] = 416,
    ["JSON Schema Draft 2020-12"] = 533,
    ["JSON Schema Draft 4"] = 530,
    ["JSON Schema Draft 7"] = 531,
    ["JSON Schema Draft 8"] = 532,
    ...
    ["KSP-CKAN"] = 529,
    Kas = 288,
    ["Keycloak REST API"] = 657,
    ["Knative Functions - func.yaml"] = 219,
    ["KoDE/CI build.yaml"] = 647,
    ["Kong DBLess Schema"] = 648,
    KrakenD = 289,
    LOOBin = 304,
    ["LinkML Metamodel"] = 302,
    Liquibase = 597,
    ["Liquibase Flow File"] = 598,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 646,
    ["Monika Configuration Schema"] = 644,
    ["Motif config"] = 550,
    ["NOX Framework (Service)"] = 346,
    ["Netin Diagnostic System Template"] = 607,
    ...
    ["OpenWeather Current Weather API"] = 589,
    ["OpenWeather Road Risk API"] = 588,
    ...
    PyProject = 405,
    Qodana = 617,
    ["Quali Torque Blueprint Spec 2"] = 639,
    ["QueryFirst config file"] = 660,
    ["RKE Cluster Configuration JSON Schema"] = 596,
    ["RKE Cluster Configuration YAML Schema"] = 595,
    ["Rancher Fleet"] = 402,
    Ray = 565,
    ["Read the Docs"] = 403,
    ...
    ["Rust Project"] = 415,
    ["Rust toolchain"] = 420,
    ["SIL Kit Participant Configuration"] = 446,
    SWADL = 468,
    ["Sapphire CLI Config"] = 421,
    ["SauceCTL Configuration"] = 604,
    ["Schema Catalog"] = 434,
    ["Scoop manifest"] = 439,
    ["Semgrep Rule"] = 441,
    ["Serenity Code Generator (Sergen)"] = 442,
    ["Serverless Framework Configuration"] = 611,
    ["Serverless Workflow Schema"] = 613,
    ["Settings.paf"] = 444,
    ["Shopware 6 Configuration"] = 614,
    ["Shopware CLI Extension Store Configuration"] = 615,
    ["Shopware CLI Project Store Configuration"] = 616,
    ["Slack app manifest"] = 448,
    Solidarity = 451,
    ["Solution filters"] = 452,
    ["Source Maps v3"] = 453,
    Sourcery = 454,
    SpecIF = 455,
    ["Sponge Mixin configuration"] = 456,
    ["StackHawk Scanner Configuration"] = 610,
    Stale = 460,
    Starship = 461,
    ["Statamic Blueprint"] = 462,
    ["StrmPrivacy Data Connector"] = 655,
    ["StrmPrivacy Data Contract"] = 656,
    ["StrmPrivacy SimpleSchema"] = 653,
    ["StrmPrivacy Stream"] = 654,
    ["StrmPrivacy batch job configuration file"] = 652,
    ["Stryker Mutator"] = 465,
    ["StyleCop Analyzers Configuration"] = 466,
    ["Swagger API 2.0"] = 469,
    TSON = 493,
    ["Talisman configuration"] = 471,
    ["Taskfile YAML Schema"] = 591,
    Taurus = 472,
    ["TestEnvironment.json"] = 481,
    ["Tier.run pricing.json"] = 475,
    Tikibase = 476,
    ["Traefik v2"] = 484,
    ["Traefik v2 File Provider"] = 485,
    Turborepo = 482,
    Tye = 618,
    ["UI5 Manifest"] = 500,
    ["UTAM Page Object"] = 503,
    ["Ubuntu Server Autoinstall"] = 498,
    ["Uniswap Token List"] = 574,
    ["Unreal Engine Uplugin"] = 661,
    ["Unreal Engine Uproject"] = 662,
    Updatecli = 625,
    Uplift = 659,
    ["User Journey Map YAML Schema"] = 594,
    V2Ray = 629,
    ["VSCode Code Snippets"] = 131,
    ["VSIX CLI publishing"] = 516,
    ["Vela Pipeline Configuration"] = 506,
    Vercel = 130,
    ["Web App Manifest"] = 523,
    ["Web types"] = 526,
    WebExtensions = 522,
    ["Webman package recipe"] = 635,
    ["Windows Package Manager Installer Manifest"] = 571,
    ["Windows Package Manager Locale Manifest"] = 572,
    ["Windows Package Manager Singleton Manifest"] = 570,
    ["Woodpecker pipeline config"] = 606,
    ["Xstate Machine Schema"] = 623,
    ["Yippee-Ki-JSON configuration YML"] = 576,
    ["angular.json"] = 11,
    ...
    ["bamboo-spec"] = 59,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 667,
    ["bashly-strings.yml"] = 668,
    ["bashly.yml"] = 666,
    ["batect.yml"] = 58,
    ["beau.yml"] = 584,
    ...
    ["ize.toml"] = 658,
    ["jsconfig.json"] = 286,
    ["jscpd Configuration Schema"] = 640,
    jsdoc = 564,
    ["k3d.yaml"] = 287,
    ...
    ["semantic-release"] = 440,
    ["servicehub.config.json"] = 536,
    ["servicehub.service.json"] = 535,
    ["settings.job"] = 443,
    ["sfdx-hardis configuration"] = 445,
    ["size-limit configuration"] = 447,
    ["skaffold.yaml"] = 600,
    ["skyuxconfig.json"] = 449,
    snapcraft = 450,
    ["stripe-app-local.json"] = 464,
    ["stripe-app.json"] = 463,
    swcrc = 587,
    ["task.json"] = 470,
    taskcat = 556,
    ["template.json"] = 473,
    ["templatsources.json"] = 474,
    ["theme.json"] = 477,
    ["tizen_workspace.json"] = 478,
    tldr = 479,
    tmLanguage = 480,
    tmuxinator = 544,
    ["transcend.yml"] = 486,
    ["trunk.yaml schema"] = 487,
    ["ts-force-config.json"] = 491,
    ["tsconfig.json"] = 488,
    ["tsd.json"] = 489,
    ["tsdrc.json"] = 490,
    ["tslint.json"] = 492,
    ...
    ["vega-lite.json"] = 505,
    ["vega.json"] = 504,
    ["venvironment-basic.yaml"] = 508,
    ["venvironment.yaml"] = 507,
    ["version.json"] = 509,
    ["vim-addon-info"] = 510,
    ["vs-2017.3.host.json"] = 512,
    ["vs-nesting.json"] = 513,
    ["vsls.json"] = 511,
    ["vss-extension.json"] = 517,
    ["vtesttree.yaml"] = 518,
    ["vtestunit.yaml"] = 519,
    ["webhint.io"] = 636,
    ["webjobpublishsettings.json"] = 525,
    ["webjobs-list.json"] = 524,
    ["xs-app.json"] = 552,
    ["xunit.runner.json"] = 534,
    yamllint = 575,
    zuul = 561,
    ["Žinoma"] = 569
  },
