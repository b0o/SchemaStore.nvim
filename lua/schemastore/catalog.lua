...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 158,
    [".cryproj (generic)"] = 544,
    [".cryproj engine-5.2"] = 539,
    [".cryproj engine-5.3"] = 540,
    [".cryproj engine-5.4"] = 541,
    [".cryproj engine-5.5"] = 542,
    [".cryproj engine-dev"] = 543,
    [".csscomb.json"] = 160,
    [".csslintrc"] = 161,
    [".es6importsorterrc.json"] = 667,
    [".eslintrc"] = 206,
    [".esmrc.json"] = 198,
    [".ffizer.yaml"] = 210,
    [".htmlhintrc"] = 254,
    ...
    [".pmbot.yml"] = 375,
    [".postcssrc"] = 380,
    [".powerpages-web-template-manifest"] = 381,
    [".pre-commit-config.yml"] = 382,
    [".pre-commit-hooks.yml"] = 383,
    [".putout.json"] = 401,
    [".rehyperc"] = 410,
    [".remarkrc"] = 411,
    [".sprite files"] = 459,
    ...
    ["Azure Pipelines"] = 48,
    ["Azure Static Web Apps CLI configuration file"] = 461,
    ["Azure Static Web Apps configuration file"] = 460,
    ["BX CI"] = 83,
    ["Better Code Hub"] = 587,
    ["Better Scripts"] = 84,
    BizTalkServerApplicationSchema = 559,
    ...
    ["Butane Config"] = 626,
    ["CICS TS region tagging"] = 633,
    ["CICS TS resource import"] = 634,
    ["CICS TS resource model"] = 635,
    ["CICS TS resource overrides"] = 636,
    ["CMake Presets"] = 85,
    ...
    ["Datahub Ingestion Recipe Schema"] = 640,
    ...
    ["Embrace Config Schema"] = 651,
    ["Error pages"] = 201,
    Esquio = 199,
    ["Estuary Flow Catalog Schema"] = 630,
    ["Expo SDK"] = 204,
    ...
    Goreleaser = 236,
    ["Goreleaser Pro"] = 237,
    ["Gradle Build Cache Node"] = 584,
    ["Gradle Enterprise"] = 583,
    ...
    Hadolint = 568,
    Hammerkit = 594,
    ["Hardware Sentry Configuration"] = 644,
    Hayson = 249,
    ...
    ["JFrog File Spec"] = 273,
    ["JFrog Pipelines YML DSL"] = 653,
    ["JMeter DSL cli config schema"] = 274,
    JReleaser = 276,
    ["JSON Document Transform"] = 283,
    ["JSON Feed"] = 284,
    ["JSON Resume"] = 417,
    ["JSON Schema Draft 2020-12"] = 535,
    ["JSON Schema Draft 4"] = 532,
    ["JSON Schema Draft 7"] = 533,
    ["JSON Schema Draft 8"] = 534,
    ...
    ["KSP-CKAN"] = 531,
    Kas = 289,
    ["Keycloak REST API"] = 659,
    ["Knative Functions - func.yaml"] = 219,
    ["KoDE/CI build.yaml"] = 649,
    ["Kong DBLess Schema"] = 650,
    KrakenD = 290,
    LOOBin = 305,
    ["LinkML Metamodel"] = 303,
    Liquibase = 599,
    ["Liquibase Flow File"] = 600,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 648,
    ["Monika Configuration Schema"] = 646,
    ["Motif config"] = 552,
    ["NOX Framework (Service)"] = 347,
    ["Netin Diagnostic System Template"] = 609,
    ["Netlify config schema"] = 339,
    ["Nightwatch.js"] = 340,
    ["OSS Review Toolkit configuration"] = 365,
    ["OSS Review Toolkit curation"] = 366,
    ["OSS Review Toolkit package configuration"] = 367,
    ["OSS Review Toolkit repository configuration"] = 368,
    ["OSS Review Toolkit resolutions"] = 369,
    Opctl = 555,
    ["OpenRewrite Resource"] = 360,
    ["OpenWeather Current Weather API"] = 591,
    ["OpenWeather Road Risk API"] = 590,
    ["Ory Hydra configuration"] = 255,
    ["Ory Keto configuration"] = 292,
    ["Ory Kratos configuration"] = 364,
    ["Ory Oathkeeper configuration"] = 354,
    ["Outblocks App configuration"] = 362,
    ["Outblocks database table"] = 363,
    ["Outblocks project configuration"] = 361,
    Packer = 372,
    Pantsbuild = 665,
    ["Pipeline component"] = 601,
    ["PocketMine plugin.yml"] = 376,
    Pterodactyl = 643,
    ["Pull Request Labeler"] = 400,
    Pulumi = 405,
    PyProject = 406,
    Qodana = 619,
    ["Quali Torque Blueprint Spec 2"] = 641,
    ["QueryFirst config file"] = 662,
    ["RKE Cluster Configuration JSON Schema"] = 598,
    ["RKE Cluster Configuration YAML Schema"] = 597,
    ["Rancher Fleet"] = 403,
    Ray = 567,
    ["Read the Docs"] = 404,
    ["Red-DiscordBot Cog"] = 407,
    ["Red-DiscordBot Cog Repo"] = 408,
    ["Red-DiscordBot Trivia"] = 409,
    Renovate = 418,
    ["Replit schema"] = 412,
    RoadRunner = 419,
    Ruff = 415,
    ["Rust Project"] = 416,
    ["Rust toolchain"] = 421,
    ["SIL Kit Participant Configuration"] = 448,
    SWADL = 470,
    ["Sapphire CLI Config"] = 422,
    ["SauceCTL Configuration"] = 606,
    ["Schema Catalog"] = 435,
    ["Scoop manifest"] = 440,
    ["Semantic Data Fabric (SDF) file"] = 441,
    ["Semgrep Rule"] = 443,
    ["Serenity Code Generator (Sergen)"] = 444,
    ["Serverless Framework Configuration"] = 613,
    ["Serverless Workflow Schema"] = 615,
    ["Settings.paf"] = 446,
    ["Shopware 6 Configuration"] = 616,
    ["Shopware CLI Extension Store Configuration"] = 617,
    ["Shopware CLI Project Store Configuration"] = 618,
    ["Slack app manifest"] = 450,
    Solidarity = 453,
    ["Solution filters"] = 454,
    ["Source Maps v3"] = 455,
    Sourcery = 456,
    SpecIF = 457,
    ["Sponge Mixin configuration"] = 458,
    ["StackHawk Scanner Configuration"] = 612,
    Stale = 462,
    Starship = 463,
    ["Statamic Blueprint"] = 464,
    ["StrmPrivacy Data Connector"] = 657,
    ["StrmPrivacy Data Contract"] = 658,
    ["StrmPrivacy SimpleSchema"] = 655,
    ["StrmPrivacy Stream"] = 656,
    ["StrmPrivacy batch job configuration file"] = 654,
    ["Stryker Mutator"] = 467,
    ["StyleCop Analyzers Configuration"] = 468,
    ["Swagger API 2.0"] = 471,
    TSON = 495,
    ["Talisman configuration"] = 473,
    ["Taskfile YAML Schema"] = 593,
    Taurus = 474,
    ["TestEnvironment.json"] = 483,
    ["Tier.run pricing.json"] = 477,
    Tikibase = 478,
    ["Traefik v2"] = 486,
    ["Traefik v2 File Provider"] = 487,
    Turborepo = 484,
    Tye = 620,
    ["UI5 Manifest"] = 502,
    ["UTAM Page Object"] = 505,
    ["Ubuntu Server Autoinstall"] = 500,
    ["Uniswap Token List"] = 576,
    ["Unreal Engine Uplugin"] = 663,
    ["Unreal Engine Uproject"] = 664,
    Updatecli = 627,
    Uplift = 661,
    ["User Journey Map YAML Schema"] = 596,
    V2Ray = 631,
    ["VSCode Code Snippets"] = 131,
    ["VSIX CLI publishing"] = 518,
    ["Vela Pipeline Configuration"] = 508,
    Vercel = 130,
    ["Web App Manifest"] = 525,
    ["Web types"] = 528,
    WebExtensions = 524,
    ["Webman package recipe"] = 637,
    ["Windows Package Manager Installer Manifest"] = 573,
    ["Windows Package Manager Locale Manifest"] = 574,
    ["Windows Package Manager Singleton Manifest"] = 572,
    ["Woodpecker pipeline config"] = 608,
    ["Xstate Machine Schema"] = 625,
    ["Yippee-Ki-JSON configuration YML"] = 578,
    ["angular.json"] = 11,
    ...
    ["bamboo-spec"] = 59,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 669,
    ["bashly-strings.yml"] = 670,
    ["bashly.yml"] = 668,
    ["batect.yml"] = 58,
    ["beau.yml"] = 586,
    ...
    ["ize.toml"] = 660,
    ["jsconfig.json"] = 287,
    ["jscpd Configuration Schema"] = 642,
    jsdoc = 566,
    ["k3d.yaml"] = 288,
    ...
    ["openrpc.json"] = 358,
    ["package.json"] = 370,
    ["package.manifest"] = 371,
    ["pattern.json"] = 374,
    ["petstore-v1.0"] = 652,
    pgap_yaml_input_reader = 373,
    ["plagiarize-me.yaml"] = 378,
    ["plagiarize.yaml"] = 377,
    ["portman.json"] = 379,
    ["prettierrc.json"] = 385,
    ["prisma.yml"] = 386,
    ["project-1.0.0-beta3.json"] = 388,
    ["project-1.0.0-beta4.json"] = 389,
    ["project-1.0.0-beta5.json"] = 390,
    ["project-1.0.0-beta6.json"] = 391,
    ["project-1.0.0-beta8.json"] = 392,
    ["project-1.0.0-rc1.json"] = 393,
    ["project-1.0.0-rc2.json"] = 394,
    ["project.json"] = 387,
    ["prometheus.json"] = 395,
    ["prometheus.rules.json"] = 396,
    ["proxies.json"] = 397,
    ["publiccode.yml"] = 398,
    ["pubspec.yaml"] = 399,
    ["pyrseas-0.8.json"] = 402,
    ["release drafter"] = 562,
    rtx = 414,
    rustfmt = 420,
    ["sarif-1.0.0.json"] = 423,
    ["sarif-2.0.0.json"] = 424,
    ["sarif-2.1.0"] = 433,
    ["sarif-2.1.0-rtm.2"] = 425,
    ["sarif-2.1.0-rtm.3"] = 427,
    ["sarif-2.1.0-rtm.4"] = 429,
    ["sarif-2.1.0-rtm.5"] = 431,
    ["sarif-external-property-file-2.1.0"] = 434,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 426,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 428,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 430,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 432,
    ["schema.org - Action"] = 436,
    ["schema.org - ContactPoint"] = 437,
    ["schema.org - Place"] = 438,
    ["schema.org - Thing"] = 439,
    ["semantic-release"] = 442,
    ["servicehub.config.json"] = 538,
    ["servicehub.service.json"] = 537,
    ["settings.job"] = 445,
    ["sfdx-hardis configuration"] = 447,
    ["size-limit configuration"] = 449,
    ["skaffold.yaml"] = 602,
    ["skyuxconfig.json"] = 451,
    snapcraft = 452,
    ["stripe-app-local.json"] = 466,
    ["stripe-app.json"] = 465,
    swcrc = 589,
    ["task.json"] = 472,
    taskcat = 558,
    ["template.json"] = 475,
    ["templatsources.json"] = 476,
    ["theme.json"] = 479,
    ["tizen_workspace.json"] = 480,
    tldr = 481,
    tmLanguage = 482,
    tmuxinator = 546,
    ["transcend.yml"] = 488,
    ["trunk.yaml schema"] = 489,
    ["ts-force-config.json"] = 493,
    ["tsconfig.json"] = 490,
    ["tsd.json"] = 491,
    ["tsdrc.json"] = 492,
    ["tslint.json"] = 494,
    ...
    ["vega-lite.json"] = 507,
    ["vega.json"] = 506,
    ["venvironment-basic.yaml"] = 510,
    ["venvironment.yaml"] = 509,
    ["version.json"] = 511,
    ["vim-addon-info"] = 512,
    ["vs-2017.3.host.json"] = 514,
    ["vs-nesting.json"] = 515,
    ["vsls.json"] = 513,
    ["vss-extension.json"] = 519,
    ["vtesttree.yaml"] = 520,
    ["vtestunit.yaml"] = 521,
    ["webhint.io"] = 638,
    ["webjobpublishsettings.json"] = 527,
    ["webjobs-list.json"] = 526,
    ["xs-app.json"] = 554,
    ["xunit.runner.json"] = 536,
    yamllint = 577,
    zuul = 563,
    ["Žinoma"] = 571
  },
