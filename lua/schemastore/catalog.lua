...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 21,
    AIConfig = 22,
    ["AMX Muse Program Descriptor"] = 1099,
    ["API Builder"] = 910,
    ...
    Aider = 1128,
    Air = 18,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1149,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1148,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1147,
    ["Azure IoT Operations connector metadata"] = 1144,
    ...
    ["Azure Pipelines"] = 83,
    ["Azure Static Web Apps CLI configuration file"] = 755,
    ["Azure Static Web Apps configuration file"] = 754,
    ["BOSH CPI Config"] = 107,
    ...
    ["Bitmovin Encoding Template"] = 1092,
    BizTalkServerApplicationSchema = 882,
    Bleep = 129,
    ...
    ["Butane Config"] = 958,
    C4InterFlow = 1107,
    ["CDK Environment Manager, concrete environment configuration"] = 1131,
    ["CDK Environment Manager, concrete environments definition"] = 1130,
    ["CDK Environment Manager, environment definition"] = 1129,
    ...
    ["Chamaleon environment"] = 1096,
    ["Chamaleon properties"] = 1097,
    ["Chamaleon template"] = 1095,
    Changesets = 237,
    Changie = 139,
    Charmcraft = 140,
    Cheatsheets = 955,
    ...
    Conjure = 150,
    ["Container Structure Test"] = 896,
    Containerlab = 924,
    ["Contextive Glossary"] = 1123,
    Convex = 149,
    ...
    ["DonateCaseBetterCasino menu"] = 1100,
    ...
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1143,
    ["EasyVCR .NET"] = 314,
    ...
    ["Evolving Resolutive Process notation"] = 1145,
    ["Expo SDK"] = 312,
    ...
    ["Google Digital Assetlinks"] = 1124,
    Goreleaser = 374,
    ["Goreleaser Pro"] = 375,
    Goss = 376,
    ...
    ["JSON Feed"] = 438,
    ["JSON Resume"] = 668,
    ["JSON Schema Draft 2020-12"] = 860,
    ["JSON Schema Draft 4"] = 857,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1020,
    ["JSON Schema Draft 7"] = 858,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1021,
    ["JSON Schema Draft 8 (2019-09)"] = 859,
    ["JSON-API"] = 436,
    ...
    ["Power Pages Configuration"] = 1134,
    ...
    Ray = 891,
    ["Read the Docs"] = 639,
    ["Red-DiscordBot Cog"] = 655,
    ["Red-DiscordBot Cog Repo"] = 656,
    ["Red-DiscordBot Trivia"] = 657,
    ["Render Blueprints"] = 926,
    RenderCV = 670,
    Renovate = 669,
    ["Replit config"] = 663,
    Restate = 1112,
    ["Revel Digital Gadget Definition File"] = 1136,
    RoadRunner = 672,
    ["Robust Station Image"] = 1142,
    Rockcraft = 673,
    ["Roo Coder Custom Modes"] = 674,
    Rubocop = 665,
    ["Rudder techniques"] = 1033,
    Ruff = 666,
    ["Rust Project"] = 667,
    ["Rust toolchain"] = 678,
    ["SDMX data message"] = 704,
    ["SDMX metadata message"] = 703,
    ["SDMX structure message"] = 702,
    ["SIL Kit Participant Configuration"] = 714,
    ["SIL Kit Registry Configuration"] = 715,
    ["SPDX 2.3"] = 752,
    SWADL = 768,
    ["Safebox Config"] = 988,
    ["Sapphire CLI Config"] = 681,
    ["SauceCTL Configuration"] = 937,
    ["Schema Catalog"] = 696,
    ["Scoop manifest"] = 701,
    ["Semantic Data Fabric (SDF) file"] = 705,
    ["Semgrep Rule"] = 707,
    ["Serenity Code Generator (Sergen)"] = 708,
    ...
    ["Sigma Detection Rule"] = 712,
    ["Sigrid scope configuration file"] = 713,
    ["SkyPilot Task JSON"] = 1034,
    ["Slack app manifest"] = 717,
    Snapcraft = 719,
    Solidarity = 722,
    ["Solution filters"] = 723,
    ["Source Maps v3"] = 724,
    Sourcery = 725,
    ["Spack bootstrap.yaml"] = 726,
    ["Spack cdash.yaml"] = 727,
    ["Spack ci.yaml"] = 728,
    ["Spack compilers.yaml"] = 729,
    ["Spack concretizer.yaml"] = 730,
    ["Spack config.yaml"] = 731,
    ["Spack definitions.yaml"] = 732,
    ["Spack develop.yaml"] = 733,
    ["Spack env_vars.yaml"] = 734,
    ["Spack environment"] = 740,
    ["Spack include.yaml"] = 735,
    ["Spack mirrors.yaml"] = 736,
    ["Spack modules.yaml"] = 737,
    ["Spack packages.yaml"] = 738,
    ["Spack repos.yaml"] = 739,
    ["Spack toolchains.yaml"] = 741,
    ["Spack upstreams.yaml"] = 742,
    ["Spack view.yaml"] = 743,
    ["Speakeasy Generation Config File"] = 747,
    ["Speakeasy Lint Configuration File"] = 744,
    ["Speakeasy Test Generation Configuration File"] = 745,
    ["Speakeasy Workflow File"] = 746,
    SpecIF = 748,
    ["Specmatic Configuration"] = 749,
    ["Sponge Mixin configuration"] = 750,
    StackBlitz = 756,
    ...
    Starship = 759,
    ["Statamic Blueprint"] = 760,
    ["Stella configuration file"] = 761,
    ["Streamlit configuration file"] = 762,
    ["Stryker Mutator"] = 765,
    ["StyleCop Analyzers Configuration"] = 766,
    ["Stylelint (.stylelintrc)"] = 767,
    ["Stylua Config"] = 1126,
    ["Sublime Syntax"] = 989,
    ["Subsquid squid manifest"] = 1036,
    ["Swagger API 2.0"] = 769,
    ["Synadia Connect Component"] = 770,
    TSON = 805,
    TSTyche = 806,
    ["TYPO3 Vendor Bundler config"] = 811,
    ["Tab data for a LinUtil"] = 1083,
    ["Tab list for a LinUtil"] = 1082,
    Tach = 771,
    ["Tach Domain"] = 772,
    Talhelper = 774,
    ["Talisman configuration"] = 775,
    Taplo = 1127,
    ["Taskfile config"] = 921,
    Taurus = 776,
    Tauticord = 777,
    Telefonistka = 1113,
    ["Terrateam config"] = 1139,
    ["TestEnvironment.json"] = 788,
    ["TextMate Grammar"] = 787,
    Threagile = 783,
    ["Tier.run pricing.json"] = 780,
    Tikibase = 781,
    Tombi = 786,
    ["Traefik v2"] = 791,
    ["Traefik v2 File Provider"] = 792,
    ["Traefik v3"] = 793,
    ["Traefik v3 File Provider"] = 794,
    ["Travis CI (.travis.yml)"] = 790,
    Treefmt = 379,
    Trident = 1109,
    ["TrueScript for *.tscript files"] = 797,
    ["Tugboat QA config.yml"] = 1106,
    TunnelHub = 1024,
    Turborepo = 789,
    Tycho = 1072,
    Tye = 951,
    ["Tyk Gateway - Open Source v5.7+"] = 1118,
    ["Typst Manifest"] = 812,
    ["UET BuildConfig.json"] = 994,
    ["UI5 Manifest"] = 818,
    ["UNCORS configuration"] = 822,
    ["UTAM Page Object"] = 821,
    ["Ubuntu Server Autoinstall"] = 816,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1110,
    ["Uniswap Token List"] = 903,
    ["Universal Schedule Format"] = 823,
    ["Unreal Engine Uplugin"] = 995,
    ["Unreal Engine Uproject"] = 996,
    ["UpCloud CLI (upctl) configuration"] = 1111,
    ...
    ["VSIX CLI publishing"] = 841,
    Vector = 825,
    ["Vela Pipeline Configuration"] = 828,
    Vercel = 211,
    ["Version Bumper config"] = 831,
    ["Viash Component Config"] = 1115,
    ["Viash Package Config"] = 1116,
    Visivo = 1022,
    ["WP-CLI"] = 851,
    Wake = 1108,
    ["Waku Config"] = 1086,
    ["Web App Manifest"] = 847,
    ["Web types"] = 850,
    WebExtensions = 846,
    ["Webman package recipe"] = 971,
    ["Windows Package Manager Installer Manifest"] = 899,
    ["Windows Package Manager Locale Manifest"] = 900,
    ["Windows Package Manager Singleton Manifest"] = 898,
    Winutil = 901,
    ["WireMock CLI import configuration"] = 1091,
    ["WireMock CLI local service configuration"] = 1090,
    ...
    ["Yippee-Ki-JSON configuration YML"] = 905,
    ["YouTrack App"] = 1075,
    ["Zarf Package Configuration"] = 1141,
    ...
    ["crowdin.yml"] = 246,
    ["ctfd-setup configuration file"] = 1098,
    ...
    ["gematik health care insurance list"] = 1104,
    ["gematik health care patient list"] = 1101,
    ["gematik health care provider institution list"] = 1103,
    ["gematik health care provider list"] = 1102,
    ["gematik tiger test environment configuration"] = 1105,
    ["gitlab-ci"] = 354,
    ["global.json"] = 370,
    ...
    ["plagiarize.yaml"] = 594,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1094,
    ["podbard.yaml"] = 597,
    ["portman.json"] = 598,
    ["prefect.toml"] = 606,
    ["prettierrc.json"] = 607,
    ...
    ["release drafter"] = 886,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 659,
    ["release-please-manifest.json"] = 660,
    ["release-plz.toml"] = 661,
    ["renv.lock"] = 671,
    ["rivet.json"] = 1031,
    ...
    samt = 679,
    samtrc = 680,
    ["sarif-1.0.0.json"] = 682,
    ["sarif-2.0.0.json"] = 683,
    ["sarif-2.1.0"] = 693,
    ["sarif-2.1.0-rtm.2"] = 684,
    ["sarif-2.1.0-rtm.3"] = 686,
    ["sarif-2.1.0-rtm.4"] = 688,
    ["sarif-2.1.0-rtm.5"] = 690,
    ["sarif-2.1.0-rtm.6"] = 691,
    ["sarif-external-property-file-2.1.0"] = 694,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 685,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 687,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 689,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 692,
    ["scalingo.json configuration"] = 695,
    ["schema.org - Action"] = 697,
    ["schema.org - ContactPoint"] = 698,
    ["schema.org - Place"] = 699,
    ["schema.org - Thing"] = 700,
    ["secrethub.yml"] = 1009,
    ["semantic-release"] = 706,
    ["servicehub.config.json"] = 863,
    ["servicehub.service.json"] = 862,
    ["settings.job"] = 709,
    ["sfdx-hardis configuration"] = 711,
    ["shard.yml"] = 1047,
    ["size-limit configuration"] = 716,
    ["skaffold.yaml"] = 932,
    ["skyuxconfig.json"] = 718,
    ["snowflake-config"] = 720,
    ["snowflake-connections"] = 721,
    ["spicepod.yaml"] = 1067,
    ["sqlc configuration"] = 753,
    ["stripe-app-local.json"] = 764,
    ["stripe-app.json"] = 763,
    swcrc = 917,
    ["task.json"] = 773,
    taskcat = 881,
    ["template.json"] = 778,
    ["templatsources.json"] = 779,
    ["theme.json"] = 782,
    ["tizen_workspace.json"] = 784,
    tldr = 785,
    ["tm_devices configuration file"] = 1132,
    tmuxinator = 866,
    ["transcend.yml"] = 795,
    ["tree-sitter grammar.json"] = 378,
    ["trime.yaml"] = 796,
    ["trunk.yaml"] = 798,
    ["ts-force-config.json"] = 803,
    ["tsconfig.json"] = 799,
    ["tsd.json"] = 800,
    ["tsdoc.json"] = 801,
    ["tsdrc.json"] = 802,
    ...
    ["vega-lite.json"] = 827,
    ["vega.json"] = 826,
    ["venvironment.yaml"] = 829,
    ["venvplus.yaml"] = 830,
    version = 1114,
    ["version.json"] = 832,
    ["vhwdebugger-binding.yaml"] = 834,
    ["vim-addon-info"] = 835,
    ["vs-2017.3.host.json"] = 837,
    ["vs-nesting.json"] = 838,
    ["vsls.json"] = 836,
    ["vss-extension.json"] = 842,
    vtcfg = 1120,
    ["vtesttree.yaml"] = 843,
    ["vtestunit.yaml"] = 844,
    ...
    ["webhint.io"] = 972,
    ["webjobpublishsettings.json"] = 849,
    ["webjobs-list.json"] = 848,
    ["well-known-fursona"] = 1054,
    ["xs-app.json"] = 876,
    ["xunit.runner.json"] = 861,
    yamllint = 904,
    zuul = 887,
    ["Žinoma"] = 897
  },
