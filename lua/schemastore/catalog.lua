...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 188,
    [".cryproj (generic)"] = 641,
    [".cryproj engine-5.2"] = 636,
    [".cryproj engine-5.3"] = 637,
    [".cryproj engine-5.4"] = 638,
    [".cryproj engine-5.5"] = 639,
    [".cryproj engine-dev"] = 640,
    [".csscomb.json"] = 190,
    [".csslintrc"] = 191,
    [".es6importsorterrc.json"] = 776,
    [".eslintrc"] = 241,
    [".esmrc.json"] = 233,
    [".ffizer.yaml"] = 246,
    [".htmlhintrc"] = 302,
    ...
    [".mtaext"] = 652,
    [".nodehawkrc"] = 407,
    [".npmpackagejsonlintrc"] = 410,
    [".phraseapp.yml"] = 458,
    [".pmbot.yml"] = 446,
    [".postcssrc"] = 453,
    [".powerpages-web-template-manifest"] = 455,
    [".pre-commit-config.yml"] = 456,
    [".pre-commit-hooks.yml"] = 457,
    [".putout.json"] = 477,
    [".rehyperc"] = 490,
    [".remarkrc"] = 492,
    [".sprite files"] = 548,
    ...
    ["Better Scripts"] = 102,
    Bigconfig = 82,
    BizTalkServerApplicationSchema = 658,
    Bleep = 103,
    ...
    ["Dart build configuration"] = 192,
    ["Dart test config"] = 193,
    ...
    ["Frogbot Config"] = 71,
    ["Fusion resource pack metadata"] = 261,
    ["Fusion texture metadata"] = 262,
    ...
    ["GitHub Funding"] = 272,
    ["GitHub Issue Template configuration"] = 274,
    ["GitHub Workflow"] = 275,
    ["GitHub Workflow Template Properties"] = 276,
    ["GitHub issue forms"] = 273,
    GitVersion = 269,
    ["Gitpod Configuration"] = 278,
    ...
    ["Goreleaser Pro"] = 284,
    Goss = 285,
    ["Gradle Build Cache Node"] = 686,
    ["Gradle Enterprise"] = 685,
    ...
    ["JSON Feed"] = 333,
    ["JSON Resume"] = 497,
    ["JSON Schema Draft 2020-12"] = 632,
    ["JSON Schema Draft 4"] = 629,
    ["JSON Schema Draft 7"] = 630,
    ["JSON Schema Draft 7 (unofficial strict)"] = 797,
    ["JSON Schema Draft 8 (2019-09)"] = 631,
    ["JSON-API"] = 331,
    ["JSON-e templates"] = 693,
    ["JSON-stat 2.0"] = 626,
    JSONPatch = 335,
    Jasmine = 315,
    Jekyll = 316,
    ...
    Liquibase = 700,
    ["Liquibase Flow File"] = 701,
    ["Lively Properties"] = 359,
    ["Lobe AI Agent"] = 64,
    ["MLOS Configs"] = 392,
    ["MS2Rescore Configuration"] = 394,
    Markdownlint = 704,
    ["Mason Registry"] = 706,
    ...
    ["Microsoft Band Web Tile"] = 370,
    ["Minecraft Custom Main Menu Mod"] = 804,
    ["Minecraft Data Pack Advancement"] = 372,
    ["Minecraft Data Pack Biome"] = 373,
    ["Minecraft Data Pack Configured Carver"] = 374,
    ["Minecraft Data Pack Damage Type"] = 375,
    ["Minecraft Data Pack Dimension"] = 377,
    ["Minecraft Data Pack Dimension Type"] = 376,
    ["Minecraft Data Pack Item Modifier"] = 378,
    ["Minecraft Data Pack Loot Table"] = 379,
    ["Minecraft Data Pack Metadata"] = 380,
    ["Minecraft Data Pack Predicate"] = 381,
    ["Minecraft Data Pack Recipe"] = 382,
    ["Minecraft Data Pack Tag"] = 383,
    ["Minecraft Data Pack Template Pool"] = 384,
    ["Minecraft Data Pack Trim Material"] = 389,
    ["Minecraft Data Pack Trim Pattern"] = 390,
    ["Minecraft Resource Pack Lang"] = 385,
    ["Minecraft Resource Pack Particle"] = 386,
    ["Minecraft Resource Pack Texture Mcmeta"] = 388,
    ["Minecraft Resourcepack Sounds"] = 387,
    ["MkDocs Configuration 1.0"] = 391,
    ["MongoDB Atlas Search Index Definition"] = 754,
    ["Monika Configuration"] = 752,
    ["Motif config"] = 651,
    ["NOX Framework (Service)"] = 409,
    ["Netin Diagnostic System Template"] = 710,
    ["Netlify config"] = 400,
    ["Network-as-Code Data Model"] = 401,
    ["Nightwatch.js"] = 402,
    ["ONe's changelog entry"] = 425,
    ["ONe's service descriptor"] = 424,
    ["OSS Review Toolkit configuration"] = 432,
    ["OSS Review Toolkit curation"] = 433,
    ["OSS Review Toolkit package configuration"] = 434,
    ["OSS Review Toolkit repository configuration"] = 435,
    ["OSS Review Toolkit resolutions"] = 436,
    Opctl = 654,
    ["OpenRewrite Resource"] = 427,
    ["OpenUtau character yaml"] = 421,
    ["OpenUtau ustx"] = 422,
    ["OpenWeather Current Weather API"] = 692,
    ["OpenWeather Road Risk API"] = 691,
    ["Ory Hydra configuration"] = 303,
    ["Ory Keto configuration"] = 343,
    ["Ory Kratos configuration"] = 431,
    ["Ory Oathkeeper configuration"] = 416,
    ["Outblocks App configuration"] = 429,
    ["Outblocks database table"] = 430,
    ["Outblocks project configuration"] = 428,
    PDM = 442,
    ["PDM Partial"] = 443,
    Packer = 439,
    Pantsbuild = 774,
    ["Paper paper-plugin.yml"] = 440,
    ["Partial-Setuptools"] = 532,
    ["Partial-poetry"] = 449,
    ["Pipeline component"] = 702,
    ["PocketMine plugin.yml"] = 447,
    Poetry = 448,
    ["Postman collection"] = 454,
    ["Problem object RFC9457"] = 801,
    ["Problem package generators"] = 461,
    Pterodactyl = 749,
    ["Pull Request Labeler"] = 476,
    Pulumi = 482,
    PyProject = 483,
    Pyright = 484,
    ["Pyright Partial"] = 485,
    ...
    ["RKE Cluster Configuration JSON"] = 699,
    ["RKE Cluster Configuration YAML"] = 698,
    ["Rancher Fleet"] = 479,
    Ray = 666,
    ["Read the Docs"] = 481,
    ...
    SWADL = 562,
    ["Safebox Config"] = 760,
    ["Sapphire CLI Config"] = 505,
    ["SauceCTL Configuration"] = 707,
    ["Schema Catalog"] = 519,
    ["Scoop manifest"] = 524,
    ["Semantic Data Fabric (SDF) file"] = 525,
    ["Semgrep Rule"] = 527,
    ["Serenity Code Generator (Sergen)"] = 528,
    ...
    ["Windows Package Manager Installer Manifest"] = 674,
    ["Windows Package Manager Locale Manifest"] = 675,
    ["Windows Package Manager Singleton Manifest"] = 673,
    ["Woodpecker pipeline config"] = 709,
    ["Xstate Machine"] = 729,
    ["Yippee-Ki-JSON configuration YML"] = 679,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 16,
    apko = 802,
    ...
    ["ecosystem.json"] = 231,
    eksctl = 232,
    ["electron-builder configuration file"] = 237,
    ["epr-manifest.json"] = 235,
    ["evcc.yaml"] = 238,
    ["ezd task runner"] = 240,
    ["fabric.mod.json"] = 244,
    ...
    ["gitlab-ci"] = 277,
    ["global.json"] = 279,
    ["go-feature-flag Flag Configuration"] = 281,
    ["golangci-lint Configuration"] = 280,
    ["haxelib.json"] = 296,
    helmfile = 669,
    helmwave = 670,
    ["host-meta.json"] = 301,
    ...
    ["mycode.json"] = 397,
    mypy = 398,
    ["napari plugin manifest"] = 399,
    neoload = 660,
    ["nest-cli"] = 405,
    ["ninjs (News in JSON) 1.3"] = 404,
    ["ninjs (News in JSON) 2.0"] = 403,
    ...
    ["nswag.json"] = 414,
    ntangle = 415,
    ["nuclei-template.yaml"] = 412,
    ["nuget-project.json"] = 413,
    ["ocelot.json"] = 417,
    ["omnisharp.json"] = 418,
    ["openapi.json"] = 419,
    ["openfin.json"] = 426,
    ...
    ["ops.yaml"] = 423,
    ["package.json"] = 437,
    ["package.manifest"] = 438,
    ["partial-cibuildwheel"] = 113,
    ["partial-scikit-build"] = 714,
    ["pathfinder.yml"] = 441,
    ["pattern.json"] = 445,
    ["petstore-v1.0"] = 758,
    pgap_yaml_input_reader = 444,
    ["plagiarize-me.yaml"] = 451,
    ["plagiarize.yaml"] = 450,
    ["portman.json"] = 452,
    ["prettierrc.json"] = 459,
    ["prisma.yml"] = 460,
    ["project-1.0.0-beta3.json"] = 463,
    ["project-1.0.0-beta4.json"] = 464,
    ["project-1.0.0-beta5.json"] = 465,
    ["project-1.0.0-beta6.json"] = 466,
    ["project-1.0.0-beta8.json"] = 467,
    ["project-1.0.0-rc1.json"] = 468,
    ["project-1.0.0-rc2.json"] = 469,
    ["project.json"] = 462,
    ["prometheus.json"] = 470,
    ["prometheus.rules.json"] = 471,
    ["prometheus.rules.test.json"] = 472,
    ["proxies.json"] = 473,
    ["publiccode.yml"] = 474,
    ["pubspec.yaml"] = 475,
    ["pyrseas-0.8.json"] = 478,
    ["quilt.mod.json"] = 784,
    ["release drafter"] = 661,
    ...
    samt = 503,
    samtrc = 504,
    ["sarif-1.0.0.json"] = 506,
    ["sarif-2.0.0.json"] = 507,
    ["sarif-2.1.0"] = 517,
    ["sarif-2.1.0-rtm.2"] = 508,
    ["sarif-2.1.0-rtm.3"] = 510,
    ["sarif-2.1.0-rtm.4"] = 512,
    ["sarif-2.1.0-rtm.5"] = 514,
    ["sarif-2.1.0-rtm.6"] = 515,
    ["sarif-external-property-file-2.1.0"] = 518,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 509,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 511,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 513,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 516,
    ["schema.org - Action"] = 520,
    ["schema.org - ContactPoint"] = 521,
    ["schema.org - Place"] = 522,
    ["schema.org - Thing"] = 523,
    ["scikit-build"] = 713,
    ["secrethub.yml"] = 786,
    ["semantic-release"] = 526,
    ["servicehub.config.json"] = 635,
    ["servicehub.service.json"] = 634,
    ["settings.job"] = 529,
