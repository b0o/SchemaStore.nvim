...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 167,
    [".cryproj (generic)"] = 578,
    [".cryproj engine-5.2"] = 573,
    [".cryproj engine-5.3"] = 574,
    [".cryproj engine-5.4"] = 575,
    [".cryproj engine-5.5"] = 576,
    [".cryproj engine-dev"] = 577,
    [".csscomb.json"] = 169,
    [".csslintrc"] = 170,
    [".es6importsorterrc.json"] = 705,
    [".eslintrc"] = 218,
    [".esmrc.json"] = 210,
    [".ffizer.yaml"] = 222,
    [".htmlhintrc"] = 270,
    ...
    [".pmbot.yml"] = 399,
    [".postcssrc"] = 404,
    [".powerpages-web-template-manifest"] = 406,
    [".pre-commit-config.yml"] = 407,
    [".pre-commit-hooks.yml"] = 408,
    [".putout.json"] = 427,
    [".rehyperc"] = 438,
    [".remarkrc"] = 439,
    [".sprite files"] = 492,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration Schema"] = 650,
    ["All Contributors configuration file"] = 704,
    ...
    ["Azure Pipelines"] = 54,
    ["Azure Static Web Apps CLI configuration file"] = 494,
    ["Azure Static Web Apps configuration file"] = 493,
    ["BX CI"] = 89,
    ["Better Code Hub"] = 623,
    ["Better Scripts"] = 90,
    BizTalkServerApplicationSchema = 593,
    ...
    ["Butane Config"] = 662,
    ["CICS TS region tagging"] = 669,
    ["CICS TS resource import"] = 670,
    ["CICS TS resource model"] = 671,
    ["CICS TS resource overrides"] = 672,
    ["CMake Presets"] = 91,
    ...
    ["Datahub Ingestion Recipe Schema"] = 676,
    ...
    ["Embrace Config Schema"] = 687,
    ["Error pages"] = 213,
    Esquio = 211,
    ["Estuary Flow Catalog Schema"] = 666,
    ["Expo SDK"] = 216,
    ...
    ["Goreleaser Pro"] = 252,
    Goss = 253,
    ["Gradle Build Cache Node"] = 620,
    ["Gradle Enterprise"] = 619,
    ...
    Hadolint = 602,
    Hammerkit = 630,
    ["Hardware Sentry Configuration"] = 680,
    Hayson = 265,
    ...
    ["JFrog File Spec"] = 289,
    ["JFrog Pipelines YML DSL"] = 689,
    ["JMeter DSL cli config schema"] = 290,
    JReleaser = 292,
    ["JSON Document Transform"] = 299,
    ["JSON Feed"] = 300,
    ["JSON Resume"] = 445,
    ["JSON Schema Draft 2020-12"] = 569,
    ["JSON Schema Draft 4"] = 566,
    ["JSON Schema Draft 7"] = 567,
    ["JSON Schema Draft 8"] = 568,
    ...
    Kas = 305,
    ["Keycloak REST API"] = 696,
    ["Knative Functions - func.yaml"] = 233,
    ["KoDE/CI build.yaml"] = 685,
    ["Kong DBLess Schema"] = 686,
    KrakenD = 306,
    LOOBin = 323,
    Lefthook = 314,
    ["LinkML Metamodel"] = 321,
    Liquibase = 635,
    ["Liquibase Flow File"] = 636,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 684,
    ["Monika Configuration Schema"] = 682,
    ["Motif config"] = 586,
    ["NOX Framework (Service)"] = 368,
    ["Netin Diagnostic System Template"] = 645,
    ...
    ["OpenWeather Current Weather API"] = 627,
    ["OpenWeather Road Risk API"] = 626,
    ...
    ["Pipeline component"] = 637,
    ["PocketMine plugin.yml"] = 400,
    ["Postman collection"] = 405,
    Pterodactyl = 679,
    ["Pull Request Labeler"] = 426,
    Pulumi = 432,
    PyProject = 433,
    Pyright = 434,
    Qodana = 655,
    ["Quali Torque Blueprint Spec 2"] = 677,
    ["QueryFirst config file"] = 699,
    ["RKE Cluster Configuration JSON Schema"] = 634,
    ["RKE Cluster Configuration YAML Schema"] = 633,
    ["Rancher Fleet"] = 429,
    Ray = 601,
    ["Read the Docs"] = 431,
    ["Red-DiscordBot Cog"] = 435,
    ["Red-DiscordBot Cog Repo"] = 436,
    ["Red-DiscordBot Trivia"] = 437,
    Renovate = 446,
    ["Replit schema"] = 440,
    RoadRunner = 447,
    Ruff = 443,
    ["Rust Project"] = 444,
    ["Rust toolchain"] = 449,
    ["SIL Kit Participant Configuration"] = 480,
    ["SIL Kit Registry Configuration"] = 481,
    SWADL = 503,
    ["Safebox Config Schema"] = 690,
    ["Sapphire CLI Config"] = 452,
    ["SauceCTL Configuration"] = 642,
    ["Schema Catalog"] = 466,
    ["Scoop manifest"] = 471,
    ["Semantic Data Fabric (SDF) file"] = 472,
    ["Semgrep Rule"] = 474,
    ["Serenity Code Generator (Sergen)"] = 475,
    ["Serverless Framework Configuration"] = 649,
    ["Serverless Workflow Schema"] = 651,
    ["Settings.paf"] = 477,
    ["Shopware 6 Configuration"] = 652,
    ["Shopware CLI Extension Store Configuration"] = 653,
    ["Shopware CLI Project Store Configuration"] = 654,
    ["Sigrid scope configuration file"] = 479,
    ["Slack app manifest"] = 483,
    Solidarity = 486,
    ["Solution filters"] = 487,
    ["Source Maps v3"] = 488,
    Sourcery = 489,
    SpecIF = 490,
    ["Sponge Mixin configuration"] = 491,
    ["StackHawk Scanner Configuration"] = 648,
    Stale = 495,
    Starship = 496,
    ["Statamic Blueprint"] = 497,
    ["StrmPrivacy Data Connector"] = 694,
    ["StrmPrivacy Data Contract"] = 695,
    ["StrmPrivacy SimpleSchema"] = 692,
    ["StrmPrivacy Stream"] = 693,
    ["StrmPrivacy batch job configuration file"] = 691,
    ["Stryker Mutator"] = 500,
    ["StyleCop Analyzers Configuration"] = 501,
    ["Swagger API 2.0"] = 504,
    TSON = 529,
    ["Talisman configuration"] = 506,
    ["Taskfile YAML Schema"] = 629,
    Taurus = 507,
    ["TestEnvironment.json"] = 516,
    ["Tier.run pricing.json"] = 510,
    Tikibase = 511,
    ["Traefik v2"] = 519,
    ["Traefik v2 File Provider"] = 520,
    Turborepo = 517,
    Tye = 656,
    ["UET BuildConfig.json"] = 700,
    ["UI5 Manifest"] = 536,
    ["UTAM Page Object"] = 539,
    ["Ubuntu Server Autoinstall"] = 534,
    ["Uniswap Token List"] = 611,
    ["Unreal Engine Uplugin"] = 701,
    ["Unreal Engine Uproject"] = 702,
    Updatecli = 663,
    Uplift = 698,
    ["User Journey Map YAML Schema"] = 632,
    V2Ray = 667,
    ["VSCode Code Snippets"] = 138,
    ["VSIX CLI publishing"] = 552,
    ["Vela Pipeline Configuration"] = 542,
    Vercel = 137,
    ["Web App Manifest"] = 559,
    ["Web types"] = 562,
    WebExtensions = 558,
    ["Webman package recipe"] = 673,
    ["Windows Package Manager Installer Manifest"] = 608,
    ["Windows Package Manager Locale Manifest"] = 609,
    ["Windows Package Manager Singleton Manifest"] = 607,
    ["Woodpecker pipeline config"] = 644,
    ["Xstate Machine Schema"] = 661,
    ["Yippee-Ki-JSON configuration YML"] = 613,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 65,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 709,
    ["bashly-strings.yml"] = 710,
    ["bashly.yml"] = 708,
    ["batect.yml"] = 64,
    ["beau.yml"] = 622,
    ...
    ["ize.toml"] = 697,
    ["jsconfig.json"] = 303,
    ["jscpd Configuration Schema"] = 678,
    jsdoc = 600,
    ["k3d.yaml"] = 304,
    ...
    ["lsdlschema.json"] = 327,
    ["madness.yml"] = 707,
    ["markdown-lint-check"] = 640,
    mboats = 647,
    ["micro-settings.json"] = 712,
    ["mimetypes.json"] = 334,
    ["mirrord-schema"] = 583,
    ["mta.yaml"] = 584,
    ["mtad.yaml"] = 585,
    ...
    ["pattern.json"] = 398,
    ["petstore-v1.0"] = 688,
    pgap_yaml_input_reader = 397,
    ["plagiarize-me.yaml"] = 402,
    ["plagiarize.yaml"] = 401,
    ["portman.json"] = 403,
    ["prettierrc.json"] = 410,
    ["prisma.yml"] = 411,
    ["project-1.0.0-beta3.json"] = 413,
    ["project-1.0.0-beta4.json"] = 414,
    ["project-1.0.0-beta5.json"] = 415,
    ["project-1.0.0-beta6.json"] = 416,
    ["project-1.0.0-beta8.json"] = 417,
    ["project-1.0.0-rc1.json"] = 418,
    ["project-1.0.0-rc2.json"] = 419,
    ["project.json"] = 412,
    ["prometheus.json"] = 420,
    ["prometheus.rules.json"] = 421,
    ["prometheus.rules.test.json"] = 422,
    ["proxies.json"] = 423,
    ["publiccode.yml"] = 424,
    ["pubspec.yaml"] = 425,
    ["pyrseas-0.8.json"] = 428,
    ["quilt.mod.json"] = 713,
    ["release drafter"] = 596,
    rtx = 442,
    rustfmt = 448,
    samt = 450,
    samtrc = 451,
    ["sarif-1.0.0.json"] = 453,
    ["sarif-2.0.0.json"] = 454,
    ["sarif-2.1.0"] = 464,
    ["sarif-2.1.0-rtm.2"] = 455,
    ["sarif-2.1.0-rtm.3"] = 457,
    ["sarif-2.1.0-rtm.4"] = 459,
    ["sarif-2.1.0-rtm.5"] = 461,
    ["sarif-2.1.0-rtm.6"] = 462,
    ["sarif-external-property-file-2.1.0"] = 465,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 456,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 458,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 460,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 463,
    ["schema.org - Action"] = 467,
    ["schema.org - ContactPoint"] = 468,
    ["schema.org - Place"] = 469,
    ["schema.org - Thing"] = 470,
    ["secrethub.yml"] = 715,
    ["semantic-release"] = 473,
    ["servicehub.config.json"] = 572,
    ["servicehub.service.json"] = 571,
    ["settings.job"] = 476,
    ["sfdx-hardis configuration"] = 478,
    ["size-limit configuration"] = 482,
    ["skaffold.yaml"] = 638,
    ["skyuxconfig.json"] = 484,
    snapcraft = 485,
    ["stripe-app-local.json"] = 499,
    ["stripe-app.json"] = 498,
    swcrc = 625,
    syntax = 717,
    ["task.json"] = 505,
    taskcat = 592,
    ["template.json"] = 508,
    ["templatsources.json"] = 509,
    ["theme.json"] = 512,
    ["tizen_workspace.json"] = 513,
    tldr = 514,
    tmLanguage = 515,
    tmuxinator = 580,
    ["transcend-pathfinder.yml"] = 522,
    ["transcend.yml"] = 521,
    ["trunk.yaml schema"] = 523,
    ["ts-force-config.json"] = 527,
    ["tsconfig.json"] = 524,
    ["tsd.json"] = 525,
    ["tsdrc.json"] = 526,
    ["tslint.json"] = 528,
    ...
    ["vega-lite.json"] = 541,
    ["vega.json"] = 540,
    ["venvironment-basic.yaml"] = 544,
    ["venvironment.yaml"] = 543,
    ["version.json"] = 545,
    ["vim-addon-info"] = 546,
    ["vs-2017.3.host.json"] = 548,
    ["vs-nesting.json"] = 549,
    ["vsls.json"] = 547,
    ["vss-extension.json"] = 553,
    ["vtesttree.yaml"] = 554,
    ["vtestunit.yaml"] = 555,
    ["webhint.io"] = 674,
    ["webjobpublishsettings.json"] = 561,
    ["webjobs-list.json"] = 560,
    ["xs-app.json"] = 588,
    ["xunit.runner.json"] = 570,
    yamllint = 612,
    zuul = 597,
    ["Žinoma"] = 606
  },
