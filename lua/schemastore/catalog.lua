...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 899,
    [".nodehawkrc"] = 555,
    [".npmpackagejsonlintrc"] = 559,
    [".omletrc"] = 1077,
    [".phrase.yml"] = 628,
    [".phraseapp.yml"] = 629,
    [".pmbot.yml"] = 614,
    [".postcssrc"] = 623,
    [".powerpages-web-template-manifest"] = 625,
    [".pre-commit-config.yml"] = 626,
    [".pre-commit-hooks.yml"] = 627,
    [".putout.json"] = 657,
    [".rehyperc"] = 682,
    [".remarkrc"] = 686,
    [".sprite files"] = 775,
    ...
    ["A micro editor config"] = 503,
    ABCInventoryModuleData = 20,
    ABCSupplyPlan = 21,
    ["ACP Cache File"] = 22,
    ["ACP Configuration File"] = 23,
    ["ACP Variables File"] = 24,
    AIConfig = 25,
    ["AMX Muse Program Descriptor"] = 1124,
    ["API Builder"] = 934,
    ["AVA Configuration"] = 997,
    ["AWS AppConfig Feature Flags-v1"] = 57,
    ["AWS CDK cdk.json"] = 240,
    ["AWS CloudFormation"] = 241,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 242,
    ["AWS Copilot Manifest"] = 1163,
    ["AWS SAM CLI Samconfig"] = 243,
    ["Adobe UXP Manifest"] = 1060,
    ["Aerleon Network & Service Definitions"] = 15,
    ["Aerleon Policy"] = 16,
    Aider = 1153,
    Air = 18,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1174,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1173,
    ["Airlock Microgateway"] = 26,
    ["Alacritty Configuration"] = 969,
    ["All Contributors configuration file"] = 1023,
    ["Ansible Argument Specs"] = 375,
    ["Ansible Collection Galaxy"] = 382,
    ["Ansible Execution Environment"] = 372,
    ["Ansible Inventory"] = 381,
    ["Ansible Meta"] = 373,
    ["Ansible Meta Runtime"] = 374,
    ["Ansible Navigator Configuration"] = 384,
    ["Ansible Playbook"] = 379,
    ["Ansible Requirements"] = 376,
    ["Ansible Rulebook"] = 380,
    ["Ansible Tasks File"] = 378,
    ["Ansible Vars File"] = 377,
    ["Ansible-lint Configuration"] = 383,
    Any = 1087,
    ["AnyWork Automation Configuration"] = 11,
    ["Apollo Router"] = 935,
    ["App config Spotify Backstage"] = 30,
    ["Application Accelerator"] = 8,
    ["Application list for a WinUtil"] = 1104,
    ArchitectFX = 1109,
    ["Argo CD"] = 44,
    ["Argo Events"] = 45,
    ["Argo Workflows"] = 46,
    AssemblyScript = 49,
    AsyncAPI = 52,
    ["AsyncAPI Tool File"] = 53,
    ["Atmos Manifests"] = 54,
    ["Aurora Agile Meta-Framework"] = 55,
    AutoAPICase = 1033,
    ["Avro Avsc"] = 56,
    ["Azure Container App template for defining an immutable revision"] = 58,
    ["Azure DevOps extension manifest"] = 61,
    ["Azure Device Update for IoT Hub import manifest"] = 59,
    ["Azure Device Update for IoT Hub update manifest"] = 60,
    ["Azure IoT Edge deployment"] = 64,
    ["Azure IoT Edge deployment template"] = 65,
    ["Azure IoT EdgeAgent deployment"] = 62,
    ["Azure IoT EdgeHub deployment"] = 63,
    ["Azure IoT Operations Wasm Graph Config"] = 1172,
    ["Azure IoT Operations connector metadata"] = 1169,
    ["Azure Landing Zones Library archetype definition"] = 69,
    ["Azure Landing Zones Library archetype override"] = 70,
    ["Azure Landing Zones Library architecture definition"] = 68,
    ["Azure Landing Zones Library metadata"] = 66,
    ["Azure Landing Zones Library policy default values"] = 67,
    ["Azure Pipelines"] = 98,
    ["Azure Static Web Apps CLI configuration file"] = 779,
    ["Azure Static Web Apps configuration file"] = 778,
    ["BOSH CPI Config"] = 122,
    ["BOSH Deploy Config"] = 123,
    ["BX CI"] = 142,
    ["Bacon config"] = 2,
    ["Bashly (bashly.yml)"] = 1027,
    ["Bashly Settings (bashly-settings.yml)"] = 1028,
    ["Better Code Hub"] = 939,
    ["Better Scripts"] = 143,
    Bigconfig = 115,
    ["Biome Formatter Config"] = 71,
    ["Bitmovin Encoding Template"] = 1117,
    BizTalkServerApplicationSchema = 906,
    Bleep = 144,
    ["Block Protocol Metadata"] = 141,
    ["Boyka Framework"] = 124,
    Briefcase = 912,
    ["Build Info"] = 132,
    Buildkite = 134,
    ["Bukkit plugin.yml"] = 133,
    ["BungeeCord plugin.yml"] = 139,
    ["Butane Config"] = 982,
    C4InterFlow = 1132,
    ["CDK Environment Manager, concrete environment configuration"] = 1156,
    ["CDK Environment Manager, concrete environments definition"] = 1155,
    ["CDK Environment Manager, environment definition"] = 1154,
    ["CGS Card Game Specification (cgs.json)"] = 1065,
    ["CICS TS region tagging"] = 991,
    ["CICS TS resource import"] = 992,
    ["CICS TS resource model"] = 993,
    ["CICS TS resource overrides"] = 994,
    ["CMake Presets"] = 145,
    ["CNC Codes"] = 166,
    ["CRS WAF test file"] = 1094,
    ["CRS WAF test platform overrides file"] = 1095,
    ["CSS Comb (.csscomb.json)"] = 268,
    ["CSS Lint (.csslintrc)"] = 269,
    ["CSpell (cspell.json)"] = 267,
    ["CVE Record Format"] = 174,
    CWL = 1071,
    ["Cache Warmup config"] = 146,
    ["Calqulus pipeline"] = 147,
    ["Camel YAML DSL"] = 148,
    ["Cannon TOML"] = 149,
    Carafe = 150,
    ["Cargo Make"] = 152,
    ["Cargo Manifest"] = 151,
    ["Catalog Info Backstage"] = 153,
    ["Chamaleon environment"] = 1121,
    ["Chamaleon properties"] = 1122,
    ["Chamaleon template"] = 1120,
    Changesets = 252,
    Changie = 154,
    Charmcraft = 155,
    Cheatsheets = 979,
    ["ChordPro Configuration"] = 156,
    ["Chrome Extension"] = 233,
    ["Chromia Model"] = 157,
    ["Chromia Seeder Module Config"] = 159,
    ["Chromia Seeder Root Config"] = 158,
    ["Cinnamon Spice info.json"] = 78,
    ["CircleCI config.yml"] = 209,
    ["Citation File Format"] = 254,
    CityJSON = 161,
    ["Claude Code Settings"] = 173,
    ["Clawject config"] = 172,
    ["Cloud Foundry Application Manifest"] = 1076,
    ["Cloud Run Spec v1"] = 1099,
    ["Cloud.gov Workshop Configuration"] = 79,
    ["CloudCannon Configuration"] = 84,
    ["CloudCannon Configuration (Collection Structures)"] = 93,
    ["CloudCannon Configuration (Collections)"] = 92,
    ["CloudCannon Configuration (Editables)"] = 91,
    ["CloudCannon Configuration (Inputs)"] = 86,
    ["CloudCannon Configuration (Snippets Definitions)"] = 90,
    ["CloudCannon Configuration (Snippets Imports)"] = 89,
    ["CloudCannon Configuration (Snippets)"] = 88,
    ["CloudCannon Configuration (Structure Value)"] = 87,
    ["CloudCannon Configuration (Structures)"] = 85,
    ["CloudEvents specification"] = 162,
    ["Code Climate"] = 210,
    CodeCV = 82,
    CodeRabbit = 81,
    ["CodeShip Pro services configuration files"] = 222,
    ["CodeShip Pro steps configuration files"] = 223,
    ["Codecov configuration files"] = 221,
    CodifyCLI = 83,
    Codux = 219,
    ["Cog config file"] = 167,
    ["Commandbox Box.json"] = 168,
    ["Commandbox Server.json"] = 169,
    ["Common Catalog Data"] = 231,
    ["Common Package Specification"] = 170,
    Concord = 1093,
    ["Configu .cfgu files"] = 1081,
    ["Configu .configu file"] = 1082,
    Conjure = 165,
    ["Container Structure Test"] = 920,
    Containerlab = 948,
    ["Contextive Glossary"] = 1148,
    Convex = 164,
    ["Crowdsec collection config"] = 262,
    ["Crowdsec parser config"] = 263,
    ["Crowdsec scenario config"] = 264,
    ["CumulusCI Config"] = 171,
    ["Custom Machinery Machine"] = 1066,
    ["Custom Machinery Recipe"] = 1067,
    ["Cycle Stack File"] = 175,
    CycloneDX = 176,
    ["DWP Exchange - catalogue entry"] = 311,
    ["DWP Exchange - gateway"] = 309,
    ["DWP Exchange - meta"] = 310,
    ["Dart Build Config (dart-build.json)"] = 270,
    ["Dart Test Config (dart-test.json)"] = 271,
    ["DashLord Configuration"] = 272,
    ["Data Contract Specification"] = 273,
    ["Data Product Specification"] = 274,
    ["DataYoga Connections"] = 177,
    ["DataYoga Job"] = 178,
    ["Databricks Asset Bundles"] = 1044,
    ["Datadog Continuous Testing"] = 474,
    ["Datadog Service Definition"] = 475,
    ["Datadog Software Catalog"] = 476,
    ["Datahub Ingestion Recipe"] = 998,
    ["Debian Upstream Metadata file"] = 184,
    ["Deck config"] = 185,
    ["Dein Config"] = 186,
    ["Deno Config (deno.json)"] = 280,
    ["Dependency cruiser"] = 187,
    ["DeployStack Configuration"] = 188,
    ["Deployah Configuration"] = 1171,
    ["Deployer Recipe"] = 283,
    ["Deta Spacefile"] = 189,
    ["Detekt Config (detekt.yml)"] = 284,
    ["Devbox Config"] = 190,
    ["Devbox Plugin"] = 191,
    Devfile = 308,
    DipDup = 1096,
    ["Discord Webhook"] = 285,
    ["DocFx Config (docfx.json)"] = 289,
    Dofigen = 290,
    ["Dolittle Artifacts"] = 291,
    ["Dolittle Bounded Context Configuration"] = 292,
    ["Dolittle Event Horizons Configuration"] = 293,
    ["Dolittle Resources Configuration"] = 294,
    ["Dolittle Server Configuration"] = 295,
    ["Dolittle Tenant Map Configuration"] = 297,
    ["Dolittle Tenants Configuration"] = 296,
    ["Dolittle Topology"] = 298,
    ["DonateCaseBetterCasino menu"] = 1125,
    ["Drupal Breakpoints"] = 192,
    ["Drupal Config"] = 204,
    ["Drupal Info"] = 193,
    ["Drupal Layouts"] = 194,
    ["Drupal Libraries"] = 195,
    ["Drupal Links Action"] = 196,
    ["Drupal Links Contextual"] = 197,
    ["Drupal Links Menu"] = 198,
    ["Drupal Links Task"] = 199,
    ["Drupal Migration"] = 200,
    ["Drupal Permissions"] = 201,
    ["Drupal Recipe"] = 202,
    ["Drupal Routing"] = 203,
    ["Drupal Services"] = 205,
    ["Drush site aliases"] = 304,
    ["Dynamic Bash Aliases (.aliases)"] = 1035,
    ["EAS config"] = 328,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1024,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1168,
    ["EasyVCR .NET"] = 329,
    ["Eidolon Resource"] = 1110,
    ["Elgato Stream Deck"] = 314,
    Elm = 1098,
    ["Embrace Config"] = 1010,
    Endurica = 1048,
    ["Enterprise Contract Policy Spec"] = 315,
    ["Erda Pipeline"] = 1073,
    ["Erda Runtime"] = 1074,
    Esquio = 317,
    ["Estuary Flow Catalog"] = 988,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 321,
    ["EveryVoice TTS Toolkit Data Configuration"] = 322,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 326,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 325,
    ["EveryVoice TTS Toolkit Text Configuration"] = 323,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 324,
    ["Evolving Resolutive Process notation"] = 1170,
    ["Expo SDK"] = 327,
    ["F-Droid Data metadata"] = 333,
    ["FasterCI Configuration"] = 99,
    FiQuS = 337,
    Firebase = 335,
    ["FlexGet Config"] = 338,
    ["Flow.json Configurations"] = 1070,
    ["Fossa configuration file"] = 345,
    ["Fossa's fossa-deps file"] = 346,
    ["Foundry VTT - Base package Manifest"] = 340,
    ["Foundry VTT - Module Manifest"] = 341,
    ["Foundry VTT - System Data Template"] = 344,
    ["Foundry VTT - System Manifest"] = 342,
    ["Foundry VTT - World Manifest"] = 343,
    ["Foxx Manifest"] = 100,
    ["Freifunk.de Community API"] = 103,
    ["Frogbot Config"] = 104,
    ["G2P Mapping Configuration"] = 352,
    ["GCP Blueprint Metadata"] = 355,
    Gaspar = 353,
    ["GatewayCore API Gateway"] = 354,
    ["Gemini CLI settings"] = 356,
    ["GeoJSON.json latest"] = 986,
    GherKing = 990,
    ["GitHub Action"] = 361,
    ["GitHub Actions typing"] = 1106,
    ["GitHub Discussion"] = 362,
    ["GitHub Funding"] = 363,
    ["GitHub Issue Template configuration"] = 364,
    ["GitHub Issue Template forms"] = 365,
    ["GitHub Workflow"] = 366,
    ["GitHub Workflow Template Properties"] = 367,
    ["GitHub automatically generated release notes configuration"] = 368,
    ["GitLab Agent for Kubernetes configuration"] = 1062,
    GitVersion = 358,
    ["Gitea Issue Template configuration"] = 359,
    ["Gitea Issue Template forms"] = 360,
    ["Gitpod Automations"] = 370,
    ["Gitpod Configuration"] = 371,
    ["GlazeWM settings"] = 1064,
    ["Global Privacy Control"] = 357,
    Goblet = 1043,
    ["Golangci-lint Configuration"] = 386,
    ["Golangci-lint Custom Plugins Configuration"] = 387,
    ["Google Chrome Related Website Sets"] = 336,
    ["Google Cloud Workflows"] = 239,
    ["Google Digital Assetlinks"] = 1149,
    Goreleaser = 389,
    ["Goreleaser Pro"] = 390,
    Goss = 391,
    ["Gradle Build Cache Node"] = 937,
    ["Gradle Enterprise"] = 936,
    ["Grafana 5.x Dashboard"] = 392,
    ["GraphQL Code Generator"] = 397,
    ["GraphQL Config"] = 396,
    ["GraphQL Mesh"] = 395,
    ["GroovyLint configuration"] = 398,
    ["Grunt JSHint task"] = 402,
    ["Grunt Watch task"] = 403,
    ["Grunt base task"] = 404,
    ["Grunt clean task"] = 400,
    ["Grunt copy task"] = 399,
    ["Grunt cssmin task"] = 401,
    HEMTT = 902,
    Hadolint = 916,
    Hammerkit = 947,
    ["Hardware Sentry Configuration"] = 1002,
    ["HashiCorp Vault"] = 405,
    Hatch = 917,
    Hayagriva = 407,
    Hayson = 408,
    ["Haystack Pipeline"] = 409,
    ["Hazelcast 5 Configuration"] = 410,
    ["Hecate Input Schema"] = 1160,
    ["Helm Chart.lock"] = 207,
    ["Helm Chart.yaml"] = 206,
    ["Helm Unittest Test Suite"] = 208,
    ["Home Assistant Integration Manifest"] = 411,
    ["Homer dashboard configuration"] = 412,
    Hugo = 978,
    ["Hugo Theme"] = 977,
    ["Hulak Configuration"] = 419,
    ["Hyperfoil benchmark configuration"] = 418,
    ["IBM Zapp document"] = 420,
    ["IBM zCodeFormatSettings"] = 421,
    ["IMG Catapult PSP"] = 426,
    ["IVMS101 by CODE Protocol"] = 1063,
    Infrahub = 428,
    Istanbul = 1006,
    ["JDownloader2 crawler multi-rules"] = 441,
    ["JDownloader2 crawler single-rules"] = 440,
    ["JFrog Applications Config"] = 442,
    ["JFrog File Spec"] = 443,
    ["JFrog Pipelines YML DSL"] = 1012,
    ["JMeter DSL cli config"] = 444,
    JReleaser = 447,
    ["JSON Document Transform"] = 455,
    ["JSON Feed"] = 456,
    ["JSON Resume"] = 692,
    ["JSON Schema Draft 2020-12"] = 884,
    ["JSON Schema Draft 4"] = 881,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1045,
    ["JSON Schema Draft 7"] = 882,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1046,
    ["JSON Schema Draft 8 (2019-09)"] = 883,
    ["JSON-API"] = 454,
    ["JSON-e templates"] = 944,
    ["JSON-stat 2.0"] = 877,
    JSONPatch = 458,
    ["JSR Package Config (jsr.json)"] = 448,
    Jarl = 1176,
    Jasmine = 435,
    Jekyll = 436,
    ["Jenkins X Pipelines"] = 437,
    ["Jenkins X Requirements"] = 438,
    Jest = 439,
    Jocker = 445,
    ["Jovo Language Models"] = 446,
    ["Jujutsu (jj) VCS config"] = 1162,
    ["KIMMDY config file"] = 469,
    ["KODE/CI build.yaml"] = 1008,
    ["KSP-AVC"] = 878,
    ["KSP-CKAN"] = 879,
    ["KSP-NetKAN"] = 880,
    KSY = 1075,
    KSail = 350,
    ["Karakum configuration file"] = 347,
    Kas = 461,
    ["Kestra flow file"] = 470,
    ["Keycloak REST API"] = 1015,
    ["Knative Functions - func.yaml"] = 348,
    Knip = 349,
    ["Kometa (nightly) config file"] = 472,
    ["Kometa config file"] = 471,
    ["Kong DBLess config"] = 1009,
    KrakenD = 473,
    ["Kubri Configuration"] = 480,
    LOOBin = 495,
    ["Lake configuration file"] = 1165,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 244,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 245,
    ["Landing Zone Accelerator on AWS - Global Config"] = 246,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 247,
    ["Landing Zone Accelerator on AWS - Network Config"] = 248,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 249,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 250,
    ["Landing Zone Accelerator on AWS - Security Config"] = 251,
    ["Lando (landofile)"] = 94,
    ["LangGraph Platform configuration"] = 1086,
    ["Language configuration"] = 1085,
    Lefthook = 484,
    ["Liferay client-extension.yaml"] = 491,
    ["LinkML Metamodel"] = 493,
    Liquibase = 953,
    ["Liquibase Flow File"] = 954,
    ["Lively Properties"] = 494,
    ["Lobe AI Agent"] = 96,
    Loki = 97,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 535,
    ["MS2Rescore Configuration"] = 538,
    ["Madness (madness.yml)"] = 1026,
    ["Mado configuration"] = 501,
    ["MapEHR Mapping"] = 502,
    Markdownlint = 957,
    ["Mason Registry"] = 960,
    ["MegaLinter Custom Flavor"] = 505,
    ["MegaLinter configuration"] = 504,
    ["MegaLinter descriptor"] = 506,
    Melange = 1053,
    ["Meltano project definition"] = 507,
    ["Mergify Configuration"] = 539,
    ["Metadata for a Bazel module"] = 508,
    ["Metadata for a Cinnamon spice"] = 1102,
    ["Metatype Configuration"] = 509,
    ["MetricsHub Configuration"] = 510,
    ["MetricsHub Connector Configuration"] = 511,
    ["Micro Editor Syntax"] = 1036,
    ["Microsoft Band Web Tile"] = 512,
    ["Microsoft RulesEngine workflow rules"] = 1090,
    ["Microsoft RulesEngine workflow rules list"] = 1091,
    ["Minecraft Custom Main Menu Mod"] = 1054,
    ["Minecraft Data Pack Advancement"] = 514,
    ["Minecraft Data Pack Biome"] = 515,
    ["Minecraft Data Pack Configured Carver"] = 516,
    ["Minecraft Data Pack Damage Type"] = 517,
    ["Minecraft Data Pack Dimension"] = 519,
    ["Minecraft Data Pack Dimension Type"] = 518,
    ["Minecraft Data Pack Item Modifier"] = 520,
    ["Minecraft Data Pack Loot Table"] = 521,
    ["Minecraft Data Pack Metadata"] = 522,
    ["Minecraft Data Pack Predicate"] = 523,
    ["Minecraft Data Pack Recipe"] = 524,
    ["Minecraft Data Pack Tag"] = 525,
    ["Minecraft Data Pack Template Pool"] = 526,
    ["Minecraft Data Pack Trim Material"] = 531,
    ["Minecraft Data Pack Trim Pattern"] = 532,
    ["Minecraft Resource Pack Lang"] = 527,
    ["Minecraft Resource Pack Particle"] = 528,
    ["Minecraft Resource Pack Texture Mcmeta"] = 530,
    ["Minecraft Resourcepack Sounds"] = 529,
    ["Monade CLI Stack Configuration"] = 542,
    ["MongoDB Atlas Search Index Definition"] = 1007,
    ["Monika Configuration"] = 1005,
    ["Monoweave Configuration"] = 537,
    ["Motif config"] = 898,
    MultiQC = 1142,
    ["NOX Framework (Service)"] = 558,
    ["Netin Diagnostic System Template"] = 964,
    ["Netlify config"] = 545,
    ["Network-as-Code Data Model"] = 546,
    ["Next Gen UI Agent A2A Server Configuration"] = 547,
    ["Next Gen UI Agent Configuration"] = 549,
    ["Next Gen UI Agent MCP Server Configuration"] = 548,
    ["Nightwatch.js"] = 551,
    ["Node.js configuration"] = 903,
    ["NueJS configuration file"] = 563,
    ["Nuitka.yaml"] = 1068,
    ["Nullstone config"] = 565,
    ["ONe's changelog entry"] = 582,
    ["ONe's service descriptor"] = 581,
    ["ORT Server repository environment configuration"] = 590,
    ["OSCAL Assessment Plan (AP)"] = 592,
    ["OSCAL Assessment Results (AR)"] = 593,
    ["OSCAL Catalog"] = 594,
    ["OSCAL Component Definition (CDef)"] = 595,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 596,
    ["OSCAL Profile"] = 597,
    ["OSCAL System Security Plan (SSP)"] = 598,
    ["OSS Review Toolkit configuration"] = 599,
    ["OSS Review Toolkit curation"] = 600,
    ["OSS Review Toolkit package configuration"] = 601,
    ["OSS Review Toolkit repository configuration"] = 602,
    ["OSS Review Toolkit resolutions"] = 603,
    ["October CMS columns"] = 569,
    ["October CMS fields"] = 570,
    ["Oh My Posh"] = 571,
    Okteto = 572,
    ["Ona Automations"] = 574,
    Opctl = 901,
    ["Open Data Contract Standard (ODCS)"] = 585,
    ["Open Data Product Standard (ODPS)"] = 586,
    ["Open Know-How"] = 1147,
    ["OpenRewrite Resource"] = 584,
    OpenStatus = 1158,
    ["OpenUtau character yaml"] = 578,
    ["OpenUtau ustx"] = 579,
    ["OpenWeather Current Weather API"] = 943,
    ["OpenWeather Road Risk API"] = 942,
    ["Ory Hydra configuration"] = 417,
    ["Ory Keto configuration"] = 477,
    ["Ory Kratos configuration"] = 591,
    ["Ory Oathkeeper configuration"] = 567,
    ["Outblocks App configuration"] = 588,
    ["Outblocks database table"] = 589,
    ["Outblocks project configuration"] = 587,
    PDM = 610,
    POPxf = 620,
    ["POPxf Correlations"] = 621,
    Packer = 607,
    Pantsbuild = 1022,
    ["Paper paper-plugin.yml"] = 608,
    ["Pipeline component"] = 955,
    ["Platform.sh application"] = 4,
    ["Platform.sh routes"] = 5,
    ["Platform.sh services"] = 6,
    ["Plex Prerolls"] = 618,
    ["PocketMine plugin.yml"] = 615,
    ["Postman collection"] = 624,
    ["Power Pages Configuration"] = 1159,
    ["Preset list for a WinUtil"] = 1105,
    ["ProActions AI-Kit Configuration"] = 633,
    ["ProActions AI-Kit Configuration for Menus"] = 635,
    ["ProActions AI-Kit Configuration for Sections"] = 637,
    ["ProActions AI-Kit Configuration for Services"] = 634,
    ["ProActions AI-Kit Configuration for Steps"] = 638,
    ["ProActions AI-Kit Configuration for Templates"] = 636,
    ["Problem object RFC9457"] = 1051,
    ["Problem package generators"] = 639,
    Pterodactyl = 1001,
    ["Pull Request Labeler"] = 656,
    Pulumi = 664,
    ["PyGTA Config"] = 660,
    PyProject = 665,
    Pylock = 1150,
    Pyright = 666,
    ["Python script metadata"] = 1144,
    ["QType AI DSL"] = 669,
    Qgoda = 668,
    Qodana = 974,
    ["Qt Creator workspace file"] = 1083,
    ["Quali Torque Blueprint Spec 2"] = 999,
    ["QueryFirst config file"] = 1018,
    ["RKE Cluster Configuration JSON"] = 952,
    ["RKE Cluster Configuration YAML"] = 951,
    RadioHound = 659,
    Railpack = 671,
    Railway = 670,
    ["Rancher Fleet"] = 661,
    ...
    Ray = 915,
    ["Read the Docs"] = 663,
    ["Red-DiscordBot Cog"] = 679,
    ["Red-DiscordBot Cog Repo"] = 680,
    ["Red-DiscordBot Trivia"] = 681,
    ["Render Blueprints"] = 950,
    RenderCV = 694,
    Renovate = 693,
    ["Replit config"] = 687,
    Restate = 1137,
    ["Revel Digital Gadget Definition File"] = 1161,
    RoadRunner = 696,
    ["Robust Station Image"] = 1167,
    Rockcraft = 697,
    ["Roo Coder Custom Modes"] = 698,
    Rubocop = 689,
    ["Rudder techniques"] = 1058,
    Ruff = 690,
    ["Rust Project"] = 691,
    ["Rust toolchain"] = 702,
    ["SDMX data message"] = 728,
    ["SDMX metadata message"] = 727,
    ["SDMX structure message"] = 726,
    ["SIL Kit Participant Configuration"] = 738,
    ["SIL Kit Registry Configuration"] = 739,
    ["SPDX 2.3"] = 776,
    SWADL = 792,
    ["Safebox Config"] = 1013,
    ["Sapphire CLI Config"] = 705,
    ["SauceCTL Configuration"] = 961,
    ["Schema Catalog"] = 720,
    ["Scoop manifest"] = 725,
    ["Semantic Data Fabric (SDF) file"] = 729,
    ["Semgrep Rule"] = 731,
    ["Serenity Code Generator (Sergen)"] = 732,
    ["Serverless Framework Configuration"] = 968,
    ["Serverless Workflow"] = 970,
    ["Settings for a Cinnamon spice"] = 1101,
    ["Settings.paf"] = 734,
    ["Shopware 6 Configuration"] = 971,
    ["Shopware CLI Extension Store Configuration"] = 972,
    ["Shopware CLI Project Store Configuration"] = 973,
    ["Sigma Detection Rule"] = 736,
    ["Sigrid scope configuration file"] = 737,
    ["SkyPilot Task JSON"] = 1059,
    ["Slack app manifest"] = 741,
    Snapcraft = 743,
    Solidarity = 746,
    ["Solution filters"] = 747,
    ["Source Maps v3"] = 748,
    Sourcery = 749,
    ["Spack bootstrap.yaml"] = 750,
    ["Spack cdash.yaml"] = 751,
    ["Spack ci.yaml"] = 752,
    ["Spack compilers.yaml"] = 753,
    ["Spack concretizer.yaml"] = 754,
    ["Spack config.yaml"] = 755,
    ["Spack definitions.yaml"] = 756,
    ["Spack develop.yaml"] = 757,
    ["Spack env_vars.yaml"] = 758,
    ["Spack environment"] = 764,
    ["Spack include.yaml"] = 759,
    ["Spack mirrors.yaml"] = 760,
    ["Spack modules.yaml"] = 761,
    ["Spack packages.yaml"] = 762,
    ["Spack repos.yaml"] = 763,
    ["Spack toolchains.yaml"] = 765,
    ["Spack upstreams.yaml"] = 766,
    ["Spack view.yaml"] = 767,
    ["Speakeasy Generation Config File"] = 771,
    ["Speakeasy Lint Configuration File"] = 768,
    ["Speakeasy Test Generation Configuration File"] = 769,
    ["Speakeasy Workflow File"] = 770,
    SpecIF = 772,
    ["Specmatic Configuration"] = 773,
    ["Sponge Mixin configuration"] = 774,
    StackBlitz = 780,
    ["StackHawk Scanner Configuration"] = 967,
    Stale = 781,
    Starfish = 782,
    ["Starlake Data Pipeline"] = 940,
    Starship = 783,
    ["Statamic Blueprint"] = 784,
    ["Stella configuration file"] = 785,
    ["Streamlit configuration file"] = 786,
    ["Stryker Mutator"] = 789,
    ["StyleCop Analyzers Configuration"] = 790,
    ["Stylelint (.stylelintrc)"] = 791,
    ["Stylua Config"] = 1151,
    ["Sublime Syntax"] = 1014,
    ["Subsquid squid manifest"] = 1061,
    ["Swagger API 2.0"] = 793,
    ["Synadia Connect Component"] = 794,
    TSON = 829,
    TSTyche = 830,
    ["TYPO3 Vendor Bundler config"] = 835,
    ["Tab data for a LinUtil"] = 1108,
    ["Tab list for a LinUtil"] = 1107,
    Tach = 795,
    ["Tach Domain"] = 796,
    Talhelper = 798,
    ["Talisman configuration"] = 799,
    Taplo = 1152,
    ["Taskfile config"] = 945,
    Taurus = 800,
    Tauticord = 801,
    ["Tekton Pipeline"] = 1180,
    ["Tekton PipelineRun"] = 1181,
    ["Tekton Task"] = 1178,
    ["Tekton TaskRun"] = 1179,
    Telefonistka = 1138,
    ["Terrateam config"] = 1164,
    ["TestEnvironment.json"] = 812,
    ["TextMate Grammar"] = 811,
    Threagile = 807,
    ["Tier.run pricing.json"] = 804,
    Tikibase = 805,
    Tombi = 810,
    ["Traefik v2"] = 815,
    ["Traefik v2 File Provider"] = 816,
    ["Traefik v3"] = 817,
    ["Traefik v3 File Provider"] = 818,
    ["Travis CI (.travis.yml)"] = 814,
    Treefmt = 394,
    Trident = 1134,
    ["TrueScript for *.tscript files"] = 821,
    ["Tugboat QA config.yml"] = 1131,
    TunnelHub = 1049,
    Turborepo = 813,
    Tycho = 1097,
    Tye = 975,
    ["Tyk Gateway - Open Source v5.7+"] = 1143,
    ["Typst Manifest"] = 836,
    ["UET BuildConfig.json"] = 1019,
    ["UI5 Manifest"] = 842,
    ["UNCORS configuration"] = 846,
    ["UTAM Page Object"] = 845,
    ["Ubuntu Server Autoinstall"] = 840,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1135,
    ["Uniswap Token List"] = 927,
    ["Universal Schedule Format"] = 847,
    ["Unreal Engine Uplugin"] = 1020,
    ["Unreal Engine Uproject"] = 1021,
    ["UpCloud CLI (upctl) configuration"] = 1136,
    ["Updatecli Compose"] = 983,
    ["Updatecli Policy Manifest"] = 984,
    ["Updatecli Policy Metadata"] = 985,
    Uplift = 1017,
    ["Upsun config"] = 3,
    ["User Journey Map"] = 949,
    V2Ray = 989,
    ["VSCode Code Snippets"] = 227,
    ["VSIX CLI publishing"] = 865,
    Vector = 849,
    ["Vela Pipeline Configuration"] = 852,
    Vercel = 226,
    ["Version Bumper config"] = 855,
    ["Viash Component Config"] = 1140,
    ["Viash Package Config"] = 1141,
    Visivo = 1047,
    ["WP-CLI"] = 875,
    Wake = 1133,
    ["Waku Config"] = 1111,
    ["Web App Manifest"] = 871,
    ["Web types"] = 874,
    WebExtensions = 870,
    ["Webman package recipe"] = 995,
    ["Windows Package Manager Installer Manifest"] = 923,
    ["Windows Package Manager Locale Manifest"] = 924,
    ["Windows Package Manager Singleton Manifest"] = 922,
    Winutil = 925,
    ["WireMock CLI import configuration"] = 1116,
    ["WireMock CLI local service configuration"] = 1115,
    ["WireMock stub mapping"] = 1114,
    ["Woodpecker pipeline config"] = 963,
    ["Wrangler CLI"] = 876,
    ["Xstate Machine"] = 981,
    ["Yandex Workflow Language"] = 1103,
    ["Yarn Config (.yarnrc.yml)"] = 938,
    ["Yippee-Ki-JSON configuration YML"] = 929,
    ["YouTrack App"] = 1100,
    ["Zarf Package Configuration"] = 1166,
    ["Zerops.io config"] = 1088,
    ["Zerops.io import"] = 1089,
    ["Zola Configuration"] = 1177,
    ["aerleon.yml"] = 14,
    ["angular.json"] = 27,
    apko = 1052,
    ["app-definition.yaml"] = 31,
    ["apple-app-site-association"] = 29,
    ["appsettings.StormPetrel.json"] = 36,
    ["appsettings.json"] = 34,
    ["appsscript.json"] = 33,
    ["appveyor.yml"] = 35,
    ["aqua-generate-registry.yaml"] = 38,
    ["aqua-policy.yaml"] = 39,
    ["aqua.yaml"] = 37,
    ["arb.json"] = 41,
    ["arc.json"] = 43,
    ["architect.yml"] = 42,
    ["artifacthub-repo.yml"] = 47,
    ["asm-lsp"] = 48,
    ["ast-grep rules"] = 51,
    ["ast-grep sgconfig.yml"] = 50,
    ["babelrc.json"] = 106,
    ["bamboo-spec"] = 109,
    ["bashly-strings.yml"] = 1029,
    ["batect.yml"] = 108,
    ["beef-database-codegen"] = 110,
    ["beef-database-v5-codegen"] = 112,
    ["beef-entity-codegen"] = 111,
    ["beef-entity-v5-codegen"] = 113,
    ["behat.yml"] = 125,
    ["bigquery-table"] = 114,
    ["bioimageio resource description"] = 1069,
    ["bitbucket-pipelines"] = 116,
    bitrise = 117,
    ["bitrise-step"] = 118,
    ["block.json"] = 140,
    ["bottom configuration"] = 72,
    ["bower.json"] = 120,
    ["bozr.suite.json"] = 127,
    bpkg = 1030,
    ["browser.i18n.json"] = 128,
    ["browsh configuration"] = 129,
    bucklescript = 130,
    ["buf.gen.yaml"] = 74,
    ["buf.plugin.yaml"] = 75,
    ["buf.work.yaml"] = 76,
    ...
    ["build-changelog"] = 131,
    ["bun.lock"] = 136,
    ["bundleconfig.json"] = 137,
    ["bunfig.toml"] = 138,
    ["cargo-mutants-config.yaml"] = 77,
    ["ccmod.json"] = 1112,
    changelogging = 1080,
    ["chisel-slices.json"] = 253,
    ["chrome-extension-locales-messages.json"] = 234,
    ["chutzpah.json"] = 235,
    cibuildwheel = 160,
    ["clang-format (.clang-format)"] = 987,
    ["clang-tidy"] = 214,
    clangd = 213,
    clib = 215,
    ["cloud-init: cloud-config userdata"] = 217,
    ["cloud-sdk-pipeline-configuration"] = 237,
    ["cloudbuild.json"] = 238,
    cloudify = 216,
    ["cmdx.yaml"] = 80,
    codemagic = 218,
    ["coffeelint.json"] = 255,
    ["commands.json"] = 230,
    ["commitlint (.commitlintrc)"] = 926,
    ["committed.toml"] = 256,
    ["compile_commands.json"] = 229,
    ["compilerconfig.json"] = 228,
    ["completely.yml"] = 1025,
    ["component-detection-manifest.json"] = 259,
    ["component.json"] = 258,
    ["composer.json"] = 257,
    ["conda-forge"] = 163,
    ["config.yaml"] = 662,
    ["contentmanifest.json"] = 236,
    ["contribute.json"] = 260,
    ["cosmos.config.json"] = 232,
    ["crowdin.yml"] = 261,
    ["ctfd-setup configuration file"] = 1123,
    ["custom-elements.json"] = 1039,
    ["cypress.json"] = 265,
    ["datalogic-scan2deploy-android"] = 275,
    ["datalogic-scan2deploy-ce"] = 276,
    ["dbt Dependencies"] = 179,
    ["dbt Packages"] = 181,
    ["dbt Project"] = 180,
    ["dbt Selectors"] = 182,
    ["dbt YAML files"] = 183,
    ["ddev-global"] = 277,
    ["ddev-project"] = 278,
    ["debugsettings.json"] = 279,
    ["dependabot-v2.json"] = 282,
    ["dependabot.json"] = 281,
    ["deployed-cli"] = 980,
    ["devcontainer.json"] = 220,
    devinit = 931,
    ["devspace.yaml"] = 1003,
    djlint = 932,
    ["docker bake"] = 287,
    ["docker sequencer"] = 288,
    ["docker-compose.yml"] = 930,
    ["dockerd.json"] = 286,
    ["dotnet Release Index manifest"] = 299,
    ["dotnet-tools.json"] = 300,
    ["dotnetcli.host.json"] = 301,
    ["dprint.json"] = 302,
    ["drone.json"] = 303,
    ["dss-2.0.0.json"] = 305,
    ["dstack configuration"] = 306,
    ["dtool dataset metadata"] = 1118,
    ["dvc.yaml"] = 307,
    ["ecosystem.json"] = 312,
    eksctl = 313,
    ["electron-builder configuration file"] = 319,
    ["epr-manifest.json"] = 318,
    ["evcc.yaml"] = 320,
    ["ezd task runner"] = 330,
    ["fabric.mod.json"] = 332,
    ["first-timers-bot"] = 339,
    ["flagd flag configuration"] = 101,
    ["fly.io Configuration"] = 102,
    fulibWorkflows = 962,
    ["function.json"] = 351,
    ["gRPC API Gateway & OpenAPI Config"] = 9,
    ["gematik health care insurance list"] = 1129,
    ["gematik health care patient list"] = 1126,
    ["gematik health care provider institution list"] = 1128,
    ["gematik health care provider list"] = 1127,
    ["gematik tiger test environment configuration"] = 1130,
    ["git-town.toml"] = 1175,
    ["gitlab-ci"] = 369,
    ["global.json"] = 385,
    ["go-feature-flag Flag Configuration"] = 388,
    ["haxelib.json"] = 406,
    helmfile = 918,
    helmwave = 919,
    ["host-meta.json"] = 414,
    ...
    ["ide.host.json"] = 422,
    ["ifstate.yaml"] = 423,
    ["imageoptimizer.json"] = 424,
    ["importmap.json"] = 427,
    instant_python_config = 429,
    instant_python_custom_project = 430,
    ["ioBroker Configuration"] = 431,
    ["ioBroker JSON UI"] = 432,
    ["ioBroker Package manifest"] = 433,
    ["ixpect.conf.yaml"] = 434,
    ["ize.toml"] = 1016,
    ["jsconfig.json"] = 459,
    ["jscpd Configuration"] = 1000,
    jsdoc = 914,
    ["k3d.yaml"] = 460,
    ["k9s aliases.yaml"] = 462,
    ["k9s cluster-config.yaml"] = 464,
    ["k9s config.yaml"] = 463,
    ["k9s hotkeys.yaml"] = 465,
    ["k9s plugins.yaml"] = 466,
    ["k9s skin.yaml"] = 467,
    ["k9s views.yaml"] = 468,
    ["kontinuous-config.yaml"] = 479,
    ["kontinuous-values.yaml"] = 478,
    ["kustomization.yaml"] = 481,
    ["label-commenter-config.yml"] = 482,
    ["latexindent configuration"] = 95,
    ["launchsettings.json"] = 483,
    lazydocker = 1038,
    lazygit = 1037,
    ["lego.json"] = 485,
    ["lerna.json"] = 486,
    ["lgtm.yml"] = 487,
    ["liblab.config.json"] = 488,
    ["libman.json"] = 489,
    ["license-report-config.json"] = 490,
    ["linkinator.config.json"] = 492,
    ["lint-staged (.lintstagedrc)"] = 892,
    ["local.settings.json"] = 497,
    ["localazy.json"] = 498,
    ["lotus.yaml"] = 496,
    ["lsdlschema.json"] = 499,
    ["markdown-link-check"] = 958,
    maturin = 959,
    mboats = 966,
    ["micro-settings.json"] = 1031,
    ["mimetypes.json"] = 513,
    ["mirrord config"] = 894,
    mise = 895,
    ["mkdocs.yml"] = 533,
    ["monospace.yml"] = 536,
    ["moon.yml"] = 1113,
    ["mprocs Configuration file"] = 1084,
    ["mrdocs.yml"] = 534,
    ["mta.yaml"] = 896,
    ["mtad.yaml"] = 897,
    ["mycode.json"] = 543,
    nFPM = 550,
    ["napari plugin manifest"] = 544,
    neoload = 909,
    ["nest-cli"] = 553,
    ["ninjs (News in JSON)"] = 552,
    ["nitro.json"] = 908,
    ["nixd configuration"] = 1057,
    ["nlu.json"] = 554,
    ["nodemon.json"] = 556,
    ["noodl config"] = 965,
    ["notebook.mod.json"] = 557,
    now = 904,
    ["npm-badges"] = 560,
    ["nswag.json"] = 564,
    ntangle = 566,
    ["nuclei-template.yaml"] = 561,
    ["nuget-project.json"] = 562,
    ["ocelot.json"] = 568,
    ["omnisharp.json"] = 573,
    ["openapi.json"] = 575,
    ["openfin.json"] = 583,
    ...
    ["overlay.json"] = 576,
    ["package.json"] = 604,
    ["package.manifest"] = 606,
    ["package.yaml"] = 605,
    ["partial-black.json"] = 126,
    ["pathfinder.yml"] = 609,
    ["pattern.json"] = 612,
    ["petstore-v1.0"] = 1011,
    pgap_yaml_input_reader = 611,
    ["pixi.toml"] = 613,
    ["plagiarize-me.yaml"] = 617,
    ["plagiarize.yaml"] = 616,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1119,
    ["podbard.yaml"] = 619,
    ["portman.json"] = 622,
    ["prefect.toml"] = 630,
    ["prettierrc.json"] = 631,
    ["prisma.yml"] = 632,
    ["project-1.0.0-beta3.json"] = 641,
    ["project-1.0.0-beta4.json"] = 642,
    ["project-1.0.0-beta5.json"] = 643,
    ["project-1.0.0-beta6.json"] = 644,
    ["project-1.0.0-beta8.json"] = 645,
    ["project-1.0.0-rc1.json"] = 646,
    ["project-1.0.0-rc2.json"] = 647,
    ["project.json"] = 640,
    ["project.owasp.yaml"] = 648,
    ["prometheus-alertmanager.json"] = 652,
    ["prometheus.json"] = 649,
    ["prometheus.rules.json"] = 650,
    ["prometheus.rules.test.json"] = 651,
    ["proxies.json"] = 653,
    ["publiccode.yml"] = 654,
    ["pubspec.yaml"] = 655,
    ["pyrseas-0.8.json"] = 658,
    pytest = 667,
    ["quilt.mod.json"] = 1032,
    ["rc3 auth"] = 673,
    ["rc3 collection"] = 674,
    ...
    ["release drafter"] = 910,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 683,
    ["release-please-manifest.json"] = 684,
    ["release-plz.toml"] = 685,
    ["renv.lock"] = 695,
    ["rivet.json"] = 1056,
    ["rivet.yaml (legacy)"] = 1055,
    rumdl = 700,
    runny = 699,
    rustfmt = 701,
    sake = 1146,
    samt = 703,
    samtrc = 704,
    ["sarif-1.0.0.json"] = 706,
    ["sarif-2.0.0.json"] = 707,
    ["sarif-2.1.0"] = 717,
    ["sarif-2.1.0-rtm.2"] = 708,
    ["sarif-2.1.0-rtm.3"] = 710,
    ["sarif-2.1.0-rtm.4"] = 712,
    ["sarif-2.1.0-rtm.5"] = 714,
    ["sarif-2.1.0-rtm.6"] = 715,
    ["sarif-external-property-file-2.1.0"] = 718,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 709,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 711,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 713,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 716,
    ["scalingo.json configuration"] = 719,
    ["schema.org - Action"] = 721,
    ["schema.org - ContactPoint"] = 722,
    ["schema.org - Place"] = 723,
    ["schema.org - Thing"] = 724,
    ["secrethub.yml"] = 1034,
    ["semantic-release"] = 730,
    ["servicehub.config.json"] = 887,
    ["servicehub.service.json"] = 886,
    ["settings.job"] = 733,
    ["sfdx-hardis configuration"] = 735,
    ["shard.yml"] = 1072,
    ["size-limit configuration"] = 740,
    ["skaffold.yaml"] = 956,
    ["skyuxconfig.json"] = 742,
    ["snowflake-config"] = 744,
    ["snowflake-connections"] = 745,
    ["spicepod.yaml"] = 1092,
    ["sqlc configuration"] = 777,
    ["stripe-app-local.json"] = 788,
    ["stripe-app.json"] = 787,
    swcrc = 941,
    ["task.json"] = 797,
    taskcat = 905,
    ["template.json"] = 802,
    ["templatsources.json"] = 803,
    ["theme.json"] = 806,
    ["tizen_workspace.json"] = 808,
    tldr = 809,
    ["tm_devices configuration file"] = 1157,
    tmuxinator = 890,
    ["transcend.yml"] = 819,
    ["tree-sitter grammar.json"] = 393,
    ["trime.yaml"] = 820,
    ["trunk.yaml"] = 822,
    ["ts-force-config.json"] = 827,
    ["tsconfig.json"] = 823,
    ["tsd.json"] = 824,
    ["tsdoc.json"] = 825,
    ["tsdrc.json"] = 826,
    ...
    v8r = 869,
    vcluster = 1078,
    ["vcpkg configuration file"] = 225,
    ["vcpkg manifest file"] = 224,
    ["vega-lite.json"] = 851,
    ["vega.json"] = 850,
    ["venvironment.yaml"] = 853,
    ["venvplus.yaml"] = 854,
    version = 1139,
    ["version.json"] = 856,
    ["vhwdebugger-binding.yaml"] = 858,
    ["vim-addon-info"] = 859,
    ["vs-2017.3.host.json"] = 861,
    ["vs-nesting.json"] = 862,
    ["vsls.json"] = 860,
    ["vss-extension.json"] = 866,
    vtcfg = 1145,
    ["vtesttree.yaml"] = 867,
    ["vtestunit.yaml"] = 868,
    ["warp-keysets.json"] = 1040,
    ["warp-themes.json"] = 1041,
    ["warp-workflows.json"] = 1042,
    ["webhint.io"] = 996,
    ["webjobpublishsettings.json"] = 873,
    ["webjobs-list.json"] = 872,
    ["well-known-fursona"] = 1079,
    ["xs-app.json"] = 900,
    ["xunit.runner.json"] = 885,
    yamllint = 928,
    zuul = 911,
    ["Žinoma"] = 921
  },
