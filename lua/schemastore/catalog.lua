...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 14,
    AIConfig = 15,
    ["AMX Muse Program Descriptor"] = 987,
    ["API Builder"] = 807,
    ["AVA Configuration"] = 867,
    ...
    ["Adobe UXP Manifest"] = 927,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Alacritty Configuration"] = 839,
    ["All Contributors configuration file"] = 892,
    ...
    ["Application list for a WinUtil"] = 970,
    ArchitectFX = 974,
    ["Argo Events"] = 29,
    ["Argo Workflows"] = 30,
    AssemblyScript = 33,
    ...
    ["Azure Pipelines"] = 66,
    ["Azure Static Web Apps CLI configuration file"] = 667,
    ["Azure Static Web Apps configuration file"] = 666,
    ["BOSH Deploy Config"] = 90,
    ["BX CI"] = 108,
    ["Bashly (bashly.yml)"] = 896,
    ["Bashly Settings (bashly-settings.yml)"] = 897,
    ["Better Code Hub"] = 811,
    ["Better Scripts"] = 109,
    Bigconfig = 83,
    ["Biome Formatter Config"] = 53,
    ["Bitmovin Encoding Template"] = 980,
    BizTalkServerApplicationSchema = 780,
    Bleep = 110,
    ...
    ["Butane Config"] = 852,
    C4InterFlow = 995,
    ["CGS Card Game Specification (cgs.json)"] = 932,
    ["CICS TS region tagging"] = 861,
    ["CICS TS resource import"] = 862,
    ["CICS TS resource model"] = 863,
    ["CICS TS resource overrides"] = 864,
    ["CMake Presets"] = 111,
    ["CNC Codes"] = 126,
    ["CRS WAF test file"] = 960,
    ["CRS WAF test platform overrides file"] = 961,
    ...
    ["Chamaleon environment"] = 984,
    ["Chamaleon properties"] = 985,
    ["Chamaleon template"] = 983,
    Changesets = 208,
    Cheatsheets = 849,
    ...
    CityJSON = 122,
    ["Clawject config"] = 131,
    ["Cloud Foundry Application Manifest"] = 943,
    ["Cloud Run Spec v1"] = 965,
    ...
    Concord = 959,
    ["Configu .cfgu files"] = 948,
    ["Configu .configu file"] = 949,
    Conjure = 125,
    ["Container Structure Test"] = 794,
    Containerlab = 819,
    ["Crowdsec collection config"] = 217,
    ["Crowdsec parser config"] = 218,
    ["Crowdsec scenario config"] = 219,
    ["CumulusCI Config"] = 130,
    ["Custom Machinery Machine"] = 933,
    ["Custom Machinery Recipe"] = 934,
    ...
    ["DonateCaseBetterCasino menu"] = 988,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 904,
    ["EAS config"] = 283,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 893,
    ["EasyVCR .NET"] = 284,
    ["Eidolon Resource"] = 975,
    ...
    ["Goreleaser Pro"] = 342,
    Goss = 343,
    ["Gradle Build Cache Node"] = 809,
    ["Gradle Enterprise"] = 808,
    ...
    Hadolint = 790,
    Hammerkit = 818,
    ["Hardware Sentry Configuration"] = 872,
    Hatch = 791,
    Hayson = 356,
    ...
    ["JFrog File Spec"] = 385,
    ["JFrog Pipelines YML DSL"] = 881,
    ["JMeter DSL cli config"] = 386,
    JReleaser = 388,
    ["JSON Document Transform"] = 396,
    ["JSON Feed"] = 397,
    ["JSON Resume"] = 605,
    ["JSON Schema Draft 2020-12"] = 760,
    ["JSON Schema Draft 4"] = 757,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 914,
    ["JSON Schema Draft 7"] = 758,
    ["JSON Schema Draft 7 (unofficial strict)"] = 915,
    ["JSON Schema Draft 8 (2019-09)"] = 759,
    ["JSON-API"] = 395,
    ["JSON-e templates"] = 816,
    ["JSON-stat 2.0"] = 753,
    JSONPatch = 399,
    ...
    ["Metadata for a Cinnamon spice"] = 968,
    ["Metatype Configuration"] = 447,
    ["MetricsHub Configuration"] = 448,
    ["MetricsHub Connector Configuration"] = 449,
    ["Micro Editor Syntax"] = 905,
    ["Microsoft Band Web Tile"] = 450,
    ["Microsoft RulesEngine workflow rules"] = 956,
    ["Microsoft RulesEngine workflow rules list"] = 957,
    ["Minecraft Custom Main Menu Mod"] = 922,
    ...
    ["MongoDB Atlas Search Index Definition"] = 876,
    ["Monika Configuration"] = 874,
    ["Monoweave Configuration"] = 475,
    ["Motif config"] = 773,
    ["NOX Framework (Service)"] = 492,
    ["Netin Diagnostic System Template"] = 834,
    ["Netlify config"] = 483,
    ...
    ["OpenUtau ustx"] = 510,
    ["OpenWeather Current Weather API"] = 815,
    ["OpenWeather Road Risk API"] = 814,
    ...
    ["Pipeline component"] = 826,
    ["Plex Prerolls"] = 546,
    ["PocketMine plugin.yml"] = 543,
    ["Postman collection"] = 550,
    ["Preset list for a WinUtil"] = 971,
    ["Problem object RFC9457"] = 919,
    ...
    Qgoda = 586,
    Qodana = 844,
    ["Qt Creator workspace file"] = 950,
    ["Quali Torque Blueprint Spec 2"] = 869,
    ["QueryFirst config file"] = 887,
    ["RKE Cluster Configuration JSON"] = 823,
    ["RKE Cluster Configuration YAML"] = 822,
    RadioHound = 578,
    Railway = 587,
    ["Rancher Fleet"] = 580,
    ["Rattler-build"] = 588,
    ...
    ["Render Blueprints"] = 821,
    RenderCV = 607,
    Renovate = 606,
    ["Replit config"] = 601,
    RoadRunner = 609,
    ["Rudder techniques"] = 925,
    Ruff = 603,
    ["Rust Project"] = 604,
    ["Rust toolchain"] = 613,
    ...
    ["SauceCTL Configuration"] = 831,
    ["Schema Catalog"] = 630,
    ["Scoop manifest"] = 635,
    ["Semantic Data Fabric (SDF) file"] = 639,
    ["Semgrep Rule"] = 641,
    ["Serenity Code Generator (Sergen)"] = 642,
    ["Serverless Framework Configuration"] = 838,
    ["Serverless Workflow"] = 840,
    ["Settings for a Cinnamon spice"] = 967,
    ["Settings.paf"] = 644,
    ["Shopware 6 Configuration"] = 841,
    ["Shopware CLI Extension Store Configuration"] = 842,
    ["Shopware CLI Project Store Configuration"] = 843,
    ["Sigma Detection Rule"] = 646,
    ["Sigrid scope configuration file"] = 647,
    ["SkyPilot Task JSON"] = 926,
    ...
    StackBlitz = 668,
    ["StackHawk Scanner Configuration"] = 837,
    Stale = 669,
    ["Starlake Data Pipeline"] = 812,
    Starship = 670,
    ["Statamic Blueprint"] = 671,
    ["Stella configuration file"] = 672,
    ["Stryker Mutator"] = 675,
    ["StyleCop Analyzers Configuration"] = 676,
    ["Stylelint (.stylelintrc)"] = 677,
    ["Sublime Syntax"] = 883,
    ["Subsquid squid manifest"] = 928,
    ["Swagger API 2.0"] = 679,
    ["Synadia Connect Component"] = 680,
    TSON = 711,
    TSTyche = 712,
    ["Tab data for a LinUtil"] = 973,
    ["Tab list for a LinUtil"] = 972,
    Talhelper = 682,
    ["Talisman configuration"] = 683,
    ["Taskfile config"] = 817,
    Taurus = 684,
    Tauticord = 685,
    ["TestEnvironment.json"] = 694,
    ["TextMate Grammar"] = 693,
    ["Tier.run pricing.json"] = 688,
    Tikibase = 689,
    ["Traefik v2"] = 697,
    ["Traefik v2 File Provider"] = 698,
    ["Traefik v3"] = 699,
    ...
    Tycho = 963,
    Tye = 845,
    ["UET BuildConfig.json"] = 888,
    ["UI5 Manifest"] = 721,
    ["UNCORS configuration"] = 725,
    ["UTAM Page Object"] = 724,
    ["Ubuntu Server Autoinstall"] = 719,
    ["Uniswap Token List"] = 800,
    ["Unreal Engine Uplugin"] = 889,
    ["Unreal Engine Uproject"] = 890,
    ["Updatecli Compose"] = 853,
    ["Updatecli Policy Manifest"] = 854,
    ["Updatecli Policy Metadata"] = 855,
    Uplift = 886,
    ["User Journey Map"] = 820,
    V2Ray = 859,
    ["VSCode Code Snippets"] = 183,
    ["VSIX CLI publishing"] = 742,
    ["Vela Pipeline Configuration"] = 729,
    Vercel = 182,
    ["Version Bumper config"] = 732,
    Visivo = 916,
    Wake = 996,
    ["Waku Config"] = 976,
    ["Web App Manifest"] = 748,
    ["Web types"] = 751,
    WebExtensions = 747,
    ["Webman package recipe"] = 865,
    ["Windows Package Manager Installer Manifest"] = 797,
    ["Windows Package Manager Locale Manifest"] = 798,
    ["Windows Package Manager Singleton Manifest"] = 796,
    ["WireMock stub mapping"] = 979,
    ["Woodpecker pipeline config"] = 833,
    ["Wrangler CLI"] = 752,
    ["Xstate Machine"] = 851,
    ["Yandex Workflow Language"] = 969,
    ["Yarn Config (.yarnrc.yml)"] = 810,
    ["Yippee-Ki-JSON configuration YML"] = 802,
    ["YouTrack App"] = 966,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 920,
    ...
    ["behat.yml"] = 92,
    ["bigquery-table"] = 82,
    ["bioimageio resource description"] = 936,
    ...
    ["crowdin.yml"] = 216,
    ["ctfd-setup configuration file"] = 986,
    ["custom-elements.json"] = 908,
    ["cypress.json"] = 220,
    ...
    ["gematik health care insurance list"] = 992,
    ["gematik health care patient list"] = 989,
    ["gematik health care provider institution list"] = 991,
    ["gematik health care provider list"] = 990,
    ["gematik tiger test environment configuration"] = 993,
    ["gitlab-ci"] = 322,
    ["global.json"] = 337,
    ...
    ["lint-staged (.lintstagedrc)"] = 768,
    ["local.settings.json"] = 437,
    ["localazy.json"] = 438,
    ["lotus.yaml"] = 436,
    ["lsdlschema.json"] = 439,
    ["markdown-link-check"] = 829,
    mboats = 836,
    ["micro-settings.json"] = 900,
    ["mimetypes.json"] = 451,
    ["mirrord config"] = 769,
    mise = 770,
    ["mkdocs.yml"] = 471,
    ...
    ["plagiarize.yaml"] = 544,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 982,
    ["podbard.yaml"] = 547,
    ["portman.json"] = 548,
    ["prefect.toml"] = 556,
    ["prettierrc.json"] = 557,
    ...
    ["servicehub.config.json"] = 763,
    ["servicehub.service.json"] = 762,
    ["settings.job"] = 643,
    ...
    snapcraft = 653,
    ["spicepod.yaml"] = 958,
    ["sqlc configuration"] = 665,
    ["stripe-app-local.json"] = 674,
    ["stripe-app.json"] = 673,
    swcrc = 813,
    ["task.json"] = 681,
    taskcat = 779,
    ["template.json"] = 686,
    ["templatsources.json"] = 687,
    ["theme.json"] = 690,
    ["tizen_workspace.json"] = 691,
    tldr = 692,
    tmuxinator = 766,
    ["transcend.yml"] = 701,
    ...
    ["vega-lite.json"] = 728,
    ["vega.json"] = 727,
    ["venvironment-basic.yaml"] = 731,
    ["venvironment.yaml"] = 730,
    ["version.json"] = 733,
    ["vhwdebugger-binding.yaml"] = 735,
    ["vim-addon-info"] = 736,
    ["vs-2017.3.host.json"] = 738,
    ["vs-nesting.json"] = 739,
    ["vsls.json"] = 737,
    ["vss-extension.json"] = 743,
    ["vtesttree.yaml"] = 744,
    ["vtestunit.yaml"] = 745,
    ["warp-keysets.json"] = 909,
    ["warp-themes.json"] = 910,
    ["warp-workflows.json"] = 911,
    ["webhint.io"] = 866,
    ["webjobpublishsettings.json"] = 750,
    ["webjobs-list.json"] = 749,
    ["well-known-fursona"] = 946,
    ["xs-app.json"] = 775,
    ["xunit.runner.json"] = 761,
    yamllint = 801,
    ["zerops.io import file"] = 955,
    ["zerops.yml"] = 954,
    zuul = 785,
    ["Žinoma"] = 795
  },
