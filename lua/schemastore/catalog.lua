...
M.json = {
  ...
  index = {
    ...
    ["<div>RIOTS' studio configuration"] = 699,
    ...
    ["Adobe UXP Manifest"] = 884,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Airplane task"] = 17,
    ["Alacritty Configuration"] = 791,
    ["All Contributors configuration file"] = 849,
    ...
    ["BX CI"] = 104,
    ["Bashly (bashly.yml)"] = 853,
    ["Bashly Settings (bashly-settings.yml)"] = 854,
    ["Better Code Hub"] = 763,
    ["Better Scripts"] = 105,
    Bigconfig = 81,
    BizTalkServerApplicationSchema = 733,
    Bleep = 106,
    ...
    ["Butane Config"] = 804,
    ["CGS Custom Card Game (CardGameDef.json)"] = 889,
    ["CICS TS region tagging"] = 813,
    ["CICS TS resource import"] = 814,
    ["CICS TS resource model"] = 815,
    ["CICS TS resource overrides"] = 816,
    ["CMake Presets"] = 107,
    ["CNC Codes"] = 121,
    ["CRS WAF test file"] = 918,
    ["CRS WAF test platform overrides file"] = 919,
    ...
    CityJSON = 117,
    ["Clawject config"] = 126,
    ["Cloud Foundry Application Manifest"] = 901,
    ["Cloud Run Spec v1"] = 923,
    ...
    Concord = 917,
    ["Configu .cfgu files"] = 906,
    ["Configu .configu file"] = 907,
    Conjure = 120,
    ["Container Structure Test"] = 746,
    Containerlab = 771,
    ["Crowdsec collection config"] = 210,
    ["Crowdsec parser config"] = 211,
    ["Crowdsec scenario config"] = 212,
    ["CumulusCI Config"] = 125,
    ["Custom Machinery Machine"] = 890,
    ["Custom Machinery Recipe"] = 891,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 861,
    ["EAS config"] = 276,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 850,
    ...
    ["Goreleaser Pro"] = 333,
    Goss = 334,
    ["Gradle Build Cache Node"] = 761,
    ["Gradle Enterprise"] = 760,
    ...
    Hadolint = 742,
    Hammerkit = 770,
    ["Hardware Sentry Configuration"] = 824,
    Hatch = 743,
    Hayson = 347,
    ...
    ["JFrog File Spec"] = 375,
    ["JFrog Pipelines YML DSL"] = 833,
    ["JMeter DSL cli config"] = 376,
    JReleaser = 378,
    ["JSON Document Transform"] = 386,
    ["JSON Feed"] = 387,
    ["JSON Resume"] = 566,
    ["JSON Schema Draft 2020-12"] = 712,
    ["JSON Schema Draft 4"] = 709,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 871,
    ["JSON Schema Draft 7"] = 710,
    ["JSON Schema Draft 7 (unofficial strict)"] = 872,
    ["JSON Schema Draft 8 (2019-09)"] = 711,
    ["JSON-API"] = 385,
    ["JSON-WF"] = 900,
    ["JSON-e templates"] = 768,
    ["JSON-stat 2.0"] = 706,
    JSONPatch = 389,
    ...
    ["Keycloak REST API"] = 841,
    ["Knative Functions - func.yaml"] = 295,
    ["KoDE/CI build.yaml"] = 829,
    ["Kong DBLess config"] = 830,
    KrakenD = 396,
    ...
    ["Micro Editor Syntax"] = 862,
    ["Microsoft Band Web Tile"] = 431,
    ["Microsoft RulesEngine workflow rules"] = 914,
    ["Microsoft RulesEngine workflow rules list"] = 915,
    ["Minecraft Custom Main Menu Mod"] = 879,
    ...
    ["MongoDB Atlas Search Index Definition"] = 828,
    ["Monika Configuration"] = 826,
    ["Monoweave Configuration"] = 455,
    ["Motif config"] = 726,
    ["NOX Framework (Service)"] = 472,
    ["Netin Diagnostic System Template"] = 786,
    ["Netlify config"] = 463,
    ...
    ["OpenUtau ustx"] = 485,
    ["OpenWeather Current Weather API"] = 767,
    ["OpenWeather Road Risk API"] = 766,
    ...
    ["Pipeline component"] = 778,
    ["PocketMine plugin.yml"] = 511,
    ["Postman collection"] = 516,
    ["Problem object RFC9457"] = 876,
    ...
    Qgoda = 548,
    Qodana = 796,
    ["Qt Creator workspace file"] = 908,
    ["Quali Torque Blueprint Spec 2"] = 821,
    ["QueryFirst config file"] = 844,
    ["RKE Cluster Configuration JSON"] = 775,
    ["RKE Cluster Configuration YAML"] = 774,
    ["Rancher Fleet"] = 542,
    ["Rattler-build"] = 549,
    Ray = 741,
    ["Read the Docs"] = 544,
    ...
    ["Render Blueprints"] = 773,
    RenderCV = 568,
    Renovate = 567,
    ["Replit config"] = 562,
    RoadRunner = 569,
    ["Rudder techniques"] = 882,
    Ruff = 564,
    ["Rust Project"] = 565,
    ["Rust toolchain"] = 573,
    ...
    ["SauceCTL Configuration"] = 783,
    ["Schema Catalog"] = 590,
    ["Scoop manifest"] = 595,
    ["Semantic Data Fabric (SDF) file"] = 599,
    ["Semgrep Rule"] = 601,
    ["Serenity Code Generator (Sergen)"] = 602,
    ["Serverless Framework Configuration"] = 790,
    ["Serverless Workflow"] = 792,
    ["Settings.paf"] = 604,
    ["Shopware 6 Configuration"] = 793,
    ["Shopware CLI Extension Store Configuration"] = 794,
    ["Shopware CLI Project Store Configuration"] = 795,
    Sigma = 606,
    ["Sigrid scope configuration file"] = 607,
    ["SkyPilot Task JSON"] = 883,
    ...
    StackBlitz = 627,
    ["StackHawk Scanner Configuration"] = 789,
    Stale = 628,
    ["Starlake Data Pipeline"] = 764,
    Starship = 629,
    ["Statamic Blueprint"] = 630,
    ["Stella configuration file"] = 631,
    ["StrmPrivacy Data Connector"] = 838,
    ["StrmPrivacy Data Contract"] = 839,
    ["StrmPrivacy SimpleSchema"] = 836,
    ["StrmPrivacy Stream"] = 837,
    ["StrmPrivacy batch job configuration file"] = 835,
    ["Stryker Mutator"] = 634,
    ["StyleCop Analyzers Configuration"] = 635,
    ["Stylelint (.stylelintrc)"] = 636,
    ["Sublime Syntax"] = 840,
    ["Subsquid squid manifest"] = 885,
    ["Swagger API 2.0"] = 638,
    TSON = 664,
    TSTyche = 665,
    Talhelper = 640,
    ...
    Tycho = 921,
    Tye = 797,
    ["UET BuildConfig.json"] = 845,
    ["UI5 Manifest"] = 674,
    ["UNCORS configuration"] = 678,
    ["UTAM Page Object"] = 677,
    ["Ubuntu Server Autoinstall"] = 672,
    ["Uniswap Token List"] = 752,
    ["Unreal Engine Uplugin"] = 846,
    ["Unreal Engine Uproject"] = 847,
    ["Updatecli Compose"] = 805,
    ["Updatecli Policy Manifest"] = 806,
    ["Updatecli Policy Metadata"] = 807,
    Uplift = 843,
    ["User Journey Map"] = 772,
    V2Ray = 811,
    ["VSCode Code Snippets"] = 176,
    ["VSIX CLI publishing"] = 694,
    ["Vela Pipeline Configuration"] = 682,
    Vercel = 175,
    Visivo = 873,
    ["Web App Manifest"] = 701,
    ["Web types"] = 704,
    WebExtensions = 700,
    ["Webman package recipe"] = 817,
    ["Windows Package Manager Installer Manifest"] = 749,
    ["Windows Package Manager Locale Manifest"] = 750,
    ["Windows Package Manager Singleton Manifest"] = 748,
    ["Woodpecker pipeline config"] = 785,
    ["Wrangler CLI"] = 705,
    ["Xstate Machine"] = 803,
    ...
    ["behat.yml"] = 89,
    ["bigquery-table"] = 80,
    ["bioimageio resource description"] = 893,
    ...
    ["lint-staged (.lintstagedrc)"] = 720,
    ["local.settings.json"] = 419,
    ["localazy.json"] = 420,
    ["lotus.yaml"] = 418,
    ["lsdlschema.json"] = 421,
    ["markdown-link-check"] = 781,
    mboats = 788,
    ["micro-settings.json"] = 857,
    ["mimetypes.json"] = 432,
    ["mirrord config"] = 721,
    mise = 722,
    ["mise-settings"] = 723,
    ...
    ["servicehub.config.json"] = 715,
    ["servicehub.service.json"] = 714,
    ["settings.job"] = 603,
    ...
    ["vega-lite.json"] = 681,
    ["vega.json"] = 680,
    ["venvironment-basic.yaml"] = 684,
    ["venvironment.yaml"] = 683,
    ["version.json"] = 685,
    ["vhwdebugger-binding.yaml"] = 687,
    ["vim-addon-info"] = 688,
    ["vs-2017.3.host.json"] = 690,
    ["vs-nesting.json"] = 691,
    ["vsls.json"] = 689,
    ["vss-extension.json"] = 695,
    ["vtesttree.yaml"] = 696,
    ["vtestunit.yaml"] = 697,
    ["warp-keysets.json"] = 866,
    ["warp-themes.json"] = 867,
    ["warp-workflows.json"] = 868,
    ["webhint.io"] = 818,
    ["webjobpublishsettings.json"] = 703,
    ["webjobs-list.json"] = 702,
    ["well-known-fursona"] = 904,
    ["xs-app.json"] = 728,
    ["xunit.runner.json"] = 713,
    yamllint = 753,
    ["zerops.io import file"] = 913,
    ["zerops.yml"] = 912,
    zuul = 737,
    ["Žinoma"] = 747
  },
