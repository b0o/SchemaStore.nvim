...
M.json = {
  ...
  index = {
    ...
    ["Azure Pipelines"] = 54,
    ["Azure Static Web Apps CLI configuration file"] = 495,
    ["Azure Static Web Apps configuration file"] = 494,
    ["BX CI"] = 89,
    ["Better Code Hub"] = 623,
    ["Better Scripts"] = 90,
    ...
    ["Stryker Mutator"] = 501,
    ["StyleCop Analyzers Configuration"] = 502,
    ["Swagger API 2.0"] = 505,
    TSON = 529,
    ["Talisman configuration"] = 507,
    ["Taskfile YAML Schema"] = 629,
    Taurus = 508,
    ["TestEnvironment.json"] = 517,
    ["Tier.run pricing.json"] = 511,
    Tikibase = 512,
    ["Traefik v2"] = 520,
    ["Traefik v2 File Provider"] = 521,
    Turborepo = 518,
    Tye = 656,
    ...
    taskcat = 592,
    ["template.json"] = 509,
    ["templatsources.json"] = 510,
    ["theme.json"] = 513,
    ["tizen_workspace.json"] = 514,
    tldr = 515,
    tmLanguage = 516,
    tmuxinator = 580,
    ["transcend.yml"] = 522,
