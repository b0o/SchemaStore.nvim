...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 641,
    [".nodehawkrc"] = 399,
    [".npmpackagejsonlintrc"] = 402,
    [".phraseapp.yml"] = 450,
    [".pmbot.yml"] = 438,
    [".postcssrc"] = 445,
    [".powerpages-web-template-manifest"] = 447,
    [".pre-commit-config.yml"] = 448,
    [".pre-commit-hooks.yml"] = 449,
    [".putout.json"] = 469,
    [".rehyperc"] = 481,
    [".remarkrc"] = 483,
    [".sprite files"] = 539,
    ...
    ["<div>RIOTS' studio configuration"] = 610,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 357,
    AIConfig = 13,
    ["API Builder"] = 673,
    ["AVA Configuration"] = 734,
    ...
    ["Airplane task"] = 15,
    ["Alacritty Configuration"] = 706,
    ["All Contributors configuration file"] = 764,
    ...
    ["Better Scripts"] = 98,
    Bigconfig = 78,
    BizTalkServerApplicationSchema = 647,
    Bleep = 99,
    ...
    ["Butane Config"] = 719,
    ["CICS TS region tagging"] = 728,
    ["CICS TS resource import"] = 729,
    ["CICS TS resource model"] = 730,
    ["CICS TS resource overrides"] = 731,
    ["CMake Presets"] = 100,
    ["CNC Codes"] = 111,
    ...
    ["Databricks Asset Bundles"] = 785,
    ["Datadog Service Definition"] = 335,
    ["Datahub Ingestion Recipe"] = 735,
    ["Dein Config"] = 117,
    Deno = 196,
    ["Deployer Recipe"] = 199,
    ["Deta Spacefile"] = 118,
    ...
    ["Goreleaser Pro"] = 277,
    Goss = 278,
    ["Gradle Build Cache Node"] = 675,
    ["Gradle Enterprise"] = 674,
    ...
    Hadolint = 656,
    Hammerkit = 684,
    ["Hardware Sentry Configuration"] = 739,
    Hatch = 657,
    Hayson = 290,
    ...
    Kas = 331,
    ["Keycloak REST API"] = 756,
    ["Knative Functions - func.yaml"] = 252,
    ["KoDE/CI build.yaml"] = 744,
    ["Kong DBLess config"] = 745,
    KrakenD = 334,
    LOOBin = 352,
    Lefthook = 342,
    ["Liferay client-extension.yaml"] = 348,
    ["LinkML Metamodel"] = 350,
    Liquibase = 689,
    ["Liquibase Flow File"] = 690,
    ["Lively Properties"] = 351,
    ["Lobe AI Agent"] = 60,
    ["MLOS Configs"] = 384,
    ["MS2Rescore Configuration"] = 386,
    Markdownlint = 693,
    ["Mason Registry"] = 695,
    ["MegaLinter configuration"] = 358,
    ["MegaLinter descriptor"] = 359,
    Melange = 792,
    ["Meltano plugin discovery definition"] = 361,
    ["Meltano project definition"] = 360,
    ["Microsoft Band Web Tile"] = 362,
    ["Minecraft Custom Main Menu Mod"] = 793,
    ["Minecraft Data Pack Advancement"] = 364,
    ["Minecraft Data Pack Biome"] = 365,
    ["Minecraft Data Pack Configured Carver"] = 366,
    ["Minecraft Data Pack Damage Type"] = 367,
    ["Minecraft Data Pack Dimension"] = 369,
    ["Minecraft Data Pack Dimension Type"] = 368,
    ["Minecraft Data Pack Item Modifier"] = 370,
    ["Minecraft Data Pack Loot Table"] = 371,
    ["Minecraft Data Pack Metadata"] = 372,
    ["Minecraft Data Pack Predicate"] = 373,
    ["Minecraft Data Pack Recipe"] = 374,
    ["Minecraft Data Pack Tag"] = 375,
    ["Minecraft Data Pack Template Pool"] = 376,
    ["Minecraft Data Pack Trim Material"] = 381,
    ["Minecraft Data Pack Trim Pattern"] = 382,
    ["Minecraft Resource Pack Lang"] = 377,
    ["Minecraft Resource Pack Particle"] = 378,
    ["Minecraft Resource Pack Texture Mcmeta"] = 380,
    ["Minecraft Resourcepack Sounds"] = 379,
    ["MkDocs Configuration 1.0"] = 383,
    ["MongoDB Atlas Search Index Definition"] = 743,
    ["Monika Configuration"] = 741,
    ["Motif config"] = 640,
    ["NOX Framework (Service)"] = 401,
    ["Netin Diagnostic System Template"] = 699,
    ["Netlify config"] = 392,
    ["Network-as-Code Data Model"] = 393,
    ["Nightwatch.js"] = 394,
    ["ONe's changelog entry"] = 417,
    ["ONe's service descriptor"] = 416,
    ["OSS Review Toolkit configuration"] = 424,
    ["OSS Review Toolkit curation"] = 425,
    ["OSS Review Toolkit package configuration"] = 426,
    ["OSS Review Toolkit repository configuration"] = 427,
    ["OSS Review Toolkit resolutions"] = 428,
    Opctl = 643,
    ["OpenRewrite Resource"] = 419,
    ["OpenUtau character yaml"] = 413,
    ["OpenUtau ustx"] = 414,
    ["OpenWeather Current Weather API"] = 681,
    ["OpenWeather Road Risk API"] = 680,
    ["Ory Hydra configuration"] = 296,
    ["Ory Keto configuration"] = 336,
    ["Ory Kratos configuration"] = 423,
    ["Ory Oathkeeper configuration"] = 408,
    ["Outblocks App configuration"] = 421,
    ["Outblocks database table"] = 422,
    ["Outblocks project configuration"] = 420,
    PDM = 434,
    ["PDM Partial"] = 435,
    Packer = 431,
    Pantsbuild = 763,
    ["Paper paper-plugin.yml"] = 432,
    ["Partial-Setuptools"] = 523,
    ["Partial-poetry"] = 441,
    ["Pipeline component"] = 691,
    ["PocketMine plugin.yml"] = 439,
    Poetry = 440,
    ["Postman collection"] = 446,
    ["Problem object RFC9457"] = 790,
    ["Problem package generators"] = 453,
    Pterodactyl = 738,
    ["Pull Request Labeler"] = 468,
    Pulumi = 474,
    PyProject = 475,
    Pyright = 476,
    Qgoda = 477,
    Qodana = 711,
    ["Quali Torque Blueprint Spec 2"] = 736,
    ["QueryFirst config file"] = 759,
    ["RKE Cluster Configuration JSON"] = 688,
    ["RKE Cluster Configuration YAML"] = 687,
    ["Rancher Fleet"] = 471,
    Ray = 655,
    ["Read the Docs"] = 473,
    ["Red-DiscordBot Cog"] = 478,
    ["Red-DiscordBot Cog Repo"] = 479,
    ["Red-DiscordBot Trivia"] = 480,
    RenderCV = 490,
    Renovate = 489,
    ["Replit config"] = 484,
    RoadRunner = 491,
    ...
    ["SauceCTL Configuration"] = 696,
    ["Schema Catalog"] = 510,
    ["Scoop manifest"] = 515,
    ["Semantic Data Fabric (SDF) file"] = 516,
    ["Semgrep Rule"] = 518,
    ["Serenity Code Generator (Sergen)"] = 519,
    ["Serverless Framework Configuration"] = 705,
    ["Serverless Workflow"] = 707,
    ["Settings.paf"] = 521,
    Setuptools = 522,
    ["Shopware 6 Configuration"] = 708,
    ["Shopware CLI Extension Store Configuration"] = 709,
    ["Shopware CLI Project Store Configuration"] = 710,
    Sigma = 525,
    ...
    StackBlitz = 543,
    ["StackHawk Scanner Configuration"] = 704,
    Stale = 544,
    ["Starlake Data Pipeline"] = 678,
    Starship = 545,
    ["Statamic Blueprint"] = 546,
    ["Stella configuration file"] = 547,
    ["StrmPrivacy Data Connector"] = 753,
    ["StrmPrivacy Data Contract"] = 754,
    ["StrmPrivacy SimpleSchema"] = 751,
    ["StrmPrivacy Stream"] = 752,
    ["StrmPrivacy batch job configuration file"] = 750,
    ["Stryker Mutator"] = 550,
    ...
    Turborepo = 568,
    Tye = 712,
    ["UET BuildConfig.json"] = 760,
    ["UI5 Manifest"] = 588,
    ["UNCORS configuration"] = 592,
    ["UTAM Page Object"] = 591,
    ["Ubuntu Server Autoinstall"] = 586,
    ["Uniswap Token List"] = 666,
    ["Unreal Engine Uplugin"] = 761,
    ["Unreal Engine Uproject"] = 762,
    ["Updatecli Compose"] = 720,
    ["Updatecli Policy Manifest"] = 721,
    ["Updatecli Policy Metadata"] = 722,
    Uplift = 758,
    ["User Journey Map"] = 686,
    V2Ray = 726,
    ["VSCode Code Snippets"] = 154,
    ["VSIX CLI publishing"] = 605,
    ["Vela Pipeline Configuration"] = 595,
    Vercel = 153,
    Visivo = 787,
    ["Web App Manifest"] = 612,
    ["Web types"] = 615,
    WebExtensions = 611,
    ["Webman package recipe"] = 732,
    ["Windows Package Manager Installer Manifest"] = 663,
    ["Windows Package Manager Locale Manifest"] = 664,
    ["Windows Package Manager Singleton Manifest"] = 662,
    ["Woodpecker pipeline config"] = 698,
    ["Xstate Machine"] = 718,
    ["Yippee-Ki-JSON configuration YML"] = 668,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 16,
    apko = 791,
    ...
    ["bamboo-spec"] = 72,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 769,
    ["bashly-strings.yml"] = 770,
    ["bashly.yml"] = 768,
    ["batect.yml"] = 71,
    ...
    ["lgtm.yml"] = 345,
    ["libman.json"] = 346,
    ["license-report-config.json"] = 347,
    ["linkinator.config.json"] = 349,
    ["local.settings.json"] = 354,
    ["localazy.json"] = 355,
    ["lotus.yaml"] = 353,
    ["lsdlschema.json"] = 356,
    ["madness.yml"] = 767,
    ["markdown-lint-check"] = 694,
    mboats = 701,
    ["micro-settings.json"] = 772,
    ["mimetypes.json"] = 363,
    ["mirrord config"] = 636,
    mise = 637,
    ["monospace.yml"] = 385,
    ...
    ["mycode.json"] = 389,
    mypy = 390,
    ["napari plugin manifest"] = 391,
    neoload = 649,
    ["nest-cli"] = 397,
    ["ninjs (News in JSON) 1.3"] = 396,
    ["ninjs (News in JSON) 2.0"] = 395,
    ["nlu.json"] = 398,
    ["nodemon.json"] = 400,
    ["noodl config"] = 700,
    now = 645,
    ...
    ["nswag.json"] = 406,
    ntangle = 407,
    ["nuclei-template.yaml"] = 404,
    ["nuget-project.json"] = 405,
    ["ocelot.json"] = 409,
    ["omnisharp.json"] = 410,
    ["openapi.json"] = 411,
    ["openfin.json"] = 418,
    ...
    ["ops.yaml"] = 415,
    ["package.json"] = 429,
    ["package.manifest"] = 430,
    ["partial-cibuildwheel"] = 108,
    ["partial-scikit-build"] = 703,
    ["pathfinder.yml"] = 433,
    ["pattern.json"] = 437,
    ["petstore-v1.0"] = 747,
    pgap_yaml_input_reader = 436,
    ["plagiarize-me.yaml"] = 443,
    ["plagiarize.yaml"] = 442,
    ["portman.json"] = 444,
    ["prettierrc.json"] = 451,
    ["prisma.yml"] = 452,
    ["project-1.0.0-beta3.json"] = 455,
    ["project-1.0.0-beta4.json"] = 456,
    ["project-1.0.0-beta5.json"] = 457,
    ["project-1.0.0-beta6.json"] = 458,
    ["project-1.0.0-beta8.json"] = 459,
    ["project-1.0.0-rc1.json"] = 460,
    ["project-1.0.0-rc2.json"] = 461,
    ["project.json"] = 454,
    ["prometheus.json"] = 462,
    ["prometheus.rules.json"] = 463,
    ["prometheus.rules.test.json"] = 464,
    ["proxies.json"] = 465,
    ["publiccode.yml"] = 466,
    ["pubspec.yaml"] = 467,
    ["pyrseas-0.8.json"] = 470,
    ["quilt.mod.json"] = 773,
    ["release drafter"] = 650,
    ["release-plz.toml"] = 482,
    ["rivet.yaml"] = 794,
    rustfmt = 492,
    samt = 494,
    samtrc = 495,
    ...
    ["vega-lite.json"] = 594,
    ["vega.json"] = 593,
    ["venvironment-basic.yaml"] = 597,
    ["venvironment.yaml"] = 596,
    ["version.json"] = 598,
    ["vim-addon-info"] = 599,
    ["vs-2017.3.host.json"] = 601,
    ["vs-nesting.json"] = 602,
    ["vsls.json"] = 600,
    ["vss-extension.json"] = 606,
    ["vtesttree.yaml"] = 607,
    ["vtestunit.yaml"] = 608,
    ["warp-keysets.json"] = 781,
    ["warp-themes.json"] = 782,
    ["warp-workflows.json"] = 783,
    ["webhint.io"] = 733,
    ["webjobpublishsettings.json"] = 614,
    ["webjobs-list.json"] = 613,
    ["xs-app.json"] = 642,
