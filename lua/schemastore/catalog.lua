...
M.json = {
  ...
  index = {
    ...
    ["AWS CDK cdk.json"] = 128,
    ["AWS CloudFormation"] = 129,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 130,
    ...
    ["Azure Pipelines"] = 43,
    ["Azure Static Web Apps CLI configuration file"] = 400,
    ["Azure Static Web Apps configuration file"] = 399,
    ["BX CI"] = 72,
    ["Better Code Hub"] = 516,
    ["Better Scripts"] = 73,
    ...
    ["Citation File Format"] = 131,
    CityJSON = 81,
    ["Code Climate"] = 106,
    ["Commandbox Box.json"] = 84,
    ["Commandbox Server.json"] = 85,
    ["Common Catalog Schema"] = 120,
    ["Common types for all schemas"] = 1,
    Conjure = 82,
    ["Container Structure Test"] = 499,
    Containerlab = 523,
    ["Dart build configuration"] = 144,
    ["Dart test config"] = 145,
    ["DashLord configuration"] = 146,
    ["Datadog Service Definition"] = 257,
    ["Datahub Ingestion Recipe Schema"] = 566,
    ["Deadpendency Config Schema"] = 88,
    ["Dein Config Schema"] = 89,
    Deno = 150,
    ["Deployer Recipe"] = 153,
    Devfile = 173,
    ["Discord Webhook"] = 155,
    ["Dolittle Artifacts"] = 159,
    ["Dolittle Bounded Context Configuration"] = 160,
    ["Dolittle Event Horizons Configuration"] = 161,
    ["Dolittle Resources Configuration"] = 162,
    ["Dolittle Server Configuration"] = 163,
    ["Dolittle Tenant Map Configuration"] = 165,
    ["Dolittle Tenants Configuration"] = 164,
    ["Dolittle Topology"] = 166,
    ["Drupal Breakpoints Schema"] = 90,
    ["Drupal Config Schema"] = 101,
    ["Drupal Info Schema"] = 91,
    ["Drupal Layouts Schema"] = 92,
    ["Drupal Libraries Schema"] = 93,
    ["Drupal Links Action Schema"] = 94,
    ["Drupal Links Contextual Schema"] = 95,
    ["Drupal Links Menu Schema"] = 96,
    ["Drupal Links Task Schema"] = 97,
    ["Drupal Migration Schema"] = 98,
    ["Drupal Permissions Schema"] = 99,
    ["Drupal Routing Schema"] = 100,
    ["Drupal Services Schema"] = 102,
    ["Drush site aliases"] = 170,
    ["Embrace Config Schema"] = 577,
    ["Error pages"] = 179,
    Esquio = 177,
    ["Estuary Flow Catalog Schema"] = 556,
    ["Expo SDK"] = 182,
    ["F-Droid Data metadata"] = 187,
    ["Facets - FSDL - Application"] = 185,
    ["Fossa configuration file"] = 192,
    ["Fossa's fossa-deps file"] = 193,
    ["Foundry VTT - Manifest"] = 190,
    ["Foundry VTT - Template"] = 191,
    ["Foxx Manifest"] = 44,
    ["GatewayCore API Gateway"] = 196,
    ["GeoJSON.json latest"] = 554,
    GherKing = 558,
    ["GitHub Action"] = 200,
    ["GitHub Funding"] = 201,
    ["GitHub Issue Template configuration"] = 203,
    ["GitHub Workflow"] = 204,
    ["GitHub Workflow Template Properties"] = 205,
    ["GitHub issue forms"] = 202,
    GitVersion = 199,
    ["Gitpod Configuration"] = 207,
    ["Global Privacy Control"] = 197,
    ["Google Cloud Workflows"] = 127,
    Goreleaser = 210,
    ["Goreleaser Pro"] = 211,
    ["Gradle Build Cache Node"] = 513,
    ["Gradle Enterprise"] = 512,
    ["Grafana 5.x Dashboard"] = 212,
    ["GraphQL Code Generator"] = 215,
    ["GraphQL Config"] = 214,
    ["GraphQL Mesh"] = 213,
    ["Grunt JSHint task"] = 219,
    ["Grunt Watch task"] = 220,
    ["Grunt base task"] = 221,
    ["Grunt clean task"] = 217,
    ["Grunt copy task"] = 216,
    ["Grunt cssmin task"] = 218,
    HEMTT = 485,
    Hadolint = 497,
    ["Hardware Sentry Configuration"] = 570,
    Hayson = 223,
    ["Haystack Pipeline"] = 224,
    ["Hazelcast 5 Configuration"] = 225,
    ["Helm Chart.lock"] = 104,
    ["Helm Chart.yaml"] = 103,
    Hugo = 548,
    ["Istanbul Schema"] = 573,
    ["JDownloader2 crawler multi-rule schema"] = 241,
    ["JDownloader2 crawler single-rule schema"] = 240,
    ["JFrog File Spec"] = 242,
    ["JFrog Pipelines YML DSL"] = 579,
    ["JSON Document Transform"] = 250,
    ["JSON Feed"] = 251,
    ["JSON Resume"] = 361,
    ...
    ["JSON schema for CodeShip Pro services configuration files"] = 113,
    ["JSON schema for CodeShip Pro steps configuration files"] = 114,
    ["JSON schema for Codecov configuration files"] = 112,
    ["JSON-API"] = 249,
    ...
    Jasmine = 236,
    Jekyll = 237,
    ["Jenkins X Pipelines"] = 238,
    ["Jenkins X Requirements"] = 239,
    ["Jovo Language Models"] = 243,
    ["KSP-AVC"] = 460,
    ["KSP-CKAN"] = 461,
    ["Keycloak REST API"] = 581,
    ["Knative Functions - func.yaml"] = 194,
    ["KoDE/CI build.yaml"] = 575,
    ["Kong DBLess Schema"] = 576,
    KrakenD = 256,
    ["LinkML Metamodel"] = 267,
    Liquibase = 527,
    ["Liquibase Flow File"] = 528,
    Markdownlint = 531,
    ["MegaLinter configuration"] = 271,
    ["MegaLinter descriptor"] = 272,
    ["Meltano plugin discovery definition"] = 274,
    ["Meltano project definition"] = 273,
    ["Microsoft Band Web Tile"] = 275,
    ["Minecraft Data Pack Advancement"] = 277,
    ["Minecraft Data Pack Biome"] = 278,
    ["Minecraft Data Pack Configured Carver"] = 279,
    ["Minecraft Data Pack Dimension"] = 281,
    ["Minecraft Data Pack Dimension Type"] = 280,
    ["Minecraft Data Pack Item Modifier"] = 282,
    ["Minecraft Data Pack Loot Table"] = 283,
    ["Minecraft Data Pack Metadata"] = 284,
    ["Minecraft Data Pack Predicate"] = 285,
    ["Minecraft Data Pack Recipe"] = 286,
    ["Minecraft Data Pack Template Pool"] = 287,
    ["Minecraft Resourcepack Sounds"] = 288,
    ["MongoDB Atlas Search Index Definition Schema"] = 574,
    ["Monika Configuration Schema"] = 572,
    ["Motif config"] = 481,
    ["Netin Diagnostic System Template"] = 536,
    ["Netlify config schema"] = 293,
    ["Nightwatch.js"] = 294,
    ...
    ["Ory Hydra configuration"] = 229,
    ["Ory Keto configuration"] = 258,
    ...
    Solidarity = 393,
    ["Solution filters"] = 394,
    ["Source Maps v3"] = 395,
    SpecIF = 396,
    ["Sponge Mixin configuration"] = 397,
    ...
    ["chutzpah.json"] = 123,
    ["cloud-init: cloud-config userdata JSON schema"] = 110,
    ["cloud-sdk-pipeline-config-schema"] = 125,
    ["cloudbuild.json"] = 126,
    cloudify = 109,
    codemagic = 111,
    ["coffeelint.json"] = 132,
    comet = 517,
    ["commands.json"] = 119,
    ["compile_commands.json"] = 118,
    ["compilerconfig.json"] = 117,
    ["component-detection-manifest.json"] = 135,
    ["component.json"] = 134,
    ["composer.json"] = 133,
    ["config.json"] = 136,
    ["contentmanifest.json"] = 124,
    ["contribute.json"] = 137,
    ["cosmos.config.json"] = 121,
    ["crowdin.yml"] = 138,
    cspell = 141,
    ["cypress.json"] = 139,
    ["datalogic-scan2deploy-android"] = 147,
    ["datalogic-scan2deploy-ce"] = 148,
    ["dbt Project"] = 87,
    ["debugsettings.json"] = 149,
    ["dependabot-v2.json"] = 152,
    ["dependabot.json"] = 151,
    ["deployed-cli"] = 550,
    ["detekt.yml"] = 154,
    devinit = 509,
    ...
    ["docker-seq schema"] = 157,
    ["dockerd.json"] = 156,
    ["dotnet Release Index manifest"] = 167,
    ["dotnetcli.host.json"] = 168,
    ["drone.json"] = 169,
    ["dss-2.0.0.json"] = 171,
    ["dvc.yaml"] = 172,
    ["ecosystem.json"] = 174,
    eksctl = 175,
    ["electron-builder configuration file."] = 180,
    ["epr-manifest.json"] = 178,
    ["evcc.yaml"] = 181,
    ["ezd schema"] = 183,
    ["fabric.mod.json"] = 186,
    ["first-timers-bot"] = 189,
    ["fly.io Schema"] = 45,
    fulibWorkflows = 534,
    ["function.json"] = 195,
    ["geojson.json"] = 198,
    ["gitlab-ci"] = 206,
    ["global.json"] = 208,
    ["golangci-lint Configuration"] = 209,
    ["haxelib.json"] = 222,
    helmfile = 498,
    ["host-meta.json"] = 227,
    ["host.json"] = 226,
    ...
    huskyrc = 477,
    ["ide.host.json"] = 230,
    ["imageoptimizer.json"] = 231,
    ["importmap.json"] = 233,
    ["ioBroker JSON UI"] = 234,
    ["ioBroker Package manifest"] = 235,
    ["ize.toml"] = 582,
    ["jsconfig.json"] = 254,
    ["jscpd Configuration Schema"] = 568,
    jsdoc = 495,
    ["k3d.yaml"] = 255,
    ["kustomization.yaml"] = 259,
    ["label-commenter-config.yml"] = 260,
    ["launchsettings.json"] = 261,
    ["lerna.json"] = 262,
    ["lgtm.yml"] = 263,
    ["libman.json"] = 264,
    ["license-report-config.json"] = 265,
    ["linkinator.config.json"] = 266,
    ["local.settings.json"] = 268,
    ["localazy.json"] = 269,
    ["lsdlschema.json"] = 270,
    ...
    ["mtad.yaml"] = 480,
    ["mycode.json"] = 291,
    ["napari plugin manifest"] = 292,
    neoload = 490,
    ["nest-cli"] = 297,
    ["ninjs (News in JSON) 1.3"] = 296,
    ["ninjs (News in JSON) 2.0"] = 295,
    ["nlu.json"] = 298,
    ["nodemon.json"] = 300,
    ...
    ["size-limit configuration"] = 390,
    ["skaffold.yaml"] = 530,
    ["skyuxconfig.json"] = 391,
    snapcraft = 392,
    ["stripe-app.json"] = 404,
    swcrc = 518,
    taskcat = 487,
