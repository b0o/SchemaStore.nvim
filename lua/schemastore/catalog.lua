...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 191,
    [".cryproj (generic)"] = 642,
    [".cryproj engine-5.2"] = 637,
    [".cryproj engine-5.3"] = 638,
    [".cryproj engine-5.4"] = 639,
    [".cryproj engine-5.5"] = 640,
    [".cryproj engine-dev"] = 641,
    [".eslintrc"] = 246,
    [".esmrc.json"] = 238,
    [".ffizer.yaml"] = 250,
    [".htmlhintrc"] = 303,
    ...
    [".mtaext"] = 653,
    [".nodehawkrc"] = 411,
    [".npmpackagejsonlintrc"] = 414,
    [".phraseapp.yml"] = 459,
    [".pmbot.yml"] = 449,
    [".postcssrc"] = 454,
    [".powerpages-web-template-manifest"] = 456,
    [".pre-commit-config.yml"] = 457,
    [".pre-commit-hooks.yml"] = 458,
    [".putout.json"] = 478,
    [".rehyperc"] = 490,
    [".remarkrc"] = 492,
    [".sprite files"] = 547,
    ...
    ["<div>RIOTS' studio configuration"] = 620,
    ["@factorial/drupal-breakpoints-css"] = 4,
    ["A micro editor config"] = 367,
    AIConfig = 11,
    ["API Builder"] = 685,
    ["AVA Configuration"] = 744,
    ...
    ["Airplane task"] = 13,
    ["Alacritty Configuration"] = 716,
    ["All Contributors configuration file"] = 774,
    ...
    ["Azure Pipelines"] = 64,
    ["Azure Static Web Apps CLI configuration file"] = 550,
    ["Azure Static Web Apps configuration file"] = 549,
    ["BX CI"] = 102,
    ["Bashly (bashly.yml)"] = 778,
    ["Bashly Settings (bashly-settings.yml)"] = 779,
    ["Better Code Hub"] = 689,
    ["Better Scripts"] = 103,
    Bigconfig = 81,
    BizTalkServerApplicationSchema = 659,
    Bleep = 104,
    ...
    ["Butane Config"] = 729,
    ["CGS Custom Card Game (CardGameDef.json)"] = 814,
    ["CICS TS region tagging"] = 738,
    ["CICS TS resource import"] = 739,
    ["CICS TS resource model"] = 740,
    ["CICS TS resource overrides"] = 741,
    ["CMake Presets"] = 105,
    ["CNC Codes"] = 116,
    ...
    ["DataYoga Job"] = 122,
    ["Databricks Asset Bundles"] = 795,
    ["Datadog Service Definition"] = 344,
    ["Datahub Ingestion Recipe"] = 745,
    ["Dein Config"] = 124,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 786,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 775,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 811,
    GitVersion = 270,
    ["Gitpod Configuration"] = 279,
    ["GlazeWM settings"] = 813,
    ...
    ["Goreleaser Pro"] = 284,
    Goss = 285,
    ["Gradle Build Cache Node"] = 687,
    ["Gradle Enterprise"] = 686,
    ["Grafana 5.x Dashboard"] = 286,
    ["GraphQL Code Generator"] = 290,
    ["GraphQL Config"] = 289,
    ["GraphQL Mesh"] = 288,
    ["Grunt JSHint task"] = 294,
    ["Grunt Watch task"] = 295,
    ["Grunt base task"] = 296,
    ["Grunt clean task"] = 292,
    ["Grunt copy task"] = 291,
    ["Grunt cssmin task"] = 293,
    HEMTT = 656,
    Hadolint = 668,
    Hammerkit = 696,
    ["Hardware Sentry Configuration"] = 749,
    Hatch = 669,
    Hayson = 298,
    ["Haystack Pipeline"] = 299,
    ["Hazelcast 5 Configuration"] = 300,
    ["Helm Chart.lock"] = 143,
    ["Helm Chart.yaml"] = 142,
    ["Helm Unittest Test Suite"] = 144,
    Hugo = 725,
    ["Hugo Theme"] = 724,
    ["IBM Zapp document"] = 305,
    ["IBM zCodeFormatSettings"] = 306,
    ["IMG Catapult PSP"] = 311,
    ["IVMS101 by CODE Protocol"] = 812,
    Istanbul = 752,
    ["JDownloader2 crawler multi-rules"] = 321,
    ["JDownloader2 crawler single-rules"] = 320,
    ["JFrog Applications Config"] = 322,
    ["JFrog File Spec"] = 323,
    ["JFrog Pipelines YML DSL"] = 758,
    ["JMeter DSL cli config"] = 324,
    JReleaser = 326,
    ["JSON Document Transform"] = 334,
    ["JSON Feed"] = 335,
    ["JSON Resume"] = 497,
    ["JSON Schema Draft 2020-12"] = 633,
    ["JSON Schema Draft 4"] = 630,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 796,
    ["JSON Schema Draft 7"] = 631,
    ["JSON Schema Draft 7 (unofficial strict)"] = 797,
    ["JSON Schema Draft 8 (2019-09)"] = 632,
    ["JSON-API"] = 333,
    ["JSON-e templates"] = 694,
    ["JSON-stat 2.0"] = 627,
    JSONPatch = 337,
    ["JSR Package Config (jsr.json)"] = 327,
    Jasmine = 316,
    Jekyll = 317,
    ["Jenkins X Pipelines"] = 318,
    ["Jenkins X Requirements"] = 319,
    ["Jovo Language Models"] = 325,
    ["KIMMDY config file"] = 342,
    ["KSP-AVC"] = 628,
    ["KSP-CKAN"] = 629,
    ["Karakum configuration file"] = 262,
    Kas = 340,
    ["Keycloak REST API"] = 766,
    ["Knative Functions - func.yaml"] = 263,
    ["KoDE/CI build.yaml"] = 754,
    ["Kong DBLess config"] = 755,
    KrakenD = 343,
    LOOBin = 362,
    Lefthook = 351,
    ["Liferay client-extension.yaml"] = 358,
    ["LinkML Metamodel"] = 360,
    Liquibase = 701,
    ["Liquibase Flow File"] = 702,
    ["Lively Properties"] = 361,
    ["Lobe AI Agent"] = 63,
    ["MLOS Configs"] = 396,
    ["MS2Rescore Configuration"] = 399,
    ["Madness (madness.yml)"] = 777,
    Markdownlint = 705,
    ["Mason Registry"] = 707,
    ["MegaLinter configuration"] = 368,
    ["MegaLinter descriptor"] = 369,
    Melange = 803,
    ["Meltano plugin discovery definition"] = 371,
    ["Meltano project definition"] = 370,
    ["MetricsHub Configuration"] = 372,
    ["MetricsHub Connector Configuration"] = 373,
    ["Micro Editor Syntax"] = 787,
    ["Microsoft Band Web Tile"] = 374,
    ["Minecraft Custom Main Menu Mod"] = 804,
    ["Minecraft Data Pack Advancement"] = 376,
    ["Minecraft Data Pack Biome"] = 377,
    ["Minecraft Data Pack Configured Carver"] = 378,
    ["Minecraft Data Pack Damage Type"] = 379,
    ["Minecraft Data Pack Dimension"] = 381,
    ["Minecraft Data Pack Dimension Type"] = 380,
    ["Minecraft Data Pack Item Modifier"] = 382,
    ["Minecraft Data Pack Loot Table"] = 383,
    ["Minecraft Data Pack Metadata"] = 384,
    ["Minecraft Data Pack Predicate"] = 385,
    ["Minecraft Data Pack Recipe"] = 386,
    ["Minecraft Data Pack Tag"] = 387,
    ["Minecraft Data Pack Template Pool"] = 388,
    ["Minecraft Data Pack Trim Material"] = 393,
    ["Minecraft Data Pack Trim Pattern"] = 394,
    ["Minecraft Resource Pack Lang"] = 389,
    ["Minecraft Resource Pack Particle"] = 390,
    ["Minecraft Resource Pack Texture Mcmeta"] = 392,
    ["Minecraft Resourcepack Sounds"] = 391,
    ["MkDocs Configuration 1.0"] = 395,
    ["MongoDB Atlas Search Index Definition"] = 753,
    ["Monika Configuration"] = 751,
    ["Monoweave Configuration"] = 398,
    ["Motif config"] = 652,
    ["NOX Framework (Service)"] = 413,
    ["Netin Diagnostic System Template"] = 711,
    ["Netlify config"] = 404,
    ["Network-as-Code Data Model"] = 405,
    ["Nightwatch.js"] = 406,
    ["Nuitka.yaml"] = 817,
    ["ONe's changelog entry"] = 429,
    ["ONe's service descriptor"] = 428,
    ["OSS Review Toolkit configuration"] = 436,
    ["OSS Review Toolkit curation"] = 437,
    ["OSS Review Toolkit package configuration"] = 438,
    ["OSS Review Toolkit repository configuration"] = 439,
    ["OSS Review Toolkit resolutions"] = 440,
    Opctl = 655,
    ["OpenRewrite Resource"] = 431,
    ["OpenUtau character yaml"] = 425,
    ["OpenUtau ustx"] = 426,
    ["OpenWeather Current Weather API"] = 693,
    ["OpenWeather Road Risk API"] = 692,
    ["Ory Hydra configuration"] = 304,
    ["Ory Keto configuration"] = 345,
    ["Ory Kratos configuration"] = 435,
    ["Ory Oathkeeper configuration"] = 420,
    ["Outblocks App configuration"] = 433,
    ["Outblocks database table"] = 434,
    ["Outblocks project configuration"] = 432,
    PDM = 446,
    Packer = 443,
    Pantsbuild = 773,
    ["Paper paper-plugin.yml"] = 444,
    ["Pipeline component"] = 703,
    ["PocketMine plugin.yml"] = 450,
    ["Postman collection"] = 455,
    ["Problem object RFC9457"] = 801,
    ["Problem package generators"] = 462,
    Pterodactyl = 748,
    ["Pull Request Labeler"] = 477,
    Pulumi = 483,
    PyProject = 484,
    Pyright = 485,
    Qgoda = 486,
    Qodana = 721,
    ["Quali Torque Blueprint Spec 2"] = 746,
    ["QueryFirst config file"] = 769,
    ["RKE Cluster Configuration JSON"] = 700,
    ["RKE Cluster Configuration YAML"] = 699,
    ["Rancher Fleet"] = 480,
    Ray = 667,
    ["Read the Docs"] = 482,
    ["Red-DiscordBot Cog"] = 487,
    ["Red-DiscordBot Cog Repo"] = 488,
    ["Red-DiscordBot Trivia"] = 489,
    RenderCV = 499,
    Renovate = 498,
    ["Replit config"] = 493,
    RoadRunner = 500,
    ["Rudder techniques"] = 807,
    Ruff = 495,
    ["Rust Project"] = 496,
    ["Rust toolchain"] = 503,
    ["SIL Kit Participant Configuration"] = 535,
    ["SIL Kit Registry Configuration"] = 536,
    SWADL = 561,
    ["Safebox Config"] = 759,
    ["Sapphire CLI Config"] = 506,
    ["SauceCTL Configuration"] = 708,
    ["Schema Catalog"] = 520,
    ["Scoop manifest"] = 525,
    ["Semantic Data Fabric (SDF) file"] = 526,
    ["Semgrep Rule"] = 528,
    ["Serenity Code Generator (Sergen)"] = 529,
    ["Serverless Framework Configuration"] = 715,
    ["Serverless Workflow"] = 717,
    ["Settings.paf"] = 531,
    ["Shopware 6 Configuration"] = 718,
    ["Shopware CLI Extension Store Configuration"] = 719,
    ["Shopware CLI Project Store Configuration"] = 720,
    Sigma = 533,
    ["Sigrid scope configuration file"] = 534,
    ["SkyPilot Task JSON"] = 808,
    ["Slack app manifest"] = 538,
    Solidarity = 541,
    ["Solution filters"] = 542,
    ["Source Maps v3"] = 543,
    Sourcery = 544,
    SpecIF = 545,
    ["Sponge Mixin configuration"] = 546,
    StackBlitz = 551,
    ["StackHawk Scanner Configuration"] = 714,
    Stale = 552,
    ["Starlake Data Pipeline"] = 690,
    Starship = 553,
    ["Statamic Blueprint"] = 554,
    ["Stella configuration file"] = 555,
    ["StrmPrivacy Data Connector"] = 763,
    ["StrmPrivacy Data Contract"] = 764,
    ["StrmPrivacy SimpleSchema"] = 761,
    ["StrmPrivacy Stream"] = 762,
    ["StrmPrivacy batch job configuration file"] = 760,
    ["Stryker Mutator"] = 558,
    ["StyleCop Analyzers Configuration"] = 559,
    ["Stylelint (.stylelintrc)"] = 560,
    ["Sublime Syntax"] = 765,
    ["Subsquid squid manifest"] = 810,
    ["Swagger API 2.0"] = 562,
    TSON = 587,
    TSTyche = 588,
    Talhelper = 564,
    ["Talisman configuration"] = 565,
    ["Taskfile config"] = 695,
    Taurus = 566,
    ["TestEnvironment.json"] = 575,
    ["TextMate Grammar"] = 574,
    ["Tier.run pricing.json"] = 569,
    Tikibase = 570,
    ["Traefik v2"] = 578,
    ["Traefik v2 File Provider"] = 579,
    ["Travis CI (.travis.yml)"] = 577,
    TunnelHub = 800,
    Turborepo = 576,
    Tye = 722,
    ["UET BuildConfig.json"] = 770,
    ["UI5 Manifest"] = 597,
    ["UNCORS configuration"] = 601,
    ["UTAM Page Object"] = 600,
    ["Ubuntu Server Autoinstall"] = 595,
    ["Uniswap Token List"] = 678,
    ["Unreal Engine Uplugin"] = 771,
    ["Unreal Engine Uproject"] = 772,
    ["Updatecli Compose"] = 730,
    ["Updatecli Policy Manifest"] = 731,
    ["Updatecli Policy Metadata"] = 732,
    Uplift = 768,
    ["User Journey Map"] = 698,
    V2Ray = 736,
    ["VSCode Code Snippets"] = 162,
    ["VSIX CLI publishing"] = 615,
    ["Vela Pipeline Configuration"] = 604,
    Vercel = 161,
    Visivo = 798,
    ["Web App Manifest"] = 622,
    ["Web types"] = 625,
    WebExtensions = 621,
    ["Webman package recipe"] = 742,
    ["Windows Package Manager Installer Manifest"] = 675,
    ["Windows Package Manager Locale Manifest"] = 676,
    ["Windows Package Manager Singleton Manifest"] = 674,
    ["Woodpecker pipeline config"] = 710,
    ["Wrangler CLI"] = 626,
    ["Xstate Machine"] = 728,
    ["Yarn Config (.yarnrc.yml)"] = 688,
    ["Yippee-Ki-JSON configuration YML"] = 680,
    ["aerleon.yml"] = 6,
    ["angular.json"] = 14,
    apko = 802,
    ...
    ["gitlab-ci"] = 278,
    ["global.json"] = 280,
    ["go-feature-flag Flag Configuration"] = 282,
    ...
    ["ide.host.json"] = 307,
    ["ifstate.conf"] = 308,
    ["imageoptimizer.json"] = 309,
    ["importmap.json"] = 312,
    ["ioBroker Configuration"] = 313,
    ["ioBroker JSON UI"] = 314,
    ["ioBroker Package manifest"] = 315,
    ["ize.toml"] = 767,
    ["jsconfig.json"] = 338,
    ["jscpd Configuration"] = 747,
    jsdoc = 666,
    ["k3d.yaml"] = 339,
    ["k9s plugin.yml"] = 341,
    ["kontinuous-config.yaml"] = 347,
    ["kontinuous-values.yaml"] = 346,
    ["kustomization.yaml"] = 348,
    ["label-commenter-config.yml"] = 349,
    ["latexindent configuration"] = 62,
    ["launchsettings.json"] = 350,
    lazydocker = 789,
    lazygit = 788,
    ["lego.json"] = 352,
    ["lerna.json"] = 353,
    ["lgtm.yml"] = 354,
    ["liblab.config.json"] = 355,
    ["libman.json"] = 356,
    ["license-report-config.json"] = 357,
    ["linkinator.config.json"] = 359,
    ["lint-staged (.lintstagedrc)"] = 646,
    ["local.settings.json"] = 364,
    ["localazy.json"] = 365,
    ["lotus.yaml"] = 363,
    ["lsdlschema.json"] = 366,
    ["markdown-lint-check"] = 706,
    mboats = 713,
    ["micro-settings.json"] = 782,
    ["mimetypes.json"] = 375,
    ["mirrord config"] = 647,
    mise = 648,
    ["mise-settings"] = 649,
    ...
    ["mtad.yaml"] = 651,
    ["mycode.json"] = 402,
    ["napari plugin manifest"] = 403,
    neoload = 661,
    ["nest-cli"] = 409,
    ["ninjs (News in JSON) 1.3"] = 408,
    ["ninjs (News in JSON) 2.0"] = 407,
    ["nixd configuration"] = 806,
    ["nlu.json"] = 410,
    ["nodemon.json"] = 412,
    ["noodl config"] = 712,
    now = 657,
    ...
    ["nswag.json"] = 418,
    ntangle = 419,
    ["nuclei-template.yaml"] = 416,
    ["nuget-project.json"] = 417,
    ["ocelot.json"] = 421,
    ["omnisharp.json"] = 422,
    ["openapi.json"] = 423,
    ["openfin.json"] = 430,
    ...
    ["ops.yaml"] = 427,
    ["package.json"] = 441,
    ["package.manifest"] = 442,
    ["partial-black.json"] = 89,
    ["pathfinder.yml"] = 445,
    ["pattern.json"] = 448,
    ["petstore-v1.0"] = 757,
    pgap_yaml_input_reader = 447,
    ["plagiarize-me.yaml"] = 452,
    ["plagiarize.yaml"] = 451,
    ["portman.json"] = 453,
    ["prettierrc.json"] = 460,
    ["prisma.yml"] = 461,
    ["project-1.0.0-beta3.json"] = 464,
    ["project-1.0.0-beta4.json"] = 465,
    ["project-1.0.0-beta5.json"] = 466,
    ["project-1.0.0-beta6.json"] = 467,
    ["project-1.0.0-beta8.json"] = 468,
    ["project-1.0.0-rc1.json"] = 469,
    ["project-1.0.0-rc2.json"] = 470,
    ["project.json"] = 463,
    ["prometheus.json"] = 471,
    ["prometheus.rules.json"] = 472,
    ["prometheus.rules.test.json"] = 473,
    ["proxies.json"] = 474,
    ["publiccode.yml"] = 475,
    ["pubspec.yaml"] = 476,
    ["pyrseas-0.8.json"] = 479,
    ["quilt.mod.json"] = 783,
    ["release drafter"] = 662,
    ["release-plz.toml"] = 491,
    ["rivet.yaml"] = 805,
    rockcraft = 501,
    rustfmt = 502,
    samt = 504,
    samtrc = 505,
    ["sarif-1.0.0.json"] = 507,
    ["sarif-2.0.0.json"] = 508,
    ["sarif-2.1.0"] = 518,
    ["sarif-2.1.0-rtm.2"] = 509,
    ["sarif-2.1.0-rtm.3"] = 511,
    ["sarif-2.1.0-rtm.4"] = 513,
    ["sarif-2.1.0-rtm.5"] = 515,
    ["sarif-2.1.0-rtm.6"] = 516,
    ["sarif-external-property-file-2.1.0"] = 519,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 510,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 512,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 514,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 517,
    ["schema.org - Action"] = 521,
    ["schema.org - ContactPoint"] = 522,
    ["schema.org - Place"] = 523,
    ["schema.org - Thing"] = 524,
    ["secrethub.yml"] = 785,
    ["semantic-release"] = 527,
    ["servicehub.config.json"] = 636,
    ["servicehub.service.json"] = 635,
    ["settings.job"] = 530,
    ["sfdx-hardis configuration"] = 532,
    ["size-limit configuration"] = 537,
    ["skaffold.yaml"] = 704,
    ["skyuxconfig.json"] = 539,
    snapcraft = 540,
    ["sqlc configuration"] = 548,
    ["stripe-app-local.json"] = 557,
    ["stripe-app.json"] = 556,
    swcrc = 691,
    ["task.json"] = 563,
    taskcat = 658,
    ["template.json"] = 567,
    ["templatsources.json"] = 568,
    ["theme.json"] = 571,
    ["tizen_workspace.json"] = 572,
    tldr = 573,
    tmuxinator = 644,
    ["transcend.yml"] = 580,
    ["tree-sitter grammar.json"] = 287,
    ["trunk.yaml"] = 581,
    ["ts-force-config.json"] = 585,
    ["tsconfig.json"] = 582,
    ["tsd.json"] = 583,
    ["tsdrc.json"] = 584,
    ["tslint.json"] = 586,
    ...
    ["vega-lite.json"] = 603,
    ["vega.json"] = 602,
    ["venvironment-basic.yaml"] = 606,
    ["venvironment.yaml"] = 605,
    ["version.json"] = 607,
    ["vim-addon-info"] = 609,
    ["vs-2017.3.host.json"] = 611,
    ["vs-nesting.json"] = 612,
    ["vsls.json"] = 610,
    ["vss-extension.json"] = 616,
    ["vtesttree.yaml"] = 617,
    ["vtestunit.yaml"] = 618,
    ["warp-keysets.json"] = 791,
    ["warp-themes.json"] = 792,
    ["warp-workflows.json"] = 793,
    ["webhint.io"] = 743,
    ["webjobpublishsettings.json"] = 624,
    ["webjobs-list.json"] = 623,
    ["xs-app.json"] = 654,
    ["xunit.runner.json"] = 634,
    yamllint = 679,
    zuul = 663,
    ["Žinoma"] = 673
  },
