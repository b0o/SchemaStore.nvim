...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 89,
    [".cryproj (generic)"] = 377,
    [".cryproj engine-5.2"] = 372,
    [".cryproj engine-5.3"] = 373,
    [".cryproj engine-5.4"] = 374,
    [".cryproj engine-5.5"] = 375,
    [".cryproj engine-dev"] = 376,
    [".csscomb.json"] = 91,
    [".csslintrc"] = 92,
    [".eslintrc"] = 125,
    [".esmrc.json"] = 119,
    ...
    [".mtaext"] = 383,
    [".nodehawkrc"] = 225,
    [".npmpackagejsonlintrc"] = 227,
    [".phraseapp.yml"] = 254,
    [".pmbot.yml"] = 247,
    [".postcssrc"] = 252,
    [".pre-commit-config.yml"] = 253,
    [".putout.json"] = 271,
    [".rehyperc"] = 276,
    [".remarkrc"] = 277,
    [".sprite files"] = 311,
    ...
    [".vsext"] = 353,
    [".yarnrc.yml"] = 415,
    ["<div>RIOTS' studio configuration"] = 356,
    ["API Builder"] = 412,
    ["AWS CloudFormation"] = 79,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 80,
    ["Airlock Microgateway"] = 4,
    ["Ansible Collection Galaxy"] = 10,
    ["Ansible Inventory"] = 9,
    ["Ansible Playbook"] = 8,
    ["Ansible Role"] = 7,
    ["Argo Workflows"] = 19,
    ["Avro Avsc"] = 21,
    ["Azure IoT Edge deployment"] = 24,
    ["Azure IoT Edge deployment template"] = 25,
    ["Azure IoT EdgeAgent deployment"] = 22,
    ["Azure IoT EdgeHub deployment"] = 23,
    ["Azure Pipelines"] = 26,
    ["Azure Static Web Apps CLI configuration file"] = 313,
    ["Azure Static Web Apps configuration file"] = 312,
    ["Better Code Hub"] = 417,
    BizTalkServerApplicationSchema = 389,
    Briefcase = 394,
    Buildkite = 47,
    ["Bukkit plugin.yml"] = 46,
    ["BungeeCord plugin.yml"] = 50,
    ["CMake Presets"] = 52,
    ["Camel YAML DSL"] = 53,
    Carafe = 54,
    ["Catalog Info Backstage"] = 55,
    ["Chrome Extension"] = 73,
    ["CircleCI config.yml"] = 59,
    ["Citation File Format"] = 81,
    CityJSON = 56,
    ["Code Climate"] = 60,
    ["Container Structure Test"] = 400,
    Containerlab = 425,
    ["Dart build configuration"] = 93,
    ["Dart test config"] = 94,
    ["Deployer Recipe"] = 100,
    ["Discord Webhook"] = 102,
    ["Dolittle Artifacts"] = 104,
    ["Dolittle Bounded Context Configuration"] = 105,
    ["Dolittle Event Horizons Configuration"] = 106,
    ["Dolittle Resources Configuration"] = 107,
    ["Dolittle Server Configuration"] = 108,
    ["Dolittle Tenant Map Configuration"] = 110,
    ["Dolittle Tenants Configuration"] = 109,
    ["Dolittle Topology"] = 111,
    ["Drush site aliases"] = 114,
    ["Eclipse Che Devfile"] = 117,
    Esquio = 120,
    ["Expo SDK"] = 124,
    ["F-Droid Data metadata"] = 128,
    ["Facets - FSDL - Application"] = 126,
    ["Fossa configuration file"] = 133,
    ["Foundry VTT - Manifest"] = 131,
    ["Foundry VTT - Template"] = 132,
    ["Foxx Manifest"] = 27,
    ["GatewayCore API Gateway"] = 136,
    ["GitHub Action"] = 140,
    ["GitHub Funding"] = 141,
    ["GitHub Issue Template configuration"] = 143,
    ["GitHub Workflow"] = 144,
    ["GitHub Workflow Template Properties"] = 145,
    ["GitHub issue forms"] = 142,
    GitVersion = 139,
    ["Gitpod Configuration"] = 147,
    ["Global Privacy Control"] = 137,
    ["Google Cloud Workflows"] = 78,
    Goreleaser = 150,
    ["Goreleaser Pro"] = 151,
    ["Gradle Build Cache Node"] = 414,
    ["Gradle Enterprise"] = 413,
    ["Grafana 5.x Dashboard"] = 152,
    ["GraphQL Code Generator"] = 155,
    ["GraphQL Config"] = 154,
    ["GraphQL Mesh"] = 153,
    ["Grunt JSHint task"] = 159,
    ["Grunt Watch task"] = 160,
    ["Grunt base task"] = 161,
    ["Grunt clean task"] = 157,
    ["Grunt copy task"] = 156,
    ["Grunt cssmin task"] = 158,
    HEMTT = 386,
    Hadolint = 398,
    ["Hammerkit YAML Schema"] = 424,
    Hayson = 163,
    ["Hazelcast 5 Configuration"] = 164,
    ["Helm Chart.lock"] = 58,
    ["Helm Chart.yaml"] = 57,
    ["JFrog File Spec"] = 176,
    ["JSON Document Transform"] = 184,
    ["JSON Feed"] = 185,
    ["JSON Resume"] = 279,
    ["JSON Schema Draft 2020-12"] = 368,
    ["JSON Schema Draft 4"] = 365,
    ["JSON Schema Draft 7"] = 366,
    ["JSON Schema Draft 8"] = 367,
    ["JSON schema for CodeShip Pro services configuration files"] = 66,
    ["JSON schema for CodeShip Pro steps configuration files"] = 67,
    ["JSON schema for Codecov configuration files"] = 65,
    ["JSON-API"] = 183,
    ["JSON-e templates"] = 422,
    ["JSON-stat 2.0"] = 362,
    JSONPatch = 187,
    ["Jekyll configuration"] = 173,
    ["Jenkins X Pipelines"] = 174,
    ["Jenkins X Requirements"] = 175,
    ["Jovo Language Models"] = 177,
    ["KSP-AVC"] = 363,
    ["KSP-CKAN"] = 364,
    Liquibase = 429,
    ["MegaLinter configuration"] = 201,
    ["MegaLinter descriptor"] = 202,
    ["Microsoft Band Web Tile"] = 203,
    ["Minecraft Data Pack Advancement"] = 205,
    ["Minecraft Data Pack Biome"] = 206,
    ["Minecraft Data Pack Configured Carver"] = 207,
    ["Minecraft Data Pack Dimension"] = 209,
    ["Minecraft Data Pack Dimension Type"] = 208,
    ["Minecraft Data Pack Item Modifier"] = 210,
    ["Minecraft Data Pack Loot Table"] = 211,
    ["Minecraft Data Pack Metadata"] = 212,
    ["Minecraft Data Pack Predicate"] = 213,
    ["Minecraft Data Pack Recipe"] = 214,
    ["Minecraft Data Pack Template Pool"] = 215,
    ["Minecraft Resourcepack Sounds"] = 216,
    ["Netin Diagnostic System Template"] = 436,
    ["Netlify config schema"] = 220,
    ["Nightwatch.js"] = 221,
    ["OSS Review Toolkit repository configuration"] = 241,
    Opctl = 385,
    ["OpenWeather Current Weather API"] = 421,
    ["OpenWeather Road Risk API"] = 420,
    ["Ory Hydra configuration"] = 168,
    ["Ory Keto configuration"] = 190,
    ["Ory Kratos configuration"] = 240,
    ["Ory Oathkeeper configuration"] = 232,
    ["Outblocks App configuration"] = 238,
    ["Outblocks database table"] = 239,
    ["Outblocks project configuration"] = 237,
    Packer = 244,
    ["Pipeline component"] = 430,
    ["PocketMine plugin.yml"] = 248,
    ["Pull Request Labeler"] = 270,
    ["RKE Cluster Configuration JSON Schema"] = 428,
    ["RKE Cluster Configuration YAML Schema"] = 427,
    Ray = 397,
    ["Read the Docs"] = 273,
    ["Red-DiscordBot Сog"] = 274,
    ["Red-DiscordBot Сog Repo"] = 275,
    Renovate = 280,
    RoadRunner = 281,
    SWADL = 321,
    ["Sapphire CLI Config"] = 282,
    ["SauceCTL Configuration"] = 433,
    ["Schema Catalog"] = 295,
    ["Scoop manifest"] = 300,
    ["Semgrep Rule"] = 301,
    Solidarity = 307,
    ["Source Maps v3"] = 308,
    SpecIF = 309,
    ["Sponge Mixin configuration"] = 310,
    ["StackHawk Scanner Configuration"] = 439,
    ["StackHead CLI config"] = 314,
    ["StackHead module configuration"] = 315,
    ["StackHead project definition"] = 316,
    Stale = 317,
    ["Stryker Mutator"] = 318,
    ["StyleCop Analyzers Configuration"] = 319,
    ["Swagger API 2.0"] = 322,
    ["Taskfile YAML Schema"] = 423,
    Taurus = 323,
    ["TestEnvironment.json"] = 328,
    ["Traefik v2"] = 330,
    ["Traefik v2 File Provider"] = 331,
    ["UI5 Manifest"] = 342,
    ["Uniswap Token List"] = 406,
    ["User Journey Map YAML Schema"] = 426,
    ["VSCode Code Snippets"] = 68,
    ["VSIX CLI publishing"] = 354,
    ["Vela Pipeline Configuration"] = 346,
    ["Web App Manifest"] = 358,
    ["Web types"] = 361,
    WebExtensions = 357,
    ["Windows Package Manager Installer Manifest"] = 403,
    ["Windows Package Manager Locale Manifest"] = 404,
    ["Windows Package Manager Singleton Manifest"] = 402,
    ["Woodpecker pipeline config"] = 435,
    ["Yippee-Ki-JSON configuration YML"] = 408,
    ["angular.json"] = 5,
    ["app-definition.yaml"] = 12,
    ...
    ["arc.json"] = 18,
    ["architect.yml"] = 17,
    ["artifacthub-repo.yml"] = 20,
    ["babelrc.json"] = 29,
    ["bamboo-spec"] = 32,
    ["batect.yml"] = 31,
    ["beau.yml"] = 416,
    ["beef-database-codegen"] = 33,
    ["beef-entity-codegen"] = 34,
    ["behat.yml"] = 42,
    ["bigquery-table"] = 35,
    ["bitbucket-pipelines"] = 36,
    bitrise = 37,
    ["bitrise-step"] = 38,
    ["block.json"] = 51,
    ["bower.json"] = 40,
    ["bozr.suite.json"] = 43,
    ["browser.i18n.json"] = 44,
    bucklescript = 45,
    ["bundleconfig.json"] = 49,
    ["chutzpah.json"] = 74,
    ["cloud-sdk-pipeline-config-schema"] = 76,
    ["cloudbuild.json"] = 77,
    cloudify = 63,
    codemagic = 64,
    ["coffeelint.json"] = 82,
    comet = 418,
    ["commands.json"] = 71,
    ["compile_commands.json"] = 70,
    ["compilerconfig.json"] = 69,
    ["component.json"] = 84,
    ["composer.json"] = 83,
    ["config.json"] = 85,
    ["contentmanifest.json"] = 75,
    ["contribute.json"] = 86,
    ["cosmos.config.json"] = 72,
    ["crowdin.yml"] = 87,
    cspell = 90,
    ["cypress.json"] = 88,
    ["datalogic-scan2deploy-android"] = 95,
    ["datalogic-scan2deploy-ce"] = 96,
    ["debugsettings.json"] = 97,
    ["dependabot-v2.json"] = 99,
    ["dependabot.json"] = 98,
    ["detekt.yml"] = 101,
    devinit = 410,
    ["docfx.json"] = 103,
    ["docker-compose.yml"] = 409,
    ["dotnetcli.host.json"] = 112,
    ["drone.json"] = 113,
    ["dss-2.0.0.json"] = 115,
    ["dvc.yaml"] = 116,
    ["ecosystem.json"] = 118,
    ["electron-builder configuration file."] = 122,
    ["epr-manifest.json"] = 121,
    ["evcc.yaml"] = 123,
    ["fabric.mod.json"] = 127,
    ["first-timers-bot"] = 130,
    fulibWorkflows = 434,
    ["func.yaml"] = 134,
    ["function.json"] = 135,
    ["geojson.json"] = 138,
    ["gitlab-ci"] = 146,
    ["global.json"] = 148,
    ["golangci-lint Configuration"] = 149,
    ["haxelib.json"] = 162,
    helmfile = 399,
    ["host-meta.json"] = 166,
    ["host.json"] = 165,
    ...
    httpmockrc = 390,
    huskyrc = 379,
    ["imageoptimizer.json"] = 169,
    ["ioBroker JSON UI"] = 171,
    ["ioBroker Package manifest"] = 172,
    ["jsconfig.json"] = 188,
    jsdoc = 396,
    ["k3d.yaml"] = 189,
    ["kustomization.yaml"] = 191,
    ["label-commenter-config.yml"] = 192,
    ["launchsettings.json"] = 193,
    ["lerna.json"] = 194,
    ["lgtm.yml"] = 195,
    ["libman.json"] = 196,
    ["license-report-config.json"] = 197,
    ["local.settings.json"] = 198,
    ["localazy.json"] = 199,
    ["lsdlschema.json"] = 200,
    ["markdownlint.json"] = 432,
    mboats = 438,
    ["mimetypes.json"] = 204,
    ["mta.yaml"] = 381,
    ["mtad.yaml"] = 382,
    ...
    neoload = 391,
    ["nest-cli"] = 223,
    ["ninjs (News in JSON)"] = 222,
    ["nlu.json"] = 224,
    ["nodemon.json"] = 226,
    ["noodl.schema.json"] = 437,
    now = 387,
    ["nswag.json"] = 230,
    ntangle = 231,
    ["nuclei-template.yaml"] = 228,
    ["nuget-project.json"] = 229,
    ["ocelot.json"] = 233,
    ["omnisharp.json"] = 234,
    ["openapi.json"] = 235,
    ["openfin.json"] = 236,
    ["package.json"] = 242,
    ["package.manifest"] = 243,
    ["pattern.json"] = 246,
    pgap_yaml_input_reader = 245,
    ["plagiarize-me.yaml"] = 250,
    ["plagiarize.yaml"] = 249,
    ["portman.json"] = 251,
    ["prettierrc.json"] = 255,
    ["prisma.yml"] = 256,
    ["project-1.0.0-beta3.json"] = 258,
    ["project-1.0.0-beta4.json"] = 259,
    ["project-1.0.0-beta5.json"] = 260,
    ["project-1.0.0-beta6.json"] = 261,
    ["project-1.0.0-beta8.json"] = 262,
    ["project-1.0.0-rc1.json"] = 263,
    ["project-1.0.0-rc2.json"] = 264,
    ["project.json"] = 257,
    ["prometheus.json"] = 265,
    ["prometheus.rules.json"] = 266,
    ["proxies.json"] = 267,
    ["publiccode.yml"] = 268,
    ["pubspec.yaml"] = 269,
    ["pyrseas-0.8.json"] = 272,
    ["release drafter"] = 392,
    ["sarif-1.0.0.json"] = 283,
    ["sarif-2.0.0.json"] = 284,
    ["sarif-2.1.0"] = 293,
    ["sarif-2.1.0-rtm.2"] = 285,
    ["sarif-2.1.0-rtm.3"] = 287,
    ["sarif-2.1.0-rtm.4"] = 289,
    ["sarif-2.1.0-rtm.5"] = 291,
    ["sarif-external-property-file-2.1.0"] = 294,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 286,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 288,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 290,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 292,
    ["schema.org - Action"] = 296,
    ["schema.org - ContactPoint"] = 297,
    ["schema.org - Place"] = 298,
    ["schema.org - Thing"] = 299,
    ["servicehub.config.json"] = 371,
    ["servicehub.service.json"] = 370,
    ["settings.job"] = 302,
    ["sfdx-hardis configuration"] = 303,
    ["size-limit configuration"] = 304,
    ["skaffold.yaml"] = 431,
    ["skyuxconfig.json"] = 305,
    snapcraft = 306,
    swcrc = 419,
    taskcat = 388,
    ["template.json"] = 324,
    ["templatsources.json"] = 325,
    ["theme.json"] = 326,
    tmLanguage = 327,
    ["trunk.yaml schema"] = 332,
    ["ts-force-config.json"] = 336,
    ["tsconfig.json"] = 333,
    ["tsd.json"] = 334,
    ["tsdrc.json"] = 335,
    ["tslint.json"] = 337,
    ...
    ["version.json"] = 347,
    ["vim-addon-info"] = 348,
    ["vs-2017.3.host.json"] = 350,
    ["vs-nesting.json"] = 351,
    ["vsls.json"] = 349,
    ["vss-extension.json"] = 355,
    ["webjobpublishsettings.json"] = 360,
    ["webjobs-list.json"] = 359,
    ["xs-app.json"] = 384,
    ["xunit.runner.json"] = 369,
    yamllint = 407,
    zuul = 393,
    ["Žinoma"] = 401
  },
