...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 119,
    [".cryproj (generic)"] = 442,
    [".cryproj engine-5.2"] = 437,
    [".cryproj engine-5.3"] = 438,
    [".cryproj engine-5.4"] = 439,
    [".cryproj engine-5.5"] = 440,
    [".cryproj engine-dev"] = 441,
    [".csscomb.json"] = 121,
    [".csslintrc"] = 122,
    [".eslintrc"] = 161,
    [".esmrc.json"] = 154,
    ...
    [".mtaext"] = 448,
    [".nodehawkrc"] = 274,
    [".npmpackagejsonlintrc"] = 276,
    [".phraseapp.yml"] = 308,
    [".pmbot.yml"] = 300,
    [".postcssrc"] = 305,
    [".pre-commit-config.yml"] = 306,
    [".pre-commit-hooks.yml"] = 307,
    [".putout.json"] = 325,
    [".rehyperc"] = 331,
    [".remarkrc"] = 332,
    [".sprite files"] = 371,
    ...
    [".vsext"] = 418,
    [".yarnrc.yml"] = 480,
    ["<div>RIOTS' studio configuration"] = 421,
    ["API Builder"] = 477,
    ["AVA Configuration Schema"] = 528,
    ...
    ["Azure Pipelines"] = 41,
    ["Azure Static Web Apps CLI configuration file"] = 373,
    ["Azure Static Web Apps configuration file"] = 372,
    ["BX CI"] = 70,
    ["Better Code Hub"] = 482,
    BizTalkServerApplicationSchema = 454,
    ...
    ["Butane config schema"] = 515,
    ["CICS TS region tagging"] = 522,
    ["CICS TS resource import"] = 523,
    ["CICS TS resource model"] = 524,
    ["CICS TS resource overrides"] = 525,
    ["CMake Presets"] = 71,
    ...
    ["Container Structure Test"] = 465,
    Containerlab = 489,
    ["Dart build configuration"] = 123,
    ["Dart test config"] = 124,
    ["DashLord configuration"] = 125,
    ["Datadog Service Catalog Definition"] = 232,
    ["Datahub Ingestion Recipe Schema"] = 529,
    ["Dein Config Schema"] = 83,
    Deno = 129,
    ["Deployer Recipe"] = 132,
    Devfile = 151,
    ["Discord Webhook"] = 134,
    ["Dolittle Artifacts"] = 137,
    ["Dolittle Bounded Context Configuration"] = 138,
    ["Dolittle Event Horizons Configuration"] = 139,
    ["Dolittle Resources Configuration"] = 140,
    ["Dolittle Server Configuration"] = 141,
    ["Dolittle Tenant Map Configuration"] = 143,
    ["Dolittle Tenants Configuration"] = 142,
    ["Dolittle Topology"] = 144,
    ["Drush site aliases"] = 148,
    ["Embrace Config Schema"] = 539,
    ["Error pages"] = 157,
    Esquio = 155,
    ["Estuary Flow Catalog Schema"] = 519,
    ["Expo SDK"] = 160,
    ["F-Droid Data metadata"] = 164,
    ["Facets - FSDL - Application"] = 162,
    ["Fossa configuration file"] = 169,
    ["Fossa's fossa-deps file"] = 170,
    ["Foundry VTT - Manifest"] = 167,
    ["Foundry VTT - Template"] = 168,
    ["Foxx Manifest"] = 42,
    ["GatewayCore API Gateway"] = 173,
    ["GeoJSON.json latest"] = 517,
    GherKing = 521,
    ["GitHub Action"] = 177,
    ["GitHub Funding"] = 178,
    ["GitHub Issue Template configuration"] = 180,
    ["GitHub Workflow"] = 181,
    ["GitHub Workflow Template Properties"] = 182,
    ["GitHub issue forms"] = 179,
    GitVersion = 176,
    ["Gitpod Configuration"] = 184,
    ["Global Privacy Control"] = 174,
    ["Google Cloud Workflows"] = 107,
    Goreleaser = 187,
    ["Goreleaser Pro"] = 188,
    ["Gradle Build Cache Node"] = 479,
    ["Gradle Enterprise"] = 478,
    ["Grafana 5.x Dashboard"] = 189,
    ["GraphQL Code Generator"] = 192,
    ["GraphQL Config"] = 191,
    ["GraphQL Mesh"] = 190,
    ["Grunt JSHint task"] = 196,
    ["Grunt Watch task"] = 197,
    ["Grunt base task"] = 198,
    ["Grunt clean task"] = 194,
    ["Grunt copy task"] = 193,
    ["Grunt cssmin task"] = 195,
    HEMTT = 451,
    Hadolint = 463,
    ["Hardware Sentry Configuration"] = 533,
    Hayson = 200,
    ["Haystack Pipeline"] = 201,
    ["Hazelcast 5 Configuration"] = 202,
    ["Helm Chart.lock"] = 85,
    ["Helm Chart.yaml"] = 84,
    Hugo = 511,
    ["Istanbul Schema"] = 536,
    ["JFrog File Spec"] = 217,
    ["JSON Document Transform"] = 225,
    ["JSON Feed"] = 226,
    ["JSON Resume"] = 335,
    ["JSON Schema Draft 2020-12"] = 433,
    ["JSON Schema Draft 4"] = 430,
    ["JSON Schema Draft 7"] = 431,
    ["JSON Schema Draft 8"] = 432,
    ...
    ["JSON-API"] = 224,
    ["JSON-e templates"] = 487,
    ["JSON-stat 2.0"] = 427,
    JSONPatch = 228,
    Jasmine = 213,
    Jekyll = 214,
    ["Jenkins X Pipelines"] = 215,
    ["Jenkins X Requirements"] = 216,
    ["Jovo Language Models"] = 218,
    ["KSP-AVC"] = 428,
    ["KSP-CKAN"] = 429,
    ["KoDE/CI build.yaml"] = 538,
    KrakenD = 231,
    ["LinkML Metamodel"] = 242,
    Liquibase = 493,
    Markdownlint = 496,
    ["MegaLinter configuration"] = 246,
    ["MegaLinter descriptor"] = 247,
    ["Meltano plugin discovery definition"] = 249,
    ["Meltano project definition"] = 248,
    ["Microsoft Band Web Tile"] = 250,
    ["Minecraft Data Pack Advancement"] = 252,
    ["Minecraft Data Pack Biome"] = 253,
    ["Minecraft Data Pack Configured Carver"] = 254,
    ["Minecraft Data Pack Dimension"] = 256,
    ["Minecraft Data Pack Dimension Type"] = 255,
    ["Minecraft Data Pack Item Modifier"] = 257,
    ["Minecraft Data Pack Loot Table"] = 258,
    ["Minecraft Data Pack Metadata"] = 259,
    ["Minecraft Data Pack Predicate"] = 260,
    ["Minecraft Data Pack Recipe"] = 261,
    ["Minecraft Data Pack Template Pool"] = 262,
    ["Minecraft Resourcepack Sounds"] = 263,
    ["MongoDB Atlas Search Index Definition Schema"] = 537,
    ["Monika Configuration Schema"] = 535,
    ["Netin Diagnostic System Template"] = 500,
    ["Netlify config schema"] = 268,
    ["Nightwatch.js"] = 269,
    ["OSS Review Toolkit curation"] = 291,
    ["OSS Review Toolkit package configuration"] = 292,
    ["OSS Review Toolkit repository configuration"] = 293,
    ["OSS Review Toolkit resolutions"] = 294,
    Opctl = 450,
    ["OpenWeather Current Weather API"] = 486,
    ["OpenWeather Road Risk API"] = 485,
    ["Ory Hydra configuration"] = 206,
    ["Ory Keto configuration"] = 233,
    ["Ory Kratos configuration"] = 290,
    ["Ory Oathkeeper configuration"] = 281,
    ["Outblocks App configuration"] = 288,
    ["Outblocks database table"] = 289,
    ["Outblocks project configuration"] = 287,
    Packer = 297,
    ["Pipeline component"] = 494,
    ["PocketMine plugin.yml"] = 301,
    Pterodactyl = 532,
    ["Pull Request Labeler"] = 324,
    PyProject = 328,
    Qodana = 508,
    ["Quali Torque Blueprint Spec 2"] = 530,
    ["RKE Cluster Configuration JSON Schema"] = 492,
    ["RKE Cluster Configuration YAML Schema"] = 491,
    Ray = 462,
    ["Read the Docs"] = 327,
    ["Red-DiscordBot Cog"] = 329,
    ["Red-DiscordBot Cog Repo"] = 330,
    Renovate = 336,
    ["Replit schema"] = 333,
    RoadRunner = 337,
    ["Rust toolchain"] = 339,
    SWADL = 383,
    ["Sapphire CLI Config"] = 340,
    ["SauceCTL Configuration"] = 497,
    ["Schema Catalog"] = 353,
    ["Scoop manifest"] = 358,
    ["Semgrep Rule"] = 360,
    ["Serverless Framework Configuration"] = 504,
    ["Settings.paf"] = 362,
    ["Shopware 6 Configuration"] = 505,
    ["Shopware CLI Extension Store Configuration"] = 506,
    ["Shopware CLI Project Store Configuration"] = 507,
    Solidarity = 367,
    ["Source Maps v3"] = 368,
    SpecIF = 369,
    ["Sponge Mixin configuration"] = 370,
    ["StackHawk Scanner Configuration"] = 503,
    ["StackHead CLI config"] = 374,
    ["StackHead module configuration"] = 375,
    ["StackHead project definition"] = 376,
    Stale = 377,
    Starship = 378,
    ["Statamic Blueprint"] = 379,
    ["Stryker Mutator"] = 380,
    ["StyleCop Analyzers Configuration"] = 381,
    ["Swagger API 2.0"] = 384,
    ["Talisman configuration"] = 385,
    ["Taskfile YAML Schema"] = 488,
    Taurus = 386,
    ["TestEnvironment.json"] = 392,
    Tikibase = 389,
    ["Traefik v2"] = 394,
    ["Traefik v2 File Provider"] = 395,
    Tye = 509,
    ["UI5 Manifest"] = 407,
    ["Ubuntu Server Autoinstall"] = 405,
    ["Uniswap Token List"] = 471,
    Updatecli = 516,
    ["User Journey Map YAML Schema"] = 490,
    V2Ray = 520,
    ["VSCode Code Snippets"] = 97,
    ["VSIX CLI publishing"] = 419,
    ["Vela Pipeline Configuration"] = 411,
    Vercel = 96,
    ["Web App Manifest"] = 423,
    ["Web types"] = 426,
    WebExtensions = 422,
    ["Webman package recipe"] = 526,
    ["Windows Package Manager Installer Manifest"] = 468,
    ["Windows Package Manager Locale Manifest"] = 469,
    ["Windows Package Manager Singleton Manifest"] = 467,
    ["Woodpecker pipeline config"] = 499,
    ["Xstate Machine Schema"] = 514,
    ["Yippee-Ki-JSON configuration YML"] = 473,
    ["angular.json"] = 8,
    ...
    cspell = 120,
    ["cypress.json"] = 118,
    ["datalogic-scan2deploy-android"] = 126,
    ["datalogic-scan2deploy-ce"] = 127,
    ["debugsettings.json"] = 128,
    ["dependabot-v2.json"] = 131,
    ["dependabot.json"] = 130,
    ["deployed-cli"] = 513,
    ["detekt.yml"] = 133,
    devinit = 475,
    ["devspace.yaml"] = 534,
    ["docfx.json"] = 136,
    ["docker-compose.yml"] = 474,
    ["dockerd.json"] = 135,
    ["dotnet Release Index manifest"] = 145,
    ["dotnetcli.host.json"] = 146,
    ["drone.json"] = 147,
    ["dss-2.0.0.json"] = 149,
    ["dvc.yaml"] = 150,
    ["ecosystem.json"] = 152,
    eksctl = 153,
    ["electron-builder configuration file."] = 158,
    ["epr-manifest.json"] = 156,
    ["evcc.yaml"] = 159,
    ["fabric.mod.json"] = 163,
    ["first-timers-bot"] = 166,
    ["fly.io Schema"] = 43,
    fulibWorkflows = 498,
    ["func.yaml"] = 171,
    ["function.json"] = 172,
    ...
    ["gitlab-ci"] = 183,
    ["global.json"] = 185,
    ["golangci-lint Configuration"] = 186,
    ["haxelib.json"] = 199,
    helmfile = 464,
    ["host-meta.json"] = 204,
    ["host.json"] = 203,
    ...
    huskyrc = 444,
    ["ide.host.json"] = 207,
    ["imageoptimizer.json"] = 208,
    ["importmap.json"] = 210,
    ["ioBroker JSON UI"] = 211,
    ["ioBroker Package manifest"] = 212,
    ["jsconfig.json"] = 229,
    ["jscpd Configuration Schema"] = 531,
    jsdoc = 461,
    ["k3d.yaml"] = 230,
    ["kustomization.yaml"] = 234,
    ["label-commenter-config.yml"] = 235,
    ["launchsettings.json"] = 236,
    ["lerna.json"] = 237,
    ["lgtm.yml"] = 238,
    ["libman.json"] = 239,
    ["license-report-config.json"] = 240,
    ["linkinator.config.json"] = 241,
    ["local.settings.json"] = 243,
    ["localazy.json"] = 244,
    ["lsdlschema.json"] = 245,
    mboats = 502,
    ["mimetypes.json"] = 251,
    ...
    ["mtad.yaml"] = 447,
    ["mycode.json"] = 266,
    ["napari plugin manifest"] = 267,
    neoload = 456,
    ["nest-cli"] = 272,
    ["ninjs (News in JSON) 1.3"] = 271,
    ["ninjs (News in JSON) 2.0"] = 270,
    ["nlu.json"] = 273,
    ["nodemon.json"] = 275,
    ["noodl.schema.json"] = 501,
    now = 452,
    ["nswag.json"] = 279,
    ntangle = 280,
    ["nuclei-template.yaml"] = 277,
    ["nuget-project.json"] = 278,
    ["ocelot.json"] = 282,
    ["omnisharp.json"] = 283,
    ["openapi.json"] = 284,
    ["openfin.json"] = 286,
    ...
    ["prettierrc.json"] = 309,
    ["prisma.yml"] = 310,
    ["project-1.0.0-beta3.json"] = 312,
    ["project-1.0.0-beta4.json"] = 313,
    ["project-1.0.0-beta5.json"] = 314,
    ["project-1.0.0-beta6.json"] = 315,
    ["project-1.0.0-beta8.json"] = 316,
    ["project-1.0.0-rc1.json"] = 317,
    ["project-1.0.0-rc2.json"] = 318,
    ["project.json"] = 311,
    ["prometheus.json"] = 319,
    ["prometheus.rules.json"] = 320,
    ["proxies.json"] = 321,
    ["publiccode.yml"] = 322,
    ["pubspec.yaml"] = 323,
    ["pyrseas-0.8.json"] = 326,
    ["release drafter"] = 457,
    rustfmt = 338,
    ["sarif-1.0.0.json"] = 341,
    ["sarif-2.0.0.json"] = 342,
    ["sarif-2.1.0"] = 351,
    ["sarif-2.1.0-rtm.2"] = 343,
    ["sarif-2.1.0-rtm.3"] = 345,
    ["sarif-2.1.0-rtm.4"] = 347,
    ["sarif-2.1.0-rtm.5"] = 349,
    ["sarif-external-property-file-2.1.0"] = 352,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 344,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 346,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 348,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 350,
    ["schema.org - Action"] = 354,
    ["schema.org - ContactPoint"] = 355,
    ["schema.org - Place"] = 356,
    ["schema.org - Thing"] = 357,
    ["semantic-release"] = 359,
    ["servicehub.config.json"] = 436,
    ["servicehub.service.json"] = 435,
    ["settings.job"] = 361,
    ["sfdx-hardis configuration"] = 363,
    ["size-limit configuration"] = 364,
    ["skaffold.yaml"] = 495,
    ["skyuxconfig.json"] = 365,
    snapcraft = 366,
    swcrc = 484,
    taskcat = 453,
    ["template.json"] = 387,
    ["templatsources.json"] = 388,
    ["theme.json"] = 390,
    tmLanguage = 391,
    ["trunk.yaml schema"] = 396,
    ["ts-force-config.json"] = 400,
    ["tsconfig.json"] = 397,
    ["tsd.json"] = 398,
    ["tsdrc.json"] = 399,
    ["tslint.json"] = 401,
    ...
    ["version.json"] = 412,
    ["vim-addon-info"] = 413,
    ["vs-2017.3.host.json"] = 415,
    ["vs-nesting.json"] = 416,
    ["vsls.json"] = 414,
    ["vss-extension.json"] = 420,
    ["webhint.io"] = 527,
    ["webjobpublishsettings.json"] = 425,
    ["webjobs-list.json"] = 424,
    ["xs-app.json"] = 449,
    ["xunit.runner.json"] = 434,
    yamllint = 472,
    zuul = 458,
    ["Žinoma"] = 466
  },
