...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 981,
    [".nodehawkrc"] = 617,
    [".npmpackagejsonlintrc"] = 621,
    [".omletrc"] = 1160,
    [".phrase.yml"] = 696,
    [".phraseapp.yml"] = 697,
    [".pmbot.yml"] = 681,
    [".postcssrc"] = 690,
    [".powerpages-web-template-manifest"] = 692,
    [".pre-commit-config.yml"] = 693,
    [".pre-commit-hooks.yml"] = 694,
    [".putout.json"] = 730,
    [".rehyperc"] = 755,
    [".remarkrc"] = 759,
    [".sprite files"] = 855,
    ...
    AIConfig = 35,
    ["AMX Muse Program Descriptor"] = 1208,
    ["API Builder"] = 1016,
    ["AVA Configuration"] = 1079,
    ...
    ["AWS Copilot Manifest"] = 1247,
    ["AWS SAM CLI Samconfig"] = 273,
    Acton = 1297,
    ["Adobe UXP Manifest"] = 1142,
    ["Aerleon Network & Service Definitions"] = 21,
    ["Aerleon Policy"] = 22,
    ["Agent Permission Policy"] = 1287,
    ["AgentCore CLI"] = 1288,
    Aider = 1237,
    Air = 24,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1258,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1257,
    ["Airlock Microgateway"] = 36,
    ["Alacritty Configuration"] = 1051,
    ["All Contributors configuration file"] = 1105,
    ["Ansible Argument Specs"] = 431,
    ["Ansible Collection Galaxy"] = 438,
    ["Ansible Execution Environment"] = 428,
    ["Ansible Inventory"] = 437,
    ["Ansible Meta"] = 429,
    ["Ansible Meta Runtime"] = 430,
    ["Ansible Navigator Configuration"] = 440,
    ["Ansible Playbook"] = 435,
    ["Ansible Requirements"] = 432,
    ["Ansible Rulebook"] = 436,
    ["Ansible Tasks File"] = 434,
    ["Ansible Vars File"] = 433,
    ["Ansible-lint Configuration"] = 439,
    Any = 1170,
    ...
    ["Application list for a WinUtil"] = 1187,
    ArchitectFX = 1192,
    ["Argo CD"] = 55,
    ["Argo Events"] = 56,
    ["Argo Workflows"] = 57,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1256,
    ["Azure IoT Operations connector metadata"] = 1253,
    ...
    ["Azure Pipelines"] = 115,
    ["Azure Static Web Apps CLI configuration file"] = 859,
    ["Azure Static Web Apps configuration file"] = 858,
    BMML = 1275,
    ["BOSH CPI Config"] = 141,
    ...
    ["Bacon config"] = 6,
    ["Barba-CV"] = 84,
    ["Bashly (bashly.yml)"] = 1109,
    ["Bashly Settings (bashly-settings.yml)"] = 1110,
    Bento = 1274,
    ["Better Code Hub"] = 1021,
    ["Better Scripts"] = 164,
    Bigconfig = 134,
    ["Biome Formatter Config"] = 85,
    ["Bitmovin Encoding Template"] = 1201,
    BizTalkServerApplicationSchema = 988,
    Bleep = 165,
    ["Block Protocol Metadata"] = 162,
    ["Bluebricks blueprint config"] = 1280,
    ["Boyka Framework"] = 143,
    ...
    ["Butane Config"] = 1064,
    C4InterFlow = 1216,
    ["CDK Environment Manager, concrete environment configuration"] = 1240,
    ["CDK Environment Manager, concrete environments definition"] = 1239,
    ["CDK Environment Manager, environment definition"] = 1238,
    ["CGS Card Game Specification (cgs.json)"] = 1147,
    ["CICS TS region tagging"] = 1073,
    ["CICS TS resource import"] = 1074,
    ["CICS TS resource model"] = 1075,
    ["CICS TS resource overrides"] = 1076,
    ["CMake Presets"] = 166,
    ["CNC Codes"] = 188,
    ["CRS WAF test file"] = 1177,
    ["CRS WAF test platform overrides file"] = 1178,
    ...
    ["Chamaleon environment"] = 1205,
    ["Chamaleon properties"] = 1206,
    ["Chamaleon template"] = 1204,
    Changepacks = 1267,
    Changesets = 282,
    Changie = 175,
    Charmcraft = 176,
    ...
    ["Clawject config"] = 194,
    ["Cloud Foundry Application Manifest"] = 1159,
    ["Cloud Run Spec v1"] = 1182,
    ...
    Concord = 1176,
    ["Configu .cfgu files"] = 1164,
    ["Configu .configu file"] = 1165,
    Conjure = 187,
    ["Container Structure Test"] = 1002,
    Containerlab = 1030,
    ["Contextive Glossary"] = 1232,
    Convex = 186,
    ["Crowdsec collection config"] = 292,
    ["Crowdsec parser config"] = 293,
    ["Crowdsec scenario config"] = 294,
    ["CumulusCI Config"] = 193,
    ["Cursor Agent Environment"] = 1285,
    ["Custom Machinery Machine"] = 1148,
    ["Custom Machinery Recipe"] = 1149,
    ...
    ["DataYoga Job"] = 204,
    ["Datadog Continuous Testing"] = 529,
    ["Datadog Service Definition"] = 530,
    ["Datadog Software Catalog"] = 531,
    ["Datahub Ingestion Recipe"] = 1080,
    ["Debian Upstream Metadata file"] = 211,
    ["Deck config"] = 212,
    ["Declarative Automation Bundles"] = 1126,
    ["DeepMatch deeplinks spec"] = 213,
    ["Dein Config"] = 214,
    ["Deno Config (deno.json)"] = 310,
    ["Dependency cruiser"] = 215,
    ["DeployStack Configuration"] = 216,
    ["Deployah Configuration"] = 1255,
    ["Deployer Recipe"] = 313,
    ["Deta Spacefile"] = 217,
    ...
    ["DonateCaseBetterCasino menu"] = 1209,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1117,
    ["EAS config"] = 381,
    ["ECA - Editor Code Assistant"] = 345,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1106,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1252,
    ["EasyVCR .NET"] = 383,
    ["Eidolon Resource"] = 1193,
    ["Elgato Stream Deck"] = 347,
    Elm = 1181,
    ["Embrace Config"] = 1092,
    Endurica = 1130,
    ["Enonic XP API descriptor"] = 350,
    ["Enonic XP Admin Extension descriptor"] = 351,
    ["Enonic XP Admin Tool descriptor"] = 352,
    ["Enonic XP Application descriptor"] = 353,
    ["Enonic XP CMS descriptor"] = 354,
    ["Enonic XP Content Type descriptor"] = 355,
    ["Enonic XP Form Fragment descriptor"] = 356,
    ["Enonic XP ID Provider descriptor"] = 357,
    ["Enonic XP Layout descriptor"] = 358,
    ["Enonic XP Macro descriptor"] = 359,
    ["Enonic XP Mixin descriptor"] = 360,
    ["Enonic XP Page descriptor"] = 361,
    ["Enonic XP Part descriptor"] = 362,
    ["Enonic XP Service descriptor"] = 363,
    ["Enonic XP Site descriptor"] = 364,
    ["Enonic XP Style descriptor"] = 365,
    ["Enonic XP Task descriptor"] = 366,
    ["Enonic XP Webapp descriptor"] = 367,
    ["Enterprise Contract Policy Spec"] = 348,
    ["Envelope Team Definition"] = 1296,
    ["Envilder Map File"] = 349,
    ["Erda Pipeline"] = 1155,
    ["Erda Runtime"] = 1156,
    ["Espanso config.yml"] = 1278,
    ["Espanso match.yml"] = 1277,
    Esquio = 369,
    ["Estuary Flow Catalog"] = 1070,
    ["Ethereum ERC1155"] = 1290,
    ["Ethereum ERC721"] = 1289,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 374,
    ["EveryVoice TTS Toolkit Data Configuration"] = 375,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 379,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 378,
    ["EveryVoice TTS Toolkit Text Configuration"] = 376,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 377,
    ["Evolving Resolutive Process notation"] = 1254,
    ["Expo SDK"] = 380,
    ["Expoot app config"] = 382,
    ["F-Droid Data metadata"] = 387,
    ["FasterCI Configuration"] = 116,
    ["Fence configuration"] = 117,
    FiQuS = 391,
    Firebase = 389,
    ["Flatpak Builder Manifest"] = 392,
    ["FlexGet Config"] = 393,
    ["Flow.json Configurations"] = 1152,
    ["Fossa configuration file"] = 400,
    ["Fossa's fossa-deps file"] = 401,
    ["Foundry VTT - Base package Manifest"] = 395,
    ["Foundry VTT - Module Manifest"] = 396,
    ["Foundry VTT - System Data Template"] = 399,
    ["Foundry VTT - System Manifest"] = 397,
    ["Foundry VTT - World Manifest"] = 398,
    ["Foxx Manifest"] = 118,
    ["Freifunk.de Community API"] = 121,
    ["Frogbot Config"] = 122,
    ["G2P Mapping Configuration"] = 407,
    ["GCP Blueprint Metadata"] = 410,
    Gaspar = 408,
    ["GatewayCore API Gateway"] = 409,
    ["Gemini CLI settings"] = 411,
    ["GeoJSON.json latest"] = 1068,
    GherKing = 1072,
    ["GitHub Action"] = 416,
    ["GitHub Actions typing"] = 1189,
    ["GitHub Discussion"] = 417,
    ["GitHub Funding"] = 418,
    ["GitHub Issue Template configuration"] = 419,
    ["GitHub Issue Template forms"] = 420,
    ["GitHub Pages Jekyll"] = 421,
    ["GitHub Workflow"] = 422,
    ["GitHub Workflow Template Properties"] = 423,
    ["GitHub automatically generated release notes configuration"] = 424,
    ["GitLab Agent for Kubernetes configuration"] = 1144,
    GitVersion = 413,
    ["Gitea Issue Template configuration"] = 414,
    ["Gitea Issue Template forms"] = 415,
    ["Gitpod Automations"] = 426,
    ["Gitpod Configuration"] = 427,
    ["GlazeWM settings"] = 1146,
    ["Global Privacy Control"] = 412,
    Goblet = 1125,
    ["Golangci-lint Configuration"] = 442,
    ["Golangci-lint Custom Plugins Configuration"] = 443,
    ["Google Chrome Related Website Sets"] = 390,
    ["Google Cloud Workflows"] = 269,
    ["Google Digital Assetlinks"] = 1233,
    Goreleaser = 445,
    ["Goreleaser Pro"] = 446,
    Goss = 447,
    ["Gradle Build Cache Node"] = 1019,
    ["Gradle Enterprise"] = 1018,
    ["Grafana 5.x Dashboard"] = 448,
    ["GraphQL Code Generator"] = 453,
    ["GraphQL Config"] = 452,
    ["GraphQL Mesh"] = 451,
    ["GroovyLint configuration"] = 454,
    ["Grunt JSHint task"] = 458,
    ["Grunt Watch task"] = 459,
    ["Grunt base task"] = 460,
    ["Grunt clean task"] = 456,
    ["Grunt copy task"] = 455,
    ["Grunt cssmin task"] = 457,
    HEMTT = 984,
    Hadolint = 998,
    Hammerkit = 1029,
    ["Hardware Sentry Configuration"] = 1084,
    ["Hashgraph Online Skill Manifest"] = 2,
    ["HashiCorp Vault"] = 461,
    Hatch = 999,
    Hayson = 463,
    ["Haystack Pipeline"] = 464,
    ["Hazelcast 5 Configuration"] = 465,
    ["Hecate Input Schema"] = 1244,
    ["Helm Chart.lock"] = 235,
    ["Helm Chart.yaml"] = 234,
    ["Helm Unittest Test Suite"] = 236,
    ["Home Assistant Integration Manifest"] = 466,
    ["Homer dashboard configuration"] = 467,
    Hugo = 1060,
    ["Hugo Theme"] = 1059,
    ["Hulak Configuration"] = 474,
    ["Hyperfoil benchmark configuration"] = 473,
    ["IBM Zapp document"] = 475,
    ["IBM zCodeFormatSettings"] = 476,
    ["IMG Catapult PSP"] = 481,
    ["IVMS101 by CODE Protocol"] = 1145,
    Infrahub = 483,
    Istanbul = 1088,
    ["JDownloader2 crawler multi-rules"] = 496,
    ["JDownloader2 crawler single-rules"] = 495,
    ["JFrog Applications Config"] = 497,
    ["JFrog File Spec"] = 498,
    ["JFrog Pipelines YML DSL"] = 1094,
    ["JMeter DSL cli config"] = 499,
    JReleaser = 502,
    ["JSON Document Transform"] = 510,
    ["JSON Feed"] = 511,
    ["JSON Resume"] = 767,
    ["JSON Schema Draft 2020-12"] = 966,
    ["JSON Schema Draft 4"] = 963,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1127,
    ["JSON Schema Draft 7"] = 964,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1128,
    ["JSON Schema Draft 8 (2019-09)"] = 965,
    ["JSON-API"] = 509,
    ["JSON-e templates"] = 1026,
    ["JSON-stat 2.0"] = 959,
    JSONPatch = 513,
    ["JSR Package Config (jsr.json)"] = 503,
    Jarl = 1260,
    Jasmine = 490,
    Jekyll = 491,
    ["Jenkins X Pipelines"] = 492,
    ["Jenkins X Requirements"] = 493,
    Jest = 494,
    Jocker = 500,
    ["Jovo Language Models"] = 501,
    ["Jujutsu (jj) VCS config"] = 1246,
    ["KIMMDY config file"] = 524,
    ["KODE/CI build.yaml"] = 1090,
    ["KSP-AVC"] = 960,
    ["KSP-CKAN"] = 961,
    ["KSP-NetKAN"] = 962,
    KSY = 1157,
    KSail = 405,
    ["KYA Manifest"] = 1158,
    ["Karakum configuration file"] = 402,
    Kas = 516,
    ["Kestra flow file"] = 525,
    ["Keycloak REST API"] = 1097,
    ["Knative Functions - func.yaml"] = 403,
    Knip = 404,
    ["Knowledge Unit"] = 533,
    ["Kometa (nightly) config file"] = 527,
    ["Kometa config file"] = 526,
    ["Kong DBLess config"] = 1091,
    KrakenD = 528,
    ["Kubri Configuration"] = 536,
    LOOBin = 551,
    ["Lake configuration file"] = 1249,
    ...
    ["Lando (landofile)"] = 111,
    ["LangGraph Platform configuration"] = 1169,
    ["Language configuration"] = 1168,
    Lefthook = 540,
    ["Liferay client-extension.yaml"] = 547,
    ["LinkML Metamodel"] = 549,
    Liquibase = 1035,
    ["Liquibase Flow File"] = 1036,
    ["Lively Properties"] = 550,
    ["Lobe AI Agent"] = 113,
    Loki = 114,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 593,
    ["MS2Rescore Configuration"] = 598,
    ["Madness (madness.yml)"] = 1108,
    ["Mado configuration"] = 557,
    ["Maestro Flow"] = 558,
    ["Mail Servers Configuration"] = 1281,
    ["MapEHR Mapping"] = 559,
    Markdownlint = 1039,
    ["Mason Registry"] = 1042,
    ["MegaLinter Custom Flavor"] = 562,
    ["MegaLinter configuration"] = 561,
    ["MegaLinter descriptor"] = 563,
    Melange = 1135,
    ["Meltano project definition"] = 564,
    ["Mergify Configuration"] = 599,
    ["Metadata for a Bazel module"] = 565,
    ["Metadata for a Cinnamon spice"] = 1185,
    ["Metatype Configuration"] = 566,
    ["MetricsHub Configuration"] = 567,
    ["MetricsHub Connector Configuration"] = 568,
    ["Micro Editor Syntax"] = 1118,
    ["Microsoft Band Web Tile"] = 569,
    ["Microsoft RulesEngine workflow rules"] = 1173,
    ["Microsoft RulesEngine workflow rules list"] = 1174,
    ["Minecraft Custom Main Menu Mod"] = 1136,
    ["Minecraft Data Pack Advancement"] = 571,
    ["Minecraft Data Pack Biome"] = 572,
    ["Minecraft Data Pack Configured Carver"] = 573,
    ["Minecraft Data Pack Damage Type"] = 574,
    ["Minecraft Data Pack Dimension"] = 576,
    ["Minecraft Data Pack Dimension Type"] = 575,
    ["Minecraft Data Pack Item Modifier"] = 577,
    ["Minecraft Data Pack Loot Table"] = 578,
    ["Minecraft Data Pack Metadata"] = 579,
    ["Minecraft Data Pack Predicate"] = 580,
    ["Minecraft Data Pack Recipe"] = 581,
    ["Minecraft Data Pack Tag"] = 582,
    ["Minecraft Data Pack Template Pool"] = 583,
    ["Minecraft Data Pack Trim Material"] = 588,
    ["Minecraft Data Pack Trim Pattern"] = 589,
    ["Minecraft Resource Pack Lang"] = 584,
    ["Minecraft Resource Pack Particle"] = 585,
    ["Minecraft Resource Pack Texture Mcmeta"] = 587,
    ["Minecraft Resourcepack Sounds"] = 586,
    ["MockServer Expectations"] = 595,
    ModuleAssembler = 591,
    ["Monade CLI Stack Configuration"] = 602,
    ["MongoDB Atlas Search Index Definition"] = 1089,
    ["Monika Configuration"] = 1087,
    ["Monoweave Configuration"] = 597,
    ["Motif config"] = 980,
    MultiQC = 1226,
    ["NOX Framework (Service)"] = 620,
    ["Netin Diagnostic System Template"] = 1046,
    ["Netlify config"] = 605,
    ["Network-as-Code Data Model"] = 606,
    ["Next Gen UI Agent A2A Server Configuration"] = 607,
    ["Next Gen UI Agent Configuration"] = 609,
    ["Next Gen UI Agent MCP Server Configuration"] = 608,
    ["Nightwatch.js"] = 613,
    ["Node.js configuration"] = 985,
    ["NueJS configuration file"] = 625,
    ["Nuitka.yaml"] = 1150,
    ["Nullstone config"] = 627,
    ["ONe's changelog entry"] = 646,
    ["ONe's service descriptor"] = 645,
    ["ORT Server repository environment configuration"] = 656,
    ["OSCAL Assessment Plan (AP)"] = 658,
    ["OSCAL Assessment Results (AR)"] = 659,
    ["OSCAL Catalog"] = 660,
    ["OSCAL Component Definition (CDef)"] = 661,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 662,
    ["OSCAL Profile"] = 663,
    ["OSCAL System Security Plan (SSP)"] = 664,
    ["OSS Review Toolkit configuration"] = 665,
    ["OSS Review Toolkit curation"] = 666,
    ["OSS Review Toolkit package configuration"] = 667,
    ["OSS Review Toolkit repository configuration"] = 668,
    ["OSS Review Toolkit resolutions"] = 669,
    ["October CMS columns"] = 631,
    ["October CMS fields"] = 632,
    ["Oh My Posh"] = 634,
    Okteto = 635,
    ["Ona Automations"] = 637,
    Opctl = 983,
    ["Open Data Contract Standard (ODCS)"] = 650,
    ["Open Data Product Standard (ODPS)"] = 651,
    ["Open Know-How"] = 1231,
    OpenDecree = 1294,
    ["OpenDecree Configuration"] = 1295,
    ["OpenRewrite Resource"] = 648,
    OpenSRM = 652,
    OpenStatus = 1242,
    ["OpenTelemetry Declarative Configuration"] = 649,
    ["OpenUtau character yaml"] = 642,
    ["OpenUtau ustx"] = 643,
    ["OpenWeather Current Weather API"] = 1025,
    ["OpenWeather Road Risk API"] = 1024,
    ["Ory Hydra configuration"] = 472,
    ["Ory Keto configuration"] = 532,
    ["Ory Kratos configuration"] = 657,
    ["Ory Oathkeeper configuration"] = 629,
    ["Outblocks App configuration"] = 654,
    ["Outblocks database table"] = 655,
    ["Outblocks project configuration"] = 653,
    PDM = 676,
    POPxf = 687,
    ["POPxf Correlations"] = 688,
    ["PRML manifest"] = 695,
    Packer = 673,
    PactSpec = 674,
    Pantsbuild = 1104,
    ["Paper paper-plugin.yml"] = 675,
    ["Pipeline component"] = 1037,
    ["Platform.sh application"] = 8,
    ["Platform.sh routes"] = 9,
    ["Platform.sh services"] = 10,
    ["Plex Prerolls"] = 685,
    ["PocketMine plugin.yml"] = 682,
    ["Postman collection"] = 691,
    ["Power Pages Configuration"] = 1243,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1188,
    ["ProActions AI-Kit Configuration"] = 703,
    ["ProActions AI-Kit Configuration for Menus"] = 705,
    ["ProActions AI-Kit Configuration for Sections"] = 707,
    ["ProActions AI-Kit Configuration for Services"] = 704,
    ["ProActions AI-Kit Configuration for Steps"] = 708,
    ["ProActions AI-Kit Configuration for Templates"] = 706,
    ["Problem object RFC9457"] = 1133,
    ["Problem package format"] = 709,
    ["Problem package generators"] = 710,
    ["Problem package submissions"] = 711,
    ["Problem package test group metadata"] = 712,
    Pterodactyl = 1083,
    ["Pull Request Labeler"] = 729,
    Pulumi = 737,
    ["PyGTA Config"] = 733,
    PyProject = 738,
    Pylock = 1234,
    Pyright = 739,
    ["Python script metadata"] = 1228,
    ["QType AI DSL"] = 742,
    Qgoda = 741,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1305,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1303,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1309,
    ["Qlik Talend Cloud Pipeline - Project"] = 1301,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1304,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1306,
    ["Qlik Talend Cloud Pipeline - Task"] = 1302,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1308,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1307,
    Qodana = 1056,
    ["Qt Creator workspace file"] = 1166,
    ["Quali Torque Blueprint Spec 2"] = 1081,
    ["QueryFirst config file"] = 1100,
    ["Qwen Code Settings"] = 1291,
    ["RKE Cluster Configuration JSON"] = 1034,
    ["RKE Cluster Configuration YAML"] = 1033,
    RadioHound = 732,
    ["Raid Profile"] = 1292,
    ["Raid Repo Configuration"] = 1293,
    Railpack = 744,
    Railway = 743,
    ["Rancher Fleet"] = 734,
    ["Rattler-build"] = 745,
    Ray = 997,
    ["Read the Docs"] = 736,
    ["Red-DiscordBot Cog"] = 752,
    ["Red-DiscordBot Cog Repo"] = 753,
    ["Red-DiscordBot Trivia"] = 754,
    ["Releasaurus Config"] = 5,
    ReleaseKit = 4,
    ["Render Blueprints"] = 1032,
    RenderCV = 771,
    Renovate = 768,
    ["Renovate global configuration"] = 769,
    ["Renovate inherited configuration"] = 770,
    ["Replit config"] = 760,
    Restate = 1221,
    ["Revel Digital Gadget Definition File"] = 1245,
    RoadRunner = 773,
    ["Robust Station Image"] = 1251,
    Rockcraft = 774,
    ["Roo Coder Custom Modes"] = 775,
    Rubocop = 764,
    ["Rudder techniques"] = 1140,
    Ruff = 765,
    ["Rust Project"] = 766,
    ["Rust toolchain"] = 780,
    ["SDMX data message"] = 807,
    ["SDMX metadata message"] = 806,
    ["SDMX structure message"] = 805,
    ["SIL Kit Participant Configuration"] = 817,
    ["SIL Kit Registry Configuration"] = 818,
    ["SPDX 2.3"] = 856,
    SWADL = 872,
    ["Safebox Config"] = 1095,
    ["Sapphire CLI Config"] = 783,
    ["SauceCTL Configuration"] = 1043,
    Scarb = 803,
    ["Schema Catalog"] = 798,
    ["Scoop manifest"] = 804,
    ["Semantic Data Fabric (SDF) file"] = 808,
    ["Semgrep Rule"] = 810,
    ["Serenity Code Generator (Sergen)"] = 811,
    ["Serverless Framework Configuration"] = 1050,
    ["Serverless Workflow"] = 1052,
    ["Settings for a Cinnamon spice"] = 1184,
    ["Settings.paf"] = 813,
    ["Shopware 6 Configuration"] = 1053,
    ["Shopware CLI Extension Store Configuration"] = 1054,
    ["Shopware CLI Project Store Configuration"] = 1055,
    ["Sigma Detection Rule"] = 815,
    ["Sigrid scope configuration file"] = 816,
    ["SkyPilot Task JSON"] = 1141,
    ["Slack app manifest"] = 820,
    Snapcraft = 822,
    ["Solarxy project config"] = 825,
    Solidarity = 826,
    ["Solution filters"] = 827,
    ["Source Maps v3"] = 828,
    Sourcery = 829,
    ["Spack bootstrap.yaml"] = 830,
    ["Spack cdash.yaml"] = 831,
    ["Spack ci.yaml"] = 832,
    ["Spack compilers.yaml"] = 833,
    ["Spack concretizer.yaml"] = 834,
    ["Spack config.yaml"] = 835,
    ["Spack definitions.yaml"] = 836,
    ["Spack develop.yaml"] = 837,
    ["Spack env_vars.yaml"] = 838,
    ["Spack environment"] = 844,
    ["Spack include.yaml"] = 839,
    ["Spack mirrors.yaml"] = 840,
    ["Spack modules.yaml"] = 841,
    ["Spack packages.yaml"] = 842,
    ["Spack repos.yaml"] = 843,
    ["Spack toolchains.yaml"] = 845,
    ["Spack upstreams.yaml"] = 846,
    ["Spack view.yaml"] = 847,
    ["Speakeasy Generation Config File"] = 851,
    ["Speakeasy Lint Configuration File"] = 848,
    ["Speakeasy Test Generation Configuration File"] = 849,
    ["Speakeasy Workflow File"] = 850,
    SpecIF = 852,
    ["Specmatic Configuration"] = 853,
    ["Sponge Mixin configuration"] = 854,
    StackBlitz = 860,
    ["StackHawk Scanner Configuration"] = 1049,
    Stale = 861,
    Starfish = 862,
    ["Starlake Data Pipeline"] = 1022,
    Starship = 863,
    ["Statamic Blueprint"] = 864,
    ["Stella configuration file"] = 865,
    ["Streamlit configuration file"] = 866,
    ["Stryker Mutator"] = 869,
    ["StyleCop Analyzers Configuration"] = 870,
    ["Stylelint (.stylelintrc)"] = 871,
    ["Stylua Config"] = 1235,
    ["Sublime Syntax"] = 1096,
    ["Subsquid squid manifest"] = 1143,
    ["Swagger API 2.0"] = 873,
    ["Synadia Connect Component"] = 874,
    TSON = 910,
    TSTyche = 911,
    ["TYPO3 Vendor Bundler config"] = 917,
    ["Tab data for a LinUtil"] = 1191,
    ["Tab list for a LinUtil"] = 1190,
    Tach = 875,
    ["Tach Domain"] = 876,
    Talhelper = 878,
    ["Talisman configuration"] = 879,
    Taplo = 1236,
    ["Taskfile config"] = 1027,
    Taurus = 880,
    Tauticord = 881,
    ["Tekton Pipeline"] = 1264,
    ["Tekton PipelineRun"] = 1265,
    ["Tekton Task"] = 1262,
    ["Tekton TaskRun"] = 1263,
    Telefonistka = 1222,
    ["Terrateam config"] = 1248,
    ["TestEnvironment.json"] = 893,
    ["TextMate Grammar"] = 892,
    Threagile = 887,
    ["Tier.run pricing.json"] = 884,
    Tikibase = 885,
    Tombi = 890,
    ["Traefik v2"] = 896,
    ["Traefik v2 File Provider"] = 897,
    ["Traefik v3"] = 898,
    ["Traefik v3 File Provider"] = 899,
    ["Travis CI (.travis.yml)"] = 895,
    Treefmt = 450,
    Trident = 1218,
    ["TrueScript for *.tscript files"] = 902,
    ["Tugboat QA config.yml"] = 1215,
    TunnelHub = 1131,
    Turborepo = 894,
    Tycho = 1180,
    Tye = 1057,
    ["Tyk Gateway - Open Source v5.7+"] = 1227,
    ["UET BuildConfig.json"] = 1101,
    ["UI5 Manifest"] = 923,
    ["UNCORS configuration"] = 927,
    ["UTAM Page Object"] = 926,
    ["Ubuntu Server Autoinstall"] = 921,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1219,
    ["Uniswap Token List"] = 1008,
    ["Universal Schedule Format"] = 928,
    ["Unreal Engine Uplugin"] = 1102,
    ["Unreal Engine Uproject"] = 1103,
    ["UpCloud CLI (upctl) configuration"] = 1220,
    ["Updatecli Compose"] = 1065,
    ["Updatecli Policy Manifest"] = 1066,
    ["Updatecli Policy Metadata"] = 1067,
    Uplift = 1099,
    ["Upsun config"] = 7,
    ["User Journey Map"] = 1031,
    V2Ray = 1071,
    ["VSCode Code Snippets"] = 257,
    ["VSIX CLI publishing"] = 946,
    Vector = 930,
    ["Vela Pipeline Configuration"] = 933,
    Vercel = 256,
    ["Version Bumper config"] = 936,
    Vespertide = 1269,
    ["Vespertide Migration"] = 1270,
    ["Vespertide Model"] = 1271,
    ["Viash Component Config"] = 1224,
    ["Viash Package Config"] = 1225,
    Visivo = 1129,
    ["WP-CLI"] = 956,
    Wake = 1217,
    ["Waku Config"] = 1194,
    ["Web App Manifest"] = 952,
    ["Web types"] = 955,
    WebExtensions = 951,
    ["Webman package recipe"] = 1077,
    ["Windows Package Manager Installer Manifest"] = 1005,
    ["Windows Package Manager Locale Manifest"] = 1006,
    ["Windows Package Manager Singleton Manifest"] = 1004,
    ["WireMock CLI import configuration"] = 1200,
    ["WireMock CLI local service configuration"] = 1199,
    ["WireMock message stub mapping"] = 1198,
    ["WireMock stub mapping"] = 1197,
    ["Woodpecker pipeline config"] = 1045,
    ["Wrangler CLI"] = 957,
    ["XenForo add-on manifest"] = 958,
    ["Xstate Machine"] = 1063,
    ["Yandex Workflow Language"] = 1186,
    ["Yarn Config (.yarnrc.yml)"] = 1020,
    ["Yippee-Ki-JSON configuration YML"] = 1011,
    ["YouTrack App"] = 1183,
    ["Zarf Package Configuration"] = 1250,
    ["Zerops import file"] = 1172,
    ["Zola Configuration"] = 1261,
    ["aerleon.yml"] = 20,
    ["amplify.yml"] = 13,
    ["angular.json"] = 37,
    apko = 1134,
    ...
    ["behat.yml"] = 144,
    ["bigquery-table"] = 133,
    ["bioimageio resource description"] = 1151,
    ...
    ["cargo-nextest repository configuration"] = 610,
    ["cargo-nextest user configuration"] = 611,
    ["ccmod.json"] = 1195,
    changelogging = 1163,
    ...
    ["chutzpah.json"] = 265,
    cibuildwheel = 181,
    ["clang-format (.clang-format)"] = 1069,
    ["clang-tidy"] = 242,
    clangd = 241,
    clib = 243,
    ...
    ["crowdin.yml"] = 291,
    ["ctfd-setup configuration file"] = 1207,
    ["custom-elements.json"] = 1121,
    ["cypress.json"] = 295,
    ["dacier.yml"] = 1300,
    ...
    ["dtool dataset metadata"] = 1202,
    ["dvc.yaml"] = 339,
    ["ecosystem.json"] = 344,
    eksctl = 346,
    ["electron-builder configuration file"] = 372,
    ["epr-manifest.json"] = 371,
    ["estampo.toml"] = 370,
    ["evcc.yaml"] = 373,
    ["ezd task runner"] = 384,
    ["fabric.mod.json"] = 386,
    ["first-timers-bot"] = 394,
    ["flagd flag configuration"] = 119,
    ["fly.io Configuration"] = 120,
    fulibWorkflows = 1044,
    ["function.json"] = 406,
    ["gRPC API Gateway & OpenAPI Config"] = 15,
    ["gematik health care insurance list"] = 1213,
    ["gematik health care patient list"] = 1210,
    ["gematik health care provider institution list"] = 1212,
    ["gematik health care provider list"] = 1211,
    ["gematik tiger test environment configuration"] = 1214,
    ["git-town.toml"] = 1259,
    ["gitlab-ci"] = 425,
    ["global.json"] = 441,
    ["go-feature-flag Flag Configuration"] = 444,
    ["haxelib.json"] = 462,
    helmfile = 1000,
    helmwave = 1001,
    ["host-meta.json"] = 469,
    ...
    ["ide.host.json"] = 477,
    ["ifstate.yaml"] = 478,
    ["imageoptimizer.json"] = 479,
    ["importmap.json"] = 482,
    instant_python_config = 484,
    instant_python_custom_project = 485,
    ["ioBroker Configuration"] = 486,
    ["ioBroker JSON UI"] = 487,
    ["ioBroker Package manifest"] = 488,
    ["ixpect.conf.yaml"] = 489,
    ["ize.toml"] = 1098,
    ["jsconfig.json"] = 514,
    ["jscpd Configuration"] = 1082,
    jsdoc = 996,
    ["k3d.yaml"] = 515,
    ["k9s aliases.yaml"] = 517,
    ["k9s cluster-config.yaml"] = 519,
    ["k9s config.yaml"] = 518,
    ["k9s hotkeys.yaml"] = 520,
    ["k9s plugins.yaml"] = 521,
    ["k9s skin.yaml"] = 522,
    ["k9s views.yaml"] = 523,
    ["kontinuous-config.yaml"] = 535,
    ["kontinuous-values.yaml"] = 534,
    ["kustomization.yaml"] = 537,
    ["label-commenter-config.yml"] = 538,
    ["latexindent configuration"] = 112,
    ["launchsettings.json"] = 539,
    lazydocker = 1120,
    lazygit = 1119,
    ["lego.json"] = 541,
    ["lerna.json"] = 542,
    ["lgtm.yml"] = 543,
    ["liblab.config.json"] = 544,
    ["libman.json"] = 545,
    ["license-report-config.json"] = 546,
    ["linkinator.config.json"] = 548,
    ["lint-staged (.lintstagedrc)"] = 974,
    ["local.settings.json"] = 553,
    ["localazy.json"] = 554,
    ["lotus.yaml"] = 552,
    ["lsdlschema.json"] = 555,
    ["macro.json"] = 1086,
    ["markdown-link-check"] = 1040,
    maturin = 1041,
    mboats = 1048,
    memnex = 1298,
    ["micro-settings.json"] = 1113,
    ["mimetypes.json"] = 570,
    ["mirrord config"] = 976,
    mise = 977,
    ["mkdocs.yml"] = 590,
    ...
    ["monospace.yml"] = 596,
    ["moon.yml"] = 1196,
    ["mprocs Configuration file"] = 1167,
    ["mrdocs.yml"] = 592,
    ["mta.yaml"] = 978,
    ["mtad.yaml"] = 979,
    ["mycode.json"] = 603,
    nFPM = 612,
    ["napari plugin manifest"] = 604,
    neoload = 991,
    ["nest-cli"] = 615,
    ["nexus-rpc-gen"] = 1286,
    ["ninjs (News in JSON)"] = 614,
    ["nitro.json"] = 990,
    ["nixd configuration"] = 1139,
    ["nlu.json"] = 616,
    ["nodemon.json"] = 618,
    ["noodl config"] = 1047,
    ["notebook.mod.json"] = 619,
    now = 986,
    ["npm-badges"] = 622,
    ["nswag.json"] = 626,
    ntangle = 628,
    ["nuclei-template.yaml"] = 623,
    ["nuget-project.json"] = 624,
    ["ocelot.json"] = 630,
    ogen = 633,
    ["omnisharp.json"] = 636,
    openHAB = 1272,
    ...
    oxlint = 1283,
    ["package.json"] = 670,
    ["package.manifest"] = 672,
    ["package.yaml"] = 671,
    ["partial-black.json"] = 145,
    ["partial-fastapi.json"] = 146,
    ["partial-pixi.json"] = 680,
    ["partial-scheduled.json"] = 147,
    ["pattern.json"] = 678,
    ["petstore-v1.0"] = 1093,
    pgap_yaml_input_reader = 677,
    pgxgen = 1276,
    pitcms = 1279,
    ["pixi.toml"] = 679,
    ["plagiarize-me.yaml"] = 684,
    ["plagiarize.yaml"] = 683,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1203,
    ["podbard.yaml"] = 686,
    ["portman.json"] = 689,
    ["prefect.toml"] = 698,
    ["prefect.yaml"] = 699,
    ...
    ["prettierrc.json"] = 701,
    ["prisma.yml"] = 702,
    ["project-1.0.0-beta3.json"] = 714,
    ["project-1.0.0-beta4.json"] = 715,
    ["project-1.0.0-beta5.json"] = 716,
    ["project-1.0.0-beta6.json"] = 717,
    ["project-1.0.0-beta8.json"] = 718,
    ["project-1.0.0-rc1.json"] = 719,
    ["project-1.0.0-rc2.json"] = 720,
    ["project.json"] = 713,
    ["project.owasp.yaml"] = 721,
    ["prometheus-alertmanager.json"] = 725,
    ["prometheus.json"] = 722,
    ["prometheus.rules.json"] = 723,
    ["prometheus.rules.test.json"] = 724,
    ["proxies.json"] = 726,
    ["publiccode.yml"] = 727,
    ["pubspec.yaml"] = 728,
    ["pyrseas-0.8.json"] = 731,
    pytest = 740,
    ["quilt.mod.json"] = 1114,
    ["rc3 auth"] = 746,
    ["rc3 collection"] = 747,
    ...
    ["release drafter"] = 992,
    ["release-hub.json"] = 3,
    ["release-please-config.json"] = 756,
    ["release-please-manifest.json"] = 757,
    ["release-plz.toml"] = 758,
    ["renv.lock"] = 772,
    ["reposets Configuration"] = 761,
    ["reposets Credentials"] = 762,
    ["revola.json"] = 1,
    ["rivet.json"] = 1138,
    ["rivet.yaml (legacy)"] = 1137,
    rumdl = 777,
    runny = 776,
    runspec = 1299,
    rustfmt = 778,
    ...
    samt = 781,
    samtrc = 782,
    ["sarif-1.0.0.json"] = 784,
    ["sarif-2.0.0.json"] = 785,
    ["sarif-2.1.0"] = 795,
    ["sarif-2.1.0-rtm.2"] = 786,
    ["sarif-2.1.0-rtm.3"] = 788,
    ["sarif-2.1.0-rtm.4"] = 790,
    ["sarif-2.1.0-rtm.5"] = 792,
    ["sarif-2.1.0-rtm.6"] = 793,
    ["sarif-external-property-file-2.1.0"] = 796,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 787,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 789,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 791,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 794,
    ["scalingo.json configuration"] = 797,
    ["schema.org - Action"] = 799,
    ["schema.org - ContactPoint"] = 800,
    ["schema.org - Place"] = 801,
    ["schema.org - Thing"] = 802,
    ["secrethub.yml"] = 1116,
    ["semantic-release"] = 809,
    ["servicehub.config.json"] = 969,
    ["servicehub.service.json"] = 968,
    ["settings.job"] = 812,
    ["sfdx-hardis configuration"] = 814,
    ["shard.yml"] = 1154,
    ["size-limit configuration"] = 819,
    ["skaffold.yaml"] = 1038,
    ["skyuxconfig.json"] = 821,
    ["snowflake-config"] = 823,
    ["snowflake-connections"] = 824,
    ["spicepod.yaml"] = 1175,
    ["sqlc configuration"] = 857,
    ["stripe-app-local.json"] = 868,
    ["stripe-app.json"] = 867,
    swcrc = 1023,
    ["task.json"] = 877,
    taskcat = 987,
    ["template.json"] = 882,
    ["templatsources.json"] = 883,
    ["text2confl config"] = 1284,
    ["theme.json"] = 886,
    ["tizen_workspace.json"] = 888,
    tldr = 889,
    ["tm_devices configuration file"] = 1241,
    tmuxinator = 972,
    tox = 891,
    ["transcend.yml"] = 900,
    ["tree-sitter grammar.json"] = 449,
    ["trime.yaml"] = 901,
    ["trunk.yaml"] = 903,
    ["ts-force-config.json"] = 908,
    ["tsconfig.json"] = 904,
    ["tsd.json"] = 905,
    ["tsdoc.json"] = 906,
    ["tsdrc.json"] = 907,
    ...
    ["vega-lite.json"] = 932,
    ["vega.json"] = 931,
    ["venvironment.yaml"] = 934,
    ["venvplus.yaml"] = 935,
    version = 1223,
    ["version.json"] = 937,
    ["vhwdebugger-binding.yaml"] = 939,
    ["vim-addon-info"] = 940,
    ["vs-2017.3.host.json"] = 942,
    ["vs-nesting.json"] = 943,
    ["vsls.json"] = 941,
    ["vss-extension.json"] = 947,
    vtcfg = 1229,
    ["vtesttree.yaml"] = 948,
    ["vtestunit.yaml"] = 949,
    ["warp-keysets.json"] = 1122,
    ["warp-themes.json"] = 1123,
    ["warp-workflows.json"] = 1124,
    ["webhint.io"] = 1078,
    ["webjobpublishsettings.json"] = 954,
    ["webjobs-list.json"] = 953,
    ["well-known-fursona"] = 1162,
    ["xs-app.json"] = 982,
    ["xunit.runner.json"] = 967,
    yamlfmt = 1009,
    yamllint = 1010,
    ["zerops.yml"] = 1171,
    zizmor = 1266,
