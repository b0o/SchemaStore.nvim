...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 119,
    [".cryproj (generic)"] = 441,
    [".cryproj engine-5.2"] = 436,
    [".cryproj engine-5.3"] = 437,
    [".cryproj engine-5.4"] = 438,
    [".cryproj engine-5.5"] = 439,
    [".cryproj engine-dev"] = 440,
    [".csscomb.json"] = 121,
    [".csslintrc"] = 122,
    [".eslintrc"] = 161,
    [".esmrc.json"] = 154,
    ...
    [".vsext"] = 417,
    [".yarnrc.yml"] = 479,
    ["<div>RIOTS' studio configuration"] = 420,
    ["API Builder"] = 476,
    ["AVA Configuration Schema"] = 527,
    ...
    ["BX CI"] = 70,
    ["Better Code Hub"] = 481,
    BizTalkServerApplicationSchema = 453,
    ...
    ["Butane config schema"] = 514,
    ["CICS TS region tagging"] = 521,
    ["CICS TS resource import"] = 522,
    ["CICS TS resource model"] = 523,
    ["CICS TS resource overrides"] = 524,
    ["CMake Presets"] = 71,
    ...
    ["Embrace Config Schema"] = 538,
    ["Error pages"] = 157,
    Esquio = 155,
    ["Estuary Flow Catalog Schema"] = 518,
    ["Expo SDK"] = 160,
    ...
    Goreleaser = 187,
    ["Goreleaser Pro"] = 188,
    ["Gradle Build Cache Node"] = 478,
    ["Gradle Enterprise"] = 477,
    ...
    HEMTT = 450,
    Hadolint = 462,
    ["Hardware Sentry Configuration"] = 532,
    Hayson = 200,
    ...
    ["JSON Feed"] = 226,
    ["JSON Resume"] = 335,
    ["JSON Schema Draft 2020-12"] = 432,
    ["JSON Schema Draft 4"] = 429,
    ["JSON Schema Draft 7"] = 430,
    ["JSON Schema Draft 8"] = 431,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 536,
    ["Monika Configuration Schema"] = 534,
    ["Netin Diagnostic System Template"] = 499,
    ...
    Opctl = 449,
    ["OpenWeather Current Weather API"] = 485,
    ["OpenWeather Road Risk API"] = 484,
    ...
    Packer = 297,
    ["Pipeline component"] = 493,
    ["PocketMine plugin.yml"] = 301,
    Pterodactyl = 531,
    ["Pull Request Labeler"] = 324,
    PyProject = 328,
    Qodana = 507,
    ["Quali Torque Blueprint Spec 2"] = 529,
    ["RKE Cluster Configuration JSON Schema"] = 491,
    ["RKE Cluster Configuration YAML Schema"] = 490,
    Ray = 461,
    ["Read the Docs"] = 327,
    ...
    ["SauceCTL Configuration"] = 496,
    ["Schema Catalog"] = 353,
    ["Scoop manifest"] = 358,
    ["Semgrep Rule"] = 360,
    ["Serverless Framework Configuration"] = 503,
    ["Settings.paf"] = 362,
    ["Shopware 6 Configuration"] = 504,
    ["Shopware CLI Extension Store Configuration"] = 505,
    ["Shopware CLI Project Store Configuration"] = 506,
    Solidarity = 367,
    ["Source Maps v3"] = 368,
    SpecIF = 369,
    ["Sponge Mixin configuration"] = 370,
    ["StackHawk Scanner Configuration"] = 502,
    ...
    ["Swagger API 2.0"] = 384,
    ["Taskfile YAML Schema"] = 487,
    Taurus = 385,
    ["TestEnvironment.json"] = 391,
    Tikibase = 388,
    ["Traefik v2"] = 393,
    ["Traefik v2 File Provider"] = 394,
    Tye = 508,
    ["UI5 Manifest"] = 406,
    ["Ubuntu Server Autoinstall"] = 404,
    ["Uniswap Token List"] = 470,
    Updatecli = 515,
    ["User Journey Map YAML Schema"] = 489,
    V2Ray = 519,
    ["VSCode Code Snippets"] = 97,
    ["VSIX CLI publishing"] = 418,
    ["Vela Pipeline Configuration"] = 410,
    Vercel = 96,
    ["Web App Manifest"] = 422,
    ["Web types"] = 425,
    WebExtensions = 421,
    ["Webman package recipe"] = 525,
    ["Windows Package Manager Installer Manifest"] = 467,
    ["Windows Package Manager Locale Manifest"] = 468,
    ["Windows Package Manager Singleton Manifest"] = 466,
    ["Woodpecker pipeline config"] = 498,
    ["Xstate Machine Schema"] = 513,
    ["Yippee-Ki-JSON configuration YML"] = 472,
    ["angular.json"] = 8,
    ...
    ["jsconfig.json"] = 229,
    ["jscpd Configuration Schema"] = 530,
    jsdoc = 460,
    ["k3d.yaml"] = 230,
    ...
    ["servicehub.config.json"] = 435,
    ["servicehub.service.json"] = 434,
    ["settings.job"] = 361,
    ...
    taskcat = 452,
    ["template.json"] = 386,
    ["templatsources.json"] = 387,
    ["theme.json"] = 389,
    tmLanguage = 390,
    ["trunk.yaml schema"] = 395,
    ["ts-force-config.json"] = 399,
    ["tsconfig.json"] = 396,
    ["tsd.json"] = 397,
    ["tsdrc.json"] = 398,
    ["tslint.json"] = 400,
    ...
    ["version.json"] = 411,
    ["vim-addon-info"] = 412,
    ["vs-2017.3.host.json"] = 414,
    ["vs-nesting.json"] = 415,
    ["vsls.json"] = 413,
    ["vss-extension.json"] = 419,
    ["webhint.io"] = 526,
    ["webjobpublishsettings.json"] = 424,
    ["webjobs-list.json"] = 423,
    ["xs-app.json"] = 448,
    ["xunit.runner.json"] = 433,
    yamllint = 471,
    zuul = 457,
    ["Žinoma"] = 465
  },
