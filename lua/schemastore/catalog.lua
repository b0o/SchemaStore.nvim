...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1046,
    [".nodehawkrc"] = 668,
    [".npmpackagejsonlintrc"] = 673,
    [".omletrc"] = 1227,
    [".phrase.yml"] = 754,
    [".phraseapp.yml"] = 755,
    [".pmbot.yml"] = 739,
    [".postcssrc"] = 748,
    [".powerpages-web-template-manifest"] = 750,
    [".pre-commit-config.yml"] = 751,
    [".pre-commit-hooks.yml"] = 752,
    [".putout.json"] = 788,
    [".rehyperc"] = 813,
    [".remarkrc"] = 817,
    [".sprite files"] = 916,
    ...
    AIConfig = 45,
    ["AMX Muse Program Descriptor"] = 1276,
    ["API Builder"] = 1082,
    ["AVA Configuration"] = 1146,
    ["AWS AppConfig Feature Flags-v1"] = 80,
    ["AWS CDK cdk.json"] = 291,
    ["AWS CloudFormation"] = 292,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 293,
    ["AWS Copilot Manifest"] = 1315,
    ["AWS SAM CLI Samconfig"] = 294,
    Acton = 1366,
    ["Adobe UXP Manifest"] = 1209,
    ["Aerleon Network & Service Definitions"] = 27,
    ["Aerleon Policy"] = 28,
    ["Agent Permission Policy"] = 1355,
    ["AgentCore CLI"] = 1356,
    AgentLoopKit = 1357,
    Aider = 1305,
    Air = 30,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1326,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1325,
    ["Airlock Microgateway"] = 46,
    ["Alacritty Configuration"] = 1118,
    ["AlgoVoi Compliance Receipt v1"] = 16,
    ["All Contributors configuration file"] = 1172,
    ["Amazon S3 bucket CORS"] = 18,
    Anodizer = 483,
    ["Ansible Argument Specs"] = 466,
    ["Ansible Collection Galaxy"] = 473,
    ["Ansible Execution Environment"] = 463,
    ["Ansible Inventory"] = 472,
    ["Ansible Meta"] = 464,
    ["Ansible Meta Runtime"] = 465,
    ["Ansible Navigator Configuration"] = 475,
    ["Ansible Playbook"] = 470,
    ["Ansible Requirements"] = 467,
    ["Ansible Rulebook"] = 471,
    ["Ansible Tasks File"] = 469,
    ["Ansible Vars File"] = 468,
    ["Ansible-lint Configuration"] = 474,
    Any = 1237,
    ...
    ["Application list for a WinUtil"] = 1255,
    ArchitectFX = 1260,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1324,
    ["Azure IoT Operations connector metadata"] = 1321,
    ...
    ["Azure Pipelines"] = 129,
    ["Azure Static Web Apps CLI configuration file"] = 920,
    ["Azure Static Web Apps configuration file"] = 919,
    BMML = 1343,
    ["BOSH BPM Config"] = 155,
    ["BOSH CPI Config"] = 156,
    ...
    ["Bacon config"] = 10,
    ["Barba-CV"] = 95,
    ["Bashly (bashly.yml)"] = 1176,
    ["Bashly Settings (bashly-settings.yml)"] = 1177,
    Bento = 1342,
    ["Better Code Hub"] = 1087,
    ["Better Scripts"] = 179,
    Bigconfig = 148,
    ["Biome Formatter Config"] = 96,
    ["Bitmovin Encoding Template"] = 1269,
    BizTalkServerApplicationSchema = 1053,
    Bleep = 180,
    ["Block Protocol Metadata"] = 177,
    ["Bluebricks blueprint config"] = 1348,
    ["Boyka Framework"] = 158,
    ...
    ["Butane Config"] = 1131,
    C4InterFlow = 1284,
    ["CDK Environment Manager, concrete environment configuration"] = 1308,
    ["CDK Environment Manager, concrete environments definition"] = 1307,
    ["CDK Environment Manager, environment definition"] = 1306,
    ["CGS Card Game Specification (cgs.json)"] = 1214,
    ["CICS TS region tagging"] = 1140,
    ["CICS TS resource import"] = 1141,
    ["CICS TS resource model"] = 1142,
    ["CICS TS resource overrides"] = 1143,
    ["CMake Presets"] = 181,
    ["CNC Codes"] = 204,
    ["CRS WAF test file"] = 1244,
    ["CRS WAF test platform overrides file"] = 1245,
    ["CSS Comb (.csscomb.json)"] = 320,
    ["CSS Lint (.csslintrc)"] = 321,
    ["CSpell (cspell.json)"] = 319,
    ["CVE Record Format"] = 216,
    CWL = 1220,
    ["Cache Warmup config"] = 182,
    ["Caido Proxy Configuration"] = 1381,
    ...
    ["Chamaleon environment"] = 1273,
    ["Chamaleon properties"] = 1274,
    ["Chamaleon template"] = 1272,
    Changepacks = 1335,
    Changesets = 303,
    Changie = 190,
    Charmcraft = 191,
    ...
    ["Clawject config"] = 210,
    ["Cloud Foundry Application Manifest"] = 1226,
    ["Cloud Run Spec v1"] = 1250,
    ...
    CodeCV = 110,
    CodeRabbit = 109,
    ["CodeShip Pro services configuration files"] = 273,
    ["CodeShip Pro steps configuration files"] = 274,
    ["Codecov configuration files"] = 272,
    Codex = 264,
    ["Codex Hooks"] = 265,
    ["Codex Plugin Manifest"] = 266,
    ["Codex Skill Metadata"] = 267,
    CodifyCLI = 111,
    Codux = 269,
    ["Cog config file"] = 205,
    ["Commandbox Box.json"] = 206,
    ["Commandbox Server.json"] = 207,
    ["Common Catalog Data"] = 282,
    ["Common Package Specification"] = 208,
    Concord = 1243,
    ["Configu .cfgu files"] = 1231,
    ["Configu .configu file"] = 1232,
    Conjure = 203,
    ["Container Structure Test"] = 1067,
    Containerlab = 1096,
    ["Contextive Glossary"] = 1300,
    ContractGuard = 1097,
    Convex = 202,
    ["Crowdsec collection config"] = 314,
    ["Crowdsec parser config"] = 315,
    ["Crowdsec scenario config"] = 316,
    ["CumulusCI Config"] = 209,
    ["Cursor Agent Environment"] = 1353,
    ["Custom Machinery Machine"] = 1215,
    ["Custom Machinery Recipe"] = 1216,
    ["Cycle Stack File"] = 217,
    CycloneDX = 218,
    ["DWP Exchange - catalogue entry"] = 366,
    ["DWP Exchange - gateway"] = 364,
    ["DWP Exchange - meta"] = 365,
    ["Dart Build Config (dart-build.json)"] = 322,
    ["Dart Test Config (dart-test.json)"] = 323,
    ["DashLord Configuration"] = 324,
    ["Data Contract Specification"] = 325,
    ["Data Product Specification"] = 326,
    ["DataYoga Connections"] = 219,
    ["DataYoga Job"] = 220,
    ["Datadog Continuous Testing"] = 571,
    ["Datadog Service Definition"] = 572,
    ["Datadog Software Catalog"] = 573,
    ["Datahub Ingestion Recipe"] = 1147,
    ["Debian Upstream Metadata file"] = 227,
    DebtLens = 228,
    ["Deck config"] = 229,
    ["Declarative Automation Bundles"] = 1193,
    ["DeepMatch deeplinks spec"] = 230,
    ["Dein Config"] = 231,
    ["Deno Config (deno.json)"] = 332,
    ["Dependency cruiser"] = 232,
    ["DeployStack Configuration"] = 233,
    ["Deployah Configuration"] = 1323,
    ["Deployer Recipe"] = 335,
    ["Deta Spacefile"] = 234,
    ["Detekt Config (detekt.yml)"] = 336,
    ["Devbox Config"] = 235,
    ["Devbox Plugin"] = 236,
    Devfile = 363,
    Devup = 1336,
    DipDup = 1246,
    ["Discord Webhook"] = 337,
    ["DocFx Config (docfx.json)"] = 342,
    ["Docker Desktop extension metadata"] = 339,
    ["Docs MCP Manifest"] = 343,
    Dofigen = 344,
    ["Dolittle Artifacts"] = 345,
    ["Dolittle Bounded Context Configuration"] = 346,
    ["Dolittle Event Horizons Configuration"] = 347,
    ["Dolittle Resources Configuration"] = 348,
    ["Dolittle Server Configuration"] = 349,
    ["Dolittle Tenant Map Configuration"] = 351,
    ["Dolittle Tenants Configuration"] = 350,
    ["Dolittle Topology"] = 352,
    ["DonateCaseBetterCasino menu"] = 1277,
    ["Drupal Breakpoints"] = 237,
    ["Drupal Config"] = 249,
    ["Drupal Info"] = 238,
    ["Drupal Layouts"] = 239,
    ["Drupal Libraries"] = 240,
    ["Drupal Links Action"] = 241,
    ["Drupal Links Contextual"] = 242,
    ["Drupal Links Menu"] = 243,
    ["Drupal Links Task"] = 244,
    ["Drupal Migration"] = 245,
    ["Drupal Permissions"] = 246,
    ["Drupal Recipe"] = 247,
    ["Drupal Routing"] = 248,
    ["Drupal Services"] = 250,
    ["Drush site aliases"] = 358,
    ["Dust configuration"] = 361,
    ["Dynamic Bash Aliases (.aliases)"] = 1184,
    ["EAS config"] = 405,
    ["ECA - Editor Code Assistant"] = 368,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1173,
    ["ESLint Suppressions"] = 410,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1320,
    ["EasyVCR .NET"] = 407,
    ["Eidolon Resource"] = 1261,
    ["Elgato Stream Deck"] = 371,
    Elm = 1248,
    ["Embrace Config"] = 1159,
    Emmet = 1249,
    Endurica = 1197,
    ["Enonic XP API descriptor"] = 374,
    ["Enonic XP Admin Extension descriptor"] = 375,
    ["Enonic XP Admin Tool descriptor"] = 376,
    ["Enonic XP Application descriptor"] = 377,
    ["Enonic XP CMS descriptor"] = 378,
    ["Enonic XP Content Type descriptor"] = 379,
    ["Enonic XP Form Fragment descriptor"] = 380,
    ["Enonic XP ID Provider descriptor"] = 381,
    ["Enonic XP Layout descriptor"] = 382,
    ["Enonic XP Macro descriptor"] = 383,
    ["Enonic XP Mixin descriptor"] = 384,
    ["Enonic XP Page descriptor"] = 385,
    ["Enonic XP Part descriptor"] = 386,
    ["Enonic XP Service descriptor"] = 387,
    ["Enonic XP Site descriptor"] = 388,
    ["Enonic XP Style descriptor"] = 389,
    ["Enonic XP Task descriptor"] = 390,
    ["Enonic XP Webapp descriptor"] = 391,
    ["Enterprise Contract Policy Spec"] = 372,
    ["Envelope Team Definition"] = 1365,
    ["Envilder Map File"] = 373,
    ["Erda Pipeline"] = 1222,
    ["Erda Runtime"] = 1223,
    ["Espanso config.yml"] = 1346,
    ["Espanso match.yml"] = 1345,
    Esquio = 393,
    ["Estuary Flow Catalog"] = 1137,
    ["Ethereum ERC1155"] = 1359,
    ["Ethereum ERC721"] = 1358,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 398,
    ["EveryVoice TTS Toolkit Data Configuration"] = 399,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 403,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 402,
    ["EveryVoice TTS Toolkit Text Configuration"] = 400,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 401,
    ["Evolving Resolutive Process notation"] = 1322,
    ["Expo SDK"] = 404,
    ["Expoot app config"] = 406,
    ["F-Droid Data metadata"] = 412,
    ["FasterCI Configuration"] = 130,
    ["Fence configuration"] = 131,
    FiQuS = 416,
    Firebase = 414,
    ["Flatpak Builder Manifest"] = 417,
    ["FlexGet Config"] = 418,
    ["Flow.json Configurations"] = 1219,
    ["Fossa configuration file"] = 425,
    ["Fossa's fossa-deps file"] = 426,
    ["Foundry VTT - Base package Manifest"] = 420,
    ["Foundry VTT - Module Manifest"] = 421,
    ["Foundry VTT - System Data Template"] = 424,
    ["Foundry VTT - System Manifest"] = 422,
    ["Foundry VTT - World Manifest"] = 423,
    ["Foxx Manifest"] = 132,
    ["Freifunk.de Community API"] = 135,
    ["Frogbot Config"] = 136,
    ["G2P Mapping Configuration"] = 433,
    GAMA = 434,
    ["GCP Blueprint Metadata"] = 437,
    Gaspar = 435,
    ["GatewayCore API Gateway"] = 436,
    ["Gemini CLI settings"] = 438,
    ["GeoJSON.json latest"] = 1135,
    GherKing = 1139,
    ["GitHub Action"] = 446,
    ["GitHub Actions typing"] = 1257,
    ["GitHub CLI configuration"] = 447,
    ["GitHub CLI hosts"] = 448,
    ["GitHub Discussion"] = 449,
    ["GitHub Funding"] = 451,
    ["GitHub Issue Template configuration"] = 452,
    ["GitHub Issue Template forms"] = 453,
    ["GitHub Pages Jekyll"] = 454,
    ["GitHub Prompt"] = 450,
    ["GitHub Secret Scanning"] = 455,
    ["GitHub Workflow"] = 456,
    ["GitHub Workflow Template Properties"] = 457,
    ["GitHub automatically generated release notes configuration"] = 458,
    ["GitLab Agent for Kubernetes configuration"] = 1211,
    GitResume = 462,
    GitVersion = 441,
    ["Gitea Issue Template configuration"] = 444,
    ["Gitea Issue Template forms"] = 445,
    Gitleaks = 442,
    ["Gitpod Automations"] = 460,
    ["Gitpod Configuration"] = 461,
    ["Glamour style"] = 439,
    ["GlazeWM settings"] = 1213,
    ["Global Privacy Control"] = 440,
    Goblet = 1192,
    ["Golangci-lint Configuration"] = 477,
    ["Golangci-lint Custom Plugins Configuration"] = 478,
    ["Google Chrome Related Website Sets"] = 415,
    ["Google Cloud Workflows"] = 290,
    ["Google Digital Assetlinks"] = 1301,
    Goreleaser = 481,
    ["Goreleaser Pro"] = 482,
    Goss = 484,
    ["Gradle Build Cache Node"] = 1085,
    ["Gradle Enterprise"] = 1084,
    ["Grafana 5.x Dashboard"] = 485,
    ["GraphQL Code Generator"] = 490,
    ["GraphQL Config"] = 489,
    ["GraphQL Mesh"] = 488,
    ["GroovyLint configuration"] = 491,
    ["Grunt JSHint task"] = 495,
    ["Grunt Watch task"] = 496,
    ["Grunt base task"] = 497,
    ["Grunt clean task"] = 493,
    ["Grunt copy task"] = 492,
    ["Grunt cssmin task"] = 494,
    HEMTT = 1049,
    Hadolint = 1063,
    Hammerkit = 1095,
    ["Hardware Sentry Configuration"] = 1151,
    ["Hashgraph Online Skill Manifest"] = 6,
    ["HashiCorp Vault"] = 498,
    Hatch = 1064,
    Hayson = 500,
    ["Haystack Pipeline"] = 501,
    ["Hazelcast 5 Configuration"] = 502,
    ["Hecate Input Schema"] = 1312,
    ["Helm Chart.lock"] = 252,
    ["Helm Chart.yaml"] = 251,
    ["Helm Unittest Test Suite"] = 253,
    ["Heloisa Assistant Plugins Marketplace"] = 1388,
    ["Hex file"] = 254,
    ["Home Assistant Integration Manifest"] = 504,
    ["Homer dashboard configuration"] = 505,
    ["Hoverfly Simulation"] = 510,
    Hugo = 1127,
    ["Hugo Theme"] = 1126,
    ["Hulak Configuration"] = 513,
    ["Hyperfoil benchmark configuration"] = 512,
    ["IBM Zapp document"] = 514,
    ["IBM zCodeFormatSettings"] = 515,
    ["IMG Catapult PSP"] = 520,
    ["IVMS101 by CODE Protocol"] = 1212,
    ["Infinispan Configuration"] = 522,
    ["Infinispan Server Configuration"] = 523,
    Infrahub = 524,
    Istanbul = 1155,
    ["JDownloader2 crawler multi-rules"] = 538,
    ["JDownloader2 crawler single-rules"] = 537,
    ["JFrog Applications Config"] = 539,
    ["JFrog File Spec"] = 540,
    ["JFrog Pipelines YML DSL"] = 1161,
    ["JMeter DSL cli config"] = 541,
    JReleaser = 544,
    ["JSON Document Transform"] = 552,
    ["JSON Feed"] = 553,
    ["JSON Resume"] = 826,
    ["JSON Schema Draft 2020-12"] = 1029,
    ["JSON Schema Draft 4"] = 1026,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1194,
    ["JSON Schema Draft 7"] = 1027,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1195,
    ["JSON Schema Draft 8 (2019-09)"] = 1028,
    ["JSON-API"] = 551,
    ["JSON-e templates"] = 1092,
    ["JSON-stat 2.0"] = 1022,
    JSONPatch = 555,
    ["JSR Package Config (jsr.json)"] = 545,
    Jarl = 1328,
    Jasmine = 532,
    Jekyll = 533,
    ["Jenkins X Pipelines"] = 534,
    ["Jenkins X Requirements"] = 535,
    Jest = 536,
    Jocker = 542,
    ["Jovo Language Models"] = 543,
    ["Jujutsu (jj) VCS config"] = 1314,
    ["KIMMDY config file"] = 566,
    ["KODE/CI build.yaml"] = 1157,
    ["KSP-AVC"] = 1023,
    ["KSP-CKAN"] = 1024,
    ["KSP-NetKAN"] = 1025,
    KSY = 1224,
    KSail = 431,
    ["KYA Manifest"] = 1225,
    ["Karakum configuration file"] = 427,
    Kas = 558,
    ["Kestra flow file"] = 567,
    ["Keycloak REST API"] = 1164,
    ["Knative Functions - func.yaml"] = 428,
    Knip = 429,
    ["Knip JSONC"] = 430,
    ["Knowledge Unit"] = 575,
    ["Kometa (nightly) config file"] = 569,
    ["Kometa config file"] = 568,
    ["Kong DBLess config"] = 1158,
    KrakenD = 570,
    ["Kubri Configuration"] = 578,
    LOOBin = 594,
    ["Lake configuration file"] = 1317,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 295,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 296,
    ["Landing Zone Accelerator on AWS - Global Config"] = 297,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 298,
    ["Landing Zone Accelerator on AWS - Network Config"] = 299,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 300,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 301,
    ["Landing Zone Accelerator on AWS - Security Config"] = 302,
    ["Lando (landofile)"] = 122,
    ["LangGraph Platform configuration"] = 1236,
    ["Language configuration"] = 1235,
    Lefthook = 583,
    ["Liferay client-extension.yaml"] = 590,
    ["LinkML Metamodel"] = 592,
    Liquibase = 1102,
    ["Liquibase Flow File"] = 1103,
    ["Lively Properties"] = 593,
    ["Lobe AI Agent"] = 124,
    Loki = 125,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 637,
    ["MS2Rescore Configuration"] = 645,
    ["MSTest testconfig.json"] = 646,
    ["Madge configuration"] = 600,
    ["Madness (madness.yml)"] = 1175,
    ["Mado configuration"] = 601,
    ["Maestro Flow"] = 602,
    ["Mail Servers Configuration"] = 1349,
    ["MapEHR Mapping"] = 603,
    Markdownlint = 1106,
    ["Mason Registry"] = 1109,
    ["MegaLinter Custom Flavor"] = 606,
    ["MegaLinter configuration"] = 605,
    ["MegaLinter descriptor"] = 607,
    Melange = 1202,
    ["Meltano project definition"] = 608,
    ["Mergify Configuration"] = 647,
    ["Mermaid config"] = 1,
    ["Metadata for a Bazel module"] = 609,
    ["Metadata for a Cinnamon spice"] = 1253,
    ["Metatype Configuration"] = 610,
    ["MetricsHub Configuration"] = 611,
    ["MetricsHub Connector Configuration"] = 612,
    ["Micro Editor Syntax"] = 1185,
    ["Microsoft Band Web Tile"] = 613,
    ["Microsoft RulesEngine workflow rules"] = 1240,
    ["Microsoft RulesEngine workflow rules list"] = 1241,
    ["Minecraft Custom Main Menu Mod"] = 1203,
    ["Minecraft Data Pack Advancement"] = 615,
    ["Minecraft Data Pack Biome"] = 616,
    ["Minecraft Data Pack Configured Carver"] = 617,
    ["Minecraft Data Pack Damage Type"] = 618,
    ["Minecraft Data Pack Dimension"] = 620,
    ["Minecraft Data Pack Dimension Type"] = 619,
    ["Minecraft Data Pack Item Modifier"] = 621,
    ["Minecraft Data Pack Loot Table"] = 622,
    ["Minecraft Data Pack Metadata"] = 623,
    ["Minecraft Data Pack Predicate"] = 624,
    ["Minecraft Data Pack Recipe"] = 625,
    ["Minecraft Data Pack Tag"] = 626,
    ["Minecraft Data Pack Template Pool"] = 627,
    ["Minecraft Data Pack Trim Material"] = 632,
    ["Minecraft Data Pack Trim Pattern"] = 633,
    ["Minecraft Resource Pack Lang"] = 628,
    ["Minecraft Resource Pack Particle"] = 629,
    ["Minecraft Resource Pack Texture Mcmeta"] = 631,
    ["Minecraft Resourcepack Sounds"] = 630,
    ["MockServer Expectation"] = 639,
    ["MockServer Expectations"] = 640,
    ModuleAssembler = 635,
    ["Monade CLI Stack Configuration"] = 650,
    ["MongoDB Atlas Search Index Definition"] = 1156,
    ["Monika Configuration"] = 1154,
    ["Monoweave Configuration"] = 644,
    ["Motif config"] = 1045,
    MultiQC = 1294,
    ["NOX Framework (Service)"] = 672,
    ["Netin Diagnostic System Template"] = 1113,
    ["Netlify config"] = 653,
    ["Network-as-Code Data Model"] = 654,
    ["Next Gen UI Agent A2A Server Configuration"] = 655,
    ["Next Gen UI Agent Configuration"] = 657,
    ["Next Gen UI Agent MCP Server Configuration"] = 656,
    ["Nightwatch.js"] = 664,
    ["Nika workflow"] = 669,
    ["Node.js configuration"] = 1050,
    ["NueJS configuration file"] = 677,
    ["Nuitka Package Config"] = 1217,
    ["Nullstone config"] = 679,
    ["ODGS Data Rules"] = 686,
    ["ODGS Ontology Graph"] = 687,
    ["ODGS Standard Metrics"] = 685,
    ["OKF Graph"] = 1389,
    ["ONe's changelog entry"] = 701,
    ["ONe's service descriptor"] = 700,
    ["ORT Server repository environment configuration"] = 711,
    ["OSCAL Assessment Plan (AP)"] = 713,
    ["OSCAL Assessment Results (AR)"] = 714,
    ["OSCAL Catalog"] = 715,
    ["OSCAL Component Definition (CDef)"] = 716,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 717,
    ["OSCAL Profile"] = 718,
    ["OSCAL System Security Plan (SSP)"] = 719,
    ["OSS Review Toolkit configuration"] = 720,
    ["OSS Review Toolkit curation"] = 721,
    ["OSS Review Toolkit package configuration"] = 722,
    ["OSS Review Toolkit project package manager definition"] = 723,
    ["OSS Review Toolkit repository configuration"] = 724,
    ["OSS Review Toolkit resolutions"] = 725,
    ["October CMS columns"] = 683,
    ["October CMS fields"] = 684,
    ["Oh My Posh"] = 689,
    Okteto = 690,
    ["Ona Automations"] = 692,
    Opctl = 1048,
    ["Open Data Contract Standard (ODCS)"] = 705,
    ["Open Data Product Standard (ODPS)"] = 706,
    ["Open Know-How"] = 1299,
    OpenDecree = 1363,
    ["OpenDecree Configuration"] = 1364,
    ["OpenRewrite Resource"] = 703,
    OpenSRM = 707,
    OpenStatus = 1310,
    ["OpenTelemetry Declarative Configuration"] = 704,
    ["OpenUtau character yaml"] = 697,
    ["OpenUtau ustx"] = 698,
    ["OpenWeather Current Weather API"] = 1091,
    ["OpenWeather Road Risk API"] = 1090,
    ["Ory Hydra configuration"] = 511,
    ["Ory Keto configuration"] = 574,
    ["Ory Kratos configuration"] = 712,
    ["Ory Oathkeeper configuration"] = 681,
    ["Outblocks App configuration"] = 709,
    ["Outblocks database table"] = 710,
    ["Outblocks project configuration"] = 708,
    PDM = 733,
    POPxf = 745,
    ["POPxf Correlations"] = 746,
    ["PRML manifest"] = 753,
    Packer = 729,
    PactSpec = 730,
    Panache = 731,
    Pantsbuild = 1171,
    ["Paper paper-plugin.yml"] = 732,
    ["Pipeline component"] = 1104,
    ["Platform.sh application"] = 12,
    ["Platform.sh routes"] = 13,
    ["Platform.sh services"] = 14,
    ["Plex Prerolls"] = 743,
    ["PocketMine plugin.yml"] = 740,
    ["Podman Desktop Extension"] = 1383,
    ["Postman collection"] = 749,
    ["Power Pages Configuration"] = 1311,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1256,
    ["ProActions AI-Kit Configuration"] = 761,
    ["ProActions AI-Kit Configuration for Menus"] = 763,
    ["ProActions AI-Kit Configuration for Sections"] = 765,
    ["ProActions AI-Kit Configuration for Services"] = 762,
    ["ProActions AI-Kit Configuration for Steps"] = 766,
    ["ProActions AI-Kit Configuration for Templates"] = 764,
    ["Problem object RFC9457"] = 1200,
    ["Problem package format"] = 767,
    ["Problem package generators"] = 768,
    ["Problem package submissions"] = 769,
    ["Problem package test group metadata"] = 770,
    Pterodactyl = 1150,
    ["Pull Request Labeler"] = 787,
    Pulumi = 795,
    ["PyGTA Config"] = 791,
    PyProject = 796,
    Pylock = 1302,
    Pyright = 797,
    ["Python script metadata"] = 1296,
    ["QType AI DSL"] = 800,
    Qgoda = 799,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1375,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1373,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1379,
    ["Qlik Talend Cloud Pipeline - Project"] = 1371,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1374,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1376,
    ["Qlik Talend Cloud Pipeline - Task"] = 1372,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1378,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1377,
    Qodana = 1123,
    ["Qt Creator workspace file"] = 1233,
    ["Quali Torque Blueprint Spec 2"] = 1148,
    ["QueryFirst config file"] = 1167,
    ["QuikRun Configuration"] = 1380,
    ["Qwen Code Settings"] = 1360,
    ["RKE Cluster Configuration JSON"] = 1101,
    ["RKE Cluster Configuration YAML"] = 1100,
    RadioHound = 790,
    ["Raid Profile"] = 1361,
    ["Raid Repo Configuration"] = 1362,
    Railpack = 802,
    Railway = 801,
    ["Rancher Fleet"] = 792,
    ["Rattler-build"] = 803,
    Ray = 1062,
    ["Read the Docs"] = 794,
    ["Red-DiscordBot Cog"] = 810,
    ["Red-DiscordBot Cog Repo"] = 811,
    ["Red-DiscordBot Trivia"] = 812,
    ["Releasaurus Config"] = 9,
    ReleaseKit = 8,
    ["Render Blueprints"] = 1099,
    RenderCV = 830,
    Renovate = 827,
    ["Renovate global configuration"] = 828,
    ["Renovate inherited configuration"] = 829,
    ["Replit config"] = 818,
    Restate = 1289,
    ["Revel Digital Gadget Definition File"] = 1313,
    RoadRunner = 832,
    ["Robust Station Image"] = 1319,
    Rockcraft = 833,
    ["Roo Coder Custom Modes"] = 834,
    Rubocop = 823,
    ["Rudder techniques"] = 1207,
    Ruff = 824,
    ["Rust Project"] = 825,
    ["Rust toolchain"] = 839,
    ["SDMX data message"] = 866,
    ["SDMX metadata message"] = 865,
    ["SDMX structure message"] = 864,
    ["SIL Kit Participant Configuration"] = 877,
    ["SIL Kit Registry Configuration"] = 878,
    ["SPDX 2.3"] = 917,
    SWADL = 933,
    ["Safebox Config"] = 1162,
    ["Sapphire CLI Config"] = 842,
    ["SauceCTL Configuration"] = 1110,
    Scarb = 862,
    ["Schema Catalog"] = 857,
    ["Scoop manifest"] = 863,
    ["Secure SDLC Evidence Bundle"] = 867,
    ["Semantic Data Fabric (SDF) file"] = 868,
    ["Semgrep Rule"] = 870,
    ["Serenity Code Generator (Sergen)"] = 871,
    ["Serverless Framework Configuration"] = 1117,
    ["Serverless Workflow"] = 1119,
    ["Settings for a Cinnamon spice"] = 1252,
    ["Settings.paf"] = 873,
    ["Shopware 6 Configuration"] = 1120,
    ["Shopware CLI Extension Store Configuration"] = 1121,
    ["Shopware CLI Project Store Configuration"] = 1122,
    ["Sigma Detection Rule"] = 875,
    ["SigmaCV CV"] = 4,
    ["Sigrid scope configuration file"] = 876,
    ["SkyPilot Task JSON"] = 1208,
    ["Slack app manifest"] = 880,
    ["Slang Server Configuration"] = 1387,
    Snapcraft = 882,
    ["Solarxy project config"] = 885,
    Solidarity = 886,
    ["Solution filters"] = 887,
    ["Source Maps v3"] = 888,
    Sourcery = 889,
    ["Spack bootstrap.yaml"] = 890,
    ["Spack cdash.yaml"] = 891,
    ["Spack ci.yaml"] = 892,
    ["Spack compilers.yaml"] = 893,
    ["Spack concretizer.yaml"] = 894,
    ["Spack config.yaml"] = 895,
    ["Spack definitions.yaml"] = 896,
    ["Spack develop.yaml"] = 897,
    ["Spack env_vars.yaml"] = 898,
    ["Spack environment"] = 904,
    ["Spack include.yaml"] = 899,
    ["Spack mirrors.yaml"] = 900,
    ["Spack modules.yaml"] = 901,
    ["Spack packages.yaml"] = 902,
    ["Spack repos.yaml"] = 903,
    ["Spack toolchains.yaml"] = 905,
    ["Spack upstreams.yaml"] = 906,
    ["Spack view.yaml"] = 907,
    ["Speakeasy Generation Config File"] = 911,
    ["Speakeasy Lint Configuration File"] = 908,
    ["Speakeasy Test Generation Configuration File"] = 909,
    ["Speakeasy Workflow File"] = 910,
    SpecIF = 912,
    ["Specmatic Configuration"] = 913,
    ["Specpin spec file"] = 2,
    ["Sponge Mixin configuration"] = 914,
    ["Spotlight Ruleset"] = 915,
    StackBlitz = 921,
    ["StackHawk Scanner Configuration"] = 1116,
    Stale = 922,
    Starfish = 923,
    ["Starlake Data Pipeline"] = 1088,
    Starship = 924,
    ["Statamic Blueprint"] = 925,
    ["Stella configuration file"] = 926,
    ["Streamlit configuration file"] = 927,
    ["Stryker Mutator"] = 930,
    ["StyleCop Analyzers Configuration"] = 931,
    ["Stylelint (.stylelintrc)"] = 932,
    ["Stylua Config"] = 1303,
    ["Sublime Syntax"] = 1163,
    ["Subsquid squid manifest"] = 1210,
    ["Swagger API 2.0"] = 934,
    ["Synadia Connect Component"] = 935,
    TSON = 972,
    TSTyche = 973,
    ["TYPO3 Vendor Bundler config"] = 979,
    ["Tab data for a LinUtil"] = 1259,
    ["Tab list for a LinUtil"] = 1258,
    Tach = 936,
    ["Tach Domain"] = 937,
    Talhelper = 939,
    ["Talisman configuration"] = 940,
    Taplo = 1304,
    ["Taskfile config"] = 1093,
    Taurus = 941,
    Tauticord = 942,
    ["Tekton Pipeline"] = 1332,
    ["Tekton PipelineRun"] = 1333,
    ["Tekton Task"] = 1330,
    ["Tekton TaskRun"] = 1331,
    Telefonistka = 1290,
    ["Terrateam config"] = 1316,
    ["TestEnvironment.json"] = 954,
    ["TextMate Grammar"] = 953,
    Threagile = 948,
    ["Tier.run pricing.json"] = 945,
    Tikibase = 946,
    Tombi = 951,
    ["Traefik v2"] = 957,
    ["Traefik v2 File Provider"] = 958,
    ["Traefik v3"] = 959,
    ["Traefik v3 File Provider"] = 960,
    ["Travis CI (.travis.yml)"] = 956,
    Treefmt = 487,
    Trident = 1286,
    Trivy = 963,
    ["TrueScript for *.tscript files"] = 964,
    ["Tugboat QA config.yml"] = 1283,
    TunnelHub = 1198,
    Turborepo = 955,
    Tycho = 1247,
    Tye = 1124,
    ["Tyk Gateway - Open Source v5.7+"] = 1295,
    ["UET BuildConfig.json"] = 1168,
    ["UI5 Manifest"] = 985,
    ["UNCORS configuration"] = 990,
    ["UTAM Page Object"] = 988,
    ["Ubuntu Server Autoinstall"] = 983,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1287,
    ["Uniswap Token List"] = 1073,
    ["Universal Schedule Format"] = 991,
    ["Unreal Engine Uplugin"] = 1169,
    ["Unreal Engine Uproject"] = 1170,
    ["UpCloud CLI (upctl) configuration"] = 1288,
    ["Updatecli Compose"] = 1132,
    ["Updatecli Policy Manifest"] = 1133,
    ["Updatecli Policy Metadata"] = 1134,
    Uplift = 1166,
    ["Upsun config"] = 11,
    ["User Journey Map"] = 1098,
    V2Ray = 1138,
    ["VSCode Code Snippets"] = 278,
    ["VSIX CLI publishing"] = 1009,
    Vector = 993,
    ["Vela Pipeline Configuration"] = 996,
    Vercel = 277,
    ["Version Bumper config"] = 999,
    Vespertide = 1337,
    ["Vespertide Migration"] = 1338,
    ["Vespertide Model"] = 1339,
    ["Viash Component Config"] = 1292,
    ["Viash Package Config"] = 1293,
    Visivo = 1196,
    ["WP-CLI"] = 1019,
    Wake = 1285,
    ["Waku Config"] = 1262,
    ["Web App Manifest"] = 1015,
    ["Web types"] = 1018,
    WebExtensions = 1014,
    ["Webman package recipe"] = 1144,
    ["Windows Package Manager Installer Manifest"] = 1070,
    ["Windows Package Manager Locale Manifest"] = 1071,
    ["Windows Package Manager Singleton Manifest"] = 1069,
    ["WireMock CLI import configuration"] = 1268,
    ["WireMock CLI local service configuration"] = 1267,
    ["WireMock message stub mapping"] = 1266,
    ["WireMock stub mapping"] = 1265,
    ["Woodpecker pipeline config"] = 1112,
    ["Wrangler CLI"] = 1020,
    ["XenForo add-on manifest"] = 1021,
    ["Xstate Machine"] = 1130,
    ["Yandex Workflow Language"] = 1254,
    ["Yarn Config (.yarnrc.yml)"] = 1086,
    ["Yippee-Ki-JSON configuration YML"] = 1077,
    ["YouTrack App"] = 1251,
    ["Zarf Package Configuration"] = 1318,
    ["Zerops import file"] = 1239,
    ["Zola Configuration"] = 1329,
    abtop = 32,
    act3 = 1367,
    actionlint = 42,
    ["aerleon.yml"] = 26,
    ["amplify.yml"] = 19,
    ["amxx-builder manifest"] = 1382,
    ["angular.json"] = 47,
    apko = 1201,
    ...
    ["behat.yml"] = 159,
    ["bigquery-table"] = 147,
    ["bioimageio resource description"] = 1218,
    ...
    ["cargo-nextest repository configuration"] = 658,
    ["cargo-nextest user configuration"] = 659,
    ["ccmod.json"] = 1263,
    changelogging = 1230,
    ["chezmoi configuration"] = 192,
    ["chisel-slices.json"] = 304,
    ["chrome-extension-locales-messages.json"] = 285,
    ["chutzpah.json"] = 286,
    cibuildwheel = 197,
    ["clang-format (.clang-format)"] = 1136,
    ["clang-tidy"] = 260,
    clangd = 259,
    clib = 261,
    ["cloud-init: cloud-config userdata"] = 263,
    ["cloud-sdk-pipeline-configuration"] = 288,
    ["cloudbuild.json"] = 289,
    cloudify = 262,
    cmakefmt = 215,
    ["cmdx.yaml"] = 108,
    ...
    ["commands.json"] = 281,
    ["commit-check"] = 307,
    ["commitlint (.commitlintrc)"] = 1072,
    ["committed.toml"] = 308,
    ["compile_commands.json"] = 280,
    ["compilerconfig.json"] = 279,
    ["completely.yml"] = 1174,
    ["component-detection-manifest.json"] = 311,
    ["component.json"] = 310,
    ["composer.json"] = 309,
    ["conda-forge"] = 201,
    ["config.yaml"] = 793,
    ["contentmanifest.json"] = 287,
    ["contribute.json"] = 312,
    ["cosmos.config.json"] = 283,
    ["crowdin.yml"] = 313,
    ["ctfd-setup configuration file"] = 1275,
    ["custom-elements.json"] = 1188,
    ["cypress.json"] = 317,
    ["dacier.yml"] = 1370,
    ["datalogic-scan2deploy-android"] = 327,
    ["datalogic-scan2deploy-ce"] = 328,
    ["dbt Dependencies"] = 222,
    ["dbt Packages"] = 224,
    ["dbt Project"] = 223,
    ["dbt Selectors"] = 225,
    ["dbt YAML files"] = 226,
    ...
    ["ddev-global"] = 329,
    ["ddev-project"] = 330,
    ["debugsettings.json"] = 331,
    ["dependabot-v2.json"] = 334,
    ["dependabot.json"] = 333,
    ["deployed-cli"] = 1129,
    ["devcontainer-feature.json"] = 271,
    ["devcontainer.json"] = 270,
    devinit = 1079,
    ["devspace.yaml"] = 1152,
    djlint = 1080,
    ["docker bake"] = 340,
    ["docker sequencer"] = 341,
    ["docker-compose.yml"] = 1078,
    ["dockerd.json"] = 338,
    ["dotnet Release Index manifest"] = 353,
    ["dotnet-tools.json"] = 354,
    ["dotnetcli.host.json"] = 355,
    ["dprint.json"] = 356,
    ["drone.json"] = 357,
    ["dss-2.0.0.json"] = 359,
    ["dstack configuration"] = 360,
    ["dtool dataset metadata"] = 1270,
    ["dvc.yaml"] = 362,
    ["ecosystem.json"] = 367,
    ["editorconfig-checker"] = 369,
    eksctl = 370,
    ["electron-builder configuration file"] = 396,
    ["epr-manifest.json"] = 395,
    ["estampo.toml"] = 394,
    ["evcc.yaml"] = 397,
    ["ezd task runner"] = 408,
    ["fabric.mod.json"] = 411,
    ["first-timers-bot"] = 419,
    ["flagd flag configuration"] = 133,
    ["fly.io Configuration"] = 134,
    fulibWorkflows = 1111,
    ["function.json"] = 432,
    ["gRPC API Gateway & OpenAPI Config"] = 21,
    ["gematik health care insurance list"] = 1281,
    ["gematik health care patient list"] = 1278,
    ["gematik health care provider institution list"] = 1280,
    ["gematik health care provider list"] = 1279,
    ["gematik tiger test environment configuration"] = 1282,
    ["git-cliff"] = 443,
    ["git-town.toml"] = 1327,
    ["gitlab-ci"] = 459,
    ["global.json"] = 476,
    ["go-feature-flag Flag Configuration"] = 480,
    gollama = 479,
    ["hassette.toml"] = 503,
    ["haxelib.json"] = 499,
    helmfile = 1065,
    ...
    ["ide.host.json"] = 516,
    ["ifstate.yaml"] = 517,
    ["imageoptimizer.json"] = 518,
    ["importmap.json"] = 521,
    ["index.toml (packwiz)"] = 1384,
    instant_python_config = 525,
    instant_python_custom_project = 526,
    intlayer = 527,
    ["ioBroker Configuration"] = 528,
    ["ioBroker JSON UI"] = 529,
    ["ioBroker Package manifest"] = 530,
    ["ixpect.conf.yaml"] = 531,
    ["ize.toml"] = 1165,
    ["jsconfig.json"] = 556,
    ["jscpd Configuration"] = 1149,
    jsdoc = 1061,
    ["k3d.yaml"] = 557,
    ["k9s aliases.yaml"] = 559,
    ["k9s cluster-config.yaml"] = 561,
    ["k9s config.yaml"] = 560,
    ["k9s hotkeys.yaml"] = 562,
    ["k9s plugins.yaml"] = 563,
    ["k9s skin.yaml"] = 564,
    ["k9s views.yaml"] = 565,
    ["kind cluster"] = 579,
    ["kontinuous-config.yaml"] = 577,
    ["kontinuous-values.yaml"] = 576,
    ["kustomization.yaml"] = 580,
    ["label-commenter-config.yml"] = 581,
    ["latexindent configuration"] = 123,
    ["launchsettings.json"] = 582,
    lazydocker = 1187,
    lazygit = 1186,
    ["lego.json"] = 584,
    ["lerna.json"] = 585,
    ["lgtm.yml"] = 586,
    ["liblab.config.json"] = 587,
    ["libman.json"] = 588,
    ["license-report-config.json"] = 589,
    ["linkinator.config.json"] = 591,
    ["lint-staged (.lintstagedrc)"] = 1038,
    ["local.settings.json"] = 596,
    ["localazy.json"] = 597,
    ["lotus.yaml"] = 595,
    ["lsd colors"] = 127,
    ["lsd config"] = 126,
    ...
    lychee = 1037,
    ["macro.json"] = 1153,
    ["markdown-link-check"] = 1107,
    maturin = 1108,
    mboats = 1115,
    memnex = 1368,
    ["micro-settings.json"] = 1180,
    ["mimetypes.json"] = 614,
    ["mirrord config"] = 1041,
    ["misata.yaml"] = 1040,
    mise = 1042,
    ["mkdocs.yml"] = 634,
    ["mockd.yaml"] = 638,
    ["mod.pw.toml (packwiz)"] = 1385,
    ["modelparams.dev Model"] = 641,
    ["models CLI"] = 642,
    ["monospace.yml"] = 643,
    ["moon.yml"] = 1264,
    ["mprocs Configuration file"] = 1234,
    ["mrdocs.yml"] = 636,
    ["mta.yaml"] = 1043,
    ["mtad.yaml"] = 1044,
    ["mycode.json"] = 651,
    nFPM = 663,
    ["napari plugin manifest"] = 652,
    neoload = 1056,
    ["nest-cli"] = 666,
    ["nexus-rpc-gen"] = 1354,
    ["nf-core module environment.yml"] = 660,
    ["nf-core module meta.yml"] = 661,
    ["nf-core subworkflow meta.yml"] = 662,
    ["ninjs (News in JSON)"] = 665,
    ["nitro.json"] = 1055,
    ["nixd configuration"] = 1206,
    ["nlu.json"] = 667,
    ["nodemon.json"] = 670,
    ["noodl config"] = 1114,
    ["notebook.mod.json"] = 671,
    now = 1051,
    ["npm-badges"] = 674,
    ["nswag.json"] = 678,
    ntangle = 680,
    ["nuclei-template.yaml"] = 675,
    ["nuget-project.json"] = 676,
    ["ocelot.json"] = 682,
    ogen = 688,
    ["omnisharp.json"] = 691,
    openHAB = 1340,
    ...
    oxfmt = 1350,
    oxlint = 1351,
    ["pack.toml (packwiz)"] = 1386,
    ["package.json"] = 726,
    ["package.manifest"] = 728,
    ["package.yaml"] = 727,
    ["partial-black.json"] = 160,
    ["partial-fastapi.json"] = 161,
    ["partial-pixi.json"] = 738,
    ["partial-scheduled.json"] = 162,
    ["pattern.json"] = 736,
    ["petstore-v1.0"] = 1160,
    pgap_yaml_input_reader = 734,
    pgrls = 735,
    pgxgen = 1344,
    pitcms = 1347,
    ["pixi.toml"] = 737,
    ["plagiarize-me.yaml"] = 742,
    ["plagiarize.yaml"] = 741,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1271,
    ["podbard.yaml"] = 744,
    ["portman.json"] = 747,
    ["prefect.toml"] = 756,
    ["prefect.yaml"] = 757,
    ...
    ["prettierrc.json"] = 759,
    ["prisma.yml"] = 760,
    ["project-1.0.0-beta3.json"] = 772,
    ["project-1.0.0-beta4.json"] = 773,
    ["project-1.0.0-beta5.json"] = 774,
    ["project-1.0.0-beta6.json"] = 775,
    ["project-1.0.0-beta8.json"] = 776,
    ["project-1.0.0-rc1.json"] = 777,
    ["project-1.0.0-rc2.json"] = 778,
    ["project.json"] = 771,
    ["project.owasp.yaml"] = 779,
    ["prometheus-alertmanager.json"] = 783,
    ["prometheus.json"] = 780,
    ["prometheus.rules.json"] = 781,
    ["prometheus.rules.test.json"] = 782,
    ["proxies.json"] = 784,
    ["publiccode.yml"] = 785,
    ["pubspec.yaml"] = 786,
    ["pyrseas-0.8.json"] = 789,
    pytest = 798,
    ["quilt.mod.json"] = 1181,
    ["rc3 auth"] = 804,
    ["rc3 collection"] = 805,
    ...
    ["rc3 settings"] = 809,
    ["registry.yaml"] = 60,
    ["release drafter"] = 1057,
    ["release-hub.json"] = 7,
    ["release-please-config.json"] = 814,
    ["release-please-manifest.json"] = 815,
    ["release-plz.toml"] = 816,
    ["renv.lock"] = 831,
    ["repo-settings-as-code"] = 819,
    ["reposets Configuration"] = 820,
    ["reposets Credentials"] = 821,
    ["revola.json"] = 5,
    ["rivet.json"] = 1205,
    ["rivet.yaml (legacy)"] = 1204,
    rumdl = 836,
    runny = 835,
    runspec = 1369,
    rustfmt = 837,
    ...
    samt = 840,
    samtrc = 841,
    ["sarif-1.0.0.json"] = 843,
    ["sarif-2.0.0.json"] = 844,
    ["sarif-2.1.0"] = 854,
    ["sarif-2.1.0-rtm.2"] = 845,
    ["sarif-2.1.0-rtm.3"] = 847,
    ["sarif-2.1.0-rtm.4"] = 849,
    ["sarif-2.1.0-rtm.5"] = 851,
    ["sarif-2.1.0-rtm.6"] = 852,
    ["sarif-external-property-file-2.1.0"] = 855,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 846,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 848,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 850,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 853,
    ["scalingo.json configuration"] = 856,
    ["schema.org - Action"] = 858,
    ["schema.org - ContactPoint"] = 859,
    ["schema.org - Place"] = 860,
    ["schema.org - Thing"] = 861,
    ["secrethub.yml"] = 1183,
    ["semantic-release"] = 869,
    ["servicehub.config.json"] = 1032,
    ["servicehub.service.json"] = 1031,
    ["settings.job"] = 872,
    ["sfdx-hardis configuration"] = 874,
    ["shard.yml"] = 1221,
    ["size-limit configuration"] = 879,
    ["skaffold.yaml"] = 1105,
    ["skyuxconfig.json"] = 881,
    ["snowflake-config"] = 883,
    ["snowflake-connections"] = 884,
    ["spicepod.yaml"] = 1242,
    ["sqlc configuration"] = 918,
    ["stripe-app-local.json"] = 929,
    ["stripe-app.json"] = 928,
    swcrc = 1089,
    ["task.json"] = 938,
    taskcat = 1052,
    ["template.json"] = 943,
    ["templatsources.json"] = 944,
    ["text2confl config"] = 1352,
    ["theme.json"] = 947,
    ["tizen_workspace.json"] = 949,
    tldr = 950,
    ["tm_devices configuration file"] = 1309,
    tmuxinator = 1035,
    tox = 952,
    ["transcend.yml"] = 961,
    ["tree-sitter grammar.json"] = 486,
    ["trime.yaml"] = 962,
    ["trunk.yaml"] = 965,
    ["ts-force-config.json"] = 970,
    ["tsconfig.json"] = 966,
    ["tsd.json"] = 967,
    ["tsdoc.json"] = 968,
    ["tsdrc.json"] = 969,
    ...
    v8r = 1013,
    vcluster = 1228,
    ["vcpkg configuration file"] = 276,
    ["vcpkg manifest file"] = 275,
    ["vega-lite.json"] = 995,
    ["vega.json"] = 994,
    ["venvironment.yaml"] = 997,
    ["venvplus.yaml"] = 998,
    version = 1291,
    ["version.json"] = 1000,
    ["vhwdebugger-binding.yaml"] = 1002,
    ["vim-addon-info"] = 1003,
    ["vs-2017.3.host.json"] = 1005,
    ["vs-nesting.json"] = 1006,
    ["vsls.json"] = 1004,
    ["vss-extension.json"] = 1010,
    vtcfg = 1297,
    ["vtesttree.yaml"] = 1011,
    ["vtestunit.yaml"] = 1012,
    ["warp-keysets.json"] = 1189,
    ["warp-themes.json"] = 1190,
    ["warp-workflows.json"] = 1191,
    ["webhint.io"] = 1145,
    ["webjobpublishsettings.json"] = 1017,
    ["webjobs-list.json"] = 1016,
    ["well-known-fursona"] = 1229,
    ["xs-app.json"] = 1047,
    ["xunit.runner.json"] = 1030,
    yamlfmt = 1074,
    yamllint = 1075,
    ["yap.json"] = 1076,
    ["zerops.yml"] = 1238,
