...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 725,
    [".nodehawkrc"] = 468,
    [".npmpackagejsonlintrc"] = 472,
    [".omletrc"] = 900,
    [".phrase.yml"] = 519,
    [".phraseapp.yml"] = 520,
    [".pmbot.yml"] = 509,
    [".postcssrc"] = 514,
    [".powerpages-web-template-manifest"] = 516,
    [".pre-commit-config.yml"] = 517,
    [".pre-commit-hooks.yml"] = 518,
    [".putout.json"] = 539,
    [".rehyperc"] = 558,
    [".remarkrc"] = 560,
    [".sprite files"] = 622,
    ...
    ["<div>RIOTS' studio configuration"] = 697,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 422,
    ABCSupplyPlan = 13,
    AIConfig = 14,
    ["API Builder"] = 757,
    ["AVA Configuration"] = 817,
    ["AWS AppConfig Feature Flags-v1"] = 38,
    ["AWS CDK cdk.json"] = 188,
    ["AWS CloudFormation"] = 189,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 190,
    ["AWS SAM CLI Samconfig"] = 191,
    ["Adobe UXP Manifest"] = 882,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 15,
    ["Airplane task"] = 16,
    ["Alacritty Configuration"] = 789,
    ["All Contributors configuration file"] = 847,
    ["Ansible Argument Specs"] = 317,
    ["Ansible Collection Galaxy"] = 324,
    ["Ansible Execution Environment"] = 314,
    ["Ansible Inventory"] = 323,
    ["Ansible Meta"] = 315,
    ["Ansible Meta Runtime"] = 316,
    ["Ansible Navigator Configuration"] = 326,
    ["Ansible Playbook"] = 321,
    ["Ansible Requirements"] = 318,
    ["Ansible Rulebook"] = 322,
    ["Ansible Tasks File"] = 320,
    ["Ansible Vars File"] = 319,
    ["Ansible-lint Configuration"] = 325,
    Any = 909,
    ...
    ["Azure Pipelines"] = 63,
    ["Azure Static Web Apps CLI configuration file"] = 625,
    ["Azure Static Web Apps configuration file"] = 624,
    ["BX CI"] = 103,
    ["Bashly (bashly.yml)"] = 851,
    ["Bashly Settings (bashly-settings.yml)"] = 852,
    ["Better Code Hub"] = 761,
    ["Better Scripts"] = 104,
    Bigconfig = 80,
    BizTalkServerApplicationSchema = 731,
    Bleep = 105,
    ["Block Protocol Metadata"] = 102,
    ["Boyka Framework"] = 87,
    Briefcase = 736,
    ["Build Info"] = 94,
    Buildkite = 96,
    ["Bukkit plugin.yml"] = 95,
    ["BungeeCord plugin.yml"] = 100,
    ["Butane Config"] = 802,
    ["CGS Custom Card Game (CardGameDef.json)"] = 887,
    ["CICS TS region tagging"] = 811,
    ["CICS TS resource import"] = 812,
    ["CICS TS resource model"] = 813,
    ["CICS TS resource overrides"] = 814,
    ["CMake Presets"] = 106,
    ["CNC Codes"] = 120,
    ["CRS WAF test file"] = 916,
    ["CRS WAF test platform overrides file"] = 917,
    ["CSS Comb (.csscomb.json)"] = 215,
    ["CSS Lint (.csslintrc)"] = 216,
    ["CSpell (cspell.json)"] = 214,
    ["CVE Record Format"] = 126,
    CWL = 893,
    ["Cache Warmup config"] = 107,
    ["Calqulus pipeline"] = 108,
    ["Camel YAML DSL"] = 109,
    Carafe = 110,
    ["Cargo Make"] = 112,
    ["Cargo Manifest"] = 111,
    ["Catalog Info Backstage"] = 113,
    Changesets = 200,
    Cheatsheets = 799,
    ["Chrome Extension"] = 181,
    ["Chromia Model"] = 114,
    ["CircleCI config.yml"] = 157,
    ["Citation File Format"] = 202,
    CityJSON = 116,
    ["Clawject config"] = 125,
    ["Cloud Foundry Application Manifest"] = 899,
    ["Cloud Run Spec v1"] = 921,
    ["CloudEvents specification"] = 117,
    ["Code Climate"] = 158,
    CodeCV = 58,
    CodeRabbit = 57,
    ["CodeShip Pro services configuration files"] = 170,
    ["CodeShip Pro steps configuration files"] = 171,
    ["Codecov configuration files"] = 169,
    CodifyCLI = 59,
    Codux = 167,
    ["Cog config file"] = 121,
    ["Commandbox Box.json"] = 122,
    ["Commandbox Server.json"] = 123,
    ["Common Catalog Data"] = 179,
    Concord = 915,
    ["Configu .cfgu files"] = 904,
    ["Configu .configu file"] = 905,
    Conjure = 119,
    ["Container Structure Test"] = 744,
    Containerlab = 769,
    ["Crowdsec collection config"] = 209,
    ["Crowdsec parser config"] = 210,
    ["Crowdsec scenario config"] = 211,
    ["CumulusCI Config"] = 124,
    ["Custom Machinery Machine"] = 888,
    ["Custom Machinery Recipe"] = 889,
    ["Cycle Stack File"] = 127,
    ["DWP Exchange - catalogue entry"] = 257,
    ["DWP Exchange - gateway"] = 255,
    ["DWP Exchange - meta"] = 256,
    ["Dart Build Config (dart-build.json)"] = 217,
    ["Dart Test Config (dart-test.json)"] = 218,
    ["DashLord Configuration"] = 219,
    ["Data Contract Specification"] = 220,
    ["Data Product Specification"] = 221,
    ["DataYoga Connections"] = 128,
    ["DataYoga Job"] = 129,
    ["Databricks Asset Bundles"] = 868,
    ["Datadog Service Definition"] = 396,
    ["Datadog Software Catalog"] = 397,
    ["Datahub Ingestion Recipe"] = 818,
    ["Dein Config"] = 135,
    ["Deno Config (deno.json)"] = 227,
    ["Dependency cruiser"] = 136,
    ["Deployer Recipe"] = 230,
    ["Deta Spacefile"] = 137,
    ["Detekt Config (detekt.yml)"] = 231,
    ["Devbox Config"] = 138,
    ["Devbox Plugin"] = 139,
    Devfile = 254,
    DipDup = 918,
    ["Discord Webhook"] = 232,
    ["DocFx Config (docfx.json)"] = 236,
    ["Dolittle Artifacts"] = 237,
    ["Dolittle Bounded Context Configuration"] = 238,
    ["Dolittle Event Horizons Configuration"] = 239,
    ["Dolittle Resources Configuration"] = 240,
    ["Dolittle Server Configuration"] = 241,
    ["Dolittle Tenant Map Configuration"] = 243,
    ["Dolittle Tenants Configuration"] = 242,
    ["Dolittle Topology"] = 244,
    ["Drupal Breakpoints"] = 140,
    ["Drupal Config"] = 152,
    ["Drupal Info"] = 141,
    ["Drupal Layouts"] = 142,
    ["Drupal Libraries"] = 143,
    ["Drupal Links Action"] = 144,
    ["Drupal Links Contextual"] = 145,
    ["Drupal Links Menu"] = 146,
    ["Drupal Links Task"] = 147,
    ["Drupal Migration"] = 148,
    ["Drupal Permissions"] = 149,
    ["Drupal Recipe"] = 150,
    ["Drupal Routing"] = 151,
    ["Drupal Services"] = 153,
    ["Drush site aliases"] = 250,
    ["Dynamic Bash Aliases (.aliases)"] = 859,
    ["EAS config"] = 275,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 848,
    ["Elgato Stream Deck"] = 260,
    Elm = 920,
    ["Embrace Config"] = 829,
    Endurica = 872,
    ["Enterprise Contract Policy Spec"] = 261,
    ["Erda Pipeline"] = 895,
    ["Erda Runtime"] = 896,
    ["Error pages"] = 265,
    Esquio = 263,
    ["Estuary Flow Catalog"] = 808,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 268,
    ["EveryVoice TTS Toolkit Data Configuration"] = 269,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 273,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 272,
    ["EveryVoice TTS Toolkit Text Configuration"] = 270,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 271,
    ["Expo SDK"] = 274,
    ["F-Droid Data metadata"] = 280,
    ["Facets - FSDL - Application"] = 278,
    ["FasterCI Configuration"] = 64,
    FiQuS = 284,
    Firebase = 282,
    ["Flow.json Configurations"] = 892,
    ["Fossa configuration file"] = 291,
    ["Fossa's fossa-deps file"] = 292,
    ["Foundry VTT - Base package Manifest"] = 286,
    ["Foundry VTT - Module Manifest"] = 287,
    ["Foundry VTT - System Data Template"] = 290,
    ["Foundry VTT - System Manifest"] = 288,
    ["Foundry VTT - World Manifest"] = 289,
    ["Foxx Manifest"] = 65,
    ["Freifunk.de Community API"] = 68,
    ["Frogbot Config"] = 69,
    ["G2P Mapping Configuration"] = 296,
    ["GCP Blueprint Metadata"] = 299,
    Gaspar = 297,
    ["GatewayCore API Gateway"] = 298,
    ["GeoJSON.json latest"] = 806,
    GherKing = 810,
    ["GitHub Action"] = 304,
    ["GitHub Discussion"] = 305,
    ["GitHub Funding"] = 306,
    ["GitHub Issue Template configuration"] = 308,
    ["GitHub Issue Template forms"] = 307,
    ["GitHub Workflow"] = 309,
    ["GitHub Workflow Template Properties"] = 310,
    ["GitHub automatically generated release notes configuration"] = 311,
    ["GitLab Agent for Kubernetes configuration"] = 884,
    GitVersion = 301,
    ["Gitea Issue Template configuration"] = 302,
    ["Gitea Issue Template forms"] = 303,
    ["Gitpod Configuration"] = 313,
    ["GlazeWM settings"] = 886,
    ["Global Privacy Control"] = 300,
    Goblet = 867,
    ["Golangci-lint Configuration"] = 328,
    ["Golangci-lint Custom Plugins Configuration"] = 329,
    ["Google Chrome Related Website Sets"] = 283,
    ["Google Cloud Workflows"] = 187,
    Goreleaser = 331,
    ["Goreleaser Pro"] = 332,
    Goss = 333,
    ["Gradle Build Cache Node"] = 759,
    ["Gradle Enterprise"] = 758,
    ["Grafana 5.x Dashboard"] = 334,
    ["GraphQL Code Generator"] = 338,
    ["GraphQL Config"] = 337,
    ["GraphQL Mesh"] = 336,
    ["Grunt JSHint task"] = 342,
    ["Grunt Watch task"] = 343,
    ["Grunt base task"] = 344,
    ["Grunt clean task"] = 340,
    ["Grunt copy task"] = 339,
    ["Grunt cssmin task"] = 341,
    HEMTT = 728,
    Hadolint = 740,
    Hammerkit = 768,
    ["Hardware Sentry Configuration"] = 822,
    Hatch = 741,
    Hayson = 346,
    ["Haystack Pipeline"] = 347,
    ["Hazelcast 5 Configuration"] = 348,
    ["Helm Chart.lock"] = 155,
    ["Helm Chart.yaml"] = 154,
    ["Helm Unittest Test Suite"] = 156,
    Hugo = 798,
    ["Hugo Theme"] = 797,
    ["Hyperfoil benchmark configuration"] = 354,
    ["IBM Zapp document"] = 355,
    ["IBM zCodeFormatSettings"] = 356,
    ["IMG Catapult PSP"] = 361,
    ["IVMS101 by CODE Protocol"] = 885,
    Infrahub = 363,
    Istanbul = 825,
    ["JDownloader2 crawler multi-rules"] = 372,
    ["JDownloader2 crawler single-rules"] = 371,
    ["JFrog Applications Config"] = 373,
    ["JFrog File Spec"] = 374,
    ["JFrog Pipelines YML DSL"] = 831,
    ["JMeter DSL cli config"] = 375,
    JReleaser = 377,
    ["JSON Document Transform"] = 385,
    ["JSON Feed"] = 386,
    ["JSON Resume"] = 565,
    ["JSON Schema Draft 2020-12"] = 710,
    ["JSON Schema Draft 4"] = 707,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 869,
    ["JSON Schema Draft 7"] = 708,
    ["JSON Schema Draft 7 (unofficial strict)"] = 870,
    ["JSON Schema Draft 8 (2019-09)"] = 709,
    ["JSON-API"] = 384,
    ["JSON-WF"] = 898,
    ["JSON-e templates"] = 766,
    ["JSON-stat 2.0"] = 704,
    JSONPatch = 388,
    ["JSR Package Config (jsr.json)"] = 378,
    Jasmine = 367,
    Jekyll = 368,
    ["Jenkins X Pipelines"] = 369,
    ["Jenkins X Requirements"] = 370,
    ["Jovo Language Models"] = 376,
    ["KIMMDY config file"] = 393,
    ["KSP-AVC"] = 705,
    ["KSP-CKAN"] = 706,
    KSY = 897,
    ["Karakum configuration file"] = 293,
    Kas = 391,
    ["Kestra flow file"] = 394,
    ["Keycloak REST API"] = 839,
    ["Knative Functions - func.yaml"] = 294,
    ["KoDE/CI build.yaml"] = 827,
    ["Kong DBLess config"] = 828,
    KrakenD = 395,
    ["Kubri Configuration"] = 401,
    LOOBin = 416,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 192,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 193,
    ["Landing Zone Accelerator on AWS - Global Config"] = 194,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 195,
    ["Landing Zone Accelerator on AWS - Network Config"] = 196,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 197,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 198,
    ["Landing Zone Accelerator on AWS - Security Config"] = 199,
    ["Language configuration"] = 908,
    Lefthook = 405,
    ["Liferay client-extension.yaml"] = 412,
    ["LinkML Metamodel"] = 414,
    Liquibase = 774,
    ["Liquibase Flow File"] = 775,
    ["Lively Properties"] = 415,
    ["Lobe AI Agent"] = 61,
    Loki = 62,
    ["MLOS Configs"] = 452,
    ["MS2Rescore Configuration"] = 455,
    ["Madness (madness.yml)"] = 850,
    ["MapEHR Mapping"] = 421,
    Markdownlint = 778,
    ["Mason Registry"] = 780,
    ["MegaLinter configuration"] = 423,
    ["MegaLinter descriptor"] = 424,
    Melange = 876,
    ["Meltano plugin discovery definition"] = 426,
    ["Meltano project definition"] = 425,
    ["Mergify Configuration"] = 456,
    ["Metadata for a Bazel module"] = 427,
    ["MetricsHub Configuration"] = 428,
    ["MetricsHub Connector Configuration"] = 429,
    ["Micro Editor Syntax"] = 860,
    ["Microsoft Band Web Tile"] = 430,
    ["Microsoft RulesEngine workflow rules"] = 912,
    ["Microsoft RulesEngine workflow rules list"] = 913,
    ["Minecraft Custom Main Menu Mod"] = 877,
    ["Minecraft Data Pack Advancement"] = 432,
    ["Minecraft Data Pack Biome"] = 433,
    ["Minecraft Data Pack Configured Carver"] = 434,
    ["Minecraft Data Pack Damage Type"] = 435,
    ["Minecraft Data Pack Dimension"] = 437,
    ["Minecraft Data Pack Dimension Type"] = 436,
    ["Minecraft Data Pack Item Modifier"] = 438,
    ["Minecraft Data Pack Loot Table"] = 439,
    ["Minecraft Data Pack Metadata"] = 440,
    ["Minecraft Data Pack Predicate"] = 441,
    ["Minecraft Data Pack Recipe"] = 442,
    ["Minecraft Data Pack Tag"] = 443,
    ["Minecraft Data Pack Template Pool"] = 444,
    ["Minecraft Data Pack Trim Material"] = 449,
    ["Minecraft Data Pack Trim Pattern"] = 450,
    ["Minecraft Resource Pack Lang"] = 445,
    ["Minecraft Resource Pack Particle"] = 446,
    ["Minecraft Resource Pack Texture Mcmeta"] = 448,
    ["Minecraft Resourcepack Sounds"] = 447,
    ["Monade CLI Stack Configuration"] = 459,
    ["MongoDB Atlas Search Index Definition"] = 826,
    ["Monika Configuration"] = 824,
    ["Monoweave Configuration"] = 454,
    ["Motif config"] = 724,
    ["NOX Framework (Service)"] = 471,
    ["Netin Diagnostic System Template"] = 784,
    ["Netlify config"] = 462,
    ["Network-as-Code Data Model"] = 463,
    ["Nightwatch.js"] = 464,
    ["Nuitka.yaml"] = 890,
    ["ONe's changelog entry"] = 487,
    ["ONe's service descriptor"] = 486,
    ["OSS Review Toolkit configuration"] = 495,
    ["OSS Review Toolkit curation"] = 496,
    ["OSS Review Toolkit package configuration"] = 497,
    ["OSS Review Toolkit repository configuration"] = 498,
    ["OSS Review Toolkit resolutions"] = 499,
    Opctl = 727,
    ["Open Data Contract Standard (ODCS))"] = 490,
    ["OpenRewrite Resource"] = 489,
    ["OpenUtau character yaml"] = 483,
    ["OpenUtau ustx"] = 484,
    ["OpenWeather Current Weather API"] = 765,
    ["OpenWeather Road Risk API"] = 764,
    ["Ory Hydra configuration"] = 353,
    ["Ory Keto configuration"] = 398,
    ["Ory Kratos configuration"] = 494,
    ["Ory Oathkeeper configuration"] = 478,
    ["Outblocks App configuration"] = 492,
    ["Outblocks database table"] = 493,
    ["Outblocks project configuration"] = 491,
    PDM = 505,
    Packer = 502,
    Pantsbuild = 846,
    ["Paper paper-plugin.yml"] = 503,
    ["Pipeline component"] = 776,
    ["PocketMine plugin.yml"] = 510,
    ["Postman collection"] = 515,
    ["Problem object RFC9457"] = 874,
    ["Problem package generators"] = 523,
    Pterodactyl = 821,
    ["Pull Request Labeler"] = 538,
    Pulumi = 544,
    PyProject = 545,
    Pyright = 546,
    Qgoda = 547,
    Qodana = 794,
    ["Qt Creator workspace file"] = 906,
    ["Quali Torque Blueprint Spec 2"] = 819,
    ["QueryFirst config file"] = 842,
    ["RKE Cluster Configuration JSON"] = 773,
    ["RKE Cluster Configuration YAML"] = 772,
    ["Rancher Fleet"] = 541,
    ["Rattler-build"] = 548,
    Ray = 739,
    ["Read the Docs"] = 543,
    ["Red-DiscordBot Cog"] = 555,
    ["Red-DiscordBot Cog Repo"] = 556,
    ["Red-DiscordBot Trivia"] = 557,
    ["Render Blueprints"] = 771,
    RenderCV = 567,
    Renovate = 566,
    ["Replit config"] = 561,
    RoadRunner = 568,
    ["Rudder techniques"] = 880,
    Ruff = 563,
    ["Rust Project"] = 564,
    ["Rust toolchain"] = 572,
    ["SDMX data message"] = 597,
    ["SDMX metadata message"] = 596,
    ["SDMX structure message"] = 595,
    ["SIL Kit Participant Configuration"] = 607,
    ["SIL Kit Registry Configuration"] = 608,
    SWADL = 636,
    ["Safebox Config"] = 832,
    ["Sapphire CLI Config"] = 575,
    ["SauceCTL Configuration"] = 781,
    ["Schema Catalog"] = 589,
    ["Scoop manifest"] = 594,
    ["Semantic Data Fabric (SDF) file"] = 598,
    ["Semgrep Rule"] = 600,
    ["Serenity Code Generator (Sergen)"] = 601,
    ["Serverless Framework Configuration"] = 788,
    ["Serverless Workflow"] = 790,
    ["Settings.paf"] = 603,
    ["Shopware 6 Configuration"] = 791,
    ["Shopware CLI Extension Store Configuration"] = 792,
    ["Shopware CLI Project Store Configuration"] = 793,
    Sigma = 605,
    ["Sigrid scope configuration file"] = 606,
    ["SkyPilot Task JSON"] = 881,
    ["Slack app manifest"] = 610,
    Solidarity = 613,
    ["Solution filters"] = 614,
    ["Source Maps v3"] = 615,
    Sourcery = 616,
    ["Speakeasy Lint Configuration File"] = 617,
    ["Speakeasy Test Generation Configuration File"] = 618,
    ["Speakeasy Workflow File"] = 619,
    SpecIF = 620,
    ["Sponge Mixin configuration"] = 621,
    StackBlitz = 626,
    ["StackHawk Scanner Configuration"] = 787,
    Stale = 627,
    ["Starlake Data Pipeline"] = 762,
    Starship = 628,
    ["Statamic Blueprint"] = 629,
    ["Stella configuration file"] = 630,
    ["StrmPrivacy Data Connector"] = 836,
    ["StrmPrivacy Data Contract"] = 837,
    ["StrmPrivacy SimpleSchema"] = 834,
    ["StrmPrivacy Stream"] = 835,
    ["StrmPrivacy batch job configuration file"] = 833,
    ["Stryker Mutator"] = 633,
    ["StyleCop Analyzers Configuration"] = 634,
    ["Stylelint (.stylelintrc)"] = 635,
    ["Sublime Syntax"] = 838,
    ["Subsquid squid manifest"] = 883,
    ["Swagger API 2.0"] = 637,
    TSON = 663,
    TSTyche = 664,
    Talhelper = 639,
    ["Talisman configuration"] = 640,
    ["Taskfile config"] = 767,
    Taurus = 641,
    ["TestEnvironment.json"] = 650,
    ["TextMate Grammar"] = 649,
    ["Tier.run pricing.json"] = 644,
    Tikibase = 645,
    ["Traefik v2"] = 653,
    ["Traefik v2 File Provider"] = 654,
    ["Travis CI (.travis.yml)"] = 652,
    TunnelHub = 873,
    Turborepo = 651,
    Tycho = 919,
    Tye = 795,
    ["UET BuildConfig.json"] = 843,
    ["UI5 Manifest"] = 673,
    ["UNCORS configuration"] = 677,
    ["UTAM Page Object"] = 676,
    ["Ubuntu Server Autoinstall"] = 671,
    ["Uniswap Token List"] = 750,
    ["Unreal Engine Uplugin"] = 844,
    ["Unreal Engine Uproject"] = 845,
    ["Updatecli Compose"] = 803,
    ["Updatecli Policy Manifest"] = 804,
    ["Updatecli Policy Metadata"] = 805,
    Uplift = 841,
    ["User Journey Map"] = 770,
    V2Ray = 809,
    ["VSCode Code Snippets"] = 175,
    ["VSIX CLI publishing"] = 692,
    ["Vela Pipeline Configuration"] = 681,
    Vercel = 174,
    Visivo = 871,
    ["Web App Manifest"] = 699,
    ["Web types"] = 702,
    WebExtensions = 698,
    ["Webman package recipe"] = 815,
    ["Windows Package Manager Installer Manifest"] = 747,
    ["Windows Package Manager Locale Manifest"] = 748,
    ["Windows Package Manager Singleton Manifest"] = 746,
    ["Woodpecker pipeline config"] = 783,
    ["Wrangler CLI"] = 703,
    ["Xstate Machine"] = 801,
    ["Yarn Config (.yarnrc.yml)"] = 760,
    ["Yippee-Ki-JSON configuration YML"] = 752,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 875,
    ...
    ["babelrc.json"] = 71,
    ["bamboo-spec"] = 74,
    ["bashly-strings.yml"] = 853,
    ["batect.yml"] = 73,
    ["beef-database-codegen"] = 75,
    ["beef-database-v5-codegen"] = 77,
    ["beef-entity-codegen"] = 76,
    ["beef-entity-v5-codegen"] = 78,
    ["behat.yml"] = 88,
    ["bigquery-table"] = 79,
    ["bioimageio resource description"] = 891,
    ["bitbucket-pipelines"] = 81,
    bitrise = 82,
    ["bitrise-step"] = 83,
    ["block.json"] = 101,
    ...
    ["bunfig.toml"] = 99,
    changelogging = 903,
    ["chisel-slices.json"] = 201,
    ["chrome-extension-locales-messages.json"] = 182,
    ["chutzpah.json"] = 183,
    cibuildwheel = 115,
    ["clang-format (.clang-format)"] = 807,
    ["clang-tidy"] = 162,
    clangd = 161,
    clib = 163,
    ["cloud-init: cloud-config userdata"] = 165,
    ["cloud-sdk-pipeline-configuration"] = 185,
    ["cloudbuild.json"] = 186,
    cloudify = 164,
    codemagic = 166,
    ["coffeelint.json"] = 203,
    ["commands.json"] = 178,
    ["commitlint (.commitlintrc)"] = 749,
    ["compile_commands.json"] = 177,
    ["compilerconfig.json"] = 176,
    ["completely.yml"] = 849,
    ["component-detection-manifest.json"] = 206,
    ["component.json"] = 205,
    ["composer.json"] = 204,
    ["conda-forge"] = 118,
    ["config.yaml"] = 542,
    ["contentmanifest.json"] = 184,
    ["contribute.json"] = 207,
    ["cosmos.config.json"] = 180,
    ["crowdin.yml"] = 208,
    ["custom-elements.json"] = 863,
    ["cypress.json"] = 212,
    ["datalogic-scan2deploy-android"] = 222,
    ["datalogic-scan2deploy-ce"] = 223,
    ["dbt Dependencies"] = 130,
    ["dbt Packages"] = 132,
    ["dbt Project"] = 131,
    ["dbt Selectors"] = 133,
    ["dbt YAML files"] = 134,
    ["ddev-global"] = 224,
    ["ddev-project"] = 225,
    ["debugsettings.json"] = 226,
    ["dependabot-v2.json"] = 229,
    ["dependabot.json"] = 228,
    ["deployed-cli"] = 800,
    ["devcontainer.json"] = 168,
    devinit = 754,
    ["devspace.yaml"] = 823,
    djlint = 755,
    ["docker bake"] = 234,
    ["docker sequencer"] = 235,
    ["docker-compose.yml"] = 753,
    ["dockerd.json"] = 233,
    ["dotnet Release Index manifest"] = 245,
    ["dotnet-tools.json"] = 246,
    ["dotnetcli.host.json"] = 247,
    ["dprint.json"] = 248,
    ["drone.json"] = 249,
    ["dss-2.0.0.json"] = 251,
    ["dstack configuration"] = 252,
    ["dvc.yaml"] = 253,
    ["ecosystem.json"] = 258,
    eksctl = 259,
    ["electron-builder configuration file"] = 266,
    ["epr-manifest.json"] = 264,
    ["evcc.yaml"] = 267,
    ["ezd task runner"] = 276,
    ["fabric.mod.json"] = 279,
    ["first-timers-bot"] = 285,
    ["flagd flag configuration"] = 66,
    ["fly.io Configuration"] = 67,
    fulibWorkflows = 782,
    ["function.json"] = 295,
    ["gRPC API Gateway & OpenAPI Config"] = 3,
    ["gitlab-ci"] = 312,
    ["global.json"] = 327,
    ["go-feature-flag Flag Configuration"] = 330,
    ["haxelib.json"] = 345,
    helmfile = 742,
    helmwave = 743,
    ["host-meta.json"] = 350,
    ...
    ["ide.host.json"] = 357,
    ["ifstate.conf"] = 358,
    ["imageoptimizer.json"] = 359,
    ["importmap.json"] = 362,
    ["ioBroker Configuration"] = 364,
    ["ioBroker JSON UI"] = 365,
    ["ioBroker Package manifest"] = 366,
    ["ize.toml"] = 840,
    ["jsconfig.json"] = 389,
    ["jscpd Configuration"] = 820,
    jsdoc = 738,
    ["k3d.yaml"] = 390,
    ["k9s plugin.yml"] = 392,
    ["kontinuous-config.yaml"] = 400,
    ["kontinuous-values.yaml"] = 399,
    ["kustomization.yaml"] = 402,
    ["label-commenter-config.yml"] = 403,
    ["latexindent configuration"] = 60,
    ["launchsettings.json"] = 404,
    lazydocker = 862,
    lazygit = 861,
    ["lego.json"] = 406,
    ["lerna.json"] = 407,
    ["lgtm.yml"] = 408,
    ["liblab.config.json"] = 409,
    ["libman.json"] = 410,
    ["license-report-config.json"] = 411,
    ["linkinator.config.json"] = 413,
    ["lint-staged (.lintstagedrc)"] = 718,
    ["local.settings.json"] = 418,
    ["localazy.json"] = 419,
    ["lotus.yaml"] = 417,
    ["lsdlschema.json"] = 420,
    ["markdown-link-check"] = 779,
    mboats = 786,
    ["micro-settings.json"] = 855,
    ["mimetypes.json"] = 431,
    ["mirrord config"] = 719,
    mise = 720,
    ["mise-settings"] = 721,
    ["mkdocs.yml"] = 451,
    ["monospace.yml"] = 453,
    ["mprocs Configuration file"] = 907,
    ["mta.yaml"] = 722,
    ["mtad.yaml"] = 723,
    ["mycode.json"] = 460,
    ["napari plugin manifest"] = 461,
    neoload = 733,
    ["nest-cli"] = 466,
    ["ninjs (News in JSON)"] = 465,
    ["nixd configuration"] = 879,
    ["nlu.json"] = 467,
    ["nodemon.json"] = 469,
    ["noodl config"] = 785,
    ["notebook.mod.json"] = 470,
    now = 729,
    ["npm-badges"] = 473,
    ["nswag.json"] = 476,
    ntangle = 477,
    ["nuclei-template.yaml"] = 474,
    ["nuget-project.json"] = 475,
    ["ocelot.json"] = 479,
    ["omnisharp.json"] = 480,
    ["openapi.json"] = 481,
    ["openfin.json"] = 488,
    ...
    ["ops.yaml"] = 485,
    ["package.json"] = 500,
    ["package.manifest"] = 501,
    ["partial-black.json"] = 89,
    ["pathfinder.yml"] = 504,
    ["pattern.json"] = 507,
    ["petstore-v1.0"] = 830,
    pgap_yaml_input_reader = 506,
    ["pixi.toml"] = 508,
    ["plagiarize-me.yaml"] = 512,
    ["plagiarize.yaml"] = 511,
    ["portman.json"] = 513,
    ["prettierrc.json"] = 521,
    ["prisma.yml"] = 522,
    ["project-1.0.0-beta3.json"] = 525,
    ["project-1.0.0-beta4.json"] = 526,
    ["project-1.0.0-beta5.json"] = 527,
    ["project-1.0.0-beta6.json"] = 528,
    ["project-1.0.0-beta8.json"] = 529,
    ["project-1.0.0-rc1.json"] = 530,
    ["project-1.0.0-rc2.json"] = 531,
    ["project.json"] = 524,
    ["prometheus.json"] = 532,
    ["prometheus.rules.json"] = 533,
    ["prometheus.rules.test.json"] = 534,
    ["proxies.json"] = 535,
    ["publiccode.yml"] = 536,
    ["pubspec.yaml"] = 537,
    ["pyrseas-0.8.json"] = 540,
    ["quilt.mod.json"] = 856,
    ["rc3 auth"] = 549,
    ["rc3 collection"] = 550,
    ["rc3 environment"] = 551,
    ...
    samt = 573,
    samtrc = 574,
    ["sarif-1.0.0.json"] = 576,
    ["sarif-2.0.0.json"] = 577,
    ["sarif-2.1.0"] = 587,
    ["sarif-2.1.0-rtm.2"] = 578,
    ["sarif-2.1.0-rtm.3"] = 580,
    ["sarif-2.1.0-rtm.4"] = 582,
    ["sarif-2.1.0-rtm.5"] = 584,
    ["sarif-2.1.0-rtm.6"] = 585,
    ["sarif-external-property-file-2.1.0"] = 588,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 579,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 581,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 583,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 586,
    ["schema.org - Action"] = 590,
    ["schema.org - ContactPoint"] = 591,
    ["schema.org - Place"] = 592,
    ["schema.org - Thing"] = 593,
    ["secrethub.yml"] = 858,
    ["semantic-release"] = 599,
    ["servicehub.config.json"] = 713,
    ["servicehub.service.json"] = 712,
    ["settings.job"] = 602,
    ["sfdx-hardis configuration"] = 604,
    ["shard.yml"] = 894,
    ["size-limit configuration"] = 609,
    ["skaffold.yaml"] = 777,
    ["skyuxconfig.json"] = 611,
    snapcraft = 612,
    ["spicepod.yaml"] = 914,
    ["sqlc configuration"] = 623,
    ["stripe-app-local.json"] = 632,
    ["stripe-app.json"] = 631,
    swcrc = 763,
    ["task.json"] = 638,
    taskcat = 730,
    ["template.json"] = 642,
    ["templatsources.json"] = 643,
    ["theme.json"] = 646,
    ["tizen_workspace.json"] = 647,
    tldr = 648,
    tmuxinator = 716,
    ["transcend.yml"] = 655,
    ["tree-sitter grammar.json"] = 335,
    ["trime.yaml"] = 656,
    ["trunk.yaml"] = 657,
    ["ts-force-config.json"] = 661,
    ["tsconfig.json"] = 658,
    ["tsd.json"] = 659,
    ["tsdrc.json"] = 660,
    ["tslint.json"] = 662,
    ...
    v8r = 696,
    vcluster = 901,
    ["vcpkg configuration file"] = 173,
    ["vcpkg manifest file"] = 172,
    ["vega-lite.json"] = 680,
    ["vega.json"] = 679,
    ["venvironment-basic.yaml"] = 683,
    ["venvironment.yaml"] = 682,
    ["version.json"] = 684,
    ["vim-addon-info"] = 686,
    ["vs-2017.3.host.json"] = 688,
    ["vs-nesting.json"] = 689,
    ["vsls.json"] = 687,
    ["vss-extension.json"] = 693,
    ["vtesttree.yaml"] = 694,
    ["vtestunit.yaml"] = 695,
    ["warp-keysets.json"] = 864,
    ["warp-themes.json"] = 865,
    ["warp-workflows.json"] = 866,
    ["webhint.io"] = 816,
    ["webjobpublishsettings.json"] = 701,
    ["webjobs-list.json"] = 700,
    ["well-known-fursona"] = 902,
    ["xs-app.json"] = 726,
    ["xunit.runner.json"] = 711,
    yamllint = 751,
    ["zerops.io import file"] = 911,
    ["zerops.yml"] = 910,
    zuul = 735,
    ["Žinoma"] = 745
  },
