...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 167,
    [".cryproj (generic)"] = 579,
    [".cryproj engine-5.2"] = 574,
    [".cryproj engine-5.3"] = 575,
    [".cryproj engine-5.4"] = 576,
    [".cryproj engine-5.5"] = 577,
    [".cryproj engine-dev"] = 578,
    [".csscomb.json"] = 169,
    [".csslintrc"] = 170,
    [".es6importsorterrc.json"] = 706,
    [".eslintrc"] = 218,
    [".esmrc.json"] = 210,
    [".ffizer.yaml"] = 222,
    [".htmlhintrc"] = 270,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration Schema"] = 651,
    ["All Contributors configuration file"] = 705,
    ...
    ["Azure Pipelines"] = 54,
    ["Azure Static Web Apps CLI configuration file"] = 496,
    ["Azure Static Web Apps configuration file"] = 495,
    ["BX CI"] = 89,
    ["Better Code Hub"] = 624,
    ["Better Scripts"] = 90,
    BizTalkServerApplicationSchema = 594,
    ...
    ["Butane Config"] = 663,
    ["CICS TS region tagging"] = 670,
    ["CICS TS resource import"] = 671,
    ["CICS TS resource model"] = 672,
    ["CICS TS resource overrides"] = 673,
    ["CMake Presets"] = 91,
    ...
    ["Datahub Ingestion Recipe Schema"] = 677,
    ...
    ["Embrace Config Schema"] = 688,
    ["Error pages"] = 213,
    Esquio = 211,
    ["Estuary Flow Catalog Schema"] = 667,
    ["Expo SDK"] = 216,
    ...
    ["Goreleaser Pro"] = 252,
    Goss = 253,
    ["Gradle Build Cache Node"] = 621,
    ["Gradle Enterprise"] = 620,
    ...
    Hadolint = 603,
    Hammerkit = 631,
    ["Hardware Sentry Configuration"] = 681,
    Hayson = 265,
    ...
    ["JFrog File Spec"] = 289,
    ["JFrog Pipelines YML DSL"] = 690,
    ["JMeter DSL cli config schema"] = 290,
    JReleaser = 292,
    ["JSON Document Transform"] = 299,
    ["JSON Feed"] = 300,
    ["JSON Resume"] = 446,
    ["JSON Schema Draft 2020-12"] = 570,
    ["JSON Schema Draft 4"] = 567,
    ["JSON Schema Draft 7"] = 568,
    ["JSON Schema Draft 8"] = 569,
    ...
    Kas = 305,
    ["Keycloak REST API"] = 697,
    ["Knative Functions - func.yaml"] = 233,
    ["KoDE/CI build.yaml"] = 686,
    ["Kong DBLess Schema"] = 687,
    KrakenD = 306,
    LOOBin = 323,
    Lefthook = 314,
    ["LinkML Metamodel"] = 321,
    Liquibase = 636,
    ["Liquibase Flow File"] = 637,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 685,
    ["Monika Configuration Schema"] = 683,
    ["Motif config"] = 587,
    ["NOX Framework (Service)"] = 368,
    ["Netin Diagnostic System Template"] = 646,
    ...
    ["OpenWeather Current Weather API"] = 628,
    ["OpenWeather Road Risk API"] = 627,
    ...
    ["Pipeline component"] = 638,
    ["PocketMine plugin.yml"] = 401,
    ["Postman collection"] = 406,
    Pterodactyl = 680,
    ["Pull Request Labeler"] = 427,
    Pulumi = 433,
    PyProject = 434,
    Pyright = 435,
    Qodana = 656,
    ["Quali Torque Blueprint Spec 2"] = 678,
    ["QueryFirst config file"] = 700,
    ["RKE Cluster Configuration JSON Schema"] = 635,
    ["RKE Cluster Configuration YAML Schema"] = 634,
    ["Rancher Fleet"] = 430,
    Ray = 602,
    ["Read the Docs"] = 432,
    ["Red-DiscordBot Cog"] = 436,
    ["Red-DiscordBot Cog Repo"] = 437,
    ["Red-DiscordBot Trivia"] = 438,
    Renovate = 447,
    ["Replit schema"] = 441,
    RoadRunner = 448,
    Ruff = 444,
    ["Rust Project"] = 445,
    ["Rust toolchain"] = 450,
    ["SIL Kit Participant Configuration"] = 481,
    ["SIL Kit Registry Configuration"] = 482,
    SWADL = 505,
    ["Safebox Config Schema"] = 691,
    ["Sapphire CLI Config"] = 453,
    ["SauceCTL Configuration"] = 643,
    ["Schema Catalog"] = 467,
    ["Scoop manifest"] = 472,
    ["Semantic Data Fabric (SDF) file"] = 473,
    ["Semgrep Rule"] = 475,
    ["Serenity Code Generator (Sergen)"] = 476,
    ["Serverless Framework Configuration"] = 650,
    ["Serverless Workflow Schema"] = 652,
    ["Settings.paf"] = 478,
    ["Shopware 6 Configuration"] = 653,
    ["Shopware CLI Extension Store Configuration"] = 654,
    ["Shopware CLI Project Store Configuration"] = 655,
    ["Sigrid scope configuration file"] = 480,
    ["Slack app manifest"] = 484,
    Solidarity = 487,
    ["Solution filters"] = 488,
    ["Source Maps v3"] = 489,
    Sourcery = 490,
    SpecIF = 491,
    ["Sponge Mixin configuration"] = 492,
    ["StackHawk Scanner Configuration"] = 649,
    Stale = 497,
    Starship = 498,
    ["Statamic Blueprint"] = 499,
    ["StrmPrivacy Data Connector"] = 695,
    ["StrmPrivacy Data Contract"] = 696,
    ["StrmPrivacy SimpleSchema"] = 693,
    ["StrmPrivacy Stream"] = 694,
    ["StrmPrivacy batch job configuration file"] = 692,
    ["Stryker Mutator"] = 502,
    ["StyleCop Analyzers Configuration"] = 503,
    ["Swagger API 2.0"] = 506,
    TSON = 530,
    ["Talisman configuration"] = 508,
    ["Taskfile YAML Schema"] = 630,
    Taurus = 509,
    ["TestEnvironment.json"] = 518,
    ["Tier.run pricing.json"] = 512,
    Tikibase = 513,
    ["Traefik v2"] = 521,
    ["Traefik v2 File Provider"] = 522,
    Turborepo = 519,
    Tye = 657,
    ["UET BuildConfig.json"] = 701,
    ["UI5 Manifest"] = 537,
    ["UTAM Page Object"] = 540,
    ["Ubuntu Server Autoinstall"] = 535,
    ["Uniswap Token List"] = 612,
    ["Unreal Engine Uplugin"] = 702,
    ["Unreal Engine Uproject"] = 703,
    Updatecli = 664,
    Uplift = 699,
    ["User Journey Map YAML Schema"] = 633,
    V2Ray = 668,
    ["VSCode Code Snippets"] = 138,
    ["VSIX CLI publishing"] = 553,
    ["Vela Pipeline Configuration"] = 543,
    Vercel = 137,
    ["Web App Manifest"] = 560,
    ["Web types"] = 563,
    WebExtensions = 559,
    ["Webman package recipe"] = 674,
    ["Windows Package Manager Installer Manifest"] = 609,
    ["Windows Package Manager Locale Manifest"] = 610,
    ["Windows Package Manager Singleton Manifest"] = 608,
    ["Woodpecker pipeline config"] = 645,
    ["Xstate Machine Schema"] = 662,
    ["Yippee-Ki-JSON configuration YML"] = 614,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 65,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 710,
    ["bashly-strings.yml"] = 711,
    ["bashly.yml"] = 709,
    ["batect.yml"] = 64,
    ["beau.yml"] = 623,
    ...
    ["ize.toml"] = 698,
    ["jsconfig.json"] = 303,
    ["jscpd Configuration Schema"] = 679,
    jsdoc = 601,
    ["k3d.yaml"] = 304,
    ...
    ["lsdlschema.json"] = 327,
    ["madness.yml"] = 708,
    ["markdown-lint-check"] = 641,
    mboats = 648,
    ["micro-settings.json"] = 713,
    ["mimetypes.json"] = 334,
    ["mirrord-schema"] = 584,
    ["mta.yaml"] = 585,
    ["mtad.yaml"] = 586,
    ...
    ["prettierrc.json"] = 411,
    ["prisma.yml"] = 412,
    ["project-1.0.0-beta3.json"] = 414,
    ["project-1.0.0-beta4.json"] = 415,
    ["project-1.0.0-beta5.json"] = 416,
    ["project-1.0.0-beta6.json"] = 417,
    ["project-1.0.0-beta8.json"] = 418,
    ["project-1.0.0-rc1.json"] = 419,
    ["project-1.0.0-rc2.json"] = 420,
    ["project.json"] = 413,
    ["prometheus.json"] = 421,
    ["prometheus.rules.json"] = 422,
    ["prometheus.rules.test.json"] = 423,
    ["proxies.json"] = 424,
    ["publiccode.yml"] = 425,
    ["pubspec.yaml"] = 426,
    ["pyrseas-0.8.json"] = 429,
    ["quilt.mod.json"] = 714,
    ["release drafter"] = 597,
    rtx = 443,
    rustfmt = 449,
    samt = 451,
    samtrc = 452,
    ["sarif-1.0.0.json"] = 454,
    ["sarif-2.0.0.json"] = 455,
    ["sarif-2.1.0"] = 465,
    ["sarif-2.1.0-rtm.2"] = 456,
    ["sarif-2.1.0-rtm.3"] = 458,
    ["sarif-2.1.0-rtm.4"] = 460,
    ["sarif-2.1.0-rtm.5"] = 462,
    ["sarif-2.1.0-rtm.6"] = 463,
    ["sarif-external-property-file-2.1.0"] = 466,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 457,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 459,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 461,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 464,
    ["schema.org - Action"] = 468,
    ["schema.org - ContactPoint"] = 469,
    ["schema.org - Place"] = 470,
    ["schema.org - Thing"] = 471,
    ["secrethub.yml"] = 716,
    ["semantic-release"] = 474,
    ["servicehub.config.json"] = 573,
    ["servicehub.service.json"] = 572,
    ["settings.job"] = 477,
    ["sfdx-hardis configuration"] = 479,
    ["size-limit configuration"] = 483,
    ["skaffold.yaml"] = 639,
    ["skyuxconfig.json"] = 485,
    snapcraft = 486,
    ["sqlc configuration"] = 494,
    ["stripe-app-local.json"] = 501,
    ["stripe-app.json"] = 500,
    swcrc = 626,
    syntax = 718,
    ["task.json"] = 507,
    taskcat = 593,
    ["template.json"] = 510,
    ["templatsources.json"] = 511,
    ["theme.json"] = 514,
    ["tizen_workspace.json"] = 515,
    tldr = 516,
    tmLanguage = 517,
    tmuxinator = 581,
    ["transcend.yml"] = 523,
    ["trunk.yaml schema"] = 524,
    ["ts-force-config.json"] = 528,
    ["tsconfig.json"] = 525,
    ["tsd.json"] = 526,
    ["tsdrc.json"] = 527,
    ["tslint.json"] = 529,
    ...
    ["vega-lite.json"] = 542,
    ["vega.json"] = 541,
    ["venvironment-basic.yaml"] = 545,
    ["venvironment.yaml"] = 544,
    ["version.json"] = 546,
    ["vim-addon-info"] = 547,
    ["vs-2017.3.host.json"] = 549,
    ["vs-nesting.json"] = 550,
    ["vsls.json"] = 548,
    ["vss-extension.json"] = 554,
    ["vtesttree.yaml"] = 555,
    ["vtestunit.yaml"] = 556,
    ["webhint.io"] = 675,
    ["webjobpublishsettings.json"] = 562,
    ["webjobs-list.json"] = 561,
    ["xs-app.json"] = 589,
    ["xunit.runner.json"] = 571,
    yamllint = 613,
    zuul = 598,
    ["Žinoma"] = 607
  },
