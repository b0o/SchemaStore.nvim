...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 186,
    [".cryproj (generic)"] = 631,
    [".cryproj engine-5.2"] = 626,
    [".cryproj engine-5.3"] = 627,
    [".cryproj engine-5.4"] = 628,
    [".cryproj engine-5.5"] = 629,
    [".cryproj engine-dev"] = 630,
    [".eslintrc"] = 240,
    [".esmrc.json"] = 232,
    [".ffizer.yaml"] = 244,
    [".htmlhintrc"] = 297,
    ...
    [".mtaext"] = 642,
    [".nodehawkrc"] = 401,
    [".npmpackagejsonlintrc"] = 404,
    [".phraseapp.yml"] = 449,
    [".pmbot.yml"] = 439,
    [".postcssrc"] = 444,
    [".powerpages-web-template-manifest"] = 446,
    [".pre-commit-config.yml"] = 447,
    [".pre-commit-hooks.yml"] = 448,
    [".putout.json"] = 468,
    [".rehyperc"] = 480,
    [".remarkrc"] = 482,
    [".sprite files"] = 537,
    ...
    ["<div>RIOTS' studio configuration"] = 609,
    ["@factorial/drupal-breakpoints-css"] = 4,
    ["A micro editor config"] = 360,
    AIConfig = 11,
    ["API Builder"] = 674,
    ["AVA Configuration"] = 733,
    ["AWS CDK cdk.json"] = 170,
    ["AWS CloudFormation"] = 171,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 172,
    ["AWS SAM CLI Samconfig"] = 173,
    ["Adobe UXP Manifest"] = 798,
    ["Aerleon Network & Service Definitions"] = 7,
    ["Aerleon Policy"] = 8,
    ["Airlock Microgateway"] = 12,
    ["Airplane task"] = 13,
    ["Alacritty Configuration"] = 705,
    ["All Contributors configuration file"] = 763,
    ...
    ["Azure Pipelines"] = 63,
    ["Azure Static Web Apps CLI configuration file"] = 540,
    ["Azure Static Web Apps configuration file"] = 539,
    ["BX CI"] = 100,
    ["Bashly (bashly.yml)"] = 767,
    ["Bashly Settings (bashly-settings.yml)"] = 768,
    ["Better Code Hub"] = 678,
    ["Better Scripts"] = 101,
    Bigconfig = 80,
    BizTalkServerApplicationSchema = 648,
    Bleep = 102,
    ...
    ["Butane Config"] = 718,
    ["CICS TS region tagging"] = 727,
    ["CICS TS resource import"] = 728,
    ["CICS TS resource model"] = 729,
    ["CICS TS resource overrides"] = 730,
    ["CMake Presets"] = 103,
    ["CNC Codes"] = 114,
    ["CSS Comb (.csscomb.json)"] = 188,
    ["CSS Lint (.csslintrc)"] = 189,
    ["CSpell (cspell.json)"] = 187,
    ...
    Cheatsheets = 715,
    ["Chrome Extension"] = 163,
    ["Chromia Model"] = 110,
    ["CircleCI config.yml"] = 140,
    ["Citation File Format"] = 175,
    CityJSON = 112,
    ["Code Climate"] = 141,
    CodeCV = 60,
    ["CodeShip Pro services configuration files"] = 152,
    ["CodeShip Pro steps configuration files"] = 153,
    ["Codecov configuration files"] = 151,
    Codux = 149,
    ["Cog config file"] = 115,
    ["Commandbox Box.json"] = 116,
    ["Commandbox Server.json"] = 117,
    ["Common Catalog Data"] = 161,
    Conjure = 113,
    ["Container Structure Test"] = 661,
    Containerlab = 686,
    ["Crowdsec collection config"] = 182,
    ["Crowdsec parser config"] = 183,
    ["Crowdsec scenario config"] = 184,
    ["CumulusCI Config"] = 118,
    ["DWP Exchange - catalogue entry"] = 228,
    ["DWP Exchange - gateway"] = 226,
    ["DWP Exchange - meta"] = 227,
    ["Dart Build Config (dart-build.json)"] = 190,
    ["Dart Test Config (dart-test.json)"] = 191,
    ["DashLord Configuration"] = 192,
    ["Data Contract Specification"] = 193,
    ["Databricks Asset Bundles"] = 784,
    ["Datadog Service Definition"] = 337,
    ["Datahub Ingestion Recipe"] = 734,
    ["Dein Config"] = 120,
    ["Deno Config (deno.json)"] = 199,
    ["Deployer Recipe"] = 202,
    ["Deta Spacefile"] = 121,
    ["Detekt Config (detekt.yml)"] = 203,
    ["Devbox Config"] = 122,
    ["Devbox Plugin"] = 123,
    Devfile = 225,
    ["Discord Webhook"] = 204,
    ["DocFx Config (docfx.json)"] = 207,
    ["Dolittle Artifacts"] = 208,
    ["Dolittle Bounded Context Configuration"] = 209,
    ["Dolittle Event Horizons Configuration"] = 210,
    ["Dolittle Resources Configuration"] = 211,
    ["Dolittle Server Configuration"] = 212,
    ["Dolittle Tenant Map Configuration"] = 214,
    ["Dolittle Tenants Configuration"] = 213,
    ["Dolittle Topology"] = 215,
    ["Drupal Breakpoints"] = 124,
    ["Drupal Config"] = 135,
    ["Drupal Info"] = 125,
    ["Drupal Layouts"] = 126,
    ["Drupal Libraries"] = 127,
    ["Drupal Links Action"] = 128,
    ["Drupal Links Contextual"] = 129,
    ["Drupal Links Menu"] = 130,
    ["Drupal Links Task"] = 131,
    ["Drupal Migration"] = 132,
    ["Drupal Permissions"] = 133,
    ["Drupal Routing"] = 134,
    ["Drupal Services"] = 136,
    ["Drush site aliases"] = 221,
    ["Dynamic Bash Aliases (.aliases)"] = 775,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 764,
    ["Elgato Stream Deck"] = 231,
    ["Embrace Config"] = 745,
    Endurica = 788,
    ["Error pages"] = 235,
    Esquio = 233,
    ["Estuary Flow Catalog"] = 724,
    ["Expo SDK"] = 238,
    ...
    ["Frogbot Config"] = 69,
    ["G2P Mapping Configuration"] = 259,
    ["GCP Blueprint Metadata"] = 262,
    Gaspar = 260,
    ["GatewayCore API Gateway"] = 261,
    ["GeoJSON.json latest"] = 722,
    GherKing = 726,
    ["GitHub Action"] = 265,
    ["GitHub Discussion"] = 266,
    ["GitHub Funding"] = 267,
    ["GitHub Issue Template configuration"] = 269,
    ["GitHub Workflow"] = 270,
    ["GitHub Workflow Template Properties"] = 271,
    ["GitHub issue forms"] = 268,
    GitVersion = 264,
    ["Gitpod Configuration"] = 273,
    ["Global Privacy Control"] = 263,
    Goblet = 783,
    ["Google Chrome Related Website Sets"] = 246,
    ["Google Cloud Workflows"] = 169,
    Gorder = 277,
    Goreleaser = 278,
    ["Goreleaser Pro"] = 279,
    Goss = 280,
    ["Gradle Build Cache Node"] = 676,
    ["Gradle Enterprise"] = 675,
    ["Grafana 5.x Dashboard"] = 281,
    ["GraphQL Code Generator"] = 284,
    ["GraphQL Config"] = 283,
    ["GraphQL Mesh"] = 282,
    ["Grunt JSHint task"] = 288,
    ["Grunt Watch task"] = 289,
    ["Grunt base task"] = 290,
    ["Grunt clean task"] = 286,
    ["Grunt copy task"] = 285,
    ["Grunt cssmin task"] = 287,
    HEMTT = 645,
    Hadolint = 657,
    Hammerkit = 685,
    ["Hardware Sentry Configuration"] = 738,
    Hatch = 658,
    Hayson = 292,
    ["Haystack Pipeline"] = 293,
    ["Hazelcast 5 Configuration"] = 294,
    ["Helm Chart.lock"] = 138,
    ["Helm Chart.yaml"] = 137,
    ["Helm Unittest Test Suite"] = 139,
    Hugo = 714,
    ["Hugo Theme"] = 713,
    ["IBM Zapp document"] = 299,
    ["IBM zCodeFormatSettings"] = 300,
    ["IMG Catapult PSP"] = 305,
    Istanbul = 741,
    ["JDownloader2 crawler multi-rules"] = 315,
    ["JDownloader2 crawler single-rules"] = 314,
    ["JFrog Applications Config"] = 316,
    ["JFrog File Spec"] = 317,
    ["JFrog Pipelines YML DSL"] = 747,
    ["JMeter DSL cli config"] = 318,
    JReleaser = 320,
    ["JSON Document Transform"] = 327,
    ["JSON Feed"] = 328,
    ["JSON Resume"] = 487,
    ["JSON Schema Draft 2020-12"] = 622,
    ["JSON Schema Draft 4"] = 619,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 785,
    ["JSON Schema Draft 7"] = 620,
    ["JSON Schema Draft 7 (unofficial strict)"] = 786,
    ["JSON Schema Draft 8 (2019-09)"] = 621,
    ["JSON-API"] = 326,
    ["JSON-e templates"] = 683,
    ["JSON-stat 2.0"] = 616,
    JSONPatch = 330,
    Jasmine = 310,
    Jekyll = 311,
    ["Jenkins X Pipelines"] = 312,
    ["Jenkins X Requirements"] = 313,
    ["Jovo Language Models"] = 319,
    ["KIMMDY config file"] = 335,
    ["KSP-AVC"] = 617,
    ["KSP-CKAN"] = 618,
    ["Karakum configuration file"] = 256,
    Kas = 333,
    ["Keycloak REST API"] = 755,
    ["Knative Functions - func.yaml"] = 257,
    ["KoDE/CI build.yaml"] = 743,
    ["Kong DBLess config"] = 744,
    KrakenD = 336,
    LOOBin = 355,
    Lefthook = 344,
    ["Liferay client-extension.yaml"] = 351,
    ["LinkML Metamodel"] = 353,
    Liquibase = 690,
    ["Liquibase Flow File"] = 691,
    ["Lively Properties"] = 354,
    ["Lobe AI Agent"] = 62,
    ["MLOS Configs"] = 387,
    ["MS2Rescore Configuration"] = 389,
    ["Madness (madness.yml)"] = 766,
    Markdownlint = 694,
    ["Mason Registry"] = 696,
    ["MegaLinter configuration"] = 361,
    ["MegaLinter descriptor"] = 362,
    Melange = 792,
    ["Meltano plugin discovery definition"] = 364,
    ["Meltano project definition"] = 363,
    ["Micro Editor Syntax"] = 776,
    ["Microsoft Band Web Tile"] = 365,
    ["Minecraft Custom Main Menu Mod"] = 793,
    ["Minecraft Data Pack Advancement"] = 367,
    ["Minecraft Data Pack Biome"] = 368,
    ["Minecraft Data Pack Configured Carver"] = 369,
    ["Minecraft Data Pack Damage Type"] = 370,
    ["Minecraft Data Pack Dimension"] = 372,
    ["Minecraft Data Pack Dimension Type"] = 371,
    ["Minecraft Data Pack Item Modifier"] = 373,
    ["Minecraft Data Pack Loot Table"] = 374,
    ["Minecraft Data Pack Metadata"] = 375,
    ["Minecraft Data Pack Predicate"] = 376,
    ["Minecraft Data Pack Recipe"] = 377,
    ["Minecraft Data Pack Tag"] = 378,
    ["Minecraft Data Pack Template Pool"] = 379,
    ["Minecraft Data Pack Trim Material"] = 384,
    ["Minecraft Data Pack Trim Pattern"] = 385,
    ["Minecraft Resource Pack Lang"] = 380,
    ["Minecraft Resource Pack Particle"] = 381,
    ["Minecraft Resource Pack Texture Mcmeta"] = 383,
    ["Minecraft Resourcepack Sounds"] = 382,
    ["MkDocs Configuration 1.0"] = 386,
    ["MongoDB Atlas Search Index Definition"] = 742,
    ["Monika Configuration"] = 740,
    ["Motif config"] = 641,
    ["NOX Framework (Service)"] = 403,
    ["Netin Diagnostic System Template"] = 700,
    ["Netlify config"] = 394,
    ["Network-as-Code Data Model"] = 395,
    ["Nightwatch.js"] = 396,
    ["ONe's changelog entry"] = 419,
    ["ONe's service descriptor"] = 418,
    ["OSS Review Toolkit configuration"] = 426,
    ["OSS Review Toolkit curation"] = 427,
    ["OSS Review Toolkit package configuration"] = 428,
    ["OSS Review Toolkit repository configuration"] = 429,
    ["OSS Review Toolkit resolutions"] = 430,
    Opctl = 644,
    ["OpenRewrite Resource"] = 421,
    ["OpenUtau character yaml"] = 415,
    ["OpenUtau ustx"] = 416,
    ["OpenWeather Current Weather API"] = 682,
    ["OpenWeather Road Risk API"] = 681,
    ["Ory Hydra configuration"] = 298,
    ["Ory Keto configuration"] = 338,
    ["Ory Kratos configuration"] = 425,
    ["Ory Oathkeeper configuration"] = 410,
    ["Outblocks App configuration"] = 423,
    ["Outblocks database table"] = 424,
    ["Outblocks project configuration"] = 422,
    PDM = 436,
    Packer = 433,
    Pantsbuild = 762,
    ["Paper paper-plugin.yml"] = 434,
    ["Pipeline component"] = 692,
    ["PocketMine plugin.yml"] = 440,
    ["Postman collection"] = 445,
    ["Problem object RFC9457"] = 790,
    ["Problem package generators"] = 452,
    Pterodactyl = 737,
    ["Pull Request Labeler"] = 467,
    Pulumi = 473,
    PyProject = 474,
    Pyright = 475,
    Qgoda = 476,
    Qodana = 710,
    ["Quali Torque Blueprint Spec 2"] = 735,
    ["QueryFirst config file"] = 758,
    ["RKE Cluster Configuration JSON"] = 689,
    ["RKE Cluster Configuration YAML"] = 688,
    ["Rancher Fleet"] = 470,
    Ray = 656,
    ["Read the Docs"] = 472,
    ["Red-DiscordBot Cog"] = 477,
    ["Red-DiscordBot Cog Repo"] = 478,
    ["Red-DiscordBot Trivia"] = 479,
    RenderCV = 489,
    Renovate = 488,
    ["Replit config"] = 483,
    RoadRunner = 490,
    ["Rudder techniques"] = 796,
    Ruff = 485,
    ["Rust Project"] = 486,
    ["Rust toolchain"] = 493,
    ["SIL Kit Participant Configuration"] = 525,
    ["SIL Kit Registry Configuration"] = 526,
    SWADL = 551,
    ["Safebox Config"] = 748,
    ["Sapphire CLI Config"] = 496,
    ["SauceCTL Configuration"] = 697,
    ["Schema Catalog"] = 510,
    ["Scoop manifest"] = 515,
    ["Semantic Data Fabric (SDF) file"] = 516,
    ["Semgrep Rule"] = 518,
    ["Serenity Code Generator (Sergen)"] = 519,
    ["Serverless Framework Configuration"] = 704,
    ["Serverless Workflow"] = 706,
    ["Settings.paf"] = 521,
    ["Shopware 6 Configuration"] = 707,
    ["Shopware CLI Extension Store Configuration"] = 708,
    ["Shopware CLI Project Store Configuration"] = 709,
    Sigma = 523,
    ["Sigrid scope configuration file"] = 524,
    ["SkyPilot Task JSON"] = 797,
    ["Slack app manifest"] = 528,
    Solidarity = 531,
    ["Solution filters"] = 532,
    ["Source Maps v3"] = 533,
    Sourcery = 534,
    SpecIF = 535,
    ["Sponge Mixin configuration"] = 536,
    StackBlitz = 541,
    ["StackHawk Scanner Configuration"] = 703,
    Stale = 542,
    ["Starlake Data Pipeline"] = 679,
    Starship = 543,
    ["Statamic Blueprint"] = 544,
    ["Stella configuration file"] = 545,
    ["StrmPrivacy Data Connector"] = 752,
    ["StrmPrivacy Data Contract"] = 753,
    ["StrmPrivacy SimpleSchema"] = 750,
    ["StrmPrivacy Stream"] = 751,
    ["StrmPrivacy batch job configuration file"] = 749,
    ["Stryker Mutator"] = 548,
    ["StyleCop Analyzers Configuration"] = 549,
    ["Stylelint (.stylelintrc)"] = 550,
    ["Sublime Syntax"] = 754,
    ["Subsquid squid manifest"] = 799,
    ["Swagger API 2.0"] = 552,
    TSON = 577,
    TSTyche = 578,
    Talhelper = 554,
    ["Talisman configuration"] = 555,
    ["Taskfile config"] = 684,
    Taurus = 556,
    ["TestEnvironment.json"] = 565,
    ["TextMate Grammar"] = 564,
    ["Tier.run pricing.json"] = 559,
    Tikibase = 560,
    ["Traefik v2"] = 568,
    ["Traefik v2 File Provider"] = 569,
    ["Travis CI (.travis.yml)"] = 567,
    TunnelHub = 789,
    Turborepo = 566,
    Tye = 711,
    ["UET BuildConfig.json"] = 759,
    ["UI5 Manifest"] = 587,
    ["UNCORS configuration"] = 591,
    ["UTAM Page Object"] = 590,
    ["Ubuntu Server Autoinstall"] = 585,
    ["Uniswap Token List"] = 667,
    ["Unreal Engine Uplugin"] = 760,
    ["Unreal Engine Uproject"] = 761,
    ["Updatecli Compose"] = 719,
    ["Updatecli Policy Manifest"] = 720,
    ["Updatecli Policy Metadata"] = 721,
    Uplift = 757,
    ["User Journey Map"] = 687,
    V2Ray = 725,
    ["VSCode Code Snippets"] = 157,
    ["VSIX CLI publishing"] = 604,
    ["Vela Pipeline Configuration"] = 594,
    Vercel = 156,
    Visivo = 787,
    ["Web App Manifest"] = 611,
    ["Web types"] = 614,
    WebExtensions = 610,
    ["Webman package recipe"] = 731,
    ["Windows Package Manager Installer Manifest"] = 664,
    ["Windows Package Manager Locale Manifest"] = 665,
    ["Windows Package Manager Singleton Manifest"] = 663,
    ["Woodpecker pipeline config"] = 699,
    ["Wrangler CLI"] = 615,
    ["Xstate Machine"] = 717,
    ["Yarn Config (.yarnrc.yml)"] = 677,
    ["Yippee-Ki-JSON configuration YML"] = 669,
    ["aerleon.yml"] = 6,
    ["angular.json"] = 14,
    apko = 791,
    ...
    ["chisel-slices.json"] = 174,
    ["chrome-extension-locales-messages.json"] = 164,
    ["chutzpah.json"] = 165,
    cibuildwheel = 111,
    ["clang-format (.clang-format)"] = 723,
    clangd = 144,
    clib = 145,
    ["cloud-init: cloud-config userdata"] = 147,
    ["cloud-sdk-pipeline-configuration"] = 167,
    ["cloudbuild.json"] = 168,
    cloudify = 146,
    codemagic = 148,
    ["coffeelint.json"] = 176,
    ["commands.json"] = 160,
    ["commitlint (.commitlintrc)"] = 666,
    ["compile_commands.json"] = 159,
    ["compilerconfig.json"] = 158,
    ["completely.yml"] = 765,
    ["component-detection-manifest.json"] = 179,
    ["component.json"] = 178,
    ["composer.json"] = 177,
    ["config.yaml"] = 471,
    ["contentmanifest.json"] = 166,
    ["contribute.json"] = 180,
    ["cosmos.config.json"] = 162,
    ["crowdin.yml"] = 181,
    ["custom-elements.json"] = 779,
    ["cypress.json"] = 185,
    ["datalogic-scan2deploy-android"] = 194,
    ["datalogic-scan2deploy-ce"] = 195,
    ["dbt Project"] = 119,
    ["ddev-global"] = 196,
    ["ddev-project"] = 197,
    ["debugsettings.json"] = 198,
    ["dependabot-v2.json"] = 201,
    ["dependabot.json"] = 200,
    ["deployed-cli"] = 716,
    ["devcontainer.json"] = 150,
    devinit = 671,
    ["devspace.yaml"] = 739,
    djlint = 672,
    ["docker sequencer"] = 206,
    ["docker-compose.yml"] = 670,
    ["dockerd.json"] = 205,
    ["dotnet Release Index manifest"] = 216,
    ["dotnet-tools.json"] = 217,
    ["dotnetcli.host.json"] = 218,
    ["dprint.json"] = 219,
    ["drone.json"] = 220,
    ["dss-2.0.0.json"] = 222,
    ["dstack configuration"] = 223,
    ["dvc.yaml"] = 224,
    ["ecosystem.json"] = 229,
    eksctl = 230,
    ...
    ["gitlab-ci"] = 272,
    ["global.json"] = 274,
    ["go-feature-flag Flag Configuration"] = 276,
    ["golangci-lint Configuration"] = 275,
    ["haxelib.json"] = 291,
    helmfile = 659,
    helmwave = 660,
    ["host-meta.json"] = 296,
    ...
    ["ide.host.json"] = 301,
    ["ifstate.conf"] = 302,
    ["imageoptimizer.json"] = 303,
    ["importmap.json"] = 306,
    ["ioBroker Configuration"] = 307,
    ["ioBroker JSON UI"] = 308,
    ["ioBroker Package manifest"] = 309,
    ["ize.toml"] = 756,
    ["jsconfig.json"] = 331,
    ["jscpd Configuration"] = 736,
    jsdoc = 655,
    ["k3d.yaml"] = 332,
    ["k9s plugin.yml"] = 334,
    ["kontinuous-config.yaml"] = 340,
    ["kontinuous-values.yaml"] = 339,
    ["kustomization.yaml"] = 341,
    ["label-commenter-config.yml"] = 342,
    ["latexindent configuration"] = 61,
    ["launchsettings.json"] = 343,
    lazydocker = 778,
    lazygit = 777,
    ["lego.json"] = 345,
    ["lerna.json"] = 346,
    ["lgtm.yml"] = 347,
    ["liblab.config.json"] = 348,
    ["libman.json"] = 349,
    ["license-report-config.json"] = 350,
    ["linkinator.config.json"] = 352,
    ["lint-staged (.lintstagedrc)"] = 635,
    ["local.settings.json"] = 357,
    ["localazy.json"] = 358,
    ["lotus.yaml"] = 356,
    ["lsdlschema.json"] = 359,
    ["markdown-lint-check"] = 695,
    mboats = 702,
    ["micro-settings.json"] = 771,
    ["mimetypes.json"] = 366,
    ["mirrord config"] = 636,
    mise = 637,
    ["mise-settings"] = 638,
    ...
    ["mtad.yaml"] = 640,
    ["mycode.json"] = 392,
    ["napari plugin manifest"] = 393,
    neoload = 650,
    ["nest-cli"] = 399,
    ["ninjs (News in JSON) 1.3"] = 398,
    ["ninjs (News in JSON) 2.0"] = 397,
    ["nixd configuration"] = 795,
    ["nlu.json"] = 400,
    ["nodemon.json"] = 402,
    ["noodl config"] = 701,
    now = 646,
    ...
    ["nswag.json"] = 408,
    ntangle = 409,
    ["nuclei-template.yaml"] = 406,
    ["nuget-project.json"] = 407,
    ["ocelot.json"] = 411,
    ["omnisharp.json"] = 412,
    ["openapi.json"] = 413,
    ["openfin.json"] = 420,
    ...
    ["ops.yaml"] = 417,
    ["package.json"] = 431,
    ["package.manifest"] = 432,
    ["pathfinder.yml"] = 435,
    ["pattern.json"] = 438,
    ["petstore-v1.0"] = 746,
    pgap_yaml_input_reader = 437,
    ["plagiarize-me.yaml"] = 442,
    ["plagiarize.yaml"] = 441,
    ["portman.json"] = 443,
    ["prettierrc.json"] = 450,
    ["prisma.yml"] = 451,
    ["project-1.0.0-beta3.json"] = 454,
    ["project-1.0.0-beta4.json"] = 455,
    ["project-1.0.0-beta5.json"] = 456,
    ["project-1.0.0-beta6.json"] = 457,
    ["project-1.0.0-beta8.json"] = 458,
    ["project-1.0.0-rc1.json"] = 459,
    ["project-1.0.0-rc2.json"] = 460,
    ["project.json"] = 453,
    ["prometheus.json"] = 461,
    ["prometheus.rules.json"] = 462,
    ["prometheus.rules.test.json"] = 463,
    ["proxies.json"] = 464,
    ["publiccode.yml"] = 465,
    ["pubspec.yaml"] = 466,
    ["pyrseas-0.8.json"] = 469,
    ["quilt.mod.json"] = 772,
    ["release drafter"] = 651,
    ["release-plz.toml"] = 481,
    ["rivet.yaml"] = 794,
    rockcraft = 491,
    rustfmt = 492,
    samt = 494,
    samtrc = 495,
    ["sarif-1.0.0.json"] = 497,
    ["sarif-2.0.0.json"] = 498,
    ["sarif-2.1.0"] = 508,
    ["sarif-2.1.0-rtm.2"] = 499,
    ["sarif-2.1.0-rtm.3"] = 501,
    ["sarif-2.1.0-rtm.4"] = 503,
    ["sarif-2.1.0-rtm.5"] = 505,
    ["sarif-2.1.0-rtm.6"] = 506,
    ["sarif-external-property-file-2.1.0"] = 509,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 500,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 502,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 504,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 507,
    ["schema.org - Action"] = 511,
    ["schema.org - ContactPoint"] = 512,
    ["schema.org - Place"] = 513,
    ["schema.org - Thing"] = 514,
    ["secrethub.yml"] = 774,
    ["semantic-release"] = 517,
    ["servicehub.config.json"] = 625,
    ["servicehub.service.json"] = 624,
    ["settings.job"] = 520,
    ["sfdx-hardis configuration"] = 522,
    ["size-limit configuration"] = 527,
    ["skaffold.yaml"] = 693,
    ["skyuxconfig.json"] = 529,
    snapcraft = 530,
    ["sqlc configuration"] = 538,
    ["stripe-app-local.json"] = 547,
    ["stripe-app.json"] = 546,
    swcrc = 680,
    ["task.json"] = 553,
    taskcat = 647,
    ["template.json"] = 557,
    ["templatsources.json"] = 558,
    ["theme.json"] = 561,
    ["tizen_workspace.json"] = 562,
    tldr = 563,
    tmuxinator = 633,
    ["transcend.yml"] = 570,
    ["trunk.yaml"] = 571,
    ["ts-force-config.json"] = 575,
    ["tsconfig.json"] = 572,
    ["tsd.json"] = 573,
    ["tsdrc.json"] = 574,
    ["tslint.json"] = 576,
    ...
    ["typingsrc.json"] = 584,
    ["typo3.json"] = 582,
    ["ui5-workspace.yaml"] = 589,
    ["ui5.yaml"] = 588,
    unist = 712,
    ["up.json"] = 586,
    v8r = 608,
    ["vcpkg configuration file"] = 155,
    ["vcpkg manifest file"] = 154,
    ["vega-lite.json"] = 593,
    ["vega.json"] = 592,
    ["venvironment-basic.yaml"] = 596,
    ["venvironment.yaml"] = 595,
    ["version.json"] = 597,
    ["vim-addon-info"] = 598,
    ["vs-2017.3.host.json"] = 600,
    ["vs-nesting.json"] = 601,
    ["vsls.json"] = 599,
    ["vss-extension.json"] = 605,
    ["vtesttree.yaml"] = 606,
    ["vtestunit.yaml"] = 607,
    ["warp-keysets.json"] = 780,
    ["warp-themes.json"] = 781,
    ["warp-workflows.json"] = 782,
    ["webhint.io"] = 732,
    ["webjobpublishsettings.json"] = 613,
    ["webjobs-list.json"] = 612,
    ["xs-app.json"] = 643,
    ["xunit.runner.json"] = 623,
    yamllint = 668,
    zuul = 652,
    ["Žinoma"] = 662
  },
