...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1007,
    [".nodehawkrc"] = 639,
    [".npmpackagejsonlintrc"] = 643,
    [".omletrc"] = 1188,
    [".phrase.yml"] = 721,
    [".phraseapp.yml"] = 722,
    [".pmbot.yml"] = 706,
    [".postcssrc"] = 715,
    [".powerpages-web-template-manifest"] = 717,
    [".pre-commit-config.yml"] = 718,
    [".pre-commit-hooks.yml"] = 719,
    [".putout.json"] = 755,
    [".rehyperc"] = 780,
    [".remarkrc"] = 784,
    [".sprite files"] = 880,
    ...
    [".vsconfig"] = 970,
    [".vsext"] = 971,
    ["1Password SSH Agent Config"] = 13,
    ["@factorial/drupal-breakpoints-css"] = 21,
    ["A micro editor config"] = 577,
    ABCClinicalDemandForecast = 30,
    ABCInventoryModuleData = 29,
    ABCSupplyPlan = 31,
    ["ACP Attempts"] = 32,
    ["ACP Cache File"] = 33,
    ["ACP Configuration File"] = 34,
    ["ACP Primer"] = 35,
    ["ACP Sync"] = 36,
    ["ACP Variables File"] = 37,
    AIConfig = 39,
    ["AMX Muse Program Descriptor"] = 1237,
    ["API Builder"] = 1043,
    ["AVA Configuration"] = 1107,
    ["AWS AppConfig Feature Flags-v1"] = 73,
    ["AWS CDK cdk.json"] = 280,
    ["AWS CloudFormation"] = 281,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 282,
    ["AWS Copilot Manifest"] = 1276,
    ["AWS SAM CLI Samconfig"] = 283,
    Acton = 1327,
    ["Adobe UXP Manifest"] = 1170,
    ["Aerleon Network & Service Definitions"] = 24,
    ["Aerleon Policy"] = 25,
    ["Agent Permission Policy"] = 1316,
    ["AgentCore CLI"] = 1317,
    AgentLoopKit = 1318,
    Aider = 1266,
    Air = 27,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1287,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1286,
    ["Airlock Microgateway"] = 40,
    ["Alacritty Configuration"] = 1079,
    ["AlgoVoi Compliance Receipt v1"] = 14,
    ["All Contributors configuration file"] = 1133,
    Anodizer = 460,
    ["Ansible Argument Specs"] = 444,
    ["Ansible Collection Galaxy"] = 451,
    ["Ansible Execution Environment"] = 441,
    ["Ansible Inventory"] = 450,
    ["Ansible Meta"] = 442,
    ["Ansible Meta Runtime"] = 443,
    ["Ansible Navigator Configuration"] = 453,
    ["Ansible Playbook"] = 448,
    ["Ansible Requirements"] = 445,
    ["Ansible Rulebook"] = 449,
    ["Ansible Tasks File"] = 447,
    ["Ansible Vars File"] = 446,
    ["Ansible-lint Configuration"] = 452,
    Any = 1198,
    ["AnyWork Automation Configuration"] = 20,
    ["Apollo Router"] = 1044,
    ["App config Spotify Backstage"] = 44,
    ["Applicant Profile Protocol"] = 17,
    ["Application Accelerator"] = 15,
    ["Application list for a WinUtil"] = 1216,
    ArchitectFX = 1221,
    ["Argo CD"] = 59,
    ["Argo Events"] = 60,
    ["Argo Workflows"] = 61,
    AssemblyScript = 64,
    AsyncAPI = 67,
    ["AsyncAPI Tool File"] = 68,
    ["Atmos Manifests"] = 69,
    ["Aurora Agile Meta-Framework"] = 70,
    AutoAPICase = 1143,
    ["Avro Avsc"] = 71,
    ["Awesome Repositories"] = 72,
    ["Azure Container App template for defining an immutable revision"] = 75,
    ["Azure DevOps extension manifest"] = 78,
    ["Azure Device Update for IoT Hub import manifest"] = 76,
    ["Azure Device Update for IoT Hub update manifest"] = 77,
    ["Azure IoT Edge deployment"] = 81,
    ["Azure IoT Edge deployment template"] = 82,
    ["Azure IoT EdgeAgent deployment"] = 79,
    ["Azure IoT EdgeHub deployment"] = 80,
    ["Azure IoT Operations Wasm Graph Config"] = 1285,
    ["Azure IoT Operations connector metadata"] = 1282,
    ["Azure Landing Zones Library archetype definition"] = 86,
    ["Azure Landing Zones Library archetype override"] = 87,
    ["Azure Landing Zones Library architecture definition"] = 85,
    ["Azure Landing Zones Library metadata"] = 83,
    ["Azure Landing Zones Library policy default values"] = 84,
    ["Azure Pipelines"] = 119,
    ["Azure Static Web Apps CLI configuration file"] = 884,
    ["Azure Static Web Apps configuration file"] = 883,
    BMML = 1304,
    ["BOSH BPM Config"] = 145,
    ["BOSH CPI Config"] = 146,
    ["BOSH Deploy Config"] = 147,
    ["BX CI"] = 168,
    ["Bacon config"] = 8,
    ["Barba-CV"] = 88,
    ["Bashly (bashly.yml)"] = 1137,
    ["Bashly Settings (bashly-settings.yml)"] = 1138,
    Bento = 1303,
    ["Better Code Hub"] = 1048,
    ["Better Scripts"] = 169,
    Bigconfig = 138,
    ["Biome Formatter Config"] = 89,
    ["Bitmovin Encoding Template"] = 1230,
    BizTalkServerApplicationSchema = 1014,
    Bleep = 170,
    ["Block Protocol Metadata"] = 167,
    ["Bluebricks blueprint config"] = 1309,
    ["Boyka Framework"] = 148,
    ["Bpod Finite-State Machine"] = 91,
    Briefcase = 1020,
    ["Build Info"] = 158,
    Buildkite = 160,
    ["Bukkit plugin.yml"] = 159,
    ["BungeeCord plugin.yml"] = 165,
    ["Burnless SRE config"] = 1,
    ["Butane Config"] = 1092,
    C4InterFlow = 1245,
    ["CDK Environment Manager, concrete environment configuration"] = 1269,
    ["CDK Environment Manager, concrete environments definition"] = 1268,
    ["CDK Environment Manager, environment definition"] = 1267,
    ["CGS Card Game Specification (cgs.json)"] = 1175,
    ["CICS TS region tagging"] = 1101,
    ["CICS TS resource import"] = 1102,
    ["CICS TS resource model"] = 1103,
    ["CICS TS resource overrides"] = 1104,
    ["CMake Presets"] = 171,
    ["CNC Codes"] = 193,
    ["CRS WAF test file"] = 1205,
    ["CRS WAF test platform overrides file"] = 1206,
    ["CSS Comb (.csscomb.json)"] = 309,
    ["CSS Lint (.csslintrc)"] = 310,
    ["CSpell (cspell.json)"] = 308,
    ["CVE Record Format"] = 205,
    CWL = 1181,
    ["Cache Warmup config"] = 172,
    ["Caido Proxy Configuration"] = 1341,
    ["Calqulus pipeline"] = 173,
    ["Camel YAML DSL"] = 174,
    ["Cannon TOML"] = 175,
    Carafe = 176,
    ["Cargo Make"] = 178,
    ["Cargo Manifest"] = 177,
    ["Catalog Info Backstage"] = 179,
    ["Chamaleon environment"] = 1234,
    ["Chamaleon properties"] = 1235,
    ["Chamaleon template"] = 1233,
    Changepacks = 1296,
    Changesets = 292,
    Changie = 180,
    Charmcraft = 181,
    Cheatsheets = 1089,
    ["ChordPro Configuration"] = 182,
    ["Chrome Extension"] = 273,
    ["Chromia Model"] = 183,
    ["Chromia Seeder Module Config"] = 185,
    ["Chromia Seeder Root Config"] = 184,
    ["Cinnamon Spice info.json"] = 99,
    ["CircleCI config.yml"] = 244,
    ["Citation File Format"] = 294,
    ["Citrus test case"] = 187,
    CityJSON = 188,
    ["Claude Code Keybindings"] = 200,
    ["Claude Code Plugin Manifest"] = 201,
    ["Claude Code Plugin Marketplace"] = 202,
    ["Claude Code Settings"] = 203,
    ["Clawject config"] = 199,
    ["Cloud Foundry Application Manifest"] = 1187,
    ["Cloud Run Spec v1"] = 1211,
    ["Cloud.gov Workshop Configuration"] = 100,
    ["CloudCannon Configuration"] = 105,
    ["CloudCannon Configuration (Collection Structures)"] = 114,
    ["CloudCannon Configuration (Collections)"] = 113,
    ["CloudCannon Configuration (Editables)"] = 112,
    ["CloudCannon Configuration (Inputs)"] = 107,
    ["CloudCannon Configuration (Snippets Definitions)"] = 111,
    ["CloudCannon Configuration (Snippets Imports)"] = 110,
    ["CloudCannon Configuration (Snippets)"] = 109,
    ["CloudCannon Configuration (Structure Value)"] = 108,
    ["CloudCannon Configuration (Structures)"] = 106,
    ["CloudEvents specification"] = 189,
    ["Code Climate"] = 245,
    CodeCV = 103,
    CodeRabbit = 102,
    ["CodeShip Pro services configuration files"] = 262,
    ["CodeShip Pro steps configuration files"] = 263,
    ["Codecov configuration files"] = 261,
    Codex = 253,
    ["Codex Hooks"] = 254,
    ["Codex Plugin Manifest"] = 255,
    ["Codex Skill Metadata"] = 256,
    CodifyCLI = 104,
    Codux = 258,
    ["Cog config file"] = 194,
    ["Commandbox Box.json"] = 195,
    ["Commandbox Server.json"] = 196,
    ["Common Catalog Data"] = 271,
    ["Common Package Specification"] = 197,
    Concord = 1204,
    ["Configu .cfgu files"] = 1192,
    ["Configu .configu file"] = 1193,
    Conjure = 192,
    ["Container Structure Test"] = 1028,
    Containerlab = 1057,
    ["Contextive Glossary"] = 1261,
    ContractGuard = 1058,
    Convex = 191,
    ["Crowdsec collection config"] = 303,
    ["Crowdsec parser config"] = 304,
    ["Crowdsec scenario config"] = 305,
    ["CumulusCI Config"] = 198,
    ["Cursor Agent Environment"] = 1314,
    ["Custom Machinery Machine"] = 1176,
    ["Custom Machinery Recipe"] = 1177,
    ["Cycle Stack File"] = 206,
    CycloneDX = 207,
    ["DWP Exchange - catalogue entry"] = 354,
    ["DWP Exchange - gateway"] = 352,
    ["DWP Exchange - meta"] = 353,
    ["Dart Build Config (dart-build.json)"] = 311,
    ["Dart Test Config (dart-test.json)"] = 312,
    ["DashLord Configuration"] = 313,
    ["Data Contract Specification"] = 314,
    ["Data Product Specification"] = 315,
    ["DataYoga Connections"] = 208,
    ["DataYoga Job"] = 209,
    ["Datadog Continuous Testing"] = 546,
    ["Datadog Service Definition"] = 547,
    ["Datadog Software Catalog"] = 548,
    ["Datahub Ingestion Recipe"] = 1108,
    ["Debian Upstream Metadata file"] = 216,
    DebtLens = 217,
    ["Deck config"] = 218,
    ["Declarative Automation Bundles"] = 1154,
    ["DeepMatch deeplinks spec"] = 219,
    ["Dein Config"] = 220,
    ["Deno Config (deno.json)"] = 321,
    ["Dependency cruiser"] = 221,
    ["DeployStack Configuration"] = 222,
    ["Deployah Configuration"] = 1284,
    ["Deployer Recipe"] = 324,
    ["Deta Spacefile"] = 223,
    ["Detekt Config (detekt.yml)"] = 325,
    ["Devbox Config"] = 224,
    ["Devbox Plugin"] = 225,
    Devfile = 351,
    Devup = 1297,
    DipDup = 1207,
    ["Discord Webhook"] = 326,
    ["DocFx Config (docfx.json)"] = 331,
    ["Docker Desktop extension metadata"] = 328,
    ["Docs MCP Manifest"] = 332,
    Dofigen = 333,
    ["Dolittle Artifacts"] = 334,
    ["Dolittle Bounded Context Configuration"] = 335,
    ["Dolittle Event Horizons Configuration"] = 336,
    ["Dolittle Resources Configuration"] = 337,
    ["Dolittle Server Configuration"] = 338,
    ["Dolittle Tenant Map Configuration"] = 340,
    ["Dolittle Tenants Configuration"] = 339,
    ["Dolittle Topology"] = 341,
    ["DonateCaseBetterCasino menu"] = 1238,
    ["Drupal Breakpoints"] = 226,
    ["Drupal Config"] = 238,
    ["Drupal Info"] = 227,
    ["Drupal Layouts"] = 228,
    ["Drupal Libraries"] = 229,
    ["Drupal Links Action"] = 230,
    ["Drupal Links Contextual"] = 231,
    ["Drupal Links Menu"] = 232,
    ["Drupal Links Task"] = 233,
    ["Drupal Migration"] = 234,
    ["Drupal Permissions"] = 235,
    ["Drupal Recipe"] = 236,
    ["Drupal Routing"] = 237,
    ["Drupal Services"] = 239,
    ["Drush site aliases"] = 347,
    ["Dynamic Bash Aliases (.aliases)"] = 1145,
    ["EAS config"] = 392,
    ["ECA - Editor Code Assistant"] = 356,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1134,
    ["ESLint Suppressions"] = 397,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1281,
    ["EasyVCR .NET"] = 394,
    ["Eidolon Resource"] = 1222,
    ["Elgato Stream Deck"] = 358,
    Elm = 1209,
    ["Embrace Config"] = 1120,
    Emmet = 1210,
    Endurica = 1158,
    ["Enonic XP API descriptor"] = 361,
    ["Enonic XP Admin Extension descriptor"] = 362,
    ["Enonic XP Admin Tool descriptor"] = 363,
    ["Enonic XP Application descriptor"] = 364,
    ["Enonic XP CMS descriptor"] = 365,
    ["Enonic XP Content Type descriptor"] = 366,
    ["Enonic XP Form Fragment descriptor"] = 367,
    ["Enonic XP ID Provider descriptor"] = 368,
    ["Enonic XP Layout descriptor"] = 369,
    ["Enonic XP Macro descriptor"] = 370,
    ["Enonic XP Mixin descriptor"] = 371,
    ["Enonic XP Page descriptor"] = 372,
    ["Enonic XP Part descriptor"] = 373,
    ["Enonic XP Service descriptor"] = 374,
    ["Enonic XP Site descriptor"] = 375,
    ["Enonic XP Style descriptor"] = 376,
    ["Enonic XP Task descriptor"] = 377,
    ["Enonic XP Webapp descriptor"] = 378,
    ["Enterprise Contract Policy Spec"] = 359,
    ["Envelope Team Definition"] = 1326,
    ["Envilder Map File"] = 360,
    ["Erda Pipeline"] = 1183,
    ["Erda Runtime"] = 1184,
    ["Espanso config.yml"] = 1307,
    ["Espanso match.yml"] = 1306,
    Esquio = 380,
    ["Estuary Flow Catalog"] = 1098,
    ["Ethereum ERC1155"] = 1320,
    ["Ethereum ERC721"] = 1319,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 385,
    ["EveryVoice TTS Toolkit Data Configuration"] = 386,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 390,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 389,
    ["EveryVoice TTS Toolkit Text Configuration"] = 387,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 388,
    ["Evolving Resolutive Process notation"] = 1283,
    ["Expo SDK"] = 391,
    ["Expoot app config"] = 393,
    ["F-Droid Data metadata"] = 399,
    ["FasterCI Configuration"] = 120,
    ["Fence configuration"] = 121,
    FiQuS = 403,
    Firebase = 401,
    ["Flatpak Builder Manifest"] = 404,
    ["FlexGet Config"] = 405,
    ["Flow.json Configurations"] = 1180,
    ["Fossa configuration file"] = 412,
    ["Fossa's fossa-deps file"] = 413,
    ["Foundry VTT - Base package Manifest"] = 407,
    ["Foundry VTT - Module Manifest"] = 408,
    ["Foundry VTT - System Data Template"] = 411,
    ["Foundry VTT - System Manifest"] = 409,
    ["Foundry VTT - World Manifest"] = 410,
    ["Foxx Manifest"] = 122,
    ["Freifunk.de Community API"] = 125,
    ["Frogbot Config"] = 126,
    ["G2P Mapping Configuration"] = 419,
    ["GCP Blueprint Metadata"] = 422,
    Gaspar = 420,
    ["GatewayCore API Gateway"] = 421,
    ["Gemini CLI settings"] = 423,
    ["GeoJSON.json latest"] = 1096,
    GherKing = 1100,
    ["GitHub Action"] = 429,
    ["GitHub Actions typing"] = 1218,
    ["GitHub Discussion"] = 430,
    ["GitHub Funding"] = 431,
    ["GitHub Issue Template configuration"] = 432,
    ["GitHub Issue Template forms"] = 433,
    ["GitHub Pages Jekyll"] = 434,
    ["GitHub Workflow"] = 435,
    ["GitHub Workflow Template Properties"] = 436,
    ["GitHub automatically generated release notes configuration"] = 437,
    ["GitLab Agent for Kubernetes configuration"] = 1172,
    GitVersion = 426,
    ["Gitea Issue Template configuration"] = 427,
    ["Gitea Issue Template forms"] = 428,
    ["Gitpod Automations"] = 439,
    ["Gitpod Configuration"] = 440,
    ["Glamour style"] = 424,
    ["GlazeWM settings"] = 1174,
    ["Global Privacy Control"] = 425,
    Goblet = 1153,
    ["Golangci-lint Configuration"] = 455,
    ["Golangci-lint Custom Plugins Configuration"] = 456,
    ["Google Chrome Related Website Sets"] = 402,
    ["Google Cloud Workflows"] = 279,
    ["Google Digital Assetlinks"] = 1262,
    Goreleaser = 458,
    ["Goreleaser Pro"] = 459,
    Goss = 461,
    ["Gradle Build Cache Node"] = 1046,
    ["Gradle Enterprise"] = 1045,
    ["Grafana 5.x Dashboard"] = 462,
    ["GraphQL Code Generator"] = 467,
    ["GraphQL Config"] = 466,
    ["GraphQL Mesh"] = 465,
    ["GroovyLint configuration"] = 468,
    ["Grunt JSHint task"] = 472,
    ["Grunt Watch task"] = 473,
    ["Grunt base task"] = 474,
    ["Grunt clean task"] = 470,
    ["Grunt copy task"] = 469,
    ["Grunt cssmin task"] = 471,
    HEMTT = 1010,
    Hadolint = 1024,
    Hammerkit = 1056,
    ["Hardware Sentry Configuration"] = 1112,
    ["Hashgraph Online Skill Manifest"] = 4,
    ["HashiCorp Vault"] = 475,
    Hatch = 1025,
    Hayson = 477,
    ["Haystack Pipeline"] = 478,
    ["Hazelcast 5 Configuration"] = 479,
    ["Hecate Input Schema"] = 1273,
    ["Helm Chart.lock"] = 241,
    ["Helm Chart.yaml"] = 240,
    ["Helm Unittest Test Suite"] = 242,
    ["Hex file"] = 243,
    ["Home Assistant Integration Manifest"] = 480,
    ["Homer dashboard configuration"] = 481,
    Hugo = 1088,
    ["Hugo Theme"] = 1087,
    ["Hulak Configuration"] = 488,
    ["Hyperfoil benchmark configuration"] = 487,
    ["IBM Zapp document"] = 489,
    ["IBM zCodeFormatSettings"] = 490,
    ["IMG Catapult PSP"] = 495,
    ["IVMS101 by CODE Protocol"] = 1173,
    ["Infinispan Configuration"] = 497,
    ["Infinispan Server Configuration"] = 498,
    Infrahub = 499,
    Istanbul = 1116,
    ["JDownloader2 crawler multi-rules"] = 513,
    ["JDownloader2 crawler single-rules"] = 512,
    ["JFrog Applications Config"] = 514,
    ["JFrog File Spec"] = 515,
    ["JFrog Pipelines YML DSL"] = 1122,
    ["JMeter DSL cli config"] = 516,
    JReleaser = 519,
    ["JSON Document Transform"] = 527,
    ["JSON Feed"] = 528,
    ["JSON Resume"] = 792,
    ["JSON Schema Draft 2020-12"] = 992,
    ["JSON Schema Draft 4"] = 989,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1155,
    ["JSON Schema Draft 7"] = 990,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1156,
    ["JSON Schema Draft 8 (2019-09)"] = 991,
    ["JSON-API"] = 526,
    ["JSON-e templates"] = 1053,
    ["JSON-stat 2.0"] = 985,
    JSONPatch = 530,
    ["JSR Package Config (jsr.json)"] = 520,
    Jarl = 1289,
    Jasmine = 507,
    Jekyll = 508,
    ["Jenkins X Pipelines"] = 509,
    ["Jenkins X Requirements"] = 510,
    Jest = 511,
    Jocker = 517,
    ["Jovo Language Models"] = 518,
    ["Jujutsu (jj) VCS config"] = 1275,
    ["KIMMDY config file"] = 541,
    ["KODE/CI build.yaml"] = 1118,
    ["KSP-AVC"] = 986,
    ["KSP-CKAN"] = 987,
    ["KSP-NetKAN"] = 988,
    KSY = 1185,
    KSail = 417,
    ["KYA Manifest"] = 1186,
    ["Karakum configuration file"] = 414,
    Kas = 533,
    ["Kestra flow file"] = 542,
    ["Keycloak REST API"] = 1125,
    ["Knative Functions - func.yaml"] = 415,
    Knip = 416,
    ["Knowledge Unit"] = 550,
    ["Kometa (nightly) config file"] = 544,
    ["Kometa config file"] = 543,
    ["Kong DBLess config"] = 1119,
    KrakenD = 545,
    ["Kubri Configuration"] = 553,
    LOOBin = 568,
    ["Lake configuration file"] = 1278,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 284,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 285,
    ["Landing Zone Accelerator on AWS - Global Config"] = 286,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 287,
    ["Landing Zone Accelerator on AWS - Network Config"] = 288,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 289,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 290,
    ["Landing Zone Accelerator on AWS - Security Config"] = 291,
    ["Lando (landofile)"] = 115,
    ["LangGraph Platform configuration"] = 1197,
    ["Language configuration"] = 1196,
    Lefthook = 557,
    ["Liferay client-extension.yaml"] = 564,
    ["LinkML Metamodel"] = 566,
    Liquibase = 1063,
    ["Liquibase Flow File"] = 1064,
    ["Lively Properties"] = 567,
    ["Lobe AI Agent"] = 117,
    Loki = 118,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 610,
    ["MS2Rescore Configuration"] = 616,
    ["MSTest testconfig.json"] = 617,
    ["Madness (madness.yml)"] = 1136,
    ["Mado configuration"] = 574,
    ["Maestro Flow"] = 575,
    ["Mail Servers Configuration"] = 1310,
    ["MapEHR Mapping"] = 576,
    Markdownlint = 1067,
    ["Mason Registry"] = 1070,
    ["MegaLinter Custom Flavor"] = 579,
    ["MegaLinter configuration"] = 578,
    ["MegaLinter descriptor"] = 580,
    Melange = 1163,
    ["Meltano project definition"] = 581,
    ["Mergify Configuration"] = 618,
    ["Metadata for a Bazel module"] = 582,
    ["Metadata for a Cinnamon spice"] = 1214,
    ["Metatype Configuration"] = 583,
    ["MetricsHub Configuration"] = 584,
    ["MetricsHub Connector Configuration"] = 585,
    ["Micro Editor Syntax"] = 1146,
    ["Microsoft Band Web Tile"] = 586,
    ["Microsoft RulesEngine workflow rules"] = 1201,
    ["Microsoft RulesEngine workflow rules list"] = 1202,
    ["Minecraft Custom Main Menu Mod"] = 1164,
    ["Minecraft Data Pack Advancement"] = 588,
    ["Minecraft Data Pack Biome"] = 589,
    ["Minecraft Data Pack Configured Carver"] = 590,
    ["Minecraft Data Pack Damage Type"] = 591,
    ["Minecraft Data Pack Dimension"] = 593,
    ["Minecraft Data Pack Dimension Type"] = 592,
    ["Minecraft Data Pack Item Modifier"] = 594,
    ["Minecraft Data Pack Loot Table"] = 595,
    ["Minecraft Data Pack Metadata"] = 596,
    ["Minecraft Data Pack Predicate"] = 597,
    ["Minecraft Data Pack Recipe"] = 598,
    ["Minecraft Data Pack Tag"] = 599,
    ["Minecraft Data Pack Template Pool"] = 600,
    ["Minecraft Data Pack Trim Material"] = 605,
    ["Minecraft Data Pack Trim Pattern"] = 606,
    ["Minecraft Resource Pack Lang"] = 601,
    ["Minecraft Resource Pack Particle"] = 602,
    ["Minecraft Resource Pack Texture Mcmeta"] = 604,
    ["Minecraft Resourcepack Sounds"] = 603,
    ["MockServer Expectations"] = 612,
    ModuleAssembler = 608,
    ["Monade CLI Stack Configuration"] = 621,
    ["MongoDB Atlas Search Index Definition"] = 1117,
    ["Monika Configuration"] = 1115,
    ["Monoweave Configuration"] = 615,
    ["Motif config"] = 1006,
    MultiQC = 1255,
    ["NOX Framework (Service)"] = 642,
    ["Netin Diagnostic System Template"] = 1074,
    ["Netlify config"] = 624,
    ["Network-as-Code Data Model"] = 625,
    ["Next Gen UI Agent A2A Server Configuration"] = 626,
    ["Next Gen UI Agent Configuration"] = 628,
    ["Next Gen UI Agent MCP Server Configuration"] = 627,
    ["Nightwatch.js"] = 635,
    ["Node.js configuration"] = 1011,
    ["NueJS configuration file"] = 647,
    ["Nuitka Package Config"] = 1178,
    ["Nullstone config"] = 649,
    ["ONe's changelog entry"] = 668,
    ["ONe's service descriptor"] = 667,
    ["ORT Server repository environment configuration"] = 678,
    ["OSCAL Assessment Plan (AP)"] = 680,
    ["OSCAL Assessment Results (AR)"] = 681,
    ["OSCAL Catalog"] = 682,
    ["OSCAL Component Definition (CDef)"] = 683,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 684,
    ["OSCAL Profile"] = 685,
    ["OSCAL System Security Plan (SSP)"] = 686,
    ["OSS Review Toolkit configuration"] = 687,
    ["OSS Review Toolkit curation"] = 688,
    ["OSS Review Toolkit package configuration"] = 689,
    ["OSS Review Toolkit project package manager definition"] = 690,
    ["OSS Review Toolkit repository configuration"] = 691,
    ["OSS Review Toolkit resolutions"] = 692,
    ["October CMS columns"] = 653,
    ["October CMS fields"] = 654,
    ["Oh My Posh"] = 656,
    Okteto = 657,
    ["Ona Automations"] = 659,
    Opctl = 1009,
    ["Open Data Contract Standard (ODCS)"] = 672,
    ["Open Data Product Standard (ODPS)"] = 673,
    ["Open Know-How"] = 1260,
    OpenDecree = 1324,
    ["OpenDecree Configuration"] = 1325,
    ["OpenRewrite Resource"] = 670,
    OpenSRM = 674,
    OpenStatus = 1271,
    ["OpenTelemetry Declarative Configuration"] = 671,
    ["OpenUtau character yaml"] = 664,
    ["OpenUtau ustx"] = 665,
    ["OpenWeather Current Weather API"] = 1052,
    ["OpenWeather Road Risk API"] = 1051,
    ["Ory Hydra configuration"] = 486,
    ["Ory Keto configuration"] = 549,
    ["Ory Kratos configuration"] = 679,
    ["Ory Oathkeeper configuration"] = 651,
    ["Outblocks App configuration"] = 676,
    ["Outblocks database table"] = 677,
    ["Outblocks project configuration"] = 675,
    PDM = 700,
    POPxf = 712,
    ["POPxf Correlations"] = 713,
    ["PRML manifest"] = 720,
    Packer = 696,
    PactSpec = 697,
    Panache = 698,
    Pantsbuild = 1132,
    ["Paper paper-plugin.yml"] = 699,
    ["Pipeline component"] = 1065,
    ["Platform.sh application"] = 10,
    ["Platform.sh routes"] = 11,
    ["Platform.sh services"] = 12,
    ["Plex Prerolls"] = 710,
    ["PocketMine plugin.yml"] = 707,
    ["Podman Desktop Extension"] = 1343,
    ["Postman collection"] = 716,
    ["Power Pages Configuration"] = 1272,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1217,
    ["ProActions AI-Kit Configuration"] = 728,
    ["ProActions AI-Kit Configuration for Menus"] = 730,
    ["ProActions AI-Kit Configuration for Sections"] = 732,
    ["ProActions AI-Kit Configuration for Services"] = 729,
    ["ProActions AI-Kit Configuration for Steps"] = 733,
    ["ProActions AI-Kit Configuration for Templates"] = 731,
    ["Problem object RFC9457"] = 1161,
    ["Problem package format"] = 734,
    ["Problem package generators"] = 735,
    ["Problem package submissions"] = 736,
    ["Problem package test group metadata"] = 737,
    Pterodactyl = 1111,
    ["Pull Request Labeler"] = 754,
    Pulumi = 762,
    ["PyGTA Config"] = 758,
    PyProject = 763,
    Pylock = 1263,
    Pyright = 764,
    ["Python script metadata"] = 1257,
    ["QType AI DSL"] = 767,
    Qgoda = 766,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1335,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1333,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1339,
    ["Qlik Talend Cloud Pipeline - Project"] = 1331,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1334,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1336,
    ["Qlik Talend Cloud Pipeline - Task"] = 1332,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1338,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1337,
    Qodana = 1084,
    ["Qt Creator workspace file"] = 1194,
    ["Quali Torque Blueprint Spec 2"] = 1109,
    ["QueryFirst config file"] = 1128,
    ["QuikRun Configuration"] = 1340,
    ["Qwen Code Settings"] = 1321,
    ["RKE Cluster Configuration JSON"] = 1062,
    ["RKE Cluster Configuration YAML"] = 1061,
    RadioHound = 757,
    ["Raid Profile"] = 1322,
    ["Raid Repo Configuration"] = 1323,
    Railpack = 769,
    Railway = 768,
    ["Rancher Fleet"] = 759,
    ["Rattler-build"] = 770,
    Ray = 1023,
    ["Read the Docs"] = 761,
    ["Red-DiscordBot Cog"] = 777,
    ["Red-DiscordBot Cog Repo"] = 778,
    ["Red-DiscordBot Trivia"] = 779,
    ["Releasaurus Config"] = 7,
    ReleaseKit = 6,
    ["Render Blueprints"] = 1060,
    RenderCV = 796,
    Renovate = 793,
    ["Renovate global configuration"] = 794,
    ["Renovate inherited configuration"] = 795,
    ["Replit config"] = 785,
    Restate = 1250,
    ["Revel Digital Gadget Definition File"] = 1274,
    RoadRunner = 798,
    ["Robust Station Image"] = 1280,
    Rockcraft = 799,
    ["Roo Coder Custom Modes"] = 800,
    Rubocop = 789,
    ["Rudder techniques"] = 1168,
    Ruff = 790,
    ["Rust Project"] = 791,
    ["Rust toolchain"] = 805,
    ["SDMX data message"] = 832,
    ["SDMX metadata message"] = 831,
    ["SDMX structure message"] = 830,
    ["SIL Kit Participant Configuration"] = 842,
    ["SIL Kit Registry Configuration"] = 843,
    ["SPDX 2.3"] = 881,
    SWADL = 897,
    ["Safebox Config"] = 1123,
    ["Sapphire CLI Config"] = 808,
    ["SauceCTL Configuration"] = 1071,
    Scarb = 828,
    ["Schema Catalog"] = 823,
    ["Scoop manifest"] = 829,
    ["Semantic Data Fabric (SDF) file"] = 833,
    ["Semgrep Rule"] = 835,
    ["Serenity Code Generator (Sergen)"] = 836,
    ["Serverless Framework Configuration"] = 1078,
    ["Serverless Workflow"] = 1080,
    ["Settings for a Cinnamon spice"] = 1213,
    ["Settings.paf"] = 838,
    ["Shopware 6 Configuration"] = 1081,
    ["Shopware CLI Extension Store Configuration"] = 1082,
    ["Shopware CLI Project Store Configuration"] = 1083,
    ["Sigma Detection Rule"] = 840,
    ["SigmaCV CV"] = 2,
    ["Sigrid scope configuration file"] = 841,
    ["SkyPilot Task JSON"] = 1169,
    ["Slack app manifest"] = 845,
    ["Slang Server Configuration"] = 1344,
    Snapcraft = 847,
    ["Solarxy project config"] = 850,
    Solidarity = 851,
    ["Solution filters"] = 852,
    ["Source Maps v3"] = 853,
    Sourcery = 854,
    ["Spack bootstrap.yaml"] = 855,
    ["Spack cdash.yaml"] = 856,
    ["Spack ci.yaml"] = 857,
    ["Spack compilers.yaml"] = 858,
    ["Spack concretizer.yaml"] = 859,
    ["Spack config.yaml"] = 860,
    ["Spack definitions.yaml"] = 861,
    ["Spack develop.yaml"] = 862,
    ["Spack env_vars.yaml"] = 863,
    ["Spack environment"] = 869,
    ["Spack include.yaml"] = 864,
    ["Spack mirrors.yaml"] = 865,
    ["Spack modules.yaml"] = 866,
    ["Spack packages.yaml"] = 867,
    ["Spack repos.yaml"] = 868,
    ["Spack toolchains.yaml"] = 870,
    ["Spack upstreams.yaml"] = 871,
    ["Spack view.yaml"] = 872,
    ["Speakeasy Generation Config File"] = 876,
    ["Speakeasy Lint Configuration File"] = 873,
    ["Speakeasy Test Generation Configuration File"] = 874,
    ["Speakeasy Workflow File"] = 875,
    SpecIF = 877,
    ["Specmatic Configuration"] = 878,
    ["Sponge Mixin configuration"] = 879,
    StackBlitz = 885,
    ["StackHawk Scanner Configuration"] = 1077,
    Stale = 886,
    Starfish = 887,
    ["Starlake Data Pipeline"] = 1049,
    Starship = 888,
    ["Statamic Blueprint"] = 889,
    ["Stella configuration file"] = 890,
    ["Streamlit configuration file"] = 891,
    ["Stryker Mutator"] = 894,
    ["StyleCop Analyzers Configuration"] = 895,
    ["Stylelint (.stylelintrc)"] = 896,
    ["Stylua Config"] = 1264,
    ["Sublime Syntax"] = 1124,
    ["Subsquid squid manifest"] = 1171,
    ["Swagger API 2.0"] = 898,
    ["Synadia Connect Component"] = 899,
    TSON = 935,
    TSTyche = 936,
    ["TYPO3 Vendor Bundler config"] = 942,
    ["Tab data for a LinUtil"] = 1220,
    ["Tab list for a LinUtil"] = 1219,
    Tach = 900,
    ["Tach Domain"] = 901,
    Talhelper = 903,
    ["Talisman configuration"] = 904,
    Taplo = 1265,
    ["Taskfile config"] = 1054,
    Taurus = 905,
    Tauticord = 906,
    ["Tekton Pipeline"] = 1293,
    ["Tekton PipelineRun"] = 1294,
    ["Tekton Task"] = 1291,
    ["Tekton TaskRun"] = 1292,
    Telefonistka = 1251,
    ["Terrateam config"] = 1277,
    ["TestEnvironment.json"] = 918,
    ["TextMate Grammar"] = 917,
    Threagile = 912,
    ["Tier.run pricing.json"] = 909,
    Tikibase = 910,
    Tombi = 915,
    ["Traefik v2"] = 921,
    ["Traefik v2 File Provider"] = 922,
    ["Traefik v3"] = 923,
    ["Traefik v3 File Provider"] = 924,
    ["Travis CI (.travis.yml)"] = 920,
    Treefmt = 464,
    Trident = 1247,
    ["TrueScript for *.tscript files"] = 927,
    ["Tugboat QA config.yml"] = 1244,
    TunnelHub = 1159,
    Turborepo = 919,
    Tycho = 1208,
    Tye = 1085,
    ["Tyk Gateway - Open Source v5.7+"] = 1256,
    ["UET BuildConfig.json"] = 1129,
    ["UI5 Manifest"] = 948,
    ["UNCORS configuration"] = 953,
    ["UTAM Page Object"] = 951,
    ["Ubuntu Server Autoinstall"] = 946,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1248,
    ["Uniswap Token List"] = 1034,
    ["Universal Schedule Format"] = 954,
    ["Unreal Engine Uplugin"] = 1130,
    ["Unreal Engine Uproject"] = 1131,
    ["UpCloud CLI (upctl) configuration"] = 1249,
    ["Updatecli Compose"] = 1093,
    ["Updatecli Policy Manifest"] = 1094,
    ["Updatecli Policy Metadata"] = 1095,
    Uplift = 1127,
    ["Upsun config"] = 9,
    ["User Journey Map"] = 1059,
    V2Ray = 1099,
    ["VSCode Code Snippets"] = 267,
    ["VSIX CLI publishing"] = 972,
    Vector = 956,
    ["Vela Pipeline Configuration"] = 959,
    Vercel = 266,
    ["Version Bumper config"] = 962,
    Vespertide = 1298,
    ["Vespertide Migration"] = 1299,
    ["Vespertide Model"] = 1300,
    ["Viash Component Config"] = 1253,
    ["Viash Package Config"] = 1254,
    Visivo = 1157,
    ["WP-CLI"] = 982,
    Wake = 1246,
    ["Waku Config"] = 1223,
    ["Web App Manifest"] = 978,
    ["Web types"] = 981,
    WebExtensions = 977,
    ["Webman package recipe"] = 1105,
    ["Windows Package Manager Installer Manifest"] = 1031,
    ["Windows Package Manager Locale Manifest"] = 1032,
    ["Windows Package Manager Singleton Manifest"] = 1030,
    ["WireMock CLI import configuration"] = 1229,
    ["WireMock CLI local service configuration"] = 1228,
    ["WireMock message stub mapping"] = 1227,
    ["WireMock stub mapping"] = 1226,
    ["Woodpecker pipeline config"] = 1073,
    ["Wrangler CLI"] = 983,
    ["XenForo add-on manifest"] = 984,
    ["Xstate Machine"] = 1091,
    ["Yandex Workflow Language"] = 1215,
    ["Yarn Config (.yarnrc.yml)"] = 1047,
    ["Yippee-Ki-JSON configuration YML"] = 1038,
    ["YouTrack App"] = 1212,
    ["Zarf Package Configuration"] = 1279,
    ["Zerops import file"] = 1200,
    ["Zola Configuration"] = 1290,
    actionlint = 38,
    ["aerleon.yml"] = 23,
    ["amplify.yml"] = 16,
    ["amxx-builder manifest"] = 1342,
    ["angular.json"] = 41,
    apko = 1162,
    ["app-definition.yaml"] = 45,
    ["apple-app-site-association"] = 43,
    ["appsettings.StormPetrel.json"] = 50,
    ["appsettings.json"] = 48,
    ["appsscript.json"] = 47,
    ["appveyor.yml"] = 49,
    ["aqua-generate-registry.yaml"] = 52,
    ["aqua-policy.yaml"] = 53,
    ["aqua.yaml"] = 51,
    ["arazzo.json"] = 55,
    ["arb.json"] = 56,
    ["arc.json"] = 58,
    ["architect.yml"] = 57,
    ["artifacthub-repo.yml"] = 62,
    ["asm-lsp"] = 63,
    ["ast-grep rules"] = 66,
    ["ast-grep sgconfig.yml"] = 65,
    ["azure.yaml"] = 74,
    ["babelrc.json"] = 128,
    ["bamboo-spec"] = 132,
    basedpyright = 130,
    ["bashly-strings.yml"] = 1139,
    ["batect.yml"] = 131,
    ["beef-database-codegen"] = 133,
    ["beef-database-v5-codegen"] = 135,
    ["beef-entity-codegen"] = 134,
    ["beef-entity-v5-codegen"] = 136,
    ["behat.yml"] = 149,
    ["bigquery-table"] = 137,
    ["bioimageio resource description"] = 1179,
    ["bitbucket-pipelines"] = 139,
    bitrise = 140,
    ["bitrise-step"] = 141,
    ["block.json"] = 166,
    ["bottom configuration"] = 90,
    ["bower.json"] = 143,
    ["bozr.suite.json"] = 153,
    bpkg = 1140,
    ["browser.i18n.json"] = 154,
    ["browsh configuration"] = 155,
    bucklescript = 156,
    ["buf.gen.yaml"] = 93,
    ["buf.lock"] = 94,
    ["buf.plugin.yaml"] = 95,
    ...
    ["build-changelog"] = 157,
    ["bun.lock"] = 162,
    ["bundleconfig.json"] = 163,
    ["bunfig.toml"] = 164,
    ["cargo-mutants-config.yaml"] = 98,
    ["cargo-nextest repository configuration"] = 629,
    ["cargo-nextest user configuration"] = 630,
    ["ccmod.json"] = 1224,
    changelogging = 1191,
    ["chisel-slices.json"] = 293,
    ["chrome-extension-locales-messages.json"] = 274,
    ["chutzpah.json"] = 275,
    cibuildwheel = 186,
    ["clang-format (.clang-format)"] = 1097,
    ["clang-tidy"] = 249,
    clangd = 248,
    clib = 250,
    ["cloud-init: cloud-config userdata"] = 252,
    ["cloud-sdk-pipeline-configuration"] = 277,
    ["cloudbuild.json"] = 278,
    cloudify = 251,
    cmakefmt = 204,
    ["cmdx.yaml"] = 101,
    ...
    ["commands.json"] = 270,
    ["commit-check"] = 296,
    ["commitlint (.commitlintrc)"] = 1033,
    ["committed.toml"] = 297,
    ["compile_commands.json"] = 269,
    ["compilerconfig.json"] = 268,
    ["completely.yml"] = 1135,
    ["component-detection-manifest.json"] = 300,
    ["component.json"] = 299,
    ["composer.json"] = 298,
    ["conda-forge"] = 190,
    ["config.yaml"] = 760,
    ["contentmanifest.json"] = 276,
    ["contribute.json"] = 301,
    ["cosmos.config.json"] = 272,
    ["crowdin.yml"] = 302,
    ["ctfd-setup configuration file"] = 1236,
    ["custom-elements.json"] = 1149,
    ["cypress.json"] = 306,
    ["dacier.yml"] = 1330,
    ["datalogic-scan2deploy-android"] = 316,
    ["datalogic-scan2deploy-ce"] = 317,
    ["dbt Dependencies"] = 211,
    ["dbt Packages"] = 213,
    ["dbt Project"] = 212,
    ["dbt Selectors"] = 214,
    ["dbt YAML files"] = 215,
    ...
    ["ddev-global"] = 318,
    ["ddev-project"] = 319,
    ["debugsettings.json"] = 320,
    ["dependabot-v2.json"] = 323,
    ["dependabot.json"] = 322,
    ["deployed-cli"] = 1090,
    ["devcontainer-feature.json"] = 260,
    ["devcontainer.json"] = 259,
    devinit = 1040,
    ["devspace.yaml"] = 1113,
    djlint = 1041,
    ["docker bake"] = 329,
    ["docker sequencer"] = 330,
    ["docker-compose.yml"] = 1039,
    ["dockerd.json"] = 327,
    ["dotnet Release Index manifest"] = 342,
    ["dotnet-tools.json"] = 343,
    ["dotnetcli.host.json"] = 344,
    ["dprint.json"] = 345,
    ["drone.json"] = 346,
    ["dss-2.0.0.json"] = 348,
    ["dstack configuration"] = 349,
    ["dtool dataset metadata"] = 1231,
    ["dvc.yaml"] = 350,
    ["ecosystem.json"] = 355,
    eksctl = 357,
    ["electron-builder configuration file"] = 383,
    ["epr-manifest.json"] = 382,
    ["estampo.toml"] = 381,
    ["evcc.yaml"] = 384,
    ["ezd task runner"] = 395,
    ["fabric.mod.json"] = 398,
    ["first-timers-bot"] = 406,
    ["flagd flag configuration"] = 123,
    ["fly.io Configuration"] = 124,
    fulibWorkflows = 1072,
    ["function.json"] = 418,
    ["gRPC API Gateway & OpenAPI Config"] = 18,
    ["gematik health care insurance list"] = 1242,
    ["gematik health care patient list"] = 1239,
    ["gematik health care provider institution list"] = 1241,
    ["gematik health care provider list"] = 1240,
    ["gematik tiger test environment configuration"] = 1243,
    ["git-town.toml"] = 1288,
    ["gitlab-ci"] = 438,
    ["global.json"] = 454,
    ["go-feature-flag Flag Configuration"] = 457,
    ["haxelib.json"] = 476,
    helmfile = 1026,
    helmwave = 1027,
    ["host-meta.json"] = 483,
    ...
    ["ide.host.json"] = 491,
    ["ifstate.yaml"] = 492,
    ["imageoptimizer.json"] = 493,
    ["importmap.json"] = 496,
    instant_python_config = 500,
    instant_python_custom_project = 501,
    intlayer = 502,
    ["ioBroker Configuration"] = 503,
    ["ioBroker JSON UI"] = 504,
    ["ioBroker Package manifest"] = 505,
    ["ixpect.conf.yaml"] = 506,
    ["ize.toml"] = 1126,
    ["jsconfig.json"] = 531,
    ["jscpd Configuration"] = 1110,
    jsdoc = 1022,
    ["k3d.yaml"] = 532,
    ["k9s aliases.yaml"] = 534,
    ["k9s cluster-config.yaml"] = 536,
    ["k9s config.yaml"] = 535,
    ["k9s hotkeys.yaml"] = 537,
    ["k9s plugins.yaml"] = 538,
    ["k9s skin.yaml"] = 539,
    ["k9s views.yaml"] = 540,
    ["kontinuous-config.yaml"] = 552,
    ["kontinuous-values.yaml"] = 551,
    ["kustomization.yaml"] = 554,
    ["label-commenter-config.yml"] = 555,
    ["latexindent configuration"] = 116,
    ["launchsettings.json"] = 556,
    lazydocker = 1148,
    lazygit = 1147,
    ["lego.json"] = 558,
    ["lerna.json"] = 559,
    ["lgtm.yml"] = 560,
    ["liblab.config.json"] = 561,
    ["libman.json"] = 562,
    ["license-report-config.json"] = 563,
    ["linkinator.config.json"] = 565,
    ["lint-staged (.lintstagedrc)"] = 1000,
    ["local.settings.json"] = 570,
    ["localazy.json"] = 571,
    ["lotus.yaml"] = 569,
    ["lsdlschema.json"] = 572,
    ["macro.json"] = 1114,
    ["markdown-link-check"] = 1068,
    maturin = 1069,
    mboats = 1076,
    memnex = 1328,
    ["micro-settings.json"] = 1141,
    ["mimetypes.json"] = 587,
    ["mirrord config"] = 1002,
    mise = 1003,
    ["mkdocs.yml"] = 607,
    ["mockd.yaml"] = 611,
    ["modelparams.dev Model"] = 613,
    ["monospace.yml"] = 614,
    ["moon.yml"] = 1225,
    ["mprocs Configuration file"] = 1195,
    ["mrdocs.yml"] = 609,
    ["mta.yaml"] = 1004,
    ["mtad.yaml"] = 1005,
    ["mycode.json"] = 622,
    nFPM = 634,
    ["napari plugin manifest"] = 623,
    neoload = 1017,
    ["nest-cli"] = 637,
    ["nexus-rpc-gen"] = 1315,
    ["nf-core module environment.yml"] = 631,
    ["nf-core module meta.yml"] = 632,
    ["nf-core subworkflow meta.yml"] = 633,
    ["ninjs (News in JSON)"] = 636,
    ["nitro.json"] = 1016,
    ["nixd configuration"] = 1167,
    ["nlu.json"] = 638,
    ["nodemon.json"] = 640,
    ["noodl config"] = 1075,
    ["notebook.mod.json"] = 641,
    now = 1012,
    ["npm-badges"] = 644,
    ["nswag.json"] = 648,
    ntangle = 650,
    ["nuclei-template.yaml"] = 645,
    ["nuget-project.json"] = 646,
    ["ocelot.json"] = 652,
    ogen = 655,
    ["omnisharp.json"] = 658,
    openHAB = 1301,
    ...
    oxlint = 1312,
    ["package.json"] = 693,
    ["package.manifest"] = 695,
    ["package.yaml"] = 694,
    ["partial-black.json"] = 150,
    ["partial-fastapi.json"] = 151,
    ["partial-pixi.json"] = 705,
    ["partial-scheduled.json"] = 152,
    ["pattern.json"] = 703,
    ["petstore-v1.0"] = 1121,
    pgap_yaml_input_reader = 701,
    pgrls = 702,
    pgxgen = 1305,
    pitcms = 1308,
    ["pixi.toml"] = 704,
    ["plagiarize-me.yaml"] = 709,
    ["plagiarize.yaml"] = 708,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1232,
    ["podbard.yaml"] = 711,
    ["portman.json"] = 714,
    ["prefect.toml"] = 723,
    ["prefect.yaml"] = 724,
    ...
    ["prettierrc.json"] = 726,
    ["prisma.yml"] = 727,
    ["project-1.0.0-beta3.json"] = 739,
    ["project-1.0.0-beta4.json"] = 740,
    ["project-1.0.0-beta5.json"] = 741,
    ["project-1.0.0-beta6.json"] = 742,
    ["project-1.0.0-beta8.json"] = 743,
    ["project-1.0.0-rc1.json"] = 744,
    ["project-1.0.0-rc2.json"] = 745,
    ["project.json"] = 738,
    ["project.owasp.yaml"] = 746,
    ["prometheus-alertmanager.json"] = 750,
    ["prometheus.json"] = 747,
    ["prometheus.rules.json"] = 748,
    ["prometheus.rules.test.json"] = 749,
    ["proxies.json"] = 751,
    ["publiccode.yml"] = 752,
    ["pubspec.yaml"] = 753,
    ["pyrseas-0.8.json"] = 756,
    pytest = 765,
    ["quilt.mod.json"] = 1142,
    ["rc3 auth"] = 771,
    ["rc3 collection"] = 772,
    ...
    ["rc3 settings"] = 776,
    ["registry.yaml"] = 54,
    ["release drafter"] = 1018,
    ["release-hub.json"] = 5,
    ["release-please-config.json"] = 781,
    ["release-please-manifest.json"] = 782,
    ["release-plz.toml"] = 783,
    ["renv.lock"] = 797,
    ["reposets Configuration"] = 786,
    ["reposets Credentials"] = 787,
    ["revola.json"] = 3,
    ["rivet.json"] = 1166,
    ["rivet.yaml (legacy)"] = 1165,
    rumdl = 802,
    runny = 801,
    runspec = 1329,
    rustfmt = 803,
    ...
    samt = 806,
    samtrc = 807,
    ["sarif-1.0.0.json"] = 809,
    ["sarif-2.0.0.json"] = 810,
    ["sarif-2.1.0"] = 820,
    ["sarif-2.1.0-rtm.2"] = 811,
    ["sarif-2.1.0-rtm.3"] = 813,
    ["sarif-2.1.0-rtm.4"] = 815,
    ["sarif-2.1.0-rtm.5"] = 817,
    ["sarif-2.1.0-rtm.6"] = 818,
    ["sarif-external-property-file-2.1.0"] = 821,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 812,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 814,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 816,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 819,
    ["scalingo.json configuration"] = 822,
    ["schema.org - Action"] = 824,
    ["schema.org - ContactPoint"] = 825,
    ["schema.org - Place"] = 826,
    ["schema.org - Thing"] = 827,
    ["secrethub.yml"] = 1144,
    ["semantic-release"] = 834,
    ["servicehub.config.json"] = 995,
    ["servicehub.service.json"] = 994,
    ["settings.job"] = 837,
    ["sfdx-hardis configuration"] = 839,
    ["shard.yml"] = 1182,
    ["size-limit configuration"] = 844,
    ["skaffold.yaml"] = 1066,
    ["skyuxconfig.json"] = 846,
    ["snowflake-config"] = 848,
    ["snowflake-connections"] = 849,
    ["spicepod.yaml"] = 1203,
    ["sqlc configuration"] = 882,
    ["stripe-app-local.json"] = 893,
    ["stripe-app.json"] = 892,
    swcrc = 1050,
    ["task.json"] = 902,
    taskcat = 1013,
    ["template.json"] = 907,
    ["templatsources.json"] = 908,
    ["text2confl config"] = 1313,
    ["theme.json"] = 911,
    ["tizen_workspace.json"] = 913,
    tldr = 914,
    ["tm_devices configuration file"] = 1270,
    tmuxinator = 998,
    tox = 916,
    ["transcend.yml"] = 925,
    ["tree-sitter grammar.json"] = 463,
    ["trime.yaml"] = 926,
    ["trunk.yaml"] = 928,
    ["ts-force-config.json"] = 933,
    ["tsconfig.json"] = 929,
    ["tsd.json"] = 930,
    ["tsdoc.json"] = 931,
    ["tsdrc.json"] = 932,
    ...
    v8r = 976,
    vcluster = 1189,
    ["vcpkg configuration file"] = 265,
    ["vcpkg manifest file"] = 264,
    ["vega-lite.json"] = 958,
    ["vega.json"] = 957,
    ["venvironment.yaml"] = 960,
    ["venvplus.yaml"] = 961,
    version = 1252,
    ["version.json"] = 963,
    ["vhwdebugger-binding.yaml"] = 965,
    ["vim-addon-info"] = 966,
    ["vs-2017.3.host.json"] = 968,
    ["vs-nesting.json"] = 969,
    ["vsls.json"] = 967,
    ["vss-extension.json"] = 973,
    vtcfg = 1258,
    ["vtesttree.yaml"] = 974,
    ["vtestunit.yaml"] = 975,
    ["warp-keysets.json"] = 1150,
    ["warp-themes.json"] = 1151,
    ["warp-workflows.json"] = 1152,
    ["webhint.io"] = 1106,
    ["webjobpublishsettings.json"] = 980,
    ["webjobs-list.json"] = 979,
    ["well-known-fursona"] = 1190,
    ["xs-app.json"] = 1008,
    ["xunit.runner.json"] = 993,
    yamlfmt = 1035,
    yamllint = 1036,
    ["yap.json"] = 1037,
    ["zerops.yml"] = 1199,
