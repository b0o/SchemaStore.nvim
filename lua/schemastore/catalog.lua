...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 135,
    [".cryproj (generic)"] = 470,
    [".cryproj engine-5.2"] = 465,
    [".cryproj engine-5.3"] = 466,
    [".cryproj engine-5.4"] = 467,
    [".cryproj engine-5.5"] = 468,
    [".cryproj engine-dev"] = 469,
    [".csscomb.json"] = 137,
    [".csslintrc"] = 138,
    [".eslintrc"] = 179,
    [".esmrc.json"] = 171,
    ...
    [".mtaext"] = 478,
    [".nodehawkrc"] = 294,
    [".npmpackagejsonlintrc"] = 296,
    [".phraseapp.yml"] = 329,
    [".pmbot.yml"] = 321,
    [".postcssrc"] = 326,
    [".pre-commit-config.yml"] = 327,
    [".pre-commit-hooks.yml"] = 328,
    [".putout.json"] = 346,
    [".rehyperc"] = 352,
    [".remarkrc"] = 353,
    [".sprite files"] = 393,
    ...
    [".vsext"] = 446,
    [".yarnrc.yml"] = 510,
    ["<div>RIOTS' studio configuration"] = 449,
    ["API Builder"] = 507,
    ["AVA Configuration Schema"] = 561,
    ["AWS CDK cdk.json"] = 123,
    ["AWS CloudFormation"] = 124,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 125,
    ...
    ["Azure Pipelines"] = 41,
    ["Azure Static Web Apps CLI configuration file"] = 395,
    ["Azure Static Web Apps configuration file"] = 394,
    ["BX CI"] = 70,
    ["Better Code Hub"] = 512,
    ["Better Scripts"] = 71,
    BizTalkServerApplicationSchema = 484,
    ["Block Protocol Metadata"] = 69,
    Briefcase = 489,
    ["Build Info"] = 62,
    Buildkite = 64,
    ...
    ["CICS TS resource overrides"] = 558,
    ["CMake Presets"] = 72,
    ["CNC Codes JSON Schema"] = 80,
    ["CSR Framework"] = 83,
    ["Calqulus pipeline"] = 73,
    ["Camel YAML DSL"] = 74,
    Carafe = 75,
    ["Cargo Config Schema"] = 76,
    ["Cargo Make"] = 77,
    ["Catalog Info Backstage"] = 78,
    Cheatsheets = 545,
    ["Chrome Extension"] = 117,
    ["CircleCI config.yml"] = 100,
    ["Citation File Format"] = 126,
    CityJSON = 79,
    ["Code Climate"] = 101,
    ["Commandbox Box.json"] = 81,
    ["Commandbox Server.json"] = 82,
    ["Common Catalog Schema"] = 115,
    ["Common types for all schemas"] = 1,
    ["Container Structure Test"] = 495,
    Containerlab = 519,
    ["Dart build configuration"] = 139,
    ["Dart test config"] = 140,
    ["DashLord configuration"] = 141,
    ["Datadog Service Definition"] = 252,
    ["Datahub Ingestion Recipe Schema"] = 562,
    ["Dein Config Schema"] = 84,
    Deno = 145,
    ["Deployer Recipe"] = 148,
    Devfile = 168,
    ["Discord Webhook"] = 150,
    ["Dolittle Artifacts"] = 154,
    ["Dolittle Bounded Context Configuration"] = 155,
    ["Dolittle Event Horizons Configuration"] = 156,
    ["Dolittle Resources Configuration"] = 157,
    ["Dolittle Server Configuration"] = 158,
    ["Dolittle Tenant Map Configuration"] = 160,
    ["Dolittle Tenants Configuration"] = 159,
    ["Dolittle Topology"] = 161,
    ["Drupal Breakpoints Schema"] = 85,
    ["Drupal Config Schema"] = 96,
    ["Drupal Info Schema"] = 86,
    ["Drupal Layouts Schema"] = 87,
    ["Drupal Libraries Schema"] = 88,
    ["Drupal Links Action Schema"] = 89,
    ["Drupal Links Contextual Schema"] = 90,
    ["Drupal Links Menu Schema"] = 91,
    ["Drupal Links Task Schema"] = 92,
    ["Drupal Migration Schema"] = 93,
    ["Drupal Permissions Schema"] = 94,
    ["Drupal Routing Schema"] = 95,
    ["Drupal Services Schema"] = 97,
    ["Drush site aliases"] = 165,
    ["Embrace Config Schema"] = 573,
    ["Error pages"] = 174,
    Esquio = 172,
    ["Estuary Flow Catalog Schema"] = 552,
    ["Expo SDK"] = 177,
    ["F-Droid Data metadata"] = 182,
    ["Facets - FSDL - Application"] = 180,
    ["Fossa configuration file"] = 187,
    ["Fossa's fossa-deps file"] = 188,
    ["Foundry VTT - Manifest"] = 185,
    ["Foundry VTT - Template"] = 186,
    ["Foxx Manifest"] = 42,
    ["GatewayCore API Gateway"] = 191,
    ["GeoJSON.json latest"] = 550,
    GherKing = 554,
    ["GitHub Action"] = 195,
    ["GitHub Funding"] = 196,
    ["GitHub Issue Template configuration"] = 198,
    ["GitHub Workflow"] = 199,
    ["GitHub Workflow Template Properties"] = 200,
    ["GitHub issue forms"] = 197,
    GitVersion = 194,
    ["Gitpod Configuration"] = 202,
    ["Global Privacy Control"] = 192,
    ["Google Cloud Workflows"] = 122,
    Goreleaser = 205,
    ["Goreleaser Pro"] = 206,
    ["Gradle Build Cache Node"] = 509,
    ["Gradle Enterprise"] = 508,
    ["Grafana 5.x Dashboard"] = 207,
    ["GraphQL Code Generator"] = 210,
    ["GraphQL Config"] = 209,
    ["GraphQL Mesh"] = 208,
    ["Grunt JSHint task"] = 214,
    ["Grunt Watch task"] = 215,
    ["Grunt base task"] = 216,
    ["Grunt clean task"] = 212,
    ["Grunt copy task"] = 211,
    ["Grunt cssmin task"] = 213,
    HEMTT = 481,
    Hadolint = 493,
    ["Hardware Sentry Configuration"] = 566,
    Hayson = 218,
    ["Haystack Pipeline"] = 219,
    ["Hazelcast 5 Configuration"] = 220,
    ["Helm Chart.lock"] = 99,
    ["Helm Chart.yaml"] = 98,
    Hugo = 544,
    ["Istanbul Schema"] = 569,
    ["JDownloader2 crawler multi-rule schema"] = 236,
    ["JDownloader2 crawler single-rule schema"] = 235,
    ["JFrog File Spec"] = 237,
    ["JFrog Pipelines YML DSL"] = 575,
    ["JSON Document Transform"] = 245,
    ["JSON Feed"] = 246,
    ["JSON Resume"] = 356,
    ["JSON Schema Draft 2020-12"] = 461,
    ["JSON Schema Draft 4"] = 458,
    ["JSON Schema Draft 7"] = 459,
    ["JSON Schema Draft 8"] = 460,
    ["JSON schema for CodeShip Pro services configuration files"] = 108,
    ["JSON schema for CodeShip Pro steps configuration files"] = 109,
    ["JSON schema for Codecov configuration files"] = 107,
    ["JSON-API"] = 244,
    ["JSON-e templates"] = 517,
    ["JSON-stat 2.0"] = 455,
    JSONPatch = 248,
    Jasmine = 231,
    Jekyll = 232,
    ["Jenkins X Pipelines"] = 233,
    ["Jenkins X Requirements"] = 234,
    ["Jovo Language Models"] = 238,
    ["KSP-AVC"] = 456,
    ["KSP-CKAN"] = 457,
    ["Keycloak REST API"] = 577,
    ["KoDE/CI build.yaml"] = 571,
    ["Kong DBLess Schema"] = 572,
    KrakenD = 251,
    ["LinkML Metamodel"] = 262,
    Liquibase = 523,
    ["Liquibase Flow File"] = 524,
    Markdownlint = 527,
    ["MegaLinter configuration"] = 266,
    ["MegaLinter descriptor"] = 267,
    ["Meltano plugin discovery definition"] = 269,
    ["Meltano project definition"] = 268,
    ["Microsoft Band Web Tile"] = 270,
    ["Minecraft Data Pack Advancement"] = 272,
    ["Minecraft Data Pack Biome"] = 273,
    ["Minecraft Data Pack Configured Carver"] = 274,
    ["Minecraft Data Pack Dimension"] = 276,
    ["Minecraft Data Pack Dimension Type"] = 275,
    ["Minecraft Data Pack Item Modifier"] = 277,
    ["Minecraft Data Pack Loot Table"] = 278,
    ["Minecraft Data Pack Metadata"] = 279,
    ["Minecraft Data Pack Predicate"] = 280,
    ["Minecraft Data Pack Recipe"] = 281,
    ["Minecraft Data Pack Template Pool"] = 282,
    ["Minecraft Resourcepack Sounds"] = 283,
    ["MongoDB Atlas Search Index Definition Schema"] = 570,
    ["Monika Configuration Schema"] = 568,
    ["Motif config"] = 477,
    ["Netin Diagnostic System Template"] = 532,
    ["Netlify config schema"] = 288,
    ["Nightwatch.js"] = 289,
    ["OSS Review Toolkit configuration"] = 311,
    ["OSS Review Toolkit curation"] = 312,
    ["OSS Review Toolkit package configuration"] = 313,
    ["OSS Review Toolkit repository configuration"] = 314,
    ["OSS Review Toolkit resolutions"] = 315,
    Opctl = 480,
    ["OpenWeather Current Weather API"] = 516,
    ["OpenWeather Road Risk API"] = 515,
    ["Ory Hydra configuration"] = 224,
    ["Ory Keto configuration"] = 253,
    ["Ory Kratos configuration"] = 310,
    ["Ory Oathkeeper configuration"] = 301,
    ["Outblocks App configuration"] = 308,
    ["Outblocks database table"] = 309,
    ["Outblocks project configuration"] = 307,
    Packer = 318,
    ["Pipeline component"] = 525,
    ["PocketMine plugin.yml"] = 322,
    Pterodactyl = 565,
    ["Pull Request Labeler"] = 345,
    PyProject = 349,
    Qodana = 541,
    ["Quali Torque Blueprint Spec 2"] = 563,
    ["RKE Cluster Configuration JSON Schema"] = 522,
    ["RKE Cluster Configuration YAML Schema"] = 521,
    Ray = 492,
    ["Read the Docs"] = 348,
    ["Red-DiscordBot Cog"] = 350,
    ["Red-DiscordBot Cog Repo"] = 351,
    Renovate = 357,
    ["Replit schema"] = 354,
    RoadRunner = 358,
    ["Rust toolchain"] = 360,
    SWADL = 406,
    ["Sapphire CLI Config"] = 361,
    ["SauceCTL Configuration"] = 529,
    ["Schema Catalog"] = 374,
    ["Scoop manifest"] = 379,
    ["Semgrep Rule"] = 381,
    ["Serverless Framework Configuration"] = 536,
    ["Serverless Workflow Schema"] = 537,
    ["Settings.paf"] = 383,
    ["Shopware 6 Configuration"] = 538,
    ["Shopware CLI Extension Store Configuration"] = 539,
    ["Shopware CLI Project Store Configuration"] = 540,
    Solidarity = 388,
    ["Solution filters"] = 389,
    ["Source Maps v3"] = 390,
    SpecIF = 391,
    ["Sponge Mixin configuration"] = 392,
    ["StackHawk Scanner Configuration"] = 535,
    ["StackHead CLI config"] = 396,
    ["StackHead module configuration"] = 397,
    ["StackHead project definition"] = 398,
    Stale = 399,
    Starship = 400,
    ["Statamic Blueprint"] = 401,
    ["StrmPrivacy batch job configuration file"] = 576,
    ["Stryker Mutator"] = 403,
    ["StyleCop Analyzers Configuration"] = 404,
    ["Swagger API 2.0"] = 407,
    ["Talisman configuration"] = 408,
    ["Taskfile YAML Schema"] = 518,
    Taurus = 409,
    ["TestEnvironment.json"] = 416,
    Tikibase = 412,
    ["Traefik v2"] = 419,
    ["Traefik v2 File Provider"] = 420,
    Turborepo = 417,
    Tye = 542,
    ["UI5 Manifest"] = 432,
    ["UTAM Page Object"] = 434,
    ["Ubuntu Server Autoinstall"] = 430,
    ["Uniswap Token List"] = 501,
    Updatecli = 549,
    ["User Journey Map YAML Schema"] = 520,
    V2Ray = 553,
    ["VSCode Code Snippets"] = 111,
    ["VSIX CLI publishing"] = 447,
    ["Vela Pipeline Configuration"] = 437,
    Vercel = 110,
    ["Web App Manifest"] = 451,
    ["Web types"] = 454,
    WebExtensions = 450,
    ["Webman package recipe"] = 559,
    ["Windows Package Manager Installer Manifest"] = 498,
    ["Windows Package Manager Locale Manifest"] = 499,
    ["Windows Package Manager Singleton Manifest"] = 497,
    ["Woodpecker pipeline config"] = 531,
    ["Xstate Machine Schema"] = 547,
    ["Yippee-Ki-JSON configuration YML"] = 503,
    ["angular.json"] = 8,
    ...
    ["batect.yml"] = 47,
    ["beau.yml"] = 511,
    ["beef-database-codegen"] = 49,
    ["beef-entity-codegen"] = 50,
    ["behat.yml"] = 58,
    ["bigquery-table"] = 51,
    ["bitbucket-pipelines"] = 52,
    bitrise = 53,
    ["bitrise-step"] = 54,
    ["block.json"] = 68,
    ["bower.json"] = 56,
    ["bozr.suite.json"] = 59,
    ["browser.i18n.json"] = 60,
    bucklescript = 61,
    ["bundleconfig.json"] = 66,
    ["chutzpah.json"] = 118,
    ["cloud-init: cloud-config userdata JSON schema"] = 105,
    ["cloud-sdk-pipeline-config-schema"] = 120,
    ["cloudbuild.json"] = 121,
    cloudify = 104,
    codemagic = 106,
    ["coffeelint.json"] = 127,
    comet = 513,
    ["commands.json"] = 114,
    ["compile_commands.json"] = 113,
    ["compilerconfig.json"] = 112,
    ["component-detection-manifest.json"] = 130,
    ["component.json"] = 129,
    ["composer.json"] = 128,
    ["config.json"] = 131,
    ["contentmanifest.json"] = 119,
    ["contribute.json"] = 132,
    ["cosmos.config.json"] = 116,
    ["crowdin.yml"] = 133,
    cspell = 136,
    ["cypress.json"] = 134,
    ["datalogic-scan2deploy-android"] = 142,
    ["datalogic-scan2deploy-ce"] = 143,
    ["debugsettings.json"] = 144,
    ["dependabot-v2.json"] = 147,
    ["dependabot.json"] = 146,
    ["deployed-cli"] = 546,
    ["detekt.yml"] = 149,
    devinit = 505,
    ["devspace.yaml"] = 567,
    ["docfx.json"] = 153,
    ["docker-compose.yml"] = 504,
    ["docker-seq schema"] = 152,
    ["dockerd.json"] = 151,
    ["dotnet Release Index manifest"] = 162,
    ["dotnetcli.host.json"] = 163,
    ["drone.json"] = 164,
    ["dss-2.0.0.json"] = 166,
    ["dvc.yaml"] = 167,
    ["ecosystem.json"] = 169,
    eksctl = 170,
    ["electron-builder configuration file."] = 175,
    ["epr-manifest.json"] = 173,
    ["evcc.yaml"] = 176,
    ["ezd schema"] = 178,
    ["fabric.mod.json"] = 181,
    ["first-timers-bot"] = 184,
    ["fly.io Schema"] = 43,
    fulibWorkflows = 530,
    ["func.yaml"] = 189,
    ["function.json"] = 190,
    ...
    ["gitlab-ci"] = 201,
    ["global.json"] = 203,
    ["golangci-lint Configuration"] = 204,
    ["haxelib.json"] = 217,
    helmfile = 494,
    ["host-meta.json"] = 222,
    ["host.json"] = 221,
    ...
    huskyrc = 473,
    ["ide.host.json"] = 225,
    ["imageoptimizer.json"] = 226,
    ["importmap.json"] = 228,
    ["ioBroker JSON UI"] = 229,
    ["ioBroker Package manifest"] = 230,
    ["ize.toml"] = 578,
    ["jsconfig.json"] = 249,
    ["jscpd Configuration Schema"] = 564,
    jsdoc = 491,
    ["k3d.yaml"] = 250,
    ["kustomization.yaml"] = 254,
    ["label-commenter-config.yml"] = 255,
    ["launchsettings.json"] = 256,
    ["lerna.json"] = 257,
    ["lgtm.yml"] = 258,
    ["libman.json"] = 259,
    ["license-report-config.json"] = 260,
    ["linkinator.config.json"] = 261,
    ["local.settings.json"] = 263,
    ["localazy.json"] = 264,
    ["lsdlschema.json"] = 265,
    ["markdown-lint-check"] = 528,
    mboats = 534,
    ["mimetypes.json"] = 271,
    ["mta.yaml"] = 475,
    ["mtad.yaml"] = 476,
    ["mycode.json"] = 286,
    ["napari plugin manifest"] = 287,
    neoload = 486,
    ["nest-cli"] = 292,
    ["ninjs (News in JSON) 1.3"] = 291,
    ["ninjs (News in JSON) 2.0"] = 290,
    ["nlu.json"] = 293,
    ["nodemon.json"] = 295,
    ["noodl.schema.json"] = 533,
    now = 482,
    ["nswag.json"] = 299,
    ntangle = 300,
    ["nuclei-template.yaml"] = 297,
    ["nuget-project.json"] = 298,
    ["ocelot.json"] = 302,
    ["omnisharp.json"] = 303,
    ["openapi.json"] = 304,
    ["openfin.json"] = 306,
    ["openrpc.json"] = 305,
    ["package.json"] = 316,
    ["package.manifest"] = 317,
    ["pattern.json"] = 320,
    ["petstore-v1.0"] = 574,
    pgap_yaml_input_reader = 319,
    ["plagiarize-me.yaml"] = 324,
    ["plagiarize.yaml"] = 323,
    ["portman.json"] = 325,
    ["prettierrc.json"] = 330,
    ["prisma.yml"] = 331,
    ["project-1.0.0-beta3.json"] = 333,
    ["project-1.0.0-beta4.json"] = 334,
    ["project-1.0.0-beta5.json"] = 335,
    ["project-1.0.0-beta6.json"] = 336,
    ["project-1.0.0-beta8.json"] = 337,
    ["project-1.0.0-rc1.json"] = 338,
    ["project-1.0.0-rc2.json"] = 339,
    ["project.json"] = 332,
    ["prometheus.json"] = 340,
    ["prometheus.rules.json"] = 341,
    ["proxies.json"] = 342,
    ["publiccode.yml"] = 343,
    ["pubspec.yaml"] = 344,
    ["pyrseas-0.8.json"] = 347,
    ["release drafter"] = 487,
    rustfmt = 359,
    ["sarif-1.0.0.json"] = 362,
    ["sarif-2.0.0.json"] = 363,
    ["sarif-2.1.0"] = 372,
    ["sarif-2.1.0-rtm.2"] = 364,
    ["sarif-2.1.0-rtm.3"] = 366,
    ["sarif-2.1.0-rtm.4"] = 368,
    ["sarif-2.1.0-rtm.5"] = 370,
    ["sarif-external-property-file-2.1.0"] = 373,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 365,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 367,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 369,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 371,
    ["schema.org - Action"] = 375,
    ["schema.org - ContactPoint"] = 376,
    ["schema.org - Place"] = 377,
    ["schema.org - Thing"] = 378,
    ["semantic-release"] = 380,
    ["servicehub.config.json"] = 464,
    ["servicehub.service.json"] = 463,
    ["settings.job"] = 382,
    ["sfdx-hardis configuration"] = 384,
    ["size-limit configuration"] = 385,
    ["skaffold.yaml"] = 526,
    ["skyuxconfig.json"] = 386,
    snapcraft = 387,
    ["stripe-app.json"] = 402,
    swcrc = 514,
    taskcat = 483,
    ["template.json"] = 410,
    ["templatsources.json"] = 411,
    ["theme.json"] = 413,
    ["tizen_workspace.json"] = 414,
    tmLanguage = 415,
    tmuxinator = 472,
    ["trunk.yaml schema"] = 421,
    ["ts-force-config.json"] = 425,
    ["tsconfig.json"] = 422,
    ["tsd.json"] = 423,
    ["tsdrc.json"] = 424,
    ["tslint.json"] = 426,
    ...
    ["vega-lite.json"] = 436,
    ["vega.json"] = 435,
    ["venvironment-basic.yaml"] = 439,
    ["venvironment.yaml"] = 438,
    ["version.json"] = 440,
    ["vim-addon-info"] = 441,
    ["vs-2017.3.host.json"] = 443,
    ["vs-nesting.json"] = 444,
    ["vsls.json"] = 442,
    ["vss-extension.json"] = 448,
    ["webhint.io"] = 560,
    ["webjobpublishsettings.json"] = 453,
    ["webjobs-list.json"] = 452,
    ["xs-app.json"] = 479,
    ["xunit.runner.json"] = 462,
    yamllint = 502,
    zuul = 488,
    ["Žinoma"] = 496
  },
