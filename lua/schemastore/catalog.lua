...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 916,
    [".nodehawkrc"] = 565,
    [".npmpackagejsonlintrc"] = 569,
    [".omletrc"] = 1095,
    [".phrase.yml"] = 640,
    [".phraseapp.yml"] = 641,
    [".pmbot.yml"] = 626,
    [".postcssrc"] = 635,
    [".powerpages-web-template-manifest"] = 637,
    [".pre-commit-config.yml"] = 638,
    [".pre-commit-hooks.yml"] = 639,
    [".putout.json"] = 673,
    [".rehyperc"] = 698,
    [".remarkrc"] = 702,
    [".sprite files"] = 793,
    ...
    AIConfig = 31,
    ["AMX Muse Program Descriptor"] = 1143,
    ["API Builder"] = 951,
    ["AVA Configuration"] = 1014,
    ["AWS AppConfig Feature Flags-v1"] = 65,
    ["AWS CDK cdk.json"] = 251,
    ["AWS CloudFormation"] = 252,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 253,
    ["AWS Copilot Manifest"] = 1182,
    ["AWS SAM CLI Samconfig"] = 254,
    ["Adobe UXP Manifest"] = 1077,
    ["Aerleon Network & Service Definitions"] = 18,
    ["Aerleon Policy"] = 19,
    Aider = 1172,
    Air = 21,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1193,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1192,
    ["Airlock Microgateway"] = 32,
    ["Alacritty Configuration"] = 986,
    ["All Contributors configuration file"] = 1040,
    ["Ansible Argument Specs"] = 386,
    ["Ansible Collection Galaxy"] = 393,
    ["Ansible Execution Environment"] = 383,
    ["Ansible Inventory"] = 392,
    ["Ansible Meta"] = 384,
    ["Ansible Meta Runtime"] = 385,
    ["Ansible Navigator Configuration"] = 395,
    ["Ansible Playbook"] = 390,
    ["Ansible Requirements"] = 387,
    ["Ansible Rulebook"] = 391,
    ["Ansible Tasks File"] = 389,
    ["Ansible Vars File"] = 388,
    ["Ansible-lint Configuration"] = 394,
    Any = 1105,
    ...
    ["Application list for a WinUtil"] = 1122,
    ArchitectFX = 1127,
    ["Argo CD"] = 51,
    ["Argo Events"] = 52,
    ["Argo Workflows"] = 53,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1191,
    ["Azure IoT Operations connector metadata"] = 1188,
    ...
    ["Azure Pipelines"] = 107,
    ["Azure Static Web Apps CLI configuration file"] = 797,
    ["Azure Static Web Apps configuration file"] = 796,
    ["BOSH CPI Config"] = 131,
    ["BOSH Deploy Config"] = 132,
    ["BX CI"] = 151,
    ["Bacon config"] = 3,
    ["Bashly (bashly.yml)"] = 1044,
    ["Bashly Settings (bashly-settings.yml)"] = 1045,
    Bento = 1209,
    ["Better Code Hub"] = 956,
    ["Better Scripts"] = 152,
    Bigconfig = 124,
    ["Biome Formatter Config"] = 79,
    ["Bitmovin Encoding Template"] = 1136,
    BizTalkServerApplicationSchema = 923,
    Bleep = 153,
    ...
    ["Butane Config"] = 999,
    C4InterFlow = 1151,
    ["CDK Environment Manager, concrete environment configuration"] = 1175,
    ["CDK Environment Manager, concrete environments definition"] = 1174,
    ["CDK Environment Manager, environment definition"] = 1173,
    ["CGS Card Game Specification (cgs.json)"] = 1082,
    ["CICS TS region tagging"] = 1008,
    ["CICS TS resource import"] = 1009,
    ["CICS TS resource model"] = 1010,
    ["CICS TS resource overrides"] = 1011,
    ["CMake Presets"] = 154,
    ["CNC Codes"] = 175,
    ["CRS WAF test file"] = 1112,
    ["CRS WAF test platform overrides file"] = 1113,
    ["CSS Comb (.csscomb.json)"] = 279,
    ["CSS Lint (.csslintrc)"] = 280,
    ["CSpell (cspell.json)"] = 278,
    ["CVE Record Format"] = 184,
    CWL = 1088,
    ...
    ["Chamaleon environment"] = 1140,
    ["Chamaleon properties"] = 1141,
    ["Chamaleon template"] = 1139,
    Changepacks = 1202,
    Changesets = 263,
    Changie = 163,
    Charmcraft = 164,
    ...
    ["Chrome Extension"] = 244,
    ["Chromia Model"] = 166,
    ["Chromia Seeder Module Config"] = 168,
    ["Chromia Seeder Root Config"] = 167,
    ["Cinnamon Spice info.json"] = 87,
    ["CircleCI config.yml"] = 219,
    ["Citation File Format"] = 265,
    CityJSON = 170,
    ["Claude Code Keybindings"] = 182,
    ["Claude Code Settings"] = 183,
    ["Clawject config"] = 181,
    ["Cloud Foundry Application Manifest"] = 1094,
    ["Cloud Run Spec v1"] = 1117,
    ...
    CodeCV = 91,
    CodeRabbit = 90,
    ["CodeShip Pro services configuration files"] = 233,
    ["CodeShip Pro steps configuration files"] = 234,
    ["Codecov configuration files"] = 232,
    Codex = 228,
    CodifyCLI = 92,
    Codux = 230,
    ["Cog config file"] = 176,
    ...
    ["Common Catalog Data"] = 242,
    ["Common Package Specification"] = 179,
    Concord = 1111,
    ["Configu .cfgu files"] = 1099,
    ["Configu .configu file"] = 1100,
    Conjure = 174,
    ["Container Structure Test"] = 937,
    Containerlab = 965,
    ["Contextive Glossary"] = 1167,
    Convex = 173,
    ["Crowdsec collection config"] = 273,
    ["Crowdsec parser config"] = 274,
    ["Crowdsec scenario config"] = 275,
    ["CumulusCI Config"] = 180,
    ["Custom Machinery Machine"] = 1083,
    ["Custom Machinery Recipe"] = 1084,
    ["Cycle Stack File"] = 185,
    CycloneDX = 186,
    ["DWP Exchange - catalogue entry"] = 322,
    ["DWP Exchange - gateway"] = 320,
    ["DWP Exchange - meta"] = 321,
    ["Dart Build Config (dart-build.json)"] = 281,
    ["Dart Test Config (dart-test.json)"] = 282,
    ["DashLord Configuration"] = 283,
    ["Data Contract Specification"] = 284,
    ["Data Product Specification"] = 285,
    ["DataYoga Connections"] = 187,
    ["DataYoga Job"] = 188,
    ["Databricks Asset Bundles"] = 1061,
    ["Datadog Continuous Testing"] = 484,
    ["Datadog Service Definition"] = 485,
    ["Datadog Software Catalog"] = 486,
    ["Datahub Ingestion Recipe"] = 1015,
    ["Debian Upstream Metadata file"] = 194,
    ["Deck config"] = 195,
    ["Dein Config"] = 196,
    ["Deno Config (deno.json)"] = 291,
    ["Dependency cruiser"] = 197,
    ["DeployStack Configuration"] = 198,
    ["Deployah Configuration"] = 1190,
    ["Deployer Recipe"] = 294,
    ["Deta Spacefile"] = 199,
    ["Detekt Config (detekt.yml)"] = 295,
    ["Devbox Config"] = 200,
    ["Devbox Plugin"] = 201,
    Devfile = 319,
    Devup = 1203,
    DipDup = 1114,
    ["Discord Webhook"] = 296,
    ["DocFx Config (docfx.json)"] = 300,
    Dofigen = 301,
    ["Dolittle Artifacts"] = 302,
    ["Dolittle Bounded Context Configuration"] = 303,
    ["Dolittle Event Horizons Configuration"] = 304,
    ["Dolittle Resources Configuration"] = 305,
    ["Dolittle Server Configuration"] = 306,
    ["Dolittle Tenant Map Configuration"] = 308,
    ["Dolittle Tenants Configuration"] = 307,
    ["Dolittle Topology"] = 309,
    ["DonateCaseBetterCasino menu"] = 1144,
    ["Drupal Breakpoints"] = 202,
    ["Drupal Config"] = 214,
    ["Drupal Info"] = 203,
    ["Drupal Layouts"] = 204,
    ["Drupal Libraries"] = 205,
    ["Drupal Links Action"] = 206,
    ["Drupal Links Contextual"] = 207,
    ["Drupal Links Menu"] = 208,
    ["Drupal Links Task"] = 209,
    ["Drupal Migration"] = 210,
    ["Drupal Permissions"] = 211,
    ["Drupal Recipe"] = 212,
    ["Drupal Routing"] = 213,
    ["Drupal Services"] = 215,
    ["Drush site aliases"] = 315,
    ["Dynamic Bash Aliases (.aliases)"] = 1052,
    ["EAS config"] = 339,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1041,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1187,
    ["EasyVCR .NET"] = 340,
    ["Eidolon Resource"] = 1128,
    ["Elgato Stream Deck"] = 325,
    Elm = 1116,
    ["Embrace Config"] = 1027,
    Endurica = 1065,
    ["Enterprise Contract Policy Spec"] = 326,
    ["Erda Pipeline"] = 1090,
    ["Erda Runtime"] = 1091,
    ["Espanso config.yml"] = 1212,
    ["Espanso match.yml"] = 1211,
    Esquio = 328,
    ["Estuary Flow Catalog"] = 1005,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 332,
    ["EveryVoice TTS Toolkit Data Configuration"] = 333,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 337,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 336,
    ["EveryVoice TTS Toolkit Text Configuration"] = 334,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 335,
    ["Evolving Resolutive Process notation"] = 1189,
    ["Expo SDK"] = 338,
    ["F-Droid Data metadata"] = 344,
    ["FasterCI Configuration"] = 108,
    FiQuS = 348,
    Firebase = 346,
    ["FlexGet Config"] = 349,
    ["Flow.json Configurations"] = 1087,
    ["Fossa configuration file"] = 356,
    ["Fossa's fossa-deps file"] = 357,
    ["Foundry VTT - Base package Manifest"] = 351,
    ["Foundry VTT - Module Manifest"] = 352,
    ["Foundry VTT - System Data Template"] = 355,
    ["Foundry VTT - System Manifest"] = 353,
    ["Foundry VTT - World Manifest"] = 354,
    ["Foxx Manifest"] = 109,
    ["Freifunk.de Community API"] = 112,
    ["Frogbot Config"] = 113,
    ["G2P Mapping Configuration"] = 363,
    ["GCP Blueprint Metadata"] = 366,
    Gaspar = 364,
    ["GatewayCore API Gateway"] = 365,
    ["Gemini CLI settings"] = 367,
    ["GeoJSON.json latest"] = 1003,
    GherKing = 1007,
    ["GitHub Action"] = 372,
    ["GitHub Actions typing"] = 1124,
    ["GitHub Discussion"] = 373,
    ["GitHub Funding"] = 374,
    ["GitHub Issue Template configuration"] = 375,
    ["GitHub Issue Template forms"] = 376,
    ["GitHub Workflow"] = 377,
    ["GitHub Workflow Template Properties"] = 378,
    ["GitHub automatically generated release notes configuration"] = 379,
    ["GitLab Agent for Kubernetes configuration"] = 1079,
    GitVersion = 369,
    ["Gitea Issue Template configuration"] = 370,
    ["Gitea Issue Template forms"] = 371,
    ["Gitpod Automations"] = 381,
    ["Gitpod Configuration"] = 382,
    ["GlazeWM settings"] = 1081,
    ["Global Privacy Control"] = 368,
    Goblet = 1060,
    ["Golangci-lint Configuration"] = 397,
    ["Golangci-lint Custom Plugins Configuration"] = 398,
    ["Google Chrome Related Website Sets"] = 347,
    ["Google Cloud Workflows"] = 250,
    ["Google Digital Assetlinks"] = 1168,
    Goreleaser = 400,
    ["Goreleaser Pro"] = 401,
    Goss = 402,
    ["Gradle Build Cache Node"] = 954,
    ["Gradle Enterprise"] = 953,
    ["Grafana 5.x Dashboard"] = 403,
    ["GraphQL Code Generator"] = 408,
    ["GraphQL Config"] = 407,
    ["GraphQL Mesh"] = 406,
    ["GroovyLint configuration"] = 409,
    ["Grunt JSHint task"] = 413,
    ["Grunt Watch task"] = 414,
    ["Grunt base task"] = 415,
    ["Grunt clean task"] = 411,
    ["Grunt copy task"] = 410,
    ["Grunt cssmin task"] = 412,
    HEMTT = 919,
    Hadolint = 933,
    Hammerkit = 964,
    ["Hardware Sentry Configuration"] = 1019,
    ["HashiCorp Vault"] = 416,
    Hatch = 934,
    Hayson = 418,
    ["Haystack Pipeline"] = 419,
    ["Hazelcast 5 Configuration"] = 420,
    ["Hecate Input Schema"] = 1179,
    ["Helm Chart.lock"] = 217,
    ["Helm Chart.yaml"] = 216,
    ["Helm Unittest Test Suite"] = 218,
    ["Home Assistant Integration Manifest"] = 421,
    ["Homer dashboard configuration"] = 422,
    Hugo = 995,
    ["Hugo Theme"] = 994,
    ["Hulak Configuration"] = 429,
    ["Hyperfoil benchmark configuration"] = 428,
    ["IBM Zapp document"] = 430,
    ["IBM zCodeFormatSettings"] = 431,
    ["IMG Catapult PSP"] = 436,
    ["IVMS101 by CODE Protocol"] = 1080,
    Infrahub = 438,
    Istanbul = 1023,
    ["JDownloader2 crawler multi-rules"] = 451,
    ["JDownloader2 crawler single-rules"] = 450,
    ["JFrog Applications Config"] = 452,
    ["JFrog File Spec"] = 453,
    ["JFrog Pipelines YML DSL"] = 1029,
    ["JMeter DSL cli config"] = 454,
    JReleaser = 457,
    ["JSON Document Transform"] = 465,
    ["JSON Feed"] = 466,
    ["JSON Resume"] = 708,
    ["JSON Schema Draft 2020-12"] = 901,
    ["JSON Schema Draft 4"] = 898,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1062,
    ["JSON Schema Draft 7"] = 899,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1063,
    ["JSON Schema Draft 8 (2019-09)"] = 900,
    ["JSON-API"] = 464,
    ["JSON-e templates"] = 961,
    ["JSON-stat 2.0"] = 894,
    JSONPatch = 468,
    ["JSR Package Config (jsr.json)"] = 458,
    Jarl = 1195,
    Jasmine = 445,
    Jekyll = 446,
    ["Jenkins X Pipelines"] = 447,
    ["Jenkins X Requirements"] = 448,
    Jest = 449,
    Jocker = 455,
    ["Jovo Language Models"] = 456,
    ["Jujutsu (jj) VCS config"] = 1181,
    ["KIMMDY config file"] = 479,
    ["KODE/CI build.yaml"] = 1025,
    ["KSP-AVC"] = 895,
    ["KSP-CKAN"] = 896,
    ["KSP-NetKAN"] = 897,
    KSY = 1092,
    KSail = 361,
    ["KYA Manifest"] = 1093,
    ["Karakum configuration file"] = 358,
    Kas = 471,
    ["Kestra flow file"] = 480,
    ["Keycloak REST API"] = 1032,
    ["Knative Functions - func.yaml"] = 359,
    Knip = 360,
    ["Kometa (nightly) config file"] = 482,
    ["Kometa config file"] = 481,
    ["Kong DBLess config"] = 1026,
    KrakenD = 483,
    ["Kubri Configuration"] = 490,
    LOOBin = 505,
    ["Lake configuration file"] = 1184,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 255,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 256,
    ["Landing Zone Accelerator on AWS - Global Config"] = 257,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 258,
    ["Landing Zone Accelerator on AWS - Network Config"] = 259,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 260,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 261,
    ["Landing Zone Accelerator on AWS - Security Config"] = 262,
    ["Lando (landofile)"] = 103,
    ["LangGraph Platform configuration"] = 1104,
    ["Language configuration"] = 1103,
    Lefthook = 494,
    ["Liferay client-extension.yaml"] = 501,
    ["LinkML Metamodel"] = 503,
    Liquibase = 970,
    ["Liquibase Flow File"] = 971,
    ["Lively Properties"] = 504,
    ["Lobe AI Agent"] = 105,
    Loki = 106,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 545,
    ["MS2Rescore Configuration"] = 548,
    ["Madness (madness.yml)"] = 1043,
    ["Mado configuration"] = 511,
    ["MapEHR Mapping"] = 512,
    Markdownlint = 974,
    ["Mason Registry"] = 977,
    ["MegaLinter Custom Flavor"] = 515,
    ["MegaLinter configuration"] = 514,
    ["MegaLinter descriptor"] = 516,
    Melange = 1070,
    ["Meltano project definition"] = 517,
    ["Mergify Configuration"] = 549,
    ["Metadata for a Bazel module"] = 518,
    ["Metadata for a Cinnamon spice"] = 1120,
    ["Metatype Configuration"] = 519,
    ["MetricsHub Configuration"] = 520,
    ["MetricsHub Connector Configuration"] = 521,
    ["Micro Editor Syntax"] = 1053,
    ["Microsoft Band Web Tile"] = 522,
    ["Microsoft RulesEngine workflow rules"] = 1108,
    ["Microsoft RulesEngine workflow rules list"] = 1109,
    ["Minecraft Custom Main Menu Mod"] = 1071,
    ["Minecraft Data Pack Advancement"] = 524,
    ["Minecraft Data Pack Biome"] = 525,
    ["Minecraft Data Pack Configured Carver"] = 526,
    ["Minecraft Data Pack Damage Type"] = 527,
    ["Minecraft Data Pack Dimension"] = 529,
    ["Minecraft Data Pack Dimension Type"] = 528,
    ["Minecraft Data Pack Item Modifier"] = 530,
    ["Minecraft Data Pack Loot Table"] = 531,
    ["Minecraft Data Pack Metadata"] = 532,
    ["Minecraft Data Pack Predicate"] = 533,
    ["Minecraft Data Pack Recipe"] = 534,
    ["Minecraft Data Pack Tag"] = 535,
    ["Minecraft Data Pack Template Pool"] = 536,
    ["Minecraft Data Pack Trim Material"] = 541,
    ["Minecraft Data Pack Trim Pattern"] = 542,
    ["Minecraft Resource Pack Lang"] = 537,
    ["Minecraft Resource Pack Particle"] = 538,
    ["Minecraft Resource Pack Texture Mcmeta"] = 540,
    ["Minecraft Resourcepack Sounds"] = 539,
    ["Monade CLI Stack Configuration"] = 552,
    ["MongoDB Atlas Search Index Definition"] = 1024,
    ["Monika Configuration"] = 1022,
    ["Monoweave Configuration"] = 547,
    ["Motif config"] = 915,
    MultiQC = 1161,
    ["NOX Framework (Service)"] = 568,
    ["Netin Diagnostic System Template"] = 981,
    ["Netlify config"] = 555,
    ["Network-as-Code Data Model"] = 556,
    ["Next Gen UI Agent A2A Server Configuration"] = 557,
    ["Next Gen UI Agent Configuration"] = 559,
    ["Next Gen UI Agent MCP Server Configuration"] = 558,
    ["Nightwatch.js"] = 561,
    ["Node.js configuration"] = 920,
    ["NueJS configuration file"] = 573,
    ["Nuitka.yaml"] = 1085,
    ["Nullstone config"] = 575,
    ["ONe's changelog entry"] = 593,
    ["ONe's service descriptor"] = 592,
    ["ORT Server repository environment configuration"] = 602,
    ["OSCAL Assessment Plan (AP)"] = 604,
    ["OSCAL Assessment Results (AR)"] = 605,
    ["OSCAL Catalog"] = 606,
    ["OSCAL Component Definition (CDef)"] = 607,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 608,
    ["OSCAL Profile"] = 609,
    ["OSCAL System Security Plan (SSP)"] = 610,
    ["OSS Review Toolkit configuration"] = 611,
    ["OSS Review Toolkit curation"] = 612,
    ["OSS Review Toolkit package configuration"] = 613,
    ["OSS Review Toolkit repository configuration"] = 614,
    ["OSS Review Toolkit resolutions"] = 615,
    ["October CMS columns"] = 579,
    ["October CMS fields"] = 580,
    ["Oh My Posh"] = 581,
    Okteto = 582,
    ["Ona Automations"] = 584,
    Opctl = 918,
    ["Open Data Contract Standard (ODCS)"] = 596,
    ["Open Data Product Standard (ODPS)"] = 597,
    ["Open Know-How"] = 1166,
    ["OpenRewrite Resource"] = 595,
    OpenSRM = 598,
    OpenStatus = 1177,
    ["OpenUtau character yaml"] = 589,
    ["OpenUtau ustx"] = 590,
    ["OpenWeather Current Weather API"] = 960,
    ["OpenWeather Road Risk API"] = 959,
    ["Ory Hydra configuration"] = 427,
    ["Ory Keto configuration"] = 487,
    ["Ory Kratos configuration"] = 603,
    ["Ory Oathkeeper configuration"] = 577,
    ["Outblocks App configuration"] = 600,
    ["Outblocks database table"] = 601,
    ["Outblocks project configuration"] = 599,
    PDM = 622,
    POPxf = 632,
    ["POPxf Correlations"] = 633,
    Packer = 619,
    Pantsbuild = 1039,
    ["Paper paper-plugin.yml"] = 620,
    ["Pipeline component"] = 972,
    ["Platform.sh application"] = 5,
    ["Platform.sh routes"] = 6,
    ["Platform.sh services"] = 7,
    ["Plex Prerolls"] = 630,
    ["PocketMine plugin.yml"] = 627,
    ["Postman collection"] = 636,
    ["Power Pages Configuration"] = 1178,
    ["Preset list for a WinUtil"] = 1123,
    ["ProActions AI-Kit Configuration"] = 646,
    ["ProActions AI-Kit Configuration for Menus"] = 648,
    ["ProActions AI-Kit Configuration for Sections"] = 650,
    ["ProActions AI-Kit Configuration for Services"] = 647,
    ["ProActions AI-Kit Configuration for Steps"] = 651,
    ["ProActions AI-Kit Configuration for Templates"] = 649,
    ["Problem object RFC9457"] = 1068,
    ["Problem package format"] = 652,
    ["Problem package generators"] = 653,
    ["Problem package submissions"] = 654,
    ["Problem package test group metadata"] = 655,
    Pterodactyl = 1018,
    ["Pull Request Labeler"] = 672,
    Pulumi = 680,
    ["PyGTA Config"] = 676,
    PyProject = 681,
    Pylock = 1169,
    Pyright = 682,
    ["Python script metadata"] = 1163,
    ["QType AI DSL"] = 685,
    Qgoda = 684,
    Qodana = 991,
    ["Qt Creator workspace file"] = 1101,
    ["Quali Torque Blueprint Spec 2"] = 1016,
    ["QueryFirst config file"] = 1035,
    ["RKE Cluster Configuration JSON"] = 969,
    ["RKE Cluster Configuration YAML"] = 968,
    RadioHound = 675,
    Railpack = 687,
    Railway = 686,
    ["Rancher Fleet"] = 677,
    ...
    Ray = 932,
    ["Read the Docs"] = 679,
    ["Red-DiscordBot Cog"] = 695,
    ["Red-DiscordBot Cog Repo"] = 696,
    ["Red-DiscordBot Trivia"] = 697,
    ["Releasaurus Config"] = 2,
    ["Render Blueprints"] = 967,
    RenderCV = 712,
    Renovate = 709,
    ["Renovate global configuration"] = 710,
    ["Renovate inherited configuration"] = 711,
    ["Replit config"] = 703,
    Restate = 1156,
    ["Revel Digital Gadget Definition File"] = 1180,
    RoadRunner = 714,
    ["Robust Station Image"] = 1186,
    Rockcraft = 715,
    ["Roo Coder Custom Modes"] = 716,
    Rubocop = 705,
    ["Rudder techniques"] = 1075,
    Ruff = 706,
    ["Rust Project"] = 707,
    ["Rust toolchain"] = 720,
    ["SDMX data message"] = 746,
    ["SDMX metadata message"] = 745,
    ["SDMX structure message"] = 744,
    ["SIL Kit Participant Configuration"] = 756,
    ["SIL Kit Registry Configuration"] = 757,
    ["SPDX 2.3"] = 794,
    SWADL = 810,
    ["Safebox Config"] = 1030,
    ["Sapphire CLI Config"] = 723,
    ["SauceCTL Configuration"] = 978,
    ["Schema Catalog"] = 738,
    ["Scoop manifest"] = 743,
    ["Semantic Data Fabric (SDF) file"] = 747,
    ["Semgrep Rule"] = 749,
    ["Serenity Code Generator (Sergen)"] = 750,
    ["Serverless Framework Configuration"] = 985,
    ["Serverless Workflow"] = 987,
    ["Settings for a Cinnamon spice"] = 1119,
    ["Settings.paf"] = 752,
    ["Shopware 6 Configuration"] = 988,
    ["Shopware CLI Extension Store Configuration"] = 989,
    ["Shopware CLI Project Store Configuration"] = 990,
    ["Sigma Detection Rule"] = 754,
    ["Sigrid scope configuration file"] = 755,
    ["SkyPilot Task JSON"] = 1076,
    ["Slack app manifest"] = 759,
    Snapcraft = 761,
    Solidarity = 764,
    ["Solution filters"] = 765,
    ["Source Maps v3"] = 766,
    Sourcery = 767,
    ["Spack bootstrap.yaml"] = 768,
    ["Spack cdash.yaml"] = 769,
    ["Spack ci.yaml"] = 770,
    ["Spack compilers.yaml"] = 771,
    ["Spack concretizer.yaml"] = 772,
    ["Spack config.yaml"] = 773,
    ["Spack definitions.yaml"] = 774,
    ["Spack develop.yaml"] = 775,
    ["Spack env_vars.yaml"] = 776,
    ["Spack environment"] = 782,
    ["Spack include.yaml"] = 777,
    ["Spack mirrors.yaml"] = 778,
    ["Spack modules.yaml"] = 779,
    ["Spack packages.yaml"] = 780,
    ["Spack repos.yaml"] = 781,
    ["Spack toolchains.yaml"] = 783,
    ["Spack upstreams.yaml"] = 784,
    ["Spack view.yaml"] = 785,
    ["Speakeasy Generation Config File"] = 789,
    ["Speakeasy Lint Configuration File"] = 786,
    ["Speakeasy Test Generation Configuration File"] = 787,
    ["Speakeasy Workflow File"] = 788,
    SpecIF = 790,
    ["Specmatic Configuration"] = 791,
    ["Sponge Mixin configuration"] = 792,
    StackBlitz = 798,
    ["StackHawk Scanner Configuration"] = 984,
    Stale = 799,
    Starfish = 800,
    ["Starlake Data Pipeline"] = 957,
    Starship = 801,
    ["Statamic Blueprint"] = 802,
    ["Stella configuration file"] = 803,
    ["Streamlit configuration file"] = 804,
    ["Stryker Mutator"] = 807,
    ["StyleCop Analyzers Configuration"] = 808,
    ["Stylelint (.stylelintrc)"] = 809,
    ["Stylua Config"] = 1170,
    ["Sublime Syntax"] = 1031,
    ["Subsquid squid manifest"] = 1078,
    ["Swagger API 2.0"] = 811,
    ["Synadia Connect Component"] = 812,
    TSON = 847,
    TSTyche = 848,
    ["TYPO3 Vendor Bundler config"] = 853,
    ["Tab data for a LinUtil"] = 1126,
    ["Tab list for a LinUtil"] = 1125,
    Tach = 813,
    ["Tach Domain"] = 814,
    Talhelper = 816,
    ["Talisman configuration"] = 817,
    Taplo = 1171,
    ["Taskfile config"] = 962,
    Taurus = 818,
    Tauticord = 819,
    ["Tekton Pipeline"] = 1199,
    ["Tekton PipelineRun"] = 1200,
    ["Tekton Task"] = 1197,
    ["Tekton TaskRun"] = 1198,
    Telefonistka = 1157,
    ["Terrateam config"] = 1183,
    ["TestEnvironment.json"] = 830,
    ["TextMate Grammar"] = 829,
    Threagile = 825,
    ["Tier.run pricing.json"] = 822,
    Tikibase = 823,
    Tombi = 828,
    ["Traefik v2"] = 833,
    ["Traefik v2 File Provider"] = 834,
    ["Traefik v3"] = 835,
    ["Traefik v3 File Provider"] = 836,
    ["Travis CI (.travis.yml)"] = 832,
    Treefmt = 405,
    Trident = 1153,
    ["TrueScript for *.tscript files"] = 839,
    ["Tugboat QA config.yml"] = 1150,
    TunnelHub = 1066,
    Turborepo = 831,
    Tycho = 1115,
    Tye = 992,
    ["Tyk Gateway - Open Source v5.7+"] = 1162,
    ["UET BuildConfig.json"] = 1036,
    ["UI5 Manifest"] = 859,
    ["UNCORS configuration"] = 863,
    ["UTAM Page Object"] = 862,
    ["Ubuntu Server Autoinstall"] = 857,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1154,
    ["Uniswap Token List"] = 944,
    ["Universal Schedule Format"] = 864,
    ["Unreal Engine Uplugin"] = 1037,
    ["Unreal Engine Uproject"] = 1038,
    ["UpCloud CLI (upctl) configuration"] = 1155,
    ["Updatecli Compose"] = 1000,
    ["Updatecli Policy Manifest"] = 1001,
    ["Updatecli Policy Metadata"] = 1002,
    Uplift = 1034,
    ["Upsun config"] = 4,
    ["User Journey Map"] = 966,
    V2Ray = 1006,
    ["VSCode Code Snippets"] = 238,
    ["VSIX CLI publishing"] = 882,
    Vector = 866,
    ["Vela Pipeline Configuration"] = 869,
    Vercel = 237,
    ["Version Bumper config"] = 872,
    Vespertide = 1204,
    ["Vespertide Migration"] = 1205,
    ["Vespertide Model"] = 1206,
    ["Viash Component Config"] = 1159,
    ["Viash Package Config"] = 1160,
    Visivo = 1064,
    ["WP-CLI"] = 892,
    Wake = 1152,
    ["Waku Config"] = 1129,
    ["Web App Manifest"] = 888,
    ["Web types"] = 891,
    WebExtensions = 887,
    ["Webman package recipe"] = 1012,
    ["Windows Package Manager Installer Manifest"] = 940,
    ["Windows Package Manager Locale Manifest"] = 941,
    ["Windows Package Manager Singleton Manifest"] = 939,
    Winutil = 942,
    ["WireMock CLI import configuration"] = 1135,
    ["WireMock CLI local service configuration"] = 1134,
    ["WireMock message stub mapping"] = 1133,
    ["WireMock stub mapping"] = 1132,
    ["Woodpecker pipeline config"] = 980,
    ["Wrangler CLI"] = 893,
    ["Xstate Machine"] = 998,
    ["Yandex Workflow Language"] = 1121,
    ["Yarn Config (.yarnrc.yml)"] = 955,
    ["Yippee-Ki-JSON configuration YML"] = 946,
    ["YouTrack App"] = 1118,
    ["Zarf Package Configuration"] = 1185,
    ["Zerops.io config"] = 1106,
    ["Zerops.io import"] = 1107,
    ["Zola Configuration"] = 1196,
    ["aerleon.yml"] = 17,
    ["amplify.yml"] = 10,
    ["angular.json"] = 33,
    apko = 1069,
    ...
    ["behat.yml"] = 134,
    ["bigquery-table"] = 123,
    ["bioimageio resource description"] = 1086,
    ...
    ["ccmod.json"] = 1130,
    changelogging = 1098,
    ["chisel-slices.json"] = 264,
    ["chrome-extension-locales-messages.json"] = 245,
    ["chutzpah.json"] = 246,
    cibuildwheel = 169,
    ["clang-format (.clang-format)"] = 1004,
    ["clang-tidy"] = 224,
    clangd = 223,
    clib = 225,
    ["cloud-init: cloud-config userdata"] = 227,
    ["cloud-sdk-pipeline-configuration"] = 248,
    ["cloudbuild.json"] = 249,
    cloudify = 226,
    ["cmdx.yaml"] = 89,
    codemagic = 229,
    ["coffeelint.json"] = 266,
    ["commands.json"] = 241,
    ["commitlint (.commitlintrc)"] = 943,
    ["committed.toml"] = 267,
    ["compile_commands.json"] = 240,
    ["compilerconfig.json"] = 239,
    ["completely.yml"] = 1042,
    ["component-detection-manifest.json"] = 270,
    ["component.json"] = 269,
    ["composer.json"] = 268,
    ["conda-forge"] = 172,
    ["config.yaml"] = 678,
    ["contentmanifest.json"] = 247,
    ["contribute.json"] = 271,
    ["cosmos.config.json"] = 243,
    ["crowdin.yml"] = 272,
    ["ctfd-setup configuration file"] = 1142,
    ["custom-elements.json"] = 1056,
    ["cypress.json"] = 276,
    ["datalogic-scan2deploy-android"] = 286,
    ["datalogic-scan2deploy-ce"] = 287,
    ["dbt Dependencies"] = 189,
    ["dbt Packages"] = 191,
    ["dbt Project"] = 190,
    ["dbt Selectors"] = 192,
    ["dbt YAML files"] = 193,
    ["ddev-global"] = 288,
    ["ddev-project"] = 289,
    ["debugsettings.json"] = 290,
    ["dependabot-v2.json"] = 293,
    ["dependabot.json"] = 292,
    ["deployed-cli"] = 997,
    ["devcontainer.json"] = 231,
    devinit = 948,
    ["devspace.yaml"] = 1020,
    djlint = 949,
    ["docker bake"] = 298,
    ["docker sequencer"] = 299,
    ["docker-compose.yml"] = 947,
    ["dockerd.json"] = 297,
    ["dotnet Release Index manifest"] = 310,
    ["dotnet-tools.json"] = 311,
    ["dotnetcli.host.json"] = 312,
    ["dprint.json"] = 313,
    ["drone.json"] = 314,
    ["dss-2.0.0.json"] = 316,
    ["dstack configuration"] = 317,
    ["dtool dataset metadata"] = 1137,
    ["dvc.yaml"] = 318,
    ["ecosystem.json"] = 323,
    eksctl = 324,
    ["electron-builder configuration file"] = 330,
    ["epr-manifest.json"] = 329,
    ["evcc.yaml"] = 331,
    ["ezd task runner"] = 341,
    ["fabric.mod.json"] = 343,
    ["first-timers-bot"] = 350,
    ["flagd flag configuration"] = 110,
    ["fly.io Configuration"] = 111,
    fulibWorkflows = 979,
    ["function.json"] = 362,
    ["gRPC API Gateway & OpenAPI Config"] = 12,
    ["gematik health care insurance list"] = 1148,
    ["gematik health care patient list"] = 1145,
    ["gematik health care provider institution list"] = 1147,
    ["gematik health care provider list"] = 1146,
    ["gematik tiger test environment configuration"] = 1149,
    ["git-town.toml"] = 1194,
    ["gitlab-ci"] = 380,
    ["global.json"] = 396,
    ["go-feature-flag Flag Configuration"] = 399,
    ["haxelib.json"] = 417,
    helmfile = 935,
    helmwave = 936,
    ["host-meta.json"] = 424,
    ...
    ["ide.host.json"] = 432,
    ["ifstate.yaml"] = 433,
    ["imageoptimizer.json"] = 434,
    ["importmap.json"] = 437,
    instant_python_config = 439,
    instant_python_custom_project = 440,
    ["ioBroker Configuration"] = 441,
    ["ioBroker JSON UI"] = 442,
    ["ioBroker Package manifest"] = 443,
    ["ixpect.conf.yaml"] = 444,
    ["ize.toml"] = 1033,
    ["jsconfig.json"] = 469,
    ["jscpd Configuration"] = 1017,
    jsdoc = 931,
    ["k3d.yaml"] = 470,
    ["k9s aliases.yaml"] = 472,
    ["k9s cluster-config.yaml"] = 474,
    ["k9s config.yaml"] = 473,
    ["k9s hotkeys.yaml"] = 475,
    ["k9s plugins.yaml"] = 476,
    ["k9s skin.yaml"] = 477,
    ["k9s views.yaml"] = 478,
    ["kontinuous-config.yaml"] = 489,
    ["kontinuous-values.yaml"] = 488,
    ["kustomization.yaml"] = 491,
    ["label-commenter-config.yml"] = 492,
    ["latexindent configuration"] = 104,
    ["launchsettings.json"] = 493,
    lazydocker = 1055,
    lazygit = 1054,
    ["lego.json"] = 495,
    ["lerna.json"] = 496,
    ["lgtm.yml"] = 497,
    ["liblab.config.json"] = 498,
    ["libman.json"] = 499,
    ["license-report-config.json"] = 500,
    ["linkinator.config.json"] = 502,
    ["lint-staged (.lintstagedrc)"] = 909,
    ["local.settings.json"] = 507,
    ["localazy.json"] = 508,
    ["lotus.yaml"] = 506,
    ["lsdlschema.json"] = 509,
    ["macro.json"] = 1021,
    ["markdown-link-check"] = 975,
    maturin = 976,
    mboats = 983,
    ["micro-settings.json"] = 1048,
    ["mimetypes.json"] = 523,
    ["mirrord config"] = 911,
    mise = 912,
    ["mkdocs.yml"] = 543,
    ["monospace.yml"] = 546,
    ["moon.yml"] = 1131,
    ["mprocs Configuration file"] = 1102,
    ["mrdocs.yml"] = 544,
    ["mta.yaml"] = 913,
    ["mtad.yaml"] = 914,
    ["mycode.json"] = 553,
    nFPM = 560,
    ["napari plugin manifest"] = 554,
    neoload = 926,
    ["nest-cli"] = 563,
    ["ninjs (News in JSON)"] = 562,
    ["nitro.json"] = 925,
    ["nixd configuration"] = 1074,
    ["nlu.json"] = 564,
    ["nodemon.json"] = 566,
    ["noodl config"] = 982,
    ["notebook.mod.json"] = 567,
    now = 921,
    ["npm-badges"] = 570,
    ["nswag.json"] = 574,
    ntangle = 576,
    ["nuclei-template.yaml"] = 571,
    ["nuget-project.json"] = 572,
    ["ocelot.json"] = 578,
    ["omnisharp.json"] = 583,
    openHAB = 1207,
    ["openapi.json"] = 585,
    ...
    ["plagiarize.yaml"] = 628,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1138,
    ["podbard.yaml"] = 631,
    ["portman.json"] = 634,
    ["prefect.toml"] = 642,
    ["prefect.yaml"] = 643,
    ["prettierrc.json"] = 644,
    ["prisma.yml"] = 645,
    ["project-1.0.0-beta3.json"] = 657,
    ["project-1.0.0-beta4.json"] = 658,
    ["project-1.0.0-beta5.json"] = 659,
    ["project-1.0.0-beta6.json"] = 660,
    ["project-1.0.0-beta8.json"] = 661,
    ["project-1.0.0-rc1.json"] = 662,
    ["project-1.0.0-rc2.json"] = 663,
    ["project.json"] = 656,
    ["project.owasp.yaml"] = 664,
    ["prometheus-alertmanager.json"] = 668,
    ["prometheus.json"] = 665,
    ["prometheus.rules.json"] = 666,
    ["prometheus.rules.test.json"] = 667,
    ["proxies.json"] = 669,
    ["publiccode.yml"] = 670,
    ["pubspec.yaml"] = 671,
    ["pyrseas-0.8.json"] = 674,
    pytest = 683,
    ["quilt.mod.json"] = 1049,
    ["rc3 auth"] = 689,
    ["rc3 collection"] = 690,
    ...
    ["release drafter"] = 927,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 699,
    ["release-please-manifest.json"] = 700,
    ["release-plz.toml"] = 701,
    ["renv.lock"] = 713,
    ["rivet.json"] = 1073,
    ["rivet.yaml (legacy)"] = 1072,
    rumdl = 718,
    runny = 717,
    rustfmt = 719,
    sake = 1165,
    samt = 721,
    samtrc = 722,
    ["sarif-1.0.0.json"] = 724,
    ["sarif-2.0.0.json"] = 725,
    ["sarif-2.1.0"] = 735,
    ["sarif-2.1.0-rtm.2"] = 726,
    ["sarif-2.1.0-rtm.3"] = 728,
    ["sarif-2.1.0-rtm.4"] = 730,
    ["sarif-2.1.0-rtm.5"] = 732,
    ["sarif-2.1.0-rtm.6"] = 733,
    ["sarif-external-property-file-2.1.0"] = 736,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 727,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 729,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 731,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 734,
    ["scalingo.json configuration"] = 737,
    ["schema.org - Action"] = 739,
    ["schema.org - ContactPoint"] = 740,
    ["schema.org - Place"] = 741,
    ["schema.org - Thing"] = 742,
    ["secrethub.yml"] = 1051,
    ["semantic-release"] = 748,
    ["servicehub.config.json"] = 904,
    ["servicehub.service.json"] = 903,
    ["settings.job"] = 751,
    ["sfdx-hardis configuration"] = 753,
    ["shard.yml"] = 1089,
    ["size-limit configuration"] = 758,
    ["skaffold.yaml"] = 973,
    ["skyuxconfig.json"] = 760,
    ["snowflake-config"] = 762,
    ["snowflake-connections"] = 763,
    ["spicepod.yaml"] = 1110,
    ["sqlc configuration"] = 795,
    ["stripe-app-local.json"] = 806,
    ["stripe-app.json"] = 805,
    swcrc = 958,
    ["task.json"] = 815,
    taskcat = 922,
    ["template.json"] = 820,
    ["templatsources.json"] = 821,
    ["theme.json"] = 824,
    ["tizen_workspace.json"] = 826,
    tldr = 827,
    ["tm_devices configuration file"] = 1176,
    tmuxinator = 907,
    ["transcend.yml"] = 837,
    ["tree-sitter grammar.json"] = 404,
    ["trime.yaml"] = 838,
    ["trunk.yaml"] = 840,
    ["ts-force-config.json"] = 845,
    ["tsconfig.json"] = 841,
    ["tsd.json"] = 842,
    ["tsdoc.json"] = 843,
    ["tsdrc.json"] = 844,
    ...
    v8r = 886,
    vcluster = 1096,
    ["vcpkg configuration file"] = 236,
    ["vcpkg manifest file"] = 235,
    ["vega-lite.json"] = 868,
    ["vega.json"] = 867,
    ["venvironment.yaml"] = 870,
    ["venvplus.yaml"] = 871,
    version = 1158,
    ["version.json"] = 873,
    ["vhwdebugger-binding.yaml"] = 875,
    ["vim-addon-info"] = 876,
    ["vs-2017.3.host.json"] = 878,
    ["vs-nesting.json"] = 879,
    ["vsls.json"] = 877,
    ["vss-extension.json"] = 883,
    vtcfg = 1164,
    ["vtesttree.yaml"] = 884,
    ["vtestunit.yaml"] = 885,
    ["warp-keysets.json"] = 1057,
    ["warp-themes.json"] = 1058,
    ["warp-workflows.json"] = 1059,
    ["webhint.io"] = 1013,
    ["webjobpublishsettings.json"] = 890,
    ["webjobs-list.json"] = 889,
    ["well-known-fursona"] = 1097,
    ["xs-app.json"] = 917,
    ["xunit.runner.json"] = 902,
    yamllint = 945,
    zizmor = 1201,
    zuul = 928,
    ["Žinoma"] = 938
