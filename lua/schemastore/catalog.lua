...
M.json = {
  ...
  index = {
    ...
    AIConfig = 45,
    ["AMX Muse Program Descriptor"] = 1270,
    ["API Builder"] = 1076,
    ["AVA Configuration"] = 1140,
    ...
    ["AWS Copilot Manifest"] = 1309,
    ["AWS SAM CLI Samconfig"] = 293,
    Acton = 1360,
    ["Adobe UXP Manifest"] = 1203,
    ["Aerleon Network & Service Definitions"] = 27,
    ["Aerleon Policy"] = 28,
    ["Agent Permission Policy"] = 1349,
    ["AgentCore CLI"] = 1350,
    AgentLoopKit = 1351,
    Aider = 1299,
    Air = 30,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1320,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1319,
    ["Airlock Microgateway"] = 46,
    ["Alacritty Configuration"] = 1112,
    ["AlgoVoi Compliance Receipt v1"] = 16,
    ["All Contributors configuration file"] = 1166,
    ...
    ["Application list for a WinUtil"] = 1249,
    ArchitectFX = 1254,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1318,
    ["Azure IoT Operations connector metadata"] = 1315,
    ...
    ["Azure Pipelines"] = 129,
    ["Azure Static Web Apps CLI configuration file"] = 914,
    ["Azure Static Web Apps configuration file"] = 913,
    BMML = 1337,
    ["BOSH BPM Config"] = 155,
    ["BOSH CPI Config"] = 156,
    ...
    ["Bacon config"] = 10,
    ["Barba-CV"] = 95,
    ["Bashly (bashly.yml)"] = 1170,
    ["Bashly Settings (bashly-settings.yml)"] = 1171,
    Bento = 1336,
    ["Better Code Hub"] = 1081,
    ["Better Scripts"] = 179,
    Bigconfig = 148,
    ["Biome Formatter Config"] = 96,
    ["Bitmovin Encoding Template"] = 1263,
    BizTalkServerApplicationSchema = 1047,
    Bleep = 180,
    ["Block Protocol Metadata"] = 177,
    ["Bluebricks blueprint config"] = 1342,
    ["Boyka Framework"] = 158,
    ...
    ["Butane Config"] = 1125,
    C4InterFlow = 1278,
    ["CDK Environment Manager, concrete environment configuration"] = 1302,
    ["CDK Environment Manager, concrete environments definition"] = 1301,
    ["CDK Environment Manager, environment definition"] = 1300,
    ["CGS Card Game Specification (cgs.json)"] = 1208,
    ["CICS TS region tagging"] = 1134,
    ["CICS TS resource import"] = 1135,
    ["CICS TS resource model"] = 1136,
    ["CICS TS resource overrides"] = 1137,
    ["CMake Presets"] = 181,
    ["CNC Codes"] = 203,
    ["CRS WAF test file"] = 1238,
    ["CRS WAF test platform overrides file"] = 1239,
    ...
    ["Caido Proxy Configuration"] = 1375,
    ...
    ["Chamaleon environment"] = 1267,
    ["Chamaleon properties"] = 1268,
    ["Chamaleon template"] = 1266,
    Changepacks = 1329,
    Changesets = 302,
    Changie = 190,
    Charmcraft = 191,
    ...
    ["Clawject config"] = 209,
    ["Cloud Foundry Application Manifest"] = 1220,
    ["Cloud Run Spec v1"] = 1244,
    ...
    Concord = 1237,
    ["Configu .cfgu files"] = 1225,
    ["Configu .configu file"] = 1226,
    Conjure = 202,
    ["Container Structure Test"] = 1061,
    Containerlab = 1090,
    ["Contextive Glossary"] = 1294,
    ContractGuard = 1091,
    Convex = 201,
    ...
    ["Cursor Agent Environment"] = 1347,
    ["Custom Machinery Machine"] = 1209,
    ["Custom Machinery Recipe"] = 1210,
    ...
    ["DonateCaseBetterCasino menu"] = 1271,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1178,
    ["EAS config"] = 403,
    ["ECA - Editor Code Assistant"] = 366,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1167,
    ["ESLint Suppressions"] = 408,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1314,
    ["EasyVCR .NET"] = 405,
    ["Eidolon Resource"] = 1255,
    ...
    ["Envelope Team Definition"] = 1359,
    ["Envilder Map File"] = 371,
    ["Erda Pipeline"] = 1216,
    ["Erda Runtime"] = 1217,
    ["Espanso config.yml"] = 1340,
    ["Espanso match.yml"] = 1339,
    Esquio = 391,
    ["Estuary Flow Catalog"] = 1131,
    ["Ethereum ERC1155"] = 1353,
    ["Ethereum ERC721"] = 1352,
    ...
    ["Evolving Resolutive Process notation"] = 1316,
    ["Expo SDK"] = 402,
    ...
    ["GeoJSON.json latest"] = 1129,
    GherKing = 1133,
    ["GitHub Action"] = 443,
    ["GitHub Actions typing"] = 1251,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 1205,
    GitResume = 457,
    GitVersion = 438,
    ...
    ["Google Digital Assetlinks"] = 1295,
    Goreleaser = 476,
    ["Goreleaser Pro"] = 477,
    Goss = 479,
    ["Gradle Build Cache Node"] = 1079,
    ["Gradle Enterprise"] = 1078,
    ...
    Hadolint = 1057,
    Hammerkit = 1089,
    ["Hardware Sentry Configuration"] = 1145,
    ...
    ["Hecate Input Schema"] = 1306,
    ["Helm Chart.lock"] = 251,
    ["Helm Chart.yaml"] = 250,
    ["Helm Unittest Test Suite"] = 252,
    ["Heloisa Assistant Plugins Marketplace"] = 1382,
    ["Hex file"] = 253,
    ...
    ["JFrog File Spec"] = 535,
    ["JFrog Pipelines YML DSL"] = 1155,
    ["JMeter DSL cli config"] = 536,
    JReleaser = 539,
    ["JSON Document Transform"] = 547,
    ["JSON Feed"] = 548,
    ["JSON Resume"] = 820,
    ["JSON Schema Draft 2020-12"] = 1023,
    ["JSON Schema Draft 4"] = 1020,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1188,
    ["JSON Schema Draft 7"] = 1021,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1189,
    ["JSON Schema Draft 8 (2019-09)"] = 1022,
    ["JSON-API"] = 546,
    ["JSON-e templates"] = 1086,
    ["JSON-stat 2.0"] = 1016,
    JSONPatch = 550,
    ...
    ["Jujutsu (jj) VCS config"] = 1308,
    ["KIMMDY config file"] = 561,
    ["KODE/CI build.yaml"] = 1151,
    ["KSP-AVC"] = 1017,
    ["KSP-CKAN"] = 1018,
    ["KSP-NetKAN"] = 1019,
    KSY = 1218,
    ...
    ["Lando (landofile)"] = 122,
    ["LangGraph Platform configuration"] = 1230,
    ["Language configuration"] = 1229,
    Lefthook = 578,
    ["Liferay client-extension.yaml"] = 585,
    ["LinkML Metamodel"] = 587,
    Liquibase = 1096,
    ["Liquibase Flow File"] = 1097,
    ...
    ["Madness (madness.yml)"] = 1169,
    ["Mado configuration"] = 596,
    ["Maestro Flow"] = 597,
    ["Mail Servers Configuration"] = 1343,
    ["MapEHR Mapping"] = 598,
    Markdownlint = 1100,
    ["Mason Registry"] = 1103,
    ...
    ["Metadata for a Cinnamon spice"] = 1247,
    ["Metatype Configuration"] = 605,
    ["MetricsHub Configuration"] = 606,
    ["MetricsHub Connector Configuration"] = 607,
    ["Micro Editor Syntax"] = 1179,
    ["Microsoft Band Web Tile"] = 608,
    ["Microsoft RulesEngine workflow rules"] = 1234,
    ["Microsoft RulesEngine workflow rules list"] = 1235,
    ["Minecraft Custom Main Menu Mod"] = 1197,
    ...
    ["MongoDB Atlas Search Index Definition"] = 1150,
    ["Monika Configuration"] = 1148,
    ["Monoweave Configuration"] = 639,
    ["Motif config"] = 1039,
    MultiQC = 1288,
    ["NOX Framework (Service)"] = 667,
    ["Netin Diagnostic System Template"] = 1107,
    ["Netlify config"] = 648,
    ...
    ["Nightwatch.js"] = 659,
    ["Nika workflow"] = 664,
    ["Node.js configuration"] = 1044,
    ["NueJS configuration file"] = 672,
    ["Nuitka Package Config"] = 1211,
    ...
    ["OpenUtau ustx"] = 693,
    ["OpenWeather Current Weather API"] = 1085,
    ["OpenWeather Road Risk API"] = 1084,
    ...
    ["Pipeline component"] = 1098,
    ["Platform.sh application"] = 12,
    ["Platform.sh routes"] = 13,
    ["Platform.sh services"] = 14,
    ["Plex Prerolls"] = 738,
    ["PocketMine plugin.yml"] = 735,
    ["Podman Desktop Extension"] = 1377,
    ["Postman collection"] = 744,
    ["Power Pages Configuration"] = 1305,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1250,
    ...
    Pylock = 1296,
    Pyright = 792,
    ["Python script metadata"] = 1290,
    ["QType AI DSL"] = 795,
    Qgoda = 794,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1369,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1367,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1373,
    ["Qlik Talend Cloud Pipeline - Project"] = 1365,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1368,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1370,
    ["Qlik Talend Cloud Pipeline - Task"] = 1366,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1372,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1371,
    Qodana = 1117,
    ["Qt Creator workspace file"] = 1227,
    ["Quali Torque Blueprint Spec 2"] = 1142,
    ["QueryFirst config file"] = 1161,
    ["QuikRun Configuration"] = 1374,
    ["Qwen Code Settings"] = 1354,
    ["RKE Cluster Configuration JSON"] = 1095,
    ["RKE Cluster Configuration YAML"] = 1094,
    RadioHound = 785,
    ["Raid Profile"] = 1355,
    ["Raid Repo Configuration"] = 1356,
    Railpack = 797,
    Railway = 796,
    ["Rancher Fleet"] = 787,
    ["Rattler-build"] = 798,
    ...
    ReleaseKit = 8,
    ["Render Blueprints"] = 1093,
    RenderCV = 824,
    Renovate = 821,
    ["Renovate global configuration"] = 822,
    ["Renovate inherited configuration"] = 823,
    ["Replit config"] = 813,
    Restate = 1283,
    ["Revel Digital Gadget Definition File"] = 1307,
    RoadRunner = 826,
    ["Robust Station Image"] = 1313,
    Rockcraft = 827,
    ["Roo Coder Custom Modes"] = 828,
    Rubocop = 817,
    ["Rudder techniques"] = 1201,
    Ruff = 818,
    ["Rust Project"] = 819,
    ["Rust toolchain"] = 833,
    ["SDMX data message"] = 860,
    ["SDMX metadata message"] = 859,
    ["SDMX structure message"] = 858,
    ["SIL Kit Participant Configuration"] = 871,
    ["SIL Kit Registry Configuration"] = 872,
    ["SPDX 2.3"] = 911,
    SWADL = 927,
    ["Safebox Config"] = 1156,
    ["Sapphire CLI Config"] = 836,
    ["SauceCTL Configuration"] = 1104,
    Scarb = 856,
    ["Schema Catalog"] = 851,
    ["Scoop manifest"] = 857,
    ["Secure SDLC Evidence Bundle"] = 861,
    ["Semantic Data Fabric (SDF) file"] = 862,
    ["Semgrep Rule"] = 864,
    ["Serenity Code Generator (Sergen)"] = 865,
    ["Serverless Framework Configuration"] = 1111,
    ["Serverless Workflow"] = 1113,
    ["Settings for a Cinnamon spice"] = 1246,
    ["Settings.paf"] = 867,
    ["Shopware 6 Configuration"] = 1114,
    ["Shopware CLI Extension Store Configuration"] = 1115,
    ["Shopware CLI Project Store Configuration"] = 1116,
    ["Sigma Detection Rule"] = 869,
    ["SigmaCV CV"] = 4,
    ["Sigrid scope configuration file"] = 870,
    ["SkyPilot Task JSON"] = 1202,
    ["Slack app manifest"] = 874,
    ["Slang Server Configuration"] = 1381,
    Snapcraft = 876,
    ["Solarxy project config"] = 879,
    Solidarity = 880,
    ["Solution filters"] = 881,
    ["Source Maps v3"] = 882,
    Sourcery = 883,
    ["Spack bootstrap.yaml"] = 884,
    ["Spack cdash.yaml"] = 885,
    ["Spack ci.yaml"] = 886,
    ["Spack compilers.yaml"] = 887,
    ["Spack concretizer.yaml"] = 888,
    ["Spack config.yaml"] = 889,
    ["Spack definitions.yaml"] = 890,
    ["Spack develop.yaml"] = 891,
    ["Spack env_vars.yaml"] = 892,
    ["Spack environment"] = 898,
    ["Spack include.yaml"] = 893,
    ["Spack mirrors.yaml"] = 894,
    ["Spack modules.yaml"] = 895,
    ["Spack packages.yaml"] = 896,
    ["Spack repos.yaml"] = 897,
    ["Spack toolchains.yaml"] = 899,
    ["Spack upstreams.yaml"] = 900,
    ["Spack view.yaml"] = 901,
    ["Speakeasy Generation Config File"] = 905,
    ["Speakeasy Lint Configuration File"] = 902,
    ["Speakeasy Test Generation Configuration File"] = 903,
    ["Speakeasy Workflow File"] = 904,
    SpecIF = 906,
    ["Specmatic Configuration"] = 907,
    ["Specpin spec file"] = 2,
    ["Sponge Mixin configuration"] = 908,
    ["Spotlight Ruleset"] = 909,
    StackBlitz = 915,
    ["StackHawk Scanner Configuration"] = 1110,
    Stale = 916,
    Starfish = 917,
    ["Starlake Data Pipeline"] = 1082,
    Starship = 918,
    ["Statamic Blueprint"] = 919,
    ["Stella configuration file"] = 920,
    ["Streamlit configuration file"] = 921,
    ["Stryker Mutator"] = 924,
    ["StyleCop Analyzers Configuration"] = 925,
    ["Stylelint (.stylelintrc)"] = 926,
    ["Stylua Config"] = 1297,
    ["Sublime Syntax"] = 1157,
    ["Subsquid squid manifest"] = 1204,
    ["Swagger API 2.0"] = 928,
    ["Synadia Connect Component"] = 929,
    TSON = 966,
    TSTyche = 967,
    ["TYPO3 Vendor Bundler config"] = 973,
    ["Tab data for a LinUtil"] = 1253,
    ["Tab list for a LinUtil"] = 1252,
    Tach = 930,
    ["Tach Domain"] = 931,
    Talhelper = 933,
    ["Talisman configuration"] = 934,
    Taplo = 1298,
    ["Taskfile config"] = 1087,
    Taurus = 935,
    Tauticord = 936,
    ["Tekton Pipeline"] = 1326,
    ["Tekton PipelineRun"] = 1327,
    ["Tekton Task"] = 1324,
    ["Tekton TaskRun"] = 1325,
    Telefonistka = 1284,
    ["Terrateam config"] = 1310,
    ["TestEnvironment.json"] = 948,
    ["TextMate Grammar"] = 947,
    Threagile = 942,
    ["Tier.run pricing.json"] = 939,
    Tikibase = 940,
    Tombi = 945,
    ["Traefik v2"] = 951,
    ["Traefik v2 File Provider"] = 952,
    ["Traefik v3"] = 953,
    ["Traefik v3 File Provider"] = 954,
    ["Travis CI (.travis.yml)"] = 950,
    Treefmt = 482,
    Trident = 1280,
    Trivy = 957,
    ["TrueScript for *.tscript files"] = 958,
    ["Tugboat QA config.yml"] = 1277,
    TunnelHub = 1192,
    Turborepo = 949,
    Tycho = 1241,
    Tye = 1118,
    ["Tyk Gateway - Open Source v5.7+"] = 1289,
    ["UET BuildConfig.json"] = 1162,
    ["UI5 Manifest"] = 979,
    ["UNCORS configuration"] = 984,
    ["UTAM Page Object"] = 982,
    ["Ubuntu Server Autoinstall"] = 977,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1281,
    ["Uniswap Token List"] = 1067,
    ["Universal Schedule Format"] = 985,
    ["Unreal Engine Uplugin"] = 1163,
    ["Unreal Engine Uproject"] = 1164,
    ["UpCloud CLI (upctl) configuration"] = 1282,
    ["Updatecli Compose"] = 1126,
    ["Updatecli Policy Manifest"] = 1127,
    ["Updatecli Policy Metadata"] = 1128,
    Uplift = 1160,
    ["Upsun config"] = 11,
    ["User Journey Map"] = 1092,
    V2Ray = 1132,
    ["VSCode Code Snippets"] = 277,
    ["VSIX CLI publishing"] = 1003,
    Vector = 987,
    ["Vela Pipeline Configuration"] = 990,
    Vercel = 276,
    ["Version Bumper config"] = 993,
    Vespertide = 1331,
    ["Vespertide Migration"] = 1332,
    ["Vespertide Model"] = 1333,
    ["Viash Component Config"] = 1286,
    ["Viash Package Config"] = 1287,
    Visivo = 1190,
    ["WP-CLI"] = 1013,
    Wake = 1279,
    ["Waku Config"] = 1256,
    ["Web App Manifest"] = 1009,
    ["Web types"] = 1012,
    WebExtensions = 1008,
    ["Webman package recipe"] = 1138,
    ["Windows Package Manager Installer Manifest"] = 1064,
    ["Windows Package Manager Locale Manifest"] = 1065,
    ["Windows Package Manager Singleton Manifest"] = 1063,
    ["WireMock CLI import configuration"] = 1262,
    ["WireMock CLI local service configuration"] = 1261,
    ["WireMock message stub mapping"] = 1260,
    ["WireMock stub mapping"] = 1259,
    ["Woodpecker pipeline config"] = 1106,
    ["Wrangler CLI"] = 1014,
    ["XenForo add-on manifest"] = 1015,
    ["Xstate Machine"] = 1124,
    ["Yandex Workflow Language"] = 1248,
    ["Yarn Config (.yarnrc.yml)"] = 1080,
    ["Yippee-Ki-JSON configuration YML"] = 1071,
    ["YouTrack App"] = 1245,
    ["Zarf Package Configuration"] = 1312,
    ["Zerops import file"] = 1233,
    ["Zola Configuration"] = 1323,
    abtop = 32,
    act3 = 1361,
    actionlint = 42,
    ["aerleon.yml"] = 26,
    ["amplify.yml"] = 19,
    ["amxx-builder manifest"] = 1376,
    ["angular.json"] = 47,
    apko = 1195,
    ...
    ["behat.yml"] = 159,
    ["bigquery-table"] = 147,
    ["bioimageio resource description"] = 1212,
    ...
    ["chutzpah.json"] = 285,
    cibuildwheel = 196,
    ["clang-format (.clang-format)"] = 1130,
    ["clang-tidy"] = 259,
    clangd = 258,
    clib = 260,
    ...
    ["crowdin.yml"] = 312,
    ["ctfd-setup configuration file"] = 1269,
    ["custom-elements.json"] = 1182,
    ["cypress.json"] = 316,
    ["dacier.yml"] = 1364,
    ...
    ["gematik health care insurance list"] = 1275,
    ["gematik health care patient list"] = 1272,
    ["gematik health care provider institution list"] = 1274,
    ["gematik health care provider list"] = 1273,
    ["gematik tiger test environment configuration"] = 1276,
    ["git-cliff"] = 440,
    ["git-town.toml"] = 1321,
    ["gitlab-ci"] = 454,
    ["global.json"] = 471,
    ...
    lychee = 1031,
    ["macro.json"] = 1147,
    ["markdown-link-check"] = 1101,
    maturin = 1102,
    mboats = 1109,
    memnex = 1362,
    ["micro-settings.json"] = 1174,
    ["mimetypes.json"] = 609,
    ["mirrord config"] = 1035,
    ["misata.yaml"] = 1034,
    mise = 1036,
    ["mkdocs.yml"] = 629,
    ["mockd.yaml"] = 633,
    ["mod.pw.toml (packwiz)"] = 1379,
    ["modelparams.dev Model"] = 636,
    ["models CLI"] = 637,
    ["monospace.yml"] = 638,
    ["moon.yml"] = 1258,
    ["mprocs Configuration file"] = 1228,
    ["mrdocs.yml"] = 631,
    ["mta.yaml"] = 1037,
    ["mtad.yaml"] = 1038,
    ["mycode.json"] = 646,
    ...
    ["plagiarize.yaml"] = 736,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1265,
    ["podbard.yaml"] = 739,
    ["portman.json"] = 742,
    ["prefect.toml"] = 751,
    ["prefect.yaml"] = 752,
    ...
    ["rc3 settings"] = 804,
    ["registry.yaml"] = 60,
    ["release drafter"] = 1051,
    ["release-hub.json"] = 7,
    ["release-please-config.json"] = 809,
    ["release-please-manifest.json"] = 810,
    ["release-plz.toml"] = 811,
    ["renv.lock"] = 825,
    ["reposets Configuration"] = 814,
    ["reposets Credentials"] = 815,
    ["revola.json"] = 5,
    ["rivet.json"] = 1199,
    ["rivet.yaml (legacy)"] = 1198,
    rumdl = 830,
    runny = 829,
    runspec = 1363,
    rustfmt = 831,
    ...
    samt = 834,
    samtrc = 835,
    ["sarif-1.0.0.json"] = 837,
    ["sarif-2.0.0.json"] = 838,
    ["sarif-2.1.0"] = 848,
    ["sarif-2.1.0-rtm.2"] = 839,
    ["sarif-2.1.0-rtm.3"] = 841,
    ["sarif-2.1.0-rtm.4"] = 843,
    ["sarif-2.1.0-rtm.5"] = 845,
    ["sarif-2.1.0-rtm.6"] = 846,
    ["sarif-external-property-file-2.1.0"] = 849,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 840,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 842,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 844,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 847,
    ["scalingo.json configuration"] = 850,
    ["schema.org - Action"] = 852,
    ["schema.org - ContactPoint"] = 853,
    ["schema.org - Place"] = 854,
    ["schema.org - Thing"] = 855,
    ["secrethub.yml"] = 1177,
    ["semantic-release"] = 863,
    ["servicehub.config.json"] = 1026,
    ["servicehub.service.json"] = 1025,
    ["settings.job"] = 866,
    ["sfdx-hardis configuration"] = 868,
    ["shard.yml"] = 1215,
    ["size-limit configuration"] = 873,
    ["skaffold.yaml"] = 1099,
    ["skyuxconfig.json"] = 875,
    ["snowflake-config"] = 877,
    ["snowflake-connections"] = 878,
    ["spicepod.yaml"] = 1236,
    ["sqlc configuration"] = 912,
    ["stripe-app-local.json"] = 923,
    ["stripe-app.json"] = 922,
    swcrc = 1083,
    ["task.json"] = 932,
    taskcat = 1046,
    ["template.json"] = 937,
    ["templatsources.json"] = 938,
    ["text2confl config"] = 1346,
    ["theme.json"] = 941,
    ["tizen_workspace.json"] = 943,
    tldr = 944,
    ["tm_devices configuration file"] = 1303,
    tmuxinator = 1029,
    tox = 946,
    ["transcend.yml"] = 955,
    ...
    ["vega-lite.json"] = 989,
    ["vega.json"] = 988,
    ["venvironment.yaml"] = 991,
    ["venvplus.yaml"] = 992,
    version = 1285,
    ["version.json"] = 994,
    ["vhwdebugger-binding.yaml"] = 996,
    ["vim-addon-info"] = 997,
    ["vs-2017.3.host.json"] = 999,
    ["vs-nesting.json"] = 1000,
    ["vsls.json"] = 998,
    ["vss-extension.json"] = 1004,
    vtcfg = 1291,
    ["vtesttree.yaml"] = 1005,
    ["vtestunit.yaml"] = 1006,
    ["warp-keysets.json"] = 1183,
    ["warp-themes.json"] = 1184,
    ["warp-workflows.json"] = 1185,
    ["webhint.io"] = 1139,
    ["webjobpublishsettings.json"] = 1011,
    ["webjobs-list.json"] = 1010,
    ["well-known-fursona"] = 1223,
    ["xs-app.json"] = 1041,
    ["xunit.runner.json"] = 1024,
    yamlfmt = 1068,
    yamllint = 1069,
    ["yap.json"] = 1070,
    ["zerops.yml"] = 1232,
