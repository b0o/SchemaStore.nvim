...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 212,
    [".cryproj (generic)"] = 689,
    [".cryproj engine-5.2"] = 684,
    [".cryproj engine-5.3"] = 685,
    [".cryproj engine-5.4"] = 686,
    [".cryproj engine-5.5"] = 687,
    [".cryproj engine-dev"] = 688,
    [".eslintrc"] = 269,
    [".esmrc.json"] = 260,
    [".ffizer.yaml"] = 273,
    [".htmlhintrc"] = 330,
    ...
    [".pmbot.yml"] = 483,
    [".postcssrc"] = 488,
    [".powerpages-web-template-manifest"] = 490,
    [".pre-commit-config.yml"] = 491,
    [".pre-commit-hooks.yml"] = 492,
    [".putout.json"] = 513,
    [".rehyperc"] = 532,
    [".remarkrc"] = 534,
    [".sprite files"] = 592,
    ...
    ["Adobe UXP Manifest"] = 857,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 15,
    ["Airplane task"] = 16,
    ["Alacritty Configuration"] = 764,
    ["All Contributors configuration file"] = 822,
    ...
    ["Azure Pipelines"] = 69,
    ["Azure Static Web Apps CLI configuration file"] = 595,
    ["Azure Static Web Apps configuration file"] = 594,
    ["BX CI"] = 107,
    ["Bashly (bashly.yml)"] = 826,
    ["Bashly Settings (bashly-settings.yml)"] = 827,
    ["Better Code Hub"] = 736,
    ["Better Scripts"] = 108,
    Bigconfig = 86,
    BizTalkServerApplicationSchema = 706,
    Bleep = 109,
    ...
    ["Butane Config"] = 777,
    ["CGS Custom Card Game (CardGameDef.json)"] = 862,
    ["CICS TS region tagging"] = 786,
    ["CICS TS resource import"] = 787,
    ["CICS TS resource model"] = 788,
    ["CICS TS resource overrides"] = 789,
    ["CMake Presets"] = 110,
    ["CNC Codes"] = 123,
    ...
    CityJSON = 120,
    ["Clawject config"] = 128,
    ["Cloud Foundry Application Manifest"] = 874,
    ["Code Climate"] = 157,
    CodeCV = 65,
    CodeRabbit = 64,
    ...
    ["Configu .cfgu files"] = 879,
    ["Configu .configu file"] = 880,
    Conjure = 122,
    ["Container Structure Test"] = 719,
    Containerlab = 744,
    ["Crowdsec collection config"] = 208,
    ["Crowdsec parser config"] = 209,
    ["Crowdsec scenario config"] = 210,
    ["CumulusCI Config"] = 127,
    ["Custom Machinery Machine"] = 863,
    ["Custom Machinery Recipe"] = 864,
    ...
    ["DataYoga Job"] = 132,
    ["Databricks Asset Bundles"] = 843,
    ["Datadog Service Definition"] = 374,
    ["Datahub Ingestion Recipe"] = 793,
    ["Dein Config"] = 134,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 834,
    ["EAS config"] = 267,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 823,
    ...
    ["Goreleaser Pro"] = 311,
    Goss = 312,
    ["Gradle Build Cache Node"] = 734,
    ["Gradle Enterprise"] = 733,
    ...
    Hadolint = 715,
    Hammerkit = 743,
    ["Hardware Sentry Configuration"] = 797,
    Hatch = 716,
    Hayson = 325,
    ...
    ["JFrog File Spec"] = 353,
    ["JFrog Pipelines YML DSL"] = 806,
    ["JMeter DSL cli config"] = 354,
    JReleaser = 356,
    ["JSON Document Transform"] = 364,
    ["JSON Feed"] = 365,
    ["JSON Resume"] = 539,
    ["JSON Schema Draft 2020-12"] = 680,
    ["JSON Schema Draft 4"] = 677,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 844,
    ["JSON Schema Draft 7"] = 678,
    ["JSON Schema Draft 7 (unofficial strict)"] = 845,
    ["JSON Schema Draft 8 (2019-09)"] = 679,
    ["JSON-API"] = 363,
    ["JSON-WF"] = 873,
    ["JSON-e templates"] = 741,
    ["JSON-stat 2.0"] = 674,
    JSONPatch = 367,
    ...
    Kas = 370,
    ["Keycloak REST API"] = 814,
    ["Knative Functions - func.yaml"] = 286,
    ["KoDE/CI build.yaml"] = 802,
    ["Kong DBLess config"] = 803,
    KrakenD = 373,
    ...
    ["Micro Editor Syntax"] = 835,
    ["Microsoft Band Web Tile"] = 405,
    ["Minecraft Custom Main Menu Mod"] = 852,
    ...
    ["MkDocs Configuration 1.0"] = 426,
    ["Monade CLI Stack Configuration"] = 434,
    ["MongoDB Atlas Search Index Definition"] = 801,
    ["Monika Configuration"] = 799,
    ["Monoweave Configuration"] = 429,
    ["Motif config"] = 699,
    ["NOX Framework (Service)"] = 446,
    ["Netin Diagnostic System Template"] = 759,
    ["Netlify config"] = 437,
    ...
    ["OSS Review Toolkit configuration"] = 469,
    ["OSS Review Toolkit curation"] = 470,
    ["OSS Review Toolkit package configuration"] = 471,
    ["OSS Review Toolkit repository configuration"] = 472,
    ["OSS Review Toolkit resolutions"] = 473,
    Opctl = 702,
    ["OpenRewrite Resource"] = 464,
    ["OpenUtau character yaml"] = 458,
    ["OpenUtau ustx"] = 459,
    ["OpenWeather Current Weather API"] = 740,
    ["OpenWeather Road Risk API"] = 739,
    ["Ory Hydra configuration"] = 332,
    ["Ory Keto configuration"] = 375,
    ["Ory Kratos configuration"] = 468,
    ["Ory Oathkeeper configuration"] = 453,
    ["Outblocks App configuration"] = 466,
    ["Outblocks database table"] = 467,
    ["Outblocks project configuration"] = 465,
    PDM = 479,
    Packer = 476,
    Pantsbuild = 821,
    ["Paper paper-plugin.yml"] = 477,
    ["Pipeline component"] = 751,
    ["PocketMine plugin.yml"] = 484,
    ["Postman collection"] = 489,
    ["Problem object RFC9457"] = 849,
    ["Problem package generators"] = 497,
    Pterodactyl = 796,
    ["Pull Request Labeler"] = 512,
    Pulumi = 518,
    PyProject = 519,
    Pyright = 520,
    Qgoda = 521,
    Qodana = 769,
    ["Qt Creator workspace file"] = 881,
    ["Quali Torque Blueprint Spec 2"] = 794,
    ["QueryFirst config file"] = 817,
    ["RKE Cluster Configuration JSON"] = 748,
    ["RKE Cluster Configuration YAML"] = 747,
    ["Rancher Fleet"] = 515,
    ["Rattler-build"] = 522,
    Ray = 714,
    ["Read the Docs"] = 517,
    ["Red-DiscordBot Cog"] = 529,
    ["Red-DiscordBot Cog Repo"] = 530,
    ["Red-DiscordBot Trivia"] = 531,
    ["Render Blueprints"] = 746,
    RenderCV = 541,
    Renovate = 540,
    ["Replit config"] = 535,
    RoadRunner = 542,
    ["Rudder techniques"] = 855,
    Ruff = 537,
    ["Rust Project"] = 538,
    ["Rust toolchain"] = 545,
    ["SDMX data message"] = 570,
    ["SDMX metadata message"] = 569,
    ["SDMX structure message"] = 568,
    ["SIL Kit Participant Configuration"] = 580,
    ["SIL Kit Registry Configuration"] = 581,
    SWADL = 606,
    ["Safebox Config"] = 807,
    ["Sapphire CLI Config"] = 548,
    ["SauceCTL Configuration"] = 756,
    ["Schema Catalog"] = 562,
    ["Scoop manifest"] = 567,
    ["Semantic Data Fabric (SDF) file"] = 571,
    ["Semgrep Rule"] = 573,
    ["Serenity Code Generator (Sergen)"] = 574,
    ["Serverless Framework Configuration"] = 763,
    ["Serverless Workflow"] = 765,
    ["Settings.paf"] = 576,
    ["Shopware 6 Configuration"] = 766,
    ["Shopware CLI Extension Store Configuration"] = 767,
    ["Shopware CLI Project Store Configuration"] = 768,
    Sigma = 578,
    ["Sigrid scope configuration file"] = 579,
    ["SkyPilot Task JSON"] = 856,
    ["Slack app manifest"] = 583,
    Solidarity = 586,
    ["Solution filters"] = 587,
    ["Source Maps v3"] = 588,
    Sourcery = 589,
    SpecIF = 590,
    ["Sponge Mixin configuration"] = 591,
    StackBlitz = 596,
    ["StackHawk Scanner Configuration"] = 762,
    Stale = 597,
    ["Starlake Data Pipeline"] = 737,
    Starship = 598,
    ["Statamic Blueprint"] = 599,
    ["Stella configuration file"] = 600,
    ["StrmPrivacy Data Connector"] = 811,
    ["StrmPrivacy Data Contract"] = 812,
    ["StrmPrivacy SimpleSchema"] = 809,
    ["StrmPrivacy Stream"] = 810,
    ["StrmPrivacy batch job configuration file"] = 808,
    ["Stryker Mutator"] = 603,
    ["StyleCop Analyzers Configuration"] = 604,
    ["Stylelint (.stylelintrc)"] = 605,
    ["Sublime Syntax"] = 813,
    ["Subsquid squid manifest"] = 858,
    ["Swagger API 2.0"] = 607,
    TSON = 633,
    TSTyche = 634,
    Talhelper = 609,
    ["Talisman configuration"] = 610,
    ["Taskfile config"] = 742,
    Taurus = 611,
    ["TestEnvironment.json"] = 620,
    ["TextMate Grammar"] = 619,
    ["Tier.run pricing.json"] = 614,
    Tikibase = 615,
    ["Traefik v2"] = 623,
    ["Traefik v2 File Provider"] = 624,
    ["Travis CI (.travis.yml)"] = 622,
    TunnelHub = 848,
    Turborepo = 621,
    Tye = 770,
    ["UET BuildConfig.json"] = 818,
    ["UI5 Manifest"] = 643,
    ["UNCORS configuration"] = 647,
    ["UTAM Page Object"] = 646,
    ["Ubuntu Server Autoinstall"] = 641,
    ["Uniswap Token List"] = 725,
    ["Unreal Engine Uplugin"] = 819,
    ["Unreal Engine Uproject"] = 820,
    ["Updatecli Compose"] = 778,
    ["Updatecli Policy Manifest"] = 779,
    ["Updatecli Policy Metadata"] = 780,
    Uplift = 816,
    ["User Journey Map"] = 745,
    V2Ray = 784,
    ["VSCode Code Snippets"] = 174,
    ["VSIX CLI publishing"] = 662,
    ["Vela Pipeline Configuration"] = 651,
    Vercel = 173,
    Visivo = 846,
    ["Web App Manifest"] = 669,
    ["Web types"] = 672,
    WebExtensions = 668,
    ["Webman package recipe"] = 790,
    ["Windows Package Manager Installer Manifest"] = 722,
    ["Windows Package Manager Locale Manifest"] = 723,
    ["Windows Package Manager Singleton Manifest"] = 721,
    ["Woodpecker pipeline config"] = 758,
    ["Wrangler CLI"] = 673,
    ["Xstate Machine"] = 776,
    ["Yarn Config (.yarnrc.yml)"] = 735,
    ["Yippee-Ki-JSON configuration YML"] = 727,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 850,
    ...
    ["behat.yml"] = 93,
    ["bigquery-table"] = 85,
    ["bioimageio resource description"] = 866,
    ...
    ["lint-staged (.lintstagedrc)"] = 693,
    ["local.settings.json"] = 395,
    ["localazy.json"] = 396,
    ["lotus.yaml"] = 394,
    ["lsdlschema.json"] = 397,
    ["markdown-link-check"] = 754,
    mboats = 761,
    ["micro-settings.json"] = 830,
    ["mimetypes.json"] = 406,
    ["mirrord config"] = 694,
    mise = 695,
    ["mise-settings"] = 696,
    ...
    ["ops.yaml"] = 460,
    ["package.json"] = 474,
    ["package.manifest"] = 475,
    ["partial-black.json"] = 94,
    ["pathfinder.yml"] = 478,
    ["pattern.json"] = 481,
    ["petstore-v1.0"] = 805,
    pgap_yaml_input_reader = 480,
    ["pixi.toml"] = 482,
    ["plagiarize-me.yaml"] = 486,
    ["plagiarize.yaml"] = 485,
    ["portman.json"] = 487,
    ["prettierrc.json"] = 495,
    ["prisma.yml"] = 496,
    ["project-1.0.0-beta3.json"] = 499,
    ["project-1.0.0-beta4.json"] = 500,
    ["project-1.0.0-beta5.json"] = 501,
    ["project-1.0.0-beta6.json"] = 502,
    ["project-1.0.0-beta8.json"] = 503,
    ["project-1.0.0-rc1.json"] = 504,
    ["project-1.0.0-rc2.json"] = 505,
    ["project.json"] = 498,
    ["prometheus.json"] = 506,
    ["prometheus.rules.json"] = 507,
    ["prometheus.rules.test.json"] = 508,
    ["proxies.json"] = 509,
    ["publiccode.yml"] = 510,
    ["pubspec.yaml"] = 511,
    ["pyrseas-0.8.json"] = 514,
    ["quilt.mod.json"] = 831,
    ["rc3 auth"] = 523,
    ["rc3 collection"] = 524,
    ["rc3 environment"] = 525,
    ...
    ["rc3 settings"] = 528,
    ["release drafter"] = 709,
    ["release-plz.toml"] = 533,
    ["rivet.yaml"] = 853,
    rockcraft = 543,
    rustfmt = 544,
    samt = 546,
    samtrc = 547,
    ["sarif-1.0.0.json"] = 549,
    ["sarif-2.0.0.json"] = 550,
    ["sarif-2.1.0"] = 560,
    ["sarif-2.1.0-rtm.2"] = 551,
    ["sarif-2.1.0-rtm.3"] = 553,
    ["sarif-2.1.0-rtm.4"] = 555,
    ["sarif-2.1.0-rtm.5"] = 557,
    ["sarif-2.1.0-rtm.6"] = 558,
    ["sarif-external-property-file-2.1.0"] = 561,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 552,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 554,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 556,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 559,
    ["schema.org - Action"] = 563,
    ["schema.org - ContactPoint"] = 564,
    ["schema.org - Place"] = 565,
    ["schema.org - Thing"] = 566,
    ["secrethub.yml"] = 833,
    ["semantic-release"] = 572,
    ["servicehub.config.json"] = 683,
    ["servicehub.service.json"] = 682,
    ["settings.job"] = 575,
    ["sfdx-hardis configuration"] = 577,
    ["shard.yml"] = 869,
    ["size-limit configuration"] = 582,
    ["skaffold.yaml"] = 752,
    ["skyuxconfig.json"] = 584,
    snapcraft = 585,
    ["sqlc configuration"] = 593,
    ["stripe-app-local.json"] = 602,
    ["stripe-app.json"] = 601,
    swcrc = 738,
    ["task.json"] = 608,
    taskcat = 705,
    ["template.json"] = 612,
    ["templatsources.json"] = 613,
    ["theme.json"] = 616,
    ["tizen_workspace.json"] = 617,
    tldr = 618,
    tmuxinator = 691,
    ["transcend.yml"] = 625,
    ...
    ["vega-lite.json"] = 650,
    ["vega.json"] = 649,
    ["venvironment-basic.yaml"] = 653,
    ["venvironment.yaml"] = 652,
    ["version.json"] = 654,
    ["vim-addon-info"] = 656,
    ["vs-2017.3.host.json"] = 658,
    ["vs-nesting.json"] = 659,
    ["vsls.json"] = 657,
    ["vss-extension.json"] = 663,
    ["vtesttree.yaml"] = 664,
    ["vtestunit.yaml"] = 665,
    ["warp-keysets.json"] = 839,
    ["warp-themes.json"] = 840,
    ["warp-workflows.json"] = 841,
    ["webhint.io"] = 791,
    ["webjobpublishsettings.json"] = 671,
    ["webjobs-list.json"] = 670,
    ["well-known-fursona"] = 877,
    ["xs-app.json"] = 701,
    ["xunit.runner.json"] = 681,
    yamllint = 726,
    zuul = 710,
    ["Žinoma"] = 720
  },
