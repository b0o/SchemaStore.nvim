...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 153,
    [".cryproj (generic)"] = 511,
    [".cryproj engine-5.2"] = 506,
    [".cryproj engine-5.3"] = 507,
    [".cryproj engine-5.4"] = 508,
    [".cryproj engine-5.5"] = 509,
    [".cryproj engine-dev"] = 510,
    [".csscomb.json"] = 155,
    [".csslintrc"] = 156,
    [".eslintrc"] = 201,
    [".esmrc.json"] = 193,
    ...
    [".mtaext"] = 520,
    [".nodehawkrc"] = 323,
    [".npmpackagejsonlintrc"] = 326,
    [".phraseapp.yml"] = 361,
    [".pmbot.yml"] = 353,
    [".postcssrc"] = 358,
    [".pre-commit-config.yml"] = 359,
    [".pre-commit-hooks.yml"] = 360,
    [".putout.json"] = 378,
    [".rehyperc"] = 386,
    [".remarkrc"] = 387,
    [".sprite files"] = 431,
    ...
    ["Azure Pipelines"] = 48,
    ["Azure Static Web Apps CLI configuration file"] = 433,
    ["Azure Static Web Apps configuration file"] = 432,
    ["BX CI"] = 83,
    ["Better Code Hub"] = 554,
    ["Better Scripts"] = 84,
    BizTalkServerApplicationSchema = 526,
    ...
    ["Butane Config"] = 592,
    ["CICS TS region tagging"] = 599,
    ["CICS TS resource import"] = 600,
    ["CICS TS resource model"] = 601,
    ["CICS TS resource overrides"] = 602,
    ["CMake Presets"] = 85,
    ...
    ["Datahub Ingestion Recipe Schema"] = 606,
    ...
    ["Embrace Config Schema"] = 617,
    ["Error pages"] = 196,
    Esquio = 194,
    ["Estuary Flow Catalog Schema"] = 596,
    ["Expo SDK"] = 199,
    ...
    Goreleaser = 227,
    ["Goreleaser Pro"] = 228,
    ["Gradle Build Cache Node"] = 551,
    ["Gradle Enterprise"] = 550,
    ...
    Hadolint = 535,
    Hammerkit = 561,
    ["Hardware Sentry Configuration"] = 610,
    Hayson = 240,
    ...
    ["JFrog File Spec"] = 260,
    ["JFrog Pipelines YML DSL"] = 619,
    ["JSON Document Transform"] = 268,
    ["JSON Feed"] = 269,
    ["JSON Resume"] = 392,
    ["JSON Schema Draft 2020-12"] = 502,
    ["JSON Schema Draft 4"] = 499,
    ["JSON Schema Draft 7"] = 500,
    ["JSON Schema Draft 8"] = 501,
    ...
    ["KSP-AVC"] = 497,
    ["KSP-CKAN"] = 498,
    ["Keycloak REST API"] = 625,
    ["Knative Functions - func.yaml"] = 211,
    ["KoDE/CI build.yaml"] = 615,
    ["Kong DBLess Schema"] = 616,
    KrakenD = 274,
    ["LinkML Metamodel"] = 287,
    Liquibase = 566,
    ["Liquibase Flow File"] = 567,
    ...
    ["Minecraft Data Pack Dimension"] = 303,
    ["Minecraft Data Pack Dimension Type"] = 302,
    ["Minecraft Data Pack Item Modifier"] = 304,
    ["Minecraft Data Pack Loot Table"] = 305,
    ["Minecraft Data Pack Metadata"] = 306,
    ["Minecraft Data Pack Predicate"] = 307,
    ["Minecraft Data Pack Recipe"] = 308,
    ["Minecraft Data Pack Tag"] = 309,
    ["Minecraft Data Pack Template Pool"] = 310,
    ["Minecraft Resourcepack Sounds"] = 311,
    ["MkDocs Configuration 1.0"] = 312,
    ["MongoDB Atlas Search Index Definition Schema"] = 614,
    ["Monika Configuration Schema"] = 612,
    ["Motif config"] = 519,
    ["NOX Framework (Service)"] = 325,
    ["Netin Diagnostic System Template"] = 575,
    ["Netlify config schema"] = 317,
    ["Nightwatch.js"] = 318,
    ["OSS Review Toolkit configuration"] = 343,
    ["OSS Review Toolkit curation"] = 344,
    ["OSS Review Toolkit package configuration"] = 345,
    ["OSS Review Toolkit repository configuration"] = 346,
    ["OSS Review Toolkit resolutions"] = 347,
    Opctl = 522,
    ["OpenRewrite Resource"] = 338,
    ["OpenWeather Current Weather API"] = 558,
    ["OpenWeather Road Risk API"] = 557,
    ["Ory Hydra configuration"] = 246,
    ["Ory Keto configuration"] = 276,
    ["Ory Kratos configuration"] = 342,
    ["Ory Oathkeeper configuration"] = 332,
    ["Outblocks App configuration"] = 340,
    ["Outblocks database table"] = 341,
    ["Outblocks project configuration"] = 339,
    Packer = 350,
    Pantsbuild = 631,
    ["Pipeline component"] = 568,
    ["PocketMine plugin.yml"] = 354,
    Pterodactyl = 609,
    ["Pull Request Labeler"] = 377,
    Pulumi = 382,
    PyProject = 383,
    Qodana = 585,
    ["Quali Torque Blueprint Spec 2"] = 607,
    ["QueryFirst config file"] = 628,
    ["RKE Cluster Configuration JSON Schema"] = 565,
    ["RKE Cluster Configuration YAML Schema"] = 564,
    ["Rancher Fleet"] = 380,
    Ray = 534,
    ["Read the Docs"] = 381,
    ["Red-DiscordBot Cog"] = 384,
    ["Red-DiscordBot Cog Repo"] = 385,
    Renovate = 393,
    ["Replit schema"] = 388,
    RoadRunner = 394,
    Ruff = 390,
    ["Rust Project"] = 391,
    ["Rust toolchain"] = 396,
    ["SIL Kit Participant Configuration"] = 421,
    SWADL = 442,
    ["Sapphire CLI Config"] = 397,
    ["SauceCTL Configuration"] = 572,
    ["Schema Catalog"] = 410,
    ["Scoop manifest"] = 415,
    ["Semgrep Rule"] = 417,
    ["Serverless Framework Configuration"] = 579,
    ["Serverless Workflow Schema"] = 581,
    ["Settings.paf"] = 419,
    ["Shopware 6 Configuration"] = 582,
    ["Shopware CLI Extension Store Configuration"] = 583,
    ["Shopware CLI Project Store Configuration"] = 584,
    Solidarity = 425,
    ["Solution filters"] = 426,
    ["Source Maps v3"] = 427,
    Sourcery = 428,
    SpecIF = 429,
    ["Sponge Mixin configuration"] = 430,
    ["StackHawk Scanner Configuration"] = 578,
    Stale = 434,
    Starship = 435,
    ["Statamic Blueprint"] = 436,
    ["StrmPrivacy Data Connector"] = 623,
    ["StrmPrivacy Data Contract"] = 624,
    ["StrmPrivacy SimpleSchema"] = 621,
    ["StrmPrivacy Stream"] = 622,
    ["StrmPrivacy batch job configuration file"] = 620,
    ["Stryker Mutator"] = 439,
    ["StyleCop Analyzers Configuration"] = 440,
    ["Swagger API 2.0"] = 443,
    TSON = 464,
    ["Talisman configuration"] = 444,
    ["Taskfile YAML Schema"] = 560,
    Taurus = 445,
    ["TestEnvironment.json"] = 453,
    ["Tier.run pricing.json"] = 448,
    Tikibase = 449,
    ["Traefik v2"] = 456,
    ["Traefik v2 File Provider"] = 457,
    Turborepo = 454,
    Tye = 586,
    ["UI5 Manifest"] = 471,
    ["UTAM Page Object"] = 474,
    ["Ubuntu Server Autoinstall"] = 469,
    ["Uniswap Token List"] = 543,
    ["Unreal Engine Uplugin"] = 629,
    ["Unreal Engine Uproject"] = 630,
    Updatecli = 593,
    Uplift = 627,
    ["User Journey Map YAML Schema"] = 563,
    V2Ray = 597,
    ["VSCode Code Snippets"] = 129,
    ["VSIX CLI publishing"] = 487,
    ["Vela Pipeline Configuration"] = 477,
    Vercel = 128,
    ["Web App Manifest"] = 492,
    ["Web types"] = 495,
    WebExtensions = 491,
    ["Webman package recipe"] = 603,
    ["Windows Package Manager Installer Manifest"] = 540,
    ["Windows Package Manager Locale Manifest"] = 541,
    ["Windows Package Manager Singleton Manifest"] = 539,
    ["Woodpecker pipeline config"] = 574,
    ["Xstate Machine Schema"] = 591,
    ["Yippee-Ki-JSON configuration YML"] = 545,
    ["angular.json"] = 11,
    ...
    ["ize.toml"] = 626,
    ["jsconfig.json"] = 272,
    ["jscpd Configuration Schema"] = 608,
    jsdoc = 533,
    ["k3d.yaml"] = 273,
    ...
    ["mtad.yaml"] = 518,
    ["mycode.json"] = 315,
    ["napari plugin manifest"] = 316,
    neoload = 528,
    ["nest-cli"] = 321,
    ["ninjs (News in JSON) 1.3"] = 320,
    ["ninjs (News in JSON) 2.0"] = 319,
    ["nlu.json"] = 322,
    ["nodemon.json"] = 324,
    ["noodl.schema.json"] = 576,
    now = 524,
    ["npm-badges"] = 327,
    ["nswag.json"] = 330,
    ntangle = 331,
    ["nuclei-template.yaml"] = 328,
    ["nuget-project.json"] = 329,
    ["ocelot.json"] = 333,
    ["omnisharp.json"] = 334,
    ["openapi.json"] = 335,
    ["openfin.json"] = 337,
    ["openrpc.json"] = 336,
    ["package.json"] = 348,
    ["package.manifest"] = 349,
    ["pattern.json"] = 352,
    ["petstore-v1.0"] = 618,
    pgap_yaml_input_reader = 351,
    ["plagiarize-me.yaml"] = 356,
    ["plagiarize.yaml"] = 355,
    ["portman.json"] = 357,
    ["prettierrc.json"] = 362,
    ["prisma.yml"] = 363,
    ["project-1.0.0-beta3.json"] = 365,
    ["project-1.0.0-beta4.json"] = 366,
    ["project-1.0.0-beta5.json"] = 367,
    ["project-1.0.0-beta6.json"] = 368,
    ["project-1.0.0-beta8.json"] = 369,
    ["project-1.0.0-rc1.json"] = 370,
    ["project-1.0.0-rc2.json"] = 371,
    ["project.json"] = 364,
    ["prometheus.json"] = 372,
    ["prometheus.rules.json"] = 373,
    ["proxies.json"] = 374,
    ["publiccode.yml"] = 375,
    ["pubspec.yaml"] = 376,
    ["pyrseas-0.8.json"] = 379,
    ["release drafter"] = 529,
    rustfmt = 395,
    ["sarif-1.0.0.json"] = 398,
    ["sarif-2.0.0.json"] = 399,
    ["sarif-2.1.0"] = 408,
    ["sarif-2.1.0-rtm.2"] = 400,
    ["sarif-2.1.0-rtm.3"] = 402,
    ["sarif-2.1.0-rtm.4"] = 404,
    ["sarif-2.1.0-rtm.5"] = 406,
    ["sarif-external-property-file-2.1.0"] = 409,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 401,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 403,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 405,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 407,
    ["schema.org - Action"] = 411,
    ["schema.org - ContactPoint"] = 412,
    ["schema.org - Place"] = 413,
    ["schema.org - Thing"] = 414,
    ["semantic-release"] = 416,
    ["servicehub.config.json"] = 505,
    ["servicehub.service.json"] = 504,
    ["settings.job"] = 418,
    ["sfdx-hardis configuration"] = 420,
    ["size-limit configuration"] = 422,
    ["skaffold.yaml"] = 569,
    ["skyuxconfig.json"] = 423,
    snapcraft = 424,
    ["stripe-app-local.json"] = 438,
    ["stripe-app.json"] = 437,
    swcrc = 556,
    taskcat = 525,
    ["template.json"] = 446,
    ["templatsources.json"] = 447,
    ["theme.json"] = 450,
    ["tizen_workspace.json"] = 451,
    tmLanguage = 452,
    tmuxinator = 513,
    ["trunk.yaml schema"] = 458,
    ["ts-force-config.json"] = 462,
    ["tsconfig.json"] = 459,
    ["tsd.json"] = 460,
    ["tsdrc.json"] = 461,
    ["tslint.json"] = 463,
    ...
    ["vega-lite.json"] = 476,
    ["vega.json"] = 475,
    ["venvironment-basic.yaml"] = 479,
    ["venvironment.yaml"] = 478,
    ["version.json"] = 480,
    ["vim-addon-info"] = 481,
    ["vs-2017.3.host.json"] = 483,
    ["vs-nesting.json"] = 484,
    ["vsls.json"] = 482,
    ["vss-extension.json"] = 488,
    ["webhint.io"] = 604,
    ["webjobpublishsettings.json"] = 494,
    ["webjobs-list.json"] = 493,
    ["xs-app.json"] = 521,
    ["xunit.runner.json"] = 503,
    yamllint = 544,
    zuul = 530,
    ["Žinoma"] = 538
  },
