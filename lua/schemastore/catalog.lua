...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 918,
    [".nodehawkrc"] = 566,
    [".npmpackagejsonlintrc"] = 570,
    [".omletrc"] = 1097,
    [".phrase.yml"] = 641,
    [".phraseapp.yml"] = 642,
    [".pmbot.yml"] = 627,
    [".postcssrc"] = 636,
    [".powerpages-web-template-manifest"] = 638,
    [".pre-commit-config.yml"] = 639,
    [".pre-commit-hooks.yml"] = 640,
    [".putout.json"] = 675,
    [".rehyperc"] = 700,
    [".remarkrc"] = 704,
    [".sprite files"] = 795,
    ...
    AIConfig = 31,
    ["AMX Muse Program Descriptor"] = 1145,
    ["API Builder"] = 953,
    ["AVA Configuration"] = 1016,
    ...
    ["AWS Copilot Manifest"] = 1184,
    ["AWS SAM CLI Samconfig"] = 255,
    ["Adobe UXP Manifest"] = 1079,
    ["Aerleon Network & Service Definitions"] = 18,
    ["Aerleon Policy"] = 19,
    Aider = 1174,
    Air = 21,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1195,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1194,
    ["Airlock Microgateway"] = 32,
    ["Alacritty Configuration"] = 988,
    ["All Contributors configuration file"] = 1042,
    ["Ansible Argument Specs"] = 387,
    ["Ansible Collection Galaxy"] = 394,
    ["Ansible Execution Environment"] = 384,
    ["Ansible Inventory"] = 393,
    ["Ansible Meta"] = 385,
    ["Ansible Meta Runtime"] = 386,
    ["Ansible Navigator Configuration"] = 396,
    ["Ansible Playbook"] = 391,
    ["Ansible Requirements"] = 388,
    ["Ansible Rulebook"] = 392,
    ["Ansible Tasks File"] = 390,
    ["Ansible Vars File"] = 389,
    ["Ansible-lint Configuration"] = 395,
    Any = 1107,
    ...
    ["Application list for a WinUtil"] = 1124,
    ArchitectFX = 1129,
    ["Argo CD"] = 51,
    ["Argo Events"] = 52,
    ["Argo Workflows"] = 53,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1193,
    ["Azure IoT Operations connector metadata"] = 1190,
    ...
    ["Azure Pipelines"] = 107,
    ["Azure Static Web Apps CLI configuration file"] = 799,
    ["Azure Static Web Apps configuration file"] = 798,
    ["BOSH CPI Config"] = 132,
    ["BOSH Deploy Config"] = 133,
    ["BX CI"] = 152,
    ["Bacon config"] = 3,
    ["Bashly (bashly.yml)"] = 1046,
    ["Bashly Settings (bashly-settings.yml)"] = 1047,
    Bento = 1211,
    ["Better Code Hub"] = 958,
    ["Better Scripts"] = 153,
    Bigconfig = 125,
    ["Biome Formatter Config"] = 79,
    ["Bitmovin Encoding Template"] = 1138,
    ...
    ["Butane Config"] = 1001,
    C4InterFlow = 1153,
    ["CDK Environment Manager, concrete environment configuration"] = 1177,
    ["CDK Environment Manager, concrete environments definition"] = 1176,
    ["CDK Environment Manager, environment definition"] = 1175,
    ["CGS Card Game Specification (cgs.json)"] = 1084,
    ["CICS TS region tagging"] = 1010,
    ["CICS TS resource import"] = 1011,
    ["CICS TS resource model"] = 1012,
    ["CICS TS resource overrides"] = 1013,
    ["CMake Presets"] = 155,
    ["CNC Codes"] = 176,
    ["CRS WAF test file"] = 1114,
    ["CRS WAF test platform overrides file"] = 1115,
    ...
    ["Chamaleon environment"] = 1142,
    ["Chamaleon properties"] = 1143,
    ["Chamaleon template"] = 1141,
    Changepacks = 1204,
    Changesets = 264,
    Changie = 164,
    Charmcraft = 165,
    ...
    ["Clawject config"] = 182,
    ["Cloud Foundry Application Manifest"] = 1096,
    ["Cloud Run Spec v1"] = 1119,
    ...
    Concord = 1113,
    ["Configu .cfgu files"] = 1101,
    ["Configu .configu file"] = 1102,
    Conjure = 175,
    ["Container Structure Test"] = 939,
    Containerlab = 967,
    ["Contextive Glossary"] = 1169,
    Convex = 174,
    ["Crowdsec collection config"] = 274,
    ["Crowdsec parser config"] = 275,
    ["Crowdsec scenario config"] = 276,
    ["CumulusCI Config"] = 181,
    ["Custom Machinery Machine"] = 1085,
    ["Custom Machinery Recipe"] = 1086,
    ...
    ["DataYoga Job"] = 189,
    ["Databricks Asset Bundles"] = 1063,
    ["Datadog Continuous Testing"] = 485,
    ["Datadog Service Definition"] = 486,
    ["Datadog Software Catalog"] = 487,
    ["Datahub Ingestion Recipe"] = 1017,
    ...
    ["DonateCaseBetterCasino menu"] = 1146,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1054,
    ["EAS config"] = 340,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1043,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1189,
    ["EasyVCR .NET"] = 341,
    ["Eidolon Resource"] = 1130,
    ["Elgato Stream Deck"] = 326,
    Elm = 1118,
    ["Embrace Config"] = 1029,
    Endurica = 1067,
    ["Enterprise Contract Policy Spec"] = 327,
    ["Erda Pipeline"] = 1092,
    ["Erda Runtime"] = 1093,
    ["Espanso config.yml"] = 1214,
    ["Espanso match.yml"] = 1213,
    Esquio = 329,
    ["Estuary Flow Catalog"] = 1007,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 333,
    ["EveryVoice TTS Toolkit Data Configuration"] = 334,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 338,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 337,
    ["EveryVoice TTS Toolkit Text Configuration"] = 335,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 336,
    ["Evolving Resolutive Process notation"] = 1191,
    ["Expo SDK"] = 339,
    ["F-Droid Data metadata"] = 345,
    ["FasterCI Configuration"] = 108,
    FiQuS = 349,
    Firebase = 347,
    ["FlexGet Config"] = 350,
    ["Flow.json Configurations"] = 1089,
    ["Fossa configuration file"] = 357,
    ["Fossa's fossa-deps file"] = 358,
    ["Foundry VTT - Base package Manifest"] = 352,
    ["Foundry VTT - Module Manifest"] = 353,
    ["Foundry VTT - System Data Template"] = 356,
    ["Foundry VTT - System Manifest"] = 354,
    ["Foundry VTT - World Manifest"] = 355,
    ["Foxx Manifest"] = 109,
    ["Freifunk.de Community API"] = 112,
    ["Frogbot Config"] = 113,
    ["G2P Mapping Configuration"] = 364,
    ["GCP Blueprint Metadata"] = 367,
    Gaspar = 365,
    ["GatewayCore API Gateway"] = 366,
    ["Gemini CLI settings"] = 368,
    ["GeoJSON.json latest"] = 1005,
    GherKing = 1009,
    ["GitHub Action"] = 373,
    ["GitHub Actions typing"] = 1126,
    ["GitHub Discussion"] = 374,
    ["GitHub Funding"] = 375,
    ["GitHub Issue Template configuration"] = 376,
    ["GitHub Issue Template forms"] = 377,
    ["GitHub Workflow"] = 378,
    ["GitHub Workflow Template Properties"] = 379,
    ["GitHub automatically generated release notes configuration"] = 380,
    ["GitLab Agent for Kubernetes configuration"] = 1081,
    GitVersion = 370,
    ["Gitea Issue Template configuration"] = 371,
    ["Gitea Issue Template forms"] = 372,
    ["Gitpod Automations"] = 382,
    ["Gitpod Configuration"] = 383,
    ["GlazeWM settings"] = 1083,
    ["Global Privacy Control"] = 369,
    Goblet = 1062,
    ["Golangci-lint Configuration"] = 398,
    ["Golangci-lint Custom Plugins Configuration"] = 399,
    ["Google Chrome Related Website Sets"] = 348,
    ["Google Cloud Workflows"] = 251,
    ["Google Digital Assetlinks"] = 1170,
    Goreleaser = 401,
    ["Goreleaser Pro"] = 402,
    Goss = 403,
    ["Gradle Build Cache Node"] = 956,
    ["Gradle Enterprise"] = 955,
    ["Grafana 5.x Dashboard"] = 404,
    ["GraphQL Code Generator"] = 409,
    ["GraphQL Config"] = 408,
    ["GraphQL Mesh"] = 407,
    ["GroovyLint configuration"] = 410,
    ["Grunt JSHint task"] = 414,
    ["Grunt Watch task"] = 415,
    ["Grunt base task"] = 416,
    ["Grunt clean task"] = 412,
    ["Grunt copy task"] = 411,
    ["Grunt cssmin task"] = 413,
    HEMTT = 921,
    Hadolint = 935,
    Hammerkit = 966,
    ["Hardware Sentry Configuration"] = 1021,
    ["HashiCorp Vault"] = 417,
    Hatch = 936,
    Hayson = 419,
    ["Haystack Pipeline"] = 420,
    ["Hazelcast 5 Configuration"] = 421,
    ["Hecate Input Schema"] = 1181,
    ["Helm Chart.lock"] = 218,
    ["Helm Chart.yaml"] = 217,
    ["Helm Unittest Test Suite"] = 219,
    ["Home Assistant Integration Manifest"] = 422,
    ["Homer dashboard configuration"] = 423,
    Hugo = 997,
    ["Hugo Theme"] = 996,
    ["Hulak Configuration"] = 430,
    ["Hyperfoil benchmark configuration"] = 429,
    ["IBM Zapp document"] = 431,
    ["IBM zCodeFormatSettings"] = 432,
    ["IMG Catapult PSP"] = 437,
    ["IVMS101 by CODE Protocol"] = 1082,
    Infrahub = 439,
    Istanbul = 1025,
    ["JDownloader2 crawler multi-rules"] = 452,
    ["JDownloader2 crawler single-rules"] = 451,
    ["JFrog Applications Config"] = 453,
    ["JFrog File Spec"] = 454,
    ["JFrog Pipelines YML DSL"] = 1031,
    ["JMeter DSL cli config"] = 455,
    JReleaser = 458,
    ["JSON Document Transform"] = 466,
    ["JSON Feed"] = 467,
    ["JSON Resume"] = 710,
    ["JSON Schema Draft 2020-12"] = 903,
    ["JSON Schema Draft 4"] = 900,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1064,
    ["JSON Schema Draft 7"] = 901,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1065,
    ["JSON Schema Draft 8 (2019-09)"] = 902,
    ["JSON-API"] = 465,
    ["JSON-e templates"] = 963,
    ["JSON-stat 2.0"] = 896,
    JSONPatch = 469,
    ["JSR Package Config (jsr.json)"] = 459,
    Jarl = 1197,
    Jasmine = 446,
    Jekyll = 447,
    ["Jenkins X Pipelines"] = 448,
    ["Jenkins X Requirements"] = 449,
    Jest = 450,
    Jocker = 456,
    ["Jovo Language Models"] = 457,
    ["Jujutsu (jj) VCS config"] = 1183,
    ["KIMMDY config file"] = 480,
    ["KODE/CI build.yaml"] = 1027,
    ["KSP-AVC"] = 897,
    ["KSP-CKAN"] = 898,
    ["KSP-NetKAN"] = 899,
    KSY = 1094,
    KSail = 362,
    ["KYA Manifest"] = 1095,
    ["Karakum configuration file"] = 359,
    Kas = 472,
    ["Kestra flow file"] = 481,
    ["Keycloak REST API"] = 1034,
    ["Knative Functions - func.yaml"] = 360,
    Knip = 361,
    ["Kometa (nightly) config file"] = 483,
    ["Kometa config file"] = 482,
    ["Kong DBLess config"] = 1028,
    KrakenD = 484,
    ["Kubri Configuration"] = 491,
    LOOBin = 506,
    ["Lake configuration file"] = 1186,
    ...
    ["Lando (landofile)"] = 103,
    ["LangGraph Platform configuration"] = 1106,
    ["Language configuration"] = 1105,
    Lefthook = 495,
    ["Liferay client-extension.yaml"] = 502,
    ["LinkML Metamodel"] = 504,
    Liquibase = 972,
    ["Liquibase Flow File"] = 973,
    ["Lively Properties"] = 505,
    ["Lobe AI Agent"] = 105,
    Loki = 106,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 546,
    ...
    Markdownlint = 976,
    ["Mason Registry"] = 979,
    ["MegaLinter Custom Flavor"] = 516,
    ["MegaLinter configuration"] = 515,
    ["MegaLinter descriptor"] = 517,
    Melange = 1072,
    ["Meltano project definition"] = 518,
    ["Mergify Configuration"] = 550,
    ["Metadata for a Bazel module"] = 519,
    ["Metadata for a Cinnamon spice"] = 1122,
    ["Metatype Configuration"] = 520,
    ["MetricsHub Configuration"] = 521,
    ["MetricsHub Connector Configuration"] = 522,
    ["Micro Editor Syntax"] = 1055,
    ["Microsoft Band Web Tile"] = 523,
    ["Microsoft RulesEngine workflow rules"] = 1110,
    ["Microsoft RulesEngine workflow rules list"] = 1111,
    ["Minecraft Custom Main Menu Mod"] = 1073,
    ["Minecraft Data Pack Advancement"] = 525,
    ["Minecraft Data Pack Biome"] = 526,
    ["Minecraft Data Pack Configured Carver"] = 527,
    ["Minecraft Data Pack Damage Type"] = 528,
    ["Minecraft Data Pack Dimension"] = 530,
    ["Minecraft Data Pack Dimension Type"] = 529,
    ["Minecraft Data Pack Item Modifier"] = 531,
    ["Minecraft Data Pack Loot Table"] = 532,
    ["Minecraft Data Pack Metadata"] = 533,
    ["Minecraft Data Pack Predicate"] = 534,
    ["Minecraft Data Pack Recipe"] = 535,
    ["Minecraft Data Pack Tag"] = 536,
    ["Minecraft Data Pack Template Pool"] = 537,
    ["Minecraft Data Pack Trim Material"] = 542,
    ["Minecraft Data Pack Trim Pattern"] = 543,
    ["Minecraft Resource Pack Lang"] = 538,
    ["Minecraft Resource Pack Particle"] = 539,
    ["Minecraft Resource Pack Texture Mcmeta"] = 541,
    ["Minecraft Resourcepack Sounds"] = 540,
    ["Monade CLI Stack Configuration"] = 553,
    ["MongoDB Atlas Search Index Definition"] = 1026,
    ["Monika Configuration"] = 1024,
    ["Monoweave Configuration"] = 548,
    ["Motif config"] = 917,
    MultiQC = 1163,
    ["NOX Framework (Service)"] = 569,
    ["Netin Diagnostic System Template"] = 983,
    ["Netlify config"] = 556,
    ["Network-as-Code Data Model"] = 557,
    ["Next Gen UI Agent A2A Server Configuration"] = 558,
    ["Next Gen UI Agent Configuration"] = 560,
    ["Next Gen UI Agent MCP Server Configuration"] = 559,
    ["Nightwatch.js"] = 562,
    ["Node.js configuration"] = 922,
    ["NueJS configuration file"] = 574,
    ["Nuitka.yaml"] = 1087,
    ["Nullstone config"] = 576,
    ["ONe's changelog entry"] = 594,
    ["ONe's service descriptor"] = 593,
    ["ORT Server repository environment configuration"] = 603,
    ["OSCAL Assessment Plan (AP)"] = 605,
    ["OSCAL Assessment Results (AR)"] = 606,
    ["OSCAL Catalog"] = 607,
    ["OSCAL Component Definition (CDef)"] = 608,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 609,
    ["OSCAL Profile"] = 610,
    ["OSCAL System Security Plan (SSP)"] = 611,
    ["OSS Review Toolkit configuration"] = 612,
    ["OSS Review Toolkit curation"] = 613,
    ["OSS Review Toolkit package configuration"] = 614,
    ["OSS Review Toolkit repository configuration"] = 615,
    ["OSS Review Toolkit resolutions"] = 616,
    ["October CMS columns"] = 580,
    ["October CMS fields"] = 581,
    ["Oh My Posh"] = 582,
    Okteto = 583,
    ["Ona Automations"] = 585,
    Opctl = 920,
    ["Open Data Contract Standard (ODCS)"] = 597,
    ["Open Data Product Standard (ODPS)"] = 598,
    ["Open Know-How"] = 1168,
    ["OpenRewrite Resource"] = 596,
    OpenSRM = 599,
    OpenStatus = 1179,
    ["OpenUtau character yaml"] = 590,
    ["OpenUtau ustx"] = 591,
    ["OpenWeather Current Weather API"] = 962,
    ["OpenWeather Road Risk API"] = 961,
    ["Ory Hydra configuration"] = 428,
    ["Ory Keto configuration"] = 488,
    ["Ory Kratos configuration"] = 604,
    ["Ory Oathkeeper configuration"] = 578,
    ["Outblocks App configuration"] = 601,
    ["Outblocks database table"] = 602,
    ["Outblocks project configuration"] = 600,
    PDM = 623,
    POPxf = 633,
    ["POPxf Correlations"] = 634,
    Packer = 620,
    Pantsbuild = 1041,
    ["Paper paper-plugin.yml"] = 621,
    ["Pipeline component"] = 974,
    ["Platform.sh application"] = 5,
    ["Platform.sh routes"] = 6,
    ["Platform.sh services"] = 7,
    ["Plex Prerolls"] = 631,
    ["PocketMine plugin.yml"] = 628,
    ["Postman collection"] = 637,
    ["Power Pages Configuration"] = 1180,
    ["Preset list for a WinUtil"] = 1125,
    ["ProActions AI-Kit Configuration"] = 648,
    ["ProActions AI-Kit Configuration for Menus"] = 650,
    ["ProActions AI-Kit Configuration for Sections"] = 652,
    ["ProActions AI-Kit Configuration for Services"] = 649,
    ["ProActions AI-Kit Configuration for Steps"] = 653,
    ["ProActions AI-Kit Configuration for Templates"] = 651,
    ["Problem object RFC9457"] = 1070,
    ["Problem package format"] = 654,
    ["Problem package generators"] = 655,
    ["Problem package submissions"] = 656,
    ["Problem package test group metadata"] = 657,
    Pterodactyl = 1020,
    ["Pull Request Labeler"] = 674,
    Pulumi = 682,
    ["PyGTA Config"] = 678,
    PyProject = 683,
    Pylock = 1171,
    Pyright = 684,
    ["Python script metadata"] = 1165,
    ["QType AI DSL"] = 687,
    Qgoda = 686,
    Qodana = 993,
    ["Qt Creator workspace file"] = 1103,
    ["Quali Torque Blueprint Spec 2"] = 1018,
    ["QueryFirst config file"] = 1037,
    ["RKE Cluster Configuration JSON"] = 971,
    ["RKE Cluster Configuration YAML"] = 970,
    RadioHound = 677,
    Railpack = 689,
    Railway = 688,
    ["Rancher Fleet"] = 679,
    ...
    Ray = 934,
    ["Read the Docs"] = 681,
    ["Red-DiscordBot Cog"] = 697,
    ["Red-DiscordBot Cog Repo"] = 698,
    ["Red-DiscordBot Trivia"] = 699,
    ["Releasaurus Config"] = 2,
    ["Render Blueprints"] = 969,
    RenderCV = 714,
    Renovate = 711,
    ["Renovate global configuration"] = 712,
    ["Renovate inherited configuration"] = 713,
    ["Replit config"] = 705,
    Restate = 1158,
    ["Revel Digital Gadget Definition File"] = 1182,
    RoadRunner = 716,
    ["Robust Station Image"] = 1188,
    Rockcraft = 717,
    ["Roo Coder Custom Modes"] = 718,
    Rubocop = 707,
    ["Rudder techniques"] = 1077,
    Ruff = 708,
    ["Rust Project"] = 709,
    ["Rust toolchain"] = 722,
    ["SDMX data message"] = 748,
    ["SDMX metadata message"] = 747,
    ["SDMX structure message"] = 746,
    ["SIL Kit Participant Configuration"] = 758,
    ["SIL Kit Registry Configuration"] = 759,
    ["SPDX 2.3"] = 796,
    SWADL = 812,
    ["Safebox Config"] = 1032,
    ["Sapphire CLI Config"] = 725,
    ["SauceCTL Configuration"] = 980,
    ["Schema Catalog"] = 740,
    ["Scoop manifest"] = 745,
    ["Semantic Data Fabric (SDF) file"] = 749,
    ["Semgrep Rule"] = 751,
    ["Serenity Code Generator (Sergen)"] = 752,
    ["Serverless Framework Configuration"] = 987,
    ["Serverless Workflow"] = 989,
    ["Settings for a Cinnamon spice"] = 1121,
    ["Settings.paf"] = 754,
    ["Shopware 6 Configuration"] = 990,
    ["Shopware CLI Extension Store Configuration"] = 991,
    ["Shopware CLI Project Store Configuration"] = 992,
    ["Sigma Detection Rule"] = 756,
    ["Sigrid scope configuration file"] = 757,
    ["SkyPilot Task JSON"] = 1078,
    ["Slack app manifest"] = 761,
    Snapcraft = 763,
    Solidarity = 766,
    ["Solution filters"] = 767,
    ["Source Maps v3"] = 768,
    Sourcery = 769,
    ["Spack bootstrap.yaml"] = 770,
    ["Spack cdash.yaml"] = 771,
    ["Spack ci.yaml"] = 772,
    ["Spack compilers.yaml"] = 773,
    ["Spack concretizer.yaml"] = 774,
    ["Spack config.yaml"] = 775,
    ["Spack definitions.yaml"] = 776,
    ["Spack develop.yaml"] = 777,
    ["Spack env_vars.yaml"] = 778,
    ["Spack environment"] = 784,
    ["Spack include.yaml"] = 779,
    ["Spack mirrors.yaml"] = 780,
    ["Spack modules.yaml"] = 781,
    ["Spack packages.yaml"] = 782,
    ["Spack repos.yaml"] = 783,
    ["Spack toolchains.yaml"] = 785,
    ["Spack upstreams.yaml"] = 786,
    ["Spack view.yaml"] = 787,
    ["Speakeasy Generation Config File"] = 791,
    ["Speakeasy Lint Configuration File"] = 788,
    ["Speakeasy Test Generation Configuration File"] = 789,
    ["Speakeasy Workflow File"] = 790,
    SpecIF = 792,
    ["Specmatic Configuration"] = 793,
    ["Sponge Mixin configuration"] = 794,
    StackBlitz = 800,
    ["StackHawk Scanner Configuration"] = 986,
    Stale = 801,
    Starfish = 802,
    ["Starlake Data Pipeline"] = 959,
    Starship = 803,
    ["Statamic Blueprint"] = 804,
    ["Stella configuration file"] = 805,
    ["Streamlit configuration file"] = 806,
    ["Stryker Mutator"] = 809,
    ["StyleCop Analyzers Configuration"] = 810,
    ["Stylelint (.stylelintrc)"] = 811,
    ["Stylua Config"] = 1172,
    ["Sublime Syntax"] = 1033,
    ["Subsquid squid manifest"] = 1080,
    ["Swagger API 2.0"] = 813,
    ["Synadia Connect Component"] = 814,
    TSON = 849,
    TSTyche = 850,
    ["TYPO3 Vendor Bundler config"] = 855,
    ["Tab data for a LinUtil"] = 1128,
    ["Tab list for a LinUtil"] = 1127,
    Tach = 815,
    ["Tach Domain"] = 816,
    Talhelper = 818,
    ["Talisman configuration"] = 819,
    Taplo = 1173,
    ["Taskfile config"] = 964,
    Taurus = 820,
    Tauticord = 821,
    ["Tekton Pipeline"] = 1201,
    ["Tekton PipelineRun"] = 1202,
    ["Tekton Task"] = 1199,
    ["Tekton TaskRun"] = 1200,
    Telefonistka = 1159,
    ["Terrateam config"] = 1185,
    ["TestEnvironment.json"] = 832,
    ["TextMate Grammar"] = 831,
    Threagile = 827,
    ["Tier.run pricing.json"] = 824,
    Tikibase = 825,
    Tombi = 830,
    ["Traefik v2"] = 835,
    ["Traefik v2 File Provider"] = 836,
    ["Traefik v3"] = 837,
    ["Traefik v3 File Provider"] = 838,
    ["Travis CI (.travis.yml)"] = 834,
    Treefmt = 406,
    Trident = 1155,
    ["TrueScript for *.tscript files"] = 841,
    ["Tugboat QA config.yml"] = 1152,
    TunnelHub = 1068,
    Turborepo = 833,
    Tycho = 1117,
    Tye = 994,
    ["Tyk Gateway - Open Source v5.7+"] = 1164,
    ["UET BuildConfig.json"] = 1038,
    ["UI5 Manifest"] = 861,
    ["UNCORS configuration"] = 865,
    ["UTAM Page Object"] = 864,
    ["Ubuntu Server Autoinstall"] = 859,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1156,
    ["Uniswap Token List"] = 946,
    ["Universal Schedule Format"] = 866,
    ["Unreal Engine Uplugin"] = 1039,
    ["Unreal Engine Uproject"] = 1040,
    ["UpCloud CLI (upctl) configuration"] = 1157,
    ["Updatecli Compose"] = 1002,
    ["Updatecli Policy Manifest"] = 1003,
    ["Updatecli Policy Metadata"] = 1004,
    Uplift = 1036,
    ["Upsun config"] = 4,
    ["User Journey Map"] = 968,
    V2Ray = 1008,
    ["VSCode Code Snippets"] = 239,
    ["VSIX CLI publishing"] = 884,
    Vector = 868,
    ["Vela Pipeline Configuration"] = 871,
    Vercel = 238,
    ["Version Bumper config"] = 874,
    Vespertide = 1206,
    ["Vespertide Migration"] = 1207,
    ["Vespertide Model"] = 1208,
    ["Viash Component Config"] = 1161,
    ["Viash Package Config"] = 1162,
    Visivo = 1066,
    ["WP-CLI"] = 894,
    Wake = 1154,
    ["Waku Config"] = 1131,
    ["Web App Manifest"] = 890,
    ["Web types"] = 893,
    WebExtensions = 889,
    ["Webman package recipe"] = 1014,
    ["Windows Package Manager Installer Manifest"] = 942,
    ["Windows Package Manager Locale Manifest"] = 943,
    ["Windows Package Manager Singleton Manifest"] = 941,
    Winutil = 944,
    ["WireMock CLI import configuration"] = 1137,
    ["WireMock CLI local service configuration"] = 1136,
    ["WireMock message stub mapping"] = 1135,
    ["WireMock stub mapping"] = 1134,
    ["Woodpecker pipeline config"] = 982,
    ["Wrangler CLI"] = 895,
    ["Xstate Machine"] = 1000,
    ["Yandex Workflow Language"] = 1123,
    ["Yarn Config (.yarnrc.yml)"] = 957,
    ["Yippee-Ki-JSON configuration YML"] = 948,
    ["YouTrack App"] = 1120,
    ["Zarf Package Configuration"] = 1187,
    ["Zerops.io config"] = 1108,
    ["Zerops.io import"] = 1109,
    ["Zola Configuration"] = 1198,
    ["aerleon.yml"] = 17,
    ["amplify.yml"] = 10,
    ["angular.json"] = 33,
    apko = 1071,
    ...
    ["behat.yml"] = 135,
    ["bigquery-table"] = 124,
    ["bioimageio resource description"] = 1088,
    ...
    ["chutzpah.json"] = 247,
    cibuildwheel = 170,
    ["clang-format (.clang-format)"] = 1006,
    ["clang-tidy"] = 225,
    clangd = 224,
    clib = 226,
    ...
    ["crowdin.yml"] = 273,
    ["ctfd-setup configuration file"] = 1144,
    ["custom-elements.json"] = 1058,
    ["cypress.json"] = 277,
    ...
    ["dtool dataset metadata"] = 1139,
    ["dvc.yaml"] = 319,
    ["ecosystem.json"] = 324,
    eksctl = 325,
    ["electron-builder configuration file"] = 331,
    ["epr-manifest.json"] = 330,
    ["evcc.yaml"] = 332,
    ["ezd task runner"] = 342,
    ["fabric.mod.json"] = 344,
    ["first-timers-bot"] = 351,
    ["flagd flag configuration"] = 110,
    ["fly.io Configuration"] = 111,
    fulibWorkflows = 981,
    ["function.json"] = 363,
    ["gRPC API Gateway & OpenAPI Config"] = 12,
    ["gematik health care insurance list"] = 1150,
    ["gematik health care patient list"] = 1147,
    ["gematik health care provider institution list"] = 1149,
    ["gematik health care provider list"] = 1148,
    ["gematik tiger test environment configuration"] = 1151,
    ["git-town.toml"] = 1196,
    ["gitlab-ci"] = 381,
    ["global.json"] = 397,
    ["go-feature-flag Flag Configuration"] = 400,
    ["haxelib.json"] = 418,
    helmfile = 937,
    helmwave = 938,
    ["host-meta.json"] = 425,
    ...
    ["ide.host.json"] = 433,
    ["ifstate.yaml"] = 434,
    ["imageoptimizer.json"] = 435,
    ["importmap.json"] = 438,
    instant_python_config = 440,
    instant_python_custom_project = 441,
    ["ioBroker Configuration"] = 442,
    ["ioBroker JSON UI"] = 443,
    ["ioBroker Package manifest"] = 444,
    ["ixpect.conf.yaml"] = 445,
    ["ize.toml"] = 1035,
    ["jsconfig.json"] = 470,
    ["jscpd Configuration"] = 1019,
    jsdoc = 933,
    ["k3d.yaml"] = 471,
    ["k9s aliases.yaml"] = 473,
    ["k9s cluster-config.yaml"] = 475,
    ["k9s config.yaml"] = 474,
    ["k9s hotkeys.yaml"] = 476,
    ["k9s plugins.yaml"] = 477,
    ["k9s skin.yaml"] = 478,
    ["k9s views.yaml"] = 479,
    ["kontinuous-config.yaml"] = 490,
    ["kontinuous-values.yaml"] = 489,
    ["kustomization.yaml"] = 492,
    ["label-commenter-config.yml"] = 493,
    ["latexindent configuration"] = 104,
    ["launchsettings.json"] = 494,
    lazydocker = 1057,
    lazygit = 1056,
    ["lego.json"] = 496,
    ["lerna.json"] = 497,
    ["lgtm.yml"] = 498,
    ["liblab.config.json"] = 499,
    ["libman.json"] = 500,
    ["license-report-config.json"] = 501,
    ["linkinator.config.json"] = 503,
    ["lint-staged (.lintstagedrc)"] = 911,
    ["local.settings.json"] = 508,
    ["localazy.json"] = 509,
    ["lotus.yaml"] = 507,
    ["lsdlschema.json"] = 510,
    ["macro.json"] = 1023,
    ["markdown-link-check"] = 977,
    maturin = 978,
    mboats = 985,
    ["micro-settings.json"] = 1050,
    ["mimetypes.json"] = 524,
    ["mirrord config"] = 913,
    mise = 914,
    ["mkdocs.yml"] = 544,
    ["monospace.yml"] = 547,
    ["moon.yml"] = 1133,
    ["mprocs Configuration file"] = 1104,
    ["mrdocs.yml"] = 545,
    ["mta.yaml"] = 915,
    ["mtad.yaml"] = 916,
    ["mycode.json"] = 554,
    nFPM = 561,
    ["napari plugin manifest"] = 555,
    neoload = 928,
    ["nest-cli"] = 564,
    ["ninjs (News in JSON)"] = 563,
    ["nitro.json"] = 927,
    ["nixd configuration"] = 1076,
    ["nlu.json"] = 565,
    ["nodemon.json"] = 567,
    ["noodl config"] = 984,
    ["notebook.mod.json"] = 568,
    now = 923,
    ["npm-badges"] = 571,
    ["nswag.json"] = 575,
    ntangle = 577,
    ["nuclei-template.yaml"] = 572,
    ["nuget-project.json"] = 573,
    ["ocelot.json"] = 579,
    ["omnisharp.json"] = 584,
    openHAB = 1209,
    ["openapi.json"] = 586,
    ...
    ["overlay.json"] = 587,
    ["package.json"] = 617,
    ["package.manifest"] = 619,
    ["package.yaml"] = 618,
    ["partial-black.json"] = 136,
    ["pathfinder.yml"] = 622,
    ["pattern.json"] = 625,
    ["petstore-v1.0"] = 1030,
    pgap_yaml_input_reader = 624,
    pgxgen = 1212,
    pitcms = 1215,
    ["pixi.toml"] = 626,
    ["plagiarize-me.yaml"] = 630,
    ["plagiarize.yaml"] = 629,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1140,
    ["podbard.yaml"] = 632,
    ["portman.json"] = 635,
    ["prefect.toml"] = 643,
    ["prefect.yaml"] = 644,
    ...
    ["prettierrc.json"] = 646,
    ["prisma.yml"] = 647,
    ["project-1.0.0-beta3.json"] = 659,
    ["project-1.0.0-beta4.json"] = 660,
    ["project-1.0.0-beta5.json"] = 661,
    ["project-1.0.0-beta6.json"] = 662,
    ["project-1.0.0-beta8.json"] = 663,
    ["project-1.0.0-rc1.json"] = 664,
    ["project-1.0.0-rc2.json"] = 665,
    ["project.json"] = 658,
    ["project.owasp.yaml"] = 666,
    ["prometheus-alertmanager.json"] = 670,
    ["prometheus.json"] = 667,
    ["prometheus.rules.json"] = 668,
    ["prometheus.rules.test.json"] = 669,
    ["proxies.json"] = 671,
    ["publiccode.yml"] = 672,
    ["pubspec.yaml"] = 673,
    ["pyrseas-0.8.json"] = 676,
    pytest = 685,
    ["quilt.mod.json"] = 1051,
    ["rc3 auth"] = 691,
    ["rc3 collection"] = 692,
    ...
    ["release drafter"] = 929,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 701,
    ["release-please-manifest.json"] = 702,
    ["release-plz.toml"] = 703,
    ["renv.lock"] = 715,
    ["rivet.json"] = 1075,
    ["rivet.yaml (legacy)"] = 1074,
    rumdl = 720,
    runny = 719,
    rustfmt = 721,
    sake = 1167,
    samt = 723,
    samtrc = 724,
    ["sarif-1.0.0.json"] = 726,
    ["sarif-2.0.0.json"] = 727,
    ["sarif-2.1.0"] = 737,
    ["sarif-2.1.0-rtm.2"] = 728,
    ["sarif-2.1.0-rtm.3"] = 730,
    ["sarif-2.1.0-rtm.4"] = 732,
    ["sarif-2.1.0-rtm.5"] = 734,
    ["sarif-2.1.0-rtm.6"] = 735,
    ["sarif-external-property-file-2.1.0"] = 738,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 729,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 731,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 733,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 736,
    ["scalingo.json configuration"] = 739,
    ["schema.org - Action"] = 741,
    ["schema.org - ContactPoint"] = 742,
    ["schema.org - Place"] = 743,
    ["schema.org - Thing"] = 744,
    ["secrethub.yml"] = 1053,
    ["semantic-release"] = 750,
    ["servicehub.config.json"] = 906,
    ["servicehub.service.json"] = 905,
    ["settings.job"] = 753,
    ["sfdx-hardis configuration"] = 755,
    ["shard.yml"] = 1091,
    ["size-limit configuration"] = 760,
    ["skaffold.yaml"] = 975,
    ["skyuxconfig.json"] = 762,
    ["snowflake-config"] = 764,
    ["snowflake-connections"] = 765,
    ["spicepod.yaml"] = 1112,
    ["sqlc configuration"] = 797,
    ["stripe-app-local.json"] = 808,
    ["stripe-app.json"] = 807,
    swcrc = 960,
    ["task.json"] = 817,
    taskcat = 924,
    ["template.json"] = 822,
    ["templatsources.json"] = 823,
    ["theme.json"] = 826,
    ["tizen_workspace.json"] = 828,
    tldr = 829,
    ["tm_devices configuration file"] = 1178,
    tmuxinator = 909,
    ["transcend.yml"] = 839,
    ["tree-sitter grammar.json"] = 405,
    ["trime.yaml"] = 840,
    ["trunk.yaml"] = 842,
    ["ts-force-config.json"] = 847,
    ["tsconfig.json"] = 843,
    ["tsd.json"] = 844,
    ["tsdoc.json"] = 845,
    ["tsdrc.json"] = 846,
    ...
    ["vega-lite.json"] = 870,
    ["vega.json"] = 869,
    ["venvironment.yaml"] = 872,
    ["venvplus.yaml"] = 873,
    version = 1160,
    ["version.json"] = 875,
    ["vhwdebugger-binding.yaml"] = 877,
    ["vim-addon-info"] = 878,
    ["vs-2017.3.host.json"] = 880,
    ["vs-nesting.json"] = 881,
    ["vsls.json"] = 879,
    ["vss-extension.json"] = 885,
    vtcfg = 1166,
    ["vtesttree.yaml"] = 886,
    ["vtestunit.yaml"] = 887,
    ["warp-keysets.json"] = 1059,
    ["warp-themes.json"] = 1060,
    ["warp-workflows.json"] = 1061,
    ["webhint.io"] = 1015,
    ["webjobpublishsettings.json"] = 892,
    ["webjobs-list.json"] = 891,
    ["well-known-fursona"] = 1099,
    ["xs-app.json"] = 919,
    ["xunit.runner.json"] = 904,
    yamllint = 947,
    zizmor = 1203,
    zuul = 930,
    ["Žinoma"] = 940
