...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1048,
    ["API Builder"] = 863,
    ["AVA Configuration"] = 925,
    ...
    ["Adobe UXP Manifest"] = 987,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1076,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 897,
    ["All Contributors configuration file"] = 950,
    ...
    ["Application list for a WinUtil"] = 1030,
    ArchitectFX = 1035,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["BX CI"] = 123,
    ["Bashly (bashly.yml)"] = 954,
    ["Bashly Settings (bashly-settings.yml)"] = 955,
    ["Better Code Hub"] = 867,
    ["Better Scripts"] = 124,
    Bigconfig = 96,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1041,
    BizTalkServerApplicationSchema = 835,
    Bleep = 125,
    ...
    ["Butane Config"] = 910,
    C4InterFlow = 1056,
    ["CDK Environment Manager, concrete environment configuration"] = 1079,
    ["CDK Environment Manager, concrete environments definition"] = 1078,
    ["CDK Environment Manager, environment definition"] = 1077,
    ["CGS Card Game Specification (cgs.json)"] = 992,
    ["CICS TS region tagging"] = 919,
    ["CICS TS resource import"] = 920,
    ["CICS TS resource model"] = 921,
    ["CICS TS resource overrides"] = 922,
    ["CMake Presets"] = 126,
    ["CNC Codes"] = 145,
    ["CRS WAF test file"] = 1020,
    ["CRS WAF test platform overrides file"] = 1021,
    ...
    ["Chamaleon environment"] = 1045,
    ["Chamaleon properties"] = 1046,
    ["Chamaleon template"] = 1044,
    Changesets = 229,
    Charmcraft = 135,
    Cheatsheets = 907,
    ...
    ["Clawject config"] = 151,
    ["Cloud Foundry Application Manifest"] = 1003,
    ["Cloud Run Spec v1"] = 1025,
    ...
    Concord = 1019,
    ["Configu .cfgu files"] = 1008,
    ["Configu .configu file"] = 1009,
    Conjure = 144,
    ["Container Structure Test"] = 849,
    Containerlab = 876,
    ["Contextive Glossary"] = 1071,
    Convex = 143,
    ["Crowdsec collection config"] = 239,
    ["Crowdsec parser config"] = 240,
    ["Crowdsec scenario config"] = 241,
    ["CumulusCI Config"] = 150,
    ["Custom Machinery Machine"] = 993,
    ["Custom Machinery Recipe"] = 994,
    ...
    ["DonateCaseBetterCasino menu"] = 1049,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 962,
    ["EAS config"] = 305,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 951,
    ["EasyVCR .NET"] = 306,
    ["Eidolon Resource"] = 1036,
    ...
    ["GeoJSON.json latest"] = 914,
    GherKing = 918,
    ["GitHub Action"] = 336,
    ["GitHub Actions typing"] = 1032,
    ...
    ["Google Digital Assetlinks"] = 1072,
    Goreleaser = 364,
    ["Goreleaser Pro"] = 365,
    Goss = 366,
    ["Gradle Build Cache Node"] = 865,
    ["Gradle Enterprise"] = 864,
    ...
    Hadolint = 845,
    Hammerkit = 875,
    ["Hardware Sentry Configuration"] = 930,
    Hatch = 846,
    Hayson = 379,
    ["Haystack Pipeline"] = 380,
    ["Hazelcast 5 Configuration"] = 381,
    ["Hecate Input Schema"] = 1083,
    ["Helm Chart.lock"] = 184,
    ["Helm Chart.yaml"] = 183,
    ...
    ["JFrog File Spec"] = 410,
    ["JFrog Pipelines YML DSL"] = 939,
    ["JMeter DSL cli config"] = 411,
    JReleaser = 414,
    ["JSON Document Transform"] = 422,
    ["JSON Feed"] = 423,
    ["JSON Resume"] = 644,
    ["JSON Schema Draft 2020-12"] = 814,
    ["JSON Schema Draft 4"] = 811,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 972,
    ["JSON Schema Draft 7"] = 812,
    ["JSON Schema Draft 7 (unofficial strict)"] = 973,
    ["JSON Schema Draft 8 (2019-09)"] = 813,
    ["JSON-API"] = 421,
    ["JSON-e templates"] = 872,
    ["JSON-stat 2.0"] = 807,
    JSONPatch = 425,
    ...
    ["Metadata for a Cinnamon spice"] = 1028,
    ["Metatype Configuration"] = 473,
    ["MetricsHub Configuration"] = 474,
    ["MetricsHub Connector Configuration"] = 475,
    ["Micro Editor Syntax"] = 963,
    ["Microsoft Band Web Tile"] = 476,
    ["Microsoft RulesEngine workflow rules"] = 1016,
    ["Microsoft RulesEngine workflow rules list"] = 1017,
    ["Minecraft Custom Main Menu Mod"] = 981,
    ...
    ["MongoDB Atlas Search Index Definition"] = 934,
    ["Monika Configuration"] = 932,
    ["Monoweave Configuration"] = 501,
    ["Motif config"] = 827,
    MultiQC = 1065,
    ["NOX Framework (Service)"] = 519,
    ["Netin Diagnostic System Template"] = 892,
    ["Netlify config"] = 509,
    ["Network-as-Code Data Model"] = 510,
    ["Nightwatch.js"] = 512,
    ["Node.js configuration"] = 832,
    ...
    ["OpenUtau ustx"] = 537,
    ["OpenWeather Current Weather API"] = 871,
    ["OpenWeather Road Risk API"] = 870,
    ...
    ["Power Pages Configuration"] = 1082,
    ["Preset list for a WinUtil"] = 1031,
    ...
    Pylock = 1073,
    Pyright = 619,
    ["Python script metadata"] = 1067,
    ["QType AI DSL"] = 622,
    Qgoda = 621,
    Qodana = 902,
    ["Qt Creator workspace file"] = 1010,
    ["Quali Torque Blueprint Spec 2"] = 927,
    ["QueryFirst config file"] = 945,
    ["RKE Cluster Configuration JSON"] = 880,
    ["RKE Cluster Configuration YAML"] = 879,
    RadioHound = 612,
    Railway = 623,
    ["Rancher Fleet"] = 614,
    ["Rattler-build"] = 624,
    ...
    ["SauceCTL Configuration"] = 889,
    ["Schema Catalog"] = 671,
    ["Scoop manifest"] = 676,
    ["Semantic Data Fabric (SDF) file"] = 680,
    ["Semgrep Rule"] = 682,
    ["Serenity Code Generator (Sergen)"] = 683,
    ["Serverless Framework Configuration"] = 896,
    ["Serverless Workflow"] = 898,
    ["Settings for a Cinnamon spice"] = 1027,
    ["Settings.paf"] = 685,
    ["Shopware 6 Configuration"] = 899,
    ["Shopware CLI Extension Store Configuration"] = 900,
    ["Shopware CLI Project Store Configuration"] = 901,
    ["Sigma Detection Rule"] = 687,
    ["Sigrid scope configuration file"] = 688,
    ["SkyPilot Task JSON"] = 986,
    ...
    StackBlitz = 712,
    ["StackHawk Scanner Configuration"] = 895,
    Stale = 713,
    ["Starlake Data Pipeline"] = 868,
    Starship = 714,
    ...
    ["Stylua Config"] = 1074,
    ["Sublime Syntax"] = 941,
    ["Subsquid squid manifest"] = 988,
    ["Swagger API 2.0"] = 723,
    ["Synadia Connect Component"] = 724,
    TSON = 758,
    TSTyche = 759,
    ["TYPO3 Vendor Bundler config"] = 764,
    ["Tab data for a LinUtil"] = 1034,
    ["Tab list for a LinUtil"] = 1033,
    Tach = 725,
    ["Tach Domain"] = 726,
    Talhelper = 728,
    ...
    ["Tugboat QA config.yml"] = 1055,
    TunnelHub = 976,
    Turborepo = 742,
    Tycho = 1023,
    Tye = 903,
    ["Tyk Gateway - Open Source v5.7+"] = 1066,
    ["Typst Manifest"] = 765,
    ["UET BuildConfig.json"] = 946,
    ["UI5 Manifest"] = 771,
    ["UNCORS configuration"] = 775,
    ["UTAM Page Object"] = 774,
    ["Ubuntu Server Autoinstall"] = 769,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1059,
    ["Uniswap Token List"] = 856,
    ["Universal Schedule Format"] = 776,
    ["Unreal Engine Uplugin"] = 947,
    ["Unreal Engine Uproject"] = 948,
    ["Updatecli Compose"] = 911,
    ["Updatecli Policy Manifest"] = 912,
    ["Updatecli Policy Metadata"] = 913,
    Uplift = 944,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 877,
    V2Ray = 917,
    ...
    ["Viash Component Config"] = 1063,
    ["Viash Package Config"] = 1064,
    Visivo = 974,
    Wake = 1057,
    ["Waku Config"] = 1037,
    ...
    ["Web types"] = 805,
    WebExtensions = 801,
    ["Webman package recipe"] = 923,
    ["Windows Package Manager Installer Manifest"] = 852,
    ["Windows Package Manager Locale Manifest"] = 853,
    ["Windows Package Manager Singleton Manifest"] = 851,
    Winutil = 854,
    ["WireMock stub mapping"] = 1040,
    ["Woodpecker pipeline config"] = 891,
    ["Wrangler CLI"] = 806,
    ["Xstate Machine"] = 909,
    ["Yandex Workflow Language"] = 1029,
    ["Yarn Config (.yarnrc.yml)"] = 866,
    ["Yippee-Ki-JSON configuration YML"] = 858,
    ["YouTrack App"] = 1026,
    ["Zerops.io config"] = 1014,
    ["Zerops.io import"] = 1015,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 979,
    ...
    ["behat.yml"] = 106,
    ["bigquery-table"] = 95,
    ["bioimageio resource description"] = 996,
    ...
    ["crowdin.yml"] = 238,
    ["ctfd-setup configuration file"] = 1047,
    ["custom-elements.json"] = 966,
    ["cypress.json"] = 242,
    ...
    ["gematik health care insurance list"] = 1053,
    ["gematik health care patient list"] = 1050,
    ["gematik health care provider institution list"] = 1052,
    ["gematik health care provider list"] = 1051,
    ["gematik tiger test environment configuration"] = 1054,
    ["gitlab-ci"] = 344,
    ["global.json"] = 360,
    ...
    ["lint-staged (.lintstagedrc)"] = 822,
    ["local.settings.json"] = 463,
    ["localazy.json"] = 464,
    ["lotus.yaml"] = 462,
    ["lsdlschema.json"] = 465,
    ["markdown-link-check"] = 886,
    maturin = 887,
    mboats = 894,
    ["micro-settings.json"] = 958,
    ["mimetypes.json"] = 477,
    ["mirrord config"] = 823,
    mise = 824,
    ["mkdocs.yml"] = 497,
    ["monospace.yml"] = 500,
    ["moon.yml"] = 1039,
    ["mprocs Configuration file"] = 1011,
    ["mrdocs.yml"] = 498,
    ["mta.yaml"] = 825,
    ["mtad.yaml"] = 826,
    ["mycode.json"] = 507,
    ...
    ["plagiarize.yaml"] = 572,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1043,
    ["podbard.yaml"] = 575,
    ["portman.json"] = 576,
    ["prefect.toml"] = 584,
    ["prettierrc.json"] = 585,
    ...
    ["servicehub.config.json"] = 817,
    ["servicehub.service.json"] = 816,
    ["settings.job"] = 684,
    ...
    tldr = 738,
    ["tm_devices configuration file"] = 1080,
    tmuxinator = 820,
    ["transcend.yml"] = 748,
    ...
    ["vtesttree.yaml"] = 798,
    ["vtestunit.yaml"] = 799,
    ["warp-keysets.json"] = 967,
    ["warp-themes.json"] = 968,
    ["warp-workflows.json"] = 969,
    ["webhint.io"] = 924,
    ["webjobpublishsettings.json"] = 804,
    ["webjobs-list.json"] = 803,
    ["well-known-fursona"] = 1006,
    ["xs-app.json"] = 829,
    ["xunit.runner.json"] = 815,
    yamllint = 857,
    zuul = 840,
    ["Žinoma"] = 850
  },
