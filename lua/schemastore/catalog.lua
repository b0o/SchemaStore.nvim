...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 863,
    [".nodehawkrc"] = 527,
    [".npmpackagejsonlintrc"] = 531,
    [".omletrc"] = 1039,
    [".phrase.yml"] = 594,
    [".phraseapp.yml"] = 595,
    [".pmbot.yml"] = 582,
    [".postcssrc"] = 589,
    [".powerpages-web-template-manifest"] = 591,
    [".pre-commit-config.yml"] = 592,
    [".pre-commit-hooks.yml"] = 593,
    [".putout.json"] = 622,
    [".rehyperc"] = 646,
    [".remarkrc"] = 650,
    [".sprite files"] = 737,
    ...
    ["A micro editor config"] = 478,
    ABCInventoryModuleData = 18,
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1084,
    ["API Builder"] = 898,
    ["AVA Configuration"] = 960,
    ["AWS AppConfig Feature Flags-v1"] = 49,
    ["AWS CDK cdk.json"] = 221,
    ["AWS CloudFormation"] = 222,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 223,
    ["AWS Copilot Manifest"] = 1123,
    ["AWS SAM CLI Samconfig"] = 224,
    ["Adobe UXP Manifest"] = 1022,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1113,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 932,
    ["All Contributors configuration file"] = 985,
    ["Ansible Argument Specs"] = 354,
    ["Ansible Collection Galaxy"] = 361,
    ["Ansible Execution Environment"] = 351,
    ["Ansible Inventory"] = 360,
    ["Ansible Meta"] = 352,
    ["Ansible Meta Runtime"] = 353,
    ["Ansible Navigator Configuration"] = 363,
    ["Ansible Playbook"] = 358,
    ["Ansible Requirements"] = 355,
    ["Ansible Rulebook"] = 359,
    ["Ansible Tasks File"] = 357,
    ["Ansible Vars File"] = 356,
    ["Ansible-lint Configuration"] = 362,
    Any = 1049,
    ["AnyWork Automation Configuration"] = 9,
    ["App config Spotify Backstage"] = 25,
    ["Application Accelerator"] = 6,
    ["Application list for a WinUtil"] = 1066,
    ArchitectFX = 1071,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure IoT Operations connector metadata"] = 1129,
    ...
    ["Azure Pipelines"] = 79,
    ["Azure Static Web Apps CLI configuration file"] = 741,
    ["Azure Static Web Apps configuration file"] = 740,
    ["BOSH CPI Config"] = 103,
    ["BOSH Deploy Config"] = 104,
    ["BX CI"] = 123,
    ["Bashly (bashly.yml)"] = 989,
    ["Bashly Settings (bashly-settings.yml)"] = 990,
    ["Better Code Hub"] = 902,
    ["Better Scripts"] = 124,
    Bigconfig = 96,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1077,
    BizTalkServerApplicationSchema = 870,
    Bleep = 125,
    ...
    ["Butane Config"] = 945,
    C4InterFlow = 1092,
    ["CDK Environment Manager, concrete environment configuration"] = 1116,
    ["CDK Environment Manager, concrete environments definition"] = 1115,
    ["CDK Environment Manager, environment definition"] = 1114,
    ["CGS Card Game Specification (cgs.json)"] = 1027,
    ["CICS TS region tagging"] = 954,
    ["CICS TS resource import"] = 955,
    ["CICS TS resource model"] = 956,
    ["CICS TS resource overrides"] = 957,
    ["CMake Presets"] = 126,
    ["CNC Codes"] = 147,
    ["CRS WAF test file"] = 1056,
    ["CRS WAF test platform overrides file"] = 1057,
    ["CSS Comb (.csscomb.json)"] = 249,
    ["CSS Lint (.csslintrc)"] = 250,
    ["CSpell (cspell.json)"] = 248,
    ...
    ["Chamaleon environment"] = 1081,
    ["Chamaleon properties"] = 1082,
    ["Chamaleon template"] = 1080,
    Changesets = 233,
    Changie = 135,
    Charmcraft = 136,
    Cheatsheets = 942,
    ["ChordPro Configuration"] = 137,
    ["Chrome Extension"] = 214,
    ["Chromia Model"] = 138,
    ["Chromia Seeder Module Config"] = 140,
    ["Chromia Seeder Root Config"] = 139,
    ["Cinnamon Spice info.json"] = 70,
    ["CircleCI config.yml"] = 190,
    ["Citation File Format"] = 235,
    CityJSON = 142,
    ["Claude Code Settings"] = 154,
    ["Clawject config"] = 153,
    ["Cloud Foundry Application Manifest"] = 1038,
    ["Cloud Run Spec v1"] = 1061,
    ["CloudCannon Configuration"] = 74,
    ["CloudEvents specification"] = 143,
    ["Code Climate"] = 191,
    CodeCV = 72,
    CodeRabbit = 71,
    ["CodeShip Pro services configuration files"] = 203,
    ["CodeShip Pro steps configuration files"] = 204,
    ["Codecov configuration files"] = 202,
    CodifyCLI = 73,
    Codux = 200,
    ["Cog config file"] = 148,
    ["Commandbox Box.json"] = 149,
    ["Commandbox Server.json"] = 150,
    ["Common Catalog Data"] = 212,
    ["Common Package Specification"] = 151,
    Concord = 1055,
    ["Configu .cfgu files"] = 1043,
    ["Configu .configu file"] = 1044,
    Conjure = 146,
    ["Container Structure Test"] = 884,
    Containerlab = 911,
    ["Contextive Glossary"] = 1108,
    Convex = 145,
    ["Crowdsec collection config"] = 243,
    ["Crowdsec parser config"] = 244,
    ["Crowdsec scenario config"] = 245,
    ["CumulusCI Config"] = 152,
    ["Custom Machinery Machine"] = 1028,
    ["Custom Machinery Recipe"] = 1029,
    ["Cycle Stack File"] = 156,
    CycloneDX = 157,
    ["DWP Exchange - catalogue entry"] = 292,
    ["DWP Exchange - gateway"] = 290,
    ["DWP Exchange - meta"] = 291,
    ["Dart Build Config (dart-build.json)"] = 251,
    ["Dart Test Config (dart-test.json)"] = 252,
    ["DashLord Configuration"] = 253,
    ["Data Contract Specification"] = 254,
    ["Data Product Specification"] = 255,
    ["DataYoga Connections"] = 158,
    ["DataYoga Job"] = 159,
    ["Databricks Asset Bundles"] = 1006,
    ["Datadog Continuous Testing"] = 449,
    ["Datadog Service Definition"] = 450,
    ["Datadog Software Catalog"] = 451,
    ["Datahub Ingestion Recipe"] = 961,
    ["Debian Upstream Metadata file"] = 165,
    ["Deck config"] = 166,
    ["Dein Config"] = 167,
    ...
    DipDup = 1058,
    ["Discord Webhook"] = 266,
    ["DocFx Config (docfx.json)"] = 270,
    Dofigen = 271,
    ["Dolittle Artifacts"] = 272,
    ["Dolittle Bounded Context Configuration"] = 273,
    ["Dolittle Event Horizons Configuration"] = 274,
    ["Dolittle Resources Configuration"] = 275,
    ["Dolittle Server Configuration"] = 276,
    ["Dolittle Tenant Map Configuration"] = 278,
    ["Dolittle Tenants Configuration"] = 277,
    ["Dolittle Topology"] = 279,
    ["DonateCaseBetterCasino menu"] = 1085,
    ["Drupal Breakpoints"] = 173,
    ["Drupal Config"] = 185,
    ["Drupal Info"] = 174,
    ["Drupal Layouts"] = 175,
    ["Drupal Libraries"] = 176,
    ["Drupal Links Action"] = 177,
    ["Drupal Links Contextual"] = 178,
    ["Drupal Links Menu"] = 179,
    ["Drupal Links Task"] = 180,
    ["Drupal Migration"] = 181,
    ["Drupal Permissions"] = 182,
    ["Drupal Recipe"] = 183,
    ["Drupal Routing"] = 184,
    ["Drupal Services"] = 186,
    ["Drush site aliases"] = 285,
    ["Dynamic Bash Aliases (.aliases)"] = 997,
    ["EAS config"] = 309,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 986,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1128,
    ["EasyVCR .NET"] = 310,
    ["Eidolon Resource"] = 1072,
    ["Elgato Stream Deck"] = 295,
    Elm = 1060,
    ["Embrace Config"] = 972,
    Endurica = 1010,
    ["Enterprise Contract Policy Spec"] = 296,
    ["Erda Pipeline"] = 1035,
    ["Erda Runtime"] = 1036,
    Esquio = 298,
    ["Estuary Flow Catalog"] = 951,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 302,
    ["EveryVoice TTS Toolkit Data Configuration"] = 303,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 307,
    ...
    ["Evolving Resolutive Process notation"] = 1130,
    ["Expo SDK"] = 308,
    ...
    Firebase = 316,
    ["FlexGet Config"] = 319,
    ["Flow.json Configurations"] = 1032,
    ["Fossa configuration file"] = 326,
    ["Fossa's fossa-deps file"] = 327,
    ["Foundry VTT - Base package Manifest"] = 321,
    ["Foundry VTT - Module Manifest"] = 322,
    ["Foundry VTT - System Data Template"] = 325,
    ["Foundry VTT - System Manifest"] = 323,
    ["Foundry VTT - World Manifest"] = 324,
    ["Foxx Manifest"] = 81,
    ["Freifunk.de Community API"] = 84,
    ["Frogbot Config"] = 85,
    ["G2P Mapping Configuration"] = 332,
    ["GCP Blueprint Metadata"] = 335,
    Gaspar = 333,
    ["GatewayCore API Gateway"] = 334,
    ["GeoJSON.json latest"] = 949,
    GherKing = 953,
    ["GitHub Action"] = 340,
    ["GitHub Actions typing"] = 1068,
    ["GitHub Discussion"] = 341,
    ["GitHub Funding"] = 342,
    ["GitHub Issue Template configuration"] = 343,
    ["GitHub Issue Template forms"] = 344,
    ["GitHub Workflow"] = 345,
    ["GitHub Workflow Template Properties"] = 346,
    ["GitHub automatically generated release notes configuration"] = 347,
    ["GitLab Agent for Kubernetes configuration"] = 1024,
    GitVersion = 337,
    ["Gitea Issue Template configuration"] = 338,
    ["Gitea Issue Template forms"] = 339,
    ["Gitpod Automations"] = 349,
    ["Gitpod Configuration"] = 350,
    ["GlazeWM settings"] = 1026,
    ["Global Privacy Control"] = 336,
    Goblet = 1005,
    ["Golangci-lint Configuration"] = 365,
    ["Golangci-lint Custom Plugins Configuration"] = 366,
    ["Google Chrome Related Website Sets"] = 317,
    ["Google Cloud Workflows"] = 220,
    ["Google Digital Assetlinks"] = 1109,
    Goreleaser = 368,
    ["Goreleaser Pro"] = 369,
    Goss = 370,
    ["Gradle Build Cache Node"] = 900,
    ["Gradle Enterprise"] = 899,
    ["Grafana 5.x Dashboard"] = 371,
    ["GraphQL Code Generator"] = 376,
    ["GraphQL Config"] = 375,
    ["GraphQL Mesh"] = 374,
    ["Grunt JSHint task"] = 380,
    ["Grunt Watch task"] = 381,
    ["Grunt base task"] = 382,
    ["Grunt clean task"] = 378,
    ["Grunt copy task"] = 377,
    ["Grunt cssmin task"] = 379,
    HEMTT = 866,
    Hadolint = 880,
    Hammerkit = 910,
    ["Hardware Sentry Configuration"] = 965,
    ["HashiCorp Vault"] = 383,
    Hatch = 881,
    Hayagriva = 385,
    Hayson = 386,
    ["Haystack Pipeline"] = 387,
    ["Hazelcast 5 Configuration"] = 388,
    ["Hecate Input Schema"] = 1120,
    ["Helm Chart.lock"] = 188,
    ["Helm Chart.yaml"] = 187,
    ["Helm Unittest Test Suite"] = 189,
    ["Home Assistant Integration Manifest"] = 389,
    ["Homer dashboard configuration"] = 390,
    Hugo = 941,
    ["Hugo Theme"] = 940,
    ["Hulak Configuration"] = 397,
    ["Hyperfoil benchmark configuration"] = 396,
    ["IBM Zapp document"] = 398,
    ["IBM zCodeFormatSettings"] = 399,
    ["IMG Catapult PSP"] = 404,
    ["IVMS101 by CODE Protocol"] = 1025,
    Infrahub = 406,
    Istanbul = 968,
    ["JDownloader2 crawler multi-rules"] = 416,
    ["JDownloader2 crawler single-rules"] = 415,
    ["JFrog Applications Config"] = 417,
    ["JFrog File Spec"] = 418,
    ["JFrog Pipelines YML DSL"] = 974,
    ["JMeter DSL cli config"] = 419,
    JReleaser = 422,
    ["JSON Document Transform"] = 430,
    ["JSON Feed"] = 431,
    ["JSON Resume"] = 656,
    ["JSON Schema Draft 2020-12"] = 848,
    ["JSON Schema Draft 4"] = 845,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1007,
    ["JSON Schema Draft 7"] = 846,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1008,
    ["JSON Schema Draft 8 (2019-09)"] = 847,
    ["JSON-API"] = 429,
    ["JSON-e templates"] = 907,
    ["JSON-stat 2.0"] = 841,
    JSONPatch = 433,
    ["JSR Package Config (jsr.json)"] = 423,
    Jasmine = 410,
    Jekyll = 411,
    ["Jenkins X Pipelines"] = 412,
    ["Jenkins X Requirements"] = 413,
    Jest = 414,
    Jocker = 420,
    ["Jovo Language Models"] = 421,
    ["Jujutsu (jj) VCS config"] = 1122,
    ["KIMMDY config file"] = 444,
    ["KODE/CI build.yaml"] = 970,
    ["KSP-AVC"] = 842,
    ["KSP-CKAN"] = 843,
    ["KSP-NetKAN"] = 844,
    KSY = 1037,
    KSail = 330,
    ["Karakum configuration file"] = 328,
    Kas = 436,
    ["Kestra flow file"] = 445,
    ["Keycloak REST API"] = 977,
    ["Knative Functions - func.yaml"] = 329,
    ["Kometa (nightly) config file"] = 447,
    ["Kometa config file"] = 446,
    ["Kong DBLess config"] = 971,
    KrakenD = 448,
    ["Kubri Configuration"] = 455,
    LOOBin = 470,
    ["Lake configuration file"] = 1125,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 225,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 226,
    ["Landing Zone Accelerator on AWS - Global Config"] = 227,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 228,
    ["Landing Zone Accelerator on AWS - Network Config"] = 229,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 230,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 231,
    ["Landing Zone Accelerator on AWS - Security Config"] = 232,
    ["Lando (landofile)"] = 75,
    ["LangGraph Platform configuration"] = 1048,
    ["Language configuration"] = 1047,
    Lefthook = 459,
    ["Liferay client-extension.yaml"] = 466,
    ["LinkML Metamodel"] = 468,
    Liquibase = 916,
    ["Liquibase Flow File"] = 917,
    ["Lively Properties"] = 469,
    ["Lobe AI Agent"] = 77,
    Loki = 78,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 510,
    ["MS2Rescore Configuration"] = 513,
    ["Madness (madness.yml)"] = 988,
    ["Mado configuration"] = 476,
    ["MapEHR Mapping"] = 477,
    Markdownlint = 920,
    ["Mason Registry"] = 923,
    ["MegaLinter Custom Flavor"] = 480,
    ["MegaLinter configuration"] = 479,
    ["MegaLinter descriptor"] = 481,
    Melange = 1015,
    ["Meltano project definition"] = 482,
    ["Mergify Configuration"] = 514,
    ["Metadata for a Bazel module"] = 483,
    ["Metadata for a Cinnamon spice"] = 1064,
    ["Metatype Configuration"] = 484,
    ["MetricsHub Configuration"] = 485,
    ["MetricsHub Connector Configuration"] = 486,
    ["Micro Editor Syntax"] = 998,
    ["Microsoft Band Web Tile"] = 487,
    ["Microsoft RulesEngine workflow rules"] = 1052,
    ["Microsoft RulesEngine workflow rules list"] = 1053,
    ["Minecraft Custom Main Menu Mod"] = 1016,
    ["Minecraft Data Pack Advancement"] = 489,
    ["Minecraft Data Pack Biome"] = 490,
    ["Minecraft Data Pack Configured Carver"] = 491,
    ["Minecraft Data Pack Damage Type"] = 492,
    ["Minecraft Data Pack Dimension"] = 494,
    ["Minecraft Data Pack Dimension Type"] = 493,
    ["Minecraft Data Pack Item Modifier"] = 495,
    ["Minecraft Data Pack Loot Table"] = 496,
    ["Minecraft Data Pack Metadata"] = 497,
    ["Minecraft Data Pack Predicate"] = 498,
    ["Minecraft Data Pack Recipe"] = 499,
    ["Minecraft Data Pack Tag"] = 500,
    ["Minecraft Data Pack Template Pool"] = 501,
    ["Minecraft Data Pack Trim Material"] = 506,
    ["Minecraft Data Pack Trim Pattern"] = 507,
    ["Minecraft Resource Pack Lang"] = 502,
    ["Minecraft Resource Pack Particle"] = 503,
    ["Minecraft Resource Pack Texture Mcmeta"] = 505,
    ["Minecraft Resourcepack Sounds"] = 504,
    ["Monade CLI Stack Configuration"] = 517,
    ["MongoDB Atlas Search Index Definition"] = 969,
    ["Monika Configuration"] = 967,
    ["Monoweave Configuration"] = 512,
    ["Motif config"] = 862,
    MultiQC = 1102,
    ["NOX Framework (Service)"] = 530,
    ["Netin Diagnostic System Template"] = 927,
    ["Netlify config"] = 520,
    ["Network-as-Code Data Model"] = 521,
    ["Nightwatch.js"] = 523,
    ["Node.js configuration"] = 867,
    ["NueJS configuration file"] = 535,
    ["Nuitka.yaml"] = 1030,
    ["Nullstone config"] = 537,
    ["ONe's changelog entry"] = 551,
    ["ONe's service descriptor"] = 550,
    ["ORT Server repository environment configuration"] = 559,
    ["OSCAL Assessment Plan (AP)"] = 561,
    ["OSCAL Assessment Results (AR)"] = 562,
    ["OSCAL Catalog"] = 563,
    ["OSCAL Component Definition (CDef)"] = 564,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 565,
    ["OSCAL Profile"] = 566,
    ["OSCAL System Security Plan (SSP)"] = 567,
    ["OSS Review Toolkit configuration"] = 568,
    ["OSS Review Toolkit curation"] = 569,
    ["OSS Review Toolkit package configuration"] = 570,
    ["OSS Review Toolkit repository configuration"] = 571,
    ["OSS Review Toolkit resolutions"] = 572,
    ["October CMS columns"] = 541,
    ["October CMS fields"] = 542,
    Okteto = 543,
    Opctl = 865,
    ["Open Data Contract Standard (ODCS)"] = 554,
    ["Open Data Product Standard (ODPS)"] = 555,
    ["Open Know-How"] = 1107,
    ["OpenRewrite Resource"] = 553,
    OpenStatus = 1118,
    ["OpenUtau character yaml"] = 547,
    ["OpenUtau ustx"] = 548,
    ["OpenWeather Current Weather API"] = 906,
    ["OpenWeather Road Risk API"] = 905,
    ["Ory Hydra configuration"] = 395,
    ["Ory Keto configuration"] = 452,
    ["Ory Kratos configuration"] = 560,
    ["Ory Oathkeeper configuration"] = 539,
    ["Outblocks App configuration"] = 557,
    ["Outblocks database table"] = 558,
    ["Outblocks project configuration"] = 556,
    PDM = 578,
    Packer = 575,
    Pantsbuild = 984,
    ["Paper paper-plugin.yml"] = 576,
    ["Pipeline component"] = 918,
    ["Platform.sh application"] = 2,
    ["Platform.sh routes"] = 3,
    ["Platform.sh services"] = 4,
    ["Plex Prerolls"] = 586,
    ["PocketMine plugin.yml"] = 583,
    ["Postman collection"] = 590,
    ["Power Pages Configuration"] = 1119,
    ["Preset list for a WinUtil"] = 1067,
    ["ProActions AI-Kit Configuration"] = 599,
    ["ProActions AI-Kit Configuration for Menus"] = 601,
    ["ProActions AI-Kit Configuration for Sections"] = 603,
    ["ProActions AI-Kit Configuration for Services"] = 600,
    ["ProActions AI-Kit Configuration for Steps"] = 604,
    ["ProActions AI-Kit Configuration for Templates"] = 602,
    ["Problem object RFC9457"] = 1013,
    ["Problem package generators"] = 605,
    Pterodactyl = 964,
    ["Pull Request Labeler"] = 621,
    Pulumi = 629,
    ["PyGTA Config"] = 625,
    PyProject = 630,
    Pylock = 1110,
    Pyright = 631,
    ["Python script metadata"] = 1104,
    ["QType AI DSL"] = 634,
    Qgoda = 633,
    Qodana = 937,
    ["Qt Creator workspace file"] = 1045,
    ["Quali Torque Blueprint Spec 2"] = 962,
    ["QueryFirst config file"] = 980,
    ["RKE Cluster Configuration JSON"] = 915,
    ["RKE Cluster Configuration YAML"] = 914,
    RadioHound = 624,
    Railway = 635,
    ["Rancher Fleet"] = 626,
    ["Rattler-build"] = 636,
    Ray = 879,
    ["Read the Docs"] = 628,
    ["Red-DiscordBot Cog"] = 643,
    ["Red-DiscordBot Cog Repo"] = 644,
    ["Red-DiscordBot Trivia"] = 645,
    ["Render Blueprints"] = 913,
    RenderCV = 658,
    Renovate = 657,
    ["Replit config"] = 651,
    Restate = 1097,
    ["Revel Digital Gadget Definition File"] = 1121,
    RoadRunner = 660,
    ["Robust Station Image"] = 1127,
    ["Roo Coder Custom Modes"] = 662,
    Rubocop = 653,
    ["Rudder techniques"] = 1020,
    Ruff = 654,
    ["Rust Project"] = 655,
    ["Rust toolchain"] = 665,
    ["SDMX data message"] = 691,
    ["SDMX metadata message"] = 690,
    ["SDMX structure message"] = 689,
    ["SIL Kit Participant Configuration"] = 701,
    ["SIL Kit Registry Configuration"] = 702,
    ["SPDX 2.3"] = 738,
    SWADL = 754,
    ["Safebox Config"] = 975,
    ["Sapphire CLI Config"] = 668,
    ["SauceCTL Configuration"] = 924,
    ["Schema Catalog"] = 683,
    ["Scoop manifest"] = 688,
    ["Semantic Data Fabric (SDF) file"] = 692,
    ["Semgrep Rule"] = 694,
    ["Serenity Code Generator (Sergen)"] = 695,
    ["Serverless Framework Configuration"] = 931,
    ["Serverless Workflow"] = 933,
    ["Settings for a Cinnamon spice"] = 1063,
    ["Settings.paf"] = 697,
    ["Shopware 6 Configuration"] = 934,
    ["Shopware CLI Extension Store Configuration"] = 935,
    ["Shopware CLI Project Store Configuration"] = 936,
    ["Sigma Detection Rule"] = 699,
    ["Sigrid scope configuration file"] = 700,
    ["SkyPilot Task JSON"] = 1021,
    ["Slack app manifest"] = 704,
    Solidarity = 709,
    ["Solution filters"] = 710,
    ["Source Maps v3"] = 711,
    Sourcery = 712,
    ["Spack bootstrap.yaml"] = 713,
    ["Spack cdash.yaml"] = 714,
    ["Spack ci.yaml"] = 715,
    ["Spack compilers.yaml"] = 716,
    ["Spack concretizer.yaml"] = 717,
    ["Spack config.yaml"] = 718,
    ["Spack definitions.yaml"] = 719,
    ["Spack develop.yaml"] = 720,
    ["Spack env_vars.yaml"] = 721,
    ["Spack environment"] = 727,
    ["Spack include.yaml"] = 722,
    ["Spack mirrors.yaml"] = 723,
    ["Spack modules.yaml"] = 724,
    ["Spack packages.yaml"] = 725,
    ["Spack repos.yaml"] = 726,
    ["Spack toolchains.yaml"] = 728,
    ["Spack upstreams.yaml"] = 729,
    ["Spack view.yaml"] = 730,
    ["Speakeasy Generation Config File"] = 734,
    ["Speakeasy Lint Configuration File"] = 731,
    ["Speakeasy Test Generation Configuration File"] = 732,
    ["Speakeasy Workflow File"] = 733,
    SpecIF = 735,
    ["Sponge Mixin configuration"] = 736,
    StackBlitz = 742,
    ["StackHawk Scanner Configuration"] = 930,
    Stale = 743,
    Starfish = 744,
    ["Starlake Data Pipeline"] = 903,
    Starship = 745,
    ["Statamic Blueprint"] = 746,
    ["Stella configuration file"] = 747,
    ["Streamlit configuration file"] = 748,
    ["Stryker Mutator"] = 751,
    ["StyleCop Analyzers Configuration"] = 752,
    ["Stylelint (.stylelintrc)"] = 753,
    ["Stylua Config"] = 1111,
    ["Sublime Syntax"] = 976,
    ["Subsquid squid manifest"] = 1023,
    ["Swagger API 2.0"] = 755,
    ["Synadia Connect Component"] = 756,
    TSON = 791,
    TSTyche = 792,
    ["TYPO3 Vendor Bundler config"] = 797,
    ["Tab data for a LinUtil"] = 1070,
    ["Tab list for a LinUtil"] = 1069,
    Tach = 757,
    ["Tach Domain"] = 758,
    Talhelper = 760,
    ["Talisman configuration"] = 761,
    Taplo = 1112,
    ["Taskfile config"] = 908,
    Taurus = 762,
    Tauticord = 763,
    Telefonistka = 1098,
    ["Terrateam config"] = 1124,
    ["TestEnvironment.json"] = 774,
    ["TextMate Grammar"] = 773,
    Threagile = 769,
    ["Tier.run pricing.json"] = 766,
    Tikibase = 767,
    Tombi = 772,
    ["Traefik v2"] = 777,
    ["Traefik v2 File Provider"] = 778,
    ["Traefik v3"] = 779,
    ["Traefik v3 File Provider"] = 780,
    ["Travis CI (.travis.yml)"] = 776,
    Treefmt = 373,
    Trident = 1094,
    ["TrueScript for *.tscript files"] = 783,
    ["Tugboat QA config.yml"] = 1091,
    TunnelHub = 1011,
    Turborepo = 775,
    Tycho = 1059,
    Tye = 938,
    ["Tyk Gateway - Open Source v5.7+"] = 1103,
    ["Typst Manifest"] = 798,
    ["UET BuildConfig.json"] = 981,
    ["UI5 Manifest"] = 804,
    ["UNCORS configuration"] = 808,
    ["UTAM Page Object"] = 807,
    ["Ubuntu Server Autoinstall"] = 802,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1095,
    ["Uniswap Token List"] = 891,
    ["Universal Schedule Format"] = 809,
    ["Unreal Engine Uplugin"] = 982,
    ["Unreal Engine Uproject"] = 983,
    ["UpCloud CLI (upctl) configuration"] = 1096,
    ["Updatecli Compose"] = 946,
    ["Updatecli Policy Manifest"] = 947,
    ["Updatecli Policy Metadata"] = 948,
    Uplift = 979,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 912,
    V2Ray = 952,
    ["VSCode Code Snippets"] = 208,
    ["VSIX CLI publishing"] = 829,
    Vector = 811,
    ["Vela Pipeline Configuration"] = 814,
    Vercel = 207,
    ["Version Bumper config"] = 819,
    ["Viash Component Config"] = 1100,
    ["Viash Package Config"] = 1101,
    Visivo = 1009,
    ["WP-CLI"] = 839,
    Wake = 1093,
    ["Waku Config"] = 1073,
    ["Web App Manifest"] = 835,
    ["Web types"] = 838,
    WebExtensions = 834,
    ["Webman package recipe"] = 958,
    ["Windows Package Manager Installer Manifest"] = 887,
    ["Windows Package Manager Locale Manifest"] = 888,
    ["Windows Package Manager Singleton Manifest"] = 886,
    Winutil = 889,
    ["WireMock stub mapping"] = 1076,
    ["Woodpecker pipeline config"] = 926,
    ["Wrangler CLI"] = 840,
    ["Xstate Machine"] = 944,
    ["Yandex Workflow Language"] = 1065,
    ["Yarn Config (.yarnrc.yml)"] = 901,
    ["Yippee-Ki-JSON configuration YML"] = 893,
    ["YouTrack App"] = 1062,
    ["Zarf Package Configuration"] = 1126,
    ["Zerops.io config"] = 1050,
    ["Zerops.io import"] = 1051,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 1014,
    ...
    ["behat.yml"] = 106,
    ["bigquery-table"] = 95,
    ["bioimageio resource description"] = 1031,
    ...
    ["ccmod.json"] = 1074,
    changelogging = 1042,
    ["chisel-slices.json"] = 234,
    ["chrome-extension-locales-messages.json"] = 215,
    ["chutzpah.json"] = 216,
    cibuildwheel = 141,
    ["clang-format (.clang-format)"] = 950,
    ["clang-tidy"] = 195,
    clangd = 194,
    clib = 196,
    ["cloud-init: cloud-config userdata"] = 198,
    ["cloud-sdk-pipeline-configuration"] = 218,
    ["cloudbuild.json"] = 219,
    cloudify = 197,
    codemagic = 199,
    ["coffeelint.json"] = 236,
    ["commands.json"] = 211,
    ["commitlint (.commitlintrc)"] = 890,
    ["committed.toml"] = 237,
    ["compile_commands.json"] = 210,
    ["compilerconfig.json"] = 209,
    ["completely.yml"] = 987,
    ["component-detection-manifest.json"] = 240,
    ["component.json"] = 239,
    ["composer.json"] = 238,
    ["conda-forge"] = 144,
    ["config.yaml"] = 627,
    ["contentmanifest.json"] = 217,
    ["contribute.json"] = 241,
    ["cosmos.config.json"] = 213,
    ["crowdin.yml"] = 242,
    ["ctfd-setup configuration file"] = 1083,
    ["custom-elements.json"] = 1001,
    ["cypress.json"] = 246,
    ["datalogic-scan2deploy-android"] = 256,
    ["datalogic-scan2deploy-ce"] = 257,
    ...
    ["ddev-global"] = 258,
    ["ddev-project"] = 259,
    ["debugsettings.json"] = 260,
    ["dependabot-v2.json"] = 263,
    ["dependabot.json"] = 262,
    ["deployed-cli"] = 943,
    ["devcontainer.json"] = 201,
    devinit = 895,
    ["devspace.yaml"] = 966,
    djlint = 896,
    ["docker bake"] = 268,
    ["docker sequencer"] = 269,
    ["docker-compose.yml"] = 894,
    ["dockerd.json"] = 267,
    ["dotnet Release Index manifest"] = 280,
    ["dotnet-tools.json"] = 281,
    ["dotnetcli.host.json"] = 282,
    ["dprint.json"] = 283,
    ["drone.json"] = 284,
    ["dss-2.0.0.json"] = 286,
    ["dstack configuration"] = 287,
    ["dtool dataset metadata"] = 1078,
    ["dvc.yaml"] = 288,
    ["ecosystem.json"] = 293,
    eksctl = 294,
    ["electron-builder configuration file"] = 300,
    ["epr-manifest.json"] = 299,
    ["evcc.yaml"] = 301,
    ["ezd task runner"] = 311,
    ["fabric.mod.json"] = 313,
    ["first-timers-bot"] = 320,
    ["flagd flag configuration"] = 82,
    ["fly.io Configuration"] = 83,
    fulibWorkflows = 925,
    ["function.json"] = 331,
    ["gRPC API Gateway & OpenAPI Config"] = 7,
    ["gematik health care insurance list"] = 1089,
    ["gematik health care patient list"] = 1086,
    ["gematik health care provider institution list"] = 1088,
    ["gematik health care provider list"] = 1087,
    ["gematik tiger test environment configuration"] = 1090,
    ["gitlab-ci"] = 348,
    ["global.json"] = 364,
    ["go-feature-flag Flag Configuration"] = 367,
    ["haxelib.json"] = 384,
    helmfile = 882,
    helmwave = 883,
    ["host-meta.json"] = 392,
    ...
    ["ide.host.json"] = 400,
    ["ifstate.yaml"] = 401,
    ["imageoptimizer.json"] = 402,
    ["importmap.json"] = 405,
    ["ioBroker Configuration"] = 407,
    ["ioBroker JSON UI"] = 408,
    ["ioBroker Package manifest"] = 409,
    ["ize.toml"] = 978,
    ["jsconfig.json"] = 434,
    ["jscpd Configuration"] = 963,
    jsdoc = 878,
    ["k3d.yaml"] = 435,
    ["k9s aliases.yaml"] = 437,
    ["k9s cluster-config.yaml"] = 439,
    ["k9s config.yaml"] = 438,
    ["k9s hotkeys.yaml"] = 440,
    ["k9s plugins.yaml"] = 441,
    ["k9s skin.yaml"] = 442,
    ["k9s views.yaml"] = 443,
    ["kontinuous-config.yaml"] = 454,
    ["kontinuous-values.yaml"] = 453,
    ["kustomization.yaml"] = 456,
    ["label-commenter-config.yml"] = 457,
    ["latexindent configuration"] = 76,
    ["launchsettings.json"] = 458,
    lazydocker = 1000,
    lazygit = 999,
    ["lego.json"] = 460,
    ["lerna.json"] = 461,
    ["lgtm.yml"] = 462,
    ["liblab.config.json"] = 463,
    ["libman.json"] = 464,
    ["license-report-config.json"] = 465,
    ["linkinator.config.json"] = 467,
    ["lint-staged (.lintstagedrc)"] = 856,
    ["local.settings.json"] = 472,
    ["localazy.json"] = 473,
    ["lotus.yaml"] = 471,
    ["lsdlschema.json"] = 474,
    ["markdown-link-check"] = 921,
    maturin = 922,
    mboats = 929,
    ["micro-settings.json"] = 993,
    ["mimetypes.json"] = 488,
    ["mirrord config"] = 858,
    mise = 859,
    ["mkdocs.yml"] = 508,
    ["monospace.yml"] = 511,
    ["moon.yml"] = 1075,
    ["mprocs Configuration file"] = 1046,
    ["mrdocs.yml"] = 509,
    ["mta.yaml"] = 860,
    ["mtad.yaml"] = 861,
    ["mycode.json"] = 518,
    nFPM = 522,
    ["napari plugin manifest"] = 519,
    neoload = 873,
    ["nest-cli"] = 525,
    ["ninjs (News in JSON)"] = 524,
    ["nitro.json"] = 872,
    ["nixd configuration"] = 1019,
    ["nlu.json"] = 526,
    ["nodemon.json"] = 528,
    ["noodl config"] = 928,
    ["notebook.mod.json"] = 529,
    now = 868,
    ["npm-badges"] = 532,
    ["nswag.json"] = 536,
    ntangle = 538,
    ["nuclei-template.yaml"] = 533,
    ["nuget-project.json"] = 534,
    ["ocelot.json"] = 540,
    ["omnisharp.json"] = 544,
    ["openapi.json"] = 545,
    ["openfin.json"] = 552,
    ...
    ["ops.yaml"] = 549,
    ["package.json"] = 573,
    ["package.manifest"] = 574,
    ["partial-black.json"] = 107,
    ["pathfinder.yml"] = 577,
    ["pattern.json"] = 580,
    ["petstore-v1.0"] = 973,
    pgap_yaml_input_reader = 579,
    ["pixi.toml"] = 581,
    ["plagiarize-me.yaml"] = 585,
    ["plagiarize.yaml"] = 584,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1079,
    ["podbard.yaml"] = 587,
    ["portman.json"] = 588,
    ["prefect.toml"] = 596,
    ["prettierrc.json"] = 597,
    ["prisma.yml"] = 598,
    ["project-1.0.0-beta3.json"] = 607,
    ["project-1.0.0-beta4.json"] = 608,
    ["project-1.0.0-beta5.json"] = 609,
    ["project-1.0.0-beta6.json"] = 610,
    ["project-1.0.0-beta8.json"] = 611,
    ["project-1.0.0-rc1.json"] = 612,
    ["project-1.0.0-rc2.json"] = 613,
    ["project.json"] = 606,
    ["project.owasp.yaml"] = 614,
    ["prometheus.json"] = 615,
    ["prometheus.rules.json"] = 616,
    ["prometheus.rules.test.json"] = 617,
    ["proxies.json"] = 618,
    ["publiccode.yml"] = 619,
    ["pubspec.yaml"] = 620,
    ["pyrseas-0.8.json"] = 623,
    pytest = 632,
    ["quilt.mod.json"] = 994,
    ["rc3 auth"] = 637,
    ["rc3 collection"] = 638,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 874,
    ["release-please-config.json"] = 647,
    ["release-please-manifest.json"] = 648,
    ["release-plz.toml"] = 649,
    ["renv.lock"] = 659,
    ["rivet.json"] = 1018,
    ["rivet.yaml (legacy)"] = 1017,
    rockcraft = 661,
    runny = 663,
    rustfmt = 664,
    sake = 1106,
    samt = 666,
    samtrc = 667,
    ["sarif-1.0.0.json"] = 669,
    ["sarif-2.0.0.json"] = 670,
    ["sarif-2.1.0"] = 680,
    ["sarif-2.1.0-rtm.2"] = 671,
    ["sarif-2.1.0-rtm.3"] = 673,
    ["sarif-2.1.0-rtm.4"] = 675,
    ["sarif-2.1.0-rtm.5"] = 677,
    ["sarif-2.1.0-rtm.6"] = 678,
    ["sarif-external-property-file-2.1.0"] = 681,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 672,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 674,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 676,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 679,
    ["scalingo.json configuration"] = 682,
    ["schema.org - Action"] = 684,
    ["schema.org - ContactPoint"] = 685,
    ["schema.org - Place"] = 686,
    ["schema.org - Thing"] = 687,
    ["secrethub.yml"] = 996,
    ["semantic-release"] = 693,
    ["servicehub.config.json"] = 851,
    ["servicehub.service.json"] = 850,
    ["settings.job"] = 696,
    ["sfdx-hardis configuration"] = 698,
    ["shard.yml"] = 1034,
    ["size-limit configuration"] = 703,
    ["skaffold.yaml"] = 919,
    ["skyuxconfig.json"] = 705,
    snapcraft = 706,
    ["snowflake-config"] = 707,
    ["snowflake-connections"] = 708,
    ["spicepod.yaml"] = 1054,
    ["sqlc configuration"] = 739,
    ["stripe-app-local.json"] = 750,
    ["stripe-app.json"] = 749,
    swcrc = 904,
    ["task.json"] = 759,
    taskcat = 869,
    ["template.json"] = 764,
    ["templatsources.json"] = 765,
    ["theme.json"] = 768,
    ["tizen_workspace.json"] = 770,
    tldr = 771,
    ["tm_devices configuration file"] = 1117,
    tmuxinator = 854,
    ["transcend.yml"] = 781,
    ["tree-sitter grammar.json"] = 372,
    ["trime.yaml"] = 782,
    ["trunk.yaml"] = 784,
    ["ts-force-config.json"] = 789,
    ["tsconfig.json"] = 785,
    ["tsd.json"] = 786,
    ["tsdoc.json"] = 787,
    ["tsdrc.json"] = 788,
    ...
    v8r = 833,
    vcluster = 1040,
    ["vcpkg configuration file"] = 206,
    ["vcpkg manifest file"] = 205,
    ["vega-lite.json"] = 813,
    ["vega.json"] = 812,
    ["venvironment-basic.yaml"] = 816,
    ["venvironment.yaml"] = 815,
    ["venvplus-basic.yaml"] = 818,
    ["venvplus.yaml"] = 817,
    version = 1099,
    ["version.json"] = 820,
    ["vhwdebugger-binding.yaml"] = 822,
    ["vim-addon-info"] = 823,
    ["vs-2017.3.host.json"] = 825,
    ["vs-nesting.json"] = 826,
    ["vsls.json"] = 824,
    ["vss-extension.json"] = 830,
    vtcfg = 1105,
    ["vtesttree.yaml"] = 831,
    ["vtestunit.yaml"] = 832,
    ["warp-keysets.json"] = 1002,
    ["warp-themes.json"] = 1003,
    ["warp-workflows.json"] = 1004,
    ["webhint.io"] = 959,
    ["webjobpublishsettings.json"] = 837,
    ["webjobs-list.json"] = 836,
    ["well-known-fursona"] = 1041,
    ["xs-app.json"] = 864,
    ["xunit.runner.json"] = 849,
    yamllint = 892,
    zuul = 875,
    ["Žinoma"] = 885
  },
