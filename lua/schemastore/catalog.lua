...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1022,
    ["API Builder"] = 839,
    ["AVA Configuration"] = 901,
    ...
    ["Adobe UXP Manifest"] = 961,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 873,
    ["All Contributors configuration file"] = 926,
    ...
    ["Application list for a WinUtil"] = 1004,
    ArchitectFX = 1009,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure Pipelines"] = 76,
    ["Azure Static Web Apps CLI configuration file"] = 690,
    ["Azure Static Web Apps configuration file"] = 689,
    ["BOSH Deploy Config"] = 100,
    ["BX CI"] = 118,
    ["Bashly (bashly.yml)"] = 930,
    ["Bashly Settings (bashly-settings.yml)"] = 931,
    ["Better Code Hub"] = 843,
    ["Better Scripts"] = 119,
    Bigconfig = 93,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1015,
    BizTalkServerApplicationSchema = 811,
    Bleep = 120,
    ...
    ["Butane Config"] = 886,
    C4InterFlow = 1030,
    ["CGS Card Game Specification (cgs.json)"] = 966,
    ["CICS TS region tagging"] = 895,
    ["CICS TS resource import"] = 896,
    ["CICS TS resource model"] = 897,
    ["CICS TS resource overrides"] = 898,
    ["CMake Presets"] = 121,
    ["CNC Codes"] = 138,
    ["CRS WAF test file"] = 994,
    ["CRS WAF test platform overrides file"] = 995,
    ...
    ["Chamaleon environment"] = 1019,
    ["Chamaleon properties"] = 1020,
    ["Chamaleon template"] = 1018,
    Changesets = 221,
    Charmcraft = 130,
    Cheatsheets = 883,
    ...
    CityJSON = 133,
    ["Clawject config"] = 144,
    ["Cloud Foundry Application Manifest"] = 977,
    ["Cloud Run Spec v1"] = 999,
    ...
    Concord = 993,
    ["Configu .cfgu files"] = 982,
    ["Configu .configu file"] = 983,
    Conjure = 137,
    ["Container Structure Test"] = 825,
    Containerlab = 852,
    ["Contextive Glossary"] = 1044,
    Convex = 136,
    ["Crowdsec collection config"] = 231,
    ["Crowdsec parser config"] = 232,
    ["Crowdsec scenario config"] = 233,
    ["CumulusCI Config"] = 143,
    ["Custom Machinery Machine"] = 967,
    ["Custom Machinery Recipe"] = 968,
    ...
    ["DonateCaseBetterCasino menu"] = 1023,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 938,
    ["EAS config"] = 297,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 927,
    ["EasyVCR .NET"] = 298,
    ["Eidolon Resource"] = 1010,
    ...
    ["GeoJSON.json latest"] = 890,
    GherKing = 894,
    ["GitHub Action"] = 328,
    ["GitHub Actions typing"] = 1006,
    ...
    ["Google Digital Assetlinks"] = 1045,
    Goreleaser = 356,
    ["Goreleaser Pro"] = 357,
    Goss = 358,
    ["Gradle Build Cache Node"] = 841,
    ["Gradle Enterprise"] = 840,
    ...
    Hadolint = 821,
    Hammerkit = 851,
    ["Hardware Sentry Configuration"] = 906,
    Hatch = 822,
    Hayson = 371,
    ...
    ["JFrog File Spec"] = 401,
    ["JFrog Pipelines YML DSL"] = 915,
    ["JMeter DSL cli config"] = 402,
    JReleaser = 404,
    ["JSON Document Transform"] = 412,
    ["JSON Feed"] = 413,
    ["JSON Resume"] = 624,
    ["JSON Schema Draft 2020-12"] = 790,
    ["JSON Schema Draft 4"] = 787,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 948,
    ["JSON Schema Draft 7"] = 788,
    ["JSON Schema Draft 7 (unofficial strict)"] = 949,
    ["JSON Schema Draft 8 (2019-09)"] = 789,
    ["JSON-API"] = 411,
    ["JSON-e templates"] = 848,
    ["JSON-stat 2.0"] = 783,
    JSONPatch = 415,
    ...
    ["Metadata for a Cinnamon spice"] = 1002,
    ["Metatype Configuration"] = 463,
    ["MetricsHub Configuration"] = 464,
    ["MetricsHub Connector Configuration"] = 465,
    ["Micro Editor Syntax"] = 939,
    ["Microsoft Band Web Tile"] = 466,
    ["Microsoft RulesEngine workflow rules"] = 990,
    ["Microsoft RulesEngine workflow rules list"] = 991,
    ["Minecraft Custom Main Menu Mod"] = 956,
    ...
    ["MongoDB Atlas Search Index Definition"] = 910,
    ["Monika Configuration"] = 908,
    ["Monoweave Configuration"] = 491,
    ["Motif config"] = 803,
    MultiQC = 1038,
    ["NOX Framework (Service)"] = 508,
    ["Netin Diagnostic System Template"] = 868,
    ["Netlify config"] = 499,
    ["Network-as-Code Data Model"] = 500,
    ["Nightwatch.js"] = 501,
    ["Node.js configuration"] = 808,
    ...
    ["OpenUtau ustx"] = 526,
    ["OpenWeather Current Weather API"] = 847,
    ["OpenWeather Road Risk API"] = 846,
    ...
    ["Preset list for a WinUtil"] = 1005,
    ["Problem object RFC9457"] = 953,
    ["Problem package generators"] = 575,
    Pterodactyl = 905,
    ["Pull Request Labeler"] = 591,
    Pulumi = 599,
    ["PyGTA Config"] = 595,
    PyProject = 600,
    Pylock = 1046,
    Pyright = 601,
    ["Python script metadata"] = 1040,
    Qgoda = 603,
    Qodana = 878,
    ["Qt Creator workspace file"] = 984,
    ["Quali Torque Blueprint Spec 2"] = 903,
    ["QueryFirst config file"] = 921,
    ["RKE Cluster Configuration JSON"] = 856,
    ["RKE Cluster Configuration YAML"] = 855,
    RadioHound = 594,
    Railway = 604,
    ["Rancher Fleet"] = 596,
    ["Rattler-build"] = 605,
    Ray = 820,
    ["Read the Docs"] = 598,
    ["Red-DiscordBot Cog"] = 612,
    ["Red-DiscordBot Cog Repo"] = 613,
    ["Red-DiscordBot Trivia"] = 614,
    ["Render Blueprints"] = 854,
    RenderCV = 626,
    Renovate = 625,
    ["Replit config"] = 620,
    Restate = 1033,
    RoadRunner = 628,
    ["Rudder techniques"] = 959,
    Ruff = 622,
    ["Rust Project"] = 623,
    ["Rust toolchain"] = 632,
    ["SDMX data message"] = 658,
    ["SDMX metadata message"] = 657,
    ["SDMX structure message"] = 656,
    ["SIL Kit Participant Configuration"] = 668,
    ["SIL Kit Registry Configuration"] = 669,
    ["SPDX 2.3"] = 687,
    SWADL = 701,
    ["Safebox Config"] = 916,
    ["Sapphire CLI Config"] = 635,
    ["SauceCTL Configuration"] = 865,
    ["Schema Catalog"] = 650,
    ["Scoop manifest"] = 655,
    ["Semantic Data Fabric (SDF) file"] = 659,
    ["Semgrep Rule"] = 661,
    ["Serenity Code Generator (Sergen)"] = 662,
    ["Serverless Framework Configuration"] = 872,
    ["Serverless Workflow"] = 874,
    ["Settings for a Cinnamon spice"] = 1001,
    ["Settings.paf"] = 664,
    ["Shopware 6 Configuration"] = 875,
    ["Shopware CLI Extension Store Configuration"] = 876,
    ["Shopware CLI Project Store Configuration"] = 877,
    ["Sigma Detection Rule"] = 666,
    ["Sigrid scope configuration file"] = 667,
    ["SkyPilot Task JSON"] = 960,
    ["Slack app manifest"] = 671,
    Solidarity = 676,
    ["Solution filters"] = 677,
    ["Source Maps v3"] = 678,
    Sourcery = 679,
    ["Speakeasy Generation Config File"] = 683,
    ["Speakeasy Lint Configuration File"] = 680,
    ["Speakeasy Test Generation Configuration File"] = 681,
    ["Speakeasy Workflow File"] = 682,
    SpecIF = 684,
    ["Sponge Mixin configuration"] = 685,
    StackBlitz = 691,
    ["StackHawk Scanner Configuration"] = 871,
    Stale = 692,
    ["Starlake Data Pipeline"] = 844,
    Starship = 693,
    ["Statamic Blueprint"] = 694,
    ["Stella configuration file"] = 695,
    ["Stryker Mutator"] = 698,
    ["StyleCop Analyzers Configuration"] = 699,
    ["Stylelint (.stylelintrc)"] = 700,
    ["Stylua Config"] = 1047,
    ["Sublime Syntax"] = 917,
    ["Subsquid squid manifest"] = 962,
    ["Swagger API 2.0"] = 702,
    ["Synadia Connect Component"] = 703,
    TSON = 737,
    TSTyche = 738,
    ["Tab data for a LinUtil"] = 1008,
    ["Tab list for a LinUtil"] = 1007,
    Tach = 704,
    ["Tach Domain"] = 705,
    Talhelper = 707,
    ...
    Tauticord = 710,
    Telefonistka = 1034,
    ["TestEnvironment.json"] = 720,
    ["TextMate Grammar"] = 719,
    ["Tier.run pricing.json"] = 713,
    Tikibase = 714,
    Tombi = 718,
    ["Traefik v2"] = 723,
    ["Traefik v2 File Provider"] = 724,
    ["Traefik v3"] = 725,
    ["Traefik v3 File Provider"] = 726,
    ["Travis CI (.travis.yml)"] = 722,
    Trident = 1032,
    ["TrueScript for *.tscript files"] = 729,
    ["Tugboat QA config.yml"] = 1029,
    TunnelHub = 952,
    Turborepo = 721,
    Tycho = 997,
    Tye = 879,
    ["Tyk Gateway - Open Source v5.7+"] = 1039,
    ["Typst Manifest"] = 743,
    ["UET BuildConfig.json"] = 922,
    ["UI5 Manifest"] = 749,
    ["UNCORS configuration"] = 753,
    ["UTAM Page Object"] = 752,
    ["Ubuntu Server Autoinstall"] = 747,
    ["Uniswap Token List"] = 832,
    ["Universal Schedule Format"] = 754,
    ["Unreal Engine Uplugin"] = 923,
    ["Unreal Engine Uproject"] = 924,
    ["Updatecli Compose"] = 887,
    ["Updatecli Policy Manifest"] = 888,
    ["Updatecli Policy Metadata"] = 889,
    Uplift = 920,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 853,
    V2Ray = 893,
    ["VSCode Code Snippets"] = 196,
    ["VSIX CLI publishing"] = 772,
    Vector = 756,
    ["Vela Pipeline Configuration"] = 759,
    Vercel = 195,
    ["Version Bumper config"] = 762,
    ["Viash Component Config"] = 1036,
    ["Viash Package Config"] = 1037,
    Visivo = 950,
    Wake = 1031,
    ["Waku Config"] = 1011,
    ["Web App Manifest"] = 778,
    ["Web types"] = 781,
    WebExtensions = 777,
    ["Webman package recipe"] = 899,
    ["Windows Package Manager Installer Manifest"] = 828,
    ["Windows Package Manager Locale Manifest"] = 829,
    ["Windows Package Manager Singleton Manifest"] = 827,
    Winutil = 830,
    ["WireMock stub mapping"] = 1014,
    ["Woodpecker pipeline config"] = 867,
    ["Wrangler CLI"] = 782,
    ["Xstate Machine"] = 885,
    ["Yandex Workflow Language"] = 1003,
    ["Yarn Config (.yarnrc.yml)"] = 842,
    ["Yippee-Ki-JSON configuration YML"] = 834,
    ["YouTrack App"] = 1000,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 954,
    ...
    ["behat.yml"] = 102,
    ["bigquery-table"] = 92,
    ["bioimageio resource description"] = 970,
    ...
    ["crowdin.yml"] = 230,
    ["ctfd-setup configuration file"] = 1021,
    ["custom-elements.json"] = 942,
    ["cypress.json"] = 234,
    ...
    ["gematik health care insurance list"] = 1027,
    ["gematik health care patient list"] = 1024,
    ["gematik health care provider institution list"] = 1026,
    ["gematik health care provider list"] = 1025,
    ["gematik tiger test environment configuration"] = 1028,
    ["gitlab-ci"] = 336,
    ["global.json"] = 352,
    ...
    ["lint-staged (.lintstagedrc)"] = 798,
    ["local.settings.json"] = 453,
    ["localazy.json"] = 454,
    ["lotus.yaml"] = 452,
    ["lsdlschema.json"] = 455,
    ["markdown-link-check"] = 862,
    maturin = 863,
    mboats = 870,
    ["micro-settings.json"] = 934,
    ["mimetypes.json"] = 467,
    ["mirrord config"] = 799,
    mise = 800,
    ["mkdocs.yml"] = 487,
    ...
    ["plagiarize.yaml"] = 560,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1017,
    ["podbard.yaml"] = 563,
    ["portman.json"] = 564,
    ["prefect.toml"] = 572,
    ["prettierrc.json"] = 573,
    ["prisma.yml"] = 574,
    ["project-1.0.0-beta3.json"] = 577,
    ["project-1.0.0-beta4.json"] = 578,
    ["project-1.0.0-beta5.json"] = 579,
    ["project-1.0.0-beta6.json"] = 580,
    ["project-1.0.0-beta8.json"] = 581,
    ["project-1.0.0-rc1.json"] = 582,
    ["project-1.0.0-rc2.json"] = 583,
    ["project.json"] = 576,
    ["project.owasp.yaml"] = 584,
    ["prometheus.json"] = 585,
    ["prometheus.rules.json"] = 586,
    ["prometheus.rules.test.json"] = 587,
    ["proxies.json"] = 588,
    ["publiccode.yml"] = 589,
    ["pubspec.yaml"] = 590,
    ["pyrseas-0.8.json"] = 593,
    pytest = 602,
    ["quilt.mod.json"] = 935,
    ["rc3 auth"] = 606,
    ["rc3 collection"] = 607,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 815,
    ["release-please-config.json"] = 616,
    ["release-please-manifest.json"] = 617,
    ["release-plz.toml"] = 618,
    ["renv.lock"] = 627,
    ["rivet.yaml"] = 957,
    rockcraft = 629,
    runny = 630,
    ...
    samt = 633,
    samtrc = 634,
    ["sarif-1.0.0.json"] = 636,
    ["sarif-2.0.0.json"] = 637,
    ["sarif-2.1.0"] = 647,
    ["sarif-2.1.0-rtm.2"] = 638,
    ["sarif-2.1.0-rtm.3"] = 640,
    ["sarif-2.1.0-rtm.4"] = 642,
    ["sarif-2.1.0-rtm.5"] = 644,
    ["sarif-2.1.0-rtm.6"] = 645,
    ["sarif-external-property-file-2.1.0"] = 648,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 639,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 641,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 643,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 646,
    ["scalingo.json configuration"] = 649,
    ["schema.org - Action"] = 651,
    ["schema.org - ContactPoint"] = 652,
    ["schema.org - Place"] = 653,
    ["schema.org - Thing"] = 654,
    ["secrethub.yml"] = 937,
    ["semantic-release"] = 660,
    ["servicehub.config.json"] = 793,
    ["servicehub.service.json"] = 792,
    ["settings.job"] = 663,
    ["sfdx-hardis configuration"] = 665,
    ["shard.yml"] = 973,
    ["size-limit configuration"] = 670,
    ["skaffold.yaml"] = 860,
    ["skyuxconfig.json"] = 672,
    snapcraft = 673,
    ["snowflake-config"] = 674,
    ["snowflake-connections"] = 675,
    ["spicepod.yaml"] = 992,
    ["sqlc configuration"] = 688,
    ["stripe-app-local.json"] = 697,
    ["stripe-app.json"] = 696,
    swcrc = 845,
    ["task.json"] = 706,
    taskcat = 810,
    ["template.json"] = 711,
    ["templatsources.json"] = 712,
    ["theme.json"] = 715,
    ["tizen_workspace.json"] = 716,
    tldr = 717,
    tmuxinator = 796,
    ["transcend.yml"] = 727,
    ...
    ["vega-lite.json"] = 758,
    ["vega.json"] = 757,
    ["venvironment-basic.yaml"] = 761,
    ["venvironment.yaml"] = 760,
    version = 1035,
    ["version.json"] = 763,
    ["vhwdebugger-binding.yaml"] = 765,
    ["vim-addon-info"] = 766,
    ["vs-2017.3.host.json"] = 768,
    ["vs-nesting.json"] = 769,
    ["vsls.json"] = 767,
    ["vss-extension.json"] = 773,
    vtcfg = 1041,
    ["vtesttree.yaml"] = 774,
    ["vtestunit.yaml"] = 775,
    ["warp-keysets.json"] = 943,
    ["warp-themes.json"] = 944,
    ["warp-workflows.json"] = 945,
    ["webhint.io"] = 900,
    ["webjobpublishsettings.json"] = 780,
    ["webjobs-list.json"] = 779,
    ["well-known-fursona"] = 980,
    ["xs-app.json"] = 805,
    ["xunit.runner.json"] = 791,
    yamllint = 833,
    ["zerops.io import file"] = 989,
    ["zerops.yml"] = 988,
    zuul = 816,
    ["Žinoma"] = 826
  },
