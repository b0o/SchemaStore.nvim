...
M.json = {
  ...
  index = {
    ...
    ["Adobe UXP Manifest"] = 904,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Alacritty Configuration"] = 816,
    ["All Contributors configuration file"] = 869,
    ...
    ["Application list for a WinUtil"] = 948,
    ArchitectFX = 952,
    ["Argo Events"] = 28,
    ["Argo Workflows"] = 29,
    AssemblyScript = 32,
    ...
    ["BX CI"] = 105,
    ["Bashly (bashly.yml)"] = 873,
    ["Bashly Settings (bashly-settings.yml)"] = 874,
    ["Better Code Hub"] = 788,
    ["Better Scripts"] = 106,
    Bigconfig = 81,
    ["Bitmovin Encoding Template"] = 958,
    ...
    ["Butane Config"] = 829,
    ["CGS Custom Card Game (CardGameDef.json)"] = 909,
    ["CICS TS region tagging"] = 838,
    ["CICS TS resource import"] = 839,
    ["CICS TS resource model"] = 840,
    ["CICS TS resource overrides"] = 841,
    ["CMake Presets"] = 108,
    ["CNC Codes"] = 123,
    ["CRS WAF test file"] = 938,
    ["CRS WAF test platform overrides file"] = 939,
    ...
    CityJSON = 119,
    ["Clawject config"] = 128,
    ["Cloud Foundry Application Manifest"] = 921,
    ["Cloud Run Spec v1"] = 943,
    ...
    Concord = 937,
    ["Configu .cfgu files"] = 926,
    ["Configu .configu file"] = 927,
    Conjure = 122,
    ["Container Structure Test"] = 771,
    Containerlab = 796,
    ["Crowdsec collection config"] = 212,
    ["Crowdsec parser config"] = 213,
    ["Crowdsec scenario config"] = 214,
    ["CumulusCI Config"] = 127,
    ["Custom Machinery Machine"] = 910,
    ["Custom Machinery Recipe"] = 911,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 881,
    ["EAS config"] = 278,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 870,
    ["EasyVCR .NET"] = 279,
    ["Eidolon Resource"] = 953,
    ...
    ["Goreleaser Pro"] = 335,
    Goss = 336,
    ["Gradle Build Cache Node"] = 786,
    ["Gradle Enterprise"] = 785,
    ...
    Hadolint = 767,
    Hammerkit = 795,
    ["Hardware Sentry Configuration"] = 849,
    Hatch = 768,
    Hayson = 349,
    ...
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 891,
    ["JSON Schema Draft 7"] = 736,
    ["JSON Schema Draft 7 (unofficial strict)"] = 892,
    ["JSON Schema Draft 8 (2019-09)"] = 737,
    ["JSON-API"] = 387,
    ["JSON-WF"] = 920,
    ["JSON-e templates"] = 793,
    ["JSON-stat 2.0"] = 731,
    JSONPatch = 391,
    ...
    ["Keycloak REST API"] = 861,
    ["Knative Functions - func.yaml"] = 297,
    ["KoDE/CI build.yaml"] = 854,
    ["Kong DBLess config"] = 855,
    KrakenD = 404,
    ...
    ["Metadata for a Cinnamon spice"] = 946,
    ["MetricsHub Configuration"] = 437,
    ["MetricsHub Connector Configuration"] = 438,
    ["Micro Editor Syntax"] = 882,
    ["Microsoft Band Web Tile"] = 439,
    ["Microsoft RulesEngine workflow rules"] = 934,
    ["Microsoft RulesEngine workflow rules list"] = 935,
    ["Minecraft Custom Main Menu Mod"] = 899,
    ...
    ["MongoDB Atlas Search Index Definition"] = 853,
    ["Monika Configuration"] = 851,
    ["Monoweave Configuration"] = 463,
    ["Motif config"] = 751,
    ["NOX Framework (Service)"] = 480,
    ["Netin Diagnostic System Template"] = 811,
    ["Netlify config"] = 471,
    ...
    ["OpenUtau ustx"] = 497,
    ["OpenWeather Current Weather API"] = 792,
    ["OpenWeather Road Risk API"] = 791,
    ...
    ["Pipeline component"] = 803,
    ["Plex Prerolls"] = 533,
    ["PocketMine plugin.yml"] = 530,
    ["Postman collection"] = 537,
    ["Preset list for a WinUtil"] = 949,
    ["Problem object RFC9457"] = 896,
    ...
    Qgoda = 570,
    Qodana = 821,
    ["Qt Creator workspace file"] = 928,
    ["Quali Torque Blueprint Spec 2"] = 846,
    ["QueryFirst config file"] = 864,
    ["RKE Cluster Configuration JSON"] = 800,
    ["RKE Cluster Configuration YAML"] = 799,
    ["Rancher Fleet"] = 564,
    ["Rattler-build"] = 571,
    Ray = 766,
    ["Read the Docs"] = 566,
    ...
    ["Render Blueprints"] = 798,
    RenderCV = 590,
    Renovate = 589,
    ["Replit config"] = 584,
    RoadRunner = 591,
    ["Rudder techniques"] = 902,
    Ruff = 586,
    ["Rust Project"] = 587,
    ["Rust toolchain"] = 595,
    ...
    ["SauceCTL Configuration"] = 808,
    ["Schema Catalog"] = 612,
    ["Scoop manifest"] = 617,
    ["Semantic Data Fabric (SDF) file"] = 621,
    ["Semgrep Rule"] = 623,
    ["Serenity Code Generator (Sergen)"] = 624,
    ["Serverless Framework Configuration"] = 815,
    ["Serverless Workflow"] = 817,
    ["Settings for a Cinnamon spice"] = 945,
    ["Settings.paf"] = 626,
    ["Shopware 6 Configuration"] = 818,
    ["Shopware CLI Extension Store Configuration"] = 819,
    ["Shopware CLI Project Store Configuration"] = 820,
    ["Sigma Detection Rule"] = 628,
    ["Sigrid scope configuration file"] = 629,
    ["SkyPilot Task JSON"] = 903,
    ...
    StackBlitz = 649,
    ["StackHawk Scanner Configuration"] = 814,
    Stale = 650,
    ["Starlake Data Pipeline"] = 789,
    Starship = 651,
    ...
    ["Sublime Syntax"] = 860,
    ["Subsquid squid manifest"] = 905,
    ["Swagger API 2.0"] = 660,
    TSON = 689,
    TSTyche = 690,
    ["Tab data for a LinUtil"] = 951,
    ["Tab list for a LinUtil"] = 950,
    Talhelper = 662,
    ...
    Tycho = 941,
    Tye = 822,
    ["UET BuildConfig.json"] = 865,
    ["UI5 Manifest"] = 699,
    ["UNCORS configuration"] = 703,
    ["UTAM Page Object"] = 702,
    ["Ubuntu Server Autoinstall"] = 697,
    ["Uniswap Token List"] = 777,
    ["Unreal Engine Uplugin"] = 866,
    ["Unreal Engine Uproject"] = 867,
    ["Updatecli Compose"] = 830,
    ["Updatecli Policy Manifest"] = 831,
    ["Updatecli Policy Metadata"] = 832,
    Uplift = 863,
    ["User Journey Map"] = 797,
    V2Ray = 836,
    ...
    ["Web types"] = 729,
    WebExtensions = 725,
    ["Webman package recipe"] = 842,
    ["Windows Package Manager Installer Manifest"] = 774,
    ["Windows Package Manager Locale Manifest"] = 775,
    ["Windows Package Manager Singleton Manifest"] = 773,
    ["WireMock stub mapping"] = 957,
    ["Woodpecker pipeline config"] = 810,
    ["Wrangler CLI"] = 730,
    ["Xstate Machine"] = 828,
    ["Yandex Workflow Language"] = 947,
    ["Yarn Config (.yarnrc.yml)"] = 787,
    ["Yippee-Ki-JSON configuration YML"] = 779,
    ["YouTrack App"] = 944,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 897,
    ...
    ["behat.yml"] = 90,
    ["bigquery-table"] = 80,
    ["bioimageio resource description"] = 913,
    ...
    ["lotus.yaml"] = 426,
    ["lsdlschema.json"] = 429,
    ["markdown-link-check"] = 806,
    mboats = 813,
    ["micro-settings.json"] = 877,
    ["mimetypes.json"] = 440,
    ["mirrord config"] = 747,
    mise = 748,
    ["mkdocs.yml"] = 460,
    ...
    ["vtesttree.yaml"] = 722,
    ["vtestunit.yaml"] = 723,
    ["warp-keysets.json"] = 886,
    ["warp-themes.json"] = 887,
    ["warp-workflows.json"] = 888,
    ["webhint.io"] = 843,
    ["webjobpublishsettings.json"] = 728,
    ["webjobs-list.json"] = 727,
    ["well-known-fursona"] = 924,
    ["xs-app.json"] = 753,
    ["xunit.runner.json"] = 739,
    yamllint = 778,
    ["zerops.io import file"] = 933,
    ["zerops.yml"] = 932,
    zuul = 762,
    ["Žinoma"] = 772
  },
