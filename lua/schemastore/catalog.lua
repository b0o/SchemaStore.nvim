...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 157,
    [".cryproj (generic)"] = 529,
    [".cryproj engine-5.2"] = 524,
    [".cryproj engine-5.3"] = 525,
    [".cryproj engine-5.4"] = 526,
    [".cryproj engine-5.5"] = 527,
    [".cryproj engine-dev"] = 528,
    [".csscomb.json"] = 159,
    [".csslintrc"] = 160,
    [".eslintrc"] = 205,
    [".esmrc.json"] = 197,
    ...
    ["Better Code Hub"] = 572,
    ["Better Scripts"] = 84,
    BizTalkServerApplicationSchema = 544,
    ...
    ["Butane Config"] = 610,
    ["CICS TS region tagging"] = 617,
    ["CICS TS resource import"] = 618,
    ["CICS TS resource model"] = 619,
    ["CICS TS resource overrides"] = 620,
    ["CMake Presets"] = 85,
    ...
    ["Datahub Ingestion Recipe Schema"] = 624,
    ...
    ["Embrace Config Schema"] = 635,
    ["Error pages"] = 200,
    Esquio = 198,
    ["Estuary Flow Catalog Schema"] = 614,
    ["Expo SDK"] = 203,
    ...
    Goreleaser = 232,
    ["Goreleaser Pro"] = 233,
    ["Gradle Build Cache Node"] = 569,
    ["Gradle Enterprise"] = 568,
    ...
    Hadolint = 553,
    Hammerkit = 579,
    ["Hardware Sentry Configuration"] = 628,
    Hayson = 245,
    ...
    ["JFrog File Spec"] = 267,
    ["JFrog Pipelines YML DSL"] = 637,
    ["JMeter DSL cli config schema"] = 268,
    ["JSON Document Transform"] = 276,
    ["JSON Feed"] = 277,
    ["JSON Resume"] = 406,
    ["JSON Schema Draft 2020-12"] = 520,
    ["JSON Schema Draft 4"] = 517,
    ["JSON Schema Draft 7"] = 518,
    ["JSON Schema Draft 8"] = 519,
    ...
    ["KSP-AVC"] = 515,
    ["KSP-CKAN"] = 516,
    ["Keycloak REST API"] = 643,
    ["Knative Functions - func.yaml"] = 215,
    ["KoDE/CI build.yaml"] = 633,
    ["Kong DBLess Schema"] = 634,
    KrakenD = 282,
    ["LinkML Metamodel"] = 295,
    Liquibase = 584,
    ["Liquibase Flow File"] = 585,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 632,
    ["Monika Configuration Schema"] = 630,
    ["Motif config"] = 537,
    ["NOX Framework (Service)"] = 337,
    ["Netin Diagnostic System Template"] = 593,
    ...
    ["OpenWeather Current Weather API"] = 576,
    ["OpenWeather Road Risk API"] = 575,
    ...
    PyProject = 395,
    Qodana = 603,
    ["Quali Torque Blueprint Spec 2"] = 625,
    ["QueryFirst config file"] = 646,
    ["RKE Cluster Configuration JSON Schema"] = 583,
    ["RKE Cluster Configuration YAML Schema"] = 582,
    ["Rancher Fleet"] = 392,
    Ray = 552,
    ["Read the Docs"] = 393,
    ...
    ["SauceCTL Configuration"] = 590,
    ["Schema Catalog"] = 424,
    ["Scoop manifest"] = 429,
    ["Semgrep Rule"] = 431,
    ["Serenity Code Generator (Sergen)"] = 432,
    ["Serverless Framework Configuration"] = 597,
    ["Serverless Workflow Schema"] = 599,
    ["Settings.paf"] = 434,
    ["Shopware 6 Configuration"] = 600,
    ["Shopware CLI Extension Store Configuration"] = 601,
    ["Shopware CLI Project Store Configuration"] = 602,
    ...
    ["StackHawk Scanner Configuration"] = 596,
    Stale = 450,
    Starship = 451,
    ["Statamic Blueprint"] = 452,
    ["StrmPrivacy Data Connector"] = 641,
    ["StrmPrivacy Data Contract"] = 642,
    ["StrmPrivacy SimpleSchema"] = 639,
    ["StrmPrivacy Stream"] = 640,
    ["StrmPrivacy batch job configuration file"] = 638,
    ["Stryker Mutator"] = 455,
    ["StyleCop Analyzers Configuration"] = 456,
    ["Swagger API 2.0"] = 459,
    TSON = 482,
    ["Talisman configuration"] = 461,
    ["Taskfile YAML Schema"] = 578,
    Taurus = 462,
    ["TestEnvironment.json"] = 470,
    ["Tier.run pricing.json"] = 465,
    Tikibase = 466,
    ["Traefik v2"] = 473,
    ["Traefik v2 File Provider"] = 474,
    Turborepo = 471,
    Tye = 604,
    ["UI5 Manifest"] = 489,
    ["UTAM Page Object"] = 492,
    ["Ubuntu Server Autoinstall"] = 487,
    ["Uniswap Token List"] = 561,
    ["Unreal Engine Uplugin"] = 647,
    ["Unreal Engine Uproject"] = 648,
    Updatecli = 611,
    Uplift = 645,
    ["User Journey Map YAML Schema"] = 581,
    V2Ray = 615,
    ["VSCode Code Snippets"] = 130,
    ["VSIX CLI publishing"] = 505,
    ["Vela Pipeline Configuration"] = 495,
    Vercel = 129,
    ["Web App Manifest"] = 510,
    ["Web types"] = 513,
    WebExtensions = 509,
    ["Webman package recipe"] = 621,
    ["Windows Package Manager Installer Manifest"] = 558,
    ["Windows Package Manager Locale Manifest"] = 559,
    ["Windows Package Manager Singleton Manifest"] = 557,
    ["Woodpecker pipeline config"] = 592,
    ["Xstate Machine Schema"] = 609,
    ["Yippee-Ki-JSON configuration YML"] = 563,
    ["angular.json"] = 11,
    ...
    ["ize.toml"] = 644,
    ["jsconfig.json"] = 280,
    ["jscpd Configuration Schema"] = 626,
    jsdoc = 551,
    ["k3d.yaml"] = 281,
    ...
    ["servicehub.config.json"] = 523,
    ["servicehub.service.json"] = 522,
    ["settings.job"] = 433,
    ...
    taskcat = 543,
    ["template.json"] = 463,
    ["templatsources.json"] = 464,
    ["theme.json"] = 467,
    ["tizen_workspace.json"] = 468,
    tmLanguage = 469,
    tmuxinator = 531,
    ["transcend.yml"] = 475,
    ["trunk.yaml schema"] = 476,
    ["ts-force-config.json"] = 480,
    ["tsconfig.json"] = 477,
    ["tsd.json"] = 478,
    ["tsdrc.json"] = 479,
    ["tslint.json"] = 481,
    ...
    ["vega-lite.json"] = 494,
    ["vega.json"] = 493,
    ["venvironment-basic.yaml"] = 497,
    ["venvironment.yaml"] = 496,
    ["version.json"] = 498,
    ["vim-addon-info"] = 499,
    ["vs-2017.3.host.json"] = 501,
    ["vs-nesting.json"] = 502,
    ["vsls.json"] = 500,
    ["vss-extension.json"] = 506,
    ["webhint.io"] = 622,
    ["webjobpublishsettings.json"] = 512,
    ["webjobs-list.json"] = 511,
    ["xs-app.json"] = 539,
    ["xunit.runner.json"] = 521,
    yamllint = 562,
    zuul = 548,
    ["Žinoma"] = 556
  },
