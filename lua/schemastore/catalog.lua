...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 14,
    AIConfig = 15,
    ["AMX Muse Program Descriptor"] = 977,
    ["API Builder"] = 798,
    ["AVA Configuration"] = 858,
    ...
    ["Adobe UXP Manifest"] = 918,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Alacritty Configuration"] = 830,
    ["All Contributors configuration file"] = 883,
    ...
    ["Application list for a WinUtil"] = 961,
    ArchitectFX = 965,
    ["Argo Events"] = 29,
    ["Argo Workflows"] = 30,
    AssemblyScript = 33,
    ...
    ["Azure Pipelines"] = 66,
    ["Azure Static Web Apps CLI configuration file"] = 660,
    ["Azure Static Web Apps configuration file"] = 659,
    ["BOSH Deploy Config"] = 90,
    ["BX CI"] = 107,
    ["Bashly (bashly.yml)"] = 887,
    ["Bashly Settings (bashly-settings.yml)"] = 888,
    ["Better Code Hub"] = 802,
    ["Better Scripts"] = 108,
    Bigconfig = 83,
    ["Biome Formatter Config"] = 53,
    ["Bitmovin Encoding Template"] = 971,
    BizTalkServerApplicationSchema = 771,
    Bleep = 109,
    ...
    ["Butane Config"] = 843,
    ["CGS Custom Card Game (CardGameDef.json)"] = 923,
    ["CICS TS region tagging"] = 852,
    ["CICS TS resource import"] = 853,
    ["CICS TS resource model"] = 854,
    ["CICS TS resource overrides"] = 855,
    ["CMake Presets"] = 110,
    ["CNC Codes"] = 125,
    ["CRS WAF test file"] = 951,
    ["CRS WAF test platform overrides file"] = 952,
    ...
    ["Chamaleon environment"] = 975,
    ["Chamaleon template"] = 974,
    Changesets = 207,
    Cheatsheets = 840,
    ...
    CityJSON = 121,
    ["Clawject config"] = 130,
    ["Cloud Foundry Application Manifest"] = 934,
    ["Cloud Run Spec v1"] = 956,
    ...
    Concord = 950,
    ["Configu .cfgu files"] = 939,
    ["Configu .configu file"] = 940,
    Conjure = 124,
    ["Container Structure Test"] = 785,
    Containerlab = 810,
    ["Crowdsec collection config"] = 216,
    ["Crowdsec parser config"] = 217,
    ["Crowdsec scenario config"] = 218,
    ["CumulusCI Config"] = 129,
    ["Custom Machinery Machine"] = 924,
    ["Custom Machinery Recipe"] = 925,
    ...
    ["DonateCaseBetterCasino menu"] = 978,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 895,
    ["EAS config"] = 282,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 884,
    ["EasyVCR .NET"] = 283,
    ["Eidolon Resource"] = 966,
    ...
    ["Goreleaser Pro"] = 340,
    Goss = 341,
    ["Gradle Build Cache Node"] = 800,
    ["Gradle Enterprise"] = 799,
    ...
    Hadolint = 781,
    Hammerkit = 809,
    ["Hardware Sentry Configuration"] = 863,
    Hatch = 782,
    Hayson = 354,
    ...
    ["JFrog File Spec"] = 383,
    ["JFrog Pipelines YML DSL"] = 872,
    ["JMeter DSL cli config"] = 384,
    JReleaser = 386,
    ["JSON Document Transform"] = 394,
    ["JSON Feed"] = 395,
    ["JSON Resume"] = 599,
    ["JSON Schema Draft 2020-12"] = 751,
    ["JSON Schema Draft 4"] = 748,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 905,
    ["JSON Schema Draft 7"] = 749,
    ["JSON Schema Draft 7 (unofficial strict)"] = 906,
    ["JSON Schema Draft 8 (2019-09)"] = 750,
    ["JSON-API"] = 393,
    ["JSON-e templates"] = 807,
    ["JSON-stat 2.0"] = 744,
    JSONPatch = 397,
    ...
    ["Metadata for a Cinnamon spice"] = 959,
    ["Metatype Configuration"] = 445,
    ["MetricsHub Configuration"] = 446,
    ["MetricsHub Connector Configuration"] = 447,
    ["Micro Editor Syntax"] = 896,
    ["Microsoft Band Web Tile"] = 448,
    ["Microsoft RulesEngine workflow rules"] = 947,
    ["Microsoft RulesEngine workflow rules list"] = 948,
    ["Minecraft Custom Main Menu Mod"] = 913,
    ...
    ["MongoDB Atlas Search Index Definition"] = 867,
    ["Monika Configuration"] = 865,
    ["Monoweave Configuration"] = 472,
    ["Motif config"] = 764,
    ["NOX Framework (Service)"] = 489,
    ["Netin Diagnostic System Template"] = 825,
    ["Netlify config"] = 480,
    ...
    ["OpenUtau ustx"] = 507,
    ["OpenWeather Current Weather API"] = 806,
    ["OpenWeather Road Risk API"] = 805,
    ...
    ["Pipeline component"] = 817,
    ["Plex Prerolls"] = 543,
    ["PocketMine plugin.yml"] = 540,
    ["Postman collection"] = 547,
    ["Preset list for a WinUtil"] = 962,
    ["Problem object RFC9457"] = 910,
    ...
    Qgoda = 581,
    Qodana = 835,
    ["Qt Creator workspace file"] = 941,
    ["Quali Torque Blueprint Spec 2"] = 860,
    ["QueryFirst config file"] = 878,
    ["RKE Cluster Configuration JSON"] = 814,
    ["RKE Cluster Configuration YAML"] = 813,
    RadioHound = 574,
    ["Rancher Fleet"] = 575,
    ["Rattler-build"] = 582,
    Ray = 780,
    ["Read the Docs"] = 577,
    ["Red-DiscordBot Cog"] = 589,
    ["Red-DiscordBot Cog Repo"] = 590,
    ["Red-DiscordBot Trivia"] = 591,
    ["Render Blueprints"] = 812,
    RenderCV = 601,
    Renovate = 600,
    ["Replit config"] = 595,
    RoadRunner = 603,
    ["Rudder techniques"] = 916,
    Ruff = 597,
    ["Rust Project"] = 598,
    ["Rust toolchain"] = 607,
    ["SDMX data message"] = 632,
    ["SDMX metadata message"] = 631,
    ["SDMX structure message"] = 630,
    ["SIL Kit Participant Configuration"] = 642,
    ["SIL Kit Registry Configuration"] = 643,
    SWADL = 671,
    ["Safebox Config"] = 873,
    ["Sapphire CLI Config"] = 610,
    ["SauceCTL Configuration"] = 822,
    ["Schema Catalog"] = 624,
    ["Scoop manifest"] = 629,
    ["Semantic Data Fabric (SDF) file"] = 633,
    ["Semgrep Rule"] = 635,
    ["Serenity Code Generator (Sergen)"] = 636,
    ["Serverless Framework Configuration"] = 829,
    ["Serverless Workflow"] = 831,
    ["Settings for a Cinnamon spice"] = 958,
    ["Settings.paf"] = 638,
    ["Shopware 6 Configuration"] = 832,
    ["Shopware CLI Extension Store Configuration"] = 833,
    ["Shopware CLI Project Store Configuration"] = 834,
    ["Sigma Detection Rule"] = 640,
    ["Sigrid scope configuration file"] = 641,
    ["SkyPilot Task JSON"] = 917,
    ["Slack app manifest"] = 645,
    Solidarity = 648,
    ["Solution filters"] = 649,
    ["Source Maps v3"] = 650,
    Sourcery = 651,
    ["Speakeasy Lint Configuration File"] = 652,
    ["Speakeasy Test Generation Configuration File"] = 653,
    ["Speakeasy Workflow File"] = 654,
    SpecIF = 655,
    ["Sponge Mixin configuration"] = 656,
    StackBlitz = 661,
    ["StackHawk Scanner Configuration"] = 828,
    Stale = 662,
    ["Starlake Data Pipeline"] = 803,
    Starship = 663,
    ["Statamic Blueprint"] = 664,
    ["Stella configuration file"] = 665,
    ["Stryker Mutator"] = 668,
    ["StyleCop Analyzers Configuration"] = 669,
    ["Stylelint (.stylelintrc)"] = 670,
    ["Sublime Syntax"] = 874,
    ["Subsquid squid manifest"] = 919,
    ["Swagger API 2.0"] = 672,
    ["Synadia Connect Component"] = 673,
    TSON = 702,
    TSTyche = 703,
    ["Tab data for a LinUtil"] = 964,
    ["Tab list for a LinUtil"] = 963,
    Talhelper = 675,
    ["Talisman configuration"] = 676,
    ["Taskfile config"] = 808,
    Taurus = 677,
    Tauticord = 678,
    ["TestEnvironment.json"] = 687,
    ["TextMate Grammar"] = 686,
    ["Tier.run pricing.json"] = 681,
    Tikibase = 682,
    ["Traefik v2"] = 690,
    ["Traefik v2 File Provider"] = 691,
    ["Travis CI (.travis.yml)"] = 689,
    ["TrueScript for *.tscript files"] = 694,
    TunnelHub = 909,
    Turborepo = 688,
    Tycho = 954,
    Tye = 836,
    ["UET BuildConfig.json"] = 879,
    ["UI5 Manifest"] = 712,
    ["UNCORS configuration"] = 716,
    ["UTAM Page Object"] = 715,
    ["Ubuntu Server Autoinstall"] = 710,
    ["Uniswap Token List"] = 791,
    ["Unreal Engine Uplugin"] = 880,
    ["Unreal Engine Uproject"] = 881,
    ["Updatecli Compose"] = 844,
    ["Updatecli Policy Manifest"] = 845,
    ["Updatecli Policy Metadata"] = 846,
    Uplift = 877,
    ["User Journey Map"] = 811,
    V2Ray = 850,
    ["VSCode Code Snippets"] = 182,
    ["VSIX CLI publishing"] = 733,
    ["Vela Pipeline Configuration"] = 720,
    Vercel = 181,
    ["Version Bumper config"] = 723,
    Visivo = 907,
    ["Waku Config"] = 967,
    ["Web App Manifest"] = 739,
    ["Web types"] = 742,
    WebExtensions = 738,
    ["Webman package recipe"] = 856,
    ["Windows Package Manager Installer Manifest"] = 788,
    ["Windows Package Manager Locale Manifest"] = 789,
    ["Windows Package Manager Singleton Manifest"] = 787,
    ["WireMock stub mapping"] = 970,
    ["Woodpecker pipeline config"] = 824,
    ["Wrangler CLI"] = 743,
    ["Xstate Machine"] = 842,
    ["Yandex Workflow Language"] = 960,
    ["Yarn Config (.yarnrc.yml)"] = 801,
    ["Yippee-Ki-JSON configuration YML"] = 793,
    ["YouTrack App"] = 957,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 911,
    ...
    ["behat.yml"] = 92,
    ["bigquery-table"] = 82,
    ["bioimageio resource description"] = 927,
    ...
    ["crowdin.yml"] = 215,
    ["ctfd-setup configuration file"] = 976,
    ["custom-elements.json"] = 899,
    ["cypress.json"] = 219,
    ...
    ["lint-staged (.lintstagedrc)"] = 759,
    ["local.settings.json"] = 435,
    ["localazy.json"] = 436,
    ["lotus.yaml"] = 434,
    ["lsdlschema.json"] = 437,
    ["markdown-link-check"] = 820,
    mboats = 827,
    ["micro-settings.json"] = 891,
    ["mimetypes.json"] = 449,
    ["mirrord config"] = 760,
    mise = 761,
    ["mkdocs.yml"] = 469,
    ...
    ["plagiarize.yaml"] = 541,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 973,
    ["podbard.yaml"] = 544,
    ["portman.json"] = 545,
    ["prefect.toml"] = 553,
    ["prettierrc.json"] = 554,
    ...
    samt = 608,
    samtrc = 609,
    ["sarif-1.0.0.json"] = 611,
    ["sarif-2.0.0.json"] = 612,
    ["sarif-2.1.0"] = 622,
    ["sarif-2.1.0-rtm.2"] = 613,
    ["sarif-2.1.0-rtm.3"] = 615,
    ["sarif-2.1.0-rtm.4"] = 617,
    ["sarif-2.1.0-rtm.5"] = 619,
    ["sarif-2.1.0-rtm.6"] = 620,
    ["sarif-external-property-file-2.1.0"] = 623,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 614,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 616,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 618,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 621,
    ["schema.org - Action"] = 625,
    ["schema.org - ContactPoint"] = 626,
    ["schema.org - Place"] = 627,
    ["schema.org - Thing"] = 628,
    ["secrethub.yml"] = 894,
    ["semantic-release"] = 634,
    ["servicehub.config.json"] = 754,
    ["servicehub.service.json"] = 753,
    ["settings.job"] = 637,
    ["sfdx-hardis configuration"] = 639,
    ["shard.yml"] = 930,
    ["size-limit configuration"] = 644,
    ["skaffold.yaml"] = 818,
    ["skyuxconfig.json"] = 646,
    snapcraft = 647,
    ["spicepod.yaml"] = 949,
    ["sqlc configuration"] = 658,
    ["stripe-app-local.json"] = 667,
    ["stripe-app.json"] = 666,
    swcrc = 804,
    ["task.json"] = 674,
    taskcat = 770,
    ["template.json"] = 679,
    ["templatsources.json"] = 680,
    ["theme.json"] = 683,
    ["tizen_workspace.json"] = 684,
    tldr = 685,
    tmuxinator = 757,
    ["transcend.yml"] = 692,
    ...
    ["vega-lite.json"] = 719,
    ["vega.json"] = 718,
    ["venvironment-basic.yaml"] = 722,
    ["venvironment.yaml"] = 721,
    ["version.json"] = 724,
    ["vhwdebugger-binding.yaml"] = 726,
    ["vim-addon-info"] = 727,
    ["vs-2017.3.host.json"] = 729,
    ["vs-nesting.json"] = 730,
    ["vsls.json"] = 728,
    ["vss-extension.json"] = 734,
    ["vtesttree.yaml"] = 735,
    ["vtestunit.yaml"] = 736,
    ["warp-keysets.json"] = 900,
    ["warp-themes.json"] = 901,
    ["warp-workflows.json"] = 902,
    ["webhint.io"] = 857,
    ["webjobpublishsettings.json"] = 741,
    ["webjobs-list.json"] = 740,
    ["well-known-fursona"] = 937,
    ["xs-app.json"] = 766,
    ["xunit.runner.json"] = 752,
    yamllint = 792,
    ["zerops.io import file"] = 946,
    ["zerops.yml"] = 945,
    zuul = 776,
    ["Žinoma"] = 786
  },
