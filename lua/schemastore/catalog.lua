...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 852,
    [".nodehawkrc"] = 520,
    [".npmpackagejsonlintrc"] = 524,
    [".omletrc"] = 1028,
    [".phrase.yml"] = 587,
    [".phraseapp.yml"] = 588,
    [".pmbot.yml"] = 575,
    [".postcssrc"] = 582,
    [".powerpages-web-template-manifest"] = 584,
    [".pre-commit-config.yml"] = 585,
    [".pre-commit-hooks.yml"] = 586,
    [".putout.json"] = 615,
    [".rehyperc"] = 639,
    [".remarkrc"] = 643,
    [".sprite files"] = 730,
    ...
    ["A micro editor config"] = 471,
    ABCInventoryModuleData = 18,
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1073,
    ["API Builder"] = 887,
    ["AVA Configuration"] = 949,
    ["AWS AppConfig Feature Flags-v1"] = 49,
    ["AWS CDK cdk.json"] = 218,
    ["AWS CloudFormation"] = 219,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 220,
    ["AWS Copilot Manifest"] = 1111,
    ["AWS SAM CLI Samconfig"] = 221,
    ["Adobe UXP Manifest"] = 1011,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1102,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 921,
    ["All Contributors configuration file"] = 974,
    ["Ansible Argument Specs"] = 351,
    ["Ansible Collection Galaxy"] = 358,
    ["Ansible Execution Environment"] = 348,
    ["Ansible Inventory"] = 357,
    ["Ansible Meta"] = 349,
    ["Ansible Meta Runtime"] = 350,
    ["Ansible Navigator Configuration"] = 360,
    ["Ansible Playbook"] = 355,
    ["Ansible Requirements"] = 352,
    ["Ansible Rulebook"] = 356,
    ["Ansible Tasks File"] = 354,
    ["Ansible Vars File"] = 353,
    ["Ansible-lint Configuration"] = 359,
    Any = 1038,
    ["AnyWork Automation Configuration"] = 9,
    ["App config Spotify Backstage"] = 25,
    ["Application Accelerator"] = 6,
    ["Application list for a WinUtil"] = 1055,
    ArchitectFX = 1060,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure Pipelines"] = 79,
    ["Azure Static Web Apps CLI configuration file"] = 734,
    ["Azure Static Web Apps configuration file"] = 733,
    ["BOSH CPI Config"] = 103,
    ["BOSH Deploy Config"] = 104,
    ["BX CI"] = 123,
    ["Bashly (bashly.yml)"] = 978,
    ["Bashly Settings (bashly-settings.yml)"] = 979,
    ["Better Code Hub"] = 891,
    ["Better Scripts"] = 124,
    Bigconfig = 96,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1066,
    BizTalkServerApplicationSchema = 859,
    Bleep = 125,
    ...
    ["Butane Config"] = 934,
    C4InterFlow = 1081,
    ["CDK Environment Manager, concrete environment configuration"] = 1105,
    ["CDK Environment Manager, concrete environments definition"] = 1104,
    ["CDK Environment Manager, environment definition"] = 1103,
    ["CGS Card Game Specification (cgs.json)"] = 1016,
    ["CICS TS region tagging"] = 943,
    ["CICS TS resource import"] = 944,
    ["CICS TS resource model"] = 945,
    ["CICS TS resource overrides"] = 946,
    ["CMake Presets"] = 126,
    ["CNC Codes"] = 146,
    ["CRS WAF test file"] = 1045,
    ["CRS WAF test platform overrides file"] = 1046,
    ["CSS Comb (.csscomb.json)"] = 246,
    ["CSS Lint (.csslintrc)"] = 247,
    ["CSpell (cspell.json)"] = 245,
    ["CVE Record Format"] = 154,
    CWL = 1022,
    ...
    ["Chamaleon environment"] = 1070,
    ["Chamaleon properties"] = 1071,
    ["Chamaleon template"] = 1069,
    Changesets = 230,
    Changie = 135,
    Charmcraft = 136,
    Cheatsheets = 931,
    ["Chrome Extension"] = 211,
    ["Chromia Model"] = 137,
    ["Chromia Seeder Module Config"] = 139,
    ["Chromia Seeder Root Config"] = 138,
    ["Cinnamon Spice info.json"] = 70,
    ["CircleCI config.yml"] = 187,
    ["Citation File Format"] = 232,
    CityJSON = 141,
    ["Claude Code Settings"] = 153,
    ["Clawject config"] = 152,
    ["Cloud Foundry Application Manifest"] = 1027,
    ["Cloud Run Spec v1"] = 1050,
    ["CloudCannon Configuration"] = 74,
    ["CloudEvents specification"] = 142,
    ["Code Climate"] = 188,
    CodeCV = 72,
    CodeRabbit = 71,
    ["CodeShip Pro services configuration files"] = 200,
    ["CodeShip Pro steps configuration files"] = 201,
    ["Codecov configuration files"] = 199,
    CodifyCLI = 73,
    Codux = 197,
    ["Cog config file"] = 147,
    ["Commandbox Box.json"] = 148,
    ["Commandbox Server.json"] = 149,
    ["Common Catalog Data"] = 209,
    ["Common Package Specification"] = 150,
    Concord = 1044,
    ["Configu .cfgu files"] = 1032,
    ["Configu .configu file"] = 1033,
    Conjure = 145,
    ["Container Structure Test"] = 873,
    Containerlab = 900,
    ["Contextive Glossary"] = 1097,
    Convex = 144,
    ["Crowdsec collection config"] = 240,
    ["Crowdsec parser config"] = 241,
    ["Crowdsec scenario config"] = 242,
    ["CumulusCI Config"] = 151,
    ["Custom Machinery Machine"] = 1017,
    ["Custom Machinery Recipe"] = 1018,
    ["Cycle Stack File"] = 155,
    CycloneDX = 156,
    ["DWP Exchange - catalogue entry"] = 289,
    ["DWP Exchange - gateway"] = 287,
    ["DWP Exchange - meta"] = 288,
    ["Dart Build Config (dart-build.json)"] = 248,
    ["Dart Test Config (dart-test.json)"] = 249,
    ["DashLord Configuration"] = 250,
    ["Data Contract Specification"] = 251,
    ["Data Product Specification"] = 252,
    ["DataYoga Connections"] = 157,
    ["DataYoga Job"] = 158,
    ["Databricks Asset Bundles"] = 995,
    ["Datadog Continuous Testing"] = 443,
    ["Datadog Service Definition"] = 444,
    ["Datadog Software Catalog"] = 445,
    ["Datahub Ingestion Recipe"] = 950,
    ["Dein Config"] = 164,
    ["Deno Config (deno.json)"] = 258,
    ["Dependency cruiser"] = 165,
    ["DeployStack Configuration"] = 166,
    ["Deployer Recipe"] = 261,
    ["Deta Spacefile"] = 167,
    ["Detekt Config (detekt.yml)"] = 262,
    ["Devbox Config"] = 168,
    ["Devbox Plugin"] = 169,
    Devfile = 286,
    DipDup = 1047,
    ["Discord Webhook"] = 263,
    ["DocFx Config (docfx.json)"] = 267,
    Dofigen = 268,
    ["Dolittle Artifacts"] = 269,
    ["Dolittle Bounded Context Configuration"] = 270,
    ["Dolittle Event Horizons Configuration"] = 271,
    ["Dolittle Resources Configuration"] = 272,
    ["Dolittle Server Configuration"] = 273,
    ["Dolittle Tenant Map Configuration"] = 275,
    ["Dolittle Tenants Configuration"] = 274,
    ["Dolittle Topology"] = 276,
    ["DonateCaseBetterCasino menu"] = 1074,
    ["Drupal Breakpoints"] = 170,
    ["Drupal Config"] = 182,
    ["Drupal Info"] = 171,
    ["Drupal Layouts"] = 172,
    ["Drupal Libraries"] = 173,
    ["Drupal Links Action"] = 174,
    ["Drupal Links Contextual"] = 175,
    ["Drupal Links Menu"] = 176,
    ["Drupal Links Task"] = 177,
    ["Drupal Migration"] = 178,
    ["Drupal Permissions"] = 179,
    ["Drupal Recipe"] = 180,
    ["Drupal Routing"] = 181,
    ["Drupal Services"] = 183,
    ["Drush site aliases"] = 282,
    ["Dynamic Bash Aliases (.aliases)"] = 986,
    ["EAS config"] = 306,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 975,
    ["EasyVCR .NET"] = 307,
    ["Eidolon Resource"] = 1061,
    ["Elgato Stream Deck"] = 292,
    Elm = 1049,
    ["Embrace Config"] = 961,
    Endurica = 999,
    ["Enterprise Contract Policy Spec"] = 293,
    ["Erda Pipeline"] = 1024,
    ["Erda Runtime"] = 1025,
    Esquio = 295,
    ["Estuary Flow Catalog"] = 940,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 299,
    ["EveryVoice TTS Toolkit Data Configuration"] = 300,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 304,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 303,
    ["EveryVoice TTS Toolkit Text Configuration"] = 301,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 302,
    ["Expo SDK"] = 305,
    ["F-Droid Data metadata"] = 311,
    ["FasterCI Configuration"] = 80,
    FiQuS = 315,
    Firebase = 313,
    ["FlexGet Config"] = 316,
    ["Flow.json Configurations"] = 1021,
    ["Fossa configuration file"] = 323,
    ["Fossa's fossa-deps file"] = 324,
    ["Foundry VTT - Base package Manifest"] = 318,
    ["Foundry VTT - Module Manifest"] = 319,
    ["Foundry VTT - System Data Template"] = 322,
    ["Foundry VTT - System Manifest"] = 320,
    ["Foundry VTT - World Manifest"] = 321,
    ["Foxx Manifest"] = 81,
    ["Freifunk.de Community API"] = 84,
    ["Frogbot Config"] = 85,
    ["G2P Mapping Configuration"] = 329,
    ["GCP Blueprint Metadata"] = 332,
    Gaspar = 330,
    ["GatewayCore API Gateway"] = 331,
    ["GeoJSON.json latest"] = 938,
    GherKing = 942,
    ["GitHub Action"] = 337,
    ["GitHub Actions typing"] = 1057,
    ["GitHub Discussion"] = 338,
    ["GitHub Funding"] = 339,
    ["GitHub Issue Template configuration"] = 340,
    ["GitHub Issue Template forms"] = 341,
    ["GitHub Workflow"] = 342,
    ["GitHub Workflow Template Properties"] = 343,
    ["GitHub automatically generated release notes configuration"] = 344,
    ["GitLab Agent for Kubernetes configuration"] = 1013,
    GitVersion = 334,
    ["Gitea Issue Template configuration"] = 335,
    ["Gitea Issue Template forms"] = 336,
    ["Gitpod Automations"] = 346,
    ["Gitpod Configuration"] = 347,
    ["GlazeWM settings"] = 1015,
    ["Global Privacy Control"] = 333,
    Goblet = 994,
    ["Golangci-lint Configuration"] = 362,
    ["Golangci-lint Custom Plugins Configuration"] = 363,
    ["Google Chrome Related Website Sets"] = 314,
    ["Google Cloud Workflows"] = 217,
    ["Google Digital Assetlinks"] = 1098,
    Goreleaser = 365,
    ["Goreleaser Pro"] = 366,
    Goss = 367,
    ["Gradle Build Cache Node"] = 889,
    ["Gradle Enterprise"] = 888,
    ["Grafana 5.x Dashboard"] = 368,
    ["GraphQL Code Generator"] = 372,
    ["GraphQL Config"] = 371,
    ["GraphQL Mesh"] = 370,
    ["Grunt JSHint task"] = 376,
    ["Grunt Watch task"] = 377,
    ["Grunt base task"] = 378,
    ["Grunt clean task"] = 374,
    ["Grunt copy task"] = 373,
    ["Grunt cssmin task"] = 375,
    HEMTT = 855,
    Hadolint = 869,
    Hammerkit = 899,
    ["Hardware Sentry Configuration"] = 954,
    ["HashiCorp Vault"] = 379,
    Hatch = 870,
    Hayson = 381,
    ["Haystack Pipeline"] = 382,
    ["Hazelcast 5 Configuration"] = 383,
    ["Hecate Input Schema"] = 1109,
    ["Helm Chart.lock"] = 185,
    ["Helm Chart.yaml"] = 184,
    ["Helm Unittest Test Suite"] = 186,
    ["Home Assistant Integration Manifest"] = 384,
    ["Homer dashboard configuration"] = 385,
    Hugo = 930,
    ["Hugo Theme"] = 929,
    ["Hyperfoil benchmark configuration"] = 391,
    ["IBM Zapp document"] = 392,
    ["IBM zCodeFormatSettings"] = 393,
    ["IMG Catapult PSP"] = 398,
    ["IVMS101 by CODE Protocol"] = 1014,
    Infrahub = 400,
    Istanbul = 957,
    ["JDownloader2 crawler multi-rules"] = 410,
    ["JDownloader2 crawler single-rules"] = 409,
    ["JFrog Applications Config"] = 411,
    ["JFrog File Spec"] = 412,
    ["JFrog Pipelines YML DSL"] = 963,
    ["JMeter DSL cli config"] = 413,
    JReleaser = 416,
    ["JSON Document Transform"] = 424,
    ["JSON Feed"] = 425,
    ["JSON Resume"] = 649,
    ["JSON Schema Draft 2020-12"] = 838,
    ["JSON Schema Draft 4"] = 835,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 996,
    ["JSON Schema Draft 7"] = 836,
    ["JSON Schema Draft 7 (unofficial strict)"] = 997,
    ["JSON Schema Draft 8 (2019-09)"] = 837,
    ["JSON-API"] = 423,
    ["JSON-e templates"] = 896,
    ["JSON-stat 2.0"] = 831,
    JSONPatch = 427,
    ["JSR Package Config (jsr.json)"] = 417,
    Jasmine = 404,
    Jekyll = 405,
    ["Jenkins X Pipelines"] = 406,
    ["Jenkins X Requirements"] = 407,
    Jest = 408,
    Jocker = 414,
    ["Jovo Language Models"] = 415,
    ["Jujutsu (jj) VCS config"] = 1110,
    ["KIMMDY config file"] = 438,
    ["KODE/CI build.yaml"] = 959,
    ["KSP-AVC"] = 832,
    ["KSP-CKAN"] = 833,
    ["KSP-NetKAN"] = 834,
    KSY = 1026,
    KSail = 327,
    ["Karakum configuration file"] = 325,
    Kas = 430,
    ["Kestra flow file"] = 439,
    ["Keycloak REST API"] = 966,
    ["Knative Functions - func.yaml"] = 326,
    ["Kometa (nightly) config file"] = 441,
    ["Kometa config file"] = 440,
    ["Kong DBLess config"] = 960,
    KrakenD = 442,
    ...
    ["Landing Zone Accelerator on AWS - IAM Config"] = 225,
    ["Landing Zone Accelerator on AWS - Network Config"] = 226,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 227,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 228,
    ["Landing Zone Accelerator on AWS - Security Config"] = 229,
    ["Lando (landofile)"] = 75,
    ["LangGraph Platform configuration"] = 1037,
    ["Language configuration"] = 1036,
    Lefthook = 453,
    ["Liferay client-extension.yaml"] = 460,
    ["LinkML Metamodel"] = 462,
    Liquibase = 905,
    ["Liquibase Flow File"] = 906,
    ["Lively Properties"] = 463,
    ["Lobe AI Agent"] = 77,
    Loki = 78,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 503,
    ["MS2Rescore Configuration"] = 506,
    ["Madness (madness.yml)"] = 977,
    ["MapEHR Mapping"] = 470,
    Markdownlint = 909,
    ["Mason Registry"] = 912,
    ["MegaLinter Custom Flavor"] = 473,
    ["MegaLinter configuration"] = 472,
    ["MegaLinter descriptor"] = 474,
    Melange = 1004,
    ["Meltano project definition"] = 475,
    ["Mergify Configuration"] = 507,
    ["Metadata for a Bazel module"] = 476,
    ["Metadata for a Cinnamon spice"] = 1053,
    ["Metatype Configuration"] = 477,
    ["MetricsHub Configuration"] = 478,
    ["MetricsHub Connector Configuration"] = 479,
    ["Micro Editor Syntax"] = 987,
    ["Microsoft Band Web Tile"] = 480,
    ["Microsoft RulesEngine workflow rules"] = 1041,
    ["Microsoft RulesEngine workflow rules list"] = 1042,
    ["Minecraft Custom Main Menu Mod"] = 1005,
    ["Minecraft Data Pack Advancement"] = 482,
    ["Minecraft Data Pack Biome"] = 483,
    ["Minecraft Data Pack Configured Carver"] = 484,
    ["Minecraft Data Pack Damage Type"] = 485,
    ["Minecraft Data Pack Dimension"] = 487,
    ["Minecraft Data Pack Dimension Type"] = 486,
    ["Minecraft Data Pack Item Modifier"] = 488,
    ["Minecraft Data Pack Loot Table"] = 489,
    ["Minecraft Data Pack Metadata"] = 490,
    ["Minecraft Data Pack Predicate"] = 491,
    ["Minecraft Data Pack Recipe"] = 492,
    ["Minecraft Data Pack Tag"] = 493,
    ["Minecraft Data Pack Template Pool"] = 494,
    ["Minecraft Data Pack Trim Material"] = 499,
    ["Minecraft Data Pack Trim Pattern"] = 500,
    ["Minecraft Resource Pack Lang"] = 495,
    ["Minecraft Resource Pack Particle"] = 496,
    ["Minecraft Resource Pack Texture Mcmeta"] = 498,
    ["Minecraft Resourcepack Sounds"] = 497,
    ["Monade CLI Stack Configuration"] = 510,
    ["MongoDB Atlas Search Index Definition"] = 958,
    ["Monika Configuration"] = 956,
    ["Monoweave Configuration"] = 505,
    ["Motif config"] = 851,
    MultiQC = 1091,
    ["NOX Framework (Service)"] = 523,
    ["Netin Diagnostic System Template"] = 916,
    ["Netlify config"] = 513,
    ["Network-as-Code Data Model"] = 514,
    ["Nightwatch.js"] = 516,
    ["Node.js configuration"] = 856,
    ["NueJS configuration file"] = 528,
    ["Nuitka.yaml"] = 1019,
    ["Nullstone config"] = 530,
    ["ONe's changelog entry"] = 544,
    ["ONe's service descriptor"] = 543,
    ["ORT Server repository environment configuration"] = 552,
    ["OSCAL Assessment Plan (AP)"] = 554,
    ["OSCAL Assessment Results (AR)"] = 555,
    ["OSCAL Catalog"] = 556,
    ["OSCAL Component Definition (CDef)"] = 557,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 558,
    ["OSCAL Profile"] = 559,
    ["OSCAL System Security Plan (SSP)"] = 560,
    ["OSS Review Toolkit configuration"] = 561,
    ["OSS Review Toolkit curation"] = 562,
    ["OSS Review Toolkit package configuration"] = 563,
    ["OSS Review Toolkit repository configuration"] = 564,
    ["OSS Review Toolkit resolutions"] = 565,
    ["October CMS columns"] = 534,
    ["October CMS fields"] = 535,
    Okteto = 536,
    Opctl = 854,
    ["Open Data Contract Standard (ODCS)"] = 547,
    ["Open Data Product Standard (ODPS)"] = 548,
    ["Open Know-How"] = 1096,
    ["OpenRewrite Resource"] = 546,
    OpenStatus = 1107,
    ["OpenUtau character yaml"] = 540,
    ["OpenUtau ustx"] = 541,
    ["OpenWeather Current Weather API"] = 895,
    ["OpenWeather Road Risk API"] = 894,
    ["Ory Hydra configuration"] = 390,
    ["Ory Keto configuration"] = 446,
    ["Ory Kratos configuration"] = 553,
    ["Ory Oathkeeper configuration"] = 532,
    ["Outblocks App configuration"] = 550,
    ["Outblocks database table"] = 551,
    ["Outblocks project configuration"] = 549,
    PDM = 571,
    Packer = 568,
    Pantsbuild = 973,
    ["Paper paper-plugin.yml"] = 569,
    ["Pipeline component"] = 907,
    ["Platform.sh application"] = 2,
    ["Platform.sh routes"] = 3,
    ["Platform.sh services"] = 4,
    ["Plex Prerolls"] = 579,
    ["PocketMine plugin.yml"] = 576,
    ["Postman collection"] = 583,
    ["Power Pages Configuration"] = 1108,
    ["Preset list for a WinUtil"] = 1056,
    ["ProActions AI-Kit Configuration"] = 592,
    ["ProActions AI-Kit Configuration for Menus"] = 594,
    ["ProActions AI-Kit Configuration for Sections"] = 596,
    ["ProActions AI-Kit Configuration for Services"] = 593,
    ["ProActions AI-Kit Configuration for Steps"] = 597,
    ["ProActions AI-Kit Configuration for Templates"] = 595,
    ["Problem object RFC9457"] = 1002,
    ["Problem package generators"] = 598,
    Pterodactyl = 953,
    ["Pull Request Labeler"] = 614,
    Pulumi = 622,
    ["PyGTA Config"] = 618,
    PyProject = 623,
    Pylock = 1099,
    Pyright = 624,
    ["Python script metadata"] = 1093,
    ["QType AI DSL"] = 627,
    Qgoda = 626,
    Qodana = 926,
    ["Qt Creator workspace file"] = 1034,
    ["Quali Torque Blueprint Spec 2"] = 951,
    ["QueryFirst config file"] = 969,
    ["RKE Cluster Configuration JSON"] = 904,
    ["RKE Cluster Configuration YAML"] = 903,
    RadioHound = 617,
    Railway = 628,
    ["Rancher Fleet"] = 619,
    ["Rattler-build"] = 629,
    Ray = 868,
    ["Read the Docs"] = 621,
    ["Red-DiscordBot Cog"] = 636,
    ["Red-DiscordBot Cog Repo"] = 637,
    ["Red-DiscordBot Trivia"] = 638,
    ["Render Blueprints"] = 902,
    RenderCV = 651,
    Renovate = 650,
    ["Replit config"] = 644,
    Restate = 1086,
    RoadRunner = 653,
    ["Roo Coder Custom Modes"] = 655,
    Rubocop = 646,
    ["Rudder techniques"] = 1009,
    Ruff = 647,
    ["Rust Project"] = 648,
    ["Rust toolchain"] = 658,
    ["SDMX data message"] = 684,
    ["SDMX metadata message"] = 683,
    ["SDMX structure message"] = 682,
    ["SIL Kit Participant Configuration"] = 694,
    ["SIL Kit Registry Configuration"] = 695,
    ["SPDX 2.3"] = 731,
    SWADL = 745,
    ["Safebox Config"] = 964,
    ["Sapphire CLI Config"] = 661,
    ["SauceCTL Configuration"] = 913,
    ["Schema Catalog"] = 676,
    ["Scoop manifest"] = 681,
    ["Semantic Data Fabric (SDF) file"] = 685,
    ["Semgrep Rule"] = 687,
    ["Serenity Code Generator (Sergen)"] = 688,
    ["Serverless Framework Configuration"] = 920,
    ["Serverless Workflow"] = 922,
    ["Settings for a Cinnamon spice"] = 1052,
    ["Settings.paf"] = 690,
    ["Shopware 6 Configuration"] = 923,
    ["Shopware CLI Extension Store Configuration"] = 924,
    ["Shopware CLI Project Store Configuration"] = 925,
    ["Sigma Detection Rule"] = 692,
    ["Sigrid scope configuration file"] = 693,
    ["SkyPilot Task JSON"] = 1010,
    ["Slack app manifest"] = 697,
    Solidarity = 702,
    ["Solution filters"] = 703,
    ["Source Maps v3"] = 704,
    Sourcery = 705,
    ["Spack bootstrap.yaml"] = 706,
    ["Spack cdash.yaml"] = 707,
    ["Spack ci.yaml"] = 708,
    ["Spack compilers.yaml"] = 709,
    ["Spack concretizer.yaml"] = 710,
    ["Spack config.yaml"] = 711,
    ["Spack definitions.yaml"] = 712,
    ["Spack develop.yaml"] = 713,
    ["Spack env_vars.yaml"] = 714,
    ["Spack environment"] = 720,
    ["Spack include.yaml"] = 715,
    ["Spack mirrors.yaml"] = 716,
    ["Spack modules.yaml"] = 717,
    ["Spack packages.yaml"] = 718,
    ["Spack repos.yaml"] = 719,
    ["Spack toolchains.yaml"] = 721,
    ["Spack upstreams.yaml"] = 722,
    ["Spack view.yaml"] = 723,
    ["Speakeasy Generation Config File"] = 727,
    ["Speakeasy Lint Configuration File"] = 724,
    ["Speakeasy Test Generation Configuration File"] = 725,
    ["Speakeasy Workflow File"] = 726,
    SpecIF = 728,
    ["Sponge Mixin configuration"] = 729,
    StackBlitz = 735,
    ["StackHawk Scanner Configuration"] = 919,
    Stale = 736,
    ["Starlake Data Pipeline"] = 892,
    Starship = 737,
    ["Statamic Blueprint"] = 738,
    ["Stella configuration file"] = 739,
    ["Stryker Mutator"] = 742,
    ["StyleCop Analyzers Configuration"] = 743,
    ["Stylelint (.stylelintrc)"] = 744,
    ["Stylua Config"] = 1100,
    ["Sublime Syntax"] = 965,
    ["Subsquid squid manifest"] = 1012,
    ["Swagger API 2.0"] = 746,
    ["Synadia Connect Component"] = 747,
    TSON = 781,
    TSTyche = 782,
    ["TYPO3 Vendor Bundler config"] = 787,
    ["Tab data for a LinUtil"] = 1059,
    ["Tab list for a LinUtil"] = 1058,
    Tach = 748,
    ["Tach Domain"] = 749,
    Talhelper = 751,
    ["Talisman configuration"] = 752,
    Taplo = 1101,
    ["Taskfile config"] = 897,
    Taurus = 753,
    Tauticord = 754,
    Telefonistka = 1087,
    ["TestEnvironment.json"] = 764,
    ["TextMate Grammar"] = 763,
    ["Tier.run pricing.json"] = 757,
    Tikibase = 758,
    Tombi = 762,
    ["Traefik v2"] = 767,
    ["Traefik v2 File Provider"] = 768,
    ["Traefik v3"] = 769,
    ["Traefik v3 File Provider"] = 770,
    ["Travis CI (.travis.yml)"] = 766,
    Trident = 1083,
    ["TrueScript for *.tscript files"] = 773,
    ["Tugboat QA config.yml"] = 1080,
    TunnelHub = 1000,
    Turborepo = 765,
    Tycho = 1048,
    Tye = 927,
    ["Tyk Gateway - Open Source v5.7+"] = 1092,
    ["Typst Manifest"] = 788,
    ["UET BuildConfig.json"] = 970,
    ["UI5 Manifest"] = 794,
    ["UNCORS configuration"] = 798,
    ["UTAM Page Object"] = 797,
    ["Ubuntu Server Autoinstall"] = 792,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1084,
    ["Uniswap Token List"] = 880,
    ["Universal Schedule Format"] = 799,
    ["Unreal Engine Uplugin"] = 971,
    ["Unreal Engine Uproject"] = 972,
    ["UpCloud CLI (upctl) configuration"] = 1085,
    ["Updatecli Compose"] = 935,
    ["Updatecli Policy Manifest"] = 936,
    ["Updatecli Policy Metadata"] = 937,
    Uplift = 968,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 901,
    V2Ray = 941,
    ["VSCode Code Snippets"] = 205,
    ["VSIX CLI publishing"] = 819,
    Vector = 801,
    ["Vela Pipeline Configuration"] = 804,
    Vercel = 204,
    ["Version Bumper config"] = 809,
    ["Viash Component Config"] = 1089,
    ["Viash Package Config"] = 1090,
    Visivo = 998,
    ["WP-CLI"] = 829,
    Wake = 1082,
    ["Waku Config"] = 1062,
    ["Web App Manifest"] = 825,
    ["Web types"] = 828,
    WebExtensions = 824,
    ["Webman package recipe"] = 947,
    ["Windows Package Manager Installer Manifest"] = 876,
    ["Windows Package Manager Locale Manifest"] = 877,
    ["Windows Package Manager Singleton Manifest"] = 875,
    Winutil = 878,
    ["WireMock stub mapping"] = 1065,
    ["Woodpecker pipeline config"] = 915,
    ["Wrangler CLI"] = 830,
    ["Xstate Machine"] = 933,
    ["Yandex Workflow Language"] = 1054,
    ["Yarn Config (.yarnrc.yml)"] = 890,
    ["Yippee-Ki-JSON configuration YML"] = 882,
    ["YouTrack App"] = 1051,
    ["Zerops.io config"] = 1039,
    ["Zerops.io import"] = 1040,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 1003,
    ...
    ["behat.yml"] = 106,
    ["bigquery-table"] = 95,
    ["bioimageio resource description"] = 1020,
    ...
    ["ccmod.json"] = 1063,
    changelogging = 1031,
    ["chisel-slices.json"] = 231,
    ["chrome-extension-locales-messages.json"] = 212,
    ["chutzpah.json"] = 213,
    cibuildwheel = 140,
    ["clang-format (.clang-format)"] = 939,
    ["clang-tidy"] = 192,
    clangd = 191,
    clib = 193,
    ["cloud-init: cloud-config userdata"] = 195,
    ["cloud-sdk-pipeline-configuration"] = 215,
    ["cloudbuild.json"] = 216,
    cloudify = 194,
    codemagic = 196,
    ["coffeelint.json"] = 233,
    ["commands.json"] = 208,
    ["commitlint (.commitlintrc)"] = 879,
    ["committed.toml"] = 234,
    ["compile_commands.json"] = 207,
    ["compilerconfig.json"] = 206,
    ["completely.yml"] = 976,
    ["component-detection-manifest.json"] = 237,
    ["component.json"] = 236,
    ["composer.json"] = 235,
    ["conda-forge"] = 143,
    ["config.yaml"] = 620,
    ["contentmanifest.json"] = 214,
    ["contribute.json"] = 238,
    ["cosmos.config.json"] = 210,
    ["crowdin.yml"] = 239,
    ["ctfd-setup configuration file"] = 1072,
    ["custom-elements.json"] = 990,
    ["cypress.json"] = 243,
    ["datalogic-scan2deploy-android"] = 253,
    ["datalogic-scan2deploy-ce"] = 254,
    ["dbt Dependencies"] = 159,
    ["dbt Packages"] = 161,
    ["dbt Project"] = 160,
    ["dbt Selectors"] = 162,
    ["dbt YAML files"] = 163,
    ["ddev-global"] = 255,
    ["ddev-project"] = 256,
    ["debugsettings.json"] = 257,
    ["dependabot-v2.json"] = 260,
    ["dependabot.json"] = 259,
    ["deployed-cli"] = 932,
    ["devcontainer.json"] = 198,
    devinit = 884,
    ["devspace.yaml"] = 955,
    djlint = 885,
    ["docker bake"] = 265,
    ["docker sequencer"] = 266,
    ["docker-compose.yml"] = 883,
    ["dockerd.json"] = 264,
    ["dotnet Release Index manifest"] = 277,
    ["dotnet-tools.json"] = 278,
    ["dotnetcli.host.json"] = 279,
    ["dprint.json"] = 280,
    ["drone.json"] = 281,
    ["dss-2.0.0.json"] = 283,
    ["dstack configuration"] = 284,
    ["dtool dataset metadata"] = 1067,
    ["dvc.yaml"] = 285,
    ["ecosystem.json"] = 290,
    eksctl = 291,
    ["electron-builder configuration file"] = 297,
    ["epr-manifest.json"] = 296,
    ["evcc.yaml"] = 298,
    ["ezd task runner"] = 308,
    ["fabric.mod.json"] = 310,
    ["first-timers-bot"] = 317,
    ["flagd flag configuration"] = 82,
    ["fly.io Configuration"] = 83,
    fulibWorkflows = 914,
    ["function.json"] = 328,
    ["gRPC API Gateway & OpenAPI Config"] = 7,
    ["gematik health care insurance list"] = 1078,
    ["gematik health care patient list"] = 1075,
    ["gematik health care provider institution list"] = 1077,
    ["gematik health care provider list"] = 1076,
    ["gematik tiger test environment configuration"] = 1079,
    ["gitlab-ci"] = 345,
    ["global.json"] = 361,
    ["go-feature-flag Flag Configuration"] = 364,
    ["haxelib.json"] = 380,
    helmfile = 871,
    helmwave = 872,
    ["host-meta.json"] = 387,
    ...
    ["ide.host.json"] = 394,
    ["ifstate.conf"] = 395,
    ["imageoptimizer.json"] = 396,
    ["importmap.json"] = 399,
    ["ioBroker Configuration"] = 401,
    ["ioBroker JSON UI"] = 402,
    ["ioBroker Package manifest"] = 403,
    ["ize.toml"] = 967,
    ["jsconfig.json"] = 428,
    ["jscpd Configuration"] = 952,
    jsdoc = 867,
    ["k3d.yaml"] = 429,
    ["k9s aliases.yaml"] = 431,
    ["k9s cluster-config.yaml"] = 433,
    ["k9s config.yaml"] = 432,
    ["k9s hotkeys.yaml"] = 434,
    ["k9s plugins.yaml"] = 435,
    ["k9s skin.yaml"] = 436,
    ["k9s views.yaml"] = 437,
    ["kontinuous-config.yaml"] = 448,
    ["kontinuous-values.yaml"] = 447,
    ["kustomization.yaml"] = 450,
    ["label-commenter-config.yml"] = 451,
    ["latexindent configuration"] = 76,
    ["launchsettings.json"] = 452,
    lazydocker = 989,
    lazygit = 988,
    ["lego.json"] = 454,
    ["lerna.json"] = 455,
    ["lgtm.yml"] = 456,
    ["liblab.config.json"] = 457,
    ["libman.json"] = 458,
    ["license-report-config.json"] = 459,
    ["linkinator.config.json"] = 461,
    ["lint-staged (.lintstagedrc)"] = 846,
    ["local.settings.json"] = 466,
    ["localazy.json"] = 467,
    ["lotus.yaml"] = 465,
    ["lsdlschema.json"] = 468,
    ["markdown-link-check"] = 910,
    maturin = 911,
    mboats = 918,
    ["micro-settings.json"] = 982,
    ["mimetypes.json"] = 481,
    ["mirrord config"] = 847,
    mise = 848,
    ["mkdocs.yml"] = 501,
    ["monospace.yml"] = 504,
    ["moon.yml"] = 1064,
    ["mprocs Configuration file"] = 1035,
    ["mrdocs.yml"] = 502,
    ["mta.yaml"] = 849,
    ["mtad.yaml"] = 850,
    ["mycode.json"] = 511,
    nFPM = 515,
    ["napari plugin manifest"] = 512,
    neoload = 862,
    ["nest-cli"] = 518,
    ["ninjs (News in JSON)"] = 517,
    ["nitro.json"] = 861,
    ["nixd configuration"] = 1008,
    ["nlu.json"] = 519,
    ["nodemon.json"] = 521,
    ["noodl config"] = 917,
    ["notebook.mod.json"] = 522,
    now = 857,
    ["npm-badges"] = 525,
    ["nswag.json"] = 529,
    ntangle = 531,
    ["nuclei-template.yaml"] = 526,
    ["nuget-project.json"] = 527,
    ["ocelot.json"] = 533,
    ["omnisharp.json"] = 537,
    ["openapi.json"] = 538,
    ["openfin.json"] = 545,
    ...
    ["ops.yaml"] = 542,
    ["package.json"] = 566,
    ["package.manifest"] = 567,
    ["partial-black.json"] = 107,
    ["pathfinder.yml"] = 570,
    ["pattern.json"] = 573,
    ["petstore-v1.0"] = 962,
    pgap_yaml_input_reader = 572,
    ["pixi.toml"] = 574,
    ["plagiarize-me.yaml"] = 578,
    ["plagiarize.yaml"] = 577,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1068,
    ["podbard.yaml"] = 580,
    ["portman.json"] = 581,
    ["prefect.toml"] = 589,
    ["prettierrc.json"] = 590,
    ["prisma.yml"] = 591,
    ["project-1.0.0-beta3.json"] = 600,
    ["project-1.0.0-beta4.json"] = 601,
    ["project-1.0.0-beta5.json"] = 602,
    ["project-1.0.0-beta6.json"] = 603,
    ["project-1.0.0-beta8.json"] = 604,
    ["project-1.0.0-rc1.json"] = 605,
    ["project-1.0.0-rc2.json"] = 606,
    ["project.json"] = 599,
    ["project.owasp.yaml"] = 607,
    ["prometheus.json"] = 608,
    ["prometheus.rules.json"] = 609,
    ["prometheus.rules.test.json"] = 610,
    ["proxies.json"] = 611,
    ["publiccode.yml"] = 612,
    ["pubspec.yaml"] = 613,
    ["pyrseas-0.8.json"] = 616,
    pytest = 625,
    ["quilt.mod.json"] = 983,
    ["rc3 auth"] = 630,
    ["rc3 collection"] = 631,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 863,
    ["release-please-config.json"] = 640,
    ["release-please-manifest.json"] = 641,
    ["release-plz.toml"] = 642,
    ["renv.lock"] = 652,
    ["rivet.json"] = 1007,
    ["rivet.yaml (legacy)"] = 1006,
    rockcraft = 654,
    runny = 656,
    rustfmt = 657,
    sake = 1095,
    samt = 659,
    samtrc = 660,
    ["sarif-1.0.0.json"] = 662,
    ["sarif-2.0.0.json"] = 663,
    ["sarif-2.1.0"] = 673,
    ["sarif-2.1.0-rtm.2"] = 664,
    ["sarif-2.1.0-rtm.3"] = 666,
    ["sarif-2.1.0-rtm.4"] = 668,
    ["sarif-2.1.0-rtm.5"] = 670,
    ["sarif-2.1.0-rtm.6"] = 671,
    ["sarif-external-property-file-2.1.0"] = 674,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 665,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 667,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 669,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 672,
    ["scalingo.json configuration"] = 675,
    ["schema.org - Action"] = 677,
    ["schema.org - ContactPoint"] = 678,
    ["schema.org - Place"] = 679,
    ["schema.org - Thing"] = 680,
    ["secrethub.yml"] = 985,
    ["semantic-release"] = 686,
    ["servicehub.config.json"] = 841,
    ["servicehub.service.json"] = 840,
    ["settings.job"] = 689,
    ["sfdx-hardis configuration"] = 691,
    ["shard.yml"] = 1023,
    ["size-limit configuration"] = 696,
    ["skaffold.yaml"] = 908,
    ["skyuxconfig.json"] = 698,
    snapcraft = 699,
    ["snowflake-config"] = 700,
    ["snowflake-connections"] = 701,
    ["spicepod.yaml"] = 1043,
    ["sqlc configuration"] = 732,
    ["stripe-app-local.json"] = 741,
    ["stripe-app.json"] = 740,
    swcrc = 893,
    ["task.json"] = 750,
    taskcat = 858,
    ["template.json"] = 755,
    ["templatsources.json"] = 756,
    ["theme.json"] = 759,
    ["tizen_workspace.json"] = 760,
    tldr = 761,
    ["tm_devices configuration file"] = 1106,
    tmuxinator = 844,
    ["transcend.yml"] = 771,
    ["tree-sitter grammar.json"] = 369,
    ["trime.yaml"] = 772,
    ["trunk.yaml"] = 774,
    ["ts-force-config.json"] = 779,
    ["tsconfig.json"] = 775,
    ["tsd.json"] = 776,
    ["tsdoc.json"] = 777,
    ["tsdrc.json"] = 778,
    ...
    v8r = 823,
    vcluster = 1029,
    ["vcpkg configuration file"] = 203,
    ["vcpkg manifest file"] = 202,
    ["vega-lite.json"] = 803,
    ["vega.json"] = 802,
    ["venvironment-basic.yaml"] = 806,
    ["venvironment.yaml"] = 805,
    ["venvplus-basic.yaml"] = 808,
    ["venvplus.yaml"] = 807,
    version = 1088,
    ["version.json"] = 810,
    ["vhwdebugger-binding.yaml"] = 812,
    ["vim-addon-info"] = 813,
    ["vs-2017.3.host.json"] = 815,
    ["vs-nesting.json"] = 816,
    ["vsls.json"] = 814,
    ["vss-extension.json"] = 820,
    vtcfg = 1094,
    ["vtesttree.yaml"] = 821,
    ["vtestunit.yaml"] = 822,
    ["warp-keysets.json"] = 991,
    ["warp-themes.json"] = 992,
    ["warp-workflows.json"] = 993,
    ["webhint.io"] = 948,
    ["webjobpublishsettings.json"] = 827,
    ["webjobs-list.json"] = 826,
    ["well-known-fursona"] = 1030,
    ["xs-app.json"] = 853,
    ["xunit.runner.json"] = 839,
    yamllint = 881,
    zuul = 864,
    ["Žinoma"] = 874
  },
