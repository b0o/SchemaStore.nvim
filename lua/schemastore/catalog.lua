...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 910,
    [".nodehawkrc"] = 561,
    [".npmpackagejsonlintrc"] = 565,
    [".omletrc"] = 1088,
    [".phrase.yml"] = 635,
    [".phraseapp.yml"] = 636,
    [".pmbot.yml"] = 621,
    [".postcssrc"] = 630,
    [".powerpages-web-template-manifest"] = 632,
    [".pre-commit-config.yml"] = 633,
    [".pre-commit-hooks.yml"] = 634,
    [".putout.json"] = 668,
    [".rehyperc"] = 693,
    [".remarkrc"] = 697,
    [".sprite files"] = 787,
    ...
    AIConfig = 29,
    ["AMX Muse Program Descriptor"] = 1136,
    ["API Builder"] = 945,
    ["AVA Configuration"] = 1008,
    ["AWS AppConfig Feature Flags-v1"] = 63,
    ["AWS CDK cdk.json"] = 247,
    ["AWS CloudFormation"] = 248,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 249,
    ["AWS Copilot Manifest"] = 1175,
    ["AWS SAM CLI Samconfig"] = 250,
    ["Adobe UXP Manifest"] = 1071,
    ["Aerleon Network & Service Definitions"] = 16,
    ["Aerleon Policy"] = 17,
    Aider = 1165,
    Air = 19,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1186,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1185,
    ["Airlock Microgateway"] = 30,
    ["Alacritty Configuration"] = 980,
    ["All Contributors configuration file"] = 1034,
    ["Ansible Argument Specs"] = 382,
    ["Ansible Collection Galaxy"] = 389,
    ["Ansible Execution Environment"] = 379,
    ["Ansible Inventory"] = 388,
    ["Ansible Meta"] = 380,
    ["Ansible Meta Runtime"] = 381,
    ["Ansible Navigator Configuration"] = 391,
    ["Ansible Playbook"] = 386,
    ["Ansible Requirements"] = 383,
    ["Ansible Rulebook"] = 387,
    ["Ansible Tasks File"] = 385,
    ["Ansible Vars File"] = 384,
    ["Ansible-lint Configuration"] = 390,
    Any = 1098,
    ["AnyWork Automation Configuration"] = 12,
    ["Apollo Router"] = 946,
    ["App config Spotify Backstage"] = 34,
    ["Application Accelerator"] = 9,
    ["Application list for a WinUtil"] = 1115,
    ArchitectFX = 1120,
    ["Argo CD"] = 49,
    ["Argo Events"] = 50,
    ["Argo Workflows"] = 51,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1184,
    ["Azure IoT Operations connector metadata"] = 1181,
    ...
    ["Azure Pipelines"] = 105,
    ["Azure Static Web Apps CLI configuration file"] = 791,
    ["Azure Static Web Apps configuration file"] = 790,
    ["BOSH CPI Config"] = 129,
    ["BOSH Deploy Config"] = 130,
    ["BX CI"] = 149,
    ["Bacon config"] = 3,
    ["Bashly (bashly.yml)"] = 1038,
    ["Bashly Settings (bashly-settings.yml)"] = 1039,
    Bento = 1202,
    ["Better Code Hub"] = 950,
    ["Better Scripts"] = 150,
    Bigconfig = 122,
    ["Biome Formatter Config"] = 77,
    ["Bitmovin Encoding Template"] = 1129,
    BizTalkServerApplicationSchema = 917,
    Bleep = 151,
    ...
    ["Butane Config"] = 993,
    C4InterFlow = 1144,
    ["CDK Environment Manager, concrete environment configuration"] = 1168,
    ["CDK Environment Manager, concrete environments definition"] = 1167,
    ["CDK Environment Manager, environment definition"] = 1166,
    ["CGS Card Game Specification (cgs.json)"] = 1076,
    ["CICS TS region tagging"] = 1002,
    ["CICS TS resource import"] = 1003,
    ["CICS TS resource model"] = 1004,
    ["CICS TS resource overrides"] = 1005,
    ["CMake Presets"] = 152,
    ["CNC Codes"] = 173,
    ["CRS WAF test file"] = 1105,
    ["CRS WAF test platform overrides file"] = 1106,
    ["CSS Comb (.csscomb.json)"] = 275,
    ["CSS Lint (.csslintrc)"] = 276,
    ["CSpell (cspell.json)"] = 274,
    ...
    ["Chamaleon environment"] = 1133,
    ["Chamaleon properties"] = 1134,
    ["Chamaleon template"] = 1132,
    Changepacks = 1195,
    Changesets = 259,
    Changie = 161,
    Charmcraft = 162,
    ...
    CodeCV = 89,
    CodeRabbit = 88,
    ["CodeShip Pro services configuration files"] = 229,
    ["CodeShip Pro steps configuration files"] = 230,
    ["Codecov configuration files"] = 228,
    CodifyCLI = 90,
    Codux = 226,
    ["Cog config file"] = 174,
    ["Commandbox Box.json"] = 175,
    ["Commandbox Server.json"] = 176,
    ["Common Catalog Data"] = 238,
    ["Common Package Specification"] = 177,
    Concord = 1104,
    ["Configu .cfgu files"] = 1092,
    ["Configu .configu file"] = 1093,
    Conjure = 172,
    ["Container Structure Test"] = 931,
    Containerlab = 959,
    ["Contextive Glossary"] = 1160,
    Convex = 171,
    ["Crowdsec collection config"] = 269,
    ["Crowdsec parser config"] = 270,
    ["Crowdsec scenario config"] = 271,
    ["CumulusCI Config"] = 178,
    ["Custom Machinery Machine"] = 1077,
    ["Custom Machinery Recipe"] = 1078,
    ["Cycle Stack File"] = 182,
    CycloneDX = 183,
    ["DWP Exchange - catalogue entry"] = 318,
    ["DWP Exchange - gateway"] = 316,
    ["DWP Exchange - meta"] = 317,
    ["Dart Build Config (dart-build.json)"] = 277,
    ["Dart Test Config (dart-test.json)"] = 278,
    ["DashLord Configuration"] = 279,
    ["Data Contract Specification"] = 280,
    ["Data Product Specification"] = 281,
    ["DataYoga Connections"] = 184,
    ["DataYoga Job"] = 185,
    ["Databricks Asset Bundles"] = 1055,
    ["Datadog Continuous Testing"] = 480,
    ["Datadog Service Definition"] = 481,
    ["Datadog Software Catalog"] = 482,
    ["Datahub Ingestion Recipe"] = 1009,
    ["Debian Upstream Metadata file"] = 191,
    ["Deck config"] = 192,
    ["Dein Config"] = 193,
    ["Deno Config (deno.json)"] = 287,
    ["Dependency cruiser"] = 194,
    ["DeployStack Configuration"] = 195,
    ["Deployah Configuration"] = 1183,
    ["Deployer Recipe"] = 290,
    ["Deta Spacefile"] = 196,
    ["Detekt Config (detekt.yml)"] = 291,
    ["Devbox Config"] = 197,
    ["Devbox Plugin"] = 198,
    Devfile = 315,
    Devup = 1196,
    DipDup = 1107,
    ["Discord Webhook"] = 292,
    ["DocFx Config (docfx.json)"] = 296,
    Dofigen = 297,
    ["Dolittle Artifacts"] = 298,
    ["Dolittle Bounded Context Configuration"] = 299,
    ["Dolittle Event Horizons Configuration"] = 300,
    ["Dolittle Resources Configuration"] = 301,
    ["Dolittle Server Configuration"] = 302,
    ["Dolittle Tenant Map Configuration"] = 304,
    ["Dolittle Tenants Configuration"] = 303,
    ["Dolittle Topology"] = 305,
    ["DonateCaseBetterCasino menu"] = 1137,
    ...
    ["Drupal Routing"] = 210,
    ["Drupal Services"] = 212,
    ["Drush site aliases"] = 311,
    ["Dynamic Bash Aliases (.aliases)"] = 1046,
    ["EAS config"] = 335,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1035,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1180,
    ["EasyVCR .NET"] = 336,
    ["Eidolon Resource"] = 1121,
    ["Elgato Stream Deck"] = 321,
    Elm = 1109,
    ["Embrace Config"] = 1021,
    Endurica = 1059,
    ["Enterprise Contract Policy Spec"] = 322,
    ["Erda Pipeline"] = 1084,
    ["Erda Runtime"] = 1085,
    Esquio = 324,
    ["Estuary Flow Catalog"] = 999,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 328,
    ["EveryVoice TTS Toolkit Data Configuration"] = 329,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 333,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 332,
    ["EveryVoice TTS Toolkit Text Configuration"] = 330,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 331,
    ["Evolving Resolutive Process notation"] = 1182,
    ["Expo SDK"] = 334,
    ["F-Droid Data metadata"] = 340,
    ["FasterCI Configuration"] = 106,
    FiQuS = 344,
    Firebase = 342,
    ["FlexGet Config"] = 345,
    ["Flow.json Configurations"] = 1081,
    ["Fossa configuration file"] = 352,
    ["Fossa's fossa-deps file"] = 353,
    ["Foundry VTT - Base package Manifest"] = 347,
    ["Foundry VTT - Module Manifest"] = 348,
    ["Foundry VTT - System Data Template"] = 351,
    ["Foundry VTT - System Manifest"] = 349,
    ["Foundry VTT - World Manifest"] = 350,
    ["Foxx Manifest"] = 107,
    ["Freifunk.de Community API"] = 110,
    ["Frogbot Config"] = 111,
    ["G2P Mapping Configuration"] = 359,
    ["GCP Blueprint Metadata"] = 362,
    Gaspar = 360,
    ["GatewayCore API Gateway"] = 361,
    ["Gemini CLI settings"] = 363,
    ["GeoJSON.json latest"] = 997,
    GherKing = 1001,
    ["GitHub Action"] = 368,
    ["GitHub Actions typing"] = 1117,
    ["GitHub Discussion"] = 369,
    ["GitHub Funding"] = 370,
    ["GitHub Issue Template configuration"] = 371,
    ["GitHub Issue Template forms"] = 372,
    ["GitHub Workflow"] = 373,
    ["GitHub Workflow Template Properties"] = 374,
    ["GitHub automatically generated release notes configuration"] = 375,
    ["GitLab Agent for Kubernetes configuration"] = 1073,
    GitVersion = 365,
    ["Gitea Issue Template configuration"] = 366,
    ["Gitea Issue Template forms"] = 367,
    ["Gitpod Automations"] = 377,
    ["Gitpod Configuration"] = 378,
    ["GlazeWM settings"] = 1075,
    ["Global Privacy Control"] = 364,
    Goblet = 1054,
    ["Golangci-lint Configuration"] = 393,
    ["Golangci-lint Custom Plugins Configuration"] = 394,
    ["Google Chrome Related Website Sets"] = 343,
    ["Google Cloud Workflows"] = 246,
    ["Google Digital Assetlinks"] = 1161,
    Goreleaser = 396,
    ["Goreleaser Pro"] = 397,
    Goss = 398,
    ["Gradle Build Cache Node"] = 948,
    ["Gradle Enterprise"] = 947,
    ["Grafana 5.x Dashboard"] = 399,
    ["GraphQL Code Generator"] = 404,
    ["GraphQL Config"] = 403,
    ["GraphQL Mesh"] = 402,
    ["GroovyLint configuration"] = 405,
    ["Grunt JSHint task"] = 409,
    ["Grunt Watch task"] = 410,
    ["Grunt base task"] = 411,
    ["Grunt clean task"] = 407,
    ["Grunt copy task"] = 406,
    ["Grunt cssmin task"] = 408,
    HEMTT = 913,
    Hadolint = 927,
    Hammerkit = 958,
    ["Hardware Sentry Configuration"] = 1013,
    ["HashiCorp Vault"] = 412,
    Hatch = 928,
    Hayson = 414,
    ["Haystack Pipeline"] = 415,
    ["Hazelcast 5 Configuration"] = 416,
    ["Hecate Input Schema"] = 1172,
    ["Helm Chart.lock"] = 214,
    ["Helm Chart.yaml"] = 213,
    ["Helm Unittest Test Suite"] = 215,
    ["Home Assistant Integration Manifest"] = 417,
    ["Homer dashboard configuration"] = 418,
    Hugo = 989,
    ["Hugo Theme"] = 988,
    ["Hulak Configuration"] = 425,
    ["Hyperfoil benchmark configuration"] = 424,
    ["IBM Zapp document"] = 426,
    ["IBM zCodeFormatSettings"] = 427,
    ["IMG Catapult PSP"] = 432,
    ["IVMS101 by CODE Protocol"] = 1074,
    Infrahub = 434,
    Istanbul = 1017,
    ["JDownloader2 crawler multi-rules"] = 447,
    ["JDownloader2 crawler single-rules"] = 446,
    ["JFrog Applications Config"] = 448,
    ["JFrog File Spec"] = 449,
    ["JFrog Pipelines YML DSL"] = 1023,
    ["JMeter DSL cli config"] = 450,
    JReleaser = 453,
    ["JSON Document Transform"] = 461,
    ["JSON Feed"] = 462,
    ["JSON Resume"] = 703,
    ["JSON Schema Draft 2020-12"] = 895,
    ["JSON Schema Draft 4"] = 892,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1056,
    ["JSON Schema Draft 7"] = 893,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1057,
    ["JSON Schema Draft 8 (2019-09)"] = 894,
    ["JSON-API"] = 460,
    ["JSON-e templates"] = 955,
    ["JSON-stat 2.0"] = 888,
    JSONPatch = 464,
    ["JSR Package Config (jsr.json)"] = 454,
    Jarl = 1188,
    Jasmine = 441,
    Jekyll = 442,
    ["Jenkins X Pipelines"] = 443,
    ["Jenkins X Requirements"] = 444,
    Jest = 445,
    Jocker = 451,
    ["Jovo Language Models"] = 452,
    ["Jujutsu (jj) VCS config"] = 1174,
    ["KIMMDY config file"] = 475,
    ["KODE/CI build.yaml"] = 1019,
    ["KSP-AVC"] = 889,
    ["KSP-CKAN"] = 890,
    ["KSP-NetKAN"] = 891,
    KSY = 1086,
    KSail = 357,
    ["Karakum configuration file"] = 354,
    Kas = 467,
    ["Kestra flow file"] = 476,
    ["Keycloak REST API"] = 1026,
    ["Knative Functions - func.yaml"] = 355,
    Knip = 356,
    ["Kometa (nightly) config file"] = 478,
    ["Kometa config file"] = 477,
    ["Kong DBLess config"] = 1020,
    KrakenD = 479,
    ["Kubri Configuration"] = 486,
    LOOBin = 501,
    ["Lake configuration file"] = 1177,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 251,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 252,
    ["Landing Zone Accelerator on AWS - Global Config"] = 253,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 254,
    ["Landing Zone Accelerator on AWS - Network Config"] = 255,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 256,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 257,
    ["Landing Zone Accelerator on AWS - Security Config"] = 258,
    ["Lando (landofile)"] = 101,
    ["LangGraph Platform configuration"] = 1097,
    ["Language configuration"] = 1096,
    Lefthook = 490,
    ["Liferay client-extension.yaml"] = 497,
    ["LinkML Metamodel"] = 499,
    Liquibase = 964,
    ["Liquibase Flow File"] = 965,
    ["Lively Properties"] = 500,
    ["Lobe AI Agent"] = 103,
    Loki = 104,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 541,
    ["MS2Rescore Configuration"] = 544,
    ["Madness (madness.yml)"] = 1037,
    ["Mado configuration"] = 507,
    ["MapEHR Mapping"] = 508,
    Markdownlint = 968,
    ["Mason Registry"] = 971,
    ["MegaLinter Custom Flavor"] = 511,
    ["MegaLinter configuration"] = 510,
    ["MegaLinter descriptor"] = 512,
    Melange = 1064,
    ["Meltano project definition"] = 513,
    ["Mergify Configuration"] = 545,
    ["Metadata for a Bazel module"] = 514,
    ["Metadata for a Cinnamon spice"] = 1113,
    ["Metatype Configuration"] = 515,
    ["MetricsHub Configuration"] = 516,
    ["MetricsHub Connector Configuration"] = 517,
    ["Micro Editor Syntax"] = 1047,
    ["Microsoft Band Web Tile"] = 518,
    ["Microsoft RulesEngine workflow rules"] = 1101,
    ["Microsoft RulesEngine workflow rules list"] = 1102,
    ["Minecraft Custom Main Menu Mod"] = 1065,
    ["Minecraft Data Pack Advancement"] = 520,
    ["Minecraft Data Pack Biome"] = 521,
    ["Minecraft Data Pack Configured Carver"] = 522,
    ["Minecraft Data Pack Damage Type"] = 523,
    ["Minecraft Data Pack Dimension"] = 525,
    ["Minecraft Data Pack Dimension Type"] = 524,
    ["Minecraft Data Pack Item Modifier"] = 526,
    ["Minecraft Data Pack Loot Table"] = 527,
    ["Minecraft Data Pack Metadata"] = 528,
    ["Minecraft Data Pack Predicate"] = 529,
    ["Minecraft Data Pack Recipe"] = 530,
    ["Minecraft Data Pack Tag"] = 531,
    ["Minecraft Data Pack Template Pool"] = 532,
    ["Minecraft Data Pack Trim Material"] = 537,
    ["Minecraft Data Pack Trim Pattern"] = 538,
    ["Minecraft Resource Pack Lang"] = 533,
    ["Minecraft Resource Pack Particle"] = 534,
    ["Minecraft Resource Pack Texture Mcmeta"] = 536,
    ["Minecraft Resourcepack Sounds"] = 535,
    ["Monade CLI Stack Configuration"] = 548,
    ["MongoDB Atlas Search Index Definition"] = 1018,
    ["Monika Configuration"] = 1016,
    ["Monoweave Configuration"] = 543,
    ["Motif config"] = 909,
    MultiQC = 1154,
    ["NOX Framework (Service)"] = 564,
    ["Netin Diagnostic System Template"] = 975,
    ["Netlify config"] = 551,
    ["Network-as-Code Data Model"] = 552,
    ["Next Gen UI Agent A2A Server Configuration"] = 553,
    ["Next Gen UI Agent Configuration"] = 555,
    ["Next Gen UI Agent MCP Server Configuration"] = 554,
    ["Nightwatch.js"] = 557,
    ["Node.js configuration"] = 914,
    ["NueJS configuration file"] = 569,
    ["Nuitka.yaml"] = 1079,
    ["Nullstone config"] = 571,
    ["ONe's changelog entry"] = 589,
    ["ONe's service descriptor"] = 588,
    ["ORT Server repository environment configuration"] = 597,
    ["OSCAL Assessment Plan (AP)"] = 599,
    ["OSCAL Assessment Results (AR)"] = 600,
    ["OSCAL Catalog"] = 601,
    ["OSCAL Component Definition (CDef)"] = 602,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 603,
    ["OSCAL Profile"] = 604,
    ["OSCAL System Security Plan (SSP)"] = 605,
    ["OSS Review Toolkit configuration"] = 606,
    ["OSS Review Toolkit curation"] = 607,
    ["OSS Review Toolkit package configuration"] = 608,
    ["OSS Review Toolkit repository configuration"] = 609,
    ["OSS Review Toolkit resolutions"] = 610,
    ["October CMS columns"] = 575,
    ["October CMS fields"] = 576,
    ["Oh My Posh"] = 577,
    Okteto = 578,
    ["Ona Automations"] = 580,
    Opctl = 912,
    ["Open Data Contract Standard (ODCS)"] = 592,
    ["Open Data Product Standard (ODPS)"] = 593,
    ["Open Know-How"] = 1159,
    ["OpenRewrite Resource"] = 591,
    OpenStatus = 1170,
    ["OpenUtau character yaml"] = 585,
    ["OpenUtau ustx"] = 586,
    ["OpenWeather Current Weather API"] = 954,
    ["OpenWeather Road Risk API"] = 953,
    ["Ory Hydra configuration"] = 423,
    ["Ory Keto configuration"] = 483,
    ["Ory Kratos configuration"] = 598,
    ["Ory Oathkeeper configuration"] = 573,
    ["Outblocks App configuration"] = 595,
    ["Outblocks database table"] = 596,
    ["Outblocks project configuration"] = 594,
    PDM = 617,
    POPxf = 627,
    ["POPxf Correlations"] = 628,
    Packer = 614,
    Pantsbuild = 1033,
    ["Paper paper-plugin.yml"] = 615,
    ["Pipeline component"] = 966,
    ["Platform.sh application"] = 5,
    ["Platform.sh routes"] = 6,
    ["Platform.sh services"] = 7,
    ["Plex Prerolls"] = 625,
    ["PocketMine plugin.yml"] = 622,
    ["Postman collection"] = 631,
    ["Power Pages Configuration"] = 1171,
    ["Preset list for a WinUtil"] = 1116,
    ["ProActions AI-Kit Configuration"] = 641,
    ["ProActions AI-Kit Configuration for Menus"] = 643,
    ["ProActions AI-Kit Configuration for Sections"] = 645,
    ["ProActions AI-Kit Configuration for Services"] = 642,
    ["ProActions AI-Kit Configuration for Steps"] = 646,
    ["ProActions AI-Kit Configuration for Templates"] = 644,
    ["Problem object RFC9457"] = 1062,
    ["Problem package format"] = 647,
    ["Problem package generators"] = 648,
    ["Problem package submissions"] = 649,
    ["Problem package test group metadata"] = 650,
    Pterodactyl = 1012,
    ["Pull Request Labeler"] = 667,
    Pulumi = 675,
    ["PyGTA Config"] = 671,
    PyProject = 676,
    Pylock = 1162,
    Pyright = 677,
    ["Python script metadata"] = 1156,
    ["QType AI DSL"] = 680,
    Qgoda = 679,
    Qodana = 985,
    ["Qt Creator workspace file"] = 1094,
    ["Quali Torque Blueprint Spec 2"] = 1010,
    ["QueryFirst config file"] = 1029,
    ["RKE Cluster Configuration JSON"] = 963,
    ["RKE Cluster Configuration YAML"] = 962,
    RadioHound = 670,
    Railpack = 682,
    Railway = 681,
    ["Rancher Fleet"] = 672,
    ...
    Ray = 926,
    ["Read the Docs"] = 674,
    ["Red-DiscordBot Cog"] = 690,
    ["Red-DiscordBot Cog Repo"] = 691,
    ["Red-DiscordBot Trivia"] = 692,
    ["Releasaurus Config"] = 2,
    ["Render Blueprints"] = 961,
    RenderCV = 706,
    Renovate = 704,
    ["Renovate global configuration"] = 705,
    ["Replit config"] = 698,
    Restate = 1149,
    ["Revel Digital Gadget Definition File"] = 1173,
    RoadRunner = 708,
    ["Robust Station Image"] = 1179,
    Rockcraft = 709,
    ["Roo Coder Custom Modes"] = 710,
    Rubocop = 700,
    ["Rudder techniques"] = 1069,
    Ruff = 701,
    ["Rust Project"] = 702,
    ["Rust toolchain"] = 714,
    ["SDMX data message"] = 740,
    ["SDMX metadata message"] = 739,
    ["SDMX structure message"] = 738,
    ["SIL Kit Participant Configuration"] = 750,
    ["SIL Kit Registry Configuration"] = 751,
    ["SPDX 2.3"] = 788,
    SWADL = 804,
    ["Safebox Config"] = 1024,
    ["Sapphire CLI Config"] = 717,
    ["SauceCTL Configuration"] = 972,
    ["Schema Catalog"] = 732,
    ["Scoop manifest"] = 737,
    ["Semantic Data Fabric (SDF) file"] = 741,
    ["Semgrep Rule"] = 743,
    ["Serenity Code Generator (Sergen)"] = 744,
    ["Serverless Framework Configuration"] = 979,
    ["Serverless Workflow"] = 981,
    ["Settings for a Cinnamon spice"] = 1112,
    ["Settings.paf"] = 746,
    ["Shopware 6 Configuration"] = 982,
    ["Shopware CLI Extension Store Configuration"] = 983,
    ["Shopware CLI Project Store Configuration"] = 984,
    ["Sigma Detection Rule"] = 748,
    ["Sigrid scope configuration file"] = 749,
    ["SkyPilot Task JSON"] = 1070,
    ["Slack app manifest"] = 753,
    Snapcraft = 755,
    Solidarity = 758,
    ["Solution filters"] = 759,
    ["Source Maps v3"] = 760,
    Sourcery = 761,
    ["Spack bootstrap.yaml"] = 762,
    ["Spack cdash.yaml"] = 763,
    ["Spack ci.yaml"] = 764,
    ["Spack compilers.yaml"] = 765,
    ["Spack concretizer.yaml"] = 766,
    ["Spack config.yaml"] = 767,
    ["Spack definitions.yaml"] = 768,
    ["Spack develop.yaml"] = 769,
    ["Spack env_vars.yaml"] = 770,
    ["Spack environment"] = 776,
    ["Spack include.yaml"] = 771,
    ["Spack mirrors.yaml"] = 772,
    ["Spack modules.yaml"] = 773,
    ["Spack packages.yaml"] = 774,
    ["Spack repos.yaml"] = 775,
    ["Spack toolchains.yaml"] = 777,
    ["Spack upstreams.yaml"] = 778,
    ["Spack view.yaml"] = 779,
    ["Speakeasy Generation Config File"] = 783,
    ["Speakeasy Lint Configuration File"] = 780,
    ["Speakeasy Test Generation Configuration File"] = 781,
    ["Speakeasy Workflow File"] = 782,
    SpecIF = 784,
    ["Specmatic Configuration"] = 785,
    ["Sponge Mixin configuration"] = 786,
    StackBlitz = 792,
    ["StackHawk Scanner Configuration"] = 978,
    Stale = 793,
    Starfish = 794,
    ["Starlake Data Pipeline"] = 951,
    Starship = 795,
    ["Statamic Blueprint"] = 796,
    ["Stella configuration file"] = 797,
    ["Streamlit configuration file"] = 798,
    ["Stryker Mutator"] = 801,
    ["StyleCop Analyzers Configuration"] = 802,
    ["Stylelint (.stylelintrc)"] = 803,
    ["Stylua Config"] = 1163,
    ["Sublime Syntax"] = 1025,
    ["Subsquid squid manifest"] = 1072,
    ["Swagger API 2.0"] = 805,
    ["Synadia Connect Component"] = 806,
    TSON = 841,
    TSTyche = 842,
    ["TYPO3 Vendor Bundler config"] = 847,
    ["Tab data for a LinUtil"] = 1119,
    ["Tab list for a LinUtil"] = 1118,
    Tach = 807,
    ["Tach Domain"] = 808,
    Talhelper = 810,
    ["Talisman configuration"] = 811,
    Taplo = 1164,
    ["Taskfile config"] = 956,
    Taurus = 812,
    Tauticord = 813,
    ["Tekton Pipeline"] = 1192,
    ["Tekton PipelineRun"] = 1193,
    ["Tekton Task"] = 1190,
    ["Tekton TaskRun"] = 1191,
    Telefonistka = 1150,
    ["Terrateam config"] = 1176,
    ["TestEnvironment.json"] = 824,
    ["TextMate Grammar"] = 823,
    Threagile = 819,
    ["Tier.run pricing.json"] = 816,
    Tikibase = 817,
    Tombi = 822,
    ["Traefik v2"] = 827,
    ["Traefik v2 File Provider"] = 828,
    ["Traefik v3"] = 829,
    ["Traefik v3 File Provider"] = 830,
    ["Travis CI (.travis.yml)"] = 826,
    Treefmt = 401,
    Trident = 1146,
    ["TrueScript for *.tscript files"] = 833,
    ["Tugboat QA config.yml"] = 1143,
    TunnelHub = 1060,
    Turborepo = 825,
    Tycho = 1108,
    Tye = 986,
    ["Tyk Gateway - Open Source v5.7+"] = 1155,
    ["UET BuildConfig.json"] = 1030,
    ["UI5 Manifest"] = 853,
    ["UNCORS configuration"] = 857,
    ["UTAM Page Object"] = 856,
    ["Ubuntu Server Autoinstall"] = 851,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1147,
    ["Uniswap Token List"] = 938,
    ["Universal Schedule Format"] = 858,
    ["Unreal Engine Uplugin"] = 1031,
    ["Unreal Engine Uproject"] = 1032,
    ["UpCloud CLI (upctl) configuration"] = 1148,
    ["Updatecli Compose"] = 994,
    ["Updatecli Policy Manifest"] = 995,
    ["Updatecli Policy Metadata"] = 996,
    Uplift = 1028,
    ["Upsun config"] = 4,
    ["User Journey Map"] = 960,
    V2Ray = 1000,
    ["VSCode Code Snippets"] = 234,
    ["VSIX CLI publishing"] = 876,
    Vector = 860,
    ["Vela Pipeline Configuration"] = 863,
    Vercel = 233,
    ["Version Bumper config"] = 866,
    Vespertide = 1197,
    ["Vespertide Migration"] = 1198,
    ["Vespertide Model"] = 1199,
    ["Viash Component Config"] = 1152,
    ["Viash Package Config"] = 1153,
    Visivo = 1058,
    ["WP-CLI"] = 886,
    Wake = 1145,
    ["Waku Config"] = 1122,
    ["Web App Manifest"] = 882,
    ["Web types"] = 885,
    WebExtensions = 881,
    ["Webman package recipe"] = 1006,
    ["Windows Package Manager Installer Manifest"] = 934,
    ["Windows Package Manager Locale Manifest"] = 935,
    ["Windows Package Manager Singleton Manifest"] = 933,
    Winutil = 936,
    ["WireMock CLI import configuration"] = 1128,
    ["WireMock CLI local service configuration"] = 1127,
    ["WireMock message stub mapping"] = 1126,
    ["WireMock stub mapping"] = 1125,
    ["Woodpecker pipeline config"] = 974,
    ["Wrangler CLI"] = 887,
    ["Xstate Machine"] = 992,
    ["Yandex Workflow Language"] = 1114,
    ["Yarn Config (.yarnrc.yml)"] = 949,
    ["Yippee-Ki-JSON configuration YML"] = 940,
    ["YouTrack App"] = 1111,
    ["Zarf Package Configuration"] = 1178,
    ["Zerops.io config"] = 1099,
    ["Zerops.io import"] = 1100,
    ["Zola Configuration"] = 1189,
    ["aerleon.yml"] = 15,
    ["angular.json"] = 31,
    apko = 1063,
    ...
    ["behat.yml"] = 132,
    ["bigquery-table"] = 121,
    ["bioimageio resource description"] = 1080,
    ...
    ["ccmod.json"] = 1123,
    changelogging = 1091,
    ["chisel-slices.json"] = 260,
    ["chrome-extension-locales-messages.json"] = 241,
    ["chutzpah.json"] = 242,
    cibuildwheel = 167,
    ["clang-format (.clang-format)"] = 998,
    ["clang-tidy"] = 221,
    clangd = 220,
    clib = 222,
    ["cloud-init: cloud-config userdata"] = 224,
    ["cloud-sdk-pipeline-configuration"] = 244,
    ["cloudbuild.json"] = 245,
    cloudify = 223,
    ["cmdx.yaml"] = 87,
    codemagic = 225,
    ["coffeelint.json"] = 262,
    ["commands.json"] = 237,
    ["commitlint (.commitlintrc)"] = 937,
    ["committed.toml"] = 263,
    ["compile_commands.json"] = 236,
    ["compilerconfig.json"] = 235,
    ["completely.yml"] = 1036,
    ["component-detection-manifest.json"] = 266,
    ["component.json"] = 265,
    ["composer.json"] = 264,
    ["conda-forge"] = 170,
    ["config.yaml"] = 673,
    ["contentmanifest.json"] = 243,
    ["contribute.json"] = 267,
    ["cosmos.config.json"] = 239,
    ["crowdin.yml"] = 268,
    ["ctfd-setup configuration file"] = 1135,
    ["custom-elements.json"] = 1050,
    ["cypress.json"] = 272,
    ["datalogic-scan2deploy-android"] = 282,
    ["datalogic-scan2deploy-ce"] = 283,
    ...
    ["ddev-global"] = 284,
    ["ddev-project"] = 285,
    ["debugsettings.json"] = 286,
    ["dependabot-v2.json"] = 289,
    ["dependabot.json"] = 288,
    ["deployed-cli"] = 991,
    ["devcontainer.json"] = 227,
    devinit = 942,
    ["devspace.yaml"] = 1014,
    djlint = 943,
    ["docker bake"] = 294,
    ["docker sequencer"] = 295,
    ["docker-compose.yml"] = 941,
    ["dockerd.json"] = 293,
    ["dotnet Release Index manifest"] = 306,
    ["dotnet-tools.json"] = 307,
    ["dotnetcli.host.json"] = 308,
    ["dprint.json"] = 309,
    ["drone.json"] = 310,
    ["dss-2.0.0.json"] = 312,
    ["dstack configuration"] = 313,
    ["dtool dataset metadata"] = 1130,
    ["dvc.yaml"] = 314,
    ["ecosystem.json"] = 319,
    eksctl = 320,
    ["electron-builder configuration file"] = 326,
    ["epr-manifest.json"] = 325,
    ["evcc.yaml"] = 327,
    ["ezd task runner"] = 337,
    ["fabric.mod.json"] = 339,
    ["first-timers-bot"] = 346,
    ["flagd flag configuration"] = 108,
    ["fly.io Configuration"] = 109,
    fulibWorkflows = 973,
    ["function.json"] = 358,
    ["gRPC API Gateway & OpenAPI Config"] = 10,
    ["gematik health care insurance list"] = 1141,
    ["gematik health care patient list"] = 1138,
    ["gematik health care provider institution list"] = 1140,
    ["gematik health care provider list"] = 1139,
    ["gematik tiger test environment configuration"] = 1142,
    ["git-town.toml"] = 1187,
    ["gitlab-ci"] = 376,
    ["global.json"] = 392,
    ["go-feature-flag Flag Configuration"] = 395,
    ["haxelib.json"] = 413,
    helmfile = 929,
    helmwave = 930,
    ["host-meta.json"] = 420,
    ...
    ["ide.host.json"] = 428,
    ["ifstate.yaml"] = 429,
    ["imageoptimizer.json"] = 430,
    ["importmap.json"] = 433,
    instant_python_config = 435,
    instant_python_custom_project = 436,
    ["ioBroker Configuration"] = 437,
    ["ioBroker JSON UI"] = 438,
    ["ioBroker Package manifest"] = 439,
    ["ixpect.conf.yaml"] = 440,
    ["ize.toml"] = 1027,
    ["jsconfig.json"] = 465,
    ["jscpd Configuration"] = 1011,
    jsdoc = 925,
    ["k3d.yaml"] = 466,
    ["k9s aliases.yaml"] = 468,
    ["k9s cluster-config.yaml"] = 470,
    ["k9s config.yaml"] = 469,
    ["k9s hotkeys.yaml"] = 471,
    ["k9s plugins.yaml"] = 472,
    ["k9s skin.yaml"] = 473,
    ["k9s views.yaml"] = 474,
    ["kontinuous-config.yaml"] = 485,
    ["kontinuous-values.yaml"] = 484,
    ["kustomization.yaml"] = 487,
    ["label-commenter-config.yml"] = 488,
    ["latexindent configuration"] = 102,
    ["launchsettings.json"] = 489,
    lazydocker = 1049,
    lazygit = 1048,
    ["lego.json"] = 491,
    ["lerna.json"] = 492,
    ["lgtm.yml"] = 493,
    ["liblab.config.json"] = 494,
    ["libman.json"] = 495,
    ["license-report-config.json"] = 496,
    ["linkinator.config.json"] = 498,
    ["lint-staged (.lintstagedrc)"] = 903,
    ["local.settings.json"] = 503,
    ["localazy.json"] = 504,
    ["lotus.yaml"] = 502,
    ["lsdlschema.json"] = 505,
    ["macro.json"] = 1015,
    ["markdown-link-check"] = 969,
    maturin = 970,
    mboats = 977,
    ["micro-settings.json"] = 1042,
    ["mimetypes.json"] = 519,
    ["mirrord config"] = 905,
    mise = 906,
    ["mkdocs.yml"] = 539,
    ["monospace.yml"] = 542,
    ["moon.yml"] = 1124,
    ["mprocs Configuration file"] = 1095,
    ["mrdocs.yml"] = 540,
    ["mta.yaml"] = 907,
    ["mtad.yaml"] = 908,
    ["mycode.json"] = 549,
    nFPM = 556,
    ["napari plugin manifest"] = 550,
    neoload = 920,
    ["nest-cli"] = 559,
    ["ninjs (News in JSON)"] = 558,
    ["nitro.json"] = 919,
    ["nixd configuration"] = 1068,
    ["nlu.json"] = 560,
    ["nodemon.json"] = 562,
    ["noodl config"] = 976,
    ["notebook.mod.json"] = 563,
    now = 915,
    ["npm-badges"] = 566,
    ["nswag.json"] = 570,
    ntangle = 572,
    ["nuclei-template.yaml"] = 567,
    ["nuget-project.json"] = 568,
    ["ocelot.json"] = 574,
    ["omnisharp.json"] = 579,
    openHAB = 1200,
    ["openapi.json"] = 581,
    ...
    ["plagiarize.yaml"] = 623,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1131,
    ["podbard.yaml"] = 626,
    ["portman.json"] = 629,
    ["prefect.toml"] = 637,
    ["prefect.yaml"] = 638,
    ["prettierrc.json"] = 639,
    ["prisma.yml"] = 640,
    ["project-1.0.0-beta3.json"] = 652,
    ["project-1.0.0-beta4.json"] = 653,
    ["project-1.0.0-beta5.json"] = 654,
    ["project-1.0.0-beta6.json"] = 655,
    ["project-1.0.0-beta8.json"] = 656,
    ["project-1.0.0-rc1.json"] = 657,
    ["project-1.0.0-rc2.json"] = 658,
    ["project.json"] = 651,
    ["project.owasp.yaml"] = 659,
    ["prometheus-alertmanager.json"] = 663,
    ["prometheus.json"] = 660,
    ["prometheus.rules.json"] = 661,
    ["prometheus.rules.test.json"] = 662,
    ["proxies.json"] = 664,
    ["publiccode.yml"] = 665,
    ["pubspec.yaml"] = 666,
    ["pyrseas-0.8.json"] = 669,
    pytest = 678,
    ["quilt.mod.json"] = 1043,
    ["rc3 auth"] = 684,
    ["rc3 collection"] = 685,
    ...
    ["release drafter"] = 921,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 694,
    ["release-please-manifest.json"] = 695,
    ["release-plz.toml"] = 696,
    ["renv.lock"] = 707,
    ["rivet.json"] = 1067,
    ["rivet.yaml (legacy)"] = 1066,
    rumdl = 712,
    runny = 711,
    rustfmt = 713,
    sake = 1158,
    samt = 715,
    samtrc = 716,
    ["sarif-1.0.0.json"] = 718,
    ["sarif-2.0.0.json"] = 719,
    ["sarif-2.1.0"] = 729,
    ["sarif-2.1.0-rtm.2"] = 720,
    ["sarif-2.1.0-rtm.3"] = 722,
    ["sarif-2.1.0-rtm.4"] = 724,
    ["sarif-2.1.0-rtm.5"] = 726,
    ["sarif-2.1.0-rtm.6"] = 727,
    ["sarif-external-property-file-2.1.0"] = 730,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 721,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 723,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 725,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 728,
    ["scalingo.json configuration"] = 731,
    ["schema.org - Action"] = 733,
    ["schema.org - ContactPoint"] = 734,
    ["schema.org - Place"] = 735,
    ["schema.org - Thing"] = 736,
    ["secrethub.yml"] = 1045,
    ["semantic-release"] = 742,
    ["servicehub.config.json"] = 898,
    ["servicehub.service.json"] = 897,
    ["settings.job"] = 745,
    ["sfdx-hardis configuration"] = 747,
    ["shard.yml"] = 1083,
    ["size-limit configuration"] = 752,
    ["skaffold.yaml"] = 967,
    ["skyuxconfig.json"] = 754,
    ["snowflake-config"] = 756,
    ["snowflake-connections"] = 757,
    ["spicepod.yaml"] = 1103,
    ["sqlc configuration"] = 789,
    ["stripe-app-local.json"] = 800,
    ["stripe-app.json"] = 799,
    swcrc = 952,
    ["task.json"] = 809,
    taskcat = 916,
    ["template.json"] = 814,
    ["templatsources.json"] = 815,
    ["theme.json"] = 818,
    ["tizen_workspace.json"] = 820,
    tldr = 821,
    ["tm_devices configuration file"] = 1169,
    tmuxinator = 901,
    ["transcend.yml"] = 831,
    ["tree-sitter grammar.json"] = 400,
    ["trime.yaml"] = 832,
    ["trunk.yaml"] = 834,
    ["ts-force-config.json"] = 839,
    ["tsconfig.json"] = 835,
    ["tsd.json"] = 836,
    ["tsdoc.json"] = 837,
    ["tsdrc.json"] = 838,
    ...
    v8r = 880,
    vcluster = 1089,
    ["vcpkg configuration file"] = 232,
    ["vcpkg manifest file"] = 231,
    ["vega-lite.json"] = 862,
    ["vega.json"] = 861,
    ["venvironment.yaml"] = 864,
    ["venvplus.yaml"] = 865,
    version = 1151,
    ["version.json"] = 867,
    ["vhwdebugger-binding.yaml"] = 869,
    ["vim-addon-info"] = 870,
    ["vs-2017.3.host.json"] = 872,
    ["vs-nesting.json"] = 873,
    ["vsls.json"] = 871,
    ["vss-extension.json"] = 877,
    vtcfg = 1157,
    ["vtesttree.yaml"] = 878,
    ["vtestunit.yaml"] = 879,
    ["warp-keysets.json"] = 1051,
    ["warp-themes.json"] = 1052,
    ["warp-workflows.json"] = 1053,
    ["webhint.io"] = 1007,
    ["webjobpublishsettings.json"] = 884,
    ["webjobs-list.json"] = 883,
    ["well-known-fursona"] = 1090,
    ["xs-app.json"] = 911,
    ["xunit.runner.json"] = 896,
    yamllint = 939,
    zizmor = 1194,
    zuul = 922,
    ["Žinoma"] = 932
