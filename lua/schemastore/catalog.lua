...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 875,
    [".nodehawkrc"] = 534,
    [".npmpackagejsonlintrc"] = 538,
    [".omletrc"] = 1051,
    [".phrase.yml"] = 603,
    [".phraseapp.yml"] = 604,
    [".pmbot.yml"] = 591,
    [".postcssrc"] = 598,
    [".powerpages-web-template-manifest"] = 600,
    [".pre-commit-config.yml"] = 601,
    [".pre-commit-hooks.yml"] = 602,
    [".putout.json"] = 632,
    [".rehyperc"] = 656,
    [".remarkrc"] = 660,
    [".sprite files"] = 749,
    ...
    [".vsconfig"] = 839,
    [".vsext"] = 840,
    ["1Password SSH Agent Config"] = 6,
    ["@factorial/drupal-breakpoints-css"] = 11,
    ["A micro editor config"] = 484,
    ABCInventoryModuleData = 19,
    ABCSupplyPlan = 20,
    AIConfig = 21,
    ["AMX Muse Program Descriptor"] = 1096,
    ["API Builder"] = 910,
    ["AVA Configuration"] = 972,
    ["AWS AppConfig Feature Flags-v1"] = 52,
    ["AWS CDK cdk.json"] = 224,
    ["AWS CloudFormation"] = 225,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 226,
    ["AWS Copilot Manifest"] = 1135,
    ["AWS SAM CLI Samconfig"] = 227,
    ["Adobe UXP Manifest"] = 1034,
    ["Aerleon Network & Service Definitions"] = 14,
    ["Aerleon Policy"] = 15,
    Aider = 1125,
    Air = 17,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1146,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1145,
    ["Airlock Microgateway"] = 22,
    ["Alacritty Configuration"] = 944,
    ["All Contributors configuration file"] = 997,
    ["Ansible Argument Specs"] = 359,
    ["Ansible Collection Galaxy"] = 366,
    ["Ansible Execution Environment"] = 356,
    ["Ansible Inventory"] = 365,
    ["Ansible Meta"] = 357,
    ["Ansible Meta Runtime"] = 358,
    ["Ansible Navigator Configuration"] = 368,
    ["Ansible Playbook"] = 363,
    ["Ansible Requirements"] = 360,
    ["Ansible Rulebook"] = 364,
    ["Ansible Tasks File"] = 362,
    ["Ansible Vars File"] = 361,
    ["Ansible-lint Configuration"] = 367,
    Any = 1061,
    ["AnyWork Automation Configuration"] = 10,
    ["App config Spotify Backstage"] = 26,
    ["Application Accelerator"] = 7,
    ...
    AssemblyScript = 44,
    AsyncAPI = 47,
    ["AsyncAPI Tool File"] = 48,
    ["Atmos Manifests"] = 49,
    ["Aurora Agile Meta-Framework"] = 50,
    AutoAPICase = 1007,
    ["Avro Avsc"] = 51,
    ["Azure Container App template for defining an immutable revision"] = 53,
    ["Azure DevOps extension manifest"] = 56,
    ["Azure Device Update for IoT Hub import manifest"] = 54,
    ["Azure Device Update for IoT Hub update manifest"] = 55,
    ["Azure IoT Edge deployment"] = 59,
    ["Azure IoT Edge deployment template"] = 60,
    ["Azure IoT EdgeAgent deployment"] = 57,
    ["Azure IoT EdgeHub deployment"] = 58,
    ["Azure IoT Operations Wasm Graph Config"] = 1144,
    ["Azure IoT Operations connector metadata"] = 1141,
    ["Azure Landing Zones Library archetype definition"] = 64,
    ["Azure Landing Zones Library archetype override"] = 65,
    ["Azure Landing Zones Library architecture definition"] = 63,
    ["Azure Landing Zones Library metadata"] = 61,
    ["Azure Landing Zones Library policy default values"] = 62,
    ["Azure Pipelines"] = 82,
    ["Azure Static Web Apps CLI configuration file"] = 753,
    ["Azure Static Web Apps configuration file"] = 752,
    ["BOSH CPI Config"] = 106,
    ["BOSH Deploy Config"] = 107,
    ["BX CI"] = 126,
    ["Bacon config"] = 1,
    ...
    ["Better Scripts"] = 127,
    Bigconfig = 99,
    ["Biome Formatter Config"] = 66,
    ["Bitmovin Encoding Template"] = 1089,
    BizTalkServerApplicationSchema = 882,
    Bleep = 128,
    ["Block Protocol Metadata"] = 125,
    ["Boyka Framework"] = 108,
    Briefcase = 888,
    ["Build Info"] = 116,
    Buildkite = 118,
    ["Bukkit plugin.yml"] = 117,
    ["BungeeCord plugin.yml"] = 123,
    ["Butane Config"] = 957,
    C4InterFlow = 1104,
    ["CDK Environment Manager, concrete environment configuration"] = 1128,
    ["CDK Environment Manager, concrete environments definition"] = 1127,
    ["CDK Environment Manager, environment definition"] = 1126,
    ...
    ["CSS Comb (.csscomb.json)"] = 252,
    ["CSS Lint (.csslintrc)"] = 253,
    ["CSpell (cspell.json)"] = 251,
    ["CVE Record Format"] = 158,
    CWL = 1045,
    ["Cache Warmup config"] = 130,
    ["Calqulus pipeline"] = 131,
    ["Camel YAML DSL"] = 132,
    ["Cannon TOML"] = 133,
    Carafe = 134,
    ["Cargo Make"] = 136,
    ["Cargo Manifest"] = 135,
    ["Catalog Info Backstage"] = 137,
    ["Chamaleon environment"] = 1093,
    ["Chamaleon properties"] = 1094,
    ["Chamaleon template"] = 1092,
    Changesets = 236,
    Changie = 138,
    Charmcraft = 139,
    Cheatsheets = 954,
    ["ChordPro Configuration"] = 140,
    ["Chrome Extension"] = 217,
    ["Chromia Model"] = 141,
    ["Chromia Seeder Module Config"] = 143,
    ["Chromia Seeder Root Config"] = 142,
    ["Cinnamon Spice info.json"] = 73,
    ["CircleCI config.yml"] = 193,
    ["Citation File Format"] = 238,
    CityJSON = 145,
    ["Claude Code Settings"] = 157,
    ["Clawject config"] = 156,
    ["Cloud Foundry Application Manifest"] = 1050,
    ["Cloud Run Spec v1"] = 1073,
    ["CloudCannon Configuration"] = 77,
    ["CloudEvents specification"] = 146,
    ["Code Climate"] = 194,
    CodeCV = 75,
    CodeRabbit = 74,
    ["CodeShip Pro services configuration files"] = 206,
    ["CodeShip Pro steps configuration files"] = 207,
    ["Codecov configuration files"] = 205,
    CodifyCLI = 76,
    Codux = 203,
    ["Cog config file"] = 151,
    ["Commandbox Box.json"] = 152,
    ["Commandbox Server.json"] = 153,
    ["Common Catalog Data"] = 215,
    ["Common Package Specification"] = 154,
    Concord = 1067,
    ...
    Containerlab = 923,
    ["Contextive Glossary"] = 1120,
    Convex = 148,
    ["Crowdsec collection config"] = 246,
    ["Crowdsec parser config"] = 247,
    ["Crowdsec scenario config"] = 248,
    ["CumulusCI Config"] = 155,
    ["Custom Machinery Machine"] = 1040,
    ["Custom Machinery Recipe"] = 1041,
    ["Cycle Stack File"] = 159,
    CycloneDX = 160,
    ["DWP Exchange - catalogue entry"] = 295,
    ["DWP Exchange - gateway"] = 293,
    ["DWP Exchange - meta"] = 294,
    ["Dart Build Config (dart-build.json)"] = 254,
    ["Dart Test Config (dart-test.json)"] = 255,
    ["DashLord Configuration"] = 256,
    ["Data Contract Specification"] = 257,
    ["Data Product Specification"] = 258,
    ["DataYoga Connections"] = 161,
    ["DataYoga Job"] = 162,
    ["Databricks Asset Bundles"] = 1018,
    ["Datadog Continuous Testing"] = 455,
    ["Datadog Service Definition"] = 456,
    ["Datadog Software Catalog"] = 457,
    ["Datahub Ingestion Recipe"] = 973,
    ["Debian Upstream Metadata file"] = 168,
    ["Deck config"] = 169,
    ["Dein Config"] = 170,
    ["Deno Config (deno.json)"] = 264,
    ["Dependency cruiser"] = 171,
    ["DeployStack Configuration"] = 172,
    ["Deployah Configuration"] = 1143,
    ["Deployer Recipe"] = 267,
    ["Deta Spacefile"] = 173,
    ["Detekt Config (detekt.yml)"] = 268,
    ["Devbox Config"] = 174,
    ["Devbox Plugin"] = 175,
    Devfile = 292,
    DipDup = 1070,
    ["Discord Webhook"] = 269,
    ["DocFx Config (docfx.json)"] = 273,
    Dofigen = 274,
    ["Dolittle Artifacts"] = 275,
    ["Dolittle Bounded Context Configuration"] = 276,
    ["Dolittle Event Horizons Configuration"] = 277,
    ["Dolittle Resources Configuration"] = 278,
    ["Dolittle Server Configuration"] = 279,
    ["Dolittle Tenant Map Configuration"] = 281,
    ["Dolittle Tenants Configuration"] = 280,
    ["Dolittle Topology"] = 282,
    ["DonateCaseBetterCasino menu"] = 1097,
    ["Drupal Breakpoints"] = 176,
    ["Drupal Config"] = 188,
    ["Drupal Info"] = 177,
    ["Drupal Layouts"] = 178,
    ["Drupal Libraries"] = 179,
    ["Drupal Links Action"] = 180,
    ["Drupal Links Contextual"] = 181,
    ["Drupal Links Menu"] = 182,
    ["Drupal Links Task"] = 183,
    ["Drupal Migration"] = 184,
    ["Drupal Permissions"] = 185,
    ["Drupal Recipe"] = 186,
    ["Drupal Routing"] = 187,
    ["Drupal Services"] = 189,
    ["Drush site aliases"] = 288,
    ["Dynamic Bash Aliases (.aliases)"] = 1009,
    ["EAS config"] = 312,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 998,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1140,
    ["EasyVCR .NET"] = 313,
    ["Eidolon Resource"] = 1084,
    ["Elgato Stream Deck"] = 298,
    Elm = 1072,
    ["Embrace Config"] = 984,
    Endurica = 1022,
    ["Enterprise Contract Policy Spec"] = 299,
    ["Erda Pipeline"] = 1047,
    ["Erda Runtime"] = 1048,
    Esquio = 301,
    ["Estuary Flow Catalog"] = 963,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 305,
    ["EveryVoice TTS Toolkit Data Configuration"] = 306,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 310,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 309,
    ["EveryVoice TTS Toolkit Text Configuration"] = 307,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 308,
    ["Evolving Resolutive Process notation"] = 1142,
    ["Expo SDK"] = 311,
    ["F-Droid Data metadata"] = 317,
    ["FasterCI Configuration"] = 83,
    FiQuS = 321,
    Firebase = 319,
    ["FlexGet Config"] = 322,
    ["Flow.json Configurations"] = 1044,
    ["Fossa configuration file"] = 329,
    ["Fossa's fossa-deps file"] = 330,
    ["Foundry VTT - Base package Manifest"] = 324,
    ["Foundry VTT - Module Manifest"] = 325,
    ["Foundry VTT - System Data Template"] = 328,
    ["Foundry VTT - System Manifest"] = 326,
    ["Foundry VTT - World Manifest"] = 327,
    ["Foxx Manifest"] = 84,
    ["Freifunk.de Community API"] = 87,
    ["Frogbot Config"] = 88,
    ["G2P Mapping Configuration"] = 336,
    ["GCP Blueprint Metadata"] = 339,
    Gaspar = 337,
    ["GatewayCore API Gateway"] = 338,
    ["Gemini CLI settings"] = 340,
    ["GeoJSON.json latest"] = 961,
    GherKing = 965,
    ["GitHub Action"] = 345,
    ["GitHub Actions typing"] = 1080,
    ["GitHub Discussion"] = 346,
    ["GitHub Funding"] = 347,
    ["GitHub Issue Template configuration"] = 348,
    ["GitHub Issue Template forms"] = 349,
    ["GitHub Workflow"] = 350,
    ["GitHub Workflow Template Properties"] = 351,
    ["GitHub automatically generated release notes configuration"] = 352,
    ["GitLab Agent for Kubernetes configuration"] = 1036,
    GitVersion = 342,
    ["Gitea Issue Template configuration"] = 343,
    ["Gitea Issue Template forms"] = 344,
    ["Gitpod Automations"] = 354,
    ["Gitpod Configuration"] = 355,
    ["GlazeWM settings"] = 1038,
    ["Global Privacy Control"] = 341,
    Goblet = 1017,
    ["Golangci-lint Configuration"] = 370,
    ["Golangci-lint Custom Plugins Configuration"] = 371,
    ["Google Chrome Related Website Sets"] = 320,
    ["Google Cloud Workflows"] = 223,
    ["Google Digital Assetlinks"] = 1121,
    Goreleaser = 373,
    ["Goreleaser Pro"] = 374,
    Goss = 375,
    ["Gradle Build Cache Node"] = 912,
    ["Gradle Enterprise"] = 911,
    ["Grafana 5.x Dashboard"] = 376,
    ["GraphQL Code Generator"] = 381,
    ["GraphQL Config"] = 380,
    ["GraphQL Mesh"] = 379,
    ["Grunt JSHint task"] = 385,
    ["Grunt Watch task"] = 386,
    ["Grunt base task"] = 387,
    ["Grunt clean task"] = 383,
    ["Grunt copy task"] = 382,
    ["Grunt cssmin task"] = 384,
    HEMTT = 878,
    Hadolint = 892,
    Hammerkit = 922,
    ...
    Hayagriva = 390,
    Hayson = 391,
    ["Haystack Pipeline"] = 392,
    ["Hazelcast 5 Configuration"] = 393,
    ["Hecate Input Schema"] = 1132,
    ["Helm Chart.lock"] = 191,
    ["Helm Chart.yaml"] = 190,
    ["Helm Unittest Test Suite"] = 192,
    ["Home Assistant Integration Manifest"] = 394,
    ["Homer dashboard configuration"] = 395,
    Hugo = 953,
    ["Hugo Theme"] = 952,
    ["Hulak Configuration"] = 402,
    ["Hyperfoil benchmark configuration"] = 401,
    ["IBM Zapp document"] = 403,
    ["IBM zCodeFormatSettings"] = 404,
    ["IMG Catapult PSP"] = 409,
    ["IVMS101 by CODE Protocol"] = 1037,
    Infrahub = 411,
    Istanbul = 980,
    ["JDownloader2 crawler multi-rules"] = 422,
    ["JDownloader2 crawler single-rules"] = 421,
    ["JFrog Applications Config"] = 423,
    ["JFrog File Spec"] = 424,
    ["JFrog Pipelines YML DSL"] = 986,
    ["JMeter DSL cli config"] = 425,
    JReleaser = 428,
    ["JSON Document Transform"] = 436,
    ["JSON Feed"] = 437,
    ["JSON Resume"] = 666,
    ...
    ["JSON-stat 2.0"] = 853,
    JSONPatch = 439,
    ["JSR Package Config (jsr.json)"] = 429,
    Jasmine = 416,
    Jekyll = 417,
    ["Jenkins X Pipelines"] = 418,
    ["Jenkins X Requirements"] = 419,
    Jest = 420,
    Jocker = 426,
    ["Jovo Language Models"] = 427,
    ["Jujutsu (jj) VCS config"] = 1134,
    ["KIMMDY config file"] = 450,
    ...
    KSY = 1049,
    KSail = 334,
    ["Karakum configuration file"] = 331,
    Kas = 442,
    ["Kestra flow file"] = 451,
    ["Keycloak REST API"] = 989,
    ["Knative Functions - func.yaml"] = 332,
    Knip = 333,
    ["Kometa (nightly) config file"] = 453,
    ["Kometa config file"] = 452,
    ["Kong DBLess config"] = 983,
    KrakenD = 454,
    ["Kubri Configuration"] = 461,
    LOOBin = 476,
    ["Lake configuration file"] = 1137,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 228,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 229,
    ["Landing Zone Accelerator on AWS - Global Config"] = 230,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 231,
    ["Landing Zone Accelerator on AWS - Network Config"] = 232,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 233,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 234,
    ["Landing Zone Accelerator on AWS - Security Config"] = 235,
    ["Lando (landofile)"] = 78,
    ["LangGraph Platform configuration"] = 1060,
    ["Language configuration"] = 1059,
    Lefthook = 465,
    ["Liferay client-extension.yaml"] = 472,
    ["LinkML Metamodel"] = 474,
    Liquibase = 928,
    ["Liquibase Flow File"] = 929,
    ["Lively Properties"] = 475,
    ["Lobe AI Agent"] = 80,
    Loki = 81,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 516,
    ["MS2Rescore Configuration"] = 519,
    ["Madness (madness.yml)"] = 1000,
    ["Mado configuration"] = 482,
    ["MapEHR Mapping"] = 483,
    Markdownlint = 932,
    ["Mason Registry"] = 935,
    ["MegaLinter Custom Flavor"] = 486,
    ["MegaLinter configuration"] = 485,
    ["MegaLinter descriptor"] = 487,
    Melange = 1027,
    ["Meltano project definition"] = 488,
    ["Mergify Configuration"] = 520,
    ["Metadata for a Bazel module"] = 489,
    ["Metadata for a Cinnamon spice"] = 1076,
    ["Metatype Configuration"] = 490,
    ["MetricsHub Configuration"] = 491,
    ["MetricsHub Connector Configuration"] = 492,
    ["Micro Editor Syntax"] = 1010,
    ["Microsoft Band Web Tile"] = 493,
    ...
    ["Minecraft Data Pack Advancement"] = 495,
    ["Minecraft Data Pack Biome"] = 496,
    ["Minecraft Data Pack Configured Carver"] = 497,
    ["Minecraft Data Pack Damage Type"] = 498,
    ["Minecraft Data Pack Dimension"] = 500,
    ["Minecraft Data Pack Dimension Type"] = 499,
    ["Minecraft Data Pack Item Modifier"] = 501,
    ["Minecraft Data Pack Loot Table"] = 502,
    ["Minecraft Data Pack Metadata"] = 503,
    ["Minecraft Data Pack Predicate"] = 504,
    ["Minecraft Data Pack Recipe"] = 505,
    ["Minecraft Data Pack Tag"] = 506,
    ["Minecraft Data Pack Template Pool"] = 507,
    ["Minecraft Data Pack Trim Material"] = 512,
    ["Minecraft Data Pack Trim Pattern"] = 513,
    ["Minecraft Resource Pack Lang"] = 508,
    ["Minecraft Resource Pack Particle"] = 509,
    ["Minecraft Resource Pack Texture Mcmeta"] = 511,
    ["Minecraft Resourcepack Sounds"] = 510,
    ["Monade CLI Stack Configuration"] = 523,
    ["MongoDB Atlas Search Index Definition"] = 981,
    ["Monika Configuration"] = 979,
    ["Monoweave Configuration"] = 518,
    ["Motif config"] = 874,
    MultiQC = 1114,
    ["NOX Framework (Service)"] = 537,
    ["Netin Diagnostic System Template"] = 939,
    ["Netlify config"] = 526,
    ["Network-as-Code Data Model"] = 527,
    ["Next Gen UI Agent Configuration"] = 528,
    ["Nightwatch.js"] = 530,
    ["Node.js configuration"] = 879,
    ["NueJS configuration file"] = 542,
    ["Nuitka.yaml"] = 1042,
    ["Nullstone config"] = 544,
    ["ONe's changelog entry"] = 559,
    ["ONe's service descriptor"] = 558,
    ["ORT Server repository environment configuration"] = 567,
    ["OSCAL Assessment Plan (AP)"] = 569,
    ["OSCAL Assessment Results (AR)"] = 570,
    ["OSCAL Catalog"] = 571,
    ["OSCAL Component Definition (CDef)"] = 572,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 573,
    ["OSCAL Profile"] = 574,
    ["OSCAL System Security Plan (SSP)"] = 575,
    ["OSS Review Toolkit configuration"] = 576,
    ["OSS Review Toolkit curation"] = 577,
    ["OSS Review Toolkit package configuration"] = 578,
    ["OSS Review Toolkit repository configuration"] = 579,
    ["OSS Review Toolkit resolutions"] = 580,
    ["October CMS columns"] = 548,
    ["October CMS fields"] = 549,
    Okteto = 550,
    ["Ona Automations"] = 552,
    Opctl = 877,
    ["Open Data Contract Standard (ODCS)"] = 562,
    ["Open Data Product Standard (ODPS)"] = 563,
    ["Open Know-How"] = 1119,
    ["OpenRewrite Resource"] = 561,
    OpenStatus = 1130,
    ["OpenUtau character yaml"] = 555,
    ["OpenUtau ustx"] = 556,
    ["OpenWeather Current Weather API"] = 918,
    ["OpenWeather Road Risk API"] = 917,
    ["Ory Hydra configuration"] = 400,
    ["Ory Keto configuration"] = 458,
    ["Ory Kratos configuration"] = 568,
    ["Ory Oathkeeper configuration"] = 546,
    ["Outblocks App configuration"] = 565,
    ["Outblocks database table"] = 566,
    ["Outblocks project configuration"] = 564,
    PDM = 587,
    Packer = 584,
    Pantsbuild = 996,
    ["Paper paper-plugin.yml"] = 585,
    ["Pipeline component"] = 930,
    ["Platform.sh application"] = 3,
    ["Platform.sh routes"] = 4,
    ["Platform.sh services"] = 5,
    ["Plex Prerolls"] = 595,
    ["PocketMine plugin.yml"] = 592,
    ["Postman collection"] = 599,
    ["Power Pages Configuration"] = 1131,
    ["Preset list for a WinUtil"] = 1079,
    ["ProActions AI-Kit Configuration"] = 608,
    ["ProActions AI-Kit Configuration for Menus"] = 610,
    ["ProActions AI-Kit Configuration for Sections"] = 612,
    ["ProActions AI-Kit Configuration for Services"] = 609,
    ["ProActions AI-Kit Configuration for Steps"] = 613,
    ["ProActions AI-Kit Configuration for Templates"] = 611,
    ["Problem object RFC9457"] = 1025,
    ["Problem package generators"] = 614,
    Pterodactyl = 976,
    ["Pull Request Labeler"] = 631,
    Pulumi = 639,
    ["PyGTA Config"] = 635,
    PyProject = 640,
    Pylock = 1122,
    Pyright = 641,
    ["Python script metadata"] = 1116,
    ["QType AI DSL"] = 644,
    Qgoda = 643,
    Qodana = 949,
    ...
    Ray = 891,
    ["Read the Docs"] = 638,
    ["Red-DiscordBot Cog"] = 653,
    ["Red-DiscordBot Cog Repo"] = 654,
    ["Red-DiscordBot Trivia"] = 655,
    ["Render Blueprints"] = 925,
    RenderCV = 668,
    Renovate = 667,
    ["Replit config"] = 661,
    Restate = 1109,
    ["Revel Digital Gadget Definition File"] = 1133,
    RoadRunner = 670,
    ["Robust Station Image"] = 1139,
    Rockcraft = 671,
    ["Roo Coder Custom Modes"] = 672,
    Rubocop = 663,
    ["Rudder techniques"] = 1032,
    Ruff = 664,
    ["Rust Project"] = 665,
    ["Rust toolchain"] = 676,
    ["SDMX data message"] = 702,
    ["SDMX metadata message"] = 701,
    ["SDMX structure message"] = 700,
    ["SIL Kit Participant Configuration"] = 712,
    ["SIL Kit Registry Configuration"] = 713,
    ["SPDX 2.3"] = 750,
    SWADL = 766,
    ["Safebox Config"] = 987,
    ["Sapphire CLI Config"] = 679,
    ["SauceCTL Configuration"] = 936,
    ["Schema Catalog"] = 694,
    ["Scoop manifest"] = 699,
    ["Semantic Data Fabric (SDF) file"] = 703,
    ["Semgrep Rule"] = 705,
    ["Serenity Code Generator (Sergen)"] = 706,
    ...
    ["Sigma Detection Rule"] = 710,
    ["Sigrid scope configuration file"] = 711,
    ["SkyPilot Task JSON"] = 1033,
    ["Slack app manifest"] = 715,
    Snapcraft = 717,
    Solidarity = 720,
    ["Solution filters"] = 721,
    ["Source Maps v3"] = 722,
    Sourcery = 723,
    ["Spack bootstrap.yaml"] = 724,
    ["Spack cdash.yaml"] = 725,
    ["Spack ci.yaml"] = 726,
    ["Spack compilers.yaml"] = 727,
    ["Spack concretizer.yaml"] = 728,
    ["Spack config.yaml"] = 729,
    ["Spack definitions.yaml"] = 730,
    ["Spack develop.yaml"] = 731,
    ["Spack env_vars.yaml"] = 732,
    ["Spack environment"] = 738,
    ["Spack include.yaml"] = 733,
    ["Spack mirrors.yaml"] = 734,
    ["Spack modules.yaml"] = 735,
    ["Spack packages.yaml"] = 736,
    ["Spack repos.yaml"] = 737,
    ["Spack toolchains.yaml"] = 739,
    ["Spack upstreams.yaml"] = 740,
    ["Spack view.yaml"] = 741,
    ["Speakeasy Generation Config File"] = 745,
    ["Speakeasy Lint Configuration File"] = 742,
    ["Speakeasy Test Generation Configuration File"] = 743,
    ["Speakeasy Workflow File"] = 744,
    SpecIF = 746,
    ["Specmatic Configuration"] = 747,
    ["Sponge Mixin configuration"] = 748,
    StackBlitz = 754,
    ...
    Starship = 757,
    ["Statamic Blueprint"] = 758,
    ["Stella configuration file"] = 759,
    ["Streamlit configuration file"] = 760,
    ["Stryker Mutator"] = 763,
    ["StyleCop Analyzers Configuration"] = 764,
    ["Stylelint (.stylelintrc)"] = 765,
    ["Stylua Config"] = 1123,
    ["Sublime Syntax"] = 988,
    ["Subsquid squid manifest"] = 1035,
    ["Swagger API 2.0"] = 767,
    ["Synadia Connect Component"] = 768,
    TSON = 803,
    TSTyche = 804,
    ["TYPO3 Vendor Bundler config"] = 809,
    ["Tab data for a LinUtil"] = 1082,
    ["Tab list for a LinUtil"] = 1081,
    Tach = 769,
    ["Tach Domain"] = 770,
    Talhelper = 772,
    ["Talisman configuration"] = 773,
    Taplo = 1124,
    ["Taskfile config"] = 920,
    Taurus = 774,
    Tauticord = 775,
    Telefonistka = 1110,
    ["Terrateam config"] = 1136,
    ["TestEnvironment.json"] = 786,
    ["TextMate Grammar"] = 785,
    Threagile = 781,
    ["Tier.run pricing.json"] = 778,
    Tikibase = 779,
    Tombi = 784,
    ["Traefik v2"] = 789,
    ["Traefik v2 File Provider"] = 790,
    ["Traefik v3"] = 791,
    ["Traefik v3 File Provider"] = 792,
    ["Travis CI (.travis.yml)"] = 788,
    Treefmt = 378,
    Trident = 1106,
    ["TrueScript for *.tscript files"] = 795,
    ["Tugboat QA config.yml"] = 1103,
    TunnelHub = 1023,
    Turborepo = 787,
    Tycho = 1071,
    Tye = 950,
    ["Tyk Gateway - Open Source v5.7+"] = 1115,
    ["Typst Manifest"] = 810,
    ["UET BuildConfig.json"] = 993,
    ["UI5 Manifest"] = 816,
    ["UNCORS configuration"] = 820,
    ["UTAM Page Object"] = 819,
    ["Ubuntu Server Autoinstall"] = 814,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1107,
    ["Uniswap Token List"] = 903,
    ["Universal Schedule Format"] = 821,
    ["Unreal Engine Uplugin"] = 994,
    ["Unreal Engine Uproject"] = 995,
    ["UpCloud CLI (upctl) configuration"] = 1108,
    ...
    V2Ray = 964,
    ["VSCode Code Snippets"] = 211,
    ["VSIX CLI publishing"] = 841,
    Vector = 823,
    ["Vela Pipeline Configuration"] = 826,
    Vercel = 210,
    ["Version Bumper config"] = 831,
    ["Viash Component Config"] = 1112,
    ["Viash Package Config"] = 1113,
    Visivo = 1021,
    ["WP-CLI"] = 851,
    Wake = 1105,
    ["Waku Config"] = 1085,
    ...
    ["YouTrack App"] = 1074,
    ["Zarf Package Configuration"] = 1138,
    ["Zerops.io config"] = 1062,
    ["Zerops.io import"] = 1063,
    ["aerleon.yml"] = 13,
    ["angular.json"] = 23,
    apko = 1026,
    ["app-definition.yaml"] = 27,
    ["apple-app-site-association"] = 25,
    ["appsettings.StormPetrel.json"] = 32,
    ["appsettings.json"] = 30,
    ["appsscript.json"] = 29,
    ["appveyor.yml"] = 31,
    ["aqua-generate-registry.yaml"] = 34,
    ["aqua-policy.yaml"] = 35,
    ["aqua.yaml"] = 33,
    ["arb.json"] = 37,
    ["arc.json"] = 39,
    ...
    ["asm-lsp"] = 43,
    ["ast-grep rules"] = 46,
    ["ast-grep sgconfig.yml"] = 45,
    ["babelrc.json"] = 90,
    ["bamboo-spec"] = 93,
    ["bashly-strings.yml"] = 1003,
    ["batect.yml"] = 92,
    ["beef-database-codegen"] = 94,
    ["beef-database-v5-codegen"] = 96,
    ["beef-entity-codegen"] = 95,
    ["beef-entity-v5-codegen"] = 97,
    ["behat.yml"] = 109,
    ["bigquery-table"] = 98,
    ["bioimageio resource description"] = 1043,
    ["bitbucket-pipelines"] = 100,
    bitrise = 101,
    ["bitrise-step"] = 102,
    ["block.json"] = 124,
    ["bottom configuration"] = 67,
    ["bower.json"] = 104,
    ["bozr.suite.json"] = 111,
    bpkg = 1004,
    ["browser.i18n.json"] = 112,
    ["browsh configuration"] = 113,
    bucklescript = 114,
    ["buf.gen.yaml"] = 69,
    ["buf.plugin.yaml"] = 70,
    ["buf.work.yaml"] = 71,
    ...
    ["build-changelog"] = 115,
    ["bun.lock"] = 120,
    ["bundleconfig.json"] = 121,
    ["bunfig.toml"] = 122,
    ["cargo-mutants-config.yaml"] = 72,
    ["ccmod.json"] = 1086,
    changelogging = 1054,
    ["chisel-slices.json"] = 237,
    ["chrome-extension-locales-messages.json"] = 218,
    ["chutzpah.json"] = 219,
    cibuildwheel = 144,
    ...
    clangd = 197,
    clib = 199,
    ["cloud-init: cloud-config userdata"] = 201,
    ["cloud-sdk-pipeline-configuration"] = 221,
    ["cloudbuild.json"] = 222,
    cloudify = 200,
    codemagic = 202,
    ["coffeelint.json"] = 239,
    ...
    ["committed.toml"] = 240,
    ["compile_commands.json"] = 213,
    ["compilerconfig.json"] = 212,
    ["completely.yml"] = 999,
    ["component-detection-manifest.json"] = 243,
    ["component.json"] = 242,
    ["composer.json"] = 241,
    ["conda-forge"] = 147,
    ["config.yaml"] = 637,
    ["contentmanifest.json"] = 220,
    ["contribute.json"] = 244,
    ["cosmos.config.json"] = 216,
    ["crowdin.yml"] = 245,
    ["ctfd-setup configuration file"] = 1095,
    ["custom-elements.json"] = 1013,
    ["cypress.json"] = 249,
    ["datalogic-scan2deploy-android"] = 259,
    ["datalogic-scan2deploy-ce"] = 260,
    ["dbt Dependencies"] = 163,
    ["dbt Packages"] = 165,
    ["dbt Project"] = 164,
    ["dbt Selectors"] = 166,
    ["dbt YAML files"] = 167,
    ["ddev-global"] = 261,
    ["ddev-project"] = 262,
    ["debugsettings.json"] = 263,
    ["dependabot-v2.json"] = 266,
    ["dependabot.json"] = 265,
    ["deployed-cli"] = 955,
    ["devcontainer.json"] = 204,
    devinit = 907,
    ["devspace.yaml"] = 978,
    djlint = 908,
    ["docker bake"] = 271,
    ["docker sequencer"] = 272,
    ["docker-compose.yml"] = 906,
    ["dockerd.json"] = 270,
    ["dotnet Release Index manifest"] = 283,
    ["dotnet-tools.json"] = 284,
    ["dotnetcli.host.json"] = 285,
    ["dprint.json"] = 286,
    ["drone.json"] = 287,
    ["dss-2.0.0.json"] = 289,
    ["dstack configuration"] = 290,
    ["dtool dataset metadata"] = 1090,
    ["dvc.yaml"] = 291,
    ["ecosystem.json"] = 296,
    eksctl = 297,
    ["electron-builder configuration file"] = 303,
    ["epr-manifest.json"] = 302,
    ["evcc.yaml"] = 304,
    ["ezd task runner"] = 314,
    ["fabric.mod.json"] = 316,
    ["first-timers-bot"] = 323,
    ["flagd flag configuration"] = 85,
    ["fly.io Configuration"] = 86,
    fulibWorkflows = 937,
    ["function.json"] = 335,
    ["gRPC API Gateway & OpenAPI Config"] = 8,
    ["gematik health care insurance list"] = 1101,
    ["gematik health care patient list"] = 1098,
    ["gematik health care provider institution list"] = 1100,
    ["gematik health care provider list"] = 1099,
    ["gematik tiger test environment configuration"] = 1102,
    ["gitlab-ci"] = 353,
    ["global.json"] = 369,
    ["go-feature-flag Flag Configuration"] = 372,
    ["haxelib.json"] = 389,
    helmfile = 894,
    helmwave = 895,
    ["host-meta.json"] = 397,
    ...
    ["ide.host.json"] = 405,
    ["ifstate.yaml"] = 406,
    ["imageoptimizer.json"] = 407,
    ["importmap.json"] = 410,
    ["ioBroker Configuration"] = 412,
    ["ioBroker JSON UI"] = 413,
    ["ioBroker Package manifest"] = 414,
    ["ixpect.conf.yaml"] = 415,
    ["ize.toml"] = 990,
    ["jsconfig.json"] = 440,
    ["jscpd Configuration"] = 975,
    jsdoc = 890,
    ["k3d.yaml"] = 441,
    ["k9s aliases.yaml"] = 443,
    ["k9s cluster-config.yaml"] = 445,
    ["k9s config.yaml"] = 444,
    ["k9s hotkeys.yaml"] = 446,
    ["k9s plugins.yaml"] = 447,
    ["k9s skin.yaml"] = 448,
    ["k9s views.yaml"] = 449,
    ["kontinuous-config.yaml"] = 460,
    ["kontinuous-values.yaml"] = 459,
    ["kustomization.yaml"] = 462,
    ["label-commenter-config.yml"] = 463,
    ["latexindent configuration"] = 79,
    ["launchsettings.json"] = 464,
    lazydocker = 1012,
    lazygit = 1011,
    ["lego.json"] = 466,
    ["lerna.json"] = 467,
    ["lgtm.yml"] = 468,
    ["liblab.config.json"] = 469,
    ["libman.json"] = 470,
    ["license-report-config.json"] = 471,
    ["linkinator.config.json"] = 473,
    ["lint-staged (.lintstagedrc)"] = 868,
    ["local.settings.json"] = 478,
    ["localazy.json"] = 479,
    ["lotus.yaml"] = 477,
    ["lsdlschema.json"] = 480,
    ...
    ["mycode.json"] = 524,
    nFPM = 529,
    ["napari plugin manifest"] = 525,
    neoload = 885,
    ["nest-cli"] = 532,
    ["ninjs (News in JSON)"] = 531,
    ["nitro.json"] = 884,
    ["nixd configuration"] = 1031,
    ["nlu.json"] = 533,
    ["nodemon.json"] = 535,
    ["noodl config"] = 940,
    ["notebook.mod.json"] = 536,
    now = 880,
    ["npm-badges"] = 539,
    ["nswag.json"] = 543,
    ntangle = 545,
    ["nuclei-template.yaml"] = 540,
    ["nuget-project.json"] = 541,
    ["ocelot.json"] = 547,
    ["omnisharp.json"] = 551,
    ["openapi.json"] = 553,
    ["openfin.json"] = 560,
    ...
    ["ops.yaml"] = 557,
    ["package.json"] = 581,
    ["package.manifest"] = 583,
    ["package.yaml"] = 582,
    ["partial-black.json"] = 110,
    ["pathfinder.yml"] = 586,
    ["pattern.json"] = 589,
    ["petstore-v1.0"] = 985,
    pgap_yaml_input_reader = 588,
    ["pixi.toml"] = 590,
    ["plagiarize-me.yaml"] = 594,
    ["plagiarize.yaml"] = 593,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1091,
    ["podbard.yaml"] = 596,
    ["portman.json"] = 597,
    ["prefect.toml"] = 605,
    ["prettierrc.json"] = 606,
    ["prisma.yml"] = 607,
    ["project-1.0.0-beta3.json"] = 616,
    ["project-1.0.0-beta4.json"] = 617,
    ["project-1.0.0-beta5.json"] = 618,
    ["project-1.0.0-beta6.json"] = 619,
    ["project-1.0.0-beta8.json"] = 620,
    ["project-1.0.0-rc1.json"] = 621,
    ["project-1.0.0-rc2.json"] = 622,
    ["project.json"] = 615,
    ["project.owasp.yaml"] = 623,
    ["prometheus-alertmanager.json"] = 627,
    ["prometheus.json"] = 624,
    ["prometheus.rules.json"] = 625,
    ["prometheus.rules.test.json"] = 626,
    ["proxies.json"] = 628,
    ["publiccode.yml"] = 629,
    ["pubspec.yaml"] = 630,
    ["pyrseas-0.8.json"] = 633,
    pytest = 642,
    ["quilt.mod.json"] = 1006,
    ["rc3 auth"] = 647,
    ["rc3 collection"] = 648,
    ...
    ["registry.yaml"] = 36,
    ["release drafter"] = 886,
    ["release-please-config.json"] = 657,
    ["release-please-manifest.json"] = 658,
    ["release-plz.toml"] = 659,
    ["renv.lock"] = 669,
    ["rivet.json"] = 1030,
    ...
    samt = 677,
    samtrc = 678,
    ["sarif-1.0.0.json"] = 680,
    ["sarif-2.0.0.json"] = 681,
    ["sarif-2.1.0"] = 691,
    ["sarif-2.1.0-rtm.2"] = 682,
    ["sarif-2.1.0-rtm.3"] = 684,
    ["sarif-2.1.0-rtm.4"] = 686,
    ["sarif-2.1.0-rtm.5"] = 688,
    ["sarif-2.1.0-rtm.6"] = 689,
    ["sarif-external-property-file-2.1.0"] = 692,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 683,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 685,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 687,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 690,
    ["scalingo.json configuration"] = 693,
    ["schema.org - Action"] = 695,
    ["schema.org - ContactPoint"] = 696,
    ["schema.org - Place"] = 697,
    ["schema.org - Thing"] = 698,
    ["secrethub.yml"] = 1008,
    ["semantic-release"] = 704,
    ["servicehub.config.json"] = 863,
    ["servicehub.service.json"] = 862,
    ["settings.job"] = 707,
    ["sfdx-hardis configuration"] = 709,
    ["shard.yml"] = 1046,
    ["size-limit configuration"] = 714,
    ["skaffold.yaml"] = 931,
    ["skyuxconfig.json"] = 716,
    ["snowflake-config"] = 718,
    ["snowflake-connections"] = 719,
    ["spicepod.yaml"] = 1066,
    ["sqlc configuration"] = 751,
    ["stripe-app-local.json"] = 762,
    ["stripe-app.json"] = 761,
    swcrc = 916,
    ["task.json"] = 771,
    taskcat = 881,
    ["template.json"] = 776,
    ["templatsources.json"] = 777,
    ["theme.json"] = 780,
    ["tizen_workspace.json"] = 782,
    tldr = 783,
    ["tm_devices configuration file"] = 1129,
    tmuxinator = 866,
    ["transcend.yml"] = 793,
    ["tree-sitter grammar.json"] = 377,
    ["trime.yaml"] = 794,
    ["trunk.yaml"] = 796,
    ["ts-force-config.json"] = 801,
    ["tsconfig.json"] = 797,
    ["tsd.json"] = 798,
    ["tsdoc.json"] = 799,
    ["tsdrc.json"] = 800,
    ...
    v8r = 845,
    vcluster = 1052,
    ["vcpkg configuration file"] = 209,
    ["vcpkg manifest file"] = 208,
    ["vega-lite.json"] = 825,
    ["vega.json"] = 824,
    ["venvironment-basic.yaml"] = 828,
    ["venvironment.yaml"] = 827,
    ["venvplus-basic.yaml"] = 830,
    ["venvplus.yaml"] = 829,
    version = 1111,
    ["version.json"] = 832,
