...
M.json = {
  ...
  index = {
    ...
    ["Adobe UXP Manifest"] = 899,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Alacritty Configuration"] = 811,
    ["All Contributors configuration file"] = 864,
    ...
    ["Application list for a WinUtil"] = 943,
    ArchitectFX = 947,
    ["Argo Events"] = 28,
    ["Argo Workflows"] = 29,
    AssemblyScript = 32,
    ...
    ["BX CI"] = 104,
    ["Bashly (bashly.yml)"] = 868,
    ["Bashly Settings (bashly-settings.yml)"] = 869,
    ["Better Code Hub"] = 783,
    ["Better Scripts"] = 105,
    Bigconfig = 80,
    BizTalkServerApplicationSchema = 753,
    Bleep = 106,
    ...
    ["Butane Config"] = 824,
    ["CGS Custom Card Game (CardGameDef.json)"] = 904,
    ["CICS TS region tagging"] = 833,
    ["CICS TS resource import"] = 834,
    ["CICS TS resource model"] = 835,
    ["CICS TS resource overrides"] = 836,
    ["CMake Presets"] = 107,
    ["CNC Codes"] = 121,
    ["CRS WAF test file"] = 933,
    ["CRS WAF test platform overrides file"] = 934,
    ...
    CityJSON = 117,
    ["Clawject config"] = 126,
    ["Cloud Foundry Application Manifest"] = 916,
    ["Cloud Run Spec v1"] = 938,
    ...
    Concord = 932,
    ["Configu .cfgu files"] = 921,
    ["Configu .configu file"] = 922,
    Conjure = 120,
    ["Container Structure Test"] = 766,
    Containerlab = 791,
    ["Crowdsec collection config"] = 210,
    ["Crowdsec parser config"] = 211,
    ["Crowdsec scenario config"] = 212,
    ["CumulusCI Config"] = 125,
    ["Custom Machinery Machine"] = 905,
    ["Custom Machinery Recipe"] = 906,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 876,
    ["EAS config"] = 276,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 865,
    ["Eidolon Resource"] = 948,
    ...
    ["Goreleaser Pro"] = 332,
    Goss = 333,
    ["Gradle Build Cache Node"] = 781,
    ["Gradle Enterprise"] = 780,
    ...
    Hadolint = 762,
    Hammerkit = 790,
    ["Hardware Sentry Configuration"] = 844,
    Hatch = 763,
    Hayson = 346,
    ...
    ["JFrog File Spec"] = 374,
    ["JFrog Pipelines YML DSL"] = 853,
    ["JMeter DSL cli config"] = 375,
    JReleaser = 377,
    ["JSON Document Transform"] = 385,
    ["JSON Feed"] = 386,
    ["JSON Resume"] = 582,
    ["JSON Schema Draft 2020-12"] = 732,
    ["JSON Schema Draft 4"] = 729,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 886,
    ["JSON Schema Draft 7"] = 730,
    ["JSON Schema Draft 7 (unofficial strict)"] = 887,
    ["JSON Schema Draft 8 (2019-09)"] = 731,
    ["JSON-API"] = 384,
    ["JSON-WF"] = 915,
    ["JSON-e templates"] = 788,
    ["JSON-stat 2.0"] = 725,
    JSONPatch = 388,
    ...
    ["Keycloak REST API"] = 856,
    ["Knative Functions - func.yaml"] = 294,
    ["KoDE/CI build.yaml"] = 849,
    ["Kong DBLess config"] = 850,
    KrakenD = 401,
    ...
    ["Metadata for a Cinnamon spice"] = 941,
    ["MetricsHub Configuration"] = 433,
    ["MetricsHub Connector Configuration"] = 434,
    ["Micro Editor Syntax"] = 877,
    ["Microsoft Band Web Tile"] = 435,
    ["Microsoft RulesEngine workflow rules"] = 929,
    ["Microsoft RulesEngine workflow rules list"] = 930,
    ["Minecraft Custom Main Menu Mod"] = 894,
    ...
    ["MongoDB Atlas Search Index Definition"] = 848,
    ["Monika Configuration"] = 846,
    ["Monoweave Configuration"] = 459,
    ["Motif config"] = 746,
    ["NOX Framework (Service)"] = 476,
    ["Netin Diagnostic System Template"] = 806,
    ["Netlify config"] = 467,
    ...
    ["OpenUtau ustx"] = 492,
    ["OpenWeather Current Weather API"] = 787,
    ["OpenWeather Road Risk API"] = 786,
    ...
    ["Pipeline component"] = 798,
    ["PocketMine plugin.yml"] = 525,
    ["Postman collection"] = 531,
    ["Preset list for a WinUtil"] = 944,
    ["Problem object RFC9457"] = 891,
    ...
    Qgoda = 564,
    Qodana = 816,
    ["Qt Creator workspace file"] = 923,
    ["Quali Torque Blueprint Spec 2"] = 841,
    ["QueryFirst config file"] = 859,
    ["RKE Cluster Configuration JSON"] = 795,
    ["RKE Cluster Configuration YAML"] = 794,
    ["Rancher Fleet"] = 558,
    ["Rattler-build"] = 565,
    Ray = 761,
    ["Read the Docs"] = 560,
    ...
    ["Render Blueprints"] = 793,
    RenderCV = 584,
    Renovate = 583,
    ["Replit config"] = 578,
    RoadRunner = 585,
    ["Rudder techniques"] = 897,
    Ruff = 580,
    ["Rust Project"] = 581,
    ["Rust toolchain"] = 589,
    ...
    ["SauceCTL Configuration"] = 803,
    ["Schema Catalog"] = 606,
    ["Scoop manifest"] = 611,
    ["Semantic Data Fabric (SDF) file"] = 615,
    ["Semgrep Rule"] = 617,
    ["Serenity Code Generator (Sergen)"] = 618,
    ["Serverless Framework Configuration"] = 810,
    ["Serverless Workflow"] = 812,
    ["Settings for a Cinnamon spice"] = 940,
    ["Settings.paf"] = 620,
    ["Shopware 6 Configuration"] = 813,
    ["Shopware CLI Extension Store Configuration"] = 814,
    ["Shopware CLI Project Store Configuration"] = 815,
    ["Sigma Detection Rule"] = 622,
    ["Sigrid scope configuration file"] = 623,
    ["SkyPilot Task JSON"] = 898,
    ...
    StackBlitz = 643,
    ["StackHawk Scanner Configuration"] = 809,
    Stale = 644,
    ["Starlake Data Pipeline"] = 784,
    Starship = 645,
    ...
    ["Sublime Syntax"] = 855,
    ["Subsquid squid manifest"] = 900,
    ["Swagger API 2.0"] = 654,
    TSON = 683,
    TSTyche = 684,
    ["Tab data for a LinUtil"] = 946,
    ["Tab list for a LinUtil"] = 945,
    Talhelper = 656,
    ...
    Tycho = 936,
    Tye = 817,
    ["UET BuildConfig.json"] = 860,
    ["UI5 Manifest"] = 693,
    ["UNCORS configuration"] = 697,
    ["UTAM Page Object"] = 696,
    ["Ubuntu Server Autoinstall"] = 691,
    ["Uniswap Token List"] = 772,
    ["Unreal Engine Uplugin"] = 861,
    ["Unreal Engine Uproject"] = 862,
    ["Updatecli Compose"] = 825,
    ["Updatecli Policy Manifest"] = 826,
    ["Updatecli Policy Metadata"] = 827,
    Uplift = 858,
    ["User Journey Map"] = 792,
    V2Ray = 831,
    ...
    ["Wrangler CLI"] = 724,
    ["Xstate Machine"] = 823,
    ["Yandex Workflow Language"] = 942,
    ["Yarn Config (.yarnrc.yml)"] = 782,
    ["Yippee-Ki-JSON configuration YML"] = 774,
    ["YouTrack App"] = 939,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 892,
    ...
    ["behat.yml"] = 89,
    ["bigquery-table"] = 79,
    ["bioimageio resource description"] = 908,
    ...
    ["lint-staged (.lintstagedrc)"] = 740,
    ["local.settings.json"] = 424,
    ["localazy.json"] = 425,
    ["lotus.yaml"] = 423,
    ["lsdlschema.json"] = 426,
    ["markdown-link-check"] = 801,
    mboats = 808,
    ["micro-settings.json"] = 872,
    ["mimetypes.json"] = 436,
    ["mirrord config"] = 741,
    mise = 742,
    ["mise-settings"] = 743,
    ...
    ["servicehub.config.json"] = 735,
    ["servicehub.service.json"] = 734,
    ["settings.job"] = 619,
    ...
    ["vtesttree.yaml"] = 716,
    ["vtestunit.yaml"] = 717,
    ["warp-keysets.json"] = 881,
    ["warp-themes.json"] = 882,
    ["warp-workflows.json"] = 883,
    ["webhint.io"] = 838,
    ["webjobpublishsettings.json"] = 722,
    ["webjobs-list.json"] = 721,
    ["well-known-fursona"] = 919,
    ["xs-app.json"] = 748,
    ["xunit.runner.json"] = 733,
    yamllint = 773,
    ["zerops.io import file"] = 928,
    ["zerops.yml"] = 927,
    zuul = 757,
    ["Žinoma"] = 767
  },
