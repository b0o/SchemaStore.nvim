...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 147,
    [".cryproj (generic)"] = 496,
    [".cryproj engine-5.2"] = 491,
    [".cryproj engine-5.3"] = 492,
    [".cryproj engine-5.4"] = 493,
    [".cryproj engine-5.5"] = 494,
    [".cryproj engine-dev"] = 495,
    [".csscomb.json"] = 149,
    [".csslintrc"] = 150,
    [".eslintrc"] = 195,
    [".esmrc.json"] = 187,
    ...
    [".mtaext"] = 505,
    [".nodehawkrc"] = 313,
    [".npmpackagejsonlintrc"] = 316,
    [".phraseapp.yml"] = 350,
    [".pmbot.yml"] = 342,
    [".postcssrc"] = 347,
    [".pre-commit-config.yml"] = 348,
    [".pre-commit-hooks.yml"] = 349,
    [".putout.json"] = 367,
    [".rehyperc"] = 374,
    [".remarkrc"] = 375,
    [".sprite files"] = 418,
    ...
    [".vsext"] = 471,
    [".yarnrc.yml"] = 537,
    ["<div>RIOTS' studio configuration"] = 475,
    ["@factorial/drupal-breakpoints-css"] = 5,
    ["A micro editor config schema"] = 283,
    ["API Builder"] = 534,
    ["AVA Configuration Schema"] = 590,
    ["AWS CDK cdk.json"] = 135,
    ["AWS CloudFormation"] = 136,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 137,
    ["Airlock Microgateway"] = 9,
    ["Airplane task"] = 10,
    ["Alacritty Configuration Schema"] = 565,
    ...
    ["Azure Pipelines"] = 47,
    ["Azure Static Web Apps CLI configuration file"] = 420,
    ["Azure Static Web Apps configuration file"] = 419,
    ["BX CI"] = 78,
    ["Better Code Hub"] = 539,
    ["Better Scripts"] = 79,
    BizTalkServerApplicationSchema = 511,
    ["Block Protocol Metadata"] = 77,
    Briefcase = 516,
    ["Build Info"] = 70,
    Buildkite = 72,
    ["Bukkit plugin.yml"] = 71,
    ["BungeeCord plugin.yml"] = 75,
    ["Butane Config"] = 577,
    ["CICS TS region tagging"] = 584,
    ["CICS TS resource import"] = 585,
    ["CICS TS resource model"] = 586,
    ["CICS TS resource overrides"] = 587,
    ["CMake Presets"] = 80,
    ["CNC Codes JSON Schema"] = 89,
    ["Calqulus pipeline"] = 81,
    ["Camel YAML DSL"] = 82,
    Carafe = 83,
    ["Cargo Config Schema"] = 84,
    ["Cargo Make"] = 85,
    ["Catalog Info Backstage"] = 86,
    Cheatsheets = 574,
    ["Chrome Extension"] = 129,
    ["CircleCI config.yml"] = 110,
    ["Citation File Format"] = 138,
    CityJSON = 87,
    ["Code Climate"] = 111,
    CodeCV = 46,
    Codux = 118,
    ["Commandbox Box.json"] = 90,
    ["Commandbox Server.json"] = 91,
    ["Common Catalog Schema"] = 127,
    ["Common types for all schemas"] = 1,
    Conjure = 88,
    ["Container Structure Test"] = 522,
    Containerlab = 547,
    ["DWP Exchange - catalogue entry"] = 184,
    ["DWP Exchange - gateway"] = 182,
    ["DWP Exchange - meta"] = 183,
    ["Dart build configuration"] = 151,
    ["Dart test config"] = 152,
    ["DashLord configuration"] = 153,
    ["Datadog Service Definition"] = 268,
    ["Datahub Ingestion Recipe Schema"] = 591,
    ["Deadpendency Config Schema"] = 93,
    ["Dein Config Schema"] = 94,
    Deno = 157,
    ["Deployer Recipe"] = 160,
    Devfile = 181,
    ["Discord Webhook"] = 162,
    ["Dolittle Artifacts"] = 166,
    ["Dolittle Bounded Context Configuration"] = 167,
    ["Dolittle Event Horizons Configuration"] = 168,
    ["Dolittle Resources Configuration"] = 169,
    ["Dolittle Server Configuration"] = 170,
    ["Dolittle Tenant Map Configuration"] = 172,
    ["Dolittle Tenants Configuration"] = 171,
    ["Dolittle Topology"] = 173,
    ["Drupal Breakpoints Schema"] = 95,
    ["Drupal Config Schema"] = 106,
    ["Drupal Info Schema"] = 96,
    ["Drupal Layouts Schema"] = 97,
    ["Drupal Libraries Schema"] = 98,
    ["Drupal Links Action Schema"] = 99,
    ["Drupal Links Contextual Schema"] = 100,
    ["Drupal Links Menu Schema"] = 101,
    ["Drupal Links Task Schema"] = 102,
    ["Drupal Migration Schema"] = 103,
    ["Drupal Permissions Schema"] = 104,
    ["Drupal Routing Schema"] = 105,
    ["Drupal Services Schema"] = 107,
    ["Drush site aliases"] = 177,
    ["Embrace Config Schema"] = 602,
    ["Error pages"] = 190,
    Esquio = 188,
    ["Estuary Flow Catalog Schema"] = 581,
    ["Expo SDK"] = 193,
    ["F-Droid Data metadata"] = 198,
    ["Facets - FSDL - Application"] = 196,
    ["Fossa configuration file"] = 203,
    ["Fossa's fossa-deps file"] = 204,
    ["Foundry VTT - Manifest"] = 201,
    ["Foundry VTT - Template"] = 202,
    ["Foxx Manifest"] = 48,
    ["GatewayCore API Gateway"] = 207,
    ["GeoJSON.json latest"] = 579,
    GherKing = 583,
    ["GitHub Action"] = 211,
    ["GitHub Funding"] = 212,
    ["GitHub Issue Template configuration"] = 214,
    ["GitHub Workflow"] = 215,
    ["GitHub Workflow Template Properties"] = 216,
    ["GitHub issue forms"] = 213,
    GitVersion = 210,
    ["Gitpod Configuration"] = 218,
    ["Global Privacy Control"] = 208,
    ["Google Cloud Workflows"] = 134,
    Goreleaser = 221,
    ["Goreleaser Pro"] = 222,
    ["Gradle Build Cache Node"] = 536,
    ["Gradle Enterprise"] = 535,
    ["Grafana 5.x Dashboard"] = 223,
    ["GraphQL Code Generator"] = 226,
    ["GraphQL Config"] = 225,
    ["GraphQL Mesh"] = 224,
    ["Grunt JSHint task"] = 230,
    ["Grunt Watch task"] = 231,
    ["Grunt base task"] = 232,
    ["Grunt clean task"] = 228,
    ["Grunt copy task"] = 227,
    ["Grunt cssmin task"] = 229,
    HEMTT = 508,
    Hadolint = 520,
    Hammerkit = 546,
    ["Hardware Sentry Configuration"] = 595,
    Hayson = 234,
    ["Haystack Pipeline"] = 235,
    ["Hazelcast 5 Configuration"] = 236,
    ["Helm Chart.lock"] = 109,
    ["Helm Chart.yaml"] = 108,
    Hugo = 573,
    ["Istanbul Schema"] = 598,
    ["JDownloader2 crawler multi-rule schema"] = 252,
    ["JDownloader2 crawler single-rule schema"] = 251,
    ["JFrog File Spec"] = 253,
    ["JFrog Pipelines YML DSL"] = 604,
    ["JSON Document Transform"] = 261,
    ["JSON Feed"] = 262,
    ["JSON Resume"] = 380,
    ["JSON Schema Draft 2020-12"] = 487,
    ["JSON Schema Draft 4"] = 484,
    ["JSON Schema Draft 7"] = 485,
    ["JSON Schema Draft 8"] = 486,
    ["JSON schema for CodeShip Pro services configuration files"] = 120,
    ["JSON schema for CodeShip Pro steps configuration files"] = 121,
    ["JSON schema for Codecov configuration files"] = 119,
    ["JSON-API"] = 260,
    ["JSON-e templates"] = 544,
    ["JSON-stat 2.0"] = 481,
    JSONPatch = 264,
    Jasmine = 247,
    Jekyll = 248,
    ["Jenkins X Pipelines"] = 249,
    ["Jenkins X Requirements"] = 250,
    ["Jovo Language Models"] = 254,
    ["KSP-AVC"] = 482,
    ["KSP-CKAN"] = 483,
    ["Keycloak REST API"] = 610,
    ["Knative Functions - func.yaml"] = 205,
    ["KoDE/CI build.yaml"] = 600,
    ["Kong DBLess Schema"] = 601,
    KrakenD = 267,
    ["LinkML Metamodel"] = 279,
    Liquibase = 551,
    ["Liquibase Flow File"] = 552,
    Markdownlint = 555,
    ["MegaLinter configuration"] = 284,
    ["MegaLinter descriptor"] = 285,
    ["Meltano plugin discovery definition"] = 287,
    ["Meltano project definition"] = 286,
    ["Microsoft Band Web Tile"] = 288,
    ["Minecraft Data Pack Advancement"] = 290,
    ["Minecraft Data Pack Biome"] = 291,
    ["Minecraft Data Pack Configured Carver"] = 292,
    ["Minecraft Data Pack Dimension"] = 294,
    ["Minecraft Data Pack Dimension Type"] = 293,
    ["Minecraft Data Pack Item Modifier"] = 295,
    ["Minecraft Data Pack Loot Table"] = 296,
    ["Minecraft Data Pack Metadata"] = 297,
    ["Minecraft Data Pack Predicate"] = 298,
    ["Minecraft Data Pack Recipe"] = 299,
    ["Minecraft Data Pack Tag"] = 300,
    ["Minecraft Data Pack Template Pool"] = 301,
    ["Minecraft Resourcepack Sounds"] = 302,
    ["MongoDB Atlas Search Index Definition Schema"] = 599,
    ["Monika Configuration Schema"] = 597,
    ["Motif config"] = 504,
    ["NOX Framework (Service)"] = 315,
    ["Netin Diagnostic System Template"] = 560,
    ["Netlify config schema"] = 307,
    ["Nightwatch.js"] = 308,
    ["OSS Review Toolkit configuration"] = 332,
    ["OSS Review Toolkit curation"] = 333,
    ["OSS Review Toolkit package configuration"] = 334,
    ["OSS Review Toolkit repository configuration"] = 335,
    ["OSS Review Toolkit resolutions"] = 336,
    Opctl = 507,
    ["OpenWeather Current Weather API"] = 543,
    ["OpenWeather Road Risk API"] = 542,
    ["Ory Hydra configuration"] = 240,
    ["Ory Keto configuration"] = 269,
    ["Ory Kratos configuration"] = 331,
    ["Ory Oathkeeper configuration"] = 322,
    ["Outblocks App configuration"] = 329,
    ...
    Pterodactyl = 594,
    ["Pull Request Labeler"] = 366,
    Pulumi = 370,
    PyProject = 371,
    Qodana = 570,
    ["Quali Torque Blueprint Spec 2"] = 592,
    ["QueryFirst config file"] = 613,
    ["RKE Cluster Configuration JSON Schema"] = 550,
    ["RKE Cluster Configuration YAML Schema"] = 549,
    Ray = 519,
    ["Read the Docs"] = 369,
    ["Red-DiscordBot Cog"] = 372,
    ["Red-DiscordBot Cog Repo"] = 373,
    Renovate = 381,
    ["Replit schema"] = 376,
    RoadRunner = 382,
    Ruff = 378,
    ["Rust Project"] = 379,
    ["Rust toolchain"] = 384,
    ["SIL Kit Participant Configuration"] = 409,
    SWADL = 429,
    ["Sapphire CLI Config"] = 385,
    ["SauceCTL Configuration"] = 557,
    ["Schema Catalog"] = 398,
    ["Scoop manifest"] = 403,
    ["Semgrep Rule"] = 405,
    ["Serverless Framework Configuration"] = 564,
    ["Serverless Workflow Schema"] = 566,
    ["Settings.paf"] = 407,
    ["Shopware 6 Configuration"] = 567,
    ["Shopware CLI Extension Store Configuration"] = 568,
    ["Shopware CLI Project Store Configuration"] = 569,
    Solidarity = 413,
    ["Solution filters"] = 414,
    ["Source Maps v3"] = 415,
    SpecIF = 416,
    ["Sponge Mixin configuration"] = 417,
    ["StackHawk Scanner Configuration"] = 563,
    Stale = 421,
    Starship = 422,
    ["Statamic Blueprint"] = 423,
    ["StrmPrivacy Data Connector"] = 608,
    ["StrmPrivacy Data Contract"] = 609,
    ["StrmPrivacy SimpleSchema"] = 606,
    ["StrmPrivacy Stream"] = 607,
    ["StrmPrivacy batch job configuration file"] = 605,
    ["Stryker Mutator"] = 426,
    ["StyleCop Analyzers Configuration"] = 427,
    ["Swagger API 2.0"] = 430,
    TSON = 450,
    ["Talisman configuration"] = 431,
    ["Taskfile YAML Schema"] = 545,
    Taurus = 432,
    ["TestEnvironment.json"] = 439,
    Tikibase = 435,
    ["Traefik v2"] = 442,
    ["Traefik v2 File Provider"] = 443,
    Turborepo = 440,
    Tye = 571,
    ["UI5 Manifest"] = 457,
    ["UTAM Page Object"] = 459,
    ["Ubuntu Server Autoinstall"] = 455,
    ["Uniswap Token List"] = 528,
    ["Unreal Engine Uplugin"] = 614,
    ["Unreal Engine Uproject"] = 615,
    Updatecli = 578,
    Uplift = 612,
    ["User Journey Map YAML Schema"] = 548,
    V2Ray = 582,
    ["VSCode Code Snippets"] = 123,
    ["VSIX CLI publishing"] = 472,
    ["Vela Pipeline Configuration"] = 462,
    Vercel = 122,
    ["Web App Manifest"] = 477,
    ["Web types"] = 480,
    WebExtensions = 476,
    ["Webman package recipe"] = 588,
    ["Windows Package Manager Installer Manifest"] = 525,
    ["Windows Package Manager Locale Manifest"] = 526,
    ["Windows Package Manager Singleton Manifest"] = 524,
    ["Woodpecker pipeline config"] = 559,
    ["Xstate Machine Schema"] = 576,
    ["Yippee-Ki-JSON configuration YML"] = 530,
    ["angular.json"] = 11,
    ...
    ["batect.yml"] = 53,
    ["beau.yml"] = 538,
    ["beef-database-codegen"] = 55,
    ["beef-database-v5-codegen"] = 57,
    ["beef-entity-codegen"] = 56,
    ["beef-entity-v5-codegen"] = 58,
    ["behat.yml"] = 66,
    ["bigquery-table"] = 59,
    ["bitbucket-pipelines"] = 60,
    bitrise = 61,
    ["bitrise-step"] = 62,
    ["block.json"] = 76,
    ["bower.json"] = 64,
    ["bozr.suite.json"] = 67,
    ["browser.i18n.json"] = 68,
    bucklescript = 69,
    ["bundleconfig.json"] = 74,
    ["chutzpah.json"] = 130,
    clangd = 114,
    ["cloud-init: cloud-config userdata JSON schema"] = 116,
    ["cloud-sdk-pipeline-config-schema"] = 132,
    ["cloudbuild.json"] = 133,
    cloudify = 115,
    codemagic = 117,
    ["coffeelint.json"] = 139,
    comet = 540,
    ["commands.json"] = 126,
    ["compile_commands.json"] = 125,
    ["compilerconfig.json"] = 124,
    ["component-detection-manifest.json"] = 142,
    ["component.json"] = 141,
    ["composer.json"] = 140,
    ["config.json"] = 143,
    ["contentmanifest.json"] = 131,
    ["contribute.json"] = 144,
    ["cosmos.config.json"] = 128,
    ["crowdin.yml"] = 145,
    cspell = 148,
    ["cypress.json"] = 146,
    ["datalogic-scan2deploy-android"] = 154,
    ["datalogic-scan2deploy-ce"] = 155,
    ["dbt Project"] = 92,
    ["debugsettings.json"] = 156,
    ["dependabot-v2.json"] = 159,
    ["dependabot.json"] = 158,
    ["deployed-cli"] = 575,
    ["detekt.yml"] = 161,
    devinit = 532,
    ["devspace.yaml"] = 596,
    ["docfx.json"] = 165,
    ["docker-compose.yml"] = 531,
    ["docker-seq schema"] = 164,
    ["dockerd.json"] = 163,
    ["dotnet Release Index manifest"] = 174,
    ["dotnetcli.host.json"] = 175,
    ["drone.json"] = 176,
    ["dss-2.0.0.json"] = 178,
    ["dstack Workflows"] = 179,
    ["dvc.yaml"] = 180,
    ["ecosystem.json"] = 185,
    eksctl = 186,
    ["electron-builder configuration file."] = 191,
    ["epr-manifest.json"] = 189,
    ["evcc.yaml"] = 192,
    ["ezd schema"] = 194,
    ["fabric.mod.json"] = 197,
    ["first-timers-bot"] = 200,
    ["fly.io Schema"] = 49,
    fulibWorkflows = 558,
    ["function.json"] = 206,
    ["geojson.json"] = 209,
    ["gitlab-ci"] = 217,
    ["global.json"] = 219,
    ["golangci-lint Configuration"] = 220,
    ["haxelib.json"] = 233,
    helmfile = 521,
    ["host-meta.json"] = 238,
    ["host.json"] = 237,
    ...
    huskyrc = 499,
    ["ide.host.json"] = 241,
    ["imageoptimizer.json"] = 242,
    ["importmap.json"] = 244,
    ["ioBroker JSON UI"] = 245,
    ["ioBroker Package manifest"] = 246,
    ["ize.toml"] = 611,
    ["jsconfig.json"] = 265,
    ["jscpd Configuration Schema"] = 593,
    jsdoc = 518,
    ["k3d.yaml"] = 266,
    ["kustomization.yaml"] = 270,
    ["label-commenter-config.yml"] = 271,
    ["launchsettings.json"] = 272,
    ["lego.json"] = 273,
    ["lerna.json"] = 274,
    ["lgtm.yml"] = 275,
    ["libman.json"] = 276,
    ["license-report-config.json"] = 277,
    ["linkinator.config.json"] = 278,
    ["local.settings.json"] = 280,
    ["localazy.json"] = 281,
    ["lsdlschema.json"] = 282,
    ["markdown-lint-check"] = 556,
    mboats = 562,
    ["mimetypes.json"] = 289,
    ["mirrord-schema"] = 501,
    ["mta.yaml"] = 502,
    ["mtad.yaml"] = 503,
    ["mycode.json"] = 305,
    ["napari plugin manifest"] = 306,
    neoload = 513,
    ["nest-cli"] = 311,
    ["ninjs (News in JSON) 1.3"] = 310,
    ["ninjs (News in JSON) 2.0"] = 309,
    ["nlu.json"] = 312,
    ["nodemon.json"] = 314,
    ["noodl.schema.json"] = 561,
    now = 509,
    ["npm-badges"] = 317,
    ["nswag.json"] = 320,
    ntangle = 321,
    ["nuclei-template.yaml"] = 318,
    ["nuget-project.json"] = 319,
    ["ocelot.json"] = 323,
    ["omnisharp.json"] = 324,
    ["openapi.json"] = 325,
    ["openfin.json"] = 327,
    ["openrpc.json"] = 326,
    ["package.json"] = 337,
    ["package.manifest"] = 338,
    ["pattern.json"] = 341,
    ["petstore-v1.0"] = 603,
    pgap_yaml_input_reader = 340,
    ["plagiarize-me.yaml"] = 345,
    ["plagiarize.yaml"] = 344,
    ["portman.json"] = 346,
    ["prettierrc.json"] = 351,
    ["prisma.yml"] = 352,
    ["project-1.0.0-beta3.json"] = 354,
    ["project-1.0.0-beta4.json"] = 355,
    ["project-1.0.0-beta5.json"] = 356,
    ["project-1.0.0-beta6.json"] = 357,
    ["project-1.0.0-beta8.json"] = 358,
    ["project-1.0.0-rc1.json"] = 359,
    ["project-1.0.0-rc2.json"] = 360,
    ["project.json"] = 353,
    ["prometheus.json"] = 361,
    ["prometheus.rules.json"] = 362,
    ["proxies.json"] = 363,
    ["publiccode.yml"] = 364,
    ["pubspec.yaml"] = 365,
    ["pyrseas-0.8.json"] = 368,
    ["release drafter"] = 514,
    rustfmt = 383,
    ["sarif-1.0.0.json"] = 386,
    ["sarif-2.0.0.json"] = 387,
    ["sarif-2.1.0"] = 396,
    ["sarif-2.1.0-rtm.2"] = 388,
    ["sarif-2.1.0-rtm.3"] = 390,
    ["sarif-2.1.0-rtm.4"] = 392,
    ["sarif-2.1.0-rtm.5"] = 394,
    ["sarif-external-property-file-2.1.0"] = 397,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 389,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 391,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 393,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 395,
    ["schema.org - Action"] = 399,
    ["schema.org - ContactPoint"] = 400,
    ["schema.org - Place"] = 401,
    ["schema.org - Thing"] = 402,
    ["semantic-release"] = 404,
    ["servicehub.config.json"] = 490,
    ["servicehub.service.json"] = 489,
    ["settings.job"] = 406,
    ["sfdx-hardis configuration"] = 408,
    ["size-limit configuration"] = 410,
    ["skaffold.yaml"] = 554,
    ["skyuxconfig.json"] = 411,
    snapcraft = 412,
    ["stripe-app-local.json"] = 425,
    ["stripe-app.json"] = 424,
    swcrc = 541,
    taskcat = 510,
    ["template.json"] = 433,
    ["templatsources.json"] = 434,
    ["theme.json"] = 436,
    ["tizen_workspace.json"] = 437,
    tmLanguage = 438,
    tmuxinator = 498,
    ["trunk.yaml schema"] = 444,
    ["ts-force-config.json"] = 448,
    ["tsconfig.json"] = 445,
    ["tsd.json"] = 446,
    ["tsdrc.json"] = 447,
    ["tslint.json"] = 449,
    ...
    ["vega-lite.json"] = 461,
    ["vega.json"] = 460,
    ["venvironment-basic.yaml"] = 464,
    ["venvironment.yaml"] = 463,
    ["version.json"] = 465,
    ["vim-addon-info"] = 466,
    ["vs-2017.3.host.json"] = 468,
    ["vs-nesting.json"] = 469,
    ["vsls.json"] = 467,
    ["vss-extension.json"] = 473,
    ["webhint.io"] = 589,
    ["webjobpublishsettings.json"] = 479,
    ["webjobs-list.json"] = 478,
    ["xs-app.json"] = 506,
    ["xunit.runner.json"] = 488,
    yamllint = 529,
    zuul = 515,
    ["Žinoma"] = 523
  },
