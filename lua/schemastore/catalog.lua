...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 192,
    [".cryproj (generic)"] = 652,
    [".cryproj engine-5.2"] = 647,
    [".cryproj engine-5.3"] = 648,
    [".cryproj engine-5.4"] = 649,
    [".cryproj engine-5.5"] = 650,
    [".cryproj engine-dev"] = 651,
    [".eslintrc"] = 247,
    [".esmrc.json"] = 239,
    [".ffizer.yaml"] = 251,
    [".htmlhintrc"] = 306,
    ...
    [".mtaext"] = 663,
    [".nodehawkrc"] = 415,
    [".npmpackagejsonlintrc"] = 418,
    [".phraseapp.yml"] = 464,
    [".pmbot.yml"] = 454,
    [".postcssrc"] = 459,
    [".powerpages-web-template-manifest"] = 461,
    [".pre-commit-config.yml"] = 462,
    [".pre-commit-hooks.yml"] = 463,
    [".putout.json"] = 483,
    [".rehyperc"] = 496,
    [".remarkrc"] = 498,
    [".sprite files"] = 556,
    ...
    ["<div>RIOTS' studio configuration"] = 630,
    ["@factorial/drupal-breakpoints-css"] = 4,
    ["A micro editor config"] = 370,
    AIConfig = 11,
    ["API Builder"] = 695,
    ["AVA Configuration"] = 755,
    ["AWS CDK cdk.json"] = 176,
    ["AWS CloudFormation"] = 177,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 178,
    ["AWS SAM CLI Samconfig"] = 179,
    ["Adobe UXP Manifest"] = 820,
    ["Aerleon Network & Service Definitions"] = 7,
    ["Aerleon Policy"] = 8,
    ["Airlock Microgateway"] = 12,
    ["Airplane task"] = 13,
    ["Alacritty Configuration"] = 727,
    ["All Contributors configuration file"] = 785,
    ...
    ["Azure Pipelines"] = 64,
    ["Azure Static Web Apps CLI configuration file"] = 559,
    ["Azure Static Web Apps configuration file"] = 558,
    ["BX CI"] = 102,
    ["Bashly (bashly.yml)"] = 789,
    ["Bashly Settings (bashly-settings.yml)"] = 790,
    ["Better Code Hub"] = 699,
    ["Better Scripts"] = 103,
    Bigconfig = 81,
    BizTalkServerApplicationSchema = 669,
    Bleep = 104,
    ...
    ["Butane Config"] = 740,
    ["CGS Custom Card Game (CardGameDef.json)"] = 825,
    ["CICS TS region tagging"] = 749,
    ["CICS TS resource import"] = 750,
    ["CICS TS resource model"] = 751,
    ["CICS TS resource overrides"] = 752,
    ["CMake Presets"] = 105,
    ["CNC Codes"] = 117,
    ["CSS Comb (.csscomb.json)"] = 194,
    ["CSS Lint (.csslintrc)"] = 195,
    ["CSpell (cspell.json)"] = 193,
    ...
    Cheatsheets = 737,
    ["Chrome Extension"] = 169,
    ["Chromia Model"] = 112,
    ["CircleCI config.yml"] = 146,
    ["Citation File Format"] = 181,
    CityJSON = 114,
    ["Code Climate"] = 147,
    CodeCV = 61,
    ["CodeShip Pro services configuration files"] = 158,
    ["CodeShip Pro steps configuration files"] = 159,
    ["Codecov configuration files"] = 157,
    Codux = 155,
    ["Cog config file"] = 118,
    ["Commandbox Box.json"] = 119,
    ["Commandbox Server.json"] = 120,
    ["Common Catalog Data"] = 167,
    Conjure = 116,
    ["Container Structure Test"] = 682,
    Containerlab = 707,
    ["Crowdsec collection config"] = 188,
    ["Crowdsec parser config"] = 189,
    ["Crowdsec scenario config"] = 190,
    ["CumulusCI Config"] = 121,
    ["Custom Machinery Machine"] = 826,
    ["Custom Machinery Recipe"] = 827,
    ["DWP Exchange - catalogue entry"] = 234,
    ["DWP Exchange - gateway"] = 232,
    ["DWP Exchange - meta"] = 233,
    ["Dart Build Config (dart-build.json)"] = 196,
    ["Dart Test Config (dart-test.json)"] = 197,
    ["DashLord Configuration"] = 198,
    ["Data Contract Specification"] = 199,
    ["DataYoga Connections"] = 122,
    ["DataYoga Job"] = 123,
    ["Databricks Asset Bundles"] = 806,
    ["Datadog Service Definition"] = 347,
    ["Datahub Ingestion Recipe"] = 756,
    ["Dein Config"] = 125,
    ["Deno Config (deno.json)"] = 205,
    ["Dependency cruiser"] = 126,
    ["Deployer Recipe"] = 208,
    ["Deta Spacefile"] = 127,
    ["Detekt Config (detekt.yml)"] = 209,
    ["Devbox Config"] = 128,
    ["Devbox Plugin"] = 129,
    Devfile = 231,
    ["Discord Webhook"] = 210,
    ["DocFx Config (docfx.json)"] = 213,
    ["Dolittle Artifacts"] = 214,
    ["Dolittle Bounded Context Configuration"] = 215,
    ["Dolittle Event Horizons Configuration"] = 216,
    ["Dolittle Resources Configuration"] = 217,
    ["Dolittle Server Configuration"] = 218,
    ["Dolittle Tenant Map Configuration"] = 220,
    ["Dolittle Tenants Configuration"] = 219,
    ["Dolittle Topology"] = 221,
    ["Drupal Breakpoints"] = 130,
    ["Drupal Config"] = 141,
    ["Drupal Info"] = 131,
    ["Drupal Layouts"] = 132,
    ["Drupal Libraries"] = 133,
    ["Drupal Links Action"] = 134,
    ["Drupal Links Contextual"] = 135,
    ["Drupal Links Menu"] = 136,
    ["Drupal Links Task"] = 137,
    ["Drupal Migration"] = 138,
    ["Drupal Permissions"] = 139,
    ["Drupal Routing"] = 140,
    ["Drupal Services"] = 142,
    ["Drush site aliases"] = 227,
    ["Dynamic Bash Aliases (.aliases)"] = 797,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 786,
    ["Elgato Stream Deck"] = 237,
    ["Embrace Config"] = 767,
    Endurica = 810,
    ["Enterprise Contract Policy Spec"] = 238,
    ["Error pages"] = 242,
    Esquio = 240,
    ["Estuary Flow Catalog"] = 746,
    ["Expo SDK"] = 245,
    ["F-Droid Data metadata"] = 250,
    ["Facets - FSDL - Application"] = 248,
    ["FasterCI Configuration"] = 65,
    FiQuS = 254,
    Firebase = 252,
    ["Fossa configuration file"] = 261,
    ["Fossa's fossa-deps file"] = 262,
    ["Foundry VTT - Base package Manifest"] = 256,
    ["Foundry VTT - Module Manifest"] = 257,
    ["Foundry VTT - System Data Template"] = 260,
    ["Foundry VTT - System Manifest"] = 258,
    ["Foundry VTT - World Manifest"] = 259,
    ["Foxx Manifest"] = 66,
    ["Freifunk.de Community API"] = 69,
    ["Frogbot Config"] = 70,
    ["G2P Mapping Configuration"] = 266,
    ["GCP Blueprint Metadata"] = 269,
    Gaspar = 267,
    ["GatewayCore API Gateway"] = 268,
    ["GeoJSON.json latest"] = 744,
    GherKing = 748,
    ["GitHub Action"] = 273,
    ["GitHub Discussion"] = 274,
    ["GitHub Funding"] = 275,
    ["GitHub Issue Template configuration"] = 277,
    ["GitHub Issue Template forms"] = 276,
    ["GitHub Workflow"] = 278,
    ["GitHub Workflow Template Properties"] = 279,
    ["GitLab Agent for Kubernetes configuration"] = 822,
    GitVersion = 271,
    ["Gitea Issue Template forms"] = 272,
    ["Gitpod Configuration"] = 281,
    ["GlazeWM settings"] = 824,
    ["Global Privacy Control"] = 270,
    Goblet = 805,
    ["Golangci-lint Configuration"] = 283,
    ["Golangci-lint Custom Plugins Configuration"] = 284,
    ["Google Chrome Related Website Sets"] = 253,
    ["Google Cloud Workflows"] = 175,
    Goreleaser = 286,
    ["Goreleaser Pro"] = 287,
    Goss = 288,
    ["Gradle Build Cache Node"] = 697,
    ["Gradle Enterprise"] = 696,
    ["Grafana 5.x Dashboard"] = 289,
    ["GraphQL Code Generator"] = 293,
    ["GraphQL Config"] = 292,
    ["GraphQL Mesh"] = 291,
    ["Grunt JSHint task"] = 297,
    ["Grunt Watch task"] = 298,
    ["Grunt base task"] = 299,
    ["Grunt clean task"] = 295,
    ["Grunt copy task"] = 294,
    ["Grunt cssmin task"] = 296,
    HEMTT = 666,
    Hadolint = 678,
    Hammerkit = 706,
    ["Hardware Sentry Configuration"] = 760,
    Hatch = 679,
    Hayson = 301,
    ["Haystack Pipeline"] = 302,
    ["Hazelcast 5 Configuration"] = 303,
    ["Helm Chart.lock"] = 144,
    ["Helm Chart.yaml"] = 143,
    ["Helm Unittest Test Suite"] = 145,
    Hugo = 736,
    ["Hugo Theme"] = 735,
    ["IBM Zapp document"] = 308,
    ["IBM zCodeFormatSettings"] = 309,
    ["IMG Catapult PSP"] = 314,
    ["IVMS101 by CODE Protocol"] = 823,
    Istanbul = 763,
    ["JDownloader2 crawler multi-rules"] = 324,
    ["JDownloader2 crawler single-rules"] = 323,
    ["JFrog Applications Config"] = 325,
    ["JFrog File Spec"] = 326,
    ["JFrog Pipelines YML DSL"] = 769,
    ["JMeter DSL cli config"] = 327,
    JReleaser = 329,
    ["JSON Document Transform"] = 337,
    ["JSON Feed"] = 338,
    ["JSON Resume"] = 503,
    ["JSON Schema Draft 2020-12"] = 643,
    ["JSON Schema Draft 4"] = 640,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 807,
    ["JSON Schema Draft 7"] = 641,
    ["JSON Schema Draft 7 (unofficial strict)"] = 808,
    ["JSON Schema Draft 8 (2019-09)"] = 642,
    ["JSON-API"] = 336,
    ["JSON-e templates"] = 704,
    ["JSON-stat 2.0"] = 637,
    JSONPatch = 340,
    ["JSR Package Config (jsr.json)"] = 330,
    Jasmine = 319,
    Jekyll = 320,
    ["Jenkins X Pipelines"] = 321,
    ["Jenkins X Requirements"] = 322,
    ["Jovo Language Models"] = 328,
    ["KIMMDY config file"] = 345,
    ["KSP-AVC"] = 638,
    ["KSP-CKAN"] = 639,
    ["Karakum configuration file"] = 263,
    Kas = 343,
    ["Keycloak REST API"] = 777,
    ["Knative Functions - func.yaml"] = 264,
    ["KoDE/CI build.yaml"] = 765,
    ["Kong DBLess config"] = 766,
    KrakenD = 346,
    LOOBin = 365,
    Lefthook = 354,
    ["Liferay client-extension.yaml"] = 361,
    ["LinkML Metamodel"] = 363,
    Liquibase = 712,
    ["Liquibase Flow File"] = 713,
    ["Lively Properties"] = 364,
    ["Lobe AI Agent"] = 63,
    ["MLOS Configs"] = 399,
    ["MS2Rescore Configuration"] = 402,
    ["Madness (madness.yml)"] = 788,
    Markdownlint = 716,
    ["Mason Registry"] = 718,
    ["MegaLinter configuration"] = 371,
    ["MegaLinter descriptor"] = 372,
    Melange = 814,
    ["Meltano plugin discovery definition"] = 374,
    ["Meltano project definition"] = 373,
    ["MetricsHub Configuration"] = 375,
    ["MetricsHub Connector Configuration"] = 376,
    ["Micro Editor Syntax"] = 798,
    ["Microsoft Band Web Tile"] = 377,
    ["Minecraft Custom Main Menu Mod"] = 815,
    ["Minecraft Data Pack Advancement"] = 379,
    ["Minecraft Data Pack Biome"] = 380,
    ["Minecraft Data Pack Configured Carver"] = 381,
    ["Minecraft Data Pack Damage Type"] = 382,
    ["Minecraft Data Pack Dimension"] = 384,
    ["Minecraft Data Pack Dimension Type"] = 383,
    ["Minecraft Data Pack Item Modifier"] = 385,
    ["Minecraft Data Pack Loot Table"] = 386,
    ["Minecraft Data Pack Metadata"] = 387,
    ["Minecraft Data Pack Predicate"] = 388,
    ["Minecraft Data Pack Recipe"] = 389,
    ["Minecraft Data Pack Tag"] = 390,
    ["Minecraft Data Pack Template Pool"] = 391,
    ["Minecraft Data Pack Trim Material"] = 396,
    ["Minecraft Data Pack Trim Pattern"] = 397,
    ["Minecraft Resource Pack Lang"] = 392,
    ["Minecraft Resource Pack Particle"] = 393,
    ["Minecraft Resource Pack Texture Mcmeta"] = 395,
    ["Minecraft Resourcepack Sounds"] = 394,
    ["MkDocs Configuration 1.0"] = 398,
    ["Monade CLI Stack Configuration"] = 405,
    ["MongoDB Atlas Search Index Definition"] = 764,
    ["Monika Configuration"] = 762,
    ["Monoweave Configuration"] = 401,
    ["Motif config"] = 662,
    ["NOX Framework (Service)"] = 417,
    ["Netin Diagnostic System Template"] = 722,
    ["Netlify config"] = 408,
    ["Network-as-Code Data Model"] = 409,
    ["Nightwatch.js"] = 410,
    ["Nuitka.yaml"] = 828,
    ["ONe's changelog entry"] = 433,
    ["ONe's service descriptor"] = 432,
    ["OSS Review Toolkit configuration"] = 440,
    ["OSS Review Toolkit curation"] = 441,
    ["OSS Review Toolkit package configuration"] = 442,
    ["OSS Review Toolkit repository configuration"] = 443,
    ["OSS Review Toolkit resolutions"] = 444,
    Opctl = 665,
    ["OpenRewrite Resource"] = 435,
    ["OpenUtau character yaml"] = 429,
    ["OpenUtau ustx"] = 430,
    ["OpenWeather Current Weather API"] = 703,
    ["OpenWeather Road Risk API"] = 702,
    ["Ory Hydra configuration"] = 307,
    ["Ory Keto configuration"] = 348,
    ["Ory Kratos configuration"] = 439,
    ["Ory Oathkeeper configuration"] = 424,
    ["Outblocks App configuration"] = 437,
    ["Outblocks database table"] = 438,
    ["Outblocks project configuration"] = 436,
    PDM = 450,
    Packer = 447,
    Pantsbuild = 784,
    ["Paper paper-plugin.yml"] = 448,
    ["Pipeline component"] = 714,
    ["PocketMine plugin.yml"] = 455,
    ["Postman collection"] = 460,
    ["Problem object RFC9457"] = 812,
    ["Problem package generators"] = 467,
    Pterodactyl = 759,
    ["Pull Request Labeler"] = 482,
    Pulumi = 488,
    PyProject = 489,
    Pyright = 490,
    Qgoda = 491,
    Qodana = 732,
    ["Quali Torque Blueprint Spec 2"] = 757,
    ["QueryFirst config file"] = 780,
    ["RKE Cluster Configuration JSON"] = 711,
    ["RKE Cluster Configuration YAML"] = 710,
    ["Rancher Fleet"] = 485,
    ["Rattler-build"] = 492,
    Ray = 677,
    ["Read the Docs"] = 487,
    ["Red-DiscordBot Cog"] = 493,
    ["Red-DiscordBot Cog Repo"] = 494,
    ["Red-DiscordBot Trivia"] = 495,
    ["Render Blueprints"] = 709,
    RenderCV = 505,
    Renovate = 504,
    ["Replit config"] = 499,
    RoadRunner = 506,
    ["Rudder techniques"] = 818,
    Ruff = 501,
    ["Rust Project"] = 502,
    ["Rust toolchain"] = 509,
    ["SDMX data message"] = 534,
    ["SDMX metadata message"] = 533,
    ["SDMX structure message"] = 532,
    ["SIL Kit Participant Configuration"] = 544,
    ["SIL Kit Registry Configuration"] = 545,
    SWADL = 570,
    ["Safebox Config"] = 770,
    ["Sapphire CLI Config"] = 512,
    ["SauceCTL Configuration"] = 719,
    ["Schema Catalog"] = 526,
    ["Scoop manifest"] = 531,
    ["Semantic Data Fabric (SDF) file"] = 535,
    ["Semgrep Rule"] = 537,
    ["Serenity Code Generator (Sergen)"] = 538,
    ["Serverless Framework Configuration"] = 726,
    ["Serverless Workflow"] = 728,
    ["Settings.paf"] = 540,
    ["Shopware 6 Configuration"] = 729,
    ["Shopware CLI Extension Store Configuration"] = 730,
    ["Shopware CLI Project Store Configuration"] = 731,
    Sigma = 542,
    ["Sigrid scope configuration file"] = 543,
    ["SkyPilot Task JSON"] = 819,
    ["Slack app manifest"] = 547,
    Solidarity = 550,
    ["Solution filters"] = 551,
    ["Source Maps v3"] = 552,
    Sourcery = 553,
    SpecIF = 554,
    ["Sponge Mixin configuration"] = 555,
    StackBlitz = 560,
    ["StackHawk Scanner Configuration"] = 725,
    Stale = 561,
    ["Starlake Data Pipeline"] = 700,
    Starship = 562,
    ["Statamic Blueprint"] = 563,
    ["Stella configuration file"] = 564,
    ["StrmPrivacy Data Connector"] = 774,
    ["StrmPrivacy Data Contract"] = 775,
    ["StrmPrivacy SimpleSchema"] = 772,
    ["StrmPrivacy Stream"] = 773,
    ["StrmPrivacy batch job configuration file"] = 771,
    ["Stryker Mutator"] = 567,
    ["StyleCop Analyzers Configuration"] = 568,
    ["Stylelint (.stylelintrc)"] = 569,
    ["Sublime Syntax"] = 776,
    ["Subsquid squid manifest"] = 821,
    ["Swagger API 2.0"] = 571,
    TSON = 597,
    TSTyche = 598,
    Talhelper = 573,
    ["Talisman configuration"] = 574,
    ["Taskfile config"] = 705,
    Taurus = 575,
    ["TestEnvironment.json"] = 584,
    ["TextMate Grammar"] = 583,
    ["Tier.run pricing.json"] = 578,
    Tikibase = 579,
    ["Traefik v2"] = 587,
    ["Traefik v2 File Provider"] = 588,
    ["Travis CI (.travis.yml)"] = 586,
    TunnelHub = 811,
    Turborepo = 585,
    Tye = 733,
    ["UET BuildConfig.json"] = 781,
    ["UI5 Manifest"] = 607,
    ["UNCORS configuration"] = 611,
    ["UTAM Page Object"] = 610,
    ["Ubuntu Server Autoinstall"] = 605,
    ["Uniswap Token List"] = 688,
    ["Unreal Engine Uplugin"] = 782,
    ["Unreal Engine Uproject"] = 783,
    ["Updatecli Compose"] = 741,
    ["Updatecli Policy Manifest"] = 742,
    ["Updatecli Policy Metadata"] = 743,
    Uplift = 779,
    ["User Journey Map"] = 708,
    V2Ray = 747,
    ["VSCode Code Snippets"] = 163,
    ["VSIX CLI publishing"] = 625,
    ["Vela Pipeline Configuration"] = 614,
    Vercel = 162,
    Visivo = 809,
    ["Web App Manifest"] = 632,
    ["Web types"] = 635,
    WebExtensions = 631,
    ["Webman package recipe"] = 753,
    ["Windows Package Manager Installer Manifest"] = 685,
    ["Windows Package Manager Locale Manifest"] = 686,
    ["Windows Package Manager Singleton Manifest"] = 684,
    ["Woodpecker pipeline config"] = 721,
    ["Wrangler CLI"] = 636,
    ["Xstate Machine"] = 739,
    ["Yarn Config (.yarnrc.yml)"] = 698,
    ["Yippee-Ki-JSON configuration YML"] = 690,
    ["aerleon.yml"] = 6,
    ["angular.json"] = 14,
    apko = 813,
    ...
    ["behat.yml"] = 88,
    ["bigquery-table"] = 80,
    ["bioimageio resource description"] = 829,
    ...
    ["chisel-slices.json"] = 180,
    ["chrome-extension-locales-messages.json"] = 170,
    ["chutzpah.json"] = 171,
    cibuildwheel = 113,
    ["clang-format (.clang-format)"] = 745,
    clangd = 150,
    clib = 151,
    ["cloud-init: cloud-config userdata"] = 153,
    ["cloud-sdk-pipeline-configuration"] = 173,
    ["cloudbuild.json"] = 174,
    cloudify = 152,
    codemagic = 154,
    ["coffeelint.json"] = 182,
    ["commands.json"] = 166,
    ["commitlint (.commitlintrc)"] = 687,
    ["compile_commands.json"] = 165,
    ["compilerconfig.json"] = 164,
    ["completely.yml"] = 787,
    ["component-detection-manifest.json"] = 185,
    ["component.json"] = 184,
    ["composer.json"] = 183,
    ["conda-forge"] = 115,
    ["config.yaml"] = 486,
    ["contentmanifest.json"] = 172,
    ["contribute.json"] = 186,
    ["cosmos.config.json"] = 168,
    ["crowdin.yml"] = 187,
    ["custom-elements.json"] = 801,
    ["cypress.json"] = 191,
    ["datalogic-scan2deploy-android"] = 200,
    ["datalogic-scan2deploy-ce"] = 201,
    ["dbt Project"] = 124,
    ["ddev-global"] = 202,
    ["ddev-project"] = 203,
    ["debugsettings.json"] = 204,
    ["dependabot-v2.json"] = 207,
    ["dependabot.json"] = 206,
    ["deployed-cli"] = 738,
    ["devcontainer.json"] = 156,
    devinit = 692,
    ["devspace.yaml"] = 761,
    djlint = 693,
    ["docker sequencer"] = 212,
    ["docker-compose.yml"] = 691,
    ["dockerd.json"] = 211,
    ["dotnet Release Index manifest"] = 222,
    ["dotnet-tools.json"] = 223,
    ["dotnetcli.host.json"] = 224,
    ["dprint.json"] = 225,
    ["drone.json"] = 226,
    ["dss-2.0.0.json"] = 228,
    ["dstack configuration"] = 229,
    ["dvc.yaml"] = 230,
    ["ecosystem.json"] = 235,
    eksctl = 236,
    ["electron-builder configuration file"] = 243,
    ["epr-manifest.json"] = 241,
    ["evcc.yaml"] = 244,
    ["ezd task runner"] = 246,
    ["fabric.mod.json"] = 249,
    ["first-timers-bot"] = 255,
    ...
    ["gitlab-ci"] = 280,
    ["global.json"] = 282,
    ["go-feature-flag Flag Configuration"] = 285,
    ["haxelib.json"] = 300,
    helmfile = 680,
    helmwave = 681,
    ["host-meta.json"] = 305,
    ...
    ["ide.host.json"] = 310,
    ["ifstate.conf"] = 311,
    ["imageoptimizer.json"] = 312,
    ["importmap.json"] = 315,
    ["ioBroker Configuration"] = 316,
    ["ioBroker JSON UI"] = 317,
    ["ioBroker Package manifest"] = 318,
    ["ize.toml"] = 778,
    ["jsconfig.json"] = 341,
    ["jscpd Configuration"] = 758,
    jsdoc = 676,
    ["k3d.yaml"] = 342,
    ["k9s plugin.yml"] = 344,
    ["kontinuous-config.yaml"] = 350,
    ["kontinuous-values.yaml"] = 349,
    ["kustomization.yaml"] = 351,
    ["label-commenter-config.yml"] = 352,
    ["latexindent configuration"] = 62,
    ["launchsettings.json"] = 353,
    lazydocker = 800,
    lazygit = 799,
    ["lego.json"] = 355,
    ["lerna.json"] = 356,
    ["lgtm.yml"] = 357,
    ["liblab.config.json"] = 358,
    ["libman.json"] = 359,
    ["license-report-config.json"] = 360,
    ["linkinator.config.json"] = 362,
    ["lint-staged (.lintstagedrc)"] = 656,
    ["local.settings.json"] = 367,
    ["localazy.json"] = 368,
    ["lotus.yaml"] = 366,
    ["lsdlschema.json"] = 369,
    ...
    ["mtad.yaml"] = 661,
    ["mycode.json"] = 406,
    ["napari plugin manifest"] = 407,
    neoload = 671,
    ["nest-cli"] = 413,
    ["ninjs (News in JSON) 1.3"] = 412,
    ["ninjs (News in JSON) 2.0"] = 411,
    ["nixd configuration"] = 817,
    ["nlu.json"] = 414,
    ["nodemon.json"] = 416,
    ["noodl config"] = 723,
    now = 667,
    ...
    ["nswag.json"] = 422,
    ntangle = 423,
    ["nuclei-template.yaml"] = 420,
    ["nuget-project.json"] = 421,
    ["ocelot.json"] = 425,
    ["omnisharp.json"] = 426,
    ["openapi.json"] = 427,
    ["openfin.json"] = 434,
    ...
    ["ops.yaml"] = 431,
    ["package.json"] = 445,
    ["package.manifest"] = 446,
    ["partial-black.json"] = 89,
    ["pathfinder.yml"] = 449,
    ["pattern.json"] = 452,
    ["petstore-v1.0"] = 768,
    pgap_yaml_input_reader = 451,
    ["pixi.toml"] = 453,
    ["plagiarize-me.yaml"] = 457,
    ["plagiarize.yaml"] = 456,
    ["portman.json"] = 458,
    ["prettierrc.json"] = 465,
    ["prisma.yml"] = 466,
    ["project-1.0.0-beta3.json"] = 469,
    ["project-1.0.0-beta4.json"] = 470,
    ["project-1.0.0-beta5.json"] = 471,
    ["project-1.0.0-beta6.json"] = 472,
    ["project-1.0.0-beta8.json"] = 473,
    ["project-1.0.0-rc1.json"] = 474,
    ["project-1.0.0-rc2.json"] = 475,
    ["project.json"] = 468,
    ["prometheus.json"] = 476,
    ["prometheus.rules.json"] = 477,
    ["prometheus.rules.test.json"] = 478,
    ["proxies.json"] = 479,
    ["publiccode.yml"] = 480,
    ["pubspec.yaml"] = 481,
    ["pyrseas-0.8.json"] = 484,
    ["quilt.mod.json"] = 794,
    ["release drafter"] = 672,
    ["release-plz.toml"] = 497,
    ["rivet.yaml"] = 816,
    rockcraft = 507,
    rustfmt = 508,
    samt = 510,
    samtrc = 511,
    ["sarif-1.0.0.json"] = 513,
    ["sarif-2.0.0.json"] = 514,
    ["sarif-2.1.0"] = 524,
    ["sarif-2.1.0-rtm.2"] = 515,
    ["sarif-2.1.0-rtm.3"] = 517,
    ["sarif-2.1.0-rtm.4"] = 519,
    ["sarif-2.1.0-rtm.5"] = 521,
    ["sarif-2.1.0-rtm.6"] = 522,
    ["sarif-external-property-file-2.1.0"] = 525,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 516,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 518,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 520,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 523,
    ["schema.org - Action"] = 527,
    ["schema.org - ContactPoint"] = 528,
    ["schema.org - Place"] = 529,
    ["schema.org - Thing"] = 530,
    ["secrethub.yml"] = 796,
    ["semantic-release"] = 536,
    ["servicehub.config.json"] = 646,
    ["servicehub.service.json"] = 645,
    ["settings.job"] = 539,
    ["sfdx-hardis configuration"] = 541,
    ["size-limit configuration"] = 546,
    ["skaffold.yaml"] = 715,
    ["skyuxconfig.json"] = 548,
    snapcraft = 549,
    ["sqlc configuration"] = 557,
    ["stripe-app-local.json"] = 566,
    ["stripe-app.json"] = 565,
    swcrc = 701,
    ["task.json"] = 572,
    taskcat = 668,
    ["template.json"] = 576,
    ["templatsources.json"] = 577,
    ["theme.json"] = 580,
    ["tizen_workspace.json"] = 581,
    tldr = 582,
    tmuxinator = 654,
    ["transcend.yml"] = 589,
    ["tree-sitter grammar.json"] = 290,
    ["trime.yaml"] = 590,
    ["trunk.yaml"] = 591,
    ["ts-force-config.json"] = 595,
    ["tsconfig.json"] = 592,
    ["tsd.json"] = 593,
    ["tsdrc.json"] = 594,
    ["tslint.json"] = 596,
    ...
    ["typingsrc.json"] = 604,
    ["typo3.json"] = 602,
    ["ui5-workspace.yaml"] = 609,
    ["ui5.yaml"] = 608,
    unist = 734,
    ["up.json"] = 606,
    v8r = 629,
    ["vcpkg configuration file"] = 161,
    ["vcpkg manifest file"] = 160,
    ["vega-lite.json"] = 613,
    ["vega.json"] = 612,
    ["venvironment-basic.yaml"] = 616,
    ["venvironment.yaml"] = 615,
    ["version.json"] = 617,
    ["vim-addon-info"] = 619,
    ["vs-2017.3.host.json"] = 621,
    ["vs-nesting.json"] = 622,
    ["vsls.json"] = 620,
    ["vss-extension.json"] = 626,
    ["vtesttree.yaml"] = 627,
    ["vtestunit.yaml"] = 628,
    ["warp-keysets.json"] = 802,
    ["warp-themes.json"] = 803,
    ["warp-workflows.json"] = 804,
    ["webhint.io"] = 754,
    ["webjobpublishsettings.json"] = 634,
    ["webjobs-list.json"] = 633,
    ["xs-app.json"] = 664,
    ["xunit.runner.json"] = 644,
    yamllint = 689,
    zuul = 673,
    ["Žinoma"] = 683
  },
