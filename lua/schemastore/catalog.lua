...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 153,
    [".cryproj (generic)"] = 514,
    [".cryproj engine-5.2"] = 509,
    [".cryproj engine-5.3"] = 510,
    [".cryproj engine-5.4"] = 511,
    [".cryproj engine-5.5"] = 512,
    [".cryproj engine-dev"] = 513,
    [".csscomb.json"] = 155,
    [".csslintrc"] = 156,
    [".eslintrc"] = 201,
    [".esmrc.json"] = 193,
    ...
    ["Better Code Hub"] = 557,
    ["Better Scripts"] = 84,
    BizTalkServerApplicationSchema = 529,
    ...
    ["Butane Config"] = 595,
    ["CICS TS region tagging"] = 602,
    ["CICS TS resource import"] = 603,
    ["CICS TS resource model"] = 604,
    ["CICS TS resource overrides"] = 605,
    ["CMake Presets"] = 85,
    ...
    ["Datahub Ingestion Recipe Schema"] = 609,
    ...
    ["Embrace Config Schema"] = 620,
    ["Error pages"] = 196,
    Esquio = 194,
    ["Estuary Flow Catalog Schema"] = 599,
    ["Expo SDK"] = 199,
    ...
    Goreleaser = 227,
    ["Goreleaser Pro"] = 228,
    ["Gradle Build Cache Node"] = 554,
    ["Gradle Enterprise"] = 553,
    ...
    Hadolint = 538,
    Hammerkit = 564,
    ["Hardware Sentry Configuration"] = 613,
    Hayson = 240,
    ...
    ["JFrog File Spec"] = 260,
    ["JFrog Pipelines YML DSL"] = 622,
    ["JMeter DSL cli config schema"] = 261,
    ["JSON Document Transform"] = 269,
    ["JSON Feed"] = 270,
    ["JSON Resume"] = 394,
    ["JSON Schema Draft 2020-12"] = 505,
    ["JSON Schema Draft 4"] = 502,
    ["JSON Schema Draft 7"] = 503,
    ["JSON Schema Draft 8"] = 504,
    ...
    ["KSP-AVC"] = 500,
    ["KSP-CKAN"] = 501,
    ["Keycloak REST API"] = 628,
    ["Knative Functions - func.yaml"] = 211,
    ["KoDE/CI build.yaml"] = 618,
    ["Kong DBLess Schema"] = 619,
    KrakenD = 275,
    ["LinkML Metamodel"] = 288,
    Liquibase = 569,
    ["Liquibase Flow File"] = 570,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 617,
    ["Monika Configuration Schema"] = 615,
    ["Motif config"] = 522,
    ["NOX Framework (Service)"] = 327,
    ["Netin Diagnostic System Template"] = 578,
    ...
    ["OpenWeather Current Weather API"] = 561,
    ["OpenWeather Road Risk API"] = 560,
    ...
    PyProject = 385,
    Qodana = 588,
    ["Quali Torque Blueprint Spec 2"] = 610,
    ["QueryFirst config file"] = 631,
    ["RKE Cluster Configuration JSON Schema"] = 568,
    ["RKE Cluster Configuration YAML Schema"] = 567,
    ["Rancher Fleet"] = 382,
    Ray = 537,
    ["Read the Docs"] = 383,
    ...
    ["SauceCTL Configuration"] = 575,
    ["Schema Catalog"] = 412,
    ["Scoop manifest"] = 417,
    ["Semgrep Rule"] = 419,
    ["Serenity Code Generator (Sergen)"] = 420,
    ["Serverless Framework Configuration"] = 582,
    ["Serverless Workflow Schema"] = 584,
    ["Settings.paf"] = 422,
    ["Shopware 6 Configuration"] = 585,
    ["Shopware CLI Extension Store Configuration"] = 586,
    ["Shopware CLI Project Store Configuration"] = 587,
    Solidarity = 428,
    ...
    ["StackHawk Scanner Configuration"] = 581,
    Stale = 437,
    Starship = 438,
    ["Statamic Blueprint"] = 439,
    ["StrmPrivacy Data Connector"] = 626,
    ["StrmPrivacy Data Contract"] = 627,
    ["StrmPrivacy SimpleSchema"] = 624,
    ["StrmPrivacy Stream"] = 625,
    ["StrmPrivacy batch job configuration file"] = 623,
    ["Stryker Mutator"] = 442,
    ["StyleCop Analyzers Configuration"] = 443,
    ["Swagger API 2.0"] = 446,
    TSON = 467,
    ["Talisman configuration"] = 447,
    ["Taskfile YAML Schema"] = 563,
    Taurus = 448,
    ...
    Tye = 589,
    ["UI5 Manifest"] = 474,
    ["UTAM Page Object"] = 477,
    ["Ubuntu Server Autoinstall"] = 472,
    ["Uniswap Token List"] = 546,
    ["Unreal Engine Uplugin"] = 632,
    ["Unreal Engine Uproject"] = 633,
    Updatecli = 596,
    Uplift = 630,
    ["User Journey Map YAML Schema"] = 566,
    V2Ray = 600,
    ["VSCode Code Snippets"] = 129,
    ["VSIX CLI publishing"] = 490,
    ["Vela Pipeline Configuration"] = 480,
    Vercel = 128,
    ["Web App Manifest"] = 495,
    ["Web types"] = 498,
    WebExtensions = 494,
    ["Webman package recipe"] = 606,
    ["Windows Package Manager Installer Manifest"] = 543,
    ["Windows Package Manager Locale Manifest"] = 544,
    ["Windows Package Manager Singleton Manifest"] = 542,
    ["Woodpecker pipeline config"] = 577,
    ["Xstate Machine Schema"] = 594,
    ["Yippee-Ki-JSON configuration YML"] = 548,
    ["angular.json"] = 11,
    ...
    ["ize.toml"] = 629,
    ["jsconfig.json"] = 273,
    ["jscpd Configuration Schema"] = 611,
    jsdoc = 536,
    ["k3d.yaml"] = 274,
    ...
    ["servicehub.config.json"] = 508,
    ["servicehub.service.json"] = 507,
    ["settings.job"] = 421,
    ...
    tmLanguage = 455,
    tmuxinator = 516,
    ["trunk.yaml schema"] = 461,
    ["ts-force-config.json"] = 465,
    ["tsconfig.json"] = 462,
    ["tsd.json"] = 463,
    ["tsdrc.json"] = 464,
    ["tslint.json"] = 466,
    ...
    ["vega-lite.json"] = 479,
    ["vega.json"] = 478,
    ["venvironment-basic.yaml"] = 482,
    ["venvironment.yaml"] = 481,
    ["version.json"] = 483,
    ["vim-addon-info"] = 484,
    ["vs-2017.3.host.json"] = 486,
    ["vs-nesting.json"] = 487,
    ["vsls.json"] = 485,
    ["vss-extension.json"] = 491,
    ["webhint.io"] = 607,
    ["webjobpublishsettings.json"] = 497,
    ["webjobs-list.json"] = 496,
    ["xs-app.json"] = 524,
    ["xunit.runner.json"] = 506,
    yamllint = 547,
    zuul = 533,
    ["Žinoma"] = 541
  },
