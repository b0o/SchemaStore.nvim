...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1002,
    [".nodehawkrc"] = 634,
    [".npmpackagejsonlintrc"] = 638,
    [".omletrc"] = 1183,
    [".phrase.yml"] = 716,
    [".phraseapp.yml"] = 717,
    [".pmbot.yml"] = 701,
    [".postcssrc"] = 710,
    [".powerpages-web-template-manifest"] = 712,
    [".pre-commit-config.yml"] = 713,
    [".pre-commit-hooks.yml"] = 714,
    [".putout.json"] = 750,
    [".rehyperc"] = 775,
    [".remarkrc"] = 779,
    [".sprite files"] = 875,
    ...
    AIConfig = 39,
    ["AMX Muse Program Descriptor"] = 1232,
    ["API Builder"] = 1038,
    ["AVA Configuration"] = 1102,
    ...
    ["AWS Copilot Manifest"] = 1271,
    ["AWS SAM CLI Samconfig"] = 282,
    Acton = 1322,
    ["Adobe UXP Manifest"] = 1165,
    ["Aerleon Network & Service Definitions"] = 24,
    ["Aerleon Policy"] = 25,
    ["Agent Permission Policy"] = 1311,
    ["AgentCore CLI"] = 1312,
    AgentLoopKit = 1313,
    Aider = 1261,
    Air = 27,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1282,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1281,
    ["Airlock Microgateway"] = 40,
    ["Alacritty Configuration"] = 1074,
    ["AlgoVoi Compliance Receipt v1"] = 14,
    ["All Contributors configuration file"] = 1128,
    Anodizer = 459,
    ...
    ["Application list for a WinUtil"] = 1211,
    ArchitectFX = 1216,
    ["Argo CD"] = 59,
    ["Argo Events"] = 60,
    ["Argo Workflows"] = 61,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1280,
    ["Azure IoT Operations connector metadata"] = 1277,
    ...
    ["Azure Pipelines"] = 119,
    ["Azure Static Web Apps CLI configuration file"] = 879,
    ["Azure Static Web Apps configuration file"] = 878,
    BMML = 1299,
    ["BOSH BPM Config"] = 145,
    ["BOSH CPI Config"] = 146,
    ...
    ["Bacon config"] = 8,
    ["Barba-CV"] = 88,
    ["Bashly (bashly.yml)"] = 1132,
    ["Bashly Settings (bashly-settings.yml)"] = 1133,
    Bento = 1298,
    ["Better Code Hub"] = 1043,
    ["Better Scripts"] = 169,
    Bigconfig = 138,
    ["Biome Formatter Config"] = 89,
    ["Bitmovin Encoding Template"] = 1225,
    BizTalkServerApplicationSchema = 1009,
    Bleep = 170,
    ["Block Protocol Metadata"] = 167,
    ["Bluebricks blueprint config"] = 1304,
    ["Boyka Framework"] = 148,
    ...
    ["Butane Config"] = 1087,
    C4InterFlow = 1240,
    ["CDK Environment Manager, concrete environment configuration"] = 1264,
    ["CDK Environment Manager, concrete environments definition"] = 1263,
    ["CDK Environment Manager, environment definition"] = 1262,
    ["CGS Card Game Specification (cgs.json)"] = 1170,
    ["CICS TS region tagging"] = 1096,
    ["CICS TS resource import"] = 1097,
    ["CICS TS resource model"] = 1098,
    ["CICS TS resource overrides"] = 1099,
    ["CMake Presets"] = 171,
    ["CNC Codes"] = 193,
    ["CRS WAF test file"] = 1200,
    ["CRS WAF test platform overrides file"] = 1201,
    ...
    ["Caido Proxy Configuration"] = 1336,
    ...
    ["Chamaleon environment"] = 1229,
    ["Chamaleon properties"] = 1230,
    ["Chamaleon template"] = 1228,
    Changepacks = 1291,
    Changesets = 291,
    Changie = 180,
    Charmcraft = 181,
    ...
    ["Clawject config"] = 199,
    ["Cloud Foundry Application Manifest"] = 1182,
    ["Cloud Run Spec v1"] = 1206,
    ...
    Concord = 1199,
    ["Configu .cfgu files"] = 1187,
    ["Configu .configu file"] = 1188,
    Conjure = 192,
    ["Container Structure Test"] = 1023,
    Containerlab = 1052,
    ["Contextive Glossary"] = 1256,
    ContractGuard = 1053,
    Convex = 191,
    ...
    ["Cursor Agent Environment"] = 1309,
    ["Custom Machinery Machine"] = 1171,
    ["Custom Machinery Recipe"] = 1172,
    ...
    ["DonateCaseBetterCasino menu"] = 1233,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1140,
    ["EAS config"] = 391,
    ["ECA - Editor Code Assistant"] = 355,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1129,
    ["ESLint Suppressions"] = 396,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1276,
    ["EasyVCR .NET"] = 393,
    ["Eidolon Resource"] = 1217,
    ...
    ["Envelope Team Definition"] = 1321,
    ["Envilder Map File"] = 359,
    ["Erda Pipeline"] = 1178,
    ["Erda Runtime"] = 1179,
    ["Espanso config.yml"] = 1302,
    ["Espanso match.yml"] = 1301,
    Esquio = 379,
    ["Estuary Flow Catalog"] = 1093,
    ["Ethereum ERC1155"] = 1315,
    ["Ethereum ERC721"] = 1314,
    ...
    ["Evolving Resolutive Process notation"] = 1278,
    ["Expo SDK"] = 390,
    ...
    ["GeoJSON.json latest"] = 1091,
    GherKing = 1095,
    ["GitHub Action"] = 428,
    ["GitHub Actions typing"] = 1213,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 1167,
    GitVersion = 425,
    ...
    ["Google Digital Assetlinks"] = 1257,
    Goreleaser = 457,
    ["Goreleaser Pro"] = 458,
    Goss = 460,
    ["Gradle Build Cache Node"] = 1041,
    ["Gradle Enterprise"] = 1040,
    ...
    Hadolint = 1019,
    Hammerkit = 1051,
    ["Hardware Sentry Configuration"] = 1107,
    ...
    ["JFrog File Spec"] = 514,
    ["JFrog Pipelines YML DSL"] = 1117,
    ["JMeter DSL cli config"] = 515,
    JReleaser = 518,
    ["JSON Document Transform"] = 526,
    ["JSON Feed"] = 527,
    ["JSON Resume"] = 787,
    ["JSON Schema Draft 2020-12"] = 987,
    ["JSON Schema Draft 4"] = 984,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1150,
    ["JSON Schema Draft 7"] = 985,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1151,
    ["JSON Schema Draft 8 (2019-09)"] = 986,
    ["JSON-API"] = 525,
    ["JSON-e templates"] = 1048,
    ["JSON-stat 2.0"] = 980,
    JSONPatch = 529,
    ...
    ["Jujutsu (jj) VCS config"] = 1270,
    ["KIMMDY config file"] = 540,
    ["KODE/CI build.yaml"] = 1113,
    ["KSP-AVC"] = 981,
    ["KSP-CKAN"] = 982,
    ["KSP-NetKAN"] = 983,
    KSY = 1180,
    ...
    ["Metadata for a Cinnamon spice"] = 1209,
    ["Metatype Configuration"] = 582,
    ["MetricsHub Configuration"] = 583,
    ["MetricsHub Connector Configuration"] = 584,
    ["Micro Editor Syntax"] = 1141,
    ["Microsoft Band Web Tile"] = 585,
    ["Microsoft RulesEngine workflow rules"] = 1196,
    ["Microsoft RulesEngine workflow rules list"] = 1197,
    ["Minecraft Custom Main Menu Mod"] = 1159,
    ...
    ["MongoDB Atlas Search Index Definition"] = 1112,
    ["Monika Configuration"] = 1110,
    ["Monoweave Configuration"] = 614,
    ["Motif config"] = 1001,
    MultiQC = 1250,
    ["NOX Framework (Service)"] = 637,
    ["Netin Diagnostic System Template"] = 1069,
    ["Netlify config"] = 622,
    ...
    ["Nightwatch.js"] = 630,
    ["Node.js configuration"] = 1006,
    ["NueJS configuration file"] = 642,
    ["Nuitka Package Config"] = 1173,
    ["Nullstone config"] = 644,
    ["ONe's changelog entry"] = 663,
    ["ONe's service descriptor"] = 662,
    ["ORT Server repository environment configuration"] = 673,
    ["OSCAL Assessment Plan (AP)"] = 675,
    ["OSCAL Assessment Results (AR)"] = 676,
    ["OSCAL Catalog"] = 677,
    ["OSCAL Component Definition (CDef)"] = 678,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 679,
    ["OSCAL Profile"] = 680,
    ["OSCAL System Security Plan (SSP)"] = 681,
    ["OSS Review Toolkit configuration"] = 682,
    ["OSS Review Toolkit curation"] = 683,
    ["OSS Review Toolkit package configuration"] = 684,
    ["OSS Review Toolkit project package manager definition"] = 685,
    ["OSS Review Toolkit repository configuration"] = 686,
    ["OSS Review Toolkit resolutions"] = 687,
    ["October CMS columns"] = 648,
    ["October CMS fields"] = 649,
    ["Oh My Posh"] = 651,
    Okteto = 652,
    ["Ona Automations"] = 654,
    Opctl = 1004,
    ["Open Data Contract Standard (ODCS)"] = 667,
    ["Open Data Product Standard (ODPS)"] = 668,
    ["Open Know-How"] = 1255,
    OpenDecree = 1319,
    ["OpenDecree Configuration"] = 1320,
    ["OpenRewrite Resource"] = 665,
    OpenSRM = 669,
    OpenStatus = 1266,
    ["OpenTelemetry Declarative Configuration"] = 666,
    ["OpenUtau character yaml"] = 659,
    ["OpenUtau ustx"] = 660,
    ["OpenWeather Current Weather API"] = 1047,
    ["OpenWeather Road Risk API"] = 1046,
    ["Ory Hydra configuration"] = 485,
    ["Ory Keto configuration"] = 548,
    ["Ory Kratos configuration"] = 674,
    ["Ory Oathkeeper configuration"] = 646,
    ["Outblocks App configuration"] = 671,
    ["Outblocks database table"] = 672,
    ["Outblocks project configuration"] = 670,
    PDM = 695,
    POPxf = 707,
    ["POPxf Correlations"] = 708,
    ["PRML manifest"] = 715,
    Packer = 691,
    PactSpec = 692,
    Panache = 693,
    Pantsbuild = 1127,
    ["Paper paper-plugin.yml"] = 694,
    ["Pipeline component"] = 1060,
    ["Platform.sh application"] = 10,
    ["Platform.sh routes"] = 11,
    ["Platform.sh services"] = 12,
    ["Plex Prerolls"] = 705,
    ["PocketMine plugin.yml"] = 702,
    ["Podman Desktop Extension"] = 1338,
    ["Postman collection"] = 711,
    ["Power Pages Configuration"] = 1267,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1212,
    ["ProActions AI-Kit Configuration"] = 723,
    ["ProActions AI-Kit Configuration for Menus"] = 725,
    ["ProActions AI-Kit Configuration for Sections"] = 727,
    ["ProActions AI-Kit Configuration for Services"] = 724,
    ["ProActions AI-Kit Configuration for Steps"] = 728,
    ["ProActions AI-Kit Configuration for Templates"] = 726,
    ["Problem object RFC9457"] = 1156,
    ["Problem package format"] = 729,
    ["Problem package generators"] = 730,
    ["Problem package submissions"] = 731,
    ["Problem package test group metadata"] = 732,
    Pterodactyl = 1106,
    ["Pull Request Labeler"] = 749,
    Pulumi = 757,
    ["PyGTA Config"] = 753,
    PyProject = 758,
    Pylock = 1258,
    Pyright = 759,
    ["Python script metadata"] = 1252,
    ["QType AI DSL"] = 762,
    Qgoda = 761,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1330,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1328,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1334,
    ["Qlik Talend Cloud Pipeline - Project"] = 1326,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1329,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1331,
    ["Qlik Talend Cloud Pipeline - Task"] = 1327,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1333,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1332,
    Qodana = 1079,
    ["Qt Creator workspace file"] = 1189,
    ["Quali Torque Blueprint Spec 2"] = 1104,
    ["QueryFirst config file"] = 1123,
    ["QuikRun Configuration"] = 1335,
    ["Qwen Code Settings"] = 1316,
    ["RKE Cluster Configuration JSON"] = 1057,
    ["RKE Cluster Configuration YAML"] = 1056,
    RadioHound = 752,
    ["Raid Profile"] = 1317,
    ["Raid Repo Configuration"] = 1318,
    Railpack = 764,
    Railway = 763,
    ["Rancher Fleet"] = 754,
    ["Rattler-build"] = 765,
    Ray = 1018,
    ["Read the Docs"] = 756,
    ["Red-DiscordBot Cog"] = 772,
    ["Red-DiscordBot Cog Repo"] = 773,
    ["Red-DiscordBot Trivia"] = 774,
    ["Releasaurus Config"] = 7,
    ReleaseKit = 6,
    ["Render Blueprints"] = 1055,
    RenderCV = 791,
    Renovate = 788,
    ["Renovate global configuration"] = 789,
    ["Renovate inherited configuration"] = 790,
    ["Replit config"] = 780,
    Restate = 1245,
    ["Revel Digital Gadget Definition File"] = 1269,
    RoadRunner = 793,
    ["Robust Station Image"] = 1275,
    Rockcraft = 794,
    ["Roo Coder Custom Modes"] = 795,
    Rubocop = 784,
    ["Rudder techniques"] = 1163,
    Ruff = 785,
    ["Rust Project"] = 786,
    ["Rust toolchain"] = 800,
    ["SDMX data message"] = 827,
    ["SDMX metadata message"] = 826,
    ["SDMX structure message"] = 825,
    ["SIL Kit Participant Configuration"] = 837,
    ["SIL Kit Registry Configuration"] = 838,
    ["SPDX 2.3"] = 876,
    SWADL = 892,
    ["Safebox Config"] = 1118,
    ["Sapphire CLI Config"] = 803,
    ["SauceCTL Configuration"] = 1066,
    Scarb = 823,
    ["Schema Catalog"] = 818,
    ["Scoop manifest"] = 824,
    ["Semantic Data Fabric (SDF) file"] = 828,
    ["Semgrep Rule"] = 830,
    ["Serenity Code Generator (Sergen)"] = 831,
    ["Serverless Framework Configuration"] = 1073,
    ["Serverless Workflow"] = 1075,
    ["Settings for a Cinnamon spice"] = 1208,
    ["Settings.paf"] = 833,
    ["Shopware 6 Configuration"] = 1076,
    ["Shopware CLI Extension Store Configuration"] = 1077,
    ["Shopware CLI Project Store Configuration"] = 1078,
    ["Sigma Detection Rule"] = 835,
    ["SigmaCV CV"] = 2,
    ...
    Solidarity = 846,
    ["Solution filters"] = 847,
    ["Source Maps v3"] = 848,
    Sourcery = 849,
    ["Spack bootstrap.yaml"] = 850,
    ["Spack cdash.yaml"] = 851,
    ["Spack ci.yaml"] = 852,
    ["Spack compilers.yaml"] = 853,
    ["Spack concretizer.yaml"] = 854,
    ["Spack config.yaml"] = 855,
    ["Spack definitions.yaml"] = 856,
    ["Spack develop.yaml"] = 857,
    ["Spack env_vars.yaml"] = 858,
    ["Spack environment"] = 864,
    ["Spack include.yaml"] = 859,
    ["Spack mirrors.yaml"] = 860,
    ["Spack modules.yaml"] = 861,
    ["Spack packages.yaml"] = 862,
    ["Spack repos.yaml"] = 863,
    ["Spack toolchains.yaml"] = 865,
    ["Spack upstreams.yaml"] = 866,
    ["Spack view.yaml"] = 867,
    ["Speakeasy Generation Config File"] = 871,
    ["Speakeasy Lint Configuration File"] = 868,
    ["Speakeasy Test Generation Configuration File"] = 869,
    ["Speakeasy Workflow File"] = 870,
    SpecIF = 872,
    ["Specmatic Configuration"] = 873,
    ["Sponge Mixin configuration"] = 874,
    StackBlitz = 880,
    ["StackHawk Scanner Configuration"] = 1072,
    Stale = 881,
    Starfish = 882,
    ["Starlake Data Pipeline"] = 1044,
    Starship = 883,
    ["Statamic Blueprint"] = 884,
    ["Stella configuration file"] = 885,
    ["Streamlit configuration file"] = 886,
    ["Stryker Mutator"] = 889,
    ["StyleCop Analyzers Configuration"] = 890,
    ["Stylelint (.stylelintrc)"] = 891,
    ["Stylua Config"] = 1259,
    ["Sublime Syntax"] = 1119,
    ["Subsquid squid manifest"] = 1166,
    ["Swagger API 2.0"] = 893,
    ["Synadia Connect Component"] = 894,
    TSON = 930,
    TSTyche = 931,
    ["TYPO3 Vendor Bundler config"] = 937,
    ["Tab data for a LinUtil"] = 1215,
    ["Tab list for a LinUtil"] = 1214,
    Tach = 895,
    ["Tach Domain"] = 896,
    Talhelper = 898,
    ["Talisman configuration"] = 899,
    Taplo = 1260,
    ["Taskfile config"] = 1049,
    Taurus = 900,
    Tauticord = 901,
    ["Tekton Pipeline"] = 1288,
    ["Tekton PipelineRun"] = 1289,
    ["Tekton Task"] = 1286,
    ["Tekton TaskRun"] = 1287,
    Telefonistka = 1246,
    ["Terrateam config"] = 1272,
    ["TestEnvironment.json"] = 913,
    ["TextMate Grammar"] = 912,
    Threagile = 907,
    ["Tier.run pricing.json"] = 904,
    Tikibase = 905,
    Tombi = 910,
    ["Traefik v2"] = 916,
    ["Traefik v2 File Provider"] = 917,
    ["Traefik v3"] = 918,
    ["Traefik v3 File Provider"] = 919,
    ["Travis CI (.travis.yml)"] = 915,
    Treefmt = 463,
    Trident = 1242,
    ["TrueScript for *.tscript files"] = 922,
    ["Tugboat QA config.yml"] = 1239,
    TunnelHub = 1154,
    Turborepo = 914,
    Tycho = 1203,
    Tye = 1080,
    ["Tyk Gateway - Open Source v5.7+"] = 1251,
    ["UET BuildConfig.json"] = 1124,
    ["UI5 Manifest"] = 943,
    ["UNCORS configuration"] = 948,
    ["UTAM Page Object"] = 946,
    ["Ubuntu Server Autoinstall"] = 941,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1243,
    ["Uniswap Token List"] = 1029,
    ["Universal Schedule Format"] = 949,
    ["Unreal Engine Uplugin"] = 1125,
    ["Unreal Engine Uproject"] = 1126,
    ["UpCloud CLI (upctl) configuration"] = 1244,
    ["Updatecli Compose"] = 1088,
    ["Updatecli Policy Manifest"] = 1089,
    ["Updatecli Policy Metadata"] = 1090,
    Uplift = 1122,
    ["Upsun config"] = 9,
    ["User Journey Map"] = 1054,
    V2Ray = 1094,
    ["VSCode Code Snippets"] = 266,
    ["VSIX CLI publishing"] = 967,
    Vector = 951,
    ["Vela Pipeline Configuration"] = 954,
    Vercel = 265,
    ["Version Bumper config"] = 957,
    Vespertide = 1293,
    ["Vespertide Migration"] = 1294,
    ["Vespertide Model"] = 1295,
    ["Viash Component Config"] = 1248,
    ["Viash Package Config"] = 1249,
    Visivo = 1152,
    ["WP-CLI"] = 977,
    Wake = 1241,
    ["Waku Config"] = 1218,
    ["Web App Manifest"] = 973,
    ["Web types"] = 976,
    WebExtensions = 972,
    ["Webman package recipe"] = 1100,
    ["Windows Package Manager Installer Manifest"] = 1026,
    ["Windows Package Manager Locale Manifest"] = 1027,
    ["Windows Package Manager Singleton Manifest"] = 1025,
    ["WireMock CLI import configuration"] = 1224,
    ["WireMock CLI local service configuration"] = 1223,
    ["WireMock message stub mapping"] = 1222,
    ["WireMock stub mapping"] = 1221,
    ["Woodpecker pipeline config"] = 1068,
    ["Wrangler CLI"] = 978,
    ["XenForo add-on manifest"] = 979,
    ["Xstate Machine"] = 1086,
    ["Yandex Workflow Language"] = 1210,
    ["Yarn Config (.yarnrc.yml)"] = 1042,
    ["Yippee-Ki-JSON configuration YML"] = 1033,
    ["YouTrack App"] = 1207,
    ["Zarf Package Configuration"] = 1274,
    ["Zerops import file"] = 1195,
    ["Zola Configuration"] = 1285,
    actionlint = 38,
    ["aerleon.yml"] = 23,
    ["amplify.yml"] = 16,
    ["amxx-builder manifest"] = 1337,
    ["angular.json"] = 41,
    apko = 1157,
    ...
    ["behat.yml"] = 149,
    ["bigquery-table"] = 137,
    ["bioimageio resource description"] = 1174,
    ...
    ["chutzpah.json"] = 274,
    cibuildwheel = 186,
    ["clang-format (.clang-format)"] = 1092,
    ["clang-tidy"] = 249,
    clangd = 248,
    clib = 250,
    ...
    ["crowdin.yml"] = 301,
    ["ctfd-setup configuration file"] = 1231,
    ["custom-elements.json"] = 1144,
    ["cypress.json"] = 305,
    ["dacier.yml"] = 1325,
    ...
    ["gematik health care insurance list"] = 1237,
    ["gematik health care patient list"] = 1234,
    ["gematik health care provider institution list"] = 1236,
    ["gematik health care provider list"] = 1235,
    ["gematik tiger test environment configuration"] = 1238,
    ["git-town.toml"] = 1283,
    ["gitlab-ci"] = 437,
    ["global.json"] = 453,
    ...
    ["lint-staged (.lintstagedrc)"] = 995,
    ["local.settings.json"] = 569,
    ["localazy.json"] = 570,
    ["lotus.yaml"] = 568,
    ["lsdlschema.json"] = 571,
    ["macro.json"] = 1109,
    ["markdown-link-check"] = 1063,
    maturin = 1064,
    mboats = 1071,
    memnex = 1323,
    ["micro-settings.json"] = 1136,
    ["mimetypes.json"] = 586,
    ["mirrord config"] = 997,
    mise = 998,
    ["mkdocs.yml"] = 606,
    ...
    ["monospace.yml"] = 613,
    ["moon.yml"] = 1220,
    ["mprocs Configuration file"] = 1190,
    ["mrdocs.yml"] = 608,
    ["mta.yaml"] = 999,
    ["mtad.yaml"] = 1000,
    ["mycode.json"] = 620,
    ...
    ["nest-cli"] = 632,
    ["nexus-rpc-gen"] = 1310,
    ["ninjs (News in JSON)"] = 631,
    ["nitro.json"] = 1011,
    ["nixd configuration"] = 1162,
    ["nlu.json"] = 633,
    ["nodemon.json"] = 635,
    ["noodl config"] = 1070,
    ["notebook.mod.json"] = 636,
    now = 1007,
    ["npm-badges"] = 639,
    ["nswag.json"] = 643,
    ntangle = 645,
    ["nuclei-template.yaml"] = 640,
    ["nuget-project.json"] = 641,
    ["ocelot.json"] = 647,
    ogen = 650,
    ["omnisharp.json"] = 653,
    openHAB = 1296,
    ...
    oxlint = 1307,
    ["package.json"] = 688,
    ["package.manifest"] = 690,
    ["package.yaml"] = 689,
    ["partial-black.json"] = 150,
    ["partial-fastapi.json"] = 151,
    ["partial-pixi.json"] = 700,
    ["partial-scheduled.json"] = 152,
    ["pattern.json"] = 698,
    ["petstore-v1.0"] = 1116,
    pgap_yaml_input_reader = 696,
    pgrls = 697,
    pgxgen = 1300,
    pitcms = 1303,
    ["pixi.toml"] = 699,
    ["plagiarize-me.yaml"] = 704,
    ["plagiarize.yaml"] = 703,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1227,
    ["podbard.yaml"] = 706,
    ["portman.json"] = 709,
    ["prefect.toml"] = 718,
    ["prefect.yaml"] = 719,
    ...
    ["prettierrc.json"] = 721,
    ["prisma.yml"] = 722,
    ["project-1.0.0-beta3.json"] = 734,
    ["project-1.0.0-beta4.json"] = 735,
    ["project-1.0.0-beta5.json"] = 736,
    ["project-1.0.0-beta6.json"] = 737,
    ["project-1.0.0-beta8.json"] = 738,
    ["project-1.0.0-rc1.json"] = 739,
    ["project-1.0.0-rc2.json"] = 740,
    ["project.json"] = 733,
    ["project.owasp.yaml"] = 741,
    ["prometheus-alertmanager.json"] = 745,
    ["prometheus.json"] = 742,
    ["prometheus.rules.json"] = 743,
    ["prometheus.rules.test.json"] = 744,
    ["proxies.json"] = 746,
    ["publiccode.yml"] = 747,
    ["pubspec.yaml"] = 748,
    ["pyrseas-0.8.json"] = 751,
    pytest = 760,
    ["quilt.mod.json"] = 1137,
    ["rc3 auth"] = 766,
    ["rc3 collection"] = 767,
    ...
    ["rc3 settings"] = 771,
    ["registry.yaml"] = 54,
    ["release drafter"] = 1013,
    ["release-hub.json"] = 5,
    ["release-please-config.json"] = 776,
    ["release-please-manifest.json"] = 777,
    ["release-plz.toml"] = 778,
    ["renv.lock"] = 792,
    ["reposets Configuration"] = 781,
    ["reposets Credentials"] = 782,
    ["revola.json"] = 3,
    ["rivet.json"] = 1161,
    ["rivet.yaml (legacy)"] = 1160,
    rumdl = 797,
    runny = 796,
    runspec = 1324,
    rustfmt = 798,
    ...
    samt = 801,
    samtrc = 802,
    ["sarif-1.0.0.json"] = 804,
    ["sarif-2.0.0.json"] = 805,
    ["sarif-2.1.0"] = 815,
    ["sarif-2.1.0-rtm.2"] = 806,
    ["sarif-2.1.0-rtm.3"] = 808,
    ["sarif-2.1.0-rtm.4"] = 810,
    ["sarif-2.1.0-rtm.5"] = 812,
    ["sarif-2.1.0-rtm.6"] = 813,
    ["sarif-external-property-file-2.1.0"] = 816,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 807,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 809,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 811,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 814,
    ["scalingo.json configuration"] = 817,
    ["schema.org - Action"] = 819,
    ["schema.org - ContactPoint"] = 820,
    ["schema.org - Place"] = 821,
    ["schema.org - Thing"] = 822,
    ["secrethub.yml"] = 1139,
    ["semantic-release"] = 829,
    ["servicehub.config.json"] = 990,
    ["servicehub.service.json"] = 989,
    ["settings.job"] = 832,
    ["sfdx-hardis configuration"] = 834,
    ["shard.yml"] = 1177,
    ["size-limit configuration"] = 839,
    ["skaffold.yaml"] = 1061,
    ["skyuxconfig.json"] = 841,
    ["snowflake-config"] = 843,
    ["snowflake-connections"] = 844,
    ["spicepod.yaml"] = 1198,
    ["sqlc configuration"] = 877,
    ["stripe-app-local.json"] = 888,
    ["stripe-app.json"] = 887,
    swcrc = 1045,
    ["task.json"] = 897,
    taskcat = 1008,
    ["template.json"] = 902,
    ["templatsources.json"] = 903,
    ["text2confl config"] = 1308,
    ["theme.json"] = 906,
    ["tizen_workspace.json"] = 908,
    tldr = 909,
    ["tm_devices configuration file"] = 1265,
    tmuxinator = 993,
    tox = 911,
    ["transcend.yml"] = 920,
    ...
    ["vega-lite.json"] = 953,
    ["vega.json"] = 952,
    ["venvironment.yaml"] = 955,
    ["venvplus.yaml"] = 956,
    version = 1247,
    ["version.json"] = 958,
    ["vhwdebugger-binding.yaml"] = 960,
    ["vim-addon-info"] = 961,
    ["vs-2017.3.host.json"] = 963,
    ["vs-nesting.json"] = 964,
    ["vsls.json"] = 962,
    ["vss-extension.json"] = 968,
    vtcfg = 1253,
    ["vtesttree.yaml"] = 969,
    ["vtestunit.yaml"] = 970,
    ["warp-keysets.json"] = 1145,
    ["warp-themes.json"] = 1146,
    ["warp-workflows.json"] = 1147,
    ["webhint.io"] = 1101,
    ["webjobpublishsettings.json"] = 975,
    ["webjobs-list.json"] = 974,
    ["well-known-fursona"] = 1185,
    ["xs-app.json"] = 1003,
    ["xunit.runner.json"] = 988,
    yamlfmt = 1030,
    yamllint = 1031,
    ["yap.json"] = 1032,
    ["zerops.yml"] = 1194,
