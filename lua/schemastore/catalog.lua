...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 169,
    [".cryproj (generic)"] = 588,
    [".cryproj engine-5.2"] = 583,
    [".cryproj engine-5.3"] = 584,
    [".cryproj engine-5.4"] = 585,
    [".cryproj engine-5.5"] = 586,
    [".cryproj engine-dev"] = 587,
    [".csscomb.json"] = 171,
    [".csslintrc"] = 172,
    [".es6importsorterrc.json"] = 714,
    [".eslintrc"] = 221,
    [".esmrc.json"] = 213,
    [".ffizer.yaml"] = 225,
    [".htmlhintrc"] = 275,
    ...
    [".mtaext"] = 597,
    [".nodehawkrc"] = 373,
    [".npmpackagejsonlintrc"] = 376,
    [".phraseapp.yml"] = 417,
    [".pmbot.yml"] = 407,
    [".postcssrc"] = 412,
    [".powerpages-web-template-manifest"] = 414,
    [".pre-commit-config.yml"] = 415,
    [".pre-commit-hooks.yml"] = 416,
    [".putout.json"] = 436,
    [".rehyperc"] = 448,
    [".remarkrc"] = 449,
    [".sprite files"] = 502,
    ...
    ["<div>RIOTS' studio configuration"] = 567,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 334,
    ["API Builder"] = 628,
    ["AVA Configuration"] = 684,
    ["AWS CDK cdk.json"] = 153,
    ["AWS CloudFormation"] = 154,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 155,
    ["AWS SAM CLI Samconfig"] = 156,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 13,
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 659,
    ["All Contributors configuration file"] = 713,
    ...
    ["Aurora Agile Meta-Framework"] = 44,
    AutoAPICase = 723,
    ["Avro Avsc"] = 45,
    ...
    ["Azure Pipelines"] = 54,
    ["Azure Static Web Apps CLI configuration file"] = 505,
    ["Azure Static Web Apps configuration file"] = 504,
    ["BX CI"] = 90,
    ["Better Code Hub"] = 632,
    ["Better Scripts"] = 91,
    Bigconfig = 71,
    BizTalkServerApplicationSchema = 603,
    Bleep = 92,
    ["Block Protocol Metadata"] = 89,
    Briefcase = 608,
    ["Build Info"] = 82,
    Buildkite = 84,
    ["Bukkit plugin.yml"] = 83,
    ["BungeeCord plugin.yml"] = 87,
    ["Butane Config"] = 671,
    ["CICS TS region tagging"] = 678,
    ["CICS TS resource import"] = 679,
    ["CICS TS resource model"] = 680,
    ["CICS TS resource overrides"] = 681,
    ["CMake Presets"] = 93,
    ["CNC Codes"] = 102,
    ["Calqulus pipeline"] = 94,
    ["Camel YAML DSL"] = 95,
    Carafe = 96,
    ["Cargo Make"] = 98,
    ["Cargo Manifest"] = 97,
    ["Catalog Info Backstage"] = 99,
    Cheatsheets = 668,
    ["Chrome Extension"] = 146,
    ["CircleCI config.yml"] = 125,
    ["Citation File Format"] = 158,
    CityJSON = 100,
    ["Code Climate"] = 126,
    CodeCV = 53,
    ["CodeShip Pro services configuration files"] = 137,
    ["CodeShip Pro steps configuration files"] = 138,
    ["Codecov configuration files"] = 136,
    Codux = 134,
    ["Cog config file"] = 103,
    ["Commandbox Box.json"] = 104,
    ["Commandbox Server.json"] = 105,
    ["Common Catalog Data"] = 144,
    ["Common types for all schemas"] = 1,
    Conjure = 101,
    ["Container Structure Test"] = 615,
    Containerlab = 640,
    ["Crowdsec collection config"] = 165,
    ["Crowdsec parser config"] = 166,
    ["Crowdsec scenario config"] = 167,
    ["DWP Exchange - catalogue entry"] = 210,
    ["DWP Exchange - gateway"] = 208,
    ["DWP Exchange - meta"] = 209,
    ["Dart build configuration"] = 173,
    ["Dart test config"] = 174,
    ["DashLord configuration"] = 175,
    ["Data Contract Specification"] = 176,
    ["Databricks Asset Bundles"] = 734,
    ["Datadog Service Definition"] = 313,
    ["Datahub Ingestion Recipe"] = 685,
    ["Dein Config"] = 107,
    Deno = 182,
    ["Deployer Recipe"] = 185,
    ["Deta Spacefile"] = 108,
    Devfile = 207,
    ["Discord Webhook"] = 187,
    ["Dolittle Artifacts"] = 191,
    ["Dolittle Bounded Context Configuration"] = 192,
    ["Dolittle Event Horizons Configuration"] = 193,
    ["Dolittle Resources Configuration"] = 194,
    ["Dolittle Server Configuration"] = 195,
    ["Dolittle Tenant Map Configuration"] = 197,
    ["Dolittle Tenants Configuration"] = 196,
    ["Dolittle Topology"] = 198,
    ["Drupal Breakpoints"] = 109,
    ["Drupal Config"] = 120,
    ["Drupal Info"] = 110,
    ["Drupal Layouts"] = 111,
    ["Drupal Libraries"] = 112,
    ["Drupal Links Action"] = 113,
    ["Drupal Links Contextual"] = 114,
    ["Drupal Links Menu"] = 115,
    ["Drupal Links Task"] = 116,
    ["Drupal Migration"] = 117,
    ["Drupal Permissions"] = 118,
    ["Drupal Routing"] = 119,
    ["Drupal Services"] = 121,
    ["Drush site aliases"] = 203,
    ["Embrace Config"] = 696,
    ["Error pages"] = 216,
    Esquio = 214,
    ["Estuary Flow Catalog"] = 675,
    ["Expo SDK"] = 219,
    ["F-Droid Data metadata"] = 224,
    ["Facets - FSDL - Application"] = 222,
    ["FasterCI Configuration"] = 55,
    Firebase = 226,
    ["Fossa configuration file"] = 233,
    ["Fossa's fossa-deps file"] = 234,
    ["Foundry VTT - Base package Manifest"] = 228,
    ["Foundry VTT - Module Manifest"] = 229,
    ["Foundry VTT - System Data Template"] = 232,
    ["Foundry VTT - System Manifest"] = 230,
    ["Foundry VTT - World Manifest"] = 231,
    ["Foxx Manifest"] = 56,
    ["Freifunk.de Community API"] = 59,
    ["Frogbot Config"] = 60,
    ["G2P Mapping Configuration"] = 238,
    ["GCP Blueprint Metadata"] = 240,
    ["GatewayCore API Gateway"] = 239,
    ["GeoJSON.json latest"] = 673,
    GherKing = 677,
    ["GitHub Action"] = 244,
    ["GitHub Discussion"] = 245,
    ["GitHub Funding"] = 246,
    ["GitHub Issue Template configuration"] = 248,
    ["GitHub Workflow"] = 249,
    ["GitHub Workflow Template Properties"] = 250,
    ["GitHub issue forms"] = 247,
    GitVersion = 243,
    ["Gitpod Configuration"] = 252,
    ["Global Privacy Control"] = 241,
    Goblet = 733,
    ["Google Cloud Workflows"] = 152,
    Goreleaser = 256,
    ["Goreleaser Pro"] = 257,
    Goss = 258,
    ["Gradle Build Cache Node"] = 630,
    ["Gradle Enterprise"] = 629,
    ["Grafana 5.x Dashboard"] = 259,
    ["GraphQL Code Generator"] = 262,
    ["GraphQL Config"] = 261,
    ["GraphQL Mesh"] = 260,
    ["Grunt JSHint task"] = 266,
    ["Grunt Watch task"] = 267,
    ["Grunt base task"] = 268,
    ["Grunt clean task"] = 264,
    ["Grunt copy task"] = 263,
    ["Grunt cssmin task"] = 265,
    HEMTT = 600,
    Hadolint = 612,
    Hammerkit = 639,
    ["Hardware Sentry Configuration"] = 689,
    Hayson = 270,
    ["Haystack Pipeline"] = 271,
    ["Hazelcast 5 Configuration"] = 272,
    ["Helm Chart.lock"] = 123,
    ["Helm Chart.yaml"] = 122,
    ["Helm Unittest Test Suite"] = 124,
    Hugo = 667,
    ["IBM Zapp document"] = 277,
    ["IBM zCodeFormatSettings"] = 278,
    ["IMG Catapult PSP"] = 283,
    Istanbul = 692,
    ["JDownloader2 crawler multi-rules"] = 293,
    ["JDownloader2 crawler single-rules"] = 292,
    ["JFrog Applications Config"] = 294,
    ["JFrog File Spec"] = 295,
    ["JFrog Pipelines YML DSL"] = 698,
    ["JMeter DSL cli config"] = 296,
    JReleaser = 298,
    ["JSON Document Transform"] = 305,
    ["JSON Feed"] = 306,
    ["JSON Resume"] = 455,
    ["JSON Schema Draft 2020-12"] = 579,
    ["JSON Schema Draft 4"] = 576,
    ["JSON Schema Draft 7"] = 577,
    ["JSON Schema Draft 7 (unofficial strict)"] = 735,
    ["JSON Schema Draft 8 (2019-09)"] = 578,
    ["JSON-API"] = 304,
    ["JSON-e templates"] = 637,
    ["JSON-stat 2.0"] = 573,
    JSONPatch = 308,
    Jasmine = 288,
    Jekyll = 289,
    ["Jenkins X Pipelines"] = 290,
    ["Jenkins X Requirements"] = 291,
    ["Jovo Language Models"] = 297,
    ["KSP-AVC"] = 574,
    ["KSP-CKAN"] = 575,
    ["Karakum configuration file"] = 235,
    Kas = 311,
    ["Keycloak REST API"] = 705,
    ["Knative Functions - func.yaml"] = 236,
    ["KoDE/CI build.yaml"] = 694,
    ["Kong DBLess config"] = 695,
    KrakenD = 312,
    LOOBin = 329,
    Lefthook = 320,
    ["LinkML Metamodel"] = 327,
    Liquibase = 644,
    ["Liquibase Flow File"] = 645,
    ["Lively Properties"] = 328,
    ["MS2Rescore Configuration"] = 361,
    Markdownlint = 648,
    ["Mason Registry"] = 650,
    ["MegaLinter configuration"] = 335,
    ["MegaLinter descriptor"] = 336,
    ["Meltano plugin discovery definition"] = 338,
    ["Meltano project definition"] = 337,
    ["Microsoft Band Web Tile"] = 339,
    ["Minecraft Data Pack Advancement"] = 341,
    ["Minecraft Data Pack Biome"] = 342,
    ["Minecraft Data Pack Configured Carver"] = 343,
    ["Minecraft Data Pack Damage Type"] = 344,
    ["Minecraft Data Pack Dimension"] = 346,
    ["Minecraft Data Pack Dimension Type"] = 345,
    ["Minecraft Data Pack Item Modifier"] = 347,
    ["Minecraft Data Pack Loot Table"] = 348,
    ["Minecraft Data Pack Metadata"] = 349,
    ["Minecraft Data Pack Predicate"] = 350,
    ["Minecraft Data Pack Recipe"] = 351,
    ["Minecraft Data Pack Tag"] = 352,
    ["Minecraft Data Pack Template Pool"] = 353,
    ["Minecraft Data Pack Trim Material"] = 358,
    ["Minecraft Data Pack Trim Pattern"] = 359,
    ["Minecraft Resource Pack Lang"] = 354,
    ["Minecraft Resource Pack Particle"] = 355,
    ["Minecraft Resource Pack Texture Mcmeta"] = 357,
    ["Minecraft Resourcepack Sounds"] = 356,
    ["MkDocs Configuration 1.0"] = 360,
    ["MongoDB Atlas Search Index Definition"] = 693,
    ["Monika Configuration"] = 691,
    ["Motif config"] = 596,
    ["NOX Framework (Service)"] = 375,
    ["Netin Diagnostic System Template"] = 654,
    ["Netlify config"] = 366,
    ["Nexus-as-Code Data Model"] = 367,
    ["Nightwatch.js"] = 368,
    ["ONe's service descriptor"] = 388,
    ["OSS Review Toolkit configuration"] = 395,
    ["OSS Review Toolkit curation"] = 396,
    ["OSS Review Toolkit package configuration"] = 397,
    ["OSS Review Toolkit repository configuration"] = 398,
    ["OSS Review Toolkit resolutions"] = 399,
    Opctl = 599,
    ["OpenRewrite Resource"] = 390,
    ["OpenWeather Current Weather API"] = 636,
    ["OpenWeather Road Risk API"] = 635,
    ["Ory Hydra configuration"] = 276,
    ["Ory Keto configuration"] = 314,
    ["Ory Kratos configuration"] = 394,
    ["Ory Oathkeeper configuration"] = 382,
    ["Outblocks App configuration"] = 392,
    ["Outblocks database table"] = 393,
    ["Outblocks project configuration"] = 391,
    Packer = 402,
    Pantsbuild = 712,
    ["Paper paper-plugin.yml"] = 403,
    ["Pipeline component"] = 646,
    ["PocketMine plugin.yml"] = 408,
    ["Postman collection"] = 413,
    ["Problem package generators"] = 420,
    Pterodactyl = 688,
    ["Pull Request Labeler"] = 435,
    Pulumi = 441,
    PyProject = 442,
    Pyright = 443,
    Qgoda = 444,
    Qodana = 664,
    ["Quali Torque Blueprint Spec 2"] = 686,
    ["QueryFirst config file"] = 708,
    ["RKE Cluster Configuration JSON"] = 643,
    ["RKE Cluster Configuration YAML"] = 642,
    ["Rancher Fleet"] = 438,
    Ray = 611,
    ["Read the Docs"] = 440,
    ["Red-DiscordBot Cog"] = 445,
    ["Red-DiscordBot Cog Repo"] = 446,
    ["Red-DiscordBot Trivia"] = 447,
    Renovate = 456,
    ["Replit config"] = 450,
    RoadRunner = 457,
    Ruff = 453,
    ["Rust Project"] = 454,
    ["Rust toolchain"] = 459,
    ["SIL Kit Participant Configuration"] = 490,
    ["SIL Kit Registry Configuration"] = 491,
    SWADL = 514,
    ["Safebox Config"] = 699,
    ["Sapphire CLI Config"] = 462,
    ["SauceCTL Configuration"] = 651,
    ["Schema Catalog"] = 476,
    ["Scoop manifest"] = 481,
    ["Semantic Data Fabric (SDF) file"] = 482,
    ["Semgrep Rule"] = 484,
    ["Serenity Code Generator (Sergen)"] = 485,
    ["Serverless Framework Configuration"] = 658,
    ["Serverless Workflow"] = 660,
    ["Settings.paf"] = 487,
    ["Shopware 6 Configuration"] = 661,
    ["Shopware CLI Extension Store Configuration"] = 662,
    ["Shopware CLI Project Store Configuration"] = 663,
    ["Sigrid scope configuration file"] = 489,
    ["Slack app manifest"] = 493,
    Solidarity = 496,
    ["Solution filters"] = 497,
    ["Source Maps v3"] = 498,
    Sourcery = 499,
    SpecIF = 500,
    ["Sponge Mixin configuration"] = 501,
    ["StackHawk Scanner Configuration"] = 657,
    Stale = 506,
    ["Starlake Data Pipeline"] = 633,
    Starship = 507,
    ["Statamic Blueprint"] = 508,
    ["StrmPrivacy Data Connector"] = 703,
    ["StrmPrivacy Data Contract"] = 704,
    ["StrmPrivacy SimpleSchema"] = 701,
    ["StrmPrivacy Stream"] = 702,
    ["StrmPrivacy batch job configuration file"] = 700,
    ["Stryker Mutator"] = 511,
    ["StyleCop Analyzers Configuration"] = 512,
    ["Swagger API 2.0"] = 515,
    TSON = 539,
    ["Talisman configuration"] = 517,
    ["Taskfile config"] = 638,
    Taurus = 518,
    ["TestEnvironment.json"] = 527,
    ["Tier.run pricing.json"] = 521,
    Tikibase = 522,
    ["Traefik v2"] = 530,
    ["Traefik v2 File Provider"] = 531,
    Turborepo = 528,
    Tye = 665,
    ["UET BuildConfig.json"] = 709,
    ["UI5 Manifest"] = 546,
    ["UTAM Page Object"] = 549,
    ["Ubuntu Server Autoinstall"] = 544,
    ["Uniswap Token List"] = 621,
    ["Unreal Engine Uplugin"] = 710,
    ["Unreal Engine Uproject"] = 711,
    Updatecli = 672,
    Uplift = 707,
    ["User Journey Map"] = 641,
    V2Ray = 676,
    ["VSCode Code Snippets"] = 140,
    ["VSIX CLI publishing"] = 562,
    ["Vela Pipeline Configuration"] = 552,
    Vercel = 139,
    Visivo = 736,
    ["Web App Manifest"] = 569,
    ["Web types"] = 572,
    WebExtensions = 568,
    ["Webman package recipe"] = 682,
    ["Windows Package Manager Installer Manifest"] = 618,
    ["Windows Package Manager Locale Manifest"] = 619,
    ["Windows Package Manager Singleton Manifest"] = 617,
    ["Woodpecker pipeline config"] = 653,
    ["Xstate Machine"] = 670,
    ["Yippee-Ki-JSON configuration YML"] = 623,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 65,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 718,
    ["bashly-strings.yml"] = 719,
    ["bashly.yml"] = 717,
    ["batect.yml"] = 64,
    ["beef-database-codegen"] = 66,
    ["beef-database-v5-codegen"] = 68,
    ["beef-entity-codegen"] = 67,
    ["beef-entity-v5-codegen"] = 69,
    ["behat.yml"] = 78,
    ["bigquery-table"] = 70,
    ["bitbucket-pipelines"] = 72,
    bitrise = 73,
    ["bitrise-step"] = 74,
    ["block.json"] = 88,
    ["bower.json"] = 76,
    ["bozr.suite.json"] = 79,
    bpkg = 720,
    ["browser.i18n.json"] = 80,
    bucklescript = 81,
    ["bundleconfig.json"] = 86,
    ["chisel-slices.json"] = 157,
    ["chrome-extension-locales-messages.json"] = 147,
    ["chutzpah.json"] = 148,
    clangd = 129,
    clib = 130,
    ["cloud-init: cloud-config userdata"] = 132,
    ["cloud-sdk-pipeline-configuration"] = 150,
    ["cloudbuild.json"] = 151,
    cloudify = 131,
    codemagic = 133,
    ["coffeelint.json"] = 159,
    ["commands.json"] = 143,
    ["compile_commands.json"] = 142,
    ["compilerconfig.json"] = 141,
    ["completely.yml"] = 715,
    ["component-detection-manifest.json"] = 162,
    ["component.json"] = 161,
    ["composer.json"] = 160,
    ["config.yaml"] = 439,
    ["contentmanifest.json"] = 149,
    ["contribute.json"] = 163,
    ["cosmos.config.json"] = 145,
    ["crowdin.yml"] = 164,
    cspell = 170,
    ["custom-elements.json"] = 729,
    ["cypress.json"] = 168,
    ["datalogic-scan2deploy-android"] = 177,
    ["datalogic-scan2deploy-ce"] = 178,
    ["dbt Project"] = 106,
    ["ddev-global"] = 179,
    ["ddev-project"] = 180,
    ["debugsettings.json"] = 181,
    ["dependabot-v2.json"] = 184,
    ["dependabot.json"] = 183,
    ["deployed-cli"] = 669,
    ["detekt.yml"] = 186,
    ["devcontainer.json"] = 135,
    devinit = 625,
    ["devspace.yaml"] = 690,
    djlint = 626,
    ["docfx.json"] = 190,
    ["docker sequencer"] = 189,
    ["docker-compose.yml"] = 624,
    ["dockerd.json"] = 188,
    ["dotnet Release Index manifest"] = 199,
    ["dotnetcli.host.json"] = 200,
    ["dprint.json"] = 201,
    ["drone.json"] = 202,
    ["dss-2.0.0.json"] = 204,
    ["dstack configuration"] = 205,
    ["dvc.yaml"] = 206,
    ["ecosystem.json"] = 211,
    eksctl = 212,
    ["electron-builder configuration file"] = 217,
    ["epr-manifest.json"] = 215,
    ["evcc.yaml"] = 218,
    ["ezd task runner"] = 220,
    ["fabric.mod.json"] = 223,
    ["first-timers-bot"] = 227,
    ...
    ["gitlab-ci"] = 251,
    ["global.json"] = 253,
    ["go-feature-flag Flag Configuration"] = 255,
    ["golangci-lint Configuration"] = 254,
    ["haxelib.json"] = 269,
    helmfile = 613,
    helmwave = 614,
    ["host-meta.json"] = 274,
    ...
    ["ide.host.json"] = 279,
    ["ifstate.conf"] = 280,
    ["imageoptimizer.json"] = 281,
    ["importmap.json"] = 284,
    ["ioBroker Configuration"] = 285,
    ["ioBroker JSON UI"] = 286,
    ["ioBroker Package manifest"] = 287,
    ["ize.toml"] = 706,
    ["jsconfig.json"] = 309,
    ["jscpd Configuration"] = 687,
    jsdoc = 610,
    ["k3d.yaml"] = 310,
    ["kontinuous-config.yaml"] = 316,
    ["kontinuous-values.yaml"] = 315,
    ["kustomization.yaml"] = 317,
    ["label-commenter-config.yml"] = 318,
    ["launchsettings.json"] = 319,
    lazydocker = 728,
    lazygit = 727,
    ["lego.json"] = 321,
    ["lerna.json"] = 322,
    ["lgtm.yml"] = 323,
    ["libman.json"] = 324,
    ["license-report-config.json"] = 325,
    ["linkinator.config.json"] = 326,
    ["local.settings.json"] = 331,
    ["localazy.json"] = 332,
    ["lotus.yaml"] = 330,
    ["lsdlschema.json"] = 333,
    ["madness.yml"] = 716,
    ["markdown-lint-check"] = 649,
    mboats = 656,
    ["micro-settings.json"] = 721,
    ["mimetypes.json"] = 340,
    ["mirrord config"] = 593,
    ["mta.yaml"] = 594,
    ["mtad.yaml"] = 595,
    ["mycode.json"] = 364,
    ["napari plugin manifest"] = 365,
    neoload = 605,
    ["nest-cli"] = 371,
    ["ninjs (News in JSON) 1.3"] = 370,
    ["ninjs (News in JSON) 2.0"] = 369,
    ["nlu.json"] = 372,
    ["nodemon.json"] = 374,
    ["noodl config"] = 655,
    now = 601,
    ...
    ["nswag.json"] = 380,
    ntangle = 381,
    ["nuclei-template.yaml"] = 378,
    ["nuget-project.json"] = 379,
    ["ocelot.json"] = 383,
    ["omnisharp.json"] = 384,
    ["openapi.json"] = 385,
    ["openfin.json"] = 389,
    ...
    ["ops.yaml"] = 387,
    ["package.json"] = 400,
    ["package.manifest"] = 401,
    ["pathfinder.yml"] = 404,
    ["pattern.json"] = 406,
    ["petstore-v1.0"] = 697,
    pgap_yaml_input_reader = 405,
    ["plagiarize-me.yaml"] = 410,
    ["plagiarize.yaml"] = 409,
    ["portman.json"] = 411,
    ["prettierrc.json"] = 418,
    ["prisma.yml"] = 419,
    ["project-1.0.0-beta3.json"] = 422,
    ["project-1.0.0-beta4.json"] = 423,
    ["project-1.0.0-beta5.json"] = 424,
    ["project-1.0.0-beta6.json"] = 425,
    ["project-1.0.0-beta8.json"] = 426,
    ["project-1.0.0-rc1.json"] = 427,
    ["project-1.0.0-rc2.json"] = 428,
    ["project.json"] = 421,
    ["prometheus.json"] = 429,
    ["prometheus.rules.json"] = 430,
    ["prometheus.rules.test.json"] = 431,
    ["proxies.json"] = 432,
    ["publiccode.yml"] = 433,
    ["pubspec.yaml"] = 434,
    ["pyrseas-0.8.json"] = 437,
    ["quilt.mod.json"] = 722,
    ["release drafter"] = 606,
    rtx = 452,
    rustfmt = 458,
    samt = 460,
    samtrc = 461,
    ["sarif-1.0.0.json"] = 463,
    ["sarif-2.0.0.json"] = 464,
    ["sarif-2.1.0"] = 474,
    ["sarif-2.1.0-rtm.2"] = 465,
    ["sarif-2.1.0-rtm.3"] = 467,
    ["sarif-2.1.0-rtm.4"] = 469,
    ["sarif-2.1.0-rtm.5"] = 471,
    ["sarif-2.1.0-rtm.6"] = 472,
    ["sarif-external-property-file-2.1.0"] = 475,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 466,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 468,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 470,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 473,
    ["schema.org - Action"] = 477,
    ["schema.org - ContactPoint"] = 478,
    ["schema.org - Place"] = 479,
    ["schema.org - Thing"] = 480,
    ["secrethub.yml"] = 724,
    ["semantic-release"] = 483,
    ["servicehub.config.json"] = 582,
    ["servicehub.service.json"] = 581,
    ["settings.job"] = 486,
    ["sfdx-hardis configuration"] = 488,
    ["size-limit configuration"] = 492,
    ["skaffold.yaml"] = 647,
    ["skyuxconfig.json"] = 494,
    snapcraft = 495,
    ["sqlc configuration"] = 503,
    ["stripe-app-local.json"] = 510,
    ["stripe-app.json"] = 509,
    swcrc = 634,
    syntax = 726,
    ["task.json"] = 516,
    taskcat = 602,
    ["template.json"] = 519,
    ["templatsources.json"] = 520,
    ["theme.json"] = 523,
    ["tizen_workspace.json"] = 524,
    tldr = 525,
    tmLanguage = 526,
    tmuxinator = 590,
    ["transcend.yml"] = 532,
    ["trunk.yaml"] = 533,
    ["ts-force-config.json"] = 537,
    ["tsconfig.json"] = 534,
    ["tsd.json"] = 535,
    ["tsdrc.json"] = 536,
    ["tslint.json"] = 538,
    ...
    ["vega-lite.json"] = 551,
    ["vega.json"] = 550,
    ["venvironment-basic.yaml"] = 554,
    ["venvironment.yaml"] = 553,
    ["version.json"] = 555,
    ["vim-addon-info"] = 556,
    ["vs-2017.3.host.json"] = 558,
    ["vs-nesting.json"] = 559,
    ["vsls.json"] = 557,
    ["vss-extension.json"] = 563,
    ["vtesttree.yaml"] = 564,
    ["vtestunit.yaml"] = 565,
    ["warp-keysets.json"] = 730,
    ["warp-themes.json"] = 731,
    ["warp-workflows.json"] = 732,
    ["webhint.io"] = 683,
    ["webjobpublishsettings.json"] = 571,
    ["webjobs-list.json"] = 570,
    ["xs-app.json"] = 598,
    ["xunit.runner.json"] = 580,
    yamllint = 622,
    zuul = 607,
    ["Žinoma"] = 616
  },
