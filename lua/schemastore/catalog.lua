...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 110,
    [".cryproj (generic)"] = 415,
    [".cryproj engine-5.2"] = 410,
    [".cryproj engine-5.3"] = 411,
    [".cryproj engine-5.4"] = 412,
    [".cryproj engine-5.5"] = 413,
    [".cryproj engine-dev"] = 414,
    [".csscomb.json"] = 112,
    [".csslintrc"] = 113,
    [".eslintrc"] = 149,
    [".esmrc.json"] = 142,
    ...
    [".vsext"] = 391,
    [".yarnrc.yml"] = 453,
    ["<div>RIOTS' studio configuration"] = 394,
    ["API Builder"] = 450,
    ["AWS CDK cdk.json"] = 99,
    ...
    ["Better Code Hub"] = 455,
    BizTalkServerApplicationSchema = 427,
    ...
    ["Error pages"] = 145,
    Esquio = 143,
    ["Estuary Flow Catalog Schema"] = 493,
    ["Expo SDK"] = 148,
    ...
    Goreleaser = 175,
    ["Goreleaser Pro"] = 176,
    ["Gradle Build Cache Node"] = 452,
    ["Gradle Enterprise"] = 451,
    ...
    ["JSON Feed"] = 213,
    ["JSON Resume"] = 313,
    ["JSON Schema Draft 2020-12"] = 406,
    ["JSON Schema Draft 4"] = 403,
    ["JSON Schema Draft 7"] = 404,
    ["JSON Schema Draft 8"] = 405,
    ...
    ["Netin Diagnostic System Template"] = 474,
    ["Netlify config schema"] = 253,
    ["Nightwatch.js"] = 254,
    ["OSS Review Toolkit repository configuration"] = 275,
    Opctl = 423,
    ["OpenWeather Current Weather API"] = 459,
    ["OpenWeather Road Risk API"] = 458,
    ...
    Packer = 278,
    ["Pipeline component"] = 468,
    ["PocketMine plugin.yml"] = 282,
    ["Pull Request Labeler"] = 304,
    Qodana = 482,
    ["RKE Cluster Configuration JSON Schema"] = 466,
    ["RKE Cluster Configuration YAML Schema"] = 465,
    Ray = 435,
    ["Read the Docs"] = 307,
    ...
    ["SauceCTL Configuration"] = 471,
    ["Schema Catalog"] = 329,
    ["Scoop manifest"] = 334,
    ["Semgrep Rule"] = 335,
    ["Serverless Framework Configuration"] = 478,
    ["Settings.paf"] = 337,
    ["Shopware 6 Configuration"] = 479,
    ["Shopware CLI Extension Store Configuration"] = 480,
    ["Shopware CLI Project Store Configuration"] = 481,
    Solidarity = 342,
    ["Source Maps v3"] = 343,
    SpecIF = 344,
    ["Sponge Mixin configuration"] = 345,
    ["StackHawk Scanner Configuration"] = 477,
    ...
    ["Swagger API 2.0"] = 358,
    ["Taskfile YAML Schema"] = 461,
    Taurus = 359,
    ["TestEnvironment.json"] = 365,
    Tikibase = 362,
    ["Traefik v2"] = 367,
    ["Traefik v2 File Provider"] = 368,
    Tye = 483,
    ["UI5 Manifest"] = 380,
    ["Ubuntu Server Autoinstall"] = 378,
    ["Uniswap Token List"] = 444,
    Updatecli = 490,
    ["User Journey Map YAML Schema"] = 464,
    V2Ray = 494,
    ["VSCode Code Snippets"] = 88,
    ["VSIX CLI publishing"] = 392,
    ["Vela Pipeline Configuration"] = 384,
    Vercel = 87,
    ["Web App Manifest"] = 396,
    ["Web types"] = 399,
    WebExtensions = 395,
    ["Windows Package Manager Installer Manifest"] = 441,
    ["Windows Package Manager Locale Manifest"] = 442,
    ["Windows Package Manager Singleton Manifest"] = 440,
    ["Woodpecker pipeline config"] = 473,
    ["Xstate Machine Schema"] = 488,
    ["Yippee-Ki-JSON configuration YML"] = 446,
    ["angular.json"] = 8,
    ...
    ["servicehub.config.json"] = 409,
    ["servicehub.service.json"] = 408,
    ["settings.job"] = 336,
    ...
    ["theme.json"] = 363,
    tmLanguage = 364,
    ["trunk.yaml schema"] = 369,
    ["ts-force-config.json"] = 373,
    ["tsconfig.json"] = 370,
    ["tsd.json"] = 371,
    ["tsdrc.json"] = 372,
    ["tslint.json"] = 374,
    ...
    ["version.json"] = 385,
    ["vim-addon-info"] = 386,
    ["vs-2017.3.host.json"] = 388,
    ["vs-nesting.json"] = 389,
    ["vsls.json"] = 387,
    ["vss-extension.json"] = 393,
    ["webjobpublishsettings.json"] = 398,
    ["webjobs-list.json"] = 397,
    ["xs-app.json"] = 422,
    ["xunit.runner.json"] = 407,
    yamllint = 445,
    zuul = 431,
    ["Žinoma"] = 439
  },
