...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 182,
    [".cryproj (generic)"] = 626,
    [".cryproj engine-5.2"] = 621,
    [".cryproj engine-5.3"] = 622,
    [".cryproj engine-5.4"] = 623,
    [".cryproj engine-5.5"] = 624,
    [".cryproj engine-dev"] = 625,
    [".csscomb.json"] = 184,
    [".csslintrc"] = 185,
    [".es6importsorterrc.json"] = 758,
    [".eslintrc"] = 234,
    [".esmrc.json"] = 226,
    [".ffizer.yaml"] = 238,
    [".htmlhintrc"] = 291,
    ...
    [".mtaext"] = 635,
    [".nodehawkrc"] = 395,
    [".npmpackagejsonlintrc"] = 398,
    [".phraseapp.yml"] = 445,
    [".pmbot.yml"] = 434,
    [".postcssrc"] = 440,
    [".powerpages-web-template-manifest"] = 442,
    [".pre-commit-config.yml"] = 443,
    [".pre-commit-hooks.yml"] = 444,
    [".putout.json"] = 464,
    [".rehyperc"] = 476,
    [".remarkrc"] = 478,
    [".sprite files"] = 534,
    ...
    ["<div>RIOTS' studio configuration"] = 605,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 353,
    AIConfig = 13,
    ["API Builder"] = 667,
    ["AVA Configuration"] = 727,
    ["AWS CDK cdk.json"] = 166,
    ["AWS CloudFormation"] = 167,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 168,
    ["AWS SAM CLI Samconfig"] = 169,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 14,
    ["Airplane task"] = 15,
    ["Alacritty Configuration"] = 699,
    ["All Contributors configuration file"] = 757,
    ...
    ["Azure Pipelines"] = 61,
    ["Azure Static Web Apps CLI configuration file"] = 537,
    ["Azure Static Web Apps configuration file"] = 536,
    ["BX CI"] = 97,
    ["Better Code Hub"] = 671,
    ["Better Scripts"] = 98,
    Bigconfig = 78,
    BizTalkServerApplicationSchema = 641,
    Bleep = 99,
    ...
    ["Butane Config"] = 712,
    ["CICS TS region tagging"] = 721,
    ["CICS TS resource import"] = 722,
    ["CICS TS resource model"] = 723,
    ["CICS TS resource overrides"] = 724,
    ["CMake Presets"] = 100,
    ["CNC Codes"] = 110,
    ...
    Cheatsheets = 709,
    ["Chrome Extension"] = 159,
    ["CircleCI config.yml"] = 136,
    ["Citation File Format"] = 171,
    CityJSON = 108,
    ["Code Climate"] = 137,
    CodeCV = 59,
    ["CodeShip Pro services configuration files"] = 148,
    ["CodeShip Pro steps configuration files"] = 149,
    ["Codecov configuration files"] = 147,
    Codux = 145,
    ["Cog config file"] = 111,
    ["Commandbox Box.json"] = 112,
    ["Commandbox Server.json"] = 113,
    ["Common Catalog Data"] = 157,
    ["Common types for all schemas"] = 1,
    Conjure = 109,
    ["Container Structure Test"] = 654,
    Containerlab = 679,
    ["Crowdsec collection config"] = 178,
    ["Crowdsec parser config"] = 179,
    ["Crowdsec scenario config"] = 180,
    ["CumulusCI Config"] = 114,
    ["DWP Exchange - catalogue entry"] = 223,
    ["DWP Exchange - gateway"] = 221,
    ["DWP Exchange - meta"] = 222,
    ["Dart build configuration"] = 186,
    ["Dart test config"] = 187,
    ["DashLord configuration"] = 188,
    ["Data Contract Specification"] = 189,
    ["Databricks Asset Bundles"] = 778,
    ["Datadog Service Definition"] = 331,
    ["Datahub Ingestion Recipe"] = 728,
    ["Dein Config"] = 116,
    Deno = 195,
    ["Deployer Recipe"] = 198,
    ["Deta Spacefile"] = 117,
    ...
    Devfile = 220,
    ["Discord Webhook"] = 200,
    ["Dolittle Artifacts"] = 204,
    ["Dolittle Bounded Context Configuration"] = 205,
    ["Dolittle Event Horizons Configuration"] = 206,
    ["Dolittle Resources Configuration"] = 207,
    ["Dolittle Server Configuration"] = 208,
    ["Dolittle Tenant Map Configuration"] = 210,
    ["Dolittle Tenants Configuration"] = 209,
    ["Dolittle Topology"] = 211,
    ["Drupal Breakpoints"] = 120,
    ["Drupal Config"] = 131,
    ["Drupal Info"] = 121,
    ["Drupal Layouts"] = 122,
    ["Drupal Libraries"] = 123,
    ["Drupal Links Action"] = 124,
    ["Drupal Links Contextual"] = 125,
    ["Drupal Links Menu"] = 126,
    ["Drupal Links Task"] = 127,
    ["Drupal Migration"] = 128,
    ["Drupal Permissions"] = 129,
    ["Drupal Routing"] = 130,
    ["Drupal Services"] = 132,
    ["Drush site aliases"] = 216,
    ["Embrace Config"] = 739,
    Endurica = 781,
    ["Error pages"] = 229,
    Esquio = 227,
    ["Estuary Flow Catalog"] = 718,
    ["Expo SDK"] = 232,
    ["F-Droid Data metadata"] = 237,
    ["Facets - FSDL - Application"] = 235,
    ["FasterCI Configuration"] = 62,
    FiQuS = 241,
    Firebase = 239,
    ["Fossa configuration file"] = 248,
    ["Fossa's fossa-deps file"] = 249,
    ["Foundry VTT - Base package Manifest"] = 243,
    ["Foundry VTT - Module Manifest"] = 244,
    ["Foundry VTT - System Data Template"] = 247,
    ["Foundry VTT - System Manifest"] = 245,
    ["Foundry VTT - World Manifest"] = 246,
    ["Foxx Manifest"] = 63,
    ["Freifunk.de Community API"] = 66,
    ["Frogbot Config"] = 67,
    ["G2P Mapping Configuration"] = 253,
    ["GCP Blueprint Metadata"] = 256,
    Gaspar = 254,
    ["GatewayCore API Gateway"] = 255,
    ["GeoJSON.json latest"] = 716,
    GherKing = 720,
    ["GitHub Action"] = 260,
    ["GitHub Discussion"] = 261,
    ["GitHub Funding"] = 262,
    ["GitHub Issue Template configuration"] = 264,
    ["GitHub Workflow"] = 265,
    ["GitHub Workflow Template Properties"] = 266,
    ["GitHub issue forms"] = 263,
    GitVersion = 259,
    ["Gitpod Configuration"] = 268,
    ["Global Privacy Control"] = 257,
    Goblet = 777,
    ["Google Chrome Related Website Sets"] = 240,
    ["Google Cloud Workflows"] = 165,
    Goreleaser = 272,
    ["Goreleaser Pro"] = 273,
    Goss = 274,
    ["Gradle Build Cache Node"] = 669,
    ["Gradle Enterprise"] = 668,
    ["Grafana 5.x Dashboard"] = 275,
    ["GraphQL Code Generator"] = 278,
    ["GraphQL Config"] = 277,
    ["GraphQL Mesh"] = 276,
    ["Grunt JSHint task"] = 282,
    ["Grunt Watch task"] = 283,
    ["Grunt base task"] = 284,
    ["Grunt clean task"] = 280,
    ["Grunt copy task"] = 279,
    ["Grunt cssmin task"] = 281,
    HEMTT = 638,
    Hadolint = 650,
    Hammerkit = 678,
    ["Hardware Sentry Configuration"] = 732,
    Hatch = 651,
    Hayson = 286,
    ["Haystack Pipeline"] = 287,
    ["Hazelcast 5 Configuration"] = 288,
    ["Helm Chart.lock"] = 134,
    ["Helm Chart.yaml"] = 133,
    ["Helm Unittest Test Suite"] = 135,
    Hugo = 708,
    ["Hugo Theme"] = 707,
    ["IBM Zapp document"] = 293,
    ["IBM zCodeFormatSettings"] = 294,
    ["IMG Catapult PSP"] = 299,
    Istanbul = 735,
    ["JDownloader2 crawler multi-rules"] = 309,
    ["JDownloader2 crawler single-rules"] = 308,
    ["JFrog Applications Config"] = 310,
    ["JFrog File Spec"] = 311,
    ["JFrog Pipelines YML DSL"] = 741,
    ["JMeter DSL cli config"] = 312,
    JReleaser = 314,
    ["JSON Document Transform"] = 321,
    ["JSON Feed"] = 322,
    ["JSON Resume"] = 484,
    ["JSON Schema Draft 2020-12"] = 617,
    ["JSON Schema Draft 4"] = 614,
    ["JSON Schema Draft 7"] = 615,
    ["JSON Schema Draft 7 (unofficial strict)"] = 779,
    ["JSON Schema Draft 8 (2019-09)"] = 616,
    ["JSON-API"] = 320,
    ["JSON-e templates"] = 676,
    ["JSON-stat 2.0"] = 611,
    JSONPatch = 324,
    Jasmine = 304,
    Jekyll = 305,
    ["Jenkins X Pipelines"] = 306,
    ["Jenkins X Requirements"] = 307,
    ["Jovo Language Models"] = 313,
    ["KIMMDY config file"] = 329,
    ["KSP-AVC"] = 612,
    ["KSP-CKAN"] = 613,
    ["Karakum configuration file"] = 250,
    Kas = 327,
    ["Keycloak REST API"] = 749,
    ["Knative Functions - func.yaml"] = 251,
    ["KoDE/CI build.yaml"] = 737,
    ["Kong DBLess config"] = 738,
    KrakenD = 330,
    LOOBin = 348,
    Lefthook = 338,
    ["Liferay client-extension.yaml"] = 344,
    ["LinkML Metamodel"] = 346,
    Liquibase = 683,
    ["Liquibase Flow File"] = 684,
    ["Lively Properties"] = 347,
    ["Lobe AI Agent"] = 60,
    ["MLOS Configs"] = 380,
    ["MS2Rescore Configuration"] = 382,
    Markdownlint = 687,
    ["Mason Registry"] = 689,
    ["MegaLinter configuration"] = 354,
    ["MegaLinter descriptor"] = 355,
    Melange = 785,
    ["Meltano plugin discovery definition"] = 357,
    ["Meltano project definition"] = 356,
    ["Microsoft Band Web Tile"] = 358,
    ["Minecraft Custom Main Menu Mod"] = 786,
    ["Minecraft Data Pack Advancement"] = 360,
    ["Minecraft Data Pack Biome"] = 361,
    ["Minecraft Data Pack Configured Carver"] = 362,
    ["Minecraft Data Pack Damage Type"] = 363,
    ["Minecraft Data Pack Dimension"] = 365,
    ["Minecraft Data Pack Dimension Type"] = 364,
    ["Minecraft Data Pack Item Modifier"] = 366,
    ["Minecraft Data Pack Loot Table"] = 367,
    ["Minecraft Data Pack Metadata"] = 368,
    ["Minecraft Data Pack Predicate"] = 369,
    ["Minecraft Data Pack Recipe"] = 370,
    ["Minecraft Data Pack Tag"] = 371,
    ["Minecraft Data Pack Template Pool"] = 372,
    ["Minecraft Data Pack Trim Material"] = 377,
    ["Minecraft Data Pack Trim Pattern"] = 378,
    ["Minecraft Resource Pack Lang"] = 373,
    ["Minecraft Resource Pack Particle"] = 374,
    ["Minecraft Resource Pack Texture Mcmeta"] = 376,
    ["Minecraft Resourcepack Sounds"] = 375,
    ["MkDocs Configuration 1.0"] = 379,
    ["MongoDB Atlas Search Index Definition"] = 736,
    ["Monika Configuration"] = 734,
    ["Motif config"] = 634,
    ["NOX Framework (Service)"] = 397,
    ["Netin Diagnostic System Template"] = 693,
    ["Netlify config"] = 388,
    ["Network-as-Code Data Model"] = 389,
    ["Nightwatch.js"] = 390,
    ["ONe's changelog entry"] = 413,
    ["ONe's service descriptor"] = 412,
    ["OSS Review Toolkit configuration"] = 420,
    ["OSS Review Toolkit curation"] = 421,
    ["OSS Review Toolkit package configuration"] = 422,
    ["OSS Review Toolkit repository configuration"] = 423,
    ["OSS Review Toolkit resolutions"] = 424,
    Opctl = 637,
    ["OpenRewrite Resource"] = 415,
    ["OpenUtau character yaml"] = 409,
    ["OpenUtau ustx"] = 410,
    ["OpenWeather Current Weather API"] = 675,
    ["OpenWeather Road Risk API"] = 674,
    ["Ory Hydra configuration"] = 292,
    ["Ory Keto configuration"] = 332,
    ["Ory Kratos configuration"] = 419,
    ["Ory Oathkeeper configuration"] = 404,
    ["Outblocks App configuration"] = 417,
    ["Outblocks database table"] = 418,
    ["Outblocks project configuration"] = 416,
    PDM = 430,
    ["PDM Partial"] = 431,
    Packer = 427,
    Pantsbuild = 756,
    ["Paper paper-plugin.yml"] = 428,
    ["Pipeline component"] = 685,
    ["PocketMine plugin.yml"] = 435,
    Poetry = 436,
    ["Postman collection"] = 441,
    ["Problem object RFC9457"] = 783,
    ["Problem package generators"] = 448,
    Pterodactyl = 731,
    ["Pull Request Labeler"] = 463,
    Pulumi = 469,
    PyProject = 470,
    Pyright = 471,
    Qgoda = 472,
    Qodana = 704,
    ["Quali Torque Blueprint Spec 2"] = 729,
    ["QueryFirst config file"] = 752,
    ["RKE Cluster Configuration JSON"] = 682,
    ["RKE Cluster Configuration YAML"] = 681,
    ["Rancher Fleet"] = 466,
    Ray = 649,
    ["Read the Docs"] = 468,
    ["Red-DiscordBot Cog"] = 473,
    ["Red-DiscordBot Cog Repo"] = 474,
    ["Red-DiscordBot Trivia"] = 475,
    RenderCV = 486,
    Renovate = 485,
    ["Replit config"] = 479,
    RoadRunner = 487,
    ...
    ["Rust Project"] = 483,
    ["Rust toolchain"] = 489,
    ["SIL Kit Participant Configuration"] = 522,
    ["SIL Kit Registry Configuration"] = 523,
    SWADL = 548,
    ["Safebox Config"] = 742,
    ["Sapphire CLI Config"] = 492,
    ["SauceCTL Configuration"] = 690,
    ["Schema Catalog"] = 506,
    ["Scoop manifest"] = 511,
    ["Semantic Data Fabric (SDF) file"] = 512,
    ["Semgrep Rule"] = 514,
    ["Serenity Code Generator (Sergen)"] = 515,
    ["Serverless Framework Configuration"] = 698,
    ["Serverless Workflow"] = 700,
    ["Settings.paf"] = 517,
    Setuptools = 518,
    ["Shopware 6 Configuration"] = 701,
    ["Shopware CLI Extension Store Configuration"] = 702,
    ["Shopware CLI Project Store Configuration"] = 703,
    Sigma = 520,
    ["Sigrid scope configuration file"] = 521,
    ["Slack app manifest"] = 525,
    Solidarity = 528,
    ["Solution filters"] = 529,
    ["Source Maps v3"] = 530,
    Sourcery = 531,
    SpecIF = 532,
    ["Sponge Mixin configuration"] = 533,
    StackBlitz = 538,
    ["StackHawk Scanner Configuration"] = 697,
    Stale = 539,
    ["Starlake Data Pipeline"] = 672,
    Starship = 540,
    ["Statamic Blueprint"] = 541,
    ["Stella configuration file"] = 542,
    ["StrmPrivacy Data Connector"] = 746,
    ["StrmPrivacy Data Contract"] = 747,
    ["StrmPrivacy SimpleSchema"] = 744,
    ["StrmPrivacy Stream"] = 745,
    ["StrmPrivacy batch job configuration file"] = 743,
    ["Stryker Mutator"] = 545,
    ["StyleCop Analyzers Configuration"] = 546,
    ["Sublime Syntax"] = 748,
    ["Swagger API 2.0"] = 549,
    TSON = 574,
    TSTyche = 575,
    Talhelper = 551,
    ["Talisman configuration"] = 552,
    ["Taskfile config"] = 677,
    Taurus = 553,
    ["TestEnvironment.json"] = 562,
    ["TextMate Grammar"] = 561,
    ["Tier.run pricing.json"] = 556,
    Tikibase = 557,
    ["Traefik v2"] = 565,
    ["Traefik v2 File Provider"] = 566,
    TunnelHub = 782,
    Turborepo = 563,
    Tye = 705,
    ["UET BuildConfig.json"] = 753,
    ["UI5 Manifest"] = 583,
    ["UNCORS configuration"] = 587,
    ["UTAM Page Object"] = 586,
    ["Ubuntu Server Autoinstall"] = 581,
    ["Uniswap Token List"] = 660,
    ["Unreal Engine Uplugin"] = 754,
    ["Unreal Engine Uproject"] = 755,
    ["Updatecli Compose"] = 713,
    ["Updatecli Policy Manifest"] = 714,
    ["Updatecli Policy Metadata"] = 715,
    Uplift = 751,
    ["User Journey Map"] = 680,
    V2Ray = 719,
    ["VSCode Code Snippets"] = 153,
    ["VSIX CLI publishing"] = 600,
    ["Vela Pipeline Configuration"] = 590,
    Vercel = 152,
    Visivo = 780,
    ["Web App Manifest"] = 607,
    ["Web types"] = 610,
    WebExtensions = 606,
    ["Webman package recipe"] = 725,
    ["Windows Package Manager Installer Manifest"] = 657,
    ["Windows Package Manager Locale Manifest"] = 658,
    ["Windows Package Manager Singleton Manifest"] = 656,
    ["Woodpecker pipeline config"] = 692,
    ["Xstate Machine"] = 711,
    ["Yippee-Ki-JSON configuration YML"] = 662,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 16,
    apko = 784,
    ...
    ["bamboo-spec"] = 72,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 762,
    ["bashly-strings.yml"] = 763,
    ["bashly.yml"] = 761,
    ["batect.yml"] = 71,
    ...
    ["chisel-slices.json"] = 170,
    ["chrome-extension-locales-messages.json"] = 160,
    ["chutzpah.json"] = 161,
    cibuildwheel = 107,
    clangd = 140,
    clib = 141,
    ["cloud-init: cloud-config userdata"] = 143,
    ["cloud-sdk-pipeline-configuration"] = 163,
    ["cloudbuild.json"] = 164,
    cloudify = 142,
    codemagic = 144,
    ["coffeelint.json"] = 172,
    ["commands.json"] = 156,
    ["compile_commands.json"] = 155,
    ["compilerconfig.json"] = 154,
    ["completely.yml"] = 759,
    ["component-detection-manifest.json"] = 175,
    ["component.json"] = 174,
    ["composer.json"] = 173,
    ["config.yaml"] = 467,
    ["contentmanifest.json"] = 162,
    ["contribute.json"] = 176,
    ["cosmos.config.json"] = 158,
    ["crowdin.yml"] = 177,
    cspell = 183,
    ["custom-elements.json"] = 773,
    ["cypress.json"] = 181,
    ["datalogic-scan2deploy-android"] = 190,
    ["datalogic-scan2deploy-ce"] = 191,
    ["dbt Project"] = 115,
    ["ddev-global"] = 192,
    ["ddev-project"] = 193,
    ["debugsettings.json"] = 194,
    ["dependabot-v2.json"] = 197,
    ["dependabot.json"] = 196,
    ["deployed-cli"] = 710,
    ["detekt.yml"] = 199,
    ["devcontainer.json"] = 146,
    devinit = 664,
    ["devspace.yaml"] = 733,
    djlint = 665,
    ["docfx.json"] = 203,
    ["docker sequencer"] = 202,
    ["docker-compose.yml"] = 663,
    ["dockerd.json"] = 201,
    ["dotnet Release Index manifest"] = 212,
    ["dotnetcli.host.json"] = 213,
    ["dprint.json"] = 214,
    ["drone.json"] = 215,
    ["dss-2.0.0.json"] = 217,
    ["dstack configuration"] = 218,
    ["dvc.yaml"] = 219,
    ["ecosystem.json"] = 224,
    eksctl = 225,
    ["electron-builder configuration file"] = 230,
    ["epr-manifest.json"] = 228,
    ["evcc.yaml"] = 231,
    ["ezd task runner"] = 233,
    ["fabric.mod.json"] = 236,
    ["first-timers-bot"] = 242,
    ...
    ["gitlab-ci"] = 267,
    ["global.json"] = 269,
    ["go-feature-flag Flag Configuration"] = 271,
    ["golangci-lint Configuration"] = 270,
    ["haxelib.json"] = 285,
    helmfile = 652,
    helmwave = 653,
    ["host-meta.json"] = 290,
    ...
    ["ide.host.json"] = 295,
    ["ifstate.conf"] = 296,
    ["imageoptimizer.json"] = 297,
    ["importmap.json"] = 300,
    ["ioBroker Configuration"] = 301,
    ["ioBroker JSON UI"] = 302,
    ["ioBroker Package manifest"] = 303,
    ["ize.toml"] = 750,
    ["jsconfig.json"] = 325,
    ["jscpd Configuration"] = 730,
    jsdoc = 648,
    ["k3d.yaml"] = 326,
    ["k9s plugin.yml"] = 328,
    ["kontinuous-config.yaml"] = 334,
    ["kontinuous-values.yaml"] = 333,
    ["kustomization.yaml"] = 335,
    ["label-commenter-config.yml"] = 336,
    ["launchsettings.json"] = 337,
    lazydocker = 772,
    lazygit = 771,
    ["lego.json"] = 339,
    ["lerna.json"] = 340,
    ["lgtm.yml"] = 341,
    ["libman.json"] = 342,
    ["license-report-config.json"] = 343,
    ["linkinator.config.json"] = 345,
    ["local.settings.json"] = 350,
    ["localazy.json"] = 351,
    ["lotus.yaml"] = 349,
    ["lsdlschema.json"] = 352,
    ["madness.yml"] = 760,
    ["markdown-lint-check"] = 688,
    mboats = 695,
    ["micro-settings.json"] = 765,
    ["mimetypes.json"] = 359,
    ["mirrord config"] = 631,
    ["monospace.yml"] = 381,
    ["mta.yaml"] = 632,
    ...
    ["mycode.json"] = 385,
    mypy = 386,
    ["napari plugin manifest"] = 387,
    neoload = 643,
    ["nest-cli"] = 393,
    ["ninjs (News in JSON) 1.3"] = 392,
    ["ninjs (News in JSON) 2.0"] = 391,
    ["nlu.json"] = 394,
    ["nodemon.json"] = 396,
    ["noodl config"] = 694,
    now = 639,
    ...
    ["nswag.json"] = 402,
    ntangle = 403,
    ["nuclei-template.yaml"] = 400,
    ["nuget-project.json"] = 401,
    ["ocelot.json"] = 405,
    ["omnisharp.json"] = 406,
    ["openapi.json"] = 407,
    ["openfin.json"] = 414,
    ...
    ["ops.yaml"] = 411,
    ["package.json"] = 425,
    ["package.manifest"] = 426,
    ["pathfinder.yml"] = 429,
    ["pattern.json"] = 433,
    ["petstore-v1.0"] = 740,
    pgap_yaml_input_reader = 432,
    ["plagiarize-me.yaml"] = 438,
    ["plagiarize.yaml"] = 437,
    ["portman.json"] = 439,
    ["prettierrc.json"] = 446,
    ["prisma.yml"] = 447,
    ["project-1.0.0-beta3.json"] = 450,
    ["project-1.0.0-beta4.json"] = 451,
    ["project-1.0.0-beta5.json"] = 452,
    ["project-1.0.0-beta6.json"] = 453,
    ["project-1.0.0-beta8.json"] = 454,
    ["project-1.0.0-rc1.json"] = 455,
    ["project-1.0.0-rc2.json"] = 456,
    ["project.json"] = 449,
    ["prometheus.json"] = 457,
    ["prometheus.rules.json"] = 458,
    ["prometheus.rules.test.json"] = 459,
    ["proxies.json"] = 460,
    ["publiccode.yml"] = 461,
    ["pubspec.yaml"] = 462,
    ["pyrseas-0.8.json"] = 465,
    ["quilt.mod.json"] = 766,
    ["release drafter"] = 644,
    ["release-plz.toml"] = 477,
    rtx = 481,
    rustfmt = 488,
    samt = 490,
    samtrc = 491,
    ["sarif-1.0.0.json"] = 493,
    ["sarif-2.0.0.json"] = 494,
    ["sarif-2.1.0"] = 504,
    ["sarif-2.1.0-rtm.2"] = 495,
    ["sarif-2.1.0-rtm.3"] = 497,
    ["sarif-2.1.0-rtm.4"] = 499,
    ["sarif-2.1.0-rtm.5"] = 501,
    ["sarif-2.1.0-rtm.6"] = 502,
    ["sarif-external-property-file-2.1.0"] = 505,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 496,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 498,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 500,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 503,
    ["schema.org - Action"] = 507,
    ["schema.org - ContactPoint"] = 508,
    ["schema.org - Place"] = 509,
    ["schema.org - Thing"] = 510,
    ["scikit-build"] = 696,
    ["secrethub.yml"] = 768,
    ["semantic-release"] = 513,
    ["servicehub.config.json"] = 620,
    ["servicehub.service.json"] = 619,
    ["settings.job"] = 516,
    ["sfdx-hardis configuration"] = 519,
    ["size-limit configuration"] = 524,
    ["skaffold.yaml"] = 686,
    ["skyuxconfig.json"] = 526,
    snapcraft = 527,
    ["sqlc configuration"] = 535,
    ["stripe-app-local.json"] = 544,
    ["stripe-app.json"] = 543,
    swcrc = 673,
    syntax = 770,
    ["task.json"] = 550,
    taskcat = 640,
    ["template.json"] = 554,
    ["templatsources.json"] = 555,
    ["theme.json"] = 558,
    ["tizen_workspace.json"] = 559,
    tldr = 560,
    tmuxinator = 628,
    ["transcend.yml"] = 567,
    ["trunk.yaml"] = 568,
    ["ts-force-config.json"] = 572,
    ["tsconfig.json"] = 569,
    ["tsd.json"] = 570,
    ["tsdrc.json"] = 571,
    ["tslint.json"] = 573,
    ...
    ["typingsrc.json"] = 580,
    ["typo3.json"] = 578,
    ["ui5-workspace.yaml"] = 585,
    ["ui5.yaml"] = 584,
    unist = 706,
    ["up.json"] = 582,
    v8r = 604,
    ["vcpkg configuration file"] = 151,
    ["vcpkg manifest file"] = 150,
    ["vega-lite.json"] = 589,
    ["vega.json"] = 588,
    ["venvironment-basic.yaml"] = 592,
    ["venvironment.yaml"] = 591,
    ["version.json"] = 593,
    ["vim-addon-info"] = 594,
    ["vs-2017.3.host.json"] = 596,
    ["vs-nesting.json"] = 597,
    ["vsls.json"] = 595,
    ["vss-extension.json"] = 601,
    ["vtesttree.yaml"] = 602,
    ["vtestunit.yaml"] = 603,
    ["warp-keysets.json"] = 774,
    ["warp-themes.json"] = 775,
    ["warp-workflows.json"] = 776,
    ["webhint.io"] = 726,
    ["webjobpublishsettings.json"] = 609,
    ["webjobs-list.json"] = 608,
    ["xs-app.json"] = 636,
    ["xunit.runner.json"] = 618,
    yamllint = 661,
    zuul = 645,
    ["Žinoma"] = 655
  },
