...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 106,
    [".cryproj (generic)"] = 410,
    [".cryproj engine-5.2"] = 405,
    [".cryproj engine-5.3"] = 406,
    [".cryproj engine-5.4"] = 407,
    [".cryproj engine-5.5"] = 408,
    [".cryproj engine-dev"] = 409,
    [".csscomb.json"] = 108,
    [".csslintrc"] = 109,
    [".eslintrc"] = 145,
    [".esmrc.json"] = 138,
    ...
    [".mtaext"] = 416,
    [".nodehawkrc"] = 255,
    [".npmpackagejsonlintrc"] = 257,
    [".phraseapp.yml"] = 284,
    [".pmbot.yml"] = 277,
    [".postcssrc"] = 282,
    [".pre-commit-config.yml"] = 283,
    [".putout.json"] = 301,
    [".rehyperc"] = 306,
    [".remarkrc"] = 307,
    [".sprite files"] = 342,
    ...
    [".vsext"] = 386,
    [".yarnrc.yml"] = 448,
    ["<div>RIOTS' studio configuration"] = 389,
    ["API Builder"] = 445,
    ["AWS CDK cdk.json"] = 95,
    ...
    ["Azure Pipelines"] = 38,
    ["Azure Static Web Apps CLI configuration file"] = 344,
    ["Azure Static Web Apps configuration file"] = 343,
    ["Better Code Hub"] = 450,
    BizTalkServerApplicationSchema = 422,
    ...
    Goreleaser = 171,
    ["Goreleaser Pro"] = 172,
    ["Gradle Build Cache Node"] = 447,
    ["Gradle Enterprise"] = 446,
    ...
    Hugo = 480,
    ["JFrog File Spec"] = 200,
    ["JSON Document Transform"] = 208,
    ["JSON Feed"] = 209,
    ["JSON Resume"] = 309,
    ["JSON Schema Draft 2020-12"] = 401,
    ["JSON Schema Draft 4"] = 398,
    ["JSON Schema Draft 7"] = 399,
    ["JSON Schema Draft 8"] = 400,
    ...
    ["JSON-API"] = 207,
    ["JSON-e templates"] = 455,
    ["JSON-stat 2.0"] = 395,
    JSONPatch = 211,
    Jekyll = 197,
    ["Jenkins X Pipelines"] = 198,
    ["Jenkins X Requirements"] = 199,
    ["Jovo Language Models"] = 201,
    ["KSP-AVC"] = 396,
    ["KSP-CKAN"] = 397,
    Liquibase = 462,
    Markdownlint = 465,
    ["MegaLinter configuration"] = 227,
    ["MegaLinter descriptor"] = 228,
    ["Meltano plugin discovery definition"] = 230,
    ["Meltano project definition"] = 229,
    ["Microsoft Band Web Tile"] = 231,
    ["Minecraft Data Pack Advancement"] = 233,
    ["Minecraft Data Pack Biome"] = 234,
    ["Minecraft Data Pack Configured Carver"] = 235,
    ["Minecraft Data Pack Dimension"] = 237,
    ["Minecraft Data Pack Dimension Type"] = 236,
    ["Minecraft Data Pack Item Modifier"] = 238,
    ["Minecraft Data Pack Loot Table"] = 239,
    ["Minecraft Data Pack Metadata"] = 240,
    ["Minecraft Data Pack Predicate"] = 241,
    ["Minecraft Data Pack Recipe"] = 242,
    ["Minecraft Data Pack Template Pool"] = 243,
    ["Minecraft Resourcepack Sounds"] = 244,
    ["Netin Diagnostic System Template"] = 469,
    ["Netlify config schema"] = 249,
    ["Nightwatch.js"] = 250,
    ["OSS Review Toolkit repository configuration"] = 271,
    Opctl = 418,
    ["OpenWeather Current Weather API"] = 454,
    ["OpenWeather Road Risk API"] = 453,
    ["Ory Hydra configuration"] = 190,
    ["Ory Keto configuration"] = 215,
    ["Ory Kratos configuration"] = 270,
    ["Ory Oathkeeper configuration"] = 262,
    ["Outblocks App configuration"] = 268,
    ["Outblocks database table"] = 269,
    ["Outblocks project configuration"] = 267,
    Packer = 274,
    ["Pipeline component"] = 463,
    ["PocketMine plugin.yml"] = 278,
    ["Pull Request Labeler"] = 300,
    Qodana = 477,
    ["RKE Cluster Configuration JSON Schema"] = 461,
    ["RKE Cluster Configuration YAML Schema"] = 460,
    Ray = 430,
    ["Read the Docs"] = 303,
    ["Red-DiscordBot Cog"] = 304,
    ["Red-DiscordBot Cog Repo"] = 305,
    Renovate = 310,
    RoadRunner = 311,
    SWADL = 353,
    ["Sapphire CLI Config"] = 312,
    ["SauceCTL Configuration"] = 466,
    ["Schema Catalog"] = 325,
    ["Scoop manifest"] = 330,
    ["Semgrep Rule"] = 331,
    ["Serverless Framework Configuration"] = 473,
    ["Settings.paf"] = 333,
    ["Shopware 6 Configuration"] = 474,
    ["Shopware CLI Extension Store Configuration"] = 475,
    ["Shopware CLI Project Store Configuration"] = 476,
    Solidarity = 338,
    ["Source Maps v3"] = 339,
    SpecIF = 340,
    ["Sponge Mixin configuration"] = 341,
    ["StackHawk Scanner Configuration"] = 472,
    ["StackHead CLI config"] = 345,
    ["StackHead module configuration"] = 346,
    ["StackHead project definition"] = 347,
    Stale = 348,
    ["Statamic Blueprint"] = 349,
    ["Stryker Mutator"] = 350,
    ["StyleCop Analyzers Configuration"] = 351,
    ["Swagger API 2.0"] = 354,
    ["Taskfile YAML Schema"] = 456,
    Taurus = 355,
    ["TestEnvironment.json"] = 360,
    ["Traefik v2"] = 362,
    ["Traefik v2 File Provider"] = 363,
    Tye = 478,
    ["UI5 Manifest"] = 375,
    ["Ubuntu Server Autoinstall"] = 373,
    ...
    Vercel = 83,
    ["Web App Manifest"] = 391,
    ["Web types"] = 394,
    WebExtensions = 390,
    ["Windows Package Manager Installer Manifest"] = 436,
    ["Windows Package Manager Locale Manifest"] = 437,
    ["Windows Package Manager Singleton Manifest"] = 435,
    ["Woodpecker pipeline config"] = 468,
    ["Xstate Machine Schema"] = 483,
    ["Yippee-Ki-JSON configuration YML"] = 441,
    ["angular.json"] = 8,
    ...
    huskyrc = 412,
    ["ide.host.json"] = 191,
    ["imageoptimizer.json"] = 192,
    ["importmap.json"] = 194,
    ["ioBroker JSON UI"] = 195,
    ["ioBroker Package manifest"] = 196,
    ["jsconfig.json"] = 212,
    jsdoc = 429,
    ["k3d.yaml"] = 213,
    ["kustomization.yaml"] = 216,
    ["label-commenter-config.yml"] = 217,
    ["launchsettings.json"] = 218,
    ["lerna.json"] = 219,
    ["lgtm.yml"] = 220,
    ["libman.json"] = 221,
    ["license-report-config.json"] = 222,
    ["linkinator.config.json"] = 223,
    ["local.settings.json"] = 224,
    ["localazy.json"] = 225,
    ["lsdlschema.json"] = 226,
    mboats = 471,
    ["mimetypes.json"] = 232,
    ...
    ["mtad.yaml"] = 415,
    ["mycode.json"] = 247,
    ["napari plugin manifest"] = 248,
    neoload = 424,
    ["nest-cli"] = 253,
    ["ninjs (News in JSON) 1.3"] = 252,
    ["ninjs (News in JSON) 2.0"] = 251,
    ["nlu.json"] = 254,
    ["nodemon.json"] = 256,
    ["noodl.schema.json"] = 470,
    now = 420,
    ["nswag.json"] = 260,
    ntangle = 261,
    ["nuclei-template.yaml"] = 258,
    ["nuget-project.json"] = 259,
    ["ocelot.json"] = 263,
    ["omnisharp.json"] = 264,
    ["openapi.json"] = 265,
    ["openfin.json"] = 266,
    ["package.json"] = 272,
    ["package.manifest"] = 273,
    ["pattern.json"] = 276,
    pgap_yaml_input_reader = 275,
    ["plagiarize-me.yaml"] = 280,
    ["plagiarize.yaml"] = 279,
    ["portman.json"] = 281,
    ["prettierrc.json"] = 285,
    ["prisma.yml"] = 286,
    ["project-1.0.0-beta3.json"] = 288,
    ["project-1.0.0-beta4.json"] = 289,
    ["project-1.0.0-beta5.json"] = 290,
    ["project-1.0.0-beta6.json"] = 291,
    ["project-1.0.0-beta8.json"] = 292,
    ["project-1.0.0-rc1.json"] = 293,
    ["project-1.0.0-rc2.json"] = 294,
    ["project.json"] = 287,
    ["prometheus.json"] = 295,
    ["prometheus.rules.json"] = 296,
    ["proxies.json"] = 297,
    ["publiccode.yml"] = 298,
    ["pubspec.yaml"] = 299,
    ["pyrseas-0.8.json"] = 302,
    ["release drafter"] = 425,
    ["sarif-1.0.0.json"] = 313,
    ["sarif-2.0.0.json"] = 314,
    ["sarif-2.1.0"] = 323,
    ["sarif-2.1.0-rtm.2"] = 315,
    ["sarif-2.1.0-rtm.3"] = 317,
    ["sarif-2.1.0-rtm.4"] = 319,
    ["sarif-2.1.0-rtm.5"] = 321,
    ["sarif-external-property-file-2.1.0"] = 324,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 316,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 318,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 320,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 322,
    ["schema.org - Action"] = 326,
    ["schema.org - ContactPoint"] = 327,
    ["schema.org - Place"] = 328,
    ["schema.org - Thing"] = 329,
    ["service.datadog.yaml"] = 214,
    ["servicehub.config.json"] = 404,
    ["servicehub.service.json"] = 403,
    ["settings.job"] = 332,
    ["sfdx-hardis configuration"] = 334,
    ["size-limit configuration"] = 335,
    ["skaffold.yaml"] = 464,
    ["skyuxconfig.json"] = 336,
    snapcraft = 337,
    swcrc = 452,
    taskcat = 421,
    ["template.json"] = 356,
    ["templatsources.json"] = 357,
    ["theme.json"] = 358,
    tmLanguage = 359,
    ["trunk.yaml schema"] = 364,
    ["ts-force-config.json"] = 368,
    ["tsconfig.json"] = 365,
    ["tsd.json"] = 366,
    ["tsdrc.json"] = 367,
    ["tslint.json"] = 369,
    ...
    ["version.json"] = 380,
    ["vim-addon-info"] = 381,
    ["vs-2017.3.host.json"] = 383,
    ["vs-nesting.json"] = 384,
    ["vsls.json"] = 382,
    ["vss-extension.json"] = 388,
    ["webjobpublishsettings.json"] = 393,
    ["webjobs-list.json"] = 392,
    ["xs-app.json"] = 417,
    ["xunit.runner.json"] = 402,
    yamllint = 440,
    zuul = 426,
    ["Žinoma"] = 434
  },
