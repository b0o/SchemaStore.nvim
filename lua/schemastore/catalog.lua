...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 177,
    [".cryproj (generic)"] = 604,
    [".cryproj engine-5.2"] = 599,
    [".cryproj engine-5.3"] = 600,
    [".cryproj engine-5.4"] = 601,
    [".cryproj engine-5.5"] = 602,
    [".cryproj engine-dev"] = 603,
    [".csscomb.json"] = 179,
    [".csslintrc"] = 180,
    [".es6importsorterrc.json"] = 735,
    [".eslintrc"] = 229,
    [".esmrc.json"] = 221,
    [".ffizer.yaml"] = 233,
    [".htmlhintrc"] = 285,
    ...
    [".mtaext"] = 613,
    [".nodehawkrc"] = 384,
    [".npmpackagejsonlintrc"] = 387,
    [".phraseapp.yml"] = 429,
    [".pmbot.yml"] = 418,
    [".postcssrc"] = 424,
    [".powerpages-web-template-manifest"] = 426,
    [".pre-commit-config.yml"] = 427,
    [".pre-commit-hooks.yml"] = 428,
    [".putout.json"] = 448,
    [".rehyperc"] = 460,
    [".remarkrc"] = 461,
    [".sprite files"] = 516,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 677,
    ["All Contributors configuration file"] = 734,
    ...
    ["Azure Pipelines"] = 59,
    ["Azure Static Web Apps CLI configuration file"] = 519,
    ["Azure Static Web Apps configuration file"] = 518,
    ["BX CI"] = 95,
    ["Better Code Hub"] = 649,
    ["Better Scripts"] = 96,
    Bigconfig = 76,
    BizTalkServerApplicationSchema = 619,
    Bleep = 97,
    ...
    ["Butane Config"] = 689,
    ["CICS TS region tagging"] = 698,
    ["CICS TS resource import"] = 699,
    ["CICS TS resource model"] = 700,
    ["CICS TS resource overrides"] = 701,
    ["CMake Presets"] = 98,
    ["CNC Codes"] = 108,
    ...
    ["Databricks Asset Bundles"] = 755,
    ["Datadog Service Definition"] = 324,
    ["Datahub Ingestion Recipe"] = 705,
    ["Dein Config"] = 113,
    Deno = 190,
    ["Deployer Recipe"] = 193,
    ["Deta Spacefile"] = 114,
    ...
    ["Goreleaser Pro"] = 267,
    Goss = 268,
    ["Gradle Build Cache Node"] = 647,
    ["Gradle Enterprise"] = 646,
    ...
    Hadolint = 628,
    Hammerkit = 656,
    ["Hardware Sentry Configuration"] = 709,
    Hatch = 629,
    Hayson = 280,
    ...
    ["JFrog File Spec"] = 305,
    ["JFrog Pipelines YML DSL"] = 718,
    ["JMeter DSL cli config"] = 306,
    JReleaser = 308,
    ["JSON Document Transform"] = 315,
    ["JSON Feed"] = 316,
    ["JSON Resume"] = 467,
    ["JSON Schema Draft 2020-12"] = 595,
    ["JSON Schema Draft 4"] = 592,
    ["JSON Schema Draft 7"] = 593,
    ["JSON Schema Draft 7 (unofficial strict)"] = 756,
    ["JSON Schema Draft 8 (2019-09)"] = 594,
    ["JSON-API"] = 314,
    ["JSON-e templates"] = 654,
    ["JSON-stat 2.0"] = 589,
    JSONPatch = 318,
    Jasmine = 298,
    Jekyll = 299,
    ...
    Kas = 321,
    ["Keycloak REST API"] = 726,
    ["Knative Functions - func.yaml"] = 245,
    ["KoDE/CI build.yaml"] = 714,
    ["Kong DBLess config"] = 715,
    KrakenD = 323,
    LOOBin = 340,
    Lefthook = 331,
    ["LinkML Metamodel"] = 338,
    Liquibase = 661,
    ["Liquibase Flow File"] = 662,
    ["Lively Properties"] = 339,
    ["Lobe AI Agent"] = 58,
    ["MS2Rescore Configuration"] = 372,
    Markdownlint = 665,
    ["Mason Registry"] = 667,
    ...
    ["MongoDB Atlas Search Index Definition"] = 713,
    ["Monika Configuration"] = 711,
    ["Motif config"] = 612,
    ["NOX Framework (Service)"] = 386,
    ["Netin Diagnostic System Template"] = 671,
    ["Netlify config"] = 377,
    ["Nexus-as-Code Data Model"] = 378,
    ["Nightwatch.js"] = 379,
    ["ONe's service descriptor"] = 399,
    ["OSS Review Toolkit configuration"] = 406,
    ["OSS Review Toolkit curation"] = 407,
    ["OSS Review Toolkit package configuration"] = 408,
    ["OSS Review Toolkit repository configuration"] = 409,
    ["OSS Review Toolkit resolutions"] = 410,
    Opctl = 615,
    ["OpenRewrite Resource"] = 401,
    ["OpenWeather Current Weather API"] = 653,
    ["OpenWeather Road Risk API"] = 652,
    ["Ory Hydra configuration"] = 286,
    ["Ory Keto configuration"] = 325,
    ["Ory Kratos configuration"] = 405,
    ["Ory Oathkeeper configuration"] = 393,
    ["Outblocks App configuration"] = 403,
    ["Outblocks database table"] = 404,
    ["Outblocks project configuration"] = 402,
    Packer = 413,
    Pantsbuild = 733,
    ["Paper paper-plugin.yml"] = 414,
    ["Pipeline component"] = 663,
    ["PocketMine plugin.yml"] = 419,
    Poetry = 420,
    ["Postman collection"] = 425,
    ["Problem package generators"] = 432,
    Pterodactyl = 708,
    ["Pull Request Labeler"] = 447,
    Pulumi = 453,
    PyProject = 454,
    Pyright = 455,
    Qgoda = 456,
    Qodana = 682,
    ["Quali Torque Blueprint Spec 2"] = 706,
    ["QueryFirst config file"] = 729,
    ["RKE Cluster Configuration JSON"] = 660,
    ["RKE Cluster Configuration YAML"] = 659,
    ["Rancher Fleet"] = 450,
    Ray = 627,
    ["Read the Docs"] = 452,
    ["Red-DiscordBot Cog"] = 457,
    ["Red-DiscordBot Cog Repo"] = 458,
    ["Red-DiscordBot Trivia"] = 459,
    RenderCV = 469,
    Renovate = 468,
    ["Replit config"] = 462,
    RoadRunner = 470,
    ...
    ["Rust Project"] = 466,
    ["Rust toolchain"] = 472,
    ["SIL Kit Participant Configuration"] = 504,
    ["SIL Kit Registry Configuration"] = 505,
    SWADL = 529,
    ["Safebox Config"] = 719,
    ["Sapphire CLI Config"] = 475,
    ["SauceCTL Configuration"] = 668,
    ["Schema Catalog"] = 489,
    ["Scoop manifest"] = 494,
    ["Semantic Data Fabric (SDF) file"] = 495,
    ["Semgrep Rule"] = 497,
    ["Serenity Code Generator (Sergen)"] = 498,
    ["Serverless Framework Configuration"] = 676,
    ["Serverless Workflow"] = 678,
    ["Settings.paf"] = 500,
    Setuptools = 501,
    ["Shopware 6 Configuration"] = 679,
    ["Shopware CLI Extension Store Configuration"] = 680,
    ["Shopware CLI Project Store Configuration"] = 681,
    ["Sigrid scope configuration file"] = 503,
    ["Slack app manifest"] = 507,
    Solidarity = 510,
    ["Solution filters"] = 511,
    ["Source Maps v3"] = 512,
    Sourcery = 513,
    SpecIF = 514,
    ["Sponge Mixin configuration"] = 515,
    StackBlitz = 520,
    ["StackHawk Scanner Configuration"] = 675,
    Stale = 521,
    ["Starlake Data Pipeline"] = 650,
    Starship = 522,
    ["Statamic Blueprint"] = 523,
    ["StrmPrivacy Data Connector"] = 723,
    ["StrmPrivacy Data Contract"] = 724,
    ["StrmPrivacy SimpleSchema"] = 721,
    ["StrmPrivacy Stream"] = 722,
    ["StrmPrivacy batch job configuration file"] = 720,
    ["Stryker Mutator"] = 526,
    ["StyleCop Analyzers Configuration"] = 527,
    ["Sublime Syntax"] = 725,
    ["Swagger API 2.0"] = 530,
    TSON = 554,
    ["Talisman configuration"] = 532,
    ["Taskfile config"] = 655,
    Taurus = 533,
    ["TestEnvironment.json"] = 542,
    ["TextMate Grammar"] = 541,
    ["Tier.run pricing.json"] = 536,
    Tikibase = 537,
    ["Traefik v2"] = 545,
    ["Traefik v2 File Provider"] = 546,
    Turborepo = 543,
    Tye = 683,
    ["UET BuildConfig.json"] = 730,
    ["UI5 Manifest"] = 562,
    ["UTAM Page Object"] = 565,
    ["Ubuntu Server Autoinstall"] = 560,
    ["Uniswap Token List"] = 638,
    ["Unreal Engine Uplugin"] = 731,
    ["Unreal Engine Uproject"] = 732,
    ["Updatecli Compose"] = 690,
    ["Updatecli Policy Manifest"] = 691,
    ["Updatecli Policy Metadata"] = 692,
    Uplift = 728,
    ["User Journey Map"] = 658,
    V2Ray = 696,
    ["VSCode Code Snippets"] = 148,
    ["VSIX CLI publishing"] = 578,
    ["Vela Pipeline Configuration"] = 568,
    Vercel = 147,
    Visivo = 757,
    ["Web App Manifest"] = 585,
    ["Web types"] = 588,
    WebExtensions = 584,
    ["Webman package recipe"] = 702,
    ["Windows Package Manager Installer Manifest"] = 635,
    ["Windows Package Manager Locale Manifest"] = 636,
    ["Windows Package Manager Singleton Manifest"] = 634,
    ["Woodpecker pipeline config"] = 670,
    ["Xstate Machine"] = 688,
    ["Yippee-Ki-JSON configuration YML"] = 640,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 70,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 739,
    ["bashly-strings.yml"] = 740,
    ["bashly.yml"] = 738,
    ["batect.yml"] = 69,
    ...
    ["lsdlschema.json"] = 344,
    ["madness.yml"] = 737,
    ["markdown-lint-check"] = 666,
    mboats = 673,
    ["micro-settings.json"] = 742,
    ["mimetypes.json"] = 351,
    ["mirrord config"] = 609,
    ["mta.yaml"] = 610,
    ["mtad.yaml"] = 611,
    ["mycode.json"] = 375,
    ["napari plugin manifest"] = 376,
    neoload = 621,
    ["nest-cli"] = 382,
    ["ninjs (News in JSON) 1.3"] = 381,
    ["ninjs (News in JSON) 2.0"] = 380,
    ["nlu.json"] = 383,
    ["nodemon.json"] = 385,
    ["noodl config"] = 672,
    now = 617,
    ...
    ["nswag.json"] = 391,
    ntangle = 392,
    ["nuclei-template.yaml"] = 389,
    ["nuget-project.json"] = 390,
    ["ocelot.json"] = 394,
    ["omnisharp.json"] = 395,
    ["openapi.json"] = 396,
    ["openfin.json"] = 400,
    ...
    ["ops.yaml"] = 398,
    ["package.json"] = 411,
    ["package.manifest"] = 412,
    ["pathfinder.yml"] = 415,
    ["pattern.json"] = 417,
    ["petstore-v1.0"] = 717,
    pgap_yaml_input_reader = 416,
    ["plagiarize-me.yaml"] = 422,
    ["plagiarize.yaml"] = 421,
    ["portman.json"] = 423,
    ["prettierrc.json"] = 430,
    ["prisma.yml"] = 431,
    ["project-1.0.0-beta3.json"] = 434,
    ["project-1.0.0-beta4.json"] = 435,
    ["project-1.0.0-beta5.json"] = 436,
    ["project-1.0.0-beta6.json"] = 437,
    ["project-1.0.0-beta8.json"] = 438,
    ["project-1.0.0-rc1.json"] = 439,
    ["project-1.0.0-rc2.json"] = 440,
    ["project.json"] = 433,
    ["prometheus.json"] = 441,
    ["prometheus.rules.json"] = 442,
    ["prometheus.rules.test.json"] = 443,
    ["proxies.json"] = 444,
    ["publiccode.yml"] = 445,
    ["pubspec.yaml"] = 446,
    ["pyrseas-0.8.json"] = 449,
    ["quilt.mod.json"] = 743,
    ["release drafter"] = 622,
    rtx = 464,
    rustfmt = 471,
    samt = 473,
    samtrc = 474,
    ["sarif-1.0.0.json"] = 476,
    ["sarif-2.0.0.json"] = 477,
    ["sarif-2.1.0"] = 487,
    ["sarif-2.1.0-rtm.2"] = 478,
    ["sarif-2.1.0-rtm.3"] = 480,
    ["sarif-2.1.0-rtm.4"] = 482,
    ["sarif-2.1.0-rtm.5"] = 484,
    ["sarif-2.1.0-rtm.6"] = 485,
    ["sarif-external-property-file-2.1.0"] = 488,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 479,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 481,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 483,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 486,
    ["schema.org - Action"] = 490,
    ["schema.org - ContactPoint"] = 491,
    ["schema.org - Place"] = 492,
    ["schema.org - Thing"] = 493,
    ["scikit-build"] = 674,
    ["secrethub.yml"] = 745,
    ["semantic-release"] = 496,
    ["servicehub.config.json"] = 598,
    ["servicehub.service.json"] = 597,
    ["settings.job"] = 499,
    ["sfdx-hardis configuration"] = 502,
    ["size-limit configuration"] = 506,
    ["skaffold.yaml"] = 664,
    ["skyuxconfig.json"] = 508,
    snapcraft = 509,
    ["sqlc configuration"] = 517,
    ["stripe-app-local.json"] = 525,
    ["stripe-app.json"] = 524,
    swcrc = 651,
    syntax = 747,
    ["task.json"] = 531,
    taskcat = 618,
    ["template.json"] = 534,
    ["templatsources.json"] = 535,
    ["theme.json"] = 538,
    ["tizen_workspace.json"] = 539,
    tldr = 540,
    tmuxinator = 606,
    ["transcend.yml"] = 547,
    ["trunk.yaml"] = 548,
    ["ts-force-config.json"] = 552,
    ["tsconfig.json"] = 549,
    ["tsd.json"] = 550,
    ["tsdrc.json"] = 551,
    ["tslint.json"] = 553,
    ...
    ["vega-lite.json"] = 567,
    ["vega.json"] = 566,
    ["venvironment-basic.yaml"] = 570,
    ["venvironment.yaml"] = 569,
    ["version.json"] = 571,
    ["vim-addon-info"] = 572,
    ["vs-2017.3.host.json"] = 574,
    ["vs-nesting.json"] = 575,
    ["vsls.json"] = 573,
    ["vss-extension.json"] = 579,
    ["vtesttree.yaml"] = 580,
    ["vtestunit.yaml"] = 581,
    ["warp-keysets.json"] = 751,
    ["warp-themes.json"] = 752,
    ["warp-workflows.json"] = 753,
    ["webhint.io"] = 703,
    ["webjobpublishsettings.json"] = 587,
    ["webjobs-list.json"] = 586,
    ["xs-app.json"] = 614,
    ["xunit.runner.json"] = 596,
    yamllint = 639,
    zuul = 623,
    ["Žinoma"] = 633
  },
