...
M.json = {
  ...
  index = {
    ...
    [".pmbot.yml"] = 588,
    [".postcssrc"] = 595,
    [".powerpages-web-template-manifest"] = 597,
    [".pre-commit-config.yml"] = 598,
    [".pre-commit-hooks.yml"] = 599,
    [".putout.json"] = 629,
    [".rehyperc"] = 653,
    [".remarkrc"] = 657,
    [".sprite files"] = 746,
    ...
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1093,
    ["API Builder"] = 907,
    ["AVA Configuration"] = 969,
    ...
    ["AWS Copilot Manifest"] = 1132,
    ["AWS SAM CLI Samconfig"] = 226,
    ["Adobe UXP Manifest"] = 1031,
    ...
    ["Application list for a WinUtil"] = 1075,
    ArchitectFX = 1080,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1141,
    ["Azure IoT Operations connector metadata"] = 1138,
    ...
    ["Azure Pipelines"] = 81,
    ["Azure Static Web Apps CLI configuration file"] = 750,
    ["Azure Static Web Apps configuration file"] = 749,
    ["BOSH CPI Config"] = 105,
    ["BOSH Deploy Config"] = 106,
    ["BX CI"] = 125,
    ["Bashly (bashly.yml)"] = 998,
    ["Bashly Settings (bashly-settings.yml)"] = 999,
    ["Better Code Hub"] = 911,
    ["Better Scripts"] = 126,
    Bigconfig = 98,
    ["Biome Formatter Config"] = 65,
    ["Bitmovin Encoding Template"] = 1086,
    BizTalkServerApplicationSchema = 879,
    Bleep = 127,
    ...
    ["Butane Config"] = 954,
    C4InterFlow = 1101,
    ["CDK Environment Manager, concrete environment configuration"] = 1125,
    ["CDK Environment Manager, concrete environments definition"] = 1124,
    ["CDK Environment Manager, environment definition"] = 1123,
    ["CGS Card Game Specification (cgs.json)"] = 1036,
    ["CICS TS region tagging"] = 963,
    ["CICS TS resource import"] = 964,
    ["CICS TS resource model"] = 965,
    ["CICS TS resource overrides"] = 966,
    ["CMake Presets"] = 128,
    ["CNC Codes"] = 149,
    ["CRS WAF test file"] = 1065,
    ["CRS WAF test platform overrides file"] = 1066,
    ...
    ["Chamaleon environment"] = 1090,
    ["Chamaleon properties"] = 1091,
    ["Chamaleon template"] = 1089,
    Changesets = 235,
    Changie = 137,
    Charmcraft = 138,
    Cheatsheets = 951,
    ...
    ["Clawject config"] = 155,
    ["Cloud Foundry Application Manifest"] = 1047,
    ["Cloud Run Spec v1"] = 1070,
    ...
    Concord = 1064,
    ["Configu .cfgu files"] = 1052,
    ["Configu .configu file"] = 1053,
    Conjure = 148,
    ["Container Structure Test"] = 893,
    Containerlab = 920,
    ["Contextive Glossary"] = 1117,
    Convex = 147,
    ["Crowdsec collection config"] = 245,
    ["Crowdsec parser config"] = 246,
    ["Crowdsec scenario config"] = 247,
    ["CumulusCI Config"] = 154,
    ["Custom Machinery Machine"] = 1037,
    ["Custom Machinery Recipe"] = 1038,
    ...
    ["DonateCaseBetterCasino menu"] = 1094,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1006,
    ["EAS config"] = 311,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 995,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1137,
    ["EasyVCR .NET"] = 312,
    ["Eidolon Resource"] = 1081,
    ...
    ["Evolving Resolutive Process notation"] = 1139,
    ["Expo SDK"] = 310,
    ...
    ["GeoJSON.json latest"] = 958,
    GherKing = 962,
    ["GitHub Action"] = 342,
    ["GitHub Actions typing"] = 1077,
    ...
    ["Google Digital Assetlinks"] = 1118,
    Goreleaser = 370,
    ["Goreleaser Pro"] = 371,
    Goss = 372,
    ["Gradle Build Cache Node"] = 909,
    ["Gradle Enterprise"] = 908,
    ...
    Hadolint = 889,
    Hammerkit = 919,
    ["Hardware Sentry Configuration"] = 974,
    ["HashiCorp Vault"] = 385,
    Hatch = 890,
    Hayagriva = 387,
    Hayson = 388,
    ...
    ["JFrog File Spec"] = 421,
    ["JFrog Pipelines YML DSL"] = 983,
    ["JMeter DSL cli config"] = 422,
    JReleaser = 425,
    ["JSON Document Transform"] = 433,
    ["JSON Feed"] = 434,
    ["JSON Resume"] = 663,
    ["JSON Schema Draft 2020-12"] = 857,
    ["JSON Schema Draft 4"] = 854,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1016,
    ["JSON Schema Draft 7"] = 855,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1017,
    ["JSON Schema Draft 8 (2019-09)"] = 856,
    ["JSON-API"] = 432,
    ["JSON-e templates"] = 916,
    ["JSON-stat 2.0"] = 850,
    JSONPatch = 436,
    ...
    ["Jujutsu (jj) VCS config"] = 1131,
    ["KIMMDY config file"] = 447,
    ["KODE/CI build.yaml"] = 979,
    ["KSP-AVC"] = 851,
    ["KSP-CKAN"] = 852,
    ["KSP-NetKAN"] = 853,
    KSY = 1046,
    ...
    ["Metadata for a Cinnamon spice"] = 1073,
    ["Metatype Configuration"] = 487,
    ["MetricsHub Configuration"] = 488,
    ["MetricsHub Connector Configuration"] = 489,
    ["Micro Editor Syntax"] = 1007,
    ["Microsoft Band Web Tile"] = 490,
    ["Microsoft RulesEngine workflow rules"] = 1061,
    ["Microsoft RulesEngine workflow rules list"] = 1062,
    ["Minecraft Custom Main Menu Mod"] = 1025,
    ...
    ["MongoDB Atlas Search Index Definition"] = 978,
    ["Monika Configuration"] = 976,
    ["Monoweave Configuration"] = 515,
    ["Motif config"] = 871,
    MultiQC = 1111,
    ["NOX Framework (Service)"] = 534,
    ["Netin Diagnostic System Template"] = 936,
    ["Netlify config"] = 523,
    ["Network-as-Code Data Model"] = 524,
    ["Next Gen UI Agent Configuration"] = 525,
    ["Nightwatch.js"] = 527,
    ["Node.js configuration"] = 876,
    ...
    ["OpenUtau ustx"] = 553,
    ["OpenWeather Current Weather API"] = 915,
    ["OpenWeather Road Risk API"] = 914,
    ...
    Packer = 581,
    Pantsbuild = 993,
    ["Paper paper-plugin.yml"] = 582,
    ["Pipeline component"] = 927,
    ["Platform.sh application"] = 2,
    ["Platform.sh routes"] = 3,
    ["Platform.sh services"] = 4,
    ["Plex Prerolls"] = 592,
    ["PocketMine plugin.yml"] = 589,
    ["Postman collection"] = 596,
    ["Power Pages Configuration"] = 1128,
    ["Preset list for a WinUtil"] = 1076,
    ["ProActions AI-Kit Configuration"] = 605,
    ["ProActions AI-Kit Configuration for Menus"] = 607,
    ["ProActions AI-Kit Configuration for Sections"] = 609,
    ["ProActions AI-Kit Configuration for Services"] = 606,
    ["ProActions AI-Kit Configuration for Steps"] = 610,
    ["ProActions AI-Kit Configuration for Templates"] = 608,
    ["Problem object RFC9457"] = 1022,
    ["Problem package generators"] = 611,
    Pterodactyl = 973,
    ["Pull Request Labeler"] = 628,
    Pulumi = 636,
    ["PyGTA Config"] = 632,
    PyProject = 637,
    Pylock = 1119,
    Pyright = 638,
    ["Python script metadata"] = 1113,
    ["QType AI DSL"] = 641,
    Qgoda = 640,
    Qodana = 946,
    ["Qt Creator workspace file"] = 1054,
    ["Quali Torque Blueprint Spec 2"] = 971,
    ["QueryFirst config file"] = 989,
    ["RKE Cluster Configuration JSON"] = 924,
    ["RKE Cluster Configuration YAML"] = 923,
    RadioHound = 631,
    Railway = 642,
    ["Rancher Fleet"] = 633,
    ["Rattler-build"] = 643,
    Ray = 888,
    ["Read the Docs"] = 635,
    ["Red-DiscordBot Cog"] = 650,
    ["Red-DiscordBot Cog Repo"] = 651,
    ["Red-DiscordBot Trivia"] = 652,
    ["Render Blueprints"] = 922,
    RenderCV = 665,
    Renovate = 664,
    ["Replit config"] = 658,
    Restate = 1106,
    ["Revel Digital Gadget Definition File"] = 1130,
    RoadRunner = 667,
    ["Robust Station Image"] = 1136,
    Rockcraft = 668,
    ["Roo Coder Custom Modes"] = 669,
    Rubocop = 660,
    ["Rudder techniques"] = 1029,
    Ruff = 661,
    ["Rust Project"] = 662,
    ["Rust toolchain"] = 673,
    ["SDMX data message"] = 699,
    ["SDMX metadata message"] = 698,
    ["SDMX structure message"] = 697,
    ["SIL Kit Participant Configuration"] = 709,
    ["SIL Kit Registry Configuration"] = 710,
    ["SPDX 2.3"] = 747,
    SWADL = 763,
    ["Safebox Config"] = 984,
    ["Sapphire CLI Config"] = 676,
    ["SauceCTL Configuration"] = 933,
    ["Schema Catalog"] = 691,
    ["Scoop manifest"] = 696,
    ["Semantic Data Fabric (SDF) file"] = 700,
    ["Semgrep Rule"] = 702,
    ["Serenity Code Generator (Sergen)"] = 703,
    ["Serverless Framework Configuration"] = 940,
    ["Serverless Workflow"] = 942,
    ["Settings for a Cinnamon spice"] = 1072,
    ["Settings.paf"] = 705,
    ["Shopware 6 Configuration"] = 943,
    ["Shopware CLI Extension Store Configuration"] = 944,
    ["Shopware CLI Project Store Configuration"] = 945,
    ["Sigma Detection Rule"] = 707,
    ["Sigrid scope configuration file"] = 708,
    ["SkyPilot Task JSON"] = 1030,
    ["Slack app manifest"] = 712,
    Snapcraft = 714,
    Solidarity = 717,
    ["Solution filters"] = 718,
    ["Source Maps v3"] = 719,
    Sourcery = 720,
    ["Spack bootstrap.yaml"] = 721,
    ["Spack cdash.yaml"] = 722,
    ["Spack ci.yaml"] = 723,
    ["Spack compilers.yaml"] = 724,
    ["Spack concretizer.yaml"] = 725,
    ["Spack config.yaml"] = 726,
    ["Spack definitions.yaml"] = 727,
    ["Spack develop.yaml"] = 728,
    ["Spack env_vars.yaml"] = 729,
    ["Spack environment"] = 735,
    ["Spack include.yaml"] = 730,
    ["Spack mirrors.yaml"] = 731,
    ["Spack modules.yaml"] = 732,
    ["Spack packages.yaml"] = 733,
    ["Spack repos.yaml"] = 734,
    ["Spack toolchains.yaml"] = 736,
    ["Spack upstreams.yaml"] = 737,
    ["Spack view.yaml"] = 738,
    ["Speakeasy Generation Config File"] = 742,
    ["Speakeasy Lint Configuration File"] = 739,
    ["Speakeasy Test Generation Configuration File"] = 740,
    ["Speakeasy Workflow File"] = 741,
    SpecIF = 743,
    ["Specmatic Configuration"] = 744,
    ["Sponge Mixin configuration"] = 745,
    StackBlitz = 751,
    ["StackHawk Scanner Configuration"] = 939,
    Stale = 752,
    Starfish = 753,
    ["Starlake Data Pipeline"] = 912,
    Starship = 754,
    ["Statamic Blueprint"] = 755,
    ["Stella configuration file"] = 756,
    ["Streamlit configuration file"] = 757,
    ["Stryker Mutator"] = 760,
    ["StyleCop Analyzers Configuration"] = 761,
    ["Stylelint (.stylelintrc)"] = 762,
    ["Stylua Config"] = 1120,
    ["Sublime Syntax"] = 985,
    ["Subsquid squid manifest"] = 1032,
    ["Swagger API 2.0"] = 764,
    ["Synadia Connect Component"] = 765,
    TSON = 800,
    TSTyche = 801,
    ["TYPO3 Vendor Bundler config"] = 806,
    ["Tab data for a LinUtil"] = 1079,
    ["Tab list for a LinUtil"] = 1078,
    Tach = 766,
    ["Tach Domain"] = 767,
    Talhelper = 769,
    ["Talisman configuration"] = 770,
    Taplo = 1121,
    ["Taskfile config"] = 917,
    Taurus = 771,
    Tauticord = 772,
    Telefonistka = 1107,
    ["Terrateam config"] = 1133,
    ["TestEnvironment.json"] = 783,
    ["TextMate Grammar"] = 782,
    Threagile = 778,
    ["Tier.run pricing.json"] = 775,
    Tikibase = 776,
    Tombi = 781,
    ["Traefik v2"] = 786,
    ["Traefik v2 File Provider"] = 787,
    ["Traefik v3"] = 788,
    ["Traefik v3 File Provider"] = 789,
    ["Travis CI (.travis.yml)"] = 785,
    Treefmt = 375,
    Trident = 1103,
    ["TrueScript for *.tscript files"] = 792,
    ["Tugboat QA config.yml"] = 1100,
    TunnelHub = 1020,
    Turborepo = 784,
    Tycho = 1068,
    Tye = 947,
    ["Tyk Gateway - Open Source v5.7+"] = 1112,
    ["Typst Manifest"] = 807,
    ["UET BuildConfig.json"] = 990,
    ["UI5 Manifest"] = 813,
    ["UNCORS configuration"] = 817,
    ["UTAM Page Object"] = 816,
    ["Ubuntu Server Autoinstall"] = 811,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1104,
    ["Uniswap Token List"] = 900,
    ["Universal Schedule Format"] = 818,
    ["Unreal Engine Uplugin"] = 991,
    ["Unreal Engine Uproject"] = 992,
    ["UpCloud CLI (upctl) configuration"] = 1105,
    ["Updatecli Compose"] = 955,
    ["Updatecli Policy Manifest"] = 956,
    ["Updatecli Policy Metadata"] = 957,
    Uplift = 988,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 921,
    V2Ray = 961,
    ["VSCode Code Snippets"] = 210,
    ["VSIX CLI publishing"] = 838,
    Vector = 820,
    ["Vela Pipeline Configuration"] = 823,
    Vercel = 209,
    ["Version Bumper config"] = 828,
    ["Viash Component Config"] = 1109,
    ["Viash Package Config"] = 1110,
    Visivo = 1018,
    ["WP-CLI"] = 848,
    Wake = 1102,
    ["Waku Config"] = 1082,
    ["Web App Manifest"] = 844,
    ["Web types"] = 847,
    WebExtensions = 843,
    ["Webman package recipe"] = 967,
    ["Windows Package Manager Installer Manifest"] = 896,
    ["Windows Package Manager Locale Manifest"] = 897,
    ["Windows Package Manager Singleton Manifest"] = 895,
    Winutil = 898,
    ["WireMock stub mapping"] = 1085,
    ["Woodpecker pipeline config"] = 935,
    ["Wrangler CLI"] = 849,
    ["Xstate Machine"] = 953,
    ["Yandex Workflow Language"] = 1074,
    ["Yarn Config (.yarnrc.yml)"] = 910,
    ["Yippee-Ki-JSON configuration YML"] = 902,
    ["YouTrack App"] = 1071,
    ["Zarf Package Configuration"] = 1135,
    ["Zerops.io config"] = 1059,
    ["Zerops.io import"] = 1060,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 1023,
    ...
    ["behat.yml"] = 108,
    ["bigquery-table"] = 97,
    ["bioimageio resource description"] = 1040,
    ...
    ["crowdin.yml"] = 244,
    ["ctfd-setup configuration file"] = 1092,
    ["custom-elements.json"] = 1010,
    ["cypress.json"] = 248,
    ...
    ["gematik health care insurance list"] = 1098,
    ["gematik health care patient list"] = 1095,
    ["gematik health care provider institution list"] = 1097,
    ["gematik health care provider list"] = 1096,
    ["gematik tiger test environment configuration"] = 1099,
    ["gitlab-ci"] = 350,
    ["global.json"] = 366,
    ...
    ["lint-staged (.lintstagedrc)"] = 865,
    ["local.settings.json"] = 475,
    ["localazy.json"] = 476,
    ["lotus.yaml"] = 474,
    ["lsdlschema.json"] = 477,
    ["markdown-link-check"] = 930,
    maturin = 931,
    mboats = 938,
    ["micro-settings.json"] = 1002,
    ["mimetypes.json"] = 491,
    ["mirrord config"] = 867,
    mise = 868,
    ["mkdocs.yml"] = 511,
    ["monospace.yml"] = 514,
    ["moon.yml"] = 1084,
    ["mprocs Configuration file"] = 1055,
    ["mrdocs.yml"] = 512,
    ["mta.yaml"] = 869,
    ["mtad.yaml"] = 870,
    ["mycode.json"] = 521,
    ...
    ["pattern.json"] = 586,
    ["petstore-v1.0"] = 982,
    pgap_yaml_input_reader = 585,
    ["pixi.toml"] = 587,
    ["plagiarize-me.yaml"] = 591,
    ["plagiarize.yaml"] = 590,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1088,
    ["podbard.yaml"] = 593,
    ["portman.json"] = 594,
    ["prefect.toml"] = 602,
    ["prettierrc.json"] = 603,
    ["prisma.yml"] = 604,
    ["project-1.0.0-beta3.json"] = 613,
    ["project-1.0.0-beta4.json"] = 614,
    ["project-1.0.0-beta5.json"] = 615,
    ["project-1.0.0-beta6.json"] = 616,
    ["project-1.0.0-beta8.json"] = 617,
    ["project-1.0.0-rc1.json"] = 618,
    ["project-1.0.0-rc2.json"] = 619,
    ["project.json"] = 612,
    ["project.owasp.yaml"] = 620,
    ["prometheus-alertmanager.json"] = 624,
    ["prometheus.json"] = 621,
    ["prometheus.rules.json"] = 622,
    ["prometheus.rules.test.json"] = 623,
    ["proxies.json"] = 625,
    ["publiccode.yml"] = 626,
    ["pubspec.yaml"] = 627,
    ["pyrseas-0.8.json"] = 630,
    pytest = 639,
    ["quilt.mod.json"] = 1003,
    ["rc3 auth"] = 644,
    ["rc3 collection"] = 645,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 883,
    ["release-please-config.json"] = 654,
    ["release-please-manifest.json"] = 655,
    ["release-plz.toml"] = 656,
    ["renv.lock"] = 666,
    ["rivet.json"] = 1027,
    ["rivet.yaml (legacy)"] = 1026,
    rumdl = 671,
    runny = 670,
    rustfmt = 672,
    sake = 1115,
    samt = 674,
    samtrc = 675,
    ["sarif-1.0.0.json"] = 677,
    ["sarif-2.0.0.json"] = 678,
    ["sarif-2.1.0"] = 688,
    ["sarif-2.1.0-rtm.2"] = 679,
    ["sarif-2.1.0-rtm.3"] = 681,
    ["sarif-2.1.0-rtm.4"] = 683,
    ["sarif-2.1.0-rtm.5"] = 685,
    ["sarif-2.1.0-rtm.6"] = 686,
    ["sarif-external-property-file-2.1.0"] = 689,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 680,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 682,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 684,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 687,
    ["scalingo.json configuration"] = 690,
    ["schema.org - Action"] = 692,
    ["schema.org - ContactPoint"] = 693,
    ["schema.org - Place"] = 694,
    ["schema.org - Thing"] = 695,
    ["secrethub.yml"] = 1005,
    ["semantic-release"] = 701,
    ["servicehub.config.json"] = 860,
    ["servicehub.service.json"] = 859,
    ["settings.job"] = 704,
    ["sfdx-hardis configuration"] = 706,
    ["shard.yml"] = 1043,
    ["size-limit configuration"] = 711,
    ["skaffold.yaml"] = 928,
    ["skyuxconfig.json"] = 713,
    ["snowflake-config"] = 715,
    ["snowflake-connections"] = 716,
    ["spicepod.yaml"] = 1063,
    ["sqlc configuration"] = 748,
    ["stripe-app-local.json"] = 759,
    ["stripe-app.json"] = 758,
    swcrc = 913,
    ["task.json"] = 768,
    taskcat = 878,
    ["template.json"] = 773,
    ["templatsources.json"] = 774,
    ["theme.json"] = 777,
    ["tizen_workspace.json"] = 779,
    tldr = 780,
    ["tm_devices configuration file"] = 1126,
    tmuxinator = 863,
    ["transcend.yml"] = 790,
    ["tree-sitter grammar.json"] = 374,
    ["trime.yaml"] = 791,
    ["trunk.yaml"] = 793,
    ["ts-force-config.json"] = 798,
    ["tsconfig.json"] = 794,
    ["tsd.json"] = 795,
    ["tsdoc.json"] = 796,
    ["tsdrc.json"] = 797,
    ...
    ["vega-lite.json"] = 822,
    ["vega.json"] = 821,
    ["venvironment-basic.yaml"] = 825,
    ["venvironment.yaml"] = 824,
    ["venvplus-basic.yaml"] = 827,
    ["venvplus.yaml"] = 826,
    version = 1108,
    ["version.json"] = 829,
    ["vhwdebugger-binding.yaml"] = 831,
    ["vim-addon-info"] = 832,
    ["vs-2017.3.host.json"] = 834,
    ["vs-nesting.json"] = 835,
    ["vsls.json"] = 833,
    ["vss-extension.json"] = 839,
    vtcfg = 1114,
    ["vtesttree.yaml"] = 840,
    ["vtestunit.yaml"] = 841,
    ["warp-keysets.json"] = 1011,
    ["warp-themes.json"] = 1012,
    ["warp-workflows.json"] = 1013,
    ["webhint.io"] = 968,
    ["webjobpublishsettings.json"] = 846,
    ["webjobs-list.json"] = 845,
    ["well-known-fursona"] = 1050,
    ["xs-app.json"] = 873,
    ["xunit.runner.json"] = 858,
    yamllint = 901,
    zuul = 884,
    ["Žinoma"] = 894
  },
