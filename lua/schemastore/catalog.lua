...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 996,
    [".nodehawkrc"] = 628,
    [".npmpackagejsonlintrc"] = 632,
    [".omletrc"] = 1177,
    [".phrase.yml"] = 710,
    [".phraseapp.yml"] = 711,
    [".pmbot.yml"] = 695,
    [".postcssrc"] = 704,
    [".powerpages-web-template-manifest"] = 706,
    [".pre-commit-config.yml"] = 707,
    [".pre-commit-hooks.yml"] = 708,
    [".putout.json"] = 744,
    [".rehyperc"] = 769,
    [".remarkrc"] = 773,
    [".sprite files"] = 869,
    ...
    AIConfig = 37,
    ["AMX Muse Program Descriptor"] = 1226,
    ["API Builder"] = 1032,
    ["AVA Configuration"] = 1096,
    ...
    ["AWS Copilot Manifest"] = 1265,
    ["AWS SAM CLI Samconfig"] = 278,
    Acton = 1316,
    ["Adobe UXP Manifest"] = 1159,
    ["Aerleon Network & Service Definitions"] = 23,
    ["Aerleon Policy"] = 24,
    ["Agent Permission Policy"] = 1305,
    ["AgentCore CLI"] = 1306,
    AgentLoopKit = 1307,
    Aider = 1255,
    Air = 26,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1276,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1275,
    ["Airlock Microgateway"] = 38,
    ["Alacritty Configuration"] = 1068,
    ["AlgoVoi Compliance Receipt v1"] = 13,
    ["All Contributors configuration file"] = 1122,
    Anodizer = 454,
    ...
    ["Application list for a WinUtil"] = 1205,
    ArchitectFX = 1210,
    ["Argo CD"] = 57,
    ["Argo Events"] = 58,
    ["Argo Workflows"] = 59,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1274,
    ["Azure IoT Operations connector metadata"] = 1271,
    ...
    ["Azure Pipelines"] = 117,
    ["Azure Static Web Apps CLI configuration file"] = 873,
    ["Azure Static Web Apps configuration file"] = 872,
    BMML = 1293,
    ["BOSH CPI Config"] = 143,
    ...
    ["Bacon config"] = 7,
    ["Barba-CV"] = 86,
    ["Bashly (bashly.yml)"] = 1126,
    ["Bashly Settings (bashly-settings.yml)"] = 1127,
    Bento = 1292,
    ["Better Code Hub"] = 1037,
    ["Better Scripts"] = 166,
    Bigconfig = 136,
    ["Biome Formatter Config"] = 87,
    ["Bitmovin Encoding Template"] = 1219,
    BizTalkServerApplicationSchema = 1003,
    Bleep = 167,
    ["Block Protocol Metadata"] = 164,
    ["Bluebricks blueprint config"] = 1298,
    ["Boyka Framework"] = 145,
    ...
    ["Butane Config"] = 1081,
    C4InterFlow = 1234,
    ["CDK Environment Manager, concrete environment configuration"] = 1258,
    ["CDK Environment Manager, concrete environments definition"] = 1257,
    ["CDK Environment Manager, environment definition"] = 1256,
    ["CGS Card Game Specification (cgs.json)"] = 1164,
    ["CICS TS region tagging"] = 1090,
    ["CICS TS resource import"] = 1091,
    ["CICS TS resource model"] = 1092,
    ["CICS TS resource overrides"] = 1093,
    ["CMake Presets"] = 168,
    ["CNC Codes"] = 190,
    ["CRS WAF test file"] = 1194,
    ["CRS WAF test platform overrides file"] = 1195,
    ...
    ["Caido Proxy Configuration"] = 1330,
    ...
    ["Chamaleon environment"] = 1223,
    ["Chamaleon properties"] = 1224,
    ["Chamaleon template"] = 1222,
    Changepacks = 1285,
    Changesets = 287,
    Changie = 177,
    Charmcraft = 178,
    ...
    ["Clawject config"] = 196,
    ["Cloud Foundry Application Manifest"] = 1176,
    ["Cloud Run Spec v1"] = 1200,
    ...
    Concord = 1193,
    ["Configu .cfgu files"] = 1181,
    ["Configu .configu file"] = 1182,
    Conjure = 189,
    ["Container Structure Test"] = 1017,
    Containerlab = 1046,
    ["Contextive Glossary"] = 1250,
    ContractGuard = 1047,
    Convex = 188,
    ...
    ["Cursor Agent Environment"] = 1303,
    ["Custom Machinery Machine"] = 1165,
    ["Custom Machinery Recipe"] = 1166,
    ...
    ["DonateCaseBetterCasino menu"] = 1227,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1134,
    ["EAS config"] = 386,
    ["ECA - Editor Code Assistant"] = 350,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1123,
    ["ESLint Suppressions"] = 391,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1270,
    ["EasyVCR .NET"] = 388,
    ["Eidolon Resource"] = 1211,
    ...
    ["Envelope Team Definition"] = 1315,
    ["Envilder Map File"] = 354,
    ["Erda Pipeline"] = 1172,
    ["Erda Runtime"] = 1173,
    ["Espanso config.yml"] = 1296,
    ["Espanso match.yml"] = 1295,
    Esquio = 374,
    ["Estuary Flow Catalog"] = 1087,
    ["Ethereum ERC1155"] = 1309,
    ["Ethereum ERC721"] = 1308,
    ...
    ["Evolving Resolutive Process notation"] = 1272,
    ["Expo SDK"] = 385,
    ...
    ["GeoJSON.json latest"] = 1085,
    GherKing = 1089,
    ["GitHub Action"] = 423,
    ["GitHub Actions typing"] = 1207,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 1161,
    GitVersion = 420,
    ...
    ["Google Digital Assetlinks"] = 1251,
    Goreleaser = 452,
    ["Goreleaser Pro"] = 453,
    Goss = 455,
    ["Gradle Build Cache Node"] = 1035,
    ["Gradle Enterprise"] = 1034,
    ...
    Hadolint = 1013,
    Hammerkit = 1045,
    ["Hardware Sentry Configuration"] = 1101,
    ...
    ["JFrog File Spec"] = 509,
    ["JFrog Pipelines YML DSL"] = 1111,
    ["JMeter DSL cli config"] = 510,
    JReleaser = 513,
    ["JSON Document Transform"] = 521,
    ["JSON Feed"] = 522,
    ["JSON Resume"] = 781,
    ["JSON Schema Draft 2020-12"] = 981,
    ["JSON Schema Draft 4"] = 978,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1144,
    ["JSON Schema Draft 7"] = 979,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1145,
    ["JSON Schema Draft 8 (2019-09)"] = 980,
    ["JSON-API"] = 520,
    ["JSON-e templates"] = 1042,
    ["JSON-stat 2.0"] = 974,
    JSONPatch = 524,
    ...
    ["Jujutsu (jj) VCS config"] = 1264,
    ["KIMMDY config file"] = 535,
    ["KODE/CI build.yaml"] = 1107,
    ["KSP-AVC"] = 975,
    ["KSP-CKAN"] = 976,
    ["KSP-NetKAN"] = 977,
    KSY = 1174,
    ...
    ["Lando (landofile)"] = 113,
    ["LangGraph Platform configuration"] = 1186,
    ["Language configuration"] = 1185,
    Lefthook = 551,
    ["Liferay client-extension.yaml"] = 558,
    ["LinkML Metamodel"] = 560,
    Liquibase = 1052,
    ["Liquibase Flow File"] = 1053,
    ["Lively Properties"] = 561,
    ["Lobe AI Agent"] = 115,
    Loki = 116,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 604,
    ["MS2Rescore Configuration"] = 609,
    ["Madness (madness.yml)"] = 1125,
    ["Mado configuration"] = 568,
    ["Maestro Flow"] = 569,
    ["Mail Servers Configuration"] = 1299,
    ["MapEHR Mapping"] = 570,
    Markdownlint = 1056,
    ["Mason Registry"] = 1059,
    ...
    ["Mergify Configuration"] = 610,
    ["Metadata for a Bazel module"] = 576,
    ["Metadata for a Cinnamon spice"] = 1203,
    ["Metatype Configuration"] = 577,
    ["MetricsHub Configuration"] = 578,
    ["MetricsHub Connector Configuration"] = 579,
    ["Micro Editor Syntax"] = 1135,
    ["Microsoft Band Web Tile"] = 580,
    ["Microsoft RulesEngine workflow rules"] = 1190,
    ["Microsoft RulesEngine workflow rules list"] = 1191,
    ["Minecraft Custom Main Menu Mod"] = 1153,
    ...
    ModuleAssembler = 602,
    ["Monade CLI Stack Configuration"] = 613,
    ["MongoDB Atlas Search Index Definition"] = 1106,
    ["Monika Configuration"] = 1104,
    ["Monoweave Configuration"] = 608,
    ["Motif config"] = 995,
    MultiQC = 1244,
    ["NOX Framework (Service)"] = 631,
    ["Netin Diagnostic System Template"] = 1063,
    ["Netlify config"] = 616,
    ["Network-as-Code Data Model"] = 617,
    ["Next Gen UI Agent A2A Server Configuration"] = 618,
    ["Next Gen UI Agent Configuration"] = 620,
    ["Next Gen UI Agent MCP Server Configuration"] = 619,
    ["Nightwatch.js"] = 624,
    ["Node.js configuration"] = 1000,
    ["NueJS configuration file"] = 636,
    ["Nuitka Package Config"] = 1167,
    ["Nullstone config"] = 638,
    ["ONe's changelog entry"] = 657,
    ["ONe's service descriptor"] = 656,
    ["ORT Server repository environment configuration"] = 667,
    ["OSCAL Assessment Plan (AP)"] = 669,
    ["OSCAL Assessment Results (AR)"] = 670,
    ["OSCAL Catalog"] = 671,
    ["OSCAL Component Definition (CDef)"] = 672,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 673,
    ["OSCAL Profile"] = 674,
    ["OSCAL System Security Plan (SSP)"] = 675,
    ["OSS Review Toolkit configuration"] = 676,
    ["OSS Review Toolkit curation"] = 677,
    ["OSS Review Toolkit package configuration"] = 678,
    ["OSS Review Toolkit project package manager definition"] = 679,
    ["OSS Review Toolkit repository configuration"] = 680,
    ["OSS Review Toolkit resolutions"] = 681,
    ["October CMS columns"] = 642,
    ["October CMS fields"] = 643,
    ["Oh My Posh"] = 645,
    Okteto = 646,
    ["Ona Automations"] = 648,
    Opctl = 998,
    ["Open Data Contract Standard (ODCS)"] = 661,
    ["Open Data Product Standard (ODPS)"] = 662,
    ["Open Know-How"] = 1249,
    OpenDecree = 1313,
    ["OpenDecree Configuration"] = 1314,
    ["OpenRewrite Resource"] = 659,
    OpenSRM = 663,
    OpenStatus = 1260,
    ["OpenTelemetry Declarative Configuration"] = 660,
    ["OpenUtau character yaml"] = 653,
    ["OpenUtau ustx"] = 654,
    ["OpenWeather Current Weather API"] = 1041,
    ["OpenWeather Road Risk API"] = 1040,
    ["Ory Hydra configuration"] = 480,
    ["Ory Keto configuration"] = 543,
    ["Ory Kratos configuration"] = 668,
    ["Ory Oathkeeper configuration"] = 640,
    ["Outblocks App configuration"] = 665,
    ["Outblocks database table"] = 666,
    ["Outblocks project configuration"] = 664,
    PDM = 689,
    POPxf = 701,
    ["POPxf Correlations"] = 702,
    ["PRML manifest"] = 709,
    Packer = 685,
    PactSpec = 686,
    Panache = 687,
    Pantsbuild = 1121,
    ["Paper paper-plugin.yml"] = 688,
    ["Pipeline component"] = 1054,
    ["Platform.sh application"] = 9,
    ["Platform.sh routes"] = 10,
    ["Platform.sh services"] = 11,
    ["Plex Prerolls"] = 699,
    ["PocketMine plugin.yml"] = 696,
    ["Podman Desktop Extension"] = 1332,
    ["Postman collection"] = 705,
    ["Power Pages Configuration"] = 1261,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1206,
    ["ProActions AI-Kit Configuration"] = 717,
    ["ProActions AI-Kit Configuration for Menus"] = 719,
    ["ProActions AI-Kit Configuration for Sections"] = 721,
    ["ProActions AI-Kit Configuration for Services"] = 718,
    ["ProActions AI-Kit Configuration for Steps"] = 722,
    ["ProActions AI-Kit Configuration for Templates"] = 720,
    ["Problem object RFC9457"] = 1150,
    ["Problem package format"] = 723,
    ["Problem package generators"] = 724,
    ["Problem package submissions"] = 725,
    ["Problem package test group metadata"] = 726,
    Pterodactyl = 1100,
    ["Pull Request Labeler"] = 743,
    Pulumi = 751,
    ["PyGTA Config"] = 747,
    PyProject = 752,
    Pylock = 1252,
    Pyright = 753,
    ["Python script metadata"] = 1246,
    ["QType AI DSL"] = 756,
    Qgoda = 755,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1324,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1322,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1328,
    ["Qlik Talend Cloud Pipeline - Project"] = 1320,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1323,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1325,
    ["Qlik Talend Cloud Pipeline - Task"] = 1321,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1327,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1326,
    Qodana = 1073,
    ["Qt Creator workspace file"] = 1183,
    ["Quali Torque Blueprint Spec 2"] = 1098,
    ["QueryFirst config file"] = 1117,
    ["QuikRun Configuration"] = 1329,
    ["Qwen Code Settings"] = 1310,
    ["RKE Cluster Configuration JSON"] = 1051,
    ["RKE Cluster Configuration YAML"] = 1050,
    RadioHound = 746,
    ["Raid Profile"] = 1311,
    ["Raid Repo Configuration"] = 1312,
    Railpack = 758,
    Railway = 757,
    ["Rancher Fleet"] = 748,
    ["Rattler-build"] = 759,
    Ray = 1012,
    ["Read the Docs"] = 750,
    ["Red-DiscordBot Cog"] = 766,
    ["Red-DiscordBot Cog Repo"] = 767,
    ["Red-DiscordBot Trivia"] = 768,
    ["Releasaurus Config"] = 6,
    ReleaseKit = 5,
    ["Render Blueprints"] = 1049,
    RenderCV = 785,
    Renovate = 782,
    ["Renovate global configuration"] = 783,
    ["Renovate inherited configuration"] = 784,
    ["Replit config"] = 774,
    Restate = 1239,
    ["Revel Digital Gadget Definition File"] = 1263,
    RoadRunner = 787,
    ["Robust Station Image"] = 1269,
    Rockcraft = 788,
    ["Roo Coder Custom Modes"] = 789,
    Rubocop = 778,
    ["Rudder techniques"] = 1157,
    Ruff = 779,
    ["Rust Project"] = 780,
    ["Rust toolchain"] = 794,
    ["SDMX data message"] = 821,
    ["SDMX metadata message"] = 820,
    ["SDMX structure message"] = 819,
    ["SIL Kit Participant Configuration"] = 831,
    ["SIL Kit Registry Configuration"] = 832,
    ["SPDX 2.3"] = 870,
    SWADL = 886,
    ["Safebox Config"] = 1112,
    ["Sapphire CLI Config"] = 797,
    ["SauceCTL Configuration"] = 1060,
    Scarb = 817,
    ["Schema Catalog"] = 812,
    ["Scoop manifest"] = 818,
    ["Semantic Data Fabric (SDF) file"] = 822,
    ["Semgrep Rule"] = 824,
    ["Serenity Code Generator (Sergen)"] = 825,
    ["Serverless Framework Configuration"] = 1067,
    ["Serverless Workflow"] = 1069,
    ["Settings for a Cinnamon spice"] = 1202,
    ["Settings.paf"] = 827,
    ["Shopware 6 Configuration"] = 1070,
    ["Shopware CLI Extension Store Configuration"] = 1071,
    ["Shopware CLI Project Store Configuration"] = 1072,
    ["Sigma Detection Rule"] = 829,
    ["SigmaCV CV"] = 1,
    ["Sigrid scope configuration file"] = 830,
    ["SkyPilot Task JSON"] = 1158,
    ["Slack app manifest"] = 834,
    Snapcraft = 836,
    ["Solarxy project config"] = 839,
    Solidarity = 840,
    ["Solution filters"] = 841,
    ["Source Maps v3"] = 842,
    Sourcery = 843,
    ["Spack bootstrap.yaml"] = 844,
    ["Spack cdash.yaml"] = 845,
    ["Spack ci.yaml"] = 846,
    ["Spack compilers.yaml"] = 847,
    ["Spack concretizer.yaml"] = 848,
    ["Spack config.yaml"] = 849,
    ["Spack definitions.yaml"] = 850,
    ["Spack develop.yaml"] = 851,
    ["Spack env_vars.yaml"] = 852,
    ["Spack environment"] = 858,
    ["Spack include.yaml"] = 853,
    ["Spack mirrors.yaml"] = 854,
    ["Spack modules.yaml"] = 855,
    ["Spack packages.yaml"] = 856,
    ["Spack repos.yaml"] = 857,
    ["Spack toolchains.yaml"] = 859,
    ["Spack upstreams.yaml"] = 860,
    ["Spack view.yaml"] = 861,
    ["Speakeasy Generation Config File"] = 865,
    ["Speakeasy Lint Configuration File"] = 862,
    ["Speakeasy Test Generation Configuration File"] = 863,
    ["Speakeasy Workflow File"] = 864,
    SpecIF = 866,
    ["Specmatic Configuration"] = 867,
    ["Sponge Mixin configuration"] = 868,
    StackBlitz = 874,
    ["StackHawk Scanner Configuration"] = 1066,
    Stale = 875,
    Starfish = 876,
    ["Starlake Data Pipeline"] = 1038,
    Starship = 877,
    ["Statamic Blueprint"] = 878,
    ["Stella configuration file"] = 879,
    ["Streamlit configuration file"] = 880,
    ["Stryker Mutator"] = 883,
    ["StyleCop Analyzers Configuration"] = 884,
    ["Stylelint (.stylelintrc)"] = 885,
    ["Stylua Config"] = 1253,
    ["Sublime Syntax"] = 1113,
    ["Subsquid squid manifest"] = 1160,
    ["Swagger API 2.0"] = 887,
    ["Synadia Connect Component"] = 888,
    TSON = 924,
    TSTyche = 925,
    ["TYPO3 Vendor Bundler config"] = 931,
    ["Tab data for a LinUtil"] = 1209,
    ["Tab list for a LinUtil"] = 1208,
    Tach = 889,
    ["Tach Domain"] = 890,
    Talhelper = 892,
    ["Talisman configuration"] = 893,
    Taplo = 1254,
    ["Taskfile config"] = 1043,
    Taurus = 894,
    Tauticord = 895,
    ["Tekton Pipeline"] = 1282,
    ["Tekton PipelineRun"] = 1283,
    ["Tekton Task"] = 1280,
    ["Tekton TaskRun"] = 1281,
    Telefonistka = 1240,
    ["Terrateam config"] = 1266,
    ["TestEnvironment.json"] = 907,
    ["TextMate Grammar"] = 906,
    Threagile = 901,
    ["Tier.run pricing.json"] = 898,
    Tikibase = 899,
    Tombi = 904,
    ["Traefik v2"] = 910,
    ["Traefik v2 File Provider"] = 911,
    ["Traefik v3"] = 912,
    ["Traefik v3 File Provider"] = 913,
    ["Travis CI (.travis.yml)"] = 909,
    Treefmt = 458,
    Trident = 1236,
    ["TrueScript for *.tscript files"] = 916,
    ["Tugboat QA config.yml"] = 1233,
    TunnelHub = 1148,
    Turborepo = 908,
    Tycho = 1197,
    Tye = 1074,
    ["Tyk Gateway - Open Source v5.7+"] = 1245,
    ["UET BuildConfig.json"] = 1118,
    ["UI5 Manifest"] = 937,
    ["UNCORS configuration"] = 942,
    ["UTAM Page Object"] = 940,
    ["Ubuntu Server Autoinstall"] = 935,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1237,
    ["Uniswap Token List"] = 1023,
    ["Universal Schedule Format"] = 943,
    ["Unreal Engine Uplugin"] = 1119,
    ["Unreal Engine Uproject"] = 1120,
    ["UpCloud CLI (upctl) configuration"] = 1238,
    ["Updatecli Compose"] = 1082,
    ["Updatecli Policy Manifest"] = 1083,
    ["Updatecli Policy Metadata"] = 1084,
    Uplift = 1116,
    ["Upsun config"] = 8,
    ["User Journey Map"] = 1048,
    V2Ray = 1088,
    ["VSCode Code Snippets"] = 262,
    ["VSIX CLI publishing"] = 961,
    Vector = 945,
    ["Vela Pipeline Configuration"] = 948,
    Vercel = 261,
    ["Version Bumper config"] = 951,
    Vespertide = 1287,
    ["Vespertide Migration"] = 1288,
    ["Vespertide Model"] = 1289,
    ["Viash Component Config"] = 1242,
    ["Viash Package Config"] = 1243,
    Visivo = 1146,
    ["WP-CLI"] = 971,
    Wake = 1235,
    ["Waku Config"] = 1212,
    ["Web App Manifest"] = 967,
    ["Web types"] = 970,
    WebExtensions = 966,
    ["Webman package recipe"] = 1094,
    ["Windows Package Manager Installer Manifest"] = 1020,
    ["Windows Package Manager Locale Manifest"] = 1021,
    ["Windows Package Manager Singleton Manifest"] = 1019,
    ["WireMock CLI import configuration"] = 1218,
    ["WireMock CLI local service configuration"] = 1217,
    ["WireMock message stub mapping"] = 1216,
    ["WireMock stub mapping"] = 1215,
    ["Woodpecker pipeline config"] = 1062,
    ["Wrangler CLI"] = 972,
    ["XenForo add-on manifest"] = 973,
    ["Xstate Machine"] = 1080,
    ["Yandex Workflow Language"] = 1204,
    ["Yarn Config (.yarnrc.yml)"] = 1036,
    ["Yippee-Ki-JSON configuration YML"] = 1027,
    ["YouTrack App"] = 1201,
    ["Zarf Package Configuration"] = 1268,
    ["Zerops import file"] = 1189,
    ["Zola Configuration"] = 1279,
    ["aerleon.yml"] = 22,
    ["amplify.yml"] = 15,
    ["amxx-builder manifest"] = 1331,
    ["angular.json"] = 39,
    apko = 1151,
    ...
    ["behat.yml"] = 146,
    ["bigquery-table"] = 135,
    ["bioimageio resource description"] = 1168,
    ...
    ["cargo-nextest repository configuration"] = 621,
    ["cargo-nextest user configuration"] = 622,
    ["ccmod.json"] = 1213,
    changelogging = 1180,
    ...
    ["chutzpah.json"] = 270,
    cibuildwheel = 183,
    ["clang-format (.clang-format)"] = 1086,
    ["clang-tidy"] = 245,
    clangd = 244,
    clib = 246,
    ...
    ["crowdin.yml"] = 296,
    ["ctfd-setup configuration file"] = 1225,
    ["custom-elements.json"] = 1138,
    ["cypress.json"] = 300,
    ["dacier.yml"] = 1319,
    ...
    ["gematik health care insurance list"] = 1231,
    ["gematik health care patient list"] = 1228,
    ["gematik health care provider institution list"] = 1230,
    ["gematik health care provider list"] = 1229,
    ["gematik tiger test environment configuration"] = 1232,
    ["git-town.toml"] = 1277,
    ["gitlab-ci"] = 432,
    ["global.json"] = 448,
    ...
    ["lint-staged (.lintstagedrc)"] = 989,
    ["local.settings.json"] = 564,
    ["localazy.json"] = 565,
    ["lotus.yaml"] = 563,
    ["lsdlschema.json"] = 566,
    ["macro.json"] = 1103,
    ["markdown-link-check"] = 1057,
    maturin = 1058,
    mboats = 1065,
    memnex = 1317,
    ["micro-settings.json"] = 1130,
    ["mimetypes.json"] = 581,
    ["mirrord config"] = 991,
    mise = 992,
    ["mkdocs.yml"] = 601,
    ...
    ["monospace.yml"] = 607,
    ["moon.yml"] = 1214,
    ["mprocs Configuration file"] = 1184,
    ["mrdocs.yml"] = 603,
    ["mta.yaml"] = 993,
    ["mtad.yaml"] = 994,
    ["mycode.json"] = 614,
    nFPM = 623,
    ["napari plugin manifest"] = 615,
    neoload = 1006,
    ["nest-cli"] = 626,
    ["nexus-rpc-gen"] = 1304,
    ["ninjs (News in JSON)"] = 625,
    ["nitro.json"] = 1005,
    ["nixd configuration"] = 1156,
    ["nlu.json"] = 627,
    ["nodemon.json"] = 629,
    ["noodl config"] = 1064,
    ["notebook.mod.json"] = 630,
    now = 1001,
    ["npm-badges"] = 633,
    ["nswag.json"] = 637,
    ntangle = 639,
    ["nuclei-template.yaml"] = 634,
    ["nuget-project.json"] = 635,
    ["ocelot.json"] = 641,
    ogen = 644,
    ["omnisharp.json"] = 647,
    openHAB = 1290,
    ...
    oxlint = 1301,
    ["package.json"] = 682,
    ["package.manifest"] = 684,
    ["package.yaml"] = 683,
    ["partial-black.json"] = 147,
    ["partial-fastapi.json"] = 148,
    ["partial-pixi.json"] = 694,
    ["partial-scheduled.json"] = 149,
    ["pattern.json"] = 692,
    ["petstore-v1.0"] = 1110,
    pgap_yaml_input_reader = 690,
    pgrls = 691,
    pgxgen = 1294,
    pitcms = 1297,
    ["pixi.toml"] = 693,
    ["plagiarize-me.yaml"] = 698,
    ["plagiarize.yaml"] = 697,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1221,
    ["podbard.yaml"] = 700,
    ["portman.json"] = 703,
    ["prefect.toml"] = 712,
    ["prefect.yaml"] = 713,
    ...
    ["prettierrc.json"] = 715,
    ["prisma.yml"] = 716,
    ["project-1.0.0-beta3.json"] = 728,
    ["project-1.0.0-beta4.json"] = 729,
    ["project-1.0.0-beta5.json"] = 730,
    ["project-1.0.0-beta6.json"] = 731,
    ["project-1.0.0-beta8.json"] = 732,
    ["project-1.0.0-rc1.json"] = 733,
    ["project-1.0.0-rc2.json"] = 734,
    ["project.json"] = 727,
    ["project.owasp.yaml"] = 735,
    ["prometheus-alertmanager.json"] = 739,
    ["prometheus.json"] = 736,
    ["prometheus.rules.json"] = 737,
    ["prometheus.rules.test.json"] = 738,
    ["proxies.json"] = 740,
    ["publiccode.yml"] = 741,
    ["pubspec.yaml"] = 742,
    ["pyrseas-0.8.json"] = 745,
    pytest = 754,
    ["quilt.mod.json"] = 1131,
    ["rc3 auth"] = 760,
    ["rc3 collection"] = 761,
    ...
    ["rc3 settings"] = 765,
    ["registry.yaml"] = 52,
    ["release drafter"] = 1007,
    ["release-hub.json"] = 4,
    ["release-please-config.json"] = 770,
    ["release-please-manifest.json"] = 771,
    ["release-plz.toml"] = 772,
    ["renv.lock"] = 786,
    ["reposets Configuration"] = 775,
    ["reposets Credentials"] = 776,
    ["revola.json"] = 2,
    ["rivet.json"] = 1155,
    ["rivet.yaml (legacy)"] = 1154,
    rumdl = 791,
    runny = 790,
    runspec = 1318,
    rustfmt = 792,
    ...
    samt = 795,
    samtrc = 796,
    ["sarif-1.0.0.json"] = 798,
    ["sarif-2.0.0.json"] = 799,
    ["sarif-2.1.0"] = 809,
    ["sarif-2.1.0-rtm.2"] = 800,
    ["sarif-2.1.0-rtm.3"] = 802,
    ["sarif-2.1.0-rtm.4"] = 804,
    ["sarif-2.1.0-rtm.5"] = 806,
    ["sarif-2.1.0-rtm.6"] = 807,
    ["sarif-external-property-file-2.1.0"] = 810,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 801,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 803,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 805,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 808,
    ["scalingo.json configuration"] = 811,
    ["schema.org - Action"] = 813,
    ["schema.org - ContactPoint"] = 814,
    ["schema.org - Place"] = 815,
    ["schema.org - Thing"] = 816,
    ["secrethub.yml"] = 1133,
    ["semantic-release"] = 823,
    ["servicehub.config.json"] = 984,
    ["servicehub.service.json"] = 983,
    ["settings.job"] = 826,
    ["sfdx-hardis configuration"] = 828,
    ["shard.yml"] = 1171,
    ["size-limit configuration"] = 833,
    ["skaffold.yaml"] = 1055,
    ["skyuxconfig.json"] = 835,
    ["snowflake-config"] = 837,
    ["snowflake-connections"] = 838,
    ["spicepod.yaml"] = 1192,
    ["sqlc configuration"] = 871,
    ["stripe-app-local.json"] = 882,
    ["stripe-app.json"] = 881,
    swcrc = 1039,
    ["task.json"] = 891,
    taskcat = 1002,
    ["template.json"] = 896,
    ["templatsources.json"] = 897,
    ["text2confl config"] = 1302,
    ["theme.json"] = 900,
    ["tizen_workspace.json"] = 902,
    tldr = 903,
    ["tm_devices configuration file"] = 1259,
    tmuxinator = 987,
    tox = 905,
    ["transcend.yml"] = 914,
    ...
    ["vega-lite.json"] = 947,
    ["vega.json"] = 946,
    ["venvironment.yaml"] = 949,
    ["venvplus.yaml"] = 950,
    version = 1241,
    ["version.json"] = 952,
    ["vhwdebugger-binding.yaml"] = 954,
    ["vim-addon-info"] = 955,
    ["vs-2017.3.host.json"] = 957,
    ["vs-nesting.json"] = 958,
    ["vsls.json"] = 956,
    ["vss-extension.json"] = 962,
    vtcfg = 1247,
    ["vtesttree.yaml"] = 963,
    ["vtestunit.yaml"] = 964,
    ["warp-keysets.json"] = 1139,
    ["warp-themes.json"] = 1140,
    ["warp-workflows.json"] = 1141,
    ["webhint.io"] = 1095,
    ["webjobpublishsettings.json"] = 969,
    ["webjobs-list.json"] = 968,
    ["well-known-fursona"] = 1179,
    ["xs-app.json"] = 997,
    ["xunit.runner.json"] = 982,
    yamlfmt = 1024,
    yamllint = 1025,
    ["yap.json"] = 1026,
    ["zerops.yml"] = 1188,
