...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 194,
    [".cryproj (generic)"] = 657,
    [".cryproj engine-5.2"] = 652,
    [".cryproj engine-5.3"] = 653,
    [".cryproj engine-5.4"] = 654,
    [".cryproj engine-5.5"] = 655,
    [".cryproj engine-dev"] = 656,
    [".eslintrc"] = 249,
    [".esmrc.json"] = 241,
    [".ffizer.yaml"] = 253,
    [".htmlhintrc"] = 309,
    ...
    [".mtaext"] = 668,
    [".nodehawkrc"] = 419,
    [".npmpackagejsonlintrc"] = 422,
    [".phrase.yml"] = 468,
    [".phraseapp.yml"] = 469,
    [".pmbot.yml"] = 458,
    [".postcssrc"] = 463,
    [".powerpages-web-template-manifest"] = 465,
    [".pre-commit-config.yml"] = 466,
    [".pre-commit-hooks.yml"] = 467,
    [".putout.json"] = 488,
    [".rehyperc"] = 501,
    [".remarkrc"] = 503,
    [".sprite files"] = 561,
    ...
    ["<div>RIOTS' studio configuration"] = 635,
    ["@factorial/drupal-breakpoints-css"] = 4,
    ["A micro editor config"] = 373,
    AIConfig = 11,
    ["API Builder"] = 700,
    ["AVA Configuration"] = 760,
    ["AWS CDK cdk.json"] = 178,
    ["AWS CloudFormation"] = 179,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 180,
    ["AWS SAM CLI Samconfig"] = 181,
    ["Adobe UXP Manifest"] = 825,
    ["Aerleon Network & Service Definitions"] = 7,
    ["Aerleon Policy"] = 8,
    ["Airlock Microgateway"] = 12,
    ["Airplane task"] = 13,
    ["Alacritty Configuration"] = 732,
    ["All Contributors configuration file"] = 790,
    ...
    ["Azure Pipelines"] = 64,
    ["Azure Static Web Apps CLI configuration file"] = 564,
    ["Azure Static Web Apps configuration file"] = 563,
    ["BX CI"] = 102,
    ["Bashly (bashly.yml)"] = 794,
    ["Bashly Settings (bashly-settings.yml)"] = 795,
    ["Better Code Hub"] = 704,
    ["Better Scripts"] = 103,
    Bigconfig = 81,
    BizTalkServerApplicationSchema = 674,
    Bleep = 104,
    ...
    ["Butane Config"] = 745,
    ["CGS Custom Card Game (CardGameDef.json)"] = 830,
    ["CICS TS region tagging"] = 754,
    ["CICS TS resource import"] = 755,
    ["CICS TS resource model"] = 756,
    ["CICS TS resource overrides"] = 757,
    ["CMake Presets"] = 105,
    ["CNC Codes"] = 117,
    ["CSS Comb (.csscomb.json)"] = 196,
    ["CSS Lint (.csslintrc)"] = 197,
    ["CSpell (cspell.json)"] = 195,
    CWL = 836,
    ...
    Cheatsheets = 742,
    ["Chrome Extension"] = 171,
    ["Chromia Model"] = 112,
    ["CircleCI config.yml"] = 148,
    ["Citation File Format"] = 183,
    CityJSON = 114,
    ["Clawject config"] = 122,
    ["Code Climate"] = 149,
    CodeCV = 61,
    ["CodeShip Pro services configuration files"] = 160,
    ["CodeShip Pro steps configuration files"] = 161,
    ["Codecov configuration files"] = 159,
    Codux = 157,
    ["Cog config file"] = 118,
    ["Commandbox Box.json"] = 119,
    ["Commandbox Server.json"] = 120,
    ["Common Catalog Data"] = 169,
    Conjure = 116,
    ["Container Structure Test"] = 687,
    Containerlab = 712,
    ["Crowdsec collection config"] = 190,
    ["Crowdsec parser config"] = 191,
    ["Crowdsec scenario config"] = 192,
    ["CumulusCI Config"] = 121,
    ["Custom Machinery Machine"] = 831,
    ["Custom Machinery Recipe"] = 832,
    ["Cycle Stack File"] = 123,
    ["DWP Exchange - catalogue entry"] = 236,
    ["DWP Exchange - gateway"] = 234,
    ["DWP Exchange - meta"] = 235,
    ["Dart Build Config (dart-build.json)"] = 198,
    ["Dart Test Config (dart-test.json)"] = 199,
    ["DashLord Configuration"] = 200,
    ["Data Contract Specification"] = 201,
    ["DataYoga Connections"] = 124,
    ["DataYoga Job"] = 125,
    ["Databricks Asset Bundles"] = 811,
    ["Datadog Service Definition"] = 350,
    ["Datahub Ingestion Recipe"] = 761,
    ["Dein Config"] = 127,
    ["Deno Config (deno.json)"] = 207,
    ["Dependency cruiser"] = 128,
    ["Deployer Recipe"] = 210,
    ["Deta Spacefile"] = 129,
    ["Detekt Config (detekt.yml)"] = 211,
    ["Devbox Config"] = 130,
    ["Devbox Plugin"] = 131,
    Devfile = 233,
    ["Discord Webhook"] = 212,
    ["DocFx Config (docfx.json)"] = 215,
    ["Dolittle Artifacts"] = 216,
    ["Dolittle Bounded Context Configuration"] = 217,
    ["Dolittle Event Horizons Configuration"] = 218,
    ["Dolittle Resources Configuration"] = 219,
    ["Dolittle Server Configuration"] = 220,
    ["Dolittle Tenant Map Configuration"] = 222,
    ["Dolittle Tenants Configuration"] = 221,
    ["Dolittle Topology"] = 223,
    ["Drupal Breakpoints"] = 132,
    ["Drupal Config"] = 143,
    ["Drupal Info"] = 133,
    ["Drupal Layouts"] = 134,
    ["Drupal Libraries"] = 135,
    ["Drupal Links Action"] = 136,
    ["Drupal Links Contextual"] = 137,
    ["Drupal Links Menu"] = 138,
    ["Drupal Links Task"] = 139,
    ["Drupal Migration"] = 140,
    ["Drupal Permissions"] = 141,
    ["Drupal Routing"] = 142,
    ["Drupal Services"] = 144,
    ["Drush site aliases"] = 229,
    ["Dynamic Bash Aliases (.aliases)"] = 802,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 791,
    ["Elgato Stream Deck"] = 239,
    ["Embrace Config"] = 772,
    Endurica = 815,
    ["Enterprise Contract Policy Spec"] = 240,
    ["Erda Pipeline"] = 838,
    ["Erda Runtime"] = 839,
    ["Error pages"] = 244,
    Esquio = 242,
    ["Estuary Flow Catalog"] = 751,
    ["Expo SDK"] = 247,
    ["F-Droid Data metadata"] = 252,
    ["Facets - FSDL - Application"] = 250,
    ["FasterCI Configuration"] = 65,
    FiQuS = 256,
    Firebase = 254,
    ["Flow.json Configurations"] = 835,
    ["Fossa configuration file"] = 263,
    ["Fossa's fossa-deps file"] = 264,
    ["Foundry VTT - Base package Manifest"] = 258,
    ["Foundry VTT - Module Manifest"] = 259,
    ["Foundry VTT - System Data Template"] = 262,
    ["Foundry VTT - System Manifest"] = 260,
    ["Foundry VTT - World Manifest"] = 261,
    ["Foxx Manifest"] = 66,
    ["Freifunk.de Community API"] = 69,
    ["Frogbot Config"] = 70,
    ["G2P Mapping Configuration"] = 268,
    ["GCP Blueprint Metadata"] = 271,
    Gaspar = 269,
    ["GatewayCore API Gateway"] = 270,
    ["GeoJSON.json latest"] = 749,
    GherKing = 753,
    ["GitHub Action"] = 276,
    ["GitHub Discussion"] = 277,
    ["GitHub Funding"] = 278,
    ["GitHub Issue Template configuration"] = 280,
    ["GitHub Issue Template forms"] = 279,
    ["GitHub Workflow"] = 281,
    ["GitHub Workflow Template Properties"] = 282,
    ["GitLab Agent for Kubernetes configuration"] = 827,
    GitVersion = 273,
    ["Gitea Issue Template configuration"] = 274,
    ["Gitea Issue Template forms"] = 275,
    ["Gitpod Configuration"] = 284,
    ["GlazeWM settings"] = 829,
    ["Global Privacy Control"] = 272,
    Goblet = 810,
    ["Golangci-lint Configuration"] = 286,
    ["Golangci-lint Custom Plugins Configuration"] = 287,
    ["Google Chrome Related Website Sets"] = 255,
    ["Google Cloud Workflows"] = 177,
    Goreleaser = 289,
    ["Goreleaser Pro"] = 290,
    Goss = 291,
    ["Gradle Build Cache Node"] = 702,
    ["Gradle Enterprise"] = 701,
    ["Grafana 5.x Dashboard"] = 292,
    ["GraphQL Code Generator"] = 296,
    ["GraphQL Config"] = 295,
    ["GraphQL Mesh"] = 294,
    ["Grunt JSHint task"] = 300,
    ["Grunt Watch task"] = 301,
    ["Grunt base task"] = 302,
    ["Grunt clean task"] = 298,
    ["Grunt copy task"] = 297,
    ["Grunt cssmin task"] = 299,
    HEMTT = 671,
    Hadolint = 683,
    Hammerkit = 711,
    ["Hardware Sentry Configuration"] = 765,
    Hatch = 684,
    Hayson = 304,
    ["Haystack Pipeline"] = 305,
    ["Hazelcast 5 Configuration"] = 306,
    ["Helm Chart.lock"] = 146,
    ["Helm Chart.yaml"] = 145,
    ["Helm Unittest Test Suite"] = 147,
    Hugo = 741,
    ["Hugo Theme"] = 740,
    ["IBM Zapp document"] = 311,
    ["IBM zCodeFormatSettings"] = 312,
    ["IMG Catapult PSP"] = 317,
    ["IVMS101 by CODE Protocol"] = 828,
    Istanbul = 768,
    ["JDownloader2 crawler multi-rules"] = 327,
    ["JDownloader2 crawler single-rules"] = 326,
    ["JFrog Applications Config"] = 328,
    ["JFrog File Spec"] = 329,
    ["JFrog Pipelines YML DSL"] = 774,
    ["JMeter DSL cli config"] = 330,
    JReleaser = 332,
    ["JSON Document Transform"] = 340,
    ["JSON Feed"] = 341,
    ["JSON Resume"] = 508,
    ["JSON Schema Draft 2020-12"] = 648,
    ["JSON Schema Draft 4"] = 645,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 812,
    ["JSON Schema Draft 7"] = 646,
    ["JSON Schema Draft 7 (unofficial strict)"] = 813,
    ["JSON Schema Draft 8 (2019-09)"] = 647,
    ["JSON-API"] = 339,
    ["JSON-e templates"] = 709,
    ["JSON-stat 2.0"] = 642,
    JSONPatch = 343,
    ["JSR Package Config (jsr.json)"] = 333,
    Jasmine = 322,
    Jekyll = 323,
    ["Jenkins X Pipelines"] = 324,
    ["Jenkins X Requirements"] = 325,
    ["Jovo Language Models"] = 331,
    ["KIMMDY config file"] = 348,
    ["KSP-AVC"] = 643,
    ["KSP-CKAN"] = 644,
    KSY = 840,
    ["Karakum configuration file"] = 265,
    Kas = 346,
    ["Keycloak REST API"] = 782,
    ["Knative Functions - func.yaml"] = 266,
    ["KoDE/CI build.yaml"] = 770,
    ["Kong DBLess config"] = 771,
    KrakenD = 349,
    LOOBin = 368,
    Lefthook = 357,
    ["Liferay client-extension.yaml"] = 364,
    ["LinkML Metamodel"] = 366,
    Liquibase = 717,
    ["Liquibase Flow File"] = 718,
    ["Lively Properties"] = 367,
    ["Lobe AI Agent"] = 63,
    ["MLOS Configs"] = 402,
    ["MS2Rescore Configuration"] = 405,
    ["Madness (madness.yml)"] = 793,
    Markdownlint = 721,
    ["Mason Registry"] = 723,
    ["MegaLinter configuration"] = 374,
    ["MegaLinter descriptor"] = 375,
    Melange = 819,
    ["Meltano plugin discovery definition"] = 377,
    ["Meltano project definition"] = 376,
    ["Mergify Configuration"] = 406,
    ["MetricsHub Configuration"] = 378,
    ["MetricsHub Connector Configuration"] = 379,
    ["Micro Editor Syntax"] = 803,
    ["Microsoft Band Web Tile"] = 380,
    ["Minecraft Custom Main Menu Mod"] = 820,
    ["Minecraft Data Pack Advancement"] = 382,
    ["Minecraft Data Pack Biome"] = 383,
    ["Minecraft Data Pack Configured Carver"] = 384,
    ["Minecraft Data Pack Damage Type"] = 385,
    ["Minecraft Data Pack Dimension"] = 387,
    ["Minecraft Data Pack Dimension Type"] = 386,
    ["Minecraft Data Pack Item Modifier"] = 388,
    ["Minecraft Data Pack Loot Table"] = 389,
    ["Minecraft Data Pack Metadata"] = 390,
    ["Minecraft Data Pack Predicate"] = 391,
    ["Minecraft Data Pack Recipe"] = 392,
    ["Minecraft Data Pack Tag"] = 393,
    ["Minecraft Data Pack Template Pool"] = 394,
    ["Minecraft Data Pack Trim Material"] = 399,
    ["Minecraft Data Pack Trim Pattern"] = 400,
    ["Minecraft Resource Pack Lang"] = 395,
    ["Minecraft Resource Pack Particle"] = 396,
    ["Minecraft Resource Pack Texture Mcmeta"] = 398,
    ["Minecraft Resourcepack Sounds"] = 397,
    ["MkDocs Configuration 1.0"] = 401,
    ["Monade CLI Stack Configuration"] = 409,
    ["MongoDB Atlas Search Index Definition"] = 769,
    ["Monika Configuration"] = 767,
    ["Monoweave Configuration"] = 404,
    ["Motif config"] = 667,
    ["NOX Framework (Service)"] = 421,
    ["Netin Diagnostic System Template"] = 727,
    ["Netlify config"] = 412,
    ["Network-as-Code Data Model"] = 413,
    ["Nightwatch.js"] = 414,
    ["Nuitka.yaml"] = 833,
    ["ONe's changelog entry"] = 437,
    ["ONe's service descriptor"] = 436,
    ["OSS Review Toolkit configuration"] = 444,
    ["OSS Review Toolkit curation"] = 445,
    ["OSS Review Toolkit package configuration"] = 446,
    ["OSS Review Toolkit repository configuration"] = 447,
    ["OSS Review Toolkit resolutions"] = 448,
    Opctl = 670,
    ["OpenRewrite Resource"] = 439,
    ["OpenUtau character yaml"] = 433,
    ["OpenUtau ustx"] = 434,
    ["OpenWeather Current Weather API"] = 708,
    ["OpenWeather Road Risk API"] = 707,
    ["Ory Hydra configuration"] = 310,
    ["Ory Keto configuration"] = 351,
    ["Ory Kratos configuration"] = 443,
    ["Ory Oathkeeper configuration"] = 428,
    ["Outblocks App configuration"] = 441,
    ["Outblocks database table"] = 442,
    ["Outblocks project configuration"] = 440,
    PDM = 454,
    Packer = 451,
    Pantsbuild = 789,
    ["Paper paper-plugin.yml"] = 452,
    ["Pipeline component"] = 719,
    ["PocketMine plugin.yml"] = 459,
    ["Postman collection"] = 464,
    ["Problem object RFC9457"] = 817,
    ["Problem package generators"] = 472,
    Pterodactyl = 764,
    ["Pull Request Labeler"] = 487,
    Pulumi = 493,
    PyProject = 494,
    Pyright = 495,
    Qgoda = 496,
    Qodana = 737,
    ["Quali Torque Blueprint Spec 2"] = 762,
    ["QueryFirst config file"] = 785,
    ["RKE Cluster Configuration JSON"] = 716,
    ["RKE Cluster Configuration YAML"] = 715,
    ["Rancher Fleet"] = 490,
    ["Rattler-build"] = 497,
    Ray = 682,
    ["Read the Docs"] = 492,
    ["Red-DiscordBot Cog"] = 498,
    ["Red-DiscordBot Cog Repo"] = 499,
    ["Red-DiscordBot Trivia"] = 500,
    ["Render Blueprints"] = 714,
    RenderCV = 510,
    Renovate = 509,
    ["Replit config"] = 504,
    RoadRunner = 511,
    ["Rudder techniques"] = 823,
    Ruff = 506,
    ["Rust Project"] = 507,
    ["Rust toolchain"] = 514,
    ["SDMX data message"] = 539,
    ["SDMX metadata message"] = 538,
    ["SDMX structure message"] = 537,
    ["SIL Kit Participant Configuration"] = 549,
    ["SIL Kit Registry Configuration"] = 550,
    SWADL = 575,
    ["Safebox Config"] = 775,
    ["Sapphire CLI Config"] = 517,
    ["SauceCTL Configuration"] = 724,
    ["Schema Catalog"] = 531,
    ["Scoop manifest"] = 536,
    ["Semantic Data Fabric (SDF) file"] = 540,
    ["Semgrep Rule"] = 542,
    ["Serenity Code Generator (Sergen)"] = 543,
    ["Serverless Framework Configuration"] = 731,
    ["Serverless Workflow"] = 733,
    ["Settings.paf"] = 545,
    ["Shopware 6 Configuration"] = 734,
    ["Shopware CLI Extension Store Configuration"] = 735,
    ["Shopware CLI Project Store Configuration"] = 736,
    Sigma = 547,
    ["Sigrid scope configuration file"] = 548,
    ["SkyPilot Task JSON"] = 824,
    ["Slack app manifest"] = 552,
    Solidarity = 555,
    ["Solution filters"] = 556,
    ["Source Maps v3"] = 557,
    Sourcery = 558,
    SpecIF = 559,
    ["Sponge Mixin configuration"] = 560,
    StackBlitz = 565,
    ["StackHawk Scanner Configuration"] = 730,
    Stale = 566,
    ["Starlake Data Pipeline"] = 705,
    Starship = 567,
    ["Statamic Blueprint"] = 568,
    ["Stella configuration file"] = 569,
    ["StrmPrivacy Data Connector"] = 779,
    ["StrmPrivacy Data Contract"] = 780,
    ["StrmPrivacy SimpleSchema"] = 777,
    ["StrmPrivacy Stream"] = 778,
    ["StrmPrivacy batch job configuration file"] = 776,
    ["Stryker Mutator"] = 572,
    ["StyleCop Analyzers Configuration"] = 573,
    ["Stylelint (.stylelintrc)"] = 574,
    ["Sublime Syntax"] = 781,
    ["Subsquid squid manifest"] = 826,
    ["Swagger API 2.0"] = 576,
    TSON = 602,
    TSTyche = 603,
    Talhelper = 578,
    ["Talisman configuration"] = 579,
    ["Taskfile config"] = 710,
    Taurus = 580,
    ["TestEnvironment.json"] = 589,
    ["TextMate Grammar"] = 588,
    ["Tier.run pricing.json"] = 583,
    Tikibase = 584,
    ["Traefik v2"] = 592,
    ["Traefik v2 File Provider"] = 593,
    ["Travis CI (.travis.yml)"] = 591,
    TunnelHub = 816,
    Turborepo = 590,
    Tye = 738,
    ["UET BuildConfig.json"] = 786,
    ["UI5 Manifest"] = 612,
    ["UNCORS configuration"] = 616,
    ["UTAM Page Object"] = 615,
    ["Ubuntu Server Autoinstall"] = 610,
    ["Uniswap Token List"] = 693,
    ["Unreal Engine Uplugin"] = 787,
    ["Unreal Engine Uproject"] = 788,
    ["Updatecli Compose"] = 746,
    ["Updatecli Policy Manifest"] = 747,
    ["Updatecli Policy Metadata"] = 748,
    Uplift = 784,
    ["User Journey Map"] = 713,
    V2Ray = 752,
    ["VSCode Code Snippets"] = 165,
    ["VSIX CLI publishing"] = 630,
    ["Vela Pipeline Configuration"] = 619,
    Vercel = 164,
    Visivo = 814,
    ["Web App Manifest"] = 637,
    ["Web types"] = 640,
    WebExtensions = 636,
    ["Webman package recipe"] = 758,
    ["Windows Package Manager Installer Manifest"] = 690,
    ["Windows Package Manager Locale Manifest"] = 691,
    ["Windows Package Manager Singleton Manifest"] = 689,
    ["Woodpecker pipeline config"] = 726,
    ["Wrangler CLI"] = 641,
    ["Xstate Machine"] = 744,
    ["Yarn Config (.yarnrc.yml)"] = 703,
    ["Yippee-Ki-JSON configuration YML"] = 695,
    ["aerleon.yml"] = 6,
    ["angular.json"] = 14,
    apko = 818,
    ...
    ["behat.yml"] = 88,
    ["bigquery-table"] = 80,
    ["bioimageio resource description"] = 834,
    ...
    ["chisel-slices.json"] = 182,
    ["chrome-extension-locales-messages.json"] = 172,
    ["chutzpah.json"] = 173,
    cibuildwheel = 113,
    ["clang-format (.clang-format)"] = 750,
    clangd = 152,
    clib = 153,
    ["cloud-init: cloud-config userdata"] = 155,
    ["cloud-sdk-pipeline-configuration"] = 175,
    ["cloudbuild.json"] = 176,
    cloudify = 154,
    codemagic = 156,
    ["coffeelint.json"] = 184,
    ["commands.json"] = 168,
    ["commitlint (.commitlintrc)"] = 692,
    ["compile_commands.json"] = 167,
    ["compilerconfig.json"] = 166,
    ["completely.yml"] = 792,
    ["component-detection-manifest.json"] = 187,
    ["component.json"] = 186,
    ["composer.json"] = 185,
    ["conda-forge"] = 115,
    ["config.yaml"] = 491,
    ["contentmanifest.json"] = 174,
    ["contribute.json"] = 188,
    ["cosmos.config.json"] = 170,
    ["crowdin.yml"] = 189,
    ["custom-elements.json"] = 806,
    ["cypress.json"] = 193,
    ["datalogic-scan2deploy-android"] = 202,
    ["datalogic-scan2deploy-ce"] = 203,
    ["dbt Project"] = 126,
    ["ddev-global"] = 204,
    ["ddev-project"] = 205,
    ["debugsettings.json"] = 206,
    ["dependabot-v2.json"] = 209,
    ["dependabot.json"] = 208,
    ["deployed-cli"] = 743,
    ["devcontainer.json"] = 158,
    devinit = 697,
    ["devspace.yaml"] = 766,
    djlint = 698,
    ["docker sequencer"] = 214,
    ["docker-compose.yml"] = 696,
    ["dockerd.json"] = 213,
    ["dotnet Release Index manifest"] = 224,
    ["dotnet-tools.json"] = 225,
    ["dotnetcli.host.json"] = 226,
    ["dprint.json"] = 227,
    ["drone.json"] = 228,
    ["dss-2.0.0.json"] = 230,
    ["dstack configuration"] = 231,
    ["dvc.yaml"] = 232,
    ["ecosystem.json"] = 237,
    eksctl = 238,
    ["electron-builder configuration file"] = 245,
    ["epr-manifest.json"] = 243,
    ["evcc.yaml"] = 246,
    ["ezd task runner"] = 248,
    ["fabric.mod.json"] = 251,
    ["first-timers-bot"] = 257,
    ...
    ["gitlab-ci"] = 283,
    ["global.json"] = 285,
    ["go-feature-flag Flag Configuration"] = 288,
    ["haxelib.json"] = 303,
    helmfile = 685,
    helmwave = 686,
    ["host-meta.json"] = 308,
    ...
    ["ide.host.json"] = 313,
    ["ifstate.conf"] = 314,
    ["imageoptimizer.json"] = 315,
    ["importmap.json"] = 318,
    ["ioBroker Configuration"] = 319,
    ["ioBroker JSON UI"] = 320,
    ["ioBroker Package manifest"] = 321,
    ["ize.toml"] = 783,
    ["jsconfig.json"] = 344,
    ["jscpd Configuration"] = 763,
    jsdoc = 681,
    ["k3d.yaml"] = 345,
    ["k9s plugin.yml"] = 347,
    ["kontinuous-config.yaml"] = 353,
    ["kontinuous-values.yaml"] = 352,
    ["kustomization.yaml"] = 354,
    ["label-commenter-config.yml"] = 355,
    ["latexindent configuration"] = 62,
    ["launchsettings.json"] = 356,
    lazydocker = 805,
    lazygit = 804,
    ["lego.json"] = 358,
    ["lerna.json"] = 359,
    ["lgtm.yml"] = 360,
    ["liblab.config.json"] = 361,
    ["libman.json"] = 362,
    ["license-report-config.json"] = 363,
    ["linkinator.config.json"] = 365,
    ["lint-staged (.lintstagedrc)"] = 661,
    ["local.settings.json"] = 370,
    ["localazy.json"] = 371,
    ["lotus.yaml"] = 369,
    ["lsdlschema.json"] = 372,
    ["markdown-link-check"] = 722,
    mboats = 729,
    ["micro-settings.json"] = 798,
    ["mimetypes.json"] = 381,
    ["mirrord config"] = 662,
    mise = 663,
    ["mise-settings"] = 664,
    ...
    ["mtad.yaml"] = 666,
    ["mycode.json"] = 410,
    ["napari plugin manifest"] = 411,
    neoload = 676,
    ["nest-cli"] = 417,
    ["ninjs (News in JSON) 1.3"] = 416,
    ["ninjs (News in JSON) 2.0"] = 415,
    ["nixd configuration"] = 822,
    ["nlu.json"] = 418,
    ["nodemon.json"] = 420,
    ["noodl config"] = 728,
    now = 672,
    ...
    ["nswag.json"] = 426,
    ntangle = 427,
    ["nuclei-template.yaml"] = 424,
    ["nuget-project.json"] = 425,
    ["ocelot.json"] = 429,
    ["omnisharp.json"] = 430,
    ["openapi.json"] = 431,
    ["openfin.json"] = 438,
    ...
    ["ops.yaml"] = 435,
    ["package.json"] = 449,
    ["package.manifest"] = 450,
    ["partial-black.json"] = 89,
    ["pathfinder.yml"] = 453,
    ["pattern.json"] = 456,
    ["petstore-v1.0"] = 773,
    pgap_yaml_input_reader = 455,
    ["pixi.toml"] = 457,
    ["plagiarize-me.yaml"] = 461,
    ["plagiarize.yaml"] = 460,
    ["portman.json"] = 462,
    ["prettierrc.json"] = 470,
    ["prisma.yml"] = 471,
    ["project-1.0.0-beta3.json"] = 474,
    ["project-1.0.0-beta4.json"] = 475,
    ["project-1.0.0-beta5.json"] = 476,
    ["project-1.0.0-beta6.json"] = 477,
    ["project-1.0.0-beta8.json"] = 478,
    ["project-1.0.0-rc1.json"] = 479,
    ["project-1.0.0-rc2.json"] = 480,
    ["project.json"] = 473,
    ["prometheus.json"] = 481,
    ["prometheus.rules.json"] = 482,
    ["prometheus.rules.test.json"] = 483,
    ["proxies.json"] = 484,
    ["publiccode.yml"] = 485,
    ["pubspec.yaml"] = 486,
    ["pyrseas-0.8.json"] = 489,
    ["quilt.mod.json"] = 799,
    ["release drafter"] = 677,
    ["release-plz.toml"] = 502,
    ["rivet.yaml"] = 821,
    rockcraft = 512,
    rustfmt = 513,
    samt = 515,
    samtrc = 516,
    ["sarif-1.0.0.json"] = 518,
    ["sarif-2.0.0.json"] = 519,
    ["sarif-2.1.0"] = 529,
    ["sarif-2.1.0-rtm.2"] = 520,
    ["sarif-2.1.0-rtm.3"] = 522,
    ["sarif-2.1.0-rtm.4"] = 524,
    ["sarif-2.1.0-rtm.5"] = 526,
    ["sarif-2.1.0-rtm.6"] = 527,
    ["sarif-external-property-file-2.1.0"] = 530,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 521,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 523,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 525,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 528,
    ["schema.org - Action"] = 532,
    ["schema.org - ContactPoint"] = 533,
    ["schema.org - Place"] = 534,
    ["schema.org - Thing"] = 535,
    ["secrethub.yml"] = 801,
    ["semantic-release"] = 541,
    ["servicehub.config.json"] = 651,
    ["servicehub.service.json"] = 650,
    ["settings.job"] = 544,
    ["sfdx-hardis configuration"] = 546,
    ["shard.yml"] = 837,
    ["size-limit configuration"] = 551,
    ["skaffold.yaml"] = 720,
    ["skyuxconfig.json"] = 553,
    snapcraft = 554,
    ["sqlc configuration"] = 562,
    ["stripe-app-local.json"] = 571,
    ["stripe-app.json"] = 570,
    swcrc = 706,
    ["task.json"] = 577,
    taskcat = 673,
    ["template.json"] = 581,
    ["templatsources.json"] = 582,
    ["theme.json"] = 585,
    ["tizen_workspace.json"] = 586,
    tldr = 587,
    tmuxinator = 659,
    ["transcend.yml"] = 594,
    ["tree-sitter grammar.json"] = 293,
    ["trime.yaml"] = 595,
    ["trunk.yaml"] = 596,
    ["ts-force-config.json"] = 600,
    ["tsconfig.json"] = 597,
    ["tsd.json"] = 598,
    ["tsdrc.json"] = 599,
    ["tslint.json"] = 601,
    ...
    ["typingsrc.json"] = 609,
    ["typo3.json"] = 607,
    ["ui5-workspace.yaml"] = 614,
    ["ui5.yaml"] = 613,
    unist = 739,
    ["up.json"] = 611,
    v8r = 634,
    ["vcpkg configuration file"] = 163,
    ["vcpkg manifest file"] = 162,
    ["vega-lite.json"] = 618,
    ["vega.json"] = 617,
    ["venvironment-basic.yaml"] = 621,
    ["venvironment.yaml"] = 620,
    ["version.json"] = 622,
    ["vim-addon-info"] = 624,
    ["vs-2017.3.host.json"] = 626,
    ["vs-nesting.json"] = 627,
    ["vsls.json"] = 625,
    ["vss-extension.json"] = 631,
    ["vtesttree.yaml"] = 632,
    ["vtestunit.yaml"] = 633,
    ["warp-keysets.json"] = 807,
    ["warp-themes.json"] = 808,
    ["warp-workflows.json"] = 809,
    ["webhint.io"] = 759,
    ["webjobpublishsettings.json"] = 639,
    ["webjobs-list.json"] = 638,
    ["xs-app.json"] = 669,
    ["xunit.runner.json"] = 649,
    yamllint = 694,
    zuul = 678,
    ["Žinoma"] = 688
  },
