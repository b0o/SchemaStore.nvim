...
M.json = {
  ...
  index = {
    ...
    AIConfig = 37,
    ["AMX Muse Program Descriptor"] = 1223,
    ["API Builder"] = 1030,
    ["AVA Configuration"] = 1093,
    ...
    ["AWS Copilot Manifest"] = 1262,
    ["AWS SAM CLI Samconfig"] = 277,
    Acton = 1313,
    ["Adobe UXP Manifest"] = 1156,
    ["Aerleon Network & Service Definitions"] = 23,
    ["Aerleon Policy"] = 24,
    ["Agent Permission Policy"] = 1302,
    ["AgentCore CLI"] = 1303,
    AgentLoopKit = 1304,
    Aider = 1252,
    Air = 26,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1273,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1272,
    ["Airlock Microgateway"] = 38,
    ["Alacritty Configuration"] = 1065,
    ["AlgoVoi Compliance Receipt v1"] = 13,
    ["All Contributors configuration file"] = 1119,
    Anodizer = 452,
    ...
    ["Application list for a WinUtil"] = 1202,
    ArchitectFX = 1207,
    ["Argo CD"] = 57,
    ["Argo Events"] = 58,
    ["Argo Workflows"] = 59,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1271,
    ["Azure IoT Operations connector metadata"] = 1268,
    ...
    ["Bacon config"] = 7,
    ["Barba-CV"] = 86,
    ["Bashly (bashly.yml)"] = 1123,
    ["Bashly Settings (bashly-settings.yml)"] = 1124,
    Bento = 1289,
    ["Better Code Hub"] = 1035,
    ["Better Scripts"] = 166,
    Bigconfig = 136,
    ["Biome Formatter Config"] = 87,
    ["Bitmovin Encoding Template"] = 1216,
    BizTalkServerApplicationSchema = 1001,
    Bleep = 167,
    ["Block Protocol Metadata"] = 164,
    ["Bluebricks blueprint config"] = 1295,
    ["Boyka Framework"] = 145,
    ...
    ["Butane Config"] = 1078,
    C4InterFlow = 1231,
    ["CDK Environment Manager, concrete environment configuration"] = 1255,
    ["CDK Environment Manager, concrete environments definition"] = 1254,
    ["CDK Environment Manager, environment definition"] = 1253,
    ["CGS Card Game Specification (cgs.json)"] = 1161,
    ["CICS TS region tagging"] = 1087,
    ["CICS TS resource import"] = 1088,
    ["CICS TS resource model"] = 1089,
    ["CICS TS resource overrides"] = 1090,
    ["CMake Presets"] = 168,
    ["CNC Codes"] = 190,
    ["CRS WAF test file"] = 1191,
    ["CRS WAF test platform overrides file"] = 1192,
    ...
    ["Caido Proxy Configuration"] = 1327,
    ...
    ["Chamaleon environment"] = 1220,
    ["Chamaleon properties"] = 1221,
    ["Chamaleon template"] = 1219,
    Changepacks = 1282,
    Changesets = 286,
    Changie = 177,
    Charmcraft = 178,
    ...
    ["Clawject config"] = 196,
    ["Cloud Foundry Application Manifest"] = 1173,
    ["Cloud Run Spec v1"] = 1197,
    ...
    Concord = 1190,
    ["Configu .cfgu files"] = 1178,
    ["Configu .configu file"] = 1179,
    Conjure = 189,
    ["Container Structure Test"] = 1015,
    Containerlab = 1044,
    ["Contextive Glossary"] = 1247,
    Convex = 188,
    ["Crowdsec collection config"] = 296,
    ["Crowdsec parser config"] = 297,
    ["Crowdsec scenario config"] = 298,
    ["CumulusCI Config"] = 195,
    ["Cursor Agent Environment"] = 1300,
    ["Custom Machinery Machine"] = 1162,
    ["Custom Machinery Recipe"] = 1163,
    ...
    ["DonateCaseBetterCasino menu"] = 1224,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1131,
    ["EAS config"] = 385,
    ["ECA - Editor Code Assistant"] = 349,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1120,
    ["ESLint Suppressions"] = 390,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1267,
    ["EasyVCR .NET"] = 387,
    ["Eidolon Resource"] = 1208,
    ...
    ["Envelope Team Definition"] = 1312,
    ["Envilder Map File"] = 353,
    ["Erda Pipeline"] = 1169,
    ["Erda Runtime"] = 1170,
    ["Espanso config.yml"] = 1293,
    ["Espanso match.yml"] = 1292,
    Esquio = 373,
    ["Estuary Flow Catalog"] = 1084,
    ["Ethereum ERC1155"] = 1306,
    ["Ethereum ERC721"] = 1305,
    ...
    ["Evolving Resolutive Process notation"] = 1269,
    ["Expo SDK"] = 384,
    ...
    ["GeoJSON.json latest"] = 1082,
    GherKing = 1086,
    ["GitHub Action"] = 421,
    ["GitHub Actions typing"] = 1204,
    ...
    ["Google Digital Assetlinks"] = 1248,
    Goreleaser = 450,
    ["Goreleaser Pro"] = 451,
    Goss = 453,
    ...
    Hadolint = 1011,
    Hammerkit = 1043,
    ["Hardware Sentry Configuration"] = 1098,
    ...
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1141,
    ["JSON Schema Draft 7"] = 977,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1142,
    ...
    ["Jujutsu (jj) VCS config"] = 1261,
    ["KIMMDY config file"] = 533,
    ["KODE/CI build.yaml"] = 1104,
    ["KSP-AVC"] = 973,
    ["KSP-CKAN"] = 974,
    ["KSP-NetKAN"] = 975,
    KSY = 1171,
    ...
    ["Metadata for a Cinnamon spice"] = 1200,
    ["Metatype Configuration"] = 575,
    ["MetricsHub Configuration"] = 576,
    ["MetricsHub Connector Configuration"] = 577,
    ["Micro Editor Syntax"] = 1132,
    ["Microsoft Band Web Tile"] = 578,
    ["Microsoft RulesEngine workflow rules"] = 1187,
    ["Microsoft RulesEngine workflow rules list"] = 1188,
    ["Minecraft Custom Main Menu Mod"] = 1150,
    ...
    ["MongoDB Atlas Search Index Definition"] = 1103,
    ["Monika Configuration"] = 1101,
    ["Monoweave Configuration"] = 606,
    ["Motif config"] = 993,
    MultiQC = 1241,
    ["NOX Framework (Service)"] = 629,
    ["Netin Diagnostic System Template"] = 1060,
    ["Netlify config"] = 614,
    ...
    ["Pipeline component"] = 1051,
    ["Platform.sh application"] = 9,
    ["Platform.sh routes"] = 10,
    ["Platform.sh services"] = 11,
    ["Plex Prerolls"] = 697,
    ["PocketMine plugin.yml"] = 694,
    ["Podman Desktop Extension"] = 1329,
    ["Postman collection"] = 703,
    ["Power Pages Configuration"] = 1258,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1203,
    ...
    Pylock = 1249,
    Pyright = 751,
    ["Python script metadata"] = 1243,
    ["QType AI DSL"] = 754,
    Qgoda = 753,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1321,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1319,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1325,
    ["Qlik Talend Cloud Pipeline - Project"] = 1317,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1320,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1322,
    ["Qlik Talend Cloud Pipeline - Task"] = 1318,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1324,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1323,
    Qodana = 1070,
    ["Qt Creator workspace file"] = 1180,
    ["Quali Torque Blueprint Spec 2"] = 1095,
    ["QueryFirst config file"] = 1114,
    ["QuikRun Configuration"] = 1326,
    ["Qwen Code Settings"] = 1307,
    ["RKE Cluster Configuration JSON"] = 1048,
    ["RKE Cluster Configuration YAML"] = 1047,
    RadioHound = 744,
    ["Raid Profile"] = 1308,
    ["Raid Repo Configuration"] = 1309,
    Railpack = 756,
    Railway = 755,
    ["Rancher Fleet"] = 746,
    ["Rattler-build"] = 757,
    ...
    ["Replit config"] = 772,
    Restate = 1236,
    ["Revel Digital Gadget Definition File"] = 1260,
    RoadRunner = 785,
    ["Robust Station Image"] = 1266,
    Rockcraft = 786,
    ["Roo Coder Custom Modes"] = 787,
    Rubocop = 776,
    ["Rudder techniques"] = 1154,
    Ruff = 777,
    ["Rust Project"] = 778,
    ["Rust toolchain"] = 792,
    ...
    ["Serverless Framework Configuration"] = 1064,
    ["Serverless Workflow"] = 1066,
    ["Settings for a Cinnamon spice"] = 1199,
    ["Settings.paf"] = 825,
    ["Shopware 6 Configuration"] = 1067,
    ["Shopware CLI Extension Store Configuration"] = 1068,
    ["Shopware CLI Project Store Configuration"] = 1069,
    ["Sigma Detection Rule"] = 827,
    ["SigmaCV CV"] = 1,
    ["Sigrid scope configuration file"] = 828,
    ["SkyPilot Task JSON"] = 1155,
    ...
    StackBlitz = 872,
    ["StackHawk Scanner Configuration"] = 1063,
    Stale = 873,
    Starfish = 874,
    ...
    ["Stylua Config"] = 1250,
    ["Sublime Syntax"] = 1110,
    ["Subsquid squid manifest"] = 1157,
    ["Swagger API 2.0"] = 885,
    ["Synadia Connect Component"] = 886,
    TSON = 922,
    TSTyche = 923,
    ["TYPO3 Vendor Bundler config"] = 929,
    ["Tab data for a LinUtil"] = 1206,
    ["Tab list for a LinUtil"] = 1205,
    Tach = 887,
    ["Tach Domain"] = 888,
    Talhelper = 890,
    ...
    Taurus = 892,
    Tauticord = 893,
    ["Tekton Pipeline"] = 1279,
    ["Tekton PipelineRun"] = 1280,
    ["Tekton Task"] = 1277,
    ["Tekton TaskRun"] = 1278,
    Telefonistka = 1237,
    ["Terrateam config"] = 1263,
    ...
    ["Tugboat QA config.yml"] = 1230,
    TunnelHub = 1145,
    Turborepo = 906,
    Tycho = 1194,
    Tye = 1071,
    ["Tyk Gateway - Open Source v5.7+"] = 1242,
    ["UET BuildConfig.json"] = 1115,
    ["UI5 Manifest"] = 935,
    ["UNCORS configuration"] = 940,
    ["UTAM Page Object"] = 938,
    ["Ubuntu Server Autoinstall"] = 933,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1234,
    ["Uniswap Token List"] = 1021,
    ["Universal Schedule Format"] = 941,
    ["Unreal Engine Uplugin"] = 1116,
    ["Unreal Engine Uproject"] = 1117,
    ["UpCloud CLI (upctl) configuration"] = 1235,
    ["Updatecli Compose"] = 1079,
    ["Updatecli Policy Manifest"] = 1080,
    ["Updatecli Policy Metadata"] = 1081,
    Uplift = 1113,
    ["Upsun config"] = 8,
    ["User Journey Map"] = 1045,
    V2Ray = 1085,
    ...
    Vespertide = 1284,
    ["Vespertide Migration"] = 1285,
    ["Vespertide Model"] = 1286,
    ["Viash Component Config"] = 1239,
    ["Viash Package Config"] = 1240,
    Visivo = 1143,
    ["WP-CLI"] = 969,
    Wake = 1232,
    ["Waku Config"] = 1209,
    ...
    ["WireMock CLI import configuration"] = 1215,
    ["WireMock CLI local service configuration"] = 1214,
    ["WireMock message stub mapping"] = 1213,
    ["WireMock stub mapping"] = 1212,
    ["Woodpecker pipeline config"] = 1059,
    ["Wrangler CLI"] = 970,
    ["XenForo add-on manifest"] = 971,
    ["Xstate Machine"] = 1077,
    ["Yandex Workflow Language"] = 1201,
    ["Yarn Config (.yarnrc.yml)"] = 1034,
    ["Yippee-Ki-JSON configuration YML"] = 1025,
    ["YouTrack App"] = 1198,
    ["Zarf Package Configuration"] = 1265,
    ["Zerops import file"] = 1186,
    ["Zola Configuration"] = 1276,
    ["aerleon.yml"] = 22,
    ["amplify.yml"] = 15,
    ["amxx-builder manifest"] = 1328,
    ["angular.json"] = 39,
    apko = 1148,
    ...
    ["behat.yml"] = 146,
    ["bigquery-table"] = 135,
    ["bioimageio resource description"] = 1165,
    ...
    ["chutzpah.json"] = 269,
    cibuildwheel = 183,
    ["clang-format (.clang-format)"] = 1083,
    ["clang-tidy"] = 245,
    clangd = 244,
    clib = 246,
    ...
    ["crowdin.yml"] = 295,
    ["ctfd-setup configuration file"] = 1222,
    ["custom-elements.json"] = 1135,
    ["cypress.json"] = 299,
    ["dacier.yml"] = 1316,
    ...
    ["gematik health care insurance list"] = 1228,
    ["gematik health care patient list"] = 1225,
    ["gematik health care provider institution list"] = 1227,
    ["gematik health care provider list"] = 1226,
    ["gematik tiger test environment configuration"] = 1229,
    ["git-town.toml"] = 1274,
    ["gitlab-ci"] = 430,
    ["global.json"] = 446,
    ...
    ["lsdlschema.json"] = 564,
    ["macro.json"] = 1100,
    ["markdown-link-check"] = 1054,
    maturin = 1055,
    mboats = 1062,
    memnex = 1314,
    ["micro-settings.json"] = 1127,
    ["mimetypes.json"] = 579,
    ["mirrord config"] = 989,
    mise = 990,
    ["mkdocs.yml"] = 599,
    ...
    ["monospace.yml"] = 605,
    ["moon.yml"] = 1211,
    ["mprocs Configuration file"] = 1181,
    ["mrdocs.yml"] = 601,
    ["mta.yaml"] = 991,
    ["mtad.yaml"] = 992,
    ["mycode.json"] = 612,
    ...
    ["plagiarize.yaml"] = 695,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1218,
    ["podbard.yaml"] = 698,
    ["portman.json"] = 701,
    ["prefect.toml"] = 710,
    ["prefect.yaml"] = 711,
    ...
    ["text2confl config"] = 1299,
    ["theme.json"] = 898,
    ["tizen_workspace.json"] = 900,
    tldr = 901,
    ["tm_devices configuration file"] = 1256,
    tmuxinator = 985,
    tox = 903,
    ["transcend.yml"] = 912,
    ...
    ["vtesttree.yaml"] = 961,
    ["vtestunit.yaml"] = 962,
    ["warp-keysets.json"] = 1136,
    ["warp-themes.json"] = 1137,
    ["warp-workflows.json"] = 1138,
    ["webhint.io"] = 1092,
    ["webjobpublishsettings.json"] = 967,
    ["webjobs-list.json"] = 966,
    ["well-known-fursona"] = 1176,
    ["xs-app.json"] = 995,
