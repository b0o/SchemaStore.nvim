...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 167,
    [".cryproj (generic)"] = 575,
    [".cryproj engine-5.2"] = 570,
    [".cryproj engine-5.3"] = 571,
    [".cryproj engine-5.4"] = 572,
    [".cryproj engine-5.5"] = 573,
    [".cryproj engine-dev"] = 574,
    [".csscomb.json"] = 169,
    [".csslintrc"] = 170,
    [".es6importsorterrc.json"] = 702,
    [".eslintrc"] = 216,
    [".esmrc.json"] = 208,
    [".ffizer.yaml"] = 220,
    [".htmlhintrc"] = 268,
    ...
    [".mtaext"] = 584,
    [".nodehawkrc"] = 363,
    [".npmpackagejsonlintrc"] = 366,
    [".phraseapp.yml"] = 406,
    [".pmbot.yml"] = 396,
    [".postcssrc"] = 401,
    [".powerpages-web-template-manifest"] = 403,
    [".pre-commit-config.yml"] = 404,
    [".pre-commit-hooks.yml"] = 405,
    [".putout.json"] = 424,
    [".rehyperc"] = 435,
    [".remarkrc"] = 436,
    [".sprite files"] = 489,
    ...
    ["<div>RIOTS' studio configuration"] = 554,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config schema"] = 325,
    ["API Builder"] = 615,
    ["AVA Configuration Schema"] = 672,
    ["AWS CDK cdk.json"] = 151,
    ["AWS CloudFormation"] = 152,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 153,
    ["AWS SAM CLI Samconfig"] = 154,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 13,
    ["Airplane task"] = 14,
    ["Alacritty Configuration Schema"] = 647,
    ["All Contributors configuration file"] = 701,
    ...
    ["Azure Pipelines"] = 54,
    ["Azure Static Web Apps CLI configuration file"] = 491,
    ["Azure Static Web Apps configuration file"] = 490,
    ["BX CI"] = 89,
    ["Better Code Hub"] = 620,
    ["Better Scripts"] = 90,
    BizTalkServerApplicationSchema = 590,
    ...
    ["Butane Config"] = 659,
    ["CICS TS region tagging"] = 666,
    ["CICS TS resource import"] = 667,
    ["CICS TS resource model"] = 668,
    ["CICS TS resource overrides"] = 669,
    ["CMake Presets"] = 91,
    ...
    Conjure = 99,
    ["Container Structure Test"] = 602,
    Containerlab = 628,
    ["Crowdsec collection Schema"] = 163,
    ["Crowdsec parser Schema"] = 164,
    ["Crowdsec scenario Schema"] = 165,
    ["DWP Exchange - catalogue entry"] = 205,
    ["DWP Exchange - gateway"] = 203,
    ["DWP Exchange - meta"] = 204,
    ["Dart build configuration"] = 171,
    ["Dart test config"] = 172,
    ["DashLord configuration"] = 173,
    ["Datadog Service Definition"] = 305,
    ["Datahub Ingestion Recipe Schema"] = 673,
    ...
    Devfile = 202,
    ["Discord Webhook"] = 182,
    ["Dolittle Artifacts"] = 186,
    ["Dolittle Bounded Context Configuration"] = 187,
    ["Dolittle Event Horizons Configuration"] = 188,
    ["Dolittle Resources Configuration"] = 189,
    ["Dolittle Server Configuration"] = 190,
    ["Dolittle Tenant Map Configuration"] = 192,
    ["Dolittle Tenants Configuration"] = 191,
    ["Dolittle Topology"] = 193,
    ...
    ["Drush site aliases"] = 198,
    ["Embrace Config Schema"] = 684,
    ["Error pages"] = 211,
    Esquio = 209,
    ["Estuary Flow Catalog Schema"] = 663,
    ["Expo SDK"] = 214,
    ["F-Droid Data metadata"] = 219,
    ["Facets - FSDL - Application"] = 217,
    ["FasterCI Configuration"] = 55,
    Firebase = 221,
    ["Fossa configuration file"] = 228,
    ["Fossa's fossa-deps file"] = 229,
    ["Foundry VTT - Base package Manifest"] = 223,
    ["Foundry VTT - Module Manifest"] = 224,
    ["Foundry VTT - System Data Template"] = 227,
    ["Foundry VTT - System Manifest"] = 225,
    ["Foundry VTT - World Manifest"] = 226,
    ["Foxx Manifest"] = 56,
    ["Freifunk.de Community API"] = 59,
    ["Frogbot Config"] = 60,
    ["GCP Blueprint Metadata"] = 234,
    ["GatewayCore API Gateway"] = 233,
    ["GeoJSON.json latest"] = 661,
    GherKing = 665,
    ["GitHub Action"] = 238,
    ["GitHub Discussion"] = 239,
    ["GitHub Funding"] = 240,
    ["GitHub Issue Template configuration"] = 242,
    ["GitHub Workflow"] = 243,
    ["GitHub Workflow Template Properties"] = 244,
    ["GitHub issue forms"] = 241,
    GitVersion = 237,
    ["Gitpod Configuration"] = 246,
    ["Global Privacy Control"] = 235,
    ["Google Cloud Workflows"] = 150,
    Goreleaser = 249,
    ["Goreleaser Pro"] = 250,
    Goss = 251,
    ["Gradle Build Cache Node"] = 617,
    ["Gradle Enterprise"] = 616,
    ["Grafana 5.x Dashboard"] = 252,
    ["GraphQL Code Generator"] = 255,
    ["GraphQL Config"] = 254,
    ["GraphQL Mesh"] = 253,
    ["Grunt JSHint task"] = 259,
    ["Grunt Watch task"] = 260,
    ["Grunt base task"] = 261,
    ["Grunt clean task"] = 257,
    ["Grunt copy task"] = 256,
    ["Grunt cssmin task"] = 258,
    HEMTT = 587,
    Hadolint = 599,
    Hammerkit = 627,
    ["Hardware Sentry Configuration"] = 677,
    Hayson = 263,
    ["Haystack Pipeline"] = 264,
    ["Hazelcast 5 Configuration"] = 265,
    ["Helm Chart.lock"] = 121,
    ["Helm Chart.yaml"] = 120,
    ["Helm Unittest Test Suite"] = 122,
    Hugo = 655,
    ["IBM Zapp document"] = 270,
    ["IBM zCodeFormatSettings"] = 271,
    ["IMG Catapult PSP"] = 276,
    ["Istanbul Schema"] = 680,
    ["JDownloader2 crawler multi-rule schema"] = 286,
    ["JDownloader2 crawler single-rule schema"] = 285,
    ["JFrog File Spec"] = 287,
    ["JFrog Pipelines YML DSL"] = 686,
    ["JMeter DSL cli config schema"] = 288,
    JReleaser = 290,
    ["JSON Document Transform"] = 297,
    ["JSON Feed"] = 298,
    ["JSON Resume"] = 442,
    ["JSON Schema Draft 2020-12"] = 566,
    ["JSON Schema Draft 4"] = 563,
    ["JSON Schema Draft 7"] = 564,
    ["JSON Schema Draft 8"] = 565,
    ...
    ["JSON-API"] = 296,
    ["JSON-e templates"] = 625,
    ["JSON-stat 2.0"] = 560,
    JSONPatch = 300,
    Jasmine = 281,
    Jekyll = 282,
    ["Jenkins X Pipelines"] = 283,
    ["Jenkins X Requirements"] = 284,
    ["Jovo Language Models"] = 289,
    ["KSP-AVC"] = 561,
    ["KSP-CKAN"] = 562,
    ["Karakum configuration file"] = 230,
    Kas = 303,
    ["Keycloak REST API"] = 693,
    ["Knative Functions - func.yaml"] = 231,
    ["KoDE/CI build.yaml"] = 682,
    ["Kong DBLess Schema"] = 683,
    KrakenD = 304,
    LOOBin = 320,
    Lefthook = 311,
    ["LinkML Metamodel"] = 318,
    Liquibase = 632,
    ["Liquibase Flow File"] = 633,
    ["Lively Properties"] = 319,
    Markdownlint = 636,
    ["Mason Registry"] = 638,
    ["MegaLinter configuration"] = 326,
    ["MegaLinter descriptor"] = 327,
    ["Meltano plugin discovery definition"] = 329,
    ["Meltano project definition"] = 328,
    ["Microsoft Band Web Tile"] = 330,
    ["Minecraft Data Pack Advancement"] = 332,
    ["Minecraft Data Pack Biome"] = 333,
    ["Minecraft Data Pack Configured Carver"] = 334,
    ["Minecraft Data Pack Damage Type"] = 335,
    ["Minecraft Data Pack Dimension"] = 337,
    ["Minecraft Data Pack Dimension Type"] = 336,
    ["Minecraft Data Pack Item Modifier"] = 338,
    ["Minecraft Data Pack Loot Table"] = 339,
    ["Minecraft Data Pack Metadata"] = 340,
    ["Minecraft Data Pack Predicate"] = 341,
    ["Minecraft Data Pack Recipe"] = 342,
    ["Minecraft Data Pack Tag"] = 343,
    ["Minecraft Data Pack Template Pool"] = 344,
    ["Minecraft Data Pack Trim Material"] = 349,
    ["Minecraft Data Pack Trim Pattern"] = 350,
    ["Minecraft Resource Pack Lang"] = 345,
    ["Minecraft Resource Pack Particle"] = 346,
    ["Minecraft Resource Pack Texture Mcmeta"] = 348,
    ["Minecraft Resourcepack Sounds"] = 347,
    ["MkDocs Configuration 1.0"] = 351,
    ["MongoDB Atlas Search Index Definition Schema"] = 681,
    ["Monika Configuration Schema"] = 679,
    ["Motif config"] = 583,
    ["NOX Framework (Service)"] = 365,
    ["Netin Diagnostic System Template"] = 642,
    ["Netlify config schema"] = 356,
    ["Nexus-as-Code schema"] = 357,
    ["Nightwatch.js"] = 358,
    ["ONe's service descriptor"] = 378,
    ["OSS Review Toolkit configuration"] = 385,
    ["OSS Review Toolkit curation"] = 386,
    ["OSS Review Toolkit package configuration"] = 387,
    ["OSS Review Toolkit repository configuration"] = 388,
    ["OSS Review Toolkit resolutions"] = 389,
    Opctl = 586,
    ["OpenRewrite Resource"] = 380,
    ["OpenWeather Current Weather API"] = 624,
    ["OpenWeather Road Risk API"] = 623,
    ["Ory Hydra configuration"] = 269,
    ["Ory Keto configuration"] = 306,
    ["Ory Kratos configuration"] = 384,
    ["Ory Oathkeeper configuration"] = 372,
    ["Outblocks App configuration"] = 382,
    ["Outblocks database table"] = 383,
    ["Outblocks project configuration"] = 381,
    Packer = 392,
    Pantsbuild = 700,
    ["Paper paper-plugin.yml"] = 393,
    ["Pipeline component"] = 634,
    ["PocketMine plugin.yml"] = 397,
    ["Postman collection"] = 402,
    Pterodactyl = 676,
    ["Pull Request Labeler"] = 423,
    Pulumi = 429,
    PyProject = 430,
    Pyright = 431,
    Qodana = 652,
    ["Quali Torque Blueprint Spec 2"] = 674,
    ["QueryFirst config file"] = 696,
    ["RKE Cluster Configuration JSON Schema"] = 631,
    ["RKE Cluster Configuration YAML Schema"] = 630,
    ["Rancher Fleet"] = 426,
    Ray = 598,
    ["Read the Docs"] = 428,
    ["Red-DiscordBot Cog"] = 432,
    ["Red-DiscordBot Cog Repo"] = 433,
    ["Red-DiscordBot Trivia"] = 434,
    Renovate = 443,
    ["Replit schema"] = 437,
    RoadRunner = 444,
    Ruff = 440,
    ["Rust Project"] = 441,
    ["Rust toolchain"] = 446,
    ["SIL Kit Participant Configuration"] = 477,
    ["SIL Kit Registry Configuration"] = 478,
    SWADL = 500,
    ["Safebox Config Schema"] = 687,
    ["Sapphire CLI Config"] = 449,
    ["SauceCTL Configuration"] = 639,
    ["Schema Catalog"] = 463,
    ["Scoop manifest"] = 468,
    ["Semantic Data Fabric (SDF) file"] = 469,
    ["Semgrep Rule"] = 471,
    ["Serenity Code Generator (Sergen)"] = 472,
    ["Serverless Framework Configuration"] = 646,
    ["Serverless Workflow Schema"] = 648,
    ["Settings.paf"] = 474,
    ["Shopware 6 Configuration"] = 649,
    ["Shopware CLI Extension Store Configuration"] = 650,
    ["Shopware CLI Project Store Configuration"] = 651,
    ["Sigrid scope configuration file"] = 476,
    ["Slack app manifest"] = 480,
    Solidarity = 483,
    ["Solution filters"] = 484,
    ["Source Maps v3"] = 485,
    Sourcery = 486,
    SpecIF = 487,
    ["Sponge Mixin configuration"] = 488,
    ["StackHawk Scanner Configuration"] = 645,
    Stale = 492,
    Starship = 493,
    ["Statamic Blueprint"] = 494,
    ["StrmPrivacy Data Connector"] = 691,
    ["StrmPrivacy Data Contract"] = 692,
    ["StrmPrivacy SimpleSchema"] = 689,
    ["StrmPrivacy Stream"] = 690,
    ["StrmPrivacy batch job configuration file"] = 688,
    ["Stryker Mutator"] = 497,
    ["StyleCop Analyzers Configuration"] = 498,
    ["Swagger API 2.0"] = 501,
    TSON = 526,
    ["Talisman configuration"] = 503,
    ["Taskfile YAML Schema"] = 626,
    Taurus = 504,
    ["TestEnvironment.json"] = 513,
    ["Tier.run pricing.json"] = 507,
    Tikibase = 508,
    ["Traefik v2"] = 516,
    ["Traefik v2 File Provider"] = 517,
    Turborepo = 514,
    Tye = 653,
    ["UET BuildConfig.json"] = 697,
    ["UI5 Manifest"] = 533,
    ["UTAM Page Object"] = 536,
    ["Ubuntu Server Autoinstall"] = 531,
    ["Uniswap Token List"] = 608,
    ["Unreal Engine Uplugin"] = 698,
    ["Unreal Engine Uproject"] = 699,
    Updatecli = 660,
    Uplift = 695,
    ["User Journey Map YAML Schema"] = 629,
    V2Ray = 664,
    ["VSCode Code Snippets"] = 138,
    ["VSIX CLI publishing"] = 549,
    ["Vela Pipeline Configuration"] = 539,
    Vercel = 137,
    ["Web App Manifest"] = 556,
    ["Web types"] = 559,
    WebExtensions = 555,
    ["Webman package recipe"] = 670,
    ["Windows Package Manager Installer Manifest"] = 605,
    ["Windows Package Manager Locale Manifest"] = 606,
    ["Windows Package Manager Singleton Manifest"] = 604,
    ["Woodpecker pipeline config"] = 641,
    ["Xstate Machine Schema"] = 658,
    ["Yippee-Ki-JSON configuration YML"] = 610,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 65,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 706,
    ["bashly-strings.yml"] = 707,
    ["bashly.yml"] = 705,
    ["batect.yml"] = 64,
    ["beau.yml"] = 619,
    ...
    ["completely.yml"] = 703,
    ["component-detection-manifest.json"] = 160,
    ["component.json"] = 159,
    ["composer.json"] = 158,
    ["config.yaml"] = 427,
    ...
    ["dbt Project"] = 104,
    ["debugsettings.json"] = 176,
    ["dependabot-v2.json"] = 179,
    ["dependabot.json"] = 178,
    ["deployed-cli"] = 657,
    ["detekt.yml"] = 181,
    ...
    djlint = 613,
    ["docfx.json"] = 185,
    ["docker-compose.yml"] = 611,
    ["docker-seq schema"] = 184,
    ["dockerd.json"] = 183,
    ["dotnet Release Index manifest"] = 194,
    ["dotnetcli.host.json"] = 195,
    ["dprint.json"] = 196,
    ["drone.json"] = 197,
    ["dss-2.0.0.json"] = 199,
    ["dstack configuration"] = 200,
    ["dvc.yaml"] = 201,
    ["ecosystem.json"] = 206,
    eksctl = 207,
    ["electron-builder configuration file."] = 212,
    ["epr-manifest.json"] = 210,
    ["evcc.yaml"] = 213,
    ["ezd schema"] = 215,
    ["fabric.mod.json"] = 218,
    ["first-timers-bot"] = 222,
    ...
    ["gitlab-ci"] = 245,
    ["global.json"] = 247,
    ["golangci-lint Configuration"] = 248,
    ["haxelib.json"] = 262,
    helmfile = 600,
    helmwave = 601,
    ["host-meta.json"] = 267,
    ...
    ["ide.host.json"] = 272,
    ["ifstate.conf"] = 273,
    ["imageoptimizer.json"] = 274,
    ["importmap.json"] = 277,
    ["ioBroker Configuration"] = 278,
    ["ioBroker JSON UI"] = 279,
    ["ioBroker Package manifest"] = 280,
    ["ize.toml"] = 694,
    ["jsconfig.json"] = 301,
    ["jscpd Configuration Schema"] = 675,
    jsdoc = 597,
    ["k3d.yaml"] = 302,
    ["kontinuous-values.yaml"] = 307,
    ["kustomization.yaml"] = 308,
    ["label-commenter-config.yml"] = 309,
    ["launchsettings.json"] = 310,
    lazydocker = 716,
    lazygit = 715,
    ["lego.json"] = 312,
    ["lerna.json"] = 313,
    ["lgtm.yml"] = 314,
    ["libman.json"] = 315,
    ["license-report-config.json"] = 316,
    ["linkinator.config.json"] = 317,
    ["local.settings.json"] = 322,
    ["localazy.json"] = 323,
    ["lotus.yaml"] = 321,
    ["lsdlschema.json"] = 324,
    ["madness.yml"] = 704,
    ["markdown-lint-check"] = 637,
    mboats = 644,
    ["micro-settings.json"] = 709,
    ["mimetypes.json"] = 331,
    ["mirrord-schema"] = 580,
    ["mta.yaml"] = 581,
    ["mtad.yaml"] = 582,
    ["mycode.json"] = 354,
    ["napari plugin manifest"] = 355,
    neoload = 592,
    ["nest-cli"] = 361,
    ["ninjs (News in JSON) 1.3"] = 360,
    ["ninjs (News in JSON) 2.0"] = 359,
    ["nlu.json"] = 362,
    ["nodemon.json"] = 364,
    ["noodl.schema.json"] = 643,
    now = 588,
    ["npm-badges"] = 367,
    ["nswag.json"] = 370,
    ntangle = 371,
    ["nuclei-template.yaml"] = 368,
    ["nuget-project.json"] = 369,
    ["ocelot.json"] = 373,
    ["omnisharp.json"] = 374,
    ["openapi.json"] = 375,
    ["openfin.json"] = 379,
    ...
    ["ops.yaml"] = 377,
    ["package.json"] = 390,
    ["package.manifest"] = 391,
    ["pattern.json"] = 395,
    ["petstore-v1.0"] = 685,
    pgap_yaml_input_reader = 394,
    ["plagiarize-me.yaml"] = 399,
    ["plagiarize.yaml"] = 398,
    ["portman.json"] = 400,
    ["prettierrc.json"] = 407,
    ["prisma.yml"] = 408,
    ["project-1.0.0-beta3.json"] = 410,
    ["project-1.0.0-beta4.json"] = 411,
    ["project-1.0.0-beta5.json"] = 412,
    ["project-1.0.0-beta6.json"] = 413,
    ["project-1.0.0-beta8.json"] = 414,
    ["project-1.0.0-rc1.json"] = 415,
    ["project-1.0.0-rc2.json"] = 416,
    ["project.json"] = 409,
    ["prometheus.json"] = 417,
    ["prometheus.rules.json"] = 418,
    ["prometheus.rules.test.json"] = 419,
    ["proxies.json"] = 420,
    ["publiccode.yml"] = 421,
    ["pubspec.yaml"] = 422,
    ["pyrseas-0.8.json"] = 425,
    ["quilt.mod.json"] = 710,
    ["release drafter"] = 593,
    rtx = 439,
    rustfmt = 445,
    samt = 447,
    samtrc = 448,
    ["sarif-1.0.0.json"] = 450,
    ["sarif-2.0.0.json"] = 451,
    ["sarif-2.1.0"] = 461,
    ["sarif-2.1.0-rtm.2"] = 452,
    ["sarif-2.1.0-rtm.3"] = 454,
    ["sarif-2.1.0-rtm.4"] = 456,
    ["sarif-2.1.0-rtm.5"] = 458,
    ["sarif-2.1.0-rtm.6"] = 459,
    ["sarif-external-property-file-2.1.0"] = 462,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 453,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 455,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 457,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 460,
    ["schema.org - Action"] = 464,
    ["schema.org - ContactPoint"] = 465,
    ["schema.org - Place"] = 466,
    ["schema.org - Thing"] = 467,
    ["secrethub.yml"] = 712,
    ["semantic-release"] = 470,
    ["servicehub.config.json"] = 569,
    ["servicehub.service.json"] = 568,
    ["settings.job"] = 473,
    ["sfdx-hardis configuration"] = 475,
    ["size-limit configuration"] = 479,
    ["skaffold.yaml"] = 635,
    ["skyuxconfig.json"] = 481,
    snapcraft = 482,
    ["stripe-app-local.json"] = 496,
    ["stripe-app.json"] = 495,
    swcrc = 622,
    syntax = 714,
    ["task.json"] = 502,
    taskcat = 589,
    ["template.json"] = 505,
    ["templatsources.json"] = 506,
    ["theme.json"] = 509,
    ["tizen_workspace.json"] = 510,
    tldr = 511,
    tmLanguage = 512,
    tmuxinator = 577,
    ["transcend-pathfinder.yml"] = 519,
    ["transcend.yml"] = 518,
    ["trunk.yaml schema"] = 520,
    ["ts-force-config.json"] = 524,
    ["tsconfig.json"] = 521,
    ["tsd.json"] = 522,
    ["tsdrc.json"] = 523,
    ["tslint.json"] = 525,
    ...
    ["vega-lite.json"] = 538,
    ["vega.json"] = 537,
    ["venvironment-basic.yaml"] = 541,
    ["venvironment.yaml"] = 540,
    ["version.json"] = 542,
    ["vim-addon-info"] = 543,
    ["vs-2017.3.host.json"] = 545,
    ["vs-nesting.json"] = 546,
    ["vsls.json"] = 544,
    ["vss-extension.json"] = 550,
    ["vtesttree.yaml"] = 551,
    ["vtestunit.yaml"] = 552,
    ["webhint.io"] = 671,
    ["webjobpublishsettings.json"] = 558,
    ["webjobs-list.json"] = 557,
    ["xs-app.json"] = 585,
    ["xunit.runner.json"] = 567,
    yamllint = 609,
    zuul = 594,
    ["Žinoma"] = 603
  },
