...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 166,
    [".cryproj (generic)"] = 574,
    [".cryproj engine-5.2"] = 569,
    [".cryproj engine-5.3"] = 570,
    [".cryproj engine-5.4"] = 571,
    [".cryproj engine-5.5"] = 572,
    [".cryproj engine-dev"] = 573,
    [".csscomb.json"] = 168,
    [".csslintrc"] = 169,
    [".es6importsorterrc.json"] = 701,
    [".eslintrc"] = 215,
    [".esmrc.json"] = 207,
    [".ffizer.yaml"] = 219,
    [".htmlhintrc"] = 267,
    ...
    [".mtaext"] = 583,
    [".nodehawkrc"] = 362,
    [".npmpackagejsonlintrc"] = 365,
    [".phraseapp.yml"] = 405,
    [".pmbot.yml"] = 395,
    [".postcssrc"] = 400,
    [".powerpages-web-template-manifest"] = 402,
    [".pre-commit-config.yml"] = 403,
    [".pre-commit-hooks.yml"] = 404,
    [".putout.json"] = 423,
    [".rehyperc"] = 434,
    [".remarkrc"] = 435,
    [".sprite files"] = 488,
    ...
    ["<div>RIOTS' studio configuration"] = 553,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config schema"] = 324,
    ["API Builder"] = 614,
    ["AVA Configuration Schema"] = 671,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration Schema"] = 646,
    ["All Contributors configuration file"] = 700,
    ...
    ["Azure Pipelines"] = 54,
    ["Azure Static Web Apps CLI configuration file"] = 490,
    ["Azure Static Web Apps configuration file"] = 489,
    ["BX CI"] = 89,
    ["Better Code Hub"] = 619,
    ["Better Scripts"] = 90,
    BizTalkServerApplicationSchema = 589,
    ...
    ["Butane Config"] = 658,
    ["CICS TS region tagging"] = 665,
    ["CICS TS resource import"] = 666,
    ["CICS TS resource model"] = 667,
    ["CICS TS resource overrides"] = 668,
    ["CMake Presets"] = 91,
    ...
    Cheatsheets = 655,
    ["Chrome Extension"] = 144,
    ["CircleCI config.yml"] = 123,
    ["Citation File Format"] = 155,
    CityJSON = 98,
    ["Code Climate"] = 124,
    CodeCV = 53,
    Codux = 132,
    ...
    Conjure = 99,
    ["Container Structure Test"] = 601,
    Containerlab = 627,
    ["Crowdsec collection Schema"] = 162,
    ["Crowdsec parser Schema"] = 163,
    ["Crowdsec scenario Schema"] = 164,
    ["DWP Exchange - catalogue entry"] = 204,
    ["DWP Exchange - gateway"] = 202,
    ["DWP Exchange - meta"] = 203,
    ["Dart build configuration"] = 170,
    ["Dart test config"] = 171,
    ["DashLord configuration"] = 172,
    ["Datadog Service Definition"] = 304,
    ["Datahub Ingestion Recipe Schema"] = 672,
    ...
    Devfile = 201,
    ["Discord Webhook"] = 181,
    ["Dolittle Artifacts"] = 185,
    ["Dolittle Bounded Context Configuration"] = 186,
    ["Dolittle Event Horizons Configuration"] = 187,
    ["Dolittle Resources Configuration"] = 188,
    ["Dolittle Server Configuration"] = 189,
    ["Dolittle Tenant Map Configuration"] = 191,
    ["Dolittle Tenants Configuration"] = 190,
    ["Dolittle Topology"] = 192,
    ...
    ["Drush site aliases"] = 197,
    ["Embrace Config Schema"] = 683,
    ["Error pages"] = 210,
    Esquio = 208,
    ["Estuary Flow Catalog Schema"] = 662,
    ["Expo SDK"] = 213,
    ["F-Droid Data metadata"] = 218,
    ["Facets - FSDL - Application"] = 216,
    ["FasterCI Configuration"] = 55,
    Firebase = 220,
    ["Fossa configuration file"] = 227,
    ["Fossa's fossa-deps file"] = 228,
    ["Foundry VTT - Base package Manifest"] = 222,
    ["Foundry VTT - Module Manifest"] = 223,
    ["Foundry VTT - System Data Template"] = 226,
    ["Foundry VTT - System Manifest"] = 224,
    ["Foundry VTT - World Manifest"] = 225,
    ["Foxx Manifest"] = 56,
    ["Freifunk.de Community API"] = 59,
    ["Frogbot Config"] = 60,
    ["GCP Blueprint Metadata"] = 233,
    ["GatewayCore API Gateway"] = 232,
    ["GeoJSON.json latest"] = 660,
    GherKing = 664,
    ["GitHub Action"] = 237,
    ["GitHub Discussion"] = 238,
    ["GitHub Funding"] = 239,
    ["GitHub Issue Template configuration"] = 241,
    ["GitHub Workflow"] = 242,
    ["GitHub Workflow Template Properties"] = 243,
    ["GitHub issue forms"] = 240,
    GitVersion = 236,
    ["Gitpod Configuration"] = 245,
    ["Global Privacy Control"] = 234,
    ["Google Cloud Workflows"] = 150,
    Goreleaser = 248,
    ["Goreleaser Pro"] = 249,
    Goss = 250,
    ["Gradle Build Cache Node"] = 616,
    ["Gradle Enterprise"] = 615,
    ["Grafana 5.x Dashboard"] = 251,
    ["GraphQL Code Generator"] = 254,
    ["GraphQL Config"] = 253,
    ["GraphQL Mesh"] = 252,
    ["Grunt JSHint task"] = 258,
    ["Grunt Watch task"] = 259,
    ["Grunt base task"] = 260,
    ["Grunt clean task"] = 256,
    ["Grunt copy task"] = 255,
    ["Grunt cssmin task"] = 257,
    HEMTT = 586,
    Hadolint = 598,
    Hammerkit = 626,
    ["Hardware Sentry Configuration"] = 676,
    Hayson = 262,
    ["Haystack Pipeline"] = 263,
    ["Hazelcast 5 Configuration"] = 264,
    ["Helm Chart.lock"] = 121,
    ["Helm Chart.yaml"] = 120,
    ["Helm Unittest Test Suite"] = 122,
    Hugo = 654,
    ["IBM Zapp document"] = 269,
    ["IBM zCodeFormatSettings"] = 270,
    ["IMG Catapult PSP"] = 275,
    ["Istanbul Schema"] = 679,
    ["JDownloader2 crawler multi-rule schema"] = 285,
    ["JDownloader2 crawler single-rule schema"] = 284,
    ["JFrog File Spec"] = 286,
    ["JFrog Pipelines YML DSL"] = 685,
    ["JMeter DSL cli config schema"] = 287,
    JReleaser = 289,
    ["JSON Document Transform"] = 296,
    ["JSON Feed"] = 297,
    ["JSON Resume"] = 441,
    ["JSON Schema Draft 2020-12"] = 565,
    ["JSON Schema Draft 4"] = 562,
    ["JSON Schema Draft 7"] = 563,
    ["JSON Schema Draft 8"] = 564,
    ...
    ["JSON-API"] = 295,
    ["JSON-e templates"] = 624,
    ["JSON-stat 2.0"] = 559,
    JSONPatch = 299,
    Jasmine = 280,
    Jekyll = 281,
    ["Jenkins X Pipelines"] = 282,
    ["Jenkins X Requirements"] = 283,
    ["Jovo Language Models"] = 288,
    ["KSP-AVC"] = 560,
    ["KSP-CKAN"] = 561,
    ["Karakum configuration file"] = 229,
    Kas = 302,
    ["Keycloak REST API"] = 692,
    ["Knative Functions - func.yaml"] = 230,
    ["KoDE/CI build.yaml"] = 681,
    ["Kong DBLess Schema"] = 682,
    KrakenD = 303,
    LOOBin = 319,
    Lefthook = 310,
    ["LinkML Metamodel"] = 317,
    Liquibase = 631,
    ["Liquibase Flow File"] = 632,
    ["Lively Properties"] = 318,
    Markdownlint = 635,
    ["Mason Registry"] = 637,
    ["MegaLinter configuration"] = 325,
    ["MegaLinter descriptor"] = 326,
    ["Meltano plugin discovery definition"] = 328,
    ["Meltano project definition"] = 327,
    ["Microsoft Band Web Tile"] = 329,
    ["Minecraft Data Pack Advancement"] = 331,
    ["Minecraft Data Pack Biome"] = 332,
    ["Minecraft Data Pack Configured Carver"] = 333,
    ["Minecraft Data Pack Damage Type"] = 334,
    ["Minecraft Data Pack Dimension"] = 336,
    ["Minecraft Data Pack Dimension Type"] = 335,
    ["Minecraft Data Pack Item Modifier"] = 337,
    ["Minecraft Data Pack Loot Table"] = 338,
    ["Minecraft Data Pack Metadata"] = 339,
    ["Minecraft Data Pack Predicate"] = 340,
    ["Minecraft Data Pack Recipe"] = 341,
    ["Minecraft Data Pack Tag"] = 342,
    ["Minecraft Data Pack Template Pool"] = 343,
    ["Minecraft Data Pack Trim Material"] = 348,
    ["Minecraft Data Pack Trim Pattern"] = 349,
    ["Minecraft Resource Pack Lang"] = 344,
    ["Minecraft Resource Pack Particle"] = 345,
    ["Minecraft Resource Pack Texture Mcmeta"] = 347,
    ["Minecraft Resourcepack Sounds"] = 346,
    ["MkDocs Configuration 1.0"] = 350,
    ["MongoDB Atlas Search Index Definition Schema"] = 680,
    ["Monika Configuration Schema"] = 678,
    ["Motif config"] = 582,
    ["NOX Framework (Service)"] = 364,
    ["Netin Diagnostic System Template"] = 641,
    ["Netlify config schema"] = 355,
    ["Nexus-as-Code schema"] = 356,
    ["Nightwatch.js"] = 357,
    ["ONe's service descriptor"] = 377,
    ["OSS Review Toolkit configuration"] = 384,
    ["OSS Review Toolkit curation"] = 385,
    ["OSS Review Toolkit package configuration"] = 386,
    ["OSS Review Toolkit repository configuration"] = 387,
    ["OSS Review Toolkit resolutions"] = 388,
    Opctl = 585,
    ["OpenRewrite Resource"] = 379,
    ["OpenWeather Current Weather API"] = 623,
    ["OpenWeather Road Risk API"] = 622,
    ["Ory Hydra configuration"] = 268,
    ["Ory Keto configuration"] = 305,
    ["Ory Kratos configuration"] = 383,
    ["Ory Oathkeeper configuration"] = 371,
    ["Outblocks App configuration"] = 381,
    ["Outblocks database table"] = 382,
    ["Outblocks project configuration"] = 380,
    Packer = 391,
    Pantsbuild = 699,
    ["Paper paper-plugin.yml"] = 392,
    ["Pipeline component"] = 633,
    ["PocketMine plugin.yml"] = 396,
    ["Postman collection"] = 401,
    Pterodactyl = 675,
    ["Pull Request Labeler"] = 422,
    Pulumi = 428,
    PyProject = 429,
    Pyright = 430,
    Qodana = 651,
    ["Quali Torque Blueprint Spec 2"] = 673,
    ["QueryFirst config file"] = 695,
    ["RKE Cluster Configuration JSON Schema"] = 630,
    ["RKE Cluster Configuration YAML Schema"] = 629,
    ["Rancher Fleet"] = 425,
    Ray = 597,
    ["Read the Docs"] = 427,
    ["Red-DiscordBot Cog"] = 431,
    ["Red-DiscordBot Cog Repo"] = 432,
    ["Red-DiscordBot Trivia"] = 433,
    Renovate = 442,
    ["Replit schema"] = 436,
    RoadRunner = 443,
    Ruff = 439,
    ["Rust Project"] = 440,
    ["Rust toolchain"] = 445,
    ["SIL Kit Participant Configuration"] = 476,
    ["SIL Kit Registry Configuration"] = 477,
    SWADL = 499,
    ["Safebox Config Schema"] = 686,
    ["Sapphire CLI Config"] = 448,
    ["SauceCTL Configuration"] = 638,
    ["Schema Catalog"] = 462,
    ["Scoop manifest"] = 467,
    ["Semantic Data Fabric (SDF) file"] = 468,
    ["Semgrep Rule"] = 470,
    ["Serenity Code Generator (Sergen)"] = 471,
    ["Serverless Framework Configuration"] = 645,
    ["Serverless Workflow Schema"] = 647,
    ["Settings.paf"] = 473,
    ["Shopware 6 Configuration"] = 648,
    ["Shopware CLI Extension Store Configuration"] = 649,
    ["Shopware CLI Project Store Configuration"] = 650,
    ["Sigrid scope configuration file"] = 475,
    ["Slack app manifest"] = 479,
    Solidarity = 482,
    ["Solution filters"] = 483,
    ["Source Maps v3"] = 484,
    Sourcery = 485,
    SpecIF = 486,
    ["Sponge Mixin configuration"] = 487,
    ["StackHawk Scanner Configuration"] = 644,
    Stale = 491,
    Starship = 492,
    ["Statamic Blueprint"] = 493,
    ["StrmPrivacy Data Connector"] = 690,
    ["StrmPrivacy Data Contract"] = 691,
    ["StrmPrivacy SimpleSchema"] = 688,
    ["StrmPrivacy Stream"] = 689,
    ["StrmPrivacy batch job configuration file"] = 687,
    ["Stryker Mutator"] = 496,
    ["StyleCop Analyzers Configuration"] = 497,
    ["Swagger API 2.0"] = 500,
    TSON = 525,
    ["Talisman configuration"] = 502,
    ["Taskfile YAML Schema"] = 625,
    Taurus = 503,
    ["TestEnvironment.json"] = 512,
    ["Tier.run pricing.json"] = 506,
    Tikibase = 507,
    ["Traefik v2"] = 515,
    ["Traefik v2 File Provider"] = 516,
    Turborepo = 513,
    Tye = 652,
    ["UET BuildConfig.json"] = 696,
    ["UI5 Manifest"] = 532,
    ["UTAM Page Object"] = 535,
    ["Ubuntu Server Autoinstall"] = 530,
    ["Uniswap Token List"] = 607,
    ["Unreal Engine Uplugin"] = 697,
    ["Unreal Engine Uproject"] = 698,
    Updatecli = 659,
    Uplift = 694,
    ["User Journey Map YAML Schema"] = 628,
    V2Ray = 663,
    ["VSCode Code Snippets"] = 138,
    ["VSIX CLI publishing"] = 548,
    ["Vela Pipeline Configuration"] = 538,
    Vercel = 137,
    ["Web App Manifest"] = 555,
    ["Web types"] = 558,
    WebExtensions = 554,
    ["Webman package recipe"] = 669,
    ["Windows Package Manager Installer Manifest"] = 604,
    ["Windows Package Manager Locale Manifest"] = 605,
    ["Windows Package Manager Singleton Manifest"] = 603,
    ["Woodpecker pipeline config"] = 640,
    ["Xstate Machine Schema"] = 657,
    ["Yippee-Ki-JSON configuration YML"] = 609,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 65,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 705,
    ["bashly-strings.yml"] = 706,
    ["bashly.yml"] = 704,
    ["batect.yml"] = 64,
    ["beau.yml"] = 618,
    ...
    ["chisel-slices.json"] = 154,
    ["chrome-extension-locales-messages.json"] = 145,
    ["chutzpah.json"] = 146,
    clangd = 127,
    clib = 128,
    ...
    ["completely.yml"] = 702,
    ["component-detection-manifest.json"] = 159,
    ["component.json"] = 158,
    ["composer.json"] = 157,
    ["config.yaml"] = 426,
    ["contentmanifest.json"] = 147,
    ["contribute.json"] = 160,
    ["cosmos.config.json"] = 143,
    ["crowdin.yml"] = 161,
    cspell = 167,
    ["cypress.json"] = 165,
    ["datalogic-scan2deploy-android"] = 173,
    ["datalogic-scan2deploy-ce"] = 174,
    ["dbt Project"] = 104,
    ["debugsettings.json"] = 175,
    ["dependabot-v2.json"] = 178,
    ["dependabot.json"] = 177,
    ["deployed-cli"] = 656,
    ["detekt.yml"] = 180,
    ["devcontainer.json"] = 133,
    devinit = 611,
    ["devspace.yaml"] = 677,
    djlint = 612,
    ["docfx.json"] = 184,
    ["docker-compose.yml"] = 610,
    ["docker-seq schema"] = 183,
    ["dockerd.json"] = 182,
    ["dotnet Release Index manifest"] = 193,
    ["dotnetcli.host.json"] = 194,
    ["dprint.json"] = 195,
    ["drone.json"] = 196,
    ["dss-2.0.0.json"] = 198,
    ["dstack configuration"] = 199,
    ["dvc.yaml"] = 200,
    ["ecosystem.json"] = 205,
    eksctl = 206,
    ["electron-builder configuration file."] = 211,
    ["epr-manifest.json"] = 209,
    ["evcc.yaml"] = 212,
    ["ezd schema"] = 214,
    ["fabric.mod.json"] = 217,
    ["first-timers-bot"] = 221,
    ...
    ["gitlab-ci"] = 244,
    ["global.json"] = 246,
    ["golangci-lint Configuration"] = 247,
    ["haxelib.json"] = 261,
    helmfile = 599,
    helmwave = 600,
    ["host-meta.json"] = 266,
    ...
    ["ide.host.json"] = 271,
    ["ifstate.conf"] = 272,
    ["imageoptimizer.json"] = 273,
    ["importmap.json"] = 276,
    ["ioBroker Configuration"] = 277,
    ["ioBroker JSON UI"] = 278,
    ["ioBroker Package manifest"] = 279,
    ["ize.toml"] = 693,
    ["jsconfig.json"] = 300,
    ["jscpd Configuration Schema"] = 674,
    jsdoc = 596,
    ["k3d.yaml"] = 301,
    ["kontinuous-values.yaml"] = 306,
    ["kustomization.yaml"] = 307,
    ["label-commenter-config.yml"] = 308,
    ["launchsettings.json"] = 309,
    lazydocker = 715,
    lazygit = 714,
    ["lego.json"] = 311,
    ["lerna.json"] = 312,
    ["lgtm.yml"] = 313,
    ["libman.json"] = 314,
    ["license-report-config.json"] = 315,
    ["linkinator.config.json"] = 316,
    ["local.settings.json"] = 321,
    ["localazy.json"] = 322,
    ["lotus.yaml"] = 320,
    ["lsdlschema.json"] = 323,
    ["madness.yml"] = 703,
    ["markdown-lint-check"] = 636,
    mboats = 643,
    ["micro-settings.json"] = 708,
    ["mimetypes.json"] = 330,
    ["mirrord-schema"] = 579,
    ["mta.yaml"] = 580,
    ["mtad.yaml"] = 581,
    ["mycode.json"] = 353,
    ["napari plugin manifest"] = 354,
    neoload = 591,
    ["nest-cli"] = 360,
    ["ninjs (News in JSON) 1.3"] = 359,
    ["ninjs (News in JSON) 2.0"] = 358,
    ["nlu.json"] = 361,
    ["nodemon.json"] = 363,
    ["noodl.schema.json"] = 642,
    now = 587,
    ["npm-badges"] = 366,
    ["nswag.json"] = 369,
    ntangle = 370,
    ["nuclei-template.yaml"] = 367,
    ["nuget-project.json"] = 368,
    ["ocelot.json"] = 372,
    ["omnisharp.json"] = 373,
    ["openapi.json"] = 374,
    ["openfin.json"] = 378,
    ...
    ["ops.yaml"] = 376,
    ["package.json"] = 389,
    ["package.manifest"] = 390,
    ["pattern.json"] = 394,
    ["petstore-v1.0"] = 684,
    pgap_yaml_input_reader = 393,
    ["plagiarize-me.yaml"] = 398,
    ["plagiarize.yaml"] = 397,
    ["portman.json"] = 399,
    ["prettierrc.json"] = 406,
    ["prisma.yml"] = 407,
    ["project-1.0.0-beta3.json"] = 409,
    ["project-1.0.0-beta4.json"] = 410,
    ["project-1.0.0-beta5.json"] = 411,
    ["project-1.0.0-beta6.json"] = 412,
    ["project-1.0.0-beta8.json"] = 413,
    ["project-1.0.0-rc1.json"] = 414,
    ["project-1.0.0-rc2.json"] = 415,
    ["project.json"] = 408,
    ["prometheus.json"] = 416,
    ["prometheus.rules.json"] = 417,
    ["prometheus.rules.test.json"] = 418,
    ["proxies.json"] = 419,
    ["publiccode.yml"] = 420,
    ["pubspec.yaml"] = 421,
    ["pyrseas-0.8.json"] = 424,
    ["quilt.mod.json"] = 709,
    ["release drafter"] = 592,
    rtx = 438,
    rustfmt = 444,
    samt = 446,
    samtrc = 447,
    ["sarif-1.0.0.json"] = 449,
    ["sarif-2.0.0.json"] = 450,
    ["sarif-2.1.0"] = 460,
    ["sarif-2.1.0-rtm.2"] = 451,
    ["sarif-2.1.0-rtm.3"] = 453,
    ["sarif-2.1.0-rtm.4"] = 455,
    ["sarif-2.1.0-rtm.5"] = 457,
    ["sarif-2.1.0-rtm.6"] = 458,
    ["sarif-external-property-file-2.1.0"] = 461,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 452,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 454,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 456,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 459,
    ["schema.org - Action"] = 463,
    ["schema.org - ContactPoint"] = 464,
    ["schema.org - Place"] = 465,
    ["schema.org - Thing"] = 466,
    ["secrethub.yml"] = 711,
    ["semantic-release"] = 469,
    ["servicehub.config.json"] = 568,
    ["servicehub.service.json"] = 567,
    ["settings.job"] = 472,
    ["sfdx-hardis configuration"] = 474,
    ["size-limit configuration"] = 478,
    ["skaffold.yaml"] = 634,
    ["skyuxconfig.json"] = 480,
    snapcraft = 481,
    ["stripe-app-local.json"] = 495,
    ["stripe-app.json"] = 494,
    swcrc = 621,
    syntax = 713,
    ["task.json"] = 501,
    taskcat = 588,
    ["template.json"] = 504,
    ["templatsources.json"] = 505,
    ["theme.json"] = 508,
    ["tizen_workspace.json"] = 509,
    tldr = 510,
    tmLanguage = 511,
    tmuxinator = 576,
    ["transcend-pathfinder.yml"] = 518,
    ["transcend.yml"] = 517,
    ["trunk.yaml schema"] = 519,
    ["ts-force-config.json"] = 523,
    ["tsconfig.json"] = 520,
    ["tsd.json"] = 521,
    ["tsdrc.json"] = 522,
    ["tslint.json"] = 524,
    ...
    ["vega-lite.json"] = 537,
    ["vega.json"] = 536,
    ["venvironment-basic.yaml"] = 540,
    ["venvironment.yaml"] = 539,
    ["version.json"] = 541,
    ["vim-addon-info"] = 542,
    ["vs-2017.3.host.json"] = 544,
    ["vs-nesting.json"] = 545,
    ["vsls.json"] = 543,
    ["vss-extension.json"] = 549,
    ["vtesttree.yaml"] = 550,
    ["vtestunit.yaml"] = 551,
    ["webhint.io"] = 670,
    ["webjobpublishsettings.json"] = 557,
    ["webjobs-list.json"] = 556,
    ["xs-app.json"] = 584,
    ["xunit.runner.json"] = 566,
    yamllint = 608,
    zuul = 593,
    ["Žinoma"] = 602
  },
