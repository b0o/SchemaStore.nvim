...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 111,
    [".cryproj (generic)"] = 416,
    [".cryproj engine-5.2"] = 411,
    [".cryproj engine-5.3"] = 412,
    [".cryproj engine-5.4"] = 413,
    [".cryproj engine-5.5"] = 414,
    [".cryproj engine-dev"] = 415,
    [".csscomb.json"] = 113,
    [".csslintrc"] = 114,
    [".eslintrc"] = 150,
    [".esmrc.json"] = 143,
    ...
    [".mtaext"] = 422,
    [".nodehawkrc"] = 260,
    [".npmpackagejsonlintrc"] = 262,
    [".phraseapp.yml"] = 289,
    [".pmbot.yml"] = 282,
    [".postcssrc"] = 287,
    [".pre-commit-config.yml"] = 288,
    [".putout.json"] = 306,
    [".rehyperc"] = 311,
    [".remarkrc"] = 312,
    [".sprite files"] = 347,
    ...
    [".vsext"] = 392,
    [".yarnrc.yml"] = 454,
    ["<div>RIOTS' studio configuration"] = 395,
    ["API Builder"] = 451,
    ...
    ["Azure Pipelines"] = 40,
    ["Azure Static Web Apps CLI configuration file"] = 349,
    ["Azure Static Web Apps configuration file"] = 348,
    ["Better Code Hub"] = 456,
    BizTalkServerApplicationSchema = 428,
    ...
    ["Error pages"] = 146,
    Esquio = 144,
    ["Estuary Flow Catalog Schema"] = 494,
    ["Expo SDK"] = 149,
    ["F-Droid Data metadata"] = 153,
    ["Facets - FSDL - Application"] = 151,
    ["Fossa configuration file"] = 158,
    ["Fossa's fossa-deps file"] = 159,
    ["Foundry VTT - Manifest"] = 156,
    ["Foundry VTT - Template"] = 157,
    ["Foxx Manifest"] = 41,
    ["GatewayCore API Gateway"] = 162,
    ["GeoJSON.json latest"] = 492,
    GherKing = 496,
    ["GitHub Action"] = 166,
    ["GitHub Funding"] = 167,
    ["GitHub Issue Template configuration"] = 169,
    ["GitHub Workflow"] = 170,
    ["GitHub Workflow Template Properties"] = 171,
    ["GitHub issue forms"] = 168,
    GitVersion = 165,
    ["Gitpod Configuration"] = 173,
    ["Global Privacy Control"] = 163,
    ["Google Cloud Workflows"] = 99,
    Goreleaser = 176,
    ["Goreleaser Pro"] = 177,
    ["Gradle Build Cache Node"] = 453,
    ["Gradle Enterprise"] = 452,
    ["Grafana 5.x Dashboard"] = 178,
    ["GraphQL Code Generator"] = 181,
    ["GraphQL Config"] = 180,
    ["GraphQL Mesh"] = 179,
    ["Grunt JSHint task"] = 185,
    ["Grunt Watch task"] = 186,
    ["Grunt base task"] = 187,
    ["Grunt clean task"] = 183,
    ["Grunt copy task"] = 182,
    ["Grunt cssmin task"] = 184,
    HEMTT = 425,
    Hadolint = 437,
    ["Hammerkit YAML Schema"] = 463,
    Hayson = 189,
    ["Haystack Pipeline"] = 190,
    ["Hazelcast 5 Configuration"] = 191,
    ["Helm Chart.lock"] = 77,
    ["Helm Chart.yaml"] = 76,
    Hugo = 486,
    ["JFrog File Spec"] = 205,
    ["JSON Document Transform"] = 213,
    ["JSON Feed"] = 214,
    ["JSON Resume"] = 314,
    ["JSON Schema Draft 2020-12"] = 407,
    ["JSON Schema Draft 4"] = 404,
    ["JSON Schema Draft 7"] = 405,
    ["JSON Schema Draft 8"] = 406,
    ...
    ["JSON-API"] = 212,
    ["JSON-e templates"] = 461,
    ["JSON-stat 2.0"] = 401,
    JSONPatch = 216,
    Jekyll = 202,
    ["Jenkins X Pipelines"] = 203,
    ["Jenkins X Requirements"] = 204,
    ["Jovo Language Models"] = 206,
    ["KSP-AVC"] = 402,
    ["KSP-CKAN"] = 403,
    Liquibase = 468,
    Markdownlint = 471,
    ["MegaLinter configuration"] = 232,
    ["MegaLinter descriptor"] = 233,
    ["Meltano plugin discovery definition"] = 235,
    ["Meltano project definition"] = 234,
    ["Microsoft Band Web Tile"] = 236,
    ["Minecraft Data Pack Advancement"] = 238,
    ["Minecraft Data Pack Biome"] = 239,
    ["Minecraft Data Pack Configured Carver"] = 240,
    ["Minecraft Data Pack Dimension"] = 242,
    ["Minecraft Data Pack Dimension Type"] = 241,
    ["Minecraft Data Pack Item Modifier"] = 243,
    ["Minecraft Data Pack Loot Table"] = 244,
    ["Minecraft Data Pack Metadata"] = 245,
    ["Minecraft Data Pack Predicate"] = 246,
    ["Minecraft Data Pack Recipe"] = 247,
    ["Minecraft Data Pack Template Pool"] = 248,
    ["Minecraft Resourcepack Sounds"] = 249,
    ["Netin Diagnostic System Template"] = 475,
    ["Netlify config schema"] = 254,
    ["Nightwatch.js"] = 255,
    ["OSS Review Toolkit repository configuration"] = 276,
    Opctl = 424,
    ["OpenWeather Current Weather API"] = 460,
    ["OpenWeather Road Risk API"] = 459,
    ["Ory Hydra configuration"] = 195,
    ["Ory Keto configuration"] = 220,
    ["Ory Kratos configuration"] = 275,
    ["Ory Oathkeeper configuration"] = 267,
    ["Outblocks App configuration"] = 273,
    ["Outblocks database table"] = 274,
    ["Outblocks project configuration"] = 272,
    Packer = 279,
    ["Pipeline component"] = 469,
    ["PocketMine plugin.yml"] = 283,
    ["Pull Request Labeler"] = 305,
    Qodana = 483,
    ["RKE Cluster Configuration JSON Schema"] = 467,
    ["RKE Cluster Configuration YAML Schema"] = 466,
    Ray = 436,
    ["Read the Docs"] = 308,
    ["Red-DiscordBot Cog"] = 309,
    ["Red-DiscordBot Cog Repo"] = 310,
    Renovate = 315,
    RoadRunner = 316,
    SWADL = 358,
    ["Sapphire CLI Config"] = 317,
    ["SauceCTL Configuration"] = 472,
    ["Schema Catalog"] = 330,
    ["Scoop manifest"] = 335,
    ["Semgrep Rule"] = 336,
    ["Serverless Framework Configuration"] = 479,
    ["Settings.paf"] = 338,
    ["Shopware 6 Configuration"] = 480,
    ["Shopware CLI Extension Store Configuration"] = 481,
    ["Shopware CLI Project Store Configuration"] = 482,
    Solidarity = 343,
    ["Source Maps v3"] = 344,
    SpecIF = 345,
    ["Sponge Mixin configuration"] = 346,
    ["StackHawk Scanner Configuration"] = 478,
    ["StackHead CLI config"] = 350,
    ["StackHead module configuration"] = 351,
    ["StackHead project definition"] = 352,
    Stale = 353,
    ["Statamic Blueprint"] = 354,
    ["Stryker Mutator"] = 355,
    ["StyleCop Analyzers Configuration"] = 356,
    ["Swagger API 2.0"] = 359,
    ["Taskfile YAML Schema"] = 462,
    Taurus = 360,
    ["TestEnvironment.json"] = 366,
    Tikibase = 363,
    ["Traefik v2"] = 368,
    ["Traefik v2 File Provider"] = 369,
    Tye = 484,
    ["UI5 Manifest"] = 381,
    ["Ubuntu Server Autoinstall"] = 379,
    ["Uniswap Token List"] = 445,
    Updatecli = 491,
    ["User Journey Map YAML Schema"] = 465,
    V2Ray = 495,
    ["VSCode Code Snippets"] = 89,
    ["VSIX CLI publishing"] = 393,
    ["Vela Pipeline Configuration"] = 385,
    Vercel = 88,
    ["Web App Manifest"] = 397,
    ["Web types"] = 400,
    WebExtensions = 396,
    ["Windows Package Manager Installer Manifest"] = 442,
    ["Windows Package Manager Locale Manifest"] = 443,
    ["Windows Package Manager Singleton Manifest"] = 441,
    ["Woodpecker pipeline config"] = 474,
    ["Xstate Machine Schema"] = 489,
    ["Yippee-Ki-JSON configuration YML"] = 447,
    ["angular.json"] = 8,
    ...
    ["dvc.yaml"] = 140,
    ["ecosystem.json"] = 142,
    ["electron-builder configuration file."] = 147,
    ["epr-manifest.json"] = 145,
    ["evcc.yaml"] = 148,
    ["fabric.mod.json"] = 152,
    ["first-timers-bot"] = 155,
    fulibWorkflows = 473,
    ["func.yaml"] = 160,
    ["function.json"] = 161,
    ["geojson.json"] = 164,
    ["gitlab-ci"] = 172,
    ["global.json"] = 174,
    ["golangci-lint Configuration"] = 175,
    ["haxelib.json"] = 188,
    helmfile = 438,
    ["host-meta.json"] = 193,
    ["host.json"] = 192,
    ...
    huskyrc = 418,
    ["ide.host.json"] = 196,
    ["imageoptimizer.json"] = 197,
    ["importmap.json"] = 199,
    ["ioBroker JSON UI"] = 200,
    ["ioBroker Package manifest"] = 201,
    ["jsconfig.json"] = 217,
    jsdoc = 435,
    ["k3d.yaml"] = 218,
    ["kustomization.yaml"] = 221,
    ["label-commenter-config.yml"] = 222,
    ["launchsettings.json"] = 223,
    ["lerna.json"] = 224,
    ["lgtm.yml"] = 225,
    ["libman.json"] = 226,
    ["license-report-config.json"] = 227,
    ["linkinator.config.json"] = 228,
    ["local.settings.json"] = 229,
    ["localazy.json"] = 230,
    ["lsdlschema.json"] = 231,
    mboats = 477,
    ["mimetypes.json"] = 237,
    ...
    ["mtad.yaml"] = 421,
    ["mycode.json"] = 252,
    ["napari plugin manifest"] = 253,
    neoload = 430,
    ["nest-cli"] = 258,
    ["ninjs (News in JSON) 1.3"] = 257,
    ["ninjs (News in JSON) 2.0"] = 256,
    ["nlu.json"] = 259,
    ["nodemon.json"] = 261,
    ["noodl.schema.json"] = 476,
    now = 426,
    ["nswag.json"] = 265,
    ntangle = 266,
    ["nuclei-template.yaml"] = 263,
    ["nuget-project.json"] = 264,
    ["ocelot.json"] = 268,
    ["omnisharp.json"] = 269,
    ["openapi.json"] = 270,
    ["openfin.json"] = 271,
    ["package.json"] = 277,
    ["package.manifest"] = 278,
    ["pattern.json"] = 281,
    pgap_yaml_input_reader = 280,
    ["plagiarize-me.yaml"] = 285,
    ["plagiarize.yaml"] = 284,
    ["portman.json"] = 286,
    ["prettierrc.json"] = 290,
    ["prisma.yml"] = 291,
    ["project-1.0.0-beta3.json"] = 293,
    ["project-1.0.0-beta4.json"] = 294,
    ["project-1.0.0-beta5.json"] = 295,
    ["project-1.0.0-beta6.json"] = 296,
    ["project-1.0.0-beta8.json"] = 297,
    ["project-1.0.0-rc1.json"] = 298,
    ["project-1.0.0-rc2.json"] = 299,
    ["project.json"] = 292,
    ["prometheus.json"] = 300,
    ["prometheus.rules.json"] = 301,
    ["proxies.json"] = 302,
    ["publiccode.yml"] = 303,
    ["pubspec.yaml"] = 304,
    ["pyrseas-0.8.json"] = 307,
    ["release drafter"] = 431,
    ["sarif-1.0.0.json"] = 318,
    ["sarif-2.0.0.json"] = 319,
    ["sarif-2.1.0"] = 328,
    ["sarif-2.1.0-rtm.2"] = 320,
    ["sarif-2.1.0-rtm.3"] = 322,
    ["sarif-2.1.0-rtm.4"] = 324,
    ["sarif-2.1.0-rtm.5"] = 326,
    ["sarif-external-property-file-2.1.0"] = 329,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 321,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 323,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 325,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 327,
    ["schema.org - Action"] = 331,
    ["schema.org - ContactPoint"] = 332,
    ["schema.org - Place"] = 333,
    ["schema.org - Thing"] = 334,
    ["service.datadog.yaml"] = 219,
    ["servicehub.config.json"] = 410,
    ["servicehub.service.json"] = 409,
    ["settings.job"] = 337,
    ["sfdx-hardis configuration"] = 339,
    ["size-limit configuration"] = 340,
    ["skaffold.yaml"] = 470,
    ["skyuxconfig.json"] = 341,
    snapcraft = 342,
    swcrc = 458,
    taskcat = 427,
    ["template.json"] = 361,
    ["templatsources.json"] = 362,
    ["theme.json"] = 364,
    tmLanguage = 365,
    ["trunk.yaml schema"] = 370,
    ["ts-force-config.json"] = 374,
    ["tsconfig.json"] = 371,
    ["tsd.json"] = 372,
    ["tsdrc.json"] = 373,
    ["tslint.json"] = 375,
    ...
    ["version.json"] = 386,
    ["vim-addon-info"] = 387,
    ["vs-2017.3.host.json"] = 389,
    ["vs-nesting.json"] = 390,
    ["vsls.json"] = 388,
    ["vss-extension.json"] = 394,
    ["webjobpublishsettings.json"] = 399,
    ["webjobs-list.json"] = 398,
    ["xs-app.json"] = 423,
    ["xunit.runner.json"] = 408,
    yamllint = 446,
    zuul = 432,
    ["Žinoma"] = 440
  },
