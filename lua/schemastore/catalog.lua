...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1081,
    [".nodehawkrc"] = 693,
    [".npmpackagejsonlintrc"] = 698,
    [".omletrc"] = 1262,
    [".phrase.yml"] = 780,
    [".phraseapp.yml"] = 781,
    [".pmbot.yml"] = 765,
    [".postcssrc"] = 774,
    [".powerpages-web-template-manifest"] = 776,
    [".pre-commit-config.yml"] = 777,
    [".pre-commit-hooks.yml"] = 778,
    [".putout.json"] = 814,
    [".rehyperc"] = 839,
    [".remarkrc"] = 843,
    [".sprite files"] = 945,
    ...
    AIConfig = 46,
    ["AMX Muse Program Descriptor"] = 1311,
    ["API Builder"] = 1117,
    ["AVA Configuration"] = 1181,
    ["AWS AppConfig Feature Flags-v1"] = 85,
    ["AWS CDK cdk.json"] = 308,
    ["AWS CloudFormation"] = 309,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 310,
    ["AWS Copilot Manifest"] = 1350,
    ["AWS SAM CLI Samconfig"] = 311,
    Acton = 1401,
    ["Adobe UXP Manifest"] = 1244,
    ["Aerleon Network & Service Definitions"] = 28,
    ["Aerleon Policy"] = 29,
    ["Agent Permission Policy"] = 1390,
    ["AgentCore CLI"] = 1391,
    AgentLoopKit = 1392,
    Aider = 1340,
    Air = 31,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1361,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1360,
    ["Airlock Microgateway"] = 47,
    ["Alacritty Configuration"] = 1153,
    ["AlgoVoi Compliance Receipt v1"] = 17,
    ["All Contributors configuration file"] = 1207,
    ["Amazon S3 bucket CORS"] = 19,
    Anodizer = 505,
    ["Ansible Argument Specs"] = 487,
    ["Ansible Collection Galaxy"] = 494,
    ["Ansible Execution Environment"] = 484,
    ["Ansible Inventory"] = 493,
    ["Ansible Meta"] = 485,
    ["Ansible Meta Runtime"] = 486,
    ["Ansible Navigator Configuration"] = 496,
    ["Ansible Playbook"] = 491,
    ["Ansible Requirements"] = 488,
    ["Ansible Rulebook"] = 492,
    ["Ansible Tasks File"] = 490,
    ["Ansible Vars File"] = 489,
    ["Ansible-lint Configuration"] = 495,
    Any = 1272,
    ...
    ["Application list for a WinUtil"] = 1290,
    ["ArchSmith diagram IR"] = 1426,
    ArchitectFX = 1295,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1359,
    ["Azure IoT Operations connector metadata"] = 1356,
    ...
    ["Azure Pipelines"] = 134,
    ["Azure Static Web Apps CLI configuration file"] = 949,
    ["Azure Static Web Apps configuration file"] = 948,
    BMML = 1378,
    ["BOSH BPM Config"] = 160,
    ["BOSH CPI Config"] = 161,
    ...
    ["Bacon config"] = 11,
    ["Barba-CV"] = 100,
    ["Bashly (bashly.yml)"] = 1211,
    ["Bashly Settings (bashly-settings.yml)"] = 1212,
    Bento = 1377,
    ["Better Code Hub"] = 1122,
    ["Better Scripts"] = 184,
    Bigconfig = 153,
    ["Biome Formatter Config"] = 101,
    ["Bitmovin Encoding Template"] = 1304,
    BizTalkServerApplicationSchema = 1088,
    Bleep = 185,
    ["Block Protocol Metadata"] = 182,
    ["Bluebricks blueprint config"] = 1383,
    ["Boyka Framework"] = 163,
    ...
    ["Butane Config"] = 1166,
    C4InterFlow = 1319,
    ["CDK Environment Manager, concrete environment configuration"] = 1343,
    ["CDK Environment Manager, concrete environments definition"] = 1342,
    ["CDK Environment Manager, environment definition"] = 1341,
    ["CGS Card Game Specification (cgs.json)"] = 1249,
    ["CICS TS region tagging"] = 1175,
    ["CICS TS resource import"] = 1176,
    ["CICS TS resource model"] = 1177,
    ["CICS TS resource overrides"] = 1178,
    ["CMake Presets"] = 186,
    ["CNC Codes"] = 209,
    ["CRS WAF test file"] = 1279,
    ["CRS WAF test platform overrides file"] = 1280,
    ["CSS Comb (.csscomb.json)"] = 338,
    ["CSS Lint (.csslintrc)"] = 339,
    ["CSpell (cspell.json)"] = 337,
    ...
    ["Caido Proxy Configuration"] = 1416,
    ...
    ["Chamaleon environment"] = 1308,
    ["Chamaleon properties"] = 1309,
    ["Chamaleon template"] = 1307,
    Changepacks = 1370,
    Changesets = 320,
    Changie = 195,
    Charmcraft = 196,
    ...
    CodeCV = 115,
    CodeRabbit = 114,
    ["CodeShip Pro services configuration files"] = 290,
    ["CodeShip Pro steps configuration files"] = 291,
    ["Codecov configuration files"] = 289,
    Codex = 280,
    ["Codex Hooks"] = 281,
    ["Codex Plugin Manifest"] = 282,
    ["Codex Skill Metadata"] = 283,
    CodifyCLI = 116,
    Codux = 285,
    ["Cog config file"] = 210,
    ["Commandbox Box.json"] = 211,
    ["Commandbox Server.json"] = 212,
    ["Common Catalog Data"] = 299,
    ["Common Package Specification"] = 213,
    Concord = 1278,
    ["Configu .cfgu files"] = 1266,
    ["Configu .configu file"] = 1267,
    Conjure = 208,
    ["Container Structure Test"] = 1102,
    Containerlab = 1131,
    ["Contextive Glossary"] = 1335,
    ContractGuard = 1132,
    Convex = 207,
    ["Crowdsec collection config"] = 331,
    ["Crowdsec parser config"] = 332,
    ["Crowdsec scenario config"] = 333,
    ["CumulusCI Config"] = 214,
    ["Cursor Agent Environment"] = 1388,
    ["Custom Machinery Machine"] = 1250,
    ["Custom Machinery Recipe"] = 1251,
    ["Cycle Stack File"] = 232,
    CycloneDX = 233,
    ["DWP Exchange - catalogue entry"] = 385,
    ["DWP Exchange - gateway"] = 383,
    ["DWP Exchange - meta"] = 384,
    ["Dart Build Config (dart-build.json)"] = 340,
    ["Dart Test Config (dart-test.json)"] = 341,
    ["DashLord Configuration"] = 342,
    ["Data Contract Specification"] = 343,
    ["Data Product Specification"] = 344,
    ["DataYoga Connections"] = 234,
    ["DataYoga Job"] = 235,
    ["Datadog Continuous Testing"] = 594,
    ["Datadog Service Definition"] = 595,
    ["Datadog Software Catalog"] = 596,
    ["Datahub Ingestion Recipe"] = 1182,
    ["Debian Upstream Metadata file"] = 242,
    DebtLens = 243,
    ["Deck config"] = 244,
    ["Declarative Automation Bundles"] = 1228,
    ["DeepMatch deeplinks spec"] = 245,
    ["Dein Config"] = 246,
    ["Deno Config (deno.json)"] = 351,
    ["Dependency cruiser"] = 247,
    ["DeployStack Configuration"] = 248,
    ["Deployah Configuration"] = 1358,
    ["Deployer Recipe"] = 354,
    ["Deta Spacefile"] = 249,
    ["Detekt Config (detekt.yml)"] = 355,
    ["Devbox Config"] = 250,
    ["Devbox Plugin"] = 251,
    Devfile = 382,
    Devup = 1371,
    DipDup = 1281,
    ["Discord Webhook"] = 356,
    ["DocFx Config (docfx.json)"] = 361,
    ["Docker Desktop extension metadata"] = 358,
    ["Docs MCP Manifest"] = 362,
    Dofigen = 363,
    ["Dolittle Artifacts"] = 364,
    ["Dolittle Bounded Context Configuration"] = 365,
    ["Dolittle Event Horizons Configuration"] = 366,
    ["Dolittle Resources Configuration"] = 367,
    ["Dolittle Server Configuration"] = 368,
    ["Dolittle Tenant Map Configuration"] = 370,
    ["Dolittle Tenants Configuration"] = 369,
    ["Dolittle Topology"] = 371,
    ["DonateCaseBetterCasino menu"] = 1312,
    ["Draugr Saga"] = 350,
    ["Drupal Breakpoints"] = 253,
    ["Drupal Config"] = 265,
    ["Drupal Info"] = 254,
    ["Drupal Layouts"] = 255,
    ["Drupal Libraries"] = 256,
    ["Drupal Links Action"] = 257,
    ["Drupal Links Contextual"] = 258,
    ["Drupal Links Menu"] = 259,
    ["Drupal Links Task"] = 260,
    ["Drupal Migration"] = 261,
    ["Drupal Permissions"] = 262,
    ["Drupal Recipe"] = 263,
    ["Drupal Routing"] = 264,
    ["Drupal Services"] = 266,
    ["Drush site aliases"] = 377,
    ["Dust configuration"] = 380,
    ["Dynamic Bash Aliases (.aliases)"] = 1219,
    ["EAS config"] = 424,
    ["ECA - Editor Code Assistant"] = 387,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1208,
    ["ESLint Suppressions"] = 429,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1355,
    ["EasyVCR .NET"] = 426,
    ["Eidolon Resource"] = 1296,
    ["Elgato Stream Deck"] = 390,
    Elm = 1283,
    ["Embrace Config"] = 1194,
    Emmet = 1284,
    Endurica = 1232,
    ["Enonic XP API descriptor"] = 393,
    ["Enonic XP Admin Extension descriptor"] = 394,
    ["Enonic XP Admin Tool descriptor"] = 395,
    ["Enonic XP Application descriptor"] = 396,
    ["Enonic XP CMS descriptor"] = 397,
    ["Enonic XP Content Type descriptor"] = 398,
    ["Enonic XP Form Fragment descriptor"] = 399,
    ["Enonic XP ID Provider descriptor"] = 400,
    ["Enonic XP Layout descriptor"] = 401,
    ["Enonic XP Macro descriptor"] = 402,
    ["Enonic XP Mixin descriptor"] = 403,
    ["Enonic XP Page descriptor"] = 404,
    ["Enonic XP Part descriptor"] = 405,
    ["Enonic XP Service descriptor"] = 406,
    ["Enonic XP Site descriptor"] = 407,
    ["Enonic XP Style descriptor"] = 408,
    ["Enonic XP Task descriptor"] = 409,
    ["Enonic XP Webapp descriptor"] = 410,
    ["Enterprise Contract Policy Spec"] = 391,
    ["Envelope Team Definition"] = 1400,
    ["Envilder Map File"] = 392,
    ["Erda Pipeline"] = 1257,
    ["Erda Runtime"] = 1258,
    ["Espanso config.yml"] = 1381,
    ["Espanso match.yml"] = 1380,
    Esquio = 412,
    ["Estuary Flow Catalog"] = 1172,
    ["Ethereum ERC1155"] = 1394,
    ["Ethereum ERC721"] = 1393,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 417,
    ["EveryVoice TTS Toolkit Data Configuration"] = 418,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 422,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 421,
    ["EveryVoice TTS Toolkit Text Configuration"] = 419,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 420,
    ["Evolving Resolutive Process notation"] = 1357,
    ["Expo SDK"] = 423,
    ["Expoot app config"] = 425,
    ["F-Droid Data metadata"] = 431,
    ["FasterCI Configuration"] = 135,
    ["Fence configuration"] = 136,
    FiQuS = 435,
    Firebase = 433,
    ["Flatpak Builder Manifest"] = 436,
    ["FlexGet Config"] = 437,
    ["Flow.json Configurations"] = 1254,
    ["Fossa configuration file"] = 444,
    ["Fossa's fossa-deps file"] = 445,
    ["Foundry VTT - Base package Manifest"] = 439,
    ["Foundry VTT - Module Manifest"] = 440,
    ["Foundry VTT - System Data Template"] = 443,
    ["Foundry VTT - System Manifest"] = 441,
    ["Foundry VTT - World Manifest"] = 442,
    ["Foxx Manifest"] = 137,
    ["Freifunk.de Community API"] = 140,
    ["Frogbot Config"] = 141,
    ["G2P Mapping Configuration"] = 452,
    GAMA = 453,
    ["GCP Blueprint Metadata"] = 456,
    Gaspar = 454,
    ["GatewayCore API Gateway"] = 455,
    ["Gemini CLI settings"] = 457,
    ["GeoJSON.json latest"] = 1170,
    GherKing = 1174,
    ["GitHub Action"] = 467,
    ["GitHub Actions typing"] = 1292,
    ["GitHub CLI configuration"] = 468,
    ["GitHub CLI hosts"] = 469,
    ["GitHub Discussion"] = 470,
    ["GitHub Funding"] = 472,
    ["GitHub Issue Template configuration"] = 473,
    ["GitHub Issue Template forms"] = 474,
    ["GitHub Pages Jekyll"] = 475,
    ["GitHub Prompt"] = 471,
    ["GitHub Secret Scanning"] = 476,
    ["GitHub Workflow"] = 477,
    ["GitHub Workflow Template Properties"] = 478,
    ["GitHub automatically generated release notes configuration"] = 479,
    ["GitLab Agent for Kubernetes configuration"] = 1246,
    ["GitLab Duo Workflow"] = 481,
    GitResume = 483,
    GitVersion = 460,
    ["Gitea Issue Template configuration"] = 463,
    ["Gitea Issue Template forms"] = 464,
    Gitleaks = 461,
    ["Gitpod Configuration"] = 482,
    ["Glamour style"] = 458,
    ["GlazeWM settings"] = 1248,
    ["Global Privacy Control"] = 459,
    Goblet = 1227,
    ["Golangci-lint Configuration"] = 498,
    ["Golangci-lint Custom Plugins Configuration"] = 499,
    ["Google Chrome Related Website Sets"] = 434,
    ["Google Cloud Workflows"] = 307,
    ["Google Digital Assetlinks"] = 1336,
    Goreleaser = 503,
    ["Goreleaser Pro"] = 504,
    Goss = 506,
    ["Gradle Build Cache Node"] = 1120,
    ["Gradle Enterprise"] = 1119,
    ["Grafana 5.x Dashboard"] = 507,
    ["GraphQL Code Generator"] = 512,
    ["GraphQL Config"] = 511,
    ["GraphQL Mesh"] = 510,
    ["GroovyLint configuration"] = 513,
    ["Grunt JSHint task"] = 517,
    ["Grunt Watch task"] = 518,
    ["Grunt base task"] = 519,
    ["Grunt clean task"] = 515,
    ["Grunt copy task"] = 514,
    ["Grunt cssmin task"] = 516,
    HEMTT = 1084,
    Hadolint = 1098,
    Hammerkit = 1130,
    ["Hardware Sentry Configuration"] = 1186,
    ["Hashgraph Online Skill Manifest"] = 7,
    ["HashiCorp Vault"] = 520,
    Hatch = 1099,
    Hayson = 522,
    ["Haystack Pipeline"] = 523,
    ["Hazelcast 5 Configuration"] = 524,
    ["Hecate Input Schema"] = 1347,
    ["Helm Chart.lock"] = 268,
    ["Helm Chart.yaml"] = 267,
    ["Helm Unittest Test Suite"] = 269,
    ["Heloisa Assistant Plugins Marketplace"] = 1423,
    ["Hex file"] = 270,
    ["Home Assistant Integration Manifest"] = 526,
    ["Homer dashboard configuration"] = 527,
    ["Hoverfly Simulation"] = 532,
    Hugo = 1162,
    ["Hugo Theme"] = 1161,
    ["Hulak Configuration"] = 535,
    ["Hyperfoil benchmark configuration"] = 534,
    ["IBM Zapp document"] = 536,
    ["IBM zCodeFormatSettings"] = 537,
    ["IMG Catapult PSP"] = 542,
    ["IVMS101 by CODE Protocol"] = 1247,
    ["Infinispan Configuration"] = 544,
    ["Infinispan Server Configuration"] = 545,
    Infrahub = 546,
    Istanbul = 1190,
    ["JDownloader2 crawler multi-rules"] = 560,
    ["JDownloader2 crawler single-rules"] = 559,
    ["JFrog Applications Config"] = 561,
    ["JFrog File Spec"] = 562,
    ["JFrog Pipelines YML DSL"] = 1196,
    ["JMeter DSL cli config"] = 563,
    JReleaser = 566,
    ["JSON Document Transform"] = 574,
    ["JSON Feed"] = 575,
    ["JSON Resume"] = 852,
    ["JSON Schema Draft 2020-12"] = 1064,
    ["JSON Schema Draft 4"] = 1061,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1229,
    ["JSON Schema Draft 7"] = 1062,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1230,
    ["JSON Schema Draft 8 (2019-09)"] = 1063,
    ["JSON-API"] = 573,
    ["JSON-e templates"] = 1127,
    ["JSON-stat 2.0"] = 1057,
    JSONPatch = 577,
    ["JSR Package Config (jsr.json)"] = 567,
    Jarl = 1363,
    Jasmine = 554,
    Jekyll = 555,
    ["Jenkins X Pipelines"] = 556,
    ["Jenkins X Requirements"] = 557,
    Jest = 558,
    Jocker = 564,
    ["Jovo Language Models"] = 565,
    Jsontron = 578,
    ["Jujutsu (jj) VCS config"] = 1349,
    ["KIMMDY config file"] = 589,
    ["KODE/CI build.yaml"] = 1192,
    ["KSP-AVC"] = 1058,
    ["KSP-CKAN"] = 1059,
    ["KSP-NetKAN"] = 1060,
    KSY = 1259,
    KSail = 450,
    ["KYA Manifest"] = 1260,
    ["Karakum configuration file"] = 446,
    Kas = 581,
    ["Kestra flow file"] = 590,
    ["Keycloak REST API"] = 1199,
    ["Knative Functions - func.yaml"] = 447,
    Knip = 448,
    ["Knip JSONC"] = 449,
    ["Knowledge Unit"] = 598,
    ["Kometa (nightly) config file"] = 592,
    ["Kometa config file"] = 591,
    ["Kong DBLess config"] = 1193,
    KrakenD = 593,
    ["Kubri Configuration"] = 601,
    LOOBin = 619,
    ["Lake configuration file"] = 1352,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 312,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 313,
    ["Landing Zone Accelerator on AWS - Global Config"] = 314,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 315,
    ["Landing Zone Accelerator on AWS - Network Config"] = 316,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 317,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 318,
    ["Landing Zone Accelerator on AWS - Security Config"] = 319,
    ["Lando (landofile)"] = 127,
    ["LangGraph Platform configuration"] = 1271,
    ["Language configuration"] = 1270,
    Lefthook = 606,
    ["Liferay client-extension.yaml"] = 613,
    ["LinkML Metamodel"] = 615,
    ["LiquiLens Evidence Carrier Reference v1"] = 617,
    ["LiquiLens Evidence Carrier v1"] = 616,
    Liquibase = 1137,
    ["Liquibase Flow File"] = 1138,
    ["Lively Properties"] = 618,
    ["Lobe AI Agent"] = 129,
    Loki = 130,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 662,
    ["MS2Rescore Configuration"] = 670,
    ["MSTest testconfig.json"] = 671,
    ["Madge configuration"] = 625,
    ["Madness (madness.yml)"] = 1210,
    ["Mado configuration"] = 626,
    ["Maestro Flow"] = 627,
    ["Mail Servers Configuration"] = 1384,
    ["MapEHR Mapping"] = 628,
    Markdownlint = 1141,
    ["Mason Registry"] = 1144,
    ["MegaLinter Custom Flavor"] = 631,
    ["MegaLinter configuration"] = 630,
    ["MegaLinter descriptor"] = 632,
    Melange = 1237,
    ["Meltano project definition"] = 633,
    ["Mergify Configuration"] = 672,
    ["Mermaid config"] = 2,
    ["Metadata for a Bazel module"] = 634,
    ["Metadata for a Cinnamon spice"] = 1288,
    ["Metatype Configuration"] = 635,
    ["MetricsHub Configuration"] = 636,
    ["MetricsHub Connector Configuration"] = 637,
    ["Micro Editor Syntax"] = 1220,
    ["Microsoft Band Web Tile"] = 638,
    ["Microsoft RulesEngine workflow rules"] = 1275,
    ["Microsoft RulesEngine workflow rules list"] = 1276,
    ["Minecraft Custom Main Menu Mod"] = 1238,
    ["Minecraft Data Pack Advancement"] = 640,
    ["Minecraft Data Pack Biome"] = 641,
    ["Minecraft Data Pack Configured Carver"] = 642,
    ["Minecraft Data Pack Damage Type"] = 643,
    ["Minecraft Data Pack Dimension"] = 645,
    ["Minecraft Data Pack Dimension Type"] = 644,
    ["Minecraft Data Pack Item Modifier"] = 646,
    ["Minecraft Data Pack Loot Table"] = 647,
    ["Minecraft Data Pack Metadata"] = 648,
    ["Minecraft Data Pack Predicate"] = 649,
    ["Minecraft Data Pack Recipe"] = 650,
    ["Minecraft Data Pack Tag"] = 651,
    ["Minecraft Data Pack Template Pool"] = 652,
    ["Minecraft Data Pack Trim Material"] = 657,
    ["Minecraft Data Pack Trim Pattern"] = 658,
    ["Minecraft Resource Pack Lang"] = 653,
    ["Minecraft Resource Pack Particle"] = 654,
    ["Minecraft Resource Pack Texture Mcmeta"] = 656,
    ["Minecraft Resourcepack Sounds"] = 655,
    ["MockServer Expectation"] = 664,
    ["MockServer Expectations"] = 665,
    ModuleAssembler = 660,
    ["Monade CLI Stack Configuration"] = 675,
    ["MongoDB Atlas Search Index Definition"] = 1191,
    ["Monika Configuration"] = 1189,
    ["Monoweave Configuration"] = 669,
    ["Motif config"] = 1080,
    MultiQC = 1329,
    ["NOX Framework (Service)"] = 697,
    ["Netin Diagnostic System Template"] = 1148,
    ["Netlify config"] = 678,
    ["Network-as-Code Data Model"] = 679,
    ["Next Gen UI Agent A2A Server Configuration"] = 680,
    ["Next Gen UI Agent Configuration"] = 682,
    ["Next Gen UI Agent MCP Server Configuration"] = 681,
    ["Nightwatch.js"] = 689,
    ["Nika workflow"] = 694,
    ["Node.js configuration"] = 1085,
    ["NueJS configuration file"] = 702,
    ["Nuitka Package Config"] = 1252,
    ["Nullstone config"] = 704,
    ["ODGS Data Rules"] = 711,
    ["ODGS Ontology Graph"] = 712,
    ["ODGS Standard Metrics"] = 710,
    ["OKF Graph"] = 1424,
    ["ONe's changelog entry"] = 726,
    ["ONe's service descriptor"] = 725,
    ["ORT Server repository environment configuration"] = 737,
    ["OSCAL Assessment Plan (AP)"] = 739,
    ["OSCAL Assessment Results (AR)"] = 740,
    ["OSCAL Catalog"] = 741,
    ["OSCAL Component Definition (CDef)"] = 742,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 743,
    ["OSCAL Profile"] = 744,
    ["OSCAL System Security Plan (SSP)"] = 745,
    ["OSS Review Toolkit configuration"] = 746,
    ["OSS Review Toolkit curation"] = 747,
    ["OSS Review Toolkit package configuration"] = 748,
    ["OSS Review Toolkit project package manager definition"] = 749,
    ["OSS Review Toolkit repository configuration"] = 750,
    ["OSS Review Toolkit resolutions"] = 751,
    ["October CMS columns"] = 708,
    ["October CMS fields"] = 709,
    ["Oh My Posh"] = 714,
    Okteto = 715,
    ["Ona Tasks and Services"] = 717,
    Opctl = 1083,
    ["Open Data Contract Standard (ODCS)"] = 730,
    ["Open Data Product Standard (ODPS)"] = 731,
    ["Open Know-How"] = 1334,
    ["Open Pentest Format"] = 732,
    OpenDecree = 1398,
    ["OpenDecree Configuration"] = 1399,
    ["OpenRewrite Resource"] = 728,
    OpenSRM = 733,
    OpenStatus = 1345,
    ["OpenTelemetry Declarative Configuration"] = 729,
    ["OpenUtau character yaml"] = 722,
    ["OpenUtau ustx"] = 723,
    ["OpenWeather Current Weather API"] = 1126,
    ["OpenWeather Road Risk API"] = 1125,
    ["Ory Hydra configuration"] = 533,
    ["Ory Keto configuration"] = 597,
    ["Ory Kratos configuration"] = 738,
    ["Ory Oathkeeper configuration"] = 706,
    ["Outblocks App configuration"] = 735,
    ["Outblocks database table"] = 736,
    ["Outblocks project configuration"] = 734,
    PDM = 759,
    POPxf = 771,
    ["POPxf Correlations"] = 772,
    ["PRML manifest"] = 779,
    Packer = 755,
    PactSpec = 756,
    Panache = 757,
    Pantsbuild = 1206,
    ["Paper paper-plugin.yml"] = 758,
    ["Pipeline component"] = 1139,
    ["Platform.sh application"] = 13,
    ["Platform.sh routes"] = 14,
    ["Platform.sh services"] = 15,
    ["Plex Prerolls"] = 769,
    ["PocketMine plugin.yml"] = 766,
    ["Podman Desktop Extension"] = 1418,
    ["Postman collection"] = 775,
    ["Power Pages Configuration"] = 1346,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1291,
    ["ProActions AI-Kit Configuration"] = 787,
    ["ProActions AI-Kit Configuration for Menus"] = 789,
    ["ProActions AI-Kit Configuration for Sections"] = 791,
    ["ProActions AI-Kit Configuration for Services"] = 788,
    ["ProActions AI-Kit Configuration for Steps"] = 792,
    ["ProActions AI-Kit Configuration for Templates"] = 790,
    ["Problem object RFC9457"] = 1235,
    ["Problem package format"] = 793,
    ["Problem package generators"] = 794,
    ["Problem package submissions"] = 795,
    ["Problem package test group metadata"] = 796,
    Pterodactyl = 1185,
    ["Pull Request Labeler"] = 813,
    Pulumi = 821,
    ["PyGTA Config"] = 817,
    PyProject = 822,
    Pylock = 1337,
    Pyright = 823,
    ["Python script metadata"] = 1331,
    ["QType AI DSL"] = 826,
    Qgoda = 825,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1410,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1408,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1414,
    ["Qlik Talend Cloud Pipeline - Project"] = 1406,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1409,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1411,
    ["Qlik Talend Cloud Pipeline - Task"] = 1407,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1413,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1412,
    Qodana = 1158,
    ["Qt Creator workspace file"] = 1268,
    ["Quali Torque Blueprint Spec 2"] = 1183,
    ["QueryFirst config file"] = 1202,
    ["QuikRun Configuration"] = 1415,
    ["Qwen Code Settings"] = 1395,
    ["RKE Cluster Configuration JSON"] = 1136,
    ["RKE Cluster Configuration YAML"] = 1135,
    RadioHound = 816,
    ["Raid Profile"] = 1396,
    ["Raid Repo Configuration"] = 1397,
    Railpack = 828,
    Railway = 827,
    ["Rancher Fleet"] = 818,
    ["Rattler-build"] = 829,
    Ray = 1097,
    ["Read the Docs"] = 820,
    ["Red-DiscordBot Cog"] = 836,
    ["Red-DiscordBot Cog Repo"] = 837,
    ["Red-DiscordBot Trivia"] = 838,
    ["Releasaurus Config"] = 10,
    ReleaseKit = 9,
    ["Render Blueprints"] = 1134,
    RenderCV = 856,
    Renovate = 853,
    ["Renovate global configuration"] = 854,
    ["Renovate inherited configuration"] = 855,
    ["Replit config"] = 844,
    Restate = 1324,
    ["Revel Digital Gadget Definition File"] = 1348,
    RoadRunner = 858,
    ["Robust Station Image"] = 1354,
    Rockcraft = 859,
    ["Roo Coder Custom Modes"] = 860,
    Rubocop = 849,
    ["Rudder techniques"] = 1242,
    Ruff = 850,
    ["Rust Project"] = 851,
    ["Rust toolchain"] = 865,
    ["SDMX data message"] = 892,
    ["SDMX metadata message"] = 891,
    ["SDMX structure message"] = 890,
    ["SIL Kit Participant Configuration"] = 903,
    ["SIL Kit Registry Configuration"] = 904,
    ["SPDX 2.3"] = 946,
    SWADL = 962,
    ["Safebox Config"] = 1197,
    ["Sapphire CLI Config"] = 868,
    ["SauceCTL Configuration"] = 1145,
    Scarb = 888,
    ["Schema Catalog"] = 883,
    ["Scoop manifest"] = 889,
    ["Secure SDLC Evidence Bundle"] = 893,
    ["Semantic Data Fabric (SDF) file"] = 894,
    ["Semgrep Rule"] = 896,
    ["Serenity Code Generator (Sergen)"] = 897,
    ["Serverless Framework Configuration"] = 1152,
    ["Serverless Workflow"] = 1154,
    ["Settings for a Cinnamon spice"] = 1287,
    ["Settings.paf"] = 899,
    ["Shopware 6 Configuration"] = 1155,
    ["Shopware CLI Extension Store Configuration"] = 1156,
    ["Shopware CLI Project Store Configuration"] = 1157,
    ["Sigma Detection Rule"] = 901,
    ["SigmaCV CV"] = 5,
    ["Sigrid scope configuration file"] = 902,
    ["SkyPilot Task JSON"] = 1243,
    ["Slack app manifest"] = 909,
    ["Slang Server Configuration"] = 1422,
    Snapcraft = 911,
    ["Solarxy project config"] = 914,
    Solidarity = 915,
    ["Solution filters"] = 916,
    ["Source Maps v3"] = 917,
    Sourcery = 918,
    ["Spack bootstrap.yaml"] = 919,
    ["Spack cdash.yaml"] = 920,
    ["Spack ci.yaml"] = 921,
    ["Spack compilers.yaml"] = 922,
    ["Spack concretizer.yaml"] = 923,
    ["Spack config.yaml"] = 924,
    ["Spack definitions.yaml"] = 925,
    ["Spack develop.yaml"] = 926,
    ["Spack env_vars.yaml"] = 927,
    ["Spack environment"] = 933,
    ["Spack include.yaml"] = 928,
    ["Spack mirrors.yaml"] = 929,
    ["Spack modules.yaml"] = 930,
    ["Spack packages.yaml"] = 931,
    ["Spack repos.yaml"] = 932,
    ["Spack toolchains.yaml"] = 934,
    ["Spack upstreams.yaml"] = 935,
    ["Spack view.yaml"] = 936,
    ["Speakeasy Generation Config File"] = 940,
    ["Speakeasy Lint Configuration File"] = 937,
    ["Speakeasy Test Generation Configuration File"] = 938,
    ["Speakeasy Workflow File"] = 939,
    SpecIF = 941,
    ["Specmatic Configuration"] = 942,
    ["Specpin spec file"] = 3,
    ["Sponge Mixin configuration"] = 943,
    ["Spotlight Ruleset"] = 944,
    StackBlitz = 950,
    ["StackHawk Scanner Configuration"] = 1151,
    Stale = 951,
    Starfish = 952,
    ["Starlake Data Pipeline"] = 1123,
    Starship = 953,
    ["Statamic Blueprint"] = 954,
    ["Stella configuration file"] = 955,
    ["Streamlit configuration file"] = 956,
    ["Stryker Mutator"] = 959,
    ["StyleCop Analyzers Configuration"] = 960,
    ["Stylelint (.stylelintrc)"] = 961,
    ["Stylua Config"] = 1338,
    ["Sublime Syntax"] = 1198,
    ["Subsquid squid manifest"] = 1245,
    ["Swagger API 2.0"] = 963,
    ["Symfony Routing Configuration"] = 964,
    ["Symfony Serializer Mapping"] = 965,
    ["Symfony Services Configuration"] = 966,
    ["Symfony Validation Mapping"] = 967,
    ["Synadia Connect Component"] = 968,
    TSON = 1006,
    TSTyche = 1007,
    ["TYPO3 Vendor Bundler config"] = 1013,
    ["Tab data for a LinUtil"] = 1294,
    ["Tab list for a LinUtil"] = 1293,
    Tach = 969,
    ["Tach Domain"] = 970,
    Talhelper = 972,
    ["Talisman configuration"] = 973,
    Taplo = 1339,
    ["Taskfile config"] = 1128,
    Taurus = 974,
    Tauticord = 975,
    ["Tekton Pipeline"] = 1367,
    ["Tekton PipelineRun"] = 1368,
    ["Tekton Task"] = 1365,
    ["Tekton TaskRun"] = 1366,
    Telefonistka = 1325,
    ["Terrateam config"] = 1351,
    ["TestEnvironment.json"] = 987,
    ["TextMate Grammar"] = 986,
    Threagile = 981,
    ["Tier.run pricing.json"] = 978,
    Tikibase = 979,
    Tombi = 984,
    ["Traefik v2"] = 990,
    ["Traefik v2 File Provider"] = 991,
    ["Traefik v3"] = 992,
    ["Traefik v3 File Provider"] = 993,
    ["Travis CI (.travis.yml)"] = 989,
    Treefmt = 509,
    Trident = 1321,
    Trivy = 996,
    ["TrueScript for *.tscript files"] = 997,
    ["Tugboat QA config.yml"] = 1318,
    TunnelHub = 1233,
    Turborepo = 988,
    Tycho = 1282,
    Tye = 1159,
    ["Tyk Gateway - Open Source v5.7+"] = 1330,
    ["UET BuildConfig.json"] = 1203,
    ["UI5 Manifest"] = 1019,
    ["UNCORS configuration"] = 1024,
    ["UTAM Page Object"] = 1022,
    ["Ubuntu Server Autoinstall"] = 1017,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1322,
    ["Uniswap Token List"] = 1108,
    ["Universal Schedule Format"] = 1025,
    ["Unreal Engine Uplugin"] = 1204,
    ["Unreal Engine Uproject"] = 1205,
    ["UpCloud CLI (upctl) configuration"] = 1323,
    ["Updatecli Compose"] = 1167,
    ["Updatecli Policy Manifest"] = 1168,
    ["Updatecli Policy Metadata"] = 1169,
    Uplift = 1201,
    ["Upsun config"] = 12,
    ["User Journey Map"] = 1133,
    V2Ray = 1173,
    ["VSCode Code Snippets"] = 295,
    ["VSIX CLI publishing"] = 1044,
    Vector = 1027,
    ["Vela Pipeline Configuration"] = 1030,
    Vercel = 294,
    ["Version Bumper config"] = 1033,
    Vespertide = 1372,
    ["Vespertide Migration"] = 1373,
    ["Vespertide Model"] = 1374,
    ["Viash Component Config"] = 1327,
    ["Viash Package Config"] = 1328,
    Visivo = 1231,
    Vogi = 1038,
    ["WP-CLI"] = 1054,
    Wake = 1320,
    ["Waku Config"] = 1297,
    ["Web App Manifest"] = 1050,
    ["Web types"] = 1053,
    WebExtensions = 1049,
    ["Webman package recipe"] = 1179,
    ["Windows Package Manager Installer Manifest"] = 1105,
    ["Windows Package Manager Locale Manifest"] = 1106,
    ["Windows Package Manager Singleton Manifest"] = 1104,
    ["WireMock CLI import configuration"] = 1303,
    ["WireMock CLI local service configuration"] = 1302,
    ["WireMock message stub mapping"] = 1301,
    ["WireMock stub mapping"] = 1300,
    ["Woodpecker pipeline config"] = 1147,
    ["Wrangler CLI"] = 1055,
    ["XenForo add-on manifest"] = 1056,
    ["Xstate Machine"] = 1165,
    ["Yandex Workflow Language"] = 1289,
    ["Yarn Config (.yarnrc.yml)"] = 1121,
    ["Yippee-Ki-JSON configuration YML"] = 1112,
    ["YouTrack App"] = 1286,
    ["Zarf Package Configuration"] = 1353,
    ["Zerops import file"] = 1274,
    ["Zola Configuration"] = 1364,
    abtop = 33,
    act3 = 1402,
    actionlint = 43,
    ["aerleon.yml"] = 27,
    ["amplify.yml"] = 20,
    ["amxx-builder manifest"] = 1417,
    ["angular.json"] = 48,
    apko = 1236,
    ...
    ["behat.yml"] = 164,
    ["bigquery-table"] = 152,
    ["bioimageio resource description"] = 1253,
    ...
    ["cargo-nextest repository configuration"] = 683,
    ["cargo-nextest user configuration"] = 684,
    ["ccmod.json"] = 1298,
    changelogging = 1265,
    ["chezmoi configuration"] = 197,
    ["chisel-slices.json"] = 321,
    ["chrome-extension-locales-messages.json"] = 302,
    ["chutzpah.json"] = 303,
    cibuildwheel = 202,
    ["clang-format (.clang-format)"] = 1171,
    ["clang-tidy"] = 276,
    clangd = 275,
    clib = 277,
    ["cloud-init: cloud-config userdata"] = 279,
    ["cloud-sdk-pipeline-configuration"] = 305,
    ["cloudbuild.json"] = 306,
    cloudify = 278,
    cmakefmt = 220,
    ["cmdx.yaml"] = 113,
    ...
    ["commands.json"] = 298,
    ["commit-check"] = 324,
    ["commitlint (.commitlintrc)"] = 1107,
    ["committed.toml"] = 325,
    ["compile_commands.json"] = 297,
    ["compilerconfig.json"] = 296,
    ["completely.yml"] = 1209,
    ["component-detection-manifest.json"] = 328,
    ["component.json"] = 327,
    ["composer.json"] = 326,
    ["conda-forge"] = 206,
    ["config.yaml"] = 819,
    ["contentmanifest.json"] = 304,
    ["contribute.json"] = 329,
    ["cosmos.config.json"] = 300,
    ["crowdin.yml"] = 330,
    crucible = 334,
    ["ctfd-setup configuration file"] = 1310,
    ["custom-elements.json"] = 1223,
    ["cypress.json"] = 335,
    ["dacier.yml"] = 1405,
    ["datalogic-scan2deploy-android"] = 345,
    ["datalogic-scan2deploy-ce"] = 346,
    ["dbt Dependencies"] = 237,
    ["dbt Packages"] = 239,
    ["dbt Project"] = 238,
    ["dbt Selectors"] = 240,
    ["dbt YAML files"] = 241,
    ...
    ["ddev-global"] = 347,
    ["ddev-project"] = 348,
    ["debugsettings.json"] = 349,
    ["dependabot-v2.json"] = 353,
    ["dependabot.json"] = 352,
    ["deployed-cli"] = 1164,
    devconcurrent = 252,
    ["devcontainer-feature.json"] = 287,
    ["devcontainer.json"] = 286,
    devinit = 1114,
    ["devspace.yaml"] = 1187,
    djlint = 1115,
    ["docker bake"] = 359,
    ["docker sequencer"] = 360,
    ["docker-compose.yml"] = 1113,
    ["dockerd.json"] = 357,
    ["dotnet Release Index manifest"] = 372,
    ["dotnet-tools.json"] = 373,
    ["dotnetcli.host.json"] = 374,
    ["dprint.json"] = 375,
    ["drone.json"] = 376,
    ["dss-2.0.0.json"] = 378,
    ["dstack configuration"] = 379,
    ["dtool dataset metadata"] = 1305,
    ["dvc.yaml"] = 381,
    ["ecosystem.json"] = 386,
    ["editorconfig-checker"] = 388,
    eksctl = 389,
    ["electron-builder configuration file"] = 415,
    ["epr-manifest.json"] = 414,
    ["estampo.toml"] = 413,
    ["evcc.yaml"] = 416,
    ["ezd task runner"] = 427,
    ["fabric.mod.json"] = 430,
    ["first-timers-bot"] = 438,
    ["flagd flag configuration"] = 138,
    ["fly.io Configuration"] = 139,
    fulibWorkflows = 1146,
    ["function.json"] = 451,
    ["gRPC API Gateway & OpenAPI Config"] = 22,
    ["gematik health care insurance list"] = 1316,
    ["gematik health care patient list"] = 1313,
    ["gematik health care provider institution list"] = 1315,
    ["gematik health care provider list"] = 1314,
    ["gematik tiger test environment configuration"] = 1317,
    ["gh-dash"] = 465,
    ["gha-doctor"] = 466,
    ["git-cliff"] = 462,
    ["git-town.toml"] = 1362,
    ["github-settings-as-code"] = 845,
    ["gitlab-ci"] = 480,
    ["global.json"] = 497,
    ["glslint config"] = 1,
    ["go-feature-flag Flag Configuration"] = 501,
    ["gojo.yaml"] = 502,
    gollama = 500,
    ["hassette.toml"] = 525,
    ["haxelib.json"] = 521,
    ...
    ["ide.host.json"] = 538,
    ["ifstate.yaml"] = 539,
    ["imageoptimizer.json"] = 540,
    ["importmap.json"] = 543,
    ["index.toml (packwiz)"] = 1419,
    instant_python_config = 547,
    instant_python_custom_project = 548,
    intlayer = 549,
    ["ioBroker Configuration"] = 550,
    ["ioBroker JSON UI"] = 551,
    ["ioBroker Package manifest"] = 552,
    ["ixpect.conf.yaml"] = 553,
    ["ize.toml"] = 1200,
    ["jsconfig.json"] = 579,
    ["jscpd Configuration"] = 1184,
    jsdoc = 1096,
    ["k3d.yaml"] = 580,
    ["k9s aliases.yaml"] = 582,
    ["k9s cluster-config.yaml"] = 584,
    ["k9s config.yaml"] = 583,
    ["k9s hotkeys.yaml"] = 585,
    ["k9s plugins.yaml"] = 586,
    ["k9s skin.yaml"] = 587,
    ["k9s views.yaml"] = 588,
    ["kind cluster"] = 602,
    ["kontinuous-config.yaml"] = 600,
    ["kontinuous-values.yaml"] = 599,
    ["kustomization.yaml"] = 603,
    ["label-commenter-config.yml"] = 604,
    ["latexindent configuration"] = 128,
    ["launchsettings.json"] = 605,
    lazydocker = 1222,
    lazygit = 1221,
    ["lego.json"] = 607,
    ["lerna.json"] = 608,
    ["lgtm.yml"] = 609,
    ["liblab.config.json"] = 610,
    ["libman.json"] = 611,
    ["license-report-config.json"] = 612,
    ["linkinator.config.json"] = 614,
    ["lint-staged (.lintstagedrc)"] = 1073,
    ["local.settings.json"] = 621,
    ["localazy.json"] = 622,
    ["lotus.yaml"] = 620,
    ["lsd colors"] = 132,
    ["lsd config"] = 131,
    ...
    lychee = 1072,
    ["macro.json"] = 1188,
    ["markdown-link-check"] = 1142,
    maturin = 1143,
    mboats = 1150,
    memnex = 1403,
    ["micro-settings.json"] = 1215,
    ["mimetypes.json"] = 639,
    ["mirrord config"] = 1076,
    ["misata.yaml"] = 1075,
    mise = 1077,
    ["mkdocs.yml"] = 659,
    ["mockd.yaml"] = 663,
    ["mod.pw.toml (packwiz)"] = 1420,
    ["modelparams.dev Model"] = 666,
    ["models CLI"] = 667,
    ["monospace.yml"] = 668,
    ["moon.yml"] = 1299,
    ["mprocs Configuration file"] = 1269,
    ["mrdocs.yml"] = 661,
    ["mta.yaml"] = 1078,
    ["mtad.yaml"] = 1079,
    ["mycode.json"] = 676,
    nFPM = 688,
    ["napari plugin manifest"] = 677,
    neoload = 1091,
    ["nest-cli"] = 691,
    ["nexus-rpc-gen"] = 1389,
    ["nf-core module environment.yml"] = 685,
    ["nf-core module meta.yml"] = 686,
    ["nf-core subworkflow meta.yml"] = 687,
    ["ninjs (News in JSON)"] = 690,
    ["nitro.json"] = 1090,
    ["nixd configuration"] = 1241,
    ["nlu.json"] = 692,
    ["nodemon.json"] = 695,
    ["noodl config"] = 1149,
    ["notebook.mod.json"] = 696,
    now = 1086,
    ["npm-badges"] = 699,
    ["nswag.json"] = 703,
    ntangle = 705,
    ["nuclei-template.yaml"] = 700,
    ["nuget-project.json"] = 701,
    ["ocelot.json"] = 707,
    ogen = 713,
    ["omnisharp.json"] = 716,
    openHAB = 1375,
    ...
    oxfmt = 1385,
    oxlint = 1386,
    ["pack.toml (packwiz)"] = 1421,
    ["package.json"] = 752,
    ["package.manifest"] = 754,
    ["package.yaml"] = 753,
    ["partial-black.json"] = 165,
    ["partial-fastapi.json"] = 166,
    ["partial-pixi.json"] = 764,
    ["partial-scheduled.json"] = 167,
    ["pattern.json"] = 762,
    ["petstore-v1.0"] = 1195,
    pgap_yaml_input_reader = 760,
    pgrls = 761,
    pgxgen = 1379,
    pitcms = 1382,
    ["pixi.toml"] = 763,
    ["plagiarize-me.yaml"] = 768,
    ["plagiarize.yaml"] = 767,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1306,
    ["podbard.yaml"] = 770,
    ["portman.json"] = 773,
    ["prefect.toml"] = 782,
    ["prefect.yaml"] = 783,
    ...
    ["prettierrc.json"] = 785,
    ["prisma.yml"] = 786,
    ["project-1.0.0-beta3.json"] = 798,
    ["project-1.0.0-beta4.json"] = 799,
    ["project-1.0.0-beta5.json"] = 800,
    ["project-1.0.0-beta6.json"] = 801,
    ["project-1.0.0-beta8.json"] = 802,
    ["project-1.0.0-rc1.json"] = 803,
    ["project-1.0.0-rc2.json"] = 804,
    ["project.json"] = 797,
    ["project.owasp.yaml"] = 805,
    ["prometheus-alertmanager.json"] = 809,
    ["prometheus.json"] = 806,
    ["prometheus.rules.json"] = 807,
    ["prometheus.rules.test.json"] = 808,
    ["proxies.json"] = 810,
    ["publiccode.yml"] = 811,
    ["pubspec.yaml"] = 812,
    ["pyrseas-0.8.json"] = 815,
    pytest = 824,
    ["quilt.mod.json"] = 1216,
    ["rc3 auth"] = 830,
    ["rc3 collection"] = 831,
    ...
    ["rc3 settings"] = 835,
    ["registry.yaml"] = 61,
    ["release drafter"] = 1092,
    ["release-hub.json"] = 8,
    ["release-please-config.json"] = 840,
    ["release-please-manifest.json"] = 841,
    ["release-plz.toml"] = 842,
    ["renv.lock"] = 857,
    ["reposets Configuration"] = 846,
    ["reposets Credentials"] = 847,
    ["revola.json"] = 6,
    ["rivet.json"] = 1240,
    ["rivet.yaml (legacy)"] = 1239,
    rumdl = 862,
    runny = 861,
    runspec = 1404,
    rustfmt = 863,
    ...
    samt = 866,
    samtrc = 867,
    ["sarif-1.0.0.json"] = 869,
    ["sarif-2.0.0.json"] = 870,
    ["sarif-2.1.0"] = 880,
    ["sarif-2.1.0-rtm.2"] = 871,
    ["sarif-2.1.0-rtm.3"] = 873,
    ["sarif-2.1.0-rtm.4"] = 875,
    ["sarif-2.1.0-rtm.5"] = 877,
    ["sarif-2.1.0-rtm.6"] = 878,
    ["sarif-external-property-file-2.1.0"] = 881,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 872,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 874,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 876,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 879,
    ["scalingo.json configuration"] = 882,
    ["schema.org - Action"] = 884,
    ["schema.org - ContactPoint"] = 885,
    ["schema.org - Place"] = 886,
    ["schema.org - Thing"] = 887,
    ["secrethub.yml"] = 1218,
    ["semantic-release"] = 895,
    ["servicehub.config.json"] = 1067,
    ["servicehub.service.json"] = 1066,
    ["settings.job"] = 898,
    ["sfdx-hardis configuration"] = 900,
    ["shard.yml"] = 1256,
    ["size-limit configuration"] = 905,
    ["skaffold.yaml"] = 1140,
    ["skill-map plugin extension manifest"] = 906,
    ["skill-map project settings"] = 907,
    ["skill-map provider kind"] = 908,
    ["skyuxconfig.json"] = 910,
    ["snowflake-config"] = 912,
    ["snowflake-connections"] = 913,
    ["spicepod.yaml"] = 1277,
    ["sqlc configuration"] = 947,
    ["stripe-app-local.json"] = 958,
    ["stripe-app.json"] = 957,
    swcrc = 1124,
    ["task.json"] = 971,
    taskcat = 1087,
    ["template.json"] = 976,
    ["templatsources.json"] = 977,
    ["text2confl config"] = 1387,
    ["theme.json"] = 980,
    ["tizen_workspace.json"] = 982,
    tldr = 983,
    ["tm_devices configuration file"] = 1344,
    tmuxinator = 1070,
    tox = 985,
    ["transcend.yml"] = 994,
    ["tree-sitter grammar.json"] = 508,
    ["trime.yaml"] = 995,
    ["trunk.yaml"] = 998,
    ["ts-force-config.json"] = 1004,
    tsbuild = 999,
    ["tsconfig.json"] = 1000,
    ["tsd.json"] = 1001,
    ["tsdoc.json"] = 1002,
    ...
    v8r = 1048,
    vcluster = 1263,
    ["vcpkg configuration file"] = 293,
    ["vcpkg manifest file"] = 292,
    ["vega-lite.json"] = 1029,
    ["vega.json"] = 1028,
    ["venvironment.yaml"] = 1031,
    ["venvplus.yaml"] = 1032,
    version = 1326,
    ["version.json"] = 1034,
    ["vhwdebugger-binding.yaml"] = 1036,
    ["vim-addon-info"] = 1037,
    ["vs-2017.3.host.json"] = 1040,
    ["vs-nesting.json"] = 1041,
    ["vsls.json"] = 1039,
    ["vss-extension.json"] = 1045,
    vtcfg = 1332,
    ["vtesttree.yaml"] = 1046,
    ["vtestunit.yaml"] = 1047,
    ["warp-keysets.json"] = 1224,
    ["warp-themes.json"] = 1225,
    ["warp-workflows.json"] = 1226,
    ["webhint.io"] = 1180,
    ["webjobpublishsettings.json"] = 1052,
    ["webjobs-list.json"] = 1051,
    ["well-known-fursona"] = 1264,
    ["xs-app.json"] = 1082,
    ["xunit.runner.json"] = 1065,
    ["yaml-workflow"] = 1427,
    yamlfmt = 1109,
    yamllint = 1110,
    ["yap.json"] = 1111,
