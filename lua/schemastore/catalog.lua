...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 211,
    [".cryproj (generic)"] = 688,
    [".cryproj engine-5.2"] = 683,
    [".cryproj engine-5.3"] = 684,
    [".cryproj engine-5.4"] = 685,
    [".cryproj engine-5.5"] = 686,
    [".cryproj engine-dev"] = 687,
    [".eslintrc"] = 268,
    [".esmrc.json"] = 259,
    [".ffizer.yaml"] = 272,
    [".htmlhintrc"] = 329,
    ...
    [".mtaext"] = 699,
    [".nodehawkrc"] = 442,
    [".npmpackagejsonlintrc"] = 446,
    [".omletrc"] = 874,
    [".phrase.yml"] = 492,
    [".phraseapp.yml"] = 493,
    [".pmbot.yml"] = 482,
    [".postcssrc"] = 487,
    [".powerpages-web-template-manifest"] = 489,
    [".pre-commit-config.yml"] = 490,
    [".pre-commit-hooks.yml"] = 491,
    [".putout.json"] = 512,
    [".rehyperc"] = 531,
    [".remarkrc"] = 533,
    [".sprite files"] = 591,
    ...
    ["<div>RIOTS' studio configuration"] = 666,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 397,
    ABCSupplyPlan = 13,
    AIConfig = 14,
    ["API Builder"] = 731,
    ["AVA Configuration"] = 791,
    ...
    ["Adobe UXP Manifest"] = 856,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 15,
    ["Airplane task"] = 16,
    ["Alacritty Configuration"] = 763,
    ["All Contributors configuration file"] = 821,
    ...
    ["Azure Pipelines"] = 69,
    ["Azure Static Web Apps CLI configuration file"] = 594,
    ["Azure Static Web Apps configuration file"] = 593,
    ["BX CI"] = 107,
    ["Bashly (bashly.yml)"] = 825,
    ["Bashly Settings (bashly-settings.yml)"] = 826,
    ["Better Code Hub"] = 735,
    ["Better Scripts"] = 108,
    Bigconfig = 86,
    BizTalkServerApplicationSchema = 705,
    Bleep = 109,
    ...
    ["Butane Config"] = 776,
    ["CGS Custom Card Game (CardGameDef.json)"] = 861,
    ["CICS TS region tagging"] = 785,
    ["CICS TS resource import"] = 786,
    ["CICS TS resource model"] = 787,
    ["CICS TS resource overrides"] = 788,
    ["CMake Presets"] = 110,
    ["CNC Codes"] = 123,
    ["CSS Comb (.csscomb.json)"] = 213,
    ["CSS Lint (.csslintrc)"] = 214,
    ["CSpell (cspell.json)"] = 212,
    ...
    ["Citation File Format"] = 200,
    CityJSON = 120,
    ["Clawject config"] = 128,
    ["Cloud Foundry Application Manifest"] = 873,
    ["Code Climate"] = 157,
    CodeCV = 65,
    CodeRabbit = 64,
    ...
    ["Configu .cfgu files"] = 878,
    ["Configu .configu file"] = 879,
    Conjure = 122,
    ["Container Structure Test"] = 718,
    Containerlab = 743,
    ["Crowdsec collection config"] = 207,
    ["Crowdsec parser config"] = 208,
    ["Crowdsec scenario config"] = 209,
    ["CumulusCI Config"] = 127,
    ["Custom Machinery Machine"] = 862,
    ["Custom Machinery Recipe"] = 863,
    ["Cycle Stack File"] = 130,
    ["DWP Exchange - catalogue entry"] = 254,
    ["DWP Exchange - gateway"] = 252,
    ["DWP Exchange - meta"] = 253,
    ["Dart Build Config (dart-build.json)"] = 215,
    ["Dart Test Config (dart-test.json)"] = 216,
    ["DashLord Configuration"] = 217,
    ["Data Contract Specification"] = 218,
    ["Data Product Specification"] = 219,
    ["DataYoga Connections"] = 131,
    ["DataYoga Job"] = 132,
    ["Databricks Asset Bundles"] = 842,
    ["Datadog Service Definition"] = 373,
    ["Datahub Ingestion Recipe"] = 792,
    ["Dein Config"] = 134,
    ["Deno Config (deno.json)"] = 225,
    ["Dependency cruiser"] = 135,
    ["Deployer Recipe"] = 228,
    ["Deta Spacefile"] = 136,
    ["Detekt Config (detekt.yml)"] = 229,
    ["Devbox Config"] = 137,
    ["Devbox Plugin"] = 138,
    Devfile = 251,
    ["Discord Webhook"] = 230,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 833,
    ["EAS config"] = 266,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 822,
    ...
    ["Error pages"] = 262,
    Esquio = 260,
    ["Estuary Flow Catalog"] = 782,
    ["Expo SDK"] = 265,
    ["F-Droid Data metadata"] = 271,
    ["Facets - FSDL - Application"] = 269,
    ["FasterCI Configuration"] = 70,
    FiQuS = 275,
    Firebase = 273,
    ["Flow.json Configurations"] = 866,
    ["Fossa configuration file"] = 282,
    ["Fossa's fossa-deps file"] = 283,
    ["Foundry VTT - Base package Manifest"] = 277,
    ["Foundry VTT - Module Manifest"] = 278,
    ["Foundry VTT - System Data Template"] = 281,
    ["Foundry VTT - System Manifest"] = 279,
    ["Foundry VTT - World Manifest"] = 280,
    ["Foxx Manifest"] = 71,
    ["Freifunk.de Community API"] = 74,
    ["Frogbot Config"] = 75,
    ["G2P Mapping Configuration"] = 287,
    ["GCP Blueprint Metadata"] = 290,
    Gaspar = 288,
    ["GatewayCore API Gateway"] = 289,
    ["GeoJSON.json latest"] = 780,
    GherKing = 784,
    ["GitHub Action"] = 295,
    ["GitHub Discussion"] = 296,
    ["GitHub Funding"] = 297,
    ["GitHub Issue Template configuration"] = 299,
    ["GitHub Issue Template forms"] = 298,
    ["GitHub Workflow"] = 300,
    ["GitHub Workflow Template Properties"] = 301,
    ["GitHub automatically generated release notes configuration"] = 302,
    ["GitLab Agent for Kubernetes configuration"] = 858,
    GitVersion = 292,
    ["Gitea Issue Template configuration"] = 293,
    ["Gitea Issue Template forms"] = 294,
    ["Gitpod Configuration"] = 304,
    ["GlazeWM settings"] = 860,
    ["Global Privacy Control"] = 291,
    Goblet = 841,
    ["Golangci-lint Configuration"] = 306,
    ["Golangci-lint Custom Plugins Configuration"] = 307,
    ["Google Chrome Related Website Sets"] = 274,
    ["Google Cloud Workflows"] = 186,
    Goreleaser = 309,
    ["Goreleaser Pro"] = 310,
    Goss = 311,
    ["Gradle Build Cache Node"] = 733,
    ["Gradle Enterprise"] = 732,
    ["Grafana 5.x Dashboard"] = 312,
    ["GraphQL Code Generator"] = 316,
    ["GraphQL Config"] = 315,
    ["GraphQL Mesh"] = 314,
    ["Grunt JSHint task"] = 320,
    ["Grunt Watch task"] = 321,
    ["Grunt base task"] = 322,
    ["Grunt clean task"] = 318,
    ["Grunt copy task"] = 317,
    ["Grunt cssmin task"] = 319,
    HEMTT = 702,
    Hadolint = 714,
    Hammerkit = 742,
    ["Hardware Sentry Configuration"] = 796,
    Hatch = 715,
    Hayson = 324,
    ["Haystack Pipeline"] = 325,
    ["Hazelcast 5 Configuration"] = 326,
    ["Helm Chart.lock"] = 154,
    ["Helm Chart.yaml"] = 153,
    ["Helm Unittest Test Suite"] = 155,
    Hugo = 772,
    ["Hugo Theme"] = 771,
    ["Hyperfoil benchmark configuration"] = 332,
    ["IBM Zapp document"] = 333,
    ["IBM zCodeFormatSettings"] = 334,
    ["IMG Catapult PSP"] = 339,
    ["IVMS101 by CODE Protocol"] = 859,
    Infrahub = 341,
    Istanbul = 799,
    ["JDownloader2 crawler multi-rules"] = 350,
    ["JDownloader2 crawler single-rules"] = 349,
    ["JFrog Applications Config"] = 351,
    ["JFrog File Spec"] = 352,
    ["JFrog Pipelines YML DSL"] = 805,
    ["JMeter DSL cli config"] = 353,
    JReleaser = 355,
    ["JSON Document Transform"] = 363,
    ["JSON Feed"] = 364,
    ["JSON Resume"] = 538,
    ["JSON Schema Draft 2020-12"] = 679,
    ["JSON Schema Draft 4"] = 676,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 843,
    ["JSON Schema Draft 7"] = 677,
    ["JSON Schema Draft 7 (unofficial strict)"] = 844,
    ["JSON Schema Draft 8 (2019-09)"] = 678,
    ["JSON-API"] = 362,
    ["JSON-WF"] = 872,
    ["JSON-e templates"] = 740,
    ["JSON-stat 2.0"] = 673,
    JSONPatch = 366,
    ["JSR Package Config (jsr.json)"] = 356,
    Jasmine = 345,
    Jekyll = 346,
    ["Jenkins X Pipelines"] = 347,
    ["Jenkins X Requirements"] = 348,
    ["Jovo Language Models"] = 354,
    ["KIMMDY config file"] = 371,
    ["KSP-AVC"] = 674,
    ["KSP-CKAN"] = 675,
    KSY = 871,
    ["Karakum configuration file"] = 284,
    Kas = 369,
    ["Keycloak REST API"] = 813,
    ["Knative Functions - func.yaml"] = 285,
    ["KoDE/CI build.yaml"] = 801,
    ["Kong DBLess config"] = 802,
    KrakenD = 372,
    ["Kubri Configuration"] = 377,
    LOOBin = 392,
    ...
    Lefthook = 381,
    ["Liferay client-extension.yaml"] = 388,
    ["LinkML Metamodel"] = 390,
    Liquibase = 748,
    ["Liquibase Flow File"] = 749,
    ["Lively Properties"] = 391,
    ["Lobe AI Agent"] = 67,
    Loki = 68,
    ["MLOS Configs"] = 426,
    ["MS2Rescore Configuration"] = 429,
    ["Madness (madness.yml)"] = 824,
    Markdownlint = 752,
    ["Mason Registry"] = 754,
    ["MegaLinter configuration"] = 398,
    ["MegaLinter descriptor"] = 399,
    Melange = 850,
    ["Meltano plugin discovery definition"] = 401,
    ["Meltano project definition"] = 400,
    ["Mergify Configuration"] = 430,
    ["MetricsHub Configuration"] = 402,
    ["MetricsHub Connector Configuration"] = 403,
    ["Micro Editor Syntax"] = 834,
    ["Microsoft Band Web Tile"] = 404,
    ["Minecraft Custom Main Menu Mod"] = 851,
    ["Minecraft Data Pack Advancement"] = 406,
    ["Minecraft Data Pack Biome"] = 407,
    ["Minecraft Data Pack Configured Carver"] = 408,
    ["Minecraft Data Pack Damage Type"] = 409,
    ["Minecraft Data Pack Dimension"] = 411,
    ["Minecraft Data Pack Dimension Type"] = 410,
    ["Minecraft Data Pack Item Modifier"] = 412,
    ["Minecraft Data Pack Loot Table"] = 413,
    ["Minecraft Data Pack Metadata"] = 414,
    ["Minecraft Data Pack Predicate"] = 415,
    ["Minecraft Data Pack Recipe"] = 416,
    ["Minecraft Data Pack Tag"] = 417,
    ["Minecraft Data Pack Template Pool"] = 418,
    ["Minecraft Data Pack Trim Material"] = 423,
    ["Minecraft Data Pack Trim Pattern"] = 424,
    ["Minecraft Resource Pack Lang"] = 419,
    ["Minecraft Resource Pack Particle"] = 420,
    ["Minecraft Resource Pack Texture Mcmeta"] = 422,
    ["Minecraft Resourcepack Sounds"] = 421,
    ["MkDocs Configuration 1.0"] = 425,
    ["Monade CLI Stack Configuration"] = 433,
    ["MongoDB Atlas Search Index Definition"] = 800,
    ["Monika Configuration"] = 798,
    ["Monoweave Configuration"] = 428,
    ["Motif config"] = 698,
    ["NOX Framework (Service)"] = 445,
    ["Netin Diagnostic System Template"] = 758,
    ["Netlify config"] = 436,
    ["Network-as-Code Data Model"] = 437,
    ["Nightwatch.js"] = 438,
    ["Nuitka.yaml"] = 864,
    ["ONe's changelog entry"] = 461,
    ["ONe's service descriptor"] = 460,
    ["OSS Review Toolkit configuration"] = 468,
    ["OSS Review Toolkit curation"] = 469,
    ["OSS Review Toolkit package configuration"] = 470,
    ["OSS Review Toolkit repository configuration"] = 471,
    ["OSS Review Toolkit resolutions"] = 472,
    Opctl = 701,
    ["OpenRewrite Resource"] = 463,
    ["OpenUtau character yaml"] = 457,
    ["OpenUtau ustx"] = 458,
    ["OpenWeather Current Weather API"] = 739,
    ["OpenWeather Road Risk API"] = 738,
    ["Ory Hydra configuration"] = 331,
    ["Ory Keto configuration"] = 374,
    ["Ory Kratos configuration"] = 467,
    ["Ory Oathkeeper configuration"] = 452,
    ["Outblocks App configuration"] = 465,
    ["Outblocks database table"] = 466,
    ["Outblocks project configuration"] = 464,
    PDM = 478,
    Packer = 475,
    Pantsbuild = 820,
    ["Paper paper-plugin.yml"] = 476,
    ["Pipeline component"] = 750,
    ["PocketMine plugin.yml"] = 483,
    ["Postman collection"] = 488,
    ["Problem object RFC9457"] = 848,
    ["Problem package generators"] = 496,
    Pterodactyl = 795,
    ["Pull Request Labeler"] = 511,
    Pulumi = 517,
    PyProject = 518,
    Pyright = 519,
    Qgoda = 520,
    Qodana = 768,
    ["Qt Creator workspace file"] = 880,
    ["Quali Torque Blueprint Spec 2"] = 793,
    ["QueryFirst config file"] = 816,
    ["RKE Cluster Configuration JSON"] = 747,
    ["RKE Cluster Configuration YAML"] = 746,
    ["Rancher Fleet"] = 514,
    ["Rattler-build"] = 521,
    Ray = 713,
    ["Read the Docs"] = 516,
    ["Red-DiscordBot Cog"] = 528,
    ["Red-DiscordBot Cog Repo"] = 529,
    ["Red-DiscordBot Trivia"] = 530,
    ["Render Blueprints"] = 745,
    RenderCV = 540,
    Renovate = 539,
    ["Replit config"] = 534,
    RoadRunner = 541,
    ["Rudder techniques"] = 854,
    Ruff = 536,
    ["Rust Project"] = 537,
    ["Rust toolchain"] = 544,
    ["SDMX data message"] = 569,
    ["SDMX metadata message"] = 568,
    ["SDMX structure message"] = 567,
    ["SIL Kit Participant Configuration"] = 579,
    ["SIL Kit Registry Configuration"] = 580,
    SWADL = 605,
    ["Safebox Config"] = 806,
    ["Sapphire CLI Config"] = 547,
    ["SauceCTL Configuration"] = 755,
    ["Schema Catalog"] = 561,
    ["Scoop manifest"] = 566,
    ["Semantic Data Fabric (SDF) file"] = 570,
    ["Semgrep Rule"] = 572,
    ["Serenity Code Generator (Sergen)"] = 573,
    ["Serverless Framework Configuration"] = 762,
    ["Serverless Workflow"] = 764,
    ["Settings.paf"] = 575,
    ["Shopware 6 Configuration"] = 765,
    ["Shopware CLI Extension Store Configuration"] = 766,
    ["Shopware CLI Project Store Configuration"] = 767,
    Sigma = 577,
    ["Sigrid scope configuration file"] = 578,
    ["SkyPilot Task JSON"] = 855,
    ["Slack app manifest"] = 582,
    Solidarity = 585,
    ["Solution filters"] = 586,
    ["Source Maps v3"] = 587,
    Sourcery = 588,
    SpecIF = 589,
    ["Sponge Mixin configuration"] = 590,
    StackBlitz = 595,
    ["StackHawk Scanner Configuration"] = 761,
    Stale = 596,
    ["Starlake Data Pipeline"] = 736,
    Starship = 597,
    ["Statamic Blueprint"] = 598,
    ["Stella configuration file"] = 599,
    ["StrmPrivacy Data Connector"] = 810,
    ["StrmPrivacy Data Contract"] = 811,
    ["StrmPrivacy SimpleSchema"] = 808,
    ["StrmPrivacy Stream"] = 809,
    ["StrmPrivacy batch job configuration file"] = 807,
    ["Stryker Mutator"] = 602,
    ["StyleCop Analyzers Configuration"] = 603,
    ["Stylelint (.stylelintrc)"] = 604,
    ["Sublime Syntax"] = 812,
    ["Subsquid squid manifest"] = 857,
    ["Swagger API 2.0"] = 606,
    TSON = 632,
    TSTyche = 633,
    Talhelper = 608,
    ["Talisman configuration"] = 609,
    ["Taskfile config"] = 741,
    Taurus = 610,
    ["TestEnvironment.json"] = 619,
    ["TextMate Grammar"] = 618,
    ["Tier.run pricing.json"] = 613,
    Tikibase = 614,
    ["Traefik v2"] = 622,
    ["Traefik v2 File Provider"] = 623,
    ["Travis CI (.travis.yml)"] = 621,
    TunnelHub = 847,
    Turborepo = 620,
    Tye = 769,
    ["UET BuildConfig.json"] = 817,
    ["UI5 Manifest"] = 642,
    ["UNCORS configuration"] = 646,
    ["UTAM Page Object"] = 645,
    ["Ubuntu Server Autoinstall"] = 640,
    ["Uniswap Token List"] = 724,
    ["Unreal Engine Uplugin"] = 818,
    ["Unreal Engine Uproject"] = 819,
    ["Updatecli Compose"] = 777,
    ["Updatecli Policy Manifest"] = 778,
    ["Updatecli Policy Metadata"] = 779,
    Uplift = 815,
    ["User Journey Map"] = 744,
    V2Ray = 783,
    ["VSCode Code Snippets"] = 174,
    ["VSIX CLI publishing"] = 661,
    ["Vela Pipeline Configuration"] = 650,
    Vercel = 173,
    Visivo = 845,
    ["Web App Manifest"] = 668,
    ["Web types"] = 671,
    WebExtensions = 667,
    ["Webman package recipe"] = 789,
    ["Windows Package Manager Installer Manifest"] = 721,
    ["Windows Package Manager Locale Manifest"] = 722,
    ["Windows Package Manager Singleton Manifest"] = 720,
    ["Woodpecker pipeline config"] = 757,
    ["Wrangler CLI"] = 672,
    ["Xstate Machine"] = 775,
    ["Yarn Config (.yarnrc.yml)"] = 734,
    ["Yippee-Ki-JSON configuration YML"] = 726,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 849,
    ...
    ["behat.yml"] = 93,
    ["bigquery-table"] = 85,
    ["bioimageio resource description"] = 865,
    ...
    changelogging = 877,
    ["chisel-slices.json"] = 199,
    ["chrome-extension-locales-messages.json"] = 181,
    ["chutzpah.json"] = 182,
    cibuildwheel = 119,
    ["clang-format (.clang-format)"] = 781,
    ["clang-tidy"] = 161,
    clangd = 160,
    clib = 162,
    ...
    ["coffeelint.json"] = 201,
    ["commands.json"] = 177,
    ["commitlint (.commitlintrc)"] = 723,
    ["compile_commands.json"] = 176,
    ["compilerconfig.json"] = 175,
    ["completely.yml"] = 823,
    ["component-detection-manifest.json"] = 204,
    ["component.json"] = 203,
    ["composer.json"] = 202,
    ["conda-forge"] = 121,
    ["config.yaml"] = 515,
    ...
    ["crowdin.yml"] = 206,
    ["custom-elements.json"] = 837,
    ["cypress.json"] = 210,
    ["datalogic-scan2deploy-android"] = 220,
    ["datalogic-scan2deploy-ce"] = 221,
    ["dbt Project"] = 133,
    ["ddev-global"] = 222,
    ["ddev-project"] = 223,
    ["debugsettings.json"] = 224,
    ["dependabot-v2.json"] = 227,
    ["dependabot.json"] = 226,
    ["deployed-cli"] = 774,
    ...
    ["gitlab-ci"] = 303,
    ["global.json"] = 305,
    ["go-feature-flag Flag Configuration"] = 308,
    ["haxelib.json"] = 323,
    helmfile = 716,
    helmwave = 717,
    ["host-meta.json"] = 328,
    ...
    ["ide.host.json"] = 335,
    ["ifstate.conf"] = 336,
    ["imageoptimizer.json"] = 337,
    ["importmap.json"] = 340,
    ["ioBroker Configuration"] = 342,
    ["ioBroker JSON UI"] = 343,
    ["ioBroker Package manifest"] = 344,
    ["ize.toml"] = 814,
    ["jsconfig.json"] = 367,
    ["jscpd Configuration"] = 794,
    jsdoc = 712,
    ["k3d.yaml"] = 368,
    ["k9s plugin.yml"] = 370,
    ["kontinuous-config.yaml"] = 376,
    ["kontinuous-values.yaml"] = 375,
    ["kustomization.yaml"] = 378,
    ["label-commenter-config.yml"] = 379,
    ["latexindent configuration"] = 66,
    ["launchsettings.json"] = 380,
    lazydocker = 836,
    lazygit = 835,
    ["lego.json"] = 382,
    ["lerna.json"] = 383,
    ["lgtm.yml"] = 384,
    ["liblab.config.json"] = 385,
    ["libman.json"] = 386,
    ["license-report-config.json"] = 387,
    ["linkinator.config.json"] = 389,
    ["lint-staged (.lintstagedrc)"] = 692,
    ["local.settings.json"] = 394,
    ["localazy.json"] = 395,
    ["lotus.yaml"] = 393,
    ["lsdlschema.json"] = 396,
    ["markdown-link-check"] = 753,
    mboats = 760,
    ["micro-settings.json"] = 829,
    ["mimetypes.json"] = 405,
    ["mirrord config"] = 693,
    mise = 694,
    ["mise-settings"] = 695,
    ...
    ["mtad.yaml"] = 697,
    ["mycode.json"] = 434,
    ["napari plugin manifest"] = 435,
    neoload = 707,
    ["nest-cli"] = 440,
    ["ninjs (News in JSON)"] = 439,
    ["nixd configuration"] = 853,
    ["nlu.json"] = 441,
    ["nodemon.json"] = 443,
    ["noodl config"] = 759,
    ["notebook.mod.json"] = 444,
    now = 703,
    ["npm-badges"] = 447,
    ["nswag.json"] = 450,
    ntangle = 451,
    ["nuclei-template.yaml"] = 448,
    ["nuget-project.json"] = 449,
    ["ocelot.json"] = 453,
    ["omnisharp.json"] = 454,
    ["openapi.json"] = 455,
    ["openfin.json"] = 462,
    ...
    ["ops.yaml"] = 459,
    ["package.json"] = 473,
    ["package.manifest"] = 474,
    ["partial-black.json"] = 94,
    ["pathfinder.yml"] = 477,
    ["pattern.json"] = 480,
    ["petstore-v1.0"] = 804,
    pgap_yaml_input_reader = 479,
    ["pixi.toml"] = 481,
    ["plagiarize-me.yaml"] = 485,
    ["plagiarize.yaml"] = 484,
    ["portman.json"] = 486,
    ["prettierrc.json"] = 494,
    ["prisma.yml"] = 495,
    ["project-1.0.0-beta3.json"] = 498,
    ["project-1.0.0-beta4.json"] = 499,
    ["project-1.0.0-beta5.json"] = 500,
    ["project-1.0.0-beta6.json"] = 501,
    ["project-1.0.0-beta8.json"] = 502,
    ["project-1.0.0-rc1.json"] = 503,
    ["project-1.0.0-rc2.json"] = 504,
    ["project.json"] = 497,
    ["prometheus.json"] = 505,
    ["prometheus.rules.json"] = 506,
    ["prometheus.rules.test.json"] = 507,
    ["proxies.json"] = 508,
    ["publiccode.yml"] = 509,
    ["pubspec.yaml"] = 510,
    ["pyrseas-0.8.json"] = 513,
    ["quilt.mod.json"] = 830,
    ["rc3 auth"] = 522,
    ["rc3 collection"] = 523,
    ["rc3 environment"] = 524,
    ...
    ["rc3 settings"] = 527,
    ["release drafter"] = 708,
    ["release-plz.toml"] = 532,
    ["rivet.yaml"] = 852,
    rockcraft = 542,
    rustfmt = 543,
    samt = 545,
    samtrc = 546,
    ["sarif-1.0.0.json"] = 548,
    ["sarif-2.0.0.json"] = 549,
    ["sarif-2.1.0"] = 559,
    ["sarif-2.1.0-rtm.2"] = 550,
    ["sarif-2.1.0-rtm.3"] = 552,
    ["sarif-2.1.0-rtm.4"] = 554,
    ["sarif-2.1.0-rtm.5"] = 556,
    ["sarif-2.1.0-rtm.6"] = 557,
    ["sarif-external-property-file-2.1.0"] = 560,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 551,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 553,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 555,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 558,
    ["schema.org - Action"] = 562,
    ["schema.org - ContactPoint"] = 563,
    ["schema.org - Place"] = 564,
    ["schema.org - Thing"] = 565,
    ["secrethub.yml"] = 832,
    ["semantic-release"] = 571,
    ["servicehub.config.json"] = 682,
    ["servicehub.service.json"] = 681,
    ["settings.job"] = 574,
    ["sfdx-hardis configuration"] = 576,
    ["shard.yml"] = 868,
    ["size-limit configuration"] = 581,
    ["skaffold.yaml"] = 751,
    ["skyuxconfig.json"] = 583,
    snapcraft = 584,
    ["sqlc configuration"] = 592,
    ["stripe-app-local.json"] = 601,
    ["stripe-app.json"] = 600,
    swcrc = 737,
    ["task.json"] = 607,
    taskcat = 704,
    ["template.json"] = 611,
    ["templatsources.json"] = 612,
    ["theme.json"] = 615,
    ["tizen_workspace.json"] = 616,
    tldr = 617,
    tmuxinator = 690,
    ["transcend.yml"] = 624,
    ["tree-sitter grammar.json"] = 313,
    ["trime.yaml"] = 625,
    ["trunk.yaml"] = 626,
    ["ts-force-config.json"] = 630,
    ["tsconfig.json"] = 627,
    ["tsd.json"] = 628,
    ["tsdrc.json"] = 629,
    ["tslint.json"] = 631,
    ...
    ["vega-lite.json"] = 649,
    ["vega.json"] = 648,
    ["venvironment-basic.yaml"] = 652,
    ["venvironment.yaml"] = 651,
    ["version.json"] = 653,
    ["vim-addon-info"] = 655,
    ["vs-2017.3.host.json"] = 657,
    ["vs-nesting.json"] = 658,
    ["vsls.json"] = 656,
    ["vss-extension.json"] = 662,
    ["vtesttree.yaml"] = 663,
    ["vtestunit.yaml"] = 664,
    ["warp-keysets.json"] = 838,
    ["warp-themes.json"] = 839,
    ["warp-workflows.json"] = 840,
    ["webhint.io"] = 790,
    ["webjobpublishsettings.json"] = 670,
    ["webjobs-list.json"] = 669,
    ["well-known-fursona"] = 876,
    ["xs-app.json"] = 700,
    ["xunit.runner.json"] = 680,
    yamllint = 725,
    zuul = 709,
    ["Žinoma"] = 719
  },
