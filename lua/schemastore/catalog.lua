...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 199,
    [".cryproj (generic)"] = 674,
    [".cryproj engine-5.2"] = 669,
    [".cryproj engine-5.3"] = 670,
    [".cryproj engine-5.4"] = 671,
    [".cryproj engine-5.5"] = 672,
    [".cryproj engine-dev"] = 673,
    [".eslintrc"] = 255,
    [".esmrc.json"] = 247,
    [".ffizer.yaml"] = 259,
    [".htmlhintrc"] = 316,
    ...
    [".mtaext"] = 685,
    [".nodehawkrc"] = 428,
    [".npmpackagejsonlintrc"] = 432,
    [".omletrc"] = 860,
    [".phrase.yml"] = 478,
    [".phraseapp.yml"] = 479,
    [".pmbot.yml"] = 468,
    [".postcssrc"] = 473,
    [".powerpages-web-template-manifest"] = 475,
    [".pre-commit-config.yml"] = 476,
    [".pre-commit-hooks.yml"] = 477,
    [".putout.json"] = 498,
    [".rehyperc"] = 517,
    [".remarkrc"] = 519,
    [".sprite files"] = 577,
    ...
    ["<div>RIOTS' studio configuration"] = 652,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 382,
    ABCSupplyPlan = 13,
    AIConfig = 14,
    ["API Builder"] = 717,
    ["AVA Configuration"] = 777,
    ...
    ["Adobe UXP Manifest"] = 842,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 15,
    ["Airplane task"] = 16,
    ["Alacritty Configuration"] = 749,
    ["All Contributors configuration file"] = 807,
    ...
    ["Azure Pipelines"] = 68,
    ["Azure Static Web Apps CLI configuration file"] = 580,
    ["Azure Static Web Apps configuration file"] = 579,
    ["BX CI"] = 106,
    ["Bashly (bashly.yml)"] = 811,
    ["Bashly Settings (bashly-settings.yml)"] = 812,
    ["Better Code Hub"] = 721,
    ["Better Scripts"] = 107,
    Bigconfig = 85,
    BizTalkServerApplicationSchema = 691,
    Bleep = 108,
    ...
    ["Butane Config"] = 762,
    ["CGS Custom Card Game (CardGameDef.json)"] = 847,
    ["CICS TS region tagging"] = 771,
    ["CICS TS resource import"] = 772,
    ["CICS TS resource model"] = 773,
    ["CICS TS resource overrides"] = 774,
    ["CMake Presets"] = 109,
    ["CNC Codes"] = 121,
    ...
    CityJSON = 118,
    ["Clawject config"] = 126,
    ["Cloud Foundry Application Manifest"] = 859,
    ["Code Climate"] = 154,
    CodeCV = 64,
    ...
    ["DataYoga Job"] = 130,
    ["Databricks Asset Bundles"] = 828,
    ["Datadog Service Definition"] = 358,
    ["Datahub Ingestion Recipe"] = 778,
    ["Dein Config"] = 132,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 819,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 808,
    ...
    ["Goreleaser Pro"] = 297,
    Goss = 298,
    ["Gradle Build Cache Node"] = 719,
    ["Gradle Enterprise"] = 718,
    ...
    Hadolint = 700,
    Hammerkit = 728,
    ["Hardware Sentry Configuration"] = 782,
    Hatch = 701,
    Hayson = 311,
    ...
    ["IVMS101 by CODE Protocol"] = 845,
    Istanbul = 785,
    ["JDownloader2 crawler multi-rules"] = 335,
    ["JDownloader2 crawler single-rules"] = 334,
    ["JFrog Applications Config"] = 336,
    ["JFrog File Spec"] = 337,
    ["JFrog Pipelines YML DSL"] = 791,
    ["JMeter DSL cli config"] = 338,
    JReleaser = 340,
    ["JSON Document Transform"] = 348,
    ["JSON Feed"] = 349,
    ["JSON Resume"] = 524,
    ["JSON Schema Draft 2020-12"] = 665,
    ["JSON Schema Draft 4"] = 662,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 829,
    ["JSON Schema Draft 7"] = 663,
    ["JSON Schema Draft 7 (unofficial strict)"] = 830,
    ["JSON Schema Draft 8 (2019-09)"] = 664,
    ["JSON-API"] = 347,
    ["JSON-WF"] = 858,
    ["JSON-e templates"] = 726,
    ["JSON-stat 2.0"] = 659,
    JSONPatch = 351,
    ["JSR Package Config (jsr.json)"] = 341,
    Jasmine = 330,
    Jekyll = 331,
    ["Jenkins X Pipelines"] = 332,
    ["Jenkins X Requirements"] = 333,
    ["Jovo Language Models"] = 339,
    ["KIMMDY config file"] = 356,
    ["KSP-AVC"] = 660,
    ["KSP-CKAN"] = 661,
    KSY = 857,
    ["Karakum configuration file"] = 271,
    Kas = 354,
    ["Keycloak REST API"] = 799,
    ["Knative Functions - func.yaml"] = 272,
    ["KoDE/CI build.yaml"] = 787,
    ["Kong DBLess config"] = 788,
    KrakenD = 357,
    ["Kubri Configuration"] = 362,
    LOOBin = 377,
    Lefthook = 366,
    ["Liferay client-extension.yaml"] = 373,
    ["LinkML Metamodel"] = 375,
    Liquibase = 734,
    ["Liquibase Flow File"] = 735,
    ["Lively Properties"] = 376,
    ["Lobe AI Agent"] = 66,
    Loki = 67,
    ["MLOS Configs"] = 411,
    ["MS2Rescore Configuration"] = 414,
    ["Madness (madness.yml)"] = 810,
    Markdownlint = 738,
    ["Mason Registry"] = 740,
    ["MegaLinter configuration"] = 383,
    ["MegaLinter descriptor"] = 384,
    Melange = 836,
    ["Meltano plugin discovery definition"] = 386,
    ["Meltano project definition"] = 385,
    ["Mergify Configuration"] = 415,
    ["MetricsHub Configuration"] = 387,
    ["MetricsHub Connector Configuration"] = 388,
    ["Micro Editor Syntax"] = 820,
    ["Microsoft Band Web Tile"] = 389,
    ["Minecraft Custom Main Menu Mod"] = 837,
    ["Minecraft Data Pack Advancement"] = 391,
    ["Minecraft Data Pack Biome"] = 392,
    ["Minecraft Data Pack Configured Carver"] = 393,
    ["Minecraft Data Pack Damage Type"] = 394,
    ["Minecraft Data Pack Dimension"] = 396,
    ["Minecraft Data Pack Dimension Type"] = 395,
    ["Minecraft Data Pack Item Modifier"] = 397,
    ["Minecraft Data Pack Loot Table"] = 398,
    ["Minecraft Data Pack Metadata"] = 399,
    ["Minecraft Data Pack Predicate"] = 400,
    ["Minecraft Data Pack Recipe"] = 401,
    ["Minecraft Data Pack Tag"] = 402,
    ["Minecraft Data Pack Template Pool"] = 403,
    ["Minecraft Data Pack Trim Material"] = 408,
    ["Minecraft Data Pack Trim Pattern"] = 409,
    ["Minecraft Resource Pack Lang"] = 404,
    ["Minecraft Resource Pack Particle"] = 405,
    ["Minecraft Resource Pack Texture Mcmeta"] = 407,
    ["Minecraft Resourcepack Sounds"] = 406,
    ["MkDocs Configuration 1.0"] = 410,
    ["Monade CLI Stack Configuration"] = 418,
    ["MongoDB Atlas Search Index Definition"] = 786,
    ["Monika Configuration"] = 784,
    ["Monoweave Configuration"] = 413,
    ["Motif config"] = 684,
    ["NOX Framework (Service)"] = 431,
    ["Netin Diagnostic System Template"] = 744,
    ["Netlify config"] = 421,
    ["Network-as-Code Data Model"] = 422,
    ["Nightwatch.js"] = 423,
    ["Nuitka.yaml"] = 850,
    ["ONe's changelog entry"] = 447,
    ["ONe's service descriptor"] = 446,
    ["OSS Review Toolkit configuration"] = 454,
    ["OSS Review Toolkit curation"] = 455,
    ["OSS Review Toolkit package configuration"] = 456,
    ["OSS Review Toolkit repository configuration"] = 457,
    ["OSS Review Toolkit resolutions"] = 458,
    Opctl = 687,
    ["OpenRewrite Resource"] = 449,
    ["OpenUtau character yaml"] = 443,
    ["OpenUtau ustx"] = 444,
    ["OpenWeather Current Weather API"] = 725,
    ["OpenWeather Road Risk API"] = 724,
    ["Ory Hydra configuration"] = 317,
    ["Ory Keto configuration"] = 359,
    ["Ory Kratos configuration"] = 453,
    ["Ory Oathkeeper configuration"] = 438,
    ["Outblocks App configuration"] = 451,
    ["Outblocks database table"] = 452,
    ["Outblocks project configuration"] = 450,
    PDM = 464,
    Packer = 461,
    Pantsbuild = 806,
    ["Paper paper-plugin.yml"] = 462,
    ["Pipeline component"] = 736,
    ["PocketMine plugin.yml"] = 469,
    ["Postman collection"] = 474,
    ["Problem object RFC9457"] = 834,
    ["Problem package generators"] = 482,
    Pterodactyl = 781,
    ["Pull Request Labeler"] = 497,
    Pulumi = 503,
    PyProject = 504,
    Pyright = 505,
    Qgoda = 506,
    Qodana = 754,
    ["Quali Torque Blueprint Spec 2"] = 779,
    ["QueryFirst config file"] = 802,
    ["RKE Cluster Configuration JSON"] = 733,
    ["RKE Cluster Configuration YAML"] = 732,
    ["Rancher Fleet"] = 500,
    ["Rattler-build"] = 507,
    Ray = 699,
    ["Read the Docs"] = 502,
    ["Red-DiscordBot Cog"] = 514,
    ["Red-DiscordBot Cog Repo"] = 515,
    ["Red-DiscordBot Trivia"] = 516,
    ["Render Blueprints"] = 731,
    RenderCV = 526,
    Renovate = 525,
    ["Replit config"] = 520,
    RoadRunner = 527,
    ["Rudder techniques"] = 840,
    Ruff = 522,
    ["Rust Project"] = 523,
    ["Rust toolchain"] = 530,
    ["SDMX data message"] = 555,
    ["SDMX metadata message"] = 554,
    ["SDMX structure message"] = 553,
    ["SIL Kit Participant Configuration"] = 565,
    ["SIL Kit Registry Configuration"] = 566,
    SWADL = 591,
    ["Safebox Config"] = 792,
    ["Sapphire CLI Config"] = 533,
    ["SauceCTL Configuration"] = 741,
    ["Schema Catalog"] = 547,
    ["Scoop manifest"] = 552,
    ["Semantic Data Fabric (SDF) file"] = 556,
    ["Semgrep Rule"] = 558,
    ["Serenity Code Generator (Sergen)"] = 559,
    ["Serverless Framework Configuration"] = 748,
    ["Serverless Workflow"] = 750,
    ["Settings.paf"] = 561,
    ["Shopware 6 Configuration"] = 751,
    ["Shopware CLI Extension Store Configuration"] = 752,
    ["Shopware CLI Project Store Configuration"] = 753,
    Sigma = 563,
    ["Sigrid scope configuration file"] = 564,
    ["SkyPilot Task JSON"] = 841,
    ["Slack app manifest"] = 568,
    Solidarity = 571,
    ["Solution filters"] = 572,
    ["Source Maps v3"] = 573,
    Sourcery = 574,
    SpecIF = 575,
    ["Sponge Mixin configuration"] = 576,
    StackBlitz = 581,
    ["StackHawk Scanner Configuration"] = 747,
    Stale = 582,
    ["Starlake Data Pipeline"] = 722,
    Starship = 583,
    ["Statamic Blueprint"] = 584,
    ["Stella configuration file"] = 585,
    ["StrmPrivacy Data Connector"] = 796,
    ["StrmPrivacy Data Contract"] = 797,
    ["StrmPrivacy SimpleSchema"] = 794,
    ["StrmPrivacy Stream"] = 795,
    ["StrmPrivacy batch job configuration file"] = 793,
    ["Stryker Mutator"] = 588,
    ["StyleCop Analyzers Configuration"] = 589,
    ["Stylelint (.stylelintrc)"] = 590,
    ["Sublime Syntax"] = 798,
    ["Subsquid squid manifest"] = 843,
    ["Swagger API 2.0"] = 592,
    TSON = 618,
    TSTyche = 619,
    Talhelper = 594,
    ["Talisman configuration"] = 595,
    ["Taskfile config"] = 727,
    Taurus = 596,
    ["TestEnvironment.json"] = 605,
    ["TextMate Grammar"] = 604,
    ["Tier.run pricing.json"] = 599,
    Tikibase = 600,
    ["Traefik v2"] = 608,
    ["Traefik v2 File Provider"] = 609,
    ["Travis CI (.travis.yml)"] = 607,
    TunnelHub = 833,
    Turborepo = 606,
    Tye = 755,
    ["UET BuildConfig.json"] = 803,
    ["UI5 Manifest"] = 628,
    ["UNCORS configuration"] = 632,
    ["UTAM Page Object"] = 631,
    ["Ubuntu Server Autoinstall"] = 626,
    ["Uniswap Token List"] = 710,
    ["Unreal Engine Uplugin"] = 804,
    ["Unreal Engine Uproject"] = 805,
    ["Updatecli Compose"] = 763,
    ["Updatecli Policy Manifest"] = 764,
    ["Updatecli Policy Metadata"] = 765,
    Uplift = 801,
    ["User Journey Map"] = 730,
    V2Ray = 769,
    ["VSCode Code Snippets"] = 170,
    ["VSIX CLI publishing"] = 647,
    ["Vela Pipeline Configuration"] = 636,
    Vercel = 169,
    Visivo = 831,
    ["Web App Manifest"] = 654,
    ["Web types"] = 657,
    WebExtensions = 653,
    ["Webman package recipe"] = 775,
    ["Windows Package Manager Installer Manifest"] = 707,
    ["Windows Package Manager Locale Manifest"] = 708,
    ["Windows Package Manager Singleton Manifest"] = 706,
    ["Woodpecker pipeline config"] = 743,
    ["Wrangler CLI"] = 658,
    ["Xstate Machine"] = 761,
    ["Yarn Config (.yarnrc.yml)"] = 720,
    ["Yippee-Ki-JSON configuration YML"] = 712,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 835,
    ...
    ["behat.yml"] = 92,
    ["bigquery-table"] = 84,
    ["bioimageio resource description"] = 851,
    ...
    ["importmap.json"] = 326,
    ["ioBroker Configuration"] = 327,
    ["ioBroker JSON UI"] = 328,
    ["ioBroker Package manifest"] = 329,
    ["ize.toml"] = 800,
    ["jsconfig.json"] = 352,
    ["jscpd Configuration"] = 780,
    jsdoc = 698,
    ["k3d.yaml"] = 353,
    ["k9s plugin.yml"] = 355,
    ["kontinuous-config.yaml"] = 361,
    ["kontinuous-values.yaml"] = 360,
    ["kustomization.yaml"] = 363,
    ["label-commenter-config.yml"] = 364,
    ["latexindent configuration"] = 65,
    ["launchsettings.json"] = 365,
    lazydocker = 822,
    lazygit = 821,
    ["lego.json"] = 367,
    ["lerna.json"] = 368,
    ["lgtm.yml"] = 369,
    ["liblab.config.json"] = 370,
    ["libman.json"] = 371,
    ["license-report-config.json"] = 372,
    ["linkinator.config.json"] = 374,
    ["lint-staged (.lintstagedrc)"] = 678,
    ["local.settings.json"] = 379,
    ["localazy.json"] = 380,
    ["lotus.yaml"] = 378,
    ["lsdlschema.json"] = 381,
    ["markdown-link-check"] = 739,
    mboats = 746,
    ["micro-settings.json"] = 815,
    ["mimetypes.json"] = 390,
    ["mirrord config"] = 679,
    mise = 680,
    ["mise-settings"] = 681,
    ...
    ["mtad.yaml"] = 683,
    ["mycode.json"] = 419,
    ["napari plugin manifest"] = 420,
    neoload = 693,
    ["nest-cli"] = 426,
    ["ninjs (News in JSON) 1.3"] = 425,
    ["ninjs (News in JSON) 2.0"] = 424,
    ["nixd configuration"] = 839,
    ["nlu.json"] = 427,
    ["nodemon.json"] = 429,
    ["noodl config"] = 745,
    ["notebook.mod.json"] = 430,
    now = 689,
    ["npm-badges"] = 433,
    ["nswag.json"] = 436,
    ntangle = 437,
    ["nuclei-template.yaml"] = 434,
    ["nuget-project.json"] = 435,
    ["ocelot.json"] = 439,
    ["omnisharp.json"] = 440,
    ["openapi.json"] = 441,
    ["openfin.json"] = 448,
    ...
    ["ops.yaml"] = 445,
    ["package.json"] = 459,
    ["package.manifest"] = 460,
    ["partial-black.json"] = 93,
    ["pathfinder.yml"] = 463,
    ["pattern.json"] = 466,
    ["petstore-v1.0"] = 790,
    pgap_yaml_input_reader = 465,
    ["pixi.toml"] = 467,
    ["plagiarize-me.yaml"] = 471,
    ["plagiarize.yaml"] = 470,
    ["portman.json"] = 472,
    ["prettierrc.json"] = 480,
    ["prisma.yml"] = 481,
    ["project-1.0.0-beta3.json"] = 484,
    ["project-1.0.0-beta4.json"] = 485,
    ["project-1.0.0-beta5.json"] = 486,
    ["project-1.0.0-beta6.json"] = 487,
    ["project-1.0.0-beta8.json"] = 488,
    ["project-1.0.0-rc1.json"] = 489,
    ["project-1.0.0-rc2.json"] = 490,
    ["project.json"] = 483,
    ["prometheus.json"] = 491,
    ["prometheus.rules.json"] = 492,
    ["prometheus.rules.test.json"] = 493,
    ["proxies.json"] = 494,
    ["publiccode.yml"] = 495,
    ["pubspec.yaml"] = 496,
    ["pyrseas-0.8.json"] = 499,
    ["quilt.mod.json"] = 816,
    ["rc3 auth"] = 508,
    ["rc3 collection"] = 509,
    ["rc3 environment"] = 510,
    ...
    ["rc3 settings"] = 513,
    ["release drafter"] = 694,
    ["release-plz.toml"] = 518,
    ["rivet.yaml"] = 838,
    rockcraft = 528,
    rustfmt = 529,
    samt = 531,
    samtrc = 532,
    ["sarif-1.0.0.json"] = 534,
    ["sarif-2.0.0.json"] = 535,
    ["sarif-2.1.0"] = 545,
    ["sarif-2.1.0-rtm.2"] = 536,
    ["sarif-2.1.0-rtm.3"] = 538,
    ["sarif-2.1.0-rtm.4"] = 540,
    ["sarif-2.1.0-rtm.5"] = 542,
    ["sarif-2.1.0-rtm.6"] = 543,
    ["sarif-external-property-file-2.1.0"] = 546,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 537,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 539,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 541,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 544,
    ["schema.org - Action"] = 548,
    ["schema.org - ContactPoint"] = 549,
    ["schema.org - Place"] = 550,
    ["schema.org - Thing"] = 551,
    ["secrethub.yml"] = 818,
    ["semantic-release"] = 557,
    ["servicehub.config.json"] = 668,
    ["servicehub.service.json"] = 667,
    ["settings.job"] = 560,
    ["sfdx-hardis configuration"] = 562,
    ["shard.yml"] = 854,
    ["size-limit configuration"] = 567,
    ["skaffold.yaml"] = 737,
    ["skyuxconfig.json"] = 569,
    snapcraft = 570,
    ["sqlc configuration"] = 578,
    ["stripe-app-local.json"] = 587,
    ["stripe-app.json"] = 586,
    swcrc = 723,
    ["task.json"] = 593,
    taskcat = 690,
    ["template.json"] = 597,
    ["templatsources.json"] = 598,
    ["theme.json"] = 601,
    ["tizen_workspace.json"] = 602,
    tldr = 603,
    tmuxinator = 676,
    ["transcend.yml"] = 610,
    ...
    ["vega-lite.json"] = 635,
    ["vega.json"] = 634,
    ["venvironment-basic.yaml"] = 638,
    ["venvironment.yaml"] = 637,
    ["version.json"] = 639,
    ["vim-addon-info"] = 641,
    ["vs-2017.3.host.json"] = 643,
    ["vs-nesting.json"] = 644,
    ["vsls.json"] = 642,
    ["vss-extension.json"] = 648,
    ["vtesttree.yaml"] = 649,
    ["vtestunit.yaml"] = 650,
    ["warp-keysets.json"] = 824,
    ["warp-themes.json"] = 825,
    ["warp-workflows.json"] = 826,
    ["webhint.io"] = 776,
    ["webjobpublishsettings.json"] = 656,
    ["webjobs-list.json"] = 655,
    ["well-known-fursona"] = 862,
    ["xs-app.json"] = 686,
    ["xunit.runner.json"] = 666,
    yamllint = 711,
    zuul = 695,
    ["Žinoma"] = 705
  },
