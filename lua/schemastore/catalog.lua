...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 748,
    [".nodehawkrc"] = 474,
    [".npmpackagejsonlintrc"] = 478,
    [".omletrc"] = 918,
    [".phrase.yml"] = 536,
    [".phraseapp.yml"] = 537,
    [".pmbot.yml"] = 525,
    [".postcssrc"] = 531,
    [".powerpages-web-template-manifest"] = 533,
    [".pre-commit-config.yml"] = 534,
    [".pre-commit-hooks.yml"] = 535,
    [".putout.json"] = 557,
    [".rehyperc"] = 576,
    [".remarkrc"] = 578,
    [".sprite files"] = 640,
    ...
    ["Mergify Configuration"] = 462,
    ["Metadata for a Bazel module"] = 433,
    ["Metadata for a Cinnamon spice"] = 942,
    ["MetricsHub Configuration"] = 434,
    ["MetricsHub Connector Configuration"] = 435,
    ["Micro Editor Syntax"] = 878,
    ["Microsoft Band Web Tile"] = 436,
    ["Microsoft RulesEngine workflow rules"] = 930,
    ["Microsoft RulesEngine workflow rules list"] = 931,
    ["Minecraft Custom Main Menu Mod"] = 895,
    ["Minecraft Data Pack Advancement"] = 438,
    ["Minecraft Data Pack Biome"] = 439,
    ["Minecraft Data Pack Configured Carver"] = 440,
    ["Minecraft Data Pack Damage Type"] = 441,
    ["Minecraft Data Pack Dimension"] = 443,
    ["Minecraft Data Pack Dimension Type"] = 442,
    ["Minecraft Data Pack Item Modifier"] = 444,
    ["Minecraft Data Pack Loot Table"] = 445,
    ["Minecraft Data Pack Metadata"] = 446,
    ["Minecraft Data Pack Predicate"] = 447,
    ["Minecraft Data Pack Recipe"] = 448,
    ["Minecraft Data Pack Tag"] = 449,
    ["Minecraft Data Pack Template Pool"] = 450,
    ["Minecraft Data Pack Trim Material"] = 455,
    ["Minecraft Data Pack Trim Pattern"] = 456,
    ["Minecraft Resource Pack Lang"] = 451,
    ["Minecraft Resource Pack Particle"] = 452,
    ["Minecraft Resource Pack Texture Mcmeta"] = 454,
    ["Minecraft Resourcepack Sounds"] = 453,
    ["Monade CLI Stack Configuration"] = 465,
    ["MongoDB Atlas Search Index Definition"] = 849,
    ["Monika Configuration"] = 847,
    ["Monoweave Configuration"] = 460,
    ["Motif config"] = 747,
    ["NOX Framework (Service)"] = 477,
    ["Netin Diagnostic System Template"] = 807,
    ["Netlify config"] = 468,
    ["Network-as-Code Data Model"] = 469,
    ["Nightwatch.js"] = 470,
    ["Nuitka.yaml"] = 908,
    ["Nullstone config"] = 483,
    ["ONe's changelog entry"] = 496,
    ["ONe's service descriptor"] = 495,
    ["OSCAL Assessment Plan (AP)"] = 504,
    ["OSCAL Assessment Results (AR)"] = 505,
    ["OSCAL Catalog"] = 506,
    ["OSCAL Component Definition (CDef)"] = 507,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 508,
    ["OSCAL Profile"] = 509,
    ["OSCAL System Security Plan (SSP)"] = 510,
    ["OSS Review Toolkit configuration"] = 511,
    ["OSS Review Toolkit curation"] = 512,
    ["OSS Review Toolkit package configuration"] = 513,
    ["OSS Review Toolkit repository configuration"] = 514,
    ["OSS Review Toolkit resolutions"] = 515,
    ["October CMS columns"] = 487,
    ["October CMS fields"] = 488,
    Opctl = 750,
    ["Open Data Contract Standard (ODCS)"] = 499,
    ["OpenRewrite Resource"] = 498,
    ["OpenUtau character yaml"] = 492,
    ["OpenUtau ustx"] = 493,
    ["OpenWeather Current Weather API"] = 788,
    ["OpenWeather Road Risk API"] = 787,
    ["Ory Hydra configuration"] = 354,
    ["Ory Keto configuration"] = 405,
    ["Ory Kratos configuration"] = 503,
    ["Ory Oathkeeper configuration"] = 485,
    ["Outblocks App configuration"] = 501,
    ["Outblocks database table"] = 502,
    ["Outblocks project configuration"] = 500,
    PDM = 521,
    Packer = 518,
    Pantsbuild = 864,
    ["Paper paper-plugin.yml"] = 519,
    ["Pipeline component"] = 799,
    ["PocketMine plugin.yml"] = 526,
    ["Postman collection"] = 532,
    ...
    ["mtad.yaml"] = 746,
    ["mycode.json"] = 466,
    ["napari plugin manifest"] = 467,
    neoload = 756,
    ["nest-cli"] = 472,
    ["ninjs (News in JSON)"] = 471,
    ["nixd configuration"] = 897,
    ["nlu.json"] = 473,
    ["nodemon.json"] = 475,
    ["noodl config"] = 808,
    ["notebook.mod.json"] = 476,
    now = 752,
    ["npm-badges"] = 479,
    ["nswag.json"] = 482,
    ntangle = 484,
    ["nuclei-template.yaml"] = 480,
    ["nuget-project.json"] = 481,
    ["ocelot.json"] = 486,
    ["omnisharp.json"] = 489,
    ["openapi.json"] = 490,
    ["openfin.json"] = 497,
    ...
    ["ops.yaml"] = 494,
    ["package.json"] = 516,
    ["package.manifest"] = 517,
    ["partial-black.json"] = 90,
    ["pathfinder.yml"] = 520,
    ["pattern.json"] = 523,
    ["petstore-v1.0"] = 853,
    pgap_yaml_input_reader = 522,
    ["pixi.toml"] = 524,
    ["plagiarize-me.yaml"] = 528,
    ["plagiarize.yaml"] = 527,
    ["podbard.yaml"] = 529,
    ["portman.json"] = 530,
    ["prefect.toml"] = 538,
    ...
    ["webhint.io"] = 839,
    ["webjobpublishsettings.json"] = 723,
    ["webjobs-list.json"] = 722,
