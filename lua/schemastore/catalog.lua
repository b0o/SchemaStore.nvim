...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 193,
    [".cryproj (generic)"] = 655,
    [".cryproj engine-5.2"] = 650,
    [".cryproj engine-5.3"] = 651,
    [".cryproj engine-5.4"] = 652,
    [".cryproj engine-5.5"] = 653,
    [".cryproj engine-dev"] = 654,
    [".eslintrc"] = 248,
    [".esmrc.json"] = 240,
    [".ffizer.yaml"] = 252,
    [".htmlhintrc"] = 308,
    ...
    [".mtaext"] = 666,
    [".nodehawkrc"] = 417,
    [".npmpackagejsonlintrc"] = 420,
    [".phrase.yml"] = 466,
    [".phraseapp.yml"] = 467,
    [".pmbot.yml"] = 456,
    [".postcssrc"] = 461,
    [".powerpages-web-template-manifest"] = 463,
    [".pre-commit-config.yml"] = 464,
    [".pre-commit-hooks.yml"] = 465,
    [".putout.json"] = 486,
    [".rehyperc"] = 499,
    [".remarkrc"] = 501,
    [".sprite files"] = 559,
    ...
    ["Adobe UXP Manifest"] = 823,
    ["Aerleon Network & Service Definitions"] = 7,
    ["Aerleon Policy"] = 8,
    ["Airlock Microgateway"] = 12,
    ["Airplane task"] = 13,
    ["Alacritty Configuration"] = 730,
    ["All Contributors configuration file"] = 788,
    ...
    ["Azure Pipelines"] = 64,
    ["Azure Static Web Apps CLI configuration file"] = 562,
    ["Azure Static Web Apps configuration file"] = 561,
    ["BX CI"] = 102,
    ["Bashly (bashly.yml)"] = 792,
    ["Bashly Settings (bashly-settings.yml)"] = 793,
    ["Better Code Hub"] = 702,
    ["Better Scripts"] = 103,
    Bigconfig = 81,
    BizTalkServerApplicationSchema = 672,
    Bleep = 104,
    ...
    ["Butane Config"] = 743,
    ["CGS Custom Card Game (CardGameDef.json)"] = 828,
    ["CICS TS region tagging"] = 752,
    ["CICS TS resource import"] = 753,
    ["CICS TS resource model"] = 754,
    ["CICS TS resource overrides"] = 755,
    ["CMake Presets"] = 105,
    ["CNC Codes"] = 117,
    ...
    ["DataYoga Job"] = 124,
    ["Databricks Asset Bundles"] = 809,
    ["Datadog Service Definition"] = 349,
    ["Datahub Ingestion Recipe"] = 759,
    ["Dein Config"] = 126,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 800,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 789,
    ...
    ["Goreleaser Pro"] = 289,
    Goss = 290,
    ["Gradle Build Cache Node"] = 700,
    ["Gradle Enterprise"] = 699,
    ...
    Hadolint = 681,
    Hammerkit = 709,
    ["Hardware Sentry Configuration"] = 763,
    Hatch = 682,
    Hayson = 303,
    ...
    ["IVMS101 by CODE Protocol"] = 826,
    Istanbul = 766,
    ["JDownloader2 crawler multi-rules"] = 326,
    ["JDownloader2 crawler single-rules"] = 325,
    ["JFrog Applications Config"] = 327,
    ["JFrog File Spec"] = 328,
    ["JFrog Pipelines YML DSL"] = 772,
    ["JMeter DSL cli config"] = 329,
    JReleaser = 331,
    ["JSON Document Transform"] = 339,
    ["JSON Feed"] = 340,
    ["JSON Resume"] = 506,
    ["JSON Schema Draft 2020-12"] = 646,
    ["JSON Schema Draft 4"] = 643,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 810,
    ["JSON Schema Draft 7"] = 644,
    ["JSON Schema Draft 7 (unofficial strict)"] = 811,
    ["JSON Schema Draft 8 (2019-09)"] = 645,
    ["JSON-API"] = 338,
    ["JSON-e templates"] = 707,
    ["JSON-stat 2.0"] = 640,
    JSONPatch = 342,
    ...
    Kas = 345,
    ["Keycloak REST API"] = 780,
    ["Knative Functions - func.yaml"] = 265,
    ["KoDE/CI build.yaml"] = 768,
    ["Kong DBLess config"] = 769,
    KrakenD = 348,
    LOOBin = 367,
    Lefthook = 356,
    ...
    ["Micro Editor Syntax"] = 801,
    ["Microsoft Band Web Tile"] = 379,
    ["Minecraft Custom Main Menu Mod"] = 818,
    ...
    ["Monade CLI Stack Configuration"] = 407,
    ["MongoDB Atlas Search Index Definition"] = 767,
    ["Monika Configuration"] = 765,
    ["Monoweave Configuration"] = 403,
    ["Motif config"] = 665,
    ["NOX Framework (Service)"] = 419,
    ["Netin Diagnostic System Template"] = 725,
    ["Netlify config"] = 410,
    ["Network-as-Code Data Model"] = 411,
    ["Nightwatch.js"] = 412,
    ["Nuitka.yaml"] = 831,
    ["ONe's changelog entry"] = 435,
    ["ONe's service descriptor"] = 434,
    ["OSS Review Toolkit configuration"] = 442,
    ["OSS Review Toolkit curation"] = 443,
    ["OSS Review Toolkit package configuration"] = 444,
    ["OSS Review Toolkit repository configuration"] = 445,
    ["OSS Review Toolkit resolutions"] = 446,
    Opctl = 668,
    ["OpenRewrite Resource"] = 437,
    ["OpenUtau character yaml"] = 431,
    ["OpenUtau ustx"] = 432,
    ["OpenWeather Current Weather API"] = 706,
    ["OpenWeather Road Risk API"] = 705,
    ["Ory Hydra configuration"] = 309,
    ["Ory Keto configuration"] = 350,
    ["Ory Kratos configuration"] = 441,
    ["Ory Oathkeeper configuration"] = 426,
    ["Outblocks App configuration"] = 439,
    ["Outblocks database table"] = 440,
    ["Outblocks project configuration"] = 438,
    PDM = 452,
    Packer = 449,
    Pantsbuild = 787,
    ["Paper paper-plugin.yml"] = 450,
    ["Pipeline component"] = 717,
    ["PocketMine plugin.yml"] = 457,
    ["Postman collection"] = 462,
    ["Problem object RFC9457"] = 815,
    ["Problem package generators"] = 470,
    Pterodactyl = 762,
    ["Pull Request Labeler"] = 485,
    Pulumi = 491,
    PyProject = 492,
    Pyright = 493,
    Qgoda = 494,
    Qodana = 735,
    ["Quali Torque Blueprint Spec 2"] = 760,
    ["QueryFirst config file"] = 783,
    ["RKE Cluster Configuration JSON"] = 714,
    ["RKE Cluster Configuration YAML"] = 713,
    ["Rancher Fleet"] = 488,
    ["Rattler-build"] = 495,
    Ray = 680,
    ["Read the Docs"] = 490,
    ["Red-DiscordBot Cog"] = 496,
    ["Red-DiscordBot Cog Repo"] = 497,
    ["Red-DiscordBot Trivia"] = 498,
    ["Render Blueprints"] = 712,
    RenderCV = 508,
    Renovate = 507,
    ["Replit config"] = 502,
    RoadRunner = 509,
    ["Rudder techniques"] = 821,
    Ruff = 504,
    ["Rust Project"] = 505,
    ["Rust toolchain"] = 512,
    ["SDMX data message"] = 537,
    ["SDMX metadata message"] = 536,
    ["SDMX structure message"] = 535,
    ["SIL Kit Participant Configuration"] = 547,
    ["SIL Kit Registry Configuration"] = 548,
    SWADL = 573,
    ["Safebox Config"] = 773,
    ["Sapphire CLI Config"] = 515,
    ["SauceCTL Configuration"] = 722,
    ["Schema Catalog"] = 529,
    ["Scoop manifest"] = 534,
    ["Semantic Data Fabric (SDF) file"] = 538,
    ["Semgrep Rule"] = 540,
    ["Serenity Code Generator (Sergen)"] = 541,
    ["Serverless Framework Configuration"] = 729,
    ["Serverless Workflow"] = 731,
    ["Settings.paf"] = 543,
    ["Shopware 6 Configuration"] = 732,
    ["Shopware CLI Extension Store Configuration"] = 733,
    ["Shopware CLI Project Store Configuration"] = 734,
    Sigma = 545,
    ["Sigrid scope configuration file"] = 546,
    ["SkyPilot Task JSON"] = 822,
    ["Slack app manifest"] = 550,
    Solidarity = 553,
    ["Solution filters"] = 554,
    ["Source Maps v3"] = 555,
    Sourcery = 556,
    SpecIF = 557,
    ["Sponge Mixin configuration"] = 558,
    StackBlitz = 563,
    ["StackHawk Scanner Configuration"] = 728,
    Stale = 564,
    ["Starlake Data Pipeline"] = 703,
    Starship = 565,
    ["Statamic Blueprint"] = 566,
    ["Stella configuration file"] = 567,
    ["StrmPrivacy Data Connector"] = 777,
    ["StrmPrivacy Data Contract"] = 778,
    ["StrmPrivacy SimpleSchema"] = 775,
    ["StrmPrivacy Stream"] = 776,
    ["StrmPrivacy batch job configuration file"] = 774,
    ["Stryker Mutator"] = 570,
    ["StyleCop Analyzers Configuration"] = 571,
    ["Stylelint (.stylelintrc)"] = 572,
    ["Sublime Syntax"] = 779,
    ["Subsquid squid manifest"] = 824,
    ["Swagger API 2.0"] = 574,
    TSON = 600,
    TSTyche = 601,
    Talhelper = 576,
    ["Talisman configuration"] = 577,
    ["Taskfile config"] = 708,
    Taurus = 578,
    ["TestEnvironment.json"] = 587,
    ["TextMate Grammar"] = 586,
    ["Tier.run pricing.json"] = 581,
    Tikibase = 582,
    ["Traefik v2"] = 590,
    ["Traefik v2 File Provider"] = 591,
    ["Travis CI (.travis.yml)"] = 589,
    TunnelHub = 814,
    Turborepo = 588,
    Tye = 736,
    ["UET BuildConfig.json"] = 784,
    ["UI5 Manifest"] = 610,
    ["UNCORS configuration"] = 614,
    ["UTAM Page Object"] = 613,
    ["Ubuntu Server Autoinstall"] = 608,
    ["Uniswap Token List"] = 691,
    ["Unreal Engine Uplugin"] = 785,
    ["Unreal Engine Uproject"] = 786,
    ["Updatecli Compose"] = 744,
    ["Updatecli Policy Manifest"] = 745,
    ["Updatecli Policy Metadata"] = 746,
    Uplift = 782,
    ["User Journey Map"] = 711,
    V2Ray = 750,
    ["VSCode Code Snippets"] = 164,
    ["VSIX CLI publishing"] = 628,
    ["Vela Pipeline Configuration"] = 617,
    Vercel = 163,
    Visivo = 812,
    ["Web App Manifest"] = 635,
    ["Web types"] = 638,
    WebExtensions = 634,
    ["Webman package recipe"] = 756,
    ["Windows Package Manager Installer Manifest"] = 688,
    ["Windows Package Manager Locale Manifest"] = 689,
    ["Windows Package Manager Singleton Manifest"] = 687,
    ["Woodpecker pipeline config"] = 724,
    ["Wrangler CLI"] = 639,
    ["Xstate Machine"] = 742,
    ["Yarn Config (.yarnrc.yml)"] = 701,
    ["Yippee-Ki-JSON configuration YML"] = 693,
    ["aerleon.yml"] = 6,
    ["angular.json"] = 14,
    apko = 816,
    ...
    ["behat.yml"] = 88,
    ["bigquery-table"] = 80,
    ["bioimageio resource description"] = 832,
    ...
    ["lint-staged (.lintstagedrc)"] = 659,
    ["local.settings.json"] = 369,
    ["localazy.json"] = 370,
    ["lotus.yaml"] = 368,
    ["lsdlschema.json"] = 371,
    ["markdown-link-check"] = 720,
    mboats = 727,
    ["micro-settings.json"] = 796,
    ["mimetypes.json"] = 380,
    ["mirrord config"] = 660,
    mise = 661,
    ["mise-settings"] = 662,
    ...
    ["mtad.yaml"] = 664,
    ["mycode.json"] = 408,
    ["napari plugin manifest"] = 409,
    neoload = 674,
    ["nest-cli"] = 415,
    ["ninjs (News in JSON) 1.3"] = 414,
    ["ninjs (News in JSON) 2.0"] = 413,
    ["nixd configuration"] = 820,
    ["nlu.json"] = 416,
    ["nodemon.json"] = 418,
    ["noodl config"] = 726,
    now = 670,
    ...
    ["nswag.json"] = 424,
    ntangle = 425,
    ["nuclei-template.yaml"] = 422,
    ["nuget-project.json"] = 423,
    ["ocelot.json"] = 427,
    ["omnisharp.json"] = 428,
    ["openapi.json"] = 429,
    ["openfin.json"] = 436,
    ...
    ["ops.yaml"] = 433,
    ["package.json"] = 447,
    ["package.manifest"] = 448,
    ["partial-black.json"] = 89,
    ["pathfinder.yml"] = 451,
    ["pattern.json"] = 454,
    ["petstore-v1.0"] = 771,
    pgap_yaml_input_reader = 453,
    ["pixi.toml"] = 455,
    ["plagiarize-me.yaml"] = 459,
    ["plagiarize.yaml"] = 458,
    ["portman.json"] = 460,
    ["prettierrc.json"] = 468,
    ["prisma.yml"] = 469,
    ["project-1.0.0-beta3.json"] = 472,
    ["project-1.0.0-beta4.json"] = 473,
    ["project-1.0.0-beta5.json"] = 474,
    ["project-1.0.0-beta6.json"] = 475,
    ["project-1.0.0-beta8.json"] = 476,
    ["project-1.0.0-rc1.json"] = 477,
    ["project-1.0.0-rc2.json"] = 478,
    ["project.json"] = 471,
    ["prometheus.json"] = 479,
    ["prometheus.rules.json"] = 480,
    ["prometheus.rules.test.json"] = 481,
    ["proxies.json"] = 482,
    ["publiccode.yml"] = 483,
    ["pubspec.yaml"] = 484,
    ["pyrseas-0.8.json"] = 487,
    ["quilt.mod.json"] = 797,
    ["release drafter"] = 675,
    ["release-plz.toml"] = 500,
    ["rivet.yaml"] = 819,
    rockcraft = 510,
    rustfmt = 511,
    samt = 513,
    samtrc = 514,
    ["sarif-1.0.0.json"] = 516,
    ["sarif-2.0.0.json"] = 517,
    ["sarif-2.1.0"] = 527,
    ["sarif-2.1.0-rtm.2"] = 518,
    ["sarif-2.1.0-rtm.3"] = 520,
    ["sarif-2.1.0-rtm.4"] = 522,
    ["sarif-2.1.0-rtm.5"] = 524,
    ["sarif-2.1.0-rtm.6"] = 525,
    ["sarif-external-property-file-2.1.0"] = 528,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 519,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 521,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 523,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 526,
    ["schema.org - Action"] = 530,
    ["schema.org - ContactPoint"] = 531,
    ["schema.org - Place"] = 532,
    ["schema.org - Thing"] = 533,
    ["secrethub.yml"] = 799,
    ["semantic-release"] = 539,
    ["servicehub.config.json"] = 649,
    ["servicehub.service.json"] = 648,
    ["settings.job"] = 542,
    ["sfdx-hardis configuration"] = 544,
    ["shard.yml"] = 835,
    ["size-limit configuration"] = 549,
    ["skaffold.yaml"] = 718,
    ["skyuxconfig.json"] = 551,
    snapcraft = 552,
    ["sqlc configuration"] = 560,
    ["stripe-app-local.json"] = 569,
    ["stripe-app.json"] = 568,
    swcrc = 704,
    ["task.json"] = 575,
    taskcat = 671,
    ["template.json"] = 579,
    ["templatsources.json"] = 580,
    ["theme.json"] = 583,
    ["tizen_workspace.json"] = 584,
    tldr = 585,
    tmuxinator = 657,
    ["transcend.yml"] = 592,
    ...
    ["vega-lite.json"] = 616,
    ["vega.json"] = 615,
    ["venvironment-basic.yaml"] = 619,
    ["venvironment.yaml"] = 618,
    ["version.json"] = 620,
    ["vim-addon-info"] = 622,
    ["vs-2017.3.host.json"] = 624,
    ["vs-nesting.json"] = 625,
    ["vsls.json"] = 623,
    ["vss-extension.json"] = 629,
    ["vtesttree.yaml"] = 630,
    ["vtestunit.yaml"] = 631,
    ["warp-keysets.json"] = 805,
    ["warp-themes.json"] = 806,
    ["warp-workflows.json"] = 807,
    ["webhint.io"] = 757,
    ["webjobpublishsettings.json"] = 637,
    ["webjobs-list.json"] = 636,
    ["xs-app.json"] = 667,
    ["xunit.runner.json"] = 647,
    yamllint = 692,
    zuul = 676,
    ["Žinoma"] = 686
  },
