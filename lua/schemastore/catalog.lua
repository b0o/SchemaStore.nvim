...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 21,
    AIConfig = 22,
    ["AMX Muse Program Descriptor"] = 1098,
    ["API Builder"] = 909,
    ["AVA Configuration"] = 972,
    ...
    ["AWS Copilot Manifest"] = 1137,
    ["AWS SAM CLI Samconfig"] = 228,
    ["Adobe UXP Manifest"] = 1034,
    ["Aerleon Network & Service Definitions"] = 15,
    ["Aerleon Policy"] = 16,
    Aider = 1127,
    Air = 18,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1148,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1147,
    ["Airlock Microgateway"] = 23,
    ["Alacritty Configuration"] = 944,
    ["All Contributors configuration file"] = 997,
    ...
    ["Application list for a WinUtil"] = 1078,
    ArchitectFX = 1083,
    ["Argo Events"] = 41,
    ["Argo Workflows"] = 42,
    AssemblyScript = 45,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1146,
    ["Azure IoT Operations connector metadata"] = 1143,
    ...
    ["BX CI"] = 127,
    ["Bacon config"] = 2,
    ["Bashly (bashly.yml)"] = 1001,
    ["Bashly Settings (bashly-settings.yml)"] = 1002,
    ["Better Code Hub"] = 914,
    ["Better Scripts"] = 128,
    Bigconfig = 100,
    ["Biome Formatter Config"] = 67,
    ["Bitmovin Encoding Template"] = 1091,
    BizTalkServerApplicationSchema = 881,
    Bleep = 129,
    ...
    ["Butane Config"] = 957,
    C4InterFlow = 1106,
    ["CDK Environment Manager, concrete environment configuration"] = 1130,
    ["CDK Environment Manager, concrete environments definition"] = 1129,
    ["CDK Environment Manager, environment definition"] = 1128,
    ["CGS Card Game Specification (cgs.json)"] = 1039,
    ["CICS TS region tagging"] = 966,
    ["CICS TS resource import"] = 967,
    ["CICS TS resource model"] = 968,
    ["CICS TS resource overrides"] = 969,
    ["CMake Presets"] = 130,
    ["CNC Codes"] = 151,
    ["CRS WAF test file"] = 1068,
    ["CRS WAF test platform overrides file"] = 1069,
    ...
    ["Chamaleon environment"] = 1095,
    ["Chamaleon properties"] = 1096,
    ["Chamaleon template"] = 1094,
    Changesets = 237,
    Changie = 139,
    Charmcraft = 140,
    Cheatsheets = 954,
    ...
    ["Clawject config"] = 157,
    ["Cloud Foundry Application Manifest"] = 1050,
    ["Cloud Run Spec v1"] = 1073,
    ...
    Concord = 1067,
    ["Configu .cfgu files"] = 1055,
    ["Configu .configu file"] = 1056,
    Conjure = 150,
    ["Container Structure Test"] = 895,
    Containerlab = 923,
    ["Contextive Glossary"] = 1122,
    Convex = 149,
    ["Crowdsec collection config"] = 247,
    ["Crowdsec parser config"] = 248,
    ["Crowdsec scenario config"] = 249,
    ["CumulusCI Config"] = 156,
    ["Custom Machinery Machine"] = 1040,
    ["Custom Machinery Recipe"] = 1041,
    ...
    ["DonateCaseBetterCasino menu"] = 1099,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1009,
    ["EAS config"] = 313,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 998,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1142,
    ["EasyVCR .NET"] = 314,
    ["Eidolon Resource"] = 1084,
    ...
    ["Evolving Resolutive Process notation"] = 1144,
    ["Expo SDK"] = 312,
    ...
    ["GeoJSON.json latest"] = 961,
    GherKing = 965,
    ["GitHub Action"] = 346,
    ["GitHub Actions typing"] = 1080,
    ...
    ["Google Digital Assetlinks"] = 1123,
    Goreleaser = 374,
    ["Goreleaser Pro"] = 375,
    Goss = 376,
    ["Gradle Build Cache Node"] = 912,
    ["Gradle Enterprise"] = 911,
    ...
    Hadolint = 891,
    Hammerkit = 922,
    ["Hardware Sentry Configuration"] = 977,
    ["HashiCorp Vault"] = 389,
    Hatch = 892,
    Hayagriva = 391,
    Hayson = 392,
    ...
    ["JFrog File Spec"] = 425,
    ["JFrog Pipelines YML DSL"] = 986,
    ["JMeter DSL cli config"] = 426,
    JReleaser = 429,
    ["JSON Document Transform"] = 437,
    ["JSON Feed"] = 438,
    ["JSON Resume"] = 667,
    ["JSON Schema Draft 2020-12"] = 859,
    ["JSON Schema Draft 4"] = 856,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1019,
    ["JSON Schema Draft 7"] = 857,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1020,
    ["JSON Schema Draft 8 (2019-09)"] = 858,
    ["JSON-API"] = 436,
    ["JSON-e templates"] = 919,
    ["JSON-stat 2.0"] = 852,
    JSONPatch = 440,
    ...
    ["Jujutsu (jj) VCS config"] = 1136,
    ["KIMMDY config file"] = 451,
    ["KODE/CI build.yaml"] = 982,
    ["KSP-AVC"] = 853,
    ["KSP-CKAN"] = 854,
    ["KSP-NetKAN"] = 855,
    KSY = 1049,
    ...
    ["Metadata for a Cinnamon spice"] = 1076,
    ["Metatype Configuration"] = 491,
    ["MetricsHub Configuration"] = 492,
    ["MetricsHub Connector Configuration"] = 493,
    ["Micro Editor Syntax"] = 1010,
    ["Microsoft Band Web Tile"] = 494,
    ["Microsoft RulesEngine workflow rules"] = 1064,
    ["Microsoft RulesEngine workflow rules list"] = 1065,
    ["Minecraft Custom Main Menu Mod"] = 1028,
    ...
    ["MongoDB Atlas Search Index Definition"] = 981,
    ["Monika Configuration"] = 979,
    ["Monoweave Configuration"] = 519,
    ["Motif config"] = 873,
    MultiQC = 1116,
    ["NOX Framework (Service)"] = 538,
    ["Netin Diagnostic System Template"] = 939,
    ["Netlify config"] = 527,
    ["Network-as-Code Data Model"] = 528,
    ["Next Gen UI Agent Configuration"] = 529,
    ["Nightwatch.js"] = 531,
    ["Node.js configuration"] = 878,
    ...
    ["OpenUtau ustx"] = 557,
    ["OpenWeather Current Weather API"] = 918,
    ["OpenWeather Road Risk API"] = 917,
    ...
    ["Power Pages Configuration"] = 1133,
    ["Preset list for a WinUtil"] = 1079,
    ...
    Pylock = 1124,
    Pyright = 642,
    ["Python script metadata"] = 1118,
    ["QType AI DSL"] = 645,
    Qgoda = 644,
    Qodana = 949,
    ["Qt Creator workspace file"] = 1057,
    ["Quali Torque Blueprint Spec 2"] = 974,
    ["QueryFirst config file"] = 992,
    ["RKE Cluster Configuration JSON"] = 927,
    ["RKE Cluster Configuration YAML"] = 926,
    RadioHound = 635,
    Railway = 646,
    ["Rancher Fleet"] = 637,
    ["Rattler-build"] = 647,
    ...
    ["Render Blueprints"] = 925,
    RenderCV = 669,
    Renovate = 668,
    ["Replit config"] = 662,
    Restate = 1111,
    ["Revel Digital Gadget Definition File"] = 1135,
    RoadRunner = 671,
    ["Robust Station Image"] = 1141,
    Rockcraft = 672,
    ["Roo Coder Custom Modes"] = 673,
    Rubocop = 664,
    ["Rudder techniques"] = 1032,
    Ruff = 665,
    ["Rust Project"] = 666,
    ["Rust toolchain"] = 677,
    ...
    ["SauceCTL Configuration"] = 936,
    ["Schema Catalog"] = 695,
    ["Scoop manifest"] = 700,
    ["Semantic Data Fabric (SDF) file"] = 704,
    ["Semgrep Rule"] = 706,
    ["Serenity Code Generator (Sergen)"] = 707,
    ["Serverless Framework Configuration"] = 943,
    ["Serverless Workflow"] = 945,
    ["Settings for a Cinnamon spice"] = 1075,
    ["Settings.paf"] = 709,
    ["Shopware 6 Configuration"] = 946,
    ["Shopware CLI Extension Store Configuration"] = 947,
    ["Shopware CLI Project Store Configuration"] = 948,
    ["Sigma Detection Rule"] = 711,
    ["Sigrid scope configuration file"] = 712,
    ["SkyPilot Task JSON"] = 1033,
    ...
    StackBlitz = 755,
    ["StackHawk Scanner Configuration"] = 942,
    Stale = 756,
    Starfish = 757,
    ["Starlake Data Pipeline"] = 915,
    Starship = 758,
    ...
    ["Stylua Config"] = 1125,
    ["Sublime Syntax"] = 988,
    ["Subsquid squid manifest"] = 1035,
    ["Swagger API 2.0"] = 768,
    ["Synadia Connect Component"] = 769,
    TSON = 804,
    TSTyche = 805,
    ["TYPO3 Vendor Bundler config"] = 810,
    ["Tab data for a LinUtil"] = 1082,
    ["Tab list for a LinUtil"] = 1081,
    Tach = 770,
    ["Tach Domain"] = 771,
    Talhelper = 773,
    ...
    ["Tugboat QA config.yml"] = 1105,
    TunnelHub = 1023,
    Turborepo = 788,
    Tycho = 1071,
    Tye = 950,
    ["Tyk Gateway - Open Source v5.7+"] = 1117,
    ["Typst Manifest"] = 811,
    ["UET BuildConfig.json"] = 993,
    ["UI5 Manifest"] = 817,
    ["UNCORS configuration"] = 821,
    ["UTAM Page Object"] = 820,
    ["Ubuntu Server Autoinstall"] = 815,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1109,
    ["Uniswap Token List"] = 902,
    ["Universal Schedule Format"] = 822,
    ["Unreal Engine Uplugin"] = 994,
    ["Unreal Engine Uproject"] = 995,
    ["UpCloud CLI (upctl) configuration"] = 1110,
    ["Updatecli Compose"] = 958,
    ["Updatecli Policy Manifest"] = 959,
    ["Updatecli Policy Metadata"] = 960,
    Uplift = 991,
    ["Upsun config"] = 3,
    ["User Journey Map"] = 924,
    V2Ray = 964,
    ["VSCode Code Snippets"] = 212,
    ["VSIX CLI publishing"] = 840,
    Vector = 824,
    ["Vela Pipeline Configuration"] = 827,
    Vercel = 211,
    ["Version Bumper config"] = 830,
    ["Viash Component Config"] = 1114,
    ["Viash Package Config"] = 1115,
    Visivo = 1021,
    ["WP-CLI"] = 850,
    Wake = 1107,
    ["Waku Config"] = 1085,
    ["Web App Manifest"] = 846,
    ["Web types"] = 849,
    WebExtensions = 845,
    ["Webman package recipe"] = 970,
    ["Windows Package Manager Installer Manifest"] = 898,
    ["Windows Package Manager Locale Manifest"] = 899,
    ["Windows Package Manager Singleton Manifest"] = 897,
    Winutil = 900,
    ["WireMock CLI import configuration"] = 1090,
    ["WireMock CLI local service configuration"] = 1089,
    ["WireMock stub mapping"] = 1088,
    ["Woodpecker pipeline config"] = 938,
    ["Wrangler CLI"] = 851,
    ["Xstate Machine"] = 956,
    ["Yandex Workflow Language"] = 1077,
    ["Yarn Config (.yarnrc.yml)"] = 913,
    ["Yippee-Ki-JSON configuration YML"] = 904,
    ["YouTrack App"] = 1074,
    ["Zarf Package Configuration"] = 1140,
    ["Zerops.io config"] = 1062,
    ["Zerops.io import"] = 1063,
    ["aerleon.yml"] = 14,
    ["angular.json"] = 24,
    apko = 1026,
    ...
    ["behat.yml"] = 110,
    ["bigquery-table"] = 99,
    ["bioimageio resource description"] = 1043,
    ...
    ["crowdin.yml"] = 246,
    ["ctfd-setup configuration file"] = 1097,
    ["custom-elements.json"] = 1013,
    ["cypress.json"] = 250,
    ...
    ["gematik health care insurance list"] = 1103,
    ["gematik health care patient list"] = 1100,
    ["gematik health care provider institution list"] = 1102,
    ["gematik health care provider list"] = 1101,
    ["gematik tiger test environment configuration"] = 1104,
    ["gitlab-ci"] = 354,
    ["global.json"] = 370,
    ...
    ["lint-staged (.lintstagedrc)"] = 867,
    ["local.settings.json"] = 479,
    ["localazy.json"] = 480,
    ["lotus.yaml"] = 478,
    ["lsdlschema.json"] = 481,
    ["markdown-link-check"] = 933,
    maturin = 934,
    mboats = 941,
    ["micro-settings.json"] = 1005,
    ["mimetypes.json"] = 495,
    ["mirrord config"] = 869,
    mise = 870,
    ["mkdocs.yml"] = 515,
    ["monospace.yml"] = 518,
    ["moon.yml"] = 1087,
    ["mprocs Configuration file"] = 1058,
    ["mrdocs.yml"] = 516,
    ["mta.yaml"] = 871,
    ["mtad.yaml"] = 872,
    ["mycode.json"] = 525,
    ...
    ["plagiarize.yaml"] = 594,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1093,
    ["podbard.yaml"] = 597,
    ["portman.json"] = 598,
    ["prefect.toml"] = 606,
    ["prettierrc.json"] = 607,
    ...
    ["servicehub.config.json"] = 862,
    ["servicehub.service.json"] = 861,
    ["settings.job"] = 708,
    ...
    tldr = 784,
    ["tm_devices configuration file"] = 1131,
    tmuxinator = 865,
    ["transcend.yml"] = 794,
    ...
    version = 1113,
    ["version.json"] = 831,
    ["vhwdebugger-binding.yaml"] = 833,
    ["vim-addon-info"] = 834,
    ["vs-2017.3.host.json"] = 836,
    ["vs-nesting.json"] = 837,
    ["vsls.json"] = 835,
    ["vss-extension.json"] = 841,
    vtcfg = 1119,
    ["vtesttree.yaml"] = 842,
    ["vtestunit.yaml"] = 843,
    ["warp-keysets.json"] = 1014,
    ["warp-themes.json"] = 1015,
    ["warp-workflows.json"] = 1016,
    ["webhint.io"] = 971,
    ["webjobpublishsettings.json"] = 848,
    ["webjobs-list.json"] = 847,
    ["well-known-fursona"] = 1053,
    ["xs-app.json"] = 875,
    ["xunit.runner.json"] = 860,
    yamllint = 903,
    zuul = 886,
    ["Žinoma"] = 896
  },
