...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 142,
    [".cryproj (generic)"] = 479,
    [".cryproj engine-5.2"] = 474,
    [".cryproj engine-5.3"] = 475,
    [".cryproj engine-5.4"] = 476,
    [".cryproj engine-5.5"] = 477,
    [".cryproj engine-dev"] = 478,
    [".csscomb.json"] = 144,
    [".csslintrc"] = 145,
    [".eslintrc"] = 186,
    [".esmrc.json"] = 178,
    ...
    [".mtaext"] = 488,
    [".nodehawkrc"] = 301,
    [".npmpackagejsonlintrc"] = 303,
    [".phraseapp.yml"] = 337,
    [".pmbot.yml"] = 329,
    [".postcssrc"] = 334,
    [".pre-commit-config.yml"] = 335,
    [".pre-commit-hooks.yml"] = 336,
    [".putout.json"] = 354,
    [".rehyperc"] = 360,
    [".remarkrc"] = 361,
    [".sprite files"] = 402,
    ...
    [".vsext"] = 454,
    [".yarnrc.yml"] = 520,
    ["<div>RIOTS' studio configuration"] = 458,
    ["@factorial/drupal-breakpoints-css"] = 4,
    ["API Builder"] = 517,
    ["AVA Configuration Schema"] = 571,
    ["AWS CDK cdk.json"] = 130,
    ["AWS CloudFormation"] = 131,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 132,
    ...
    ["Azure Pipelines"] = 44,
    ["Azure Static Web Apps CLI configuration file"] = 404,
    ["Azure Static Web Apps configuration file"] = 403,
    ["BX CI"] = 75,
    ["Better Code Hub"] = 522,
    ["Better Scripts"] = 76,
    BizTalkServerApplicationSchema = 494,
    ...
    ["Butane Config"] = 558,
    ["CICS TS region tagging"] = 565,
    ["CICS TS resource import"] = 566,
    ["CICS TS resource model"] = 567,
    ["CICS TS resource overrides"] = 568,
    ["CMake Presets"] = 77,
    ...
    Cheatsheets = 555,
    ["Chrome Extension"] = 124,
    ["CircleCI config.yml"] = 107,
    ["Citation File Format"] = 133,
    CityJSON = 84,
    ["Code Climate"] = 108,
    ["Commandbox Box.json"] = 87,
    ["Commandbox Server.json"] = 88,
    ["Common Catalog Schema"] = 122,
    ["Common types for all schemas"] = 1,
    Conjure = 85,
    ["Container Structure Test"] = 505,
    Containerlab = 529,
    ["Dart build configuration"] = 146,
    ["Dart test config"] = 147,
    ["DashLord configuration"] = 148,
    ["Datadog Service Definition"] = 259,
    ["Datahub Ingestion Recipe Schema"] = 572,
    ...
    Devfile = 175,
    ["Discord Webhook"] = 157,
    ["Dolittle Artifacts"] = 161,
    ["Dolittle Bounded Context Configuration"] = 162,
    ["Dolittle Event Horizons Configuration"] = 163,
    ["Dolittle Resources Configuration"] = 164,
    ["Dolittle Server Configuration"] = 165,
    ["Dolittle Tenant Map Configuration"] = 167,
    ["Dolittle Tenants Configuration"] = 166,
    ["Dolittle Topology"] = 168,
    ...
    ["Drush site aliases"] = 172,
    ["Embrace Config Schema"] = 583,
    ["Error pages"] = 181,
    Esquio = 179,
    ["Estuary Flow Catalog Schema"] = 562,
    ["Expo SDK"] = 184,
    ["F-Droid Data metadata"] = 189,
    ["Facets - FSDL - Application"] = 187,
    ["Fossa configuration file"] = 194,
    ["Fossa's fossa-deps file"] = 195,
    ["Foundry VTT - Manifest"] = 192,
    ["Foundry VTT - Template"] = 193,
    ["Foxx Manifest"] = 45,
    ["GatewayCore API Gateway"] = 198,
    ["GeoJSON.json latest"] = 560,
    GherKing = 564,
    ["GitHub Action"] = 202,
    ["GitHub Funding"] = 203,
    ["GitHub Issue Template configuration"] = 205,
    ["GitHub Workflow"] = 206,
    ["GitHub Workflow Template Properties"] = 207,
    ["GitHub issue forms"] = 204,
    GitVersion = 201,
    ["Gitpod Configuration"] = 209,
    ["Global Privacy Control"] = 199,
    ["Google Cloud Workflows"] = 129,
    Goreleaser = 212,
    ["Goreleaser Pro"] = 213,
    ["Gradle Build Cache Node"] = 519,
    ["Gradle Enterprise"] = 518,
    ["Grafana 5.x Dashboard"] = 214,
    ["GraphQL Code Generator"] = 217,
    ["GraphQL Config"] = 216,
    ["GraphQL Mesh"] = 215,
    ["Grunt JSHint task"] = 221,
    ["Grunt Watch task"] = 222,
    ["Grunt base task"] = 223,
    ["Grunt clean task"] = 219,
    ["Grunt copy task"] = 218,
    ["Grunt cssmin task"] = 220,
    HEMTT = 491,
    Hadolint = 503,
    ["Hardware Sentry Configuration"] = 576,
    Hayson = 225,
    ["Haystack Pipeline"] = 226,
    ["Hazelcast 5 Configuration"] = 227,
    ["Helm Chart.lock"] = 106,
    ["Helm Chart.yaml"] = 105,
    Hugo = 554,
    ["Istanbul Schema"] = 579,
    ["JDownloader2 crawler multi-rule schema"] = 243,
    ["JDownloader2 crawler single-rule schema"] = 242,
    ["JFrog File Spec"] = 244,
    ["JFrog Pipelines YML DSL"] = 585,
    ["JSON Document Transform"] = 252,
    ["JSON Feed"] = 253,
    ["JSON Resume"] = 364,
    ["JSON Schema Draft 2020-12"] = 470,
    ["JSON Schema Draft 4"] = 467,
    ["JSON Schema Draft 7"] = 468,
    ["JSON Schema Draft 8"] = 469,
    ["JSON schema for CodeShip Pro services configuration files"] = 115,
    ["JSON schema for CodeShip Pro steps configuration files"] = 116,
    ["JSON schema for Codecov configuration files"] = 114,
    ["JSON-API"] = 251,
    ["JSON-e templates"] = 527,
    ["JSON-stat 2.0"] = 464,
    JSONPatch = 255,
    Jasmine = 238,
    Jekyll = 239,
    ["Jenkins X Pipelines"] = 240,
    ["Jenkins X Requirements"] = 241,
    ["Jovo Language Models"] = 245,
    ["KSP-AVC"] = 465,
    ["KSP-CKAN"] = 466,
    ["Keycloak REST API"] = 587,
    ["Knative Functions - func.yaml"] = 196,
    ["KoDE/CI build.yaml"] = 581,
    ["Kong DBLess Schema"] = 582,
    KrakenD = 258,
    ["LinkML Metamodel"] = 269,
    Liquibase = 533,
    ["Liquibase Flow File"] = 534,
    Markdownlint = 537,
    ["MegaLinter configuration"] = 273,
    ["MegaLinter descriptor"] = 274,
    ["Meltano plugin discovery definition"] = 276,
    ["Meltano project definition"] = 275,
    ["Microsoft Band Web Tile"] = 277,
    ["Minecraft Data Pack Advancement"] = 279,
    ["Minecraft Data Pack Biome"] = 280,
    ["Minecraft Data Pack Configured Carver"] = 281,
    ["Minecraft Data Pack Dimension"] = 283,
    ["Minecraft Data Pack Dimension Type"] = 282,
    ["Minecraft Data Pack Item Modifier"] = 284,
    ["Minecraft Data Pack Loot Table"] = 285,
    ["Minecraft Data Pack Metadata"] = 286,
    ["Minecraft Data Pack Predicate"] = 287,
    ["Minecraft Data Pack Recipe"] = 288,
    ["Minecraft Data Pack Template Pool"] = 289,
    ["Minecraft Resourcepack Sounds"] = 290,
    ["MongoDB Atlas Search Index Definition Schema"] = 580,
    ["Monika Configuration Schema"] = 578,
    ["Motif config"] = 487,
    ["Netin Diagnostic System Template"] = 542,
    ["Netlify config schema"] = 295,
    ["Nightwatch.js"] = 296,
    ["OSS Review Toolkit configuration"] = 319,
    ["OSS Review Toolkit curation"] = 320,
    ["OSS Review Toolkit package configuration"] = 321,
    ["OSS Review Toolkit repository configuration"] = 322,
    ["OSS Review Toolkit resolutions"] = 323,
    Opctl = 490,
    ["OpenWeather Current Weather API"] = 526,
    ["OpenWeather Road Risk API"] = 525,
    ["Ory Hydra configuration"] = 231,
    ["Ory Keto configuration"] = 260,
    ["Ory Kratos configuration"] = 318,
    ["Ory Oathkeeper configuration"] = 309,
    ["Outblocks App configuration"] = 316,
    ["Outblocks database table"] = 317,
    ["Outblocks project configuration"] = 315,
    Packer = 326,
    ["Pipeline component"] = 535,
    ["PocketMine plugin.yml"] = 330,
    Pterodactyl = 575,
    ["Pull Request Labeler"] = 353,
    PyProject = 357,
    Qodana = 551,
    ["Quali Torque Blueprint Spec 2"] = 573,
    ["QueryFirst config file"] = 590,
    ["RKE Cluster Configuration JSON Schema"] = 532,
    ["RKE Cluster Configuration YAML Schema"] = 531,
    Ray = 502,
    ["Read the Docs"] = 356,
    ["Red-DiscordBot Cog"] = 358,
    ["Red-DiscordBot Cog Repo"] = 359,
    Renovate = 365,
    ["Replit schema"] = 362,
    RoadRunner = 366,
    ["Rust toolchain"] = 368,
    ["SIL Kit Participant Configuration"] = 393,
    SWADL = 413,
    ["Sapphire CLI Config"] = 369,
    ["SauceCTL Configuration"] = 539,
    ["Schema Catalog"] = 382,
    ["Scoop manifest"] = 387,
    ["Semgrep Rule"] = 389,
    ["Serverless Framework Configuration"] = 546,
    ["Serverless Workflow Schema"] = 547,
    ["Settings.paf"] = 391,
    ["Shopware 6 Configuration"] = 548,
    ["Shopware CLI Extension Store Configuration"] = 549,
    ["Shopware CLI Project Store Configuration"] = 550,
    Solidarity = 397,
    ["Solution filters"] = 398,
    ["Source Maps v3"] = 399,
    SpecIF = 400,
    ["Sponge Mixin configuration"] = 401,
    ["StackHawk Scanner Configuration"] = 545,
    Stale = 405,
    Starship = 406,
    ["Statamic Blueprint"] = 407,
    ["StrmPrivacy batch job configuration file"] = 586,
    ["Stryker Mutator"] = 410,
    ["StyleCop Analyzers Configuration"] = 411,
    ["Swagger API 2.0"] = 414,
    TSON = 434,
    ["Talisman configuration"] = 415,
    ["Taskfile YAML Schema"] = 528,
    Taurus = 416,
    ["TestEnvironment.json"] = 423,
    Tikibase = 419,
    ["Traefik v2"] = 426,
    ["Traefik v2 File Provider"] = 427,
    Turborepo = 424,
    Tye = 552,
    ["UI5 Manifest"] = 440,
    ["UTAM Page Object"] = 442,
    ["Ubuntu Server Autoinstall"] = 438,
    ["Uniswap Token List"] = 511,
    Updatecli = 559,
    Uplift = 589,
    ["User Journey Map YAML Schema"] = 530,
    V2Ray = 563,
    ["VSCode Code Snippets"] = 118,
    ["VSIX CLI publishing"] = 455,
    ["Vela Pipeline Configuration"] = 445,
    Vercel = 117,
    ["Web App Manifest"] = 460,
    ["Web types"] = 463,
    WebExtensions = 459,
    ["Webman package recipe"] = 569,
    ["Windows Package Manager Installer Manifest"] = 508,
    ["Windows Package Manager Locale Manifest"] = 509,
    ["Windows Package Manager Singleton Manifest"] = 507,
    ["Woodpecker pipeline config"] = 541,
    ["Xstate Machine Schema"] = 557,
    ["Yippee-Ki-JSON configuration YML"] = 513,
    ["angular.json"] = 10,
    ...
    ["cloud-sdk-pipeline-config-schema"] = 127,
    ["cloudbuild.json"] = 128,
    cloudify = 111,
    codemagic = 113,
    ["coffeelint.json"] = 134,
    comet = 523,
    ["commands.json"] = 121,
    ["compile_commands.json"] = 120,
    ["compilerconfig.json"] = 119,
    ["component-detection-manifest.json"] = 137,
    ["component.json"] = 136,
    ["composer.json"] = 135,
    ["config.json"] = 138,
    ["contentmanifest.json"] = 126,
    ["contribute.json"] = 139,
    ["cosmos.config.json"] = 123,
    ["crowdin.yml"] = 140,
    cspell = 143,
    ["cypress.json"] = 141,
    ["datalogic-scan2deploy-android"] = 149,
    ["datalogic-scan2deploy-ce"] = 150,
    ["debugsettings.json"] = 151,
    ["dependabot-v2.json"] = 154,
    ["dependabot.json"] = 153,
    ["deployed-cli"] = 556,
    ["detekt.yml"] = 156,
    devinit = 515,
    ["devspace.yaml"] = 577,
    ["docfx.json"] = 160,
    ["docker-compose.yml"] = 514,
    ["docker-seq schema"] = 159,
    ["dockerd.json"] = 158,
    ["dotnet Release Index manifest"] = 169,
    ["dotnetcli.host.json"] = 170,
    ["drone.json"] = 171,
    ["dss-2.0.0.json"] = 173,
    ["dvc.yaml"] = 174,
    ["ecosystem.json"] = 176,
    eksctl = 177,
    ["electron-builder configuration file."] = 182,
    ["epr-manifest.json"] = 180,
    ["evcc.yaml"] = 183,
    ["ezd schema"] = 185,
    ["fabric.mod.json"] = 188,
    ["first-timers-bot"] = 191,
    ["fly.io Schema"] = 46,
    fulibWorkflows = 540,
    ["function.json"] = 197,
    ["geojson.json"] = 200,
    ["gitlab-ci"] = 208,
    ["global.json"] = 210,
    ["golangci-lint Configuration"] = 211,
    ["haxelib.json"] = 224,
    helmfile = 504,
    ["host-meta.json"] = 229,
    ["host.json"] = 228,
    ...
    huskyrc = 482,
    ["ide.host.json"] = 232,
    ["imageoptimizer.json"] = 233,
    ["importmap.json"] = 235,
    ["ioBroker JSON UI"] = 236,
    ["ioBroker Package manifest"] = 237,
    ["ize.toml"] = 588,
    ["jsconfig.json"] = 256,
    ["jscpd Configuration Schema"] = 574,
    jsdoc = 501,
    ["k3d.yaml"] = 257,
    ["kustomization.yaml"] = 261,
    ["label-commenter-config.yml"] = 262,
    ["launchsettings.json"] = 263,
    ["lerna.json"] = 264,
    ["lgtm.yml"] = 265,
    ["libman.json"] = 266,
    ["license-report-config.json"] = 267,
    ["linkinator.config.json"] = 268,
    ["local.settings.json"] = 270,
    ["localazy.json"] = 271,
    ["lsdlschema.json"] = 272,
    ["markdown-lint-check"] = 538,
    mboats = 544,
    ["mimetypes.json"] = 278,
    ["mirrord-schema"] = 484,
    ["mta.yaml"] = 485,
    ["mtad.yaml"] = 486,
    ["mycode.json"] = 293,
    ["napari plugin manifest"] = 294,
    neoload = 496,
    ["nest-cli"] = 299,
    ["ninjs (News in JSON) 1.3"] = 298,
    ["ninjs (News in JSON) 2.0"] = 297,
    ["nlu.json"] = 300,
    ["nodemon.json"] = 302,
    ["noodl.schema.json"] = 543,
    now = 492,
    ["npm-badges"] = 304,
    ["nswag.json"] = 307,
    ntangle = 308,
    ["nuclei-template.yaml"] = 305,
    ["nuget-project.json"] = 306,
    ["ocelot.json"] = 310,
    ["omnisharp.json"] = 311,
    ["openapi.json"] = 312,
    ["openfin.json"] = 314,
    ["openrpc.json"] = 313,
    ["package.json"] = 324,
    ["package.manifest"] = 325,
    ["pattern.json"] = 328,
    ["petstore-v1.0"] = 584,
    pgap_yaml_input_reader = 327,
    ["plagiarize-me.yaml"] = 332,
    ["plagiarize.yaml"] = 331,
    ["portman.json"] = 333,
    ["prettierrc.json"] = 338,
    ["prisma.yml"] = 339,
    ["project-1.0.0-beta3.json"] = 341,
    ["project-1.0.0-beta4.json"] = 342,
    ["project-1.0.0-beta5.json"] = 343,
    ["project-1.0.0-beta6.json"] = 344,
    ["project-1.0.0-beta8.json"] = 345,
    ["project-1.0.0-rc1.json"] = 346,
    ["project-1.0.0-rc2.json"] = 347,
    ["project.json"] = 340,
    ["prometheus.json"] = 348,
    ["prometheus.rules.json"] = 349,
    ["proxies.json"] = 350,
    ["publiccode.yml"] = 351,
    ["pubspec.yaml"] = 352,
    ["pyrseas-0.8.json"] = 355,
    ["release drafter"] = 497,
    rustfmt = 367,
    ["sarif-1.0.0.json"] = 370,
    ["sarif-2.0.0.json"] = 371,
    ["sarif-2.1.0"] = 380,
    ["sarif-2.1.0-rtm.2"] = 372,
    ["sarif-2.1.0-rtm.3"] = 374,
    ["sarif-2.1.0-rtm.4"] = 376,
    ["sarif-2.1.0-rtm.5"] = 378,
    ["sarif-external-property-file-2.1.0"] = 381,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 373,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 375,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 377,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 379,
    ["schema.org - Action"] = 383,
    ["schema.org - ContactPoint"] = 384,
    ["schema.org - Place"] = 385,
    ["schema.org - Thing"] = 386,
    ["semantic-release"] = 388,
    ["servicehub.config.json"] = 473,
    ["servicehub.service.json"] = 472,
    ["settings.job"] = 390,
    ["sfdx-hardis configuration"] = 392,
    ["size-limit configuration"] = 394,
    ["skaffold.yaml"] = 536,
    ["skyuxconfig.json"] = 395,
    snapcraft = 396,
    ["stripe-app-local.json"] = 409,
    ["stripe-app.json"] = 408,
    swcrc = 524,
    taskcat = 493,
    ["template.json"] = 417,
    ["templatsources.json"] = 418,
    ["theme.json"] = 420,
    ["tizen_workspace.json"] = 421,
    tmLanguage = 422,
    tmuxinator = 481,
    ["trunk.yaml schema"] = 428,
    ["ts-force-config.json"] = 432,
    ["tsconfig.json"] = 429,
    ["tsd.json"] = 430,
    ["tsdrc.json"] = 431,
    ["tslint.json"] = 433,
    ...
    ["vega-lite.json"] = 444,
    ["vega.json"] = 443,
    ["venvironment-basic.yaml"] = 447,
    ["venvironment.yaml"] = 446,
    ["version.json"] = 448,
    ["vim-addon-info"] = 449,
    ["vs-2017.3.host.json"] = 451,
    ["vs-nesting.json"] = 452,
    ["vsls.json"] = 450,
    ["vss-extension.json"] = 456,
    ["webhint.io"] = 570,
    ["webjobpublishsettings.json"] = 462,
    ["webjobs-list.json"] = 461,
    ["xs-app.json"] = 489,
    ["xunit.runner.json"] = 471,
    yamllint = 512,
    zuul = 498,
    ["Žinoma"] = 506
  },
