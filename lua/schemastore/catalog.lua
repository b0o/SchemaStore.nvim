...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 821,
    [".nodehawkrc"] = 512,
    [".npmpackagejsonlintrc"] = 516,
    [".omletrc"] = 997,
    [".phrase.yml"] = 578,
    [".phraseapp.yml"] = 579,
    [".pmbot.yml"] = 566,
    [".postcssrc"] = 573,
    [".powerpages-web-template-manifest"] = 575,
    [".pre-commit-config.yml"] = 576,
    [".pre-commit-hooks.yml"] = 577,
    [".putout.json"] = 606,
    [".rehyperc"] = 629,
    [".remarkrc"] = 633,
    [".sprite files"] = 701,
    ...
    ["A micro editor config"] = 464,
    ABCInventoryModuleData = 18,
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1041,
    ["API Builder"] = 856,
    ["AVA Configuration"] = 918,
    ["AWS AppConfig Feature Flags-v1"] = 49,
    ["AWS CDK cdk.json"] = 214,
    ["AWS CloudFormation"] = 215,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 216,
    ["AWS SAM CLI Samconfig"] = 217,
    ["Adobe UXP Manifest"] = 980,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1069,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 890,
    ["All Contributors configuration file"] = 943,
    ["Ansible Argument Specs"] = 347,
    ["Ansible Collection Galaxy"] = 354,
    ["Ansible Execution Environment"] = 344,
    ["Ansible Inventory"] = 353,
    ["Ansible Meta"] = 345,
    ["Ansible Meta Runtime"] = 346,
    ["Ansible Navigator Configuration"] = 356,
    ["Ansible Playbook"] = 351,
    ["Ansible Requirements"] = 348,
    ["Ansible Rulebook"] = 352,
    ["Ansible Tasks File"] = 350,
    ["Ansible Vars File"] = 349,
    ["Ansible-lint Configuration"] = 355,
    Any = 1006,
    ["AnyWork Automation Configuration"] = 9,
    ["App config Spotify Backstage"] = 25,
    ["Application Accelerator"] = 6,
    ["Application list for a WinUtil"] = 1023,
    ArchitectFX = 1028,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure Pipelines"] = 77,
    ["Azure Static Web Apps CLI configuration file"] = 705,
    ["Azure Static Web Apps configuration file"] = 704,
    ["BOSH CPI Config"] = 101,
    ["BOSH Deploy Config"] = 102,
    ["BX CI"] = 121,
    ["Bashly (bashly.yml)"] = 947,
    ["Bashly Settings (bashly-settings.yml)"] = 948,
    ["Better Code Hub"] = 860,
    ["Better Scripts"] = 122,
    Bigconfig = 94,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1034,
    BizTalkServerApplicationSchema = 828,
    Bleep = 123,
    ["Block Protocol Metadata"] = 120,
    ["Boyka Framework"] = 103,
    Briefcase = 834,
    ["Build Info"] = 111,
    Buildkite = 113,
    ["Bukkit plugin.yml"] = 112,
    ["BungeeCord plugin.yml"] = 118,
    ["Butane Config"] = 903,
    C4InterFlow = 1049,
    ["CDK Environment Manager, concrete environment configuration"] = 1072,
    ["CDK Environment Manager, concrete environments definition"] = 1071,
    ["CDK Environment Manager, environment definition"] = 1070,
    ["CGS Card Game Specification (cgs.json)"] = 985,
    ["CICS TS region tagging"] = 912,
    ["CICS TS resource import"] = 913,
    ["CICS TS resource model"] = 914,
    ["CICS TS resource overrides"] = 915,
    ["CMake Presets"] = 124,
    ["CNC Codes"] = 143,
    ["CRS WAF test file"] = 1013,
    ["CRS WAF test platform overrides file"] = 1014,
    ["CSS Comb (.csscomb.json)"] = 242,
    ["CSS Lint (.csslintrc)"] = 243,
    ["CSpell (cspell.json)"] = 241,
    ["CVE Record Format"] = 150,
    CWL = 991,
    ["Cache Warmup config"] = 125,
    ["Calqulus pipeline"] = 126,
    ["Camel YAML DSL"] = 127,
    ["Cannon TOML"] = 128,
    Carafe = 129,
    ["Cargo Make"] = 131,
    ["Cargo Manifest"] = 130,
    ["Catalog Info Backstage"] = 132,
    ["Chamaleon environment"] = 1038,
    ["Chamaleon properties"] = 1039,
    ["Chamaleon template"] = 1037,
    Changesets = 226,
    Charmcraft = 133,
    Cheatsheets = 900,
    ["Chrome Extension"] = 207,
    ["Chromia Model"] = 134,
    ["Chromia Seeder Module Config"] = 136,
    ["Chromia Seeder Root Config"] = 135,
    ["Cinnamon Spice info.json"] = 69,
    ["CircleCI config.yml"] = 183,
    ["Citation File Format"] = 228,
    CityJSON = 138,
    ["Clawject config"] = 149,
    ["Cloud Foundry Application Manifest"] = 996,
    ["Cloud Run Spec v1"] = 1018,
    ["CloudCannon Configuration"] = 73,
    ["CloudEvents specification"] = 139,
    ["Code Climate"] = 184,
    CodeCV = 71,
    CodeRabbit = 70,
    ["CodeShip Pro services configuration files"] = 196,
    ["CodeShip Pro steps configuration files"] = 197,
    ["Codecov configuration files"] = 195,
    CodifyCLI = 72,
    Codux = 193,
    ["Cog config file"] = 144,
    ["Commandbox Box.json"] = 145,
    ["Commandbox Server.json"] = 146,
    ["Common Catalog Data"] = 205,
    ["Common Package Specification"] = 147,
    Concord = 1012,
    ["Configu .cfgu files"] = 1001,
    ["Configu .configu file"] = 1002,
    Conjure = 142,
    ["Container Structure Test"] = 842,
    Containerlab = 869,
    ["Contextive Glossary"] = 1064,
    Convex = 141,
    ["Crowdsec collection config"] = 236,
    ["Crowdsec parser config"] = 237,
    ["Crowdsec scenario config"] = 238,
    ["CumulusCI Config"] = 148,
    ["Custom Machinery Machine"] = 986,
    ["Custom Machinery Recipe"] = 987,
    ["Cycle Stack File"] = 151,
    CycloneDX = 152,
    ["DWP Exchange - catalogue entry"] = 285,
    ["DWP Exchange - gateway"] = 283,
    ["DWP Exchange - meta"] = 284,
    ["Dart Build Config (dart-build.json)"] = 244,
    ["Dart Test Config (dart-test.json)"] = 245,
    ["DashLord Configuration"] = 246,
    ["Data Contract Specification"] = 247,
    ["Data Product Specification"] = 248,
    ["DataYoga Connections"] = 153,
    ["DataYoga Job"] = 154,
    ["Databricks Asset Bundles"] = 964,
    ["Datadog Service Definition"] = 437,
    ["Datadog Software Catalog"] = 438,
    ["Datahub Ingestion Recipe"] = 919,
    ["Dein Config"] = 160,
    ["Deno Config (deno.json)"] = 254,
    ["Dependency cruiser"] = 161,
    ["DeployStack Configuration"] = 162,
    ["Deployer Recipe"] = 257,
    ["Deta Spacefile"] = 163,
    ["Detekt Config (detekt.yml)"] = 258,
    ["Devbox Config"] = 164,
    ["Devbox Plugin"] = 165,
    Devfile = 282,
    DipDup = 1015,
    ["Discord Webhook"] = 259,
    ["DocFx Config (docfx.json)"] = 263,
    Dofigen = 264,
    ["Dolittle Artifacts"] = 265,
    ["Dolittle Bounded Context Configuration"] = 266,
    ["Dolittle Event Horizons Configuration"] = 267,
    ["Dolittle Resources Configuration"] = 268,
    ["Dolittle Server Configuration"] = 269,
    ["Dolittle Tenant Map Configuration"] = 271,
    ["Dolittle Tenants Configuration"] = 270,
    ["Dolittle Topology"] = 272,
    ["DonateCaseBetterCasino menu"] = 1042,
    ["Drupal Breakpoints"] = 166,
    ["Drupal Config"] = 178,
    ["Drupal Info"] = 167,
    ["Drupal Layouts"] = 168,
    ["Drupal Libraries"] = 169,
    ["Drupal Links Action"] = 170,
    ["Drupal Links Contextual"] = 171,
    ["Drupal Links Menu"] = 172,
    ["Drupal Links Task"] = 173,
    ["Drupal Migration"] = 174,
    ["Drupal Permissions"] = 175,
    ["Drupal Recipe"] = 176,
    ["Drupal Routing"] = 177,
    ["Drupal Services"] = 179,
    ["Drush site aliases"] = 278,
    ["Dynamic Bash Aliases (.aliases)"] = 955,
    ["EAS config"] = 302,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 944,
    ["EasyVCR .NET"] = 303,
    ["Eidolon Resource"] = 1029,
    ["Elgato Stream Deck"] = 288,
    Elm = 1017,
    ["Embrace Config"] = 930,
    Endurica = 968,
    ["Enterprise Contract Policy Spec"] = 289,
    ["Erda Pipeline"] = 993,
    ["Erda Runtime"] = 994,
    Esquio = 291,
    ["Estuary Flow Catalog"] = 909,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 295,
    ["EveryVoice TTS Toolkit Data Configuration"] = 296,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 300,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 299,
    ["EveryVoice TTS Toolkit Text Configuration"] = 297,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 298,
    ["Expo SDK"] = 301,
    ["F-Droid Data metadata"] = 307,
    ["FasterCI Configuration"] = 78,
    FiQuS = 311,
    Firebase = 309,
    ["FlexGet Config"] = 312,
    ["Flow.json Configurations"] = 990,
    ["Fossa configuration file"] = 319,
    ["Fossa's fossa-deps file"] = 320,
    ["Foundry VTT - Base package Manifest"] = 314,
    ["Foundry VTT - Module Manifest"] = 315,
    ["Foundry VTT - System Data Template"] = 318,
    ["Foundry VTT - System Manifest"] = 316,
    ["Foundry VTT - World Manifest"] = 317,
    ["Foxx Manifest"] = 79,
    ["Freifunk.de Community API"] = 82,
    ["Frogbot Config"] = 83,
    ["G2P Mapping Configuration"] = 325,
    ["GCP Blueprint Metadata"] = 328,
    Gaspar = 326,
    ["GatewayCore API Gateway"] = 327,
    ["GeoJSON.json latest"] = 907,
    GherKing = 911,
    ["GitHub Action"] = 333,
    ["GitHub Actions typing"] = 1025,
    ["GitHub Discussion"] = 334,
    ["GitHub Funding"] = 335,
    ["GitHub Issue Template configuration"] = 336,
    ["GitHub Issue Template forms"] = 337,
    ["GitHub Workflow"] = 338,
    ["GitHub Workflow Template Properties"] = 339,
    ["GitHub automatically generated release notes configuration"] = 340,
    ["GitLab Agent for Kubernetes configuration"] = 982,
    GitVersion = 330,
    ["Gitea Issue Template configuration"] = 331,
    ["Gitea Issue Template forms"] = 332,
    ["Gitpod Automations"] = 342,
    ["Gitpod Configuration"] = 343,
    ["GlazeWM settings"] = 984,
    ["Global Privacy Control"] = 329,
    Goblet = 963,
    ["Golangci-lint Configuration"] = 358,
    ["Golangci-lint Custom Plugins Configuration"] = 359,
    ["Google Chrome Related Website Sets"] = 310,
    ["Google Cloud Workflows"] = 213,
    ["Google Digital Assetlinks"] = 1065,
    Goreleaser = 361,
    ["Goreleaser Pro"] = 362,
    Goss = 363,
    ["Gradle Build Cache Node"] = 858,
    ["Gradle Enterprise"] = 857,
    ["Grafana 5.x Dashboard"] = 364,
    ["GraphQL Code Generator"] = 368,
    ["GraphQL Config"] = 367,
    ["GraphQL Mesh"] = 366,
    ["Grunt JSHint task"] = 372,
    ["Grunt Watch task"] = 373,
    ["Grunt base task"] = 374,
    ["Grunt clean task"] = 370,
    ["Grunt copy task"] = 369,
    ["Grunt cssmin task"] = 371,
    HEMTT = 824,
    Hadolint = 838,
    Hammerkit = 868,
    ["Hardware Sentry Configuration"] = 923,
    Hatch = 839,
    Hayson = 376,
    ["Haystack Pipeline"] = 377,
    ["Hazelcast 5 Configuration"] = 378,
    ["Helm Chart.lock"] = 181,
    ["Helm Chart.yaml"] = 180,
    ["Helm Unittest Test Suite"] = 182,
    ["Home Assistant Integration Manifest"] = 379,
    ["Homer dashboard configuration"] = 380,
    Hugo = 899,
    ["Hugo Theme"] = 898,
    ["Hyperfoil benchmark configuration"] = 386,
    ["IBM Zapp document"] = 387,
    ["IBM zCodeFormatSettings"] = 388,
    ["IMG Catapult PSP"] = 393,
    ["IVMS101 by CODE Protocol"] = 983,
    Infrahub = 395,
    Istanbul = 926,
    ["JDownloader2 crawler multi-rules"] = 405,
    ["JDownloader2 crawler single-rules"] = 404,
    ["JFrog Applications Config"] = 406,
    ["JFrog File Spec"] = 407,
    ["JFrog Pipelines YML DSL"] = 932,
    ["JMeter DSL cli config"] = 408,
    JReleaser = 410,
    ["JSON Document Transform"] = 418,
    ["JSON Feed"] = 419,
    ["JSON Resume"] = 638,
    ["JSON Schema Draft 2020-12"] = 807,
    ["JSON Schema Draft 4"] = 804,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 965,
    ["JSON Schema Draft 7"] = 805,
    ["JSON Schema Draft 7 (unofficial strict)"] = 966,
    ["JSON Schema Draft 8 (2019-09)"] = 806,
    ["JSON-API"] = 417,
    ["JSON-e templates"] = 865,
    ["JSON-stat 2.0"] = 800,
    JSONPatch = 421,
    ["JSR Package Config (jsr.json)"] = 411,
    Jasmine = 399,
    Jekyll = 400,
    ["Jenkins X Pipelines"] = 401,
    ["Jenkins X Requirements"] = 402,
    Jest = 403,
    ["Jovo Language Models"] = 409,
    ["KIMMDY config file"] = 432,
    ["KODE/CI build.yaml"] = 928,
    ["KSP-AVC"] = 801,
    ["KSP-CKAN"] = 802,
    ["KSP-NetKAN"] = 803,
    KSY = 995,
    KSail = 323,
    ["Karakum configuration file"] = 321,
    Kas = 424,
    ["Kestra flow file"] = 433,
    ["Keycloak REST API"] = 935,
    ["Knative Functions - func.yaml"] = 322,
    ["Kometa (nightly) config file"] = 435,
    ["Kometa config file"] = 434,
    ["Kong DBLess config"] = 929,
    KrakenD = 436,
    ["Kubri Configuration"] = 442,
    LOOBin = 457,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 218,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 219,
    ["Landing Zone Accelerator on AWS - Global Config"] = 220,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 221,
    ["Landing Zone Accelerator on AWS - Network Config"] = 222,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 223,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 224,
    ["Landing Zone Accelerator on AWS - Security Config"] = 225,
    ["Language configuration"] = 1005,
    Lefthook = 446,
    ["Liferay client-extension.yaml"] = 453,
    ["LinkML Metamodel"] = 455,
    Liquibase = 874,
    ["Liquibase Flow File"] = 875,
    ["Lively Properties"] = 456,
    ["Lobe AI Agent"] = 75,
    Loki = 76,
    ["MLOS Configs"] = 495,
    ["MS2Rescore Configuration"] = 498,
    ["Madness (madness.yml)"] = 946,
    ["MapEHR Mapping"] = 463,
    Markdownlint = 878,
    ["Mason Registry"] = 881,
    ["MegaLinter configuration"] = 465,
    ["MegaLinter descriptor"] = 466,
    Melange = 973,
    ["Meltano project definition"] = 467,
    ["Mergify Configuration"] = 499,
    ["Metadata for a Bazel module"] = 468,
    ["Metadata for a Cinnamon spice"] = 1021,
    ["Metatype Configuration"] = 469,
    ["MetricsHub Configuration"] = 470,
    ["MetricsHub Connector Configuration"] = 471,
    ["Micro Editor Syntax"] = 956,
    ["Microsoft Band Web Tile"] = 472,
    ["Microsoft RulesEngine workflow rules"] = 1009,
    ["Microsoft RulesEngine workflow rules list"] = 1010,
    ["Minecraft Custom Main Menu Mod"] = 974,
    ["Minecraft Data Pack Advancement"] = 474,
    ["Minecraft Data Pack Biome"] = 475,
    ["Minecraft Data Pack Configured Carver"] = 476,
    ["Minecraft Data Pack Damage Type"] = 477,
    ["Minecraft Data Pack Dimension"] = 479,
    ["Minecraft Data Pack Dimension Type"] = 478,
    ["Minecraft Data Pack Item Modifier"] = 480,
    ["Minecraft Data Pack Loot Table"] = 481,
    ["Minecraft Data Pack Metadata"] = 482,
    ["Minecraft Data Pack Predicate"] = 483,
    ["Minecraft Data Pack Recipe"] = 484,
    ["Minecraft Data Pack Tag"] = 485,
    ["Minecraft Data Pack Template Pool"] = 486,
    ["Minecraft Data Pack Trim Material"] = 491,
    ["Minecraft Data Pack Trim Pattern"] = 492,
    ["Minecraft Resource Pack Lang"] = 487,
    ["Minecraft Resource Pack Particle"] = 488,
    ["Minecraft Resource Pack Texture Mcmeta"] = 490,
    ["Minecraft Resourcepack Sounds"] = 489,
    ["Monade CLI Stack Configuration"] = 502,
    ["MongoDB Atlas Search Index Definition"] = 927,
    ["Monika Configuration"] = 925,
    ["Monoweave Configuration"] = 497,
    ["Motif config"] = 820,
    MultiQC = 1058,
    ["NOX Framework (Service)"] = 515,
    ["Netin Diagnostic System Template"] = 885,
    ["Netlify config"] = 505,
    ["Network-as-Code Data Model"] = 506,
    ["Nightwatch.js"] = 508,
    ["Node.js configuration"] = 825,
    ["NueJS configuration file"] = 520,
    ["Nuitka.yaml"] = 988,
    ["Nullstone config"] = 522,
    ["ONe's changelog entry"] = 536,
    ["ONe's service descriptor"] = 535,
    ["ORT Server repository environment configuration"] = 543,
    ["OSCAL Assessment Plan (AP)"] = 545,
    ["OSCAL Assessment Results (AR)"] = 546,
    ["OSCAL Catalog"] = 547,
    ["OSCAL Component Definition (CDef)"] = 548,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 549,
    ["OSCAL Profile"] = 550,
    ["OSCAL System Security Plan (SSP)"] = 551,
    ["OSS Review Toolkit configuration"] = 552,
    ["OSS Review Toolkit curation"] = 553,
    ["OSS Review Toolkit package configuration"] = 554,
    ["OSS Review Toolkit repository configuration"] = 555,
    ["OSS Review Toolkit resolutions"] = 556,
    ["October CMS columns"] = 526,
    ["October CMS fields"] = 527,
    Okteto = 528,
    Opctl = 823,
    ...
    ["OpenWeather Road Risk API"] = 863,
    ["Ory Hydra configuration"] = 385,
    ["Ory Keto configuration"] = 439,
    ["Ory Kratos configuration"] = 544,
    ["Ory Oathkeeper configuration"] = 524,
    ["Outblocks App configuration"] = 541,
    ["Outblocks database table"] = 542,
    ["Outblocks project configuration"] = 540,
    PDM = 562,
    Packer = 559,
    Pantsbuild = 942,
    ["Paper paper-plugin.yml"] = 560,
    ["Pipeline component"] = 876,
    ["Platform.sh application"] = 2,
    ["Platform.sh routes"] = 3,
    ["Platform.sh services"] = 4,
    ["Plex Prerolls"] = 570,
    ["PocketMine plugin.yml"] = 567,
    ["Postman collection"] = 574,
    ["Preset list for a WinUtil"] = 1024,
    ["ProActions AI-Kit Configuration"] = 583,
    ["ProActions AI-Kit Configuration for Menus"] = 585,
    ["ProActions AI-Kit Configuration for Sections"] = 587,
    ["ProActions AI-Kit Configuration for Services"] = 584,
    ["ProActions AI-Kit Configuration for Steps"] = 588,
    ["ProActions AI-Kit Configuration for Templates"] = 586,
    ["Problem object RFC9457"] = 971,
    ["Problem package generators"] = 589,
    Pterodactyl = 922,
    ["Pull Request Labeler"] = 605,
    Pulumi = 613,
    ["PyGTA Config"] = 609,
    PyProject = 614,
    Pylock = 1066,
    Pyright = 615,
    ["Python script metadata"] = 1060,
    Qgoda = 617,
    Qodana = 895,
    ["Qt Creator workspace file"] = 1003,
    ["Quali Torque Blueprint Spec 2"] = 920,
    ["QueryFirst config file"] = 938,
    ["RKE Cluster Configuration JSON"] = 873,
    ["RKE Cluster Configuration YAML"] = 872,
    RadioHound = 608,
    Railway = 618,
    ["Rancher Fleet"] = 610,
    ["Rattler-build"] = 619,
    Ray = 837,
    ["Read the Docs"] = 612,
    ["Red-DiscordBot Cog"] = 626,
    ["Red-DiscordBot Cog Repo"] = 627,
    ["Red-DiscordBot Trivia"] = 628,
    ["Render Blueprints"] = 871,
    RenderCV = 640,
    Renovate = 639,
    ["Replit config"] = 634,
    Restate = 1053,
    RoadRunner = 642,
    ["Roo Coder Custom Modes"] = 644,
    ["Rudder techniques"] = 978,
    Ruff = 636,
    ["Rust Project"] = 637,
    ["Rust toolchain"] = 647,
    ["SDMX data message"] = 673,
    ["SDMX metadata message"] = 672,
    ["SDMX structure message"] = 671,
    ["SIL Kit Participant Configuration"] = 683,
    ["SIL Kit Registry Configuration"] = 684,
    ["SPDX 2.3"] = 702,
    SWADL = 716,
    ["Safebox Config"] = 933,
    ["Sapphire CLI Config"] = 650,
    ["SauceCTL Configuration"] = 882,
    ["Schema Catalog"] = 665,
    ["Scoop manifest"] = 670,
    ["Semantic Data Fabric (SDF) file"] = 674,
    ["Semgrep Rule"] = 676,
    ["Serenity Code Generator (Sergen)"] = 677,
    ["Serverless Framework Configuration"] = 889,
    ["Serverless Workflow"] = 891,
    ["Settings for a Cinnamon spice"] = 1020,
    ["Settings.paf"] = 679,
    ["Shopware 6 Configuration"] = 892,
    ["Shopware CLI Extension Store Configuration"] = 893,
    ["Shopware CLI Project Store Configuration"] = 894,
    ["Sigma Detection Rule"] = 681,
    ["Sigrid scope configuration file"] = 682,
    ["SkyPilot Task JSON"] = 979,
    ["Slack app manifest"] = 686,
    Solidarity = 691,
    ["Solution filters"] = 692,
    ["Source Maps v3"] = 693,
    Sourcery = 694,
    ["Speakeasy Generation Config File"] = 698,
    ["Speakeasy Lint Configuration File"] = 695,
    ["Speakeasy Test Generation Configuration File"] = 696,
    ["Speakeasy Workflow File"] = 697,
    SpecIF = 699,
    ["Sponge Mixin configuration"] = 700,
    StackBlitz = 706,
    ["StackHawk Scanner Configuration"] = 888,
    Stale = 707,
    ["Starlake Data Pipeline"] = 861,
    Starship = 708,
    ["Statamic Blueprint"] = 709,
    ["Stella configuration file"] = 710,
    ["Stryker Mutator"] = 713,
    ["StyleCop Analyzers Configuration"] = 714,
    ["Stylelint (.stylelintrc)"] = 715,
    ["Stylua Config"] = 1067,
    ["Sublime Syntax"] = 934,
    ["Subsquid squid manifest"] = 981,
    ["Swagger API 2.0"] = 717,
    ["Synadia Connect Component"] = 718,
    TSON = 752,
    TSTyche = 753,
    ["Tab data for a LinUtil"] = 1027,
    ["Tab list for a LinUtil"] = 1026,
    Tach = 719,
    ["Tach Domain"] = 720,
    Talhelper = 722,
    ["Talisman configuration"] = 723,
    Taplo = 1068,
    ["Taskfile config"] = 866,
    Taurus = 724,
    Tauticord = 725,
    Telefonistka = 1054,
    ["TestEnvironment.json"] = 735,
    ["TextMate Grammar"] = 734,
    ["Tier.run pricing.json"] = 728,
    Tikibase = 729,
    Tombi = 733,
    ["Traefik v2"] = 738,
    ["Traefik v2 File Provider"] = 739,
    ["Traefik v3"] = 740,
    ["Traefik v3 File Provider"] = 741,
    ["Travis CI (.travis.yml)"] = 737,
    Trident = 1051,
    ["TrueScript for *.tscript files"] = 744,
    ["Tugboat QA config.yml"] = 1048,
    TunnelHub = 969,
    Turborepo = 736,
    Tycho = 1016,
    Tye = 896,
    ["Tyk Gateway - Open Source v5.7+"] = 1059,
    ["Typst Manifest"] = 758,
    ["UET BuildConfig.json"] = 939,
    ["UI5 Manifest"] = 764,
    ["UNCORS configuration"] = 768,
    ["UTAM Page Object"] = 767,
    ["Ubuntu Server Autoinstall"] = 762,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1052,
    ["Uniswap Token List"] = 849,
    ["Universal Schedule Format"] = 769,
    ["Unreal Engine Uplugin"] = 940,
    ["Unreal Engine Uproject"] = 941,
    ["Updatecli Compose"] = 904,
    ["Updatecli Policy Manifest"] = 905,
    ["Updatecli Policy Metadata"] = 906,
    Uplift = 937,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 870,
    V2Ray = 910,
    ["VSCode Code Snippets"] = 201,
    ["VSIX CLI publishing"] = 789,
    Vector = 771,
    ["Vela Pipeline Configuration"] = 774,
    Vercel = 200,
    ["Version Bumper config"] = 779,
    ["Viash Component Config"] = 1056,
    ["Viash Package Config"] = 1057,
    Visivo = 967,
    Wake = 1050,
    ["Waku Config"] = 1030,
    ["Web App Manifest"] = 795,
    ["Web types"] = 798,
    WebExtensions = 794,
    ["Webman package recipe"] = 916,
    ["Windows Package Manager Installer Manifest"] = 845,
    ["Windows Package Manager Locale Manifest"] = 846,
    ["Windows Package Manager Singleton Manifest"] = 844,
    Winutil = 847,
    ["WireMock stub mapping"] = 1033,
    ["Woodpecker pipeline config"] = 884,
    ["Wrangler CLI"] = 799,
    ["Xstate Machine"] = 902,
    ["Yandex Workflow Language"] = 1022,
    ["Yarn Config (.yarnrc.yml)"] = 859,
    ["Yippee-Ki-JSON configuration YML"] = 851,
    ["YouTrack App"] = 1019,
    ["Zerops.io config"] = 1007,
    ["Zerops.io import"] = 1008,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 972,
    ...
    ["behat.yml"] = 104,
    ["bigquery-table"] = 93,
    ["bioimageio resource description"] = 989,
    ...
    ["bozr.suite.json"] = 106,
    bpkg = 950,
    ["browser.i18n.json"] = 107,
    ["browsh configuration"] = 108,
    bucklescript = 109,
    ["buf.gen.yaml"] = 66,
    ["buf.plugin.yaml"] = 67,
    ["buf.work.yaml"] = 68,
    ...
    ["build-changelog"] = 110,
    ["bun.lock"] = 115,
    ["bundleconfig.json"] = 116,
    ["bunfig.toml"] = 117,
    ["ccmod.json"] = 1031,
    changelogging = 1000,
    ["chisel-slices.json"] = 227,
    ["chrome-extension-locales-messages.json"] = 208,
    ["chutzpah.json"] = 209,
    cibuildwheel = 137,
    ["clang-format (.clang-format)"] = 908,
    ["clang-tidy"] = 188,
    clangd = 187,
    clib = 189,
    ["cloud-init: cloud-config userdata"] = 191,
    ["cloud-sdk-pipeline-configuration"] = 211,
    ["cloudbuild.json"] = 212,
    cloudify = 190,
    codemagic = 192,
    ["coffeelint.json"] = 229,
    ["commands.json"] = 204,
    ["commitlint (.commitlintrc)"] = 848,
    ["committed.toml"] = 230,
    ["compile_commands.json"] = 203,
    ["compilerconfig.json"] = 202,
    ["completely.yml"] = 945,
    ["component-detection-manifest.json"] = 233,
    ["component.json"] = 232,
    ["composer.json"] = 231,
    ["conda-forge"] = 140,
    ["config.yaml"] = 611,
    ["contentmanifest.json"] = 210,
    ["contribute.json"] = 234,
    ["cosmos.config.json"] = 206,
    ["crowdin.yml"] = 235,
    ["ctfd-setup configuration file"] = 1040,
    ["custom-elements.json"] = 959,
    ["cypress.json"] = 239,
    ["datalogic-scan2deploy-android"] = 249,
    ["datalogic-scan2deploy-ce"] = 250,
    ["dbt Dependencies"] = 155,
    ["dbt Packages"] = 157,
    ["dbt Project"] = 156,
    ["dbt Selectors"] = 158,
    ["dbt YAML files"] = 159,
    ["ddev-global"] = 251,
    ["ddev-project"] = 252,
    ["debugsettings.json"] = 253,
    ["dependabot-v2.json"] = 256,
    ["dependabot.json"] = 255,
    ["deployed-cli"] = 901,
    ["devcontainer.json"] = 194,
    devinit = 853,
    ["devspace.yaml"] = 924,
    djlint = 854,
    ["docker bake"] = 261,
    ["docker sequencer"] = 262,
    ["docker-compose.yml"] = 852,
    ["dockerd.json"] = 260,
    ["dotnet Release Index manifest"] = 273,
    ["dotnet-tools.json"] = 274,
    ["dotnetcli.host.json"] = 275,
    ["dprint.json"] = 276,
    ["drone.json"] = 277,
    ["dss-2.0.0.json"] = 279,
    ["dstack configuration"] = 280,
    ["dtool dataset metadata"] = 1035,
    ["dvc.yaml"] = 281,
    ["ecosystem.json"] = 286,
    eksctl = 287,
    ["electron-builder configuration file"] = 293,
    ["epr-manifest.json"] = 292,
    ["evcc.yaml"] = 294,
    ["ezd task runner"] = 304,
    ["fabric.mod.json"] = 306,
    ["first-timers-bot"] = 313,
    ["flagd flag configuration"] = 80,
    ["fly.io Configuration"] = 81,
    fulibWorkflows = 883,
    ["function.json"] = 324,
    ["gRPC API Gateway & OpenAPI Config"] = 7,
    ["gematik health care insurance list"] = 1046,
    ["gematik health care patient list"] = 1043,
    ["gematik health care provider institution list"] = 1045,
    ["gematik health care provider list"] = 1044,
    ["gematik tiger test environment configuration"] = 1047,
    ["gitlab-ci"] = 341,
    ["global.json"] = 357,
    ["go-feature-flag Flag Configuration"] = 360,
    ["haxelib.json"] = 375,
    helmfile = 840,
    helmwave = 841,
    ["host-meta.json"] = 382,
    ...
    ["ide.host.json"] = 389,
    ["ifstate.conf"] = 390,
    ["imageoptimizer.json"] = 391,
    ["importmap.json"] = 394,
    ["ioBroker Configuration"] = 396,
    ["ioBroker JSON UI"] = 397,
    ["ioBroker Package manifest"] = 398,
    ["ize.toml"] = 936,
    ["jsconfig.json"] = 422,
    ["jscpd Configuration"] = 921,
    jsdoc = 836,
    ["k3d.yaml"] = 423,
    ["k9s aliases.yaml"] = 425,
    ["k9s cluster-config.yaml"] = 427,
    ["k9s config.yaml"] = 426,
    ["k9s hotkeys.yaml"] = 428,
    ["k9s plugins.yaml"] = 429,
    ["k9s skin.yaml"] = 430,
    ["k9s views.yaml"] = 431,
    ["kontinuous-config.yaml"] = 441,
    ["kontinuous-values.yaml"] = 440,
    ["kustomization.yaml"] = 443,
    ["label-commenter-config.yml"] = 444,
    ["latexindent configuration"] = 74,
    ["launchsettings.json"] = 445,
    lazydocker = 958,
    lazygit = 957,
    ["lego.json"] = 447,
    ["lerna.json"] = 448,
    ["lgtm.yml"] = 449,
    ["liblab.config.json"] = 450,
    ["libman.json"] = 451,
    ["license-report-config.json"] = 452,
    ["linkinator.config.json"] = 454,
    ["lint-staged (.lintstagedrc)"] = 815,
    ["local.settings.json"] = 459,
    ["localazy.json"] = 460,
    ["lotus.yaml"] = 458,
    ["lsdlschema.json"] = 461,
    ["markdown-link-check"] = 879,
    maturin = 880,
    mboats = 887,
    ["micro-settings.json"] = 951,
    ["mimetypes.json"] = 473,
    ["mirrord config"] = 816,
    mise = 817,
    ["mkdocs.yml"] = 493,
    ["monospace.yml"] = 496,
    ["moon.yml"] = 1032,
    ["mprocs Configuration file"] = 1004,
    ["mrdocs.yml"] = 494,
    ["mta.yaml"] = 818,
    ["mtad.yaml"] = 819,
    ["mycode.json"] = 503,
    nFPM = 507,
    ["napari plugin manifest"] = 504,
    neoload = 831,
    ["nest-cli"] = 510,
    ["ninjs (News in JSON)"] = 509,
    ["nitro.json"] = 830,
    ["nixd configuration"] = 977,
    ["nlu.json"] = 511,
    ["nodemon.json"] = 513,
    ["noodl config"] = 886,
    ["notebook.mod.json"] = 514,
    now = 826,
    ["npm-badges"] = 517,
    ["nswag.json"] = 521,
    ntangle = 523,
    ["nuclei-template.yaml"] = 518,
    ["nuget-project.json"] = 519,
    ["ocelot.json"] = 525,
    ["omnisharp.json"] = 529,
    ["openapi.json"] = 530,
    ["openfin.json"] = 537,
    ...
    ["ops.yaml"] = 534,
    ["package.json"] = 557,
    ["package.manifest"] = 558,
    ["partial-black.json"] = 105,
    ["pathfinder.yml"] = 561,
    ["pattern.json"] = 564,
    ["petstore-v1.0"] = 931,
    pgap_yaml_input_reader = 563,
    ["pixi.toml"] = 565,
    ["plagiarize-me.yaml"] = 569,
    ["plagiarize.yaml"] = 568,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1036,
    ["podbard.yaml"] = 571,
    ["portman.json"] = 572,
    ["prefect.toml"] = 580,
    ["prettierrc.json"] = 581,
    ["prisma.yml"] = 582,
    ["project-1.0.0-beta3.json"] = 591,
    ["project-1.0.0-beta4.json"] = 592,
    ["project-1.0.0-beta5.json"] = 593,
    ["project-1.0.0-beta6.json"] = 594,
    ["project-1.0.0-beta8.json"] = 595,
    ["project-1.0.0-rc1.json"] = 596,
    ["project-1.0.0-rc2.json"] = 597,
    ["project.json"] = 590,
    ["project.owasp.yaml"] = 598,
    ["prometheus.json"] = 599,
    ["prometheus.rules.json"] = 600,
    ["prometheus.rules.test.json"] = 601,
    ["proxies.json"] = 602,
    ["publiccode.yml"] = 603,
    ["pubspec.yaml"] = 604,
    ["pyrseas-0.8.json"] = 607,
    pytest = 616,
    ["quilt.mod.json"] = 952,
    ["rc3 auth"] = 620,
    ["rc3 collection"] = 621,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 832,
    ["release-please-config.json"] = 630,
    ["release-please-manifest.json"] = 631,
    ["release-plz.toml"] = 632,
    ["renv.lock"] = 641,
    ["rivet.json"] = 976,
    ["rivet.yaml (legacy)"] = 975,
    rockcraft = 643,
    runny = 645,
    rustfmt = 646,
    sake = 1062,
    samt = 648,
    samtrc = 649,
    ["sarif-1.0.0.json"] = 651,
    ["sarif-2.0.0.json"] = 652,
    ["sarif-2.1.0"] = 662,
    ["sarif-2.1.0-rtm.2"] = 653,
    ["sarif-2.1.0-rtm.3"] = 655,
    ["sarif-2.1.0-rtm.4"] = 657,
    ["sarif-2.1.0-rtm.5"] = 659,
    ["sarif-2.1.0-rtm.6"] = 660,
    ["sarif-external-property-file-2.1.0"] = 663,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 654,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 656,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 658,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 661,
    ["scalingo.json configuration"] = 664,
    ["schema.org - Action"] = 666,
    ["schema.org - ContactPoint"] = 667,
    ["schema.org - Place"] = 668,
    ["schema.org - Thing"] = 669,
    ["secrethub.yml"] = 954,
    ["semantic-release"] = 675,
    ["servicehub.config.json"] = 810,
    ["servicehub.service.json"] = 809,
    ["settings.job"] = 678,
    ["sfdx-hardis configuration"] = 680,
    ["shard.yml"] = 992,
    ["size-limit configuration"] = 685,
    ["skaffold.yaml"] = 877,
    ["skyuxconfig.json"] = 687,
    snapcraft = 688,
    ["snowflake-config"] = 689,
    ["snowflake-connections"] = 690,
    ["spicepod.yaml"] = 1011,
    ["sqlc configuration"] = 703,
    ["stripe-app-local.json"] = 712,
    ["stripe-app.json"] = 711,
    swcrc = 862,
    ["task.json"] = 721,
    taskcat = 827,
    ["template.json"] = 726,
    ["templatsources.json"] = 727,
    ["theme.json"] = 730,
    ["tizen_workspace.json"] = 731,
    tldr = 732,
    ["tm_devices configuration file"] = 1073,
    tmuxinator = 813,
    ["transcend.yml"] = 742,
    ["tree-sitter grammar.json"] = 365,
    ["trime.yaml"] = 743,
    ["trunk.yaml"] = 745,
    ["ts-force-config.json"] = 750,
    ["tsconfig.json"] = 746,
    ["tsd.json"] = 747,
    ["tsdoc.json"] = 748,
    ["tsdrc.json"] = 749,
    ...
    v8r = 793,
    vcluster = 998,
    ["vcpkg configuration file"] = 199,
    ["vcpkg manifest file"] = 198,
    ["vega-lite.json"] = 773,
    ["vega.json"] = 772,
    ["venvironment-basic.yaml"] = 776,
    ["venvironment.yaml"] = 775,
    ["venvplus-basic.yaml"] = 778,
    ["venvplus.yaml"] = 777,
    version = 1055,
    ["version.json"] = 780,
    ["vhwdebugger-binding.yaml"] = 782,
    ["vim-addon-info"] = 783,
    ["vs-2017.3.host.json"] = 785,
    ["vs-nesting.json"] = 786,
    ["vsls.json"] = 784,
    ["vss-extension.json"] = 790,
    vtcfg = 1061,
    ["vtesttree.yaml"] = 791,
    ["vtestunit.yaml"] = 792,
    ["warp-keysets.json"] = 960,
    ["warp-themes.json"] = 961,
    ["warp-workflows.json"] = 962,
    ["webhint.io"] = 917,
    ["webjobpublishsettings.json"] = 797,
    ["webjobs-list.json"] = 796,
    ["well-known-fursona"] = 999,
    ["xs-app.json"] = 822,
    ["xunit.runner.json"] = 808,
    yamllint = 850,
    zuul = 833,
    ["Žinoma"] = 843
  },
