...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1111,
    [".nodehawkrc"] = 716,
    [".npmpackagejsonlintrc"] = 721,
    [".omletrc"] = 1292,
    [".phrase.yml"] = 803,
    [".phraseapp.yml"] = 804,
    [".pmbot.yml"] = 788,
    [".postcssrc"] = 797,
    [".powerpages-web-template-manifest"] = 799,
    [".pre-commit-config.yml"] = 800,
    [".pre-commit-hooks.yml"] = 801,
    [".putout.json"] = 837,
    [".rehyperc"] = 862,
    [".remarkrc"] = 866,
    [".sprite files"] = 968,
    ...
    AIConfig = 50,
    ["AMX Muse Program Descriptor"] = 1341,
    ["API Builder"] = 1147,
    ["AVA Configuration"] = 1211,
    ...
    ["AWS Copilot Manifest"] = 1380,
    ["AWS SAM CLI Samconfig"] = 327,
    Acton = 1434,
    ["Adobe UXP Manifest"] = 1274,
    ["Aerleon Network & Service Definitions"] = 30,
    ["Aerleon Policy"] = 31,
    ["Agent Permission Policy"] = 1420,
    ["Agent Run Metrics"] = 32,
    ["AgentCore CLI"] = 1421,
    ["AgentCtl MCP"] = 1423,
    ["AgentCtl config"] = 1422,
    ["AgentCtl permissions"] = 1424,
    AgentLoopKit = 1425,
    Aider = 1370,
    Air = 34,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1391,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1390,
    ["Airlock Microgateway"] = 51,
    ["Alacritty Configuration"] = 1183,
    ["AlgoVoi Compliance Receipt v1"] = 19,
    ["All Contributors configuration file"] = 1237,
    ["Amazon S3 bucket CORS"] = 21,
    Ameba = 1,
    Anodizer = 524,
    ["Ansible Argument Specs"] = 506,
    ["Ansible Collection Galaxy"] = 513,
    ["Ansible Execution Environment"] = 503,
    ["Ansible Inventory"] = 512,
    ["Ansible Meta"] = 504,
    ["Ansible Meta Runtime"] = 505,
    ["Ansible Navigator Configuration"] = 515,
    ["Ansible Playbook"] = 510,
    ["Ansible Requirements"] = 507,
    ["Ansible Rulebook"] = 511,
    ["Ansible Tasks File"] = 509,
    ["Ansible Vars File"] = 508,
    ["Ansible-lint Configuration"] = 514,
    Any = 1302,
    ...
    ["Application list for a WinUtil"] = 1320,
    ["ArchSmith diagram IR"] = 1463,
    ArchitectFX = 1325,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1389,
    ["Azure IoT Operations connector metadata"] = 1386,
    ...
    ["Azure Pipelines"] = 139,
    ["Azure Static Web Apps CLI configuration file"] = 972,
    ["Azure Static Web Apps configuration file"] = 971,
    BMML = 1408,
    ["BOSH BPM Config"] = 167,
    ["BOSH CPI Config"] = 168,
    ...
    Badness = 151,
    ["Barba-CV"] = 105,
    ["Bashly (bashly.yml)"] = 1241,
    ["Bashly Settings (bashly-settings.yml)"] = 1242,
    Bento = 1407,
    ["Better Code Hub"] = 1152,
    ["Better Scripts"] = 194,
    Bigconfig = 160,
    ["Biome Formatter Config"] = 106,
    ["Bitmovin Encoding Template"] = 1334,
    BizTalkServerApplicationSchema = 1118,
    Bleep = 195,
    ["Block Protocol Metadata"] = 192,
    ["Bluebricks blueprint config"] = 1413,
    ["Boyka Framework"] = 173,
    ...
    ["Butane Config"] = 1196,
    C4InterFlow = 1349,
    ["CDK Environment Manager, concrete environment configuration"] = 1373,
    ["CDK Environment Manager, concrete environments definition"] = 1372,
    ["CDK Environment Manager, environment definition"] = 1371,
    ["CGS Card Game Specification (cgs.json)"] = 1279,
    ["CICS TS region tagging"] = 1205,
    ["CICS TS resource import"] = 1206,
    ["CICS TS resource model"] = 1207,
    ["CICS TS resource overrides"] = 1208,
    ["CMake Presets"] = 196,
    ["CNC Codes"] = 223,
    ["CRS WAF test file"] = 1309,
    ["CRS WAF test platform overrides file"] = 1310,
    ...
    ["Caido Proxy Configuration"] = 1449,
    ...
    ["Chamaleon environment"] = 1338,
    ["Chamaleon properties"] = 1339,
    ["Chamaleon template"] = 1337,
    Changepacks = 1400,
    Changesets = 336,
    Changie = 208,
    Charmcraft = 209,
    ...
    ["Claude Code Launch Preview"] = 1462,
    ["Claude Code Plugin Manifest"] = 231,
    ["Claude Code Plugin Marketplace"] = 232,
    ["Claude Code Settings"] = 233,
    ["Clawject config"] = 229,
    ["Cloud Foundry Application Manifest"] = 1291,
    ["Cloud Run Spec v1"] = 1315,
    ...
    Concord = 1308,
    ["Configu .cfgu files"] = 1296,
    ["Configu .configu file"] = 1297,
    Conjure = 222,
    ["Container Structure Test"] = 1132,
    Containerlab = 1161,
    ["Context Passport"] = 2,
    ["Context Reasoning Format (CRF)"] = 220,
    ["Contextive Glossary"] = 1365,
    ContractGuard = 1162,
    Convex = 221,
    ...
    ["Cursor Agent Environment"] = 1418,
    ["Custom Machinery Machine"] = 1280,
    ["Custom Machinery Recipe"] = 1281,
    ...
    ["DataYoga Job"] = 250,
    ["Datadog Continuous Testing"] = 614,
    ["Datadog Service Definition"] = 615,
    ["Datadog Software Catalog"] = 616,
    ["Datahub Ingestion Recipe"] = 1212,
    ["Debian Upstream Metadata file"] = 257,
    DebtLens = 258,
    ["Decision Reasoning Format (DRF)"] = 259,
    ["Deck config"] = 260,
    ["Declarative Automation Bundles"] = 1258,
    ...
    ["DonateCaseBetterCasino menu"] = 1342,
    ["Draugr Saga"] = 368,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1249,
    ["EAS config"] = 443,
    ["ECA - Editor Code Assistant"] = 406,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1238,
    ["ESLint Suppressions"] = 448,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1385,
    ["EasyVCR .NET"] = 445,
    ["Eidolon Resource"] = 1326,
    ...
    ["Envelope Team Definition"] = 1433,
    ["Envilder Map File"] = 411,
    ["Erda Pipeline"] = 1287,
    ["Erda Runtime"] = 1288,
    ["Espanso config.yml"] = 1411,
    ["Espanso match.yml"] = 1410,
    Esquio = 431,
    ["Estuary Flow Catalog"] = 1202,
    ["Ethereum ERC1155"] = 1427,
    ["Ethereum ERC721"] = 1426,
    ...
    ["Evolving Resolutive Process notation"] = 1387,
    ["Expo SDK"] = 442,
    ...
    ["Frogbot Config"] = 147,
    ["G2P Mapping Configuration"] = 471,
    GAMA = 472,
    ["GCP Blueprint Metadata"] = 475,
    Gaspar = 473,
    ["GatewayCore API Gateway"] = 474,
    ["Gemini CLI settings"] = 476,
    ["GeoJSON.json latest"] = 1200,
    GherKing = 1204,
    ["GitHub Action"] = 486,
    ["GitHub Actions typing"] = 1322,
    ["GitHub CLI configuration"] = 487,
    ["GitHub CLI hosts"] = 488,
    ["GitHub Discussion"] = 489,
    ["GitHub Funding"] = 491,
    ["GitHub Issue Template configuration"] = 492,
    ["GitHub Issue Template forms"] = 493,
    ["GitHub Pages Jekyll"] = 494,
    ["GitHub Prompt"] = 490,
    ["GitHub Secret Scanning"] = 495,
    ["GitHub Workflow"] = 496,
    ["GitHub Workflow Template Properties"] = 497,
    ["GitHub automatically generated release notes configuration"] = 498,
    ["GitLab Agent for Kubernetes configuration"] = 1276,
    ["GitLab Duo Workflow"] = 500,
    GitResume = 502,
    GitVersion = 479,
    ["Gitea Issue Template configuration"] = 482,
    ["Gitea Issue Template forms"] = 483,
    Gitleaks = 480,
    ["Gitpod Configuration"] = 501,
    ["Glamour style"] = 477,
    ["GlazeWM settings"] = 1278,
    ["Global Privacy Control"] = 478,
    Goblet = 1257,
    ["Golangci-lint Configuration"] = 517,
    ["Golangci-lint Custom Plugins Configuration"] = 518,
    ["Google Chrome Related Website Sets"] = 453,
    ["Google Cloud Workflows"] = 323,
    ["Google Digital Assetlinks"] = 1366,
    Goreleaser = 522,
    ["Goreleaser Pro"] = 523,
    Goss = 525,
    ["Gradle Build Cache Node"] = 1150,
    ["Gradle Enterprise"] = 1149,
    ["Grafana 5.x Dashboard"] = 526,
    ["GraphQL Code Generator"] = 531,
    ["GraphQL Config"] = 530,
    ["GraphQL Mesh"] = 529,
    ["GroovyLint configuration"] = 532,
    ["Grunt JSHint task"] = 536,
    ["Grunt Watch task"] = 537,
    ["Grunt base task"] = 538,
    ["Grunt clean task"] = 534,
    ["Grunt copy task"] = 533,
    ["Grunt cssmin task"] = 535,
    HEMTT = 1114,
    ["HULL - Helm Uniform Layer Library"] = 1467,
    Hadolint = 1128,
    Hammerkit = 1160,
    ["Hardware Sentry Configuration"] = 1216,
    ["Hashgraph Online Skill Manifest"] = 9,
    ["HashiCorp Vault"] = 539,
    Hatch = 1129,
    Hayson = 542,
    ["Haystack Pipeline"] = 543,
    ["Hazelcast 5 Configuration"] = 544,
    ["Hecate Input Schema"] = 1377,
    ["Helm Chart.lock"] = 286,
    ["Helm Chart.yaml"] = 285,
    ["Helm Unittest Test Suite"] = 287,
    ["Heloisa Assistant Plugins Marketplace"] = 1460,
    ["Hex file"] = 288,
    ["Home Assistant Integration Manifest"] = 546,
    ["Homer dashboard configuration"] = 547,
    ["Hoverfly Simulation"] = 552,
    Hugo = 1192,
    ["Hugo Theme"] = 1191,
    ["Hulak Configuration"] = 555,
    ["Hyperfoil benchmark configuration"] = 554,
    ["IBM Zapp document"] = 556,
    ["IBM zCodeFormatSettings"] = 557,
    ["IMG Catapult PSP"] = 562,
    ["IVMS101 by CODE Protocol"] = 1277,
    ["Infinispan Configuration"] = 564,
    ["Infinispan Server Configuration"] = 565,
    Infrahub = 566,
    Istanbul = 1220,
    ["JDownloader2 crawler multi-rules"] = 580,
    ["JDownloader2 crawler single-rules"] = 579,
    ["JFrog Applications Config"] = 581,
    ["JFrog File Spec"] = 582,
    ["JFrog Pipelines YML DSL"] = 1226,
    ["JMeter DSL cli config"] = 583,
    JReleaser = 586,
    ["JSON Document Transform"] = 594,
    ["JSON Feed"] = 595,
    ["JSON Resume"] = 875,
    ["JSON Schema Draft 2020-12"] = 1093,
    ["JSON Schema Draft 4"] = 1090,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1259,
    ["JSON Schema Draft 7"] = 1091,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1260,
    ["JSON Schema Draft 8 (2019-09)"] = 1092,
    ["JSON-API"] = 593,
    ["JSON-e templates"] = 1157,
    ["JSON-stat 2.0"] = 1086,
    JSONPatch = 597,
    ["JSR Package Config (jsr.json)"] = 587,
    Jarl = 1393,
    Jasmine = 574,
    Jekyll = 575,
    ["Jenkins X Pipelines"] = 576,
    ["Jenkins X Requirements"] = 577,
    Jest = 578,
    Jocker = 584,
    ["Jovo Language Models"] = 585,
    Jsontron = 598,
    ["Jujutsu (jj) VCS config"] = 1379,
    ["KIMMDY config file"] = 609,
    ["KODE/CI build.yaml"] = 1222,
    ["KSP-AVC"] = 1087,
    ["KSP-CKAN"] = 1088,
    ["KSP-NetKAN"] = 1089,
    KSY = 1289,
    ...
    Kas = 601,
    ["Kestra flow file"] = 610,
    ["Keycloak REST API"] = 1229,
    ["Knative Functions - func.yaml"] = 466,
    Knip = 467,
    ["Knip JSONC"] = 468,
    ["Knowledge Unit"] = 618,
    ["Kometa (nightly) config file"] = 612,
    ["Kometa config file"] = 611,
    ["Kong DBLess config"] = 1223,
    KrakenD = 613,
    ["Kubri Configuration"] = 621,
    LOOBin = 642,
    ["Lake configuration file"] = 1382,
    ...
    ["Lando (landofile)"] = 132,
    ["LangGraph Platform configuration"] = 1301,
    ["Language configuration"] = 1300,
    Lefthook = 628,
    ["Liferay client-extension.yaml"] = 635,
    ["LinkML Metamodel"] = 637,
    ["LiquiLens Evidence Carrier Reference v1"] = 639,
    ["LiquiLens Evidence Carrier v1"] = 638,
    Liquibase = 1167,
    ["Liquibase Flow File"] = 1168,
    ["Lively Properties"] = 641,
    ["Lobe AI Agent"] = 134,
    Loki = 135,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 685,
    ["MS2Rescore Configuration"] = 693,
    ["MSTest testconfig.json"] = 694,
    ["Madge configuration"] = 648,
    ["Madness (madness.yml)"] = 1240,
    ["Mado configuration"] = 649,
    ["Maestro Flow"] = 650,
    ["Mail Servers Configuration"] = 1414,
    ["MapEHR Mapping"] = 651,
    Markdownlint = 1171,
    ["Mason Registry"] = 1174,
    ["MegaLinter Custom Flavor"] = 654,
    ["MegaLinter configuration"] = 653,
    ["MegaLinter descriptor"] = 655,
    Melange = 1267,
    ["Meltano project definition"] = 656,
    ["Mergify Configuration"] = 695,
    ["Mermaid config"] = 4,
    ["Metadata for a Bazel module"] = 657,
    ["Metadata for a Cinnamon spice"] = 1318,
    ["Metatype Configuration"] = 658,
    ["MetricsHub Configuration"] = 659,
    ["MetricsHub Connector Configuration"] = 660,
    ["Micro Editor Syntax"] = 1250,
    ["Microsoft Band Web Tile"] = 661,
    ["Microsoft RulesEngine workflow rules"] = 1305,
    ["Microsoft RulesEngine workflow rules list"] = 1306,
    ["Minecraft Custom Main Menu Mod"] = 1268,
    ["Minecraft Data Pack Advancement"] = 663,
    ["Minecraft Data Pack Biome"] = 664,
    ["Minecraft Data Pack Configured Carver"] = 665,
    ["Minecraft Data Pack Damage Type"] = 666,
    ["Minecraft Data Pack Dimension"] = 668,
    ["Minecraft Data Pack Dimension Type"] = 667,
    ["Minecraft Data Pack Item Modifier"] = 669,
    ["Minecraft Data Pack Loot Table"] = 670,
    ["Minecraft Data Pack Metadata"] = 671,
    ["Minecraft Data Pack Predicate"] = 672,
    ["Minecraft Data Pack Recipe"] = 673,
    ["Minecraft Data Pack Tag"] = 674,
    ["Minecraft Data Pack Template Pool"] = 675,
    ["Minecraft Data Pack Trim Material"] = 680,
    ["Minecraft Data Pack Trim Pattern"] = 681,
    ["Minecraft Resource Pack Lang"] = 676,
    ["Minecraft Resource Pack Particle"] = 677,
    ["Minecraft Resource Pack Texture Mcmeta"] = 679,
    ["Minecraft Resourcepack Sounds"] = 678,
    ["MockServer Expectation"] = 687,
    ["MockServer Expectations"] = 688,
    ModuleAssembler = 683,
    ["Monade CLI Stack Configuration"] = 698,
    ["MongoDB Atlas Search Index Definition"] = 1221,
    ["Monika Configuration"] = 1219,
    ["Monoweave Configuration"] = 692,
    ["Motif config"] = 1110,
    MultiQC = 1359,
    ["NOX Framework (Service)"] = 720,
    ["Netin Diagnostic System Template"] = 1178,
    ["Netlify config"] = 701,
    ["Network-as-Code Data Model"] = 702,
    ["Next Gen UI Agent A2A Server Configuration"] = 703,
    ["Next Gen UI Agent Configuration"] = 705,
    ["Next Gen UI Agent MCP Server Configuration"] = 704,
    ["Nightwatch.js"] = 712,
    ["Nika workflow"] = 717,
    ["Node.js configuration"] = 1115,
    ["NueJS configuration file"] = 725,
    ["Nuitka Package Config"] = 1282,
    ["Nullstone config"] = 727,
    ["ODGS Data Rules"] = 734,
    ["ODGS Ontology Graph"] = 735,
    ["ODGS Standard Metrics"] = 733,
    ["OKF Graph"] = 1461,
    ["ONe's changelog entry"] = 749,
    ["ONe's service descriptor"] = 748,
    ["ORT Server repository environment configuration"] = 760,
    ["OSCAL Assessment Plan (AP)"] = 762,
    ["OSCAL Assessment Results (AR)"] = 763,
    ["OSCAL Catalog"] = 764,
    ["OSCAL Component Definition (CDef)"] = 765,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 766,
    ["OSCAL Profile"] = 767,
    ["OSCAL System Security Plan (SSP)"] = 768,
    ["OSS Review Toolkit configuration"] = 769,
    ["OSS Review Toolkit curation"] = 770,
    ["OSS Review Toolkit package configuration"] = 771,
    ["OSS Review Toolkit project package manager definition"] = 772,
    ["OSS Review Toolkit repository configuration"] = 773,
    ["OSS Review Toolkit resolutions"] = 774,
    ["October CMS columns"] = 731,
    ["October CMS fields"] = 732,
    ["Oh My Posh"] = 737,
    Okteto = 738,
    ["Ona Tasks and Services"] = 740,
    Opctl = 1113,
    ["Open Data Contract Standard (ODCS)"] = 753,
    ["Open Data Product Standard (ODPS)"] = 754,
    ["Open Know-How"] = 1364,
    ["Open Pentest Format"] = 755,
    OpenDecree = 1431,
    ["OpenDecree Configuration"] = 1432,
    ["OpenRewrite Resource"] = 751,
    OpenSRM = 756,
    OpenStatus = 1375,
    ["OpenTelemetry Declarative Configuration"] = 752,
    ["OpenUtau character yaml"] = 745,
    ["OpenUtau ustx"] = 746,
    ["OpenWeather Current Weather API"] = 1156,
    ["OpenWeather Road Risk API"] = 1155,
    ["Ory Hydra configuration"] = 553,
    ["Ory Keto configuration"] = 617,
    ["Ory Kratos configuration"] = 761,
    ["Ory Oathkeeper configuration"] = 729,
    ["Outblocks App configuration"] = 758,
    ["Outblocks database table"] = 759,
    ["Outblocks project configuration"] = 757,
    PDM = 782,
    POPxf = 794,
    ["POPxf Correlations"] = 795,
    ["PRML manifest"] = 802,
    Packer = 778,
    PactSpec = 779,
    Panache = 780,
    Pantsbuild = 1236,
    ["Paper paper-plugin.yml"] = 781,
    ["Pipeline component"] = 1169,
    ["Platform.sh application"] = 15,
    ["Platform.sh routes"] = 16,
    ["Platform.sh services"] = 17,
    ["Plex Prerolls"] = 792,
    ["PocketMine plugin.yml"] = 789,
    ["Podman Desktop Extension"] = 1451,
    ["Postman collection"] = 798,
    ["Power Pages Configuration"] = 1376,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1321,
    ["ProActions AI-Kit Configuration"] = 810,
    ["ProActions AI-Kit Configuration for Menus"] = 812,
    ["ProActions AI-Kit Configuration for Sections"] = 814,
    ["ProActions AI-Kit Configuration for Services"] = 811,
    ["ProActions AI-Kit Configuration for Steps"] = 815,
    ["ProActions AI-Kit Configuration for Templates"] = 813,
    ["Problem object RFC9457"] = 1265,
    ["Problem package format"] = 816,
    ["Problem package generators"] = 817,
    ["Problem package submissions"] = 818,
    ["Problem package test group metadata"] = 819,
    ["Production delivery manifest"] = 1469,
    Pterodactyl = 1215,
    ["Pull Request Labeler"] = 836,
    Pulumi = 844,
    ["PyGTA Config"] = 840,
    PyProject = 845,
    Pylock = 1367,
    Pyright = 846,
    ["Python script metadata"] = 1361,
    ["QType AI DSL"] = 849,
    Qgoda = 848,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1443,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1441,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1447,
    ["Qlik Talend Cloud Pipeline - Project"] = 1439,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1442,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1444,
    ["Qlik Talend Cloud Pipeline - Task"] = 1440,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1446,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1445,
    Qodana = 1188,
    ["Qt Creator workspace file"] = 1298,
    ["Quali Torque Blueprint Spec 2"] = 1213,
    ["QueryFirst config file"] = 1232,
    ["QuikRun Configuration"] = 1448,
    ["Qwen Code Settings"] = 1428,
    ["RKE Cluster Configuration JSON"] = 1166,
    ["RKE Cluster Configuration YAML"] = 1165,
    RadioHound = 839,
    ["Raid Profile"] = 1429,
    ["Raid Repo Configuration"] = 1430,
    Railpack = 851,
    Railway = 850,
    ["Rancher Fleet"] = 841,
    ["Rattler-build"] = 852,
    Ray = 1127,
    ["Read the Docs"] = 843,
    ["Red-DiscordBot Cog"] = 859,
    ["Red-DiscordBot Cog Repo"] = 860,
    ["Red-DiscordBot Trivia"] = 861,
    ["Releasaurus Config"] = 12,
    ReleaseKit = 11,
    ["Render Blueprints"] = 1164,
    RenderCV = 879,
    Renovate = 876,
    ["Renovate global configuration"] = 877,
    ["Renovate inherited configuration"] = 878,
    ["Replit config"] = 867,
    Restate = 1354,
    ["Revel Digital Gadget Definition File"] = 1378,
    RoadRunner = 881,
    ["Robust Station Image"] = 1384,
    Rockcraft = 882,
    ["Roo Coder Custom Modes"] = 883,
    Rubocop = 872,
    ["Rudder techniques"] = 1272,
    Ruff = 873,
    ["Rust Project"] = 874,
    ["Rust toolchain"] = 888,
    ["SDMX data message"] = 915,
    ["SDMX metadata message"] = 914,
    ["SDMX structure message"] = 913,
    ["SIL Kit Participant Configuration"] = 926,
    ["SIL Kit Registry Configuration"] = 927,
    ["SPDX 2.3"] = 969,
    SWADL = 985,
    ["Safebox Config"] = 1227,
    ["Sapphire CLI Config"] = 891,
    ["SauceCTL Configuration"] = 1175,
    Scarb = 911,
    ["Schema Catalog"] = 906,
    ["Scoop manifest"] = 912,
    ["Secure SDLC Evidence Bundle"] = 916,
    ["Semantic Data Fabric (SDF) file"] = 917,
    ["Semgrep Rule"] = 919,
    ["Serenity Code Generator (Sergen)"] = 920,
    ["Serverless Framework Configuration"] = 1182,
    ["Serverless Workflow"] = 1184,
    ["Settings for a Cinnamon spice"] = 1317,
    ["Settings.paf"] = 922,
    ["Shopware 6 Configuration"] = 1185,
    ["Shopware CLI Extension Store Configuration"] = 1186,
    ["Shopware CLI Project Store Configuration"] = 1187,
    ["Sigma Detection Rule"] = 924,
    ["SigmaCV CV"] = 7,
    ["Sigrid scope configuration file"] = 925,
    ["SkyPilot Task JSON"] = 1273,
    ["Slack app manifest"] = 932,
    ["Slang Server Configuration"] = 1455,
    Snapcraft = 934,
    ["Solarxy project config"] = 937,
    Solidarity = 938,
    ["Solution filters"] = 939,
    ["Source Maps v3"] = 940,
    Sourcery = 941,
    ["Spack bootstrap.yaml"] = 942,
    ["Spack cdash.yaml"] = 943,
    ["Spack ci.yaml"] = 944,
    ["Spack compilers.yaml"] = 945,
    ["Spack concretizer.yaml"] = 946,
    ["Spack config.yaml"] = 947,
    ["Spack definitions.yaml"] = 948,
    ["Spack develop.yaml"] = 949,
    ["Spack env_vars.yaml"] = 950,
    ["Spack environment"] = 956,
    ["Spack include.yaml"] = 951,
    ["Spack mirrors.yaml"] = 952,
    ["Spack modules.yaml"] = 953,
    ["Spack packages.yaml"] = 954,
    ["Spack repos.yaml"] = 955,
    ["Spack toolchains.yaml"] = 957,
    ["Spack upstreams.yaml"] = 958,
    ["Spack view.yaml"] = 959,
    ["Speakeasy Generation Config File"] = 963,
    ["Speakeasy Lint Configuration File"] = 960,
    ["Speakeasy Test Generation Configuration File"] = 961,
    ["Speakeasy Workflow File"] = 962,
    SpecIF = 964,
    ["Specmatic Configuration"] = 965,
    ["Specpin spec file"] = 5,
    ["Sponge Mixin configuration"] = 966,
    ["Spotlight Ruleset"] = 967,
    StackBlitz = 973,
    ["StackHawk Scanner Configuration"] = 1181,
    Stale = 974,
    Starfish = 975,
    ["Starlake Data Pipeline"] = 1153,
    Starship = 976,
    ["Statamic Blueprint"] = 977,
    ["Stella configuration file"] = 978,
    ["Streamlit configuration file"] = 979,
    ["Stryker Mutator"] = 982,
    ["StyleCop Analyzers Configuration"] = 983,
    ["Stylelint (.stylelintrc)"] = 984,
    ["Stylua Config"] = 1368,
    ["Sublime Syntax"] = 1228,
    ["Subsquid squid manifest"] = 1275,
    ["Swagger API 2.0"] = 986,
    ["Symfony Routing Configuration"] = 987,
    ["Symfony Serializer Mapping"] = 988,
    ["Symfony Services Configuration"] = 989,
    ["Symfony Validation Mapping"] = 990,
    ["Synadia Connect Component"] = 991,
    TSON = 1034,
    TSTyche = 1035,
    ["TYPO3 Vendor Bundler config"] = 1041,
    ["Tab data for a LinUtil"] = 1324,
    ["Tab list for a LinUtil"] = 1323,
    Tach = 992,
    ["Tach Domain"] = 993,
    Talhelper = 995,
    ["Talisman configuration"] = 996,
    Taplo = 1369,
    ["Taskfile config"] = 1158,
    Taurus = 997,
    Tauticord = 998,
    ["Tekton Pipeline"] = 1397,
    ["Tekton PipelineRun"] = 1398,
    ["Tekton Task"] = 1395,
    ["Tekton TaskRun"] = 1396,
    Telefonistka = 1355,
    ["Terraform PowerShell provider block manifest"] = 1001,
    ["Terraform PowerShell provider data source manifest"] = 1002,
    ["Terraform PowerShell provider resource manifest"] = 1003,
    ["Terraform PowerShell provider settings"] = 1004,
    ["Terrateam config"] = 1381,
    ["Tesseract configuration"] = 1005,
    ["TestEnvironment.json"] = 1015,
    ["TextMate Grammar"] = 1014,
    Threagile = 1009,
    ["Tier.run pricing.json"] = 1006,
    Tikibase = 1007,
    Tombi = 1012,
    ["Traefik v2"] = 1018,
    ["Traefik v2 File Provider"] = 1019,
    ["Traefik v3"] = 1020,
    ["Traefik v3 File Provider"] = 1021,
    ["Travis CI (.travis.yml)"] = 1017,
    Treefmt = 528,
    Trident = 1351,
    Trivy = 1024,
    ["TrueScript for *.tscript files"] = 1025,
    ["Tugboat QA config.yml"] = 1348,
    TunnelHub = 1263,
    Turborepo = 1016,
    Tycho = 1312,
    Tye = 1189,
    ["Tyk Gateway - Open Source v5.7+"] = 1360,
    ["UET BuildConfig.json"] = 1233,
    ["UI5 Manifest"] = 1047,
    ["UNCORS configuration"] = 1052,
    ["UTAM Page Object"] = 1050,
    ["Ubuntu Server Autoinstall"] = 1045,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1352,
    ["Uniswap Token List"] = 1138,
    ["Universal Schedule Format"] = 1053,
    ["Unreal Engine Uplugin"] = 1234,
    ["Unreal Engine Uproject"] = 1235,
    ["UpCloud CLI (upctl) configuration"] = 1353,
    ["Updatecli Compose"] = 1197,
    ["Updatecli Policy Manifest"] = 1198,
    ["Updatecli Policy Metadata"] = 1199,
    Uplift = 1231,
    ["Upsun config"] = 14,
    ["User Journey Map"] = 1163,
    V2Ray = 1203,
    ["VSCode Code Snippets"] = 311,
    ["VSIX CLI publishing"] = 1073,
    Vector = 1055,
    ["Vee JSON menu output"] = 1056,
    ["Vela Pipeline Configuration"] = 1059,
    Vercel = 310,
    ["Version Bumper config"] = 1062,
    Vespertide = 1402,
    ["Vespertide Migration"] = 1403,
    ["Vespertide Model"] = 1404,
    ["Viash Component Config"] = 1357,
    ["Viash Package Config"] = 1358,
    Visivo = 1261,
    Vogi = 1067,
    ["WP-CLI"] = 1083,
    Wake = 1350,
    ["Waku Config"] = 1327,
    ["Web App Manifest"] = 1079,
    ["Web types"] = 1082,
    WebExtensions = 1078,
    ["Webman package recipe"] = 1209,
    ["Windows Package Manager Installer Manifest"] = 1135,
    ["Windows Package Manager Locale Manifest"] = 1136,
    ["Windows Package Manager Singleton Manifest"] = 1134,
    ["WireMock CLI import configuration"] = 1333,
    ["WireMock CLI local service configuration"] = 1332,
    ["WireMock message stub mapping"] = 1331,
    ["WireMock stub mapping"] = 1330,
    ["Woodpecker pipeline config"] = 1177,
    ["Wrangler CLI"] = 1084,
    ["XenForo add-on manifest"] = 1085,
    ["Xstate Machine"] = 1195,
    ["Yandex Workflow Language"] = 1319,
    ["Yarn Config (.yarnrc.yml)"] = 1151,
    ["Yippee-Ki-JSON configuration YML"] = 1142,
    ["YouTrack App"] = 1316,
    ["Zarf Package Configuration"] = 1383,
    ["Zerops import file"] = 1304,
    ["Zola Configuration"] = 1394,
    abtop = 36,
    act3 = 1435,
    actionlint = 46,
    ["aerleon.yml"] = 29,
    ...
    ["behat.yml"] = 174,
    ["bigquery-table"] = 159,
    ["bioimageio resource description"] = 1283,
    ...
    ["cargo-nextest repository configuration"] = 706,
    ["cargo-nextest user configuration"] = 707,
    ["ccmod.json"] = 1328,
    ["cfgd Config"] = 1456,
    ["cfgd ConfigSource"] = 1459,
    ["cfgd Module"] = 1457,
    ["cfgd Profile"] = 1458,
    changelogging = 1295,
    ...
    ["chutzpah.json"] = 319,
    cibuildwheel = 215,
    ["clang-format (.clang-format)"] = 1201,
    ["clang-tidy"] = 294,
    clangd = 293,
    clib = 295,
    ...
    ["crowdin.yml"] = 346,
    crucible = 350,
    ["ctfd-setup configuration file"] = 1340,
    ["custom-elements.json"] = 1253,
    ["cypress.json"] = 351,
    ["dacier.yml"] = 1438,
    ...
    ["gematik health care insurance list"] = 1346,
    ["gematik health care patient list"] = 1343,
    ["gematik health care provider institution list"] = 1345,
    ["gematik health care provider list"] = 1344,
    ["gematik tiger test environment configuration"] = 1347,
    ["gh-dash"] = 484,
    ["gha-doctor"] = 485,
    ["git-cliff"] = 481,
    ["git-town.toml"] = 1392,
    ["github-settings-as-code"] = 868,
    ["gitlab-ci"] = 499,
    ["global.json"] = 516,
    ["glslint config"] = 3,
    ["go-feature-flag Flag Configuration"] = 520,
    ["gojo.yaml"] = 521,
    gollama = 519,
    ["hassette.toml"] = 545,
    ["haxelib.json"] = 540,
    ...
    ["ide.host.json"] = 558,
    ["ifstate.yaml"] = 559,
    ["imageoptimizer.json"] = 560,
    ["importmap.json"] = 563,
    ["index.toml (packwiz)"] = 1452,
    instant_python_config = 567,
    instant_python_custom_project = 568,
    intlayer = 569,
    ["ioBroker Configuration"] = 570,
    ["ioBroker JSON UI"] = 571,
    ["ioBroker Package manifest"] = 572,
    ["ixpect.conf.yaml"] = 573,
    ["ize.toml"] = 1230,
    ["jsconfig.json"] = 599,
    ["jscpd Configuration"] = 1214,
    jsdoc = 1126,
    ["k3d.yaml"] = 600,
    ["k9s aliases.yaml"] = 602,
    ["k9s cluster-config.yaml"] = 604,
    ["k9s config.yaml"] = 603,
    ["k9s hotkeys.yaml"] = 605,
    ["k9s plugins.yaml"] = 606,
    ["k9s skin.yaml"] = 607,
    ["k9s views.yaml"] = 608,
    ["kind cluster"] = 622,
    ["kontinuous-config.yaml"] = 620,
    ["kontinuous-values.yaml"] = 619,
    ["kustomization.yaml"] = 623,
    ["label-commenter-config.yml"] = 626,
    ["latexindent configuration"] = 133,
    ["launchsettings.json"] = 627,
    lazydocker = 1252,
    lazygit = 1251,
    ["lego.json"] = 629,
    ["lerna.json"] = 630,
    ["lgtm.yml"] = 631,
    ["liblab.config.json"] = 632,
    ["libman.json"] = 633,
    ["license-report-config.json"] = 634,
    ["linkinator.config.json"] = 636,
    ["lint-staged (.lintstagedrc)"] = 1102,
    ["litertlm_manifest.json"] = 640,
    ["local.settings.json"] = 644,
    ["localazy.json"] = 645,
    ["lotus.yaml"] = 643,
    ["lsd colors"] = 137,
    ["lsd config"] = 136,
    ...
    lychee = 1101,
    ["macro.json"] = 1218,
    ["markdown-link-check"] = 1172,
    maturin = 1173,
    mboats = 1180,
    memnex = 1436,
    ["micro-settings.json"] = 1245,
    ["mimetypes.json"] = 662,
    ["mirrord config"] = 1105,
    ["misata.yaml"] = 1104,
    mise = 1106,
    ...
    ["mkdocs.yml"] = 682,
    ["mockd.yaml"] = 686,
    ["mod.pw.toml (packwiz)"] = 1453,
    ["modelparams.dev Model"] = 689,
    ["models CLI"] = 690,
    ["monospace.yml"] = 691,
    ["moon.yml"] = 1329,
    ["mprocs Configuration file"] = 1299,
    ["mrdocs.yml"] = 684,
    ["mta.yaml"] = 1108,
    ["mtad.yaml"] = 1109,
    ["mycode.json"] = 699,
    nFPM = 711,
    ["napari plugin manifest"] = 700,
    neoload = 1121,
    ["nest-cli"] = 714,
    ["nexus-rpc-gen"] = 1419,
    ["nf-core module environment.yml"] = 708,
    ["nf-core module meta.yml"] = 709,
    ["nf-core subworkflow meta.yml"] = 710,
    ["ninjs (News in JSON)"] = 713,
    ["nitro.json"] = 1120,
    ["nixd configuration"] = 1271,
    ["nlu.json"] = 715,
    ["nodemon.json"] = 718,
    ["noodl config"] = 1179,
    ["notebook.mod.json"] = 719,
    now = 1116,
    ["npm-badges"] = 722,
    ["nswag.json"] = 726,
    ntangle = 728,
    ["nuclei-template.yaml"] = 723,
    ["nuget-project.json"] = 724,
    ["ocelot.json"] = 730,
    ogen = 736,
    ["omnisharp.json"] = 739,
    openHAB = 1405,
    ...
    oxfmt = 1415,
    oxlint = 1416,
    ["pack.toml (packwiz)"] = 1454,
    ["package.json"] = 775,
    ["package.manifest"] = 777,
    ["package.yaml"] = 776,
    ["partial-black.json"] = 175,
    ["partial-fastapi.json"] = 176,
    ["partial-pixi.json"] = 787,
    ["partial-scheduled.json"] = 177,
    ["pattern.json"] = 785,
    ["petstore-v1.0"] = 1225,
    pgap_yaml_input_reader = 783,
    pgrls = 784,
    pgxgen = 1409,
    pitcms = 1412,
    ["pixi.toml"] = 786,
    ["plagiarize-me.yaml"] = 791,
    ["plagiarize.yaml"] = 790,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1336,
    ["podbard.yaml"] = 793,
    ["portman.json"] = 796,
    ["prefect.toml"] = 805,
    ["prefect.yaml"] = 806,
    ...
    ["prettierrc.json"] = 808,
    ["prisma.yml"] = 809,
    ["project-1.0.0-beta3.json"] = 821,
    ["project-1.0.0-beta4.json"] = 822,
    ["project-1.0.0-beta5.json"] = 823,
    ["project-1.0.0-beta6.json"] = 824,
    ["project-1.0.0-beta8.json"] = 825,
    ["project-1.0.0-rc1.json"] = 826,
    ["project-1.0.0-rc2.json"] = 827,
    ["project.json"] = 820,
    ["project.owasp.yaml"] = 828,
    ["prometheus-alertmanager.json"] = 832,
    ["prometheus.json"] = 829,
    ["prometheus.rules.json"] = 830,
    ["prometheus.rules.test.json"] = 831,
    ["proxies.json"] = 833,
    ["publiccode.yml"] = 834,
    ["pubspec.yaml"] = 835,
    ["pyrseas-0.8.json"] = 838,
    pytest = 847,
    ["quilt.mod.json"] = 1246,
    ["rc3 auth"] = 853,
    ["rc3 collection"] = 854,
    ...
    ["rc3 settings"] = 858,
    ["registry.yaml"] = 65,
    ["release drafter"] = 1122,
    ["release-hub.json"] = 10,
    ["release-please-config.json"] = 863,
    ["release-please-manifest.json"] = 864,
    ["release-plz.toml"] = 865,
    ["renv.lock"] = 880,
    ["replacement-transformer.yaml"] = 624,
    ["reposets Configuration"] = 869,
    ["reposets Credentials"] = 870,
    ["revola.json"] = 8,
    ["rivet.json"] = 1270,
    ["rivet.yaml (legacy)"] = 1269,
    rumdl = 885,
    runny = 884,
    runspec = 1437,
    rustfmt = 886,
    ...
    samt = 889,
    samtrc = 890,
    ["sarif-1.0.0.json"] = 892,
    ["sarif-2.0.0.json"] = 893,
    ["sarif-2.1.0"] = 903,
    ["sarif-2.1.0-rtm.2"] = 894,
    ["sarif-2.1.0-rtm.3"] = 896,
    ["sarif-2.1.0-rtm.4"] = 898,
    ["sarif-2.1.0-rtm.5"] = 900,
    ["sarif-2.1.0-rtm.6"] = 901,
    ["sarif-external-property-file-2.1.0"] = 904,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 895,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 897,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 899,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 902,
    ["scalingo.json configuration"] = 905,
    ["schema.org - Action"] = 907,
    ["schema.org - ContactPoint"] = 908,
    ["schema.org - Place"] = 909,
    ["schema.org - Thing"] = 910,
    ["secrethub.yml"] = 1248,
    ["semantic-release"] = 918,
    servercn = 1465,
    ["servicehub.config.json"] = 1096,
    ["servicehub.service.json"] = 1095,
    ["settings.job"] = 921,
    ["sfdx-hardis configuration"] = 923,
    ["shard.yml"] = 1286,
    ["size-limit configuration"] = 928,
    ["skaffold.yaml"] = 1170,
    ["skill-map plugin extension manifest"] = 929,
    ["skill-map project settings"] = 930,
    ["skill-map provider kind"] = 931,
    ["skyuxconfig.json"] = 933,
    ["snowflake-config"] = 935,
    ["snowflake-connections"] = 936,
    ["spicepod.yaml"] = 1307,
    ["sqlc configuration"] = 970,
    ["stripe-app-local.json"] = 981,
    ["stripe-app.json"] = 980,
    swcrc = 1154,
    ["task.json"] = 994,
    taskcat = 1117,
    ["template.json"] = 999,
    ["templatsources.json"] = 1000,
    ["text2confl config"] = 1417,
    ["theme.json"] = 1008,
    ["tizen_workspace.json"] = 1010,
    tldr = 1011,
    ["tm_devices configuration file"] = 1374,
    tmuxinator = 1099,
    tox = 1013,
    ["transcend.yml"] = 1022,
    ["tree-sitter grammar.json"] = 527,
    ["trime.yaml"] = 1023,
    ["trunk.yaml"] = 1026,
    ["ts-force-config.json"] = 1032,
    tsbuild = 1027,
    ["tsconfig.json"] = 1028,
    ["tsd.json"] = 1029,
    ["tsdoc.json"] = 1030,
    ...
    uv = 1054,
    v8r = 1077,
    ["value-add-transformer.yaml"] = 625,
    vcluster = 1293,
    ["vcpkg configuration file"] = 309,
    ["vcpkg manifest file"] = 308,
    ["vega-lite.json"] = 1058,
    ["vega.json"] = 1057,
    ["venvironment.yaml"] = 1060,
    ["venvplus.yaml"] = 1061,
    version = 1356,
    ["version.json"] = 1063,
    ["vhwdebugger-binding.yaml"] = 1065,
    ["vim-addon-info"] = 1066,
    ["vs-2017.3.host.json"] = 1069,
    ["vs-nesting.json"] = 1070,
    ["vsls.json"] = 1068,
    ["vss-extension.json"] = 1074,
    vtcfg = 1362,
    ["vtesttree.yaml"] = 1075,
    ["vtestunit.yaml"] = 1076,
    ["warp-keysets.json"] = 1254,
    ["warp-themes.json"] = 1255,
    ["warp-workflows.json"] = 1256,
    ["webhint.io"] = 1210,
    ["webjobpublishsettings.json"] = 1081,
    ["webjobs-list.json"] = 1080,
    ["well-known-fursona"] = 1294,
    ["xs-app.json"] = 1112,
    ["xunit.runner.json"] = 1094,
    ["yaml-workflow"] = 1464,
    yamlfmt = 1139,
    yamllint = 1140,
    ["yap.json"] = 1141,
