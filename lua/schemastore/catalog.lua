...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 15,
    AIConfig = 16,
    ["AMX Muse Program Descriptor"] = 1008,
    ["API Builder"] = 825,
    ["AVA Configuration"] = 887,
    ...
    ["Adobe UXP Manifest"] = 947,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    Air = 12,
    ["Airlock Microgateway"] = 17,
    ["Alacritty Configuration"] = 859,
    ["All Contributors configuration file"] = 912,
    ...
    ["Application list for a WinUtil"] = 990,
    ArchitectFX = 995,
    ["Argo Events"] = 31,
    ["Argo Workflows"] = 32,
    AssemblyScript = 35,
    ...
    ["BX CI"] = 110,
    ["Bashly (bashly.yml)"] = 916,
    ["Bashly Settings (bashly-settings.yml)"] = 917,
    ["Better Code Hub"] = 829,
    ["Better Scripts"] = 111,
    Bigconfig = 85,
    ["Biome Formatter Config"] = 55,
    ["Bitmovin Encoding Template"] = 1001,
    BizTalkServerApplicationSchema = 797,
    Bleep = 112,
    ...
    ["Butane Config"] = 872,
    C4InterFlow = 1016,
    ["CGS Card Game Specification (cgs.json)"] = 952,
    ["CICS TS region tagging"] = 881,
    ["CICS TS resource import"] = 882,
    ["CICS TS resource model"] = 883,
    ["CICS TS resource overrides"] = 884,
    ["CMake Presets"] = 113,
    ["CNC Codes"] = 130,
    ["CRS WAF test file"] = 980,
    ["CRS WAF test platform overrides file"] = 981,
    ...
    ["Chamaleon environment"] = 1005,
    ["Chamaleon properties"] = 1006,
    ["Chamaleon template"] = 1004,
    Changesets = 213,
    Charmcraft = 122,
    Cheatsheets = 869,
    ...
    CityJSON = 125,
    ["Clawject config"] = 136,
    ["Cloud Foundry Application Manifest"] = 963,
    ["Cloud Run Spec v1"] = 985,
    ...
    Concord = 979,
    ["Configu .cfgu files"] = 968,
    ["Configu .configu file"] = 969,
    Conjure = 129,
    ["Container Structure Test"] = 811,
    Containerlab = 838,
    ["Contextive Glossary"] = 1030,
    Convex = 128,
    ["Crowdsec collection config"] = 222,
    ["Crowdsec parser config"] = 223,
    ["Crowdsec scenario config"] = 224,
    ["CumulusCI Config"] = 135,
    ["Custom Machinery Machine"] = 953,
    ["Custom Machinery Recipe"] = 954,
    ...
    ["DonateCaseBetterCasino menu"] = 1009,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 924,
    ["EAS config"] = 288,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 913,
    ["EasyVCR .NET"] = 289,
    ["Eidolon Resource"] = 996,
    ...
    ["GeoJSON.json latest"] = 876,
    GherKing = 880,
    ["GitHub Action"] = 319,
    ["GitHub Actions typing"] = 992,
    ...
    ["Goreleaser Pro"] = 348,
    Goss = 349,
    ["Gradle Build Cache Node"] = 827,
    ["Gradle Enterprise"] = 826,
    ...
    Hadolint = 807,
    Hammerkit = 837,
    ["Hardware Sentry Configuration"] = 892,
    Hatch = 808,
    Hayson = 362,
    ...
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 934,
    ["JSON Schema Draft 7"] = 775,
    ["JSON Schema Draft 7 (unofficial strict)"] = 935,
    ["JSON Schema Draft 8 (2019-09)"] = 776,
    ["JSON-API"] = 402,
    ["JSON-e templates"] = 834,
    ["JSON-stat 2.0"] = 770,
    JSONPatch = 406,
    ...
    ["Metadata for a Cinnamon spice"] = 988,
    ["Metatype Configuration"] = 454,
    ["MetricsHub Configuration"] = 455,
    ["MetricsHub Connector Configuration"] = 456,
    ["Micro Editor Syntax"] = 925,
    ["Microsoft Band Web Tile"] = 457,
    ["Microsoft RulesEngine workflow rules"] = 976,
    ["Microsoft RulesEngine workflow rules list"] = 977,
    ["Minecraft Custom Main Menu Mod"] = 942,
    ...
    ["MongoDB Atlas Search Index Definition"] = 896,
    ["Monika Configuration"] = 894,
    ["Monoweave Configuration"] = 482,
    ["Motif config"] = 790,
    MultiQC = 1024,
    ["NOX Framework (Service)"] = 499,
    ["Netin Diagnostic System Template"] = 854,
    ["Netlify config"] = 490,
    ...
    ["OpenUtau ustx"] = 517,
    ["OpenWeather Current Weather API"] = 833,
    ["OpenWeather Road Risk API"] = 832,
    ...
    ["Pipeline component"] = 845,
    ["Plex Prerolls"] = 553,
    ["PocketMine plugin.yml"] = 550,
    ["Postman collection"] = 557,
    ["Preset list for a WinUtil"] = 991,
    ["Problem object RFC9457"] = 939,
    ...
    PyProject = 591,
    Pyright = 592,
    ["Python script metadata"] = 1026,
    Qgoda = 594,
    Qodana = 864,
    ["Qt Creator workspace file"] = 970,
    ["Quali Torque Blueprint Spec 2"] = 889,
    ["QueryFirst config file"] = 907,
    ["RKE Cluster Configuration JSON"] = 842,
    ["RKE Cluster Configuration YAML"] = 841,
    RadioHound = 585,
    Railway = 595,
    ["Rancher Fleet"] = 587,
    ["Rattler-build"] = 596,
    ...
    ["Render Blueprints"] = 840,
    RenderCV = 615,
    Renovate = 614,
    ["Replit config"] = 609,
    Restate = 1019,
    RoadRunner = 617,
    ["Rudder techniques"] = 945,
    Ruff = 611,
    ["Rust Project"] = 612,
    ["Rust toolchain"] = 621,
    ...
    ["SauceCTL Configuration"] = 851,
    ["Schema Catalog"] = 639,
    ["Scoop manifest"] = 644,
    ["Semantic Data Fabric (SDF) file"] = 648,
    ["Semgrep Rule"] = 650,
    ["Serenity Code Generator (Sergen)"] = 651,
    ["Serverless Framework Configuration"] = 858,
    ["Serverless Workflow"] = 860,
    ["Settings for a Cinnamon spice"] = 987,
    ["Settings.paf"] = 653,
    ["Shopware 6 Configuration"] = 861,
    ["Shopware CLI Extension Store Configuration"] = 862,
    ["Shopware CLI Project Store Configuration"] = 863,
    ["Sigma Detection Rule"] = 655,
    ["Sigrid scope configuration file"] = 656,
    ["SkyPilot Task JSON"] = 946,
    ...
    StackBlitz = 680,
    ["StackHawk Scanner Configuration"] = 857,
    Stale = 681,
    ["Starlake Data Pipeline"] = 830,
    Starship = 682,
    ...
    ["Sublime Syntax"] = 903,
    ["Subsquid squid manifest"] = 948,
    ["Swagger API 2.0"] = 691,
    ["Synadia Connect Component"] = 692,
    TSON = 726,
    TSTyche = 727,
    ["Tab data for a LinUtil"] = 994,
    ["Tab list for a LinUtil"] = 993,
    Tach = 693,
    ["Tach Domain"] = 694,
    Talhelper = 696,
    ...
    ["Tugboat QA config.yml"] = 1015,
    TunnelHub = 938,
    Turborepo = 710,
    Tycho = 983,
    Tye = 865,
    ["Tyk Gateway - Open Source v5.7+"] = 1025,
    ["UET BuildConfig.json"] = 908,
    ["UI5 Manifest"] = 736,
    ["UNCORS configuration"] = 740,
    ["UTAM Page Object"] = 739,
    ["Ubuntu Server Autoinstall"] = 734,
    ["Uniswap Token List"] = 818,
    ["Universal Schedule Format"] = 741,
    ["Unreal Engine Uplugin"] = 909,
    ["Unreal Engine Uproject"] = 910,
    ["Updatecli Compose"] = 873,
    ["Updatecli Policy Manifest"] = 874,
    ["Updatecli Policy Metadata"] = 875,
    Uplift = 906,
    ["User Journey Map"] = 839,
    V2Ray = 879,
    ...
    ["Viash Component Config"] = 1022,
    ["Viash Package Config"] = 1023,
    Visivo = 936,
    Wake = 1017,
    ["Waku Config"] = 997,
    ...
    ["Web types"] = 768,
    WebExtensions = 764,
    ["Webman package recipe"] = 885,
    ["Windows Package Manager Installer Manifest"] = 814,
    ["Windows Package Manager Locale Manifest"] = 815,
    ["Windows Package Manager Singleton Manifest"] = 813,
    Winutil = 816,
    ["WireMock stub mapping"] = 1000,
    ["Woodpecker pipeline config"] = 853,
    ["Wrangler CLI"] = 769,
    ["Xstate Machine"] = 871,
    ["Yandex Workflow Language"] = 989,
    ["Yarn Config (.yarnrc.yml)"] = 828,
    ["Yippee-Ki-JSON configuration YML"] = 820,
    ["YouTrack App"] = 986,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 18,
    apko = 940,
    ...
    ["behat.yml"] = 94,
    ["bigquery-table"] = 84,
    ["bioimageio resource description"] = 956,
    ...
    ["crowdin.yml"] = 221,
    ["ctfd-setup configuration file"] = 1007,
    ["custom-elements.json"] = 928,
    ["cypress.json"] = 225,
    ...
    ["gematik health care insurance list"] = 1013,
    ["gematik health care patient list"] = 1010,
    ["gematik health care provider institution list"] = 1012,
    ["gematik health care provider list"] = 1011,
    ["gematik tiger test environment configuration"] = 1014,
    ["gitlab-ci"] = 327,
    ["global.json"] = 343,
    ...
    ["lotus.yaml"] = 443,
    ["lsdlschema.json"] = 446,
    ["markdown-link-check"] = 848,
    maturin = 849,
    mboats = 856,
    ["micro-settings.json"] = 920,
    ["mimetypes.json"] = 458,
    ["mirrord config"] = 786,
    mise = 787,
    ["mkdocs.yml"] = 478,
    ...
    ["plagiarize.yaml"] = 551,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1003,
    ["podbard.yaml"] = 554,
    ["portman.json"] = 555,
    ["prefect.toml"] = 563,
    ["prettierrc.json"] = 564,
    ...
    ["vtesttree.yaml"] = 761,
    ["vtestunit.yaml"] = 762,
    ["warp-keysets.json"] = 929,
    ["warp-themes.json"] = 930,
    ["warp-workflows.json"] = 931,
    ["webhint.io"] = 886,
    ["webjobpublishsettings.json"] = 767,
    ["webjobs-list.json"] = 766,
    ["well-known-fursona"] = 966,
    ["xs-app.json"] = 792,
    ["xunit.runner.json"] = 778,
    yamllint = 819,
    ["zerops.io import file"] = 975,
    ["zerops.yml"] = 974,
    zuul = 802,
    ["Žinoma"] = 812
  },
