...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 144,
    [".cryproj (generic)"] = 487,
    [".cryproj engine-5.2"] = 482,
    [".cryproj engine-5.3"] = 483,
    [".cryproj engine-5.4"] = 484,
    [".cryproj engine-5.5"] = 485,
    [".cryproj engine-dev"] = 486,
    [".csscomb.json"] = 146,
    [".csslintrc"] = 147,
    [".eslintrc"] = 192,
    [".esmrc.json"] = 184,
    ...
    ["Azure Pipelines"] = 44,
    ["Azure Static Web Apps CLI configuration file"] = 412,
    ["Azure Static Web Apps configuration file"] = 411,
    ["BX CI"] = 75,
    ["Better Code Hub"] = 530,
    ["Better Scripts"] = 76,
    BizTalkServerApplicationSchema = 502,
    ...
    ["Butane Config"] = 567,
    ["CICS TS region tagging"] = 574,
    ["CICS TS resource import"] = 575,
    ["CICS TS resource model"] = 576,
    ["CICS TS resource overrides"] = 577,
    ["CMake Presets"] = 77,
    ...
    ["Datahub Ingestion Recipe Schema"] = 581,
    ...
    ["Embrace Config Schema"] = 592,
    ["Error pages"] = 187,
    Esquio = 185,
    ["Estuary Flow Catalog Schema"] = 571,
    ["Expo SDK"] = 190,
    ...
    Goreleaser = 218,
    ["Goreleaser Pro"] = 219,
    ["Gradle Build Cache Node"] = 527,
    ["Gradle Enterprise"] = 526,
    ...
    HEMTT = 499,
    Hadolint = 511,
    ["Hardware Sentry Configuration"] = 585,
    Hayson = 231,
    ...
    ["JFrog File Spec"] = 250,
    ["JFrog Pipelines YML DSL"] = 594,
    ["JSON Document Transform"] = 258,
    ["JSON Feed"] = 259,
    ["JSON Resume"] = 372,
    ["JSON Schema Draft 2020-12"] = 478,
    ["JSON Schema Draft 4"] = 475,
    ["JSON Schema Draft 7"] = 476,
    ["JSON Schema Draft 8"] = 477,
    ...
    ["KSP-AVC"] = 473,
    ["KSP-CKAN"] = 474,
    ["Keycloak REST API"] = 600,
    ["Knative Functions - func.yaml"] = 202,
    ["KoDE/CI build.yaml"] = 590,
    ["Kong DBLess Schema"] = 591,
    KrakenD = 264,
    ["LinkML Metamodel"] = 276,
    Liquibase = 541,
    ["Liquibase Flow File"] = 542,
    Markdownlint = 545,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 589,
    ["Monika Configuration Schema"] = 587,
    ["Motif config"] = 495,
    ["Netin Diagnostic System Template"] = 550,
    ...
    Opctl = 498,
    ["OpenWeather Current Weather API"] = 534,
    ["OpenWeather Road Risk API"] = 533,
    ...
    Packer = 333,
    ["Pipeline component"] = 543,
    ["PocketMine plugin.yml"] = 337,
    Pterodactyl = 584,
    ["Pull Request Labeler"] = 360,
    PyProject = 364,
    Qodana = 560,
    ["Quali Torque Blueprint Spec 2"] = 582,
    ["QueryFirst config file"] = 603,
    ["RKE Cluster Configuration JSON Schema"] = 540,
    ["RKE Cluster Configuration YAML Schema"] = 539,
    Ray = 510,
    ["Read the Docs"] = 363,
    ["Red-DiscordBot Cog"] = 365,
    ["Red-DiscordBot Cog Repo"] = 366,
    Renovate = 373,
    ["Replit schema"] = 369,
    RoadRunner = 374,
    ["Rust Project"] = 371,
    ["Rust toolchain"] = 376,
    ["SIL Kit Participant Configuration"] = 401,
    SWADL = 421,
    ["Sapphire CLI Config"] = 377,
    ["SauceCTL Configuration"] = 547,
    ["Schema Catalog"] = 390,
    ["Scoop manifest"] = 395,
    ["Semgrep Rule"] = 397,
    ["Serverless Framework Configuration"] = 554,
    ["Serverless Workflow Schema"] = 556,
    ["Settings.paf"] = 399,
    ["Shopware 6 Configuration"] = 557,
    ["Shopware CLI Extension Store Configuration"] = 558,
    ["Shopware CLI Project Store Configuration"] = 559,
    Solidarity = 405,
    ["Solution filters"] = 406,
    ["Source Maps v3"] = 407,
    SpecIF = 408,
    ["Sponge Mixin configuration"] = 409,
    ["StackHawk Scanner Configuration"] = 553,
    Stale = 413,
    Starship = 414,
    ["Statamic Blueprint"] = 415,
    ["StrmPrivacy Data Connector"] = 598,
    ["StrmPrivacy Data Contract"] = 599,
    ["StrmPrivacy SimpleSchema"] = 596,
    ["StrmPrivacy Stream"] = 597,
    ["StrmPrivacy batch job configuration file"] = 595,
    ["Stryker Mutator"] = 418,
    ["StyleCop Analyzers Configuration"] = 419,
    ["Swagger API 2.0"] = 422,
    TSON = 442,
    ["Talisman configuration"] = 423,
    ["Taskfile YAML Schema"] = 536,
    Taurus = 424,
    ["TestEnvironment.json"] = 431,
    Tikibase = 427,
    ["Traefik v2"] = 434,
    ["Traefik v2 File Provider"] = 435,
    Turborepo = 432,
    Tye = 561,
    ["UI5 Manifest"] = 448,
    ["UTAM Page Object"] = 450,
    ["Ubuntu Server Autoinstall"] = 446,
    ["Uniswap Token List"] = 519,
    ["Unreal Engine Uplugin"] = 604,
    ["Unreal Engine Uproject"] = 605,
    Updatecli = 568,
    Uplift = 602,
    ["User Journey Map YAML Schema"] = 538,
    V2Ray = 572,
    ["VSCode Code Snippets"] = 120,
    ["VSIX CLI publishing"] = 463,
    ["Vela Pipeline Configuration"] = 453,
    Vercel = 119,
    ["Web App Manifest"] = 468,
    ["Web types"] = 471,
    WebExtensions = 467,
    ["Webman package recipe"] = 578,
    ["Windows Package Manager Installer Manifest"] = 516,
    ["Windows Package Manager Locale Manifest"] = 517,
    ["Windows Package Manager Singleton Manifest"] = 515,
    ["Woodpecker pipeline config"] = 549,
    ["Xstate Machine Schema"] = 566,
    ["Yippee-Ki-JSON configuration YML"] = 521,
    ["angular.json"] = 10,
    ...
    ["ize.toml"] = 601,
    ["jsconfig.json"] = 262,
    ["jscpd Configuration Schema"] = 583,
    jsdoc = 509,
    ["k3d.yaml"] = 263,
    ...
    ["release drafter"] = 505,
    rustfmt = 375,
    ["sarif-1.0.0.json"] = 378,
    ["sarif-2.0.0.json"] = 379,
    ["sarif-2.1.0"] = 388,
    ["sarif-2.1.0-rtm.2"] = 380,
    ["sarif-2.1.0-rtm.3"] = 382,
    ["sarif-2.1.0-rtm.4"] = 384,
    ["sarif-2.1.0-rtm.5"] = 386,
    ["sarif-external-property-file-2.1.0"] = 389,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 381,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 383,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 385,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 387,
    ["schema.org - Action"] = 391,
    ["schema.org - ContactPoint"] = 392,
    ["schema.org - Place"] = 393,
    ["schema.org - Thing"] = 394,
    ["semantic-release"] = 396,
    ["servicehub.config.json"] = 481,
    ["servicehub.service.json"] = 480,
    ["settings.job"] = 398,
    ["sfdx-hardis configuration"] = 400,
    ["size-limit configuration"] = 402,
    ["skaffold.yaml"] = 544,
    ["skyuxconfig.json"] = 403,
    snapcraft = 404,
    ["stripe-app-local.json"] = 417,
    ["stripe-app.json"] = 416,
    swcrc = 532,
    taskcat = 501,
    ["template.json"] = 425,
    ["templatsources.json"] = 426,
    ["theme.json"] = 428,
    ["tizen_workspace.json"] = 429,
    tmLanguage = 430,
    tmuxinator = 489,
    ["trunk.yaml schema"] = 436,
    ["ts-force-config.json"] = 440,
    ["tsconfig.json"] = 437,
    ["tsd.json"] = 438,
    ["tsdrc.json"] = 439,
    ["tslint.json"] = 441,
    ...
    ["vega-lite.json"] = 452,
    ["vega.json"] = 451,
    ["venvironment-basic.yaml"] = 455,
    ["venvironment.yaml"] = 454,
    ["version.json"] = 456,
    ["vim-addon-info"] = 457,
    ["vs-2017.3.host.json"] = 459,
    ["vs-nesting.json"] = 460,
    ["vsls.json"] = 458,
    ["vss-extension.json"] = 464,
    ["webhint.io"] = 579,
    ["webjobpublishsettings.json"] = 470,
    ["webjobs-list.json"] = 469,
    ["xs-app.json"] = 497,
    ["xunit.runner.json"] = 479,
    yamllint = 520,
    zuul = 506,
    ["Žinoma"] = 514
  },
