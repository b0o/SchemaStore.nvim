...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 181,
    [".cryproj (generic)"] = 622,
    [".cryproj engine-5.2"] = 617,
    [".cryproj engine-5.3"] = 618,
    [".cryproj engine-5.4"] = 619,
    [".cryproj engine-5.5"] = 620,
    [".cryproj engine-dev"] = 621,
    [".csscomb.json"] = 183,
    [".csslintrc"] = 184,
    [".es6importsorterrc.json"] = 753,
    [".eslintrc"] = 233,
    [".esmrc.json"] = 225,
    [".ffizer.yaml"] = 237,
    [".htmlhintrc"] = 290,
    ...
    [".mtaext"] = 631,
    [".nodehawkrc"] = 393,
    [".npmpackagejsonlintrc"] = 396,
    [".phraseapp.yml"] = 441,
    [".pmbot.yml"] = 430,
    [".postcssrc"] = 436,
    [".powerpages-web-template-manifest"] = 438,
    [".pre-commit-config.yml"] = 439,
    [".pre-commit-hooks.yml"] = 440,
    [".putout.json"] = 460,
    [".rehyperc"] = 472,
    [".remarkrc"] = 474,
    [".sprite files"] = 530,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 695,
    ["All Contributors configuration file"] = 752,
    ...
    ["Azure Pipelines"] = 60,
    ["Azure Static Web Apps CLI configuration file"] = 533,
    ["Azure Static Web Apps configuration file"] = 532,
    ["BX CI"] = 96,
    ["Better Code Hub"] = 667,
    ["Better Scripts"] = 97,
    Bigconfig = 77,
    BizTalkServerApplicationSchema = 637,
    Bleep = 98,
    ...
    ["Butane Config"] = 707,
    ["CICS TS region tagging"] = 716,
    ["CICS TS resource import"] = 717,
    ["CICS TS resource model"] = 718,
    ["CICS TS resource overrides"] = 719,
    ["CMake Presets"] = 99,
    ["CNC Codes"] = 109,
    ...
    ["Databricks Asset Bundles"] = 773,
    ["Datadog Service Definition"] = 330,
    ["Datahub Ingestion Recipe"] = 723,
    ["Dein Config"] = 115,
    Deno = 194,
    ["Deployer Recipe"] = 197,
    ["Deta Spacefile"] = 116,
    ...
    ["Goreleaser Pro"] = 272,
    Goss = 273,
    ["Gradle Build Cache Node"] = 665,
    ["Gradle Enterprise"] = 664,
    ...
    Hadolint = 646,
    Hammerkit = 674,
    ["Hardware Sentry Configuration"] = 727,
    Hatch = 647,
    Hayson = 285,
    ...
    ["JFrog File Spec"] = 310,
    ["JFrog Pipelines YML DSL"] = 736,
    ["JMeter DSL cli config"] = 311,
    JReleaser = 313,
    ["JSON Document Transform"] = 320,
    ["JSON Feed"] = 321,
    ["JSON Resume"] = 480,
    ["JSON Schema Draft 2020-12"] = 613,
    ["JSON Schema Draft 4"] = 610,
    ["JSON Schema Draft 7"] = 611,
    ["JSON Schema Draft 7 (unofficial strict)"] = 774,
    ["JSON Schema Draft 8 (2019-09)"] = 612,
    ["JSON-API"] = 319,
    ["JSON-e templates"] = 672,
    ["JSON-stat 2.0"] = 607,
    JSONPatch = 323,
    Jasmine = 303,
    Jekyll = 304,
    ...
    Kas = 326,
    ["Keycloak REST API"] = 744,
    ["Knative Functions - func.yaml"] = 250,
    ["KoDE/CI build.yaml"] = 732,
    ["Kong DBLess config"] = 733,
    KrakenD = 329,
    LOOBin = 347,
    Lefthook = 337,
    ...
    ["Minecraft Custom Main Menu Mod"] = 781,
    ...
    ["MongoDB Atlas Search Index Definition"] = 731,
    ["Monika Configuration"] = 729,
    ["Motif config"] = 630,
    ["NOX Framework (Service)"] = 395,
    ["Netin Diagnostic System Template"] = 689,
    ["Netlify config"] = 386,
    ["Network-as-Code Data Model"] = 387,
    ["Nightwatch.js"] = 388,
    ["ONe's changelog entry"] = 411,
    ["ONe's service descriptor"] = 410,
    ["OSS Review Toolkit configuration"] = 418,
    ["OSS Review Toolkit curation"] = 419,
    ["OSS Review Toolkit package configuration"] = 420,
    ["OSS Review Toolkit repository configuration"] = 421,
    ["OSS Review Toolkit resolutions"] = 422,
    Opctl = 633,
    ["OpenRewrite Resource"] = 413,
    ["OpenUtau character yaml"] = 407,
    ["OpenUtau ustx"] = 408,
    ["OpenWeather Current Weather API"] = 671,
    ["OpenWeather Road Risk API"] = 670,
    ["Ory Hydra configuration"] = 291,
    ["Ory Keto configuration"] = 331,
    ["Ory Kratos configuration"] = 417,
    ["Ory Oathkeeper configuration"] = 402,
    ["Outblocks App configuration"] = 415,
    ["Outblocks database table"] = 416,
    ["Outblocks project configuration"] = 414,
    Packer = 425,
    Pantsbuild = 751,
    ["Paper paper-plugin.yml"] = 426,
    ["Pipeline component"] = 681,
    ["PocketMine plugin.yml"] = 431,
    Poetry = 432,
    ["Postman collection"] = 437,
    ["Problem object RFC9457"] = 778,
    ["Problem package generators"] = 444,
    Pterodactyl = 726,
    ["Pull Request Labeler"] = 459,
    Pulumi = 465,
    PyProject = 466,
    Pyright = 467,
    Qgoda = 468,
    Qodana = 700,
    ["Quali Torque Blueprint Spec 2"] = 724,
    ["QueryFirst config file"] = 747,
    ["RKE Cluster Configuration JSON"] = 678,
    ["RKE Cluster Configuration YAML"] = 677,
    ["Rancher Fleet"] = 462,
    Ray = 645,
    ["Read the Docs"] = 464,
    ["Red-DiscordBot Cog"] = 469,
    ["Red-DiscordBot Cog Repo"] = 470,
    ["Red-DiscordBot Trivia"] = 471,
    RenderCV = 482,
    Renovate = 481,
    ["Replit config"] = 475,
    RoadRunner = 483,
    ...
    ["Rust Project"] = 479,
    ["Rust toolchain"] = 485,
    ["SIL Kit Participant Configuration"] = 518,
    ["SIL Kit Registry Configuration"] = 519,
    SWADL = 544,
    ["Safebox Config"] = 737,
    ["Sapphire CLI Config"] = 488,
    ["SauceCTL Configuration"] = 686,
    ["Schema Catalog"] = 502,
    ["Scoop manifest"] = 507,
    ["Semantic Data Fabric (SDF) file"] = 508,
    ["Semgrep Rule"] = 510,
    ["Serenity Code Generator (Sergen)"] = 511,
    ["Serverless Framework Configuration"] = 694,
    ["Serverless Workflow"] = 696,
    ["Settings.paf"] = 513,
    Setuptools = 514,
    ["Shopware 6 Configuration"] = 697,
    ["Shopware CLI Extension Store Configuration"] = 698,
    ["Shopware CLI Project Store Configuration"] = 699,
    Sigma = 516,
    ["Sigrid scope configuration file"] = 517,
    ["Slack app manifest"] = 521,
    Solidarity = 524,
    ["Solution filters"] = 525,
    ["Source Maps v3"] = 526,
    Sourcery = 527,
    SpecIF = 528,
    ["Sponge Mixin configuration"] = 529,
    StackBlitz = 534,
    ["StackHawk Scanner Configuration"] = 693,
    Stale = 535,
    ["Starlake Data Pipeline"] = 668,
    Starship = 536,
    ["Statamic Blueprint"] = 537,
    ["Stella configuration file"] = 538,
    ["StrmPrivacy Data Connector"] = 741,
    ["StrmPrivacy Data Contract"] = 742,
    ["StrmPrivacy SimpleSchema"] = 739,
    ["StrmPrivacy Stream"] = 740,
    ["StrmPrivacy batch job configuration file"] = 738,
    ["Stryker Mutator"] = 541,
    ["StyleCop Analyzers Configuration"] = 542,
    ["Sublime Syntax"] = 743,
    ["Swagger API 2.0"] = 545,
    TSON = 570,
    TSTyche = 571,
    Talhelper = 547,
    ["Talisman configuration"] = 548,
    ["Taskfile config"] = 673,
    Taurus = 549,
    ["TestEnvironment.json"] = 558,
    ["TextMate Grammar"] = 557,
    ["Tier.run pricing.json"] = 552,
    Tikibase = 553,
    ["Traefik v2"] = 561,
    ["Traefik v2 File Provider"] = 562,
    TunnelHub = 777,
    Turborepo = 559,
    Tye = 701,
    ["UET BuildConfig.json"] = 748,
    ["UI5 Manifest"] = 579,
    ["UNCORS configuration"] = 583,
    ["UTAM Page Object"] = 582,
    ["Ubuntu Server Autoinstall"] = 577,
    ["Uniswap Token List"] = 656,
    ["Unreal Engine Uplugin"] = 749,
    ["Unreal Engine Uproject"] = 750,
    ["Updatecli Compose"] = 708,
    ["Updatecli Policy Manifest"] = 709,
    ["Updatecli Policy Metadata"] = 710,
    Uplift = 746,
    ["User Journey Map"] = 676,
    V2Ray = 714,
    ["VSCode Code Snippets"] = 152,
    ["VSIX CLI publishing"] = 596,
    ["Vela Pipeline Configuration"] = 586,
    Vercel = 151,
    Visivo = 775,
    ["Web App Manifest"] = 603,
    ["Web types"] = 606,
    WebExtensions = 602,
    ["Webman package recipe"] = 720,
    ["Windows Package Manager Installer Manifest"] = 653,
    ["Windows Package Manager Locale Manifest"] = 654,
    ["Windows Package Manager Singleton Manifest"] = 652,
    ["Woodpecker pipeline config"] = 688,
    ["Xstate Machine"] = 706,
    ["Yippee-Ki-JSON configuration YML"] = 658,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    apko = 779,
    ...
    ["bamboo-spec"] = 71,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 757,
    ["bashly-strings.yml"] = 758,
    ["bashly.yml"] = 756,
    ["batect.yml"] = 70,
    ...
    ["lsdlschema.json"] = 351,
    ["madness.yml"] = 755,
    ["markdown-lint-check"] = 684,
    mboats = 691,
    ["micro-settings.json"] = 760,
    ["mimetypes.json"] = 358,
    ["mirrord config"] = 627,
    ["monospace.yml"] = 380,
    ["mta.yaml"] = 628,
    ["mtad.yaml"] = 629,
    ["mycode.json"] = 384,
    ["napari plugin manifest"] = 385,
    neoload = 639,
    ["nest-cli"] = 391,
    ["ninjs (News in JSON) 1.3"] = 390,
    ["ninjs (News in JSON) 2.0"] = 389,
    ["nlu.json"] = 392,
    ["nodemon.json"] = 394,
    ["noodl config"] = 690,
    now = 635,
    ...
    ["nswag.json"] = 400,
    ntangle = 401,
    ["nuclei-template.yaml"] = 398,
    ["nuget-project.json"] = 399,
    ["ocelot.json"] = 403,
    ["omnisharp.json"] = 404,
    ["openapi.json"] = 405,
    ["openfin.json"] = 412,
    ...
    ["ops.yaml"] = 409,
    ["package.json"] = 423,
    ["package.manifest"] = 424,
    ["pathfinder.yml"] = 427,
    ["pattern.json"] = 429,
    ["petstore-v1.0"] = 735,
    pgap_yaml_input_reader = 428,
    ["plagiarize-me.yaml"] = 434,
    ["plagiarize.yaml"] = 433,
    ["portman.json"] = 435,
    ["prettierrc.json"] = 442,
    ["prisma.yml"] = 443,
    ["project-1.0.0-beta3.json"] = 446,
    ["project-1.0.0-beta4.json"] = 447,
    ["project-1.0.0-beta5.json"] = 448,
    ["project-1.0.0-beta6.json"] = 449,
    ["project-1.0.0-beta8.json"] = 450,
    ["project-1.0.0-rc1.json"] = 451,
    ["project-1.0.0-rc2.json"] = 452,
    ["project.json"] = 445,
    ["prometheus.json"] = 453,
    ["prometheus.rules.json"] = 454,
    ["prometheus.rules.test.json"] = 455,
    ["proxies.json"] = 456,
    ["publiccode.yml"] = 457,
    ["pubspec.yaml"] = 458,
    ["pyrseas-0.8.json"] = 461,
    ["quilt.mod.json"] = 761,
    ["release drafter"] = 640,
    ["release-plz.toml"] = 473,
    rtx = 477,
    rustfmt = 484,
    samt = 486,
    samtrc = 487,
    ["sarif-1.0.0.json"] = 489,
    ["sarif-2.0.0.json"] = 490,
    ["sarif-2.1.0"] = 500,
    ["sarif-2.1.0-rtm.2"] = 491,
    ["sarif-2.1.0-rtm.3"] = 493,
    ["sarif-2.1.0-rtm.4"] = 495,
    ["sarif-2.1.0-rtm.5"] = 497,
    ["sarif-2.1.0-rtm.6"] = 498,
    ["sarif-external-property-file-2.1.0"] = 501,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 492,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 494,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 496,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 499,
    ["schema.org - Action"] = 503,
    ["schema.org - ContactPoint"] = 504,
    ["schema.org - Place"] = 505,
    ["schema.org - Thing"] = 506,
    ["scikit-build"] = 692,
    ["secrethub.yml"] = 763,
    ["semantic-release"] = 509,
    ["servicehub.config.json"] = 616,
    ["servicehub.service.json"] = 615,
    ["settings.job"] = 512,
    ["sfdx-hardis configuration"] = 515,
    ["size-limit configuration"] = 520,
    ["skaffold.yaml"] = 682,
    ["skyuxconfig.json"] = 522,
    snapcraft = 523,
    ["sqlc configuration"] = 531,
    ["stripe-app-local.json"] = 540,
    ["stripe-app.json"] = 539,
    swcrc = 669,
    syntax = 765,
    ["task.json"] = 546,
    taskcat = 636,
    ["template.json"] = 550,
    ["templatsources.json"] = 551,
    ["theme.json"] = 554,
    ["tizen_workspace.json"] = 555,
    tldr = 556,
    tmuxinator = 624,
    ["transcend.yml"] = 563,
    ["trunk.yaml"] = 564,
    ["ts-force-config.json"] = 568,
    ["tsconfig.json"] = 565,
    ["tsd.json"] = 566,
    ["tsdrc.json"] = 567,
    ["tslint.json"] = 569,
    ...
    ["vega-lite.json"] = 585,
    ["vega.json"] = 584,
    ["venvironment-basic.yaml"] = 588,
    ["venvironment.yaml"] = 587,
    ["version.json"] = 589,
    ["vim-addon-info"] = 590,
    ["vs-2017.3.host.json"] = 592,
    ["vs-nesting.json"] = 593,
    ["vsls.json"] = 591,
    ["vss-extension.json"] = 597,
    ["vtesttree.yaml"] = 598,
    ["vtestunit.yaml"] = 599,
    ["warp-keysets.json"] = 769,
    ["warp-themes.json"] = 770,
    ["warp-workflows.json"] = 771,
    ["webhint.io"] = 721,
    ["webjobpublishsettings.json"] = 605,
    ["webjobs-list.json"] = 604,
    ["xs-app.json"] = 632,
    ["xunit.runner.json"] = 614,
    yamllint = 657,
    zuul = 641,
    ["Žinoma"] = 651
  },
