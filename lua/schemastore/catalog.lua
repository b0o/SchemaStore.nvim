...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 145,
    [".cryproj (generic)"] = 494,
    [".cryproj engine-5.2"] = 489,
    [".cryproj engine-5.3"] = 490,
    [".cryproj engine-5.4"] = 491,
    [".cryproj engine-5.5"] = 492,
    [".cryproj engine-dev"] = 493,
    [".csscomb.json"] = 147,
    [".csslintrc"] = 148,
    [".eslintrc"] = 193,
    [".esmrc.json"] = 185,
    ...
    ["Better Code Hub"] = 537,
    ["Better Scripts"] = 77,
    BizTalkServerApplicationSchema = 509,
    ...
    ["Butane Config"] = 575,
    ["CICS TS region tagging"] = 582,
    ["CICS TS resource import"] = 583,
    ["CICS TS resource model"] = 584,
    ["CICS TS resource overrides"] = 585,
    ["CMake Presets"] = 78,
    ...
    ["Datahub Ingestion Recipe Schema"] = 589,
    ...
    ["Embrace Config Schema"] = 600,
    ["Error pages"] = 188,
    Esquio = 186,
    ["Estuary Flow Catalog Schema"] = 579,
    ["Expo SDK"] = 191,
    ...
    Goreleaser = 219,
    ["Goreleaser Pro"] = 220,
    ["Gradle Build Cache Node"] = 534,
    ["Gradle Enterprise"] = 533,
    ...
    Hadolint = 518,
    Hammerkit = 544,
    ["Hardware Sentry Configuration"] = 593,
    Hayson = 232,
    ...
    ["JFrog File Spec"] = 251,
    ["JFrog Pipelines YML DSL"] = 602,
    ["JSON Document Transform"] = 259,
    ["JSON Feed"] = 260,
    ["JSON Resume"] = 378,
    ["JSON Schema Draft 2020-12"] = 485,
    ["JSON Schema Draft 4"] = 482,
    ["JSON Schema Draft 7"] = 483,
    ["JSON Schema Draft 8"] = 484,
    ...
    ["KSP-AVC"] = 480,
    ["KSP-CKAN"] = 481,
    ["Keycloak REST API"] = 608,
    ["Knative Functions - func.yaml"] = 203,
    ["KoDE/CI build.yaml"] = 598,
    ["Kong DBLess Schema"] = 599,
    KrakenD = 265,
    ["LinkML Metamodel"] = 277,
    Liquibase = 549,
    ["Liquibase Flow File"] = 550,
    Markdownlint = 553,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 597,
    ["Monika Configuration Schema"] = 595,
    ["Motif config"] = 502,
    ["NOX Framework (Service)"] = 313,
    ["Netin Diagnostic System Template"] = 558,
    ...
    Opctl = 505,
    ["OpenWeather Current Weather API"] = 541,
    ["OpenWeather Road Risk API"] = 540,
    ...
    PyProject = 369,
    Qodana = 568,
    ["Quali Torque Blueprint Spec 2"] = 590,
    ["QueryFirst config file"] = 611,
    ["RKE Cluster Configuration JSON Schema"] = 548,
    ["RKE Cluster Configuration YAML Schema"] = 547,
    Ray = 517,
    ["Read the Docs"] = 367,
    ...
    ["SauceCTL Configuration"] = 555,
    ["Schema Catalog"] = 396,
    ["Scoop manifest"] = 401,
    ["Semgrep Rule"] = 403,
    ["Serverless Framework Configuration"] = 562,
    ["Serverless Workflow Schema"] = 564,
    ["Settings.paf"] = 405,
    ["Shopware 6 Configuration"] = 565,
    ["Shopware CLI Extension Store Configuration"] = 566,
    ["Shopware CLI Project Store Configuration"] = 567,
    Solidarity = 411,
    ["Solution filters"] = 412,
    ["Source Maps v3"] = 413,
    SpecIF = 414,
    ["Sponge Mixin configuration"] = 415,
    ["StackHawk Scanner Configuration"] = 561,
    Stale = 419,
    Starship = 420,
    ["Statamic Blueprint"] = 421,
    ["StrmPrivacy Data Connector"] = 606,
    ["StrmPrivacy Data Contract"] = 607,
    ["StrmPrivacy SimpleSchema"] = 604,
    ["StrmPrivacy Stream"] = 605,
    ["StrmPrivacy batch job configuration file"] = 603,
    ["Stryker Mutator"] = 424,
    ["StyleCop Analyzers Configuration"] = 425,
    ["Swagger API 2.0"] = 428,
    TSON = 448,
    ["Talisman configuration"] = 429,
    ["Taskfile YAML Schema"] = 543,
    Taurus = 430,
    ...
    Tye = 569,
    ["UI5 Manifest"] = 455,
    ["UTAM Page Object"] = 457,
    ["Ubuntu Server Autoinstall"] = 453,
    ["Uniswap Token List"] = 526,
    ["Unreal Engine Uplugin"] = 612,
    ["Unreal Engine Uproject"] = 613,
    Updatecli = 576,
    Uplift = 610,
    ["User Journey Map YAML Schema"] = 546,
    V2Ray = 580,
    ["VSCode Code Snippets"] = 121,
    ["VSIX CLI publishing"] = 470,
    ["Vela Pipeline Configuration"] = 460,
    Vercel = 120,
    ["Web App Manifest"] = 475,
    ["Web types"] = 478,
    WebExtensions = 474,
    ["Webman package recipe"] = 586,
    ["Windows Package Manager Installer Manifest"] = 523,
    ["Windows Package Manager Locale Manifest"] = 524,
    ["Windows Package Manager Singleton Manifest"] = 522,
    ["Woodpecker pipeline config"] = 557,
    ["Xstate Machine Schema"] = 574,
    ["Yippee-Ki-JSON configuration YML"] = 528,
    ["angular.json"] = 10,
    ...
    ["ize.toml"] = 609,
    ["jsconfig.json"] = 263,
    ["jscpd Configuration Schema"] = 591,
    jsdoc = 516,
    ["k3d.yaml"] = 264,
    ...
    ["servicehub.config.json"] = 488,
    ["servicehub.service.json"] = 487,
    ["settings.job"] = 404,
    ...
    ["vega-lite.json"] = 459,
    ["vega.json"] = 458,
    ["venvironment-basic.yaml"] = 462,
    ["venvironment.yaml"] = 461,
    ["version.json"] = 463,
    ["vim-addon-info"] = 464,
    ["vs-2017.3.host.json"] = 466,
    ["vs-nesting.json"] = 467,
    ["vsls.json"] = 465,
    ["vss-extension.json"] = 471,
    ["webhint.io"] = 587,
    ["webjobpublishsettings.json"] = 477,
    ["webjobs-list.json"] = 476,
    ["xs-app.json"] = 504,
    ["xunit.runner.json"] = 486,
    yamllint = 527,
    zuul = 513,
    ["Žinoma"] = 521
  },
