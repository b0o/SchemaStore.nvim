...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 167,
    [".cryproj (generic)"] = 584,
    [".cryproj engine-5.2"] = 579,
    [".cryproj engine-5.3"] = 580,
    [".cryproj engine-5.4"] = 581,
    [".cryproj engine-5.5"] = 582,
    [".cryproj engine-dev"] = 583,
    [".csscomb.json"] = 169,
    [".csslintrc"] = 170,
    [".es6importsorterrc.json"] = 710,
    [".eslintrc"] = 219,
    [".esmrc.json"] = 211,
    [".ffizer.yaml"] = 223,
    [".htmlhintrc"] = 272,
    ...
    [".mtaext"] = 593,
    [".nodehawkrc"] = 369,
    [".npmpackagejsonlintrc"] = 372,
    [".phraseapp.yml"] = 413,
    [".pmbot.yml"] = 403,
    [".postcssrc"] = 408,
    [".powerpages-web-template-manifest"] = 410,
    [".pre-commit-config.yml"] = 411,
    [".pre-commit-hooks.yml"] = 412,
    [".putout.json"] = 432,
    [".rehyperc"] = 444,
    [".remarkrc"] = 445,
    [".sprite files"] = 498,
    ...
    ["<div>RIOTS' studio configuration"] = 563,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 330,
    ["API Builder"] = 624,
    ["AVA Configuration"] = 680,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 655,
    ["All Contributors configuration file"] = 709,
    ...
    ["Azure Pipelines"] = 54,
    ["Azure Static Web Apps CLI configuration file"] = 501,
    ["Azure Static Web Apps configuration file"] = 500,
    ["BX CI"] = 89,
    ["Better Code Hub"] = 628,
    ["Better Scripts"] = 90,
    BizTalkServerApplicationSchema = 599,
    ...
    ["Butane Config"] = 667,
    ["CICS TS region tagging"] = 674,
    ["CICS TS resource import"] = 675,
    ["CICS TS resource model"] = 676,
    ["CICS TS resource overrides"] = 677,
    ["CMake Presets"] = 91,
    ["CNC Codes"] = 100,
    ...
    ["Datadog Service Definition"] = 309,
    ["Datahub Ingestion Recipe"] = 681,
    ["Dein Config"] = 105,
    Deno = 180,
    ["Deployer Recipe"] = 183,
    ["Deta Spacefile"] = 106,
    ...
    ["Goreleaser Pro"] = 254,
    Goss = 255,
    ["Gradle Build Cache Node"] = 626,
    ["Gradle Enterprise"] = 625,
    ["Grafana 5.x Dashboard"] = 256,
    ["GraphQL Code Generator"] = 259,
    ["GraphQL Config"] = 258,
    ["GraphQL Mesh"] = 257,
    ["Grunt JSHint task"] = 263,
    ["Grunt Watch task"] = 264,
    ["Grunt base task"] = 265,
    ["Grunt clean task"] = 261,
    ["Grunt copy task"] = 260,
    ["Grunt cssmin task"] = 262,
    HEMTT = 596,
    Hadolint = 608,
    Hammerkit = 635,
    ["Hardware Sentry Configuration"] = 685,
    Hayson = 267,
    ["Haystack Pipeline"] = 268,
    ["Hazelcast 5 Configuration"] = 269,
    ["Helm Chart.lock"] = 121,
    ["Helm Chart.yaml"] = 120,
    ["Helm Unittest Test Suite"] = 122,
    Hugo = 663,
    ["IBM Zapp document"] = 274,
    ["IBM zCodeFormatSettings"] = 275,
    ["IMG Catapult PSP"] = 280,
    Istanbul = 688,
    ["JDownloader2 crawler multi-rules"] = 290,
    ["JDownloader2 crawler single-rules"] = 289,
    ["JFrog File Spec"] = 291,
    ["JFrog Pipelines YML DSL"] = 694,
    ["JMeter DSL cli config"] = 292,
    JReleaser = 294,
    ["JSON Document Transform"] = 301,
    ["JSON Feed"] = 302,
    ["JSON Resume"] = 451,
    ["JSON Schema Draft 2020-12"] = 575,
    ["JSON Schema Draft 4"] = 572,
    ["JSON Schema Draft 7"] = 573,
    ["JSON Schema Draft 8 (2019-09)"] = 574,
    ["JSON-API"] = 300,
    ["JSON-e templates"] = 633,
    ["JSON-stat 2.0"] = 569,
    JSONPatch = 304,
    Jasmine = 285,
    Jekyll = 286,
    ["Jenkins X Pipelines"] = 287,
    ["Jenkins X Requirements"] = 288,
    ["Jovo Language Models"] = 293,
    ["KSP-AVC"] = 570,
    ["KSP-CKAN"] = 571,
    ["Karakum configuration file"] = 233,
    Kas = 307,
    ["Keycloak REST API"] = 701,
    ["Knative Functions - func.yaml"] = 234,
    ["KoDE/CI build.yaml"] = 690,
    ["Kong DBLess config"] = 691,
    KrakenD = 308,
    LOOBin = 325,
    Lefthook = 316,
    ["LinkML Metamodel"] = 323,
    Liquibase = 640,
    ["Liquibase Flow File"] = 641,
    ["Lively Properties"] = 324,
    ["MS2Rescore Configuration"] = 357,
    Markdownlint = 644,
    ["Mason Registry"] = 646,
    ["MegaLinter configuration"] = 331,
    ["MegaLinter descriptor"] = 332,
    ["Meltano plugin discovery definition"] = 334,
    ["Meltano project definition"] = 333,
    ["Microsoft Band Web Tile"] = 335,
    ["Minecraft Data Pack Advancement"] = 337,
    ["Minecraft Data Pack Biome"] = 338,
    ["Minecraft Data Pack Configured Carver"] = 339,
    ["Minecraft Data Pack Damage Type"] = 340,
    ["Minecraft Data Pack Dimension"] = 342,
    ["Minecraft Data Pack Dimension Type"] = 341,
    ["Minecraft Data Pack Item Modifier"] = 343,
    ["Minecraft Data Pack Loot Table"] = 344,
    ["Minecraft Data Pack Metadata"] = 345,
    ["Minecraft Data Pack Predicate"] = 346,
    ["Minecraft Data Pack Recipe"] = 347,
    ["Minecraft Data Pack Tag"] = 348,
    ["Minecraft Data Pack Template Pool"] = 349,
    ["Minecraft Data Pack Trim Material"] = 354,
    ["Minecraft Data Pack Trim Pattern"] = 355,
    ["Minecraft Resource Pack Lang"] = 350,
    ["Minecraft Resource Pack Particle"] = 351,
    ["Minecraft Resource Pack Texture Mcmeta"] = 353,
    ["Minecraft Resourcepack Sounds"] = 352,
    ["MkDocs Configuration 1.0"] = 356,
    ["MongoDB Atlas Search Index Definition"] = 689,
    ["Monika Configuration"] = 687,
    ["Motif config"] = 592,
    ["NOX Framework (Service)"] = 371,
    ["Netin Diagnostic System Template"] = 650,
    ["Netlify config"] = 362,
    ["Nexus-as-Code Data Model"] = 363,
    ["Nightwatch.js"] = 364,
    ["ONe's service descriptor"] = 384,
    ["OSS Review Toolkit configuration"] = 391,
    ["OSS Review Toolkit curation"] = 392,
    ["OSS Review Toolkit package configuration"] = 393,
    ["OSS Review Toolkit repository configuration"] = 394,
    ["OSS Review Toolkit resolutions"] = 395,
    Opctl = 595,
    ["OpenRewrite Resource"] = 386,
    ["OpenWeather Current Weather API"] = 632,
    ["OpenWeather Road Risk API"] = 631,
    ["Ory Hydra configuration"] = 273,
    ["Ory Keto configuration"] = 310,
    ["Ory Kratos configuration"] = 390,
    ["Ory Oathkeeper configuration"] = 378,
    ["Outblocks App configuration"] = 388,
    ["Outblocks database table"] = 389,
    ["Outblocks project configuration"] = 387,
    Packer = 398,
    Pantsbuild = 708,
    ["Paper paper-plugin.yml"] = 399,
    ["Pipeline component"] = 642,
    ["PocketMine plugin.yml"] = 404,
    ["Postman collection"] = 409,
    ["Problem package generators"] = 416,
    Pterodactyl = 684,
    ["Pull Request Labeler"] = 431,
    Pulumi = 437,
    PyProject = 438,
    Pyright = 439,
    Qgoda = 440,
    Qodana = 660,
    ["Quali Torque Blueprint Spec 2"] = 682,
    ["QueryFirst config file"] = 704,
    ["RKE Cluster Configuration JSON"] = 639,
    ["RKE Cluster Configuration YAML"] = 638,
    ["Rancher Fleet"] = 434,
    Ray = 607,
    ["Read the Docs"] = 436,
    ["Red-DiscordBot Cog"] = 441,
    ["Red-DiscordBot Cog Repo"] = 442,
    ["Red-DiscordBot Trivia"] = 443,
    Renovate = 452,
    ["Replit config"] = 446,
    RoadRunner = 453,
    Ruff = 449,
    ["Rust Project"] = 450,
    ["Rust toolchain"] = 455,
    ["SIL Kit Participant Configuration"] = 486,
    ["SIL Kit Registry Configuration"] = 487,
    SWADL = 510,
    ["Safebox Config"] = 695,
    ["Sapphire CLI Config"] = 458,
    ["SauceCTL Configuration"] = 647,
    ["Schema Catalog"] = 472,
    ["Scoop manifest"] = 477,
    ["Semantic Data Fabric (SDF) file"] = 478,
    ["Semgrep Rule"] = 480,
    ["Serenity Code Generator (Sergen)"] = 481,
    ["Serverless Framework Configuration"] = 654,
    ["Serverless Workflow"] = 656,
    ["Settings.paf"] = 483,
    ["Shopware 6 Configuration"] = 657,
    ["Shopware CLI Extension Store Configuration"] = 658,
    ["Shopware CLI Project Store Configuration"] = 659,
    ["Sigrid scope configuration file"] = 485,
    ["Slack app manifest"] = 489,
    Solidarity = 492,
    ["Solution filters"] = 493,
    ["Source Maps v3"] = 494,
    Sourcery = 495,
    SpecIF = 496,
    ["Sponge Mixin configuration"] = 497,
    ["StackHawk Scanner Configuration"] = 653,
    Stale = 502,
    ["Starlake Data Pipeline"] = 629,
    Starship = 503,
    ["Statamic Blueprint"] = 504,
    ["StrmPrivacy Data Connector"] = 699,
    ["StrmPrivacy Data Contract"] = 700,
    ["StrmPrivacy SimpleSchema"] = 697,
    ["StrmPrivacy Stream"] = 698,
    ["StrmPrivacy batch job configuration file"] = 696,
    ["Stryker Mutator"] = 507,
    ["StyleCop Analyzers Configuration"] = 508,
    ["Swagger API 2.0"] = 511,
    TSON = 535,
    ["Talisman configuration"] = 513,
    ["Taskfile config"] = 634,
    Taurus = 514,
    ["TestEnvironment.json"] = 523,
    ["Tier.run pricing.json"] = 517,
    Tikibase = 518,
    ["Traefik v2"] = 526,
    ["Traefik v2 File Provider"] = 527,
    Turborepo = 524,
    Tye = 661,
    ["UET BuildConfig.json"] = 705,
    ["UI5 Manifest"] = 542,
    ["UTAM Page Object"] = 545,
    ["Ubuntu Server Autoinstall"] = 540,
    ["Uniswap Token List"] = 617,
    ["Unreal Engine Uplugin"] = 706,
    ["Unreal Engine Uproject"] = 707,
    Updatecli = 668,
    Uplift = 703,
    ["User Journey Map"] = 637,
    V2Ray = 672,
    ["VSCode Code Snippets"] = 138,
    ["VSIX CLI publishing"] = 558,
    ["Vela Pipeline Configuration"] = 548,
    Vercel = 137,
    ["Web App Manifest"] = 565,
    ["Web types"] = 568,
    WebExtensions = 564,
    ["Webman package recipe"] = 678,
    ["Windows Package Manager Installer Manifest"] = 614,
    ["Windows Package Manager Locale Manifest"] = 615,
    ["Windows Package Manager Singleton Manifest"] = 613,
    ["Woodpecker pipeline config"] = 649,
    ["Xstate Machine"] = 666,
    ["Yippee-Ki-JSON configuration YML"] = 619,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 65,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 714,
    ["bashly-strings.yml"] = 715,
    ["bashly.yml"] = 713,
    ["batect.yml"] = 64,
    ...
    ["ide.host.json"] = 276,
    ["ifstate.conf"] = 277,
    ["imageoptimizer.json"] = 278,
    ["importmap.json"] = 281,
    ["ioBroker Configuration"] = 282,
    ["ioBroker JSON UI"] = 283,
    ["ioBroker Package manifest"] = 284,
    ["ize.toml"] = 702,
    ["jsconfig.json"] = 305,
    ["jscpd Configuration"] = 683,
    jsdoc = 606,
    ["k3d.yaml"] = 306,
    ["kontinuous-config.yaml"] = 312,
    ["kontinuous-values.yaml"] = 311,
    ["kustomization.yaml"] = 313,
    ["label-commenter-config.yml"] = 314,
    ["launchsettings.json"] = 315,
    lazydocker = 724,
    lazygit = 723,
    ["lego.json"] = 317,
    ["lerna.json"] = 318,
    ["lgtm.yml"] = 319,
    ["libman.json"] = 320,
    ["license-report-config.json"] = 321,
    ["linkinator.config.json"] = 322,
    ["local.settings.json"] = 327,
    ["localazy.json"] = 328,
    ["lotus.yaml"] = 326,
    ["lsdlschema.json"] = 329,
    ["madness.yml"] = 712,
    ["markdown-lint-check"] = 645,
    mboats = 652,
    ["micro-settings.json"] = 717,
    ["mimetypes.json"] = 336,
    ["mirrord config"] = 589,
    ["mta.yaml"] = 590,
    ["mtad.yaml"] = 591,
    ["mycode.json"] = 360,
    ["napari plugin manifest"] = 361,
    neoload = 601,
    ["nest-cli"] = 367,
    ["ninjs (News in JSON) 1.3"] = 366,
    ["ninjs (News in JSON) 2.0"] = 365,
    ["nlu.json"] = 368,
    ["nodemon.json"] = 370,
    ["noodl config"] = 651,
    now = 597,
    ...
    ["nswag.json"] = 376,
    ntangle = 377,
    ["nuclei-template.yaml"] = 374,
    ["nuget-project.json"] = 375,
    ["ocelot.json"] = 379,
    ["omnisharp.json"] = 380,
    ["openapi.json"] = 381,
    ["openfin.json"] = 385,
    ...
    ["ops.yaml"] = 383,
    ["package.json"] = 396,
    ["package.manifest"] = 397,
    ["pathfinder.yml"] = 400,
    ["pattern.json"] = 402,
    ["petstore-v1.0"] = 693,
    pgap_yaml_input_reader = 401,
    ["plagiarize-me.yaml"] = 406,
    ["plagiarize.yaml"] = 405,
    ["portman.json"] = 407,
    ["prettierrc.json"] = 414,
    ["prisma.yml"] = 415,
    ["project-1.0.0-beta3.json"] = 418,
    ["project-1.0.0-beta4.json"] = 419,
    ["project-1.0.0-beta5.json"] = 420,
    ["project-1.0.0-beta6.json"] = 421,
    ["project-1.0.0-beta8.json"] = 422,
    ["project-1.0.0-rc1.json"] = 423,
    ["project-1.0.0-rc2.json"] = 424,
    ["project.json"] = 417,
    ["prometheus.json"] = 425,
    ["prometheus.rules.json"] = 426,
    ["prometheus.rules.test.json"] = 427,
    ["proxies.json"] = 428,
    ["publiccode.yml"] = 429,
    ["pubspec.yaml"] = 430,
    ["pyrseas-0.8.json"] = 433,
    ["quilt.mod.json"] = 718,
    ["release drafter"] = 602,
    rtx = 448,
    rustfmt = 454,
    samt = 456,
    samtrc = 457,
    ["sarif-1.0.0.json"] = 459,
    ["sarif-2.0.0.json"] = 460,
    ["sarif-2.1.0"] = 470,
    ["sarif-2.1.0-rtm.2"] = 461,
    ["sarif-2.1.0-rtm.3"] = 463,
    ["sarif-2.1.0-rtm.4"] = 465,
    ["sarif-2.1.0-rtm.5"] = 467,
    ["sarif-2.1.0-rtm.6"] = 468,
    ["sarif-external-property-file-2.1.0"] = 471,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 462,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 464,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 466,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 469,
    ["schema.org - Action"] = 473,
    ["schema.org - ContactPoint"] = 474,
    ["schema.org - Place"] = 475,
    ["schema.org - Thing"] = 476,
    ["secrethub.yml"] = 720,
    ["semantic-release"] = 479,
    ["servicehub.config.json"] = 578,
    ["servicehub.service.json"] = 577,
    ["settings.job"] = 482,
    ["sfdx-hardis configuration"] = 484,
    ["size-limit configuration"] = 488,
    ["skaffold.yaml"] = 643,
    ["skyuxconfig.json"] = 490,
    snapcraft = 491,
    ["sqlc configuration"] = 499,
    ["stripe-app-local.json"] = 506,
    ["stripe-app.json"] = 505,
    swcrc = 630,
    syntax = 722,
    ["task.json"] = 512,
    taskcat = 598,
    ["template.json"] = 515,
    ["templatsources.json"] = 516,
    ["theme.json"] = 519,
    ["tizen_workspace.json"] = 520,
    tldr = 521,
    tmLanguage = 522,
    tmuxinator = 586,
    ["transcend.yml"] = 528,
    ["trunk.yaml"] = 529,
    ["ts-force-config.json"] = 533,
    ["tsconfig.json"] = 530,
    ["tsd.json"] = 531,
    ["tsdrc.json"] = 532,
    ["tslint.json"] = 534,
    ...
    ["vega-lite.json"] = 547,
    ["vega.json"] = 546,
    ["venvironment-basic.yaml"] = 550,
    ["venvironment.yaml"] = 549,
    ["version.json"] = 551,
    ["vim-addon-info"] = 552,
    ["vs-2017.3.host.json"] = 554,
    ["vs-nesting.json"] = 555,
    ["vsls.json"] = 553,
    ["vss-extension.json"] = 559,
    ["vtesttree.yaml"] = 560,
    ["vtestunit.yaml"] = 561,
    ["warp-keysets.json"] = 726,
    ["warp-themes.json"] = 727,
    ["warp-workflows.json"] = 728,
    ["webhint.io"] = 679,
    ["webjobpublishsettings.json"] = 567,
    ["webjobs-list.json"] = 566,
    ["xs-app.json"] = 594,
    ["xunit.runner.json"] = 576,
    yamllint = 618,
    zuul = 603,
    ["Žinoma"] = 612
  },
