...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 148,
    [".cryproj (generic)"] = 500,
    [".cryproj engine-5.2"] = 495,
    [".cryproj engine-5.3"] = 496,
    [".cryproj engine-5.4"] = 497,
    [".cryproj engine-5.5"] = 498,
    [".cryproj engine-dev"] = 499,
    [".csscomb.json"] = 150,
    [".csslintrc"] = 151,
    [".eslintrc"] = 196,
    [".esmrc.json"] = 188,
    ...
    [".mtaext"] = 509,
    [".nodehawkrc"] = 316,
    [".npmpackagejsonlintrc"] = 319,
    [".phraseapp.yml"] = 353,
    [".pmbot.yml"] = 345,
    [".postcssrc"] = 350,
    [".pre-commit-config.yml"] = 351,
    [".pre-commit-hooks.yml"] = 352,
    [".putout.json"] = 370,
    [".rehyperc"] = 377,
    [".remarkrc"] = 378,
    [".sprite files"] = 421,
    ...
    [".vsext"] = 475,
    [".yarnrc.yml"] = 541,
    ["<div>RIOTS' studio configuration"] = 479,
    ["@factorial/drupal-breakpoints-css"] = 5,
    ["A micro editor config schema"] = 285,
    ["API Builder"] = 538,
    ["AVA Configuration Schema"] = 594,
    ["AWS CDK cdk.json"] = 136,
    ["AWS CloudFormation"] = 137,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 138,
    ["Airlock Microgateway"] = 9,
    ["Airplane task"] = 10,
    ["Alacritty Configuration Schema"] = 569,
    ...
    ["Azure Pipelines"] = 47,
    ["Azure Static Web Apps CLI configuration file"] = 423,
    ["Azure Static Web Apps configuration file"] = 422,
    ["BX CI"] = 80,
    ["Better Code Hub"] = 543,
    ["Better Scripts"] = 81,
    BizTalkServerApplicationSchema = 515,
    ["Block Protocol Metadata"] = 79,
    Briefcase = 520,
    ["Build Info"] = 72,
    Buildkite = 74,
    ["Bukkit plugin.yml"] = 73,
    ["BungeeCord plugin.yml"] = 77,
    ["Butane Config"] = 581,
    ["CICS TS region tagging"] = 588,
    ["CICS TS resource import"] = 589,
    ["CICS TS resource model"] = 590,
    ["CICS TS resource overrides"] = 591,
    ["CMake Presets"] = 82,
    ["CNC Codes JSON Schema"] = 91,
    ["Calqulus pipeline"] = 83,
    ["Camel YAML DSL"] = 84,
    Carafe = 85,
    ["Cargo Config Schema"] = 86,
    ["Cargo Make"] = 87,
    ["Catalog Info Backstage"] = 88,
    Cheatsheets = 578,
    ["Chrome Extension"] = 130,
    ["CircleCI config.yml"] = 111,
    ["Citation File Format"] = 139,
    CityJSON = 89,
    ["Code Climate"] = 112,
    CodeCV = 46,
    Codux = 119,
    ["Commandbox Box.json"] = 92,
    ["Commandbox Server.json"] = 93,
    ["Common Catalog Schema"] = 128,
    ["Common types for all schemas"] = 1,
    Conjure = 90,
    ["Container Structure Test"] = 526,
    Containerlab = 551,
    ["DWP Exchange - catalogue entry"] = 185,
    ["DWP Exchange - gateway"] = 183,
    ["DWP Exchange - meta"] = 184,
    ["Dart build configuration"] = 152,
    ["Dart test config"] = 153,
    ["DashLord configuration"] = 154,
    ["Datadog Service Definition"] = 269,
    ["Datahub Ingestion Recipe Schema"] = 595,
    ["Dein Config Schema"] = 95,
    Deno = 158,
    ["Deployer Recipe"] = 161,
    Devfile = 182,
    ["Discord Webhook"] = 163,
    ["Dolittle Artifacts"] = 167,
    ["Dolittle Bounded Context Configuration"] = 168,
    ["Dolittle Event Horizons Configuration"] = 169,
    ["Dolittle Resources Configuration"] = 170,
    ["Dolittle Server Configuration"] = 171,
    ["Dolittle Tenant Map Configuration"] = 173,
    ["Dolittle Tenants Configuration"] = 172,
    ["Dolittle Topology"] = 174,
    ["Drupal Breakpoints Schema"] = 96,
    ["Drupal Config Schema"] = 107,
    ["Drupal Info Schema"] = 97,
    ["Drupal Layouts Schema"] = 98,
    ["Drupal Libraries Schema"] = 99,
    ["Drupal Links Action Schema"] = 100,
    ["Drupal Links Contextual Schema"] = 101,
    ["Drupal Links Menu Schema"] = 102,
    ["Drupal Links Task Schema"] = 103,
    ["Drupal Migration Schema"] = 104,
    ["Drupal Permissions Schema"] = 105,
    ["Drupal Routing Schema"] = 106,
    ["Drupal Services Schema"] = 108,
    ["Drush site aliases"] = 178,
    ["Embrace Config Schema"] = 606,
    ["Error pages"] = 191,
    Esquio = 189,
    ["Estuary Flow Catalog Schema"] = 585,
    ["Expo SDK"] = 194,
    ["F-Droid Data metadata"] = 199,
    ["Facets - FSDL - Application"] = 197,
    ["Fossa configuration file"] = 204,
    ["Fossa's fossa-deps file"] = 205,
    ["Foundry VTT - Manifest"] = 202,
    ["Foundry VTT - Template"] = 203,
    ["Foxx Manifest"] = 48,
    ["Freifunk.de Community API"] = 51,
    ["GatewayCore API Gateway"] = 208,
    ["GeoJSON.json latest"] = 583,
    GherKing = 587,
    ["GitHub Action"] = 212,
    ["GitHub Funding"] = 213,
    ["GitHub Issue Template configuration"] = 215,
    ["GitHub Workflow"] = 216,
    ["GitHub Workflow Template Properties"] = 217,
    ["GitHub issue forms"] = 214,
    GitVersion = 211,
    ["Gitpod Configuration"] = 219,
    ["Global Privacy Control"] = 209,
    ["Google Cloud Workflows"] = 135,
    Goreleaser = 222,
    ["Goreleaser Pro"] = 223,
    ["Gradle Build Cache Node"] = 540,
    ["Gradle Enterprise"] = 539,
    ["Grafana 5.x Dashboard"] = 224,
    ["GraphQL Code Generator"] = 227,
    ["GraphQL Config"] = 226,
    ["GraphQL Mesh"] = 225,
    ["Grunt JSHint task"] = 231,
    ["Grunt Watch task"] = 232,
    ["Grunt base task"] = 233,
    ["Grunt clean task"] = 229,
    ["Grunt copy task"] = 228,
    ["Grunt cssmin task"] = 230,
    HEMTT = 512,
    Hadolint = 524,
    Hammerkit = 550,
    ["Hardware Sentry Configuration"] = 599,
    Hayson = 235,
    ["Haystack Pipeline"] = 236,
    ["Hazelcast 5 Configuration"] = 237,
    ["Helm Chart.lock"] = 110,
    ["Helm Chart.yaml"] = 109,
    Hugo = 577,
    ["Istanbul Schema"] = 602,
    ["JDownloader2 crawler multi-rule schema"] = 253,
    ["JDownloader2 crawler single-rule schema"] = 252,
    ["JFrog File Spec"] = 254,
    ["JFrog Pipelines YML DSL"] = 608,
    ["JSON Document Transform"] = 262,
    ["JSON Feed"] = 263,
    ["JSON Resume"] = 383,
    ["JSON Schema Draft 2020-12"] = 491,
    ["JSON Schema Draft 4"] = 488,
    ["JSON Schema Draft 7"] = 489,
    ["JSON Schema Draft 8"] = 490,
    ["JSON schema for CodeShip Pro services configuration files"] = 121,
    ["JSON schema for CodeShip Pro steps configuration files"] = 122,
    ["JSON schema for Codecov configuration files"] = 120,
    ["JSON-API"] = 261,
    ["JSON-e templates"] = 548,
    ["JSON-stat 2.0"] = 485,
    JSONPatch = 265,
    Jasmine = 248,
    Jekyll = 249,
    ["Jenkins X Pipelines"] = 250,
    ["Jenkins X Requirements"] = 251,
    ["Jovo Language Models"] = 255,
    ["KSP-AVC"] = 486,
    ["KSP-CKAN"] = 487,
    ["Keycloak REST API"] = 614,
    ["Knative Functions - func.yaml"] = 206,
    ["KoDE/CI build.yaml"] = 604,
    ["Kong DBLess Schema"] = 605,
    KrakenD = 268,
    ["LinkML Metamodel"] = 280,
    Liquibase = 555,
    ["Liquibase Flow File"] = 556,
    ["Lively Properties"] = 281,
    Markdownlint = 559,
    ["MegaLinter configuration"] = 286,
    ["MegaLinter descriptor"] = 287,
    ["Meltano plugin discovery definition"] = 289,
    ["Meltano project definition"] = 288,
    ["Microsoft Band Web Tile"] = 290,
    ["Minecraft Data Pack Advancement"] = 292,
    ["Minecraft Data Pack Biome"] = 293,
    ["Minecraft Data Pack Configured Carver"] = 294,
    ["Minecraft Data Pack Dimension"] = 296,
    ["Minecraft Data Pack Dimension Type"] = 295,
    ["Minecraft Data Pack Item Modifier"] = 297,
    ["Minecraft Data Pack Loot Table"] = 298,
    ["Minecraft Data Pack Metadata"] = 299,
    ["Minecraft Data Pack Predicate"] = 300,
    ["Minecraft Data Pack Recipe"] = 301,
    ["Minecraft Data Pack Tag"] = 302,
    ["Minecraft Data Pack Template Pool"] = 303,
    ["Minecraft Resourcepack Sounds"] = 304,
    ["MkDocs Configuration 1.0"] = 305,
    ["MongoDB Atlas Search Index Definition Schema"] = 603,
    ["Monika Configuration Schema"] = 601,
    ["Motif config"] = 508,
    ["NOX Framework (Service)"] = 318,
    ["Netin Diagnostic System Template"] = 564,
    ["Netlify config schema"] = 310,
    ["Nightwatch.js"] = 311,
    ["OSS Review Toolkit configuration"] = 335,
    ["OSS Review Toolkit curation"] = 336,
    ["OSS Review Toolkit package configuration"] = 337,
    ["OSS Review Toolkit repository configuration"] = 338,
    ["OSS Review Toolkit resolutions"] = 339,
    Opctl = 511,
    ["OpenWeather Current Weather API"] = 547,
    ["OpenWeather Road Risk API"] = 546,
    ["Ory Hydra configuration"] = 241,
    ["Ory Keto configuration"] = 270,
    ["Ory Kratos configuration"] = 334,
    ["Ory Oathkeeper configuration"] = 325,
    ["Outblocks App configuration"] = 332,
    ["Outblocks database table"] = 333,
    ["Outblocks project configuration"] = 331,
    Packer = 342,
    Pantsbuild = 620,
    ["Pipeline component"] = 557,
    ["PocketMine plugin.yml"] = 346,
    Pterodactyl = 598,
    ["Pull Request Labeler"] = 369,
    Pulumi = 373,
    PyProject = 374,
    Qodana = 574,
    ["Quali Torque Blueprint Spec 2"] = 596,
    ["QueryFirst config file"] = 617,
    ["RKE Cluster Configuration JSON Schema"] = 554,
    ["RKE Cluster Configuration YAML Schema"] = 553,
    Ray = 523,
    ["Read the Docs"] = 372,
    ["Red-DiscordBot Cog"] = 375,
    ["Red-DiscordBot Cog Repo"] = 376,
    Renovate = 384,
    ["Replit schema"] = 379,
    RoadRunner = 385,
    Ruff = 381,
    ["Rust Project"] = 382,
    ["Rust toolchain"] = 387,
    ["SIL Kit Participant Configuration"] = 412,
    SWADL = 432,
    ["Sapphire CLI Config"] = 388,
    ["SauceCTL Configuration"] = 561,
    ["Schema Catalog"] = 401,
    ["Scoop manifest"] = 406,
    ["Semgrep Rule"] = 408,
    ["Serverless Framework Configuration"] = 568,
    ["Serverless Workflow Schema"] = 570,
    ["Settings.paf"] = 410,
    ["Shopware 6 Configuration"] = 571,
    ["Shopware CLI Extension Store Configuration"] = 572,
    ["Shopware CLI Project Store Configuration"] = 573,
    Solidarity = 416,
    ["Solution filters"] = 417,
    ["Source Maps v3"] = 418,
    SpecIF = 419,
    ["Sponge Mixin configuration"] = 420,
    ["StackHawk Scanner Configuration"] = 567,
    Stale = 424,
    Starship = 425,
    ["Statamic Blueprint"] = 426,
    ["StrmPrivacy Data Connector"] = 612,
    ["StrmPrivacy Data Contract"] = 613,
    ["StrmPrivacy SimpleSchema"] = 610,
    ["StrmPrivacy Stream"] = 611,
    ["StrmPrivacy batch job configuration file"] = 609,
    ["Stryker Mutator"] = 429,
    ["StyleCop Analyzers Configuration"] = 430,
    ["Swagger API 2.0"] = 433,
    TSON = 453,
    ["Talisman configuration"] = 434,
    ["Taskfile YAML Schema"] = 549,
    Taurus = 435,
    ["TestEnvironment.json"] = 442,
    Tikibase = 438,
    ["Traefik v2"] = 445,
    ["Traefik v2 File Provider"] = 446,
    Turborepo = 443,
    Tye = 575,
    ["UI5 Manifest"] = 460,
    ["UTAM Page Object"] = 463,
    ["Ubuntu Server Autoinstall"] = 458,
    ["Uniswap Token List"] = 532,
    ["Unreal Engine Uplugin"] = 618,
    ["Unreal Engine Uproject"] = 619,
    Updatecli = 582,
    Uplift = 616,
    ["User Journey Map YAML Schema"] = 552,
    V2Ray = 586,
    ["VSCode Code Snippets"] = 124,
    ["VSIX CLI publishing"] = 476,
    ["Vela Pipeline Configuration"] = 466,
    Vercel = 123,
    ["Web App Manifest"] = 481,
    ["Web types"] = 484,
    WebExtensions = 480,
    ["Webman package recipe"] = 592,
    ["Windows Package Manager Installer Manifest"] = 529,
    ["Windows Package Manager Locale Manifest"] = 530,
    ["Windows Package Manager Singleton Manifest"] = 528,
    ["Woodpecker pipeline config"] = 563,
    ["Xstate Machine Schema"] = 580,
    ["Yippee-Ki-JSON configuration YML"] = 534,
    ["angular.json"] = 11,
    ...
    ["batect.yml"] = 55,
    ["beau.yml"] = 542,
    ["beef-database-codegen"] = 57,
    ["beef-database-v5-codegen"] = 59,
    ["beef-entity-codegen"] = 58,
    ["beef-entity-v5-codegen"] = 60,
    ["behat.yml"] = 68,
    ["bigquery-table"] = 61,
    ["bitbucket-pipelines"] = 62,
    bitrise = 63,
    ["bitrise-step"] = 64,
    ["block.json"] = 78,
    ["bower.json"] = 66,
    ["bozr.suite.json"] = 69,
    ["browser.i18n.json"] = 70,
    bucklescript = 71,
    ["bundleconfig.json"] = 76,
    ["chutzpah.json"] = 131,
    clangd = 115,
    ["cloud-init: cloud-config userdata JSON schema"] = 117,
    ["cloud-sdk-pipeline-config-schema"] = 133,
    ["cloudbuild.json"] = 134,
    cloudify = 116,
    codemagic = 118,
    ["coffeelint.json"] = 140,
    comet = 544,
    ["commands.json"] = 127,
    ["compile_commands.json"] = 126,
    ["compilerconfig.json"] = 125,
    ["component-detection-manifest.json"] = 143,
    ["component.json"] = 142,
    ["composer.json"] = 141,
    ["config.json"] = 144,
    ["contentmanifest.json"] = 132,
    ["contribute.json"] = 145,
    ["cosmos.config.json"] = 129,
    ["crowdin.yml"] = 146,
    cspell = 149,
    ["cypress.json"] = 147,
    ["datalogic-scan2deploy-android"] = 155,
    ["datalogic-scan2deploy-ce"] = 156,
    ["dbt Project"] = 94,
    ["debugsettings.json"] = 157,
    ["dependabot-v2.json"] = 160,
    ["dependabot.json"] = 159,
    ["deployed-cli"] = 579,
    ["detekt.yml"] = 162,
    devinit = 536,
    ["devspace.yaml"] = 600,
    ["docfx.json"] = 166,
    ["docker-compose.yml"] = 535,
    ["docker-seq schema"] = 165,
    ["dockerd.json"] = 164,
    ["dotnet Release Index manifest"] = 175,
    ["dotnetcli.host.json"] = 176,
    ["drone.json"] = 177,
    ["dss-2.0.0.json"] = 179,
    ["dstack Workflows"] = 180,
    ["dvc.yaml"] = 181,
    ["ecosystem.json"] = 186,
    eksctl = 187,
    ["electron-builder configuration file."] = 192,
    ["epr-manifest.json"] = 190,
    ["evcc.yaml"] = 193,
    ["ezd schema"] = 195,
    ["fabric.mod.json"] = 198,
    ["first-timers-bot"] = 201,
    ...
    ["gitlab-ci"] = 218,
    ["global.json"] = 220,
    ["golangci-lint Configuration"] = 221,
    ["haxelib.json"] = 234,
    helmfile = 525,
    ["host-meta.json"] = 239,
    ["host.json"] = 238,
    ...
    huskyrc = 503,
    ["ide.host.json"] = 242,
    ["imageoptimizer.json"] = 243,
    ["importmap.json"] = 245,
    ["ioBroker JSON UI"] = 246,
    ["ioBroker Package manifest"] = 247,
    ["ize.toml"] = 615,
    ["jsconfig.json"] = 266,
    ["jscpd Configuration Schema"] = 597,
    jsdoc = 522,
    ["k3d.yaml"] = 267,
    ["kustomization.yaml"] = 271,
    ["label-commenter-config.yml"] = 272,
    ["launchsettings.json"] = 273,
    ["lego.json"] = 274,
    ["lerna.json"] = 275,
    ["lgtm.yml"] = 276,
    ["libman.json"] = 277,
    ["license-report-config.json"] = 278,
    ["linkinator.config.json"] = 279,
    ["local.settings.json"] = 282,
    ["localazy.json"] = 283,
    ["lsdlschema.json"] = 284,
    ["markdown-lint-check"] = 560,
    mboats = 566,
    ["mimetypes.json"] = 291,
    ["mirrord-schema"] = 505,
    ["mta.yaml"] = 506,
    ["mtad.yaml"] = 507,
    ["mycode.json"] = 308,
    ["napari plugin manifest"] = 309,
    neoload = 517,
    ["nest-cli"] = 314,
    ["ninjs (News in JSON) 1.3"] = 313,
    ["ninjs (News in JSON) 2.0"] = 312,
    ["nlu.json"] = 315,
    ["nodemon.json"] = 317,
    ["noodl.schema.json"] = 565,
    now = 513,
    ["npm-badges"] = 320,
    ["nswag.json"] = 323,
    ntangle = 324,
    ["nuclei-template.yaml"] = 321,
    ["nuget-project.json"] = 322,
    ["ocelot.json"] = 326,
    ["omnisharp.json"] = 327,
    ["openapi.json"] = 328,
    ["openfin.json"] = 330,
    ["openrpc.json"] = 329,
    ["package.json"] = 340,
    ["package.manifest"] = 341,
    ["pattern.json"] = 344,
    ["petstore-v1.0"] = 607,
    pgap_yaml_input_reader = 343,
    ["plagiarize-me.yaml"] = 348,
    ["plagiarize.yaml"] = 347,
    ["portman.json"] = 349,
    ["prettierrc.json"] = 354,
    ["prisma.yml"] = 355,
    ["project-1.0.0-beta3.json"] = 357,
    ["project-1.0.0-beta4.json"] = 358,
    ["project-1.0.0-beta5.json"] = 359,
    ["project-1.0.0-beta6.json"] = 360,
    ["project-1.0.0-beta8.json"] = 361,
    ["project-1.0.0-rc1.json"] = 362,
    ["project-1.0.0-rc2.json"] = 363,
    ["project.json"] = 356,
    ["prometheus.json"] = 364,
    ["prometheus.rules.json"] = 365,
    ["proxies.json"] = 366,
    ["publiccode.yml"] = 367,
    ["pubspec.yaml"] = 368,
    ["pyrseas-0.8.json"] = 371,
    ["release drafter"] = 518,
    rustfmt = 386,
    ["sarif-1.0.0.json"] = 389,
    ["sarif-2.0.0.json"] = 390,
    ["sarif-2.1.0"] = 399,
    ["sarif-2.1.0-rtm.2"] = 391,
    ["sarif-2.1.0-rtm.3"] = 393,
    ["sarif-2.1.0-rtm.4"] = 395,
    ["sarif-2.1.0-rtm.5"] = 397,
    ["sarif-external-property-file-2.1.0"] = 400,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 392,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 394,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 396,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 398,
    ["schema.org - Action"] = 402,
    ["schema.org - ContactPoint"] = 403,
    ["schema.org - Place"] = 404,
    ["schema.org - Thing"] = 405,
    ["semantic-release"] = 407,
    ["servicehub.config.json"] = 494,
    ["servicehub.service.json"] = 493,
    ["settings.job"] = 409,
    ["sfdx-hardis configuration"] = 411,
    ["size-limit configuration"] = 413,
    ["skaffold.yaml"] = 558,
    ["skyuxconfig.json"] = 414,
    snapcraft = 415,
    ["stripe-app-local.json"] = 428,
    ["stripe-app.json"] = 427,
    swcrc = 545,
    taskcat = 514,
    ["template.json"] = 436,
    ["templatsources.json"] = 437,
    ["theme.json"] = 439,
    ["tizen_workspace.json"] = 440,
    tmLanguage = 441,
    tmuxinator = 502,
    ["trunk.yaml schema"] = 447,
    ["ts-force-config.json"] = 451,
    ["tsconfig.json"] = 448,
    ["tsd.json"] = 449,
    ["tsdrc.json"] = 450,
    ["tslint.json"] = 452,
    ...
    ["vega-lite.json"] = 465,
    ["vega.json"] = 464,
    ["venvironment-basic.yaml"] = 468,
    ["venvironment.yaml"] = 467,
    ["version.json"] = 469,
    ["vim-addon-info"] = 470,
    ["vs-2017.3.host.json"] = 472,
    ["vs-nesting.json"] = 473,
    ["vsls.json"] = 471,
    ["vss-extension.json"] = 477,
    ["webhint.io"] = 593,
    ["webjobpublishsettings.json"] = 483,
    ["webjobs-list.json"] = 482,
    ["xs-app.json"] = 510,
    ["xunit.runner.json"] = 492,
    yamllint = 533,
    zuul = 519,
    ["Žinoma"] = 527
  },
