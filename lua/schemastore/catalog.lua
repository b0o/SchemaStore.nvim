...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 157,
    [".cryproj (generic)"] = 531,
    [".cryproj engine-5.2"] = 526,
    [".cryproj engine-5.3"] = 527,
    [".cryproj engine-5.4"] = 528,
    [".cryproj engine-5.5"] = 529,
    [".cryproj engine-dev"] = 530,
    [".csscomb.json"] = 159,
    [".csslintrc"] = 160,
    [".eslintrc"] = 205,
    [".esmrc.json"] = 197,
    ...
    [".mtaext"] = 540,
    [".nodehawkrc"] = 337,
    [".npmpackagejsonlintrc"] = 340,
    [".phraseapp.yml"] = 375,
    [".pmbot.yml"] = 367,
    [".postcssrc"] = 372,
    [".pre-commit-config.yml"] = 373,
    [".pre-commit-hooks.yml"] = 374,
    [".putout.json"] = 392,
    [".rehyperc"] = 401,
    [".remarkrc"] = 402,
    [".sprite files"] = 449,
    ...
    [".vsext"] = 506,
    [".yarnrc.yml"] = 572,
    ["<div>RIOTS' studio configuration"] = 510,
    ["@factorial/drupal-breakpoints-css"] = 5,
    ["A micro editor config schema"] = 302,
    ["API Builder"] = 569,
    ["AVA Configuration Schema"] = 625,
    ["AWS CDK cdk.json"] = 142,
    ["AWS CloudFormation"] = 143,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 144,
    ["Airlock Microgateway"] = 9,
    ["Airplane task"] = 10,
    ["Alacritty Configuration Schema"] = 600,
    ["All Contributors configuration file"] = 652,
    ...
    ["Azure Pipelines"] = 48,
    ["Azure Static Web Apps CLI configuration file"] = 451,
    ["Azure Static Web Apps configuration file"] = 450,
    ["BX CI"] = 83,
    ["Better Code Hub"] = 574,
    ["Better Scripts"] = 84,
    BizTalkServerApplicationSchema = 546,
    ...
    ["Butane Config"] = 612,
    ["CICS TS region tagging"] = 619,
    ["CICS TS resource import"] = 620,
    ["CICS TS resource model"] = 621,
    ["CICS TS resource overrides"] = 622,
    ["CMake Presets"] = 85,
    ...
    Cheatsheets = 609,
    ["Chrome Extension"] = 136,
    ["CircleCI config.yml"] = 116,
    ["Citation File Format"] = 145,
    CityJSON = 92,
    ["Code Climate"] = 117,
    CodeCV = 47,
    Codux = 124,
    ...
    ["Common Catalog Schema"] = 134,
    ["Common types for all schemas"] = 1,
    Conjure = 93,
    ["Container Structure Test"] = 557,
    Containerlab = 582,
    ["Crowdsec collection Schema"] = 153,
    ["Crowdsec parser Schema"] = 154,
    ["Crowdsec scenario Schema"] = 155,
    ["DWP Exchange - catalogue entry"] = 194,
    ["DWP Exchange - gateway"] = 192,
    ["DWP Exchange - meta"] = 193,
    ["Dart build configuration"] = 161,
    ["Dart test config"] = 162,
    ["DashLord configuration"] = 163,
    ["Datadog Service Definition"] = 285,
    ["Datahub Ingestion Recipe Schema"] = 626,
    ["Dein Config Schema"] = 99,
    Deno = 167,
    ["Deployer Recipe"] = 170,
    Devfile = 191,
    ["Discord Webhook"] = 172,
    ["Dolittle Artifacts"] = 176,
    ["Dolittle Bounded Context Configuration"] = 177,
    ["Dolittle Event Horizons Configuration"] = 178,
    ["Dolittle Resources Configuration"] = 179,
    ["Dolittle Server Configuration"] = 180,
    ["Dolittle Tenant Map Configuration"] = 182,
    ["Dolittle Tenants Configuration"] = 181,
    ["Dolittle Topology"] = 183,
    ["Drupal Breakpoints Schema"] = 100,
    ["Drupal Config Schema"] = 111,
    ["Drupal Info Schema"] = 101,
    ["Drupal Layouts Schema"] = 102,
    ["Drupal Libraries Schema"] = 103,
    ["Drupal Links Action Schema"] = 104,
    ["Drupal Links Contextual Schema"] = 105,
    ["Drupal Links Menu Schema"] = 106,
    ["Drupal Links Task Schema"] = 107,
    ["Drupal Migration Schema"] = 108,
    ["Drupal Permissions Schema"] = 109,
    ["Drupal Routing Schema"] = 110,
    ["Drupal Services Schema"] = 112,
    ["Drush site aliases"] = 187,
    ["Embrace Config Schema"] = 637,
    ["Error pages"] = 200,
    Esquio = 198,
    ["Estuary Flow Catalog Schema"] = 616,
    ["Expo SDK"] = 203,
    ["F-Droid Data metadata"] = 208,
    ["Facets - FSDL - Application"] = 206,
    ["FasterCI Configuration"] = 49,
    ["Fossa configuration file"] = 213,
    ["Fossa's fossa-deps file"] = 214,
    ["Foundry VTT - Manifest"] = 211,
    ["Foundry VTT - Template"] = 212,
    ["Foxx Manifest"] = 50,
    ["Freifunk.de Community API"] = 53,
    ["Frogbot Config"] = 54,
    ["GatewayCore API Gateway"] = 217,
    ["GeoJSON.json latest"] = 614,
    GherKing = 618,
    ["GitHub Action"] = 221,
    ["GitHub Discussion"] = 222,
    ["GitHub Funding"] = 223,
    ["GitHub Issue Template configuration"] = 225,
    ["GitHub Workflow"] = 226,
    ["GitHub Workflow Template Properties"] = 227,
    ["GitHub issue forms"] = 224,
    GitVersion = 220,
    ["Gitpod Configuration"] = 229,
    ["Global Privacy Control"] = 218,
    ["Google Cloud Workflows"] = 141,
    Goreleaser = 232,
    ["Goreleaser Pro"] = 233,
    ["Gradle Build Cache Node"] = 571,
    ["Gradle Enterprise"] = 570,
    ["Grafana 5.x Dashboard"] = 234,
    ["GraphQL Code Generator"] = 237,
    ["GraphQL Config"] = 236,
    ["GraphQL Mesh"] = 235,
    ["Grunt JSHint task"] = 241,
    ["Grunt Watch task"] = 242,
    ["Grunt base task"] = 243,
    ["Grunt clean task"] = 239,
    ["Grunt copy task"] = 238,
    ["Grunt cssmin task"] = 240,
    HEMTT = 543,
    Hadolint = 555,
    Hammerkit = 581,
    ["Hardware Sentry Configuration"] = 630,
    Hayson = 245,
    ["Haystack Pipeline"] = 246,
    ["Hazelcast 5 Configuration"] = 247,
    ["Helm Chart.lock"] = 114,
    ["Helm Chart.yaml"] = 113,
    ["Helm Unittest Test Suite"] = 115,
    Hugo = 608,
    ["IBM Zapp document"] = 252,
    ["IBM zCodeFormatSettings"] = 253,
    ["IMG Catapult PSP"] = 258,
    ["Istanbul Schema"] = 633,
    ["JDownloader2 crawler multi-rule schema"] = 268,
    ["JDownloader2 crawler single-rule schema"] = 267,
    ["JFrog File Spec"] = 269,
    ["JFrog Pipelines YML DSL"] = 639,
    ["JMeter DSL cli config schema"] = 270,
    ["JSON Document Transform"] = 278,
    ["JSON Feed"] = 279,
    ["JSON Resume"] = 408,
    ["JSON Schema Draft 2020-12"] = 522,
    ["JSON Schema Draft 4"] = 519,
    ["JSON Schema Draft 7"] = 520,
    ["JSON Schema Draft 8"] = 521,
    ["JSON schema for CodeShip Pro services configuration files"] = 127,
    ["JSON schema for CodeShip Pro steps configuration files"] = 128,
    ["JSON schema for Codecov configuration files"] = 126,
    ["JSON-API"] = 277,
    ["JSON-e templates"] = 579,
    ["JSON-stat 2.0"] = 516,
    JSONPatch = 281,
    Jasmine = 263,
    Jekyll = 264,
    ["Jenkins X Pipelines"] = 265,
    ["Jenkins X Requirements"] = 266,
    ["Jovo Language Models"] = 271,
    ["KSP-AVC"] = 517,
    ["KSP-CKAN"] = 518,
    ["Keycloak REST API"] = 645,
    ["Knative Functions - func.yaml"] = 215,
    ["KoDE/CI build.yaml"] = 635,
    ["Kong DBLess Schema"] = 636,
    KrakenD = 284,
    ["LinkML Metamodel"] = 297,
    Liquibase = 586,
    ["Liquibase Flow File"] = 587,
    ["Lively Properties"] = 298,
    Markdownlint = 590,
    ["MegaLinter configuration"] = 303,
    ["MegaLinter descriptor"] = 304,
    ["Meltano plugin discovery definition"] = 306,
    ["Meltano project definition"] = 305,
    ["Microsoft Band Web Tile"] = 307,
    ["Minecraft Data Pack Advancement"] = 309,
    ["Minecraft Data Pack Biome"] = 310,
    ["Minecraft Data Pack Configured Carver"] = 311,
    ["Minecraft Data Pack Damage Type"] = 312,
    ["Minecraft Data Pack Dimension"] = 314,
    ["Minecraft Data Pack Dimension Type"] = 313,
    ["Minecraft Data Pack Item Modifier"] = 315,
    ["Minecraft Data Pack Loot Table"] = 316,
    ["Minecraft Data Pack Metadata"] = 317,
    ["Minecraft Data Pack Predicate"] = 318,
    ["Minecraft Data Pack Recipe"] = 319,
    ["Minecraft Data Pack Tag"] = 320,
    ["Minecraft Data Pack Template Pool"] = 321,
    ["Minecraft Resource Pack Lang"] = 322,
    ["Minecraft Resource Pack Particle"] = 323,
    ["Minecraft Resource Pack Texture Mcmeta"] = 325,
    ["Minecraft Resourcepack Sounds"] = 324,
    ["MkDocs Configuration 1.0"] = 326,
    ["MongoDB Atlas Search Index Definition Schema"] = 634,
    ["Monika Configuration Schema"] = 632,
    ["Motif config"] = 539,
    ["NOX Framework (Service)"] = 339,
    ["Netin Diagnostic System Template"] = 595,
    ["Netlify config schema"] = 331,
    ["Nightwatch.js"] = 332,
    ["OSS Review Toolkit configuration"] = 357,
    ["OSS Review Toolkit curation"] = 358,
    ["OSS Review Toolkit package configuration"] = 359,
    ["OSS Review Toolkit repository configuration"] = 360,
    ["OSS Review Toolkit resolutions"] = 361,
    Opctl = 542,
    ["OpenRewrite Resource"] = 352,
    ["OpenWeather Current Weather API"] = 578,
    ["OpenWeather Road Risk API"] = 577,
    ["Ory Hydra configuration"] = 251,
    ["Ory Keto configuration"] = 286,
    ["Ory Kratos configuration"] = 356,
    ["Ory Oathkeeper configuration"] = 346,
    ["Outblocks App configuration"] = 354,
    ["Outblocks database table"] = 355,
    ["Outblocks project configuration"] = 353,
    Packer = 364,
    Pantsbuild = 651,
    ["Pipeline component"] = 588,
    ["PocketMine plugin.yml"] = 368,
    Pterodactyl = 629,
    ["Pull Request Labeler"] = 391,
    Pulumi = 396,
    PyProject = 397,
    Qodana = 605,
    ["Quali Torque Blueprint Spec 2"] = 627,
    ["QueryFirst config file"] = 648,
    ["RKE Cluster Configuration JSON Schema"] = 585,
    ["RKE Cluster Configuration YAML Schema"] = 584,
    ["Rancher Fleet"] = 394,
    Ray = 554,
    ["Read the Docs"] = 395,
    ["Red-DiscordBot Cog"] = 398,
    ["Red-DiscordBot Cog Repo"] = 399,
    ["Red-DiscordBot Trivia"] = 400,
    Renovate = 409,
    ["Replit schema"] = 403,
    RoadRunner = 410,
    Ruff = 406,
    ["Rust Project"] = 407,
    ["Rust toolchain"] = 412,
    ["SIL Kit Participant Configuration"] = 438,
    SWADL = 460,
    ["Sapphire CLI Config"] = 413,
    ["SauceCTL Configuration"] = 592,
    ["Schema Catalog"] = 426,
    ["Scoop manifest"] = 431,
    ["Semgrep Rule"] = 433,
    ["Serenity Code Generator (Sergen)"] = 434,
    ["Serverless Framework Configuration"] = 599,
    ["Serverless Workflow Schema"] = 601,
    ["Settings.paf"] = 436,
    ["Shopware 6 Configuration"] = 602,
    ["Shopware CLI Extension Store Configuration"] = 603,
    ["Shopware CLI Project Store Configuration"] = 604,
    ["Slack app manifest"] = 440,
    Solidarity = 443,
    ["Solution filters"] = 444,
    ["Source Maps v3"] = 445,
    Sourcery = 446,
    SpecIF = 447,
    ["Sponge Mixin configuration"] = 448,
    ["StackHawk Scanner Configuration"] = 598,
    Stale = 452,
    Starship = 453,
    ["Statamic Blueprint"] = 454,
    ["StrmPrivacy Data Connector"] = 643,
    ["StrmPrivacy Data Contract"] = 644,
    ["StrmPrivacy SimpleSchema"] = 641,
    ["StrmPrivacy Stream"] = 642,
    ["StrmPrivacy batch job configuration file"] = 640,
    ["Stryker Mutator"] = 457,
    ["StyleCop Analyzers Configuration"] = 458,
    ["Swagger API 2.0"] = 461,
    TSON = 484,
    ["Talisman configuration"] = 463,
    ["Taskfile YAML Schema"] = 580,
    Taurus = 464,
    ["TestEnvironment.json"] = 472,
    ["Tier.run pricing.json"] = 467,
    Tikibase = 468,
    ["Traefik v2"] = 475,
    ["Traefik v2 File Provider"] = 476,
    Turborepo = 473,
    Tye = 606,
    ["UI5 Manifest"] = 491,
    ["UTAM Page Object"] = 494,
    ["Ubuntu Server Autoinstall"] = 489,
    ["Uniswap Token List"] = 563,
    ["Unreal Engine Uplugin"] = 649,
    ["Unreal Engine Uproject"] = 650,
    Updatecli = 613,
    Uplift = 647,
    ["User Journey Map YAML Schema"] = 583,
    V2Ray = 617,
    ["VSCode Code Snippets"] = 130,
    ["VSIX CLI publishing"] = 507,
    ["Vela Pipeline Configuration"] = 497,
    Vercel = 129,
    ["Web App Manifest"] = 512,
    ["Web types"] = 515,
    WebExtensions = 511,
    ["Webman package recipe"] = 623,
    ["Windows Package Manager Installer Manifest"] = 560,
    ["Windows Package Manager Locale Manifest"] = 561,
    ["Windows Package Manager Singleton Manifest"] = 559,
    ["Woodpecker pipeline config"] = 594,
    ["Xstate Machine Schema"] = 611,
    ["Yippee-Ki-JSON configuration YML"] = 565,
    ["angular.json"] = 11,
    ...
    ["chutzpah.json"] = 137,
    clangd = 120,
    ["cloud-init: cloud-config userdata JSON schema"] = 122,
    ["cloud-sdk-pipeline-config-schema"] = 139,
    ["cloudbuild.json"] = 140,
    cloudify = 121,
    codemagic = 123,
    ["coffeelint.json"] = 146,
    comet = 575,
    ["commands.json"] = 133,
    ["compile_commands.json"] = 132,
    ["compilerconfig.json"] = 131,
    ["component-detection-manifest.json"] = 149,
    ["component.json"] = 148,
    ["composer.json"] = 147,
    ["config.json"] = 150,
    ["contentmanifest.json"] = 138,
    ["contribute.json"] = 151,
    ["cosmos.config.json"] = 135,
    ["crowdin.yml"] = 152,
    cspell = 158,
    ["cypress.json"] = 156,
    ["datalogic-scan2deploy-android"] = 164,
    ["datalogic-scan2deploy-ce"] = 165,
    ["dbt Project"] = 98,
    ["debugsettings.json"] = 166,
    ["dependabot-v2.json"] = 169,
    ["dependabot.json"] = 168,
    ["deployed-cli"] = 610,
    ["detekt.yml"] = 171,
    ...
    ["devspace.yaml"] = 631,
    ["docfx.json"] = 175,
    ["docker-compose.yml"] = 566,
    ["docker-seq schema"] = 174,
    ["dockerd.json"] = 173,
    ["dotnet Release Index manifest"] = 184,
    ["dotnetcli.host.json"] = 185,
    ["drone.json"] = 186,
    ["dss-2.0.0.json"] = 188,
    ["dstack Workflows"] = 189,
    ["dvc.yaml"] = 190,
    ["ecosystem.json"] = 195,
    eksctl = 196,
    ["electron-builder configuration file."] = 201,
    ["epr-manifest.json"] = 199,
    ["evcc.yaml"] = 202,
    ["ezd schema"] = 204,
    ["fabric.mod.json"] = 207,
    ["first-timers-bot"] = 210,
    ...
    ["gitlab-ci"] = 228,
    ["global.json"] = 230,
    ["golangci-lint Configuration"] = 231,
    ["haxelib.json"] = 244,
    helmfile = 556,
    ["host-meta.json"] = 249,
    ["host.json"] = 248,
    ...
    ["ide.host.json"] = 254,
    ["ifstate.conf"] = 255,
    ["imageoptimizer.json"] = 256,
    ["importmap.json"] = 259,
    ["ioBroker Configuration"] = 260,
    ["ioBroker JSON UI"] = 261,
    ["ioBroker Package manifest"] = 262,
    ["ize.toml"] = 646,
    ["jsconfig.json"] = 282,
    ["jscpd Configuration Schema"] = 628,
    jsdoc = 553,
    ["k3d.yaml"] = 283,
    ["kontinuous-values.yaml"] = 287,
    ["kustomization.yaml"] = 288,
    ["label-commenter-config.yml"] = 289,
    ["launchsettings.json"] = 290,
    ["lego.json"] = 291,
    ["lerna.json"] = 292,
    ["lgtm.yml"] = 293,
    ["libman.json"] = 294,
    ["license-report-config.json"] = 295,
    ["linkinator.config.json"] = 296,
    ["local.settings.json"] = 299,
    ["localazy.json"] = 300,
    ["lsdlschema.json"] = 301,
    ["markdown-lint-check"] = 591,
    mboats = 597,
    ["mimetypes.json"] = 308,
    ["mirrord-schema"] = 536,
    ["mta.yaml"] = 537,
    ["mtad.yaml"] = 538,
    ["mycode.json"] = 329,
    ["napari plugin manifest"] = 330,
    neoload = 548,
    ["nest-cli"] = 335,
    ["ninjs (News in JSON) 1.3"] = 334,
    ["ninjs (News in JSON) 2.0"] = 333,
    ["nlu.json"] = 336,
    ["nodemon.json"] = 338,
    ["noodl.schema.json"] = 596,
    now = 544,
    ["npm-badges"] = 341,
    ["nswag.json"] = 344,
    ntangle = 345,
    ["nuclei-template.yaml"] = 342,
    ["nuget-project.json"] = 343,
    ["ocelot.json"] = 347,
    ["omnisharp.json"] = 348,
    ["openapi.json"] = 349,
    ["openfin.json"] = 351,
    ["openrpc.json"] = 350,
    ["package.json"] = 362,
    ["package.manifest"] = 363,
    ["pattern.json"] = 366,
    ["petstore-v1.0"] = 638,
    pgap_yaml_input_reader = 365,
    ["plagiarize-me.yaml"] = 370,
    ["plagiarize.yaml"] = 369,
    ["portman.json"] = 371,
    ["prettierrc.json"] = 376,
    ["prisma.yml"] = 377,
    ["project-1.0.0-beta3.json"] = 379,
    ["project-1.0.0-beta4.json"] = 380,
    ["project-1.0.0-beta5.json"] = 381,
    ["project-1.0.0-beta6.json"] = 382,
    ["project-1.0.0-beta8.json"] = 383,
    ["project-1.0.0-rc1.json"] = 384,
    ["project-1.0.0-rc2.json"] = 385,
    ["project.json"] = 378,
    ["prometheus.json"] = 386,
    ["prometheus.rules.json"] = 387,
    ["proxies.json"] = 388,
    ["publiccode.yml"] = 389,
    ["pubspec.yaml"] = 390,
    ["pyrseas-0.8.json"] = 393,
    ["release drafter"] = 549,
    rtx = 405,
    rustfmt = 411,
    ["sarif-1.0.0.json"] = 414,
    ["sarif-2.0.0.json"] = 415,
    ["sarif-2.1.0"] = 424,
    ["sarif-2.1.0-rtm.2"] = 416,
    ["sarif-2.1.0-rtm.3"] = 418,
    ["sarif-2.1.0-rtm.4"] = 420,
    ["sarif-2.1.0-rtm.5"] = 422,
    ["sarif-external-property-file-2.1.0"] = 425,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 417,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 419,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 421,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 423,
    ["schema.org - Action"] = 427,
    ["schema.org - ContactPoint"] = 428,
    ["schema.org - Place"] = 429,
    ["schema.org - Thing"] = 430,
    ["semantic-release"] = 432,
    ["servicehub.config.json"] = 525,
    ["servicehub.service.json"] = 524,
    ["settings.job"] = 435,
    ["sfdx-hardis configuration"] = 437,
    ["size-limit configuration"] = 439,
    ["skaffold.yaml"] = 589,
    ["skyuxconfig.json"] = 441,
    snapcraft = 442,
    ["stripe-app-local.json"] = 456,
    ["stripe-app.json"] = 455,
    swcrc = 576,
    ["task.json"] = 462,
    taskcat = 545,
    ["template.json"] = 465,
    ["templatsources.json"] = 466,
    ["theme.json"] = 469,
    ["tizen_workspace.json"] = 470,
    tmLanguage = 471,
    tmuxinator = 533,
    ["transcend.yml"] = 477,
    ["trunk.yaml schema"] = 478,
    ["ts-force-config.json"] = 482,
    ["tsconfig.json"] = 479,
    ["tsd.json"] = 480,
    ["tsdrc.json"] = 481,
    ["tslint.json"] = 483,
    ...
    ["vega-lite.json"] = 496,
    ["vega.json"] = 495,
    ["venvironment-basic.yaml"] = 499,
    ["venvironment.yaml"] = 498,
    ["version.json"] = 500,
    ["vim-addon-info"] = 501,
    ["vs-2017.3.host.json"] = 503,
    ["vs-nesting.json"] = 504,
    ["vsls.json"] = 502,
    ["vss-extension.json"] = 508,
    ["webhint.io"] = 624,
    ["webjobpublishsettings.json"] = 514,
    ["webjobs-list.json"] = 513,
    ["xs-app.json"] = 541,
    ["xunit.runner.json"] = 523,
    yamllint = 564,
    zuul = 550,
    ["Žinoma"] = 558
  },
