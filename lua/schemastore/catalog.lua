...
M.json = {
  ...
  index = {
    ...
    [".pmbot.yml"] = 592,
    [".postcssrc"] = 601,
    [".powerpages-web-template-manifest"] = 603,
    [".pre-commit-config.yml"] = 604,
    [".pre-commit-hooks.yml"] = 605,
    [".putout.json"] = 635,
    [".rehyperc"] = 660,
    [".remarkrc"] = 664,
    [".sprite files"] = 753,
    ...
    ABCSupplyPlan = 21,
    AIConfig = 22,
    ["AMX Muse Program Descriptor"] = 1101,
    ["API Builder"] = 912,
    ["AVA Configuration"] = 975,
    ...
    ["AWS Copilot Manifest"] = 1140,
    ["AWS SAM CLI Samconfig"] = 228,
    ["Adobe UXP Manifest"] = 1037,
    ["Aerleon Network & Service Definitions"] = 15,
    ["Aerleon Policy"] = 16,
    Aider = 1130,
    Air = 18,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1151,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1150,
    ["Airlock Microgateway"] = 23,
    ["Alacritty Configuration"] = 947,
    ["All Contributors configuration file"] = 1000,
    ...
    ["Application list for a WinUtil"] = 1081,
    ArchitectFX = 1086,
    ["Argo Events"] = 41,
    ["Argo Workflows"] = 42,
    AssemblyScript = 45,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1149,
    ["Azure IoT Operations connector metadata"] = 1146,
    ...
    ["Azure Pipelines"] = 83,
    ["Azure Static Web Apps CLI configuration file"] = 757,
    ["Azure Static Web Apps configuration file"] = 756,
    ["BOSH CPI Config"] = 107,
    ["BOSH Deploy Config"] = 108,
    ["BX CI"] = 127,
    ["Bacon config"] = 2,
    ["Bashly (bashly.yml)"] = 1004,
    ["Bashly Settings (bashly-settings.yml)"] = 1005,
    ["Better Code Hub"] = 917,
    ["Better Scripts"] = 128,
    Bigconfig = 100,
    ["Biome Formatter Config"] = 67,
    ["Bitmovin Encoding Template"] = 1094,
    BizTalkServerApplicationSchema = 884,
    Bleep = 129,
    ...
    ["Butane Config"] = 960,
    C4InterFlow = 1109,
    ["CDK Environment Manager, concrete environment configuration"] = 1133,
    ["CDK Environment Manager, concrete environments definition"] = 1132,
    ["CDK Environment Manager, environment definition"] = 1131,
    ["CGS Card Game Specification (cgs.json)"] = 1042,
    ["CICS TS region tagging"] = 969,
    ["CICS TS resource import"] = 970,
    ["CICS TS resource model"] = 971,
    ["CICS TS resource overrides"] = 972,
    ["CMake Presets"] = 130,
    ["CNC Codes"] = 151,
    ["CRS WAF test file"] = 1071,
    ["CRS WAF test platform overrides file"] = 1072,
    ...
    ["Chamaleon environment"] = 1098,
    ["Chamaleon properties"] = 1099,
    ["Chamaleon template"] = 1097,
    Changesets = 237,
    Changie = 139,
    Charmcraft = 140,
    Cheatsheets = 957,
    ...
    ["Clawject config"] = 157,
    ["Cloud Foundry Application Manifest"] = 1053,
    ["Cloud Run Spec v1"] = 1076,
    ...
    Concord = 1070,
    ["Configu .cfgu files"] = 1058,
    ["Configu .configu file"] = 1059,
    Conjure = 150,
    ["Container Structure Test"] = 898,
    Containerlab = 926,
    ["Contextive Glossary"] = 1125,
    Convex = 149,
    ["Crowdsec collection config"] = 247,
    ["Crowdsec parser config"] = 248,
    ["Crowdsec scenario config"] = 249,
    ["CumulusCI Config"] = 156,
    ["Custom Machinery Machine"] = 1043,
    ["Custom Machinery Recipe"] = 1044,
    ...
    ["DonateCaseBetterCasino menu"] = 1102,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1012,
    ["EAS config"] = 313,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1001,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1145,
    ["EasyVCR .NET"] = 314,
    ["Eidolon Resource"] = 1087,
    ...
    ["Evolving Resolutive Process notation"] = 1147,
    ["Expo SDK"] = 312,
    ...
    ["GeoJSON.json latest"] = 964,
    GherKing = 968,
    ["GitHub Action"] = 346,
    ["GitHub Actions typing"] = 1083,
    ...
    ["Google Digital Assetlinks"] = 1126,
    Goreleaser = 374,
    ["Goreleaser Pro"] = 375,
    Goss = 376,
    ["Gradle Build Cache Node"] = 915,
    ["Gradle Enterprise"] = 914,
    ...
    Hadolint = 894,
    Hammerkit = 925,
    ["Hardware Sentry Configuration"] = 980,
    ["HashiCorp Vault"] = 389,
    Hatch = 895,
    Hayagriva = 391,
    Hayson = 392,
    ...
    ["JFrog File Spec"] = 425,
    ["JFrog Pipelines YML DSL"] = 989,
    ["JMeter DSL cli config"] = 426,
    JReleaser = 429,
    ["JSON Document Transform"] = 437,
    ["JSON Feed"] = 438,
    ["JSON Resume"] = 670,
    ["JSON Schema Draft 2020-12"] = 862,
    ["JSON Schema Draft 4"] = 859,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1022,
    ["JSON Schema Draft 7"] = 860,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1023,
    ["JSON Schema Draft 8 (2019-09)"] = 861,
    ["JSON-API"] = 436,
    ["JSON-e templates"] = 922,
    ["JSON-stat 2.0"] = 855,
    JSONPatch = 440,
    ...
    ["Jujutsu (jj) VCS config"] = 1139,
    ["KIMMDY config file"] = 451,
    ["KODE/CI build.yaml"] = 985,
    ["KSP-AVC"] = 856,
    ["KSP-CKAN"] = 857,
    ["KSP-NetKAN"] = 858,
    KSY = 1052,
    ...
    ["Metadata for a Cinnamon spice"] = 1079,
    ["Metatype Configuration"] = 491,
    ["MetricsHub Configuration"] = 492,
    ["MetricsHub Connector Configuration"] = 493,
    ["Micro Editor Syntax"] = 1013,
    ["Microsoft Band Web Tile"] = 494,
    ["Microsoft RulesEngine workflow rules"] = 1067,
    ["Microsoft RulesEngine workflow rules list"] = 1068,
    ["Minecraft Custom Main Menu Mod"] = 1031,
    ...
    ["MongoDB Atlas Search Index Definition"] = 984,
    ["Monika Configuration"] = 982,
    ["Monoweave Configuration"] = 519,
    ["Motif config"] = 876,
    MultiQC = 1119,
    ["NOX Framework (Service)"] = 538,
    ["Netin Diagnostic System Template"] = 942,
    ["Netlify config"] = 527,
    ["Network-as-Code Data Model"] = 528,
    ["Next Gen UI Agent Configuration"] = 529,
    ["Nightwatch.js"] = 531,
    ["Node.js configuration"] = 881,
    ...
    ["OpenUtau ustx"] = 557,
    ["OpenWeather Current Weather API"] = 921,
    ["OpenWeather Road Risk API"] = 920,
    ...
    PDM = 588,
    POPxf = 598,
    ["POPxf Correlations"] = 599,
    Packer = 585,
    Pantsbuild = 999,
    ["Paper paper-plugin.yml"] = 586,
    ["Pipeline component"] = 933,
    ["Platform.sh application"] = 4,
    ["Platform.sh routes"] = 5,
    ["Platform.sh services"] = 6,
    ["Plex Prerolls"] = 596,
    ["PocketMine plugin.yml"] = 593,
    ["Postman collection"] = 602,
    ["Power Pages Configuration"] = 1136,
    ["Preset list for a WinUtil"] = 1082,
    ["ProActions AI-Kit Configuration"] = 611,
    ["ProActions AI-Kit Configuration for Menus"] = 613,
    ["ProActions AI-Kit Configuration for Sections"] = 615,
    ["ProActions AI-Kit Configuration for Services"] = 612,
    ["ProActions AI-Kit Configuration for Steps"] = 616,
    ["ProActions AI-Kit Configuration for Templates"] = 614,
    ["Problem object RFC9457"] = 1028,
    ["Problem package generators"] = 617,
    Pterodactyl = 979,
    ["Pull Request Labeler"] = 634,
    Pulumi = 642,
    ["PyGTA Config"] = 638,
    PyProject = 643,
    Pylock = 1127,
    Pyright = 644,
    ["Python script metadata"] = 1121,
    ["QType AI DSL"] = 647,
    Qgoda = 646,
    Qodana = 952,
    ["Qt Creator workspace file"] = 1060,
    ["Quali Torque Blueprint Spec 2"] = 977,
    ["QueryFirst config file"] = 995,
    ["RKE Cluster Configuration JSON"] = 930,
    ["RKE Cluster Configuration YAML"] = 929,
    RadioHound = 637,
    Railpack = 649,
    Railway = 648,
    ["Rancher Fleet"] = 639,
    ...
    Ray = 893,
    ["Read the Docs"] = 641,
    ["Red-DiscordBot Cog"] = 657,
    ["Red-DiscordBot Cog Repo"] = 658,
    ["Red-DiscordBot Trivia"] = 659,
    ["Render Blueprints"] = 928,
    RenderCV = 672,
    Renovate = 671,
    ["Replit config"] = 665,
    Restate = 1114,
    ["Revel Digital Gadget Definition File"] = 1138,
    RoadRunner = 674,
    ["Robust Station Image"] = 1144,
    Rockcraft = 675,
    ["Roo Coder Custom Modes"] = 676,
    Rubocop = 667,
    ["Rudder techniques"] = 1035,
    Ruff = 668,
    ["Rust Project"] = 669,
    ["Rust toolchain"] = 680,
    ["SDMX data message"] = 706,
    ["SDMX metadata message"] = 705,
    ["SDMX structure message"] = 704,
    ["SIL Kit Participant Configuration"] = 716,
    ["SIL Kit Registry Configuration"] = 717,
    ["SPDX 2.3"] = 754,
    SWADL = 770,
    ["Safebox Config"] = 990,
    ["Sapphire CLI Config"] = 683,
    ["SauceCTL Configuration"] = 939,
    ["Schema Catalog"] = 698,
    ["Scoop manifest"] = 703,
    ["Semantic Data Fabric (SDF) file"] = 707,
    ["Semgrep Rule"] = 709,
    ["Serenity Code Generator (Sergen)"] = 710,
    ["Serverless Framework Configuration"] = 946,
    ["Serverless Workflow"] = 948,
    ["Settings for a Cinnamon spice"] = 1078,
    ["Settings.paf"] = 712,
    ["Shopware 6 Configuration"] = 949,
    ["Shopware CLI Extension Store Configuration"] = 950,
    ["Shopware CLI Project Store Configuration"] = 951,
    ["Sigma Detection Rule"] = 714,
    ["Sigrid scope configuration file"] = 715,
    ["SkyPilot Task JSON"] = 1036,
    ["Slack app manifest"] = 719,
    Snapcraft = 721,
    Solidarity = 724,
    ["Solution filters"] = 725,
    ["Source Maps v3"] = 726,
    Sourcery = 727,
    ["Spack bootstrap.yaml"] = 728,
    ["Spack cdash.yaml"] = 729,
    ["Spack ci.yaml"] = 730,
    ["Spack compilers.yaml"] = 731,
    ["Spack concretizer.yaml"] = 732,
    ["Spack config.yaml"] = 733,
    ["Spack definitions.yaml"] = 734,
    ["Spack develop.yaml"] = 735,
    ["Spack env_vars.yaml"] = 736,
    ["Spack environment"] = 742,
    ["Spack include.yaml"] = 737,
    ["Spack mirrors.yaml"] = 738,
    ["Spack modules.yaml"] = 739,
    ["Spack packages.yaml"] = 740,
    ["Spack repos.yaml"] = 741,
    ["Spack toolchains.yaml"] = 743,
    ["Spack upstreams.yaml"] = 744,
    ["Spack view.yaml"] = 745,
    ["Speakeasy Generation Config File"] = 749,
    ["Speakeasy Lint Configuration File"] = 746,
    ["Speakeasy Test Generation Configuration File"] = 747,
    ["Speakeasy Workflow File"] = 748,
    SpecIF = 750,
    ["Specmatic Configuration"] = 751,
    ["Sponge Mixin configuration"] = 752,
    StackBlitz = 758,
    ["StackHawk Scanner Configuration"] = 945,
    Stale = 759,
    Starfish = 760,
    ["Starlake Data Pipeline"] = 918,
    Starship = 761,
    ["Statamic Blueprint"] = 762,
    ["Stella configuration file"] = 763,
    ["Streamlit configuration file"] = 764,
    ["Stryker Mutator"] = 767,
    ["StyleCop Analyzers Configuration"] = 768,
    ["Stylelint (.stylelintrc)"] = 769,
    ["Stylua Config"] = 1128,
    ["Sublime Syntax"] = 991,
    ["Subsquid squid manifest"] = 1038,
    ["Swagger API 2.0"] = 771,
    ["Synadia Connect Component"] = 772,
    TSON = 807,
    TSTyche = 808,
    ["TYPO3 Vendor Bundler config"] = 813,
    ["Tab data for a LinUtil"] = 1085,
    ["Tab list for a LinUtil"] = 1084,
    Tach = 773,
    ["Tach Domain"] = 774,
    Talhelper = 776,
    ["Talisman configuration"] = 777,
    Taplo = 1129,
    ["Taskfile config"] = 923,
    Taurus = 778,
    Tauticord = 779,
    Telefonistka = 1115,
    ["Terrateam config"] = 1141,
    ["TestEnvironment.json"] = 790,
    ["TextMate Grammar"] = 789,
    Threagile = 785,
    ["Tier.run pricing.json"] = 782,
    Tikibase = 783,
    Tombi = 788,
    ["Traefik v2"] = 793,
    ["Traefik v2 File Provider"] = 794,
    ["Traefik v3"] = 795,
    ["Traefik v3 File Provider"] = 796,
    ["Travis CI (.travis.yml)"] = 792,
    Treefmt = 379,
    Trident = 1111,
    ["TrueScript for *.tscript files"] = 799,
    ["Tugboat QA config.yml"] = 1108,
    TunnelHub = 1026,
    Turborepo = 791,
    Tycho = 1074,
    Tye = 953,
    ["Tyk Gateway - Open Source v5.7+"] = 1120,
    ["Typst Manifest"] = 814,
    ["UET BuildConfig.json"] = 996,
    ["UI5 Manifest"] = 820,
    ["UNCORS configuration"] = 824,
    ["UTAM Page Object"] = 823,
    ["Ubuntu Server Autoinstall"] = 818,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1112,
    ["Uniswap Token List"] = 905,
    ["Universal Schedule Format"] = 825,
    ["Unreal Engine Uplugin"] = 997,
    ["Unreal Engine Uproject"] = 998,
    ["UpCloud CLI (upctl) configuration"] = 1113,
    ["Updatecli Compose"] = 961,
    ["Updatecli Policy Manifest"] = 962,
    ["Updatecli Policy Metadata"] = 963,
    Uplift = 994,
    ["Upsun config"] = 3,
    ["User Journey Map"] = 927,
    V2Ray = 967,
    ["VSCode Code Snippets"] = 212,
    ["VSIX CLI publishing"] = 843,
    Vector = 827,
    ["Vela Pipeline Configuration"] = 830,
    Vercel = 211,
    ["Version Bumper config"] = 833,
    ["Viash Component Config"] = 1117,
    ["Viash Package Config"] = 1118,
    Visivo = 1024,
    ["WP-CLI"] = 853,
    Wake = 1110,
    ["Waku Config"] = 1088,
    ["Web App Manifest"] = 849,
    ["Web types"] = 852,
    WebExtensions = 848,
    ["Webman package recipe"] = 973,
    ["Windows Package Manager Installer Manifest"] = 901,
    ["Windows Package Manager Locale Manifest"] = 902,
    ["Windows Package Manager Singleton Manifest"] = 900,
    Winutil = 903,
    ["WireMock CLI import configuration"] = 1093,
    ["WireMock CLI local service configuration"] = 1092,
    ["WireMock stub mapping"] = 1091,
    ["Woodpecker pipeline config"] = 941,
    ["Wrangler CLI"] = 854,
    ["Xstate Machine"] = 959,
    ["Yandex Workflow Language"] = 1080,
    ["Yarn Config (.yarnrc.yml)"] = 916,
    ["Yippee-Ki-JSON configuration YML"] = 907,
    ["YouTrack App"] = 1077,
    ["Zarf Package Configuration"] = 1143,
    ["Zerops.io config"] = 1065,
    ["Zerops.io import"] = 1066,
    ["aerleon.yml"] = 14,
    ["angular.json"] = 24,
    apko = 1029,
    ...
    ["behat.yml"] = 110,
    ["bigquery-table"] = 99,
    ["bioimageio resource description"] = 1046,
    ...
    ["crowdin.yml"] = 246,
    ["ctfd-setup configuration file"] = 1100,
    ["custom-elements.json"] = 1016,
    ["cypress.json"] = 250,
    ...
    ["gematik health care insurance list"] = 1106,
    ["gematik health care patient list"] = 1103,
    ["gematik health care provider institution list"] = 1105,
    ["gematik health care provider list"] = 1104,
    ["gematik tiger test environment configuration"] = 1107,
    ["gitlab-ci"] = 354,
    ["global.json"] = 370,
    ...
    ["lint-staged (.lintstagedrc)"] = 870,
    ["local.settings.json"] = 479,
    ["localazy.json"] = 480,
    ["lotus.yaml"] = 478,
    ["lsdlschema.json"] = 481,
    ["markdown-link-check"] = 936,
    maturin = 937,
    mboats = 944,
    ["micro-settings.json"] = 1008,
    ["mimetypes.json"] = 495,
    ["mirrord config"] = 872,
    mise = 873,
    ["mkdocs.yml"] = 515,
    ["monospace.yml"] = 518,
    ["moon.yml"] = 1090,
    ["mprocs Configuration file"] = 1061,
    ["mrdocs.yml"] = 516,
    ["mta.yaml"] = 874,
    ["mtad.yaml"] = 875,
    ["mycode.json"] = 525,
    ...
    ["plagiarize.yaml"] = 594,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1096,
    ["podbard.yaml"] = 597,
    ["portman.json"] = 600,
    ["prefect.toml"] = 608,
    ["prettierrc.json"] = 609,
    ["prisma.yml"] = 610,
    ["project-1.0.0-beta3.json"] = 619,
    ["project-1.0.0-beta4.json"] = 620,
    ["project-1.0.0-beta5.json"] = 621,
    ["project-1.0.0-beta6.json"] = 622,
    ["project-1.0.0-beta8.json"] = 623,
    ["project-1.0.0-rc1.json"] = 624,
    ["project-1.0.0-rc2.json"] = 625,
    ["project.json"] = 618,
    ["project.owasp.yaml"] = 626,
    ["prometheus-alertmanager.json"] = 630,
    ["prometheus.json"] = 627,
    ["prometheus.rules.json"] = 628,
    ["prometheus.rules.test.json"] = 629,
    ["proxies.json"] = 631,
    ["publiccode.yml"] = 632,
    ["pubspec.yaml"] = 633,
    ["pyrseas-0.8.json"] = 636,
    pytest = 645,
    ["quilt.mod.json"] = 1009,
    ["rc3 auth"] = 651,
    ["rc3 collection"] = 652,
    ...
    ["release drafter"] = 888,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 661,
    ["release-please-manifest.json"] = 662,
    ["release-plz.toml"] = 663,
    ["renv.lock"] = 673,
    ["rivet.json"] = 1033,
    ["rivet.yaml (legacy)"] = 1032,
    rumdl = 678,
    runny = 677,
    rustfmt = 679,
    sake = 1123,
    samt = 681,
    samtrc = 682,
    ["sarif-1.0.0.json"] = 684,
    ["sarif-2.0.0.json"] = 685,
    ["sarif-2.1.0"] = 695,
    ["sarif-2.1.0-rtm.2"] = 686,
    ["sarif-2.1.0-rtm.3"] = 688,
    ["sarif-2.1.0-rtm.4"] = 690,
    ["sarif-2.1.0-rtm.5"] = 692,
    ["sarif-2.1.0-rtm.6"] = 693,
    ["sarif-external-property-file-2.1.0"] = 696,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 687,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 689,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 691,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 694,
    ["scalingo.json configuration"] = 697,
    ["schema.org - Action"] = 699,
    ["schema.org - ContactPoint"] = 700,
    ["schema.org - Place"] = 701,
    ["schema.org - Thing"] = 702,
    ["secrethub.yml"] = 1011,
    ["semantic-release"] = 708,
    ["servicehub.config.json"] = 865,
    ["servicehub.service.json"] = 864,
    ["settings.job"] = 711,
    ["sfdx-hardis configuration"] = 713,
    ["shard.yml"] = 1049,
    ["size-limit configuration"] = 718,
    ["skaffold.yaml"] = 934,
    ["skyuxconfig.json"] = 720,
    ["snowflake-config"] = 722,
    ["snowflake-connections"] = 723,
    ["spicepod.yaml"] = 1069,
    ["sqlc configuration"] = 755,
    ["stripe-app-local.json"] = 766,
    ["stripe-app.json"] = 765,
    swcrc = 919,
    ["task.json"] = 775,
    taskcat = 883,
    ["template.json"] = 780,
    ["templatsources.json"] = 781,
    ["theme.json"] = 784,
    ["tizen_workspace.json"] = 786,
    tldr = 787,
    ["tm_devices configuration file"] = 1134,
    tmuxinator = 868,
    ["transcend.yml"] = 797,
    ["tree-sitter grammar.json"] = 378,
    ["trime.yaml"] = 798,
    ["trunk.yaml"] = 800,
    ["ts-force-config.json"] = 805,
    ["tsconfig.json"] = 801,
    ["tsd.json"] = 802,
    ["tsdoc.json"] = 803,
    ["tsdrc.json"] = 804,
    ...
    ["vega-lite.json"] = 829,
    ["vega.json"] = 828,
    ["venvironment.yaml"] = 831,
    ["venvplus.yaml"] = 832,
    version = 1116,
    ["version.json"] = 834,
    ["vhwdebugger-binding.yaml"] = 836,
    ["vim-addon-info"] = 837,
    ["vs-2017.3.host.json"] = 839,
    ["vs-nesting.json"] = 840,
    ["vsls.json"] = 838,
    ["vss-extension.json"] = 844,
    vtcfg = 1122,
    ["vtesttree.yaml"] = 845,
    ["vtestunit.yaml"] = 846,
    ["warp-keysets.json"] = 1017,
    ["warp-themes.json"] = 1018,
    ["warp-workflows.json"] = 1019,
    ["webhint.io"] = 974,
    ["webjobpublishsettings.json"] = 851,
    ["webjobs-list.json"] = 850,
    ["well-known-fursona"] = 1056,
    ["xs-app.json"] = 878,
    ["xunit.runner.json"] = 863,
    yamllint = 906,
    zuul = 889,
    ["Žinoma"] = 899
  },
