...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 172,
    [".cryproj (generic)"] = 591,
    [".cryproj engine-5.2"] = 586,
    [".cryproj engine-5.3"] = 587,
    [".cryproj engine-5.4"] = 588,
    [".cryproj engine-5.5"] = 589,
    [".cryproj engine-dev"] = 590,
    [".csscomb.json"] = 174,
    [".csslintrc"] = 175,
    [".es6importsorterrc.json"] = 717,
    [".eslintrc"] = 224,
    [".esmrc.json"] = 216,
    [".ffizer.yaml"] = 228,
    [".htmlhintrc"] = 278,
    ...
    [".mtaext"] = 600,
    [".nodehawkrc"] = 376,
    [".npmpackagejsonlintrc"] = 379,
    [".phraseapp.yml"] = 420,
    [".pmbot.yml"] = 410,
    [".postcssrc"] = 415,
    [".powerpages-web-template-manifest"] = 417,
    [".pre-commit-config.yml"] = 418,
    [".pre-commit-hooks.yml"] = 419,
    [".putout.json"] = 439,
    [".rehyperc"] = 451,
    [".remarkrc"] = 452,
    [".sprite files"] = 505,
    ...
    ["<div>RIOTS' studio configuration"] = 570,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 337,
    ["API Builder"] = 631,
    ["AVA Configuration"] = 687,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 662,
    ["All Contributors configuration file"] = 716,
    ...
    ["Azure Pipelines"] = 56,
    ["Azure Static Web Apps CLI configuration file"] = 508,
    ["Azure Static Web Apps configuration file"] = 507,
    ["BX CI"] = 92,
    ["Better Code Hub"] = 635,
    ["Better Scripts"] = 93,
    Bigconfig = 73,
    BizTalkServerApplicationSchema = 606,
    Bleep = 94,
    ...
    ["Butane Config"] = 674,
    ["CICS TS region tagging"] = 681,
    ["CICS TS resource import"] = 682,
    ["CICS TS resource model"] = 683,
    ["CICS TS resource overrides"] = 684,
    ["CMake Presets"] = 95,
    ["CNC Codes"] = 105,
    ...
    ["Databricks Asset Bundles"] = 737,
    ["Datadog Service Definition"] = 316,
    ["Datahub Ingestion Recipe"] = 688,
    ["Dein Config"] = 110,
    Deno = 185,
    ["Deployer Recipe"] = 188,
    ["Deta Spacefile"] = 111,
    ...
    ["GCP Blueprint Metadata"] = 243,
    ["GatewayCore API Gateway"] = 242,
    ["GeoJSON.json latest"] = 676,
    GherKing = 680,
    ["GitHub Action"] = 247,
    ["GitHub Discussion"] = 248,
    ["GitHub Funding"] = 249,
    ["GitHub Issue Template configuration"] = 251,
    ["GitHub Workflow"] = 252,
    ["GitHub Workflow Template Properties"] = 253,
    ["GitHub issue forms"] = 250,
    GitVersion = 246,
    ["Gitpod Configuration"] = 255,
    ["Global Privacy Control"] = 244,
    Goblet = 736,
    ["Google Cloud Workflows"] = 155,
    Goreleaser = 259,
    ["Goreleaser Pro"] = 260,
    Goss = 261,
    ["Gradle Build Cache Node"] = 633,
    ["Gradle Enterprise"] = 632,
    ["Grafana 5.x Dashboard"] = 262,
    ["GraphQL Code Generator"] = 265,
    ["GraphQL Config"] = 264,
    ["GraphQL Mesh"] = 263,
    ["Grunt JSHint task"] = 269,
    ["Grunt Watch task"] = 270,
    ["Grunt base task"] = 271,
    ["Grunt clean task"] = 267,
    ["Grunt copy task"] = 266,
    ["Grunt cssmin task"] = 268,
    HEMTT = 603,
    Hadolint = 615,
    Hammerkit = 642,
    ["Hardware Sentry Configuration"] = 692,
    Hayson = 273,
    ["Haystack Pipeline"] = 274,
    ["Hazelcast 5 Configuration"] = 275,
    ["Helm Chart.lock"] = 126,
    ["Helm Chart.yaml"] = 125,
    ["Helm Unittest Test Suite"] = 127,
    Hugo = 670,
    ["IBM Zapp document"] = 280,
    ["IBM zCodeFormatSettings"] = 281,
    ["IMG Catapult PSP"] = 286,
    Istanbul = 695,
    ["JDownloader2 crawler multi-rules"] = 296,
    ["JDownloader2 crawler single-rules"] = 295,
    ["JFrog Applications Config"] = 297,
    ["JFrog File Spec"] = 298,
    ["JFrog Pipelines YML DSL"] = 701,
    ["JMeter DSL cli config"] = 299,
    JReleaser = 301,
    ["JSON Document Transform"] = 308,
    ["JSON Feed"] = 309,
    ["JSON Resume"] = 458,
    ["JSON Schema Draft 2020-12"] = 582,
    ["JSON Schema Draft 4"] = 579,
    ["JSON Schema Draft 7"] = 580,
    ["JSON Schema Draft 7 (unofficial strict)"] = 738,
    ["JSON Schema Draft 8 (2019-09)"] = 581,
    ["JSON-API"] = 307,
    ["JSON-e templates"] = 640,
    ["JSON-stat 2.0"] = 576,
    JSONPatch = 311,
    Jasmine = 291,
    Jekyll = 292,
    ["Jenkins X Pipelines"] = 293,
    ["Jenkins X Requirements"] = 294,
    ["Jovo Language Models"] = 300,
    ["KSP-AVC"] = 577,
    ["KSP-CKAN"] = 578,
    ["Karakum configuration file"] = 238,
    Kas = 314,
    ["Keycloak REST API"] = 708,
    ["Knative Functions - func.yaml"] = 239,
    ["KoDE/CI build.yaml"] = 697,
    ["Kong DBLess config"] = 698,
    KrakenD = 315,
    LOOBin = 332,
    Lefthook = 323,
    ["LinkML Metamodel"] = 330,
    Liquibase = 647,
    ["Liquibase Flow File"] = 648,
    ["Lively Properties"] = 331,
    ["Lobe AI Agent"] = 55,
    ["MS2Rescore Configuration"] = 364,
    Markdownlint = 651,
    ["Mason Registry"] = 653,
    ["MegaLinter configuration"] = 338,
    ["MegaLinter descriptor"] = 339,
    ["Meltano plugin discovery definition"] = 341,
    ["Meltano project definition"] = 340,
    ["Microsoft Band Web Tile"] = 342,
    ["Minecraft Data Pack Advancement"] = 344,
    ["Minecraft Data Pack Biome"] = 345,
    ["Minecraft Data Pack Configured Carver"] = 346,
    ["Minecraft Data Pack Damage Type"] = 347,
    ["Minecraft Data Pack Dimension"] = 349,
    ["Minecraft Data Pack Dimension Type"] = 348,
    ["Minecraft Data Pack Item Modifier"] = 350,
    ["Minecraft Data Pack Loot Table"] = 351,
    ["Minecraft Data Pack Metadata"] = 352,
    ["Minecraft Data Pack Predicate"] = 353,
    ["Minecraft Data Pack Recipe"] = 354,
    ["Minecraft Data Pack Tag"] = 355,
    ["Minecraft Data Pack Template Pool"] = 356,
    ["Minecraft Data Pack Trim Material"] = 361,
    ["Minecraft Data Pack Trim Pattern"] = 362,
    ["Minecraft Resource Pack Lang"] = 357,
    ["Minecraft Resource Pack Particle"] = 358,
    ["Minecraft Resource Pack Texture Mcmeta"] = 360,
    ["Minecraft Resourcepack Sounds"] = 359,
    ["MkDocs Configuration 1.0"] = 363,
    ["MongoDB Atlas Search Index Definition"] = 696,
    ["Monika Configuration"] = 694,
    ["Motif config"] = 599,
    ["NOX Framework (Service)"] = 378,
    ["Netin Diagnostic System Template"] = 657,
    ["Netlify config"] = 369,
    ["Nexus-as-Code Data Model"] = 370,
    ["Nightwatch.js"] = 371,
    ["ONe's service descriptor"] = 391,
    ["OSS Review Toolkit configuration"] = 398,
    ["OSS Review Toolkit curation"] = 399,
    ["OSS Review Toolkit package configuration"] = 400,
    ["OSS Review Toolkit repository configuration"] = 401,
    ["OSS Review Toolkit resolutions"] = 402,
    Opctl = 602,
    ["OpenRewrite Resource"] = 393,
    ["OpenWeather Current Weather API"] = 639,
    ["OpenWeather Road Risk API"] = 638,
    ["Ory Hydra configuration"] = 279,
    ["Ory Keto configuration"] = 317,
    ["Ory Kratos configuration"] = 397,
    ["Ory Oathkeeper configuration"] = 385,
    ["Outblocks App configuration"] = 395,
    ["Outblocks database table"] = 396,
    ["Outblocks project configuration"] = 394,
    Packer = 405,
    Pantsbuild = 715,
    ["Paper paper-plugin.yml"] = 406,
    ["Pipeline component"] = 649,
    ["PocketMine plugin.yml"] = 411,
    ["Postman collection"] = 416,
    ["Problem package generators"] = 423,
    Pterodactyl = 691,
    ["Pull Request Labeler"] = 438,
    Pulumi = 444,
    PyProject = 445,
    Pyright = 446,
    Qgoda = 447,
    Qodana = 667,
    ["Quali Torque Blueprint Spec 2"] = 689,
    ["QueryFirst config file"] = 711,
    ["RKE Cluster Configuration JSON"] = 646,
    ["RKE Cluster Configuration YAML"] = 645,
    ["Rancher Fleet"] = 441,
    Ray = 614,
    ["Read the Docs"] = 443,
    ["Red-DiscordBot Cog"] = 448,
    ["Red-DiscordBot Cog Repo"] = 449,
    ["Red-DiscordBot Trivia"] = 450,
    Renovate = 459,
    ["Replit config"] = 453,
    RoadRunner = 460,
    Ruff = 456,
    ["Rust Project"] = 457,
    ["Rust toolchain"] = 462,
    ["SIL Kit Participant Configuration"] = 493,
    ["SIL Kit Registry Configuration"] = 494,
    SWADL = 517,
    ["Safebox Config"] = 702,
    ["Sapphire CLI Config"] = 465,
    ["SauceCTL Configuration"] = 654,
    ["Schema Catalog"] = 479,
    ["Scoop manifest"] = 484,
    ["Semantic Data Fabric (SDF) file"] = 485,
    ["Semgrep Rule"] = 487,
    ["Serenity Code Generator (Sergen)"] = 488,
    ["Serverless Framework Configuration"] = 661,
    ["Serverless Workflow"] = 663,
    ["Settings.paf"] = 490,
    ["Shopware 6 Configuration"] = 664,
    ["Shopware CLI Extension Store Configuration"] = 665,
    ["Shopware CLI Project Store Configuration"] = 666,
    ["Sigrid scope configuration file"] = 492,
    ["Slack app manifest"] = 496,
    Solidarity = 499,
    ["Solution filters"] = 500,
    ["Source Maps v3"] = 501,
    Sourcery = 502,
    SpecIF = 503,
    ["Sponge Mixin configuration"] = 504,
    ["StackHawk Scanner Configuration"] = 660,
    Stale = 509,
    ["Starlake Data Pipeline"] = 636,
    Starship = 510,
    ["Statamic Blueprint"] = 511,
    ["StrmPrivacy Data Connector"] = 706,
    ["StrmPrivacy Data Contract"] = 707,
    ["StrmPrivacy SimpleSchema"] = 704,
    ["StrmPrivacy Stream"] = 705,
    ["StrmPrivacy batch job configuration file"] = 703,
    ["Stryker Mutator"] = 514,
    ["StyleCop Analyzers Configuration"] = 515,
    ["Swagger API 2.0"] = 518,
    TSON = 542,
    ["Talisman configuration"] = 520,
    ["Taskfile config"] = 641,
    Taurus = 521,
    ["TestEnvironment.json"] = 530,
    ["Tier.run pricing.json"] = 524,
    Tikibase = 525,
    ["Traefik v2"] = 533,
    ["Traefik v2 File Provider"] = 534,
    Turborepo = 531,
    Tye = 668,
    ["UET BuildConfig.json"] = 712,
    ["UI5 Manifest"] = 549,
    ["UTAM Page Object"] = 552,
    ["Ubuntu Server Autoinstall"] = 547,
    ["Uniswap Token List"] = 624,
    ["Unreal Engine Uplugin"] = 713,
    ["Unreal Engine Uproject"] = 714,
    Updatecli = 675,
    Uplift = 710,
    ["User Journey Map"] = 644,
    V2Ray = 679,
    ["VSCode Code Snippets"] = 143,
    ["VSIX CLI publishing"] = 565,
    ["Vela Pipeline Configuration"] = 555,
    Vercel = 142,
    Visivo = 739,
    ["Web App Manifest"] = 572,
    ["Web types"] = 575,
    WebExtensions = 571,
    ["Webman package recipe"] = 685,
    ["Windows Package Manager Installer Manifest"] = 621,
    ["Windows Package Manager Locale Manifest"] = 622,
    ["Windows Package Manager Singleton Manifest"] = 620,
    ["Woodpecker pipeline config"] = 656,
    ["Xstate Machine"] = 673,
    ["Yippee-Ki-JSON configuration YML"] = 626,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 67,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 721,
    ["bashly-strings.yml"] = 722,
    ["bashly.yml"] = 720,
    ["batect.yml"] = 66,
    ...
    ["gitlab-ci"] = 254,
    ["global.json"] = 256,
    ["go-feature-flag Flag Configuration"] = 258,
    ["golangci-lint Configuration"] = 257,
    ["haxelib.json"] = 272,
    helmfile = 616,
    helmwave = 617,
    ["host-meta.json"] = 277,
    ...
    ["ide.host.json"] = 282,
    ["ifstate.conf"] = 283,
    ["imageoptimizer.json"] = 284,
    ["importmap.json"] = 287,
    ["ioBroker Configuration"] = 288,
    ["ioBroker JSON UI"] = 289,
    ["ioBroker Package manifest"] = 290,
    ["ize.toml"] = 709,
    ["jsconfig.json"] = 312,
    ["jscpd Configuration"] = 690,
    jsdoc = 613,
    ["k3d.yaml"] = 313,
    ["kontinuous-config.yaml"] = 319,
    ["kontinuous-values.yaml"] = 318,
    ["kustomization.yaml"] = 320,
    ["label-commenter-config.yml"] = 321,
    ["launchsettings.json"] = 322,
    lazydocker = 731,
    lazygit = 730,
    ["lego.json"] = 324,
    ["lerna.json"] = 325,
    ["lgtm.yml"] = 326,
    ["libman.json"] = 327,
    ["license-report-config.json"] = 328,
    ["linkinator.config.json"] = 329,
    ["local.settings.json"] = 334,
    ["localazy.json"] = 335,
    ["lotus.yaml"] = 333,
    ["lsdlschema.json"] = 336,
    ["madness.yml"] = 719,
    ["markdown-lint-check"] = 652,
    mboats = 659,
    ["micro-settings.json"] = 724,
    ["mimetypes.json"] = 343,
    ["mirrord config"] = 596,
    ["mta.yaml"] = 597,
    ["mtad.yaml"] = 598,
    ["mycode.json"] = 367,
    ["napari plugin manifest"] = 368,
    neoload = 608,
    ["nest-cli"] = 374,
    ["ninjs (News in JSON) 1.3"] = 373,
    ["ninjs (News in JSON) 2.0"] = 372,
    ["nlu.json"] = 375,
    ["nodemon.json"] = 377,
    ["noodl config"] = 658,
    now = 604,
    ...
    ["nswag.json"] = 383,
    ntangle = 384,
    ["nuclei-template.yaml"] = 381,
    ["nuget-project.json"] = 382,
    ["ocelot.json"] = 386,
    ["omnisharp.json"] = 387,
    ["openapi.json"] = 388,
    ["openfin.json"] = 392,
    ...
    ["ops.yaml"] = 390,
    ["package.json"] = 403,
    ["package.manifest"] = 404,
    ["pathfinder.yml"] = 407,
    ["pattern.json"] = 409,
    ["petstore-v1.0"] = 700,
    pgap_yaml_input_reader = 408,
    ["plagiarize-me.yaml"] = 413,
    ["plagiarize.yaml"] = 412,
    ["portman.json"] = 414,
    ["prettierrc.json"] = 421,
    ["prisma.yml"] = 422,
    ["project-1.0.0-beta3.json"] = 425,
    ["project-1.0.0-beta4.json"] = 426,
    ["project-1.0.0-beta5.json"] = 427,
    ["project-1.0.0-beta6.json"] = 428,
    ["project-1.0.0-beta8.json"] = 429,
    ["project-1.0.0-rc1.json"] = 430,
    ["project-1.0.0-rc2.json"] = 431,
    ["project.json"] = 424,
    ["prometheus.json"] = 432,
    ["prometheus.rules.json"] = 433,
    ["prometheus.rules.test.json"] = 434,
    ["proxies.json"] = 435,
    ["publiccode.yml"] = 436,
    ["pubspec.yaml"] = 437,
    ["pyrseas-0.8.json"] = 440,
    ["quilt.mod.json"] = 725,
    ["release drafter"] = 609,
    rtx = 455,
    rustfmt = 461,
    samt = 463,
    samtrc = 464,
    ["sarif-1.0.0.json"] = 466,
    ["sarif-2.0.0.json"] = 467,
    ["sarif-2.1.0"] = 477,
    ["sarif-2.1.0-rtm.2"] = 468,
    ["sarif-2.1.0-rtm.3"] = 470,
    ["sarif-2.1.0-rtm.4"] = 472,
    ["sarif-2.1.0-rtm.5"] = 474,
    ["sarif-2.1.0-rtm.6"] = 475,
    ["sarif-external-property-file-2.1.0"] = 478,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 469,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 471,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 473,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 476,
    ["schema.org - Action"] = 480,
    ["schema.org - ContactPoint"] = 481,
    ["schema.org - Place"] = 482,
    ["schema.org - Thing"] = 483,
    ["secrethub.yml"] = 727,
    ["semantic-release"] = 486,
    ["servicehub.config.json"] = 585,
    ["servicehub.service.json"] = 584,
    ["settings.job"] = 489,
    ["sfdx-hardis configuration"] = 491,
    ["size-limit configuration"] = 495,
    ["skaffold.yaml"] = 650,
    ["skyuxconfig.json"] = 497,
    snapcraft = 498,
    ["sqlc configuration"] = 506,
    ["stripe-app-local.json"] = 513,
    ["stripe-app.json"] = 512,
    swcrc = 637,
    syntax = 729,
    ["task.json"] = 519,
    taskcat = 605,
    ["template.json"] = 522,
    ["templatsources.json"] = 523,
    ["theme.json"] = 526,
    ["tizen_workspace.json"] = 527,
    tldr = 528,
    tmLanguage = 529,
    tmuxinator = 593,
    ["transcend.yml"] = 535,
    ["trunk.yaml"] = 536,
    ["ts-force-config.json"] = 540,
    ["tsconfig.json"] = 537,
    ["tsd.json"] = 538,
    ["tsdrc.json"] = 539,
    ["tslint.json"] = 541,
    ...
    ["vega-lite.json"] = 554,
    ["vega.json"] = 553,
    ["venvironment-basic.yaml"] = 557,
    ["venvironment.yaml"] = 556,
    ["version.json"] = 558,
    ["vim-addon-info"] = 559,
    ["vs-2017.3.host.json"] = 561,
    ["vs-nesting.json"] = 562,
    ["vsls.json"] = 560,
    ["vss-extension.json"] = 566,
    ["vtesttree.yaml"] = 567,
    ["vtestunit.yaml"] = 568,
    ["warp-keysets.json"] = 733,
    ["warp-themes.json"] = 734,
    ["warp-workflows.json"] = 735,
    ["webhint.io"] = 686,
    ["webjobpublishsettings.json"] = 574,
    ["webjobs-list.json"] = 573,
    ["xs-app.json"] = 601,
    ["xunit.runner.json"] = 583,
    yamllint = 625,
    zuul = 610,
    ["Žinoma"] = 619
  },
