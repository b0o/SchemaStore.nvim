...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 112,
    [".cryproj (generic)"] = 424,
    [".cryproj engine-5.2"] = 419,
    [".cryproj engine-5.3"] = 420,
    [".cryproj engine-5.4"] = 421,
    [".cryproj engine-5.5"] = 422,
    [".cryproj engine-dev"] = 423,
    [".csscomb.json"] = 114,
    [".csslintrc"] = 115,
    [".eslintrc"] = 152,
    [".esmrc.json"] = 145,
    ...
    [".vsext"] = 400,
    [".yarnrc.yml"] = 462,
    ["<div>RIOTS' studio configuration"] = 403,
    ["API Builder"] = 459,
    ["AVA Configuration Schema"] = 508,
    ...
    ["Azure Pipelines"] = 40,
    ["Azure Static Web Apps CLI configuration file"] = 357,
    ["Azure Static Web Apps configuration file"] = 356,
    ["Better Code Hub"] = 464,
    BizTalkServerApplicationSchema = 436,
    ...
    ["Butane config schema"] = 498,
    ["CICS TS resource overrides"] = 505,
    ["CMake Presets"] = 68,
    ["CSR Framework"] = 76,
    ...
    ["Error pages"] = 148,
    Esquio = 146,
    ["Estuary Flow Catalog Schema"] = 502,
    ["Expo SDK"] = 151,
    ...
    Goreleaser = 178,
    ["Goreleaser Pro"] = 179,
    ["Gradle Build Cache Node"] = 461,
    ["Gradle Enterprise"] = 460,
    ...
    ["JSON Feed"] = 216,
    ["JSON Resume"] = 321,
    ["JSON Schema Draft 2020-12"] = 415,
    ["JSON Schema Draft 4"] = 412,
    ["JSON Schema Draft 7"] = 413,
    ["JSON Schema Draft 8"] = 414,
    ...
    ["Netin Diagnostic System Template"] = 483,
    ...
    Opctl = 432,
    ["OpenWeather Current Weather API"] = 468,
    ["OpenWeather Road Risk API"] = 467,
    ...
    Ray = 444,
    ["Read the Docs"] = 315,
    ["Red-DiscordBot Cog"] = 316,
    ["Red-DiscordBot Cog Repo"] = 317,
    Renovate = 322,
    RoadRunner = 323,
    SWADL = 366,
    ["Sapphire CLI Config"] = 324,
    ["SauceCTL Configuration"] = 480,
    ["Schema Catalog"] = 337,
    ["Scoop manifest"] = 342,
    ["Semantic Release"] = 343,
    ["Semgrep Rule"] = 344,
    ["Serverless Framework Configuration"] = 487,
    ["Settings.paf"] = 346,
    ["Shopware 6 Configuration"] = 488,
    ["Shopware CLI Extension Store Configuration"] = 489,
    ["Shopware CLI Project Store Configuration"] = 490,
    Solidarity = 351,
    ["Source Maps v3"] = 352,
    SpecIF = 353,
    ["Sponge Mixin configuration"] = 354,
    ["StackHawk Scanner Configuration"] = 486,
    ["StackHead CLI config"] = 358,
    ["StackHead module configuration"] = 359,
    ["StackHead project definition"] = 360,
    Stale = 361,
    ["Statamic Blueprint"] = 362,
    ["Stryker Mutator"] = 363,
    ["StyleCop Analyzers Configuration"] = 364,
    ["Swagger API 2.0"] = 367,
    ["Taskfile YAML Schema"] = 470,
    Taurus = 368,
    ["TestEnvironment.json"] = 374,
    Tikibase = 371,
    ["Traefik v2"] = 376,
    ["Traefik v2 File Provider"] = 377,
    Tye = 492,
    ["UI5 Manifest"] = 389,
    ["Ubuntu Server Autoinstall"] = 387,
    ["Uniswap Token List"] = 453,
    Updatecli = 499,
    ["User Journey Map YAML Schema"] = 473,
    V2Ray = 503,
    ["VSCode Code Snippets"] = 90,
    ["VSIX CLI publishing"] = 401,
    ["Vela Pipeline Configuration"] = 393,
    Vercel = 89,
    ["Web App Manifest"] = 405,
    ["Web types"] = 408,
    WebExtensions = 404,
    ["Webman package recipe"] = 506,
    ["Windows Package Manager Installer Manifest"] = 450,
    ["Windows Package Manager Locale Manifest"] = 451,
    ["Windows Package Manager Singleton Manifest"] = 449,
    ["Woodpecker pipeline config"] = 482,
    ["Xstate Machine Schema"] = 497,
    ["Yippee-Ki-JSON configuration YML"] = 455,
    ["angular.json"] = 8,
    ...
    ["prettierrc.json"] = 297,
    ["prisma.yml"] = 298,
    ["project-1.0.0-beta3.json"] = 300,
    ["project-1.0.0-beta4.json"] = 301,
    ["project-1.0.0-beta5.json"] = 302,
    ["project-1.0.0-beta6.json"] = 303,
    ["project-1.0.0-beta8.json"] = 304,
    ["project-1.0.0-rc1.json"] = 305,
    ["project-1.0.0-rc2.json"] = 306,
    ["project.json"] = 299,
    ["prometheus.json"] = 307,
    ["prometheus.rules.json"] = 308,
    ["proxies.json"] = 309,
    ["publiccode.yml"] = 310,
    ["pubspec.yaml"] = 311,
    ["pyrseas-0.8.json"] = 314,
    ["release drafter"] = 439,
    ["sarif-1.0.0.json"] = 325,
    ["sarif-2.0.0.json"] = 326,
    ["sarif-2.1.0"] = 335,
    ["sarif-2.1.0-rtm.2"] = 327,
    ["sarif-2.1.0-rtm.3"] = 329,
    ["sarif-2.1.0-rtm.4"] = 331,
    ["sarif-2.1.0-rtm.5"] = 333,
    ["sarif-external-property-file-2.1.0"] = 336,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 328,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 330,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 332,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 334,
    ["schema.org - Action"] = 338,
    ["schema.org - ContactPoint"] = 339,
    ["schema.org - Place"] = 340,
    ["schema.org - Thing"] = 341,
    ["service.datadog.yaml"] = 221,
    ["servicehub.config.json"] = 418,
    ["servicehub.service.json"] = 417,
    ["settings.job"] = 345,
    ["sfdx-hardis configuration"] = 347,
    ["size-limit configuration"] = 348,
    ["skaffold.yaml"] = 478,
    ["skyuxconfig.json"] = 349,
    snapcraft = 350,
    swcrc = 466,
    taskcat = 435,
    ["template.json"] = 369,
    ["templatsources.json"] = 370,
    ["theme.json"] = 372,
    tmLanguage = 373,
    ["trunk.yaml schema"] = 378,
    ["ts-force-config.json"] = 382,
    ["tsconfig.json"] = 379,
    ["tsd.json"] = 380,
    ["tsdrc.json"] = 381,
    ["tslint.json"] = 383,
    ...
    ["version.json"] = 394,
    ["vim-addon-info"] = 395,
    ["vs-2017.3.host.json"] = 397,
    ["vs-nesting.json"] = 398,
    ["vsls.json"] = 396,
    ["vss-extension.json"] = 402,
    ["webhint.io"] = 507,
    ["webjobpublishsettings.json"] = 407,
    ["webjobs-list.json"] = 406,
    ["xs-app.json"] = 431,
    ["xunit.runner.json"] = 416,
    yamllint = 454,
    zuul = 440,
    ["Žinoma"] = 448
  },
