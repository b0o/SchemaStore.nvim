...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 189,
    [".cryproj (generic)"] = 638,
    [".cryproj engine-5.2"] = 633,
    [".cryproj engine-5.3"] = 634,
    [".cryproj engine-5.4"] = 635,
    [".cryproj engine-5.5"] = 636,
    [".cryproj engine-dev"] = 637,
    [".eslintrc"] = 243,
    [".esmrc.json"] = 235,
    [".ffizer.yaml"] = 247,
    [".htmlhintrc"] = 301,
    ...
    [".pmbot.yml"] = 445,
    [".postcssrc"] = 450,
    [".powerpages-web-template-manifest"] = 452,
    [".pre-commit-config.yml"] = 453,
    [".pre-commit-hooks.yml"] = 454,
    [".putout.json"] = 474,
    [".rehyperc"] = 486,
    [".remarkrc"] = 488,
    [".sprite files"] = 543,
    ...
    ["<div>RIOTS' studio configuration"] = 616,
    ["@factorial/drupal-breakpoints-css"] = 4,
    ["A micro editor config"] = 364,
    AIConfig = 11,
    ["API Builder"] = 681,
    ["AVA Configuration"] = 740,
    ...
    ["Adobe UXP Manifest"] = 805,
    ["Aerleon Network & Service Definitions"] = 7,
    ["Aerleon Policy"] = 8,
    ["Airlock Microgateway"] = 12,
    ["Airplane task"] = 13,
    ["Alacritty Configuration"] = 712,
    ["All Contributors configuration file"] = 770,
    ...
    ["Azure Pipelines"] = 64,
    ["Azure Static Web Apps CLI configuration file"] = 546,
    ["Azure Static Web Apps configuration file"] = 545,
    ["BX CI"] = 102,
    ["Bashly (bashly.yml)"] = 774,
    ["Bashly Settings (bashly-settings.yml)"] = 775,
    ["Better Code Hub"] = 685,
    ["Better Scripts"] = 103,
    Bigconfig = 81,
    BizTalkServerApplicationSchema = 655,
    Bleep = 104,
    ...
    ["Butane Config"] = 725,
    ["CGS Custom Card Game (CardGameDef.json)"] = 810,
    ["CICS TS region tagging"] = 734,
    ["CICS TS resource import"] = 735,
    ["CICS TS resource model"] = 736,
    ["CICS TS resource overrides"] = 737,
    ["CMake Presets"] = 105,
    ["CNC Codes"] = 116,
    ...
    ["Databricks Asset Bundles"] = 791,
    ["Datadog Service Definition"] = 341,
    ["Datahub Ingestion Recipe"] = 741,
    ["Dein Config"] = 122,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 782,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 771,
    ["Elgato Stream Deck"] = 234,
    ["Embrace Config"] = 752,
    Endurica = 795,
    ["Error pages"] = 238,
    Esquio = 236,
    ["Estuary Flow Catalog"] = 731,
    ["Expo SDK"] = 241,
    ["F-Droid Data metadata"] = 246,
    ["Facets - FSDL - Application"] = 244,
    ["FasterCI Configuration"] = 65,
    FiQuS = 250,
    Firebase = 248,
    ["Fossa configuration file"] = 257,
    ["Fossa's fossa-deps file"] = 258,
    ["Foundry VTT - Base package Manifest"] = 252,
    ["Foundry VTT - Module Manifest"] = 253,
    ["Foundry VTT - System Data Template"] = 256,
    ["Foundry VTT - System Manifest"] = 254,
    ["Foundry VTT - World Manifest"] = 255,
    ["Foxx Manifest"] = 66,
    ["Freifunk.de Community API"] = 69,
    ["Frogbot Config"] = 70,
    ["G2P Mapping Configuration"] = 262,
    ["GCP Blueprint Metadata"] = 265,
    Gaspar = 263,
    ["GatewayCore API Gateway"] = 264,
    ["GeoJSON.json latest"] = 729,
    GherKing = 733,
    ["GitHub Action"] = 268,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 807,
    GitVersion = 267,
    ["Gitpod Configuration"] = 276,
    ["GlazeWM settings"] = 809,
    ...
    ["Goreleaser Pro"] = 282,
    Goss = 283,
    ["Gradle Build Cache Node"] = 683,
    ["Gradle Enterprise"] = 682,
    ["Grafana 5.x Dashboard"] = 284,
    ["GraphQL Code Generator"] = 288,
    ["GraphQL Config"] = 287,
    ["GraphQL Mesh"] = 286,
    ["Grunt JSHint task"] = 292,
    ["Grunt Watch task"] = 293,
    ["Grunt base task"] = 294,
    ["Grunt clean task"] = 290,
    ["Grunt copy task"] = 289,
    ["Grunt cssmin task"] = 291,
    HEMTT = 652,
    Hadolint = 664,
    Hammerkit = 692,
    ["Hardware Sentry Configuration"] = 745,
    Hatch = 665,
    Hayson = 296,
    ["Haystack Pipeline"] = 297,
    ["Hazelcast 5 Configuration"] = 298,
    ["Helm Chart.lock"] = 141,
    ["Helm Chart.yaml"] = 140,
    ...
    ["IVMS101 by CODE Protocol"] = 808,
    Istanbul = 748,
    ["JDownloader2 crawler multi-rules"] = 319,
    ["JDownloader2 crawler single-rules"] = 318,
    ["JFrog Applications Config"] = 320,
    ["JFrog File Spec"] = 321,
    ["JFrog Pipelines YML DSL"] = 754,
    ["JMeter DSL cli config"] = 322,
    JReleaser = 324,
    ["JSON Document Transform"] = 331,
    ["JSON Feed"] = 332,
    ["JSON Resume"] = 493,
    ["JSON Schema Draft 2020-12"] = 629,
    ["JSON Schema Draft 4"] = 626,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 792,
    ["JSON Schema Draft 7"] = 627,
    ["JSON Schema Draft 7 (unofficial strict)"] = 793,
    ["JSON Schema Draft 8 (2019-09)"] = 628,
    ["JSON-API"] = 330,
    ["JSON-e templates"] = 690,
    ["JSON-stat 2.0"] = 623,
    JSONPatch = 334,
    Jasmine = 314,
    Jekyll = 315,
    ["Jenkins X Pipelines"] = 316,
    ["Jenkins X Requirements"] = 317,
    ["Jovo Language Models"] = 323,
    ["KIMMDY config file"] = 339,
    ["KSP-AVC"] = 624,
    ["KSP-CKAN"] = 625,
    ["Karakum configuration file"] = 259,
    Kas = 337,
    ["Keycloak REST API"] = 762,
    ["Knative Functions - func.yaml"] = 260,
    ["KoDE/CI build.yaml"] = 750,
    ["Kong DBLess config"] = 751,
    KrakenD = 340,
    LOOBin = 359,
    Lefthook = 348,
    ["Liferay client-extension.yaml"] = 355,
    ["LinkML Metamodel"] = 357,
    Liquibase = 697,
    ["Liquibase Flow File"] = 698,
    ["Lively Properties"] = 358,
    ["Lobe AI Agent"] = 63,
    ["MLOS Configs"] = 393,
    ["MS2Rescore Configuration"] = 395,
    ["Madness (madness.yml)"] = 773,
    Markdownlint = 701,
    ["Mason Registry"] = 703,
    ["MegaLinter configuration"] = 365,
    ["MegaLinter descriptor"] = 366,
    Melange = 799,
    ["Meltano plugin discovery definition"] = 368,
    ["Meltano project definition"] = 367,
    ["MetricsHub Configuration"] = 369,
    ["MetricsHub Connector Configuration"] = 370,
    ["Micro Editor Syntax"] = 783,
    ["Microsoft Band Web Tile"] = 371,
    ["Minecraft Custom Main Menu Mod"] = 800,
    ["Minecraft Data Pack Advancement"] = 373,
    ["Minecraft Data Pack Biome"] = 374,
    ["Minecraft Data Pack Configured Carver"] = 375,
    ["Minecraft Data Pack Damage Type"] = 376,
    ["Minecraft Data Pack Dimension"] = 378,
    ["Minecraft Data Pack Dimension Type"] = 377,
    ["Minecraft Data Pack Item Modifier"] = 379,
    ["Minecraft Data Pack Loot Table"] = 380,
    ["Minecraft Data Pack Metadata"] = 381,
    ["Minecraft Data Pack Predicate"] = 382,
    ["Minecraft Data Pack Recipe"] = 383,
    ["Minecraft Data Pack Tag"] = 384,
    ["Minecraft Data Pack Template Pool"] = 385,
    ["Minecraft Data Pack Trim Material"] = 390,
    ["Minecraft Data Pack Trim Pattern"] = 391,
    ["Minecraft Resource Pack Lang"] = 386,
    ["Minecraft Resource Pack Particle"] = 387,
    ["Minecraft Resource Pack Texture Mcmeta"] = 389,
    ["Minecraft Resourcepack Sounds"] = 388,
    ["MkDocs Configuration 1.0"] = 392,
    ["MongoDB Atlas Search Index Definition"] = 749,
    ["Monika Configuration"] = 747,
    ["Motif config"] = 648,
    ["NOX Framework (Service)"] = 409,
    ["Netin Diagnostic System Template"] = 707,
    ["Netlify config"] = 400,
    ...
    ["OpenUtau ustx"] = 422,
    ["OpenWeather Current Weather API"] = 689,
    ["OpenWeather Road Risk API"] = 688,
    ["Ory Hydra configuration"] = 302,
    ["Ory Keto configuration"] = 342,
    ...
    ["Pipeline component"] = 699,
    ["PocketMine plugin.yml"] = 446,
    ["Postman collection"] = 451,
    ["Problem object RFC9457"] = 797,
    ["Problem package generators"] = 458,
    Pterodactyl = 744,
    ["Pull Request Labeler"] = 473,
    Pulumi = 479,
    PyProject = 480,
    Pyright = 481,
    Qgoda = 482,
    Qodana = 717,
    ["Quali Torque Blueprint Spec 2"] = 742,
    ["QueryFirst config file"] = 765,
    ["RKE Cluster Configuration JSON"] = 696,
    ["RKE Cluster Configuration YAML"] = 695,
    ["Rancher Fleet"] = 476,
    Ray = 663,
    ["Read the Docs"] = 478,
    ["Red-DiscordBot Cog"] = 483,
    ["Red-DiscordBot Cog Repo"] = 484,
    ["Red-DiscordBot Trivia"] = 485,
    RenderCV = 495,
    Renovate = 494,
    ["Replit config"] = 489,
    RoadRunner = 496,
    ["Rudder techniques"] = 803,
    Ruff = 491,
    ["Rust Project"] = 492,
    ["Rust toolchain"] = 499,
    ["SIL Kit Participant Configuration"] = 531,
    ["SIL Kit Registry Configuration"] = 532,
    SWADL = 557,
    ["Safebox Config"] = 755,
    ["Sapphire CLI Config"] = 502,
    ["SauceCTL Configuration"] = 704,
    ["Schema Catalog"] = 516,
    ["Scoop manifest"] = 521,
    ["Semantic Data Fabric (SDF) file"] = 522,
    ["Semgrep Rule"] = 524,
    ["Serenity Code Generator (Sergen)"] = 525,
    ["Serverless Framework Configuration"] = 711,
    ["Serverless Workflow"] = 713,
    ["Settings.paf"] = 527,
    ["Shopware 6 Configuration"] = 714,
    ["Shopware CLI Extension Store Configuration"] = 715,
    ["Shopware CLI Project Store Configuration"] = 716,
    Sigma = 529,
    ["Sigrid scope configuration file"] = 530,
    ["SkyPilot Task JSON"] = 804,
    ["Slack app manifest"] = 534,
    Solidarity = 537,
    ["Solution filters"] = 538,
    ["Source Maps v3"] = 539,
    Sourcery = 540,
    SpecIF = 541,
    ["Sponge Mixin configuration"] = 542,
    StackBlitz = 547,
    ["StackHawk Scanner Configuration"] = 710,
    Stale = 548,
    ["Starlake Data Pipeline"] = 686,
    Starship = 549,
    ["Statamic Blueprint"] = 550,
    ["Stella configuration file"] = 551,
    ["StrmPrivacy Data Connector"] = 759,
    ["StrmPrivacy Data Contract"] = 760,
    ["StrmPrivacy SimpleSchema"] = 757,
    ["StrmPrivacy Stream"] = 758,
    ["StrmPrivacy batch job configuration file"] = 756,
    ["Stryker Mutator"] = 554,
    ["StyleCop Analyzers Configuration"] = 555,
    ["Stylelint (.stylelintrc)"] = 556,
    ["Sublime Syntax"] = 761,
    ["Subsquid squid manifest"] = 806,
    ["Swagger API 2.0"] = 558,
    TSON = 583,
    TSTyche = 584,
    Talhelper = 560,
    ["Talisman configuration"] = 561,
    ["Taskfile config"] = 691,
    Taurus = 562,
    ["TestEnvironment.json"] = 571,
    ["TextMate Grammar"] = 570,
    ["Tier.run pricing.json"] = 565,
    Tikibase = 566,
    ["Traefik v2"] = 574,
    ["Traefik v2 File Provider"] = 575,
    ["Travis CI (.travis.yml)"] = 573,
    TunnelHub = 796,
    Turborepo = 572,
    Tye = 718,
    ["UET BuildConfig.json"] = 766,
    ["UI5 Manifest"] = 593,
    ["UNCORS configuration"] = 597,
    ["UTAM Page Object"] = 596,
    ["Ubuntu Server Autoinstall"] = 591,
    ["Uniswap Token List"] = 674,
    ["Unreal Engine Uplugin"] = 767,
    ["Unreal Engine Uproject"] = 768,
    ["Updatecli Compose"] = 726,
    ["Updatecli Policy Manifest"] = 727,
    ["Updatecli Policy Metadata"] = 728,
    Uplift = 764,
    ["User Journey Map"] = 694,
    V2Ray = 732,
    ["VSCode Code Snippets"] = 160,
    ["VSIX CLI publishing"] = 611,
    ["Vela Pipeline Configuration"] = 600,
    Vercel = 159,
    Visivo = 794,
    ["Web App Manifest"] = 618,
    ["Web types"] = 621,
    WebExtensions = 617,
    ["Webman package recipe"] = 738,
    ["Windows Package Manager Installer Manifest"] = 671,
    ["Windows Package Manager Locale Manifest"] = 672,
    ["Windows Package Manager Singleton Manifest"] = 670,
    ["Woodpecker pipeline config"] = 706,
    ["Wrangler CLI"] = 622,
    ["Xstate Machine"] = 724,
    ["Yarn Config (.yarnrc.yml)"] = 684,
    ["Yippee-Ki-JSON configuration YML"] = 676,
    ["aerleon.yml"] = 6,
    ["angular.json"] = 14,
    apko = 798,
    ...
    ["ecosystem.json"] = 232,
    eksctl = 233,
    ["electron-builder configuration file"] = 239,
    ["epr-manifest.json"] = 237,
    ["evcc.yaml"] = 240,
    ["ezd task runner"] = 242,
    ["fabric.mod.json"] = 245,
    ["first-timers-bot"] = 251,
    ...
    ["ide.host.json"] = 305,
    ["ifstate.conf"] = 306,
    ["imageoptimizer.json"] = 307,
    ["importmap.json"] = 310,
    ["ioBroker Configuration"] = 311,
    ["ioBroker JSON UI"] = 312,
    ["ioBroker Package manifest"] = 313,
    ["ize.toml"] = 763,
    ["jsconfig.json"] = 335,
    ["jscpd Configuration"] = 743,
    jsdoc = 662,
    ["k3d.yaml"] = 336,
    ["k9s plugin.yml"] = 338,
    ["kontinuous-config.yaml"] = 344,
    ["kontinuous-values.yaml"] = 343,
    ["kustomization.yaml"] = 345,
    ["label-commenter-config.yml"] = 346,
    ["latexindent configuration"] = 62,
    ["launchsettings.json"] = 347,
    lazydocker = 785,
    lazygit = 784,
    ["lego.json"] = 349,
    ["lerna.json"] = 350,
    ["lgtm.yml"] = 351,
    ["liblab.config.json"] = 352,
    ["libman.json"] = 353,
    ["license-report-config.json"] = 354,
    ["linkinator.config.json"] = 356,
    ["lint-staged (.lintstagedrc)"] = 642,
    ["local.settings.json"] = 361,
    ["localazy.json"] = 362,
    ["lotus.yaml"] = 360,
    ["lsdlschema.json"] = 363,
    ["markdown-lint-check"] = 702,
    mboats = 709,
    ["micro-settings.json"] = 778,
    ["mimetypes.json"] = 372,
    ["mirrord config"] = 643,
    mise = 644,
    ["mise-settings"] = 645,
    ...
    ["pattern.json"] = 444,
    ["petstore-v1.0"] = 753,
    pgap_yaml_input_reader = 443,
    ["plagiarize-me.yaml"] = 448,
    ["plagiarize.yaml"] = 447,
    ["portman.json"] = 449,
    ["prettierrc.json"] = 456,
    ["prisma.yml"] = 457,
    ["project-1.0.0-beta3.json"] = 460,
    ["project-1.0.0-beta4.json"] = 461,
    ["project-1.0.0-beta5.json"] = 462,
    ["project-1.0.0-beta6.json"] = 463,
    ["project-1.0.0-beta8.json"] = 464,
    ["project-1.0.0-rc1.json"] = 465,
    ["project-1.0.0-rc2.json"] = 466,
    ["project.json"] = 459,
    ["prometheus.json"] = 467,
    ["prometheus.rules.json"] = 468,
    ["prometheus.rules.test.json"] = 469,
    ["proxies.json"] = 470,
    ["publiccode.yml"] = 471,
    ["pubspec.yaml"] = 472,
    ["pyrseas-0.8.json"] = 475,
    ["quilt.mod.json"] = 779,
    ["release drafter"] = 658,
    ["release-plz.toml"] = 487,
    ["rivet.yaml"] = 801,
    rockcraft = 497,
    rustfmt = 498,
    samt = 500,
    samtrc = 501,
    ["sarif-1.0.0.json"] = 503,
    ["sarif-2.0.0.json"] = 504,
    ["sarif-2.1.0"] = 514,
    ["sarif-2.1.0-rtm.2"] = 505,
    ["sarif-2.1.0-rtm.3"] = 507,
    ["sarif-2.1.0-rtm.4"] = 509,
    ["sarif-2.1.0-rtm.5"] = 511,
    ["sarif-2.1.0-rtm.6"] = 512,
    ["sarif-external-property-file-2.1.0"] = 515,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 506,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 508,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 510,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 513,
    ["schema.org - Action"] = 517,
    ["schema.org - ContactPoint"] = 518,
    ["schema.org - Place"] = 519,
    ["schema.org - Thing"] = 520,
    ["secrethub.yml"] = 781,
    ["semantic-release"] = 523,
    ["servicehub.config.json"] = 632,
    ["servicehub.service.json"] = 631,
    ["settings.job"] = 526,
    ["sfdx-hardis configuration"] = 528,
    ["size-limit configuration"] = 533,
    ["skaffold.yaml"] = 700,
    ["skyuxconfig.json"] = 535,
    snapcraft = 536,
    ["sqlc configuration"] = 544,
    ["stripe-app-local.json"] = 553,
    ["stripe-app.json"] = 552,
    swcrc = 687,
    ["task.json"] = 559,
    taskcat = 654,
    ["template.json"] = 563,
    ["templatsources.json"] = 564,
    ["theme.json"] = 567,
    ["tizen_workspace.json"] = 568,
    tldr = 569,
    tmuxinator = 640,
    ["transcend.yml"] = 576,
    ["tree-sitter grammar.json"] = 285,
    ["trunk.yaml"] = 577,
    ["ts-force-config.json"] = 581,
    ["tsconfig.json"] = 578,
    ["tsd.json"] = 579,
    ["tsdrc.json"] = 580,
    ["tslint.json"] = 582,
    ...
    ["vega-lite.json"] = 599,
    ["vega.json"] = 598,
    ["venvironment-basic.yaml"] = 602,
    ["venvironment.yaml"] = 601,
    ["version.json"] = 603,
    ["vim-addon-info"] = 605,
    ["vs-2017.3.host.json"] = 607,
    ["vs-nesting.json"] = 608,
    ["vsls.json"] = 606,
    ["vss-extension.json"] = 612,
    ["vtesttree.yaml"] = 613,
    ["vtestunit.yaml"] = 614,
    ["warp-keysets.json"] = 787,
    ["warp-themes.json"] = 788,
    ["warp-workflows.json"] = 789,
    ["webhint.io"] = 739,
    ["webjobpublishsettings.json"] = 620,
    ["webjobs-list.json"] = 619,
    ["xs-app.json"] = 650,
    ["xunit.runner.json"] = 630,
    yamllint = 675,
    zuul = 659,
    ["Žinoma"] = 669
  },
