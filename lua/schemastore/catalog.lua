...
M.json = {
  ...
  index = {
    ...
    ["StrmPrivacy Data Connector"] = 855,
    ["StrmPrivacy Data Contract"] = 856,
    ["StrmPrivacy SimpleSchema"] = 853,
    ["StrmPrivacy Stream"] = 854,
    ["StrmPrivacy batch job configuration file"] = 852,
    ["Stryker Mutator"] = 648,
