...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 158,
    [".cryproj (generic)"] = 534,
    [".cryproj engine-5.2"] = 529,
    [".cryproj engine-5.3"] = 530,
    [".cryproj engine-5.4"] = 531,
    [".cryproj engine-5.5"] = 532,
    [".cryproj engine-dev"] = 533,
    [".csscomb.json"] = 160,
    [".csslintrc"] = 161,
    [".es6importsorterrc.json"] = 657,
    [".eslintrc"] = 206,
    [".esmrc.json"] = 198,
    [".ffizer.yaml"] = 210,
    [".htmlhintrc"] = 251,
    ...
    [".mtaext"] = 543,
    [".nodehawkrc"] = 340,
    [".npmpackagejsonlintrc"] = 343,
    [".phraseapp.yml"] = 378,
    [".pmbot.yml"] = 370,
    [".postcssrc"] = 375,
    [".pre-commit-config.yml"] = 376,
    [".pre-commit-hooks.yml"] = 377,
    [".putout.json"] = 395,
    [".rehyperc"] = 404,
    [".remarkrc"] = 405,
    [".sprite files"] = 452,
    ...
    [".vsext"] = 509,
    [".yarnrc.yml"] = 575,
    ["<div>RIOTS' studio configuration"] = 513,
    ["@factorial/drupal-breakpoints-css"] = 5,
    ["A micro editor config schema"] = 305,
    ["API Builder"] = 572,
    ["AVA Configuration Schema"] = 629,
    ["AWS CDK cdk.json"] = 143,
    ["AWS CloudFormation"] = 144,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 145,
    ["Airlock Microgateway"] = 9,
    ["Airplane task"] = 10,
    ["Alacritty Configuration Schema"] = 604,
    ["All Contributors configuration file"] = 656,
    ...
    ["Azure Pipelines"] = 48,
    ["Azure Static Web Apps CLI configuration file"] = 454,
    ["Azure Static Web Apps configuration file"] = 453,
    ["BX CI"] = 83,
    ["Better Code Hub"] = 577,
    ["Better Scripts"] = 84,
    BizTalkServerApplicationSchema = 549,
    ...
    ["Butane Config"] = 616,
    ["CICS TS region tagging"] = 623,
    ["CICS TS resource import"] = 624,
    ["CICS TS resource model"] = 625,
    ["CICS TS resource overrides"] = 626,
    ["CMake Presets"] = 85,
    ...
    ["Datahub Ingestion Recipe Schema"] = 630,
    ...
    ["Embrace Config Schema"] = 641,
    ["Error pages"] = 201,
    Esquio = 199,
    ["Estuary Flow Catalog Schema"] = 620,
    ["Expo SDK"] = 204,
    ...
    Goreleaser = 233,
    ["Goreleaser Pro"] = 234,
    ["Gradle Build Cache Node"] = 574,
    ["Gradle Enterprise"] = 573,
    ...
    Hadolint = 558,
    Hammerkit = 584,
    ["Hardware Sentry Configuration"] = 634,
    Hayson = 246,
    ...
    ["JFrog File Spec"] = 270,
    ["JFrog Pipelines YML DSL"] = 643,
    ["JMeter DSL cli config schema"] = 271,
    ["JSON Document Transform"] = 279,
    ["JSON Feed"] = 280,
    ["JSON Resume"] = 411,
    ["JSON Schema Draft 2020-12"] = 525,
    ["JSON Schema Draft 4"] = 522,
    ["JSON Schema Draft 7"] = 523,
    ["JSON Schema Draft 8"] = 524,
    ...
    ["KSP-CKAN"] = 521,
    Kas = 285,
    ["Keycloak REST API"] = 649,
    ["Knative Functions - func.yaml"] = 216,
    ["KoDE/CI build.yaml"] = 639,
    ["Kong DBLess Schema"] = 640,
    KrakenD = 286,
    LOOBin = 301,
    ["LinkML Metamodel"] = 299,
    Liquibase = 589,
    ["Liquibase Flow File"] = 590,
    ["Lively Properties"] = 300,
    Markdownlint = 593,
    ["Mason Registry"] = 595,
    ["MegaLinter configuration"] = 306,
    ["MegaLinter descriptor"] = 307,
    ["Meltano plugin discovery definition"] = 309,
    ["Meltano project definition"] = 308,
    ["Microsoft Band Web Tile"] = 310,
    ["Minecraft Data Pack Advancement"] = 312,
    ["Minecraft Data Pack Biome"] = 313,
    ["Minecraft Data Pack Configured Carver"] = 314,
    ["Minecraft Data Pack Damage Type"] = 315,
    ["Minecraft Data Pack Dimension"] = 317,
    ["Minecraft Data Pack Dimension Type"] = 316,
    ["Minecraft Data Pack Item Modifier"] = 318,
    ["Minecraft Data Pack Loot Table"] = 319,
    ["Minecraft Data Pack Metadata"] = 320,
    ["Minecraft Data Pack Predicate"] = 321,
    ["Minecraft Data Pack Recipe"] = 322,
    ["Minecraft Data Pack Tag"] = 323,
    ["Minecraft Data Pack Template Pool"] = 324,
    ["Minecraft Resource Pack Lang"] = 325,
    ["Minecraft Resource Pack Particle"] = 326,
    ["Minecraft Resource Pack Texture Mcmeta"] = 328,
    ["Minecraft Resourcepack Sounds"] = 327,
    ["MkDocs Configuration 1.0"] = 329,
    ["MongoDB Atlas Search Index Definition Schema"] = 638,
    ["Monika Configuration Schema"] = 636,
    ["Motif config"] = 542,
    ["NOX Framework (Service)"] = 342,
    ["Netin Diagnostic System Template"] = 599,
    ["Netlify config schema"] = 334,
    ["Nightwatch.js"] = 335,
    ["OSS Review Toolkit configuration"] = 360,
    ["OSS Review Toolkit curation"] = 361,
    ["OSS Review Toolkit package configuration"] = 362,
    ["OSS Review Toolkit repository configuration"] = 363,
    ["OSS Review Toolkit resolutions"] = 364,
    Opctl = 545,
    ["OpenRewrite Resource"] = 355,
    ["OpenWeather Current Weather API"] = 581,
    ["OpenWeather Road Risk API"] = 580,
    ["Ory Hydra configuration"] = 252,
    ["Ory Keto configuration"] = 288,
    ["Ory Kratos configuration"] = 359,
    ["Ory Oathkeeper configuration"] = 349,
    ["Outblocks App configuration"] = 357,
    ["Outblocks database table"] = 358,
    ["Outblocks project configuration"] = 356,
    Packer = 367,
    Pantsbuild = 655,
    ["Pipeline component"] = 591,
    ["PocketMine plugin.yml"] = 371,
    Pterodactyl = 633,
    ["Pull Request Labeler"] = 394,
    Pulumi = 399,
    PyProject = 400,
    Qodana = 609,
    ["Quali Torque Blueprint Spec 2"] = 631,
    ["QueryFirst config file"] = 652,
    ["RKE Cluster Configuration JSON Schema"] = 588,
    ["RKE Cluster Configuration YAML Schema"] = 587,
    ["Rancher Fleet"] = 397,
    Ray = 557,
    ["Read the Docs"] = 398,
    ["Red-DiscordBot Cog"] = 401,
    ["Red-DiscordBot Cog Repo"] = 402,
    ["Red-DiscordBot Trivia"] = 403,
    Renovate = 412,
    ["Replit schema"] = 406,
    RoadRunner = 413,
    Ruff = 409,
    ["Rust Project"] = 410,
    ["Rust toolchain"] = 415,
    ["SIL Kit Participant Configuration"] = 441,
    SWADL = 463,
    ["Sapphire CLI Config"] = 416,
    ["SauceCTL Configuration"] = 596,
    ["Schema Catalog"] = 429,
    ["Scoop manifest"] = 434,
    ["Semgrep Rule"] = 436,
    ["Serenity Code Generator (Sergen)"] = 437,
    ["Serverless Framework Configuration"] = 603,
    ["Serverless Workflow Schema"] = 605,
    ["Settings.paf"] = 439,
    ["Shopware 6 Configuration"] = 606,
    ["Shopware CLI Extension Store Configuration"] = 607,
    ["Shopware CLI Project Store Configuration"] = 608,
    ["Slack app manifest"] = 443,
    Solidarity = 446,
    ["Solution filters"] = 447,
    ["Source Maps v3"] = 448,
    Sourcery = 449,
    SpecIF = 450,
    ["Sponge Mixin configuration"] = 451,
    ["StackHawk Scanner Configuration"] = 602,
    Stale = 455,
    Starship = 456,
    ["Statamic Blueprint"] = 457,
    ["StrmPrivacy Data Connector"] = 647,
    ["StrmPrivacy Data Contract"] = 648,
    ["StrmPrivacy SimpleSchema"] = 645,
    ["StrmPrivacy Stream"] = 646,
    ["StrmPrivacy batch job configuration file"] = 644,
    ["Stryker Mutator"] = 460,
    ["StyleCop Analyzers Configuration"] = 461,
    ["Swagger API 2.0"] = 464,
    TSON = 487,
    ["Talisman configuration"] = 466,
    ["Taskfile YAML Schema"] = 583,
    Taurus = 467,
    ["TestEnvironment.json"] = 475,
    ["Tier.run pricing.json"] = 470,
    Tikibase = 471,
    ["Traefik v2"] = 478,
    ["Traefik v2 File Provider"] = 479,
    Turborepo = 476,
    Tye = 610,
    ["UI5 Manifest"] = 494,
    ["UTAM Page Object"] = 497,
    ["Ubuntu Server Autoinstall"] = 492,
    ["Uniswap Token List"] = 566,
    ["Unreal Engine Uplugin"] = 653,
    ["Unreal Engine Uproject"] = 654,
    Updatecli = 617,
    Uplift = 651,
    ["User Journey Map YAML Schema"] = 586,
    V2Ray = 621,
    ["VSCode Code Snippets"] = 131,
    ["VSIX CLI publishing"] = 510,
    ["Vela Pipeline Configuration"] = 500,
    Vercel = 130,
    ["Web App Manifest"] = 515,
    ["Web types"] = 518,
    WebExtensions = 514,
    ["Webman package recipe"] = 627,
    ["Windows Package Manager Installer Manifest"] = 563,
    ["Windows Package Manager Locale Manifest"] = 564,
    ["Windows Package Manager Singleton Manifest"] = 562,
    ["Woodpecker pipeline config"] = 598,
    ["Xstate Machine Schema"] = 615,
    ["Yippee-Ki-JSON configuration YML"] = 568,
    ["angular.json"] = 11,
    ...
    ["ize.toml"] = 650,
    ["jsconfig.json"] = 283,
    ["jscpd Configuration Schema"] = 632,
    jsdoc = 556,
    ["k3d.yaml"] = 284,
    ...
    ["local.settings.json"] = 302,
    ["localazy.json"] = 303,
    ["lsdlschema.json"] = 304,
    ["markdown-lint-check"] = 594,
    mboats = 601,
    ["mimetypes.json"] = 311,
    ["mirrord-schema"] = 539,
    ["mta.yaml"] = 540,
    ["mtad.yaml"] = 541,
    ["mycode.json"] = 332,
    ["napari plugin manifest"] = 333,
    neoload = 551,
    ["nest-cli"] = 338,
    ["ninjs (News in JSON) 1.3"] = 337,
    ["ninjs (News in JSON) 2.0"] = 336,
    ["nlu.json"] = 339,
    ["nodemon.json"] = 341,
    ["noodl.schema.json"] = 600,
    now = 547,
    ["npm-badges"] = 344,
    ["nswag.json"] = 347,
    ntangle = 348,
    ["nuclei-template.yaml"] = 345,
    ["nuget-project.json"] = 346,
    ["ocelot.json"] = 350,
    ["omnisharp.json"] = 351,
    ["openapi.json"] = 352,
    ["openfin.json"] = 354,
    ["openrpc.json"] = 353,
    ["package.json"] = 365,
    ["package.manifest"] = 366,
    ["pattern.json"] = 369,
    ["petstore-v1.0"] = 642,
    pgap_yaml_input_reader = 368,
    ["plagiarize-me.yaml"] = 373,
    ["plagiarize.yaml"] = 372,
    ["portman.json"] = 374,
    ["prettierrc.json"] = 379,
    ["prisma.yml"] = 380,
    ["project-1.0.0-beta3.json"] = 382,
    ["project-1.0.0-beta4.json"] = 383,
    ["project-1.0.0-beta5.json"] = 384,
    ["project-1.0.0-beta6.json"] = 385,
    ["project-1.0.0-beta8.json"] = 386,
    ["project-1.0.0-rc1.json"] = 387,
    ["project-1.0.0-rc2.json"] = 388,
    ["project.json"] = 381,
    ["prometheus.json"] = 389,
    ["prometheus.rules.json"] = 390,
    ["proxies.json"] = 391,
    ["publiccode.yml"] = 392,
    ["pubspec.yaml"] = 393,
    ["pyrseas-0.8.json"] = 396,
    ["release drafter"] = 552,
    rtx = 408,
    rustfmt = 414,
    ["sarif-1.0.0.json"] = 417,
    ["sarif-2.0.0.json"] = 418,
    ["sarif-2.1.0"] = 427,
    ["sarif-2.1.0-rtm.2"] = 419,
    ["sarif-2.1.0-rtm.3"] = 421,
    ["sarif-2.1.0-rtm.4"] = 423,
    ["sarif-2.1.0-rtm.5"] = 425,
    ["sarif-external-property-file-2.1.0"] = 428,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 420,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 422,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 424,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 426,
    ["schema.org - Action"] = 430,
    ["schema.org - ContactPoint"] = 431,
    ["schema.org - Place"] = 432,
    ["schema.org - Thing"] = 433,
    ["semantic-release"] = 435,
    ["servicehub.config.json"] = 528,
    ["servicehub.service.json"] = 527,
    ["settings.job"] = 438,
    ["sfdx-hardis configuration"] = 440,
    ["size-limit configuration"] = 442,
    ["skaffold.yaml"] = 592,
    ["skyuxconfig.json"] = 444,
    snapcraft = 445,
    ["stripe-app-local.json"] = 459,
    ["stripe-app.json"] = 458,
    swcrc = 579,
    ["task.json"] = 465,
    taskcat = 548,
    ["template.json"] = 468,
    ["templatsources.json"] = 469,
    ["theme.json"] = 472,
    ["tizen_workspace.json"] = 473,
    tmLanguage = 474,
    tmuxinator = 536,
    ["transcend.yml"] = 480,
    ["trunk.yaml schema"] = 481,
    ["ts-force-config.json"] = 485,
    ["tsconfig.json"] = 482,
    ["tsd.json"] = 483,
    ["tsdrc.json"] = 484,
    ["tslint.json"] = 486,
    ...
    ["vega-lite.json"] = 499,
    ["vega.json"] = 498,
    ["venvironment-basic.yaml"] = 502,
    ["venvironment.yaml"] = 501,
    ["version.json"] = 503,
    ["vim-addon-info"] = 504,
    ["vs-2017.3.host.json"] = 506,
    ["vs-nesting.json"] = 507,
    ["vsls.json"] = 505,
    ["vss-extension.json"] = 511,
    ["webhint.io"] = 628,
    ["webjobpublishsettings.json"] = 517,
    ["webjobs-list.json"] = 516,
    ["xs-app.json"] = 544,
    ["xunit.runner.json"] = 526,
    yamllint = 567,
    zuul = 553,
    ["Žinoma"] = 561
  },
