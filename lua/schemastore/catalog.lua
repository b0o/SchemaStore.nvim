...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 14,
    AIConfig = 15,
    ["AMX Muse Program Descriptor"] = 989,
    ["API Builder"] = 809,
    ["AVA Configuration"] = 869,
    ...
    ["Adobe UXP Manifest"] = 929,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Alacritty Configuration"] = 841,
    ["All Contributors configuration file"] = 894,
    ...
    ["Application list for a WinUtil"] = 972,
    ArchitectFX = 976,
    ["Argo Events"] = 29,
    ["Argo Workflows"] = 30,
    AssemblyScript = 33,
    ...
    ["Azure Pipelines"] = 66,
    ["Azure Static Web Apps CLI configuration file"] = 669,
    ["Azure Static Web Apps configuration file"] = 668,
    ["BOSH Deploy Config"] = 90,
    ["BX CI"] = 108,
    ["Bashly (bashly.yml)"] = 898,
    ["Bashly Settings (bashly-settings.yml)"] = 899,
    ["Better Code Hub"] = 813,
    ["Better Scripts"] = 109,
    Bigconfig = 83,
    ["Biome Formatter Config"] = 53,
    ["Bitmovin Encoding Template"] = 982,
    BizTalkServerApplicationSchema = 782,
    Bleep = 110,
    ...
    ["Butane Config"] = 854,
    C4InterFlow = 997,
    ["CGS Card Game Specification (cgs.json)"] = 934,
    ["CICS TS region tagging"] = 863,
    ["CICS TS resource import"] = 864,
    ["CICS TS resource model"] = 865,
    ["CICS TS resource overrides"] = 866,
    ["CMake Presets"] = 111,
    ["CNC Codes"] = 126,
    ["CRS WAF test file"] = 962,
    ["CRS WAF test platform overrides file"] = 963,
    ...
    ["Chamaleon environment"] = 986,
    ["Chamaleon properties"] = 987,
    ["Chamaleon template"] = 985,
    Changesets = 208,
    Cheatsheets = 851,
    ...
    CityJSON = 122,
    ["Clawject config"] = 131,
    ["Cloud Foundry Application Manifest"] = 945,
    ["Cloud Run Spec v1"] = 967,
    ...
    Concord = 961,
    ["Configu .cfgu files"] = 950,
    ["Configu .configu file"] = 951,
    Conjure = 125,
    ["Container Structure Test"] = 796,
    Containerlab = 821,
    ["Crowdsec collection config"] = 217,
    ["Crowdsec parser config"] = 218,
    ["Crowdsec scenario config"] = 219,
    ["CumulusCI Config"] = 130,
    ["Custom Machinery Machine"] = 935,
    ["Custom Machinery Recipe"] = 936,
    ...
    ["DonateCaseBetterCasino menu"] = 990,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 906,
    ["EAS config"] = 283,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 895,
    ["EasyVCR .NET"] = 284,
    ["Eidolon Resource"] = 977,
    ...
    ["Goreleaser Pro"] = 342,
    Goss = 343,
    ["Gradle Build Cache Node"] = 811,
    ["Gradle Enterprise"] = 810,
    ...
    Hadolint = 792,
    Hammerkit = 820,
    ["Hardware Sentry Configuration"] = 874,
    Hatch = 793,
    Hayson = 356,
    ...
    ["JFrog File Spec"] = 385,
    ["JFrog Pipelines YML DSL"] = 883,
    ["JMeter DSL cli config"] = 386,
    JReleaser = 388,
    ["JSON Document Transform"] = 396,
    ["JSON Feed"] = 397,
    ["JSON Resume"] = 605,
    ["JSON Schema Draft 2020-12"] = 762,
    ["JSON Schema Draft 4"] = 759,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 916,
    ["JSON Schema Draft 7"] = 760,
    ["JSON Schema Draft 7 (unofficial strict)"] = 917,
    ["JSON Schema Draft 8 (2019-09)"] = 761,
    ["JSON-API"] = 395,
    ["JSON-e templates"] = 818,
    ["JSON-stat 2.0"] = 755,
    JSONPatch = 399,
    ...
    ["Metadata for a Cinnamon spice"] = 970,
    ["Metatype Configuration"] = 447,
    ["MetricsHub Configuration"] = 448,
    ["MetricsHub Connector Configuration"] = 449,
    ["Micro Editor Syntax"] = 907,
    ["Microsoft Band Web Tile"] = 450,
    ["Microsoft RulesEngine workflow rules"] = 958,
    ["Microsoft RulesEngine workflow rules list"] = 959,
    ["Minecraft Custom Main Menu Mod"] = 924,
    ...
    ["MongoDB Atlas Search Index Definition"] = 878,
    ["Monika Configuration"] = 876,
    ["Monoweave Configuration"] = 475,
    ["Motif config"] = 775,
    ["NOX Framework (Service)"] = 492,
    ["Netin Diagnostic System Template"] = 836,
    ["Netlify config"] = 483,
    ...
    ["OpenUtau ustx"] = 510,
    ["OpenWeather Current Weather API"] = 817,
    ["OpenWeather Road Risk API"] = 816,
    ...
    ["Pipeline component"] = 828,
    ["Plex Prerolls"] = 546,
    ["PocketMine plugin.yml"] = 543,
    ["Postman collection"] = 550,
    ["Preset list for a WinUtil"] = 973,
    ["Problem object RFC9457"] = 921,
    ...
    Qgoda = 586,
    Qodana = 846,
    ["Qt Creator workspace file"] = 952,
    ["Quali Torque Blueprint Spec 2"] = 871,
    ["QueryFirst config file"] = 889,
    ["RKE Cluster Configuration JSON"] = 825,
    ["RKE Cluster Configuration YAML"] = 824,
    RadioHound = 578,
    Railway = 587,
    ["Rancher Fleet"] = 580,
    ["Rattler-build"] = 588,
    ...
    ["Render Blueprints"] = 823,
    RenderCV = 607,
    Renovate = 606,
    ["Replit config"] = 601,
    RoadRunner = 609,
    ["Rudder techniques"] = 927,
    Ruff = 603,
    ["Rust Project"] = 604,
    ["Rust toolchain"] = 613,
    ["SDMX data message"] = 639,
    ["SDMX metadata message"] = 638,
    ["SDMX structure message"] = 637,
    ["SIL Kit Participant Configuration"] = 649,
    ["SIL Kit Registry Configuration"] = 650,
    ["SPDX 2.3"] = 666,
    SWADL = 680,
    ["Safebox Config"] = 884,
    ["Sapphire CLI Config"] = 616,
    ["SauceCTL Configuration"] = 833,
    ["Schema Catalog"] = 631,
    ["Scoop manifest"] = 636,
    ["Semantic Data Fabric (SDF) file"] = 640,
    ["Semgrep Rule"] = 642,
    ["Serenity Code Generator (Sergen)"] = 643,
    ["Serverless Framework Configuration"] = 840,
    ["Serverless Workflow"] = 842,
    ["Settings for a Cinnamon spice"] = 969,
    ["Settings.paf"] = 645,
    ["Shopware 6 Configuration"] = 843,
    ["Shopware CLI Extension Store Configuration"] = 844,
    ["Shopware CLI Project Store Configuration"] = 845,
    ["Sigma Detection Rule"] = 647,
    ["Sigrid scope configuration file"] = 648,
    ["SkyPilot Task JSON"] = 928,
    ["Slack app manifest"] = 652,
    Solidarity = 655,
    ["Solution filters"] = 656,
    ["Source Maps v3"] = 657,
    Sourcery = 658,
    ["Speakeasy Generation Config File"] = 662,
    ["Speakeasy Lint Configuration File"] = 659,
    ["Speakeasy Test Generation Configuration File"] = 660,
    ["Speakeasy Workflow File"] = 661,
    SpecIF = 663,
    ["Sponge Mixin configuration"] = 664,
    StackBlitz = 670,
    ["StackHawk Scanner Configuration"] = 839,
    Stale = 671,
    ["Starlake Data Pipeline"] = 814,
    Starship = 672,
    ["Statamic Blueprint"] = 673,
    ["Stella configuration file"] = 674,
    ["Stryker Mutator"] = 677,
    ["StyleCop Analyzers Configuration"] = 678,
    ["Stylelint (.stylelintrc)"] = 679,
    ["Sublime Syntax"] = 885,
    ["Subsquid squid manifest"] = 930,
    ["Swagger API 2.0"] = 681,
    ["Synadia Connect Component"] = 682,
    TSON = 713,
    TSTyche = 714,
    ["Tab data for a LinUtil"] = 975,
    ["Tab list for a LinUtil"] = 974,
    Talhelper = 684,
    ["Talisman configuration"] = 685,
    ["Taskfile config"] = 819,
    Taurus = 686,
    Tauticord = 687,
    ["TestEnvironment.json"] = 696,
    ["TextMate Grammar"] = 695,
    ["Tier.run pricing.json"] = 690,
    Tikibase = 691,
    ["Traefik v2"] = 699,
    ["Traefik v2 File Provider"] = 700,
    ["Traefik v3"] = 701,
    ["Traefik v3 File Provider"] = 702,
    ["Travis CI (.travis.yml)"] = 698,
    Trident = 999,
    ["TrueScript for *.tscript files"] = 705,
    ["Tugboat QA config.yml"] = 996,
    TunnelHub = 920,
    Turborepo = 697,
    Tycho = 965,
    Tye = 847,
    ["UET BuildConfig.json"] = 890,
    ["UI5 Manifest"] = 723,
    ["UNCORS configuration"] = 727,
    ["UTAM Page Object"] = 726,
    ["Ubuntu Server Autoinstall"] = 721,
    ["Uniswap Token List"] = 802,
    ["Unreal Engine Uplugin"] = 891,
    ["Unreal Engine Uproject"] = 892,
    ["Updatecli Compose"] = 855,
    ["Updatecli Policy Manifest"] = 856,
    ["Updatecli Policy Metadata"] = 857,
    Uplift = 888,
    ["User Journey Map"] = 822,
    V2Ray = 861,
    ["VSCode Code Snippets"] = 183,
    ["VSIX CLI publishing"] = 744,
    ["Vela Pipeline Configuration"] = 731,
    Vercel = 182,
    ["Version Bumper config"] = 734,
    Visivo = 918,
    Wake = 998,
    ["Waku Config"] = 978,
    ["Web App Manifest"] = 750,
    ["Web types"] = 753,
    WebExtensions = 749,
    ["Webman package recipe"] = 867,
    ["Windows Package Manager Installer Manifest"] = 799,
    ["Windows Package Manager Locale Manifest"] = 800,
    ["Windows Package Manager Singleton Manifest"] = 798,
    ["WireMock stub mapping"] = 981,
    ["Woodpecker pipeline config"] = 835,
    ["Wrangler CLI"] = 754,
    ["Xstate Machine"] = 853,
    ["Yandex Workflow Language"] = 971,
    ["Yarn Config (.yarnrc.yml)"] = 812,
    ["Yippee-Ki-JSON configuration YML"] = 804,
    ["YouTrack App"] = 968,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 922,
    ...
    ["behat.yml"] = 92,
    ["bigquery-table"] = 82,
    ["bioimageio resource description"] = 938,
    ...
    ["crowdin.yml"] = 216,
    ["ctfd-setup configuration file"] = 988,
    ["custom-elements.json"] = 910,
    ["cypress.json"] = 220,
    ...
    ["gematik health care insurance list"] = 994,
    ["gematik health care patient list"] = 991,
    ["gematik health care provider institution list"] = 993,
    ["gematik health care provider list"] = 992,
    ["gematik tiger test environment configuration"] = 995,
    ["gitlab-ci"] = 322,
    ["global.json"] = 337,
    ...
    ["lint-staged (.lintstagedrc)"] = 770,
    ["local.settings.json"] = 437,
    ["localazy.json"] = 438,
    ["lotus.yaml"] = 436,
    ["lsdlschema.json"] = 439,
    ["markdown-link-check"] = 831,
    mboats = 838,
    ["micro-settings.json"] = 902,
    ["mimetypes.json"] = 451,
    ["mirrord config"] = 771,
    mise = 772,
    ["mkdocs.yml"] = 471,
    ...
    ["plagiarize.yaml"] = 544,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 984,
    ["podbard.yaml"] = 547,
    ["portman.json"] = 548,
    ["prefect.toml"] = 556,
    ["prettierrc.json"] = 557,
    ...
    ["scalingo.json configuration"] = 630,
    ["schema.org - Action"] = 632,
    ["schema.org - ContactPoint"] = 633,
    ["schema.org - Place"] = 634,
    ["schema.org - Thing"] = 635,
    ["secrethub.yml"] = 905,
    ["semantic-release"] = 641,
    ["servicehub.config.json"] = 765,
    ["servicehub.service.json"] = 764,
    ["settings.job"] = 644,
    ["sfdx-hardis configuration"] = 646,
    ["shard.yml"] = 941,
    ["size-limit configuration"] = 651,
    ["skaffold.yaml"] = 829,
    ["skyuxconfig.json"] = 653,
    snapcraft = 654,
    ["spicepod.yaml"] = 960,
    ["sqlc configuration"] = 667,
    ["stripe-app-local.json"] = 676,
    ["stripe-app.json"] = 675,
    swcrc = 815,
    ["task.json"] = 683,
    taskcat = 781,
    ["template.json"] = 688,
    ["templatsources.json"] = 689,
    ["theme.json"] = 692,
    ["tizen_workspace.json"] = 693,
    tldr = 694,
    tmuxinator = 768,
    ["transcend.yml"] = 703,
    ...
    ["vega-lite.json"] = 730,
    ["vega.json"] = 729,
    ["venvironment-basic.yaml"] = 733,
    ["venvironment.yaml"] = 732,
    ["version.json"] = 735,
    ["vhwdebugger-binding.yaml"] = 737,
    ["vim-addon-info"] = 738,
    ["vs-2017.3.host.json"] = 740,
    ["vs-nesting.json"] = 741,
    ["vsls.json"] = 739,
    ["vss-extension.json"] = 745,
    ["vtesttree.yaml"] = 746,
    ["vtestunit.yaml"] = 747,
    ["warp-keysets.json"] = 911,
    ["warp-themes.json"] = 912,
    ["warp-workflows.json"] = 913,
    ["webhint.io"] = 868,
    ["webjobpublishsettings.json"] = 752,
    ["webjobs-list.json"] = 751,
    ["well-known-fursona"] = 948,
    ["xs-app.json"] = 777,
    ["xunit.runner.json"] = 763,
    yamllint = 803,
    ["zerops.io import file"] = 957,
    ["zerops.yml"] = 956,
    zuul = 787,
    ["Žinoma"] = 797
  },
