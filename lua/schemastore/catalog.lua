...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 93,
    [".cryproj (generic)"] = 384,
    [".cryproj engine-5.2"] = 379,
    [".cryproj engine-5.3"] = 380,
    [".cryproj engine-5.4"] = 381,
    [".cryproj engine-5.5"] = 382,
    [".cryproj engine-dev"] = 383,
    [".csscomb.json"] = 95,
    [".csslintrc"] = 96,
    [".eslintrc"] = 129,
    [".esmrc.json"] = 123,
    ...
    [".mtaext"] = 390,
    [".nodehawkrc"] = 232,
    [".npmpackagejsonlintrc"] = 234,
    [".phraseapp.yml"] = 261,
    [".pmbot.yml"] = 254,
    [".postcssrc"] = 259,
    [".pre-commit-config.yml"] = 260,
    [".putout.json"] = 278,
    [".rehyperc"] = 283,
    [".remarkrc"] = 284,
    [".sprite files"] = 318,
    ...
    [".vsext"] = 360,
    [".yarnrc.yml"] = 422,
    ["<div>RIOTS' studio configuration"] = 363,
    ["API Builder"] = 419,
    ...
    ["Azure Pipelines"] = 30,
    ["Azure Static Web Apps CLI configuration file"] = 320,
    ["Azure Static Web Apps configuration file"] = 319,
    ["Better Code Hub"] = 424,
    BizTalkServerApplicationSchema = 396,
    Briefcase = 401,
    Buildkite = 51,
    ...
    Goreleaser = 154,
    ["Goreleaser Pro"] = 155,
    ["Gradle Build Cache Node"] = 421,
    ["Gradle Enterprise"] = 420,
    ...
    ["JSON Feed"] = 189,
    ["JSON Resume"] = 286,
    ["JSON Schema Draft 2020-12"] = 375,
    ["JSON Schema Draft 4"] = 372,
    ["JSON Schema Draft 7"] = 373,
    ["JSON Schema Draft 8"] = 374,
    ...
    ["Meltano plugin discovery definition"] = 208,
    ["Meltano project definition"] = 207,
    ["Microsoft Band Web Tile"] = 209,
    ["Minecraft Data Pack Advancement"] = 211,
    ["Minecraft Data Pack Biome"] = 212,
    ["Minecraft Data Pack Configured Carver"] = 213,
    ["Minecraft Data Pack Dimension"] = 215,
    ["Minecraft Data Pack Dimension Type"] = 214,
    ["Minecraft Data Pack Item Modifier"] = 216,
    ["Minecraft Data Pack Loot Table"] = 217,
    ["Minecraft Data Pack Metadata"] = 218,
    ["Minecraft Data Pack Predicate"] = 219,
    ["Minecraft Data Pack Recipe"] = 220,
    ["Minecraft Data Pack Template Pool"] = 221,
    ["Minecraft Resourcepack Sounds"] = 222,
    ["Netin Diagnostic System Template"] = 443,
    ["Netlify config schema"] = 227,
    ["Nightwatch.js"] = 228,
    ["OSS Review Toolkit repository configuration"] = 248,
    Opctl = 392,
    ["OpenWeather Current Weather API"] = 428,
    ["OpenWeather Road Risk API"] = 427,
    ["Ory Hydra configuration"] = 172,
    ["Ory Keto configuration"] = 194,
    ["Ory Kratos configuration"] = 247,
    ["Ory Oathkeeper configuration"] = 239,
    ["Outblocks App configuration"] = 245,
    ["Outblocks database table"] = 246,
    ["Outblocks project configuration"] = 244,
    Packer = 251,
    ["Pipeline component"] = 437,
    ["PocketMine plugin.yml"] = 255,
    ["Pull Request Labeler"] = 277,
    ["RKE Cluster Configuration JSON Schema"] = 435,
    ["RKE Cluster Configuration YAML Schema"] = 434,
    Ray = 404,
    ["Read the Docs"] = 280,
    ["Red-DiscordBot Сog"] = 281,
    ["Red-DiscordBot Сog Repo"] = 282,
    Renovate = 287,
    RoadRunner = 288,
    SWADL = 328,
    ["Sapphire CLI Config"] = 289,
    ["SauceCTL Configuration"] = 440,
    ["Schema Catalog"] = 302,
    ["Scoop manifest"] = 307,
    ["Semgrep Rule"] = 308,
    ...
    ["Source Maps v3"] = 315,
    SpecIF = 316,
    ["Sponge Mixin configuration"] = 317,
    ["StackHawk Scanner Configuration"] = 446,
    ["StackHead CLI config"] = 321,
    ["StackHead module configuration"] = 322,
    ["StackHead project definition"] = 323,
    Stale = 324,
    ["Stryker Mutator"] = 325,
    ["StyleCop Analyzers Configuration"] = 326,
    ["Swagger API 2.0"] = 329,
    ["Taskfile YAML Schema"] = 430,
    Taurus = 330,
    ["TestEnvironment.json"] = 335,
    ["Traefik v2"] = 337,
    ["Traefik v2 File Provider"] = 338,
    ["UI5 Manifest"] = 349,
    ["Uniswap Token List"] = 413,
    ["User Journey Map YAML Schema"] = 433,
    ["VSCode Code Snippets"] = 72,
    ["VSIX CLI publishing"] = 361,
    ["Vela Pipeline Configuration"] = 353,
    ["Web App Manifest"] = 365,
    ["Web types"] = 368,
    WebExtensions = 364,
    ["Windows Package Manager Installer Manifest"] = 410,
    ["Windows Package Manager Locale Manifest"] = 411,
    ["Windows Package Manager Singleton Manifest"] = 409,
    ["Woodpecker pipeline config"] = 442,
    ["Yippee-Ki-JSON configuration YML"] = 415,
    ["angular.json"] = 6,
    ...
    ["localazy.json"] = 203,
    ["lsdlschema.json"] = 204,
    ["markdownlint.json"] = 439,
    mboats = 445,
    ["mimetypes.json"] = 210,
    ["mta.yaml"] = 388,
    ["mtad.yaml"] = 389,
    ["mycode.json"] = 225,
    ["napari plugin manifest"] = 226,
    neoload = 398,
    ["nest-cli"] = 230,
    ["ninjs (News in JSON)"] = 229,
    ["nlu.json"] = 231,
    ["nodemon.json"] = 233,
    ["noodl.schema.json"] = 444,
    now = 394,
    ["nswag.json"] = 237,
    ntangle = 238,
    ["nuclei-template.yaml"] = 235,
    ["nuget-project.json"] = 236,
    ["ocelot.json"] = 240,
    ["omnisharp.json"] = 241,
    ["openapi.json"] = 242,
    ["openfin.json"] = 243,
    ["package.json"] = 249,
    ["package.manifest"] = 250,
    ["pattern.json"] = 253,
    pgap_yaml_input_reader = 252,
    ["plagiarize-me.yaml"] = 257,
    ["plagiarize.yaml"] = 256,
    ["portman.json"] = 258,
    ["prettierrc.json"] = 262,
    ["prisma.yml"] = 263,
    ["project-1.0.0-beta3.json"] = 265,
    ["project-1.0.0-beta4.json"] = 266,
    ["project-1.0.0-beta5.json"] = 267,
    ["project-1.0.0-beta6.json"] = 268,
    ["project-1.0.0-beta8.json"] = 269,
    ["project-1.0.0-rc1.json"] = 270,
    ["project-1.0.0-rc2.json"] = 271,
    ["project.json"] = 264,
    ["prometheus.json"] = 272,
    ["prometheus.rules.json"] = 273,
    ["proxies.json"] = 274,
    ["publiccode.yml"] = 275,
    ["pubspec.yaml"] = 276,
    ["pyrseas-0.8.json"] = 279,
    ["release drafter"] = 399,
    ["sarif-1.0.0.json"] = 290,
    ["sarif-2.0.0.json"] = 291,
    ["sarif-2.1.0"] = 300,
    ["sarif-2.1.0-rtm.2"] = 292,
    ["sarif-2.1.0-rtm.3"] = 294,
    ["sarif-2.1.0-rtm.4"] = 296,
    ["sarif-2.1.0-rtm.5"] = 298,
    ["sarif-external-property-file-2.1.0"] = 301,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 293,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 295,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 297,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 299,
    ["schema.org - Action"] = 303,
    ["schema.org - ContactPoint"] = 304,
    ["schema.org - Place"] = 305,
    ["schema.org - Thing"] = 306,
    ["servicehub.config.json"] = 378,
    ["servicehub.service.json"] = 377,
    ["settings.job"] = 309,
    ["sfdx-hardis configuration"] = 310,
    ["size-limit configuration"] = 311,
    ["skaffold.yaml"] = 438,
    ["skyuxconfig.json"] = 312,
    snapcraft = 313,
    swcrc = 426,
    taskcat = 395,
    ["template.json"] = 331,
    ["templatsources.json"] = 332,
    ["theme.json"] = 333,
    tmLanguage = 334,
    ["trunk.yaml schema"] = 339,
    ["ts-force-config.json"] = 343,
    ["tsconfig.json"] = 340,
    ["tsd.json"] = 341,
    ["tsdrc.json"] = 342,
    ["tslint.json"] = 344,
    ...
    ["version.json"] = 354,
    ["vim-addon-info"] = 355,
    ["vs-2017.3.host.json"] = 357,
    ["vs-nesting.json"] = 358,
    ["vsls.json"] = 356,
    ["vss-extension.json"] = 362,
    ["webjobpublishsettings.json"] = 367,
    ["webjobs-list.json"] = 366,
    ["xs-app.json"] = 391,
    ["xunit.runner.json"] = 376,
    yamllint = 414,
    zuul = 400,
    ["Žinoma"] = 408
  },
