...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 941,
    [".nodehawkrc"] = 583,
    [".npmpackagejsonlintrc"] = 587,
    [".omletrc"] = 1120,
    [".phrase.yml"] = 661,
    [".phraseapp.yml"] = 662,
    [".pmbot.yml"] = 647,
    [".postcssrc"] = 656,
    [".powerpages-web-template-manifest"] = 658,
    [".pre-commit-config.yml"] = 659,
    [".pre-commit-hooks.yml"] = 660,
    [".putout.json"] = 695,
    [".rehyperc"] = 720,
    [".remarkrc"] = 724,
    [".sprite files"] = 816,
    ...
    AIConfig = 34,
    ["AMX Muse Program Descriptor"] = 1168,
    ["API Builder"] = 976,
    ["AVA Configuration"] = 1039,
    ["AWS AppConfig Feature Flags-v1"] = 68,
    ["AWS CDK cdk.json"] = 262,
    ["AWS CloudFormation"] = 263,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 264,
    ["AWS Copilot Manifest"] = 1207,
    ["AWS SAM CLI Samconfig"] = 265,
    ["Adobe UXP Manifest"] = 1102,
    ["Aerleon Network & Service Definitions"] = 20,
    ["Aerleon Policy"] = 21,
    ["AgentCore CLI"] = 1247,
    Aider = 1197,
    Air = 23,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1218,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1217,
    ["Airlock Microgateway"] = 35,
    ["Alacritty Configuration"] = 1011,
    ["All Contributors configuration file"] = 1065,
    ["Ansible Argument Specs"] = 401,
    ["Ansible Collection Galaxy"] = 408,
    ["Ansible Execution Environment"] = 398,
    ["Ansible Inventory"] = 407,
    ["Ansible Meta"] = 399,
    ["Ansible Meta Runtime"] = 400,
    ["Ansible Navigator Configuration"] = 410,
    ["Ansible Playbook"] = 405,
    ["Ansible Requirements"] = 402,
    ["Ansible Rulebook"] = 406,
    ["Ansible Tasks File"] = 404,
    ["Ansible Vars File"] = 403,
    ["Ansible-lint Configuration"] = 409,
    Any = 1130,
    ...
    ["Application list for a WinUtil"] = 1147,
    ArchitectFX = 1152,
    ["Argo CD"] = 54,
    ["Argo Events"] = 55,
    ["Argo Workflows"] = 56,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1216,
    ["Azure IoT Operations connector metadata"] = 1213,
    ...
    ["Azure Pipelines"] = 113,
    ["Azure Static Web Apps CLI configuration file"] = 820,
    ["Azure Static Web Apps configuration file"] = 819,
    BMML = 1235,
    ["BOSH CPI Config"] = 138,
    ["BOSH Deploy Config"] = 139,
    ["BX CI"] = 158,
    ["Bacon config"] = 5,
    ["Barba-CV"] = 83,
    ["Bashly (bashly.yml)"] = 1069,
    ["Bashly Settings (bashly-settings.yml)"] = 1070,
    Bento = 1234,
    ["Better Code Hub"] = 981,
    ["Better Scripts"] = 159,
    Bigconfig = 131,
    ["Biome Formatter Config"] = 84,
    ["Bitmovin Encoding Template"] = 1161,
    BizTalkServerApplicationSchema = 948,
    Bleep = 160,
    ["Block Protocol Metadata"] = 157,
    ["Bluebricks blueprint config"] = 1240,
    ["Boyka Framework"] = 140,
    Briefcase = 954,
    ["Build Info"] = 148,
    Buildkite = 150,
    ["Bukkit plugin.yml"] = 149,
    ["BungeeCord plugin.yml"] = 155,
    ["Butane Config"] = 1024,
    C4InterFlow = 1176,
    ["CDK Environment Manager, concrete environment configuration"] = 1200,
    ["CDK Environment Manager, concrete environments definition"] = 1199,
    ["CDK Environment Manager, environment definition"] = 1198,
    ["CGS Card Game Specification (cgs.json)"] = 1107,
    ["CICS TS region tagging"] = 1033,
    ["CICS TS resource import"] = 1034,
    ["CICS TS resource model"] = 1035,
    ["CICS TS resource overrides"] = 1036,
    ["CMake Presets"] = 161,
    ["CNC Codes"] = 183,
    ["CRS WAF test file"] = 1137,
    ["CRS WAF test platform overrides file"] = 1138,
    ["CSS Comb (.csscomb.json)"] = 290,
    ["CSS Lint (.csslintrc)"] = 291,
    ["CSpell (cspell.json)"] = 289,
    ["CVE Record Format"] = 193,
    CWL = 1113,
    ["Cache Warmup config"] = 162,
    ["Calqulus pipeline"] = 163,
    ["Camel YAML DSL"] = 164,
    ["Cannon TOML"] = 165,
    Carafe = 166,
    ["Cargo Make"] = 168,
    ["Cargo Manifest"] = 167,
    ["Catalog Info Backstage"] = 169,
    ["Chamaleon environment"] = 1165,
    ["Chamaleon properties"] = 1166,
    ["Chamaleon template"] = 1164,
    Changepacks = 1227,
    Changesets = 274,
    Changie = 170,
    Charmcraft = 171,
    Cheatsheets = 1021,
    ["ChordPro Configuration"] = 172,
    ["Chrome Extension"] = 255,
    ["Chromia Model"] = 173,
    ["Chromia Seeder Module Config"] = 175,
    ["Chromia Seeder Root Config"] = 174,
    ["Cinnamon Spice info.json"] = 93,
    ["CircleCI config.yml"] = 230,
    ["Citation File Format"] = 276,
    ["Citrus test case"] = 177,
    CityJSON = 178,
    ["Claude Code Keybindings"] = 190,
    ["Claude Code Settings"] = 191,
    ["Clawject config"] = 189,
    ["Cloud Foundry Application Manifest"] = 1119,
    ["Cloud Run Spec v1"] = 1142,
    ...
    ["CloudEvents specification"] = 179,
    ["Code Climate"] = 231,
    CodeCV = 97,
    CodeRabbit = 96,
    ["CodeShip Pro services configuration files"] = 244,
    ["CodeShip Pro steps configuration files"] = 245,
    ["Codecov configuration files"] = 243,
    Codex = 239,
    CodifyCLI = 98,
    Codux = 241,
    ["Cog config file"] = 184,
    ["Commandbox Box.json"] = 185,
    ["Commandbox Server.json"] = 186,
    ["Common Catalog Data"] = 253,
    ["Common Package Specification"] = 187,
    Concord = 1136,
    ["Configu .cfgu files"] = 1124,
    ["Configu .configu file"] = 1125,
    Conjure = 182,
    ["Container Structure Test"] = 962,
    Containerlab = 990,
    ["Contextive Glossary"] = 1192,
    Convex = 181,
    ["Crowdsec collection config"] = 284,
    ["Crowdsec parser config"] = 285,
    ["Crowdsec scenario config"] = 286,
    ["CumulusCI Config"] = 188,
    ["Cursor Agent Environment"] = 1245,
    ["Custom Machinery Machine"] = 1108,
    ["Custom Machinery Recipe"] = 1109,
    ["Cycle Stack File"] = 194,
    CycloneDX = 195,
    ["DWP Exchange - catalogue entry"] = 335,
    ["DWP Exchange - gateway"] = 333,
    ["DWP Exchange - meta"] = 334,
    ["Dart Build Config (dart-build.json)"] = 292,
    ["Dart Test Config (dart-test.json)"] = 293,
    ["DashLord Configuration"] = 294,
    ["Data Contract Specification"] = 295,
    ["Data Product Specification"] = 296,
    ["DataYoga Connections"] = 196,
    ["DataYoga Job"] = 197,
    ["Databricks Asset Bundles"] = 1086,
    ["Datadog Continuous Testing"] = 499,
    ["Datadog Service Definition"] = 500,
    ["Datadog Software Catalog"] = 501,
    ["Datahub Ingestion Recipe"] = 1040,
    ["Debian Upstream Metadata file"] = 204,
    ["Deck config"] = 205,
    ["DeepMatch deeplinks spec"] = 206,
    ["Dein Config"] = 207,
    ["Deno Config (deno.json)"] = 302,
    ["Dependency cruiser"] = 208,
    ["DeployStack Configuration"] = 209,
    ["Deployah Configuration"] = 1215,
    ["Deployer Recipe"] = 305,
    ["Deta Spacefile"] = 210,
    ["Detekt Config (detekt.yml)"] = 306,
    ["Devbox Config"] = 211,
    ["Devbox Plugin"] = 212,
    Devfile = 332,
    Devup = 1228,
    DipDup = 1139,
    ["Discord Webhook"] = 307,
    ["DocFx Config (docfx.json)"] = 312,
    ["Docker Desktop extension metadata"] = 309,
    ["Docs MCP Manifest"] = 313,
    Dofigen = 314,
    ["Dolittle Artifacts"] = 315,
    ["Dolittle Bounded Context Configuration"] = 316,
    ["Dolittle Event Horizons Configuration"] = 317,
    ["Dolittle Resources Configuration"] = 318,
    ["Dolittle Server Configuration"] = 319,
    ["Dolittle Tenant Map Configuration"] = 321,
    ["Dolittle Tenants Configuration"] = 320,
    ["Dolittle Topology"] = 322,
    ["DonateCaseBetterCasino menu"] = 1169,
    ["Drupal Breakpoints"] = 213,
    ["Drupal Config"] = 225,
    ["Drupal Info"] = 214,
    ["Drupal Layouts"] = 215,
    ["Drupal Libraries"] = 216,
    ["Drupal Links Action"] = 217,
    ["Drupal Links Contextual"] = 218,
    ["Drupal Links Menu"] = 219,
    ["Drupal Links Task"] = 220,
    ["Drupal Migration"] = 221,
    ["Drupal Permissions"] = 222,
    ["Drupal Recipe"] = 223,
    ["Drupal Routing"] = 224,
    ["Drupal Services"] = 226,
    ["Drush site aliases"] = 328,
    ["Dynamic Bash Aliases (.aliases)"] = 1077,
    ["EAS config"] = 353,
    ["ECA - Editor Code Assistant"] = 337,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1066,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1212,
    ["EasyVCR .NET"] = 354,
    ["Eidolon Resource"] = 1153,
    ["Elgato Stream Deck"] = 339,
    Elm = 1141,
    ["Embrace Config"] = 1052,
    Endurica = 1090,
    ["Enterprise Contract Policy Spec"] = 340,
    ["Erda Pipeline"] = 1115,
    ["Erda Runtime"] = 1116,
    ["Espanso config.yml"] = 1238,
    ["Espanso match.yml"] = 1237,
    Esquio = 342,
    ["Estuary Flow Catalog"] = 1030,
    ["Ethereum ERC1155"] = 1249,
    ["Ethereum ERC721"] = 1248,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 346,
    ["EveryVoice TTS Toolkit Data Configuration"] = 347,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 351,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 350,
    ["EveryVoice TTS Toolkit Text Configuration"] = 348,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 349,
    ["Evolving Resolutive Process notation"] = 1214,
    ["Expo SDK"] = 352,
    ["F-Droid Data metadata"] = 358,
    ["FasterCI Configuration"] = 114,
    FiQuS = 362,
    Firebase = 360,
    ["Flatpak Builder Manifest"] = 363,
    ["FlexGet Config"] = 364,
    ["Flow.json Configurations"] = 1112,
    ["Fossa configuration file"] = 371,
    ["Fossa's fossa-deps file"] = 372,
    ["Foundry VTT - Base package Manifest"] = 366,
    ["Foundry VTT - Module Manifest"] = 367,
    ["Foundry VTT - System Data Template"] = 370,
    ["Foundry VTT - System Manifest"] = 368,
    ["Foundry VTT - World Manifest"] = 369,
    ["Foxx Manifest"] = 115,
    ["Freifunk.de Community API"] = 118,
    ["Frogbot Config"] = 119,
    ["G2P Mapping Configuration"] = 378,
    ["GCP Blueprint Metadata"] = 381,
    Gaspar = 379,
    ["GatewayCore API Gateway"] = 380,
    ["Gemini CLI settings"] = 382,
    ["GeoJSON.json latest"] = 1028,
    GherKing = 1032,
    ["GitHub Action"] = 387,
    ["GitHub Actions typing"] = 1149,
    ["GitHub Discussion"] = 388,
    ["GitHub Funding"] = 389,
    ["GitHub Issue Template configuration"] = 390,
    ["GitHub Issue Template forms"] = 391,
    ["GitHub Workflow"] = 392,
    ["GitHub Workflow Template Properties"] = 393,
    ["GitHub automatically generated release notes configuration"] = 394,
    ["GitLab Agent for Kubernetes configuration"] = 1104,
    GitVersion = 384,
    ["Gitea Issue Template configuration"] = 385,
    ["Gitea Issue Template forms"] = 386,
    ["Gitpod Automations"] = 396,
    ["Gitpod Configuration"] = 397,
    ["GlazeWM settings"] = 1106,
    ["Global Privacy Control"] = 383,
    Goblet = 1085,
    ["Golangci-lint Configuration"] = 412,
    ["Golangci-lint Custom Plugins Configuration"] = 413,
    ["Google Chrome Related Website Sets"] = 361,
    ["Google Cloud Workflows"] = 261,
    ["Google Digital Assetlinks"] = 1193,
    Goreleaser = 415,
    ["Goreleaser Pro"] = 416,
    Goss = 417,
    ["Gradle Build Cache Node"] = 979,
    ["Gradle Enterprise"] = 978,
    ["Grafana 5.x Dashboard"] = 418,
    ["GraphQL Code Generator"] = 423,
    ["GraphQL Config"] = 422,
    ["GraphQL Mesh"] = 421,
    ["GroovyLint configuration"] = 424,
    ["Grunt JSHint task"] = 428,
    ["Grunt Watch task"] = 429,
    ["Grunt base task"] = 430,
    ["Grunt clean task"] = 426,
    ["Grunt copy task"] = 425,
    ["Grunt cssmin task"] = 427,
    HEMTT = 944,
    Hadolint = 958,
    Hammerkit = 989,
    ["Hardware Sentry Configuration"] = 1044,
    ["Hashgraph Online Skill Manifest"] = 1,
    ["HashiCorp Vault"] = 431,
    Hatch = 959,
    Hayson = 433,
    ["Haystack Pipeline"] = 434,
    ["Hazelcast 5 Configuration"] = 435,
    ["Hecate Input Schema"] = 1204,
    ["Helm Chart.lock"] = 228,
    ["Helm Chart.yaml"] = 227,
    ["Helm Unittest Test Suite"] = 229,
    ["Home Assistant Integration Manifest"] = 436,
    ["Homer dashboard configuration"] = 437,
    Hugo = 1020,
    ["Hugo Theme"] = 1019,
    ["Hulak Configuration"] = 444,
    ["Hyperfoil benchmark configuration"] = 443,
    ["IBM Zapp document"] = 445,
    ["IBM zCodeFormatSettings"] = 446,
    ["IMG Catapult PSP"] = 451,
    ["IVMS101 by CODE Protocol"] = 1105,
    Infrahub = 453,
    Istanbul = 1048,
    ["JDownloader2 crawler multi-rules"] = 466,
    ["JDownloader2 crawler single-rules"] = 465,
    ["JFrog Applications Config"] = 467,
    ["JFrog File Spec"] = 468,
    ["JFrog Pipelines YML DSL"] = 1054,
    ["JMeter DSL cli config"] = 469,
    JReleaser = 472,
    ["JSON Document Transform"] = 480,
    ["JSON Feed"] = 481,
    ["JSON Resume"] = 730,
    ["JSON Schema Draft 2020-12"] = 926,
    ["JSON Schema Draft 4"] = 923,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1087,
    ["JSON Schema Draft 7"] = 924,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1088,
    ["JSON Schema Draft 8 (2019-09)"] = 925,
    ["JSON-API"] = 479,
    ["JSON-e templates"] = 986,
    ["JSON-stat 2.0"] = 919,
    JSONPatch = 483,
    ["JSR Package Config (jsr.json)"] = 473,
    Jarl = 1220,
    Jasmine = 460,
    Jekyll = 461,
    ["Jenkins X Pipelines"] = 462,
    ["Jenkins X Requirements"] = 463,
    Jest = 464,
    Jocker = 470,
    ["Jovo Language Models"] = 471,
    ["Jujutsu (jj) VCS config"] = 1206,
    ["KIMMDY config file"] = 494,
    ["KODE/CI build.yaml"] = 1050,
    ["KSP-AVC"] = 920,
    ["KSP-CKAN"] = 921,
    ["KSP-NetKAN"] = 922,
    KSY = 1117,
    KSail = 376,
    ["KYA Manifest"] = 1118,
    ["Karakum configuration file"] = 373,
    Kas = 486,
    ["Kestra flow file"] = 495,
    ["Keycloak REST API"] = 1057,
    ["Knative Functions - func.yaml"] = 374,
    Knip = 375,
    ["Kometa (nightly) config file"] = 497,
    ["Kometa config file"] = 496,
    ["Kong DBLess config"] = 1051,
    KrakenD = 498,
    ["Kubri Configuration"] = 505,
    LOOBin = 520,
    ["Lake configuration file"] = 1209,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 266,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 267,
    ["Landing Zone Accelerator on AWS - Global Config"] = 268,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 269,
    ["Landing Zone Accelerator on AWS - Network Config"] = 270,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 271,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 272,
    ["Landing Zone Accelerator on AWS - Security Config"] = 273,
    ["Lando (landofile)"] = 109,
    ["LangGraph Platform configuration"] = 1129,
    ["Language configuration"] = 1128,
    Lefthook = 509,
    ["Liferay client-extension.yaml"] = 516,
    ["LinkML Metamodel"] = 518,
    Liquibase = 995,
    ["Liquibase Flow File"] = 996,
    ["Lively Properties"] = 519,
    ["Lobe AI Agent"] = 111,
    Loki = 112,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 562,
    ["MS2Rescore Configuration"] = 566,
    ["Madness (madness.yml)"] = 1068,
    ["Mado configuration"] = 526,
    ["Maestro Flow"] = 527,
    ["Mail Servers Configuration"] = 1241,
    ["MapEHR Mapping"] = 528,
    Markdownlint = 999,
    ["Mason Registry"] = 1002,
    ["MegaLinter Custom Flavor"] = 531,
    ["MegaLinter configuration"] = 530,
    ["MegaLinter descriptor"] = 532,
    Melange = 1095,
    ["Meltano project definition"] = 533,
    ["Mergify Configuration"] = 567,
    ["Metadata for a Bazel module"] = 534,
    ["Metadata for a Cinnamon spice"] = 1145,
    ["Metatype Configuration"] = 535,
    ["MetricsHub Configuration"] = 536,
    ["MetricsHub Connector Configuration"] = 537,
    ["Micro Editor Syntax"] = 1078,
    ["Microsoft Band Web Tile"] = 538,
    ["Microsoft RulesEngine workflow rules"] = 1133,
    ["Microsoft RulesEngine workflow rules list"] = 1134,
    ["Minecraft Custom Main Menu Mod"] = 1096,
    ["Minecraft Data Pack Advancement"] = 540,
    ["Minecraft Data Pack Biome"] = 541,
    ["Minecraft Data Pack Configured Carver"] = 542,
    ["Minecraft Data Pack Damage Type"] = 543,
    ["Minecraft Data Pack Dimension"] = 545,
    ["Minecraft Data Pack Dimension Type"] = 544,
    ["Minecraft Data Pack Item Modifier"] = 546,
    ["Minecraft Data Pack Loot Table"] = 547,
    ["Minecraft Data Pack Metadata"] = 548,
    ["Minecraft Data Pack Predicate"] = 549,
    ["Minecraft Data Pack Recipe"] = 550,
    ["Minecraft Data Pack Tag"] = 551,
    ["Minecraft Data Pack Template Pool"] = 552,
    ["Minecraft Data Pack Trim Material"] = 557,
    ["Minecraft Data Pack Trim Pattern"] = 558,
    ["Minecraft Resource Pack Lang"] = 553,
    ["Minecraft Resource Pack Particle"] = 554,
    ["Minecraft Resource Pack Texture Mcmeta"] = 556,
    ["Minecraft Resourcepack Sounds"] = 555,
    ModuleAssembler = 560,
    ["Monade CLI Stack Configuration"] = 570,
    ["MongoDB Atlas Search Index Definition"] = 1049,
    ["Monika Configuration"] = 1047,
    ["Monoweave Configuration"] = 565,
    ["Motif config"] = 940,
    MultiQC = 1186,
    ["NOX Framework (Service)"] = 586,
    ["Netin Diagnostic System Template"] = 1006,
    ["Netlify config"] = 573,
    ["Network-as-Code Data Model"] = 574,
    ["Next Gen UI Agent A2A Server Configuration"] = 575,
    ["Next Gen UI Agent Configuration"] = 577,
    ["Next Gen UI Agent MCP Server Configuration"] = 576,
    ["Nightwatch.js"] = 579,
    ["Node.js configuration"] = 945,
    ["NueJS configuration file"] = 591,
    ["Nuitka.yaml"] = 1110,
    ["Nullstone config"] = 593,
    ["ONe's changelog entry"] = 612,
    ["ONe's service descriptor"] = 611,
    ["ORT Server repository environment configuration"] = 622,
    ["OSCAL Assessment Plan (AP)"] = 624,
    ["OSCAL Assessment Results (AR)"] = 625,
    ["OSCAL Catalog"] = 626,
    ["OSCAL Component Definition (CDef)"] = 627,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 628,
    ["OSCAL Profile"] = 629,
    ["OSCAL System Security Plan (SSP)"] = 630,
    ["OSS Review Toolkit configuration"] = 631,
    ["OSS Review Toolkit curation"] = 632,
    ["OSS Review Toolkit package configuration"] = 633,
    ["OSS Review Toolkit repository configuration"] = 634,
    ["OSS Review Toolkit resolutions"] = 635,
    ["October CMS columns"] = 597,
    ["October CMS fields"] = 598,
    ["Oh My Posh"] = 600,
    Okteto = 601,
    ["Ona Automations"] = 603,
    Opctl = 943,
    ["Open Data Contract Standard (ODCS)"] = 616,
    ["Open Data Product Standard (ODPS)"] = 617,
    ["Open Know-How"] = 1191,
    ["OpenRewrite Resource"] = 614,
    OpenSRM = 618,
    OpenStatus = 1202,
    ["OpenTelemetry Declarative Configuration"] = 615,
    ["OpenUtau character yaml"] = 608,
    ["OpenUtau ustx"] = 609,
    ["OpenWeather Current Weather API"] = 985,
    ["OpenWeather Road Risk API"] = 984,
    ["Ory Hydra configuration"] = 442,
    ["Ory Keto configuration"] = 502,
    ["Ory Kratos configuration"] = 623,
    ["Ory Oathkeeper configuration"] = 595,
    ["Outblocks App configuration"] = 620,
    ["Outblocks database table"] = 621,
    ["Outblocks project configuration"] = 619,
    PDM = 642,
    POPxf = 653,
    ["POPxf Correlations"] = 654,
    Packer = 639,
    PactSpec = 640,
    Pantsbuild = 1064,
    ["Paper paper-plugin.yml"] = 641,
    ["Pipeline component"] = 997,
    ["Platform.sh application"] = 7,
    ["Platform.sh routes"] = 8,
    ["Platform.sh services"] = 9,
    ["Plex Prerolls"] = 651,
    ["PocketMine plugin.yml"] = 648,
    ["Postman collection"] = 657,
    ["Power Pages Configuration"] = 1203,
    ["Preset list for a WinUtil"] = 1148,
    ["ProActions AI-Kit Configuration"] = 668,
    ["ProActions AI-Kit Configuration for Menus"] = 670,
    ["ProActions AI-Kit Configuration for Sections"] = 672,
    ["ProActions AI-Kit Configuration for Services"] = 669,
    ["ProActions AI-Kit Configuration for Steps"] = 673,
    ["ProActions AI-Kit Configuration for Templates"] = 671,
    ["Problem object RFC9457"] = 1093,
    ["Problem package format"] = 674,
    ["Problem package generators"] = 675,
    ["Problem package submissions"] = 676,
    ["Problem package test group metadata"] = 677,
    Pterodactyl = 1043,
    ["Pull Request Labeler"] = 694,
    Pulumi = 702,
    ["PyGTA Config"] = 698,
    PyProject = 703,
    Pylock = 1194,
    Pyright = 704,
    ["Python script metadata"] = 1188,
    ["QType AI DSL"] = 707,
    Qgoda = 706,
    Qodana = 1016,
    ["Qt Creator workspace file"] = 1126,
    ["Quali Torque Blueprint Spec 2"] = 1041,
    ["QueryFirst config file"] = 1060,
    ["Qwen Code Settings"] = 1250,
    ...
    Ray = 957,
    ["Read the Docs"] = 701,
    ["Red-DiscordBot Cog"] = 717,
    ["Red-DiscordBot Cog Repo"] = 718,
    ["Red-DiscordBot Trivia"] = 719,
    ["Releasaurus Config"] = 4,
    ReleaseKit = 3,
    ["Render Blueprints"] = 992,
    RenderCV = 734,
    Renovate = 731,
    ["Renovate global configuration"] = 732,
    ["Renovate inherited configuration"] = 733,
    ["Replit config"] = 725,
    Restate = 1181,
    ["Revel Digital Gadget Definition File"] = 1205,
    RoadRunner = 736,
    ["Robust Station Image"] = 1211,
    Rockcraft = 737,
    ["Roo Coder Custom Modes"] = 738,
    Rubocop = 727,
    ["Rudder techniques"] = 1100,
    Ruff = 728,
    ["Rust Project"] = 729,
    ["Rust toolchain"] = 742,
    ["SDMX data message"] = 769,
    ["SDMX metadata message"] = 768,
    ["SDMX structure message"] = 767,
    ["SIL Kit Participant Configuration"] = 779,
    ["SIL Kit Registry Configuration"] = 780,
    ["SPDX 2.3"] = 817,
    SWADL = 833,
    ["Safebox Config"] = 1055,
    ["Sapphire CLI Config"] = 745,
    ["SauceCTL Configuration"] = 1003,
    Scarb = 765,
    ["Schema Catalog"] = 760,
    ["Scoop manifest"] = 766,
    ["Semantic Data Fabric (SDF) file"] = 770,
    ["Semgrep Rule"] = 772,
    ["Serenity Code Generator (Sergen)"] = 773,
    ["Serverless Framework Configuration"] = 1010,
    ["Serverless Workflow"] = 1012,
    ["Settings for a Cinnamon spice"] = 1144,
    ["Settings.paf"] = 775,
    ["Shopware 6 Configuration"] = 1013,
    ["Shopware CLI Extension Store Configuration"] = 1014,
    ["Shopware CLI Project Store Configuration"] = 1015,
    ["Sigma Detection Rule"] = 777,
    ["Sigrid scope configuration file"] = 778,
    ["SkyPilot Task JSON"] = 1101,
    ["Slack app manifest"] = 782,
    Snapcraft = 784,
    Solidarity = 787,
    ["Solution filters"] = 788,
    ["Source Maps v3"] = 789,
    Sourcery = 790,
    ["Spack bootstrap.yaml"] = 791,
    ["Spack cdash.yaml"] = 792,
    ["Spack ci.yaml"] = 793,
    ["Spack compilers.yaml"] = 794,
    ["Spack concretizer.yaml"] = 795,
    ["Spack config.yaml"] = 796,
    ["Spack definitions.yaml"] = 797,
    ["Spack develop.yaml"] = 798,
    ["Spack env_vars.yaml"] = 799,
    ["Spack environment"] = 805,
    ["Spack include.yaml"] = 800,
    ["Spack mirrors.yaml"] = 801,
    ["Spack modules.yaml"] = 802,
    ["Spack packages.yaml"] = 803,
    ["Spack repos.yaml"] = 804,
    ["Spack toolchains.yaml"] = 806,
    ["Spack upstreams.yaml"] = 807,
    ["Spack view.yaml"] = 808,
    ["Speakeasy Generation Config File"] = 812,
    ["Speakeasy Lint Configuration File"] = 809,
    ["Speakeasy Test Generation Configuration File"] = 810,
    ["Speakeasy Workflow File"] = 811,
    SpecIF = 813,
    ["Specmatic Configuration"] = 814,
    ["Sponge Mixin configuration"] = 815,
    StackBlitz = 821,
    ["StackHawk Scanner Configuration"] = 1009,
    Stale = 822,
    Starfish = 823,
    ["Starlake Data Pipeline"] = 982,
    Starship = 824,
    ["Statamic Blueprint"] = 825,
    ["Stella configuration file"] = 826,
    ["Streamlit configuration file"] = 827,
    ["Stryker Mutator"] = 830,
    ["StyleCop Analyzers Configuration"] = 831,
    ["Stylelint (.stylelintrc)"] = 832,
    ["Stylua Config"] = 1195,
    ["Sublime Syntax"] = 1056,
    ["Subsquid squid manifest"] = 1103,
    ["Swagger API 2.0"] = 834,
    ["Synadia Connect Component"] = 835,
    TSON = 871,
    TSTyche = 872,
    ["TYPO3 Vendor Bundler config"] = 878,
    ["Tab data for a LinUtil"] = 1151,
    ["Tab list for a LinUtil"] = 1150,
    Tach = 836,
    ["Tach Domain"] = 837,
    Talhelper = 839,
    ["Talisman configuration"] = 840,
    Taplo = 1196,
    ["Taskfile config"] = 987,
    Taurus = 841,
    Tauticord = 842,
    ["Tekton Pipeline"] = 1224,
    ["Tekton PipelineRun"] = 1225,
    ["Tekton Task"] = 1222,
    ["Tekton TaskRun"] = 1223,
    Telefonistka = 1182,
    ["Terrateam config"] = 1208,
    ["TestEnvironment.json"] = 854,
    ["TextMate Grammar"] = 853,
    Threagile = 848,
    ["Tier.run pricing.json"] = 845,
    Tikibase = 846,
    Tombi = 851,
    ["Traefik v2"] = 857,
    ["Traefik v2 File Provider"] = 858,
    ["Traefik v3"] = 859,
    ["Traefik v3 File Provider"] = 860,
    ["Travis CI (.travis.yml)"] = 856,
    Treefmt = 420,
    Trident = 1178,
    ["TrueScript for *.tscript files"] = 863,
    ["Tugboat QA config.yml"] = 1175,
    TunnelHub = 1091,
    Turborepo = 855,
    Tycho = 1140,
    Tye = 1017,
    ["Tyk Gateway - Open Source v5.7+"] = 1187,
    ["UET BuildConfig.json"] = 1061,
    ["UI5 Manifest"] = 884,
    ["UNCORS configuration"] = 888,
    ["UTAM Page Object"] = 887,
    ["Ubuntu Server Autoinstall"] = 882,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1179,
    ["Uniswap Token List"] = 969,
    ["Universal Schedule Format"] = 889,
    ["Unreal Engine Uplugin"] = 1062,
    ["Unreal Engine Uproject"] = 1063,
    ["UpCloud CLI (upctl) configuration"] = 1180,
    ["Updatecli Compose"] = 1025,
    ["Updatecli Policy Manifest"] = 1026,
    ["Updatecli Policy Metadata"] = 1027,
    Uplift = 1059,
    ["Upsun config"] = 6,
    ["User Journey Map"] = 991,
    V2Ray = 1031,
    ["VSCode Code Snippets"] = 249,
    ["VSIX CLI publishing"] = 907,
    Vector = 891,
    ["Vela Pipeline Configuration"] = 894,
    Vercel = 248,
    ["Version Bumper config"] = 897,
    Vespertide = 1229,
    ["Vespertide Migration"] = 1230,
    ["Vespertide Model"] = 1231,
    ["Viash Component Config"] = 1184,
    ["Viash Package Config"] = 1185,
    Visivo = 1089,
    ["WP-CLI"] = 917,
    Wake = 1177,
    ["Waku Config"] = 1154,
    ["Web App Manifest"] = 913,
    ["Web types"] = 916,
    WebExtensions = 912,
    ["Webman package recipe"] = 1037,
    ["Windows Package Manager Installer Manifest"] = 965,
    ["Windows Package Manager Locale Manifest"] = 966,
    ["Windows Package Manager Singleton Manifest"] = 964,
    Winutil = 967,
    ["WireMock CLI import configuration"] = 1160,
    ["WireMock CLI local service configuration"] = 1159,
    ["WireMock message stub mapping"] = 1158,
    ["WireMock stub mapping"] = 1157,
    ["Woodpecker pipeline config"] = 1005,
    ["Wrangler CLI"] = 918,
    ["Xstate Machine"] = 1023,
    ["Yandex Workflow Language"] = 1146,
    ["Yarn Config (.yarnrc.yml)"] = 980,
    ["Yippee-Ki-JSON configuration YML"] = 971,
    ["YouTrack App"] = 1143,
    ["Zarf Package Configuration"] = 1210,
    ["Zerops.io config"] = 1131,
    ["Zerops.io import"] = 1132,
    ["Zola Configuration"] = 1221,
    ["aerleon.yml"] = 19,
    ["amplify.yml"] = 12,
    ["angular.json"] = 36,
    apko = 1094,
    ...
    ["bamboo-spec"] = 125,
    basedpyright = 123,
    ["bashly-strings.yml"] = 1071,
    ["batect.yml"] = 124,
    ["beef-database-codegen"] = 126,
    ["beef-database-v5-codegen"] = 128,
    ["beef-entity-codegen"] = 127,
    ["beef-entity-v5-codegen"] = 129,
    ["behat.yml"] = 141,
    ["bigquery-table"] = 130,
    ["bioimageio resource description"] = 1111,
    ["bitbucket-pipelines"] = 132,
    bitrise = 133,
    ["bitrise-step"] = 134,
    ["block.json"] = 156,
    ...
    ["bozr.suite.json"] = 143,
    bpkg = 1072,
    ["browser.i18n.json"] = 144,
    ["browsh configuration"] = 145,
    bucklescript = 146,
    ["buf.gen.yaml"] = 87,
    ["buf.lock"] = 88,
    ["buf.plugin.yaml"] = 89,
    ...
    ["build-changelog"] = 147,
    ["bun.lock"] = 152,
    ["bundleconfig.json"] = 153,
    ["bunfig.toml"] = 154,
    ["cargo-mutants-config.yaml"] = 92,
    ["ccmod.json"] = 1155,
    changelogging = 1123,
    ["chisel-slices.json"] = 275,
    ["chrome-extension-locales-messages.json"] = 256,
    ["chutzpah.json"] = 257,
    cibuildwheel = 176,
    ["clang-format (.clang-format)"] = 1029,
    ["clang-tidy"] = 235,
    clangd = 234,
    clib = 236,
    ["cloud-init: cloud-config userdata"] = 238,
    ["cloud-sdk-pipeline-configuration"] = 259,
    ["cloudbuild.json"] = 260,
    cloudify = 237,
    cmakefmt = 192,
    ["cmdx.yaml"] = 95,
    ...
    ["coffeelint.json"] = 277,
    ["commands.json"] = 252,
    ["commitlint (.commitlintrc)"] = 968,
    ["committed.toml"] = 278,
    ["compile_commands.json"] = 251,
    ["compilerconfig.json"] = 250,
    ["completely.yml"] = 1067,
    ["component-detection-manifest.json"] = 281,
    ["component.json"] = 280,
    ["composer.json"] = 279,
    ["conda-forge"] = 180,
    ["config.yaml"] = 700,
    ["contentmanifest.json"] = 258,
    ["contribute.json"] = 282,
    ["cosmos.config.json"] = 254,
    ["crowdin.yml"] = 283,
    ["ctfd-setup configuration file"] = 1167,
    ["custom-elements.json"] = 1081,
    ["cypress.json"] = 287,
    ["datalogic-scan2deploy-android"] = 297,
    ["datalogic-scan2deploy-ce"] = 298,
    ["dbt Dependencies"] = 199,
    ["dbt Packages"] = 201,
    ["dbt Project"] = 200,
    ["dbt Selectors"] = 202,
    ["dbt YAML files"] = 203,
    ...
    ["ddev-global"] = 299,
    ["ddev-project"] = 300,
    ["debugsettings.json"] = 301,
    ["dependabot-v2.json"] = 304,
    ["dependabot.json"] = 303,
    ["deployed-cli"] = 1022,
    ["devcontainer.json"] = 242,
    devinit = 973,
    ["devspace.yaml"] = 1045,
    djlint = 974,
    ["docker bake"] = 310,
    ["docker sequencer"] = 311,
    ["docker-compose.yml"] = 972,
    ["dockerd.json"] = 308,
    ["dotnet Release Index manifest"] = 323,
    ["dotnet-tools.json"] = 324,
    ["dotnetcli.host.json"] = 325,
    ["dprint.json"] = 326,
    ["drone.json"] = 327,
    ["dss-2.0.0.json"] = 329,
    ["dstack configuration"] = 330,
    ["dtool dataset metadata"] = 1162,
    ["dvc.yaml"] = 331,
    ["ecosystem.json"] = 336,
    eksctl = 338,
    ["electron-builder configuration file"] = 344,
    ["epr-manifest.json"] = 343,
    ["evcc.yaml"] = 345,
    ["ezd task runner"] = 355,
    ["fabric.mod.json"] = 357,
    ["first-timers-bot"] = 365,
    ["flagd flag configuration"] = 116,
    ["fly.io Configuration"] = 117,
    fulibWorkflows = 1004,
    ["function.json"] = 377,
    ["gRPC API Gateway & OpenAPI Config"] = 14,
    ["gematik health care insurance list"] = 1173,
    ["gematik health care patient list"] = 1170,
    ["gematik health care provider institution list"] = 1172,
    ["gematik health care provider list"] = 1171,
    ["gematik tiger test environment configuration"] = 1174,
    ["git-town.toml"] = 1219,
    ["gitlab-ci"] = 395,
    ["global.json"] = 411,
    ["go-feature-flag Flag Configuration"] = 414,
    ["haxelib.json"] = 432,
    helmfile = 960,
    helmwave = 961,
    ["host-meta.json"] = 439,
    ...
    ["ide.host.json"] = 447,
    ["ifstate.yaml"] = 448,
    ["imageoptimizer.json"] = 449,
    ["importmap.json"] = 452,
    instant_python_config = 454,
    instant_python_custom_project = 455,
    ["ioBroker Configuration"] = 456,
    ["ioBroker JSON UI"] = 457,
    ["ioBroker Package manifest"] = 458,
    ["ixpect.conf.yaml"] = 459,
    ["ize.toml"] = 1058,
    ["jsconfig.json"] = 484,
    ["jscpd Configuration"] = 1042,
    jsdoc = 956,
    ["k3d.yaml"] = 485,
    ["k9s aliases.yaml"] = 487,
    ["k9s cluster-config.yaml"] = 489,
    ["k9s config.yaml"] = 488,
    ["k9s hotkeys.yaml"] = 490,
    ["k9s plugins.yaml"] = 491,
    ["k9s skin.yaml"] = 492,
    ["k9s views.yaml"] = 493,
    ["kontinuous-config.yaml"] = 504,
    ["kontinuous-values.yaml"] = 503,
    ["kustomization.yaml"] = 506,
    ["label-commenter-config.yml"] = 507,
    ["latexindent configuration"] = 110,
    ["launchsettings.json"] = 508,
    lazydocker = 1080,
    lazygit = 1079,
    ["lego.json"] = 510,
    ["lerna.json"] = 511,
    ["lgtm.yml"] = 512,
    ["liblab.config.json"] = 513,
    ["libman.json"] = 514,
    ["license-report-config.json"] = 515,
    ["linkinator.config.json"] = 517,
    ["lint-staged (.lintstagedrc)"] = 934,
    ["local.settings.json"] = 522,
    ["localazy.json"] = 523,
    ["lotus.yaml"] = 521,
    ["lsdlschema.json"] = 524,
    ["macro.json"] = 1046,
    ["markdown-link-check"] = 1000,
    maturin = 1001,
    mboats = 1008,
    ["micro-settings.json"] = 1073,
    ["mimetypes.json"] = 539,
    ["mirrord config"] = 936,
    mise = 937,
    ["mkdocs.yml"] = 559,
    ...
    ["monospace.yml"] = 564,
    ["moon.yml"] = 1156,
    ["mprocs Configuration file"] = 1127,
    ["mrdocs.yml"] = 561,
    ["mta.yaml"] = 938,
    ["mtad.yaml"] = 939,
    ["mycode.json"] = 571,
    nFPM = 578,
    ["napari plugin manifest"] = 572,
    neoload = 951,
    ["nest-cli"] = 581,
    ["nexus-rpc-gen"] = 1246,
    ["ninjs (News in JSON)"] = 580,
    ["nitro.json"] = 950,
    ["nixd configuration"] = 1099,
    ["nlu.json"] = 582,
    ["nodemon.json"] = 584,
    ["noodl config"] = 1007,
    ["notebook.mod.json"] = 585,
    now = 946,
    ["npm-badges"] = 588,
    ["nswag.json"] = 592,
    ntangle = 594,
    ["nuclei-template.yaml"] = 589,
    ["nuget-project.json"] = 590,
    ["ocelot.json"] = 596,
    ogen = 599,
    ["omnisharp.json"] = 602,
    openHAB = 1232,
    ...
    oxlint = 1243,
    ["package.json"] = 636,
    ["package.manifest"] = 638,
    ["package.yaml"] = 637,
    ["partial-black.json"] = 142,
    ["partial-pixi.json"] = 646,
    ["pattern.json"] = 644,
    ["petstore-v1.0"] = 1053,
    pgap_yaml_input_reader = 643,
    pgxgen = 1236,
    pitcms = 1239,
    ["pixi.toml"] = 645,
    ["plagiarize-me.yaml"] = 650,
    ["plagiarize.yaml"] = 649,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1163,
    ["podbard.yaml"] = 652,
    ["portman.json"] = 655,
    ["prefect.toml"] = 663,
    ["prefect.yaml"] = 664,
    ...
    ["prettierrc.json"] = 666,
    ["prisma.yml"] = 667,
    ["project-1.0.0-beta3.json"] = 679,
    ["project-1.0.0-beta4.json"] = 680,
    ["project-1.0.0-beta5.json"] = 681,
    ["project-1.0.0-beta6.json"] = 682,
    ["project-1.0.0-beta8.json"] = 683,
    ["project-1.0.0-rc1.json"] = 684,
    ["project-1.0.0-rc2.json"] = 685,
    ["project.json"] = 678,
    ["project.owasp.yaml"] = 686,
    ["prometheus-alertmanager.json"] = 690,
    ["prometheus.json"] = 687,
    ["prometheus.rules.json"] = 688,
    ["prometheus.rules.test.json"] = 689,
    ["proxies.json"] = 691,
    ["publiccode.yml"] = 692,
    ["pubspec.yaml"] = 693,
    ["pyrseas-0.8.json"] = 696,
    pytest = 705,
    ["quilt.mod.json"] = 1074,
    ["rc3 auth"] = 711,
    ["rc3 collection"] = 712,
    ...
    ["release drafter"] = 952,
    ["release-hub.json"] = 2,
    ["release-please-config.json"] = 721,
    ["release-please-manifest.json"] = 722,
    ["release-plz.toml"] = 723,
    ["renv.lock"] = 735,
    ["rivet.json"] = 1098,
    ["rivet.yaml (legacy)"] = 1097,
    rumdl = 740,
    runny = 739,
    rustfmt = 741,
    sake = 1190,
    samt = 743,
    samtrc = 744,
    ["sarif-1.0.0.json"] = 746,
    ["sarif-2.0.0.json"] = 747,
    ["sarif-2.1.0"] = 757,
    ["sarif-2.1.0-rtm.2"] = 748,
    ["sarif-2.1.0-rtm.3"] = 750,
    ["sarif-2.1.0-rtm.4"] = 752,
    ["sarif-2.1.0-rtm.5"] = 754,
    ["sarif-2.1.0-rtm.6"] = 755,
    ["sarif-external-property-file-2.1.0"] = 758,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 749,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 751,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 753,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 756,
    ["scalingo.json configuration"] = 759,
    ["schema.org - Action"] = 761,
    ["schema.org - ContactPoint"] = 762,
    ["schema.org - Place"] = 763,
    ["schema.org - Thing"] = 764,
    ["secrethub.yml"] = 1076,
    ["semantic-release"] = 771,
    ["servicehub.config.json"] = 929,
    ["servicehub.service.json"] = 928,
    ["settings.job"] = 774,
    ["sfdx-hardis configuration"] = 776,
    ["shard.yml"] = 1114,
    ["size-limit configuration"] = 781,
    ["skaffold.yaml"] = 998,
    ["skyuxconfig.json"] = 783,
    ["snowflake-config"] = 785,
    ["snowflake-connections"] = 786,
    ["spicepod.yaml"] = 1135,
    ["sqlc configuration"] = 818,
    ["stripe-app-local.json"] = 829,
    ["stripe-app.json"] = 828,
    swcrc = 983,
    ["task.json"] = 838,
    taskcat = 947,
    ["template.json"] = 843,
    ["templatsources.json"] = 844,
    ["text2confl config"] = 1244,
    ["theme.json"] = 847,
    ["tizen_workspace.json"] = 849,
    tldr = 850,
    ["tm_devices configuration file"] = 1201,
    tmuxinator = 932,
    tox = 852,
    ["transcend.yml"] = 861,
    ["tree-sitter grammar.json"] = 419,
    ["trime.yaml"] = 862,
    ["trunk.yaml"] = 864,
    ["ts-force-config.json"] = 869,
    ["tsconfig.json"] = 865,
    ["tsd.json"] = 866,
    ["tsdoc.json"] = 867,
    ["tsdrc.json"] = 868,
    ...
    v8r = 911,
    vcluster = 1121,
    ["vcpkg configuration file"] = 247,
    ["vcpkg manifest file"] = 246,
    ["vega-lite.json"] = 893,
    ["vega.json"] = 892,
    ["venvironment.yaml"] = 895,
    ["venvplus.yaml"] = 896,
    version = 1183,
    ["version.json"] = 898,
    ["vhwdebugger-binding.yaml"] = 900,
    ["vim-addon-info"] = 901,
    ["vs-2017.3.host.json"] = 903,
    ["vs-nesting.json"] = 904,
    ["vsls.json"] = 902,
    ["vss-extension.json"] = 908,
    vtcfg = 1189,
    ["vtesttree.yaml"] = 909,
    ["vtestunit.yaml"] = 910,
    ["warp-keysets.json"] = 1082,
    ["warp-themes.json"] = 1083,
    ["warp-workflows.json"] = 1084,
    ["webhint.io"] = 1038,
    ["webjobpublishsettings.json"] = 915,
    ["webjobs-list.json"] = 914,
    ["well-known-fursona"] = 1122,
    ["xs-app.json"] = 942,
    ["xunit.runner.json"] = 927,
    yamllint = 970,
    zizmor = 1226,
    zuul = 953,
    ["Žinoma"] = 963
