...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 868,
    [".nodehawkrc"] = 530,
    [".npmpackagejsonlintrc"] = 534,
    [".omletrc"] = 1044,
    [".phrase.yml"] = 598,
    [".phraseapp.yml"] = 599,
    [".pmbot.yml"] = 586,
    [".postcssrc"] = 593,
    [".powerpages-web-template-manifest"] = 595,
    [".pre-commit-config.yml"] = 596,
    [".pre-commit-hooks.yml"] = 597,
    [".putout.json"] = 626,
    [".rehyperc"] = 650,
    [".remarkrc"] = 654,
    [".sprite files"] = 742,
    ...
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1089,
    ["API Builder"] = 903,
    ["AVA Configuration"] = 965,
    ...
    ["AWS Copilot Manifest"] = 1128,
    ["AWS SAM CLI Samconfig"] = 226,
    ["Adobe UXP Manifest"] = 1027,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1118,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 937,
    ["All Contributors configuration file"] = 990,
    ...
    ["Application list for a WinUtil"] = 1071,
    ArchitectFX = 1076,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure Pipelines"] = 81,
    ["Azure Static Web Apps CLI configuration file"] = 746,
    ["Azure Static Web Apps configuration file"] = 745,
    ["BOSH CPI Config"] = 105,
    ["BOSH Deploy Config"] = 106,
    ["BX CI"] = 125,
    ["Bashly (bashly.yml)"] = 994,
    ["Bashly Settings (bashly-settings.yml)"] = 995,
    ["Better Code Hub"] = 907,
    ["Better Scripts"] = 126,
    Bigconfig = 98,
    ["Biome Formatter Config"] = 65,
    ["Bitmovin Encoding Template"] = 1082,
    BizTalkServerApplicationSchema = 875,
    Bleep = 127,
    ...
    ["Butane Config"] = 950,
    C4InterFlow = 1097,
    ["CDK Environment Manager, concrete environment configuration"] = 1121,
    ["CDK Environment Manager, concrete environments definition"] = 1120,
    ["CDK Environment Manager, environment definition"] = 1119,
    ["CGS Card Game Specification (cgs.json)"] = 1032,
    ["CICS TS region tagging"] = 959,
    ["CICS TS resource import"] = 960,
    ["CICS TS resource model"] = 961,
    ["CICS TS resource overrides"] = 962,
    ["CMake Presets"] = 128,
    ["CNC Codes"] = 149,
    ["CRS WAF test file"] = 1061,
    ["CRS WAF test platform overrides file"] = 1062,
    ...
    ["Chamaleon environment"] = 1086,
    ["Chamaleon properties"] = 1087,
    ["Chamaleon template"] = 1085,
    Changesets = 235,
    Changie = 137,
    Charmcraft = 138,
    Cheatsheets = 947,
    ...
    ["Clawject config"] = 155,
    ["Cloud Foundry Application Manifest"] = 1043,
    ["Cloud Run Spec v1"] = 1066,
    ...
    Concord = 1060,
    ["Configu .cfgu files"] = 1048,
    ["Configu .configu file"] = 1049,
    Conjure = 148,
    ["Container Structure Test"] = 889,
    Containerlab = 916,
    ["Contextive Glossary"] = 1113,
    Convex = 147,
    ["Crowdsec collection config"] = 245,
    ["Crowdsec parser config"] = 246,
    ["Crowdsec scenario config"] = 247,
    ["CumulusCI Config"] = 154,
    ["Custom Machinery Machine"] = 1033,
    ["Custom Machinery Recipe"] = 1034,
    ...
    ["DonateCaseBetterCasino menu"] = 1090,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1002,
    ["EAS config"] = 311,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 991,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1133,
    ["EasyVCR .NET"] = 312,
    ["Eidolon Resource"] = 1077,
    ...
    ["Evolving Resolutive Process notation"] = 1135,
    ["Expo SDK"] = 310,
    ...
    ["GeoJSON.json latest"] = 954,
    GherKing = 958,
    ["GitHub Action"] = 342,
    ["GitHub Actions typing"] = 1073,
    ...
    ["Google Digital Assetlinks"] = 1114,
    Goreleaser = 370,
    ["Goreleaser Pro"] = 371,
    Goss = 372,
    ["Gradle Build Cache Node"] = 905,
    ["Gradle Enterprise"] = 904,
    ...
    Hadolint = 885,
    Hammerkit = 915,
    ["Hardware Sentry Configuration"] = 970,
    ["HashiCorp Vault"] = 385,
    Hatch = 886,
    Hayagriva = 387,
    Hayson = 388,
    ...
    ["JFrog File Spec"] = 420,
    ["JFrog Pipelines YML DSL"] = 979,
    ["JMeter DSL cli config"] = 421,
    JReleaser = 424,
    ["JSON Document Transform"] = 432,
    ["JSON Feed"] = 433,
    ["JSON Resume"] = 660,
    ["JSON Schema Draft 2020-12"] = 853,
    ["JSON Schema Draft 4"] = 850,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1012,
    ["JSON Schema Draft 7"] = 851,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1013,
    ["JSON Schema Draft 8 (2019-09)"] = 852,
    ["JSON-API"] = 431,
    ["JSON-e templates"] = 912,
    ["JSON-stat 2.0"] = 846,
    JSONPatch = 435,
    ...
    ["Jujutsu (jj) VCS config"] = 1127,
    ["KIMMDY config file"] = 446,
    ["KODE/CI build.yaml"] = 975,
    ["KSP-AVC"] = 847,
    ["KSP-CKAN"] = 848,
    ["KSP-NetKAN"] = 849,
    KSY = 1042,
    ...
    ["Metadata for a Cinnamon spice"] = 1069,
    ["Metatype Configuration"] = 486,
    ["MetricsHub Configuration"] = 487,
    ["MetricsHub Connector Configuration"] = 488,
    ["Micro Editor Syntax"] = 1003,
    ["Microsoft Band Web Tile"] = 489,
    ["Microsoft RulesEngine workflow rules"] = 1057,
    ["Microsoft RulesEngine workflow rules list"] = 1058,
    ["Minecraft Custom Main Menu Mod"] = 1021,
    ...
    ["MongoDB Atlas Search Index Definition"] = 974,
    ["Monika Configuration"] = 972,
    ["Monoweave Configuration"] = 514,
    ["Motif config"] = 867,
    MultiQC = 1107,
    ["NOX Framework (Service)"] = 533,
    ["Netin Diagnostic System Template"] = 932,
    ["Netlify config"] = 522,
    ["Network-as-Code Data Model"] = 523,
    ["Next Gen UI Agent Configuration"] = 524,
    ["Nightwatch.js"] = 526,
    ["Node.js configuration"] = 872,
    ["NueJS configuration file"] = 538,
    ["Nuitka.yaml"] = 1035,
    ["Nullstone config"] = 540,
    ["ONe's changelog entry"] = 555,
    ["ONe's service descriptor"] = 554,
    ["ORT Server repository environment configuration"] = 563,
    ["OSCAL Assessment Plan (AP)"] = 565,
    ["OSCAL Assessment Results (AR)"] = 566,
    ["OSCAL Catalog"] = 567,
    ["OSCAL Component Definition (CDef)"] = 568,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 569,
    ["OSCAL Profile"] = 570,
    ["OSCAL System Security Plan (SSP)"] = 571,
    ["OSS Review Toolkit configuration"] = 572,
    ["OSS Review Toolkit curation"] = 573,
    ["OSS Review Toolkit package configuration"] = 574,
    ["OSS Review Toolkit repository configuration"] = 575,
    ["OSS Review Toolkit resolutions"] = 576,
    ["October CMS columns"] = 544,
    ["October CMS fields"] = 545,
    Okteto = 546,
    ["Ona Automations"] = 548,
    Opctl = 870,
    ["Open Data Contract Standard (ODCS)"] = 558,
    ["Open Data Product Standard (ODPS)"] = 559,
    ["Open Know-How"] = 1112,
    ["OpenRewrite Resource"] = 557,
    OpenStatus = 1123,
    ["OpenUtau character yaml"] = 551,
    ["OpenUtau ustx"] = 552,
    ["OpenWeather Current Weather API"] = 911,
    ["OpenWeather Road Risk API"] = 910,
    ["Ory Hydra configuration"] = 397,
    ["Ory Keto configuration"] = 454,
    ["Ory Kratos configuration"] = 564,
    ["Ory Oathkeeper configuration"] = 542,
    ["Outblocks App configuration"] = 561,
    ["Outblocks database table"] = 562,
    ["Outblocks project configuration"] = 560,
    PDM = 582,
    Packer = 579,
    Pantsbuild = 989,
    ["Paper paper-plugin.yml"] = 580,
    ["Pipeline component"] = 923,
    ["Platform.sh application"] = 2,
    ["Platform.sh routes"] = 3,
    ["Platform.sh services"] = 4,
    ["Plex Prerolls"] = 590,
    ["PocketMine plugin.yml"] = 587,
    ["Postman collection"] = 594,
    ["Power Pages Configuration"] = 1124,
    ["Preset list for a WinUtil"] = 1072,
    ["ProActions AI-Kit Configuration"] = 603,
    ["ProActions AI-Kit Configuration for Menus"] = 605,
    ["ProActions AI-Kit Configuration for Sections"] = 607,
    ["ProActions AI-Kit Configuration for Services"] = 604,
    ["ProActions AI-Kit Configuration for Steps"] = 608,
    ["ProActions AI-Kit Configuration for Templates"] = 606,
    ["Problem object RFC9457"] = 1018,
    ["Problem package generators"] = 609,
    Pterodactyl = 969,
    ["Pull Request Labeler"] = 625,
    Pulumi = 633,
    ["PyGTA Config"] = 629,
    PyProject = 634,
    Pylock = 1115,
    Pyright = 635,
    ["Python script metadata"] = 1109,
    ["QType AI DSL"] = 638,
    Qgoda = 637,
    Qodana = 942,
    ["Qt Creator workspace file"] = 1050,
    ["Quali Torque Blueprint Spec 2"] = 967,
    ["QueryFirst config file"] = 985,
    ["RKE Cluster Configuration JSON"] = 920,
    ["RKE Cluster Configuration YAML"] = 919,
    RadioHound = 628,
    Railway = 639,
    ["Rancher Fleet"] = 630,
    ["Rattler-build"] = 640,
    Ray = 884,
    ["Read the Docs"] = 632,
    ["Red-DiscordBot Cog"] = 647,
    ["Red-DiscordBot Cog Repo"] = 648,
    ["Red-DiscordBot Trivia"] = 649,
    ["Render Blueprints"] = 918,
    RenderCV = 662,
    Renovate = 661,
    ["Replit config"] = 655,
    Restate = 1102,
    ["Revel Digital Gadget Definition File"] = 1126,
    RoadRunner = 664,
    ["Robust Station Image"] = 1132,
    ["Roo Coder Custom Modes"] = 666,
    Rubocop = 657,
    ["Rudder techniques"] = 1025,
    Ruff = 658,
    ["Rust Project"] = 659,
    ["Rust toolchain"] = 669,
    ["SDMX data message"] = 695,
    ["SDMX metadata message"] = 694,
    ["SDMX structure message"] = 693,
    ["SIL Kit Participant Configuration"] = 705,
    ["SIL Kit Registry Configuration"] = 706,
    ["SPDX 2.3"] = 743,
    SWADL = 759,
    ["Safebox Config"] = 980,
    ["Sapphire CLI Config"] = 672,
    ["SauceCTL Configuration"] = 929,
    ["Schema Catalog"] = 687,
    ["Scoop manifest"] = 692,
    ["Semantic Data Fabric (SDF) file"] = 696,
    ["Semgrep Rule"] = 698,
    ["Serenity Code Generator (Sergen)"] = 699,
    ["Serverless Framework Configuration"] = 936,
    ["Serverless Workflow"] = 938,
    ["Settings for a Cinnamon spice"] = 1068,
    ["Settings.paf"] = 701,
    ["Shopware 6 Configuration"] = 939,
    ["Shopware CLI Extension Store Configuration"] = 940,
    ["Shopware CLI Project Store Configuration"] = 941,
    ["Sigma Detection Rule"] = 703,
    ["Sigrid scope configuration file"] = 704,
    ["SkyPilot Task JSON"] = 1026,
    ["Slack app manifest"] = 708,
    Solidarity = 713,
    ["Solution filters"] = 714,
    ["Source Maps v3"] = 715,
    Sourcery = 716,
    ["Spack bootstrap.yaml"] = 717,
    ["Spack cdash.yaml"] = 718,
    ["Spack ci.yaml"] = 719,
    ["Spack compilers.yaml"] = 720,
    ["Spack concretizer.yaml"] = 721,
    ["Spack config.yaml"] = 722,
    ["Spack definitions.yaml"] = 723,
    ["Spack develop.yaml"] = 724,
    ["Spack env_vars.yaml"] = 725,
    ["Spack environment"] = 731,
    ["Spack include.yaml"] = 726,
    ["Spack mirrors.yaml"] = 727,
    ["Spack modules.yaml"] = 728,
    ["Spack packages.yaml"] = 729,
    ["Spack repos.yaml"] = 730,
    ["Spack toolchains.yaml"] = 732,
    ["Spack upstreams.yaml"] = 733,
    ["Spack view.yaml"] = 734,
    ["Speakeasy Generation Config File"] = 738,
    ["Speakeasy Lint Configuration File"] = 735,
    ["Speakeasy Test Generation Configuration File"] = 736,
    ["Speakeasy Workflow File"] = 737,
    SpecIF = 739,
    ["Specmatic Configuration"] = 740,
    ["Sponge Mixin configuration"] = 741,
    StackBlitz = 747,
    ["StackHawk Scanner Configuration"] = 935,
    Stale = 748,
    Starfish = 749,
    ["Starlake Data Pipeline"] = 908,
    Starship = 750,
    ["Statamic Blueprint"] = 751,
    ["Stella configuration file"] = 752,
    ["Streamlit configuration file"] = 753,
    ["Stryker Mutator"] = 756,
    ["StyleCop Analyzers Configuration"] = 757,
    ["Stylelint (.stylelintrc)"] = 758,
    ["Stylua Config"] = 1116,
    ["Sublime Syntax"] = 981,
    ["Subsquid squid manifest"] = 1028,
    ["Swagger API 2.0"] = 760,
    ["Synadia Connect Component"] = 761,
    TSON = 796,
    TSTyche = 797,
    ["TYPO3 Vendor Bundler config"] = 802,
    ["Tab data for a LinUtil"] = 1075,
    ["Tab list for a LinUtil"] = 1074,
    Tach = 762,
    ["Tach Domain"] = 763,
    Talhelper = 765,
    ["Talisman configuration"] = 766,
    Taplo = 1117,
    ["Taskfile config"] = 913,
    Taurus = 767,
    Tauticord = 768,
    Telefonistka = 1103,
    ["Terrateam config"] = 1129,
    ["TestEnvironment.json"] = 779,
    ["TextMate Grammar"] = 778,
    Threagile = 774,
    ["Tier.run pricing.json"] = 771,
    Tikibase = 772,
    Tombi = 777,
    ["Traefik v2"] = 782,
    ["Traefik v2 File Provider"] = 783,
    ["Traefik v3"] = 784,
    ["Traefik v3 File Provider"] = 785,
    ["Travis CI (.travis.yml)"] = 781,
    Treefmt = 375,
    Trident = 1099,
    ["TrueScript for *.tscript files"] = 788,
    ["Tugboat QA config.yml"] = 1096,
    TunnelHub = 1016,
    Turborepo = 780,
    Tycho = 1064,
    Tye = 943,
    ["Tyk Gateway - Open Source v5.7+"] = 1108,
    ["Typst Manifest"] = 803,
    ["UET BuildConfig.json"] = 986,
    ["UI5 Manifest"] = 809,
    ["UNCORS configuration"] = 813,
    ["UTAM Page Object"] = 812,
    ["Ubuntu Server Autoinstall"] = 807,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1100,
    ["Uniswap Token List"] = 896,
    ["Universal Schedule Format"] = 814,
    ["Unreal Engine Uplugin"] = 987,
    ["Unreal Engine Uproject"] = 988,
    ["UpCloud CLI (upctl) configuration"] = 1101,
    ["Updatecli Compose"] = 951,
    ["Updatecli Policy Manifest"] = 952,
    ["Updatecli Policy Metadata"] = 953,
    Uplift = 984,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 917,
    V2Ray = 957,
    ["VSCode Code Snippets"] = 210,
    ["VSIX CLI publishing"] = 834,
    Vector = 816,
    ["Vela Pipeline Configuration"] = 819,
    Vercel = 209,
    ["Version Bumper config"] = 824,
    ["Viash Component Config"] = 1105,
    ["Viash Package Config"] = 1106,
    Visivo = 1014,
    ["WP-CLI"] = 844,
    Wake = 1098,
    ["Waku Config"] = 1078,
    ["Web App Manifest"] = 840,
    ["Web types"] = 843,
    WebExtensions = 839,
    ["Webman package recipe"] = 963,
    ["Windows Package Manager Installer Manifest"] = 892,
    ["Windows Package Manager Locale Manifest"] = 893,
    ["Windows Package Manager Singleton Manifest"] = 891,
    Winutil = 894,
    ["WireMock stub mapping"] = 1081,
    ["Woodpecker pipeline config"] = 931,
    ["Wrangler CLI"] = 845,
    ["Xstate Machine"] = 949,
    ["Yandex Workflow Language"] = 1070,
    ["Yarn Config (.yarnrc.yml)"] = 906,
    ["Yippee-Ki-JSON configuration YML"] = 898,
    ["YouTrack App"] = 1067,
    ["Zarf Package Configuration"] = 1131,
    ["Zerops.io config"] = 1055,
    ["Zerops.io import"] = 1056,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 1019,
    ...
    ["behat.yml"] = 108,
    ["bigquery-table"] = 97,
    ["bioimageio resource description"] = 1036,
    ...
    ["crowdin.yml"] = 244,
    ["ctfd-setup configuration file"] = 1088,
    ["custom-elements.json"] = 1006,
    ["cypress.json"] = 248,
    ...
    ["gematik health care insurance list"] = 1094,
    ["gematik health care patient list"] = 1091,
    ["gematik health care provider institution list"] = 1093,
    ["gematik health care provider list"] = 1092,
    ["gematik tiger test environment configuration"] = 1095,
    ["gitlab-ci"] = 350,
    ["global.json"] = 366,
    ...
    ["lint-staged (.lintstagedrc)"] = 861,
    ["local.settings.json"] = 474,
    ["localazy.json"] = 475,
    ["lotus.yaml"] = 473,
    ["lsdlschema.json"] = 476,
    ["markdown-link-check"] = 926,
    maturin = 927,
    mboats = 934,
    ["micro-settings.json"] = 998,
    ["mimetypes.json"] = 490,
    ["mirrord config"] = 863,
    mise = 864,
    ["mkdocs.yml"] = 510,
    ["monospace.yml"] = 513,
    ["moon.yml"] = 1080,
    ["mprocs Configuration file"] = 1051,
    ["mrdocs.yml"] = 511,
    ["mta.yaml"] = 865,
    ["mtad.yaml"] = 866,
    ["mycode.json"] = 520,
    ...
    neoload = 878,
    ["nest-cli"] = 528,
    ["ninjs (News in JSON)"] = 527,
    ["nitro.json"] = 877,
    ["nixd configuration"] = 1024,
    ["nlu.json"] = 529,
    ["nodemon.json"] = 531,
    ["noodl config"] = 933,
    ["notebook.mod.json"] = 532,
    now = 873,
    ["npm-badges"] = 535,
    ["nswag.json"] = 539,
    ntangle = 541,
    ["nuclei-template.yaml"] = 536,
    ["nuget-project.json"] = 537,
    ["ocelot.json"] = 543,
    ["omnisharp.json"] = 547,
    ["openapi.json"] = 549,
    ["openfin.json"] = 556,
    ...
    ["ops.yaml"] = 553,
    ["package.json"] = 577,
    ["package.manifest"] = 578,
    ["partial-black.json"] = 109,
    ["pathfinder.yml"] = 581,
    ["pattern.json"] = 584,
    ["petstore-v1.0"] = 978,
    pgap_yaml_input_reader = 583,
    ["pixi.toml"] = 585,
    ["plagiarize-me.yaml"] = 589,
    ["plagiarize.yaml"] = 588,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1084,
    ["podbard.yaml"] = 591,
    ["portman.json"] = 592,
    ["prefect.toml"] = 600,
    ["prettierrc.json"] = 601,
    ["prisma.yml"] = 602,
    ["project-1.0.0-beta3.json"] = 611,
    ["project-1.0.0-beta4.json"] = 612,
    ["project-1.0.0-beta5.json"] = 613,
    ["project-1.0.0-beta6.json"] = 614,
    ["project-1.0.0-beta8.json"] = 615,
    ["project-1.0.0-rc1.json"] = 616,
    ["project-1.0.0-rc2.json"] = 617,
    ["project.json"] = 610,
    ["project.owasp.yaml"] = 618,
    ["prometheus.json"] = 619,
    ["prometheus.rules.json"] = 620,
    ["prometheus.rules.test.json"] = 621,
    ["proxies.json"] = 622,
    ["publiccode.yml"] = 623,
    ["pubspec.yaml"] = 624,
    ["pyrseas-0.8.json"] = 627,
    pytest = 636,
    ["quilt.mod.json"] = 999,
    ["rc3 auth"] = 641,
    ["rc3 collection"] = 642,
    ...
    ["release-please-manifest.json"] = 652,
    ["release-plz.toml"] = 653,
    ["renv.lock"] = 663,
    ["rivet.json"] = 1023,
    ["rivet.yaml (legacy)"] = 1022,
    rockcraft = 665,
    runny = 667,
    rustfmt = 668,
    sake = 1111,
    samt = 670,
    samtrc = 671,
    ["sarif-1.0.0.json"] = 673,
    ["sarif-2.0.0.json"] = 674,
    ["sarif-2.1.0"] = 684,
    ["sarif-2.1.0-rtm.2"] = 675,
    ["sarif-2.1.0-rtm.3"] = 677,
    ["sarif-2.1.0-rtm.4"] = 679,
    ["sarif-2.1.0-rtm.5"] = 681,
    ["sarif-2.1.0-rtm.6"] = 682,
    ["sarif-external-property-file-2.1.0"] = 685,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 676,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 678,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 680,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 683,
    ["scalingo.json configuration"] = 686,
    ["schema.org - Action"] = 688,
    ["schema.org - ContactPoint"] = 689,
    ["schema.org - Place"] = 690,
    ["schema.org - Thing"] = 691,
    ["secrethub.yml"] = 1001,
    ["semantic-release"] = 697,
    ["servicehub.config.json"] = 856,
    ["servicehub.service.json"] = 855,
    ["settings.job"] = 700,
    ["sfdx-hardis configuration"] = 702,
    ["shard.yml"] = 1039,
    ["size-limit configuration"] = 707,
    ["skaffold.yaml"] = 924,
    ["skyuxconfig.json"] = 709,
    snapcraft = 710,
    ["snowflake-config"] = 711,
    ["snowflake-connections"] = 712,
    ["spicepod.yaml"] = 1059,
    ["sqlc configuration"] = 744,
    ["stripe-app-local.json"] = 755,
    ["stripe-app.json"] = 754,
    swcrc = 909,
    ["task.json"] = 764,
    taskcat = 874,
    ["template.json"] = 769,
    ["templatsources.json"] = 770,
    ["theme.json"] = 773,
    ["tizen_workspace.json"] = 775,
    tldr = 776,
    ["tm_devices configuration file"] = 1122,
    tmuxinator = 859,
    ["transcend.yml"] = 786,
    ["tree-sitter grammar.json"] = 374,
    ["trime.yaml"] = 787,
    ["trunk.yaml"] = 789,
    ["ts-force-config.json"] = 794,
    ["tsconfig.json"] = 790,
    ["tsd.json"] = 791,
    ["tsdoc.json"] = 792,
    ["tsdrc.json"] = 793,
    ...
    ["vega-lite.json"] = 818,
    ["vega.json"] = 817,
    ["venvironment-basic.yaml"] = 821,
    ["venvironment.yaml"] = 820,
    ["venvplus-basic.yaml"] = 823,
    ["venvplus.yaml"] = 822,
    version = 1104,
    ["version.json"] = 825,
    ["vhwdebugger-binding.yaml"] = 827,
    ["vim-addon-info"] = 828,
    ["vs-2017.3.host.json"] = 830,
    ["vs-nesting.json"] = 831,
    ["vsls.json"] = 829,
    ["vss-extension.json"] = 835,
    vtcfg = 1110,
    ["vtesttree.yaml"] = 836,
    ["vtestunit.yaml"] = 837,
    ["warp-keysets.json"] = 1007,
    ["warp-themes.json"] = 1008,
    ["warp-workflows.json"] = 1009,
    ["webhint.io"] = 964,
    ["webjobpublishsettings.json"] = 842,
    ["webjobs-list.json"] = 841,
    ["well-known-fursona"] = 1046,
    ["xs-app.json"] = 869,
    ["xunit.runner.json"] = 854,
    yamllint = 897,
    zuul = 880,
    ["Žinoma"] = 890
  },
