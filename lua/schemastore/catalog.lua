...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 143,
    [".cryproj (generic)"] = 484,
    [".cryproj engine-5.2"] = 479,
    [".cryproj engine-5.3"] = 480,
    [".cryproj engine-5.4"] = 481,
    [".cryproj engine-5.5"] = 482,
    [".cryproj engine-dev"] = 483,
    [".csscomb.json"] = 145,
    [".csslintrc"] = 146,
    [".eslintrc"] = 190,
    [".esmrc.json"] = 182,
    ...
    [".vsext"] = 459,
    [".yarnrc.yml"] = 525,
    ["<div>RIOTS' studio configuration"] = 463,
    ["@factorial/drupal-breakpoints-css"] = 4,
    ["API Builder"] = 522,
    ["AVA Configuration Schema"] = 576,
    ...
    ["Azure Pipelines"] = 44,
    ["Azure Static Web Apps CLI configuration file"] = 409,
    ["Azure Static Web Apps configuration file"] = 408,
    ["BX CI"] = 75,
    ["Better Code Hub"] = 527,
    ["Better Scripts"] = 76,
    BizTalkServerApplicationSchema = 499,
    ...
    ["Butane Config"] = 563,
    ["CICS TS region tagging"] = 570,
    ["CICS TS resource import"] = 571,
    ["CICS TS resource model"] = 572,
    ["CICS TS resource overrides"] = 573,
    ["CMake Presets"] = 77,
    ...
    ["Datahub Ingestion Recipe Schema"] = 577,
    ...
    ["Embrace Config Schema"] = 588,
    ["Error pages"] = 185,
    Esquio = 183,
    ["Estuary Flow Catalog Schema"] = 567,
    ["Expo SDK"] = 188,
    ...
    Goreleaser = 216,
    ["Goreleaser Pro"] = 217,
    ["Gradle Build Cache Node"] = 524,
    ["Gradle Enterprise"] = 523,
    ...
    HEMTT = 496,
    Hadolint = 508,
    ["Hardware Sentry Configuration"] = 581,
    Hayson = 229,
    ...
    ["JFrog File Spec"] = 248,
    ["JFrog Pipelines YML DSL"] = 590,
    ["JSON Document Transform"] = 256,
    ["JSON Feed"] = 257,
    ["JSON Resume"] = 369,
    ["JSON Schema Draft 2020-12"] = 475,
    ["JSON Schema Draft 4"] = 472,
    ["JSON Schema Draft 7"] = 473,
    ["JSON Schema Draft 8"] = 474,
    ...
    ["KSP-AVC"] = 470,
    ["KSP-CKAN"] = 471,
    ["Keycloak REST API"] = 596,
    ["Knative Functions - func.yaml"] = 200,
    ["KoDE/CI build.yaml"] = 586,
    ["Kong DBLess Schema"] = 587,
    KrakenD = 262,
    ["LinkML Metamodel"] = 274,
    Liquibase = 538,
    ["Liquibase Flow File"] = 539,
    Markdownlint = 542,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 585,
    ["Monika Configuration Schema"] = 583,
    ["Motif config"] = 492,
    ["Netin Diagnostic System Template"] = 547,
    ...
    Opctl = 495,
    ["OpenWeather Current Weather API"] = 531,
    ["OpenWeather Road Risk API"] = 530,
    ...
    Packer = 331,
    ["Pipeline component"] = 540,
    ["PocketMine plugin.yml"] = 335,
    Pterodactyl = 580,
    ["Pull Request Labeler"] = 358,
    PyProject = 362,
    Qodana = 556,
    ["Quali Torque Blueprint Spec 2"] = 578,
    ["QueryFirst config file"] = 599,
    ["RKE Cluster Configuration JSON Schema"] = 537,
    ["RKE Cluster Configuration YAML Schema"] = 536,
    Ray = 507,
    ["Read the Docs"] = 361,
    ...
    RoadRunner = 371,
    ["Rust toolchain"] = 373,
    ["SIL Kit Participant Configuration"] = 398,
    SWADL = 418,
    ["Sapphire CLI Config"] = 374,
    ["SauceCTL Configuration"] = 544,
    ["Schema Catalog"] = 387,
    ["Scoop manifest"] = 392,
    ["Semgrep Rule"] = 394,
    ["Serverless Framework Configuration"] = 551,
    ["Serverless Workflow Schema"] = 552,
    ["Settings.paf"] = 396,
    ["Shopware 6 Configuration"] = 553,
    ["Shopware CLI Extension Store Configuration"] = 554,
    ["Shopware CLI Project Store Configuration"] = 555,
    Solidarity = 402,
    ["Solution filters"] = 403,
    ["Source Maps v3"] = 404,
    SpecIF = 405,
    ["Sponge Mixin configuration"] = 406,
    ["StackHawk Scanner Configuration"] = 550,
    Stale = 410,
    Starship = 411,
    ["Statamic Blueprint"] = 412,
    ["StrmPrivacy Data Connector"] = 594,
    ["StrmPrivacy Data Contract"] = 595,
    ["StrmPrivacy SimpleSchema"] = 592,
    ["StrmPrivacy Stream"] = 593,
    ["StrmPrivacy batch job configuration file"] = 591,
    ["Stryker Mutator"] = 415,
    ["StyleCop Analyzers Configuration"] = 416,
    ["Swagger API 2.0"] = 419,
    TSON = 439,
    ["Talisman configuration"] = 420,
    ["Taskfile YAML Schema"] = 533,
    Taurus = 421,
    ["TestEnvironment.json"] = 428,
    Tikibase = 424,
    ["Traefik v2"] = 431,
    ["Traefik v2 File Provider"] = 432,
    Turborepo = 429,
    Tye = 557,
    ["UI5 Manifest"] = 445,
    ...
    ["VSIX CLI publishing"] = 460,
    ["Vela Pipeline Configuration"] = 450,
    Vercel = 118,
    ["Web App Manifest"] = 465,
    ["Web types"] = 468,
    WebExtensions = 464,
    ["Webman package recipe"] = 574,
    ["Windows Package Manager Installer Manifest"] = 513,
    ["Windows Package Manager Locale Manifest"] = 514,
    ["Windows Package Manager Singleton Manifest"] = 512,
    ["Woodpecker pipeline config"] = 546,
    ["Xstate Machine Schema"] = 562,
    ["Yippee-Ki-JSON configuration YML"] = 518,
    ["angular.json"] = 10,
    ...
    ["ize.toml"] = 597,
    ["jsconfig.json"] = 260,
    ["jscpd Configuration Schema"] = 579,
    jsdoc = 506,
    ["k3d.yaml"] = 261,
    ...
    ["release drafter"] = 502,
    rustfmt = 372,
    ["sarif-1.0.0.json"] = 375,
    ["sarif-2.0.0.json"] = 376,
    ["sarif-2.1.0"] = 385,
    ["sarif-2.1.0-rtm.2"] = 377,
    ["sarif-2.1.0-rtm.3"] = 379,
    ["sarif-2.1.0-rtm.4"] = 381,
    ["sarif-2.1.0-rtm.5"] = 383,
    ["sarif-external-property-file-2.1.0"] = 386,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 378,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 380,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 382,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 384,
    ["schema.org - Action"] = 388,
    ["schema.org - ContactPoint"] = 389,
    ["schema.org - Place"] = 390,
    ["schema.org - Thing"] = 391,
    ["semantic-release"] = 393,
    ["servicehub.config.json"] = 478,
    ["servicehub.service.json"] = 477,
    ["settings.job"] = 395,
    ["sfdx-hardis configuration"] = 397,
    ["size-limit configuration"] = 399,
    ["skaffold.yaml"] = 541,
    ["skyuxconfig.json"] = 400,
    snapcraft = 401,
    ["stripe-app-local.json"] = 414,
    ["stripe-app.json"] = 413,
    swcrc = 529,
    taskcat = 498,
    ["template.json"] = 422,
    ["templatsources.json"] = 423,
    ["theme.json"] = 425,
    ["tizen_workspace.json"] = 426,
    tmLanguage = 427,
    tmuxinator = 486,
    ["trunk.yaml schema"] = 433,
    ["ts-force-config.json"] = 437,
    ["tsconfig.json"] = 434,
    ["tsd.json"] = 435,
    ["tsdrc.json"] = 436,
    ["tslint.json"] = 438,
    ...
    ["vega-lite.json"] = 449,
    ["vega.json"] = 448,
    ["venvironment-basic.yaml"] = 452,
    ["venvironment.yaml"] = 451,
    ["version.json"] = 453,
    ["vim-addon-info"] = 454,
    ["vs-2017.3.host.json"] = 456,
    ["vs-nesting.json"] = 457,
    ["vsls.json"] = 455,
    ["vss-extension.json"] = 461,
    ["webhint.io"] = 575,
    ["webjobpublishsettings.json"] = 467,
    ["webjobs-list.json"] = 466,
    ["xs-app.json"] = 494,
    ["xunit.runner.json"] = 476,
    yamllint = 517,
    zuul = 503,
    ["Žinoma"] = 511
  },
