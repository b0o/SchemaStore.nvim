...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 158,
    [".cryproj (generic)"] = 551,
    [".cryproj engine-5.2"] = 546,
    [".cryproj engine-5.3"] = 547,
    [".cryproj engine-5.4"] = 548,
    [".cryproj engine-5.5"] = 549,
    [".cryproj engine-dev"] = 550,
    [".csscomb.json"] = 160,
    [".csslintrc"] = 161,
    [".es6importsorterrc.json"] = 674,
    [".eslintrc"] = 206,
    [".esmrc.json"] = 198,
    [".ffizer.yaml"] = 210,
    [".htmlhintrc"] = 255,
    ...
    [".pmbot.yml"] = 378,
    [".postcssrc"] = 383,
    [".powerpages-web-template-manifest"] = 385,
    [".pre-commit-config.yml"] = 386,
    [".pre-commit-hooks.yml"] = 387,
    [".putout.json"] = 405,
    [".rehyperc"] = 415,
    [".remarkrc"] = 416,
    [".sprite files"] = 466,
    ...
    ["Azure Pipelines"] = 48,
    ["Azure Static Web Apps CLI configuration file"] = 468,
    ["Azure Static Web Apps configuration file"] = 467,
    ["BX CI"] = 83,
    ["Better Code Hub"] = 594,
    ["Better Scripts"] = 84,
    BizTalkServerApplicationSchema = 566,
    ...
    ["Butane Config"] = 633,
    ["CICS TS region tagging"] = 640,
    ["CICS TS resource import"] = 641,
    ["CICS TS resource model"] = 642,
    ["CICS TS resource overrides"] = 643,
    ["CMake Presets"] = 85,
    ...
    ["Datahub Ingestion Recipe Schema"] = 647,
    ...
    ["Embrace Config Schema"] = 658,
    ["Error pages"] = 201,
    Esquio = 199,
    ["Estuary Flow Catalog Schema"] = 637,
    ["Expo SDK"] = 204,
    ...
    Goreleaser = 237,
    ["Goreleaser Pro"] = 238,
    ["Gradle Build Cache Node"] = 591,
    ["Gradle Enterprise"] = 590,
    ...
    Hadolint = 575,
    Hammerkit = 601,
    ["Hardware Sentry Configuration"] = 651,
    Hayson = 250,
    ...
    ["JFrog File Spec"] = 274,
    ["JFrog Pipelines YML DSL"] = 660,
    ["JMeter DSL cli config schema"] = 275,
    JReleaser = 277,
    ["JSON Document Transform"] = 284,
    ["JSON Feed"] = 285,
    ["JSON Resume"] = 422,
    ["JSON Schema Draft 2020-12"] = 542,
    ["JSON Schema Draft 4"] = 539,
    ["JSON Schema Draft 7"] = 540,
    ["JSON Schema Draft 8"] = 541,
    ...
    ["KSP-CKAN"] = 538,
    Kas = 290,
    ["Keycloak REST API"] = 666,
    ["Knative Functions - func.yaml"] = 219,
    ["KoDE/CI build.yaml"] = 656,
    ["Kong DBLess Schema"] = 657,
    KrakenD = 291,
    LOOBin = 306,
    ["LinkML Metamodel"] = 304,
    Liquibase = 606,
    ["Liquibase Flow File"] = 607,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 655,
    ["Monika Configuration Schema"] = 653,
    ["Motif config"] = 559,
    ["NOX Framework (Service)"] = 349,
    ["Netin Diagnostic System Template"] = 616,
    ...
    ["OpenWeather Current Weather API"] = 598,
    ["OpenWeather Road Risk API"] = 597,
    ...
    Packer = 375,
    Pantsbuild = 672,
    ["Pipeline component"] = 608,
    ["PocketMine plugin.yml"] = 379,
    ["Postman collection"] = 384,
    Pterodactyl = 650,
    ["Pull Request Labeler"] = 404,
    Pulumi = 409,
    PyProject = 410,
    Pyright = 411,
    Qodana = 626,
    ["Quali Torque Blueprint Spec 2"] = 648,
    ["QueryFirst config file"] = 669,
    ["RKE Cluster Configuration JSON Schema"] = 605,
    ["RKE Cluster Configuration YAML Schema"] = 604,
    ["Rancher Fleet"] = 407,
    Ray = 574,
    ["Read the Docs"] = 408,
    ["Red-DiscordBot Cog"] = 412,
    ["Red-DiscordBot Cog Repo"] = 413,
    ["Red-DiscordBot Trivia"] = 414,
    Renovate = 423,
    ["Replit schema"] = 417,
    RoadRunner = 424,
    Ruff = 420,
    ["Rust Project"] = 421,
    ["Rust toolchain"] = 426,
    ["SIL Kit Participant Configuration"] = 455,
    SWADL = 477,
    ["Sapphire CLI Config"] = 429,
    ["SauceCTL Configuration"] = 613,
    ["Schema Catalog"] = 442,
    ["Scoop manifest"] = 447,
    ["Semantic Data Fabric (SDF) file"] = 448,
    ["Semgrep Rule"] = 450,
    ["Serenity Code Generator (Sergen)"] = 451,
    ["Serverless Framework Configuration"] = 620,
    ["Serverless Workflow Schema"] = 622,
    ["Settings.paf"] = 453,
    ["Shopware 6 Configuration"] = 623,
    ["Shopware CLI Extension Store Configuration"] = 624,
    ["Shopware CLI Project Store Configuration"] = 625,
    ["Slack app manifest"] = 457,
    Solidarity = 460,
    ["Solution filters"] = 461,
    ["Source Maps v3"] = 462,
    Sourcery = 463,
    SpecIF = 464,
    ["Sponge Mixin configuration"] = 465,
    ["StackHawk Scanner Configuration"] = 619,
    Stale = 469,
    Starship = 470,
    ["Statamic Blueprint"] = 471,
    ["StrmPrivacy Data Connector"] = 664,
    ["StrmPrivacy Data Contract"] = 665,
    ["StrmPrivacy SimpleSchema"] = 662,
    ["StrmPrivacy Stream"] = 663,
    ["StrmPrivacy batch job configuration file"] = 661,
    ["Stryker Mutator"] = 474,
    ["StyleCop Analyzers Configuration"] = 475,
    ["Swagger API 2.0"] = 478,
    TSON = 502,
    ["Talisman configuration"] = 480,
    ["Taskfile YAML Schema"] = 600,
    Taurus = 481,
    ["TestEnvironment.json"] = 490,
    ["Tier.run pricing.json"] = 484,
    Tikibase = 485,
    ["Traefik v2"] = 493,
    ["Traefik v2 File Provider"] = 494,
    Turborepo = 491,
    Tye = 627,
    ["UI5 Manifest"] = 509,
    ["UTAM Page Object"] = 512,
    ["Ubuntu Server Autoinstall"] = 507,
    ["Uniswap Token List"] = 583,
    ["Unreal Engine Uplugin"] = 670,
    ["Unreal Engine Uproject"] = 671,
    Updatecli = 634,
    Uplift = 668,
    ["User Journey Map YAML Schema"] = 603,
    V2Ray = 638,
    ["VSCode Code Snippets"] = 131,
    ["VSIX CLI publishing"] = 525,
    ["Vela Pipeline Configuration"] = 515,
    Vercel = 130,
    ["Web App Manifest"] = 532,
    ["Web types"] = 535,
    WebExtensions = 531,
    ["Webman package recipe"] = 644,
    ["Windows Package Manager Installer Manifest"] = 580,
    ["Windows Package Manager Locale Manifest"] = 581,
    ["Windows Package Manager Singleton Manifest"] = 579,
    ["Woodpecker pipeline config"] = 615,
    ["Xstate Machine Schema"] = 632,
    ["Yippee-Ki-JSON configuration YML"] = 585,
    ["angular.json"] = 11,
    ...
    ["bamboo-spec"] = 59,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 676,
    ["bashly-strings.yml"] = 677,
    ["bashly.yml"] = 675,
    ["batect.yml"] = 58,
    ["beau.yml"] = 593,
    ...
    ["ize.toml"] = 667,
    ["jsconfig.json"] = 288,
    ["jscpd Configuration Schema"] = 649,
    jsdoc = 573,
    ["k3d.yaml"] = 289,
    ...
    ["lotus.yaml"] = 307,
    ["lsdlschema.json"] = 310,
    ["markdown-lint-check"] = 611,
    mboats = 618,
    ["micro-settings.json"] = 678,
    ["mimetypes.json"] = 317,
    ["mirrord-schema"] = 556,
    ["mta.yaml"] = 557,
    ["mtad.yaml"] = 558,
    ...
    ["pattern.json"] = 377,
    ["petstore-v1.0"] = 659,
    pgap_yaml_input_reader = 376,
    ["plagiarize-me.yaml"] = 381,
    ["plagiarize.yaml"] = 380,
    ["portman.json"] = 382,
    ["prettierrc.json"] = 389,
    ["prisma.yml"] = 390,
    ["project-1.0.0-beta3.json"] = 392,
    ["project-1.0.0-beta4.json"] = 393,
    ["project-1.0.0-beta5.json"] = 394,
    ["project-1.0.0-beta6.json"] = 395,
    ["project-1.0.0-beta8.json"] = 396,
    ["project-1.0.0-rc1.json"] = 397,
    ["project-1.0.0-rc2.json"] = 398,
    ["project.json"] = 391,
    ["prometheus.json"] = 399,
    ["prometheus.rules.json"] = 400,
    ["proxies.json"] = 401,
    ["publiccode.yml"] = 402,
    ["pubspec.yaml"] = 403,
    ["pyrseas-0.8.json"] = 406,
    ["quilt.mod.json"] = 679,
    ["release drafter"] = 569,
    rtx = 419,
    rustfmt = 425,
    samt = 427,
    samtrc = 428,
    ["sarif-1.0.0.json"] = 430,
    ["sarif-2.0.0.json"] = 431,
    ["sarif-2.1.0"] = 440,
    ["sarif-2.1.0-rtm.2"] = 432,
    ["sarif-2.1.0-rtm.3"] = 434,
    ["sarif-2.1.0-rtm.4"] = 436,
    ["sarif-2.1.0-rtm.5"] = 438,
    ["sarif-external-property-file-2.1.0"] = 441,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 433,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 435,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 437,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 439,
    ["schema.org - Action"] = 443,
    ["schema.org - ContactPoint"] = 444,
    ["schema.org - Place"] = 445,
    ["schema.org - Thing"] = 446,
    ["semantic-release"] = 449,
    ["servicehub.config.json"] = 545,
    ["servicehub.service.json"] = 544,
    ["settings.job"] = 452,
    ["sfdx-hardis configuration"] = 454,
    ["size-limit configuration"] = 456,
    ["skaffold.yaml"] = 609,
    ["skyuxconfig.json"] = 458,
    snapcraft = 459,
    ["stripe-app-local.json"] = 473,
    ["stripe-app.json"] = 472,
    swcrc = 596,
    ["task.json"] = 479,
    taskcat = 565,
    ["template.json"] = 482,
    ["templatsources.json"] = 483,
    ["theme.json"] = 486,
    ["tizen_workspace.json"] = 487,
    tldr = 488,
    tmLanguage = 489,
    tmuxinator = 553,
    ["transcend.yml"] = 495,
    ["trunk.yaml schema"] = 496,
    ["ts-force-config.json"] = 500,
    ["tsconfig.json"] = 497,
    ["tsd.json"] = 498,
    ["tsdrc.json"] = 499,
    ["tslint.json"] = 501,
    ...
    ["vega-lite.json"] = 514,
    ["vega.json"] = 513,
    ["venvironment-basic.yaml"] = 517,
    ["venvironment.yaml"] = 516,
    ["version.json"] = 518,
    ["vim-addon-info"] = 519,
    ["vs-2017.3.host.json"] = 521,
    ["vs-nesting.json"] = 522,
    ["vsls.json"] = 520,
    ["vss-extension.json"] = 526,
    ["vtesttree.yaml"] = 527,
    ["vtestunit.yaml"] = 528,
    ["webhint.io"] = 645,
    ["webjobpublishsettings.json"] = 534,
    ["webjobs-list.json"] = 533,
    ["xs-app.json"] = 561,
    ["xunit.runner.json"] = 543,
    yamllint = 584,
    zuul = 570,
    ["Žinoma"] = 578
  },
