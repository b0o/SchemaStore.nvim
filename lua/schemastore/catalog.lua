...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1073,
    [".nodehawkrc"] = 689,
    [".npmpackagejsonlintrc"] = 694,
    [".omletrc"] = 1254,
    [".phrase.yml"] = 776,
    [".phraseapp.yml"] = 777,
    [".pmbot.yml"] = 761,
    [".postcssrc"] = 770,
    [".powerpages-web-template-manifest"] = 772,
    [".pre-commit-config.yml"] = 773,
    [".pre-commit-hooks.yml"] = 774,
    [".putout.json"] = 810,
    [".rehyperc"] = 835,
    [".remarkrc"] = 839,
    [".sprite files"] = 941,
    ...
    AIConfig = 46,
    ["AMX Muse Program Descriptor"] = 1303,
    ["API Builder"] = 1109,
    ["AVA Configuration"] = 1173,
    ["AWS AppConfig Feature Flags-v1"] = 85,
    ["AWS CDK cdk.json"] = 306,
    ["AWS CloudFormation"] = 307,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 308,
    ["AWS Copilot Manifest"] = 1342,
    ["AWS SAM CLI Samconfig"] = 309,
    Acton = 1393,
    ["Adobe UXP Manifest"] = 1236,
    ["Aerleon Network & Service Definitions"] = 28,
    ["Aerleon Policy"] = 29,
    ["Agent Permission Policy"] = 1382,
    ["AgentCore CLI"] = 1383,
    AgentLoopKit = 1384,
    Aider = 1332,
    Air = 31,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1353,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1352,
    ["Airlock Microgateway"] = 47,
    ["Alacritty Configuration"] = 1145,
    ["AlgoVoi Compliance Receipt v1"] = 17,
    ["All Contributors configuration file"] = 1199,
    ["Amazon S3 bucket CORS"] = 19,
    Anodizer = 503,
    ["Ansible Argument Specs"] = 485,
    ["Ansible Collection Galaxy"] = 492,
    ["Ansible Execution Environment"] = 482,
    ["Ansible Inventory"] = 491,
    ["Ansible Meta"] = 483,
    ["Ansible Meta Runtime"] = 484,
    ["Ansible Navigator Configuration"] = 494,
    ["Ansible Playbook"] = 489,
    ["Ansible Requirements"] = 486,
    ["Ansible Rulebook"] = 490,
    ["Ansible Tasks File"] = 488,
    ["Ansible Vars File"] = 487,
    ["Ansible-lint Configuration"] = 493,
    Any = 1264,
    ...
    ["Application list for a WinUtil"] = 1282,
    ["ArchSmith diagram IR"] = 1418,
    ArchitectFX = 1287,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1351,
    ["Azure IoT Operations connector metadata"] = 1348,
    ...
    ["Azure Pipelines"] = 134,
    ["Azure Static Web Apps CLI configuration file"] = 945,
    ["Azure Static Web Apps configuration file"] = 944,
    BMML = 1370,
    ["BOSH BPM Config"] = 160,
    ["BOSH CPI Config"] = 161,
    ...
    ["Bacon config"] = 11,
    ["Barba-CV"] = 100,
    ["Bashly (bashly.yml)"] = 1203,
    ["Bashly Settings (bashly-settings.yml)"] = 1204,
    Bento = 1369,
    ["Better Code Hub"] = 1114,
    ["Better Scripts"] = 184,
    Bigconfig = 153,
    ["Biome Formatter Config"] = 101,
    ["Bitmovin Encoding Template"] = 1296,
    BizTalkServerApplicationSchema = 1080,
    Bleep = 185,
    ["Block Protocol Metadata"] = 182,
    ["Bluebricks blueprint config"] = 1375,
    ["Boyka Framework"] = 163,
    ...
    ["Butane Config"] = 1158,
    C4InterFlow = 1311,
    ["CDK Environment Manager, concrete environment configuration"] = 1335,
    ["CDK Environment Manager, concrete environments definition"] = 1334,
    ["CDK Environment Manager, environment definition"] = 1333,
    ["CGS Card Game Specification (cgs.json)"] = 1241,
    ["CICS TS region tagging"] = 1167,
    ["CICS TS resource import"] = 1168,
    ["CICS TS resource model"] = 1169,
    ["CICS TS resource overrides"] = 1170,
    ["CMake Presets"] = 186,
    ["CNC Codes"] = 209,
    ["CRS WAF test file"] = 1271,
    ["CRS WAF test platform overrides file"] = 1272,
    ["CSS Comb (.csscomb.json)"] = 336,
    ["CSS Lint (.csslintrc)"] = 337,
    ["CSpell (cspell.json)"] = 335,
    ...
    ["Caido Proxy Configuration"] = 1408,
    ...
    ["Chamaleon environment"] = 1300,
    ["Chamaleon properties"] = 1301,
    ["Chamaleon template"] = 1299,
    Changepacks = 1362,
    Changesets = 318,
    Changie = 195,
    Charmcraft = 196,
    ...
    CodeCV = 115,
    CodeRabbit = 114,
    ["CodeShip Pro services configuration files"] = 288,
    ["CodeShip Pro steps configuration files"] = 289,
    ["Codecov configuration files"] = 287,
    Codex = 279,
    ["Codex Hooks"] = 280,
    ["Codex Plugin Manifest"] = 281,
    ["Codex Skill Metadata"] = 282,
    CodifyCLI = 116,
    Codux = 284,
    ["Cog config file"] = 210,
    ["Commandbox Box.json"] = 211,
    ["Commandbox Server.json"] = 212,
    ["Common Catalog Data"] = 297,
    ["Common Package Specification"] = 213,
    Concord = 1270,
    ["Configu .cfgu files"] = 1258,
    ["Configu .configu file"] = 1259,
    Conjure = 208,
    ["Container Structure Test"] = 1094,
    Containerlab = 1123,
    ["Contextive Glossary"] = 1327,
    ContractGuard = 1124,
    Convex = 207,
    ["Crowdsec collection config"] = 329,
    ["Crowdsec parser config"] = 330,
    ["Crowdsec scenario config"] = 331,
    ["CumulusCI Config"] = 214,
    ["Cursor Agent Environment"] = 1380,
    ["Custom Machinery Machine"] = 1242,
    ["Custom Machinery Recipe"] = 1243,
    ["Cycle Stack File"] = 232,
    CycloneDX = 233,
    ["DWP Exchange - catalogue entry"] = 383,
    ["DWP Exchange - gateway"] = 381,
    ["DWP Exchange - meta"] = 382,
    ["Dart Build Config (dart-build.json)"] = 338,
    ["Dart Test Config (dart-test.json)"] = 339,
    ["DashLord Configuration"] = 340,
    ["Data Contract Specification"] = 341,
    ["Data Product Specification"] = 342,
    ["DataYoga Connections"] = 234,
    ["DataYoga Job"] = 235,
    ["Datadog Continuous Testing"] = 592,
    ["Datadog Service Definition"] = 593,
    ["Datadog Software Catalog"] = 594,
    ["Datahub Ingestion Recipe"] = 1174,
    ["Debian Upstream Metadata file"] = 242,
    DebtLens = 243,
    ["Deck config"] = 244,
    ["Declarative Automation Bundles"] = 1220,
    ["DeepMatch deeplinks spec"] = 245,
    ["Dein Config"] = 246,
    ["Deno Config (deno.json)"] = 349,
    ["Dependency cruiser"] = 247,
    ["DeployStack Configuration"] = 248,
    ["Deployah Configuration"] = 1350,
    ["Deployer Recipe"] = 352,
    ["Deta Spacefile"] = 249,
    ["Detekt Config (detekt.yml)"] = 353,
    ["Devbox Config"] = 250,
    ["Devbox Plugin"] = 251,
    Devfile = 380,
    Devup = 1363,
    DipDup = 1273,
    ["Discord Webhook"] = 354,
    ["DocFx Config (docfx.json)"] = 359,
    ["Docker Desktop extension metadata"] = 356,
    ["Docs MCP Manifest"] = 360,
    Dofigen = 361,
    ["Dolittle Artifacts"] = 362,
    ["Dolittle Bounded Context Configuration"] = 363,
    ["Dolittle Event Horizons Configuration"] = 364,
    ["Dolittle Resources Configuration"] = 365,
    ["Dolittle Server Configuration"] = 366,
    ["Dolittle Tenant Map Configuration"] = 368,
    ["Dolittle Tenants Configuration"] = 367,
    ["Dolittle Topology"] = 369,
    ["DonateCaseBetterCasino menu"] = 1304,
    ["Draugr Saga"] = 348,
    ["Drupal Breakpoints"] = 252,
    ["Drupal Config"] = 264,
    ["Drupal Info"] = 253,
    ["Drupal Layouts"] = 254,
    ["Drupal Libraries"] = 255,
    ["Drupal Links Action"] = 256,
    ["Drupal Links Contextual"] = 257,
    ["Drupal Links Menu"] = 258,
    ["Drupal Links Task"] = 259,
    ["Drupal Migration"] = 260,
    ["Drupal Permissions"] = 261,
    ["Drupal Recipe"] = 262,
    ["Drupal Routing"] = 263,
    ["Drupal Services"] = 265,
    ["Drush site aliases"] = 375,
    ["Dust configuration"] = 378,
    ["Dynamic Bash Aliases (.aliases)"] = 1211,
    ["EAS config"] = 422,
    ["ECA - Editor Code Assistant"] = 385,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1200,
    ["ESLint Suppressions"] = 427,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1347,
    ["EasyVCR .NET"] = 424,
    ["Eidolon Resource"] = 1288,
    ["Elgato Stream Deck"] = 388,
    Elm = 1275,
    ["Embrace Config"] = 1186,
    Emmet = 1276,
    Endurica = 1224,
    ["Enonic XP API descriptor"] = 391,
    ["Enonic XP Admin Extension descriptor"] = 392,
    ["Enonic XP Admin Tool descriptor"] = 393,
    ["Enonic XP Application descriptor"] = 394,
    ["Enonic XP CMS descriptor"] = 395,
    ["Enonic XP Content Type descriptor"] = 396,
    ["Enonic XP Form Fragment descriptor"] = 397,
    ["Enonic XP ID Provider descriptor"] = 398,
    ["Enonic XP Layout descriptor"] = 399,
    ["Enonic XP Macro descriptor"] = 400,
    ["Enonic XP Mixin descriptor"] = 401,
    ["Enonic XP Page descriptor"] = 402,
    ["Enonic XP Part descriptor"] = 403,
    ["Enonic XP Service descriptor"] = 404,
    ["Enonic XP Site descriptor"] = 405,
    ["Enonic XP Style descriptor"] = 406,
    ["Enonic XP Task descriptor"] = 407,
    ["Enonic XP Webapp descriptor"] = 408,
    ["Enterprise Contract Policy Spec"] = 389,
    ["Envelope Team Definition"] = 1392,
    ["Envilder Map File"] = 390,
    ["Erda Pipeline"] = 1249,
    ["Erda Runtime"] = 1250,
    ["Espanso config.yml"] = 1373,
    ["Espanso match.yml"] = 1372,
    Esquio = 410,
    ["Estuary Flow Catalog"] = 1164,
    ["Ethereum ERC1155"] = 1386,
    ["Ethereum ERC721"] = 1385,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 415,
    ["EveryVoice TTS Toolkit Data Configuration"] = 416,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 420,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 419,
    ["EveryVoice TTS Toolkit Text Configuration"] = 417,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 418,
    ["Evolving Resolutive Process notation"] = 1349,
    ["Expo SDK"] = 421,
    ["Expoot app config"] = 423,
    ["F-Droid Data metadata"] = 429,
    ["FasterCI Configuration"] = 135,
    ["Fence configuration"] = 136,
    FiQuS = 433,
    Firebase = 431,
    ["Flatpak Builder Manifest"] = 434,
    ["FlexGet Config"] = 435,
    ["Flow.json Configurations"] = 1246,
    ["Fossa configuration file"] = 442,
    ["Fossa's fossa-deps file"] = 443,
    ["Foundry VTT - Base package Manifest"] = 437,
    ["Foundry VTT - Module Manifest"] = 438,
    ["Foundry VTT - System Data Template"] = 441,
    ["Foundry VTT - System Manifest"] = 439,
    ["Foundry VTT - World Manifest"] = 440,
    ["Foxx Manifest"] = 137,
    ["Freifunk.de Community API"] = 140,
    ["Frogbot Config"] = 141,
    ["G2P Mapping Configuration"] = 450,
    GAMA = 451,
    ["GCP Blueprint Metadata"] = 454,
    Gaspar = 452,
    ["GatewayCore API Gateway"] = 453,
    ["Gemini CLI settings"] = 455,
    ["GeoJSON.json latest"] = 1162,
    GherKing = 1166,
    ["GitHub Action"] = 465,
    ["GitHub Actions typing"] = 1284,
    ["GitHub CLI configuration"] = 466,
    ["GitHub CLI hosts"] = 467,
    ["GitHub Discussion"] = 468,
    ["GitHub Funding"] = 470,
    ["GitHub Issue Template configuration"] = 471,
    ["GitHub Issue Template forms"] = 472,
    ["GitHub Pages Jekyll"] = 473,
    ["GitHub Prompt"] = 469,
    ["GitHub Secret Scanning"] = 474,
    ["GitHub Workflow"] = 475,
    ["GitHub Workflow Template Properties"] = 476,
    ["GitHub automatically generated release notes configuration"] = 477,
    ["GitLab Agent for Kubernetes configuration"] = 1238,
    ["GitLab Duo Workflow"] = 479,
    GitResume = 481,
    GitVersion = 458,
    ["Gitea Issue Template configuration"] = 461,
    ["Gitea Issue Template forms"] = 462,
    Gitleaks = 459,
    ["Gitpod Configuration"] = 480,
    ["Glamour style"] = 456,
    ["GlazeWM settings"] = 1240,
    ["Global Privacy Control"] = 457,
    Goblet = 1219,
    ["Golangci-lint Configuration"] = 496,
    ["Golangci-lint Custom Plugins Configuration"] = 497,
    ["Google Chrome Related Website Sets"] = 432,
    ["Google Cloud Workflows"] = 305,
    ["Google Digital Assetlinks"] = 1328,
    Goreleaser = 501,
    ["Goreleaser Pro"] = 502,
    Goss = 504,
    ["Gradle Build Cache Node"] = 1112,
    ["Gradle Enterprise"] = 1111,
    ["Grafana 5.x Dashboard"] = 505,
    ["GraphQL Code Generator"] = 510,
    ["GraphQL Config"] = 509,
    ["GraphQL Mesh"] = 508,
    ["GroovyLint configuration"] = 511,
    ["Grunt JSHint task"] = 515,
    ["Grunt Watch task"] = 516,
    ["Grunt base task"] = 517,
    ["Grunt clean task"] = 513,
    ["Grunt copy task"] = 512,
    ["Grunt cssmin task"] = 514,
    HEMTT = 1076,
    Hadolint = 1090,
    Hammerkit = 1122,
    ["Hardware Sentry Configuration"] = 1178,
    ["Hashgraph Online Skill Manifest"] = 7,
    ["HashiCorp Vault"] = 518,
    Hatch = 1091,
    Hayson = 520,
    ["Haystack Pipeline"] = 521,
    ["Hazelcast 5 Configuration"] = 522,
    ["Hecate Input Schema"] = 1339,
    ["Helm Chart.lock"] = 267,
    ["Helm Chart.yaml"] = 266,
    ["Helm Unittest Test Suite"] = 268,
    ["Heloisa Assistant Plugins Marketplace"] = 1415,
    ["Hex file"] = 269,
    ["Home Assistant Integration Manifest"] = 524,
    ["Homer dashboard configuration"] = 525,
    ["Hoverfly Simulation"] = 530,
    Hugo = 1154,
    ["Hugo Theme"] = 1153,
    ["Hulak Configuration"] = 533,
    ["Hyperfoil benchmark configuration"] = 532,
    ["IBM Zapp document"] = 534,
    ["IBM zCodeFormatSettings"] = 535,
    ["IMG Catapult PSP"] = 540,
    ["IVMS101 by CODE Protocol"] = 1239,
    ["Infinispan Configuration"] = 542,
    ["Infinispan Server Configuration"] = 543,
    Infrahub = 544,
    Istanbul = 1182,
    ["JDownloader2 crawler multi-rules"] = 558,
    ["JDownloader2 crawler single-rules"] = 557,
    ["JFrog Applications Config"] = 559,
    ["JFrog File Spec"] = 560,
    ["JFrog Pipelines YML DSL"] = 1188,
    ["JMeter DSL cli config"] = 561,
    JReleaser = 564,
    ["JSON Document Transform"] = 572,
    ["JSON Feed"] = 573,
    ["JSON Resume"] = 848,
    ["JSON Schema Draft 2020-12"] = 1056,
    ["JSON Schema Draft 4"] = 1053,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1221,
    ["JSON Schema Draft 7"] = 1054,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1222,
    ["JSON Schema Draft 8 (2019-09)"] = 1055,
    ["JSON-API"] = 571,
    ["JSON-e templates"] = 1119,
    ["JSON-stat 2.0"] = 1049,
    JSONPatch = 575,
    ["JSR Package Config (jsr.json)"] = 565,
    Jarl = 1355,
    Jasmine = 552,
    Jekyll = 553,
    ["Jenkins X Pipelines"] = 554,
    ["Jenkins X Requirements"] = 555,
    Jest = 556,
    Jocker = 562,
    ["Jovo Language Models"] = 563,
    Jsontron = 576,
    ["Jujutsu (jj) VCS config"] = 1341,
    ["KIMMDY config file"] = 587,
    ["KODE/CI build.yaml"] = 1184,
    ["KSP-AVC"] = 1050,
    ["KSP-CKAN"] = 1051,
    ["KSP-NetKAN"] = 1052,
    KSY = 1251,
    KSail = 448,
    ["KYA Manifest"] = 1252,
    ["Karakum configuration file"] = 444,
    Kas = 579,
    ["Kestra flow file"] = 588,
    ["Keycloak REST API"] = 1191,
    ["Knative Functions - func.yaml"] = 445,
    Knip = 446,
    ["Knip JSONC"] = 447,
    ["Knowledge Unit"] = 596,
    ["Kometa (nightly) config file"] = 590,
    ["Kometa config file"] = 589,
    ["Kong DBLess config"] = 1185,
    KrakenD = 591,
    ["Kubri Configuration"] = 599,
    LOOBin = 615,
    ["Lake configuration file"] = 1344,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 310,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 311,
    ["Landing Zone Accelerator on AWS - Global Config"] = 312,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 313,
    ["Landing Zone Accelerator on AWS - Network Config"] = 314,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 315,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 316,
    ["Landing Zone Accelerator on AWS - Security Config"] = 317,
    ["Lando (landofile)"] = 127,
    ["LangGraph Platform configuration"] = 1263,
    ["Language configuration"] = 1262,
    Lefthook = 604,
    ["Liferay client-extension.yaml"] = 611,
    ["LinkML Metamodel"] = 613,
    Liquibase = 1129,
    ["Liquibase Flow File"] = 1130,
    ["Lively Properties"] = 614,
    ["Lobe AI Agent"] = 129,
    Loki = 130,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 658,
    ["MS2Rescore Configuration"] = 666,
    ["MSTest testconfig.json"] = 667,
    ["Madge configuration"] = 621,
    ["Madness (madness.yml)"] = 1202,
    ["Mado configuration"] = 622,
    ["Maestro Flow"] = 623,
    ["Mail Servers Configuration"] = 1376,
    ["MapEHR Mapping"] = 624,
    Markdownlint = 1133,
    ["Mason Registry"] = 1136,
    ["MegaLinter Custom Flavor"] = 627,
    ["MegaLinter configuration"] = 626,
    ["MegaLinter descriptor"] = 628,
    Melange = 1229,
    ["Meltano project definition"] = 629,
    ["Mergify Configuration"] = 668,
    ["Mermaid config"] = 2,
    ["Metadata for a Bazel module"] = 630,
    ["Metadata for a Cinnamon spice"] = 1280,
    ["Metatype Configuration"] = 631,
    ["MetricsHub Configuration"] = 632,
    ["MetricsHub Connector Configuration"] = 633,
    ["Micro Editor Syntax"] = 1212,
    ["Microsoft Band Web Tile"] = 634,
    ["Microsoft RulesEngine workflow rules"] = 1267,
    ["Microsoft RulesEngine workflow rules list"] = 1268,
    ["Minecraft Custom Main Menu Mod"] = 1230,
    ["Minecraft Data Pack Advancement"] = 636,
    ["Minecraft Data Pack Biome"] = 637,
    ["Minecraft Data Pack Configured Carver"] = 638,
    ["Minecraft Data Pack Damage Type"] = 639,
    ["Minecraft Data Pack Dimension"] = 641,
    ["Minecraft Data Pack Dimension Type"] = 640,
    ["Minecraft Data Pack Item Modifier"] = 642,
    ["Minecraft Data Pack Loot Table"] = 643,
    ["Minecraft Data Pack Metadata"] = 644,
    ["Minecraft Data Pack Predicate"] = 645,
    ["Minecraft Data Pack Recipe"] = 646,
    ["Minecraft Data Pack Tag"] = 647,
    ["Minecraft Data Pack Template Pool"] = 648,
    ["Minecraft Data Pack Trim Material"] = 653,
    ["Minecraft Data Pack Trim Pattern"] = 654,
    ["Minecraft Resource Pack Lang"] = 649,
    ["Minecraft Resource Pack Particle"] = 650,
    ["Minecraft Resource Pack Texture Mcmeta"] = 652,
    ["Minecraft Resourcepack Sounds"] = 651,
    ["MockServer Expectation"] = 660,
    ["MockServer Expectations"] = 661,
    ModuleAssembler = 656,
    ["Monade CLI Stack Configuration"] = 671,
    ["MongoDB Atlas Search Index Definition"] = 1183,
    ["Monika Configuration"] = 1181,
    ["Monoweave Configuration"] = 665,
    ["Motif config"] = 1072,
    MultiQC = 1321,
    ["NOX Framework (Service)"] = 693,
    ["Netin Diagnostic System Template"] = 1140,
    ["Netlify config"] = 674,
    ["Network-as-Code Data Model"] = 675,
    ["Next Gen UI Agent A2A Server Configuration"] = 676,
    ["Next Gen UI Agent Configuration"] = 678,
    ["Next Gen UI Agent MCP Server Configuration"] = 677,
    ["Nightwatch.js"] = 685,
    ["Nika workflow"] = 690,
    ["Node.js configuration"] = 1077,
    ["NueJS configuration file"] = 698,
    ["Nuitka Package Config"] = 1244,
    ["Nullstone config"] = 700,
    ["ODGS Data Rules"] = 707,
    ["ODGS Ontology Graph"] = 708,
    ["ODGS Standard Metrics"] = 706,
    ["OKF Graph"] = 1416,
    ["ONe's changelog entry"] = 722,
    ["ONe's service descriptor"] = 721,
    ["ORT Server repository environment configuration"] = 733,
    ["OSCAL Assessment Plan (AP)"] = 735,
    ["OSCAL Assessment Results (AR)"] = 736,
    ["OSCAL Catalog"] = 737,
    ["OSCAL Component Definition (CDef)"] = 738,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 739,
    ["OSCAL Profile"] = 740,
    ["OSCAL System Security Plan (SSP)"] = 741,
    ["OSS Review Toolkit configuration"] = 742,
    ["OSS Review Toolkit curation"] = 743,
    ["OSS Review Toolkit package configuration"] = 744,
    ["OSS Review Toolkit project package manager definition"] = 745,
    ["OSS Review Toolkit repository configuration"] = 746,
    ["OSS Review Toolkit resolutions"] = 747,
    ["October CMS columns"] = 704,
    ["October CMS fields"] = 705,
    ["Oh My Posh"] = 710,
    Okteto = 711,
    ["Ona Tasks and Services"] = 713,
    Opctl = 1075,
    ["Open Data Contract Standard (ODCS)"] = 726,
    ["Open Data Product Standard (ODPS)"] = 727,
    ["Open Know-How"] = 1326,
    ["Open Pentest Format"] = 728,
    OpenDecree = 1390,
    ["OpenDecree Configuration"] = 1391,
    ["OpenRewrite Resource"] = 724,
    OpenSRM = 729,
    OpenStatus = 1337,
    ["OpenTelemetry Declarative Configuration"] = 725,
    ["OpenUtau character yaml"] = 718,
    ["OpenUtau ustx"] = 719,
    ["OpenWeather Current Weather API"] = 1118,
    ["OpenWeather Road Risk API"] = 1117,
    ["Ory Hydra configuration"] = 531,
    ["Ory Keto configuration"] = 595,
    ["Ory Kratos configuration"] = 734,
    ["Ory Oathkeeper configuration"] = 702,
    ["Outblocks App configuration"] = 731,
    ["Outblocks database table"] = 732,
    ["Outblocks project configuration"] = 730,
    PDM = 755,
    POPxf = 767,
    ["POPxf Correlations"] = 768,
    ["PRML manifest"] = 775,
    Packer = 751,
    PactSpec = 752,
    Panache = 753,
    Pantsbuild = 1198,
    ["Paper paper-plugin.yml"] = 754,
    ["Pipeline component"] = 1131,
    ["Platform.sh application"] = 13,
    ["Platform.sh routes"] = 14,
    ["Platform.sh services"] = 15,
    ["Plex Prerolls"] = 765,
    ["PocketMine plugin.yml"] = 762,
    ["Podman Desktop Extension"] = 1410,
    ["Postman collection"] = 771,
    ["Power Pages Configuration"] = 1338,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1283,
    ["ProActions AI-Kit Configuration"] = 783,
    ["ProActions AI-Kit Configuration for Menus"] = 785,
    ["ProActions AI-Kit Configuration for Sections"] = 787,
    ["ProActions AI-Kit Configuration for Services"] = 784,
    ["ProActions AI-Kit Configuration for Steps"] = 788,
    ["ProActions AI-Kit Configuration for Templates"] = 786,
    ["Problem object RFC9457"] = 1227,
    ["Problem package format"] = 789,
    ["Problem package generators"] = 790,
    ["Problem package submissions"] = 791,
    ["Problem package test group metadata"] = 792,
    Pterodactyl = 1177,
    ["Pull Request Labeler"] = 809,
    Pulumi = 817,
    ["PyGTA Config"] = 813,
    PyProject = 818,
    Pylock = 1329,
    Pyright = 819,
    ["Python script metadata"] = 1323,
    ["QType AI DSL"] = 822,
    Qgoda = 821,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1402,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1400,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1406,
    ["Qlik Talend Cloud Pipeline - Project"] = 1398,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1401,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1403,
    ["Qlik Talend Cloud Pipeline - Task"] = 1399,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1405,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1404,
    Qodana = 1150,
    ["Qt Creator workspace file"] = 1260,
    ["Quali Torque Blueprint Spec 2"] = 1175,
    ["QueryFirst config file"] = 1194,
    ["QuikRun Configuration"] = 1407,
    ["Qwen Code Settings"] = 1387,
    ["RKE Cluster Configuration JSON"] = 1128,
    ["RKE Cluster Configuration YAML"] = 1127,
    RadioHound = 812,
    ["Raid Profile"] = 1388,
    ["Raid Repo Configuration"] = 1389,
    Railpack = 824,
    Railway = 823,
    ["Rancher Fleet"] = 814,
    ["Rattler-build"] = 825,
    Ray = 1089,
    ["Read the Docs"] = 816,
    ["Red-DiscordBot Cog"] = 832,
    ["Red-DiscordBot Cog Repo"] = 833,
    ["Red-DiscordBot Trivia"] = 834,
    ["Releasaurus Config"] = 10,
    ReleaseKit = 9,
    ["Render Blueprints"] = 1126,
    RenderCV = 852,
    Renovate = 849,
    ["Renovate global configuration"] = 850,
    ["Renovate inherited configuration"] = 851,
    ["Replit config"] = 840,
    Restate = 1316,
    ["Revel Digital Gadget Definition File"] = 1340,
    RoadRunner = 854,
    ["Robust Station Image"] = 1346,
    Rockcraft = 855,
    ["Roo Coder Custom Modes"] = 856,
    Rubocop = 845,
    ["Rudder techniques"] = 1234,
    Ruff = 846,
    ["Rust Project"] = 847,
    ["Rust toolchain"] = 861,
    ["SDMX data message"] = 888,
    ["SDMX metadata message"] = 887,
    ["SDMX structure message"] = 886,
    ["SIL Kit Participant Configuration"] = 899,
    ["SIL Kit Registry Configuration"] = 900,
    ["SPDX 2.3"] = 942,
    SWADL = 958,
    ["Safebox Config"] = 1189,
    ["Sapphire CLI Config"] = 864,
    ["SauceCTL Configuration"] = 1137,
    Scarb = 884,
    ["Schema Catalog"] = 879,
    ["Scoop manifest"] = 885,
    ["Secure SDLC Evidence Bundle"] = 889,
    ["Semantic Data Fabric (SDF) file"] = 890,
    ["Semgrep Rule"] = 892,
    ["Serenity Code Generator (Sergen)"] = 893,
    ["Serverless Framework Configuration"] = 1144,
    ["Serverless Workflow"] = 1146,
    ["Settings for a Cinnamon spice"] = 1279,
    ["Settings.paf"] = 895,
    ["Shopware 6 Configuration"] = 1147,
    ["Shopware CLI Extension Store Configuration"] = 1148,
    ["Shopware CLI Project Store Configuration"] = 1149,
    ["Sigma Detection Rule"] = 897,
    ["SigmaCV CV"] = 5,
    ["Sigrid scope configuration file"] = 898,
    ["SkyPilot Task JSON"] = 1235,
    ["Slack app manifest"] = 905,
    ["Slang Server Configuration"] = 1414,
    Snapcraft = 907,
    ["Solarxy project config"] = 910,
    Solidarity = 911,
    ["Solution filters"] = 912,
    ["Source Maps v3"] = 913,
    Sourcery = 914,
    ["Spack bootstrap.yaml"] = 915,
    ["Spack cdash.yaml"] = 916,
    ["Spack ci.yaml"] = 917,
    ["Spack compilers.yaml"] = 918,
    ["Spack concretizer.yaml"] = 919,
    ["Spack config.yaml"] = 920,
    ["Spack definitions.yaml"] = 921,
    ["Spack develop.yaml"] = 922,
    ["Spack env_vars.yaml"] = 923,
    ["Spack environment"] = 929,
    ["Spack include.yaml"] = 924,
    ["Spack mirrors.yaml"] = 925,
    ["Spack modules.yaml"] = 926,
    ["Spack packages.yaml"] = 927,
    ["Spack repos.yaml"] = 928,
    ["Spack toolchains.yaml"] = 930,
    ["Spack upstreams.yaml"] = 931,
    ["Spack view.yaml"] = 932,
    ["Speakeasy Generation Config File"] = 936,
    ["Speakeasy Lint Configuration File"] = 933,
    ["Speakeasy Test Generation Configuration File"] = 934,
    ["Speakeasy Workflow File"] = 935,
    SpecIF = 937,
    ["Specmatic Configuration"] = 938,
    ["Specpin spec file"] = 3,
    ["Sponge Mixin configuration"] = 939,
    ["Spotlight Ruleset"] = 940,
    StackBlitz = 946,
    ["StackHawk Scanner Configuration"] = 1143,
    Stale = 947,
    Starfish = 948,
    ["Starlake Data Pipeline"] = 1115,
    Starship = 949,
    ["Statamic Blueprint"] = 950,
    ["Stella configuration file"] = 951,
    ["Streamlit configuration file"] = 952,
    ["Stryker Mutator"] = 955,
    ["StyleCop Analyzers Configuration"] = 956,
    ["Stylelint (.stylelintrc)"] = 957,
    ["Stylua Config"] = 1330,
    ["Sublime Syntax"] = 1190,
    ["Subsquid squid manifest"] = 1237,
    ["Swagger API 2.0"] = 959,
    ["Synadia Connect Component"] = 960,
    TSON = 998,
    TSTyche = 999,
    ["TYPO3 Vendor Bundler config"] = 1005,
    ["Tab data for a LinUtil"] = 1286,
    ["Tab list for a LinUtil"] = 1285,
    Tach = 961,
    ["Tach Domain"] = 962,
    Talhelper = 964,
    ["Talisman configuration"] = 965,
    Taplo = 1331,
    ["Taskfile config"] = 1120,
    Taurus = 966,
    Tauticord = 967,
    ["Tekton Pipeline"] = 1359,
    ["Tekton PipelineRun"] = 1360,
    ["Tekton Task"] = 1357,
    ["Tekton TaskRun"] = 1358,
    Telefonistka = 1317,
    ["Terrateam config"] = 1343,
    ["TestEnvironment.json"] = 979,
    ["TextMate Grammar"] = 978,
    Threagile = 973,
    ["Tier.run pricing.json"] = 970,
    Tikibase = 971,
    Tombi = 976,
    ["Traefik v2"] = 982,
    ["Traefik v2 File Provider"] = 983,
    ["Traefik v3"] = 984,
    ["Traefik v3 File Provider"] = 985,
    ["Travis CI (.travis.yml)"] = 981,
    Treefmt = 507,
    Trident = 1313,
    Trivy = 988,
    ["TrueScript for *.tscript files"] = 989,
    ["Tugboat QA config.yml"] = 1310,
    TunnelHub = 1225,
    Turborepo = 980,
    Tycho = 1274,
    Tye = 1151,
    ["Tyk Gateway - Open Source v5.7+"] = 1322,
    ["UET BuildConfig.json"] = 1195,
    ["UI5 Manifest"] = 1011,
    ["UNCORS configuration"] = 1016,
    ["UTAM Page Object"] = 1014,
    ["Ubuntu Server Autoinstall"] = 1009,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1314,
    ["Uniswap Token List"] = 1100,
    ["Universal Schedule Format"] = 1017,
    ["Unreal Engine Uplugin"] = 1196,
    ["Unreal Engine Uproject"] = 1197,
    ["UpCloud CLI (upctl) configuration"] = 1315,
    ["Updatecli Compose"] = 1159,
    ["Updatecli Policy Manifest"] = 1160,
    ["Updatecli Policy Metadata"] = 1161,
    Uplift = 1193,
    ["Upsun config"] = 12,
    ["User Journey Map"] = 1125,
    V2Ray = 1165,
    ["VSCode Code Snippets"] = 293,
    ["VSIX CLI publishing"] = 1036,
    Vector = 1019,
    ["Vela Pipeline Configuration"] = 1022,
    Vercel = 292,
    ["Version Bumper config"] = 1025,
    Vespertide = 1364,
    ["Vespertide Migration"] = 1365,
    ["Vespertide Model"] = 1366,
    ["Viash Component Config"] = 1319,
    ["Viash Package Config"] = 1320,
    Visivo = 1223,
    Vogi = 1030,
    ["WP-CLI"] = 1046,
    Wake = 1312,
    ["Waku Config"] = 1289,
    ["Web App Manifest"] = 1042,
    ["Web types"] = 1045,
    WebExtensions = 1041,
    ["Webman package recipe"] = 1171,
    ["Windows Package Manager Installer Manifest"] = 1097,
    ["Windows Package Manager Locale Manifest"] = 1098,
    ["Windows Package Manager Singleton Manifest"] = 1096,
    ["WireMock CLI import configuration"] = 1295,
    ["WireMock CLI local service configuration"] = 1294,
    ["WireMock message stub mapping"] = 1293,
    ["WireMock stub mapping"] = 1292,
    ["Woodpecker pipeline config"] = 1139,
    ["Wrangler CLI"] = 1047,
    ["XenForo add-on manifest"] = 1048,
    ["Xstate Machine"] = 1157,
    ["Yandex Workflow Language"] = 1281,
    ["Yarn Config (.yarnrc.yml)"] = 1113,
    ["Yippee-Ki-JSON configuration YML"] = 1104,
    ["YouTrack App"] = 1278,
    ["Zarf Package Configuration"] = 1345,
    ["Zerops import file"] = 1266,
    ["Zola Configuration"] = 1356,
    abtop = 33,
    act3 = 1394,
    actionlint = 43,
    ["aerleon.yml"] = 27,
    ["amplify.yml"] = 20,
    ["amxx-builder manifest"] = 1409,
    ["angular.json"] = 48,
    apko = 1228,
    ...
    ["behat.yml"] = 164,
    ["bigquery-table"] = 152,
    ["bioimageio resource description"] = 1245,
    ...
    ["cargo-nextest repository configuration"] = 679,
    ["cargo-nextest user configuration"] = 680,
    ["ccmod.json"] = 1290,
    changelogging = 1257,
    ["chezmoi configuration"] = 197,
    ["chisel-slices.json"] = 319,
    ["chrome-extension-locales-messages.json"] = 300,
    ["chutzpah.json"] = 301,
    cibuildwheel = 202,
    ["clang-format (.clang-format)"] = 1163,
    ["clang-tidy"] = 275,
    clangd = 274,
    clib = 276,
    ["cloud-init: cloud-config userdata"] = 278,
    ["cloud-sdk-pipeline-configuration"] = 303,
    ["cloudbuild.json"] = 304,
    cloudify = 277,
    cmakefmt = 220,
    ["cmdx.yaml"] = 113,
    ...
    ["commands.json"] = 296,
    ["commit-check"] = 322,
    ["commitlint (.commitlintrc)"] = 1099,
    ["committed.toml"] = 323,
    ["compile_commands.json"] = 295,
    ["compilerconfig.json"] = 294,
    ["completely.yml"] = 1201,
    ["component-detection-manifest.json"] = 326,
    ["component.json"] = 325,
    ["composer.json"] = 324,
    ["conda-forge"] = 206,
    ["config.yaml"] = 815,
    ["contentmanifest.json"] = 302,
    ["contribute.json"] = 327,
    ["cosmos.config.json"] = 298,
    ["crowdin.yml"] = 328,
    crucible = 332,
    ["ctfd-setup configuration file"] = 1302,
    ["custom-elements.json"] = 1215,
    ["cypress.json"] = 333,
    ["dacier.yml"] = 1397,
    ["datalogic-scan2deploy-android"] = 343,
    ["datalogic-scan2deploy-ce"] = 344,
    ...
    ["ddev-global"] = 345,
    ["ddev-project"] = 346,
    ["debugsettings.json"] = 347,
    ["dependabot-v2.json"] = 351,
    ["dependabot.json"] = 350,
    ["deployed-cli"] = 1156,
    ["devcontainer-feature.json"] = 286,
    ["devcontainer.json"] = 285,
    devinit = 1106,
    ["devspace.yaml"] = 1179,
    djlint = 1107,
    ["docker bake"] = 357,
    ["docker sequencer"] = 358,
    ["docker-compose.yml"] = 1105,
    ["dockerd.json"] = 355,
    ["dotnet Release Index manifest"] = 370,
    ["dotnet-tools.json"] = 371,
    ["dotnetcli.host.json"] = 372,
    ["dprint.json"] = 373,
    ["drone.json"] = 374,
    ["dss-2.0.0.json"] = 376,
    ["dstack configuration"] = 377,
    ["dtool dataset metadata"] = 1297,
    ["dvc.yaml"] = 379,
    ["ecosystem.json"] = 384,
    ["editorconfig-checker"] = 386,
    eksctl = 387,
    ["electron-builder configuration file"] = 413,
    ["epr-manifest.json"] = 412,
    ["estampo.toml"] = 411,
    ["evcc.yaml"] = 414,
    ["ezd task runner"] = 425,
    ["fabric.mod.json"] = 428,
    ["first-timers-bot"] = 436,
    ["flagd flag configuration"] = 138,
    ["fly.io Configuration"] = 139,
    fulibWorkflows = 1138,
    ["function.json"] = 449,
    ["gRPC API Gateway & OpenAPI Config"] = 22,
    ["gematik health care insurance list"] = 1308,
    ["gematik health care patient list"] = 1305,
    ["gematik health care provider institution list"] = 1307,
    ["gematik health care provider list"] = 1306,
    ["gematik tiger test environment configuration"] = 1309,
    ["gh-dash"] = 463,
    ["gha-doctor"] = 464,
    ["git-cliff"] = 460,
    ["git-town.toml"] = 1354,
    ["github-settings-as-code"] = 841,
    ["gitlab-ci"] = 478,
    ["global.json"] = 495,
    ["glslint config"] = 1,
    ["go-feature-flag Flag Configuration"] = 499,
    ["gojo.yaml"] = 500,
    gollama = 498,
    ["hassette.toml"] = 523,
    ["haxelib.json"] = 519,
    ...
    ["ide.host.json"] = 536,
    ["ifstate.yaml"] = 537,
    ["imageoptimizer.json"] = 538,
    ["importmap.json"] = 541,
    ["index.toml (packwiz)"] = 1411,
    instant_python_config = 545,
    instant_python_custom_project = 546,
    intlayer = 547,
    ["ioBroker Configuration"] = 548,
    ["ioBroker JSON UI"] = 549,
    ["ioBroker Package manifest"] = 550,
    ["ixpect.conf.yaml"] = 551,
    ["ize.toml"] = 1192,
    ["jsconfig.json"] = 577,
    ["jscpd Configuration"] = 1176,
    jsdoc = 1088,
    ["k3d.yaml"] = 578,
    ["k9s aliases.yaml"] = 580,
    ["k9s cluster-config.yaml"] = 582,
    ["k9s config.yaml"] = 581,
    ["k9s hotkeys.yaml"] = 583,
    ["k9s plugins.yaml"] = 584,
    ["k9s skin.yaml"] = 585,
    ["k9s views.yaml"] = 586,
    ["kind cluster"] = 600,
    ["kontinuous-config.yaml"] = 598,
    ["kontinuous-values.yaml"] = 597,
    ["kustomization.yaml"] = 601,
    ["label-commenter-config.yml"] = 602,
    ["latexindent configuration"] = 128,
    ["launchsettings.json"] = 603,
    lazydocker = 1214,
    lazygit = 1213,
    ["lego.json"] = 605,
    ["lerna.json"] = 606,
    ["lgtm.yml"] = 607,
    ["liblab.config.json"] = 608,
    ["libman.json"] = 609,
    ["license-report-config.json"] = 610,
    ["linkinator.config.json"] = 612,
    ["lint-staged (.lintstagedrc)"] = 1065,
    ["local.settings.json"] = 617,
    ["localazy.json"] = 618,
    ["lotus.yaml"] = 616,
    ["lsd colors"] = 132,
    ["lsd config"] = 131,
    ...
    lychee = 1064,
    ["macro.json"] = 1180,
    ["markdown-link-check"] = 1134,
    maturin = 1135,
    mboats = 1142,
    memnex = 1395,
    ["micro-settings.json"] = 1207,
    ["mimetypes.json"] = 635,
    ["mirrord config"] = 1068,
    ["misata.yaml"] = 1067,
    mise = 1069,
    ["mkdocs.yml"] = 655,
    ["mockd.yaml"] = 659,
    ["mod.pw.toml (packwiz)"] = 1412,
    ["modelparams.dev Model"] = 662,
    ["models CLI"] = 663,
    ["monospace.yml"] = 664,
    ["moon.yml"] = 1291,
    ["mprocs Configuration file"] = 1261,
    ["mrdocs.yml"] = 657,
    ["mta.yaml"] = 1070,
    ["mtad.yaml"] = 1071,
    ["mycode.json"] = 672,
    nFPM = 684,
    ["napari plugin manifest"] = 673,
    neoload = 1083,
    ["nest-cli"] = 687,
    ["nexus-rpc-gen"] = 1381,
    ["nf-core module environment.yml"] = 681,
    ["nf-core module meta.yml"] = 682,
    ["nf-core subworkflow meta.yml"] = 683,
    ["ninjs (News in JSON)"] = 686,
    ["nitro.json"] = 1082,
    ["nixd configuration"] = 1233,
    ["nlu.json"] = 688,
    ["nodemon.json"] = 691,
    ["noodl config"] = 1141,
    ["notebook.mod.json"] = 692,
    now = 1078,
    ["npm-badges"] = 695,
    ["nswag.json"] = 699,
    ntangle = 701,
    ["nuclei-template.yaml"] = 696,
    ["nuget-project.json"] = 697,
    ["ocelot.json"] = 703,
    ogen = 709,
    ["omnisharp.json"] = 712,
    openHAB = 1367,
    ...
    oxfmt = 1377,
    oxlint = 1378,
    ["pack.toml (packwiz)"] = 1413,
    ["package.json"] = 748,
    ["package.manifest"] = 750,
    ["package.yaml"] = 749,
    ["partial-black.json"] = 165,
    ["partial-fastapi.json"] = 166,
    ["partial-pixi.json"] = 760,
    ["partial-scheduled.json"] = 167,
    ["pattern.json"] = 758,
    ["petstore-v1.0"] = 1187,
    pgap_yaml_input_reader = 756,
    pgrls = 757,
    pgxgen = 1371,
    pitcms = 1374,
    ["pixi.toml"] = 759,
    ["plagiarize-me.yaml"] = 764,
    ["plagiarize.yaml"] = 763,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1298,
    ["podbard.yaml"] = 766,
    ["portman.json"] = 769,
    ["prefect.toml"] = 778,
    ["prefect.yaml"] = 779,
    ...
    ["prettierrc.json"] = 781,
    ["prisma.yml"] = 782,
    ["project-1.0.0-beta3.json"] = 794,
    ["project-1.0.0-beta4.json"] = 795,
    ["project-1.0.0-beta5.json"] = 796,
    ["project-1.0.0-beta6.json"] = 797,
    ["project-1.0.0-beta8.json"] = 798,
    ["project-1.0.0-rc1.json"] = 799,
    ["project-1.0.0-rc2.json"] = 800,
    ["project.json"] = 793,
    ["project.owasp.yaml"] = 801,
    ["prometheus-alertmanager.json"] = 805,
    ["prometheus.json"] = 802,
    ["prometheus.rules.json"] = 803,
    ["prometheus.rules.test.json"] = 804,
    ["proxies.json"] = 806,
    ["publiccode.yml"] = 807,
    ["pubspec.yaml"] = 808,
    ["pyrseas-0.8.json"] = 811,
    pytest = 820,
    ["quilt.mod.json"] = 1208,
    ["rc3 auth"] = 826,
    ["rc3 collection"] = 827,
    ...
    ["rc3 settings"] = 831,
    ["registry.yaml"] = 61,
    ["release drafter"] = 1084,
    ["release-hub.json"] = 8,
    ["release-please-config.json"] = 836,
    ["release-please-manifest.json"] = 837,
    ["release-plz.toml"] = 838,
    ["renv.lock"] = 853,
    ["reposets Configuration"] = 842,
    ["reposets Credentials"] = 843,
    ["revola.json"] = 6,
    ["rivet.json"] = 1232,
    ["rivet.yaml (legacy)"] = 1231,
    rumdl = 858,
    runny = 857,
    runspec = 1396,
    rustfmt = 859,
    ...
    samt = 862,
    samtrc = 863,
    ["sarif-1.0.0.json"] = 865,
    ["sarif-2.0.0.json"] = 866,
    ["sarif-2.1.0"] = 876,
    ["sarif-2.1.0-rtm.2"] = 867,
    ["sarif-2.1.0-rtm.3"] = 869,
    ["sarif-2.1.0-rtm.4"] = 871,
    ["sarif-2.1.0-rtm.5"] = 873,
    ["sarif-2.1.0-rtm.6"] = 874,
    ["sarif-external-property-file-2.1.0"] = 877,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 868,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 870,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 872,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 875,
    ["scalingo.json configuration"] = 878,
    ["schema.org - Action"] = 880,
    ["schema.org - ContactPoint"] = 881,
    ["schema.org - Place"] = 882,
    ["schema.org - Thing"] = 883,
    ["secrethub.yml"] = 1210,
    ["semantic-release"] = 891,
    ["servicehub.config.json"] = 1059,
    ["servicehub.service.json"] = 1058,
    ["settings.job"] = 894,
    ["sfdx-hardis configuration"] = 896,
    ["shard.yml"] = 1248,
    ["size-limit configuration"] = 901,
    ["skaffold.yaml"] = 1132,
    ["skill-map plugin extension manifest"] = 902,
    ["skill-map project settings"] = 903,
    ["skill-map provider kind"] = 904,
    ["skyuxconfig.json"] = 906,
    ["snowflake-config"] = 908,
    ["snowflake-connections"] = 909,
    ["spicepod.yaml"] = 1269,
    ["sqlc configuration"] = 943,
    ["stripe-app-local.json"] = 954,
    ["stripe-app.json"] = 953,
    swcrc = 1116,
    ["task.json"] = 963,
    taskcat = 1079,
    ["template.json"] = 968,
    ["templatsources.json"] = 969,
    ["text2confl config"] = 1379,
    ["theme.json"] = 972,
    ["tizen_workspace.json"] = 974,
    tldr = 975,
    ["tm_devices configuration file"] = 1336,
    tmuxinator = 1062,
    tox = 977,
    ["transcend.yml"] = 986,
    ["tree-sitter grammar.json"] = 506,
    ["trime.yaml"] = 987,
    ["trunk.yaml"] = 990,
    ["ts-force-config.json"] = 996,
    tsbuild = 991,
    ["tsconfig.json"] = 992,
    ["tsd.json"] = 993,
    ["tsdoc.json"] = 994,
    ...
    v8r = 1040,
    vcluster = 1255,
    ["vcpkg configuration file"] = 291,
    ["vcpkg manifest file"] = 290,
    ["vega-lite.json"] = 1021,
    ["vega.json"] = 1020,
    ["venvironment.yaml"] = 1023,
    ["venvplus.yaml"] = 1024,
    version = 1318,
    ["version.json"] = 1026,
    ["vhwdebugger-binding.yaml"] = 1028,
    ["vim-addon-info"] = 1029,
    ["vs-2017.3.host.json"] = 1032,
    ["vs-nesting.json"] = 1033,
    ["vsls.json"] = 1031,
    ["vss-extension.json"] = 1037,
    vtcfg = 1324,
    ["vtesttree.yaml"] = 1038,
    ["vtestunit.yaml"] = 1039,
    ["warp-keysets.json"] = 1216,
    ["warp-themes.json"] = 1217,
    ["warp-workflows.json"] = 1218,
    ["webhint.io"] = 1172,
    ["webjobpublishsettings.json"] = 1044,
    ["webjobs-list.json"] = 1043,
    ["well-known-fursona"] = 1256,
    ["xs-app.json"] = 1074,
    ["xunit.runner.json"] = 1057,
    yamlfmt = 1101,
    yamllint = 1102,
    ["yap.json"] = 1103,
    ["zerops.yml"] = 1265,
