...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 950,
    [".nodehawkrc"] = 589,
    [".npmpackagejsonlintrc"] = 593,
    [".omletrc"] = 1129,
    [".phrase.yml"] = 668,
    [".phraseapp.yml"] = 669,
    [".pmbot.yml"] = 653,
    [".postcssrc"] = 663,
    [".powerpages-web-template-manifest"] = 665,
    [".pre-commit-config.yml"] = 666,
    [".pre-commit-hooks.yml"] = 667,
    [".putout.json"] = 702,
    [".rehyperc"] = 727,
    [".remarkrc"] = 731,
    [".sprite files"] = 825,
    ...
    [".vsconfig"] = 914,
    [".vsext"] = 915,
    ["1Password SSH Agent Config"] = 10,
    ["@factorial/drupal-breakpoints-css"] = 17,
    ["A micro editor config"] = 535,
    ABCClinicalDemandForecast = 26,
    ABCInventoryModuleData = 25,
    ABCSupplyPlan = 27,
    ["ACP Attempts"] = 28,
    ["ACP Cache File"] = 29,
    ["ACP Configuration File"] = 30,
    ["ACP Primer"] = 31,
    ["ACP Sync"] = 32,
    ["ACP Variables File"] = 33,
    AIConfig = 34,
    ["AMX Muse Program Descriptor"] = 1177,
    ["API Builder"] = 985,
    ["AVA Configuration"] = 1048,
    ["AWS AppConfig Feature Flags-v1"] = 68,
    ["AWS CDK cdk.json"] = 266,
    ["AWS CloudFormation"] = 267,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 268,
    ["AWS Copilot Manifest"] = 1216,
    ["AWS SAM CLI Samconfig"] = 269,
    ["Adobe UXP Manifest"] = 1111,
    ["Aerleon Network & Service Definitions"] = 20,
    ["Aerleon Policy"] = 21,
    ["AgentCore CLI"] = 1256,
    Aider = 1206,
    Air = 23,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1227,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1226,
    ["Airlock Microgateway"] = 35,
    ["Alacritty Configuration"] = 1020,
    ["All Contributors configuration file"] = 1074,
    ["Ansible Argument Specs"] = 406,
    ["Ansible Collection Galaxy"] = 413,
    ["Ansible Execution Environment"] = 403,
    ["Ansible Inventory"] = 412,
    ["Ansible Meta"] = 404,
    ["Ansible Meta Runtime"] = 405,
    ["Ansible Navigator Configuration"] = 415,
    ["Ansible Playbook"] = 410,
    ["Ansible Requirements"] = 407,
    ["Ansible Rulebook"] = 411,
    ["Ansible Tasks File"] = 409,
    ["Ansible Vars File"] = 408,
    ["Ansible-lint Configuration"] = 414,
    Any = 1139,
    ["AnyWork Automation Configuration"] = 16,
    ["Apollo Router"] = 986,
    ["App config Spotify Backstage"] = 39,
    ["Applicant Profile Protocol"] = 13,
    ["Application Accelerator"] = 11,
    ["Application list for a WinUtil"] = 1156,
    ArchitectFX = 1161,
    ["Argo CD"] = 54,
    ["Argo Events"] = 55,
    ["Argo Workflows"] = 56,
    AssemblyScript = 59,
    AsyncAPI = 62,
    ["AsyncAPI Tool File"] = 63,
    ["Atmos Manifests"] = 64,
    ["Aurora Agile Meta-Framework"] = 65,
    AutoAPICase = 1084,
    ["Avro Avsc"] = 66,
    ["Awesome Repositories"] = 67,
    ["Azure Container App template for defining an immutable revision"] = 70,
    ["Azure DevOps extension manifest"] = 73,
    ["Azure Device Update for IoT Hub import manifest"] = 71,
    ["Azure Device Update for IoT Hub update manifest"] = 72,
    ["Azure IoT Edge deployment"] = 76,
    ["Azure IoT Edge deployment template"] = 77,
    ["Azure IoT EdgeAgent deployment"] = 74,
    ["Azure IoT EdgeHub deployment"] = 75,
    ["Azure IoT Operations Wasm Graph Config"] = 1225,
    ["Azure IoT Operations connector metadata"] = 1222,
    ["Azure Landing Zones Library archetype definition"] = 81,
    ["Azure Landing Zones Library archetype override"] = 82,
    ["Azure Landing Zones Library architecture definition"] = 80,
    ["Azure Landing Zones Library metadata"] = 78,
    ["Azure Landing Zones Library policy default values"] = 79,
    ["Azure Pipelines"] = 113,
    ["Azure Static Web Apps CLI configuration file"] = 829,
    ["Azure Static Web Apps configuration file"] = 828,
    BMML = 1244,
    ["BOSH CPI Config"] = 139,
    ["BOSH Deploy Config"] = 140,
    ["BX CI"] = 160,
    ["Bacon config"] = 5,
    ["Barba-CV"] = 83,
    ["Bashly (bashly.yml)"] = 1078,
    ["Bashly Settings (bashly-settings.yml)"] = 1079,
    Bento = 1243,
    ["Better Code Hub"] = 990,
    ["Better Scripts"] = 161,
    Bigconfig = 132,
    ["Biome Formatter Config"] = 84,
    ["Bitmovin Encoding Template"] = 1170,
    BizTalkServerApplicationSchema = 957,
    Bleep = 162,
    ["Block Protocol Metadata"] = 159,
    ["Bluebricks blueprint config"] = 1249,
    ["Boyka Framework"] = 141,
    Briefcase = 963,
    ["Build Info"] = 150,
    Buildkite = 152,
    ["Bukkit plugin.yml"] = 151,
    ["BungeeCord plugin.yml"] = 157,
    ["Butane Config"] = 1033,
    C4InterFlow = 1185,
    ["CDK Environment Manager, concrete environment configuration"] = 1209,
    ["CDK Environment Manager, concrete environments definition"] = 1208,
    ["CDK Environment Manager, environment definition"] = 1207,
    ["CGS Card Game Specification (cgs.json)"] = 1116,
    ["CICS TS region tagging"] = 1042,
    ["CICS TS resource import"] = 1043,
    ["CICS TS resource model"] = 1044,
    ["CICS TS resource overrides"] = 1045,
    ["CMake Presets"] = 163,
    ["CNC Codes"] = 185,
    ["CRS WAF test file"] = 1146,
    ["CRS WAF test platform overrides file"] = 1147,
    ["CSS Comb (.csscomb.json)"] = 294,
    ["CSS Lint (.csslintrc)"] = 295,
    ["CSpell (cspell.json)"] = 293,
    ["CVE Record Format"] = 197,
    CWL = 1122,
    ["Cache Warmup config"] = 164,
    ["Calqulus pipeline"] = 165,
    ["Camel YAML DSL"] = 166,
    ["Cannon TOML"] = 167,
    Carafe = 168,
    ["Cargo Make"] = 170,
    ["Cargo Manifest"] = 169,
    ["Catalog Info Backstage"] = 171,
    ["Chamaleon environment"] = 1174,
    ["Chamaleon properties"] = 1175,
    ["Chamaleon template"] = 1173,
    Changepacks = 1236,
    Changesets = 278,
    Changie = 172,
    Charmcraft = 173,
    Cheatsheets = 1030,
    ["ChordPro Configuration"] = 174,
    ["Chrome Extension"] = 259,
    ["Chromia Model"] = 175,
    ["Chromia Seeder Module Config"] = 177,
    ["Chromia Seeder Root Config"] = 176,
    ["Cinnamon Spice info.json"] = 93,
    ["CircleCI config.yml"] = 234,
    ["Citation File Format"] = 280,
    ["Citrus test case"] = 179,
    CityJSON = 180,
    ["Claude Code Keybindings"] = 192,
    ["Claude Code Plugin Manifest"] = 193,
    ["Claude Code Plugin Marketplace"] = 194,
    ["Claude Code Settings"] = 195,
    ["Clawject config"] = 191,
    ["Cloud Foundry Application Manifest"] = 1128,
    ["Cloud Run Spec v1"] = 1151,
    ["Cloud.gov Workshop Configuration"] = 94,
    ["CloudCannon Configuration"] = 99,
    ["CloudCannon Configuration (Collection Structures)"] = 108,
    ["CloudCannon Configuration (Collections)"] = 107,
    ["CloudCannon Configuration (Editables)"] = 106,
    ["CloudCannon Configuration (Inputs)"] = 101,
    ["CloudCannon Configuration (Snippets Definitions)"] = 105,
    ["CloudCannon Configuration (Snippets Imports)"] = 104,
    ["CloudCannon Configuration (Snippets)"] = 103,
    ["CloudCannon Configuration (Structure Value)"] = 102,
    ["CloudCannon Configuration (Structures)"] = 100,
    ["CloudEvents specification"] = 181,
    ["Code Climate"] = 235,
    CodeCV = 97,
    CodeRabbit = 96,
    ["CodeShip Pro services configuration files"] = 248,
    ["CodeShip Pro steps configuration files"] = 249,
    ["Codecov configuration files"] = 247,
    Codex = 243,
    CodifyCLI = 98,
    Codux = 245,
    ["Cog config file"] = 186,
    ["Commandbox Box.json"] = 187,
    ["Commandbox Server.json"] = 188,
    ["Common Catalog Data"] = 257,
    ["Common Package Specification"] = 189,
    Concord = 1145,
    ["Configu .cfgu files"] = 1133,
    ["Configu .configu file"] = 1134,
    Conjure = 184,
    ["Container Structure Test"] = 971,
    Containerlab = 999,
    ["Contextive Glossary"] = 1201,
    Convex = 183,
    ["Crowdsec collection config"] = 288,
    ["Crowdsec parser config"] = 289,
    ["Crowdsec scenario config"] = 290,
    ["CumulusCI Config"] = 190,
    ["Cursor Agent Environment"] = 1254,
    ["Custom Machinery Machine"] = 1117,
    ["Custom Machinery Recipe"] = 1118,
    ["Cycle Stack File"] = 198,
    CycloneDX = 199,
    ["DWP Exchange - catalogue entry"] = 339,
    ["DWP Exchange - gateway"] = 337,
    ["DWP Exchange - meta"] = 338,
    ["Dart Build Config (dart-build.json)"] = 296,
    ["Dart Test Config (dart-test.json)"] = 297,
    ["DashLord Configuration"] = 298,
    ["Data Contract Specification"] = 299,
    ["Data Product Specification"] = 300,
    ["DataYoga Connections"] = 200,
    ["DataYoga Job"] = 201,
    ["Databricks Asset Bundles"] = 1095,
    ["Datadog Continuous Testing"] = 504,
    ["Datadog Service Definition"] = 505,
    ["Datadog Software Catalog"] = 506,
    ["Datahub Ingestion Recipe"] = 1049,
    ["Debian Upstream Metadata file"] = 208,
    ["Deck config"] = 209,
    ["DeepMatch deeplinks spec"] = 210,
    ["Dein Config"] = 211,
    ["Deno Config (deno.json)"] = 306,
    ["Dependency cruiser"] = 212,
    ["DeployStack Configuration"] = 213,
    ["Deployah Configuration"] = 1224,
    ["Deployer Recipe"] = 309,
    ["Deta Spacefile"] = 214,
    ["Detekt Config (detekt.yml)"] = 310,
    ["Devbox Config"] = 215,
    ["Devbox Plugin"] = 216,
    Devfile = 336,
    Devup = 1237,
    DipDup = 1148,
    ["Discord Webhook"] = 311,
    ["DocFx Config (docfx.json)"] = 316,
    ["Docker Desktop extension metadata"] = 313,
    ["Docs MCP Manifest"] = 317,
    Dofigen = 318,
    ["Dolittle Artifacts"] = 319,
    ["Dolittle Bounded Context Configuration"] = 320,
    ["Dolittle Event Horizons Configuration"] = 321,
    ["Dolittle Resources Configuration"] = 322,
    ["Dolittle Server Configuration"] = 323,
    ["Dolittle Tenant Map Configuration"] = 325,
    ["Dolittle Tenants Configuration"] = 324,
    ["Dolittle Topology"] = 326,
    ["DonateCaseBetterCasino menu"] = 1178,
    ["Drupal Breakpoints"] = 217,
    ["Drupal Config"] = 229,
    ["Drupal Info"] = 218,
    ["Drupal Layouts"] = 219,
    ["Drupal Libraries"] = 220,
    ["Drupal Links Action"] = 221,
    ["Drupal Links Contextual"] = 222,
    ["Drupal Links Menu"] = 223,
    ["Drupal Links Task"] = 224,
    ["Drupal Migration"] = 225,
    ["Drupal Permissions"] = 226,
    ["Drupal Recipe"] = 227,
    ["Drupal Routing"] = 228,
    ["Drupal Services"] = 230,
    ["Drush site aliases"] = 332,
    ["Dynamic Bash Aliases (.aliases)"] = 1086,
    ["EAS config"] = 358,
    ["ECA - Editor Code Assistant"] = 341,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1075,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1221,
    ["EasyVCR .NET"] = 359,
    ["Eidolon Resource"] = 1162,
    ["Elgato Stream Deck"] = 343,
    Elm = 1150,
    ["Embrace Config"] = 1061,
    Endurica = 1099,
    ["Enterprise Contract Policy Spec"] = 344,
    ["Erda Pipeline"] = 1124,
    ["Erda Runtime"] = 1125,
    ["Espanso config.yml"] = 1247,
    ["Espanso match.yml"] = 1246,
    Esquio = 346,
    ["Estuary Flow Catalog"] = 1039,
    ["Ethereum ERC1155"] = 1258,
    ["Ethereum ERC721"] = 1257,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 351,
    ["EveryVoice TTS Toolkit Data Configuration"] = 352,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 356,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 355,
    ["EveryVoice TTS Toolkit Text Configuration"] = 353,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 354,
    ["Evolving Resolutive Process notation"] = 1223,
    ["Expo SDK"] = 357,
    ["F-Droid Data metadata"] = 363,
    ["FasterCI Configuration"] = 114,
    ["Fence configuration"] = 115,
    FiQuS = 367,
    Firebase = 365,
    ["Flatpak Builder Manifest"] = 368,
    ["FlexGet Config"] = 369,
    ["Flow.json Configurations"] = 1121,
    ["Fossa configuration file"] = 376,
    ["Fossa's fossa-deps file"] = 377,
    ["Foundry VTT - Base package Manifest"] = 371,
    ["Foundry VTT - Module Manifest"] = 372,
    ["Foundry VTT - System Data Template"] = 375,
    ["Foundry VTT - System Manifest"] = 373,
    ["Foundry VTT - World Manifest"] = 374,
    ["Foxx Manifest"] = 116,
    ["Freifunk.de Community API"] = 119,
    ["Frogbot Config"] = 120,
    ["G2P Mapping Configuration"] = 383,
    ["GCP Blueprint Metadata"] = 386,
    Gaspar = 384,
    ["GatewayCore API Gateway"] = 385,
    ["Gemini CLI settings"] = 387,
    ["GeoJSON.json latest"] = 1037,
    GherKing = 1041,
    ["GitHub Action"] = 392,
    ["GitHub Actions typing"] = 1158,
    ["GitHub Discussion"] = 393,
    ["GitHub Funding"] = 394,
    ["GitHub Issue Template configuration"] = 395,
    ["GitHub Issue Template forms"] = 396,
    ["GitHub Workflow"] = 397,
    ["GitHub Workflow Template Properties"] = 398,
    ["GitHub automatically generated release notes configuration"] = 399,
    ["GitLab Agent for Kubernetes configuration"] = 1113,
    GitVersion = 389,
    ["Gitea Issue Template configuration"] = 390,
    ["Gitea Issue Template forms"] = 391,
    ["Gitpod Automations"] = 401,
    ["Gitpod Configuration"] = 402,
    ["GlazeWM settings"] = 1115,
    ["Global Privacy Control"] = 388,
    Goblet = 1094,
    ["Golangci-lint Configuration"] = 417,
    ["Golangci-lint Custom Plugins Configuration"] = 418,
    ["Google Chrome Related Website Sets"] = 366,
    ["Google Cloud Workflows"] = 265,
    ["Google Digital Assetlinks"] = 1202,
    Goreleaser = 420,
    ["Goreleaser Pro"] = 421,
    Goss = 422,
    ["Gradle Build Cache Node"] = 988,
    ["Gradle Enterprise"] = 987,
    ["Grafana 5.x Dashboard"] = 423,
    ["GraphQL Code Generator"] = 428,
    ["GraphQL Config"] = 427,
    ["GraphQL Mesh"] = 426,
    ["GroovyLint configuration"] = 429,
    ["Grunt JSHint task"] = 433,
    ["Grunt Watch task"] = 434,
    ["Grunt base task"] = 435,
    ["Grunt clean task"] = 431,
    ["Grunt copy task"] = 430,
    ["Grunt cssmin task"] = 432,
    HEMTT = 953,
    Hadolint = 967,
    Hammerkit = 998,
    ["Hardware Sentry Configuration"] = 1053,
    ["Hashgraph Online Skill Manifest"] = 1,
    ["HashiCorp Vault"] = 436,
    Hatch = 968,
    Hayson = 438,
    ["Haystack Pipeline"] = 439,
    ["Hazelcast 5 Configuration"] = 440,
    ["Hecate Input Schema"] = 1213,
    ["Helm Chart.lock"] = 232,
    ["Helm Chart.yaml"] = 231,
    ["Helm Unittest Test Suite"] = 233,
    ["Home Assistant Integration Manifest"] = 441,
    ["Homer dashboard configuration"] = 442,
    Hugo = 1029,
    ["Hugo Theme"] = 1028,
    ["Hulak Configuration"] = 449,
    ["Hyperfoil benchmark configuration"] = 448,
    ["IBM Zapp document"] = 450,
    ["IBM zCodeFormatSettings"] = 451,
    ["IMG Catapult PSP"] = 456,
    ["IVMS101 by CODE Protocol"] = 1114,
    Infrahub = 458,
    Istanbul = 1057,
    ["JDownloader2 crawler multi-rules"] = 471,
    ["JDownloader2 crawler single-rules"] = 470,
    ["JFrog Applications Config"] = 472,
    ["JFrog File Spec"] = 473,
    ["JFrog Pipelines YML DSL"] = 1063,
    ["JMeter DSL cli config"] = 474,
    JReleaser = 477,
    ["JSON Document Transform"] = 485,
    ["JSON Feed"] = 486,
    ["JSON Resume"] = 739,
    ["JSON Schema Draft 2020-12"] = 935,
    ["JSON Schema Draft 4"] = 932,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1096,
    ["JSON Schema Draft 7"] = 933,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1097,
    ["JSON Schema Draft 8 (2019-09)"] = 934,
    ["JSON-API"] = 484,
    ["JSON-e templates"] = 995,
    ["JSON-stat 2.0"] = 928,
    JSONPatch = 488,
    ["JSR Package Config (jsr.json)"] = 478,
    Jarl = 1229,
    Jasmine = 465,
    Jekyll = 466,
    ["Jenkins X Pipelines"] = 467,
    ["Jenkins X Requirements"] = 468,
    Jest = 469,
    Jocker = 475,
    ["Jovo Language Models"] = 476,
    ["Jujutsu (jj) VCS config"] = 1215,
    ["KIMMDY config file"] = 499,
    ["KODE/CI build.yaml"] = 1059,
    ["KSP-AVC"] = 929,
    ["KSP-CKAN"] = 930,
    ["KSP-NetKAN"] = 931,
    KSY = 1126,
    KSail = 381,
    ["KYA Manifest"] = 1127,
    ["Karakum configuration file"] = 378,
    Kas = 491,
    ["Kestra flow file"] = 500,
    ["Keycloak REST API"] = 1066,
    ["Knative Functions - func.yaml"] = 379,
    Knip = 380,
    ["Knowledge Unit"] = 508,
    ["Kometa (nightly) config file"] = 502,
    ["Kometa config file"] = 501,
    ["Kong DBLess config"] = 1060,
    KrakenD = 503,
    ["Kubri Configuration"] = 511,
    LOOBin = 526,
    ["Lake configuration file"] = 1218,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 270,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 271,
    ["Landing Zone Accelerator on AWS - Global Config"] = 272,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 273,
    ["Landing Zone Accelerator on AWS - Network Config"] = 274,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 275,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 276,
    ["Landing Zone Accelerator on AWS - Security Config"] = 277,
    ["Lando (landofile)"] = 109,
    ["LangGraph Platform configuration"] = 1138,
    ["Language configuration"] = 1137,
    Lefthook = 515,
    ["Liferay client-extension.yaml"] = 522,
    ["LinkML Metamodel"] = 524,
    Liquibase = 1004,
    ["Liquibase Flow File"] = 1005,
    ["Lively Properties"] = 525,
    ["Lobe AI Agent"] = 111,
    Loki = 112,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 568,
    ["MS2Rescore Configuration"] = 572,
    ["Madness (madness.yml)"] = 1077,
    ["Mado configuration"] = 532,
    ["Maestro Flow"] = 533,
    ["Mail Servers Configuration"] = 1250,
    ["MapEHR Mapping"] = 534,
    Markdownlint = 1008,
    ["Mason Registry"] = 1011,
    ["MegaLinter Custom Flavor"] = 537,
    ["MegaLinter configuration"] = 536,
    ["MegaLinter descriptor"] = 538,
    Melange = 1104,
    ["Meltano project definition"] = 539,
    ["Mergify Configuration"] = 573,
    ["Metadata for a Bazel module"] = 540,
    ["Metadata for a Cinnamon spice"] = 1154,
    ["Metatype Configuration"] = 541,
    ["MetricsHub Configuration"] = 542,
    ["MetricsHub Connector Configuration"] = 543,
    ["Micro Editor Syntax"] = 1087,
    ["Microsoft Band Web Tile"] = 544,
    ["Microsoft RulesEngine workflow rules"] = 1142,
    ["Microsoft RulesEngine workflow rules list"] = 1143,
    ["Minecraft Custom Main Menu Mod"] = 1105,
    ["Minecraft Data Pack Advancement"] = 546,
    ["Minecraft Data Pack Biome"] = 547,
    ["Minecraft Data Pack Configured Carver"] = 548,
    ["Minecraft Data Pack Damage Type"] = 549,
    ["Minecraft Data Pack Dimension"] = 551,
    ["Minecraft Data Pack Dimension Type"] = 550,
    ["Minecraft Data Pack Item Modifier"] = 552,
    ["Minecraft Data Pack Loot Table"] = 553,
    ["Minecraft Data Pack Metadata"] = 554,
    ["Minecraft Data Pack Predicate"] = 555,
    ["Minecraft Data Pack Recipe"] = 556,
    ["Minecraft Data Pack Tag"] = 557,
    ["Minecraft Data Pack Template Pool"] = 558,
    ["Minecraft Data Pack Trim Material"] = 563,
    ["Minecraft Data Pack Trim Pattern"] = 564,
    ["Minecraft Resource Pack Lang"] = 559,
    ["Minecraft Resource Pack Particle"] = 560,
    ["Minecraft Resource Pack Texture Mcmeta"] = 562,
    ["Minecraft Resourcepack Sounds"] = 561,
    ModuleAssembler = 566,
    ["Monade CLI Stack Configuration"] = 576,
    ["MongoDB Atlas Search Index Definition"] = 1058,
    ["Monika Configuration"] = 1056,
    ["Monoweave Configuration"] = 571,
    ["Motif config"] = 949,
    MultiQC = 1195,
    ["NOX Framework (Service)"] = 592,
    ["Netin Diagnostic System Template"] = 1015,
    ["Netlify config"] = 579,
    ["Network-as-Code Data Model"] = 580,
    ["Next Gen UI Agent A2A Server Configuration"] = 581,
    ["Next Gen UI Agent Configuration"] = 583,
    ["Next Gen UI Agent MCP Server Configuration"] = 582,
    ["Nightwatch.js"] = 585,
    ["Node.js configuration"] = 954,
    ["NueJS configuration file"] = 597,
    ["Nuitka.yaml"] = 1119,
    ["Nullstone config"] = 599,
    ["ONe's changelog entry"] = 618,
    ["ONe's service descriptor"] = 617,
    ["ORT Server repository environment configuration"] = 628,
    ["OSCAL Assessment Plan (AP)"] = 630,
    ["OSCAL Assessment Results (AR)"] = 631,
    ["OSCAL Catalog"] = 632,
    ["OSCAL Component Definition (CDef)"] = 633,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 634,
    ["OSCAL Profile"] = 635,
    ["OSCAL System Security Plan (SSP)"] = 636,
    ["OSS Review Toolkit configuration"] = 637,
    ["OSS Review Toolkit curation"] = 638,
    ["OSS Review Toolkit package configuration"] = 639,
    ["OSS Review Toolkit repository configuration"] = 640,
    ["OSS Review Toolkit resolutions"] = 641,
    ["October CMS columns"] = 603,
    ["October CMS fields"] = 604,
    ["Oh My Posh"] = 606,
    Okteto = 607,
    ["Ona Automations"] = 609,
    Opctl = 952,
    ["Open Data Contract Standard (ODCS)"] = 622,
    ["Open Data Product Standard (ODPS)"] = 623,
    ["Open Know-How"] = 1200,
    ["OpenRewrite Resource"] = 620,
    OpenSRM = 624,
    OpenStatus = 1211,
    ["OpenTelemetry Declarative Configuration"] = 621,
    ["OpenUtau character yaml"] = 614,
    ["OpenUtau ustx"] = 615,
    ["OpenWeather Current Weather API"] = 994,
    ["OpenWeather Road Risk API"] = 993,
    ["Ory Hydra configuration"] = 447,
    ["Ory Keto configuration"] = 507,
    ["Ory Kratos configuration"] = 629,
    ["Ory Oathkeeper configuration"] = 601,
    ["Outblocks App configuration"] = 626,
    ["Outblocks database table"] = 627,
    ["Outblocks project configuration"] = 625,
    PDM = 648,
    POPxf = 660,
    ["POPxf Correlations"] = 661,
    Packer = 645,
    PactSpec = 646,
    Pantsbuild = 1073,
    ["Paper paper-plugin.yml"] = 647,
    ["Pipeline component"] = 1006,
    ["Platform.sh application"] = 7,
    ["Platform.sh routes"] = 8,
    ["Platform.sh services"] = 9,
    ["Plex Prerolls"] = 657,
    ["PocketMine plugin.yml"] = 654,
    ["Podman Desktop Extension"] = 659,
    ["Postman collection"] = 664,
    ["Power Pages Configuration"] = 1212,
    ["Preset list for a WinUtil"] = 1157,
    ["ProActions AI-Kit Configuration"] = 675,
    ["ProActions AI-Kit Configuration for Menus"] = 677,
    ["ProActions AI-Kit Configuration for Sections"] = 679,
    ["ProActions AI-Kit Configuration for Services"] = 676,
    ["ProActions AI-Kit Configuration for Steps"] = 680,
    ["ProActions AI-Kit Configuration for Templates"] = 678,
    ["Problem object RFC9457"] = 1102,
    ["Problem package format"] = 681,
    ["Problem package generators"] = 682,
    ["Problem package submissions"] = 683,
    ["Problem package test group metadata"] = 684,
    Pterodactyl = 1052,
    ["Pull Request Labeler"] = 701,
    Pulumi = 709,
    ["PyGTA Config"] = 705,
    PyProject = 710,
    Pylock = 1203,
    Pyright = 711,
    ["Python script metadata"] = 1197,
    ["QType AI DSL"] = 714,
    Qgoda = 713,
    Qodana = 1025,
    ["Qt Creator workspace file"] = 1135,
    ["Quali Torque Blueprint Spec 2"] = 1050,
    ["QueryFirst config file"] = 1069,
    ["Qwen Code Settings"] = 1259,
    ["RKE Cluster Configuration JSON"] = 1003,
    ["RKE Cluster Configuration YAML"] = 1002,
    RadioHound = 704,
    ["Raid Profile"] = 1260,
    ["Raid Repo Configuration"] = 1261,
    Railpack = 716,
    Railway = 715,
    ["Rancher Fleet"] = 706,
    ["Rattler-build"] = 717,
    Ray = 966,
    ["Read the Docs"] = 708,
    ["Red-DiscordBot Cog"] = 724,
    ["Red-DiscordBot Cog Repo"] = 725,
    ["Red-DiscordBot Trivia"] = 726,
    ["Releasaurus Config"] = 4,
    ReleaseKit = 3,
    ["Render Blueprints"] = 1001,
    RenderCV = 743,
    Renovate = 740,
    ["Renovate global configuration"] = 741,
    ["Renovate inherited configuration"] = 742,
    ["Replit config"] = 732,
    Restate = 1190,
    ["Revel Digital Gadget Definition File"] = 1214,
    RoadRunner = 745,
    ["Robust Station Image"] = 1220,
    Rockcraft = 746,
    ["Roo Coder Custom Modes"] = 747,
    Rubocop = 736,
    ["Rudder techniques"] = 1109,
    Ruff = 737,
    ["Rust Project"] = 738,
    ["Rust toolchain"] = 751,
    ["SDMX data message"] = 778,
    ["SDMX metadata message"] = 777,
    ["SDMX structure message"] = 776,
    ["SIL Kit Participant Configuration"] = 788,
    ["SIL Kit Registry Configuration"] = 789,
    ["SPDX 2.3"] = 826,
    SWADL = 842,
    ["Safebox Config"] = 1064,
    ["Sapphire CLI Config"] = 754,
    ["SauceCTL Configuration"] = 1012,
    Scarb = 774,
    ["Schema Catalog"] = 769,
    ["Scoop manifest"] = 775,
    ["Semantic Data Fabric (SDF) file"] = 779,
    ["Semgrep Rule"] = 781,
    ["Serenity Code Generator (Sergen)"] = 782,
    ["Serverless Framework Configuration"] = 1019,
    ["Serverless Workflow"] = 1021,
    ["Settings for a Cinnamon spice"] = 1153,
    ["Settings.paf"] = 784,
    ["Shopware 6 Configuration"] = 1022,
    ["Shopware CLI Extension Store Configuration"] = 1023,
    ["Shopware CLI Project Store Configuration"] = 1024,
    ["Sigma Detection Rule"] = 786,
    ["Sigrid scope configuration file"] = 787,
    ["SkyPilot Task JSON"] = 1110,
    ["Slack app manifest"] = 791,
    Snapcraft = 793,
    Solidarity = 796,
    ["Solution filters"] = 797,
    ["Source Maps v3"] = 798,
    Sourcery = 799,
    ["Spack bootstrap.yaml"] = 800,
    ["Spack cdash.yaml"] = 801,
    ["Spack ci.yaml"] = 802,
    ["Spack compilers.yaml"] = 803,
    ["Spack concretizer.yaml"] = 804,
    ["Spack config.yaml"] = 805,
    ["Spack definitions.yaml"] = 806,
    ["Spack develop.yaml"] = 807,
    ["Spack env_vars.yaml"] = 808,
    ["Spack environment"] = 814,
    ["Spack include.yaml"] = 809,
    ["Spack mirrors.yaml"] = 810,
    ["Spack modules.yaml"] = 811,
    ["Spack packages.yaml"] = 812,
    ["Spack repos.yaml"] = 813,
    ["Spack toolchains.yaml"] = 815,
    ["Spack upstreams.yaml"] = 816,
    ["Spack view.yaml"] = 817,
    ["Speakeasy Generation Config File"] = 821,
    ["Speakeasy Lint Configuration File"] = 818,
    ["Speakeasy Test Generation Configuration File"] = 819,
    ["Speakeasy Workflow File"] = 820,
    SpecIF = 822,
    ["Specmatic Configuration"] = 823,
    ["Sponge Mixin configuration"] = 824,
    StackBlitz = 830,
    ["StackHawk Scanner Configuration"] = 1018,
    Stale = 831,
    Starfish = 832,
    ["Starlake Data Pipeline"] = 991,
    Starship = 833,
    ["Statamic Blueprint"] = 834,
    ["Stella configuration file"] = 835,
    ["Streamlit configuration file"] = 836,
    ["Stryker Mutator"] = 839,
    ["StyleCop Analyzers Configuration"] = 840,
    ["Stylelint (.stylelintrc)"] = 841,
    ["Stylua Config"] = 1204,
    ["Sublime Syntax"] = 1065,
    ["Subsquid squid manifest"] = 1112,
    ["Swagger API 2.0"] = 843,
    ["Synadia Connect Component"] = 844,
    TSON = 880,
    TSTyche = 881,
    ["TYPO3 Vendor Bundler config"] = 887,
    ["Tab data for a LinUtil"] = 1160,
    ["Tab list for a LinUtil"] = 1159,
    Tach = 845,
    ["Tach Domain"] = 846,
    Talhelper = 848,
    ["Talisman configuration"] = 849,
    Taplo = 1205,
    ["Taskfile config"] = 996,
    Taurus = 850,
    Tauticord = 851,
    ["Tekton Pipeline"] = 1233,
    ["Tekton PipelineRun"] = 1234,
    ["Tekton Task"] = 1231,
    ["Tekton TaskRun"] = 1232,
    Telefonistka = 1191,
    ["Terrateam config"] = 1217,
    ["TestEnvironment.json"] = 863,
    ["TextMate Grammar"] = 862,
    Threagile = 857,
    ["Tier.run pricing.json"] = 854,
    Tikibase = 855,
    Tombi = 860,
    ["Traefik v2"] = 866,
    ["Traefik v2 File Provider"] = 867,
    ["Traefik v3"] = 868,
    ["Traefik v3 File Provider"] = 869,
    ["Travis CI (.travis.yml)"] = 865,
    Treefmt = 425,
    Trident = 1187,
    ["TrueScript for *.tscript files"] = 872,
    ["Tugboat QA config.yml"] = 1184,
    TunnelHub = 1100,
    Turborepo = 864,
    Tycho = 1149,
    Tye = 1026,
    ["Tyk Gateway - Open Source v5.7+"] = 1196,
    ["UET BuildConfig.json"] = 1070,
    ["UI5 Manifest"] = 893,
    ["UNCORS configuration"] = 897,
    ["UTAM Page Object"] = 896,
    ["Ubuntu Server Autoinstall"] = 891,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1188,
    ["Uniswap Token List"] = 978,
    ["Universal Schedule Format"] = 898,
    ["Unreal Engine Uplugin"] = 1071,
    ["Unreal Engine Uproject"] = 1072,
    ["UpCloud CLI (upctl) configuration"] = 1189,
    ["Updatecli Compose"] = 1034,
    ["Updatecli Policy Manifest"] = 1035,
    ["Updatecli Policy Metadata"] = 1036,
    Uplift = 1068,
    ["Upsun config"] = 6,
    ["User Journey Map"] = 1000,
    V2Ray = 1040,
    ["VSCode Code Snippets"] = 253,
    ["VSIX CLI publishing"] = 916,
    Vector = 900,
    ["Vela Pipeline Configuration"] = 903,
    Vercel = 252,
    ["Version Bumper config"] = 906,
    Vespertide = 1238,
    ["Vespertide Migration"] = 1239,
    ["Vespertide Model"] = 1240,
    ["Viash Component Config"] = 1193,
    ["Viash Package Config"] = 1194,
    Visivo = 1098,
    ["WP-CLI"] = 926,
    Wake = 1186,
    ["Waku Config"] = 1163,
    ["Web App Manifest"] = 922,
    ["Web types"] = 925,
    WebExtensions = 921,
    ["Webman package recipe"] = 1046,
    ["Windows Package Manager Installer Manifest"] = 974,
    ["Windows Package Manager Locale Manifest"] = 975,
    ["Windows Package Manager Singleton Manifest"] = 973,
    Winutil = 976,
    ["WireMock CLI import configuration"] = 1169,
    ["WireMock CLI local service configuration"] = 1168,
    ["WireMock message stub mapping"] = 1167,
    ["WireMock stub mapping"] = 1166,
    ["Woodpecker pipeline config"] = 1014,
    ["Wrangler CLI"] = 927,
    ["Xstate Machine"] = 1032,
    ["Yandex Workflow Language"] = 1155,
    ["Yarn Config (.yarnrc.yml)"] = 989,
    ["Yippee-Ki-JSON configuration YML"] = 980,
    ["YouTrack App"] = 1152,
    ["Zarf Package Configuration"] = 1219,
    ["Zerops.io config"] = 1140,
    ["Zerops.io import"] = 1141,
    ["Zola Configuration"] = 1230,
    ["aerleon.yml"] = 19,
    ["amplify.yml"] = 12,
    ["angular.json"] = 36,
    apko = 1103,
    ["app-definition.yaml"] = 40,
    ["apple-app-site-association"] = 38,
    ["appsettings.StormPetrel.json"] = 45,
    ["appsettings.json"] = 43,
    ["appsscript.json"] = 42,
    ["appveyor.yml"] = 44,
    ["aqua-generate-registry.yaml"] = 47,
    ["aqua-policy.yaml"] = 48,
    ["aqua.yaml"] = 46,
    ["arazzo.json"] = 50,
    ["arb.json"] = 51,
    ["arc.json"] = 53,
    ["architect.yml"] = 52,
    ["artifacthub-repo.yml"] = 57,
    ["asm-lsp"] = 58,
    ["ast-grep rules"] = 61,
    ["ast-grep sgconfig.yml"] = 60,
    ["azure.yaml"] = 69,
    ["babelrc.json"] = 122,
    ["bamboo-spec"] = 126,
    basedpyright = 124,
    ["bashly-strings.yml"] = 1080,
    ["batect.yml"] = 125,
    ["beef-database-codegen"] = 127,
    ["beef-database-v5-codegen"] = 129,
    ["beef-entity-codegen"] = 128,
    ["beef-entity-v5-codegen"] = 130,
    ["behat.yml"] = 142,
    ["bigquery-table"] = 131,
    ["bioimageio resource description"] = 1120,
    ["bitbucket-pipelines"] = 133,
    bitrise = 134,
    ["bitrise-step"] = 135,
    ["block.json"] = 158,
    ["bottom configuration"] = 85,
    ["bower.json"] = 137,
    ["bozr.suite.json"] = 145,
    bpkg = 1081,
    ["browser.i18n.json"] = 146,
    ["browsh configuration"] = 147,
    bucklescript = 148,
    ["buf.gen.yaml"] = 87,
    ["buf.lock"] = 88,
    ["buf.plugin.yaml"] = 89,
    ...
    ["build-changelog"] = 149,
    ["bun.lock"] = 154,
    ["bundleconfig.json"] = 155,
    ["bunfig.toml"] = 156,
    ["cargo-mutants-config.yaml"] = 92,
    ["ccmod.json"] = 1164,
    changelogging = 1132,
    ["chisel-slices.json"] = 279,
    ["chrome-extension-locales-messages.json"] = 260,
    ["chutzpah.json"] = 261,
    cibuildwheel = 178,
    ["clang-format (.clang-format)"] = 1038,
    ["clang-tidy"] = 239,
    clangd = 238,
    clib = 240,
    ["cloud-init: cloud-config userdata"] = 242,
    ["cloud-sdk-pipeline-configuration"] = 263,
    ["cloudbuild.json"] = 264,
    cloudify = 241,
    cmakefmt = 196,
    ["cmdx.yaml"] = 95,
    ...
    ["coffeelint.json"] = 281,
    ["commands.json"] = 256,
    ["commitlint (.commitlintrc)"] = 977,
    ["committed.toml"] = 282,
    ["compile_commands.json"] = 255,
    ["compilerconfig.json"] = 254,
    ["completely.yml"] = 1076,
    ["component-detection-manifest.json"] = 285,
    ["component.json"] = 284,
    ["composer.json"] = 283,
    ["conda-forge"] = 182,
    ["config.yaml"] = 707,
    ["contentmanifest.json"] = 262,
    ["contribute.json"] = 286,
    ["cosmos.config.json"] = 258,
    ["crowdin.yml"] = 287,
    ["ctfd-setup configuration file"] = 1176,
    ["custom-elements.json"] = 1090,
    ["cypress.json"] = 291,
    ["datalogic-scan2deploy-android"] = 301,
    ["datalogic-scan2deploy-ce"] = 302,
    ["dbt Dependencies"] = 203,
    ["dbt Packages"] = 205,
    ["dbt Project"] = 204,
    ["dbt Selectors"] = 206,
    ["dbt YAML files"] = 207,
    ...
    ["ddev-global"] = 303,
    ["ddev-project"] = 304,
    ["debugsettings.json"] = 305,
    ["dependabot-v2.json"] = 308,
    ["dependabot.json"] = 307,
    ["deployed-cli"] = 1031,
    ["devcontainer.json"] = 246,
    devinit = 982,
    ["devspace.yaml"] = 1054,
    djlint = 983,
    ["docker bake"] = 314,
    ["docker sequencer"] = 315,
    ["docker-compose.yml"] = 981,
    ["dockerd.json"] = 312,
    ["dotnet Release Index manifest"] = 327,
    ["dotnet-tools.json"] = 328,
    ["dotnetcli.host.json"] = 329,
    ["dprint.json"] = 330,
    ["drone.json"] = 331,
    ["dss-2.0.0.json"] = 333,
    ["dstack configuration"] = 334,
    ["dtool dataset metadata"] = 1171,
    ["dvc.yaml"] = 335,
    ["ecosystem.json"] = 340,
    eksctl = 342,
    ["electron-builder configuration file"] = 349,
    ["epr-manifest.json"] = 348,
    ["estampo.toml"] = 347,
    ["evcc.yaml"] = 350,
    ["ezd task runner"] = 360,
    ["fabric.mod.json"] = 362,
    ["first-timers-bot"] = 370,
    ["flagd flag configuration"] = 117,
    ["fly.io Configuration"] = 118,
    fulibWorkflows = 1013,
    ["function.json"] = 382,
    ["gRPC API Gateway & OpenAPI Config"] = 14,
    ["gematik health care insurance list"] = 1182,
    ["gematik health care patient list"] = 1179,
    ["gematik health care provider institution list"] = 1181,
    ["gematik health care provider list"] = 1180,
    ["gematik tiger test environment configuration"] = 1183,
    ["git-town.toml"] = 1228,
    ["gitlab-ci"] = 400,
    ["global.json"] = 416,
    ["go-feature-flag Flag Configuration"] = 419,
    ["haxelib.json"] = 437,
    helmfile = 969,
    helmwave = 970,
    ["host-meta.json"] = 444,
    ...
    ["ide.host.json"] = 452,
    ["ifstate.yaml"] = 453,
    ["imageoptimizer.json"] = 454,
    ["importmap.json"] = 457,
    instant_python_config = 459,
    instant_python_custom_project = 460,
    ["ioBroker Configuration"] = 461,
    ["ioBroker JSON UI"] = 462,
    ["ioBroker Package manifest"] = 463,
    ["ixpect.conf.yaml"] = 464,
    ["ize.toml"] = 1067,
    ["jsconfig.json"] = 489,
    ["jscpd Configuration"] = 1051,
    jsdoc = 965,
    ["k3d.yaml"] = 490,
    ["k9s aliases.yaml"] = 492,
    ["k9s cluster-config.yaml"] = 494,
    ["k9s config.yaml"] = 493,
    ["k9s hotkeys.yaml"] = 495,
    ["k9s plugins.yaml"] = 496,
    ["k9s skin.yaml"] = 497,
    ["k9s views.yaml"] = 498,
    ["kontinuous-config.yaml"] = 510,
    ["kontinuous-values.yaml"] = 509,
    ["kustomization.yaml"] = 512,
    ["label-commenter-config.yml"] = 513,
    ["latexindent configuration"] = 110,
    ["launchsettings.json"] = 514,
    lazydocker = 1089,
    lazygit = 1088,
    ["lego.json"] = 516,
    ["lerna.json"] = 517,
    ["lgtm.yml"] = 518,
    ["liblab.config.json"] = 519,
    ["libman.json"] = 520,
    ["license-report-config.json"] = 521,
    ["linkinator.config.json"] = 523,
    ["lint-staged (.lintstagedrc)"] = 943,
    ["local.settings.json"] = 528,
    ["localazy.json"] = 529,
    ["lotus.yaml"] = 527,
    ["lsdlschema.json"] = 530,
    ["macro.json"] = 1055,
    ["markdown-link-check"] = 1009,
    maturin = 1010,
    mboats = 1017,
    ["micro-settings.json"] = 1082,
    ["mimetypes.json"] = 545,
    ["mirrord config"] = 945,
    mise = 946,
    ["mkdocs.yml"] = 565,
    ...
    ["monospace.yml"] = 570,
    ["moon.yml"] = 1165,
    ["mprocs Configuration file"] = 1136,
    ["mrdocs.yml"] = 567,
    ["mta.yaml"] = 947,
    ["mtad.yaml"] = 948,
    ["mycode.json"] = 577,
    nFPM = 584,
    ["napari plugin manifest"] = 578,
    neoload = 960,
    ["nest-cli"] = 587,
    ["nexus-rpc-gen"] = 1255,
    ["ninjs (News in JSON)"] = 586,
    ["nitro.json"] = 959,
    ["nixd configuration"] = 1108,
    ["nlu.json"] = 588,
    ["nodemon.json"] = 590,
    ["noodl config"] = 1016,
    ["notebook.mod.json"] = 591,
    now = 955,
    ["npm-badges"] = 594,
    ["nswag.json"] = 598,
    ntangle = 600,
    ["nuclei-template.yaml"] = 595,
    ["nuget-project.json"] = 596,
    ["ocelot.json"] = 602,
    ogen = 605,
    ["omnisharp.json"] = 608,
    openHAB = 1241,
    ...
    oxlint = 1252,
    ["package.json"] = 642,
    ["package.manifest"] = 644,
    ["package.yaml"] = 643,
    ["partial-black.json"] = 143,
    ["partial-fastapi.json"] = 144,
    ["partial-pixi.json"] = 652,
    ["pattern.json"] = 650,
    ["petstore-v1.0"] = 1062,
    pgap_yaml_input_reader = 649,
    pgxgen = 1245,
    pitcms = 1248,
    ["pixi.toml"] = 651,
    ["plagiarize-me.yaml"] = 656,
    ["plagiarize.yaml"] = 655,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1172,
    ["podbard.yaml"] = 658,
    ["portman.json"] = 662,
    ["prefect.toml"] = 670,
    ["prefect.yaml"] = 671,
    ...
    ["prettierrc.json"] = 673,
    ["prisma.yml"] = 674,
    ["project-1.0.0-beta3.json"] = 686,
    ["project-1.0.0-beta4.json"] = 687,
    ["project-1.0.0-beta5.json"] = 688,
    ["project-1.0.0-beta6.json"] = 689,
    ["project-1.0.0-beta8.json"] = 690,
    ["project-1.0.0-rc1.json"] = 691,
    ["project-1.0.0-rc2.json"] = 692,
    ["project.json"] = 685,
    ["project.owasp.yaml"] = 693,
    ["prometheus-alertmanager.json"] = 697,
    ["prometheus.json"] = 694,
    ["prometheus.rules.json"] = 695,
    ["prometheus.rules.test.json"] = 696,
    ["proxies.json"] = 698,
    ["publiccode.yml"] = 699,
    ["pubspec.yaml"] = 700,
    ["pyrseas-0.8.json"] = 703,
    pytest = 712,
    ["quilt.mod.json"] = 1083,
    ["rc3 auth"] = 718,
    ["rc3 collection"] = 719,
    ...
    ["release drafter"] = 961,
    ["release-hub.json"] = 2,
    ["release-please-config.json"] = 728,
    ["release-please-manifest.json"] = 729,
    ["release-plz.toml"] = 730,
    ["renv.lock"] = 744,
    ["reposets Configuration"] = 733,
    ["reposets Credentials"] = 734,
    ["rivet.json"] = 1107,
    ["rivet.yaml (legacy)"] = 1106,
    rumdl = 749,
    runny = 748,
    rustfmt = 750,
    sake = 1199,
    samt = 752,
    samtrc = 753,
    ["sarif-1.0.0.json"] = 755,
    ["sarif-2.0.0.json"] = 756,
    ["sarif-2.1.0"] = 766,
    ["sarif-2.1.0-rtm.2"] = 757,
    ["sarif-2.1.0-rtm.3"] = 759,
    ["sarif-2.1.0-rtm.4"] = 761,
    ["sarif-2.1.0-rtm.5"] = 763,
    ["sarif-2.1.0-rtm.6"] = 764,
    ["sarif-external-property-file-2.1.0"] = 767,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 758,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 760,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 762,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 765,
    ["scalingo.json configuration"] = 768,
    ["schema.org - Action"] = 770,
    ["schema.org - ContactPoint"] = 771,
    ["schema.org - Place"] = 772,
    ["schema.org - Thing"] = 773,
    ["secrethub.yml"] = 1085,
    ["semantic-release"] = 780,
    ["servicehub.config.json"] = 938,
    ["servicehub.service.json"] = 937,
    ["settings.job"] = 783,
    ["sfdx-hardis configuration"] = 785,
    ["shard.yml"] = 1123,
    ["size-limit configuration"] = 790,
    ["skaffold.yaml"] = 1007,
    ["skyuxconfig.json"] = 792,
    ["snowflake-config"] = 794,
    ["snowflake-connections"] = 795,
    ["spicepod.yaml"] = 1144,
    ["sqlc configuration"] = 827,
    ["stripe-app-local.json"] = 838,
    ["stripe-app.json"] = 837,
    swcrc = 992,
    ["task.json"] = 847,
    taskcat = 956,
    ["template.json"] = 852,
    ["templatsources.json"] = 853,
    ["text2confl config"] = 1253,
    ["theme.json"] = 856,
    ["tizen_workspace.json"] = 858,
    tldr = 859,
    ["tm_devices configuration file"] = 1210,
    tmuxinator = 941,
    tox = 861,
    ["transcend.yml"] = 870,
    ["tree-sitter grammar.json"] = 424,
    ["trime.yaml"] = 871,
    ["trunk.yaml"] = 873,
    ["ts-force-config.json"] = 878,
    ["tsconfig.json"] = 874,
    ["tsd.json"] = 875,
    ["tsdoc.json"] = 876,
    ["tsdrc.json"] = 877,
    ...
    v8r = 920,
    vcluster = 1130,
    ["vcpkg configuration file"] = 251,
    ["vcpkg manifest file"] = 250,
    ["vega-lite.json"] = 902,
    ["vega.json"] = 901,
    ["venvironment.yaml"] = 904,
    ["venvplus.yaml"] = 905,
    version = 1192,
    ["version.json"] = 907,
    ["vhwdebugger-binding.yaml"] = 909,
    ["vim-addon-info"] = 910,
    ["vs-2017.3.host.json"] = 912,
    ["vs-nesting.json"] = 913,
    ["vsls.json"] = 911,
    ["vss-extension.json"] = 917,
    vtcfg = 1198,
    ["vtesttree.yaml"] = 918,
    ["vtestunit.yaml"] = 919,
    ["warp-keysets.json"] = 1091,
    ["warp-themes.json"] = 1092,
    ["warp-workflows.json"] = 1093,
    ["webhint.io"] = 1047,
    ["webjobpublishsettings.json"] = 924,
    ["webjobs-list.json"] = 923,
    ["well-known-fursona"] = 1131,
    ["xs-app.json"] = 951,
    ["xunit.runner.json"] = 936,
    yamllint = 979,
    zizmor = 1235,
    zuul = 962,
    ["Žinoma"] = 972
