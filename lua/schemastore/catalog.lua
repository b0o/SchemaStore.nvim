...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 992,
    [".nodehawkrc"] = 624,
    [".npmpackagejsonlintrc"] = 628,
    [".omletrc"] = 1172,
    [".phrase.yml"] = 706,
    [".phraseapp.yml"] = 707,
    [".pmbot.yml"] = 691,
    [".postcssrc"] = 700,
    [".powerpages-web-template-manifest"] = 702,
    [".pre-commit-config.yml"] = 703,
    [".pre-commit-hooks.yml"] = 704,
    [".putout.json"] = 740,
    [".rehyperc"] = 765,
    [".remarkrc"] = 769,
    [".sprite files"] = 865,
    ...
    AIConfig = 36,
    ["AMX Muse Program Descriptor"] = 1221,
    ["API Builder"] = 1028,
    ["AVA Configuration"] = 1091,
    ["AWS AppConfig Feature Flags-v1"] = 70,
    ["AWS CDK cdk.json"] = 272,
    ["AWS CloudFormation"] = 273,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 274,
    ["AWS Copilot Manifest"] = 1260,
    ["AWS SAM CLI Samconfig"] = 275,
    Acton = 1310,
    ["Adobe UXP Manifest"] = 1154,
    ["Aerleon Network & Service Definitions"] = 22,
    ["Aerleon Policy"] = 23,
    ["Agent Permission Policy"] = 1300,
    ["AgentCore CLI"] = 1301,
    Aider = 1250,
    Air = 25,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1271,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1270,
    ["Airlock Microgateway"] = 37,
    ["Alacritty Configuration"] = 1063,
    ["AlgoVoi Compliance Receipt v1"] = 12,
    ["All Contributors configuration file"] = 1117,
    Anodizer = 450,
    ["Ansible Argument Specs"] = 434,
    ["Ansible Collection Galaxy"] = 441,
    ["Ansible Execution Environment"] = 431,
    ["Ansible Inventory"] = 440,
    ["Ansible Meta"] = 432,
    ["Ansible Meta Runtime"] = 433,
    ["Ansible Navigator Configuration"] = 443,
    ["Ansible Playbook"] = 438,
    ["Ansible Requirements"] = 435,
    ["Ansible Rulebook"] = 439,
    ["Ansible Tasks File"] = 437,
    ["Ansible Vars File"] = 436,
    ["Ansible-lint Configuration"] = 442,
    Any = 1182,
    ...
    ["Application list for a WinUtil"] = 1200,
    ArchitectFX = 1205,
    ["Argo CD"] = 56,
    ["Argo Events"] = 57,
    ["Argo Workflows"] = 58,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1269,
    ["Azure IoT Operations connector metadata"] = 1266,
    ...
    ["Azure Pipelines"] = 116,
    ["Azure Static Web Apps CLI configuration file"] = 869,
    ["Azure Static Web Apps configuration file"] = 868,
    BMML = 1288,
    ["BOSH CPI Config"] = 142,
    ...
    ["Bacon config"] = 6,
    ["Barba-CV"] = 85,
    ["Bashly (bashly.yml)"] = 1121,
    ["Bashly Settings (bashly-settings.yml)"] = 1122,
    Bento = 1287,
    ["Better Code Hub"] = 1033,
    ["Better Scripts"] = 165,
    Bigconfig = 135,
    ["Biome Formatter Config"] = 86,
    ["Bitmovin Encoding Template"] = 1214,
    BizTalkServerApplicationSchema = 999,
    Bleep = 166,
    ["Block Protocol Metadata"] = 163,
    ["Bluebricks blueprint config"] = 1293,
    ["Boyka Framework"] = 144,
    ...
    ["Butane Config"] = 1076,
    C4InterFlow = 1229,
    ["CDK Environment Manager, concrete environment configuration"] = 1253,
    ["CDK Environment Manager, concrete environments definition"] = 1252,
    ["CDK Environment Manager, environment definition"] = 1251,
    ["CGS Card Game Specification (cgs.json)"] = 1159,
    ["CICS TS region tagging"] = 1085,
    ["CICS TS resource import"] = 1086,
    ["CICS TS resource model"] = 1087,
    ["CICS TS resource overrides"] = 1088,
    ["CMake Presets"] = 167,
    ["CNC Codes"] = 189,
    ["CRS WAF test file"] = 1189,
    ["CRS WAF test platform overrides file"] = 1190,
    ["CSS Comb (.csscomb.json)"] = 300,
    ["CSS Lint (.csslintrc)"] = 301,
    ["CSpell (cspell.json)"] = 299,
    ["CVE Record Format"] = 201,
    CWL = 1165,
    ["Cache Warmup config"] = 168,
    ["Caido Proxy Configuration"] = 1324,
    ...
    ["Chamaleon environment"] = 1218,
    ["Chamaleon properties"] = 1219,
    ["Chamaleon template"] = 1217,
    Changepacks = 1280,
    Changesets = 284,
    Changie = 176,
    Charmcraft = 177,
    ...
    ["Clawject config"] = 195,
    ["Cloud Foundry Application Manifest"] = 1171,
    ["Cloud Run Spec v1"] = 1195,
    ...
    CodeCV = 100,
    CodeRabbit = 99,
    ["CodeShip Pro services configuration files"] = 254,
    ["CodeShip Pro steps configuration files"] = 255,
    ["Codecov configuration files"] = 253,
    Codex = 248,
    ["Codex Hooks"] = 249,
    CodifyCLI = 101,
    Codux = 251,
    ...
    ["Common Catalog Data"] = 263,
    ["Common Package Specification"] = 193,
    Concord = 1188,
    ["Configu .cfgu files"] = 1176,
    ["Configu .configu file"] = 1177,
    Conjure = 188,
    ["Container Structure Test"] = 1013,
    Containerlab = 1042,
    ["Contextive Glossary"] = 1245,
    Convex = 187,
    ["Crowdsec collection config"] = 294,
    ["Crowdsec parser config"] = 295,
    ["Crowdsec scenario config"] = 296,
    ["CumulusCI Config"] = 194,
    ["Cursor Agent Environment"] = 1298,
    ["Custom Machinery Machine"] = 1160,
    ["Custom Machinery Recipe"] = 1161,
    ["Cycle Stack File"] = 202,
    CycloneDX = 203,
    ["DWP Exchange - catalogue entry"] = 345,
    ["DWP Exchange - gateway"] = 343,
    ["DWP Exchange - meta"] = 344,
    ["Dart Build Config (dart-build.json)"] = 302,
    ["Dart Test Config (dart-test.json)"] = 303,
    ["DashLord Configuration"] = 304,
    ["Data Contract Specification"] = 305,
    ["Data Product Specification"] = 306,
    ["DataYoga Connections"] = 204,
    ["DataYoga Job"] = 205,
    ["Datadog Continuous Testing"] = 536,
    ["Datadog Service Definition"] = 537,
    ["Datadog Software Catalog"] = 538,
    ["Datahub Ingestion Recipe"] = 1092,
    ["Debian Upstream Metadata file"] = 212,
    ["Deck config"] = 213,
    ["Declarative Automation Bundles"] = 1138,
    ["DeepMatch deeplinks spec"] = 214,
    ["Dein Config"] = 215,
    ["Deno Config (deno.json)"] = 312,
    ["Dependency cruiser"] = 216,
    ["DeployStack Configuration"] = 217,
    ["Deployah Configuration"] = 1268,
    ["Deployer Recipe"] = 315,
    ["Deta Spacefile"] = 218,
    ["Detekt Config (detekt.yml)"] = 316,
    ["Devbox Config"] = 219,
    ["Devbox Plugin"] = 220,
    Devfile = 342,
    Devup = 1281,
    DipDup = 1191,
    ["Discord Webhook"] = 317,
    ["DocFx Config (docfx.json)"] = 322,
    ["Docker Desktop extension metadata"] = 319,
    ["Docs MCP Manifest"] = 323,
    Dofigen = 324,
    ["Dolittle Artifacts"] = 325,
    ["Dolittle Bounded Context Configuration"] = 326,
    ["Dolittle Event Horizons Configuration"] = 327,
    ["Dolittle Resources Configuration"] = 328,
    ["Dolittle Server Configuration"] = 329,
    ["Dolittle Tenant Map Configuration"] = 331,
    ["Dolittle Tenants Configuration"] = 330,
    ["Dolittle Topology"] = 332,
    ["DonateCaseBetterCasino menu"] = 1222,
    ...
    ["Drupal Routing"] = 232,
    ["Drupal Services"] = 234,
    ["Drush site aliases"] = 338,
    ["Dynamic Bash Aliases (.aliases)"] = 1129,
    ["EAS config"] = 383,
    ["ECA - Editor Code Assistant"] = 347,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1118,
    ["ESLint Suppressions"] = 388,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1265,
    ["EasyVCR .NET"] = 385,
    ["Eidolon Resource"] = 1206,
    ["Elgato Stream Deck"] = 349,
    Elm = 1193,
    ["Embrace Config"] = 1104,
    Emmet = 1194,
    Endurica = 1142,
    ["Enonic XP API descriptor"] = 352,
    ["Enonic XP Admin Extension descriptor"] = 353,
    ["Enonic XP Admin Tool descriptor"] = 354,
    ["Enonic XP Application descriptor"] = 355,
    ["Enonic XP CMS descriptor"] = 356,
    ["Enonic XP Content Type descriptor"] = 357,
    ["Enonic XP Form Fragment descriptor"] = 358,
    ["Enonic XP ID Provider descriptor"] = 359,
    ["Enonic XP Layout descriptor"] = 360,
    ["Enonic XP Macro descriptor"] = 361,
    ["Enonic XP Mixin descriptor"] = 362,
    ["Enonic XP Page descriptor"] = 363,
    ["Enonic XP Part descriptor"] = 364,
    ["Enonic XP Service descriptor"] = 365,
    ["Enonic XP Site descriptor"] = 366,
    ["Enonic XP Style descriptor"] = 367,
    ["Enonic XP Task descriptor"] = 368,
    ["Enonic XP Webapp descriptor"] = 369,
    ["Enterprise Contract Policy Spec"] = 350,
    ["Envelope Team Definition"] = 1309,
    ["Envilder Map File"] = 351,
    ["Erda Pipeline"] = 1167,
    ["Erda Runtime"] = 1168,
    ["Espanso config.yml"] = 1291,
    ["Espanso match.yml"] = 1290,
    Esquio = 371,
    ["Estuary Flow Catalog"] = 1082,
    ["Ethereum ERC1155"] = 1303,
    ["Ethereum ERC721"] = 1302,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 376,
    ["EveryVoice TTS Toolkit Data Configuration"] = 377,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 381,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 380,
    ["EveryVoice TTS Toolkit Text Configuration"] = 378,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 379,
    ["Evolving Resolutive Process notation"] = 1267,
    ["Expo SDK"] = 382,
    ["Expoot app config"] = 384,
    ["F-Droid Data metadata"] = 390,
    ["FasterCI Configuration"] = 117,
    ["Fence configuration"] = 118,
    FiQuS = 394,
    Firebase = 392,
    ["Flatpak Builder Manifest"] = 395,
    ["FlexGet Config"] = 396,
    ["Flow.json Configurations"] = 1164,
    ["Fossa configuration file"] = 403,
    ["Fossa's fossa-deps file"] = 404,
    ["Foundry VTT - Base package Manifest"] = 398,
    ["Foundry VTT - Module Manifest"] = 399,
    ["Foundry VTT - System Data Template"] = 402,
    ["Foundry VTT - System Manifest"] = 400,
    ["Foundry VTT - World Manifest"] = 401,
    ["Foxx Manifest"] = 119,
    ["Freifunk.de Community API"] = 122,
    ["Frogbot Config"] = 123,
    ["G2P Mapping Configuration"] = 410,
    ["GCP Blueprint Metadata"] = 413,
    Gaspar = 411,
    ["GatewayCore API Gateway"] = 412,
    ["Gemini CLI settings"] = 414,
    ["GeoJSON.json latest"] = 1080,
    GherKing = 1084,
    ["GitHub Action"] = 419,
    ["GitHub Actions typing"] = 1202,
    ["GitHub Discussion"] = 420,
    ["GitHub Funding"] = 421,
    ["GitHub Issue Template configuration"] = 422,
    ["GitHub Issue Template forms"] = 423,
    ["GitHub Pages Jekyll"] = 424,
    ["GitHub Workflow"] = 425,
    ["GitHub Workflow Template Properties"] = 426,
    ["GitHub automatically generated release notes configuration"] = 427,
    ["GitLab Agent for Kubernetes configuration"] = 1156,
    GitVersion = 416,
    ["Gitea Issue Template configuration"] = 417,
    ["Gitea Issue Template forms"] = 418,
    ["Gitpod Automations"] = 429,
    ["Gitpod Configuration"] = 430,
    ["GlazeWM settings"] = 1158,
    ["Global Privacy Control"] = 415,
    Goblet = 1137,
    ["Golangci-lint Configuration"] = 445,
    ["Golangci-lint Custom Plugins Configuration"] = 446,
    ["Google Chrome Related Website Sets"] = 393,
    ["Google Cloud Workflows"] = 271,
    ["Google Digital Assetlinks"] = 1246,
    Goreleaser = 448,
    ["Goreleaser Pro"] = 449,
    Goss = 451,
    ["Gradle Build Cache Node"] = 1031,
    ["Gradle Enterprise"] = 1030,
    ["Grafana 5.x Dashboard"] = 452,
    ["GraphQL Code Generator"] = 457,
    ["GraphQL Config"] = 456,
    ["GraphQL Mesh"] = 455,
    ["GroovyLint configuration"] = 458,
    ["Grunt JSHint task"] = 462,
    ["Grunt Watch task"] = 463,
    ["Grunt base task"] = 464,
    ["Grunt clean task"] = 460,
    ["Grunt copy task"] = 459,
    ["Grunt cssmin task"] = 461,
    HEMTT = 995,
    Hadolint = 1009,
    Hammerkit = 1041,
    ["Hardware Sentry Configuration"] = 1096,
    ["Hashgraph Online Skill Manifest"] = 2,
    ["HashiCorp Vault"] = 465,
    Hatch = 1010,
    Hayson = 467,
    ["Haystack Pipeline"] = 468,
    ["Hazelcast 5 Configuration"] = 469,
    ["Hecate Input Schema"] = 1257,
    ["Helm Chart.lock"] = 236,
    ["Helm Chart.yaml"] = 235,
    ["Helm Unittest Test Suite"] = 237,
    ["Hex file"] = 238,
    ["Home Assistant Integration Manifest"] = 470,
    ["Homer dashboard configuration"] = 471,
    Hugo = 1072,
    ["Hugo Theme"] = 1071,
    ["Hulak Configuration"] = 478,
    ["Hyperfoil benchmark configuration"] = 477,
    ["IBM Zapp document"] = 479,
    ["IBM zCodeFormatSettings"] = 480,
    ["IMG Catapult PSP"] = 485,
    ["IVMS101 by CODE Protocol"] = 1157,
    ["Infinispan Configuration"] = 487,
    ["Infinispan Server Configuration"] = 488,
    Infrahub = 489,
    Istanbul = 1100,
    ["JDownloader2 crawler multi-rules"] = 503,
    ["JDownloader2 crawler single-rules"] = 502,
    ["JFrog Applications Config"] = 504,
    ["JFrog File Spec"] = 505,
    ["JFrog Pipelines YML DSL"] = 1106,
    ["JMeter DSL cli config"] = 506,
    JReleaser = 509,
    ["JSON Document Transform"] = 517,
    ["JSON Feed"] = 518,
    ["JSON Resume"] = 777,
    ["JSON Schema Draft 2020-12"] = 977,
    ["JSON Schema Draft 4"] = 974,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1139,
    ["JSON Schema Draft 7"] = 975,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1140,
    ["JSON Schema Draft 8 (2019-09)"] = 976,
    ["JSON-API"] = 516,
    ["JSON-e templates"] = 1038,
    ["JSON-stat 2.0"] = 970,
    JSONPatch = 520,
    ["JSR Package Config (jsr.json)"] = 510,
    Jarl = 1273,
    Jasmine = 497,
    Jekyll = 498,
    ["Jenkins X Pipelines"] = 499,
    ["Jenkins X Requirements"] = 500,
    Jest = 501,
    Jocker = 507,
    ["Jovo Language Models"] = 508,
    ["Jujutsu (jj) VCS config"] = 1259,
    ["KIMMDY config file"] = 531,
    ["KODE/CI build.yaml"] = 1102,
    ["KSP-AVC"] = 971,
    ["KSP-CKAN"] = 972,
    ["KSP-NetKAN"] = 973,
    KSY = 1169,
    KSail = 408,
    ["KYA Manifest"] = 1170,
    ["Karakum configuration file"] = 405,
    Kas = 523,
    ["Kestra flow file"] = 532,
    ["Keycloak REST API"] = 1109,
    ["Knative Functions - func.yaml"] = 406,
    Knip = 407,
    ["Knowledge Unit"] = 540,
    ["Kometa (nightly) config file"] = 534,
    ["Kometa config file"] = 533,
    ["Kong DBLess config"] = 1103,
    KrakenD = 535,
    ["Kubri Configuration"] = 543,
    LOOBin = 558,
    ["Lake configuration file"] = 1262,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 276,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 277,
    ["Landing Zone Accelerator on AWS - Global Config"] = 278,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 279,
    ["Landing Zone Accelerator on AWS - Network Config"] = 280,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 281,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 282,
    ["Landing Zone Accelerator on AWS - Security Config"] = 283,
    ["Lando (landofile)"] = 112,
    ["LangGraph Platform configuration"] = 1181,
    ["Language configuration"] = 1180,
    Lefthook = 547,
    ["Liferay client-extension.yaml"] = 554,
    ["LinkML Metamodel"] = 556,
    Liquibase = 1047,
    ["Liquibase Flow File"] = 1048,
    ["Lively Properties"] = 557,
    ["Lobe AI Agent"] = 114,
    Loki = 115,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 600,
    ["MS2Rescore Configuration"] = 605,
    ["Madness (madness.yml)"] = 1120,
    ["Mado configuration"] = 564,
    ["Maestro Flow"] = 565,
    ["Mail Servers Configuration"] = 1294,
    ["MapEHR Mapping"] = 566,
    Markdownlint = 1051,
    ["Mason Registry"] = 1054,
    ["MegaLinter Custom Flavor"] = 569,
    ["MegaLinter configuration"] = 568,
    ["MegaLinter descriptor"] = 570,
    Melange = 1147,
    ["Meltano project definition"] = 571,
    ["Mergify Configuration"] = 606,
    ["Metadata for a Bazel module"] = 572,
    ["Metadata for a Cinnamon spice"] = 1198,
    ["Metatype Configuration"] = 573,
    ["MetricsHub Configuration"] = 574,
    ["MetricsHub Connector Configuration"] = 575,
    ["Micro Editor Syntax"] = 1130,
    ["Microsoft Band Web Tile"] = 576,
    ["Microsoft RulesEngine workflow rules"] = 1185,
    ["Microsoft RulesEngine workflow rules list"] = 1186,
    ["Minecraft Custom Main Menu Mod"] = 1148,
    ["Minecraft Data Pack Advancement"] = 578,
    ["Minecraft Data Pack Biome"] = 579,
    ["Minecraft Data Pack Configured Carver"] = 580,
    ["Minecraft Data Pack Damage Type"] = 581,
    ["Minecraft Data Pack Dimension"] = 583,
    ["Minecraft Data Pack Dimension Type"] = 582,
    ["Minecraft Data Pack Item Modifier"] = 584,
    ["Minecraft Data Pack Loot Table"] = 585,
    ["Minecraft Data Pack Metadata"] = 586,
    ["Minecraft Data Pack Predicate"] = 587,
    ["Minecraft Data Pack Recipe"] = 588,
    ["Minecraft Data Pack Tag"] = 589,
    ["Minecraft Data Pack Template Pool"] = 590,
    ["Minecraft Data Pack Trim Material"] = 595,
    ["Minecraft Data Pack Trim Pattern"] = 596,
    ["Minecraft Resource Pack Lang"] = 591,
    ["Minecraft Resource Pack Particle"] = 592,
    ["Minecraft Resource Pack Texture Mcmeta"] = 594,
    ["Minecraft Resourcepack Sounds"] = 593,
    ["MockServer Expectations"] = 602,
    ModuleAssembler = 598,
    ["Monade CLI Stack Configuration"] = 609,
    ["MongoDB Atlas Search Index Definition"] = 1101,
    ["Monika Configuration"] = 1099,
    ["Monoweave Configuration"] = 604,
    ["Motif config"] = 991,
    MultiQC = 1239,
    ["NOX Framework (Service)"] = 627,
    ["Netin Diagnostic System Template"] = 1058,
    ["Netlify config"] = 612,
    ["Network-as-Code Data Model"] = 613,
    ["Next Gen UI Agent A2A Server Configuration"] = 614,
    ["Next Gen UI Agent Configuration"] = 616,
    ["Next Gen UI Agent MCP Server Configuration"] = 615,
    ["Nightwatch.js"] = 620,
    ["Node.js configuration"] = 996,
    ["NueJS configuration file"] = 632,
    ["Nuitka Package Config"] = 1162,
    ["Nullstone config"] = 634,
    ["ONe's changelog entry"] = 653,
    ["ONe's service descriptor"] = 652,
    ["ORT Server repository environment configuration"] = 663,
    ["OSCAL Assessment Plan (AP)"] = 665,
    ["OSCAL Assessment Results (AR)"] = 666,
    ["OSCAL Catalog"] = 667,
    ["OSCAL Component Definition (CDef)"] = 668,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 669,
    ["OSCAL Profile"] = 670,
    ["OSCAL System Security Plan (SSP)"] = 671,
    ["OSS Review Toolkit configuration"] = 672,
    ["OSS Review Toolkit curation"] = 673,
    ["OSS Review Toolkit package configuration"] = 674,
    ["OSS Review Toolkit project package manager definition"] = 675,
    ["OSS Review Toolkit repository configuration"] = 676,
    ["OSS Review Toolkit resolutions"] = 677,
    ["October CMS columns"] = 638,
    ["October CMS fields"] = 639,
    ["Oh My Posh"] = 641,
    Okteto = 642,
    ["Ona Automations"] = 644,
    Opctl = 994,
    ["Open Data Contract Standard (ODCS)"] = 657,
    ["Open Data Product Standard (ODPS)"] = 658,
    ["Open Know-How"] = 1244,
    OpenDecree = 1307,
    ["OpenDecree Configuration"] = 1308,
    ["OpenRewrite Resource"] = 655,
    OpenSRM = 659,
    OpenStatus = 1255,
    ["OpenTelemetry Declarative Configuration"] = 656,
    ["OpenUtau character yaml"] = 649,
    ["OpenUtau ustx"] = 650,
    ["OpenWeather Current Weather API"] = 1037,
    ["OpenWeather Road Risk API"] = 1036,
    ["Ory Hydra configuration"] = 476,
    ["Ory Keto configuration"] = 539,
    ["Ory Kratos configuration"] = 664,
    ["Ory Oathkeeper configuration"] = 636,
    ["Outblocks App configuration"] = 661,
    ["Outblocks database table"] = 662,
    ["Outblocks project configuration"] = 660,
    PDM = 685,
    POPxf = 697,
    ["POPxf Correlations"] = 698,
    ["PRML manifest"] = 705,
    Packer = 681,
    PactSpec = 682,
    Panache = 683,
    Pantsbuild = 1116,
    ["Paper paper-plugin.yml"] = 684,
    ["Pipeline component"] = 1049,
    ["Platform.sh application"] = 8,
    ["Platform.sh routes"] = 9,
    ["Platform.sh services"] = 10,
    ["Plex Prerolls"] = 695,
    ["PocketMine plugin.yml"] = 692,
    ["Podman Desktop Extension"] = 1326,
    ["Postman collection"] = 701,
    ["Power Pages Configuration"] = 1256,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1201,
    ["ProActions AI-Kit Configuration"] = 713,
    ["ProActions AI-Kit Configuration for Menus"] = 715,
    ["ProActions AI-Kit Configuration for Sections"] = 717,
    ["ProActions AI-Kit Configuration for Services"] = 714,
    ["ProActions AI-Kit Configuration for Steps"] = 718,
    ["ProActions AI-Kit Configuration for Templates"] = 716,
    ["Problem object RFC9457"] = 1145,
    ["Problem package format"] = 719,
    ["Problem package generators"] = 720,
    ["Problem package submissions"] = 721,
    ["Problem package test group metadata"] = 722,
    Pterodactyl = 1095,
    ["Pull Request Labeler"] = 739,
    Pulumi = 747,
    ["PyGTA Config"] = 743,
    PyProject = 748,
    Pylock = 1247,
    Pyright = 749,
    ["Python script metadata"] = 1241,
    ["QType AI DSL"] = 752,
    Qgoda = 751,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1318,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1316,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1322,
    ["Qlik Talend Cloud Pipeline - Project"] = 1314,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1317,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1319,
    ["Qlik Talend Cloud Pipeline - Task"] = 1315,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1321,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1320,
    Qodana = 1068,
    ["Qt Creator workspace file"] = 1178,
    ["Quali Torque Blueprint Spec 2"] = 1093,
    ["QueryFirst config file"] = 1112,
    ["QuikRun Configuration"] = 1323,
    ["Qwen Code Settings"] = 1304,
    ["RKE Cluster Configuration JSON"] = 1046,
    ["RKE Cluster Configuration YAML"] = 1045,
    RadioHound = 742,
    ["Raid Profile"] = 1305,
    ["Raid Repo Configuration"] = 1306,
    Railpack = 754,
    Railway = 753,
    ["Rancher Fleet"] = 744,
    ["Rattler-build"] = 755,
    Ray = 1008,
    ["Read the Docs"] = 746,
    ["Red-DiscordBot Cog"] = 762,
    ["Red-DiscordBot Cog Repo"] = 763,
    ["Red-DiscordBot Trivia"] = 764,
    ["Releasaurus Config"] = 5,
    ReleaseKit = 4,
    ["Render Blueprints"] = 1044,
    RenderCV = 781,
    Renovate = 778,
    ["Renovate global configuration"] = 779,
    ["Renovate inherited configuration"] = 780,
    ["Replit config"] = 770,
    Restate = 1234,
    ["Revel Digital Gadget Definition File"] = 1258,
    RoadRunner = 783,
    ["Robust Station Image"] = 1264,
    Rockcraft = 784,
    ["Roo Coder Custom Modes"] = 785,
    Rubocop = 774,
    ["Rudder techniques"] = 1152,
    Ruff = 775,
    ["Rust Project"] = 776,
    ["Rust toolchain"] = 790,
    ["SDMX data message"] = 817,
    ["SDMX metadata message"] = 816,
    ["SDMX structure message"] = 815,
    ["SIL Kit Participant Configuration"] = 827,
    ["SIL Kit Registry Configuration"] = 828,
    ["SPDX 2.3"] = 866,
    SWADL = 882,
    ["Safebox Config"] = 1107,
    ["Sapphire CLI Config"] = 793,
    ["SauceCTL Configuration"] = 1055,
    Scarb = 813,
    ["Schema Catalog"] = 808,
    ["Scoop manifest"] = 814,
    ["Semantic Data Fabric (SDF) file"] = 818,
    ["Semgrep Rule"] = 820,
    ["Serenity Code Generator (Sergen)"] = 821,
    ["Serverless Framework Configuration"] = 1062,
    ["Serverless Workflow"] = 1064,
    ["Settings for a Cinnamon spice"] = 1197,
    ["Settings.paf"] = 823,
    ["Shopware 6 Configuration"] = 1065,
    ["Shopware CLI Extension Store Configuration"] = 1066,
    ["Shopware CLI Project Store Configuration"] = 1067,
    ["Sigma Detection Rule"] = 825,
    ["Sigrid scope configuration file"] = 826,
    ["SkyPilot Task JSON"] = 1153,
    ["Slack app manifest"] = 830,
    Snapcraft = 832,
    ["Solarxy project config"] = 835,
    Solidarity = 836,
    ["Solution filters"] = 837,
    ["Source Maps v3"] = 838,
    Sourcery = 839,
    ["Spack bootstrap.yaml"] = 840,
    ["Spack cdash.yaml"] = 841,
    ["Spack ci.yaml"] = 842,
    ["Spack compilers.yaml"] = 843,
    ["Spack concretizer.yaml"] = 844,
    ["Spack config.yaml"] = 845,
    ["Spack definitions.yaml"] = 846,
    ["Spack develop.yaml"] = 847,
    ["Spack env_vars.yaml"] = 848,
    ["Spack environment"] = 854,
    ["Spack include.yaml"] = 849,
    ["Spack mirrors.yaml"] = 850,
    ["Spack modules.yaml"] = 851,
    ["Spack packages.yaml"] = 852,
    ["Spack repos.yaml"] = 853,
    ["Spack toolchains.yaml"] = 855,
    ["Spack upstreams.yaml"] = 856,
    ["Spack view.yaml"] = 857,
    ["Speakeasy Generation Config File"] = 861,
    ["Speakeasy Lint Configuration File"] = 858,
    ["Speakeasy Test Generation Configuration File"] = 859,
    ["Speakeasy Workflow File"] = 860,
    SpecIF = 862,
    ["Specmatic Configuration"] = 863,
    ["Sponge Mixin configuration"] = 864,
    StackBlitz = 870,
    ["StackHawk Scanner Configuration"] = 1061,
    Stale = 871,
    Starfish = 872,
    ["Starlake Data Pipeline"] = 1034,
    Starship = 873,
    ["Statamic Blueprint"] = 874,
    ["Stella configuration file"] = 875,
    ["Streamlit configuration file"] = 876,
    ["Stryker Mutator"] = 879,
    ["StyleCop Analyzers Configuration"] = 880,
    ["Stylelint (.stylelintrc)"] = 881,
    ["Stylua Config"] = 1248,
    ["Sublime Syntax"] = 1108,
    ["Subsquid squid manifest"] = 1155,
    ["Swagger API 2.0"] = 883,
    ["Synadia Connect Component"] = 884,
    TSON = 920,
    TSTyche = 921,
    ["TYPO3 Vendor Bundler config"] = 927,
    ["Tab data for a LinUtil"] = 1204,
    ["Tab list for a LinUtil"] = 1203,
    Tach = 885,
    ["Tach Domain"] = 886,
    Talhelper = 888,
    ["Talisman configuration"] = 889,
    Taplo = 1249,
    ["Taskfile config"] = 1039,
    Taurus = 890,
    Tauticord = 891,
    ["Tekton Pipeline"] = 1277,
    ["Tekton PipelineRun"] = 1278,
    ["Tekton Task"] = 1275,
    ["Tekton TaskRun"] = 1276,
    Telefonistka = 1235,
    ["Terrateam config"] = 1261,
    ["TestEnvironment.json"] = 903,
    ["TextMate Grammar"] = 902,
    Threagile = 897,
    ["Tier.run pricing.json"] = 894,
    Tikibase = 895,
    Tombi = 900,
    ["Traefik v2"] = 906,
    ["Traefik v2 File Provider"] = 907,
    ["Traefik v3"] = 908,
    ["Traefik v3 File Provider"] = 909,
    ["Travis CI (.travis.yml)"] = 905,
    Treefmt = 454,
    Trident = 1231,
    ["TrueScript for *.tscript files"] = 912,
    ["Tugboat QA config.yml"] = 1228,
    TunnelHub = 1143,
    Turborepo = 904,
    Tycho = 1192,
    Tye = 1069,
    ["Tyk Gateway - Open Source v5.7+"] = 1240,
    ["UET BuildConfig.json"] = 1113,
    ["UI5 Manifest"] = 933,
    ["UNCORS configuration"] = 938,
    ["UTAM Page Object"] = 936,
    ["Ubuntu Server Autoinstall"] = 931,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1232,
    ["Uniswap Token List"] = 1019,
    ["Universal Schedule Format"] = 939,
    ["Unreal Engine Uplugin"] = 1114,
    ["Unreal Engine Uproject"] = 1115,
    ["UpCloud CLI (upctl) configuration"] = 1233,
    ["Updatecli Compose"] = 1077,
    ["Updatecli Policy Manifest"] = 1078,
    ["Updatecli Policy Metadata"] = 1079,
    Uplift = 1111,
    ["Upsun config"] = 7,
    ["User Journey Map"] = 1043,
    V2Ray = 1083,
    ["VSCode Code Snippets"] = 259,
    ["VSIX CLI publishing"] = 957,
    Vector = 941,
    ["Vela Pipeline Configuration"] = 944,
    Vercel = 258,
    ["Version Bumper config"] = 947,
    Vespertide = 1282,
    ["Vespertide Migration"] = 1283,
    ["Vespertide Model"] = 1284,
    ["Viash Component Config"] = 1237,
    ["Viash Package Config"] = 1238,
    Visivo = 1141,
    ["WP-CLI"] = 967,
    Wake = 1230,
    ["Waku Config"] = 1207,
    ["Web App Manifest"] = 963,
    ["Web types"] = 966,
    WebExtensions = 962,
    ["Webman package recipe"] = 1089,
    ["Windows Package Manager Installer Manifest"] = 1016,
    ["Windows Package Manager Locale Manifest"] = 1017,
    ["Windows Package Manager Singleton Manifest"] = 1015,
    ["WireMock CLI import configuration"] = 1213,
    ["WireMock CLI local service configuration"] = 1212,
    ["WireMock message stub mapping"] = 1211,
    ["WireMock stub mapping"] = 1210,
    ["Woodpecker pipeline config"] = 1057,
    ["Wrangler CLI"] = 968,
    ["XenForo add-on manifest"] = 969,
    ["Xstate Machine"] = 1075,
    ["Yandex Workflow Language"] = 1199,
    ["Yarn Config (.yarnrc.yml)"] = 1032,
    ["Yippee-Ki-JSON configuration YML"] = 1023,
    ["YouTrack App"] = 1196,
    ["Zarf Package Configuration"] = 1263,
    ["Zerops import file"] = 1184,
    ["Zola Configuration"] = 1274,
    ["aerleon.yml"] = 21,
    ["amplify.yml"] = 14,
    ["amxx-builder manifest"] = 1325,
    ["angular.json"] = 38,
    apko = 1146,
    ...
    ["behat.yml"] = 145,
    ["bigquery-table"] = 134,
    ["bioimageio resource description"] = 1163,
    ...
    ["cargo-nextest repository configuration"] = 617,
    ["cargo-nextest user configuration"] = 618,
    ["ccmod.json"] = 1208,
    changelogging = 1175,
    ["chisel-slices.json"] = 285,
    ["chrome-extension-locales-messages.json"] = 266,
    ["chutzpah.json"] = 267,
    cibuildwheel = 182,
    ["clang-format (.clang-format)"] = 1081,
    ["clang-tidy"] = 244,
    clangd = 243,
    clib = 245,
    ["cloud-init: cloud-config userdata"] = 247,
    ["cloud-sdk-pipeline-configuration"] = 269,
    ["cloudbuild.json"] = 270,
    cloudify = 246,
    cmakefmt = 200,
    ["cmdx.yaml"] = 98,
    ...
    ["coffeelint.json"] = 287,
    ["commands.json"] = 262,
    ["commitlint (.commitlintrc)"] = 1018,
    ["committed.toml"] = 288,
    ["compile_commands.json"] = 261,
    ["compilerconfig.json"] = 260,
    ["completely.yml"] = 1119,
    ["component-detection-manifest.json"] = 291,
    ["component.json"] = 290,
    ["composer.json"] = 289,
    ["conda-forge"] = 186,
    ["config.yaml"] = 745,
    ["contentmanifest.json"] = 268,
    ["contribute.json"] = 292,
    ["cosmos.config.json"] = 264,
    ["crowdin.yml"] = 293,
    ["ctfd-setup configuration file"] = 1220,
    ["custom-elements.json"] = 1133,
    ["cypress.json"] = 297,
    ["dacier.yml"] = 1313,
    ["datalogic-scan2deploy-android"] = 307,
    ["datalogic-scan2deploy-ce"] = 308,
    ...
    ["ddev-global"] = 309,
    ["ddev-project"] = 310,
    ["debugsettings.json"] = 311,
    ["dependabot-v2.json"] = 314,
    ["dependabot.json"] = 313,
    ["deployed-cli"] = 1074,
    ["devcontainer.json"] = 252,
    devinit = 1025,
    ["devspace.yaml"] = 1097,
    djlint = 1026,
    ["docker bake"] = 320,
    ["docker sequencer"] = 321,
    ["docker-compose.yml"] = 1024,
    ["dockerd.json"] = 318,
    ["dotnet Release Index manifest"] = 333,
    ["dotnet-tools.json"] = 334,
    ["dotnetcli.host.json"] = 335,
    ["dprint.json"] = 336,
    ["drone.json"] = 337,
    ["dss-2.0.0.json"] = 339,
    ["dstack configuration"] = 340,
    ["dtool dataset metadata"] = 1215,
    ["dvc.yaml"] = 341,
    ["ecosystem.json"] = 346,
    eksctl = 348,
    ["electron-builder configuration file"] = 374,
    ["epr-manifest.json"] = 373,
    ["estampo.toml"] = 372,
    ["evcc.yaml"] = 375,
    ["ezd task runner"] = 386,
    ["fabric.mod.json"] = 389,
    ["first-timers-bot"] = 397,
    ["flagd flag configuration"] = 120,
    ["fly.io Configuration"] = 121,
    fulibWorkflows = 1056,
    ["function.json"] = 409,
    ["gRPC API Gateway & OpenAPI Config"] = 16,
    ["gematik health care insurance list"] = 1226,
    ["gematik health care patient list"] = 1223,
    ["gematik health care provider institution list"] = 1225,
    ["gematik health care provider list"] = 1224,
    ["gematik tiger test environment configuration"] = 1227,
    ["git-town.toml"] = 1272,
    ["gitlab-ci"] = 428,
    ["global.json"] = 444,
    ["go-feature-flag Flag Configuration"] = 447,
    ["haxelib.json"] = 466,
    helmfile = 1011,
    helmwave = 1012,
    ["host-meta.json"] = 473,
    ...
    ["ide.host.json"] = 481,
    ["ifstate.yaml"] = 482,
    ["imageoptimizer.json"] = 483,
    ["importmap.json"] = 486,
    instant_python_config = 490,
    instant_python_custom_project = 491,
    intlayer = 492,
    ["ioBroker Configuration"] = 493,
    ["ioBroker JSON UI"] = 494,
    ["ioBroker Package manifest"] = 495,
    ["ixpect.conf.yaml"] = 496,
    ["ize.toml"] = 1110,
    ["jsconfig.json"] = 521,
    ["jscpd Configuration"] = 1094,
    jsdoc = 1007,
    ["k3d.yaml"] = 522,
    ["k9s aliases.yaml"] = 524,
    ["k9s cluster-config.yaml"] = 526,
    ["k9s config.yaml"] = 525,
    ["k9s hotkeys.yaml"] = 527,
    ["k9s plugins.yaml"] = 528,
    ["k9s skin.yaml"] = 529,
    ["k9s views.yaml"] = 530,
    ["kontinuous-config.yaml"] = 542,
    ["kontinuous-values.yaml"] = 541,
    ["kustomization.yaml"] = 544,
    ["label-commenter-config.yml"] = 545,
    ["latexindent configuration"] = 113,
    ["launchsettings.json"] = 546,
    lazydocker = 1132,
    lazygit = 1131,
    ["lego.json"] = 548,
    ["lerna.json"] = 549,
    ["lgtm.yml"] = 550,
    ["liblab.config.json"] = 551,
    ["libman.json"] = 552,
    ["license-report-config.json"] = 553,
    ["linkinator.config.json"] = 555,
    ["lint-staged (.lintstagedrc)"] = 985,
    ["local.settings.json"] = 560,
    ["localazy.json"] = 561,
    ["lotus.yaml"] = 559,
    ["lsdlschema.json"] = 562,
    ["macro.json"] = 1098,
    ["markdown-link-check"] = 1052,
    maturin = 1053,
    mboats = 1060,
    memnex = 1311,
    ["micro-settings.json"] = 1125,
    ["mimetypes.json"] = 577,
    ["mirrord config"] = 987,
    mise = 988,
    ["mkdocs.yml"] = 597,
    ...
    ["monospace.yml"] = 603,
    ["moon.yml"] = 1209,
    ["mprocs Configuration file"] = 1179,
    ["mrdocs.yml"] = 599,
    ["mta.yaml"] = 989,
    ["mtad.yaml"] = 990,
    ["mycode.json"] = 610,
    nFPM = 619,
    ["napari plugin manifest"] = 611,
    neoload = 1002,
    ["nest-cli"] = 622,
    ["nexus-rpc-gen"] = 1299,
    ["ninjs (News in JSON)"] = 621,
    ["nitro.json"] = 1001,
    ["nixd configuration"] = 1151,
    ["nlu.json"] = 623,
    ["nodemon.json"] = 625,
    ["noodl config"] = 1059,
    ["notebook.mod.json"] = 626,
    now = 997,
    ["npm-badges"] = 629,
    ["nswag.json"] = 633,
    ntangle = 635,
    ["nuclei-template.yaml"] = 630,
    ["nuget-project.json"] = 631,
    ["ocelot.json"] = 637,
    ogen = 640,
    ["omnisharp.json"] = 643,
    openHAB = 1285,
    ...
    oxlint = 1296,
    ["package.json"] = 678,
    ["package.manifest"] = 680,
    ["package.yaml"] = 679,
    ["partial-black.json"] = 146,
    ["partial-fastapi.json"] = 147,
    ["partial-pixi.json"] = 690,
    ["partial-scheduled.json"] = 148,
    ["pattern.json"] = 688,
    ["petstore-v1.0"] = 1105,
    pgap_yaml_input_reader = 686,
    pgrls = 687,
    pgxgen = 1289,
    pitcms = 1292,
    ["pixi.toml"] = 689,
    ["plagiarize-me.yaml"] = 694,
    ["plagiarize.yaml"] = 693,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1216,
    ["podbard.yaml"] = 696,
    ["portman.json"] = 699,
    ["prefect.toml"] = 708,
    ["prefect.yaml"] = 709,
    ...
    ["prettierrc.json"] = 711,
    ["prisma.yml"] = 712,
    ["project-1.0.0-beta3.json"] = 724,
    ["project-1.0.0-beta4.json"] = 725,
    ["project-1.0.0-beta5.json"] = 726,
    ["project-1.0.0-beta6.json"] = 727,
    ["project-1.0.0-beta8.json"] = 728,
    ["project-1.0.0-rc1.json"] = 729,
    ["project-1.0.0-rc2.json"] = 730,
    ["project.json"] = 723,
    ["project.owasp.yaml"] = 731,
    ["prometheus-alertmanager.json"] = 735,
    ["prometheus.json"] = 732,
    ["prometheus.rules.json"] = 733,
    ["prometheus.rules.test.json"] = 734,
    ["proxies.json"] = 736,
    ["publiccode.yml"] = 737,
    ["pubspec.yaml"] = 738,
    ["pyrseas-0.8.json"] = 741,
    pytest = 750,
    ["quilt.mod.json"] = 1126,
    ["rc3 auth"] = 756,
    ["rc3 collection"] = 757,
    ...
    ["rc3 settings"] = 761,
    ["registry.yaml"] = 51,
    ["release drafter"] = 1003,
    ["release-hub.json"] = 3,
    ["release-please-config.json"] = 766,
    ["release-please-manifest.json"] = 767,
    ["release-plz.toml"] = 768,
    ["renv.lock"] = 782,
    ["reposets Configuration"] = 771,
    ["reposets Credentials"] = 772,
    ["revola.json"] = 1,
    ["rivet.json"] = 1150,
    ["rivet.yaml (legacy)"] = 1149,
    rumdl = 787,
    runny = 786,
    runspec = 1312,
    rustfmt = 788,
    ...
    samt = 791,
    samtrc = 792,
    ["sarif-1.0.0.json"] = 794,
    ["sarif-2.0.0.json"] = 795,
    ["sarif-2.1.0"] = 805,
    ["sarif-2.1.0-rtm.2"] = 796,
    ["sarif-2.1.0-rtm.3"] = 798,
    ["sarif-2.1.0-rtm.4"] = 800,
    ["sarif-2.1.0-rtm.5"] = 802,
    ["sarif-2.1.0-rtm.6"] = 803,
    ["sarif-external-property-file-2.1.0"] = 806,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 797,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 799,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 801,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 804,
    ["scalingo.json configuration"] = 807,
    ["schema.org - Action"] = 809,
    ["schema.org - ContactPoint"] = 810,
    ["schema.org - Place"] = 811,
    ["schema.org - Thing"] = 812,
    ["secrethub.yml"] = 1128,
    ["semantic-release"] = 819,
    ["servicehub.config.json"] = 980,
    ["servicehub.service.json"] = 979,
    ["settings.job"] = 822,
    ["sfdx-hardis configuration"] = 824,
    ["shard.yml"] = 1166,
    ["size-limit configuration"] = 829,
    ["skaffold.yaml"] = 1050,
    ["skyuxconfig.json"] = 831,
    ["snowflake-config"] = 833,
    ["snowflake-connections"] = 834,
    ["spicepod.yaml"] = 1187,
    ["sqlc configuration"] = 867,
    ["stripe-app-local.json"] = 878,
    ["stripe-app.json"] = 877,
    swcrc = 1035,
    ["task.json"] = 887,
    taskcat = 998,
    ["template.json"] = 892,
    ["templatsources.json"] = 893,
    ["text2confl config"] = 1297,
    ["theme.json"] = 896,
    ["tizen_workspace.json"] = 898,
    tldr = 899,
    ["tm_devices configuration file"] = 1254,
    tmuxinator = 983,
    tox = 901,
    ["transcend.yml"] = 910,
    ["tree-sitter grammar.json"] = 453,
    ["trime.yaml"] = 911,
    ["trunk.yaml"] = 913,
    ["ts-force-config.json"] = 918,
    ["tsconfig.json"] = 914,
    ["tsd.json"] = 915,
    ["tsdoc.json"] = 916,
    ["tsdrc.json"] = 917,
    ...
    v8r = 961,
    vcluster = 1173,
    ["vcpkg configuration file"] = 257,
    ["vcpkg manifest file"] = 256,
    ["vega-lite.json"] = 943,
    ["vega.json"] = 942,
    ["venvironment.yaml"] = 945,
    ["venvplus.yaml"] = 946,
    version = 1236,
    ["version.json"] = 948,
    ["vhwdebugger-binding.yaml"] = 950,
    ["vim-addon-info"] = 951,
    ["vs-2017.3.host.json"] = 953,
    ["vs-nesting.json"] = 954,
    ["vsls.json"] = 952,
    ["vss-extension.json"] = 958,
    vtcfg = 1242,
    ["vtesttree.yaml"] = 959,
    ["vtestunit.yaml"] = 960,
    ["warp-keysets.json"] = 1134,
    ["warp-themes.json"] = 1135,
    ["warp-workflows.json"] = 1136,
    ["webhint.io"] = 1090,
    ["webjobpublishsettings.json"] = 965,
    ["webjobs-list.json"] = 964,
    ["well-known-fursona"] = 1174,
    ["xs-app.json"] = 993,
    ["xunit.runner.json"] = 978,
    yamlfmt = 1020,
    yamllint = 1021,
    ["yap.json"] = 1022,
    ["zerops.yml"] = 1183,
