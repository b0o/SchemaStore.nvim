...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 797,
    [".nodehawkrc"] = 499,
    [".npmpackagejsonlintrc"] = 503,
    [".omletrc"] = 971,
    [".phrase.yml"] = 564,
    [".phraseapp.yml"] = 565,
    [".pmbot.yml"] = 552,
    [".postcssrc"] = 559,
    [".powerpages-web-template-manifest"] = 561,
    [".pre-commit-config.yml"] = 562,
    [".pre-commit-hooks.yml"] = 563,
    [".putout.json"] = 586,
    [".rehyperc"] = 609,
    [".remarkrc"] = 613,
    [".sprite files"] = 680,
    ...
    ["A micro editor config"] = 452,
    ABCInventoryModuleData = 14,
    ABCSupplyPlan = 15,
    AIConfig = 16,
    ["AMX Muse Program Descriptor"] = 1015,
    ["API Builder"] = 832,
    ["AVA Configuration"] = 894,
    ["AWS AppConfig Feature Flags-v1"] = 43,
    ["AWS CDK cdk.json"] = 203,
    ["AWS CloudFormation"] = 204,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 205,
    ["AWS SAM CLI Samconfig"] = 206,
    ["Adobe UXP Manifest"] = 954,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    Air = 12,
    ["Airlock Microgateway"] = 17,
    ["Alacritty Configuration"] = 866,
    ["All Contributors configuration file"] = 919,
    ["Ansible Argument Specs"] = 336,
    ["Ansible Collection Galaxy"] = 343,
    ["Ansible Execution Environment"] = 333,
    ["Ansible Inventory"] = 342,
    ["Ansible Meta"] = 334,
    ["Ansible Meta Runtime"] = 335,
    ["Ansible Navigator Configuration"] = 345,
    ["Ansible Playbook"] = 340,
    ["Ansible Requirements"] = 337,
    ["Ansible Rulebook"] = 341,
    ["Ansible Tasks File"] = 339,
    ["Ansible Vars File"] = 338,
    ["Ansible-lint Configuration"] = 344,
    Any = 980,
    ["AnyWork Automation Configuration"] = 5,
    ["App config Spotify Backstage"] = 21,
    ["Application Accelerator"] = 2,
    ["Application list for a WinUtil"] = 997,
    ArchitectFX = 1002,
    ["Argo Events"] = 33,
    ["Argo Workflows"] = 34,
    AssemblyScript = 37,
    AsyncAPI = 38,
    ["AsyncAPI Tool File"] = 39,
    ["Atmos Manifests"] = 40,
    ["Aurora Agile Meta-Framework"] = 41,
    AutoAPICase = 929,
    ["Avro Avsc"] = 42,
    ["Azure Container App template for defining an immutable revision"] = 44,
    ["Azure DevOps extension manifest"] = 47,
    ["Azure Device Update for IoT Hub import manifest"] = 45,
    ["Azure Device Update for IoT Hub update manifest"] = 46,
    ["Azure IoT Edge deployment"] = 50,
    ["Azure IoT Edge deployment template"] = 51,
    ["Azure IoT EdgeAgent deployment"] = 48,
    ["Azure IoT EdgeHub deployment"] = 49,
    ["Azure Landing Zones Library archetype definition"] = 55,
    ["Azure Landing Zones Library archetype override"] = 56,
    ["Azure Landing Zones Library architecture definition"] = 54,
    ["Azure Landing Zones Library metadata"] = 52,
    ["Azure Landing Zones Library policy default values"] = 53,
    ["Azure Pipelines"] = 70,
    ["Azure Static Web Apps CLI configuration file"] = 684,
    ["Azure Static Web Apps configuration file"] = 683,
    ["BOSH Deploy Config"] = 94,
    ["BX CI"] = 112,
    ["Bashly (bashly.yml)"] = 923,
    ["Bashly Settings (bashly-settings.yml)"] = 924,
    ["Better Code Hub"] = 836,
    ["Better Scripts"] = 113,
    Bigconfig = 87,
    ["Biome Formatter Config"] = 57,
    ["Bitmovin Encoding Template"] = 1008,
    BizTalkServerApplicationSchema = 804,
    Bleep = 114,
    ["Block Protocol Metadata"] = 111,
    ["Boyka Framework"] = 95,
    Briefcase = 810,
    ["Build Info"] = 102,
    Buildkite = 104,
    ["Bukkit plugin.yml"] = 103,
    ["BungeeCord plugin.yml"] = 109,
    ["Butane Config"] = 879,
    C4InterFlow = 1023,
    ["CGS Card Game Specification (cgs.json)"] = 959,
    ["CICS TS region tagging"] = 888,
    ["CICS TS resource import"] = 889,
    ["CICS TS resource model"] = 890,
    ["CICS TS resource overrides"] = 891,
    ["CMake Presets"] = 115,
    ["CNC Codes"] = 132,
    ["CRS WAF test file"] = 987,
    ["CRS WAF test platform overrides file"] = 988,
    ["CSS Comb (.csscomb.json)"] = 231,
    ["CSS Lint (.csslintrc)"] = 232,
    ["CSpell (cspell.json)"] = 230,
    ["CVE Record Format"] = 139,
    CWL = 965,
    ["Cache Warmup config"] = 116,
    ["Calqulus pipeline"] = 117,
    ["Camel YAML DSL"] = 118,
    ["Cannon TOML"] = 119,
    Carafe = 120,
    ["Cargo Make"] = 122,
    ["Cargo Manifest"] = 121,
    ["Catalog Info Backstage"] = 123,
    ["Chamaleon environment"] = 1012,
    ["Chamaleon properties"] = 1013,
    ["Chamaleon template"] = 1011,
    Changesets = 215,
    Charmcraft = 124,
    Cheatsheets = 876,
    ["Chrome Extension"] = 196,
    ["Chromia Model"] = 125,
    ["CircleCI config.yml"] = 172,
    ["Citation File Format"] = 217,
    CityJSON = 127,
    ["Clawject config"] = 138,
    ["Cloud Foundry Application Manifest"] = 970,
    ["Cloud Run Spec v1"] = 992,
    ["CloudCannon Configuration"] = 66,
    ["CloudEvents specification"] = 128,
    ["Code Climate"] = 173,
    CodeCV = 64,
    CodeRabbit = 63,
    ["CodeShip Pro services configuration files"] = 185,
    ["CodeShip Pro steps configuration files"] = 186,
    ["Codecov configuration files"] = 184,
    CodifyCLI = 65,
    Codux = 182,
    ["Cog config file"] = 133,
    ["Commandbox Box.json"] = 134,
    ["Commandbox Server.json"] = 135,
    ["Common Catalog Data"] = 194,
    ["Common Package Specification"] = 136,
    Concord = 986,
    ["Configu .cfgu files"] = 975,
    ["Configu .configu file"] = 976,
    Conjure = 131,
    ["Container Structure Test"] = 818,
    Containerlab = 845,
    ["Contextive Glossary"] = 1037,
    Convex = 130,
    ["Crowdsec collection config"] = 225,
    ["Crowdsec parser config"] = 226,
    ["Crowdsec scenario config"] = 227,
    ["CumulusCI Config"] = 137,
    ["Custom Machinery Machine"] = 960,
    ["Custom Machinery Recipe"] = 961,
    ["Cycle Stack File"] = 140,
    CycloneDX = 141,
    ["DWP Exchange - catalogue entry"] = 274,
    ["DWP Exchange - gateway"] = 272,
    ["DWP Exchange - meta"] = 273,
    ["Dart Build Config (dart-build.json)"] = 233,
    ["Dart Test Config (dart-test.json)"] = 234,
    ["DashLord Configuration"] = 235,
    ["Data Contract Specification"] = 236,
    ["Data Product Specification"] = 237,
    ["DataYoga Connections"] = 142,
    ["DataYoga Job"] = 143,
    ["Databricks Asset Bundles"] = 940,
    ["Datadog Service Definition"] = 425,
    ["Datadog Software Catalog"] = 426,
    ["Datahub Ingestion Recipe"] = 895,
    ["Dein Config"] = 149,
    ["Deno Config (deno.json)"] = 243,
    ["Dependency cruiser"] = 150,
    ["DeployStack Configuration"] = 151,
    ["Deployer Recipe"] = 246,
    ["Deta Spacefile"] = 152,
    ["Detekt Config (detekt.yml)"] = 247,
    ["Devbox Config"] = 153,
    ["Devbox Plugin"] = 154,
    Devfile = 271,
    DipDup = 989,
    ["Discord Webhook"] = 248,
    ["DocFx Config (docfx.json)"] = 252,
    Dofigen = 253,
    ["Dolittle Artifacts"] = 254,
    ["Dolittle Bounded Context Configuration"] = 255,
    ["Dolittle Event Horizons Configuration"] = 256,
    ["Dolittle Resources Configuration"] = 257,
    ["Dolittle Server Configuration"] = 258,
    ["Dolittle Tenant Map Configuration"] = 260,
    ["Dolittle Tenants Configuration"] = 259,
    ["Dolittle Topology"] = 261,
    ["DonateCaseBetterCasino menu"] = 1016,
    ["Drupal Breakpoints"] = 155,
    ["Drupal Config"] = 167,
    ["Drupal Info"] = 156,
    ["Drupal Layouts"] = 157,
    ["Drupal Libraries"] = 158,
    ["Drupal Links Action"] = 159,
    ["Drupal Links Contextual"] = 160,
    ["Drupal Links Menu"] = 161,
    ["Drupal Links Task"] = 162,
    ["Drupal Migration"] = 163,
    ["Drupal Permissions"] = 164,
    ["Drupal Recipe"] = 165,
    ["Drupal Routing"] = 166,
    ["Drupal Services"] = 168,
    ["Drush site aliases"] = 267,
    ["Dynamic Bash Aliases (.aliases)"] = 931,
    ["EAS config"] = 291,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 920,
    ["EasyVCR .NET"] = 292,
    ["Eidolon Resource"] = 1003,
    ["Elgato Stream Deck"] = 277,
    Elm = 991,
    ["Embrace Config"] = 906,
    Endurica = 944,
    ["Enterprise Contract Policy Spec"] = 278,
    ["Erda Pipeline"] = 967,
    ["Erda Runtime"] = 968,
    Esquio = 280,
    ["Estuary Flow Catalog"] = 885,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 284,
    ["EveryVoice TTS Toolkit Data Configuration"] = 285,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 289,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 288,
    ["EveryVoice TTS Toolkit Text Configuration"] = 286,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 287,
    ["Expo SDK"] = 290,
    ["F-Droid Data metadata"] = 296,
    ["FasterCI Configuration"] = 71,
    FiQuS = 300,
    Firebase = 298,
    ["FlexGet Config"] = 301,
    ["Flow.json Configurations"] = 964,
    ["Fossa configuration file"] = 308,
    ["Fossa's fossa-deps file"] = 309,
    ["Foundry VTT - Base package Manifest"] = 303,
    ["Foundry VTT - Module Manifest"] = 304,
    ["Foundry VTT - System Data Template"] = 307,
    ["Foundry VTT - System Manifest"] = 305,
    ["Foundry VTT - World Manifest"] = 306,
    ["Foxx Manifest"] = 72,
    ["Freifunk.de Community API"] = 75,
    ["Frogbot Config"] = 76,
    ["G2P Mapping Configuration"] = 314,
    ["GCP Blueprint Metadata"] = 317,
    Gaspar = 315,
    ["GatewayCore API Gateway"] = 316,
    ["GeoJSON.json latest"] = 883,
    GherKing = 887,
    ["GitHub Action"] = 322,
    ["GitHub Actions typing"] = 999,
    ["GitHub Discussion"] = 323,
    ["GitHub Funding"] = 324,
    ["GitHub Issue Template configuration"] = 325,
    ["GitHub Issue Template forms"] = 326,
    ["GitHub Workflow"] = 327,
    ["GitHub Workflow Template Properties"] = 328,
    ["GitHub automatically generated release notes configuration"] = 329,
    ["GitLab Agent for Kubernetes configuration"] = 956,
    GitVersion = 319,
    ["Gitea Issue Template configuration"] = 320,
    ["Gitea Issue Template forms"] = 321,
    ["Gitpod Automations"] = 331,
    ["Gitpod Configuration"] = 332,
    ["GlazeWM settings"] = 958,
    ["Global Privacy Control"] = 318,
    Goblet = 939,
    ["Golangci-lint Configuration"] = 347,
    ["Golangci-lint Custom Plugins Configuration"] = 348,
    ["Google Chrome Related Website Sets"] = 299,
    ["Google Cloud Workflows"] = 202,
    Goreleaser = 350,
    ["Goreleaser Pro"] = 351,
    Goss = 352,
    ["Gradle Build Cache Node"] = 834,
    ["Gradle Enterprise"] = 833,
    ["Grafana 5.x Dashboard"] = 353,
    ["GraphQL Code Generator"] = 357,
    ["GraphQL Config"] = 356,
    ["GraphQL Mesh"] = 355,
    ["Grunt JSHint task"] = 361,
    ["Grunt Watch task"] = 362,
    ["Grunt base task"] = 363,
    ["Grunt clean task"] = 359,
    ["Grunt copy task"] = 358,
    ["Grunt cssmin task"] = 360,
    HEMTT = 800,
    Hadolint = 814,
    Hammerkit = 844,
    ["Hardware Sentry Configuration"] = 899,
    Hatch = 815,
    Hayson = 365,
    ["Haystack Pipeline"] = 366,
    ["Hazelcast 5 Configuration"] = 367,
    ["Helm Chart.lock"] = 170,
    ["Helm Chart.yaml"] = 169,
    ["Helm Unittest Test Suite"] = 171,
    ["Homer dashboard configuration"] = 368,
    Hugo = 875,
    ["Hugo Theme"] = 874,
    ["Hyperfoil benchmark configuration"] = 374,
    ["IBM Zapp document"] = 375,
    ["IBM zCodeFormatSettings"] = 376,
    ["IMG Catapult PSP"] = 381,
    ["IVMS101 by CODE Protocol"] = 957,
    Infrahub = 383,
    Istanbul = 902,
    ["JDownloader2 crawler multi-rules"] = 393,
    ["JDownloader2 crawler single-rules"] = 392,
    ["JFrog Applications Config"] = 394,
    ["JFrog File Spec"] = 395,
    ["JFrog Pipelines YML DSL"] = 908,
    ["JMeter DSL cli config"] = 396,
    JReleaser = 398,
    ["JSON Document Transform"] = 406,
    ["JSON Feed"] = 407,
    ["JSON Resume"] = 618,
    ["JSON Schema Draft 2020-12"] = 783,
    ["JSON Schema Draft 4"] = 780,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 941,
    ["JSON Schema Draft 7"] = 781,
    ["JSON Schema Draft 7 (unofficial strict)"] = 942,
    ["JSON Schema Draft 8 (2019-09)"] = 782,
    ["JSON-API"] = 405,
    ["JSON-e templates"] = 841,
    ["JSON-stat 2.0"] = 776,
    JSONPatch = 409,
    ["JSR Package Config (jsr.json)"] = 399,
    Jasmine = 387,
    Jekyll = 388,
    ["Jenkins X Pipelines"] = 389,
    ["Jenkins X Requirements"] = 390,
    Jest = 391,
    ["Jovo Language Models"] = 397,
    ["KIMMDY config file"] = 420,
    ["KODE/CI build.yaml"] = 904,
    ["KSP-AVC"] = 777,
    ["KSP-CKAN"] = 778,
    ["KSP-NetKAN"] = 779,
    KSY = 969,
    KSail = 312,
    ["Karakum configuration file"] = 310,
    Kas = 412,
    ["Kestra flow file"] = 421,
    ["Keycloak REST API"] = 911,
    ["Knative Functions - func.yaml"] = 311,
    ["Kometa (nightly) config file"] = 423,
    ["Kometa config file"] = 422,
    ["Kong DBLess config"] = 905,
    KrakenD = 424,
    ["Kubri Configuration"] = 430,
    LOOBin = 445,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 207,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 208,
    ["Landing Zone Accelerator on AWS - Global Config"] = 209,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 210,
    ["Landing Zone Accelerator on AWS - Network Config"] = 211,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 212,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 213,
    ["Landing Zone Accelerator on AWS - Security Config"] = 214,
    ["Language configuration"] = 979,
    Lefthook = 434,
    ["Liferay client-extension.yaml"] = 441,
    ["LinkML Metamodel"] = 443,
    Liquibase = 850,
    ["Liquibase Flow File"] = 851,
    ["Lively Properties"] = 444,
    ["Lobe AI Agent"] = 68,
    Loki = 69,
    ["MLOS Configs"] = 483,
    ["MS2Rescore Configuration"] = 486,
    ["Madness (madness.yml)"] = 922,
    ["MapEHR Mapping"] = 451,
    Markdownlint = 854,
    ["Mason Registry"] = 857,
    ["MegaLinter configuration"] = 453,
    ["MegaLinter descriptor"] = 454,
    Melange = 948,
    ["Meltano project definition"] = 455,
    ["Mergify Configuration"] = 487,
    ["Metadata for a Bazel module"] = 456,
    ["Metadata for a Cinnamon spice"] = 995,
    ["Metatype Configuration"] = 457,
    ["MetricsHub Configuration"] = 458,
    ["MetricsHub Connector Configuration"] = 459,
    ["Micro Editor Syntax"] = 932,
    ["Microsoft Band Web Tile"] = 460,
    ["Microsoft RulesEngine workflow rules"] = 983,
    ["Microsoft RulesEngine workflow rules list"] = 984,
    ["Minecraft Custom Main Menu Mod"] = 949,
    ["Minecraft Data Pack Advancement"] = 462,
    ["Minecraft Data Pack Biome"] = 463,
    ["Minecraft Data Pack Configured Carver"] = 464,
    ["Minecraft Data Pack Damage Type"] = 465,
    ["Minecraft Data Pack Dimension"] = 467,
    ["Minecraft Data Pack Dimension Type"] = 466,
    ["Minecraft Data Pack Item Modifier"] = 468,
    ["Minecraft Data Pack Loot Table"] = 469,
    ["Minecraft Data Pack Metadata"] = 470,
    ["Minecraft Data Pack Predicate"] = 471,
    ["Minecraft Data Pack Recipe"] = 472,
    ["Minecraft Data Pack Tag"] = 473,
    ["Minecraft Data Pack Template Pool"] = 474,
    ["Minecraft Data Pack Trim Material"] = 479,
    ["Minecraft Data Pack Trim Pattern"] = 480,
    ["Minecraft Resource Pack Lang"] = 475,
    ["Minecraft Resource Pack Particle"] = 476,
    ["Minecraft Resource Pack Texture Mcmeta"] = 478,
    ["Minecraft Resourcepack Sounds"] = 477,
    ["Monade CLI Stack Configuration"] = 490,
    ["MongoDB Atlas Search Index Definition"] = 903,
    ["Monika Configuration"] = 901,
    ["Monoweave Configuration"] = 485,
    ["Motif config"] = 796,
    MultiQC = 1031,
    ["NOX Framework (Service)"] = 502,
    ["Netin Diagnostic System Template"] = 861,
    ["Netlify config"] = 493,
    ["Network-as-Code Data Model"] = 494,
    ["Nightwatch.js"] = 495,
    ["Node.js configuration"] = 801,
    ["NueJS configuration file"] = 507,
    ["Nuitka.yaml"] = 962,
    ["Nullstone config"] = 509,
    ["ONe's changelog entry"] = 523,
    ["ONe's service descriptor"] = 522,
    ["OSCAL Assessment Plan (AP)"] = 531,
    ["OSCAL Assessment Results (AR)"] = 532,
    ["OSCAL Catalog"] = 533,
    ["OSCAL Component Definition (CDef)"] = 534,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 535,
    ["OSCAL Profile"] = 536,
    ["OSCAL System Security Plan (SSP)"] = 537,
    ["OSS Review Toolkit configuration"] = 538,
    ["OSS Review Toolkit curation"] = 539,
    ["OSS Review Toolkit package configuration"] = 540,
    ["OSS Review Toolkit repository configuration"] = 541,
    ["OSS Review Toolkit resolutions"] = 542,
    ["October CMS columns"] = 513,
    ["October CMS fields"] = 514,
    Okteto = 515,
    Opctl = 799,
    ["Open Data Contract Standard (ODCS)"] = 526,
    ["Open Know-How"] = 1036,
    ["OpenRewrite Resource"] = 525,
    ["OpenUtau character yaml"] = 519,
    ["OpenUtau ustx"] = 520,
    ["OpenWeather Current Weather API"] = 840,
    ["OpenWeather Road Risk API"] = 839,
    ["Ory Hydra configuration"] = 373,
    ["Ory Keto configuration"] = 427,
    ["Ory Kratos configuration"] = 530,
    ["Ory Oathkeeper configuration"] = 511,
    ["Outblocks App configuration"] = 528,
    ["Outblocks database table"] = 529,
    ["Outblocks project configuration"] = 527,
    PDM = 548,
    Packer = 545,
    Pantsbuild = 918,
    ["Paper paper-plugin.yml"] = 546,
    ["Pipeline component"] = 852,
    ["Plex Prerolls"] = 556,
    ["PocketMine plugin.yml"] = 553,
    ["Postman collection"] = 560,
    ["Preset list for a WinUtil"] = 998,
    ["Problem object RFC9457"] = 946,
    ["Problem package generators"] = 569,
    Pterodactyl = 898,
    ["Pull Request Labeler"] = 585,
    Pulumi = 593,
    ["PyGTA Config"] = 589,
    PyProject = 594,
    Pyright = 595,
    ["Python script metadata"] = 1033,
    Qgoda = 597,
    Qodana = 871,
    ["Qt Creator workspace file"] = 977,
    ["Quali Torque Blueprint Spec 2"] = 896,
    ["QueryFirst config file"] = 914,
    ["RKE Cluster Configuration JSON"] = 849,
    ["RKE Cluster Configuration YAML"] = 848,
    RadioHound = 588,
    Railway = 598,
    ["Rancher Fleet"] = 590,
    ["Rattler-build"] = 599,
    Ray = 813,
    ["Read the Docs"] = 592,
    ["Red-DiscordBot Cog"] = 606,
    ["Red-DiscordBot Cog Repo"] = 607,
    ["Red-DiscordBot Trivia"] = 608,
    ["Render Blueprints"] = 847,
    RenderCV = 620,
    Renovate = 619,
    ["Replit config"] = 614,
    Restate = 1026,
    RoadRunner = 622,
    ["Rudder techniques"] = 952,
    Ruff = 616,
    ["Rust Project"] = 617,
    ["Rust toolchain"] = 626,
    ["SDMX data message"] = 652,
    ["SDMX metadata message"] = 651,
    ["SDMX structure message"] = 650,
    ["SIL Kit Participant Configuration"] = 662,
    ["SIL Kit Registry Configuration"] = 663,
    ["SPDX 2.3"] = 681,
    SWADL = 695,
    ["Safebox Config"] = 909,
    ["Sapphire CLI Config"] = 629,
    ["SauceCTL Configuration"] = 858,
    ["Schema Catalog"] = 644,
    ["Scoop manifest"] = 649,
    ["Semantic Data Fabric (SDF) file"] = 653,
    ["Semgrep Rule"] = 655,
    ["Serenity Code Generator (Sergen)"] = 656,
    ["Serverless Framework Configuration"] = 865,
    ["Serverless Workflow"] = 867,
    ["Settings for a Cinnamon spice"] = 994,
    ["Settings.paf"] = 658,
    ["Shopware 6 Configuration"] = 868,
    ["Shopware CLI Extension Store Configuration"] = 869,
    ["Shopware CLI Project Store Configuration"] = 870,
    ["Sigma Detection Rule"] = 660,
    ["Sigrid scope configuration file"] = 661,
    ["SkyPilot Task JSON"] = 953,
    ["Slack app manifest"] = 665,
    Solidarity = 670,
    ["Solution filters"] = 671,
    ["Source Maps v3"] = 672,
    Sourcery = 673,
    ["Speakeasy Generation Config File"] = 677,
    ["Speakeasy Lint Configuration File"] = 674,
    ["Speakeasy Test Generation Configuration File"] = 675,
    ["Speakeasy Workflow File"] = 676,
    SpecIF = 678,
    ["Sponge Mixin configuration"] = 679,
    StackBlitz = 685,
    ["StackHawk Scanner Configuration"] = 864,
    Stale = 686,
    ["Starlake Data Pipeline"] = 837,
    Starship = 687,
    ["Statamic Blueprint"] = 688,
    ["Stella configuration file"] = 689,
    ["Stryker Mutator"] = 692,
    ["StyleCop Analyzers Configuration"] = 693,
    ["Stylelint (.stylelintrc)"] = 694,
    ["Sublime Syntax"] = 910,
    ["Subsquid squid manifest"] = 955,
    ["Swagger API 2.0"] = 696,
    ["Synadia Connect Component"] = 697,
    TSON = 731,
    TSTyche = 732,
    ["Tab data for a LinUtil"] = 1001,
    ["Tab list for a LinUtil"] = 1000,
    Tach = 698,
    ["Tach Domain"] = 699,
    Talhelper = 701,
    ["Talisman configuration"] = 702,
    ["Taskfile config"] = 842,
    Taurus = 703,
    Tauticord = 704,
    Telefonistka = 1027,
    ["TestEnvironment.json"] = 714,
    ["TextMate Grammar"] = 713,
    ["Tier.run pricing.json"] = 707,
    Tikibase = 708,
    Tombi = 712,
    ["Traefik v2"] = 717,
    ["Traefik v2 File Provider"] = 718,
    ["Traefik v3"] = 719,
    ["Traefik v3 File Provider"] = 720,
    ["Travis CI (.travis.yml)"] = 716,
    Trident = 1025,
    ["TrueScript for *.tscript files"] = 723,
    ["Tugboat QA config.yml"] = 1022,
    TunnelHub = 945,
    Turborepo = 715,
    Tycho = 990,
    Tye = 872,
    ["Tyk Gateway - Open Source v5.7+"] = 1032,
    ["UET BuildConfig.json"] = 915,
    ["UI5 Manifest"] = 742,
    ["UNCORS configuration"] = 746,
    ["UTAM Page Object"] = 745,
    ["Ubuntu Server Autoinstall"] = 740,
    ["Uniswap Token List"] = 825,
    ["Universal Schedule Format"] = 747,
    ["Unreal Engine Uplugin"] = 916,
    ["Unreal Engine Uproject"] = 917,
    ["Updatecli Compose"] = 880,
    ["Updatecli Policy Manifest"] = 881,
    ["Updatecli Policy Metadata"] = 882,
    Uplift = 913,
    ["User Journey Map"] = 846,
    V2Ray = 886,
    ["VSCode Code Snippets"] = 190,
    ["VSIX CLI publishing"] = 765,
    Vector = 749,
    ["Vela Pipeline Configuration"] = 752,
    Vercel = 189,
    ["Version Bumper config"] = 755,
    ["Viash Component Config"] = 1029,
    ["Viash Package Config"] = 1030,
    Visivo = 943,
    Wake = 1024,
    ["Waku Config"] = 1004,
    ["Web App Manifest"] = 771,
    ["Web types"] = 774,
    WebExtensions = 770,
    ["Webman package recipe"] = 892,
    ["Windows Package Manager Installer Manifest"] = 821,
    ["Windows Package Manager Locale Manifest"] = 822,
    ["Windows Package Manager Singleton Manifest"] = 820,
    Winutil = 823,
    ["WireMock stub mapping"] = 1007,
    ["Woodpecker pipeline config"] = 860,
    ["Wrangler CLI"] = 775,
    ["Xstate Machine"] = 878,
    ["Yandex Workflow Language"] = 996,
    ["Yarn Config (.yarnrc.yml)"] = 835,
    ["Yippee-Ki-JSON configuration YML"] = 827,
    ["YouTrack App"] = 993,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 18,
    apko = 947,
    ...
    ["babelrc.json"] = 78,
    ["bamboo-spec"] = 81,
    ["bashly-strings.yml"] = 925,
    ["batect.yml"] = 80,
    ["beef-database-codegen"] = 82,
    ["beef-database-v5-codegen"] = 84,
    ["beef-entity-codegen"] = 83,
    ["beef-entity-v5-codegen"] = 85,
    ["behat.yml"] = 96,
    ["bigquery-table"] = 86,
    ["bioimageio resource description"] = 963,
    ["bitbucket-pipelines"] = 88,
    bitrise = 89,
    ["bitrise-step"] = 90,
    ["block.json"] = 110,
    ["bottom configuration"] = 58,
    ["bower.json"] = 92,
    ["bozr.suite.json"] = 98,
    bpkg = 926,
    ["browser.i18n.json"] = 99,
    ["browsh configuration"] = 100,
    bucklescript = 101,
    ["buf.gen.yaml"] = 60,
    ["buf.plugin.yaml"] = 61,
    ["buf.work.yaml"] = 62,
    ["buf.yaml"] = 59,
    ["bun.lock"] = 106,
    ["bundleconfig.json"] = 107,
    ["bunfig.toml"] = 108,
    ["ccmod.json"] = 1005,
    changelogging = 974,
    ["chisel-slices.json"] = 216,
    ["chrome-extension-locales-messages.json"] = 197,
    ["chutzpah.json"] = 198,
    cibuildwheel = 126,
    ["clang-format (.clang-format)"] = 884,
    ["clang-tidy"] = 177,
    clangd = 176,
    clib = 178,
    ["cloud-init: cloud-config userdata"] = 180,
    ["cloud-sdk-pipeline-configuration"] = 200,
    ["cloudbuild.json"] = 201,
    cloudify = 179,
    codemagic = 181,
    ["coffeelint.json"] = 218,
    ["commands.json"] = 193,
    ["commitlint (.commitlintrc)"] = 824,
    ["committed.toml"] = 219,
    ["compile_commands.json"] = 192,
    ["compilerconfig.json"] = 191,
    ["completely.yml"] = 921,
    ["component-detection-manifest.json"] = 222,
    ["component.json"] = 221,
    ["composer.json"] = 220,
    ["conda-forge"] = 129,
    ["config.yaml"] = 591,
    ["contentmanifest.json"] = 199,
    ["contribute.json"] = 223,
    ["cosmos.config.json"] = 195,
    ["crowdin.yml"] = 224,
    ["ctfd-setup configuration file"] = 1014,
    ["custom-elements.json"] = 935,
    ["cypress.json"] = 228,
    ["datalogic-scan2deploy-android"] = 238,
    ["datalogic-scan2deploy-ce"] = 239,
    ["dbt Dependencies"] = 144,
    ["dbt Packages"] = 146,
    ["dbt Project"] = 145,
    ["dbt Selectors"] = 147,
    ["dbt YAML files"] = 148,
    ["ddev-global"] = 240,
    ["ddev-project"] = 241,
    ["debugsettings.json"] = 242,
    ["dependabot-v2.json"] = 245,
    ["dependabot.json"] = 244,
    ["deployed-cli"] = 877,
    ["devcontainer.json"] = 183,
    devinit = 829,
    ["devspace.yaml"] = 900,
    djlint = 830,
    ["docker bake"] = 250,
    ["docker sequencer"] = 251,
    ["docker-compose.yml"] = 828,
    ["dockerd.json"] = 249,
    ["dotnet Release Index manifest"] = 262,
    ["dotnet-tools.json"] = 263,
    ["dotnetcli.host.json"] = 264,
    ["dprint.json"] = 265,
    ["drone.json"] = 266,
    ["dss-2.0.0.json"] = 268,
    ["dstack configuration"] = 269,
    ["dtool dataset metadata"] = 1009,
    ["dvc.yaml"] = 270,
    ["ecosystem.json"] = 275,
    eksctl = 276,
    ["electron-builder configuration file"] = 282,
    ["epr-manifest.json"] = 281,
    ["evcc.yaml"] = 283,
    ["ezd task runner"] = 293,
    ["fabric.mod.json"] = 295,
    ["first-timers-bot"] = 302,
    ["flagd flag configuration"] = 73,
    ["fly.io Configuration"] = 74,
    fulibWorkflows = 859,
    ["function.json"] = 313,
    ["gRPC API Gateway & OpenAPI Config"] = 3,
    ["gematik health care insurance list"] = 1020,
    ["gematik health care patient list"] = 1017,
    ["gematik health care provider institution list"] = 1019,
    ["gematik health care provider list"] = 1018,
    ["gematik tiger test environment configuration"] = 1021,
    ["gitlab-ci"] = 330,
    ["global.json"] = 346,
    ["go-feature-flag Flag Configuration"] = 349,
    ["haxelib.json"] = 364,
    helmfile = 816,
    helmwave = 817,
    ["host-meta.json"] = 370,
    ...
    ["ide.host.json"] = 377,
    ["ifstate.conf"] = 378,
    ["imageoptimizer.json"] = 379,
    ["importmap.json"] = 382,
    ["ioBroker Configuration"] = 384,
    ["ioBroker JSON UI"] = 385,
    ["ioBroker Package manifest"] = 386,
    ["ize.toml"] = 912,
    ["jsconfig.json"] = 410,
    ["jscpd Configuration"] = 897,
    jsdoc = 812,
    ["k3d.yaml"] = 411,
    ["k9s aliases.yaml"] = 413,
    ["k9s cluster-config.yaml"] = 415,
    ["k9s config.yaml"] = 414,
    ["k9s hotkeys.yaml"] = 416,
    ["k9s plugins.yaml"] = 417,
    ["k9s skin.yaml"] = 418,
    ["k9s views.yaml"] = 419,
    ["kontinuous-config.yaml"] = 429,
    ["kontinuous-values.yaml"] = 428,
    ["kustomization.yaml"] = 431,
    ["label-commenter-config.yml"] = 432,
    ["latexindent configuration"] = 67,
    ["launchsettings.json"] = 433,
    lazydocker = 934,
    lazygit = 933,
    ["lego.json"] = 435,
    ["lerna.json"] = 436,
    ["lgtm.yml"] = 437,
    ["liblab.config.json"] = 438,
    ["libman.json"] = 439,
    ["license-report-config.json"] = 440,
    ["linkinator.config.json"] = 442,
    ["lint-staged (.lintstagedrc)"] = 791,
    ["local.settings.json"] = 447,
    ["localazy.json"] = 448,
    ["lotus.yaml"] = 446,
    ["lsdlschema.json"] = 449,
    ["markdown-link-check"] = 855,
    maturin = 856,
    mboats = 863,
    ["micro-settings.json"] = 927,
    ["mimetypes.json"] = 461,
    ["mirrord config"] = 792,
    mise = 793,
    ["mkdocs.yml"] = 481,
    ["monospace.yml"] = 484,
    ["moon.yml"] = 1006,
    ["mprocs Configuration file"] = 978,
    ["mrdocs.yml"] = 482,
    ["mta.yaml"] = 794,
    ["mtad.yaml"] = 795,
    ["mycode.json"] = 491,
    ["napari plugin manifest"] = 492,
    neoload = 807,
    ["nest-cli"] = 497,
    ["ninjs (News in JSON)"] = 496,
    ["nitro.json"] = 806,
    ["nixd configuration"] = 951,
    ["nlu.json"] = 498,
    ["nodemon.json"] = 500,
    ["noodl config"] = 862,
    ["notebook.mod.json"] = 501,
    now = 802,
    ["npm-badges"] = 504,
    ["nswag.json"] = 508,
    ntangle = 510,
    ["nuclei-template.yaml"] = 505,
    ["nuget-project.json"] = 506,
    ["ocelot.json"] = 512,
    ["omnisharp.json"] = 516,
    ["openapi.json"] = 517,
    ["openfin.json"] = 524,
    ...
    ["ops.yaml"] = 521,
    ["package.json"] = 543,
    ["package.manifest"] = 544,
    ["partial-black.json"] = 97,
    ["pathfinder.yml"] = 547,
    ["pattern.json"] = 550,
    ["petstore-v1.0"] = 907,
    pgap_yaml_input_reader = 549,
    ["pixi.toml"] = 551,
    ["plagiarize-me.yaml"] = 555,
    ["plagiarize.yaml"] = 554,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1010,
    ["podbard.yaml"] = 557,
    ["portman.json"] = 558,
    ["prefect.toml"] = 566,
    ["prettierrc.json"] = 567,
    ["prisma.yml"] = 568,
    ["project-1.0.0-beta3.json"] = 571,
    ["project-1.0.0-beta4.json"] = 572,
    ["project-1.0.0-beta5.json"] = 573,
    ["project-1.0.0-beta6.json"] = 574,
    ["project-1.0.0-beta8.json"] = 575,
    ["project-1.0.0-rc1.json"] = 576,
    ["project-1.0.0-rc2.json"] = 577,
    ["project.json"] = 570,
    ["project.owasp.yaml"] = 578,
    ["prometheus.json"] = 579,
    ["prometheus.rules.json"] = 580,
    ["prometheus.rules.test.json"] = 581,
    ["proxies.json"] = 582,
    ["publiccode.yml"] = 583,
    ["pubspec.yaml"] = 584,
    ["pyrseas-0.8.json"] = 587,
    pytest = 596,
    ["quilt.mod.json"] = 928,
    ["rc3 auth"] = 600,
    ["rc3 collection"] = 601,
    ...
    ["rc3 settings"] = 605,
    ["release drafter"] = 808,
    ["release-please-config.json"] = 610,
    ["release-please-manifest.json"] = 611,
    ["release-plz.toml"] = 612,
    ["renv.lock"] = 621,
    ["rivet.yaml"] = 950,
    rockcraft = 623,
    runny = 624,
    ...
    samt = 627,
    samtrc = 628,
    ["sarif-1.0.0.json"] = 630,
    ["sarif-2.0.0.json"] = 631,
    ["sarif-2.1.0"] = 641,
    ["sarif-2.1.0-rtm.2"] = 632,
    ["sarif-2.1.0-rtm.3"] = 634,
    ["sarif-2.1.0-rtm.4"] = 636,
    ["sarif-2.1.0-rtm.5"] = 638,
    ["sarif-2.1.0-rtm.6"] = 639,
    ["sarif-external-property-file-2.1.0"] = 642,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 633,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 635,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 637,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 640,
    ["scalingo.json configuration"] = 643,
    ["schema.org - Action"] = 645,
    ["schema.org - ContactPoint"] = 646,
    ["schema.org - Place"] = 647,
    ["schema.org - Thing"] = 648,
    ["secrethub.yml"] = 930,
    ["semantic-release"] = 654,
    ["servicehub.config.json"] = 786,
    ["servicehub.service.json"] = 785,
    ["settings.job"] = 657,
    ["sfdx-hardis configuration"] = 659,
    ["shard.yml"] = 966,
    ["size-limit configuration"] = 664,
    ["skaffold.yaml"] = 853,
    ["skyuxconfig.json"] = 666,
    snapcraft = 667,
    ["snowflake-config"] = 668,
    ["snowflake-connections"] = 669,
    ["spicepod.yaml"] = 985,
    ["sqlc configuration"] = 682,
    ["stripe-app-local.json"] = 691,
    ["stripe-app.json"] = 690,
    swcrc = 838,
    ["task.json"] = 700,
    taskcat = 803,
    ["template.json"] = 705,
    ["templatsources.json"] = 706,
    ["theme.json"] = 709,
    ["tizen_workspace.json"] = 710,
    tldr = 711,
    tmuxinator = 789,
    ["transcend.yml"] = 721,
    ["tree-sitter grammar.json"] = 354,
    ["trime.yaml"] = 722,
    ["trunk.yaml"] = 724,
    ["ts-force-config.json"] = 729,
    ["tsconfig.json"] = 725,
    ["tsd.json"] = 726,
    ["tsdoc.json"] = 727,
    ["tsdrc.json"] = 728,
    ...
    v8r = 769,
    vcluster = 972,
    ["vcpkg configuration file"] = 188,
    ["vcpkg manifest file"] = 187,
    ["vega-lite.json"] = 751,
    ["vega.json"] = 750,
    ["venvironment-basic.yaml"] = 754,
    ["venvironment.yaml"] = 753,
    version = 1028,
    ["version.json"] = 756,
    ["vhwdebugger-binding.yaml"] = 758,
    ["vim-addon-info"] = 759,
    ["vs-2017.3.host.json"] = 761,
    ["vs-nesting.json"] = 762,
    ["vsls.json"] = 760,
    ["vss-extension.json"] = 766,
    vtcfg = 1034,
    ["vtesttree.yaml"] = 767,
    ["vtestunit.yaml"] = 768,
    ["warp-keysets.json"] = 936,
    ["warp-themes.json"] = 937,
    ["warp-workflows.json"] = 938,
    ["webhint.io"] = 893,
    ["webjobpublishsettings.json"] = 773,
    ["webjobs-list.json"] = 772,
    ["well-known-fursona"] = 973,
    ["xs-app.json"] = 798,
    ["xunit.runner.json"] = 784,
    yamllint = 826,
    ["zerops.io import file"] = 982,
    ["zerops.yml"] = 981,
    zuul = 809,
    ["Žinoma"] = 819
  },
