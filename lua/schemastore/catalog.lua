...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1063,
    [".nodehawkrc"] = 680,
    [".npmpackagejsonlintrc"] = 685,
    [".omletrc"] = 1244,
    [".phrase.yml"] = 766,
    [".phraseapp.yml"] = 767,
    [".pmbot.yml"] = 751,
    [".postcssrc"] = 760,
    [".powerpages-web-template-manifest"] = 762,
    [".pre-commit-config.yml"] = 763,
    [".pre-commit-hooks.yml"] = 764,
    [".putout.json"] = 800,
    [".rehyperc"] = 825,
    [".remarkrc"] = 829,
    [".sprite files"] = 931,
    ...
    AIConfig = 45,
    ["AMX Muse Program Descriptor"] = 1293,
    ["API Builder"] = 1099,
    ["AVA Configuration"] = 1163,
    ["AWS AppConfig Feature Flags-v1"] = 80,
    ["AWS CDK cdk.json"] = 301,
    ["AWS CloudFormation"] = 302,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 303,
    ["AWS Copilot Manifest"] = 1332,
    ["AWS SAM CLI Samconfig"] = 304,
    Acton = 1383,
    ["Adobe UXP Manifest"] = 1226,
    ["Aerleon Network & Service Definitions"] = 27,
    ["Aerleon Policy"] = 28,
    ["Agent Permission Policy"] = 1372,
    ["AgentCore CLI"] = 1373,
    AgentLoopKit = 1374,
    Aider = 1322,
    Air = 30,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1343,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1342,
    ["Airlock Microgateway"] = 46,
    ["Alacritty Configuration"] = 1135,
    ["AlgoVoi Compliance Receipt v1"] = 16,
    ["All Contributors configuration file"] = 1189,
    ["Amazon S3 bucket CORS"] = 18,
    Anodizer = 495,
    ["Ansible Argument Specs"] = 478,
    ["Ansible Collection Galaxy"] = 485,
    ["Ansible Execution Environment"] = 475,
    ["Ansible Inventory"] = 484,
    ["Ansible Meta"] = 476,
    ["Ansible Meta Runtime"] = 477,
    ["Ansible Navigator Configuration"] = 487,
    ["Ansible Playbook"] = 482,
    ["Ansible Requirements"] = 479,
    ["Ansible Rulebook"] = 483,
    ["Ansible Tasks File"] = 481,
    ["Ansible Vars File"] = 480,
    ["Ansible-lint Configuration"] = 486,
    Any = 1254,
    ...
    ["Application list for a WinUtil"] = 1272,
    ArchitectFX = 1277,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1341,
    ["Azure IoT Operations connector metadata"] = 1338,
    ...
    ["Azure Pipelines"] = 129,
    ["Azure Static Web Apps CLI configuration file"] = 935,
    ["Azure Static Web Apps configuration file"] = 934,
    BMML = 1360,
    ["BOSH BPM Config"] = 155,
    ["BOSH CPI Config"] = 156,
    ...
    ["Bacon config"] = 10,
    ["Barba-CV"] = 95,
    ["Bashly (bashly.yml)"] = 1193,
    ["Bashly Settings (bashly-settings.yml)"] = 1194,
    Bento = 1359,
    ["Better Code Hub"] = 1104,
    ["Better Scripts"] = 179,
    Bigconfig = 148,
    ["Biome Formatter Config"] = 96,
    ["Bitmovin Encoding Template"] = 1286,
    BizTalkServerApplicationSchema = 1070,
    Bleep = 180,
    ["Block Protocol Metadata"] = 177,
    ["Bluebricks blueprint config"] = 1365,
    ["Boyka Framework"] = 158,
    ...
    ["Butane Config"] = 1148,
    C4InterFlow = 1301,
    ["CDK Environment Manager, concrete environment configuration"] = 1325,
    ["CDK Environment Manager, concrete environments definition"] = 1324,
    ["CDK Environment Manager, environment definition"] = 1323,
    ["CGS Card Game Specification (cgs.json)"] = 1231,
    ["CICS TS region tagging"] = 1157,
    ["CICS TS resource import"] = 1158,
    ["CICS TS resource model"] = 1159,
    ["CICS TS resource overrides"] = 1160,
    ["CMake Presets"] = 181,
    ["CNC Codes"] = 204,
    ["CRS WAF test file"] = 1261,
    ["CRS WAF test platform overrides file"] = 1262,
    ["CSS Comb (.csscomb.json)"] = 330,
    ["CSS Lint (.csslintrc)"] = 331,
    ["CSpell (cspell.json)"] = 329,
    ["CVE Record Format"] = 216,
    ["CVX achievements.yaml"] = 222,
    ["CVX competencies.yaml"] = 221,
    ["CVX config.yaml"] = 225,
    ["CVX education.yaml"] = 220,
    ["CVX experience.yaml"] = 219,
    ["CVX keywords.yaml"] = 224,
    ["CVX layout"] = 226,
    ["CVX personal.yaml"] = 217,
    ["CVX referees.yaml"] = 223,
    ["CVX summary.yaml"] = 218,
    CWL = 1237,
    ["Cache Warmup config"] = 182,
    ["Caido Proxy Configuration"] = 1398,
    ...
    ["Chamaleon environment"] = 1290,
    ["Chamaleon properties"] = 1291,
    ["Chamaleon template"] = 1289,
    Changepacks = 1352,
    Changesets = 313,
    Changie = 190,
    Charmcraft = 191,
    Cheatsheets = 1145,
    ["ChordPro Configuration"] = 193,
    ["Chrome Extension"] = 294,
    ["Chromia Model"] = 194,
    ["Chromia Seeder Module Config"] = 196,
    ["Chromia Seeder Root Config"] = 195,
    ["Cinnamon Spice info.json"] = 106,
    ["CircleCI config.yml"] = 265,
    ["Citation File Format"] = 315,
    ["Citrus test case"] = 198,
    CityJSON = 199,
    ["Claude Code Keybindings"] = 211,
    ["Claude Code Launch Preview"] = 1407,
    ["Claude Code Plugin Manifest"] = 212,
    ["Claude Code Plugin Marketplace"] = 213,
    ["Claude Code Settings"] = 214,
    ["Clawject config"] = 210,
    ["Cloud Foundry Application Manifest"] = 1243,
    ["Cloud Run Spec v1"] = 1267,
    ...
    ["CloudEvents specification"] = 200,
    ["Code Climate"] = 266,
    CodeCV = 110,
    CodeRabbit = 109,
    ["CodeShip Pro services configuration files"] = 283,
    ["CodeShip Pro steps configuration files"] = 284,
    ["Codecov configuration files"] = 282,
    Codex = 274,
    ["Codex Hooks"] = 275,
    ["Codex Plugin Manifest"] = 276,
    ["Codex Skill Metadata"] = 277,
    CodifyCLI = 111,
    Codux = 279,
    ["Cog config file"] = 205,
    ["Commandbox Box.json"] = 206,
    ["Commandbox Server.json"] = 207,
    ["Common Catalog Data"] = 292,
    ["Common Package Specification"] = 208,
    Concord = 1260,
    ["Configu .cfgu files"] = 1248,
    ["Configu .configu file"] = 1249,
    Conjure = 203,
    ["Container Structure Test"] = 1084,
    Containerlab = 1113,
    ["Contextive Glossary"] = 1317,
    ContractGuard = 1114,
    Convex = 202,
    ["Crowdsec collection config"] = 324,
    ["Crowdsec parser config"] = 325,
    ["Crowdsec scenario config"] = 326,
    ["CumulusCI Config"] = 209,
    ["Cursor Agent Environment"] = 1370,
    ["Custom Machinery Machine"] = 1232,
    ["Custom Machinery Recipe"] = 1233,
    ["Cycle Stack File"] = 227,
    CycloneDX = 228,
    ["DWP Exchange - catalogue entry"] = 377,
    ["DWP Exchange - gateway"] = 375,
    ["DWP Exchange - meta"] = 376,
    ["Dart Build Config (dart-build.json)"] = 332,
    ["Dart Test Config (dart-test.json)"] = 333,
    ["DashLord Configuration"] = 334,
    ["Data Contract Specification"] = 335,
    ["Data Product Specification"] = 336,
    ["DataYoga Connections"] = 229,
    ["DataYoga Job"] = 230,
    ["Datadog Continuous Testing"] = 583,
    ["Datadog Service Definition"] = 584,
    ["Datadog Software Catalog"] = 585,
    ["Datahub Ingestion Recipe"] = 1164,
    ["Debian Upstream Metadata file"] = 237,
    DebtLens = 238,
    ["Deck config"] = 239,
    ["Declarative Automation Bundles"] = 1210,
    ["DeepMatch deeplinks spec"] = 240,
    ["Dein Config"] = 241,
    ["Deno Config (deno.json)"] = 343,
    ["Dependency cruiser"] = 242,
    ["DeployStack Configuration"] = 243,
    ["Deployah Configuration"] = 1340,
    ["Deployer Recipe"] = 346,
    ["Deta Spacefile"] = 244,
    ["Detekt Config (detekt.yml)"] = 347,
    ["Devbox Config"] = 245,
    ["Devbox Plugin"] = 246,
    Devfile = 374,
    Devup = 1353,
    DipDup = 1263,
    ["Discord Webhook"] = 348,
    ["DocFx Config (docfx.json)"] = 353,
    ["Docker Desktop extension metadata"] = 350,
    ["Docs MCP Manifest"] = 354,
    Dofigen = 355,
    ["Dolittle Artifacts"] = 356,
    ["Dolittle Bounded Context Configuration"] = 357,
    ["Dolittle Event Horizons Configuration"] = 358,
    ["Dolittle Resources Configuration"] = 359,
    ["Dolittle Server Configuration"] = 360,
    ["Dolittle Tenant Map Configuration"] = 362,
    ["Dolittle Tenants Configuration"] = 361,
    ["Dolittle Topology"] = 363,
    ["DonateCaseBetterCasino menu"] = 1294,
    ["Draugr Saga"] = 342,
    ["Drupal Breakpoints"] = 247,
    ["Drupal Config"] = 259,
    ["Drupal Info"] = 248,
    ["Drupal Layouts"] = 249,
    ["Drupal Libraries"] = 250,
    ["Drupal Links Action"] = 251,
    ["Drupal Links Contextual"] = 252,
    ["Drupal Links Menu"] = 253,
    ["Drupal Links Task"] = 254,
    ["Drupal Migration"] = 255,
    ["Drupal Permissions"] = 256,
    ["Drupal Recipe"] = 257,
    ["Drupal Routing"] = 258,
    ["Drupal Services"] = 260,
    ["Drush site aliases"] = 369,
    ["Dust configuration"] = 372,
    ["Dynamic Bash Aliases (.aliases)"] = 1201,
    ["EAS config"] = 416,
    ["ECA - Editor Code Assistant"] = 379,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1190,
    ["ESLint Suppressions"] = 421,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1337,
    ["EasyVCR .NET"] = 418,
    ["Eidolon Resource"] = 1278,
    ["Elgato Stream Deck"] = 382,
    Elm = 1265,
    ["Embrace Config"] = 1176,
    Emmet = 1266,
    Endurica = 1214,
    ["Enonic XP API descriptor"] = 385,
    ["Enonic XP Admin Extension descriptor"] = 386,
    ["Enonic XP Admin Tool descriptor"] = 387,
    ["Enonic XP Application descriptor"] = 388,
    ["Enonic XP CMS descriptor"] = 389,
    ["Enonic XP Content Type descriptor"] = 390,
    ["Enonic XP Form Fragment descriptor"] = 391,
    ["Enonic XP ID Provider descriptor"] = 392,
    ["Enonic XP Layout descriptor"] = 393,
    ["Enonic XP Macro descriptor"] = 394,
    ["Enonic XP Mixin descriptor"] = 395,
    ["Enonic XP Page descriptor"] = 396,
    ["Enonic XP Part descriptor"] = 397,
    ["Enonic XP Service descriptor"] = 398,
    ["Enonic XP Site descriptor"] = 399,
    ["Enonic XP Style descriptor"] = 400,
    ["Enonic XP Task descriptor"] = 401,
    ["Enonic XP Webapp descriptor"] = 402,
    ["Enterprise Contract Policy Spec"] = 383,
    ["Envelope Team Definition"] = 1382,
    ["Envilder Map File"] = 384,
    ["Erda Pipeline"] = 1239,
    ["Erda Runtime"] = 1240,
    ["Espanso config.yml"] = 1363,
    ["Espanso match.yml"] = 1362,
    Esquio = 404,
    ["Estuary Flow Catalog"] = 1154,
    ["Ethereum ERC1155"] = 1376,
    ["Ethereum ERC721"] = 1375,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 409,
    ["EveryVoice TTS Toolkit Data Configuration"] = 410,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 414,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 413,
    ["EveryVoice TTS Toolkit Text Configuration"] = 411,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 412,
    ["Evolving Resolutive Process notation"] = 1339,
    ["Expo SDK"] = 415,
    ["Expoot app config"] = 417,
    ["F-Droid Data metadata"] = 423,
    ["FasterCI Configuration"] = 130,
    ["Fence configuration"] = 131,
    FiQuS = 427,
    Firebase = 425,
    ["Flatpak Builder Manifest"] = 428,
    ["FlexGet Config"] = 429,
    ["Flow.json Configurations"] = 1236,
    ["Fossa configuration file"] = 436,
    ["Fossa's fossa-deps file"] = 437,
    ["Foundry VTT - Base package Manifest"] = 431,
    ["Foundry VTT - Module Manifest"] = 432,
    ["Foundry VTT - System Data Template"] = 435,
    ["Foundry VTT - System Manifest"] = 433,
    ["Foundry VTT - World Manifest"] = 434,
    ["Foxx Manifest"] = 132,
    ["Freifunk.de Community API"] = 135,
    ["Frogbot Config"] = 136,
    ["G2P Mapping Configuration"] = 444,
    GAMA = 445,
    ["GCP Blueprint Metadata"] = 448,
    Gaspar = 446,
    ["GatewayCore API Gateway"] = 447,
    ["Gemini CLI settings"] = 449,
    ["GeoJSON.json latest"] = 1152,
    GherKing = 1156,
    ["GitHub Action"] = 458,
    ["GitHub Actions typing"] = 1274,
    ["GitHub CLI configuration"] = 459,
    ["GitHub CLI hosts"] = 460,
    ["GitHub Discussion"] = 461,
    ["GitHub Funding"] = 463,
    ["GitHub Issue Template configuration"] = 464,
    ["GitHub Issue Template forms"] = 465,
    ["GitHub Pages Jekyll"] = 466,
    ["GitHub Prompt"] = 462,
    ["GitHub Secret Scanning"] = 467,
    ["GitHub Workflow"] = 468,
    ["GitHub Workflow Template Properties"] = 469,
    ["GitHub automatically generated release notes configuration"] = 470,
    ["GitLab Agent for Kubernetes configuration"] = 1228,
    GitResume = 474,
    GitVersion = 452,
    ["Gitea Issue Template configuration"] = 455,
    ["Gitea Issue Template forms"] = 456,
    Gitleaks = 453,
    ["Gitpod Automations"] = 472,
    ["Gitpod Configuration"] = 473,
    ["Glamour style"] = 450,
    ["GlazeWM settings"] = 1230,
    ["Global Privacy Control"] = 451,
    Goblet = 1209,
    ["Golangci-lint Configuration"] = 489,
    ["Golangci-lint Custom Plugins Configuration"] = 490,
    ["Google Chrome Related Website Sets"] = 426,
    ["Google Cloud Workflows"] = 300,
    ["Google Digital Assetlinks"] = 1318,
    Goreleaser = 493,
    ["Goreleaser Pro"] = 494,
    Goss = 496,
    ["Gradle Build Cache Node"] = 1102,
    ["Gradle Enterprise"] = 1101,
    ["Grafana 5.x Dashboard"] = 497,
    ["GraphQL Code Generator"] = 502,
    ["GraphQL Config"] = 501,
    ["GraphQL Mesh"] = 500,
    ["GroovyLint configuration"] = 503,
    ["Grunt JSHint task"] = 507,
    ["Grunt Watch task"] = 508,
    ["Grunt base task"] = 509,
    ["Grunt clean task"] = 505,
    ["Grunt copy task"] = 504,
    ["Grunt cssmin task"] = 506,
    HEMTT = 1066,
    Hadolint = 1080,
    Hammerkit = 1112,
    ["Hardware Sentry Configuration"] = 1168,
    ["Hashgraph Online Skill Manifest"] = 6,
    ["HashiCorp Vault"] = 510,
    Hatch = 1081,
    Hayson = 512,
    ["Haystack Pipeline"] = 513,
    ["Hazelcast 5 Configuration"] = 514,
    ["Hecate Input Schema"] = 1329,
    ["Helm Chart.lock"] = 262,
    ["Helm Chart.yaml"] = 261,
    ["Helm Unittest Test Suite"] = 263,
    ["Heloisa Assistant Plugins Marketplace"] = 1405,
    ["Hex file"] = 264,
    ["Home Assistant Integration Manifest"] = 516,
    ["Homer dashboard configuration"] = 517,
    ["Hoverfly Simulation"] = 522,
    Hugo = 1144,
    ["Hugo Theme"] = 1143,
    ["Hulak Configuration"] = 525,
    ["Hyperfoil benchmark configuration"] = 524,
    ["IBM Zapp document"] = 526,
    ["IBM zCodeFormatSettings"] = 527,
    ["IMG Catapult PSP"] = 532,
    ["IVMS101 by CODE Protocol"] = 1229,
    ["Infinispan Configuration"] = 534,
    ["Infinispan Server Configuration"] = 535,
    Infrahub = 536,
    Istanbul = 1172,
    ["JDownloader2 crawler multi-rules"] = 550,
    ["JDownloader2 crawler single-rules"] = 549,
    ["JFrog Applications Config"] = 551,
    ["JFrog File Spec"] = 552,
    ["JFrog Pipelines YML DSL"] = 1178,
    ["JMeter DSL cli config"] = 553,
    JReleaser = 556,
    ["JSON Document Transform"] = 564,
    ["JSON Feed"] = 565,
    ["JSON Resume"] = 838,
    ["JSON Schema Draft 2020-12"] = 1046,
    ["JSON Schema Draft 4"] = 1043,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1211,
    ["JSON Schema Draft 7"] = 1044,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1212,
    ["JSON Schema Draft 8 (2019-09)"] = 1045,
    ["JSON-API"] = 563,
    ["JSON-e templates"] = 1109,
    ["JSON-stat 2.0"] = 1039,
    JSONPatch = 567,
    ["JSR Package Config (jsr.json)"] = 557,
    Jarl = 1345,
    Jasmine = 544,
    Jekyll = 545,
    ["Jenkins X Pipelines"] = 546,
    ["Jenkins X Requirements"] = 547,
    Jest = 548,
    Jocker = 554,
    ["Jovo Language Models"] = 555,
    ["Jujutsu (jj) VCS config"] = 1331,
    ["KIMMDY config file"] = 578,
    ["KODE/CI build.yaml"] = 1174,
    ["KSP-AVC"] = 1040,
    ["KSP-CKAN"] = 1041,
    ["KSP-NetKAN"] = 1042,
    KSY = 1241,
    KSail = 442,
    ["KYA Manifest"] = 1242,
    ["Karakum configuration file"] = 438,
    Kas = 570,
    ["Kestra flow file"] = 579,
    ["Keycloak REST API"] = 1181,
    ["Knative Functions - func.yaml"] = 439,
    Knip = 440,
    ["Knip JSONC"] = 441,
    ["Knowledge Unit"] = 587,
    ["Kometa (nightly) config file"] = 581,
    ["Kometa config file"] = 580,
    ["Kong DBLess config"] = 1175,
    KrakenD = 582,
    ["Kubri Configuration"] = 590,
    LOOBin = 606,
    ["Lake configuration file"] = 1334,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 305,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 306,
    ["Landing Zone Accelerator on AWS - Global Config"] = 307,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 308,
    ["Landing Zone Accelerator on AWS - Network Config"] = 309,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 310,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 311,
    ["Landing Zone Accelerator on AWS - Security Config"] = 312,
    ["Lando (landofile)"] = 122,
    ["LangGraph Platform configuration"] = 1253,
    ["Language configuration"] = 1252,
    Lefthook = 595,
    ["Liferay client-extension.yaml"] = 602,
    ["LinkML Metamodel"] = 604,
    Liquibase = 1119,
    ["Liquibase Flow File"] = 1120,
    ["Lively Properties"] = 605,
    ["Lobe AI Agent"] = 124,
    Loki = 125,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 649,
    ["MS2Rescore Configuration"] = 657,
    ["MSTest testconfig.json"] = 658,
    ["Madge configuration"] = 612,
    ["Madness (madness.yml)"] = 1192,
    ["Mado configuration"] = 613,
    ["Maestro Flow"] = 614,
    ["Mail Servers Configuration"] = 1366,
    ["MapEHR Mapping"] = 615,
    Markdownlint = 1123,
    ["Mason Registry"] = 1126,
    ["MegaLinter Custom Flavor"] = 618,
    ["MegaLinter configuration"] = 617,
    ["MegaLinter descriptor"] = 619,
    Melange = 1219,
    ["Meltano project definition"] = 620,
    ["Mergify Configuration"] = 659,
    ["Mermaid config"] = 1,
    ["Metadata for a Bazel module"] = 621,
    ["Metadata for a Cinnamon spice"] = 1270,
    ["Metatype Configuration"] = 622,
    ["MetricsHub Configuration"] = 623,
    ["MetricsHub Connector Configuration"] = 624,
    ["Micro Editor Syntax"] = 1202,
    ["Microsoft Band Web Tile"] = 625,
    ["Microsoft RulesEngine workflow rules"] = 1257,
    ["Microsoft RulesEngine workflow rules list"] = 1258,
    ["Minecraft Custom Main Menu Mod"] = 1220,
    ["Minecraft Data Pack Advancement"] = 627,
    ["Minecraft Data Pack Biome"] = 628,
    ["Minecraft Data Pack Configured Carver"] = 629,
    ["Minecraft Data Pack Damage Type"] = 630,
    ["Minecraft Data Pack Dimension"] = 632,
    ["Minecraft Data Pack Dimension Type"] = 631,
    ["Minecraft Data Pack Item Modifier"] = 633,
    ["Minecraft Data Pack Loot Table"] = 634,
    ["Minecraft Data Pack Metadata"] = 635,
    ["Minecraft Data Pack Predicate"] = 636,
    ["Minecraft Data Pack Recipe"] = 637,
    ["Minecraft Data Pack Tag"] = 638,
    ["Minecraft Data Pack Template Pool"] = 639,
    ["Minecraft Data Pack Trim Material"] = 644,
    ["Minecraft Data Pack Trim Pattern"] = 645,
    ["Minecraft Resource Pack Lang"] = 640,
    ["Minecraft Resource Pack Particle"] = 641,
    ["Minecraft Resource Pack Texture Mcmeta"] = 643,
    ["Minecraft Resourcepack Sounds"] = 642,
    ["MockServer Expectation"] = 651,
    ["MockServer Expectations"] = 652,
    ModuleAssembler = 647,
    ["Monade CLI Stack Configuration"] = 662,
    ["MongoDB Atlas Search Index Definition"] = 1173,
    ["Monika Configuration"] = 1171,
    ["Monoweave Configuration"] = 656,
    ["Motif config"] = 1062,
    MultiQC = 1311,
    ["NOX Framework (Service)"] = 684,
    ["Netin Diagnostic System Template"] = 1130,
    ["Netlify config"] = 665,
    ["Network-as-Code Data Model"] = 666,
    ["Next Gen UI Agent A2A Server Configuration"] = 667,
    ["Next Gen UI Agent Configuration"] = 669,
    ["Next Gen UI Agent MCP Server Configuration"] = 668,
    ["Nightwatch.js"] = 676,
    ["Nika workflow"] = 681,
    ["Node.js configuration"] = 1067,
    ["NueJS configuration file"] = 689,
    ["Nuitka Package Config"] = 1234,
    ["Nullstone config"] = 691,
    ["ODGS Data Rules"] = 698,
    ["ODGS Ontology Graph"] = 699,
    ["ODGS Standard Metrics"] = 697,
    ["OKF Graph"] = 1406,
    ["ONe's changelog entry"] = 713,
    ["ONe's service descriptor"] = 712,
    ["ORT Server repository environment configuration"] = 723,
    ["OSCAL Assessment Plan (AP)"] = 725,
    ["OSCAL Assessment Results (AR)"] = 726,
    ["OSCAL Catalog"] = 727,
    ["OSCAL Component Definition (CDef)"] = 728,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 729,
    ["OSCAL Profile"] = 730,
    ["OSCAL System Security Plan (SSP)"] = 731,
    ["OSS Review Toolkit configuration"] = 732,
    ["OSS Review Toolkit curation"] = 733,
    ["OSS Review Toolkit package configuration"] = 734,
    ["OSS Review Toolkit project package manager definition"] = 735,
    ["OSS Review Toolkit repository configuration"] = 736,
    ["OSS Review Toolkit resolutions"] = 737,
    ["October CMS columns"] = 695,
    ["October CMS fields"] = 696,
    ["Oh My Posh"] = 701,
    Okteto = 702,
    ["Ona Automations"] = 704,
    Opctl = 1065,
    ["Open Data Contract Standard (ODCS)"] = 717,
    ["Open Data Product Standard (ODPS)"] = 718,
    ["Open Know-How"] = 1316,
    OpenDecree = 1380,
    ["OpenDecree Configuration"] = 1381,
    ["OpenRewrite Resource"] = 715,
    OpenSRM = 719,
    OpenStatus = 1327,
    ["OpenTelemetry Declarative Configuration"] = 716,
    ["OpenUtau character yaml"] = 709,
    ["OpenUtau ustx"] = 710,
    ["OpenWeather Current Weather API"] = 1108,
    ["OpenWeather Road Risk API"] = 1107,
    ["Ory Hydra configuration"] = 523,
    ["Ory Keto configuration"] = 586,
    ["Ory Kratos configuration"] = 724,
    ["Ory Oathkeeper configuration"] = 693,
    ["Outblocks App configuration"] = 721,
    ["Outblocks database table"] = 722,
    ["Outblocks project configuration"] = 720,
    PDM = 745,
    POPxf = 757,
    ["POPxf Correlations"] = 758,
    ["PRML manifest"] = 765,
    Packer = 741,
    PactSpec = 742,
    Panache = 743,
    Pantsbuild = 1188,
    ["Paper paper-plugin.yml"] = 744,
    ["Pipeline component"] = 1121,
    ["Platform.sh application"] = 12,
    ["Platform.sh routes"] = 13,
    ["Platform.sh services"] = 14,
    ["Plex Prerolls"] = 755,
    ["PocketMine plugin.yml"] = 752,
    ["Podman Desktop Extension"] = 1400,
    ["Postman collection"] = 761,
    ["Power Pages Configuration"] = 1328,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1273,
    ["ProActions AI-Kit Configuration"] = 773,
    ["ProActions AI-Kit Configuration for Menus"] = 775,
    ["ProActions AI-Kit Configuration for Sections"] = 777,
    ["ProActions AI-Kit Configuration for Services"] = 774,
    ["ProActions AI-Kit Configuration for Steps"] = 778,
    ["ProActions AI-Kit Configuration for Templates"] = 776,
    ["Problem object RFC9457"] = 1217,
    ["Problem package format"] = 779,
    ["Problem package generators"] = 780,
    ["Problem package submissions"] = 781,
    ["Problem package test group metadata"] = 782,
    Pterodactyl = 1167,
    ["Pull Request Labeler"] = 799,
    Pulumi = 807,
    ["PyGTA Config"] = 803,
    PyProject = 808,
    Pylock = 1319,
    Pyright = 809,
    ["Python script metadata"] = 1313,
    ["QType AI DSL"] = 812,
    Qgoda = 811,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1392,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1390,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1396,
    ["Qlik Talend Cloud Pipeline - Project"] = 1388,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1391,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1393,
    ["Qlik Talend Cloud Pipeline - Task"] = 1389,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1395,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1394,
    Qodana = 1140,
    ["Qt Creator workspace file"] = 1250,
    ["Quali Torque Blueprint Spec 2"] = 1165,
    ["QueryFirst config file"] = 1184,
    ["QuikRun Configuration"] = 1397,
    ["Qwen Code Settings"] = 1377,
    ["RKE Cluster Configuration JSON"] = 1118,
    ["RKE Cluster Configuration YAML"] = 1117,
    RadioHound = 802,
    ["Raid Profile"] = 1378,
    ["Raid Repo Configuration"] = 1379,
    Railpack = 814,
    Railway = 813,
    ["Rancher Fleet"] = 804,
    ["Rattler-build"] = 815,
    Ray = 1079,
    ["Read the Docs"] = 806,
    ["Red-DiscordBot Cog"] = 822,
    ["Red-DiscordBot Cog Repo"] = 823,
    ["Red-DiscordBot Trivia"] = 824,
    ["Releasaurus Config"] = 9,
    ReleaseKit = 8,
    ["Render Blueprints"] = 1116,
    RenderCV = 842,
    Renovate = 839,
    ["Renovate global configuration"] = 840,
    ["Renovate inherited configuration"] = 841,
    ["Replit config"] = 830,
    Restate = 1306,
    ["Revel Digital Gadget Definition File"] = 1330,
    RoadRunner = 844,
    ["Robust Station Image"] = 1336,
    Rockcraft = 845,
    ["Roo Coder Custom Modes"] = 846,
    Rubocop = 835,
    ["Rudder techniques"] = 1224,
    Ruff = 836,
    ["Rust Project"] = 837,
    ["Rust toolchain"] = 851,
    ["SDMX data message"] = 878,
    ["SDMX metadata message"] = 877,
    ["SDMX structure message"] = 876,
    ["SIL Kit Participant Configuration"] = 889,
    ["SIL Kit Registry Configuration"] = 890,
    ["SPDX 2.3"] = 932,
    SWADL = 948,
    ["Safebox Config"] = 1179,
    ["Sapphire CLI Config"] = 854,
    ["SauceCTL Configuration"] = 1127,
    Scarb = 874,
    ["Schema Catalog"] = 869,
    ["Scoop manifest"] = 875,
    ["Secure SDLC Evidence Bundle"] = 879,
    ["Semantic Data Fabric (SDF) file"] = 880,
    ["Semgrep Rule"] = 882,
    ["Serenity Code Generator (Sergen)"] = 883,
    ["Serverless Framework Configuration"] = 1134,
    ["Serverless Workflow"] = 1136,
    ["Settings for a Cinnamon spice"] = 1269,
    ["Settings.paf"] = 885,
    ["Shopware 6 Configuration"] = 1137,
    ["Shopware CLI Extension Store Configuration"] = 1138,
    ["Shopware CLI Project Store Configuration"] = 1139,
    ["Sigma Detection Rule"] = 887,
    ["SigmaCV CV"] = 4,
    ["Sigrid scope configuration file"] = 888,
    ["SkyPilot Task JSON"] = 1225,
    ["Slack app manifest"] = 895,
    ["Slang Server Configuration"] = 1404,
    Snapcraft = 897,
    ["Solarxy project config"] = 900,
    Solidarity = 901,
    ["Solution filters"] = 902,
    ["Source Maps v3"] = 903,
    Sourcery = 904,
    ["Spack bootstrap.yaml"] = 905,
    ["Spack cdash.yaml"] = 906,
    ["Spack ci.yaml"] = 907,
    ["Spack compilers.yaml"] = 908,
    ["Spack concretizer.yaml"] = 909,
    ["Spack config.yaml"] = 910,
    ["Spack definitions.yaml"] = 911,
    ["Spack develop.yaml"] = 912,
    ["Spack env_vars.yaml"] = 913,
    ["Spack environment"] = 919,
    ["Spack include.yaml"] = 914,
    ["Spack mirrors.yaml"] = 915,
    ["Spack modules.yaml"] = 916,
    ["Spack packages.yaml"] = 917,
    ["Spack repos.yaml"] = 918,
    ["Spack toolchains.yaml"] = 920,
    ["Spack upstreams.yaml"] = 921,
    ["Spack view.yaml"] = 922,
    ["Speakeasy Generation Config File"] = 926,
    ["Speakeasy Lint Configuration File"] = 923,
    ["Speakeasy Test Generation Configuration File"] = 924,
    ["Speakeasy Workflow File"] = 925,
    SpecIF = 927,
    ["Specmatic Configuration"] = 928,
    ["Specpin spec file"] = 2,
    ["Sponge Mixin configuration"] = 929,
    ["Spotlight Ruleset"] = 930,
    StackBlitz = 936,
    ["StackHawk Scanner Configuration"] = 1133,
    Stale = 937,
    Starfish = 938,
    ["Starlake Data Pipeline"] = 1105,
    Starship = 939,
    ["Statamic Blueprint"] = 940,
    ["Stella configuration file"] = 941,
    ["Streamlit configuration file"] = 942,
    ["Stryker Mutator"] = 945,
    ["StyleCop Analyzers Configuration"] = 946,
    ["Stylelint (.stylelintrc)"] = 947,
    ["Stylua Config"] = 1320,
    ["Sublime Syntax"] = 1180,
    ["Subsquid squid manifest"] = 1227,
    ["Swagger API 2.0"] = 949,
    ["Synadia Connect Component"] = 950,
    TSON = 988,
    TSTyche = 989,
    ["TYPO3 Vendor Bundler config"] = 995,
    ["Tab data for a LinUtil"] = 1276,
    ["Tab list for a LinUtil"] = 1275,
    Tach = 951,
    ["Tach Domain"] = 952,
    Talhelper = 954,
    ["Talisman configuration"] = 955,
    Taplo = 1321,
    ["Taskfile config"] = 1110,
    Taurus = 956,
    Tauticord = 957,
    ["Tekton Pipeline"] = 1349,
    ["Tekton PipelineRun"] = 1350,
    ["Tekton Task"] = 1347,
    ["Tekton TaskRun"] = 1348,
    Telefonistka = 1307,
    ["Terrateam config"] = 1333,
    ["TestEnvironment.json"] = 969,
    ["TextMate Grammar"] = 968,
    Threagile = 963,
    ["Tier.run pricing.json"] = 960,
    Tikibase = 961,
    Tombi = 966,
    ["Traefik v2"] = 972,
    ["Traefik v2 File Provider"] = 973,
    ["Traefik v3"] = 974,
    ["Traefik v3 File Provider"] = 975,
    ["Travis CI (.travis.yml)"] = 971,
    Treefmt = 499,
    Trident = 1303,
    Trivy = 978,
    ["TrueScript for *.tscript files"] = 979,
    ["Tugboat QA config.yml"] = 1300,
    TunnelHub = 1215,
    Turborepo = 970,
    Tycho = 1264,
    Tye = 1141,
    ["Tyk Gateway - Open Source v5.7+"] = 1312,
    ["UET BuildConfig.json"] = 1185,
    ["UI5 Manifest"] = 1001,
    ["UNCORS configuration"] = 1006,
    ["UTAM Page Object"] = 1004,
    ["Ubuntu Server Autoinstall"] = 999,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1304,
    ["Uniswap Token List"] = 1090,
    ["Universal Schedule Format"] = 1007,
    ["Unreal Engine Uplugin"] = 1186,
    ["Unreal Engine Uproject"] = 1187,
    ["UpCloud CLI (upctl) configuration"] = 1305,
    ["Updatecli Compose"] = 1149,
    ["Updatecli Policy Manifest"] = 1150,
    ["Updatecli Policy Metadata"] = 1151,
    Uplift = 1183,
    ["Upsun config"] = 11,
    ["User Journey Map"] = 1115,
    V2Ray = 1155,
    ["VSCode Code Snippets"] = 288,
    ["VSIX CLI publishing"] = 1026,
    Vector = 1009,
    ["Vela Pipeline Configuration"] = 1012,
    Vercel = 287,
    ["Version Bumper config"] = 1015,
    Vespertide = 1354,
    ["Vespertide Migration"] = 1355,
    ["Vespertide Model"] = 1356,
    ["Viash Component Config"] = 1309,
    ["Viash Package Config"] = 1310,
    Visivo = 1213,
    Vogi = 1020,
    ["WP-CLI"] = 1036,
    Wake = 1302,
    ["Waku Config"] = 1279,
    ["Web App Manifest"] = 1032,
    ["Web types"] = 1035,
    WebExtensions = 1031,
    ["Webman package recipe"] = 1161,
    ["Windows Package Manager Installer Manifest"] = 1087,
    ["Windows Package Manager Locale Manifest"] = 1088,
    ["Windows Package Manager Singleton Manifest"] = 1086,
    ["WireMock CLI import configuration"] = 1285,
    ["WireMock CLI local service configuration"] = 1284,
    ["WireMock message stub mapping"] = 1283,
    ["WireMock stub mapping"] = 1282,
    ["Woodpecker pipeline config"] = 1129,
    ["Wrangler CLI"] = 1037,
    ["XenForo add-on manifest"] = 1038,
    ["Xstate Machine"] = 1147,
    ["Yandex Workflow Language"] = 1271,
    ["Yarn Config (.yarnrc.yml)"] = 1103,
    ["Yippee-Ki-JSON configuration YML"] = 1094,
    ["YouTrack App"] = 1268,
    ["Zarf Package Configuration"] = 1335,
    ["Zerops import file"] = 1256,
    ["Zola Configuration"] = 1346,
    abtop = 32,
    act3 = 1384,
    actionlint = 42,
    ["aerleon.yml"] = 26,
    ["amplify.yml"] = 19,
    ["amxx-builder manifest"] = 1399,
    ["angular.json"] = 47,
    apko = 1218,
    ...
    ["behat.yml"] = 159,
    ["bigquery-table"] = 147,
    ["bioimageio resource description"] = 1235,
    ...
    ["cargo-nextest repository configuration"] = 670,
    ["cargo-nextest user configuration"] = 671,
    ["ccmod.json"] = 1280,
    changelogging = 1247,
    ["chezmoi configuration"] = 192,
    ["chisel-slices.json"] = 314,
    ["chrome-extension-locales-messages.json"] = 295,
    ["chutzpah.json"] = 296,
    cibuildwheel = 197,
    ["clang-format (.clang-format)"] = 1153,
    ["clang-tidy"] = 270,
    clangd = 269,
    clib = 271,
    ["cloud-init: cloud-config userdata"] = 273,
    ["cloud-sdk-pipeline-configuration"] = 298,
    ["cloudbuild.json"] = 299,
    cloudify = 272,
    cmakefmt = 215,
    ["cmdx.yaml"] = 108,
    ...
    ["commands.json"] = 291,
    ["commit-check"] = 317,
    ["commitlint (.commitlintrc)"] = 1089,
    ["committed.toml"] = 318,
    ["compile_commands.json"] = 290,
    ["compilerconfig.json"] = 289,
    ["completely.yml"] = 1191,
    ["component-detection-manifest.json"] = 321,
    ["component.json"] = 320,
    ["composer.json"] = 319,
    ["conda-forge"] = 201,
    ["config.yaml"] = 805,
    ["contentmanifest.json"] = 297,
    ["contribute.json"] = 322,
    ["cosmos.config.json"] = 293,
    ["crowdin.yml"] = 323,
    ["ctfd-setup configuration file"] = 1292,
    ["custom-elements.json"] = 1205,
    ["cypress.json"] = 327,
    ["dacier.yml"] = 1387,
    ["datalogic-scan2deploy-android"] = 337,
    ["datalogic-scan2deploy-ce"] = 338,
    ["dbt Dependencies"] = 232,
    ["dbt Packages"] = 234,
    ["dbt Project"] = 233,
    ["dbt Selectors"] = 235,
    ["dbt YAML files"] = 236,
    ...
    ["ddev-global"] = 339,
    ["ddev-project"] = 340,
    ["debugsettings.json"] = 341,
    ["dependabot-v2.json"] = 345,
    ["dependabot.json"] = 344,
    ["deployed-cli"] = 1146,
    ["devcontainer-feature.json"] = 281,
    ["devcontainer.json"] = 280,
    devinit = 1096,
    ["devspace.yaml"] = 1169,
    djlint = 1097,
    ["docker bake"] = 351,
    ["docker sequencer"] = 352,
    ["docker-compose.yml"] = 1095,
    ["dockerd.json"] = 349,
    ["dotnet Release Index manifest"] = 364,
    ["dotnet-tools.json"] = 365,
    ["dotnetcli.host.json"] = 366,
    ["dprint.json"] = 367,
    ["drone.json"] = 368,
    ["dss-2.0.0.json"] = 370,
    ["dstack configuration"] = 371,
    ["dtool dataset metadata"] = 1287,
    ["dvc.yaml"] = 373,
    ["ecosystem.json"] = 378,
    ["editorconfig-checker"] = 380,
    eksctl = 381,
    ["electron-builder configuration file"] = 407,
    ["epr-manifest.json"] = 406,
    ["estampo.toml"] = 405,
    ["evcc.yaml"] = 408,
    ["ezd task runner"] = 419,
    ["fabric.mod.json"] = 422,
    ["first-timers-bot"] = 430,
    ["flagd flag configuration"] = 133,
    ["fly.io Configuration"] = 134,
    fulibWorkflows = 1128,
    ["function.json"] = 443,
    ["gRPC API Gateway & OpenAPI Config"] = 21,
    ["gematik health care insurance list"] = 1298,
    ["gematik health care patient list"] = 1295,
    ["gematik health care provider institution list"] = 1297,
    ["gematik health care provider list"] = 1296,
    ["gematik tiger test environment configuration"] = 1299,
    ["gh-dash"] = 457,
    ["git-cliff"] = 454,
    ["git-town.toml"] = 1344,
    ["gitlab-ci"] = 471,
    ["global.json"] = 488,
    ["go-feature-flag Flag Configuration"] = 492,
    gollama = 491,
    ["hassette.toml"] = 515,
    ["haxelib.json"] = 511,
    helmfile = 1082,
    ...
    ["ide.host.json"] = 528,
    ["ifstate.yaml"] = 529,
    ["imageoptimizer.json"] = 530,
    ["importmap.json"] = 533,
    ["index.toml (packwiz)"] = 1401,
    instant_python_config = 537,
    instant_python_custom_project = 538,
    intlayer = 539,
    ["ioBroker Configuration"] = 540,
    ["ioBroker JSON UI"] = 541,
    ["ioBroker Package manifest"] = 542,
    ["ixpect.conf.yaml"] = 543,
    ["ize.toml"] = 1182,
    ["jsconfig.json"] = 568,
    ["jscpd Configuration"] = 1166,
    jsdoc = 1078,
    ["k3d.yaml"] = 569,
    ["k9s aliases.yaml"] = 571,
    ["k9s cluster-config.yaml"] = 573,
    ["k9s config.yaml"] = 572,
    ["k9s hotkeys.yaml"] = 574,
    ["k9s plugins.yaml"] = 575,
    ["k9s skin.yaml"] = 576,
    ["k9s views.yaml"] = 577,
    ["kind cluster"] = 591,
    ["kontinuous-config.yaml"] = 589,
    ["kontinuous-values.yaml"] = 588,
    ["kustomization.yaml"] = 592,
    ["label-commenter-config.yml"] = 593,
    ["latexindent configuration"] = 123,
    ["launchsettings.json"] = 594,
    lazydocker = 1204,
    lazygit = 1203,
    ["lego.json"] = 596,
    ["lerna.json"] = 597,
    ["lgtm.yml"] = 598,
    ["liblab.config.json"] = 599,
    ["libman.json"] = 600,
    ["license-report-config.json"] = 601,
    ["linkinator.config.json"] = 603,
    ["lint-staged (.lintstagedrc)"] = 1055,
    ["local.settings.json"] = 608,
    ["localazy.json"] = 609,
    ["lotus.yaml"] = 607,
    ["lsd colors"] = 127,
    ["lsd config"] = 126,
    ...
    lychee = 1054,
    ["macro.json"] = 1170,
    ["markdown-link-check"] = 1124,
    maturin = 1125,
    mboats = 1132,
    memnex = 1385,
    ["micro-settings.json"] = 1197,
    ["mimetypes.json"] = 626,
    ["mirrord config"] = 1058,
    ["misata.yaml"] = 1057,
    mise = 1059,
    ["mkdocs.yml"] = 646,
    ["mockd.yaml"] = 650,
    ["mod.pw.toml (packwiz)"] = 1402,
    ["modelparams.dev Model"] = 653,
    ["models CLI"] = 654,
    ["monospace.yml"] = 655,
    ["moon.yml"] = 1281,
    ["mprocs Configuration file"] = 1251,
    ["mrdocs.yml"] = 648,
    ["mta.yaml"] = 1060,
    ["mtad.yaml"] = 1061,
    ["mycode.json"] = 663,
    nFPM = 675,
    ["napari plugin manifest"] = 664,
    neoload = 1073,
    ["nest-cli"] = 678,
    ["nexus-rpc-gen"] = 1371,
    ["nf-core module environment.yml"] = 672,
    ["nf-core module meta.yml"] = 673,
    ["nf-core subworkflow meta.yml"] = 674,
    ["ninjs (News in JSON)"] = 677,
    ["nitro.json"] = 1072,
    ["nixd configuration"] = 1223,
    ["nlu.json"] = 679,
    ["nodemon.json"] = 682,
    ["noodl config"] = 1131,
    ["notebook.mod.json"] = 683,
    now = 1068,
    ["npm-badges"] = 686,
    ["nswag.json"] = 690,
    ntangle = 692,
    ["nuclei-template.yaml"] = 687,
    ["nuget-project.json"] = 688,
    ["ocelot.json"] = 694,
    ogen = 700,
    ["omnisharp.json"] = 703,
    openHAB = 1357,
    ...
    oxfmt = 1367,
    oxlint = 1368,
    ["pack.toml (packwiz)"] = 1403,
    ["package.json"] = 738,
    ["package.manifest"] = 740,
    ["package.yaml"] = 739,
    ["partial-black.json"] = 160,
    ["partial-fastapi.json"] = 161,
    ["partial-pixi.json"] = 750,
    ["partial-scheduled.json"] = 162,
    ["pattern.json"] = 748,
    ["petstore-v1.0"] = 1177,
    pgap_yaml_input_reader = 746,
    pgrls = 747,
    pgxgen = 1361,
    pitcms = 1364,
    ["pixi.toml"] = 749,
    ["plagiarize-me.yaml"] = 754,
    ["plagiarize.yaml"] = 753,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1288,
    ["podbard.yaml"] = 756,
    ["portman.json"] = 759,
    ["prefect.toml"] = 768,
    ["prefect.yaml"] = 769,
    ...
    ["prettierrc.json"] = 771,
    ["prisma.yml"] = 772,
    ["project-1.0.0-beta3.json"] = 784,
    ["project-1.0.0-beta4.json"] = 785,
    ["project-1.0.0-beta5.json"] = 786,
    ["project-1.0.0-beta6.json"] = 787,
    ["project-1.0.0-beta8.json"] = 788,
    ["project-1.0.0-rc1.json"] = 789,
    ["project-1.0.0-rc2.json"] = 790,
    ["project.json"] = 783,
    ["project.owasp.yaml"] = 791,
    ["prometheus-alertmanager.json"] = 795,
    ["prometheus.json"] = 792,
    ["prometheus.rules.json"] = 793,
    ["prometheus.rules.test.json"] = 794,
    ["proxies.json"] = 796,
    ["publiccode.yml"] = 797,
    ["pubspec.yaml"] = 798,
    ["pyrseas-0.8.json"] = 801,
    pytest = 810,
    ["quilt.mod.json"] = 1198,
    ["rc3 auth"] = 816,
    ["rc3 collection"] = 817,
    ...
    ["rc3 settings"] = 821,
    ["registry.yaml"] = 60,
    ["release drafter"] = 1074,
    ["release-hub.json"] = 7,
    ["release-please-config.json"] = 826,
    ["release-please-manifest.json"] = 827,
    ["release-plz.toml"] = 828,
    ["renv.lock"] = 843,
    ["repo-settings-as-code"] = 831,
    ["reposets Configuration"] = 832,
    ["reposets Credentials"] = 833,
    ["revola.json"] = 5,
    ["rivet.json"] = 1222,
    ["rivet.yaml (legacy)"] = 1221,
    rumdl = 848,
    runny = 847,
    runspec = 1386,
    rustfmt = 849,
    ...
    samt = 852,
    samtrc = 853,
    ["sarif-1.0.0.json"] = 855,
    ["sarif-2.0.0.json"] = 856,
    ["sarif-2.1.0"] = 866,
    ["sarif-2.1.0-rtm.2"] = 857,
    ["sarif-2.1.0-rtm.3"] = 859,
    ["sarif-2.1.0-rtm.4"] = 861,
    ["sarif-2.1.0-rtm.5"] = 863,
    ["sarif-2.1.0-rtm.6"] = 864,
    ["sarif-external-property-file-2.1.0"] = 867,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 858,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 860,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 862,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 865,
    ["scalingo.json configuration"] = 868,
    ["schema.org - Action"] = 870,
    ["schema.org - ContactPoint"] = 871,
    ["schema.org - Place"] = 872,
    ["schema.org - Thing"] = 873,
    ["secrethub.yml"] = 1200,
    ["semantic-release"] = 881,
    ["servicehub.config.json"] = 1049,
    ["servicehub.service.json"] = 1048,
    ["settings.job"] = 884,
    ["sfdx-hardis configuration"] = 886,
    ["shard.yml"] = 1238,
    ["size-limit configuration"] = 891,
    ["skaffold.yaml"] = 1122,
    ["skill-map plugin extension manifest"] = 892,
    ["skill-map project settings"] = 893,
    ["skill-map provider kind"] = 894,
    ["skyuxconfig.json"] = 896,
    ["snowflake-config"] = 898,
    ["snowflake-connections"] = 899,
    ["spicepod.yaml"] = 1259,
    ["sqlc configuration"] = 933,
    ["stripe-app-local.json"] = 944,
    ["stripe-app.json"] = 943,
    swcrc = 1106,
    ["task.json"] = 953,
    taskcat = 1069,
    ["template.json"] = 958,
    ["templatsources.json"] = 959,
    ["text2confl config"] = 1369,
    ["theme.json"] = 962,
    ["tizen_workspace.json"] = 964,
    tldr = 965,
    ["tm_devices configuration file"] = 1326,
    tmuxinator = 1052,
    tox = 967,
    ["transcend.yml"] = 976,
    ["tree-sitter grammar.json"] = 498,
    ["trime.yaml"] = 977,
    ["trunk.yaml"] = 980,
    ["ts-force-config.json"] = 986,
    tsbuild = 981,
    ["tsconfig.json"] = 982,
    ["tsd.json"] = 983,
    ["tsdoc.json"] = 984,
    ...
    v8r = 1030,
    vcluster = 1245,
    ["vcpkg configuration file"] = 286,
    ["vcpkg manifest file"] = 285,
    ["vega-lite.json"] = 1011,
    ["vega.json"] = 1010,
    ["venvironment.yaml"] = 1013,
    ["venvplus.yaml"] = 1014,
    version = 1308,
    ["version.json"] = 1016,
    ["vhwdebugger-binding.yaml"] = 1018,
    ["vim-addon-info"] = 1019,
    ["vs-2017.3.host.json"] = 1022,
    ["vs-nesting.json"] = 1023,
    ["vsls.json"] = 1021,
    ["vss-extension.json"] = 1027,
    vtcfg = 1314,
    ["vtesttree.yaml"] = 1028,
    ["vtestunit.yaml"] = 1029,
    ["warp-keysets.json"] = 1206,
    ["warp-themes.json"] = 1207,
    ["warp-workflows.json"] = 1208,
    ["webhint.io"] = 1162,
    ["webjobpublishsettings.json"] = 1034,
    ["webjobs-list.json"] = 1033,
    ["well-known-fursona"] = 1246,
    ["xs-app.json"] = 1064,
    ["xunit.runner.json"] = 1047,
    yamlfmt = 1091,
    yamllint = 1092,
    ["yap.json"] = 1093,
    ["zerops.yml"] = 1255,
