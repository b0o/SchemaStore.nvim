...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1001,
    [".nodehawkrc"] = 633,
    [".npmpackagejsonlintrc"] = 637,
    [".omletrc"] = 1182,
    [".phrase.yml"] = 715,
    [".phraseapp.yml"] = 716,
    [".pmbot.yml"] = 700,
    [".postcssrc"] = 709,
    [".powerpages-web-template-manifest"] = 711,
    [".pre-commit-config.yml"] = 712,
    [".pre-commit-hooks.yml"] = 713,
    [".putout.json"] = 749,
    [".rehyperc"] = 774,
    [".remarkrc"] = 778,
    [".sprite files"] = 874,
    ...
    AIConfig = 38,
    ["AMX Muse Program Descriptor"] = 1231,
    ["API Builder"] = 1037,
    ["AVA Configuration"] = 1101,
    ["AWS AppConfig Feature Flags-v1"] = 72,
    ["AWS CDK cdk.json"] = 278,
    ["AWS CloudFormation"] = 279,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 280,
    ["AWS Copilot Manifest"] = 1270,
    ["AWS SAM CLI Samconfig"] = 281,
    Acton = 1321,
    ["Adobe UXP Manifest"] = 1164,
    ["Aerleon Network & Service Definitions"] = 23,
    ["Aerleon Policy"] = 24,
    ["Agent Permission Policy"] = 1310,
    ["AgentCore CLI"] = 1311,
    AgentLoopKit = 1312,
    Aider = 1260,
    Air = 26,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1281,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1280,
    ["Airlock Microgateway"] = 39,
    ["Alacritty Configuration"] = 1073,
    ["AlgoVoi Compliance Receipt v1"] = 13,
    ["All Contributors configuration file"] = 1127,
    Anodizer = 458,
    ["Ansible Argument Specs"] = 442,
    ["Ansible Collection Galaxy"] = 449,
    ["Ansible Execution Environment"] = 439,
    ["Ansible Inventory"] = 448,
    ["Ansible Meta"] = 440,
    ["Ansible Meta Runtime"] = 441,
    ["Ansible Navigator Configuration"] = 451,
    ["Ansible Playbook"] = 446,
    ["Ansible Requirements"] = 443,
    ["Ansible Rulebook"] = 447,
    ["Ansible Tasks File"] = 445,
    ["Ansible Vars File"] = 444,
    ["Ansible-lint Configuration"] = 450,
    Any = 1192,
    ["AnyWork Automation Configuration"] = 19,
    ["Apollo Router"] = 1038,
    ["App config Spotify Backstage"] = 43,
    ["Applicant Profile Protocol"] = 16,
    ["Application Accelerator"] = 14,
    ["Application list for a WinUtil"] = 1210,
    ArchitectFX = 1215,
    ["Argo CD"] = 58,
    ["Argo Events"] = 59,
    ["Argo Workflows"] = 60,
    AssemblyScript = 63,
    AsyncAPI = 66,
    ["AsyncAPI Tool File"] = 67,
    ["Atmos Manifests"] = 68,
    ["Aurora Agile Meta-Framework"] = 69,
    AutoAPICase = 1137,
    ["Avro Avsc"] = 70,
    ["Awesome Repositories"] = 71,
    ["Azure Container App template for defining an immutable revision"] = 74,
    ["Azure DevOps extension manifest"] = 77,
    ["Azure Device Update for IoT Hub import manifest"] = 75,
    ["Azure Device Update for IoT Hub update manifest"] = 76,
    ["Azure IoT Edge deployment"] = 80,
    ["Azure IoT Edge deployment template"] = 81,
    ["Azure IoT EdgeAgent deployment"] = 78,
    ["Azure IoT EdgeHub deployment"] = 79,
    ["Azure IoT Operations Wasm Graph Config"] = 1279,
    ["Azure IoT Operations connector metadata"] = 1276,
    ["Azure Landing Zones Library archetype definition"] = 85,
    ["Azure Landing Zones Library archetype override"] = 86,
    ["Azure Landing Zones Library architecture definition"] = 84,
    ["Azure Landing Zones Library metadata"] = 82,
    ["Azure Landing Zones Library policy default values"] = 83,
    ["Azure Pipelines"] = 118,
    ["Azure Static Web Apps CLI configuration file"] = 878,
    ["Azure Static Web Apps configuration file"] = 877,
    BMML = 1298,
    ["BOSH BPM Config"] = 144,
    ["BOSH CPI Config"] = 145,
    ["BOSH Deploy Config"] = 146,
    ["BX CI"] = 167,
    ["Bacon config"] = 7,
    ["Barba-CV"] = 87,
    ["Bashly (bashly.yml)"] = 1131,
    ["Bashly Settings (bashly-settings.yml)"] = 1132,
    Bento = 1297,
    ["Better Code Hub"] = 1042,
    ["Better Scripts"] = 168,
    Bigconfig = 137,
    ["Biome Formatter Config"] = 88,
    ["Bitmovin Encoding Template"] = 1224,
    BizTalkServerApplicationSchema = 1008,
    Bleep = 169,
    ["Block Protocol Metadata"] = 166,
    ["Bluebricks blueprint config"] = 1303,
    ["Boyka Framework"] = 147,
    ["Bpod Finite-State Machine"] = 90,
    Briefcase = 1014,
    ["Build Info"] = 157,
    Buildkite = 159,
    ["Bukkit plugin.yml"] = 158,
    ["BungeeCord plugin.yml"] = 164,
    ["Butane Config"] = 1086,
    C4InterFlow = 1239,
    ["CDK Environment Manager, concrete environment configuration"] = 1263,
    ["CDK Environment Manager, concrete environments definition"] = 1262,
    ["CDK Environment Manager, environment definition"] = 1261,
    ["CGS Card Game Specification (cgs.json)"] = 1169,
    ["CICS TS region tagging"] = 1095,
    ["CICS TS resource import"] = 1096,
    ["CICS TS resource model"] = 1097,
    ["CICS TS resource overrides"] = 1098,
    ["CMake Presets"] = 170,
    ["CNC Codes"] = 192,
    ["CRS WAF test file"] = 1199,
    ["CRS WAF test platform overrides file"] = 1200,
    ["CSS Comb (.csscomb.json)"] = 307,
    ["CSS Lint (.csslintrc)"] = 308,
    ["CSpell (cspell.json)"] = 306,
    ["CVE Record Format"] = 204,
    CWL = 1175,
    ["Cache Warmup config"] = 171,
    ["Caido Proxy Configuration"] = 1335,
    ["Calqulus pipeline"] = 172,
    ["Camel YAML DSL"] = 173,
    ["Cannon TOML"] = 174,
    Carafe = 175,
    ["Cargo Make"] = 177,
    ["Cargo Manifest"] = 176,
    ["Catalog Info Backstage"] = 178,
    ["Chamaleon environment"] = 1228,
    ["Chamaleon properties"] = 1229,
    ["Chamaleon template"] = 1227,
    Changepacks = 1290,
    Changesets = 290,
    Changie = 179,
    Charmcraft = 180,
    Cheatsheets = 1083,
    ["ChordPro Configuration"] = 181,
    ["Chrome Extension"] = 271,
    ["Chromia Model"] = 182,
    ["Chromia Seeder Module Config"] = 184,
    ["Chromia Seeder Root Config"] = 183,
    ["Cinnamon Spice info.json"] = 98,
    ["CircleCI config.yml"] = 243,
    ["Citation File Format"] = 292,
    ["Citrus test case"] = 186,
    CityJSON = 187,
    ["Claude Code Keybindings"] = 199,
    ["Claude Code Plugin Manifest"] = 200,
    ["Claude Code Plugin Marketplace"] = 201,
    ["Claude Code Settings"] = 202,
    ["Clawject config"] = 198,
    ["Cloud Foundry Application Manifest"] = 1181,
    ["Cloud Run Spec v1"] = 1205,
    ["Cloud.gov Workshop Configuration"] = 99,
    ["CloudCannon Configuration"] = 104,
    ["CloudCannon Configuration (Collection Structures)"] = 113,
    ["CloudCannon Configuration (Collections)"] = 112,
    ["CloudCannon Configuration (Editables)"] = 111,
    ["CloudCannon Configuration (Inputs)"] = 106,
    ["CloudCannon Configuration (Snippets Definitions)"] = 110,
    ["CloudCannon Configuration (Snippets Imports)"] = 109,
    ["CloudCannon Configuration (Snippets)"] = 108,
    ["CloudCannon Configuration (Structure Value)"] = 107,
    ["CloudCannon Configuration (Structures)"] = 105,
    ["CloudEvents specification"] = 188,
    ["Code Climate"] = 244,
    CodeCV = 102,
    CodeRabbit = 101,
    ["CodeShip Pro services configuration files"] = 260,
    ["CodeShip Pro steps configuration files"] = 261,
    ["Codecov configuration files"] = 259,
    Codex = 252,
    ["Codex Hooks"] = 253,
    ["Codex Skill Metadata"] = 254,
    CodifyCLI = 103,
    Codux = 256,
    ["Cog config file"] = 193,
    ["Commandbox Box.json"] = 194,
    ["Commandbox Server.json"] = 195,
    ["Common Catalog Data"] = 269,
    ["Common Package Specification"] = 196,
    Concord = 1198,
    ["Configu .cfgu files"] = 1186,
    ["Configu .configu file"] = 1187,
    Conjure = 191,
    ["Container Structure Test"] = 1022,
    Containerlab = 1051,
    ["Contextive Glossary"] = 1255,
    ContractGuard = 1052,
    Convex = 190,
    ["Crowdsec collection config"] = 301,
    ["Crowdsec parser config"] = 302,
    ["Crowdsec scenario config"] = 303,
    ["CumulusCI Config"] = 197,
    ["Cursor Agent Environment"] = 1308,
    ["Custom Machinery Machine"] = 1170,
    ["Custom Machinery Recipe"] = 1171,
    ["Cycle Stack File"] = 205,
    CycloneDX = 206,
    ["DWP Exchange - catalogue entry"] = 352,
    ["DWP Exchange - gateway"] = 350,
    ["DWP Exchange - meta"] = 351,
    ["Dart Build Config (dart-build.json)"] = 309,
    ["Dart Test Config (dart-test.json)"] = 310,
    ["DashLord Configuration"] = 311,
    ["Data Contract Specification"] = 312,
    ["Data Product Specification"] = 313,
    ["DataYoga Connections"] = 207,
    ["DataYoga Job"] = 208,
    ["Datadog Continuous Testing"] = 544,
    ["Datadog Service Definition"] = 545,
    ["Datadog Software Catalog"] = 546,
    ["Datahub Ingestion Recipe"] = 1102,
    ["Debian Upstream Metadata file"] = 215,
    DebtLens = 216,
    ["Deck config"] = 217,
    ["Declarative Automation Bundles"] = 1148,
    ["DeepMatch deeplinks spec"] = 218,
    ["Dein Config"] = 219,
    ["Deno Config (deno.json)"] = 319,
    ["Dependency cruiser"] = 220,
    ["DeployStack Configuration"] = 221,
    ["Deployah Configuration"] = 1278,
    ["Deployer Recipe"] = 322,
    ["Deta Spacefile"] = 222,
    ["Detekt Config (detekt.yml)"] = 323,
    ["Devbox Config"] = 223,
    ["Devbox Plugin"] = 224,
    Devfile = 349,
    Devup = 1291,
    DipDup = 1201,
    ["Discord Webhook"] = 324,
    ["DocFx Config (docfx.json)"] = 329,
    ["Docker Desktop extension metadata"] = 326,
    ["Docs MCP Manifest"] = 330,
    Dofigen = 331,
    ["Dolittle Artifacts"] = 332,
    ["Dolittle Bounded Context Configuration"] = 333,
    ["Dolittle Event Horizons Configuration"] = 334,
    ["Dolittle Resources Configuration"] = 335,
    ["Dolittle Server Configuration"] = 336,
    ["Dolittle Tenant Map Configuration"] = 338,
    ["Dolittle Tenants Configuration"] = 337,
    ["Dolittle Topology"] = 339,
    ["DonateCaseBetterCasino menu"] = 1232,
    ["Drupal Breakpoints"] = 225,
    ["Drupal Config"] = 237,
    ["Drupal Info"] = 226,
    ["Drupal Layouts"] = 227,
    ["Drupal Libraries"] = 228,
    ["Drupal Links Action"] = 229,
    ["Drupal Links Contextual"] = 230,
    ["Drupal Links Menu"] = 231,
    ["Drupal Links Task"] = 232,
    ["Drupal Migration"] = 233,
    ["Drupal Permissions"] = 234,
    ["Drupal Recipe"] = 235,
    ["Drupal Routing"] = 236,
    ["Drupal Services"] = 238,
    ["Drush site aliases"] = 345,
    ["Dynamic Bash Aliases (.aliases)"] = 1139,
    ["EAS config"] = 390,
    ["ECA - Editor Code Assistant"] = 354,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1128,
    ["ESLint Suppressions"] = 395,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1275,
    ["EasyVCR .NET"] = 392,
    ["Eidolon Resource"] = 1216,
    ["Elgato Stream Deck"] = 356,
    Elm = 1203,
    ["Embrace Config"] = 1114,
    Emmet = 1204,
    Endurica = 1152,
    ["Enonic XP API descriptor"] = 359,
    ["Enonic XP Admin Extension descriptor"] = 360,
    ["Enonic XP Admin Tool descriptor"] = 361,
    ["Enonic XP Application descriptor"] = 362,
    ["Enonic XP CMS descriptor"] = 363,
    ["Enonic XP Content Type descriptor"] = 364,
    ["Enonic XP Form Fragment descriptor"] = 365,
    ["Enonic XP ID Provider descriptor"] = 366,
    ["Enonic XP Layout descriptor"] = 367,
    ["Enonic XP Macro descriptor"] = 368,
    ["Enonic XP Mixin descriptor"] = 369,
    ["Enonic XP Page descriptor"] = 370,
    ["Enonic XP Part descriptor"] = 371,
    ["Enonic XP Service descriptor"] = 372,
    ["Enonic XP Site descriptor"] = 373,
    ["Enonic XP Style descriptor"] = 374,
    ["Enonic XP Task descriptor"] = 375,
    ["Enonic XP Webapp descriptor"] = 376,
    ["Enterprise Contract Policy Spec"] = 357,
    ["Envelope Team Definition"] = 1320,
    ["Envilder Map File"] = 358,
    ["Erda Pipeline"] = 1177,
    ["Erda Runtime"] = 1178,
    ["Espanso config.yml"] = 1301,
    ["Espanso match.yml"] = 1300,
    Esquio = 378,
    ["Estuary Flow Catalog"] = 1092,
    ["Ethereum ERC1155"] = 1314,
    ["Ethereum ERC721"] = 1313,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 383,
    ["EveryVoice TTS Toolkit Data Configuration"] = 384,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 388,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 387,
    ["EveryVoice TTS Toolkit Text Configuration"] = 385,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 386,
    ["Evolving Resolutive Process notation"] = 1277,
    ["Expo SDK"] = 389,
    ["Expoot app config"] = 391,
    ["F-Droid Data metadata"] = 397,
    ["FasterCI Configuration"] = 119,
    ["Fence configuration"] = 120,
    FiQuS = 401,
    Firebase = 399,
    ["Flatpak Builder Manifest"] = 402,
    ["FlexGet Config"] = 403,
    ["Flow.json Configurations"] = 1174,
    ["Fossa configuration file"] = 410,
    ["Fossa's fossa-deps file"] = 411,
    ["Foundry VTT - Base package Manifest"] = 405,
    ["Foundry VTT - Module Manifest"] = 406,
    ["Foundry VTT - System Data Template"] = 409,
    ["Foundry VTT - System Manifest"] = 407,
    ["Foundry VTT - World Manifest"] = 408,
    ["Foxx Manifest"] = 121,
    ["Freifunk.de Community API"] = 124,
    ["Frogbot Config"] = 125,
    ["G2P Mapping Configuration"] = 417,
    ["GCP Blueprint Metadata"] = 420,
    Gaspar = 418,
    ["GatewayCore API Gateway"] = 419,
    ["Gemini CLI settings"] = 421,
    ["GeoJSON.json latest"] = 1090,
    GherKing = 1094,
    ["GitHub Action"] = 427,
    ["GitHub Actions typing"] = 1212,
    ["GitHub Discussion"] = 428,
    ["GitHub Funding"] = 429,
    ["GitHub Issue Template configuration"] = 430,
    ["GitHub Issue Template forms"] = 431,
    ["GitHub Pages Jekyll"] = 432,
    ["GitHub Workflow"] = 433,
    ["GitHub Workflow Template Properties"] = 434,
    ["GitHub automatically generated release notes configuration"] = 435,
    ["GitLab Agent for Kubernetes configuration"] = 1166,
    GitVersion = 424,
    ["Gitea Issue Template configuration"] = 425,
    ["Gitea Issue Template forms"] = 426,
    ["Gitpod Automations"] = 437,
    ["Gitpod Configuration"] = 438,
    ["Glamour style"] = 422,
    ["GlazeWM settings"] = 1168,
    ["Global Privacy Control"] = 423,
    Goblet = 1147,
    ["Golangci-lint Configuration"] = 453,
    ["Golangci-lint Custom Plugins Configuration"] = 454,
    ["Google Chrome Related Website Sets"] = 400,
    ["Google Cloud Workflows"] = 277,
    ["Google Digital Assetlinks"] = 1256,
    Goreleaser = 456,
    ["Goreleaser Pro"] = 457,
    Goss = 459,
    ["Gradle Build Cache Node"] = 1040,
    ["Gradle Enterprise"] = 1039,
    ["Grafana 5.x Dashboard"] = 460,
    ["GraphQL Code Generator"] = 465,
    ["GraphQL Config"] = 464,
    ["GraphQL Mesh"] = 463,
    ["GroovyLint configuration"] = 466,
    ["Grunt JSHint task"] = 470,
    ["Grunt Watch task"] = 471,
    ["Grunt base task"] = 472,
    ["Grunt clean task"] = 468,
    ["Grunt copy task"] = 467,
    ["Grunt cssmin task"] = 469,
    HEMTT = 1004,
    Hadolint = 1018,
    Hammerkit = 1050,
    ["Hardware Sentry Configuration"] = 1106,
    ["Hashgraph Online Skill Manifest"] = 3,
    ["HashiCorp Vault"] = 473,
    Hatch = 1019,
    Hayson = 475,
    ["Haystack Pipeline"] = 476,
    ["Hazelcast 5 Configuration"] = 477,
    ["Hecate Input Schema"] = 1267,
    ["Helm Chart.lock"] = 240,
    ["Helm Chart.yaml"] = 239,
    ["Helm Unittest Test Suite"] = 241,
    ["Hex file"] = 242,
    ["Home Assistant Integration Manifest"] = 478,
    ["Homer dashboard configuration"] = 479,
    Hugo = 1082,
    ["Hugo Theme"] = 1081,
    ["Hulak Configuration"] = 486,
    ["Hyperfoil benchmark configuration"] = 485,
    ["IBM Zapp document"] = 487,
    ["IBM zCodeFormatSettings"] = 488,
    ["IMG Catapult PSP"] = 493,
    ["IVMS101 by CODE Protocol"] = 1167,
    ["Infinispan Configuration"] = 495,
    ["Infinispan Server Configuration"] = 496,
    Infrahub = 497,
    Istanbul = 1110,
    ["JDownloader2 crawler multi-rules"] = 511,
    ["JDownloader2 crawler single-rules"] = 510,
    ["JFrog Applications Config"] = 512,
    ["JFrog File Spec"] = 513,
    ["JFrog Pipelines YML DSL"] = 1116,
    ["JMeter DSL cli config"] = 514,
    JReleaser = 517,
    ["JSON Document Transform"] = 525,
    ["JSON Feed"] = 526,
    ["JSON Resume"] = 786,
    ["JSON Schema Draft 2020-12"] = 986,
    ["JSON Schema Draft 4"] = 983,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1149,
    ["JSON Schema Draft 7"] = 984,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1150,
    ["JSON Schema Draft 8 (2019-09)"] = 985,
    ["JSON-API"] = 524,
    ["JSON-e templates"] = 1047,
    ["JSON-stat 2.0"] = 979,
    JSONPatch = 528,
    ["JSR Package Config (jsr.json)"] = 518,
    Jarl = 1283,
    Jasmine = 505,
    Jekyll = 506,
    ["Jenkins X Pipelines"] = 507,
    ["Jenkins X Requirements"] = 508,
    Jest = 509,
    Jocker = 515,
    ["Jovo Language Models"] = 516,
    ["Jujutsu (jj) VCS config"] = 1269,
    ["KIMMDY config file"] = 539,
    ["KODE/CI build.yaml"] = 1112,
    ["KSP-AVC"] = 980,
    ["KSP-CKAN"] = 981,
    ["KSP-NetKAN"] = 982,
    KSY = 1179,
    KSail = 415,
    ["KYA Manifest"] = 1180,
    ["Karakum configuration file"] = 412,
    Kas = 531,
    ["Kestra flow file"] = 540,
    ["Keycloak REST API"] = 1119,
    ["Knative Functions - func.yaml"] = 413,
    Knip = 414,
    ["Knowledge Unit"] = 548,
    ["Kometa (nightly) config file"] = 542,
    ["Kometa config file"] = 541,
    ["Kong DBLess config"] = 1113,
    KrakenD = 543,
    ["Kubri Configuration"] = 551,
    LOOBin = 566,
    ["Lake configuration file"] = 1272,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 282,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 283,
    ["Landing Zone Accelerator on AWS - Global Config"] = 284,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 285,
    ["Landing Zone Accelerator on AWS - Network Config"] = 286,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 287,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 288,
    ["Landing Zone Accelerator on AWS - Security Config"] = 289,
    ["Lando (landofile)"] = 114,
    ["LangGraph Platform configuration"] = 1191,
    ["Language configuration"] = 1190,
    Lefthook = 555,
    ["Liferay client-extension.yaml"] = 562,
    ["LinkML Metamodel"] = 564,
    Liquibase = 1057,
    ["Liquibase Flow File"] = 1058,
    ["Lively Properties"] = 565,
    ["Lobe AI Agent"] = 116,
    Loki = 117,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 608,
    ["MS2Rescore Configuration"] = 614,
    ["Madness (madness.yml)"] = 1130,
    ["Mado configuration"] = 572,
    ["Maestro Flow"] = 573,
    ["Mail Servers Configuration"] = 1304,
    ["MapEHR Mapping"] = 574,
    Markdownlint = 1061,
    ["Mason Registry"] = 1064,
    ["MegaLinter Custom Flavor"] = 577,
    ["MegaLinter configuration"] = 576,
    ["MegaLinter descriptor"] = 578,
    Melange = 1157,
    ["Meltano project definition"] = 579,
    ["Mergify Configuration"] = 615,
    ["Metadata for a Bazel module"] = 580,
    ["Metadata for a Cinnamon spice"] = 1208,
    ["Metatype Configuration"] = 581,
    ["MetricsHub Configuration"] = 582,
    ["MetricsHub Connector Configuration"] = 583,
    ["Micro Editor Syntax"] = 1140,
    ["Microsoft Band Web Tile"] = 584,
    ["Microsoft RulesEngine workflow rules"] = 1195,
    ["Microsoft RulesEngine workflow rules list"] = 1196,
    ["Minecraft Custom Main Menu Mod"] = 1158,
    ["Minecraft Data Pack Advancement"] = 586,
    ["Minecraft Data Pack Biome"] = 587,
    ["Minecraft Data Pack Configured Carver"] = 588,
    ["Minecraft Data Pack Damage Type"] = 589,
    ["Minecraft Data Pack Dimension"] = 591,
    ["Minecraft Data Pack Dimension Type"] = 590,
    ["Minecraft Data Pack Item Modifier"] = 592,
    ["Minecraft Data Pack Loot Table"] = 593,
    ["Minecraft Data Pack Metadata"] = 594,
    ["Minecraft Data Pack Predicate"] = 595,
    ["Minecraft Data Pack Recipe"] = 596,
    ["Minecraft Data Pack Tag"] = 597,
    ["Minecraft Data Pack Template Pool"] = 598,
    ["Minecraft Data Pack Trim Material"] = 603,
    ["Minecraft Data Pack Trim Pattern"] = 604,
    ["Minecraft Resource Pack Lang"] = 599,
    ["Minecraft Resource Pack Particle"] = 600,
    ["Minecraft Resource Pack Texture Mcmeta"] = 602,
    ["Minecraft Resourcepack Sounds"] = 601,
    ["MockServer Expectations"] = 610,
    ModuleAssembler = 606,
    ["Monade CLI Stack Configuration"] = 618,
    ["MongoDB Atlas Search Index Definition"] = 1111,
    ["Monika Configuration"] = 1109,
    ["Monoweave Configuration"] = 613,
    ["Motif config"] = 1000,
    MultiQC = 1249,
    ["NOX Framework (Service)"] = 636,
    ["Netin Diagnostic System Template"] = 1068,
    ["Netlify config"] = 621,
    ["Network-as-Code Data Model"] = 622,
    ["Next Gen UI Agent A2A Server Configuration"] = 623,
    ["Next Gen UI Agent Configuration"] = 625,
    ["Next Gen UI Agent MCP Server Configuration"] = 624,
    ["Nightwatch.js"] = 629,
    ["Node.js configuration"] = 1005,
    ["NueJS configuration file"] = 641,
    ["Nuitka Package Config"] = 1172,
    ["Nullstone config"] = 643,
    ["ONe's changelog entry"] = 662,
    ["ONe's service descriptor"] = 661,
    ["ORT Server repository environment configuration"] = 672,
    ["OSCAL Assessment Plan (AP)"] = 674,
    ["OSCAL Assessment Results (AR)"] = 675,
    ["OSCAL Catalog"] = 676,
    ["OSCAL Component Definition (CDef)"] = 677,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 678,
    ["OSCAL Profile"] = 679,
    ["OSCAL System Security Plan (SSP)"] = 680,
    ["OSS Review Toolkit configuration"] = 681,
    ["OSS Review Toolkit curation"] = 682,
    ["OSS Review Toolkit package configuration"] = 683,
    ["OSS Review Toolkit project package manager definition"] = 684,
    ["OSS Review Toolkit repository configuration"] = 685,
    ["OSS Review Toolkit resolutions"] = 686,
    ["October CMS columns"] = 647,
    ["October CMS fields"] = 648,
    ["Oh My Posh"] = 650,
    Okteto = 651,
    ["Ona Automations"] = 653,
    Opctl = 1003,
    ["Open Data Contract Standard (ODCS)"] = 666,
    ["Open Data Product Standard (ODPS)"] = 667,
    ["Open Know-How"] = 1254,
    OpenDecree = 1318,
    ["OpenDecree Configuration"] = 1319,
    ["OpenRewrite Resource"] = 664,
    OpenSRM = 668,
    OpenStatus = 1265,
    ["OpenTelemetry Declarative Configuration"] = 665,
    ["OpenUtau character yaml"] = 658,
    ["OpenUtau ustx"] = 659,
    ["OpenWeather Current Weather API"] = 1046,
    ["OpenWeather Road Risk API"] = 1045,
    ["Ory Hydra configuration"] = 484,
    ["Ory Keto configuration"] = 547,
    ["Ory Kratos configuration"] = 673,
    ["Ory Oathkeeper configuration"] = 645,
    ["Outblocks App configuration"] = 670,
    ["Outblocks database table"] = 671,
    ["Outblocks project configuration"] = 669,
    PDM = 694,
    POPxf = 706,
    ["POPxf Correlations"] = 707,
    ["PRML manifest"] = 714,
    Packer = 690,
    PactSpec = 691,
    Panache = 692,
    Pantsbuild = 1126,
    ["Paper paper-plugin.yml"] = 693,
    ["Pipeline component"] = 1059,
    ["Platform.sh application"] = 9,
    ["Platform.sh routes"] = 10,
    ["Platform.sh services"] = 11,
    ["Plex Prerolls"] = 704,
    ["PocketMine plugin.yml"] = 701,
    ["Podman Desktop Extension"] = 1337,
    ["Postman collection"] = 710,
    ["Power Pages Configuration"] = 1266,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1211,
    ["ProActions AI-Kit Configuration"] = 722,
    ["ProActions AI-Kit Configuration for Menus"] = 724,
    ["ProActions AI-Kit Configuration for Sections"] = 726,
    ["ProActions AI-Kit Configuration for Services"] = 723,
    ["ProActions AI-Kit Configuration for Steps"] = 727,
    ["ProActions AI-Kit Configuration for Templates"] = 725,
    ["Problem object RFC9457"] = 1155,
    ["Problem package format"] = 728,
    ["Problem package generators"] = 729,
    ["Problem package submissions"] = 730,
    ["Problem package test group metadata"] = 731,
    Pterodactyl = 1105,
    ["Pull Request Labeler"] = 748,
    Pulumi = 756,
    ["PyGTA Config"] = 752,
    PyProject = 757,
    Pylock = 1257,
    Pyright = 758,
    ["Python script metadata"] = 1251,
    ["QType AI DSL"] = 761,
    Qgoda = 760,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1329,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1327,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1333,
    ["Qlik Talend Cloud Pipeline - Project"] = 1325,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1328,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1330,
    ["Qlik Talend Cloud Pipeline - Task"] = 1326,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1332,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1331,
    Qodana = 1078,
    ["Qt Creator workspace file"] = 1188,
    ["Quali Torque Blueprint Spec 2"] = 1103,
    ["QueryFirst config file"] = 1122,
    ["QuikRun Configuration"] = 1334,
    ["Qwen Code Settings"] = 1315,
    ["RKE Cluster Configuration JSON"] = 1056,
    ["RKE Cluster Configuration YAML"] = 1055,
    RadioHound = 751,
    ["Raid Profile"] = 1316,
    ["Raid Repo Configuration"] = 1317,
    Railpack = 763,
    Railway = 762,
    ["Rancher Fleet"] = 753,
    ["Rattler-build"] = 764,
    Ray = 1017,
    ["Read the Docs"] = 755,
    ["Red-DiscordBot Cog"] = 771,
    ["Red-DiscordBot Cog Repo"] = 772,
    ["Red-DiscordBot Trivia"] = 773,
    ["Releasaurus Config"] = 6,
    ReleaseKit = 5,
    ["Render Blueprints"] = 1054,
    RenderCV = 790,
    Renovate = 787,
    ["Renovate global configuration"] = 788,
    ["Renovate inherited configuration"] = 789,
    ["Replit config"] = 779,
    Restate = 1244,
    ["Revel Digital Gadget Definition File"] = 1268,
    RoadRunner = 792,
    ["Robust Station Image"] = 1274,
    Rockcraft = 793,
    ["Roo Coder Custom Modes"] = 794,
    Rubocop = 783,
    ["Rudder techniques"] = 1162,
    Ruff = 784,
    ["Rust Project"] = 785,
    ["Rust toolchain"] = 799,
    ["SDMX data message"] = 826,
    ["SDMX metadata message"] = 825,
    ["SDMX structure message"] = 824,
    ["SIL Kit Participant Configuration"] = 836,
    ["SIL Kit Registry Configuration"] = 837,
    ["SPDX 2.3"] = 875,
    SWADL = 891,
    ["Safebox Config"] = 1117,
    ["Sapphire CLI Config"] = 802,
    ["SauceCTL Configuration"] = 1065,
    Scarb = 822,
    ["Schema Catalog"] = 817,
    ["Scoop manifest"] = 823,
    ["Semantic Data Fabric (SDF) file"] = 827,
    ["Semgrep Rule"] = 829,
    ["Serenity Code Generator (Sergen)"] = 830,
    ["Serverless Framework Configuration"] = 1072,
    ["Serverless Workflow"] = 1074,
    ["Settings for a Cinnamon spice"] = 1207,
    ["Settings.paf"] = 832,
    ["Shopware 6 Configuration"] = 1075,
    ["Shopware CLI Extension Store Configuration"] = 1076,
    ["Shopware CLI Project Store Configuration"] = 1077,
    ["Sigma Detection Rule"] = 834,
    ["SigmaCV CV"] = 1,
    ["Sigrid scope configuration file"] = 835,
    ["SkyPilot Task JSON"] = 1163,
    ["Slack app manifest"] = 839,
    Snapcraft = 841,
    ["Solarxy project config"] = 844,
    Solidarity = 845,
    ["Solution filters"] = 846,
    ["Source Maps v3"] = 847,
    Sourcery = 848,
    ["Spack bootstrap.yaml"] = 849,
    ["Spack cdash.yaml"] = 850,
    ["Spack ci.yaml"] = 851,
    ["Spack compilers.yaml"] = 852,
    ["Spack concretizer.yaml"] = 853,
    ["Spack config.yaml"] = 854,
    ["Spack definitions.yaml"] = 855,
    ["Spack develop.yaml"] = 856,
    ["Spack env_vars.yaml"] = 857,
    ["Spack environment"] = 863,
    ["Spack include.yaml"] = 858,
    ["Spack mirrors.yaml"] = 859,
    ["Spack modules.yaml"] = 860,
    ["Spack packages.yaml"] = 861,
    ["Spack repos.yaml"] = 862,
    ["Spack toolchains.yaml"] = 864,
    ["Spack upstreams.yaml"] = 865,
    ["Spack view.yaml"] = 866,
    ["Speakeasy Generation Config File"] = 870,
    ["Speakeasy Lint Configuration File"] = 867,
    ["Speakeasy Test Generation Configuration File"] = 868,
    ["Speakeasy Workflow File"] = 869,
    SpecIF = 871,
    ["Specmatic Configuration"] = 872,
    ["Sponge Mixin configuration"] = 873,
    StackBlitz = 879,
    ["StackHawk Scanner Configuration"] = 1071,
    Stale = 880,
    Starfish = 881,
    ["Starlake Data Pipeline"] = 1043,
    Starship = 882,
    ["Statamic Blueprint"] = 883,
    ["Stella configuration file"] = 884,
    ["Streamlit configuration file"] = 885,
    ["Stryker Mutator"] = 888,
    ["StyleCop Analyzers Configuration"] = 889,
    ["Stylelint (.stylelintrc)"] = 890,
    ["Stylua Config"] = 1258,
    ["Sublime Syntax"] = 1118,
    ["Subsquid squid manifest"] = 1165,
    ["Swagger API 2.0"] = 892,
    ["Synadia Connect Component"] = 893,
    TSON = 929,
    TSTyche = 930,
    ["TYPO3 Vendor Bundler config"] = 936,
    ["Tab data for a LinUtil"] = 1214,
    ["Tab list for a LinUtil"] = 1213,
    Tach = 894,
    ["Tach Domain"] = 895,
    Talhelper = 897,
    ["Talisman configuration"] = 898,
    Taplo = 1259,
    ["Taskfile config"] = 1048,
    Taurus = 899,
    Tauticord = 900,
    ["Tekton Pipeline"] = 1287,
    ["Tekton PipelineRun"] = 1288,
    ["Tekton Task"] = 1285,
    ["Tekton TaskRun"] = 1286,
    Telefonistka = 1245,
    ["Terrateam config"] = 1271,
    ["TestEnvironment.json"] = 912,
    ["TextMate Grammar"] = 911,
    Threagile = 906,
    ["Tier.run pricing.json"] = 903,
    Tikibase = 904,
    Tombi = 909,
    ["Traefik v2"] = 915,
    ["Traefik v2 File Provider"] = 916,
    ["Traefik v3"] = 917,
    ["Traefik v3 File Provider"] = 918,
    ["Travis CI (.travis.yml)"] = 914,
    Treefmt = 462,
    Trident = 1241,
    ["TrueScript for *.tscript files"] = 921,
    ["Tugboat QA config.yml"] = 1238,
    TunnelHub = 1153,
    Turborepo = 913,
    Tycho = 1202,
    Tye = 1079,
    ["Tyk Gateway - Open Source v5.7+"] = 1250,
    ["UET BuildConfig.json"] = 1123,
    ["UI5 Manifest"] = 942,
    ["UNCORS configuration"] = 947,
    ["UTAM Page Object"] = 945,
    ["Ubuntu Server Autoinstall"] = 940,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1242,
    ["Uniswap Token List"] = 1028,
    ["Universal Schedule Format"] = 948,
    ["Unreal Engine Uplugin"] = 1124,
    ["Unreal Engine Uproject"] = 1125,
    ["UpCloud CLI (upctl) configuration"] = 1243,
    ["Updatecli Compose"] = 1087,
    ["Updatecli Policy Manifest"] = 1088,
    ["Updatecli Policy Metadata"] = 1089,
    Uplift = 1121,
    ["Upsun config"] = 8,
    ["User Journey Map"] = 1053,
    V2Ray = 1093,
    ["VSCode Code Snippets"] = 265,
    ["VSIX CLI publishing"] = 966,
    Vector = 950,
    ["Vela Pipeline Configuration"] = 953,
    Vercel = 264,
    ["Version Bumper config"] = 956,
    Vespertide = 1292,
    ["Vespertide Migration"] = 1293,
    ["Vespertide Model"] = 1294,
    ["Viash Component Config"] = 1247,
    ["Viash Package Config"] = 1248,
    Visivo = 1151,
    ["WP-CLI"] = 976,
    Wake = 1240,
    ["Waku Config"] = 1217,
    ["Web App Manifest"] = 972,
    ["Web types"] = 975,
    WebExtensions = 971,
    ["Webman package recipe"] = 1099,
    ["Windows Package Manager Installer Manifest"] = 1025,
    ["Windows Package Manager Locale Manifest"] = 1026,
    ["Windows Package Manager Singleton Manifest"] = 1024,
    ["WireMock CLI import configuration"] = 1223,
    ["WireMock CLI local service configuration"] = 1222,
    ["WireMock message stub mapping"] = 1221,
    ["WireMock stub mapping"] = 1220,
    ["Woodpecker pipeline config"] = 1067,
    ["Wrangler CLI"] = 977,
    ["XenForo add-on manifest"] = 978,
    ["Xstate Machine"] = 1085,
    ["Yandex Workflow Language"] = 1209,
    ["Yarn Config (.yarnrc.yml)"] = 1041,
    ["Yippee-Ki-JSON configuration YML"] = 1032,
    ["YouTrack App"] = 1206,
    ["Zarf Package Configuration"] = 1273,
    ["Zerops import file"] = 1194,
    ["Zola Configuration"] = 1284,
    actionlint = 37,
    ["aerleon.yml"] = 22,
    ["amplify.yml"] = 15,
    ["amxx-builder manifest"] = 1336,
    ["angular.json"] = 40,
    apko = 1156,
    ["app-definition.yaml"] = 44,
    ["apple-app-site-association"] = 42,
    ["appsettings.StormPetrel.json"] = 49,
    ["appsettings.json"] = 47,
    ["appsscript.json"] = 46,
    ["appveyor.yml"] = 48,
    ["aqua-generate-registry.yaml"] = 51,
    ["aqua-policy.yaml"] = 52,
    ["aqua.yaml"] = 50,
    ["arazzo.json"] = 54,
    ["arb.json"] = 55,
    ["arc.json"] = 57,
    ["architect.yml"] = 56,
    ["artifacthub-repo.yml"] = 61,
    ["asm-lsp"] = 62,
    ["ast-grep rules"] = 65,
    ["ast-grep sgconfig.yml"] = 64,
    ["azure.yaml"] = 73,
    ["babelrc.json"] = 127,
    ["bamboo-spec"] = 131,
    basedpyright = 129,
    ["bashly-strings.yml"] = 1133,
    ["batect.yml"] = 130,
    ["beef-database-codegen"] = 132,
    ["beef-database-v5-codegen"] = 134,
    ["beef-entity-codegen"] = 133,
    ["beef-entity-v5-codegen"] = 135,
    ["behat.yml"] = 148,
    ["bigquery-table"] = 136,
    ["bioimageio resource description"] = 1173,
    ["bitbucket-pipelines"] = 138,
    bitrise = 139,
    ["bitrise-step"] = 140,
    ["block.json"] = 165,
    ["bottom configuration"] = 89,
    ["bower.json"] = 142,
    ["bozr.suite.json"] = 152,
    bpkg = 1134,
    ["browser.i18n.json"] = 153,
    ["browsh configuration"] = 154,
    bucklescript = 155,
    ["buf.gen.yaml"] = 92,
    ["buf.lock"] = 93,
    ["buf.plugin.yaml"] = 94,
    ...
    ["build-changelog"] = 156,
    ["bun.lock"] = 161,
    ["bundleconfig.json"] = 162,
    ["bunfig.toml"] = 163,
    ["cargo-mutants-config.yaml"] = 97,
    ["cargo-nextest repository configuration"] = 626,
    ["cargo-nextest user configuration"] = 627,
    ["ccmod.json"] = 1218,
    changelogging = 1185,
    ["chisel-slices.json"] = 291,
    ["chrome-extension-locales-messages.json"] = 272,
    ["chutzpah.json"] = 273,
    cibuildwheel = 185,
    ["clang-format (.clang-format)"] = 1091,
    ["clang-tidy"] = 248,
    clangd = 247,
    clib = 249,
    ["cloud-init: cloud-config userdata"] = 251,
    ["cloud-sdk-pipeline-configuration"] = 275,
    ["cloudbuild.json"] = 276,
    cloudify = 250,
    cmakefmt = 203,
    ["cmdx.yaml"] = 100,
    ...
    ["commands.json"] = 268,
    ["commit-check"] = 294,
    ["commitlint (.commitlintrc)"] = 1027,
    ["committed.toml"] = 295,
    ["compile_commands.json"] = 267,
    ["compilerconfig.json"] = 266,
    ["completely.yml"] = 1129,
    ["component-detection-manifest.json"] = 298,
    ["component.json"] = 297,
    ["composer.json"] = 296,
    ["conda-forge"] = 189,
    ["config.yaml"] = 754,
    ["contentmanifest.json"] = 274,
    ["contribute.json"] = 299,
    ["cosmos.config.json"] = 270,
    ["crowdin.yml"] = 300,
    ["ctfd-setup configuration file"] = 1230,
    ["custom-elements.json"] = 1143,
    ["cypress.json"] = 304,
    ["dacier.yml"] = 1324,
    ["datalogic-scan2deploy-android"] = 314,
    ["datalogic-scan2deploy-ce"] = 315,
    ["dbt Dependencies"] = 210,
    ["dbt Packages"] = 212,
    ["dbt Project"] = 211,
    ["dbt Selectors"] = 213,
    ["dbt YAML files"] = 214,
    ...
    ["ddev-global"] = 316,
    ["ddev-project"] = 317,
    ["debugsettings.json"] = 318,
    ["dependabot-v2.json"] = 321,
    ["dependabot.json"] = 320,
    ["deployed-cli"] = 1084,
    ["devcontainer-feature.json"] = 258,
    ["devcontainer.json"] = 257,
    devinit = 1034,
    ["devspace.yaml"] = 1107,
    djlint = 1035,
    ["docker bake"] = 327,
    ["docker sequencer"] = 328,
    ["docker-compose.yml"] = 1033,
    ["dockerd.json"] = 325,
    ["dotnet Release Index manifest"] = 340,
    ["dotnet-tools.json"] = 341,
    ["dotnetcli.host.json"] = 342,
    ["dprint.json"] = 343,
    ["drone.json"] = 344,
    ["dss-2.0.0.json"] = 346,
    ["dstack configuration"] = 347,
    ["dtool dataset metadata"] = 1225,
    ["dvc.yaml"] = 348,
    ["ecosystem.json"] = 353,
    eksctl = 355,
    ["electron-builder configuration file"] = 381,
    ["epr-manifest.json"] = 380,
    ["estampo.toml"] = 379,
    ["evcc.yaml"] = 382,
    ["ezd task runner"] = 393,
    ["fabric.mod.json"] = 396,
    ["first-timers-bot"] = 404,
    ["flagd flag configuration"] = 122,
    ["fly.io Configuration"] = 123,
    fulibWorkflows = 1066,
    ["function.json"] = 416,
    ["gRPC API Gateway & OpenAPI Config"] = 17,
    ["gematik health care insurance list"] = 1236,
    ["gematik health care patient list"] = 1233,
    ["gematik health care provider institution list"] = 1235,
    ["gematik health care provider list"] = 1234,
    ["gematik tiger test environment configuration"] = 1237,
    ["git-town.toml"] = 1282,
    ["gitlab-ci"] = 436,
    ["global.json"] = 452,
    ["go-feature-flag Flag Configuration"] = 455,
    ["haxelib.json"] = 474,
    helmfile = 1020,
    helmwave = 1021,
    ["host-meta.json"] = 481,
    ...
    ["ide.host.json"] = 489,
    ["ifstate.yaml"] = 490,
    ["imageoptimizer.json"] = 491,
    ["importmap.json"] = 494,
    instant_python_config = 498,
    instant_python_custom_project = 499,
    intlayer = 500,
    ["ioBroker Configuration"] = 501,
    ["ioBroker JSON UI"] = 502,
    ["ioBroker Package manifest"] = 503,
    ["ixpect.conf.yaml"] = 504,
    ["ize.toml"] = 1120,
    ["jsconfig.json"] = 529,
    ["jscpd Configuration"] = 1104,
    jsdoc = 1016,
    ["k3d.yaml"] = 530,
    ["k9s aliases.yaml"] = 532,
    ["k9s cluster-config.yaml"] = 534,
    ["k9s config.yaml"] = 533,
    ["k9s hotkeys.yaml"] = 535,
    ["k9s plugins.yaml"] = 536,
    ["k9s skin.yaml"] = 537,
    ["k9s views.yaml"] = 538,
    ["kontinuous-config.yaml"] = 550,
    ["kontinuous-values.yaml"] = 549,
    ["kustomization.yaml"] = 552,
    ["label-commenter-config.yml"] = 553,
    ["latexindent configuration"] = 115,
    ["launchsettings.json"] = 554,
    lazydocker = 1142,
    lazygit = 1141,
    ["lego.json"] = 556,
    ["lerna.json"] = 557,
    ["lgtm.yml"] = 558,
    ["liblab.config.json"] = 559,
    ["libman.json"] = 560,
    ["license-report-config.json"] = 561,
    ["linkinator.config.json"] = 563,
    ["lint-staged (.lintstagedrc)"] = 994,
    ["local.settings.json"] = 568,
    ["localazy.json"] = 569,
    ["lotus.yaml"] = 567,
    ["lsdlschema.json"] = 570,
    ["macro.json"] = 1108,
    ["markdown-link-check"] = 1062,
    maturin = 1063,
    mboats = 1070,
    memnex = 1322,
    ["micro-settings.json"] = 1135,
    ["mimetypes.json"] = 585,
    ["mirrord config"] = 996,
    mise = 997,
    ["mkdocs.yml"] = 605,
    ["mockd.yaml"] = 609,
    ["modelparams.dev Model"] = 611,
    ["monospace.yml"] = 612,
    ["moon.yml"] = 1219,
    ["mprocs Configuration file"] = 1189,
    ["mrdocs.yml"] = 607,
    ["mta.yaml"] = 998,
    ["mtad.yaml"] = 999,
    ["mycode.json"] = 619,
    nFPM = 628,
    ["napari plugin manifest"] = 620,
    neoload = 1011,
    ["nest-cli"] = 631,
    ["nexus-rpc-gen"] = 1309,
    ["ninjs (News in JSON)"] = 630,
    ["nitro.json"] = 1010,
    ["nixd configuration"] = 1161,
    ["nlu.json"] = 632,
    ["nodemon.json"] = 634,
    ["noodl config"] = 1069,
    ["notebook.mod.json"] = 635,
    now = 1006,
    ["npm-badges"] = 638,
    ["nswag.json"] = 642,
    ntangle = 644,
    ["nuclei-template.yaml"] = 639,
    ["nuget-project.json"] = 640,
    ["ocelot.json"] = 646,
    ogen = 649,
    ["omnisharp.json"] = 652,
    openHAB = 1295,
    ...
    oxlint = 1306,
    ["package.json"] = 687,
    ["package.manifest"] = 689,
    ["package.yaml"] = 688,
    ["partial-black.json"] = 149,
    ["partial-fastapi.json"] = 150,
    ["partial-pixi.json"] = 699,
    ["partial-scheduled.json"] = 151,
    ["pattern.json"] = 697,
    ["petstore-v1.0"] = 1115,
    pgap_yaml_input_reader = 695,
    pgrls = 696,
    pgxgen = 1299,
    pitcms = 1302,
    ["pixi.toml"] = 698,
    ["plagiarize-me.yaml"] = 703,
    ["plagiarize.yaml"] = 702,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1226,
    ["podbard.yaml"] = 705,
    ["portman.json"] = 708,
    ["prefect.toml"] = 717,
    ["prefect.yaml"] = 718,
    ...
    ["prettierrc.json"] = 720,
    ["prisma.yml"] = 721,
    ["project-1.0.0-beta3.json"] = 733,
    ["project-1.0.0-beta4.json"] = 734,
    ["project-1.0.0-beta5.json"] = 735,
    ["project-1.0.0-beta6.json"] = 736,
    ["project-1.0.0-beta8.json"] = 737,
    ["project-1.0.0-rc1.json"] = 738,
    ["project-1.0.0-rc2.json"] = 739,
    ["project.json"] = 732,
    ["project.owasp.yaml"] = 740,
    ["prometheus-alertmanager.json"] = 744,
    ["prometheus.json"] = 741,
    ["prometheus.rules.json"] = 742,
    ["prometheus.rules.test.json"] = 743,
    ["proxies.json"] = 745,
    ["publiccode.yml"] = 746,
    ["pubspec.yaml"] = 747,
    ["pyrseas-0.8.json"] = 750,
    pytest = 759,
    ["quilt.mod.json"] = 1136,
    ["rc3 auth"] = 765,
    ["rc3 collection"] = 766,
    ...
    ["rc3 settings"] = 770,
    ["registry.yaml"] = 53,
    ["release drafter"] = 1012,
    ["release-hub.json"] = 4,
    ["release-please-config.json"] = 775,
    ["release-please-manifest.json"] = 776,
    ["release-plz.toml"] = 777,
    ["renv.lock"] = 791,
    ["reposets Configuration"] = 780,
    ["reposets Credentials"] = 781,
    ["revola.json"] = 2,
    ["rivet.json"] = 1160,
    ["rivet.yaml (legacy)"] = 1159,
    rumdl = 796,
    runny = 795,
    runspec = 1323,
    rustfmt = 797,
    ...
    samt = 800,
    samtrc = 801,
    ["sarif-1.0.0.json"] = 803,
    ["sarif-2.0.0.json"] = 804,
    ["sarif-2.1.0"] = 814,
    ["sarif-2.1.0-rtm.2"] = 805,
    ["sarif-2.1.0-rtm.3"] = 807,
    ["sarif-2.1.0-rtm.4"] = 809,
    ["sarif-2.1.0-rtm.5"] = 811,
    ["sarif-2.1.0-rtm.6"] = 812,
    ["sarif-external-property-file-2.1.0"] = 815,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 806,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 808,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 810,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 813,
    ["scalingo.json configuration"] = 816,
    ["schema.org - Action"] = 818,
    ["schema.org - ContactPoint"] = 819,
    ["schema.org - Place"] = 820,
    ["schema.org - Thing"] = 821,
    ["secrethub.yml"] = 1138,
    ["semantic-release"] = 828,
    ["servicehub.config.json"] = 989,
    ["servicehub.service.json"] = 988,
    ["settings.job"] = 831,
    ["sfdx-hardis configuration"] = 833,
    ["shard.yml"] = 1176,
    ["size-limit configuration"] = 838,
    ["skaffold.yaml"] = 1060,
    ["skyuxconfig.json"] = 840,
    ["snowflake-config"] = 842,
    ["snowflake-connections"] = 843,
    ["spicepod.yaml"] = 1197,
    ["sqlc configuration"] = 876,
    ["stripe-app-local.json"] = 887,
    ["stripe-app.json"] = 886,
    swcrc = 1044,
    ["task.json"] = 896,
    taskcat = 1007,
    ["template.json"] = 901,
    ["templatsources.json"] = 902,
    ["text2confl config"] = 1307,
    ["theme.json"] = 905,
    ["tizen_workspace.json"] = 907,
    tldr = 908,
    ["tm_devices configuration file"] = 1264,
    tmuxinator = 992,
    tox = 910,
    ["transcend.yml"] = 919,
    ["tree-sitter grammar.json"] = 461,
    ["trime.yaml"] = 920,
    ["trunk.yaml"] = 922,
    ["ts-force-config.json"] = 927,
    ["tsconfig.json"] = 923,
    ["tsd.json"] = 924,
    ["tsdoc.json"] = 925,
    ["tsdrc.json"] = 926,
    ...
    v8r = 970,
    vcluster = 1183,
    ["vcpkg configuration file"] = 263,
    ["vcpkg manifest file"] = 262,
    ["vega-lite.json"] = 952,
    ["vega.json"] = 951,
    ["venvironment.yaml"] = 954,
    ["venvplus.yaml"] = 955,
    version = 1246,
    ["version.json"] = 957,
    ["vhwdebugger-binding.yaml"] = 959,
    ["vim-addon-info"] = 960,
    ["vs-2017.3.host.json"] = 962,
    ["vs-nesting.json"] = 963,
    ["vsls.json"] = 961,
    ["vss-extension.json"] = 967,
    vtcfg = 1252,
    ["vtesttree.yaml"] = 968,
    ["vtestunit.yaml"] = 969,
    ["warp-keysets.json"] = 1144,
    ["warp-themes.json"] = 1145,
    ["warp-workflows.json"] = 1146,
    ["webhint.io"] = 1100,
    ["webjobpublishsettings.json"] = 974,
    ["webjobs-list.json"] = 973,
    ["well-known-fursona"] = 1184,
    ["xs-app.json"] = 1002,
    ["xunit.runner.json"] = 987,
    yamlfmt = 1029,
    yamllint = 1030,
    ["yap.json"] = 1031,
    ["zerops.yml"] = 1193,
