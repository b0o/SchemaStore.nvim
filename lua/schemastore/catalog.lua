...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1091,
    [".nodehawkrc"] = 702,
    [".npmpackagejsonlintrc"] = 707,
    [".omletrc"] = 1272,
    [".phrase.yml"] = 789,
    [".phraseapp.yml"] = 790,
    [".pmbot.yml"] = 774,
    [".postcssrc"] = 783,
    [".powerpages-web-template-manifest"] = 785,
    [".pre-commit-config.yml"] = 786,
    [".pre-commit-hooks.yml"] = 787,
    [".putout.json"] = 823,
    [".rehyperc"] = 848,
    [".remarkrc"] = 852,
    [".sprite files"] = 954,
    ...
    [".vsconfig"] = 1052,
    [".vsext"] = 1053,
    ["1Password SSH Agent Config"] = 17,
    ["@factorial/drupal-breakpoints-css"] = 26,
    ["A micro editor config"] = 638,
    ABCClinicalDemandForecast = 36,
    ABCInventoryModuleData = 35,
    ABCSupplyPlan = 37,
    ["ACP Attempts"] = 38,
    ["ACP Cache File"] = 39,
    ["ACP Configuration File"] = 40,
    ["ACP Primer"] = 41,
    ["ACP Sync"] = 42,
    ["ACP Variables File"] = 43,
    ["AI Harness config"] = 45,
    ["AI Harness org policy"] = 46,
    AIConfig = 47,
    ["AMX Muse Program Descriptor"] = 1321,
    ["API Builder"] = 1127,
    ["AVA Configuration"] = 1191,
    ["AWS AppConfig Feature Flags-v1"] = 86,
    ["AWS CDK cdk.json"] = 315,
    ["AWS CloudFormation"] = 316,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 317,
    ["AWS Copilot Manifest"] = 1360,
    ["AWS SAM CLI Samconfig"] = 318,
    Acton = 1414,
    ["Adobe UXP Manifest"] = 1254,
    ["Aerleon Network & Service Definitions"] = 29,
    ["Aerleon Policy"] = 30,
    ["Agent Permission Policy"] = 1400,
    ["AgentCore CLI"] = 1401,
    ["AgentCtl MCP"] = 1403,
    ["AgentCtl config"] = 1402,
    ["AgentCtl permissions"] = 1404,
    AgentLoopKit = 1405,
    Aider = 1350,
    Air = 32,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1371,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1370,
    ["Airlock Microgateway"] = 48,
    ["Alacritty Configuration"] = 1163,
    ["AlgoVoi Compliance Receipt v1"] = 18,
    ["All Contributors configuration file"] = 1217,
    ["Amazon S3 bucket CORS"] = 20,
    Anodizer = 514,
    ["Ansible Argument Specs"] = 496,
    ["Ansible Collection Galaxy"] = 503,
    ["Ansible Execution Environment"] = 493,
    ["Ansible Inventory"] = 502,
    ["Ansible Meta"] = 494,
    ["Ansible Meta Runtime"] = 495,
    ["Ansible Navigator Configuration"] = 505,
    ["Ansible Playbook"] = 500,
    ["Ansible Requirements"] = 497,
    ["Ansible Rulebook"] = 501,
    ["Ansible Tasks File"] = 499,
    ["Ansible Vars File"] = 498,
    ["Ansible-lint Configuration"] = 504,
    Any = 1282,
    ["AnyWork Automation Configuration"] = 25,
    ["Apollo Router"] = 1128,
    ["App config Spotify Backstage"] = 52,
    ["Applicant Profile Protocol"] = 22,
    ["Application Accelerator"] = 19,
    ["Application list for a WinUtil"] = 1300,
    ["ArchSmith diagram IR"] = 1439,
    ArchitectFX = 1305,
    ["Archival editor configuration"] = 67,
    ["Archival object definitions"] = 68,
    ["Archival site configuration"] = 69,
    ["Archival template definition"] = 70,
    ["Are The Types Wrong?"] = 75,
    ["Argo CD"] = 71,
    ["Argo Events"] = 72,
    ["Argo Workflows"] = 73,
    AssemblyScript = 77,
    AsyncAPI = 80,
    ["AsyncAPI Tool File"] = 81,
    ["Atmos Manifests"] = 82,
    ["Aurora Agile Meta-Framework"] = 83,
    AutoAPICase = 1227,
    ["Avro Avsc"] = 84,
    ["Awesome Repositories"] = 85,
    ["Azure Container App template for defining an immutable revision"] = 88,
    ["Azure DevOps extension manifest"] = 91,
    ["Azure Device Update for IoT Hub import manifest"] = 89,
    ["Azure Device Update for IoT Hub update manifest"] = 90,
    ["Azure IoT Edge deployment"] = 94,
    ["Azure IoT Edge deployment template"] = 95,
    ["Azure IoT EdgeAgent deployment"] = 92,
    ["Azure IoT EdgeHub deployment"] = 93,
    ["Azure IoT Operations Wasm Graph Config"] = 1369,
    ["Azure IoT Operations connector metadata"] = 1366,
    ["Azure Landing Zones Library archetype definition"] = 99,
    ["Azure Landing Zones Library archetype override"] = 100,
    ["Azure Landing Zones Library architecture definition"] = 98,
    ["Azure Landing Zones Library metadata"] = 96,
    ["Azure Landing Zones Library policy default values"] = 97,
    ["Azure Pipelines"] = 135,
    ["Azure Static Web Apps CLI configuration file"] = 958,
    ["Azure Static Web Apps configuration file"] = 957,
    BMML = 1388,
    ["BOSH BPM Config"] = 161,
    ["BOSH CPI Config"] = 162,
    ["BOSH Deploy Config"] = 163,
    ["BOSH Job Spec"] = 164,
    ["BOSH Ops File"] = 166,
    ["BOSH Package Spec"] = 165,
    ["BX CI"] = 187,
    ["Bacon config"] = 12,
    ["Barba-CV"] = 101,
    ["Bashly (bashly.yml)"] = 1221,
    ["Bashly Settings (bashly-settings.yml)"] = 1222,
    Bento = 1387,
    ["Better Code Hub"] = 1132,
    ["Better Scripts"] = 188,
    Bigconfig = 154,
    ["Biome Formatter Config"] = 102,
    ["Bitmovin Encoding Template"] = 1314,
    BizTalkServerApplicationSchema = 1098,
    Bleep = 189,
    ["Block Protocol Metadata"] = 186,
    ["Bluebricks blueprint config"] = 1393,
    ["Boyka Framework"] = 167,
    ["Bpod Finite-State Machine"] = 104,
    Briefcase = 1104,
    ["Build Info"] = 177,
    Buildkite = 179,
    ["Bukkit plugin.yml"] = 178,
    ["BungeeCord plugin.yml"] = 184,
    ["Burnless SRE config"] = 5,
    ["Butane Config"] = 1176,
    C4InterFlow = 1329,
    ["CDK Environment Manager, concrete environment configuration"] = 1353,
    ["CDK Environment Manager, concrete environments definition"] = 1352,
    ["CDK Environment Manager, environment definition"] = 1351,
    ["CGS Card Game Specification (cgs.json)"] = 1259,
    ["CICS TS region tagging"] = 1185,
    ["CICS TS resource import"] = 1186,
    ["CICS TS resource model"] = 1187,
    ["CICS TS resource overrides"] = 1188,
    ["CMake Presets"] = 190,
    ["CNC Codes"] = 213,
    ["CRS WAF test file"] = 1289,
    ["CRS WAF test platform overrides file"] = 1290,
    ["CSS Comb (.csscomb.json)"] = 345,
    ["CSS Lint (.csslintrc)"] = 346,
    ["CSpell (cspell.json)"] = 344,
    ["CVE Record Format"] = 225,
    ["CVX achievements.yaml"] = 231,
    ["CVX competencies.yaml"] = 230,
    ["CVX config.yaml"] = 234,
    ["CVX education.yaml"] = 229,
    ["CVX experience.yaml"] = 228,
    ["CVX keywords.yaml"] = 233,
    ["CVX layout"] = 235,
    ["CVX personal.yaml"] = 226,
    ["CVX referees.yaml"] = 232,
    ["CVX summary.yaml"] = 227,
    CWL = 1265,
    ["Cache Warmup config"] = 191,
    ["Caido Proxy Configuration"] = 1429,
    ["Calqulus pipeline"] = 192,
    ["Camel YAML DSL"] = 193,
    ["Cannon TOML"] = 194,
    Carafe = 195,
    ["Cargo Make"] = 197,
    ["Cargo Manifest"] = 196,
    ["Catalog Info Backstage"] = 198,
    ["Chamaleon environment"] = 1318,
    ["Chamaleon properties"] = 1319,
    ["Chamaleon template"] = 1317,
    Changepacks = 1380,
    Changesets = 327,
    Changie = 199,
    Charmcraft = 200,
    Cheatsheets = 1173,
    ["ChordPro Configuration"] = 202,
    ["Chrome Extension"] = 308,
    ["Chromia Model"] = 203,
    ["Chromia Seeder Module Config"] = 205,
    ["Chromia Seeder Root Config"] = 204,
    ["Cinnamon Spice info.json"] = 112,
    ["CircleCI config.yml"] = 278,
    ["Citation File Format"] = 329,
    ["Citrus test case"] = 207,
    CityJSON = 208,
    ["Claude Code Keybindings"] = 220,
    ["Claude Code Launch Preview"] = 1438,
    ["Claude Code Plugin Manifest"] = 221,
    ["Claude Code Plugin Marketplace"] = 222,
    ["Claude Code Settings"] = 223,
    ["Clawject config"] = 219,
    ["Cloud Foundry Application Manifest"] = 1271,
    ["Cloud Run Spec v1"] = 1295,
    ["Cloud.gov Workshop Configuration"] = 113,
    ["CloudCannon Configuration"] = 118,
    ["CloudCannon Configuration (Collection Structures)"] = 127,
    ["CloudCannon Configuration (Collections)"] = 126,
    ["CloudCannon Configuration (Editables)"] = 125,
    ["CloudCannon Configuration (Inputs)"] = 120,
    ["CloudCannon Configuration (Snippets Definitions)"] = 124,
    ["CloudCannon Configuration (Snippets Imports)"] = 123,
    ["CloudCannon Configuration (Snippets)"] = 122,
    ["CloudCannon Configuration (Structure Value)"] = 121,
    ["CloudCannon Configuration (Structures)"] = 119,
    ["CloudEvents specification"] = 209,
    ["Code Climate"] = 279,
    CodeCV = 116,
    CodeRabbit = 115,
    ["CodeShip Pro services configuration files"] = 297,
    ["CodeShip Pro steps configuration files"] = 298,
    ["Codecov configuration files"] = 296,
    Codex = 287,
    ["Codex Hooks"] = 288,
    ["Codex Plugin Manifest"] = 289,
    ["Codex Skill Metadata"] = 290,
    CodifyCLI = 117,
    Codux = 292,
    ["Cog config file"] = 214,
    ["Commandbox Box.json"] = 215,
    ["Commandbox Server.json"] = 216,
    ["Common Catalog Data"] = 306,
    ["Common Package Specification"] = 217,
    Concord = 1288,
    ["Configu .cfgu files"] = 1276,
    ["Configu .configu file"] = 1277,
    Conjure = 212,
    ["Container Structure Test"] = 1112,
    Containerlab = 1141,
    ["Context Passport"] = 1,
    ["Contextive Glossary"] = 1345,
    ContractGuard = 1142,
    Convex = 211,
    ["Crowdsec collection config"] = 338,
    ["Crowdsec parser config"] = 339,
    ["Crowdsec scenario config"] = 340,
    ["CumulusCI Config"] = 218,
    ["Cursor Agent Environment"] = 1398,
    ["Custom Machinery Machine"] = 1260,
    ["Custom Machinery Recipe"] = 1261,
    ["Cycle Stack File"] = 236,
    CycloneDX = 237,
    ["DWP Exchange - catalogue entry"] = 394,
    ["DWP Exchange - gateway"] = 392,
    ["DWP Exchange - meta"] = 393,
    ["Dagger module"] = 347,
    ["Dark Factory consumer config"] = 238,
    ["Dart Build Config (dart-build.json)"] = 348,
    ["Dart Test Config (dart-test.json)"] = 349,
    ["DashLord Configuration"] = 350,
    ["Data Contract Specification"] = 351,
    ["Data Product Specification"] = 352,
    ["DataYoga Connections"] = 239,
    ["DataYoga Job"] = 240,
    ["Datadog Continuous Testing"] = 603,
    ["Datadog Service Definition"] = 604,
    ["Datadog Software Catalog"] = 605,
    ["Datahub Ingestion Recipe"] = 1192,
    ["Debian Upstream Metadata file"] = 247,
    DebtLens = 248,
    ["Deck config"] = 249,
    ["Declarative Automation Bundles"] = 1238,
    ["DeepMatch deeplinks spec"] = 250,
    ["Dein Config"] = 251,
    ["Deno Config (deno.json)"] = 360,
    ["Dependency cruiser"] = 252,
    ["DeployStack Configuration"] = 253,
    ["Deployah Configuration"] = 1368,
    ["Deployer Recipe"] = 363,
    ["Design Tokens Community Group format"] = 254,
    ["Design Tokens Community Group resolver"] = 255,
    ["Deta Spacefile"] = 256,
    ["Detekt Config (detekt.yml)"] = 364,
    ["Devbox Config"] = 257,
    ["Devbox Plugin"] = 258,
    Devfile = 391,
    Devup = 1381,
    DipDup = 1291,
    ["Discord Webhook"] = 365,
    ["DocFx Config (docfx.json)"] = 370,
    ["Docker Desktop extension metadata"] = 367,
    ["Docs MCP Manifest"] = 371,
    Dofigen = 372,
    ["Dolittle Artifacts"] = 373,
    ["Dolittle Bounded Context Configuration"] = 374,
    ["Dolittle Event Horizons Configuration"] = 375,
    ["Dolittle Resources Configuration"] = 376,
    ["Dolittle Server Configuration"] = 377,
    ["Dolittle Tenant Map Configuration"] = 379,
    ["Dolittle Tenants Configuration"] = 378,
    ["Dolittle Topology"] = 380,
    ["DonateCaseBetterCasino menu"] = 1322,
    ["Draugr Saga"] = 358,
    ["Draugr Saga fragment"] = 359,
    ["Drupal Breakpoints"] = 260,
    ["Drupal Config"] = 272,
    ["Drupal Info"] = 261,
    ["Drupal Layouts"] = 262,
    ["Drupal Libraries"] = 263,
    ["Drupal Links Action"] = 264,
    ["Drupal Links Contextual"] = 265,
    ["Drupal Links Menu"] = 266,
    ["Drupal Links Task"] = 267,
    ["Drupal Migration"] = 268,
    ["Drupal Permissions"] = 269,
    ["Drupal Recipe"] = 270,
    ["Drupal Routing"] = 271,
    ["Drupal Services"] = 273,
    ["Drush site aliases"] = 386,
    ["Dust configuration"] = 389,
    ["Dynamic Bash Aliases (.aliases)"] = 1229,
    ["EAS config"] = 433,
    ["ECA - Editor Code Assistant"] = 396,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1218,
    ["ESLint Suppressions"] = 438,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1365,
    ["EasyVCR .NET"] = 435,
    ["Eidolon Resource"] = 1306,
    ["Elgato Stream Deck"] = 399,
    Elm = 1293,
    ["Embrace Config"] = 1204,
    Emmet = 1294,
    Endurica = 1242,
    ["Enonic XP API descriptor"] = 402,
    ["Enonic XP Admin Extension descriptor"] = 403,
    ["Enonic XP Admin Tool descriptor"] = 404,
    ["Enonic XP Application descriptor"] = 405,
    ["Enonic XP CMS descriptor"] = 406,
    ["Enonic XP Content Type descriptor"] = 407,
    ["Enonic XP Form Fragment descriptor"] = 408,
    ["Enonic XP ID Provider descriptor"] = 409,
    ["Enonic XP Layout descriptor"] = 410,
    ["Enonic XP Macro descriptor"] = 411,
    ["Enonic XP Mixin descriptor"] = 412,
    ["Enonic XP Page descriptor"] = 413,
    ["Enonic XP Part descriptor"] = 414,
    ["Enonic XP Service descriptor"] = 415,
    ["Enonic XP Site descriptor"] = 416,
    ["Enonic XP Style descriptor"] = 417,
    ["Enonic XP Task descriptor"] = 418,
    ["Enonic XP Webapp descriptor"] = 419,
    ["Enterprise Contract Policy Spec"] = 400,
    ["Envelope Team Definition"] = 1413,
    ["Envilder Map File"] = 401,
    ["Erda Pipeline"] = 1267,
    ["Erda Runtime"] = 1268,
    ["Espanso config.yml"] = 1391,
    ["Espanso match.yml"] = 1390,
    Esquio = 421,
    ["Estuary Flow Catalog"] = 1182,
    ["Ethereum ERC1155"] = 1407,
    ["Ethereum ERC721"] = 1406,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 426,
    ["EveryVoice TTS Toolkit Data Configuration"] = 427,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 431,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 430,
    ["EveryVoice TTS Toolkit Text Configuration"] = 428,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 429,
    ["Evolving Resolutive Process notation"] = 1367,
    ["Expo SDK"] = 432,
    ["Expoot app config"] = 434,
    ["F-Droid Data metadata"] = 440,
    ["FasterCI Configuration"] = 136,
    ["Fence configuration"] = 137,
    FiQuS = 444,
    Firebase = 442,
    ["Flatpak Builder Manifest"] = 445,
    ["FlexGet Config"] = 446,
    ["Flow.json Configurations"] = 1264,
    ["Fossa configuration file"] = 453,
    ["Fossa's fossa-deps file"] = 454,
    ["Foundry VTT - Base package Manifest"] = 448,
    ["Foundry VTT - Module Manifest"] = 449,
    ["Foundry VTT - System Data Template"] = 452,
    ["Foundry VTT - System Manifest"] = 450,
    ["Foundry VTT - World Manifest"] = 451,
    ["Foxx Manifest"] = 138,
    ["Freifunk.de Community API"] = 141,
    ["Frogbot Config"] = 142,
    ["G2P Mapping Configuration"] = 461,
    GAMA = 462,
    ["GCP Blueprint Metadata"] = 465,
    Gaspar = 463,
    ["GatewayCore API Gateway"] = 464,
    ["Gemini CLI settings"] = 466,
    ["GeoJSON.json latest"] = 1180,
    GherKing = 1184,
    ["GitHub Action"] = 476,
    ["GitHub Actions typing"] = 1302,
    ["GitHub CLI configuration"] = 477,
    ["GitHub CLI hosts"] = 478,
    ["GitHub Discussion"] = 479,
    ["GitHub Funding"] = 481,
    ["GitHub Issue Template configuration"] = 482,
    ["GitHub Issue Template forms"] = 483,
    ["GitHub Pages Jekyll"] = 484,
    ["GitHub Prompt"] = 480,
    ["GitHub Secret Scanning"] = 485,
    ["GitHub Workflow"] = 486,
    ["GitHub Workflow Template Properties"] = 487,
    ["GitHub automatically generated release notes configuration"] = 488,
    ["GitLab Agent for Kubernetes configuration"] = 1256,
    ["GitLab Duo Workflow"] = 490,
    GitResume = 492,
    GitVersion = 469,
    ["Gitea Issue Template configuration"] = 472,
    ["Gitea Issue Template forms"] = 473,
    Gitleaks = 470,
    ["Gitpod Configuration"] = 491,
    ["Glamour style"] = 467,
    ["GlazeWM settings"] = 1258,
    ["Global Privacy Control"] = 468,
    Goblet = 1237,
    ["Golangci-lint Configuration"] = 507,
    ["Golangci-lint Custom Plugins Configuration"] = 508,
    ["Google Chrome Related Website Sets"] = 443,
    ["Google Cloud Workflows"] = 314,
    ["Google Digital Assetlinks"] = 1346,
    Goreleaser = 512,
    ["Goreleaser Pro"] = 513,
    Goss = 515,
    ["Gradle Build Cache Node"] = 1130,
    ["Gradle Enterprise"] = 1129,
    ["Grafana 5.x Dashboard"] = 516,
    ["GraphQL Code Generator"] = 521,
    ["GraphQL Config"] = 520,
    ["GraphQL Mesh"] = 519,
    ["GroovyLint configuration"] = 522,
    ["Grunt JSHint task"] = 526,
    ["Grunt Watch task"] = 527,
    ["Grunt base task"] = 528,
    ["Grunt clean task"] = 524,
    ["Grunt copy task"] = 523,
    ["Grunt cssmin task"] = 525,
    HEMTT = 1094,
    Hadolint = 1108,
    Hammerkit = 1140,
    ["Hardware Sentry Configuration"] = 1196,
    ["Hashgraph Online Skill Manifest"] = 8,
    ["HashiCorp Vault"] = 529,
    Hatch = 1109,
    Hayson = 531,
    ["Haystack Pipeline"] = 532,
    ["Hazelcast 5 Configuration"] = 533,
    ["Hecate Input Schema"] = 1357,
    ["Helm Chart.lock"] = 275,
    ["Helm Chart.yaml"] = 274,
    ["Helm Unittest Test Suite"] = 276,
    ["Heloisa Assistant Plugins Marketplace"] = 1436,
    ["Hex file"] = 277,
    ["Home Assistant Integration Manifest"] = 535,
    ["Homer dashboard configuration"] = 536,
    ["Hoverfly Simulation"] = 541,
    Hugo = 1172,
    ["Hugo Theme"] = 1171,
    ["Hulak Configuration"] = 544,
    ["Hyperfoil benchmark configuration"] = 543,
    ["IBM Zapp document"] = 545,
    ["IBM zCodeFormatSettings"] = 546,
    ["IMG Catapult PSP"] = 551,
    ["IVMS101 by CODE Protocol"] = 1257,
    ["Infinispan Configuration"] = 553,
    ["Infinispan Server Configuration"] = 554,
    Infrahub = 555,
    Istanbul = 1200,
    ["JDownloader2 crawler multi-rules"] = 569,
    ["JDownloader2 crawler single-rules"] = 568,
    ["JFrog Applications Config"] = 570,
    ["JFrog File Spec"] = 571,
    ["JFrog Pipelines YML DSL"] = 1206,
    ["JMeter DSL cli config"] = 572,
    JReleaser = 575,
    ["JSON Document Transform"] = 583,
    ["JSON Feed"] = 584,
    ["JSON Resume"] = 861,
    ["JSON Schema Draft 2020-12"] = 1074,
    ["JSON Schema Draft 4"] = 1071,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1239,
    ["JSON Schema Draft 7"] = 1072,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1240,
    ["JSON Schema Draft 8 (2019-09)"] = 1073,
    ["JSON-API"] = 582,
    ["JSON-e templates"] = 1137,
    ["JSON-stat 2.0"] = 1067,
    JSONPatch = 586,
    ["JSR Package Config (jsr.json)"] = 576,
    Jarl = 1373,
    Jasmine = 563,
    Jekyll = 564,
    ["Jenkins X Pipelines"] = 565,
    ["Jenkins X Requirements"] = 566,
    Jest = 567,
    Jocker = 573,
    ["Jovo Language Models"] = 574,
    Jsontron = 587,
    ["Jujutsu (jj) VCS config"] = 1359,
    ["KIMMDY config file"] = 598,
    ["KODE/CI build.yaml"] = 1202,
    ["KSP-AVC"] = 1068,
    ["KSP-CKAN"] = 1069,
    ["KSP-NetKAN"] = 1070,
    KSY = 1269,
    KSail = 459,
    ["KYA Manifest"] = 1270,
    ["Karakum configuration file"] = 455,
    Kas = 590,
    ["Kestra flow file"] = 599,
    ["Keycloak REST API"] = 1209,
    ["Knative Functions - func.yaml"] = 456,
    Knip = 457,
    ["Knip JSONC"] = 458,
    ["Knowledge Unit"] = 607,
    ["Kometa (nightly) config file"] = 601,
    ["Kometa config file"] = 600,
    ["Kong DBLess config"] = 1203,
    KrakenD = 602,
    ["Kubri Configuration"] = 610,
    LOOBin = 628,
    ["Lake configuration file"] = 1362,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 319,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 320,
    ["Landing Zone Accelerator on AWS - Global Config"] = 321,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 322,
    ["Landing Zone Accelerator on AWS - Network Config"] = 323,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 324,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 325,
    ["Landing Zone Accelerator on AWS - Security Config"] = 326,
    ["Lando (landofile)"] = 128,
    ["LangGraph Platform configuration"] = 1281,
    ["Language configuration"] = 1280,
    Lefthook = 615,
    ["Liferay client-extension.yaml"] = 622,
    ["LinkML Metamodel"] = 624,
    ["LiquiLens Evidence Carrier Reference v1"] = 626,
    ["LiquiLens Evidence Carrier v1"] = 625,
    Liquibase = 1147,
    ["Liquibase Flow File"] = 1148,
    ["Lively Properties"] = 627,
    ["Lobe AI Agent"] = 130,
    Loki = 131,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 671,
    ["MS2Rescore Configuration"] = 679,
    ["MSTest testconfig.json"] = 680,
    ["Madge configuration"] = 634,
    ["Madness (madness.yml)"] = 1220,
    ["Mado configuration"] = 635,
    ["Maestro Flow"] = 636,
    ["Mail Servers Configuration"] = 1394,
    ["MapEHR Mapping"] = 637,
    Markdownlint = 1151,
    ["Mason Registry"] = 1154,
    ["MegaLinter Custom Flavor"] = 640,
    ["MegaLinter configuration"] = 639,
    ["MegaLinter descriptor"] = 641,
    Melange = 1247,
    ["Meltano project definition"] = 642,
    ["Mergify Configuration"] = 681,
    ["Mermaid config"] = 3,
    ["Metadata for a Bazel module"] = 643,
    ["Metadata for a Cinnamon spice"] = 1298,
    ["Metatype Configuration"] = 644,
    ["MetricsHub Configuration"] = 645,
    ["MetricsHub Connector Configuration"] = 646,
    ["Micro Editor Syntax"] = 1230,
    ["Microsoft Band Web Tile"] = 647,
    ["Microsoft RulesEngine workflow rules"] = 1285,
    ["Microsoft RulesEngine workflow rules list"] = 1286,
    ["Minecraft Custom Main Menu Mod"] = 1248,
    ["Minecraft Data Pack Advancement"] = 649,
    ["Minecraft Data Pack Biome"] = 650,
    ["Minecraft Data Pack Configured Carver"] = 651,
    ["Minecraft Data Pack Damage Type"] = 652,
    ["Minecraft Data Pack Dimension"] = 654,
    ["Minecraft Data Pack Dimension Type"] = 653,
    ["Minecraft Data Pack Item Modifier"] = 655,
    ["Minecraft Data Pack Loot Table"] = 656,
    ["Minecraft Data Pack Metadata"] = 657,
    ["Minecraft Data Pack Predicate"] = 658,
    ["Minecraft Data Pack Recipe"] = 659,
    ["Minecraft Data Pack Tag"] = 660,
    ["Minecraft Data Pack Template Pool"] = 661,
    ["Minecraft Data Pack Trim Material"] = 666,
    ["Minecraft Data Pack Trim Pattern"] = 667,
    ["Minecraft Resource Pack Lang"] = 662,
    ["Minecraft Resource Pack Particle"] = 663,
    ["Minecraft Resource Pack Texture Mcmeta"] = 665,
    ["Minecraft Resourcepack Sounds"] = 664,
    ["MockServer Expectation"] = 673,
    ["MockServer Expectations"] = 674,
    ModuleAssembler = 669,
    ["Monade CLI Stack Configuration"] = 684,
    ["MongoDB Atlas Search Index Definition"] = 1201,
    ["Monika Configuration"] = 1199,
    ["Monoweave Configuration"] = 678,
    ["Motif config"] = 1090,
    MultiQC = 1339,
    ["NOX Framework (Service)"] = 706,
    ["Netin Diagnostic System Template"] = 1158,
    ["Netlify config"] = 687,
    ["Network-as-Code Data Model"] = 688,
    ["Next Gen UI Agent A2A Server Configuration"] = 689,
    ["Next Gen UI Agent Configuration"] = 691,
    ["Next Gen UI Agent MCP Server Configuration"] = 690,
    ["Nightwatch.js"] = 698,
    ["Nika workflow"] = 703,
    ["Node.js configuration"] = 1095,
    ["NueJS configuration file"] = 711,
    ["Nuitka Package Config"] = 1262,
    ["Nullstone config"] = 713,
    ["ODGS Data Rules"] = 720,
    ["ODGS Ontology Graph"] = 721,
    ["ODGS Standard Metrics"] = 719,
    ["OKF Graph"] = 1437,
    ["ONe's changelog entry"] = 735,
    ["ONe's service descriptor"] = 734,
    ["ORT Server repository environment configuration"] = 746,
    ["OSCAL Assessment Plan (AP)"] = 748,
    ["OSCAL Assessment Results (AR)"] = 749,
    ["OSCAL Catalog"] = 750,
    ["OSCAL Component Definition (CDef)"] = 751,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 752,
    ["OSCAL Profile"] = 753,
    ["OSCAL System Security Plan (SSP)"] = 754,
    ["OSS Review Toolkit configuration"] = 755,
    ["OSS Review Toolkit curation"] = 756,
    ["OSS Review Toolkit package configuration"] = 757,
    ["OSS Review Toolkit project package manager definition"] = 758,
    ["OSS Review Toolkit repository configuration"] = 759,
    ["OSS Review Toolkit resolutions"] = 760,
    ["October CMS columns"] = 717,
    ["October CMS fields"] = 718,
    ["Oh My Posh"] = 723,
    Okteto = 724,
    ["Ona Tasks and Services"] = 726,
    Opctl = 1093,
    ["Open Data Contract Standard (ODCS)"] = 739,
    ["Open Data Product Standard (ODPS)"] = 740,
    ["Open Know-How"] = 1344,
    ["Open Pentest Format"] = 741,
    OpenDecree = 1411,
    ["OpenDecree Configuration"] = 1412,
    ["OpenRewrite Resource"] = 737,
    OpenSRM = 742,
    OpenStatus = 1355,
    ["OpenTelemetry Declarative Configuration"] = 738,
    ["OpenUtau character yaml"] = 731,
    ["OpenUtau ustx"] = 732,
    ["OpenWeather Current Weather API"] = 1136,
    ["OpenWeather Road Risk API"] = 1135,
    ["Ory Hydra configuration"] = 542,
    ["Ory Keto configuration"] = 606,
    ["Ory Kratos configuration"] = 747,
    ["Ory Oathkeeper configuration"] = 715,
    ["Outblocks App configuration"] = 744,
    ["Outblocks database table"] = 745,
    ["Outblocks project configuration"] = 743,
    PDM = 768,
    POPxf = 780,
    ["POPxf Correlations"] = 781,
    ["PRML manifest"] = 788,
    Packer = 764,
    PactSpec = 765,
    Panache = 766,
    Pantsbuild = 1216,
    ["Paper paper-plugin.yml"] = 767,
    ["Pipeline component"] = 1149,
    ["Platform.sh application"] = 14,
    ["Platform.sh routes"] = 15,
    ["Platform.sh services"] = 16,
    ["Plex Prerolls"] = 778,
    ["PocketMine plugin.yml"] = 775,
    ["Podman Desktop Extension"] = 1431,
    ["Postman collection"] = 784,
    ["Power Pages Configuration"] = 1356,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1301,
    ["ProActions AI-Kit Configuration"] = 796,
    ["ProActions AI-Kit Configuration for Menus"] = 798,
    ["ProActions AI-Kit Configuration for Sections"] = 800,
    ["ProActions AI-Kit Configuration for Services"] = 797,
    ["ProActions AI-Kit Configuration for Steps"] = 801,
    ["ProActions AI-Kit Configuration for Templates"] = 799,
    ["Problem object RFC9457"] = 1245,
    ["Problem package format"] = 802,
    ["Problem package generators"] = 803,
    ["Problem package submissions"] = 804,
    ["Problem package test group metadata"] = 805,
    Pterodactyl = 1195,
    ["Pull Request Labeler"] = 822,
    Pulumi = 830,
    ["PyGTA Config"] = 826,
    PyProject = 831,
    Pylock = 1347,
    Pyright = 832,
    ["Python script metadata"] = 1341,
    ["QType AI DSL"] = 835,
    Qgoda = 834,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1423,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1421,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1427,
    ["Qlik Talend Cloud Pipeline - Project"] = 1419,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1422,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1424,
    ["Qlik Talend Cloud Pipeline - Task"] = 1420,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1426,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1425,
    Qodana = 1168,
    ["Qt Creator workspace file"] = 1278,
    ["Quali Torque Blueprint Spec 2"] = 1193,
    ["QueryFirst config file"] = 1212,
    ["QuikRun Configuration"] = 1428,
    ["Qwen Code Settings"] = 1408,
    ["RKE Cluster Configuration JSON"] = 1146,
    ["RKE Cluster Configuration YAML"] = 1145,
    RadioHound = 825,
    ["Raid Profile"] = 1409,
    ["Raid Repo Configuration"] = 1410,
    Railpack = 837,
    Railway = 836,
    ["Rancher Fleet"] = 827,
    ["Rattler-build"] = 838,
    Ray = 1107,
    ["Read the Docs"] = 829,
    ["Red-DiscordBot Cog"] = 845,
    ["Red-DiscordBot Cog Repo"] = 846,
    ["Red-DiscordBot Trivia"] = 847,
    ["Releasaurus Config"] = 11,
    ReleaseKit = 10,
    ["Render Blueprints"] = 1144,
    RenderCV = 865,
    Renovate = 862,
    ["Renovate global configuration"] = 863,
    ["Renovate inherited configuration"] = 864,
    ["Replit config"] = 853,
    Restate = 1334,
    ["Revel Digital Gadget Definition File"] = 1358,
    RoadRunner = 867,
    ["Robust Station Image"] = 1364,
    Rockcraft = 868,
    ["Roo Coder Custom Modes"] = 869,
    Rubocop = 858,
    ["Rudder techniques"] = 1252,
    Ruff = 859,
    ["Rust Project"] = 860,
    ["Rust toolchain"] = 874,
    ["SDMX data message"] = 901,
    ["SDMX metadata message"] = 900,
    ["SDMX structure message"] = 899,
    ["SIL Kit Participant Configuration"] = 912,
    ["SIL Kit Registry Configuration"] = 913,
    ["SPDX 2.3"] = 955,
    SWADL = 971,
    ["Safebox Config"] = 1207,
    ["Sapphire CLI Config"] = 877,
    ["SauceCTL Configuration"] = 1155,
    Scarb = 897,
    ["Schema Catalog"] = 892,
    ["Scoop manifest"] = 898,
    ["Secure SDLC Evidence Bundle"] = 902,
    ["Semantic Data Fabric (SDF) file"] = 903,
    ["Semgrep Rule"] = 905,
    ["Serenity Code Generator (Sergen)"] = 906,
    ["Serverless Framework Configuration"] = 1162,
    ["Serverless Workflow"] = 1164,
    ["Settings for a Cinnamon spice"] = 1297,
    ["Settings.paf"] = 908,
    ["Shopware 6 Configuration"] = 1165,
    ["Shopware CLI Extension Store Configuration"] = 1166,
    ["Shopware CLI Project Store Configuration"] = 1167,
    ["Sigma Detection Rule"] = 910,
    ["SigmaCV CV"] = 6,
    ["Sigrid scope configuration file"] = 911,
    ["SkyPilot Task JSON"] = 1253,
    ["Slack app manifest"] = 918,
    ["Slang Server Configuration"] = 1435,
    Snapcraft = 920,
    ["Solarxy project config"] = 923,
    Solidarity = 924,
    ["Solution filters"] = 925,
    ["Source Maps v3"] = 926,
    Sourcery = 927,
    ["Spack bootstrap.yaml"] = 928,
    ["Spack cdash.yaml"] = 929,
    ["Spack ci.yaml"] = 930,
    ["Spack compilers.yaml"] = 931,
    ["Spack concretizer.yaml"] = 932,
    ["Spack config.yaml"] = 933,
    ["Spack definitions.yaml"] = 934,
    ["Spack develop.yaml"] = 935,
    ["Spack env_vars.yaml"] = 936,
    ["Spack environment"] = 942,
    ["Spack include.yaml"] = 937,
    ["Spack mirrors.yaml"] = 938,
    ["Spack modules.yaml"] = 939,
    ["Spack packages.yaml"] = 940,
    ["Spack repos.yaml"] = 941,
    ["Spack toolchains.yaml"] = 943,
    ["Spack upstreams.yaml"] = 944,
    ["Spack view.yaml"] = 945,
    ["Speakeasy Generation Config File"] = 949,
    ["Speakeasy Lint Configuration File"] = 946,
    ["Speakeasy Test Generation Configuration File"] = 947,
    ["Speakeasy Workflow File"] = 948,
    SpecIF = 950,
    ["Specmatic Configuration"] = 951,
    ["Specpin spec file"] = 4,
    ["Sponge Mixin configuration"] = 952,
    ["Spotlight Ruleset"] = 953,
    StackBlitz = 959,
    ["StackHawk Scanner Configuration"] = 1161,
    Stale = 960,
    Starfish = 961,
    ["Starlake Data Pipeline"] = 1133,
    Starship = 962,
    ["Statamic Blueprint"] = 963,
    ["Stella configuration file"] = 964,
    ["Streamlit configuration file"] = 965,
    ["Stryker Mutator"] = 968,
    ["StyleCop Analyzers Configuration"] = 969,
    ["Stylelint (.stylelintrc)"] = 970,
    ["Stylua Config"] = 1348,
    ["Sublime Syntax"] = 1208,
    ["Subsquid squid manifest"] = 1255,
    ["Swagger API 2.0"] = 972,
    ["Symfony Routing Configuration"] = 973,
    ["Symfony Serializer Mapping"] = 974,
    ["Symfony Services Configuration"] = 975,
    ["Symfony Validation Mapping"] = 976,
    ["Synadia Connect Component"] = 977,
    TSON = 1015,
    TSTyche = 1016,
    ["TYPO3 Vendor Bundler config"] = 1022,
    ["Tab data for a LinUtil"] = 1304,
    ["Tab list for a LinUtil"] = 1303,
    Tach = 978,
    ["Tach Domain"] = 979,
    Talhelper = 981,
    ["Talisman configuration"] = 982,
    Taplo = 1349,
    ["Taskfile config"] = 1138,
    Taurus = 983,
    Tauticord = 984,
    ["Tekton Pipeline"] = 1377,
    ["Tekton PipelineRun"] = 1378,
    ["Tekton Task"] = 1375,
    ["Tekton TaskRun"] = 1376,
    Telefonistka = 1335,
    ["Terrateam config"] = 1361,
    ["TestEnvironment.json"] = 996,
    ["TextMate Grammar"] = 995,
    Threagile = 990,
    ["Tier.run pricing.json"] = 987,
    Tikibase = 988,
    Tombi = 993,
    ["Traefik v2"] = 999,
    ["Traefik v2 File Provider"] = 1000,
    ["Traefik v3"] = 1001,
    ["Traefik v3 File Provider"] = 1002,
    ["Travis CI (.travis.yml)"] = 998,
    Treefmt = 518,
    Trident = 1331,
    Trivy = 1005,
    ["TrueScript for *.tscript files"] = 1006,
    ["Tugboat QA config.yml"] = 1328,
    TunnelHub = 1243,
    Turborepo = 997,
    Tycho = 1292,
    Tye = 1169,
    ["Tyk Gateway - Open Source v5.7+"] = 1340,
    ["UET BuildConfig.json"] = 1213,
    ["UI5 Manifest"] = 1028,
    ["UNCORS configuration"] = 1033,
    ["UTAM Page Object"] = 1031,
    ["Ubuntu Server Autoinstall"] = 1026,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1332,
    ["Uniswap Token List"] = 1118,
    ["Universal Schedule Format"] = 1034,
    ["Unreal Engine Uplugin"] = 1214,
    ["Unreal Engine Uproject"] = 1215,
    ["UpCloud CLI (upctl) configuration"] = 1333,
    ["Updatecli Compose"] = 1177,
    ["Updatecli Policy Manifest"] = 1178,
    ["Updatecli Policy Metadata"] = 1179,
    Uplift = 1211,
    ["Upsun config"] = 13,
    ["User Journey Map"] = 1143,
    V2Ray = 1183,
    ["VSCode Code Snippets"] = 302,
    ["VSIX CLI publishing"] = 1054,
    Vector = 1036,
    ["Vee JSON menu output"] = 1037,
    ["Vela Pipeline Configuration"] = 1040,
    Vercel = 301,
    ["Version Bumper config"] = 1043,
    Vespertide = 1382,
    ["Vespertide Migration"] = 1383,
    ["Vespertide Model"] = 1384,
    ["Viash Component Config"] = 1337,
    ["Viash Package Config"] = 1338,
    Visivo = 1241,
    Vogi = 1048,
    ["WP-CLI"] = 1064,
    Wake = 1330,
    ["Waku Config"] = 1307,
    ["Web App Manifest"] = 1060,
    ["Web types"] = 1063,
    WebExtensions = 1059,
    ["Webman package recipe"] = 1189,
    ["Windows Package Manager Installer Manifest"] = 1115,
    ["Windows Package Manager Locale Manifest"] = 1116,
    ["Windows Package Manager Singleton Manifest"] = 1114,
    ["WireMock CLI import configuration"] = 1313,
    ["WireMock CLI local service configuration"] = 1312,
    ["WireMock message stub mapping"] = 1311,
    ["WireMock stub mapping"] = 1310,
    ["Woodpecker pipeline config"] = 1157,
    ["Wrangler CLI"] = 1065,
    ["XenForo add-on manifest"] = 1066,
    ["Xstate Machine"] = 1175,
    ["Yandex Workflow Language"] = 1299,
    ["Yarn Config (.yarnrc.yml)"] = 1131,
    ["Yippee-Ki-JSON configuration YML"] = 1122,
    ["YouTrack App"] = 1296,
    ["Zarf Package Configuration"] = 1363,
    ["Zerops import file"] = 1284,
    ["Zola Configuration"] = 1374,
    abtop = 34,
    act3 = 1415,
    actionlint = 44,
    ["aerleon.yml"] = 28,
    ["amplify.yml"] = 21,
    ["amxx-builder manifest"] = 1430,
    ["angular.json"] = 49,
    apko = 1246,
    ["app-definition.yaml"] = 53,
    ["apple-app-site-association"] = 51,
    ["appsettings.StormPetrel.json"] = 58,
    ["appsettings.json"] = 56,
    ["appsscript.json"] = 55,
    ["appveyor.yml"] = 57,
    ["aqua-generate-registry.yaml"] = 60,
    ["aqua-policy.yaml"] = 61,
    ["aqua.yaml"] = 59,
    ["arazzo.json"] = 63,
    ["arb.json"] = 64,
    ["arc.json"] = 66,
    ["architect.yml"] = 65,
    ["artifacthub-repo.yml"] = 74,
    ["asm-lsp"] = 76,
    ["ast-grep rules"] = 79,
    ["ast-grep sgconfig.yml"] = 78,
    ["azure.yaml"] = 87,
    ["babelrc.json"] = 144,
    ["bamboo-spec"] = 148,
    basedpyright = 146,
    ["bashly-strings.yml"] = 1223,
    ["batect.yml"] = 147,
    ["beef-database-codegen"] = 149,
    ["beef-database-v5-codegen"] = 151,
    ["beef-entity-codegen"] = 150,
    ["beef-entity-v5-codegen"] = 152,
    ["behat.yml"] = 168,
    ["bigquery-table"] = 153,
    ["bioimageio resource description"] = 1263,
    ["bitbucket-pipelines"] = 155,
    bitrise = 156,
    ["bitrise-step"] = 157,
    ["block.json"] = 185,
    ["bottom configuration"] = 103,
    ["bower.json"] = 159,
    ["bozr.suite.json"] = 172,
    bpkg = 1224,
    ["browser.i18n.json"] = 173,
    ["browsh configuration"] = 174,
    bucklescript = 175,
    ["buf.gen.yaml"] = 106,
    ["buf.lock"] = 107,
    ["buf.plugin.yaml"] = 108,
    ...
    ["build-changelog"] = 176,
    ["bun.lock"] = 181,
    ["bundleconfig.json"] = 182,
    ["bunfig.toml"] = 183,
    ["cargo-mutants-config.yaml"] = 111,
    ["cargo-nextest repository configuration"] = 692,
    ["cargo-nextest user configuration"] = 693,
    ["ccmod.json"] = 1308,
    changelogging = 1275,
    ["chezmoi configuration"] = 201,
    ["chisel-slices.json"] = 328,
    ["chrome-extension-locales-messages.json"] = 309,
    ["chutzpah.json"] = 310,
    cibuildwheel = 206,
    ["clang-format (.clang-format)"] = 1181,
    ["clang-tidy"] = 283,
    clangd = 282,
    clib = 284,
    ["cloud-init: cloud-config userdata"] = 286,
    ["cloud-sdk-pipeline-configuration"] = 312,
    ["cloudbuild.json"] = 313,
    cloudify = 285,
    cmakefmt = 224,
    ["cmdx.yaml"] = 114,
    ...
    ["commands.json"] = 305,
    ["commit-check"] = 331,
    ["commitlint (.commitlintrc)"] = 1117,
    ["committed.toml"] = 332,
    ["compile_commands.json"] = 304,
    ["compilerconfig.json"] = 303,
    ["completely.yml"] = 1219,
    ["component-detection-manifest.json"] = 335,
    ["component.json"] = 334,
    ["composer.json"] = 333,
    ["conda-forge"] = 210,
    ["config.yaml"] = 828,
    ["contentmanifest.json"] = 311,
    ["contribute.json"] = 336,
    ["cosmos.config.json"] = 307,
    ["crowdin.yml"] = 337,
    crucible = 341,
    ["ctfd-setup configuration file"] = 1320,
    ["custom-elements.json"] = 1233,
    ["cypress.json"] = 342,
    ["dacier.yml"] = 1418,
    ["datalogic-scan2deploy-android"] = 353,
    ["datalogic-scan2deploy-ce"] = 354,
    ["dbt Dependencies"] = 242,
    ["dbt Packages"] = 244,
    ["dbt Project"] = 243,
    ["dbt Selectors"] = 245,
    ["dbt YAML files"] = 246,
    ...
    ["ddev-global"] = 355,
    ["ddev-project"] = 356,
    ["debugsettings.json"] = 357,
    ["dependabot-v2.json"] = 362,
    ["dependabot.json"] = 361,
    ["deployed-cli"] = 1174,
    devconcurrent = 259,
    ["devcontainer-feature.json"] = 294,
    ["devcontainer.json"] = 293,
    devinit = 1124,
    ["devspace.yaml"] = 1197,
    djlint = 1125,
    ["docker bake"] = 368,
    ["docker sequencer"] = 369,
    ["docker-compose.yml"] = 1123,
    ["dockerd.json"] = 366,
    ["dotnet Release Index manifest"] = 381,
    ["dotnet-tools.json"] = 382,
    ["dotnetcli.host.json"] = 383,
    ["dprint.json"] = 384,
    ["drone.json"] = 385,
    ["dss-2.0.0.json"] = 387,
    ["dstack configuration"] = 388,
    ["dtool dataset metadata"] = 1315,
    ["dvc.yaml"] = 390,
    ["ecosystem.json"] = 395,
    ["editorconfig-checker"] = 397,
    eksctl = 398,
    ["electron-builder configuration file"] = 424,
    ["epr-manifest.json"] = 423,
    ["estampo.toml"] = 422,
    ["evcc.yaml"] = 425,
    ["ezd task runner"] = 436,
    ["fabric.mod.json"] = 439,
    ["first-timers-bot"] = 447,
    ["flagd flag configuration"] = 139,
    ["fly.io Configuration"] = 140,
    fulibWorkflows = 1156,
    ["function.json"] = 460,
    ["gRPC API Gateway & OpenAPI Config"] = 23,
    ["gematik health care insurance list"] = 1326,
    ["gematik health care patient list"] = 1323,
    ["gematik health care provider institution list"] = 1325,
    ["gematik health care provider list"] = 1324,
    ["gematik tiger test environment configuration"] = 1327,
    ["gh-dash"] = 474,
    ["gha-doctor"] = 475,
    ["git-cliff"] = 471,
    ["git-town.toml"] = 1372,
    ["github-settings-as-code"] = 854,
    ["gitlab-ci"] = 489,
    ["global.json"] = 506,
    ["glslint config"] = 2,
    ["go-feature-flag Flag Configuration"] = 510,
    ["gojo.yaml"] = 511,
    gollama = 509,
    ["hassette.toml"] = 534,
    ["haxelib.json"] = 530,
    ...
    ["ide.host.json"] = 547,
    ["ifstate.yaml"] = 548,
    ["imageoptimizer.json"] = 549,
    ["importmap.json"] = 552,
    ["index.toml (packwiz)"] = 1432,
    instant_python_config = 556,
    instant_python_custom_project = 557,
    intlayer = 558,
    ["ioBroker Configuration"] = 559,
    ["ioBroker JSON UI"] = 560,
    ["ioBroker Package manifest"] = 561,
    ["ixpect.conf.yaml"] = 562,
    ["ize.toml"] = 1210,
    ["jsconfig.json"] = 588,
    ["jscpd Configuration"] = 1194,
    jsdoc = 1106,
    ["k3d.yaml"] = 589,
    ["k9s aliases.yaml"] = 591,
    ["k9s cluster-config.yaml"] = 593,
    ["k9s config.yaml"] = 592,
    ["k9s hotkeys.yaml"] = 594,
    ["k9s plugins.yaml"] = 595,
    ["k9s skin.yaml"] = 596,
    ["k9s views.yaml"] = 597,
    ["kind cluster"] = 611,
    ["kontinuous-config.yaml"] = 609,
    ["kontinuous-values.yaml"] = 608,
    ["kustomization.yaml"] = 612,
    ["label-commenter-config.yml"] = 613,
    ["latexindent configuration"] = 129,
    ["launchsettings.json"] = 614,
    lazydocker = 1232,
    lazygit = 1231,
    ["lego.json"] = 616,
    ["lerna.json"] = 617,
    ["lgtm.yml"] = 618,
    ["liblab.config.json"] = 619,
    ["libman.json"] = 620,
    ["license-report-config.json"] = 621,
    ["linkinator.config.json"] = 623,
    ["lint-staged (.lintstagedrc)"] = 1083,
    ["local.settings.json"] = 630,
    ["localazy.json"] = 631,
    ["lotus.yaml"] = 629,
    ["lsd colors"] = 133,
    ["lsd config"] = 132,
    ...
    lychee = 1082,
    ["macro.json"] = 1198,
    ["markdown-link-check"] = 1152,
    maturin = 1153,
    mboats = 1160,
    memnex = 1416,
    ["micro-settings.json"] = 1225,
    ["mimetypes.json"] = 648,
    ["mirrord config"] = 1086,
    ["misata.yaml"] = 1085,
    mise = 1087,
    ["mkdocs.yml"] = 668,
    ["mockd.yaml"] = 672,
    ["mod.pw.toml (packwiz)"] = 1433,
    ["modelparams.dev Model"] = 675,
    ["models CLI"] = 676,
    ["monospace.yml"] = 677,
    ["moon.yml"] = 1309,
    ["mprocs Configuration file"] = 1279,
    ["mrdocs.yml"] = 670,
    ["mta.yaml"] = 1088,
    ["mtad.yaml"] = 1089,
    ["mycode.json"] = 685,
    nFPM = 697,
    ["napari plugin manifest"] = 686,
    neoload = 1101,
    ["nest-cli"] = 700,
    ["nexus-rpc-gen"] = 1399,
    ["nf-core module environment.yml"] = 694,
    ["nf-core module meta.yml"] = 695,
    ["nf-core subworkflow meta.yml"] = 696,
    ["ninjs (News in JSON)"] = 699,
    ["nitro.json"] = 1100,
    ["nixd configuration"] = 1251,
    ["nlu.json"] = 701,
    ["nodemon.json"] = 704,
    ["noodl config"] = 1159,
    ["notebook.mod.json"] = 705,
    now = 1096,
    ["npm-badges"] = 708,
    ["nswag.json"] = 712,
    ntangle = 714,
    ["nuclei-template.yaml"] = 709,
    ["nuget-project.json"] = 710,
    ["ocelot.json"] = 716,
    ogen = 722,
    ["omnisharp.json"] = 725,
    openHAB = 1385,
    ...
    oxfmt = 1395,
    oxlint = 1396,
    ["pack.toml (packwiz)"] = 1434,
    ["package.json"] = 761,
    ["package.manifest"] = 763,
    ["package.yaml"] = 762,
    ["partial-black.json"] = 169,
    ["partial-fastapi.json"] = 170,
    ["partial-pixi.json"] = 773,
    ["partial-scheduled.json"] = 171,
    ["pattern.json"] = 771,
    ["petstore-v1.0"] = 1205,
    pgap_yaml_input_reader = 769,
    pgrls = 770,
    pgxgen = 1389,
    pitcms = 1392,
    ["pixi.toml"] = 772,
    ["plagiarize-me.yaml"] = 777,
    ["plagiarize.yaml"] = 776,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1316,
    ["podbard.yaml"] = 779,
    ["portman.json"] = 782,
    ["prefect.toml"] = 791,
    ["prefect.yaml"] = 792,
    ...
    ["prettierrc.json"] = 794,
    ["prisma.yml"] = 795,
    ["project-1.0.0-beta3.json"] = 807,
    ["project-1.0.0-beta4.json"] = 808,
    ["project-1.0.0-beta5.json"] = 809,
    ["project-1.0.0-beta6.json"] = 810,
    ["project-1.0.0-beta8.json"] = 811,
    ["project-1.0.0-rc1.json"] = 812,
    ["project-1.0.0-rc2.json"] = 813,
    ["project.json"] = 806,
    ["project.owasp.yaml"] = 814,
    ["prometheus-alertmanager.json"] = 818,
    ["prometheus.json"] = 815,
    ["prometheus.rules.json"] = 816,
    ["prometheus.rules.test.json"] = 817,
    ["proxies.json"] = 819,
    ["publiccode.yml"] = 820,
    ["pubspec.yaml"] = 821,
    ["pyrseas-0.8.json"] = 824,
    pytest = 833,
    ["quilt.mod.json"] = 1226,
    ["rc3 auth"] = 839,
    ["rc3 collection"] = 840,
    ...
    ["rc3 settings"] = 844,
    ["registry.yaml"] = 62,
    ["release drafter"] = 1102,
    ["release-hub.json"] = 9,
    ["release-please-config.json"] = 849,
    ["release-please-manifest.json"] = 850,
    ["release-plz.toml"] = 851,
    ["renv.lock"] = 866,
    ["reposets Configuration"] = 855,
    ["reposets Credentials"] = 856,
    ["revola.json"] = 7,
    ["rivet.json"] = 1250,
    ["rivet.yaml (legacy)"] = 1249,
    rumdl = 871,
    runny = 870,
    runspec = 1417,
    rustfmt = 872,
    ...
    samt = 875,
    samtrc = 876,
    ["sarif-1.0.0.json"] = 878,
    ["sarif-2.0.0.json"] = 879,
    ["sarif-2.1.0"] = 889,
    ["sarif-2.1.0-rtm.2"] = 880,
    ["sarif-2.1.0-rtm.3"] = 882,
    ["sarif-2.1.0-rtm.4"] = 884,
    ["sarif-2.1.0-rtm.5"] = 886,
    ["sarif-2.1.0-rtm.6"] = 887,
    ["sarif-external-property-file-2.1.0"] = 890,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 881,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 883,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 885,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 888,
    ["scalingo.json configuration"] = 891,
    ["schema.org - Action"] = 893,
    ["schema.org - ContactPoint"] = 894,
    ["schema.org - Place"] = 895,
    ["schema.org - Thing"] = 896,
    ["secrethub.yml"] = 1228,
    ["semantic-release"] = 904,
    servercn = 1441,
    ["servicehub.config.json"] = 1077,
    ["servicehub.service.json"] = 1076,
    ["settings.job"] = 907,
    ["sfdx-hardis configuration"] = 909,
    ["shard.yml"] = 1266,
    ["size-limit configuration"] = 914,
    ["skaffold.yaml"] = 1150,
    ["skill-map plugin extension manifest"] = 915,
    ["skill-map project settings"] = 916,
    ["skill-map provider kind"] = 917,
    ["skyuxconfig.json"] = 919,
    ["snowflake-config"] = 921,
    ["snowflake-connections"] = 922,
    ["spicepod.yaml"] = 1287,
    ["sqlc configuration"] = 956,
    ["stripe-app-local.json"] = 967,
    ["stripe-app.json"] = 966,
    swcrc = 1134,
    ["task.json"] = 980,
    taskcat = 1097,
    ["template.json"] = 985,
    ["templatsources.json"] = 986,
    ["text2confl config"] = 1397,
    ["theme.json"] = 989,
    ["tizen_workspace.json"] = 991,
    tldr = 992,
    ["tm_devices configuration file"] = 1354,
    tmuxinator = 1080,
    tox = 994,
    ["transcend.yml"] = 1003,
    ["tree-sitter grammar.json"] = 517,
    ["trime.yaml"] = 1004,
    ["trunk.yaml"] = 1007,
    ["ts-force-config.json"] = 1013,
    tsbuild = 1008,
    ["tsconfig.json"] = 1009,
    ["tsd.json"] = 1010,
    ["tsdoc.json"] = 1011,
    ...
    v8r = 1058,
    vcluster = 1273,
    ["vcpkg configuration file"] = 300,
    ["vcpkg manifest file"] = 299,
    ["vega-lite.json"] = 1039,
    ["vega.json"] = 1038,
    ["venvironment.yaml"] = 1041,
    ["venvplus.yaml"] = 1042,
    version = 1336,
    ["version.json"] = 1044,
    ["vhwdebugger-binding.yaml"] = 1046,
    ["vim-addon-info"] = 1047,
    ["vs-2017.3.host.json"] = 1050,
    ["vs-nesting.json"] = 1051,
    ["vsls.json"] = 1049,
    ["vss-extension.json"] = 1055,
    vtcfg = 1342,
    ["vtesttree.yaml"] = 1056,
    ["vtestunit.yaml"] = 1057,
    ["warp-keysets.json"] = 1234,
    ["warp-themes.json"] = 1235,
    ["warp-workflows.json"] = 1236,
    ["webhint.io"] = 1190,
    ["webjobpublishsettings.json"] = 1062,
    ["webjobs-list.json"] = 1061,
    ["well-known-fursona"] = 1274,
    ["xs-app.json"] = 1092,
    ["xunit.runner.json"] = 1075,
    ["yaml-workflow"] = 1440,
    yamlfmt = 1119,
    yamllint = 1120,
    ["yap.json"] = 1121,
