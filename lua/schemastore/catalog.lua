...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1070,
    [".nodehawkrc"] = 686,
    [".npmpackagejsonlintrc"] = 691,
    [".omletrc"] = 1251,
    [".phrase.yml"] = 773,
    [".phraseapp.yml"] = 774,
    [".pmbot.yml"] = 758,
    [".postcssrc"] = 767,
    [".powerpages-web-template-manifest"] = 769,
    [".pre-commit-config.yml"] = 770,
    [".pre-commit-hooks.yml"] = 771,
    [".putout.json"] = 807,
    [".rehyperc"] = 832,
    [".remarkrc"] = 836,
    [".sprite files"] = 938,
    ...
    AIConfig = 45,
    ["AMX Muse Program Descriptor"] = 1300,
    ["API Builder"] = 1106,
    ["AVA Configuration"] = 1170,
    ["AWS AppConfig Feature Flags-v1"] = 84,
    ["AWS CDK cdk.json"] = 305,
    ["AWS CloudFormation"] = 306,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 307,
    ["AWS Copilot Manifest"] = 1339,
    ["AWS SAM CLI Samconfig"] = 308,
    Acton = 1390,
    ["Adobe UXP Manifest"] = 1233,
    ["Aerleon Network & Service Definitions"] = 27,
    ["Aerleon Policy"] = 28,
    ["Agent Permission Policy"] = 1379,
    ["AgentCore CLI"] = 1380,
    AgentLoopKit = 1381,
    Aider = 1329,
    Air = 30,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1350,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1349,
    ["Airlock Microgateway"] = 46,
    ["Alacritty Configuration"] = 1142,
    ["AlgoVoi Compliance Receipt v1"] = 16,
    ["All Contributors configuration file"] = 1196,
    ["Amazon S3 bucket CORS"] = 18,
    Anodizer = 501,
    ["Ansible Argument Specs"] = 483,
    ["Ansible Collection Galaxy"] = 490,
    ["Ansible Execution Environment"] = 480,
    ["Ansible Inventory"] = 489,
    ["Ansible Meta"] = 481,
    ["Ansible Meta Runtime"] = 482,
    ["Ansible Navigator Configuration"] = 492,
    ["Ansible Playbook"] = 487,
    ["Ansible Requirements"] = 484,
    ["Ansible Rulebook"] = 488,
    ["Ansible Tasks File"] = 486,
    ["Ansible Vars File"] = 485,
    ["Ansible-lint Configuration"] = 491,
    Any = 1261,
    ...
    ["Application list for a WinUtil"] = 1279,
    ArchitectFX = 1284,
    ["Archival editor configuration"] = 65,
    ["Archival object definitions"] = 66,
    ["Archival site configuration"] = 67,
    ["Archival template definition"] = 68,
    ["Are The Types Wrong?"] = 73,
    ["Argo CD"] = 69,
    ["Argo Events"] = 70,
    ["Argo Workflows"] = 71,
    AssemblyScript = 75,
    AsyncAPI = 78,
    ["AsyncAPI Tool File"] = 79,
    ["Atmos Manifests"] = 80,
    ["Aurora Agile Meta-Framework"] = 81,
    AutoAPICase = 1206,
    ["Avro Avsc"] = 82,
    ["Awesome Repositories"] = 83,
    ["Azure Container App template for defining an immutable revision"] = 86,
    ["Azure DevOps extension manifest"] = 89,
    ["Azure Device Update for IoT Hub import manifest"] = 87,
    ["Azure Device Update for IoT Hub update manifest"] = 88,
    ["Azure IoT Edge deployment"] = 92,
    ["Azure IoT Edge deployment template"] = 93,
    ["Azure IoT EdgeAgent deployment"] = 90,
    ["Azure IoT EdgeHub deployment"] = 91,
    ["Azure IoT Operations Wasm Graph Config"] = 1348,
    ["Azure IoT Operations connector metadata"] = 1345,
    ["Azure Landing Zones Library archetype definition"] = 97,
    ["Azure Landing Zones Library archetype override"] = 98,
    ["Azure Landing Zones Library architecture definition"] = 96,
    ["Azure Landing Zones Library metadata"] = 94,
    ["Azure Landing Zones Library policy default values"] = 95,
    ["Azure Pipelines"] = 133,
    ["Azure Static Web Apps CLI configuration file"] = 942,
    ["Azure Static Web Apps configuration file"] = 941,
    BMML = 1367,
    ["BOSH BPM Config"] = 159,
    ["BOSH CPI Config"] = 160,
    ["BOSH Deploy Config"] = 161,
    ["BX CI"] = 182,
    ["Bacon config"] = 10,
    ["Barba-CV"] = 99,
    ["Bashly (bashly.yml)"] = 1200,
    ["Bashly Settings (bashly-settings.yml)"] = 1201,
    Bento = 1366,
    ["Better Code Hub"] = 1111,
    ["Better Scripts"] = 183,
    Bigconfig = 152,
    ["Biome Formatter Config"] = 100,
    ["Bitmovin Encoding Template"] = 1293,
    BizTalkServerApplicationSchema = 1077,
    Bleep = 184,
    ["Block Protocol Metadata"] = 181,
    ["Bluebricks blueprint config"] = 1372,
    ["Boyka Framework"] = 162,
    ["Bpod Finite-State Machine"] = 102,
    Briefcase = 1083,
    ["Build Info"] = 172,
    Buildkite = 174,
    ["Bukkit plugin.yml"] = 173,
    ["BungeeCord plugin.yml"] = 179,
    ["Burnless SRE config"] = 3,
    ["Butane Config"] = 1155,
    C4InterFlow = 1308,
    ["CDK Environment Manager, concrete environment configuration"] = 1332,
    ["CDK Environment Manager, concrete environments definition"] = 1331,
    ["CDK Environment Manager, environment definition"] = 1330,
    ["CGS Card Game Specification (cgs.json)"] = 1238,
    ["CICS TS region tagging"] = 1164,
    ["CICS TS resource import"] = 1165,
    ["CICS TS resource model"] = 1166,
    ["CICS TS resource overrides"] = 1167,
    ["CMake Presets"] = 185,
    ["CNC Codes"] = 208,
    ["CRS WAF test file"] = 1268,
    ["CRS WAF test platform overrides file"] = 1269,
    ["CSS Comb (.csscomb.json)"] = 334,
    ["CSS Lint (.csslintrc)"] = 335,
    ["CSpell (cspell.json)"] = 333,
    ["CVE Record Format"] = 220,
    ["CVX achievements.yaml"] = 226,
    ["CVX competencies.yaml"] = 225,
    ["CVX config.yaml"] = 229,
    ["CVX education.yaml"] = 224,
    ["CVX experience.yaml"] = 223,
    ["CVX keywords.yaml"] = 228,
    ["CVX layout"] = 230,
    ["CVX personal.yaml"] = 221,
    ["CVX referees.yaml"] = 227,
    ["CVX summary.yaml"] = 222,
    CWL = 1244,
    ["Cache Warmup config"] = 186,
    ["Caido Proxy Configuration"] = 1405,
    ["Calqulus pipeline"] = 187,
    ["Camel YAML DSL"] = 188,
    ["Cannon TOML"] = 189,
    Carafe = 190,
    ["Cargo Make"] = 192,
    ["Cargo Manifest"] = 191,
    ["Catalog Info Backstage"] = 193,
    ["Chamaleon environment"] = 1297,
    ["Chamaleon properties"] = 1298,
    ["Chamaleon template"] = 1296,
    Changepacks = 1359,
    Changesets = 317,
    Changie = 194,
    Charmcraft = 195,
    Cheatsheets = 1152,
    ["ChordPro Configuration"] = 197,
    ["Chrome Extension"] = 298,
    ["Chromia Model"] = 198,
    ["Chromia Seeder Module Config"] = 200,
    ["Chromia Seeder Root Config"] = 199,
    ["Cinnamon Spice info.json"] = 110,
    ["CircleCI config.yml"] = 269,
    ["Citation File Format"] = 319,
    ["Citrus test case"] = 202,
    CityJSON = 203,
    ["Claude Code Keybindings"] = 215,
    ["Claude Code Launch Preview"] = 1414,
    ["Claude Code Plugin Manifest"] = 216,
    ["Claude Code Plugin Marketplace"] = 217,
    ["Claude Code Settings"] = 218,
    ["Clawject config"] = 214,
    ["Cloud Foundry Application Manifest"] = 1250,
    ["Cloud Run Spec v1"] = 1274,
    ["Cloud.gov Workshop Configuration"] = 111,
    ["CloudCannon Configuration"] = 116,
    ["CloudCannon Configuration (Collection Structures)"] = 125,
    ["CloudCannon Configuration (Collections)"] = 124,
    ["CloudCannon Configuration (Editables)"] = 123,
    ["CloudCannon Configuration (Inputs)"] = 118,
    ["CloudCannon Configuration (Snippets Definitions)"] = 122,
    ["CloudCannon Configuration (Snippets Imports)"] = 121,
    ["CloudCannon Configuration (Snippets)"] = 120,
    ["CloudCannon Configuration (Structure Value)"] = 119,
    ["CloudCannon Configuration (Structures)"] = 117,
    ["CloudEvents specification"] = 204,
    ["Code Climate"] = 270,
    CodeCV = 114,
    CodeRabbit = 113,
    ["CodeShip Pro services configuration files"] = 287,
    ["CodeShip Pro steps configuration files"] = 288,
    ["Codecov configuration files"] = 286,
    Codex = 278,
    ["Codex Hooks"] = 279,
    ["Codex Plugin Manifest"] = 280,
    ["Codex Skill Metadata"] = 281,
    CodifyCLI = 115,
    Codux = 283,
    ["Cog config file"] = 209,
    ["Commandbox Box.json"] = 210,
    ["Commandbox Server.json"] = 211,
    ["Common Catalog Data"] = 296,
    ["Common Package Specification"] = 212,
    Concord = 1267,
    ["Configu .cfgu files"] = 1255,
    ["Configu .configu file"] = 1256,
    Conjure = 207,
    ["Container Structure Test"] = 1091,
    Containerlab = 1120,
    ["Contextive Glossary"] = 1324,
    ContractGuard = 1121,
    Convex = 206,
    ["Crowdsec collection config"] = 328,
    ["Crowdsec parser config"] = 329,
    ["Crowdsec scenario config"] = 330,
    ["CumulusCI Config"] = 213,
    ["Cursor Agent Environment"] = 1377,
    ["Custom Machinery Machine"] = 1239,
    ["Custom Machinery Recipe"] = 1240,
    ["Cycle Stack File"] = 231,
    CycloneDX = 232,
    ["DWP Exchange - catalogue entry"] = 381,
    ["DWP Exchange - gateway"] = 379,
    ["DWP Exchange - meta"] = 380,
    ["Dart Build Config (dart-build.json)"] = 336,
    ["Dart Test Config (dart-test.json)"] = 337,
    ["DashLord Configuration"] = 338,
    ["Data Contract Specification"] = 339,
    ["Data Product Specification"] = 340,
    ["DataYoga Connections"] = 233,
    ["DataYoga Job"] = 234,
    ["Datadog Continuous Testing"] = 589,
    ["Datadog Service Definition"] = 590,
    ["Datadog Software Catalog"] = 591,
    ["Datahub Ingestion Recipe"] = 1171,
    ["Debian Upstream Metadata file"] = 241,
    DebtLens = 242,
    ["Deck config"] = 243,
    ["Declarative Automation Bundles"] = 1217,
    ["DeepMatch deeplinks spec"] = 244,
    ["Dein Config"] = 245,
    ["Deno Config (deno.json)"] = 347,
    ["Dependency cruiser"] = 246,
    ["DeployStack Configuration"] = 247,
    ["Deployah Configuration"] = 1347,
    ["Deployer Recipe"] = 350,
    ["Deta Spacefile"] = 248,
    ["Detekt Config (detekt.yml)"] = 351,
    ["Devbox Config"] = 249,
    ["Devbox Plugin"] = 250,
    Devfile = 378,
    Devup = 1360,
    DipDup = 1270,
    ["Discord Webhook"] = 352,
    ["DocFx Config (docfx.json)"] = 357,
    ["Docker Desktop extension metadata"] = 354,
    ["Docs MCP Manifest"] = 358,
    Dofigen = 359,
    ["Dolittle Artifacts"] = 360,
    ["Dolittle Bounded Context Configuration"] = 361,
    ["Dolittle Event Horizons Configuration"] = 362,
    ["Dolittle Resources Configuration"] = 363,
    ["Dolittle Server Configuration"] = 364,
    ["Dolittle Tenant Map Configuration"] = 366,
    ["Dolittle Tenants Configuration"] = 365,
    ["Dolittle Topology"] = 367,
    ["DonateCaseBetterCasino menu"] = 1301,
    ["Draugr Saga"] = 346,
    ["Drupal Breakpoints"] = 251,
    ["Drupal Config"] = 263,
    ["Drupal Info"] = 252,
    ["Drupal Layouts"] = 253,
    ["Drupal Libraries"] = 254,
    ["Drupal Links Action"] = 255,
    ["Drupal Links Contextual"] = 256,
    ["Drupal Links Menu"] = 257,
    ["Drupal Links Task"] = 258,
    ["Drupal Migration"] = 259,
    ["Drupal Permissions"] = 260,
    ["Drupal Recipe"] = 261,
    ["Drupal Routing"] = 262,
    ["Drupal Services"] = 264,
    ["Drush site aliases"] = 373,
    ["Dust configuration"] = 376,
    ["Dynamic Bash Aliases (.aliases)"] = 1208,
    ["EAS config"] = 420,
    ["ECA - Editor Code Assistant"] = 383,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1197,
    ["ESLint Suppressions"] = 425,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1344,
    ["EasyVCR .NET"] = 422,
    ["Eidolon Resource"] = 1285,
    ["Elgato Stream Deck"] = 386,
    Elm = 1272,
    ["Embrace Config"] = 1183,
    Emmet = 1273,
    Endurica = 1221,
    ["Enonic XP API descriptor"] = 389,
    ["Enonic XP Admin Extension descriptor"] = 390,
    ["Enonic XP Admin Tool descriptor"] = 391,
    ["Enonic XP Application descriptor"] = 392,
    ["Enonic XP CMS descriptor"] = 393,
    ["Enonic XP Content Type descriptor"] = 394,
    ["Enonic XP Form Fragment descriptor"] = 395,
    ["Enonic XP ID Provider descriptor"] = 396,
    ["Enonic XP Layout descriptor"] = 397,
    ["Enonic XP Macro descriptor"] = 398,
    ["Enonic XP Mixin descriptor"] = 399,
    ["Enonic XP Page descriptor"] = 400,
    ["Enonic XP Part descriptor"] = 401,
    ["Enonic XP Service descriptor"] = 402,
    ["Enonic XP Site descriptor"] = 403,
    ["Enonic XP Style descriptor"] = 404,
    ["Enonic XP Task descriptor"] = 405,
    ["Enonic XP Webapp descriptor"] = 406,
    ["Enterprise Contract Policy Spec"] = 387,
    ["Envelope Team Definition"] = 1389,
    ["Envilder Map File"] = 388,
    ["Erda Pipeline"] = 1246,
    ["Erda Runtime"] = 1247,
    ["Espanso config.yml"] = 1370,
    ["Espanso match.yml"] = 1369,
    Esquio = 408,
    ["Estuary Flow Catalog"] = 1161,
    ["Ethereum ERC1155"] = 1383,
    ["Ethereum ERC721"] = 1382,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 413,
    ["EveryVoice TTS Toolkit Data Configuration"] = 414,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 418,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 417,
    ["EveryVoice TTS Toolkit Text Configuration"] = 415,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 416,
    ["Evolving Resolutive Process notation"] = 1346,
    ["Expo SDK"] = 419,
    ["Expoot app config"] = 421,
    ["F-Droid Data metadata"] = 427,
    ["FasterCI Configuration"] = 134,
    ["Fence configuration"] = 135,
    FiQuS = 431,
    Firebase = 429,
    ["Flatpak Builder Manifest"] = 432,
    ["FlexGet Config"] = 433,
    ["Flow.json Configurations"] = 1243,
    ["Fossa configuration file"] = 440,
    ["Fossa's fossa-deps file"] = 441,
    ["Foundry VTT - Base package Manifest"] = 435,
    ["Foundry VTT - Module Manifest"] = 436,
    ["Foundry VTT - System Data Template"] = 439,
    ["Foundry VTT - System Manifest"] = 437,
    ["Foundry VTT - World Manifest"] = 438,
    ["Foxx Manifest"] = 136,
    ["Freifunk.de Community API"] = 139,
    ["Frogbot Config"] = 140,
    ["G2P Mapping Configuration"] = 448,
    GAMA = 449,
    ["GCP Blueprint Metadata"] = 452,
    Gaspar = 450,
    ["GatewayCore API Gateway"] = 451,
    ["Gemini CLI settings"] = 453,
    ["GeoJSON.json latest"] = 1159,
    GherKing = 1163,
    ["GitHub Action"] = 463,
    ["GitHub Actions typing"] = 1281,
    ["GitHub CLI configuration"] = 464,
    ["GitHub CLI hosts"] = 465,
    ["GitHub Discussion"] = 466,
    ["GitHub Funding"] = 468,
    ["GitHub Issue Template configuration"] = 469,
    ["GitHub Issue Template forms"] = 470,
    ["GitHub Pages Jekyll"] = 471,
    ["GitHub Prompt"] = 467,
    ["GitHub Secret Scanning"] = 472,
    ["GitHub Workflow"] = 473,
    ["GitHub Workflow Template Properties"] = 474,
    ["GitHub automatically generated release notes configuration"] = 475,
    ["GitLab Agent for Kubernetes configuration"] = 1235,
    ["GitLab Duo Workflow"] = 477,
    GitResume = 479,
    GitVersion = 456,
    ["Gitea Issue Template configuration"] = 459,
    ["Gitea Issue Template forms"] = 460,
    Gitleaks = 457,
    ["Gitpod Configuration"] = 478,
    ["Glamour style"] = 454,
    ["GlazeWM settings"] = 1237,
    ["Global Privacy Control"] = 455,
    Goblet = 1216,
    ["Golangci-lint Configuration"] = 494,
    ["Golangci-lint Custom Plugins Configuration"] = 495,
    ["Google Chrome Related Website Sets"] = 430,
    ["Google Cloud Workflows"] = 304,
    ["Google Digital Assetlinks"] = 1325,
    Goreleaser = 499,
    ["Goreleaser Pro"] = 500,
    Goss = 502,
    ["Gradle Build Cache Node"] = 1109,
    ["Gradle Enterprise"] = 1108,
    ["Grafana 5.x Dashboard"] = 503,
    ["GraphQL Code Generator"] = 508,
    ["GraphQL Config"] = 507,
    ["GraphQL Mesh"] = 506,
    ["GroovyLint configuration"] = 509,
    ["Grunt JSHint task"] = 513,
    ["Grunt Watch task"] = 514,
    ["Grunt base task"] = 515,
    ["Grunt clean task"] = 511,
    ["Grunt copy task"] = 510,
    ["Grunt cssmin task"] = 512,
    HEMTT = 1073,
    Hadolint = 1087,
    Hammerkit = 1119,
    ["Hardware Sentry Configuration"] = 1175,
    ["Hashgraph Online Skill Manifest"] = 6,
    ["HashiCorp Vault"] = 516,
    Hatch = 1088,
    Hayson = 518,
    ["Haystack Pipeline"] = 519,
    ["Hazelcast 5 Configuration"] = 520,
    ["Hecate Input Schema"] = 1336,
    ["Helm Chart.lock"] = 266,
    ["Helm Chart.yaml"] = 265,
    ["Helm Unittest Test Suite"] = 267,
    ["Heloisa Assistant Plugins Marketplace"] = 1412,
    ["Hex file"] = 268,
    ["Home Assistant Integration Manifest"] = 522,
    ["Homer dashboard configuration"] = 523,
    ["Hoverfly Simulation"] = 528,
    Hugo = 1151,
    ["Hugo Theme"] = 1150,
    ["Hulak Configuration"] = 531,
    ["Hyperfoil benchmark configuration"] = 530,
    ["IBM Zapp document"] = 532,
    ["IBM zCodeFormatSettings"] = 533,
    ["IMG Catapult PSP"] = 538,
    ["IVMS101 by CODE Protocol"] = 1236,
    ["Infinispan Configuration"] = 540,
    ["Infinispan Server Configuration"] = 541,
    Infrahub = 542,
    Istanbul = 1179,
    ["JDownloader2 crawler multi-rules"] = 556,
    ["JDownloader2 crawler single-rules"] = 555,
    ["JFrog Applications Config"] = 557,
    ["JFrog File Spec"] = 558,
    ["JFrog Pipelines YML DSL"] = 1185,
    ["JMeter DSL cli config"] = 559,
    JReleaser = 562,
    ["JSON Document Transform"] = 570,
    ["JSON Feed"] = 571,
    ["JSON Resume"] = 845,
    ["JSON Schema Draft 2020-12"] = 1053,
    ["JSON Schema Draft 4"] = 1050,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1218,
    ["JSON Schema Draft 7"] = 1051,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1219,
    ["JSON Schema Draft 8 (2019-09)"] = 1052,
    ["JSON-API"] = 569,
    ["JSON-e templates"] = 1116,
    ["JSON-stat 2.0"] = 1046,
    JSONPatch = 573,
    ["JSR Package Config (jsr.json)"] = 563,
    Jarl = 1352,
    Jasmine = 550,
    Jekyll = 551,
    ["Jenkins X Pipelines"] = 552,
    ["Jenkins X Requirements"] = 553,
    Jest = 554,
    Jocker = 560,
    ["Jovo Language Models"] = 561,
    ["Jujutsu (jj) VCS config"] = 1338,
    ["KIMMDY config file"] = 584,
    ["KODE/CI build.yaml"] = 1181,
    ["KSP-AVC"] = 1047,
    ["KSP-CKAN"] = 1048,
    ["KSP-NetKAN"] = 1049,
    KSY = 1248,
    KSail = 446,
    ["KYA Manifest"] = 1249,
    ["Karakum configuration file"] = 442,
    Kas = 576,
    ["Kestra flow file"] = 585,
    ["Keycloak REST API"] = 1188,
    ["Knative Functions - func.yaml"] = 443,
    Knip = 444,
    ["Knip JSONC"] = 445,
    ["Knowledge Unit"] = 593,
    ["Kometa (nightly) config file"] = 587,
    ["Kometa config file"] = 586,
    ["Kong DBLess config"] = 1182,
    KrakenD = 588,
    ["Kubri Configuration"] = 596,
    LOOBin = 612,
    ["Lake configuration file"] = 1341,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 309,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 310,
    ["Landing Zone Accelerator on AWS - Global Config"] = 311,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 312,
    ["Landing Zone Accelerator on AWS - Network Config"] = 313,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 314,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 315,
    ["Landing Zone Accelerator on AWS - Security Config"] = 316,
    ["Lando (landofile)"] = 126,
    ["LangGraph Platform configuration"] = 1260,
    ["Language configuration"] = 1259,
    Lefthook = 601,
    ["Liferay client-extension.yaml"] = 608,
    ["LinkML Metamodel"] = 610,
    Liquibase = 1126,
    ["Liquibase Flow File"] = 1127,
    ["Lively Properties"] = 611,
    ["Lobe AI Agent"] = 128,
    Loki = 129,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 655,
    ["MS2Rescore Configuration"] = 663,
    ["MSTest testconfig.json"] = 664,
    ["Madge configuration"] = 618,
    ["Madness (madness.yml)"] = 1199,
    ["Mado configuration"] = 619,
    ["Maestro Flow"] = 620,
    ["Mail Servers Configuration"] = 1373,
    ["MapEHR Mapping"] = 621,
    Markdownlint = 1130,
    ["Mason Registry"] = 1133,
    ["MegaLinter Custom Flavor"] = 624,
    ["MegaLinter configuration"] = 623,
    ["MegaLinter descriptor"] = 625,
    Melange = 1226,
    ["Meltano project definition"] = 626,
    ["Mergify Configuration"] = 665,
    ["Mermaid config"] = 1,
    ["Metadata for a Bazel module"] = 627,
    ["Metadata for a Cinnamon spice"] = 1277,
    ["Metatype Configuration"] = 628,
    ["MetricsHub Configuration"] = 629,
    ["MetricsHub Connector Configuration"] = 630,
    ["Micro Editor Syntax"] = 1209,
    ["Microsoft Band Web Tile"] = 631,
    ["Microsoft RulesEngine workflow rules"] = 1264,
    ["Microsoft RulesEngine workflow rules list"] = 1265,
    ["Minecraft Custom Main Menu Mod"] = 1227,
    ["Minecraft Data Pack Advancement"] = 633,
    ["Minecraft Data Pack Biome"] = 634,
    ["Minecraft Data Pack Configured Carver"] = 635,
    ["Minecraft Data Pack Damage Type"] = 636,
    ["Minecraft Data Pack Dimension"] = 638,
    ["Minecraft Data Pack Dimension Type"] = 637,
    ["Minecraft Data Pack Item Modifier"] = 639,
    ["Minecraft Data Pack Loot Table"] = 640,
    ["Minecraft Data Pack Metadata"] = 641,
    ["Minecraft Data Pack Predicate"] = 642,
    ["Minecraft Data Pack Recipe"] = 643,
    ["Minecraft Data Pack Tag"] = 644,
    ["Minecraft Data Pack Template Pool"] = 645,
    ["Minecraft Data Pack Trim Material"] = 650,
    ["Minecraft Data Pack Trim Pattern"] = 651,
    ["Minecraft Resource Pack Lang"] = 646,
    ["Minecraft Resource Pack Particle"] = 647,
    ["Minecraft Resource Pack Texture Mcmeta"] = 649,
    ["Minecraft Resourcepack Sounds"] = 648,
    ["MockServer Expectation"] = 657,
    ["MockServer Expectations"] = 658,
    ModuleAssembler = 653,
    ["Monade CLI Stack Configuration"] = 668,
    ["MongoDB Atlas Search Index Definition"] = 1180,
    ["Monika Configuration"] = 1178,
    ["Monoweave Configuration"] = 662,
    ["Motif config"] = 1069,
    MultiQC = 1318,
    ["NOX Framework (Service)"] = 690,
    ["Netin Diagnostic System Template"] = 1137,
    ["Netlify config"] = 671,
    ["Network-as-Code Data Model"] = 672,
    ["Next Gen UI Agent A2A Server Configuration"] = 673,
    ["Next Gen UI Agent Configuration"] = 675,
    ["Next Gen UI Agent MCP Server Configuration"] = 674,
    ["Nightwatch.js"] = 682,
    ["Nika workflow"] = 687,
    ["Node.js configuration"] = 1074,
    ["NueJS configuration file"] = 695,
    ["Nuitka Package Config"] = 1241,
    ["Nullstone config"] = 697,
    ["ODGS Data Rules"] = 704,
    ["ODGS Ontology Graph"] = 705,
    ["ODGS Standard Metrics"] = 703,
    ["OKF Graph"] = 1413,
    ["ONe's changelog entry"] = 719,
    ["ONe's service descriptor"] = 718,
    ["ORT Server repository environment configuration"] = 730,
    ["OSCAL Assessment Plan (AP)"] = 732,
    ["OSCAL Assessment Results (AR)"] = 733,
    ["OSCAL Catalog"] = 734,
    ["OSCAL Component Definition (CDef)"] = 735,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 736,
    ["OSCAL Profile"] = 737,
    ["OSCAL System Security Plan (SSP)"] = 738,
    ["OSS Review Toolkit configuration"] = 739,
    ["OSS Review Toolkit curation"] = 740,
    ["OSS Review Toolkit package configuration"] = 741,
    ["OSS Review Toolkit project package manager definition"] = 742,
    ["OSS Review Toolkit repository configuration"] = 743,
    ["OSS Review Toolkit resolutions"] = 744,
    ["October CMS columns"] = 701,
    ["October CMS fields"] = 702,
    ["Oh My Posh"] = 707,
    Okteto = 708,
    ["Ona Tasks and Services"] = 710,
    Opctl = 1072,
    ["Open Data Contract Standard (ODCS)"] = 723,
    ["Open Data Product Standard (ODPS)"] = 724,
    ["Open Know-How"] = 1323,
    ["Open Pentest Format"] = 725,
    OpenDecree = 1387,
    ["OpenDecree Configuration"] = 1388,
    ["OpenRewrite Resource"] = 721,
    OpenSRM = 726,
    OpenStatus = 1334,
    ["OpenTelemetry Declarative Configuration"] = 722,
    ["OpenUtau character yaml"] = 715,
    ["OpenUtau ustx"] = 716,
    ["OpenWeather Current Weather API"] = 1115,
    ["OpenWeather Road Risk API"] = 1114,
    ["Ory Hydra configuration"] = 529,
    ["Ory Keto configuration"] = 592,
    ["Ory Kratos configuration"] = 731,
    ["Ory Oathkeeper configuration"] = 699,
    ["Outblocks App configuration"] = 728,
    ["Outblocks database table"] = 729,
    ["Outblocks project configuration"] = 727,
    PDM = 752,
    POPxf = 764,
    ["POPxf Correlations"] = 765,
    ["PRML manifest"] = 772,
    Packer = 748,
    PactSpec = 749,
    Panache = 750,
    Pantsbuild = 1195,
    ["Paper paper-plugin.yml"] = 751,
    ["Pipeline component"] = 1128,
    ["Platform.sh application"] = 12,
    ["Platform.sh routes"] = 13,
    ["Platform.sh services"] = 14,
    ["Plex Prerolls"] = 762,
    ["PocketMine plugin.yml"] = 759,
    ["Podman Desktop Extension"] = 1407,
    ["Postman collection"] = 768,
    ["Power Pages Configuration"] = 1335,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1280,
    ["ProActions AI-Kit Configuration"] = 780,
    ["ProActions AI-Kit Configuration for Menus"] = 782,
    ["ProActions AI-Kit Configuration for Sections"] = 784,
    ["ProActions AI-Kit Configuration for Services"] = 781,
    ["ProActions AI-Kit Configuration for Steps"] = 785,
    ["ProActions AI-Kit Configuration for Templates"] = 783,
    ["Problem object RFC9457"] = 1224,
    ["Problem package format"] = 786,
    ["Problem package generators"] = 787,
    ["Problem package submissions"] = 788,
    ["Problem package test group metadata"] = 789,
    Pterodactyl = 1174,
    ["Pull Request Labeler"] = 806,
    Pulumi = 814,
    ["PyGTA Config"] = 810,
    PyProject = 815,
    Pylock = 1326,
    Pyright = 816,
    ["Python script metadata"] = 1320,
    ["QType AI DSL"] = 819,
    Qgoda = 818,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1399,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1397,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1403,
    ["Qlik Talend Cloud Pipeline - Project"] = 1395,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1398,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1400,
    ["Qlik Talend Cloud Pipeline - Task"] = 1396,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1402,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1401,
    Qodana = 1147,
    ["Qt Creator workspace file"] = 1257,
    ["Quali Torque Blueprint Spec 2"] = 1172,
    ["QueryFirst config file"] = 1191,
    ["QuikRun Configuration"] = 1404,
    ["Qwen Code Settings"] = 1384,
    ["RKE Cluster Configuration JSON"] = 1125,
    ["RKE Cluster Configuration YAML"] = 1124,
    RadioHound = 809,
    ["Raid Profile"] = 1385,
    ["Raid Repo Configuration"] = 1386,
    Railpack = 821,
    Railway = 820,
    ["Rancher Fleet"] = 811,
    ["Rattler-build"] = 822,
    Ray = 1086,
    ["Read the Docs"] = 813,
    ["Red-DiscordBot Cog"] = 829,
    ["Red-DiscordBot Cog Repo"] = 830,
    ["Red-DiscordBot Trivia"] = 831,
    ["Releasaurus Config"] = 9,
    ReleaseKit = 8,
    ["Render Blueprints"] = 1123,
    RenderCV = 849,
    Renovate = 846,
    ["Renovate global configuration"] = 847,
    ["Renovate inherited configuration"] = 848,
    ["Replit config"] = 837,
    Restate = 1313,
    ["Revel Digital Gadget Definition File"] = 1337,
    RoadRunner = 851,
    ["Robust Station Image"] = 1343,
    Rockcraft = 852,
    ["Roo Coder Custom Modes"] = 853,
    Rubocop = 842,
    ["Rudder techniques"] = 1231,
    Ruff = 843,
    ["Rust Project"] = 844,
    ["Rust toolchain"] = 858,
    ["SDMX data message"] = 885,
    ["SDMX metadata message"] = 884,
    ["SDMX structure message"] = 883,
    ["SIL Kit Participant Configuration"] = 896,
    ["SIL Kit Registry Configuration"] = 897,
    ["SPDX 2.3"] = 939,
    SWADL = 955,
    ["Safebox Config"] = 1186,
    ["Sapphire CLI Config"] = 861,
    ["SauceCTL Configuration"] = 1134,
    Scarb = 881,
    ["Schema Catalog"] = 876,
    ["Scoop manifest"] = 882,
    ["Secure SDLC Evidence Bundle"] = 886,
    ["Semantic Data Fabric (SDF) file"] = 887,
    ["Semgrep Rule"] = 889,
    ["Serenity Code Generator (Sergen)"] = 890,
    ["Serverless Framework Configuration"] = 1141,
    ["Serverless Workflow"] = 1143,
    ["Settings for a Cinnamon spice"] = 1276,
    ["Settings.paf"] = 892,
    ["Shopware 6 Configuration"] = 1144,
    ["Shopware CLI Extension Store Configuration"] = 1145,
    ["Shopware CLI Project Store Configuration"] = 1146,
    ["Sigma Detection Rule"] = 894,
    ["SigmaCV CV"] = 4,
    ["Sigrid scope configuration file"] = 895,
    ["SkyPilot Task JSON"] = 1232,
    ["Slack app manifest"] = 902,
    ["Slang Server Configuration"] = 1411,
    Snapcraft = 904,
    ["Solarxy project config"] = 907,
    Solidarity = 908,
    ["Solution filters"] = 909,
    ["Source Maps v3"] = 910,
    Sourcery = 911,
    ["Spack bootstrap.yaml"] = 912,
    ["Spack cdash.yaml"] = 913,
    ["Spack ci.yaml"] = 914,
    ["Spack compilers.yaml"] = 915,
    ["Spack concretizer.yaml"] = 916,
    ["Spack config.yaml"] = 917,
    ["Spack definitions.yaml"] = 918,
    ["Spack develop.yaml"] = 919,
    ["Spack env_vars.yaml"] = 920,
    ["Spack environment"] = 926,
    ["Spack include.yaml"] = 921,
    ["Spack mirrors.yaml"] = 922,
    ["Spack modules.yaml"] = 923,
    ["Spack packages.yaml"] = 924,
    ["Spack repos.yaml"] = 925,
    ["Spack toolchains.yaml"] = 927,
    ["Spack upstreams.yaml"] = 928,
    ["Spack view.yaml"] = 929,
    ["Speakeasy Generation Config File"] = 933,
    ["Speakeasy Lint Configuration File"] = 930,
    ["Speakeasy Test Generation Configuration File"] = 931,
    ["Speakeasy Workflow File"] = 932,
    SpecIF = 934,
    ["Specmatic Configuration"] = 935,
    ["Specpin spec file"] = 2,
    ["Sponge Mixin configuration"] = 936,
    ["Spotlight Ruleset"] = 937,
    StackBlitz = 943,
    ["StackHawk Scanner Configuration"] = 1140,
    Stale = 944,
    Starfish = 945,
    ["Starlake Data Pipeline"] = 1112,
    Starship = 946,
    ["Statamic Blueprint"] = 947,
    ["Stella configuration file"] = 948,
    ["Streamlit configuration file"] = 949,
    ["Stryker Mutator"] = 952,
    ["StyleCop Analyzers Configuration"] = 953,
    ["Stylelint (.stylelintrc)"] = 954,
    ["Stylua Config"] = 1327,
    ["Sublime Syntax"] = 1187,
    ["Subsquid squid manifest"] = 1234,
    ["Swagger API 2.0"] = 956,
    ["Synadia Connect Component"] = 957,
    TSON = 995,
    TSTyche = 996,
    ["TYPO3 Vendor Bundler config"] = 1002,
    ["Tab data for a LinUtil"] = 1283,
    ["Tab list for a LinUtil"] = 1282,
    Tach = 958,
    ["Tach Domain"] = 959,
    Talhelper = 961,
    ["Talisman configuration"] = 962,
    Taplo = 1328,
    ["Taskfile config"] = 1117,
    Taurus = 963,
    Tauticord = 964,
    ["Tekton Pipeline"] = 1356,
    ["Tekton PipelineRun"] = 1357,
    ["Tekton Task"] = 1354,
    ["Tekton TaskRun"] = 1355,
    Telefonistka = 1314,
    ["Terrateam config"] = 1340,
    ["TestEnvironment.json"] = 976,
    ["TextMate Grammar"] = 975,
    Threagile = 970,
    ["Tier.run pricing.json"] = 967,
    Tikibase = 968,
    Tombi = 973,
    ["Traefik v2"] = 979,
    ["Traefik v2 File Provider"] = 980,
    ["Traefik v3"] = 981,
    ["Traefik v3 File Provider"] = 982,
    ["Travis CI (.travis.yml)"] = 978,
    Treefmt = 505,
    Trident = 1310,
    Trivy = 985,
    ["TrueScript for *.tscript files"] = 986,
    ["Tugboat QA config.yml"] = 1307,
    TunnelHub = 1222,
    Turborepo = 977,
    Tycho = 1271,
    Tye = 1148,
    ["Tyk Gateway - Open Source v5.7+"] = 1319,
    ["UET BuildConfig.json"] = 1192,
    ["UI5 Manifest"] = 1008,
    ["UNCORS configuration"] = 1013,
    ["UTAM Page Object"] = 1011,
    ["Ubuntu Server Autoinstall"] = 1006,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1311,
    ["Uniswap Token List"] = 1097,
    ["Universal Schedule Format"] = 1014,
    ["Unreal Engine Uplugin"] = 1193,
    ["Unreal Engine Uproject"] = 1194,
    ["UpCloud CLI (upctl) configuration"] = 1312,
    ["Updatecli Compose"] = 1156,
    ["Updatecli Policy Manifest"] = 1157,
    ["Updatecli Policy Metadata"] = 1158,
    Uplift = 1190,
    ["Upsun config"] = 11,
    ["User Journey Map"] = 1122,
    V2Ray = 1162,
    ["VSCode Code Snippets"] = 292,
    ["VSIX CLI publishing"] = 1033,
    Vector = 1016,
    ["Vela Pipeline Configuration"] = 1019,
    Vercel = 291,
    ["Version Bumper config"] = 1022,
    Vespertide = 1361,
    ["Vespertide Migration"] = 1362,
    ["Vespertide Model"] = 1363,
    ["Viash Component Config"] = 1316,
    ["Viash Package Config"] = 1317,
    Visivo = 1220,
    Vogi = 1027,
    ["WP-CLI"] = 1043,
    Wake = 1309,
    ["Waku Config"] = 1286,
    ["Web App Manifest"] = 1039,
    ["Web types"] = 1042,
    WebExtensions = 1038,
    ["Webman package recipe"] = 1168,
    ["Windows Package Manager Installer Manifest"] = 1094,
    ["Windows Package Manager Locale Manifest"] = 1095,
    ["Windows Package Manager Singleton Manifest"] = 1093,
    ["WireMock CLI import configuration"] = 1292,
    ["WireMock CLI local service configuration"] = 1291,
    ["WireMock message stub mapping"] = 1290,
    ["WireMock stub mapping"] = 1289,
    ["Woodpecker pipeline config"] = 1136,
    ["Wrangler CLI"] = 1044,
    ["XenForo add-on manifest"] = 1045,
    ["Xstate Machine"] = 1154,
    ["Yandex Workflow Language"] = 1278,
    ["Yarn Config (.yarnrc.yml)"] = 1110,
    ["Yippee-Ki-JSON configuration YML"] = 1101,
    ["YouTrack App"] = 1275,
    ["Zarf Package Configuration"] = 1342,
    ["Zerops import file"] = 1263,
    ["Zola Configuration"] = 1353,
    abtop = 32,
    act3 = 1391,
    actionlint = 42,
    ["aerleon.yml"] = 26,
    ["amplify.yml"] = 19,
    ["amxx-builder manifest"] = 1406,
    ["angular.json"] = 47,
    apko = 1225,
    ...
    ["arc.json"] = 64,
    ["architect.yml"] = 63,
    ["artifacthub-repo.yml"] = 72,
    ["asm-lsp"] = 74,
    ["ast-grep rules"] = 77,
    ["ast-grep sgconfig.yml"] = 76,
    ["azure.yaml"] = 85,
    ["babelrc.json"] = 142,
    ["bamboo-spec"] = 146,
    basedpyright = 144,
    ["bashly-strings.yml"] = 1202,
    ["batect.yml"] = 145,
    ["beef-database-codegen"] = 147,
    ["beef-database-v5-codegen"] = 149,
    ["beef-entity-codegen"] = 148,
    ["beef-entity-v5-codegen"] = 150,
    ["behat.yml"] = 163,
    ["bigquery-table"] = 151,
    ["bioimageio resource description"] = 1242,
    ["bitbucket-pipelines"] = 153,
    bitrise = 154,
    ["bitrise-step"] = 155,
    ["block.json"] = 180,
    ["bottom configuration"] = 101,
    ["bower.json"] = 157,
    ["bozr.suite.json"] = 167,
    bpkg = 1203,
    ["browser.i18n.json"] = 168,
    ["browsh configuration"] = 169,
    bucklescript = 170,
    ["buf.gen.yaml"] = 104,
    ["buf.lock"] = 105,
    ["buf.plugin.yaml"] = 106,
    ...
    ["build-changelog"] = 171,
    ["bun.lock"] = 176,
    ["bundleconfig.json"] = 177,
    ["bunfig.toml"] = 178,
    ["cargo-mutants-config.yaml"] = 109,
    ["cargo-nextest repository configuration"] = 676,
    ["cargo-nextest user configuration"] = 677,
    ["ccmod.json"] = 1287,
    changelogging = 1254,
    ["chezmoi configuration"] = 196,
    ["chisel-slices.json"] = 318,
    ["chrome-extension-locales-messages.json"] = 299,
    ["chutzpah.json"] = 300,
    cibuildwheel = 201,
    ["clang-format (.clang-format)"] = 1160,
    ["clang-tidy"] = 274,
    clangd = 273,
    clib = 275,
    ["cloud-init: cloud-config userdata"] = 277,
    ["cloud-sdk-pipeline-configuration"] = 302,
    ["cloudbuild.json"] = 303,
    cloudify = 276,
    cmakefmt = 219,
    ["cmdx.yaml"] = 112,
    ...
    ["commands.json"] = 295,
    ["commit-check"] = 321,
    ["commitlint (.commitlintrc)"] = 1096,
    ["committed.toml"] = 322,
    ["compile_commands.json"] = 294,
    ["compilerconfig.json"] = 293,
    ["completely.yml"] = 1198,
    ["component-detection-manifest.json"] = 325,
    ["component.json"] = 324,
    ["composer.json"] = 323,
    ["conda-forge"] = 205,
    ["config.yaml"] = 812,
    ["contentmanifest.json"] = 301,
    ["contribute.json"] = 326,
    ["cosmos.config.json"] = 297,
    ["crowdin.yml"] = 327,
    ["ctfd-setup configuration file"] = 1299,
    ["custom-elements.json"] = 1212,
    ["cypress.json"] = 331,
    ["dacier.yml"] = 1394,
    ["datalogic-scan2deploy-android"] = 341,
    ["datalogic-scan2deploy-ce"] = 342,
    ["dbt Dependencies"] = 236,
    ["dbt Packages"] = 238,
    ["dbt Project"] = 237,
    ["dbt Selectors"] = 239,
    ["dbt YAML files"] = 240,
    ...
    ["ddev-global"] = 343,
    ["ddev-project"] = 344,
    ["debugsettings.json"] = 345,
    ["dependabot-v2.json"] = 349,
    ["dependabot.json"] = 348,
    ["deployed-cli"] = 1153,
    ["devcontainer-feature.json"] = 285,
    ["devcontainer.json"] = 284,
    devinit = 1103,
    ["devspace.yaml"] = 1176,
    djlint = 1104,
    ["docker bake"] = 355,
    ["docker sequencer"] = 356,
    ["docker-compose.yml"] = 1102,
    ["dockerd.json"] = 353,
    ["dotnet Release Index manifest"] = 368,
    ["dotnet-tools.json"] = 369,
    ["dotnetcli.host.json"] = 370,
    ["dprint.json"] = 371,
    ["drone.json"] = 372,
    ["dss-2.0.0.json"] = 374,
    ["dstack configuration"] = 375,
    ["dtool dataset metadata"] = 1294,
    ["dvc.yaml"] = 377,
    ["ecosystem.json"] = 382,
    ["editorconfig-checker"] = 384,
    eksctl = 385,
    ["electron-builder configuration file"] = 411,
    ["epr-manifest.json"] = 410,
    ["estampo.toml"] = 409,
    ["evcc.yaml"] = 412,
    ["ezd task runner"] = 423,
    ["fabric.mod.json"] = 426,
    ["first-timers-bot"] = 434,
    ["flagd flag configuration"] = 137,
    ["fly.io Configuration"] = 138,
    fulibWorkflows = 1135,
    ["function.json"] = 447,
    ["gRPC API Gateway & OpenAPI Config"] = 21,
    ["gematik health care insurance list"] = 1305,
    ["gematik health care patient list"] = 1302,
    ["gematik health care provider institution list"] = 1304,
    ["gematik health care provider list"] = 1303,
    ["gematik tiger test environment configuration"] = 1306,
    ["gh-dash"] = 461,
    ["gha-doctor"] = 462,
    ["git-cliff"] = 458,
    ["git-town.toml"] = 1351,
    ["gitlab-ci"] = 476,
    ["global.json"] = 493,
    ["go-feature-flag Flag Configuration"] = 497,
    ["gojo.yaml"] = 498,
    gollama = 496,
    ["hassette.toml"] = 521,
    ["haxelib.json"] = 517,
    ...
    ["ide.host.json"] = 534,
    ["ifstate.yaml"] = 535,
    ["imageoptimizer.json"] = 536,
    ["importmap.json"] = 539,
    ["index.toml (packwiz)"] = 1408,
    instant_python_config = 543,
    instant_python_custom_project = 544,
    intlayer = 545,
    ["ioBroker Configuration"] = 546,
    ["ioBroker JSON UI"] = 547,
    ["ioBroker Package manifest"] = 548,
    ["ixpect.conf.yaml"] = 549,
    ["ize.toml"] = 1189,
    ["jsconfig.json"] = 574,
    ["jscpd Configuration"] = 1173,
    jsdoc = 1085,
    ["k3d.yaml"] = 575,
    ["k9s aliases.yaml"] = 577,
    ["k9s cluster-config.yaml"] = 579,
    ["k9s config.yaml"] = 578,
    ["k9s hotkeys.yaml"] = 580,
    ["k9s plugins.yaml"] = 581,
    ["k9s skin.yaml"] = 582,
    ["k9s views.yaml"] = 583,
    ["kind cluster"] = 597,
    ["kontinuous-config.yaml"] = 595,
    ["kontinuous-values.yaml"] = 594,
    ["kustomization.yaml"] = 598,
    ["label-commenter-config.yml"] = 599,
    ["latexindent configuration"] = 127,
    ["launchsettings.json"] = 600,
    lazydocker = 1211,
    lazygit = 1210,
    ["lego.json"] = 602,
    ["lerna.json"] = 603,
    ["lgtm.yml"] = 604,
    ["liblab.config.json"] = 605,
    ["libman.json"] = 606,
    ["license-report-config.json"] = 607,
    ["linkinator.config.json"] = 609,
    ["lint-staged (.lintstagedrc)"] = 1062,
    ["local.settings.json"] = 614,
    ["localazy.json"] = 615,
    ["lotus.yaml"] = 613,
    ["lsd colors"] = 131,
    ["lsd config"] = 130,
    ...
    lychee = 1061,
    ["macro.json"] = 1177,
    ["markdown-link-check"] = 1131,
    maturin = 1132,
    mboats = 1139,
    memnex = 1392,
    ["micro-settings.json"] = 1204,
    ["mimetypes.json"] = 632,
    ["mirrord config"] = 1065,
    ["misata.yaml"] = 1064,
    mise = 1066,
    ["mkdocs.yml"] = 652,
    ["mockd.yaml"] = 656,
    ["mod.pw.toml (packwiz)"] = 1409,
    ["modelparams.dev Model"] = 659,
    ["models CLI"] = 660,
    ["monospace.yml"] = 661,
    ["moon.yml"] = 1288,
    ["mprocs Configuration file"] = 1258,
    ["mrdocs.yml"] = 654,
    ["mta.yaml"] = 1067,
    ["mtad.yaml"] = 1068,
    ["mycode.json"] = 669,
    nFPM = 681,
    ["napari plugin manifest"] = 670,
    neoload = 1080,
    ["nest-cli"] = 684,
    ["nexus-rpc-gen"] = 1378,
    ["nf-core module environment.yml"] = 678,
    ["nf-core module meta.yml"] = 679,
    ["nf-core subworkflow meta.yml"] = 680,
    ["ninjs (News in JSON)"] = 683,
    ["nitro.json"] = 1079,
    ["nixd configuration"] = 1230,
    ["nlu.json"] = 685,
    ["nodemon.json"] = 688,
    ["noodl config"] = 1138,
    ["notebook.mod.json"] = 689,
    now = 1075,
    ["npm-badges"] = 692,
    ["nswag.json"] = 696,
    ntangle = 698,
    ["nuclei-template.yaml"] = 693,
    ["nuget-project.json"] = 694,
    ["ocelot.json"] = 700,
    ogen = 706,
    ["omnisharp.json"] = 709,
    openHAB = 1364,
    ...
    oxfmt = 1374,
    oxlint = 1375,
    ["pack.toml (packwiz)"] = 1410,
    ["package.json"] = 745,
    ["package.manifest"] = 747,
    ["package.yaml"] = 746,
    ["partial-black.json"] = 164,
    ["partial-fastapi.json"] = 165,
    ["partial-pixi.json"] = 757,
    ["partial-scheduled.json"] = 166,
    ["pattern.json"] = 755,
    ["petstore-v1.0"] = 1184,
    pgap_yaml_input_reader = 753,
    pgrls = 754,
    pgxgen = 1368,
    pitcms = 1371,
    ["pixi.toml"] = 756,
    ["plagiarize-me.yaml"] = 761,
    ["plagiarize.yaml"] = 760,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1295,
    ["podbard.yaml"] = 763,
    ["portman.json"] = 766,
    ["prefect.toml"] = 775,
    ["prefect.yaml"] = 776,
    ...
    ["prettierrc.json"] = 778,
    ["prisma.yml"] = 779,
    ["project-1.0.0-beta3.json"] = 791,
    ["project-1.0.0-beta4.json"] = 792,
    ["project-1.0.0-beta5.json"] = 793,
    ["project-1.0.0-beta6.json"] = 794,
    ["project-1.0.0-beta8.json"] = 795,
    ["project-1.0.0-rc1.json"] = 796,
    ["project-1.0.0-rc2.json"] = 797,
    ["project.json"] = 790,
    ["project.owasp.yaml"] = 798,
    ["prometheus-alertmanager.json"] = 802,
    ["prometheus.json"] = 799,
    ["prometheus.rules.json"] = 800,
    ["prometheus.rules.test.json"] = 801,
    ["proxies.json"] = 803,
    ["publiccode.yml"] = 804,
    ["pubspec.yaml"] = 805,
    ["pyrseas-0.8.json"] = 808,
    pytest = 817,
    ["quilt.mod.json"] = 1205,
    ["rc3 auth"] = 823,
    ["rc3 collection"] = 824,
    ...
    ["rc3 settings"] = 828,
    ["registry.yaml"] = 60,
    ["release drafter"] = 1081,
    ["release-hub.json"] = 7,
    ["release-please-config.json"] = 833,
    ["release-please-manifest.json"] = 834,
    ["release-plz.toml"] = 835,
    ["renv.lock"] = 850,
    ["repo-settings-as-code"] = 838,
    ["reposets Configuration"] = 839,
    ["reposets Credentials"] = 840,
    ["revola.json"] = 5,
    ["rivet.json"] = 1229,
    ["rivet.yaml (legacy)"] = 1228,
    rumdl = 855,
    runny = 854,
    runspec = 1393,
    rustfmt = 856,
    ...
    samt = 859,
    samtrc = 860,
    ["sarif-1.0.0.json"] = 862,
    ["sarif-2.0.0.json"] = 863,
    ["sarif-2.1.0"] = 873,
    ["sarif-2.1.0-rtm.2"] = 864,
    ["sarif-2.1.0-rtm.3"] = 866,
    ["sarif-2.1.0-rtm.4"] = 868,
    ["sarif-2.1.0-rtm.5"] = 870,
    ["sarif-2.1.0-rtm.6"] = 871,
    ["sarif-external-property-file-2.1.0"] = 874,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 865,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 867,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 869,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 872,
    ["scalingo.json configuration"] = 875,
    ["schema.org - Action"] = 877,
    ["schema.org - ContactPoint"] = 878,
    ["schema.org - Place"] = 879,
    ["schema.org - Thing"] = 880,
    ["secrethub.yml"] = 1207,
    ["semantic-release"] = 888,
    ["servicehub.config.json"] = 1056,
    ["servicehub.service.json"] = 1055,
    ["settings.job"] = 891,
    ["sfdx-hardis configuration"] = 893,
    ["shard.yml"] = 1245,
    ["size-limit configuration"] = 898,
    ["skaffold.yaml"] = 1129,
    ["skill-map plugin extension manifest"] = 899,
    ["skill-map project settings"] = 900,
    ["skill-map provider kind"] = 901,
    ["skyuxconfig.json"] = 903,
    ["snowflake-config"] = 905,
    ["snowflake-connections"] = 906,
    ["spicepod.yaml"] = 1266,
    ["sqlc configuration"] = 940,
    ["stripe-app-local.json"] = 951,
    ["stripe-app.json"] = 950,
    swcrc = 1113,
    ["task.json"] = 960,
    taskcat = 1076,
    ["template.json"] = 965,
    ["templatsources.json"] = 966,
    ["text2confl config"] = 1376,
    ["theme.json"] = 969,
    ["tizen_workspace.json"] = 971,
    tldr = 972,
    ["tm_devices configuration file"] = 1333,
    tmuxinator = 1059,
    tox = 974,
    ["transcend.yml"] = 983,
    ["tree-sitter grammar.json"] = 504,
    ["trime.yaml"] = 984,
    ["trunk.yaml"] = 987,
    ["ts-force-config.json"] = 993,
    tsbuild = 988,
    ["tsconfig.json"] = 989,
    ["tsd.json"] = 990,
    ["tsdoc.json"] = 991,
    ...
    v8r = 1037,
    vcluster = 1252,
    ["vcpkg configuration file"] = 290,
    ["vcpkg manifest file"] = 289,
    ["vega-lite.json"] = 1018,
    ["vega.json"] = 1017,
    ["venvironment.yaml"] = 1020,
    ["venvplus.yaml"] = 1021,
    version = 1315,
    ["version.json"] = 1023,
    ["vhwdebugger-binding.yaml"] = 1025,
    ["vim-addon-info"] = 1026,
    ["vs-2017.3.host.json"] = 1029,
    ["vs-nesting.json"] = 1030,
    ["vsls.json"] = 1028,
    ["vss-extension.json"] = 1034,
    vtcfg = 1321,
    ["vtesttree.yaml"] = 1035,
    ["vtestunit.yaml"] = 1036,
    ["warp-keysets.json"] = 1213,
    ["warp-themes.json"] = 1214,
    ["warp-workflows.json"] = 1215,
    ["webhint.io"] = 1169,
    ["webjobpublishsettings.json"] = 1041,
    ["webjobs-list.json"] = 1040,
    ["well-known-fursona"] = 1253,
    ["xs-app.json"] = 1071,
    ["xunit.runner.json"] = 1054,
    yamlfmt = 1098,
    yamllint = 1099,
    ["yap.json"] = 1100,
    ["zerops.yml"] = 1262,
