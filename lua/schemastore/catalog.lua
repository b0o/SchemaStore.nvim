...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1086,
    [".nodehawkrc"] = 698,
    [".npmpackagejsonlintrc"] = 703,
    [".omletrc"] = 1267,
    [".phrase.yml"] = 785,
    [".phraseapp.yml"] = 786,
    [".pmbot.yml"] = 770,
    [".postcssrc"] = 779,
    [".powerpages-web-template-manifest"] = 781,
    [".pre-commit-config.yml"] = 782,
    [".pre-commit-hooks.yml"] = 783,
    [".putout.json"] = 819,
    [".rehyperc"] = 844,
    [".remarkrc"] = 848,
    [".sprite files"] = 950,
    ...
    AIConfig = 46,
    ["AMX Muse Program Descriptor"] = 1316,
    ["API Builder"] = 1122,
    ["AVA Configuration"] = 1186,
    ["AWS AppConfig Feature Flags-v1"] = 85,
    ["AWS CDK cdk.json"] = 313,
    ["AWS CloudFormation"] = 314,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 315,
    ["AWS Copilot Manifest"] = 1355,
    ["AWS SAM CLI Samconfig"] = 316,
    Acton = 1409,
    ["Adobe UXP Manifest"] = 1249,
    ["Aerleon Network & Service Definitions"] = 28,
    ["Aerleon Policy"] = 29,
    ["Agent Permission Policy"] = 1395,
    ["AgentCore CLI"] = 1396,
    ["AgentCtl MCP"] = 1398,
    ["AgentCtl config"] = 1397,
    ["AgentCtl permissions"] = 1399,
    AgentLoopKit = 1400,
    Aider = 1345,
    Air = 31,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1366,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1365,
    ["Airlock Microgateway"] = 47,
    ["Alacritty Configuration"] = 1158,
    ["AlgoVoi Compliance Receipt v1"] = 17,
    ["All Contributors configuration file"] = 1212,
    ["Amazon S3 bucket CORS"] = 19,
    Anodizer = 510,
    ["Ansible Argument Specs"] = 492,
    ["Ansible Collection Galaxy"] = 499,
    ["Ansible Execution Environment"] = 489,
    ["Ansible Inventory"] = 498,
    ["Ansible Meta"] = 490,
    ["Ansible Meta Runtime"] = 491,
    ["Ansible Navigator Configuration"] = 501,
    ["Ansible Playbook"] = 496,
    ["Ansible Requirements"] = 493,
    ["Ansible Rulebook"] = 497,
    ["Ansible Tasks File"] = 495,
    ["Ansible Vars File"] = 494,
    ["Ansible-lint Configuration"] = 500,
    Any = 1277,
    ...
    ["Application list for a WinUtil"] = 1295,
    ["ArchSmith diagram IR"] = 1434,
    ArchitectFX = 1300,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1364,
    ["Azure IoT Operations connector metadata"] = 1361,
    ...
    ["Azure Pipelines"] = 134,
    ["Azure Static Web Apps CLI configuration file"] = 954,
    ["Azure Static Web Apps configuration file"] = 953,
    BMML = 1383,
    ["BOSH BPM Config"] = 160,
    ["BOSH CPI Config"] = 161,
    ...
    ["Bacon config"] = 11,
    ["Barba-CV"] = 100,
    ["Bashly (bashly.yml)"] = 1216,
    ["Bashly Settings (bashly-settings.yml)"] = 1217,
    Bento = 1382,
    ["Better Code Hub"] = 1127,
    ["Better Scripts"] = 186,
    Bigconfig = 153,
    ["Biome Formatter Config"] = 101,
    ["Bitmovin Encoding Template"] = 1309,
    BizTalkServerApplicationSchema = 1093,
    Bleep = 187,
    ["Block Protocol Metadata"] = 184,
    ["Bluebricks blueprint config"] = 1388,
    ["Boyka Framework"] = 165,
    ["Bpod Finite-State Machine"] = 103,
    Briefcase = 1099,
    ["Build Info"] = 175,
    Buildkite = 177,
    ["Bukkit plugin.yml"] = 176,
    ["BungeeCord plugin.yml"] = 182,
    ["Burnless SRE config"] = 4,
    ["Butane Config"] = 1171,
    C4InterFlow = 1324,
    ["CDK Environment Manager, concrete environment configuration"] = 1348,
    ["CDK Environment Manager, concrete environments definition"] = 1347,
    ["CDK Environment Manager, environment definition"] = 1346,
    ["CGS Card Game Specification (cgs.json)"] = 1254,
    ["CICS TS region tagging"] = 1180,
    ["CICS TS resource import"] = 1181,
    ["CICS TS resource model"] = 1182,
    ["CICS TS resource overrides"] = 1183,
    ["CMake Presets"] = 188,
    ["CNC Codes"] = 211,
    ["CRS WAF test file"] = 1284,
    ["CRS WAF test platform overrides file"] = 1285,
    ["CSS Comb (.csscomb.json)"] = 343,
    ["CSS Lint (.csslintrc)"] = 344,
    ["CSpell (cspell.json)"] = 342,
    ["CVE Record Format"] = 223,
    ["CVX achievements.yaml"] = 229,
    ["CVX competencies.yaml"] = 228,
    ["CVX config.yaml"] = 232,
    ["CVX education.yaml"] = 227,
    ["CVX experience.yaml"] = 226,
    ["CVX keywords.yaml"] = 231,
    ["CVX layout"] = 233,
    ["CVX personal.yaml"] = 224,
    ["CVX referees.yaml"] = 230,
    ["CVX summary.yaml"] = 225,
    CWL = 1260,
    ["Cache Warmup config"] = 189,
    ["Caido Proxy Configuration"] = 1424,
    ["Calqulus pipeline"] = 190,
    ["Camel YAML DSL"] = 191,
    ["Cannon TOML"] = 192,
    Carafe = 193,
    ["Cargo Make"] = 195,
    ["Cargo Manifest"] = 194,
    ["Catalog Info Backstage"] = 196,
    ["Chamaleon environment"] = 1313,
    ["Chamaleon properties"] = 1314,
    ["Chamaleon template"] = 1312,
    Changepacks = 1375,
    Changesets = 325,
    Changie = 197,
    Charmcraft = 198,
    Cheatsheets = 1168,
    ["ChordPro Configuration"] = 200,
    ["Chrome Extension"] = 306,
    ["Chromia Model"] = 201,
    ["Chromia Seeder Module Config"] = 203,
    ["Chromia Seeder Root Config"] = 202,
    ["Cinnamon Spice info.json"] = 111,
    ["CircleCI config.yml"] = 276,
    ["Citation File Format"] = 327,
    ["Citrus test case"] = 205,
    CityJSON = 206,
    ["Claude Code Keybindings"] = 218,
    ["Claude Code Launch Preview"] = 1433,
    ["Claude Code Plugin Manifest"] = 219,
    ["Claude Code Plugin Marketplace"] = 220,
    ["Claude Code Settings"] = 221,
    ["Clawject config"] = 217,
    ["Cloud Foundry Application Manifest"] = 1266,
    ["Cloud Run Spec v1"] = 1290,
    ...
    ["CloudEvents specification"] = 207,
    ["Code Climate"] = 277,
    CodeCV = 115,
    CodeRabbit = 114,
    ["CodeShip Pro services configuration files"] = 295,
    ["CodeShip Pro steps configuration files"] = 296,
    ["Codecov configuration files"] = 294,
    Codex = 285,
    ["Codex Hooks"] = 286,
    ["Codex Plugin Manifest"] = 287,
    ["Codex Skill Metadata"] = 288,
    CodifyCLI = 116,
    Codux = 290,
    ["Cog config file"] = 212,
    ["Commandbox Box.json"] = 213,
    ["Commandbox Server.json"] = 214,
    ["Common Catalog Data"] = 304,
    ["Common Package Specification"] = 215,
    Concord = 1283,
    ["Configu .cfgu files"] = 1271,
    ["Configu .configu file"] = 1272,
    Conjure = 210,
    ["Container Structure Test"] = 1107,
    Containerlab = 1136,
    ["Contextive Glossary"] = 1340,
    ContractGuard = 1137,
    Convex = 209,
    ["Crowdsec collection config"] = 336,
    ["Crowdsec parser config"] = 337,
    ["Crowdsec scenario config"] = 338,
    ["CumulusCI Config"] = 216,
    ["Cursor Agent Environment"] = 1393,
    ["Custom Machinery Machine"] = 1255,
    ["Custom Machinery Recipe"] = 1256,
    ["Cycle Stack File"] = 234,
    CycloneDX = 235,
    ["DWP Exchange - catalogue entry"] = 390,
    ["DWP Exchange - gateway"] = 388,
    ["DWP Exchange - meta"] = 389,
    ["Dark Factory consumer config"] = 236,
    ["Dart Build Config (dart-build.json)"] = 345,
    ["Dart Test Config (dart-test.json)"] = 346,
    ["DashLord Configuration"] = 347,
    ["Data Contract Specification"] = 348,
    ["Data Product Specification"] = 349,
    ["DataYoga Connections"] = 237,
    ["DataYoga Job"] = 238,
    ["Datadog Continuous Testing"] = 599,
    ["Datadog Service Definition"] = 600,
    ["Datadog Software Catalog"] = 601,
    ["Datahub Ingestion Recipe"] = 1187,
    ["Debian Upstream Metadata file"] = 245,
    DebtLens = 246,
    ["Deck config"] = 247,
    ["Declarative Automation Bundles"] = 1233,
    ["DeepMatch deeplinks spec"] = 248,
    ["Dein Config"] = 249,
    ["Deno Config (deno.json)"] = 356,
    ["Dependency cruiser"] = 250,
    ["DeployStack Configuration"] = 251,
    ["Deployah Configuration"] = 1363,
    ["Deployer Recipe"] = 359,
    ["Design Tokens Community Group format"] = 252,
    ["Design Tokens Community Group resolver"] = 253,
    ["Deta Spacefile"] = 254,
    ["Detekt Config (detekt.yml)"] = 360,
    ["Devbox Config"] = 255,
    ["Devbox Plugin"] = 256,
    Devfile = 387,
    Devup = 1376,
    DipDup = 1286,
    ["Discord Webhook"] = 361,
    ["DocFx Config (docfx.json)"] = 366,
    ["Docker Desktop extension metadata"] = 363,
    ["Docs MCP Manifest"] = 367,
    Dofigen = 368,
    ["Dolittle Artifacts"] = 369,
    ["Dolittle Bounded Context Configuration"] = 370,
    ["Dolittle Event Horizons Configuration"] = 371,
    ["Dolittle Resources Configuration"] = 372,
    ["Dolittle Server Configuration"] = 373,
    ["Dolittle Tenant Map Configuration"] = 375,
    ["Dolittle Tenants Configuration"] = 374,
    ["Dolittle Topology"] = 376,
    ["DonateCaseBetterCasino menu"] = 1317,
    ["Draugr Saga"] = 355,
    ["Drupal Breakpoints"] = 258,
    ["Drupal Config"] = 270,
    ["Drupal Info"] = 259,
    ["Drupal Layouts"] = 260,
    ["Drupal Libraries"] = 261,
    ["Drupal Links Action"] = 262,
    ["Drupal Links Contextual"] = 263,
    ["Drupal Links Menu"] = 264,
    ["Drupal Links Task"] = 265,
    ["Drupal Migration"] = 266,
    ["Drupal Permissions"] = 267,
    ["Drupal Recipe"] = 268,
    ["Drupal Routing"] = 269,
    ["Drupal Services"] = 271,
    ["Drush site aliases"] = 382,
    ["Dust configuration"] = 385,
    ["Dynamic Bash Aliases (.aliases)"] = 1224,
    ["EAS config"] = 429,
    ["ECA - Editor Code Assistant"] = 392,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1213,
    ["ESLint Suppressions"] = 434,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1360,
    ["EasyVCR .NET"] = 431,
    ["Eidolon Resource"] = 1301,
    ["Elgato Stream Deck"] = 395,
    Elm = 1288,
    ["Embrace Config"] = 1199,
    Emmet = 1289,
    Endurica = 1237,
    ["Enonic XP API descriptor"] = 398,
    ["Enonic XP Admin Extension descriptor"] = 399,
    ["Enonic XP Admin Tool descriptor"] = 400,
    ["Enonic XP Application descriptor"] = 401,
    ["Enonic XP CMS descriptor"] = 402,
    ["Enonic XP Content Type descriptor"] = 403,
    ["Enonic XP Form Fragment descriptor"] = 404,
    ["Enonic XP ID Provider descriptor"] = 405,
    ["Enonic XP Layout descriptor"] = 406,
    ["Enonic XP Macro descriptor"] = 407,
    ["Enonic XP Mixin descriptor"] = 408,
    ["Enonic XP Page descriptor"] = 409,
    ["Enonic XP Part descriptor"] = 410,
    ["Enonic XP Service descriptor"] = 411,
    ["Enonic XP Site descriptor"] = 412,
    ["Enonic XP Style descriptor"] = 413,
    ["Enonic XP Task descriptor"] = 414,
    ["Enonic XP Webapp descriptor"] = 415,
    ["Enterprise Contract Policy Spec"] = 396,
    ["Envelope Team Definition"] = 1408,
    ["Envilder Map File"] = 397,
    ["Erda Pipeline"] = 1262,
    ["Erda Runtime"] = 1263,
    ["Espanso config.yml"] = 1386,
    ["Espanso match.yml"] = 1385,
    Esquio = 417,
    ["Estuary Flow Catalog"] = 1177,
    ["Ethereum ERC1155"] = 1402,
    ["Ethereum ERC721"] = 1401,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 422,
    ["EveryVoice TTS Toolkit Data Configuration"] = 423,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 427,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 426,
    ["EveryVoice TTS Toolkit Text Configuration"] = 424,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 425,
    ["Evolving Resolutive Process notation"] = 1362,
    ["Expo SDK"] = 428,
    ["Expoot app config"] = 430,
    ["F-Droid Data metadata"] = 436,
    ["FasterCI Configuration"] = 135,
    ["Fence configuration"] = 136,
    FiQuS = 440,
    Firebase = 438,
    ["Flatpak Builder Manifest"] = 441,
    ["FlexGet Config"] = 442,
    ["Flow.json Configurations"] = 1259,
    ["Fossa configuration file"] = 449,
    ["Fossa's fossa-deps file"] = 450,
    ["Foundry VTT - Base package Manifest"] = 444,
    ["Foundry VTT - Module Manifest"] = 445,
    ["Foundry VTT - System Data Template"] = 448,
    ["Foundry VTT - System Manifest"] = 446,
    ["Foundry VTT - World Manifest"] = 447,
    ["Foxx Manifest"] = 137,
    ["Freifunk.de Community API"] = 140,
    ["Frogbot Config"] = 141,
    ["G2P Mapping Configuration"] = 457,
    GAMA = 458,
    ["GCP Blueprint Metadata"] = 461,
    Gaspar = 459,
    ["GatewayCore API Gateway"] = 460,
    ["Gemini CLI settings"] = 462,
    ["GeoJSON.json latest"] = 1175,
    GherKing = 1179,
    ["GitHub Action"] = 472,
    ["GitHub Actions typing"] = 1297,
    ["GitHub CLI configuration"] = 473,
    ["GitHub CLI hosts"] = 474,
    ["GitHub Discussion"] = 475,
    ["GitHub Funding"] = 477,
    ["GitHub Issue Template configuration"] = 478,
    ["GitHub Issue Template forms"] = 479,
    ["GitHub Pages Jekyll"] = 480,
    ["GitHub Prompt"] = 476,
    ["GitHub Secret Scanning"] = 481,
    ["GitHub Workflow"] = 482,
    ["GitHub Workflow Template Properties"] = 483,
    ["GitHub automatically generated release notes configuration"] = 484,
    ["GitLab Agent for Kubernetes configuration"] = 1251,
    ["GitLab Duo Workflow"] = 486,
    GitResume = 488,
    GitVersion = 465,
    ["Gitea Issue Template configuration"] = 468,
    ["Gitea Issue Template forms"] = 469,
    Gitleaks = 466,
    ["Gitpod Configuration"] = 487,
    ["Glamour style"] = 463,
    ["GlazeWM settings"] = 1253,
    ["Global Privacy Control"] = 464,
    Goblet = 1232,
    ["Golangci-lint Configuration"] = 503,
    ["Golangci-lint Custom Plugins Configuration"] = 504,
    ["Google Chrome Related Website Sets"] = 439,
    ["Google Cloud Workflows"] = 312,
    ["Google Digital Assetlinks"] = 1341,
    Goreleaser = 508,
    ["Goreleaser Pro"] = 509,
    Goss = 511,
    ["Gradle Build Cache Node"] = 1125,
    ["Gradle Enterprise"] = 1124,
    ["Grafana 5.x Dashboard"] = 512,
    ["GraphQL Code Generator"] = 517,
    ["GraphQL Config"] = 516,
    ["GraphQL Mesh"] = 515,
    ["GroovyLint configuration"] = 518,
    ["Grunt JSHint task"] = 522,
    ["Grunt Watch task"] = 523,
    ["Grunt base task"] = 524,
    ["Grunt clean task"] = 520,
    ["Grunt copy task"] = 519,
    ["Grunt cssmin task"] = 521,
    HEMTT = 1089,
    Hadolint = 1103,
    Hammerkit = 1135,
    ["Hardware Sentry Configuration"] = 1191,
    ["Hashgraph Online Skill Manifest"] = 7,
    ["HashiCorp Vault"] = 525,
    Hatch = 1104,
    Hayson = 527,
    ["Haystack Pipeline"] = 528,
    ["Hazelcast 5 Configuration"] = 529,
    ["Hecate Input Schema"] = 1352,
    ["Helm Chart.lock"] = 273,
    ["Helm Chart.yaml"] = 272,
    ["Helm Unittest Test Suite"] = 274,
    ["Heloisa Assistant Plugins Marketplace"] = 1431,
    ["Hex file"] = 275,
    ["Home Assistant Integration Manifest"] = 531,
    ["Homer dashboard configuration"] = 532,
    ["Hoverfly Simulation"] = 537,
    Hugo = 1167,
    ["Hugo Theme"] = 1166,
    ["Hulak Configuration"] = 540,
    ["Hyperfoil benchmark configuration"] = 539,
    ["IBM Zapp document"] = 541,
    ["IBM zCodeFormatSettings"] = 542,
    ["IMG Catapult PSP"] = 547,
    ["IVMS101 by CODE Protocol"] = 1252,
    ["Infinispan Configuration"] = 549,
    ["Infinispan Server Configuration"] = 550,
    Infrahub = 551,
    Istanbul = 1195,
    ["JDownloader2 crawler multi-rules"] = 565,
    ["JDownloader2 crawler single-rules"] = 564,
    ["JFrog Applications Config"] = 566,
    ["JFrog File Spec"] = 567,
    ["JFrog Pipelines YML DSL"] = 1201,
    ["JMeter DSL cli config"] = 568,
    JReleaser = 571,
    ["JSON Document Transform"] = 579,
    ["JSON Feed"] = 580,
    ["JSON Resume"] = 857,
    ["JSON Schema Draft 2020-12"] = 1069,
    ["JSON Schema Draft 4"] = 1066,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1234,
    ["JSON Schema Draft 7"] = 1067,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1235,
    ["JSON Schema Draft 8 (2019-09)"] = 1068,
    ["JSON-API"] = 578,
    ["JSON-e templates"] = 1132,
    ["JSON-stat 2.0"] = 1062,
    JSONPatch = 582,
    ["JSR Package Config (jsr.json)"] = 572,
    Jarl = 1368,
    Jasmine = 559,
    Jekyll = 560,
    ["Jenkins X Pipelines"] = 561,
    ["Jenkins X Requirements"] = 562,
    Jest = 563,
    Jocker = 569,
    ["Jovo Language Models"] = 570,
    Jsontron = 583,
    ["Jujutsu (jj) VCS config"] = 1354,
    ["KIMMDY config file"] = 594,
    ["KODE/CI build.yaml"] = 1197,
    ["KSP-AVC"] = 1063,
    ["KSP-CKAN"] = 1064,
    ["KSP-NetKAN"] = 1065,
    KSY = 1264,
    KSail = 455,
    ["KYA Manifest"] = 1265,
    ["Karakum configuration file"] = 451,
    Kas = 586,
    ["Kestra flow file"] = 595,
    ["Keycloak REST API"] = 1204,
    ["Knative Functions - func.yaml"] = 452,
    Knip = 453,
    ["Knip JSONC"] = 454,
    ["Knowledge Unit"] = 603,
    ["Kometa (nightly) config file"] = 597,
    ["Kometa config file"] = 596,
    ["Kong DBLess config"] = 1198,
    KrakenD = 598,
    ["Kubri Configuration"] = 606,
    LOOBin = 624,
    ["Lake configuration file"] = 1357,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 317,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 318,
    ["Landing Zone Accelerator on AWS - Global Config"] = 319,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 320,
    ["Landing Zone Accelerator on AWS - Network Config"] = 321,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 322,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 323,
    ["Landing Zone Accelerator on AWS - Security Config"] = 324,
    ["Lando (landofile)"] = 127,
    ["LangGraph Platform configuration"] = 1276,
    ["Language configuration"] = 1275,
    Lefthook = 611,
    ["Liferay client-extension.yaml"] = 618,
    ["LinkML Metamodel"] = 620,
    ["LiquiLens Evidence Carrier Reference v1"] = 622,
    ["LiquiLens Evidence Carrier v1"] = 621,
    Liquibase = 1142,
    ["Liquibase Flow File"] = 1143,
    ["Lively Properties"] = 623,
    ["Lobe AI Agent"] = 129,
    Loki = 130,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 667,
    ["MS2Rescore Configuration"] = 675,
    ["MSTest testconfig.json"] = 676,
    ["Madge configuration"] = 630,
    ["Madness (madness.yml)"] = 1215,
    ["Mado configuration"] = 631,
    ["Maestro Flow"] = 632,
    ["Mail Servers Configuration"] = 1389,
    ["MapEHR Mapping"] = 633,
    Markdownlint = 1146,
    ["Mason Registry"] = 1149,
    ["MegaLinter Custom Flavor"] = 636,
    ["MegaLinter configuration"] = 635,
    ["MegaLinter descriptor"] = 637,
    Melange = 1242,
    ["Meltano project definition"] = 638,
    ["Mergify Configuration"] = 677,
    ["Mermaid config"] = 2,
    ["Metadata for a Bazel module"] = 639,
    ["Metadata for a Cinnamon spice"] = 1293,
    ["Metatype Configuration"] = 640,
    ["MetricsHub Configuration"] = 641,
    ["MetricsHub Connector Configuration"] = 642,
    ["Micro Editor Syntax"] = 1225,
    ["Microsoft Band Web Tile"] = 643,
    ["Microsoft RulesEngine workflow rules"] = 1280,
    ["Microsoft RulesEngine workflow rules list"] = 1281,
    ["Minecraft Custom Main Menu Mod"] = 1243,
    ["Minecraft Data Pack Advancement"] = 645,
    ["Minecraft Data Pack Biome"] = 646,
    ["Minecraft Data Pack Configured Carver"] = 647,
    ["Minecraft Data Pack Damage Type"] = 648,
    ["Minecraft Data Pack Dimension"] = 650,
    ["Minecraft Data Pack Dimension Type"] = 649,
    ["Minecraft Data Pack Item Modifier"] = 651,
    ["Minecraft Data Pack Loot Table"] = 652,
    ["Minecraft Data Pack Metadata"] = 653,
    ["Minecraft Data Pack Predicate"] = 654,
    ["Minecraft Data Pack Recipe"] = 655,
    ["Minecraft Data Pack Tag"] = 656,
    ["Minecraft Data Pack Template Pool"] = 657,
    ["Minecraft Data Pack Trim Material"] = 662,
    ["Minecraft Data Pack Trim Pattern"] = 663,
    ["Minecraft Resource Pack Lang"] = 658,
    ["Minecraft Resource Pack Particle"] = 659,
    ["Minecraft Resource Pack Texture Mcmeta"] = 661,
    ["Minecraft Resourcepack Sounds"] = 660,
    ["MockServer Expectation"] = 669,
    ["MockServer Expectations"] = 670,
    ModuleAssembler = 665,
    ["Monade CLI Stack Configuration"] = 680,
    ["MongoDB Atlas Search Index Definition"] = 1196,
    ["Monika Configuration"] = 1194,
    ["Monoweave Configuration"] = 674,
    ["Motif config"] = 1085,
    MultiQC = 1334,
    ["NOX Framework (Service)"] = 702,
    ["Netin Diagnostic System Template"] = 1153,
    ["Netlify config"] = 683,
    ["Network-as-Code Data Model"] = 684,
    ["Next Gen UI Agent A2A Server Configuration"] = 685,
    ["Next Gen UI Agent Configuration"] = 687,
    ["Next Gen UI Agent MCP Server Configuration"] = 686,
    ["Nightwatch.js"] = 694,
    ["Nika workflow"] = 699,
    ["Node.js configuration"] = 1090,
    ["NueJS configuration file"] = 707,
    ["Nuitka Package Config"] = 1257,
    ["Nullstone config"] = 709,
    ["ODGS Data Rules"] = 716,
    ["ODGS Ontology Graph"] = 717,
    ["ODGS Standard Metrics"] = 715,
    ["OKF Graph"] = 1432,
    ["ONe's changelog entry"] = 731,
    ["ONe's service descriptor"] = 730,
    ["ORT Server repository environment configuration"] = 742,
    ["OSCAL Assessment Plan (AP)"] = 744,
    ["OSCAL Assessment Results (AR)"] = 745,
    ["OSCAL Catalog"] = 746,
    ["OSCAL Component Definition (CDef)"] = 747,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 748,
    ["OSCAL Profile"] = 749,
    ["OSCAL System Security Plan (SSP)"] = 750,
    ["OSS Review Toolkit configuration"] = 751,
    ["OSS Review Toolkit curation"] = 752,
    ["OSS Review Toolkit package configuration"] = 753,
    ["OSS Review Toolkit project package manager definition"] = 754,
    ["OSS Review Toolkit repository configuration"] = 755,
    ["OSS Review Toolkit resolutions"] = 756,
    ["October CMS columns"] = 713,
    ["October CMS fields"] = 714,
    ["Oh My Posh"] = 719,
    Okteto = 720,
    ["Ona Tasks and Services"] = 722,
    Opctl = 1088,
    ["Open Data Contract Standard (ODCS)"] = 735,
    ["Open Data Product Standard (ODPS)"] = 736,
    ["Open Know-How"] = 1339,
    ["Open Pentest Format"] = 737,
    OpenDecree = 1406,
    ["OpenDecree Configuration"] = 1407,
    ["OpenRewrite Resource"] = 733,
    OpenSRM = 738,
    OpenStatus = 1350,
    ["OpenTelemetry Declarative Configuration"] = 734,
    ["OpenUtau character yaml"] = 727,
    ["OpenUtau ustx"] = 728,
    ["OpenWeather Current Weather API"] = 1131,
    ["OpenWeather Road Risk API"] = 1130,
    ["Ory Hydra configuration"] = 538,
    ["Ory Keto configuration"] = 602,
    ["Ory Kratos configuration"] = 743,
    ["Ory Oathkeeper configuration"] = 711,
    ["Outblocks App configuration"] = 740,
    ["Outblocks database table"] = 741,
    ["Outblocks project configuration"] = 739,
    PDM = 764,
    POPxf = 776,
    ["POPxf Correlations"] = 777,
    ["PRML manifest"] = 784,
    Packer = 760,
    PactSpec = 761,
    Panache = 762,
    Pantsbuild = 1211,
    ["Paper paper-plugin.yml"] = 763,
    ["Pipeline component"] = 1144,
    ["Platform.sh application"] = 13,
    ["Platform.sh routes"] = 14,
    ["Platform.sh services"] = 15,
    ["Plex Prerolls"] = 774,
    ["PocketMine plugin.yml"] = 771,
    ["Podman Desktop Extension"] = 1426,
    ["Postman collection"] = 780,
    ["Power Pages Configuration"] = 1351,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1296,
    ["ProActions AI-Kit Configuration"] = 792,
    ["ProActions AI-Kit Configuration for Menus"] = 794,
    ["ProActions AI-Kit Configuration for Sections"] = 796,
    ["ProActions AI-Kit Configuration for Services"] = 793,
    ["ProActions AI-Kit Configuration for Steps"] = 797,
    ["ProActions AI-Kit Configuration for Templates"] = 795,
    ["Problem object RFC9457"] = 1240,
    ["Problem package format"] = 798,
    ["Problem package generators"] = 799,
    ["Problem package submissions"] = 800,
    ["Problem package test group metadata"] = 801,
    Pterodactyl = 1190,
    ["Pull Request Labeler"] = 818,
    Pulumi = 826,
    ["PyGTA Config"] = 822,
    PyProject = 827,
    Pylock = 1342,
    Pyright = 828,
    ["Python script metadata"] = 1336,
    ["QType AI DSL"] = 831,
    Qgoda = 830,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1418,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1416,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1422,
    ["Qlik Talend Cloud Pipeline - Project"] = 1414,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1417,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1419,
    ["Qlik Talend Cloud Pipeline - Task"] = 1415,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1421,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1420,
    Qodana = 1163,
    ["Qt Creator workspace file"] = 1273,
    ["Quali Torque Blueprint Spec 2"] = 1188,
    ["QueryFirst config file"] = 1207,
    ["QuikRun Configuration"] = 1423,
    ["Qwen Code Settings"] = 1403,
    ["RKE Cluster Configuration JSON"] = 1141,
    ["RKE Cluster Configuration YAML"] = 1140,
    RadioHound = 821,
    ["Raid Profile"] = 1404,
    ["Raid Repo Configuration"] = 1405,
    Railpack = 833,
    Railway = 832,
    ["Rancher Fleet"] = 823,
    ["Rattler-build"] = 834,
    Ray = 1102,
    ["Read the Docs"] = 825,
    ["Red-DiscordBot Cog"] = 841,
    ["Red-DiscordBot Cog Repo"] = 842,
    ["Red-DiscordBot Trivia"] = 843,
    ["Releasaurus Config"] = 10,
    ReleaseKit = 9,
    ["Render Blueprints"] = 1139,
    RenderCV = 861,
    Renovate = 858,
    ["Renovate global configuration"] = 859,
    ["Renovate inherited configuration"] = 860,
    ["Replit config"] = 849,
    Restate = 1329,
    ["Revel Digital Gadget Definition File"] = 1353,
    RoadRunner = 863,
    ["Robust Station Image"] = 1359,
    Rockcraft = 864,
    ["Roo Coder Custom Modes"] = 865,
    Rubocop = 854,
    ["Rudder techniques"] = 1247,
    Ruff = 855,
    ["Rust Project"] = 856,
    ["Rust toolchain"] = 870,
    ["SDMX data message"] = 897,
    ["SDMX metadata message"] = 896,
    ["SDMX structure message"] = 895,
    ["SIL Kit Participant Configuration"] = 908,
    ["SIL Kit Registry Configuration"] = 909,
    ["SPDX 2.3"] = 951,
    SWADL = 967,
    ["Safebox Config"] = 1202,
    ["Sapphire CLI Config"] = 873,
    ["SauceCTL Configuration"] = 1150,
    Scarb = 893,
    ["Schema Catalog"] = 888,
    ["Scoop manifest"] = 894,
    ["Secure SDLC Evidence Bundle"] = 898,
    ["Semantic Data Fabric (SDF) file"] = 899,
    ["Semgrep Rule"] = 901,
    ["Serenity Code Generator (Sergen)"] = 902,
    ["Serverless Framework Configuration"] = 1157,
    ["Serverless Workflow"] = 1159,
    ["Settings for a Cinnamon spice"] = 1292,
    ["Settings.paf"] = 904,
    ["Shopware 6 Configuration"] = 1160,
    ["Shopware CLI Extension Store Configuration"] = 1161,
    ["Shopware CLI Project Store Configuration"] = 1162,
    ["Sigma Detection Rule"] = 906,
    ["SigmaCV CV"] = 5,
    ["Sigrid scope configuration file"] = 907,
    ["SkyPilot Task JSON"] = 1248,
    ["Slack app manifest"] = 914,
    ["Slang Server Configuration"] = 1430,
    Snapcraft = 916,
    ["Solarxy project config"] = 919,
    Solidarity = 920,
    ["Solution filters"] = 921,
    ["Source Maps v3"] = 922,
    Sourcery = 923,
    ["Spack bootstrap.yaml"] = 924,
    ["Spack cdash.yaml"] = 925,
    ["Spack ci.yaml"] = 926,
    ["Spack compilers.yaml"] = 927,
    ["Spack concretizer.yaml"] = 928,
    ["Spack config.yaml"] = 929,
    ["Spack definitions.yaml"] = 930,
    ["Spack develop.yaml"] = 931,
    ["Spack env_vars.yaml"] = 932,
    ["Spack environment"] = 938,
    ["Spack include.yaml"] = 933,
    ["Spack mirrors.yaml"] = 934,
    ["Spack modules.yaml"] = 935,
    ["Spack packages.yaml"] = 936,
    ["Spack repos.yaml"] = 937,
    ["Spack toolchains.yaml"] = 939,
    ["Spack upstreams.yaml"] = 940,
    ["Spack view.yaml"] = 941,
    ["Speakeasy Generation Config File"] = 945,
    ["Speakeasy Lint Configuration File"] = 942,
    ["Speakeasy Test Generation Configuration File"] = 943,
    ["Speakeasy Workflow File"] = 944,
    SpecIF = 946,
    ["Specmatic Configuration"] = 947,
    ["Specpin spec file"] = 3,
    ["Sponge Mixin configuration"] = 948,
    ["Spotlight Ruleset"] = 949,
    StackBlitz = 955,
    ["StackHawk Scanner Configuration"] = 1156,
    Stale = 956,
    Starfish = 957,
    ["Starlake Data Pipeline"] = 1128,
    Starship = 958,
    ["Statamic Blueprint"] = 959,
    ["Stella configuration file"] = 960,
    ["Streamlit configuration file"] = 961,
    ["Stryker Mutator"] = 964,
    ["StyleCop Analyzers Configuration"] = 965,
    ["Stylelint (.stylelintrc)"] = 966,
    ["Stylua Config"] = 1343,
    ["Sublime Syntax"] = 1203,
    ["Subsquid squid manifest"] = 1250,
    ["Swagger API 2.0"] = 968,
    ["Symfony Routing Configuration"] = 969,
    ["Symfony Serializer Mapping"] = 970,
    ["Symfony Services Configuration"] = 971,
    ["Symfony Validation Mapping"] = 972,
    ["Synadia Connect Component"] = 973,
    TSON = 1011,
    TSTyche = 1012,
    ["TYPO3 Vendor Bundler config"] = 1018,
    ["Tab data for a LinUtil"] = 1299,
    ["Tab list for a LinUtil"] = 1298,
    Tach = 974,
    ["Tach Domain"] = 975,
    Talhelper = 977,
    ["Talisman configuration"] = 978,
    Taplo = 1344,
    ["Taskfile config"] = 1133,
    Taurus = 979,
    Tauticord = 980,
    ["Tekton Pipeline"] = 1372,
    ["Tekton PipelineRun"] = 1373,
    ["Tekton Task"] = 1370,
    ["Tekton TaskRun"] = 1371,
    Telefonistka = 1330,
    ["Terrateam config"] = 1356,
    ["TestEnvironment.json"] = 992,
    ["TextMate Grammar"] = 991,
    Threagile = 986,
    ["Tier.run pricing.json"] = 983,
    Tikibase = 984,
    Tombi = 989,
    ["Traefik v2"] = 995,
    ["Traefik v2 File Provider"] = 996,
    ["Traefik v3"] = 997,
    ["Traefik v3 File Provider"] = 998,
    ["Travis CI (.travis.yml)"] = 994,
    Treefmt = 514,
    Trident = 1326,
    Trivy = 1001,
    ["TrueScript for *.tscript files"] = 1002,
    ["Tugboat QA config.yml"] = 1323,
    TunnelHub = 1238,
    Turborepo = 993,
    Tycho = 1287,
    Tye = 1164,
    ["Tyk Gateway - Open Source v5.7+"] = 1335,
    ["UET BuildConfig.json"] = 1208,
    ["UI5 Manifest"] = 1024,
    ["UNCORS configuration"] = 1029,
    ["UTAM Page Object"] = 1027,
    ["Ubuntu Server Autoinstall"] = 1022,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1327,
    ["Uniswap Token List"] = 1113,
    ["Universal Schedule Format"] = 1030,
    ["Unreal Engine Uplugin"] = 1209,
    ["Unreal Engine Uproject"] = 1210,
    ["UpCloud CLI (upctl) configuration"] = 1328,
    ["Updatecli Compose"] = 1172,
    ["Updatecli Policy Manifest"] = 1173,
    ["Updatecli Policy Metadata"] = 1174,
    Uplift = 1206,
    ["Upsun config"] = 12,
    ["User Journey Map"] = 1138,
    V2Ray = 1178,
    ["VSCode Code Snippets"] = 300,
    ["VSIX CLI publishing"] = 1049,
    Vector = 1032,
    ["Vela Pipeline Configuration"] = 1035,
    Vercel = 299,
    ["Version Bumper config"] = 1038,
    Vespertide = 1377,
    ["Vespertide Migration"] = 1378,
    ["Vespertide Model"] = 1379,
    ["Viash Component Config"] = 1332,
    ["Viash Package Config"] = 1333,
    Visivo = 1236,
    Vogi = 1043,
    ["WP-CLI"] = 1059,
    Wake = 1325,
    ["Waku Config"] = 1302,
    ["Web App Manifest"] = 1055,
    ["Web types"] = 1058,
    WebExtensions = 1054,
    ["Webman package recipe"] = 1184,
    ["Windows Package Manager Installer Manifest"] = 1110,
    ["Windows Package Manager Locale Manifest"] = 1111,
    ["Windows Package Manager Singleton Manifest"] = 1109,
    ["WireMock CLI import configuration"] = 1308,
    ["WireMock CLI local service configuration"] = 1307,
    ["WireMock message stub mapping"] = 1306,
    ["WireMock stub mapping"] = 1305,
    ["Woodpecker pipeline config"] = 1152,
    ["Wrangler CLI"] = 1060,
    ["XenForo add-on manifest"] = 1061,
    ["Xstate Machine"] = 1170,
    ["Yandex Workflow Language"] = 1294,
    ["Yarn Config (.yarnrc.yml)"] = 1126,
    ["Yippee-Ki-JSON configuration YML"] = 1117,
    ["YouTrack App"] = 1291,
    ["Zarf Package Configuration"] = 1358,
    ["Zerops import file"] = 1279,
    ["Zola Configuration"] = 1369,
    abtop = 33,
    act3 = 1410,
    actionlint = 43,
    ["aerleon.yml"] = 27,
    ["amplify.yml"] = 20,
    ["amxx-builder manifest"] = 1425,
    ["angular.json"] = 48,
    apko = 1241,
    ...
    ["behat.yml"] = 166,
    ["bigquery-table"] = 152,
    ["bioimageio resource description"] = 1258,
    ...
    ["bozr.suite.json"] = 170,
    bpkg = 1219,
    ["browser.i18n.json"] = 171,
    ["browsh configuration"] = 172,
    bucklescript = 173,
    ["buf.gen.yaml"] = 105,
    ["buf.lock"] = 106,
    ["buf.plugin.yaml"] = 107,
    ...
    ["build-changelog"] = 174,
    ["bun.lock"] = 179,
    ["bundleconfig.json"] = 180,
    ["bunfig.toml"] = 181,
    ["cargo-mutants-config.yaml"] = 110,
    ["cargo-nextest repository configuration"] = 688,
    ["cargo-nextest user configuration"] = 689,
    ["ccmod.json"] = 1303,
    changelogging = 1270,
    ["chezmoi configuration"] = 199,
    ["chisel-slices.json"] = 326,
    ["chrome-extension-locales-messages.json"] = 307,
    ["chutzpah.json"] = 308,
    cibuildwheel = 204,
    ["clang-format (.clang-format)"] = 1176,
    ["clang-tidy"] = 281,
    clangd = 280,
    clib = 282,
    ["cloud-init: cloud-config userdata"] = 284,
    ["cloud-sdk-pipeline-configuration"] = 310,
    ["cloudbuild.json"] = 311,
    cloudify = 283,
    cmakefmt = 222,
    ["cmdx.yaml"] = 113,
    ...
    ["commands.json"] = 303,
    ["commit-check"] = 329,
    ["commitlint (.commitlintrc)"] = 1112,
    ["committed.toml"] = 330,
    ["compile_commands.json"] = 302,
    ["compilerconfig.json"] = 301,
    ["completely.yml"] = 1214,
    ["component-detection-manifest.json"] = 333,
    ["component.json"] = 332,
    ["composer.json"] = 331,
    ["conda-forge"] = 208,
    ["config.yaml"] = 824,
    ["contentmanifest.json"] = 309,
    ["contribute.json"] = 334,
    ["cosmos.config.json"] = 305,
    ["crowdin.yml"] = 335,
    crucible = 339,
    ["ctfd-setup configuration file"] = 1315,
    ["custom-elements.json"] = 1228,
    ["cypress.json"] = 340,
    ["dacier.yml"] = 1413,
    ["datalogic-scan2deploy-android"] = 350,
    ["datalogic-scan2deploy-ce"] = 351,
    ["dbt Dependencies"] = 240,
    ["dbt Packages"] = 242,
    ["dbt Project"] = 241,
    ["dbt Selectors"] = 243,
    ["dbt YAML files"] = 244,
    ...
    ["ddev-global"] = 352,
    ["ddev-project"] = 353,
    ["debugsettings.json"] = 354,
    ["dependabot-v2.json"] = 358,
    ["dependabot.json"] = 357,
    ["deployed-cli"] = 1169,
    devconcurrent = 257,
    ["devcontainer-feature.json"] = 292,
    ["devcontainer.json"] = 291,
    devinit = 1119,
    ["devspace.yaml"] = 1192,
    djlint = 1120,
    ["docker bake"] = 364,
    ["docker sequencer"] = 365,
    ["docker-compose.yml"] = 1118,
    ["dockerd.json"] = 362,
    ["dotnet Release Index manifest"] = 377,
    ["dotnet-tools.json"] = 378,
    ["dotnetcli.host.json"] = 379,
    ["dprint.json"] = 380,
    ["drone.json"] = 381,
    ["dss-2.0.0.json"] = 383,
    ["dstack configuration"] = 384,
    ["dtool dataset metadata"] = 1310,
    ["dvc.yaml"] = 386,
    ["ecosystem.json"] = 391,
    ["editorconfig-checker"] = 393,
    eksctl = 394,
    ["electron-builder configuration file"] = 420,
    ["epr-manifest.json"] = 419,
    ["estampo.toml"] = 418,
    ["evcc.yaml"] = 421,
    ["ezd task runner"] = 432,
    ["fabric.mod.json"] = 435,
    ["first-timers-bot"] = 443,
    ["flagd flag configuration"] = 138,
    ["fly.io Configuration"] = 139,
    fulibWorkflows = 1151,
    ["function.json"] = 456,
    ["gRPC API Gateway & OpenAPI Config"] = 22,
    ["gematik health care insurance list"] = 1321,
    ["gematik health care patient list"] = 1318,
    ["gematik health care provider institution list"] = 1320,
    ["gematik health care provider list"] = 1319,
    ["gematik tiger test environment configuration"] = 1322,
    ["gh-dash"] = 470,
    ["gha-doctor"] = 471,
    ["git-cliff"] = 467,
    ["git-town.toml"] = 1367,
    ["github-settings-as-code"] = 850,
    ["gitlab-ci"] = 485,
    ["global.json"] = 502,
    ["glslint config"] = 1,
    ["go-feature-flag Flag Configuration"] = 506,
    ["gojo.yaml"] = 507,
    gollama = 505,
    ["hassette.toml"] = 530,
    ["haxelib.json"] = 526,
    ...
    ["ide.host.json"] = 543,
    ["ifstate.yaml"] = 544,
    ["imageoptimizer.json"] = 545,
    ["importmap.json"] = 548,
    ["index.toml (packwiz)"] = 1427,
    instant_python_config = 552,
    instant_python_custom_project = 553,
    intlayer = 554,
    ["ioBroker Configuration"] = 555,
    ["ioBroker JSON UI"] = 556,
    ["ioBroker Package manifest"] = 557,
    ["ixpect.conf.yaml"] = 558,
    ["ize.toml"] = 1205,
    ["jsconfig.json"] = 584,
    ["jscpd Configuration"] = 1189,
    jsdoc = 1101,
    ["k3d.yaml"] = 585,
    ["k9s aliases.yaml"] = 587,
    ["k9s cluster-config.yaml"] = 589,
    ["k9s config.yaml"] = 588,
    ["k9s hotkeys.yaml"] = 590,
    ["k9s plugins.yaml"] = 591,
    ["k9s skin.yaml"] = 592,
    ["k9s views.yaml"] = 593,
    ["kind cluster"] = 607,
    ["kontinuous-config.yaml"] = 605,
    ["kontinuous-values.yaml"] = 604,
    ["kustomization.yaml"] = 608,
    ["label-commenter-config.yml"] = 609,
    ["latexindent configuration"] = 128,
    ["launchsettings.json"] = 610,
    lazydocker = 1227,
    lazygit = 1226,
    ["lego.json"] = 612,
    ["lerna.json"] = 613,
    ["lgtm.yml"] = 614,
    ["liblab.config.json"] = 615,
    ["libman.json"] = 616,
    ["license-report-config.json"] = 617,
    ["linkinator.config.json"] = 619,
    ["lint-staged (.lintstagedrc)"] = 1078,
    ["local.settings.json"] = 626,
    ["localazy.json"] = 627,
    ["lotus.yaml"] = 625,
    ["lsd colors"] = 132,
    ["lsd config"] = 131,
    ...
    lychee = 1077,
    ["macro.json"] = 1193,
    ["markdown-link-check"] = 1147,
    maturin = 1148,
    mboats = 1155,
    memnex = 1411,
    ["micro-settings.json"] = 1220,
    ["mimetypes.json"] = 644,
    ["mirrord config"] = 1081,
    ["misata.yaml"] = 1080,
    mise = 1082,
    ["mkdocs.yml"] = 664,
    ["mockd.yaml"] = 668,
    ["mod.pw.toml (packwiz)"] = 1428,
    ["modelparams.dev Model"] = 671,
    ["models CLI"] = 672,
    ["monospace.yml"] = 673,
    ["moon.yml"] = 1304,
    ["mprocs Configuration file"] = 1274,
    ["mrdocs.yml"] = 666,
    ["mta.yaml"] = 1083,
    ["mtad.yaml"] = 1084,
    ["mycode.json"] = 681,
    nFPM = 693,
    ["napari plugin manifest"] = 682,
    neoload = 1096,
    ["nest-cli"] = 696,
    ["nexus-rpc-gen"] = 1394,
    ["nf-core module environment.yml"] = 690,
    ["nf-core module meta.yml"] = 691,
    ["nf-core subworkflow meta.yml"] = 692,
    ["ninjs (News in JSON)"] = 695,
    ["nitro.json"] = 1095,
    ["nixd configuration"] = 1246,
    ["nlu.json"] = 697,
    ["nodemon.json"] = 700,
    ["noodl config"] = 1154,
    ["notebook.mod.json"] = 701,
    now = 1091,
    ["npm-badges"] = 704,
    ["nswag.json"] = 708,
    ntangle = 710,
    ["nuclei-template.yaml"] = 705,
    ["nuget-project.json"] = 706,
    ["ocelot.json"] = 712,
    ogen = 718,
    ["omnisharp.json"] = 721,
    openHAB = 1380,
    ...
    oxfmt = 1390,
    oxlint = 1391,
    ["pack.toml (packwiz)"] = 1429,
    ["package.json"] = 757,
    ["package.manifest"] = 759,
    ["package.yaml"] = 758,
    ["partial-black.json"] = 167,
    ["partial-fastapi.json"] = 168,
    ["partial-pixi.json"] = 769,
    ["partial-scheduled.json"] = 169,
    ["pattern.json"] = 767,
    ["petstore-v1.0"] = 1200,
    pgap_yaml_input_reader = 765,
    pgrls = 766,
    pgxgen = 1384,
    pitcms = 1387,
    ["pixi.toml"] = 768,
    ["plagiarize-me.yaml"] = 773,
    ["plagiarize.yaml"] = 772,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1311,
    ["podbard.yaml"] = 775,
    ["portman.json"] = 778,
    ["prefect.toml"] = 787,
    ["prefect.yaml"] = 788,
    ...
    ["prettierrc.json"] = 790,
    ["prisma.yml"] = 791,
    ["project-1.0.0-beta3.json"] = 803,
    ["project-1.0.0-beta4.json"] = 804,
    ["project-1.0.0-beta5.json"] = 805,
    ["project-1.0.0-beta6.json"] = 806,
    ["project-1.0.0-beta8.json"] = 807,
    ["project-1.0.0-rc1.json"] = 808,
    ["project-1.0.0-rc2.json"] = 809,
    ["project.json"] = 802,
    ["project.owasp.yaml"] = 810,
    ["prometheus-alertmanager.json"] = 814,
    ["prometheus.json"] = 811,
    ["prometheus.rules.json"] = 812,
    ["prometheus.rules.test.json"] = 813,
    ["proxies.json"] = 815,
    ["publiccode.yml"] = 816,
    ["pubspec.yaml"] = 817,
    ["pyrseas-0.8.json"] = 820,
    pytest = 829,
    ["quilt.mod.json"] = 1221,
    ["rc3 auth"] = 835,
    ["rc3 collection"] = 836,
    ...
    ["rc3 settings"] = 840,
    ["registry.yaml"] = 61,
    ["release drafter"] = 1097,
    ["release-hub.json"] = 8,
    ["release-please-config.json"] = 845,
    ["release-please-manifest.json"] = 846,
    ["release-plz.toml"] = 847,
    ["renv.lock"] = 862,
    ["reposets Configuration"] = 851,
    ["reposets Credentials"] = 852,
    ["revola.json"] = 6,
    ["rivet.json"] = 1245,
    ["rivet.yaml (legacy)"] = 1244,
    rumdl = 867,
    runny = 866,
    runspec = 1412,
    rustfmt = 868,
    ...
    samt = 871,
    samtrc = 872,
    ["sarif-1.0.0.json"] = 874,
    ["sarif-2.0.0.json"] = 875,
    ["sarif-2.1.0"] = 885,
    ["sarif-2.1.0-rtm.2"] = 876,
    ["sarif-2.1.0-rtm.3"] = 878,
    ["sarif-2.1.0-rtm.4"] = 880,
    ["sarif-2.1.0-rtm.5"] = 882,
    ["sarif-2.1.0-rtm.6"] = 883,
    ["sarif-external-property-file-2.1.0"] = 886,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 877,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 879,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 881,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 884,
    ["scalingo.json configuration"] = 887,
    ["schema.org - Action"] = 889,
    ["schema.org - ContactPoint"] = 890,
    ["schema.org - Place"] = 891,
    ["schema.org - Thing"] = 892,
    ["secrethub.yml"] = 1223,
    ["semantic-release"] = 900,
    ["servicehub.config.json"] = 1072,
    ["servicehub.service.json"] = 1071,
    ["settings.job"] = 903,
    ["sfdx-hardis configuration"] = 905,
    ["shard.yml"] = 1261,
    ["size-limit configuration"] = 910,
    ["skaffold.yaml"] = 1145,
    ["skill-map plugin extension manifest"] = 911,
    ["skill-map project settings"] = 912,
    ["skill-map provider kind"] = 913,
    ["skyuxconfig.json"] = 915,
    ["snowflake-config"] = 917,
    ["snowflake-connections"] = 918,
    ["spicepod.yaml"] = 1282,
    ["sqlc configuration"] = 952,
    ["stripe-app-local.json"] = 963,
    ["stripe-app.json"] = 962,
    swcrc = 1129,
    ["task.json"] = 976,
    taskcat = 1092,
    ["template.json"] = 981,
    ["templatsources.json"] = 982,
    ["text2confl config"] = 1392,
    ["theme.json"] = 985,
    ["tizen_workspace.json"] = 987,
    tldr = 988,
    ["tm_devices configuration file"] = 1349,
    tmuxinator = 1075,
    tox = 990,
    ["transcend.yml"] = 999,
    ["tree-sitter grammar.json"] = 513,
    ["trime.yaml"] = 1000,
    ["trunk.yaml"] = 1003,
    ["ts-force-config.json"] = 1009,
    tsbuild = 1004,
    ["tsconfig.json"] = 1005,
    ["tsd.json"] = 1006,
    ["tsdoc.json"] = 1007,
    ...
    v8r = 1053,
    vcluster = 1268,
    ["vcpkg configuration file"] = 298,
    ["vcpkg manifest file"] = 297,
    ["vega-lite.json"] = 1034,
    ["vega.json"] = 1033,
    ["venvironment.yaml"] = 1036,
    ["venvplus.yaml"] = 1037,
    version = 1331,
    ["version.json"] = 1039,
    ["vhwdebugger-binding.yaml"] = 1041,
    ["vim-addon-info"] = 1042,
    ["vs-2017.3.host.json"] = 1045,
    ["vs-nesting.json"] = 1046,
    ["vsls.json"] = 1044,
    ["vss-extension.json"] = 1050,
    vtcfg = 1337,
    ["vtesttree.yaml"] = 1051,
    ["vtestunit.yaml"] = 1052,
    ["warp-keysets.json"] = 1229,
    ["warp-themes.json"] = 1230,
    ["warp-workflows.json"] = 1231,
    ["webhint.io"] = 1185,
    ["webjobpublishsettings.json"] = 1057,
    ["webjobs-list.json"] = 1056,
    ["well-known-fursona"] = 1269,
    ["xs-app.json"] = 1087,
    ["xunit.runner.json"] = 1070,
    ["yaml-workflow"] = 1435,
    yamlfmt = 1114,
    yamllint = 1115,
    ["yap.json"] = 1116,
