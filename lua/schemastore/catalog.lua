...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 165,
    [".cryproj (generic)"] = 567,
    [".cryproj engine-5.2"] = 562,
    [".cryproj engine-5.3"] = 563,
    [".cryproj engine-5.4"] = 564,
    [".cryproj engine-5.5"] = 565,
    [".cryproj engine-dev"] = 566,
    [".csscomb.json"] = 167,
    [".csslintrc"] = 168,
    [".es6importsorterrc.json"] = 694,
    [".eslintrc"] = 214,
    [".esmrc.json"] = 206,
    [".ffizer.yaml"] = 218,
    [".htmlhintrc"] = 264,
    ...
    [".pmbot.yml"] = 391,
    [".postcssrc"] = 396,
    [".powerpages-web-template-manifest"] = 398,
    [".pre-commit-config.yml"] = 399,
    [".pre-commit-hooks.yml"] = 400,
    [".putout.json"] = 419,
    [".rehyperc"] = 429,
    [".remarkrc"] = 430,
    [".sprite files"] = 482,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration Schema"] = 639,
    ["All Contributors configuration file"] = 693,
    ...
    ["Azure Pipelines"] = 54,
    ["Azure Static Web Apps CLI configuration file"] = 484,
    ["Azure Static Web Apps configuration file"] = 483,
    ["BX CI"] = 89,
    ["Better Code Hub"] = 612,
    ["Better Scripts"] = 90,
    BizTalkServerApplicationSchema = 582,
    ...
    ["Butane Config"] = 651,
    ["CICS TS region tagging"] = 658,
    ["CICS TS resource import"] = 659,
    ["CICS TS resource model"] = 660,
    ["CICS TS resource overrides"] = 661,
    ["CMake Presets"] = 91,
    ...
    ["Datahub Ingestion Recipe Schema"] = 665,
    ...
    ["Embrace Config Schema"] = 676,
    ["Error pages"] = 209,
    Esquio = 207,
    ["Estuary Flow Catalog Schema"] = 655,
    ["Expo SDK"] = 212,
    ...
    Goreleaser = 246,
    ["Goreleaser Pro"] = 247,
    ["Gradle Build Cache Node"] = 609,
    ["Gradle Enterprise"] = 608,
    ...
    Hadolint = 591,
    Hammerkit = 619,
    ["Hardware Sentry Configuration"] = 669,
    Hayson = 259,
    ...
    ["JFrog File Spec"] = 283,
    ["JFrog Pipelines YML DSL"] = 678,
    ["JMeter DSL cli config schema"] = 284,
    JReleaser = 286,
    ["JSON Document Transform"] = 293,
    ["JSON Feed"] = 294,
    ["JSON Resume"] = 436,
    ["JSON Schema Draft 2020-12"] = 558,
    ["JSON Schema Draft 4"] = 555,
    ["JSON Schema Draft 7"] = 556,
    ["JSON Schema Draft 8"] = 557,
    ...
    ["KSP-CKAN"] = 554,
    Kas = 299,
    ["Keycloak REST API"] = 685,
    ["Knative Functions - func.yaml"] = 228,
    ["KoDE/CI build.yaml"] = 674,
    ["Kong DBLess Schema"] = 675,
    KrakenD = 300,
    LOOBin = 316,
    Lefthook = 307,
    ["LinkML Metamodel"] = 314,
    Liquibase = 624,
    ["Liquibase Flow File"] = 625,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 673,
    ["Monika Configuration Schema"] = 671,
    ["Motif config"] = 575,
    ["NOX Framework (Service)"] = 361,
    ["Netin Diagnostic System Template"] = 634,
    ["Netlify config schema"] = 352,
    ["Nexus-as-Code schema"] = 353,
    ["Nightwatch.js"] = 354,
    ["ONe's service descriptor"] = 373,
    ["OSS Review Toolkit configuration"] = 380,
    ["OSS Review Toolkit curation"] = 381,
    ["OSS Review Toolkit package configuration"] = 382,
    ["OSS Review Toolkit repository configuration"] = 383,
    ["OSS Review Toolkit resolutions"] = 384,
    Opctl = 578,
    ["OpenRewrite Resource"] = 375,
    ["OpenWeather Current Weather API"] = 616,
    ["OpenWeather Road Risk API"] = 615,
    ["Ory Hydra configuration"] = 265,
    ["Ory Keto configuration"] = 302,
    ["Ory Kratos configuration"] = 379,
    ["Ory Oathkeeper configuration"] = 368,
    ["Outblocks App configuration"] = 377,
    ["Outblocks database table"] = 378,
    ["Outblocks project configuration"] = 376,
    Packer = 387,
    Pantsbuild = 692,
    ["Paper paper-plugin.yml"] = 388,
    ["Pipeline component"] = 626,
    ["PocketMine plugin.yml"] = 392,
    ["Postman collection"] = 397,
    Pterodactyl = 668,
    ["Pull Request Labeler"] = 418,
    Pulumi = 423,
    PyProject = 424,
    Pyright = 425,
    Qodana = 644,
    ["Quali Torque Blueprint Spec 2"] = 666,
    ["QueryFirst config file"] = 688,
    ["RKE Cluster Configuration JSON Schema"] = 623,
    ["RKE Cluster Configuration YAML Schema"] = 622,
    ["Rancher Fleet"] = 421,
    Ray = 590,
    ["Read the Docs"] = 422,
    ["Red-DiscordBot Cog"] = 426,
    ["Red-DiscordBot Cog Repo"] = 427,
    ["Red-DiscordBot Trivia"] = 428,
    Renovate = 437,
    ["Replit schema"] = 431,
    RoadRunner = 438,
    Ruff = 434,
    ["Rust Project"] = 435,
    ["Rust toolchain"] = 440,
    ["SIL Kit Participant Configuration"] = 470,
    ["SIL Kit Registry Configuration"] = 471,
    SWADL = 493,
    ["Safebox Config Schema"] = 679,
    ["Sapphire CLI Config"] = 443,
    ["SauceCTL Configuration"] = 631,
    ["Schema Catalog"] = 456,
    ["Scoop manifest"] = 461,
    ["Semantic Data Fabric (SDF) file"] = 462,
    ["Semgrep Rule"] = 464,
    ["Serenity Code Generator (Sergen)"] = 465,
    ["Serverless Framework Configuration"] = 638,
    ["Serverless Workflow Schema"] = 640,
    ["Settings.paf"] = 467,
    ["Shopware 6 Configuration"] = 641,
    ["Shopware CLI Extension Store Configuration"] = 642,
    ["Shopware CLI Project Store Configuration"] = 643,
    ["Sigrid scope configuration file"] = 469,
    ["Slack app manifest"] = 473,
    Solidarity = 476,
    ["Solution filters"] = 477,
    ["Source Maps v3"] = 478,
    Sourcery = 479,
    SpecIF = 480,
    ["Sponge Mixin configuration"] = 481,
    ["StackHawk Scanner Configuration"] = 637,
    Stale = 485,
    Starship = 486,
    ["Statamic Blueprint"] = 487,
    ["StrmPrivacy Data Connector"] = 683,
    ["StrmPrivacy Data Contract"] = 684,
    ["StrmPrivacy SimpleSchema"] = 681,
    ["StrmPrivacy Stream"] = 682,
    ["StrmPrivacy batch job configuration file"] = 680,
    ["Stryker Mutator"] = 490,
    ["StyleCop Analyzers Configuration"] = 491,
    ["Swagger API 2.0"] = 494,
    TSON = 518,
    ["Talisman configuration"] = 496,
    ["Taskfile YAML Schema"] = 618,
    Taurus = 497,
    ["TestEnvironment.json"] = 506,
    ["Tier.run pricing.json"] = 500,
    Tikibase = 501,
    ["Traefik v2"] = 509,
    ["Traefik v2 File Provider"] = 510,
    Turborepo = 507,
    Tye = 645,
    ["UET BuildConfig.json"] = 689,
    ["UI5 Manifest"] = 525,
    ["UTAM Page Object"] = 528,
    ["Ubuntu Server Autoinstall"] = 523,
    ["Uniswap Token List"] = 600,
    ["Unreal Engine Uplugin"] = 690,
    ["Unreal Engine Uproject"] = 691,
    Updatecli = 652,
    Uplift = 687,
    ["User Journey Map YAML Schema"] = 621,
    V2Ray = 656,
    ["VSCode Code Snippets"] = 137,
    ["VSIX CLI publishing"] = 541,
    ["Vela Pipeline Configuration"] = 531,
    Vercel = 136,
    ["Web App Manifest"] = 548,
    ["Web types"] = 551,
    WebExtensions = 547,
    ["Webman package recipe"] = 662,
    ["Windows Package Manager Installer Manifest"] = 597,
    ["Windows Package Manager Locale Manifest"] = 598,
    ["Windows Package Manager Singleton Manifest"] = 596,
    ["Woodpecker pipeline config"] = 633,
    ["Xstate Machine Schema"] = 650,
    ["Yippee-Ki-JSON configuration YML"] = 602,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 65,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 698,
    ["bashly-strings.yml"] = 699,
    ["bashly.yml"] = 697,
    ["batect.yml"] = 64,
    ["beau.yml"] = 611,
    ...
    ["ize.toml"] = 686,
    ["jsconfig.json"] = 297,
    ["jscpd Configuration Schema"] = 667,
    jsdoc = 589,
    ["k3d.yaml"] = 298,
    ...
    ["lsdlschema.json"] = 320,
    ["madness.yml"] = 696,
    ["markdown-lint-check"] = 629,
    mboats = 636,
    ["micro-settings.json"] = 700,
    ["mimetypes.json"] = 327,
    ["mirrord-schema"] = 572,
    ["mta.yaml"] = 573,
    ["mtad.yaml"] = 574,
    ...
    ["openrpc.json"] = 372,
    ["package.json"] = 385,
    ["package.manifest"] = 386,
    ["pattern.json"] = 390,
    ["petstore-v1.0"] = 677,
    pgap_yaml_input_reader = 389,
    ["plagiarize-me.yaml"] = 394,
    ["plagiarize.yaml"] = 393,
    ["portman.json"] = 395,
    ["prettierrc.json"] = 402,
    ["prisma.yml"] = 403,
    ["project-1.0.0-beta3.json"] = 405,
    ["project-1.0.0-beta4.json"] = 406,
    ["project-1.0.0-beta5.json"] = 407,
    ["project-1.0.0-beta6.json"] = 408,
    ["project-1.0.0-beta8.json"] = 409,
    ["project-1.0.0-rc1.json"] = 410,
    ["project-1.0.0-rc2.json"] = 411,
    ["project.json"] = 404,
    ["prometheus.json"] = 412,
    ["prometheus.rules.json"] = 413,
    ["prometheus.rules.test.json"] = 414,
    ["proxies.json"] = 415,
    ["publiccode.yml"] = 416,
    ["pubspec.yaml"] = 417,
    ["pyrseas-0.8.json"] = 420,
    ["quilt.mod.json"] = 701,
    ["release drafter"] = 585,
    rtx = 433,
    rustfmt = 439,
    samt = 441,
    samtrc = 442,
    ["sarif-1.0.0.json"] = 444,
    ["sarif-2.0.0.json"] = 445,
    ["sarif-2.1.0"] = 454,
    ["sarif-2.1.0-rtm.2"] = 446,
    ["sarif-2.1.0-rtm.3"] = 448,
    ["sarif-2.1.0-rtm.4"] = 450,
    ["sarif-2.1.0-rtm.5"] = 452,
    ["sarif-external-property-file-2.1.0"] = 455,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 447,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 449,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 451,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 453,
    ["schema.org - Action"] = 457,
    ["schema.org - ContactPoint"] = 458,
    ["schema.org - Place"] = 459,
    ["schema.org - Thing"] = 460,
    ["secrethub.yml"] = 703,
    ["semantic-release"] = 463,
    ["servicehub.config.json"] = 561,
    ["servicehub.service.json"] = 560,
    ["settings.job"] = 466,
    ["sfdx-hardis configuration"] = 468,
    ["size-limit configuration"] = 472,
    ["skaffold.yaml"] = 627,
    ["skyuxconfig.json"] = 474,
    snapcraft = 475,
    ["stripe-app-local.json"] = 489,
    ["stripe-app.json"] = 488,
    swcrc = 614,
    ["task.json"] = 495,
    taskcat = 581,
    ["template.json"] = 498,
    ["templatsources.json"] = 499,
    ["theme.json"] = 502,
    ["tizen_workspace.json"] = 503,
    tldr = 504,
    tmLanguage = 505,
    tmuxinator = 569,
    ["transcend.yml"] = 511,
    ["trunk.yaml schema"] = 512,
    ["ts-force-config.json"] = 516,
    ["tsconfig.json"] = 513,
    ["tsd.json"] = 514,
    ["tsdrc.json"] = 515,
    ["tslint.json"] = 517,
    ...
    ["vega-lite.json"] = 530,
    ["vega.json"] = 529,
    ["venvironment-basic.yaml"] = 533,
    ["venvironment.yaml"] = 532,
    ["version.json"] = 534,
    ["vim-addon-info"] = 535,
    ["vs-2017.3.host.json"] = 537,
    ["vs-nesting.json"] = 538,
    ["vsls.json"] = 536,
    ["vss-extension.json"] = 542,
    ["vtesttree.yaml"] = 543,
    ["vtestunit.yaml"] = 544,
    ["webhint.io"] = 663,
    ["webjobpublishsettings.json"] = 550,
    ["webjobs-list.json"] = 549,
    ["xs-app.json"] = 577,
    ["xunit.runner.json"] = 559,
    yamllint = 601,
    zuul = 586,
    ["Žinoma"] = 595
  },
