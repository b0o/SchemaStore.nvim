...
M.json = {
  ...
  index = {
    ...
    [".pmbot.yml"] = 594,
    [".postcssrc"] = 603,
    [".powerpages-web-template-manifest"] = 605,
    [".pre-commit-config.yml"] = 606,
    [".pre-commit-hooks.yml"] = 607,
    [".putout.json"] = 637,
    [".rehyperc"] = 662,
    [".remarkrc"] = 666,
    [".sprite files"] = 755,
    ...
    ABCSupplyPlan = 21,
    AIConfig = 22,
    ["AMX Muse Program Descriptor"] = 1103,
    ["API Builder"] = 914,
    ["AVA Configuration"] = 977,
    ...
    ["AWS Copilot Manifest"] = 1142,
    ["AWS SAM CLI Samconfig"] = 230,
    ["Adobe UXP Manifest"] = 1039,
    ["Aerleon Network & Service Definitions"] = 15,
    ["Aerleon Policy"] = 16,
    Aider = 1132,
    Air = 18,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1153,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1152,
    ["Airlock Microgateway"] = 23,
    ["Alacritty Configuration"] = 949,
    ["All Contributors configuration file"] = 1002,
    ...
    ["Application list for a WinUtil"] = 1083,
    ArchitectFX = 1088,
    ["Argo CD"] = 41,
    ["Argo Events"] = 42,
    ["Argo Workflows"] = 43,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1151,
    ["Azure IoT Operations connector metadata"] = 1148,
    ...
    ["Azure Pipelines"] = 85,
    ["Azure Static Web Apps CLI configuration file"] = 759,
    ["Azure Static Web Apps configuration file"] = 758,
    ["BOSH CPI Config"] = 109,
    ["BOSH Deploy Config"] = 110,
    ["BX CI"] = 129,
    ["Bacon config"] = 2,
    ["Bashly (bashly.yml)"] = 1006,
    ["Bashly Settings (bashly-settings.yml)"] = 1007,
    ["Better Code Hub"] = 919,
    ["Better Scripts"] = 130,
    Bigconfig = 102,
    ["Biome Formatter Config"] = 68,
    ["Bitmovin Encoding Template"] = 1096,
    BizTalkServerApplicationSchema = 886,
    Bleep = 131,
    ...
    ["Butane Config"] = 962,
    C4InterFlow = 1111,
    ["CDK Environment Manager, concrete environment configuration"] = 1135,
    ["CDK Environment Manager, concrete environments definition"] = 1134,
    ["CDK Environment Manager, environment definition"] = 1133,
    ["CGS Card Game Specification (cgs.json)"] = 1044,
    ["CICS TS region tagging"] = 971,
    ["CICS TS resource import"] = 972,
    ["CICS TS resource model"] = 973,
    ["CICS TS resource overrides"] = 974,
    ["CMake Presets"] = 132,
    ["CNC Codes"] = 153,
    ["CRS WAF test file"] = 1073,
    ["CRS WAF test platform overrides file"] = 1074,
    ...
    ["Chamaleon environment"] = 1100,
    ["Chamaleon properties"] = 1101,
    ["Chamaleon template"] = 1099,
    Changesets = 239,
    Changie = 141,
    Charmcraft = 142,
    Cheatsheets = 959,
    ...
    ["Clawject config"] = 159,
    ["Cloud Foundry Application Manifest"] = 1055,
    ["Cloud Run Spec v1"] = 1078,
    ...
    Concord = 1072,
    ["Configu .cfgu files"] = 1060,
    ["Configu .configu file"] = 1061,
    Conjure = 152,
    ["Container Structure Test"] = 900,
    Containerlab = 928,
    ["Contextive Glossary"] = 1127,
    Convex = 151,
    ["Crowdsec collection config"] = 249,
    ["Crowdsec parser config"] = 250,
    ["Crowdsec scenario config"] = 251,
    ["CumulusCI Config"] = 158,
    ["Custom Machinery Machine"] = 1045,
    ["Custom Machinery Recipe"] = 1046,
    ...
    ["DonateCaseBetterCasino menu"] = 1104,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1014,
    ["EAS config"] = 315,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1003,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1147,
    ["EasyVCR .NET"] = 316,
    ["Eidolon Resource"] = 1089,
    ...
    ["Evolving Resolutive Process notation"] = 1149,
    ["Expo SDK"] = 314,
    ...
    ["GeoJSON.json latest"] = 966,
    GherKing = 970,
    ["GitHub Action"] = 348,
    ["GitHub Actions typing"] = 1085,
    ...
    ["Google Digital Assetlinks"] = 1128,
    Goreleaser = 376,
    ["Goreleaser Pro"] = 377,
    Goss = 378,
    ["Gradle Build Cache Node"] = 917,
    ["Gradle Enterprise"] = 916,
    ...
    Hadolint = 896,
    Hammerkit = 927,
    ["Hardware Sentry Configuration"] = 982,
    ["HashiCorp Vault"] = 391,
    Hatch = 897,
    Hayagriva = 393,
    Hayson = 394,
    ...
    ["JFrog File Spec"] = 427,
    ["JFrog Pipelines YML DSL"] = 991,
    ["JMeter DSL cli config"] = 428,
    JReleaser = 431,
    ["JSON Document Transform"] = 439,
    ["JSON Feed"] = 440,
    ["JSON Resume"] = 672,
    ["JSON Schema Draft 2020-12"] = 864,
    ["JSON Schema Draft 4"] = 861,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1024,
    ["JSON Schema Draft 7"] = 862,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1025,
    ["JSON Schema Draft 8 (2019-09)"] = 863,
    ["JSON-API"] = 438,
    ["JSON-e templates"] = 924,
    ["JSON-stat 2.0"] = 857,
    JSONPatch = 442,
    ...
    ["Jujutsu (jj) VCS config"] = 1141,
    ["KIMMDY config file"] = 453,
    ["KODE/CI build.yaml"] = 987,
    ["KSP-AVC"] = 858,
    ["KSP-CKAN"] = 859,
    ["KSP-NetKAN"] = 860,
    KSY = 1054,
    ...
    ["Metadata for a Cinnamon spice"] = 1081,
    ["Metatype Configuration"] = 493,
    ["MetricsHub Configuration"] = 494,
    ["MetricsHub Connector Configuration"] = 495,
    ["Micro Editor Syntax"] = 1015,
    ["Microsoft Band Web Tile"] = 496,
    ["Microsoft RulesEngine workflow rules"] = 1069,
    ["Microsoft RulesEngine workflow rules list"] = 1070,
    ["Minecraft Custom Main Menu Mod"] = 1033,
    ...
    ["MongoDB Atlas Search Index Definition"] = 986,
    ["Monika Configuration"] = 984,
    ["Monoweave Configuration"] = 521,
    ["Motif config"] = 878,
    MultiQC = 1121,
    ["NOX Framework (Service)"] = 540,
    ["Netin Diagnostic System Template"] = 944,
    ["Netlify config"] = 529,
    ["Network-as-Code Data Model"] = 530,
    ["Next Gen UI Agent Configuration"] = 531,
    ["Nightwatch.js"] = 533,
    ["Node.js configuration"] = 883,
    ["NueJS configuration file"] = 545,
    ["Nuitka.yaml"] = 1047,
    ["Nullstone config"] = 547,
    ["ONe's changelog entry"] = 562,
    ["ONe's service descriptor"] = 561,
    ["ORT Server repository environment configuration"] = 570,
    ["OSCAL Assessment Plan (AP)"] = 572,
    ["OSCAL Assessment Results (AR)"] = 573,
    ["OSCAL Catalog"] = 574,
    ["OSCAL Component Definition (CDef)"] = 575,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 576,
    ["OSCAL Profile"] = 577,
    ["OSCAL System Security Plan (SSP)"] = 578,
    ["OSS Review Toolkit configuration"] = 579,
    ["OSS Review Toolkit curation"] = 580,
    ["OSS Review Toolkit package configuration"] = 581,
    ["OSS Review Toolkit repository configuration"] = 582,
    ["OSS Review Toolkit resolutions"] = 583,
    ["October CMS columns"] = 551,
    ["October CMS fields"] = 552,
    Okteto = 553,
    ["Ona Automations"] = 555,
    Opctl = 881,
    ["Open Data Contract Standard (ODCS)"] = 565,
    ["Open Data Product Standard (ODPS)"] = 566,
    ["Open Know-How"] = 1126,
    ["OpenRewrite Resource"] = 564,
    OpenStatus = 1137,
    ["OpenUtau character yaml"] = 558,
    ["OpenUtau ustx"] = 559,
    ["OpenWeather Current Weather API"] = 923,
    ["OpenWeather Road Risk API"] = 922,
    ["Ory Hydra configuration"] = 403,
    ["Ory Keto configuration"] = 461,
    ["Ory Kratos configuration"] = 571,
    ["Ory Oathkeeper configuration"] = 549,
    ["Outblocks App configuration"] = 568,
    ["Outblocks database table"] = 569,
    ["Outblocks project configuration"] = 567,
    PDM = 590,
    POPxf = 600,
    ["POPxf Correlations"] = 601,
    Packer = 587,
    Pantsbuild = 1001,
    ["Paper paper-plugin.yml"] = 588,
    ["Pipeline component"] = 935,
    ["Platform.sh application"] = 4,
    ["Platform.sh routes"] = 5,
    ["Platform.sh services"] = 6,
    ["Plex Prerolls"] = 598,
    ["PocketMine plugin.yml"] = 595,
    ["Postman collection"] = 604,
    ["Power Pages Configuration"] = 1138,
    ["Preset list for a WinUtil"] = 1084,
    ["ProActions AI-Kit Configuration"] = 613,
    ["ProActions AI-Kit Configuration for Menus"] = 615,
    ["ProActions AI-Kit Configuration for Sections"] = 617,
    ["ProActions AI-Kit Configuration for Services"] = 614,
    ["ProActions AI-Kit Configuration for Steps"] = 618,
    ["ProActions AI-Kit Configuration for Templates"] = 616,
    ["Problem object RFC9457"] = 1030,
    ["Problem package generators"] = 619,
    Pterodactyl = 981,
    ["Pull Request Labeler"] = 636,
    Pulumi = 644,
    ["PyGTA Config"] = 640,
    PyProject = 645,
    Pylock = 1129,
    Pyright = 646,
    ["Python script metadata"] = 1123,
    ["QType AI DSL"] = 649,
    Qgoda = 648,
    Qodana = 954,
    ["Qt Creator workspace file"] = 1062,
    ["Quali Torque Blueprint Spec 2"] = 979,
    ["QueryFirst config file"] = 997,
    ["RKE Cluster Configuration JSON"] = 932,
    ["RKE Cluster Configuration YAML"] = 931,
    RadioHound = 639,
    Railpack = 651,
    Railway = 650,
    ["Rancher Fleet"] = 641,
    ...
    Ray = 895,
    ["Read the Docs"] = 643,
    ["Red-DiscordBot Cog"] = 659,
    ["Red-DiscordBot Cog Repo"] = 660,
    ["Red-DiscordBot Trivia"] = 661,
    ["Render Blueprints"] = 930,
    RenderCV = 674,
    Renovate = 673,
    ["Replit config"] = 667,
    Restate = 1116,
    ["Revel Digital Gadget Definition File"] = 1140,
    RoadRunner = 676,
    ["Robust Station Image"] = 1146,
    Rockcraft = 677,
    ["Roo Coder Custom Modes"] = 678,
    Rubocop = 669,
    ["Rudder techniques"] = 1037,
    Ruff = 670,
    ["Rust Project"] = 671,
    ["Rust toolchain"] = 682,
    ["SDMX data message"] = 708,
    ["SDMX metadata message"] = 707,
    ["SDMX structure message"] = 706,
    ["SIL Kit Participant Configuration"] = 718,
    ["SIL Kit Registry Configuration"] = 719,
    ["SPDX 2.3"] = 756,
    SWADL = 772,
    ["Safebox Config"] = 992,
    ["Sapphire CLI Config"] = 685,
    ["SauceCTL Configuration"] = 941,
    ["Schema Catalog"] = 700,
    ["Scoop manifest"] = 705,
    ["Semantic Data Fabric (SDF) file"] = 709,
    ["Semgrep Rule"] = 711,
    ["Serenity Code Generator (Sergen)"] = 712,
    ["Serverless Framework Configuration"] = 948,
    ["Serverless Workflow"] = 950,
    ["Settings for a Cinnamon spice"] = 1080,
    ["Settings.paf"] = 714,
    ["Shopware 6 Configuration"] = 951,
    ["Shopware CLI Extension Store Configuration"] = 952,
    ["Shopware CLI Project Store Configuration"] = 953,
    ["Sigma Detection Rule"] = 716,
    ["Sigrid scope configuration file"] = 717,
    ["SkyPilot Task JSON"] = 1038,
    ["Slack app manifest"] = 721,
    Snapcraft = 723,
    Solidarity = 726,
    ["Solution filters"] = 727,
    ["Source Maps v3"] = 728,
    Sourcery = 729,
    ["Spack bootstrap.yaml"] = 730,
    ["Spack cdash.yaml"] = 731,
    ["Spack ci.yaml"] = 732,
    ["Spack compilers.yaml"] = 733,
    ["Spack concretizer.yaml"] = 734,
    ["Spack config.yaml"] = 735,
    ["Spack definitions.yaml"] = 736,
    ["Spack develop.yaml"] = 737,
    ["Spack env_vars.yaml"] = 738,
    ["Spack environment"] = 744,
    ["Spack include.yaml"] = 739,
    ["Spack mirrors.yaml"] = 740,
    ["Spack modules.yaml"] = 741,
    ["Spack packages.yaml"] = 742,
    ["Spack repos.yaml"] = 743,
    ["Spack toolchains.yaml"] = 745,
    ["Spack upstreams.yaml"] = 746,
    ["Spack view.yaml"] = 747,
    ["Speakeasy Generation Config File"] = 751,
    ["Speakeasy Lint Configuration File"] = 748,
    ["Speakeasy Test Generation Configuration File"] = 749,
    ["Speakeasy Workflow File"] = 750,
    SpecIF = 752,
    ["Specmatic Configuration"] = 753,
    ["Sponge Mixin configuration"] = 754,
    StackBlitz = 760,
    ["StackHawk Scanner Configuration"] = 947,
    Stale = 761,
    Starfish = 762,
    ["Starlake Data Pipeline"] = 920,
    Starship = 763,
    ["Statamic Blueprint"] = 764,
    ["Stella configuration file"] = 765,
    ["Streamlit configuration file"] = 766,
    ["Stryker Mutator"] = 769,
    ["StyleCop Analyzers Configuration"] = 770,
    ["Stylelint (.stylelintrc)"] = 771,
    ["Stylua Config"] = 1130,
    ["Sublime Syntax"] = 993,
    ["Subsquid squid manifest"] = 1040,
    ["Swagger API 2.0"] = 773,
    ["Synadia Connect Component"] = 774,
    TSON = 809,
    TSTyche = 810,
    ["TYPO3 Vendor Bundler config"] = 815,
    ["Tab data for a LinUtil"] = 1087,
    ["Tab list for a LinUtil"] = 1086,
    Tach = 775,
    ["Tach Domain"] = 776,
    Talhelper = 778,
    ["Talisman configuration"] = 779,
    Taplo = 1131,
    ["Taskfile config"] = 925,
    Taurus = 780,
    Tauticord = 781,
    Telefonistka = 1117,
    ["Terrateam config"] = 1143,
    ["TestEnvironment.json"] = 792,
    ["TextMate Grammar"] = 791,
    Threagile = 787,
    ["Tier.run pricing.json"] = 784,
    Tikibase = 785,
    Tombi = 790,
    ["Traefik v2"] = 795,
    ["Traefik v2 File Provider"] = 796,
    ["Traefik v3"] = 797,
    ["Traefik v3 File Provider"] = 798,
    ["Travis CI (.travis.yml)"] = 794,
    Treefmt = 381,
    Trident = 1113,
    ["TrueScript for *.tscript files"] = 801,
    ["Tugboat QA config.yml"] = 1110,
    TunnelHub = 1028,
    Turborepo = 793,
    Tycho = 1076,
    Tye = 955,
    ["Tyk Gateway - Open Source v5.7+"] = 1122,
    ["Typst Manifest"] = 816,
    ["UET BuildConfig.json"] = 998,
    ["UI5 Manifest"] = 822,
    ["UNCORS configuration"] = 826,
    ["UTAM Page Object"] = 825,
    ["Ubuntu Server Autoinstall"] = 820,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1114,
    ["Uniswap Token List"] = 907,
    ["Universal Schedule Format"] = 827,
    ["Unreal Engine Uplugin"] = 999,
    ["Unreal Engine Uproject"] = 1000,
    ["UpCloud CLI (upctl) configuration"] = 1115,
    ["Updatecli Compose"] = 963,
    ["Updatecli Policy Manifest"] = 964,
    ["Updatecli Policy Metadata"] = 965,
    Uplift = 996,
    ["Upsun config"] = 3,
    ["User Journey Map"] = 929,
    V2Ray = 969,
    ["VSCode Code Snippets"] = 214,
    ["VSIX CLI publishing"] = 845,
    Vector = 829,
    ["Vela Pipeline Configuration"] = 832,
    Vercel = 213,
    ["Version Bumper config"] = 835,
    ["Viash Component Config"] = 1119,
    ["Viash Package Config"] = 1120,
    Visivo = 1026,
    ["WP-CLI"] = 855,
    Wake = 1112,
    ["Waku Config"] = 1090,
    ["Web App Manifest"] = 851,
    ["Web types"] = 854,
    WebExtensions = 850,
    ["Webman package recipe"] = 975,
    ["Windows Package Manager Installer Manifest"] = 903,
    ["Windows Package Manager Locale Manifest"] = 904,
    ["Windows Package Manager Singleton Manifest"] = 902,
    Winutil = 905,
    ["WireMock CLI import configuration"] = 1095,
    ["WireMock CLI local service configuration"] = 1094,
    ["WireMock stub mapping"] = 1093,
    ["Woodpecker pipeline config"] = 943,
    ["Wrangler CLI"] = 856,
    ["Xstate Machine"] = 961,
    ["Yandex Workflow Language"] = 1082,
    ["Yarn Config (.yarnrc.yml)"] = 918,
    ["Yippee-Ki-JSON configuration YML"] = 909,
    ["YouTrack App"] = 1079,
    ["Zarf Package Configuration"] = 1145,
    ["Zerops.io config"] = 1067,
    ["Zerops.io import"] = 1068,
    ["Zola Configuration"] = 1156,
    ["aerleon.yml"] = 14,
    ["angular.json"] = 24,
    apko = 1031,
    ...
    ["behat.yml"] = 112,
    ["bigquery-table"] = 101,
    ["bioimageio resource description"] = 1048,
    ...
    ["crowdin.yml"] = 248,
    ["ctfd-setup configuration file"] = 1102,
    ["custom-elements.json"] = 1018,
    ["cypress.json"] = 252,
    ...
    ["gematik health care insurance list"] = 1108,
    ["gematik health care patient list"] = 1105,
    ["gematik health care provider institution list"] = 1107,
    ["gematik health care provider list"] = 1106,
    ["gematik tiger test environment configuration"] = 1109,
    ["git-town.toml"] = 1154,
    ["gitlab-ci"] = 356,
    ["global.json"] = 372,
    ...
    ["lint-staged (.lintstagedrc)"] = 872,
    ["local.settings.json"] = 481,
    ["localazy.json"] = 482,
    ["lotus.yaml"] = 480,
    ["lsdlschema.json"] = 483,
    ["markdown-link-check"] = 938,
    maturin = 939,
    mboats = 946,
    ["micro-settings.json"] = 1010,
    ["mimetypes.json"] = 497,
    ["mirrord config"] = 874,
    mise = 875,
    ["mkdocs.yml"] = 517,
    ["monospace.yml"] = 520,
    ["moon.yml"] = 1092,
    ["mprocs Configuration file"] = 1063,
    ["mrdocs.yml"] = 518,
    ["mta.yaml"] = 876,
    ["mtad.yaml"] = 877,
    ["mycode.json"] = 527,
    ...
    ["ops.yaml"] = 560,
    ["package.json"] = 584,
    ["package.manifest"] = 586,
    ["package.yaml"] = 585,
    ["partial-black.json"] = 113,
    ["pathfinder.yml"] = 589,
    ["pattern.json"] = 592,
    ["petstore-v1.0"] = 990,
    pgap_yaml_input_reader = 591,
    ["pixi.toml"] = 593,
    ["plagiarize-me.yaml"] = 597,
    ["plagiarize.yaml"] = 596,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1098,
    ["podbard.yaml"] = 599,
    ["portman.json"] = 602,
    ["prefect.toml"] = 610,
    ["prettierrc.json"] = 611,
    ["prisma.yml"] = 612,
    ["project-1.0.0-beta3.json"] = 621,
    ["project-1.0.0-beta4.json"] = 622,
    ["project-1.0.0-beta5.json"] = 623,
    ["project-1.0.0-beta6.json"] = 624,
    ["project-1.0.0-beta8.json"] = 625,
    ["project-1.0.0-rc1.json"] = 626,
    ["project-1.0.0-rc2.json"] = 627,
    ["project.json"] = 620,
    ["project.owasp.yaml"] = 628,
    ["prometheus-alertmanager.json"] = 632,
    ["prometheus.json"] = 629,
    ["prometheus.rules.json"] = 630,
    ["prometheus.rules.test.json"] = 631,
    ["proxies.json"] = 633,
    ["publiccode.yml"] = 634,
    ["pubspec.yaml"] = 635,
    ["pyrseas-0.8.json"] = 638,
    pytest = 647,
    ["quilt.mod.json"] = 1011,
    ["rc3 auth"] = 653,
    ["rc3 collection"] = 654,
    ...
    ["release drafter"] = 890,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 663,
    ["release-please-manifest.json"] = 664,
    ["release-plz.toml"] = 665,
    ["renv.lock"] = 675,
    ["rivet.json"] = 1035,
    ["rivet.yaml (legacy)"] = 1034,
    rumdl = 680,
    runny = 679,
    rustfmt = 681,
    sake = 1125,
    samt = 683,
    samtrc = 684,
    ["sarif-1.0.0.json"] = 686,
    ["sarif-2.0.0.json"] = 687,
    ["sarif-2.1.0"] = 697,
    ["sarif-2.1.0-rtm.2"] = 688,
    ["sarif-2.1.0-rtm.3"] = 690,
    ["sarif-2.1.0-rtm.4"] = 692,
    ["sarif-2.1.0-rtm.5"] = 694,
    ["sarif-2.1.0-rtm.6"] = 695,
    ["sarif-external-property-file-2.1.0"] = 698,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 689,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 691,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 693,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 696,
    ["scalingo.json configuration"] = 699,
    ["schema.org - Action"] = 701,
    ["schema.org - ContactPoint"] = 702,
    ["schema.org - Place"] = 703,
    ["schema.org - Thing"] = 704,
    ["secrethub.yml"] = 1013,
    ["semantic-release"] = 710,
    ["servicehub.config.json"] = 867,
    ["servicehub.service.json"] = 866,
    ["settings.job"] = 713,
    ["sfdx-hardis configuration"] = 715,
    ["shard.yml"] = 1051,
    ["size-limit configuration"] = 720,
    ["skaffold.yaml"] = 936,
    ["skyuxconfig.json"] = 722,
    ["snowflake-config"] = 724,
    ["snowflake-connections"] = 725,
    ["spicepod.yaml"] = 1071,
    ["sqlc configuration"] = 757,
    ["stripe-app-local.json"] = 768,
    ["stripe-app.json"] = 767,
    swcrc = 921,
    ["task.json"] = 777,
    taskcat = 885,
    ["template.json"] = 782,
    ["templatsources.json"] = 783,
    ["theme.json"] = 786,
    ["tizen_workspace.json"] = 788,
    tldr = 789,
    ["tm_devices configuration file"] = 1136,
    tmuxinator = 870,
    ["transcend.yml"] = 799,
    ["tree-sitter grammar.json"] = 380,
    ["trime.yaml"] = 800,
    ["trunk.yaml"] = 802,
    ["ts-force-config.json"] = 807,
    ["tsconfig.json"] = 803,
    ["tsd.json"] = 804,
    ["tsdoc.json"] = 805,
    ["tsdrc.json"] = 806,
    ...
    ["vega-lite.json"] = 831,
    ["vega.json"] = 830,
    ["venvironment.yaml"] = 833,
    ["venvplus.yaml"] = 834,
    version = 1118,
    ["version.json"] = 836,
    ["vhwdebugger-binding.yaml"] = 838,
    ["vim-addon-info"] = 839,
    ["vs-2017.3.host.json"] = 841,
    ["vs-nesting.json"] = 842,
    ["vsls.json"] = 840,
    ["vss-extension.json"] = 846,
    vtcfg = 1124,
    ["vtesttree.yaml"] = 847,
    ["vtestunit.yaml"] = 848,
    ["warp-keysets.json"] = 1019,
    ["warp-themes.json"] = 1020,
    ["warp-workflows.json"] = 1021,
    ["webhint.io"] = 976,
    ["webjobpublishsettings.json"] = 853,
    ["webjobs-list.json"] = 852,
    ["well-known-fursona"] = 1058,
    ["xs-app.json"] = 880,
    ["xunit.runner.json"] = 865,
    yamllint = 908,
    zuul = 891,
    ["Žinoma"] = 901
  },
