...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 145,
    [".cryproj (generic)"] = 491,
    [".cryproj engine-5.2"] = 486,
    [".cryproj engine-5.3"] = 487,
    [".cryproj engine-5.4"] = 488,
    [".cryproj engine-5.5"] = 489,
    [".cryproj engine-dev"] = 490,
    [".csscomb.json"] = 147,
    [".csslintrc"] = 148,
    [".eslintrc"] = 193,
    [".esmrc.json"] = 185,
    ...
    [".mtaext"] = 500,
    [".nodehawkrc"] = 309,
    [".npmpackagejsonlintrc"] = 312,
    [".phraseapp.yml"] = 346,
    [".pmbot.yml"] = 338,
    [".postcssrc"] = 343,
    [".pre-commit-config.yml"] = 344,
    [".pre-commit-hooks.yml"] = 345,
    [".putout.json"] = 363,
    [".rehyperc"] = 370,
    [".remarkrc"] = 371,
    [".sprite files"] = 414,
    ...
    ["Azure Pipelines"] = 45,
    ["Azure Static Web Apps CLI configuration file"] = 416,
    ["Azure Static Web Apps configuration file"] = 415,
    ["BX CI"] = 76,
    ["Better Code Hub"] = 534,
    ["Better Scripts"] = 77,
    BizTalkServerApplicationSchema = 506,
    ...
    ["Butane Config"] = 571,
    ["CICS TS region tagging"] = 578,
    ["CICS TS resource import"] = 579,
    ["CICS TS resource model"] = 580,
    ["CICS TS resource overrides"] = 581,
    ["CMake Presets"] = 78,
    ...
    ["Datahub Ingestion Recipe Schema"] = 585,
    ...
    ["Embrace Config Schema"] = 596,
    ["Error pages"] = 188,
    Esquio = 186,
    ["Estuary Flow Catalog Schema"] = 575,
    ["Expo SDK"] = 191,
    ...
    Goreleaser = 219,
    ["Goreleaser Pro"] = 220,
    ["Gradle Build Cache Node"] = 531,
    ["Gradle Enterprise"] = 530,
    ...
    HEMTT = 503,
    Hadolint = 515,
    ["Hardware Sentry Configuration"] = 589,
    Hayson = 232,
    ...
    ["JFrog File Spec"] = 251,
    ["JFrog Pipelines YML DSL"] = 598,
    ["JSON Document Transform"] = 259,
    ["JSON Feed"] = 260,
    ["JSON Resume"] = 376,
    ["JSON Schema Draft 2020-12"] = 482,
    ["JSON Schema Draft 4"] = 479,
    ["JSON Schema Draft 7"] = 480,
    ["JSON Schema Draft 8"] = 481,
    ...
    ["KSP-AVC"] = 477,
    ["KSP-CKAN"] = 478,
    ["Keycloak REST API"] = 604,
    ["Knative Functions - func.yaml"] = 203,
    ["KoDE/CI build.yaml"] = 594,
    ["Kong DBLess Schema"] = 595,
    KrakenD = 265,
    ["LinkML Metamodel"] = 277,
    Liquibase = 545,
    ["Liquibase Flow File"] = 546,
    Markdownlint = 549,
    ...
    ["Minecraft Data Pack Template Pool"] = 297,
    ["Minecraft Resourcepack Sounds"] = 298,
    ["MongoDB Atlas Search Index Definition Schema"] = 593,
    ["Monika Configuration Schema"] = 591,
    ["Motif config"] = 499,
    ["NOX Framework (Service)"] = 311,
    ["Netin Diagnostic System Template"] = 554,
    ["Netlify config schema"] = 303,
    ["Nightwatch.js"] = 304,
    ["OSS Review Toolkit configuration"] = 328,
    ["OSS Review Toolkit curation"] = 329,
    ["OSS Review Toolkit package configuration"] = 330,
    ["OSS Review Toolkit repository configuration"] = 331,
    ["OSS Review Toolkit resolutions"] = 332,
    Opctl = 502,
    ["OpenWeather Current Weather API"] = 538,
    ["OpenWeather Road Risk API"] = 537,
    ["Ory Hydra configuration"] = 238,
    ["Ory Keto configuration"] = 267,
    ["Ory Kratos configuration"] = 327,
    ["Ory Oathkeeper configuration"] = 318,
    ["Outblocks App configuration"] = 325,
    ["Outblocks database table"] = 326,
    ["Outblocks project configuration"] = 324,
    Packer = 335,
    ["Pipeline component"] = 547,
    ["PocketMine plugin.yml"] = 339,
    Pterodactyl = 588,
    ["Pull Request Labeler"] = 362,
    Pulumi = 366,
    PyProject = 367,
    Qodana = 564,
    ["Quali Torque Blueprint Spec 2"] = 586,
    ["QueryFirst config file"] = 607,
    ["RKE Cluster Configuration JSON Schema"] = 544,
    ["RKE Cluster Configuration YAML Schema"] = 543,
    Ray = 514,
    ["Read the Docs"] = 365,
    ["Red-DiscordBot Cog"] = 368,
    ["Red-DiscordBot Cog Repo"] = 369,
    Renovate = 377,
    ["Replit schema"] = 372,
    RoadRunner = 378,
    Ruff = 374,
    ["Rust Project"] = 375,
    ["Rust toolchain"] = 380,
    ["SIL Kit Participant Configuration"] = 405,
    SWADL = 425,
    ["Sapphire CLI Config"] = 381,
    ["SauceCTL Configuration"] = 551,
    ["Schema Catalog"] = 394,
    ["Scoop manifest"] = 399,
    ["Semgrep Rule"] = 401,
    ["Serverless Framework Configuration"] = 558,
    ["Serverless Workflow Schema"] = 560,
    ["Settings.paf"] = 403,
    ["Shopware 6 Configuration"] = 561,
    ["Shopware CLI Extension Store Configuration"] = 562,
    ["Shopware CLI Project Store Configuration"] = 563,
    Solidarity = 409,
    ["Solution filters"] = 410,
    ["Source Maps v3"] = 411,
    SpecIF = 412,
    ["Sponge Mixin configuration"] = 413,
    ["StackHawk Scanner Configuration"] = 557,
    Stale = 417,
    Starship = 418,
    ["Statamic Blueprint"] = 419,
    ["StrmPrivacy Data Connector"] = 602,
    ["StrmPrivacy Data Contract"] = 603,
    ["StrmPrivacy SimpleSchema"] = 600,
    ["StrmPrivacy Stream"] = 601,
    ["StrmPrivacy batch job configuration file"] = 599,
    ["Stryker Mutator"] = 422,
    ["StyleCop Analyzers Configuration"] = 423,
    ["Swagger API 2.0"] = 426,
    TSON = 446,
    ["Talisman configuration"] = 427,
    ["Taskfile YAML Schema"] = 540,
    Taurus = 428,
    ["TestEnvironment.json"] = 435,
    Tikibase = 431,
    ["Traefik v2"] = 438,
    ["Traefik v2 File Provider"] = 439,
    Turborepo = 436,
    Tye = 565,
    ["UI5 Manifest"] = 452,
    ["UTAM Page Object"] = 454,
    ["Ubuntu Server Autoinstall"] = 450,
    ["Uniswap Token List"] = 523,
    ["Unreal Engine Uplugin"] = 608,
    ["Unreal Engine Uproject"] = 609,
    Updatecli = 572,
    Uplift = 606,
    ["User Journey Map YAML Schema"] = 542,
    V2Ray = 576,
    ["VSCode Code Snippets"] = 121,
    ["VSIX CLI publishing"] = 467,
    ["Vela Pipeline Configuration"] = 457,
    Vercel = 120,
    ["Web App Manifest"] = 472,
    ["Web types"] = 475,
    WebExtensions = 471,
    ["Webman package recipe"] = 582,
    ["Windows Package Manager Installer Manifest"] = 520,
    ["Windows Package Manager Locale Manifest"] = 521,
    ["Windows Package Manager Singleton Manifest"] = 519,
    ["Woodpecker pipeline config"] = 553,
    ["Xstate Machine Schema"] = 570,
    ["Yippee-Ki-JSON configuration YML"] = 525,
    ["angular.json"] = 10,
    ...
    ["ize.toml"] = 605,
    ["jsconfig.json"] = 263,
    ["jscpd Configuration Schema"] = 587,
    jsdoc = 513,
    ["k3d.yaml"] = 264,
    ...
    ["mtad.yaml"] = 498,
    ["mycode.json"] = 301,
    ["napari plugin manifest"] = 302,
    neoload = 508,
    ["nest-cli"] = 307,
    ["ninjs (News in JSON) 1.3"] = 306,
    ["ninjs (News in JSON) 2.0"] = 305,
    ["nlu.json"] = 308,
    ["nodemon.json"] = 310,
    ["noodl.schema.json"] = 555,
    now = 504,
    ["npm-badges"] = 313,
    ["nswag.json"] = 316,
    ntangle = 317,
    ["nuclei-template.yaml"] = 314,
    ["nuget-project.json"] = 315,
    ["ocelot.json"] = 319,
    ["omnisharp.json"] = 320,
    ["openapi.json"] = 321,
    ["openfin.json"] = 323,
    ["openrpc.json"] = 322,
    ["package.json"] = 333,
    ["package.manifest"] = 334,
    ["pattern.json"] = 337,
    ["petstore-v1.0"] = 597,
    pgap_yaml_input_reader = 336,
    ["plagiarize-me.yaml"] = 341,
    ["plagiarize.yaml"] = 340,
    ["portman.json"] = 342,
    ["prettierrc.json"] = 347,
    ["prisma.yml"] = 348,
    ["project-1.0.0-beta3.json"] = 350,
    ["project-1.0.0-beta4.json"] = 351,
    ["project-1.0.0-beta5.json"] = 352,
    ["project-1.0.0-beta6.json"] = 353,
    ["project-1.0.0-beta8.json"] = 354,
    ["project-1.0.0-rc1.json"] = 355,
    ["project-1.0.0-rc2.json"] = 356,
    ["project.json"] = 349,
    ["prometheus.json"] = 357,
    ["prometheus.rules.json"] = 358,
    ["proxies.json"] = 359,
    ["publiccode.yml"] = 360,
    ["pubspec.yaml"] = 361,
    ["pyrseas-0.8.json"] = 364,
    ["release drafter"] = 509,
    rustfmt = 379,
    ["sarif-1.0.0.json"] = 382,
    ["sarif-2.0.0.json"] = 383,
    ["sarif-2.1.0"] = 392,
    ["sarif-2.1.0-rtm.2"] = 384,
    ["sarif-2.1.0-rtm.3"] = 386,
    ["sarif-2.1.0-rtm.4"] = 388,
    ["sarif-2.1.0-rtm.5"] = 390,
    ["sarif-external-property-file-2.1.0"] = 393,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 385,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 387,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 389,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 391,
    ["schema.org - Action"] = 395,
    ["schema.org - ContactPoint"] = 396,
    ["schema.org - Place"] = 397,
    ["schema.org - Thing"] = 398,
    ["semantic-release"] = 400,
    ["servicehub.config.json"] = 485,
    ["servicehub.service.json"] = 484,
    ["settings.job"] = 402,
    ["sfdx-hardis configuration"] = 404,
    ["size-limit configuration"] = 406,
    ["skaffold.yaml"] = 548,
    ["skyuxconfig.json"] = 407,
    snapcraft = 408,
    ["stripe-app-local.json"] = 421,
    ["stripe-app.json"] = 420,
    swcrc = 536,
    taskcat = 505,
    ["template.json"] = 429,
    ["templatsources.json"] = 430,
    ["theme.json"] = 432,
    ["tizen_workspace.json"] = 433,
    tmLanguage = 434,
    tmuxinator = 493,
    ["trunk.yaml schema"] = 440,
    ["ts-force-config.json"] = 444,
    ["tsconfig.json"] = 441,
    ["tsd.json"] = 442,
    ["tsdrc.json"] = 443,
    ["tslint.json"] = 445,
    ...
    ["vega-lite.json"] = 456,
    ["vega.json"] = 455,
    ["venvironment-basic.yaml"] = 459,
    ["venvironment.yaml"] = 458,
    ["version.json"] = 460,
    ["vim-addon-info"] = 461,
    ["vs-2017.3.host.json"] = 463,
    ["vs-nesting.json"] = 464,
    ["vsls.json"] = 462,
    ["vss-extension.json"] = 468,
    ["webhint.io"] = 583,
    ["webjobpublishsettings.json"] = 474,
    ["webjobs-list.json"] = 473,
    ["xs-app.json"] = 501,
    ["xunit.runner.json"] = 483,
    yamllint = 524,
    zuul = 510,
    ["Žinoma"] = 518
  },
