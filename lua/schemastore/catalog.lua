...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1044,
    ["API Builder"] = 859,
    ["AVA Configuration"] = 921,
    ...
    ["Adobe UXP Manifest"] = 983,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1072,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 893,
    ["All Contributors configuration file"] = 946,
    ...
    ["Application list for a WinUtil"] = 1026,
    ArchitectFX = 1031,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["BX CI"] = 122,
    ["Bashly (bashly.yml)"] = 950,
    ["Bashly Settings (bashly-settings.yml)"] = 951,
    ["Better Code Hub"] = 863,
    ["Better Scripts"] = 123,
    Bigconfig = 95,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1037,
    BizTalkServerApplicationSchema = 831,
    Bleep = 124,
    ...
    ["Butane Config"] = 906,
    C4InterFlow = 1052,
    ["CDK Environment Manager, concrete environment configuration"] = 1075,
    ["CDK Environment Manager, concrete environments definition"] = 1074,
    ["CDK Environment Manager, environment definition"] = 1073,
    ["CGS Card Game Specification (cgs.json)"] = 988,
    ["CICS TS region tagging"] = 915,
    ["CICS TS resource import"] = 916,
    ["CICS TS resource model"] = 917,
    ["CICS TS resource overrides"] = 918,
    ["CMake Presets"] = 125,
    ["CNC Codes"] = 144,
    ["CRS WAF test file"] = 1016,
    ["CRS WAF test platform overrides file"] = 1017,
    ...
    ["Chamaleon environment"] = 1041,
    ["Chamaleon properties"] = 1042,
    ["Chamaleon template"] = 1040,
    Changesets = 228,
    Charmcraft = 134,
    Cheatsheets = 903,
    ...
    ["Clawject config"] = 150,
    ["Cloud Foundry Application Manifest"] = 999,
    ["Cloud Run Spec v1"] = 1021,
    ...
    Concord = 1015,
    ["Configu .cfgu files"] = 1004,
    ["Configu .configu file"] = 1005,
    Conjure = 143,
    ["Container Structure Test"] = 845,
    Containerlab = 872,
    ["Contextive Glossary"] = 1067,
    Convex = 142,
    ["Crowdsec collection config"] = 238,
    ["Crowdsec parser config"] = 239,
    ["Crowdsec scenario config"] = 240,
    ["CumulusCI Config"] = 149,
    ["Custom Machinery Machine"] = 989,
    ["Custom Machinery Recipe"] = 990,
    ...
    ["DonateCaseBetterCasino menu"] = 1045,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 958,
    ["EAS config"] = 304,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 947,
    ["EasyVCR .NET"] = 305,
    ["Eidolon Resource"] = 1032,
    ...
    ["GeoJSON.json latest"] = 910,
    GherKing = 914,
    ["GitHub Action"] = 335,
    ["GitHub Actions typing"] = 1028,
    ...
    ["Google Digital Assetlinks"] = 1068,
    Goreleaser = 363,
    ["Goreleaser Pro"] = 364,
    Goss = 365,
    ["Gradle Build Cache Node"] = 861,
    ["Gradle Enterprise"] = 860,
    ...
    Hadolint = 841,
    Hammerkit = 871,
    ["Hardware Sentry Configuration"] = 926,
    Hatch = 842,
    Hayson = 378,
    ["Haystack Pipeline"] = 379,
    ["Hazelcast 5 Configuration"] = 380,
    ["Hecate Input Schema"] = 1079,
    ["Helm Chart.lock"] = 183,
    ["Helm Chart.yaml"] = 182,
    ...
    ["JFrog File Spec"] = 409,
    ["JFrog Pipelines YML DSL"] = 935,
    ["JMeter DSL cli config"] = 410,
    JReleaser = 413,
    ["JSON Document Transform"] = 421,
    ["JSON Feed"] = 422,
    ["JSON Resume"] = 641,
    ["JSON Schema Draft 2020-12"] = 810,
    ["JSON Schema Draft 4"] = 807,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 968,
    ["JSON Schema Draft 7"] = 808,
    ["JSON Schema Draft 7 (unofficial strict)"] = 969,
    ["JSON Schema Draft 8 (2019-09)"] = 809,
    ["JSON-API"] = 420,
    ["JSON-e templates"] = 868,
    ["JSON-stat 2.0"] = 803,
    JSONPatch = 424,
    ...
    ["Metadata for a Cinnamon spice"] = 1024,
    ["Metatype Configuration"] = 472,
    ["MetricsHub Configuration"] = 473,
    ["MetricsHub Connector Configuration"] = 474,
    ["Micro Editor Syntax"] = 959,
    ["Microsoft Band Web Tile"] = 475,
    ["Microsoft RulesEngine workflow rules"] = 1012,
    ["Microsoft RulesEngine workflow rules list"] = 1013,
    ["Minecraft Custom Main Menu Mod"] = 977,
    ...
    ["MongoDB Atlas Search Index Definition"] = 930,
    ["Monika Configuration"] = 928,
    ["Monoweave Configuration"] = 500,
    ["Motif config"] = 823,
    MultiQC = 1061,
    ["NOX Framework (Service)"] = 518,
    ["Netin Diagnostic System Template"] = 888,
    ["Netlify config"] = 508,
    ["Network-as-Code Data Model"] = 509,
    ["Nightwatch.js"] = 511,
    ["Node.js configuration"] = 828,
    ...
    ["OpenUtau ustx"] = 536,
    ["OpenWeather Current Weather API"] = 867,
    ["OpenWeather Road Risk API"] = 866,
    ...
    ["Power Pages Configuration"] = 1078,
    ["Preset list for a WinUtil"] = 1027,
    ...
    Pylock = 1069,
    Pyright = 618,
    ["Python script metadata"] = 1063,
    Qgoda = 620,
    Qodana = 898,
    ["Qt Creator workspace file"] = 1006,
    ["Quali Torque Blueprint Spec 2"] = 923,
    ["QueryFirst config file"] = 941,
    ["RKE Cluster Configuration JSON"] = 876,
    ["RKE Cluster Configuration YAML"] = 875,
    RadioHound = 611,
    Railway = 621,
    ["Rancher Fleet"] = 613,
    ["Rattler-build"] = 622,
    ...
    ["SauceCTL Configuration"] = 885,
    ["Schema Catalog"] = 668,
    ["Scoop manifest"] = 673,
    ["Semantic Data Fabric (SDF) file"] = 677,
    ["Semgrep Rule"] = 679,
    ["Serenity Code Generator (Sergen)"] = 680,
    ["Serverless Framework Configuration"] = 892,
    ["Serverless Workflow"] = 894,
    ["Settings for a Cinnamon spice"] = 1023,
    ["Settings.paf"] = 682,
    ["Shopware 6 Configuration"] = 895,
    ["Shopware CLI Extension Store Configuration"] = 896,
    ["Shopware CLI Project Store Configuration"] = 897,
    ["Sigma Detection Rule"] = 684,
    ["Sigrid scope configuration file"] = 685,
    ["SkyPilot Task JSON"] = 982,
    ...
    StackBlitz = 709,
    ["StackHawk Scanner Configuration"] = 891,
    Stale = 710,
    ["Starlake Data Pipeline"] = 864,
    Starship = 711,
    ...
    ["Stylua Config"] = 1070,
    ["Sublime Syntax"] = 937,
    ["Subsquid squid manifest"] = 984,
    ["Swagger API 2.0"] = 720,
    ["Synadia Connect Component"] = 721,
    TSON = 755,
    TSTyche = 756,
    ["Tab data for a LinUtil"] = 1030,
    ["Tab list for a LinUtil"] = 1029,
    Tach = 722,
    ["Tach Domain"] = 723,
    Talhelper = 725,
    ...
    ["Tugboat QA config.yml"] = 1051,
    TunnelHub = 972,
    Turborepo = 739,
    Tycho = 1019,
    Tye = 899,
    ["Tyk Gateway - Open Source v5.7+"] = 1062,
    ["Typst Manifest"] = 761,
    ["UET BuildConfig.json"] = 942,
    ["UI5 Manifest"] = 767,
    ["UNCORS configuration"] = 771,
    ["UTAM Page Object"] = 770,
    ["Ubuntu Server Autoinstall"] = 765,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1055,
    ["Uniswap Token List"] = 852,
    ["Universal Schedule Format"] = 772,
    ["Unreal Engine Uplugin"] = 943,
    ["Unreal Engine Uproject"] = 944,
    ["Updatecli Compose"] = 907,
    ["Updatecli Policy Manifest"] = 908,
    ["Updatecli Policy Metadata"] = 909,
    Uplift = 940,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 873,
    V2Ray = 913,
    ["VSCode Code Snippets"] = 203,
    ["VSIX CLI publishing"] = 792,
    Vector = 774,
    ["Vela Pipeline Configuration"] = 777,
    Vercel = 202,
    ["Version Bumper config"] = 782,
    ["Viash Component Config"] = 1059,
    ["Viash Package Config"] = 1060,
    Visivo = 970,
    Wake = 1053,
    ["Waku Config"] = 1033,
    ["Web App Manifest"] = 798,
    ["Web types"] = 801,
    WebExtensions = 797,
    ["Webman package recipe"] = 919,
    ["Windows Package Manager Installer Manifest"] = 848,
    ["Windows Package Manager Locale Manifest"] = 849,
    ["Windows Package Manager Singleton Manifest"] = 847,
    Winutil = 850,
    ["WireMock stub mapping"] = 1036,
    ["Woodpecker pipeline config"] = 887,
    ["Wrangler CLI"] = 802,
    ["Xstate Machine"] = 905,
    ["Yandex Workflow Language"] = 1025,
    ["Yarn Config (.yarnrc.yml)"] = 862,
    ["Yippee-Ki-JSON configuration YML"] = 854,
    ["YouTrack App"] = 1022,
    ["Zerops.io config"] = 1010,
    ["Zerops.io import"] = 1011,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 975,
    ...
    ["behat.yml"] = 105,
    ["bigquery-table"] = 94,
    ["bioimageio resource description"] = 992,
    ...
    ["crowdin.yml"] = 237,
    ["ctfd-setup configuration file"] = 1043,
    ["custom-elements.json"] = 962,
    ["cypress.json"] = 241,
    ...
    ["gematik health care insurance list"] = 1049,
    ["gematik health care patient list"] = 1046,
    ["gematik health care provider institution list"] = 1048,
    ["gematik health care provider list"] = 1047,
    ["gematik tiger test environment configuration"] = 1050,
    ["gitlab-ci"] = 343,
    ["global.json"] = 359,
    ...
    ["lint-staged (.lintstagedrc)"] = 818,
    ["local.settings.json"] = 462,
    ["localazy.json"] = 463,
    ["lotus.yaml"] = 461,
    ["lsdlschema.json"] = 464,
    ["markdown-link-check"] = 882,
    maturin = 883,
    mboats = 890,
    ["micro-settings.json"] = 954,
    ["mimetypes.json"] = 476,
    ["mirrord config"] = 819,
    mise = 820,
    ["mkdocs.yml"] = 496,
    ["monospace.yml"] = 499,
    ["moon.yml"] = 1035,
    ["mprocs Configuration file"] = 1007,
    ["mrdocs.yml"] = 497,
    ["mta.yaml"] = 821,
    ["mtad.yaml"] = 822,
    ["mycode.json"] = 506,
    ...
    ["plagiarize.yaml"] = 571,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1039,
    ["podbard.yaml"] = 574,
    ["portman.json"] = 575,
    ["prefect.toml"] = 583,
    ["prettierrc.json"] = 584,
    ...
    ["servicehub.config.json"] = 813,
    ["servicehub.service.json"] = 812,
    ["settings.job"] = 681,
    ...
    tldr = 735,
    ["tm_devices configuration file"] = 1076,
    tmuxinator = 816,
    ["transcend.yml"] = 745,
    ...
    ["vega-lite.json"] = 776,
    ["vega.json"] = 775,
    ["venvironment-basic.yaml"] = 779,
    ["venvironment.yaml"] = 778,
    ["venvplus-basic.yaml"] = 781,
    ["venvplus.yaml"] = 780,
    version = 1058,
    ["version.json"] = 783,
    ["vhwdebugger-binding.yaml"] = 785,
    ["vim-addon-info"] = 786,
    ["vs-2017.3.host.json"] = 788,
    ["vs-nesting.json"] = 789,
    ["vsls.json"] = 787,
    ["vss-extension.json"] = 793,
    vtcfg = 1064,
    ["vtesttree.yaml"] = 794,
    ["vtestunit.yaml"] = 795,
    ["warp-keysets.json"] = 963,
    ["warp-themes.json"] = 964,
    ["warp-workflows.json"] = 965,
    ["webhint.io"] = 920,
    ["webjobpublishsettings.json"] = 800,
    ["webjobs-list.json"] = 799,
    ["well-known-fursona"] = 1002,
    ["xs-app.json"] = 825,
    ["xunit.runner.json"] = 811,
    yamllint = 853,
    zuul = 836,
    ["Žinoma"] = 846
  },
