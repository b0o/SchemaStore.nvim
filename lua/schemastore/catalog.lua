...
M.json = {
  ...
  index = {
    ...
    [".pmbot.yml"] = 527,
    [".postcssrc"] = 534,
    [".powerpages-web-template-manifest"] = 536,
    [".pre-commit-config.yml"] = 537,
    [".pre-commit-hooks.yml"] = 538,
    [".putout.json"] = 560,
    [".rehyperc"] = 579,
    [".remarkrc"] = 581,
    [".sprite files"] = 643,
    ...
    ["Adobe UXP Manifest"] = 902,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Alacritty Configuration"] = 814,
    ["All Contributors configuration file"] = 867,
    ...
    ["Application list for a WinUtil"] = 946,
    ArchitectFX = 950,
    ["Argo Events"] = 28,
    ["Argo Workflows"] = 29,
    AssemblyScript = 32,
    ...
    ["Azure Pipelines"] = 64,
    ["Azure Static Web Apps CLI configuration file"] = 646,
    ["Azure Static Web Apps configuration file"] = 645,
    ["BOSH Deploy Config"] = 88,
    ["BX CI"] = 105,
    ["Bashly (bashly.yml)"] = 871,
    ["Bashly Settings (bashly-settings.yml)"] = 872,
    ["Better Code Hub"] = 786,
    ["Better Scripts"] = 106,
    Bigconfig = 81,
    ...
    ["Butane Config"] = 827,
    ["CGS Custom Card Game (CardGameDef.json)"] = 907,
    ["CICS TS region tagging"] = 836,
    ["CICS TS resource import"] = 837,
    ["CICS TS resource model"] = 838,
    ["CICS TS resource overrides"] = 839,
    ["CMake Presets"] = 108,
    ["CNC Codes"] = 123,
    ["CRS WAF test file"] = 936,
    ["CRS WAF test platform overrides file"] = 937,
    ...
    CityJSON = 119,
    ["Clawject config"] = 128,
    ["Cloud Foundry Application Manifest"] = 919,
    ["Cloud Run Spec v1"] = 941,
    ...
    Concord = 935,
    ["Configu .cfgu files"] = 924,
    ["Configu .configu file"] = 925,
    Conjure = 122,
    ["Container Structure Test"] = 769,
    Containerlab = 794,
    ["Crowdsec collection config"] = 212,
    ["Crowdsec parser config"] = 213,
    ["Crowdsec scenario config"] = 214,
    ["CumulusCI Config"] = 127,
    ["Custom Machinery Machine"] = 908,
    ["Custom Machinery Recipe"] = 909,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 879,
    ["EAS config"] = 278,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 868,
    ["EasyVCR .NET"] = 279,
    ["Eidolon Resource"] = 951,
    ...
    ["Goreleaser Pro"] = 335,
    Goss = 336,
    ["Gradle Build Cache Node"] = 784,
    ["Gradle Enterprise"] = 783,
    ...
    Hadolint = 765,
    Hammerkit = 793,
    ["Hardware Sentry Configuration"] = 847,
    Hatch = 766,
    Hayson = 349,
    ...
    ["JFrog File Spec"] = 377,
    ["JFrog Pipelines YML DSL"] = 856,
    ["JMeter DSL cli config"] = 378,
    JReleaser = 380,
    ["JSON Document Transform"] = 388,
    ["JSON Feed"] = 389,
    ["JSON Resume"] = 586,
    ["JSON Schema Draft 2020-12"] = 736,
    ["JSON Schema Draft 4"] = 733,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 889,
    ["JSON Schema Draft 7"] = 734,
    ["JSON Schema Draft 7 (unofficial strict)"] = 890,
    ["JSON Schema Draft 8 (2019-09)"] = 735,
    ["JSON-API"] = 387,
    ["JSON-WF"] = 918,
    ["JSON-e templates"] = 791,
    ["JSON-stat 2.0"] = 729,
    JSONPatch = 391,
    ...
    ["Keycloak REST API"] = 859,
    ["Knative Functions - func.yaml"] = 297,
    ["KoDE/CI build.yaml"] = 852,
    ["Kong DBLess config"] = 853,
    KrakenD = 404,
    ...
    ["Metadata for a Cinnamon spice"] = 944,
    ["MetricsHub Configuration"] = 436,
    ["MetricsHub Connector Configuration"] = 437,
    ["Micro Editor Syntax"] = 880,
    ["Microsoft Band Web Tile"] = 438,
    ["Microsoft RulesEngine workflow rules"] = 932,
    ["Microsoft RulesEngine workflow rules list"] = 933,
    ["Minecraft Custom Main Menu Mod"] = 897,
    ...
    ["MongoDB Atlas Search Index Definition"] = 851,
    ["Monika Configuration"] = 849,
    ["Monoweave Configuration"] = 462,
    ["Motif config"] = 749,
    ["NOX Framework (Service)"] = 479,
    ["Netin Diagnostic System Template"] = 809,
    ["Netlify config"] = 470,
    ...
    ["OpenUtau ustx"] = 495,
    ["OpenWeather Current Weather API"] = 790,
    ["OpenWeather Road Risk API"] = 789,
    ...
    ["Pipeline component"] = 801,
    ["Plex Prerolls"] = 531,
    ["PocketMine plugin.yml"] = 528,
    ["Postman collection"] = 535,
    ["Preset list for a WinUtil"] = 947,
    ["Problem object RFC9457"] = 894,
    ["Problem package generators"] = 544,
    Pterodactyl = 846,
    ["Pull Request Labeler"] = 559,
    Pulumi = 565,
    PyProject = 566,
    Pyright = 567,
    Qgoda = 568,
    Qodana = 819,
    ["Qt Creator workspace file"] = 926,
    ["Quali Torque Blueprint Spec 2"] = 844,
    ["QueryFirst config file"] = 862,
    ["RKE Cluster Configuration JSON"] = 798,
    ["RKE Cluster Configuration YAML"] = 797,
    ["Rancher Fleet"] = 562,
    ["Rattler-build"] = 569,
    Ray = 764,
    ["Read the Docs"] = 564,
    ["Red-DiscordBot Cog"] = 576,
    ["Red-DiscordBot Cog Repo"] = 577,
    ["Red-DiscordBot Trivia"] = 578,
    ["Render Blueprints"] = 796,
    RenderCV = 588,
    Renovate = 587,
    ["Replit config"] = 582,
    RoadRunner = 589,
    ["Rudder techniques"] = 900,
    Ruff = 584,
    ["Rust Project"] = 585,
    ["Rust toolchain"] = 593,
    ["SDMX data message"] = 618,
    ["SDMX metadata message"] = 617,
    ["SDMX structure message"] = 616,
    ["SIL Kit Participant Configuration"] = 628,
    ["SIL Kit Registry Configuration"] = 629,
    SWADL = 657,
    ["Safebox Config"] = 857,
    ["Sapphire CLI Config"] = 596,
    ["SauceCTL Configuration"] = 806,
    ["Schema Catalog"] = 610,
    ["Scoop manifest"] = 615,
    ["Semantic Data Fabric (SDF) file"] = 619,
    ["Semgrep Rule"] = 621,
    ["Serenity Code Generator (Sergen)"] = 622,
    ["Serverless Framework Configuration"] = 813,
    ["Serverless Workflow"] = 815,
    ["Settings for a Cinnamon spice"] = 943,
    ["Settings.paf"] = 624,
    ["Shopware 6 Configuration"] = 816,
    ["Shopware CLI Extension Store Configuration"] = 817,
    ["Shopware CLI Project Store Configuration"] = 818,
    ["Sigma Detection Rule"] = 626,
    ["Sigrid scope configuration file"] = 627,
    ["SkyPilot Task JSON"] = 901,
    ["Slack app manifest"] = 631,
    Solidarity = 634,
    ["Solution filters"] = 635,
    ["Source Maps v3"] = 636,
    Sourcery = 637,
    ["Speakeasy Lint Configuration File"] = 638,
    ["Speakeasy Test Generation Configuration File"] = 639,
    ["Speakeasy Workflow File"] = 640,
    SpecIF = 641,
    ["Sponge Mixin configuration"] = 642,
    StackBlitz = 647,
    ["StackHawk Scanner Configuration"] = 812,
    Stale = 648,
    ["Starlake Data Pipeline"] = 787,
    Starship = 649,
    ["Statamic Blueprint"] = 650,
    ["Stella configuration file"] = 651,
    ["Stryker Mutator"] = 654,
    ["StyleCop Analyzers Configuration"] = 655,
    ["Stylelint (.stylelintrc)"] = 656,
    ["Sublime Syntax"] = 858,
    ["Subsquid squid manifest"] = 903,
    ["Swagger API 2.0"] = 658,
    TSON = 687,
    TSTyche = 688,
    ["Tab data for a LinUtil"] = 949,
    ["Tab list for a LinUtil"] = 948,
    Talhelper = 660,
    ["Talisman configuration"] = 661,
    ["Taskfile config"] = 792,
    Taurus = 662,
    Tauticord = 663,
    ["TestEnvironment.json"] = 672,
    ["TextMate Grammar"] = 671,
    ["Tier.run pricing.json"] = 666,
    Tikibase = 667,
    ["Traefik v2"] = 675,
    ["Traefik v2 File Provider"] = 676,
    ["Travis CI (.travis.yml)"] = 674,
    ["TrueScript for *.tscript files"] = 679,
    TunnelHub = 893,
    Turborepo = 673,
    Tycho = 939,
    Tye = 820,
    ["UET BuildConfig.json"] = 863,
    ["UI5 Manifest"] = 697,
    ["UNCORS configuration"] = 701,
    ["UTAM Page Object"] = 700,
    ["Ubuntu Server Autoinstall"] = 695,
    ["Uniswap Token List"] = 775,
    ["Unreal Engine Uplugin"] = 864,
    ["Unreal Engine Uproject"] = 865,
    ["Updatecli Compose"] = 828,
    ["Updatecli Policy Manifest"] = 829,
    ["Updatecli Policy Metadata"] = 830,
    Uplift = 861,
    ["User Journey Map"] = 795,
    V2Ray = 834,
    ["VSCode Code Snippets"] = 178,
    ["VSIX CLI publishing"] = 718,
    ["Vela Pipeline Configuration"] = 705,
    Vercel = 177,
    ["Version Bumper config"] = 708,
    Visivo = 891,
    ["Waku Config"] = 952,
    ["Web App Manifest"] = 724,
    ["Web types"] = 727,
    WebExtensions = 723,
    ["Webman package recipe"] = 840,
    ["Windows Package Manager Installer Manifest"] = 772,
    ["Windows Package Manager Locale Manifest"] = 773,
    ["Windows Package Manager Singleton Manifest"] = 771,
    ["WireMock stub mapping"] = 955,
    ["Woodpecker pipeline config"] = 808,
    ["Wrangler CLI"] = 728,
    ["Xstate Machine"] = 826,
    ["Yandex Workflow Language"] = 945,
    ["Yarn Config (.yarnrc.yml)"] = 785,
    ["Yippee-Ki-JSON configuration YML"] = 777,
    ["YouTrack App"] = 942,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 895,
    ...
    ["behat.yml"] = 90,
    ["bigquery-table"] = 80,
    ["bioimageio resource description"] = 911,
    ...
    ["lint-staged (.lintstagedrc)"] = 744,
    ["local.settings.json"] = 427,
    ["localazy.json"] = 428,
    ["lotus.yaml"] = 426,
    ["lsdlschema.json"] = 429,
    ["markdown-link-check"] = 804,
    mboats = 811,
    ["micro-settings.json"] = 875,
    ["mimetypes.json"] = 439,
    ["mirrord config"] = 745,
    mise = 746,
    ["mkdocs.yml"] = 459,
    ...
    ["prettierrc.json"] = 542,
    ["prisma.yml"] = 543,
    ["project-1.0.0-beta3.json"] = 546,
    ["project-1.0.0-beta4.json"] = 547,
    ["project-1.0.0-beta5.json"] = 548,
    ["project-1.0.0-beta6.json"] = 549,
    ["project-1.0.0-beta8.json"] = 550,
    ["project-1.0.0-rc1.json"] = 551,
    ["project-1.0.0-rc2.json"] = 552,
    ["project.json"] = 545,
    ["prometheus.json"] = 553,
    ["prometheus.rules.json"] = 554,
    ["prometheus.rules.test.json"] = 555,
    ["proxies.json"] = 556,
    ["publiccode.yml"] = 557,
    ["pubspec.yaml"] = 558,
    ["pyrseas-0.8.json"] = 561,
    ["quilt.mod.json"] = 876,
    ["rc3 auth"] = 570,
    ["rc3 collection"] = 571,
    ["rc3 environment"] = 572,
    ...
    samt = 594,
    samtrc = 595,
    ["sarif-1.0.0.json"] = 597,
    ["sarif-2.0.0.json"] = 598,
    ["sarif-2.1.0"] = 608,
    ["sarif-2.1.0-rtm.2"] = 599,
    ["sarif-2.1.0-rtm.3"] = 601,
    ["sarif-2.1.0-rtm.4"] = 603,
    ["sarif-2.1.0-rtm.5"] = 605,
    ["sarif-2.1.0-rtm.6"] = 606,
    ["sarif-external-property-file-2.1.0"] = 609,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 600,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 602,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 604,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 607,
    ["schema.org - Action"] = 611,
    ["schema.org - ContactPoint"] = 612,
    ["schema.org - Place"] = 613,
    ["schema.org - Thing"] = 614,
    ["secrethub.yml"] = 878,
    ["semantic-release"] = 620,
    ["servicehub.config.json"] = 739,
    ["servicehub.service.json"] = 738,
    ["settings.job"] = 623,
    ["sfdx-hardis configuration"] = 625,
    ["shard.yml"] = 914,
    ["size-limit configuration"] = 630,
    ["skaffold.yaml"] = 802,
    ["skyuxconfig.json"] = 632,
    snapcraft = 633,
    ["spicepod.yaml"] = 934,
    ["sqlc configuration"] = 644,
    ["stripe-app-local.json"] = 653,
    ["stripe-app.json"] = 652,
    swcrc = 788,
    ["task.json"] = 659,
    taskcat = 755,
    ["template.json"] = 664,
    ["templatsources.json"] = 665,
    ["theme.json"] = 668,
    ["tizen_workspace.json"] = 669,
    tldr = 670,
    tmuxinator = 742,
    ["transcend.yml"] = 677,
    ...
    ["vega-lite.json"] = 704,
    ["vega.json"] = 703,
    ["venvironment-basic.yaml"] = 707,
    ["venvironment.yaml"] = 706,
    ["version.json"] = 709,
    ["vhwdebugger-binding.yaml"] = 711,
    ["vim-addon-info"] = 712,
    ["vs-2017.3.host.json"] = 714,
    ["vs-nesting.json"] = 715,
    ["vsls.json"] = 713,
    ["vss-extension.json"] = 719,
    ["vtesttree.yaml"] = 720,
    ["vtestunit.yaml"] = 721,
    ["warp-keysets.json"] = 884,
    ["warp-themes.json"] = 885,
    ["warp-workflows.json"] = 886,
    ["webhint.io"] = 841,
    ["webjobpublishsettings.json"] = 726,
    ["webjobs-list.json"] = 725,
    ["well-known-fursona"] = 922,
    ["xs-app.json"] = 751,
    ["xunit.runner.json"] = 737,
    yamllint = 776,
    ["zerops.io import file"] = 931,
    ["zerops.yml"] = 930,
    zuul = 760,
    ["Žinoma"] = 770
  },
