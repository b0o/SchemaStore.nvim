...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1019,
    [".nodehawkrc"] = 647,
    [".npmpackagejsonlintrc"] = 652,
    [".omletrc"] = 1200,
    [".phrase.yml"] = 730,
    [".phraseapp.yml"] = 731,
    [".pmbot.yml"] = 715,
    [".postcssrc"] = 724,
    [".powerpages-web-template-manifest"] = 726,
    [".pre-commit-config.yml"] = 727,
    [".pre-commit-hooks.yml"] = 728,
    [".putout.json"] = 764,
    [".rehyperc"] = 789,
    [".remarkrc"] = 793,
    [".sprite files"] = 891,
    ...
    AIConfig = 43,
    ["AMX Muse Program Descriptor"] = 1249,
    ["API Builder"] = 1055,
    ["AVA Configuration"] = 1119,
    ...
    ["AWS Copilot Manifest"] = 1288,
    ["AWS SAM CLI Samconfig"] = 287,
    Acton = 1339,
    ["Adobe UXP Manifest"] = 1182,
    ["Aerleon Network & Service Definitions"] = 25,
    ["Aerleon Policy"] = 26,
    ["Agent Permission Policy"] = 1328,
    ["AgentCore CLI"] = 1329,
    AgentLoopKit = 1330,
    Aider = 1278,
    Air = 28,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1299,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1298,
    ["Airlock Microgateway"] = 44,
    ["Alacritty Configuration"] = 1091,
    ["AlgoVoi Compliance Receipt v1"] = 15,
    ["All Contributors configuration file"] = 1145,
    Anodizer = 468,
    ["Ansible Argument Specs"] = 451,
    ["Ansible Collection Galaxy"] = 458,
    ["Ansible Execution Environment"] = 448,
    ["Ansible Inventory"] = 457,
    ["Ansible Meta"] = 449,
    ["Ansible Meta Runtime"] = 450,
    ["Ansible Navigator Configuration"] = 460,
    ["Ansible Playbook"] = 455,
    ["Ansible Requirements"] = 452,
    ["Ansible Rulebook"] = 456,
    ["Ansible Tasks File"] = 454,
    ["Ansible Vars File"] = 453,
    ["Ansible-lint Configuration"] = 459,
    Any = 1210,
    ...
    ["Application list for a WinUtil"] = 1228,
    ArchitectFX = 1233,
    ["Argo CD"] = 63,
    ["Argo Events"] = 64,
    ["Argo Workflows"] = 65,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1297,
    ["Azure IoT Operations connector metadata"] = 1294,
    ...
    ["Azure Pipelines"] = 123,
    ["Azure Static Web Apps CLI configuration file"] = 895,
    ["Azure Static Web Apps configuration file"] = 894,
    BMML = 1316,
    ["BOSH BPM Config"] = 149,
    ["BOSH CPI Config"] = 150,
    ...
    ["Bacon config"] = 9,
    ["Barba-CV"] = 92,
    ["Bashly (bashly.yml)"] = 1149,
    ["Bashly Settings (bashly-settings.yml)"] = 1150,
    Bento = 1315,
    ["Better Code Hub"] = 1060,
    ["Better Scripts"] = 173,
    Bigconfig = 142,
    ["Biome Formatter Config"] = 93,
    ["Bitmovin Encoding Template"] = 1242,
    BizTalkServerApplicationSchema = 1026,
    Bleep = 174,
    ["Block Protocol Metadata"] = 171,
    ["Bluebricks blueprint config"] = 1321,
    ["Boyka Framework"] = 152,
    ...
    ["Butane Config"] = 1104,
    C4InterFlow = 1257,
    ["CDK Environment Manager, concrete environment configuration"] = 1281,
    ["CDK Environment Manager, concrete environments definition"] = 1280,
    ["CDK Environment Manager, environment definition"] = 1279,
    ["CGS Card Game Specification (cgs.json)"] = 1187,
    ["CICS TS region tagging"] = 1113,
    ["CICS TS resource import"] = 1114,
    ["CICS TS resource model"] = 1115,
    ["CICS TS resource overrides"] = 1116,
    ["CMake Presets"] = 175,
    ["CNC Codes"] = 197,
    ["CRS WAF test file"] = 1217,
    ["CRS WAF test platform overrides file"] = 1218,
    ...
    ["Caido Proxy Configuration"] = 1353,
    ...
    ["Chamaleon environment"] = 1246,
    ["Chamaleon properties"] = 1247,
    ["Chamaleon template"] = 1245,
    Changepacks = 1308,
    Changesets = 296,
    Changie = 184,
    Charmcraft = 185,
    ...
    ["Clawject config"] = 203,
    ["Cloud Foundry Application Manifest"] = 1199,
    ["Cloud Run Spec v1"] = 1223,
    ...
    Concord = 1216,
    ["Configu .cfgu files"] = 1204,
    ["Configu .configu file"] = 1205,
    Conjure = 196,
    ["Container Structure Test"] = 1040,
    Containerlab = 1069,
    ["Contextive Glossary"] = 1273,
    ContractGuard = 1070,
    Convex = 195,
    ...
    ["Cursor Agent Environment"] = 1326,
    ["Custom Machinery Machine"] = 1188,
    ["Custom Machinery Recipe"] = 1189,
    ...
    ["DataYoga Job"] = 213,
    ["Datadog Continuous Testing"] = 554,
    ["Datadog Service Definition"] = 555,
    ["Datadog Software Catalog"] = 556,
    ["Datahub Ingestion Recipe"] = 1120,
    ["Debian Upstream Metadata file"] = 220,
    DebtLens = 221,
    ["Deck config"] = 222,
    ["Declarative Automation Bundles"] = 1166,
    ["DeepMatch deeplinks spec"] = 223,
    ["Dein Config"] = 224,
    ["Deno Config (deno.json)"] = 325,
    ["Dependency cruiser"] = 225,
    ["DeployStack Configuration"] = 226,
    ["Deployah Configuration"] = 1296,
    ["Deployer Recipe"] = 328,
    ["Deta Spacefile"] = 227,
    ...
    ["DonateCaseBetterCasino menu"] = 1250,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1157,
    ["EAS config"] = 396,
    ["ECA - Editor Code Assistant"] = 360,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1146,
    ["ESLint Suppressions"] = 401,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1293,
    ["EasyVCR .NET"] = 398,
    ["Eidolon Resource"] = 1234,
    ...
    ["Envelope Team Definition"] = 1338,
    ["Envilder Map File"] = 364,
    ["Erda Pipeline"] = 1195,
    ["Erda Runtime"] = 1196,
    ["Espanso config.yml"] = 1319,
    ["Espanso match.yml"] = 1318,
    Esquio = 384,
    ["Estuary Flow Catalog"] = 1110,
    ["Ethereum ERC1155"] = 1332,
    ["Ethereum ERC721"] = 1331,
    ...
    ["Evolving Resolutive Process notation"] = 1295,
    ["Expo SDK"] = 395,
    ...
    ["GeoJSON.json latest"] = 1108,
    GherKing = 1112,
    ["GitHub Action"] = 435,
    ["GitHub Actions typing"] = 1230,
    ["GitHub Discussion"] = 436,
    ["GitHub Funding"] = 437,
    ["GitHub Issue Template configuration"] = 438,
    ["GitHub Issue Template forms"] = 439,
    ["GitHub Pages Jekyll"] = 440,
    ["GitHub Workflow"] = 441,
    ["GitHub Workflow Template Properties"] = 442,
    ["GitHub automatically generated release notes configuration"] = 443,
    ["GitLab Agent for Kubernetes configuration"] = 1184,
    GitResume = 447,
    GitVersion = 431,
    ["Gitea Issue Template configuration"] = 433,
    ["Gitea Issue Template forms"] = 434,
    Gitleaks = 432,
    ["Gitpod Automations"] = 445,
    ["Gitpod Configuration"] = 446,
    ["Glamour style"] = 429,
    ["GlazeWM settings"] = 1186,
    ["Global Privacy Control"] = 430,
    Goblet = 1165,
    ["Golangci-lint Configuration"] = 462,
    ["Golangci-lint Custom Plugins Configuration"] = 463,
    ["Google Chrome Related Website Sets"] = 406,
    ["Google Cloud Workflows"] = 283,
    ["Google Digital Assetlinks"] = 1274,
    Goreleaser = 466,
    ["Goreleaser Pro"] = 467,
    Goss = 469,
    ["Gradle Build Cache Node"] = 1058,
    ["Gradle Enterprise"] = 1057,
    ["Grafana 5.x Dashboard"] = 470,
    ["GraphQL Code Generator"] = 475,
    ["GraphQL Config"] = 474,
    ["GraphQL Mesh"] = 473,
    ["GroovyLint configuration"] = 476,
    ["Grunt JSHint task"] = 480,
    ["Grunt Watch task"] = 481,
    ["Grunt base task"] = 482,
    ["Grunt clean task"] = 478,
    ["Grunt copy task"] = 477,
    ["Grunt cssmin task"] = 479,
    HEMTT = 1022,
    Hadolint = 1036,
    Hammerkit = 1068,
    ["Hardware Sentry Configuration"] = 1124,
    ["Hashgraph Online Skill Manifest"] = 5,
    ["HashiCorp Vault"] = 483,
    Hatch = 1037,
    Hayson = 485,
    ["Haystack Pipeline"] = 486,
    ["Hazelcast 5 Configuration"] = 487,
    ["Hecate Input Schema"] = 1285,
    ["Helm Chart.lock"] = 245,
    ["Helm Chart.yaml"] = 244,
    ["Helm Unittest Test Suite"] = 246,
    ["Hex file"] = 247,
    ["Home Assistant Integration Manifest"] = 488,
    ["Homer dashboard configuration"] = 489,
    Hugo = 1100,
    ["Hugo Theme"] = 1099,
    ["Hulak Configuration"] = 496,
    ["Hyperfoil benchmark configuration"] = 495,
    ["IBM Zapp document"] = 497,
    ["IBM zCodeFormatSettings"] = 498,
    ["IMG Catapult PSP"] = 503,
    ["IVMS101 by CODE Protocol"] = 1185,
    ["Infinispan Configuration"] = 505,
    ["Infinispan Server Configuration"] = 506,
    Infrahub = 507,
    Istanbul = 1128,
    ["JDownloader2 crawler multi-rules"] = 521,
    ["JDownloader2 crawler single-rules"] = 520,
    ["JFrog Applications Config"] = 522,
    ["JFrog File Spec"] = 523,
    ["JFrog Pipelines YML DSL"] = 1134,
    ["JMeter DSL cli config"] = 524,
    JReleaser = 527,
    ["JSON Document Transform"] = 535,
    ["JSON Feed"] = 536,
    ["JSON Resume"] = 801,
    ["JSON Schema Draft 2020-12"] = 1003,
    ["JSON Schema Draft 4"] = 1000,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1167,
    ["JSON Schema Draft 7"] = 1001,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1168,
    ["JSON Schema Draft 8 (2019-09)"] = 1002,
    ["JSON-API"] = 534,
    ["JSON-e templates"] = 1065,
    ["JSON-stat 2.0"] = 996,
    JSONPatch = 538,
    ["JSR Package Config (jsr.json)"] = 528,
    Jarl = 1301,
    Jasmine = 515,
    Jekyll = 516,
    ["Jenkins X Pipelines"] = 517,
    ["Jenkins X Requirements"] = 518,
    Jest = 519,
    Jocker = 525,
    ["Jovo Language Models"] = 526,
    ["Jujutsu (jj) VCS config"] = 1287,
    ["KIMMDY config file"] = 549,
    ["KODE/CI build.yaml"] = 1130,
    ["KSP-AVC"] = 997,
    ["KSP-CKAN"] = 998,
    ["KSP-NetKAN"] = 999,
    KSY = 1197,
    ...
    Kas = 541,
    ["Kestra flow file"] = 550,
    ["Keycloak REST API"] = 1137,
    ["Knative Functions - func.yaml"] = 419,
    Knip = 420,
    ["Knowledge Unit"] = 558,
    ["Kometa (nightly) config file"] = 552,
    ["Kometa config file"] = 551,
    ["Kong DBLess config"] = 1131,
    KrakenD = 553,
    ["Kubri Configuration"] = 561,
    LOOBin = 576,
    ["Lake configuration file"] = 1290,
    ...
    ["Lando (landofile)"] = 119,
    ["LangGraph Platform configuration"] = 1209,
    ["Language configuration"] = 1208,
    Lefthook = 565,
    ["Liferay client-extension.yaml"] = 572,
    ["LinkML Metamodel"] = 574,
    Liquibase = 1075,
    ["Liquibase Flow File"] = 1076,
    ["Lively Properties"] = 575,
    ["Lobe AI Agent"] = 121,
    Loki = 122,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 618,
    ["MS2Rescore Configuration"] = 624,
    ["MSTest testconfig.json"] = 625,
    ["Madness (madness.yml)"] = 1148,
    ["Mado configuration"] = 582,
    ["Maestro Flow"] = 583,
    ["Mail Servers Configuration"] = 1322,
    ["MapEHR Mapping"] = 584,
    Markdownlint = 1079,
    ["Mason Registry"] = 1082,
    ["MegaLinter Custom Flavor"] = 587,
    ["MegaLinter configuration"] = 586,
    ["MegaLinter descriptor"] = 588,
    Melange = 1175,
    ["Meltano project definition"] = 589,
    ["Mergify Configuration"] = 626,
    ["Metadata for a Bazel module"] = 590,
    ["Metadata for a Cinnamon spice"] = 1226,
    ["Metatype Configuration"] = 591,
    ["MetricsHub Configuration"] = 592,
    ["MetricsHub Connector Configuration"] = 593,
    ["Micro Editor Syntax"] = 1158,
    ["Microsoft Band Web Tile"] = 594,
    ["Microsoft RulesEngine workflow rules"] = 1213,
    ["Microsoft RulesEngine workflow rules list"] = 1214,
    ["Minecraft Custom Main Menu Mod"] = 1176,
    ["Minecraft Data Pack Advancement"] = 596,
    ["Minecraft Data Pack Biome"] = 597,
    ["Minecraft Data Pack Configured Carver"] = 598,
    ["Minecraft Data Pack Damage Type"] = 599,
    ["Minecraft Data Pack Dimension"] = 601,
    ["Minecraft Data Pack Dimension Type"] = 600,
    ["Minecraft Data Pack Item Modifier"] = 602,
    ["Minecraft Data Pack Loot Table"] = 603,
    ["Minecraft Data Pack Metadata"] = 604,
    ["Minecraft Data Pack Predicate"] = 605,
    ["Minecraft Data Pack Recipe"] = 606,
    ["Minecraft Data Pack Tag"] = 607,
    ["Minecraft Data Pack Template Pool"] = 608,
    ["Minecraft Data Pack Trim Material"] = 613,
    ["Minecraft Data Pack Trim Pattern"] = 614,
    ["Minecraft Resource Pack Lang"] = 609,
    ["Minecraft Resource Pack Particle"] = 610,
    ["Minecraft Resource Pack Texture Mcmeta"] = 612,
    ["Minecraft Resourcepack Sounds"] = 611,
    ["MockServer Expectations"] = 620,
    ModuleAssembler = 616,
    ["Monade CLI Stack Configuration"] = 629,
    ["MongoDB Atlas Search Index Definition"] = 1129,
    ["Monika Configuration"] = 1127,
    ["Monoweave Configuration"] = 623,
    ["Motif config"] = 1018,
    MultiQC = 1267,
    ["NOX Framework (Service)"] = 651,
    ["Netin Diagnostic System Template"] = 1086,
    ["Netlify config"] = 632,
    ["Network-as-Code Data Model"] = 633,
    ["Next Gen UI Agent A2A Server Configuration"] = 634,
    ["Next Gen UI Agent Configuration"] = 636,
    ["Next Gen UI Agent MCP Server Configuration"] = 635,
    ["Nightwatch.js"] = 643,
    ["Nika workflow"] = 648,
    ["Node.js configuration"] = 1023,
    ["NueJS configuration file"] = 656,
    ["Nuitka Package Config"] = 1190,
    ["Nullstone config"] = 658,
    ["ONe's changelog entry"] = 677,
    ["ONe's service descriptor"] = 676,
    ["ORT Server repository environment configuration"] = 687,
    ["OSCAL Assessment Plan (AP)"] = 689,
    ["OSCAL Assessment Results (AR)"] = 690,
    ["OSCAL Catalog"] = 691,
    ["OSCAL Component Definition (CDef)"] = 692,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 693,
    ["OSCAL Profile"] = 694,
    ["OSCAL System Security Plan (SSP)"] = 695,
    ["OSS Review Toolkit configuration"] = 696,
    ["OSS Review Toolkit curation"] = 697,
    ["OSS Review Toolkit package configuration"] = 698,
    ["OSS Review Toolkit project package manager definition"] = 699,
    ["OSS Review Toolkit repository configuration"] = 700,
    ["OSS Review Toolkit resolutions"] = 701,
    ["October CMS columns"] = 662,
    ["October CMS fields"] = 663,
    ["Oh My Posh"] = 665,
    Okteto = 666,
    ["Ona Automations"] = 668,
    Opctl = 1021,
    ["Open Data Contract Standard (ODCS)"] = 681,
    ["Open Data Product Standard (ODPS)"] = 682,
    ["Open Know-How"] = 1272,
    OpenDecree = 1336,
    ["OpenDecree Configuration"] = 1337,
    ["OpenRewrite Resource"] = 679,
    OpenSRM = 683,
    OpenStatus = 1283,
    ["OpenTelemetry Declarative Configuration"] = 680,
    ["OpenUtau character yaml"] = 673,
    ["OpenUtau ustx"] = 674,
    ["OpenWeather Current Weather API"] = 1064,
    ["OpenWeather Road Risk API"] = 1063,
    ["Ory Hydra configuration"] = 494,
    ["Ory Keto configuration"] = 557,
    ["Ory Kratos configuration"] = 688,
    ["Ory Oathkeeper configuration"] = 660,
    ["Outblocks App configuration"] = 685,
    ["Outblocks database table"] = 686,
    ["Outblocks project configuration"] = 684,
    PDM = 709,
    POPxf = 721,
    ["POPxf Correlations"] = 722,
    ["PRML manifest"] = 729,
    Packer = 705,
    PactSpec = 706,
    Panache = 707,
    Pantsbuild = 1144,
    ["Paper paper-plugin.yml"] = 708,
    ["Pipeline component"] = 1077,
    ["Platform.sh application"] = 11,
    ["Platform.sh routes"] = 12,
    ["Platform.sh services"] = 13,
    ["Plex Prerolls"] = 719,
    ["PocketMine plugin.yml"] = 716,
    ["Podman Desktop Extension"] = 1355,
    ["Postman collection"] = 725,
    ["Power Pages Configuration"] = 1284,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1229,
    ["ProActions AI-Kit Configuration"] = 737,
    ["ProActions AI-Kit Configuration for Menus"] = 739,
    ["ProActions AI-Kit Configuration for Sections"] = 741,
    ["ProActions AI-Kit Configuration for Services"] = 738,
    ["ProActions AI-Kit Configuration for Steps"] = 742,
    ["ProActions AI-Kit Configuration for Templates"] = 740,
    ["Problem object RFC9457"] = 1173,
    ["Problem package format"] = 743,
    ["Problem package generators"] = 744,
    ["Problem package submissions"] = 745,
    ["Problem package test group metadata"] = 746,
    Pterodactyl = 1123,
    ["Pull Request Labeler"] = 763,
    Pulumi = 771,
    ["PyGTA Config"] = 767,
    PyProject = 772,
    Pylock = 1275,
    Pyright = 773,
    ["Python script metadata"] = 1269,
    ["QType AI DSL"] = 776,
    Qgoda = 775,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1347,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1345,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1351,
    ["Qlik Talend Cloud Pipeline - Project"] = 1343,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1346,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1348,
    ["Qlik Talend Cloud Pipeline - Task"] = 1344,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1350,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1349,
    Qodana = 1096,
    ["Qt Creator workspace file"] = 1206,
    ["Quali Torque Blueprint Spec 2"] = 1121,
    ["QueryFirst config file"] = 1140,
    ["QuikRun Configuration"] = 1352,
    ["Qwen Code Settings"] = 1333,
    ["RKE Cluster Configuration JSON"] = 1074,
    ["RKE Cluster Configuration YAML"] = 1073,
    RadioHound = 766,
    ["Raid Profile"] = 1334,
    ["Raid Repo Configuration"] = 1335,
    Railpack = 778,
    Railway = 777,
    ["Rancher Fleet"] = 768,
    ["Rattler-build"] = 779,
    Ray = 1035,
    ["Read the Docs"] = 770,
    ["Red-DiscordBot Cog"] = 786,
    ["Red-DiscordBot Cog Repo"] = 787,
    ["Red-DiscordBot Trivia"] = 788,
    ["Releasaurus Config"] = 8,
    ReleaseKit = 7,
    ["Render Blueprints"] = 1072,
    RenderCV = 805,
    Renovate = 802,
    ["Renovate global configuration"] = 803,
    ["Renovate inherited configuration"] = 804,
    ["Replit config"] = 794,
    Restate = 1262,
    ["Revel Digital Gadget Definition File"] = 1286,
    RoadRunner = 807,
    ["Robust Station Image"] = 1292,
    Rockcraft = 808,
    ["Roo Coder Custom Modes"] = 809,
    Rubocop = 798,
    ["Rudder techniques"] = 1180,
    Ruff = 799,
    ["Rust Project"] = 800,
    ["Rust toolchain"] = 814,
    ["SDMX data message"] = 841,
    ["SDMX metadata message"] = 840,
    ["SDMX structure message"] = 839,
    ["SIL Kit Participant Configuration"] = 852,
    ["SIL Kit Registry Configuration"] = 853,
    ["SPDX 2.3"] = 892,
    SWADL = 908,
    ["Safebox Config"] = 1135,
    ["Sapphire CLI Config"] = 817,
    ["SauceCTL Configuration"] = 1083,
    Scarb = 837,
    ["Schema Catalog"] = 832,
    ["Scoop manifest"] = 838,
    ["Secure SDLC Evidence Bundle"] = 842,
    ["Semantic Data Fabric (SDF) file"] = 843,
    ["Semgrep Rule"] = 845,
    ["Serenity Code Generator (Sergen)"] = 846,
    ["Serverless Framework Configuration"] = 1090,
    ["Serverless Workflow"] = 1092,
    ["Settings for a Cinnamon spice"] = 1225,
    ["Settings.paf"] = 848,
    ["Shopware 6 Configuration"] = 1093,
    ["Shopware CLI Extension Store Configuration"] = 1094,
    ["Shopware CLI Project Store Configuration"] = 1095,
    ["Sigma Detection Rule"] = 850,
    ["SigmaCV CV"] = 3,
    ["Sigrid scope configuration file"] = 851,
    ["SkyPilot Task JSON"] = 1181,
    ["Slack app manifest"] = 855,
    ["Slang Server Configuration"] = 1359,
    Snapcraft = 857,
    ["Solarxy project config"] = 860,
    Solidarity = 861,
    ["Solution filters"] = 862,
    ["Source Maps v3"] = 863,
    Sourcery = 864,
    ["Spack bootstrap.yaml"] = 865,
    ["Spack cdash.yaml"] = 866,
    ["Spack ci.yaml"] = 867,
    ["Spack compilers.yaml"] = 868,
    ["Spack concretizer.yaml"] = 869,
    ["Spack config.yaml"] = 870,
    ["Spack definitions.yaml"] = 871,
    ["Spack develop.yaml"] = 872,
    ["Spack env_vars.yaml"] = 873,
    ["Spack environment"] = 879,
    ["Spack include.yaml"] = 874,
    ["Spack mirrors.yaml"] = 875,
    ["Spack modules.yaml"] = 876,
    ["Spack packages.yaml"] = 877,
    ["Spack repos.yaml"] = 878,
    ["Spack toolchains.yaml"] = 880,
    ["Spack upstreams.yaml"] = 881,
    ["Spack view.yaml"] = 882,
    ["Speakeasy Generation Config File"] = 886,
    ["Speakeasy Lint Configuration File"] = 883,
    ["Speakeasy Test Generation Configuration File"] = 884,
    ["Speakeasy Workflow File"] = 885,
    SpecIF = 887,
    ["Specmatic Configuration"] = 888,
    ["Specpin spec file"] = 1,
    ["Sponge Mixin configuration"] = 889,
    ["Spotlight Ruleset"] = 890,
    StackBlitz = 896,
    ["StackHawk Scanner Configuration"] = 1089,
    Stale = 897,
    Starfish = 898,
    ["Starlake Data Pipeline"] = 1061,
    Starship = 899,
    ["Statamic Blueprint"] = 900,
    ["Stella configuration file"] = 901,
    ["Streamlit configuration file"] = 902,
    ["Stryker Mutator"] = 905,
    ["StyleCop Analyzers Configuration"] = 906,
    ["Stylelint (.stylelintrc)"] = 907,
    ["Stylua Config"] = 1276,
    ["Sublime Syntax"] = 1136,
    ["Subsquid squid manifest"] = 1183,
    ["Swagger API 2.0"] = 909,
    ["Synadia Connect Component"] = 910,
    TSON = 946,
    TSTyche = 947,
    ["TYPO3 Vendor Bundler config"] = 953,
    ["Tab data for a LinUtil"] = 1232,
    ["Tab list for a LinUtil"] = 1231,
    Tach = 911,
    ["Tach Domain"] = 912,
    Talhelper = 914,
    ["Talisman configuration"] = 915,
    Taplo = 1277,
    ["Taskfile config"] = 1066,
    Taurus = 916,
    Tauticord = 917,
    ["Tekton Pipeline"] = 1305,
    ["Tekton PipelineRun"] = 1306,
    ["Tekton Task"] = 1303,
    ["Tekton TaskRun"] = 1304,
    Telefonistka = 1263,
    ["Terrateam config"] = 1289,
    ["TestEnvironment.json"] = 929,
    ["TextMate Grammar"] = 928,
    Threagile = 923,
    ["Tier.run pricing.json"] = 920,
    Tikibase = 921,
    Tombi = 926,
    ["Traefik v2"] = 932,
    ["Traefik v2 File Provider"] = 933,
    ["Traefik v3"] = 934,
    ["Traefik v3 File Provider"] = 935,
    ["Travis CI (.travis.yml)"] = 931,
    Treefmt = 472,
    Trident = 1259,
    ["TrueScript for *.tscript files"] = 938,
    ["Tugboat QA config.yml"] = 1256,
    TunnelHub = 1171,
    Turborepo = 930,
    Tycho = 1220,
    Tye = 1097,
    ["Tyk Gateway - Open Source v5.7+"] = 1268,
    ["UET BuildConfig.json"] = 1141,
    ["UI5 Manifest"] = 959,
    ["UNCORS configuration"] = 964,
    ["UTAM Page Object"] = 962,
    ["Ubuntu Server Autoinstall"] = 957,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1260,
    ["Uniswap Token List"] = 1046,
    ["Universal Schedule Format"] = 965,
    ["Unreal Engine Uplugin"] = 1142,
    ["Unreal Engine Uproject"] = 1143,
    ["UpCloud CLI (upctl) configuration"] = 1261,
    ["Updatecli Compose"] = 1105,
    ["Updatecli Policy Manifest"] = 1106,
    ["Updatecli Policy Metadata"] = 1107,
    Uplift = 1139,
    ["Upsun config"] = 10,
    ["User Journey Map"] = 1071,
    V2Ray = 1111,
    ["VSCode Code Snippets"] = 271,
    ["VSIX CLI publishing"] = 983,
    Vector = 967,
    ["Vela Pipeline Configuration"] = 970,
    Vercel = 270,
    ["Version Bumper config"] = 973,
    Vespertide = 1310,
    ["Vespertide Migration"] = 1311,
    ["Vespertide Model"] = 1312,
    ["Viash Component Config"] = 1265,
    ["Viash Package Config"] = 1266,
    Visivo = 1169,
    ["WP-CLI"] = 993,
    Wake = 1258,
    ["Waku Config"] = 1235,
    ["Web App Manifest"] = 989,
    ["Web types"] = 992,
    WebExtensions = 988,
    ["Webman package recipe"] = 1117,
    ["Windows Package Manager Installer Manifest"] = 1043,
    ["Windows Package Manager Locale Manifest"] = 1044,
    ["Windows Package Manager Singleton Manifest"] = 1042,
    ["WireMock CLI import configuration"] = 1241,
    ["WireMock CLI local service configuration"] = 1240,
    ["WireMock message stub mapping"] = 1239,
    ["WireMock stub mapping"] = 1238,
    ["Woodpecker pipeline config"] = 1085,
    ["Wrangler CLI"] = 994,
    ["XenForo add-on manifest"] = 995,
    ["Xstate Machine"] = 1103,
    ["Yandex Workflow Language"] = 1227,
    ["Yarn Config (.yarnrc.yml)"] = 1059,
    ["Yippee-Ki-JSON configuration YML"] = 1050,
    ["YouTrack App"] = 1224,
    ["Zarf Package Configuration"] = 1291,
    ["Zerops import file"] = 1212,
    ["Zola Configuration"] = 1302,
    abtop = 30,
    actionlint = 40,
    ["aerleon.yml"] = 24,
    ["amplify.yml"] = 17,
    ["amxx-builder manifest"] = 1354,
    ["angular.json"] = 45,
    apko = 1174,
    ...
    ["behat.yml"] = 153,
    ["bigquery-table"] = 141,
    ["bioimageio resource description"] = 1191,
    ...
    ["cargo-nextest repository configuration"] = 637,
    ["cargo-nextest user configuration"] = 638,
    ["ccmod.json"] = 1236,
    changelogging = 1203,
    ...
    ["chutzpah.json"] = 279,
    cibuildwheel = 190,
    ["clang-format (.clang-format)"] = 1109,
    ["clang-tidy"] = 253,
    clangd = 252,
    clib = 254,
    ...
    ["crowdin.yml"] = 306,
    ["ctfd-setup configuration file"] = 1248,
    ["custom-elements.json"] = 1161,
    ["cypress.json"] = 310,
    ["dacier.yml"] = 1342,
    ...
    ["gematik health care insurance list"] = 1254,
    ["gematik health care patient list"] = 1251,
    ["gematik health care provider institution list"] = 1253,
    ["gematik health care provider list"] = 1252,
    ["gematik tiger test environment configuration"] = 1255,
    ["git-town.toml"] = 1300,
    ["gitlab-ci"] = 444,
    ["global.json"] = 461,
    ["go-feature-flag Flag Configuration"] = 465,
    gollama = 464,
    ["haxelib.json"] = 484,
    helmfile = 1038,
    helmwave = 1039,
    ...
    ["ide.host.json"] = 499,
    ["ifstate.yaml"] = 500,
    ["imageoptimizer.json"] = 501,
    ["importmap.json"] = 504,
    ["index.toml (packwiz)"] = 1356,
    instant_python_config = 508,
    instant_python_custom_project = 509,
    intlayer = 510,
    ["ioBroker Configuration"] = 511,
    ["ioBroker JSON UI"] = 512,
    ["ioBroker Package manifest"] = 513,
    ["ixpect.conf.yaml"] = 514,
    ["ize.toml"] = 1138,
    ["jsconfig.json"] = 539,
    ["jscpd Configuration"] = 1122,
    jsdoc = 1034,
    ["k3d.yaml"] = 540,
    ["k9s aliases.yaml"] = 542,
    ["k9s cluster-config.yaml"] = 544,
    ["k9s config.yaml"] = 543,
    ["k9s hotkeys.yaml"] = 545,
    ["k9s plugins.yaml"] = 546,
    ["k9s skin.yaml"] = 547,
    ["k9s views.yaml"] = 548,
    ["kontinuous-config.yaml"] = 560,
    ["kontinuous-values.yaml"] = 559,
    ["kustomization.yaml"] = 562,
    ["label-commenter-config.yml"] = 563,
    ["latexindent configuration"] = 120,
    ["launchsettings.json"] = 564,
    lazydocker = 1160,
    lazygit = 1159,
    ["lego.json"] = 566,
    ["lerna.json"] = 567,
    ["lgtm.yml"] = 568,
    ["liblab.config.json"] = 569,
    ["libman.json"] = 570,
    ["license-report-config.json"] = 571,
    ["linkinator.config.json"] = 573,
    ["lint-staged (.lintstagedrc)"] = 1012,
    ["local.settings.json"] = 578,
    ["localazy.json"] = 579,
    ["lotus.yaml"] = 577,
    ["lsdlschema.json"] = 580,
    lychee = 1011,
    ["macro.json"] = 1126,
    ["markdown-link-check"] = 1080,
    maturin = 1081,
    mboats = 1088,
    memnex = 1340,
    ["micro-settings.json"] = 1153,
    ["mimetypes.json"] = 595,
    ["mirrord config"] = 1014,
    mise = 1015,
    ["mkdocs.yml"] = 615,
    ["mockd.yaml"] = 619,
    ["mod.pw.toml (packwiz)"] = 1357,
    ["modelparams.dev Model"] = 621,
    ["monospace.yml"] = 622,
    ["moon.yml"] = 1237,
    ["mprocs Configuration file"] = 1207,
    ["mrdocs.yml"] = 617,
    ["mta.yaml"] = 1016,
    ["mtad.yaml"] = 1017,
    ["mycode.json"] = 630,
    nFPM = 642,
    ["napari plugin manifest"] = 631,
    neoload = 1029,
    ["nest-cli"] = 645,
    ["nexus-rpc-gen"] = 1327,
    ["nf-core module environment.yml"] = 639,
    ["nf-core module meta.yml"] = 640,
    ["nf-core subworkflow meta.yml"] = 641,
    ["ninjs (News in JSON)"] = 644,
    ["nitro.json"] = 1028,
    ["nixd configuration"] = 1179,
    ["nlu.json"] = 646,
    ["nodemon.json"] = 649,
    ["noodl config"] = 1087,
    ["notebook.mod.json"] = 650,
    now = 1024,
    ["npm-badges"] = 653,
    ["nswag.json"] = 657,
    ntangle = 659,
    ["nuclei-template.yaml"] = 654,
    ["nuget-project.json"] = 655,
    ["ocelot.json"] = 661,
    ogen = 664,
    ["omnisharp.json"] = 667,
    openHAB = 1313,
    ...
    oxfmt = 1323,
    oxlint = 1324,
    ["pack.toml (packwiz)"] = 1358,
    ["package.json"] = 702,
    ["package.manifest"] = 704,
    ["package.yaml"] = 703,
    ["partial-black.json"] = 154,
    ["partial-fastapi.json"] = 155,
    ["partial-pixi.json"] = 714,
    ["partial-scheduled.json"] = 156,
    ["pattern.json"] = 712,
    ["petstore-v1.0"] = 1133,
    pgap_yaml_input_reader = 710,
    pgrls = 711,
    pgxgen = 1317,
    pitcms = 1320,
    ["pixi.toml"] = 713,
    ["plagiarize-me.yaml"] = 718,
    ["plagiarize.yaml"] = 717,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1244,
    ["podbard.yaml"] = 720,
    ["portman.json"] = 723,
    ["prefect.toml"] = 732,
    ["prefect.yaml"] = 733,
    ...
    ["prettierrc.json"] = 735,
    ["prisma.yml"] = 736,
    ["project-1.0.0-beta3.json"] = 748,
    ["project-1.0.0-beta4.json"] = 749,
    ["project-1.0.0-beta5.json"] = 750,
    ["project-1.0.0-beta6.json"] = 751,
    ["project-1.0.0-beta8.json"] = 752,
    ["project-1.0.0-rc1.json"] = 753,
    ["project-1.0.0-rc2.json"] = 754,
    ["project.json"] = 747,
    ["project.owasp.yaml"] = 755,
    ["prometheus-alertmanager.json"] = 759,
    ["prometheus.json"] = 756,
    ["prometheus.rules.json"] = 757,
    ["prometheus.rules.test.json"] = 758,
    ["proxies.json"] = 760,
    ["publiccode.yml"] = 761,
    ["pubspec.yaml"] = 762,
    ["pyrseas-0.8.json"] = 765,
    pytest = 774,
    ["quilt.mod.json"] = 1154,
    ["rc3 auth"] = 780,
    ["rc3 collection"] = 781,
    ...
    ["rc3 settings"] = 785,
    ["registry.yaml"] = 58,
    ["release drafter"] = 1030,
    ["release-hub.json"] = 6,
    ["release-please-config.json"] = 790,
    ["release-please-manifest.json"] = 791,
    ["release-plz.toml"] = 792,
    ["renv.lock"] = 806,
    ["reposets Configuration"] = 795,
    ["reposets Credentials"] = 796,
    ["revola.json"] = 4,
    ["rivet.json"] = 1178,
    ["rivet.yaml (legacy)"] = 1177,
    rumdl = 811,
    runny = 810,
    runspec = 1341,
    rustfmt = 812,
    ...
    samt = 815,
    samtrc = 816,
    ["sarif-1.0.0.json"] = 818,
    ["sarif-2.0.0.json"] = 819,
    ["sarif-2.1.0"] = 829,
    ["sarif-2.1.0-rtm.2"] = 820,
    ["sarif-2.1.0-rtm.3"] = 822,
    ["sarif-2.1.0-rtm.4"] = 824,
    ["sarif-2.1.0-rtm.5"] = 826,
    ["sarif-2.1.0-rtm.6"] = 827,
    ["sarif-external-property-file-2.1.0"] = 830,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 821,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 823,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 825,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 828,
    ["scalingo.json configuration"] = 831,
    ["schema.org - Action"] = 833,
    ["schema.org - ContactPoint"] = 834,
    ["schema.org - Place"] = 835,
    ["schema.org - Thing"] = 836,
    ["secrethub.yml"] = 1156,
    ["semantic-release"] = 844,
    ["servicehub.config.json"] = 1006,
    ["servicehub.service.json"] = 1005,
    ["settings.job"] = 847,
    ["sfdx-hardis configuration"] = 849,
    ["shard.yml"] = 1194,
    ["size-limit configuration"] = 854,
    ["skaffold.yaml"] = 1078,
    ["skyuxconfig.json"] = 856,
    ["snowflake-config"] = 858,
    ["snowflake-connections"] = 859,
    ["spicepod.yaml"] = 1215,
    ["sqlc configuration"] = 893,
    ["stripe-app-local.json"] = 904,
    ["stripe-app.json"] = 903,
    swcrc = 1062,
    ["task.json"] = 913,
    taskcat = 1025,
    ["template.json"] = 918,
    ["templatsources.json"] = 919,
    ["text2confl config"] = 1325,
    ["theme.json"] = 922,
    ["tizen_workspace.json"] = 924,
    tldr = 925,
    ["tm_devices configuration file"] = 1282,
    tmuxinator = 1009,
    tox = 927,
    ["transcend.yml"] = 936,
    ["tree-sitter grammar.json"] = 471,
    ["trime.yaml"] = 937,
    ["trunk.yaml"] = 939,
    ["ts-force-config.json"] = 944,
    ["tsconfig.json"] = 940,
    ["tsd.json"] = 941,
    ["tsdoc.json"] = 942,
    ["tsdrc.json"] = 943,
    ...
    ["vega-lite.json"] = 969,
    ["vega.json"] = 968,
    ["venvironment.yaml"] = 971,
    ["venvplus.yaml"] = 972,
    version = 1264,
    ["version.json"] = 974,
    ["vhwdebugger-binding.yaml"] = 976,
    ["vim-addon-info"] = 977,
    ["vs-2017.3.host.json"] = 979,
    ["vs-nesting.json"] = 980,
    ["vsls.json"] = 978,
    ["vss-extension.json"] = 984,
    vtcfg = 1270,
    ["vtesttree.yaml"] = 985,
    ["vtestunit.yaml"] = 986,
    ["warp-keysets.json"] = 1162,
    ["warp-themes.json"] = 1163,
    ["warp-workflows.json"] = 1164,
    ["webhint.io"] = 1118,
    ["webjobpublishsettings.json"] = 991,
    ["webjobs-list.json"] = 990,
    ["well-known-fursona"] = 1202,
    ["xs-app.json"] = 1020,
    ["xunit.runner.json"] = 1004,
    yamlfmt = 1047,
    yamllint = 1048,
    ["yap.json"] = 1049,
    ["zerops.yml"] = 1211,
