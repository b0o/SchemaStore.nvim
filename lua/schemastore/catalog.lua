...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1010,
    [".nodehawkrc"] = 640,
    [".npmpackagejsonlintrc"] = 644,
    [".omletrc"] = 1191,
    [".phrase.yml"] = 722,
    [".phraseapp.yml"] = 723,
    [".pmbot.yml"] = 707,
    [".postcssrc"] = 716,
    [".powerpages-web-template-manifest"] = 718,
    [".pre-commit-config.yml"] = 719,
    [".pre-commit-hooks.yml"] = 720,
    [".putout.json"] = 756,
    [".rehyperc"] = 781,
    [".remarkrc"] = 785,
    [".sprite files"] = 883,
    ...
    ["A micro editor config"] = 578,
    ABCClinicalDemandForecast = 31,
    ABCInventoryModuleData = 30,
    ABCSupplyPlan = 32,
    ["ACP Attempts"] = 33,
    ["ACP Cache File"] = 34,
    ["ACP Configuration File"] = 35,
    ["ACP Primer"] = 36,
    ["ACP Sync"] = 37,
    ["ACP Variables File"] = 38,
    AIConfig = 40,
    ["AMX Muse Program Descriptor"] = 1240,
    ["API Builder"] = 1046,
    ["AVA Configuration"] = 1110,
    ["AWS AppConfig Feature Flags-v1"] = 74,
    ["AWS CDK cdk.json"] = 281,
    ["AWS CloudFormation"] = 282,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 283,
    ["AWS Copilot Manifest"] = 1279,
    ["AWS SAM CLI Samconfig"] = 284,
    Acton = 1330,
    ["Adobe UXP Manifest"] = 1173,
    ["Aerleon Network & Service Definitions"] = 25,
    ["Aerleon Policy"] = 26,
    ["Agent Permission Policy"] = 1319,
    ["AgentCore CLI"] = 1320,
    AgentLoopKit = 1321,
    Aider = 1269,
    Air = 28,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1290,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1289,
    ["Airlock Microgateway"] = 41,
    ["Alacritty Configuration"] = 1082,
    ["AlgoVoi Compliance Receipt v1"] = 15,
    ["All Contributors configuration file"] = 1136,
    Anodizer = 461,
    ["Ansible Argument Specs"] = 445,
    ["Ansible Collection Galaxy"] = 452,
    ["Ansible Execution Environment"] = 442,
    ["Ansible Inventory"] = 451,
    ["Ansible Meta"] = 443,
    ["Ansible Meta Runtime"] = 444,
    ["Ansible Navigator Configuration"] = 454,
    ["Ansible Playbook"] = 449,
    ["Ansible Requirements"] = 446,
    ["Ansible Rulebook"] = 450,
    ["Ansible Tasks File"] = 448,
    ["Ansible Vars File"] = 447,
    ["Ansible-lint Configuration"] = 453,
    Any = 1201,
    ["AnyWork Automation Configuration"] = 21,
    ["Apollo Router"] = 1047,
    ["App config Spotify Backstage"] = 45,
    ["Applicant Profile Protocol"] = 18,
    ["Application Accelerator"] = 16,
    ["Application list for a WinUtil"] = 1219,
    ArchitectFX = 1224,
    ["Argo CD"] = 60,
    ["Argo Events"] = 61,
    ["Argo Workflows"] = 62,
    AssemblyScript = 65,
    AsyncAPI = 68,
    ["AsyncAPI Tool File"] = 69,
    ["Atmos Manifests"] = 70,
    ["Aurora Agile Meta-Framework"] = 71,
    AutoAPICase = 1146,
    ["Avro Avsc"] = 72,
    ["Awesome Repositories"] = 73,
    ["Azure Container App template for defining an immutable revision"] = 76,
    ["Azure DevOps extension manifest"] = 79,
    ["Azure Device Update for IoT Hub import manifest"] = 77,
    ["Azure Device Update for IoT Hub update manifest"] = 78,
    ["Azure IoT Edge deployment"] = 82,
    ["Azure IoT Edge deployment template"] = 83,
    ["Azure IoT EdgeAgent deployment"] = 80,
    ["Azure IoT EdgeHub deployment"] = 81,
    ["Azure IoT Operations Wasm Graph Config"] = 1288,
    ["Azure IoT Operations connector metadata"] = 1285,
    ["Azure Landing Zones Library archetype definition"] = 87,
    ["Azure Landing Zones Library archetype override"] = 88,
    ["Azure Landing Zones Library architecture definition"] = 86,
    ["Azure Landing Zones Library metadata"] = 84,
    ["Azure Landing Zones Library policy default values"] = 85,
    ["Azure Pipelines"] = 120,
    ["Azure Static Web Apps CLI configuration file"] = 887,
    ["Azure Static Web Apps configuration file"] = 886,
    BMML = 1307,
    ["BOSH BPM Config"] = 146,
    ["BOSH CPI Config"] = 147,
    ["BOSH Deploy Config"] = 148,
    ["BX CI"] = 169,
    ["Bacon config"] = 9,
    ["Barba-CV"] = 89,
    ["Bashly (bashly.yml)"] = 1140,
    ["Bashly Settings (bashly-settings.yml)"] = 1141,
    Bento = 1306,
    ["Better Code Hub"] = 1051,
    ["Better Scripts"] = 170,
    Bigconfig = 139,
    ["Biome Formatter Config"] = 90,
    ["Bitmovin Encoding Template"] = 1233,
    BizTalkServerApplicationSchema = 1017,
    Bleep = 171,
    ["Block Protocol Metadata"] = 168,
    ["Bluebricks blueprint config"] = 1312,
    ["Boyka Framework"] = 149,
    ["Bpod Finite-State Machine"] = 92,
    Briefcase = 1023,
    ["Build Info"] = 159,
    Buildkite = 161,
    ["Bukkit plugin.yml"] = 160,
    ["BungeeCord plugin.yml"] = 166,
    ["Burnless SRE config"] = 2,
    ["Butane Config"] = 1095,
    C4InterFlow = 1248,
    ["CDK Environment Manager, concrete environment configuration"] = 1272,
    ["CDK Environment Manager, concrete environments definition"] = 1271,
    ["CDK Environment Manager, environment definition"] = 1270,
    ["CGS Card Game Specification (cgs.json)"] = 1178,
    ["CICS TS region tagging"] = 1104,
    ["CICS TS resource import"] = 1105,
    ["CICS TS resource model"] = 1106,
    ["CICS TS resource overrides"] = 1107,
    ["CMake Presets"] = 172,
    ["CNC Codes"] = 194,
    ["CRS WAF test file"] = 1208,
    ["CRS WAF test platform overrides file"] = 1209,
    ["CSS Comb (.csscomb.json)"] = 310,
    ["CSS Lint (.csslintrc)"] = 311,
    ["CSpell (cspell.json)"] = 309,
    ["CVE Record Format"] = 206,
    CWL = 1184,
    ["Cache Warmup config"] = 173,
    ["Caido Proxy Configuration"] = 1344,
    ["Calqulus pipeline"] = 174,
    ["Camel YAML DSL"] = 175,
    ["Cannon TOML"] = 176,
    Carafe = 177,
    ["Cargo Make"] = 179,
    ["Cargo Manifest"] = 178,
    ["Catalog Info Backstage"] = 180,
    ["Chamaleon environment"] = 1237,
    ["Chamaleon properties"] = 1238,
    ["Chamaleon template"] = 1236,
    Changepacks = 1299,
    Changesets = 293,
    Changie = 181,
    Charmcraft = 182,
    Cheatsheets = 1092,
    ["ChordPro Configuration"] = 183,
    ["Chrome Extension"] = 274,
    ["Chromia Model"] = 184,
    ["Chromia Seeder Module Config"] = 186,
    ["Chromia Seeder Root Config"] = 185,
    ["Cinnamon Spice info.json"] = 100,
    ["CircleCI config.yml"] = 245,
    ["Citation File Format"] = 295,
    ["Citrus test case"] = 188,
    CityJSON = 189,
    ["Claude Code Keybindings"] = 201,
    ["Claude Code Plugin Manifest"] = 202,
    ["Claude Code Plugin Marketplace"] = 203,
    ["Claude Code Settings"] = 204,
    ["Clawject config"] = 200,
    ["Cloud Foundry Application Manifest"] = 1190,
    ["Cloud Run Spec v1"] = 1214,
    ["Cloud.gov Workshop Configuration"] = 101,
    ["CloudCannon Configuration"] = 106,
    ["CloudCannon Configuration (Collection Structures)"] = 115,
    ["CloudCannon Configuration (Collections)"] = 114,
    ["CloudCannon Configuration (Editables)"] = 113,
    ["CloudCannon Configuration (Inputs)"] = 108,
    ["CloudCannon Configuration (Snippets Definitions)"] = 112,
    ["CloudCannon Configuration (Snippets Imports)"] = 111,
    ["CloudCannon Configuration (Snippets)"] = 110,
    ["CloudCannon Configuration (Structure Value)"] = 109,
    ["CloudCannon Configuration (Structures)"] = 107,
    ["CloudEvents specification"] = 190,
    ["Code Climate"] = 246,
    CodeCV = 104,
    CodeRabbit = 103,
    ["CodeShip Pro services configuration files"] = 263,
    ["CodeShip Pro steps configuration files"] = 264,
    ["Codecov configuration files"] = 262,
    Codex = 254,
    ["Codex Hooks"] = 255,
    ["Codex Plugin Manifest"] = 256,
    ["Codex Skill Metadata"] = 257,
    CodifyCLI = 105,
    Codux = 259,
    ["Cog config file"] = 195,
    ["Commandbox Box.json"] = 196,
    ["Commandbox Server.json"] = 197,
    ["Common Catalog Data"] = 272,
    ["Common Package Specification"] = 198,
    Concord = 1207,
    ["Configu .cfgu files"] = 1195,
    ["Configu .configu file"] = 1196,
    Conjure = 193,
    ["Container Structure Test"] = 1031,
    Containerlab = 1060,
    ["Contextive Glossary"] = 1264,
    ContractGuard = 1061,
    Convex = 192,
    ["Crowdsec collection config"] = 304,
    ["Crowdsec parser config"] = 305,
    ["Crowdsec scenario config"] = 306,
    ["CumulusCI Config"] = 199,
    ["Cursor Agent Environment"] = 1317,
    ["Custom Machinery Machine"] = 1179,
    ["Custom Machinery Recipe"] = 1180,
    ["Cycle Stack File"] = 207,
    CycloneDX = 208,
    ["DWP Exchange - catalogue entry"] = 355,
    ["DWP Exchange - gateway"] = 353,
    ["DWP Exchange - meta"] = 354,
    ["Dart Build Config (dart-build.json)"] = 312,
    ["Dart Test Config (dart-test.json)"] = 313,
    ["DashLord Configuration"] = 314,
    ["Data Contract Specification"] = 315,
    ["Data Product Specification"] = 316,
    ["DataYoga Connections"] = 209,
    ["DataYoga Job"] = 210,
    ["Datadog Continuous Testing"] = 547,
    ["Datadog Service Definition"] = 548,
    ["Datadog Software Catalog"] = 549,
    ["Datahub Ingestion Recipe"] = 1111,
    ["Debian Upstream Metadata file"] = 217,
    DebtLens = 218,
    ["Deck config"] = 219,
    ["Declarative Automation Bundles"] = 1157,
    ["DeepMatch deeplinks spec"] = 220,
    ["Dein Config"] = 221,
    ["Deno Config (deno.json)"] = 322,
    ["Dependency cruiser"] = 222,
    ["DeployStack Configuration"] = 223,
    ["Deployah Configuration"] = 1287,
    ["Deployer Recipe"] = 325,
    ["Deta Spacefile"] = 224,
    ["Detekt Config (detekt.yml)"] = 326,
    ["Devbox Config"] = 225,
    ["Devbox Plugin"] = 226,
    Devfile = 352,
    Devup = 1300,
    DipDup = 1210,
    ["Discord Webhook"] = 327,
    ["DocFx Config (docfx.json)"] = 332,
    ["Docker Desktop extension metadata"] = 329,
    ["Docs MCP Manifest"] = 333,
    Dofigen = 334,
    ["Dolittle Artifacts"] = 335,
    ["Dolittle Bounded Context Configuration"] = 336,
    ["Dolittle Event Horizons Configuration"] = 337,
    ["Dolittle Resources Configuration"] = 338,
    ["Dolittle Server Configuration"] = 339,
    ["Dolittle Tenant Map Configuration"] = 341,
    ["Dolittle Tenants Configuration"] = 340,
    ["Dolittle Topology"] = 342,
    ["DonateCaseBetterCasino menu"] = 1241,
    ["Drupal Breakpoints"] = 227,
    ["Drupal Config"] = 239,
    ["Drupal Info"] = 228,
    ["Drupal Layouts"] = 229,
    ["Drupal Libraries"] = 230,
    ["Drupal Links Action"] = 231,
    ["Drupal Links Contextual"] = 232,
    ["Drupal Links Menu"] = 233,
    ["Drupal Links Task"] = 234,
    ["Drupal Migration"] = 235,
    ["Drupal Permissions"] = 236,
    ["Drupal Recipe"] = 237,
    ["Drupal Routing"] = 238,
    ["Drupal Services"] = 240,
    ["Drush site aliases"] = 348,
    ["Dynamic Bash Aliases (.aliases)"] = 1148,
    ["EAS config"] = 393,
    ["ECA - Editor Code Assistant"] = 357,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1137,
    ["ESLint Suppressions"] = 398,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1284,
    ["EasyVCR .NET"] = 395,
    ["Eidolon Resource"] = 1225,
    ["Elgato Stream Deck"] = 359,
    Elm = 1212,
    ["Embrace Config"] = 1123,
    Emmet = 1213,
    Endurica = 1161,
    ["Enonic XP API descriptor"] = 362,
    ["Enonic XP Admin Extension descriptor"] = 363,
    ["Enonic XP Admin Tool descriptor"] = 364,
    ["Enonic XP Application descriptor"] = 365,
    ["Enonic XP CMS descriptor"] = 366,
    ["Enonic XP Content Type descriptor"] = 367,
    ["Enonic XP Form Fragment descriptor"] = 368,
    ["Enonic XP ID Provider descriptor"] = 369,
    ["Enonic XP Layout descriptor"] = 370,
    ["Enonic XP Macro descriptor"] = 371,
    ["Enonic XP Mixin descriptor"] = 372,
    ["Enonic XP Page descriptor"] = 373,
    ["Enonic XP Part descriptor"] = 374,
    ["Enonic XP Service descriptor"] = 375,
    ["Enonic XP Site descriptor"] = 376,
    ["Enonic XP Style descriptor"] = 377,
    ["Enonic XP Task descriptor"] = 378,
    ["Enonic XP Webapp descriptor"] = 379,
    ["Enterprise Contract Policy Spec"] = 360,
    ["Envelope Team Definition"] = 1329,
    ["Envilder Map File"] = 361,
    ["Erda Pipeline"] = 1186,
    ["Erda Runtime"] = 1187,
    ["Espanso config.yml"] = 1310,
    ["Espanso match.yml"] = 1309,
    Esquio = 381,
    ["Estuary Flow Catalog"] = 1101,
    ["Ethereum ERC1155"] = 1323,
    ["Ethereum ERC721"] = 1322,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 386,
    ["EveryVoice TTS Toolkit Data Configuration"] = 387,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 391,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 390,
    ["EveryVoice TTS Toolkit Text Configuration"] = 388,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 389,
    ["Evolving Resolutive Process notation"] = 1286,
    ["Expo SDK"] = 392,
    ["Expoot app config"] = 394,
    ["F-Droid Data metadata"] = 400,
    ["FasterCI Configuration"] = 121,
    ["Fence configuration"] = 122,
    FiQuS = 404,
    Firebase = 402,
    ["Flatpak Builder Manifest"] = 405,
    ["FlexGet Config"] = 406,
    ["Flow.json Configurations"] = 1183,
    ["Fossa configuration file"] = 413,
    ["Fossa's fossa-deps file"] = 414,
    ["Foundry VTT - Base package Manifest"] = 408,
    ["Foundry VTT - Module Manifest"] = 409,
    ["Foundry VTT - System Data Template"] = 412,
    ["Foundry VTT - System Manifest"] = 410,
    ["Foundry VTT - World Manifest"] = 411,
    ["Foxx Manifest"] = 123,
    ["Freifunk.de Community API"] = 126,
    ["Frogbot Config"] = 127,
    ["G2P Mapping Configuration"] = 420,
    ["GCP Blueprint Metadata"] = 423,
    Gaspar = 421,
    ["GatewayCore API Gateway"] = 422,
    ["Gemini CLI settings"] = 424,
    ["GeoJSON.json latest"] = 1099,
    GherKing = 1103,
    ["GitHub Action"] = 430,
    ["GitHub Actions typing"] = 1221,
    ["GitHub Discussion"] = 431,
    ["GitHub Funding"] = 432,
    ["GitHub Issue Template configuration"] = 433,
    ["GitHub Issue Template forms"] = 434,
    ["GitHub Pages Jekyll"] = 435,
    ["GitHub Workflow"] = 436,
    ["GitHub Workflow Template Properties"] = 437,
    ["GitHub automatically generated release notes configuration"] = 438,
    ["GitLab Agent for Kubernetes configuration"] = 1175,
    GitVersion = 427,
    ["Gitea Issue Template configuration"] = 428,
    ["Gitea Issue Template forms"] = 429,
    ["Gitpod Automations"] = 440,
    ["Gitpod Configuration"] = 441,
    ["Glamour style"] = 425,
    ["GlazeWM settings"] = 1177,
    ["Global Privacy Control"] = 426,
    Goblet = 1156,
    ["Golangci-lint Configuration"] = 456,
    ["Golangci-lint Custom Plugins Configuration"] = 457,
    ["Google Chrome Related Website Sets"] = 403,
    ["Google Cloud Workflows"] = 280,
    ["Google Digital Assetlinks"] = 1265,
    Goreleaser = 459,
    ["Goreleaser Pro"] = 460,
    Goss = 462,
    ["Gradle Build Cache Node"] = 1049,
    ["Gradle Enterprise"] = 1048,
    ["Grafana 5.x Dashboard"] = 463,
    ["GraphQL Code Generator"] = 468,
    ["GraphQL Config"] = 467,
    ["GraphQL Mesh"] = 466,
    ["GroovyLint configuration"] = 469,
    ["Grunt JSHint task"] = 473,
    ["Grunt Watch task"] = 474,
    ["Grunt base task"] = 475,
    ["Grunt clean task"] = 471,
    ["Grunt copy task"] = 470,
    ["Grunt cssmin task"] = 472,
    HEMTT = 1013,
    Hadolint = 1027,
    Hammerkit = 1059,
    ["Hardware Sentry Configuration"] = 1115,
    ["Hashgraph Online Skill Manifest"] = 5,
    ["HashiCorp Vault"] = 476,
    Hatch = 1028,
    Hayson = 478,
    ["Haystack Pipeline"] = 479,
    ["Hazelcast 5 Configuration"] = 480,
    ["Hecate Input Schema"] = 1276,
    ["Helm Chart.lock"] = 242,
    ["Helm Chart.yaml"] = 241,
    ["Helm Unittest Test Suite"] = 243,
    ["Hex file"] = 244,
    ["Home Assistant Integration Manifest"] = 481,
    ["Homer dashboard configuration"] = 482,
    Hugo = 1091,
    ["Hugo Theme"] = 1090,
    ["Hulak Configuration"] = 489,
    ["Hyperfoil benchmark configuration"] = 488,
    ["IBM Zapp document"] = 490,
    ["IBM zCodeFormatSettings"] = 491,
    ["IMG Catapult PSP"] = 496,
    ["IVMS101 by CODE Protocol"] = 1176,
    ["Infinispan Configuration"] = 498,
    ["Infinispan Server Configuration"] = 499,
    Infrahub = 500,
    Istanbul = 1119,
    ["JDownloader2 crawler multi-rules"] = 514,
    ["JDownloader2 crawler single-rules"] = 513,
    ["JFrog Applications Config"] = 515,
    ["JFrog File Spec"] = 516,
    ["JFrog Pipelines YML DSL"] = 1125,
    ["JMeter DSL cli config"] = 517,
    JReleaser = 520,
    ["JSON Document Transform"] = 528,
    ["JSON Feed"] = 529,
    ["JSON Resume"] = 793,
    ["JSON Schema Draft 2020-12"] = 995,
    ["JSON Schema Draft 4"] = 992,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1158,
    ["JSON Schema Draft 7"] = 993,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1159,
    ["JSON Schema Draft 8 (2019-09)"] = 994,
    ["JSON-API"] = 527,
    ["JSON-e templates"] = 1056,
    ["JSON-stat 2.0"] = 988,
    JSONPatch = 531,
    ["JSR Package Config (jsr.json)"] = 521,
    Jarl = 1292,
    Jasmine = 508,
    Jekyll = 509,
    ["Jenkins X Pipelines"] = 510,
    ["Jenkins X Requirements"] = 511,
    Jest = 512,
    Jocker = 518,
    ["Jovo Language Models"] = 519,
    ["Jujutsu (jj) VCS config"] = 1278,
    ["KIMMDY config file"] = 542,
    ["KODE/CI build.yaml"] = 1121,
    ["KSP-AVC"] = 989,
    ["KSP-CKAN"] = 990,
    ["KSP-NetKAN"] = 991,
    KSY = 1188,
    KSail = 418,
    ["KYA Manifest"] = 1189,
    ["Karakum configuration file"] = 415,
    Kas = 534,
    ["Kestra flow file"] = 543,
    ["Keycloak REST API"] = 1128,
    ["Knative Functions - func.yaml"] = 416,
    Knip = 417,
    ["Knowledge Unit"] = 551,
    ["Kometa (nightly) config file"] = 545,
    ["Kometa config file"] = 544,
    ["Kong DBLess config"] = 1122,
    KrakenD = 546,
    ["Kubri Configuration"] = 554,
    LOOBin = 569,
    ["Lake configuration file"] = 1281,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 285,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 286,
    ["Landing Zone Accelerator on AWS - Global Config"] = 287,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 288,
    ["Landing Zone Accelerator on AWS - Network Config"] = 289,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 290,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 291,
    ["Landing Zone Accelerator on AWS - Security Config"] = 292,
    ["Lando (landofile)"] = 116,
    ["LangGraph Platform configuration"] = 1200,
    ["Language configuration"] = 1199,
    Lefthook = 558,
    ["Liferay client-extension.yaml"] = 565,
    ["LinkML Metamodel"] = 567,
    Liquibase = 1066,
    ["Liquibase Flow File"] = 1067,
    ["Lively Properties"] = 568,
    ["Lobe AI Agent"] = 118,
    Loki = 119,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 611,
    ["MS2Rescore Configuration"] = 617,
    ["MSTest testconfig.json"] = 618,
    ["Madness (madness.yml)"] = 1139,
    ["Mado configuration"] = 575,
    ["Maestro Flow"] = 576,
    ["Mail Servers Configuration"] = 1313,
    ["MapEHR Mapping"] = 577,
    Markdownlint = 1070,
    ["Mason Registry"] = 1073,
    ["MegaLinter Custom Flavor"] = 580,
    ["MegaLinter configuration"] = 579,
    ["MegaLinter descriptor"] = 581,
    Melange = 1166,
    ["Meltano project definition"] = 582,
    ["Mergify Configuration"] = 619,
    ["Metadata for a Bazel module"] = 583,
    ["Metadata for a Cinnamon spice"] = 1217,
    ["Metatype Configuration"] = 584,
    ["MetricsHub Configuration"] = 585,
    ["MetricsHub Connector Configuration"] = 586,
    ["Micro Editor Syntax"] = 1149,
    ["Microsoft Band Web Tile"] = 587,
    ["Microsoft RulesEngine workflow rules"] = 1204,
    ["Microsoft RulesEngine workflow rules list"] = 1205,
    ["Minecraft Custom Main Menu Mod"] = 1167,
    ["Minecraft Data Pack Advancement"] = 589,
    ["Minecraft Data Pack Biome"] = 590,
    ["Minecraft Data Pack Configured Carver"] = 591,
    ["Minecraft Data Pack Damage Type"] = 592,
    ["Minecraft Data Pack Dimension"] = 594,
    ["Minecraft Data Pack Dimension Type"] = 593,
    ["Minecraft Data Pack Item Modifier"] = 595,
    ["Minecraft Data Pack Loot Table"] = 596,
    ["Minecraft Data Pack Metadata"] = 597,
    ["Minecraft Data Pack Predicate"] = 598,
    ["Minecraft Data Pack Recipe"] = 599,
    ["Minecraft Data Pack Tag"] = 600,
    ["Minecraft Data Pack Template Pool"] = 601,
    ["Minecraft Data Pack Trim Material"] = 606,
    ["Minecraft Data Pack Trim Pattern"] = 607,
    ["Minecraft Resource Pack Lang"] = 602,
    ["Minecraft Resource Pack Particle"] = 603,
    ["Minecraft Resource Pack Texture Mcmeta"] = 605,
    ["Minecraft Resourcepack Sounds"] = 604,
    ["MockServer Expectations"] = 613,
    ModuleAssembler = 609,
    ["Monade CLI Stack Configuration"] = 622,
    ["MongoDB Atlas Search Index Definition"] = 1120,
    ["Monika Configuration"] = 1118,
    ["Monoweave Configuration"] = 616,
    ["Motif config"] = 1009,
    MultiQC = 1258,
    ["NOX Framework (Service)"] = 643,
    ["Netin Diagnostic System Template"] = 1077,
    ["Netlify config"] = 625,
    ["Network-as-Code Data Model"] = 626,
    ["Next Gen UI Agent A2A Server Configuration"] = 627,
    ["Next Gen UI Agent Configuration"] = 629,
    ["Next Gen UI Agent MCP Server Configuration"] = 628,
    ["Nightwatch.js"] = 636,
    ["Node.js configuration"] = 1014,
    ["NueJS configuration file"] = 648,
    ["Nuitka Package Config"] = 1181,
    ["Nullstone config"] = 650,
    ["ONe's changelog entry"] = 669,
    ["ONe's service descriptor"] = 668,
    ["ORT Server repository environment configuration"] = 679,
    ["OSCAL Assessment Plan (AP)"] = 681,
    ["OSCAL Assessment Results (AR)"] = 682,
    ["OSCAL Catalog"] = 683,
    ["OSCAL Component Definition (CDef)"] = 684,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 685,
    ["OSCAL Profile"] = 686,
    ["OSCAL System Security Plan (SSP)"] = 687,
    ["OSS Review Toolkit configuration"] = 688,
    ["OSS Review Toolkit curation"] = 689,
    ["OSS Review Toolkit package configuration"] = 690,
    ["OSS Review Toolkit project package manager definition"] = 691,
    ["OSS Review Toolkit repository configuration"] = 692,
    ["OSS Review Toolkit resolutions"] = 693,
    ["October CMS columns"] = 654,
    ["October CMS fields"] = 655,
    ["Oh My Posh"] = 657,
    Okteto = 658,
    ["Ona Automations"] = 660,
    Opctl = 1012,
    ["Open Data Contract Standard (ODCS)"] = 673,
    ["Open Data Product Standard (ODPS)"] = 674,
    ["Open Know-How"] = 1263,
    OpenDecree = 1327,
    ["OpenDecree Configuration"] = 1328,
    ["OpenRewrite Resource"] = 671,
    OpenSRM = 675,
    OpenStatus = 1274,
    ["OpenTelemetry Declarative Configuration"] = 672,
    ["OpenUtau character yaml"] = 665,
    ["OpenUtau ustx"] = 666,
    ["OpenWeather Current Weather API"] = 1055,
    ["OpenWeather Road Risk API"] = 1054,
    ["Ory Hydra configuration"] = 487,
    ["Ory Keto configuration"] = 550,
    ["Ory Kratos configuration"] = 680,
    ["Ory Oathkeeper configuration"] = 652,
    ["Outblocks App configuration"] = 677,
    ["Outblocks database table"] = 678,
    ["Outblocks project configuration"] = 676,
    PDM = 701,
    POPxf = 713,
    ["POPxf Correlations"] = 714,
    ["PRML manifest"] = 721,
    Packer = 697,
    PactSpec = 698,
    Panache = 699,
    Pantsbuild = 1135,
    ["Paper paper-plugin.yml"] = 700,
    ["Pipeline component"] = 1068,
    ["Platform.sh application"] = 11,
    ["Platform.sh routes"] = 12,
    ["Platform.sh services"] = 13,
    ["Plex Prerolls"] = 711,
    ["PocketMine plugin.yml"] = 708,
    ["Podman Desktop Extension"] = 1346,
    ["Postman collection"] = 717,
    ["Power Pages Configuration"] = 1275,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1220,
    ["ProActions AI-Kit Configuration"] = 729,
    ["ProActions AI-Kit Configuration for Menus"] = 731,
    ["ProActions AI-Kit Configuration for Sections"] = 733,
    ["ProActions AI-Kit Configuration for Services"] = 730,
    ["ProActions AI-Kit Configuration for Steps"] = 734,
    ["ProActions AI-Kit Configuration for Templates"] = 732,
    ["Problem object RFC9457"] = 1164,
    ["Problem package format"] = 735,
    ["Problem package generators"] = 736,
    ["Problem package submissions"] = 737,
    ["Problem package test group metadata"] = 738,
    Pterodactyl = 1114,
    ["Pull Request Labeler"] = 755,
    Pulumi = 763,
    ["PyGTA Config"] = 759,
    PyProject = 764,
    Pylock = 1266,
    Pyright = 765,
    ["Python script metadata"] = 1260,
    ["QType AI DSL"] = 768,
    Qgoda = 767,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1338,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1336,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1342,
    ["Qlik Talend Cloud Pipeline - Project"] = 1334,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1337,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1339,
    ["Qlik Talend Cloud Pipeline - Task"] = 1335,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1341,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1340,
    Qodana = 1087,
    ["Qt Creator workspace file"] = 1197,
    ["Quali Torque Blueprint Spec 2"] = 1112,
    ["QueryFirst config file"] = 1131,
    ["QuikRun Configuration"] = 1343,
    ["Qwen Code Settings"] = 1324,
    ["RKE Cluster Configuration JSON"] = 1065,
    ["RKE Cluster Configuration YAML"] = 1064,
    RadioHound = 758,
    ["Raid Profile"] = 1325,
    ["Raid Repo Configuration"] = 1326,
    Railpack = 770,
    Railway = 769,
    ["Rancher Fleet"] = 760,
    ["Rattler-build"] = 771,
    Ray = 1026,
    ["Read the Docs"] = 762,
    ["Red-DiscordBot Cog"] = 778,
    ["Red-DiscordBot Cog Repo"] = 779,
    ["Red-DiscordBot Trivia"] = 780,
    ["Releasaurus Config"] = 8,
    ReleaseKit = 7,
    ["Render Blueprints"] = 1063,
    RenderCV = 797,
    Renovate = 794,
    ["Renovate global configuration"] = 795,
    ["Renovate inherited configuration"] = 796,
    ["Replit config"] = 786,
    Restate = 1253,
    ["Revel Digital Gadget Definition File"] = 1277,
    RoadRunner = 799,
    ["Robust Station Image"] = 1283,
    Rockcraft = 800,
    ["Roo Coder Custom Modes"] = 801,
    Rubocop = 790,
    ["Rudder techniques"] = 1171,
    Ruff = 791,
    ["Rust Project"] = 792,
    ["Rust toolchain"] = 806,
    ["SDMX data message"] = 833,
    ["SDMX metadata message"] = 832,
    ["SDMX structure message"] = 831,
    ["SIL Kit Participant Configuration"] = 844,
    ["SIL Kit Registry Configuration"] = 845,
    ["SPDX 2.3"] = 884,
    SWADL = 900,
    ["Safebox Config"] = 1126,
    ["Sapphire CLI Config"] = 809,
    ["SauceCTL Configuration"] = 1074,
    Scarb = 829,
    ["Schema Catalog"] = 824,
    ["Scoop manifest"] = 830,
    ["Secure SDLC Evidence Bundle"] = 834,
    ["Semantic Data Fabric (SDF) file"] = 835,
    ["Semgrep Rule"] = 837,
    ["Serenity Code Generator (Sergen)"] = 838,
    ["Serverless Framework Configuration"] = 1081,
    ["Serverless Workflow"] = 1083,
    ["Settings for a Cinnamon spice"] = 1216,
    ["Settings.paf"] = 840,
    ["Shopware 6 Configuration"] = 1084,
    ["Shopware CLI Extension Store Configuration"] = 1085,
    ["Shopware CLI Project Store Configuration"] = 1086,
    ["Sigma Detection Rule"] = 842,
    ["SigmaCV CV"] = 3,
    ["Sigrid scope configuration file"] = 843,
    ["SkyPilot Task JSON"] = 1172,
    ["Slack app manifest"] = 847,
    ["Slang Server Configuration"] = 1347,
    Snapcraft = 849,
    ["Solarxy project config"] = 852,
    Solidarity = 853,
    ["Solution filters"] = 854,
    ["Source Maps v3"] = 855,
    Sourcery = 856,
    ["Spack bootstrap.yaml"] = 857,
    ["Spack cdash.yaml"] = 858,
    ["Spack ci.yaml"] = 859,
    ["Spack compilers.yaml"] = 860,
    ["Spack concretizer.yaml"] = 861,
    ["Spack config.yaml"] = 862,
    ["Spack definitions.yaml"] = 863,
    ["Spack develop.yaml"] = 864,
    ["Spack env_vars.yaml"] = 865,
    ["Spack environment"] = 871,
    ["Spack include.yaml"] = 866,
    ["Spack mirrors.yaml"] = 867,
    ["Spack modules.yaml"] = 868,
    ["Spack packages.yaml"] = 869,
    ["Spack repos.yaml"] = 870,
    ["Spack toolchains.yaml"] = 872,
    ["Spack upstreams.yaml"] = 873,
    ["Spack view.yaml"] = 874,
    ["Speakeasy Generation Config File"] = 878,
    ["Speakeasy Lint Configuration File"] = 875,
    ["Speakeasy Test Generation Configuration File"] = 876,
    ["Speakeasy Workflow File"] = 877,
    SpecIF = 879,
    ["Specmatic Configuration"] = 880,
    ["Specpin spec file"] = 1,
    ["Sponge Mixin configuration"] = 881,
    ["Spotlight Ruleset"] = 882,
    StackBlitz = 888,
    ["StackHawk Scanner Configuration"] = 1080,
    Stale = 889,
    Starfish = 890,
    ["Starlake Data Pipeline"] = 1052,
    Starship = 891,
    ["Statamic Blueprint"] = 892,
    ["Stella configuration file"] = 893,
    ["Streamlit configuration file"] = 894,
    ["Stryker Mutator"] = 897,
    ["StyleCop Analyzers Configuration"] = 898,
    ["Stylelint (.stylelintrc)"] = 899,
    ["Stylua Config"] = 1267,
    ["Sublime Syntax"] = 1127,
    ["Subsquid squid manifest"] = 1174,
    ["Swagger API 2.0"] = 901,
    ["Synadia Connect Component"] = 902,
    TSON = 938,
    TSTyche = 939,
    ["TYPO3 Vendor Bundler config"] = 945,
    ["Tab data for a LinUtil"] = 1223,
    ["Tab list for a LinUtil"] = 1222,
    Tach = 903,
    ["Tach Domain"] = 904,
    Talhelper = 906,
    ["Talisman configuration"] = 907,
    Taplo = 1268,
    ["Taskfile config"] = 1057,
    Taurus = 908,
    Tauticord = 909,
    ["Tekton Pipeline"] = 1296,
    ["Tekton PipelineRun"] = 1297,
    ["Tekton Task"] = 1294,
    ["Tekton TaskRun"] = 1295,
    Telefonistka = 1254,
    ["Terrateam config"] = 1280,
    ["TestEnvironment.json"] = 921,
    ["TextMate Grammar"] = 920,
    Threagile = 915,
    ["Tier.run pricing.json"] = 912,
    Tikibase = 913,
    Tombi = 918,
    ["Traefik v2"] = 924,
    ["Traefik v2 File Provider"] = 925,
    ["Traefik v3"] = 926,
    ["Traefik v3 File Provider"] = 927,
    ["Travis CI (.travis.yml)"] = 923,
    Treefmt = 465,
    Trident = 1250,
    ["TrueScript for *.tscript files"] = 930,
    ["Tugboat QA config.yml"] = 1247,
    TunnelHub = 1162,
    Turborepo = 922,
    Tycho = 1211,
    Tye = 1088,
    ["Tyk Gateway - Open Source v5.7+"] = 1259,
    ["UET BuildConfig.json"] = 1132,
    ["UI5 Manifest"] = 951,
    ["UNCORS configuration"] = 956,
    ["UTAM Page Object"] = 954,
    ["Ubuntu Server Autoinstall"] = 949,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1251,
    ["Uniswap Token List"] = 1037,
    ["Universal Schedule Format"] = 957,
    ["Unreal Engine Uplugin"] = 1133,
    ["Unreal Engine Uproject"] = 1134,
    ["UpCloud CLI (upctl) configuration"] = 1252,
    ["Updatecli Compose"] = 1096,
    ["Updatecli Policy Manifest"] = 1097,
    ["Updatecli Policy Metadata"] = 1098,
    Uplift = 1130,
    ["Upsun config"] = 10,
    ["User Journey Map"] = 1062,
    V2Ray = 1102,
    ["VSCode Code Snippets"] = 268,
    ["VSIX CLI publishing"] = 975,
    Vector = 959,
    ["Vela Pipeline Configuration"] = 962,
    Vercel = 267,
    ["Version Bumper config"] = 965,
    Vespertide = 1301,
    ["Vespertide Migration"] = 1302,
    ["Vespertide Model"] = 1303,
    ["Viash Component Config"] = 1256,
    ["Viash Package Config"] = 1257,
    Visivo = 1160,
    ["WP-CLI"] = 985,
    Wake = 1249,
    ["Waku Config"] = 1226,
    ["Web App Manifest"] = 981,
    ["Web types"] = 984,
    WebExtensions = 980,
    ["Webman package recipe"] = 1108,
    ["Windows Package Manager Installer Manifest"] = 1034,
    ["Windows Package Manager Locale Manifest"] = 1035,
    ["Windows Package Manager Singleton Manifest"] = 1033,
    ["WireMock CLI import configuration"] = 1232,
    ["WireMock CLI local service configuration"] = 1231,
    ["WireMock message stub mapping"] = 1230,
    ["WireMock stub mapping"] = 1229,
    ["Woodpecker pipeline config"] = 1076,
    ["Wrangler CLI"] = 986,
    ["XenForo add-on manifest"] = 987,
    ["Xstate Machine"] = 1094,
    ["Yandex Workflow Language"] = 1218,
    ["Yarn Config (.yarnrc.yml)"] = 1050,
    ["Yippee-Ki-JSON configuration YML"] = 1041,
    ["YouTrack App"] = 1215,
    ["Zarf Package Configuration"] = 1282,
    ["Zerops import file"] = 1203,
    ["Zola Configuration"] = 1293,
    actionlint = 39,
    ["aerleon.yml"] = 24,
    ["amplify.yml"] = 17,
    ["amxx-builder manifest"] = 1345,
    ["angular.json"] = 42,
    apko = 1165,
    ["app-definition.yaml"] = 46,
    ["apple-app-site-association"] = 44,
    ["appsettings.StormPetrel.json"] = 51,
    ["appsettings.json"] = 49,
    ["appsscript.json"] = 48,
    ["appveyor.yml"] = 50,
    ["aqua-generate-registry.yaml"] = 53,
    ["aqua-policy.yaml"] = 54,
    ["aqua.yaml"] = 52,
    ["arazzo.json"] = 56,
    ["arb.json"] = 57,
    ["arc.json"] = 59,
    ["architect.yml"] = 58,
    ["artifacthub-repo.yml"] = 63,
    ["asm-lsp"] = 64,
    ["ast-grep rules"] = 67,
    ["ast-grep sgconfig.yml"] = 66,
    ["azure.yaml"] = 75,
    ["babelrc.json"] = 129,
    ["bamboo-spec"] = 133,
    basedpyright = 131,
    ["bashly-strings.yml"] = 1142,
    ["batect.yml"] = 132,
    ["beef-database-codegen"] = 134,
    ["beef-database-v5-codegen"] = 136,
    ["beef-entity-codegen"] = 135,
    ["beef-entity-v5-codegen"] = 137,
    ["behat.yml"] = 150,
    ["bigquery-table"] = 138,
    ["bioimageio resource description"] = 1182,
    ["bitbucket-pipelines"] = 140,
    bitrise = 141,
    ["bitrise-step"] = 142,
    ["block.json"] = 167,
    ["bottom configuration"] = 91,
    ["bower.json"] = 144,
    ["bozr.suite.json"] = 154,
    bpkg = 1143,
    ["browser.i18n.json"] = 155,
    ["browsh configuration"] = 156,
    bucklescript = 157,
    ["buf.gen.yaml"] = 94,
    ["buf.lock"] = 95,
    ["buf.plugin.yaml"] = 96,
    ...
    ["build-changelog"] = 158,
    ["bun.lock"] = 163,
    ["bundleconfig.json"] = 164,
    ["bunfig.toml"] = 165,
    ["cargo-mutants-config.yaml"] = 99,
    ["cargo-nextest repository configuration"] = 630,
    ["cargo-nextest user configuration"] = 631,
    ["ccmod.json"] = 1227,
    changelogging = 1194,
    ["chisel-slices.json"] = 294,
    ["chrome-extension-locales-messages.json"] = 275,
    ["chutzpah.json"] = 276,
    cibuildwheel = 187,
    ["clang-format (.clang-format)"] = 1100,
    ["clang-tidy"] = 250,
    clangd = 249,
    clib = 251,
    ["cloud-init: cloud-config userdata"] = 253,
    ["cloud-sdk-pipeline-configuration"] = 278,
    ["cloudbuild.json"] = 279,
    cloudify = 252,
    cmakefmt = 205,
    ["cmdx.yaml"] = 102,
    ...
    ["commands.json"] = 271,
    ["commit-check"] = 297,
    ["commitlint (.commitlintrc)"] = 1036,
    ["committed.toml"] = 298,
    ["compile_commands.json"] = 270,
    ["compilerconfig.json"] = 269,
    ["completely.yml"] = 1138,
    ["component-detection-manifest.json"] = 301,
    ["component.json"] = 300,
    ["composer.json"] = 299,
    ["conda-forge"] = 191,
    ["config.yaml"] = 761,
    ["contentmanifest.json"] = 277,
    ["contribute.json"] = 302,
    ["cosmos.config.json"] = 273,
    ["crowdin.yml"] = 303,
    ["ctfd-setup configuration file"] = 1239,
    ["custom-elements.json"] = 1152,
    ["cypress.json"] = 307,
    ["dacier.yml"] = 1333,
    ["datalogic-scan2deploy-android"] = 317,
    ["datalogic-scan2deploy-ce"] = 318,
    ["dbt Dependencies"] = 212,
    ["dbt Packages"] = 214,
    ["dbt Project"] = 213,
    ["dbt Selectors"] = 215,
    ["dbt YAML files"] = 216,
    ...
    ["ddev-global"] = 319,
    ["ddev-project"] = 320,
    ["debugsettings.json"] = 321,
    ["dependabot-v2.json"] = 324,
    ["dependabot.json"] = 323,
    ["deployed-cli"] = 1093,
    ["devcontainer-feature.json"] = 261,
    ["devcontainer.json"] = 260,
    devinit = 1043,
    ["devspace.yaml"] = 1116,
    djlint = 1044,
    ["docker bake"] = 330,
    ["docker sequencer"] = 331,
    ["docker-compose.yml"] = 1042,
    ["dockerd.json"] = 328,
    ["dotnet Release Index manifest"] = 343,
    ["dotnet-tools.json"] = 344,
    ["dotnetcli.host.json"] = 345,
    ["dprint.json"] = 346,
    ["drone.json"] = 347,
    ["dss-2.0.0.json"] = 349,
    ["dstack configuration"] = 350,
    ["dtool dataset metadata"] = 1234,
    ["dvc.yaml"] = 351,
    ["ecosystem.json"] = 356,
    eksctl = 358,
    ["electron-builder configuration file"] = 384,
    ["epr-manifest.json"] = 383,
    ["estampo.toml"] = 382,
    ["evcc.yaml"] = 385,
    ["ezd task runner"] = 396,
    ["fabric.mod.json"] = 399,
    ["first-timers-bot"] = 407,
    ["flagd flag configuration"] = 124,
    ["fly.io Configuration"] = 125,
    fulibWorkflows = 1075,
    ["function.json"] = 419,
    ["gRPC API Gateway & OpenAPI Config"] = 19,
    ["gematik health care insurance list"] = 1245,
    ["gematik health care patient list"] = 1242,
    ["gematik health care provider institution list"] = 1244,
    ["gematik health care provider list"] = 1243,
    ["gematik tiger test environment configuration"] = 1246,
    ["git-town.toml"] = 1291,
    ["gitlab-ci"] = 439,
    ["global.json"] = 455,
    ["go-feature-flag Flag Configuration"] = 458,
    ["haxelib.json"] = 477,
    helmfile = 1029,
    helmwave = 1030,
    ["host-meta.json"] = 484,
    ...
    ["ide.host.json"] = 492,
    ["ifstate.yaml"] = 493,
    ["imageoptimizer.json"] = 494,
    ["importmap.json"] = 497,
    instant_python_config = 501,
    instant_python_custom_project = 502,
    intlayer = 503,
    ["ioBroker Configuration"] = 504,
    ["ioBroker JSON UI"] = 505,
    ["ioBroker Package manifest"] = 506,
    ["ixpect.conf.yaml"] = 507,
    ["ize.toml"] = 1129,
    ["jsconfig.json"] = 532,
    ["jscpd Configuration"] = 1113,
    jsdoc = 1025,
    ["k3d.yaml"] = 533,
    ["k9s aliases.yaml"] = 535,
    ["k9s cluster-config.yaml"] = 537,
    ["k9s config.yaml"] = 536,
    ["k9s hotkeys.yaml"] = 538,
    ["k9s plugins.yaml"] = 539,
    ["k9s skin.yaml"] = 540,
    ["k9s views.yaml"] = 541,
    ["kontinuous-config.yaml"] = 553,
    ["kontinuous-values.yaml"] = 552,
    ["kustomization.yaml"] = 555,
    ["label-commenter-config.yml"] = 556,
    ["latexindent configuration"] = 117,
    ["launchsettings.json"] = 557,
    lazydocker = 1151,
    lazygit = 1150,
    ["lego.json"] = 559,
    ["lerna.json"] = 560,
    ["lgtm.yml"] = 561,
    ["liblab.config.json"] = 562,
    ["libman.json"] = 563,
    ["license-report-config.json"] = 564,
    ["linkinator.config.json"] = 566,
    ["lint-staged (.lintstagedrc)"] = 1003,
    ["local.settings.json"] = 571,
    ["localazy.json"] = 572,
    ["lotus.yaml"] = 570,
    ["lsdlschema.json"] = 573,
    ["macro.json"] = 1117,
    ["markdown-link-check"] = 1071,
    maturin = 1072,
    mboats = 1079,
    memnex = 1331,
    ["micro-settings.json"] = 1144,
    ["mimetypes.json"] = 588,
    ["mirrord config"] = 1005,
    mise = 1006,
    ["mkdocs.yml"] = 608,
    ["mockd.yaml"] = 612,
    ["modelparams.dev Model"] = 614,
    ["monospace.yml"] = 615,
    ["moon.yml"] = 1228,
    ["mprocs Configuration file"] = 1198,
    ["mrdocs.yml"] = 610,
    ["mta.yaml"] = 1007,
    ["mtad.yaml"] = 1008,
    ["mycode.json"] = 623,
    nFPM = 635,
    ["napari plugin manifest"] = 624,
    neoload = 1020,
    ["nest-cli"] = 638,
    ["nexus-rpc-gen"] = 1318,
    ["nf-core module environment.yml"] = 632,
    ["nf-core module meta.yml"] = 633,
    ["nf-core subworkflow meta.yml"] = 634,
    ["ninjs (News in JSON)"] = 637,
    ["nitro.json"] = 1019,
    ["nixd configuration"] = 1170,
    ["nlu.json"] = 639,
    ["nodemon.json"] = 641,
    ["noodl config"] = 1078,
    ["notebook.mod.json"] = 642,
    now = 1015,
    ["npm-badges"] = 645,
    ["nswag.json"] = 649,
    ntangle = 651,
    ["nuclei-template.yaml"] = 646,
    ["nuget-project.json"] = 647,
    ["ocelot.json"] = 653,
    ogen = 656,
    ["omnisharp.json"] = 659,
    openHAB = 1304,
    ...
    oxlint = 1315,
    ["package.json"] = 694,
    ["package.manifest"] = 696,
    ["package.yaml"] = 695,
    ["partial-black.json"] = 151,
    ["partial-fastapi.json"] = 152,
    ["partial-pixi.json"] = 706,
    ["partial-scheduled.json"] = 153,
    ["pattern.json"] = 704,
    ["petstore-v1.0"] = 1124,
    pgap_yaml_input_reader = 702,
    pgrls = 703,
    pgxgen = 1308,
    pitcms = 1311,
    ["pixi.toml"] = 705,
    ["plagiarize-me.yaml"] = 710,
    ["plagiarize.yaml"] = 709,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1235,
    ["podbard.yaml"] = 712,
    ["portman.json"] = 715,
    ["prefect.toml"] = 724,
    ["prefect.yaml"] = 725,
    ...
    ["prettierrc.json"] = 727,
    ["prisma.yml"] = 728,
    ["project-1.0.0-beta3.json"] = 740,
    ["project-1.0.0-beta4.json"] = 741,
    ["project-1.0.0-beta5.json"] = 742,
    ["project-1.0.0-beta6.json"] = 743,
    ["project-1.0.0-beta8.json"] = 744,
    ["project-1.0.0-rc1.json"] = 745,
    ["project-1.0.0-rc2.json"] = 746,
    ["project.json"] = 739,
    ["project.owasp.yaml"] = 747,
    ["prometheus-alertmanager.json"] = 751,
    ["prometheus.json"] = 748,
    ["prometheus.rules.json"] = 749,
    ["prometheus.rules.test.json"] = 750,
    ["proxies.json"] = 752,
    ["publiccode.yml"] = 753,
    ["pubspec.yaml"] = 754,
    ["pyrseas-0.8.json"] = 757,
    pytest = 766,
    ["quilt.mod.json"] = 1145,
    ["rc3 auth"] = 772,
    ["rc3 collection"] = 773,
    ...
    ["rc3 settings"] = 777,
    ["registry.yaml"] = 55,
    ["release drafter"] = 1021,
    ["release-hub.json"] = 6,
    ["release-please-config.json"] = 782,
    ["release-please-manifest.json"] = 783,
    ["release-plz.toml"] = 784,
    ["renv.lock"] = 798,
    ["reposets Configuration"] = 787,
    ["reposets Credentials"] = 788,
    ["revola.json"] = 4,
    ["rivet.json"] = 1169,
    ["rivet.yaml (legacy)"] = 1168,
    rumdl = 803,
    runny = 802,
    runspec = 1332,
    rustfmt = 804,
    ...
    samt = 807,
    samtrc = 808,
    ["sarif-1.0.0.json"] = 810,
    ["sarif-2.0.0.json"] = 811,
    ["sarif-2.1.0"] = 821,
    ["sarif-2.1.0-rtm.2"] = 812,
    ["sarif-2.1.0-rtm.3"] = 814,
    ["sarif-2.1.0-rtm.4"] = 816,
    ["sarif-2.1.0-rtm.5"] = 818,
    ["sarif-2.1.0-rtm.6"] = 819,
    ["sarif-external-property-file-2.1.0"] = 822,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 813,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 815,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 817,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 820,
    ["scalingo.json configuration"] = 823,
    ["schema.org - Action"] = 825,
    ["schema.org - ContactPoint"] = 826,
    ["schema.org - Place"] = 827,
    ["schema.org - Thing"] = 828,
    ["secrethub.yml"] = 1147,
    ["semantic-release"] = 836,
    ["servicehub.config.json"] = 998,
    ["servicehub.service.json"] = 997,
    ["settings.job"] = 839,
    ["sfdx-hardis configuration"] = 841,
    ["shard.yml"] = 1185,
    ["size-limit configuration"] = 846,
    ["skaffold.yaml"] = 1069,
    ["skyuxconfig.json"] = 848,
    ["snowflake-config"] = 850,
    ["snowflake-connections"] = 851,
    ["spicepod.yaml"] = 1206,
    ["sqlc configuration"] = 885,
    ["stripe-app-local.json"] = 896,
    ["stripe-app.json"] = 895,
    swcrc = 1053,
    ["task.json"] = 905,
    taskcat = 1016,
    ["template.json"] = 910,
    ["templatsources.json"] = 911,
    ["text2confl config"] = 1316,
    ["theme.json"] = 914,
    ["tizen_workspace.json"] = 916,
    tldr = 917,
    ["tm_devices configuration file"] = 1273,
    tmuxinator = 1001,
    tox = 919,
    ["transcend.yml"] = 928,
    ["tree-sitter grammar.json"] = 464,
    ["trime.yaml"] = 929,
    ["trunk.yaml"] = 931,
    ["ts-force-config.json"] = 936,
    ["tsconfig.json"] = 932,
    ["tsd.json"] = 933,
    ["tsdoc.json"] = 934,
    ["tsdrc.json"] = 935,
    ...
    v8r = 979,
    vcluster = 1192,
    ["vcpkg configuration file"] = 266,
    ["vcpkg manifest file"] = 265,
    ["vega-lite.json"] = 961,
    ["vega.json"] = 960,
    ["venvironment.yaml"] = 963,
    ["venvplus.yaml"] = 964,
    version = 1255,
    ["version.json"] = 966,
    ["vhwdebugger-binding.yaml"] = 968,
    ["vim-addon-info"] = 969,
    ["vs-2017.3.host.json"] = 971,
    ["vs-nesting.json"] = 972,
    ["vsls.json"] = 970,
    ["vss-extension.json"] = 976,
    vtcfg = 1261,
    ["vtesttree.yaml"] = 977,
    ["vtestunit.yaml"] = 978,
    ["warp-keysets.json"] = 1153,
    ["warp-themes.json"] = 1154,
    ["warp-workflows.json"] = 1155,
    ["webhint.io"] = 1109,
    ["webjobpublishsettings.json"] = 983,
    ["webjobs-list.json"] = 982,
    ["well-known-fursona"] = 1193,
    ["xs-app.json"] = 1011,
    ["xunit.runner.json"] = 996,
    yamlfmt = 1038,
    yamllint = 1039,
    ["yap.json"] = 1040,
    ["zerops.yml"] = 1202,
