...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 97,
    [".cryproj (generic)"] = 396,
    [".cryproj engine-5.2"] = 391,
    [".cryproj engine-5.3"] = 392,
    [".cryproj engine-5.4"] = 393,
    [".cryproj engine-5.5"] = 394,
    [".cryproj engine-dev"] = 395,
    [".csscomb.json"] = 99,
    [".csslintrc"] = 100,
    [".eslintrc"] = 135,
    [".esmrc.json"] = 128,
    ...
    [".mtaext"] = 402,
    [".nodehawkrc"] = 241,
    [".npmpackagejsonlintrc"] = 243,
    [".phraseapp.yml"] = 270,
    [".pmbot.yml"] = 263,
    [".postcssrc"] = 268,
    [".pre-commit-config.yml"] = 269,
    [".putout.json"] = 287,
    [".rehyperc"] = 292,
    [".remarkrc"] = 293,
    [".sprite files"] = 328,
    ...
    [".vsext"] = 372,
    [".yarnrc.yml"] = 434,
    ["<div>RIOTS' studio configuration"] = 375,
    ["API Builder"] = 431,
    ["AWS CloudFormation"] = 87,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 88,
    ...
    ["Azure Pipelines"] = 32,
    ["Azure Static Web Apps CLI configuration file"] = 330,
    ["Azure Static Web Apps configuration file"] = 329,
    ["Better Code Hub"] = 436,
    BizTalkServerApplicationSchema = 408,
    Briefcase = 413,
    Buildkite = 53,
    ...
    ["Citation File Format"] = 89,
    CityJSON = 62,
    ["Code Climate"] = 67,
    ["Container Structure Test"] = 419,
    Containerlab = 444,
    ...
    ["Dolittle Event Horizons Configuration"] = 114,
    ["Dolittle Resources Configuration"] = 115,
    ["Dolittle Server Configuration"] = 116,
    ["Dolittle Tenant Map Configuration"] = 118,
    ...
    Esquio = 129,
    ["Expo SDK"] = 134,
    ["F-Droid Data metadata"] = 138,
    ["Facets - FSDL - Application"] = 136,
    ["Fossa configuration file"] = 143,
    ["Foundry VTT - Manifest"] = 141,
    ["Foundry VTT - Template"] = 142,
    ["Foxx Manifest"] = 33,
    ["GatewayCore API Gateway"] = 146,
    ["GitHub Action"] = 150,
    ["GitHub Funding"] = 151,
    ["GitHub Issue Template configuration"] = 153,
    ["GitHub Workflow"] = 154,
    ["GitHub Workflow Template Properties"] = 155,
    ["GitHub issue forms"] = 152,
    GitVersion = 149,
    ["Gitpod Configuration"] = 157,
    ["Global Privacy Control"] = 147,
    ["Google Cloud Workflows"] = 86,
    Goreleaser = 160,
    ["Goreleaser Pro"] = 161,
    ["Gradle Build Cache Node"] = 433,
    ["Gradle Enterprise"] = 432,
    ["Grafana 5.x Dashboard"] = 162,
    ["GraphQL Code Generator"] = 165,
    ["GraphQL Config"] = 164,
    ["GraphQL Mesh"] = 163,
    ["Grunt JSHint task"] = 169,
    ["Grunt Watch task"] = 170,
    ["Grunt base task"] = 171,
    ["Grunt clean task"] = 167,
    ["Grunt copy task"] = 166,
    ["Grunt cssmin task"] = 168,
    HEMTT = 405,
    Hadolint = 417,
    ["Hammerkit YAML Schema"] = 443,
    Hayson = 173,
    ["Haystack Pipeline"] = 174,
    ["Hazelcast 5 Configuration"] = 175,
    ["Helm Chart.lock"] = 65,
    ["Helm Chart.yaml"] = 64,
    ["JFrog File Spec"] = 188,
    ["JSON Document Transform"] = 196,
    ["JSON Feed"] = 197,
    ["JSON Resume"] = 295,
    ["JSON Schema Draft 2020-12"] = 387,
    ["JSON Schema Draft 4"] = 384,
    ["JSON Schema Draft 7"] = 385,
    ["JSON Schema Draft 8"] = 386,
    ["JSON schema for CodeShip Pro services configuration files"] = 73,
    ["JSON schema for CodeShip Pro steps configuration files"] = 74,
    ["JSON schema for Codecov configuration files"] = 72,
    ["JSON-API"] = 195,
    ["JSON-e templates"] = 441,
    ["JSON-stat 2.0"] = 381,
    JSONPatch = 199,
    ["Jekyll configuration"] = 185,
    ["Jenkins X Pipelines"] = 186,
    ["Jenkins X Requirements"] = 187,
    ["Jovo Language Models"] = 189,
    ["KSP-AVC"] = 382,
    ["KSP-CKAN"] = 383,
    Liquibase = 448,
    ["MegaLinter configuration"] = 213,
    ["MegaLinter descriptor"] = 214,
    ["Meltano plugin discovery definition"] = 216,
    ["Meltano project definition"] = 215,
    ["Microsoft Band Web Tile"] = 217,
    ["Minecraft Data Pack Advancement"] = 219,
    ["Minecraft Data Pack Biome"] = 220,
    ["Minecraft Data Pack Configured Carver"] = 221,
    ["Minecraft Data Pack Dimension"] = 223,
    ["Minecraft Data Pack Dimension Type"] = 222,
    ["Minecraft Data Pack Item Modifier"] = 224,
    ["Minecraft Data Pack Loot Table"] = 225,
    ["Minecraft Data Pack Metadata"] = 226,
    ["Minecraft Data Pack Predicate"] = 227,
    ["Minecraft Data Pack Recipe"] = 228,
    ["Minecraft Data Pack Template Pool"] = 229,
    ["Minecraft Resourcepack Sounds"] = 230,
    ["Netin Diagnostic System Template"] = 455,
    ["Netlify config schema"] = 235,
    ["Nightwatch.js"] = 236,
    ["OSS Review Toolkit repository configuration"] = 257,
    Opctl = 404,
    ["OpenWeather Current Weather API"] = 440,
    ["OpenWeather Road Risk API"] = 439,
    ["Ory Hydra configuration"] = 179,
    ["Ory Keto configuration"] = 202,
    ["Ory Kratos configuration"] = 256,
    ["Ory Oathkeeper configuration"] = 248,
    ["Outblocks App configuration"] = 254,
    ["Outblocks database table"] = 255,
    ["Outblocks project configuration"] = 253,
    Packer = 260,
    ["Pipeline component"] = 449,
    ["PocketMine plugin.yml"] = 264,
    ["Pull Request Labeler"] = 286,
    Qodana = 462,
    ["RKE Cluster Configuration JSON Schema"] = 447,
    ["RKE Cluster Configuration YAML Schema"] = 446,
    Ray = 416,
    ["Read the Docs"] = 289,
    ["Red-DiscordBot Cog"] = 290,
    ["Red-DiscordBot Cog Repo"] = 291,
    Renovate = 296,
    RoadRunner = 297,
    SWADL = 339,
    ["Sapphire CLI Config"] = 298,
    ["SauceCTL Configuration"] = 452,
    ["Schema Catalog"] = 311,
    ["Scoop manifest"] = 316,
    ["Semgrep Rule"] = 317,
    ["Serverless Framework Configuration"] = 459,
    ["Settings.paf"] = 319,
    ["Shopware CLI Extension Store Configuration"] = 460,
    ["Shopware CLI Project Store Configuration"] = 461,
    Solidarity = 324,
    ["Source Maps v3"] = 325,
    SpecIF = 326,
    ["Sponge Mixin configuration"] = 327,
    ["StackHawk Scanner Configuration"] = 458,
    ["StackHead CLI config"] = 331,
    ["StackHead module configuration"] = 332,
    ["StackHead project definition"] = 333,
    Stale = 334,
    ["Statamic Blueprint"] = 335,
    ["Stryker Mutator"] = 336,
    ["StyleCop Analyzers Configuration"] = 337,
    ["Swagger API 2.0"] = 340,
    ["Taskfile YAML Schema"] = 442,
    Taurus = 341,
    ["TestEnvironment.json"] = 346,
    ["Traefik v2"] = 348,
    ["Traefik v2 File Provider"] = 349,
    Tye = 463,
    ["UI5 Manifest"] = 361,
    ["Ubuntu Server Autoinstall"] = 359,
    ["Uniswap Token List"] = 425,
    ["User Journey Map YAML Schema"] = 445,
    ["VSCode Code Snippets"] = 76,
    ["VSIX CLI publishing"] = 373,
    ["Vela Pipeline Configuration"] = 365,
    Vercel = 75,
    ["Web App Manifest"] = 377,
    ["Web types"] = 380,
    WebExtensions = 376,
    ["Windows Package Manager Installer Manifest"] = 422,
    ["Windows Package Manager Locale Manifest"] = 423,
    ["Windows Package Manager Singleton Manifest"] = 421,
    ["Woodpecker pipeline config"] = 454,
    ["Yippee-Ki-JSON configuration YML"] = 427,
    ["angular.json"] = 6,
    ...
    ["chutzpah.json"] = 82,
    ["cloud-sdk-pipeline-config-schema"] = 84,
    ["cloudbuild.json"] = 85,
    cloudify = 70,
    codemagic = 71,
    ["coffeelint.json"] = 90,
    comet = 437,
    ["commands.json"] = 79,
    ["compile_commands.json"] = 78,
    ["compilerconfig.json"] = 77,
    ["component.json"] = 92,
    ["composer.json"] = 91,
    ["config.json"] = 93,
    ["contentmanifest.json"] = 83,
    ["contribute.json"] = 94,
    ["cosmos.config.json"] = 80,
    ["crowdin.yml"] = 95,
    cspell = 98,
    ["cypress.json"] = 96,
    ["datalogic-scan2deploy-android"] = 103,
    ["datalogic-scan2deploy-ce"] = 104,
    ["debugsettings.json"] = 105,
    ["dependabot-v2.json"] = 107,
    ["dependabot.json"] = 106,
    ["detekt.yml"] = 109,
    devinit = 429,
    ["docfx.json"] = 111,
    ["docker-compose.yml"] = 428,
    ["dotnet Release Index manifest"] = 120,
    ["dotnetcli.host.json"] = 121,
    ["drone.json"] = 122,
    ["dss-2.0.0.json"] = 124,
    ["dvc.yaml"] = 125,
    ["ecosystem.json"] = 127,
    ["electron-builder configuration file."] = 132,
    ["epr-manifest.json"] = 130,
    ["evcc.yaml"] = 133,
    ["fabric.mod.json"] = 137,
    ["first-timers-bot"] = 140,
    fulibWorkflows = 453,
    ["func.yaml"] = 144,
    ["function.json"] = 145,
    ["geojson.json"] = 148,
    ["gitlab-ci"] = 156,
    ["global.json"] = 158,
    ["golangci-lint Configuration"] = 159,
    ["haxelib.json"] = 172,
    helmfile = 418,
    ["host-meta.json"] = 177,
    ["host.json"] = 176,
    ...
    httpmockrc = 409,
    huskyrc = 398,
    ["imageoptimizer.json"] = 180,
    ["importmap.json"] = 182,
    ["ioBroker JSON UI"] = 183,
    ["ioBroker Package manifest"] = 184,
    ["jsconfig.json"] = 200,
    jsdoc = 415,
    ["k3d.yaml"] = 201,
    ["kustomization.yaml"] = 203,
    ["label-commenter-config.yml"] = 204,
    ["launchsettings.json"] = 205,
    ["lerna.json"] = 206,
    ["lgtm.yml"] = 207,
    ["libman.json"] = 208,
    ["license-report-config.json"] = 209,
    ["local.settings.json"] = 210,
    ["localazy.json"] = 211,
    ["lsdlschema.json"] = 212,
    ["markdownlint.json"] = 451,
    mboats = 457,
    ["mimetypes.json"] = 218,
    ["mta.yaml"] = 400,
    ["mtad.yaml"] = 401,
    ["mycode.json"] = 233,
    ["napari plugin manifest"] = 234,
    neoload = 410,
    ["nest-cli"] = 239,
    ["ninjs (News in JSON) 1.3"] = 238,
    ["ninjs (News in JSON) 2.0"] = 237,
    ["nlu.json"] = 240,
    ["nodemon.json"] = 242,
    ["noodl.schema.json"] = 456,
    now = 406,
    ["nswag.json"] = 246,
    ntangle = 247,
    ["nuclei-template.yaml"] = 244,
    ["nuget-project.json"] = 245,
    ["ocelot.json"] = 249,
    ["omnisharp.json"] = 250,
    ["openapi.json"] = 251,
    ["openfin.json"] = 252,
    ["package.json"] = 258,
    ["package.manifest"] = 259,
    ["pattern.json"] = 262,
    pgap_yaml_input_reader = 261,
    ["plagiarize-me.yaml"] = 266,
    ["plagiarize.yaml"] = 265,
    ["portman.json"] = 267,
    ["prettierrc.json"] = 271,
    ["prisma.yml"] = 272,
    ["project-1.0.0-beta3.json"] = 274,
    ["project-1.0.0-beta4.json"] = 275,
    ["project-1.0.0-beta5.json"] = 276,
    ["project-1.0.0-beta6.json"] = 277,
    ["project-1.0.0-beta8.json"] = 278,
    ["project-1.0.0-rc1.json"] = 279,
    ["project-1.0.0-rc2.json"] = 280,
    ["project.json"] = 273,
    ["prometheus.json"] = 281,
    ["prometheus.rules.json"] = 282,
    ["proxies.json"] = 283,
    ["publiccode.yml"] = 284,
    ["pubspec.yaml"] = 285,
    ["pyrseas-0.8.json"] = 288,
    ["release drafter"] = 411,
    ["sarif-1.0.0.json"] = 299,
    ["sarif-2.0.0.json"] = 300,
    ["sarif-2.1.0"] = 309,
    ["sarif-2.1.0-rtm.2"] = 301,
    ["sarif-2.1.0-rtm.3"] = 303,
    ["sarif-2.1.0-rtm.4"] = 305,
    ["sarif-2.1.0-rtm.5"] = 307,
    ["sarif-external-property-file-2.1.0"] = 310,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 302,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 304,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 306,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 308,
    ["schema.org - Action"] = 312,
    ["schema.org - ContactPoint"] = 313,
    ["schema.org - Place"] = 314,
    ["schema.org - Thing"] = 315,
    ["servicehub.config.json"] = 390,
    ["servicehub.service.json"] = 389,
    ["settings.job"] = 318,
    ["sfdx-hardis configuration"] = 320,
    ["size-limit configuration"] = 321,
    ["skaffold.yaml"] = 450,
    ["skyuxconfig.json"] = 322,
    snapcraft = 323,
    swcrc = 438,
    taskcat = 407,
    ["template.json"] = 342,
    ["templatsources.json"] = 343,
    ["theme.json"] = 344,
    tmLanguage = 345,
    ["trunk.yaml schema"] = 350,
    ["ts-force-config.json"] = 354,
    ["tsconfig.json"] = 351,
    ["tsd.json"] = 352,
    ["tsdrc.json"] = 353,
    ["tslint.json"] = 355,
    ...
    ["version.json"] = 366,
    ["vim-addon-info"] = 367,
    ["vs-2017.3.host.json"] = 369,
    ["vs-nesting.json"] = 370,
    ["vsls.json"] = 368,
    ["vss-extension.json"] = 374,
    ["webjobpublishsettings.json"] = 379,
    ["webjobs-list.json"] = 378,
    ["xs-app.json"] = 403,
    ["xunit.runner.json"] = 388,
    yamllint = 426,
    zuul = 412,
    ["Žinoma"] = 420
  },
