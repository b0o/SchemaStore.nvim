...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 811,
    [".nodehawkrc"] = 505,
    [".npmpackagejsonlintrc"] = 509,
    [".omletrc"] = 985,
    [".phrase.yml"] = 571,
    [".phraseapp.yml"] = 572,
    [".pmbot.yml"] = 559,
    [".postcssrc"] = 566,
    [".powerpages-web-template-manifest"] = 568,
    [".pre-commit-config.yml"] = 569,
    [".pre-commit-hooks.yml"] = 570,
    [".putout.json"] = 599,
    [".rehyperc"] = 622,
    [".remarkrc"] = 626,
    [".sprite files"] = 693,
    ...
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1029,
    ["API Builder"] = 846,
    ["AVA Configuration"] = 908,
    ...
    ["Adobe UXP Manifest"] = 968,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 880,
    ["All Contributors configuration file"] = 933,
    ...
    ["Application list for a WinUtil"] = 1011,
    ArchitectFX = 1016,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure Pipelines"] = 76,
    ["Azure Static Web Apps CLI configuration file"] = 697,
    ["Azure Static Web Apps configuration file"] = 696,
    ["BOSH Deploy Config"] = 100,
    ["BX CI"] = 118,
    ["Bashly (bashly.yml)"] = 937,
    ["Bashly Settings (bashly-settings.yml)"] = 938,
    ["Better Code Hub"] = 850,
    ["Better Scripts"] = 119,
    Bigconfig = 93,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1022,
    BizTalkServerApplicationSchema = 818,
    Bleep = 120,
    ...
    ["Butane Config"] = 893,
    C4InterFlow = 1037,
    ["CGS Card Game Specification (cgs.json)"] = 973,
    ["CICS TS region tagging"] = 902,
    ["CICS TS resource import"] = 903,
    ["CICS TS resource model"] = 904,
    ["CICS TS resource overrides"] = 905,
    ["CMake Presets"] = 121,
    ["CNC Codes"] = 138,
    ["CRS WAF test file"] = 1001,
    ["CRS WAF test platform overrides file"] = 1002,
    ...
    ["Chamaleon environment"] = 1026,
    ["Chamaleon properties"] = 1027,
    ["Chamaleon template"] = 1025,
    Changesets = 221,
    Charmcraft = 130,
    Cheatsheets = 890,
    ...
    CityJSON = 133,
    ["Clawject config"] = 144,
    ["Cloud Foundry Application Manifest"] = 984,
    ["Cloud Run Spec v1"] = 1006,
    ...
    Concord = 1000,
    ["Configu .cfgu files"] = 989,
    ["Configu .configu file"] = 990,
    Conjure = 137,
    ["Container Structure Test"] = 832,
    Containerlab = 859,
    ["Contextive Glossary"] = 1051,
    Convex = 136,
    ["Crowdsec collection config"] = 231,
    ["Crowdsec parser config"] = 232,
    ["Crowdsec scenario config"] = 233,
    ["CumulusCI Config"] = 143,
    ["Custom Machinery Machine"] = 974,
    ["Custom Machinery Recipe"] = 975,
    ...
    ["DonateCaseBetterCasino menu"] = 1030,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 945,
    ["EAS config"] = 297,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 934,
    ["EasyVCR .NET"] = 298,
    ["Eidolon Resource"] = 1017,
    ...
    ["GeoJSON.json latest"] = 897,
    GherKing = 901,
    ["GitHub Action"] = 328,
    ["GitHub Actions typing"] = 1013,
    ...
    ["Google Digital Assetlinks"] = 1052,
    Goreleaser = 356,
    ["Goreleaser Pro"] = 357,
    Goss = 358,
    ["Gradle Build Cache Node"] = 848,
    ["Gradle Enterprise"] = 847,
    ...
    Hadolint = 828,
    Hammerkit = 858,
    ["Hardware Sentry Configuration"] = 913,
    Hatch = 829,
    Hayson = 371,
    ...
    ["JFrog File Spec"] = 401,
    ["JFrog Pipelines YML DSL"] = 922,
    ["JMeter DSL cli config"] = 402,
    JReleaser = 404,
    ["JSON Document Transform"] = 412,
    ["JSON Feed"] = 413,
    ["JSON Resume"] = 631,
    ["JSON Schema Draft 2020-12"] = 797,
    ["JSON Schema Draft 4"] = 794,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 955,
    ["JSON Schema Draft 7"] = 795,
    ["JSON Schema Draft 7 (unofficial strict)"] = 956,
    ["JSON Schema Draft 8 (2019-09)"] = 796,
    ["JSON-API"] = 411,
    ["JSON-e templates"] = 855,
    ["JSON-stat 2.0"] = 790,
    JSONPatch = 415,
    ...
    ["Metadata for a Cinnamon spice"] = 1009,
    ["Metatype Configuration"] = 463,
    ["MetricsHub Configuration"] = 464,
    ["MetricsHub Connector Configuration"] = 465,
    ["Micro Editor Syntax"] = 946,
    ["Microsoft Band Web Tile"] = 466,
    ["Microsoft RulesEngine workflow rules"] = 997,
    ["Microsoft RulesEngine workflow rules list"] = 998,
    ["Minecraft Custom Main Menu Mod"] = 963,
    ...
    ["MongoDB Atlas Search Index Definition"] = 917,
    ["Monika Configuration"] = 915,
    ["Monoweave Configuration"] = 491,
    ["Motif config"] = 810,
    MultiQC = 1045,
    ["NOX Framework (Service)"] = 508,
    ["Netin Diagnostic System Template"] = 875,
    ["Netlify config"] = 499,
    ["Network-as-Code Data Model"] = 500,
    ["Nightwatch.js"] = 501,
    ["Node.js configuration"] = 815,
    ["NueJS configuration file"] = 513,
    ["Nuitka.yaml"] = 976,
    ["Nullstone config"] = 515,
    ["ONe's changelog entry"] = 529,
    ["ONe's service descriptor"] = 528,
    ["ORT Server repository environment configuration"] = 536,
    ["OSCAL Assessment Plan (AP)"] = 538,
    ["OSCAL Assessment Results (AR)"] = 539,
    ["OSCAL Catalog"] = 540,
    ["OSCAL Component Definition (CDef)"] = 541,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 542,
    ["OSCAL Profile"] = 543,
    ["OSCAL System Security Plan (SSP)"] = 544,
    ["OSS Review Toolkit configuration"] = 545,
    ["OSS Review Toolkit curation"] = 546,
    ["OSS Review Toolkit package configuration"] = 547,
    ["OSS Review Toolkit repository configuration"] = 548,
    ["OSS Review Toolkit resolutions"] = 549,
    ["October CMS columns"] = 519,
    ["October CMS fields"] = 520,
    Okteto = 521,
    Opctl = 813,
    ["Open Data Contract Standard (ODCS)"] = 532,
    ["Open Know-How"] = 1050,
    ["OpenRewrite Resource"] = 531,
    ["OpenUtau character yaml"] = 525,
    ["OpenUtau ustx"] = 526,
    ["OpenWeather Current Weather API"] = 854,
    ["OpenWeather Road Risk API"] = 853,
    ["Ory Hydra configuration"] = 379,
    ["Ory Keto configuration"] = 433,
    ["Ory Kratos configuration"] = 537,
    ["Ory Oathkeeper configuration"] = 517,
    ["Outblocks App configuration"] = 534,
    ["Outblocks database table"] = 535,
    ["Outblocks project configuration"] = 533,
    PDM = 555,
    Packer = 552,
    Pantsbuild = 932,
    ["Paper paper-plugin.yml"] = 553,
    ["Pipeline component"] = 866,
    ["Platform.sh application"] = 2,
    ["Platform.sh routes"] = 3,
    ["Platform.sh services"] = 4,
    ["Plex Prerolls"] = 563,
    ["PocketMine plugin.yml"] = 560,
    ["Postman collection"] = 567,
    ["Preset list for a WinUtil"] = 1012,
    ["ProActions AI-Kit Configuration"] = 576,
    ["ProActions AI-Kit Configuration for Menus"] = 578,
    ["ProActions AI-Kit Configuration for Sections"] = 580,
    ["ProActions AI-Kit Configuration for Services"] = 577,
    ["ProActions AI-Kit Configuration for Steps"] = 581,
    ["ProActions AI-Kit Configuration for Templates"] = 579,
    ["Problem object RFC9457"] = 960,
    ["Problem package generators"] = 582,
    Pterodactyl = 912,
    ["Pull Request Labeler"] = 598,
    Pulumi = 606,
    ["PyGTA Config"] = 602,
    PyProject = 607,
    Pylock = 1053,
    Pyright = 608,
    ["Python script metadata"] = 1047,
    Qgoda = 610,
    Qodana = 885,
    ["Qt Creator workspace file"] = 991,
    ["Quali Torque Blueprint Spec 2"] = 910,
    ["QueryFirst config file"] = 928,
    ["RKE Cluster Configuration JSON"] = 863,
    ["RKE Cluster Configuration YAML"] = 862,
    RadioHound = 601,
    Railway = 611,
    ["Rancher Fleet"] = 603,
    ["Rattler-build"] = 612,
    Ray = 827,
    ["Read the Docs"] = 605,
    ["Red-DiscordBot Cog"] = 619,
    ["Red-DiscordBot Cog Repo"] = 620,
    ["Red-DiscordBot Trivia"] = 621,
    ["Render Blueprints"] = 861,
    RenderCV = 633,
    Renovate = 632,
    ["Replit config"] = 627,
    Restate = 1040,
    RoadRunner = 635,
    ["Rudder techniques"] = 966,
    Ruff = 629,
    ["Rust Project"] = 630,
    ["Rust toolchain"] = 639,
    ["SDMX data message"] = 665,
    ["SDMX metadata message"] = 664,
    ["SDMX structure message"] = 663,
    ["SIL Kit Participant Configuration"] = 675,
    ["SIL Kit Registry Configuration"] = 676,
    ["SPDX 2.3"] = 694,
    SWADL = 708,
    ["Safebox Config"] = 923,
    ["Sapphire CLI Config"] = 642,
    ["SauceCTL Configuration"] = 872,
    ["Schema Catalog"] = 657,
    ["Scoop manifest"] = 662,
    ["Semantic Data Fabric (SDF) file"] = 666,
    ["Semgrep Rule"] = 668,
    ["Serenity Code Generator (Sergen)"] = 669,
    ["Serverless Framework Configuration"] = 879,
    ["Serverless Workflow"] = 881,
    ["Settings for a Cinnamon spice"] = 1008,
    ["Settings.paf"] = 671,
    ["Shopware 6 Configuration"] = 882,
    ["Shopware CLI Extension Store Configuration"] = 883,
    ["Shopware CLI Project Store Configuration"] = 884,
    ["Sigma Detection Rule"] = 673,
    ["Sigrid scope configuration file"] = 674,
    ["SkyPilot Task JSON"] = 967,
    ["Slack app manifest"] = 678,
    Solidarity = 683,
    ["Solution filters"] = 684,
    ["Source Maps v3"] = 685,
    Sourcery = 686,
    ["Speakeasy Generation Config File"] = 690,
    ["Speakeasy Lint Configuration File"] = 687,
    ["Speakeasy Test Generation Configuration File"] = 688,
    ["Speakeasy Workflow File"] = 689,
    SpecIF = 691,
    ["Sponge Mixin configuration"] = 692,
    StackBlitz = 698,
    ["StackHawk Scanner Configuration"] = 878,
    Stale = 699,
    ["Starlake Data Pipeline"] = 851,
    Starship = 700,
    ["Statamic Blueprint"] = 701,
    ["Stella configuration file"] = 702,
    ["Stryker Mutator"] = 705,
    ["StyleCop Analyzers Configuration"] = 706,
    ["Stylelint (.stylelintrc)"] = 707,
    ["Stylua Config"] = 1054,
    ["Sublime Syntax"] = 924,
    ["Subsquid squid manifest"] = 969,
    ["Swagger API 2.0"] = 709,
    ["Synadia Connect Component"] = 710,
    TSON = 744,
    TSTyche = 745,
    ["Tab data for a LinUtil"] = 1015,
    ["Tab list for a LinUtil"] = 1014,
    Tach = 711,
    ["Tach Domain"] = 712,
    Talhelper = 714,
    ["Talisman configuration"] = 715,
    Taplo = 1055,
    ["Taskfile config"] = 856,
    Taurus = 716,
    Tauticord = 717,
    Telefonistka = 1041,
    ["TestEnvironment.json"] = 727,
    ["TextMate Grammar"] = 726,
    ["Tier.run pricing.json"] = 720,
    Tikibase = 721,
    Tombi = 725,
    ["Traefik v2"] = 730,
    ["Traefik v2 File Provider"] = 731,
    ["Traefik v3"] = 732,
    ["Traefik v3 File Provider"] = 733,
    ["Travis CI (.travis.yml)"] = 729,
    Trident = 1039,
    ["TrueScript for *.tscript files"] = 736,
    ["Tugboat QA config.yml"] = 1036,
    TunnelHub = 959,
    Turborepo = 728,
    Tycho = 1004,
    Tye = 886,
    ["Tyk Gateway - Open Source v5.7+"] = 1046,
    ["Typst Manifest"] = 750,
    ["UET BuildConfig.json"] = 929,
    ["UI5 Manifest"] = 756,
    ["UNCORS configuration"] = 760,
    ["UTAM Page Object"] = 759,
    ["Ubuntu Server Autoinstall"] = 754,
    ["Uniswap Token List"] = 839,
    ["Universal Schedule Format"] = 761,
    ["Unreal Engine Uplugin"] = 930,
    ["Unreal Engine Uproject"] = 931,
    ["Updatecli Compose"] = 894,
    ["Updatecli Policy Manifest"] = 895,
    ["Updatecli Policy Metadata"] = 896,
    Uplift = 927,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 860,
    V2Ray = 900,
    ["VSCode Code Snippets"] = 196,
    ["VSIX CLI publishing"] = 779,
    Vector = 763,
    ["Vela Pipeline Configuration"] = 766,
    Vercel = 195,
    ["Version Bumper config"] = 769,
    ["Viash Component Config"] = 1043,
    ["Viash Package Config"] = 1044,
    Visivo = 957,
    Wake = 1038,
    ["Waku Config"] = 1018,
    ["Web App Manifest"] = 785,
    ["Web types"] = 788,
    WebExtensions = 784,
    ["Webman package recipe"] = 906,
    ["Windows Package Manager Installer Manifest"] = 835,
    ["Windows Package Manager Locale Manifest"] = 836,
    ["Windows Package Manager Singleton Manifest"] = 834,
    Winutil = 837,
    ["WireMock stub mapping"] = 1021,
    ["Woodpecker pipeline config"] = 874,
    ["Wrangler CLI"] = 789,
    ["Xstate Machine"] = 892,
    ["Yandex Workflow Language"] = 1010,
    ["Yarn Config (.yarnrc.yml)"] = 849,
    ["Yippee-Ki-JSON configuration YML"] = 841,
    ["YouTrack App"] = 1007,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 961,
    ...
    ["behat.yml"] = 102,
    ["bigquery-table"] = 92,
    ["bioimageio resource description"] = 977,
    ...
    ["crowdin.yml"] = 230,
    ["ctfd-setup configuration file"] = 1028,
    ["custom-elements.json"] = 949,
    ["cypress.json"] = 234,
    ...
    ["gematik health care insurance list"] = 1034,
    ["gematik health care patient list"] = 1031,
    ["gematik health care provider institution list"] = 1033,
    ["gematik health care provider list"] = 1032,
    ["gematik tiger test environment configuration"] = 1035,
    ["gitlab-ci"] = 336,
    ["global.json"] = 352,
    ...
    ["lint-staged (.lintstagedrc)"] = 805,
    ["local.settings.json"] = 453,
    ["localazy.json"] = 454,
    ["lotus.yaml"] = 452,
    ["lsdlschema.json"] = 455,
    ["markdown-link-check"] = 869,
    maturin = 870,
    mboats = 877,
    ["micro-settings.json"] = 941,
    ["mimetypes.json"] = 467,
    ["mirrord config"] = 806,
    mise = 807,
    ["mkdocs.yml"] = 487,
    ...
    neoload = 821,
    ["nest-cli"] = 503,
    ["ninjs (News in JSON)"] = 502,
    ["nitro.json"] = 820,
    ["nixd configuration"] = 965,
    ["nlu.json"] = 504,
    ["nodemon.json"] = 506,
    ["noodl config"] = 876,
    ["notebook.mod.json"] = 507,
    now = 816,
    ["npm-badges"] = 510,
    ["nswag.json"] = 514,
    ntangle = 516,
    ["nuclei-template.yaml"] = 511,
    ["nuget-project.json"] = 512,
    ["ocelot.json"] = 518,
    ["omnisharp.json"] = 522,
    ["openapi.json"] = 523,
    ["openfin.json"] = 530,
    ...
    ["ops.yaml"] = 527,
    ["package.json"] = 550,
    ["package.manifest"] = 551,
    ["partial-black.json"] = 103,
    ["pathfinder.yml"] = 554,
    ["pattern.json"] = 557,
    ["petstore-v1.0"] = 921,
    pgap_yaml_input_reader = 556,
    ["pixi.toml"] = 558,
    ["plagiarize-me.yaml"] = 562,
    ["plagiarize.yaml"] = 561,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1024,
    ["podbard.yaml"] = 564,
    ["portman.json"] = 565,
    ["prefect.toml"] = 573,
    ["prettierrc.json"] = 574,
    ["prisma.yml"] = 575,
    ["project-1.0.0-beta3.json"] = 584,
    ["project-1.0.0-beta4.json"] = 585,
    ["project-1.0.0-beta5.json"] = 586,
    ["project-1.0.0-beta6.json"] = 587,
    ["project-1.0.0-beta8.json"] = 588,
    ["project-1.0.0-rc1.json"] = 589,
    ["project-1.0.0-rc2.json"] = 590,
    ["project.json"] = 583,
    ["project.owasp.yaml"] = 591,
    ["prometheus.json"] = 592,
    ["prometheus.rules.json"] = 593,
    ["prometheus.rules.test.json"] = 594,
    ["proxies.json"] = 595,
    ["publiccode.yml"] = 596,
    ["pubspec.yaml"] = 597,
    ["pyrseas-0.8.json"] = 600,
    pytest = 609,
    ["quilt.mod.json"] = 942,
    ["rc3 auth"] = 613,
    ["rc3 collection"] = 614,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 822,
    ["release-please-config.json"] = 623,
    ["release-please-manifest.json"] = 624,
    ["release-plz.toml"] = 625,
    ["renv.lock"] = 634,
    ["rivet.yaml"] = 964,
    rockcraft = 636,
    runny = 637,
    ...
    samt = 640,
    samtrc = 641,
    ["sarif-1.0.0.json"] = 643,
    ["sarif-2.0.0.json"] = 644,
    ["sarif-2.1.0"] = 654,
    ["sarif-2.1.0-rtm.2"] = 645,
    ["sarif-2.1.0-rtm.3"] = 647,
    ["sarif-2.1.0-rtm.4"] = 649,
    ["sarif-2.1.0-rtm.5"] = 651,
    ["sarif-2.1.0-rtm.6"] = 652,
    ["sarif-external-property-file-2.1.0"] = 655,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 646,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 648,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 650,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 653,
    ["scalingo.json configuration"] = 656,
    ["schema.org - Action"] = 658,
    ["schema.org - ContactPoint"] = 659,
    ["schema.org - Place"] = 660,
    ["schema.org - Thing"] = 661,
    ["secrethub.yml"] = 944,
    ["semantic-release"] = 667,
    ["servicehub.config.json"] = 800,
    ["servicehub.service.json"] = 799,
    ["settings.job"] = 670,
    ["sfdx-hardis configuration"] = 672,
    ["shard.yml"] = 980,
    ["size-limit configuration"] = 677,
    ["skaffold.yaml"] = 867,
    ["skyuxconfig.json"] = 679,
    snapcraft = 680,
    ["snowflake-config"] = 681,
    ["snowflake-connections"] = 682,
    ["spicepod.yaml"] = 999,
    ["sqlc configuration"] = 695,
    ["stripe-app-local.json"] = 704,
    ["stripe-app.json"] = 703,
    swcrc = 852,
    ["task.json"] = 713,
    taskcat = 817,
    ["template.json"] = 718,
    ["templatsources.json"] = 719,
    ["theme.json"] = 722,
    ["tizen_workspace.json"] = 723,
    tldr = 724,
    tmuxinator = 803,
    ["transcend.yml"] = 734,
    ...
    ["vega-lite.json"] = 765,
    ["vega.json"] = 764,
    ["venvironment-basic.yaml"] = 768,
    ["venvironment.yaml"] = 767,
    version = 1042,
    ["version.json"] = 770,
    ["vhwdebugger-binding.yaml"] = 772,
    ["vim-addon-info"] = 773,
    ["vs-2017.3.host.json"] = 775,
    ["vs-nesting.json"] = 776,
    ["vsls.json"] = 774,
    ["vss-extension.json"] = 780,
    vtcfg = 1048,
    ["vtesttree.yaml"] = 781,
    ["vtestunit.yaml"] = 782,
    ["warp-keysets.json"] = 950,
    ["warp-themes.json"] = 951,
    ["warp-workflows.json"] = 952,
    ["webhint.io"] = 907,
    ["webjobpublishsettings.json"] = 787,
    ["webjobs-list.json"] = 786,
    ["well-known-fursona"] = 987,
    ["xs-app.json"] = 812,
    ["xunit.runner.json"] = 798,
    yamllint = 840,
    ["zerops.io import file"] = 996,
    ["zerops.yml"] = 995,
    zuul = 823,
    ["Žinoma"] = 833
  },
