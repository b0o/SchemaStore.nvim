...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 930,
    [".nodehawkrc"] = 574,
    [".npmpackagejsonlintrc"] = 578,
    [".omletrc"] = 1109,
    [".phrase.yml"] = 651,
    [".phraseapp.yml"] = 652,
    [".pmbot.yml"] = 637,
    [".postcssrc"] = 646,
    [".powerpages-web-template-manifest"] = 648,
    [".pre-commit-config.yml"] = 649,
    [".pre-commit-hooks.yml"] = 650,
    [".putout.json"] = 685,
    [".rehyperc"] = 710,
    [".remarkrc"] = 714,
    [".sprite files"] = 805,
    ...
    AIConfig = 33,
    ["AMX Muse Program Descriptor"] = 1157,
    ["API Builder"] = 965,
    ["AVA Configuration"] = 1028,
    ["AWS AppConfig Feature Flags-v1"] = 67,
    ["AWS CDK cdk.json"] = 255,
    ["AWS CloudFormation"] = 256,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 257,
    ["AWS Copilot Manifest"] = 1196,
    ["AWS SAM CLI Samconfig"] = 258,
    ["Adobe UXP Manifest"] = 1091,
    ["Aerleon Network & Service Definitions"] = 19,
    ["Aerleon Policy"] = 20,
    Aider = 1186,
    Air = 22,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1207,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1206,
    ["Airlock Microgateway"] = 34,
    ["Alacritty Configuration"] = 1000,
    ["All Contributors configuration file"] = 1054,
    ["Ansible Argument Specs"] = 394,
    ["Ansible Collection Galaxy"] = 401,
    ["Ansible Execution Environment"] = 391,
    ["Ansible Inventory"] = 400,
    ["Ansible Meta"] = 392,
    ["Ansible Meta Runtime"] = 393,
    ["Ansible Navigator Configuration"] = 403,
    ["Ansible Playbook"] = 398,
    ["Ansible Requirements"] = 395,
    ["Ansible Rulebook"] = 399,
    ["Ansible Tasks File"] = 397,
    ["Ansible Vars File"] = 396,
    ["Ansible-lint Configuration"] = 402,
    Any = 1119,
    ...
    ["Application list for a WinUtil"] = 1136,
    ArchitectFX = 1141,
    ["Argo CD"] = 53,
    ["Argo Events"] = 54,
    ["Argo Workflows"] = 55,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1205,
    ["Azure IoT Operations connector metadata"] = 1202,
    ...
    ["Azure Pipelines"] = 109,
    ["Azure Static Web Apps CLI configuration file"] = 809,
    ["Azure Static Web Apps configuration file"] = 808,
    BMML = 1224,
    ["BOSH CPI Config"] = 134,
    ["BOSH Deploy Config"] = 135,
    ["BX CI"] = 154,
    ["Bacon config"] = 4,
    ["Bashly (bashly.yml)"] = 1058,
    ["Bashly Settings (bashly-settings.yml)"] = 1059,
    Bento = 1223,
    ["Better Code Hub"] = 970,
    ["Better Scripts"] = 155,
    Bigconfig = 127,
    ["Biome Formatter Config"] = 81,
    ["Bitmovin Encoding Template"] = 1150,
    BizTalkServerApplicationSchema = 937,
    Bleep = 156,
    ["Block Protocol Metadata"] = 153,
    ["Bluebricks blueprint config"] = 1229,
    ["Boyka Framework"] = 136,
    Briefcase = 943,
    ["Build Info"] = 144,
    Buildkite = 146,
    ...
    ["Butane Config"] = 1013,
    C4InterFlow = 1165,
    ["CDK Environment Manager, concrete environment configuration"] = 1189,
    ["CDK Environment Manager, concrete environments definition"] = 1188,
    ["CDK Environment Manager, environment definition"] = 1187,
    ["CGS Card Game Specification (cgs.json)"] = 1096,
    ["CICS TS region tagging"] = 1022,
    ["CICS TS resource import"] = 1023,
    ["CICS TS resource model"] = 1024,
    ["CICS TS resource overrides"] = 1025,
    ["CMake Presets"] = 157,
    ["CNC Codes"] = 179,
    ["CRS WAF test file"] = 1126,
    ["CRS WAF test platform overrides file"] = 1127,
    ["CSS Comb (.csscomb.json)"] = 283,
    ["CSS Lint (.csslintrc)"] = 284,
    ["CSpell (cspell.json)"] = 282,
    ...
    ["Chamaleon environment"] = 1154,
    ["Chamaleon properties"] = 1155,
    ["Chamaleon template"] = 1153,
    Changepacks = 1216,
    Changesets = 267,
    Changie = 166,
    Charmcraft = 167,
    ...
    CodeCV = 93,
    CodeRabbit = 92,
    ["CodeShip Pro services configuration files"] = 237,
    ["CodeShip Pro steps configuration files"] = 238,
    ["Codecov configuration files"] = 236,
    Codex = 232,
    CodifyCLI = 94,
    Codux = 234,
    ["Cog config file"] = 180,
    ...
    ["Common Catalog Data"] = 246,
    ["Common Package Specification"] = 183,
    Concord = 1125,
    ["Configu .cfgu files"] = 1113,
    ["Configu .configu file"] = 1114,
    Conjure = 178,
    ["Container Structure Test"] = 951,
    Containerlab = 979,
    ["Contextive Glossary"] = 1181,
    Convex = 177,
    ["Crowdsec collection config"] = 277,
    ["Crowdsec parser config"] = 278,
    ["Crowdsec scenario config"] = 279,
    ["CumulusCI Config"] = 184,
    ["Custom Machinery Machine"] = 1097,
    ["Custom Machinery Recipe"] = 1098,
    ["Cycle Stack File"] = 189,
    CycloneDX = 190,
    ["DWP Exchange - catalogue entry"] = 328,
    ["DWP Exchange - gateway"] = 326,
    ["DWP Exchange - meta"] = 327,
    ["Dart Build Config (dart-build.json)"] = 285,
    ["Dart Test Config (dart-test.json)"] = 286,
    ["DashLord Configuration"] = 287,
    ["Data Contract Specification"] = 288,
    ["Data Product Specification"] = 289,
    ["DataYoga Connections"] = 191,
    ["DataYoga Job"] = 192,
    ["Databricks Asset Bundles"] = 1075,
    ["Datadog Continuous Testing"] = 492,
    ["Datadog Service Definition"] = 493,
    ["Datadog Software Catalog"] = 494,
    ["Datahub Ingestion Recipe"] = 1029,
    ["Debian Upstream Metadata file"] = 198,
    ["Deck config"] = 199,
    ["Dein Config"] = 200,
    ["Deno Config (deno.json)"] = 295,
    ["Dependency cruiser"] = 201,
    ["DeployStack Configuration"] = 202,
    ["Deployah Configuration"] = 1204,
    ["Deployer Recipe"] = 298,
    ["Deta Spacefile"] = 203,
    ["Detekt Config (detekt.yml)"] = 299,
    ["Devbox Config"] = 204,
    ["Devbox Plugin"] = 205,
    Devfile = 325,
    Devup = 1217,
    DipDup = 1128,
    ["Discord Webhook"] = 300,
    ["DocFx Config (docfx.json)"] = 305,
    ["Docker Desktop extension metadata"] = 302,
    ["Docs MCP Manifest"] = 306,
    Dofigen = 307,
    ["Dolittle Artifacts"] = 308,
    ["Dolittle Bounded Context Configuration"] = 309,
    ["Dolittle Event Horizons Configuration"] = 310,
    ["Dolittle Resources Configuration"] = 311,
    ["Dolittle Server Configuration"] = 312,
    ["Dolittle Tenant Map Configuration"] = 314,
    ["Dolittle Tenants Configuration"] = 313,
    ["Dolittle Topology"] = 315,
    ["DonateCaseBetterCasino menu"] = 1158,
    ["Drupal Breakpoints"] = 206,
    ["Drupal Config"] = 218,
    ["Drupal Info"] = 207,
    ["Drupal Layouts"] = 208,
    ["Drupal Libraries"] = 209,
    ["Drupal Links Action"] = 210,
    ["Drupal Links Contextual"] = 211,
    ["Drupal Links Menu"] = 212,
    ["Drupal Links Task"] = 213,
    ["Drupal Migration"] = 214,
    ["Drupal Permissions"] = 215,
    ["Drupal Recipe"] = 216,
    ["Drupal Routing"] = 217,
    ["Drupal Services"] = 219,
    ["Drush site aliases"] = 321,
    ["Dynamic Bash Aliases (.aliases)"] = 1066,
    ["EAS config"] = 346,
    ["ECA - Editor Code Assistant"] = 330,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1055,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1201,
    ["EasyVCR .NET"] = 347,
    ["Eidolon Resource"] = 1142,
    ["Elgato Stream Deck"] = 332,
    Elm = 1130,
    ["Embrace Config"] = 1041,
    Endurica = 1079,
    ["Enterprise Contract Policy Spec"] = 333,
    ["Erda Pipeline"] = 1104,
    ["Erda Runtime"] = 1105,
    ["Espanso config.yml"] = 1227,
    ["Espanso match.yml"] = 1226,
    Esquio = 335,
    ["Estuary Flow Catalog"] = 1019,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 339,
    ["EveryVoice TTS Toolkit Data Configuration"] = 340,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 344,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 343,
    ["EveryVoice TTS Toolkit Text Configuration"] = 341,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 342,
    ["Evolving Resolutive Process notation"] = 1203,
    ["Expo SDK"] = 345,
    ["F-Droid Data metadata"] = 351,
    ["FasterCI Configuration"] = 110,
    FiQuS = 355,
    Firebase = 353,
    ["Flatpak Builder Manifest"] = 356,
    ["FlexGet Config"] = 357,
    ["Flow.json Configurations"] = 1101,
    ["Fossa configuration file"] = 364,
    ["Fossa's fossa-deps file"] = 365,
    ["Foundry VTT - Base package Manifest"] = 359,
    ["Foundry VTT - Module Manifest"] = 360,
    ["Foundry VTT - System Data Template"] = 363,
    ["Foundry VTT - System Manifest"] = 361,
    ["Foundry VTT - World Manifest"] = 362,
    ["Foxx Manifest"] = 111,
    ["Freifunk.de Community API"] = 114,
    ["Frogbot Config"] = 115,
    ["G2P Mapping Configuration"] = 371,
    ["GCP Blueprint Metadata"] = 374,
    Gaspar = 372,
    ["GatewayCore API Gateway"] = 373,
    ["Gemini CLI settings"] = 375,
    ["GeoJSON.json latest"] = 1017,
    GherKing = 1021,
    ["GitHub Action"] = 380,
    ["GitHub Actions typing"] = 1138,
    ["GitHub Discussion"] = 381,
    ["GitHub Funding"] = 382,
    ["GitHub Issue Template configuration"] = 383,
    ["GitHub Issue Template forms"] = 384,
    ["GitHub Workflow"] = 385,
    ["GitHub Workflow Template Properties"] = 386,
    ["GitHub automatically generated release notes configuration"] = 387,
    ["GitLab Agent for Kubernetes configuration"] = 1093,
    GitVersion = 377,
    ["Gitea Issue Template configuration"] = 378,
    ["Gitea Issue Template forms"] = 379,
    ["Gitpod Automations"] = 389,
    ["Gitpod Configuration"] = 390,
    ["GlazeWM settings"] = 1095,
    ["Global Privacy Control"] = 376,
    Goblet = 1074,
    ["Golangci-lint Configuration"] = 405,
    ["Golangci-lint Custom Plugins Configuration"] = 406,
    ["Google Chrome Related Website Sets"] = 354,
    ["Google Cloud Workflows"] = 254,
    ["Google Digital Assetlinks"] = 1182,
    Goreleaser = 408,
    ["Goreleaser Pro"] = 409,
    Goss = 410,
    ["Gradle Build Cache Node"] = 968,
    ["Gradle Enterprise"] = 967,
    ["Grafana 5.x Dashboard"] = 411,
    ["GraphQL Code Generator"] = 416,
    ["GraphQL Config"] = 415,
    ["GraphQL Mesh"] = 414,
    ["GroovyLint configuration"] = 417,
    ["Grunt JSHint task"] = 421,
    ["Grunt Watch task"] = 422,
    ["Grunt base task"] = 423,
    ["Grunt clean task"] = 419,
    ["Grunt copy task"] = 418,
    ["Grunt cssmin task"] = 420,
    HEMTT = 933,
    Hadolint = 947,
    Hammerkit = 978,
    ["Hardware Sentry Configuration"] = 1033,
    ["Hashgraph Online Skill Manifest"] = 1,
    ["HashiCorp Vault"] = 424,
    Hatch = 948,
    Hayson = 426,
    ["Haystack Pipeline"] = 427,
    ["Hazelcast 5 Configuration"] = 428,
    ["Hecate Input Schema"] = 1193,
    ["Helm Chart.lock"] = 221,
    ["Helm Chart.yaml"] = 220,
    ["Helm Unittest Test Suite"] = 222,
    ["Home Assistant Integration Manifest"] = 429,
    ["Homer dashboard configuration"] = 430,
    Hugo = 1009,
    ["Hugo Theme"] = 1008,
    ["Hulak Configuration"] = 437,
    ["Hyperfoil benchmark configuration"] = 436,
    ["IBM Zapp document"] = 438,
    ["IBM zCodeFormatSettings"] = 439,
    ["IMG Catapult PSP"] = 444,
    ["IVMS101 by CODE Protocol"] = 1094,
    Infrahub = 446,
    Istanbul = 1037,
    ["JDownloader2 crawler multi-rules"] = 459,
    ["JDownloader2 crawler single-rules"] = 458,
    ["JFrog Applications Config"] = 460,
    ["JFrog File Spec"] = 461,
    ["JFrog Pipelines YML DSL"] = 1043,
    ["JMeter DSL cli config"] = 462,
    JReleaser = 465,
    ["JSON Document Transform"] = 473,
    ["JSON Feed"] = 474,
    ["JSON Resume"] = 720,
    ["JSON Schema Draft 2020-12"] = 915,
    ["JSON Schema Draft 4"] = 912,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1076,
    ["JSON Schema Draft 7"] = 913,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1077,
    ["JSON Schema Draft 8 (2019-09)"] = 914,
    ["JSON-API"] = 472,
    ["JSON-e templates"] = 975,
    ["JSON-stat 2.0"] = 908,
    JSONPatch = 476,
    ["JSR Package Config (jsr.json)"] = 466,
    Jarl = 1209,
    Jasmine = 453,
    Jekyll = 454,
    ["Jenkins X Pipelines"] = 455,
    ["Jenkins X Requirements"] = 456,
    Jest = 457,
    Jocker = 463,
    ["Jovo Language Models"] = 464,
    ["Jujutsu (jj) VCS config"] = 1195,
    ["KIMMDY config file"] = 487,
    ["KODE/CI build.yaml"] = 1039,
    ["KSP-AVC"] = 909,
    ["KSP-CKAN"] = 910,
    ["KSP-NetKAN"] = 911,
    KSY = 1106,
    KSail = 369,
    ["KYA Manifest"] = 1107,
    ["Karakum configuration file"] = 366,
    Kas = 479,
    ["Kestra flow file"] = 488,
    ["Keycloak REST API"] = 1046,
    ["Knative Functions - func.yaml"] = 367,
    Knip = 368,
    ["Kometa (nightly) config file"] = 490,
    ["Kometa config file"] = 489,
    ["Kong DBLess config"] = 1040,
    KrakenD = 491,
    ["Kubri Configuration"] = 498,
    LOOBin = 513,
    ["Lake configuration file"] = 1198,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 259,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 260,
    ["Landing Zone Accelerator on AWS - Global Config"] = 261,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 262,
    ["Landing Zone Accelerator on AWS - Network Config"] = 263,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 264,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 265,
    ["Landing Zone Accelerator on AWS - Security Config"] = 266,
    ["Lando (landofile)"] = 105,
    ["LangGraph Platform configuration"] = 1118,
    ["Language configuration"] = 1117,
    Lefthook = 502,
    ["Liferay client-extension.yaml"] = 509,
    ["LinkML Metamodel"] = 511,
    Liquibase = 984,
    ["Liquibase Flow File"] = 985,
    ["Lively Properties"] = 512,
    ["Lobe AI Agent"] = 107,
    Loki = 108,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 553,
    ["MS2Rescore Configuration"] = 557,
    ["Madness (madness.yml)"] = 1057,
    ["Mado configuration"] = 519,
    ["Mail Servers Configuration"] = 1230,
    ["MapEHR Mapping"] = 520,
    Markdownlint = 988,
    ["Mason Registry"] = 991,
    ["MegaLinter Custom Flavor"] = 523,
    ["MegaLinter configuration"] = 522,
    ["MegaLinter descriptor"] = 524,
    Melange = 1084,
    ["Meltano project definition"] = 525,
    ["Mergify Configuration"] = 558,
    ["Metadata for a Bazel module"] = 526,
    ["Metadata for a Cinnamon spice"] = 1134,
    ["Metatype Configuration"] = 527,
    ["MetricsHub Configuration"] = 528,
    ["MetricsHub Connector Configuration"] = 529,
    ["Micro Editor Syntax"] = 1067,
    ["Microsoft Band Web Tile"] = 530,
    ["Microsoft RulesEngine workflow rules"] = 1122,
    ["Microsoft RulesEngine workflow rules list"] = 1123,
    ["Minecraft Custom Main Menu Mod"] = 1085,
    ["Minecraft Data Pack Advancement"] = 532,
    ["Minecraft Data Pack Biome"] = 533,
    ["Minecraft Data Pack Configured Carver"] = 534,
    ["Minecraft Data Pack Damage Type"] = 535,
    ["Minecraft Data Pack Dimension"] = 537,
    ["Minecraft Data Pack Dimension Type"] = 536,
    ["Minecraft Data Pack Item Modifier"] = 538,
    ["Minecraft Data Pack Loot Table"] = 539,
    ["Minecraft Data Pack Metadata"] = 540,
    ["Minecraft Data Pack Predicate"] = 541,
    ["Minecraft Data Pack Recipe"] = 542,
    ["Minecraft Data Pack Tag"] = 543,
    ["Minecraft Data Pack Template Pool"] = 544,
    ["Minecraft Data Pack Trim Material"] = 549,
    ["Minecraft Data Pack Trim Pattern"] = 550,
    ["Minecraft Resource Pack Lang"] = 545,
    ["Minecraft Resource Pack Particle"] = 546,
    ["Minecraft Resource Pack Texture Mcmeta"] = 548,
    ["Minecraft Resourcepack Sounds"] = 547,
    ["Monade CLI Stack Configuration"] = 561,
    ["MongoDB Atlas Search Index Definition"] = 1038,
    ["Monika Configuration"] = 1036,
    ["Monoweave Configuration"] = 556,
    ["Motif config"] = 929,
    MultiQC = 1175,
    ["NOX Framework (Service)"] = 577,
    ["Netin Diagnostic System Template"] = 995,
    ["Netlify config"] = 564,
    ["Network-as-Code Data Model"] = 565,
    ["Next Gen UI Agent A2A Server Configuration"] = 566,
    ["Next Gen UI Agent Configuration"] = 568,
    ["Next Gen UI Agent MCP Server Configuration"] = 567,
    ["Nightwatch.js"] = 570,
    ["Node.js configuration"] = 934,
    ["NueJS configuration file"] = 582,
    ["Nuitka.yaml"] = 1099,
    ["Nullstone config"] = 584,
    ["ONe's changelog entry"] = 603,
    ["ONe's service descriptor"] = 602,
    ["ORT Server repository environment configuration"] = 613,
    ["OSCAL Assessment Plan (AP)"] = 615,
    ["OSCAL Assessment Results (AR)"] = 616,
    ["OSCAL Catalog"] = 617,
    ["OSCAL Component Definition (CDef)"] = 618,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 619,
    ["OSCAL Profile"] = 620,
    ["OSCAL System Security Plan (SSP)"] = 621,
    ["OSS Review Toolkit configuration"] = 622,
    ["OSS Review Toolkit curation"] = 623,
    ["OSS Review Toolkit package configuration"] = 624,
    ["OSS Review Toolkit repository configuration"] = 625,
    ["OSS Review Toolkit resolutions"] = 626,
    ["October CMS columns"] = 588,
    ["October CMS fields"] = 589,
    ["Oh My Posh"] = 591,
    Okteto = 592,
    ["Ona Automations"] = 594,
    Opctl = 932,
    ["Open Data Contract Standard (ODCS)"] = 607,
    ["Open Data Product Standard (ODPS)"] = 608,
    ["Open Know-How"] = 1180,
    ["OpenRewrite Resource"] = 605,
    OpenSRM = 609,
    OpenStatus = 1191,
    ["OpenTelemetry Declarative Configuration"] = 606,
    ["OpenUtau character yaml"] = 599,
    ["OpenUtau ustx"] = 600,
    ["OpenWeather Current Weather API"] = 974,
    ["OpenWeather Road Risk API"] = 973,
    ["Ory Hydra configuration"] = 435,
    ["Ory Keto configuration"] = 495,
    ["Ory Kratos configuration"] = 614,
    ["Ory Oathkeeper configuration"] = 586,
    ["Outblocks App configuration"] = 611,
    ["Outblocks database table"] = 612,
    ["Outblocks project configuration"] = 610,
    PDM = 633,
    POPxf = 643,
    ["POPxf Correlations"] = 644,
    Packer = 630,
    Pantsbuild = 1053,
    ["Paper paper-plugin.yml"] = 631,
    ["Pipeline component"] = 986,
    ["Platform.sh application"] = 6,
    ["Platform.sh routes"] = 7,
    ["Platform.sh services"] = 8,
    ["Plex Prerolls"] = 641,
    ["PocketMine plugin.yml"] = 638,
    ["Postman collection"] = 647,
    ["Power Pages Configuration"] = 1192,
    ["Preset list for a WinUtil"] = 1137,
    ["ProActions AI-Kit Configuration"] = 658,
    ["ProActions AI-Kit Configuration for Menus"] = 660,
    ["ProActions AI-Kit Configuration for Sections"] = 662,
    ["ProActions AI-Kit Configuration for Services"] = 659,
    ["ProActions AI-Kit Configuration for Steps"] = 663,
    ["ProActions AI-Kit Configuration for Templates"] = 661,
    ["Problem object RFC9457"] = 1082,
    ["Problem package format"] = 664,
    ["Problem package generators"] = 665,
    ["Problem package submissions"] = 666,
    ["Problem package test group metadata"] = 667,
    Pterodactyl = 1032,
    ["Pull Request Labeler"] = 684,
    Pulumi = 692,
    ["PyGTA Config"] = 688,
    PyProject = 693,
    Pylock = 1183,
    Pyright = 694,
    ["Python script metadata"] = 1177,
    ["QType AI DSL"] = 697,
    Qgoda = 696,
    Qodana = 1005,
    ["Qt Creator workspace file"] = 1115,
    ["Quali Torque Blueprint Spec 2"] = 1030,
    ["QueryFirst config file"] = 1049,
    ["RKE Cluster Configuration JSON"] = 983,
    ["RKE Cluster Configuration YAML"] = 982,
    RadioHound = 687,
    Railpack = 699,
    Railway = 698,
    ["Rancher Fleet"] = 689,
    ...
    Ray = 946,
    ["Read the Docs"] = 691,
    ["Red-DiscordBot Cog"] = 707,
    ["Red-DiscordBot Cog Repo"] = 708,
    ["Red-DiscordBot Trivia"] = 709,
    ["Releasaurus Config"] = 3,
    ["Render Blueprints"] = 981,
    RenderCV = 724,
    Renovate = 721,
    ["Renovate global configuration"] = 722,
    ["Renovate inherited configuration"] = 723,
    ["Replit config"] = 715,
    Restate = 1170,
    ["Revel Digital Gadget Definition File"] = 1194,
    RoadRunner = 726,
    ["Robust Station Image"] = 1200,
    Rockcraft = 727,
    ["Roo Coder Custom Modes"] = 728,
    Rubocop = 717,
    ["Rudder techniques"] = 1089,
    Ruff = 718,
    ["Rust Project"] = 719,
    ["Rust toolchain"] = 732,
    ["SDMX data message"] = 758,
    ["SDMX metadata message"] = 757,
    ["SDMX structure message"] = 756,
    ["SIL Kit Participant Configuration"] = 768,
    ["SIL Kit Registry Configuration"] = 769,
    ["SPDX 2.3"] = 806,
    SWADL = 822,
    ["Safebox Config"] = 1044,
    ["Sapphire CLI Config"] = 735,
    ["SauceCTL Configuration"] = 992,
    ["Schema Catalog"] = 750,
    ["Scoop manifest"] = 755,
    ["Semantic Data Fabric (SDF) file"] = 759,
    ["Semgrep Rule"] = 761,
    ["Serenity Code Generator (Sergen)"] = 762,
    ["Serverless Framework Configuration"] = 999,
    ["Serverless Workflow"] = 1001,
    ["Settings for a Cinnamon spice"] = 1133,
    ["Settings.paf"] = 764,
    ["Shopware 6 Configuration"] = 1002,
    ["Shopware CLI Extension Store Configuration"] = 1003,
    ["Shopware CLI Project Store Configuration"] = 1004,
    ["Sigma Detection Rule"] = 766,
    ["Sigrid scope configuration file"] = 767,
    ["SkyPilot Task JSON"] = 1090,
    ["Slack app manifest"] = 771,
    Snapcraft = 773,
    Solidarity = 776,
    ["Solution filters"] = 777,
    ["Source Maps v3"] = 778,
    Sourcery = 779,
    ["Spack bootstrap.yaml"] = 780,
    ["Spack cdash.yaml"] = 781,
    ["Spack ci.yaml"] = 782,
    ["Spack compilers.yaml"] = 783,
    ["Spack concretizer.yaml"] = 784,
    ["Spack config.yaml"] = 785,
    ["Spack definitions.yaml"] = 786,
    ["Spack develop.yaml"] = 787,
    ["Spack env_vars.yaml"] = 788,
    ["Spack environment"] = 794,
    ["Spack include.yaml"] = 789,
    ["Spack mirrors.yaml"] = 790,
    ["Spack modules.yaml"] = 791,
    ["Spack packages.yaml"] = 792,
    ["Spack repos.yaml"] = 793,
    ["Spack toolchains.yaml"] = 795,
    ["Spack upstreams.yaml"] = 796,
    ["Spack view.yaml"] = 797,
    ["Speakeasy Generation Config File"] = 801,
    ["Speakeasy Lint Configuration File"] = 798,
    ["Speakeasy Test Generation Configuration File"] = 799,
    ["Speakeasy Workflow File"] = 800,
    SpecIF = 802,
    ["Specmatic Configuration"] = 803,
    ["Sponge Mixin configuration"] = 804,
    StackBlitz = 810,
    ["StackHawk Scanner Configuration"] = 998,
    Stale = 811,
    Starfish = 812,
    ["Starlake Data Pipeline"] = 971,
    Starship = 813,
    ["Statamic Blueprint"] = 814,
    ["Stella configuration file"] = 815,
    ["Streamlit configuration file"] = 816,
    ["Stryker Mutator"] = 819,
    ["StyleCop Analyzers Configuration"] = 820,
    ["Stylelint (.stylelintrc)"] = 821,
    ["Stylua Config"] = 1184,
    ["Sublime Syntax"] = 1045,
    ["Subsquid squid manifest"] = 1092,
    ["Swagger API 2.0"] = 823,
    ["Synadia Connect Component"] = 824,
    TSON = 860,
    TSTyche = 861,
    ["TYPO3 Vendor Bundler config"] = 867,
    ["Tab data for a LinUtil"] = 1140,
    ["Tab list for a LinUtil"] = 1139,
    Tach = 825,
    ["Tach Domain"] = 826,
    Talhelper = 828,
    ["Talisman configuration"] = 829,
    Taplo = 1185,
    ["Taskfile config"] = 976,
    Taurus = 830,
    Tauticord = 831,
    ["Tekton Pipeline"] = 1213,
    ["Tekton PipelineRun"] = 1214,
    ["Tekton Task"] = 1211,
    ["Tekton TaskRun"] = 1212,
    Telefonistka = 1171,
    ["Terrateam config"] = 1197,
    ["TestEnvironment.json"] = 843,
    ["TextMate Grammar"] = 842,
    Threagile = 837,
    ["Tier.run pricing.json"] = 834,
    Tikibase = 835,
    Tombi = 840,
    ["Traefik v2"] = 846,
    ["Traefik v2 File Provider"] = 847,
    ["Traefik v3"] = 848,
    ["Traefik v3 File Provider"] = 849,
    ["Travis CI (.travis.yml)"] = 845,
    Treefmt = 413,
    Trident = 1167,
    ["TrueScript for *.tscript files"] = 852,
    ["Tugboat QA config.yml"] = 1164,
    TunnelHub = 1080,
    Turborepo = 844,
    Tycho = 1129,
    Tye = 1006,
    ["Tyk Gateway - Open Source v5.7+"] = 1176,
    ["UET BuildConfig.json"] = 1050,
    ["UI5 Manifest"] = 873,
    ["UNCORS configuration"] = 877,
    ["UTAM Page Object"] = 876,
    ["Ubuntu Server Autoinstall"] = 871,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1168,
    ["Uniswap Token List"] = 958,
    ["Universal Schedule Format"] = 878,
    ["Unreal Engine Uplugin"] = 1051,
    ["Unreal Engine Uproject"] = 1052,
    ["UpCloud CLI (upctl) configuration"] = 1169,
    ["Updatecli Compose"] = 1014,
    ["Updatecli Policy Manifest"] = 1015,
    ["Updatecli Policy Metadata"] = 1016,
    Uplift = 1048,
    ["Upsun config"] = 5,
    ["User Journey Map"] = 980,
    V2Ray = 1020,
    ["VSCode Code Snippets"] = 242,
    ["VSIX CLI publishing"] = 896,
    Vector = 880,
    ["Vela Pipeline Configuration"] = 883,
    Vercel = 241,
    ["Version Bumper config"] = 886,
    Vespertide = 1218,
    ["Vespertide Migration"] = 1219,
    ["Vespertide Model"] = 1220,
    ["Viash Component Config"] = 1173,
    ["Viash Package Config"] = 1174,
    Visivo = 1078,
    ["WP-CLI"] = 906,
    Wake = 1166,
    ["Waku Config"] = 1143,
    ["Web App Manifest"] = 902,
    ["Web types"] = 905,
    WebExtensions = 901,
    ["Webman package recipe"] = 1026,
    ["Windows Package Manager Installer Manifest"] = 954,
    ["Windows Package Manager Locale Manifest"] = 955,
    ["Windows Package Manager Singleton Manifest"] = 953,
    Winutil = 956,
    ["WireMock CLI import configuration"] = 1149,
    ["WireMock CLI local service configuration"] = 1148,
    ["WireMock message stub mapping"] = 1147,
    ["WireMock stub mapping"] = 1146,
    ["Woodpecker pipeline config"] = 994,
    ["Wrangler CLI"] = 907,
    ["Xstate Machine"] = 1012,
    ["Yandex Workflow Language"] = 1135,
    ["Yarn Config (.yarnrc.yml)"] = 969,
    ["Yippee-Ki-JSON configuration YML"] = 960,
    ["YouTrack App"] = 1132,
    ["Zarf Package Configuration"] = 1199,
    ["Zerops.io config"] = 1120,
    ["Zerops.io import"] = 1121,
    ["Zola Configuration"] = 1210,
    ["aerleon.yml"] = 18,
    ["amplify.yml"] = 11,
    ["angular.json"] = 35,
    apko = 1083,
    ...
    ["behat.yml"] = 137,
    ["bigquery-table"] = 126,
    ["bioimageio resource description"] = 1100,
    ...
    ["ccmod.json"] = 1144,
    changelogging = 1112,
    ["chisel-slices.json"] = 268,
    ["chrome-extension-locales-messages.json"] = 249,
    ["chutzpah.json"] = 250,
    cibuildwheel = 172,
    ["clang-format (.clang-format)"] = 1018,
    ["clang-tidy"] = 228,
    clangd = 227,
    clib = 229,
    ["cloud-init: cloud-config userdata"] = 231,
    ["cloud-sdk-pipeline-configuration"] = 252,
    ["cloudbuild.json"] = 253,
    cloudify = 230,
    ["cmdx.yaml"] = 91,
    codemagic = 233,
    ["coffeelint.json"] = 270,
    ["commands.json"] = 245,
    ["commitlint (.commitlintrc)"] = 957,
    ["committed.toml"] = 271,
    ["compile_commands.json"] = 244,
    ["compilerconfig.json"] = 243,
    ["completely.yml"] = 1056,
    ["component-detection-manifest.json"] = 274,
    ["component.json"] = 273,
    ["composer.json"] = 272,
    ["conda-forge"] = 176,
    ["config.yaml"] = 690,
    ["contentmanifest.json"] = 251,
    ["contribute.json"] = 275,
    ["cosmos.config.json"] = 247,
    ["crowdin.yml"] = 276,
    ["ctfd-setup configuration file"] = 1156,
    ["custom-elements.json"] = 1070,
    ["cypress.json"] = 280,
    ["datalogic-scan2deploy-android"] = 290,
    ["datalogic-scan2deploy-ce"] = 291,
    ["dbt Dependencies"] = 193,
    ["dbt Packages"] = 195,
    ["dbt Project"] = 194,
    ["dbt Selectors"] = 196,
    ["dbt YAML files"] = 197,
    ["ddev-global"] = 292,
    ["ddev-project"] = 293,
    ["debugsettings.json"] = 294,
    ["dependabot-v2.json"] = 297,
    ["dependabot.json"] = 296,
    ["deployed-cli"] = 1011,
    ["devcontainer.json"] = 235,
    devinit = 962,
    ["devspace.yaml"] = 1034,
    djlint = 963,
    ["docker bake"] = 303,
    ["docker sequencer"] = 304,
    ["docker-compose.yml"] = 961,
    ["dockerd.json"] = 301,
    ["dotnet Release Index manifest"] = 316,
    ["dotnet-tools.json"] = 317,
    ["dotnetcli.host.json"] = 318,
    ["dprint.json"] = 319,
    ["drone.json"] = 320,
    ["dss-2.0.0.json"] = 322,
    ["dstack configuration"] = 323,
    ["dtool dataset metadata"] = 1151,
    ["dvc.yaml"] = 324,
    ["ecosystem.json"] = 329,
    eksctl = 331,
    ["electron-builder configuration file"] = 337,
    ["epr-manifest.json"] = 336,
    ["evcc.yaml"] = 338,
    ["ezd task runner"] = 348,
    ["fabric.mod.json"] = 350,
    ["first-timers-bot"] = 358,
    ["flagd flag configuration"] = 112,
    ["fly.io Configuration"] = 113,
    fulibWorkflows = 993,
    ["function.json"] = 370,
    ["gRPC API Gateway & OpenAPI Config"] = 13,
    ["gematik health care insurance list"] = 1162,
    ["gematik health care patient list"] = 1159,
    ["gematik health care provider institution list"] = 1161,
    ["gematik health care provider list"] = 1160,
    ["gematik tiger test environment configuration"] = 1163,
    ["git-town.toml"] = 1208,
    ["gitlab-ci"] = 388,
    ["global.json"] = 404,
    ["go-feature-flag Flag Configuration"] = 407,
    ["haxelib.json"] = 425,
    helmfile = 949,
    helmwave = 950,
    ["host-meta.json"] = 432,
    ...
    ["ide.host.json"] = 440,
    ["ifstate.yaml"] = 441,
    ["imageoptimizer.json"] = 442,
    ["importmap.json"] = 445,
    instant_python_config = 447,
    instant_python_custom_project = 448,
    ["ioBroker Configuration"] = 449,
    ["ioBroker JSON UI"] = 450,
    ["ioBroker Package manifest"] = 451,
    ["ixpect.conf.yaml"] = 452,
    ["ize.toml"] = 1047,
    ["jsconfig.json"] = 477,
    ["jscpd Configuration"] = 1031,
    jsdoc = 945,
    ["k3d.yaml"] = 478,
    ["k9s aliases.yaml"] = 480,
    ["k9s cluster-config.yaml"] = 482,
    ["k9s config.yaml"] = 481,
    ["k9s hotkeys.yaml"] = 483,
    ["k9s plugins.yaml"] = 484,
    ["k9s skin.yaml"] = 485,
    ["k9s views.yaml"] = 486,
    ["kontinuous-config.yaml"] = 497,
    ["kontinuous-values.yaml"] = 496,
    ["kustomization.yaml"] = 499,
    ["label-commenter-config.yml"] = 500,
    ["latexindent configuration"] = 106,
    ["launchsettings.json"] = 501,
    lazydocker = 1069,
    lazygit = 1068,
    ["lego.json"] = 503,
    ["lerna.json"] = 504,
    ["lgtm.yml"] = 505,
    ["liblab.config.json"] = 506,
    ["libman.json"] = 507,
    ["license-report-config.json"] = 508,
    ["linkinator.config.json"] = 510,
    ["lint-staged (.lintstagedrc)"] = 923,
    ["local.settings.json"] = 515,
    ["localazy.json"] = 516,
    ["lotus.yaml"] = 514,
    ["lsdlschema.json"] = 517,
    ["macro.json"] = 1035,
    ["markdown-link-check"] = 989,
    maturin = 990,
    mboats = 997,
    ["micro-settings.json"] = 1062,
    ["mimetypes.json"] = 531,
    ["mirrord config"] = 925,
    mise = 926,
    ["mkdocs.yml"] = 551,
    ...
    ["monospace.yml"] = 555,
    ["moon.yml"] = 1145,
    ["mprocs Configuration file"] = 1116,
    ["mrdocs.yml"] = 552,
    ["mta.yaml"] = 927,
    ["mtad.yaml"] = 928,
    ["mycode.json"] = 562,
    nFPM = 569,
    ["napari plugin manifest"] = 563,
    neoload = 940,
    ["nest-cli"] = 572,
    ["ninjs (News in JSON)"] = 571,
    ["nitro.json"] = 939,
    ["nixd configuration"] = 1088,
    ["nlu.json"] = 573,
    ["nodemon.json"] = 575,
    ["noodl config"] = 996,
    ["notebook.mod.json"] = 576,
    now = 935,
    ["npm-badges"] = 579,
    ["nswag.json"] = 583,
    ntangle = 585,
    ["nuclei-template.yaml"] = 580,
    ["nuget-project.json"] = 581,
    ["ocelot.json"] = 587,
    ogen = 590,
    ["omnisharp.json"] = 593,
    openHAB = 1221,
    ...
    oxlint = 1232,
    ["package.json"] = 627,
    ["package.manifest"] = 629,
    ["package.yaml"] = 628,
    ["partial-black.json"] = 138,
    ["pathfinder.yml"] = 632,
    ["pattern.json"] = 635,
    ["petstore-v1.0"] = 1042,
    pgap_yaml_input_reader = 634,
    pgxgen = 1225,
    pitcms = 1228,
    ["pixi.toml"] = 636,
    ["plagiarize-me.yaml"] = 640,
    ["plagiarize.yaml"] = 639,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1152,
    ["podbard.yaml"] = 642,
    ["portman.json"] = 645,
    ["prefect.toml"] = 653,
    ["prefect.yaml"] = 654,
    ...
    ["prettierrc.json"] = 656,
    ["prisma.yml"] = 657,
    ["project-1.0.0-beta3.json"] = 669,
    ["project-1.0.0-beta4.json"] = 670,
    ["project-1.0.0-beta5.json"] = 671,
    ["project-1.0.0-beta6.json"] = 672,
    ["project-1.0.0-beta8.json"] = 673,
    ["project-1.0.0-rc1.json"] = 674,
    ["project-1.0.0-rc2.json"] = 675,
    ["project.json"] = 668,
    ["project.owasp.yaml"] = 676,
    ["prometheus-alertmanager.json"] = 680,
    ["prometheus.json"] = 677,
    ["prometheus.rules.json"] = 678,
    ["prometheus.rules.test.json"] = 679,
    ["proxies.json"] = 681,
    ["publiccode.yml"] = 682,
    ["pubspec.yaml"] = 683,
    ["pyrseas-0.8.json"] = 686,
    pytest = 695,
    ["quilt.mod.json"] = 1063,
    ["rc3 auth"] = 701,
    ["rc3 collection"] = 702,
    ...
    ["release drafter"] = 941,
    ["release-hub.json"] = 2,
    ["release-please-config.json"] = 711,
    ["release-please-manifest.json"] = 712,
    ["release-plz.toml"] = 713,
    ["renv.lock"] = 725,
    ["rivet.json"] = 1087,
    ["rivet.yaml (legacy)"] = 1086,
    rumdl = 730,
    runny = 729,
    rustfmt = 731,
    sake = 1179,
    samt = 733,
    samtrc = 734,
    ["sarif-1.0.0.json"] = 736,
    ["sarif-2.0.0.json"] = 737,
    ["sarif-2.1.0"] = 747,
    ["sarif-2.1.0-rtm.2"] = 738,
    ["sarif-2.1.0-rtm.3"] = 740,
    ["sarif-2.1.0-rtm.4"] = 742,
    ["sarif-2.1.0-rtm.5"] = 744,
    ["sarif-2.1.0-rtm.6"] = 745,
    ["sarif-external-property-file-2.1.0"] = 748,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 739,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 741,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 743,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 746,
    ["scalingo.json configuration"] = 749,
    ["schema.org - Action"] = 751,
    ["schema.org - ContactPoint"] = 752,
    ["schema.org - Place"] = 753,
    ["schema.org - Thing"] = 754,
    ["secrethub.yml"] = 1065,
    ["semantic-release"] = 760,
    ["servicehub.config.json"] = 918,
    ["servicehub.service.json"] = 917,
    ["settings.job"] = 763,
    ["sfdx-hardis configuration"] = 765,
    ["shard.yml"] = 1103,
    ["size-limit configuration"] = 770,
    ["skaffold.yaml"] = 987,
    ["skyuxconfig.json"] = 772,
    ["snowflake-config"] = 774,
    ["snowflake-connections"] = 775,
    ["spicepod.yaml"] = 1124,
    ["sqlc configuration"] = 807,
    ["stripe-app-local.json"] = 818,
    ["stripe-app.json"] = 817,
    swcrc = 972,
    ["task.json"] = 827,
    taskcat = 936,
    ["template.json"] = 832,
    ["templatsources.json"] = 833,
    ["text2confl config"] = 1233,
    ["theme.json"] = 836,
    ["tizen_workspace.json"] = 838,
    tldr = 839,
    ["tm_devices configuration file"] = 1190,
    tmuxinator = 921,
    tox = 841,
    ["transcend.yml"] = 850,
    ["tree-sitter grammar.json"] = 412,
    ["trime.yaml"] = 851,
    ["trunk.yaml"] = 853,
    ["ts-force-config.json"] = 858,
    ["tsconfig.json"] = 854,
    ["tsd.json"] = 855,
    ["tsdoc.json"] = 856,
    ["tsdrc.json"] = 857,
    ...
    v8r = 900,
    vcluster = 1110,
    ["vcpkg configuration file"] = 240,
    ["vcpkg manifest file"] = 239,
    ["vega-lite.json"] = 882,
    ["vega.json"] = 881,
    ["venvironment.yaml"] = 884,
    ["venvplus.yaml"] = 885,
    version = 1172,
    ["version.json"] = 887,
    ["vhwdebugger-binding.yaml"] = 889,
    ["vim-addon-info"] = 890,
    ["vs-2017.3.host.json"] = 892,
    ["vs-nesting.json"] = 893,
    ["vsls.json"] = 891,
    ["vss-extension.json"] = 897,
    vtcfg = 1178,
    ["vtesttree.yaml"] = 898,
    ["vtestunit.yaml"] = 899,
    ["warp-keysets.json"] = 1071,
    ["warp-themes.json"] = 1072,
    ["warp-workflows.json"] = 1073,
    ["webhint.io"] = 1027,
    ["webjobpublishsettings.json"] = 904,
    ["webjobs-list.json"] = 903,
    ["well-known-fursona"] = 1111,
    ["xs-app.json"] = 931,
    ["xunit.runner.json"] = 916,
    yamllint = 959,
    zizmor = 1215,
    zuul = 942,
    ["Žinoma"] = 952
