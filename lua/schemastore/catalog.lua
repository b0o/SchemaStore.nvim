...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 830,
    [".nodehawkrc"] = 516,
    [".npmpackagejsonlintrc"] = 520,
    [".omletrc"] = 1006,
    [".phrase.yml"] = 583,
    [".phraseapp.yml"] = 584,
    [".pmbot.yml"] = 571,
    [".postcssrc"] = 578,
    [".powerpages-web-template-manifest"] = 580,
    [".pre-commit-config.yml"] = 581,
    [".pre-commit-hooks.yml"] = 582,
    [".putout.json"] = 611,
    [".rehyperc"] = 635,
    [".remarkrc"] = 639,
    [".sprite files"] = 708,
    ...
    ["A micro editor config"] = 468,
    ABCInventoryModuleData = 18,
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1051,
    ["API Builder"] = 865,
    ["AVA Configuration"] = 927,
    ...
    ["AWS Copilot Manifest"] = 1088,
    ["AWS SAM CLI Samconfig"] = 220,
    ["Adobe UXP Manifest"] = 989,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1079,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 899,
    ["All Contributors configuration file"] = 952,
    ...
    ["Application list for a WinUtil"] = 1033,
    ArchitectFX = 1038,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure Pipelines"] = 79,
    ["Azure Static Web Apps CLI configuration file"] = 712,
    ["Azure Static Web Apps configuration file"] = 711,
    ["BOSH CPI Config"] = 103,
    ["BOSH Deploy Config"] = 104,
    ["BX CI"] = 123,
    ["Bashly (bashly.yml)"] = 956,
    ["Bashly Settings (bashly-settings.yml)"] = 957,
    ["Better Code Hub"] = 869,
    ["Better Scripts"] = 124,
    Bigconfig = 96,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1044,
    BizTalkServerApplicationSchema = 837,
    Bleep = 125,
    ...
    ["Butane Config"] = 912,
    C4InterFlow = 1059,
    ["CDK Environment Manager, concrete environment configuration"] = 1082,
    ["CDK Environment Manager, concrete environments definition"] = 1081,
    ["CDK Environment Manager, environment definition"] = 1080,
    ["CGS Card Game Specification (cgs.json)"] = 994,
    ["CICS TS region tagging"] = 921,
    ["CICS TS resource import"] = 922,
    ["CICS TS resource model"] = 923,
    ["CICS TS resource overrides"] = 924,
    ["CMake Presets"] = 126,
    ["CNC Codes"] = 145,
    ["CRS WAF test file"] = 1023,
    ["CRS WAF test platform overrides file"] = 1024,
    ...
    ["Chamaleon environment"] = 1048,
    ["Chamaleon properties"] = 1049,
    ["Chamaleon template"] = 1047,
    Changesets = 229,
    Charmcraft = 135,
    Cheatsheets = 909,
    ...
    ["Clawject config"] = 151,
    ["Cloud Foundry Application Manifest"] = 1005,
    ["Cloud Run Spec v1"] = 1028,
    ...
    Concord = 1022,
    ["Configu .cfgu files"] = 1010,
    ["Configu .configu file"] = 1011,
    Conjure = 144,
    ["Container Structure Test"] = 851,
    Containerlab = 878,
    ["Contextive Glossary"] = 1074,
    Convex = 143,
    ["Crowdsec collection config"] = 239,
    ["Crowdsec parser config"] = 240,
    ["Crowdsec scenario config"] = 241,
    ["CumulusCI Config"] = 150,
    ["Custom Machinery Machine"] = 995,
    ["Custom Machinery Recipe"] = 996,
    ...
    ["DataYoga Job"] = 157,
    ["Databricks Asset Bundles"] = 973,
    ["Datadog Service Definition"] = 441,
    ["Datadog Software Catalog"] = 442,
    ["Datahub Ingestion Recipe"] = 928,
    ["Dein Config"] = 163,
    ...
    ["DonateCaseBetterCasino menu"] = 1052,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 964,
    ["EAS config"] = 305,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 953,
    ["EasyVCR .NET"] = 306,
    ["Eidolon Resource"] = 1039,
    ...
    ["GeoJSON.json latest"] = 916,
    GherKing = 920,
    ["GitHub Action"] = 336,
    ["GitHub Actions typing"] = 1035,
    ...
    ["Google Digital Assetlinks"] = 1075,
    Goreleaser = 364,
    ["Goreleaser Pro"] = 365,
    Goss = 366,
    ["Gradle Build Cache Node"] = 867,
    ["Gradle Enterprise"] = 866,
    ...
    Hadolint = 847,
    Hammerkit = 877,
    ["Hardware Sentry Configuration"] = 932,
    Hatch = 848,
    Hayson = 379,
    ["Haystack Pipeline"] = 380,
    ["Hazelcast 5 Configuration"] = 381,
    ["Hecate Input Schema"] = 1086,
    ["Helm Chart.lock"] = 184,
    ["Helm Chart.yaml"] = 183,
    ["Helm Unittest Test Suite"] = 185,
    ["Home Assistant Integration Manifest"] = 382,
    ["Homer dashboard configuration"] = 383,
    Hugo = 908,
    ["Hugo Theme"] = 907,
    ["Hyperfoil benchmark configuration"] = 389,
    ["IBM Zapp document"] = 390,
    ["IBM zCodeFormatSettings"] = 391,
    ["IMG Catapult PSP"] = 396,
    ["IVMS101 by CODE Protocol"] = 992,
    Infrahub = 398,
    Istanbul = 935,
    ["JDownloader2 crawler multi-rules"] = 408,
    ["JDownloader2 crawler single-rules"] = 407,
    ["JFrog Applications Config"] = 409,
    ["JFrog File Spec"] = 410,
    ["JFrog Pipelines YML DSL"] = 941,
    ["JMeter DSL cli config"] = 411,
    JReleaser = 414,
    ["JSON Document Transform"] = 422,
    ["JSON Feed"] = 423,
    ["JSON Resume"] = 645,
    ["JSON Schema Draft 2020-12"] = 816,
    ["JSON Schema Draft 4"] = 813,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 974,
    ["JSON Schema Draft 7"] = 814,
    ["JSON Schema Draft 7 (unofficial strict)"] = 975,
    ["JSON Schema Draft 8 (2019-09)"] = 815,
    ["JSON-API"] = 421,
    ["JSON-e templates"] = 874,
    ["JSON-stat 2.0"] = 809,
    JSONPatch = 425,
    ["JSR Package Config (jsr.json)"] = 415,
    Jasmine = 402,
    Jekyll = 403,
    ["Jenkins X Pipelines"] = 404,
    ["Jenkins X Requirements"] = 405,
    Jest = 406,
    Jocker = 412,
    ["Jovo Language Models"] = 413,
    ["Jujutsu (jj) VCS config"] = 1087,
    ["KIMMDY config file"] = 436,
    ["KODE/CI build.yaml"] = 937,
    ["KSP-AVC"] = 810,
    ["KSP-CKAN"] = 811,
    ["KSP-NetKAN"] = 812,
    KSY = 1004,
    ...
    Kas = 428,
    ["Kestra flow file"] = 437,
    ["Keycloak REST API"] = 944,
    ["Knative Functions - func.yaml"] = 325,
    ["Kometa (nightly) config file"] = 439,
    ["Kometa config file"] = 438,
    ["Kong DBLess config"] = 938,
    KrakenD = 440,
    ["Kubri Configuration"] = 446,
    LOOBin = 461,
    ...
    ["Lando (landofile)"] = 75,
    ["LangGraph Platform configuration"] = 1015,
    ["Language configuration"] = 1014,
    Lefthook = 450,
    ["Liferay client-extension.yaml"] = 457,
    ["LinkML Metamodel"] = 459,
    Liquibase = 883,
    ["Liquibase Flow File"] = 884,
    ["Lively Properties"] = 460,
    ["Lobe AI Agent"] = 77,
    Loki = 78,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 499,
    ["MS2Rescore Configuration"] = 502,
    ["Madness (madness.yml)"] = 955,
    ["MapEHR Mapping"] = 467,
    Markdownlint = 887,
    ["Mason Registry"] = 890,
    ["MegaLinter configuration"] = 469,
    ["MegaLinter descriptor"] = 470,
    Melange = 982,
    ["Meltano project definition"] = 471,
    ["Mergify Configuration"] = 503,
    ["Metadata for a Bazel module"] = 472,
    ["Metadata for a Cinnamon spice"] = 1031,
    ["Metatype Configuration"] = 473,
    ["MetricsHub Configuration"] = 474,
    ["MetricsHub Connector Configuration"] = 475,
    ["Micro Editor Syntax"] = 965,
    ["Microsoft Band Web Tile"] = 476,
    ["Microsoft RulesEngine workflow rules"] = 1019,
    ["Microsoft RulesEngine workflow rules list"] = 1020,
    ["Minecraft Custom Main Menu Mod"] = 983,
    ["Minecraft Data Pack Advancement"] = 478,
    ["Minecraft Data Pack Biome"] = 479,
    ["Minecraft Data Pack Configured Carver"] = 480,
    ["Minecraft Data Pack Damage Type"] = 481,
    ["Minecraft Data Pack Dimension"] = 483,
    ["Minecraft Data Pack Dimension Type"] = 482,
    ["Minecraft Data Pack Item Modifier"] = 484,
    ["Minecraft Data Pack Loot Table"] = 485,
    ["Minecraft Data Pack Metadata"] = 486,
    ["Minecraft Data Pack Predicate"] = 487,
    ["Minecraft Data Pack Recipe"] = 488,
    ["Minecraft Data Pack Tag"] = 489,
    ["Minecraft Data Pack Template Pool"] = 490,
    ["Minecraft Data Pack Trim Material"] = 495,
    ["Minecraft Data Pack Trim Pattern"] = 496,
    ["Minecraft Resource Pack Lang"] = 491,
    ["Minecraft Resource Pack Particle"] = 492,
    ["Minecraft Resource Pack Texture Mcmeta"] = 494,
    ["Minecraft Resourcepack Sounds"] = 493,
    ["Monade CLI Stack Configuration"] = 506,
    ["MongoDB Atlas Search Index Definition"] = 936,
    ["Monika Configuration"] = 934,
    ["Monoweave Configuration"] = 501,
    ["Motif config"] = 829,
    MultiQC = 1068,
    ["NOX Framework (Service)"] = 519,
    ["Netin Diagnostic System Template"] = 894,
    ["Netlify config"] = 509,
    ["Network-as-Code Data Model"] = 510,
    ["Nightwatch.js"] = 512,
    ["Node.js configuration"] = 834,
    ["NueJS configuration file"] = 524,
    ["Nuitka.yaml"] = 997,
    ["Nullstone config"] = 526,
    ["ONe's changelog entry"] = 540,
    ["ONe's service descriptor"] = 539,
    ["ORT Server repository environment configuration"] = 548,
    ["OSCAL Assessment Plan (AP)"] = 550,
    ["OSCAL Assessment Results (AR)"] = 551,
    ["OSCAL Catalog"] = 552,
    ["OSCAL Component Definition (CDef)"] = 553,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 554,
    ["OSCAL Profile"] = 555,
    ["OSCAL System Security Plan (SSP)"] = 556,
    ["OSS Review Toolkit configuration"] = 557,
    ["OSS Review Toolkit curation"] = 558,
    ["OSS Review Toolkit package configuration"] = 559,
    ["OSS Review Toolkit repository configuration"] = 560,
    ["OSS Review Toolkit resolutions"] = 561,
    ["October CMS columns"] = 530,
    ["October CMS fields"] = 531,
    Okteto = 532,
    Opctl = 832,
    ["Open Data Contract Standard (ODCS)"] = 543,
    ["Open Data Product Standard (ODPS)"] = 544,
    ["Open Know-How"] = 1073,
    ["OpenRewrite Resource"] = 542,
    OpenStatus = 1084,
    ["OpenUtau character yaml"] = 536,
    ["OpenUtau ustx"] = 537,
    ["OpenWeather Current Weather API"] = 873,
    ["OpenWeather Road Risk API"] = 872,
    ["Ory Hydra configuration"] = 388,
    ["Ory Keto configuration"] = 443,
    ["Ory Kratos configuration"] = 549,
    ["Ory Oathkeeper configuration"] = 528,
    ["Outblocks App configuration"] = 546,
    ["Outblocks database table"] = 547,
    ["Outblocks project configuration"] = 545,
    PDM = 567,
    Packer = 564,
    Pantsbuild = 951,
    ["Paper paper-plugin.yml"] = 565,
    ["Pipeline component"] = 885,
    ["Platform.sh application"] = 2,
    ["Platform.sh routes"] = 3,
    ["Platform.sh services"] = 4,
    ["Plex Prerolls"] = 575,
    ["PocketMine plugin.yml"] = 572,
    ["Postman collection"] = 579,
    ["Power Pages Configuration"] = 1085,
    ["Preset list for a WinUtil"] = 1034,
    ["ProActions AI-Kit Configuration"] = 588,
    ["ProActions AI-Kit Configuration for Menus"] = 590,
    ["ProActions AI-Kit Configuration for Sections"] = 592,
    ["ProActions AI-Kit Configuration for Services"] = 589,
    ["ProActions AI-Kit Configuration for Steps"] = 593,
    ["ProActions AI-Kit Configuration for Templates"] = 591,
    ["Problem object RFC9457"] = 980,
    ["Problem package generators"] = 594,
    Pterodactyl = 931,
    ["Pull Request Labeler"] = 610,
    Pulumi = 618,
    ["PyGTA Config"] = 614,
    PyProject = 619,
    Pylock = 1076,
    Pyright = 620,
    ["Python script metadata"] = 1070,
    ["QType AI DSL"] = 623,
    Qgoda = 622,
    Qodana = 904,
    ["Qt Creator workspace file"] = 1012,
    ["Quali Torque Blueprint Spec 2"] = 929,
    ["QueryFirst config file"] = 947,
    ["RKE Cluster Configuration JSON"] = 882,
    ["RKE Cluster Configuration YAML"] = 881,
    RadioHound = 613,
    Railway = 624,
    ["Rancher Fleet"] = 615,
    ["Rattler-build"] = 625,
    Ray = 846,
    ["Read the Docs"] = 617,
    ["Red-DiscordBot Cog"] = 632,
    ["Red-DiscordBot Cog Repo"] = 633,
    ["Red-DiscordBot Trivia"] = 634,
    ["Render Blueprints"] = 880,
    RenderCV = 647,
    Renovate = 646,
    ["Replit config"] = 640,
    Restate = 1063,
    RoadRunner = 649,
    ["Roo Coder Custom Modes"] = 651,
    Rubocop = 642,
    ["Rudder techniques"] = 987,
    Ruff = 643,
    ["Rust Project"] = 644,
    ["Rust toolchain"] = 654,
    ["SDMX data message"] = 680,
    ["SDMX metadata message"] = 679,
    ["SDMX structure message"] = 678,
    ["SIL Kit Participant Configuration"] = 690,
    ["SIL Kit Registry Configuration"] = 691,
    ["SPDX 2.3"] = 709,
    SWADL = 723,
    ["Safebox Config"] = 942,
    ["Sapphire CLI Config"] = 657,
    ["SauceCTL Configuration"] = 891,
    ["Schema Catalog"] = 672,
    ["Scoop manifest"] = 677,
    ["Semantic Data Fabric (SDF) file"] = 681,
    ["Semgrep Rule"] = 683,
    ["Serenity Code Generator (Sergen)"] = 684,
    ["Serverless Framework Configuration"] = 898,
    ["Serverless Workflow"] = 900,
    ["Settings for a Cinnamon spice"] = 1030,
    ["Settings.paf"] = 686,
    ["Shopware 6 Configuration"] = 901,
    ["Shopware CLI Extension Store Configuration"] = 902,
    ["Shopware CLI Project Store Configuration"] = 903,
    ["Sigma Detection Rule"] = 688,
    ["Sigrid scope configuration file"] = 689,
    ["SkyPilot Task JSON"] = 988,
    ["Slack app manifest"] = 693,
    Solidarity = 698,
    ["Solution filters"] = 699,
    ["Source Maps v3"] = 700,
    Sourcery = 701,
    ["Speakeasy Generation Config File"] = 705,
    ["Speakeasy Lint Configuration File"] = 702,
    ["Speakeasy Test Generation Configuration File"] = 703,
    ["Speakeasy Workflow File"] = 704,
    SpecIF = 706,
    ["Sponge Mixin configuration"] = 707,
    StackBlitz = 713,
    ["StackHawk Scanner Configuration"] = 897,
    Stale = 714,
    ["Starlake Data Pipeline"] = 870,
    Starship = 715,
    ["Statamic Blueprint"] = 716,
    ["Stella configuration file"] = 717,
    ["Stryker Mutator"] = 720,
    ["StyleCop Analyzers Configuration"] = 721,
    ["Stylelint (.stylelintrc)"] = 722,
    ["Stylua Config"] = 1077,
    ["Sublime Syntax"] = 943,
    ["Subsquid squid manifest"] = 990,
    ["Swagger API 2.0"] = 724,
    ["Synadia Connect Component"] = 725,
    TSON = 759,
    TSTyche = 760,
    ["TYPO3 Vendor Bundler config"] = 765,
    ["Tab data for a LinUtil"] = 1037,
    ["Tab list for a LinUtil"] = 1036,
    Tach = 726,
    ["Tach Domain"] = 727,
    Talhelper = 729,
    ["Talisman configuration"] = 730,
    Taplo = 1078,
    ["Taskfile config"] = 875,
    Taurus = 731,
    Tauticord = 732,
    Telefonistka = 1064,
    ["TestEnvironment.json"] = 742,
    ["TextMate Grammar"] = 741,
    ["Tier.run pricing.json"] = 735,
    Tikibase = 736,
    Tombi = 740,
    ["Traefik v2"] = 745,
    ["Traefik v2 File Provider"] = 746,
    ["Traefik v3"] = 747,
    ["Traefik v3 File Provider"] = 748,
    ["Travis CI (.travis.yml)"] = 744,
    Trident = 1061,
    ["TrueScript for *.tscript files"] = 751,
    ["Tugboat QA config.yml"] = 1058,
    TunnelHub = 978,
    Turborepo = 743,
    Tycho = 1026,
    Tye = 905,
    ["Tyk Gateway - Open Source v5.7+"] = 1069,
    ["Typst Manifest"] = 766,
    ["UET BuildConfig.json"] = 948,
    ["UI5 Manifest"] = 772,
    ["UNCORS configuration"] = 776,
    ["UTAM Page Object"] = 775,
    ["Ubuntu Server Autoinstall"] = 770,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1062,
    ["Uniswap Token List"] = 858,
    ["Universal Schedule Format"] = 777,
    ["Unreal Engine Uplugin"] = 949,
    ["Unreal Engine Uproject"] = 950,
    ["Updatecli Compose"] = 913,
    ["Updatecli Policy Manifest"] = 914,
    ["Updatecli Policy Metadata"] = 915,
    Uplift = 946,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 879,
    V2Ray = 919,
    ["VSCode Code Snippets"] = 204,
    ["VSIX CLI publishing"] = 797,
    Vector = 779,
    ["Vela Pipeline Configuration"] = 782,
    Vercel = 203,
    ["Version Bumper config"] = 787,
    ["Viash Component Config"] = 1066,
    ["Viash Package Config"] = 1067,
    Visivo = 976,
    ["WP-CLI"] = 807,
    Wake = 1060,
    ["Waku Config"] = 1040,
    ["Web App Manifest"] = 803,
    ["Web types"] = 806,
    WebExtensions = 802,
    ["Webman package recipe"] = 925,
    ["Windows Package Manager Installer Manifest"] = 854,
    ["Windows Package Manager Locale Manifest"] = 855,
    ["Windows Package Manager Singleton Manifest"] = 853,
    Winutil = 856,
    ["WireMock stub mapping"] = 1043,
    ["Woodpecker pipeline config"] = 893,
    ["Wrangler CLI"] = 808,
    ["Xstate Machine"] = 911,
    ["Yandex Workflow Language"] = 1032,
    ["Yarn Config (.yarnrc.yml)"] = 868,
    ["Yippee-Ki-JSON configuration YML"] = 860,
    ["YouTrack App"] = 1029,
    ["Zerops.io config"] = 1017,
    ["Zerops.io import"] = 1018,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 981,
    ...
    ["behat.yml"] = 106,
    ["bigquery-table"] = 95,
    ["bioimageio resource description"] = 998,
    ...
    ["crowdin.yml"] = 238,
    ["ctfd-setup configuration file"] = 1050,
    ["custom-elements.json"] = 968,
    ["cypress.json"] = 242,
    ...
    ["gematik health care insurance list"] = 1056,
    ["gematik health care patient list"] = 1053,
    ["gematik health care provider institution list"] = 1055,
    ["gematik health care provider list"] = 1054,
    ["gematik tiger test environment configuration"] = 1057,
    ["gitlab-ci"] = 344,
    ["global.json"] = 360,
    ...
    ["ide.host.json"] = 392,
    ["ifstate.conf"] = 393,
    ["imageoptimizer.json"] = 394,
    ["importmap.json"] = 397,
    ["ioBroker Configuration"] = 399,
    ["ioBroker JSON UI"] = 400,
    ["ioBroker Package manifest"] = 401,
    ["ize.toml"] = 945,
    ["jsconfig.json"] = 426,
    ["jscpd Configuration"] = 930,
    jsdoc = 845,
    ["k3d.yaml"] = 427,
    ["k9s aliases.yaml"] = 429,
    ["k9s cluster-config.yaml"] = 431,
    ["k9s config.yaml"] = 430,
    ["k9s hotkeys.yaml"] = 432,
    ["k9s plugins.yaml"] = 433,
    ["k9s skin.yaml"] = 434,
    ["k9s views.yaml"] = 435,
    ["kontinuous-config.yaml"] = 445,
    ["kontinuous-values.yaml"] = 444,
    ["kustomization.yaml"] = 447,
    ["label-commenter-config.yml"] = 448,
    ["latexindent configuration"] = 76,
    ["launchsettings.json"] = 449,
    lazydocker = 967,
    lazygit = 966,
    ["lego.json"] = 451,
    ["lerna.json"] = 452,
    ["lgtm.yml"] = 453,
    ["liblab.config.json"] = 454,
    ["libman.json"] = 455,
    ["license-report-config.json"] = 456,
    ["linkinator.config.json"] = 458,
    ["lint-staged (.lintstagedrc)"] = 824,
    ["local.settings.json"] = 463,
    ["localazy.json"] = 464,
    ["lotus.yaml"] = 462,
    ["lsdlschema.json"] = 465,
    ["markdown-link-check"] = 888,
    maturin = 889,
    mboats = 896,
    ["micro-settings.json"] = 960,
    ["mimetypes.json"] = 477,
    ["mirrord config"] = 825,
    mise = 826,
    ["mkdocs.yml"] = 497,
    ["monospace.yml"] = 500,
    ["moon.yml"] = 1042,
    ["mprocs Configuration file"] = 1013,
    ["mrdocs.yml"] = 498,
    ["mta.yaml"] = 827,
    ["mtad.yaml"] = 828,
    ["mycode.json"] = 507,
    nFPM = 511,
    ["napari plugin manifest"] = 508,
    neoload = 840,
    ["nest-cli"] = 514,
    ["ninjs (News in JSON)"] = 513,
    ["nitro.json"] = 839,
    ["nixd configuration"] = 986,
    ["nlu.json"] = 515,
    ["nodemon.json"] = 517,
    ["noodl config"] = 895,
    ["notebook.mod.json"] = 518,
    now = 835,
    ["npm-badges"] = 521,
    ["nswag.json"] = 525,
    ntangle = 527,
    ["nuclei-template.yaml"] = 522,
    ["nuget-project.json"] = 523,
    ["ocelot.json"] = 529,
    ["omnisharp.json"] = 533,
    ["openapi.json"] = 534,
    ["openfin.json"] = 541,
    ...
    ["ops.yaml"] = 538,
    ["package.json"] = 562,
    ["package.manifest"] = 563,
    ["partial-black.json"] = 107,
    ["pathfinder.yml"] = 566,
    ["pattern.json"] = 569,
    ["petstore-v1.0"] = 940,
    pgap_yaml_input_reader = 568,
    ["pixi.toml"] = 570,
    ["plagiarize-me.yaml"] = 574,
    ["plagiarize.yaml"] = 573,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1046,
    ["podbard.yaml"] = 576,
    ["portman.json"] = 577,
    ["prefect.toml"] = 585,
    ["prettierrc.json"] = 586,
    ["prisma.yml"] = 587,
    ["project-1.0.0-beta3.json"] = 596,
    ["project-1.0.0-beta4.json"] = 597,
    ["project-1.0.0-beta5.json"] = 598,
    ["project-1.0.0-beta6.json"] = 599,
    ["project-1.0.0-beta8.json"] = 600,
    ["project-1.0.0-rc1.json"] = 601,
    ["project-1.0.0-rc2.json"] = 602,
    ["project.json"] = 595,
    ["project.owasp.yaml"] = 603,
    ["prometheus.json"] = 604,
    ["prometheus.rules.json"] = 605,
    ["prometheus.rules.test.json"] = 606,
    ["proxies.json"] = 607,
    ["publiccode.yml"] = 608,
    ["pubspec.yaml"] = 609,
    ["pyrseas-0.8.json"] = 612,
    pytest = 621,
    ["quilt.mod.json"] = 961,
    ["rc3 auth"] = 626,
    ["rc3 collection"] = 627,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 841,
    ["release-please-config.json"] = 636,
    ["release-please-manifest.json"] = 637,
    ["release-plz.toml"] = 638,
    ["renv.lock"] = 648,
    ["rivet.json"] = 985,
    ["rivet.yaml (legacy)"] = 984,
    rockcraft = 650,
    runny = 652,
    rustfmt = 653,
    sake = 1072,
    samt = 655,
    samtrc = 656,
    ["sarif-1.0.0.json"] = 658,
    ["sarif-2.0.0.json"] = 659,
    ["sarif-2.1.0"] = 669,
    ["sarif-2.1.0-rtm.2"] = 660,
    ["sarif-2.1.0-rtm.3"] = 662,
    ["sarif-2.1.0-rtm.4"] = 664,
    ["sarif-2.1.0-rtm.5"] = 666,
    ["sarif-2.1.0-rtm.6"] = 667,
    ["sarif-external-property-file-2.1.0"] = 670,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 661,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 663,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 665,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 668,
    ["scalingo.json configuration"] = 671,
    ["schema.org - Action"] = 673,
    ["schema.org - ContactPoint"] = 674,
    ["schema.org - Place"] = 675,
    ["schema.org - Thing"] = 676,
    ["secrethub.yml"] = 963,
    ["semantic-release"] = 682,
    ["servicehub.config.json"] = 819,
    ["servicehub.service.json"] = 818,
    ["settings.job"] = 685,
    ["sfdx-hardis configuration"] = 687,
    ["shard.yml"] = 1001,
    ["size-limit configuration"] = 692,
    ["skaffold.yaml"] = 886,
    ["skyuxconfig.json"] = 694,
    snapcraft = 695,
    ["snowflake-config"] = 696,
    ["snowflake-connections"] = 697,
    ["spicepod.yaml"] = 1021,
    ["sqlc configuration"] = 710,
    ["stripe-app-local.json"] = 719,
    ["stripe-app.json"] = 718,
    swcrc = 871,
    ["task.json"] = 728,
    taskcat = 836,
    ["template.json"] = 733,
    ["templatsources.json"] = 734,
    ["theme.json"] = 737,
    ["tizen_workspace.json"] = 738,
    tldr = 739,
    ["tm_devices configuration file"] = 1083,
    tmuxinator = 822,
    ["transcend.yml"] = 749,
    ["tree-sitter grammar.json"] = 368,
    ["trime.yaml"] = 750,
    ["trunk.yaml"] = 752,
    ["ts-force-config.json"] = 757,
    ["tsconfig.json"] = 753,
    ["tsd.json"] = 754,
    ["tsdoc.json"] = 755,
    ["tsdrc.json"] = 756,
    ...
    ["vega-lite.json"] = 781,
    ["vega.json"] = 780,
    ["venvironment-basic.yaml"] = 784,
    ["venvironment.yaml"] = 783,
    ["venvplus-basic.yaml"] = 786,
    ["venvplus.yaml"] = 785,
    version = 1065,
    ["version.json"] = 788,
    ["vhwdebugger-binding.yaml"] = 790,
    ["vim-addon-info"] = 791,
    ["vs-2017.3.host.json"] = 793,
    ["vs-nesting.json"] = 794,
    ["vsls.json"] = 792,
    ["vss-extension.json"] = 798,
    vtcfg = 1071,
    ["vtesttree.yaml"] = 799,
    ["vtestunit.yaml"] = 800,
    ["warp-keysets.json"] = 969,
    ["warp-themes.json"] = 970,
    ["warp-workflows.json"] = 971,
    ["webhint.io"] = 926,
    ["webjobpublishsettings.json"] = 805,
    ["webjobs-list.json"] = 804,
    ["well-known-fursona"] = 1008,
    ["xs-app.json"] = 831,
    ["xunit.runner.json"] = 817,
    yamllint = 859,
    zuul = 842,
    ["Žinoma"] = 852
  },
