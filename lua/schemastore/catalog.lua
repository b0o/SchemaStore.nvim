...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 15,
    AIConfig = 16,
    ["AMX Muse Program Descriptor"] = 1006,
    ["API Builder"] = 823,
    ["AVA Configuration"] = 885,
    ...
    ["Adobe UXP Manifest"] = 945,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    Air = 12,
    ["Airlock Microgateway"] = 17,
    ["Alacritty Configuration"] = 857,
    ["All Contributors configuration file"] = 910,
    ...
    ["Application list for a WinUtil"] = 988,
    ArchitectFX = 993,
    ["Argo Events"] = 31,
    ["Argo Workflows"] = 32,
    AssemblyScript = 35,
    ...
    ["Azure Pipelines"] = 68,
    ["Azure Static Web Apps CLI configuration file"] = 677,
    ["Azure Static Web Apps configuration file"] = 676,
    ["BOSH Deploy Config"] = 92,
    ["BX CI"] = 110,
    ["Bashly (bashly.yml)"] = 914,
    ["Bashly Settings (bashly-settings.yml)"] = 915,
    ["Better Code Hub"] = 827,
    ["Better Scripts"] = 111,
    Bigconfig = 85,
    ["Biome Formatter Config"] = 55,
    ["Bitmovin Encoding Template"] = 999,
    BizTalkServerApplicationSchema = 795,
    Bleep = 112,
    ...
    ["Butane Config"] = 870,
    C4InterFlow = 1014,
    ["CGS Card Game Specification (cgs.json)"] = 950,
    ["CICS TS region tagging"] = 879,
    ["CICS TS resource import"] = 880,
    ["CICS TS resource model"] = 881,
    ["CICS TS resource overrides"] = 882,
    ["CMake Presets"] = 113,
    ["CNC Codes"] = 129,
    ["CRS WAF test file"] = 978,
    ["CRS WAF test platform overrides file"] = 979,
    ...
    ["Chamaleon environment"] = 1003,
    ["Chamaleon properties"] = 1004,
    ["Chamaleon template"] = 1002,
    Changesets = 212,
    Charmcraft = 122,
    Cheatsheets = 867,
    ...
    CityJSON = 125,
    ["Clawject config"] = 135,
    ["Cloud Foundry Application Manifest"] = 961,
    ["Cloud Run Spec v1"] = 983,
    ...
    Concord = 977,
    ["Configu .cfgu files"] = 966,
    ["Configu .configu file"] = 967,
    Conjure = 128,
    ["Container Structure Test"] = 809,
    Containerlab = 836,
    ["Crowdsec collection config"] = 221,
    ["Crowdsec parser config"] = 222,
    ["Crowdsec scenario config"] = 223,
    ["CumulusCI Config"] = 134,
    ["Custom Machinery Machine"] = 951,
    ["Custom Machinery Recipe"] = 952,
    ...
    ["DonateCaseBetterCasino menu"] = 1007,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 922,
    ["EAS config"] = 287,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 911,
    ["EasyVCR .NET"] = 288,
    ["Eidolon Resource"] = 994,
    ...
    ["GeoJSON.json latest"] = 874,
    GherKing = 878,
    ["GitHub Action"] = 318,
    ["GitHub Actions typing"] = 990,
    ...
    ["Goreleaser Pro"] = 347,
    Goss = 348,
    ["Gradle Build Cache Node"] = 825,
    ["Gradle Enterprise"] = 824,
    ...
    Hadolint = 805,
    Hammerkit = 835,
    ["Hardware Sentry Configuration"] = 890,
    Hatch = 806,
    Hayson = 361,
    ...
    ["JFrog File Spec"] = 390,
    ["JFrog Pipelines YML DSL"] = 899,
    ["JMeter DSL cli config"] = 391,
    JReleaser = 393,
    ["JSON Document Transform"] = 401,
    ["JSON Feed"] = 402,
    ["JSON Resume"] = 611,
    ["JSON Schema Draft 2020-12"] = 775,
    ["JSON Schema Draft 4"] = 772,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 932,
    ["JSON Schema Draft 7"] = 773,
    ["JSON Schema Draft 7 (unofficial strict)"] = 933,
    ["JSON Schema Draft 8 (2019-09)"] = 774,
    ["JSON-API"] = 400,
    ["JSON-e templates"] = 832,
    ["JSON-stat 2.0"] = 768,
    JSONPatch = 404,
    ...
    ["Metadata for a Cinnamon spice"] = 986,
    ["Metatype Configuration"] = 452,
    ["MetricsHub Configuration"] = 453,
    ["MetricsHub Connector Configuration"] = 454,
    ["Micro Editor Syntax"] = 923,
    ["Microsoft Band Web Tile"] = 455,
    ["Microsoft RulesEngine workflow rules"] = 974,
    ["Microsoft RulesEngine workflow rules list"] = 975,
    ["Minecraft Custom Main Menu Mod"] = 940,
    ...
    ["MongoDB Atlas Search Index Definition"] = 894,
    ["Monika Configuration"] = 892,
    ["Monoweave Configuration"] = 480,
    ["Motif config"] = 788,
    MultiQC = 1022,
    ["NOX Framework (Service)"] = 497,
    ["Netin Diagnostic System Template"] = 852,
    ["Netlify config"] = 488,
    ...
    ["OpenUtau ustx"] = 515,
    ["OpenWeather Current Weather API"] = 831,
    ["OpenWeather Road Risk API"] = 830,
    ...
    ["Pipeline component"] = 843,
    ["Plex Prerolls"] = 551,
    ["PocketMine plugin.yml"] = 548,
    ["Postman collection"] = 555,
    ["Preset list for a WinUtil"] = 989,
    ["Problem object RFC9457"] = 937,
    ...
    PyProject = 589,
    Pyright = 590,
    ["Python script metadata"] = 1024,
    Qgoda = 592,
    Qodana = 862,
    ["Qt Creator workspace file"] = 968,
    ["Quali Torque Blueprint Spec 2"] = 887,
    ["QueryFirst config file"] = 905,
    ["RKE Cluster Configuration JSON"] = 840,
    ["RKE Cluster Configuration YAML"] = 839,
    RadioHound = 583,
    Railway = 593,
    ["Rancher Fleet"] = 585,
    ["Rattler-build"] = 594,
    Ray = 804,
    ["Read the Docs"] = 587,
    ["Red-DiscordBot Cog"] = 601,
    ["Red-DiscordBot Cog Repo"] = 602,
    ["Red-DiscordBot Trivia"] = 603,
    ["Render Blueprints"] = 838,
    RenderCV = 613,
    Renovate = 612,
    ["Replit config"] = 607,
    Restate = 1017,
    RoadRunner = 615,
    ["Rudder techniques"] = 943,
    Ruff = 609,
    ["Rust Project"] = 610,
    ["Rust toolchain"] = 619,
    ["SDMX data message"] = 645,
    ["SDMX metadata message"] = 644,
    ["SDMX structure message"] = 643,
    ["SIL Kit Participant Configuration"] = 655,
    ["SIL Kit Registry Configuration"] = 656,
    ["SPDX 2.3"] = 674,
    SWADL = 688,
    ["Safebox Config"] = 900,
    ["Sapphire CLI Config"] = 622,
    ["SauceCTL Configuration"] = 849,
    ["Schema Catalog"] = 637,
    ["Scoop manifest"] = 642,
    ["Semantic Data Fabric (SDF) file"] = 646,
    ["Semgrep Rule"] = 648,
    ["Serenity Code Generator (Sergen)"] = 649,
    ["Serverless Framework Configuration"] = 856,
    ["Serverless Workflow"] = 858,
    ["Settings for a Cinnamon spice"] = 985,
    ["Settings.paf"] = 651,
    ["Shopware 6 Configuration"] = 859,
    ["Shopware CLI Extension Store Configuration"] = 860,
    ["Shopware CLI Project Store Configuration"] = 861,
    ["Sigma Detection Rule"] = 653,
    ["Sigrid scope configuration file"] = 654,
    ["SkyPilot Task JSON"] = 944,
    ["Slack app manifest"] = 658,
    Solidarity = 663,
    ["Solution filters"] = 664,
    ["Source Maps v3"] = 665,
    Sourcery = 666,
    ["Speakeasy Generation Config File"] = 670,
    ["Speakeasy Lint Configuration File"] = 667,
    ["Speakeasy Test Generation Configuration File"] = 668,
    ["Speakeasy Workflow File"] = 669,
    SpecIF = 671,
    ["Sponge Mixin configuration"] = 672,
    StackBlitz = 678,
    ["StackHawk Scanner Configuration"] = 855,
    Stale = 679,
    ["Starlake Data Pipeline"] = 828,
    Starship = 680,
    ["Statamic Blueprint"] = 681,
    ["Stella configuration file"] = 682,
    ["Stryker Mutator"] = 685,
    ["StyleCop Analyzers Configuration"] = 686,
    ["Stylelint (.stylelintrc)"] = 687,
    ["Sublime Syntax"] = 901,
    ["Subsquid squid manifest"] = 946,
    ["Swagger API 2.0"] = 689,
    ["Synadia Connect Component"] = 690,
    TSON = 724,
    TSTyche = 725,
    ["Tab data for a LinUtil"] = 992,
    ["Tab list for a LinUtil"] = 991,
    Tach = 691,
    ["Tach Domain"] = 692,
    Talhelper = 694,
    ["Talisman configuration"] = 695,
    ["Taskfile config"] = 833,
    Taurus = 696,
    Tauticord = 697,
    Telefonistka = 1018,
    ["TestEnvironment.json"] = 707,
    ["TextMate Grammar"] = 706,
    ["Tier.run pricing.json"] = 700,
    Tikibase = 701,
    Tombi = 705,
    ["Traefik v2"] = 710,
    ["Traefik v2 File Provider"] = 711,
    ["Traefik v3"] = 712,
    ["Traefik v3 File Provider"] = 713,
    ["Travis CI (.travis.yml)"] = 709,
    Trident = 1016,
    ["TrueScript for *.tscript files"] = 716,
    ["Tugboat QA config.yml"] = 1013,
    TunnelHub = 936,
    Turborepo = 708,
    Tycho = 981,
    Tye = 863,
    ["Tyk Gateway - Open Source v5.7+"] = 1023,
    ["UET BuildConfig.json"] = 906,
    ["UI5 Manifest"] = 734,
    ["UNCORS configuration"] = 738,
    ["UTAM Page Object"] = 737,
    ["Ubuntu Server Autoinstall"] = 732,
    ["Uniswap Token List"] = 816,
    ["Universal Schedule Format"] = 739,
    ["Unreal Engine Uplugin"] = 907,
    ["Unreal Engine Uproject"] = 908,
    ["Updatecli Compose"] = 871,
    ["Updatecli Policy Manifest"] = 872,
    ["Updatecli Policy Metadata"] = 873,
    Uplift = 904,
    ["User Journey Map"] = 837,
    V2Ray = 877,
    ["VSCode Code Snippets"] = 187,
    ["VSIX CLI publishing"] = 757,
    Vector = 741,
    ["Vela Pipeline Configuration"] = 744,
    Vercel = 186,
    ["Version Bumper config"] = 747,
    ["Viash Component Config"] = 1020,
    ["Viash Package Config"] = 1021,
    Visivo = 934,
    Wake = 1015,
    ["Waku Config"] = 995,
    ["Web App Manifest"] = 763,
    ["Web types"] = 766,
    WebExtensions = 762,
    ["Webman package recipe"] = 883,
    ["Windows Package Manager Installer Manifest"] = 812,
    ["Windows Package Manager Locale Manifest"] = 813,
    ["Windows Package Manager Singleton Manifest"] = 811,
    Winutil = 814,
    ["WireMock stub mapping"] = 998,
    ["Woodpecker pipeline config"] = 851,
    ["Wrangler CLI"] = 767,
    ["Xstate Machine"] = 869,
    ["Yandex Workflow Language"] = 987,
    ["Yarn Config (.yarnrc.yml)"] = 826,
    ["Yippee-Ki-JSON configuration YML"] = 818,
    ["YouTrack App"] = 984,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 18,
    apko = 938,
    ...
    ["behat.yml"] = 94,
    ["bigquery-table"] = 84,
    ["bioimageio resource description"] = 954,
    ...
    ["crowdin.yml"] = 220,
    ["ctfd-setup configuration file"] = 1005,
    ["custom-elements.json"] = 926,
    ["cypress.json"] = 224,
    ...
    ["gematik health care insurance list"] = 1011,
    ["gematik health care patient list"] = 1008,
    ["gematik health care provider institution list"] = 1010,
    ["gematik health care provider list"] = 1009,
    ["gematik tiger test environment configuration"] = 1012,
    ["gitlab-ci"] = 326,
    ["global.json"] = 342,
    ...
    ["lint-staged (.lintstagedrc)"] = 783,
    ["local.settings.json"] = 442,
    ["localazy.json"] = 443,
    ["lotus.yaml"] = 441,
    ["lsdlschema.json"] = 444,
    ["markdown-link-check"] = 846,
    maturin = 847,
    mboats = 854,
    ["micro-settings.json"] = 918,
    ["mimetypes.json"] = 456,
    ["mirrord config"] = 784,
    mise = 785,
    ["mkdocs.yml"] = 476,
    ...
    ["plagiarize.yaml"] = 549,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1001,
    ["podbard.yaml"] = 552,
    ["portman.json"] = 553,
    ["prefect.toml"] = 561,
    ["prettierrc.json"] = 562,
    ...
    samt = 620,
    samtrc = 621,
    ["sarif-1.0.0.json"] = 623,
    ["sarif-2.0.0.json"] = 624,
    ["sarif-2.1.0"] = 634,
    ["sarif-2.1.0-rtm.2"] = 625,
    ["sarif-2.1.0-rtm.3"] = 627,
    ["sarif-2.1.0-rtm.4"] = 629,
    ["sarif-2.1.0-rtm.5"] = 631,
    ["sarif-2.1.0-rtm.6"] = 632,
    ["sarif-external-property-file-2.1.0"] = 635,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 626,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 628,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 630,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 633,
    ["scalingo.json configuration"] = 636,
    ["schema.org - Action"] = 638,
    ["schema.org - ContactPoint"] = 639,
    ["schema.org - Place"] = 640,
    ["schema.org - Thing"] = 641,
    ["secrethub.yml"] = 921,
    ["semantic-release"] = 647,
    ["servicehub.config.json"] = 778,
    ["servicehub.service.json"] = 777,
    ["settings.job"] = 650,
    ["sfdx-hardis configuration"] = 652,
    ["shard.yml"] = 957,
    ["size-limit configuration"] = 657,
    ["skaffold.yaml"] = 844,
    ["skyuxconfig.json"] = 659,
    snapcraft = 660,
    ["snowflake-config"] = 661,
    ["snowflake-connections"] = 662,
    ["spicepod.yaml"] = 976,
    ["sqlc configuration"] = 675,
    ["stripe-app-local.json"] = 684,
    ["stripe-app.json"] = 683,
    swcrc = 829,
    ["task.json"] = 693,
    taskcat = 794,
    ["template.json"] = 698,
    ["templatsources.json"] = 699,
    ["theme.json"] = 702,
    ["tizen_workspace.json"] = 703,
    tldr = 704,
    tmuxinator = 781,
    ["transcend.yml"] = 714,
    ...
    ["vega-lite.json"] = 743,
    ["vega.json"] = 742,
    ["venvironment-basic.yaml"] = 746,
    ["venvironment.yaml"] = 745,
    version = 1019,
    ["version.json"] = 748,
    ["vhwdebugger-binding.yaml"] = 750,
    ["vim-addon-info"] = 751,
    ["vs-2017.3.host.json"] = 753,
    ["vs-nesting.json"] = 754,
    ["vsls.json"] = 752,
    ["vss-extension.json"] = 758,
    vtcfg = 1025,
    ["vtesttree.yaml"] = 759,
    ["vtestunit.yaml"] = 760,
    ["warp-keysets.json"] = 927,
    ["warp-themes.json"] = 928,
    ["warp-workflows.json"] = 929,
    ["webhint.io"] = 884,
    ["webjobpublishsettings.json"] = 765,
    ["webjobs-list.json"] = 764,
    ["well-known-fursona"] = 964,
    ["xs-app.json"] = 790,
    ["xunit.runner.json"] = 776,
    yamllint = 817,
    ["zerops.io import file"] = 973,
    ["zerops.yml"] = 972,
    zuul = 800,
    ["Žinoma"] = 810
  },
