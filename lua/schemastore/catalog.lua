...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 178,
    [".cryproj (generic)"] = 611,
    [".cryproj engine-5.2"] = 606,
    [".cryproj engine-5.3"] = 607,
    [".cryproj engine-5.4"] = 608,
    [".cryproj engine-5.5"] = 609,
    [".cryproj engine-dev"] = 610,
    [".csscomb.json"] = 180,
    [".csslintrc"] = 181,
    [".es6importsorterrc.json"] = 742,
    [".eslintrc"] = 230,
    [".esmrc.json"] = 222,
    [".ffizer.yaml"] = 234,
    [".htmlhintrc"] = 287,
    ...
    [".mtaext"] = 620,
    [".nodehawkrc"] = 387,
    [".npmpackagejsonlintrc"] = 390,
    [".phraseapp.yml"] = 434,
    [".pmbot.yml"] = 423,
    [".postcssrc"] = 429,
    [".powerpages-web-template-manifest"] = 431,
    [".pre-commit-config.yml"] = 432,
    [".pre-commit-hooks.yml"] = 433,
    [".putout.json"] = 453,
    [".rehyperc"] = 465,
    [".remarkrc"] = 466,
    [".sprite files"] = 521,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 684,
    ["All Contributors configuration file"] = 741,
    ...
    ["Azure Pipelines"] = 59,
    ["Azure Static Web Apps CLI configuration file"] = 524,
    ["Azure Static Web Apps configuration file"] = 523,
    ["BX CI"] = 95,
    ["Better Code Hub"] = 656,
    ["Better Scripts"] = 96,
    Bigconfig = 76,
    BizTalkServerApplicationSchema = 626,
    Bleep = 97,
    ...
    ["Butane Config"] = 696,
    ["CICS TS region tagging"] = 705,
    ["CICS TS resource import"] = 706,
    ["CICS TS resource model"] = 707,
    ["CICS TS resource overrides"] = 708,
    ["CMake Presets"] = 98,
    ["CNC Codes"] = 108,
    ...
    ["Databricks Asset Bundles"] = 762,
    ["Datadog Service Definition"] = 326,
    ["Datahub Ingestion Recipe"] = 712,
    ["Dein Config"] = 113,
    Deno = 191,
    ["Deployer Recipe"] = 194,
    ["Deta Spacefile"] = 114,
    ...
    ["Goreleaser Pro"] = 269,
    Goss = 270,
    ["Gradle Build Cache Node"] = 654,
    ["Gradle Enterprise"] = 653,
    ...
    Hadolint = 635,
    Hammerkit = 663,
    ["Hardware Sentry Configuration"] = 716,
    Hatch = 636,
    Hayson = 282,
    ...
    ["JFrog File Spec"] = 307,
    ["JFrog Pipelines YML DSL"] = 725,
    ["JMeter DSL cli config"] = 308,
    JReleaser = 310,
    ["JSON Document Transform"] = 317,
    ["JSON Feed"] = 318,
    ["JSON Resume"] = 472,
    ["JSON Schema Draft 2020-12"] = 602,
    ["JSON Schema Draft 4"] = 599,
    ["JSON Schema Draft 7"] = 600,
    ["JSON Schema Draft 7 (unofficial strict)"] = 763,
    ["JSON Schema Draft 8 (2019-09)"] = 601,
    ["JSON-API"] = 316,
    ["JSON-e templates"] = 661,
    ["JSON-stat 2.0"] = 596,
    JSONPatch = 320,
    Jasmine = 300,
    Jekyll = 301,
    ...
    Kas = 323,
    ["Keycloak REST API"] = 733,
    ["Knative Functions - func.yaml"] = 247,
    ["KoDE/CI build.yaml"] = 721,
    ["Kong DBLess config"] = 722,
    KrakenD = 325,
    LOOBin = 342,
    Lefthook = 333,
    ["LinkML Metamodel"] = 340,
    Liquibase = 668,
    ["Liquibase Flow File"] = 669,
    ["Lively Properties"] = 341,
    ["Lobe AI Agent"] = 58,
    ["MS2Rescore Configuration"] = 375,
    Markdownlint = 672,
    ["Mason Registry"] = 674,
    ...
    ["MongoDB Atlas Search Index Definition"] = 720,
    ["Monika Configuration"] = 718,
    ["Motif config"] = 619,
    ["NOX Framework (Service)"] = 389,
    ["Netin Diagnostic System Template"] = 678,
    ["Netlify config"] = 380,
    ["Nexus-as-Code Data Model"] = 381,
    ["Nightwatch.js"] = 382,
    ["ONe's service descriptor"] = 404,
    ["OSS Review Toolkit configuration"] = 411,
    ["OSS Review Toolkit curation"] = 412,
    ["OSS Review Toolkit package configuration"] = 413,
    ["OSS Review Toolkit repository configuration"] = 414,
    ["OSS Review Toolkit resolutions"] = 415,
    Opctl = 622,
    ["OpenRewrite Resource"] = 406,
    ["OpenUtau character yaml"] = 401,
    ["OpenUtau ustx"] = 402,
    ["OpenWeather Current Weather API"] = 660,
    ["OpenWeather Road Risk API"] = 659,
    ["Ory Hydra configuration"] = 288,
    ["Ory Keto configuration"] = 327,
    ["Ory Kratos configuration"] = 410,
    ["Ory Oathkeeper configuration"] = 396,
    ["Outblocks App configuration"] = 408,
    ["Outblocks database table"] = 409,
    ["Outblocks project configuration"] = 407,
    Packer = 418,
    Pantsbuild = 740,
    ["Paper paper-plugin.yml"] = 419,
    ["Pipeline component"] = 670,
    ...
    Qgoda = 461,
    Qodana = 689,
    ["Quali Torque Blueprint Spec 2"] = 713,
    ["QueryFirst config file"] = 736,
    ["RKE Cluster Configuration JSON"] = 667,
    ["RKE Cluster Configuration YAML"] = 666,
    ["Rancher Fleet"] = 455,
    Ray = 634,
    ["Read the Docs"] = 457,
    ["Red-DiscordBot Cog"] = 462,
    ["Red-DiscordBot Cog Repo"] = 463,
    ["Red-DiscordBot Trivia"] = 464,
    RenderCV = 474,
    Renovate = 473,
    ["Replit config"] = 467,
    RoadRunner = 475,
    ...
    ["Rust Project"] = 471,
    ["Rust toolchain"] = 477,
    ["SIL Kit Participant Configuration"] = 509,
    ["SIL Kit Registry Configuration"] = 510,
    SWADL = 534,
    ["Safebox Config"] = 726,
    ["Sapphire CLI Config"] = 480,
    ["SauceCTL Configuration"] = 675,
    ["Schema Catalog"] = 494,
    ["Scoop manifest"] = 499,
    ["Semantic Data Fabric (SDF) file"] = 500,
    ["Semgrep Rule"] = 502,
    ["Serenity Code Generator (Sergen)"] = 503,
    ["Serverless Framework Configuration"] = 683,
    ["Serverless Workflow"] = 685,
    ["Settings.paf"] = 505,
    Setuptools = 506,
    ["Shopware 6 Configuration"] = 686,
    ["Shopware CLI Extension Store Configuration"] = 687,
    ["Shopware CLI Project Store Configuration"] = 688,
    ["Sigrid scope configuration file"] = 508,
    ["Slack app manifest"] = 512,
    Solidarity = 515,
    ["Solution filters"] = 516,
    ["Source Maps v3"] = 517,
    Sourcery = 518,
    SpecIF = 519,
    ["Sponge Mixin configuration"] = 520,
    StackBlitz = 525,
    ["StackHawk Scanner Configuration"] = 682,
    Stale = 526,
    ["Starlake Data Pipeline"] = 657,
    Starship = 527,
    ["Statamic Blueprint"] = 528,
    ["StrmPrivacy Data Connector"] = 730,
    ["StrmPrivacy Data Contract"] = 731,
    ["StrmPrivacy SimpleSchema"] = 728,
    ["StrmPrivacy Stream"] = 729,
    ["StrmPrivacy batch job configuration file"] = 727,
    ["Stryker Mutator"] = 531,
    ["StyleCop Analyzers Configuration"] = 532,
    ["Sublime Syntax"] = 732,
    ["Swagger API 2.0"] = 535,
    TSON = 560,
    TSTyche = 561,
    Talhelper = 537,
    ["Talisman configuration"] = 538,
    ["Taskfile config"] = 662,
    Taurus = 539,
    ["TestEnvironment.json"] = 548,
    ["TextMate Grammar"] = 547,
    ["Tier.run pricing.json"] = 542,
    Tikibase = 543,
    ["Traefik v2"] = 551,
    ["Traefik v2 File Provider"] = 552,
    TunnelHub = 766,
    Turborepo = 549,
    Tye = 690,
    ["UET BuildConfig.json"] = 737,
    ["UI5 Manifest"] = 569,
    ["UTAM Page Object"] = 572,
    ["Ubuntu Server Autoinstall"] = 567,
    ["Uniswap Token List"] = 645,
    ["Unreal Engine Uplugin"] = 738,
    ["Unreal Engine Uproject"] = 739,
    ["Updatecli Compose"] = 697,
    ["Updatecli Policy Manifest"] = 698,
    ["Updatecli Policy Metadata"] = 699,
    Uplift = 735,
    ["User Journey Map"] = 665,
    V2Ray = 703,
    ["VSCode Code Snippets"] = 149,
    ["VSIX CLI publishing"] = 585,
    ["Vela Pipeline Configuration"] = 575,
    Vercel = 148,
    Visivo = 764,
    ["Web App Manifest"] = 592,
    ["Web types"] = 595,
    WebExtensions = 591,
    ["Webman package recipe"] = 709,
    ["Windows Package Manager Installer Manifest"] = 642,
    ["Windows Package Manager Locale Manifest"] = 643,
    ["Windows Package Manager Singleton Manifest"] = 641,
    ["Woodpecker pipeline config"] = 677,
    ["Xstate Machine"] = 695,
    ...
    ["bamboo-spec"] = 70,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 746,
    ["bashly-strings.yml"] = 747,
    ["bashly.yml"] = 745,
    ["batect.yml"] = 69,
    ...
    ["lsdlschema.json"] = 346,
    ["madness.yml"] = 744,
    ["markdown-lint-check"] = 673,
    mboats = 680,
    ["micro-settings.json"] = 749,
    ["mimetypes.json"] = 353,
    ["mirrord config"] = 616,
    ["monospace.yml"] = 374,
    ["mta.yaml"] = 617,
    ["mtad.yaml"] = 618,
    ["mycode.json"] = 378,
    ["napari plugin manifest"] = 379,
    neoload = 628,
    ["nest-cli"] = 385,
    ["ninjs (News in JSON) 1.3"] = 384,
    ["ninjs (News in JSON) 2.0"] = 383,
    ["nlu.json"] = 386,
    ["nodemon.json"] = 388,
    ["noodl config"] = 679,
    now = 624,
    ...
    ["nswag.json"] = 394,
    ntangle = 395,
    ["nuclei-template.yaml"] = 392,
    ["nuget-project.json"] = 393,
    ["ocelot.json"] = 397,
    ["omnisharp.json"] = 398,
    ["openapi.json"] = 399,
    ["openfin.json"] = 405,
    ...
    ["ops.yaml"] = 403,
    ["package.json"] = 416,
    ["package.manifest"] = 417,
    ["pathfinder.yml"] = 420,
    ["pattern.json"] = 422,
    ["petstore-v1.0"] = 724,
    pgap_yaml_input_reader = 421,
    ["plagiarize-me.yaml"] = 427,
    ["plagiarize.yaml"] = 426,
    ["portman.json"] = 428,
    ["prettierrc.json"] = 435,
    ["prisma.yml"] = 436,
    ["project-1.0.0-beta3.json"] = 439,
    ["project-1.0.0-beta4.json"] = 440,
    ["project-1.0.0-beta5.json"] = 441,
    ["project-1.0.0-beta6.json"] = 442,
    ["project-1.0.0-beta8.json"] = 443,
    ["project-1.0.0-rc1.json"] = 444,
    ["project-1.0.0-rc2.json"] = 445,
    ["project.json"] = 438,
    ["prometheus.json"] = 446,
    ["prometheus.rules.json"] = 447,
    ["prometheus.rules.test.json"] = 448,
    ["proxies.json"] = 449,
    ["publiccode.yml"] = 450,
    ["pubspec.yaml"] = 451,
    ["pyrseas-0.8.json"] = 454,
    ["quilt.mod.json"] = 750,
    ["release drafter"] = 629,
    rtx = 469,
    rustfmt = 476,
    samt = 478,
    samtrc = 479,
    ["sarif-1.0.0.json"] = 481,
    ["sarif-2.0.0.json"] = 482,
    ["sarif-2.1.0"] = 492,
    ["sarif-2.1.0-rtm.2"] = 483,
    ["sarif-2.1.0-rtm.3"] = 485,
    ["sarif-2.1.0-rtm.4"] = 487,
    ["sarif-2.1.0-rtm.5"] = 489,
    ["sarif-2.1.0-rtm.6"] = 490,
    ["sarif-external-property-file-2.1.0"] = 493,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 484,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 486,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 488,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 491,
    ["schema.org - Action"] = 495,
    ["schema.org - ContactPoint"] = 496,
    ["schema.org - Place"] = 497,
    ["schema.org - Thing"] = 498,
    ["scikit-build"] = 681,
    ["secrethub.yml"] = 752,
    ["semantic-release"] = 501,
    ["servicehub.config.json"] = 605,
    ["servicehub.service.json"] = 604,
    ["settings.job"] = 504,
    ["sfdx-hardis configuration"] = 507,
    ["size-limit configuration"] = 511,
    ["skaffold.yaml"] = 671,
    ["skyuxconfig.json"] = 513,
    snapcraft = 514,
    ["sqlc configuration"] = 522,
    ["stripe-app-local.json"] = 530,
    ["stripe-app.json"] = 529,
    swcrc = 658,
    syntax = 754,
    ["task.json"] = 536,
    taskcat = 625,
    ["template.json"] = 540,
    ["templatsources.json"] = 541,
    ["theme.json"] = 544,
    ["tizen_workspace.json"] = 545,
    tldr = 546,
    tmuxinator = 613,
    ["transcend.yml"] = 553,
    ["trunk.yaml"] = 554,
    ["ts-force-config.json"] = 558,
    ["tsconfig.json"] = 555,
    ["tsd.json"] = 556,
    ["tsdrc.json"] = 557,
    ["tslint.json"] = 559,
    ...
    ["vega-lite.json"] = 574,
    ["vega.json"] = 573,
    ["venvironment-basic.yaml"] = 577,
    ["venvironment.yaml"] = 576,
    ["version.json"] = 578,
    ["vim-addon-info"] = 579,
    ["vs-2017.3.host.json"] = 581,
    ["vs-nesting.json"] = 582,
    ["vsls.json"] = 580,
    ["vss-extension.json"] = 586,
    ["vtesttree.yaml"] = 587,
    ["vtestunit.yaml"] = 588,
    ["warp-keysets.json"] = 758,
    ["warp-themes.json"] = 759,
    ["warp-workflows.json"] = 760,
    ["webhint.io"] = 710,
    ["webjobpublishsettings.json"] = 594,
    ["webjobs-list.json"] = 593,
    ["xs-app.json"] = 621,
    ["xunit.runner.json"] = 603,
    yamllint = 646,
    zuul = 630,
    ["Žinoma"] = 640
  },
