...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 91,
    [".cryproj (generic)"] = 380,
    [".cryproj engine-5.2"] = 375,
    [".cryproj engine-5.3"] = 376,
    [".cryproj engine-5.4"] = 377,
    [".cryproj engine-5.5"] = 378,
    [".cryproj engine-dev"] = 379,
    [".csscomb.json"] = 93,
    [".csslintrc"] = 94,
    [".eslintrc"] = 127,
    [".esmrc.json"] = 121,
    ...
    [".mtaext"] = 386,
    [".nodehawkrc"] = 228,
    [".npmpackagejsonlintrc"] = 230,
    [".phraseapp.yml"] = 257,
    [".pmbot.yml"] = 250,
    [".postcssrc"] = 255,
    [".pre-commit-config.yml"] = 256,
    [".putout.json"] = 274,
    [".rehyperc"] = 279,
    [".remarkrc"] = 280,
    [".sprite files"] = 314,
    ...
    [".vsext"] = 356,
    [".yarnrc.yml"] = 418,
    ["<div>RIOTS' studio configuration"] = 359,
    ["API Builder"] = 415,
    ...
    ["Azure Pipelines"] = 28,
    ["Azure Static Web Apps CLI configuration file"] = 316,
    ["Azure Static Web Apps configuration file"] = 315,
    ["Better Code Hub"] = 420,
    BizTalkServerApplicationSchema = 392,
    Briefcase = 397,
    Buildkite = 49,
    ...
    Goreleaser = 152,
    ["Goreleaser Pro"] = 153,
    ["Gradle Build Cache Node"] = 417,
    ["Gradle Enterprise"] = 416,
    ...
    ["JSON Feed"] = 187,
    ["JSON Resume"] = 282,
    ["JSON Schema Draft 2020-12"] = 371,
    ["JSON Schema Draft 4"] = 368,
    ["JSON Schema Draft 7"] = 369,
    ["JSON Schema Draft 8"] = 370,
    ...
    ["Microsoft Band Web Tile"] = 205,
    ["Minecraft Data Pack Advancement"] = 207,
    ["Minecraft Data Pack Biome"] = 208,
    ["Minecraft Data Pack Configured Carver"] = 209,
    ["Minecraft Data Pack Dimension"] = 211,
    ["Minecraft Data Pack Dimension Type"] = 210,
    ["Minecraft Data Pack Item Modifier"] = 212,
    ["Minecraft Data Pack Loot Table"] = 213,
    ["Minecraft Data Pack Metadata"] = 214,
    ["Minecraft Data Pack Predicate"] = 215,
    ["Minecraft Data Pack Recipe"] = 216,
    ["Minecraft Data Pack Template Pool"] = 217,
    ["Minecraft Resourcepack Sounds"] = 218,
    ["Netin Diagnostic System Template"] = 439,
    ["Netlify config schema"] = 223,
    ["Nightwatch.js"] = 224,
    ["OSS Review Toolkit repository configuration"] = 244,
    Opctl = 388,
    ["OpenWeather Current Weather API"] = 424,
    ["OpenWeather Road Risk API"] = 423,
    ["Ory Hydra configuration"] = 170,
    ["Ory Keto configuration"] = 192,
    ["Ory Kratos configuration"] = 243,
    ["Ory Oathkeeper configuration"] = 235,
    ["Outblocks App configuration"] = 241,
    ["Outblocks database table"] = 242,
    ["Outblocks project configuration"] = 240,
    Packer = 247,
    ["Pipeline component"] = 433,
    ["PocketMine plugin.yml"] = 251,
    ["Pull Request Labeler"] = 273,
    ["RKE Cluster Configuration JSON Schema"] = 431,
    ["RKE Cluster Configuration YAML Schema"] = 430,
    Ray = 400,
    ["Read the Docs"] = 276,
    ["Red-DiscordBot Сog"] = 277,
    ["Red-DiscordBot Сog Repo"] = 278,
    Renovate = 283,
    RoadRunner = 284,
    SWADL = 324,
    ["Sapphire CLI Config"] = 285,
    ["SauceCTL Configuration"] = 436,
    ["Schema Catalog"] = 298,
    ["Scoop manifest"] = 303,
    ["Semgrep Rule"] = 304,
    ["Serverless Framework Configuration"] = 443,
    Solidarity = 310,
    ["Source Maps v3"] = 311,
    SpecIF = 312,
    ["Sponge Mixin configuration"] = 313,
    ["StackHawk Scanner Configuration"] = 442,
    ["StackHead CLI config"] = 317,
    ["StackHead module configuration"] = 318,
    ["StackHead project definition"] = 319,
    Stale = 320,
    ["Stryker Mutator"] = 321,
    ["StyleCop Analyzers Configuration"] = 322,
    ["Swagger API 2.0"] = 325,
    ["Taskfile YAML Schema"] = 426,
    Taurus = 326,
    ["TestEnvironment.json"] = 331,
    ["Traefik v2"] = 333,
    ["Traefik v2 File Provider"] = 334,
    ["UI5 Manifest"] = 345,
    ["Uniswap Token List"] = 409,
    ["User Journey Map YAML Schema"] = 429,
    ["VSCode Code Snippets"] = 70,
    ["VSIX CLI publishing"] = 357,
    ["Vela Pipeline Configuration"] = 349,
    ["Web App Manifest"] = 361,
    ["Web types"] = 364,
    WebExtensions = 360,
    ["Windows Package Manager Installer Manifest"] = 406,
    ["Windows Package Manager Locale Manifest"] = 407,
    ["Windows Package Manager Singleton Manifest"] = 405,
    ["Woodpecker pipeline config"] = 438,
    ["Yippee-Ki-JSON configuration YML"] = 411,
    ["angular.json"] = 6,
    ...
    ["localazy.json"] = 201,
    ["lsdlschema.json"] = 202,
    ["markdownlint.json"] = 435,
    mboats = 441,
    ["mimetypes.json"] = 206,
    ["mta.yaml"] = 384,
    ["mtad.yaml"] = 385,
    ["mycode.json"] = 221,
    ["napari plugin manifest"] = 222,
    neoload = 394,
    ["nest-cli"] = 226,
    ["ninjs (News in JSON)"] = 225,
    ["nlu.json"] = 227,
    ["nodemon.json"] = 229,
    ["noodl.schema.json"] = 440,
    now = 390,
    ["nswag.json"] = 233,
    ntangle = 234,
    ["nuclei-template.yaml"] = 231,
    ["nuget-project.json"] = 232,
    ["ocelot.json"] = 236,
    ["omnisharp.json"] = 237,
    ["openapi.json"] = 238,
    ["openfin.json"] = 239,
    ["package.json"] = 245,
    ["package.manifest"] = 246,
    ["pattern.json"] = 249,
    pgap_yaml_input_reader = 248,
    ["plagiarize-me.yaml"] = 253,
    ["plagiarize.yaml"] = 252,
    ["portman.json"] = 254,
    ["prettierrc.json"] = 258,
    ["prisma.yml"] = 259,
    ["project-1.0.0-beta3.json"] = 261,
    ["project-1.0.0-beta4.json"] = 262,
    ["project-1.0.0-beta5.json"] = 263,
    ["project-1.0.0-beta6.json"] = 264,
    ["project-1.0.0-beta8.json"] = 265,
    ["project-1.0.0-rc1.json"] = 266,
    ["project-1.0.0-rc2.json"] = 267,
    ["project.json"] = 260,
    ["prometheus.json"] = 268,
    ["prometheus.rules.json"] = 269,
    ["proxies.json"] = 270,
    ["publiccode.yml"] = 271,
    ["pubspec.yaml"] = 272,
    ["pyrseas-0.8.json"] = 275,
    ["release drafter"] = 395,
    ["sarif-1.0.0.json"] = 286,
    ["sarif-2.0.0.json"] = 287,
    ["sarif-2.1.0"] = 296,
    ["sarif-2.1.0-rtm.2"] = 288,
    ["sarif-2.1.0-rtm.3"] = 290,
    ["sarif-2.1.0-rtm.4"] = 292,
    ["sarif-2.1.0-rtm.5"] = 294,
    ["sarif-external-property-file-2.1.0"] = 297,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 289,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 291,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 293,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 295,
    ["schema.org - Action"] = 299,
    ["schema.org - ContactPoint"] = 300,
    ["schema.org - Place"] = 301,
    ["schema.org - Thing"] = 302,
    ["servicehub.config.json"] = 374,
    ["servicehub.service.json"] = 373,
    ["settings.job"] = 305,
    ["sfdx-hardis configuration"] = 306,
    ["size-limit configuration"] = 307,
    ["skaffold.yaml"] = 434,
    ["skyuxconfig.json"] = 308,
    snapcraft = 309,
    swcrc = 422,
    taskcat = 391,
    ["template.json"] = 327,
    ["templatsources.json"] = 328,
    ["theme.json"] = 329,
    tmLanguage = 330,
    ["trunk.yaml schema"] = 335,
    ["ts-force-config.json"] = 339,
    ["tsconfig.json"] = 336,
    ["tsd.json"] = 337,
    ["tsdrc.json"] = 338,
    ["tslint.json"] = 340,
    ...
    ["version.json"] = 350,
    ["vim-addon-info"] = 351,
    ["vs-2017.3.host.json"] = 353,
    ["vs-nesting.json"] = 354,
    ["vsls.json"] = 352,
    ["vss-extension.json"] = 358,
    ["webjobpublishsettings.json"] = 363,
    ["webjobs-list.json"] = 362,
    ["xs-app.json"] = 387,
    ["xunit.runner.json"] = 372,
    yamllint = 410,
    zuul = 396,
    ["Žinoma"] = 404
  },
