...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 158,
    [".cryproj (generic)"] = 540,
    [".cryproj engine-5.2"] = 535,
    [".cryproj engine-5.3"] = 536,
    [".cryproj engine-5.4"] = 537,
    [".cryproj engine-5.5"] = 538,
    [".cryproj engine-dev"] = 539,
    [".csscomb.json"] = 160,
    [".csslintrc"] = 161,
    [".es6importsorterrc.json"] = 663,
    [".eslintrc"] = 206,
    [".esmrc.json"] = 198,
    [".ffizer.yaml"] = 210,
    [".htmlhintrc"] = 254,
    ...
    ["Better Code Hub"] = 583,
    ["Better Scripts"] = 84,
    BizTalkServerApplicationSchema = 555,
    ...
    ["Butane Config"] = 622,
    ["CICS TS region tagging"] = 629,
    ["CICS TS resource import"] = 630,
    ["CICS TS resource model"] = 631,
    ["CICS TS resource overrides"] = 632,
    ["CMake Presets"] = 85,
    ...
    ["Datahub Ingestion Recipe Schema"] = 636,
    ...
    ["Embrace Config Schema"] = 647,
    ["Error pages"] = 201,
    Esquio = 199,
    ["Estuary Flow Catalog Schema"] = 626,
    ["Expo SDK"] = 204,
    ...
    Goreleaser = 236,
    ["Goreleaser Pro"] = 237,
    ["Gradle Build Cache Node"] = 580,
    ["Gradle Enterprise"] = 579,
    ...
    Hadolint = 564,
    Hammerkit = 590,
    ["Hardware Sentry Configuration"] = 640,
    Hayson = 249,
    ...
    ["JFrog File Spec"] = 273,
    ["JFrog Pipelines YML DSL"] = 649,
    ["JMeter DSL cli config schema"] = 274,
    ["JSON Document Transform"] = 282,
    ["JSON Feed"] = 283,
    ["JSON Resume"] = 416,
    ["JSON Schema Draft 2020-12"] = 531,
    ["JSON Schema Draft 4"] = 528,
    ["JSON Schema Draft 7"] = 529,
    ["JSON Schema Draft 8"] = 530,
    ...
    ["KSP-CKAN"] = 527,
    Kas = 288,
    ["Keycloak REST API"] = 655,
    ["Knative Functions - func.yaml"] = 219,
    ["KoDE/CI build.yaml"] = 645,
    ["Kong DBLess Schema"] = 646,
    KrakenD = 289,
    LOOBin = 304,
    ["LinkML Metamodel"] = 302,
    Liquibase = 595,
    ["Liquibase Flow File"] = 596,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 644,
    ["Monika Configuration Schema"] = 642,
    ["Motif config"] = 548,
    ["NOX Framework (Service)"] = 346,
    ["Netin Diagnostic System Template"] = 605,
    ...
    ["OpenWeather Current Weather API"] = 587,
    ["OpenWeather Road Risk API"] = 586,
    ...
    PyProject = 405,
    Qodana = 615,
    ["Quali Torque Blueprint Spec 2"] = 637,
    ["QueryFirst config file"] = 658,
    ["RKE Cluster Configuration JSON Schema"] = 594,
    ["RKE Cluster Configuration YAML Schema"] = 593,
    ["Rancher Fleet"] = 402,
    Ray = 563,
    ["Read the Docs"] = 403,
    ...
    ["SauceCTL Configuration"] = 602,
    ["Schema Catalog"] = 434,
    ["Scoop manifest"] = 439,
    ["Semgrep Rule"] = 441,
    ["Serenity Code Generator (Sergen)"] = 442,
    ["Serverless Framework Configuration"] = 609,
    ["Serverless Workflow Schema"] = 611,
    ["Settings.paf"] = 444,
    ["Shopware 6 Configuration"] = 612,
    ["Shopware CLI Extension Store Configuration"] = 613,
    ["Shopware CLI Project Store Configuration"] = 614,
    ...
    ["StackHawk Scanner Configuration"] = 608,
    Stale = 460,
    Starship = 461,
    ["Statamic Blueprint"] = 462,
    ["StrmPrivacy Data Connector"] = 653,
    ["StrmPrivacy Data Contract"] = 654,
    ["StrmPrivacy SimpleSchema"] = 651,
    ["StrmPrivacy Stream"] = 652,
    ["StrmPrivacy batch job configuration file"] = 650,
    ["Stryker Mutator"] = 465,
    ["StyleCop Analyzers Configuration"] = 466,
    ["Swagger API 2.0"] = 469,
    TSON = 492,
    ["Talisman configuration"] = 471,
    ["Taskfile YAML Schema"] = 589,
    Taurus = 472,
    ["TestEnvironment.json"] = 480,
    ["Tier.run pricing.json"] = 475,
    Tikibase = 476,
    ["Traefik v2"] = 483,
    ["Traefik v2 File Provider"] = 484,
    Turborepo = 481,
    Tye = 616,
    ["UI5 Manifest"] = 499,
    ["UTAM Page Object"] = 502,
    ["Ubuntu Server Autoinstall"] = 497,
    ["Uniswap Token List"] = 572,
    ["Unreal Engine Uplugin"] = 659,
    ["Unreal Engine Uproject"] = 660,
    Updatecli = 623,
    Uplift = 657,
    ["User Journey Map YAML Schema"] = 592,
    V2Ray = 627,
    ["VSCode Code Snippets"] = 131,
    ["VSIX CLI publishing"] = 515,
    ["Vela Pipeline Configuration"] = 505,
    Vercel = 130,
    ["Web App Manifest"] = 521,
    ["Web types"] = 524,
    WebExtensions = 520,
    ["Webman package recipe"] = 633,
    ["Windows Package Manager Installer Manifest"] = 569,
    ["Windows Package Manager Locale Manifest"] = 570,
    ["Windows Package Manager Singleton Manifest"] = 568,
    ["Woodpecker pipeline config"] = 604,
    ["Xstate Machine Schema"] = 621,
    ["Yippee-Ki-JSON configuration YML"] = 574,
    ["angular.json"] = 11,
    ...
    ["bamboo-spec"] = 59,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 665,
    ["bashly-strings.yml"] = 666,
    ["bashly.yml"] = 664,
    ["batect.yml"] = 58,
    ["beau.yml"] = 582,
    ...
    ["ize.toml"] = 656,
    ["jsconfig.json"] = 286,
    ["jscpd Configuration Schema"] = 638,
    jsdoc = 562,
    ["k3d.yaml"] = 287,
    ...
    ["servicehub.config.json"] = 534,
    ["servicehub.service.json"] = 533,
    ["settings.job"] = 443,
    ...
    tmuxinator = 542,
    ["transcend.yml"] = 485,
    ["trunk.yaml schema"] = 486,
    ["ts-force-config.json"] = 490,
    ["tsconfig.json"] = 487,
    ["tsd.json"] = 488,
    ["tsdrc.json"] = 489,
    ["tslint.json"] = 491,
    ...
    ["vega-lite.json"] = 504,
    ["vega.json"] = 503,
    ["venvironment-basic.yaml"] = 507,
    ["venvironment.yaml"] = 506,
    ["version.json"] = 508,
    ["vim-addon-info"] = 509,
    ["vs-2017.3.host.json"] = 511,
    ["vs-nesting.json"] = 512,
    ["vsls.json"] = 510,
    ["vss-extension.json"] = 516,
    ["vtesttree.yaml"] = 517,
    ["webhint.io"] = 634,
    ["webjobpublishsettings.json"] = 523,
    ["webjobs-list.json"] = 522,
    ["xs-app.json"] = 550,
    ["xunit.runner.json"] = 532,
    yamllint = 573,
    zuul = 559,
    ["Žinoma"] = 567
  },
