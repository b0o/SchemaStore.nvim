...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 113,
    [".cryproj (generic)"] = 430,
    [".cryproj engine-5.2"] = 425,
    [".cryproj engine-5.3"] = 426,
    [".cryproj engine-5.4"] = 427,
    [".cryproj engine-5.5"] = 428,
    [".cryproj engine-dev"] = 429,
    [".csscomb.json"] = 115,
    [".csslintrc"] = 116,
    [".eslintrc"] = 154,
    [".esmrc.json"] = 147,
    ...
    [".mtaext"] = 436,
    [".nodehawkrc"] = 267,
    [".npmpackagejsonlintrc"] = 269,
    [".phraseapp.yml"] = 301,
    [".pmbot.yml"] = 293,
    [".postcssrc"] = 298,
    [".pre-commit-config.yml"] = 299,
    [".pre-commit-hooks.yml"] = 300,
    [".putout.json"] = 318,
    [".rehyperc"] = 323,
    [".remarkrc"] = 324,
    [".sprite files"] = 360,
    ...
    [".vsext"] = 406,
    [".yarnrc.yml"] = 468,
    ["<div>RIOTS' studio configuration"] = 409,
    ["API Builder"] = 465,
    ["AVA Configuration Schema"] = 517,
    ["AWS CDK cdk.json"] = 102,
    ["AWS CloudFormation"] = 103,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 104,
    ...
    ["Azure Pipelines"] = 40,
    ["Azure Static Web Apps CLI configuration file"] = 362,
    ["Azure Static Web Apps configuration file"] = 361,
    ["BX CI"] = 68,
    ["Better Code Hub"] = 470,
    BizTalkServerApplicationSchema = 442,
    ...
    ["Butane config schema"] = 504,
    ["CICS TS region tagging"] = 511,
    ["CICS TS resource import"] = 512,
    ["CICS TS resource model"] = 513,
    ["CICS TS resource overrides"] = 514,
    ["CMake Presets"] = 69,
    ["CSR Framework"] = 77,
    ["Calqulus pipeline"] = 70,
    ["Camel YAML DSL"] = 71,
    Carafe = 72,
    ["Catalog Info Backstage"] = 73,
    Cheatsheets = 501,
    ["Chrome Extension"] = 96,
    ["CircleCI config.yml"] = 80,
    ["Citation File Format"] = 105,
    CityJSON = 74,
    ["Code Climate"] = 81,
    ["Commandbox Box.json"] = 75,
    ["Commandbox Server.json"] = 76,
    ["Common types for all schemas"] = 1,
    ["Container Structure Test"] = 453,
    Containerlab = 478,
    ["Dart build configuration"] = 117,
    ["Dart test config"] = 118,
    ["Datadog Service Catalog Definition"] = 225,
    ["Datahub Ingestion Recipe Schema"] = 518,
    Deno = 122,
    ["Deployer Recipe"] = 125,
    Devfile = 144,
    ["Discord Webhook"] = 127,
    ["Dolittle Artifacts"] = 130,
    ["Dolittle Bounded Context Configuration"] = 131,
    ["Dolittle Event Horizons Configuration"] = 132,
    ["Dolittle Resources Configuration"] = 133,
    ["Dolittle Server Configuration"] = 134,
    ["Dolittle Tenant Map Configuration"] = 136,
    ["Dolittle Tenants Configuration"] = 135,
    ["Dolittle Topology"] = 137,
    ["Drush site aliases"] = 141,
    ["Error pages"] = 150,
    Esquio = 148,
    ["Estuary Flow Catalog Schema"] = 508,
    ["Expo SDK"] = 153,
    ["F-Droid Data metadata"] = 157,
    ["Facets - FSDL - Application"] = 155,
    ["Fossa configuration file"] = 162,
    ["Fossa's fossa-deps file"] = 163,
    ["Foundry VTT - Manifest"] = 160,
    ["Foundry VTT - Template"] = 161,
    ["Foxx Manifest"] = 41,
    ["GatewayCore API Gateway"] = 166,
    ["GeoJSON.json latest"] = 506,
    GherKing = 510,
    ["GitHub Action"] = 170,
    ["GitHub Funding"] = 171,
    ["GitHub Issue Template configuration"] = 173,
    ["GitHub Workflow"] = 174,
    ["GitHub Workflow Template Properties"] = 175,
    ["GitHub issue forms"] = 172,
    GitVersion = 169,
    ["Gitpod Configuration"] = 177,
    ["Global Privacy Control"] = 167,
    ["Google Cloud Workflows"] = 101,
    Goreleaser = 180,
    ["Goreleaser Pro"] = 181,
    ["Gradle Build Cache Node"] = 467,
    ["Gradle Enterprise"] = 466,
    ["Grafana 5.x Dashboard"] = 182,
    ["GraphQL Code Generator"] = 185,
    ["GraphQL Config"] = 184,
    ["GraphQL Mesh"] = 183,
    ["Grunt JSHint task"] = 189,
    ["Grunt Watch task"] = 190,
    ["Grunt base task"] = 191,
    ["Grunt clean task"] = 187,
    ["Grunt copy task"] = 186,
    ["Grunt cssmin task"] = 188,
    HEMTT = 439,
    Hadolint = 451,
    ["Hammerkit YAML Schema"] = 477,
    ["Hardware Sentry Configuration"] = 522,
    Hayson = 193,
    ["Haystack Pipeline"] = 194,
    ["Hazelcast 5 Configuration"] = 195,
    ["Helm Chart.lock"] = 79,
    ["Helm Chart.yaml"] = 78,
    Hugo = 500,
    ["JFrog File Spec"] = 210,
    ["JSON Document Transform"] = 218,
    ["JSON Feed"] = 219,
    ["JSON Resume"] = 326,
    ["JSON Schema Draft 2020-12"] = 421,
    ["JSON Schema Draft 4"] = 418,
    ["JSON Schema Draft 7"] = 419,
    ["JSON Schema Draft 8"] = 420,
    ["JSON schema for CodeShip Pro services configuration files"] = 88,
    ["JSON schema for CodeShip Pro steps configuration files"] = 89,
    ["JSON schema for Codecov configuration files"] = 87,
    ["JSON-API"] = 217,
    ["JSON-e templates"] = 475,
    ["JSON-stat 2.0"] = 415,
    JSONPatch = 221,
    Jasmine = 206,
    Jekyll = 207,
    ["Jenkins X Pipelines"] = 208,
    ["Jenkins X Requirements"] = 209,
    ["Jovo Language Models"] = 211,
    ["KSP-AVC"] = 416,
    ["KSP-CKAN"] = 417,
    KrakenD = 224,
    ["LinkML Metamodel"] = 235,
    Liquibase = 482,
    Markdownlint = 485,
    ["MegaLinter configuration"] = 239,
    ["MegaLinter descriptor"] = 240,
    ["Meltano plugin discovery definition"] = 242,
    ["Meltano project definition"] = 241,
    ["Microsoft Band Web Tile"] = 243,
    ["Minecraft Data Pack Advancement"] = 245,
    ["Minecraft Data Pack Biome"] = 246,
    ["Minecraft Data Pack Configured Carver"] = 247,
    ["Minecraft Data Pack Dimension"] = 249,
    ["Minecraft Data Pack Dimension Type"] = 248,
    ["Minecraft Data Pack Item Modifier"] = 250,
    ["Minecraft Data Pack Loot Table"] = 251,
    ["Minecraft Data Pack Metadata"] = 252,
    ["Minecraft Data Pack Predicate"] = 253,
    ["Minecraft Data Pack Recipe"] = 254,
    ["Minecraft Data Pack Template Pool"] = 255,
    ["Minecraft Resourcepack Sounds"] = 256,
    ["Netin Diagnostic System Template"] = 489,
    ["Netlify config schema"] = 261,
    ["Nightwatch.js"] = 262,
    ["OSS Review Toolkit curation"] = 284,
    ["OSS Review Toolkit package configuration"] = 285,
    ["OSS Review Toolkit repository configuration"] = 286,
    ["OSS Review Toolkit resolutions"] = 287,
    Opctl = 438,
    ["OpenWeather Current Weather API"] = 474,
    ["OpenWeather Road Risk API"] = 473,
    ["Ory Hydra configuration"] = 199,
    ["Ory Keto configuration"] = 226,
    ["Ory Kratos configuration"] = 283,
    ["Ory Oathkeeper configuration"] = 274,
    ["Outblocks App configuration"] = 281,
    ["Outblocks database table"] = 282,
    ["Outblocks project configuration"] = 280,
    Packer = 290,
    ["Pipeline component"] = 483,
    ["PocketMine plugin.yml"] = 294,
    Pterodactyl = 521,
    ["Pull Request Labeler"] = 317,
    Qodana = 497,
    ["Quali Torque Blueprint Spec 2"] = 519,
    ["RKE Cluster Configuration JSON Schema"] = 481,
    ["RKE Cluster Configuration YAML Schema"] = 480,
    Ray = 450,
    ["Read the Docs"] = 320,
    ["Red-DiscordBot Cog"] = 321,
    ["Red-DiscordBot Cog Repo"] = 322,
    Renovate = 327,
    RoadRunner = 328,
    SWADL = 372,
    ["Sapphire CLI Config"] = 329,
    ["SauceCTL Configuration"] = 486,
    ["Schema Catalog"] = 342,
    ["Scoop manifest"] = 347,
    ["Semgrep Rule"] = 349,
    ["Serverless Framework Configuration"] = 493,
    ["Settings.paf"] = 351,
    ["Shopware 6 Configuration"] = 494,
    ["Shopware CLI Extension Store Configuration"] = 495,
    ["Shopware CLI Project Store Configuration"] = 496,
    Solidarity = 356,
    ["Source Maps v3"] = 357,
    SpecIF = 358,
    ["Sponge Mixin configuration"] = 359,
    ["StackHawk Scanner Configuration"] = 492,
    ["StackHead CLI config"] = 363,
    ["StackHead module configuration"] = 364,
    ["StackHead project definition"] = 365,
    Stale = 366,
    Starship = 367,
    ["Statamic Blueprint"] = 368,
    ["Stryker Mutator"] = 369,
    ["StyleCop Analyzers Configuration"] = 370,
    ["Swagger API 2.0"] = 373,
    ["Taskfile YAML Schema"] = 476,
    Taurus = 374,
    ["TestEnvironment.json"] = 380,
    Tikibase = 377,
    ["Traefik v2"] = 382,
    ["Traefik v2 File Provider"] = 383,
    Tye = 498,
    ["UI5 Manifest"] = 395,
    ["Ubuntu Server Autoinstall"] = 393,
    ["Uniswap Token List"] = 459,
    Updatecli = 505,
    ["User Journey Map YAML Schema"] = 479,
    V2Ray = 509,
    ["VSCode Code Snippets"] = 91,
    ["VSIX CLI publishing"] = 407,
    ["Vela Pipeline Configuration"] = 399,
    Vercel = 90,
    ["Web App Manifest"] = 411,
    ["Web types"] = 414,
    WebExtensions = 410,
    ["Webman package recipe"] = 515,
    ["Windows Package Manager Installer Manifest"] = 456,
    ["Windows Package Manager Locale Manifest"] = 457,
    ["Windows Package Manager Singleton Manifest"] = 455,
    ["Woodpecker pipeline config"] = 488,
    ["Xstate Machine Schema"] = 503,
    ["Yippee-Ki-JSON configuration YML"] = 461,
    ["angular.json"] = 8,
    ...
    ["chutzpah.json"] = 97,
    ["cloud-init: cloud-config userdata JSON schema"] = 85,
    ["cloud-sdk-pipeline-config-schema"] = 99,
    ["cloudbuild.json"] = 100,
    cloudify = 84,
    codemagic = 86,
    ["coffeelint.json"] = 106,
    comet = 471,
    ["commands.json"] = 94,
    ["compile_commands.json"] = 93,
    ["compilerconfig.json"] = 92,
    ["component.json"] = 108,
    ["composer.json"] = 107,
    ["config.json"] = 109,
    ["contentmanifest.json"] = 98,
    ["contribute.json"] = 110,
    ["cosmos.config.json"] = 95,
    ["crowdin.yml"] = 111,
    cspell = 114,
    ["cypress.json"] = 112,
    ["datalogic-scan2deploy-android"] = 119,
    ["datalogic-scan2deploy-ce"] = 120,
    ["debugsettings.json"] = 121,
    ["dependabot-v2.json"] = 124,
    ["dependabot.json"] = 123,
    ["deployed-cli"] = 502,
    ["detekt.yml"] = 126,
    devinit = 463,
    ...
    ["dockerd.json"] = 128,
    ["dotnet Release Index manifest"] = 138,
    ["dotnetcli.host.json"] = 139,
    ["drone.json"] = 140,
    ["dss-2.0.0.json"] = 142,
    ["dvc.yaml"] = 143,
    ["ecosystem.json"] = 145,
    eksctl = 146,
    ["electron-builder configuration file."] = 151,
    ["epr-manifest.json"] = 149,
    ["evcc.yaml"] = 152,
    ["fabric.mod.json"] = 156,
    ["first-timers-bot"] = 159,
    fulibWorkflows = 487,
    ["func.yaml"] = 164,
    ["function.json"] = 165,
    ["geojson.json"] = 168,
    ["gitlab-ci"] = 176,
    ["global.json"] = 178,
    ["golangci-lint Configuration"] = 179,
    ["haxelib.json"] = 192,
    helmfile = 452,
    ["host-meta.json"] = 197,
    ["host.json"] = 196,
    ...
    huskyrc = 432,
    ["ide.host.json"] = 200,
    ["imageoptimizer.json"] = 201,
    ["importmap.json"] = 203,
    ["ioBroker JSON UI"] = 204,
    ["ioBroker Package manifest"] = 205,
    ["jsconfig.json"] = 222,
    ["jscpd Configuration Schema"] = 520,
    jsdoc = 449,
    ["k3d.yaml"] = 223,
    ["kustomization.yaml"] = 227,
    ["label-commenter-config.yml"] = 228,
    ["launchsettings.json"] = 229,
    ["lerna.json"] = 230,
    ["lgtm.yml"] = 231,
    ["libman.json"] = 232,
    ["license-report-config.json"] = 233,
    ["linkinator.config.json"] = 234,
    ["local.settings.json"] = 236,
    ["localazy.json"] = 237,
    ["lsdlschema.json"] = 238,
    mboats = 491,
    ["mimetypes.json"] = 244,
    ...
    ["mtad.yaml"] = 435,
    ["mycode.json"] = 259,
    ["napari plugin manifest"] = 260,
    neoload = 444,
    ["nest-cli"] = 265,
    ["ninjs (News in JSON) 1.3"] = 264,
    ["ninjs (News in JSON) 2.0"] = 263,
    ["nlu.json"] = 266,
    ["nodemon.json"] = 268,
    ["noodl.schema.json"] = 490,
    now = 440,
    ["nswag.json"] = 272,
    ntangle = 273,
    ["nuclei-template.yaml"] = 270,
    ["nuget-project.json"] = 271,
    ["ocelot.json"] = 275,
    ["omnisharp.json"] = 276,
    ["openapi.json"] = 277,
    ["openfin.json"] = 279,
    ["openrpc.json"] = 278,
    ["package.json"] = 288,
    ["package.manifest"] = 289,
    ["pattern.json"] = 292,
    pgap_yaml_input_reader = 291,
    ["plagiarize-me.yaml"] = 296,
    ["plagiarize.yaml"] = 295,
    ["portman.json"] = 297,
    ["prettierrc.json"] = 302,
    ["prisma.yml"] = 303,
    ["project-1.0.0-beta3.json"] = 305,
    ["project-1.0.0-beta4.json"] = 306,
    ["project-1.0.0-beta5.json"] = 307,
    ["project-1.0.0-beta6.json"] = 308,
    ["project-1.0.0-beta8.json"] = 309,
    ["project-1.0.0-rc1.json"] = 310,
    ["project-1.0.0-rc2.json"] = 311,
    ["project.json"] = 304,
    ["prometheus.json"] = 312,
    ["prometheus.rules.json"] = 313,
    ["proxies.json"] = 314,
    ["publiccode.yml"] = 315,
    ["pubspec.yaml"] = 316,
    ["pyrseas-0.8.json"] = 319,
    ["release drafter"] = 445,
    ["sarif-1.0.0.json"] = 330,
    ["sarif-2.0.0.json"] = 331,
    ["sarif-2.1.0"] = 340,
    ["sarif-2.1.0-rtm.2"] = 332,
    ["sarif-2.1.0-rtm.3"] = 334,
    ["sarif-2.1.0-rtm.4"] = 336,
    ["sarif-2.1.0-rtm.5"] = 338,
    ["sarif-external-property-file-2.1.0"] = 341,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 333,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 335,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 337,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 339,
    ["schema.org - Action"] = 343,
    ["schema.org - ContactPoint"] = 344,
    ["schema.org - Place"] = 345,
    ["schema.org - Thing"] = 346,
    ["semantic-release"] = 348,
    ["servicehub.config.json"] = 424,
    ["servicehub.service.json"] = 423,
    ["settings.job"] = 350,
    ["sfdx-hardis configuration"] = 352,
    ["size-limit configuration"] = 353,
    ["skaffold.yaml"] = 484,
    ["skyuxconfig.json"] = 354,
    snapcraft = 355,
    swcrc = 472,
    taskcat = 441,
    ["template.json"] = 375,
    ["templatsources.json"] = 376,
    ["theme.json"] = 378,
    tmLanguage = 379,
    ["trunk.yaml schema"] = 384,
    ["ts-force-config.json"] = 388,
    ["tsconfig.json"] = 385,
    ["tsd.json"] = 386,
    ["tsdrc.json"] = 387,
    ["tslint.json"] = 389,
    ...
    ["version.json"] = 400,
    ["vim-addon-info"] = 401,
    ["vs-2017.3.host.json"] = 403,
    ["vs-nesting.json"] = 404,
    ["vsls.json"] = 402,
    ["vss-extension.json"] = 408,
    ["webhint.io"] = 516,
    ["webjobpublishsettings.json"] = 413,
    ["webjobs-list.json"] = 412,
    ["xs-app.json"] = 437,
    ["xunit.runner.json"] = 422,
    yamllint = 460,
    zuul = 446,
    ["Žinoma"] = 454
  },
