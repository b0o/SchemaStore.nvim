...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 145,
    [".cryproj (generic)"] = 492,
    [".cryproj engine-5.2"] = 487,
    [".cryproj engine-5.3"] = 488,
    [".cryproj engine-5.4"] = 489,
    [".cryproj engine-5.5"] = 490,
    [".cryproj engine-dev"] = 491,
    [".csscomb.json"] = 147,
    [".csslintrc"] = 148,
    [".eslintrc"] = 193,
    [".esmrc.json"] = 185,
    ...
    [".mtaext"] = 501,
    [".nodehawkrc"] = 310,
    [".npmpackagejsonlintrc"] = 313,
    [".phraseapp.yml"] = 347,
    [".pmbot.yml"] = 339,
    [".postcssrc"] = 344,
    [".pre-commit-config.yml"] = 345,
    [".pre-commit-hooks.yml"] = 346,
    [".putout.json"] = 364,
    [".rehyperc"] = 371,
    [".remarkrc"] = 372,
    [".sprite files"] = 415,
    ...
    ["Azure Pipelines"] = 45,
    ["Azure Static Web Apps CLI configuration file"] = 417,
    ["Azure Static Web Apps configuration file"] = 416,
    ["BX CI"] = 76,
    ["Better Code Hub"] = 535,
    ["Better Scripts"] = 77,
    BizTalkServerApplicationSchema = 507,
    ...
    ["Butane Config"] = 572,
    ["CICS TS region tagging"] = 579,
    ["CICS TS resource import"] = 580,
    ["CICS TS resource model"] = 581,
    ["CICS TS resource overrides"] = 582,
    ["CMake Presets"] = 78,
    ...
    ["Datahub Ingestion Recipe Schema"] = 586,
    ...
    ["Embrace Config Schema"] = 597,
    ["Error pages"] = 188,
    Esquio = 186,
    ["Estuary Flow Catalog Schema"] = 576,
    ["Expo SDK"] = 191,
    ...
    Goreleaser = 219,
    ["Goreleaser Pro"] = 220,
    ["Gradle Build Cache Node"] = 532,
    ["Gradle Enterprise"] = 531,
    ...
    HEMTT = 504,
    Hadolint = 516,
    ["Hardware Sentry Configuration"] = 590,
    Hayson = 232,
    ...
    ["JFrog File Spec"] = 251,
    ["JFrog Pipelines YML DSL"] = 599,
    ["JSON Document Transform"] = 259,
    ["JSON Feed"] = 260,
    ["JSON Resume"] = 377,
    ["JSON Schema Draft 2020-12"] = 483,
    ["JSON Schema Draft 4"] = 480,
    ["JSON Schema Draft 7"] = 481,
    ["JSON Schema Draft 8"] = 482,
    ...
    ["KSP-AVC"] = 478,
    ["KSP-CKAN"] = 479,
    ["Keycloak REST API"] = 605,
    ["Knative Functions - func.yaml"] = 203,
    ["KoDE/CI build.yaml"] = 595,
    ["Kong DBLess Schema"] = 596,
    KrakenD = 265,
    ["LinkML Metamodel"] = 277,
    Liquibase = 546,
    ["Liquibase Flow File"] = 547,
    Markdownlint = 550,
    ["MegaLinter configuration"] = 281,
    ["MegaLinter descriptor"] = 282,
    ["Meltano plugin discovery definition"] = 284,
    ["Meltano project definition"] = 283,
    ["Microsoft Band Web Tile"] = 285,
    ["Minecraft Data Pack Advancement"] = 287,
    ["Minecraft Data Pack Biome"] = 288,
    ["Minecraft Data Pack Configured Carver"] = 289,
    ["Minecraft Data Pack Dimension"] = 291,
    ["Minecraft Data Pack Dimension Type"] = 290,
    ["Minecraft Data Pack Item Modifier"] = 292,
    ["Minecraft Data Pack Loot Table"] = 293,
    ["Minecraft Data Pack Metadata"] = 294,
    ["Minecraft Data Pack Predicate"] = 295,
    ["Minecraft Data Pack Recipe"] = 296,
    ["Minecraft Data Pack Tag"] = 297,
    ["Minecraft Data Pack Template Pool"] = 298,
    ["Minecraft Resourcepack Sounds"] = 299,
    ["MongoDB Atlas Search Index Definition Schema"] = 594,
    ["Monika Configuration Schema"] = 592,
    ["Motif config"] = 500,
    ["NOX Framework (Service)"] = 312,
    ["Netin Diagnostic System Template"] = 555,
    ["Netlify config schema"] = 304,
    ["Nightwatch.js"] = 305,
    ["OSS Review Toolkit configuration"] = 329,
    ["OSS Review Toolkit curation"] = 330,
    ["OSS Review Toolkit package configuration"] = 331,
    ["OSS Review Toolkit repository configuration"] = 332,
    ["OSS Review Toolkit resolutions"] = 333,
    Opctl = 503,
    ["OpenWeather Current Weather API"] = 539,
    ["OpenWeather Road Risk API"] = 538,
    ["Ory Hydra configuration"] = 238,
    ["Ory Keto configuration"] = 267,
    ["Ory Kratos configuration"] = 328,
    ["Ory Oathkeeper configuration"] = 319,
    ["Outblocks App configuration"] = 326,
    ["Outblocks database table"] = 327,
    ["Outblocks project configuration"] = 325,
    Packer = 336,
    ["Pipeline component"] = 548,
    ["PocketMine plugin.yml"] = 340,
    Pterodactyl = 589,
    ["Pull Request Labeler"] = 363,
    Pulumi = 367,
    PyProject = 368,
    Qodana = 565,
    ["Quali Torque Blueprint Spec 2"] = 587,
    ["QueryFirst config file"] = 608,
    ["RKE Cluster Configuration JSON Schema"] = 545,
    ["RKE Cluster Configuration YAML Schema"] = 544,
    Ray = 515,
    ["Read the Docs"] = 366,
    ["Red-DiscordBot Cog"] = 369,
    ["Red-DiscordBot Cog Repo"] = 370,
    Renovate = 378,
    ["Replit schema"] = 373,
    RoadRunner = 379,
    Ruff = 375,
    ["Rust Project"] = 376,
    ["Rust toolchain"] = 381,
    ["SIL Kit Participant Configuration"] = 406,
    SWADL = 426,
    ["Sapphire CLI Config"] = 382,
    ["SauceCTL Configuration"] = 552,
    ["Schema Catalog"] = 395,
    ["Scoop manifest"] = 400,
    ["Semgrep Rule"] = 402,
    ["Serverless Framework Configuration"] = 559,
    ["Serverless Workflow Schema"] = 561,
    ["Settings.paf"] = 404,
    ["Shopware 6 Configuration"] = 562,
    ["Shopware CLI Extension Store Configuration"] = 563,
    ["Shopware CLI Project Store Configuration"] = 564,
    Solidarity = 410,
    ["Solution filters"] = 411,
    ["Source Maps v3"] = 412,
    SpecIF = 413,
    ["Sponge Mixin configuration"] = 414,
    ["StackHawk Scanner Configuration"] = 558,
    Stale = 418,
    Starship = 419,
    ["Statamic Blueprint"] = 420,
    ["StrmPrivacy Data Connector"] = 603,
    ["StrmPrivacy Data Contract"] = 604,
    ["StrmPrivacy SimpleSchema"] = 601,
    ["StrmPrivacy Stream"] = 602,
    ["StrmPrivacy batch job configuration file"] = 600,
    ["Stryker Mutator"] = 423,
    ["StyleCop Analyzers Configuration"] = 424,
    ["Swagger API 2.0"] = 427,
    TSON = 447,
    ["Talisman configuration"] = 428,
    ["Taskfile YAML Schema"] = 541,
    Taurus = 429,
    ["TestEnvironment.json"] = 436,
    Tikibase = 432,
    ["Traefik v2"] = 439,
    ["Traefik v2 File Provider"] = 440,
    Turborepo = 437,
    Tye = 566,
    ["UI5 Manifest"] = 453,
    ["UTAM Page Object"] = 455,
    ["Ubuntu Server Autoinstall"] = 451,
    ["Uniswap Token List"] = 524,
    ["Unreal Engine Uplugin"] = 609,
    ["Unreal Engine Uproject"] = 610,
    Updatecli = 573,
    Uplift = 607,
    ["User Journey Map YAML Schema"] = 543,
    V2Ray = 577,
    ["VSCode Code Snippets"] = 121,
    ["VSIX CLI publishing"] = 468,
    ["Vela Pipeline Configuration"] = 458,
    Vercel = 120,
    ["Web App Manifest"] = 473,
    ["Web types"] = 476,
    WebExtensions = 472,
    ["Webman package recipe"] = 583,
    ["Windows Package Manager Installer Manifest"] = 521,
    ["Windows Package Manager Locale Manifest"] = 522,
    ["Windows Package Manager Singleton Manifest"] = 520,
    ["Woodpecker pipeline config"] = 554,
    ["Xstate Machine Schema"] = 571,
    ["Yippee-Ki-JSON configuration YML"] = 526,
    ["angular.json"] = 10,
    ...
    ["ize.toml"] = 606,
    ["jsconfig.json"] = 263,
    ["jscpd Configuration Schema"] = 588,
    jsdoc = 514,
    ["k3d.yaml"] = 264,
    ...
    ["mtad.yaml"] = 499,
    ["mycode.json"] = 302,
    ["napari plugin manifest"] = 303,
    neoload = 509,
    ["nest-cli"] = 308,
    ["ninjs (News in JSON) 1.3"] = 307,
    ["ninjs (News in JSON) 2.0"] = 306,
    ["nlu.json"] = 309,
    ["nodemon.json"] = 311,
    ["noodl.schema.json"] = 556,
    now = 505,
    ["npm-badges"] = 314,
    ["nswag.json"] = 317,
    ntangle = 318,
    ["nuclei-template.yaml"] = 315,
    ["nuget-project.json"] = 316,
    ["ocelot.json"] = 320,
    ["omnisharp.json"] = 321,
    ["openapi.json"] = 322,
    ["openfin.json"] = 324,
    ["openrpc.json"] = 323,
    ["package.json"] = 334,
    ["package.manifest"] = 335,
    ["pattern.json"] = 338,
    ["petstore-v1.0"] = 598,
    pgap_yaml_input_reader = 337,
    ["plagiarize-me.yaml"] = 342,
    ["plagiarize.yaml"] = 341,
    ["portman.json"] = 343,
    ["prettierrc.json"] = 348,
    ["prisma.yml"] = 349,
    ["project-1.0.0-beta3.json"] = 351,
    ["project-1.0.0-beta4.json"] = 352,
    ["project-1.0.0-beta5.json"] = 353,
    ["project-1.0.0-beta6.json"] = 354,
    ["project-1.0.0-beta8.json"] = 355,
    ["project-1.0.0-rc1.json"] = 356,
    ["project-1.0.0-rc2.json"] = 357,
    ["project.json"] = 350,
    ["prometheus.json"] = 358,
    ["prometheus.rules.json"] = 359,
    ["proxies.json"] = 360,
    ["publiccode.yml"] = 361,
    ["pubspec.yaml"] = 362,
    ["pyrseas-0.8.json"] = 365,
    ["release drafter"] = 510,
    rustfmt = 380,
    ["sarif-1.0.0.json"] = 383,
    ["sarif-2.0.0.json"] = 384,
    ["sarif-2.1.0"] = 393,
    ["sarif-2.1.0-rtm.2"] = 385,
    ["sarif-2.1.0-rtm.3"] = 387,
    ["sarif-2.1.0-rtm.4"] = 389,
    ["sarif-2.1.0-rtm.5"] = 391,
    ["sarif-external-property-file-2.1.0"] = 394,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 386,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 388,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 390,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 392,
    ["schema.org - Action"] = 396,
    ["schema.org - ContactPoint"] = 397,
    ["schema.org - Place"] = 398,
    ["schema.org - Thing"] = 399,
    ["semantic-release"] = 401,
    ["servicehub.config.json"] = 486,
    ["servicehub.service.json"] = 485,
    ["settings.job"] = 403,
    ["sfdx-hardis configuration"] = 405,
    ["size-limit configuration"] = 407,
    ["skaffold.yaml"] = 549,
    ["skyuxconfig.json"] = 408,
    snapcraft = 409,
    ["stripe-app-local.json"] = 422,
    ["stripe-app.json"] = 421,
    swcrc = 537,
    taskcat = 506,
    ["template.json"] = 430,
    ["templatsources.json"] = 431,
    ["theme.json"] = 433,
    ["tizen_workspace.json"] = 434,
    tmLanguage = 435,
    tmuxinator = 494,
    ["trunk.yaml schema"] = 441,
    ["ts-force-config.json"] = 445,
    ["tsconfig.json"] = 442,
    ["tsd.json"] = 443,
    ["tsdrc.json"] = 444,
    ["tslint.json"] = 446,
    ...
    ["vega-lite.json"] = 457,
    ["vega.json"] = 456,
    ["venvironment-basic.yaml"] = 460,
    ["venvironment.yaml"] = 459,
    ["version.json"] = 461,
    ["vim-addon-info"] = 462,
    ["vs-2017.3.host.json"] = 464,
    ["vs-nesting.json"] = 465,
    ["vsls.json"] = 463,
    ["vss-extension.json"] = 469,
    ["webhint.io"] = 584,
    ["webjobpublishsettings.json"] = 475,
    ["webjobs-list.json"] = 474,
    ["xs-app.json"] = 502,
    ["xunit.runner.json"] = 484,
    yamllint = 525,
    zuul = 511,
    ["Žinoma"] = 519
  },
