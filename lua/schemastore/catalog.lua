...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 175,
    [".cryproj (generic)"] = 601,
    [".cryproj engine-5.2"] = 596,
    [".cryproj engine-5.3"] = 597,
    [".cryproj engine-5.4"] = 598,
    [".cryproj engine-5.5"] = 599,
    [".cryproj engine-dev"] = 600,
    [".csscomb.json"] = 177,
    [".csslintrc"] = 178,
    [".es6importsorterrc.json"] = 730,
    [".eslintrc"] = 227,
    [".esmrc.json"] = 219,
    [".ffizer.yaml"] = 231,
    [".htmlhintrc"] = 283,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 673,
    ["All Contributors configuration file"] = 729,
    ...
    ["Azure Pipelines"] = 59,
    ["Azure Static Web Apps CLI configuration file"] = 516,
    ["Azure Static Web Apps configuration file"] = 515,
    ["BX CI"] = 95,
    ["Better Code Hub"] = 645,
    ["Better Scripts"] = 96,
    Bigconfig = 76,
    BizTalkServerApplicationSchema = 616,
    Bleep = 97,
    ...
    ["Butane Config"] = 685,
    ["CICS TS region tagging"] = 694,
    ["CICS TS resource import"] = 695,
    ["CICS TS resource model"] = 696,
    ["CICS TS resource overrides"] = 697,
    ["CMake Presets"] = 98,
    ["CNC Codes"] = 108,
    ...
    ["Databricks Asset Bundles"] = 750,
    ["Datadog Service Definition"] = 322,
    ["Datahub Ingestion Recipe"] = 701,
    ["Dein Config"] = 113,
    Deno = 188,
    ["Deployer Recipe"] = 191,
    ["Deta Spacefile"] = 114,
    ...
    ["Goreleaser Pro"] = 265,
    Goss = 266,
    ["Gradle Build Cache Node"] = 643,
    ["Gradle Enterprise"] = 642,
    ...
    Hadolint = 625,
    Hammerkit = 652,
    ["Hardware Sentry Configuration"] = 705,
    Hayson = 278,
    ...
    ["JFrog File Spec"] = 303,
    ["JFrog Pipelines YML DSL"] = 714,
    ["JMeter DSL cli config"] = 304,
    JReleaser = 306,
    ["JSON Document Transform"] = 313,
    ["JSON Feed"] = 314,
    ["JSON Resume"] = 465,
    ["JSON Schema Draft 2020-12"] = 592,
    ["JSON Schema Draft 4"] = 589,
    ["JSON Schema Draft 7"] = 590,
    ["JSON Schema Draft 7 (unofficial strict)"] = 751,
    ["JSON Schema Draft 8 (2019-09)"] = 591,
    ["JSON-API"] = 312,
    ["JSON-e templates"] = 650,
    ["JSON-stat 2.0"] = 586,
    JSONPatch = 316,
    Jasmine = 296,
    Jekyll = 297,
    ...
    Kas = 319,
    ["Keycloak REST API"] = 721,
    ["Knative Functions - func.yaml"] = 243,
    ["KoDE/CI build.yaml"] = 710,
    ["Kong DBLess config"] = 711,
    KrakenD = 321,
    LOOBin = 338,
    Lefthook = 329,
    ["LinkML Metamodel"] = 336,
    Liquibase = 657,
    ["Liquibase Flow File"] = 658,
    ...
    ["MongoDB Atlas Search Index Definition"] = 709,
    ["Monika Configuration"] = 707,
    ["Motif config"] = 609,
    ["NOX Framework (Service)"] = 384,
    ["Netin Diagnostic System Template"] = 667,
    ["Netlify config"] = 375,
    ...
    ["OpenWeather Current Weather API"] = 649,
    ["OpenWeather Road Risk API"] = 648,
    ...
    Qgoda = 454,
    Qodana = 678,
    ["Quali Torque Blueprint Spec 2"] = 702,
    ["QueryFirst config file"] = 724,
    ["RKE Cluster Configuration JSON"] = 656,
    ["RKE Cluster Configuration YAML"] = 655,
    ["Rancher Fleet"] = 448,
    Ray = 624,
    ["Read the Docs"] = 450,
    ...
    ["Rust Project"] = 464,
    ["Rust toolchain"] = 469,
    ["SIL Kit Participant Configuration"] = 501,
    ["SIL Kit Registry Configuration"] = 502,
    SWADL = 526,
    ["Safebox Config"] = 715,
    ["Sapphire CLI Config"] = 472,
    ["SauceCTL Configuration"] = 664,
    ["Schema Catalog"] = 486,
    ["Scoop manifest"] = 491,
    ["Semantic Data Fabric (SDF) file"] = 492,
    ["Semgrep Rule"] = 494,
    ["Serenity Code Generator (Sergen)"] = 495,
    ["Serverless Framework Configuration"] = 672,
    ["Serverless Workflow"] = 674,
    ["Settings.paf"] = 497,
    Setuptools = 498,
    ["Shopware 6 Configuration"] = 675,
    ["Shopware CLI Extension Store Configuration"] = 676,
    ["Shopware CLI Project Store Configuration"] = 677,
    ["Sigrid scope configuration file"] = 500,
    ["Slack app manifest"] = 504,
    Solidarity = 507,
    ["Solution filters"] = 508,
    ["Source Maps v3"] = 509,
    Sourcery = 510,
    SpecIF = 511,
    ["Sponge Mixin configuration"] = 512,
    StackBlitz = 517,
    ["StackHawk Scanner Configuration"] = 671,
    Stale = 518,
    ["Starlake Data Pipeline"] = 646,
    Starship = 519,
    ["Statamic Blueprint"] = 520,
    ["StrmPrivacy Data Connector"] = 719,
    ["StrmPrivacy Data Contract"] = 720,
    ["StrmPrivacy SimpleSchema"] = 717,
    ["StrmPrivacy Stream"] = 718,
    ["StrmPrivacy batch job configuration file"] = 716,
    ["Stryker Mutator"] = 523,
    ["StyleCop Analyzers Configuration"] = 524,
    ["Swagger API 2.0"] = 527,
    TSON = 551,
    ["Talisman configuration"] = 529,
    ["Taskfile config"] = 651,
    Taurus = 530,
    ["TestEnvironment.json"] = 539,
    ["TextMate Grammar"] = 538,
    ["Tier.run pricing.json"] = 533,
    Tikibase = 534,
    ["Traefik v2"] = 542,
    ["Traefik v2 File Provider"] = 543,
    Turborepo = 540,
    Tye = 679,
    ["UET BuildConfig.json"] = 725,
    ["UI5 Manifest"] = 559,
    ["UTAM Page Object"] = 562,
    ["Ubuntu Server Autoinstall"] = 557,
    ["Uniswap Token List"] = 634,
    ["Unreal Engine Uplugin"] = 726,
    ["Unreal Engine Uproject"] = 727,
    ["Updatecli Compose"] = 686,
    ["Updatecli Policy Manifest"] = 687,
    ["Updatecli Policy Metadata"] = 688,
    Uplift = 723,
    ["User Journey Map"] = 654,
    V2Ray = 692,
    ["VSCode Code Snippets"] = 146,
    ["VSIX CLI publishing"] = 575,
    ["Vela Pipeline Configuration"] = 565,
    Vercel = 145,
    Visivo = 752,
    ["Web App Manifest"] = 582,
    ["Web types"] = 585,
    WebExtensions = 581,
    ["Webman package recipe"] = 698,
    ["Windows Package Manager Installer Manifest"] = 631,
    ["Windows Package Manager Locale Manifest"] = 632,
    ["Windows Package Manager Singleton Manifest"] = 630,
    ["Woodpecker pipeline config"] = 666,
    ["Xstate Machine"] = 684,
    ["Yippee-Ki-JSON configuration YML"] = 636,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 70,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 734,
    ["bashly-strings.yml"] = 735,
    ["bashly.yml"] = 733,
    ["batect.yml"] = 69,
    ...
    ["lsdlschema.json"] = 342,
    ["madness.yml"] = 732,
    ["markdown-lint-check"] = 662,
    mboats = 669,
    ["micro-settings.json"] = 737,
    ["mimetypes.json"] = 349,
    ["mirrord config"] = 606,
    ["mta.yaml"] = 607,
    ["mtad.yaml"] = 608,
    ...
    samt = 470,
    samtrc = 471,
    ["sarif-1.0.0.json"] = 473,
    ["sarif-2.0.0.json"] = 474,
    ["sarif-2.1.0"] = 484,
    ["sarif-2.1.0-rtm.2"] = 475,
    ["sarif-2.1.0-rtm.3"] = 477,
    ["sarif-2.1.0-rtm.4"] = 479,
    ["sarif-2.1.0-rtm.5"] = 481,
    ["sarif-2.1.0-rtm.6"] = 482,
    ["sarif-external-property-file-2.1.0"] = 485,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 476,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 478,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 480,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 483,
    ["schema.org - Action"] = 487,
    ["schema.org - ContactPoint"] = 488,
    ["schema.org - Place"] = 489,
    ["schema.org - Thing"] = 490,
    ["scikit-build"] = 670,
    ["secrethub.yml"] = 740,
    ["semantic-release"] = 493,
    ["servicehub.config.json"] = 595,
    ["servicehub.service.json"] = 594,
    ["settings.job"] = 496,
    ["sfdx-hardis configuration"] = 499,
    ["size-limit configuration"] = 503,
    ["skaffold.yaml"] = 660,
    ["skyuxconfig.json"] = 505,
    snapcraft = 506,
    ["sqlc configuration"] = 514,
    ["stripe-app-local.json"] = 522,
    ["stripe-app.json"] = 521,
    swcrc = 647,
    syntax = 742,
    ["task.json"] = 528,
    taskcat = 615,
    ["template.json"] = 531,
    ["templatsources.json"] = 532,
    ["theme.json"] = 535,
    ["tizen_workspace.json"] = 536,
    tldr = 537,
    tmuxinator = 603,
    ["transcend.yml"] = 544,
    ["trunk.yaml"] = 545,
    ["ts-force-config.json"] = 549,
    ["tsconfig.json"] = 546,
    ["tsd.json"] = 547,
    ["tsdrc.json"] = 548,
    ["tslint.json"] = 550,
    ...
    ["vega-lite.json"] = 564,
    ["vega.json"] = 563,
    ["venvironment-basic.yaml"] = 567,
    ["venvironment.yaml"] = 566,
    ["version.json"] = 568,
    ["vim-addon-info"] = 569,
    ["vs-2017.3.host.json"] = 571,
    ["vs-nesting.json"] = 572,
    ["vsls.json"] = 570,
    ["vss-extension.json"] = 576,
    ["vtesttree.yaml"] = 577,
    ["vtestunit.yaml"] = 578,
    ["warp-keysets.json"] = 746,
    ["warp-themes.json"] = 747,
    ["warp-workflows.json"] = 748,
    ["webhint.io"] = 699,
    ["webjobpublishsettings.json"] = 584,
    ["webjobs-list.json"] = 583,
    ["xs-app.json"] = 611,
    ["xunit.runner.json"] = 593,
    yamllint = 635,
    zuul = 620,
    ["Žinoma"] = 629
  },
