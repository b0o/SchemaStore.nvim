...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 157,
    [".cryproj (generic)"] = 528,
    [".cryproj engine-5.2"] = 523,
    [".cryproj engine-5.3"] = 524,
    [".cryproj engine-5.4"] = 525,
    [".cryproj engine-5.5"] = 526,
    [".cryproj engine-dev"] = 527,
    [".csscomb.json"] = 159,
    [".csslintrc"] = 160,
    [".eslintrc"] = 205,
    [".esmrc.json"] = 197,
    ...
    [".mtaext"] = 537,
    [".nodehawkrc"] = 335,
    [".npmpackagejsonlintrc"] = 338,
    [".phraseapp.yml"] = 373,
    [".pmbot.yml"] = 365,
    [".postcssrc"] = 370,
    [".pre-commit-config.yml"] = 371,
    [".pre-commit-hooks.yml"] = 372,
    [".putout.json"] = 390,
    [".rehyperc"] = 399,
    [".remarkrc"] = 400,
    [".sprite files"] = 447,
    ...
    [".vsext"] = 503,
    [".yarnrc.yml"] = 569,
    ["<div>RIOTS' studio configuration"] = 507,
    ["@factorial/drupal-breakpoints-css"] = 5,
    ["A micro editor config schema"] = 300,
    ["API Builder"] = 566,
    ["AVA Configuration Schema"] = 622,
    ["AWS CDK cdk.json"] = 142,
    ["AWS CloudFormation"] = 143,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 144,
    ["Airlock Microgateway"] = 9,
    ["Airplane task"] = 10,
    ["Alacritty Configuration Schema"] = 597,
    ["All Contributors configuration file"] = 649,
    ...
    ["Azure Pipelines"] = 48,
    ["Azure Static Web Apps CLI configuration file"] = 449,
    ["Azure Static Web Apps configuration file"] = 448,
    ["BX CI"] = 83,
    ["Better Code Hub"] = 571,
    ["Better Scripts"] = 84,
    BizTalkServerApplicationSchema = 543,
    ...
    ["Butane Config"] = 609,
    ["CICS TS region tagging"] = 616,
    ["CICS TS resource import"] = 617,
    ["CICS TS resource model"] = 618,
    ["CICS TS resource overrides"] = 619,
    ["CMake Presets"] = 85,
    ...
    ["Datadog Service Definition"] = 283,
    ["Datahub Ingestion Recipe Schema"] = 623,
    ...
    ["Embrace Config Schema"] = 634,
    ["Error pages"] = 200,
    Esquio = 198,
    ["Estuary Flow Catalog Schema"] = 613,
    ["Expo SDK"] = 203,
    ...
    Goreleaser = 232,
    ["Goreleaser Pro"] = 233,
    ["Gradle Build Cache Node"] = 568,
    ["Gradle Enterprise"] = 567,
    ...
    Hadolint = 552,
    Hammerkit = 578,
    ["Hardware Sentry Configuration"] = 627,
    Hayson = 245,
    ...
    Hugo = 605,
    ["IMG Catapult PSP"] = 256,
    ["Istanbul Schema"] = 630,
    ["JDownloader2 crawler multi-rule schema"] = 266,
    ["JDownloader2 crawler single-rule schema"] = 265,
    ["JFrog File Spec"] = 267,
    ["JFrog Pipelines YML DSL"] = 636,
    ["JMeter DSL cli config schema"] = 268,
    ["JSON Document Transform"] = 276,
    ["JSON Feed"] = 277,
    ["JSON Resume"] = 406,
    ["JSON Schema Draft 2020-12"] = 519,
    ["JSON Schema Draft 4"] = 516,
    ["JSON Schema Draft 7"] = 517,
    ["JSON Schema Draft 8"] = 518,
    ...
    ["JSON-API"] = 275,
    ["JSON-e templates"] = 576,
    ["JSON-stat 2.0"] = 513,
    JSONPatch = 279,
    Jasmine = 261,
    Jekyll = 262,
    ["Jenkins X Pipelines"] = 263,
    ["Jenkins X Requirements"] = 264,
    ["Jovo Language Models"] = 269,
    ["KSP-AVC"] = 514,
    ["KSP-CKAN"] = 515,
    ["Keycloak REST API"] = 642,
    ["Knative Functions - func.yaml"] = 215,
    ["KoDE/CI build.yaml"] = 632,
    ["Kong DBLess Schema"] = 633,
    KrakenD = 282,
    ["LinkML Metamodel"] = 295,
    Liquibase = 583,
    ["Liquibase Flow File"] = 584,
    ["Lively Properties"] = 296,
    Markdownlint = 587,
    ["MegaLinter configuration"] = 301,
    ["MegaLinter descriptor"] = 302,
    ["Meltano plugin discovery definition"] = 304,
    ["Meltano project definition"] = 303,
    ["Microsoft Band Web Tile"] = 305,
    ["Minecraft Data Pack Advancement"] = 307,
    ["Minecraft Data Pack Biome"] = 308,
    ["Minecraft Data Pack Configured Carver"] = 309,
    ["Minecraft Data Pack Damage Type"] = 310,
    ["Minecraft Data Pack Dimension"] = 312,
    ["Minecraft Data Pack Dimension Type"] = 311,
    ["Minecraft Data Pack Item Modifier"] = 313,
    ["Minecraft Data Pack Loot Table"] = 314,
    ["Minecraft Data Pack Metadata"] = 315,
    ["Minecraft Data Pack Predicate"] = 316,
    ["Minecraft Data Pack Recipe"] = 317,
    ["Minecraft Data Pack Tag"] = 318,
    ["Minecraft Data Pack Template Pool"] = 319,
    ["Minecraft Resource Pack Lang"] = 320,
    ["Minecraft Resource Pack Particle"] = 321,
    ["Minecraft Resource Pack Texture Mcmeta"] = 323,
    ["Minecraft Resourcepack Sounds"] = 322,
    ["MkDocs Configuration 1.0"] = 324,
    ["MongoDB Atlas Search Index Definition Schema"] = 631,
    ["Monika Configuration Schema"] = 629,
    ["Motif config"] = 536,
    ["NOX Framework (Service)"] = 337,
    ["Netin Diagnostic System Template"] = 592,
    ["Netlify config schema"] = 329,
    ["Nightwatch.js"] = 330,
    ["OSS Review Toolkit configuration"] = 355,
    ["OSS Review Toolkit curation"] = 356,
    ["OSS Review Toolkit package configuration"] = 357,
    ["OSS Review Toolkit repository configuration"] = 358,
    ["OSS Review Toolkit resolutions"] = 359,
    Opctl = 539,
    ["OpenRewrite Resource"] = 350,
    ["OpenWeather Current Weather API"] = 575,
    ["OpenWeather Road Risk API"] = 574,
    ["Ory Hydra configuration"] = 251,
    ["Ory Keto configuration"] = 284,
    ["Ory Kratos configuration"] = 354,
    ["Ory Oathkeeper configuration"] = 344,
    ["Outblocks App configuration"] = 352,
    ["Outblocks database table"] = 353,
    ["Outblocks project configuration"] = 351,
    Packer = 362,
    Pantsbuild = 648,
    ["Pipeline component"] = 585,
    ["PocketMine plugin.yml"] = 366,
    Pterodactyl = 626,
    ["Pull Request Labeler"] = 389,
    Pulumi = 394,
    PyProject = 395,
    Qodana = 602,
    ["Quali Torque Blueprint Spec 2"] = 624,
    ["QueryFirst config file"] = 645,
    ["RKE Cluster Configuration JSON Schema"] = 582,
    ["RKE Cluster Configuration YAML Schema"] = 581,
    ["Rancher Fleet"] = 392,
    Ray = 551,
    ["Read the Docs"] = 393,
    ["Red-DiscordBot Cog"] = 396,
    ["Red-DiscordBot Cog Repo"] = 397,
    ["Red-DiscordBot Trivia"] = 398,
    Renovate = 407,
    ["Replit schema"] = 401,
    RoadRunner = 408,
    Ruff = 404,
    ["Rust Project"] = 405,
    ["Rust toolchain"] = 410,
    ["SIL Kit Participant Configuration"] = 436,
    SWADL = 458,
    ["Sapphire CLI Config"] = 411,
    ["SauceCTL Configuration"] = 589,
    ["Schema Catalog"] = 424,
    ["Scoop manifest"] = 429,
    ["Semgrep Rule"] = 431,
    ["Serenity Code Generator (Sergen)"] = 432,
    ["Serverless Framework Configuration"] = 596,
    ["Serverless Workflow Schema"] = 598,
    ["Settings.paf"] = 434,
    ["Shopware 6 Configuration"] = 599,
    ["Shopware CLI Extension Store Configuration"] = 600,
    ["Shopware CLI Project Store Configuration"] = 601,
    ["Slack app manifest"] = 438,
    Solidarity = 441,
    ["Solution filters"] = 442,
    ["Source Maps v3"] = 443,
    Sourcery = 444,
    SpecIF = 445,
    ["Sponge Mixin configuration"] = 446,
    ["StackHawk Scanner Configuration"] = 595,
    Stale = 450,
    Starship = 451,
    ["Statamic Blueprint"] = 452,
    ["StrmPrivacy Data Connector"] = 640,
    ["StrmPrivacy Data Contract"] = 641,
    ["StrmPrivacy SimpleSchema"] = 638,
    ["StrmPrivacy Stream"] = 639,
    ["StrmPrivacy batch job configuration file"] = 637,
    ["Stryker Mutator"] = 455,
    ["StyleCop Analyzers Configuration"] = 456,
    ["Swagger API 2.0"] = 459,
    TSON = 481,
    ["Talisman configuration"] = 460,
    ["Taskfile YAML Schema"] = 577,
    Taurus = 461,
    ["TestEnvironment.json"] = 469,
    ["Tier.run pricing.json"] = 464,
    Tikibase = 465,
    ["Traefik v2"] = 472,
    ["Traefik v2 File Provider"] = 473,
    Turborepo = 470,
    Tye = 603,
    ["UI5 Manifest"] = 488,
    ["UTAM Page Object"] = 491,
    ["Ubuntu Server Autoinstall"] = 486,
    ["Uniswap Token List"] = 560,
    ["Unreal Engine Uplugin"] = 646,
    ["Unreal Engine Uproject"] = 647,
    Updatecli = 610,
    Uplift = 644,
    ["User Journey Map YAML Schema"] = 580,
    V2Ray = 614,
    ["VSCode Code Snippets"] = 130,
    ["VSIX CLI publishing"] = 504,
    ["Vela Pipeline Configuration"] = 494,
    Vercel = 129,
    ["Web App Manifest"] = 509,
    ["Web types"] = 512,
    WebExtensions = 508,
    ["Webman package recipe"] = 620,
    ["Windows Package Manager Installer Manifest"] = 557,
    ["Windows Package Manager Locale Manifest"] = 558,
    ["Windows Package Manager Singleton Manifest"] = 556,
    ["Woodpecker pipeline config"] = 591,
    ["Xstate Machine Schema"] = 608,
    ["Yippee-Ki-JSON configuration YML"] = 562,
    ["angular.json"] = 11,
    ...
    ["ide.host.json"] = 252,
    ["ifstate.conf"] = 253,
    ["imageoptimizer.json"] = 254,
    ["importmap.json"] = 257,
    ["ioBroker Configuration"] = 258,
    ["ioBroker JSON UI"] = 259,
    ["ioBroker Package manifest"] = 260,
    ["ize.toml"] = 643,
    ["jsconfig.json"] = 280,
    ["jscpd Configuration Schema"] = 625,
    jsdoc = 550,
    ["k3d.yaml"] = 281,
    ["kontinuous-values.yaml"] = 285,
    ["kustomization.yaml"] = 286,
    ["label-commenter-config.yml"] = 287,
    ["launchsettings.json"] = 288,
    ["lego.json"] = 289,
    ["lerna.json"] = 290,
    ["lgtm.yml"] = 291,
    ["libman.json"] = 292,
    ["license-report-config.json"] = 293,
    ["linkinator.config.json"] = 294,
    ["local.settings.json"] = 297,
    ["localazy.json"] = 298,
    ["lsdlschema.json"] = 299,
    ["markdown-lint-check"] = 588,
    mboats = 594,
    ["mimetypes.json"] = 306,
    ["mirrord-schema"] = 533,
    ["mta.yaml"] = 534,
    ["mtad.yaml"] = 535,
    ["mycode.json"] = 327,
    ["napari plugin manifest"] = 328,
    neoload = 545,
    ["nest-cli"] = 333,
    ["ninjs (News in JSON) 1.3"] = 332,
    ["ninjs (News in JSON) 2.0"] = 331,
    ["nlu.json"] = 334,
    ["nodemon.json"] = 336,
    ["noodl.schema.json"] = 593,
    now = 541,
    ["npm-badges"] = 339,
    ["nswag.json"] = 342,
    ntangle = 343,
    ["nuclei-template.yaml"] = 340,
    ["nuget-project.json"] = 341,
    ["ocelot.json"] = 345,
    ["omnisharp.json"] = 346,
    ["openapi.json"] = 347,
    ["openfin.json"] = 349,
    ["openrpc.json"] = 348,
    ["package.json"] = 360,
    ["package.manifest"] = 361,
    ["pattern.json"] = 364,
    ["petstore-v1.0"] = 635,
    pgap_yaml_input_reader = 363,
    ["plagiarize-me.yaml"] = 368,
    ["plagiarize.yaml"] = 367,
    ["portman.json"] = 369,
    ["prettierrc.json"] = 374,
    ["prisma.yml"] = 375,
    ["project-1.0.0-beta3.json"] = 377,
    ["project-1.0.0-beta4.json"] = 378,
    ["project-1.0.0-beta5.json"] = 379,
    ["project-1.0.0-beta6.json"] = 380,
    ["project-1.0.0-beta8.json"] = 381,
    ["project-1.0.0-rc1.json"] = 382,
    ["project-1.0.0-rc2.json"] = 383,
    ["project.json"] = 376,
    ["prometheus.json"] = 384,
    ["prometheus.rules.json"] = 385,
    ["proxies.json"] = 386,
    ["publiccode.yml"] = 387,
    ["pubspec.yaml"] = 388,
    ["pyrseas-0.8.json"] = 391,
    ["release drafter"] = 546,
    rtx = 403,
    rustfmt = 409,
    ["sarif-1.0.0.json"] = 412,
    ["sarif-2.0.0.json"] = 413,
    ["sarif-2.1.0"] = 422,
    ["sarif-2.1.0-rtm.2"] = 414,
    ["sarif-2.1.0-rtm.3"] = 416,
    ["sarif-2.1.0-rtm.4"] = 418,
    ["sarif-2.1.0-rtm.5"] = 420,
    ["sarif-external-property-file-2.1.0"] = 423,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 415,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 417,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 419,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 421,
    ["schema.org - Action"] = 425,
    ["schema.org - ContactPoint"] = 426,
    ["schema.org - Place"] = 427,
    ["schema.org - Thing"] = 428,
    ["semantic-release"] = 430,
    ["servicehub.config.json"] = 522,
    ["servicehub.service.json"] = 521,
    ["settings.job"] = 433,
    ["sfdx-hardis configuration"] = 435,
    ["size-limit configuration"] = 437,
    ["skaffold.yaml"] = 586,
    ["skyuxconfig.json"] = 439,
    snapcraft = 440,
    ["stripe-app-local.json"] = 454,
    ["stripe-app.json"] = 453,
    swcrc = 573,
    taskcat = 542,
    ["template.json"] = 462,
    ["templatsources.json"] = 463,
    ["theme.json"] = 466,
    ["tizen_workspace.json"] = 467,
    tmLanguage = 468,
    tmuxinator = 530,
    ["transcend.yml"] = 474,
    ["trunk.yaml schema"] = 475,
    ["ts-force-config.json"] = 479,
    ["tsconfig.json"] = 476,
    ["tsd.json"] = 477,
    ["tsdrc.json"] = 478,
    ["tslint.json"] = 480,
    ...
    ["vega-lite.json"] = 493,
    ["vega.json"] = 492,
    ["venvironment-basic.yaml"] = 496,
    ["venvironment.yaml"] = 495,
    ["version.json"] = 497,
    ["vim-addon-info"] = 498,
    ["vs-2017.3.host.json"] = 500,
    ["vs-nesting.json"] = 501,
    ["vsls.json"] = 499,
    ["vss-extension.json"] = 505,
    ["webhint.io"] = 621,
    ["webjobpublishsettings.json"] = 511,
    ["webjobs-list.json"] = 510,
    ["xs-app.json"] = 538,
    ["xunit.runner.json"] = 520,
    yamllint = 561,
    zuul = 547,
    ["Žinoma"] = 555
  },
