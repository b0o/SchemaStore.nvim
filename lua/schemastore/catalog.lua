...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 152,
    [".cryproj (generic)"] = 508,
    [".cryproj engine-5.2"] = 503,
    [".cryproj engine-5.3"] = 504,
    [".cryproj engine-5.4"] = 505,
    [".cryproj engine-5.5"] = 506,
    [".cryproj engine-dev"] = 507,
    [".csscomb.json"] = 154,
    [".csslintrc"] = 155,
    [".eslintrc"] = 200,
    [".esmrc.json"] = 192,
    ...
    [".mtaext"] = 517,
    [".nodehawkrc"] = 321,
    [".npmpackagejsonlintrc"] = 324,
    [".phraseapp.yml"] = 359,
    [".pmbot.yml"] = 351,
    [".postcssrc"] = 356,
    [".pre-commit-config.yml"] = 357,
    [".pre-commit-hooks.yml"] = 358,
    [".putout.json"] = 376,
    [".rehyperc"] = 384,
    [".remarkrc"] = 385,
    [".sprite files"] = 428,
    ...
    [".vsext"] = 483,
    [".yarnrc.yml"] = 549,
    ["<div>RIOTS' studio configuration"] = 487,
    ["@factorial/drupal-breakpoints-css"] = 5,
    ["A micro editor config schema"] = 290,
    ["API Builder"] = 546,
    ["AVA Configuration Schema"] = 602,
    ["AWS CDK cdk.json"] = 140,
    ["AWS CloudFormation"] = 141,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 142,
    ["Airlock Microgateway"] = 9,
    ["Airplane task"] = 10,
    ["Alacritty Configuration Schema"] = 577,
    ["All Contributors configuration file"] = 629,
    ...
    ["Azure Pipelines"] = 47,
    ["Azure Static Web Apps CLI configuration file"] = 430,
    ["Azure Static Web Apps configuration file"] = 429,
    ["BX CI"] = 82,
    ["Better Code Hub"] = 551,
    ["Better Scripts"] = 83,
    BizTalkServerApplicationSchema = 523,
    ...
    ["Butane Config"] = 589,
    ["CICS TS region tagging"] = 596,
    ["CICS TS resource import"] = 597,
    ["CICS TS resource model"] = 598,
    ["CICS TS resource overrides"] = 599,
    ["CMake Presets"] = 84,
    ...
    ["Datahub Ingestion Recipe Schema"] = 603,
    ...
    ["Embrace Config Schema"] = 614,
    ["Error pages"] = 195,
    Esquio = 193,
    ["Estuary Flow Catalog Schema"] = 593,
    ["Expo SDK"] = 198,
    ...
    Goreleaser = 226,
    ["Goreleaser Pro"] = 227,
    ["Gradle Build Cache Node"] = 548,
    ["Gradle Enterprise"] = 547,
    ...
    Hadolint = 532,
    Hammerkit = 558,
    ["Hardware Sentry Configuration"] = 607,
    Hayson = 239,
    ...
    ["JFrog File Spec"] = 259,
    ["JFrog Pipelines YML DSL"] = 616,
    ["JSON Document Transform"] = 267,
    ["JSON Feed"] = 268,
    ["JSON Resume"] = 390,
    ["JSON Schema Draft 2020-12"] = 499,
    ["JSON Schema Draft 4"] = 496,
    ["JSON Schema Draft 7"] = 497,
    ["JSON Schema Draft 8"] = 498,
    ...
    ["KSP-AVC"] = 494,
    ["KSP-CKAN"] = 495,
    ["Keycloak REST API"] = 622,
    ["Knative Functions - func.yaml"] = 210,
    ["KoDE/CI build.yaml"] = 612,
    ["Kong DBLess Schema"] = 613,
    KrakenD = 273,
    ["LinkML Metamodel"] = 285,
    Liquibase = 563,
    ["Liquibase Flow File"] = 564,
    ["Lively Properties"] = 286,
    Markdownlint = 567,
    ["MegaLinter configuration"] = 291,
    ["MegaLinter descriptor"] = 292,
    ["Meltano plugin discovery definition"] = 294,
    ["Meltano project definition"] = 293,
    ["Microsoft Band Web Tile"] = 295,
    ["Minecraft Data Pack Advancement"] = 297,
    ["Minecraft Data Pack Biome"] = 298,
    ["Minecraft Data Pack Configured Carver"] = 299,
    ["Minecraft Data Pack Dimension"] = 301,
    ["Minecraft Data Pack Dimension Type"] = 300,
    ["Minecraft Data Pack Item Modifier"] = 302,
    ["Minecraft Data Pack Loot Table"] = 303,
    ["Minecraft Data Pack Metadata"] = 304,
    ["Minecraft Data Pack Predicate"] = 305,
    ["Minecraft Data Pack Recipe"] = 306,
    ["Minecraft Data Pack Tag"] = 307,
    ["Minecraft Data Pack Template Pool"] = 308,
    ["Minecraft Resourcepack Sounds"] = 309,
    ["MkDocs Configuration 1.0"] = 310,
    ["MongoDB Atlas Search Index Definition Schema"] = 611,
    ["Monika Configuration Schema"] = 609,
    ["Motif config"] = 516,
    ["NOX Framework (Service)"] = 323,
    ["Netin Diagnostic System Template"] = 572,
    ["Netlify config schema"] = 315,
    ["Nightwatch.js"] = 316,
    ["OSS Review Toolkit configuration"] = 341,
    ["OSS Review Toolkit curation"] = 342,
    ["OSS Review Toolkit package configuration"] = 343,
    ["OSS Review Toolkit repository configuration"] = 344,
    ["OSS Review Toolkit resolutions"] = 345,
    Opctl = 519,
    ["OpenRewrite Resource"] = 336,
    ["OpenWeather Current Weather API"] = 555,
    ["OpenWeather Road Risk API"] = 554,
    ["Ory Hydra configuration"] = 245,
    ["Ory Keto configuration"] = 275,
    ["Ory Kratos configuration"] = 340,
    ["Ory Oathkeeper configuration"] = 330,
    ["Outblocks App configuration"] = 338,
    ["Outblocks database table"] = 339,
    ["Outblocks project configuration"] = 337,
    Packer = 348,
    Pantsbuild = 628,
    ["Pipeline component"] = 565,
    ["PocketMine plugin.yml"] = 352,
    Pterodactyl = 606,
    ["Pull Request Labeler"] = 375,
    Pulumi = 380,
    PyProject = 381,
    Qodana = 582,
    ["Quali Torque Blueprint Spec 2"] = 604,
    ["QueryFirst config file"] = 625,
    ["RKE Cluster Configuration JSON Schema"] = 562,
    ["RKE Cluster Configuration YAML Schema"] = 561,
    ["Rancher Fleet"] = 378,
    Ray = 531,
    ["Read the Docs"] = 379,
    ["Red-DiscordBot Cog"] = 382,
    ["Red-DiscordBot Cog Repo"] = 383,
    Renovate = 391,
    ["Replit schema"] = 386,
    RoadRunner = 392,
    Ruff = 388,
    ["Rust Project"] = 389,
    ["Rust toolchain"] = 394,
    ["SIL Kit Participant Configuration"] = 419,
    SWADL = 439,
    ["Sapphire CLI Config"] = 395,
    ["SauceCTL Configuration"] = 569,
    ["Schema Catalog"] = 408,
    ["Scoop manifest"] = 413,
    ["Semgrep Rule"] = 415,
    ["Serverless Framework Configuration"] = 576,
    ["Serverless Workflow Schema"] = 578,
    ["Settings.paf"] = 417,
    ["Shopware 6 Configuration"] = 579,
    ["Shopware CLI Extension Store Configuration"] = 580,
    ["Shopware CLI Project Store Configuration"] = 581,
    Solidarity = 423,
    ["Solution filters"] = 424,
    ["Source Maps v3"] = 425,
    SpecIF = 426,
    ["Sponge Mixin configuration"] = 427,
    ["StackHawk Scanner Configuration"] = 575,
    Stale = 431,
    Starship = 432,
    ["Statamic Blueprint"] = 433,
    ["StrmPrivacy Data Connector"] = 620,
    ["StrmPrivacy Data Contract"] = 621,
    ["StrmPrivacy SimpleSchema"] = 618,
    ["StrmPrivacy Stream"] = 619,
    ["StrmPrivacy batch job configuration file"] = 617,
    ["Stryker Mutator"] = 436,
    ["StyleCop Analyzers Configuration"] = 437,
    ["Swagger API 2.0"] = 440,
    TSON = 461,
    ["Talisman configuration"] = 441,
    ["Taskfile YAML Schema"] = 557,
    Taurus = 442,
    ["TestEnvironment.json"] = 450,
    ["Tier.run pricing.json"] = 445,
    Tikibase = 446,
    ["Traefik v2"] = 453,
    ["Traefik v2 File Provider"] = 454,
    Turborepo = 451,
    Tye = 583,
    ["UI5 Manifest"] = 468,
    ["UTAM Page Object"] = 471,
    ["Ubuntu Server Autoinstall"] = 466,
    ["Uniswap Token List"] = 540,
    ["Unreal Engine Uplugin"] = 626,
    ["Unreal Engine Uproject"] = 627,
    Updatecli = 590,
    Uplift = 624,
    ["User Journey Map YAML Schema"] = 560,
    V2Ray = 594,
    ["VSCode Code Snippets"] = 128,
    ["VSIX CLI publishing"] = 484,
    ["Vela Pipeline Configuration"] = 474,
    Vercel = 127,
    ["Web App Manifest"] = 489,
    ["Web types"] = 492,
    WebExtensions = 488,
    ["Webman package recipe"] = 600,
    ["Windows Package Manager Installer Manifest"] = 537,
    ["Windows Package Manager Locale Manifest"] = 538,
    ["Windows Package Manager Singleton Manifest"] = 536,
    ["Woodpecker pipeline config"] = 571,
    ["Xstate Machine Schema"] = 588,
    ["Yippee-Ki-JSON configuration YML"] = 542,
    ["angular.json"] = 11,
    ...
    ["ize.toml"] = 623,
    ["jsconfig.json"] = 271,
    ["jscpd Configuration Schema"] = 605,
    jsdoc = 530,
    ["k3d.yaml"] = 272,
    ["kustomization.yaml"] = 276,
    ["label-commenter-config.yml"] = 277,
    ["launchsettings.json"] = 278,
    ["lego.json"] = 279,
    ["lerna.json"] = 280,
    ["lgtm.yml"] = 281,
    ["libman.json"] = 282,
    ["license-report-config.json"] = 283,
    ["linkinator.config.json"] = 284,
    ["local.settings.json"] = 287,
    ["localazy.json"] = 288,
    ["lsdlschema.json"] = 289,
    ["markdown-lint-check"] = 568,
    mboats = 574,
    ["mimetypes.json"] = 296,
    ["mirrord-schema"] = 513,
    ["mta.yaml"] = 514,
    ["mtad.yaml"] = 515,
    ["mycode.json"] = 313,
    ["napari plugin manifest"] = 314,
    neoload = 525,
    ["nest-cli"] = 319,
    ["ninjs (News in JSON) 1.3"] = 318,
    ["ninjs (News in JSON) 2.0"] = 317,
    ["nlu.json"] = 320,
    ["nodemon.json"] = 322,
    ["noodl.schema.json"] = 573,
    now = 521,
    ["npm-badges"] = 325,
    ["nswag.json"] = 328,
    ntangle = 329,
    ["nuclei-template.yaml"] = 326,
    ["nuget-project.json"] = 327,
    ["ocelot.json"] = 331,
    ["omnisharp.json"] = 332,
    ["openapi.json"] = 333,
    ["openfin.json"] = 335,
    ["openrpc.json"] = 334,
    ["package.json"] = 346,
    ["package.manifest"] = 347,
    ["pattern.json"] = 350,
    ["petstore-v1.0"] = 615,
    pgap_yaml_input_reader = 349,
    ["plagiarize-me.yaml"] = 354,
    ["plagiarize.yaml"] = 353,
    ["portman.json"] = 355,
    ["prettierrc.json"] = 360,
    ["prisma.yml"] = 361,
    ["project-1.0.0-beta3.json"] = 363,
    ["project-1.0.0-beta4.json"] = 364,
    ["project-1.0.0-beta5.json"] = 365,
    ["project-1.0.0-beta6.json"] = 366,
    ["project-1.0.0-beta8.json"] = 367,
    ["project-1.0.0-rc1.json"] = 368,
    ["project-1.0.0-rc2.json"] = 369,
    ["project.json"] = 362,
    ["prometheus.json"] = 370,
    ["prometheus.rules.json"] = 371,
    ["proxies.json"] = 372,
    ["publiccode.yml"] = 373,
    ["pubspec.yaml"] = 374,
    ["pyrseas-0.8.json"] = 377,
    ["release drafter"] = 526,
    rustfmt = 393,
    ["sarif-1.0.0.json"] = 396,
    ["sarif-2.0.0.json"] = 397,
    ["sarif-2.1.0"] = 406,
    ["sarif-2.1.0-rtm.2"] = 398,
    ["sarif-2.1.0-rtm.3"] = 400,
    ["sarif-2.1.0-rtm.4"] = 402,
    ["sarif-2.1.0-rtm.5"] = 404,
    ["sarif-external-property-file-2.1.0"] = 407,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 399,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 401,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 403,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 405,
    ["schema.org - Action"] = 409,
    ["schema.org - ContactPoint"] = 410,
    ["schema.org - Place"] = 411,
    ["schema.org - Thing"] = 412,
    ["semantic-release"] = 414,
    ["servicehub.config.json"] = 502,
    ["servicehub.service.json"] = 501,
    ["settings.job"] = 416,
    ["sfdx-hardis configuration"] = 418,
    ["size-limit configuration"] = 420,
    ["skaffold.yaml"] = 566,
    ["skyuxconfig.json"] = 421,
    snapcraft = 422,
    ["stripe-app-local.json"] = 435,
    ["stripe-app.json"] = 434,
    swcrc = 553,
    taskcat = 522,
    ["template.json"] = 443,
    ["templatsources.json"] = 444,
    ["theme.json"] = 447,
    ["tizen_workspace.json"] = 448,
    tmLanguage = 449,
    tmuxinator = 510,
    ["trunk.yaml schema"] = 455,
    ["ts-force-config.json"] = 459,
    ["tsconfig.json"] = 456,
    ["tsd.json"] = 457,
    ["tsdrc.json"] = 458,
    ["tslint.json"] = 460,
    ...
    ["vega-lite.json"] = 473,
    ["vega.json"] = 472,
    ["venvironment-basic.yaml"] = 476,
    ["venvironment.yaml"] = 475,
    ["version.json"] = 477,
    ["vim-addon-info"] = 478,
    ["vs-2017.3.host.json"] = 480,
    ["vs-nesting.json"] = 481,
    ["vsls.json"] = 479,
    ["vss-extension.json"] = 485,
    ["webhint.io"] = 601,
    ["webjobpublishsettings.json"] = 491,
    ["webjobs-list.json"] = 490,
    ["xs-app.json"] = 518,
    ["xunit.runner.json"] = 500,
    yamllint = 541,
    zuul = 527,
    ["Žinoma"] = 535
  },
