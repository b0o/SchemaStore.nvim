...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 198,
    [".cryproj (generic)"] = 671,
    [".cryproj engine-5.2"] = 666,
    [".cryproj engine-5.3"] = 667,
    [".cryproj engine-5.4"] = 668,
    [".cryproj engine-5.5"] = 669,
    [".cryproj engine-dev"] = 670,
    [".eslintrc"] = 254,
    [".esmrc.json"] = 246,
    [".ffizer.yaml"] = 258,
    [".htmlhintrc"] = 314,
    ...
    [".mtaext"] = 682,
    [".nodehawkrc"] = 425,
    [".npmpackagejsonlintrc"] = 429,
    [".omletrc"] = 857,
    [".phrase.yml"] = 475,
    [".phraseapp.yml"] = 476,
    [".pmbot.yml"] = 465,
    [".postcssrc"] = 470,
    [".powerpages-web-template-manifest"] = 472,
    [".pre-commit-config.yml"] = 473,
    [".pre-commit-hooks.yml"] = 474,
    [".putout.json"] = 495,
    [".rehyperc"] = 514,
    [".remarkrc"] = 516,
    [".sprite files"] = 574,
    ...
    ["<div>RIOTS' studio configuration"] = 649,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 379,
    ABCSupplyPlan = 13,
    AIConfig = 14,
    ["API Builder"] = 714,
    ["AVA Configuration"] = 774,
    ["AWS CDK cdk.json"] = 182,
    ["AWS CloudFormation"] = 183,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 184,
    ["AWS SAM CLI Samconfig"] = 185,
    ["Adobe UXP Manifest"] = 839,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 15,
    ["Airplane task"] = 16,
    ["Alacritty Configuration"] = 746,
    ["All Contributors configuration file"] = 804,
    ...
    ["Azure Pipelines"] = 68,
    ["Azure Static Web Apps CLI configuration file"] = 577,
    ["Azure Static Web Apps configuration file"] = 576,
    ["BX CI"] = 106,
    ["Bashly (bashly.yml)"] = 808,
    ["Bashly Settings (bashly-settings.yml)"] = 809,
    ["Better Code Hub"] = 718,
    ["Better Scripts"] = 107,
    Bigconfig = 85,
    BizTalkServerApplicationSchema = 688,
    Bleep = 108,
    ...
    ["Butane Config"] = 759,
    ["CGS Custom Card Game (CardGameDef.json)"] = 844,
    ["CICS TS region tagging"] = 768,
    ["CICS TS resource import"] = 769,
    ["CICS TS resource model"] = 770,
    ["CICS TS resource overrides"] = 771,
    ["CMake Presets"] = 109,
    ["CNC Codes"] = 121,
    ["CSS Comb (.csscomb.json)"] = 200,
    ["CSS Lint (.csslintrc)"] = 201,
    ["CSpell (cspell.json)"] = 199,
    CWL = 850,
    ...
    Cheatsheets = 756,
    ["Chrome Extension"] = 175,
    ["Chromia Model"] = 116,
    ["CircleCI config.yml"] = 152,
    ["Citation File Format"] = 187,
    CityJSON = 118,
    ["Clawject config"] = 126,
    ["Cloud Foundry Application Manifest"] = 856,
    ["Code Climate"] = 153,
    CodeCV = 64,
    ["CodeShip Pro services configuration files"] = 164,
    ["CodeShip Pro steps configuration files"] = 165,
    ["Codecov configuration files"] = 163,
    Codux = 161,
    ["Cog config file"] = 122,
    ["Commandbox Box.json"] = 123,
    ["Commandbox Server.json"] = 124,
    ["Common Catalog Data"] = 173,
    Conjure = 120,
    ["Container Structure Test"] = 701,
    Containerlab = 726,
    ["Crowdsec collection config"] = 194,
    ["Crowdsec parser config"] = 195,
    ["Crowdsec scenario config"] = 196,
    ["CumulusCI Config"] = 125,
    ["Custom Machinery Machine"] = 845,
    ["Custom Machinery Recipe"] = 846,
    ["Cycle Stack File"] = 127,
    ["DWP Exchange - catalogue entry"] = 241,
    ["DWP Exchange - gateway"] = 239,
    ["DWP Exchange - meta"] = 240,
    ["Dart Build Config (dart-build.json)"] = 202,
    ["Dart Test Config (dart-test.json)"] = 203,
    ["DashLord Configuration"] = 204,
    ["Data Contract Specification"] = 205,
    ["Data Product Specification"] = 206,
    ["DataYoga Connections"] = 128,
    ["DataYoga Job"] = 129,
    ["Databricks Asset Bundles"] = 825,
    ["Datadog Service Definition"] = 356,
    ["Datahub Ingestion Recipe"] = 775,
    ["Dein Config"] = 131,
    ["Deno Config (deno.json)"] = 212,
    ["Dependency cruiser"] = 132,
    ["Deployer Recipe"] = 215,
    ["Deta Spacefile"] = 133,
    ["Detekt Config (detekt.yml)"] = 216,
    ["Devbox Config"] = 134,
    ["Devbox Plugin"] = 135,
    Devfile = 238,
    ["Discord Webhook"] = 217,
    ["DocFx Config (docfx.json)"] = 220,
    ["Dolittle Artifacts"] = 221,
    ["Dolittle Bounded Context Configuration"] = 222,
    ["Dolittle Event Horizons Configuration"] = 223,
    ["Dolittle Resources Configuration"] = 224,
    ["Dolittle Server Configuration"] = 225,
    ["Dolittle Tenant Map Configuration"] = 227,
    ["Dolittle Tenants Configuration"] = 226,
    ["Dolittle Topology"] = 228,
    ...
    ["Drupal Routing"] = 146,
    ["Drupal Services"] = 148,
    ["Drush site aliases"] = 234,
    ["Dynamic Bash Aliases (.aliases)"] = 816,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 805,
    ["Elgato Stream Deck"] = 244,
    ["Embrace Config"] = 786,
    Endurica = 829,
    ["Enterprise Contract Policy Spec"] = 245,
    ["Erda Pipeline"] = 852,
    ["Erda Runtime"] = 853,
    ["Error pages"] = 249,
    Esquio = 247,
    ["Estuary Flow Catalog"] = 765,
    ["Expo SDK"] = 252,
    ["F-Droid Data metadata"] = 257,
    ["Facets - FSDL - Application"] = 255,
    ["FasterCI Configuration"] = 69,
    FiQuS = 261,
    Firebase = 259,
    ["Flow.json Configurations"] = 849,
    ["Fossa configuration file"] = 268,
    ["Fossa's fossa-deps file"] = 269,
    ["Foundry VTT - Base package Manifest"] = 263,
    ["Foundry VTT - Module Manifest"] = 264,
    ["Foundry VTT - System Data Template"] = 267,
    ["Foundry VTT - System Manifest"] = 265,
    ["Foundry VTT - World Manifest"] = 266,
    ["Foxx Manifest"] = 70,
    ["Freifunk.de Community API"] = 73,
    ["Frogbot Config"] = 74,
    ["G2P Mapping Configuration"] = 273,
    ["GCP Blueprint Metadata"] = 276,
    Gaspar = 274,
    ["GatewayCore API Gateway"] = 275,
    ["GeoJSON.json latest"] = 763,
    GherKing = 767,
    ["GitHub Action"] = 281,
    ["GitHub Discussion"] = 282,
    ["GitHub Funding"] = 283,
    ["GitHub Issue Template configuration"] = 285,
    ["GitHub Issue Template forms"] = 284,
    ["GitHub Workflow"] = 286,
    ["GitHub Workflow Template Properties"] = 287,
    ["GitLab Agent for Kubernetes configuration"] = 841,
    GitVersion = 278,
    ["Gitea Issue Template configuration"] = 279,
    ["Gitea Issue Template forms"] = 280,
    ["Gitpod Configuration"] = 289,
    ["GlazeWM settings"] = 843,
    ["Global Privacy Control"] = 277,
    Goblet = 824,
    ["Golangci-lint Configuration"] = 291,
    ["Golangci-lint Custom Plugins Configuration"] = 292,
    ["Google Chrome Related Website Sets"] = 260,
    ["Google Cloud Workflows"] = 181,
    Goreleaser = 294,
    ["Goreleaser Pro"] = 295,
    Goss = 296,
    ["Gradle Build Cache Node"] = 716,
    ["Gradle Enterprise"] = 715,
    ["Grafana 5.x Dashboard"] = 297,
    ["GraphQL Code Generator"] = 301,
    ["GraphQL Config"] = 300,
    ["GraphQL Mesh"] = 299,
    ["Grunt JSHint task"] = 305,
    ["Grunt Watch task"] = 306,
    ["Grunt base task"] = 307,
    ["Grunt clean task"] = 303,
    ["Grunt copy task"] = 302,
    ["Grunt cssmin task"] = 304,
    HEMTT = 685,
    Hadolint = 697,
    Hammerkit = 725,
    ["Hardware Sentry Configuration"] = 779,
    Hatch = 698,
    Hayson = 309,
    ["Haystack Pipeline"] = 310,
    ["Hazelcast 5 Configuration"] = 311,
    ["Helm Chart.lock"] = 150,
    ["Helm Chart.yaml"] = 149,
    ["Helm Unittest Test Suite"] = 151,
    Hugo = 755,
    ["Hugo Theme"] = 754,
    ["Hyperfoil benchmark configuration"] = 316,
    ["IBM Zapp document"] = 317,
    ["IBM zCodeFormatSettings"] = 318,
    ["IMG Catapult PSP"] = 323,
    ["IVMS101 by CODE Protocol"] = 842,
    Istanbul = 782,
    ["JDownloader2 crawler multi-rules"] = 333,
    ["JDownloader2 crawler single-rules"] = 332,
    ["JFrog Applications Config"] = 334,
    ["JFrog File Spec"] = 335,
    ["JFrog Pipelines YML DSL"] = 788,
    ["JMeter DSL cli config"] = 336,
    JReleaser = 338,
    ["JSON Document Transform"] = 346,
    ["JSON Feed"] = 347,
    ["JSON Resume"] = 521,
    ["JSON Schema Draft 2020-12"] = 662,
    ["JSON Schema Draft 4"] = 659,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 826,
    ["JSON Schema Draft 7"] = 660,
    ["JSON Schema Draft 7 (unofficial strict)"] = 827,
    ["JSON Schema Draft 8 (2019-09)"] = 661,
    ["JSON-API"] = 345,
    ["JSON-WF"] = 855,
    ["JSON-e templates"] = 723,
    ["JSON-stat 2.0"] = 656,
    JSONPatch = 349,
    ["JSR Package Config (jsr.json)"] = 339,
    Jasmine = 328,
    Jekyll = 329,
    ["Jenkins X Pipelines"] = 330,
    ["Jenkins X Requirements"] = 331,
    ["Jovo Language Models"] = 337,
    ["KIMMDY config file"] = 354,
    ["KSP-AVC"] = 657,
    ["KSP-CKAN"] = 658,
    KSY = 854,
    ["Karakum configuration file"] = 270,
    Kas = 352,
    ["Keycloak REST API"] = 796,
    ["Knative Functions - func.yaml"] = 271,
    ["KoDE/CI build.yaml"] = 784,
    ["Kong DBLess config"] = 785,
    KrakenD = 355,
    LOOBin = 374,
    Lefthook = 363,
    ["Liferay client-extension.yaml"] = 370,
    ["LinkML Metamodel"] = 372,
    Liquibase = 731,
    ["Liquibase Flow File"] = 732,
    ["Lively Properties"] = 373,
    ["Lobe AI Agent"] = 66,
    Loki = 67,
    ["MLOS Configs"] = 408,
    ["MS2Rescore Configuration"] = 411,
    ["Madness (madness.yml)"] = 807,
    Markdownlint = 735,
    ["Mason Registry"] = 737,
    ["MegaLinter configuration"] = 380,
    ["MegaLinter descriptor"] = 381,
    Melange = 833,
    ["Meltano plugin discovery definition"] = 383,
    ["Meltano project definition"] = 382,
    ["Mergify Configuration"] = 412,
    ["MetricsHub Configuration"] = 384,
    ["MetricsHub Connector Configuration"] = 385,
    ["Micro Editor Syntax"] = 817,
    ["Microsoft Band Web Tile"] = 386,
    ["Minecraft Custom Main Menu Mod"] = 834,
    ["Minecraft Data Pack Advancement"] = 388,
    ["Minecraft Data Pack Biome"] = 389,
    ["Minecraft Data Pack Configured Carver"] = 390,
    ["Minecraft Data Pack Damage Type"] = 391,
    ["Minecraft Data Pack Dimension"] = 393,
    ["Minecraft Data Pack Dimension Type"] = 392,
    ["Minecraft Data Pack Item Modifier"] = 394,
    ["Minecraft Data Pack Loot Table"] = 395,
    ["Minecraft Data Pack Metadata"] = 396,
    ["Minecraft Data Pack Predicate"] = 397,
    ["Minecraft Data Pack Recipe"] = 398,
    ["Minecraft Data Pack Tag"] = 399,
    ["Minecraft Data Pack Template Pool"] = 400,
    ["Minecraft Data Pack Trim Material"] = 405,
    ["Minecraft Data Pack Trim Pattern"] = 406,
    ["Minecraft Resource Pack Lang"] = 401,
    ["Minecraft Resource Pack Particle"] = 402,
    ["Minecraft Resource Pack Texture Mcmeta"] = 404,
    ["Minecraft Resourcepack Sounds"] = 403,
    ["MkDocs Configuration 1.0"] = 407,
    ["Monade CLI Stack Configuration"] = 415,
    ["MongoDB Atlas Search Index Definition"] = 783,
    ["Monika Configuration"] = 781,
    ["Monoweave Configuration"] = 410,
    ["Motif config"] = 681,
    ["NOX Framework (Service)"] = 428,
    ["Netin Diagnostic System Template"] = 741,
    ["Netlify config"] = 418,
    ["Network-as-Code Data Model"] = 419,
    ["Nightwatch.js"] = 420,
    ["Nuitka.yaml"] = 847,
    ["ONe's changelog entry"] = 444,
    ["ONe's service descriptor"] = 443,
    ["OSS Review Toolkit configuration"] = 451,
    ["OSS Review Toolkit curation"] = 452,
    ["OSS Review Toolkit package configuration"] = 453,
    ["OSS Review Toolkit repository configuration"] = 454,
    ["OSS Review Toolkit resolutions"] = 455,
    Opctl = 684,
    ["OpenRewrite Resource"] = 446,
    ["OpenUtau character yaml"] = 440,
    ["OpenUtau ustx"] = 441,
    ["OpenWeather Current Weather API"] = 722,
    ["OpenWeather Road Risk API"] = 721,
    ["Ory Hydra configuration"] = 315,
    ["Ory Keto configuration"] = 357,
    ["Ory Kratos configuration"] = 450,
    ["Ory Oathkeeper configuration"] = 435,
    ["Outblocks App configuration"] = 448,
    ["Outblocks database table"] = 449,
    ["Outblocks project configuration"] = 447,
    PDM = 461,
    Packer = 458,
    Pantsbuild = 803,
    ["Paper paper-plugin.yml"] = 459,
    ["Pipeline component"] = 733,
    ["PocketMine plugin.yml"] = 466,
    ["Postman collection"] = 471,
    ["Problem object RFC9457"] = 831,
    ["Problem package generators"] = 479,
    Pterodactyl = 778,
    ["Pull Request Labeler"] = 494,
    Pulumi = 500,
    PyProject = 501,
    Pyright = 502,
    Qgoda = 503,
    Qodana = 751,
    ["Quali Torque Blueprint Spec 2"] = 776,
    ["QueryFirst config file"] = 799,
    ["RKE Cluster Configuration JSON"] = 730,
    ["RKE Cluster Configuration YAML"] = 729,
    ["Rancher Fleet"] = 497,
    ["Rattler-build"] = 504,
    Ray = 696,
    ["Read the Docs"] = 499,
    ["Red-DiscordBot Cog"] = 511,
    ["Red-DiscordBot Cog Repo"] = 512,
    ["Red-DiscordBot Trivia"] = 513,
    ["Render Blueprints"] = 728,
    RenderCV = 523,
    Renovate = 522,
    ["Replit config"] = 517,
    RoadRunner = 524,
    ["Rudder techniques"] = 837,
    Ruff = 519,
    ["Rust Project"] = 520,
    ["Rust toolchain"] = 527,
    ["SDMX data message"] = 552,
    ["SDMX metadata message"] = 551,
    ["SDMX structure message"] = 550,
    ["SIL Kit Participant Configuration"] = 562,
    ["SIL Kit Registry Configuration"] = 563,
    SWADL = 588,
    ["Safebox Config"] = 789,
    ["Sapphire CLI Config"] = 530,
    ["SauceCTL Configuration"] = 738,
    ["Schema Catalog"] = 544,
    ["Scoop manifest"] = 549,
    ["Semantic Data Fabric (SDF) file"] = 553,
    ["Semgrep Rule"] = 555,
    ["Serenity Code Generator (Sergen)"] = 556,
    ["Serverless Framework Configuration"] = 745,
    ["Serverless Workflow"] = 747,
    ["Settings.paf"] = 558,
    ["Shopware 6 Configuration"] = 748,
    ["Shopware CLI Extension Store Configuration"] = 749,
    ["Shopware CLI Project Store Configuration"] = 750,
    Sigma = 560,
    ["Sigrid scope configuration file"] = 561,
    ["SkyPilot Task JSON"] = 838,
    ["Slack app manifest"] = 565,
    Solidarity = 568,
    ["Solution filters"] = 569,
    ["Source Maps v3"] = 570,
    Sourcery = 571,
    SpecIF = 572,
    ["Sponge Mixin configuration"] = 573,
    StackBlitz = 578,
    ["StackHawk Scanner Configuration"] = 744,
    Stale = 579,
    ["Starlake Data Pipeline"] = 719,
    Starship = 580,
    ["Statamic Blueprint"] = 581,
    ["Stella configuration file"] = 582,
    ["StrmPrivacy Data Connector"] = 793,
    ["StrmPrivacy Data Contract"] = 794,
    ["StrmPrivacy SimpleSchema"] = 791,
    ["StrmPrivacy Stream"] = 792,
    ["StrmPrivacy batch job configuration file"] = 790,
    ["Stryker Mutator"] = 585,
    ["StyleCop Analyzers Configuration"] = 586,
    ["Stylelint (.stylelintrc)"] = 587,
    ["Sublime Syntax"] = 795,
    ["Subsquid squid manifest"] = 840,
    ["Swagger API 2.0"] = 589,
    TSON = 615,
    TSTyche = 616,
    Talhelper = 591,
    ["Talisman configuration"] = 592,
    ["Taskfile config"] = 724,
    Taurus = 593,
    ["TestEnvironment.json"] = 602,
    ["TextMate Grammar"] = 601,
    ["Tier.run pricing.json"] = 596,
    Tikibase = 597,
    ["Traefik v2"] = 605,
    ["Traefik v2 File Provider"] = 606,
    ["Travis CI (.travis.yml)"] = 604,
    TunnelHub = 830,
    Turborepo = 603,
    Tye = 752,
    ["UET BuildConfig.json"] = 800,
    ["UI5 Manifest"] = 625,
    ["UNCORS configuration"] = 629,
    ["UTAM Page Object"] = 628,
    ["Ubuntu Server Autoinstall"] = 623,
    ["Uniswap Token List"] = 707,
    ["Unreal Engine Uplugin"] = 801,
    ["Unreal Engine Uproject"] = 802,
    ["Updatecli Compose"] = 760,
    ["Updatecli Policy Manifest"] = 761,
    ["Updatecli Policy Metadata"] = 762,
    Uplift = 798,
    ["User Journey Map"] = 727,
    V2Ray = 766,
    ["VSCode Code Snippets"] = 169,
    ["VSIX CLI publishing"] = 644,
    ["Vela Pipeline Configuration"] = 633,
    Vercel = 168,
    Visivo = 828,
    ["Web App Manifest"] = 651,
    ["Web types"] = 654,
    WebExtensions = 650,
    ["Webman package recipe"] = 772,
    ["Windows Package Manager Installer Manifest"] = 704,
    ["Windows Package Manager Locale Manifest"] = 705,
    ["Windows Package Manager Singleton Manifest"] = 703,
    ["Woodpecker pipeline config"] = 740,
    ["Wrangler CLI"] = 655,
    ["Xstate Machine"] = 758,
    ["Yarn Config (.yarnrc.yml)"] = 717,
    ["Yippee-Ki-JSON configuration YML"] = 709,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 832,
    ...
    ["behat.yml"] = 92,
    ["bigquery-table"] = 84,
    ["bioimageio resource description"] = 848,
    ...
    ["chisel-slices.json"] = 186,
    ["chrome-extension-locales-messages.json"] = 176,
    ["chutzpah.json"] = 177,
    cibuildwheel = 117,
    ["clang-format (.clang-format)"] = 764,
    clangd = 156,
    clib = 157,
    ["cloud-init: cloud-config userdata"] = 159,
    ["cloud-sdk-pipeline-configuration"] = 179,
    ["cloudbuild.json"] = 180,
    cloudify = 158,
    codemagic = 160,
    ["coffeelint.json"] = 188,
    ["commands.json"] = 172,
    ["commitlint (.commitlintrc)"] = 706,
    ["compile_commands.json"] = 171,
    ["compilerconfig.json"] = 170,
    ["completely.yml"] = 806,
    ["component-detection-manifest.json"] = 191,
    ["component.json"] = 190,
    ["composer.json"] = 189,
    ["conda-forge"] = 119,
    ["config.yaml"] = 498,
    ["contentmanifest.json"] = 178,
    ["contribute.json"] = 192,
    ["cosmos.config.json"] = 174,
    ["crowdin.yml"] = 193,
    ["custom-elements.json"] = 820,
    ["cypress.json"] = 197,
    ["datalogic-scan2deploy-android"] = 207,
    ["datalogic-scan2deploy-ce"] = 208,
    ["dbt Project"] = 130,
    ["ddev-global"] = 209,
    ["ddev-project"] = 210,
    ["debugsettings.json"] = 211,
    ["dependabot-v2.json"] = 214,
    ["dependabot.json"] = 213,
    ["deployed-cli"] = 757,
    ["devcontainer.json"] = 162,
    devinit = 711,
    ["devspace.yaml"] = 780,
    djlint = 712,
    ["docker sequencer"] = 219,
    ["docker-compose.yml"] = 710,
    ["dockerd.json"] = 218,
    ["dotnet Release Index manifest"] = 229,
    ["dotnet-tools.json"] = 230,
    ["dotnetcli.host.json"] = 231,
    ["dprint.json"] = 232,
    ["drone.json"] = 233,
    ["dss-2.0.0.json"] = 235,
    ["dstack configuration"] = 236,
    ["dvc.yaml"] = 237,
    ["ecosystem.json"] = 242,
    eksctl = 243,
    ["electron-builder configuration file"] = 250,
    ["epr-manifest.json"] = 248,
    ["evcc.yaml"] = 251,
    ["ezd task runner"] = 253,
    ["fabric.mod.json"] = 256,
    ["first-timers-bot"] = 262,
    ...
    ["gitlab-ci"] = 288,
    ["global.json"] = 290,
    ["go-feature-flag Flag Configuration"] = 293,
    ["haxelib.json"] = 308,
    helmfile = 699,
    helmwave = 700,
    ["host-meta.json"] = 313,
    ...
    ["ide.host.json"] = 319,
    ["ifstate.conf"] = 320,
    ["imageoptimizer.json"] = 321,
    ["importmap.json"] = 324,
    ["ioBroker Configuration"] = 325,
    ["ioBroker JSON UI"] = 326,
    ["ioBroker Package manifest"] = 327,
    ["ize.toml"] = 797,
    ["jsconfig.json"] = 350,
    ["jscpd Configuration"] = 777,
    jsdoc = 695,
    ["k3d.yaml"] = 351,
    ["k9s plugin.yml"] = 353,
    ["kontinuous-config.yaml"] = 359,
    ["kontinuous-values.yaml"] = 358,
    ["kustomization.yaml"] = 360,
    ["label-commenter-config.yml"] = 361,
    ["latexindent configuration"] = 65,
    ["launchsettings.json"] = 362,
    lazydocker = 819,
    lazygit = 818,
    ["lego.json"] = 364,
    ["lerna.json"] = 365,
    ["lgtm.yml"] = 366,
    ["liblab.config.json"] = 367,
    ["libman.json"] = 368,
    ["license-report-config.json"] = 369,
    ["linkinator.config.json"] = 371,
    ["lint-staged (.lintstagedrc)"] = 675,
    ["local.settings.json"] = 376,
    ["localazy.json"] = 377,
    ["lotus.yaml"] = 375,
    ["lsdlschema.json"] = 378,
    ["markdown-link-check"] = 736,
    mboats = 743,
    ["micro-settings.json"] = 812,
    ["mimetypes.json"] = 387,
    ["mirrord config"] = 676,
    mise = 677,
    ["mise-settings"] = 678,
    ...
    ["mtad.yaml"] = 680,
    ["mycode.json"] = 416,
    ["napari plugin manifest"] = 417,
    neoload = 690,
    ["nest-cli"] = 423,
    ["ninjs (News in JSON) 1.3"] = 422,
    ["ninjs (News in JSON) 2.0"] = 421,
    ["nixd configuration"] = 836,
    ["nlu.json"] = 424,
    ["nodemon.json"] = 426,
    ["noodl config"] = 742,
    ["notebook.mod.json"] = 427,
    now = 686,
    ["npm-badges"] = 430,
    ["nswag.json"] = 433,
    ntangle = 434,
    ["nuclei-template.yaml"] = 431,
    ["nuget-project.json"] = 432,
    ["ocelot.json"] = 436,
    ["omnisharp.json"] = 437,
    ["openapi.json"] = 438,
    ["openfin.json"] = 445,
    ...
    ["ops.yaml"] = 442,
    ["package.json"] = 456,
    ["package.manifest"] = 457,
    ["partial-black.json"] = 93,
    ["pathfinder.yml"] = 460,
    ["pattern.json"] = 463,
    ["petstore-v1.0"] = 787,
    pgap_yaml_input_reader = 462,
    ["pixi.toml"] = 464,
    ["plagiarize-me.yaml"] = 468,
    ["plagiarize.yaml"] = 467,
    ["portman.json"] = 469,
    ["prettierrc.json"] = 477,
    ["prisma.yml"] = 478,
    ["project-1.0.0-beta3.json"] = 481,
    ["project-1.0.0-beta4.json"] = 482,
    ["project-1.0.0-beta5.json"] = 483,
    ["project-1.0.0-beta6.json"] = 484,
    ["project-1.0.0-beta8.json"] = 485,
    ["project-1.0.0-rc1.json"] = 486,
    ["project-1.0.0-rc2.json"] = 487,
    ["project.json"] = 480,
    ["prometheus.json"] = 488,
    ["prometheus.rules.json"] = 489,
    ["prometheus.rules.test.json"] = 490,
    ["proxies.json"] = 491,
    ["publiccode.yml"] = 492,
    ["pubspec.yaml"] = 493,
    ["pyrseas-0.8.json"] = 496,
    ["quilt.mod.json"] = 813,
    ["rc3 auth"] = 505,
    ["rc3 collection"] = 506,
    ["rc3 environment"] = 507,
    ...
    ["rc3 settings"] = 510,
    ["release drafter"] = 691,
    ["release-plz.toml"] = 515,
    ["rivet.yaml"] = 835,
    rockcraft = 525,
    rustfmt = 526,
    samt = 528,
    samtrc = 529,
    ["sarif-1.0.0.json"] = 531,
    ["sarif-2.0.0.json"] = 532,
    ["sarif-2.1.0"] = 542,
    ["sarif-2.1.0-rtm.2"] = 533,
    ["sarif-2.1.0-rtm.3"] = 535,
    ["sarif-2.1.0-rtm.4"] = 537,
    ["sarif-2.1.0-rtm.5"] = 539,
    ["sarif-2.1.0-rtm.6"] = 540,
    ["sarif-external-property-file-2.1.0"] = 543,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 534,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 536,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 538,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 541,
    ["schema.org - Action"] = 545,
    ["schema.org - ContactPoint"] = 546,
    ["schema.org - Place"] = 547,
    ["schema.org - Thing"] = 548,
    ["secrethub.yml"] = 815,
    ["semantic-release"] = 554,
    ["servicehub.config.json"] = 665,
    ["servicehub.service.json"] = 664,
    ["settings.job"] = 557,
    ["sfdx-hardis configuration"] = 559,
    ["shard.yml"] = 851,
    ["size-limit configuration"] = 564,
    ["skaffold.yaml"] = 734,
    ["skyuxconfig.json"] = 566,
    snapcraft = 567,
    ["sqlc configuration"] = 575,
    ["stripe-app-local.json"] = 584,
    ["stripe-app.json"] = 583,
    swcrc = 720,
    ["task.json"] = 590,
    taskcat = 687,
    ["template.json"] = 594,
    ["templatsources.json"] = 595,
    ["theme.json"] = 598,
    ["tizen_workspace.json"] = 599,
    tldr = 600,
    tmuxinator = 673,
    ["transcend.yml"] = 607,
    ["tree-sitter grammar.json"] = 298,
    ["trime.yaml"] = 608,
    ["trunk.yaml"] = 609,
    ["ts-force-config.json"] = 613,
    ["tsconfig.json"] = 610,
    ["tsd.json"] = 611,
    ["tsdrc.json"] = 612,
    ["tslint.json"] = 614,
    ...
    v8r = 648,
    vcluster = 858,
    ["vcpkg configuration file"] = 167,
    ["vcpkg manifest file"] = 166,
    ["vega-lite.json"] = 632,
    ["vega.json"] = 631,
    ["venvironment-basic.yaml"] = 635,
    ["venvironment.yaml"] = 634,
    ["version.json"] = 636,
    ["vim-addon-info"] = 638,
    ["vs-2017.3.host.json"] = 640,
    ["vs-nesting.json"] = 641,
    ["vsls.json"] = 639,
    ["vss-extension.json"] = 645,
    ["vtesttree.yaml"] = 646,
    ["vtestunit.yaml"] = 647,
    ["warp-keysets.json"] = 821,
    ["warp-themes.json"] = 822,
    ["warp-workflows.json"] = 823,
    ["webhint.io"] = 773,
    ["webjobpublishsettings.json"] = 653,
    ["webjobs-list.json"] = 652,
    ["well-known-fursona"] = 859,
    ["xs-app.json"] = 683,
    ["xunit.runner.json"] = 663,
    yamllint = 708,
    zuul = 692,
    ["Žinoma"] = 702
  },
