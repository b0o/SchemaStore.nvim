...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 995,
    [".nodehawkrc"] = 627,
    [".npmpackagejsonlintrc"] = 631,
    [".omletrc"] = 1176,
    [".phrase.yml"] = 709,
    [".phraseapp.yml"] = 710,
    [".pmbot.yml"] = 694,
    [".postcssrc"] = 703,
    [".powerpages-web-template-manifest"] = 705,
    [".pre-commit-config.yml"] = 706,
    [".pre-commit-hooks.yml"] = 707,
    [".putout.json"] = 743,
    [".rehyperc"] = 768,
    [".remarkrc"] = 772,
    [".sprite files"] = 868,
    ...
    AIConfig = 37,
    ["AMX Muse Program Descriptor"] = 1225,
    ["API Builder"] = 1031,
    ["AVA Configuration"] = 1095,
    ["AWS AppConfig Feature Flags-v1"] = 71,
    ["AWS CDK cdk.json"] = 274,
    ["AWS CloudFormation"] = 275,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 276,
    ["AWS Copilot Manifest"] = 1264,
    ["AWS SAM CLI Samconfig"] = 277,
    Acton = 1315,
    ["Adobe UXP Manifest"] = 1158,
    ["Aerleon Network & Service Definitions"] = 23,
    ["Aerleon Policy"] = 24,
    ["Agent Permission Policy"] = 1304,
    ["AgentCore CLI"] = 1305,
    AgentLoopKit = 1306,
    Aider = 1254,
    Air = 26,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1275,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1274,
    ["Airlock Microgateway"] = 38,
    ["Alacritty Configuration"] = 1067,
    ["AlgoVoi Compliance Receipt v1"] = 13,
    ["All Contributors configuration file"] = 1121,
    Anodizer = 453,
    ["Ansible Argument Specs"] = 437,
    ["Ansible Collection Galaxy"] = 444,
    ["Ansible Execution Environment"] = 434,
    ["Ansible Inventory"] = 443,
    ["Ansible Meta"] = 435,
    ["Ansible Meta Runtime"] = 436,
    ["Ansible Navigator Configuration"] = 446,
    ["Ansible Playbook"] = 441,
    ["Ansible Requirements"] = 438,
    ["Ansible Rulebook"] = 442,
    ["Ansible Tasks File"] = 440,
    ["Ansible Vars File"] = 439,
    ["Ansible-lint Configuration"] = 445,
    Any = 1186,
    ...
    ["Application list for a WinUtil"] = 1204,
    ArchitectFX = 1209,
    ["Argo CD"] = 57,
    ["Argo Events"] = 58,
    ["Argo Workflows"] = 59,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1273,
    ["Azure IoT Operations connector metadata"] = 1270,
    ...
    ["Azure Pipelines"] = 117,
    ["Azure Static Web Apps CLI configuration file"] = 872,
    ["Azure Static Web Apps configuration file"] = 871,
    BMML = 1292,
    ["BOSH CPI Config"] = 143,
    ...
    ["Bacon config"] = 7,
    ["Barba-CV"] = 86,
    ["Bashly (bashly.yml)"] = 1125,
    ["Bashly Settings (bashly-settings.yml)"] = 1126,
    Bento = 1291,
    ["Better Code Hub"] = 1036,
    ["Better Scripts"] = 166,
    Bigconfig = 136,
    ["Biome Formatter Config"] = 87,
    ["Bitmovin Encoding Template"] = 1218,
    BizTalkServerApplicationSchema = 1002,
    Bleep = 167,
    ["Block Protocol Metadata"] = 164,
    ["Bluebricks blueprint config"] = 1297,
    ["Boyka Framework"] = 145,
    ...
    ["Butane Config"] = 1080,
    C4InterFlow = 1233,
    ["CDK Environment Manager, concrete environment configuration"] = 1257,
    ["CDK Environment Manager, concrete environments definition"] = 1256,
    ["CDK Environment Manager, environment definition"] = 1255,
    ["CGS Card Game Specification (cgs.json)"] = 1163,
    ["CICS TS region tagging"] = 1089,
    ["CICS TS resource import"] = 1090,
    ["CICS TS resource model"] = 1091,
    ["CICS TS resource overrides"] = 1092,
    ["CMake Presets"] = 168,
    ["CNC Codes"] = 190,
    ["CRS WAF test file"] = 1193,
    ["CRS WAF test platform overrides file"] = 1194,
    ["CSS Comb (.csscomb.json)"] = 302,
    ["CSS Lint (.csslintrc)"] = 303,
    ["CSpell (cspell.json)"] = 301,
    ["CVE Record Format"] = 202,
    CWL = 1169,
    ["Cache Warmup config"] = 169,
    ["Caido Proxy Configuration"] = 1329,
    ...
    ["Chamaleon environment"] = 1222,
    ["Chamaleon properties"] = 1223,
    ["Chamaleon template"] = 1221,
    Changepacks = 1284,
    Changesets = 286,
    Changie = 177,
    Charmcraft = 178,
    ...
    ["Clawject config"] = 196,
    ["Cloud Foundry Application Manifest"] = 1175,
    ["Cloud Run Spec v1"] = 1199,
    ...
    CodeCV = 101,
    CodeRabbit = 100,
    ["CodeShip Pro services configuration files"] = 256,
    ["CodeShip Pro steps configuration files"] = 257,
    ["Codecov configuration files"] = 255,
    Codex = 249,
    ["Codex Hooks"] = 250,
    ...
    ["Common Catalog Data"] = 265,
    ["Common Package Specification"] = 194,
    Concord = 1192,
    ["Configu .cfgu files"] = 1180,
    ["Configu .configu file"] = 1181,
    Conjure = 189,
    ["Container Structure Test"] = 1016,
    Containerlab = 1045,
    ["Contextive Glossary"] = 1249,
    ContractGuard = 1046,
    Convex = 188,
    ["Crowdsec collection config"] = 296,
    ["Crowdsec parser config"] = 297,
    ["Crowdsec scenario config"] = 298,
    ["CumulusCI Config"] = 195,
    ["Cursor Agent Environment"] = 1302,
    ["Custom Machinery Machine"] = 1164,
    ["Custom Machinery Recipe"] = 1165,
    ["Cycle Stack File"] = 203,
    CycloneDX = 204,
    ["DWP Exchange - catalogue entry"] = 347,
    ["DWP Exchange - gateway"] = 345,
    ["DWP Exchange - meta"] = 346,
    ["Dart Build Config (dart-build.json)"] = 304,
    ["Dart Test Config (dart-test.json)"] = 305,
    ["DashLord Configuration"] = 306,
    ["Data Contract Specification"] = 307,
    ["Data Product Specification"] = 308,
    ["DataYoga Connections"] = 205,
    ["DataYoga Job"] = 206,
    ["Datadog Continuous Testing"] = 539,
    ["Datadog Service Definition"] = 540,
    ["Datadog Software Catalog"] = 541,
    ["Datahub Ingestion Recipe"] = 1096,
    ["Debian Upstream Metadata file"] = 213,
    ["Deck config"] = 214,
    ["Declarative Automation Bundles"] = 1142,
    ["DeepMatch deeplinks spec"] = 215,
    ["Dein Config"] = 216,
    ["Deno Config (deno.json)"] = 314,
    ["Dependency cruiser"] = 217,
    ["DeployStack Configuration"] = 218,
    ["Deployah Configuration"] = 1272,
    ["Deployer Recipe"] = 317,
    ["Deta Spacefile"] = 219,
    ["Detekt Config (detekt.yml)"] = 318,
    ["Devbox Config"] = 220,
    ["Devbox Plugin"] = 221,
    Devfile = 344,
    Devup = 1285,
    DipDup = 1195,
    ["Discord Webhook"] = 319,
    ["DocFx Config (docfx.json)"] = 324,
    ["Docker Desktop extension metadata"] = 321,
    ["Docs MCP Manifest"] = 325,
    Dofigen = 326,
    ["Dolittle Artifacts"] = 327,
    ["Dolittle Bounded Context Configuration"] = 328,
    ["Dolittle Event Horizons Configuration"] = 329,
    ["Dolittle Resources Configuration"] = 330,
    ["Dolittle Server Configuration"] = 331,
    ["Dolittle Tenant Map Configuration"] = 333,
    ["Dolittle Tenants Configuration"] = 332,
    ["Dolittle Topology"] = 334,
    ["DonateCaseBetterCasino menu"] = 1226,
    ...
    ["Drupal Routing"] = 233,
    ["Drupal Services"] = 235,
    ["Drush site aliases"] = 340,
    ["Dynamic Bash Aliases (.aliases)"] = 1133,
    ["EAS config"] = 385,
    ["ECA - Editor Code Assistant"] = 349,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1122,
    ["ESLint Suppressions"] = 390,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1269,
    ["EasyVCR .NET"] = 387,
    ["Eidolon Resource"] = 1210,
    ["Elgato Stream Deck"] = 351,
    Elm = 1197,
    ["Embrace Config"] = 1108,
    Emmet = 1198,
    Endurica = 1146,
    ["Enonic XP API descriptor"] = 354,
    ["Enonic XP Admin Extension descriptor"] = 355,
    ["Enonic XP Admin Tool descriptor"] = 356,
    ["Enonic XP Application descriptor"] = 357,
    ["Enonic XP CMS descriptor"] = 358,
    ["Enonic XP Content Type descriptor"] = 359,
    ["Enonic XP Form Fragment descriptor"] = 360,
    ["Enonic XP ID Provider descriptor"] = 361,
    ["Enonic XP Layout descriptor"] = 362,
    ["Enonic XP Macro descriptor"] = 363,
    ["Enonic XP Mixin descriptor"] = 364,
    ["Enonic XP Page descriptor"] = 365,
    ["Enonic XP Part descriptor"] = 366,
    ["Enonic XP Service descriptor"] = 367,
    ["Enonic XP Site descriptor"] = 368,
    ["Enonic XP Style descriptor"] = 369,
    ["Enonic XP Task descriptor"] = 370,
    ["Enonic XP Webapp descriptor"] = 371,
    ["Enterprise Contract Policy Spec"] = 352,
    ["Envelope Team Definition"] = 1314,
    ["Envilder Map File"] = 353,
    ["Erda Pipeline"] = 1171,
    ["Erda Runtime"] = 1172,
    ["Espanso config.yml"] = 1295,
    ["Espanso match.yml"] = 1294,
    Esquio = 373,
    ["Estuary Flow Catalog"] = 1086,
    ["Ethereum ERC1155"] = 1308,
    ["Ethereum ERC721"] = 1307,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 378,
    ["EveryVoice TTS Toolkit Data Configuration"] = 379,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 383,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 382,
    ["EveryVoice TTS Toolkit Text Configuration"] = 380,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 381,
    ["Evolving Resolutive Process notation"] = 1271,
    ["Expo SDK"] = 384,
    ["Expoot app config"] = 386,
    ["F-Droid Data metadata"] = 392,
    ["FasterCI Configuration"] = 118,
    ["Fence configuration"] = 119,
    FiQuS = 396,
    Firebase = 394,
    ["Flatpak Builder Manifest"] = 397,
    ["FlexGet Config"] = 398,
    ["Flow.json Configurations"] = 1168,
    ["Fossa configuration file"] = 405,
    ["Fossa's fossa-deps file"] = 406,
    ["Foundry VTT - Base package Manifest"] = 400,
    ["Foundry VTT - Module Manifest"] = 401,
    ["Foundry VTT - System Data Template"] = 404,
    ["Foundry VTT - System Manifest"] = 402,
    ["Foundry VTT - World Manifest"] = 403,
    ["Foxx Manifest"] = 120,
    ["Freifunk.de Community API"] = 123,
    ["Frogbot Config"] = 124,
    ["G2P Mapping Configuration"] = 412,
    ["GCP Blueprint Metadata"] = 415,
    Gaspar = 413,
    ["GatewayCore API Gateway"] = 414,
    ["Gemini CLI settings"] = 416,
    ["GeoJSON.json latest"] = 1084,
    GherKing = 1088,
    ["GitHub Action"] = 422,
    ["GitHub Actions typing"] = 1206,
    ["GitHub Discussion"] = 423,
    ["GitHub Funding"] = 424,
    ["GitHub Issue Template configuration"] = 425,
    ["GitHub Issue Template forms"] = 426,
    ["GitHub Pages Jekyll"] = 427,
    ["GitHub Workflow"] = 428,
    ["GitHub Workflow Template Properties"] = 429,
    ["GitHub automatically generated release notes configuration"] = 430,
    ["GitLab Agent for Kubernetes configuration"] = 1160,
    GitVersion = 419,
    ["Gitea Issue Template configuration"] = 420,
    ["Gitea Issue Template forms"] = 421,
    ["Gitpod Automations"] = 432,
    ["Gitpod Configuration"] = 433,
    ["Glamour style"] = 417,
    ["GlazeWM settings"] = 1162,
    ["Global Privacy Control"] = 418,
    Goblet = 1141,
    ["Golangci-lint Configuration"] = 448,
    ["Golangci-lint Custom Plugins Configuration"] = 449,
    ["Google Chrome Related Website Sets"] = 395,
    ["Google Cloud Workflows"] = 273,
    ["Google Digital Assetlinks"] = 1250,
    Goreleaser = 451,
    ["Goreleaser Pro"] = 452,
    Goss = 454,
    ["Gradle Build Cache Node"] = 1034,
    ["Gradle Enterprise"] = 1033,
    ["Grafana 5.x Dashboard"] = 455,
    ["GraphQL Code Generator"] = 460,
    ["GraphQL Config"] = 459,
    ["GraphQL Mesh"] = 458,
    ["GroovyLint configuration"] = 461,
    ["Grunt JSHint task"] = 465,
    ["Grunt Watch task"] = 466,
    ["Grunt base task"] = 467,
    ["Grunt clean task"] = 463,
    ["Grunt copy task"] = 462,
    ["Grunt cssmin task"] = 464,
    HEMTT = 998,
    Hadolint = 1012,
    Hammerkit = 1044,
    ["Hardware Sentry Configuration"] = 1100,
    ["Hashgraph Online Skill Manifest"] = 3,
    ["HashiCorp Vault"] = 468,
    Hatch = 1013,
    Hayson = 470,
    ["Haystack Pipeline"] = 471,
    ["Hazelcast 5 Configuration"] = 472,
    ["Hecate Input Schema"] = 1261,
    ["Helm Chart.lock"] = 237,
    ["Helm Chart.yaml"] = 236,
    ["Helm Unittest Test Suite"] = 238,
    ["Hex file"] = 239,
    ["Home Assistant Integration Manifest"] = 473,
    ["Homer dashboard configuration"] = 474,
    Hugo = 1076,
    ["Hugo Theme"] = 1075,
    ["Hulak Configuration"] = 481,
    ["Hyperfoil benchmark configuration"] = 480,
    ["IBM Zapp document"] = 482,
    ["IBM zCodeFormatSettings"] = 483,
    ["IMG Catapult PSP"] = 488,
    ["IVMS101 by CODE Protocol"] = 1161,
    ["Infinispan Configuration"] = 490,
    ["Infinispan Server Configuration"] = 491,
    Infrahub = 492,
    Istanbul = 1104,
    ["JDownloader2 crawler multi-rules"] = 506,
    ["JDownloader2 crawler single-rules"] = 505,
    ["JFrog Applications Config"] = 507,
    ["JFrog File Spec"] = 508,
    ["JFrog Pipelines YML DSL"] = 1110,
    ["JMeter DSL cli config"] = 509,
    JReleaser = 512,
    ["JSON Document Transform"] = 520,
    ["JSON Feed"] = 521,
    ["JSON Resume"] = 780,
    ["JSON Schema Draft 2020-12"] = 980,
    ["JSON Schema Draft 4"] = 977,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1143,
    ["JSON Schema Draft 7"] = 978,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1144,
    ["JSON Schema Draft 8 (2019-09)"] = 979,
    ["JSON-API"] = 519,
    ["JSON-e templates"] = 1041,
    ["JSON-stat 2.0"] = 973,
    JSONPatch = 523,
    ["JSR Package Config (jsr.json)"] = 513,
    Jarl = 1277,
    Jasmine = 500,
    Jekyll = 501,
    ["Jenkins X Pipelines"] = 502,
    ["Jenkins X Requirements"] = 503,
    Jest = 504,
    Jocker = 510,
    ["Jovo Language Models"] = 511,
    ["Jujutsu (jj) VCS config"] = 1263,
    ["KIMMDY config file"] = 534,
    ["KODE/CI build.yaml"] = 1106,
    ["KSP-AVC"] = 974,
    ["KSP-CKAN"] = 975,
    ["KSP-NetKAN"] = 976,
    KSY = 1173,
    KSail = 410,
    ["KYA Manifest"] = 1174,
    ["Karakum configuration file"] = 407,
    Kas = 526,
    ["Kestra flow file"] = 535,
    ["Keycloak REST API"] = 1113,
    ["Knative Functions - func.yaml"] = 408,
    Knip = 409,
    ["Knowledge Unit"] = 543,
    ["Kometa (nightly) config file"] = 537,
    ["Kometa config file"] = 536,
    ["Kong DBLess config"] = 1107,
    KrakenD = 538,
    ["Kubri Configuration"] = 546,
    LOOBin = 561,
    ["Lake configuration file"] = 1266,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 278,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 279,
    ["Landing Zone Accelerator on AWS - Global Config"] = 280,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 281,
    ["Landing Zone Accelerator on AWS - Network Config"] = 282,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 283,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 284,
    ["Landing Zone Accelerator on AWS - Security Config"] = 285,
    ["Lando (landofile)"] = 113,
    ["LangGraph Platform configuration"] = 1185,
    ["Language configuration"] = 1184,
    Lefthook = 550,
    ["Liferay client-extension.yaml"] = 557,
    ["LinkML Metamodel"] = 559,
    Liquibase = 1051,
    ["Liquibase Flow File"] = 1052,
    ["Lively Properties"] = 560,
    ["Lobe AI Agent"] = 115,
    Loki = 116,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 603,
    ["MS2Rescore Configuration"] = 608,
    ["Madness (madness.yml)"] = 1124,
    ["Mado configuration"] = 567,
    ["Maestro Flow"] = 568,
    ["Mail Servers Configuration"] = 1298,
    ["MapEHR Mapping"] = 569,
    Markdownlint = 1055,
    ["Mason Registry"] = 1058,
    ["MegaLinter Custom Flavor"] = 572,
    ["MegaLinter configuration"] = 571,
    ["MegaLinter descriptor"] = 573,
    Melange = 1151,
    ["Meltano project definition"] = 574,
    ["Mergify Configuration"] = 609,
    ["Metadata for a Bazel module"] = 575,
    ["Metadata for a Cinnamon spice"] = 1202,
    ["Metatype Configuration"] = 576,
    ["MetricsHub Configuration"] = 577,
    ["MetricsHub Connector Configuration"] = 578,
    ["Micro Editor Syntax"] = 1134,
    ["Microsoft Band Web Tile"] = 579,
    ["Microsoft RulesEngine workflow rules"] = 1189,
    ["Microsoft RulesEngine workflow rules list"] = 1190,
    ["Minecraft Custom Main Menu Mod"] = 1152,
    ["Minecraft Data Pack Advancement"] = 581,
    ["Minecraft Data Pack Biome"] = 582,
    ["Minecraft Data Pack Configured Carver"] = 583,
    ["Minecraft Data Pack Damage Type"] = 584,
    ["Minecraft Data Pack Dimension"] = 586,
    ["Minecraft Data Pack Dimension Type"] = 585,
    ["Minecraft Data Pack Item Modifier"] = 587,
    ["Minecraft Data Pack Loot Table"] = 588,
    ["Minecraft Data Pack Metadata"] = 589,
    ["Minecraft Data Pack Predicate"] = 590,
    ["Minecraft Data Pack Recipe"] = 591,
    ["Minecraft Data Pack Tag"] = 592,
    ["Minecraft Data Pack Template Pool"] = 593,
    ["Minecraft Data Pack Trim Material"] = 598,
    ["Minecraft Data Pack Trim Pattern"] = 599,
    ["Minecraft Resource Pack Lang"] = 594,
    ["Minecraft Resource Pack Particle"] = 595,
    ["Minecraft Resource Pack Texture Mcmeta"] = 597,
    ["Minecraft Resourcepack Sounds"] = 596,
    ["MockServer Expectations"] = 605,
    ModuleAssembler = 601,
    ["Monade CLI Stack Configuration"] = 612,
    ["MongoDB Atlas Search Index Definition"] = 1105,
    ["Monika Configuration"] = 1103,
    ["Monoweave Configuration"] = 607,
    ["Motif config"] = 994,
    MultiQC = 1243,
    ["NOX Framework (Service)"] = 630,
    ["Netin Diagnostic System Template"] = 1062,
    ["Netlify config"] = 615,
    ["Network-as-Code Data Model"] = 616,
    ["Next Gen UI Agent A2A Server Configuration"] = 617,
    ["Next Gen UI Agent Configuration"] = 619,
    ["Next Gen UI Agent MCP Server Configuration"] = 618,
    ["Nightwatch.js"] = 623,
    ["Node.js configuration"] = 999,
    ["NueJS configuration file"] = 635,
    ["Nuitka Package Config"] = 1166,
    ["Nullstone config"] = 637,
    ["ONe's changelog entry"] = 656,
    ["ONe's service descriptor"] = 655,
    ["ORT Server repository environment configuration"] = 666,
    ["OSCAL Assessment Plan (AP)"] = 668,
    ["OSCAL Assessment Results (AR)"] = 669,
    ["OSCAL Catalog"] = 670,
    ["OSCAL Component Definition (CDef)"] = 671,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 672,
    ["OSCAL Profile"] = 673,
    ["OSCAL System Security Plan (SSP)"] = 674,
    ["OSS Review Toolkit configuration"] = 675,
    ["OSS Review Toolkit curation"] = 676,
    ["OSS Review Toolkit package configuration"] = 677,
    ["OSS Review Toolkit project package manager definition"] = 678,
    ["OSS Review Toolkit repository configuration"] = 679,
    ["OSS Review Toolkit resolutions"] = 680,
    ["October CMS columns"] = 641,
    ["October CMS fields"] = 642,
    ["Oh My Posh"] = 644,
    Okteto = 645,
    ["Ona Automations"] = 647,
    Opctl = 997,
    ["Open Data Contract Standard (ODCS)"] = 660,
    ["Open Data Product Standard (ODPS)"] = 661,
    ["Open Know-How"] = 1248,
    OpenDecree = 1312,
    ["OpenDecree Configuration"] = 1313,
    ["OpenRewrite Resource"] = 658,
    OpenSRM = 662,
    OpenStatus = 1259,
    ["OpenTelemetry Declarative Configuration"] = 659,
    ["OpenUtau character yaml"] = 652,
    ["OpenUtau ustx"] = 653,
    ["OpenWeather Current Weather API"] = 1040,
    ["OpenWeather Road Risk API"] = 1039,
    ["Ory Hydra configuration"] = 479,
    ["Ory Keto configuration"] = 542,
    ["Ory Kratos configuration"] = 667,
    ["Ory Oathkeeper configuration"] = 639,
    ["Outblocks App configuration"] = 664,
    ["Outblocks database table"] = 665,
    ["Outblocks project configuration"] = 663,
    PDM = 688,
    POPxf = 700,
    ["POPxf Correlations"] = 701,
    ["PRML manifest"] = 708,
    Packer = 684,
    PactSpec = 685,
    Panache = 686,
    Pantsbuild = 1120,
    ["Paper paper-plugin.yml"] = 687,
    ["Pipeline component"] = 1053,
    ["Platform.sh application"] = 9,
    ["Platform.sh routes"] = 10,
    ["Platform.sh services"] = 11,
    ["Plex Prerolls"] = 698,
    ["PocketMine plugin.yml"] = 695,
    ["Podman Desktop Extension"] = 1331,
    ["Postman collection"] = 704,
    ["Power Pages Configuration"] = 1260,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1205,
    ["ProActions AI-Kit Configuration"] = 716,
    ["ProActions AI-Kit Configuration for Menus"] = 718,
    ["ProActions AI-Kit Configuration for Sections"] = 720,
    ["ProActions AI-Kit Configuration for Services"] = 717,
    ["ProActions AI-Kit Configuration for Steps"] = 721,
    ["ProActions AI-Kit Configuration for Templates"] = 719,
    ["Problem object RFC9457"] = 1149,
    ["Problem package format"] = 722,
    ["Problem package generators"] = 723,
    ["Problem package submissions"] = 724,
    ["Problem package test group metadata"] = 725,
    Pterodactyl = 1099,
    ["Pull Request Labeler"] = 742,
    Pulumi = 750,
    ["PyGTA Config"] = 746,
    PyProject = 751,
    Pylock = 1251,
    Pyright = 752,
    ["Python script metadata"] = 1245,
    ["QType AI DSL"] = 755,
    Qgoda = 754,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1323,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1321,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1327,
    ["Qlik Talend Cloud Pipeline - Project"] = 1319,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1322,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1324,
    ["Qlik Talend Cloud Pipeline - Task"] = 1320,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1326,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1325,
    Qodana = 1072,
    ["Qt Creator workspace file"] = 1182,
    ["Quali Torque Blueprint Spec 2"] = 1097,
    ["QueryFirst config file"] = 1116,
    ["QuikRun Configuration"] = 1328,
    ["Qwen Code Settings"] = 1309,
    ["RKE Cluster Configuration JSON"] = 1050,
    ["RKE Cluster Configuration YAML"] = 1049,
    RadioHound = 745,
    ["Raid Profile"] = 1310,
    ["Raid Repo Configuration"] = 1311,
    Railpack = 757,
    Railway = 756,
    ["Rancher Fleet"] = 747,
    ["Rattler-build"] = 758,
    Ray = 1011,
    ["Read the Docs"] = 749,
    ["Red-DiscordBot Cog"] = 765,
    ["Red-DiscordBot Cog Repo"] = 766,
    ["Red-DiscordBot Trivia"] = 767,
    ["Releasaurus Config"] = 6,
    ReleaseKit = 5,
    ["Render Blueprints"] = 1048,
    RenderCV = 784,
    Renovate = 781,
    ["Renovate global configuration"] = 782,
    ["Renovate inherited configuration"] = 783,
    ["Replit config"] = 773,
    Restate = 1238,
    ["Revel Digital Gadget Definition File"] = 1262,
    RoadRunner = 786,
    ["Robust Station Image"] = 1268,
    Rockcraft = 787,
    ["Roo Coder Custom Modes"] = 788,
    Rubocop = 777,
    ["Rudder techniques"] = 1156,
    Ruff = 778,
    ["Rust Project"] = 779,
    ["Rust toolchain"] = 793,
    ["SDMX data message"] = 820,
    ["SDMX metadata message"] = 819,
    ["SDMX structure message"] = 818,
    ["SIL Kit Participant Configuration"] = 830,
    ["SIL Kit Registry Configuration"] = 831,
    ["SPDX 2.3"] = 869,
    SWADL = 885,
    ["Safebox Config"] = 1111,
    ["Sapphire CLI Config"] = 796,
    ["SauceCTL Configuration"] = 1059,
    Scarb = 816,
    ["Schema Catalog"] = 811,
    ["Scoop manifest"] = 817,
    ["Semantic Data Fabric (SDF) file"] = 821,
    ["Semgrep Rule"] = 823,
    ["Serenity Code Generator (Sergen)"] = 824,
    ["Serverless Framework Configuration"] = 1066,
    ["Serverless Workflow"] = 1068,
    ["Settings for a Cinnamon spice"] = 1201,
    ["Settings.paf"] = 826,
    ["Shopware 6 Configuration"] = 1069,
    ["Shopware CLI Extension Store Configuration"] = 1070,
    ["Shopware CLI Project Store Configuration"] = 1071,
    ["Sigma Detection Rule"] = 828,
    ["SigmaCV CV"] = 1,
    ["Sigrid scope configuration file"] = 829,
    ["SkyPilot Task JSON"] = 1157,
    ["Slack app manifest"] = 833,
    Snapcraft = 835,
    ["Solarxy project config"] = 838,
    Solidarity = 839,
    ["Solution filters"] = 840,
    ["Source Maps v3"] = 841,
    Sourcery = 842,
    ["Spack bootstrap.yaml"] = 843,
    ["Spack cdash.yaml"] = 844,
    ["Spack ci.yaml"] = 845,
    ["Spack compilers.yaml"] = 846,
    ["Spack concretizer.yaml"] = 847,
    ["Spack config.yaml"] = 848,
    ["Spack definitions.yaml"] = 849,
    ["Spack develop.yaml"] = 850,
    ["Spack env_vars.yaml"] = 851,
    ["Spack environment"] = 857,
    ["Spack include.yaml"] = 852,
    ["Spack mirrors.yaml"] = 853,
    ["Spack modules.yaml"] = 854,
    ["Spack packages.yaml"] = 855,
    ["Spack repos.yaml"] = 856,
    ["Spack toolchains.yaml"] = 858,
    ["Spack upstreams.yaml"] = 859,
    ["Spack view.yaml"] = 860,
    ["Speakeasy Generation Config File"] = 864,
    ["Speakeasy Lint Configuration File"] = 861,
    ["Speakeasy Test Generation Configuration File"] = 862,
    ["Speakeasy Workflow File"] = 863,
    SpecIF = 865,
    ["Specmatic Configuration"] = 866,
    ["Sponge Mixin configuration"] = 867,
    StackBlitz = 873,
    ["StackHawk Scanner Configuration"] = 1065,
    Stale = 874,
    Starfish = 875,
    ["Starlake Data Pipeline"] = 1037,
    Starship = 876,
    ["Statamic Blueprint"] = 877,
    ["Stella configuration file"] = 878,
    ["Streamlit configuration file"] = 879,
    ["Stryker Mutator"] = 882,
    ["StyleCop Analyzers Configuration"] = 883,
    ["Stylelint (.stylelintrc)"] = 884,
    ["Stylua Config"] = 1252,
    ["Sublime Syntax"] = 1112,
    ["Subsquid squid manifest"] = 1159,
    ["Swagger API 2.0"] = 886,
    ["Synadia Connect Component"] = 887,
    TSON = 923,
    TSTyche = 924,
    ["TYPO3 Vendor Bundler config"] = 930,
    ["Tab data for a LinUtil"] = 1208,
    ["Tab list for a LinUtil"] = 1207,
    Tach = 888,
    ["Tach Domain"] = 889,
    Talhelper = 891,
    ["Talisman configuration"] = 892,
    Taplo = 1253,
    ["Taskfile config"] = 1042,
    Taurus = 893,
    Tauticord = 894,
    ["Tekton Pipeline"] = 1281,
    ["Tekton PipelineRun"] = 1282,
    ["Tekton Task"] = 1279,
    ["Tekton TaskRun"] = 1280,
    Telefonistka = 1239,
    ["Terrateam config"] = 1265,
    ["TestEnvironment.json"] = 906,
    ["TextMate Grammar"] = 905,
    Threagile = 900,
    ["Tier.run pricing.json"] = 897,
    Tikibase = 898,
    Tombi = 903,
    ["Traefik v2"] = 909,
    ["Traefik v2 File Provider"] = 910,
    ["Traefik v3"] = 911,
    ["Traefik v3 File Provider"] = 912,
    ["Travis CI (.travis.yml)"] = 908,
    Treefmt = 457,
    Trident = 1235,
    ["TrueScript for *.tscript files"] = 915,
    ["Tugboat QA config.yml"] = 1232,
    TunnelHub = 1147,
    Turborepo = 907,
    Tycho = 1196,
    Tye = 1073,
    ["Tyk Gateway - Open Source v5.7+"] = 1244,
    ["UET BuildConfig.json"] = 1117,
    ["UI5 Manifest"] = 936,
    ["UNCORS configuration"] = 941,
    ["UTAM Page Object"] = 939,
    ["Ubuntu Server Autoinstall"] = 934,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1236,
    ["Uniswap Token List"] = 1022,
    ["Universal Schedule Format"] = 942,
    ["Unreal Engine Uplugin"] = 1118,
    ["Unreal Engine Uproject"] = 1119,
    ["UpCloud CLI (upctl) configuration"] = 1237,
    ["Updatecli Compose"] = 1081,
    ["Updatecli Policy Manifest"] = 1082,
    ["Updatecli Policy Metadata"] = 1083,
    Uplift = 1115,
    ["Upsun config"] = 8,
    ["User Journey Map"] = 1047,
    V2Ray = 1087,
    ["VSCode Code Snippets"] = 261,
    ["VSIX CLI publishing"] = 960,
    Vector = 944,
    ["Vela Pipeline Configuration"] = 947,
    Vercel = 260,
    ["Version Bumper config"] = 950,
    Vespertide = 1286,
    ["Vespertide Migration"] = 1287,
    ["Vespertide Model"] = 1288,
    ["Viash Component Config"] = 1241,
    ["Viash Package Config"] = 1242,
    Visivo = 1145,
    ["WP-CLI"] = 970,
    Wake = 1234,
    ["Waku Config"] = 1211,
    ["Web App Manifest"] = 966,
    ["Web types"] = 969,
    WebExtensions = 965,
    ["Webman package recipe"] = 1093,
    ["Windows Package Manager Installer Manifest"] = 1019,
    ["Windows Package Manager Locale Manifest"] = 1020,
    ["Windows Package Manager Singleton Manifest"] = 1018,
    ["WireMock CLI import configuration"] = 1217,
    ["WireMock CLI local service configuration"] = 1216,
    ["WireMock message stub mapping"] = 1215,
    ["WireMock stub mapping"] = 1214,
    ["Woodpecker pipeline config"] = 1061,
    ["Wrangler CLI"] = 971,
    ["XenForo add-on manifest"] = 972,
    ["Xstate Machine"] = 1079,
    ["Yandex Workflow Language"] = 1203,
    ["Yarn Config (.yarnrc.yml)"] = 1035,
    ["Yippee-Ki-JSON configuration YML"] = 1026,
    ["YouTrack App"] = 1200,
    ["Zarf Package Configuration"] = 1267,
    ["Zerops import file"] = 1188,
    ["Zola Configuration"] = 1278,
    ["aerleon.yml"] = 22,
    ["amplify.yml"] = 15,
    ["amxx-builder manifest"] = 1330,
    ["angular.json"] = 39,
    apko = 1150,
    ...
    ["behat.yml"] = 146,
    ["bigquery-table"] = 135,
    ["bioimageio resource description"] = 1167,
    ...
    ["cargo-nextest repository configuration"] = 620,
    ["cargo-nextest user configuration"] = 621,
    ["ccmod.json"] = 1212,
    changelogging = 1179,
    ["chisel-slices.json"] = 287,
    ["chrome-extension-locales-messages.json"] = 268,
    ["chutzpah.json"] = 269,
    cibuildwheel = 183,
    ["clang-format (.clang-format)"] = 1085,
    ["clang-tidy"] = 245,
    clangd = 244,
    clib = 246,
    ["cloud-init: cloud-config userdata"] = 248,
    ["cloud-sdk-pipeline-configuration"] = 271,
    ["cloudbuild.json"] = 272,
    cloudify = 247,
    cmakefmt = 201,
    ["cmdx.yaml"] = 99,
    ...
    ["coffeelint.json"] = 289,
    ["commands.json"] = 264,
    ["commitlint (.commitlintrc)"] = 1021,
    ["committed.toml"] = 290,
    ["compile_commands.json"] = 263,
    ["compilerconfig.json"] = 262,
    ["completely.yml"] = 1123,
    ["component-detection-manifest.json"] = 293,
    ["component.json"] = 292,
    ["composer.json"] = 291,
    ["conda-forge"] = 187,
    ["config.yaml"] = 748,
    ["contentmanifest.json"] = 270,
    ["contribute.json"] = 294,
    ["cosmos.config.json"] = 266,
    ["crowdin.yml"] = 295,
    ["ctfd-setup configuration file"] = 1224,
    ["custom-elements.json"] = 1137,
    ["cypress.json"] = 299,
    ["dacier.yml"] = 1318,
    ["datalogic-scan2deploy-android"] = 309,
    ["datalogic-scan2deploy-ce"] = 310,
    ...
    ["ddev-global"] = 311,
    ["ddev-project"] = 312,
    ["debugsettings.json"] = 313,
    ["dependabot-v2.json"] = 316,
    ["dependabot.json"] = 315,
    ["deployed-cli"] = 1078,
    ...
    djlint = 1029,
    ["docker bake"] = 322,
    ["docker sequencer"] = 323,
    ["docker-compose.yml"] = 1027,
    ["dockerd.json"] = 320,
    ["dotnet Release Index manifest"] = 335,
    ["dotnet-tools.json"] = 336,
    ["dotnetcli.host.json"] = 337,
    ["dprint.json"] = 338,
    ["drone.json"] = 339,
    ["dss-2.0.0.json"] = 341,
    ["dstack configuration"] = 342,
    ["dtool dataset metadata"] = 1219,
    ["dvc.yaml"] = 343,
    ["ecosystem.json"] = 348,
    eksctl = 350,
    ["electron-builder configuration file"] = 376,
    ["epr-manifest.json"] = 375,
    ["estampo.toml"] = 374,
    ["evcc.yaml"] = 377,
    ["ezd task runner"] = 388,
    ["fabric.mod.json"] = 391,
    ["first-timers-bot"] = 399,
    ["flagd flag configuration"] = 121,
    ["fly.io Configuration"] = 122,
    fulibWorkflows = 1060,
    ["function.json"] = 411,
    ["gRPC API Gateway & OpenAPI Config"] = 17,
    ["gematik health care insurance list"] = 1230,
    ["gematik health care patient list"] = 1227,
    ["gematik health care provider institution list"] = 1229,
    ["gematik health care provider list"] = 1228,
    ["gematik tiger test environment configuration"] = 1231,
    ["git-town.toml"] = 1276,
    ["gitlab-ci"] = 431,
    ["global.json"] = 447,
    ["go-feature-flag Flag Configuration"] = 450,
    ["haxelib.json"] = 469,
    helmfile = 1014,
    helmwave = 1015,
    ["host-meta.json"] = 476,
    ...
    ["ide.host.json"] = 484,
    ["ifstate.yaml"] = 485,
    ["imageoptimizer.json"] = 486,
    ["importmap.json"] = 489,
    instant_python_config = 493,
    instant_python_custom_project = 494,
    intlayer = 495,
    ["ioBroker Configuration"] = 496,
    ["ioBroker JSON UI"] = 497,
    ["ioBroker Package manifest"] = 498,
    ["ixpect.conf.yaml"] = 499,
    ["ize.toml"] = 1114,
    ["jsconfig.json"] = 524,
    ["jscpd Configuration"] = 1098,
    jsdoc = 1010,
    ["k3d.yaml"] = 525,
    ["k9s aliases.yaml"] = 527,
    ["k9s cluster-config.yaml"] = 529,
    ["k9s config.yaml"] = 528,
    ["k9s hotkeys.yaml"] = 530,
    ["k9s plugins.yaml"] = 531,
    ["k9s skin.yaml"] = 532,
    ["k9s views.yaml"] = 533,
    ["kontinuous-config.yaml"] = 545,
    ["kontinuous-values.yaml"] = 544,
    ["kustomization.yaml"] = 547,
    ["label-commenter-config.yml"] = 548,
    ["latexindent configuration"] = 114,
    ["launchsettings.json"] = 549,
    lazydocker = 1136,
    lazygit = 1135,
    ["lego.json"] = 551,
    ["lerna.json"] = 552,
    ["lgtm.yml"] = 553,
    ["liblab.config.json"] = 554,
    ["libman.json"] = 555,
    ["license-report-config.json"] = 556,
    ["linkinator.config.json"] = 558,
    ["lint-staged (.lintstagedrc)"] = 988,
    ["local.settings.json"] = 563,
    ["localazy.json"] = 564,
    ["lotus.yaml"] = 562,
    ["lsdlschema.json"] = 565,
    ["macro.json"] = 1102,
    ["markdown-link-check"] = 1056,
    maturin = 1057,
    mboats = 1064,
    memnex = 1316,
    ["micro-settings.json"] = 1129,
    ["mimetypes.json"] = 580,
    ["mirrord config"] = 990,
    mise = 991,
    ["mkdocs.yml"] = 600,
    ...
    ["monospace.yml"] = 606,
    ["moon.yml"] = 1213,
    ["mprocs Configuration file"] = 1183,
    ["mrdocs.yml"] = 602,
    ["mta.yaml"] = 992,
    ["mtad.yaml"] = 993,
    ["mycode.json"] = 613,
    nFPM = 622,
    ["napari plugin manifest"] = 614,
    neoload = 1005,
    ["nest-cli"] = 625,
    ["nexus-rpc-gen"] = 1303,
    ["ninjs (News in JSON)"] = 624,
    ["nitro.json"] = 1004,
    ["nixd configuration"] = 1155,
    ["nlu.json"] = 626,
    ["nodemon.json"] = 628,
    ["noodl config"] = 1063,
    ["notebook.mod.json"] = 629,
    now = 1000,
    ["npm-badges"] = 632,
    ["nswag.json"] = 636,
    ntangle = 638,
    ["nuclei-template.yaml"] = 633,
    ["nuget-project.json"] = 634,
    ["ocelot.json"] = 640,
    ogen = 643,
    ["omnisharp.json"] = 646,
    openHAB = 1289,
    ...
    oxlint = 1300,
    ["package.json"] = 681,
    ["package.manifest"] = 683,
    ["package.yaml"] = 682,
    ["partial-black.json"] = 147,
    ["partial-fastapi.json"] = 148,
    ["partial-pixi.json"] = 693,
    ["partial-scheduled.json"] = 149,
    ["pattern.json"] = 691,
    ["petstore-v1.0"] = 1109,
    pgap_yaml_input_reader = 689,
    pgrls = 690,
    pgxgen = 1293,
    pitcms = 1296,
    ["pixi.toml"] = 692,
    ["plagiarize-me.yaml"] = 697,
    ["plagiarize.yaml"] = 696,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1220,
    ["podbard.yaml"] = 699,
    ["portman.json"] = 702,
    ["prefect.toml"] = 711,
    ["prefect.yaml"] = 712,
    ...
    ["prettierrc.json"] = 714,
    ["prisma.yml"] = 715,
    ["project-1.0.0-beta3.json"] = 727,
    ["project-1.0.0-beta4.json"] = 728,
    ["project-1.0.0-beta5.json"] = 729,
    ["project-1.0.0-beta6.json"] = 730,
    ["project-1.0.0-beta8.json"] = 731,
    ["project-1.0.0-rc1.json"] = 732,
    ["project-1.0.0-rc2.json"] = 733,
    ["project.json"] = 726,
    ["project.owasp.yaml"] = 734,
    ["prometheus-alertmanager.json"] = 738,
    ["prometheus.json"] = 735,
    ["prometheus.rules.json"] = 736,
    ["prometheus.rules.test.json"] = 737,
    ["proxies.json"] = 739,
    ["publiccode.yml"] = 740,
    ["pubspec.yaml"] = 741,
    ["pyrseas-0.8.json"] = 744,
    pytest = 753,
    ["quilt.mod.json"] = 1130,
    ["rc3 auth"] = 759,
    ["rc3 collection"] = 760,
    ...
    ["rc3 settings"] = 764,
    ["registry.yaml"] = 52,
    ["release drafter"] = 1006,
    ["release-hub.json"] = 4,
    ["release-please-config.json"] = 769,
    ["release-please-manifest.json"] = 770,
    ["release-plz.toml"] = 771,
    ["renv.lock"] = 785,
    ["reposets Configuration"] = 774,
    ["reposets Credentials"] = 775,
    ["revola.json"] = 2,
    ["rivet.json"] = 1154,
    ["rivet.yaml (legacy)"] = 1153,
    rumdl = 790,
    runny = 789,
    runspec = 1317,
    rustfmt = 791,
    ...
    samt = 794,
    samtrc = 795,
    ["sarif-1.0.0.json"] = 797,
    ["sarif-2.0.0.json"] = 798,
    ["sarif-2.1.0"] = 808,
    ["sarif-2.1.0-rtm.2"] = 799,
    ["sarif-2.1.0-rtm.3"] = 801,
    ["sarif-2.1.0-rtm.4"] = 803,
    ["sarif-2.1.0-rtm.5"] = 805,
    ["sarif-2.1.0-rtm.6"] = 806,
    ["sarif-external-property-file-2.1.0"] = 809,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 800,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 802,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 804,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 807,
    ["scalingo.json configuration"] = 810,
    ["schema.org - Action"] = 812,
    ["schema.org - ContactPoint"] = 813,
    ["schema.org - Place"] = 814,
    ["schema.org - Thing"] = 815,
    ["secrethub.yml"] = 1132,
    ["semantic-release"] = 822,
    ["servicehub.config.json"] = 983,
    ["servicehub.service.json"] = 982,
    ["settings.job"] = 825,
    ["sfdx-hardis configuration"] = 827,
    ["shard.yml"] = 1170,
    ["size-limit configuration"] = 832,
    ["skaffold.yaml"] = 1054,
    ["skyuxconfig.json"] = 834,
    ["snowflake-config"] = 836,
    ["snowflake-connections"] = 837,
    ["spicepod.yaml"] = 1191,
    ["sqlc configuration"] = 870,
    ["stripe-app-local.json"] = 881,
    ["stripe-app.json"] = 880,
    swcrc = 1038,
    ["task.json"] = 890,
    taskcat = 1001,
    ["template.json"] = 895,
    ["templatsources.json"] = 896,
    ["text2confl config"] = 1301,
    ["theme.json"] = 899,
    ["tizen_workspace.json"] = 901,
    tldr = 902,
    ["tm_devices configuration file"] = 1258,
    tmuxinator = 986,
    tox = 904,
    ["transcend.yml"] = 913,
    ["tree-sitter grammar.json"] = 456,
    ["trime.yaml"] = 914,
    ["trunk.yaml"] = 916,
    ["ts-force-config.json"] = 921,
    ["tsconfig.json"] = 917,
    ["tsd.json"] = 918,
    ["tsdoc.json"] = 919,
    ["tsdrc.json"] = 920,
    ...
    v8r = 964,
    vcluster = 1177,
    ["vcpkg configuration file"] = 259,
    ["vcpkg manifest file"] = 258,
    ["vega-lite.json"] = 946,
    ["vega.json"] = 945,
    ["venvironment.yaml"] = 948,
    ["venvplus.yaml"] = 949,
    version = 1240,
    ["version.json"] = 951,
    ["vhwdebugger-binding.yaml"] = 953,
    ["vim-addon-info"] = 954,
    ["vs-2017.3.host.json"] = 956,
    ["vs-nesting.json"] = 957,
    ["vsls.json"] = 955,
    ["vss-extension.json"] = 961,
    vtcfg = 1246,
    ["vtesttree.yaml"] = 962,
    ["vtestunit.yaml"] = 963,
    ["warp-keysets.json"] = 1138,
    ["warp-themes.json"] = 1139,
    ["warp-workflows.json"] = 1140,
    ["webhint.io"] = 1094,
    ["webjobpublishsettings.json"] = 968,
    ["webjobs-list.json"] = 967,
    ["well-known-fursona"] = 1178,
    ["xs-app.json"] = 996,
    ["xunit.runner.json"] = 981,
    yamlfmt = 1023,
    yamllint = 1024,
    ["yap.json"] = 1025,
    ["zerops.yml"] = 1187,
