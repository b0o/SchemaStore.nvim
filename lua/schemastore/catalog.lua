...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 936,
    [".nodehawkrc"] = 580,
    [".npmpackagejsonlintrc"] = 584,
    [".omletrc"] = 1115,
    [".phrase.yml"] = 657,
    [".phraseapp.yml"] = 658,
    [".pmbot.yml"] = 643,
    [".postcssrc"] = 652,
    [".powerpages-web-template-manifest"] = 654,
    [".pre-commit-config.yml"] = 655,
    [".pre-commit-hooks.yml"] = 656,
    [".putout.json"] = 691,
    [".rehyperc"] = 716,
    [".remarkrc"] = 720,
    [".sprite files"] = 811,
    ...
    AIConfig = 34,
    ["AMX Muse Program Descriptor"] = 1163,
    ["API Builder"] = 971,
    ["AVA Configuration"] = 1034,
    ...
    ["AWS Copilot Manifest"] = 1202,
    ["AWS SAM CLI Samconfig"] = 263,
    ["Adobe UXP Manifest"] = 1097,
    ["Aerleon Network & Service Definitions"] = 20,
    ["Aerleon Policy"] = 21,
    ["AgentCore CLI"] = 1242,
    Aider = 1192,
    Air = 23,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1213,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1212,
    ["Airlock Microgateway"] = 35,
    ["Alacritty Configuration"] = 1006,
    ["All Contributors configuration file"] = 1060,
    ...
    ["Application list for a WinUtil"] = 1142,
    ArchitectFX = 1147,
    ["Argo CD"] = 54,
    ["Argo Events"] = 55,
    ["Argo Workflows"] = 56,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1211,
    ["Azure IoT Operations connector metadata"] = 1208,
    ...
    ["Azure Pipelines"] = 112,
    ["Azure Static Web Apps CLI configuration file"] = 815,
    ["Azure Static Web Apps configuration file"] = 814,
    BMML = 1230,
    ["BOSH CPI Config"] = 137,
    ...
    ["Bacon config"] = 5,
    ["Barba-CV"] = 83,
    ["Bashly (bashly.yml)"] = 1064,
    ["Bashly Settings (bashly-settings.yml)"] = 1065,
    Bento = 1229,
    ["Better Code Hub"] = 976,
    ["Better Scripts"] = 158,
    Bigconfig = 130,
    ["Biome Formatter Config"] = 84,
    ["Bitmovin Encoding Template"] = 1156,
    BizTalkServerApplicationSchema = 943,
    Bleep = 159,
    ["Block Protocol Metadata"] = 156,
    ["Bluebricks blueprint config"] = 1235,
    ["Boyka Framework"] = 139,
    Briefcase = 949,
    ["Build Info"] = 147,
    Buildkite = 149,
    ...
    ["Butane Config"] = 1019,
    C4InterFlow = 1171,
    ["CDK Environment Manager, concrete environment configuration"] = 1195,
    ["CDK Environment Manager, concrete environments definition"] = 1194,
    ["CDK Environment Manager, environment definition"] = 1193,
    ["CGS Card Game Specification (cgs.json)"] = 1102,
    ["CICS TS region tagging"] = 1028,
    ["CICS TS resource import"] = 1029,
    ["CICS TS resource model"] = 1030,
    ["CICS TS resource overrides"] = 1031,
    ["CMake Presets"] = 160,
    ["CNC Codes"] = 182,
    ["CRS WAF test file"] = 1132,
    ["CRS WAF test platform overrides file"] = 1133,
    ...
    ["Chamaleon environment"] = 1160,
    ["Chamaleon properties"] = 1161,
    ["Chamaleon template"] = 1159,
    Changepacks = 1222,
    Changesets = 272,
    Changie = 169,
    Charmcraft = 170,
    ...
    ["Clawject config"] = 188,
    ["Cloud Foundry Application Manifest"] = 1114,
    ["Cloud Run Spec v1"] = 1137,
    ...
    Concord = 1131,
    ["Configu .cfgu files"] = 1119,
    ["Configu .configu file"] = 1120,
    Conjure = 181,
    ["Container Structure Test"] = 957,
    Containerlab = 985,
    ["Contextive Glossary"] = 1187,
    Convex = 180,
    ["Crowdsec collection config"] = 282,
    ["Crowdsec parser config"] = 283,
    ["Crowdsec scenario config"] = 284,
    ["CumulusCI Config"] = 187,
    ["Cursor Agent Environment"] = 1240,
    ["Custom Machinery Machine"] = 1103,
    ["Custom Machinery Recipe"] = 1104,
    ...
    ["DonateCaseBetterCasino menu"] = 1164,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1072,
    ["EAS config"] = 351,
    ["ECA - Editor Code Assistant"] = 335,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1061,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1207,
    ["EasyVCR .NET"] = 352,
    ["Eidolon Resource"] = 1148,
    ...
    ["Erda Pipeline"] = 1110,
    ["Erda Runtime"] = 1111,
    ["Espanso config.yml"] = 1233,
    ["Espanso match.yml"] = 1232,
    Esquio = 340,
    ["Estuary Flow Catalog"] = 1025,
    ...
    ["Evolving Resolutive Process notation"] = 1209,
    ["Expo SDK"] = 350,
    ...
    ["GeoJSON.json latest"] = 1023,
    GherKing = 1027,
    ["GitHub Action"] = 385,
    ["GitHub Actions typing"] = 1144,
    ...
    ["Google Digital Assetlinks"] = 1188,
    Goreleaser = 413,
    ["Goreleaser Pro"] = 414,
    Goss = 415,
    ["Gradle Build Cache Node"] = 974,
    ["Gradle Enterprise"] = 973,
    ...
    Hadolint = 953,
    Hammerkit = 984,
    ["Hardware Sentry Configuration"] = 1039,
    ...
    ["JFrog File Spec"] = 466,
    ["JFrog Pipelines YML DSL"] = 1049,
    ["JMeter DSL cli config"] = 467,
    JReleaser = 470,
    ["JSON Document Transform"] = 478,
    ["JSON Feed"] = 479,
    ["JSON Resume"] = 726,
    ["JSON Schema Draft 2020-12"] = 921,
    ["JSON Schema Draft 4"] = 918,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1082,
    ["JSON Schema Draft 7"] = 919,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1083,
    ["JSON Schema Draft 8 (2019-09)"] = 920,
    ["JSON-API"] = 477,
    ["JSON-e templates"] = 981,
    ["JSON-stat 2.0"] = 914,
    JSONPatch = 481,
    ...
    ["Jujutsu (jj) VCS config"] = 1201,
    ["KIMMDY config file"] = 492,
    ["KODE/CI build.yaml"] = 1045,
    ["KSP-AVC"] = 915,
    ["KSP-CKAN"] = 916,
    ["KSP-NetKAN"] = 917,
    KSY = 1112,
    ...
    ["Lando (landofile)"] = 108,
    ["LangGraph Platform configuration"] = 1124,
    ["Language configuration"] = 1123,
    Lefthook = 507,
    ["Liferay client-extension.yaml"] = 514,
    ["LinkML Metamodel"] = 516,
    Liquibase = 990,
    ["Liquibase Flow File"] = 991,
    ["Lively Properties"] = 517,
    ["Lobe AI Agent"] = 110,
    Loki = 111,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 559,
    ["MS2Rescore Configuration"] = 563,
    ["Madness (madness.yml)"] = 1063,
    ["Mado configuration"] = 524,
    ["Maestro Flow"] = 525,
    ["Mail Servers Configuration"] = 1236,
    ["MapEHR Mapping"] = 526,
    Markdownlint = 994,
    ["Mason Registry"] = 997,
    ...
    ["Mergify Configuration"] = 564,
    ["Metadata for a Bazel module"] = 532,
    ["Metadata for a Cinnamon spice"] = 1140,
    ["Metatype Configuration"] = 533,
    ["MetricsHub Configuration"] = 534,
    ["MetricsHub Connector Configuration"] = 535,
    ["Micro Editor Syntax"] = 1073,
    ["Microsoft Band Web Tile"] = 536,
    ["Microsoft RulesEngine workflow rules"] = 1128,
    ["Microsoft RulesEngine workflow rules list"] = 1129,
    ["Minecraft Custom Main Menu Mod"] = 1091,
    ...
    ["Monade CLI Stack Configuration"] = 567,
    ["MongoDB Atlas Search Index Definition"] = 1044,
    ["Monika Configuration"] = 1042,
    ["Monoweave Configuration"] = 562,
    ["Motif config"] = 935,
    MultiQC = 1181,
    ["NOX Framework (Service)"] = 583,
    ["Netin Diagnostic System Template"] = 1001,
    ["Netlify config"] = 570,
    ["Network-as-Code Data Model"] = 571,
    ["Next Gen UI Agent A2A Server Configuration"] = 572,
    ["Next Gen UI Agent Configuration"] = 574,
    ["Next Gen UI Agent MCP Server Configuration"] = 573,
    ["Nightwatch.js"] = 576,
    ["Node.js configuration"] = 940,
    ["NueJS configuration file"] = 588,
    ["Nuitka.yaml"] = 1105,
    ["Nullstone config"] = 590,
    ["ONe's changelog entry"] = 609,
    ["ONe's service descriptor"] = 608,
    ["ORT Server repository environment configuration"] = 619,
    ["OSCAL Assessment Plan (AP)"] = 621,
    ["OSCAL Assessment Results (AR)"] = 622,
    ["OSCAL Catalog"] = 623,
    ["OSCAL Component Definition (CDef)"] = 624,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 625,
    ["OSCAL Profile"] = 626,
    ["OSCAL System Security Plan (SSP)"] = 627,
    ["OSS Review Toolkit configuration"] = 628,
    ["OSS Review Toolkit curation"] = 629,
    ["OSS Review Toolkit package configuration"] = 630,
    ["OSS Review Toolkit repository configuration"] = 631,
    ["OSS Review Toolkit resolutions"] = 632,
    ["October CMS columns"] = 594,
    ["October CMS fields"] = 595,
    ["Oh My Posh"] = 597,
    Okteto = 598,
    ["Ona Automations"] = 600,
    Opctl = 938,
    ["Open Data Contract Standard (ODCS)"] = 613,
    ["Open Data Product Standard (ODPS)"] = 614,
    ["Open Know-How"] = 1186,
    ["OpenRewrite Resource"] = 611,
    OpenSRM = 615,
    OpenStatus = 1197,
    ["OpenTelemetry Declarative Configuration"] = 612,
    ["OpenUtau character yaml"] = 605,
    ["OpenUtau ustx"] = 606,
    ["OpenWeather Current Weather API"] = 980,
    ["OpenWeather Road Risk API"] = 979,
    ["Ory Hydra configuration"] = 440,
    ["Ory Keto configuration"] = 500,
    ["Ory Kratos configuration"] = 620,
    ["Ory Oathkeeper configuration"] = 592,
    ["Outblocks App configuration"] = 617,
    ["Outblocks database table"] = 618,
    ["Outblocks project configuration"] = 616,
    PDM = 638,
    POPxf = 649,
    ["POPxf Correlations"] = 650,
    Packer = 636,
    Pantsbuild = 1059,
    ["Paper paper-plugin.yml"] = 637,
    ["Pipeline component"] = 992,
    ["Platform.sh application"] = 7,
    ["Platform.sh routes"] = 8,
    ["Platform.sh services"] = 9,
    ["Plex Prerolls"] = 647,
    ["PocketMine plugin.yml"] = 644,
    ["Postman collection"] = 653,
    ["Power Pages Configuration"] = 1198,
    ["Preset list for a WinUtil"] = 1143,
    ["ProActions AI-Kit Configuration"] = 664,
    ["ProActions AI-Kit Configuration for Menus"] = 666,
    ["ProActions AI-Kit Configuration for Sections"] = 668,
    ["ProActions AI-Kit Configuration for Services"] = 665,
    ["ProActions AI-Kit Configuration for Steps"] = 669,
    ["ProActions AI-Kit Configuration for Templates"] = 667,
    ["Problem object RFC9457"] = 1088,
    ["Problem package format"] = 670,
    ["Problem package generators"] = 671,
    ["Problem package submissions"] = 672,
    ["Problem package test group metadata"] = 673,
    Pterodactyl = 1038,
    ["Pull Request Labeler"] = 690,
    Pulumi = 698,
    ["PyGTA Config"] = 694,
    PyProject = 699,
    Pylock = 1189,
    Pyright = 700,
    ["Python script metadata"] = 1183,
    ["QType AI DSL"] = 703,
    Qgoda = 702,
    Qodana = 1011,
    ["Qt Creator workspace file"] = 1121,
    ["Quali Torque Blueprint Spec 2"] = 1036,
    ["QueryFirst config file"] = 1055,
    ["RKE Cluster Configuration JSON"] = 989,
    ["RKE Cluster Configuration YAML"] = 988,
    RadioHound = 693,
    Railpack = 705,
    Railway = 704,
    ["Rancher Fleet"] = 695,
    ...
    Ray = 952,
    ["Read the Docs"] = 697,
    ["Red-DiscordBot Cog"] = 713,
    ["Red-DiscordBot Cog Repo"] = 714,
    ["Red-DiscordBot Trivia"] = 715,
    ["Releasaurus Config"] = 4,
    ReleaseKit = 3,
    ["Render Blueprints"] = 987,
    RenderCV = 730,
    Renovate = 727,
    ["Renovate global configuration"] = 728,
    ["Renovate inherited configuration"] = 729,
    ["Replit config"] = 721,
    Restate = 1176,
    ["Revel Digital Gadget Definition File"] = 1200,
    RoadRunner = 732,
    ["Robust Station Image"] = 1206,
    Rockcraft = 733,
    ["Roo Coder Custom Modes"] = 734,
    Rubocop = 723,
    ["Rudder techniques"] = 1095,
    Ruff = 724,
    ["Rust Project"] = 725,
    ["Rust toolchain"] = 738,
    ["SDMX data message"] = 764,
    ["SDMX metadata message"] = 763,
    ["SDMX structure message"] = 762,
    ["SIL Kit Participant Configuration"] = 774,
    ["SIL Kit Registry Configuration"] = 775,
    ["SPDX 2.3"] = 812,
    SWADL = 828,
    ["Safebox Config"] = 1050,
    ["Sapphire CLI Config"] = 741,
    ["SauceCTL Configuration"] = 998,
    ["Schema Catalog"] = 756,
    ["Scoop manifest"] = 761,
    ["Semantic Data Fabric (SDF) file"] = 765,
    ["Semgrep Rule"] = 767,
    ["Serenity Code Generator (Sergen)"] = 768,
    ["Serverless Framework Configuration"] = 1005,
    ["Serverless Workflow"] = 1007,
    ["Settings for a Cinnamon spice"] = 1139,
    ["Settings.paf"] = 770,
    ["Shopware 6 Configuration"] = 1008,
    ["Shopware CLI Extension Store Configuration"] = 1009,
    ["Shopware CLI Project Store Configuration"] = 1010,
    ["Sigma Detection Rule"] = 772,
    ["Sigrid scope configuration file"] = 773,
    ["SkyPilot Task JSON"] = 1096,
    ["Slack app manifest"] = 777,
    Snapcraft = 779,
    Solidarity = 782,
    ["Solution filters"] = 783,
    ["Source Maps v3"] = 784,
    Sourcery = 785,
    ["Spack bootstrap.yaml"] = 786,
    ["Spack cdash.yaml"] = 787,
    ["Spack ci.yaml"] = 788,
    ["Spack compilers.yaml"] = 789,
    ["Spack concretizer.yaml"] = 790,
    ["Spack config.yaml"] = 791,
    ["Spack definitions.yaml"] = 792,
    ["Spack develop.yaml"] = 793,
    ["Spack env_vars.yaml"] = 794,
    ["Spack environment"] = 800,
    ["Spack include.yaml"] = 795,
    ["Spack mirrors.yaml"] = 796,
    ["Spack modules.yaml"] = 797,
    ["Spack packages.yaml"] = 798,
    ["Spack repos.yaml"] = 799,
    ["Spack toolchains.yaml"] = 801,
    ["Spack upstreams.yaml"] = 802,
    ["Spack view.yaml"] = 803,
    ["Speakeasy Generation Config File"] = 807,
    ["Speakeasy Lint Configuration File"] = 804,
    ["Speakeasy Test Generation Configuration File"] = 805,
    ["Speakeasy Workflow File"] = 806,
    SpecIF = 808,
    ["Specmatic Configuration"] = 809,
    ["Sponge Mixin configuration"] = 810,
    StackBlitz = 816,
    ["StackHawk Scanner Configuration"] = 1004,
    Stale = 817,
    Starfish = 818,
    ["Starlake Data Pipeline"] = 977,
    Starship = 819,
    ["Statamic Blueprint"] = 820,
    ["Stella configuration file"] = 821,
    ["Streamlit configuration file"] = 822,
    ["Stryker Mutator"] = 825,
    ["StyleCop Analyzers Configuration"] = 826,
    ["Stylelint (.stylelintrc)"] = 827,
    ["Stylua Config"] = 1190,
    ["Sublime Syntax"] = 1051,
    ["Subsquid squid manifest"] = 1098,
    ["Swagger API 2.0"] = 829,
    ["Synadia Connect Component"] = 830,
    TSON = 866,
    TSTyche = 867,
    ["TYPO3 Vendor Bundler config"] = 873,
    ["Tab data for a LinUtil"] = 1146,
    ["Tab list for a LinUtil"] = 1145,
    Tach = 831,
    ["Tach Domain"] = 832,
    Talhelper = 834,
    ["Talisman configuration"] = 835,
    Taplo = 1191,
    ["Taskfile config"] = 982,
    Taurus = 836,
    Tauticord = 837,
    ["Tekton Pipeline"] = 1219,
    ["Tekton PipelineRun"] = 1220,
    ["Tekton Task"] = 1217,
    ["Tekton TaskRun"] = 1218,
    Telefonistka = 1177,
    ["Terrateam config"] = 1203,
    ["TestEnvironment.json"] = 849,
    ["TextMate Grammar"] = 848,
    Threagile = 843,
    ["Tier.run pricing.json"] = 840,
    Tikibase = 841,
    Tombi = 846,
    ["Traefik v2"] = 852,
    ["Traefik v2 File Provider"] = 853,
    ["Traefik v3"] = 854,
    ["Traefik v3 File Provider"] = 855,
    ["Travis CI (.travis.yml)"] = 851,
    Treefmt = 418,
    Trident = 1173,
    ["TrueScript for *.tscript files"] = 858,
    ["Tugboat QA config.yml"] = 1170,
    TunnelHub = 1086,
    Turborepo = 850,
    Tycho = 1135,
    Tye = 1012,
    ["Tyk Gateway - Open Source v5.7+"] = 1182,
    ["UET BuildConfig.json"] = 1056,
    ["UI5 Manifest"] = 879,
    ["UNCORS configuration"] = 883,
    ["UTAM Page Object"] = 882,
    ["Ubuntu Server Autoinstall"] = 877,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1174,
    ["Uniswap Token List"] = 964,
    ["Universal Schedule Format"] = 884,
    ["Unreal Engine Uplugin"] = 1057,
    ["Unreal Engine Uproject"] = 1058,
    ["UpCloud CLI (upctl) configuration"] = 1175,
    ["Updatecli Compose"] = 1020,
    ["Updatecli Policy Manifest"] = 1021,
    ["Updatecli Policy Metadata"] = 1022,
    Uplift = 1054,
    ["Upsun config"] = 6,
    ["User Journey Map"] = 986,
    V2Ray = 1026,
    ["VSCode Code Snippets"] = 247,
    ["VSIX CLI publishing"] = 902,
    Vector = 886,
    ["Vela Pipeline Configuration"] = 889,
    Vercel = 246,
    ["Version Bumper config"] = 892,
    Vespertide = 1224,
    ["Vespertide Migration"] = 1225,
    ["Vespertide Model"] = 1226,
    ["Viash Component Config"] = 1179,
    ["Viash Package Config"] = 1180,
    Visivo = 1084,
    ["WP-CLI"] = 912,
    Wake = 1172,
    ["Waku Config"] = 1149,
    ["Web App Manifest"] = 908,
    ["Web types"] = 911,
    WebExtensions = 907,
    ["Webman package recipe"] = 1032,
    ["Windows Package Manager Installer Manifest"] = 960,
    ["Windows Package Manager Locale Manifest"] = 961,
    ["Windows Package Manager Singleton Manifest"] = 959,
    Winutil = 962,
    ["WireMock CLI import configuration"] = 1155,
    ["WireMock CLI local service configuration"] = 1154,
    ["WireMock message stub mapping"] = 1153,
    ["WireMock stub mapping"] = 1152,
    ["Woodpecker pipeline config"] = 1000,
    ["Wrangler CLI"] = 913,
    ["Xstate Machine"] = 1018,
    ["Yandex Workflow Language"] = 1141,
    ["Yarn Config (.yarnrc.yml)"] = 975,
    ["Yippee-Ki-JSON configuration YML"] = 966,
    ["YouTrack App"] = 1138,
    ["Zarf Package Configuration"] = 1205,
    ["Zerops.io config"] = 1126,
    ["Zerops.io import"] = 1127,
    ["Zola Configuration"] = 1216,
    ["aerleon.yml"] = 19,
    ["amplify.yml"] = 12,
    ["angular.json"] = 36,
    apko = 1089,
    ...
    ["behat.yml"] = 140,
    ["bigquery-table"] = 129,
    ["bioimageio resource description"] = 1106,
    ...
    ["chutzpah.json"] = 255,
    cibuildwheel = 175,
    ["clang-format (.clang-format)"] = 1024,
    ["clang-tidy"] = 233,
    clangd = 232,
    clib = 234,
    ...
    ["crowdin.yml"] = 281,
    ["ctfd-setup configuration file"] = 1162,
    ["custom-elements.json"] = 1076,
    ["cypress.json"] = 285,
    ...
    ["gematik health care insurance list"] = 1168,
    ["gematik health care patient list"] = 1165,
    ["gematik health care provider institution list"] = 1167,
    ["gematik health care provider list"] = 1166,
    ["gematik tiger test environment configuration"] = 1169,
    ["git-town.toml"] = 1214,
    ["gitlab-ci"] = 393,
    ["global.json"] = 409,
    ...
    ["lint-staged (.lintstagedrc)"] = 929,
    ["local.settings.json"] = 520,
    ["localazy.json"] = 521,
    ["lotus.yaml"] = 519,
    ["lsdlschema.json"] = 522,
    ["macro.json"] = 1041,
    ["markdown-link-check"] = 995,
    maturin = 996,
    mboats = 1003,
    ["micro-settings.json"] = 1068,
    ["mimetypes.json"] = 537,
    ["mirrord config"] = 931,
    mise = 932,
    ["mkdocs.yml"] = 557,
    ...
    ["monospace.yml"] = 561,
    ["moon.yml"] = 1151,
    ["mprocs Configuration file"] = 1122,
    ["mrdocs.yml"] = 558,
    ["mta.yaml"] = 933,
    ["mtad.yaml"] = 934,
    ["mycode.json"] = 568,
    nFPM = 575,
    ["napari plugin manifest"] = 569,
    neoload = 946,
    ["nest-cli"] = 578,
    ["nexus-rpc-gen"] = 1241,
    ["ninjs (News in JSON)"] = 577,
    ["nitro.json"] = 945,
    ["nixd configuration"] = 1094,
    ["nlu.json"] = 579,
    ["nodemon.json"] = 581,
    ["noodl config"] = 1002,
    ["notebook.mod.json"] = 582,
    now = 941,
    ["npm-badges"] = 585,
    ["nswag.json"] = 589,
    ntangle = 591,
    ["nuclei-template.yaml"] = 586,
    ["nuget-project.json"] = 587,
    ["ocelot.json"] = 593,
    ogen = 596,
    ["omnisharp.json"] = 599,
    openHAB = 1227,
    ...
    oxlint = 1238,
    ["package.json"] = 633,
    ["package.manifest"] = 635,
    ["package.yaml"] = 634,
    ["partial-black.json"] = 141,
    ["partial-pixi.json"] = 642,
    ["pattern.json"] = 640,
    ["petstore-v1.0"] = 1048,
    pgap_yaml_input_reader = 639,
    pgxgen = 1231,
    pitcms = 1234,
    ["pixi.toml"] = 641,
    ["plagiarize-me.yaml"] = 646,
    ["plagiarize.yaml"] = 645,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1158,
    ["podbard.yaml"] = 648,
    ["portman.json"] = 651,
    ["prefect.toml"] = 659,
    ["prefect.yaml"] = 660,
    ...
    ["prettierrc.json"] = 662,
    ["prisma.yml"] = 663,
    ["project-1.0.0-beta3.json"] = 675,
    ["project-1.0.0-beta4.json"] = 676,
    ["project-1.0.0-beta5.json"] = 677,
    ["project-1.0.0-beta6.json"] = 678,
    ["project-1.0.0-beta8.json"] = 679,
    ["project-1.0.0-rc1.json"] = 680,
    ["project-1.0.0-rc2.json"] = 681,
    ["project.json"] = 674,
    ["project.owasp.yaml"] = 682,
    ["prometheus-alertmanager.json"] = 686,
    ["prometheus.json"] = 683,
    ["prometheus.rules.json"] = 684,
    ["prometheus.rules.test.json"] = 685,
    ["proxies.json"] = 687,
    ["publiccode.yml"] = 688,
    ["pubspec.yaml"] = 689,
    ["pyrseas-0.8.json"] = 692,
    pytest = 701,
    ["quilt.mod.json"] = 1069,
    ["rc3 auth"] = 707,
    ["rc3 collection"] = 708,
    ...
    ["release drafter"] = 947,
    ["release-hub.json"] = 2,
    ["release-please-config.json"] = 717,
    ["release-please-manifest.json"] = 718,
    ["release-plz.toml"] = 719,
    ["renv.lock"] = 731,
    ["rivet.json"] = 1093,
    ["rivet.yaml (legacy)"] = 1092,
    rumdl = 736,
    runny = 735,
    rustfmt = 737,
    sake = 1185,
    samt = 739,
    samtrc = 740,
    ["sarif-1.0.0.json"] = 742,
    ["sarif-2.0.0.json"] = 743,
    ["sarif-2.1.0"] = 753,
    ["sarif-2.1.0-rtm.2"] = 744,
    ["sarif-2.1.0-rtm.3"] = 746,
    ["sarif-2.1.0-rtm.4"] = 748,
    ["sarif-2.1.0-rtm.5"] = 750,
    ["sarif-2.1.0-rtm.6"] = 751,
    ["sarif-external-property-file-2.1.0"] = 754,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 745,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 747,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 749,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 752,
    ["scalingo.json configuration"] = 755,
    ["schema.org - Action"] = 757,
    ["schema.org - ContactPoint"] = 758,
    ["schema.org - Place"] = 759,
    ["schema.org - Thing"] = 760,
    ["secrethub.yml"] = 1071,
    ["semantic-release"] = 766,
    ["servicehub.config.json"] = 924,
    ["servicehub.service.json"] = 923,
    ["settings.job"] = 769,
    ["sfdx-hardis configuration"] = 771,
    ["shard.yml"] = 1109,
    ["size-limit configuration"] = 776,
    ["skaffold.yaml"] = 993,
    ["skyuxconfig.json"] = 778,
    ["snowflake-config"] = 780,
    ["snowflake-connections"] = 781,
    ["spicepod.yaml"] = 1130,
    ["sqlc configuration"] = 813,
    ["stripe-app-local.json"] = 824,
    ["stripe-app.json"] = 823,
    swcrc = 978,
    ["task.json"] = 833,
    taskcat = 942,
    ["template.json"] = 838,
    ["templatsources.json"] = 839,
    ["text2confl config"] = 1239,
    ["theme.json"] = 842,
    ["tizen_workspace.json"] = 844,
    tldr = 845,
    ["tm_devices configuration file"] = 1196,
    tmuxinator = 927,
    tox = 847,
    ["transcend.yml"] = 856,
    ...
    ["vega-lite.json"] = 888,
    ["vega.json"] = 887,
    ["venvironment.yaml"] = 890,
    ["venvplus.yaml"] = 891,
    version = 1178,
    ["version.json"] = 893,
    ["vhwdebugger-binding.yaml"] = 895,
    ["vim-addon-info"] = 896,
    ["vs-2017.3.host.json"] = 898,
    ["vs-nesting.json"] = 899,
    ["vsls.json"] = 897,
    ["vss-extension.json"] = 903,
    vtcfg = 1184,
    ["vtesttree.yaml"] = 904,
    ["vtestunit.yaml"] = 905,
    ["warp-keysets.json"] = 1077,
    ["warp-themes.json"] = 1078,
    ["warp-workflows.json"] = 1079,
    ["webhint.io"] = 1033,
    ["webjobpublishsettings.json"] = 910,
    ["webjobs-list.json"] = 909,
    ["well-known-fursona"] = 1117,
    ["xs-app.json"] = 937,
    ["xunit.runner.json"] = 922,
    yamllint = 965,
    zizmor = 1221,
    zuul = 948,
    ["Žinoma"] = 958
