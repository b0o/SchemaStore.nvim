...
M.json = {
  ...
  index = {
    ...
    ["Expo SDK"] = 237,
    ["F-Droid Data metadata"] = 242,
    ["Facets - FSDL - Application"] = 240,
    ["FasterCI Configuration"] = 66,
    FiQuS = 246,
    Firebase = 244,
    ["Fossa configuration file"] = 253,
    ["Fossa's fossa-deps file"] = 254,
    ["Foundry VTT - Base package Manifest"] = 248,
    ["Foundry VTT - Module Manifest"] = 249,
    ["Foundry VTT - System Data Template"] = 252,
    ["Foundry VTT - System Manifest"] = 250,
    ["Foundry VTT - World Manifest"] = 251,
    ["Foxx Manifest"] = 67,
    ["Freifunk.de Community API"] = 70,
    ["Frogbot Config"] = 71,
    ["Fusion resource pack metadata"] = 258,
    ["Fusion texture metadata"] = 259,
    ["G2P Mapping Configuration"] = 260,
    ["GCP Blueprint Metadata"] = 263,
    Gaspar = 261,
    ["GatewayCore API Gateway"] = 262,
    ...
    ["Global Privacy Control"] = 264,
    Goblet = 791,
    ["Google Chrome Related Website Sets"] = 245,
    ...
    ["KSP-AVC"] = 623,
    ["KSP-CKAN"] = 624,
    ["Karakum configuration file"] = 255,
    Kas = 335,
    ["Keycloak REST API"] = 763,
    ["Knative Functions - func.yaml"] = 256,
    ...
    ["Motif config"] = 647,
    ["NOX Framework (Service)"] = 406,
    ["Netin Diagnostic System Template"] = 706,
    ["Netlify config"] = 397,
    ["Network-as-Code Data Model"] = 398,
    ["Nightwatch.js"] = 399,
    ["ONe's changelog entry"] = 422,
    ["ONe's service descriptor"] = 421,
    ["OSS Review Toolkit configuration"] = 429,
    ["OSS Review Toolkit curation"] = 430,
    ["OSS Review Toolkit package configuration"] = 431,
    ["OSS Review Toolkit repository configuration"] = 432,
    ["OSS Review Toolkit resolutions"] = 433,
    Opctl = 650,
    ["OpenRewrite Resource"] = 424,
    ["OpenUtau character yaml"] = 418,
    ["OpenUtau ustx"] = 419,
    ["OpenWeather Current Weather API"] = 688,
    ["OpenWeather Road Risk API"] = 687,
    ["Ory Hydra configuration"] = 300,
    ["Ory Keto configuration"] = 340,
    ["Ory Kratos configuration"] = 428,
    ["Ory Oathkeeper configuration"] = 413,
    ["Outblocks App configuration"] = 426,
    ["Outblocks database table"] = 427,
    ["Outblocks project configuration"] = 425,
    PDM = 439,
    ["PDM Partial"] = 440,
    Packer = 436,
    Pantsbuild = 770,
    ["Paper paper-plugin.yml"] = 437,
    ["Partial-Setuptools"] = 528,
    ["Partial-poetry"] = 446,
    ...
    ["ecosystem.json"] = 229,
    eksctl = 230,
    ["electron-builder configuration file"] = 235,
    ["epr-manifest.json"] = 233,
    ["evcc.yaml"] = 236,
    ["ezd task runner"] = 238,
    ["fabric.mod.json"] = 241,
    ["first-timers-bot"] = 247,
    ...
    ["mycode.json"] = 394,
    mypy = 395,
    ["napari plugin manifest"] = 396,
    neoload = 656,
    ["nest-cli"] = 402,
    ["ninjs (News in JSON) 1.3"] = 401,
    ["ninjs (News in JSON) 2.0"] = 400,
    ["nlu.json"] = 403,
    ["nodemon.json"] = 405,
    ["noodl config"] = 707,
    now = 652,
    ...
    ["nswag.json"] = 411,
    ntangle = 412,
    ["nuclei-template.yaml"] = 409,
    ["nuget-project.json"] = 410,
    ["ocelot.json"] = 414,
    ["omnisharp.json"] = 415,
    ["openapi.json"] = 416,
    ["openfin.json"] = 423,
    ...
    ["ops.yaml"] = 420,
    ["package.json"] = 434,
    ["package.manifest"] = 435,
    ["partial-cibuildwheel"] = 112,
    ["partial-scikit-build"] = 710,
    ["pathfinder.yml"] = 438,
    ["pattern.json"] = 442,
    ["petstore-v1.0"] = 754,
