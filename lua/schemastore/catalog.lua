...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 158,
    [".cryproj (generic)"] = 532,
    [".cryproj engine-5.2"] = 527,
    [".cryproj engine-5.3"] = 528,
    [".cryproj engine-5.4"] = 529,
    [".cryproj engine-5.5"] = 530,
    [".cryproj engine-dev"] = 531,
    [".csscomb.json"] = 160,
    [".csslintrc"] = 161,
    [".eslintrc"] = 206,
    [".esmrc.json"] = 198,
    ...
    [".mtaext"] = 541,
    [".nodehawkrc"] = 338,
    [".npmpackagejsonlintrc"] = 341,
    [".phraseapp.yml"] = 376,
    [".pmbot.yml"] = 368,
    [".postcssrc"] = 373,
    [".pre-commit-config.yml"] = 374,
    [".pre-commit-hooks.yml"] = 375,
    [".putout.json"] = 393,
    [".rehyperc"] = 402,
    [".remarkrc"] = 403,
    [".sprite files"] = 450,
    ...
    [".vsext"] = 507,
    [".yarnrc.yml"] = 573,
    ["<div>RIOTS' studio configuration"] = 511,
    ["@factorial/drupal-breakpoints-css"] = 5,
    ["A micro editor config schema"] = 303,
    ["API Builder"] = 570,
    ["AVA Configuration Schema"] = 626,
    ["AWS CDK cdk.json"] = 143,
    ["AWS CloudFormation"] = 144,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 145,
    ["Airlock Microgateway"] = 9,
    ["Airplane task"] = 10,
    ["Alacritty Configuration Schema"] = 601,
    ["All Contributors configuration file"] = 653,
    ...
    ["Azure Pipelines"] = 48,
    ["Azure Static Web Apps CLI configuration file"] = 452,
    ["Azure Static Web Apps configuration file"] = 451,
    ["BX CI"] = 83,
    ["Better Code Hub"] = 575,
    ["Better Scripts"] = 84,
    BizTalkServerApplicationSchema = 547,
    ...
    ["Butane Config"] = 613,
    ["CICS TS region tagging"] = 620,
    ["CICS TS resource import"] = 621,
    ["CICS TS resource model"] = 622,
    ["CICS TS resource overrides"] = 623,
    ["CMake Presets"] = 85,
    ...
    ["Datadog Service Definition"] = 286,
    ["Datahub Ingestion Recipe Schema"] = 627,
    ...
    ["Embrace Config Schema"] = 638,
    ["Error pages"] = 201,
    Esquio = 199,
    ["Estuary Flow Catalog Schema"] = 617,
    ["Expo SDK"] = 204,
    ...
    Goreleaser = 233,
    ["Goreleaser Pro"] = 234,
    ["Gradle Build Cache Node"] = 572,
    ["Gradle Enterprise"] = 571,
    ...
    Hadolint = 556,
    Hammerkit = 582,
    ["Hardware Sentry Configuration"] = 631,
    Hayson = 246,
    ...
    ["JFrog File Spec"] = 270,
    ["JFrog Pipelines YML DSL"] = 640,
    ["JMeter DSL cli config schema"] = 271,
    ["JSON Document Transform"] = 279,
    ["JSON Feed"] = 280,
    ["JSON Resume"] = 409,
    ["JSON Schema Draft 2020-12"] = 523,
    ["JSON Schema Draft 4"] = 520,
    ["JSON Schema Draft 7"] = 521,
    ["JSON Schema Draft 8"] = 522,
    ...
    ["KSP-AVC"] = 518,
    ["KSP-CKAN"] = 519,
    ["Keycloak REST API"] = 646,
    ["Knative Functions - func.yaml"] = 216,
    ["KoDE/CI build.yaml"] = 636,
    ["Kong DBLess Schema"] = 637,
    KrakenD = 285,
    ["LinkML Metamodel"] = 298,
    Liquibase = 587,
    ["Liquibase Flow File"] = 588,
    ["Lively Properties"] = 299,
    Markdownlint = 591,
    ["MegaLinter configuration"] = 304,
    ["MegaLinter descriptor"] = 305,
    ["Meltano plugin discovery definition"] = 307,
    ["Meltano project definition"] = 306,
    ["Microsoft Band Web Tile"] = 308,
    ["Minecraft Data Pack Advancement"] = 310,
    ["Minecraft Data Pack Biome"] = 311,
    ["Minecraft Data Pack Configured Carver"] = 312,
    ["Minecraft Data Pack Damage Type"] = 313,
    ["Minecraft Data Pack Dimension"] = 315,
    ["Minecraft Data Pack Dimension Type"] = 314,
    ["Minecraft Data Pack Item Modifier"] = 316,
    ["Minecraft Data Pack Loot Table"] = 317,
    ["Minecraft Data Pack Metadata"] = 318,
    ["Minecraft Data Pack Predicate"] = 319,
    ["Minecraft Data Pack Recipe"] = 320,
    ["Minecraft Data Pack Tag"] = 321,
    ["Minecraft Data Pack Template Pool"] = 322,
    ["Minecraft Resource Pack Lang"] = 323,
    ["Minecraft Resource Pack Particle"] = 324,
    ["Minecraft Resource Pack Texture Mcmeta"] = 326,
    ["Minecraft Resourcepack Sounds"] = 325,
    ["MkDocs Configuration 1.0"] = 327,
    ["MongoDB Atlas Search Index Definition Schema"] = 635,
    ["Monika Configuration Schema"] = 633,
    ["Motif config"] = 540,
    ["NOX Framework (Service)"] = 340,
    ["Netin Diagnostic System Template"] = 596,
    ["Netlify config schema"] = 332,
    ["Nightwatch.js"] = 333,
    ["OSS Review Toolkit configuration"] = 358,
    ["OSS Review Toolkit curation"] = 359,
    ["OSS Review Toolkit package configuration"] = 360,
    ["OSS Review Toolkit repository configuration"] = 361,
    ["OSS Review Toolkit resolutions"] = 362,
    Opctl = 543,
    ["OpenRewrite Resource"] = 353,
    ["OpenWeather Current Weather API"] = 579,
    ["OpenWeather Road Risk API"] = 578,
    ["Ory Hydra configuration"] = 252,
    ["Ory Keto configuration"] = 287,
    ["Ory Kratos configuration"] = 357,
    ["Ory Oathkeeper configuration"] = 347,
    ["Outblocks App configuration"] = 355,
    ["Outblocks database table"] = 356,
    ["Outblocks project configuration"] = 354,
    Packer = 365,
    Pantsbuild = 652,
    ["Pipeline component"] = 589,
    ["PocketMine plugin.yml"] = 369,
    Pterodactyl = 630,
    ["Pull Request Labeler"] = 392,
    Pulumi = 397,
    PyProject = 398,
    Qodana = 606,
    ["Quali Torque Blueprint Spec 2"] = 628,
    ["QueryFirst config file"] = 649,
    ["RKE Cluster Configuration JSON Schema"] = 586,
    ["RKE Cluster Configuration YAML Schema"] = 585,
    ["Rancher Fleet"] = 395,
    Ray = 555,
    ["Read the Docs"] = 396,
    ["Red-DiscordBot Cog"] = 399,
    ["Red-DiscordBot Cog Repo"] = 400,
    ["Red-DiscordBot Trivia"] = 401,
    Renovate = 410,
    ["Replit schema"] = 404,
    RoadRunner = 411,
    Ruff = 407,
    ["Rust Project"] = 408,
    ["Rust toolchain"] = 413,
    ["SIL Kit Participant Configuration"] = 439,
    SWADL = 461,
    ["Sapphire CLI Config"] = 414,
    ["SauceCTL Configuration"] = 593,
    ["Schema Catalog"] = 427,
    ["Scoop manifest"] = 432,
    ["Semgrep Rule"] = 434,
    ["Serenity Code Generator (Sergen)"] = 435,
    ["Serverless Framework Configuration"] = 600,
    ["Serverless Workflow Schema"] = 602,
    ["Settings.paf"] = 437,
    ["Shopware 6 Configuration"] = 603,
    ["Shopware CLI Extension Store Configuration"] = 604,
    ["Shopware CLI Project Store Configuration"] = 605,
    ["Slack app manifest"] = 441,
    Solidarity = 444,
    ["Solution filters"] = 445,
    ["Source Maps v3"] = 446,
    Sourcery = 447,
    SpecIF = 448,
    ["Sponge Mixin configuration"] = 449,
    ["StackHawk Scanner Configuration"] = 599,
    Stale = 453,
    Starship = 454,
    ["Statamic Blueprint"] = 455,
    ["StrmPrivacy Data Connector"] = 644,
    ["StrmPrivacy Data Contract"] = 645,
    ["StrmPrivacy SimpleSchema"] = 642,
    ["StrmPrivacy Stream"] = 643,
    ["StrmPrivacy batch job configuration file"] = 641,
    ["Stryker Mutator"] = 458,
    ["StyleCop Analyzers Configuration"] = 459,
    ["Swagger API 2.0"] = 462,
    TSON = 485,
    ["Talisman configuration"] = 464,
    ["Taskfile YAML Schema"] = 581,
    Taurus = 465,
    ["TestEnvironment.json"] = 473,
    ["Tier.run pricing.json"] = 468,
    Tikibase = 469,
    ["Traefik v2"] = 476,
    ["Traefik v2 File Provider"] = 477,
    Turborepo = 474,
    Tye = 607,
    ["UI5 Manifest"] = 492,
    ["UTAM Page Object"] = 495,
    ["Ubuntu Server Autoinstall"] = 490,
    ["Uniswap Token List"] = 564,
    ["Unreal Engine Uplugin"] = 650,
    ["Unreal Engine Uproject"] = 651,
    Updatecli = 614,
    Uplift = 648,
    ["User Journey Map YAML Schema"] = 584,
    V2Ray = 618,
    ["VSCode Code Snippets"] = 131,
    ["VSIX CLI publishing"] = 508,
    ["Vela Pipeline Configuration"] = 498,
    Vercel = 130,
    ["Web App Manifest"] = 513,
    ["Web types"] = 516,
    WebExtensions = 512,
    ["Webman package recipe"] = 624,
    ["Windows Package Manager Installer Manifest"] = 561,
    ["Windows Package Manager Locale Manifest"] = 562,
    ["Windows Package Manager Singleton Manifest"] = 560,
    ["Woodpecker pipeline config"] = 595,
    ["Xstate Machine Schema"] = 612,
    ["Yippee-Ki-JSON configuration YML"] = 566,
    ["angular.json"] = 11,
    ...
    ["ize.toml"] = 647,
    ["jsconfig.json"] = 283,
    ["jscpd Configuration Schema"] = 629,
    jsdoc = 554,
    ["k3d.yaml"] = 284,
    ["kontinuous-values.yaml"] = 288,
    ["kustomization.yaml"] = 289,
    ["label-commenter-config.yml"] = 290,
    ["launchsettings.json"] = 291,
    ["lego.json"] = 292,
    ["lerna.json"] = 293,
    ["lgtm.yml"] = 294,
    ["libman.json"] = 295,
    ["license-report-config.json"] = 296,
    ["linkinator.config.json"] = 297,
    ["local.settings.json"] = 300,
    ["localazy.json"] = 301,
    ["lsdlschema.json"] = 302,
    ["markdown-lint-check"] = 592,
    mboats = 598,
    ["mimetypes.json"] = 309,
    ["mirrord-schema"] = 537,
    ["mta.yaml"] = 538,
    ["mtad.yaml"] = 539,
    ["mycode.json"] = 330,
    ["napari plugin manifest"] = 331,
    neoload = 549,
    ["nest-cli"] = 336,
    ["ninjs (News in JSON) 1.3"] = 335,
    ["ninjs (News in JSON) 2.0"] = 334,
    ["nlu.json"] = 337,
    ["nodemon.json"] = 339,
    ["noodl.schema.json"] = 597,
    now = 545,
    ["npm-badges"] = 342,
    ["nswag.json"] = 345,
    ntangle = 346,
    ["nuclei-template.yaml"] = 343,
    ["nuget-project.json"] = 344,
    ["ocelot.json"] = 348,
    ["omnisharp.json"] = 349,
    ["openapi.json"] = 350,
    ["openfin.json"] = 352,
    ["openrpc.json"] = 351,
    ["package.json"] = 363,
    ["package.manifest"] = 364,
    ["pattern.json"] = 367,
    ["petstore-v1.0"] = 639,
    pgap_yaml_input_reader = 366,
    ["plagiarize-me.yaml"] = 371,
    ["plagiarize.yaml"] = 370,
    ["portman.json"] = 372,
    ["prettierrc.json"] = 377,
    ["prisma.yml"] = 378,
    ["project-1.0.0-beta3.json"] = 380,
    ["project-1.0.0-beta4.json"] = 381,
    ["project-1.0.0-beta5.json"] = 382,
    ["project-1.0.0-beta6.json"] = 383,
    ["project-1.0.0-beta8.json"] = 384,
    ["project-1.0.0-rc1.json"] = 385,
    ["project-1.0.0-rc2.json"] = 386,
    ["project.json"] = 379,
    ["prometheus.json"] = 387,
    ["prometheus.rules.json"] = 388,
    ["proxies.json"] = 389,
    ["publiccode.yml"] = 390,
    ["pubspec.yaml"] = 391,
    ["pyrseas-0.8.json"] = 394,
    ["release drafter"] = 550,
    rtx = 406,
    rustfmt = 412,
    ["sarif-1.0.0.json"] = 415,
    ["sarif-2.0.0.json"] = 416,
    ["sarif-2.1.0"] = 425,
    ["sarif-2.1.0-rtm.2"] = 417,
    ["sarif-2.1.0-rtm.3"] = 419,
    ["sarif-2.1.0-rtm.4"] = 421,
    ["sarif-2.1.0-rtm.5"] = 423,
    ["sarif-external-property-file-2.1.0"] = 426,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 418,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 420,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 422,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 424,
    ["schema.org - Action"] = 428,
    ["schema.org - ContactPoint"] = 429,
    ["schema.org - Place"] = 430,
    ["schema.org - Thing"] = 431,
    ["semantic-release"] = 433,
    ["servicehub.config.json"] = 526,
    ["servicehub.service.json"] = 525,
    ["settings.job"] = 436,
    ["sfdx-hardis configuration"] = 438,
    ["size-limit configuration"] = 440,
    ["skaffold.yaml"] = 590,
    ["skyuxconfig.json"] = 442,
    snapcraft = 443,
    ["stripe-app-local.json"] = 457,
    ["stripe-app.json"] = 456,
    swcrc = 577,
    ["task.json"] = 463,
    taskcat = 546,
    ["template.json"] = 466,
    ["templatsources.json"] = 467,
    ["theme.json"] = 470,
    ["tizen_workspace.json"] = 471,
    tmLanguage = 472,
    tmuxinator = 534,
    ["transcend.yml"] = 478,
    ["trunk.yaml schema"] = 479,
    ["ts-force-config.json"] = 483,
    ["tsconfig.json"] = 480,
    ["tsd.json"] = 481,
    ["tsdrc.json"] = 482,
    ["tslint.json"] = 484,
    ...
    ["vega-lite.json"] = 497,
    ["vega.json"] = 496,
    ["venvironment-basic.yaml"] = 500,
    ["venvironment.yaml"] = 499,
    ["version.json"] = 501,
    ["vim-addon-info"] = 502,
    ["vs-2017.3.host.json"] = 504,
    ["vs-nesting.json"] = 505,
    ["vsls.json"] = 503,
    ["vss-extension.json"] = 509,
    ["webhint.io"] = 625,
    ["webjobpublishsettings.json"] = 515,
    ["webjobs-list.json"] = 514,
    ["xs-app.json"] = 542,
    ["xunit.runner.json"] = 524,
    yamllint = 565,
    zuul = 551,
    ["Žinoma"] = 559
  },
