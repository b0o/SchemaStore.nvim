...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 112,
    [".cryproj (generic)"] = 419,
    [".cryproj engine-5.2"] = 414,
    [".cryproj engine-5.3"] = 415,
    [".cryproj engine-5.4"] = 416,
    [".cryproj engine-5.5"] = 417,
    [".cryproj engine-dev"] = 418,
    [".csscomb.json"] = 114,
    [".csslintrc"] = 115,
    [".eslintrc"] = 152,
    [".esmrc.json"] = 145,
    ...
    ["Azure Pipelines"] = 40,
    ["Azure Static Web Apps CLI configuration file"] = 352,
    ["Azure Static Web Apps configuration file"] = 351,
    ["Better Code Hub"] = 459,
    BizTalkServerApplicationSchema = 431,
    ...
    ["Butane config schema"] = 493,
    ["CICS TS resource overrides"] = 500,
    ["CMake Presets"] = 68,
    ["CSR Framework"] = 76,
    ...
    ["Error pages"] = 148,
    Esquio = 146,
    ["Estuary Flow Catalog Schema"] = 497,
    ["Expo SDK"] = 151,
    ...
    Goreleaser = 178,
    ["Goreleaser Pro"] = 179,
    ["Gradle Build Cache Node"] = 456,
    ["Gradle Enterprise"] = 455,
    ...
    ["JSON Feed"] = 216,
    ["JSON Resume"] = 317,
    ["JSON Schema Draft 2020-12"] = 410,
    ["JSON Schema Draft 4"] = 407,
    ["JSON Schema Draft 7"] = 408,
    ["JSON Schema Draft 8"] = 409,
    ...
    ["Netin Diagnostic System Template"] = 478,
    ["Netlify config schema"] = 257,
    ["Nightwatch.js"] = 258,
    ["OSS Review Toolkit repository configuration"] = 279,
    Opctl = 427,
    ["OpenWeather Current Weather API"] = 463,
    ["OpenWeather Road Risk API"] = 462,
    ...
    Packer = 282,
    ["Pipeline component"] = 472,
    ["PocketMine plugin.yml"] = 286,
    ["Pull Request Labeler"] = 308,
    Qodana = 486,
    ["RKE Cluster Configuration JSON Schema"] = 470,
    ["RKE Cluster Configuration YAML Schema"] = 469,
    Ray = 439,
    ["Read the Docs"] = 311,
    ["Red-DiscordBot Cog"] = 312,
    ["Red-DiscordBot Cog Repo"] = 313,
    Renovate = 318,
    RoadRunner = 319,
    SWADL = 361,
    ["Sapphire CLI Config"] = 320,
    ["SauceCTL Configuration"] = 475,
    ["Schema Catalog"] = 333,
    ["Scoop manifest"] = 338,
    ["Semgrep Rule"] = 339,
    ["Serverless Framework Configuration"] = 482,
    ["Settings.paf"] = 341,
    ["Shopware 6 Configuration"] = 483,
    ["Shopware CLI Extension Store Configuration"] = 484,
    ["Shopware CLI Project Store Configuration"] = 485,
    Solidarity = 346,
    ["Source Maps v3"] = 347,
    SpecIF = 348,
    ["Sponge Mixin configuration"] = 349,
    ["StackHawk Scanner Configuration"] = 481,
    ["StackHead CLI config"] = 353,
    ["StackHead module configuration"] = 354,
    ["StackHead project definition"] = 355,
    Stale = 356,
    ["Statamic Blueprint"] = 357,
    ["Stryker Mutator"] = 358,
    ["StyleCop Analyzers Configuration"] = 359,
    ["Swagger API 2.0"] = 362,
    ["Taskfile YAML Schema"] = 465,
    Taurus = 363,
    ["TestEnvironment.json"] = 369,
    Tikibase = 366,
    ["Traefik v2"] = 371,
    ["Traefik v2 File Provider"] = 372,
    Tye = 487,
    ["UI5 Manifest"] = 384,
    ["Ubuntu Server Autoinstall"] = 382,
    ["Uniswap Token List"] = 448,
    Updatecli = 494,
    ["User Journey Map YAML Schema"] = 468,
    V2Ray = 498,
    ["VSCode Code Snippets"] = 90,
    ["VSIX CLI publishing"] = 396,
    ["Vela Pipeline Configuration"] = 388,
    Vercel = 89,
    ["Web App Manifest"] = 400,
    ["Web types"] = 403,
    WebExtensions = 399,
    ["Webman package recipe"] = 501,
    ["Windows Package Manager Installer Manifest"] = 445,
    ["Windows Package Manager Locale Manifest"] = 446,
    ["Windows Package Manager Singleton Manifest"] = 444,
    ["Woodpecker pipeline config"] = 477,
    ["Xstate Machine Schema"] = 492,
    ["Yippee-Ki-JSON configuration YML"] = 450,
    ["angular.json"] = 8,
    ...
    ["openfin.json"] = 274,
    ["package.json"] = 280,
    ["package.manifest"] = 281,
    ["pattern.json"] = 284,
    pgap_yaml_input_reader = 283,
    ["plagiarize-me.yaml"] = 288,
    ["plagiarize.yaml"] = 287,
    ["portman.json"] = 289,
    ["prettierrc.json"] = 293,
    ["prisma.yml"] = 294,
    ["project-1.0.0-beta3.json"] = 296,
    ["project-1.0.0-beta4.json"] = 297,
    ["project-1.0.0-beta5.json"] = 298,
    ["project-1.0.0-beta6.json"] = 299,
    ["project-1.0.0-beta8.json"] = 300,
    ["project-1.0.0-rc1.json"] = 301,
    ["project-1.0.0-rc2.json"] = 302,
    ["project.json"] = 295,
    ["prometheus.json"] = 303,
    ["prometheus.rules.json"] = 304,
    ["proxies.json"] = 305,
    ["publiccode.yml"] = 306,
    ["pubspec.yaml"] = 307,
    ["pyrseas-0.8.json"] = 310,
    ["release drafter"] = 434,
    ["sarif-1.0.0.json"] = 321,
    ["sarif-2.0.0.json"] = 322,
    ["sarif-2.1.0"] = 331,
    ["sarif-2.1.0-rtm.2"] = 323,
    ["sarif-2.1.0-rtm.3"] = 325,
    ["sarif-2.1.0-rtm.4"] = 327,
    ["sarif-2.1.0-rtm.5"] = 329,
    ["sarif-external-property-file-2.1.0"] = 332,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 324,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 326,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 328,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 330,
    ["schema.org - Action"] = 334,
    ["schema.org - ContactPoint"] = 335,
    ["schema.org - Place"] = 336,
    ["schema.org - Thing"] = 337,
    ["service.datadog.yaml"] = 221,
    ["servicehub.config.json"] = 413,
    ["servicehub.service.json"] = 412,
    ["settings.job"] = 340,
    ["sfdx-hardis configuration"] = 342,
    ["size-limit configuration"] = 343,
    ["skaffold.yaml"] = 473,
    ["skyuxconfig.json"] = 344,
    snapcraft = 345,
    swcrc = 461,
    taskcat = 430,
    ["template.json"] = 364,
    ["templatsources.json"] = 365,
    ["theme.json"] = 367,
    tmLanguage = 368,
    ["trunk.yaml schema"] = 373,
    ["ts-force-config.json"] = 377,
    ["tsconfig.json"] = 374,
    ["tsd.json"] = 375,
    ["tsdrc.json"] = 376,
    ["tslint.json"] = 378,
    ...
    ["version.json"] = 389,
    ["vim-addon-info"] = 390,
    ["vs-2017.3.host.json"] = 392,
    ["vs-nesting.json"] = 393,
    ["vsls.json"] = 391,
    ["vss-extension.json"] = 397,
    ["webhint.io"] = 502,
    ["webjobpublishsettings.json"] = 402,
    ["webjobs-list.json"] = 401,
    ["xs-app.json"] = 426,
    ["xunit.runner.json"] = 411,
    yamllint = 449,
    zuul = 435,
    ["Žinoma"] = 443
  },
