...
M.json = {
  ...
  index = {
    ...
    AIConfig = 36,
    ["AMX Muse Program Descriptor"] = 1211,
    ["API Builder"] = 1019,
    ["AVA Configuration"] = 1082,
    ...
    ["AWS Copilot Manifest"] = 1250,
    ["AWS SAM CLI Samconfig"] = 274,
    Acton = 1300,
    ["Adobe UXP Manifest"] = 1145,
    ["Aerleon Network & Service Definitions"] = 22,
    ["Aerleon Policy"] = 23,
    ["Agent Permission Policy"] = 1290,
    ["AgentCore CLI"] = 1291,
    Aider = 1240,
    Air = 25,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1261,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1260,
    ["Airlock Microgateway"] = 37,
    ["Alacritty Configuration"] = 1054,
    ["AlgoVoi Compliance Receipt v1"] = 12,
    ["All Contributors configuration file"] = 1108,
    Anodizer = 448,
    ...
    ["Application list for a WinUtil"] = 1190,
    ArchitectFX = 1195,
    ["Argo CD"] = 56,
    ["Argo Events"] = 57,
    ["Argo Workflows"] = 58,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1259,
    ["Azure IoT Operations connector metadata"] = 1256,
    ...
    ["Bacon config"] = 6,
    ["Barba-CV"] = 85,
    ["Bashly (bashly.yml)"] = 1112,
    ["Bashly Settings (bashly-settings.yml)"] = 1113,
    Bento = 1277,
    ["Better Code Hub"] = 1024,
    ["Better Scripts"] = 165,
    Bigconfig = 135,
    ["Biome Formatter Config"] = 86,
    ["Bitmovin Encoding Template"] = 1204,
    BizTalkServerApplicationSchema = 991,
    Bleep = 166,
    ["Block Protocol Metadata"] = 163,
    ["Bluebricks blueprint config"] = 1283,
    ["Boyka Framework"] = 144,
    ...
    ["Butane Config"] = 1067,
    C4InterFlow = 1219,
    ["CDK Environment Manager, concrete environment configuration"] = 1243,
    ["CDK Environment Manager, concrete environments definition"] = 1242,
    ["CDK Environment Manager, environment definition"] = 1241,
    ["CGS Card Game Specification (cgs.json)"] = 1150,
    ["CICS TS region tagging"] = 1076,
    ["CICS TS resource import"] = 1077,
    ["CICS TS resource model"] = 1078,
    ["CICS TS resource overrides"] = 1079,
    ["CMake Presets"] = 167,
    ["CNC Codes"] = 189,
    ["CRS WAF test file"] = 1180,
    ["CRS WAF test platform overrides file"] = 1181,
    ...
    ["Chamaleon environment"] = 1208,
    ["Chamaleon properties"] = 1209,
    ["Chamaleon template"] = 1207,
    Changepacks = 1270,
    Changesets = 283,
    Changie = 176,
    Charmcraft = 177,
    ...
    ["Clawject config"] = 195,
    ["Cloud Foundry Application Manifest"] = 1162,
    ["Cloud Run Spec v1"] = 1185,
    ...
    Concord = 1179,
    ["Configu .cfgu files"] = 1167,
    ["Configu .configu file"] = 1168,
    Conjure = 188,
    ["Container Structure Test"] = 1005,
    Containerlab = 1033,
    ["Contextive Glossary"] = 1235,
    Convex = 187,
    ["Crowdsec collection config"] = 293,
    ["Crowdsec parser config"] = 294,
    ["Crowdsec scenario config"] = 295,
    ["CumulusCI Config"] = 194,
    ["Cursor Agent Environment"] = 1288,
    ["Custom Machinery Machine"] = 1151,
    ["Custom Machinery Recipe"] = 1152,
    ...
    ["DonateCaseBetterCasino menu"] = 1212,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1120,
    ["EAS config"] = 382,
    ["ECA - Editor Code Assistant"] = 346,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1109,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1255,
    ["EasyVCR .NET"] = 384,
    ["Eidolon Resource"] = 1196,
    ...
    ["Envelope Team Definition"] = 1299,
    ["Envilder Map File"] = 350,
    ["Erda Pipeline"] = 1158,
    ["Erda Runtime"] = 1159,
    ["Espanso config.yml"] = 1281,
    ["Espanso match.yml"] = 1280,
    Esquio = 370,
    ["Estuary Flow Catalog"] = 1073,
    ["Ethereum ERC1155"] = 1293,
    ["Ethereum ERC721"] = 1292,
    ...
    ["Evolving Resolutive Process notation"] = 1257,
    ["Expo SDK"] = 381,
    ...
    ["GeoJSON.json latest"] = 1071,
    GherKing = 1075,
    ["GitHub Action"] = 417,
    ["GitHub Actions typing"] = 1192,
    ...
    ["Google Digital Assetlinks"] = 1236,
    Goreleaser = 446,
    ["Goreleaser Pro"] = 447,
    Goss = 449,
    ["Gradle Build Cache Node"] = 1022,
    ["Gradle Enterprise"] = 1021,
    ...
    Hadolint = 1001,
    Hammerkit = 1032,
    ["Hardware Sentry Configuration"] = 1087,
    ...
    ["JFrog File Spec"] = 500,
    ["JFrog Pipelines YML DSL"] = 1097,
    ["JMeter DSL cli config"] = 501,
    JReleaser = 504,
    ["JSON Document Transform"] = 512,
    ["JSON Feed"] = 513,
    ["JSON Resume"] = 770,
    ["JSON Schema Draft 2020-12"] = 969,
    ["JSON Schema Draft 4"] = 966,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1130,
    ["JSON Schema Draft 7"] = 967,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1131,
    ["JSON Schema Draft 8 (2019-09)"] = 968,
    ["JSON-API"] = 511,
    ["JSON-e templates"] = 1029,
    ["JSON-stat 2.0"] = 962,
    JSONPatch = 515,
    ...
    ["Jujutsu (jj) VCS config"] = 1249,
    ["KIMMDY config file"] = 526,
    ["KODE/CI build.yaml"] = 1093,
    ["KSP-AVC"] = 963,
    ["KSP-CKAN"] = 964,
    ["KSP-NetKAN"] = 965,
    KSY = 1160,
    ...
    ["Metadata for a Cinnamon spice"] = 1188,
    ["Metatype Configuration"] = 568,
    ["MetricsHub Configuration"] = 569,
    ["MetricsHub Connector Configuration"] = 570,
    ["Micro Editor Syntax"] = 1121,
    ["Microsoft Band Web Tile"] = 571,
    ["Microsoft RulesEngine workflow rules"] = 1176,
    ["Microsoft RulesEngine workflow rules list"] = 1177,
    ["Minecraft Custom Main Menu Mod"] = 1139,
    ...
    ["MongoDB Atlas Search Index Definition"] = 1092,
    ["Monika Configuration"] = 1090,
    ["Monoweave Configuration"] = 599,
    ["Motif config"] = 983,
    MultiQC = 1229,
    ["NOX Framework (Service)"] = 622,
    ["Netin Diagnostic System Template"] = 1049,
    ["Netlify config"] = 607,
    ...
    ["OpenUtau ustx"] = 645,
    ["OpenWeather Current Weather API"] = 1028,
    ["OpenWeather Road Risk API"] = 1027,
    ...
    ["Power Pages Configuration"] = 1246,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1191,
    ...
    Pylock = 1237,
    Pyright = 742,
    ["Python script metadata"] = 1231,
    ["QType AI DSL"] = 745,
    Qgoda = 744,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1308,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1306,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1312,
    ["Qlik Talend Cloud Pipeline - Project"] = 1304,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1307,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1309,
    ["Qlik Talend Cloud Pipeline - Task"] = 1305,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1311,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1310,
    Qodana = 1059,
    ["Qt Creator workspace file"] = 1169,
    ["Quali Torque Blueprint Spec 2"] = 1084,
    ["QueryFirst config file"] = 1103,
    ["QuikRun Configuration"] = 1313,
    ["Qwen Code Settings"] = 1294,
    ["RKE Cluster Configuration JSON"] = 1037,
    ["RKE Cluster Configuration YAML"] = 1036,
    RadioHound = 735,
    ["Raid Profile"] = 1295,
    ["Raid Repo Configuration"] = 1296,
    Railpack = 747,
    Railway = 746,
    ["Rancher Fleet"] = 737,
    ["Rattler-build"] = 748,
    ...
    ["Replit config"] = 763,
    Restate = 1224,
    ["Revel Digital Gadget Definition File"] = 1248,
    RoadRunner = 776,
    ["Robust Station Image"] = 1254,
    Rockcraft = 777,
    ["Roo Coder Custom Modes"] = 778,
    Rubocop = 767,
    ["Rudder techniques"] = 1143,
    Ruff = 768,
    ["Rust Project"] = 769,
    ["Rust toolchain"] = 783,
    ...
    ["Serverless Framework Configuration"] = 1053,
    ["Serverless Workflow"] = 1055,
    ["Settings for a Cinnamon spice"] = 1187,
    ["Settings.paf"] = 816,
    ["Shopware 6 Configuration"] = 1056,
    ["Shopware CLI Extension Store Configuration"] = 1057,
    ["Shopware CLI Project Store Configuration"] = 1058,
    ["Sigma Detection Rule"] = 818,
    ["Sigrid scope configuration file"] = 819,
    ["SkyPilot Task JSON"] = 1144,
    ...
    StackBlitz = 863,
    ["StackHawk Scanner Configuration"] = 1052,
    Stale = 864,
    Starfish = 865,
    ["Starlake Data Pipeline"] = 1025,
    Starship = 866,
    ...
    ["Stylua Config"] = 1238,
    ["Sublime Syntax"] = 1099,
    ["Subsquid squid manifest"] = 1146,
    ["Swagger API 2.0"] = 876,
    ["Synadia Connect Component"] = 877,
    TSON = 913,
    TSTyche = 914,
    ["TYPO3 Vendor Bundler config"] = 920,
    ["Tab data for a LinUtil"] = 1194,
    ["Tab list for a LinUtil"] = 1193,
    Tach = 878,
    ["Tach Domain"] = 879,
    Talhelper = 881,
    ["Talisman configuration"] = 882,
    Taplo = 1239,
    ["Taskfile config"] = 1030,
    Taurus = 883,
    Tauticord = 884,
    ["Tekton Pipeline"] = 1267,
    ["Tekton PipelineRun"] = 1268,
    ["Tekton Task"] = 1265,
    ["Tekton TaskRun"] = 1266,
    Telefonistka = 1225,
    ["Terrateam config"] = 1251,
    ...
    ["Tugboat QA config.yml"] = 1218,
    TunnelHub = 1134,
    Turborepo = 897,
    Tycho = 1183,
    Tye = 1060,
    ["Tyk Gateway - Open Source v5.7+"] = 1230,
    ["UET BuildConfig.json"] = 1104,
    ["UI5 Manifest"] = 926,
    ["UNCORS configuration"] = 930,
    ["UTAM Page Object"] = 929,
    ["Ubuntu Server Autoinstall"] = 924,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1222,
    ["Uniswap Token List"] = 1011,
    ["Universal Schedule Format"] = 931,
    ["Unreal Engine Uplugin"] = 1105,
    ["Unreal Engine Uproject"] = 1106,
    ["UpCloud CLI (upctl) configuration"] = 1223,
    ["Updatecli Compose"] = 1068,
    ["Updatecli Policy Manifest"] = 1069,
    ["Updatecli Policy Metadata"] = 1070,
    Uplift = 1102,
    ["Upsun config"] = 7,
    ["User Journey Map"] = 1034,
    V2Ray = 1074,
    ["VSCode Code Snippets"] = 258,
    ["VSIX CLI publishing"] = 949,
    Vector = 933,
    ["Vela Pipeline Configuration"] = 936,
    Vercel = 257,
    ["Version Bumper config"] = 939,
    Vespertide = 1272,
    ["Vespertide Migration"] = 1273,
    ["Vespertide Model"] = 1274,
    ["Viash Component Config"] = 1227,
    ["Viash Package Config"] = 1228,
    Visivo = 1132,
    ["WP-CLI"] = 959,
    Wake = 1220,
    ["Waku Config"] = 1197,
    ["Web App Manifest"] = 955,
    ["Web types"] = 958,
    WebExtensions = 954,
    ["Webman package recipe"] = 1080,
    ["Windows Package Manager Installer Manifest"] = 1008,
    ["Windows Package Manager Locale Manifest"] = 1009,
    ["Windows Package Manager Singleton Manifest"] = 1007,
    ["WireMock CLI import configuration"] = 1203,
    ["WireMock CLI local service configuration"] = 1202,
    ["WireMock message stub mapping"] = 1201,
    ["WireMock stub mapping"] = 1200,
    ["Woodpecker pipeline config"] = 1048,
    ["Wrangler CLI"] = 960,
    ["XenForo add-on manifest"] = 961,
    ["Xstate Machine"] = 1066,
    ["Yandex Workflow Language"] = 1189,
    ["Yarn Config (.yarnrc.yml)"] = 1023,
    ["Yippee-Ki-JSON configuration YML"] = 1014,
    ["YouTrack App"] = 1186,
    ["Zarf Package Configuration"] = 1253,
    ["Zerops import file"] = 1175,
    ...
    ["behat.yml"] = 145,
    ["bigquery-table"] = 134,
    ["bioimageio resource description"] = 1154,
    ...
    ["chutzpah.json"] = 266,
    cibuildwheel = 182,
    ["clang-format (.clang-format)"] = 1072,
    ["clang-tidy"] = 243,
    clangd = 242,
    clib = 244,
    ...
    ["crowdin.yml"] = 292,
    ["ctfd-setup configuration file"] = 1210,
    ["custom-elements.json"] = 1124,
    ["cypress.json"] = 296,
    ["dacier.yml"] = 1303,
    ...
    ["gematik health care insurance list"] = 1216,
    ["gematik health care patient list"] = 1213,
    ["gematik health care provider institution list"] = 1215,
    ["gematik health care provider list"] = 1214,
    ["gematik tiger test environment configuration"] = 1217,
    ["git-town.toml"] = 1262,
    ["gitlab-ci"] = 426,
    ["global.json"] = 442,
    ...
    ["lint-staged (.lintstagedrc)"] = 977,
    ["local.settings.json"] = 555,
    ["localazy.json"] = 556,
    ["lotus.yaml"] = 554,
    ["lsdlschema.json"] = 557,
    ["macro.json"] = 1089,
    ["markdown-link-check"] = 1043,
    maturin = 1044,
    mboats = 1051,
    memnex = 1301,
    ["micro-settings.json"] = 1116,
    ["mimetypes.json"] = 572,
    ["mirrord config"] = 979,
    mise = 980,
    ["mkdocs.yml"] = 592,
    ...
    ["monospace.yml"] = 598,
    ["moon.yml"] = 1199,
    ["mprocs Configuration file"] = 1170,
    ["mrdocs.yml"] = 594,
    ["mta.yaml"] = 981,
    ["mtad.yaml"] = 982,
    ["mycode.json"] = 605,
    ...
    ["plagiarize.yaml"] = 686,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1206,
    ["podbard.yaml"] = 689,
    ["portman.json"] = 692,
    ["prefect.toml"] = 701,
    ["prefect.yaml"] = 702,
    ...
    ["servicehub.config.json"] = 972,
    ["servicehub.service.json"] = 971,
    ["settings.job"] = 815,
    ...
    ["text2confl config"] = 1287,
    ["theme.json"] = 889,
    ["tizen_workspace.json"] = 891,
    tldr = 892,
    ["tm_devices configuration file"] = 1244,
    tmuxinator = 975,
    tox = 894,
    ["transcend.yml"] = 903,
    ...
    ["vega-lite.json"] = 935,
    ["vega.json"] = 934,
    ["venvironment.yaml"] = 937,
    ["venvplus.yaml"] = 938,
    version = 1226,
    ["version.json"] = 940,
    ["vhwdebugger-binding.yaml"] = 942,
    ["vim-addon-info"] = 943,
    ["vs-2017.3.host.json"] = 945,
    ["vs-nesting.json"] = 946,
    ["vsls.json"] = 944,
    ["vss-extension.json"] = 950,
    vtcfg = 1232,
    ["vtesttree.yaml"] = 951,
    ["vtestunit.yaml"] = 952,
    ["warp-keysets.json"] = 1125,
    ["warp-themes.json"] = 1126,
    ["warp-workflows.json"] = 1127,
    ["webhint.io"] = 1081,
    ["webjobpublishsettings.json"] = 957,
    ["webjobs-list.json"] = 956,
    ["well-known-fursona"] = 1165,
    ["xs-app.json"] = 985,
    ["xunit.runner.json"] = 970,
    yamlfmt = 1012,
    yamllint = 1013,
    ["zerops.yml"] = 1174,
    zizmor = 1269,
