...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 195,
    [".cryproj (generic)"] = 659,
    [".cryproj engine-5.2"] = 654,
    [".cryproj engine-5.3"] = 655,
    [".cryproj engine-5.4"] = 656,
    [".cryproj engine-5.5"] = 657,
    [".cryproj engine-dev"] = 658,
    [".eslintrc"] = 251,
    [".esmrc.json"] = 243,
    [".ffizer.yaml"] = 255,
    [".htmlhintrc"] = 311,
    ...
    [".mtaext"] = 670,
    [".nodehawkrc"] = 421,
    [".npmpackagejsonlintrc"] = 424,
    [".phrase.yml"] = 470,
    [".phraseapp.yml"] = 471,
    [".pmbot.yml"] = 460,
    [".postcssrc"] = 465,
    [".powerpages-web-template-manifest"] = 467,
    [".pre-commit-config.yml"] = 468,
    [".pre-commit-hooks.yml"] = 469,
    [".putout.json"] = 490,
    [".rehyperc"] = 503,
    [".remarkrc"] = 505,
    [".sprite files"] = 563,
    ...
    ["Adobe UXP Manifest"] = 827,
    ["Aerleon Network & Service Definitions"] = 8,
    ["Aerleon Policy"] = 9,
    ["Airlock Microgateway"] = 13,
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 734,
    ["All Contributors configuration file"] = 792,
    ...
    ["Azure Pipelines"] = 65,
    ["Azure Static Web Apps CLI configuration file"] = 566,
    ["Azure Static Web Apps configuration file"] = 565,
    ["BX CI"] = 103,
    ["Bashly (bashly.yml)"] = 796,
    ["Bashly Settings (bashly-settings.yml)"] = 797,
    ["Better Code Hub"] = 706,
    ["Better Scripts"] = 104,
    Bigconfig = 82,
    BizTalkServerApplicationSchema = 676,
    Bleep = 105,
    ...
    ["Butane Config"] = 747,
    ["CGS Custom Card Game (CardGameDef.json)"] = 832,
    ["CICS TS region tagging"] = 756,
    ["CICS TS resource import"] = 757,
    ["CICS TS resource model"] = 758,
    ["CICS TS resource overrides"] = 759,
    ["CMake Presets"] = 106,
    ["CNC Codes"] = 118,
    ...
    ["DataYoga Job"] = 126,
    ["Databricks Asset Bundles"] = 813,
    ["Datadog Service Definition"] = 352,
    ["Datahub Ingestion Recipe"] = 763,
    ["Dein Config"] = 128,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 804,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 793,
    ...
    ["Goreleaser Pro"] = 292,
    Goss = 293,
    ["Gradle Build Cache Node"] = 704,
    ["Gradle Enterprise"] = 703,
    ...
    Hadolint = 685,
    Hammerkit = 713,
    ["Hardware Sentry Configuration"] = 767,
    Hatch = 686,
    Hayson = 306,
    ...
    ["IVMS101 by CODE Protocol"] = 830,
    Istanbul = 770,
    ["JDownloader2 crawler multi-rules"] = 329,
    ["JDownloader2 crawler single-rules"] = 328,
    ["JFrog Applications Config"] = 330,
    ["JFrog File Spec"] = 331,
    ["JFrog Pipelines YML DSL"] = 776,
    ["JMeter DSL cli config"] = 332,
    JReleaser = 334,
    ["JSON Document Transform"] = 342,
    ["JSON Feed"] = 343,
    ["JSON Resume"] = 510,
    ["JSON Schema Draft 2020-12"] = 650,
    ["JSON Schema Draft 4"] = 647,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 814,
    ["JSON Schema Draft 7"] = 648,
    ["JSON Schema Draft 7 (unofficial strict)"] = 815,
    ["JSON Schema Draft 8 (2019-09)"] = 649,
    ["JSON-API"] = 341,
    ["JSON-WF"] = 843,
    ["JSON-e templates"] = 711,
    ["JSON-stat 2.0"] = 644,
    JSONPatch = 345,
    ...
    Kas = 348,
    ["Keycloak REST API"] = 784,
    ["Knative Functions - func.yaml"] = 268,
    ["KoDE/CI build.yaml"] = 772,
    ["Kong DBLess config"] = 773,
    KrakenD = 351,
    LOOBin = 370,
    Lefthook = 359,
    ...
    ["Micro Editor Syntax"] = 805,
    ["Microsoft Band Web Tile"] = 382,
    ["Minecraft Custom Main Menu Mod"] = 822,
    ...
    ["MongoDB Atlas Search Index Definition"] = 771,
    ["Monika Configuration"] = 769,
    ["Monoweave Configuration"] = 406,
    ["Motif config"] = 669,
    ["NOX Framework (Service)"] = 423,
    ["Netin Diagnostic System Template"] = 729,
    ["Netlify config"] = 414,
    ["Network-as-Code Data Model"] = 415,
    ["Nightwatch.js"] = 416,
    ["Nuitka.yaml"] = 835,
    ["ONe's changelog entry"] = 439,
    ["ONe's service descriptor"] = 438,
    ["OSS Review Toolkit configuration"] = 446,
    ["OSS Review Toolkit curation"] = 447,
    ["OSS Review Toolkit package configuration"] = 448,
    ["OSS Review Toolkit repository configuration"] = 449,
    ["OSS Review Toolkit resolutions"] = 450,
    Opctl = 672,
    ["OpenRewrite Resource"] = 441,
    ["OpenUtau character yaml"] = 435,
    ["OpenUtau ustx"] = 436,
    ["OpenWeather Current Weather API"] = 710,
    ["OpenWeather Road Risk API"] = 709,
    ["Ory Hydra configuration"] = 312,
    ["Ory Keto configuration"] = 353,
    ["Ory Kratos configuration"] = 445,
    ["Ory Oathkeeper configuration"] = 430,
    ["Outblocks App configuration"] = 443,
    ["Outblocks database table"] = 444,
    ["Outblocks project configuration"] = 442,
    PDM = 456,
    Packer = 453,
    Pantsbuild = 791,
    ["Paper paper-plugin.yml"] = 454,
    ["Pipeline component"] = 721,
    ["PocketMine plugin.yml"] = 461,
    ["Postman collection"] = 466,
    ["Problem object RFC9457"] = 819,
    ["Problem package generators"] = 474,
    Pterodactyl = 766,
    ["Pull Request Labeler"] = 489,
    Pulumi = 495,
    PyProject = 496,
    Pyright = 497,
    Qgoda = 498,
    Qodana = 739,
    ["Quali Torque Blueprint Spec 2"] = 764,
    ["QueryFirst config file"] = 787,
    ["RKE Cluster Configuration JSON"] = 718,
    ["RKE Cluster Configuration YAML"] = 717,
    ["Rancher Fleet"] = 492,
    ["Rattler-build"] = 499,
    Ray = 684,
    ["Read the Docs"] = 494,
    ["Red-DiscordBot Cog"] = 500,
    ["Red-DiscordBot Cog Repo"] = 501,
    ["Red-DiscordBot Trivia"] = 502,
    ["Render Blueprints"] = 716,
    RenderCV = 512,
    Renovate = 511,
    ["Replit config"] = 506,
    RoadRunner = 513,
    ["Rudder techniques"] = 825,
    Ruff = 508,
    ["Rust Project"] = 509,
    ["Rust toolchain"] = 516,
    ["SDMX data message"] = 541,
    ["SDMX metadata message"] = 540,
    ["SDMX structure message"] = 539,
    ["SIL Kit Participant Configuration"] = 551,
    ["SIL Kit Registry Configuration"] = 552,
    SWADL = 577,
    ["Safebox Config"] = 777,
    ["Sapphire CLI Config"] = 519,
    ["SauceCTL Configuration"] = 726,
    ["Schema Catalog"] = 533,
    ["Scoop manifest"] = 538,
    ["Semantic Data Fabric (SDF) file"] = 542,
    ["Semgrep Rule"] = 544,
    ["Serenity Code Generator (Sergen)"] = 545,
    ["Serverless Framework Configuration"] = 733,
    ["Serverless Workflow"] = 735,
    ["Settings.paf"] = 547,
    ["Shopware 6 Configuration"] = 736,
    ["Shopware CLI Extension Store Configuration"] = 737,
    ["Shopware CLI Project Store Configuration"] = 738,
    Sigma = 549,
    ["Sigrid scope configuration file"] = 550,
    ["SkyPilot Task JSON"] = 826,
    ["Slack app manifest"] = 554,
    Solidarity = 557,
    ["Solution filters"] = 558,
    ["Source Maps v3"] = 559,
    Sourcery = 560,
    SpecIF = 561,
    ["Sponge Mixin configuration"] = 562,
    StackBlitz = 567,
    ["StackHawk Scanner Configuration"] = 732,
    Stale = 568,
    ["Starlake Data Pipeline"] = 707,
    Starship = 569,
    ["Statamic Blueprint"] = 570,
    ["Stella configuration file"] = 571,
    ["StrmPrivacy Data Connector"] = 781,
    ["StrmPrivacy Data Contract"] = 782,
    ["StrmPrivacy SimpleSchema"] = 779,
    ["StrmPrivacy Stream"] = 780,
    ["StrmPrivacy batch job configuration file"] = 778,
    ["Stryker Mutator"] = 574,
    ["StyleCop Analyzers Configuration"] = 575,
    ["Stylelint (.stylelintrc)"] = 576,
    ["Sublime Syntax"] = 783,
    ["Subsquid squid manifest"] = 828,
    ["Swagger API 2.0"] = 578,
    TSON = 604,
    TSTyche = 605,
    Talhelper = 580,
    ["Talisman configuration"] = 581,
    ["Taskfile config"] = 712,
    Taurus = 582,
    ["TestEnvironment.json"] = 591,
    ["TextMate Grammar"] = 590,
    ["Tier.run pricing.json"] = 585,
    Tikibase = 586,
    ["Traefik v2"] = 594,
    ["Traefik v2 File Provider"] = 595,
    ["Travis CI (.travis.yml)"] = 593,
    TunnelHub = 818,
    Turborepo = 592,
    Tye = 740,
    ["UET BuildConfig.json"] = 788,
    ["UI5 Manifest"] = 614,
    ["UNCORS configuration"] = 618,
    ["UTAM Page Object"] = 617,
    ["Ubuntu Server Autoinstall"] = 612,
    ["Uniswap Token List"] = 695,
    ["Unreal Engine Uplugin"] = 789,
    ["Unreal Engine Uproject"] = 790,
    ["Updatecli Compose"] = 748,
    ["Updatecli Policy Manifest"] = 749,
    ["Updatecli Policy Metadata"] = 750,
    Uplift = 786,
    ["User Journey Map"] = 715,
    V2Ray = 754,
    ["VSCode Code Snippets"] = 166,
    ["VSIX CLI publishing"] = 632,
    ["Vela Pipeline Configuration"] = 621,
    Vercel = 165,
    Visivo = 816,
    ["Web App Manifest"] = 639,
    ["Web types"] = 642,
    WebExtensions = 638,
    ["Webman package recipe"] = 760,
    ["Windows Package Manager Installer Manifest"] = 692,
    ["Windows Package Manager Locale Manifest"] = 693,
    ["Windows Package Manager Singleton Manifest"] = 691,
    ["Woodpecker pipeline config"] = 728,
    ["Wrangler CLI"] = 643,
    ["Xstate Machine"] = 746,
    ["Yarn Config (.yarnrc.yml)"] = 705,
    ["Yippee-Ki-JSON configuration YML"] = 697,
    ["aerleon.yml"] = 7,
    ["angular.json"] = 15,
    apko = 820,
    ...
    ["behat.yml"] = 89,
    ["bigquery-table"] = 81,
    ["bioimageio resource description"] = 836,
    ...
    ["lint-staged (.lintstagedrc)"] = 663,
    ["local.settings.json"] = 372,
    ["localazy.json"] = 373,
    ["lotus.yaml"] = 371,
    ["lsdlschema.json"] = 374,
    ["markdown-link-check"] = 724,
    mboats = 731,
    ["micro-settings.json"] = 800,
    ["mimetypes.json"] = 383,
    ["mirrord config"] = 664,
    mise = 665,
    ["mise-settings"] = 666,
    ...
    ["nswag.json"] = 428,
    ntangle = 429,
    ["nuclei-template.yaml"] = 426,
    ["nuget-project.json"] = 427,
    ["ocelot.json"] = 431,
    ["omnisharp.json"] = 432,
    ["openapi.json"] = 433,
    ["openfin.json"] = 440,
    ...
    ["ops.yaml"] = 437,
    ["package.json"] = 451,
    ["package.manifest"] = 452,
    ["partial-black.json"] = 90,
    ["pathfinder.yml"] = 455,
    ["pattern.json"] = 458,
    ["petstore-v1.0"] = 775,
    pgap_yaml_input_reader = 457,
    ["pixi.toml"] = 459,
    ["plagiarize-me.yaml"] = 463,
    ["plagiarize.yaml"] = 462,
    ["portman.json"] = 464,
    ["prettierrc.json"] = 472,
    ["prisma.yml"] = 473,
    ["project-1.0.0-beta3.json"] = 476,
    ["project-1.0.0-beta4.json"] = 477,
    ["project-1.0.0-beta5.json"] = 478,
    ["project-1.0.0-beta6.json"] = 479,
    ["project-1.0.0-beta8.json"] = 480,
    ["project-1.0.0-rc1.json"] = 481,
    ["project-1.0.0-rc2.json"] = 482,
    ["project.json"] = 475,
    ["prometheus.json"] = 483,
    ["prometheus.rules.json"] = 484,
    ["prometheus.rules.test.json"] = 485,
    ["proxies.json"] = 486,
    ["publiccode.yml"] = 487,
    ["pubspec.yaml"] = 488,
    ["pyrseas-0.8.json"] = 491,
    ["quilt.mod.json"] = 801,
    ["release drafter"] = 679,
    ["release-plz.toml"] = 504,
    ["rivet.yaml"] = 823,
    rockcraft = 514,
    rustfmt = 515,
    samt = 517,
    samtrc = 518,
    ["sarif-1.0.0.json"] = 520,
    ["sarif-2.0.0.json"] = 521,
    ["sarif-2.1.0"] = 531,
    ["sarif-2.1.0-rtm.2"] = 522,
    ["sarif-2.1.0-rtm.3"] = 524,
    ["sarif-2.1.0-rtm.4"] = 526,
    ["sarif-2.1.0-rtm.5"] = 528,
    ["sarif-2.1.0-rtm.6"] = 529,
    ["sarif-external-property-file-2.1.0"] = 532,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 523,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 525,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 527,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 530,
    ["schema.org - Action"] = 534,
    ["schema.org - ContactPoint"] = 535,
    ["schema.org - Place"] = 536,
    ["schema.org - Thing"] = 537,
    ["secrethub.yml"] = 803,
    ["semantic-release"] = 543,
    ["servicehub.config.json"] = 653,
    ["servicehub.service.json"] = 652,
    ["settings.job"] = 546,
    ["sfdx-hardis configuration"] = 548,
    ["shard.yml"] = 839,
    ["size-limit configuration"] = 553,
    ["skaffold.yaml"] = 722,
    ["skyuxconfig.json"] = 555,
    snapcraft = 556,
    ["sqlc configuration"] = 564,
    ["stripe-app-local.json"] = 573,
    ["stripe-app.json"] = 572,
    swcrc = 708,
    ["task.json"] = 579,
    taskcat = 675,
    ["template.json"] = 583,
    ["templatsources.json"] = 584,
    ["theme.json"] = 587,
    ["tizen_workspace.json"] = 588,
    tldr = 589,
    tmuxinator = 661,
    ["transcend.yml"] = 596,
    ...
    ["vega-lite.json"] = 620,
    ["vega.json"] = 619,
    ["venvironment-basic.yaml"] = 623,
    ["venvironment.yaml"] = 622,
    ["version.json"] = 624,
    ["vim-addon-info"] = 626,
    ["vs-2017.3.host.json"] = 628,
    ["vs-nesting.json"] = 629,
    ["vsls.json"] = 627,
    ["vss-extension.json"] = 633,
    ["vtesttree.yaml"] = 634,
    ["vtestunit.yaml"] = 635,
    ["warp-keysets.json"] = 809,
    ["warp-themes.json"] = 810,
    ["warp-workflows.json"] = 811,
    ["webhint.io"] = 761,
    ["webjobpublishsettings.json"] = 641,
    ["webjobs-list.json"] = 640,
    ["xs-app.json"] = 671,
    ["xunit.runner.json"] = 651,
    yamllint = 696,
    zuul = 680,
    ["Žinoma"] = 690
  },
