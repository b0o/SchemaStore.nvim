...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 861,
    [".nodehawkrc"] = 525,
    [".npmpackagejsonlintrc"] = 529,
    [".omletrc"] = 1037,
    [".phrase.yml"] = 592,
    [".phraseapp.yml"] = 593,
    [".pmbot.yml"] = 580,
    [".postcssrc"] = 587,
    [".powerpages-web-template-manifest"] = 589,
    [".pre-commit-config.yml"] = 590,
    [".pre-commit-hooks.yml"] = 591,
    [".putout.json"] = 620,
    [".rehyperc"] = 644,
    [".remarkrc"] = 648,
    [".sprite files"] = 735,
    ...
    ["A micro editor config"] = 476,
    ABCInventoryModuleData = 18,
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1082,
    ["API Builder"] = 896,
    ["AVA Configuration"] = 958,
    ...
    ["AWS Copilot Manifest"] = 1121,
    ["AWS SAM CLI Samconfig"] = 224,
    ["Adobe UXP Manifest"] = 1020,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1111,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 930,
    ["All Contributors configuration file"] = 983,
    ...
    ["Application list for a WinUtil"] = 1064,
    ArchitectFX = 1069,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure IoT Operations connector metadata"] = 1127,
    ...
    ["Azure Pipelines"] = 79,
    ["Azure Static Web Apps CLI configuration file"] = 739,
    ["Azure Static Web Apps configuration file"] = 738,
    ["BOSH CPI Config"] = 103,
    ["BOSH Deploy Config"] = 104,
    ["BX CI"] = 123,
    ["Bashly (bashly.yml)"] = 987,
    ["Bashly Settings (bashly-settings.yml)"] = 988,
    ["Better Code Hub"] = 900,
    ["Better Scripts"] = 124,
    Bigconfig = 96,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1075,
    BizTalkServerApplicationSchema = 868,
    Bleep = 125,
    ...
    ["Butane Config"] = 943,
    C4InterFlow = 1090,
    ["CDK Environment Manager, concrete environment configuration"] = 1114,
    ["CDK Environment Manager, concrete environments definition"] = 1113,
    ["CDK Environment Manager, environment definition"] = 1112,
    ["CGS Card Game Specification (cgs.json)"] = 1025,
    ["CICS TS region tagging"] = 952,
    ["CICS TS resource import"] = 953,
    ["CICS TS resource model"] = 954,
    ["CICS TS resource overrides"] = 955,
    ["CMake Presets"] = 126,
    ["CNC Codes"] = 147,
    ["CRS WAF test file"] = 1054,
    ["CRS WAF test platform overrides file"] = 1055,
    ...
    ["Chamaleon environment"] = 1079,
    ["Chamaleon properties"] = 1080,
    ["Chamaleon template"] = 1078,
    Changesets = 233,
    Changie = 135,
    Charmcraft = 136,
    Cheatsheets = 940,
    ...
    ["Clawject config"] = 153,
    ["Cloud Foundry Application Manifest"] = 1036,
    ["Cloud Run Spec v1"] = 1059,
    ...
    Concord = 1053,
    ["Configu .cfgu files"] = 1041,
    ["Configu .configu file"] = 1042,
    Conjure = 146,
    ["Container Structure Test"] = 882,
    Containerlab = 909,
    ["Contextive Glossary"] = 1106,
    Convex = 145,
    ["Crowdsec collection config"] = 243,
    ["Crowdsec parser config"] = 244,
    ["Crowdsec scenario config"] = 245,
    ["CumulusCI Config"] = 152,
    ["Custom Machinery Machine"] = 1026,
    ["Custom Machinery Recipe"] = 1027,
    ...
    ["DataYoga Job"] = 159,
    ["Databricks Asset Bundles"] = 1004,
    ["Datadog Continuous Testing"] = 448,
    ["Datadog Service Definition"] = 449,
    ["Datadog Software Catalog"] = 450,
    ["Datahub Ingestion Recipe"] = 959,
    ...
    ["DonateCaseBetterCasino menu"] = 1083,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 995,
    ["EAS config"] = 309,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 984,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1126,
    ["EasyVCR .NET"] = 310,
    ["Eidolon Resource"] = 1070,
    ...
    ["Evolving Resolutive Process notation"] = 1128,
    ["Expo SDK"] = 308,
    ...
    ["GeoJSON.json latest"] = 947,
    GherKing = 951,
    ["GitHub Action"] = 340,
    ["GitHub Actions typing"] = 1066,
    ...
    ["Google Digital Assetlinks"] = 1107,
    Goreleaser = 368,
    ["Goreleaser Pro"] = 369,
    Goss = 370,
    ["Gradle Build Cache Node"] = 898,
    ["Gradle Enterprise"] = 897,
    ...
    Hadolint = 878,
    Hammerkit = 908,
    ["Hardware Sentry Configuration"] = 963,
    ["HashiCorp Vault"] = 383,
    Hatch = 879,
    Hayagriva = 385,
    Hayson = 386,
    ...
    ["IBM Zapp document"] = 397,
    ["IBM zCodeFormatSettings"] = 398,
    ["IMG Catapult PSP"] = 403,
    ["IVMS101 by CODE Protocol"] = 1023,
    Infrahub = 405,
    Istanbul = 966,
    ["JDownloader2 crawler multi-rules"] = 415,
    ["JDownloader2 crawler single-rules"] = 414,
    ["JFrog Applications Config"] = 416,
    ["JFrog File Spec"] = 417,
    ["JFrog Pipelines YML DSL"] = 972,
    ["JMeter DSL cli config"] = 418,
    JReleaser = 421,
    ["JSON Document Transform"] = 429,
    ["JSON Feed"] = 430,
    ["JSON Resume"] = 654,
    ["JSON Schema Draft 2020-12"] = 846,
    ["JSON Schema Draft 4"] = 843,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1005,
    ["JSON Schema Draft 7"] = 844,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1006,
    ["JSON Schema Draft 8 (2019-09)"] = 845,
    ["JSON-API"] = 428,
    ["JSON-e templates"] = 905,
    ["JSON-stat 2.0"] = 839,
    JSONPatch = 432,
    ["JSR Package Config (jsr.json)"] = 422,
    Jasmine = 409,
    Jekyll = 410,
    ["Jenkins X Pipelines"] = 411,
    ["Jenkins X Requirements"] = 412,
    Jest = 413,
    Jocker = 419,
    ["Jovo Language Models"] = 420,
    ["Jujutsu (jj) VCS config"] = 1120,
    ["KIMMDY config file"] = 443,
    ["KODE/CI build.yaml"] = 968,
    ["KSP-AVC"] = 840,
    ["KSP-CKAN"] = 841,
    ["KSP-NetKAN"] = 842,
    KSY = 1035,
    ...
    Kas = 435,
    ["Kestra flow file"] = 444,
    ["Keycloak REST API"] = 975,
    ["Knative Functions - func.yaml"] = 329,
    ["Kometa (nightly) config file"] = 446,
    ["Kometa config file"] = 445,
    ["Kong DBLess config"] = 969,
    KrakenD = 447,
    ["Kubri Configuration"] = 454,
    LOOBin = 469,
    ["Lake configuration file"] = 1123,
    ...
    ["Lando (landofile)"] = 75,
    ["LangGraph Platform configuration"] = 1046,
    ["Language configuration"] = 1045,
    Lefthook = 458,
    ["Liferay client-extension.yaml"] = 465,
    ["LinkML Metamodel"] = 467,
    Liquibase = 914,
    ["Liquibase Flow File"] = 915,
    ["Lively Properties"] = 468,
    ["Lobe AI Agent"] = 77,
    Loki = 78,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 508,
    ["MS2Rescore Configuration"] = 511,
    ["Madness (madness.yml)"] = 986,
    ["MapEHR Mapping"] = 475,
    Markdownlint = 918,
    ["Mason Registry"] = 921,
    ["MegaLinter Custom Flavor"] = 478,
    ["MegaLinter configuration"] = 477,
    ["MegaLinter descriptor"] = 479,
    Melange = 1013,
    ["Meltano project definition"] = 480,
    ["Mergify Configuration"] = 512,
    ["Metadata for a Bazel module"] = 481,
    ["Metadata for a Cinnamon spice"] = 1062,
    ["Metatype Configuration"] = 482,
    ["MetricsHub Configuration"] = 483,
    ["MetricsHub Connector Configuration"] = 484,
    ["Micro Editor Syntax"] = 996,
    ["Microsoft Band Web Tile"] = 485,
    ["Microsoft RulesEngine workflow rules"] = 1050,
    ["Microsoft RulesEngine workflow rules list"] = 1051,
    ["Minecraft Custom Main Menu Mod"] = 1014,
    ["Minecraft Data Pack Advancement"] = 487,
    ["Minecraft Data Pack Biome"] = 488,
    ["Minecraft Data Pack Configured Carver"] = 489,
    ["Minecraft Data Pack Damage Type"] = 490,
    ["Minecraft Data Pack Dimension"] = 492,
    ["Minecraft Data Pack Dimension Type"] = 491,
    ["Minecraft Data Pack Item Modifier"] = 493,
    ["Minecraft Data Pack Loot Table"] = 494,
    ["Minecraft Data Pack Metadata"] = 495,
    ["Minecraft Data Pack Predicate"] = 496,
    ["Minecraft Data Pack Recipe"] = 497,
    ["Minecraft Data Pack Tag"] = 498,
    ["Minecraft Data Pack Template Pool"] = 499,
    ["Minecraft Data Pack Trim Material"] = 504,
    ["Minecraft Data Pack Trim Pattern"] = 505,
    ["Minecraft Resource Pack Lang"] = 500,
    ["Minecraft Resource Pack Particle"] = 501,
    ["Minecraft Resource Pack Texture Mcmeta"] = 503,
    ["Minecraft Resourcepack Sounds"] = 502,
    ["Monade CLI Stack Configuration"] = 515,
    ["MongoDB Atlas Search Index Definition"] = 967,
    ["Monika Configuration"] = 965,
    ["Monoweave Configuration"] = 510,
    ["Motif config"] = 860,
    MultiQC = 1100,
    ["NOX Framework (Service)"] = 528,
    ["Netin Diagnostic System Template"] = 925,
    ["Netlify config"] = 518,
    ["Network-as-Code Data Model"] = 519,
    ["Nightwatch.js"] = 521,
    ["Node.js configuration"] = 865,
    ["NueJS configuration file"] = 533,
    ["Nuitka.yaml"] = 1028,
    ["Nullstone config"] = 535,
    ["ONe's changelog entry"] = 549,
    ["ONe's service descriptor"] = 548,
    ["ORT Server repository environment configuration"] = 557,
    ["OSCAL Assessment Plan (AP)"] = 559,
    ["OSCAL Assessment Results (AR)"] = 560,
    ["OSCAL Catalog"] = 561,
    ["OSCAL Component Definition (CDef)"] = 562,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 563,
    ["OSCAL Profile"] = 564,
    ["OSCAL System Security Plan (SSP)"] = 565,
    ["OSS Review Toolkit configuration"] = 566,
    ["OSS Review Toolkit curation"] = 567,
    ["OSS Review Toolkit package configuration"] = 568,
    ["OSS Review Toolkit repository configuration"] = 569,
    ["OSS Review Toolkit resolutions"] = 570,
    ["October CMS columns"] = 539,
    ["October CMS fields"] = 540,
    Okteto = 541,
    Opctl = 863,
    ["Open Data Contract Standard (ODCS)"] = 552,
    ["Open Data Product Standard (ODPS)"] = 553,
    ["Open Know-How"] = 1105,
    ["OpenRewrite Resource"] = 551,
    OpenStatus = 1116,
    ["OpenUtau character yaml"] = 545,
    ["OpenUtau ustx"] = 546,
    ["OpenWeather Current Weather API"] = 904,
    ["OpenWeather Road Risk API"] = 903,
    ["Ory Hydra configuration"] = 395,
    ["Ory Keto configuration"] = 451,
    ["Ory Kratos configuration"] = 558,
    ["Ory Oathkeeper configuration"] = 537,
    ["Outblocks App configuration"] = 555,
    ["Outblocks database table"] = 556,
    ["Outblocks project configuration"] = 554,
    PDM = 576,
    Packer = 573,
    Pantsbuild = 982,
    ["Paper paper-plugin.yml"] = 574,
    ["Pipeline component"] = 916,
    ["Platform.sh application"] = 2,
    ["Platform.sh routes"] = 3,
    ["Platform.sh services"] = 4,
    ["Plex Prerolls"] = 584,
    ["PocketMine plugin.yml"] = 581,
    ["Postman collection"] = 588,
    ["Power Pages Configuration"] = 1117,
    ["Preset list for a WinUtil"] = 1065,
    ["ProActions AI-Kit Configuration"] = 597,
    ["ProActions AI-Kit Configuration for Menus"] = 599,
    ["ProActions AI-Kit Configuration for Sections"] = 601,
    ["ProActions AI-Kit Configuration for Services"] = 598,
    ["ProActions AI-Kit Configuration for Steps"] = 602,
    ["ProActions AI-Kit Configuration for Templates"] = 600,
    ["Problem object RFC9457"] = 1011,
    ["Problem package generators"] = 603,
    Pterodactyl = 962,
    ["Pull Request Labeler"] = 619,
    Pulumi = 627,
    ["PyGTA Config"] = 623,
    PyProject = 628,
    Pylock = 1108,
    Pyright = 629,
    ["Python script metadata"] = 1102,
    ["QType AI DSL"] = 632,
    Qgoda = 631,
    Qodana = 935,
    ["Qt Creator workspace file"] = 1043,
    ["Quali Torque Blueprint Spec 2"] = 960,
    ["QueryFirst config file"] = 978,
    ["RKE Cluster Configuration JSON"] = 913,
    ["RKE Cluster Configuration YAML"] = 912,
    RadioHound = 622,
    Railway = 633,
    ["Rancher Fleet"] = 624,
    ["Rattler-build"] = 634,
    Ray = 877,
    ["Read the Docs"] = 626,
    ["Red-DiscordBot Cog"] = 641,
    ["Red-DiscordBot Cog Repo"] = 642,
    ["Red-DiscordBot Trivia"] = 643,
    ["Render Blueprints"] = 911,
    RenderCV = 656,
    Renovate = 655,
    ["Replit config"] = 649,
    Restate = 1095,
    ["Revel Digital Gadget Definition File"] = 1119,
    RoadRunner = 658,
    ["Robust Station Image"] = 1125,
    ["Roo Coder Custom Modes"] = 660,
    Rubocop = 651,
    ["Rudder techniques"] = 1018,
    Ruff = 652,
    ["Rust Project"] = 653,
    ["Rust toolchain"] = 663,
    ["SDMX data message"] = 689,
    ["SDMX metadata message"] = 688,
    ["SDMX structure message"] = 687,
    ["SIL Kit Participant Configuration"] = 699,
    ["SIL Kit Registry Configuration"] = 700,
    ["SPDX 2.3"] = 736,
    SWADL = 752,
    ["Safebox Config"] = 973,
    ["Sapphire CLI Config"] = 666,
    ["SauceCTL Configuration"] = 922,
    ["Schema Catalog"] = 681,
    ["Scoop manifest"] = 686,
    ["Semantic Data Fabric (SDF) file"] = 690,
    ["Semgrep Rule"] = 692,
    ["Serenity Code Generator (Sergen)"] = 693,
    ["Serverless Framework Configuration"] = 929,
    ["Serverless Workflow"] = 931,
    ["Settings for a Cinnamon spice"] = 1061,
    ["Settings.paf"] = 695,
    ["Shopware 6 Configuration"] = 932,
    ["Shopware CLI Extension Store Configuration"] = 933,
    ["Shopware CLI Project Store Configuration"] = 934,
    ["Sigma Detection Rule"] = 697,
    ["Sigrid scope configuration file"] = 698,
    ["SkyPilot Task JSON"] = 1019,
    ["Slack app manifest"] = 702,
    Solidarity = 707,
    ["Solution filters"] = 708,
    ["Source Maps v3"] = 709,
    Sourcery = 710,
    ["Spack bootstrap.yaml"] = 711,
    ["Spack cdash.yaml"] = 712,
    ["Spack ci.yaml"] = 713,
    ["Spack compilers.yaml"] = 714,
    ["Spack concretizer.yaml"] = 715,
    ["Spack config.yaml"] = 716,
    ["Spack definitions.yaml"] = 717,
    ["Spack develop.yaml"] = 718,
    ["Spack env_vars.yaml"] = 719,
    ["Spack environment"] = 725,
    ["Spack include.yaml"] = 720,
    ["Spack mirrors.yaml"] = 721,
    ["Spack modules.yaml"] = 722,
    ["Spack packages.yaml"] = 723,
    ["Spack repos.yaml"] = 724,
    ["Spack toolchains.yaml"] = 726,
    ["Spack upstreams.yaml"] = 727,
    ["Spack view.yaml"] = 728,
    ["Speakeasy Generation Config File"] = 732,
    ["Speakeasy Lint Configuration File"] = 729,
    ["Speakeasy Test Generation Configuration File"] = 730,
    ["Speakeasy Workflow File"] = 731,
    SpecIF = 733,
    ["Sponge Mixin configuration"] = 734,
    StackBlitz = 740,
    ["StackHawk Scanner Configuration"] = 928,
    Stale = 741,
    Starfish = 742,
    ["Starlake Data Pipeline"] = 901,
    Starship = 743,
    ["Statamic Blueprint"] = 744,
    ["Stella configuration file"] = 745,
    ["Streamlit configuration file"] = 746,
    ["Stryker Mutator"] = 749,
    ["StyleCop Analyzers Configuration"] = 750,
    ["Stylelint (.stylelintrc)"] = 751,
    ["Stylua Config"] = 1109,
    ["Sublime Syntax"] = 974,
    ["Subsquid squid manifest"] = 1021,
    ["Swagger API 2.0"] = 753,
    ["Synadia Connect Component"] = 754,
    TSON = 789,
    TSTyche = 790,
    ["TYPO3 Vendor Bundler config"] = 795,
    ["Tab data for a LinUtil"] = 1068,
    ["Tab list for a LinUtil"] = 1067,
    Tach = 755,
    ["Tach Domain"] = 756,
    Talhelper = 758,
    ["Talisman configuration"] = 759,
    Taplo = 1110,
    ["Taskfile config"] = 906,
    Taurus = 760,
    Tauticord = 761,
    Telefonistka = 1096,
    ["Terrateam config"] = 1122,
    ["TestEnvironment.json"] = 772,
    ["TextMate Grammar"] = 771,
    Threagile = 767,
    ["Tier.run pricing.json"] = 764,
    Tikibase = 765,
    Tombi = 770,
    ["Traefik v2"] = 775,
    ["Traefik v2 File Provider"] = 776,
    ["Traefik v3"] = 777,
    ["Traefik v3 File Provider"] = 778,
    ["Travis CI (.travis.yml)"] = 774,
    Treefmt = 373,
    Trident = 1092,
    ["TrueScript for *.tscript files"] = 781,
    ["Tugboat QA config.yml"] = 1089,
    TunnelHub = 1009,
    Turborepo = 773,
    Tycho = 1057,
    Tye = 936,
    ["Tyk Gateway - Open Source v5.7+"] = 1101,
    ["Typst Manifest"] = 796,
    ["UET BuildConfig.json"] = 979,
    ["UI5 Manifest"] = 802,
    ["UNCORS configuration"] = 806,
    ["UTAM Page Object"] = 805,
    ["Ubuntu Server Autoinstall"] = 800,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1093,
    ["Uniswap Token List"] = 889,
    ["Universal Schedule Format"] = 807,
    ["Unreal Engine Uplugin"] = 980,
    ["Unreal Engine Uproject"] = 981,
    ["UpCloud CLI (upctl) configuration"] = 1094,
    ["Updatecli Compose"] = 944,
    ["Updatecli Policy Manifest"] = 945,
    ["Updatecli Policy Metadata"] = 946,
    Uplift = 977,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 910,
    V2Ray = 950,
    ["VSCode Code Snippets"] = 208,
    ["VSIX CLI publishing"] = 827,
    Vector = 809,
    ["Vela Pipeline Configuration"] = 812,
    Vercel = 207,
    ["Version Bumper config"] = 817,
    ["Viash Component Config"] = 1098,
    ["Viash Package Config"] = 1099,
    Visivo = 1007,
    ["WP-CLI"] = 837,
    Wake = 1091,
    ["Waku Config"] = 1071,
    ["Web App Manifest"] = 833,
    ["Web types"] = 836,
    WebExtensions = 832,
    ["Webman package recipe"] = 956,
    ["Windows Package Manager Installer Manifest"] = 885,
    ["Windows Package Manager Locale Manifest"] = 886,
    ["Windows Package Manager Singleton Manifest"] = 884,
    Winutil = 887,
    ["WireMock stub mapping"] = 1074,
    ["Woodpecker pipeline config"] = 924,
    ["Wrangler CLI"] = 838,
    ["Xstate Machine"] = 942,
    ["Yandex Workflow Language"] = 1063,
    ["Yarn Config (.yarnrc.yml)"] = 899,
    ["Yippee-Ki-JSON configuration YML"] = 891,
    ["YouTrack App"] = 1060,
    ["Zarf Package Configuration"] = 1124,
    ["Zerops.io config"] = 1048,
    ["Zerops.io import"] = 1049,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 1012,
    ...
    ["behat.yml"] = 106,
    ["bigquery-table"] = 95,
    ["bioimageio resource description"] = 1029,
    ...
    ["crowdin.yml"] = 242,
    ["ctfd-setup configuration file"] = 1081,
    ["custom-elements.json"] = 999,
    ["cypress.json"] = 246,
    ...
    ["gematik health care insurance list"] = 1087,
    ["gematik health care patient list"] = 1084,
    ["gematik health care provider institution list"] = 1086,
    ["gematik health care provider list"] = 1085,
    ["gematik tiger test environment configuration"] = 1088,
    ["gitlab-ci"] = 348,
    ["global.json"] = 364,
    ...
    ["ide.host.json"] = 399,
    ["ifstate.yaml"] = 400,
    ["imageoptimizer.json"] = 401,
    ["importmap.json"] = 404,
    ["ioBroker Configuration"] = 406,
    ["ioBroker JSON UI"] = 407,
    ["ioBroker Package manifest"] = 408,
    ["ize.toml"] = 976,
    ["jsconfig.json"] = 433,
    ["jscpd Configuration"] = 961,
    jsdoc = 876,
    ["k3d.yaml"] = 434,
    ["k9s aliases.yaml"] = 436,
    ["k9s cluster-config.yaml"] = 438,
    ["k9s config.yaml"] = 437,
    ["k9s hotkeys.yaml"] = 439,
    ["k9s plugins.yaml"] = 440,
    ["k9s skin.yaml"] = 441,
    ["k9s views.yaml"] = 442,
    ["kontinuous-config.yaml"] = 453,
    ["kontinuous-values.yaml"] = 452,
    ["kustomization.yaml"] = 455,
    ["label-commenter-config.yml"] = 456,
    ["latexindent configuration"] = 76,
    ["launchsettings.json"] = 457,
    lazydocker = 998,
    lazygit = 997,
    ["lego.json"] = 459,
    ["lerna.json"] = 460,
    ["lgtm.yml"] = 461,
    ["liblab.config.json"] = 462,
    ["libman.json"] = 463,
    ["license-report-config.json"] = 464,
    ["linkinator.config.json"] = 466,
    ["lint-staged (.lintstagedrc)"] = 854,
    ["local.settings.json"] = 471,
    ["localazy.json"] = 472,
    ["lotus.yaml"] = 470,
    ["lsdlschema.json"] = 473,
    ["markdown-link-check"] = 919,
    maturin = 920,
    mboats = 927,
    ["micro-settings.json"] = 991,
    ["mimetypes.json"] = 486,
    ["mirrord config"] = 856,
    mise = 857,
    ["mkdocs.yml"] = 506,
    ["monospace.yml"] = 509,
    ["moon.yml"] = 1073,
    ["mprocs Configuration file"] = 1044,
    ["mrdocs.yml"] = 507,
    ["mta.yaml"] = 858,
    ["mtad.yaml"] = 859,
    ["mycode.json"] = 516,
    nFPM = 520,
    ["napari plugin manifest"] = 517,
    neoload = 871,
    ["nest-cli"] = 523,
    ["ninjs (News in JSON)"] = 522,
    ["nitro.json"] = 870,
    ["nixd configuration"] = 1017,
    ["nlu.json"] = 524,
    ["nodemon.json"] = 526,
    ["noodl config"] = 926,
    ["notebook.mod.json"] = 527,
    now = 866,
    ["npm-badges"] = 530,
    ["nswag.json"] = 534,
    ntangle = 536,
    ["nuclei-template.yaml"] = 531,
    ["nuget-project.json"] = 532,
    ["ocelot.json"] = 538,
    ["omnisharp.json"] = 542,
    ["openapi.json"] = 543,
    ["openfin.json"] = 550,
    ...
    ["ops.yaml"] = 547,
    ["package.json"] = 571,
    ["package.manifest"] = 572,
    ["partial-black.json"] = 107,
    ["pathfinder.yml"] = 575,
    ["pattern.json"] = 578,
    ["petstore-v1.0"] = 971,
    pgap_yaml_input_reader = 577,
    ["pixi.toml"] = 579,
    ["plagiarize-me.yaml"] = 583,
    ["plagiarize.yaml"] = 582,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1077,
    ["podbard.yaml"] = 585,
    ["portman.json"] = 586,
    ["prefect.toml"] = 594,
    ["prettierrc.json"] = 595,
    ["prisma.yml"] = 596,
    ["project-1.0.0-beta3.json"] = 605,
    ["project-1.0.0-beta4.json"] = 606,
    ["project-1.0.0-beta5.json"] = 607,
    ["project-1.0.0-beta6.json"] = 608,
    ["project-1.0.0-beta8.json"] = 609,
    ["project-1.0.0-rc1.json"] = 610,
    ["project-1.0.0-rc2.json"] = 611,
    ["project.json"] = 604,
    ["project.owasp.yaml"] = 612,
    ["prometheus.json"] = 613,
    ["prometheus.rules.json"] = 614,
    ["prometheus.rules.test.json"] = 615,
    ["proxies.json"] = 616,
    ["publiccode.yml"] = 617,
    ["pubspec.yaml"] = 618,
    ["pyrseas-0.8.json"] = 621,
    pytest = 630,
    ["quilt.mod.json"] = 992,
    ["rc3 auth"] = 635,
    ["rc3 collection"] = 636,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 872,
    ["release-please-config.json"] = 645,
    ["release-please-manifest.json"] = 646,
    ["release-plz.toml"] = 647,
    ["renv.lock"] = 657,
    ["rivet.json"] = 1016,
    ["rivet.yaml (legacy)"] = 1015,
    rockcraft = 659,
    runny = 661,
    rustfmt = 662,
    sake = 1104,
    samt = 664,
    samtrc = 665,
    ["sarif-1.0.0.json"] = 667,
    ["sarif-2.0.0.json"] = 668,
    ["sarif-2.1.0"] = 678,
    ["sarif-2.1.0-rtm.2"] = 669,
    ["sarif-2.1.0-rtm.3"] = 671,
    ["sarif-2.1.0-rtm.4"] = 673,
    ["sarif-2.1.0-rtm.5"] = 675,
    ["sarif-2.1.0-rtm.6"] = 676,
    ["sarif-external-property-file-2.1.0"] = 679,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 670,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 672,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 674,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 677,
    ["scalingo.json configuration"] = 680,
    ["schema.org - Action"] = 682,
    ["schema.org - ContactPoint"] = 683,
    ["schema.org - Place"] = 684,
    ["schema.org - Thing"] = 685,
    ["secrethub.yml"] = 994,
    ["semantic-release"] = 691,
    ["servicehub.config.json"] = 849,
    ["servicehub.service.json"] = 848,
    ["settings.job"] = 694,
    ["sfdx-hardis configuration"] = 696,
    ["shard.yml"] = 1032,
    ["size-limit configuration"] = 701,
    ["skaffold.yaml"] = 917,
    ["skyuxconfig.json"] = 703,
    snapcraft = 704,
    ["snowflake-config"] = 705,
    ["snowflake-connections"] = 706,
    ["spicepod.yaml"] = 1052,
    ["sqlc configuration"] = 737,
    ["stripe-app-local.json"] = 748,
    ["stripe-app.json"] = 747,
    swcrc = 902,
    ["task.json"] = 757,
    taskcat = 867,
    ["template.json"] = 762,
    ["templatsources.json"] = 763,
    ["theme.json"] = 766,
    ["tizen_workspace.json"] = 768,
    tldr = 769,
    ["tm_devices configuration file"] = 1115,
    tmuxinator = 852,
    ["transcend.yml"] = 779,
    ["tree-sitter grammar.json"] = 372,
    ["trime.yaml"] = 780,
    ["trunk.yaml"] = 782,
    ["ts-force-config.json"] = 787,
    ["tsconfig.json"] = 783,
    ["tsd.json"] = 784,
    ["tsdoc.json"] = 785,
    ["tsdrc.json"] = 786,
    ...
    ["vega-lite.json"] = 811,
    ["vega.json"] = 810,
    ["venvironment-basic.yaml"] = 814,
    ["venvironment.yaml"] = 813,
    ["venvplus-basic.yaml"] = 816,
    ["venvplus.yaml"] = 815,
    version = 1097,
    ["version.json"] = 818,
    ["vhwdebugger-binding.yaml"] = 820,
    ["vim-addon-info"] = 821,
    ["vs-2017.3.host.json"] = 823,
    ["vs-nesting.json"] = 824,
    ["vsls.json"] = 822,
    ["vss-extension.json"] = 828,
    vtcfg = 1103,
    ["vtesttree.yaml"] = 829,
    ["vtestunit.yaml"] = 830,
    ["warp-keysets.json"] = 1000,
    ["warp-themes.json"] = 1001,
    ["warp-workflows.json"] = 1002,
    ["webhint.io"] = 957,
    ["webjobpublishsettings.json"] = 835,
    ["webjobs-list.json"] = 834,
    ["well-known-fursona"] = 1039,
    ["xs-app.json"] = 862,
    ["xunit.runner.json"] = 847,
    yamllint = 890,
    zuul = 873,
    ["Žinoma"] = 883
  },
