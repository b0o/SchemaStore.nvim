...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 873,
    [".nodehawkrc"] = 532,
    [".npmpackagejsonlintrc"] = 536,
    [".omletrc"] = 1049,
    [".phrase.yml"] = 601,
    [".phraseapp.yml"] = 602,
    [".pmbot.yml"] = 589,
    [".postcssrc"] = 596,
    [".powerpages-web-template-manifest"] = 598,
    [".pre-commit-config.yml"] = 599,
    [".pre-commit-hooks.yml"] = 600,
    [".putout.json"] = 630,
    [".rehyperc"] = 654,
    [".remarkrc"] = 658,
    [".sprite files"] = 747,
    ...
    [".vsconfig"] = 837,
    [".vsext"] = 838,
    ["1Password SSH Agent Config"] = 5,
    ["@factorial/drupal-breakpoints-css"] = 10,
    ["A micro editor config"] = 482,
    ABCInventoryModuleData = 18,
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1094,
    ["API Builder"] = 908,
    ["AVA Configuration"] = 970,
    ["AWS AppConfig Feature Flags-v1"] = 51,
    ["AWS CDK cdk.json"] = 223,
    ["AWS CloudFormation"] = 224,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 225,
    ["AWS Copilot Manifest"] = 1133,
    ["AWS SAM CLI Samconfig"] = 226,
    ["Adobe UXP Manifest"] = 1032,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1123,
    Air = 16,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1144,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1143,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 942,
    ["All Contributors configuration file"] = 995,
    ["Ansible Argument Specs"] = 357,
    ["Ansible Collection Galaxy"] = 364,
    ["Ansible Execution Environment"] = 354,
    ["Ansible Inventory"] = 363,
    ["Ansible Meta"] = 355,
    ["Ansible Meta Runtime"] = 356,
    ["Ansible Navigator Configuration"] = 366,
    ["Ansible Playbook"] = 361,
    ["Ansible Requirements"] = 358,
    ["Ansible Rulebook"] = 362,
    ["Ansible Tasks File"] = 360,
    ["Ansible Vars File"] = 359,
    ["Ansible-lint Configuration"] = 365,
    Any = 1059,
    ["AnyWork Automation Configuration"] = 9,
    ["App config Spotify Backstage"] = 25,
    ["Application Accelerator"] = 6,
    ["Application list for a WinUtil"] = 1076,
    ArchitectFX = 1081,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    AsyncAPI = 46,
    ["AsyncAPI Tool File"] = 47,
    ["Atmos Manifests"] = 48,
    ["Aurora Agile Meta-Framework"] = 49,
    AutoAPICase = 1005,
    ["Avro Avsc"] = 50,
    ["Azure Container App template for defining an immutable revision"] = 52,
    ["Azure DevOps extension manifest"] = 55,
    ["Azure Device Update for IoT Hub import manifest"] = 53,
    ["Azure Device Update for IoT Hub update manifest"] = 54,
    ["Azure IoT Edge deployment"] = 58,
    ["Azure IoT Edge deployment template"] = 59,
    ["Azure IoT EdgeAgent deployment"] = 56,
    ["Azure IoT EdgeHub deployment"] = 57,
    ["Azure IoT Operations Wasm Graph Config"] = 1142,
    ["Azure IoT Operations connector metadata"] = 1139,
    ["Azure Landing Zones Library archetype definition"] = 63,
    ["Azure Landing Zones Library archetype override"] = 64,
    ["Azure Landing Zones Library architecture definition"] = 62,
    ["Azure Landing Zones Library metadata"] = 60,
    ["Azure Landing Zones Library policy default values"] = 61,
    ["Azure Pipelines"] = 81,
    ["Azure Static Web Apps CLI configuration file"] = 751,
    ["Azure Static Web Apps configuration file"] = 750,
    ["BOSH CPI Config"] = 105,
    ["BOSH Deploy Config"] = 106,
    ["BX CI"] = 125,
    ["Bashly (bashly.yml)"] = 999,
    ["Bashly Settings (bashly-settings.yml)"] = 1000,
    ["Better Code Hub"] = 912,
    ["Better Scripts"] = 126,
    Bigconfig = 98,
    ["Biome Formatter Config"] = 65,
    ["Bitmovin Encoding Template"] = 1087,
    BizTalkServerApplicationSchema = 880,
    Bleep = 127,
    ["Block Protocol Metadata"] = 124,
    ["Boyka Framework"] = 107,
    Briefcase = 886,
    ["Build Info"] = 115,
    Buildkite = 117,
    ["Bukkit plugin.yml"] = 116,
    ["BungeeCord plugin.yml"] = 122,
    ["Butane Config"] = 955,
    C4InterFlow = 1102,
    ["CDK Environment Manager, concrete environment configuration"] = 1126,
    ["CDK Environment Manager, concrete environments definition"] = 1125,
    ["CDK Environment Manager, environment definition"] = 1124,
    ["CGS Card Game Specification (cgs.json)"] = 1037,
    ["CICS TS region tagging"] = 964,
    ["CICS TS resource import"] = 965,
    ["CICS TS resource model"] = 966,
    ["CICS TS resource overrides"] = 967,
    ["CMake Presets"] = 128,
    ["CNC Codes"] = 149,
    ["CRS WAF test file"] = 1066,
    ["CRS WAF test platform overrides file"] = 1067,
    ["CSS Comb (.csscomb.json)"] = 251,
    ["CSS Lint (.csslintrc)"] = 252,
    ["CSpell (cspell.json)"] = 250,
    ["CVE Record Format"] = 157,
    CWL = 1043,
    ["Cache Warmup config"] = 129,
    ["Calqulus pipeline"] = 130,
    ["Camel YAML DSL"] = 131,
    ["Cannon TOML"] = 132,
    Carafe = 133,
    ["Cargo Make"] = 135,
    ["Cargo Manifest"] = 134,
    ["Catalog Info Backstage"] = 136,
    ["Chamaleon environment"] = 1091,
    ["Chamaleon properties"] = 1092,
    ["Chamaleon template"] = 1090,
    Changesets = 235,
    Changie = 137,
    Charmcraft = 138,
    Cheatsheets = 952,
    ["ChordPro Configuration"] = 139,
    ["Chrome Extension"] = 216,
    ["Chromia Model"] = 140,
    ["Chromia Seeder Module Config"] = 142,
    ["Chromia Seeder Root Config"] = 141,
    ["Cinnamon Spice info.json"] = 72,
    ["CircleCI config.yml"] = 192,
    ["Citation File Format"] = 237,
    CityJSON = 144,
    ["Claude Code Settings"] = 156,
    ["Clawject config"] = 155,
    ["Cloud Foundry Application Manifest"] = 1048,
    ["Cloud Run Spec v1"] = 1071,
    ["CloudCannon Configuration"] = 76,
    ["CloudEvents specification"] = 145,
    ["Code Climate"] = 193,
    CodeCV = 74,
    CodeRabbit = 73,
    ["CodeShip Pro services configuration files"] = 205,
    ["CodeShip Pro steps configuration files"] = 206,
    ["Codecov configuration files"] = 204,
    CodifyCLI = 75,
    Codux = 202,
    ["Cog config file"] = 150,
    ["Commandbox Box.json"] = 151,
    ["Commandbox Server.json"] = 152,
    ["Common Catalog Data"] = 214,
    ["Common Package Specification"] = 153,
    Concord = 1065,
    ["Configu .cfgu files"] = 1053,
    ["Configu .configu file"] = 1054,
    Conjure = 148,
    ["Container Structure Test"] = 894,
    Containerlab = 921,
    ["Contextive Glossary"] = 1118,
    Convex = 147,
    ["Crowdsec collection config"] = 245,
    ["Crowdsec parser config"] = 246,
    ["Crowdsec scenario config"] = 247,
    ["CumulusCI Config"] = 154,
    ["Custom Machinery Machine"] = 1038,
    ["Custom Machinery Recipe"] = 1039,
    ["Cycle Stack File"] = 158,
    CycloneDX = 159,
    ["DWP Exchange - catalogue entry"] = 294,
    ["DWP Exchange - gateway"] = 292,
    ["DWP Exchange - meta"] = 293,
    ["Dart Build Config (dart-build.json)"] = 253,
    ["Dart Test Config (dart-test.json)"] = 254,
    ["DashLord Configuration"] = 255,
    ["Data Contract Specification"] = 256,
    ["Data Product Specification"] = 257,
    ["DataYoga Connections"] = 160,
    ["DataYoga Job"] = 161,
    ["Databricks Asset Bundles"] = 1016,
    ["Datadog Continuous Testing"] = 453,
    ["Datadog Service Definition"] = 454,
    ["Datadog Software Catalog"] = 455,
    ["Datahub Ingestion Recipe"] = 971,
    ["Debian Upstream Metadata file"] = 167,
    ["Deck config"] = 168,
    ["Dein Config"] = 169,
    ["Deno Config (deno.json)"] = 263,
    ["Dependency cruiser"] = 170,
    ["DeployStack Configuration"] = 171,
    ["Deployah Configuration"] = 1141,
    ["Deployer Recipe"] = 266,
    ["Deta Spacefile"] = 172,
    ["Detekt Config (detekt.yml)"] = 267,
    ["Devbox Config"] = 173,
    ["Devbox Plugin"] = 174,
    Devfile = 291,
    DipDup = 1068,
    ["Discord Webhook"] = 268,
    ["DocFx Config (docfx.json)"] = 272,
    Dofigen = 273,
    ["Dolittle Artifacts"] = 274,
    ["Dolittle Bounded Context Configuration"] = 275,
    ["Dolittle Event Horizons Configuration"] = 276,
    ["Dolittle Resources Configuration"] = 277,
    ["Dolittle Server Configuration"] = 278,
    ["Dolittle Tenant Map Configuration"] = 280,
    ["Dolittle Tenants Configuration"] = 279,
    ["Dolittle Topology"] = 281,
    ["DonateCaseBetterCasino menu"] = 1095,
    ["Drupal Breakpoints"] = 175,
    ["Drupal Config"] = 187,
    ["Drupal Info"] = 176,
    ["Drupal Layouts"] = 177,
    ["Drupal Libraries"] = 178,
    ["Drupal Links Action"] = 179,
    ["Drupal Links Contextual"] = 180,
    ["Drupal Links Menu"] = 181,
    ["Drupal Links Task"] = 182,
    ["Drupal Migration"] = 183,
    ["Drupal Permissions"] = 184,
    ["Drupal Recipe"] = 185,
    ["Drupal Routing"] = 186,
    ["Drupal Services"] = 188,
    ["Drush site aliases"] = 287,
    ["Dynamic Bash Aliases (.aliases)"] = 1007,
    ["EAS config"] = 311,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 996,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1138,
    ["EasyVCR .NET"] = 312,
    ["Eidolon Resource"] = 1082,
    ["Elgato Stream Deck"] = 297,
    Elm = 1070,
    ["Embrace Config"] = 982,
    Endurica = 1020,
    ["Enterprise Contract Policy Spec"] = 298,
    ["Erda Pipeline"] = 1045,
    ["Erda Runtime"] = 1046,
    Esquio = 300,
    ["Estuary Flow Catalog"] = 961,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 304,
    ["EveryVoice TTS Toolkit Data Configuration"] = 305,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 309,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 308,
    ["EveryVoice TTS Toolkit Text Configuration"] = 306,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 307,
    ["Evolving Resolutive Process notation"] = 1140,
    ["Expo SDK"] = 310,
    ["F-Droid Data metadata"] = 316,
    ["FasterCI Configuration"] = 82,
    FiQuS = 320,
    Firebase = 318,
    ["FlexGet Config"] = 321,
    ["Flow.json Configurations"] = 1042,
    ["Fossa configuration file"] = 328,
    ["Fossa's fossa-deps file"] = 329,
    ["Foundry VTT - Base package Manifest"] = 323,
    ["Foundry VTT - Module Manifest"] = 324,
    ["Foundry VTT - System Data Template"] = 327,
    ["Foundry VTT - System Manifest"] = 325,
    ["Foundry VTT - World Manifest"] = 326,
    ["Foxx Manifest"] = 83,
    ["Freifunk.de Community API"] = 86,
    ["Frogbot Config"] = 87,
    ["G2P Mapping Configuration"] = 335,
    ["GCP Blueprint Metadata"] = 338,
    Gaspar = 336,
    ["GatewayCore API Gateway"] = 337,
    ["GeoJSON.json latest"] = 959,
    GherKing = 963,
    ["GitHub Action"] = 343,
    ["GitHub Actions typing"] = 1078,
    ["GitHub Discussion"] = 344,
    ["GitHub Funding"] = 345,
    ["GitHub Issue Template configuration"] = 346,
    ["GitHub Issue Template forms"] = 347,
    ["GitHub Workflow"] = 348,
    ["GitHub Workflow Template Properties"] = 349,
    ["GitHub automatically generated release notes configuration"] = 350,
    ["GitLab Agent for Kubernetes configuration"] = 1034,
    GitVersion = 340,
    ["Gitea Issue Template configuration"] = 341,
    ["Gitea Issue Template forms"] = 342,
    ["Gitpod Automations"] = 352,
    ["Gitpod Configuration"] = 353,
    ["GlazeWM settings"] = 1036,
    ["Global Privacy Control"] = 339,
    Goblet = 1015,
    ["Golangci-lint Configuration"] = 368,
    ["Golangci-lint Custom Plugins Configuration"] = 369,
    ["Google Chrome Related Website Sets"] = 319,
    ["Google Cloud Workflows"] = 222,
    ["Google Digital Assetlinks"] = 1119,
    Goreleaser = 371,
    ["Goreleaser Pro"] = 372,
    Goss = 373,
    ["Gradle Build Cache Node"] = 910,
    ["Gradle Enterprise"] = 909,
    ["Grafana 5.x Dashboard"] = 374,
    ["GraphQL Code Generator"] = 379,
    ["GraphQL Config"] = 378,
    ["GraphQL Mesh"] = 377,
    ["Grunt JSHint task"] = 383,
    ["Grunt Watch task"] = 384,
    ["Grunt base task"] = 385,
    ["Grunt clean task"] = 381,
    ["Grunt copy task"] = 380,
    ["Grunt cssmin task"] = 382,
    HEMTT = 876,
    Hadolint = 890,
    Hammerkit = 920,
    ["Hardware Sentry Configuration"] = 975,
    ["HashiCorp Vault"] = 386,
    Hatch = 891,
    Hayagriva = 388,
    Hayson = 389,
    ["Haystack Pipeline"] = 390,
    ["Hazelcast 5 Configuration"] = 391,
    ["Hecate Input Schema"] = 1130,
    ["Helm Chart.lock"] = 190,
    ["Helm Chart.yaml"] = 189,
    ["Helm Unittest Test Suite"] = 191,
    ["Home Assistant Integration Manifest"] = 392,
    ["Homer dashboard configuration"] = 393,
    Hugo = 951,
    ["Hugo Theme"] = 950,
    ["Hulak Configuration"] = 400,
    ["Hyperfoil benchmark configuration"] = 399,
    ["IBM Zapp document"] = 401,
    ["IBM zCodeFormatSettings"] = 402,
    ["IMG Catapult PSP"] = 407,
    ["IVMS101 by CODE Protocol"] = 1035,
    Infrahub = 409,
    Istanbul = 978,
    ["JDownloader2 crawler multi-rules"] = 420,
    ["JDownloader2 crawler single-rules"] = 419,
    ["JFrog Applications Config"] = 421,
    ["JFrog File Spec"] = 422,
    ["JFrog Pipelines YML DSL"] = 984,
    ["JMeter DSL cli config"] = 423,
    JReleaser = 426,
    ["JSON Document Transform"] = 434,
    ["JSON Feed"] = 435,
    ["JSON Resume"] = 664,
    ["JSON Schema Draft 2020-12"] = 858,
    ["JSON Schema Draft 4"] = 855,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1017,
    ["JSON Schema Draft 7"] = 856,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1018,
    ["JSON Schema Draft 8 (2019-09)"] = 857,
    ["JSON-API"] = 433,
    ["JSON-e templates"] = 917,
    ["JSON-stat 2.0"] = 851,
    JSONPatch = 437,
    ["JSR Package Config (jsr.json)"] = 427,
    Jasmine = 414,
    Jekyll = 415,
    ["Jenkins X Pipelines"] = 416,
    ["Jenkins X Requirements"] = 417,
    Jest = 418,
    Jocker = 424,
    ["Jovo Language Models"] = 425,
    ["Jujutsu (jj) VCS config"] = 1132,
    ["KIMMDY config file"] = 448,
    ["KODE/CI build.yaml"] = 980,
    ["KSP-AVC"] = 852,
    ["KSP-CKAN"] = 853,
    ["KSP-NetKAN"] = 854,
    KSY = 1047,
    KSail = 333,
    ["Karakum configuration file"] = 330,
    Kas = 440,
    ["Kestra flow file"] = 449,
    ["Keycloak REST API"] = 987,
    ["Knative Functions - func.yaml"] = 331,
    Knip = 332,
    ["Kometa (nightly) config file"] = 451,
    ["Kometa config file"] = 450,
    ["Kong DBLess config"] = 981,
    KrakenD = 452,
    ["Kubri Configuration"] = 459,
    LOOBin = 474,
    ["Lake configuration file"] = 1135,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 227,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 228,
    ["Landing Zone Accelerator on AWS - Global Config"] = 229,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 230,
    ["Landing Zone Accelerator on AWS - Network Config"] = 231,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 232,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 233,
    ["Landing Zone Accelerator on AWS - Security Config"] = 234,
    ["Lando (landofile)"] = 77,
    ["LangGraph Platform configuration"] = 1058,
    ["Language configuration"] = 1057,
    Lefthook = 463,
    ["Liferay client-extension.yaml"] = 470,
    ["LinkML Metamodel"] = 472,
    Liquibase = 926,
    ["Liquibase Flow File"] = 927,
    ["Lively Properties"] = 473,
    ["Lobe AI Agent"] = 79,
    Loki = 80,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 514,
    ["MS2Rescore Configuration"] = 517,
    ["Madness (madness.yml)"] = 998,
    ["Mado configuration"] = 480,
    ["MapEHR Mapping"] = 481,
    Markdownlint = 930,
    ["Mason Registry"] = 933,
    ["MegaLinter Custom Flavor"] = 484,
    ["MegaLinter configuration"] = 483,
    ["MegaLinter descriptor"] = 485,
    Melange = 1025,
    ["Meltano project definition"] = 486,
    ["Mergify Configuration"] = 518,
    ["Metadata for a Bazel module"] = 487,
    ["Metadata for a Cinnamon spice"] = 1074,
    ["Metatype Configuration"] = 488,
    ["MetricsHub Configuration"] = 489,
    ["MetricsHub Connector Configuration"] = 490,
    ["Micro Editor Syntax"] = 1008,
    ["Microsoft Band Web Tile"] = 491,
    ["Microsoft RulesEngine workflow rules"] = 1062,
    ["Microsoft RulesEngine workflow rules list"] = 1063,
    ["Minecraft Custom Main Menu Mod"] = 1026,
    ["Minecraft Data Pack Advancement"] = 493,
    ["Minecraft Data Pack Biome"] = 494,
    ["Minecraft Data Pack Configured Carver"] = 495,
    ["Minecraft Data Pack Damage Type"] = 496,
    ["Minecraft Data Pack Dimension"] = 498,
    ["Minecraft Data Pack Dimension Type"] = 497,
    ["Minecraft Data Pack Item Modifier"] = 499,
    ["Minecraft Data Pack Loot Table"] = 500,
    ["Minecraft Data Pack Metadata"] = 501,
    ["Minecraft Data Pack Predicate"] = 502,
    ["Minecraft Data Pack Recipe"] = 503,
    ["Minecraft Data Pack Tag"] = 504,
    ["Minecraft Data Pack Template Pool"] = 505,
    ["Minecraft Data Pack Trim Material"] = 510,
    ["Minecraft Data Pack Trim Pattern"] = 511,
    ["Minecraft Resource Pack Lang"] = 506,
    ["Minecraft Resource Pack Particle"] = 507,
    ["Minecraft Resource Pack Texture Mcmeta"] = 509,
    ["Minecraft Resourcepack Sounds"] = 508,
    ["Monade CLI Stack Configuration"] = 521,
    ["MongoDB Atlas Search Index Definition"] = 979,
    ["Monika Configuration"] = 977,
    ["Monoweave Configuration"] = 516,
    ["Motif config"] = 872,
    MultiQC = 1112,
    ["NOX Framework (Service)"] = 535,
    ["Netin Diagnostic System Template"] = 937,
    ["Netlify config"] = 524,
    ["Network-as-Code Data Model"] = 525,
    ["Next Gen UI Agent Configuration"] = 526,
    ["Nightwatch.js"] = 528,
    ["Node.js configuration"] = 877,
    ["NueJS configuration file"] = 540,
    ["Nuitka.yaml"] = 1040,
    ["Nullstone config"] = 542,
    ["ONe's changelog entry"] = 557,
    ["ONe's service descriptor"] = 556,
    ["ORT Server repository environment configuration"] = 565,
    ["OSCAL Assessment Plan (AP)"] = 567,
    ["OSCAL Assessment Results (AR)"] = 568,
    ["OSCAL Catalog"] = 569,
    ["OSCAL Component Definition (CDef)"] = 570,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 571,
    ["OSCAL Profile"] = 572,
    ["OSCAL System Security Plan (SSP)"] = 573,
    ["OSS Review Toolkit configuration"] = 574,
    ["OSS Review Toolkit curation"] = 575,
    ["OSS Review Toolkit package configuration"] = 576,
    ["OSS Review Toolkit repository configuration"] = 577,
    ["OSS Review Toolkit resolutions"] = 578,
    ["October CMS columns"] = 546,
    ["October CMS fields"] = 547,
    Okteto = 548,
    ["Ona Automations"] = 550,
    Opctl = 875,
    ["Open Data Contract Standard (ODCS)"] = 560,
    ["Open Data Product Standard (ODPS)"] = 561,
    ["Open Know-How"] = 1117,
    ["OpenRewrite Resource"] = 559,
    OpenStatus = 1128,
    ["OpenUtau character yaml"] = 553,
    ["OpenUtau ustx"] = 554,
    ["OpenWeather Current Weather API"] = 916,
    ["OpenWeather Road Risk API"] = 915,
    ["Ory Hydra configuration"] = 398,
    ["Ory Keto configuration"] = 456,
    ["Ory Kratos configuration"] = 566,
    ["Ory Oathkeeper configuration"] = 544,
    ["Outblocks App configuration"] = 563,
    ["Outblocks database table"] = 564,
    ["Outblocks project configuration"] = 562,
    PDM = 585,
    Packer = 582,
    Pantsbuild = 994,
    ["Paper paper-plugin.yml"] = 583,
    ["Pipeline component"] = 928,
    ["Platform.sh application"] = 2,
    ["Platform.sh routes"] = 3,
    ["Platform.sh services"] = 4,
    ["Plex Prerolls"] = 593,
    ["PocketMine plugin.yml"] = 590,
    ["Postman collection"] = 597,
    ["Power Pages Configuration"] = 1129,
    ["Preset list for a WinUtil"] = 1077,
    ["ProActions AI-Kit Configuration"] = 606,
    ["ProActions AI-Kit Configuration for Menus"] = 608,
    ["ProActions AI-Kit Configuration for Sections"] = 610,
    ["ProActions AI-Kit Configuration for Services"] = 607,
    ["ProActions AI-Kit Configuration for Steps"] = 611,
    ["ProActions AI-Kit Configuration for Templates"] = 609,
    ["Problem object RFC9457"] = 1023,
    ["Problem package generators"] = 612,
    Pterodactyl = 974,
    ["Pull Request Labeler"] = 629,
    Pulumi = 637,
    ["PyGTA Config"] = 633,
    PyProject = 638,
    Pylock = 1120,
    Pyright = 639,
    ["Python script metadata"] = 1114,
    ["QType AI DSL"] = 642,
    Qgoda = 641,
    Qodana = 947,
    ["Qt Creator workspace file"] = 1055,
    ["Quali Torque Blueprint Spec 2"] = 972,
    ["QueryFirst config file"] = 990,
    ["RKE Cluster Configuration JSON"] = 925,
    ["RKE Cluster Configuration YAML"] = 924,
    RadioHound = 632,
    Railway = 643,
    ["Rancher Fleet"] = 634,
    ["Rattler-build"] = 644,
    Ray = 889,
    ["Read the Docs"] = 636,
    ["Red-DiscordBot Cog"] = 651,
    ["Red-DiscordBot Cog Repo"] = 652,
    ["Red-DiscordBot Trivia"] = 653,
    ["Render Blueprints"] = 923,
    RenderCV = 666,
    Renovate = 665,
    ["Replit config"] = 659,
    Restate = 1107,
    ["Revel Digital Gadget Definition File"] = 1131,
    RoadRunner = 668,
    ["Robust Station Image"] = 1137,
    Rockcraft = 669,
    ["Roo Coder Custom Modes"] = 670,
    Rubocop = 661,
    ["Rudder techniques"] = 1030,
    Ruff = 662,
    ["Rust Project"] = 663,
    ["Rust toolchain"] = 674,
    ["SDMX data message"] = 700,
    ["SDMX metadata message"] = 699,
    ["SDMX structure message"] = 698,
    ["SIL Kit Participant Configuration"] = 710,
    ["SIL Kit Registry Configuration"] = 711,
    ["SPDX 2.3"] = 748,
    SWADL = 764,
    ["Safebox Config"] = 985,
    ["Sapphire CLI Config"] = 677,
    ["SauceCTL Configuration"] = 934,
    ["Schema Catalog"] = 692,
    ["Scoop manifest"] = 697,
    ["Semantic Data Fabric (SDF) file"] = 701,
    ["Semgrep Rule"] = 703,
    ["Serenity Code Generator (Sergen)"] = 704,
    ["Serverless Framework Configuration"] = 941,
    ["Serverless Workflow"] = 943,
    ["Settings for a Cinnamon spice"] = 1073,
    ["Settings.paf"] = 706,
    ["Shopware 6 Configuration"] = 944,
    ["Shopware CLI Extension Store Configuration"] = 945,
    ["Shopware CLI Project Store Configuration"] = 946,
    ["Sigma Detection Rule"] = 708,
    ["Sigrid scope configuration file"] = 709,
    ["SkyPilot Task JSON"] = 1031,
    ["Slack app manifest"] = 713,
    Snapcraft = 715,
    Solidarity = 718,
    ["Solution filters"] = 719,
    ["Source Maps v3"] = 720,
    Sourcery = 721,
    ["Spack bootstrap.yaml"] = 722,
    ["Spack cdash.yaml"] = 723,
    ["Spack ci.yaml"] = 724,
    ["Spack compilers.yaml"] = 725,
    ["Spack concretizer.yaml"] = 726,
    ["Spack config.yaml"] = 727,
    ["Spack definitions.yaml"] = 728,
    ["Spack develop.yaml"] = 729,
    ["Spack env_vars.yaml"] = 730,
    ["Spack environment"] = 736,
    ["Spack include.yaml"] = 731,
    ["Spack mirrors.yaml"] = 732,
    ["Spack modules.yaml"] = 733,
    ["Spack packages.yaml"] = 734,
    ["Spack repos.yaml"] = 735,
    ["Spack toolchains.yaml"] = 737,
    ["Spack upstreams.yaml"] = 738,
    ["Spack view.yaml"] = 739,
    ["Speakeasy Generation Config File"] = 743,
    ["Speakeasy Lint Configuration File"] = 740,
    ["Speakeasy Test Generation Configuration File"] = 741,
    ["Speakeasy Workflow File"] = 742,
    SpecIF = 744,
    ["Specmatic Configuration"] = 745,
    ["Sponge Mixin configuration"] = 746,
    StackBlitz = 752,
    ["StackHawk Scanner Configuration"] = 940,
    Stale = 753,
    Starfish = 754,
    ["Starlake Data Pipeline"] = 913,
    Starship = 755,
    ["Statamic Blueprint"] = 756,
    ["Stella configuration file"] = 757,
    ["Streamlit configuration file"] = 758,
    ["Stryker Mutator"] = 761,
    ["StyleCop Analyzers Configuration"] = 762,
    ["Stylelint (.stylelintrc)"] = 763,
    ["Stylua Config"] = 1121,
    ["Sublime Syntax"] = 986,
    ["Subsquid squid manifest"] = 1033,
    ["Swagger API 2.0"] = 765,
    ["Synadia Connect Component"] = 766,
    TSON = 801,
    TSTyche = 802,
    ["TYPO3 Vendor Bundler config"] = 807,
    ["Tab data for a LinUtil"] = 1080,
    ["Tab list for a LinUtil"] = 1079,
    Tach = 767,
    ["Tach Domain"] = 768,
    Talhelper = 770,
    ["Talisman configuration"] = 771,
    Taplo = 1122,
    ["Taskfile config"] = 918,
    Taurus = 772,
    Tauticord = 773,
    Telefonistka = 1108,
    ["Terrateam config"] = 1134,
    ["TestEnvironment.json"] = 784,
    ["TextMate Grammar"] = 783,
    Threagile = 779,
    ["Tier.run pricing.json"] = 776,
    Tikibase = 777,
    Tombi = 782,
    ["Traefik v2"] = 787,
    ["Traefik v2 File Provider"] = 788,
    ["Traefik v3"] = 789,
    ["Traefik v3 File Provider"] = 790,
    ["Travis CI (.travis.yml)"] = 786,
    Treefmt = 376,
    Trident = 1104,
    ["TrueScript for *.tscript files"] = 793,
    ["Tugboat QA config.yml"] = 1101,
    TunnelHub = 1021,
    Turborepo = 785,
    Tycho = 1069,
    Tye = 948,
    ["Tyk Gateway - Open Source v5.7+"] = 1113,
    ["Typst Manifest"] = 808,
    ["UET BuildConfig.json"] = 991,
    ["UI5 Manifest"] = 814,
    ["UNCORS configuration"] = 818,
    ["UTAM Page Object"] = 817,
    ["Ubuntu Server Autoinstall"] = 812,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1105,
    ["Uniswap Token List"] = 901,
    ["Universal Schedule Format"] = 819,
    ["Unreal Engine Uplugin"] = 992,
    ["Unreal Engine Uproject"] = 993,
    ["UpCloud CLI (upctl) configuration"] = 1106,
    ["Updatecli Compose"] = 956,
    ["Updatecli Policy Manifest"] = 957,
    ["Updatecli Policy Metadata"] = 958,
    Uplift = 989,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 922,
    V2Ray = 962,
    ["VSCode Code Snippets"] = 210,
    ["VSIX CLI publishing"] = 839,
    Vector = 821,
    ["Vela Pipeline Configuration"] = 824,
    Vercel = 209,
    ["Version Bumper config"] = 829,
    ["Viash Component Config"] = 1110,
    ["Viash Package Config"] = 1111,
    Visivo = 1019,
    ["WP-CLI"] = 849,
    Wake = 1103,
    ["Waku Config"] = 1083,
    ["Web App Manifest"] = 845,
    ["Web types"] = 848,
    WebExtensions = 844,
    ["Webman package recipe"] = 968,
    ["Windows Package Manager Installer Manifest"] = 897,
    ["Windows Package Manager Locale Manifest"] = 898,
    ["Windows Package Manager Singleton Manifest"] = 896,
    Winutil = 899,
    ["WireMock stub mapping"] = 1086,
    ["Woodpecker pipeline config"] = 936,
    ["Wrangler CLI"] = 850,
    ["Xstate Machine"] = 954,
    ["Yandex Workflow Language"] = 1075,
    ["Yarn Config (.yarnrc.yml)"] = 911,
    ["Yippee-Ki-JSON configuration YML"] = 903,
    ["YouTrack App"] = 1072,
    ["Zarf Package Configuration"] = 1136,
    ["Zerops.io config"] = 1060,
    ["Zerops.io import"] = 1061,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 1024,
    ["app-definition.yaml"] = 26,
    ["apple-app-site-association"] = 24,
    ["appsettings.StormPetrel.json"] = 31,
    ["appsettings.json"] = 29,
    ["appsscript.json"] = 28,
    ["appveyor.yml"] = 30,
    ["aqua-generate-registry.yaml"] = 33,
    ["aqua-policy.yaml"] = 34,
    ["aqua.yaml"] = 32,
    ["arb.json"] = 36,
    ["arc.json"] = 38,
    ...
    ["asm-lsp"] = 42,
    ["ast-grep rules"] = 45,
    ["ast-grep sgconfig.yml"] = 44,
    ["babelrc.json"] = 89,
    ["bamboo-spec"] = 92,
    ["bashly-strings.yml"] = 1001,
    ["batect.yml"] = 91,
    ["beef-database-codegen"] = 93,
    ["beef-database-v5-codegen"] = 95,
    ["beef-entity-codegen"] = 94,
    ["beef-entity-v5-codegen"] = 96,
    ["behat.yml"] = 108,
    ["bigquery-table"] = 97,
    ["bioimageio resource description"] = 1041,
    ["bitbucket-pipelines"] = 99,
    bitrise = 100,
    ["bitrise-step"] = 101,
    ["block.json"] = 123,
    ["bottom configuration"] = 66,
    ["bower.json"] = 103,
    ["bozr.suite.json"] = 110,
    bpkg = 1002,
    ["browser.i18n.json"] = 111,
    ["browsh configuration"] = 112,
    bucklescript = 113,
    ["buf.gen.yaml"] = 68,
    ["buf.plugin.yaml"] = 69,
    ["buf.work.yaml"] = 70,
    ...
    ["build-changelog"] = 114,
    ["bun.lock"] = 119,
    ["bundleconfig.json"] = 120,
    ["bunfig.toml"] = 121,
    ["cargo-mutants-config.yaml"] = 71,
    ["ccmod.json"] = 1084,
    changelogging = 1052,
    ["chisel-slices.json"] = 236,
    ["chrome-extension-locales-messages.json"] = 217,
    ["chutzpah.json"] = 218,
    cibuildwheel = 143,
    ["clang-format (.clang-format)"] = 960,
    ["clang-tidy"] = 197,
    clangd = 196,
    clib = 198,
    ["cloud-init: cloud-config userdata"] = 200,
    ["cloud-sdk-pipeline-configuration"] = 220,
    ["cloudbuild.json"] = 221,
    cloudify = 199,
    codemagic = 201,
    ["coffeelint.json"] = 238,
    ["commands.json"] = 213,
    ["commitlint (.commitlintrc)"] = 900,
    ["committed.toml"] = 239,
    ["compile_commands.json"] = 212,
    ["compilerconfig.json"] = 211,
    ["completely.yml"] = 997,
    ["component-detection-manifest.json"] = 242,
    ["component.json"] = 241,
    ["composer.json"] = 240,
    ["conda-forge"] = 146,
    ["config.yaml"] = 635,
    ["contentmanifest.json"] = 219,
    ["contribute.json"] = 243,
    ["cosmos.config.json"] = 215,
    ["crowdin.yml"] = 244,
    ["ctfd-setup configuration file"] = 1093,
    ["custom-elements.json"] = 1011,
    ["cypress.json"] = 248,
    ["datalogic-scan2deploy-android"] = 258,
    ["datalogic-scan2deploy-ce"] = 259,
    ["dbt Dependencies"] = 162,
    ["dbt Packages"] = 164,
    ["dbt Project"] = 163,
    ["dbt Selectors"] = 165,
    ["dbt YAML files"] = 166,
    ["ddev-global"] = 260,
    ["ddev-project"] = 261,
    ["debugsettings.json"] = 262,
    ["dependabot-v2.json"] = 265,
    ["dependabot.json"] = 264,
    ["deployed-cli"] = 953,
    ["devcontainer.json"] = 203,
    devinit = 905,
    ["devspace.yaml"] = 976,
    djlint = 906,
    ["docker bake"] = 270,
    ["docker sequencer"] = 271,
    ["docker-compose.yml"] = 904,
    ["dockerd.json"] = 269,
    ["dotnet Release Index manifest"] = 282,
    ["dotnet-tools.json"] = 283,
    ["dotnetcli.host.json"] = 284,
    ["dprint.json"] = 285,
    ["drone.json"] = 286,
    ["dss-2.0.0.json"] = 288,
    ["dstack configuration"] = 289,
    ["dtool dataset metadata"] = 1088,
    ["dvc.yaml"] = 290,
    ["ecosystem.json"] = 295,
    eksctl = 296,
    ["electron-builder configuration file"] = 302,
    ["epr-manifest.json"] = 301,
    ["evcc.yaml"] = 303,
    ["ezd task runner"] = 313,
    ["fabric.mod.json"] = 315,
    ["first-timers-bot"] = 322,
    ["flagd flag configuration"] = 84,
    ["fly.io Configuration"] = 85,
    fulibWorkflows = 935,
    ["function.json"] = 334,
    ["gRPC API Gateway & OpenAPI Config"] = 7,
    ["gematik health care insurance list"] = 1099,
    ["gematik health care patient list"] = 1096,
    ["gematik health care provider institution list"] = 1098,
    ["gematik health care provider list"] = 1097,
    ["gematik tiger test environment configuration"] = 1100,
    ["gitlab-ci"] = 351,
    ["global.json"] = 367,
    ["go-feature-flag Flag Configuration"] = 370,
    ["haxelib.json"] = 387,
    helmfile = 892,
    helmwave = 893,
    ["host-meta.json"] = 395,
    ...
    ["ide.host.json"] = 403,
    ["ifstate.yaml"] = 404,
    ["imageoptimizer.json"] = 405,
    ["importmap.json"] = 408,
    ["ioBroker Configuration"] = 410,
    ["ioBroker JSON UI"] = 411,
    ["ioBroker Package manifest"] = 412,
    ["ixpect.conf.yaml"] = 413,
    ["ize.toml"] = 988,
    ["jsconfig.json"] = 438,
    ["jscpd Configuration"] = 973,
    jsdoc = 888,
    ["k3d.yaml"] = 439,
    ["k9s aliases.yaml"] = 441,
    ["k9s cluster-config.yaml"] = 443,
    ["k9s config.yaml"] = 442,
    ["k9s hotkeys.yaml"] = 444,
    ["k9s plugins.yaml"] = 445,
    ["k9s skin.yaml"] = 446,
    ["k9s views.yaml"] = 447,
    ["kontinuous-config.yaml"] = 458,
    ["kontinuous-values.yaml"] = 457,
    ["kustomization.yaml"] = 460,
    ["label-commenter-config.yml"] = 461,
    ["latexindent configuration"] = 78,
    ["launchsettings.json"] = 462,
    lazydocker = 1010,
    lazygit = 1009,
    ["lego.json"] = 464,
    ["lerna.json"] = 465,
    ["lgtm.yml"] = 466,
    ["liblab.config.json"] = 467,
    ["libman.json"] = 468,
    ["license-report-config.json"] = 469,
    ["linkinator.config.json"] = 471,
    ["lint-staged (.lintstagedrc)"] = 866,
    ["local.settings.json"] = 476,
    ["localazy.json"] = 477,
    ["lotus.yaml"] = 475,
    ["lsdlschema.json"] = 478,
    ["markdown-link-check"] = 931,
    maturin = 932,
    mboats = 939,
    ["micro-settings.json"] = 1003,
    ["mimetypes.json"] = 492,
    ["mirrord config"] = 868,
    mise = 869,
    ["mkdocs.yml"] = 512,
    ["monospace.yml"] = 515,
    ["moon.yml"] = 1085,
    ["mprocs Configuration file"] = 1056,
    ["mrdocs.yml"] = 513,
    ["mta.yaml"] = 870,
    ["mtad.yaml"] = 871,
    ["mycode.json"] = 522,
    nFPM = 527,
    ["napari plugin manifest"] = 523,
    neoload = 883,
    ["nest-cli"] = 530,
    ["ninjs (News in JSON)"] = 529,
    ["nitro.json"] = 882,
    ["nixd configuration"] = 1029,
    ["nlu.json"] = 531,
    ["nodemon.json"] = 533,
    ["noodl config"] = 938,
    ["notebook.mod.json"] = 534,
    now = 878,
    ["npm-badges"] = 537,
    ["nswag.json"] = 541,
    ntangle = 543,
    ["nuclei-template.yaml"] = 538,
    ["nuget-project.json"] = 539,
    ["ocelot.json"] = 545,
    ["omnisharp.json"] = 549,
    ["openapi.json"] = 551,
    ["openfin.json"] = 558,
    ...
    ["ops.yaml"] = 555,
    ["package.json"] = 579,
    ["package.manifest"] = 581,
    ["package.yaml"] = 580,
    ["partial-black.json"] = 109,
    ["pathfinder.yml"] = 584,
    ["pattern.json"] = 587,
    ["petstore-v1.0"] = 983,
    pgap_yaml_input_reader = 586,
    ["pixi.toml"] = 588,
    ["plagiarize-me.yaml"] = 592,
    ["plagiarize.yaml"] = 591,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1089,
    ["podbard.yaml"] = 594,
    ["portman.json"] = 595,
    ["prefect.toml"] = 603,
    ["prettierrc.json"] = 604,
    ["prisma.yml"] = 605,
    ["project-1.0.0-beta3.json"] = 614,
    ["project-1.0.0-beta4.json"] = 615,
    ["project-1.0.0-beta5.json"] = 616,
    ["project-1.0.0-beta6.json"] = 617,
    ["project-1.0.0-beta8.json"] = 618,
    ["project-1.0.0-rc1.json"] = 619,
    ["project-1.0.0-rc2.json"] = 620,
    ["project.json"] = 613,
    ["project.owasp.yaml"] = 621,
    ["prometheus-alertmanager.json"] = 625,
    ["prometheus.json"] = 622,
    ["prometheus.rules.json"] = 623,
    ["prometheus.rules.test.json"] = 624,
    ["proxies.json"] = 626,
    ["publiccode.yml"] = 627,
    ["pubspec.yaml"] = 628,
    ["pyrseas-0.8.json"] = 631,
    pytest = 640,
    ["quilt.mod.json"] = 1004,
    ["rc3 auth"] = 645,
    ["rc3 collection"] = 646,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 884,
    ["release-please-config.json"] = 655,
    ["release-please-manifest.json"] = 656,
    ["release-plz.toml"] = 657,
    ["renv.lock"] = 667,
    ["rivet.json"] = 1028,
    ["rivet.yaml (legacy)"] = 1027,
    rumdl = 672,
    runny = 671,
    rustfmt = 673,
    sake = 1116,
    samt = 675,
    samtrc = 676,
    ["sarif-1.0.0.json"] = 678,
    ["sarif-2.0.0.json"] = 679,
    ["sarif-2.1.0"] = 689,
    ["sarif-2.1.0-rtm.2"] = 680,
    ["sarif-2.1.0-rtm.3"] = 682,
    ["sarif-2.1.0-rtm.4"] = 684,
    ["sarif-2.1.0-rtm.5"] = 686,
    ["sarif-2.1.0-rtm.6"] = 687,
    ["sarif-external-property-file-2.1.0"] = 690,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 681,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 683,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 685,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 688,
    ["scalingo.json configuration"] = 691,
    ["schema.org - Action"] = 693,
    ["schema.org - ContactPoint"] = 694,
    ["schema.org - Place"] = 695,
    ["schema.org - Thing"] = 696,
    ["secrethub.yml"] = 1006,
    ["semantic-release"] = 702,
    ["servicehub.config.json"] = 861,
    ["servicehub.service.json"] = 860,
    ["settings.job"] = 705,
    ["sfdx-hardis configuration"] = 707,
    ["shard.yml"] = 1044,
    ["size-limit configuration"] = 712,
    ["skaffold.yaml"] = 929,
    ["skyuxconfig.json"] = 714,
    ["snowflake-config"] = 716,
    ["snowflake-connections"] = 717,
    ["spicepod.yaml"] = 1064,
    ["sqlc configuration"] = 749,
    ["stripe-app-local.json"] = 760,
    ["stripe-app.json"] = 759,
    swcrc = 914,
    ["task.json"] = 769,
    taskcat = 879,
    ["template.json"] = 774,
    ["templatsources.json"] = 775,
    ["theme.json"] = 778,
    ["tizen_workspace.json"] = 780,
    tldr = 781,
    ["tm_devices configuration file"] = 1127,
    tmuxinator = 864,
    ["transcend.yml"] = 791,
    ["tree-sitter grammar.json"] = 375,
    ["trime.yaml"] = 792,
    ["trunk.yaml"] = 794,
    ["ts-force-config.json"] = 799,
    ["tsconfig.json"] = 795,
    ["tsd.json"] = 796,
    ["tsdoc.json"] = 797,
    ["tsdrc.json"] = 798,
    ...
    v8r = 843,
    vcluster = 1050,
    ["vcpkg configuration file"] = 208,
    ["vcpkg manifest file"] = 207,
    ["vega-lite.json"] = 823,
    ["vega.json"] = 822,
    ["venvironment-basic.yaml"] = 826,
    ["venvironment.yaml"] = 825,
    ["venvplus-basic.yaml"] = 828,
    ["venvplus.yaml"] = 827,
    version = 1109,
    ["version.json"] = 830,
    ["vhwdebugger-binding.yaml"] = 832,
    ["vim-addon-info"] = 833,
    ["vs-2017.3.host.json"] = 835,
    ["vs-nesting.json"] = 836,
    ["vsls.json"] = 834,
    ["vss-extension.json"] = 840,
    vtcfg = 1115,
    ["vtesttree.yaml"] = 841,
    ["vtestunit.yaml"] = 842,
    ["warp-keysets.json"] = 1012,
    ["warp-themes.json"] = 1013,
    ["warp-workflows.json"] = 1014,
    ["webhint.io"] = 969,
    ["webjobpublishsettings.json"] = 847,
    ["webjobs-list.json"] = 846,
    ["well-known-fursona"] = 1051,
    ["xs-app.json"] = 874,
    ["xunit.runner.json"] = 859,
    yamllint = 902,
    zuul = 885,
    ["Žinoma"] = 895
  },
