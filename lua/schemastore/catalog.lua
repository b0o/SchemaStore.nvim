...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 167,
    [".cryproj (generic)"] = 581,
    [".cryproj engine-5.2"] = 576,
    [".cryproj engine-5.3"] = 577,
    [".cryproj engine-5.4"] = 578,
    [".cryproj engine-5.5"] = 579,
    [".cryproj engine-dev"] = 580,
    [".csscomb.json"] = 169,
    [".csslintrc"] = 170,
    [".es6importsorterrc.json"] = 708,
    [".eslintrc"] = 218,
    [".esmrc.json"] = 210,
    [".ffizer.yaml"] = 222,
    [".htmlhintrc"] = 270,
    ...
    ["<div>RIOTS' studio configuration"] = 560,
    ...
    ["Azure Pipelines"] = 54,
    ["Azure Static Web Apps CLI configuration file"] = 498,
    ["Azure Static Web Apps configuration file"] = 497,
    ["BX CI"] = 89,
    ["Better Code Hub"] = 626,
    ["Better Scripts"] = 90,
    BizTalkServerApplicationSchema = 596,
    ...
    ["Butane Config"] = 665,
    ["CICS TS region tagging"] = 672,
    ["CICS TS resource import"] = 673,
    ...
    ["Goreleaser Pro"] = 252,
    Goss = 253,
    ["Gradle Build Cache Node"] = 623,
    ["Gradle Enterprise"] = 622,
    ...
    Hadolint = 605,
    Hammerkit = 633,
    ["Hardware Sentry Configuration"] = 683,
    Hayson = 265,
    ...
    ["JSON Feed"] = 300,
    ["JSON Resume"] = 448,
    ["JSON Schema Draft 2020-12"] = 572,
    ["JSON Schema Draft 4"] = 569,
    ["JSON Schema Draft 7"] = 570,
    ["JSON Schema Draft 8"] = 571,
    ...
    ["OpenWeather Current Weather API"] = 630,
    ["OpenWeather Road Risk API"] = 629,
    ...
    Ray = 604,
    ["Read the Docs"] = 433,
    ["Red-DiscordBot Cog"] = 438,
    ["Red-DiscordBot Cog Repo"] = 439,
    ["Red-DiscordBot Trivia"] = 440,
    Renovate = 449,
    ["Replit schema"] = 443,
    RoadRunner = 450,
    Ruff = 446,
    ["Rust Project"] = 447,
    ["Rust toolchain"] = 452,
    ["SIL Kit Participant Configuration"] = 483,
    ["SIL Kit Registry Configuration"] = 484,
    SWADL = 507,
    ["Safebox Config Schema"] = 693,
    ["Sapphire CLI Config"] = 455,
    ["SauceCTL Configuration"] = 645,
    ["Schema Catalog"] = 469,
    ["Scoop manifest"] = 474,
    ["Semantic Data Fabric (SDF) file"] = 475,
    ["Semgrep Rule"] = 477,
    ["Serenity Code Generator (Sergen)"] = 478,
    ...
    ["Shopware CLI Project Store Configuration"] = 657,
    ["Sigrid scope configuration file"] = 482,
    ["Slack app manifest"] = 486,
    Solidarity = 489,
    ["Solution filters"] = 490,
    ["Source Maps v3"] = 491,
    Sourcery = 492,
    SpecIF = 493,
    ["Sponge Mixin configuration"] = 494,
    ["StackHawk Scanner Configuration"] = 651,
    Stale = 499,
    Starship = 500,
    ["Statamic Blueprint"] = 501,
    ["StrmPrivacy Data Connector"] = 697,
    ["StrmPrivacy Data Contract"] = 698,
    ["StrmPrivacy SimpleSchema"] = 695,
    ["StrmPrivacy Stream"] = 696,
    ["StrmPrivacy batch job configuration file"] = 694,
    ["Stryker Mutator"] = 504,
    ["StyleCop Analyzers Configuration"] = 505,
    ["Swagger API 2.0"] = 508,
    TSON = 532,
    ["Talisman configuration"] = 510,
    ["Taskfile YAML Schema"] = 632,
    Taurus = 511,
    ["TestEnvironment.json"] = 520,
    ["Tier.run pricing.json"] = 514,
    Tikibase = 515,
    ["Traefik v2"] = 523,
    ["Traefik v2 File Provider"] = 524,
    Turborepo = 521,
    Tye = 659,
    ["UET BuildConfig.json"] = 703,
    ["UI5 Manifest"] = 539,
    ["UTAM Page Object"] = 542,
    ["Ubuntu Server Autoinstall"] = 537,
    ["Uniswap Token List"] = 614,
    ["Unreal Engine Uplugin"] = 704,
    ...
    ["VSIX CLI publishing"] = 555,
    ["Vela Pipeline Configuration"] = 545,
    Vercel = 137,
    ["Web App Manifest"] = 562,
    ["Web types"] = 565,
    WebExtensions = 561,
    ["Webman package recipe"] = 676,
    ["Windows Package Manager Installer Manifest"] = 611,
    ["Windows Package Manager Locale Manifest"] = 612,
    ["Windows Package Manager Singleton Manifest"] = 610,
    ["Woodpecker pipeline config"] = 647,
    ["Xstate Machine Schema"] = 664,
    ["Yippee-Ki-JSON configuration YML"] = 616,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 65,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 712,
    ["bashly-strings.yml"] = 713,
    ["bashly.yml"] = 711,
    ["batect.yml"] = 64,
    ["beau.yml"] = 625,
    ...
    samt = 453,
    samtrc = 454,
    ["sarif-1.0.0.json"] = 456,
    ["sarif-2.0.0.json"] = 457,
    ["sarif-2.1.0"] = 467,
    ["sarif-2.1.0-rtm.2"] = 458,
    ["sarif-2.1.0-rtm.3"] = 460,
    ["sarif-2.1.0-rtm.4"] = 462,
    ["sarif-2.1.0-rtm.5"] = 464,
    ["sarif-2.1.0-rtm.6"] = 465,
    ["sarif-external-property-file-2.1.0"] = 468,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 459,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 461,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 463,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 466,
    ["schema.org - Action"] = 470,
    ["schema.org - ContactPoint"] = 471,
    ["schema.org - Place"] = 472,
    ["schema.org - Thing"] = 473,
    ["secrethub.yml"] = 718,
    ["semantic-release"] = 476,
    ["servicehub.config.json"] = 575,
    ["servicehub.service.json"] = 574,
    ["settings.job"] = 479,
    ["sfdx-hardis configuration"] = 481,
    ["size-limit configuration"] = 485,
    ["skaffold.yaml"] = 641,
    ["skyuxconfig.json"] = 487,
    snapcraft = 488,
    ["sqlc configuration"] = 496,
    ["stripe-app-local.json"] = 503,
    ["stripe-app.json"] = 502,
    swcrc = 628,
    syntax = 720,
    ["task.json"] = 509,
    taskcat = 595,
    ["template.json"] = 512,
    ["templatsources.json"] = 513,
    ["theme.json"] = 516,
    ["tizen_workspace.json"] = 517,
    tldr = 518,
    tmLanguage = 519,
    tmuxinator = 583,
    ["transcend.yml"] = 525,
    ["trunk.yaml schema"] = 526,
    ["ts-force-config.json"] = 530,
    ["tsconfig.json"] = 527,
    ["tsd.json"] = 528,
    ["tsdrc.json"] = 529,
    ["tslint.json"] = 531,
    ...
    ["vega-lite.json"] = 544,
    ["vega.json"] = 543,
    ["venvironment-basic.yaml"] = 547,
    ["venvironment.yaml"] = 546,
    ["version.json"] = 548,
    ["vim-addon-info"] = 549,
    ["vs-2017.3.host.json"] = 551,
    ["vs-nesting.json"] = 552,
    ["vsls.json"] = 550,
    ["vss-extension.json"] = 556,
    ["vtesttree.yaml"] = 557,
    ["vtestunit.yaml"] = 558,
    ["webhint.io"] = 677,
    ["webjobpublishsettings.json"] = 564,
    ["webjobs-list.json"] = 563,
    ["xs-app.json"] = 591,
    ["xunit.runner.json"] = 573,
    yamllint = 615,
    zuul = 600,
    ["Žinoma"] = 609
  },
