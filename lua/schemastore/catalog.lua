...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 997,
    [".nodehawkrc"] = 629,
    [".npmpackagejsonlintrc"] = 633,
    [".omletrc"] = 1178,
    [".phrase.yml"] = 711,
    [".phraseapp.yml"] = 712,
    [".pmbot.yml"] = 696,
    [".postcssrc"] = 705,
    [".powerpages-web-template-manifest"] = 707,
    [".pre-commit-config.yml"] = 708,
    [".pre-commit-hooks.yml"] = 709,
    [".putout.json"] = 745,
    [".rehyperc"] = 770,
    [".remarkrc"] = 774,
    [".sprite files"] = 870,
    ...
    AIConfig = 37,
    ["AMX Muse Program Descriptor"] = 1227,
    ["API Builder"] = 1033,
    ["AVA Configuration"] = 1097,
    ["AWS AppConfig Feature Flags-v1"] = 71,
    ["AWS CDK cdk.json"] = 275,
    ["AWS CloudFormation"] = 276,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 277,
    ["AWS Copilot Manifest"] = 1266,
    ["AWS SAM CLI Samconfig"] = 278,
    Acton = 1317,
    ["Adobe UXP Manifest"] = 1160,
    ["Aerleon Network & Service Definitions"] = 23,
    ["Aerleon Policy"] = 24,
    ["Agent Permission Policy"] = 1306,
    ["AgentCore CLI"] = 1307,
    AgentLoopKit = 1308,
    Aider = 1256,
    Air = 26,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1277,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1276,
    ["Airlock Microgateway"] = 38,
    ["Alacritty Configuration"] = 1069,
    ["AlgoVoi Compliance Receipt v1"] = 13,
    ["All Contributors configuration file"] = 1123,
    Anodizer = 454,
    ["Ansible Argument Specs"] = 438,
    ["Ansible Collection Galaxy"] = 445,
    ["Ansible Execution Environment"] = 435,
    ["Ansible Inventory"] = 444,
    ["Ansible Meta"] = 436,
    ["Ansible Meta Runtime"] = 437,
    ["Ansible Navigator Configuration"] = 447,
    ["Ansible Playbook"] = 442,
    ["Ansible Requirements"] = 439,
    ["Ansible Rulebook"] = 443,
    ["Ansible Tasks File"] = 441,
    ["Ansible Vars File"] = 440,
    ["Ansible-lint Configuration"] = 446,
    Any = 1188,
    ...
    ["Application list for a WinUtil"] = 1206,
    ArchitectFX = 1211,
    ["Argo CD"] = 57,
    ["Argo Events"] = 58,
    ["Argo Workflows"] = 59,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1275,
    ["Azure IoT Operations connector metadata"] = 1272,
    ...
    ["Azure Pipelines"] = 117,
    ["Azure Static Web Apps CLI configuration file"] = 874,
    ["Azure Static Web Apps configuration file"] = 873,
    BMML = 1294,
    ["BOSH CPI Config"] = 143,
    ["BOSH Deploy Config"] = 144,
    ["BX CI"] = 165,
    ["Bacon config"] = 7,
    ["Barba-CV"] = 86,
    ["Bashly (bashly.yml)"] = 1127,
    ["Bashly Settings (bashly-settings.yml)"] = 1128,
    Bento = 1293,
    ["Better Code Hub"] = 1038,
    ["Better Scripts"] = 166,
    Bigconfig = 136,
    ["Biome Formatter Config"] = 87,
    ["Bitmovin Encoding Template"] = 1220,
    BizTalkServerApplicationSchema = 1004,
    Bleep = 167,
    ["Block Protocol Metadata"] = 164,
    ["Bluebricks blueprint config"] = 1299,
    ["Boyka Framework"] = 145,
    ["Bpod Finite-State Machine"] = 89,
    Briefcase = 1010,
    ["Build Info"] = 155,
    Buildkite = 157,
    ["Bukkit plugin.yml"] = 156,
    ["BungeeCord plugin.yml"] = 162,
    ["Butane Config"] = 1082,
    C4InterFlow = 1235,
    ["CDK Environment Manager, concrete environment configuration"] = 1259,
    ["CDK Environment Manager, concrete environments definition"] = 1258,
    ["CDK Environment Manager, environment definition"] = 1257,
    ["CGS Card Game Specification (cgs.json)"] = 1165,
    ["CICS TS region tagging"] = 1091,
    ["CICS TS resource import"] = 1092,
    ["CICS TS resource model"] = 1093,
    ["CICS TS resource overrides"] = 1094,
    ["CMake Presets"] = 168,
    ["CNC Codes"] = 190,
    ["CRS WAF test file"] = 1195,
    ["CRS WAF test platform overrides file"] = 1196,
    ["CSS Comb (.csscomb.json)"] = 303,
    ["CSS Lint (.csslintrc)"] = 304,
    ["CSpell (cspell.json)"] = 302,
    ["CVE Record Format"] = 202,
    CWL = 1171,
    ["Cache Warmup config"] = 169,
    ["Caido Proxy Configuration"] = 1331,
    ["Calqulus pipeline"] = 170,
    ["Camel YAML DSL"] = 171,
    ["Cannon TOML"] = 172,
    Carafe = 173,
    ["Cargo Make"] = 175,
    ["Cargo Manifest"] = 174,
    ["Catalog Info Backstage"] = 176,
    ["Chamaleon environment"] = 1224,
    ["Chamaleon properties"] = 1225,
    ["Chamaleon template"] = 1223,
    Changepacks = 1286,
    Changesets = 287,
    Changie = 177,
    Charmcraft = 178,
    Cheatsheets = 1079,
    ["ChordPro Configuration"] = 179,
    ["Chrome Extension"] = 268,
    ["Chromia Model"] = 180,
    ["Chromia Seeder Module Config"] = 182,
    ["Chromia Seeder Root Config"] = 181,
    ["Cinnamon Spice info.json"] = 97,
    ["CircleCI config.yml"] = 240,
    ["Citation File Format"] = 289,
    ["Citrus test case"] = 184,
    CityJSON = 185,
    ["Claude Code Keybindings"] = 197,
    ["Claude Code Plugin Manifest"] = 198,
    ["Claude Code Plugin Marketplace"] = 199,
    ["Claude Code Settings"] = 200,
    ["Clawject config"] = 196,
    ["Cloud Foundry Application Manifest"] = 1177,
    ["Cloud Run Spec v1"] = 1201,
    ...
    ["CloudEvents specification"] = 186,
    ["Code Climate"] = 241,
    CodeCV = 101,
    CodeRabbit = 100,
    ["CodeShip Pro services configuration files"] = 257,
    ["CodeShip Pro steps configuration files"] = 258,
    ["Codecov configuration files"] = 256,
    Codex = 249,
    ["Codex Hooks"] = 250,
    ["Codex Skill Metadata"] = 251,
    CodifyCLI = 102,
    Codux = 253,
    ["Cog config file"] = 191,
    ["Commandbox Box.json"] = 192,
    ["Commandbox Server.json"] = 193,
    ["Common Catalog Data"] = 266,
    ["Common Package Specification"] = 194,
    Concord = 1194,
    ["Configu .cfgu files"] = 1182,
    ["Configu .configu file"] = 1183,
    Conjure = 189,
    ["Container Structure Test"] = 1018,
    Containerlab = 1047,
    ["Contextive Glossary"] = 1251,
    ContractGuard = 1048,
    Convex = 188,
    ["Crowdsec collection config"] = 297,
    ["Crowdsec parser config"] = 298,
    ["Crowdsec scenario config"] = 299,
    ["CumulusCI Config"] = 195,
    ["Cursor Agent Environment"] = 1304,
    ["Custom Machinery Machine"] = 1166,
    ["Custom Machinery Recipe"] = 1167,
    ["Cycle Stack File"] = 203,
    CycloneDX = 204,
    ["DWP Exchange - catalogue entry"] = 348,
    ["DWP Exchange - gateway"] = 346,
    ["DWP Exchange - meta"] = 347,
    ["Dart Build Config (dart-build.json)"] = 305,
    ["Dart Test Config (dart-test.json)"] = 306,
    ["DashLord Configuration"] = 307,
    ["Data Contract Specification"] = 308,
    ["Data Product Specification"] = 309,
    ["DataYoga Connections"] = 205,
    ["DataYoga Job"] = 206,
    ["Datadog Continuous Testing"] = 540,
    ["Datadog Service Definition"] = 541,
    ["Datadog Software Catalog"] = 542,
    ["Datahub Ingestion Recipe"] = 1098,
    ["Debian Upstream Metadata file"] = 213,
    ["Deck config"] = 214,
    ["Declarative Automation Bundles"] = 1144,
    ["DeepMatch deeplinks spec"] = 215,
    ["Dein Config"] = 216,
    ["Deno Config (deno.json)"] = 315,
    ["Dependency cruiser"] = 217,
    ["DeployStack Configuration"] = 218,
    ["Deployah Configuration"] = 1274,
    ["Deployer Recipe"] = 318,
    ["Deta Spacefile"] = 219,
    ["Detekt Config (detekt.yml)"] = 319,
    ["Devbox Config"] = 220,
    ["Devbox Plugin"] = 221,
    Devfile = 345,
    Devup = 1287,
    DipDup = 1197,
    ["Discord Webhook"] = 320,
    ["DocFx Config (docfx.json)"] = 325,
    ["Docker Desktop extension metadata"] = 322,
    ["Docs MCP Manifest"] = 326,
    Dofigen = 327,
    ["Dolittle Artifacts"] = 328,
    ["Dolittle Bounded Context Configuration"] = 329,
    ["Dolittle Event Horizons Configuration"] = 330,
    ["Dolittle Resources Configuration"] = 331,
    ["Dolittle Server Configuration"] = 332,
    ["Dolittle Tenant Map Configuration"] = 334,
    ["Dolittle Tenants Configuration"] = 333,
    ["Dolittle Topology"] = 335,
    ["DonateCaseBetterCasino menu"] = 1228,
    ["Drupal Breakpoints"] = 222,
    ["Drupal Config"] = 234,
    ["Drupal Info"] = 223,
    ["Drupal Layouts"] = 224,
    ["Drupal Libraries"] = 225,
    ["Drupal Links Action"] = 226,
    ["Drupal Links Contextual"] = 227,
    ["Drupal Links Menu"] = 228,
    ["Drupal Links Task"] = 229,
    ["Drupal Migration"] = 230,
    ["Drupal Permissions"] = 231,
    ["Drupal Recipe"] = 232,
    ["Drupal Routing"] = 233,
    ["Drupal Services"] = 235,
    ["Drush site aliases"] = 341,
    ["Dynamic Bash Aliases (.aliases)"] = 1135,
    ["EAS config"] = 386,
    ["ECA - Editor Code Assistant"] = 350,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1124,
    ["ESLint Suppressions"] = 391,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1271,
    ["EasyVCR .NET"] = 388,
    ["Eidolon Resource"] = 1212,
    ["Elgato Stream Deck"] = 352,
    Elm = 1199,
    ["Embrace Config"] = 1110,
    Emmet = 1200,
    Endurica = 1148,
    ["Enonic XP API descriptor"] = 355,
    ["Enonic XP Admin Extension descriptor"] = 356,
    ["Enonic XP Admin Tool descriptor"] = 357,
    ["Enonic XP Application descriptor"] = 358,
    ["Enonic XP CMS descriptor"] = 359,
    ["Enonic XP Content Type descriptor"] = 360,
    ["Enonic XP Form Fragment descriptor"] = 361,
    ["Enonic XP ID Provider descriptor"] = 362,
    ["Enonic XP Layout descriptor"] = 363,
    ["Enonic XP Macro descriptor"] = 364,
    ["Enonic XP Mixin descriptor"] = 365,
    ["Enonic XP Page descriptor"] = 366,
    ["Enonic XP Part descriptor"] = 367,
    ["Enonic XP Service descriptor"] = 368,
    ["Enonic XP Site descriptor"] = 369,
    ["Enonic XP Style descriptor"] = 370,
    ["Enonic XP Task descriptor"] = 371,
    ["Enonic XP Webapp descriptor"] = 372,
    ["Enterprise Contract Policy Spec"] = 353,
    ["Envelope Team Definition"] = 1316,
    ["Envilder Map File"] = 354,
    ["Erda Pipeline"] = 1173,
    ["Erda Runtime"] = 1174,
    ["Espanso config.yml"] = 1297,
    ["Espanso match.yml"] = 1296,
    Esquio = 374,
    ["Estuary Flow Catalog"] = 1088,
    ["Ethereum ERC1155"] = 1310,
    ["Ethereum ERC721"] = 1309,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 379,
    ["EveryVoice TTS Toolkit Data Configuration"] = 380,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 384,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 383,
    ["EveryVoice TTS Toolkit Text Configuration"] = 381,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 382,
    ["Evolving Resolutive Process notation"] = 1273,
    ["Expo SDK"] = 385,
    ["Expoot app config"] = 387,
    ["F-Droid Data metadata"] = 393,
    ["FasterCI Configuration"] = 118,
    ["Fence configuration"] = 119,
    FiQuS = 397,
    Firebase = 395,
    ["Flatpak Builder Manifest"] = 398,
    ["FlexGet Config"] = 399,
    ["Flow.json Configurations"] = 1170,
    ["Fossa configuration file"] = 406,
    ["Fossa's fossa-deps file"] = 407,
    ["Foundry VTT - Base package Manifest"] = 401,
    ["Foundry VTT - Module Manifest"] = 402,
    ["Foundry VTT - System Data Template"] = 405,
    ["Foundry VTT - System Manifest"] = 403,
    ["Foundry VTT - World Manifest"] = 404,
    ["Foxx Manifest"] = 120,
    ["Freifunk.de Community API"] = 123,
    ["Frogbot Config"] = 124,
    ["G2P Mapping Configuration"] = 413,
    ["GCP Blueprint Metadata"] = 416,
    Gaspar = 414,
    ["GatewayCore API Gateway"] = 415,
    ["Gemini CLI settings"] = 417,
    ["GeoJSON.json latest"] = 1086,
    GherKing = 1090,
    ["GitHub Action"] = 423,
    ["GitHub Actions typing"] = 1208,
    ["GitHub Discussion"] = 424,
    ["GitHub Funding"] = 425,
    ["GitHub Issue Template configuration"] = 426,
    ["GitHub Issue Template forms"] = 427,
    ["GitHub Pages Jekyll"] = 428,
    ["GitHub Workflow"] = 429,
    ["GitHub Workflow Template Properties"] = 430,
    ["GitHub automatically generated release notes configuration"] = 431,
    ["GitLab Agent for Kubernetes configuration"] = 1162,
    GitVersion = 420,
    ["Gitea Issue Template configuration"] = 421,
    ["Gitea Issue Template forms"] = 422,
    ["Gitpod Automations"] = 433,
    ["Gitpod Configuration"] = 434,
    ["Glamour style"] = 418,
    ["GlazeWM settings"] = 1164,
    ["Global Privacy Control"] = 419,
    Goblet = 1143,
    ["Golangci-lint Configuration"] = 449,
    ["Golangci-lint Custom Plugins Configuration"] = 450,
    ["Google Chrome Related Website Sets"] = 396,
    ["Google Cloud Workflows"] = 274,
    ["Google Digital Assetlinks"] = 1252,
    Goreleaser = 452,
    ["Goreleaser Pro"] = 453,
    Goss = 455,
    ["Gradle Build Cache Node"] = 1036,
    ["Gradle Enterprise"] = 1035,
    ["Grafana 5.x Dashboard"] = 456,
    ["GraphQL Code Generator"] = 461,
    ["GraphQL Config"] = 460,
    ["GraphQL Mesh"] = 459,
    ["GroovyLint configuration"] = 462,
    ["Grunt JSHint task"] = 466,
    ["Grunt Watch task"] = 467,
    ["Grunt base task"] = 468,
    ["Grunt clean task"] = 464,
    ["Grunt copy task"] = 463,
    ["Grunt cssmin task"] = 465,
    HEMTT = 1000,
    Hadolint = 1014,
    Hammerkit = 1046,
    ["Hardware Sentry Configuration"] = 1102,
    ["Hashgraph Online Skill Manifest"] = 3,
    ["HashiCorp Vault"] = 469,
    Hatch = 1015,
    Hayson = 471,
    ["Haystack Pipeline"] = 472,
    ["Hazelcast 5 Configuration"] = 473,
    ["Hecate Input Schema"] = 1263,
    ["Helm Chart.lock"] = 237,
    ["Helm Chart.yaml"] = 236,
    ["Helm Unittest Test Suite"] = 238,
    ["Hex file"] = 239,
    ["Home Assistant Integration Manifest"] = 474,
    ["Homer dashboard configuration"] = 475,
    Hugo = 1078,
    ["Hugo Theme"] = 1077,
    ["Hulak Configuration"] = 482,
    ["Hyperfoil benchmark configuration"] = 481,
    ["IBM Zapp document"] = 483,
    ["IBM zCodeFormatSettings"] = 484,
    ["IMG Catapult PSP"] = 489,
    ["IVMS101 by CODE Protocol"] = 1163,
    ["Infinispan Configuration"] = 491,
    ["Infinispan Server Configuration"] = 492,
    Infrahub = 493,
    Istanbul = 1106,
    ["JDownloader2 crawler multi-rules"] = 507,
    ["JDownloader2 crawler single-rules"] = 506,
    ["JFrog Applications Config"] = 508,
    ["JFrog File Spec"] = 509,
    ["JFrog Pipelines YML DSL"] = 1112,
    ["JMeter DSL cli config"] = 510,
    JReleaser = 513,
    ["JSON Document Transform"] = 521,
    ["JSON Feed"] = 522,
    ["JSON Resume"] = 782,
    ["JSON Schema Draft 2020-12"] = 982,
    ["JSON Schema Draft 4"] = 979,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1145,
    ["JSON Schema Draft 7"] = 980,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1146,
    ["JSON Schema Draft 8 (2019-09)"] = 981,
    ["JSON-API"] = 520,
    ["JSON-e templates"] = 1043,
    ["JSON-stat 2.0"] = 975,
    JSONPatch = 524,
    ["JSR Package Config (jsr.json)"] = 514,
    Jarl = 1279,
    Jasmine = 501,
    Jekyll = 502,
    ["Jenkins X Pipelines"] = 503,
    ["Jenkins X Requirements"] = 504,
    Jest = 505,
    Jocker = 511,
    ["Jovo Language Models"] = 512,
    ["Jujutsu (jj) VCS config"] = 1265,
    ["KIMMDY config file"] = 535,
    ["KODE/CI build.yaml"] = 1108,
    ["KSP-AVC"] = 976,
    ["KSP-CKAN"] = 977,
    ["KSP-NetKAN"] = 978,
    KSY = 1175,
    KSail = 411,
    ["KYA Manifest"] = 1176,
    ["Karakum configuration file"] = 408,
    Kas = 527,
    ["Kestra flow file"] = 536,
    ["Keycloak REST API"] = 1115,
    ["Knative Functions - func.yaml"] = 409,
    Knip = 410,
    ["Knowledge Unit"] = 544,
    ["Kometa (nightly) config file"] = 538,
    ["Kometa config file"] = 537,
    ["Kong DBLess config"] = 1109,
    KrakenD = 539,
    ["Kubri Configuration"] = 547,
    LOOBin = 562,
    ["Lake configuration file"] = 1268,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 279,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 280,
    ["Landing Zone Accelerator on AWS - Global Config"] = 281,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 282,
    ["Landing Zone Accelerator on AWS - Network Config"] = 283,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 284,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 285,
    ["Landing Zone Accelerator on AWS - Security Config"] = 286,
    ["Lando (landofile)"] = 113,
    ["LangGraph Platform configuration"] = 1187,
    ["Language configuration"] = 1186,
    Lefthook = 551,
    ["Liferay client-extension.yaml"] = 558,
    ["LinkML Metamodel"] = 560,
    Liquibase = 1053,
    ["Liquibase Flow File"] = 1054,
    ["Lively Properties"] = 561,
    ["Lobe AI Agent"] = 115,
    Loki = 116,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 604,
    ["MS2Rescore Configuration"] = 610,
    ["Madness (madness.yml)"] = 1126,
    ["Mado configuration"] = 568,
    ["Maestro Flow"] = 569,
    ["Mail Servers Configuration"] = 1300,
    ["MapEHR Mapping"] = 570,
    Markdownlint = 1057,
    ["Mason Registry"] = 1060,
    ["MegaLinter Custom Flavor"] = 573,
    ["MegaLinter configuration"] = 572,
    ["MegaLinter descriptor"] = 574,
    Melange = 1153,
    ["Meltano project definition"] = 575,
    ["Mergify Configuration"] = 611,
    ["Metadata for a Bazel module"] = 576,
    ["Metadata for a Cinnamon spice"] = 1204,
    ["Metatype Configuration"] = 577,
    ["MetricsHub Configuration"] = 578,
    ["MetricsHub Connector Configuration"] = 579,
    ["Micro Editor Syntax"] = 1136,
    ["Microsoft Band Web Tile"] = 580,
    ["Microsoft RulesEngine workflow rules"] = 1191,
    ["Microsoft RulesEngine workflow rules list"] = 1192,
    ["Minecraft Custom Main Menu Mod"] = 1154,
    ["Minecraft Data Pack Advancement"] = 582,
    ["Minecraft Data Pack Biome"] = 583,
    ["Minecraft Data Pack Configured Carver"] = 584,
    ["Minecraft Data Pack Damage Type"] = 585,
    ["Minecraft Data Pack Dimension"] = 587,
    ["Minecraft Data Pack Dimension Type"] = 586,
    ["Minecraft Data Pack Item Modifier"] = 588,
    ["Minecraft Data Pack Loot Table"] = 589,
    ["Minecraft Data Pack Metadata"] = 590,
    ["Minecraft Data Pack Predicate"] = 591,
    ["Minecraft Data Pack Recipe"] = 592,
    ["Minecraft Data Pack Tag"] = 593,
    ["Minecraft Data Pack Template Pool"] = 594,
    ["Minecraft Data Pack Trim Material"] = 599,
    ["Minecraft Data Pack Trim Pattern"] = 600,
    ["Minecraft Resource Pack Lang"] = 595,
    ["Minecraft Resource Pack Particle"] = 596,
    ["Minecraft Resource Pack Texture Mcmeta"] = 598,
    ["Minecraft Resourcepack Sounds"] = 597,
    ["MockServer Expectations"] = 606,
    ModuleAssembler = 602,
    ["Monade CLI Stack Configuration"] = 614,
    ["MongoDB Atlas Search Index Definition"] = 1107,
    ["Monika Configuration"] = 1105,
    ["Monoweave Configuration"] = 609,
    ["Motif config"] = 996,
    MultiQC = 1245,
    ["NOX Framework (Service)"] = 632,
    ["Netin Diagnostic System Template"] = 1064,
    ["Netlify config"] = 617,
    ["Network-as-Code Data Model"] = 618,
    ["Next Gen UI Agent A2A Server Configuration"] = 619,
    ["Next Gen UI Agent Configuration"] = 621,
    ["Next Gen UI Agent MCP Server Configuration"] = 620,
    ["Nightwatch.js"] = 625,
    ["Node.js configuration"] = 1001,
    ["NueJS configuration file"] = 637,
    ["Nuitka Package Config"] = 1168,
    ["Nullstone config"] = 639,
    ["ONe's changelog entry"] = 658,
    ["ONe's service descriptor"] = 657,
    ["ORT Server repository environment configuration"] = 668,
    ["OSCAL Assessment Plan (AP)"] = 670,
    ["OSCAL Assessment Results (AR)"] = 671,
    ["OSCAL Catalog"] = 672,
    ["OSCAL Component Definition (CDef)"] = 673,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 674,
    ["OSCAL Profile"] = 675,
    ["OSCAL System Security Plan (SSP)"] = 676,
    ["OSS Review Toolkit configuration"] = 677,
    ["OSS Review Toolkit curation"] = 678,
    ["OSS Review Toolkit package configuration"] = 679,
    ["OSS Review Toolkit project package manager definition"] = 680,
    ["OSS Review Toolkit repository configuration"] = 681,
    ["OSS Review Toolkit resolutions"] = 682,
    ["October CMS columns"] = 643,
    ["October CMS fields"] = 644,
    ["Oh My Posh"] = 646,
    Okteto = 647,
    ["Ona Automations"] = 649,
    Opctl = 999,
    ["Open Data Contract Standard (ODCS)"] = 662,
    ["Open Data Product Standard (ODPS)"] = 663,
    ["Open Know-How"] = 1250,
    OpenDecree = 1314,
    ["OpenDecree Configuration"] = 1315,
    ["OpenRewrite Resource"] = 660,
    OpenSRM = 664,
    OpenStatus = 1261,
    ["OpenTelemetry Declarative Configuration"] = 661,
    ["OpenUtau character yaml"] = 654,
    ["OpenUtau ustx"] = 655,
    ["OpenWeather Current Weather API"] = 1042,
    ["OpenWeather Road Risk API"] = 1041,
    ["Ory Hydra configuration"] = 480,
    ["Ory Keto configuration"] = 543,
    ["Ory Kratos configuration"] = 669,
    ["Ory Oathkeeper configuration"] = 641,
    ["Outblocks App configuration"] = 666,
    ["Outblocks database table"] = 667,
    ["Outblocks project configuration"] = 665,
    PDM = 690,
    POPxf = 702,
    ["POPxf Correlations"] = 703,
    ["PRML manifest"] = 710,
    Packer = 686,
    PactSpec = 687,
    Panache = 688,
    Pantsbuild = 1122,
    ["Paper paper-plugin.yml"] = 689,
    ["Pipeline component"] = 1055,
    ["Platform.sh application"] = 9,
    ["Platform.sh routes"] = 10,
    ["Platform.sh services"] = 11,
    ["Plex Prerolls"] = 700,
    ["PocketMine plugin.yml"] = 697,
    ["Podman Desktop Extension"] = 1333,
    ["Postman collection"] = 706,
    ["Power Pages Configuration"] = 1262,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1207,
    ["ProActions AI-Kit Configuration"] = 718,
    ["ProActions AI-Kit Configuration for Menus"] = 720,
    ["ProActions AI-Kit Configuration for Sections"] = 722,
    ["ProActions AI-Kit Configuration for Services"] = 719,
    ["ProActions AI-Kit Configuration for Steps"] = 723,
    ["ProActions AI-Kit Configuration for Templates"] = 721,
    ["Problem object RFC9457"] = 1151,
    ["Problem package format"] = 724,
    ["Problem package generators"] = 725,
    ["Problem package submissions"] = 726,
    ["Problem package test group metadata"] = 727,
    Pterodactyl = 1101,
    ["Pull Request Labeler"] = 744,
    Pulumi = 752,
    ["PyGTA Config"] = 748,
    PyProject = 753,
    Pylock = 1253,
    Pyright = 754,
    ["Python script metadata"] = 1247,
    ["QType AI DSL"] = 757,
    Qgoda = 756,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1325,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1323,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1329,
    ["Qlik Talend Cloud Pipeline - Project"] = 1321,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1324,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1326,
    ["Qlik Talend Cloud Pipeline - Task"] = 1322,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1328,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1327,
    Qodana = 1074,
    ["Qt Creator workspace file"] = 1184,
    ["Quali Torque Blueprint Spec 2"] = 1099,
    ["QueryFirst config file"] = 1118,
    ["QuikRun Configuration"] = 1330,
    ["Qwen Code Settings"] = 1311,
    ["RKE Cluster Configuration JSON"] = 1052,
    ["RKE Cluster Configuration YAML"] = 1051,
    RadioHound = 747,
    ["Raid Profile"] = 1312,
    ["Raid Repo Configuration"] = 1313,
    Railpack = 759,
    Railway = 758,
    ["Rancher Fleet"] = 749,
    ["Rattler-build"] = 760,
    Ray = 1013,
    ["Read the Docs"] = 751,
    ["Red-DiscordBot Cog"] = 767,
    ["Red-DiscordBot Cog Repo"] = 768,
    ["Red-DiscordBot Trivia"] = 769,
    ["Releasaurus Config"] = 6,
    ReleaseKit = 5,
    ["Render Blueprints"] = 1050,
    RenderCV = 786,
    Renovate = 783,
    ["Renovate global configuration"] = 784,
    ["Renovate inherited configuration"] = 785,
    ["Replit config"] = 775,
    Restate = 1240,
    ["Revel Digital Gadget Definition File"] = 1264,
    RoadRunner = 788,
    ["Robust Station Image"] = 1270,
    Rockcraft = 789,
    ["Roo Coder Custom Modes"] = 790,
    Rubocop = 779,
    ["Rudder techniques"] = 1158,
    Ruff = 780,
    ["Rust Project"] = 781,
    ["Rust toolchain"] = 795,
    ["SDMX data message"] = 822,
    ["SDMX metadata message"] = 821,
    ["SDMX structure message"] = 820,
    ["SIL Kit Participant Configuration"] = 832,
    ["SIL Kit Registry Configuration"] = 833,
    ["SPDX 2.3"] = 871,
    SWADL = 887,
    ["Safebox Config"] = 1113,
    ["Sapphire CLI Config"] = 798,
    ["SauceCTL Configuration"] = 1061,
    Scarb = 818,
    ["Schema Catalog"] = 813,
    ["Scoop manifest"] = 819,
    ["Semantic Data Fabric (SDF) file"] = 823,
    ["Semgrep Rule"] = 825,
    ["Serenity Code Generator (Sergen)"] = 826,
    ["Serverless Framework Configuration"] = 1068,
    ["Serverless Workflow"] = 1070,
    ["Settings for a Cinnamon spice"] = 1203,
    ["Settings.paf"] = 828,
    ["Shopware 6 Configuration"] = 1071,
    ["Shopware CLI Extension Store Configuration"] = 1072,
    ["Shopware CLI Project Store Configuration"] = 1073,
    ["Sigma Detection Rule"] = 830,
    ["SigmaCV CV"] = 1,
    ["Sigrid scope configuration file"] = 831,
    ["SkyPilot Task JSON"] = 1159,
    ["Slack app manifest"] = 835,
    Snapcraft = 837,
    ["Solarxy project config"] = 840,
    Solidarity = 841,
    ["Solution filters"] = 842,
    ["Source Maps v3"] = 843,
    Sourcery = 844,
    ["Spack bootstrap.yaml"] = 845,
    ["Spack cdash.yaml"] = 846,
    ["Spack ci.yaml"] = 847,
    ["Spack compilers.yaml"] = 848,
    ["Spack concretizer.yaml"] = 849,
    ["Spack config.yaml"] = 850,
    ["Spack definitions.yaml"] = 851,
    ["Spack develop.yaml"] = 852,
    ["Spack env_vars.yaml"] = 853,
    ["Spack environment"] = 859,
    ["Spack include.yaml"] = 854,
    ["Spack mirrors.yaml"] = 855,
    ["Spack modules.yaml"] = 856,
    ["Spack packages.yaml"] = 857,
    ["Spack repos.yaml"] = 858,
    ["Spack toolchains.yaml"] = 860,
    ["Spack upstreams.yaml"] = 861,
    ["Spack view.yaml"] = 862,
    ["Speakeasy Generation Config File"] = 866,
    ["Speakeasy Lint Configuration File"] = 863,
    ["Speakeasy Test Generation Configuration File"] = 864,
    ["Speakeasy Workflow File"] = 865,
    SpecIF = 867,
    ["Specmatic Configuration"] = 868,
    ["Sponge Mixin configuration"] = 869,
    StackBlitz = 875,
    ["StackHawk Scanner Configuration"] = 1067,
    Stale = 876,
    Starfish = 877,
    ["Starlake Data Pipeline"] = 1039,
    Starship = 878,
    ["Statamic Blueprint"] = 879,
    ["Stella configuration file"] = 880,
    ["Streamlit configuration file"] = 881,
    ["Stryker Mutator"] = 884,
    ["StyleCop Analyzers Configuration"] = 885,
    ["Stylelint (.stylelintrc)"] = 886,
    ["Stylua Config"] = 1254,
    ["Sublime Syntax"] = 1114,
    ["Subsquid squid manifest"] = 1161,
    ["Swagger API 2.0"] = 888,
    ["Synadia Connect Component"] = 889,
    TSON = 925,
    TSTyche = 926,
    ["TYPO3 Vendor Bundler config"] = 932,
    ["Tab data for a LinUtil"] = 1210,
    ["Tab list for a LinUtil"] = 1209,
    Tach = 890,
    ["Tach Domain"] = 891,
    Talhelper = 893,
    ["Talisman configuration"] = 894,
    Taplo = 1255,
    ["Taskfile config"] = 1044,
    Taurus = 895,
    Tauticord = 896,
    ["Tekton Pipeline"] = 1283,
    ["Tekton PipelineRun"] = 1284,
    ["Tekton Task"] = 1281,
    ["Tekton TaskRun"] = 1282,
    Telefonistka = 1241,
    ["Terrateam config"] = 1267,
    ["TestEnvironment.json"] = 908,
    ["TextMate Grammar"] = 907,
    Threagile = 902,
    ["Tier.run pricing.json"] = 899,
    Tikibase = 900,
    Tombi = 905,
    ["Traefik v2"] = 911,
    ["Traefik v2 File Provider"] = 912,
    ["Traefik v3"] = 913,
    ["Traefik v3 File Provider"] = 914,
    ["Travis CI (.travis.yml)"] = 910,
    Treefmt = 458,
    Trident = 1237,
    ["TrueScript for *.tscript files"] = 917,
    ["Tugboat QA config.yml"] = 1234,
    TunnelHub = 1149,
    Turborepo = 909,
    Tycho = 1198,
    Tye = 1075,
    ["Tyk Gateway - Open Source v5.7+"] = 1246,
    ["UET BuildConfig.json"] = 1119,
    ["UI5 Manifest"] = 938,
    ["UNCORS configuration"] = 943,
    ["UTAM Page Object"] = 941,
    ["Ubuntu Server Autoinstall"] = 936,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1238,
    ["Uniswap Token List"] = 1024,
    ["Universal Schedule Format"] = 944,
    ["Unreal Engine Uplugin"] = 1120,
    ["Unreal Engine Uproject"] = 1121,
    ["UpCloud CLI (upctl) configuration"] = 1239,
    ["Updatecli Compose"] = 1083,
    ["Updatecli Policy Manifest"] = 1084,
    ["Updatecli Policy Metadata"] = 1085,
    Uplift = 1117,
    ["Upsun config"] = 8,
    ["User Journey Map"] = 1049,
    V2Ray = 1089,
    ["VSCode Code Snippets"] = 262,
    ["VSIX CLI publishing"] = 962,
    Vector = 946,
    ["Vela Pipeline Configuration"] = 949,
    Vercel = 261,
    ["Version Bumper config"] = 952,
    Vespertide = 1288,
    ["Vespertide Migration"] = 1289,
    ["Vespertide Model"] = 1290,
    ["Viash Component Config"] = 1243,
    ["Viash Package Config"] = 1244,
    Visivo = 1147,
    ["WP-CLI"] = 972,
    Wake = 1236,
    ["Waku Config"] = 1213,
    ["Web App Manifest"] = 968,
    ["Web types"] = 971,
    WebExtensions = 967,
    ["Webman package recipe"] = 1095,
    ["Windows Package Manager Installer Manifest"] = 1021,
    ["Windows Package Manager Locale Manifest"] = 1022,
    ["Windows Package Manager Singleton Manifest"] = 1020,
    ["WireMock CLI import configuration"] = 1219,
    ["WireMock CLI local service configuration"] = 1218,
    ["WireMock message stub mapping"] = 1217,
    ["WireMock stub mapping"] = 1216,
    ["Woodpecker pipeline config"] = 1063,
    ["Wrangler CLI"] = 973,
    ["XenForo add-on manifest"] = 974,
    ["Xstate Machine"] = 1081,
    ["Yandex Workflow Language"] = 1205,
    ["Yarn Config (.yarnrc.yml)"] = 1037,
    ["Yippee-Ki-JSON configuration YML"] = 1028,
    ["YouTrack App"] = 1202,
    ["Zarf Package Configuration"] = 1269,
    ["Zerops import file"] = 1190,
    ["Zola Configuration"] = 1280,
    ["aerleon.yml"] = 22,
    ["amplify.yml"] = 15,
    ["amxx-builder manifest"] = 1332,
    ["angular.json"] = 39,
    apko = 1152,
    ...
    ["behat.yml"] = 146,
    ["bigquery-table"] = 135,
    ["bioimageio resource description"] = 1169,
    ...
    ["bozr.suite.json"] = 150,
    bpkg = 1130,
    ["browser.i18n.json"] = 151,
    ["browsh configuration"] = 152,
    bucklescript = 153,
    ["buf.gen.yaml"] = 91,
    ["buf.lock"] = 92,
    ["buf.plugin.yaml"] = 93,
    ...
    ["build-changelog"] = 154,
    ["bun.lock"] = 159,
    ["bundleconfig.json"] = 160,
    ["bunfig.toml"] = 161,
    ["cargo-mutants-config.yaml"] = 96,
    ["cargo-nextest repository configuration"] = 622,
    ["cargo-nextest user configuration"] = 623,
    ["ccmod.json"] = 1214,
    changelogging = 1181,
    ["chisel-slices.json"] = 288,
    ["chrome-extension-locales-messages.json"] = 269,
    ["chutzpah.json"] = 270,
    cibuildwheel = 183,
    ["clang-format (.clang-format)"] = 1087,
    ["clang-tidy"] = 245,
    clangd = 244,
    clib = 246,
    ["cloud-init: cloud-config userdata"] = 248,
    ["cloud-sdk-pipeline-configuration"] = 272,
    ["cloudbuild.json"] = 273,
    cloudify = 247,
    cmakefmt = 201,
    ["cmdx.yaml"] = 99,
    ...
    ["coffeelint.json"] = 290,
    ["commands.json"] = 265,
    ["commitlint (.commitlintrc)"] = 1023,
    ["committed.toml"] = 291,
    ["compile_commands.json"] = 264,
    ["compilerconfig.json"] = 263,
    ["completely.yml"] = 1125,
    ["component-detection-manifest.json"] = 294,
    ["component.json"] = 293,
    ["composer.json"] = 292,
    ["conda-forge"] = 187,
    ["config.yaml"] = 750,
    ["contentmanifest.json"] = 271,
    ["contribute.json"] = 295,
    ["cosmos.config.json"] = 267,
    ["crowdin.yml"] = 296,
    ["ctfd-setup configuration file"] = 1226,
    ["custom-elements.json"] = 1139,
    ["cypress.json"] = 300,
    ["dacier.yml"] = 1320,
    ["datalogic-scan2deploy-android"] = 310,
    ["datalogic-scan2deploy-ce"] = 311,
    ["dbt Dependencies"] = 208,
    ["dbt Packages"] = 210,
    ["dbt Project"] = 209,
    ["dbt Selectors"] = 211,
    ["dbt YAML files"] = 212,
    ...
    ["ddev-global"] = 312,
    ["ddev-project"] = 313,
    ["debugsettings.json"] = 314,
    ["dependabot-v2.json"] = 317,
    ["dependabot.json"] = 316,
    ["deployed-cli"] = 1080,
    ["devcontainer-feature.json"] = 255,
    ["devcontainer.json"] = 254,
    devinit = 1030,
    ["devspace.yaml"] = 1103,
    djlint = 1031,
    ["docker bake"] = 323,
    ["docker sequencer"] = 324,
    ["docker-compose.yml"] = 1029,
    ["dockerd.json"] = 321,
    ["dotnet Release Index manifest"] = 336,
    ["dotnet-tools.json"] = 337,
    ["dotnetcli.host.json"] = 338,
    ["dprint.json"] = 339,
    ["drone.json"] = 340,
    ["dss-2.0.0.json"] = 342,
    ["dstack configuration"] = 343,
    ["dtool dataset metadata"] = 1221,
    ["dvc.yaml"] = 344,
    ["ecosystem.json"] = 349,
    eksctl = 351,
    ["electron-builder configuration file"] = 377,
    ["epr-manifest.json"] = 376,
    ["estampo.toml"] = 375,
    ["evcc.yaml"] = 378,
    ["ezd task runner"] = 389,
    ["fabric.mod.json"] = 392,
    ["first-timers-bot"] = 400,
    ["flagd flag configuration"] = 121,
    ["fly.io Configuration"] = 122,
    fulibWorkflows = 1062,
    ["function.json"] = 412,
    ["gRPC API Gateway & OpenAPI Config"] = 17,
    ["gematik health care insurance list"] = 1232,
    ["gematik health care patient list"] = 1229,
    ["gematik health care provider institution list"] = 1231,
    ["gematik health care provider list"] = 1230,
    ["gematik tiger test environment configuration"] = 1233,
    ["git-town.toml"] = 1278,
    ["gitlab-ci"] = 432,
    ["global.json"] = 448,
    ["go-feature-flag Flag Configuration"] = 451,
    ["haxelib.json"] = 470,
    helmfile = 1016,
    helmwave = 1017,
    ["host-meta.json"] = 477,
    ...
    ["ide.host.json"] = 485,
    ["ifstate.yaml"] = 486,
    ["imageoptimizer.json"] = 487,
    ["importmap.json"] = 490,
    instant_python_config = 494,
    instant_python_custom_project = 495,
    intlayer = 496,
    ["ioBroker Configuration"] = 497,
    ["ioBroker JSON UI"] = 498,
    ["ioBroker Package manifest"] = 499,
    ["ixpect.conf.yaml"] = 500,
    ["ize.toml"] = 1116,
    ["jsconfig.json"] = 525,
    ["jscpd Configuration"] = 1100,
    jsdoc = 1012,
    ["k3d.yaml"] = 526,
    ["k9s aliases.yaml"] = 528,
    ["k9s cluster-config.yaml"] = 530,
    ["k9s config.yaml"] = 529,
    ["k9s hotkeys.yaml"] = 531,
    ["k9s plugins.yaml"] = 532,
    ["k9s skin.yaml"] = 533,
    ["k9s views.yaml"] = 534,
    ["kontinuous-config.yaml"] = 546,
    ["kontinuous-values.yaml"] = 545,
    ["kustomization.yaml"] = 548,
    ["label-commenter-config.yml"] = 549,
    ["latexindent configuration"] = 114,
    ["launchsettings.json"] = 550,
    lazydocker = 1138,
    lazygit = 1137,
    ["lego.json"] = 552,
    ["lerna.json"] = 553,
    ["lgtm.yml"] = 554,
    ["liblab.config.json"] = 555,
    ["libman.json"] = 556,
    ["license-report-config.json"] = 557,
    ["linkinator.config.json"] = 559,
    ["lint-staged (.lintstagedrc)"] = 990,
    ["local.settings.json"] = 564,
    ["localazy.json"] = 565,
    ["lotus.yaml"] = 563,
    ["lsdlschema.json"] = 566,
    ["macro.json"] = 1104,
    ["markdown-link-check"] = 1058,
    maturin = 1059,
    mboats = 1066,
    memnex = 1318,
    ["micro-settings.json"] = 1131,
    ["mimetypes.json"] = 581,
    ["mirrord config"] = 992,
    mise = 993,
    ["mkdocs.yml"] = 601,
    ["mockd.yaml"] = 605,
    ["modelparams.dev Model"] = 607,
    ["monospace.yml"] = 608,
    ["moon.yml"] = 1215,
    ["mprocs Configuration file"] = 1185,
    ["mrdocs.yml"] = 603,
    ["mta.yaml"] = 994,
    ["mtad.yaml"] = 995,
    ["mycode.json"] = 615,
    nFPM = 624,
    ["napari plugin manifest"] = 616,
    neoload = 1007,
    ["nest-cli"] = 627,
    ["nexus-rpc-gen"] = 1305,
    ["ninjs (News in JSON)"] = 626,
    ["nitro.json"] = 1006,
    ["nixd configuration"] = 1157,
    ["nlu.json"] = 628,
    ["nodemon.json"] = 630,
    ["noodl config"] = 1065,
    ["notebook.mod.json"] = 631,
    now = 1002,
    ["npm-badges"] = 634,
    ["nswag.json"] = 638,
    ntangle = 640,
    ["nuclei-template.yaml"] = 635,
    ["nuget-project.json"] = 636,
    ["ocelot.json"] = 642,
    ogen = 645,
    ["omnisharp.json"] = 648,
    openHAB = 1291,
    ...
    oxlint = 1302,
    ["package.json"] = 683,
    ["package.manifest"] = 685,
    ["package.yaml"] = 684,
    ["partial-black.json"] = 147,
    ["partial-fastapi.json"] = 148,
    ["partial-pixi.json"] = 695,
    ["partial-scheduled.json"] = 149,
    ["pattern.json"] = 693,
    ["petstore-v1.0"] = 1111,
    pgap_yaml_input_reader = 691,
    pgrls = 692,
    pgxgen = 1295,
    pitcms = 1298,
    ["pixi.toml"] = 694,
    ["plagiarize-me.yaml"] = 699,
    ["plagiarize.yaml"] = 698,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1222,
    ["podbard.yaml"] = 701,
    ["portman.json"] = 704,
    ["prefect.toml"] = 713,
    ["prefect.yaml"] = 714,
    ...
    ["prettierrc.json"] = 716,
    ["prisma.yml"] = 717,
    ["project-1.0.0-beta3.json"] = 729,
    ["project-1.0.0-beta4.json"] = 730,
    ["project-1.0.0-beta5.json"] = 731,
    ["project-1.0.0-beta6.json"] = 732,
    ["project-1.0.0-beta8.json"] = 733,
    ["project-1.0.0-rc1.json"] = 734,
    ["project-1.0.0-rc2.json"] = 735,
    ["project.json"] = 728,
    ["project.owasp.yaml"] = 736,
    ["prometheus-alertmanager.json"] = 740,
    ["prometheus.json"] = 737,
    ["prometheus.rules.json"] = 738,
    ["prometheus.rules.test.json"] = 739,
    ["proxies.json"] = 741,
    ["publiccode.yml"] = 742,
    ["pubspec.yaml"] = 743,
    ["pyrseas-0.8.json"] = 746,
    pytest = 755,
    ["quilt.mod.json"] = 1132,
    ["rc3 auth"] = 761,
    ["rc3 collection"] = 762,
    ...
    ["rc3 settings"] = 766,
    ["registry.yaml"] = 52,
    ["release drafter"] = 1008,
    ["release-hub.json"] = 4,
    ["release-please-config.json"] = 771,
    ["release-please-manifest.json"] = 772,
    ["release-plz.toml"] = 773,
    ["renv.lock"] = 787,
    ["reposets Configuration"] = 776,
    ["reposets Credentials"] = 777,
    ["revola.json"] = 2,
    ["rivet.json"] = 1156,
    ["rivet.yaml (legacy)"] = 1155,
    rumdl = 792,
    runny = 791,
    runspec = 1319,
    rustfmt = 793,
    ...
    samt = 796,
    samtrc = 797,
    ["sarif-1.0.0.json"] = 799,
    ["sarif-2.0.0.json"] = 800,
    ["sarif-2.1.0"] = 810,
    ["sarif-2.1.0-rtm.2"] = 801,
    ["sarif-2.1.0-rtm.3"] = 803,
    ["sarif-2.1.0-rtm.4"] = 805,
    ["sarif-2.1.0-rtm.5"] = 807,
    ["sarif-2.1.0-rtm.6"] = 808,
    ["sarif-external-property-file-2.1.0"] = 811,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 802,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 804,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 806,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 809,
    ["scalingo.json configuration"] = 812,
    ["schema.org - Action"] = 814,
    ["schema.org - ContactPoint"] = 815,
    ["schema.org - Place"] = 816,
    ["schema.org - Thing"] = 817,
    ["secrethub.yml"] = 1134,
    ["semantic-release"] = 824,
    ["servicehub.config.json"] = 985,
    ["servicehub.service.json"] = 984,
    ["settings.job"] = 827,
    ["sfdx-hardis configuration"] = 829,
    ["shard.yml"] = 1172,
    ["size-limit configuration"] = 834,
    ["skaffold.yaml"] = 1056,
    ["skyuxconfig.json"] = 836,
    ["snowflake-config"] = 838,
    ["snowflake-connections"] = 839,
    ["spicepod.yaml"] = 1193,
    ["sqlc configuration"] = 872,
    ["stripe-app-local.json"] = 883,
    ["stripe-app.json"] = 882,
    swcrc = 1040,
    ["task.json"] = 892,
    taskcat = 1003,
    ["template.json"] = 897,
    ["templatsources.json"] = 898,
    ["text2confl config"] = 1303,
    ["theme.json"] = 901,
    ["tizen_workspace.json"] = 903,
    tldr = 904,
    ["tm_devices configuration file"] = 1260,
    tmuxinator = 988,
    tox = 906,
    ["transcend.yml"] = 915,
    ["tree-sitter grammar.json"] = 457,
    ["trime.yaml"] = 916,
    ["trunk.yaml"] = 918,
    ["ts-force-config.json"] = 923,
    ["tsconfig.json"] = 919,
    ["tsd.json"] = 920,
    ["tsdoc.json"] = 921,
    ["tsdrc.json"] = 922,
    ...
    v8r = 966,
    vcluster = 1179,
    ["vcpkg configuration file"] = 260,
    ["vcpkg manifest file"] = 259,
    ["vega-lite.json"] = 948,
    ["vega.json"] = 947,
    ["venvironment.yaml"] = 950,
    ["venvplus.yaml"] = 951,
    version = 1242,
    ["version.json"] = 953,
    ["vhwdebugger-binding.yaml"] = 955,
    ["vim-addon-info"] = 956,
    ["vs-2017.3.host.json"] = 958,
    ["vs-nesting.json"] = 959,
    ["vsls.json"] = 957,
    ["vss-extension.json"] = 963,
    vtcfg = 1248,
    ["vtesttree.yaml"] = 964,
    ["vtestunit.yaml"] = 965,
    ["warp-keysets.json"] = 1140,
    ["warp-themes.json"] = 1141,
    ["warp-workflows.json"] = 1142,
    ["webhint.io"] = 1096,
    ["webjobpublishsettings.json"] = 970,
    ["webjobs-list.json"] = 969,
    ["well-known-fursona"] = 1180,
    ["xs-app.json"] = 998,
    ["xunit.runner.json"] = 983,
    yamlfmt = 1025,
    yamllint = 1026,
    ["yap.json"] = 1027,
    ["zerops.yml"] = 1189,
