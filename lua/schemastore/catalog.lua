...
M.json = {
  ...
  index = {
    ...
    ["CMake Presets"] = 109,
    ["CNC Codes"] = 121,
    ["CSS Comb (.csscomb.json)"] = 201,
    ["CSS Lint (.csslintrc)"] = 202,
    ["CSpell (cspell.json)"] = 200,
    ...
    Containerlab = 730,
    ["Crowdsec collection config"] = 195,
    ["Crowdsec parser config"] = 196,
    ["Crowdsec scenario config"] = 197,
    ["CumulusCI Config"] = 125,
    ["Custom Machinery Machine"] = 849,
    ["Custom Machinery Recipe"] = 850,
    ["Cycle Stack File"] = 128,
    ["DWP Exchange - catalogue entry"] = 242,
    ["DWP Exchange - gateway"] = 240,
    ["DWP Exchange - meta"] = 241,
    ["Dart Build Config (dart-build.json)"] = 203,
    ["Dart Test Config (dart-test.json)"] = 204,
    ["DashLord Configuration"] = 205,
    ["Data Contract Specification"] = 206,
    ["Data Product Specification"] = 207,
    ["DataYoga Connections"] = 129,
    ["DataYoga Job"] = 130,
    ["Databricks Asset Bundles"] = 829,
    ["Datadog Service Definition"] = 359,
    ["Datahub Ingestion Recipe"] = 779,
    ["Dein Config"] = 132,
    ["Deno Config (deno.json)"] = 213,
    ["Dependency cruiser"] = 133,
    ["Deployer Recipe"] = 216,
    ["Deta Spacefile"] = 134,
    ["Detekt Config (detekt.yml)"] = 217,
    ["Devbox Config"] = 135,
    ["Devbox Plugin"] = 136,
    Devfile = 239,
    ["Discord Webhook"] = 218,
    ["DocFx Config (docfx.json)"] = 221,
    ["Dolittle Artifacts"] = 222,
    ["Dolittle Bounded Context Configuration"] = 223,
    ["Dolittle Event Horizons Configuration"] = 224,
    ["Dolittle Resources Configuration"] = 225,
    ["Dolittle Server Configuration"] = 226,
    ["Dolittle Tenant Map Configuration"] = 228,
    ["Dolittle Tenants Configuration"] = 227,
    ["Dolittle Topology"] = 229,
    ...
    ["Drupal Routing"] = 147,
    ["Drupal Services"] = 149,
    ["Drush site aliases"] = 235,
    ["Dynamic Bash Aliases (.aliases)"] = 820,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 809,
    ["Elgato Stream Deck"] = 245,
    ["Embrace Config"] = 790,
    Endurica = 833,
    ["Enterprise Contract Policy Spec"] = 246,
    ["Erda Pipeline"] = 856,
    ["Erda Runtime"] = 857,
    ["Error pages"] = 250,
    Esquio = 248,
    ...
    ["Expo SDK"] = 253,
    ["F-Droid Data metadata"] = 258,
    ["Facets - FSDL - Application"] = 256,
    ["FasterCI Configuration"] = 69,
    FiQuS = 262,
    Firebase = 260,
    ["Flow.json Configurations"] = 853,
    ["Fossa configuration file"] = 269,
    ["Fossa's fossa-deps file"] = 270,
    ["Foundry VTT - Base package Manifest"] = 264,
    ["Foundry VTT - Module Manifest"] = 265,
    ["Foundry VTT - System Data Template"] = 268,
    ["Foundry VTT - System Manifest"] = 266,
    ["Foundry VTT - World Manifest"] = 267,
    ["Foxx Manifest"] = 70,
    ["Freifunk.de Community API"] = 73,
    ["Frogbot Config"] = 74,
    ["G2P Mapping Configuration"] = 274,
    ["GCP Blueprint Metadata"] = 277,
    Gaspar = 275,
    ["GatewayCore API Gateway"] = 276,
    ["GeoJSON.json latest"] = 767,
    GherKing = 771,
    ["GitHub Action"] = 282,
    ["GitHub Discussion"] = 283,
    ["GitHub Funding"] = 284,
    ["GitHub Issue Template configuration"] = 286,
    ["GitHub Issue Template forms"] = 285,
    ["GitHub Workflow"] = 287,
    ["GitHub Workflow Template Properties"] = 288,
    ["GitHub automatically generated release notes configuration"] = 289,
    ["GitLab Agent for Kubernetes configuration"] = 845,
    GitVersion = 279,
    ["Gitea Issue Template configuration"] = 280,
    ["Gitea Issue Template forms"] = 281,
    ["Gitpod Configuration"] = 291,
    ["GlazeWM settings"] = 847,
    ["Global Privacy Control"] = 278,
    Goblet = 828,
    ["Golangci-lint Configuration"] = 293,
    ["Golangci-lint Custom Plugins Configuration"] = 294,
    ["Google Chrome Related Website Sets"] = 261,
    ...
    ["Grafana 5.x Dashboard"] = 299,
    ["GraphQL Code Generator"] = 303,
    ["GraphQL Config"] = 302,
    ["GraphQL Mesh"] = 301,
    ["Grunt JSHint task"] = 307,
    ["Grunt Watch task"] = 308,
    ["Grunt base task"] = 309,
    ["Grunt clean task"] = 305,
    ["Grunt copy task"] = 304,
    ["Grunt cssmin task"] = 306,
    HEMTT = 689,
    Hadolint = 701,
    Hammerkit = 729,
    ...
    Hatch = 702,
    Hayson = 311,
    ["Haystack Pipeline"] = 312,
    ["Hazelcast 5 Configuration"] = 313,
    ["Helm Chart.lock"] = 151,
    ["Helm Chart.yaml"] = 150,
    ["Helm Unittest Test Suite"] = 152,
    Hugo = 759,
    ["Hugo Theme"] = 758,
    ["Hyperfoil benchmark configuration"] = 318,
    ["IBM Zapp document"] = 319,
    ["IBM zCodeFormatSettings"] = 320,
    ["IMG Catapult PSP"] = 325,
    ["IVMS101 by CODE Protocol"] = 846,
    Infrahub = 327,
    Istanbul = 786,
    ["JDownloader2 crawler multi-rules"] = 336,
    ["JDownloader2 crawler single-rules"] = 335,
    ["JFrog Applications Config"] = 337,
    ["JFrog File Spec"] = 338,
    ["JFrog Pipelines YML DSL"] = 792,
    ["JMeter DSL cli config"] = 339,
    JReleaser = 341,
    ["JSON Document Transform"] = 349,
    ["JSON Feed"] = 350,
    ["JSON Resume"] = 525,
    ...
    ["JSON-stat 2.0"] = 660,
    JSONPatch = 352,
    ["JSR Package Config (jsr.json)"] = 342,
    Jasmine = 331,
    Jekyll = 332,
    ["Jenkins X Pipelines"] = 333,
    ["Jenkins X Requirements"] = 334,
    ["Jovo Language Models"] = 340,
    ["KIMMDY config file"] = 357,
    ["KSP-AVC"] = 661,
    ["KSP-CKAN"] = 662,
    KSY = 858,
    ["Karakum configuration file"] = 271,
    Kas = 355,
    ["Keycloak REST API"] = 800,
    ["Knative Functions - func.yaml"] = 272,
    ["KoDE/CI build.yaml"] = 788,
    ["Kong DBLess config"] = 789,
    KrakenD = 358,
    ["Kubri Configuration"] = 363,
    LOOBin = 378,
    Lefthook = 367,
    ["Liferay client-extension.yaml"] = 374,
    ["LinkML Metamodel"] = 376,
    Liquibase = 735,
    ["Liquibase Flow File"] = 736,
    ["Lively Properties"] = 377,
    ["Lobe AI Agent"] = 66,
    Loki = 67,
    ["MLOS Configs"] = 412,
    ["MS2Rescore Configuration"] = 415,
    ["Madness (madness.yml)"] = 811,
    Markdownlint = 739,
    ["Mason Registry"] = 741,
    ["MegaLinter configuration"] = 384,
    ["MegaLinter descriptor"] = 385,
    Melange = 837,
    ["Meltano plugin discovery definition"] = 387,
    ["Meltano project definition"] = 386,
    ["Mergify Configuration"] = 416,
    ["MetricsHub Configuration"] = 388,
    ["MetricsHub Connector Configuration"] = 389,
    ["Micro Editor Syntax"] = 821,
    ["Microsoft Band Web Tile"] = 390,
    ["Minecraft Custom Main Menu Mod"] = 838,
    ["Minecraft Data Pack Advancement"] = 392,
    ["Minecraft Data Pack Biome"] = 393,
    ["Minecraft Data Pack Configured Carver"] = 394,
    ["Minecraft Data Pack Damage Type"] = 395,
    ["Minecraft Data Pack Dimension"] = 397,
    ["Minecraft Data Pack Dimension Type"] = 396,
    ["Minecraft Data Pack Item Modifier"] = 398,
    ["Minecraft Data Pack Loot Table"] = 399,
    ["Minecraft Data Pack Metadata"] = 400,
    ["Minecraft Data Pack Predicate"] = 401,
    ["Minecraft Data Pack Recipe"] = 402,
    ["Minecraft Data Pack Tag"] = 403,
    ["Minecraft Data Pack Template Pool"] = 404,
    ["Minecraft Data Pack Trim Material"] = 409,
    ["Minecraft Data Pack Trim Pattern"] = 410,
    ["Minecraft Resource Pack Lang"] = 405,
    ["Minecraft Resource Pack Particle"] = 406,
    ["Minecraft Resource Pack Texture Mcmeta"] = 408,
    ["Minecraft Resourcepack Sounds"] = 407,
    ["MkDocs Configuration 1.0"] = 411,
    ["Monade CLI Stack Configuration"] = 419,
    ["MongoDB Atlas Search Index Definition"] = 787,
    ["Monika Configuration"] = 785,
    ["Monoweave Configuration"] = 414,
    ["Motif config"] = 685,
    ["NOX Framework (Service)"] = 432,
    ["Netin Diagnostic System Template"] = 745,
    ["Netlify config"] = 422,
    ["Network-as-Code Data Model"] = 423,
    ["Nightwatch.js"] = 424,
    ["Nuitka.yaml"] = 851,
    ...
    ["Ory Hydra configuration"] = 317,
    ["Ory Keto configuration"] = 360,
    ...
    ["completely.yml"] = 810,
    ["component-detection-manifest.json"] = 192,
    ["component.json"] = 191,
    ["composer.json"] = 190,
    ["conda-forge"] = 119,
    ["config.yaml"] = 502,
    ...
    ["cypress.json"] = 198,
    ["datalogic-scan2deploy-android"] = 208,
    ["datalogic-scan2deploy-ce"] = 209,
    ["dbt Project"] = 131,
    ["ddev-global"] = 210,
    ["ddev-project"] = 211,
    ["debugsettings.json"] = 212,
    ["dependabot-v2.json"] = 215,
    ["dependabot.json"] = 214,
    ["deployed-cli"] = 761,
    ...
    ["devspace.yaml"] = 784,
    djlint = 716,
    ["docker sequencer"] = 220,
    ["docker-compose.yml"] = 714,
    ["dockerd.json"] = 219,
    ["dotnet Release Index manifest"] = 230,
    ["dotnet-tools.json"] = 231,
    ["dotnetcli.host.json"] = 232,
    ["dprint.json"] = 233,
    ["drone.json"] = 234,
    ["dss-2.0.0.json"] = 236,
    ["dstack configuration"] = 237,
    ["dvc.yaml"] = 238,
    ["ecosystem.json"] = 243,
    eksctl = 244,
    ["electron-builder configuration file"] = 251,
    ["epr-manifest.json"] = 249,
    ["evcc.yaml"] = 252,
    ["ezd task runner"] = 254,
    ["fabric.mod.json"] = 257,
    ["first-timers-bot"] = 263,
    ...
    ["gitlab-ci"] = 290,
    ["global.json"] = 292,
    ["go-feature-flag Flag Configuration"] = 295,
    ["haxelib.json"] = 310,
    helmfile = 703,
    helmwave = 704,
    ["host-meta.json"] = 315,
    ...
    ["ide.host.json"] = 321,
    ["ifstate.conf"] = 322,
    ["imageoptimizer.json"] = 323,
    ["importmap.json"] = 326,
    ["ioBroker Configuration"] = 328,
    ["ioBroker JSON UI"] = 329,
    ["ioBroker Package manifest"] = 330,
    ["ize.toml"] = 801,
    ["jsconfig.json"] = 353,
    ...
    ["k3d.yaml"] = 354,
    ["k9s plugin.yml"] = 356,
    ["kontinuous-config.yaml"] = 362,
    ["kontinuous-values.yaml"] = 361,
    ["kustomization.yaml"] = 364,
    ["label-commenter-config.yml"] = 365,
    ["latexindent configuration"] = 65,
    ["launchsettings.json"] = 366,
    lazydocker = 823,
    lazygit = 822,
    ["lego.json"] = 368,
    ["lerna.json"] = 369,
    ["lgtm.yml"] = 370,
    ["liblab.config.json"] = 371,
    ["libman.json"] = 372,
    ["license-report-config.json"] = 373,
    ["linkinator.config.json"] = 375,
    ["lint-staged (.lintstagedrc)"] = 679,
    ["local.settings.json"] = 380,
    ["localazy.json"] = 381,
    ["lotus.yaml"] = 379,
    ["lsdlschema.json"] = 382,
    ...
    ["mtad.yaml"] = 684,
    ["mycode.json"] = 420,
    ["napari plugin manifest"] = 421,
    neoload = 694,
    ["nest-cli"] = 427,
    ["ninjs (News in JSON) 1.3"] = 426,
    ["ninjs (News in JSON) 2.0"] = 425,
