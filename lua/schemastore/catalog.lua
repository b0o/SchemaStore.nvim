...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 97,
    [".cryproj (generic)"] = 391,
    [".cryproj engine-5.2"] = 386,
    [".cryproj engine-5.3"] = 387,
    [".cryproj engine-5.4"] = 388,
    [".cryproj engine-5.5"] = 389,
    [".cryproj engine-dev"] = 390,
    [".csscomb.json"] = 99,
    [".csslintrc"] = 100,
    [".eslintrc"] = 134,
    [".esmrc.json"] = 127,
    ...
    [".vsext"] = 367,
    [".yarnrc.yml"] = 429,
    ["<div>RIOTS' studio configuration"] = 370,
    ["API Builder"] = 426,
    ...
    ["Azure Pipelines"] = 32,
    ["Azure Static Web Apps CLI configuration file"] = 326,
    ["Azure Static Web Apps configuration file"] = 325,
    ["Better Code Hub"] = 431,
    BizTalkServerApplicationSchema = 403,
    Briefcase = 408,
    Buildkite = 53,
    ...
    Goreleaser = 159,
    ["Goreleaser Pro"] = 160,
    ["Gradle Build Cache Node"] = 428,
    ["Gradle Enterprise"] = 427,
    ...
    ["JSON Feed"] = 195,
    ["JSON Resume"] = 292,
    ["JSON Schema Draft 2020-12"] = 382,
    ["JSON Schema Draft 4"] = 379,
    ["JSON Schema Draft 7"] = 380,
    ["JSON Schema Draft 8"] = 381,
    ...
    ["Netin Diagnostic System Template"] = 450,
    ["Netlify config schema"] = 233,
    ["Nightwatch.js"] = 234,
    ["OSS Review Toolkit repository configuration"] = 254,
    Opctl = 399,
    ["OpenWeather Current Weather API"] = 435,
    ["OpenWeather Road Risk API"] = 434,
    ...
    Packer = 257,
    ["Pipeline component"] = 444,
    ["PocketMine plugin.yml"] = 261,
    ["Pull Request Labeler"] = 283,
    Qodana = 457,
    ["RKE Cluster Configuration JSON Schema"] = 442,
    ["RKE Cluster Configuration YAML Schema"] = 441,
    Ray = 411,
    ["Read the Docs"] = 286,
    ...
    ["SauceCTL Configuration"] = 447,
    ["Schema Catalog"] = 308,
    ["Scoop manifest"] = 313,
    ["Semgrep Rule"] = 314,
    ["Serverless Framework Configuration"] = 454,
    ["Shopware CLI Extension Store Configuration"] = 455,
    ["Shopware CLI Project Store Configuration"] = 456,
    Solidarity = 320,
    ["Source Maps v3"] = 321,
    SpecIF = 322,
    ["Sponge Mixin configuration"] = 323,
    ["StackHawk Scanner Configuration"] = 453,
    ["StackHead CLI config"] = 327,
    ["StackHead module configuration"] = 328,
    ["StackHead project definition"] = 329,
    Stale = 330,
    ["Statamic Blueprint"] = 331,
    ["Stryker Mutator"] = 332,
    ["StyleCop Analyzers Configuration"] = 333,
    ["Swagger API 2.0"] = 336,
    ["Taskfile YAML Schema"] = 437,
    Taurus = 337,
    ["TestEnvironment.json"] = 342,
    ["Traefik v2"] = 344,
    ["Traefik v2 File Provider"] = 345,
    ["UI5 Manifest"] = 356,
    ["Uniswap Token List"] = 420,
    ["User Journey Map YAML Schema"] = 440,
    ["VSCode Code Snippets"] = 76,
    ["VSIX CLI publishing"] = 368,
    ["Vela Pipeline Configuration"] = 360,
    Vercel = 75,
    ["Web App Manifest"] = 372,
    ["Web types"] = 375,
    WebExtensions = 371,
    ["Windows Package Manager Installer Manifest"] = 417,
    ["Windows Package Manager Locale Manifest"] = 418,
    ["Windows Package Manager Singleton Manifest"] = 416,
    ["Woodpecker pipeline config"] = 449,
    ["Yippee-Ki-JSON configuration YML"] = 422,
    ["angular.json"] = 6,
    ...
    ["servicehub.config.json"] = 385,
    ["servicehub.service.json"] = 384,
    ["settings.job"] = 315,
    ["sfdx-hardis configuration"] = 316,
    ["size-limit configuration"] = 317,
    ["skaffold.yaml"] = 445,
    ["skyuxconfig.json"] = 318,
    snapcraft = 319,
    swcrc = 433,
    taskcat = 402,
    ["template.json"] = 338,
    ["templatsources.json"] = 339,
    ["theme.json"] = 340,
    tmLanguage = 341,
    ["trunk.yaml schema"] = 346,
    ["ts-force-config.json"] = 350,
    ["tsconfig.json"] = 347,
    ["tsd.json"] = 348,
    ["tsdrc.json"] = 349,
    ["tslint.json"] = 351,
    ...
    ["version.json"] = 361,
    ["vim-addon-info"] = 362,
    ["vs-2017.3.host.json"] = 364,
    ["vs-nesting.json"] = 365,
    ["vsls.json"] = 363,
    ["vss-extension.json"] = 369,
    ["webjobpublishsettings.json"] = 374,
    ["webjobs-list.json"] = 373,
    ["xs-app.json"] = 398,
    ["xunit.runner.json"] = 383,
    yamllint = 421,
    zuul = 407,
    ["Žinoma"] = 415
  },
