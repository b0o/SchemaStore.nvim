...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 152,
    [".cryproj (generic)"] = 509,
    [".cryproj engine-5.2"] = 504,
    [".cryproj engine-5.3"] = 505,
    [".cryproj engine-5.4"] = 506,
    [".cryproj engine-5.5"] = 507,
    [".cryproj engine-dev"] = 508,
    [".csscomb.json"] = 154,
    [".csslintrc"] = 155,
    [".eslintrc"] = 200,
    [".esmrc.json"] = 192,
    ...
    [".mtaext"] = 518,
    [".nodehawkrc"] = 322,
    [".npmpackagejsonlintrc"] = 325,
    [".phraseapp.yml"] = 360,
    [".pmbot.yml"] = 352,
    [".postcssrc"] = 357,
    [".pre-commit-config.yml"] = 358,
    [".pre-commit-hooks.yml"] = 359,
    [".putout.json"] = 377,
    [".rehyperc"] = 385,
    [".remarkrc"] = 386,
    [".sprite files"] = 429,
    ...
    [".vsext"] = 484,
    [".yarnrc.yml"] = 550,
    ["<div>RIOTS' studio configuration"] = 488,
    ["@factorial/drupal-breakpoints-css"] = 5,
    ["A micro editor config schema"] = 291,
    ["API Builder"] = 547,
    ["AVA Configuration Schema"] = 603,
    ["AWS CDK cdk.json"] = 140,
    ["AWS CloudFormation"] = 141,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 142,
    ["Airlock Microgateway"] = 9,
    ["Airplane task"] = 10,
    ["Alacritty Configuration Schema"] = 578,
    ["All Contributors configuration file"] = 630,
    ...
    ["Azure Pipelines"] = 47,
    ["Azure Static Web Apps CLI configuration file"] = 431,
    ["Azure Static Web Apps configuration file"] = 430,
    ["BX CI"] = 82,
    ["Better Code Hub"] = 552,
    ["Better Scripts"] = 83,
    BizTalkServerApplicationSchema = 524,
    ["Block Protocol Metadata"] = 81,
    Briefcase = 529,
    ["Build Info"] = 74,
    Buildkite = 76,
    ["Bukkit plugin.yml"] = 75,
    ["BungeeCord plugin.yml"] = 79,
    ["Butane Config"] = 590,
    ["CICS TS region tagging"] = 597,
    ["CICS TS resource import"] = 598,
    ["CICS TS resource model"] = 599,
    ["CICS TS resource overrides"] = 600,
    ["CMake Presets"] = 84,
    ["CNC Codes JSON Schema"] = 93,
    ["Calqulus pipeline"] = 85,
    ["Camel YAML DSL"] = 86,
    Carafe = 87,
    ["Cargo Config Schema"] = 88,
    ["Cargo Make"] = 89,
    ["Catalog Info Backstage"] = 90,
    Cheatsheets = 587,
    ["Chrome Extension"] = 134,
    ["CircleCI config.yml"] = 115,
    ["Citation File Format"] = 143,
    CityJSON = 91,
    ["Code Climate"] = 116,
    CodeCV = 46,
    Codux = 123,
    ["Cog config file"] = 94,
    ["Commandbox Box.json"] = 95,
    ["Commandbox Server.json"] = 96,
    ["Common Catalog Schema"] = 132,
    ["Common types for all schemas"] = 1,
    Conjure = 92,
    ["Container Structure Test"] = 535,
    Containerlab = 560,
    ["DWP Exchange - catalogue entry"] = 189,
    ["DWP Exchange - gateway"] = 187,
    ["DWP Exchange - meta"] = 188,
    ["Dart build configuration"] = 156,
    ["Dart test config"] = 157,
    ["DashLord configuration"] = 158,
    ["Datadog Service Definition"] = 274,
    ["Datahub Ingestion Recipe Schema"] = 604,
    ["Dein Config Schema"] = 98,
    Deno = 162,
    ["Deployer Recipe"] = 165,
    Devfile = 186,
    ["Discord Webhook"] = 167,
    ["Dolittle Artifacts"] = 171,
    ["Dolittle Bounded Context Configuration"] = 172,
    ["Dolittle Event Horizons Configuration"] = 173,
    ["Dolittle Resources Configuration"] = 174,
    ["Dolittle Server Configuration"] = 175,
    ["Dolittle Tenant Map Configuration"] = 177,
    ["Dolittle Tenants Configuration"] = 176,
    ["Dolittle Topology"] = 178,
    ["Drupal Breakpoints Schema"] = 99,
    ["Drupal Config Schema"] = 110,
    ["Drupal Info Schema"] = 100,
    ["Drupal Layouts Schema"] = 101,
    ["Drupal Libraries Schema"] = 102,
    ["Drupal Links Action Schema"] = 103,
    ["Drupal Links Contextual Schema"] = 104,
    ["Drupal Links Menu Schema"] = 105,
    ["Drupal Links Task Schema"] = 106,
    ["Drupal Migration Schema"] = 107,
    ["Drupal Permissions Schema"] = 108,
    ["Drupal Routing Schema"] = 109,
    ["Drupal Services Schema"] = 111,
    ["Drush site aliases"] = 182,
    ["Embrace Config Schema"] = 615,
    ["Error pages"] = 195,
    Esquio = 193,
    ["Estuary Flow Catalog Schema"] = 594,
    ["Expo SDK"] = 198,
    ["F-Droid Data metadata"] = 203,
    ["Facets - FSDL - Application"] = 201,
    ["FasterCI Configuration"] = 48,
    ["Fossa configuration file"] = 208,
    ["Fossa's fossa-deps file"] = 209,
    ["Foundry VTT - Manifest"] = 206,
    ["Foundry VTT - Template"] = 207,
    ["Foxx Manifest"] = 49,
    ["Freifunk.de Community API"] = 52,
    ["Frogbot Config"] = 53,
    ["GatewayCore API Gateway"] = 212,
    ["GeoJSON.json latest"] = 592,
    GherKing = 596,
    ["GitHub Action"] = 216,
    ["GitHub Funding"] = 217,
    ["GitHub Issue Template configuration"] = 219,
    ["GitHub Workflow"] = 220,
    ["GitHub Workflow Template Properties"] = 221,
    ["GitHub issue forms"] = 218,
    GitVersion = 215,
    ["Gitpod Configuration"] = 223,
    ["Global Privacy Control"] = 213,
    ["Google Cloud Workflows"] = 139,
    Goreleaser = 226,
    ["Goreleaser Pro"] = 227,
    ["Gradle Build Cache Node"] = 549,
    ["Gradle Enterprise"] = 548,
    ["Grafana 5.x Dashboard"] = 228,
    ["GraphQL Code Generator"] = 231,
    ["GraphQL Config"] = 230,
    ["GraphQL Mesh"] = 229,
    ["Grunt JSHint task"] = 235,
    ["Grunt Watch task"] = 236,
    ["Grunt base task"] = 237,
    ["Grunt clean task"] = 233,
    ["Grunt copy task"] = 232,
    ["Grunt cssmin task"] = 234,
    HEMTT = 521,
    Hadolint = 533,
    Hammerkit = 559,
    ["Hardware Sentry Configuration"] = 608,
    Hayson = 239,
    ["Haystack Pipeline"] = 240,
    ["Hazelcast 5 Configuration"] = 241,
    ["Helm Chart.lock"] = 113,
    ["Helm Chart.yaml"] = 112,
    ["Helm Unittest Test Suite"] = 114,
    Hugo = 586,
    ["Istanbul Schema"] = 611,
    ["JDownloader2 crawler multi-rule schema"] = 258,
    ["JDownloader2 crawler single-rule schema"] = 257,
    ["JFrog File Spec"] = 259,
    ["JFrog Pipelines YML DSL"] = 617,
    ["JSON Document Transform"] = 267,
    ["JSON Feed"] = 268,
    ["JSON Resume"] = 391,
    ["JSON Schema Draft 2020-12"] = 500,
    ["JSON Schema Draft 4"] = 497,
    ["JSON Schema Draft 7"] = 498,
    ["JSON Schema Draft 8"] = 499,
    ["JSON schema for CodeShip Pro services configuration files"] = 125,
    ["JSON schema for CodeShip Pro steps configuration files"] = 126,
    ["JSON schema for Codecov configuration files"] = 124,
    ["JSON-API"] = 266,
    ["JSON-e templates"] = 557,
    ["JSON-stat 2.0"] = 494,
    JSONPatch = 270,
    Jasmine = 253,
    Jekyll = 254,
    ["Jenkins X Pipelines"] = 255,
    ["Jenkins X Requirements"] = 256,
    ["Jovo Language Models"] = 260,
    ["KSP-AVC"] = 495,
    ["KSP-CKAN"] = 496,
    ["Keycloak REST API"] = 623,
    ["Knative Functions - func.yaml"] = 210,
    ["KoDE/CI build.yaml"] = 613,
    ["Kong DBLess Schema"] = 614,
    KrakenD = 273,
    ["LinkML Metamodel"] = 286,
    Liquibase = 564,
    ["Liquibase Flow File"] = 565,
    ["Lively Properties"] = 287,
    Markdownlint = 568,
    ["MegaLinter configuration"] = 292,
    ["MegaLinter descriptor"] = 293,
    ["Meltano plugin discovery definition"] = 295,
    ["Meltano project definition"] = 294,
    ["Microsoft Band Web Tile"] = 296,
    ["Minecraft Data Pack Advancement"] = 298,
    ["Minecraft Data Pack Biome"] = 299,
    ["Minecraft Data Pack Configured Carver"] = 300,
    ["Minecraft Data Pack Dimension"] = 302,
    ["Minecraft Data Pack Dimension Type"] = 301,
    ["Minecraft Data Pack Item Modifier"] = 303,
    ["Minecraft Data Pack Loot Table"] = 304,
    ["Minecraft Data Pack Metadata"] = 305,
    ["Minecraft Data Pack Predicate"] = 306,
    ["Minecraft Data Pack Recipe"] = 307,
    ["Minecraft Data Pack Tag"] = 308,
    ["Minecraft Data Pack Template Pool"] = 309,
    ["Minecraft Resourcepack Sounds"] = 310,
    ["MkDocs Configuration 1.0"] = 311,
    ["MongoDB Atlas Search Index Definition Schema"] = 612,
    ["Monika Configuration Schema"] = 610,
    ["Motif config"] = 517,
    ["NOX Framework (Service)"] = 324,
    ["Netin Diagnostic System Template"] = 573,
    ["Netlify config schema"] = 316,
    ["Nightwatch.js"] = 317,
    ["OSS Review Toolkit configuration"] = 342,
    ["OSS Review Toolkit curation"] = 343,
    ["OSS Review Toolkit package configuration"] = 344,
    ["OSS Review Toolkit repository configuration"] = 345,
    ["OSS Review Toolkit resolutions"] = 346,
    Opctl = 520,
    ["OpenRewrite Resource"] = 337,
    ["OpenWeather Current Weather API"] = 556,
    ["OpenWeather Road Risk API"] = 555,
    ["Ory Hydra configuration"] = 245,
    ["Ory Keto configuration"] = 275,
    ["Ory Kratos configuration"] = 341,
    ["Ory Oathkeeper configuration"] = 331,
    ["Outblocks App configuration"] = 339,
    ["Outblocks database table"] = 340,
    ["Outblocks project configuration"] = 338,
    Packer = 349,
    Pantsbuild = 629,
    ["Pipeline component"] = 566,
    ["PocketMine plugin.yml"] = 353,
    Pterodactyl = 607,
    ["Pull Request Labeler"] = 376,
    Pulumi = 381,
    PyProject = 382,
    Qodana = 583,
    ["Quali Torque Blueprint Spec 2"] = 605,
    ["QueryFirst config file"] = 626,
    ["RKE Cluster Configuration JSON Schema"] = 563,
    ["RKE Cluster Configuration YAML Schema"] = 562,
    ["Rancher Fleet"] = 379,
    Ray = 532,
    ["Read the Docs"] = 380,
    ["Red-DiscordBot Cog"] = 383,
    ["Red-DiscordBot Cog Repo"] = 384,
    Renovate = 392,
    ["Replit schema"] = 387,
    RoadRunner = 393,
    Ruff = 389,
    ["Rust Project"] = 390,
    ["Rust toolchain"] = 395,
    ["SIL Kit Participant Configuration"] = 420,
    SWADL = 440,
    ["Sapphire CLI Config"] = 396,
    ["SauceCTL Configuration"] = 570,
    ["Schema Catalog"] = 409,
    ["Scoop manifest"] = 414,
    ["Semgrep Rule"] = 416,
    ["Serverless Framework Configuration"] = 577,
    ["Serverless Workflow Schema"] = 579,
    ["Settings.paf"] = 418,
    ["Shopware 6 Configuration"] = 580,
    ["Shopware CLI Extension Store Configuration"] = 581,
    ["Shopware CLI Project Store Configuration"] = 582,
    Solidarity = 424,
    ["Solution filters"] = 425,
    ["Source Maps v3"] = 426,
    SpecIF = 427,
    ["Sponge Mixin configuration"] = 428,
    ["StackHawk Scanner Configuration"] = 576,
    Stale = 432,
    Starship = 433,
    ["Statamic Blueprint"] = 434,
    ["StrmPrivacy Data Connector"] = 621,
    ["StrmPrivacy Data Contract"] = 622,
    ["StrmPrivacy SimpleSchema"] = 619,
    ["StrmPrivacy Stream"] = 620,
    ["StrmPrivacy batch job configuration file"] = 618,
    ["Stryker Mutator"] = 437,
    ["StyleCop Analyzers Configuration"] = 438,
    ["Swagger API 2.0"] = 441,
    TSON = 462,
    ["Talisman configuration"] = 442,
    ["Taskfile YAML Schema"] = 558,
    Taurus = 443,
    ["TestEnvironment.json"] = 451,
    ["Tier.run pricing.json"] = 446,
    Tikibase = 447,
    ["Traefik v2"] = 454,
    ["Traefik v2 File Provider"] = 455,
    Turborepo = 452,
    Tye = 584,
    ["UI5 Manifest"] = 469,
    ["UTAM Page Object"] = 472,
    ["Ubuntu Server Autoinstall"] = 467,
    ["Uniswap Token List"] = 541,
    ["Unreal Engine Uplugin"] = 627,
    ["Unreal Engine Uproject"] = 628,
    Updatecli = 591,
    Uplift = 625,
    ["User Journey Map YAML Schema"] = 561,
    V2Ray = 595,
    ["VSCode Code Snippets"] = 128,
    ["VSIX CLI publishing"] = 485,
    ["Vela Pipeline Configuration"] = 475,
    Vercel = 127,
    ["Web App Manifest"] = 490,
    ["Web types"] = 493,
    WebExtensions = 489,
    ["Webman package recipe"] = 601,
    ["Windows Package Manager Installer Manifest"] = 538,
    ["Windows Package Manager Locale Manifest"] = 539,
    ["Windows Package Manager Singleton Manifest"] = 537,
    ["Woodpecker pipeline config"] = 572,
    ["Xstate Machine Schema"] = 589,
    ["Yippee-Ki-JSON configuration YML"] = 543,
    ["angular.json"] = 11,
    ...
    ["batect.yml"] = 57,
    ["beau.yml"] = 551,
    ["beef-database-codegen"] = 59,
    ["beef-database-v5-codegen"] = 61,
    ["beef-entity-codegen"] = 60,
    ["beef-entity-v5-codegen"] = 62,
    ["behat.yml"] = 70,
    ["bigquery-table"] = 63,
    ["bitbucket-pipelines"] = 64,
    bitrise = 65,
    ["bitrise-step"] = 66,
    ["block.json"] = 80,
    ["bower.json"] = 68,
    ["bozr.suite.json"] = 71,
    ["browser.i18n.json"] = 72,
    bucklescript = 73,
    ["bundleconfig.json"] = 78,
    ["chutzpah.json"] = 135,
    clangd = 119,
    ["cloud-init: cloud-config userdata JSON schema"] = 121,
    ["cloud-sdk-pipeline-config-schema"] = 137,
    ["cloudbuild.json"] = 138,
    cloudify = 120,
    codemagic = 122,
    ["coffeelint.json"] = 144,
    comet = 553,
    ["commands.json"] = 131,
    ["compile_commands.json"] = 130,
    ["compilerconfig.json"] = 129,
    ["component-detection-manifest.json"] = 147,
    ["component.json"] = 146,
    ["composer.json"] = 145,
    ["config.json"] = 148,
    ["contentmanifest.json"] = 136,
    ["contribute.json"] = 149,
    ["cosmos.config.json"] = 133,
    ["crowdin.yml"] = 150,
    cspell = 153,
    ["cypress.json"] = 151,
    ["datalogic-scan2deploy-android"] = 159,
    ["datalogic-scan2deploy-ce"] = 160,
    ["dbt Project"] = 97,
    ["debugsettings.json"] = 161,
    ["dependabot-v2.json"] = 164,
    ["dependabot.json"] = 163,
    ["deployed-cli"] = 588,
    ["detekt.yml"] = 166,
    devinit = 545,
    ...
    ["docker-seq schema"] = 169,
    ["dockerd.json"] = 168,
    ["dotnet Release Index manifest"] = 179,
    ["dotnetcli.host.json"] = 180,
    ["drone.json"] = 181,
    ["dss-2.0.0.json"] = 183,
    ["dstack Workflows"] = 184,
    ["dvc.yaml"] = 185,
    ["ecosystem.json"] = 190,
    eksctl = 191,
    ["electron-builder configuration file."] = 196,
    ["epr-manifest.json"] = 194,
    ["evcc.yaml"] = 197,
    ["ezd schema"] = 199,
    ["fabric.mod.json"] = 202,
    ["first-timers-bot"] = 205,
    ["flagd flag configuration"] = 50,
    ["fly.io Schema"] = 51,
    fulibWorkflows = 571,
    ["function.json"] = 211,
    ["geojson.json"] = 214,
    ["gitlab-ci"] = 222,
    ["global.json"] = 224,
    ["golangci-lint Configuration"] = 225,
    ["haxelib.json"] = 238,
    helmfile = 534,
    ["host-meta.json"] = 243,
    ["host.json"] = 242,
    ...
    ["ide.host.json"] = 246,
    ["ifstate.conf"] = 247,
    ["imageoptimizer.json"] = 248,
    ["importmap.json"] = 250,
    ["ioBroker JSON UI"] = 251,
    ["ioBroker Package manifest"] = 252,
    ["ize.toml"] = 624,
    ["jsconfig.json"] = 271,
    ["jscpd Configuration Schema"] = 606,
    jsdoc = 531,
    ["k3d.yaml"] = 272,
    ["kontinuous-values.yaml"] = 276,
    ["kustomization.yaml"] = 277,
    ["label-commenter-config.yml"] = 278,
    ["launchsettings.json"] = 279,
    ["lego.json"] = 280,
    ["lerna.json"] = 281,
    ["lgtm.yml"] = 282,
    ["libman.json"] = 283,
    ["license-report-config.json"] = 284,
    ["linkinator.config.json"] = 285,
    ["local.settings.json"] = 288,
    ["localazy.json"] = 289,
    ["lsdlschema.json"] = 290,
    ["markdown-lint-check"] = 569,
    mboats = 575,
    ["mimetypes.json"] = 297,
    ["mirrord-schema"] = 514,
    ["mta.yaml"] = 515,
    ["mtad.yaml"] = 516,
    ["mycode.json"] = 314,
    ["napari plugin manifest"] = 315,
    neoload = 526,
    ["nest-cli"] = 320,
    ["ninjs (News in JSON) 1.3"] = 319,
    ["ninjs (News in JSON) 2.0"] = 318,
    ["nlu.json"] = 321,
    ["nodemon.json"] = 323,
    ["noodl.schema.json"] = 574,
    now = 522,
    ["npm-badges"] = 326,
    ["nswag.json"] = 329,
    ntangle = 330,
    ["nuclei-template.yaml"] = 327,
    ["nuget-project.json"] = 328,
    ["ocelot.json"] = 332,
    ["omnisharp.json"] = 333,
    ["openapi.json"] = 334,
    ["openfin.json"] = 336,
    ["openrpc.json"] = 335,
    ["package.json"] = 347,
    ["package.manifest"] = 348,
    ["pattern.json"] = 351,
    ["petstore-v1.0"] = 616,
    pgap_yaml_input_reader = 350,
    ["plagiarize-me.yaml"] = 355,
    ["plagiarize.yaml"] = 354,
    ["portman.json"] = 356,
    ["prettierrc.json"] = 361,
    ["prisma.yml"] = 362,
    ["project-1.0.0-beta3.json"] = 364,
    ["project-1.0.0-beta4.json"] = 365,
    ["project-1.0.0-beta5.json"] = 366,
    ["project-1.0.0-beta6.json"] = 367,
    ["project-1.0.0-beta8.json"] = 368,
    ["project-1.0.0-rc1.json"] = 369,
    ["project-1.0.0-rc2.json"] = 370,
    ["project.json"] = 363,
    ["prometheus.json"] = 371,
    ["prometheus.rules.json"] = 372,
    ["proxies.json"] = 373,
    ["publiccode.yml"] = 374,
    ["pubspec.yaml"] = 375,
    ["pyrseas-0.8.json"] = 378,
    ["release drafter"] = 527,
    rustfmt = 394,
    ["sarif-1.0.0.json"] = 397,
    ["sarif-2.0.0.json"] = 398,
    ["sarif-2.1.0"] = 407,
    ["sarif-2.1.0-rtm.2"] = 399,
    ["sarif-2.1.0-rtm.3"] = 401,
    ["sarif-2.1.0-rtm.4"] = 403,
    ["sarif-2.1.0-rtm.5"] = 405,
    ["sarif-external-property-file-2.1.0"] = 408,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 400,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 402,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 404,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 406,
    ["schema.org - Action"] = 410,
    ["schema.org - ContactPoint"] = 411,
    ["schema.org - Place"] = 412,
    ["schema.org - Thing"] = 413,
    ["semantic-release"] = 415,
    ["servicehub.config.json"] = 503,
    ["servicehub.service.json"] = 502,
    ["settings.job"] = 417,
    ["sfdx-hardis configuration"] = 419,
    ["size-limit configuration"] = 421,
    ["skaffold.yaml"] = 567,
    ["skyuxconfig.json"] = 422,
    snapcraft = 423,
    ["stripe-app-local.json"] = 436,
    ["stripe-app.json"] = 435,
    swcrc = 554,
    taskcat = 523,
    ["template.json"] = 444,
    ["templatsources.json"] = 445,
    ["theme.json"] = 448,
    ["tizen_workspace.json"] = 449,
    tmLanguage = 450,
    tmuxinator = 511,
    ["trunk.yaml schema"] = 456,
    ["ts-force-config.json"] = 460,
    ["tsconfig.json"] = 457,
    ["tsd.json"] = 458,
    ["tsdrc.json"] = 459,
    ["tslint.json"] = 461,
    ...
    ["vega-lite.json"] = 474,
    ["vega.json"] = 473,
    ["venvironment-basic.yaml"] = 477,
    ["venvironment.yaml"] = 476,
    ["version.json"] = 478,
    ["vim-addon-info"] = 479,
    ["vs-2017.3.host.json"] = 481,
    ["vs-nesting.json"] = 482,
    ["vsls.json"] = 480,
    ["vss-extension.json"] = 486,
    ["webhint.io"] = 602,
    ["webjobpublishsettings.json"] = 492,
    ["webjobs-list.json"] = 491,
    ["xs-app.json"] = 519,
    ["xunit.runner.json"] = 501,
    yamllint = 542,
    zuul = 528,
    ["Žinoma"] = 536
  },
