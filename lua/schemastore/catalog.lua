...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 106,
    [".cryproj (generic)"] = 408,
    [".cryproj engine-5.2"] = 403,
    [".cryproj engine-5.3"] = 404,
    [".cryproj engine-5.4"] = 405,
    [".cryproj engine-5.5"] = 406,
    [".cryproj engine-dev"] = 407,
    [".csscomb.json"] = 108,
    [".csslintrc"] = 109,
    [".eslintrc"] = 145,
    [".esmrc.json"] = 138,
    ...
    [".mtaext"] = 414,
    [".nodehawkrc"] = 253,
    [".npmpackagejsonlintrc"] = 255,
    [".phraseapp.yml"] = 282,
    [".pmbot.yml"] = 275,
    [".postcssrc"] = 280,
    [".pre-commit-config.yml"] = 281,
    [".putout.json"] = 299,
    [".rehyperc"] = 304,
    [".remarkrc"] = 305,
    [".sprite files"] = 340,
    ...
    [".vsext"] = 384,
    [".yarnrc.yml"] = 446,
    ["<div>RIOTS' studio configuration"] = 387,
    ["API Builder"] = 443,
    ["AWS CDK cdk.json"] = 95,
    ...
    ["Azure Pipelines"] = 38,
    ["Azure Static Web Apps CLI configuration file"] = 342,
    ["Azure Static Web Apps configuration file"] = 341,
    ["Better Code Hub"] = 448,
    BizTalkServerApplicationSchema = 420,
    ...
    Goreleaser = 171,
    ["Goreleaser Pro"] = 172,
    ["Gradle Build Cache Node"] = 445,
    ["Gradle Enterprise"] = 444,
    ...
    ["JSON Feed"] = 208,
    ["JSON Resume"] = 307,
    ["JSON Schema Draft 2020-12"] = 399,
    ["JSON Schema Draft 4"] = 396,
    ["JSON Schema Draft 7"] = 397,
    ["JSON Schema Draft 8"] = 398,
    ...
    Liquibase = 460,
    Markdownlint = 463,
    ["MegaLinter configuration"] = 225,
    ["MegaLinter descriptor"] = 226,
    ["Meltano plugin discovery definition"] = 228,
    ["Meltano project definition"] = 227,
    ["Microsoft Band Web Tile"] = 229,
    ["Minecraft Data Pack Advancement"] = 231,
    ["Minecraft Data Pack Biome"] = 232,
    ["Minecraft Data Pack Configured Carver"] = 233,
    ["Minecraft Data Pack Dimension"] = 235,
    ["Minecraft Data Pack Dimension Type"] = 234,
    ["Minecraft Data Pack Item Modifier"] = 236,
    ["Minecraft Data Pack Loot Table"] = 237,
    ["Minecraft Data Pack Metadata"] = 238,
    ["Minecraft Data Pack Predicate"] = 239,
    ["Minecraft Data Pack Recipe"] = 240,
    ["Minecraft Data Pack Template Pool"] = 241,
    ["Minecraft Resourcepack Sounds"] = 242,
    ["Netin Diagnostic System Template"] = 467,
    ["Netlify config schema"] = 247,
    ["Nightwatch.js"] = 248,
    ["OSS Review Toolkit repository configuration"] = 269,
    Opctl = 416,
    ["OpenWeather Current Weather API"] = 452,
    ["OpenWeather Road Risk API"] = 451,
    ["Ory Hydra configuration"] = 190,
    ["Ory Keto configuration"] = 214,
    ["Ory Kratos configuration"] = 268,
    ["Ory Oathkeeper configuration"] = 260,
    ["Outblocks App configuration"] = 266,
    ["Outblocks database table"] = 267,
    ["Outblocks project configuration"] = 265,
    Packer = 272,
    ["Pipeline component"] = 461,
    ["PocketMine plugin.yml"] = 276,
    ["Pull Request Labeler"] = 298,
    Qodana = 475,
    ["RKE Cluster Configuration JSON Schema"] = 459,
    ["RKE Cluster Configuration YAML Schema"] = 458,
    Ray = 428,
    ["Read the Docs"] = 301,
    ["Red-DiscordBot Cog"] = 302,
    ["Red-DiscordBot Cog Repo"] = 303,
    Renovate = 308,
    RoadRunner = 309,
    SWADL = 351,
    ["Sapphire CLI Config"] = 310,
    ["SauceCTL Configuration"] = 464,
    ["Schema Catalog"] = 323,
    ["Scoop manifest"] = 328,
    ["Semgrep Rule"] = 329,
    ["Serverless Framework Configuration"] = 471,
    ["Settings.paf"] = 331,
    ["Shopware 6 Configuration"] = 472,
    ["Shopware CLI Extension Store Configuration"] = 473,
    ["Shopware CLI Project Store Configuration"] = 474,
    Solidarity = 336,
    ["Source Maps v3"] = 337,
    SpecIF = 338,
    ["Sponge Mixin configuration"] = 339,
    ["StackHawk Scanner Configuration"] = 470,
    ["StackHead CLI config"] = 343,
    ["StackHead module configuration"] = 344,
    ["StackHead project definition"] = 345,
    Stale = 346,
    ["Statamic Blueprint"] = 347,
    ["Stryker Mutator"] = 348,
    ["StyleCop Analyzers Configuration"] = 349,
    ["Swagger API 2.0"] = 352,
    ["Taskfile YAML Schema"] = 454,
    Taurus = 353,
    ["TestEnvironment.json"] = 358,
    ["Traefik v2"] = 360,
    ["Traefik v2 File Provider"] = 361,
    Tye = 476,
    ["UI5 Manifest"] = 373,
    ...
    ["Vela Pipeline Configuration"] = 377,
    Vercel = 83,
    ["Web App Manifest"] = 389,
    ["Web types"] = 392,
    WebExtensions = 388,
    ["Windows Package Manager Installer Manifest"] = 434,
    ...
    ["mtad.yaml"] = 413,
    ["mycode.json"] = 245,
    ["napari plugin manifest"] = 246,
    neoload = 422,
    ["nest-cli"] = 251,
    ["ninjs (News in JSON) 1.3"] = 250,
    ["ninjs (News in JSON) 2.0"] = 249,
    ["nlu.json"] = 252,
    ["nodemon.json"] = 254,
    ["noodl.schema.json"] = 468,
    now = 418,
    ["nswag.json"] = 258,
    ntangle = 259,
    ["nuclei-template.yaml"] = 256,
    ["nuget-project.json"] = 257,
    ["ocelot.json"] = 261,
    ["omnisharp.json"] = 262,
    ["openapi.json"] = 263,
    ["openfin.json"] = 264,
    ["package.json"] = 270,
    ["package.manifest"] = 271,
    ["pattern.json"] = 274,
    pgap_yaml_input_reader = 273,
    ["plagiarize-me.yaml"] = 278,
    ["plagiarize.yaml"] = 277,
    ["portman.json"] = 279,
    ["prettierrc.json"] = 283,
    ["prisma.yml"] = 284,
    ["project-1.0.0-beta3.json"] = 286,
    ["project-1.0.0-beta4.json"] = 287,
    ["project-1.0.0-beta5.json"] = 288,
    ["project-1.0.0-beta6.json"] = 289,
    ["project-1.0.0-beta8.json"] = 290,
    ["project-1.0.0-rc1.json"] = 291,
    ["project-1.0.0-rc2.json"] = 292,
    ["project.json"] = 285,
    ["prometheus.json"] = 293,
    ["prometheus.rules.json"] = 294,
    ["proxies.json"] = 295,
    ["publiccode.yml"] = 296,
    ["pubspec.yaml"] = 297,
    ["pyrseas-0.8.json"] = 300,
    ["release drafter"] = 423,
    ["sarif-1.0.0.json"] = 311,
    ["sarif-2.0.0.json"] = 312,
    ["sarif-2.1.0"] = 321,
    ["sarif-2.1.0-rtm.2"] = 313,
    ["sarif-2.1.0-rtm.3"] = 315,
    ["sarif-2.1.0-rtm.4"] = 317,
    ["sarif-2.1.0-rtm.5"] = 319,
    ["sarif-external-property-file-2.1.0"] = 322,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 314,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 316,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 318,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 320,
    ["schema.org - Action"] = 324,
    ["schema.org - ContactPoint"] = 325,
    ["schema.org - Place"] = 326,
    ["schema.org - Thing"] = 327,
    ["service.datadog.yaml"] = 213,
    ["servicehub.config.json"] = 402,
    ["servicehub.service.json"] = 401,
    ["settings.job"] = 330,
    ["sfdx-hardis configuration"] = 332,
    ["size-limit configuration"] = 333,
    ["skaffold.yaml"] = 462,
    ["skyuxconfig.json"] = 334,
    snapcraft = 335,
    swcrc = 450,
    taskcat = 419,
    ["template.json"] = 354,
    ["templatsources.json"] = 355,
    ["theme.json"] = 356,
    tmLanguage = 357,
    ["trunk.yaml schema"] = 362,
    ["ts-force-config.json"] = 366,
    ["tsconfig.json"] = 363,
    ["tsd.json"] = 364,
    ["tsdrc.json"] = 365,
    ["tslint.json"] = 367,
    ...
    ["version.json"] = 378,
    ["vim-addon-info"] = 379,
    ["vs-2017.3.host.json"] = 381,
    ["vs-nesting.json"] = 382,
    ["vsls.json"] = 380,
    ["vss-extension.json"] = 386,
    ["webjobpublishsettings.json"] = 391,
    ["webjobs-list.json"] = 390,
    ["xs-app.json"] = 415,
    ["xunit.runner.json"] = 400,
    yamllint = 438,
    zuul = 424,
    ["Žinoma"] = 432
  },
