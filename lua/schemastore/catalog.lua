...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 201,
    [".cryproj (generic)"] = 677,
    [".cryproj engine-5.2"] = 672,
    [".cryproj engine-5.3"] = 673,
    [".cryproj engine-5.4"] = 674,
    [".cryproj engine-5.5"] = 675,
    [".cryproj engine-dev"] = 676,
    [".eslintrc"] = 258,
    [".esmrc.json"] = 249,
    [".ffizer.yaml"] = 262,
    [".htmlhintrc"] = 319,
    ...
    [".mtaext"] = 688,
    [".nodehawkrc"] = 431,
    [".npmpackagejsonlintrc"] = 435,
    [".omletrc"] = 863,
    [".phrase.yml"] = 481,
    [".phraseapp.yml"] = 482,
    [".pmbot.yml"] = 471,
    [".postcssrc"] = 476,
    [".powerpages-web-template-manifest"] = 478,
    [".pre-commit-config.yml"] = 479,
    [".pre-commit-hooks.yml"] = 480,
    [".putout.json"] = 501,
    [".rehyperc"] = 520,
    [".remarkrc"] = 522,
    [".sprite files"] = 580,
    ...
    ["<div>RIOTS' studio configuration"] = 655,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 386,
    ABCSupplyPlan = 13,
    AIConfig = 14,
    ["API Builder"] = 720,
    ["AVA Configuration"] = 780,
    ...
    ["Adobe UXP Manifest"] = 845,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 15,
    ["Airplane task"] = 16,
    ["Alacritty Configuration"] = 752,
    ["All Contributors configuration file"] = 810,
    ...
    ["Azure Pipelines"] = 68,
    ["Azure Static Web Apps CLI configuration file"] = 583,
    ["Azure Static Web Apps configuration file"] = 582,
    ["BX CI"] = 106,
    ["Bashly (bashly.yml)"] = 814,
    ["Bashly Settings (bashly-settings.yml)"] = 815,
    ["Better Code Hub"] = 724,
    ["Better Scripts"] = 107,
    Bigconfig = 85,
    BizTalkServerApplicationSchema = 694,
    Bleep = 108,
    ...
    ["Butane Config"] = 765,
    ["CGS Custom Card Game (CardGameDef.json)"] = 850,
    ["CICS TS region tagging"] = 774,
    ["CICS TS resource import"] = 775,
    ["CICS TS resource model"] = 776,
    ["CICS TS resource overrides"] = 777,
    ["CMake Presets"] = 109,
    ["CNC Codes"] = 121,
    ["CSS Comb (.csscomb.json)"] = 203,
    ["CSS Lint (.csslintrc)"] = 204,
    ["CSpell (cspell.json)"] = 202,
    ...
    ["Citation File Format"] = 190,
    CityJSON = 118,
    ["Clawject config"] = 126,
    ["Cloud Foundry Application Manifest"] = 862,
    ["Code Climate"] = 155,
    CodeCV = 64,
    ...
    ["Configu .cfgu files"] = 867,
    ["Configu .configu file"] = 868,
    Conjure = 120,
    ["Container Structure Test"] = 707,
    Containerlab = 732,
    ["Crowdsec collection config"] = 197,
    ["Crowdsec parser config"] = 198,
    ["Crowdsec scenario config"] = 199,
    ["CumulusCI Config"] = 125,
    ["Custom Machinery Machine"] = 851,
    ["Custom Machinery Recipe"] = 852,
    ["Cycle Stack File"] = 128,
    ["DWP Exchange - catalogue entry"] = 244,
    ["DWP Exchange - gateway"] = 242,
    ["DWP Exchange - meta"] = 243,
    ["Dart Build Config (dart-build.json)"] = 205,
    ["Dart Test Config (dart-test.json)"] = 206,
    ["DashLord Configuration"] = 207,
    ["Data Contract Specification"] = 208,
    ["Data Product Specification"] = 209,
    ["DataYoga Connections"] = 129,
    ["DataYoga Job"] = 130,
    ["Databricks Asset Bundles"] = 831,
    ["Datadog Service Definition"] = 362,
    ["Datahub Ingestion Recipe"] = 781,
    ["Dein Config"] = 132,
    ["Deno Config (deno.json)"] = 215,
    ["Dependency cruiser"] = 133,
    ["Deployer Recipe"] = 218,
    ["Deta Spacefile"] = 134,
    ["Detekt Config (detekt.yml)"] = 219,
    ["Devbox Config"] = 135,
    ["Devbox Plugin"] = 136,
    Devfile = 241,
    ["Discord Webhook"] = 220,
    ["DocFx Config (docfx.json)"] = 223,
    ["Dolittle Artifacts"] = 224,
    ["Dolittle Bounded Context Configuration"] = 225,
    ["Dolittle Event Horizons Configuration"] = 226,
    ["Dolittle Resources Configuration"] = 227,
    ["Dolittle Server Configuration"] = 228,
    ["Dolittle Tenant Map Configuration"] = 230,
    ["Dolittle Tenants Configuration"] = 229,
    ["Dolittle Topology"] = 231,
    ...
    ["Drupal Routing"] = 148,
    ["Drupal Services"] = 150,
    ["Drush site aliases"] = 237,
    ["Dynamic Bash Aliases (.aliases)"] = 822,
    ["EAS config"] = 256,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 811,
    ["Elgato Stream Deck"] = 247,
    ["Embrace Config"] = 792,
    Endurica = 835,
    ["Enterprise Contract Policy Spec"] = 248,
    ["Erda Pipeline"] = 858,
    ["Erda Runtime"] = 859,
    ["Error pages"] = 252,
    Esquio = 250,
    ["Estuary Flow Catalog"] = 771,
    ["Expo SDK"] = 255,
    ["F-Droid Data metadata"] = 261,
    ["Facets - FSDL - Application"] = 259,
    ["FasterCI Configuration"] = 69,
    FiQuS = 265,
    Firebase = 263,
    ["Flow.json Configurations"] = 855,
    ["Fossa configuration file"] = 272,
    ["Fossa's fossa-deps file"] = 273,
    ["Foundry VTT - Base package Manifest"] = 267,
    ["Foundry VTT - Module Manifest"] = 268,
    ["Foundry VTT - System Data Template"] = 271,
    ["Foundry VTT - System Manifest"] = 269,
    ["Foundry VTT - World Manifest"] = 270,
    ["Foxx Manifest"] = 70,
    ["Freifunk.de Community API"] = 73,
    ["Frogbot Config"] = 74,
    ["G2P Mapping Configuration"] = 277,
    ["GCP Blueprint Metadata"] = 280,
    Gaspar = 278,
    ["GatewayCore API Gateway"] = 279,
    ["GeoJSON.json latest"] = 769,
    GherKing = 773,
    ["GitHub Action"] = 285,
    ["GitHub Discussion"] = 286,
    ["GitHub Funding"] = 287,
    ["GitHub Issue Template configuration"] = 289,
    ["GitHub Issue Template forms"] = 288,
    ["GitHub Workflow"] = 290,
    ["GitHub Workflow Template Properties"] = 291,
    ["GitHub automatically generated release notes configuration"] = 292,
    ["GitLab Agent for Kubernetes configuration"] = 847,
    GitVersion = 282,
    ["Gitea Issue Template configuration"] = 283,
    ["Gitea Issue Template forms"] = 284,
    ["Gitpod Configuration"] = 294,
    ["GlazeWM settings"] = 849,
    ["Global Privacy Control"] = 281,
    Goblet = 830,
    ["Golangci-lint Configuration"] = 296,
    ["Golangci-lint Custom Plugins Configuration"] = 297,
    ["Google Chrome Related Website Sets"] = 264,
    ["Google Cloud Workflows"] = 184,
    Goreleaser = 299,
    ["Goreleaser Pro"] = 300,
    Goss = 301,
    ["Gradle Build Cache Node"] = 722,
    ["Gradle Enterprise"] = 721,
    ["Grafana 5.x Dashboard"] = 302,
    ["GraphQL Code Generator"] = 306,
    ["GraphQL Config"] = 305,
    ["GraphQL Mesh"] = 304,
    ["Grunt JSHint task"] = 310,
    ["Grunt Watch task"] = 311,
    ["Grunt base task"] = 312,
    ["Grunt clean task"] = 308,
    ["Grunt copy task"] = 307,
    ["Grunt cssmin task"] = 309,
    HEMTT = 691,
    Hadolint = 703,
    Hammerkit = 731,
    ["Hardware Sentry Configuration"] = 785,
    Hatch = 704,
    Hayson = 314,
    ["Haystack Pipeline"] = 315,
    ["Hazelcast 5 Configuration"] = 316,
    ["Helm Chart.lock"] = 152,
    ["Helm Chart.yaml"] = 151,
    ["Helm Unittest Test Suite"] = 153,
    Hugo = 761,
    ["Hugo Theme"] = 760,
    ["Hyperfoil benchmark configuration"] = 321,
    ["IBM Zapp document"] = 322,
    ["IBM zCodeFormatSettings"] = 323,
    ["IMG Catapult PSP"] = 328,
    ["IVMS101 by CODE Protocol"] = 848,
    Infrahub = 330,
    Istanbul = 788,
    ["JDownloader2 crawler multi-rules"] = 339,
    ["JDownloader2 crawler single-rules"] = 338,
    ["JFrog Applications Config"] = 340,
    ["JFrog File Spec"] = 341,
    ["JFrog Pipelines YML DSL"] = 794,
    ["JMeter DSL cli config"] = 342,
    JReleaser = 344,
    ["JSON Document Transform"] = 352,
    ["JSON Feed"] = 353,
    ["JSON Resume"] = 527,
    ["JSON Schema Draft 2020-12"] = 668,
    ["JSON Schema Draft 4"] = 665,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 832,
    ["JSON Schema Draft 7"] = 666,
    ["JSON Schema Draft 7 (unofficial strict)"] = 833,
    ["JSON Schema Draft 8 (2019-09)"] = 667,
    ["JSON-API"] = 351,
    ["JSON-WF"] = 861,
    ["JSON-e templates"] = 729,
    ["JSON-stat 2.0"] = 662,
    JSONPatch = 355,
    ["JSR Package Config (jsr.json)"] = 345,
    Jasmine = 334,
    Jekyll = 335,
    ["Jenkins X Pipelines"] = 336,
    ["Jenkins X Requirements"] = 337,
    ["Jovo Language Models"] = 343,
    ["KIMMDY config file"] = 360,
    ["KSP-AVC"] = 663,
    ["KSP-CKAN"] = 664,
    KSY = 860,
    ["Karakum configuration file"] = 274,
    Kas = 358,
    ["Keycloak REST API"] = 802,
    ["Knative Functions - func.yaml"] = 275,
    ["KoDE/CI build.yaml"] = 790,
    ["Kong DBLess config"] = 791,
    KrakenD = 361,
    ["Kubri Configuration"] = 366,
    LOOBin = 381,
    Lefthook = 370,
    ["Liferay client-extension.yaml"] = 377,
    ["LinkML Metamodel"] = 379,
    Liquibase = 737,
    ["Liquibase Flow File"] = 738,
    ["Lively Properties"] = 380,
    ["Lobe AI Agent"] = 66,
    Loki = 67,
    ["MLOS Configs"] = 415,
    ["MS2Rescore Configuration"] = 418,
    ["Madness (madness.yml)"] = 813,
    Markdownlint = 741,
    ["Mason Registry"] = 743,
    ["MegaLinter configuration"] = 387,
    ["MegaLinter descriptor"] = 388,
    Melange = 839,
    ["Meltano plugin discovery definition"] = 390,
    ["Meltano project definition"] = 389,
    ["Mergify Configuration"] = 419,
    ["MetricsHub Configuration"] = 391,
    ["MetricsHub Connector Configuration"] = 392,
    ["Micro Editor Syntax"] = 823,
    ["Microsoft Band Web Tile"] = 393,
    ["Minecraft Custom Main Menu Mod"] = 840,
    ["Minecraft Data Pack Advancement"] = 395,
    ["Minecraft Data Pack Biome"] = 396,
    ["Minecraft Data Pack Configured Carver"] = 397,
    ["Minecraft Data Pack Damage Type"] = 398,
    ["Minecraft Data Pack Dimension"] = 400,
    ["Minecraft Data Pack Dimension Type"] = 399,
    ["Minecraft Data Pack Item Modifier"] = 401,
    ["Minecraft Data Pack Loot Table"] = 402,
    ["Minecraft Data Pack Metadata"] = 403,
    ["Minecraft Data Pack Predicate"] = 404,
    ["Minecraft Data Pack Recipe"] = 405,
    ["Minecraft Data Pack Tag"] = 406,
    ["Minecraft Data Pack Template Pool"] = 407,
    ["Minecraft Data Pack Trim Material"] = 412,
    ["Minecraft Data Pack Trim Pattern"] = 413,
    ["Minecraft Resource Pack Lang"] = 408,
    ["Minecraft Resource Pack Particle"] = 409,
    ["Minecraft Resource Pack Texture Mcmeta"] = 411,
    ["Minecraft Resourcepack Sounds"] = 410,
    ["MkDocs Configuration 1.0"] = 414,
    ["Monade CLI Stack Configuration"] = 422,
    ["MongoDB Atlas Search Index Definition"] = 789,
    ["Monika Configuration"] = 787,
    ["Monoweave Configuration"] = 417,
    ["Motif config"] = 687,
    ["NOX Framework (Service)"] = 434,
    ["Netin Diagnostic System Template"] = 747,
    ["Netlify config"] = 425,
    ["Network-as-Code Data Model"] = 426,
    ["Nightwatch.js"] = 427,
    ["Nuitka.yaml"] = 853,
    ["ONe's changelog entry"] = 450,
    ["ONe's service descriptor"] = 449,
    ["OSS Review Toolkit configuration"] = 457,
    ["OSS Review Toolkit curation"] = 458,
    ["OSS Review Toolkit package configuration"] = 459,
    ["OSS Review Toolkit repository configuration"] = 460,
    ["OSS Review Toolkit resolutions"] = 461,
    Opctl = 690,
    ["OpenRewrite Resource"] = 452,
    ["OpenUtau character yaml"] = 446,
    ["OpenUtau ustx"] = 447,
    ["OpenWeather Current Weather API"] = 728,
    ["OpenWeather Road Risk API"] = 727,
    ["Ory Hydra configuration"] = 320,
    ["Ory Keto configuration"] = 363,
    ["Ory Kratos configuration"] = 456,
    ["Ory Oathkeeper configuration"] = 441,
    ["Outblocks App configuration"] = 454,
    ["Outblocks database table"] = 455,
    ["Outblocks project configuration"] = 453,
    PDM = 467,
    Packer = 464,
    Pantsbuild = 809,
    ["Paper paper-plugin.yml"] = 465,
    ["Pipeline component"] = 739,
    ["PocketMine plugin.yml"] = 472,
    ["Postman collection"] = 477,
    ["Problem object RFC9457"] = 837,
    ["Problem package generators"] = 485,
    Pterodactyl = 784,
    ["Pull Request Labeler"] = 500,
    Pulumi = 506,
    PyProject = 507,
    Pyright = 508,
    Qgoda = 509,
    Qodana = 757,
    ["Qt Creator workspace file"] = 869,
    ["Quali Torque Blueprint Spec 2"] = 782,
    ["QueryFirst config file"] = 805,
    ["RKE Cluster Configuration JSON"] = 736,
    ["RKE Cluster Configuration YAML"] = 735,
    ["Rancher Fleet"] = 503,
    ["Rattler-build"] = 510,
    Ray = 702,
    ["Read the Docs"] = 505,
    ["Red-DiscordBot Cog"] = 517,
    ["Red-DiscordBot Cog Repo"] = 518,
    ["Red-DiscordBot Trivia"] = 519,
    ["Render Blueprints"] = 734,
    RenderCV = 529,
    Renovate = 528,
    ["Replit config"] = 523,
    RoadRunner = 530,
    ["Rudder techniques"] = 843,
    Ruff = 525,
    ["Rust Project"] = 526,
    ["Rust toolchain"] = 533,
    ["SDMX data message"] = 558,
    ["SDMX metadata message"] = 557,
    ["SDMX structure message"] = 556,
    ["SIL Kit Participant Configuration"] = 568,
    ["SIL Kit Registry Configuration"] = 569,
    SWADL = 594,
    ["Safebox Config"] = 795,
    ["Sapphire CLI Config"] = 536,
    ["SauceCTL Configuration"] = 744,
    ["Schema Catalog"] = 550,
    ["Scoop manifest"] = 555,
    ["Semantic Data Fabric (SDF) file"] = 559,
    ["Semgrep Rule"] = 561,
    ["Serenity Code Generator (Sergen)"] = 562,
    ["Serverless Framework Configuration"] = 751,
    ["Serverless Workflow"] = 753,
    ["Settings.paf"] = 564,
    ["Shopware 6 Configuration"] = 754,
    ["Shopware CLI Extension Store Configuration"] = 755,
    ["Shopware CLI Project Store Configuration"] = 756,
    Sigma = 566,
    ["Sigrid scope configuration file"] = 567,
    ["SkyPilot Task JSON"] = 844,
    ["Slack app manifest"] = 571,
    Solidarity = 574,
    ["Solution filters"] = 575,
    ["Source Maps v3"] = 576,
    Sourcery = 577,
    SpecIF = 578,
    ["Sponge Mixin configuration"] = 579,
    StackBlitz = 584,
    ["StackHawk Scanner Configuration"] = 750,
    Stale = 585,
    ["Starlake Data Pipeline"] = 725,
    Starship = 586,
    ["Statamic Blueprint"] = 587,
    ["Stella configuration file"] = 588,
    ["StrmPrivacy Data Connector"] = 799,
    ["StrmPrivacy Data Contract"] = 800,
    ["StrmPrivacy SimpleSchema"] = 797,
    ["StrmPrivacy Stream"] = 798,
    ["StrmPrivacy batch job configuration file"] = 796,
    ["Stryker Mutator"] = 591,
    ["StyleCop Analyzers Configuration"] = 592,
    ["Stylelint (.stylelintrc)"] = 593,
    ["Sublime Syntax"] = 801,
    ["Subsquid squid manifest"] = 846,
    ["Swagger API 2.0"] = 595,
    TSON = 621,
    TSTyche = 622,
    Talhelper = 597,
    ["Talisman configuration"] = 598,
    ["Taskfile config"] = 730,
    Taurus = 599,
    ["TestEnvironment.json"] = 608,
    ["TextMate Grammar"] = 607,
    ["Tier.run pricing.json"] = 602,
    Tikibase = 603,
    ["Traefik v2"] = 611,
    ["Traefik v2 File Provider"] = 612,
    ["Travis CI (.travis.yml)"] = 610,
    TunnelHub = 836,
    Turborepo = 609,
    Tye = 758,
    ["UET BuildConfig.json"] = 806,
    ["UI5 Manifest"] = 631,
    ["UNCORS configuration"] = 635,
    ["UTAM Page Object"] = 634,
    ["Ubuntu Server Autoinstall"] = 629,
    ["Uniswap Token List"] = 713,
    ["Unreal Engine Uplugin"] = 807,
    ["Unreal Engine Uproject"] = 808,
    ["Updatecli Compose"] = 766,
    ["Updatecli Policy Manifest"] = 767,
    ["Updatecli Policy Metadata"] = 768,
    Uplift = 804,
    ["User Journey Map"] = 733,
    V2Ray = 772,
    ["VSCode Code Snippets"] = 172,
    ["VSIX CLI publishing"] = 650,
    ["Vela Pipeline Configuration"] = 639,
    Vercel = 171,
    Visivo = 834,
    ["Web App Manifest"] = 657,
    ["Web types"] = 660,
    WebExtensions = 656,
    ["Webman package recipe"] = 778,
    ["Windows Package Manager Installer Manifest"] = 710,
    ["Windows Package Manager Locale Manifest"] = 711,
    ["Windows Package Manager Singleton Manifest"] = 709,
    ["Woodpecker pipeline config"] = 746,
    ["Wrangler CLI"] = 661,
    ["Xstate Machine"] = 764,
    ["Yarn Config (.yarnrc.yml)"] = 723,
    ["Yippee-Ki-JSON configuration YML"] = 715,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 838,
    ...
    ["behat.yml"] = 92,
    ["bigquery-table"] = 84,
    ["bioimageio resource description"] = 854,
    ...
    changelogging = 866,
    ["chisel-slices.json"] = 189,
    ["chrome-extension-locales-messages.json"] = 179,
    ["chutzpah.json"] = 180,
    cibuildwheel = 117,
    ["clang-format (.clang-format)"] = 770,
    ["clang-tidy"] = 159,
    clangd = 158,
    clib = 160,
    ...
    ["coffeelint.json"] = 191,
    ["commands.json"] = 175,
    ["commitlint (.commitlintrc)"] = 712,
    ["compile_commands.json"] = 174,
    ["compilerconfig.json"] = 173,
    ["completely.yml"] = 812,
    ["component-detection-manifest.json"] = 194,
    ["component.json"] = 193,
    ["composer.json"] = 192,
    ["conda-forge"] = 119,
    ["config.yaml"] = 504,
    ...
    ["crowdin.yml"] = 196,
    ["custom-elements.json"] = 826,
    ["cypress.json"] = 200,
    ["datalogic-scan2deploy-android"] = 210,
    ["datalogic-scan2deploy-ce"] = 211,
    ["dbt Project"] = 131,
    ["ddev-global"] = 212,
    ["ddev-project"] = 213,
    ["debugsettings.json"] = 214,
    ["dependabot-v2.json"] = 217,
    ["dependabot.json"] = 216,
    ["deployed-cli"] = 763,
    ...
    ["devspace.yaml"] = 786,
    djlint = 718,
    ["docker sequencer"] = 222,
    ["docker-compose.yml"] = 716,
    ["dockerd.json"] = 221,
    ["dotnet Release Index manifest"] = 232,
    ["dotnet-tools.json"] = 233,
    ["dotnetcli.host.json"] = 234,
    ["dprint.json"] = 235,
    ["drone.json"] = 236,
    ["dss-2.0.0.json"] = 238,
    ["dstack configuration"] = 239,
    ["dvc.yaml"] = 240,
    ["ecosystem.json"] = 245,
    eksctl = 246,
    ["electron-builder configuration file"] = 253,
    ["epr-manifest.json"] = 251,
    ["evcc.yaml"] = 254,
    ["ezd task runner"] = 257,
    ["fabric.mod.json"] = 260,
    ["first-timers-bot"] = 266,
    ...
    ["gitlab-ci"] = 293,
    ["global.json"] = 295,
    ["go-feature-flag Flag Configuration"] = 298,
    ["haxelib.json"] = 313,
    helmfile = 705,
    helmwave = 706,
    ["host-meta.json"] = 318,
    ...
    ["ide.host.json"] = 324,
    ["ifstate.conf"] = 325,
    ["imageoptimizer.json"] = 326,
    ["importmap.json"] = 329,
    ["ioBroker Configuration"] = 331,
    ["ioBroker JSON UI"] = 332,
    ["ioBroker Package manifest"] = 333,
    ["ize.toml"] = 803,
    ["jsconfig.json"] = 356,
    ["jscpd Configuration"] = 783,
    jsdoc = 701,
    ["k3d.yaml"] = 357,
    ["k9s plugin.yml"] = 359,
    ["kontinuous-config.yaml"] = 365,
    ["kontinuous-values.yaml"] = 364,
    ["kustomization.yaml"] = 367,
    ["label-commenter-config.yml"] = 368,
    ["latexindent configuration"] = 65,
    ["launchsettings.json"] = 369,
    lazydocker = 825,
    lazygit = 824,
    ["lego.json"] = 371,
    ["lerna.json"] = 372,
    ["lgtm.yml"] = 373,
    ["liblab.config.json"] = 374,
    ["libman.json"] = 375,
    ["license-report-config.json"] = 376,
    ["linkinator.config.json"] = 378,
    ["lint-staged (.lintstagedrc)"] = 681,
    ["local.settings.json"] = 383,
    ["localazy.json"] = 384,
    ["lotus.yaml"] = 382,
    ["lsdlschema.json"] = 385,
    ["markdown-link-check"] = 742,
    mboats = 749,
    ["micro-settings.json"] = 818,
    ["mimetypes.json"] = 394,
    ["mirrord config"] = 682,
    mise = 683,
    ["mise-settings"] = 684,
    ...
    ["mtad.yaml"] = 686,
    ["mycode.json"] = 423,
    ["napari plugin manifest"] = 424,
    neoload = 696,
    ["nest-cli"] = 429,
    ["ninjs (News in JSON)"] = 428,
    ["nixd configuration"] = 842,
    ["nlu.json"] = 430,
    ["nodemon.json"] = 432,
    ["noodl config"] = 748,
    ["notebook.mod.json"] = 433,
    now = 692,
    ["npm-badges"] = 436,
    ["nswag.json"] = 439,
    ntangle = 440,
    ["nuclei-template.yaml"] = 437,
    ["nuget-project.json"] = 438,
    ["ocelot.json"] = 442,
    ["omnisharp.json"] = 443,
    ["openapi.json"] = 444,
    ["openfin.json"] = 451,
    ...
    ["ops.yaml"] = 448,
    ["package.json"] = 462,
    ["package.manifest"] = 463,
    ["partial-black.json"] = 93,
    ["pathfinder.yml"] = 466,
    ["pattern.json"] = 469,
    ["petstore-v1.0"] = 793,
    pgap_yaml_input_reader = 468,
    ["pixi.toml"] = 470,
    ["plagiarize-me.yaml"] = 474,
    ["plagiarize.yaml"] = 473,
    ["portman.json"] = 475,
    ["prettierrc.json"] = 483,
    ["prisma.yml"] = 484,
    ["project-1.0.0-beta3.json"] = 487,
    ["project-1.0.0-beta4.json"] = 488,
    ["project-1.0.0-beta5.json"] = 489,
    ["project-1.0.0-beta6.json"] = 490,
    ["project-1.0.0-beta8.json"] = 491,
    ["project-1.0.0-rc1.json"] = 492,
    ["project-1.0.0-rc2.json"] = 493,
    ["project.json"] = 486,
    ["prometheus.json"] = 494,
    ["prometheus.rules.json"] = 495,
    ["prometheus.rules.test.json"] = 496,
    ["proxies.json"] = 497,
    ["publiccode.yml"] = 498,
    ["pubspec.yaml"] = 499,
    ["pyrseas-0.8.json"] = 502,
    ["quilt.mod.json"] = 819,
    ["rc3 auth"] = 511,
    ["rc3 collection"] = 512,
    ["rc3 environment"] = 513,
    ...
    ["rc3 settings"] = 516,
    ["release drafter"] = 697,
    ["release-plz.toml"] = 521,
    ["rivet.yaml"] = 841,
    rockcraft = 531,
    rustfmt = 532,
    samt = 534,
    samtrc = 535,
    ["sarif-1.0.0.json"] = 537,
    ["sarif-2.0.0.json"] = 538,
    ["sarif-2.1.0"] = 548,
    ["sarif-2.1.0-rtm.2"] = 539,
    ["sarif-2.1.0-rtm.3"] = 541,
    ["sarif-2.1.0-rtm.4"] = 543,
    ["sarif-2.1.0-rtm.5"] = 545,
    ["sarif-2.1.0-rtm.6"] = 546,
    ["sarif-external-property-file-2.1.0"] = 549,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 540,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 542,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 544,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 547,
    ["schema.org - Action"] = 551,
    ["schema.org - ContactPoint"] = 552,
    ["schema.org - Place"] = 553,
    ["schema.org - Thing"] = 554,
    ["secrethub.yml"] = 821,
    ["semantic-release"] = 560,
    ["servicehub.config.json"] = 671,
    ["servicehub.service.json"] = 670,
    ["settings.job"] = 563,
    ["sfdx-hardis configuration"] = 565,
    ["shard.yml"] = 857,
    ["size-limit configuration"] = 570,
    ["skaffold.yaml"] = 740,
    ["skyuxconfig.json"] = 572,
    snapcraft = 573,
    ["sqlc configuration"] = 581,
    ["stripe-app-local.json"] = 590,
    ["stripe-app.json"] = 589,
    swcrc = 726,
    ["task.json"] = 596,
    taskcat = 693,
    ["template.json"] = 600,
    ["templatsources.json"] = 601,
    ["theme.json"] = 604,
    ["tizen_workspace.json"] = 605,
    tldr = 606,
    tmuxinator = 679,
    ["transcend.yml"] = 613,
    ["tree-sitter grammar.json"] = 303,
    ["trime.yaml"] = 614,
    ["trunk.yaml"] = 615,
    ["ts-force-config.json"] = 619,
    ["tsconfig.json"] = 616,
    ["tsd.json"] = 617,
    ["tsdrc.json"] = 618,
    ["tslint.json"] = 620,
    ...
    ["vega-lite.json"] = 638,
    ["vega.json"] = 637,
    ["venvironment-basic.yaml"] = 641,
    ["venvironment.yaml"] = 640,
    ["version.json"] = 642,
    ["vim-addon-info"] = 644,
    ["vs-2017.3.host.json"] = 646,
    ["vs-nesting.json"] = 647,
    ["vsls.json"] = 645,
    ["vss-extension.json"] = 651,
    ["vtesttree.yaml"] = 652,
    ["vtestunit.yaml"] = 653,
    ["warp-keysets.json"] = 827,
    ["warp-themes.json"] = 828,
    ["warp-workflows.json"] = 829,
    ["webhint.io"] = 779,
    ["webjobpublishsettings.json"] = 659,
    ["webjobs-list.json"] = 658,
    ["well-known-fursona"] = 865,
    ["xs-app.json"] = 689,
    ["xunit.runner.json"] = 669,
    yamllint = 714,
    zuul = 698,
    ["Žinoma"] = 708
  },
