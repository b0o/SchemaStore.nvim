...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 153,
    [".cryproj (generic)"] = 515,
    [".cryproj engine-5.2"] = 510,
    [".cryproj engine-5.3"] = 511,
    [".cryproj engine-5.4"] = 512,
    [".cryproj engine-5.5"] = 513,
    [".cryproj engine-dev"] = 514,
    [".csscomb.json"] = 155,
    [".csslintrc"] = 156,
    [".eslintrc"] = 201,
    [".esmrc.json"] = 193,
    ...
    [".mtaext"] = 524,
    [".nodehawkrc"] = 325,
    [".npmpackagejsonlintrc"] = 328,
    [".phraseapp.yml"] = 363,
    [".pmbot.yml"] = 355,
    [".postcssrc"] = 360,
    [".pre-commit-config.yml"] = 361,
    [".pre-commit-hooks.yml"] = 362,
    [".putout.json"] = 380,
    [".rehyperc"] = 388,
    [".remarkrc"] = 389,
    [".sprite files"] = 434,
    ...
    [".vsext"] = 490,
    [".yarnrc.yml"] = 556,
    ["<div>RIOTS' studio configuration"] = 494,
    ["@factorial/drupal-breakpoints-css"] = 5,
    ["A micro editor config schema"] = 293,
    ["API Builder"] = 553,
    ["AVA Configuration Schema"] = 609,
    ["AWS CDK cdk.json"] = 141,
    ["AWS CloudFormation"] = 142,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 143,
    ["Airlock Microgateway"] = 9,
    ["Airplane task"] = 10,
    ["Alacritty Configuration Schema"] = 584,
    ["All Contributors configuration file"] = 636,
    ...
    ["Azure Pipelines"] = 48,
    ["Azure Static Web Apps CLI configuration file"] = 436,
    ["Azure Static Web Apps configuration file"] = 435,
    ["BX CI"] = 83,
    ["Better Code Hub"] = 558,
    ["Better Scripts"] = 84,
    BizTalkServerApplicationSchema = 530,
    ...
    ["Butane Config"] = 596,
    ["CICS TS region tagging"] = 603,
    ["CICS TS resource import"] = 604,
    ["CICS TS resource model"] = 605,
    ["CICS TS resource overrides"] = 606,
    ["CMake Presets"] = 85,
    ...
    Cheatsheets = 593,
    ["Chrome Extension"] = 135,
    ["CircleCI config.yml"] = 116,
    ["Citation File Format"] = 144,
    CityJSON = 92,
    ["Code Climate"] = 117,
    CodeCV = 47,
    Codux = 124,
    ...
    ["Common Catalog Schema"] = 133,
    ["Common types for all schemas"] = 1,
    Conjure = 93,
    ["Container Structure Test"] = 541,
    Containerlab = 566,
    ["DWP Exchange - catalogue entry"] = 190,
    ["DWP Exchange - gateway"] = 188,
    ["DWP Exchange - meta"] = 189,
    ["Dart build configuration"] = 157,
    ["Dart test config"] = 158,
    ["DashLord configuration"] = 159,
    ["Datadog Service Definition"] = 276,
    ["Datahub Ingestion Recipe Schema"] = 610,
    ["Dein Config Schema"] = 99,
    Deno = 163,
    ["Deployer Recipe"] = 166,
    Devfile = 187,
    ["Discord Webhook"] = 168,
    ["Dolittle Artifacts"] = 172,
    ["Dolittle Bounded Context Configuration"] = 173,
    ["Dolittle Event Horizons Configuration"] = 174,
    ["Dolittle Resources Configuration"] = 175,
    ["Dolittle Server Configuration"] = 176,
    ["Dolittle Tenant Map Configuration"] = 178,
    ["Dolittle Tenants Configuration"] = 177,
    ["Dolittle Topology"] = 179,
    ...
    ["Drush site aliases"] = 183,
    ["Embrace Config Schema"] = 621,
    ["Error pages"] = 196,
    Esquio = 194,
    ["Estuary Flow Catalog Schema"] = 600,
    ["Expo SDK"] = 199,
    ["F-Droid Data metadata"] = 204,
    ["Facets - FSDL - Application"] = 202,
    ["FasterCI Configuration"] = 49,
    ["Fossa configuration file"] = 209,
    ["Fossa's fossa-deps file"] = 210,
    ["Foundry VTT - Manifest"] = 207,
    ["Foundry VTT - Template"] = 208,
    ["Foxx Manifest"] = 50,
    ["Freifunk.de Community API"] = 53,
    ["Frogbot Config"] = 54,
    ["GatewayCore API Gateway"] = 213,
    ["GeoJSON.json latest"] = 598,
    GherKing = 602,
    ["GitHub Action"] = 217,
    ["GitHub Funding"] = 218,
    ["GitHub Issue Template configuration"] = 220,
    ["GitHub Workflow"] = 221,
    ["GitHub Workflow Template Properties"] = 222,
    ["GitHub issue forms"] = 219,
    GitVersion = 216,
    ["Gitpod Configuration"] = 224,
    ["Global Privacy Control"] = 214,
    ["Google Cloud Workflows"] = 140,
    Goreleaser = 227,
    ["Goreleaser Pro"] = 228,
    ["Gradle Build Cache Node"] = 555,
    ["Gradle Enterprise"] = 554,
    ["Grafana 5.x Dashboard"] = 229,
    ["GraphQL Code Generator"] = 232,
    ["GraphQL Config"] = 231,
    ["GraphQL Mesh"] = 230,
    ["Grunt JSHint task"] = 236,
    ["Grunt Watch task"] = 237,
    ["Grunt base task"] = 238,
    ["Grunt clean task"] = 234,
    ["Grunt copy task"] = 233,
    ["Grunt cssmin task"] = 235,
    HEMTT = 527,
    Hadolint = 539,
    Hammerkit = 565,
    ["Hardware Sentry Configuration"] = 614,
    Hayson = 240,
    ["Haystack Pipeline"] = 241,
    ["Hazelcast 5 Configuration"] = 242,
    ["Helm Chart.lock"] = 114,
    ["Helm Chart.yaml"] = 113,
    ["Helm Unittest Test Suite"] = 115,
    Hugo = 592,
    ["Istanbul Schema"] = 617,
    ["JDownloader2 crawler multi-rule schema"] = 259,
    ["JDownloader2 crawler single-rule schema"] = 258,
    ["JFrog File Spec"] = 260,
    ["JFrog Pipelines YML DSL"] = 623,
    ["JMeter DSL cli config schema"] = 261,
    ["JSON Document Transform"] = 269,
    ["JSON Feed"] = 270,
    ["JSON Resume"] = 394,
    ["JSON Schema Draft 2020-12"] = 506,
    ["JSON Schema Draft 4"] = 503,
    ["JSON Schema Draft 7"] = 504,
    ["JSON Schema Draft 8"] = 505,
    ["JSON schema for CodeShip Pro services configuration files"] = 126,
    ["JSON schema for CodeShip Pro steps configuration files"] = 127,
    ["JSON schema for Codecov configuration files"] = 125,
    ["JSON-API"] = 268,
    ["JSON-e templates"] = 563,
    ["JSON-stat 2.0"] = 500,
    JSONPatch = 272,
    Jasmine = 254,
    Jekyll = 255,
    ["Jenkins X Pipelines"] = 256,
    ["Jenkins X Requirements"] = 257,
    ["Jovo Language Models"] = 262,
    ["KSP-AVC"] = 501,
    ["KSP-CKAN"] = 502,
    ["Keycloak REST API"] = 629,
    ["Knative Functions - func.yaml"] = 211,
    ["KoDE/CI build.yaml"] = 619,
    ["Kong DBLess Schema"] = 620,
    KrakenD = 275,
    ["LinkML Metamodel"] = 288,
    Liquibase = 570,
    ["Liquibase Flow File"] = 571,
    ["Lively Properties"] = 289,
    Markdownlint = 574,
    ["MegaLinter configuration"] = 294,
    ["MegaLinter descriptor"] = 295,
    ["Meltano plugin discovery definition"] = 297,
    ["Meltano project definition"] = 296,
    ["Microsoft Band Web Tile"] = 298,
    ["Minecraft Data Pack Advancement"] = 300,
    ["Minecraft Data Pack Biome"] = 301,
    ["Minecraft Data Pack Configured Carver"] = 302,
    ["Minecraft Data Pack Damage Type"] = 303,
    ["Minecraft Data Pack Dimension"] = 305,
    ["Minecraft Data Pack Dimension Type"] = 304,
    ["Minecraft Data Pack Item Modifier"] = 306,
    ["Minecraft Data Pack Loot Table"] = 307,
    ["Minecraft Data Pack Metadata"] = 308,
    ["Minecraft Data Pack Predicate"] = 309,
    ["Minecraft Data Pack Recipe"] = 310,
    ["Minecraft Data Pack Tag"] = 311,
    ["Minecraft Data Pack Template Pool"] = 312,
    ["Minecraft Resourcepack Sounds"] = 313,
    ["MkDocs Configuration 1.0"] = 314,
    ["MongoDB Atlas Search Index Definition Schema"] = 618,
    ["Monika Configuration Schema"] = 616,
    ["Motif config"] = 523,
    ["NOX Framework (Service)"] = 327,
    ["Netin Diagnostic System Template"] = 579,
    ["Netlify config schema"] = 319,
    ["Nightwatch.js"] = 320,
    ["OSS Review Toolkit configuration"] = 345,
    ["OSS Review Toolkit curation"] = 346,
    ["OSS Review Toolkit package configuration"] = 347,
    ["OSS Review Toolkit repository configuration"] = 348,
    ["OSS Review Toolkit resolutions"] = 349,
    Opctl = 526,
    ["OpenRewrite Resource"] = 340,
    ["OpenWeather Current Weather API"] = 562,
    ["OpenWeather Road Risk API"] = 561,
    ["Ory Hydra configuration"] = 246,
    ["Ory Keto configuration"] = 277,
    ["Ory Kratos configuration"] = 344,
    ["Ory Oathkeeper configuration"] = 334,
    ["Outblocks App configuration"] = 342,
    ["Outblocks database table"] = 343,
    ["Outblocks project configuration"] = 341,
    Packer = 352,
    Pantsbuild = 635,
    ["Pipeline component"] = 572,
    ["PocketMine plugin.yml"] = 356,
    Pterodactyl = 613,
    ["Pull Request Labeler"] = 379,
    Pulumi = 384,
    PyProject = 385,
    Qodana = 589,
    ["Quali Torque Blueprint Spec 2"] = 611,
    ["QueryFirst config file"] = 632,
    ["RKE Cluster Configuration JSON Schema"] = 569,
    ["RKE Cluster Configuration YAML Schema"] = 568,
    ["Rancher Fleet"] = 382,
    Ray = 538,
    ["Read the Docs"] = 383,
    ["Red-DiscordBot Cog"] = 386,
    ["Red-DiscordBot Cog Repo"] = 387,
    Renovate = 395,
    ["Replit schema"] = 390,
    RoadRunner = 396,
    Ruff = 392,
    ["Rust Project"] = 393,
    ["Rust toolchain"] = 398,
    ["SIL Kit Participant Configuration"] = 424,
    SWADL = 445,
    ["Sapphire CLI Config"] = 399,
    ["SauceCTL Configuration"] = 576,
    ["Schema Catalog"] = 412,
    ["Scoop manifest"] = 417,
    ["Semgrep Rule"] = 419,
    ["Serenity Code Generator (Sergen)"] = 420,
    ["Serverless Framework Configuration"] = 583,
    ["Serverless Workflow Schema"] = 585,
    ["Settings.paf"] = 422,
    ["Shopware 6 Configuration"] = 586,
    ["Shopware CLI Extension Store Configuration"] = 587,
    ["Shopware CLI Project Store Configuration"] = 588,
    Solidarity = 428,
    ["Solution filters"] = 429,
    ["Source Maps v3"] = 430,
    Sourcery = 431,
    SpecIF = 432,
    ["Sponge Mixin configuration"] = 433,
    ["StackHawk Scanner Configuration"] = 582,
    Stale = 437,
    Starship = 438,
    ["Statamic Blueprint"] = 439,
    ["StrmPrivacy Data Connector"] = 627,
    ["StrmPrivacy Data Contract"] = 628,
    ["StrmPrivacy SimpleSchema"] = 625,
    ["StrmPrivacy Stream"] = 626,
    ["StrmPrivacy batch job configuration file"] = 624,
    ["Stryker Mutator"] = 442,
    ["StyleCop Analyzers Configuration"] = 443,
    ["Swagger API 2.0"] = 446,
    TSON = 468,
    ["Talisman configuration"] = 447,
    ["Taskfile YAML Schema"] = 564,
    Taurus = 448,
    ["TestEnvironment.json"] = 456,
    ["Tier.run pricing.json"] = 451,
    Tikibase = 452,
    ["Traefik v2"] = 459,
    ["Traefik v2 File Provider"] = 460,
    Turborepo = 457,
    Tye = 590,
    ["UI5 Manifest"] = 475,
    ["UTAM Page Object"] = 478,
    ["Ubuntu Server Autoinstall"] = 473,
    ["Uniswap Token List"] = 547,
    ["Unreal Engine Uplugin"] = 633,
    ["Unreal Engine Uproject"] = 634,
    Updatecli = 597,
    Uplift = 631,
    ["User Journey Map YAML Schema"] = 567,
    V2Ray = 601,
    ["VSCode Code Snippets"] = 129,
    ["VSIX CLI publishing"] = 491,
    ["Vela Pipeline Configuration"] = 481,
    Vercel = 128,
    ["Web App Manifest"] = 496,
    ["Web types"] = 499,
    WebExtensions = 495,
    ["Webman package recipe"] = 607,
    ["Windows Package Manager Installer Manifest"] = 544,
    ["Windows Package Manager Locale Manifest"] = 545,
    ["Windows Package Manager Singleton Manifest"] = 543,
    ["Woodpecker pipeline config"] = 578,
    ["Xstate Machine Schema"] = 595,
    ["Yippee-Ki-JSON configuration YML"] = 549,
    ["angular.json"] = 11,
    ...
    ["cloud-sdk-pipeline-config-schema"] = 138,
    ["cloudbuild.json"] = 139,
    cloudify = 121,
    codemagic = 123,
    ["coffeelint.json"] = 145,
    comet = 559,
    ["commands.json"] = 132,
    ["compile_commands.json"] = 131,
    ["compilerconfig.json"] = 130,
    ["component-detection-manifest.json"] = 148,
    ["component.json"] = 147,
    ["composer.json"] = 146,
    ["config.json"] = 149,
    ["contentmanifest.json"] = 137,
    ["contribute.json"] = 150,
    ["cosmos.config.json"] = 134,
    ["crowdin.yml"] = 151,
    cspell = 154,
    ["cypress.json"] = 152,
    ["datalogic-scan2deploy-android"] = 160,
    ["datalogic-scan2deploy-ce"] = 161,
    ["dbt Project"] = 98,
    ["debugsettings.json"] = 162,
    ["dependabot-v2.json"] = 165,
    ["dependabot.json"] = 164,
    ["deployed-cli"] = 594,
    ["detekt.yml"] = 167,
    devinit = 551,
    ["devspace.yaml"] = 615,
    ["docfx.json"] = 171,
    ["docker-compose.yml"] = 550,
    ["docker-seq schema"] = 170,
    ["dockerd.json"] = 169,
    ["dotnet Release Index manifest"] = 180,
    ["dotnetcli.host.json"] = 181,
    ["drone.json"] = 182,
    ["dss-2.0.0.json"] = 184,
    ["dstack Workflows"] = 185,
    ["dvc.yaml"] = 186,
    ["ecosystem.json"] = 191,
    eksctl = 192,
    ["electron-builder configuration file."] = 197,
    ["epr-manifest.json"] = 195,
    ["evcc.yaml"] = 198,
    ["ezd schema"] = 200,
    ["fabric.mod.json"] = 203,
    ["first-timers-bot"] = 206,
    ...
    ["gitlab-ci"] = 223,
    ["global.json"] = 225,
    ["golangci-lint Configuration"] = 226,
    ["haxelib.json"] = 239,
    helmfile = 540,
    ["host-meta.json"] = 244,
    ["host.json"] = 243,
    ...
    ["ide.host.json"] = 247,
    ["ifstate.conf"] = 248,
    ["imageoptimizer.json"] = 249,
    ["importmap.json"] = 251,
    ["ioBroker JSON UI"] = 252,
    ["ioBroker Package manifest"] = 253,
    ["ize.toml"] = 630,
    ["jsconfig.json"] = 273,
    ["jscpd Configuration Schema"] = 612,
    jsdoc = 537,
    ["k3d.yaml"] = 274,
    ["kontinuous-values.yaml"] = 278,
    ["kustomization.yaml"] = 279,
    ["label-commenter-config.yml"] = 280,
    ["launchsettings.json"] = 281,
    ["lego.json"] = 282,
    ["lerna.json"] = 283,
    ["lgtm.yml"] = 284,
    ["libman.json"] = 285,
    ["license-report-config.json"] = 286,
    ["linkinator.config.json"] = 287,
    ["local.settings.json"] = 290,
    ["localazy.json"] = 291,
    ["lsdlschema.json"] = 292,
    ["markdown-lint-check"] = 575,
    mboats = 581,
    ["mimetypes.json"] = 299,
    ["mirrord-schema"] = 520,
    ["mta.yaml"] = 521,
    ["mtad.yaml"] = 522,
    ["mycode.json"] = 317,
    ["napari plugin manifest"] = 318,
    neoload = 532,
    ["nest-cli"] = 323,
    ["ninjs (News in JSON) 1.3"] = 322,
    ["ninjs (News in JSON) 2.0"] = 321,
    ["nlu.json"] = 324,
    ["nodemon.json"] = 326,
    ["noodl.schema.json"] = 580,
    now = 528,
    ["npm-badges"] = 329,
    ["nswag.json"] = 332,
    ntangle = 333,
    ["nuclei-template.yaml"] = 330,
    ["nuget-project.json"] = 331,
    ["ocelot.json"] = 335,
    ["omnisharp.json"] = 336,
    ["openapi.json"] = 337,
    ["openfin.json"] = 339,
    ["openrpc.json"] = 338,
    ["package.json"] = 350,
    ["package.manifest"] = 351,
    ["pattern.json"] = 354,
    ["petstore-v1.0"] = 622,
    pgap_yaml_input_reader = 353,
    ["plagiarize-me.yaml"] = 358,
    ["plagiarize.yaml"] = 357,
    ["portman.json"] = 359,
    ["prettierrc.json"] = 364,
    ["prisma.yml"] = 365,
    ["project-1.0.0-beta3.json"] = 367,
    ["project-1.0.0-beta4.json"] = 368,
    ["project-1.0.0-beta5.json"] = 369,
    ["project-1.0.0-beta6.json"] = 370,
    ["project-1.0.0-beta8.json"] = 371,
    ["project-1.0.0-rc1.json"] = 372,
    ["project-1.0.0-rc2.json"] = 373,
    ["project.json"] = 366,
    ["prometheus.json"] = 374,
    ["prometheus.rules.json"] = 375,
    ["proxies.json"] = 376,
    ["publiccode.yml"] = 377,
    ["pubspec.yaml"] = 378,
    ["pyrseas-0.8.json"] = 381,
    ["release drafter"] = 533,
    rustfmt = 397,
    ["sarif-1.0.0.json"] = 400,
    ["sarif-2.0.0.json"] = 401,
    ["sarif-2.1.0"] = 410,
    ["sarif-2.1.0-rtm.2"] = 402,
    ["sarif-2.1.0-rtm.3"] = 404,
    ["sarif-2.1.0-rtm.4"] = 406,
    ["sarif-2.1.0-rtm.5"] = 408,
    ["sarif-external-property-file-2.1.0"] = 411,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 403,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 405,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 407,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 409,
    ["schema.org - Action"] = 413,
    ["schema.org - ContactPoint"] = 414,
    ["schema.org - Place"] = 415,
    ["schema.org - Thing"] = 416,
    ["semantic-release"] = 418,
    ["servicehub.config.json"] = 509,
    ["servicehub.service.json"] = 508,
    ["settings.job"] = 421,
    ["sfdx-hardis configuration"] = 423,
    ["size-limit configuration"] = 425,
    ["skaffold.yaml"] = 573,
    ["skyuxconfig.json"] = 426,
    snapcraft = 427,
    ["stripe-app-local.json"] = 441,
    ["stripe-app.json"] = 440,
    swcrc = 560,
    taskcat = 529,
    ["template.json"] = 449,
    ["templatsources.json"] = 450,
    ["theme.json"] = 453,
    ["tizen_workspace.json"] = 454,
    tmLanguage = 455,
    tmuxinator = 517,
    ["transcend.yml"] = 461,
    ["trunk.yaml schema"] = 462,
    ["ts-force-config.json"] = 466,
    ["tsconfig.json"] = 463,
    ["tsd.json"] = 464,
    ["tsdrc.json"] = 465,
    ["tslint.json"] = 467,
    ...
    ["vega-lite.json"] = 480,
    ["vega.json"] = 479,
    ["venvironment-basic.yaml"] = 483,
    ["venvironment.yaml"] = 482,
    ["version.json"] = 484,
    ["vim-addon-info"] = 485,
    ["vs-2017.3.host.json"] = 487,
    ["vs-nesting.json"] = 488,
    ["vsls.json"] = 486,
    ["vss-extension.json"] = 492,
    ["webhint.io"] = 608,
    ["webjobpublishsettings.json"] = 498,
    ["webjobs-list.json"] = 497,
    ["xs-app.json"] = 525,
    ["xunit.runner.json"] = 507,
    yamllint = 548,
    zuul = 534,
    ["Žinoma"] = 542
  },
