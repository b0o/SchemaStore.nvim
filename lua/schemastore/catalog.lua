...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1104,
    [".nodehawkrc"] = 710,
    [".npmpackagejsonlintrc"] = 715,
    [".omletrc"] = 1285,
    [".phrase.yml"] = 797,
    [".phraseapp.yml"] = 798,
    [".pmbot.yml"] = 782,
    [".postcssrc"] = 791,
    [".powerpages-web-template-manifest"] = 793,
    [".pre-commit-config.yml"] = 794,
    [".pre-commit-hooks.yml"] = 795,
    [".putout.json"] = 831,
    [".rehyperc"] = 856,
    [".remarkrc"] = 860,
    [".sprite files"] = 962,
    ...
    Ameba = 1,
    Anodizer = 521,
    ["Ansible Argument Specs"] = 503,
    ["Ansible Collection Galaxy"] = 510,
    ["Ansible Execution Environment"] = 500,
    ["Ansible Inventory"] = 509,
    ["Ansible Meta"] = 501,
    ["Ansible Meta Runtime"] = 502,
    ["Ansible Navigator Configuration"] = 512,
    ["Ansible Playbook"] = 507,
    ["Ansible Requirements"] = 504,
    ["Ansible Rulebook"] = 508,
    ["Ansible Tasks File"] = 506,
    ["Ansible Vars File"] = 505,
    ["Ansible-lint Configuration"] = 511,
    Any = 1295,
    ...
    ["Azure Pipelines"] = 137,
    ["Azure Static Web Apps CLI configuration file"] = 966,
    ["Azure Static Web Apps configuration file"] = 965,
    BMML = 1401,
    ["BOSH BPM Config"] = 165,
    ["BOSH CPI Config"] = 166,
    ...
    CycloneDX = 242,
    ["DWP Exchange - catalogue entry"] = 401,
    ["DWP Exchange - gateway"] = 399,
    ["DWP Exchange - meta"] = 400,
    ["Dagger module"] = 353,
    ...
    ["DataYoga Job"] = 245,
    ["Datadog Continuous Testing"] = 610,
    ["Datadog Service Definition"] = 611,
    ["Datadog Software Catalog"] = 612,
    ...
    DipDup = 1304,
    ["Discord Webhook"] = 372,
    ["DocFx Config (docfx.json)"] = 377,
    ["Docker Desktop extension metadata"] = 374,
    ["Docs MCP Manifest"] = 378,
    Dofigen = 379,
    ["Dolittle Artifacts"] = 380,
    ["Dolittle Bounded Context Configuration"] = 381,
    ["Dolittle Event Horizons Configuration"] = 382,
    ["Dolittle Resources Configuration"] = 383,
    ["Dolittle Server Configuration"] = 384,
    ["Dolittle Tenant Map Configuration"] = 386,
    ["Dolittle Tenants Configuration"] = 385,
    ["Dolittle Topology"] = 387,
    ["DonateCaseBetterCasino menu"] = 1335,
    ["Draugr Saga"] = 365,
    ["Draugr Saga fragment"] = 366,
    ...
    ["Drupal Routing"] = 277,
    ["Drupal Services"] = 279,
    ["Drush site aliases"] = 393,
    ["Dust configuration"] = 396,
    ["Dynamic Bash Aliases (.aliases)"] = 1242,
    ["EAS config"] = 440,
    ["ECA - Editor Code Assistant"] = 403,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1231,
    ["ESLint Suppressions"] = 445,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1378,
    ["EasyVCR .NET"] = 442,
    ["Eidolon Resource"] = 1319,
    ["Elgato Stream Deck"] = 406,
    Elm = 1306,
    ["Embrace Config"] = 1217,
    Emmet = 1307,
    Endurica = 1255,
    ["Enonic XP API descriptor"] = 409,
    ["Enonic XP Admin Extension descriptor"] = 410,
    ["Enonic XP Admin Tool descriptor"] = 411,
    ["Enonic XP Application descriptor"] = 412,
    ["Enonic XP CMS descriptor"] = 413,
    ["Enonic XP Content Type descriptor"] = 414,
    ["Enonic XP Form Fragment descriptor"] = 415,
    ["Enonic XP ID Provider descriptor"] = 416,
    ["Enonic XP Layout descriptor"] = 417,
    ["Enonic XP Macro descriptor"] = 418,
    ["Enonic XP Mixin descriptor"] = 419,
    ["Enonic XP Page descriptor"] = 420,
    ["Enonic XP Part descriptor"] = 421,
    ["Enonic XP Service descriptor"] = 422,
    ["Enonic XP Site descriptor"] = 423,
    ["Enonic XP Style descriptor"] = 424,
    ["Enonic XP Task descriptor"] = 425,
    ["Enonic XP Webapp descriptor"] = 426,
    ["Enterprise Contract Policy Spec"] = 407,
    ["Envelope Team Definition"] = 1426,
    ["Envilder Map File"] = 408,
    ["Erda Pipeline"] = 1280,
    ["Erda Runtime"] = 1281,
    ...
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 433,
    ["EveryVoice TTS Toolkit Data Configuration"] = 434,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 438,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 437,
    ["EveryVoice TTS Toolkit Text Configuration"] = 435,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 436,
    ["Evolving Resolutive Process notation"] = 1380,
    ["Expo SDK"] = 439,
    ["Expoot app config"] = 441,
    ["F-Droid Data metadata"] = 447,
    ["FasterCI Configuration"] = 138,
    Fatou = 139,
    ["Fence configuration"] = 140,
    FiQuS = 451,
    Firebase = 449,
    ["Flatpak Builder Manifest"] = 452,
    ["FlexGet Config"] = 453,
    ["Flow.json Configurations"] = 1277,
    ["Fossa configuration file"] = 460,
    ["Fossa's fossa-deps file"] = 461,
    ["Foundry VTT - Base package Manifest"] = 455,
    ["Foundry VTT - Module Manifest"] = 456,
    ["Foundry VTT - System Data Template"] = 459,
    ["Foundry VTT - System Manifest"] = 457,
    ["Foundry VTT - World Manifest"] = 458,
    ["Foxx Manifest"] = 141,
    ["Freifunk.de Community API"] = 144,
    ["Frogbot Config"] = 145,
    ["G2P Mapping Configuration"] = 468,
    GAMA = 469,
    ["GCP Blueprint Metadata"] = 472,
    Gaspar = 470,
    ["GatewayCore API Gateway"] = 471,
    ["Gemini CLI settings"] = 473,
    ["GeoJSON.json latest"] = 1193,
    GherKing = 1197,
    ["GitHub Action"] = 483,
    ["GitHub Actions typing"] = 1315,
    ["GitHub CLI configuration"] = 484,
    ["GitHub CLI hosts"] = 485,
    ["GitHub Discussion"] = 486,
    ["GitHub Funding"] = 488,
    ["GitHub Issue Template configuration"] = 489,
    ["GitHub Issue Template forms"] = 490,
    ["GitHub Pages Jekyll"] = 491,
    ["GitHub Prompt"] = 487,
    ["GitHub Secret Scanning"] = 492,
    ["GitHub Workflow"] = 493,
    ["GitHub Workflow Template Properties"] = 494,
    ["GitHub automatically generated release notes configuration"] = 495,
    ["GitLab Agent for Kubernetes configuration"] = 1269,
    ["GitLab Duo Workflow"] = 497,
    GitResume = 499,
    GitVersion = 476,
    ["Gitea Issue Template configuration"] = 479,
    ["Gitea Issue Template forms"] = 480,
    Gitleaks = 477,
    ["Gitpod Configuration"] = 498,
    ["Glamour style"] = 474,
    ["GlazeWM settings"] = 1271,
    ["Global Privacy Control"] = 475,
    Goblet = 1250,
    ["Golangci-lint Configuration"] = 514,
    ["Golangci-lint Custom Plugins Configuration"] = 515,
    ["Google Chrome Related Website Sets"] = 450,
    ...
    ["Grafana 5.x Dashboard"] = 523,
    ["GraphQL Code Generator"] = 528,
    ["GraphQL Config"] = 527,
    ["GraphQL Mesh"] = 526,
    ["GroovyLint configuration"] = 529,
    ["Grunt JSHint task"] = 533,
    ["Grunt Watch task"] = 534,
    ["Grunt base task"] = 535,
    ["Grunt clean task"] = 531,
    ["Grunt copy task"] = 530,
    ["Grunt cssmin task"] = 532,
    HEMTT = 1107,
    ...
    Hatch = 1122,
    Hayson = 538,
    ["Haystack Pipeline"] = 539,
    ["Hazelcast 5 Configuration"] = 540,
    ...
    ["Hex file"] = 283,
    ["Home Assistant Integration Manifest"] = 542,
    ["Homer dashboard configuration"] = 543,
    ["Hoverfly Simulation"] = 548,
    Hugo = 1185,
    ["Hugo Theme"] = 1184,
    ["Hulak Configuration"] = 551,
    ["Hyperfoil benchmark configuration"] = 550,
    ["IBM Zapp document"] = 552,
    ["IBM zCodeFormatSettings"] = 553,
    ["IMG Catapult PSP"] = 558,
    ["IVMS101 by CODE Protocol"] = 1270,
    ["Infinispan Configuration"] = 560,
    ["Infinispan Server Configuration"] = 561,
    Infrahub = 562,
    Istanbul = 1213,
    ["JDownloader2 crawler multi-rules"] = 576,
    ["JDownloader2 crawler single-rules"] = 575,
    ["JFrog Applications Config"] = 577,
    ["JFrog File Spec"] = 578,
    ["JFrog Pipelines YML DSL"] = 1219,
    ["JMeter DSL cli config"] = 579,
    JReleaser = 582,
    ["JSON Document Transform"] = 590,
    ["JSON Feed"] = 591,
    ["JSON Resume"] = 869,
    ["JSON Schema Draft 2020-12"] = 1087,
    ["JSON Schema Draft 4"] = 1084,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1252,
    ["JSON Schema Draft 7"] = 1085,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1253,
    ["JSON Schema Draft 8 (2019-09)"] = 1086,
    ["JSON-API"] = 589,
    ["JSON-e templates"] = 1150,
    ["JSON-stat 2.0"] = 1080,
    JSONPatch = 593,
    ["JSR Package Config (jsr.json)"] = 583,
    Jarl = 1386,
    Jasmine = 570,
    Jekyll = 571,
    ["Jenkins X Pipelines"] = 572,
    ["Jenkins X Requirements"] = 573,
    Jest = 574,
    Jocker = 580,
    ["Jovo Language Models"] = 581,
    Jsontron = 594,
    ["Jujutsu (jj) VCS config"] = 1372,
    ["KIMMDY config file"] = 605,
    ...
    KSail = 466,
    ["KYA Manifest"] = 1283,
    ["Karakum configuration file"] = 462,
    Kas = 597,
    ["Kestra flow file"] = 606,
    ["Keycloak REST API"] = 1222,
    ["Knative Functions - func.yaml"] = 463,
    Knip = 464,
    ["Knip JSONC"] = 465,
    ["Knowledge Unit"] = 614,
    ["Kometa (nightly) config file"] = 608,
    ["Kometa config file"] = 607,
    ["Kong DBLess config"] = 1216,
    KrakenD = 609,
    ["Kubri Configuration"] = 617,
    LOOBin = 636,
    ...
    Lefthook = 622,
    ["Liferay client-extension.yaml"] = 629,
    ["LinkML Metamodel"] = 631,
    ["LiquiLens Evidence Carrier Reference v1"] = 633,
    ["LiquiLens Evidence Carrier v1"] = 632,
    Liquibase = 1160,
    ["Liquibase Flow File"] = 1161,
    ["Lively Properties"] = 635,
    ["Lobe AI Agent"] = 132,
    Loki = 133,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 679,
    ["MS2Rescore Configuration"] = 687,
    ["MSTest testconfig.json"] = 688,
    ["Madge configuration"] = 642,
    ["Madness (madness.yml)"] = 1233,
    ["Mado configuration"] = 643,
    ["Maestro Flow"] = 644,
    ["Mail Servers Configuration"] = 1407,
    ["MapEHR Mapping"] = 645,
    Markdownlint = 1164,
    ["Mason Registry"] = 1167,
    ["MegaLinter Custom Flavor"] = 648,
    ["MegaLinter configuration"] = 647,
    ["MegaLinter descriptor"] = 649,
    Melange = 1260,
    ["Meltano project definition"] = 650,
    ["Mergify Configuration"] = 689,
    ["Mermaid config"] = 4,
    ["Metadata for a Bazel module"] = 651,
    ["Metadata for a Cinnamon spice"] = 1311,
    ["Metatype Configuration"] = 652,
    ["MetricsHub Configuration"] = 653,
    ["MetricsHub Connector Configuration"] = 654,
    ["Micro Editor Syntax"] = 1243,
    ["Microsoft Band Web Tile"] = 655,
    ...
    ["Minecraft Data Pack Advancement"] = 657,
    ["Minecraft Data Pack Biome"] = 658,
    ["Minecraft Data Pack Configured Carver"] = 659,
    ["Minecraft Data Pack Damage Type"] = 660,
    ["Minecraft Data Pack Dimension"] = 662,
    ["Minecraft Data Pack Dimension Type"] = 661,
    ["Minecraft Data Pack Item Modifier"] = 663,
    ["Minecraft Data Pack Loot Table"] = 664,
    ["Minecraft Data Pack Metadata"] = 665,
    ["Minecraft Data Pack Predicate"] = 666,
    ["Minecraft Data Pack Recipe"] = 667,
    ["Minecraft Data Pack Tag"] = 668,
    ["Minecraft Data Pack Template Pool"] = 669,
    ["Minecraft Data Pack Trim Material"] = 674,
    ["Minecraft Data Pack Trim Pattern"] = 675,
    ["Minecraft Resource Pack Lang"] = 670,
    ["Minecraft Resource Pack Particle"] = 671,
    ["Minecraft Resource Pack Texture Mcmeta"] = 673,
    ["Minecraft Resourcepack Sounds"] = 672,
    ["MockServer Expectation"] = 681,
    ["MockServer Expectations"] = 682,
    ModuleAssembler = 677,
    ["Monade CLI Stack Configuration"] = 692,
    ["MongoDB Atlas Search Index Definition"] = 1214,
    ["Monika Configuration"] = 1212,
    ["Monoweave Configuration"] = 686,
    ["Motif config"] = 1103,
    MultiQC = 1352,
    ["NOX Framework (Service)"] = 714,
    ["Netin Diagnostic System Template"] = 1171,
    ["Netlify config"] = 695,
    ["Network-as-Code Data Model"] = 696,
    ["Next Gen UI Agent A2A Server Configuration"] = 697,
    ["Next Gen UI Agent Configuration"] = 699,
    ["Next Gen UI Agent MCP Server Configuration"] = 698,
    ["Nightwatch.js"] = 706,
    ["Nika workflow"] = 711,
    ["Node.js configuration"] = 1108,
    ["NueJS configuration file"] = 719,
    ["Nuitka Package Config"] = 1275,
    ["Nullstone config"] = 721,
    ["ODGS Data Rules"] = 728,
    ["ODGS Ontology Graph"] = 729,
    ["ODGS Standard Metrics"] = 727,
    ["OKF Graph"] = 1454,
    ["ONe's changelog entry"] = 743,
    ["ONe's service descriptor"] = 742,
    ["ORT Server repository environment configuration"] = 754,
    ["OSCAL Assessment Plan (AP)"] = 756,
    ["OSCAL Assessment Results (AR)"] = 757,
    ["OSCAL Catalog"] = 758,
    ["OSCAL Component Definition (CDef)"] = 759,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 760,
    ["OSCAL Profile"] = 761,
    ["OSCAL System Security Plan (SSP)"] = 762,
    ["OSS Review Toolkit configuration"] = 763,
    ["OSS Review Toolkit curation"] = 764,
    ["OSS Review Toolkit package configuration"] = 765,
    ["OSS Review Toolkit project package manager definition"] = 766,
    ["OSS Review Toolkit repository configuration"] = 767,
    ["OSS Review Toolkit resolutions"] = 768,
    ["October CMS columns"] = 725,
    ["October CMS fields"] = 726,
    ["Oh My Posh"] = 731,
    Okteto = 732,
    ["Ona Tasks and Services"] = 734,
    Opctl = 1106,
    ["Open Data Contract Standard (ODCS)"] = 747,
    ["Open Data Product Standard (ODPS)"] = 748,
    ["Open Know-How"] = 1357,
    ["Open Pentest Format"] = 749,
    OpenDecree = 1424,
    ["OpenDecree Configuration"] = 1425,
    ["OpenRewrite Resource"] = 745,
    OpenSRM = 750,
    OpenStatus = 1368,
    ["OpenTelemetry Declarative Configuration"] = 746,
    ["OpenUtau character yaml"] = 739,
    ["OpenUtau ustx"] = 740,
    ["OpenWeather Current Weather API"] = 1149,
    ["OpenWeather Road Risk API"] = 1148,
    ["Ory Hydra configuration"] = 549,
    ["Ory Keto configuration"] = 613,
    ["Ory Kratos configuration"] = 755,
    ["Ory Oathkeeper configuration"] = 723,
    ["Outblocks App configuration"] = 752,
    ["Outblocks database table"] = 753,
    ["Outblocks project configuration"] = 751,
    PDM = 776,
    POPxf = 788,
    ["POPxf Correlations"] = 789,
    ["PRML manifest"] = 796,
    Packer = 772,
    PactSpec = 773,
    Panache = 774,
    Pantsbuild = 1229,
    ["Paper paper-plugin.yml"] = 775,
    ["Pipeline component"] = 1162,
    ["Platform.sh application"] = 15,
    ["Platform.sh routes"] = 16,
    ["Platform.sh services"] = 17,
    ["Plex Prerolls"] = 786,
    ["PocketMine plugin.yml"] = 783,
    ["Podman Desktop Extension"] = 1444,
    ["Postman collection"] = 792,
    ["Power Pages Configuration"] = 1369,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1314,
    ["ProActions AI-Kit Configuration"] = 804,
    ["ProActions AI-Kit Configuration for Menus"] = 806,
    ["ProActions AI-Kit Configuration for Sections"] = 808,
    ["ProActions AI-Kit Configuration for Services"] = 805,
    ["ProActions AI-Kit Configuration for Steps"] = 809,
    ["ProActions AI-Kit Configuration for Templates"] = 807,
    ["Problem object RFC9457"] = 1258,
    ["Problem package format"] = 810,
    ...
    Ray = 1120,
    ["Read the Docs"] = 837,
    ["Red-DiscordBot Cog"] = 853,
    ["Red-DiscordBot Cog Repo"] = 854,
    ["Red-DiscordBot Trivia"] = 855,
    ["Releasaurus Config"] = 12,
    ReleaseKit = 11,
    ["Render Blueprints"] = 1157,
    RenderCV = 873,
    Renovate = 870,
    ["Renovate global configuration"] = 871,
    ["Renovate inherited configuration"] = 872,
    ["Replit config"] = 861,
    Restate = 1347,
    ...
    Rockcraft = 876,
    ["Roo Coder Custom Modes"] = 877,
    Rubocop = 866,
    ["Rudder techniques"] = 1265,
    Ruff = 867,
    ["Rust Project"] = 868,
    ["Rust toolchain"] = 882,
    ["SDMX data message"] = 909,
    ["SDMX metadata message"] = 908,
    ["SDMX structure message"] = 907,
    ["SIL Kit Participant Configuration"] = 920,
    ["SIL Kit Registry Configuration"] = 921,
    ["SPDX 2.3"] = 963,
    SWADL = 979,
    ["Safebox Config"] = 1220,
    ["Sapphire CLI Config"] = 885,
    ["SauceCTL Configuration"] = 1168,
    Scarb = 905,
    ["Schema Catalog"] = 900,
    ["Scoop manifest"] = 906,
    ["Secure SDLC Evidence Bundle"] = 910,
    ["Semantic Data Fabric (SDF) file"] = 911,
    ["Semgrep Rule"] = 913,
    ["Serenity Code Generator (Sergen)"] = 914,
    ...
    ["Sigma Detection Rule"] = 918,
    ["SigmaCV CV"] = 7,
    ["Sigrid scope configuration file"] = 919,
    ["SkyPilot Task JSON"] = 1266,
    ["Slack app manifest"] = 926,
    ["Slang Server Configuration"] = 1448,
    Snapcraft = 928,
    ["Solarxy project config"] = 931,
    Solidarity = 932,
    ["Solution filters"] = 933,
    ["Source Maps v3"] = 934,
    Sourcery = 935,
    ["Spack bootstrap.yaml"] = 936,
    ["Spack cdash.yaml"] = 937,
    ["Spack ci.yaml"] = 938,
    ["Spack compilers.yaml"] = 939,
    ["Spack concretizer.yaml"] = 940,
    ["Spack config.yaml"] = 941,
    ["Spack definitions.yaml"] = 942,
    ["Spack develop.yaml"] = 943,
    ["Spack env_vars.yaml"] = 944,
    ["Spack environment"] = 950,
    ["Spack include.yaml"] = 945,
    ["Spack mirrors.yaml"] = 946,
    ["Spack modules.yaml"] = 947,
    ["Spack packages.yaml"] = 948,
    ["Spack repos.yaml"] = 949,
    ["Spack toolchains.yaml"] = 951,
    ["Spack upstreams.yaml"] = 952,
    ["Spack view.yaml"] = 953,
    ["Speakeasy Generation Config File"] = 957,
    ["Speakeasy Lint Configuration File"] = 954,
    ["Speakeasy Test Generation Configuration File"] = 955,
    ["Speakeasy Workflow File"] = 956,
    SpecIF = 958,
    ["Specmatic Configuration"] = 959,
    ["Specpin spec file"] = 5,
    ["Sponge Mixin configuration"] = 960,
    ["Spotlight Ruleset"] = 961,
    StackBlitz = 967,
    ...
    Starship = 970,
    ["Statamic Blueprint"] = 971,
    ["Stella configuration file"] = 972,
    ["Streamlit configuration file"] = 973,
    ["Stryker Mutator"] = 976,
    ["StyleCop Analyzers Configuration"] = 977,
    ["Stylelint (.stylelintrc)"] = 978,
    ["Stylua Config"] = 1361,
    ["Sublime Syntax"] = 1221,
    ["Subsquid squid manifest"] = 1268,
    ["Swagger API 2.0"] = 980,
    ["Symfony Routing Configuration"] = 981,
    ["Symfony Serializer Mapping"] = 982,
    ["Symfony Services Configuration"] = 983,
    ["Symfony Validation Mapping"] = 984,
    ["Synadia Connect Component"] = 985,
    TSON = 1028,
    TSTyche = 1029,
    ["TYPO3 Vendor Bundler config"] = 1035,
    ["Tab data for a LinUtil"] = 1317,
    ["Tab list for a LinUtil"] = 1316,
    Tach = 986,
    ["Tach Domain"] = 987,
    Talhelper = 989,
    ["Talisman configuration"] = 990,
    Taplo = 1362,
    ...
    ["Tekton TaskRun"] = 1389,
    Telefonistka = 1348,
    ["Terraform PowerShell provider block manifest"] = 995,
    ["Terraform PowerShell provider data source manifest"] = 996,
    ["Terraform PowerShell provider resource manifest"] = 997,
    ["Terraform PowerShell provider settings"] = 998,
    ["Terrateam config"] = 1374,
    ["Tesseract configuration"] = 999,
    ["TestEnvironment.json"] = 1009,
    ["TextMate Grammar"] = 1008,
    Threagile = 1003,
    ["Tier.run pricing.json"] = 1000,
    Tikibase = 1001,
    Tombi = 1006,
    ["Traefik v2"] = 1012,
    ["Traefik v2 File Provider"] = 1013,
    ["Traefik v3"] = 1014,
    ["Traefik v3 File Provider"] = 1015,
    ["Travis CI (.travis.yml)"] = 1011,
    Treefmt = 525,
    Trident = 1344,
    Trivy = 1018,
    ["TrueScript for *.tscript files"] = 1019,
    ...
    ["UI5 Manifest"] = 1041,
    ["UNCORS configuration"] = 1046,
    ["UTAM Page Object"] = 1044,
    ["Ubuntu Server Autoinstall"] = 1039,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1345,
    ["Uniswap Token List"] = 1131,
    ["Universal Schedule Format"] = 1047,
    ...
    ["VSIX CLI publishing"] = 1067,
    Vector = 1049,
    ["Vee JSON menu output"] = 1050,
    ["Vela Pipeline Configuration"] = 1053,
    Vercel = 307,
    ["Version Bumper config"] = 1056,
    Vespertide = 1395,
    ...
    ["cargo-nextest repository configuration"] = 700,
    ["cargo-nextest user configuration"] = 701,
    ["ccmod.json"] = 1321,
    ["cfgd Config"] = 1449,
    ...
    ["ddev-global"] = 362,
    ["ddev-project"] = 363,
    ["debugsettings.json"] = 364,
    ["dependabot-v2.json"] = 369,
    ["dependabot.json"] = 368,
    ["deployed-cli"] = 1187,
    devconcurrent = 265,
    ...
    djlint = 1138,
    ["docker bake"] = 375,
    ["docker sequencer"] = 376,
    ["docker-compose.yml"] = 1136,
    ["dockerd.json"] = 373,
    ["dotnet Release Index manifest"] = 388,
    ["dotnet-tools.json"] = 389,
    ["dotnetcli.host.json"] = 390,
    ["dprint.json"] = 391,
    ["drone.json"] = 392,
    ["dss-2.0.0.json"] = 394,
    ["dstack configuration"] = 395,
    ["dtool dataset metadata"] = 1328,
    ["dvc.yaml"] = 397,
    ["ecosystem.json"] = 402,
    ["editorconfig-checker"] = 404,
    eksctl = 405,
    ["electron-builder configuration file"] = 431,
    ["epr-manifest.json"] = 430,
    ["estampo.toml"] = 429,
    ["evcc.yaml"] = 432,
    ["ezd task runner"] = 443,
    ["fabric.mod.json"] = 446,
    ["first-timers-bot"] = 454,
    ...
    ["git-cliff"] = 478,
    ["git-town.toml"] = 1385,
    ["github-settings-as-code"] = 862,
    ["gitlab-ci"] = 496,
    ["global.json"] = 513,
    ["glslint config"] = 3,
    ["go-feature-flag Flag Configuration"] = 517,
    ["gojo.yaml"] = 518,
    gollama = 516,
    ["hassette.toml"] = 541,
    ["haxelib.json"] = 537,
    ...
    ["ide.host.json"] = 554,
    ["ifstate.yaml"] = 555,
    ["imageoptimizer.json"] = 556,
    ["importmap.json"] = 559,
    ["index.toml (packwiz)"] = 1445,
    instant_python_config = 563,
    instant_python_custom_project = 564,
    intlayer = 565,
    ["ioBroker Configuration"] = 566,
    ["ioBroker JSON UI"] = 567,
    ["ioBroker Package manifest"] = 568,
    ["ixpect.conf.yaml"] = 569,
    ["ize.toml"] = 1223,
    ["jsconfig.json"] = 595,
    ["jscpd Configuration"] = 1207,
    jsdoc = 1119,
    ["k3d.yaml"] = 596,
    ["k9s aliases.yaml"] = 598,
    ["k9s cluster-config.yaml"] = 600,
    ["k9s config.yaml"] = 599,
    ["k9s hotkeys.yaml"] = 601,
    ["k9s plugins.yaml"] = 602,
    ["k9s skin.yaml"] = 603,
    ["k9s views.yaml"] = 604,
    ["kind cluster"] = 618,
    ["kontinuous-config.yaml"] = 616,
    ["kontinuous-values.yaml"] = 615,
    ["kustomization.yaml"] = 619,
    ["label-commenter-config.yml"] = 620,
    ["latexindent configuration"] = 131,
    ["launchsettings.json"] = 621,
    lazydocker = 1245,
    lazygit = 1244,
    ["lego.json"] = 623,
    ["lerna.json"] = 624,
    ["lgtm.yml"] = 625,
    ["liblab.config.json"] = 626,
    ["libman.json"] = 627,
    ["license-report-config.json"] = 628,
    ["linkinator.config.json"] = 630,
    ["lint-staged (.lintstagedrc)"] = 1096,
    ["litertlm_manifest.json"] = 634,
    ["local.settings.json"] = 638,
    ["localazy.json"] = 639,
    ["lotus.yaml"] = 637,
    ["lsd colors"] = 135,
    ["lsd config"] = 134,
    ...
    ["mycode.json"] = 693,
    nFPM = 705,
    ["napari plugin manifest"] = 694,
    neoload = 1114,
    ["nest-cli"] = 708,
    ["nexus-rpc-gen"] = 1412,
    ["nf-core module environment.yml"] = 702,
    ["nf-core module meta.yml"] = 703,
    ["nf-core subworkflow meta.yml"] = 704,
    ["ninjs (News in JSON)"] = 707,
    ["nitro.json"] = 1113,
    ["nixd configuration"] = 1264,
    ["nlu.json"] = 709,
    ["nodemon.json"] = 712,
    ["noodl config"] = 1172,
    ["notebook.mod.json"] = 713,
    now = 1109,
    ["npm-badges"] = 716,
    ["nswag.json"] = 720,
    ntangle = 722,
    ["nuclei-template.yaml"] = 717,
    ["nuget-project.json"] = 718,
    ["ocelot.json"] = 724,
    ogen = 730,
    ["omnisharp.json"] = 733,
    openHAB = 1398,
    ...
    ["package.json"] = 769,
    ["package.manifest"] = 771,
    ["package.yaml"] = 770,
    ["partial-black.json"] = 173,
    ["partial-fastapi.json"] = 174,
    ["partial-pixi.json"] = 781,
    ["partial-scheduled.json"] = 175,
    ["pattern.json"] = 779,
    ["petstore-v1.0"] = 1218,
    pgap_yaml_input_reader = 777,
    pgrls = 778,
    pgxgen = 1402,
    pitcms = 1405,
    ["pixi.toml"] = 780,
    ["plagiarize-me.yaml"] = 785,
    ["plagiarize.yaml"] = 784,
    ...
    ["prettierrc.json"] = 802,
    ["prisma.yml"] = 803,
    ["project-1.0.0-beta3.json"] = 815,
    ["project-1.0.0-beta4.json"] = 816,
    ["project-1.0.0-beta5.json"] = 817,
    ["project-1.0.0-beta6.json"] = 818,
    ["project-1.0.0-beta8.json"] = 819,
    ["project-1.0.0-rc1.json"] = 820,
    ["project-1.0.0-rc2.json"] = 821,
    ["project.json"] = 814,
    ["project.owasp.yaml"] = 822,
    ["prometheus-alertmanager.json"] = 826,
    ["prometheus.json"] = 823,
    ["prometheus.rules.json"] = 824,
    ["prometheus.rules.test.json"] = 825,
    ["proxies.json"] = 827,
    ["publiccode.yml"] = 828,
    ["pubspec.yaml"] = 829,
    ["pyrseas-0.8.json"] = 832,
    pytest = 841,
    ["quilt.mod.json"] = 1239,
    ["rc3 auth"] = 847,
    ["rc3 collection"] = 848,
    ...
    ["release-hub.json"] = 10,
    ["release-please-config.json"] = 857,
    ["release-please-manifest.json"] = 858,
    ["release-plz.toml"] = 859,
    ["renv.lock"] = 874,
    ["reposets Configuration"] = 863,
    ["reposets Credentials"] = 864,
    ["revola.json"] = 8,
    ["rivet.json"] = 1263,
    ...
    samt = 883,
    samtrc = 884,
    ["sarif-1.0.0.json"] = 886,
    ["sarif-2.0.0.json"] = 887,
    ["sarif-2.1.0"] = 897,
    ["sarif-2.1.0-rtm.2"] = 888,
    ["sarif-2.1.0-rtm.3"] = 890,
    ["sarif-2.1.0-rtm.4"] = 892,
    ["sarif-2.1.0-rtm.5"] = 894,
    ["sarif-2.1.0-rtm.6"] = 895,
    ["sarif-external-property-file-2.1.0"] = 898,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 889,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 891,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 893,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 896,
    ["scalingo.json configuration"] = 899,
    ["schema.org - Action"] = 901,
    ["schema.org - ContactPoint"] = 902,
    ["schema.org - Place"] = 903,
    ["schema.org - Thing"] = 904,
    ["secrethub.yml"] = 1241,
    ["semantic-release"] = 912,
    servercn = 1458,
    ["servicehub.config.json"] = 1090,
    ["servicehub.service.json"] = 1089,
    ["settings.job"] = 915,
    ["sfdx-hardis configuration"] = 917,
    ["shard.yml"] = 1279,
    ["size-limit configuration"] = 922,
    ["skaffold.yaml"] = 1163,
    ["skill-map plugin extension manifest"] = 923,
    ["skill-map project settings"] = 924,
    ["skill-map provider kind"] = 925,
    ["skyuxconfig.json"] = 927,
    ["snowflake-config"] = 929,
    ["snowflake-connections"] = 930,
    ["spicepod.yaml"] = 1300,
    ["sqlc configuration"] = 964,
    ["stripe-app-local.json"] = 975,
    ["stripe-app.json"] = 974,
    swcrc = 1147,
    ["task.json"] = 988,
    taskcat = 1110,
    ["template.json"] = 993,
    ["templatsources.json"] = 994,
    ["text2confl config"] = 1410,
    ["theme.json"] = 1002,
    ["tizen_workspace.json"] = 1004,
    tldr = 1005,
    ["tm_devices configuration file"] = 1367,
    tmuxinator = 1093,
    tox = 1007,
    ["transcend.yml"] = 1016,
    ["tree-sitter grammar.json"] = 524,
    ["trime.yaml"] = 1017,
    ["trunk.yaml"] = 1020,
    ["ts-force-config.json"] = 1026,
    tsbuild = 1021,
    ["tsconfig.json"] = 1022,
    ["tsd.json"] = 1023,
    ["tsdoc.json"] = 1024,
    ...
    ["vega-lite.json"] = 1052,
    ["vega.json"] = 1051,
    ["venvironment.yaml"] = 1054,
    ["venvplus.yaml"] = 1055,
    version = 1349,
    ["version.json"] = 1057,
    ["vhwdebugger-binding.yaml"] = 1059,
    ["vim-addon-info"] = 1060,
    ["vs-2017.3.host.json"] = 1063,
    ["vs-nesting.json"] = 1064,
    ["vsls.json"] = 1062,
    ["vss-extension.json"] = 1068,
    vtcfg = 1355,
    ["vtesttree.yaml"] = 1069,
    ["vtestunit.yaml"] = 1070,
    ...
    ["webhint.io"] = 1203,
    ["webjobpublishsettings.json"] = 1075,
    ["webjobs-list.json"] = 1074,
    ["well-known-fursona"] = 1287,
    ["xs-app.json"] = 1105,
    ["xunit.runner.json"] = 1088,
    ["yaml-workflow"] = 1457,
    yamlfmt = 1132,
    yamllint = 1133,
    ["yap.json"] = 1134,
