...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 994,
    [".nodehawkrc"] = 626,
    [".npmpackagejsonlintrc"] = 630,
    [".omletrc"] = 1175,
    [".phrase.yml"] = 708,
    [".phraseapp.yml"] = 709,
    [".pmbot.yml"] = 693,
    [".postcssrc"] = 702,
    [".powerpages-web-template-manifest"] = 704,
    [".pre-commit-config.yml"] = 705,
    [".pre-commit-hooks.yml"] = 706,
    [".putout.json"] = 742,
    [".rehyperc"] = 767,
    [".remarkrc"] = 771,
    [".sprite files"] = 867,
    ...
    AIConfig = 37,
    ["AMX Muse Program Descriptor"] = 1224,
    ["API Builder"] = 1030,
    ["AVA Configuration"] = 1094,
    ...
    ["AWS Copilot Manifest"] = 1263,
    ["AWS SAM CLI Samconfig"] = 277,
    Acton = 1314,
    ["Adobe UXP Manifest"] = 1157,
    ["Aerleon Network & Service Definitions"] = 23,
    ["Aerleon Policy"] = 24,
    ["Agent Permission Policy"] = 1303,
    ["AgentCore CLI"] = 1304,
    AgentLoopKit = 1305,
    Aider = 1253,
    Air = 26,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1274,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1273,
    ["Airlock Microgateway"] = 38,
    ["Alacritty Configuration"] = 1066,
    ["AlgoVoi Compliance Receipt v1"] = 13,
    ["All Contributors configuration file"] = 1120,
    Anodizer = 452,
    ["Ansible Argument Specs"] = 436,
    ["Ansible Collection Galaxy"] = 443,
    ["Ansible Execution Environment"] = 433,
    ["Ansible Inventory"] = 442,
    ["Ansible Meta"] = 434,
    ["Ansible Meta Runtime"] = 435,
    ["Ansible Navigator Configuration"] = 445,
    ["Ansible Playbook"] = 440,
    ["Ansible Requirements"] = 437,
    ["Ansible Rulebook"] = 441,
    ["Ansible Tasks File"] = 439,
    ["Ansible Vars File"] = 438,
    ["Ansible-lint Configuration"] = 444,
    Any = 1185,
    ...
    ["Application list for a WinUtil"] = 1203,
    ArchitectFX = 1208,
    ["Argo CD"] = 57,
    ["Argo Events"] = 58,
    ["Argo Workflows"] = 59,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1272,
    ["Azure IoT Operations connector metadata"] = 1269,
    ...
    ["Azure Pipelines"] = 117,
    ["Azure Static Web Apps CLI configuration file"] = 871,
    ["Azure Static Web Apps configuration file"] = 870,
    BMML = 1291,
    ["BOSH CPI Config"] = 143,
    ...
    ["Bacon config"] = 7,
    ["Barba-CV"] = 86,
    ["Bashly (bashly.yml)"] = 1124,
    ["Bashly Settings (bashly-settings.yml)"] = 1125,
    Bento = 1290,
    ["Better Code Hub"] = 1035,
    ["Better Scripts"] = 166,
    Bigconfig = 136,
    ["Biome Formatter Config"] = 87,
    ["Bitmovin Encoding Template"] = 1217,
    BizTalkServerApplicationSchema = 1001,
    Bleep = 167,
    ["Block Protocol Metadata"] = 164,
    ["Bluebricks blueprint config"] = 1296,
    ["Boyka Framework"] = 145,
    ...
    ["Butane Config"] = 1079,
    C4InterFlow = 1232,
    ["CDK Environment Manager, concrete environment configuration"] = 1256,
    ["CDK Environment Manager, concrete environments definition"] = 1255,
    ["CDK Environment Manager, environment definition"] = 1254,
    ["CGS Card Game Specification (cgs.json)"] = 1162,
    ["CICS TS region tagging"] = 1088,
    ["CICS TS resource import"] = 1089,
    ["CICS TS resource model"] = 1090,
    ["CICS TS resource overrides"] = 1091,
    ["CMake Presets"] = 168,
    ["CNC Codes"] = 190,
    ["CRS WAF test file"] = 1192,
    ["CRS WAF test platform overrides file"] = 1193,
    ...
    ["Caido Proxy Configuration"] = 1328,
    ...
    ["Chamaleon environment"] = 1221,
    ["Chamaleon properties"] = 1222,
    ["Chamaleon template"] = 1220,
    Changepacks = 1283,
    Changesets = 286,
    Changie = 177,
    Charmcraft = 178,
    ...
    ["Clawject config"] = 196,
    ["Cloud Foundry Application Manifest"] = 1174,
    ["Cloud Run Spec v1"] = 1198,
    ...
    Concord = 1191,
    ["Configu .cfgu files"] = 1179,
    ["Configu .configu file"] = 1180,
    Conjure = 189,
    ["Container Structure Test"] = 1015,
    Containerlab = 1044,
    ["Contextive Glossary"] = 1248,
    ContractGuard = 1045,
    Convex = 188,
    ...
    ["Cursor Agent Environment"] = 1301,
    ["Custom Machinery Machine"] = 1163,
    ["Custom Machinery Recipe"] = 1164,
    ...
    ["DataYoga Job"] = 206,
    ["Datadog Continuous Testing"] = 538,
    ["Datadog Service Definition"] = 539,
    ["Datadog Software Catalog"] = 540,
    ["Datahub Ingestion Recipe"] = 1095,
    ["Debian Upstream Metadata file"] = 213,
    ["Deck config"] = 214,
    ["Declarative Automation Bundles"] = 1141,
    ["DeepMatch deeplinks spec"] = 215,
    ["Dein Config"] = 216,
    ["Deno Config (deno.json)"] = 314,
    ["Dependency cruiser"] = 217,
    ["DeployStack Configuration"] = 218,
    ["Deployah Configuration"] = 1271,
    ["Deployer Recipe"] = 317,
    ["Deta Spacefile"] = 219,
    ...
    ["DonateCaseBetterCasino menu"] = 1225,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1132,
    ["EAS config"] = 385,
    ["ECA - Editor Code Assistant"] = 349,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1121,
    ["ESLint Suppressions"] = 390,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1268,
    ["EasyVCR .NET"] = 387,
    ["Eidolon Resource"] = 1209,
    ...
    ["Envelope Team Definition"] = 1313,
    ["Envilder Map File"] = 353,
    ["Erda Pipeline"] = 1170,
    ["Erda Runtime"] = 1171,
    ["Espanso config.yml"] = 1294,
    ["Espanso match.yml"] = 1293,
    Esquio = 373,
    ["Estuary Flow Catalog"] = 1085,
    ["Ethereum ERC1155"] = 1307,
    ["Ethereum ERC721"] = 1306,
    ...
    ["Evolving Resolutive Process notation"] = 1270,
    ["Expo SDK"] = 384,
    ...
    ["GeoJSON.json latest"] = 1083,
    GherKing = 1087,
    ["GitHub Action"] = 421,
    ["GitHub Actions typing"] = 1205,
    ["GitHub Discussion"] = 422,
    ["GitHub Funding"] = 423,
    ["GitHub Issue Template configuration"] = 424,
    ["GitHub Issue Template forms"] = 425,
    ["GitHub Pages Jekyll"] = 426,
    ["GitHub Workflow"] = 427,
    ["GitHub Workflow Template Properties"] = 428,
    ["GitHub automatically generated release notes configuration"] = 429,
    ["GitLab Agent for Kubernetes configuration"] = 1159,
    GitVersion = 418,
    ["Gitea Issue Template configuration"] = 419,
    ["Gitea Issue Template forms"] = 420,
    ["Gitpod Automations"] = 431,
    ["Gitpod Configuration"] = 432,
    ["GlazeWM settings"] = 1161,
    ["Global Privacy Control"] = 417,
    Goblet = 1140,
    ["Golangci-lint Configuration"] = 447,
    ["Golangci-lint Custom Plugins Configuration"] = 448,
    ["Google Chrome Related Website Sets"] = 395,
    ["Google Cloud Workflows"] = 273,
    ["Google Digital Assetlinks"] = 1249,
    Goreleaser = 450,
    ["Goreleaser Pro"] = 451,
    Goss = 453,
    ["Gradle Build Cache Node"] = 1033,
    ["Gradle Enterprise"] = 1032,
    ["Grafana 5.x Dashboard"] = 454,
    ["GraphQL Code Generator"] = 459,
    ["GraphQL Config"] = 458,
    ["GraphQL Mesh"] = 457,
    ["GroovyLint configuration"] = 460,
    ["Grunt JSHint task"] = 464,
    ["Grunt Watch task"] = 465,
    ["Grunt base task"] = 466,
    ["Grunt clean task"] = 462,
    ["Grunt copy task"] = 461,
    ["Grunt cssmin task"] = 463,
    HEMTT = 997,
    Hadolint = 1011,
    Hammerkit = 1043,
    ["Hardware Sentry Configuration"] = 1099,
    ["Hashgraph Online Skill Manifest"] = 3,
    ["HashiCorp Vault"] = 467,
    Hatch = 1012,
    Hayson = 469,
    ["Haystack Pipeline"] = 470,
    ["Hazelcast 5 Configuration"] = 471,
    ["Hecate Input Schema"] = 1260,
    ["Helm Chart.lock"] = 237,
    ["Helm Chart.yaml"] = 236,
    ["Helm Unittest Test Suite"] = 238,
    ["Hex file"] = 239,
    ["Home Assistant Integration Manifest"] = 472,
    ["Homer dashboard configuration"] = 473,
    Hugo = 1075,
    ["Hugo Theme"] = 1074,
    ["Hulak Configuration"] = 480,
    ["Hyperfoil benchmark configuration"] = 479,
    ["IBM Zapp document"] = 481,
    ["IBM zCodeFormatSettings"] = 482,
    ["IMG Catapult PSP"] = 487,
    ["IVMS101 by CODE Protocol"] = 1160,
    ["Infinispan Configuration"] = 489,
    ["Infinispan Server Configuration"] = 490,
    Infrahub = 491,
    Istanbul = 1103,
    ["JDownloader2 crawler multi-rules"] = 505,
    ["JDownloader2 crawler single-rules"] = 504,
    ["JFrog Applications Config"] = 506,
    ["JFrog File Spec"] = 507,
    ["JFrog Pipelines YML DSL"] = 1109,
    ["JMeter DSL cli config"] = 508,
    JReleaser = 511,
    ["JSON Document Transform"] = 519,
    ["JSON Feed"] = 520,
    ["JSON Resume"] = 779,
    ["JSON Schema Draft 2020-12"] = 979,
    ["JSON Schema Draft 4"] = 976,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1142,
    ["JSON Schema Draft 7"] = 977,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1143,
    ["JSON Schema Draft 8 (2019-09)"] = 978,
    ["JSON-API"] = 518,
    ["JSON-e templates"] = 1040,
    ["JSON-stat 2.0"] = 972,
    JSONPatch = 522,
    ["JSR Package Config (jsr.json)"] = 512,
    Jarl = 1276,
    Jasmine = 499,
    Jekyll = 500,
    ["Jenkins X Pipelines"] = 501,
    ["Jenkins X Requirements"] = 502,
    Jest = 503,
    Jocker = 509,
    ["Jovo Language Models"] = 510,
    ["Jujutsu (jj) VCS config"] = 1262,
    ["KIMMDY config file"] = 533,
    ["KODE/CI build.yaml"] = 1105,
    ["KSP-AVC"] = 973,
    ["KSP-CKAN"] = 974,
    ["KSP-NetKAN"] = 975,
    KSY = 1172,
    ...
    Kas = 525,
    ["Kestra flow file"] = 534,
    ["Keycloak REST API"] = 1112,
    ["Knative Functions - func.yaml"] = 408,
    Knip = 409,
    ["Knowledge Unit"] = 542,
    ["Kometa (nightly) config file"] = 536,
    ["Kometa config file"] = 535,
    ["Kong DBLess config"] = 1106,
    KrakenD = 537,
    ["Kubri Configuration"] = 545,
    LOOBin = 560,
    ["Lake configuration file"] = 1265,
    ...
    ["Lando (landofile)"] = 113,
    ["LangGraph Platform configuration"] = 1184,
    ["Language configuration"] = 1183,
    Lefthook = 549,
    ["Liferay client-extension.yaml"] = 556,
    ["LinkML Metamodel"] = 558,
    Liquibase = 1050,
    ["Liquibase Flow File"] = 1051,
    ["Lively Properties"] = 559,
    ["Lobe AI Agent"] = 115,
    Loki = 116,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 602,
    ["MS2Rescore Configuration"] = 607,
    ["Madness (madness.yml)"] = 1123,
    ["Mado configuration"] = 566,
    ["Maestro Flow"] = 567,
    ["Mail Servers Configuration"] = 1297,
    ["MapEHR Mapping"] = 568,
    Markdownlint = 1054,
    ["Mason Registry"] = 1057,
    ["MegaLinter Custom Flavor"] = 571,
    ["MegaLinter configuration"] = 570,
    ["MegaLinter descriptor"] = 572,
    Melange = 1150,
    ["Meltano project definition"] = 573,
    ["Mergify Configuration"] = 608,
    ["Metadata for a Bazel module"] = 574,
    ["Metadata for a Cinnamon spice"] = 1201,
    ["Metatype Configuration"] = 575,
    ["MetricsHub Configuration"] = 576,
    ["MetricsHub Connector Configuration"] = 577,
    ["Micro Editor Syntax"] = 1133,
    ["Microsoft Band Web Tile"] = 578,
    ["Microsoft RulesEngine workflow rules"] = 1188,
    ["Microsoft RulesEngine workflow rules list"] = 1189,
    ["Minecraft Custom Main Menu Mod"] = 1151,
    ["Minecraft Data Pack Advancement"] = 580,
    ["Minecraft Data Pack Biome"] = 581,
    ["Minecraft Data Pack Configured Carver"] = 582,
    ["Minecraft Data Pack Damage Type"] = 583,
    ["Minecraft Data Pack Dimension"] = 585,
    ["Minecraft Data Pack Dimension Type"] = 584,
    ["Minecraft Data Pack Item Modifier"] = 586,
    ["Minecraft Data Pack Loot Table"] = 587,
    ["Minecraft Data Pack Metadata"] = 588,
    ["Minecraft Data Pack Predicate"] = 589,
    ["Minecraft Data Pack Recipe"] = 590,
    ["Minecraft Data Pack Tag"] = 591,
    ["Minecraft Data Pack Template Pool"] = 592,
    ["Minecraft Data Pack Trim Material"] = 597,
    ["Minecraft Data Pack Trim Pattern"] = 598,
    ["Minecraft Resource Pack Lang"] = 593,
    ["Minecraft Resource Pack Particle"] = 594,
    ["Minecraft Resource Pack Texture Mcmeta"] = 596,
    ["Minecraft Resourcepack Sounds"] = 595,
    ["MockServer Expectations"] = 604,
    ModuleAssembler = 600,
    ["Monade CLI Stack Configuration"] = 611,
    ["MongoDB Atlas Search Index Definition"] = 1104,
    ["Monika Configuration"] = 1102,
    ["Monoweave Configuration"] = 606,
    ["Motif config"] = 993,
    MultiQC = 1242,
    ["NOX Framework (Service)"] = 629,
    ["Netin Diagnostic System Template"] = 1061,
    ["Netlify config"] = 614,
    ["Network-as-Code Data Model"] = 615,
    ["Next Gen UI Agent A2A Server Configuration"] = 616,
    ["Next Gen UI Agent Configuration"] = 618,
    ["Next Gen UI Agent MCP Server Configuration"] = 617,
    ["Nightwatch.js"] = 622,
    ["Node.js configuration"] = 998,
    ["NueJS configuration file"] = 634,
    ["Nuitka Package Config"] = 1165,
    ["Nullstone config"] = 636,
    ["ONe's changelog entry"] = 655,
    ["ONe's service descriptor"] = 654,
    ["ORT Server repository environment configuration"] = 665,
    ["OSCAL Assessment Plan (AP)"] = 667,
    ["OSCAL Assessment Results (AR)"] = 668,
    ["OSCAL Catalog"] = 669,
    ["OSCAL Component Definition (CDef)"] = 670,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 671,
    ["OSCAL Profile"] = 672,
    ["OSCAL System Security Plan (SSP)"] = 673,
    ["OSS Review Toolkit configuration"] = 674,
    ["OSS Review Toolkit curation"] = 675,
    ["OSS Review Toolkit package configuration"] = 676,
    ["OSS Review Toolkit project package manager definition"] = 677,
    ["OSS Review Toolkit repository configuration"] = 678,
    ["OSS Review Toolkit resolutions"] = 679,
    ["October CMS columns"] = 640,
    ["October CMS fields"] = 641,
    ["Oh My Posh"] = 643,
    Okteto = 644,
    ["Ona Automations"] = 646,
    Opctl = 996,
    ["Open Data Contract Standard (ODCS)"] = 659,
    ["Open Data Product Standard (ODPS)"] = 660,
    ["Open Know-How"] = 1247,
    OpenDecree = 1311,
    ["OpenDecree Configuration"] = 1312,
    ["OpenRewrite Resource"] = 657,
    OpenSRM = 661,
    OpenStatus = 1258,
    ["OpenTelemetry Declarative Configuration"] = 658,
    ["OpenUtau character yaml"] = 651,
    ["OpenUtau ustx"] = 652,
    ["OpenWeather Current Weather API"] = 1039,
    ["OpenWeather Road Risk API"] = 1038,
    ["Ory Hydra configuration"] = 478,
    ["Ory Keto configuration"] = 541,
    ["Ory Kratos configuration"] = 666,
    ["Ory Oathkeeper configuration"] = 638,
    ["Outblocks App configuration"] = 663,
    ["Outblocks database table"] = 664,
    ["Outblocks project configuration"] = 662,
    PDM = 687,
    POPxf = 699,
    ["POPxf Correlations"] = 700,
    ["PRML manifest"] = 707,
    Packer = 683,
    PactSpec = 684,
    Panache = 685,
    Pantsbuild = 1119,
    ["Paper paper-plugin.yml"] = 686,
    ["Pipeline component"] = 1052,
    ["Platform.sh application"] = 9,
    ["Platform.sh routes"] = 10,
    ["Platform.sh services"] = 11,
    ["Plex Prerolls"] = 697,
    ["PocketMine plugin.yml"] = 694,
    ["Podman Desktop Extension"] = 1330,
    ["Postman collection"] = 703,
    ["Power Pages Configuration"] = 1259,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1204,
    ["ProActions AI-Kit Configuration"] = 715,
    ["ProActions AI-Kit Configuration for Menus"] = 717,
    ["ProActions AI-Kit Configuration for Sections"] = 719,
    ["ProActions AI-Kit Configuration for Services"] = 716,
    ["ProActions AI-Kit Configuration for Steps"] = 720,
    ["ProActions AI-Kit Configuration for Templates"] = 718,
    ["Problem object RFC9457"] = 1148,
    ["Problem package format"] = 721,
    ["Problem package generators"] = 722,
    ["Problem package submissions"] = 723,
    ["Problem package test group metadata"] = 724,
    Pterodactyl = 1098,
    ["Pull Request Labeler"] = 741,
    Pulumi = 749,
    ["PyGTA Config"] = 745,
    PyProject = 750,
    Pylock = 1250,
    Pyright = 751,
    ["Python script metadata"] = 1244,
    ["QType AI DSL"] = 754,
    Qgoda = 753,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1322,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1320,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1326,
    ["Qlik Talend Cloud Pipeline - Project"] = 1318,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1321,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1323,
    ["Qlik Talend Cloud Pipeline - Task"] = 1319,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1325,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1324,
    Qodana = 1071,
    ["Qt Creator workspace file"] = 1181,
    ["Quali Torque Blueprint Spec 2"] = 1096,
    ["QueryFirst config file"] = 1115,
    ["QuikRun Configuration"] = 1327,
    ["Qwen Code Settings"] = 1308,
    ["RKE Cluster Configuration JSON"] = 1049,
    ["RKE Cluster Configuration YAML"] = 1048,
    RadioHound = 744,
    ["Raid Profile"] = 1309,
    ["Raid Repo Configuration"] = 1310,
    Railpack = 756,
    Railway = 755,
    ["Rancher Fleet"] = 746,
    ["Rattler-build"] = 757,
    Ray = 1010,
    ["Read the Docs"] = 748,
    ["Red-DiscordBot Cog"] = 764,
    ["Red-DiscordBot Cog Repo"] = 765,
    ["Red-DiscordBot Trivia"] = 766,
    ["Releasaurus Config"] = 6,
    ReleaseKit = 5,
    ["Render Blueprints"] = 1047,
    RenderCV = 783,
    Renovate = 780,
    ["Renovate global configuration"] = 781,
    ["Renovate inherited configuration"] = 782,
    ["Replit config"] = 772,
    Restate = 1237,
    ["Revel Digital Gadget Definition File"] = 1261,
    RoadRunner = 785,
    ["Robust Station Image"] = 1267,
    Rockcraft = 786,
    ["Roo Coder Custom Modes"] = 787,
    Rubocop = 776,
    ["Rudder techniques"] = 1155,
    Ruff = 777,
    ["Rust Project"] = 778,
    ["Rust toolchain"] = 792,
    ["SDMX data message"] = 819,
    ["SDMX metadata message"] = 818,
    ["SDMX structure message"] = 817,
    ["SIL Kit Participant Configuration"] = 829,
    ["SIL Kit Registry Configuration"] = 830,
    ["SPDX 2.3"] = 868,
    SWADL = 884,
    ["Safebox Config"] = 1110,
    ["Sapphire CLI Config"] = 795,
    ["SauceCTL Configuration"] = 1058,
    Scarb = 815,
    ["Schema Catalog"] = 810,
    ["Scoop manifest"] = 816,
    ["Semantic Data Fabric (SDF) file"] = 820,
    ["Semgrep Rule"] = 822,
    ["Serenity Code Generator (Sergen)"] = 823,
    ["Serverless Framework Configuration"] = 1065,
    ["Serverless Workflow"] = 1067,
    ["Settings for a Cinnamon spice"] = 1200,
    ["Settings.paf"] = 825,
    ["Shopware 6 Configuration"] = 1068,
    ["Shopware CLI Extension Store Configuration"] = 1069,
    ["Shopware CLI Project Store Configuration"] = 1070,
    ["Sigma Detection Rule"] = 827,
    ["SigmaCV CV"] = 1,
    ["Sigrid scope configuration file"] = 828,
    ["SkyPilot Task JSON"] = 1156,
    ["Slack app manifest"] = 832,
    Snapcraft = 834,
    ["Solarxy project config"] = 837,
    Solidarity = 838,
    ["Solution filters"] = 839,
    ["Source Maps v3"] = 840,
    Sourcery = 841,
    ["Spack bootstrap.yaml"] = 842,
    ["Spack cdash.yaml"] = 843,
    ["Spack ci.yaml"] = 844,
    ["Spack compilers.yaml"] = 845,
    ["Spack concretizer.yaml"] = 846,
    ["Spack config.yaml"] = 847,
    ["Spack definitions.yaml"] = 848,
    ["Spack develop.yaml"] = 849,
    ["Spack env_vars.yaml"] = 850,
    ["Spack environment"] = 856,
    ["Spack include.yaml"] = 851,
    ["Spack mirrors.yaml"] = 852,
    ["Spack modules.yaml"] = 853,
    ["Spack packages.yaml"] = 854,
    ["Spack repos.yaml"] = 855,
    ["Spack toolchains.yaml"] = 857,
    ["Spack upstreams.yaml"] = 858,
    ["Spack view.yaml"] = 859,
    ["Speakeasy Generation Config File"] = 863,
    ["Speakeasy Lint Configuration File"] = 860,
    ["Speakeasy Test Generation Configuration File"] = 861,
    ["Speakeasy Workflow File"] = 862,
    SpecIF = 864,
    ["Specmatic Configuration"] = 865,
    ["Sponge Mixin configuration"] = 866,
    StackBlitz = 872,
    ["StackHawk Scanner Configuration"] = 1064,
    Stale = 873,
    Starfish = 874,
    ["Starlake Data Pipeline"] = 1036,
    Starship = 875,
    ["Statamic Blueprint"] = 876,
    ["Stella configuration file"] = 877,
    ["Streamlit configuration file"] = 878,
    ["Stryker Mutator"] = 881,
    ["StyleCop Analyzers Configuration"] = 882,
    ["Stylelint (.stylelintrc)"] = 883,
    ["Stylua Config"] = 1251,
    ["Sublime Syntax"] = 1111,
    ["Subsquid squid manifest"] = 1158,
    ["Swagger API 2.0"] = 885,
    ["Synadia Connect Component"] = 886,
    TSON = 922,
    TSTyche = 923,
    ["TYPO3 Vendor Bundler config"] = 929,
    ["Tab data for a LinUtil"] = 1207,
    ["Tab list for a LinUtil"] = 1206,
    Tach = 887,
    ["Tach Domain"] = 888,
    Talhelper = 890,
    ["Talisman configuration"] = 891,
    Taplo = 1252,
    ["Taskfile config"] = 1041,
    Taurus = 892,
    Tauticord = 893,
    ["Tekton Pipeline"] = 1280,
    ["Tekton PipelineRun"] = 1281,
    ["Tekton Task"] = 1278,
    ["Tekton TaskRun"] = 1279,
    Telefonistka = 1238,
    ["Terrateam config"] = 1264,
    ["TestEnvironment.json"] = 905,
    ["TextMate Grammar"] = 904,
    Threagile = 899,
    ["Tier.run pricing.json"] = 896,
    Tikibase = 897,
    Tombi = 902,
    ["Traefik v2"] = 908,
    ["Traefik v2 File Provider"] = 909,
    ["Traefik v3"] = 910,
    ["Traefik v3 File Provider"] = 911,
    ["Travis CI (.travis.yml)"] = 907,
    Treefmt = 456,
    Trident = 1234,
    ["TrueScript for *.tscript files"] = 914,
    ["Tugboat QA config.yml"] = 1231,
    TunnelHub = 1146,
    Turborepo = 906,
    Tycho = 1195,
    Tye = 1072,
    ["Tyk Gateway - Open Source v5.7+"] = 1243,
    ["UET BuildConfig.json"] = 1116,
    ["UI5 Manifest"] = 935,
    ["UNCORS configuration"] = 940,
    ["UTAM Page Object"] = 938,
    ["Ubuntu Server Autoinstall"] = 933,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1235,
    ["Uniswap Token List"] = 1021,
    ["Universal Schedule Format"] = 941,
    ["Unreal Engine Uplugin"] = 1117,
    ["Unreal Engine Uproject"] = 1118,
    ["UpCloud CLI (upctl) configuration"] = 1236,
    ["Updatecli Compose"] = 1080,
    ["Updatecli Policy Manifest"] = 1081,
    ["Updatecli Policy Metadata"] = 1082,
    Uplift = 1114,
    ["Upsun config"] = 8,
    ["User Journey Map"] = 1046,
    V2Ray = 1086,
    ["VSCode Code Snippets"] = 261,
    ["VSIX CLI publishing"] = 959,
    Vector = 943,
    ["Vela Pipeline Configuration"] = 946,
    Vercel = 260,
    ["Version Bumper config"] = 949,
    Vespertide = 1285,
    ["Vespertide Migration"] = 1286,
    ["Vespertide Model"] = 1287,
    ["Viash Component Config"] = 1240,
    ["Viash Package Config"] = 1241,
    Visivo = 1144,
    ["WP-CLI"] = 969,
    Wake = 1233,
    ["Waku Config"] = 1210,
    ["Web App Manifest"] = 965,
    ["Web types"] = 968,
    WebExtensions = 964,
    ["Webman package recipe"] = 1092,
    ["Windows Package Manager Installer Manifest"] = 1018,
    ["Windows Package Manager Locale Manifest"] = 1019,
    ["Windows Package Manager Singleton Manifest"] = 1017,
    ["WireMock CLI import configuration"] = 1216,
    ["WireMock CLI local service configuration"] = 1215,
    ["WireMock message stub mapping"] = 1214,
    ["WireMock stub mapping"] = 1213,
    ["Woodpecker pipeline config"] = 1060,
    ["Wrangler CLI"] = 970,
    ["XenForo add-on manifest"] = 971,
    ["Xstate Machine"] = 1078,
    ["Yandex Workflow Language"] = 1202,
    ["Yarn Config (.yarnrc.yml)"] = 1034,
    ["Yippee-Ki-JSON configuration YML"] = 1025,
    ["YouTrack App"] = 1199,
    ["Zarf Package Configuration"] = 1266,
    ["Zerops import file"] = 1187,
    ["Zola Configuration"] = 1277,
    ["aerleon.yml"] = 22,
    ["amplify.yml"] = 15,
    ["amxx-builder manifest"] = 1329,
    ["angular.json"] = 39,
    apko = 1149,
    ...
    ["behat.yml"] = 146,
    ["bigquery-table"] = 135,
    ["bioimageio resource description"] = 1166,
    ...
    ["cargo-nextest repository configuration"] = 619,
    ["cargo-nextest user configuration"] = 620,
    ["ccmod.json"] = 1211,
    changelogging = 1178,
    ...
    ["chutzpah.json"] = 269,
    cibuildwheel = 183,
    ["clang-format (.clang-format)"] = 1084,
    ["clang-tidy"] = 245,
    clangd = 244,
    clib = 246,
    ...
    ["crowdin.yml"] = 295,
    ["ctfd-setup configuration file"] = 1223,
    ["custom-elements.json"] = 1136,
    ["cypress.json"] = 299,
    ["dacier.yml"] = 1317,
    ...
    ["gematik health care insurance list"] = 1229,
    ["gematik health care patient list"] = 1226,
    ["gematik health care provider institution list"] = 1228,
    ["gematik health care provider list"] = 1227,
    ["gematik tiger test environment configuration"] = 1230,
    ["git-town.toml"] = 1275,
    ["gitlab-ci"] = 430,
    ["global.json"] = 446,
    ["go-feature-flag Flag Configuration"] = 449,
    ["haxelib.json"] = 468,
    helmfile = 1013,
    helmwave = 1014,
    ["host-meta.json"] = 475,
    ...
    ["ide.host.json"] = 483,
    ["ifstate.yaml"] = 484,
    ["imageoptimizer.json"] = 485,
    ["importmap.json"] = 488,
    instant_python_config = 492,
    instant_python_custom_project = 493,
    intlayer = 494,
    ["ioBroker Configuration"] = 495,
    ["ioBroker JSON UI"] = 496,
    ["ioBroker Package manifest"] = 497,
    ["ixpect.conf.yaml"] = 498,
    ["ize.toml"] = 1113,
    ["jsconfig.json"] = 523,
    ["jscpd Configuration"] = 1097,
    jsdoc = 1009,
    ["k3d.yaml"] = 524,
    ["k9s aliases.yaml"] = 526,
    ["k9s cluster-config.yaml"] = 528,
    ["k9s config.yaml"] = 527,
    ["k9s hotkeys.yaml"] = 529,
    ["k9s plugins.yaml"] = 530,
    ["k9s skin.yaml"] = 531,
    ["k9s views.yaml"] = 532,
    ["kontinuous-config.yaml"] = 544,
    ["kontinuous-values.yaml"] = 543,
    ["kustomization.yaml"] = 546,
    ["label-commenter-config.yml"] = 547,
    ["latexindent configuration"] = 114,
    ["launchsettings.json"] = 548,
    lazydocker = 1135,
    lazygit = 1134,
    ["lego.json"] = 550,
    ["lerna.json"] = 551,
    ["lgtm.yml"] = 552,
    ["liblab.config.json"] = 553,
    ["libman.json"] = 554,
    ["license-report-config.json"] = 555,
    ["linkinator.config.json"] = 557,
    ["lint-staged (.lintstagedrc)"] = 987,
    ["local.settings.json"] = 562,
    ["localazy.json"] = 563,
    ["lotus.yaml"] = 561,
    ["lsdlschema.json"] = 564,
    ["macro.json"] = 1101,
    ["markdown-link-check"] = 1055,
    maturin = 1056,
    mboats = 1063,
    memnex = 1315,
    ["micro-settings.json"] = 1128,
    ["mimetypes.json"] = 579,
    ["mirrord config"] = 989,
    mise = 990,
    ["mkdocs.yml"] = 599,
    ...
    ["monospace.yml"] = 605,
    ["moon.yml"] = 1212,
    ["mprocs Configuration file"] = 1182,
    ["mrdocs.yml"] = 601,
    ["mta.yaml"] = 991,
    ["mtad.yaml"] = 992,
    ["mycode.json"] = 612,
    nFPM = 621,
    ["napari plugin manifest"] = 613,
    neoload = 1004,
    ["nest-cli"] = 624,
    ["nexus-rpc-gen"] = 1302,
    ["ninjs (News in JSON)"] = 623,
    ["nitro.json"] = 1003,
    ["nixd configuration"] = 1154,
    ["nlu.json"] = 625,
    ["nodemon.json"] = 627,
    ["noodl config"] = 1062,
    ["notebook.mod.json"] = 628,
    now = 999,
    ["npm-badges"] = 631,
    ["nswag.json"] = 635,
    ntangle = 637,
    ["nuclei-template.yaml"] = 632,
    ["nuget-project.json"] = 633,
    ["ocelot.json"] = 639,
    ogen = 642,
    ["omnisharp.json"] = 645,
    openHAB = 1288,
    ...
    oxlint = 1299,
    ["package.json"] = 680,
    ["package.manifest"] = 682,
    ["package.yaml"] = 681,
    ["partial-black.json"] = 147,
    ["partial-fastapi.json"] = 148,
    ["partial-pixi.json"] = 692,
    ["partial-scheduled.json"] = 149,
    ["pattern.json"] = 690,
    ["petstore-v1.0"] = 1108,
    pgap_yaml_input_reader = 688,
    pgrls = 689,
    pgxgen = 1292,
    pitcms = 1295,
    ["pixi.toml"] = 691,
    ["plagiarize-me.yaml"] = 696,
    ["plagiarize.yaml"] = 695,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1219,
    ["podbard.yaml"] = 698,
    ["portman.json"] = 701,
    ["prefect.toml"] = 710,
    ["prefect.yaml"] = 711,
    ...
    ["prettierrc.json"] = 713,
    ["prisma.yml"] = 714,
    ["project-1.0.0-beta3.json"] = 726,
    ["project-1.0.0-beta4.json"] = 727,
    ["project-1.0.0-beta5.json"] = 728,
    ["project-1.0.0-beta6.json"] = 729,
    ["project-1.0.0-beta8.json"] = 730,
    ["project-1.0.0-rc1.json"] = 731,
    ["project-1.0.0-rc2.json"] = 732,
    ["project.json"] = 725,
    ["project.owasp.yaml"] = 733,
    ["prometheus-alertmanager.json"] = 737,
    ["prometheus.json"] = 734,
    ["prometheus.rules.json"] = 735,
    ["prometheus.rules.test.json"] = 736,
    ["proxies.json"] = 738,
    ["publiccode.yml"] = 739,
    ["pubspec.yaml"] = 740,
    ["pyrseas-0.8.json"] = 743,
    pytest = 752,
    ["quilt.mod.json"] = 1129,
    ["rc3 auth"] = 758,
    ["rc3 collection"] = 759,
    ...
    ["rc3 settings"] = 763,
    ["registry.yaml"] = 52,
    ["release drafter"] = 1005,
    ["release-hub.json"] = 4,
    ["release-please-config.json"] = 768,
    ["release-please-manifest.json"] = 769,
    ["release-plz.toml"] = 770,
    ["renv.lock"] = 784,
    ["reposets Configuration"] = 773,
    ["reposets Credentials"] = 774,
    ["revola.json"] = 2,
    ["rivet.json"] = 1153,
    ["rivet.yaml (legacy)"] = 1152,
    rumdl = 789,
    runny = 788,
    runspec = 1316,
    rustfmt = 790,
    ...
    samt = 793,
    samtrc = 794,
    ["sarif-1.0.0.json"] = 796,
    ["sarif-2.0.0.json"] = 797,
    ["sarif-2.1.0"] = 807,
    ["sarif-2.1.0-rtm.2"] = 798,
    ["sarif-2.1.0-rtm.3"] = 800,
    ["sarif-2.1.0-rtm.4"] = 802,
    ["sarif-2.1.0-rtm.5"] = 804,
    ["sarif-2.1.0-rtm.6"] = 805,
    ["sarif-external-property-file-2.1.0"] = 808,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 799,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 801,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 803,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 806,
    ["scalingo.json configuration"] = 809,
    ["schema.org - Action"] = 811,
    ["schema.org - ContactPoint"] = 812,
    ["schema.org - Place"] = 813,
    ["schema.org - Thing"] = 814,
    ["secrethub.yml"] = 1131,
    ["semantic-release"] = 821,
    ["servicehub.config.json"] = 982,
    ["servicehub.service.json"] = 981,
    ["settings.job"] = 824,
    ["sfdx-hardis configuration"] = 826,
    ["shard.yml"] = 1169,
    ["size-limit configuration"] = 831,
    ["skaffold.yaml"] = 1053,
    ["skyuxconfig.json"] = 833,
    ["snowflake-config"] = 835,
    ["snowflake-connections"] = 836,
    ["spicepod.yaml"] = 1190,
    ["sqlc configuration"] = 869,
    ["stripe-app-local.json"] = 880,
    ["stripe-app.json"] = 879,
    swcrc = 1037,
    ["task.json"] = 889,
    taskcat = 1000,
    ["template.json"] = 894,
    ["templatsources.json"] = 895,
    ["text2confl config"] = 1300,
    ["theme.json"] = 898,
    ["tizen_workspace.json"] = 900,
    tldr = 901,
    ["tm_devices configuration file"] = 1257,
    tmuxinator = 985,
    tox = 903,
    ["transcend.yml"] = 912,
    ["tree-sitter grammar.json"] = 455,
    ["trime.yaml"] = 913,
    ["trunk.yaml"] = 915,
    ["ts-force-config.json"] = 920,
    ["tsconfig.json"] = 916,
    ["tsd.json"] = 917,
    ["tsdoc.json"] = 918,
    ["tsdrc.json"] = 919,
    ...
    ["vega-lite.json"] = 945,
    ["vega.json"] = 944,
    ["venvironment.yaml"] = 947,
    ["venvplus.yaml"] = 948,
    version = 1239,
    ["version.json"] = 950,
    ["vhwdebugger-binding.yaml"] = 952,
    ["vim-addon-info"] = 953,
    ["vs-2017.3.host.json"] = 955,
    ["vs-nesting.json"] = 956,
    ["vsls.json"] = 954,
    ["vss-extension.json"] = 960,
    vtcfg = 1245,
    ["vtesttree.yaml"] = 961,
    ["vtestunit.yaml"] = 962,
    ["warp-keysets.json"] = 1137,
    ["warp-themes.json"] = 1138,
    ["warp-workflows.json"] = 1139,
    ["webhint.io"] = 1093,
    ["webjobpublishsettings.json"] = 967,
    ["webjobs-list.json"] = 966,
    ["well-known-fursona"] = 1177,
    ["xs-app.json"] = 995,
    ["xunit.runner.json"] = 980,
    yamlfmt = 1022,
    yamllint = 1023,
    ["yap.json"] = 1024,
    ["zerops.yml"] = 1186,
