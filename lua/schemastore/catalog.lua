...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 145,
    [".cryproj (generic)"] = 493,
    [".cryproj engine-5.2"] = 488,
    [".cryproj engine-5.3"] = 489,
    [".cryproj engine-5.4"] = 490,
    [".cryproj engine-5.5"] = 491,
    [".cryproj engine-dev"] = 492,
    [".csscomb.json"] = 147,
    [".csslintrc"] = 148,
    [".eslintrc"] = 193,
    [".esmrc.json"] = 185,
    ...
    [".mtaext"] = 502,
    [".nodehawkrc"] = 311,
    [".npmpackagejsonlintrc"] = 314,
    [".phraseapp.yml"] = 348,
    [".pmbot.yml"] = 340,
    [".postcssrc"] = 345,
    [".pre-commit-config.yml"] = 346,
    [".pre-commit-hooks.yml"] = 347,
    [".putout.json"] = 365,
    [".rehyperc"] = 372,
    [".remarkrc"] = 373,
    [".sprite files"] = 416,
    ...
    [".vsext"] = 468,
    [".yarnrc.yml"] = 534,
    ["<div>RIOTS' studio configuration"] = 472,
    ["@factorial/drupal-breakpoints-css"] = 4,
    ["A micro editor config schema"] = 281,
    ["API Builder"] = 531,
    ["AVA Configuration Schema"] = 586,
    ["AWS CDK cdk.json"] = 133,
    ["AWS CloudFormation"] = 134,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 135,
    ["Airlock Microgateway"] = 8,
    ["Airplane task"] = 9,
    ["Alacritty Configuration Schema"] = 561,
    ...
    ["Azure IoT Edge deployment"] = 43,
    ["Azure IoT Edge deployment template"] = 44,
    ["Azure IoT EdgeAgent deployment"] = 41,
    ["Azure IoT EdgeHub deployment"] = 42,
    ["Azure Pipelines"] = 45,
    ["Azure Static Web Apps CLI configuration file"] = 418,
    ["Azure Static Web Apps configuration file"] = 417,
    ["BX CI"] = 76,
    ["Better Code Hub"] = 536,
    ["Better Scripts"] = 77,
    BizTalkServerApplicationSchema = 508,
    ["Block Protocol Metadata"] = 75,
    Briefcase = 513,
    ["Build Info"] = 68,
    Buildkite = 70,
    ["Bukkit plugin.yml"] = 69,
    ["BungeeCord plugin.yml"] = 73,
    ["Butane Config"] = 573,
    ["CICS TS region tagging"] = 580,
    ["CICS TS resource import"] = 581,
    ["CICS TS resource model"] = 582,
    ["CICS TS resource overrides"] = 583,
    ["CMake Presets"] = 78,
    ["CNC Codes JSON Schema"] = 87,
    ["Calqulus pipeline"] = 79,
    ["Camel YAML DSL"] = 80,
    Carafe = 81,
    ["Cargo Config Schema"] = 82,
    ["Cargo Make"] = 83,
    ["Catalog Info Backstage"] = 84,
    Cheatsheets = 570,
    ["Chrome Extension"] = 127,
    ["CircleCI config.yml"] = 108,
    ["Citation File Format"] = 136,
    CityJSON = 85,
    ["Code Climate"] = 109,
    Codux = 116,
    ["Commandbox Box.json"] = 88,
    ["Commandbox Server.json"] = 89,
    ["Common Catalog Schema"] = 125,
    ["Common types for all schemas"] = 1,
    Conjure = 86,
    ["Container Structure Test"] = 519,
    Containerlab = 543,
    ["DWP Exchange - catalogue entry"] = 182,
    ["DWP Exchange - gateway"] = 180,
    ["DWP Exchange - meta"] = 181,
    ["Dart build configuration"] = 149,
    ["Dart test config"] = 150,
    ["DashLord configuration"] = 151,
    ["Datadog Service Definition"] = 266,
    ["Datahub Ingestion Recipe Schema"] = 587,
    ["Deadpendency Config Schema"] = 91,
    ["Dein Config Schema"] = 92,
    Deno = 155,
    ["Deployer Recipe"] = 158,
    Devfile = 179,
    ["Discord Webhook"] = 160,
    ["Dolittle Artifacts"] = 164,
    ["Dolittle Bounded Context Configuration"] = 165,
    ["Dolittle Event Horizons Configuration"] = 166,
    ["Dolittle Resources Configuration"] = 167,
    ["Dolittle Server Configuration"] = 168,
    ["Dolittle Tenant Map Configuration"] = 170,
    ["Dolittle Tenants Configuration"] = 169,
    ["Dolittle Topology"] = 171,
    ["Drupal Breakpoints Schema"] = 93,
    ["Drupal Config Schema"] = 104,
    ["Drupal Info Schema"] = 94,
    ["Drupal Layouts Schema"] = 95,
    ["Drupal Libraries Schema"] = 96,
    ["Drupal Links Action Schema"] = 97,
    ["Drupal Links Contextual Schema"] = 98,
    ["Drupal Links Menu Schema"] = 99,
    ["Drupal Links Task Schema"] = 100,
    ["Drupal Migration Schema"] = 101,
    ["Drupal Permissions Schema"] = 102,
    ["Drupal Routing Schema"] = 103,
    ["Drupal Services Schema"] = 105,
    ["Drush site aliases"] = 175,
    ["Embrace Config Schema"] = 598,
    ["Error pages"] = 188,
    Esquio = 186,
    ["Estuary Flow Catalog Schema"] = 577,
    ["Expo SDK"] = 191,
    ["F-Droid Data metadata"] = 196,
    ["Facets - FSDL - Application"] = 194,
    ["Fossa configuration file"] = 201,
    ["Fossa's fossa-deps file"] = 202,
    ["Foundry VTT - Manifest"] = 199,
    ["Foundry VTT - Template"] = 200,
    ["Foxx Manifest"] = 46,
    ["GatewayCore API Gateway"] = 205,
    ["GeoJSON.json latest"] = 575,
    GherKing = 579,
    ["GitHub Action"] = 209,
    ["GitHub Funding"] = 210,
    ["GitHub Issue Template configuration"] = 212,
    ["GitHub Workflow"] = 213,
    ["GitHub Workflow Template Properties"] = 214,
    ["GitHub issue forms"] = 211,
    GitVersion = 208,
    ["Gitpod Configuration"] = 216,
    ["Global Privacy Control"] = 206,
    ["Google Cloud Workflows"] = 132,
    Goreleaser = 219,
    ["Goreleaser Pro"] = 220,
    ["Gradle Build Cache Node"] = 533,
    ["Gradle Enterprise"] = 532,
    ["Grafana 5.x Dashboard"] = 221,
    ["GraphQL Code Generator"] = 224,
    ["GraphQL Config"] = 223,
    ["GraphQL Mesh"] = 222,
    ["Grunt JSHint task"] = 228,
    ["Grunt Watch task"] = 229,
    ["Grunt base task"] = 230,
    ["Grunt clean task"] = 226,
    ["Grunt copy task"] = 225,
    ["Grunt cssmin task"] = 227,
    HEMTT = 505,
    Hadolint = 517,
    ["Hardware Sentry Configuration"] = 591,
    Hayson = 232,
    ["Haystack Pipeline"] = 233,
    ["Hazelcast 5 Configuration"] = 234,
    ["Helm Chart.lock"] = 107,
    ["Helm Chart.yaml"] = 106,
    Hugo = 569,
    ["Istanbul Schema"] = 594,
    ["JDownloader2 crawler multi-rule schema"] = 250,
    ["JDownloader2 crawler single-rule schema"] = 249,
    ["JFrog File Spec"] = 251,
    ["JFrog Pipelines YML DSL"] = 600,
    ["JSON Document Transform"] = 259,
    ["JSON Feed"] = 260,
    ["JSON Resume"] = 378,
    ["JSON Schema Draft 2020-12"] = 484,
    ["JSON Schema Draft 4"] = 481,
    ["JSON Schema Draft 7"] = 482,
    ["JSON Schema Draft 8"] = 483,
    ["JSON schema for CodeShip Pro services configuration files"] = 118,
    ["JSON schema for CodeShip Pro steps configuration files"] = 119,
    ["JSON schema for Codecov configuration files"] = 117,
    ["JSON-API"] = 258,
    ["JSON-e templates"] = 541,
    ["JSON-stat 2.0"] = 478,
    JSONPatch = 262,
    Jasmine = 245,
    Jekyll = 246,
    ["Jenkins X Pipelines"] = 247,
    ["Jenkins X Requirements"] = 248,
    ["Jovo Language Models"] = 252,
    ["KSP-AVC"] = 479,
    ["KSP-CKAN"] = 480,
    ["Keycloak REST API"] = 606,
    ["Knative Functions - func.yaml"] = 203,
    ["KoDE/CI build.yaml"] = 596,
    ["Kong DBLess Schema"] = 597,
    KrakenD = 265,
    ["LinkML Metamodel"] = 277,
    Liquibase = 547,
    ["Liquibase Flow File"] = 548,
    Markdownlint = 551,
    ["MegaLinter configuration"] = 282,
    ["MegaLinter descriptor"] = 283,
    ["Meltano plugin discovery definition"] = 285,
    ["Meltano project definition"] = 284,
    ["Microsoft Band Web Tile"] = 286,
    ["Minecraft Data Pack Advancement"] = 288,
    ["Minecraft Data Pack Biome"] = 289,
    ["Minecraft Data Pack Configured Carver"] = 290,
    ["Minecraft Data Pack Dimension"] = 292,
    ["Minecraft Data Pack Dimension Type"] = 291,
    ["Minecraft Data Pack Item Modifier"] = 293,
    ["Minecraft Data Pack Loot Table"] = 294,
    ["Minecraft Data Pack Metadata"] = 295,
    ["Minecraft Data Pack Predicate"] = 296,
    ["Minecraft Data Pack Recipe"] = 297,
    ["Minecraft Data Pack Tag"] = 298,
    ["Minecraft Data Pack Template Pool"] = 299,
    ["Minecraft Resourcepack Sounds"] = 300,
    ["MongoDB Atlas Search Index Definition Schema"] = 595,
    ["Monika Configuration Schema"] = 593,
    ["Motif config"] = 501,
    ["NOX Framework (Service)"] = 313,
    ["Netin Diagnostic System Template"] = 556,
    ["Netlify config schema"] = 305,
    ["Nightwatch.js"] = 306,
    ["OSS Review Toolkit configuration"] = 330,
    ["OSS Review Toolkit curation"] = 331,
    ["OSS Review Toolkit package configuration"] = 332,
    ["OSS Review Toolkit repository configuration"] = 333,
    ["OSS Review Toolkit resolutions"] = 334,
    Opctl = 504,
    ["OpenWeather Current Weather API"] = 540,
    ["OpenWeather Road Risk API"] = 539,
    ["Ory Hydra configuration"] = 238,
    ["Ory Keto configuration"] = 267,
    ["Ory Kratos configuration"] = 329,
    ["Ory Oathkeeper configuration"] = 320,
    ["Outblocks App configuration"] = 327,
    ["Outblocks database table"] = 328,
    ["Outblocks project configuration"] = 326,
    Packer = 337,
    ["Pipeline component"] = 549,
    ["PocketMine plugin.yml"] = 341,
    Pterodactyl = 590,
    ["Pull Request Labeler"] = 364,
    Pulumi = 368,
    PyProject = 369,
    Qodana = 566,
    ["Quali Torque Blueprint Spec 2"] = 588,
    ["QueryFirst config file"] = 609,
    ["RKE Cluster Configuration JSON Schema"] = 546,
    ["RKE Cluster Configuration YAML Schema"] = 545,
    Ray = 516,
    ["Read the Docs"] = 367,
    ["Red-DiscordBot Cog"] = 370,
    ["Red-DiscordBot Cog Repo"] = 371,
    Renovate = 379,
    ["Replit schema"] = 374,
    RoadRunner = 380,
    Ruff = 376,
    ["Rust Project"] = 377,
    ["Rust toolchain"] = 382,
    ["SIL Kit Participant Configuration"] = 407,
    SWADL = 427,
    ["Sapphire CLI Config"] = 383,
    ["SauceCTL Configuration"] = 553,
    ["Schema Catalog"] = 396,
    ["Scoop manifest"] = 401,
    ["Semgrep Rule"] = 403,
    ["Serverless Framework Configuration"] = 560,
    ["Serverless Workflow Schema"] = 562,
    ["Settings.paf"] = 405,
    ["Shopware 6 Configuration"] = 563,
    ["Shopware CLI Extension Store Configuration"] = 564,
    ["Shopware CLI Project Store Configuration"] = 565,
    Solidarity = 411,
    ["Solution filters"] = 412,
    ["Source Maps v3"] = 413,
    SpecIF = 414,
    ["Sponge Mixin configuration"] = 415,
    ["StackHawk Scanner Configuration"] = 559,
    Stale = 419,
    Starship = 420,
    ["Statamic Blueprint"] = 421,
    ["StrmPrivacy Data Connector"] = 604,
    ["StrmPrivacy Data Contract"] = 605,
    ["StrmPrivacy SimpleSchema"] = 602,
    ["StrmPrivacy Stream"] = 603,
    ["StrmPrivacy batch job configuration file"] = 601,
    ["Stryker Mutator"] = 424,
    ["StyleCop Analyzers Configuration"] = 425,
    ["Swagger API 2.0"] = 428,
    TSON = 448,
    ["Talisman configuration"] = 429,
    ["Taskfile YAML Schema"] = 542,
    Taurus = 430,
    ["TestEnvironment.json"] = 437,
    Tikibase = 433,
    ["Traefik v2"] = 440,
    ["Traefik v2 File Provider"] = 441,
    Turborepo = 438,
    Tye = 567,
    ["UI5 Manifest"] = 454,
    ["UTAM Page Object"] = 456,
    ["Ubuntu Server Autoinstall"] = 452,
    ["Uniswap Token List"] = 525,
    ["Unreal Engine Uplugin"] = 610,
    ["Unreal Engine Uproject"] = 611,
    Updatecli = 574,
    Uplift = 608,
    ["User Journey Map YAML Schema"] = 544,
    V2Ray = 578,
    ["VSCode Code Snippets"] = 121,
    ["VSIX CLI publishing"] = 469,
    ["Vela Pipeline Configuration"] = 459,
    Vercel = 120,
    ["Web App Manifest"] = 474,
    ["Web types"] = 477,
    WebExtensions = 473,
    ["Webman package recipe"] = 584,
    ["Windows Package Manager Installer Manifest"] = 522,
    ["Windows Package Manager Locale Manifest"] = 523,
    ["Windows Package Manager Singleton Manifest"] = 521,
    ["Woodpecker pipeline config"] = 555,
    ["Xstate Machine Schema"] = 572,
    ["Yippee-Ki-JSON configuration YML"] = 527,
    ["angular.json"] = 10,
    ...
    ["batect.yml"] = 51,
    ["beau.yml"] = 535,
    ["beef-database-codegen"] = 53,
    ["beef-database-v5-codegen"] = 55,
    ["beef-entity-codegen"] = 54,
    ["beef-entity-v5-codegen"] = 56,
    ["behat.yml"] = 64,
    ["bigquery-table"] = 57,
    ["bitbucket-pipelines"] = 58,
    bitrise = 59,
    ["bitrise-step"] = 60,
    ["block.json"] = 74,
    ["bower.json"] = 62,
    ["bozr.suite.json"] = 65,
    ["browser.i18n.json"] = 66,
    bucklescript = 67,
    ["bundleconfig.json"] = 72,
    ["chutzpah.json"] = 128,
    clangd = 112,
    ["cloud-init: cloud-config userdata JSON schema"] = 114,
    ["cloud-sdk-pipeline-config-schema"] = 130,
    ["cloudbuild.json"] = 131,
    cloudify = 113,
    codemagic = 115,
    ["coffeelint.json"] = 137,
    comet = 537,
    ["commands.json"] = 124,
    ["compile_commands.json"] = 123,
    ["compilerconfig.json"] = 122,
    ["component-detection-manifest.json"] = 140,
    ["component.json"] = 139,
    ["composer.json"] = 138,
    ["config.json"] = 141,
    ["contentmanifest.json"] = 129,
    ["contribute.json"] = 142,
    ["cosmos.config.json"] = 126,
    ["crowdin.yml"] = 143,
    cspell = 146,
    ["cypress.json"] = 144,
    ["datalogic-scan2deploy-android"] = 152,
    ["datalogic-scan2deploy-ce"] = 153,
    ["dbt Project"] = 90,
    ["debugsettings.json"] = 154,
    ["dependabot-v2.json"] = 157,
    ["dependabot.json"] = 156,
    ["deployed-cli"] = 571,
    ["detekt.yml"] = 159,
    devinit = 529,
    ["devspace.yaml"] = 592,
    ["docfx.json"] = 163,
    ["docker-compose.yml"] = 528,
    ["docker-seq schema"] = 162,
    ["dockerd.json"] = 161,
    ["dotnet Release Index manifest"] = 172,
    ["dotnetcli.host.json"] = 173,
    ["drone.json"] = 174,
    ["dss-2.0.0.json"] = 176,
    ["dstack Workflows"] = 177,
    ["dvc.yaml"] = 178,
    ["ecosystem.json"] = 183,
    eksctl = 184,
    ["electron-builder configuration file."] = 189,
    ["epr-manifest.json"] = 187,
    ["evcc.yaml"] = 190,
    ["ezd schema"] = 192,
    ["fabric.mod.json"] = 195,
    ["first-timers-bot"] = 198,
    ["fly.io Schema"] = 47,
    fulibWorkflows = 554,
    ["function.json"] = 204,
    ["geojson.json"] = 207,
    ["gitlab-ci"] = 215,
    ["global.json"] = 217,
    ["golangci-lint Configuration"] = 218,
    ["haxelib.json"] = 231,
    helmfile = 518,
    ["host-meta.json"] = 236,
    ["host.json"] = 235,
    ...
    huskyrc = 496,
    ["ide.host.json"] = 239,
    ["imageoptimizer.json"] = 240,
    ["importmap.json"] = 242,
    ["ioBroker JSON UI"] = 243,
    ["ioBroker Package manifest"] = 244,
    ["ize.toml"] = 607,
    ["jsconfig.json"] = 263,
    ["jscpd Configuration Schema"] = 589,
    jsdoc = 515,
    ["k3d.yaml"] = 264,
    ["kustomization.yaml"] = 268,
    ["label-commenter-config.yml"] = 269,
    ["launchsettings.json"] = 270,
    ["lego.json"] = 271,
    ["lerna.json"] = 272,
    ["lgtm.yml"] = 273,
    ["libman.json"] = 274,
    ["license-report-config.json"] = 275,
    ["linkinator.config.json"] = 276,
    ["local.settings.json"] = 278,
    ["localazy.json"] = 279,
    ["lsdlschema.json"] = 280,
    ["markdown-lint-check"] = 552,
    mboats = 558,
    ["mimetypes.json"] = 287,
    ["mirrord-schema"] = 498,
    ["mta.yaml"] = 499,
    ["mtad.yaml"] = 500,
    ["mycode.json"] = 303,
    ["napari plugin manifest"] = 304,
    neoload = 510,
    ["nest-cli"] = 309,
    ["ninjs (News in JSON) 1.3"] = 308,
    ["ninjs (News in JSON) 2.0"] = 307,
    ["nlu.json"] = 310,
    ["nodemon.json"] = 312,
    ["noodl.schema.json"] = 557,
    now = 506,
    ["npm-badges"] = 315,
    ["nswag.json"] = 318,
    ntangle = 319,
    ["nuclei-template.yaml"] = 316,
    ["nuget-project.json"] = 317,
    ["ocelot.json"] = 321,
    ["omnisharp.json"] = 322,
    ["openapi.json"] = 323,
    ["openfin.json"] = 325,
    ["openrpc.json"] = 324,
    ["package.json"] = 335,
    ["package.manifest"] = 336,
    ["pattern.json"] = 339,
    ["petstore-v1.0"] = 599,
    pgap_yaml_input_reader = 338,
    ["plagiarize-me.yaml"] = 343,
    ["plagiarize.yaml"] = 342,
    ["portman.json"] = 344,
    ["prettierrc.json"] = 349,
    ["prisma.yml"] = 350,
    ["project-1.0.0-beta3.json"] = 352,
    ["project-1.0.0-beta4.json"] = 353,
    ["project-1.0.0-beta5.json"] = 354,
    ["project-1.0.0-beta6.json"] = 355,
    ["project-1.0.0-beta8.json"] = 356,
    ["project-1.0.0-rc1.json"] = 357,
    ["project-1.0.0-rc2.json"] = 358,
    ["project.json"] = 351,
    ["prometheus.json"] = 359,
    ["prometheus.rules.json"] = 360,
    ["proxies.json"] = 361,
    ["publiccode.yml"] = 362,
    ["pubspec.yaml"] = 363,
    ["pyrseas-0.8.json"] = 366,
    ["release drafter"] = 511,
    rustfmt = 381,
    ["sarif-1.0.0.json"] = 384,
    ["sarif-2.0.0.json"] = 385,
    ["sarif-2.1.0"] = 394,
    ["sarif-2.1.0-rtm.2"] = 386,
    ["sarif-2.1.0-rtm.3"] = 388,
    ["sarif-2.1.0-rtm.4"] = 390,
    ["sarif-2.1.0-rtm.5"] = 392,
    ["sarif-external-property-file-2.1.0"] = 395,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 387,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 389,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 391,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 393,
    ["schema.org - Action"] = 397,
    ["schema.org - ContactPoint"] = 398,
    ["schema.org - Place"] = 399,
    ["schema.org - Thing"] = 400,
    ["semantic-release"] = 402,
    ["servicehub.config.json"] = 487,
    ["servicehub.service.json"] = 486,
    ["settings.job"] = 404,
    ["sfdx-hardis configuration"] = 406,
    ["size-limit configuration"] = 408,
    ["skaffold.yaml"] = 550,
    ["skyuxconfig.json"] = 409,
    snapcraft = 410,
    ["stripe-app-local.json"] = 423,
    ["stripe-app.json"] = 422,
    swcrc = 538,
    taskcat = 507,
    ["template.json"] = 431,
    ["templatsources.json"] = 432,
    ["theme.json"] = 434,
    ["tizen_workspace.json"] = 435,
    tmLanguage = 436,
    tmuxinator = 495,
    ["trunk.yaml schema"] = 442,
    ["ts-force-config.json"] = 446,
    ["tsconfig.json"] = 443,
    ["tsd.json"] = 444,
    ["tsdrc.json"] = 445,
    ["tslint.json"] = 447,
    ...
    ["vega-lite.json"] = 458,
    ["vega.json"] = 457,
    ["venvironment-basic.yaml"] = 461,
    ["venvironment.yaml"] = 460,
    ["version.json"] = 462,
    ["vim-addon-info"] = 463,
    ["vs-2017.3.host.json"] = 465,
    ["vs-nesting.json"] = 466,
    ["vsls.json"] = 464,
    ["vss-extension.json"] = 470,
    ["webhint.io"] = 585,
    ["webjobpublishsettings.json"] = 476,
    ["webjobs-list.json"] = 475,
    ["xs-app.json"] = 503,
    ["xunit.runner.json"] = 485,
    yamllint = 526,
    zuul = 512,
    ["Žinoma"] = 520
  },
