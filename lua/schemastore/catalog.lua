...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 180,
    [".cryproj (generic)"] = 619,
    [".cryproj engine-5.2"] = 614,
    [".cryproj engine-5.3"] = 615,
    [".cryproj engine-5.4"] = 616,
    [".cryproj engine-5.5"] = 617,
    [".cryproj engine-dev"] = 618,
    [".csscomb.json"] = 182,
    [".csslintrc"] = 183,
    [".es6importsorterrc.json"] = 750,
    [".eslintrc"] = 232,
    [".esmrc.json"] = 224,
    [".ffizer.yaml"] = 236,
    [".htmlhintrc"] = 289,
    ...
    [".pmbot.yml"] = 428,
    [".postcssrc"] = 434,
    [".powerpages-web-template-manifest"] = 436,
    [".pre-commit-config.yml"] = 437,
    [".pre-commit-hooks.yml"] = 438,
    [".putout.json"] = 458,
    [".rehyperc"] = 470,
    [".remarkrc"] = 472,
    [".sprite files"] = 527,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 692,
    ["All Contributors configuration file"] = 749,
    ...
    ["Azure Pipelines"] = 60,
    ["Azure Static Web Apps CLI configuration file"] = 530,
    ["Azure Static Web Apps configuration file"] = 529,
    ["BX CI"] = 96,
    ["Better Code Hub"] = 664,
    ["Better Scripts"] = 97,
    Bigconfig = 77,
    BizTalkServerApplicationSchema = 634,
    Bleep = 98,
    ...
    ["Butane Config"] = 704,
    ["CICS TS region tagging"] = 713,
    ["CICS TS resource import"] = 714,
    ["CICS TS resource model"] = 715,
    ["CICS TS resource overrides"] = 716,
    ["CMake Presets"] = 99,
    ["CNC Codes"] = 109,
    ...
    ["Databricks Asset Bundles"] = 770,
    ["Datadog Service Definition"] = 329,
    ["Datahub Ingestion Recipe"] = 720,
    ["Dein Config"] = 114,
    Deno = 193,
    ["Deployer Recipe"] = 196,
    ["Deta Spacefile"] = 115,
    ...
    ["Goreleaser Pro"] = 271,
    Goss = 272,
    ["Gradle Build Cache Node"] = 662,
    ["Gradle Enterprise"] = 661,
    ...
    Hadolint = 643,
    Hammerkit = 671,
    ["Hardware Sentry Configuration"] = 724,
    Hatch = 644,
    Hayson = 284,
    ...
    ["JFrog File Spec"] = 309,
    ["JFrog Pipelines YML DSL"] = 733,
    ["JMeter DSL cli config"] = 310,
    JReleaser = 312,
    ["JSON Document Transform"] = 319,
    ["JSON Feed"] = 320,
    ["JSON Resume"] = 478,
    ["JSON Schema Draft 2020-12"] = 610,
    ["JSON Schema Draft 4"] = 607,
    ["JSON Schema Draft 7"] = 608,
    ["JSON Schema Draft 7 (unofficial strict)"] = 771,
    ["JSON Schema Draft 8 (2019-09)"] = 609,
    ["JSON-API"] = 318,
    ["JSON-e templates"] = 669,
    ["JSON-stat 2.0"] = 604,
    JSONPatch = 322,
    Jasmine = 302,
    Jekyll = 303,
    ...
    Kas = 325,
    ["Keycloak REST API"] = 741,
    ["Knative Functions - func.yaml"] = 249,
    ["KoDE/CI build.yaml"] = 729,
    ["Kong DBLess config"] = 730,
    KrakenD = 328,
    LOOBin = 346,
    Lefthook = 336,
    ...
    ["Minecraft Custom Main Menu Mod"] = 778,
    ...
    ["MongoDB Atlas Search Index Definition"] = 728,
    ["Monika Configuration"] = 726,
    ["Motif config"] = 627,
    ["NOX Framework (Service)"] = 394,
    ["Netin Diagnostic System Template"] = 686,
    ["Netlify config"] = 385,
    ["Network-as-Code Data Model"] = 386,
    ["Nightwatch.js"] = 387,
    ["ONe's service descriptor"] = 409,
    ["OSS Review Toolkit configuration"] = 416,
    ["OSS Review Toolkit curation"] = 417,
    ["OSS Review Toolkit package configuration"] = 418,
    ["OSS Review Toolkit repository configuration"] = 419,
    ["OSS Review Toolkit resolutions"] = 420,
    Opctl = 630,
    ["OpenRewrite Resource"] = 411,
    ["OpenUtau character yaml"] = 406,
    ["OpenUtau ustx"] = 407,
    ["OpenWeather Current Weather API"] = 668,
    ["OpenWeather Road Risk API"] = 667,
    ["Ory Hydra configuration"] = 290,
    ["Ory Keto configuration"] = 330,
    ["Ory Kratos configuration"] = 415,
    ["Ory Oathkeeper configuration"] = 401,
    ["Outblocks App configuration"] = 413,
    ["Outblocks database table"] = 414,
    ["Outblocks project configuration"] = 412,
    Packer = 423,
    Pantsbuild = 748,
    ["Paper paper-plugin.yml"] = 424,
    ["Pipeline component"] = 678,
    ["PocketMine plugin.yml"] = 429,
    Poetry = 430,
    ["Postman collection"] = 435,
    ["Problem object RFC9457"] = 775,
    ["Problem package generators"] = 442,
    Pterodactyl = 723,
    ["Pull Request Labeler"] = 457,
    Pulumi = 463,
    PyProject = 464,
    Pyright = 465,
    Qgoda = 466,
    Qodana = 697,
    ["Quali Torque Blueprint Spec 2"] = 721,
    ["QueryFirst config file"] = 744,
    ["RKE Cluster Configuration JSON"] = 675,
    ["RKE Cluster Configuration YAML"] = 674,
    ["Rancher Fleet"] = 460,
    Ray = 642,
    ["Read the Docs"] = 462,
    ["Red-DiscordBot Cog"] = 467,
    ["Red-DiscordBot Cog Repo"] = 468,
    ["Red-DiscordBot Trivia"] = 469,
    RenderCV = 480,
    Renovate = 479,
    ["Replit config"] = 473,
    RoadRunner = 481,
    ...
    ["Rust Project"] = 477,
    ["Rust toolchain"] = 483,
    ["SIL Kit Participant Configuration"] = 515,
    ["SIL Kit Registry Configuration"] = 516,
    SWADL = 541,
    ["Safebox Config"] = 734,
    ["Sapphire CLI Config"] = 486,
    ["SauceCTL Configuration"] = 683,
    ["Schema Catalog"] = 500,
    ["Scoop manifest"] = 505,
    ["Semantic Data Fabric (SDF) file"] = 506,
    ["Semgrep Rule"] = 508,
    ["Serenity Code Generator (Sergen)"] = 509,
    ["Serverless Framework Configuration"] = 691,
    ["Serverless Workflow"] = 693,
    ["Settings.paf"] = 511,
    Setuptools = 512,
    ["Shopware 6 Configuration"] = 694,
    ["Shopware CLI Extension Store Configuration"] = 695,
    ["Shopware CLI Project Store Configuration"] = 696,
    ["Sigrid scope configuration file"] = 514,
    ["Slack app manifest"] = 518,
    Solidarity = 521,
    ["Solution filters"] = 522,
    ["Source Maps v3"] = 523,
    Sourcery = 524,
    SpecIF = 525,
    ["Sponge Mixin configuration"] = 526,
    StackBlitz = 531,
    ["StackHawk Scanner Configuration"] = 690,
    Stale = 532,
    ["Starlake Data Pipeline"] = 665,
    Starship = 533,
    ["Statamic Blueprint"] = 534,
    ["Stella configuration file"] = 535,
    ["StrmPrivacy Data Connector"] = 738,
    ["StrmPrivacy Data Contract"] = 739,
    ["StrmPrivacy SimpleSchema"] = 736,
    ["StrmPrivacy Stream"] = 737,
    ["StrmPrivacy batch job configuration file"] = 735,
    ["Stryker Mutator"] = 538,
    ["StyleCop Analyzers Configuration"] = 539,
    ["Sublime Syntax"] = 740,
    ["Swagger API 2.0"] = 542,
    TSON = 567,
    TSTyche = 568,
    Talhelper = 544,
    ["Talisman configuration"] = 545,
    ["Taskfile config"] = 670,
    Taurus = 546,
    ["TestEnvironment.json"] = 555,
    ["TextMate Grammar"] = 554,
    ["Tier.run pricing.json"] = 549,
    Tikibase = 550,
    ["Traefik v2"] = 558,
    ["Traefik v2 File Provider"] = 559,
    TunnelHub = 774,
    Turborepo = 556,
    Tye = 698,
    ["UET BuildConfig.json"] = 745,
    ["UI5 Manifest"] = 576,
    ["UNCORS configuration"] = 580,
    ["UTAM Page Object"] = 579,
    ["Ubuntu Server Autoinstall"] = 574,
    ["Uniswap Token List"] = 653,
    ["Unreal Engine Uplugin"] = 746,
    ["Unreal Engine Uproject"] = 747,
    ["Updatecli Compose"] = 705,
    ["Updatecli Policy Manifest"] = 706,
    ["Updatecli Policy Metadata"] = 707,
    Uplift = 743,
    ["User Journey Map"] = 673,
    V2Ray = 711,
    ["VSCode Code Snippets"] = 151,
    ["VSIX CLI publishing"] = 593,
    ["Vela Pipeline Configuration"] = 583,
    Vercel = 150,
    Visivo = 772,
    ["Web App Manifest"] = 600,
    ["Web types"] = 603,
    WebExtensions = 599,
    ["Webman package recipe"] = 717,
    ["Windows Package Manager Installer Manifest"] = 650,
    ["Windows Package Manager Locale Manifest"] = 651,
    ["Windows Package Manager Singleton Manifest"] = 649,
    ["Woodpecker pipeline config"] = 685,
    ["Xstate Machine"] = 703,
    ["Yippee-Ki-JSON configuration YML"] = 655,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    apko = 776,
    ...
    ["bamboo-spec"] = 71,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 754,
    ["bashly-strings.yml"] = 755,
    ["bashly.yml"] = 753,
    ["batect.yml"] = 70,
    ...
    ["lsdlschema.json"] = 350,
    ["madness.yml"] = 752,
    ["markdown-lint-check"] = 681,
    mboats = 688,
    ["micro-settings.json"] = 757,
    ["mimetypes.json"] = 357,
    ["mirrord config"] = 624,
    ["monospace.yml"] = 379,
    ["mta.yaml"] = 625,
    ...
    ["ops.yaml"] = 408,
    ["package.json"] = 421,
    ["package.manifest"] = 422,
    ["pathfinder.yml"] = 425,
    ["pattern.json"] = 427,
    ["petstore-v1.0"] = 732,
    pgap_yaml_input_reader = 426,
    ["plagiarize-me.yaml"] = 432,
    ["plagiarize.yaml"] = 431,
    ["portman.json"] = 433,
    ["prettierrc.json"] = 440,
    ["prisma.yml"] = 441,
    ["project-1.0.0-beta3.json"] = 444,
    ["project-1.0.0-beta4.json"] = 445,
    ["project-1.0.0-beta5.json"] = 446,
    ["project-1.0.0-beta6.json"] = 447,
    ["project-1.0.0-beta8.json"] = 448,
    ["project-1.0.0-rc1.json"] = 449,
    ["project-1.0.0-rc2.json"] = 450,
    ["project.json"] = 443,
    ["prometheus.json"] = 451,
    ["prometheus.rules.json"] = 452,
    ["prometheus.rules.test.json"] = 453,
    ["proxies.json"] = 454,
    ["publiccode.yml"] = 455,
    ["pubspec.yaml"] = 456,
    ["pyrseas-0.8.json"] = 459,
    ["quilt.mod.json"] = 758,
    ["release drafter"] = 637,
    ["release-plz.toml"] = 471,
    rtx = 475,
    rustfmt = 482,
    samt = 484,
    samtrc = 485,
    ["sarif-1.0.0.json"] = 487,
    ["sarif-2.0.0.json"] = 488,
    ["sarif-2.1.0"] = 498,
    ["sarif-2.1.0-rtm.2"] = 489,
    ["sarif-2.1.0-rtm.3"] = 491,
    ["sarif-2.1.0-rtm.4"] = 493,
    ["sarif-2.1.0-rtm.5"] = 495,
    ["sarif-2.1.0-rtm.6"] = 496,
    ["sarif-external-property-file-2.1.0"] = 499,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 490,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 492,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 494,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 497,
    ["schema.org - Action"] = 501,
    ["schema.org - ContactPoint"] = 502,
    ["schema.org - Place"] = 503,
    ["schema.org - Thing"] = 504,
    ["scikit-build"] = 689,
    ["secrethub.yml"] = 760,
    ["semantic-release"] = 507,
    ["servicehub.config.json"] = 613,
    ["servicehub.service.json"] = 612,
    ["settings.job"] = 510,
    ["sfdx-hardis configuration"] = 513,
    ["size-limit configuration"] = 517,
    ["skaffold.yaml"] = 679,
    ["skyuxconfig.json"] = 519,
    snapcraft = 520,
    ["sqlc configuration"] = 528,
    ["stripe-app-local.json"] = 537,
    ["stripe-app.json"] = 536,
    swcrc = 666,
    syntax = 762,
    ["task.json"] = 543,
    taskcat = 633,
    ["template.json"] = 547,
    ["templatsources.json"] = 548,
    ["theme.json"] = 551,
    ["tizen_workspace.json"] = 552,
    tldr = 553,
    tmuxinator = 621,
    ["transcend.yml"] = 560,
    ["trunk.yaml"] = 561,
    ["ts-force-config.json"] = 565,
    ["tsconfig.json"] = 562,
    ["tsd.json"] = 563,
    ["tsdrc.json"] = 564,
    ["tslint.json"] = 566,
    ...
    ["vega-lite.json"] = 582,
    ["vega.json"] = 581,
    ["venvironment-basic.yaml"] = 585,
    ["venvironment.yaml"] = 584,
    ["version.json"] = 586,
    ["vim-addon-info"] = 587,
    ["vs-2017.3.host.json"] = 589,
    ["vs-nesting.json"] = 590,
    ["vsls.json"] = 588,
    ["vss-extension.json"] = 594,
    ["vtesttree.yaml"] = 595,
    ["vtestunit.yaml"] = 596,
    ["warp-keysets.json"] = 766,
    ["warp-themes.json"] = 767,
    ["warp-workflows.json"] = 768,
    ["webhint.io"] = 718,
    ["webjobpublishsettings.json"] = 602,
    ["webjobs-list.json"] = 601,
    ["xs-app.json"] = 629,
    ["xunit.runner.json"] = 611,
    yamllint = 654,
    zuul = 638,
    ["Žinoma"] = 648
  },
