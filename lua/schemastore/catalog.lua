...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 944,
    [".nodehawkrc"] = 586,
    [".npmpackagejsonlintrc"] = 590,
    [".omletrc"] = 1123,
    [".phrase.yml"] = 664,
    [".phraseapp.yml"] = 665,
    [".pmbot.yml"] = 650,
    [".postcssrc"] = 659,
    [".powerpages-web-template-manifest"] = 661,
    [".pre-commit-config.yml"] = 662,
    [".pre-commit-hooks.yml"] = 663,
    [".putout.json"] = 698,
    [".rehyperc"] = 723,
    [".remarkrc"] = 727,
    [".sprite files"] = 819,
    ...
    AIConfig = 34,
    ["AMX Muse Program Descriptor"] = 1171,
    ["API Builder"] = 979,
    ["AVA Configuration"] = 1042,
    ...
    ["AWS Copilot Manifest"] = 1210,
    ["AWS SAM CLI Samconfig"] = 267,
    ["Adobe UXP Manifest"] = 1105,
    ["Aerleon Network & Service Definitions"] = 20,
    ["Aerleon Policy"] = 21,
    ["AgentCore CLI"] = 1250,
    Aider = 1200,
    Air = 23,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1221,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1220,
    ["Airlock Microgateway"] = 35,
    ["Alacritty Configuration"] = 1014,
    ["All Contributors configuration file"] = 1068,
    ["Ansible Argument Specs"] = 403,
    ["Ansible Collection Galaxy"] = 410,
    ["Ansible Execution Environment"] = 400,
    ["Ansible Inventory"] = 409,
    ["Ansible Meta"] = 401,
    ["Ansible Meta Runtime"] = 402,
    ["Ansible Navigator Configuration"] = 412,
    ["Ansible Playbook"] = 407,
    ["Ansible Requirements"] = 404,
    ["Ansible Rulebook"] = 408,
    ["Ansible Tasks File"] = 406,
    ["Ansible Vars File"] = 405,
    ["Ansible-lint Configuration"] = 411,
    Any = 1133,
    ...
    ["Application list for a WinUtil"] = 1150,
    ArchitectFX = 1155,
    ["Argo CD"] = 54,
    ["Argo Events"] = 55,
    ["Argo Workflows"] = 56,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1219,
    ["Azure IoT Operations connector metadata"] = 1216,
    ...
    ["Azure Pipelines"] = 113,
    ["Azure Static Web Apps CLI configuration file"] = 823,
    ["Azure Static Web Apps configuration file"] = 822,
    BMML = 1238,
    ["BOSH CPI Config"] = 139,
    ...
    ["Bacon config"] = 5,
    ["Barba-CV"] = 83,
    ["Bashly (bashly.yml)"] = 1072,
    ["Bashly Settings (bashly-settings.yml)"] = 1073,
    Bento = 1237,
    ["Better Code Hub"] = 984,
    ["Better Scripts"] = 161,
    Bigconfig = 132,
    ["Biome Formatter Config"] = 84,
    ["Bitmovin Encoding Template"] = 1164,
    BizTalkServerApplicationSchema = 951,
    Bleep = 162,
    ["Block Protocol Metadata"] = 159,
    ["Bluebricks blueprint config"] = 1243,
    ["Boyka Framework"] = 141,
    Briefcase = 957,
    ["Build Info"] = 150,
    Buildkite = 152,
    ...
    ["Butane Config"] = 1027,
    C4InterFlow = 1179,
    ["CDK Environment Manager, concrete environment configuration"] = 1203,
    ["CDK Environment Manager, concrete environments definition"] = 1202,
    ["CDK Environment Manager, environment definition"] = 1201,
    ["CGS Card Game Specification (cgs.json)"] = 1110,
    ["CICS TS region tagging"] = 1036,
    ["CICS TS resource import"] = 1037,
    ["CICS TS resource model"] = 1038,
    ["CICS TS resource overrides"] = 1039,
    ["CMake Presets"] = 163,
    ["CNC Codes"] = 185,
    ["CRS WAF test file"] = 1140,
    ["CRS WAF test platform overrides file"] = 1141,
    ...
    ["Chamaleon environment"] = 1168,
    ["Chamaleon properties"] = 1169,
    ["Chamaleon template"] = 1167,
    Changepacks = 1230,
    Changesets = 276,
    Changie = 172,
    Charmcraft = 173,
    ...
    ["Clawject config"] = 191,
    ["Cloud Foundry Application Manifest"] = 1122,
    ["Cloud Run Spec v1"] = 1145,
    ...
    Concord = 1139,
    ["Configu .cfgu files"] = 1127,
    ["Configu .configu file"] = 1128,
    Conjure = 184,
    ["Container Structure Test"] = 965,
    Containerlab = 993,
    ["Contextive Glossary"] = 1195,
    Convex = 183,
    ["Crowdsec collection config"] = 286,
    ["Crowdsec parser config"] = 287,
    ["Crowdsec scenario config"] = 288,
    ["CumulusCI Config"] = 190,
    ["Cursor Agent Environment"] = 1248,
    ["Custom Machinery Machine"] = 1111,
    ["Custom Machinery Recipe"] = 1112,
    ...
    ["DataYoga Job"] = 199,
    ["Databricks Asset Bundles"] = 1089,
    ["Datadog Continuous Testing"] = 501,
    ["Datadog Service Definition"] = 502,
    ["Datadog Software Catalog"] = 503,
    ["Datahub Ingestion Recipe"] = 1043,
    ...
    ["DonateCaseBetterCasino menu"] = 1172,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1080,
    ["EAS config"] = 355,
    ["ECA - Editor Code Assistant"] = 339,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1069,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1215,
    ["EasyVCR .NET"] = 356,
    ["Eidolon Resource"] = 1156,
    ...
    ["Erda Pipeline"] = 1118,
    ["Erda Runtime"] = 1119,
    ["Espanso config.yml"] = 1241,
    ["Espanso match.yml"] = 1240,
    Esquio = 344,
    ["Estuary Flow Catalog"] = 1033,
    ["Ethereum ERC1155"] = 1252,
    ["Ethereum ERC721"] = 1251,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 348,
    ["EveryVoice TTS Toolkit Data Configuration"] = 349,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 353,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 352,
    ["EveryVoice TTS Toolkit Text Configuration"] = 350,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 351,
    ["Evolving Resolutive Process notation"] = 1217,
    ["Expo SDK"] = 354,
    ["F-Droid Data metadata"] = 360,
    ["FasterCI Configuration"] = 114,
    ["Fence configuration"] = 115,
    FiQuS = 364,
    Firebase = 362,
    ["Flatpak Builder Manifest"] = 365,
    ["FlexGet Config"] = 366,
    ["Flow.json Configurations"] = 1115,
    ["Fossa configuration file"] = 373,
    ["Fossa's fossa-deps file"] = 374,
    ["Foundry VTT - Base package Manifest"] = 368,
    ["Foundry VTT - Module Manifest"] = 369,
    ["Foundry VTT - System Data Template"] = 372,
    ["Foundry VTT - System Manifest"] = 370,
    ["Foundry VTT - World Manifest"] = 371,
    ["Foxx Manifest"] = 116,
    ["Freifunk.de Community API"] = 119,
    ["Frogbot Config"] = 120,
    ["G2P Mapping Configuration"] = 380,
    ["GCP Blueprint Metadata"] = 383,
    Gaspar = 381,
    ["GatewayCore API Gateway"] = 382,
    ["Gemini CLI settings"] = 384,
    ["GeoJSON.json latest"] = 1031,
    GherKing = 1035,
    ["GitHub Action"] = 389,
    ["GitHub Actions typing"] = 1152,
    ["GitHub Discussion"] = 390,
    ["GitHub Funding"] = 391,
    ["GitHub Issue Template configuration"] = 392,
    ["GitHub Issue Template forms"] = 393,
    ["GitHub Workflow"] = 394,
    ["GitHub Workflow Template Properties"] = 395,
    ["GitHub automatically generated release notes configuration"] = 396,
    ["GitLab Agent for Kubernetes configuration"] = 1107,
    GitVersion = 386,
    ["Gitea Issue Template configuration"] = 387,
    ["Gitea Issue Template forms"] = 388,
    ["Gitpod Automations"] = 398,
    ["Gitpod Configuration"] = 399,
    ["GlazeWM settings"] = 1109,
    ["Global Privacy Control"] = 385,
    Goblet = 1088,
    ["Golangci-lint Configuration"] = 414,
    ["Golangci-lint Custom Plugins Configuration"] = 415,
    ["Google Chrome Related Website Sets"] = 363,
    ["Google Cloud Workflows"] = 263,
    ["Google Digital Assetlinks"] = 1196,
    Goreleaser = 417,
    ["Goreleaser Pro"] = 418,
    Goss = 419,
    ["Gradle Build Cache Node"] = 982,
    ["Gradle Enterprise"] = 981,
    ["Grafana 5.x Dashboard"] = 420,
    ["GraphQL Code Generator"] = 425,
    ["GraphQL Config"] = 424,
    ["GraphQL Mesh"] = 423,
    ["GroovyLint configuration"] = 426,
    ["Grunt JSHint task"] = 430,
    ["Grunt Watch task"] = 431,
    ["Grunt base task"] = 432,
    ["Grunt clean task"] = 428,
    ["Grunt copy task"] = 427,
    ["Grunt cssmin task"] = 429,
    HEMTT = 947,
    Hadolint = 961,
    Hammerkit = 992,
    ["Hardware Sentry Configuration"] = 1047,
    ["Hashgraph Online Skill Manifest"] = 1,
    ["HashiCorp Vault"] = 433,
    Hatch = 962,
    Hayson = 435,
    ["Haystack Pipeline"] = 436,
    ["Hazelcast 5 Configuration"] = 437,
    ["Hecate Input Schema"] = 1207,
    ["Helm Chart.lock"] = 230,
    ["Helm Chart.yaml"] = 229,
    ["Helm Unittest Test Suite"] = 231,
    ["Home Assistant Integration Manifest"] = 438,
    ["Homer dashboard configuration"] = 439,
    Hugo = 1023,
    ["Hugo Theme"] = 1022,
    ["Hulak Configuration"] = 446,
    ["Hyperfoil benchmark configuration"] = 445,
    ["IBM Zapp document"] = 447,
    ["IBM zCodeFormatSettings"] = 448,
    ["IMG Catapult PSP"] = 453,
    ["IVMS101 by CODE Protocol"] = 1108,
    Infrahub = 455,
    Istanbul = 1051,
    ["JDownloader2 crawler multi-rules"] = 468,
    ["JDownloader2 crawler single-rules"] = 467,
    ["JFrog Applications Config"] = 469,
    ["JFrog File Spec"] = 470,
    ["JFrog Pipelines YML DSL"] = 1057,
    ["JMeter DSL cli config"] = 471,
    JReleaser = 474,
    ["JSON Document Transform"] = 482,
    ["JSON Feed"] = 483,
    ["JSON Resume"] = 733,
    ["JSON Schema Draft 2020-12"] = 929,
    ["JSON Schema Draft 4"] = 926,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1090,
    ["JSON Schema Draft 7"] = 927,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1091,
    ["JSON Schema Draft 8 (2019-09)"] = 928,
    ["JSON-API"] = 481,
    ["JSON-e templates"] = 989,
    ["JSON-stat 2.0"] = 922,
    JSONPatch = 485,
    ["JSR Package Config (jsr.json)"] = 475,
    Jarl = 1223,
    Jasmine = 462,
    Jekyll = 463,
    ["Jenkins X Pipelines"] = 464,
    ["Jenkins X Requirements"] = 465,
    Jest = 466,
    Jocker = 472,
    ["Jovo Language Models"] = 473,
    ["Jujutsu (jj) VCS config"] = 1209,
    ["KIMMDY config file"] = 496,
    ["KODE/CI build.yaml"] = 1053,
    ["KSP-AVC"] = 923,
    ["KSP-CKAN"] = 924,
    ["KSP-NetKAN"] = 925,
    KSY = 1120,
    KSail = 378,
    ["KYA Manifest"] = 1121,
    ["Karakum configuration file"] = 375,
    Kas = 488,
    ["Kestra flow file"] = 497,
    ["Keycloak REST API"] = 1060,
    ["Knative Functions - func.yaml"] = 376,
    Knip = 377,
    ["Knowledge Unit"] = 505,
    ["Kometa (nightly) config file"] = 499,
    ["Kometa config file"] = 498,
    ["Kong DBLess config"] = 1054,
    KrakenD = 500,
    ["Kubri Configuration"] = 508,
    LOOBin = 523,
    ["Lake configuration file"] = 1212,
    ...
    ["Lando (landofile)"] = 109,
    ["LangGraph Platform configuration"] = 1132,
    ["Language configuration"] = 1131,
    Lefthook = 512,
    ["Liferay client-extension.yaml"] = 519,
    ["LinkML Metamodel"] = 521,
    Liquibase = 998,
    ["Liquibase Flow File"] = 999,
    ["Lively Properties"] = 522,
    ["Lobe AI Agent"] = 111,
    Loki = 112,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 565,
    ["MS2Rescore Configuration"] = 569,
    ["Madness (madness.yml)"] = 1071,
    ["Mado configuration"] = 529,
    ["Maestro Flow"] = 530,
    ["Mail Servers Configuration"] = 1244,
    ["MapEHR Mapping"] = 531,
    Markdownlint = 1002,
    ["Mason Registry"] = 1005,
    ["MegaLinter Custom Flavor"] = 534,
    ["MegaLinter configuration"] = 533,
    ["MegaLinter descriptor"] = 535,
    Melange = 1098,
    ["Meltano project definition"] = 536,
    ["Mergify Configuration"] = 570,
    ["Metadata for a Bazel module"] = 537,
    ["Metadata for a Cinnamon spice"] = 1148,
    ["Metatype Configuration"] = 538,
    ["MetricsHub Configuration"] = 539,
    ["MetricsHub Connector Configuration"] = 540,
    ["Micro Editor Syntax"] = 1081,
    ["Microsoft Band Web Tile"] = 541,
    ["Microsoft RulesEngine workflow rules"] = 1136,
    ["Microsoft RulesEngine workflow rules list"] = 1137,
    ["Minecraft Custom Main Menu Mod"] = 1099,
    ["Minecraft Data Pack Advancement"] = 543,
    ["Minecraft Data Pack Biome"] = 544,
    ["Minecraft Data Pack Configured Carver"] = 545,
    ["Minecraft Data Pack Damage Type"] = 546,
    ["Minecraft Data Pack Dimension"] = 548,
    ["Minecraft Data Pack Dimension Type"] = 547,
    ["Minecraft Data Pack Item Modifier"] = 549,
    ["Minecraft Data Pack Loot Table"] = 550,
    ["Minecraft Data Pack Metadata"] = 551,
    ["Minecraft Data Pack Predicate"] = 552,
    ["Minecraft Data Pack Recipe"] = 553,
    ["Minecraft Data Pack Tag"] = 554,
    ["Minecraft Data Pack Template Pool"] = 555,
    ["Minecraft Data Pack Trim Material"] = 560,
    ["Minecraft Data Pack Trim Pattern"] = 561,
    ["Minecraft Resource Pack Lang"] = 556,
    ["Minecraft Resource Pack Particle"] = 557,
    ["Minecraft Resource Pack Texture Mcmeta"] = 559,
    ["Minecraft Resourcepack Sounds"] = 558,
    ModuleAssembler = 563,
    ["Monade CLI Stack Configuration"] = 573,
    ["MongoDB Atlas Search Index Definition"] = 1052,
    ["Monika Configuration"] = 1050,
    ["Monoweave Configuration"] = 568,
    ["Motif config"] = 943,
    MultiQC = 1189,
    ["NOX Framework (Service)"] = 589,
    ["Netin Diagnostic System Template"] = 1009,
    ["Netlify config"] = 576,
    ["Network-as-Code Data Model"] = 577,
    ["Next Gen UI Agent A2A Server Configuration"] = 578,
    ["Next Gen UI Agent Configuration"] = 580,
    ["Next Gen UI Agent MCP Server Configuration"] = 579,
    ["Nightwatch.js"] = 582,
    ["Node.js configuration"] = 948,
    ["NueJS configuration file"] = 594,
    ["Nuitka.yaml"] = 1113,
    ["Nullstone config"] = 596,
    ["ONe's changelog entry"] = 615,
    ["ONe's service descriptor"] = 614,
    ["ORT Server repository environment configuration"] = 625,
    ["OSCAL Assessment Plan (AP)"] = 627,
    ["OSCAL Assessment Results (AR)"] = 628,
    ["OSCAL Catalog"] = 629,
    ["OSCAL Component Definition (CDef)"] = 630,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 631,
    ["OSCAL Profile"] = 632,
    ["OSCAL System Security Plan (SSP)"] = 633,
    ["OSS Review Toolkit configuration"] = 634,
    ["OSS Review Toolkit curation"] = 635,
    ["OSS Review Toolkit package configuration"] = 636,
    ["OSS Review Toolkit repository configuration"] = 637,
    ["OSS Review Toolkit resolutions"] = 638,
    ["October CMS columns"] = 600,
    ["October CMS fields"] = 601,
    ["Oh My Posh"] = 603,
    Okteto = 604,
    ["Ona Automations"] = 606,
    Opctl = 946,
    ["Open Data Contract Standard (ODCS)"] = 619,
    ["Open Data Product Standard (ODPS)"] = 620,
    ["Open Know-How"] = 1194,
    ["OpenRewrite Resource"] = 617,
    OpenSRM = 621,
    OpenStatus = 1205,
    ["OpenTelemetry Declarative Configuration"] = 618,
    ["OpenUtau character yaml"] = 611,
    ["OpenUtau ustx"] = 612,
    ["OpenWeather Current Weather API"] = 988,
    ["OpenWeather Road Risk API"] = 987,
    ["Ory Hydra configuration"] = 444,
    ["Ory Keto configuration"] = 504,
    ["Ory Kratos configuration"] = 626,
    ["Ory Oathkeeper configuration"] = 598,
    ["Outblocks App configuration"] = 623,
    ["Outblocks database table"] = 624,
    ["Outblocks project configuration"] = 622,
    PDM = 645,
    POPxf = 656,
    ["POPxf Correlations"] = 657,
    Packer = 642,
    PactSpec = 643,
    Pantsbuild = 1067,
    ["Paper paper-plugin.yml"] = 644,
    ["Pipeline component"] = 1000,
    ["Platform.sh application"] = 7,
    ["Platform.sh routes"] = 8,
    ["Platform.sh services"] = 9,
    ["Plex Prerolls"] = 654,
    ["PocketMine plugin.yml"] = 651,
    ["Postman collection"] = 660,
    ["Power Pages Configuration"] = 1206,
    ["Preset list for a WinUtil"] = 1151,
    ["ProActions AI-Kit Configuration"] = 671,
    ["ProActions AI-Kit Configuration for Menus"] = 673,
    ["ProActions AI-Kit Configuration for Sections"] = 675,
    ["ProActions AI-Kit Configuration for Services"] = 672,
    ["ProActions AI-Kit Configuration for Steps"] = 676,
    ["ProActions AI-Kit Configuration for Templates"] = 674,
    ["Problem object RFC9457"] = 1096,
    ["Problem package format"] = 677,
    ["Problem package generators"] = 678,
    ["Problem package submissions"] = 679,
    ["Problem package test group metadata"] = 680,
    Pterodactyl = 1046,
    ["Pull Request Labeler"] = 697,
    Pulumi = 705,
    ["PyGTA Config"] = 701,
    PyProject = 706,
    Pylock = 1197,
    Pyright = 707,
    ["Python script metadata"] = 1191,
    ["QType AI DSL"] = 710,
    Qgoda = 709,
    Qodana = 1019,
    ["Qt Creator workspace file"] = 1129,
    ["Quali Torque Blueprint Spec 2"] = 1044,
    ["QueryFirst config file"] = 1063,
    ["Qwen Code Settings"] = 1253,
    ["RKE Cluster Configuration JSON"] = 997,
    ["RKE Cluster Configuration YAML"] = 996,
    RadioHound = 700,
    ["Raid Profile"] = 1254,
    ["Raid Repo Configuration"] = 1255,
    Railpack = 712,
    Railway = 711,
    ["Rancher Fleet"] = 702,
    ["Rattler-build"] = 713,
    Ray = 960,
    ["Read the Docs"] = 704,
    ["Red-DiscordBot Cog"] = 720,
    ["Red-DiscordBot Cog Repo"] = 721,
    ["Red-DiscordBot Trivia"] = 722,
    ["Releasaurus Config"] = 4,
    ReleaseKit = 3,
    ["Render Blueprints"] = 995,
    RenderCV = 737,
    Renovate = 734,
    ["Renovate global configuration"] = 735,
    ["Renovate inherited configuration"] = 736,
    ["Replit config"] = 728,
    Restate = 1184,
    ["Revel Digital Gadget Definition File"] = 1208,
    RoadRunner = 739,
    ["Robust Station Image"] = 1214,
    Rockcraft = 740,
    ["Roo Coder Custom Modes"] = 741,
    Rubocop = 730,
    ["Rudder techniques"] = 1103,
    Ruff = 731,
    ["Rust Project"] = 732,
    ["Rust toolchain"] = 745,
    ["SDMX data message"] = 772,
    ["SDMX metadata message"] = 771,
    ["SDMX structure message"] = 770,
    ["SIL Kit Participant Configuration"] = 782,
    ["SIL Kit Registry Configuration"] = 783,
    ["SPDX 2.3"] = 820,
    SWADL = 836,
    ["Safebox Config"] = 1058,
    ["Sapphire CLI Config"] = 748,
    ["SauceCTL Configuration"] = 1006,
    Scarb = 768,
    ["Schema Catalog"] = 763,
    ["Scoop manifest"] = 769,
    ["Semantic Data Fabric (SDF) file"] = 773,
    ["Semgrep Rule"] = 775,
    ["Serenity Code Generator (Sergen)"] = 776,
    ["Serverless Framework Configuration"] = 1013,
    ["Serverless Workflow"] = 1015,
    ["Settings for a Cinnamon spice"] = 1147,
    ["Settings.paf"] = 778,
    ["Shopware 6 Configuration"] = 1016,
    ["Shopware CLI Extension Store Configuration"] = 1017,
    ["Shopware CLI Project Store Configuration"] = 1018,
    ["Sigma Detection Rule"] = 780,
    ["Sigrid scope configuration file"] = 781,
    ["SkyPilot Task JSON"] = 1104,
    ["Slack app manifest"] = 785,
    Snapcraft = 787,
    Solidarity = 790,
    ["Solution filters"] = 791,
    ["Source Maps v3"] = 792,
    Sourcery = 793,
    ["Spack bootstrap.yaml"] = 794,
    ["Spack cdash.yaml"] = 795,
    ["Spack ci.yaml"] = 796,
    ["Spack compilers.yaml"] = 797,
    ["Spack concretizer.yaml"] = 798,
    ["Spack config.yaml"] = 799,
    ["Spack definitions.yaml"] = 800,
    ["Spack develop.yaml"] = 801,
    ["Spack env_vars.yaml"] = 802,
    ["Spack environment"] = 808,
    ["Spack include.yaml"] = 803,
    ["Spack mirrors.yaml"] = 804,
    ["Spack modules.yaml"] = 805,
    ["Spack packages.yaml"] = 806,
    ["Spack repos.yaml"] = 807,
    ["Spack toolchains.yaml"] = 809,
    ["Spack upstreams.yaml"] = 810,
    ["Spack view.yaml"] = 811,
    ["Speakeasy Generation Config File"] = 815,
    ["Speakeasy Lint Configuration File"] = 812,
    ["Speakeasy Test Generation Configuration File"] = 813,
    ["Speakeasy Workflow File"] = 814,
    SpecIF = 816,
    ["Specmatic Configuration"] = 817,
    ["Sponge Mixin configuration"] = 818,
    StackBlitz = 824,
    ["StackHawk Scanner Configuration"] = 1012,
    Stale = 825,
    Starfish = 826,
    ["Starlake Data Pipeline"] = 985,
    Starship = 827,
    ["Statamic Blueprint"] = 828,
    ["Stella configuration file"] = 829,
    ["Streamlit configuration file"] = 830,
    ["Stryker Mutator"] = 833,
    ["StyleCop Analyzers Configuration"] = 834,
    ["Stylelint (.stylelintrc)"] = 835,
    ["Stylua Config"] = 1198,
    ["Sublime Syntax"] = 1059,
    ["Subsquid squid manifest"] = 1106,
    ["Swagger API 2.0"] = 837,
    ["Synadia Connect Component"] = 838,
    TSON = 874,
    TSTyche = 875,
    ["TYPO3 Vendor Bundler config"] = 881,
    ["Tab data for a LinUtil"] = 1154,
    ["Tab list for a LinUtil"] = 1153,
    Tach = 839,
    ["Tach Domain"] = 840,
    Talhelper = 842,
    ["Talisman configuration"] = 843,
    Taplo = 1199,
    ["Taskfile config"] = 990,
    Taurus = 844,
    Tauticord = 845,
    ["Tekton Pipeline"] = 1227,
    ["Tekton PipelineRun"] = 1228,
    ["Tekton Task"] = 1225,
    ["Tekton TaskRun"] = 1226,
    Telefonistka = 1185,
    ["Terrateam config"] = 1211,
    ["TestEnvironment.json"] = 857,
    ["TextMate Grammar"] = 856,
    Threagile = 851,
    ["Tier.run pricing.json"] = 848,
    Tikibase = 849,
    Tombi = 854,
    ["Traefik v2"] = 860,
    ["Traefik v2 File Provider"] = 861,
    ["Traefik v3"] = 862,
    ["Traefik v3 File Provider"] = 863,
    ["Travis CI (.travis.yml)"] = 859,
    Treefmt = 422,
    Trident = 1181,
    ["TrueScript for *.tscript files"] = 866,
    ["Tugboat QA config.yml"] = 1178,
    TunnelHub = 1094,
    Turborepo = 858,
    Tycho = 1143,
    Tye = 1020,
    ["Tyk Gateway - Open Source v5.7+"] = 1190,
    ["UET BuildConfig.json"] = 1064,
    ["UI5 Manifest"] = 887,
    ["UNCORS configuration"] = 891,
    ["UTAM Page Object"] = 890,
    ["Ubuntu Server Autoinstall"] = 885,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1182,
    ["Uniswap Token List"] = 972,
    ["Universal Schedule Format"] = 892,
    ["Unreal Engine Uplugin"] = 1065,
    ["Unreal Engine Uproject"] = 1066,
    ["UpCloud CLI (upctl) configuration"] = 1183,
    ["Updatecli Compose"] = 1028,
    ["Updatecli Policy Manifest"] = 1029,
    ["Updatecli Policy Metadata"] = 1030,
    Uplift = 1062,
    ["Upsun config"] = 6,
    ["User Journey Map"] = 994,
    V2Ray = 1034,
    ["VSCode Code Snippets"] = 251,
    ["VSIX CLI publishing"] = 910,
    Vector = 894,
    ["Vela Pipeline Configuration"] = 897,
    Vercel = 250,
    ["Version Bumper config"] = 900,
    Vespertide = 1232,
    ["Vespertide Migration"] = 1233,
    ["Vespertide Model"] = 1234,
    ["Viash Component Config"] = 1187,
    ["Viash Package Config"] = 1188,
    Visivo = 1092,
    ["WP-CLI"] = 920,
    Wake = 1180,
    ["Waku Config"] = 1157,
    ["Web App Manifest"] = 916,
    ["Web types"] = 919,
    WebExtensions = 915,
    ["Webman package recipe"] = 1040,
    ["Windows Package Manager Installer Manifest"] = 968,
    ["Windows Package Manager Locale Manifest"] = 969,
    ["Windows Package Manager Singleton Manifest"] = 967,
    Winutil = 970,
    ["WireMock CLI import configuration"] = 1163,
    ["WireMock CLI local service configuration"] = 1162,
    ["WireMock message stub mapping"] = 1161,
    ["WireMock stub mapping"] = 1160,
    ["Woodpecker pipeline config"] = 1008,
    ["Wrangler CLI"] = 921,
    ["Xstate Machine"] = 1026,
    ["Yandex Workflow Language"] = 1149,
    ["Yarn Config (.yarnrc.yml)"] = 983,
    ["Yippee-Ki-JSON configuration YML"] = 974,
    ["YouTrack App"] = 1146,
    ["Zarf Package Configuration"] = 1213,
    ["Zerops.io config"] = 1134,
    ["Zerops.io import"] = 1135,
    ["Zola Configuration"] = 1224,
    ["aerleon.yml"] = 19,
    ["amplify.yml"] = 12,
    ["angular.json"] = 36,
    apko = 1097,
    ...
    ["behat.yml"] = 142,
    ["bigquery-table"] = 131,
    ["bioimageio resource description"] = 1114,
    ...
    ["chutzpah.json"] = 259,
    cibuildwheel = 178,
    ["clang-format (.clang-format)"] = 1032,
    ["clang-tidy"] = 237,
    clangd = 236,
    clib = 238,
    ...
    ["crowdin.yml"] = 285,
    ["ctfd-setup configuration file"] = 1170,
    ["custom-elements.json"] = 1084,
    ["cypress.json"] = 289,
    ...
    ["dtool dataset metadata"] = 1165,
    ["dvc.yaml"] = 333,
    ["ecosystem.json"] = 338,
    eksctl = 340,
    ["electron-builder configuration file"] = 346,
    ["epr-manifest.json"] = 345,
    ["evcc.yaml"] = 347,
    ["ezd task runner"] = 357,
    ["fabric.mod.json"] = 359,
    ["first-timers-bot"] = 367,
    ["flagd flag configuration"] = 117,
    ["fly.io Configuration"] = 118,
    fulibWorkflows = 1007,
    ["function.json"] = 379,
    ["gRPC API Gateway & OpenAPI Config"] = 14,
    ["gematik health care insurance list"] = 1176,
    ["gematik health care patient list"] = 1173,
    ["gematik health care provider institution list"] = 1175,
    ["gematik health care provider list"] = 1174,
    ["gematik tiger test environment configuration"] = 1177,
    ["git-town.toml"] = 1222,
    ["gitlab-ci"] = 397,
    ["global.json"] = 413,
    ["go-feature-flag Flag Configuration"] = 416,
    ["haxelib.json"] = 434,
    helmfile = 963,
    helmwave = 964,
    ["host-meta.json"] = 441,
    ...
    ["ide.host.json"] = 449,
    ["ifstate.yaml"] = 450,
    ["imageoptimizer.json"] = 451,
    ["importmap.json"] = 454,
    instant_python_config = 456,
    instant_python_custom_project = 457,
    ["ioBroker Configuration"] = 458,
    ["ioBroker JSON UI"] = 459,
    ["ioBroker Package manifest"] = 460,
    ["ixpect.conf.yaml"] = 461,
    ["ize.toml"] = 1061,
    ["jsconfig.json"] = 486,
    ["jscpd Configuration"] = 1045,
    jsdoc = 959,
    ["k3d.yaml"] = 487,
    ["k9s aliases.yaml"] = 489,
    ["k9s cluster-config.yaml"] = 491,
    ["k9s config.yaml"] = 490,
    ["k9s hotkeys.yaml"] = 492,
    ["k9s plugins.yaml"] = 493,
    ["k9s skin.yaml"] = 494,
    ["k9s views.yaml"] = 495,
    ["kontinuous-config.yaml"] = 507,
    ["kontinuous-values.yaml"] = 506,
    ["kustomization.yaml"] = 509,
    ["label-commenter-config.yml"] = 510,
    ["latexindent configuration"] = 110,
    ["launchsettings.json"] = 511,
    lazydocker = 1083,
    lazygit = 1082,
    ["lego.json"] = 513,
    ["lerna.json"] = 514,
    ["lgtm.yml"] = 515,
    ["liblab.config.json"] = 516,
    ["libman.json"] = 517,
    ["license-report-config.json"] = 518,
    ["linkinator.config.json"] = 520,
    ["lint-staged (.lintstagedrc)"] = 937,
    ["local.settings.json"] = 525,
    ["localazy.json"] = 526,
    ["lotus.yaml"] = 524,
    ["lsdlschema.json"] = 527,
    ["macro.json"] = 1049,
    ["markdown-link-check"] = 1003,
    maturin = 1004,
    mboats = 1011,
    ["micro-settings.json"] = 1076,
    ["mimetypes.json"] = 542,
    ["mirrord config"] = 939,
    mise = 940,
    ["mkdocs.yml"] = 562,
    ...
    ["monospace.yml"] = 567,
    ["moon.yml"] = 1159,
    ["mprocs Configuration file"] = 1130,
    ["mrdocs.yml"] = 564,
    ["mta.yaml"] = 941,
    ["mtad.yaml"] = 942,
    ["mycode.json"] = 574,
    nFPM = 581,
    ["napari plugin manifest"] = 575,
    neoload = 954,
    ["nest-cli"] = 584,
    ["nexus-rpc-gen"] = 1249,
    ["ninjs (News in JSON)"] = 583,
    ["nitro.json"] = 953,
    ["nixd configuration"] = 1102,
    ["nlu.json"] = 585,
    ["nodemon.json"] = 587,
    ["noodl config"] = 1010,
    ["notebook.mod.json"] = 588,
    now = 949,
    ["npm-badges"] = 591,
    ["nswag.json"] = 595,
    ntangle = 597,
    ["nuclei-template.yaml"] = 592,
    ["nuget-project.json"] = 593,
    ["ocelot.json"] = 599,
    ogen = 602,
    ["omnisharp.json"] = 605,
    openHAB = 1235,
    ...
    oxlint = 1246,
    ["package.json"] = 639,
    ["package.manifest"] = 641,
    ["package.yaml"] = 640,
    ["partial-black.json"] = 143,
    ["partial-fastapi.json"] = 144,
    ["partial-pixi.json"] = 649,
    ["pattern.json"] = 647,
    ["petstore-v1.0"] = 1056,
    pgap_yaml_input_reader = 646,
    pgxgen = 1239,
    pitcms = 1242,
    ["pixi.toml"] = 648,
    ["plagiarize-me.yaml"] = 653,
    ["plagiarize.yaml"] = 652,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1166,
    ["podbard.yaml"] = 655,
    ["portman.json"] = 658,
    ["prefect.toml"] = 666,
    ["prefect.yaml"] = 667,
    ...
    ["prettierrc.json"] = 669,
    ["prisma.yml"] = 670,
    ["project-1.0.0-beta3.json"] = 682,
    ["project-1.0.0-beta4.json"] = 683,
    ["project-1.0.0-beta5.json"] = 684,
    ["project-1.0.0-beta6.json"] = 685,
    ["project-1.0.0-beta8.json"] = 686,
    ["project-1.0.0-rc1.json"] = 687,
    ["project-1.0.0-rc2.json"] = 688,
    ["project.json"] = 681,
    ["project.owasp.yaml"] = 689,
    ["prometheus-alertmanager.json"] = 693,
    ["prometheus.json"] = 690,
    ["prometheus.rules.json"] = 691,
    ["prometheus.rules.test.json"] = 692,
    ["proxies.json"] = 694,
    ["publiccode.yml"] = 695,
    ["pubspec.yaml"] = 696,
    ["pyrseas-0.8.json"] = 699,
    pytest = 708,
    ["quilt.mod.json"] = 1077,
    ["rc3 auth"] = 714,
    ["rc3 collection"] = 715,
    ...
    ["release drafter"] = 955,
    ["release-hub.json"] = 2,
    ["release-please-config.json"] = 724,
    ["release-please-manifest.json"] = 725,
    ["release-plz.toml"] = 726,
    ["renv.lock"] = 738,
    ["rivet.json"] = 1101,
    ["rivet.yaml (legacy)"] = 1100,
    rumdl = 743,
    runny = 742,
    rustfmt = 744,
    sake = 1193,
    samt = 746,
    samtrc = 747,
    ["sarif-1.0.0.json"] = 749,
    ["sarif-2.0.0.json"] = 750,
    ["sarif-2.1.0"] = 760,
    ["sarif-2.1.0-rtm.2"] = 751,
    ["sarif-2.1.0-rtm.3"] = 753,
    ["sarif-2.1.0-rtm.4"] = 755,
    ["sarif-2.1.0-rtm.5"] = 757,
    ["sarif-2.1.0-rtm.6"] = 758,
    ["sarif-external-property-file-2.1.0"] = 761,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 752,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 754,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 756,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 759,
    ["scalingo.json configuration"] = 762,
    ["schema.org - Action"] = 764,
    ["schema.org - ContactPoint"] = 765,
    ["schema.org - Place"] = 766,
    ["schema.org - Thing"] = 767,
    ["secrethub.yml"] = 1079,
    ["semantic-release"] = 774,
    ["servicehub.config.json"] = 932,
    ["servicehub.service.json"] = 931,
    ["settings.job"] = 777,
    ["sfdx-hardis configuration"] = 779,
    ["shard.yml"] = 1117,
    ["size-limit configuration"] = 784,
    ["skaffold.yaml"] = 1001,
    ["skyuxconfig.json"] = 786,
    ["snowflake-config"] = 788,
    ["snowflake-connections"] = 789,
    ["spicepod.yaml"] = 1138,
    ["sqlc configuration"] = 821,
    ["stripe-app-local.json"] = 832,
    ["stripe-app.json"] = 831,
    swcrc = 986,
    ["task.json"] = 841,
    taskcat = 950,
    ["template.json"] = 846,
    ["templatsources.json"] = 847,
    ["text2confl config"] = 1247,
    ["theme.json"] = 850,
    ["tizen_workspace.json"] = 852,
    tldr = 853,
    ["tm_devices configuration file"] = 1204,
    tmuxinator = 935,
    tox = 855,
    ["transcend.yml"] = 864,
    ["tree-sitter grammar.json"] = 421,
    ["trime.yaml"] = 865,
    ["trunk.yaml"] = 867,
    ["ts-force-config.json"] = 872,
    ["tsconfig.json"] = 868,
    ["tsd.json"] = 869,
    ["tsdoc.json"] = 870,
    ["tsdrc.json"] = 871,
    ...
    ["vega-lite.json"] = 896,
    ["vega.json"] = 895,
    ["venvironment.yaml"] = 898,
    ["venvplus.yaml"] = 899,
    version = 1186,
    ["version.json"] = 901,
    ["vhwdebugger-binding.yaml"] = 903,
    ["vim-addon-info"] = 904,
    ["vs-2017.3.host.json"] = 906,
    ["vs-nesting.json"] = 907,
    ["vsls.json"] = 905,
    ["vss-extension.json"] = 911,
    vtcfg = 1192,
    ["vtesttree.yaml"] = 912,
    ["vtestunit.yaml"] = 913,
    ["warp-keysets.json"] = 1085,
    ["warp-themes.json"] = 1086,
    ["warp-workflows.json"] = 1087,
    ["webhint.io"] = 1041,
    ["webjobpublishsettings.json"] = 918,
    ["webjobs-list.json"] = 917,
    ["well-known-fursona"] = 1125,
    ["xs-app.json"] = 945,
    ["xunit.runner.json"] = 930,
    yamllint = 973,
    zizmor = 1229,
    zuul = 956,
    ["Žinoma"] = 966
