...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 135,
    [".cryproj (generic)"] = 461,
    [".cryproj engine-5.2"] = 456,
    [".cryproj engine-5.3"] = 457,
    [".cryproj engine-5.4"] = 458,
    [".cryproj engine-5.5"] = 459,
    [".cryproj engine-dev"] = 460,
    [".csscomb.json"] = 137,
    [".csslintrc"] = 138,
    [".eslintrc"] = 177,
    [".esmrc.json"] = 170,
    ...
    [".vsext"] = 437,
    [".yarnrc.yml"] = 501,
    ["<div>RIOTS' studio configuration"] = 440,
    ["API Builder"] = 498,
    ["AVA Configuration Schema"] = 552,
    ...
    ["Better Code Hub"] = 503,
    ["Better Scripts"] = 71,
    BizTalkServerApplicationSchema = 475,
    ...
    ["Butane config schema"] = 539,
    ["CICS TS region tagging"] = 546,
    ["CICS TS resource import"] = 547,
    ["CICS TS resource model"] = 548,
    ["CICS TS resource overrides"] = 549,
    ["CMake Presets"] = 72,
    ...
    ["Embrace Config Schema"] = 564,
    ["Error pages"] = 173,
    Esquio = 171,
    ["Estuary Flow Catalog Schema"] = 543,
    ["Expo SDK"] = 176,
    ...
    Goreleaser = 203,
    ["Goreleaser Pro"] = 204,
    ["Gradle Build Cache Node"] = 500,
    ["Gradle Enterprise"] = 499,
    ...
    HEMTT = 472,
    Hadolint = 484,
    ["Hardware Sentry Configuration"] = 557,
    Hayson = 216,
    ...
    ["JSON Feed"] = 242,
    ["JSON Resume"] = 351,
    ["JSON Schema Draft 2020-12"] = 452,
    ["JSON Schema Draft 4"] = 449,
    ["JSON Schema Draft 7"] = 450,
    ["JSON Schema Draft 8"] = 451,
    ...
    ["KSP-AVC"] = 447,
    ["KSP-CKAN"] = 448,
    ["KoDE/CI build.yaml"] = 562,
    ["Kong DBLess Schema"] = 563,
    KrakenD = 247,
    ["LinkML Metamodel"] = 258,
    Liquibase = 514,
    ["Liquibase Flow File"] = 515,
    Markdownlint = 518,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 561,
    ["Monika Configuration Schema"] = 559,
    ["Motif config"] = 468,
    ["Netin Diagnostic System Template"] = 523,
    ...
    Opctl = 471,
    ["OpenWeather Current Weather API"] = 507,
    ["OpenWeather Road Risk API"] = 506,
    ...
    Packer = 313,
    ["Pipeline component"] = 516,
    ["PocketMine plugin.yml"] = 317,
    Pterodactyl = 556,
    ["Pull Request Labeler"] = 340,
    PyProject = 344,
    Qodana = 532,
    ["Quali Torque Blueprint Spec 2"] = 554,
    ["RKE Cluster Configuration JSON Schema"] = 513,
    ["RKE Cluster Configuration YAML Schema"] = 512,
    Ray = 483,
    ["Read the Docs"] = 343,
    ...
    ["SauceCTL Configuration"] = 520,
    ["Schema Catalog"] = 369,
    ["Scoop manifest"] = 374,
    ["Semgrep Rule"] = 376,
    ["Serverless Framework Configuration"] = 527,
    ["Serverless Workflow Schema"] = 528,
    ["Settings.paf"] = 378,
    ["Shopware 6 Configuration"] = 529,
    ["Shopware CLI Extension Store Configuration"] = 530,
    ["Shopware CLI Project Store Configuration"] = 531,
    Solidarity = 383,
    ["Source Maps v3"] = 384,
    SpecIF = 385,
    ["Sponge Mixin configuration"] = 386,
    ["StackHawk Scanner Configuration"] = 526,
    ...
    ["Stryker Mutator"] = 397,
    ["StyleCop Analyzers Configuration"] = 398,
    ["Swagger API 2.0"] = 401,
    ["Talisman configuration"] = 402,
    ["Taskfile YAML Schema"] = 509,
    Taurus = 403,
    ["TestEnvironment.json"] = 409,
    Tikibase = 406,
    ["Traefik v2"] = 412,
    ["Traefik v2 File Provider"] = 413,
    Turborepo = 410,
    Tye = 533,
    ["UI5 Manifest"] = 425,
    ["UTAM Page Object"] = 427,
    ["Ubuntu Server Autoinstall"] = 423,
    ["Uniswap Token List"] = 492,
    Updatecli = 540,
    ["User Journey Map YAML Schema"] = 511,
    V2Ray = 544,
    ["VSCode Code Snippets"] = 111,
    ["VSIX CLI publishing"] = 438,
    ["Vela Pipeline Configuration"] = 430,
    Vercel = 110,
    ["Web App Manifest"] = 442,
    ["Web types"] = 445,
    WebExtensions = 441,
    ["Webman package recipe"] = 550,
    ["Windows Package Manager Installer Manifest"] = 489,
    ["Windows Package Manager Locale Manifest"] = 490,
    ["Windows Package Manager Singleton Manifest"] = 488,
    ["Woodpecker pipeline config"] = 522,
    ["Xstate Machine Schema"] = 538,
    ["Yippee-Ki-JSON configuration YML"] = 494,
    ["angular.json"] = 8,
    ...
    ["jsconfig.json"] = 245,
    ["jscpd Configuration Schema"] = 555,
    jsdoc = 482,
    ["k3d.yaml"] = 246,
    ...
    ["servicehub.config.json"] = 455,
    ["servicehub.service.json"] = 454,
    ["settings.job"] = 377,
    ...
    taskcat = 474,
    ["template.json"] = 404,
    ["templatsources.json"] = 405,
    ["theme.json"] = 407,
    tmLanguage = 408,
    tmuxinator = 463,
    ["trunk.yaml schema"] = 414,
    ["ts-force-config.json"] = 418,
    ["tsconfig.json"] = 415,
    ["tsd.json"] = 416,
    ["tsdrc.json"] = 417,
    ["tslint.json"] = 419,
    ...
    ["version.json"] = 431,
    ["vim-addon-info"] = 432,
    ["vs-2017.3.host.json"] = 434,
    ["vs-nesting.json"] = 435,
    ["vsls.json"] = 433,
    ["vss-extension.json"] = 439,
    ["webhint.io"] = 551,
    ["webjobpublishsettings.json"] = 444,
    ["webjobs-list.json"] = 443,
    ["xs-app.json"] = 470,
    ["xunit.runner.json"] = 453,
    yamllint = 493,
    zuul = 479,
    ["Žinoma"] = 487
  },
