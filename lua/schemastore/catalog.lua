...
M.json = {
  ...
  index = {
    ...
    ["Azure Pipelines"] = 139,
    ["Azure Static Web Apps CLI configuration file"] = 975,
    ["Azure Static Web Apps configuration file"] = 974,
    BMML = 1411,
    ["BOSH BPM Config"] = 167,
    ["BOSH CPI Config"] = 168,
    ...
    Ray = 1130,
    ["Read the Docs"] = 846,
    ["Red-DiscordBot Cog"] = 862,
    ["Red-DiscordBot Cog Repo"] = 863,
    ["Red-DiscordBot Trivia"] = 864,
    ["Releasaurus Config"] = 12,
    ReleaseKit = 11,
    ["Render Blueprints"] = 1167,
    RenderCV = 882,
    Renovate = 879,
    ["Renovate global configuration"] = 880,
    ["Renovate inherited configuration"] = 881,
    ["Replit config"] = 870,
    Restate = 1357,
    ...
    Rockcraft = 885,
    ["Roo Coder Custom Modes"] = 886,
    Rubocop = 875,
    ["Rudder techniques"] = 1275,
    Ruff = 876,
    ["Rust Project"] = 877,
    ["Rust toolchain"] = 891,
    ["SDMX data message"] = 918,
    ["SDMX metadata message"] = 917,
    ["SDMX structure message"] = 916,
    ["SIL Kit Participant Configuration"] = 929,
    ["SIL Kit Registry Configuration"] = 930,
    ["SPDX 2.3"] = 972,
    SWADL = 988,
    ["Safebox Config"] = 1230,
    ["Sapphire CLI Config"] = 894,
    ["SauceCTL Configuration"] = 1178,
    Scarb = 914,
    ["Schema Catalog"] = 909,
    ["Scoop manifest"] = 915,
    ["Secure SDLC Evidence Bundle"] = 919,
    ["Semantic Data Fabric (SDF) file"] = 920,
    ["Semgrep Rule"] = 922,
    ["Serenity Code Generator (Sergen)"] = 923,
    ...
    ["Sigma Detection Rule"] = 927,
    ["SigmaCV CV"] = 7,
    ["Sigrid scope configuration file"] = 928,
    ["SkyPilot Task JSON"] = 1276,
    ["Slack app manifest"] = 935,
    ["Slang Server Configuration"] = 1458,
    Snapcraft = 937,
    ["Solarxy project config"] = 940,
    Solidarity = 941,
    ["Solution filters"] = 942,
    ["Source Maps v3"] = 943,
    Sourcery = 944,
    ["Spack bootstrap.yaml"] = 945,
    ["Spack cdash.yaml"] = 946,
    ["Spack ci.yaml"] = 947,
    ["Spack compilers.yaml"] = 948,
    ["Spack concretizer.yaml"] = 949,
    ["Spack config.yaml"] = 950,
    ["Spack definitions.yaml"] = 951,
    ["Spack develop.yaml"] = 952,
    ["Spack env_vars.yaml"] = 953,
    ["Spack environment"] = 959,
    ["Spack include.yaml"] = 954,
    ["Spack mirrors.yaml"] = 955,
    ["Spack modules.yaml"] = 956,
    ["Spack packages.yaml"] = 957,
    ["Spack repos.yaml"] = 958,
    ["Spack toolchains.yaml"] = 960,
    ["Spack upstreams.yaml"] = 961,
    ["Spack view.yaml"] = 962,
    ["Speakeasy Generation Config File"] = 966,
    ["Speakeasy Lint Configuration File"] = 963,
    ["Speakeasy Test Generation Configuration File"] = 964,
    ["Speakeasy Workflow File"] = 965,
    SpecIF = 967,
    ["Specmatic Configuration"] = 968,
    ["Specpin spec file"] = 5,
    ["Sponge Mixin configuration"] = 969,
    ["Spotlight Ruleset"] = 970,
    StackBlitz = 976,
    ...
    Starship = 979,
    ["Statamic Blueprint"] = 980,
    ["Stella configuration file"] = 981,
    ["Streamlit configuration file"] = 982,
    ["Stryker Mutator"] = 985,
    ["StyleCop Analyzers Configuration"] = 986,
    ["Stylelint (.stylelintrc)"] = 987,
    ["Stylua Config"] = 1371,
    ["Sublime Syntax"] = 1231,
    ["Subsquid squid manifest"] = 1278,
    ["Swagger API 2.0"] = 989,
    ["Symfony Routing Configuration"] = 990,
    ["Symfony Serializer Mapping"] = 991,
    ["Symfony Services Configuration"] = 992,
    ["Symfony Validation Mapping"] = 993,
    ["Synadia Connect Component"] = 994,
    TSON = 1037,
    TSTyche = 1038,
    ["TYPO3 Vendor Bundler config"] = 1044,
    ["Tab data for a LinUtil"] = 1327,
    ["Tab list for a LinUtil"] = 1326,
    Tach = 995,
    ["Tach Domain"] = 996,
    Talhelper = 998,
    ["Talisman configuration"] = 999,
    Taplo = 1372,
    ...
    ["Tekton TaskRun"] = 1399,
    Telefonistka = 1358,
    ["Terraform PowerShell provider block manifest"] = 1004,
    ["Terraform PowerShell provider data source manifest"] = 1005,
    ["Terraform PowerShell provider resource manifest"] = 1006,
    ["Terraform PowerShell provider settings"] = 1007,
    ["Terrateam config"] = 1384,
    ["Tesseract configuration"] = 1008,
    ["TestEnvironment.json"] = 1018,
    ["TextMate Grammar"] = 1017,
    Threagile = 1012,
    ["Tier.run pricing.json"] = 1009,
    Tikibase = 1010,
    Tombi = 1015,
    ["Traefik v2"] = 1021,
    ["Traefik v2 File Provider"] = 1022,
    ["Traefik v3"] = 1023,
    ["Traefik v3 File Provider"] = 1024,
    ["Travis CI (.travis.yml)"] = 1020,
    Treefmt = 529,
    Trident = 1354,
    Trivy = 1027,
    ["TrueScript for *.tscript files"] = 1028,
    ...
    ["UI5 Manifest"] = 1050,
    ["UNCORS configuration"] = 1055,
    ["UTAM Page Object"] = 1053,
    ["Ubuntu Server Autoinstall"] = 1048,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1355,
    ["Uniswap Token List"] = 1141,
    ["Universal Schedule Format"] = 1056,
    ...
    Vector = 1058,
    ["Vee JSON menu output"] = 1059,
    ["Vela Pipeline Configuration"] = 1062,
    Vercel = 310,
    ...
    ["release-hub.json"] = 10,
    ["release-please-config.json"] = 866,
    ["release-please-manifest.json"] = 867,
    ["release-plz.toml"] = 868,
    ["renv.lock"] = 883,
    ["replacement-transformer.yaml"] = 625,
    ["reposets Configuration"] = 872,
    ["reposets Credentials"] = 873,
    ["revola.json"] = 8,
    ["rivet.json"] = 1273,
    ...
    samt = 892,
    samtrc = 893,
    ["sarif-1.0.0.json"] = 895,
    ["sarif-2.0.0.json"] = 896,
    ["sarif-2.1.0"] = 906,
    ["sarif-2.1.0-rtm.2"] = 897,
    ["sarif-2.1.0-rtm.3"] = 899,
    ["sarif-2.1.0-rtm.4"] = 901,
    ["sarif-2.1.0-rtm.5"] = 903,
    ["sarif-2.1.0-rtm.6"] = 904,
    ["sarif-external-property-file-2.1.0"] = 907,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 898,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 900,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 902,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 905,
    ["scalingo.json configuration"] = 908,
    ["schema.org - Action"] = 910,
    ["schema.org - ContactPoint"] = 911,
    ["schema.org - Place"] = 912,
    ["schema.org - Thing"] = 913,
    ["secrethub.yml"] = 1251,
    ["semantic-release"] = 921,
    servercn = 1468,
    ["servicehub.config.json"] = 1099,
    ["servicehub.service.json"] = 1098,
    ["settings.job"] = 924,
    ["sfdx-hardis configuration"] = 926,
    ["shard.yml"] = 1289,
    ["size-limit configuration"] = 931,
    ["skaffold.yaml"] = 1173,
    ["skill-map plugin extension manifest"] = 932,
    ["skill-map project settings"] = 933,
    ["skill-map provider kind"] = 934,
    ["skyuxconfig.json"] = 936,
    ["snowflake-config"] = 938,
    ["snowflake-connections"] = 939,
    ["spicepod.yaml"] = 1310,
    ["sqlc configuration"] = 973,
    ["stripe-app-local.json"] = 984,
    ["stripe-app.json"] = 983,
    swcrc = 1157,
    ["task.json"] = 997,
    taskcat = 1120,
    ["template.json"] = 1002,
    ["templatsources.json"] = 1003,
    ["text2confl config"] = 1420,
    ["theme.json"] = 1011,
    ["tizen_workspace.json"] = 1013,
    tldr = 1014,
