...
M.json = {
  ...
  index = {
    ...
    [".pmbot.yml"] = 516,
    [".postcssrc"] = 521,
    [".powerpages-web-template-manifest"] = 523,
    [".pre-commit-config.yml"] = 524,
    [".pre-commit-hooks.yml"] = 525,
    [".putout.json"] = 546,
    [".rehyperc"] = 565,
    [".remarkrc"] = 567,
    [".sprite files"] = 629,
    ...
    ["<div>RIOTS' studio configuration"] = 707,
    ...
    ["Adobe UXP Manifest"] = 892,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Airplane task"] = 17,
    ["Alacritty Configuration"] = 799,
    ["All Contributors configuration file"] = 857,
    ...
    ["Application list for a WinUtil"] = 936,
    ["Argo Events"] = 29,
    ["Argo Workflows"] = 30,
    AssemblyScript = 33,
    AsyncAPI = 34,
    ...
    ["Azure Pipelines"] = 64,
    ["Azure Static Web Apps CLI configuration file"] = 632,
    ["Azure Static Web Apps configuration file"] = 631,
    ["BX CI"] = 104,
    ["Bashly (bashly.yml)"] = 861,
    ["Bashly Settings (bashly-settings.yml)"] = 862,
    ["Better Code Hub"] = 771,
    ["Better Scripts"] = 105,
    Bigconfig = 81,
    BizTalkServerApplicationSchema = 741,
    Bleep = 106,
    ...
    ["Butane Config"] = 812,
    ["CGS Custom Card Game (CardGameDef.json)"] = 897,
    ["CICS TS region tagging"] = 821,
    ["CICS TS resource import"] = 822,
    ["CICS TS resource model"] = 823,
    ["CICS TS resource overrides"] = 824,
    ["CMake Presets"] = 107,
    ["CNC Codes"] = 121,
    ["CRS WAF test file"] = 926,
    ["CRS WAF test platform overrides file"] = 927,
    ...
    CityJSON = 117,
    ["Clawject config"] = 126,
    ["Cloud Foundry Application Manifest"] = 909,
    ["Cloud Run Spec v1"] = 931,
    ...
    Concord = 925,
    ["Configu .cfgu files"] = 914,
    ["Configu .configu file"] = 915,
    Conjure = 120,
    ["Container Structure Test"] = 754,
    Containerlab = 779,
    ["Crowdsec collection config"] = 210,
    ["Crowdsec parser config"] = 211,
    ["Crowdsec scenario config"] = 212,
    ["CumulusCI Config"] = 125,
    ["Custom Machinery Machine"] = 898,
    ["Custom Machinery Recipe"] = 899,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 869,
    ["EAS config"] = 276,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 858,
    ...
    ["Goreleaser Pro"] = 333,
    Goss = 334,
    ["Gradle Build Cache Node"] = 769,
    ["Gradle Enterprise"] = 768,
    ...
    Hadolint = 750,
    Hammerkit = 778,
    ["Hardware Sentry Configuration"] = 832,
    Hatch = 751,
    Hayson = 347,
    ...
    ["JFrog File Spec"] = 375,
    ["JFrog Pipelines YML DSL"] = 841,
    ["JMeter DSL cli config"] = 376,
    JReleaser = 378,
    ["JSON Document Transform"] = 386,
    ["JSON Feed"] = 387,
    ["JSON Resume"] = 572,
    ["JSON Schema Draft 2020-12"] = 720,
    ["JSON Schema Draft 4"] = 717,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 879,
    ["JSON Schema Draft 7"] = 718,
    ["JSON Schema Draft 7 (unofficial strict)"] = 880,
    ["JSON Schema Draft 8 (2019-09)"] = 719,
    ["JSON-API"] = 385,
    ["JSON-WF"] = 908,
    ["JSON-e templates"] = 776,
    ["JSON-stat 2.0"] = 714,
    JSONPatch = 389,
    ...
    ["Keycloak REST API"] = 849,
    ["Knative Functions - func.yaml"] = 295,
    ["KoDE/CI build.yaml"] = 837,
    ["Kong DBLess config"] = 838,
    KrakenD = 402,
    ...
    ["Metadata for a Cinnamon spice"] = 934,
    ["MetricsHub Configuration"] = 435,
    ["MetricsHub Connector Configuration"] = 436,
    ["Micro Editor Syntax"] = 870,
    ["Microsoft Band Web Tile"] = 437,
    ["Microsoft RulesEngine workflow rules"] = 922,
    ["Microsoft RulesEngine workflow rules list"] = 923,
    ["Minecraft Custom Main Menu Mod"] = 887,
    ...
    ["MongoDB Atlas Search Index Definition"] = 836,
    ["Monika Configuration"] = 834,
    ["Monoweave Configuration"] = 461,
    ["Motif config"] = 734,
    ["NOX Framework (Service)"] = 478,
    ["Netin Diagnostic System Template"] = 794,
    ["Netlify config"] = 469,
    ...
    ["OpenUtau ustx"] = 491,
    ["OpenWeather Current Weather API"] = 775,
    ["OpenWeather Road Risk API"] = 774,
    ...
    ["Pipeline component"] = 786,
    ["PocketMine plugin.yml"] = 517,
    ["Postman collection"] = 522,
    ["Preset list for a WinUtil"] = 937,
    ["Problem object RFC9457"] = 884,
    ["Problem package generators"] = 530,
    Pterodactyl = 831,
    ["Pull Request Labeler"] = 545,
    Pulumi = 551,
    PyProject = 552,
    Pyright = 553,
    Qgoda = 554,
    Qodana = 804,
    ["Qt Creator workspace file"] = 916,
    ["Quali Torque Blueprint Spec 2"] = 829,
    ["QueryFirst config file"] = 852,
    ["RKE Cluster Configuration JSON"] = 783,
    ["RKE Cluster Configuration YAML"] = 782,
    ["Rancher Fleet"] = 548,
    ["Rattler-build"] = 555,
    Ray = 749,
    ["Read the Docs"] = 550,
    ["Red-DiscordBot Cog"] = 562,
    ["Red-DiscordBot Cog Repo"] = 563,
    ["Red-DiscordBot Trivia"] = 564,
    ["Render Blueprints"] = 781,
    RenderCV = 574,
    Renovate = 573,
    ["Replit config"] = 568,
    RoadRunner = 575,
    ["Rudder techniques"] = 890,
    Ruff = 570,
    ["Rust Project"] = 571,
    ["Rust toolchain"] = 579,
    ["SDMX data message"] = 604,
    ["SDMX metadata message"] = 603,
    ["SDMX structure message"] = 602,
    ["SIL Kit Participant Configuration"] = 614,
    ["SIL Kit Registry Configuration"] = 615,
    SWADL = 643,
    ["Safebox Config"] = 842,
    ["Sapphire CLI Config"] = 582,
    ["SauceCTL Configuration"] = 791,
    ["Schema Catalog"] = 596,
    ["Scoop manifest"] = 601,
    ["Semantic Data Fabric (SDF) file"] = 605,
    ["Semgrep Rule"] = 607,
    ["Serenity Code Generator (Sergen)"] = 608,
    ["Serverless Framework Configuration"] = 798,
    ["Serverless Workflow"] = 800,
    ["Settings for a Cinnamon spice"] = 933,
    ["Settings.paf"] = 610,
    ["Shopware 6 Configuration"] = 801,
    ["Shopware CLI Extension Store Configuration"] = 802,
    ["Shopware CLI Project Store Configuration"] = 803,
    Sigma = 612,
    ["Sigrid scope configuration file"] = 613,
    ["SkyPilot Task JSON"] = 891,
    ["Slack app manifest"] = 617,
    Solidarity = 620,
    ["Solution filters"] = 621,
    ["Source Maps v3"] = 622,
    Sourcery = 623,
    ["Speakeasy Lint Configuration File"] = 624,
    ["Speakeasy Test Generation Configuration File"] = 625,
    ["Speakeasy Workflow File"] = 626,
    SpecIF = 627,
    ["Sponge Mixin configuration"] = 628,
    StackBlitz = 633,
    ["StackHawk Scanner Configuration"] = 797,
    Stale = 634,
    ["Starlake Data Pipeline"] = 772,
    Starship = 635,
    ["Statamic Blueprint"] = 636,
    ["Stella configuration file"] = 637,
    ["StrmPrivacy Data Connector"] = 846,
    ["StrmPrivacy Data Contract"] = 847,
    ["StrmPrivacy SimpleSchema"] = 844,
    ["StrmPrivacy Stream"] = 845,
    ["StrmPrivacy batch job configuration file"] = 843,
    ["Stryker Mutator"] = 640,
    ["StyleCop Analyzers Configuration"] = 641,
    ["Stylelint (.stylelintrc)"] = 642,
    ["Sublime Syntax"] = 848,
    ["Subsquid squid manifest"] = 893,
    ["Swagger API 2.0"] = 644,
    TSON = 672,
    TSTyche = 673,
    ["Tab data for a LinUtil"] = 939,
    ["Tab list for a LinUtil"] = 938,
    Talhelper = 646,
    ["Talisman configuration"] = 647,
    ["Taskfile config"] = 777,
    Taurus = 648,
    ["TestEnvironment.json"] = 657,
    ["TextMate Grammar"] = 656,
    ["Tier.run pricing.json"] = 651,
    Tikibase = 652,
    ["Traefik v2"] = 660,
    ["Traefik v2 File Provider"] = 661,
    ["Travis CI (.travis.yml)"] = 659,
    ["TrueScript for *.tscript files"] = 664,
    TunnelHub = 883,
    Turborepo = 658,
    Tycho = 929,
    Tye = 805,
    ["UET BuildConfig.json"] = 853,
    ["UI5 Manifest"] = 682,
    ["UNCORS configuration"] = 686,
    ["UTAM Page Object"] = 685,
    ["Ubuntu Server Autoinstall"] = 680,
    ["Uniswap Token List"] = 760,
    ["Unreal Engine Uplugin"] = 854,
    ["Unreal Engine Uproject"] = 855,
    ["Updatecli Compose"] = 813,
    ["Updatecli Policy Manifest"] = 814,
    ["Updatecli Policy Metadata"] = 815,
    Uplift = 851,
    ["User Journey Map"] = 780,
    V2Ray = 819,
    ["VSCode Code Snippets"] = 176,
    ["VSIX CLI publishing"] = 702,
    ["Vela Pipeline Configuration"] = 690,
    Vercel = 175,
    Visivo = 881,
    ["Web App Manifest"] = 709,
    ["Web types"] = 712,
    WebExtensions = 708,
    ["Webman package recipe"] = 825,
    ["Windows Package Manager Installer Manifest"] = 757,
    ["Windows Package Manager Locale Manifest"] = 758,
    ["Windows Package Manager Singleton Manifest"] = 756,
    ["Woodpecker pipeline config"] = 793,
    ["Wrangler CLI"] = 713,
    ["Xstate Machine"] = 811,
    ["Yandex Workflow Language"] = 935,
    ["Yarn Config (.yarnrc.yml)"] = 770,
    ["Yippee-Ki-JSON configuration YML"] = 762,
    ["YouTrack App"] = 932,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 18,
    apko = 885,
    ...
    ["behat.yml"] = 89,
    ["bigquery-table"] = 80,
    ["bioimageio resource description"] = 901,
    ...
    ["lint-staged (.lintstagedrc)"] = 728,
    ["local.settings.json"] = 425,
    ["localazy.json"] = 426,
    ["lotus.yaml"] = 424,
    ["lsdlschema.json"] = 427,
    ["markdown-link-check"] = 789,
    mboats = 796,
    ["micro-settings.json"] = 865,
    ["mimetypes.json"] = 438,
    ["mirrord config"] = 729,
    mise = 730,
    ["mise-settings"] = 731,
    ...
    ["prettierrc.json"] = 528,
    ["prisma.yml"] = 529,
    ["project-1.0.0-beta3.json"] = 532,
    ["project-1.0.0-beta4.json"] = 533,
    ["project-1.0.0-beta5.json"] = 534,
    ["project-1.0.0-beta6.json"] = 535,
    ["project-1.0.0-beta8.json"] = 536,
    ["project-1.0.0-rc1.json"] = 537,
    ["project-1.0.0-rc2.json"] = 538,
    ["project.json"] = 531,
    ["prometheus.json"] = 539,
    ["prometheus.rules.json"] = 540,
    ["prometheus.rules.test.json"] = 541,
    ["proxies.json"] = 542,
    ["publiccode.yml"] = 543,
    ["pubspec.yaml"] = 544,
    ["pyrseas-0.8.json"] = 547,
    ["quilt.mod.json"] = 866,
    ["rc3 auth"] = 556,
    ["rc3 collection"] = 557,
    ["rc3 environment"] = 558,
    ...
    samt = 580,
    samtrc = 581,
    ["sarif-1.0.0.json"] = 583,
    ["sarif-2.0.0.json"] = 584,
    ["sarif-2.1.0"] = 594,
    ["sarif-2.1.0-rtm.2"] = 585,
    ["sarif-2.1.0-rtm.3"] = 587,
    ["sarif-2.1.0-rtm.4"] = 589,
    ["sarif-2.1.0-rtm.5"] = 591,
    ["sarif-2.1.0-rtm.6"] = 592,
    ["sarif-external-property-file-2.1.0"] = 595,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 586,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 588,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 590,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 593,
    ["schema.org - Action"] = 597,
    ["schema.org - ContactPoint"] = 598,
    ["schema.org - Place"] = 599,
    ["schema.org - Thing"] = 600,
    ["secrethub.yml"] = 868,
    ["semantic-release"] = 606,
    ["servicehub.config.json"] = 723,
    ["servicehub.service.json"] = 722,
    ["settings.job"] = 609,
    ["sfdx-hardis configuration"] = 611,
    ["shard.yml"] = 904,
    ["size-limit configuration"] = 616,
    ["skaffold.yaml"] = 787,
    ["skyuxconfig.json"] = 618,
    snapcraft = 619,
    ["spicepod.yaml"] = 924,
    ["sqlc configuration"] = 630,
    ["stripe-app-local.json"] = 639,
    ["stripe-app.json"] = 638,
    swcrc = 773,
    ["task.json"] = 645,
    taskcat = 740,
    ["template.json"] = 649,
    ["templatsources.json"] = 650,
    ["theme.json"] = 653,
    ["tizen_workspace.json"] = 654,
    tldr = 655,
    tmuxinator = 726,
    ["transcend.yml"] = 662,
    ...
    ["vega-lite.json"] = 689,
    ["vega.json"] = 688,
    ["venvironment-basic.yaml"] = 692,
    ["venvironment.yaml"] = 691,
    ["version.json"] = 693,
    ["vhwdebugger-binding.yaml"] = 695,
    ["vim-addon-info"] = 696,
    ["vs-2017.3.host.json"] = 698,
    ["vs-nesting.json"] = 699,
    ["vsls.json"] = 697,
    ["vss-extension.json"] = 703,
    ["vtesttree.yaml"] = 704,
    ["vtestunit.yaml"] = 705,
    ["warp-keysets.json"] = 874,
    ["warp-themes.json"] = 875,
    ["warp-workflows.json"] = 876,
    ["webhint.io"] = 826,
    ["webjobpublishsettings.json"] = 711,
    ["webjobs-list.json"] = 710,
    ["well-known-fursona"] = 912,
    ["xs-app.json"] = 736,
    ["xunit.runner.json"] = 721,
    yamllint = 761,
    ["zerops.io import file"] = 921,
    ["zerops.yml"] = 920,
    zuul = 745,
    ["Žinoma"] = 755
  },
