...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 184,
    [".cryproj (generic)"] = 634,
    [".cryproj engine-5.2"] = 629,
    [".cryproj engine-5.3"] = 630,
    [".cryproj engine-5.4"] = 631,
    [".cryproj engine-5.5"] = 632,
    [".cryproj engine-dev"] = 633,
    [".csscomb.json"] = 186,
    [".csslintrc"] = 187,
    [".es6importsorterrc.json"] = 769,
    [".eslintrc"] = 236,
    [".esmrc.json"] = 228,
    [".ffizer.yaml"] = 240,
    [".htmlhintrc"] = 296,
    ...
    [".pmbot.yml"] = 440,
    [".postcssrc"] = 447,
    [".powerpages-web-template-manifest"] = 449,
    [".pre-commit-config.yml"] = 450,
    [".pre-commit-hooks.yml"] = 451,
    [".putout.json"] = 471,
    [".rehyperc"] = 483,
    [".remarkrc"] = 485,
    [".sprite files"] = 541,
    ...
    ["<div>RIOTS' studio configuration"] = 613,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 359,
    AIConfig = 13,
    ["API Builder"] = 677,
    ["AVA Configuration"] = 738,
    ["AWS CDK cdk.json"] = 168,
    ["AWS CloudFormation"] = 169,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 170,
    ["AWS SAM CLI Samconfig"] = 171,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 14,
    ["Airplane task"] = 15,
    ["Alacritty Configuration"] = 710,
    ["All Contributors configuration file"] = 768,
    ...
    ["Azure Pipelines"] = 62,
    ["Azure Static Web Apps CLI configuration file"] = 544,
    ["Azure Static Web Apps configuration file"] = 543,
    ["BX CI"] = 98,
    ["Better Code Hub"] = 681,
    ["Better Scripts"] = 99,
    Bigconfig = 79,
    BizTalkServerApplicationSchema = 651,
    Bleep = 100,
    ...
    ["CICS TS resource overrides"] = 735,
    ["CMake Presets"] = 101,
    ["CNC Codes"] = 112,
    ["Calqulus pipeline"] = 102,
    ["Camel YAML DSL"] = 103,
    Carafe = 104,
    ["Cargo Make"] = 106,
    ["Cargo Manifest"] = 105,
    ["Catalog Info Backstage"] = 107,
    Cheatsheets = 720,
    ["Chrome Extension"] = 161,
    ["CircleCI config.yml"] = 138,
    ["Citation File Format"] = 173,
    CityJSON = 110,
    ["Code Climate"] = 139,
    CodeCV = 59,
    ["CodeShip Pro services configuration files"] = 150,
    ["CodeShip Pro steps configuration files"] = 151,
    ["Codecov configuration files"] = 149,
    Codux = 147,
    ["Cog config file"] = 113,
    ["Commandbox Box.json"] = 114,
    ["Commandbox Server.json"] = 115,
    ["Common Catalog Data"] = 159,
    ["Common types for all schemas"] = 1,
    Conjure = 111,
    ["Container Structure Test"] = 664,
    Containerlab = 689,
    ["Crowdsec collection config"] = 180,
    ["Crowdsec parser config"] = 181,
    ["Crowdsec scenario config"] = 182,
    ["CumulusCI Config"] = 116,
    ["DWP Exchange - catalogue entry"] = 225,
    ["DWP Exchange - gateway"] = 223,
    ["DWP Exchange - meta"] = 224,
    ["Dart build configuration"] = 188,
    ["Dart test config"] = 189,
    ["DashLord configuration"] = 190,
    ["Data Contract Specification"] = 191,
    ["Databricks Asset Bundles"] = 789,
    ["Datadog Service Definition"] = 336,
    ["Datahub Ingestion Recipe"] = 739,
    ["Dein Config"] = 118,
    Deno = 197,
    ["Deployer Recipe"] = 200,
    ["Deta Spacefile"] = 119,
    ...
    Devfile = 222,
    ["Discord Webhook"] = 202,
    ["Dolittle Artifacts"] = 206,
    ["Dolittle Bounded Context Configuration"] = 207,
    ["Dolittle Event Horizons Configuration"] = 208,
    ["Dolittle Resources Configuration"] = 209,
    ["Dolittle Server Configuration"] = 210,
    ["Dolittle Tenant Map Configuration"] = 212,
    ["Dolittle Tenants Configuration"] = 211,
    ["Dolittle Topology"] = 213,
    ["Drupal Breakpoints"] = 122,
    ["Drupal Config"] = 133,
    ["Drupal Info"] = 123,
    ["Drupal Layouts"] = 124,
    ["Drupal Libraries"] = 125,
    ["Drupal Links Action"] = 126,
    ["Drupal Links Contextual"] = 127,
    ["Drupal Links Menu"] = 128,
    ["Drupal Links Task"] = 129,
    ["Drupal Migration"] = 130,
    ["Drupal Permissions"] = 131,
    ["Drupal Routing"] = 132,
    ["Drupal Services"] = 134,
    ["Drush site aliases"] = 218,
    ["Embrace Config"] = 750,
    Endurica = 792,
    ["Error pages"] = 231,
    Esquio = 229,
    ["Estuary Flow Catalog"] = 729,
    ["Expo SDK"] = 234,
    ["F-Droid Data metadata"] = 239,
    ["Facets - FSDL - Application"] = 237,
    ["FasterCI Configuration"] = 63,
    FiQuS = 243,
    Firebase = 241,
    ["Fossa configuration file"] = 250,
    ["Fossa's fossa-deps file"] = 251,
    ["Foundry VTT - Base package Manifest"] = 245,
    ["Foundry VTT - Module Manifest"] = 246,
    ["Foundry VTT - System Data Template"] = 249,
    ["Foundry VTT - System Manifest"] = 247,
    ["Foundry VTT - World Manifest"] = 248,
    ["Foxx Manifest"] = 64,
    ["Freifunk.de Community API"] = 67,
    ["Frogbot Config"] = 68,
    ["Fusion resource pack metadata"] = 255,
    ["Fusion texture metadata"] = 256,
    ["G2P Mapping Configuration"] = 257,
    ["GCP Blueprint Metadata"] = 260,
    Gaspar = 258,
    ["GatewayCore API Gateway"] = 259,
    ["GeoJSON.json latest"] = 727,
    GherKing = 731,
    ["GitHub Action"] = 264,
    ["GitHub Discussion"] = 265,
    ["GitHub Funding"] = 266,
    ["GitHub Issue Template configuration"] = 268,
    ["GitHub Workflow"] = 269,
    ["GitHub Workflow Template Properties"] = 270,
    ["GitHub issue forms"] = 267,
    GitVersion = 263,
    ["Gitpod Configuration"] = 272,
    ["Global Privacy Control"] = 261,
    Goblet = 788,
    ["Google Chrome Related Website Sets"] = 242,
    ["Google Cloud Workflows"] = 167,
    Gorder = 276,
    Goreleaser = 277,
    ["Goreleaser Pro"] = 278,
    Goss = 279,
    ["Gradle Build Cache Node"] = 679,
    ["Gradle Enterprise"] = 678,
    ["Grafana 5.x Dashboard"] = 280,
    ["GraphQL Code Generator"] = 283,
    ["GraphQL Config"] = 282,
    ["GraphQL Mesh"] = 281,
    ["Grunt JSHint task"] = 287,
    ["Grunt Watch task"] = 288,
    ["Grunt base task"] = 289,
    ["Grunt clean task"] = 285,
    ["Grunt copy task"] = 284,
    ["Grunt cssmin task"] = 286,
    HEMTT = 648,
    Hadolint = 660,
    Hammerkit = 688,
    ["Hardware Sentry Configuration"] = 743,
    Hatch = 661,
    Hayson = 291,
    ["Haystack Pipeline"] = 292,
    ["Hazelcast 5 Configuration"] = 293,
    ["Helm Chart.lock"] = 136,
    ["Helm Chart.yaml"] = 135,
    ["Helm Unittest Test Suite"] = 137,
    Hugo = 719,
    ["Hugo Theme"] = 718,
    ["IBM Zapp document"] = 298,
    ["IBM zCodeFormatSettings"] = 299,
    ["IMG Catapult PSP"] = 304,
    Istanbul = 746,
    ["JDownloader2 crawler multi-rules"] = 314,
    ["JDownloader2 crawler single-rules"] = 313,
    ["JFrog Applications Config"] = 315,
    ["JFrog File Spec"] = 316,
    ["JFrog Pipelines YML DSL"] = 752,
    ["JMeter DSL cli config"] = 317,
    JReleaser = 319,
    ["JSON Document Transform"] = 326,
    ["JSON Feed"] = 327,
    ["JSON Resume"] = 490,
    ["JSON Schema Draft 2020-12"] = 625,
    ["JSON Schema Draft 4"] = 622,
    ["JSON Schema Draft 7"] = 623,
    ["JSON Schema Draft 7 (unofficial strict)"] = 790,
    ["JSON Schema Draft 8 (2019-09)"] = 624,
    ["JSON-API"] = 325,
    ["JSON-e templates"] = 686,
    ["JSON-stat 2.0"] = 619,
    JSONPatch = 329,
    Jasmine = 309,
    Jekyll = 310,
    ["Jenkins X Pipelines"] = 311,
    ["Jenkins X Requirements"] = 312,
    ["Jovo Language Models"] = 318,
    ["KIMMDY config file"] = 334,
    ["KSP-AVC"] = 620,
    ["KSP-CKAN"] = 621,
    ["Karakum configuration file"] = 252,
    Kas = 332,
    ["Keycloak REST API"] = 760,
    ["Knative Functions - func.yaml"] = 253,
    ["KoDE/CI build.yaml"] = 748,
    ["Kong DBLess config"] = 749,
    KrakenD = 335,
    LOOBin = 354,
    Lefthook = 343,
    ["Liferay client-extension.yaml"] = 350,
    ["LinkML Metamodel"] = 352,
    Liquibase = 693,
    ["Liquibase Flow File"] = 694,
    ["Lively Properties"] = 353,
    ["Lobe AI Agent"] = 61,
    ["MLOS Configs"] = 386,
    ["MS2Rescore Configuration"] = 388,
    Markdownlint = 697,
    ["Mason Registry"] = 699,
    ["MegaLinter configuration"] = 360,
    ["MegaLinter descriptor"] = 361,
    Melange = 796,
    ["Meltano plugin discovery definition"] = 363,
    ["Meltano project definition"] = 362,
    ["Microsoft Band Web Tile"] = 364,
    ["Minecraft Custom Main Menu Mod"] = 797,
    ["Minecraft Data Pack Advancement"] = 366,
    ["Minecraft Data Pack Biome"] = 367,
    ["Minecraft Data Pack Configured Carver"] = 368,
    ["Minecraft Data Pack Damage Type"] = 369,
    ["Minecraft Data Pack Dimension"] = 371,
    ["Minecraft Data Pack Dimension Type"] = 370,
    ["Minecraft Data Pack Item Modifier"] = 372,
    ["Minecraft Data Pack Loot Table"] = 373,
    ["Minecraft Data Pack Metadata"] = 374,
    ["Minecraft Data Pack Predicate"] = 375,
    ["Minecraft Data Pack Recipe"] = 376,
    ["Minecraft Data Pack Tag"] = 377,
    ["Minecraft Data Pack Template Pool"] = 378,
    ["Minecraft Data Pack Trim Material"] = 383,
    ["Minecraft Data Pack Trim Pattern"] = 384,
    ["Minecraft Resource Pack Lang"] = 379,
    ["Minecraft Resource Pack Particle"] = 380,
    ["Minecraft Resource Pack Texture Mcmeta"] = 382,
    ["Minecraft Resourcepack Sounds"] = 381,
    ["MkDocs Configuration 1.0"] = 385,
    ["MongoDB Atlas Search Index Definition"] = 747,
    ["Monika Configuration"] = 745,
    ["Motif config"] = 644,
    ["NOX Framework (Service)"] = 403,
    ["Netin Diagnostic System Template"] = 703,
    ["Netlify config"] = 394,
    ...
    ["OpenUtau ustx"] = 416,
    ["OpenWeather Current Weather API"] = 685,
    ["OpenWeather Road Risk API"] = 684,
    ["Ory Hydra configuration"] = 297,
    ["Ory Keto configuration"] = 337,
    ...
    ["Partial-Setuptools"] = 525,
    ["Partial-poetry"] = 443,
    ["Pipeline component"] = 695,
    ["PocketMine plugin.yml"] = 441,
    Poetry = 442,
    ["Postman collection"] = 448,
    ["Problem object RFC9457"] = 794,
    ["Problem package generators"] = 455,
    Pterodactyl = 742,
    ["Pull Request Labeler"] = 470,
    Pulumi = 476,
    PyProject = 477,
    Pyright = 478,
    Qgoda = 479,
    Qodana = 715,
    ["Quali Torque Blueprint Spec 2"] = 740,
    ["QueryFirst config file"] = 763,
    ["RKE Cluster Configuration JSON"] = 692,
    ["RKE Cluster Configuration YAML"] = 691,
    ["Rancher Fleet"] = 473,
    Ray = 659,
    ["Read the Docs"] = 475,
    ["Red-DiscordBot Cog"] = 480,
    ["Red-DiscordBot Cog Repo"] = 481,
    ["Red-DiscordBot Trivia"] = 482,
    RenderCV = 492,
    Renovate = 491,
    ["Replit config"] = 486,
    RoadRunner = 493,
    ["Rudder techniques"] = 799,
    Ruff = 488,
    ["Rust Project"] = 489,
    ["Rust toolchain"] = 495,
    ["SIL Kit Participant Configuration"] = 529,
    ["SIL Kit Registry Configuration"] = 530,
    SWADL = 555,
    ["Safebox Config"] = 753,
    ["Sapphire CLI Config"] = 498,
    ["SauceCTL Configuration"] = 700,
    ["Schema Catalog"] = 512,
    ["Scoop manifest"] = 517,
    ["Semantic Data Fabric (SDF) file"] = 518,
    ["Semgrep Rule"] = 520,
    ["Serenity Code Generator (Sergen)"] = 521,
    ["Serverless Framework Configuration"] = 709,
    ["Serverless Workflow"] = 711,
    ["Settings.paf"] = 523,
    Setuptools = 524,
    ["Shopware 6 Configuration"] = 712,
    ["Shopware CLI Extension Store Configuration"] = 713,
    ["Shopware CLI Project Store Configuration"] = 714,
    Sigma = 527,
    ["Sigrid scope configuration file"] = 528,
    ["SkyPilot Task JSON"] = 800,
    ["Slack app manifest"] = 532,
    Solidarity = 535,
    ["Solution filters"] = 536,
    ["Source Maps v3"] = 537,
    Sourcery = 538,
    SpecIF = 539,
    ["Sponge Mixin configuration"] = 540,
    StackBlitz = 545,
    ["StackHawk Scanner Configuration"] = 708,
    Stale = 546,
    ["Starlake Data Pipeline"] = 682,
    Starship = 547,
    ["Statamic Blueprint"] = 548,
    ["Stella configuration file"] = 549,
    ["StrmPrivacy Data Connector"] = 757,
    ["StrmPrivacy Data Contract"] = 758,
    ["StrmPrivacy SimpleSchema"] = 755,
    ["StrmPrivacy Stream"] = 756,
    ["StrmPrivacy batch job configuration file"] = 754,
    ["Stryker Mutator"] = 552,
    ["StyleCop Analyzers Configuration"] = 553,
    ["Sublime Syntax"] = 759,
    ["Swagger API 2.0"] = 556,
    TSON = 581,
    TSTyche = 582,
    Talhelper = 558,
    ["Talisman configuration"] = 559,
    ["Taskfile config"] = 687,
    Taurus = 560,
    ["TestEnvironment.json"] = 569,
    ["TextMate Grammar"] = 568,
    ["Tier.run pricing.json"] = 563,
    Tikibase = 564,
    ["Traefik v2"] = 572,
    ["Traefik v2 File Provider"] = 573,
    TunnelHub = 793,
    Turborepo = 570,
    Tye = 716,
    ["UET BuildConfig.json"] = 764,
    ["UI5 Manifest"] = 591,
    ["UNCORS configuration"] = 595,
    ["UTAM Page Object"] = 594,
    ["Ubuntu Server Autoinstall"] = 589,
    ["Uniswap Token List"] = 670,
    ["Unreal Engine Uplugin"] = 765,
    ["Unreal Engine Uproject"] = 766,
    ["Updatecli Compose"] = 724,
    ["Updatecli Policy Manifest"] = 725,
    ["Updatecli Policy Metadata"] = 726,
    Uplift = 762,
    ["User Journey Map"] = 690,
    V2Ray = 730,
    ["VSCode Code Snippets"] = 155,
    ["VSIX CLI publishing"] = 608,
    ["Vela Pipeline Configuration"] = 598,
    Vercel = 154,
    Visivo = 791,
    ["Web App Manifest"] = 615,
    ["Web types"] = 618,
    WebExtensions = 614,
    ["Webman package recipe"] = 736,
    ["Windows Package Manager Installer Manifest"] = 667,
    ["Windows Package Manager Locale Manifest"] = 668,
    ["Windows Package Manager Singleton Manifest"] = 666,
    ["Woodpecker pipeline config"] = 702,
    ["Xstate Machine"] = 722,
    ["Yippee-Ki-JSON configuration YML"] = 672,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 16,
    apko = 795,
    ...
    ["bamboo-spec"] = 73,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 773,
    ["bashly-strings.yml"] = 774,
    ["bashly.yml"] = 772,
    ["batect.yml"] = 72,
    ["beef-database-codegen"] = 74,
    ["beef-database-v5-codegen"] = 76,
    ["beef-entity-codegen"] = 75,
    ["beef-entity-v5-codegen"] = 77,
    ["behat.yml"] = 86,
    ["bigquery-table"] = 78,
    ...
    ["chisel-slices.json"] = 172,
    ["chrome-extension-locales-messages.json"] = 162,
    ["chutzpah.json"] = 163,
    cibuildwheel = 108,
    clangd = 142,
    clib = 143,
    ["cloud-init: cloud-config userdata"] = 145,
    ["cloud-sdk-pipeline-configuration"] = 165,
    ["cloudbuild.json"] = 166,
    cloudify = 144,
    codemagic = 146,
    ["coffeelint.json"] = 174,
    ["commands.json"] = 158,
    ["compile_commands.json"] = 157,
    ["compilerconfig.json"] = 156,
    ["completely.yml"] = 770,
    ["component-detection-manifest.json"] = 177,
    ["component.json"] = 176,
    ["composer.json"] = 175,
    ["config.yaml"] = 474,
    ["contentmanifest.json"] = 164,
    ["contribute.json"] = 178,
    ["cosmos.config.json"] = 160,
    ["crowdin.yml"] = 179,
    cspell = 185,
    ["custom-elements.json"] = 784,
    ["cypress.json"] = 183,
    ["datalogic-scan2deploy-android"] = 192,
    ["datalogic-scan2deploy-ce"] = 193,
    ["dbt Project"] = 117,
    ["ddev-global"] = 194,
    ["ddev-project"] = 195,
    ["debugsettings.json"] = 196,
    ["dependabot-v2.json"] = 199,
    ["dependabot.json"] = 198,
    ["deployed-cli"] = 721,
    ["detekt.yml"] = 201,
    ["devcontainer.json"] = 148,
    devinit = 674,
    ["devspace.yaml"] = 744,
    djlint = 675,
    ["docfx.json"] = 205,
    ["docker sequencer"] = 204,
    ["docker-compose.yml"] = 673,
    ["dockerd.json"] = 203,
    ["dotnet Release Index manifest"] = 214,
    ["dotnetcli.host.json"] = 215,
    ["dprint.json"] = 216,
    ["drone.json"] = 217,
    ["dss-2.0.0.json"] = 219,
    ["dstack configuration"] = 220,
    ["dvc.yaml"] = 221,
    ["ecosystem.json"] = 226,
    eksctl = 227,
    ["electron-builder configuration file"] = 232,
    ["epr-manifest.json"] = 230,
    ["evcc.yaml"] = 233,
    ["ezd task runner"] = 235,
    ["fabric.mod.json"] = 238,
    ["first-timers-bot"] = 244,
    ["flagd flag configuration"] = 65,
    ["fly.io Configuration"] = 66,
    fulibWorkflows = 701,
    ["function.json"] = 254,
    ["geojson.json"] = 262,
    ["gitlab-ci"] = 271,
    ["global.json"] = 273,
    ["go-feature-flag Flag Configuration"] = 275,
    ["golangci-lint Configuration"] = 274,
    ["haxelib.json"] = 290,
    helmfile = 662,
    helmwave = 663,
    ["host-meta.json"] = 295,
    ...
    ["ide.host.json"] = 300,
    ["ifstate.conf"] = 301,
    ["imageoptimizer.json"] = 302,
    ["importmap.json"] = 305,
    ["ioBroker Configuration"] = 306,
    ["ioBroker JSON UI"] = 307,
    ["ioBroker Package manifest"] = 308,
    ["ize.toml"] = 761,
    ["jsconfig.json"] = 330,
    ["jscpd Configuration"] = 741,
    jsdoc = 658,
    ["k3d.yaml"] = 331,
    ["k9s plugin.yml"] = 333,
    ["kontinuous-config.yaml"] = 339,
    ["kontinuous-values.yaml"] = 338,
    ["kustomization.yaml"] = 340,
    ["label-commenter-config.yml"] = 341,
    ["latexindent configuration"] = 60,
    ["launchsettings.json"] = 342,
    lazydocker = 783,
    lazygit = 782,
    ["lego.json"] = 344,
    ["lerna.json"] = 345,
    ["lgtm.yml"] = 346,
    ["liblab.config.json"] = 347,
    ["libman.json"] = 348,
    ["license-report-config.json"] = 349,
    ["linkinator.config.json"] = 351,
    ["local.settings.json"] = 356,
    ["localazy.json"] = 357,
    ["lotus.yaml"] = 355,
    ["lsdlschema.json"] = 358,
    ["madness.yml"] = 771,
    ["markdown-lint-check"] = 698,
    mboats = 705,
    ["micro-settings.json"] = 776,
    ["mimetypes.json"] = 365,
    ["mirrord config"] = 639,
    mise = 640,
    ["mise-settings"] = 641,
    ...
    ["partial-cibuildwheel"] = 109,
    ["partial-scikit-build"] = 707,
    ["pathfinder.yml"] = 435,
    ["pattern.json"] = 439,
    ["petstore-v1.0"] = 751,
    pgap_yaml_input_reader = 438,
    ["plagiarize-me.yaml"] = 445,
    ["plagiarize.yaml"] = 444,
    ["portman.json"] = 446,
    ["prettierrc.json"] = 453,
    ["prisma.yml"] = 454,
    ["project-1.0.0-beta3.json"] = 457,
    ["project-1.0.0-beta4.json"] = 458,
    ["project-1.0.0-beta5.json"] = 459,
    ["project-1.0.0-beta6.json"] = 460,
    ["project-1.0.0-beta8.json"] = 461,
    ["project-1.0.0-rc1.json"] = 462,
    ["project-1.0.0-rc2.json"] = 463,
    ["project.json"] = 456,
    ["prometheus.json"] = 464,
    ["prometheus.rules.json"] = 465,
    ["prometheus.rules.test.json"] = 466,
    ["proxies.json"] = 467,
    ["publiccode.yml"] = 468,
    ["pubspec.yaml"] = 469,
    ["pyrseas-0.8.json"] = 472,
    ["quilt.mod.json"] = 777,
    ["release drafter"] = 654,
    ["release-plz.toml"] = 484,
    ["rivet.yaml"] = 798,
    rustfmt = 494,
    samt = 496,
    samtrc = 497,
    ["sarif-1.0.0.json"] = 499,
    ["sarif-2.0.0.json"] = 500,
    ["sarif-2.1.0"] = 510,
    ["sarif-2.1.0-rtm.2"] = 501,
    ["sarif-2.1.0-rtm.3"] = 503,
    ["sarif-2.1.0-rtm.4"] = 505,
    ["sarif-2.1.0-rtm.5"] = 507,
    ["sarif-2.1.0-rtm.6"] = 508,
    ["sarif-external-property-file-2.1.0"] = 511,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 502,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 504,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 506,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 509,
    ["schema.org - Action"] = 513,
    ["schema.org - ContactPoint"] = 514,
    ["schema.org - Place"] = 515,
    ["schema.org - Thing"] = 516,
    ["scikit-build"] = 706,
    ["secrethub.yml"] = 779,
    ["semantic-release"] = 519,
    ["servicehub.config.json"] = 628,
    ["servicehub.service.json"] = 627,
    ["settings.job"] = 522,
    ["sfdx-hardis configuration"] = 526,
    ["size-limit configuration"] = 531,
    ["skaffold.yaml"] = 696,
    ["skyuxconfig.json"] = 533,
    snapcraft = 534,
    ["sqlc configuration"] = 542,
    ["stripe-app-local.json"] = 551,
    ["stripe-app.json"] = 550,
    swcrc = 683,
    syntax = 781,
    ["task.json"] = 557,
    taskcat = 650,
    ["template.json"] = 561,
    ["templatsources.json"] = 562,
    ["theme.json"] = 565,
    ["tizen_workspace.json"] = 566,
    tldr = 567,
    tmuxinator = 636,
    ["transcend.yml"] = 574,
    ["trunk.yaml"] = 575,
    ["ts-force-config.json"] = 579,
    ["tsconfig.json"] = 576,
    ["tsd.json"] = 577,
    ["tsdrc.json"] = 578,
    ["tslint.json"] = 580,
    ...
    ["typingsrc.json"] = 588,
    ["typo3.json"] = 586,
    ["ui5-workspace.yaml"] = 593,
    ["ui5.yaml"] = 592,
    unist = 717,
    ["up.json"] = 590,
    v8r = 612,
    ["vcpkg configuration file"] = 153,
    ["vcpkg manifest file"] = 152,
    ["vega-lite.json"] = 597,
    ["vega.json"] = 596,
    ["venvironment-basic.yaml"] = 600,
    ["venvironment.yaml"] = 599,
    ["version.json"] = 601,
    ["vim-addon-info"] = 602,
    ["vs-2017.3.host.json"] = 604,
    ["vs-nesting.json"] = 605,
    ["vsls.json"] = 603,
    ["vss-extension.json"] = 609,
    ["vtesttree.yaml"] = 610,
    ["vtestunit.yaml"] = 611,
    ["warp-keysets.json"] = 785,
    ["warp-themes.json"] = 786,
    ["warp-workflows.json"] = 787,
    ["webhint.io"] = 737,
    ["webjobpublishsettings.json"] = 617,
    ["webjobs-list.json"] = 616,
    ["xs-app.json"] = 646,
    ["xunit.runner.json"] = 626,
    yamllint = 671,
    zuul = 655,
    ["Žinoma"] = 665
  },
