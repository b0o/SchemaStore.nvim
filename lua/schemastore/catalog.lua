...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 167,
    [".cryproj (generic)"] = 586,
    [".cryproj engine-5.2"] = 581,
    [".cryproj engine-5.3"] = 582,
    [".cryproj engine-5.4"] = 583,
    [".cryproj engine-5.5"] = 584,
    [".cryproj engine-dev"] = 585,
    [".csscomb.json"] = 169,
    [".csslintrc"] = 170,
    [".es6importsorterrc.json"] = 712,
    [".eslintrc"] = 219,
    [".esmrc.json"] = 211,
    [".ffizer.yaml"] = 223,
    [".htmlhintrc"] = 273,
    ...
    [".mtaext"] = 595,
    [".nodehawkrc"] = 371,
    [".npmpackagejsonlintrc"] = 374,
    [".phraseapp.yml"] = 415,
    [".pmbot.yml"] = 405,
    [".postcssrc"] = 410,
    [".powerpages-web-template-manifest"] = 412,
    [".pre-commit-config.yml"] = 413,
    [".pre-commit-hooks.yml"] = 414,
    [".putout.json"] = 434,
    [".rehyperc"] = 446,
    [".remarkrc"] = 447,
    [".sprite files"] = 500,
    ...
    ["<div>RIOTS' studio configuration"] = 565,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 332,
    ["API Builder"] = 626,
    ["AVA Configuration"] = 682,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 657,
    ["All Contributors configuration file"] = 711,
    ...
    ["Azure Pipelines"] = 54,
    ["Azure Static Web Apps CLI configuration file"] = 503,
    ["Azure Static Web Apps configuration file"] = 502,
    ["BX CI"] = 89,
    ["Better Code Hub"] = 630,
    ["Better Scripts"] = 90,
    BizTalkServerApplicationSchema = 601,
    ...
    ["Butane Config"] = 669,
    ["CICS TS region tagging"] = 676,
    ["CICS TS resource import"] = 677,
    ["CICS TS resource model"] = 678,
    ["CICS TS resource overrides"] = 679,
    ["CMake Presets"] = 91,
    ["CNC Codes"] = 100,
    ...
    Conjure = 99,
    ["Container Structure Test"] = 613,
    Containerlab = 638,
    ["Crowdsec collection config"] = 163,
    ["Crowdsec parser config"] = 164,
    ["Crowdsec scenario config"] = 165,
    ["DWP Exchange - catalogue entry"] = 208,
    ["DWP Exchange - gateway"] = 206,
    ["DWP Exchange - meta"] = 207,
    ["Dart build configuration"] = 171,
    ["Dart test config"] = 172,
    ["DashLord configuration"] = 173,
    ["Data Contract Specification"] = 174,
    ["Databricks Asset Bundles"] = 732,
    ["Datadog Service Definition"] = 311,
    ["Datahub Ingestion Recipe"] = 683,
    ["Dein Config"] = 105,
    Deno = 180,
    ["Deployer Recipe"] = 183,
    ["Deta Spacefile"] = 106,
    Devfile = 205,
    ["Discord Webhook"] = 185,
    ["Dolittle Artifacts"] = 189,
    ["Dolittle Bounded Context Configuration"] = 190,
    ["Dolittle Event Horizons Configuration"] = 191,
    ["Dolittle Resources Configuration"] = 192,
    ["Dolittle Server Configuration"] = 193,
    ["Dolittle Tenant Map Configuration"] = 195,
    ["Dolittle Tenants Configuration"] = 194,
    ["Dolittle Topology"] = 196,
    ...
    ["Drupal Routing"] = 117,
    ["Drupal Services"] = 119,
    ["Drush site aliases"] = 201,
    ["Embrace Config"] = 694,
    ["Error pages"] = 214,
    Esquio = 212,
    ["Estuary Flow Catalog"] = 673,
    ["Expo SDK"] = 217,
    ["F-Droid Data metadata"] = 222,
    ["Facets - FSDL - Application"] = 220,
    ["FasterCI Configuration"] = 55,
    Firebase = 224,
    ["Fossa configuration file"] = 231,
    ["Fossa's fossa-deps file"] = 232,
    ["Foundry VTT - Base package Manifest"] = 226,
    ["Foundry VTT - Module Manifest"] = 227,
    ["Foundry VTT - System Data Template"] = 230,
    ["Foundry VTT - System Manifest"] = 228,
    ["Foundry VTT - World Manifest"] = 229,
    ["Foxx Manifest"] = 56,
    ["Freifunk.de Community API"] = 59,
    ["Frogbot Config"] = 60,
    ["G2P Mapping Configuration"] = 236,
    ["GCP Blueprint Metadata"] = 238,
    ["GatewayCore API Gateway"] = 237,
    ["GeoJSON.json latest"] = 671,
    GherKing = 675,
    ["GitHub Action"] = 242,
    ["GitHub Discussion"] = 243,
    ["GitHub Funding"] = 244,
    ["GitHub Issue Template configuration"] = 246,
    ["GitHub Workflow"] = 247,
    ["GitHub Workflow Template Properties"] = 248,
    ["GitHub issue forms"] = 245,
    GitVersion = 241,
    ...
    ["Goreleaser Pro"] = 255,
    Goss = 256,
    ["Gradle Build Cache Node"] = 628,
    ["Gradle Enterprise"] = 627,
    ["Grafana 5.x Dashboard"] = 257,
    ["GraphQL Code Generator"] = 260,
    ["GraphQL Config"] = 259,
    ["GraphQL Mesh"] = 258,
    ["Grunt JSHint task"] = 264,
    ["Grunt Watch task"] = 265,
    ["Grunt base task"] = 266,
    ["Grunt clean task"] = 262,
    ["Grunt copy task"] = 261,
    ["Grunt cssmin task"] = 263,
    HEMTT = 598,
    Hadolint = 610,
    Hammerkit = 637,
    ["Hardware Sentry Configuration"] = 687,
    Hayson = 268,
    ["Haystack Pipeline"] = 269,
    ["Hazelcast 5 Configuration"] = 270,
    ["Helm Chart.lock"] = 121,
    ["Helm Chart.yaml"] = 120,
    ["Helm Unittest Test Suite"] = 122,
    Hugo = 665,
    ["IBM Zapp document"] = 275,
    ["IBM zCodeFormatSettings"] = 276,
    ["IMG Catapult PSP"] = 281,
    Istanbul = 690,
    ["JDownloader2 crawler multi-rules"] = 291,
    ["JDownloader2 crawler single-rules"] = 290,
    ["JFrog Applications Config"] = 292,
    ["JFrog File Spec"] = 293,
    ["JFrog Pipelines YML DSL"] = 696,
    ["JMeter DSL cli config"] = 294,
    JReleaser = 296,
    ["JSON Document Transform"] = 303,
    ["JSON Feed"] = 304,
    ["JSON Resume"] = 453,
    ["JSON Schema Draft 2020-12"] = 577,
    ["JSON Schema Draft 4"] = 574,
    ["JSON Schema Draft 7"] = 575,
    ["JSON Schema Draft 7 (unofficial strict)"] = 733,
    ["JSON Schema Draft 8 (2019-09)"] = 576,
    ["JSON-API"] = 302,
    ["JSON-e templates"] = 635,
    ["JSON-stat 2.0"] = 571,
    JSONPatch = 306,
    Jasmine = 286,
    Jekyll = 287,
    ["Jenkins X Pipelines"] = 288,
    ["Jenkins X Requirements"] = 289,
    ["Jovo Language Models"] = 295,
    ["KSP-AVC"] = 572,
    ["KSP-CKAN"] = 573,
    ["Karakum configuration file"] = 233,
    Kas = 309,
    ["Keycloak REST API"] = 703,
    ["Knative Functions - func.yaml"] = 234,
    ["KoDE/CI build.yaml"] = 692,
    ["Kong DBLess config"] = 693,
    KrakenD = 310,
    LOOBin = 327,
    Lefthook = 318,
    ["LinkML Metamodel"] = 325,
    Liquibase = 642,
    ["Liquibase Flow File"] = 643,
    ["Lively Properties"] = 326,
    ["MS2Rescore Configuration"] = 359,
    Markdownlint = 646,
    ["Mason Registry"] = 648,
    ["MegaLinter configuration"] = 333,
    ["MegaLinter descriptor"] = 334,
    ["Meltano plugin discovery definition"] = 336,
    ["Meltano project definition"] = 335,
    ["Microsoft Band Web Tile"] = 337,
    ["Minecraft Data Pack Advancement"] = 339,
    ["Minecraft Data Pack Biome"] = 340,
    ["Minecraft Data Pack Configured Carver"] = 341,
    ["Minecraft Data Pack Damage Type"] = 342,
    ["Minecraft Data Pack Dimension"] = 344,
    ["Minecraft Data Pack Dimension Type"] = 343,
    ["Minecraft Data Pack Item Modifier"] = 345,
    ["Minecraft Data Pack Loot Table"] = 346,
    ["Minecraft Data Pack Metadata"] = 347,
    ["Minecraft Data Pack Predicate"] = 348,
    ["Minecraft Data Pack Recipe"] = 349,
    ["Minecraft Data Pack Tag"] = 350,
    ["Minecraft Data Pack Template Pool"] = 351,
    ["Minecraft Data Pack Trim Material"] = 356,
    ["Minecraft Data Pack Trim Pattern"] = 357,
    ["Minecraft Resource Pack Lang"] = 352,
    ["Minecraft Resource Pack Particle"] = 353,
    ["Minecraft Resource Pack Texture Mcmeta"] = 355,
    ["Minecraft Resourcepack Sounds"] = 354,
    ["MkDocs Configuration 1.0"] = 358,
    ["MongoDB Atlas Search Index Definition"] = 691,
    ["Monika Configuration"] = 689,
    ["Motif config"] = 594,
    ["NOX Framework (Service)"] = 373,
    ["Netin Diagnostic System Template"] = 652,
    ["Netlify config"] = 364,
    ["Nexus-as-Code Data Model"] = 365,
    ["Nightwatch.js"] = 366,
    ["ONe's service descriptor"] = 386,
    ["OSS Review Toolkit configuration"] = 393,
    ["OSS Review Toolkit curation"] = 394,
    ["OSS Review Toolkit package configuration"] = 395,
    ["OSS Review Toolkit repository configuration"] = 396,
    ["OSS Review Toolkit resolutions"] = 397,
    Opctl = 597,
    ["OpenRewrite Resource"] = 388,
    ["OpenWeather Current Weather API"] = 634,
    ["OpenWeather Road Risk API"] = 633,
    ["Ory Hydra configuration"] = 274,
    ["Ory Keto configuration"] = 312,
    ["Ory Kratos configuration"] = 392,
    ["Ory Oathkeeper configuration"] = 380,
    ["Outblocks App configuration"] = 390,
    ["Outblocks database table"] = 391,
    ["Outblocks project configuration"] = 389,
    Packer = 400,
    Pantsbuild = 710,
    ["Paper paper-plugin.yml"] = 401,
    ["Pipeline component"] = 644,
    ["PocketMine plugin.yml"] = 406,
    ["Postman collection"] = 411,
    ["Problem package generators"] = 418,
    Pterodactyl = 686,
    ["Pull Request Labeler"] = 433,
    Pulumi = 439,
    PyProject = 440,
    Pyright = 441,
    Qgoda = 442,
    Qodana = 662,
    ["Quali Torque Blueprint Spec 2"] = 684,
    ["QueryFirst config file"] = 706,
    ["RKE Cluster Configuration JSON"] = 641,
    ["RKE Cluster Configuration YAML"] = 640,
    ["Rancher Fleet"] = 436,
    Ray = 609,
    ["Read the Docs"] = 438,
    ["Red-DiscordBot Cog"] = 443,
    ["Red-DiscordBot Cog Repo"] = 444,
    ["Red-DiscordBot Trivia"] = 445,
    Renovate = 454,
    ["Replit config"] = 448,
    RoadRunner = 455,
    Ruff = 451,
    ["Rust Project"] = 452,
    ["Rust toolchain"] = 457,
    ["SIL Kit Participant Configuration"] = 488,
    ["SIL Kit Registry Configuration"] = 489,
    SWADL = 512,
    ["Safebox Config"] = 697,
    ["Sapphire CLI Config"] = 460,
    ["SauceCTL Configuration"] = 649,
    ["Schema Catalog"] = 474,
    ["Scoop manifest"] = 479,
    ["Semantic Data Fabric (SDF) file"] = 480,
    ["Semgrep Rule"] = 482,
    ["Serenity Code Generator (Sergen)"] = 483,
    ["Serverless Framework Configuration"] = 656,
    ["Serverless Workflow"] = 658,
    ["Settings.paf"] = 485,
    ["Shopware 6 Configuration"] = 659,
    ["Shopware CLI Extension Store Configuration"] = 660,
    ["Shopware CLI Project Store Configuration"] = 661,
    ["Sigrid scope configuration file"] = 487,
    ["Slack app manifest"] = 491,
    Solidarity = 494,
    ["Solution filters"] = 495,
    ["Source Maps v3"] = 496,
    Sourcery = 497,
    SpecIF = 498,
    ["Sponge Mixin configuration"] = 499,
    ["StackHawk Scanner Configuration"] = 655,
    Stale = 504,
    ["Starlake Data Pipeline"] = 631,
    Starship = 505,
    ["Statamic Blueprint"] = 506,
    ["StrmPrivacy Data Connector"] = 701,
    ["StrmPrivacy Data Contract"] = 702,
    ["StrmPrivacy SimpleSchema"] = 699,
    ["StrmPrivacy Stream"] = 700,
    ["StrmPrivacy batch job configuration file"] = 698,
    ["Stryker Mutator"] = 509,
    ["StyleCop Analyzers Configuration"] = 510,
    ["Swagger API 2.0"] = 513,
    TSON = 537,
    ["Talisman configuration"] = 515,
    ["Taskfile config"] = 636,
    Taurus = 516,
    ["TestEnvironment.json"] = 525,
    ["Tier.run pricing.json"] = 519,
    Tikibase = 520,
    ["Traefik v2"] = 528,
    ["Traefik v2 File Provider"] = 529,
    Turborepo = 526,
    Tye = 663,
    ["UET BuildConfig.json"] = 707,
    ["UI5 Manifest"] = 544,
    ["UTAM Page Object"] = 547,
    ["Ubuntu Server Autoinstall"] = 542,
    ["Uniswap Token List"] = 619,
    ["Unreal Engine Uplugin"] = 708,
    ["Unreal Engine Uproject"] = 709,
    Updatecli = 670,
    Uplift = 705,
    ["User Journey Map"] = 639,
    V2Ray = 674,
    ...
    ["Web types"] = 570,
    WebExtensions = 566,
    ["Webman package recipe"] = 680,
    ["Windows Package Manager Installer Manifest"] = 616,
    ["Windows Package Manager Locale Manifest"] = 617,
    ["Windows Package Manager Singleton Manifest"] = 615,
    ["Woodpecker pipeline config"] = 651,
    ["Xstate Machine"] = 668,
    ["Yippee-Ki-JSON configuration YML"] = 621,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 65,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 716,
    ["bashly-strings.yml"] = 717,
    ["bashly.yml"] = 715,
    ["batect.yml"] = 64,
    ...
    ["crowdin.yml"] = 162,
    cspell = 168,
    ["custom-elements.json"] = 727,
    ["cypress.json"] = 166,
    ["datalogic-scan2deploy-android"] = 175,
    ["datalogic-scan2deploy-ce"] = 176,
    ["dbt Project"] = 104,
    ["ddev-global"] = 177,
    ["ddev-project"] = 178,
    ["debugsettings.json"] = 179,
    ["dependabot-v2.json"] = 182,
    ["dependabot.json"] = 181,
    ["deployed-cli"] = 667,
    ["detekt.yml"] = 184,
    ...
    djlint = 624,
    ["docfx.json"] = 188,
    ["docker sequencer"] = 187,
    ["docker-compose.yml"] = 622,
    ["dockerd.json"] = 186,
    ["dotnet Release Index manifest"] = 197,
    ["dotnetcli.host.json"] = 198,
    ["dprint.json"] = 199,
    ["drone.json"] = 200,
    ["dss-2.0.0.json"] = 202,
    ["dstack configuration"] = 203,
    ["dvc.yaml"] = 204,
    ["ecosystem.json"] = 209,
    eksctl = 210,
    ["electron-builder configuration file"] = 215,
    ["epr-manifest.json"] = 213,
    ["evcc.yaml"] = 216,
    ["ezd task runner"] = 218,
    ["fabric.mod.json"] = 221,
    ["first-timers-bot"] = 225,
    ...
    ["gitlab-ci"] = 249,
    ["global.json"] = 251,
    ["go-feature-flag Flag Configuration"] = 253,
    ...
    ["ide.host.json"] = 277,
    ["ifstate.conf"] = 278,
    ["imageoptimizer.json"] = 279,
    ["importmap.json"] = 282,
    ["ioBroker Configuration"] = 283,
    ["ioBroker JSON UI"] = 284,
    ["ioBroker Package manifest"] = 285,
    ["ize.toml"] = 704,
    ["jsconfig.json"] = 307,
    ["jscpd Configuration"] = 685,
    jsdoc = 608,
    ["k3d.yaml"] = 308,
    ["kontinuous-config.yaml"] = 314,
    ["kontinuous-values.yaml"] = 313,
    ["kustomization.yaml"] = 315,
    ["label-commenter-config.yml"] = 316,
    ["launchsettings.json"] = 317,
    lazydocker = 726,
    lazygit = 725,
    ["lego.json"] = 319,
    ["lerna.json"] = 320,
    ["lgtm.yml"] = 321,
    ["libman.json"] = 322,
    ["license-report-config.json"] = 323,
    ["linkinator.config.json"] = 324,
    ["local.settings.json"] = 329,
    ["localazy.json"] = 330,
    ["lotus.yaml"] = 328,
    ["lsdlschema.json"] = 331,
    ["madness.yml"] = 714,
    ["markdown-lint-check"] = 647,
    mboats = 654,
    ["micro-settings.json"] = 719,
    ["mimetypes.json"] = 338,
    ["mirrord config"] = 591,
    ["mta.yaml"] = 592,
    ["mtad.yaml"] = 593,
    ["mycode.json"] = 362,
    ["napari plugin manifest"] = 363,
    neoload = 603,
    ["nest-cli"] = 369,
    ["ninjs (News in JSON) 1.3"] = 368,
    ["ninjs (News in JSON) 2.0"] = 367,
    ["nlu.json"] = 370,
    ["nodemon.json"] = 372,
    ["noodl config"] = 653,
    now = 599,
    ...
    ["nswag.json"] = 378,
    ntangle = 379,
    ["nuclei-template.yaml"] = 376,
    ["nuget-project.json"] = 377,
    ["ocelot.json"] = 381,
    ["omnisharp.json"] = 382,
    ["openapi.json"] = 383,
    ["openfin.json"] = 387,
    ...
    ["ops.yaml"] = 385,
    ["package.json"] = 398,
    ["package.manifest"] = 399,
    ["pathfinder.yml"] = 402,
    ["pattern.json"] = 404,
    ["petstore-v1.0"] = 695,
    pgap_yaml_input_reader = 403,
    ["plagiarize-me.yaml"] = 408,
    ["plagiarize.yaml"] = 407,
    ["portman.json"] = 409,
    ["prettierrc.json"] = 416,
    ["prisma.yml"] = 417,
    ["project-1.0.0-beta3.json"] = 420,
    ["project-1.0.0-beta4.json"] = 421,
    ["project-1.0.0-beta5.json"] = 422,
    ["project-1.0.0-beta6.json"] = 423,
    ["project-1.0.0-beta8.json"] = 424,
    ["project-1.0.0-rc1.json"] = 425,
    ["project-1.0.0-rc2.json"] = 426,
    ["project.json"] = 419,
    ["prometheus.json"] = 427,
    ["prometheus.rules.json"] = 428,
    ["prometheus.rules.test.json"] = 429,
    ["proxies.json"] = 430,
    ["publiccode.yml"] = 431,
    ["pubspec.yaml"] = 432,
    ["pyrseas-0.8.json"] = 435,
    ["quilt.mod.json"] = 720,
    ["release drafter"] = 604,
    rtx = 450,
    rustfmt = 456,
    samt = 458,
    samtrc = 459,
    ["sarif-1.0.0.json"] = 461,
    ["sarif-2.0.0.json"] = 462,
    ["sarif-2.1.0"] = 472,
    ["sarif-2.1.0-rtm.2"] = 463,
    ["sarif-2.1.0-rtm.3"] = 465,
    ["sarif-2.1.0-rtm.4"] = 467,
    ["sarif-2.1.0-rtm.5"] = 469,
    ["sarif-2.1.0-rtm.6"] = 470,
    ["sarif-external-property-file-2.1.0"] = 473,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 464,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 466,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 468,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 471,
    ["schema.org - Action"] = 475,
    ["schema.org - ContactPoint"] = 476,
    ["schema.org - Place"] = 477,
    ["schema.org - Thing"] = 478,
    ["secrethub.yml"] = 722,
    ["semantic-release"] = 481,
    ["servicehub.config.json"] = 580,
    ["servicehub.service.json"] = 579,
    ["settings.job"] = 484,
    ["sfdx-hardis configuration"] = 486,
    ["size-limit configuration"] = 490,
    ["skaffold.yaml"] = 645,
    ["skyuxconfig.json"] = 492,
    snapcraft = 493,
    ["sqlc configuration"] = 501,
    ["stripe-app-local.json"] = 508,
    ["stripe-app.json"] = 507,
    swcrc = 632,
    syntax = 724,
    ["task.json"] = 514,
    taskcat = 600,
    ["template.json"] = 517,
    ["templatsources.json"] = 518,
    ["theme.json"] = 521,
    ["tizen_workspace.json"] = 522,
    tldr = 523,
    tmLanguage = 524,
    tmuxinator = 588,
    ["transcend.yml"] = 530,
    ["trunk.yaml"] = 531,
    ["ts-force-config.json"] = 535,
    ["tsconfig.json"] = 532,
    ["tsd.json"] = 533,
    ["tsdrc.json"] = 534,
    ["tslint.json"] = 536,
    ...
    ["vega-lite.json"] = 549,
    ["vega.json"] = 548,
    ["venvironment-basic.yaml"] = 552,
    ["venvironment.yaml"] = 551,
    ["version.json"] = 553,
    ["vim-addon-info"] = 554,
    ["vs-2017.3.host.json"] = 556,
    ["vs-nesting.json"] = 557,
    ["vsls.json"] = 555,
    ["vss-extension.json"] = 561,
    ["vtesttree.yaml"] = 562,
    ["vtestunit.yaml"] = 563,
    ["warp-keysets.json"] = 728,
    ["warp-themes.json"] = 729,
    ["warp-workflows.json"] = 730,
    ["webhint.io"] = 681,
    ["webjobpublishsettings.json"] = 569,
    ["webjobs-list.json"] = 568,
    ["xs-app.json"] = 596,
    ["xunit.runner.json"] = 578,
    yamllint = 620,
    zuul = 605,
    ["Žinoma"] = 614
  },
