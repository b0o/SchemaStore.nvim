...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 983,
    [".nodehawkrc"] = 618,
    [".npmpackagejsonlintrc"] = 622,
    [".omletrc"] = 1162,
    [".phrase.yml"] = 698,
    [".phraseapp.yml"] = 699,
    [".pmbot.yml"] = 683,
    [".postcssrc"] = 692,
    [".powerpages-web-template-manifest"] = 694,
    [".pre-commit-config.yml"] = 695,
    [".pre-commit-hooks.yml"] = 696,
    [".putout.json"] = 732,
    [".rehyperc"] = 757,
    [".remarkrc"] = 761,
    [".sprite files"] = 857,
    ...
    AIConfig = 36,
    ["AMX Muse Program Descriptor"] = 1210,
    ["API Builder"] = 1018,
    ["AVA Configuration"] = 1081,
    ...
    ["AWS Copilot Manifest"] = 1249,
    ["AWS SAM CLI Samconfig"] = 274,
    Acton = 1299,
    ["Adobe UXP Manifest"] = 1144,
    ["Aerleon Network & Service Definitions"] = 22,
    ["Aerleon Policy"] = 23,
    ["Agent Permission Policy"] = 1289,
    ["AgentCore CLI"] = 1290,
    Aider = 1239,
    Air = 25,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1260,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1259,
    ["Airlock Microgateway"] = 37,
    ["Alacritty Configuration"] = 1053,
    ["AlgoVoi Compliance Receipt v1"] = 12,
    ["All Contributors configuration file"] = 1107,
    ...
    ["Application list for a WinUtil"] = 1189,
    ArchitectFX = 1194,
    ["Argo CD"] = 56,
    ["Argo Events"] = 57,
    ["Argo Workflows"] = 58,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1258,
    ["Azure IoT Operations connector metadata"] = 1255,
    ...
    ["Azure Pipelines"] = 116,
    ["Azure Static Web Apps CLI configuration file"] = 861,
    ["Azure Static Web Apps configuration file"] = 860,
    BMML = 1277,
    ["BOSH CPI Config"] = 142,
    ...
    ["Bacon config"] = 6,
    ["Barba-CV"] = 85,
    ["Bashly (bashly.yml)"] = 1111,
    ["Bashly Settings (bashly-settings.yml)"] = 1112,
    Bento = 1276,
    ["Better Code Hub"] = 1023,
    ["Better Scripts"] = 165,
    Bigconfig = 135,
    ["Biome Formatter Config"] = 86,
    ["Bitmovin Encoding Template"] = 1203,
    BizTalkServerApplicationSchema = 990,
    Bleep = 166,
    ["Block Protocol Metadata"] = 163,
    ["Bluebricks blueprint config"] = 1282,
    ["Boyka Framework"] = 144,
    ...
    ["Butane Config"] = 1066,
    C4InterFlow = 1218,
    ["CDK Environment Manager, concrete environment configuration"] = 1242,
    ["CDK Environment Manager, concrete environments definition"] = 1241,
    ["CDK Environment Manager, environment definition"] = 1240,
    ["CGS Card Game Specification (cgs.json)"] = 1149,
    ["CICS TS region tagging"] = 1075,
    ["CICS TS resource import"] = 1076,
    ["CICS TS resource model"] = 1077,
    ["CICS TS resource overrides"] = 1078,
    ["CMake Presets"] = 167,
    ["CNC Codes"] = 189,
    ["CRS WAF test file"] = 1179,
    ["CRS WAF test platform overrides file"] = 1180,
    ...
    ["Chamaleon environment"] = 1207,
    ["Chamaleon properties"] = 1208,
    ["Chamaleon template"] = 1206,
    Changepacks = 1269,
    Changesets = 283,
    Changie = 176,
    Charmcraft = 177,
    ...
    ["Clawject config"] = 195,
    ["Cloud Foundry Application Manifest"] = 1161,
    ["Cloud Run Spec v1"] = 1184,
    ...
    Concord = 1178,
    ["Configu .cfgu files"] = 1166,
    ["Configu .configu file"] = 1167,
    Conjure = 188,
    ["Container Structure Test"] = 1004,
    Containerlab = 1032,
    ["Contextive Glossary"] = 1234,
    Convex = 187,
    ["Crowdsec collection config"] = 293,
    ["Crowdsec parser config"] = 294,
    ["Crowdsec scenario config"] = 295,
    ["CumulusCI Config"] = 194,
    ["Cursor Agent Environment"] = 1287,
    ["Custom Machinery Machine"] = 1150,
    ["Custom Machinery Recipe"] = 1151,
    ...
    ["DataYoga Job"] = 205,
    ["Datadog Continuous Testing"] = 530,
    ["Datadog Service Definition"] = 531,
    ["Datadog Software Catalog"] = 532,
    ["Datahub Ingestion Recipe"] = 1082,
    ["Debian Upstream Metadata file"] = 212,
    ["Deck config"] = 213,
    ["Declarative Automation Bundles"] = 1128,
    ["DeepMatch deeplinks spec"] = 214,
    ["Dein Config"] = 215,
    ["Deno Config (deno.json)"] = 311,
    ["Dependency cruiser"] = 216,
    ["DeployStack Configuration"] = 217,
    ["Deployah Configuration"] = 1257,
    ["Deployer Recipe"] = 314,
    ["Deta Spacefile"] = 218,
    ...
    ["DonateCaseBetterCasino menu"] = 1211,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1119,
    ["EAS config"] = 382,
    ["ECA - Editor Code Assistant"] = 346,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1108,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1254,
    ["EasyVCR .NET"] = 384,
    ["Eidolon Resource"] = 1195,
    ...
    ["Envelope Team Definition"] = 1298,
    ["Envilder Map File"] = 350,
    ["Erda Pipeline"] = 1157,
    ["Erda Runtime"] = 1158,
    ["Espanso config.yml"] = 1280,
    ["Espanso match.yml"] = 1279,
    Esquio = 370,
    ["Estuary Flow Catalog"] = 1072,
    ["Ethereum ERC1155"] = 1292,
    ["Ethereum ERC721"] = 1291,
    ...
    ["Evolving Resolutive Process notation"] = 1256,
    ["Expo SDK"] = 381,
    ...
    ["GeoJSON.json latest"] = 1070,
    GherKing = 1074,
    ["GitHub Action"] = 417,
    ["GitHub Actions typing"] = 1191,
    ...
    ["Google Digital Assetlinks"] = 1235,
    Goreleaser = 446,
    ["Goreleaser Pro"] = 447,
    Goss = 448,
    ["Gradle Build Cache Node"] = 1021,
    ["Gradle Enterprise"] = 1020,
    ["Grafana 5.x Dashboard"] = 449,
    ["GraphQL Code Generator"] = 454,
    ["GraphQL Config"] = 453,
    ["GraphQL Mesh"] = 452,
    ["GroovyLint configuration"] = 455,
    ["Grunt JSHint task"] = 459,
    ["Grunt Watch task"] = 460,
    ["Grunt base task"] = 461,
    ["Grunt clean task"] = 457,
    ["Grunt copy task"] = 456,
    ["Grunt cssmin task"] = 458,
    HEMTT = 986,
    Hadolint = 1000,
    Hammerkit = 1031,
    ["Hardware Sentry Configuration"] = 1086,
    ["Hashgraph Online Skill Manifest"] = 2,
    ["HashiCorp Vault"] = 462,
    Hatch = 1001,
    Hayson = 464,
    ["Haystack Pipeline"] = 465,
    ["Hazelcast 5 Configuration"] = 466,
    ["Hecate Input Schema"] = 1246,
    ["Helm Chart.lock"] = 236,
    ["Helm Chart.yaml"] = 235,
    ["Helm Unittest Test Suite"] = 237,
    ["Home Assistant Integration Manifest"] = 467,
    ["Homer dashboard configuration"] = 468,
    Hugo = 1062,
    ["Hugo Theme"] = 1061,
    ["Hulak Configuration"] = 475,
    ["Hyperfoil benchmark configuration"] = 474,
    ["IBM Zapp document"] = 476,
    ["IBM zCodeFormatSettings"] = 477,
    ["IMG Catapult PSP"] = 482,
    ["IVMS101 by CODE Protocol"] = 1147,
    Infrahub = 484,
    Istanbul = 1090,
    ["JDownloader2 crawler multi-rules"] = 497,
    ["JDownloader2 crawler single-rules"] = 496,
    ["JFrog Applications Config"] = 498,
    ["JFrog File Spec"] = 499,
    ["JFrog Pipelines YML DSL"] = 1096,
    ["JMeter DSL cli config"] = 500,
    JReleaser = 503,
    ["JSON Document Transform"] = 511,
    ["JSON Feed"] = 512,
    ["JSON Resume"] = 769,
    ["JSON Schema Draft 2020-12"] = 968,
    ["JSON Schema Draft 4"] = 965,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1129,
    ["JSON Schema Draft 7"] = 966,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1130,
    ["JSON Schema Draft 8 (2019-09)"] = 967,
    ["JSON-API"] = 510,
    ["JSON-e templates"] = 1028,
    ["JSON-stat 2.0"] = 961,
    JSONPatch = 514,
    ["JSR Package Config (jsr.json)"] = 504,
    Jarl = 1262,
    Jasmine = 491,
    Jekyll = 492,
    ["Jenkins X Pipelines"] = 493,
    ["Jenkins X Requirements"] = 494,
    Jest = 495,
    Jocker = 501,
    ["Jovo Language Models"] = 502,
    ["Jujutsu (jj) VCS config"] = 1248,
    ["KIMMDY config file"] = 525,
    ["KODE/CI build.yaml"] = 1092,
    ["KSP-AVC"] = 962,
    ["KSP-CKAN"] = 963,
    ["KSP-NetKAN"] = 964,
    KSY = 1159,
    ...
    Kas = 517,
    ["Kestra flow file"] = 526,
    ["Keycloak REST API"] = 1099,
    ["Knative Functions - func.yaml"] = 404,
    Knip = 405,
    ["Knowledge Unit"] = 534,
    ["Kometa (nightly) config file"] = 528,
    ["Kometa config file"] = 527,
    ["Kong DBLess config"] = 1093,
    KrakenD = 529,
    ["Kubri Configuration"] = 537,
    LOOBin = 552,
    ["Lake configuration file"] = 1251,
    ...
    ["Lando (landofile)"] = 112,
    ["LangGraph Platform configuration"] = 1171,
    ["Language configuration"] = 1170,
    Lefthook = 541,
    ["Liferay client-extension.yaml"] = 548,
    ["LinkML Metamodel"] = 550,
    Liquibase = 1037,
    ["Liquibase Flow File"] = 1038,
    ["Lively Properties"] = 551,
    ["Lobe AI Agent"] = 114,
    Loki = 115,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 594,
    ["MS2Rescore Configuration"] = 599,
    ["Madness (madness.yml)"] = 1110,
    ["Mado configuration"] = 558,
    ["Maestro Flow"] = 559,
    ["Mail Servers Configuration"] = 1283,
    ["MapEHR Mapping"] = 560,
    Markdownlint = 1041,
    ["Mason Registry"] = 1044,
    ["MegaLinter Custom Flavor"] = 563,
    ["MegaLinter configuration"] = 562,
    ["MegaLinter descriptor"] = 564,
    Melange = 1137,
    ["Meltano project definition"] = 565,
    ["Mergify Configuration"] = 600,
    ["Metadata for a Bazel module"] = 566,
    ["Metadata for a Cinnamon spice"] = 1187,
    ["Metatype Configuration"] = 567,
    ["MetricsHub Configuration"] = 568,
    ["MetricsHub Connector Configuration"] = 569,
    ["Micro Editor Syntax"] = 1120,
    ["Microsoft Band Web Tile"] = 570,
    ["Microsoft RulesEngine workflow rules"] = 1175,
    ["Microsoft RulesEngine workflow rules list"] = 1176,
    ["Minecraft Custom Main Menu Mod"] = 1138,
    ["Minecraft Data Pack Advancement"] = 572,
    ["Minecraft Data Pack Biome"] = 573,
    ["Minecraft Data Pack Configured Carver"] = 574,
    ["Minecraft Data Pack Damage Type"] = 575,
    ["Minecraft Data Pack Dimension"] = 577,
    ["Minecraft Data Pack Dimension Type"] = 576,
    ["Minecraft Data Pack Item Modifier"] = 578,
    ["Minecraft Data Pack Loot Table"] = 579,
    ["Minecraft Data Pack Metadata"] = 580,
    ["Minecraft Data Pack Predicate"] = 581,
    ["Minecraft Data Pack Recipe"] = 582,
    ["Minecraft Data Pack Tag"] = 583,
    ["Minecraft Data Pack Template Pool"] = 584,
    ["Minecraft Data Pack Trim Material"] = 589,
    ["Minecraft Data Pack Trim Pattern"] = 590,
    ["Minecraft Resource Pack Lang"] = 585,
    ["Minecraft Resource Pack Particle"] = 586,
    ["Minecraft Resource Pack Texture Mcmeta"] = 588,
    ["Minecraft Resourcepack Sounds"] = 587,
    ["MockServer Expectations"] = 596,
    ModuleAssembler = 592,
    ["Monade CLI Stack Configuration"] = 603,
    ["MongoDB Atlas Search Index Definition"] = 1091,
    ["Monika Configuration"] = 1089,
    ["Monoweave Configuration"] = 598,
    ["Motif config"] = 982,
    MultiQC = 1228,
    ["NOX Framework (Service)"] = 621,
    ["Netin Diagnostic System Template"] = 1048,
    ["Netlify config"] = 606,
    ["Network-as-Code Data Model"] = 607,
    ["Next Gen UI Agent A2A Server Configuration"] = 608,
    ["Next Gen UI Agent Configuration"] = 610,
    ["Next Gen UI Agent MCP Server Configuration"] = 609,
    ["Nightwatch.js"] = 614,
    ["Node.js configuration"] = 987,
    ["NueJS configuration file"] = 626,
    ["Nuitka.yaml"] = 1152,
    ["Nullstone config"] = 628,
    ["ONe's changelog entry"] = 647,
    ["ONe's service descriptor"] = 646,
    ["ORT Server repository environment configuration"] = 657,
    ["OSCAL Assessment Plan (AP)"] = 659,
    ["OSCAL Assessment Results (AR)"] = 660,
    ["OSCAL Catalog"] = 661,
    ["OSCAL Component Definition (CDef)"] = 662,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 663,
    ["OSCAL Profile"] = 664,
    ["OSCAL System Security Plan (SSP)"] = 665,
    ["OSS Review Toolkit configuration"] = 666,
    ["OSS Review Toolkit curation"] = 667,
    ["OSS Review Toolkit package configuration"] = 668,
    ["OSS Review Toolkit repository configuration"] = 669,
    ["OSS Review Toolkit resolutions"] = 670,
    ["October CMS columns"] = 632,
    ["October CMS fields"] = 633,
    ["Oh My Posh"] = 635,
    Okteto = 636,
    ["Ona Automations"] = 638,
    Opctl = 985,
    ["Open Data Contract Standard (ODCS)"] = 651,
    ["Open Data Product Standard (ODPS)"] = 652,
    ["Open Know-How"] = 1233,
    OpenDecree = 1296,
    ["OpenDecree Configuration"] = 1297,
    ["OpenRewrite Resource"] = 649,
    OpenSRM = 653,
    OpenStatus = 1244,
    ["OpenTelemetry Declarative Configuration"] = 650,
    ["OpenUtau character yaml"] = 643,
    ["OpenUtau ustx"] = 644,
    ["OpenWeather Current Weather API"] = 1027,
    ["OpenWeather Road Risk API"] = 1026,
    ["Ory Hydra configuration"] = 473,
    ["Ory Keto configuration"] = 533,
    ["Ory Kratos configuration"] = 658,
    ["Ory Oathkeeper configuration"] = 630,
    ["Outblocks App configuration"] = 655,
    ["Outblocks database table"] = 656,
    ["Outblocks project configuration"] = 654,
    PDM = 677,
    POPxf = 689,
    ["POPxf Correlations"] = 690,
    ["PRML manifest"] = 697,
    Packer = 674,
    PactSpec = 675,
    Pantsbuild = 1106,
    ["Paper paper-plugin.yml"] = 676,
    ["Pipeline component"] = 1039,
    ["Platform.sh application"] = 8,
    ["Platform.sh routes"] = 9,
    ["Platform.sh services"] = 10,
    ["Plex Prerolls"] = 687,
    ["PocketMine plugin.yml"] = 684,
    ["Postman collection"] = 693,
    ["Power Pages Configuration"] = 1245,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1190,
    ["ProActions AI-Kit Configuration"] = 705,
    ["ProActions AI-Kit Configuration for Menus"] = 707,
    ["ProActions AI-Kit Configuration for Sections"] = 709,
    ["ProActions AI-Kit Configuration for Services"] = 706,
    ["ProActions AI-Kit Configuration for Steps"] = 710,
    ["ProActions AI-Kit Configuration for Templates"] = 708,
    ["Problem object RFC9457"] = 1135,
    ["Problem package format"] = 711,
    ["Problem package generators"] = 712,
    ["Problem package submissions"] = 713,
    ["Problem package test group metadata"] = 714,
    Pterodactyl = 1085,
    ["Pull Request Labeler"] = 731,
    Pulumi = 739,
    ["PyGTA Config"] = 735,
    PyProject = 740,
    Pylock = 1236,
    Pyright = 741,
    ["Python script metadata"] = 1230,
    ["QType AI DSL"] = 744,
    Qgoda = 743,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1307,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1305,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1311,
    ["Qlik Talend Cloud Pipeline - Project"] = 1303,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1306,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1308,
    ["Qlik Talend Cloud Pipeline - Task"] = 1304,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1310,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1309,
    Qodana = 1058,
    ["Qt Creator workspace file"] = 1168,
    ["Quali Torque Blueprint Spec 2"] = 1083,
    ["QueryFirst config file"] = 1102,
    ["QuikRun Configuration"] = 1312,
    ["Qwen Code Settings"] = 1293,
    ["RKE Cluster Configuration JSON"] = 1036,
    ["RKE Cluster Configuration YAML"] = 1035,
    RadioHound = 734,
    ["Raid Profile"] = 1294,
    ["Raid Repo Configuration"] = 1295,
    Railpack = 746,
    Railway = 745,
    ["Rancher Fleet"] = 736,
    ["Rattler-build"] = 747,
    Ray = 999,
    ["Read the Docs"] = 738,
    ["Red-DiscordBot Cog"] = 754,
    ["Red-DiscordBot Cog Repo"] = 755,
    ["Red-DiscordBot Trivia"] = 756,
    ["Releasaurus Config"] = 5,
    ReleaseKit = 4,
    ["Render Blueprints"] = 1034,
    RenderCV = 773,
    Renovate = 770,
    ["Renovate global configuration"] = 771,
    ["Renovate inherited configuration"] = 772,
    ["Replit config"] = 762,
    Restate = 1223,
    ["Revel Digital Gadget Definition File"] = 1247,
    RoadRunner = 775,
    ["Robust Station Image"] = 1253,
    Rockcraft = 776,
    ["Roo Coder Custom Modes"] = 777,
    Rubocop = 766,
    ["Rudder techniques"] = 1142,
    Ruff = 767,
    ["Rust Project"] = 768,
    ["Rust toolchain"] = 782,
    ["SDMX data message"] = 809,
    ["SDMX metadata message"] = 808,
    ["SDMX structure message"] = 807,
    ["SIL Kit Participant Configuration"] = 819,
    ["SIL Kit Registry Configuration"] = 820,
    ["SPDX 2.3"] = 858,
    SWADL = 874,
    ["Safebox Config"] = 1097,
    ["Sapphire CLI Config"] = 785,
    ["SauceCTL Configuration"] = 1045,
    Scarb = 805,
    ["Schema Catalog"] = 800,
    ["Scoop manifest"] = 806,
    ["Semantic Data Fabric (SDF) file"] = 810,
    ["Semgrep Rule"] = 812,
    ["Serenity Code Generator (Sergen)"] = 813,
    ["Serverless Framework Configuration"] = 1052,
    ["Serverless Workflow"] = 1054,
    ["Settings for a Cinnamon spice"] = 1186,
    ["Settings.paf"] = 815,
    ["Shopware 6 Configuration"] = 1055,
    ["Shopware CLI Extension Store Configuration"] = 1056,
    ["Shopware CLI Project Store Configuration"] = 1057,
    ["Sigma Detection Rule"] = 817,
    ["Sigrid scope configuration file"] = 818,
    ["SkyPilot Task JSON"] = 1143,
    ["Slack app manifest"] = 822,
    Snapcraft = 824,
    ["Solarxy project config"] = 827,
    Solidarity = 828,
    ["Solution filters"] = 829,
    ["Source Maps v3"] = 830,
    Sourcery = 831,
    ["Spack bootstrap.yaml"] = 832,
    ["Spack cdash.yaml"] = 833,
    ["Spack ci.yaml"] = 834,
    ["Spack compilers.yaml"] = 835,
    ["Spack concretizer.yaml"] = 836,
    ["Spack config.yaml"] = 837,
    ["Spack definitions.yaml"] = 838,
    ["Spack develop.yaml"] = 839,
    ["Spack env_vars.yaml"] = 840,
    ["Spack environment"] = 846,
    ["Spack include.yaml"] = 841,
    ["Spack mirrors.yaml"] = 842,
    ["Spack modules.yaml"] = 843,
    ["Spack packages.yaml"] = 844,
    ["Spack repos.yaml"] = 845,
    ["Spack toolchains.yaml"] = 847,
    ["Spack upstreams.yaml"] = 848,
    ["Spack view.yaml"] = 849,
    ["Speakeasy Generation Config File"] = 853,
    ["Speakeasy Lint Configuration File"] = 850,
    ["Speakeasy Test Generation Configuration File"] = 851,
    ["Speakeasy Workflow File"] = 852,
    SpecIF = 854,
    ["Specmatic Configuration"] = 855,
    ["Sponge Mixin configuration"] = 856,
    StackBlitz = 862,
    ["StackHawk Scanner Configuration"] = 1051,
    Stale = 863,
    Starfish = 864,
    ["Starlake Data Pipeline"] = 1024,
    Starship = 865,
    ["Statamic Blueprint"] = 866,
    ["Stella configuration file"] = 867,
    ["Streamlit configuration file"] = 868,
    ["Stryker Mutator"] = 871,
    ["StyleCop Analyzers Configuration"] = 872,
    ["Stylelint (.stylelintrc)"] = 873,
    ["Stylua Config"] = 1237,
    ["Sublime Syntax"] = 1098,
    ["Subsquid squid manifest"] = 1145,
    ["Swagger API 2.0"] = 875,
    ["Synadia Connect Component"] = 876,
    TSON = 912,
    TSTyche = 913,
    ["TYPO3 Vendor Bundler config"] = 919,
    ["Tab data for a LinUtil"] = 1193,
    ["Tab list for a LinUtil"] = 1192,
    Tach = 877,
    ["Tach Domain"] = 878,
    Talhelper = 880,
    ["Talisman configuration"] = 881,
    Taplo = 1238,
    ["Taskfile config"] = 1029,
    Taurus = 882,
    Tauticord = 883,
    ["Tekton Pipeline"] = 1266,
    ["Tekton PipelineRun"] = 1267,
    ["Tekton Task"] = 1264,
    ["Tekton TaskRun"] = 1265,
    Telefonistka = 1224,
    ["Terrateam config"] = 1250,
    ["TestEnvironment.json"] = 895,
    ["TextMate Grammar"] = 894,
    Threagile = 889,
    ["Tier.run pricing.json"] = 886,
    Tikibase = 887,
    Tombi = 892,
    ["Traefik v2"] = 898,
    ["Traefik v2 File Provider"] = 899,
    ["Traefik v3"] = 900,
    ["Traefik v3 File Provider"] = 901,
    ["Travis CI (.travis.yml)"] = 897,
    Treefmt = 451,
    Trident = 1220,
    ["TrueScript for *.tscript files"] = 904,
    ["Tugboat QA config.yml"] = 1217,
    TunnelHub = 1133,
    Turborepo = 896,
    Tycho = 1182,
    Tye = 1059,
    ["Tyk Gateway - Open Source v5.7+"] = 1229,
    ["UET BuildConfig.json"] = 1103,
    ["UI5 Manifest"] = 925,
    ["UNCORS configuration"] = 929,
    ["UTAM Page Object"] = 928,
    ["Ubuntu Server Autoinstall"] = 923,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1221,
    ["Uniswap Token List"] = 1010,
    ["Universal Schedule Format"] = 930,
    ["Unreal Engine Uplugin"] = 1104,
    ["Unreal Engine Uproject"] = 1105,
    ["UpCloud CLI (upctl) configuration"] = 1222,
    ["Updatecli Compose"] = 1067,
    ["Updatecli Policy Manifest"] = 1068,
    ["Updatecli Policy Metadata"] = 1069,
    Uplift = 1101,
    ["Upsun config"] = 7,
    ["User Journey Map"] = 1033,
    V2Ray = 1073,
    ["VSCode Code Snippets"] = 258,
    ["VSIX CLI publishing"] = 948,
    Vector = 932,
    ["Vela Pipeline Configuration"] = 935,
    Vercel = 257,
    ["Version Bumper config"] = 938,
    Vespertide = 1271,
    ["Vespertide Migration"] = 1272,
    ["Vespertide Model"] = 1273,
    ["Viash Component Config"] = 1226,
    ["Viash Package Config"] = 1227,
    Visivo = 1131,
    ["WP-CLI"] = 958,
    Wake = 1219,
    ["Waku Config"] = 1196,
    ["Web App Manifest"] = 954,
    ["Web types"] = 957,
    WebExtensions = 953,
    ["Webman package recipe"] = 1079,
    ["Windows Package Manager Installer Manifest"] = 1007,
    ["Windows Package Manager Locale Manifest"] = 1008,
    ["Windows Package Manager Singleton Manifest"] = 1006,
    ["WireMock CLI import configuration"] = 1202,
    ["WireMock CLI local service configuration"] = 1201,
    ["WireMock message stub mapping"] = 1200,
    ["WireMock stub mapping"] = 1199,
    ["Woodpecker pipeline config"] = 1047,
    ["Wrangler CLI"] = 959,
    ["XenForo add-on manifest"] = 960,
    ["Xstate Machine"] = 1065,
    ["Yandex Workflow Language"] = 1188,
    ["Yarn Config (.yarnrc.yml)"] = 1022,
    ["Yippee-Ki-JSON configuration YML"] = 1013,
    ["YouTrack App"] = 1185,
    ["Zarf Package Configuration"] = 1252,
    ["Zerops import file"] = 1174,
    ["Zola Configuration"] = 1263,
    ["aerleon.yml"] = 21,
    ["amplify.yml"] = 14,
    ["angular.json"] = 38,
    apko = 1136,
    ...
    ["behat.yml"] = 145,
    ["bigquery-table"] = 134,
    ["bioimageio resource description"] = 1153,
    ...
    ["cargo-nextest repository configuration"] = 611,
    ["cargo-nextest user configuration"] = 612,
    ["ccmod.json"] = 1197,
    changelogging = 1165,
    ...
    ["chutzpah.json"] = 266,
    cibuildwheel = 182,
    ["clang-format (.clang-format)"] = 1071,
    ["clang-tidy"] = 243,
    clangd = 242,
    clib = 244,
    ...
    ["crowdin.yml"] = 292,
    ["ctfd-setup configuration file"] = 1209,
    ["custom-elements.json"] = 1123,
    ["cypress.json"] = 296,
    ["dacier.yml"] = 1302,
    ...
    ["gematik health care insurance list"] = 1215,
    ["gematik health care patient list"] = 1212,
    ["gematik health care provider institution list"] = 1214,
    ["gematik health care provider list"] = 1213,
    ["gematik tiger test environment configuration"] = 1216,
    ["git-town.toml"] = 1261,
    ["gitlab-ci"] = 426,
    ["global.json"] = 442,
    ...
    ["ide.host.json"] = 478,
    ["ifstate.yaml"] = 479,
    ["imageoptimizer.json"] = 480,
    ["importmap.json"] = 483,
    instant_python_config = 485,
    instant_python_custom_project = 486,
    ["ioBroker Configuration"] = 487,
    ["ioBroker JSON UI"] = 488,
    ["ioBroker Package manifest"] = 489,
    ["ixpect.conf.yaml"] = 490,
    ["ize.toml"] = 1100,
    ["jsconfig.json"] = 515,
    ["jscpd Configuration"] = 1084,
    jsdoc = 998,
    ["k3d.yaml"] = 516,
    ["k9s aliases.yaml"] = 518,
    ["k9s cluster-config.yaml"] = 520,
    ["k9s config.yaml"] = 519,
    ["k9s hotkeys.yaml"] = 521,
    ["k9s plugins.yaml"] = 522,
    ["k9s skin.yaml"] = 523,
    ["k9s views.yaml"] = 524,
    ["kontinuous-config.yaml"] = 536,
    ["kontinuous-values.yaml"] = 535,
    ["kustomization.yaml"] = 538,
    ["label-commenter-config.yml"] = 539,
    ["latexindent configuration"] = 113,
    ["launchsettings.json"] = 540,
    lazydocker = 1122,
    lazygit = 1121,
    ["lego.json"] = 542,
    ["lerna.json"] = 543,
    ["lgtm.yml"] = 544,
    ["liblab.config.json"] = 545,
    ["libman.json"] = 546,
    ["license-report-config.json"] = 547,
    ["linkinator.config.json"] = 549,
    ["lint-staged (.lintstagedrc)"] = 976,
    ["local.settings.json"] = 554,
    ["localazy.json"] = 555,
    ["lotus.yaml"] = 553,
    ["lsdlschema.json"] = 556,
    ["macro.json"] = 1088,
    ["markdown-link-check"] = 1042,
    maturin = 1043,
    mboats = 1050,
    memnex = 1300,
    ["micro-settings.json"] = 1115,
    ["mimetypes.json"] = 571,
    ["mirrord config"] = 978,
    mise = 979,
    ["mkdocs.yml"] = 591,
    ...
    ["monospace.yml"] = 597,
    ["moon.yml"] = 1198,
    ["mprocs Configuration file"] = 1169,
    ["mrdocs.yml"] = 593,
    ["mta.yaml"] = 980,
    ["mtad.yaml"] = 981,
    ["mycode.json"] = 604,
    nFPM = 613,
    ["napari plugin manifest"] = 605,
    neoload = 993,
    ["nest-cli"] = 616,
    ["nexus-rpc-gen"] = 1288,
    ["ninjs (News in JSON)"] = 615,
    ["nitro.json"] = 992,
    ["nixd configuration"] = 1141,
    ["nlu.json"] = 617,
    ["nodemon.json"] = 619,
    ["noodl config"] = 1049,
    ["notebook.mod.json"] = 620,
    now = 988,
    ["npm-badges"] = 623,
    ["nswag.json"] = 627,
    ntangle = 629,
    ["nuclei-template.yaml"] = 624,
    ["nuget-project.json"] = 625,
    ["ocelot.json"] = 631,
    ogen = 634,
    ["omnisharp.json"] = 637,
    openHAB = 1274,
    ...
    oxlint = 1285,
    ["package.json"] = 671,
    ["package.manifest"] = 673,
    ["package.yaml"] = 672,
    ["partial-black.json"] = 146,
    ["partial-fastapi.json"] = 147,
    ["partial-pixi.json"] = 682,
    ["partial-scheduled.json"] = 148,
    ["pattern.json"] = 680,
    ["petstore-v1.0"] = 1095,
    pgap_yaml_input_reader = 678,
    pgrls = 679,
    pgxgen = 1278,
    pitcms = 1281,
    ["pixi.toml"] = 681,
    ["plagiarize-me.yaml"] = 686,
    ["plagiarize.yaml"] = 685,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1205,
    ["podbard.yaml"] = 688,
    ["portman.json"] = 691,
    ["prefect.toml"] = 700,
    ["prefect.yaml"] = 701,
    ...
    ["prettierrc.json"] = 703,
    ["prisma.yml"] = 704,
    ["project-1.0.0-beta3.json"] = 716,
    ["project-1.0.0-beta4.json"] = 717,
    ["project-1.0.0-beta5.json"] = 718,
    ["project-1.0.0-beta6.json"] = 719,
    ["project-1.0.0-beta8.json"] = 720,
    ["project-1.0.0-rc1.json"] = 721,
    ["project-1.0.0-rc2.json"] = 722,
    ["project.json"] = 715,
    ["project.owasp.yaml"] = 723,
    ["prometheus-alertmanager.json"] = 727,
    ["prometheus.json"] = 724,
    ["prometheus.rules.json"] = 725,
    ["prometheus.rules.test.json"] = 726,
    ["proxies.json"] = 728,
    ["publiccode.yml"] = 729,
    ["pubspec.yaml"] = 730,
    ["pyrseas-0.8.json"] = 733,
    pytest = 742,
    ["quilt.mod.json"] = 1116,
    ["rc3 auth"] = 748,
    ["rc3 collection"] = 749,
    ...
    ["release drafter"] = 994,
    ["release-hub.json"] = 3,
    ["release-please-config.json"] = 758,
    ["release-please-manifest.json"] = 759,
    ["release-plz.toml"] = 760,
    ["renv.lock"] = 774,
    ["reposets Configuration"] = 763,
    ["reposets Credentials"] = 764,
    ["revola.json"] = 1,
    ["rivet.json"] = 1140,
    ["rivet.yaml (legacy)"] = 1139,
    rumdl = 779,
    runny = 778,
    runspec = 1301,
    rustfmt = 780,
    ...
    samt = 783,
    samtrc = 784,
    ["sarif-1.0.0.json"] = 786,
    ["sarif-2.0.0.json"] = 787,
    ["sarif-2.1.0"] = 797,
    ["sarif-2.1.0-rtm.2"] = 788,
    ["sarif-2.1.0-rtm.3"] = 790,
    ["sarif-2.1.0-rtm.4"] = 792,
    ["sarif-2.1.0-rtm.5"] = 794,
    ["sarif-2.1.0-rtm.6"] = 795,
    ["sarif-external-property-file-2.1.0"] = 798,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 789,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 791,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 793,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 796,
    ["scalingo.json configuration"] = 799,
    ["schema.org - Action"] = 801,
    ["schema.org - ContactPoint"] = 802,
    ["schema.org - Place"] = 803,
    ["schema.org - Thing"] = 804,
    ["secrethub.yml"] = 1118,
    ["semantic-release"] = 811,
    ["servicehub.config.json"] = 971,
    ["servicehub.service.json"] = 970,
    ["settings.job"] = 814,
    ["sfdx-hardis configuration"] = 816,
    ["shard.yml"] = 1156,
    ["size-limit configuration"] = 821,
    ["skaffold.yaml"] = 1040,
    ["skyuxconfig.json"] = 823,
    ["snowflake-config"] = 825,
    ["snowflake-connections"] = 826,
    ["spicepod.yaml"] = 1177,
    ["sqlc configuration"] = 859,
    ["stripe-app-local.json"] = 870,
    ["stripe-app.json"] = 869,
    swcrc = 1025,
    ["task.json"] = 879,
    taskcat = 989,
    ["template.json"] = 884,
    ["templatsources.json"] = 885,
    ["text2confl config"] = 1286,
    ["theme.json"] = 888,
    ["tizen_workspace.json"] = 890,
    tldr = 891,
    ["tm_devices configuration file"] = 1243,
    tmuxinator = 974,
    tox = 893,
    ["transcend.yml"] = 902,
    ["tree-sitter grammar.json"] = 450,
    ["trime.yaml"] = 903,
    ["trunk.yaml"] = 905,
    ["ts-force-config.json"] = 910,
    ["tsconfig.json"] = 906,
    ["tsd.json"] = 907,
    ["tsdoc.json"] = 908,
    ["tsdrc.json"] = 909,
    ...
    ["vega-lite.json"] = 934,
    ["vega.json"] = 933,
    ["venvironment.yaml"] = 936,
    ["venvplus.yaml"] = 937,
    version = 1225,
    ["version.json"] = 939,
    ["vhwdebugger-binding.yaml"] = 941,
    ["vim-addon-info"] = 942,
    ["vs-2017.3.host.json"] = 944,
    ["vs-nesting.json"] = 945,
    ["vsls.json"] = 943,
    ["vss-extension.json"] = 949,
    vtcfg = 1231,
    ["vtesttree.yaml"] = 950,
    ["vtestunit.yaml"] = 951,
    ["warp-keysets.json"] = 1124,
    ["warp-themes.json"] = 1125,
    ["warp-workflows.json"] = 1126,
    ["webhint.io"] = 1080,
    ["webjobpublishsettings.json"] = 956,
    ["webjobs-list.json"] = 955,
    ["well-known-fursona"] = 1164,
    ["xs-app.json"] = 984,
    ["xunit.runner.json"] = 969,
    yamlfmt = 1011,
    yamllint = 1012,
    ["zerops.yml"] = 1173,
    zizmor = 1268,
