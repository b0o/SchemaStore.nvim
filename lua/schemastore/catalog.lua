...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 850,
    [".nodehawkrc"] = 518,
    [".npmpackagejsonlintrc"] = 522,
    [".omletrc"] = 1026,
    [".phrase.yml"] = 585,
    [".phraseapp.yml"] = 586,
    [".pmbot.yml"] = 573,
    [".postcssrc"] = 580,
    [".powerpages-web-template-manifest"] = 582,
    [".pre-commit-config.yml"] = 583,
    [".pre-commit-hooks.yml"] = 584,
    [".putout.json"] = 613,
    [".rehyperc"] = 637,
    [".remarkrc"] = 641,
    [".sprite files"] = 728,
    ...
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1071,
    ["API Builder"] = 885,
    ["AVA Configuration"] = 947,
    ...
    ["AWS Copilot Manifest"] = 1109,
    ["AWS SAM CLI Samconfig"] = 220,
    ["Adobe UXP Manifest"] = 1009,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Aider = 1100,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 919,
    ["All Contributors configuration file"] = 972,
    ...
    ["Application list for a WinUtil"] = 1053,
    ArchitectFX = 1058,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure Pipelines"] = 79,
    ["Azure Static Web Apps CLI configuration file"] = 732,
    ["Azure Static Web Apps configuration file"] = 731,
    ["BOSH CPI Config"] = 103,
    ["BOSH Deploy Config"] = 104,
    ["BX CI"] = 123,
    ["Bashly (bashly.yml)"] = 976,
    ["Bashly Settings (bashly-settings.yml)"] = 977,
    ["Better Code Hub"] = 889,
    ["Better Scripts"] = 124,
    Bigconfig = 96,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1064,
    BizTalkServerApplicationSchema = 857,
    Bleep = 125,
    ...
    ["Butane Config"] = 932,
    C4InterFlow = 1079,
    ["CDK Environment Manager, concrete environment configuration"] = 1103,
    ["CDK Environment Manager, concrete environments definition"] = 1102,
    ["CDK Environment Manager, environment definition"] = 1101,
    ["CGS Card Game Specification (cgs.json)"] = 1014,
    ["CICS TS region tagging"] = 941,
    ["CICS TS resource import"] = 942,
    ["CICS TS resource model"] = 943,
    ["CICS TS resource overrides"] = 944,
    ["CMake Presets"] = 126,
    ["CNC Codes"] = 145,
    ["CRS WAF test file"] = 1043,
    ["CRS WAF test platform overrides file"] = 1044,
    ...
    ["Chamaleon environment"] = 1068,
    ["Chamaleon properties"] = 1069,
    ["Chamaleon template"] = 1067,
    Changesets = 229,
    Charmcraft = 135,
    Cheatsheets = 929,
    ...
    ["Clawject config"] = 151,
    ["Cloud Foundry Application Manifest"] = 1025,
    ["Cloud Run Spec v1"] = 1048,
    ...
    Concord = 1042,
    ["Configu .cfgu files"] = 1030,
    ["Configu .configu file"] = 1031,
    Conjure = 144,
    ["Container Structure Test"] = 871,
    Containerlab = 898,
    ["Contextive Glossary"] = 1095,
    Convex = 143,
    ["Crowdsec collection config"] = 239,
    ["Crowdsec parser config"] = 240,
    ["Crowdsec scenario config"] = 241,
    ["CumulusCI Config"] = 150,
    ["Custom Machinery Machine"] = 1015,
    ["Custom Machinery Recipe"] = 1016,
    ...
    ["DonateCaseBetterCasino menu"] = 1072,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 984,
    ["EAS config"] = 305,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 973,
    ["EasyVCR .NET"] = 306,
    ["Eidolon Resource"] = 1059,
    ...
    ["GeoJSON.json latest"] = 936,
    GherKing = 940,
    ["GitHub Action"] = 336,
    ["GitHub Actions typing"] = 1055,
    ...
    ["Google Digital Assetlinks"] = 1096,
    Goreleaser = 364,
    ["Goreleaser Pro"] = 365,
    Goss = 366,
    ["Gradle Build Cache Node"] = 887,
    ["Gradle Enterprise"] = 886,
    ...
    Hadolint = 867,
    Hammerkit = 897,
    ["Hardware Sentry Configuration"] = 952,
    ["HashiCorp Vault"] = 378,
    Hatch = 868,
    Hayson = 380,
    ["Haystack Pipeline"] = 381,
    ["Hazelcast 5 Configuration"] = 382,
    ["Hecate Input Schema"] = 1107,
    ["Helm Chart.lock"] = 184,
    ["Helm Chart.yaml"] = 183,
    ...
    ["JFrog File Spec"] = 411,
    ["JFrog Pipelines YML DSL"] = 961,
    ["JMeter DSL cli config"] = 412,
    JReleaser = 415,
    ["JSON Document Transform"] = 423,
    ["JSON Feed"] = 424,
    ["JSON Resume"] = 647,
    ["JSON Schema Draft 2020-12"] = 836,
    ["JSON Schema Draft 4"] = 833,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 994,
    ["JSON Schema Draft 7"] = 834,
    ["JSON Schema Draft 7 (unofficial strict)"] = 995,
    ["JSON Schema Draft 8 (2019-09)"] = 835,
    ["JSON-API"] = 422,
    ["JSON-e templates"] = 894,
    ["JSON-stat 2.0"] = 829,
    JSONPatch = 426,
    ...
    ["Jujutsu (jj) VCS config"] = 1108,
    ["KIMMDY config file"] = 437,
    ["KODE/CI build.yaml"] = 957,
    ["KSP-AVC"] = 830,
    ["KSP-CKAN"] = 831,
    ["KSP-NetKAN"] = 832,
    KSY = 1024,
    ...
    ["Lando (landofile)"] = 75,
    ["LangGraph Platform configuration"] = 1035,
    ["Language configuration"] = 1034,
    Lefthook = 452,
    ["Liferay client-extension.yaml"] = 459,
    ["LinkML Metamodel"] = 461,
    Liquibase = 903,
    ["Liquibase Flow File"] = 904,
    ["Lively Properties"] = 462,
    ["Lobe AI Agent"] = 77,
    Loki = 78,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 501,
    ["MS2Rescore Configuration"] = 504,
    ["Madness (madness.yml)"] = 975,
    ["MapEHR Mapping"] = 469,
    Markdownlint = 907,
    ["Mason Registry"] = 910,
    ["MegaLinter configuration"] = 471,
    ["MegaLinter descriptor"] = 472,
    Melange = 1002,
    ["Meltano project definition"] = 473,
    ["Mergify Configuration"] = 505,
    ["Metadata for a Bazel module"] = 474,
    ["Metadata for a Cinnamon spice"] = 1051,
    ["Metatype Configuration"] = 475,
    ["MetricsHub Configuration"] = 476,
    ["MetricsHub Connector Configuration"] = 477,
    ["Micro Editor Syntax"] = 985,
    ["Microsoft Band Web Tile"] = 478,
    ["Microsoft RulesEngine workflow rules"] = 1039,
    ["Microsoft RulesEngine workflow rules list"] = 1040,
    ["Minecraft Custom Main Menu Mod"] = 1003,
    ["Minecraft Data Pack Advancement"] = 480,
    ["Minecraft Data Pack Biome"] = 481,
    ["Minecraft Data Pack Configured Carver"] = 482,
    ["Minecraft Data Pack Damage Type"] = 483,
    ["Minecraft Data Pack Dimension"] = 485,
    ["Minecraft Data Pack Dimension Type"] = 484,
    ["Minecraft Data Pack Item Modifier"] = 486,
    ["Minecraft Data Pack Loot Table"] = 487,
    ["Minecraft Data Pack Metadata"] = 488,
    ["Minecraft Data Pack Predicate"] = 489,
    ["Minecraft Data Pack Recipe"] = 490,
    ["Minecraft Data Pack Tag"] = 491,
    ["Minecraft Data Pack Template Pool"] = 492,
    ["Minecraft Data Pack Trim Material"] = 497,
    ["Minecraft Data Pack Trim Pattern"] = 498,
    ["Minecraft Resource Pack Lang"] = 493,
    ["Minecraft Resource Pack Particle"] = 494,
    ["Minecraft Resource Pack Texture Mcmeta"] = 496,
    ["Minecraft Resourcepack Sounds"] = 495,
    ["Monade CLI Stack Configuration"] = 508,
    ["MongoDB Atlas Search Index Definition"] = 956,
    ["Monika Configuration"] = 954,
    ["Monoweave Configuration"] = 503,
    ["Motif config"] = 849,
    MultiQC = 1089,
    ["NOX Framework (Service)"] = 521,
    ["Netin Diagnostic System Template"] = 914,
    ["Netlify config"] = 511,
    ["Network-as-Code Data Model"] = 512,
    ["Nightwatch.js"] = 514,
    ["Node.js configuration"] = 854,
    ["NueJS configuration file"] = 526,
    ["Nuitka.yaml"] = 1017,
    ["Nullstone config"] = 528,
    ["ONe's changelog entry"] = 542,
    ["ONe's service descriptor"] = 541,
    ["ORT Server repository environment configuration"] = 550,
    ["OSCAL Assessment Plan (AP)"] = 552,
    ["OSCAL Assessment Results (AR)"] = 553,
    ["OSCAL Catalog"] = 554,
    ["OSCAL Component Definition (CDef)"] = 555,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 556,
    ["OSCAL Profile"] = 557,
    ["OSCAL System Security Plan (SSP)"] = 558,
    ["OSS Review Toolkit configuration"] = 559,
    ["OSS Review Toolkit curation"] = 560,
    ["OSS Review Toolkit package configuration"] = 561,
    ["OSS Review Toolkit repository configuration"] = 562,
    ["OSS Review Toolkit resolutions"] = 563,
    ["October CMS columns"] = 532,
    ["October CMS fields"] = 533,
    Okteto = 534,
    Opctl = 852,
    ["Open Data Contract Standard (ODCS)"] = 545,
    ["Open Data Product Standard (ODPS)"] = 546,
    ["Open Know-How"] = 1094,
    ["OpenRewrite Resource"] = 544,
    OpenStatus = 1105,
    ["OpenUtau character yaml"] = 538,
    ["OpenUtau ustx"] = 539,
    ["OpenWeather Current Weather API"] = 893,
    ["OpenWeather Road Risk API"] = 892,
    ["Ory Hydra configuration"] = 389,
    ["Ory Keto configuration"] = 445,
    ["Ory Kratos configuration"] = 551,
    ["Ory Oathkeeper configuration"] = 530,
    ["Outblocks App configuration"] = 548,
    ["Outblocks database table"] = 549,
    ["Outblocks project configuration"] = 547,
    PDM = 569,
    Packer = 566,
    Pantsbuild = 971,
    ["Paper paper-plugin.yml"] = 567,
    ["Pipeline component"] = 905,
    ["Platform.sh application"] = 2,
    ["Platform.sh routes"] = 3,
    ["Platform.sh services"] = 4,
    ["Plex Prerolls"] = 577,
    ["PocketMine plugin.yml"] = 574,
    ["Postman collection"] = 581,
    ["Power Pages Configuration"] = 1106,
    ["Preset list for a WinUtil"] = 1054,
    ["ProActions AI-Kit Configuration"] = 590,
    ["ProActions AI-Kit Configuration for Menus"] = 592,
    ["ProActions AI-Kit Configuration for Sections"] = 594,
    ["ProActions AI-Kit Configuration for Services"] = 591,
    ["ProActions AI-Kit Configuration for Steps"] = 595,
    ["ProActions AI-Kit Configuration for Templates"] = 593,
    ["Problem object RFC9457"] = 1000,
    ["Problem package generators"] = 596,
    Pterodactyl = 951,
    ["Pull Request Labeler"] = 612,
    Pulumi = 620,
    ["PyGTA Config"] = 616,
    PyProject = 621,
    Pylock = 1097,
    Pyright = 622,
    ["Python script metadata"] = 1091,
    ["QType AI DSL"] = 625,
    Qgoda = 624,
    Qodana = 924,
    ["Qt Creator workspace file"] = 1032,
    ["Quali Torque Blueprint Spec 2"] = 949,
    ["QueryFirst config file"] = 967,
    ["RKE Cluster Configuration JSON"] = 902,
    ["RKE Cluster Configuration YAML"] = 901,
    RadioHound = 615,
    Railway = 626,
    ["Rancher Fleet"] = 617,
    ["Rattler-build"] = 627,
    Ray = 866,
    ["Read the Docs"] = 619,
    ["Red-DiscordBot Cog"] = 634,
    ["Red-DiscordBot Cog Repo"] = 635,
    ["Red-DiscordBot Trivia"] = 636,
    ["Render Blueprints"] = 900,
    RenderCV = 649,
    Renovate = 648,
    ["Replit config"] = 642,
    Restate = 1084,
    RoadRunner = 651,
    ["Roo Coder Custom Modes"] = 653,
    Rubocop = 644,
    ["Rudder techniques"] = 1007,
    Ruff = 645,
    ["Rust Project"] = 646,
    ["Rust toolchain"] = 656,
    ["SDMX data message"] = 682,
    ["SDMX metadata message"] = 681,
    ["SDMX structure message"] = 680,
    ["SIL Kit Participant Configuration"] = 692,
    ["SIL Kit Registry Configuration"] = 693,
    ["SPDX 2.3"] = 729,
    SWADL = 743,
    ["Safebox Config"] = 962,
    ["Sapphire CLI Config"] = 659,
    ["SauceCTL Configuration"] = 911,
    ["Schema Catalog"] = 674,
    ["Scoop manifest"] = 679,
    ["Semantic Data Fabric (SDF) file"] = 683,
    ["Semgrep Rule"] = 685,
    ["Serenity Code Generator (Sergen)"] = 686,
    ["Serverless Framework Configuration"] = 918,
    ["Serverless Workflow"] = 920,
    ["Settings for a Cinnamon spice"] = 1050,
    ["Settings.paf"] = 688,
    ["Shopware 6 Configuration"] = 921,
    ["Shopware CLI Extension Store Configuration"] = 922,
    ["Shopware CLI Project Store Configuration"] = 923,
    ["Sigma Detection Rule"] = 690,
    ["Sigrid scope configuration file"] = 691,
    ["SkyPilot Task JSON"] = 1008,
    ["Slack app manifest"] = 695,
    Solidarity = 700,
    ["Solution filters"] = 701,
    ["Source Maps v3"] = 702,
    Sourcery = 703,
    ["Spack bootstrap.yaml"] = 704,
    ["Spack cdash.yaml"] = 705,
    ["Spack ci.yaml"] = 706,
    ["Spack compilers.yaml"] = 707,
    ["Spack concretizer.yaml"] = 708,
    ["Spack config.yaml"] = 709,
    ["Spack definitions.yaml"] = 710,
    ["Spack develop.yaml"] = 711,
    ["Spack env_vars.yaml"] = 712,
    ["Spack environment"] = 718,
    ["Spack include.yaml"] = 713,
    ["Spack mirrors.yaml"] = 714,
    ["Spack modules.yaml"] = 715,
    ["Spack packages.yaml"] = 716,
    ["Spack repos.yaml"] = 717,
    ["Spack toolchains.yaml"] = 719,
    ["Spack upstreams.yaml"] = 720,
    ["Spack view.yaml"] = 721,
    ["Speakeasy Generation Config File"] = 725,
    ["Speakeasy Lint Configuration File"] = 722,
    ["Speakeasy Test Generation Configuration File"] = 723,
    ["Speakeasy Workflow File"] = 724,
    SpecIF = 726,
    ["Sponge Mixin configuration"] = 727,
    StackBlitz = 733,
    ["StackHawk Scanner Configuration"] = 917,
    Stale = 734,
    ["Starlake Data Pipeline"] = 890,
    Starship = 735,
    ["Statamic Blueprint"] = 736,
    ["Stella configuration file"] = 737,
    ["Stryker Mutator"] = 740,
    ["StyleCop Analyzers Configuration"] = 741,
    ["Stylelint (.stylelintrc)"] = 742,
    ["Stylua Config"] = 1098,
    ["Sublime Syntax"] = 963,
    ["Subsquid squid manifest"] = 1010,
    ["Swagger API 2.0"] = 744,
    ["Synadia Connect Component"] = 745,
    TSON = 779,
    TSTyche = 780,
    ["TYPO3 Vendor Bundler config"] = 785,
    ["Tab data for a LinUtil"] = 1057,
    ["Tab list for a LinUtil"] = 1056,
    Tach = 746,
    ["Tach Domain"] = 747,
    Talhelper = 749,
    ["Talisman configuration"] = 750,
    Taplo = 1099,
    ["Taskfile config"] = 895,
    Taurus = 751,
    Tauticord = 752,
    Telefonistka = 1085,
    ["TestEnvironment.json"] = 762,
    ["TextMate Grammar"] = 761,
    ["Tier.run pricing.json"] = 755,
    Tikibase = 756,
    Tombi = 760,
    ["Traefik v2"] = 765,
    ["Traefik v2 File Provider"] = 766,
    ["Traefik v3"] = 767,
    ["Traefik v3 File Provider"] = 768,
    ["Travis CI (.travis.yml)"] = 764,
    Trident = 1081,
    ["TrueScript for *.tscript files"] = 771,
    ["Tugboat QA config.yml"] = 1078,
    TunnelHub = 998,
    Turborepo = 763,
    Tycho = 1046,
    Tye = 925,
    ["Tyk Gateway - Open Source v5.7+"] = 1090,
    ["Typst Manifest"] = 786,
    ["UET BuildConfig.json"] = 968,
    ["UI5 Manifest"] = 792,
    ["UNCORS configuration"] = 796,
    ["UTAM Page Object"] = 795,
    ["Ubuntu Server Autoinstall"] = 790,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1082,
    ["Uniswap Token List"] = 878,
    ["Universal Schedule Format"] = 797,
    ["Unreal Engine Uplugin"] = 969,
    ["Unreal Engine Uproject"] = 970,
    ["UpCloud CLI (upctl) configuration"] = 1083,
    ["Updatecli Compose"] = 933,
    ["Updatecli Policy Manifest"] = 934,
    ["Updatecli Policy Metadata"] = 935,
    Uplift = 966,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 899,
    V2Ray = 939,
    ["VSCode Code Snippets"] = 204,
    ["VSIX CLI publishing"] = 817,
    Vector = 799,
    ["Vela Pipeline Configuration"] = 802,
    Vercel = 203,
    ["Version Bumper config"] = 807,
    ["Viash Component Config"] = 1087,
    ["Viash Package Config"] = 1088,
    Visivo = 996,
    ["WP-CLI"] = 827,
    Wake = 1080,
    ["Waku Config"] = 1060,
    ["Web App Manifest"] = 823,
    ["Web types"] = 826,
    WebExtensions = 822,
    ["Webman package recipe"] = 945,
    ["Windows Package Manager Installer Manifest"] = 874,
    ["Windows Package Manager Locale Manifest"] = 875,
    ["Windows Package Manager Singleton Manifest"] = 873,
    Winutil = 876,
    ["WireMock stub mapping"] = 1063,
    ["Woodpecker pipeline config"] = 913,
    ["Wrangler CLI"] = 828,
    ["Xstate Machine"] = 931,
    ["Yandex Workflow Language"] = 1052,
    ["Yarn Config (.yarnrc.yml)"] = 888,
    ["Yippee-Ki-JSON configuration YML"] = 880,
    ["YouTrack App"] = 1049,
    ["Zerops.io config"] = 1037,
    ["Zerops.io import"] = 1038,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 1001,
    ...
    ["behat.yml"] = 106,
    ["bigquery-table"] = 95,
    ["bioimageio resource description"] = 1018,
    ...
    ["crowdin.yml"] = 238,
    ["ctfd-setup configuration file"] = 1070,
    ["custom-elements.json"] = 988,
    ["cypress.json"] = 242,
    ...
    ["gematik health care insurance list"] = 1076,
    ["gematik health care patient list"] = 1073,
    ["gematik health care provider institution list"] = 1075,
    ["gematik health care provider list"] = 1074,
    ["gematik tiger test environment configuration"] = 1077,
    ["gitlab-ci"] = 344,
    ["global.json"] = 360,
    ...
    ["lint-staged (.lintstagedrc)"] = 844,
    ["local.settings.json"] = 465,
    ["localazy.json"] = 466,
    ["lotus.yaml"] = 464,
    ["lsdlschema.json"] = 467,
    ["markdown-link-check"] = 908,
    maturin = 909,
    mboats = 916,
    ["micro-settings.json"] = 980,
    ["mimetypes.json"] = 479,
    ["mirrord config"] = 845,
    mise = 846,
    ["mkdocs.yml"] = 499,
    ["monospace.yml"] = 502,
    ["moon.yml"] = 1062,
    ["mprocs Configuration file"] = 1033,
    ["mrdocs.yml"] = 500,
    ["mta.yaml"] = 847,
    ["mtad.yaml"] = 848,
    ["mycode.json"] = 509,
    nFPM = 513,
    ["napari plugin manifest"] = 510,
    neoload = 860,
    ["nest-cli"] = 516,
    ["ninjs (News in JSON)"] = 515,
    ["nitro.json"] = 859,
    ["nixd configuration"] = 1006,
    ["nlu.json"] = 517,
    ["nodemon.json"] = 519,
    ["noodl config"] = 915,
    ["notebook.mod.json"] = 520,
    now = 855,
    ["npm-badges"] = 523,
    ["nswag.json"] = 527,
    ntangle = 529,
    ["nuclei-template.yaml"] = 524,
    ["nuget-project.json"] = 525,
    ["ocelot.json"] = 531,
    ["omnisharp.json"] = 535,
    ["openapi.json"] = 536,
    ["openfin.json"] = 543,
    ...
    ["ops.yaml"] = 540,
    ["package.json"] = 564,
    ["package.manifest"] = 565,
    ["partial-black.json"] = 107,
    ["pathfinder.yml"] = 568,
    ["pattern.json"] = 571,
    ["petstore-v1.0"] = 960,
    pgap_yaml_input_reader = 570,
    ["pixi.toml"] = 572,
    ["plagiarize-me.yaml"] = 576,
    ["plagiarize.yaml"] = 575,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1066,
    ["podbard.yaml"] = 578,
    ["portman.json"] = 579,
    ["prefect.toml"] = 587,
    ["prettierrc.json"] = 588,
    ["prisma.yml"] = 589,
    ["project-1.0.0-beta3.json"] = 598,
    ["project-1.0.0-beta4.json"] = 599,
    ["project-1.0.0-beta5.json"] = 600,
    ["project-1.0.0-beta6.json"] = 601,
    ["project-1.0.0-beta8.json"] = 602,
    ["project-1.0.0-rc1.json"] = 603,
    ["project-1.0.0-rc2.json"] = 604,
    ["project.json"] = 597,
    ["project.owasp.yaml"] = 605,
    ["prometheus.json"] = 606,
    ["prometheus.rules.json"] = 607,
    ["prometheus.rules.test.json"] = 608,
    ["proxies.json"] = 609,
    ["publiccode.yml"] = 610,
    ["pubspec.yaml"] = 611,
    ["pyrseas-0.8.json"] = 614,
    pytest = 623,
    ["quilt.mod.json"] = 981,
    ["rc3 auth"] = 628,
    ["rc3 collection"] = 629,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 861,
    ["release-please-config.json"] = 638,
    ["release-please-manifest.json"] = 639,
    ["release-plz.toml"] = 640,
    ["renv.lock"] = 650,
    ["rivet.json"] = 1005,
    ["rivet.yaml (legacy)"] = 1004,
    rockcraft = 652,
    runny = 654,
    rustfmt = 655,
    sake = 1093,
    samt = 657,
    samtrc = 658,
    ["sarif-1.0.0.json"] = 660,
    ["sarif-2.0.0.json"] = 661,
    ["sarif-2.1.0"] = 671,
    ["sarif-2.1.0-rtm.2"] = 662,
    ["sarif-2.1.0-rtm.3"] = 664,
    ["sarif-2.1.0-rtm.4"] = 666,
    ["sarif-2.1.0-rtm.5"] = 668,
    ["sarif-2.1.0-rtm.6"] = 669,
    ["sarif-external-property-file-2.1.0"] = 672,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 663,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 665,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 667,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 670,
    ["scalingo.json configuration"] = 673,
    ["schema.org - Action"] = 675,
    ["schema.org - ContactPoint"] = 676,
    ["schema.org - Place"] = 677,
    ["schema.org - Thing"] = 678,
    ["secrethub.yml"] = 983,
    ["semantic-release"] = 684,
    ["servicehub.config.json"] = 839,
    ["servicehub.service.json"] = 838,
    ["settings.job"] = 687,
    ["sfdx-hardis configuration"] = 689,
    ["shard.yml"] = 1021,
    ["size-limit configuration"] = 694,
    ["skaffold.yaml"] = 906,
    ["skyuxconfig.json"] = 696,
    snapcraft = 697,
    ["snowflake-config"] = 698,
    ["snowflake-connections"] = 699,
    ["spicepod.yaml"] = 1041,
    ["sqlc configuration"] = 730,
    ["stripe-app-local.json"] = 739,
    ["stripe-app.json"] = 738,
    swcrc = 891,
    ["task.json"] = 748,
    taskcat = 856,
    ["template.json"] = 753,
    ["templatsources.json"] = 754,
    ["theme.json"] = 757,
    ["tizen_workspace.json"] = 758,
    tldr = 759,
    ["tm_devices configuration file"] = 1104,
    tmuxinator = 842,
    ["transcend.yml"] = 769,
    ["tree-sitter grammar.json"] = 368,
    ["trime.yaml"] = 770,
    ["trunk.yaml"] = 772,
    ["ts-force-config.json"] = 777,
    ["tsconfig.json"] = 773,
    ["tsd.json"] = 774,
    ["tsdoc.json"] = 775,
    ["tsdrc.json"] = 776,
    ...
    ["vega-lite.json"] = 801,
    ["vega.json"] = 800,
    ["venvironment-basic.yaml"] = 804,
    ["venvironment.yaml"] = 803,
    ["venvplus-basic.yaml"] = 806,
    ["venvplus.yaml"] = 805,
    version = 1086,
    ["version.json"] = 808,
    ["vhwdebugger-binding.yaml"] = 810,
    ["vim-addon-info"] = 811,
    ["vs-2017.3.host.json"] = 813,
    ["vs-nesting.json"] = 814,
    ["vsls.json"] = 812,
    ["vss-extension.json"] = 818,
    vtcfg = 1092,
    ["vtesttree.yaml"] = 819,
    ["vtestunit.yaml"] = 820,
    ["warp-keysets.json"] = 989,
    ["warp-themes.json"] = 990,
    ["warp-workflows.json"] = 991,
    ["webhint.io"] = 946,
    ["webjobpublishsettings.json"] = 825,
    ["webjobs-list.json"] = 824,
    ["well-known-fursona"] = 1028,
    ["xs-app.json"] = 851,
    ["xunit.runner.json"] = 837,
    yamllint = 879,
    zuul = 862,
    ["Žinoma"] = 872
  },
