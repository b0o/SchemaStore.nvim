...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 213,
    [".cryproj (generic)"] = 691,
    [".cryproj engine-5.2"] = 686,
    [".cryproj engine-5.3"] = 687,
    [".cryproj engine-5.4"] = 688,
    [".cryproj engine-5.5"] = 689,
    [".cryproj engine-dev"] = 690,
    [".eslintrc"] = 270,
    [".esmrc.json"] = 261,
    [".ffizer.yaml"] = 274,
    [".htmlhintrc"] = 331,
    ...
    [".mtaext"] = 702,
    [".nodehawkrc"] = 444,
    [".npmpackagejsonlintrc"] = 448,
    [".omletrc"] = 877,
    [".phrase.yml"] = 495,
    [".phraseapp.yml"] = 496,
    [".pmbot.yml"] = 485,
    [".postcssrc"] = 490,
    [".powerpages-web-template-manifest"] = 492,
    [".pre-commit-config.yml"] = 493,
    [".pre-commit-hooks.yml"] = 494,
    [".putout.json"] = 515,
    [".rehyperc"] = 534,
    [".remarkrc"] = 536,
    [".sprite files"] = 594,
    ...
    ["<div>RIOTS' studio configuration"] = 669,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 399,
    ABCSupplyPlan = 13,
    AIConfig = 14,
    ["API Builder"] = 734,
    ["AVA Configuration"] = 794,
    ...
    ["Adobe UXP Manifest"] = 859,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 15,
    ["Airplane task"] = 16,
    ["Alacritty Configuration"] = 766,
    ["All Contributors configuration file"] = 824,
    ...
    ["Azure Pipelines"] = 69,
    ["Azure Static Web Apps CLI configuration file"] = 597,
    ["Azure Static Web Apps configuration file"] = 596,
    ["BX CI"] = 107,
    ["Bashly (bashly.yml)"] = 828,
    ["Bashly Settings (bashly-settings.yml)"] = 829,
    ["Better Code Hub"] = 738,
    ["Better Scripts"] = 108,
    Bigconfig = 86,
    BizTalkServerApplicationSchema = 708,
    Bleep = 109,
    ...
    ["Butane Config"] = 779,
    ["CGS Custom Card Game (CardGameDef.json)"] = 864,
    ["CICS TS region tagging"] = 788,
    ["CICS TS resource import"] = 789,
    ["CICS TS resource model"] = 790,
    ["CICS TS resource overrides"] = 791,
    ["CMake Presets"] = 110,
    ["CNC Codes"] = 124,
    ...
    CityJSON = 120,
    ["Clawject config"] = 129,
    ["Cloud Foundry Application Manifest"] = 876,
    ...
    ["Configu .cfgu files"] = 881,
    ["Configu .configu file"] = 882,
    Conjure = 123,
    ["Container Structure Test"] = 721,
    Containerlab = 746,
    ["Crowdsec collection config"] = 209,
    ["Crowdsec parser config"] = 210,
    ["Crowdsec scenario config"] = 211,
    ["CumulusCI Config"] = 128,
    ["Custom Machinery Machine"] = 865,
    ["Custom Machinery Recipe"] = 866,
    ...
    ["DataYoga Job"] = 133,
    ["Databricks Asset Bundles"] = 845,
    ["Datadog Service Definition"] = 375,
    ["Datahub Ingestion Recipe"] = 795,
    ["Dein Config"] = 135,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 836,
    ["EAS config"] = 268,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 825,
    ...
    ["Error pages"] = 264,
    Esquio = 262,
    ["Estuary Flow Catalog"] = 785,
    ["Expo SDK"] = 267,
    ["F-Droid Data metadata"] = 273,
    ["Facets - FSDL - Application"] = 271,
    ["FasterCI Configuration"] = 70,
    FiQuS = 277,
    Firebase = 275,
    ["Flow.json Configurations"] = 869,
    ["Fossa configuration file"] = 284,
    ["Fossa's fossa-deps file"] = 285,
    ["Foundry VTT - Base package Manifest"] = 279,
    ["Foundry VTT - Module Manifest"] = 280,
    ["Foundry VTT - System Data Template"] = 283,
    ["Foundry VTT - System Manifest"] = 281,
    ["Foundry VTT - World Manifest"] = 282,
    ["Foxx Manifest"] = 71,
    ["Freifunk.de Community API"] = 74,
    ["Frogbot Config"] = 75,
    ["G2P Mapping Configuration"] = 289,
    ["GCP Blueprint Metadata"] = 292,
    Gaspar = 290,
    ["GatewayCore API Gateway"] = 291,
    ["GeoJSON.json latest"] = 783,
    GherKing = 787,
    ["GitHub Action"] = 297,
    ["GitHub Discussion"] = 298,
    ["GitHub Funding"] = 299,
    ["GitHub Issue Template configuration"] = 301,
    ["GitHub Issue Template forms"] = 300,
    ["GitHub Workflow"] = 302,
    ["GitHub Workflow Template Properties"] = 303,
    ["GitHub automatically generated release notes configuration"] = 304,
    ["GitLab Agent for Kubernetes configuration"] = 861,
    GitVersion = 294,
    ["Gitea Issue Template configuration"] = 295,
    ["Gitea Issue Template forms"] = 296,
    ["Gitpod Configuration"] = 306,
    ["GlazeWM settings"] = 863,
    ["Global Privacy Control"] = 293,
    Goblet = 844,
    ["Golangci-lint Configuration"] = 308,
    ["Golangci-lint Custom Plugins Configuration"] = 309,
    ["Google Chrome Related Website Sets"] = 276,
    ["Google Cloud Workflows"] = 187,
    Goreleaser = 311,
    ["Goreleaser Pro"] = 312,
    Goss = 313,
    ["Gradle Build Cache Node"] = 736,
    ["Gradle Enterprise"] = 735,
    ["Grafana 5.x Dashboard"] = 314,
    ["GraphQL Code Generator"] = 318,
    ["GraphQL Config"] = 317,
    ["GraphQL Mesh"] = 316,
    ["Grunt JSHint task"] = 322,
    ["Grunt Watch task"] = 323,
    ["Grunt base task"] = 324,
    ["Grunt clean task"] = 320,
    ["Grunt copy task"] = 319,
    ["Grunt cssmin task"] = 321,
    HEMTT = 705,
    Hadolint = 717,
    Hammerkit = 745,
    ["Hardware Sentry Configuration"] = 799,
    Hatch = 718,
    Hayson = 326,
    ["Haystack Pipeline"] = 327,
    ["Hazelcast 5 Configuration"] = 328,
    ["Helm Chart.lock"] = 155,
    ["Helm Chart.yaml"] = 154,
    ["Helm Unittest Test Suite"] = 156,
    Hugo = 775,
    ["Hugo Theme"] = 774,
    ["Hyperfoil benchmark configuration"] = 334,
    ["IBM Zapp document"] = 335,
    ["IBM zCodeFormatSettings"] = 336,
    ["IMG Catapult PSP"] = 341,
    ["IVMS101 by CODE Protocol"] = 862,
    Infrahub = 343,
    Istanbul = 802,
    ["JDownloader2 crawler multi-rules"] = 352,
    ["JDownloader2 crawler single-rules"] = 351,
    ["JFrog Applications Config"] = 353,
    ["JFrog File Spec"] = 354,
    ["JFrog Pipelines YML DSL"] = 808,
    ["JMeter DSL cli config"] = 355,
    JReleaser = 357,
    ["JSON Document Transform"] = 365,
    ["JSON Feed"] = 366,
    ["JSON Resume"] = 541,
    ["JSON Schema Draft 2020-12"] = 682,
    ["JSON Schema Draft 4"] = 679,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 846,
    ["JSON Schema Draft 7"] = 680,
    ["JSON Schema Draft 7 (unofficial strict)"] = 847,
    ["JSON Schema Draft 8 (2019-09)"] = 681,
    ["JSON-API"] = 364,
    ["JSON-WF"] = 875,
    ["JSON-e templates"] = 743,
    ["JSON-stat 2.0"] = 676,
    JSONPatch = 368,
    ["JSR Package Config (jsr.json)"] = 358,
    Jasmine = 347,
    Jekyll = 348,
    ["Jenkins X Pipelines"] = 349,
    ["Jenkins X Requirements"] = 350,
    ["Jovo Language Models"] = 356,
    ["KIMMDY config file"] = 373,
    ["KSP-AVC"] = 677,
    ["KSP-CKAN"] = 678,
    KSY = 874,
    ["Karakum configuration file"] = 286,
    Kas = 371,
    ["Keycloak REST API"] = 816,
    ["Knative Functions - func.yaml"] = 287,
    ["KoDE/CI build.yaml"] = 804,
    ["Kong DBLess config"] = 805,
    KrakenD = 374,
    ["Kubri Configuration"] = 379,
    LOOBin = 394,
    ...
    Lefthook = 383,
    ["Liferay client-extension.yaml"] = 390,
    ["LinkML Metamodel"] = 392,
    Liquibase = 751,
    ["Liquibase Flow File"] = 752,
    ["Lively Properties"] = 393,
    ["Lobe AI Agent"] = 67,
    Loki = 68,
    ["MLOS Configs"] = 428,
    ["MS2Rescore Configuration"] = 431,
    ["Madness (madness.yml)"] = 827,
    Markdownlint = 755,
    ["Mason Registry"] = 757,
    ["MegaLinter configuration"] = 400,
    ["MegaLinter descriptor"] = 401,
    Melange = 853,
    ["Meltano plugin discovery definition"] = 403,
    ["Meltano project definition"] = 402,
    ["Mergify Configuration"] = 432,
    ["MetricsHub Configuration"] = 404,
    ["MetricsHub Connector Configuration"] = 405,
    ["Micro Editor Syntax"] = 837,
    ["Microsoft Band Web Tile"] = 406,
    ["Minecraft Custom Main Menu Mod"] = 854,
    ["Minecraft Data Pack Advancement"] = 408,
    ["Minecraft Data Pack Biome"] = 409,
    ["Minecraft Data Pack Configured Carver"] = 410,
    ["Minecraft Data Pack Damage Type"] = 411,
    ["Minecraft Data Pack Dimension"] = 413,
    ["Minecraft Data Pack Dimension Type"] = 412,
    ["Minecraft Data Pack Item Modifier"] = 414,
    ["Minecraft Data Pack Loot Table"] = 415,
    ["Minecraft Data Pack Metadata"] = 416,
    ["Minecraft Data Pack Predicate"] = 417,
    ["Minecraft Data Pack Recipe"] = 418,
    ["Minecraft Data Pack Tag"] = 419,
    ["Minecraft Data Pack Template Pool"] = 420,
    ["Minecraft Data Pack Trim Material"] = 425,
    ["Minecraft Data Pack Trim Pattern"] = 426,
    ["Minecraft Resource Pack Lang"] = 421,
    ["Minecraft Resource Pack Particle"] = 422,
    ["Minecraft Resource Pack Texture Mcmeta"] = 424,
    ["Minecraft Resourcepack Sounds"] = 423,
    ["Monade CLI Stack Configuration"] = 435,
    ["MongoDB Atlas Search Index Definition"] = 803,
    ["Monika Configuration"] = 801,
    ["Monoweave Configuration"] = 430,
    ["Motif config"] = 701,
    ["NOX Framework (Service)"] = 447,
    ["Netin Diagnostic System Template"] = 761,
    ["Netlify config"] = 438,
    ["Network-as-Code Data Model"] = 439,
    ["Nightwatch.js"] = 440,
    ["Nuitka.yaml"] = 867,
    ["ONe's changelog entry"] = 463,
    ["ONe's service descriptor"] = 462,
    ["OSS Review Toolkit configuration"] = 471,
    ["OSS Review Toolkit curation"] = 472,
    ["OSS Review Toolkit package configuration"] = 473,
    ["OSS Review Toolkit repository configuration"] = 474,
    ["OSS Review Toolkit resolutions"] = 475,
    Opctl = 704,
    ["Open Data Contract Standard (ODCS))"] = 466,
    ["OpenRewrite Resource"] = 465,
    ["OpenUtau character yaml"] = 459,
    ["OpenUtau ustx"] = 460,
    ["OpenWeather Current Weather API"] = 742,
    ["OpenWeather Road Risk API"] = 741,
    ["Ory Hydra configuration"] = 333,
    ["Ory Keto configuration"] = 376,
    ["Ory Kratos configuration"] = 470,
    ["Ory Oathkeeper configuration"] = 454,
    ["Outblocks App configuration"] = 468,
    ["Outblocks database table"] = 469,
    ["Outblocks project configuration"] = 467,
    PDM = 481,
    Packer = 478,
    Pantsbuild = 823,
    ["Paper paper-plugin.yml"] = 479,
    ["Pipeline component"] = 753,
    ["PocketMine plugin.yml"] = 486,
    ["Postman collection"] = 491,
    ["Problem object RFC9457"] = 851,
    ["Problem package generators"] = 499,
    Pterodactyl = 798,
    ["Pull Request Labeler"] = 514,
    Pulumi = 520,
    PyProject = 521,
    Pyright = 522,
    Qgoda = 523,
    Qodana = 771,
    ["Qt Creator workspace file"] = 883,
    ["Quali Torque Blueprint Spec 2"] = 796,
    ["QueryFirst config file"] = 819,
    ["RKE Cluster Configuration JSON"] = 750,
    ["RKE Cluster Configuration YAML"] = 749,
    ["Rancher Fleet"] = 517,
    ["Rattler-build"] = 524,
    Ray = 716,
    ["Read the Docs"] = 519,
    ["Red-DiscordBot Cog"] = 531,
    ["Red-DiscordBot Cog Repo"] = 532,
    ["Red-DiscordBot Trivia"] = 533,
    ["Render Blueprints"] = 748,
    RenderCV = 543,
    Renovate = 542,
    ["Replit config"] = 537,
    RoadRunner = 544,
    ["Rudder techniques"] = 857,
    Ruff = 539,
    ["Rust Project"] = 540,
    ["Rust toolchain"] = 547,
    ["SDMX data message"] = 572,
    ["SDMX metadata message"] = 571,
    ["SDMX structure message"] = 570,
    ["SIL Kit Participant Configuration"] = 582,
    ["SIL Kit Registry Configuration"] = 583,
    SWADL = 608,
    ["Safebox Config"] = 809,
    ["Sapphire CLI Config"] = 550,
    ["SauceCTL Configuration"] = 758,
    ["Schema Catalog"] = 564,
    ["Scoop manifest"] = 569,
    ["Semantic Data Fabric (SDF) file"] = 573,
    ["Semgrep Rule"] = 575,
    ["Serenity Code Generator (Sergen)"] = 576,
    ["Serverless Framework Configuration"] = 765,
    ["Serverless Workflow"] = 767,
    ["Settings.paf"] = 578,
    ["Shopware 6 Configuration"] = 768,
    ["Shopware CLI Extension Store Configuration"] = 769,
    ["Shopware CLI Project Store Configuration"] = 770,
    Sigma = 580,
    ["Sigrid scope configuration file"] = 581,
    ["SkyPilot Task JSON"] = 858,
    ["Slack app manifest"] = 585,
    Solidarity = 588,
    ["Solution filters"] = 589,
    ["Source Maps v3"] = 590,
    Sourcery = 591,
    SpecIF = 592,
    ["Sponge Mixin configuration"] = 593,
    StackBlitz = 598,
    ["StackHawk Scanner Configuration"] = 764,
    Stale = 599,
    ["Starlake Data Pipeline"] = 739,
    Starship = 600,
    ["Statamic Blueprint"] = 601,
    ["Stella configuration file"] = 602,
    ["StrmPrivacy Data Connector"] = 813,
    ["StrmPrivacy Data Contract"] = 814,
    ["StrmPrivacy SimpleSchema"] = 811,
    ["StrmPrivacy Stream"] = 812,
    ["StrmPrivacy batch job configuration file"] = 810,
    ["Stryker Mutator"] = 605,
    ["StyleCop Analyzers Configuration"] = 606,
    ["Stylelint (.stylelintrc)"] = 607,
    ["Sublime Syntax"] = 815,
    ["Subsquid squid manifest"] = 860,
    ["Swagger API 2.0"] = 609,
    TSON = 635,
    TSTyche = 636,
    Talhelper = 611,
    ["Talisman configuration"] = 612,
    ["Taskfile config"] = 744,
    Taurus = 613,
    ["TestEnvironment.json"] = 622,
    ["TextMate Grammar"] = 621,
    ["Tier.run pricing.json"] = 616,
    Tikibase = 617,
    ["Traefik v2"] = 625,
    ["Traefik v2 File Provider"] = 626,
    ["Travis CI (.travis.yml)"] = 624,
    TunnelHub = 850,
    Turborepo = 623,
    Tye = 772,
    ["UET BuildConfig.json"] = 820,
    ["UI5 Manifest"] = 645,
    ["UNCORS configuration"] = 649,
    ["UTAM Page Object"] = 648,
    ["Ubuntu Server Autoinstall"] = 643,
    ["Uniswap Token List"] = 727,
    ["Unreal Engine Uplugin"] = 821,
    ["Unreal Engine Uproject"] = 822,
    ["Updatecli Compose"] = 780,
    ["Updatecli Policy Manifest"] = 781,
    ["Updatecli Policy Metadata"] = 782,
    Uplift = 818,
    ["User Journey Map"] = 747,
    V2Ray = 786,
    ["VSCode Code Snippets"] = 175,
    ["VSIX CLI publishing"] = 664,
    ["Vela Pipeline Configuration"] = 653,
    Vercel = 174,
    Visivo = 848,
    ["Web App Manifest"] = 671,
    ["Web types"] = 674,
    WebExtensions = 670,
    ["Webman package recipe"] = 792,
    ["Windows Package Manager Installer Manifest"] = 724,
    ["Windows Package Manager Locale Manifest"] = 725,
    ["Windows Package Manager Singleton Manifest"] = 723,
    ["Woodpecker pipeline config"] = 760,
    ["Wrangler CLI"] = 675,
    ["Xstate Machine"] = 778,
    ["Yarn Config (.yarnrc.yml)"] = 737,
    ["Yippee-Ki-JSON configuration YML"] = 729,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 852,
    ...
    ["babelrc.json"] = 77,
    ["bamboo-spec"] = 80,
    ["bashly-strings.yml"] = 830,
    ["batect.yml"] = 79,
    ["beef-database-codegen"] = 81,
    ["beef-database-v5-codegen"] = 83,
    ["beef-entity-codegen"] = 82,
    ["beef-entity-v5-codegen"] = 84,
    ["behat.yml"] = 93,
    ["bigquery-table"] = 85,
    ["bioimageio resource description"] = 868,
    ["bitbucket-pipelines"] = 87,
    bitrise = 88,
    ["bitrise-step"] = 89,
    ["block.json"] = 105,
    ...
    ["ezd task runner"] = 269,
    ["fabric.mod.json"] = 272,
    ["first-timers-bot"] = 278,
    ["flagd flag configuration"] = 72,
    ["fly.io Configuration"] = 73,
    fulibWorkflows = 759,
    ["function.json"] = 288,
    ["gRPC API Gateway & OpenAPI Config"] = 3,
    ["gitlab-ci"] = 305,
    ["global.json"] = 307,
    ["go-feature-flag Flag Configuration"] = 310,
    ["haxelib.json"] = 325,
    helmfile = 719,
    helmwave = 720,
    ["host-meta.json"] = 330,
    ...
    ["ide.host.json"] = 337,
    ["ifstate.conf"] = 338,
    ["imageoptimizer.json"] = 339,
    ["importmap.json"] = 342,
    ["ioBroker Configuration"] = 344,
    ["ioBroker JSON UI"] = 345,
    ["ioBroker Package manifest"] = 346,
    ["ize.toml"] = 817,
    ["jsconfig.json"] = 369,
    ["jscpd Configuration"] = 797,
    jsdoc = 715,
    ["k3d.yaml"] = 370,
    ["k9s plugin.yml"] = 372,
    ["kontinuous-config.yaml"] = 378,
    ["kontinuous-values.yaml"] = 377,
    ["kustomization.yaml"] = 380,
    ["label-commenter-config.yml"] = 381,
    ["latexindent configuration"] = 66,
    ["launchsettings.json"] = 382,
    lazydocker = 839,
    lazygit = 838,
    ["lego.json"] = 384,
    ["lerna.json"] = 385,
    ["lgtm.yml"] = 386,
    ["liblab.config.json"] = 387,
    ["libman.json"] = 388,
    ["license-report-config.json"] = 389,
    ["linkinator.config.json"] = 391,
    ["lint-staged (.lintstagedrc)"] = 695,
    ["local.settings.json"] = 396,
    ["localazy.json"] = 397,
    ["lotus.yaml"] = 395,
    ["lsdlschema.json"] = 398,
    ["markdown-link-check"] = 756,
    mboats = 763,
    ["micro-settings.json"] = 832,
    ["mimetypes.json"] = 407,
    ["mirrord config"] = 696,
    mise = 697,
    ["mise-settings"] = 698,
    ["mkdocs.yml"] = 427,
    ["monospace.yml"] = 429,
    ["mprocs Configuration file"] = 884,
    ["mta.yaml"] = 699,
    ["mtad.yaml"] = 700,
    ["mycode.json"] = 436,
    ["napari plugin manifest"] = 437,
    neoload = 710,
    ["nest-cli"] = 442,
    ["ninjs (News in JSON)"] = 441,
    ["nixd configuration"] = 856,
    ["nlu.json"] = 443,
    ["nodemon.json"] = 445,
    ["noodl config"] = 762,
    ["notebook.mod.json"] = 446,
    now = 706,
    ["npm-badges"] = 449,
    ["nswag.json"] = 452,
    ntangle = 453,
    ["nuclei-template.yaml"] = 450,
    ["nuget-project.json"] = 451,
    ["ocelot.json"] = 455,
    ["omnisharp.json"] = 456,
    ["openapi.json"] = 457,
    ["openfin.json"] = 464,
    ...
    ["ops.yaml"] = 461,
    ["package.json"] = 476,
    ["package.manifest"] = 477,
    ["partial-black.json"] = 94,
    ["pathfinder.yml"] = 480,
    ["pattern.json"] = 483,
    ["petstore-v1.0"] = 807,
    pgap_yaml_input_reader = 482,
    ["pixi.toml"] = 484,
    ["plagiarize-me.yaml"] = 488,
    ["plagiarize.yaml"] = 487,
    ["portman.json"] = 489,
    ["prettierrc.json"] = 497,
    ["prisma.yml"] = 498,
    ["project-1.0.0-beta3.json"] = 501,
    ["project-1.0.0-beta4.json"] = 502,
    ["project-1.0.0-beta5.json"] = 503,
    ["project-1.0.0-beta6.json"] = 504,
    ["project-1.0.0-beta8.json"] = 505,
    ["project-1.0.0-rc1.json"] = 506,
    ["project-1.0.0-rc2.json"] = 507,
    ["project.json"] = 500,
    ["prometheus.json"] = 508,
    ["prometheus.rules.json"] = 509,
    ["prometheus.rules.test.json"] = 510,
    ["proxies.json"] = 511,
    ["publiccode.yml"] = 512,
    ["pubspec.yaml"] = 513,
    ["pyrseas-0.8.json"] = 516,
    ["quilt.mod.json"] = 833,
    ["rc3 auth"] = 525,
    ["rc3 collection"] = 526,
    ["rc3 environment"] = 527,
    ...
    ["rc3 settings"] = 530,
    ["release drafter"] = 711,
    ["release-plz.toml"] = 535,
    ["rivet.yaml"] = 855,
    rockcraft = 545,
    rustfmt = 546,
    samt = 548,
    samtrc = 549,
    ["sarif-1.0.0.json"] = 551,
    ["sarif-2.0.0.json"] = 552,
    ["sarif-2.1.0"] = 562,
    ["sarif-2.1.0-rtm.2"] = 553,
    ["sarif-2.1.0-rtm.3"] = 555,
    ["sarif-2.1.0-rtm.4"] = 557,
    ["sarif-2.1.0-rtm.5"] = 559,
    ["sarif-2.1.0-rtm.6"] = 560,
    ["sarif-external-property-file-2.1.0"] = 563,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 554,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 556,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 558,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 561,
    ["schema.org - Action"] = 565,
    ["schema.org - ContactPoint"] = 566,
    ["schema.org - Place"] = 567,
    ["schema.org - Thing"] = 568,
    ["secrethub.yml"] = 835,
    ["semantic-release"] = 574,
    ["servicehub.config.json"] = 685,
    ["servicehub.service.json"] = 684,
    ["settings.job"] = 577,
    ["sfdx-hardis configuration"] = 579,
    ["shard.yml"] = 871,
    ["size-limit configuration"] = 584,
    ["skaffold.yaml"] = 754,
    ["skyuxconfig.json"] = 586,
    snapcraft = 587,
    ["sqlc configuration"] = 595,
    ["stripe-app-local.json"] = 604,
    ["stripe-app.json"] = 603,
    swcrc = 740,
    ["task.json"] = 610,
    taskcat = 707,
    ["template.json"] = 614,
    ["templatsources.json"] = 615,
    ["theme.json"] = 618,
    ["tizen_workspace.json"] = 619,
    tldr = 620,
    tmuxinator = 693,
    ["transcend.yml"] = 627,
    ["tree-sitter grammar.json"] = 315,
    ["trime.yaml"] = 628,
    ["trunk.yaml"] = 629,
    ["ts-force-config.json"] = 633,
    ["tsconfig.json"] = 630,
    ["tsd.json"] = 631,
    ["tsdrc.json"] = 632,
    ["tslint.json"] = 634,
    ...
    ["vega-lite.json"] = 652,
    ["vega.json"] = 651,
    ["venvironment-basic.yaml"] = 655,
    ["venvironment.yaml"] = 654,
    ["version.json"] = 656,
    ["vim-addon-info"] = 658,
    ["vs-2017.3.host.json"] = 660,
    ["vs-nesting.json"] = 661,
    ["vsls.json"] = 659,
    ["vss-extension.json"] = 665,
    ["vtesttree.yaml"] = 666,
    ["vtestunit.yaml"] = 667,
    ["warp-keysets.json"] = 841,
    ["warp-themes.json"] = 842,
    ["warp-workflows.json"] = 843,
    ["webhint.io"] = 793,
    ["webjobpublishsettings.json"] = 673,
    ["webjobs-list.json"] = 672,
    ["well-known-fursona"] = 879,
    ["xs-app.json"] = 703,
    ["xunit.runner.json"] = 683,
    yamllint = 728,
    zuul = 712,
    ["Žinoma"] = 722
  },
