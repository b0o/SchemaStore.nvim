...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 175,
    [".cryproj (generic)"] = 598,
    [".cryproj engine-5.2"] = 593,
    [".cryproj engine-5.3"] = 594,
    [".cryproj engine-5.4"] = 595,
    [".cryproj engine-5.5"] = 596,
    [".cryproj engine-dev"] = 597,
    [".csscomb.json"] = 177,
    [".csslintrc"] = 178,
    [".es6importsorterrc.json"] = 725,
    [".eslintrc"] = 227,
    [".esmrc.json"] = 219,
    [".ffizer.yaml"] = 231,
    [".htmlhintrc"] = 282,
    ...
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 670,
    ["All Contributors configuration file"] = 724,
    ...
    ["Better Scripts"] = 96,
    Bigconfig = 76,
    BizTalkServerApplicationSchema = 613,
    Bleep = 97,
    ...
    ["Butane Config"] = 682,
    ["CICS TS region tagging"] = 689,
    ["CICS TS resource import"] = 690,
    ["CICS TS resource model"] = 691,
    ["CICS TS resource overrides"] = 692,
    ["CMake Presets"] = 98,
    ["CNC Codes"] = 108,
    ...
    ["Databricks Asset Bundles"] = 745,
    ["Datadog Service Definition"] = 321,
    ["Datahub Ingestion Recipe"] = 696,
    ["Dein Config"] = 113,
    Deno = 188,
    ["Deployer Recipe"] = 191,
    ["Deta Spacefile"] = 114,
    ...
    ["Goreleaser Pro"] = 264,
    Goss = 265,
    ["Gradle Build Cache Node"] = 640,
    ["Gradle Enterprise"] = 639,
    ...
    Hadolint = 622,
    Hammerkit = 649,
    ["Hardware Sentry Configuration"] = 700,
    Hayson = 277,
    ...
    ["JFrog File Spec"] = 302,
    ["JFrog Pipelines YML DSL"] = 709,
    ["JMeter DSL cli config"] = 303,
    JReleaser = 305,
    ["JSON Document Transform"] = 312,
    ["JSON Feed"] = 313,
    ["JSON Resume"] = 464,
    ["JSON Schema Draft 2020-12"] = 589,
    ["JSON Schema Draft 4"] = 586,
    ["JSON Schema Draft 7"] = 587,
    ["JSON Schema Draft 7 (unofficial strict)"] = 746,
    ["JSON Schema Draft 8 (2019-09)"] = 588,
    ["JSON-API"] = 311,
    ["JSON-e templates"] = 647,
    ["JSON-stat 2.0"] = 583,
    JSONPatch = 315,
    Jasmine = 295,
    Jekyll = 296,
    ...
    Kas = 318,
    ["Keycloak REST API"] = 716,
    ["Knative Functions - func.yaml"] = 242,
    ["KoDE/CI build.yaml"] = 705,
    ["Kong DBLess config"] = 706,
    KrakenD = 320,
    LOOBin = 337,
    Lefthook = 328,
    ["LinkML Metamodel"] = 335,
    Liquibase = 654,
    ["Liquibase Flow File"] = 655,
    ...
    ["MongoDB Atlas Search Index Definition"] = 704,
    ["Monika Configuration"] = 702,
    ["Motif config"] = 606,
    ["NOX Framework (Service)"] = 383,
    ["Netin Diagnostic System Template"] = 664,
    ["Netlify config"] = 374,
    ...
    ["OpenWeather Current Weather API"] = 646,
    ["OpenWeather Road Risk API"] = 645,
    ...
    Qgoda = 453,
    Qodana = 675,
    ["Quali Torque Blueprint Spec 2"] = 697,
    ["QueryFirst config file"] = 719,
    ["RKE Cluster Configuration JSON"] = 653,
    ["RKE Cluster Configuration YAML"] = 652,
    ["Rancher Fleet"] = 447,
    Ray = 621,
    ["Read the Docs"] = 449,
    ...
    ["SauceCTL Configuration"] = 661,
    ["Schema Catalog"] = 485,
    ["Scoop manifest"] = 490,
    ["Semantic Data Fabric (SDF) file"] = 491,
    ["Semgrep Rule"] = 493,
    ["Serenity Code Generator (Sergen)"] = 494,
    ["Serverless Framework Configuration"] = 669,
    ["Serverless Workflow"] = 671,
    ["Settings.paf"] = 496,
    ["Shopware 6 Configuration"] = 672,
    ["Shopware CLI Extension Store Configuration"] = 673,
    ["Shopware CLI Project Store Configuration"] = 674,
    ...
    ["StackHawk Scanner Configuration"] = 668,
    Stale = 515,
    ["Starlake Data Pipeline"] = 643,
    Starship = 516,
    ["Statamic Blueprint"] = 517,
    ["StrmPrivacy Data Connector"] = 714,
    ["StrmPrivacy Data Contract"] = 715,
    ["StrmPrivacy SimpleSchema"] = 712,
    ["StrmPrivacy Stream"] = 713,
    ["StrmPrivacy batch job configuration file"] = 711,
    ["Stryker Mutator"] = 520,
    ...
    Turborepo = 537,
    Tye = 676,
    ["UET BuildConfig.json"] = 720,
    ["UI5 Manifest"] = 556,
    ["UTAM Page Object"] = 559,
    ["Ubuntu Server Autoinstall"] = 554,
    ["Uniswap Token List"] = 631,
    ["Unreal Engine Uplugin"] = 721,
    ["Unreal Engine Uproject"] = 722,
    Updatecli = 683,
    Uplift = 718,
    ["User Journey Map"] = 651,
    V2Ray = 687,
    ["VSCode Code Snippets"] = 146,
    ["VSIX CLI publishing"] = 572,
    ["Vela Pipeline Configuration"] = 562,
    Vercel = 145,
    Visivo = 747,
    ["Web App Manifest"] = 579,
    ["Web types"] = 582,
    WebExtensions = 578,
    ["Webman package recipe"] = 693,
    ["Windows Package Manager Installer Manifest"] = 628,
    ["Windows Package Manager Locale Manifest"] = 629,
    ["Windows Package Manager Singleton Manifest"] = 627,
    ["Woodpecker pipeline config"] = 663,
    ["Xstate Machine"] = 681,
    ["Yippee-Ki-JSON configuration YML"] = 633,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    ...
    ["bamboo-spec"] = 70,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 729,
    ["bashly-strings.yml"] = 730,
    ["bashly.yml"] = 728,
    ["batect.yml"] = 69,
    ...
    ["lsdlschema.json"] = 341,
    ["madness.yml"] = 727,
    ["markdown-lint-check"] = 659,
    mboats = 666,
    ["micro-settings.json"] = 732,
    ["mimetypes.json"] = 348,
    ["mirrord config"] = 603,
    ["mta.yaml"] = 604,
    ["mtad.yaml"] = 605,
    ...
    ["servicehub.config.json"] = 592,
    ["servicehub.service.json"] = 591,
    ["settings.job"] = 495,
    ...
    ["vega-lite.json"] = 561,
    ["vega.json"] = 560,
    ["venvironment-basic.yaml"] = 564,
    ["venvironment.yaml"] = 563,
    ["version.json"] = 565,
    ["vim-addon-info"] = 566,
    ["vs-2017.3.host.json"] = 568,
    ["vs-nesting.json"] = 569,
    ["vsls.json"] = 567,
    ["vss-extension.json"] = 573,
    ["vtesttree.yaml"] = 574,
    ["vtestunit.yaml"] = 575,
    ["warp-keysets.json"] = 741,
    ["warp-themes.json"] = 742,
    ["warp-workflows.json"] = 743,
    ["webhint.io"] = 694,
    ["webjobpublishsettings.json"] = 581,
    ["webjobs-list.json"] = 580,
    ["xs-app.json"] = 608,
    ["xunit.runner.json"] = 590,
    yamllint = 632,
    zuul = 617,
    ["Žinoma"] = 626
  },
