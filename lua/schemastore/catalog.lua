...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 153,
    [".cryproj (generic)"] = 510,
    [".cryproj engine-5.2"] = 505,
    [".cryproj engine-5.3"] = 506,
    [".cryproj engine-5.4"] = 507,
    [".cryproj engine-5.5"] = 508,
    [".cryproj engine-dev"] = 509,
    [".csscomb.json"] = 155,
    [".csslintrc"] = 156,
    [".eslintrc"] = 201,
    [".esmrc.json"] = 193,
    ...
    ["Azure Pipelines"] = 48,
    ["Azure Static Web Apps CLI configuration file"] = 432,
    ["Azure Static Web Apps configuration file"] = 431,
    ["BX CI"] = 83,
    ["Better Code Hub"] = 553,
    ["Better Scripts"] = 84,
    BizTalkServerApplicationSchema = 525,
    ...
    ["Butane Config"] = 591,
    ["CICS TS region tagging"] = 598,
    ["CICS TS resource import"] = 599,
    ["CICS TS resource model"] = 600,
    ["CICS TS resource overrides"] = 601,
    ["CMake Presets"] = 85,
    ...
    ["Datahub Ingestion Recipe Schema"] = 605,
    ...
    ["Embrace Config Schema"] = 616,
    ["Error pages"] = 196,
    Esquio = 194,
    ["Estuary Flow Catalog Schema"] = 595,
    ["Expo SDK"] = 199,
    ...
    Goreleaser = 227,
    ["Goreleaser Pro"] = 228,
    ["Gradle Build Cache Node"] = 550,
    ["Gradle Enterprise"] = 549,
    ...
    Hadolint = 534,
    Hammerkit = 560,
    ["Hardware Sentry Configuration"] = 609,
    Hayson = 240,
    ...
    ["JFrog File Spec"] = 260,
    ["JFrog Pipelines YML DSL"] = 618,
    ["JSON Document Transform"] = 268,
    ["JSON Feed"] = 269,
    ["JSON Resume"] = 392,
    ["JSON Schema Draft 2020-12"] = 501,
    ["JSON Schema Draft 4"] = 498,
    ["JSON Schema Draft 7"] = 499,
    ["JSON Schema Draft 8"] = 500,
    ...
    ["KSP-AVC"] = 496,
    ["KSP-CKAN"] = 497,
    ["Keycloak REST API"] = 624,
    ["Knative Functions - func.yaml"] = 211,
    ["KoDE/CI build.yaml"] = 614,
    ["Kong DBLess Schema"] = 615,
    KrakenD = 274,
    ["LinkML Metamodel"] = 287,
    Liquibase = 565,
    ["Liquibase Flow File"] = 566,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 613,
    ["Monika Configuration Schema"] = 611,
    ["Motif config"] = 518,
    ["NOX Framework (Service)"] = 325,
    ["Netin Diagnostic System Template"] = 574,
    ...
    ["OpenWeather Current Weather API"] = 557,
    ["OpenWeather Road Risk API"] = 556,
    ...
    PyProject = 383,
    Qodana = 584,
    ["Quali Torque Blueprint Spec 2"] = 606,
    ["QueryFirst config file"] = 627,
    ["RKE Cluster Configuration JSON Schema"] = 564,
    ["RKE Cluster Configuration YAML Schema"] = 563,
    ["Rancher Fleet"] = 380,
    Ray = 533,
    ["Read the Docs"] = 381,
    ...
    ["SauceCTL Configuration"] = 571,
    ["Schema Catalog"] = 410,
    ["Scoop manifest"] = 415,
    ["Semgrep Rule"] = 417,
    ["Serverless Framework Configuration"] = 578,
    ["Serverless Workflow Schema"] = 580,
    ["Settings.paf"] = 419,
    ["Shopware 6 Configuration"] = 581,
    ["Shopware CLI Extension Store Configuration"] = 582,
    ["Shopware CLI Project Store Configuration"] = 583,
    Solidarity = 425,
    ["Solution filters"] = 426,
    ["Source Maps v3"] = 427,
    SpecIF = 428,
    ["Sponge Mixin configuration"] = 429,
    ["StackHawk Scanner Configuration"] = 577,
    Stale = 433,
    Starship = 434,
    ["Statamic Blueprint"] = 435,
    ["StrmPrivacy Data Connector"] = 622,
    ["StrmPrivacy Data Contract"] = 623,
    ["StrmPrivacy SimpleSchema"] = 620,
    ["StrmPrivacy Stream"] = 621,
    ["StrmPrivacy batch job configuration file"] = 619,
    ["Stryker Mutator"] = 438,
    ["StyleCop Analyzers Configuration"] = 439,
    ["Swagger API 2.0"] = 442,
    TSON = 463,
    ["Talisman configuration"] = 443,
    ["Taskfile YAML Schema"] = 559,
    Taurus = 444,
    ["TestEnvironment.json"] = 452,
    ["Tier.run pricing.json"] = 447,
    Tikibase = 448,
    ["Traefik v2"] = 455,
    ["Traefik v2 File Provider"] = 456,
    Turborepo = 453,
    Tye = 585,
    ["UI5 Manifest"] = 470,
    ["UTAM Page Object"] = 473,
    ["Ubuntu Server Autoinstall"] = 468,
    ["Uniswap Token List"] = 542,
    ["Unreal Engine Uplugin"] = 628,
    ["Unreal Engine Uproject"] = 629,
    Updatecli = 592,
    Uplift = 626,
    ["User Journey Map YAML Schema"] = 562,
    V2Ray = 596,
    ["VSCode Code Snippets"] = 129,
    ["VSIX CLI publishing"] = 486,
    ["Vela Pipeline Configuration"] = 476,
    Vercel = 128,
    ["Web App Manifest"] = 491,
    ["Web types"] = 494,
    WebExtensions = 490,
    ["Webman package recipe"] = 602,
    ["Windows Package Manager Installer Manifest"] = 539,
    ["Windows Package Manager Locale Manifest"] = 540,
    ["Windows Package Manager Singleton Manifest"] = 538,
    ["Woodpecker pipeline config"] = 573,
    ["Xstate Machine Schema"] = 590,
    ["Yippee-Ki-JSON configuration YML"] = 544,
    ["angular.json"] = 11,
    ...
    ["ize.toml"] = 625,
    ["jsconfig.json"] = 272,
    ["jscpd Configuration Schema"] = 607,
    jsdoc = 532,
    ["k3d.yaml"] = 273,
    ...
    ["servicehub.config.json"] = 504,
    ["servicehub.service.json"] = 503,
    ["settings.job"] = 418,
    ...
    snapcraft = 424,
    ["stripe-app-local.json"] = 437,
    ["stripe-app.json"] = 436,
    swcrc = 555,
    taskcat = 524,
    ["template.json"] = 445,
    ["templatsources.json"] = 446,
    ["theme.json"] = 449,
    ["tizen_workspace.json"] = 450,
    tmLanguage = 451,
    tmuxinator = 512,
    ["trunk.yaml schema"] = 457,
    ["ts-force-config.json"] = 461,
    ["tsconfig.json"] = 458,
    ["tsd.json"] = 459,
    ["tsdrc.json"] = 460,
    ["tslint.json"] = 462,
    ...
    ["vega-lite.json"] = 475,
    ["vega.json"] = 474,
    ["venvironment-basic.yaml"] = 478,
    ["venvironment.yaml"] = 477,
    ["version.json"] = 479,
    ["vim-addon-info"] = 480,
    ["vs-2017.3.host.json"] = 482,
    ["vs-nesting.json"] = 483,
    ["vsls.json"] = 481,
    ["vss-extension.json"] = 487,
    ["webhint.io"] = 603,
    ["webjobpublishsettings.json"] = 493,
    ["webjobs-list.json"] = 492,
    ["xs-app.json"] = 520,
    ["xunit.runner.json"] = 502,
    yamllint = 543,
    zuul = 529,
    ["Žinoma"] = 537
  },
