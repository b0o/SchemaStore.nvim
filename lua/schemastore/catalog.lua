...
M.json = {
  ...
  index = {
    ...
    [".pmbot.yml"] = 558,
    [".postcssrc"] = 565,
    [".powerpages-web-template-manifest"] = 567,
    [".pre-commit-config.yml"] = 568,
    [".pre-commit-hooks.yml"] = 569,
    [".putout.json"] = 598,
    [".rehyperc"] = 621,
    [".remarkrc"] = 625,
    [".sprite files"] = 692,
    ...
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1028,
    ["API Builder"] = 845,
    ["AVA Configuration"] = 907,
    ...
    ["Adobe UXP Manifest"] = 967,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 879,
    ["All Contributors configuration file"] = 932,
    ...
    ["Application list for a WinUtil"] = 1010,
    ArchitectFX = 1015,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure Pipelines"] = 76,
    ["Azure Static Web Apps CLI configuration file"] = 696,
    ["Azure Static Web Apps configuration file"] = 695,
    ["BOSH Deploy Config"] = 100,
    ["BX CI"] = 118,
    ["Bashly (bashly.yml)"] = 936,
    ["Bashly Settings (bashly-settings.yml)"] = 937,
    ["Better Code Hub"] = 849,
    ["Better Scripts"] = 119,
    Bigconfig = 93,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1021,
    BizTalkServerApplicationSchema = 817,
    Bleep = 120,
    ...
    ["Butane Config"] = 892,
    C4InterFlow = 1036,
    ["CGS Card Game Specification (cgs.json)"] = 972,
    ["CICS TS region tagging"] = 901,
    ["CICS TS resource import"] = 902,
    ["CICS TS resource model"] = 903,
    ["CICS TS resource overrides"] = 904,
    ["CMake Presets"] = 121,
    ["CNC Codes"] = 138,
    ["CRS WAF test file"] = 1000,
    ["CRS WAF test platform overrides file"] = 1001,
    ...
    ["Chamaleon environment"] = 1025,
    ["Chamaleon properties"] = 1026,
    ["Chamaleon template"] = 1024,
    Changesets = 221,
    Charmcraft = 130,
    Cheatsheets = 889,
    ...
    CityJSON = 133,
    ["Clawject config"] = 144,
    ["Cloud Foundry Application Manifest"] = 983,
    ["Cloud Run Spec v1"] = 1005,
    ...
    Concord = 999,
    ["Configu .cfgu files"] = 988,
    ["Configu .configu file"] = 989,
    Conjure = 137,
    ["Container Structure Test"] = 831,
    Containerlab = 858,
    ["Contextive Glossary"] = 1050,
    Convex = 136,
    ["Crowdsec collection config"] = 231,
    ["Crowdsec parser config"] = 232,
    ["Crowdsec scenario config"] = 233,
    ["CumulusCI Config"] = 143,
    ["Custom Machinery Machine"] = 973,
    ["Custom Machinery Recipe"] = 974,
    ...
    ["DonateCaseBetterCasino menu"] = 1029,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 944,
    ["EAS config"] = 297,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 933,
    ["EasyVCR .NET"] = 298,
    ["Eidolon Resource"] = 1016,
    ...
    ["GeoJSON.json latest"] = 896,
    GherKing = 900,
    ["GitHub Action"] = 328,
    ["GitHub Actions typing"] = 1012,
    ...
    ["Google Digital Assetlinks"] = 1051,
    Goreleaser = 356,
    ["Goreleaser Pro"] = 357,
    Goss = 358,
    ["Gradle Build Cache Node"] = 847,
    ["Gradle Enterprise"] = 846,
    ...
    Hadolint = 827,
    Hammerkit = 857,
    ["Hardware Sentry Configuration"] = 912,
    Hatch = 828,
    Hayson = 371,
    ...
    ["JFrog File Spec"] = 401,
    ["JFrog Pipelines YML DSL"] = 921,
    ["JMeter DSL cli config"] = 402,
    JReleaser = 404,
    ["JSON Document Transform"] = 412,
    ["JSON Feed"] = 413,
    ["JSON Resume"] = 630,
    ["JSON Schema Draft 2020-12"] = 796,
    ["JSON Schema Draft 4"] = 793,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 954,
    ["JSON Schema Draft 7"] = 794,
    ["JSON Schema Draft 7 (unofficial strict)"] = 955,
    ["JSON Schema Draft 8 (2019-09)"] = 795,
    ["JSON-API"] = 411,
    ["JSON-e templates"] = 854,
    ["JSON-stat 2.0"] = 789,
    JSONPatch = 415,
    ...
    ["Metadata for a Cinnamon spice"] = 1008,
    ["Metatype Configuration"] = 463,
    ["MetricsHub Configuration"] = 464,
    ["MetricsHub Connector Configuration"] = 465,
    ["Micro Editor Syntax"] = 945,
    ["Microsoft Band Web Tile"] = 466,
    ["Microsoft RulesEngine workflow rules"] = 996,
    ["Microsoft RulesEngine workflow rules list"] = 997,
    ["Minecraft Custom Main Menu Mod"] = 962,
    ...
    ["MongoDB Atlas Search Index Definition"] = 916,
    ["Monika Configuration"] = 914,
    ["Monoweave Configuration"] = 491,
    ["Motif config"] = 809,
    MultiQC = 1044,
    ["NOX Framework (Service)"] = 508,
    ["Netin Diagnostic System Template"] = 874,
    ["Netlify config"] = 499,
    ["Network-as-Code Data Model"] = 500,
    ["Nightwatch.js"] = 501,
    ["Node.js configuration"] = 814,
    ["NueJS configuration file"] = 513,
    ["Nuitka.yaml"] = 975,
    ["Nullstone config"] = 515,
    ["ONe's changelog entry"] = 529,
    ["ONe's service descriptor"] = 528,
    ["OSCAL Assessment Plan (AP)"] = 537,
    ["OSCAL Assessment Results (AR)"] = 538,
    ["OSCAL Catalog"] = 539,
    ["OSCAL Component Definition (CDef)"] = 540,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 541,
    ["OSCAL Profile"] = 542,
    ["OSCAL System Security Plan (SSP)"] = 543,
    ["OSS Review Toolkit configuration"] = 544,
    ["OSS Review Toolkit curation"] = 545,
    ["OSS Review Toolkit package configuration"] = 546,
    ["OSS Review Toolkit repository configuration"] = 547,
    ["OSS Review Toolkit resolutions"] = 548,
    ...
    ["OpenUtau ustx"] = 526,
    ["OpenWeather Current Weather API"] = 853,
    ["OpenWeather Road Risk API"] = 852,
    ["Ory Hydra configuration"] = 379,
    ["Ory Keto configuration"] = 433,
    ["Ory Kratos configuration"] = 536,
    ...
    Packer = 551,
    Pantsbuild = 931,
    ["Paper paper-plugin.yml"] = 552,
    ["Pipeline component"] = 865,
    ["Platform.sh application"] = 2,
    ["Platform.sh routes"] = 3,
    ["Platform.sh services"] = 4,
    ["Plex Prerolls"] = 562,
    ["PocketMine plugin.yml"] = 559,
    ["Postman collection"] = 566,
    ["Preset list for a WinUtil"] = 1011,
    ["ProActions AI-Kit Configuration"] = 575,
    ["ProActions AI-Kit Configuration for Menus"] = 577,
    ["ProActions AI-Kit Configuration for Sections"] = 579,
    ["ProActions AI-Kit Configuration for Services"] = 576,
    ["ProActions AI-Kit Configuration for Steps"] = 580,
    ["ProActions AI-Kit Configuration for Templates"] = 578,
    ["Problem object RFC9457"] = 959,
    ["Problem package generators"] = 581,
    Pterodactyl = 911,
    ["Pull Request Labeler"] = 597,
    Pulumi = 605,
    ["PyGTA Config"] = 601,
    PyProject = 606,
    Pylock = 1052,
    Pyright = 607,
    ["Python script metadata"] = 1046,
    Qgoda = 609,
    Qodana = 884,
    ["Qt Creator workspace file"] = 990,
    ["Quali Torque Blueprint Spec 2"] = 909,
    ["QueryFirst config file"] = 927,
    ["RKE Cluster Configuration JSON"] = 862,
    ["RKE Cluster Configuration YAML"] = 861,
    RadioHound = 600,
    Railway = 610,
    ["Rancher Fleet"] = 602,
    ["Rattler-build"] = 611,
    Ray = 826,
    ["Read the Docs"] = 604,
    ["Red-DiscordBot Cog"] = 618,
    ["Red-DiscordBot Cog Repo"] = 619,
    ["Red-DiscordBot Trivia"] = 620,
    ["Render Blueprints"] = 860,
    RenderCV = 632,
    Renovate = 631,
    ["Replit config"] = 626,
    Restate = 1039,
    RoadRunner = 634,
    ["Rudder techniques"] = 965,
    Ruff = 628,
    ["Rust Project"] = 629,
    ["Rust toolchain"] = 638,
    ["SDMX data message"] = 664,
    ["SDMX metadata message"] = 663,
    ["SDMX structure message"] = 662,
    ["SIL Kit Participant Configuration"] = 674,
    ["SIL Kit Registry Configuration"] = 675,
    ["SPDX 2.3"] = 693,
    SWADL = 707,
    ["Safebox Config"] = 922,
    ["Sapphire CLI Config"] = 641,
    ["SauceCTL Configuration"] = 871,
    ["Schema Catalog"] = 656,
    ["Scoop manifest"] = 661,
    ["Semantic Data Fabric (SDF) file"] = 665,
    ["Semgrep Rule"] = 667,
    ["Serenity Code Generator (Sergen)"] = 668,
    ["Serverless Framework Configuration"] = 878,
    ["Serverless Workflow"] = 880,
    ["Settings for a Cinnamon spice"] = 1007,
    ["Settings.paf"] = 670,
    ["Shopware 6 Configuration"] = 881,
    ["Shopware CLI Extension Store Configuration"] = 882,
    ["Shopware CLI Project Store Configuration"] = 883,
    ["Sigma Detection Rule"] = 672,
    ["Sigrid scope configuration file"] = 673,
    ["SkyPilot Task JSON"] = 966,
    ["Slack app manifest"] = 677,
    Solidarity = 682,
    ["Solution filters"] = 683,
    ["Source Maps v3"] = 684,
    Sourcery = 685,
    ["Speakeasy Generation Config File"] = 689,
    ["Speakeasy Lint Configuration File"] = 686,
    ["Speakeasy Test Generation Configuration File"] = 687,
    ["Speakeasy Workflow File"] = 688,
    SpecIF = 690,
    ["Sponge Mixin configuration"] = 691,
    StackBlitz = 697,
    ["StackHawk Scanner Configuration"] = 877,
    Stale = 698,
    ["Starlake Data Pipeline"] = 850,
    Starship = 699,
    ["Statamic Blueprint"] = 700,
    ["Stella configuration file"] = 701,
    ["Stryker Mutator"] = 704,
    ["StyleCop Analyzers Configuration"] = 705,
    ["Stylelint (.stylelintrc)"] = 706,
    ["Stylua Config"] = 1053,
    ["Sublime Syntax"] = 923,
    ["Subsquid squid manifest"] = 968,
    ["Swagger API 2.0"] = 708,
    ["Synadia Connect Component"] = 709,
    TSON = 743,
    TSTyche = 744,
    ["Tab data for a LinUtil"] = 1014,
    ["Tab list for a LinUtil"] = 1013,
    Tach = 710,
    ["Tach Domain"] = 711,
    Talhelper = 713,
    ["Talisman configuration"] = 714,
    Taplo = 1054,
    ["Taskfile config"] = 855,
    Taurus = 715,
    Tauticord = 716,
    Telefonistka = 1040,
    ["TestEnvironment.json"] = 726,
    ["TextMate Grammar"] = 725,
    ["Tier.run pricing.json"] = 719,
    Tikibase = 720,
    Tombi = 724,
    ["Traefik v2"] = 729,
    ["Traefik v2 File Provider"] = 730,
    ["Traefik v3"] = 731,
    ["Traefik v3 File Provider"] = 732,
    ["Travis CI (.travis.yml)"] = 728,
    Trident = 1038,
    ["TrueScript for *.tscript files"] = 735,
    ["Tugboat QA config.yml"] = 1035,
    TunnelHub = 958,
    Turborepo = 727,
    Tycho = 1003,
    Tye = 885,
    ["Tyk Gateway - Open Source v5.7+"] = 1045,
    ["Typst Manifest"] = 749,
    ["UET BuildConfig.json"] = 928,
    ["UI5 Manifest"] = 755,
    ["UNCORS configuration"] = 759,
    ["UTAM Page Object"] = 758,
    ["Ubuntu Server Autoinstall"] = 753,
    ["Uniswap Token List"] = 838,
    ["Universal Schedule Format"] = 760,
    ["Unreal Engine Uplugin"] = 929,
    ["Unreal Engine Uproject"] = 930,
    ["Updatecli Compose"] = 893,
    ["Updatecli Policy Manifest"] = 894,
    ["Updatecli Policy Metadata"] = 895,
    Uplift = 926,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 859,
    V2Ray = 899,
    ["VSCode Code Snippets"] = 196,
    ["VSIX CLI publishing"] = 778,
    Vector = 762,
    ["Vela Pipeline Configuration"] = 765,
    Vercel = 195,
    ["Version Bumper config"] = 768,
    ["Viash Component Config"] = 1042,
    ["Viash Package Config"] = 1043,
    Visivo = 956,
    Wake = 1037,
    ["Waku Config"] = 1017,
    ["Web App Manifest"] = 784,
    ["Web types"] = 787,
    WebExtensions = 783,
    ["Webman package recipe"] = 905,
    ["Windows Package Manager Installer Manifest"] = 834,
    ["Windows Package Manager Locale Manifest"] = 835,
    ["Windows Package Manager Singleton Manifest"] = 833,
    Winutil = 836,
    ["WireMock stub mapping"] = 1020,
    ["Woodpecker pipeline config"] = 873,
    ["Wrangler CLI"] = 788,
    ["Xstate Machine"] = 891,
    ["Yandex Workflow Language"] = 1009,
    ["Yarn Config (.yarnrc.yml)"] = 848,
    ["Yippee-Ki-JSON configuration YML"] = 840,
    ["YouTrack App"] = 1006,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 960,
    ...
    ["behat.yml"] = 102,
    ["bigquery-table"] = 92,
    ["bioimageio resource description"] = 976,
    ...
    ["crowdin.yml"] = 230,
    ["ctfd-setup configuration file"] = 1027,
    ["custom-elements.json"] = 948,
    ["cypress.json"] = 234,
    ...
    ["gematik health care insurance list"] = 1033,
    ["gematik health care patient list"] = 1030,
    ["gematik health care provider institution list"] = 1032,
    ["gematik health care provider list"] = 1031,
    ["gematik tiger test environment configuration"] = 1034,
    ["gitlab-ci"] = 336,
    ["global.json"] = 352,
    ...
    ["lint-staged (.lintstagedrc)"] = 804,
    ["local.settings.json"] = 453,
    ["localazy.json"] = 454,
    ["lotus.yaml"] = 452,
    ["lsdlschema.json"] = 455,
    ["markdown-link-check"] = 868,
    maturin = 869,
    mboats = 876,
    ["micro-settings.json"] = 940,
    ["mimetypes.json"] = 467,
    ["mirrord config"] = 805,
    mise = 806,
    ["mkdocs.yml"] = 487,
    ...
    ["ops.yaml"] = 527,
    ["package.json"] = 549,
    ["package.manifest"] = 550,
    ["partial-black.json"] = 103,
    ["pathfinder.yml"] = 553,
    ["pattern.json"] = 556,
    ["petstore-v1.0"] = 920,
    pgap_yaml_input_reader = 555,
    ["pixi.toml"] = 557,
    ["plagiarize-me.yaml"] = 561,
    ["plagiarize.yaml"] = 560,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1023,
    ["podbard.yaml"] = 563,
    ["portman.json"] = 564,
    ["prefect.toml"] = 572,
    ["prettierrc.json"] = 573,
    ["prisma.yml"] = 574,
    ["project-1.0.0-beta3.json"] = 583,
    ["project-1.0.0-beta4.json"] = 584,
    ["project-1.0.0-beta5.json"] = 585,
    ["project-1.0.0-beta6.json"] = 586,
    ["project-1.0.0-beta8.json"] = 587,
    ["project-1.0.0-rc1.json"] = 588,
    ["project-1.0.0-rc2.json"] = 589,
    ["project.json"] = 582,
    ["project.owasp.yaml"] = 590,
    ["prometheus.json"] = 591,
    ["prometheus.rules.json"] = 592,
    ["prometheus.rules.test.json"] = 593,
    ["proxies.json"] = 594,
    ["publiccode.yml"] = 595,
    ["pubspec.yaml"] = 596,
    ["pyrseas-0.8.json"] = 599,
    pytest = 608,
    ["quilt.mod.json"] = 941,
    ["rc3 auth"] = 612,
    ["rc3 collection"] = 613,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 821,
    ["release-please-config.json"] = 622,
    ["release-please-manifest.json"] = 623,
    ["release-plz.toml"] = 624,
    ["renv.lock"] = 633,
    ["rivet.yaml"] = 963,
    rockcraft = 635,
    runny = 636,
    ...
    samt = 639,
    samtrc = 640,
    ["sarif-1.0.0.json"] = 642,
    ["sarif-2.0.0.json"] = 643,
    ["sarif-2.1.0"] = 653,
    ["sarif-2.1.0-rtm.2"] = 644,
    ["sarif-2.1.0-rtm.3"] = 646,
    ["sarif-2.1.0-rtm.4"] = 648,
    ["sarif-2.1.0-rtm.5"] = 650,
    ["sarif-2.1.0-rtm.6"] = 651,
    ["sarif-external-property-file-2.1.0"] = 654,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 645,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 647,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 649,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 652,
    ["scalingo.json configuration"] = 655,
    ["schema.org - Action"] = 657,
    ["schema.org - ContactPoint"] = 658,
    ["schema.org - Place"] = 659,
    ["schema.org - Thing"] = 660,
    ["secrethub.yml"] = 943,
    ["semantic-release"] = 666,
    ["servicehub.config.json"] = 799,
    ["servicehub.service.json"] = 798,
    ["settings.job"] = 669,
    ["sfdx-hardis configuration"] = 671,
    ["shard.yml"] = 979,
    ["size-limit configuration"] = 676,
    ["skaffold.yaml"] = 866,
    ["skyuxconfig.json"] = 678,
    snapcraft = 679,
    ["snowflake-config"] = 680,
    ["snowflake-connections"] = 681,
    ["spicepod.yaml"] = 998,
    ["sqlc configuration"] = 694,
    ["stripe-app-local.json"] = 703,
    ["stripe-app.json"] = 702,
    swcrc = 851,
    ["task.json"] = 712,
    taskcat = 816,
    ["template.json"] = 717,
    ["templatsources.json"] = 718,
    ["theme.json"] = 721,
    ["tizen_workspace.json"] = 722,
    tldr = 723,
    tmuxinator = 802,
    ["transcend.yml"] = 733,
    ...
    ["vega-lite.json"] = 764,
    ["vega.json"] = 763,
    ["venvironment-basic.yaml"] = 767,
    ["venvironment.yaml"] = 766,
    version = 1041,
    ["version.json"] = 769,
    ["vhwdebugger-binding.yaml"] = 771,
    ["vim-addon-info"] = 772,
    ["vs-2017.3.host.json"] = 774,
    ["vs-nesting.json"] = 775,
    ["vsls.json"] = 773,
    ["vss-extension.json"] = 779,
    vtcfg = 1047,
    ["vtesttree.yaml"] = 780,
    ["vtestunit.yaml"] = 781,
    ["warp-keysets.json"] = 949,
    ["warp-themes.json"] = 950,
    ["warp-workflows.json"] = 951,
    ["webhint.io"] = 906,
    ["webjobpublishsettings.json"] = 786,
    ["webjobs-list.json"] = 785,
    ["well-known-fursona"] = 986,
    ["xs-app.json"] = 811,
    ["xunit.runner.json"] = 797,
    yamllint = 839,
    ["zerops.io import file"] = 995,
    ["zerops.yml"] = 994,
    zuul = 822,
    ["Žinoma"] = 832
  },
