...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1021,
    ["API Builder"] = 838,
    ["AVA Configuration"] = 900,
    ...
    ["Adobe UXP Manifest"] = 960,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 872,
    ["All Contributors configuration file"] = 925,
    ...
    ["Application list for a WinUtil"] = 1003,
    ArchitectFX = 1008,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["BX CI"] = 118,
    ["Bashly (bashly.yml)"] = 929,
    ["Bashly Settings (bashly-settings.yml)"] = 930,
    ["Better Code Hub"] = 842,
    ["Better Scripts"] = 119,
    Bigconfig = 93,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1014,
    BizTalkServerApplicationSchema = 810,
    Bleep = 120,
    ...
    ["Butane Config"] = 885,
    C4InterFlow = 1029,
    ["CGS Card Game Specification (cgs.json)"] = 965,
    ["CICS TS region tagging"] = 894,
    ["CICS TS resource import"] = 895,
    ["CICS TS resource model"] = 896,
    ["CICS TS resource overrides"] = 897,
    ["CMake Presets"] = 121,
    ["CNC Codes"] = 138,
    ["CRS WAF test file"] = 993,
    ["CRS WAF test platform overrides file"] = 994,
    ...
    ["Chamaleon environment"] = 1018,
    ["Chamaleon properties"] = 1019,
    ["Chamaleon template"] = 1017,
    Changesets = 221,
    Charmcraft = 130,
    Cheatsheets = 882,
    ...
    CityJSON = 133,
    ["Clawject config"] = 144,
    ["Cloud Foundry Application Manifest"] = 976,
    ["Cloud Run Spec v1"] = 998,
    ...
    Concord = 992,
    ["Configu .cfgu files"] = 981,
    ["Configu .configu file"] = 982,
    Conjure = 137,
    ["Container Structure Test"] = 824,
    Containerlab = 851,
    ["Contextive Glossary"] = 1043,
    Convex = 136,
    ["Crowdsec collection config"] = 231,
    ["Crowdsec parser config"] = 232,
    ["Crowdsec scenario config"] = 233,
    ["CumulusCI Config"] = 143,
    ["Custom Machinery Machine"] = 966,
    ["Custom Machinery Recipe"] = 967,
    ...
    ["DonateCaseBetterCasino menu"] = 1022,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 937,
    ["EAS config"] = 297,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 926,
    ["EasyVCR .NET"] = 298,
    ["Eidolon Resource"] = 1009,
    ...
    ["GeoJSON.json latest"] = 889,
    GherKing = 893,
    ["GitHub Action"] = 328,
    ["GitHub Actions typing"] = 1005,
    ...
    ["Google Digital Assetlinks"] = 1044,
    Goreleaser = 356,
    ["Goreleaser Pro"] = 357,
    Goss = 358,
    ["Gradle Build Cache Node"] = 840,
    ["Gradle Enterprise"] = 839,
    ...
    Hadolint = 820,
    Hammerkit = 850,
    ["Hardware Sentry Configuration"] = 905,
    Hatch = 821,
    Hayson = 371,
    ...
    ["JFrog File Spec"] = 401,
    ["JFrog Pipelines YML DSL"] = 914,
    ["JMeter DSL cli config"] = 402,
    JReleaser = 404,
    ["JSON Document Transform"] = 412,
    ["JSON Feed"] = 413,
    ["JSON Resume"] = 624,
    ["JSON Schema Draft 2020-12"] = 789,
    ["JSON Schema Draft 4"] = 786,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 947,
    ["JSON Schema Draft 7"] = 787,
    ["JSON Schema Draft 7 (unofficial strict)"] = 948,
    ["JSON Schema Draft 8 (2019-09)"] = 788,
    ["JSON-API"] = 411,
    ["JSON-e templates"] = 847,
    ["JSON-stat 2.0"] = 782,
    JSONPatch = 415,
    ...
    ["Metadata for a Cinnamon spice"] = 1001,
    ["Metatype Configuration"] = 463,
    ["MetricsHub Configuration"] = 464,
    ["MetricsHub Connector Configuration"] = 465,
    ["Micro Editor Syntax"] = 938,
    ["Microsoft Band Web Tile"] = 466,
    ["Microsoft RulesEngine workflow rules"] = 989,
    ["Microsoft RulesEngine workflow rules list"] = 990,
    ["Minecraft Custom Main Menu Mod"] = 955,
    ...
    ["MongoDB Atlas Search Index Definition"] = 909,
    ["Monika Configuration"] = 907,
    ["Monoweave Configuration"] = 491,
    ["Motif config"] = 802,
    MultiQC = 1037,
    ["NOX Framework (Service)"] = 508,
    ["Netin Diagnostic System Template"] = 867,
    ["Netlify config"] = 499,
    ["Network-as-Code Data Model"] = 500,
    ["Nightwatch.js"] = 501,
    ["Node.js configuration"] = 807,
    ...
    ["OpenUtau ustx"] = 526,
    ["OpenWeather Current Weather API"] = 846,
    ["OpenWeather Road Risk API"] = 845,
    ...
    ["Preset list for a WinUtil"] = 1004,
    ["Problem object RFC9457"] = 952,
    ...
    Pylock = 1045,
    Pyright = 601,
    ["Python script metadata"] = 1039,
    Qgoda = 603,
    Qodana = 877,
    ["Qt Creator workspace file"] = 983,
    ["Quali Torque Blueprint Spec 2"] = 902,
    ["QueryFirst config file"] = 920,
    ["RKE Cluster Configuration JSON"] = 855,
    ["RKE Cluster Configuration YAML"] = 854,
    RadioHound = 594,
    Railway = 604,
    ["Rancher Fleet"] = 596,
    ["Rattler-build"] = 605,
    ...
    ["Render Blueprints"] = 853,
    RenderCV = 626,
    Renovate = 625,
    ["Replit config"] = 620,
    Restate = 1032,
    RoadRunner = 628,
    ["Rudder techniques"] = 958,
    Ruff = 622,
    ["Rust Project"] = 623,
    ["Rust toolchain"] = 632,
    ...
    ["SauceCTL Configuration"] = 864,
    ["Schema Catalog"] = 650,
    ["Scoop manifest"] = 655,
    ["Semantic Data Fabric (SDF) file"] = 659,
    ["Semgrep Rule"] = 661,
    ["Serenity Code Generator (Sergen)"] = 662,
    ["Serverless Framework Configuration"] = 871,
    ["Serverless Workflow"] = 873,
    ["Settings for a Cinnamon spice"] = 1000,
    ["Settings.paf"] = 664,
    ["Shopware 6 Configuration"] = 874,
    ["Shopware CLI Extension Store Configuration"] = 875,
    ["Shopware CLI Project Store Configuration"] = 876,
    ["Sigma Detection Rule"] = 666,
    ["Sigrid scope configuration file"] = 667,
    ["SkyPilot Task JSON"] = 959,
    ...
    StackBlitz = 691,
    ["StackHawk Scanner Configuration"] = 870,
    Stale = 692,
    ["Starlake Data Pipeline"] = 843,
    Starship = 693,
    ...
    TSON = 737,
    TSTyche = 738,
    ["Tab data for a LinUtil"] = 1007,
    ["Tab list for a LinUtil"] = 1006,
    Tach = 704,
    ["Tach Domain"] = 705,
    Talhelper = 707,
    ...
    ["Tugboat QA config.yml"] = 1028,
    TunnelHub = 951,
    Turborepo = 721,
    Tycho = 996,
    Tye = 878,
    ["Tyk Gateway - Open Source v5.7+"] = 1038,
    ["UET BuildConfig.json"] = 921,
    ["UI5 Manifest"] = 748,
    ["UNCORS configuration"] = 752,
    ["UTAM Page Object"] = 751,
    ["Ubuntu Server Autoinstall"] = 746,
    ["Uniswap Token List"] = 831,
    ["Universal Schedule Format"] = 753,
    ["Unreal Engine Uplugin"] = 922,
    ["Unreal Engine Uproject"] = 923,
    ["Updatecli Compose"] = 886,
    ["Updatecli Policy Manifest"] = 887,
    ["Updatecli Policy Metadata"] = 888,
    Uplift = 919,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 852,
    V2Ray = 892,
    ["VSCode Code Snippets"] = 196,
    ["VSIX CLI publishing"] = 771,
    Vector = 755,
    ["Vela Pipeline Configuration"] = 758,
    Vercel = 195,
    ["Version Bumper config"] = 761,
    ["Viash Component Config"] = 1035,
    ["Viash Package Config"] = 1036,
    Visivo = 949,
    Wake = 1030,
    ["Waku Config"] = 1010,
    ["Web App Manifest"] = 777,
    ["Web types"] = 780,
    WebExtensions = 776,
    ["Webman package recipe"] = 898,
    ["Windows Package Manager Installer Manifest"] = 827,
    ["Windows Package Manager Locale Manifest"] = 828,
    ["Windows Package Manager Singleton Manifest"] = 826,
    Winutil = 829,
    ["WireMock stub mapping"] = 1013,
    ["Woodpecker pipeline config"] = 866,
    ["Wrangler CLI"] = 781,
    ["Xstate Machine"] = 884,
    ["Yandex Workflow Language"] = 1002,
    ["Yarn Config (.yarnrc.yml)"] = 841,
    ["Yippee-Ki-JSON configuration YML"] = 833,
    ["YouTrack App"] = 999,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 953,
    ...
    ["behat.yml"] = 102,
    ["bigquery-table"] = 92,
    ["bioimageio resource description"] = 969,
    ...
    ["crowdin.yml"] = 230,
    ["ctfd-setup configuration file"] = 1020,
    ["custom-elements.json"] = 941,
    ["cypress.json"] = 234,
    ...
    ["gematik health care insurance list"] = 1026,
    ["gematik health care patient list"] = 1023,
    ["gematik health care provider institution list"] = 1025,
    ["gematik health care provider list"] = 1024,
    ["gematik tiger test environment configuration"] = 1027,
    ["gitlab-ci"] = 336,
    ["global.json"] = 352,
    ...
    ["lint-staged (.lintstagedrc)"] = 797,
    ["local.settings.json"] = 453,
    ["localazy.json"] = 454,
    ["lotus.yaml"] = 452,
    ["lsdlschema.json"] = 455,
    ["markdown-link-check"] = 861,
    maturin = 862,
    mboats = 869,
    ["micro-settings.json"] = 933,
    ["mimetypes.json"] = 467,
    ["mirrord config"] = 798,
    mise = 799,
    ["mkdocs.yml"] = 487,
    ...
    ["plagiarize.yaml"] = 560,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1016,
    ["podbard.yaml"] = 563,
    ["portman.json"] = 564,
    ["prefect.toml"] = 572,
    ["prettierrc.json"] = 573,
    ...
    ["servicehub.config.json"] = 792,
    ["servicehub.service.json"] = 791,
    ["settings.job"] = 663,
    ...
    ["vega-lite.json"] = 757,
    ["vega.json"] = 756,
    ["venvironment-basic.yaml"] = 760,
    ["venvironment.yaml"] = 759,
    version = 1034,
    ["version.json"] = 762,
    ["vhwdebugger-binding.yaml"] = 764,
    ["vim-addon-info"] = 765,
    ["vs-2017.3.host.json"] = 767,
    ["vs-nesting.json"] = 768,
    ["vsls.json"] = 766,
    ["vss-extension.json"] = 772,
    vtcfg = 1040,
    ["vtesttree.yaml"] = 773,
    ["vtestunit.yaml"] = 774,
    ["warp-keysets.json"] = 942,
    ["warp-themes.json"] = 943,
    ["warp-workflows.json"] = 944,
    ["webhint.io"] = 899,
    ["webjobpublishsettings.json"] = 779,
    ["webjobs-list.json"] = 778,
    ["well-known-fursona"] = 979,
    ["xs-app.json"] = 804,
    ["xunit.runner.json"] = 790,
    yamllint = 832,
    ["zerops.io import file"] = 988,
    ["zerops.yml"] = 987,
    zuul = 815,
    ["Žinoma"] = 825
  },
