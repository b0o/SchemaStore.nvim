...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 755,
    [".nodehawkrc"] = 479,
    [".npmpackagejsonlintrc"] = 483,
    [".omletrc"] = 926,
    [".phrase.yml"] = 544,
    [".phraseapp.yml"] = 545,
    [".pmbot.yml"] = 532,
    [".postcssrc"] = 539,
    [".powerpages-web-template-manifest"] = 541,
    [".pre-commit-config.yml"] = 542,
    [".pre-commit-hooks.yml"] = 543,
    [".putout.json"] = 565,
    [".rehyperc"] = 584,
    [".remarkrc"] = 586,
    [".sprite files"] = 648,
    ...
    ["A micro editor config"] = 434,
    ABCInventoryModuleData = 13,
    ABCSupplyPlan = 14,
    AIConfig = 15,
    ["API Builder"] = 788,
    ["AVA Configuration"] = 848,
    ...
    ["Adobe UXP Manifest"] = 908,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Alacritty Configuration"] = 820,
    ["All Contributors configuration file"] = 873,
    ["Ansible Argument Specs"] = 321,
    ["Ansible Collection Galaxy"] = 328,
    ["Ansible Execution Environment"] = 318,
    ["Ansible Inventory"] = 327,
    ["Ansible Meta"] = 319,
    ["Ansible Meta Runtime"] = 320,
    ["Ansible Navigator Configuration"] = 330,
    ["Ansible Playbook"] = 325,
    ["Ansible Requirements"] = 322,
    ["Ansible Rulebook"] = 326,
    ["Ansible Tasks File"] = 324,
    ["Ansible Vars File"] = 323,
    ["Ansible-lint Configuration"] = 329,
    Any = 935,
    ["AnyWork Automation Configuration"] = 5,
    ["App config Spotify Backstage"] = 20,
    ["Application Accelerator"] = 2,
    ["Application list for a WinUtil"] = 952,
    ArchitectFX = 956,
    ["Argo Events"] = 28,
    ["Argo Workflows"] = 29,
    AssemblyScript = 32,
    ...
    ["Azure Pipelines"] = 65,
    ["Azure Static Web Apps CLI configuration file"] = 651,
    ["Azure Static Web Apps configuration file"] = 650,
    ["BOSH Deploy Config"] = 89,
    ["BX CI"] = 106,
    ["Bashly (bashly.yml)"] = 877,
    ["Bashly Settings (bashly-settings.yml)"] = 878,
    ["Better Code Hub"] = 792,
    ["Better Scripts"] = 107,
    Bigconfig = 82,
    ["Biome Formatter Config"] = 52,
    ["Bitmovin Encoding Template"] = 962,
    BizTalkServerApplicationSchema = 761,
    Bleep = 108,
    ...
    ["Butane Config"] = 833,
    ["CGS Custom Card Game (CardGameDef.json)"] = 913,
    ["CICS TS region tagging"] = 842,
    ["CICS TS resource import"] = 843,
    ["CICS TS resource model"] = 844,
    ["CICS TS resource overrides"] = 845,
    ["CMake Presets"] = 109,
    ["CNC Codes"] = 124,
    ["CRS WAF test file"] = 942,
    ["CRS WAF test platform overrides file"] = 943,
    ...
    ["Chamaleon environment"] = 966,
    ["Chamaleon template"] = 965,
    Changesets = 204,
    Cheatsheets = 830,
    ...
    CityJSON = 120,
    ["Clawject config"] = 129,
    ["Cloud Foundry Application Manifest"] = 925,
    ["Cloud Run Spec v1"] = 947,
    ...
    Concord = 941,
    ["Configu .cfgu files"] = 930,
    ["Configu .configu file"] = 931,
    Conjure = 123,
    ["Container Structure Test"] = 775,
    Containerlab = 800,
    ["Crowdsec collection config"] = 213,
    ["Crowdsec parser config"] = 214,
    ["Crowdsec scenario config"] = 215,
    ["CumulusCI Config"] = 128,
    ["Custom Machinery Machine"] = 914,
    ["Custom Machinery Recipe"] = 915,
    ["Cycle Stack File"] = 131,
    ["DWP Exchange - catalogue entry"] = 261,
    ["DWP Exchange - gateway"] = 259,
    ["DWP Exchange - meta"] = 260,
    ...
    ["DataYoga Job"] = 133,
    ["Databricks Asset Bundles"] = 894,
    ["Datadog Service Definition"] = 407,
    ["Datadog Software Catalog"] = 408,
    ["Datahub Ingestion Recipe"] = 849,
    ["Dein Config"] = 139,
    ...
    ["Dolittle Artifacts"] = 241,
    ["Dolittle Bounded Context Configuration"] = 242,
    ["Dolittle Event Horizons Configuration"] = 243,
    ["Dolittle Resources Configuration"] = 244,
    ["Dolittle Server Configuration"] = 245,
    ["Dolittle Tenant Map Configuration"] = 247,
    ["Dolittle Tenants Configuration"] = 246,
    ["Dolittle Topology"] = 248,
    ...
    ["Drupal Routing"] = 155,
    ["Drupal Services"] = 157,
    ["Drush site aliases"] = 254,
    ["Dynamic Bash Aliases (.aliases)"] = 885,
    ["EAS config"] = 279,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 874,
    ["EasyVCR .NET"] = 280,
    ["Eidolon Resource"] = 957,
    ["Elgato Stream Deck"] = 264,
    Elm = 946,
    ["Embrace Config"] = 860,
    Endurica = 898,
    ["Enterprise Contract Policy Spec"] = 265,
    ["Erda Pipeline"] = 921,
    ["Erda Runtime"] = 922,
    ["Error pages"] = 269,
    Esquio = 267,
    ["Estuary Flow Catalog"] = 839,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 272,
    ["EveryVoice TTS Toolkit Data Configuration"] = 273,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 277,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 276,
    ["EveryVoice TTS Toolkit Text Configuration"] = 274,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 275,
    ["Expo SDK"] = 278,
    ["F-Droid Data metadata"] = 284,
    ["FasterCI Configuration"] = 66,
    FiQuS = 288,
    Firebase = 286,
    ["Flow.json Configurations"] = 918,
    ["Fossa configuration file"] = 295,
    ["Fossa's fossa-deps file"] = 296,
    ["Foundry VTT - Base package Manifest"] = 290,
    ["Foundry VTT - Module Manifest"] = 291,
    ["Foundry VTT - System Data Template"] = 294,
    ["Foundry VTT - System Manifest"] = 292,
    ["Foundry VTT - World Manifest"] = 293,
    ["Foxx Manifest"] = 67,
    ["Freifunk.de Community API"] = 70,
    ["Frogbot Config"] = 71,
    ["G2P Mapping Configuration"] = 300,
    ["GCP Blueprint Metadata"] = 303,
    Gaspar = 301,
    ["GatewayCore API Gateway"] = 302,
    ["GeoJSON.json latest"] = 837,
    GherKing = 841,
    ["GitHub Action"] = 308,
    ...
    ["GitLab Agent for Kubernetes configuration"] = 910,
    GitVersion = 305,
    ["Gitea Issue Template configuration"] = 306,
    ["Gitea Issue Template forms"] = 307,
    ["Gitpod Configuration"] = 317,
    ["GlazeWM settings"] = 912,
    ["Global Privacy Control"] = 304,
    Goblet = 893,
    ["Golangci-lint Configuration"] = 332,
    ["Golangci-lint Custom Plugins Configuration"] = 333,
    ["Google Chrome Related Website Sets"] = 287,
    ["Google Cloud Workflows"] = 191,
    Goreleaser = 335,
    ["Goreleaser Pro"] = 336,
    Goss = 337,
    ["Gradle Build Cache Node"] = 790,
    ["Gradle Enterprise"] = 789,
    ["Grafana 5.x Dashboard"] = 338,
    ["GraphQL Code Generator"] = 342,
    ["GraphQL Config"] = 341,
    ["GraphQL Mesh"] = 340,
    ["Grunt JSHint task"] = 346,
    ["Grunt Watch task"] = 347,
    ["Grunt base task"] = 348,
    ["Grunt clean task"] = 344,
    ["Grunt copy task"] = 343,
    ["Grunt cssmin task"] = 345,
    HEMTT = 758,
    Hadolint = 771,
    Hammerkit = 799,
    ["Hardware Sentry Configuration"] = 853,
    Hatch = 772,
    Hayson = 350,
    ["Haystack Pipeline"] = 351,
    ["Hazelcast 5 Configuration"] = 352,
    ["Helm Chart.lock"] = 159,
    ["Helm Chart.yaml"] = 158,
    ["Helm Unittest Test Suite"] = 160,
    Hugo = 829,
    ["Hugo Theme"] = 828,
    ["Hyperfoil benchmark configuration"] = 358,
    ["IBM Zapp document"] = 359,
    ["IBM zCodeFormatSettings"] = 360,
    ["IMG Catapult PSP"] = 365,
    ["IVMS101 by CODE Protocol"] = 911,
    Infrahub = 367,
    Istanbul = 856,
    ["JDownloader2 crawler multi-rules"] = 377,
    ["JDownloader2 crawler single-rules"] = 376,
    ["JFrog Applications Config"] = 378,
    ["JFrog File Spec"] = 379,
    ["JFrog Pipelines YML DSL"] = 862,
    ["JMeter DSL cli config"] = 380,
    JReleaser = 382,
    ["JSON Document Transform"] = 390,
    ["JSON Feed"] = 391,
    ["JSON Resume"] = 591,
    ["JSON Schema Draft 2020-12"] = 741,
    ["JSON Schema Draft 4"] = 738,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 895,
    ["JSON Schema Draft 7"] = 739,
    ["JSON Schema Draft 7 (unofficial strict)"] = 896,
    ["JSON Schema Draft 8 (2019-09)"] = 740,
    ["JSON-API"] = 389,
    ["JSON-WF"] = 924,
    ["JSON-e templates"] = 797,
    ["JSON-stat 2.0"] = 734,
    JSONPatch = 393,
    ["JSR Package Config (jsr.json)"] = 383,
    Jasmine = 371,
    Jekyll = 372,
    ["Jenkins X Pipelines"] = 373,
    ["Jenkins X Requirements"] = 374,
    Jest = 375,
    ["Jovo Language Models"] = 381,
    ["KIMMDY config file"] = 404,
    ["KSP-AVC"] = 735,
    ["KSP-CKAN"] = 736,
    ["KSP-NetKAN"] = 737,
    KSY = 923,
    ["Karakum configuration file"] = 297,
    Kas = 396,
    ["Kestra flow file"] = 405,
    ["Keycloak REST API"] = 865,
    ["Knative Functions - func.yaml"] = 298,
    ["KoDE/CI build.yaml"] = 858,
    ["Kong DBLess config"] = 859,
    KrakenD = 406,
    ["Kubri Configuration"] = 412,
    LOOBin = 427,
    ...
    ["Language configuration"] = 934,
    Lefthook = 416,
    ["Liferay client-extension.yaml"] = 423,
    ["LinkML Metamodel"] = 425,
    Liquibase = 805,
    ["Liquibase Flow File"] = 806,
    ["Lively Properties"] = 426,
    ["Lobe AI Agent"] = 63,
    Loki = 64,
    ["MLOS Configs"] = 463,
    ["MS2Rescore Configuration"] = 466,
    ["Madness (madness.yml)"] = 876,
    ["MapEHR Mapping"] = 433,
    Markdownlint = 809,
    ["Mason Registry"] = 811,
    ["MegaLinter configuration"] = 435,
    ["MegaLinter descriptor"] = 436,
    Melange = 902,
    ["Meltano project definition"] = 437,
    ["Mergify Configuration"] = 467,
    ["Metadata for a Bazel module"] = 438,
    ["Metadata for a Cinnamon spice"] = 950,
    ["MetricsHub Configuration"] = 439,
    ["MetricsHub Connector Configuration"] = 440,
    ["Micro Editor Syntax"] = 886,
    ["Microsoft Band Web Tile"] = 441,
    ["Microsoft RulesEngine workflow rules"] = 938,
    ["Microsoft RulesEngine workflow rules list"] = 939,
    ["Minecraft Custom Main Menu Mod"] = 903,
    ["Minecraft Data Pack Advancement"] = 443,
    ["Minecraft Data Pack Biome"] = 444,
    ["Minecraft Data Pack Configured Carver"] = 445,
    ["Minecraft Data Pack Damage Type"] = 446,
    ["Minecraft Data Pack Dimension"] = 448,
    ["Minecraft Data Pack Dimension Type"] = 447,
    ["Minecraft Data Pack Item Modifier"] = 449,
    ["Minecraft Data Pack Loot Table"] = 450,
    ["Minecraft Data Pack Metadata"] = 451,
    ["Minecraft Data Pack Predicate"] = 452,
    ["Minecraft Data Pack Recipe"] = 453,
    ["Minecraft Data Pack Tag"] = 454,
    ["Minecraft Data Pack Template Pool"] = 455,
    ["Minecraft Data Pack Trim Material"] = 460,
    ["Minecraft Data Pack Trim Pattern"] = 461,
    ["Minecraft Resource Pack Lang"] = 456,
    ["Minecraft Resource Pack Particle"] = 457,
    ["Minecraft Resource Pack Texture Mcmeta"] = 459,
    ["Minecraft Resourcepack Sounds"] = 458,
    ["Monade CLI Stack Configuration"] = 470,
    ["MongoDB Atlas Search Index Definition"] = 857,
    ["Monika Configuration"] = 855,
    ["Monoweave Configuration"] = 465,
    ["Motif config"] = 754,
    ["NOX Framework (Service)"] = 482,
    ["Netin Diagnostic System Template"] = 815,
    ["Netlify config"] = 473,
    ["Network-as-Code Data Model"] = 474,
    ["Nightwatch.js"] = 475,
    ["NueJS configuration file"] = 487,
    ["Nuitka.yaml"] = 916,
    ["Nullstone config"] = 489,
    ["ONe's changelog entry"] = 503,
    ["ONe's service descriptor"] = 502,
    ["OSCAL Assessment Plan (AP)"] = 511,
    ["OSCAL Assessment Results (AR)"] = 512,
    ["OSCAL Catalog"] = 513,
    ["OSCAL Component Definition (CDef)"] = 514,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 515,
    ["OSCAL Profile"] = 516,
    ["OSCAL System Security Plan (SSP)"] = 517,
    ["OSS Review Toolkit configuration"] = 518,
    ["OSS Review Toolkit curation"] = 519,
    ["OSS Review Toolkit package configuration"] = 520,
    ["OSS Review Toolkit repository configuration"] = 521,
    ["OSS Review Toolkit resolutions"] = 522,
    ["October CMS columns"] = 493,
    ["October CMS fields"] = 494,
    Okteto = 495,
    Opctl = 757,
    ["Open Data Contract Standard (ODCS)"] = 506,
    ["OpenRewrite Resource"] = 505,
    ["OpenUtau character yaml"] = 499,
    ["OpenUtau ustx"] = 500,
    ["OpenWeather Current Weather API"] = 796,
    ["OpenWeather Road Risk API"] = 795,
    ["Ory Hydra configuration"] = 357,
    ["Ory Keto configuration"] = 409,
    ["Ory Kratos configuration"] = 510,
    ["Ory Oathkeeper configuration"] = 491,
    ["Outblocks App configuration"] = 508,
    ["Outblocks database table"] = 509,
    ["Outblocks project configuration"] = 507,
    PDM = 528,
    Packer = 525,
    Pantsbuild = 872,
    ["Paper paper-plugin.yml"] = 526,
    ["Pipeline component"] = 807,
    ["Plex Prerolls"] = 536,
    ["PocketMine plugin.yml"] = 533,
    ["Postman collection"] = 540,
    ["Preset list for a WinUtil"] = 953,
    ["Problem object RFC9457"] = 900,
    ["Problem package generators"] = 549,
    Pterodactyl = 852,
    ["Pull Request Labeler"] = 564,
    Pulumi = 570,
    PyProject = 571,
    Pyright = 572,
    Qgoda = 573,
    Qodana = 825,
    ["Qt Creator workspace file"] = 932,
    ["Quali Torque Blueprint Spec 2"] = 850,
    ["QueryFirst config file"] = 868,
    ["RKE Cluster Configuration JSON"] = 804,
    ["RKE Cluster Configuration YAML"] = 803,
    ["Rancher Fleet"] = 567,
    ["Rattler-build"] = 574,
    Ray = 770,
    ["Read the Docs"] = 569,
    ["Red-DiscordBot Cog"] = 581,
    ["Red-DiscordBot Cog Repo"] = 582,
    ["Red-DiscordBot Trivia"] = 583,
    ["Render Blueprints"] = 802,
    RenderCV = 593,
    Renovate = 592,
    ["Replit config"] = 587,
    RoadRunner = 594,
    ["Rudder techniques"] = 906,
    Ruff = 589,
    ["Rust Project"] = 590,
    ["Rust toolchain"] = 598,
    ["SDMX data message"] = 623,
    ["SDMX metadata message"] = 622,
    ["SDMX structure message"] = 621,
    ["SIL Kit Participant Configuration"] = 633,
    ["SIL Kit Registry Configuration"] = 634,
    SWADL = 662,
    ["Safebox Config"] = 863,
    ["Sapphire CLI Config"] = 601,
    ["SauceCTL Configuration"] = 812,
    ["Schema Catalog"] = 615,
    ["Scoop manifest"] = 620,
    ["Semantic Data Fabric (SDF) file"] = 624,
    ["Semgrep Rule"] = 626,
    ["Serenity Code Generator (Sergen)"] = 627,
    ["Serverless Framework Configuration"] = 819,
    ["Serverless Workflow"] = 821,
    ["Settings for a Cinnamon spice"] = 949,
    ["Settings.paf"] = 629,
    ["Shopware 6 Configuration"] = 822,
    ["Shopware CLI Extension Store Configuration"] = 823,
    ["Shopware CLI Project Store Configuration"] = 824,
    ["Sigma Detection Rule"] = 631,
    ["Sigrid scope configuration file"] = 632,
    ["SkyPilot Task JSON"] = 907,
    ["Slack app manifest"] = 636,
    Solidarity = 639,
    ["Solution filters"] = 640,
    ["Source Maps v3"] = 641,
    Sourcery = 642,
    ["Speakeasy Lint Configuration File"] = 643,
    ["Speakeasy Test Generation Configuration File"] = 644,
    ["Speakeasy Workflow File"] = 645,
    SpecIF = 646,
    ["Sponge Mixin configuration"] = 647,
    StackBlitz = 652,
    ["StackHawk Scanner Configuration"] = 818,
    Stale = 653,
    ["Starlake Data Pipeline"] = 793,
    Starship = 654,
    ["Statamic Blueprint"] = 655,
    ["Stella configuration file"] = 656,
    ["Stryker Mutator"] = 659,
    ["StyleCop Analyzers Configuration"] = 660,
    ["Stylelint (.stylelintrc)"] = 661,
    ["Sublime Syntax"] = 864,
    ["Subsquid squid manifest"] = 909,
    ["Swagger API 2.0"] = 663,
    TSON = 692,
    TSTyche = 693,
    ["Tab data for a LinUtil"] = 955,
    ["Tab list for a LinUtil"] = 954,
    Talhelper = 665,
    ["Talisman configuration"] = 666,
    ["Taskfile config"] = 798,
    Taurus = 667,
    Tauticord = 668,
    ["TestEnvironment.json"] = 677,
    ["TextMate Grammar"] = 676,
    ["Tier.run pricing.json"] = 671,
    Tikibase = 672,
    ["Traefik v2"] = 680,
    ["Traefik v2 File Provider"] = 681,
    ["Travis CI (.travis.yml)"] = 679,
    ["TrueScript for *.tscript files"] = 684,
    TunnelHub = 899,
    Turborepo = 678,
    Tycho = 945,
    Tye = 826,
    ["UET BuildConfig.json"] = 869,
    ["UI5 Manifest"] = 702,
    ["UNCORS configuration"] = 706,
    ["UTAM Page Object"] = 705,
    ["Ubuntu Server Autoinstall"] = 700,
    ["Uniswap Token List"] = 781,
    ["Unreal Engine Uplugin"] = 870,
    ["Unreal Engine Uproject"] = 871,
    ["Updatecli Compose"] = 834,
    ["Updatecli Policy Manifest"] = 835,
    ["Updatecli Policy Metadata"] = 836,
    Uplift = 867,
    ["User Journey Map"] = 801,
    V2Ray = 840,
    ["VSCode Code Snippets"] = 179,
    ["VSIX CLI publishing"] = 723,
    ["Vela Pipeline Configuration"] = 710,
    Vercel = 178,
    ["Version Bumper config"] = 713,
    Visivo = 897,
    ["Waku Config"] = 958,
    ["Web App Manifest"] = 729,
    ["Web types"] = 732,
    WebExtensions = 728,
    ["Webman package recipe"] = 846,
    ["Windows Package Manager Installer Manifest"] = 778,
    ["Windows Package Manager Locale Manifest"] = 779,
    ["Windows Package Manager Singleton Manifest"] = 777,
    ["WireMock stub mapping"] = 961,
    ["Woodpecker pipeline config"] = 814,
    ["Wrangler CLI"] = 733,
    ["Xstate Machine"] = 832,
    ["Yandex Workflow Language"] = 951,
    ["Yarn Config (.yarnrc.yml)"] = 791,
    ["Yippee-Ki-JSON configuration YML"] = 783,
    ["YouTrack App"] = 948,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 901,
    ...
    ["behat.yml"] = 91,
    ["bigquery-table"] = 81,
    ["bioimageio resource description"] = 917,
    ...
    ["crowdin.yml"] = 212,
    ["ctfd-setup configuration file"] = 967,
    ["custom-elements.json"] = 889,
    ["cypress.json"] = 216,
    ...
    ["dockerd.json"] = 237,
    ["dotnet Release Index manifest"] = 249,
    ["dotnet-tools.json"] = 250,
    ["dotnetcli.host.json"] = 251,
    ["dprint.json"] = 252,
    ["drone.json"] = 253,
    ["dss-2.0.0.json"] = 255,
    ["dstack configuration"] = 256,
    ["dtool dataset metadata"] = 963,
    ["dvc.yaml"] = 257,
    ["ecosystem.json"] = 262,
    eksctl = 263,
    ["electron-builder configuration file"] = 270,
    ["epr-manifest.json"] = 268,
    ["evcc.yaml"] = 271,
    ["ezd task runner"] = 281,
    ["fabric.mod.json"] = 283,
    ["first-timers-bot"] = 289,
    ...
    ["gitlab-ci"] = 316,
    ["global.json"] = 331,
    ["go-feature-flag Flag Configuration"] = 334,
    ["haxelib.json"] = 349,
    helmfile = 773,
    helmwave = 774,
    ["host-meta.json"] = 354,
    ...
    ["ide.host.json"] = 361,
    ["ifstate.conf"] = 362,
    ["imageoptimizer.json"] = 363,
    ["importmap.json"] = 366,
    ["ioBroker Configuration"] = 368,
    ["ioBroker JSON UI"] = 369,
    ["ioBroker Package manifest"] = 370,
    ["ize.toml"] = 866,
    ["jsconfig.json"] = 394,
    ["jscpd Configuration"] = 851,
    jsdoc = 769,
    ["k3d.yaml"] = 395,
    ["k9s aliases.yaml"] = 397,
    ["k9s cluster-config.yaml"] = 399,
    ["k9s config.yaml"] = 398,
    ["k9s hotkeys.yaml"] = 400,
    ["k9s plugins.yaml"] = 401,
    ["k9s skin.yaml"] = 402,
    ["k9s views.yaml"] = 403,
    ["kontinuous-config.yaml"] = 411,
    ["kontinuous-values.yaml"] = 410,
    ["kustomization.yaml"] = 413,
    ["label-commenter-config.yml"] = 414,
    ["latexindent configuration"] = 62,
    ["launchsettings.json"] = 415,
    lazydocker = 888,
    lazygit = 887,
    ["lego.json"] = 417,
    ["lerna.json"] = 418,
    ["lgtm.yml"] = 419,
    ["liblab.config.json"] = 420,
    ["libman.json"] = 421,
    ["license-report-config.json"] = 422,
    ["linkinator.config.json"] = 424,
    ["lint-staged (.lintstagedrc)"] = 749,
    ["local.settings.json"] = 429,
    ["localazy.json"] = 430,
    ["lotus.yaml"] = 428,
    ["lsdlschema.json"] = 431,
    ["markdown-link-check"] = 810,
    mboats = 817,
    ["micro-settings.json"] = 881,
    ["mimetypes.json"] = 442,
    ["mirrord config"] = 750,
    mise = 751,
    ["mkdocs.yml"] = 462,
    ["monospace.yml"] = 464,
    ["moon.yml"] = 960,
    ["mprocs Configuration file"] = 933,
    ["mta.yaml"] = 752,
    ["mtad.yaml"] = 753,
    ["mycode.json"] = 471,
    ["napari plugin manifest"] = 472,
    neoload = 764,
    ["nest-cli"] = 477,
    ["ninjs (News in JSON)"] = 476,
    ["nitro.json"] = 763,
    ["nixd configuration"] = 905,
    ["nlu.json"] = 478,
    ["nodemon.json"] = 480,
    ["noodl config"] = 816,
    ["notebook.mod.json"] = 481,
    now = 759,
    ["npm-badges"] = 484,
    ["nswag.json"] = 488,
    ntangle = 490,
    ["nuclei-template.yaml"] = 485,
    ["nuget-project.json"] = 486,
    ["ocelot.json"] = 492,
    ["omnisharp.json"] = 496,
    ["openapi.json"] = 497,
    ["openfin.json"] = 504,
    ...
    ["ops.yaml"] = 501,
    ["package.json"] = 523,
    ["package.manifest"] = 524,
    ["partial-black.json"] = 92,
    ["pathfinder.yml"] = 527,
    ["pattern.json"] = 530,
    ["petstore-v1.0"] = 861,
    pgap_yaml_input_reader = 529,
    ["pixi.toml"] = 531,
    ["plagiarize-me.yaml"] = 535,
    ["plagiarize.yaml"] = 534,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 964,
    ["podbard.yaml"] = 537,
    ["portman.json"] = 538,
    ["prefect.toml"] = 546,
    ["prettierrc.json"] = 547,
    ["prisma.yml"] = 548,
    ["project-1.0.0-beta3.json"] = 551,
    ["project-1.0.0-beta4.json"] = 552,
    ["project-1.0.0-beta5.json"] = 553,
    ["project-1.0.0-beta6.json"] = 554,
    ["project-1.0.0-beta8.json"] = 555,
    ["project-1.0.0-rc1.json"] = 556,
    ["project-1.0.0-rc2.json"] = 557,
    ["project.json"] = 550,
    ["prometheus.json"] = 558,
    ["prometheus.rules.json"] = 559,
    ["prometheus.rules.test.json"] = 560,
    ["proxies.json"] = 561,
    ["publiccode.yml"] = 562,
    ["pubspec.yaml"] = 563,
    ["pyrseas-0.8.json"] = 566,
    ["quilt.mod.json"] = 882,
    ["rc3 auth"] = 575,
    ["rc3 collection"] = 576,
    ["rc3 environment"] = 577,
    ...
    samt = 599,
    samtrc = 600,
    ["sarif-1.0.0.json"] = 602,
    ["sarif-2.0.0.json"] = 603,
    ["sarif-2.1.0"] = 613,
    ["sarif-2.1.0-rtm.2"] = 604,
    ["sarif-2.1.0-rtm.3"] = 606,
    ["sarif-2.1.0-rtm.4"] = 608,
    ["sarif-2.1.0-rtm.5"] = 610,
    ["sarif-2.1.0-rtm.6"] = 611,
    ["sarif-external-property-file-2.1.0"] = 614,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 605,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 607,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 609,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 612,
    ["schema.org - Action"] = 616,
    ["schema.org - ContactPoint"] = 617,
    ["schema.org - Place"] = 618,
    ["schema.org - Thing"] = 619,
    ["secrethub.yml"] = 884,
    ["semantic-release"] = 625,
    ["servicehub.config.json"] = 744,
    ["servicehub.service.json"] = 743,
    ["settings.job"] = 628,
    ["sfdx-hardis configuration"] = 630,
    ["shard.yml"] = 920,
    ["size-limit configuration"] = 635,
    ["skaffold.yaml"] = 808,
    ["skyuxconfig.json"] = 637,
    snapcraft = 638,
    ["spicepod.yaml"] = 940,
    ["sqlc configuration"] = 649,
    ["stripe-app-local.json"] = 658,
    ["stripe-app.json"] = 657,
    swcrc = 794,
    ["task.json"] = 664,
    taskcat = 760,
    ["template.json"] = 669,
    ["templatsources.json"] = 670,
    ["theme.json"] = 673,
    ["tizen_workspace.json"] = 674,
    tldr = 675,
    tmuxinator = 747,
    ["transcend.yml"] = 682,
    ["tree-sitter grammar.json"] = 339,
    ["trime.yaml"] = 683,
    ["trunk.yaml"] = 685,
    ["ts-force-config.json"] = 690,
    ["tsconfig.json"] = 686,
    ["tsd.json"] = 687,
    ["tsdoc.json"] = 688,
    ["tsdrc.json"] = 689,
    ...
    ["vega-lite.json"] = 709,
    ["vega.json"] = 708,
    ["venvironment-basic.yaml"] = 712,
    ["venvironment.yaml"] = 711,
    ["version.json"] = 714,
    ["vhwdebugger-binding.yaml"] = 716,
    ["vim-addon-info"] = 717,
    ["vs-2017.3.host.json"] = 719,
    ["vs-nesting.json"] = 720,
    ["vsls.json"] = 718,
    ["vss-extension.json"] = 724,
    ["vtesttree.yaml"] = 725,
    ["vtestunit.yaml"] = 726,
    ["warp-keysets.json"] = 890,
    ["warp-themes.json"] = 891,
    ["warp-workflows.json"] = 892,
    ["webhint.io"] = 847,
    ["webjobpublishsettings.json"] = 731,
    ["webjobs-list.json"] = 730,
    ["well-known-fursona"] = 928,
    ["xs-app.json"] = 756,
    ["xunit.runner.json"] = 742,
    yamllint = 782,
    ["zerops.io import file"] = 937,
    ["zerops.yml"] = 936,
    zuul = 766,
    ["Žinoma"] = 776
  },
