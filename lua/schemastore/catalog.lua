...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 143,
    [".cryproj (generic)"] = 485,
    [".cryproj engine-5.2"] = 480,
    [".cryproj engine-5.3"] = 481,
    [".cryproj engine-5.4"] = 482,
    [".cryproj engine-5.5"] = 483,
    [".cryproj engine-dev"] = 484,
    [".csscomb.json"] = 145,
    [".csslintrc"] = 146,
    [".eslintrc"] = 190,
    [".esmrc.json"] = 182,
    ...
    [".mtaext"] = 494,
    [".nodehawkrc"] = 306,
    [".npmpackagejsonlintrc"] = 308,
    [".phraseapp.yml"] = 342,
    [".pmbot.yml"] = 334,
    [".postcssrc"] = 339,
    [".pre-commit-config.yml"] = 340,
    [".pre-commit-hooks.yml"] = 341,
    [".putout.json"] = 359,
    [".rehyperc"] = 365,
    [".remarkrc"] = 366,
    [".sprite files"] = 408,
    ...
    ["Azure Pipelines"] = 44,
    ["Azure Static Web Apps CLI configuration file"] = 410,
    ["Azure Static Web Apps configuration file"] = 409,
    ["BX CI"] = 75,
    ["Better Code Hub"] = 528,
    ["Better Scripts"] = 76,
    BizTalkServerApplicationSchema = 500,
    ...
    ["Butane Config"] = 565,
    ["CICS TS region tagging"] = 572,
    ["CICS TS resource import"] = 573,
    ["CICS TS resource model"] = 574,
    ["CICS TS resource overrides"] = 575,
    ["CMake Presets"] = 77,
    ...
    Conjure = 85,
    ["Container Structure Test"] = 511,
    Containerlab = 535,
    ["DWP Exchange - catalogue entry"] = 179,
    ["DWP Exchange - gateway"] = 177,
    ["DWP Exchange - meta"] = 178,
    ["Dart build configuration"] = 147,
    ["Dart test config"] = 148,
    ["DashLord configuration"] = 149,
    ["Datadog Service Definition"] = 263,
    ["Datahub Ingestion Recipe Schema"] = 579,
    ...
    ["Embrace Config Schema"] = 590,
    ["Error pages"] = 185,
    Esquio = 183,
    ["Estuary Flow Catalog Schema"] = 569,
    ["Expo SDK"] = 188,
    ["F-Droid Data metadata"] = 193,
    ["Facets - FSDL - Application"] = 191,
    ["Fossa configuration file"] = 198,
    ["Fossa's fossa-deps file"] = 199,
    ["Foundry VTT - Manifest"] = 196,
    ["Foundry VTT - Template"] = 197,
    ["Foxx Manifest"] = 45,
    ["GatewayCore API Gateway"] = 202,
    ["GeoJSON.json latest"] = 567,
    GherKing = 571,
    ["GitHub Action"] = 206,
    ["GitHub Funding"] = 207,
    ["GitHub Issue Template configuration"] = 209,
    ["GitHub Workflow"] = 210,
    ["GitHub Workflow Template Properties"] = 211,
    ["GitHub issue forms"] = 208,
    GitVersion = 205,
    ["Gitpod Configuration"] = 213,
    ["Global Privacy Control"] = 203,
    ["Google Cloud Workflows"] = 130,
    Goreleaser = 216,
    ["Goreleaser Pro"] = 217,
    ["Gradle Build Cache Node"] = 525,
    ["Gradle Enterprise"] = 524,
    ["Grafana 5.x Dashboard"] = 218,
    ["GraphQL Code Generator"] = 221,
    ["GraphQL Config"] = 220,
    ["GraphQL Mesh"] = 219,
    ["Grunt JSHint task"] = 225,
    ["Grunt Watch task"] = 226,
    ["Grunt base task"] = 227,
    ["Grunt clean task"] = 223,
    ["Grunt copy task"] = 222,
    ["Grunt cssmin task"] = 224,
    HEMTT = 497,
    Hadolint = 509,
    ["Hardware Sentry Configuration"] = 583,
    Hayson = 229,
    ["Haystack Pipeline"] = 230,
    ["Hazelcast 5 Configuration"] = 231,
    ["Helm Chart.lock"] = 106,
    ["Helm Chart.yaml"] = 105,
    Hugo = 561,
    ["Istanbul Schema"] = 586,
    ["JDownloader2 crawler multi-rule schema"] = 247,
    ["JDownloader2 crawler single-rule schema"] = 246,
    ["JFrog File Spec"] = 248,
    ["JFrog Pipelines YML DSL"] = 592,
    ["JSON Document Transform"] = 256,
    ["JSON Feed"] = 257,
    ["JSON Resume"] = 370,
    ["JSON Schema Draft 2020-12"] = 476,
    ["JSON Schema Draft 4"] = 473,
    ["JSON Schema Draft 7"] = 474,
    ["JSON Schema Draft 8"] = 475,
    ...
    ["JSON-API"] = 255,
    ["JSON-e templates"] = 533,
    ["JSON-stat 2.0"] = 470,
    JSONPatch = 259,
    Jasmine = 242,
    Jekyll = 243,
    ["Jenkins X Pipelines"] = 244,
    ["Jenkins X Requirements"] = 245,
    ["Jovo Language Models"] = 249,
    ["KSP-AVC"] = 471,
    ["KSP-CKAN"] = 472,
    ["Keycloak REST API"] = 598,
    ["Knative Functions - func.yaml"] = 200,
    ["KoDE/CI build.yaml"] = 588,
    ["Kong DBLess Schema"] = 589,
    KrakenD = 262,
    ["LinkML Metamodel"] = 274,
    Liquibase = 539,
    ["Liquibase Flow File"] = 540,
    Markdownlint = 543,
    ["MegaLinter configuration"] = 278,
    ["MegaLinter descriptor"] = 279,
    ["Meltano plugin discovery definition"] = 281,
    ["Meltano project definition"] = 280,
    ["Microsoft Band Web Tile"] = 282,
    ["Minecraft Data Pack Advancement"] = 284,
    ["Minecraft Data Pack Biome"] = 285,
    ["Minecraft Data Pack Configured Carver"] = 286,
    ["Minecraft Data Pack Dimension"] = 288,
    ["Minecraft Data Pack Dimension Type"] = 287,
    ["Minecraft Data Pack Item Modifier"] = 289,
    ["Minecraft Data Pack Loot Table"] = 290,
    ["Minecraft Data Pack Metadata"] = 291,
    ["Minecraft Data Pack Predicate"] = 292,
    ["Minecraft Data Pack Recipe"] = 293,
    ["Minecraft Data Pack Template Pool"] = 294,
    ["Minecraft Resourcepack Sounds"] = 295,
    ["MongoDB Atlas Search Index Definition Schema"] = 587,
    ["Monika Configuration Schema"] = 585,
    ["Motif config"] = 493,
    ["Netin Diagnostic System Template"] = 548,
    ["Netlify config schema"] = 300,
    ["Nightwatch.js"] = 301,
    ["OSS Review Toolkit configuration"] = 324,
    ["OSS Review Toolkit curation"] = 325,
    ["OSS Review Toolkit package configuration"] = 326,
    ["OSS Review Toolkit repository configuration"] = 327,
    ["OSS Review Toolkit resolutions"] = 328,
    Opctl = 496,
    ["OpenWeather Current Weather API"] = 532,
    ["OpenWeather Road Risk API"] = 531,
    ["Ory Hydra configuration"] = 235,
    ["Ory Keto configuration"] = 264,
    ["Ory Kratos configuration"] = 323,
    ["Ory Oathkeeper configuration"] = 314,
    ["Outblocks App configuration"] = 321,
    ["Outblocks database table"] = 322,
    ["Outblocks project configuration"] = 320,
    Packer = 331,
    ["Pipeline component"] = 541,
    ["PocketMine plugin.yml"] = 335,
    Pterodactyl = 582,
    ["Pull Request Labeler"] = 358,
    PyProject = 362,
    Qodana = 558,
    ["Quali Torque Blueprint Spec 2"] = 580,
    ["QueryFirst config file"] = 601,
    ["RKE Cluster Configuration JSON Schema"] = 538,
    ["RKE Cluster Configuration YAML Schema"] = 537,
    Ray = 508,
    ["Read the Docs"] = 361,
    ["Red-DiscordBot Cog"] = 363,
    ["Red-DiscordBot Cog Repo"] = 364,
    Renovate = 371,
    ["Replit schema"] = 367,
    RoadRunner = 372,
    ["Rust Project"] = 369,
    ["Rust toolchain"] = 374,
    ["SIL Kit Participant Configuration"] = 399,
    SWADL = 419,
    ["Sapphire CLI Config"] = 375,
    ["SauceCTL Configuration"] = 545,
    ["Schema Catalog"] = 388,
    ["Scoop manifest"] = 393,
    ["Semgrep Rule"] = 395,
    ["Serverless Framework Configuration"] = 552,
    ["Serverless Workflow Schema"] = 554,
    ["Settings.paf"] = 397,
    ["Shopware 6 Configuration"] = 555,
    ["Shopware CLI Extension Store Configuration"] = 556,
    ["Shopware CLI Project Store Configuration"] = 557,
    Solidarity = 403,
    ["Solution filters"] = 404,
    ["Source Maps v3"] = 405,
    SpecIF = 406,
    ["Sponge Mixin configuration"] = 407,
    ["StackHawk Scanner Configuration"] = 551,
    Stale = 411,
    Starship = 412,
    ["Statamic Blueprint"] = 413,
    ["StrmPrivacy Data Connector"] = 596,
    ["StrmPrivacy Data Contract"] = 597,
    ["StrmPrivacy SimpleSchema"] = 594,
    ["StrmPrivacy Stream"] = 595,
    ["StrmPrivacy batch job configuration file"] = 593,
    ["Stryker Mutator"] = 416,
    ["StyleCop Analyzers Configuration"] = 417,
    ["Swagger API 2.0"] = 420,
    TSON = 440,
    ["Talisman configuration"] = 421,
    ["Taskfile YAML Schema"] = 534,
    Taurus = 422,
    ["TestEnvironment.json"] = 429,
    Tikibase = 425,
    ["Traefik v2"] = 432,
    ["Traefik v2 File Provider"] = 433,
    Turborepo = 430,
    Tye = 559,
    ["UI5 Manifest"] = 446,
    ["UTAM Page Object"] = 448,
    ["Ubuntu Server Autoinstall"] = 444,
    ["Uniswap Token List"] = 517,
    ["Unreal Engine Uplugin"] = 602,
    ["Unreal Engine Uproject"] = 603,
    Updatecli = 566,
    Uplift = 600,
    ["User Journey Map YAML Schema"] = 536,
    V2Ray = 570,
    ["VSCode Code Snippets"] = 119,
    ["VSIX CLI publishing"] = 461,
    ["Vela Pipeline Configuration"] = 451,
    Vercel = 118,
    ["Web App Manifest"] = 466,
    ["Web types"] = 469,
    WebExtensions = 465,
    ["Webman package recipe"] = 576,
    ["Windows Package Manager Installer Manifest"] = 514,
    ["Windows Package Manager Locale Manifest"] = 515,
    ["Windows Package Manager Singleton Manifest"] = 513,
    ["Woodpecker pipeline config"] = 547,
    ["Xstate Machine Schema"] = 564,
    ["Yippee-Ki-JSON configuration YML"] = 519,
    ["angular.json"] = 10,
    ...
    ["ecosystem.json"] = 180,
    eksctl = 181,
    ["electron-builder configuration file."] = 186,
    ["epr-manifest.json"] = 184,
    ["evcc.yaml"] = 187,
    ["ezd schema"] = 189,
    ["fabric.mod.json"] = 192,
    ["first-timers-bot"] = 195,
    ["fly.io Schema"] = 46,
    fulibWorkflows = 546,
    ["function.json"] = 201,
    ["geojson.json"] = 204,
    ["gitlab-ci"] = 212,
    ["global.json"] = 214,
    ["golangci-lint Configuration"] = 215,
    ["haxelib.json"] = 228,
    helmfile = 510,
    ["host-meta.json"] = 233,
    ["host.json"] = 232,
    ...
    huskyrc = 488,
    ["ide.host.json"] = 236,
    ["imageoptimizer.json"] = 237,
    ["importmap.json"] = 239,
    ["ioBroker JSON UI"] = 240,
    ["ioBroker Package manifest"] = 241,
    ["ize.toml"] = 599,
    ["jsconfig.json"] = 260,
    ["jscpd Configuration Schema"] = 581,
    jsdoc = 507,
    ["k3d.yaml"] = 261,
    ["kustomization.yaml"] = 265,
    ["label-commenter-config.yml"] = 266,
    ["launchsettings.json"] = 267,
    ["lego.json"] = 268,
    ["lerna.json"] = 269,
    ["lgtm.yml"] = 270,
    ["libman.json"] = 271,
    ["license-report-config.json"] = 272,
    ["linkinator.config.json"] = 273,
    ["local.settings.json"] = 275,
    ["localazy.json"] = 276,
    ["lsdlschema.json"] = 277,
    ["markdown-lint-check"] = 544,
    mboats = 550,
    ["mimetypes.json"] = 283,
    ["mirrord-schema"] = 490,
    ["mta.yaml"] = 491,
    ["mtad.yaml"] = 492,
    ["mycode.json"] = 298,
    ["napari plugin manifest"] = 299,
    neoload = 502,
    ["nest-cli"] = 304,
    ["ninjs (News in JSON) 1.3"] = 303,
    ["ninjs (News in JSON) 2.0"] = 302,
    ["nlu.json"] = 305,
    ["nodemon.json"] = 307,
    ["noodl.schema.json"] = 549,
    now = 498,
    ["npm-badges"] = 309,
    ["nswag.json"] = 312,
    ntangle = 313,
    ["nuclei-template.yaml"] = 310,
    ["nuget-project.json"] = 311,
    ["ocelot.json"] = 315,
    ["omnisharp.json"] = 316,
    ["openapi.json"] = 317,
    ["openfin.json"] = 319,
    ["openrpc.json"] = 318,
    ["package.json"] = 329,
    ["package.manifest"] = 330,
    ["pattern.json"] = 333,
    ["petstore-v1.0"] = 591,
    pgap_yaml_input_reader = 332,
    ["plagiarize-me.yaml"] = 337,
    ["plagiarize.yaml"] = 336,
    ["portman.json"] = 338,
    ["prettierrc.json"] = 343,
    ["prisma.yml"] = 344,
    ["project-1.0.0-beta3.json"] = 346,
    ["project-1.0.0-beta4.json"] = 347,
    ["project-1.0.0-beta5.json"] = 348,
    ["project-1.0.0-beta6.json"] = 349,
    ["project-1.0.0-beta8.json"] = 350,
    ["project-1.0.0-rc1.json"] = 351,
    ["project-1.0.0-rc2.json"] = 352,
    ["project.json"] = 345,
    ["prometheus.json"] = 353,
    ["prometheus.rules.json"] = 354,
    ["proxies.json"] = 355,
    ["publiccode.yml"] = 356,
    ["pubspec.yaml"] = 357,
    ["pyrseas-0.8.json"] = 360,
    ["release drafter"] = 503,
    rustfmt = 373,
    ["sarif-1.0.0.json"] = 376,
    ["sarif-2.0.0.json"] = 377,
    ["sarif-2.1.0"] = 386,
    ["sarif-2.1.0-rtm.2"] = 378,
    ["sarif-2.1.0-rtm.3"] = 380,
    ["sarif-2.1.0-rtm.4"] = 382,
    ["sarif-2.1.0-rtm.5"] = 384,
    ["sarif-external-property-file-2.1.0"] = 387,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 379,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 381,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 383,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 385,
    ["schema.org - Action"] = 389,
    ["schema.org - ContactPoint"] = 390,
    ["schema.org - Place"] = 391,
    ["schema.org - Thing"] = 392,
    ["semantic-release"] = 394,
    ["servicehub.config.json"] = 479,
    ["servicehub.service.json"] = 478,
    ["settings.job"] = 396,
    ["sfdx-hardis configuration"] = 398,
    ["size-limit configuration"] = 400,
    ["skaffold.yaml"] = 542,
    ["skyuxconfig.json"] = 401,
    snapcraft = 402,
    ["stripe-app-local.json"] = 415,
    ["stripe-app.json"] = 414,
    swcrc = 530,
    taskcat = 499,
    ["template.json"] = 423,
    ["templatsources.json"] = 424,
    ["theme.json"] = 426,
    ["tizen_workspace.json"] = 427,
    tmLanguage = 428,
    tmuxinator = 487,
    ["trunk.yaml schema"] = 434,
    ["ts-force-config.json"] = 438,
    ["tsconfig.json"] = 435,
    ["tsd.json"] = 436,
    ["tsdrc.json"] = 437,
    ["tslint.json"] = 439,
    ...
    ["vega-lite.json"] = 450,
    ["vega.json"] = 449,
    ["venvironment-basic.yaml"] = 453,
    ["venvironment.yaml"] = 452,
    ["version.json"] = 454,
    ["vim-addon-info"] = 455,
    ["vs-2017.3.host.json"] = 457,
    ["vs-nesting.json"] = 458,
    ["vsls.json"] = 456,
    ["vss-extension.json"] = 462,
    ["webhint.io"] = 577,
    ["webjobpublishsettings.json"] = 468,
    ["webjobs-list.json"] = 467,
    ["xs-app.json"] = 495,
    ["xunit.runner.json"] = 477,
    yamllint = 518,
    zuul = 504,
    ["Žinoma"] = 512
  },
