...
M.json = {
  ...
  index = {
    ...
    [".pmbot.yml"] = 634,
    [".postcssrc"] = 643,
    [".powerpages-web-template-manifest"] = 645,
    [".pre-commit-config.yml"] = 646,
    [".pre-commit-hooks.yml"] = 647,
    [".putout.json"] = 682,
    [".rehyperc"] = 707,
    [".remarkrc"] = 711,
    [".sprite files"] = 802,
    ...
    AIConfig = 32,
    ["AMX Muse Program Descriptor"] = 1153,
    ["API Builder"] = 961,
    ["AVA Configuration"] = 1024,
    ...
    ["AWS Copilot Manifest"] = 1192,
    ["AWS SAM CLI Samconfig"] = 257,
    ["Adobe UXP Manifest"] = 1087,
    ["Aerleon Network & Service Definitions"] = 18,
    ["Aerleon Policy"] = 19,
    Aider = 1182,
    Air = 21,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1203,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1202,
    ["Airlock Microgateway"] = 33,
    ["Alacritty Configuration"] = 996,
    ["All Contributors configuration file"] = 1050,
    ...
    ["Application list for a WinUtil"] = 1132,
    ArchitectFX = 1137,
    ["Argo CD"] = 52,
    ["Argo Events"] = 53,
    ["Argo Workflows"] = 54,
    ...
    ["Azure IoT Operations Wasm Graph Config"] = 1201,
    ["Azure IoT Operations connector metadata"] = 1198,
    ...
    ["Azure Pipelines"] = 108,
    ["Azure Static Web Apps CLI configuration file"] = 806,
    ["Azure Static Web Apps configuration file"] = 805,
    BMML = 1220,
    ["BOSH CPI Config"] = 133,
    ["BOSH Deploy Config"] = 134,
    ["BX CI"] = 153,
    ["Bacon config"] = 3,
    ["Bashly (bashly.yml)"] = 1054,
    ["Bashly Settings (bashly-settings.yml)"] = 1055,
    Bento = 1219,
    ["Better Code Hub"] = 966,
    ["Better Scripts"] = 154,
    Bigconfig = 126,
    ["Biome Formatter Config"] = 80,
    ["Bitmovin Encoding Template"] = 1146,
    BizTalkServerApplicationSchema = 933,
    Bleep = 155,
    ["Block Protocol Metadata"] = 152,
    ["Bluebricks blueprint config"] = 1225,
    ["Boyka Framework"] = 135,
    Briefcase = 939,
    ["Build Info"] = 143,
    Buildkite = 145,
    ...
    ["Butane Config"] = 1009,
    C4InterFlow = 1161,
    ["CDK Environment Manager, concrete environment configuration"] = 1185,
    ["CDK Environment Manager, concrete environments definition"] = 1184,
    ["CDK Environment Manager, environment definition"] = 1183,
    ["CGS Card Game Specification (cgs.json)"] = 1092,
    ["CICS TS region tagging"] = 1018,
    ["CICS TS resource import"] = 1019,
    ["CICS TS resource model"] = 1020,
    ["CICS TS resource overrides"] = 1021,
    ["CMake Presets"] = 156,
    ["CNC Codes"] = 178,
    ["CRS WAF test file"] = 1122,
    ["CRS WAF test platform overrides file"] = 1123,
    ...
    ["Chamaleon environment"] = 1150,
    ["Chamaleon properties"] = 1151,
    ["Chamaleon template"] = 1149,
    Changepacks = 1212,
    Changesets = 266,
    Changie = 165,
    Charmcraft = 166,
    ...
    ["Clawject config"] = 184,
    ["Cloud Foundry Application Manifest"] = 1104,
    ["Cloud Run Spec v1"] = 1127,
    ...
    Concord = 1121,
    ["Configu .cfgu files"] = 1109,
    ["Configu .configu file"] = 1110,
    Conjure = 177,
    ["Container Structure Test"] = 947,
    Containerlab = 975,
    ["Contextive Glossary"] = 1177,
    Convex = 176,
    ["Crowdsec collection config"] = 276,
    ["Crowdsec parser config"] = 277,
    ["Crowdsec scenario config"] = 278,
    ["CumulusCI Config"] = 183,
    ["Custom Machinery Machine"] = 1093,
    ["Custom Machinery Recipe"] = 1094,
    ...
    ["DonateCaseBetterCasino menu"] = 1154,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 1062,
    ["EAS config"] = 345,
    ["ECA - Editor Code Assistant"] = 329,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1051,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1197,
    ["EasyVCR .NET"] = 346,
    ["Eidolon Resource"] = 1138,
    ...
    ["Erda Pipeline"] = 1100,
    ["Erda Runtime"] = 1101,
    ["Espanso config.yml"] = 1223,
    ["Espanso match.yml"] = 1222,
    Esquio = 334,
    ["Estuary Flow Catalog"] = 1015,
    ...
    ["Evolving Resolutive Process notation"] = 1199,
    ["Expo SDK"] = 344,
    ...
    ["GeoJSON.json latest"] = 1013,
    GherKing = 1017,
    ["GitHub Action"] = 379,
    ["GitHub Actions typing"] = 1134,
    ...
    ["Google Digital Assetlinks"] = 1178,
    Goreleaser = 407,
    ["Goreleaser Pro"] = 408,
    Goss = 409,
    ["Gradle Build Cache Node"] = 964,
    ["Gradle Enterprise"] = 963,
    ...
    Hadolint = 943,
    Hammerkit = 974,
    ["Hardware Sentry Configuration"] = 1029,
    ["HashiCorp Vault"] = 423,
    Hatch = 944,
    Hayson = 425,
    ["Haystack Pipeline"] = 426,
    ["Hazelcast 5 Configuration"] = 427,
    ["Hecate Input Schema"] = 1189,
    ["Helm Chart.lock"] = 220,
    ["Helm Chart.yaml"] = 219,
    ...
    ["JFrog File Spec"] = 460,
    ["JFrog Pipelines YML DSL"] = 1039,
    ["JMeter DSL cli config"] = 461,
    JReleaser = 464,
    ["JSON Document Transform"] = 472,
    ["JSON Feed"] = 473,
    ["JSON Resume"] = 717,
    ["JSON Schema Draft 2020-12"] = 911,
    ["JSON Schema Draft 4"] = 908,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1072,
    ["JSON Schema Draft 7"] = 909,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1073,
    ["JSON Schema Draft 8 (2019-09)"] = 910,
    ["JSON-API"] = 471,
    ["JSON-e templates"] = 971,
    ["JSON-stat 2.0"] = 904,
    JSONPatch = 475,
    ...
    ["Jujutsu (jj) VCS config"] = 1191,
    ["KIMMDY config file"] = 486,
    ["KODE/CI build.yaml"] = 1035,
    ["KSP-AVC"] = 905,
    ["KSP-CKAN"] = 906,
    ["KSP-NetKAN"] = 907,
    KSY = 1102,
    ...
    ["Metadata for a Cinnamon spice"] = 1130,
    ["Metatype Configuration"] = 526,
    ["MetricsHub Configuration"] = 527,
    ["MetricsHub Connector Configuration"] = 528,
    ["Micro Editor Syntax"] = 1063,
    ["Microsoft Band Web Tile"] = 529,
    ["Microsoft RulesEngine workflow rules"] = 1118,
    ["Microsoft RulesEngine workflow rules list"] = 1119,
    ["Minecraft Custom Main Menu Mod"] = 1081,
    ...
    ["MongoDB Atlas Search Index Definition"] = 1034,
    ["Monika Configuration"] = 1032,
    ["Monoweave Configuration"] = 555,
    ["Motif config"] = 925,
    MultiQC = 1171,
    ["NOX Framework (Service)"] = 576,
    ["Netin Diagnostic System Template"] = 991,
    ["Netlify config"] = 563,
    ...
    ["Nightwatch.js"] = 569,
    ["Node.js configuration"] = 930,
    ["NueJS configuration file"] = 581,
    ["Nuitka.yaml"] = 1095,
    ["Nullstone config"] = 583,
    ["ONe's changelog entry"] = 601,
    ["ONe's service descriptor"] = 600,
    ["ORT Server repository environment configuration"] = 610,
    ["OSCAL Assessment Plan (AP)"] = 612,
    ["OSCAL Assessment Results (AR)"] = 613,
    ["OSCAL Catalog"] = 614,
    ["OSCAL Component Definition (CDef)"] = 615,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 616,
    ["OSCAL Profile"] = 617,
    ["OSCAL System Security Plan (SSP)"] = 618,
    ["OSS Review Toolkit configuration"] = 619,
    ["OSS Review Toolkit curation"] = 620,
    ["OSS Review Toolkit package configuration"] = 621,
    ["OSS Review Toolkit repository configuration"] = 622,
    ["OSS Review Toolkit resolutions"] = 623,
    ...
    ["Ona Automations"] = 592,
    Opctl = 928,
    ["Open Data Contract Standard (ODCS)"] = 604,
    ["Open Data Product Standard (ODPS)"] = 605,
    ["Open Know-How"] = 1176,
    ...
    ["OpenUtau ustx"] = 598,
    ["OpenWeather Current Weather API"] = 970,
    ["OpenWeather Road Risk API"] = 969,
    ["Ory Hydra configuration"] = 434,
    ["Ory Keto configuration"] = 494,
    ["Ory Kratos configuration"] = 611,
    ["Ory Oathkeeper configuration"] = 585,
    ["Outblocks App configuration"] = 608,
    ["Outblocks database table"] = 609,
    ["Outblocks project configuration"] = 607,
    PDM = 630,
    POPxf = 640,
    ["POPxf Correlations"] = 641,
    Packer = 627,
    Pantsbuild = 1049,
    ["Paper paper-plugin.yml"] = 628,
    ["Pipeline component"] = 982,
    ["Platform.sh application"] = 5,
    ["Platform.sh routes"] = 6,
    ["Platform.sh services"] = 7,
    ["Plex Prerolls"] = 638,
    ["PocketMine plugin.yml"] = 635,
    ["Postman collection"] = 644,
    ["Power Pages Configuration"] = 1188,
    ["Preset list for a WinUtil"] = 1133,
    ["ProActions AI-Kit Configuration"] = 655,
    ["ProActions AI-Kit Configuration for Menus"] = 657,
    ["ProActions AI-Kit Configuration for Sections"] = 659,
    ["ProActions AI-Kit Configuration for Services"] = 656,
    ["ProActions AI-Kit Configuration for Steps"] = 660,
    ["ProActions AI-Kit Configuration for Templates"] = 658,
    ["Problem object RFC9457"] = 1078,
    ["Problem package format"] = 661,
    ["Problem package generators"] = 662,
    ["Problem package submissions"] = 663,
    ["Problem package test group metadata"] = 664,
    Pterodactyl = 1028,
    ["Pull Request Labeler"] = 681,
    Pulumi = 689,
    ["PyGTA Config"] = 685,
    PyProject = 690,
    Pylock = 1179,
    Pyright = 691,
    ["Python script metadata"] = 1173,
    ["QType AI DSL"] = 694,
    Qgoda = 693,
    Qodana = 1001,
    ["Qt Creator workspace file"] = 1111,
    ["Quali Torque Blueprint Spec 2"] = 1026,
    ["QueryFirst config file"] = 1045,
    ["RKE Cluster Configuration JSON"] = 979,
    ["RKE Cluster Configuration YAML"] = 978,
    RadioHound = 684,
    Railpack = 696,
    Railway = 695,
    ["Rancher Fleet"] = 686,
    ...
    Ray = 942,
    ["Read the Docs"] = 688,
    ["Red-DiscordBot Cog"] = 704,
    ["Red-DiscordBot Cog Repo"] = 705,
    ["Red-DiscordBot Trivia"] = 706,
    ["Releasaurus Config"] = 2,
    ["Render Blueprints"] = 977,
    RenderCV = 721,
    Renovate = 718,
    ["Renovate global configuration"] = 719,
    ["Renovate inherited configuration"] = 720,
    ["Replit config"] = 712,
    Restate = 1166,
    ["Revel Digital Gadget Definition File"] = 1190,
    RoadRunner = 723,
    ["Robust Station Image"] = 1196,
    Rockcraft = 724,
    ["Roo Coder Custom Modes"] = 725,
    Rubocop = 714,
    ["Rudder techniques"] = 1085,
    Ruff = 715,
    ["Rust Project"] = 716,
    ["Rust toolchain"] = 729,
    ["SDMX data message"] = 755,
    ["SDMX metadata message"] = 754,
    ["SDMX structure message"] = 753,
    ["SIL Kit Participant Configuration"] = 765,
    ["SIL Kit Registry Configuration"] = 766,
    ["SPDX 2.3"] = 803,
    SWADL = 819,
    ["Safebox Config"] = 1040,
    ["Sapphire CLI Config"] = 732,
    ["SauceCTL Configuration"] = 988,
    ["Schema Catalog"] = 747,
    ["Scoop manifest"] = 752,
    ["Semantic Data Fabric (SDF) file"] = 756,
    ["Semgrep Rule"] = 758,
    ["Serenity Code Generator (Sergen)"] = 759,
    ["Serverless Framework Configuration"] = 995,
    ["Serverless Workflow"] = 997,
    ["Settings for a Cinnamon spice"] = 1129,
    ["Settings.paf"] = 761,
    ["Shopware 6 Configuration"] = 998,
    ["Shopware CLI Extension Store Configuration"] = 999,
    ["Shopware CLI Project Store Configuration"] = 1000,
    ["Sigma Detection Rule"] = 763,
    ["Sigrid scope configuration file"] = 764,
    ["SkyPilot Task JSON"] = 1086,
    ["Slack app manifest"] = 768,
    Snapcraft = 770,
    Solidarity = 773,
    ["Solution filters"] = 774,
    ["Source Maps v3"] = 775,
    Sourcery = 776,
    ["Spack bootstrap.yaml"] = 777,
    ["Spack cdash.yaml"] = 778,
    ["Spack ci.yaml"] = 779,
    ["Spack compilers.yaml"] = 780,
    ["Spack concretizer.yaml"] = 781,
    ["Spack config.yaml"] = 782,
    ["Spack definitions.yaml"] = 783,
    ["Spack develop.yaml"] = 784,
    ["Spack env_vars.yaml"] = 785,
    ["Spack environment"] = 791,
    ["Spack include.yaml"] = 786,
    ["Spack mirrors.yaml"] = 787,
    ["Spack modules.yaml"] = 788,
    ["Spack packages.yaml"] = 789,
    ["Spack repos.yaml"] = 790,
    ["Spack toolchains.yaml"] = 792,
    ["Spack upstreams.yaml"] = 793,
    ["Spack view.yaml"] = 794,
    ["Speakeasy Generation Config File"] = 798,
    ["Speakeasy Lint Configuration File"] = 795,
    ["Speakeasy Test Generation Configuration File"] = 796,
    ["Speakeasy Workflow File"] = 797,
    SpecIF = 799,
    ["Specmatic Configuration"] = 800,
    ["Sponge Mixin configuration"] = 801,
    StackBlitz = 807,
    ["StackHawk Scanner Configuration"] = 994,
    Stale = 808,
    Starfish = 809,
    ["Starlake Data Pipeline"] = 967,
    Starship = 810,
    ["Statamic Blueprint"] = 811,
    ["Stella configuration file"] = 812,
    ["Streamlit configuration file"] = 813,
    ["Stryker Mutator"] = 816,
    ["StyleCop Analyzers Configuration"] = 817,
    ["Stylelint (.stylelintrc)"] = 818,
    ["Stylua Config"] = 1180,
    ["Sublime Syntax"] = 1041,
    ["Subsquid squid manifest"] = 1088,
    ["Swagger API 2.0"] = 820,
    ["Synadia Connect Component"] = 821,
    TSON = 857,
    TSTyche = 858,
    ["TYPO3 Vendor Bundler config"] = 863,
    ["Tab data for a LinUtil"] = 1136,
    ["Tab list for a LinUtil"] = 1135,
    Tach = 822,
    ["Tach Domain"] = 823,
    Talhelper = 825,
    ["Talisman configuration"] = 826,
    Taplo = 1181,
    ["Taskfile config"] = 972,
    Taurus = 827,
    Tauticord = 828,
    ["Tekton Pipeline"] = 1209,
    ["Tekton PipelineRun"] = 1210,
    ["Tekton Task"] = 1207,
    ["Tekton TaskRun"] = 1208,
    Telefonistka = 1167,
    ["Terrateam config"] = 1193,
    ["TestEnvironment.json"] = 840,
    ["TextMate Grammar"] = 839,
    Threagile = 834,
    ["Tier.run pricing.json"] = 831,
    Tikibase = 832,
    Tombi = 837,
    ["Traefik v2"] = 843,
    ["Traefik v2 File Provider"] = 844,
    ["Traefik v3"] = 845,
    ["Traefik v3 File Provider"] = 846,
    ["Travis CI (.travis.yml)"] = 842,
    Treefmt = 412,
    Trident = 1163,
    ["TrueScript for *.tscript files"] = 849,
    ["Tugboat QA config.yml"] = 1160,
    TunnelHub = 1076,
    Turborepo = 841,
    Tycho = 1125,
    Tye = 1002,
    ["Tyk Gateway - Open Source v5.7+"] = 1172,
    ["UET BuildConfig.json"] = 1046,
    ["UI5 Manifest"] = 869,
    ["UNCORS configuration"] = 873,
    ["UTAM Page Object"] = 872,
    ["Ubuntu Server Autoinstall"] = 867,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1164,
    ["Uniswap Token List"] = 954,
    ["Universal Schedule Format"] = 874,
    ["Unreal Engine Uplugin"] = 1047,
    ["Unreal Engine Uproject"] = 1048,
    ["UpCloud CLI (upctl) configuration"] = 1165,
    ["Updatecli Compose"] = 1010,
    ["Updatecli Policy Manifest"] = 1011,
    ["Updatecli Policy Metadata"] = 1012,
    Uplift = 1044,
    ["Upsun config"] = 4,
    ["User Journey Map"] = 976,
    V2Ray = 1016,
    ["VSCode Code Snippets"] = 241,
    ["VSIX CLI publishing"] = 892,
    Vector = 876,
    ["Vela Pipeline Configuration"] = 879,
    Vercel = 240,
    ["Version Bumper config"] = 882,
    Vespertide = 1214,
    ["Vespertide Migration"] = 1215,
    ["Vespertide Model"] = 1216,
    ["Viash Component Config"] = 1169,
    ["Viash Package Config"] = 1170,
    Visivo = 1074,
    ["WP-CLI"] = 902,
    Wake = 1162,
    ["Waku Config"] = 1139,
    ["Web App Manifest"] = 898,
    ["Web types"] = 901,
    WebExtensions = 897,
    ["Webman package recipe"] = 1022,
    ["Windows Package Manager Installer Manifest"] = 950,
    ["Windows Package Manager Locale Manifest"] = 951,
    ["Windows Package Manager Singleton Manifest"] = 949,
    Winutil = 952,
    ["WireMock CLI import configuration"] = 1145,
    ["WireMock CLI local service configuration"] = 1144,
    ["WireMock message stub mapping"] = 1143,
    ["WireMock stub mapping"] = 1142,
    ["Woodpecker pipeline config"] = 990,
    ["Wrangler CLI"] = 903,
    ["Xstate Machine"] = 1008,
    ["Yandex Workflow Language"] = 1131,
    ["Yarn Config (.yarnrc.yml)"] = 965,
    ["Yippee-Ki-JSON configuration YML"] = 956,
    ["YouTrack App"] = 1128,
    ["Zarf Package Configuration"] = 1195,
    ["Zerops.io config"] = 1116,
    ["Zerops.io import"] = 1117,
    ["Zola Configuration"] = 1206,
    ["aerleon.yml"] = 17,
    ["amplify.yml"] = 10,
    ["angular.json"] = 34,
    apko = 1079,
    ...
    ["behat.yml"] = 136,
    ["bigquery-table"] = 125,
    ["bioimageio resource description"] = 1096,
    ...
    ["chutzpah.json"] = 249,
    cibuildwheel = 171,
    ["clang-format (.clang-format)"] = 1014,
    ["clang-tidy"] = 227,
    clangd = 226,
    clib = 228,
    ...
    ["crowdin.yml"] = 275,
    ["ctfd-setup configuration file"] = 1152,
    ["custom-elements.json"] = 1066,
    ["cypress.json"] = 279,
    ...
    ["gematik health care insurance list"] = 1158,
    ["gematik health care patient list"] = 1155,
    ["gematik health care provider institution list"] = 1157,
    ["gematik health care provider list"] = 1156,
    ["gematik tiger test environment configuration"] = 1159,
    ["git-town.toml"] = 1204,
    ["gitlab-ci"] = 387,
    ["global.json"] = 403,
    ...
    ["lint-staged (.lintstagedrc)"] = 919,
    ["local.settings.json"] = 514,
    ["localazy.json"] = 515,
    ["lotus.yaml"] = 513,
    ["lsdlschema.json"] = 516,
    ["macro.json"] = 1031,
    ["markdown-link-check"] = 985,
    maturin = 986,
    mboats = 993,
    ["micro-settings.json"] = 1058,
    ["mimetypes.json"] = 530,
    ["mirrord config"] = 921,
    mise = 922,
    ["mkdocs.yml"] = 550,
    ...
    ["monospace.yml"] = 554,
    ["moon.yml"] = 1141,
    ["mprocs Configuration file"] = 1112,
    ["mrdocs.yml"] = 551,
    ["mta.yaml"] = 923,
    ["mtad.yaml"] = 924,
    ["mycode.json"] = 561,
    ...
    oxlint = 1228,
    ["package.json"] = 624,
    ["package.manifest"] = 626,
    ["package.yaml"] = 625,
    ["partial-black.json"] = 137,
    ["pathfinder.yml"] = 629,
    ["pattern.json"] = 632,
    ["petstore-v1.0"] = 1038,
    pgap_yaml_input_reader = 631,
    pgxgen = 1221,
    pitcms = 1224,
    ["pixi.toml"] = 633,
    ["plagiarize-me.yaml"] = 637,
    ["plagiarize.yaml"] = 636,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1148,
    ["podbard.yaml"] = 639,
    ["portman.json"] = 642,
    ["prefect.toml"] = 650,
    ["prefect.yaml"] = 651,
    ...
    ["prettierrc.json"] = 653,
    ["prisma.yml"] = 654,
    ["project-1.0.0-beta3.json"] = 666,
    ["project-1.0.0-beta4.json"] = 667,
    ["project-1.0.0-beta5.json"] = 668,
    ["project-1.0.0-beta6.json"] = 669,
    ["project-1.0.0-beta8.json"] = 670,
    ["project-1.0.0-rc1.json"] = 671,
    ["project-1.0.0-rc2.json"] = 672,
    ["project.json"] = 665,
    ["project.owasp.yaml"] = 673,
    ["prometheus-alertmanager.json"] = 677,
    ["prometheus.json"] = 674,
    ["prometheus.rules.json"] = 675,
    ["prometheus.rules.test.json"] = 676,
    ["proxies.json"] = 678,
    ["publiccode.yml"] = 679,
    ["pubspec.yaml"] = 680,
    ["pyrseas-0.8.json"] = 683,
    pytest = 692,
    ["quilt.mod.json"] = 1059,
    ["rc3 auth"] = 698,
    ["rc3 collection"] = 699,
    ...
    ["release drafter"] = 937,
    ["release-hub.json"] = 1,
    ["release-please-config.json"] = 708,
    ["release-please-manifest.json"] = 709,
    ["release-plz.toml"] = 710,
    ["renv.lock"] = 722,
    ["rivet.json"] = 1083,
    ["rivet.yaml (legacy)"] = 1082,
    rumdl = 727,
    runny = 726,
    rustfmt = 728,
    sake = 1175,
    samt = 730,
    samtrc = 731,
    ["sarif-1.0.0.json"] = 733,
    ["sarif-2.0.0.json"] = 734,
    ["sarif-2.1.0"] = 744,
    ["sarif-2.1.0-rtm.2"] = 735,
    ["sarif-2.1.0-rtm.3"] = 737,
    ["sarif-2.1.0-rtm.4"] = 739,
    ["sarif-2.1.0-rtm.5"] = 741,
    ["sarif-2.1.0-rtm.6"] = 742,
    ["sarif-external-property-file-2.1.0"] = 745,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 736,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 738,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 740,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 743,
    ["scalingo.json configuration"] = 746,
    ["schema.org - Action"] = 748,
    ["schema.org - ContactPoint"] = 749,
    ["schema.org - Place"] = 750,
    ["schema.org - Thing"] = 751,
    ["secrethub.yml"] = 1061,
    ["semantic-release"] = 757,
    ["servicehub.config.json"] = 914,
    ["servicehub.service.json"] = 913,
    ["settings.job"] = 760,
    ["sfdx-hardis configuration"] = 762,
    ["shard.yml"] = 1099,
    ["size-limit configuration"] = 767,
    ["skaffold.yaml"] = 983,
    ["skyuxconfig.json"] = 769,
    ["snowflake-config"] = 771,
    ["snowflake-connections"] = 772,
    ["spicepod.yaml"] = 1120,
    ["sqlc configuration"] = 804,
    ["stripe-app-local.json"] = 815,
    ["stripe-app.json"] = 814,
    swcrc = 968,
    ["task.json"] = 824,
    taskcat = 932,
    ["template.json"] = 829,
    ["templatsources.json"] = 830,
    ["text2confl config"] = 1229,
    ["theme.json"] = 833,
    ["tizen_workspace.json"] = 835,
    tldr = 836,
    ["tm_devices configuration file"] = 1186,
    tmuxinator = 917,
    tox = 838,
    ["transcend.yml"] = 847,
    ...
    ["vega-lite.json"] = 878,
    ["vega.json"] = 877,
    ["venvironment.yaml"] = 880,
    ["venvplus.yaml"] = 881,
    version = 1168,
    ["version.json"] = 883,
    ["vhwdebugger-binding.yaml"] = 885,
    ["vim-addon-info"] = 886,
    ["vs-2017.3.host.json"] = 888,
    ["vs-nesting.json"] = 889,
    ["vsls.json"] = 887,
    ["vss-extension.json"] = 893,
    vtcfg = 1174,
    ["vtesttree.yaml"] = 894,
    ["vtestunit.yaml"] = 895,
    ["warp-keysets.json"] = 1067,
    ["warp-themes.json"] = 1068,
    ["warp-workflows.json"] = 1069,
    ["webhint.io"] = 1023,
    ["webjobpublishsettings.json"] = 900,
    ["webjobs-list.json"] = 899,
    ["well-known-fursona"] = 1107,
    ["xs-app.json"] = 927,
    ["xunit.runner.json"] = 912,
    yamllint = 955,
    zizmor = 1211,
    zuul = 938,
    ["Žinoma"] = 948
