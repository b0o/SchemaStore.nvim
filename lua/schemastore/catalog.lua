...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 719,
    [".nodehawkrc"] = 462,
    [".npmpackagejsonlintrc"] = 466,
    [".omletrc"] = 894,
    [".phrase.yml"] = 513,
    [".phraseapp.yml"] = 514,
    [".pmbot.yml"] = 503,
    [".postcssrc"] = 508,
    [".powerpages-web-template-manifest"] = 510,
    [".pre-commit-config.yml"] = 511,
    [".pre-commit-hooks.yml"] = 512,
    [".putout.json"] = 533,
    [".rehyperc"] = 552,
    [".remarkrc"] = 554,
    [".sprite files"] = 616,
    ...
    ["<div>RIOTS' studio configuration"] = 691,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 416,
    ABCSupplyPlan = 13,
    AIConfig = 14,
    ["API Builder"] = 751,
    ["AVA Configuration"] = 811,
    ["AWS CDK cdk.json"] = 184,
    ["AWS CloudFormation"] = 185,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 186,
    ["AWS SAM CLI Samconfig"] = 187,
    ["Adobe UXP Manifest"] = 876,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 15,
    ["Airplane task"] = 16,
    ["Alacritty Configuration"] = 783,
    ["All Contributors configuration file"] = 841,
    ["Ansible Argument Specs"] = 313,
    ["Ansible Collection Galaxy"] = 320,
    ["Ansible Execution Environment"] = 310,
    ["Ansible Inventory"] = 319,
    ["Ansible Meta"] = 311,
    ["Ansible Meta Runtime"] = 312,
    ["Ansible Navigator Configuration"] = 322,
    ["Ansible Playbook"] = 317,
    ["Ansible Requirements"] = 314,
    ["Ansible Rulebook"] = 318,
    ["Ansible Tasks File"] = 316,
    ["Ansible Vars File"] = 315,
    ["Ansible-lint Configuration"] = 321,
    Any = 903,
    ...
    ["Azure Pipelines"] = 60,
    ["Azure Static Web Apps CLI configuration file"] = 619,
    ["Azure Static Web Apps configuration file"] = 618,
    ["BX CI"] = 99,
    ["Bashly (bashly.yml)"] = 845,
    ["Bashly Settings (bashly-settings.yml)"] = 846,
    ["Better Code Hub"] = 755,
    ["Better Scripts"] = 100,
    Bigconfig = 77,
    BizTalkServerApplicationSchema = 725,
    Bleep = 101,
    ["Block Protocol Metadata"] = 98,
    ["Boyka Framework"] = 84,
    Briefcase = 730,
    ["Build Info"] = 91,
    Buildkite = 93,
    ["Bukkit plugin.yml"] = 92,
    ["BungeeCord plugin.yml"] = 96,
    ["Butane Config"] = 796,
    ["CGS Custom Card Game (CardGameDef.json)"] = 881,
    ["CICS TS region tagging"] = 805,
    ["CICS TS resource import"] = 806,
    ["CICS TS resource model"] = 807,
    ["CICS TS resource overrides"] = 808,
    ["CMake Presets"] = 102,
    ["CNC Codes"] = 116,
    ["CRS WAF test file"] = 910,
    ["CRS WAF test platform overrides file"] = 911,
    ["CSS Comb (.csscomb.json)"] = 211,
    ["CSS Lint (.csslintrc)"] = 212,
    ["CSpell (cspell.json)"] = 210,
    ["CVE Record Format"] = 122,
    CWL = 887,
    ["Cache Warmup config"] = 103,
    ["Calqulus pipeline"] = 104,
    ["Camel YAML DSL"] = 105,
    Carafe = 106,
    ["Cargo Make"] = 108,
    ["Cargo Manifest"] = 107,
    ["Catalog Info Backstage"] = 109,
    Changesets = 196,
    Cheatsheets = 793,
    ["Chrome Extension"] = 177,
    ["Chromia Model"] = 110,
    ["CircleCI config.yml"] = 153,
    ["Citation File Format"] = 198,
    CityJSON = 112,
    ["Clawject config"] = 121,
    ["Cloud Foundry Application Manifest"] = 893,
    ["CloudEvents specification"] = 113,
    ["Code Climate"] = 154,
    CodeCV = 55,
    CodeRabbit = 54,
    ["CodeShip Pro services configuration files"] = 166,
    ["CodeShip Pro steps configuration files"] = 167,
    ["Codecov configuration files"] = 165,
    CodifyCLI = 56,
    Codux = 163,
    ["Cog config file"] = 117,
    ["Commandbox Box.json"] = 118,
    ["Commandbox Server.json"] = 119,
    ["Common Catalog Data"] = 175,
    Concord = 909,
    ["Configu .cfgu files"] = 898,
    ["Configu .configu file"] = 899,
    Conjure = 115,
    ["Container Structure Test"] = 738,
    Containerlab = 763,
    ["Crowdsec collection config"] = 205,
    ["Crowdsec parser config"] = 206,
    ["Crowdsec scenario config"] = 207,
    ["CumulusCI Config"] = 120,
    ["Custom Machinery Machine"] = 882,
    ["Custom Machinery Recipe"] = 883,
    ["Cycle Stack File"] = 123,
    ["DWP Exchange - catalogue entry"] = 253,
    ["DWP Exchange - gateway"] = 251,
    ["DWP Exchange - meta"] = 252,
    ["Dart Build Config (dart-build.json)"] = 213,
    ["Dart Test Config (dart-test.json)"] = 214,
    ["DashLord Configuration"] = 215,
    ["Data Contract Specification"] = 216,
    ["Data Product Specification"] = 217,
    ["DataYoga Connections"] = 124,
    ["DataYoga Job"] = 125,
    ["Databricks Asset Bundles"] = 862,
    ["Datadog Service Definition"] = 391,
    ["Datadog Software Catalog"] = 392,
    ["Datahub Ingestion Recipe"] = 812,
    ["Dein Config"] = 131,
    ["Deno Config (deno.json)"] = 223,
    ["Dependency cruiser"] = 132,
    ["Deployer Recipe"] = 226,
    ["Deta Spacefile"] = 133,
    ["Detekt Config (detekt.yml)"] = 227,
    ["Devbox Config"] = 134,
    ["Devbox Plugin"] = 135,
    Devfile = 250,
    DipDup = 912,
    ["Discord Webhook"] = 228,
    ["DocFx Config (docfx.json)"] = 232,
    ["Dolittle Artifacts"] = 233,
    ["Dolittle Bounded Context Configuration"] = 234,
    ["Dolittle Event Horizons Configuration"] = 235,
    ["Dolittle Resources Configuration"] = 236,
    ["Dolittle Server Configuration"] = 237,
    ["Dolittle Tenant Map Configuration"] = 239,
    ["Dolittle Tenants Configuration"] = 238,
    ["Dolittle Topology"] = 240,
    ["Drupal Breakpoints"] = 136,
    ["Drupal Config"] = 148,
    ["Drupal Info"] = 137,
    ["Drupal Layouts"] = 138,
    ["Drupal Libraries"] = 139,
    ["Drupal Links Action"] = 140,
    ["Drupal Links Contextual"] = 141,
    ["Drupal Links Menu"] = 142,
    ["Drupal Links Task"] = 143,
    ["Drupal Migration"] = 144,
    ["Drupal Permissions"] = 145,
    ["Drupal Recipe"] = 146,
    ["Drupal Routing"] = 147,
    ["Drupal Services"] = 149,
    ["Drush site aliases"] = 246,
    ["Dynamic Bash Aliases (.aliases)"] = 853,
    ["EAS config"] = 271,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 842,
    ...
    ["Error pages"] = 261,
    Esquio = 259,
    ["Estuary Flow Catalog"] = 802,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 264,
    ["EveryVoice TTS Toolkit Data Configuration"] = 265,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 269,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 268,
    ["EveryVoice TTS Toolkit Text Configuration"] = 266,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 267,
    ["Expo SDK"] = 270,
    ["F-Droid Data metadata"] = 276,
    ["Facets - FSDL - Application"] = 274,
    ["FasterCI Configuration"] = 61,
    FiQuS = 280,
    Firebase = 278,
    ["Flow.json Configurations"] = 886,
    ["Fossa configuration file"] = 287,
    ["Fossa's fossa-deps file"] = 288,
    ["Foundry VTT - Base package Manifest"] = 282,
    ["Foundry VTT - Module Manifest"] = 283,
    ["Foundry VTT - System Data Template"] = 286,
    ["Foundry VTT - System Manifest"] = 284,
    ["Foundry VTT - World Manifest"] = 285,
    ["Foxx Manifest"] = 62,
    ["Freifunk.de Community API"] = 65,
    ["Frogbot Config"] = 66,
    ["G2P Mapping Configuration"] = 292,
    ["GCP Blueprint Metadata"] = 295,
    Gaspar = 293,
    ["GatewayCore API Gateway"] = 294,
    ["GeoJSON.json latest"] = 800,
    GherKing = 804,
    ["GitHub Action"] = 300,
    ["GitHub Discussion"] = 301,
    ["GitHub Funding"] = 302,
    ["GitHub Issue Template configuration"] = 304,
    ["GitHub Issue Template forms"] = 303,
    ["GitHub Workflow"] = 305,
    ["GitHub Workflow Template Properties"] = 306,
    ["GitHub automatically generated release notes configuration"] = 307,
    ["GitLab Agent for Kubernetes configuration"] = 878,
    GitVersion = 297,
    ["Gitea Issue Template configuration"] = 298,
    ["Gitea Issue Template forms"] = 299,
    ["Gitpod Configuration"] = 309,
    ["GlazeWM settings"] = 880,
    ["Global Privacy Control"] = 296,
    Goblet = 861,
    ["Golangci-lint Configuration"] = 324,
    ["Golangci-lint Custom Plugins Configuration"] = 325,
    ["Google Chrome Related Website Sets"] = 279,
    ["Google Cloud Workflows"] = 183,
    Goreleaser = 327,
    ["Goreleaser Pro"] = 328,
    Goss = 329,
    ["Gradle Build Cache Node"] = 753,
    ["Gradle Enterprise"] = 752,
    ["Grafana 5.x Dashboard"] = 330,
    ["GraphQL Code Generator"] = 334,
    ["GraphQL Config"] = 333,
    ["GraphQL Mesh"] = 332,
    ["Grunt JSHint task"] = 338,
    ["Grunt Watch task"] = 339,
    ["Grunt base task"] = 340,
    ["Grunt clean task"] = 336,
    ["Grunt copy task"] = 335,
    ["Grunt cssmin task"] = 337,
    HEMTT = 722,
    Hadolint = 734,
    Hammerkit = 762,
    ["Hardware Sentry Configuration"] = 816,
    Hatch = 735,
    Hayson = 342,
    ["Haystack Pipeline"] = 343,
    ["Hazelcast 5 Configuration"] = 344,
    ["Helm Chart.lock"] = 151,
    ["Helm Chart.yaml"] = 150,
    ["Helm Unittest Test Suite"] = 152,
    Hugo = 792,
    ["Hugo Theme"] = 791,
    ["Hyperfoil benchmark configuration"] = 350,
    ["IBM Zapp document"] = 351,
    ["IBM zCodeFormatSettings"] = 352,
    ["IMG Catapult PSP"] = 357,
    ["IVMS101 by CODE Protocol"] = 879,
    Infrahub = 359,
    Istanbul = 819,
    ["JDownloader2 crawler multi-rules"] = 368,
    ["JDownloader2 crawler single-rules"] = 367,
    ["JFrog Applications Config"] = 369,
    ["JFrog File Spec"] = 370,
    ["JFrog Pipelines YML DSL"] = 825,
    ["JMeter DSL cli config"] = 371,
    JReleaser = 373,
    ["JSON Document Transform"] = 381,
    ["JSON Feed"] = 382,
    ["JSON Resume"] = 559,
    ["JSON Schema Draft 2020-12"] = 704,
    ["JSON Schema Draft 4"] = 701,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 863,
    ["JSON Schema Draft 7"] = 702,
    ["JSON Schema Draft 7 (unofficial strict)"] = 864,
    ["JSON Schema Draft 8 (2019-09)"] = 703,
    ["JSON-API"] = 380,
    ["JSON-WF"] = 892,
    ["JSON-e templates"] = 760,
    ["JSON-stat 2.0"] = 698,
    JSONPatch = 384,
    ["JSR Package Config (jsr.json)"] = 374,
    Jasmine = 363,
    Jekyll = 364,
    ["Jenkins X Pipelines"] = 365,
    ["Jenkins X Requirements"] = 366,
    ["Jovo Language Models"] = 372,
    ["KIMMDY config file"] = 389,
    ["KSP-AVC"] = 699,
    ["KSP-CKAN"] = 700,
    KSY = 891,
    ["Karakum configuration file"] = 289,
    Kas = 387,
    ["Keycloak REST API"] = 833,
    ["Knative Functions - func.yaml"] = 290,
    ["KoDE/CI build.yaml"] = 821,
    ["Kong DBLess config"] = 822,
    KrakenD = 390,
    ["Kubri Configuration"] = 396,
    LOOBin = 411,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 188,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 189,
    ["Landing Zone Accelerator on AWS - Global Config"] = 190,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 191,
    ["Landing Zone Accelerator on AWS - Network Config"] = 192,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 193,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 194,
    ["Landing Zone Accelerator on AWS - Security Config"] = 195,
    ["Language configuration"] = 902,
    Lefthook = 400,
    ["Liferay client-extension.yaml"] = 407,
    ["LinkML Metamodel"] = 409,
    Liquibase = 768,
    ["Liquibase Flow File"] = 769,
    ["Lively Properties"] = 410,
    ["Lobe AI Agent"] = 58,
    Loki = 59,
    ["MLOS Configs"] = 446,
    ["MS2Rescore Configuration"] = 449,
    ["Madness (madness.yml)"] = 844,
    Markdownlint = 772,
    ["Mason Registry"] = 774,
    ["MegaLinter configuration"] = 417,
    ["MegaLinter descriptor"] = 418,
    Melange = 870,
    ["Meltano plugin discovery definition"] = 420,
    ["Meltano project definition"] = 419,
    ["Mergify Configuration"] = 450,
    ["Metadata for a Bazel module"] = 421,
    ["MetricsHub Configuration"] = 422,
    ["MetricsHub Connector Configuration"] = 423,
    ["Micro Editor Syntax"] = 854,
    ["Microsoft Band Web Tile"] = 424,
    ["Microsoft RulesEngine workflow rules"] = 906,
    ["Microsoft RulesEngine workflow rules list"] = 907,
    ["Minecraft Custom Main Menu Mod"] = 871,
    ["Minecraft Data Pack Advancement"] = 426,
    ["Minecraft Data Pack Biome"] = 427,
    ["Minecraft Data Pack Configured Carver"] = 428,
    ["Minecraft Data Pack Damage Type"] = 429,
    ["Minecraft Data Pack Dimension"] = 431,
    ["Minecraft Data Pack Dimension Type"] = 430,
    ["Minecraft Data Pack Item Modifier"] = 432,
    ["Minecraft Data Pack Loot Table"] = 433,
    ["Minecraft Data Pack Metadata"] = 434,
    ["Minecraft Data Pack Predicate"] = 435,
    ["Minecraft Data Pack Recipe"] = 436,
    ["Minecraft Data Pack Tag"] = 437,
    ["Minecraft Data Pack Template Pool"] = 438,
    ["Minecraft Data Pack Trim Material"] = 443,
    ["Minecraft Data Pack Trim Pattern"] = 444,
    ["Minecraft Resource Pack Lang"] = 439,
    ["Minecraft Resource Pack Particle"] = 440,
    ["Minecraft Resource Pack Texture Mcmeta"] = 442,
    ["Minecraft Resourcepack Sounds"] = 441,
    ["Monade CLI Stack Configuration"] = 453,
    ["MongoDB Atlas Search Index Definition"] = 820,
    ["Monika Configuration"] = 818,
    ["Monoweave Configuration"] = 448,
    ["Motif config"] = 718,
    ["NOX Framework (Service)"] = 465,
    ["Netin Diagnostic System Template"] = 778,
    ["Netlify config"] = 456,
    ["Network-as-Code Data Model"] = 457,
    ["Nightwatch.js"] = 458,
    ["Nuitka.yaml"] = 884,
    ["ONe's changelog entry"] = 481,
    ["ONe's service descriptor"] = 480,
    ["OSS Review Toolkit configuration"] = 489,
    ["OSS Review Toolkit curation"] = 490,
    ["OSS Review Toolkit package configuration"] = 491,
    ["OSS Review Toolkit repository configuration"] = 492,
    ["OSS Review Toolkit resolutions"] = 493,
    Opctl = 721,
    ["Open Data Contract Standard (ODCS))"] = 484,
    ["OpenRewrite Resource"] = 483,
    ["OpenUtau character yaml"] = 477,
    ["OpenUtau ustx"] = 478,
    ["OpenWeather Current Weather API"] = 759,
    ["OpenWeather Road Risk API"] = 758,
    ["Ory Hydra configuration"] = 349,
    ["Ory Keto configuration"] = 393,
    ["Ory Kratos configuration"] = 488,
    ["Ory Oathkeeper configuration"] = 472,
    ["Outblocks App configuration"] = 486,
    ["Outblocks database table"] = 487,
    ["Outblocks project configuration"] = 485,
    PDM = 499,
    Packer = 496,
    Pantsbuild = 840,
    ["Paper paper-plugin.yml"] = 497,
    ["Pipeline component"] = 770,
    ["PocketMine plugin.yml"] = 504,
    ["Postman collection"] = 509,
    ["Problem object RFC9457"] = 868,
    ["Problem package generators"] = 517,
    Pterodactyl = 815,
    ["Pull Request Labeler"] = 532,
    Pulumi = 538,
    PyProject = 539,
    Pyright = 540,
    Qgoda = 541,
    Qodana = 788,
    ["Qt Creator workspace file"] = 900,
    ["Quali Torque Blueprint Spec 2"] = 813,
    ["QueryFirst config file"] = 836,
    ["RKE Cluster Configuration JSON"] = 767,
    ["RKE Cluster Configuration YAML"] = 766,
    ["Rancher Fleet"] = 535,
    ["Rattler-build"] = 542,
    Ray = 733,
    ["Read the Docs"] = 537,
    ["Red-DiscordBot Cog"] = 549,
    ["Red-DiscordBot Cog Repo"] = 550,
    ["Red-DiscordBot Trivia"] = 551,
    ["Render Blueprints"] = 765,
    RenderCV = 561,
    Renovate = 560,
    ["Replit config"] = 555,
    RoadRunner = 562,
    ["Rudder techniques"] = 874,
    Ruff = 557,
    ["Rust Project"] = 558,
    ["Rust toolchain"] = 566,
    ["SDMX data message"] = 591,
    ["SDMX metadata message"] = 590,
    ["SDMX structure message"] = 589,
    ["SIL Kit Participant Configuration"] = 601,
    ["SIL Kit Registry Configuration"] = 602,
    SWADL = 630,
    ["Safebox Config"] = 826,
    ["Sapphire CLI Config"] = 569,
    ["SauceCTL Configuration"] = 775,
    ["Schema Catalog"] = 583,
    ["Scoop manifest"] = 588,
    ["Semantic Data Fabric (SDF) file"] = 592,
    ["Semgrep Rule"] = 594,
    ["Serenity Code Generator (Sergen)"] = 595,
    ["Serverless Framework Configuration"] = 782,
    ["Serverless Workflow"] = 784,
    ["Settings.paf"] = 597,
    ["Shopware 6 Configuration"] = 785,
    ["Shopware CLI Extension Store Configuration"] = 786,
    ["Shopware CLI Project Store Configuration"] = 787,
    Sigma = 599,
    ["Sigrid scope configuration file"] = 600,
    ["SkyPilot Task JSON"] = 875,
    ["Slack app manifest"] = 604,
    Solidarity = 607,
    ["Solution filters"] = 608,
    ["Source Maps v3"] = 609,
    Sourcery = 610,
    ["Speakeasy Lint Configuration File"] = 611,
    ["Speakeasy Test Generation Configuration File"] = 612,
    ["Speakeasy Workflow File"] = 613,
    SpecIF = 614,
    ["Sponge Mixin configuration"] = 615,
    StackBlitz = 620,
    ["StackHawk Scanner Configuration"] = 781,
    Stale = 621,
    ["Starlake Data Pipeline"] = 756,
    Starship = 622,
    ["Statamic Blueprint"] = 623,
    ["Stella configuration file"] = 624,
    ["StrmPrivacy Data Connector"] = 830,
    ["StrmPrivacy Data Contract"] = 831,
    ["StrmPrivacy SimpleSchema"] = 828,
    ["StrmPrivacy Stream"] = 829,
    ["StrmPrivacy batch job configuration file"] = 827,
    ["Stryker Mutator"] = 627,
    ["StyleCop Analyzers Configuration"] = 628,
    ["Stylelint (.stylelintrc)"] = 629,
    ["Sublime Syntax"] = 832,
    ["Subsquid squid manifest"] = 877,
    ["Swagger API 2.0"] = 631,
    TSON = 657,
    TSTyche = 658,
    Talhelper = 633,
    ["Talisman configuration"] = 634,
    ["Taskfile config"] = 761,
    Taurus = 635,
    ["TestEnvironment.json"] = 644,
    ["TextMate Grammar"] = 643,
    ["Tier.run pricing.json"] = 638,
    Tikibase = 639,
    ["Traefik v2"] = 647,
    ["Traefik v2 File Provider"] = 648,
    ["Travis CI (.travis.yml)"] = 646,
    TunnelHub = 867,
    Turborepo = 645,
    Tycho = 913,
    Tye = 789,
    ["UET BuildConfig.json"] = 837,
    ["UI5 Manifest"] = 667,
    ["UNCORS configuration"] = 671,
    ["UTAM Page Object"] = 670,
    ["Ubuntu Server Autoinstall"] = 665,
    ["Uniswap Token List"] = 744,
    ["Unreal Engine Uplugin"] = 838,
    ["Unreal Engine Uproject"] = 839,
    ["Updatecli Compose"] = 797,
    ["Updatecli Policy Manifest"] = 798,
    ["Updatecli Policy Metadata"] = 799,
    Uplift = 835,
    ["User Journey Map"] = 764,
    V2Ray = 803,
    ["VSCode Code Snippets"] = 171,
    ["VSIX CLI publishing"] = 686,
    ["Vela Pipeline Configuration"] = 675,
    Vercel = 170,
    Visivo = 865,
    ["Web App Manifest"] = 693,
    ["Web types"] = 696,
    WebExtensions = 692,
    ["Webman package recipe"] = 809,
    ["Windows Package Manager Installer Manifest"] = 741,
    ["Windows Package Manager Locale Manifest"] = 742,
    ["Windows Package Manager Singleton Manifest"] = 740,
    ["Woodpecker pipeline config"] = 777,
    ["Wrangler CLI"] = 697,
    ["Xstate Machine"] = 795,
    ["Yarn Config (.yarnrc.yml)"] = 754,
    ["Yippee-Ki-JSON configuration YML"] = 746,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 869,
    ...
    ["babelrc.json"] = 68,
    ["bamboo-spec"] = 71,
    ["bashly-strings.yml"] = 847,
    ["batect.yml"] = 70,
    ["beef-database-codegen"] = 72,
    ["beef-database-v5-codegen"] = 74,
    ["beef-entity-codegen"] = 73,
    ["beef-entity-v5-codegen"] = 75,
    ["behat.yml"] = 85,
    ["bigquery-table"] = 76,
    ["bioimageio resource description"] = 885,
    ["bitbucket-pipelines"] = 78,
    bitrise = 79,
    ["bitrise-step"] = 80,
    ["block.json"] = 97,
    ...
    ["bozr.suite.json"] = 87,
    bpkg = 848,
    ["browser.i18n.json"] = 88,
    ["browsh configuration"] = 89,
    bucklescript = 90,
    ["buf.gen.yaml"] = 51,
    ["buf.plugin.yaml"] = 52,
    ["buf.work.yaml"] = 53,
    ["buf.yaml"] = 50,
    ["bundleconfig.json"] = 95,
    changelogging = 897,
    ["chisel-slices.json"] = 197,
    ["chrome-extension-locales-messages.json"] = 178,
    ["chutzpah.json"] = 179,
    cibuildwheel = 111,
    ["clang-format (.clang-format)"] = 801,
    ["clang-tidy"] = 158,
    clangd = 157,
    clib = 159,
    ["cloud-init: cloud-config userdata"] = 161,
    ["cloud-sdk-pipeline-configuration"] = 181,
    ["cloudbuild.json"] = 182,
    cloudify = 160,
    codemagic = 162,
    ["coffeelint.json"] = 199,
    ["commands.json"] = 174,
    ["commitlint (.commitlintrc)"] = 743,
    ["compile_commands.json"] = 173,
    ["compilerconfig.json"] = 172,
    ["completely.yml"] = 843,
    ["component-detection-manifest.json"] = 202,
    ["component.json"] = 201,
    ["composer.json"] = 200,
    ["conda-forge"] = 114,
    ["config.yaml"] = 536,
    ["contentmanifest.json"] = 180,
    ["contribute.json"] = 203,
    ["cosmos.config.json"] = 176,
    ["crowdin.yml"] = 204,
    ["custom-elements.json"] = 857,
    ["cypress.json"] = 208,
    ["datalogic-scan2deploy-android"] = 218,
    ["datalogic-scan2deploy-ce"] = 219,
    ["dbt Dependencies"] = 126,
    ["dbt Packages"] = 128,
    ["dbt Project"] = 127,
    ["dbt Selectors"] = 129,
    ["dbt YAML files"] = 130,
    ["ddev-global"] = 220,
    ["ddev-project"] = 221,
    ["debugsettings.json"] = 222,
    ["dependabot-v2.json"] = 225,
    ["dependabot.json"] = 224,
    ["deployed-cli"] = 794,
    ["devcontainer.json"] = 164,
    devinit = 748,
    ["devspace.yaml"] = 817,
    djlint = 749,
    ["docker bake"] = 230,
    ["docker sequencer"] = 231,
    ["docker-compose.yml"] = 747,
    ["dockerd.json"] = 229,
    ["dotnet Release Index manifest"] = 241,
    ["dotnet-tools.json"] = 242,
    ["dotnetcli.host.json"] = 243,
    ["dprint.json"] = 244,
    ["drone.json"] = 245,
    ["dss-2.0.0.json"] = 247,
    ["dstack configuration"] = 248,
    ["dvc.yaml"] = 249,
    ["ecosystem.json"] = 254,
    eksctl = 255,
    ["electron-builder configuration file"] = 262,
    ["epr-manifest.json"] = 260,
    ["evcc.yaml"] = 263,
    ["ezd task runner"] = 272,
    ["fabric.mod.json"] = 275,
    ["first-timers-bot"] = 281,
    ["flagd flag configuration"] = 63,
    ["fly.io Configuration"] = 64,
    fulibWorkflows = 776,
    ["function.json"] = 291,
    ["gRPC API Gateway & OpenAPI Config"] = 3,
    ["gitlab-ci"] = 308,
    ["global.json"] = 323,
    ["go-feature-flag Flag Configuration"] = 326,
    ["haxelib.json"] = 341,
    helmfile = 736,
    helmwave = 737,
    ["host-meta.json"] = 346,
    ...
    ["ide.host.json"] = 353,
    ["ifstate.conf"] = 354,
    ["imageoptimizer.json"] = 355,
    ["importmap.json"] = 358,
    ["ioBroker Configuration"] = 360,
    ["ioBroker JSON UI"] = 361,
    ["ioBroker Package manifest"] = 362,
    ["ize.toml"] = 834,
    ["jsconfig.json"] = 385,
    ["jscpd Configuration"] = 814,
    jsdoc = 732,
    ["k3d.yaml"] = 386,
    ["k9s plugin.yml"] = 388,
    ["kontinuous-config.yaml"] = 395,
    ["kontinuous-values.yaml"] = 394,
    ["kustomization.yaml"] = 397,
    ["label-commenter-config.yml"] = 398,
    ["latexindent configuration"] = 57,
    ["launchsettings.json"] = 399,
    lazydocker = 856,
    lazygit = 855,
    ["lego.json"] = 401,
    ["lerna.json"] = 402,
    ["lgtm.yml"] = 403,
    ["liblab.config.json"] = 404,
    ["libman.json"] = 405,
    ["license-report-config.json"] = 406,
    ["linkinator.config.json"] = 408,
    ["lint-staged (.lintstagedrc)"] = 712,
    ["local.settings.json"] = 413,
    ["localazy.json"] = 414,
    ["lotus.yaml"] = 412,
    ["lsdlschema.json"] = 415,
    ["markdown-link-check"] = 773,
    mboats = 780,
    ["micro-settings.json"] = 849,
    ["mimetypes.json"] = 425,
    ["mirrord config"] = 713,
    mise = 714,
    ["mise-settings"] = 715,
    ["mkdocs.yml"] = 445,
    ["monospace.yml"] = 447,
    ["mprocs Configuration file"] = 901,
    ["mta.yaml"] = 716,
    ["mtad.yaml"] = 717,
    ["mycode.json"] = 454,
    ["napari plugin manifest"] = 455,
    neoload = 727,
    ["nest-cli"] = 460,
    ["ninjs (News in JSON)"] = 459,
    ["nixd configuration"] = 873,
    ["nlu.json"] = 461,
    ["nodemon.json"] = 463,
    ["noodl config"] = 779,
    ["notebook.mod.json"] = 464,
    now = 723,
    ["npm-badges"] = 467,
    ["nswag.json"] = 470,
    ntangle = 471,
    ["nuclei-template.yaml"] = 468,
    ["nuget-project.json"] = 469,
    ["ocelot.json"] = 473,
    ["omnisharp.json"] = 474,
    ["openapi.json"] = 475,
    ["openfin.json"] = 482,
    ...
    ["ops.yaml"] = 479,
    ["package.json"] = 494,
    ["package.manifest"] = 495,
    ["partial-black.json"] = 86,
    ["pathfinder.yml"] = 498,
    ["pattern.json"] = 501,
    ["petstore-v1.0"] = 824,
    pgap_yaml_input_reader = 500,
    ["pixi.toml"] = 502,
    ["plagiarize-me.yaml"] = 506,
    ["plagiarize.yaml"] = 505,
    ["portman.json"] = 507,
    ["prettierrc.json"] = 515,
    ["prisma.yml"] = 516,
    ["project-1.0.0-beta3.json"] = 519,
    ["project-1.0.0-beta4.json"] = 520,
    ["project-1.0.0-beta5.json"] = 521,
    ["project-1.0.0-beta6.json"] = 522,
    ["project-1.0.0-beta8.json"] = 523,
    ["project-1.0.0-rc1.json"] = 524,
    ["project-1.0.0-rc2.json"] = 525,
    ["project.json"] = 518,
    ["prometheus.json"] = 526,
    ["prometheus.rules.json"] = 527,
    ["prometheus.rules.test.json"] = 528,
    ["proxies.json"] = 529,
    ["publiccode.yml"] = 530,
    ["pubspec.yaml"] = 531,
    ["pyrseas-0.8.json"] = 534,
    ["quilt.mod.json"] = 850,
    ["rc3 auth"] = 543,
    ["rc3 collection"] = 544,
    ["rc3 environment"] = 545,
    ...
    samt = 567,
    samtrc = 568,
    ["sarif-1.0.0.json"] = 570,
    ["sarif-2.0.0.json"] = 571,
    ["sarif-2.1.0"] = 581,
    ["sarif-2.1.0-rtm.2"] = 572,
    ["sarif-2.1.0-rtm.3"] = 574,
    ["sarif-2.1.0-rtm.4"] = 576,
    ["sarif-2.1.0-rtm.5"] = 578,
    ["sarif-2.1.0-rtm.6"] = 579,
    ["sarif-external-property-file-2.1.0"] = 582,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 573,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 575,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 577,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 580,
    ["schema.org - Action"] = 584,
    ["schema.org - ContactPoint"] = 585,
    ["schema.org - Place"] = 586,
    ["schema.org - Thing"] = 587,
    ["secrethub.yml"] = 852,
    ["semantic-release"] = 593,
    ["servicehub.config.json"] = 707,
    ["servicehub.service.json"] = 706,
    ["settings.job"] = 596,
    ["sfdx-hardis configuration"] = 598,
    ["shard.yml"] = 888,
    ["size-limit configuration"] = 603,
    ["skaffold.yaml"] = 771,
    ["skyuxconfig.json"] = 605,
    snapcraft = 606,
    ["spicepod.yaml"] = 908,
    ["sqlc configuration"] = 617,
    ["stripe-app-local.json"] = 626,
    ["stripe-app.json"] = 625,
    swcrc = 757,
    ["task.json"] = 632,
    taskcat = 724,
    ["template.json"] = 636,
    ["templatsources.json"] = 637,
    ["theme.json"] = 640,
    ["tizen_workspace.json"] = 641,
    tldr = 642,
    tmuxinator = 710,
    ["transcend.yml"] = 649,
    ["tree-sitter grammar.json"] = 331,
    ["trime.yaml"] = 650,
    ["trunk.yaml"] = 651,
    ["ts-force-config.json"] = 655,
    ["tsconfig.json"] = 652,
    ["tsd.json"] = 653,
    ["tsdrc.json"] = 654,
    ["tslint.json"] = 656,
    ...
    v8r = 690,
    vcluster = 895,
    ["vcpkg configuration file"] = 169,
    ["vcpkg manifest file"] = 168,
    ["vega-lite.json"] = 674,
    ["vega.json"] = 673,
    ["venvironment-basic.yaml"] = 677,
    ["venvironment.yaml"] = 676,
    ["version.json"] = 678,
    ["vim-addon-info"] = 680,
    ["vs-2017.3.host.json"] = 682,
    ["vs-nesting.json"] = 683,
    ["vsls.json"] = 681,
    ["vss-extension.json"] = 687,
    ["vtesttree.yaml"] = 688,
    ["vtestunit.yaml"] = 689,
    ["warp-keysets.json"] = 858,
    ["warp-themes.json"] = 859,
    ["warp-workflows.json"] = 860,
    ["webhint.io"] = 810,
    ["webjobpublishsettings.json"] = 695,
    ["webjobs-list.json"] = 694,
    ["well-known-fursona"] = 896,
    ["xs-app.json"] = 720,
    ["xunit.runner.json"] = 705,
    yamllint = 745,
    ["zerops.io import file"] = 905,
    ["zerops.yml"] = 904,
    zuul = 729,
    ["Žinoma"] = 739
  },
