...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 145,
    [".cryproj (generic)"] = 490,
    [".cryproj engine-5.2"] = 485,
    [".cryproj engine-5.3"] = 486,
    [".cryproj engine-5.4"] = 487,
    [".cryproj engine-5.5"] = 488,
    [".cryproj engine-dev"] = 489,
    [".csscomb.json"] = 147,
    [".csslintrc"] = 148,
    [".eslintrc"] = 193,
    [".esmrc.json"] = 185,
    ...
    ["Azure Pipelines"] = 45,
    ["Azure Static Web Apps CLI configuration file"] = 415,
    ["Azure Static Web Apps configuration file"] = 414,
    ["BX CI"] = 76,
    ["Better Code Hub"] = 533,
    ["Better Scripts"] = 77,
    BizTalkServerApplicationSchema = 505,
    ...
    ["Butane Config"] = 570,
    ["CICS TS region tagging"] = 577,
    ["CICS TS resource import"] = 578,
    ["CICS TS resource model"] = 579,
    ["CICS TS resource overrides"] = 580,
    ["CMake Presets"] = 78,
    ...
    ["Datahub Ingestion Recipe Schema"] = 584,
    ...
    ["Embrace Config Schema"] = 595,
    ["Error pages"] = 188,
    Esquio = 186,
    ["Estuary Flow Catalog Schema"] = 574,
    ["Expo SDK"] = 191,
    ...
    Goreleaser = 219,
    ["Goreleaser Pro"] = 220,
    ["Gradle Build Cache Node"] = 530,
    ["Gradle Enterprise"] = 529,
    ...
    HEMTT = 502,
    Hadolint = 514,
    ["Hardware Sentry Configuration"] = 588,
    Hayson = 232,
    ...
    ["JFrog File Spec"] = 251,
    ["JFrog Pipelines YML DSL"] = 597,
    ["JSON Document Transform"] = 259,
    ["JSON Feed"] = 260,
    ["JSON Resume"] = 375,
    ["JSON Schema Draft 2020-12"] = 481,
    ["JSON Schema Draft 4"] = 478,
    ["JSON Schema Draft 7"] = 479,
    ["JSON Schema Draft 8"] = 480,
    ...
    ["KSP-AVC"] = 476,
    ["KSP-CKAN"] = 477,
    ["Keycloak REST API"] = 603,
    ["Knative Functions - func.yaml"] = 203,
    ["KoDE/CI build.yaml"] = 593,
    ["Kong DBLess Schema"] = 594,
    KrakenD = 265,
    ["LinkML Metamodel"] = 277,
    Liquibase = 544,
    ["Liquibase Flow File"] = 545,
    Markdownlint = 548,
    ...
    ["MongoDB Atlas Search Index Definition Schema"] = 592,
    ["Monika Configuration Schema"] = 590,
    ["Motif config"] = 498,
    ["Netin Diagnostic System Template"] = 553,
    ...
    Opctl = 501,
    ["OpenWeather Current Weather API"] = 537,
    ["OpenWeather Road Risk API"] = 536,
    ...
    PyProject = 366,
    Qodana = 563,
    ["Quali Torque Blueprint Spec 2"] = 585,
    ["QueryFirst config file"] = 606,
    ["RKE Cluster Configuration JSON Schema"] = 543,
    ["RKE Cluster Configuration YAML Schema"] = 542,
    Ray = 513,
    ["Read the Docs"] = 364,
    ...
    ["Rust Project"] = 374,
    ["Rust toolchain"] = 379,
    ["SIL Kit Participant Configuration"] = 404,
    SWADL = 424,
    ["Sapphire CLI Config"] = 380,
    ["SauceCTL Configuration"] = 550,
    ["Schema Catalog"] = 393,
    ["Scoop manifest"] = 398,
    ["Semgrep Rule"] = 400,
    ["Serverless Framework Configuration"] = 557,
    ["Serverless Workflow Schema"] = 559,
    ["Settings.paf"] = 402,
    ["Shopware 6 Configuration"] = 560,
    ["Shopware CLI Extension Store Configuration"] = 561,
    ["Shopware CLI Project Store Configuration"] = 562,
    Solidarity = 408,
    ["Solution filters"] = 409,
    ["Source Maps v3"] = 410,
    SpecIF = 411,
    ["Sponge Mixin configuration"] = 412,
    ["StackHawk Scanner Configuration"] = 556,
    Stale = 416,
    Starship = 417,
    ["Statamic Blueprint"] = 418,
    ["StrmPrivacy Data Connector"] = 601,
    ["StrmPrivacy Data Contract"] = 602,
    ["StrmPrivacy SimpleSchema"] = 599,
    ["StrmPrivacy Stream"] = 600,
    ["StrmPrivacy batch job configuration file"] = 598,
    ["Stryker Mutator"] = 421,
    ["StyleCop Analyzers Configuration"] = 422,
    ["Swagger API 2.0"] = 425,
    TSON = 445,
    ["Talisman configuration"] = 426,
    ["Taskfile YAML Schema"] = 539,
    Taurus = 427,
    ["TestEnvironment.json"] = 434,
    Tikibase = 430,
    ["Traefik v2"] = 437,
    ["Traefik v2 File Provider"] = 438,
    Turborepo = 435,
    Tye = 564,
    ["UI5 Manifest"] = 451,
    ["UTAM Page Object"] = 453,
    ["Ubuntu Server Autoinstall"] = 449,
    ["Uniswap Token List"] = 522,
    ["Unreal Engine Uplugin"] = 607,
    ["Unreal Engine Uproject"] = 608,
    Updatecli = 571,
    Uplift = 605,
    ["User Journey Map YAML Schema"] = 541,
    V2Ray = 575,
    ["VSCode Code Snippets"] = 121,
    ["VSIX CLI publishing"] = 466,
    ["Vela Pipeline Configuration"] = 456,
    Vercel = 120,
    ["Web App Manifest"] = 471,
    ["Web types"] = 474,
    WebExtensions = 470,
    ["Webman package recipe"] = 581,
    ["Windows Package Manager Installer Manifest"] = 519,
    ["Windows Package Manager Locale Manifest"] = 520,
    ["Windows Package Manager Singleton Manifest"] = 518,
    ["Woodpecker pipeline config"] = 552,
    ["Xstate Machine Schema"] = 569,
    ["Yippee-Ki-JSON configuration YML"] = 524,
    ["angular.json"] = 10,
    ...
    ["ize.toml"] = 604,
    ["jsconfig.json"] = 263,
    ["jscpd Configuration Schema"] = 586,
    jsdoc = 512,
    ["k3d.yaml"] = 264,
    ...
    ["release drafter"] = 508,
    rustfmt = 378,
    ["sarif-1.0.0.json"] = 381,
    ["sarif-2.0.0.json"] = 382,
    ["sarif-2.1.0"] = 391,
    ["sarif-2.1.0-rtm.2"] = 383,
    ["sarif-2.1.0-rtm.3"] = 385,
    ["sarif-2.1.0-rtm.4"] = 387,
    ["sarif-2.1.0-rtm.5"] = 389,
    ["sarif-external-property-file-2.1.0"] = 392,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 384,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 386,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 388,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 390,
    ["schema.org - Action"] = 394,
    ["schema.org - ContactPoint"] = 395,
    ["schema.org - Place"] = 396,
    ["schema.org - Thing"] = 397,
    ["semantic-release"] = 399,
    ["servicehub.config.json"] = 484,
    ["servicehub.service.json"] = 483,
    ["settings.job"] = 401,
    ["sfdx-hardis configuration"] = 403,
    ["size-limit configuration"] = 405,
    ["skaffold.yaml"] = 547,
    ["skyuxconfig.json"] = 406,
    snapcraft = 407,
    ["stripe-app-local.json"] = 420,
    ["stripe-app.json"] = 419,
    swcrc = 535,
    taskcat = 504,
    ["template.json"] = 428,
    ["templatsources.json"] = 429,
    ["theme.json"] = 431,
    ["tizen_workspace.json"] = 432,
    tmLanguage = 433,
    tmuxinator = 492,
    ["trunk.yaml schema"] = 439,
    ["ts-force-config.json"] = 443,
    ["tsconfig.json"] = 440,
    ["tsd.json"] = 441,
    ["tsdrc.json"] = 442,
    ["tslint.json"] = 444,
    ...
    ["vega-lite.json"] = 455,
    ["vega.json"] = 454,
    ["venvironment-basic.yaml"] = 458,
    ["venvironment.yaml"] = 457,
    ["version.json"] = 459,
    ["vim-addon-info"] = 460,
    ["vs-2017.3.host.json"] = 462,
    ["vs-nesting.json"] = 463,
    ["vsls.json"] = 461,
    ["vss-extension.json"] = 467,
    ["webhint.io"] = 582,
    ["webjobpublishsettings.json"] = 473,
    ["webjobs-list.json"] = 472,
    ["xs-app.json"] = 500,
    ["xunit.runner.json"] = 482,
    yamllint = 523,
    zuul = 509,
    ["Žinoma"] = 517
  },
