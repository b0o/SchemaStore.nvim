...
M.json = {
  ...
  index = {
    ...
    ["Azure Pipelines"] = 103,
    ["Azure Static Web Apps CLI configuration file"] = 789,
    ["Azure Static Web Apps configuration file"] = 788,
    ["BOSH CPI Config"] = 127,
    ...
    Rockcraft = 707,
    ["Roo Coder Custom Modes"] = 708,
    Rubocop = 699,
    ["Rudder techniques"] = 1068,
    Ruff = 700,
    ["Rust Project"] = 701,
    ["Rust toolchain"] = 712,
    ["SDMX data message"] = 738,
    ["SDMX metadata message"] = 737,
    ["SDMX structure message"] = 736,
    ["SIL Kit Participant Configuration"] = 748,
    ["SIL Kit Registry Configuration"] = 749,
    ["SPDX 2.3"] = 786,
    SWADL = 802,
    ["Safebox Config"] = 1023,
    ["Sapphire CLI Config"] = 715,
    ["SauceCTL Configuration"] = 971,
    ["Schema Catalog"] = 730,
    ["Scoop manifest"] = 735,
    ["Semantic Data Fabric (SDF) file"] = 739,
    ["Semgrep Rule"] = 741,
    ["Serenity Code Generator (Sergen)"] = 742,
    ...
    ["Sigma Detection Rule"] = 746,
    ["Sigrid scope configuration file"] = 747,
    ["SkyPilot Task JSON"] = 1069,
    ["Slack app manifest"] = 751,
    Snapcraft = 753,
    Solidarity = 756,
    ["Solution filters"] = 757,
    ["Source Maps v3"] = 758,
    Sourcery = 759,
    ["Spack bootstrap.yaml"] = 760,
    ["Spack cdash.yaml"] = 761,
    ["Spack ci.yaml"] = 762,
    ["Spack compilers.yaml"] = 763,
    ["Spack concretizer.yaml"] = 764,
    ["Spack config.yaml"] = 765,
    ["Spack definitions.yaml"] = 766,
    ["Spack develop.yaml"] = 767,
    ["Spack env_vars.yaml"] = 768,
    ["Spack environment"] = 774,
    ["Spack include.yaml"] = 769,
    ["Spack mirrors.yaml"] = 770,
    ["Spack modules.yaml"] = 771,
    ["Spack packages.yaml"] = 772,
    ["Spack repos.yaml"] = 773,
    ["Spack toolchains.yaml"] = 775,
    ["Spack upstreams.yaml"] = 776,
    ["Spack view.yaml"] = 777,
    ["Speakeasy Generation Config File"] = 781,
    ["Speakeasy Lint Configuration File"] = 778,
    ["Speakeasy Test Generation Configuration File"] = 779,
    ["Speakeasy Workflow File"] = 780,
    SpecIF = 782,
    ["Specmatic Configuration"] = 783,
    ["Sponge Mixin configuration"] = 784,
    StackBlitz = 790,
    ...
    Starship = 793,
    ["Statamic Blueprint"] = 794,
    ["Stella configuration file"] = 795,
    ["Streamlit configuration file"] = 796,
    ["Stryker Mutator"] = 799,
    ["StyleCop Analyzers Configuration"] = 800,
    ["Stylelint (.stylelintrc)"] = 801,
    ["Stylua Config"] = 1162,
    ["Sublime Syntax"] = 1024,
    ["Subsquid squid manifest"] = 1071,
    ["Swagger API 2.0"] = 803,
    ["Synadia Connect Component"] = 804,
    TSON = 839,
    TSTyche = 840,
    ["TYPO3 Vendor Bundler config"] = 845,
    ["Tab data for a LinUtil"] = 1118,
    ["Tab list for a LinUtil"] = 1117,
    Tach = 805,
    ["Tach Domain"] = 806,
    Talhelper = 808,
    ["Talisman configuration"] = 809,
    Taplo = 1163,
    ["Taskfile config"] = 955,
    Taurus = 810,
    Tauticord = 811,
    ...
    ["TestEnvironment.json"] = 822,
    ["TextMate Grammar"] = 821,
    Threagile = 817,
    ["Tier.run pricing.json"] = 814,
    Tikibase = 815,
    Tombi = 820,
    ["Traefik v2"] = 825,
    ["Traefik v2 File Provider"] = 826,
    ["Traefik v3"] = 827,
    ["Traefik v3 File Provider"] = 828,
    ["Travis CI (.travis.yml)"] = 824,
    Treefmt = 399,
    Trident = 1145,
    ["TrueScript for *.tscript files"] = 831,
    ...
    samt = 713,
    samtrc = 714,
    ["sarif-1.0.0.json"] = 716,
    ["sarif-2.0.0.json"] = 717,
    ["sarif-2.1.0"] = 727,
    ["sarif-2.1.0-rtm.2"] = 718,
    ["sarif-2.1.0-rtm.3"] = 720,
    ["sarif-2.1.0-rtm.4"] = 722,
    ["sarif-2.1.0-rtm.5"] = 724,
    ["sarif-2.1.0-rtm.6"] = 725,
    ["sarif-external-property-file-2.1.0"] = 728,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 719,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 721,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 723,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 726,
    ["scalingo.json configuration"] = 729,
    ["schema.org - Action"] = 731,
    ["schema.org - ContactPoint"] = 732,
    ["schema.org - Place"] = 733,
    ["schema.org - Thing"] = 734,
    ["secrethub.yml"] = 1044,
    ["semantic-release"] = 740,
    ["servicehub.config.json"] = 897,
    ["servicehub.service.json"] = 896,
    ["settings.job"] = 743,
    ["sfdx-hardis configuration"] = 745,
    ["shard.yml"] = 1082,
    ["size-limit configuration"] = 750,
    ["skaffold.yaml"] = 966,
    ["skyuxconfig.json"] = 752,
    ["snowflake-config"] = 754,
    ["snowflake-connections"] = 755,
    ["spicepod.yaml"] = 1102,
    ["sqlc configuration"] = 787,
    ["stripe-app-local.json"] = 798,
    ["stripe-app.json"] = 797,
    swcrc = 951,
    ["task.json"] = 807,
    taskcat = 915,
    ["template.json"] = 812,
    ["templatsources.json"] = 813,
    ["theme.json"] = 816,
    ["tizen_workspace.json"] = 818,
    tldr = 819,
