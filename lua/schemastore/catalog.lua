...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 812,
    [".nodehawkrc"] = 506,
    [".npmpackagejsonlintrc"] = 510,
    [".omletrc"] = 987,
    [".phrase.yml"] = 572,
    [".phraseapp.yml"] = 573,
    [".pmbot.yml"] = 560,
    [".postcssrc"] = 567,
    [".powerpages-web-template-manifest"] = 569,
    [".pre-commit-config.yml"] = 570,
    [".pre-commit-hooks.yml"] = 571,
    [".putout.json"] = 600,
    [".rehyperc"] = 623,
    [".remarkrc"] = 627,
    [".sprite files"] = 694,
    ...
    ["A micro editor config"] = 458,
    ABCInventoryModuleData = 18,
    ABCSupplyPlan = 19,
    AIConfig = 20,
    ["AMX Muse Program Descriptor"] = 1031,
    ["API Builder"] = 847,
    ["AVA Configuration"] = 909,
    ["AWS AppConfig Feature Flags-v1"] = 49,
    ["AWS CDK cdk.json"] = 209,
    ["AWS CloudFormation"] = 210,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 211,
    ["AWS SAM CLI Samconfig"] = 212,
    ["Adobe UXP Manifest"] = 970,
    ["Aerleon Network & Service Definitions"] = 13,
    ["Aerleon Policy"] = 14,
    Air = 16,
    ["Airlock Microgateway"] = 21,
    ["Alacritty Configuration"] = 881,
    ["All Contributors configuration file"] = 934,
    ["Ansible Argument Specs"] = 342,
    ["Ansible Collection Galaxy"] = 349,
    ["Ansible Execution Environment"] = 339,
    ["Ansible Inventory"] = 348,
    ["Ansible Meta"] = 340,
    ["Ansible Meta Runtime"] = 341,
    ["Ansible Navigator Configuration"] = 351,
    ["Ansible Playbook"] = 346,
    ["Ansible Requirements"] = 343,
    ["Ansible Rulebook"] = 347,
    ["Ansible Tasks File"] = 345,
    ["Ansible Vars File"] = 344,
    ["Ansible-lint Configuration"] = 350,
    Any = 996,
    ["AnyWork Automation Configuration"] = 9,
    ["App config Spotify Backstage"] = 25,
    ["Application Accelerator"] = 6,
    ["Application list for a WinUtil"] = 1013,
    ArchitectFX = 1018,
    ["Argo Events"] = 39,
    ["Argo Workflows"] = 40,
    AssemblyScript = 43,
    ...
    ["Azure Pipelines"] = 76,
    ["Azure Static Web Apps CLI configuration file"] = 698,
    ["Azure Static Web Apps configuration file"] = 697,
    ["BOSH Deploy Config"] = 100,
    ["BX CI"] = 118,
    ["Bashly (bashly.yml)"] = 938,
    ["Bashly Settings (bashly-settings.yml)"] = 939,
    ["Better Code Hub"] = 851,
    ["Better Scripts"] = 119,
    Bigconfig = 93,
    ["Biome Formatter Config"] = 63,
    ["Bitmovin Encoding Template"] = 1024,
    BizTalkServerApplicationSchema = 819,
    Bleep = 120,
    ["Block Protocol Metadata"] = 117,
    ["Boyka Framework"] = 101,
    Briefcase = 825,
    ["Build Info"] = 108,
    Buildkite = 110,
    ["Bukkit plugin.yml"] = 109,
    ["BungeeCord plugin.yml"] = 115,
    ["Butane Config"] = 894,
    C4InterFlow = 1039,
    ["CGS Card Game Specification (cgs.json)"] = 975,
    ["CICS TS region tagging"] = 903,
    ["CICS TS resource import"] = 904,
    ["CICS TS resource model"] = 905,
    ["CICS TS resource overrides"] = 906,
    ["CMake Presets"] = 121,
    ["CNC Codes"] = 138,
    ["CRS WAF test file"] = 1003,
    ["CRS WAF test platform overrides file"] = 1004,
    ["CSS Comb (.csscomb.json)"] = 237,
    ["CSS Lint (.csslintrc)"] = 238,
    ["CSpell (cspell.json)"] = 236,
    ["CVE Record Format"] = 145,
    CWL = 981,
    ["Cache Warmup config"] = 122,
    ["Calqulus pipeline"] = 123,
    ["Camel YAML DSL"] = 124,
    ["Cannon TOML"] = 125,
    Carafe = 126,
    ["Cargo Make"] = 128,
    ["Cargo Manifest"] = 127,
    ["Catalog Info Backstage"] = 129,
    ["Chamaleon environment"] = 1028,
    ["Chamaleon properties"] = 1029,
    ["Chamaleon template"] = 1027,
    Changesets = 221,
    Charmcraft = 130,
    Cheatsheets = 891,
    ["Chrome Extension"] = 202,
    ["Chromia Model"] = 131,
    ["CircleCI config.yml"] = 178,
    ["Citation File Format"] = 223,
    CityJSON = 133,
    ["Clawject config"] = 144,
    ["Cloud Foundry Application Manifest"] = 986,
    ["Cloud Run Spec v1"] = 1008,
    ["CloudCannon Configuration"] = 72,
    ["CloudEvents specification"] = 134,
    ["Code Climate"] = 179,
    CodeCV = 70,
    CodeRabbit = 69,
    ["CodeShip Pro services configuration files"] = 191,
    ["CodeShip Pro steps configuration files"] = 192,
    ["Codecov configuration files"] = 190,
    CodifyCLI = 71,
    Codux = 188,
    ["Cog config file"] = 139,
    ["Commandbox Box.json"] = 140,
    ["Commandbox Server.json"] = 141,
    ["Common Catalog Data"] = 200,
    ["Common Package Specification"] = 142,
    Concord = 1002,
    ["Configu .cfgu files"] = 991,
    ["Configu .configu file"] = 992,
    Conjure = 137,
    ["Container Structure Test"] = 833,
    Containerlab = 860,
    ["Contextive Glossary"] = 1054,
    Convex = 136,
    ["Crowdsec collection config"] = 231,
    ["Crowdsec parser config"] = 232,
    ["Crowdsec scenario config"] = 233,
    ["CumulusCI Config"] = 143,
    ["Custom Machinery Machine"] = 976,
    ["Custom Machinery Recipe"] = 977,
    ["Cycle Stack File"] = 146,
    CycloneDX = 147,
    ["DWP Exchange - catalogue entry"] = 280,
    ["DWP Exchange - gateway"] = 278,
    ["DWP Exchange - meta"] = 279,
    ["Dart Build Config (dart-build.json)"] = 239,
    ["Dart Test Config (dart-test.json)"] = 240,
    ["DashLord Configuration"] = 241,
    ["Data Contract Specification"] = 242,
    ["Data Product Specification"] = 243,
    ["DataYoga Connections"] = 148,
    ["DataYoga Job"] = 149,
    ["Databricks Asset Bundles"] = 955,
    ["Datadog Service Definition"] = 431,
    ["Datadog Software Catalog"] = 432,
    ["Datahub Ingestion Recipe"] = 910,
    ["Dein Config"] = 155,
    ["Deno Config (deno.json)"] = 249,
    ["Dependency cruiser"] = 156,
    ["DeployStack Configuration"] = 157,
    ["Deployer Recipe"] = 252,
    ["Deta Spacefile"] = 158,
    ["Detekt Config (detekt.yml)"] = 253,
    ["Devbox Config"] = 159,
    ["Devbox Plugin"] = 160,
    Devfile = 277,
    DipDup = 1005,
    ["Discord Webhook"] = 254,
    ["DocFx Config (docfx.json)"] = 258,
    Dofigen = 259,
    ["Dolittle Artifacts"] = 260,
    ["Dolittle Bounded Context Configuration"] = 261,
    ["Dolittle Event Horizons Configuration"] = 262,
    ["Dolittle Resources Configuration"] = 263,
    ["Dolittle Server Configuration"] = 264,
    ["Dolittle Tenant Map Configuration"] = 266,
    ["Dolittle Tenants Configuration"] = 265,
    ["Dolittle Topology"] = 267,
    ["DonateCaseBetterCasino menu"] = 1032,
    ["Drupal Breakpoints"] = 161,
    ["Drupal Config"] = 173,
    ["Drupal Info"] = 162,
    ["Drupal Layouts"] = 163,
    ["Drupal Libraries"] = 164,
    ["Drupal Links Action"] = 165,
    ["Drupal Links Contextual"] = 166,
    ["Drupal Links Menu"] = 167,
    ["Drupal Links Task"] = 168,
    ["Drupal Migration"] = 169,
    ["Drupal Permissions"] = 170,
    ["Drupal Recipe"] = 171,
    ["Drupal Routing"] = 172,
    ["Drupal Services"] = 174,
    ["Drush site aliases"] = 273,
    ["Dynamic Bash Aliases (.aliases)"] = 946,
    ["EAS config"] = 297,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 935,
    ["EasyVCR .NET"] = 298,
    ["Eidolon Resource"] = 1019,
    ["Elgato Stream Deck"] = 283,
    Elm = 1007,
    ["Embrace Config"] = 921,
    Endurica = 959,
    ["Enterprise Contract Policy Spec"] = 284,
    ["Erda Pipeline"] = 983,
    ["Erda Runtime"] = 984,
    Esquio = 286,
    ["Estuary Flow Catalog"] = 900,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 290,
    ["EveryVoice TTS Toolkit Data Configuration"] = 291,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 295,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 294,
    ["EveryVoice TTS Toolkit Text Configuration"] = 292,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 293,
    ["Expo SDK"] = 296,
    ["F-Droid Data metadata"] = 302,
    ["FasterCI Configuration"] = 77,
    FiQuS = 306,
    Firebase = 304,
    ["FlexGet Config"] = 307,
    ["Flow.json Configurations"] = 980,
    ["Fossa configuration file"] = 314,
    ["Fossa's fossa-deps file"] = 315,
    ["Foundry VTT - Base package Manifest"] = 309,
    ["Foundry VTT - Module Manifest"] = 310,
    ["Foundry VTT - System Data Template"] = 313,
    ["Foundry VTT - System Manifest"] = 311,
    ["Foundry VTT - World Manifest"] = 312,
    ["Foxx Manifest"] = 78,
    ["Freifunk.de Community API"] = 81,
    ["Frogbot Config"] = 82,
    ["G2P Mapping Configuration"] = 320,
    ["GCP Blueprint Metadata"] = 323,
    Gaspar = 321,
    ["GatewayCore API Gateway"] = 322,
    ["GeoJSON.json latest"] = 898,
    GherKing = 902,
    ["GitHub Action"] = 328,
    ["GitHub Actions typing"] = 1015,
    ["GitHub Discussion"] = 329,
    ["GitHub Funding"] = 330,
    ["GitHub Issue Template configuration"] = 331,
    ["GitHub Issue Template forms"] = 332,
    ["GitHub Workflow"] = 333,
    ["GitHub Workflow Template Properties"] = 334,
    ["GitHub automatically generated release notes configuration"] = 335,
    ["GitLab Agent for Kubernetes configuration"] = 972,
    GitVersion = 325,
    ["Gitea Issue Template configuration"] = 326,
    ["Gitea Issue Template forms"] = 327,
    ["Gitpod Automations"] = 337,
    ["Gitpod Configuration"] = 338,
    ["GlazeWM settings"] = 974,
    ["Global Privacy Control"] = 324,
    Goblet = 954,
    ["Golangci-lint Configuration"] = 353,
    ["Golangci-lint Custom Plugins Configuration"] = 354,
    ["Google Chrome Related Website Sets"] = 305,
    ["Google Cloud Workflows"] = 208,
    ["Google Digital Assetlinks"] = 1055,
    Goreleaser = 356,
    ["Goreleaser Pro"] = 357,
    Goss = 358,
    ["Gradle Build Cache Node"] = 849,
    ["Gradle Enterprise"] = 848,
    ["Grafana 5.x Dashboard"] = 359,
    ["GraphQL Code Generator"] = 363,
    ["GraphQL Config"] = 362,
    ["GraphQL Mesh"] = 361,
    ["Grunt JSHint task"] = 367,
    ["Grunt Watch task"] = 368,
    ["Grunt base task"] = 369,
    ["Grunt clean task"] = 365,
    ["Grunt copy task"] = 364,
    ["Grunt cssmin task"] = 366,
    HEMTT = 815,
    Hadolint = 829,
    Hammerkit = 859,
    ["Hardware Sentry Configuration"] = 914,
    Hatch = 830,
    Hayson = 371,
    ["Haystack Pipeline"] = 372,
    ["Hazelcast 5 Configuration"] = 373,
    ["Helm Chart.lock"] = 176,
    ["Helm Chart.yaml"] = 175,
    ["Helm Unittest Test Suite"] = 177,
    ["Homer dashboard configuration"] = 374,
    Hugo = 890,
    ["Hugo Theme"] = 889,
    ["Hyperfoil benchmark configuration"] = 380,
    ["IBM Zapp document"] = 381,
    ["IBM zCodeFormatSettings"] = 382,
    ["IMG Catapult PSP"] = 387,
    ["IVMS101 by CODE Protocol"] = 973,
    Infrahub = 389,
    Istanbul = 917,
    ["JDownloader2 crawler multi-rules"] = 399,
    ["JDownloader2 crawler single-rules"] = 398,
    ["JFrog Applications Config"] = 400,
    ["JFrog File Spec"] = 401,
    ["JFrog Pipelines YML DSL"] = 923,
    ["JMeter DSL cli config"] = 402,
    JReleaser = 404,
    ["JSON Document Transform"] = 412,
    ["JSON Feed"] = 413,
    ["JSON Resume"] = 632,
    ["JSON Schema Draft 2020-12"] = 798,
    ["JSON Schema Draft 4"] = 795,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 956,
    ["JSON Schema Draft 7"] = 796,
    ["JSON Schema Draft 7 (unofficial strict)"] = 957,
    ["JSON Schema Draft 8 (2019-09)"] = 797,
    ["JSON-API"] = 411,
    ["JSON-e templates"] = 856,
    ["JSON-stat 2.0"] = 791,
    JSONPatch = 415,
    ["JSR Package Config (jsr.json)"] = 405,
    Jasmine = 393,
    Jekyll = 394,
    ["Jenkins X Pipelines"] = 395,
    ["Jenkins X Requirements"] = 396,
    Jest = 397,
    ["Jovo Language Models"] = 403,
    ["KIMMDY config file"] = 426,
    ["KODE/CI build.yaml"] = 919,
    ["KSP-AVC"] = 792,
    ["KSP-CKAN"] = 793,
    ["KSP-NetKAN"] = 794,
    KSY = 985,
    KSail = 318,
    ["Karakum configuration file"] = 316,
    Kas = 418,
    ["Kestra flow file"] = 427,
    ["Keycloak REST API"] = 926,
    ["Knative Functions - func.yaml"] = 317,
    ["Kometa (nightly) config file"] = 429,
    ["Kometa config file"] = 428,
    ["Kong DBLess config"] = 920,
    KrakenD = 430,
    ["Kubri Configuration"] = 436,
    LOOBin = 451,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 213,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 214,
    ["Landing Zone Accelerator on AWS - Global Config"] = 215,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 216,
    ["Landing Zone Accelerator on AWS - Network Config"] = 217,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 218,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 219,
    ["Landing Zone Accelerator on AWS - Security Config"] = 220,
    ["Language configuration"] = 995,
    Lefthook = 440,
    ["Liferay client-extension.yaml"] = 447,
    ["LinkML Metamodel"] = 449,
    Liquibase = 865,
    ["Liquibase Flow File"] = 866,
    ["Lively Properties"] = 450,
    ["Lobe AI Agent"] = 74,
    Loki = 75,
    ["MLOS Configs"] = 489,
    ["MS2Rescore Configuration"] = 492,
    ["Madness (madness.yml)"] = 937,
    ["MapEHR Mapping"] = 457,
    Markdownlint = 869,
    ["Mason Registry"] = 872,
    ["MegaLinter configuration"] = 459,
    ["MegaLinter descriptor"] = 460,
    Melange = 964,
    ["Meltano project definition"] = 461,
    ["Mergify Configuration"] = 493,
    ["Metadata for a Bazel module"] = 462,
    ["Metadata for a Cinnamon spice"] = 1011,
    ["Metatype Configuration"] = 463,
    ["MetricsHub Configuration"] = 464,
    ["MetricsHub Connector Configuration"] = 465,
    ["Micro Editor Syntax"] = 947,
    ["Microsoft Band Web Tile"] = 466,
    ["Microsoft RulesEngine workflow rules"] = 999,
    ["Microsoft RulesEngine workflow rules list"] = 1000,
    ["Minecraft Custom Main Menu Mod"] = 965,
    ["Minecraft Data Pack Advancement"] = 468,
    ["Minecraft Data Pack Biome"] = 469,
    ["Minecraft Data Pack Configured Carver"] = 470,
    ["Minecraft Data Pack Damage Type"] = 471,
    ["Minecraft Data Pack Dimension"] = 473,
    ["Minecraft Data Pack Dimension Type"] = 472,
    ["Minecraft Data Pack Item Modifier"] = 474,
    ["Minecraft Data Pack Loot Table"] = 475,
    ["Minecraft Data Pack Metadata"] = 476,
    ["Minecraft Data Pack Predicate"] = 477,
    ["Minecraft Data Pack Recipe"] = 478,
    ["Minecraft Data Pack Tag"] = 479,
    ["Minecraft Data Pack Template Pool"] = 480,
    ["Minecraft Data Pack Trim Material"] = 485,
    ["Minecraft Data Pack Trim Pattern"] = 486,
    ["Minecraft Resource Pack Lang"] = 481,
    ["Minecraft Resource Pack Particle"] = 482,
    ["Minecraft Resource Pack Texture Mcmeta"] = 484,
    ["Minecraft Resourcepack Sounds"] = 483,
    ["Monade CLI Stack Configuration"] = 496,
    ["MongoDB Atlas Search Index Definition"] = 918,
    ["Monika Configuration"] = 916,
    ["Monoweave Configuration"] = 491,
    ["Motif config"] = 811,
    MultiQC = 1048,
    ["NOX Framework (Service)"] = 509,
    ["Netin Diagnostic System Template"] = 876,
    ["Netlify config"] = 499,
    ["Network-as-Code Data Model"] = 500,
    ["Nightwatch.js"] = 502,
    ["Node.js configuration"] = 816,
    ["NueJS configuration file"] = 514,
    ["Nuitka.yaml"] = 978,
    ["Nullstone config"] = 516,
    ["ONe's changelog entry"] = 530,
    ["ONe's service descriptor"] = 529,
    ["ORT Server repository environment configuration"] = 537,
    ["OSCAL Assessment Plan (AP)"] = 539,
    ["OSCAL Assessment Results (AR)"] = 540,
    ["OSCAL Catalog"] = 541,
    ["OSCAL Component Definition (CDef)"] = 542,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 543,
    ["OSCAL Profile"] = 544,
    ["OSCAL System Security Plan (SSP)"] = 545,
    ["OSS Review Toolkit configuration"] = 546,
    ["OSS Review Toolkit curation"] = 547,
    ["OSS Review Toolkit package configuration"] = 548,
    ["OSS Review Toolkit repository configuration"] = 549,
    ["OSS Review Toolkit resolutions"] = 550,
    ["October CMS columns"] = 520,
    ["October CMS fields"] = 521,
    Okteto = 522,
    Opctl = 814,
    ["Open Data Contract Standard (ODCS)"] = 533,
    ["Open Know-How"] = 1053,
    ["OpenRewrite Resource"] = 532,
    ["OpenUtau character yaml"] = 526,
    ["OpenUtau ustx"] = 527,
    ["OpenWeather Current Weather API"] = 855,
    ["OpenWeather Road Risk API"] = 854,
    ["Ory Hydra configuration"] = 379,
    ["Ory Keto configuration"] = 433,
    ["Ory Kratos configuration"] = 538,
    ["Ory Oathkeeper configuration"] = 518,
    ["Outblocks App configuration"] = 535,
    ["Outblocks database table"] = 536,
    ["Outblocks project configuration"] = 534,
    PDM = 556,
    Packer = 553,
    Pantsbuild = 933,
    ["Paper paper-plugin.yml"] = 554,
    ["Pipeline component"] = 867,
    ["Platform.sh application"] = 2,
    ["Platform.sh routes"] = 3,
    ["Platform.sh services"] = 4,
    ["Plex Prerolls"] = 564,
    ["PocketMine plugin.yml"] = 561,
    ["Postman collection"] = 568,
    ["Preset list for a WinUtil"] = 1014,
    ["ProActions AI-Kit Configuration"] = 577,
    ["ProActions AI-Kit Configuration for Menus"] = 579,
    ["ProActions AI-Kit Configuration for Sections"] = 581,
    ["ProActions AI-Kit Configuration for Services"] = 578,
    ["ProActions AI-Kit Configuration for Steps"] = 582,
    ["ProActions AI-Kit Configuration for Templates"] = 580,
    ["Problem object RFC9457"] = 962,
    ["Problem package generators"] = 583,
    Pterodactyl = 913,
    ["Pull Request Labeler"] = 599,
    Pulumi = 607,
    ["PyGTA Config"] = 603,
    PyProject = 608,
    Pylock = 1056,
    Pyright = 609,
    ["Python script metadata"] = 1050,
    Qgoda = 611,
    Qodana = 886,
    ["Qt Creator workspace file"] = 993,
    ["Quali Torque Blueprint Spec 2"] = 911,
    ["QueryFirst config file"] = 929,
    ["RKE Cluster Configuration JSON"] = 864,
    ["RKE Cluster Configuration YAML"] = 863,
    RadioHound = 602,
    Railway = 612,
    ["Rancher Fleet"] = 604,
    ["Rattler-build"] = 613,
    Ray = 828,
    ["Read the Docs"] = 606,
    ["Red-DiscordBot Cog"] = 620,
    ["Red-DiscordBot Cog Repo"] = 621,
    ["Red-DiscordBot Trivia"] = 622,
    ["Render Blueprints"] = 862,
    RenderCV = 634,
    Renovate = 633,
    ["Replit config"] = 628,
    Restate = 1043,
    RoadRunner = 636,
    ["Rudder techniques"] = 968,
    Ruff = 630,
    ["Rust Project"] = 631,
    ["Rust toolchain"] = 640,
    ["SDMX data message"] = 666,
    ["SDMX metadata message"] = 665,
    ["SDMX structure message"] = 664,
    ["SIL Kit Participant Configuration"] = 676,
    ["SIL Kit Registry Configuration"] = 677,
    ["SPDX 2.3"] = 695,
    SWADL = 709,
    ["Safebox Config"] = 924,
    ["Sapphire CLI Config"] = 643,
    ["SauceCTL Configuration"] = 873,
    ["Schema Catalog"] = 658,
    ["Scoop manifest"] = 663,
    ["Semantic Data Fabric (SDF) file"] = 667,
    ["Semgrep Rule"] = 669,
    ["Serenity Code Generator (Sergen)"] = 670,
    ["Serverless Framework Configuration"] = 880,
    ["Serverless Workflow"] = 882,
    ["Settings for a Cinnamon spice"] = 1010,
    ["Settings.paf"] = 672,
    ["Shopware 6 Configuration"] = 883,
    ["Shopware CLI Extension Store Configuration"] = 884,
    ["Shopware CLI Project Store Configuration"] = 885,
    ["Sigma Detection Rule"] = 674,
    ["Sigrid scope configuration file"] = 675,
    ["SkyPilot Task JSON"] = 969,
    ["Slack app manifest"] = 679,
    Solidarity = 684,
    ["Solution filters"] = 685,
    ["Source Maps v3"] = 686,
    Sourcery = 687,
    ["Speakeasy Generation Config File"] = 691,
    ["Speakeasy Lint Configuration File"] = 688,
    ["Speakeasy Test Generation Configuration File"] = 689,
    ["Speakeasy Workflow File"] = 690,
    SpecIF = 692,
    ["Sponge Mixin configuration"] = 693,
    StackBlitz = 699,
    ["StackHawk Scanner Configuration"] = 879,
    Stale = 700,
    ["Starlake Data Pipeline"] = 852,
    Starship = 701,
    ["Statamic Blueprint"] = 702,
    ["Stella configuration file"] = 703,
    ["Stryker Mutator"] = 706,
    ["StyleCop Analyzers Configuration"] = 707,
    ["Stylelint (.stylelintrc)"] = 708,
    ["Stylua Config"] = 1057,
    ["Sublime Syntax"] = 925,
    ["Subsquid squid manifest"] = 971,
    ["Swagger API 2.0"] = 710,
    ["Synadia Connect Component"] = 711,
    TSON = 745,
    TSTyche = 746,
    ["Tab data for a LinUtil"] = 1017,
    ["Tab list for a LinUtil"] = 1016,
    Tach = 712,
    ["Tach Domain"] = 713,
    Talhelper = 715,
    ["Talisman configuration"] = 716,
    Taplo = 1058,
    ["Taskfile config"] = 857,
    Taurus = 717,
    Tauticord = 718,
    Telefonistka = 1044,
    ["TestEnvironment.json"] = 728,
    ["TextMate Grammar"] = 727,
    ["Tier.run pricing.json"] = 721,
    Tikibase = 722,
    Tombi = 726,
    ["Traefik v2"] = 731,
    ["Traefik v2 File Provider"] = 732,
    ["Traefik v3"] = 733,
    ["Traefik v3 File Provider"] = 734,
    ["Travis CI (.travis.yml)"] = 730,
    Trident = 1041,
    ["TrueScript for *.tscript files"] = 737,
    ["Tugboat QA config.yml"] = 1038,
    TunnelHub = 960,
    Turborepo = 729,
    Tycho = 1006,
    Tye = 887,
    ["Tyk Gateway - Open Source v5.7+"] = 1049,
    ["Typst Manifest"] = 751,
    ["UET BuildConfig.json"] = 930,
    ["UI5 Manifest"] = 757,
    ["UNCORS configuration"] = 761,
    ["UTAM Page Object"] = 760,
    ["Ubuntu Server Autoinstall"] = 755,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1042,
    ["Uniswap Token List"] = 840,
    ["Universal Schedule Format"] = 762,
    ["Unreal Engine Uplugin"] = 931,
    ["Unreal Engine Uproject"] = 932,
    ["Updatecli Compose"] = 895,
    ["Updatecli Policy Manifest"] = 896,
    ["Updatecli Policy Metadata"] = 897,
    Uplift = 928,
    ["Upsun config"] = 1,
    ["User Journey Map"] = 861,
    V2Ray = 901,
    ["VSCode Code Snippets"] = 196,
    ["VSIX CLI publishing"] = 780,
    Vector = 764,
    ["Vela Pipeline Configuration"] = 767,
    Vercel = 195,
    ["Version Bumper config"] = 770,
    ["Viash Component Config"] = 1046,
    ["Viash Package Config"] = 1047,
    Visivo = 958,
    Wake = 1040,
    ["Waku Config"] = 1020,
    ["Web App Manifest"] = 786,
    ["Web types"] = 789,
    WebExtensions = 785,
    ["Webman package recipe"] = 907,
    ["Windows Package Manager Installer Manifest"] = 836,
    ["Windows Package Manager Locale Manifest"] = 837,
    ["Windows Package Manager Singleton Manifest"] = 835,
    Winutil = 838,
    ["WireMock stub mapping"] = 1023,
    ["Woodpecker pipeline config"] = 875,
    ["Wrangler CLI"] = 790,
    ["Xstate Machine"] = 893,
    ["Yandex Workflow Language"] = 1012,
    ["Yarn Config (.yarnrc.yml)"] = 850,
    ["Yippee-Ki-JSON configuration YML"] = 842,
    ["YouTrack App"] = 1009,
    ["Zerops.io config"] = 997,
    ["Zerops.io import"] = 998,
    ["aerleon.yml"] = 12,
    ["angular.json"] = 22,
    apko = 963,
    ...
    ["babelrc.json"] = 84,
    ["bamboo-spec"] = 87,
    ["bashly-strings.yml"] = 940,
    ["batect.yml"] = 86,
    ["beef-database-codegen"] = 88,
    ["beef-database-v5-codegen"] = 90,
    ["beef-entity-codegen"] = 89,
    ["beef-entity-v5-codegen"] = 91,
    ["behat.yml"] = 102,
    ["bigquery-table"] = 92,
    ["bioimageio resource description"] = 979,
    ["bitbucket-pipelines"] = 94,
    bitrise = 95,
    ["bitrise-step"] = 96,
    ["block.json"] = 116,
    ...
    ["bozr.suite.json"] = 104,
    bpkg = 941,
    ["browser.i18n.json"] = 105,
    ["browsh configuration"] = 106,
    bucklescript = 107,
    ["buf.gen.yaml"] = 66,
    ["buf.plugin.yaml"] = 67,
    ["buf.work.yaml"] = 68,
    ["buf.yaml"] = 65,
    ["bun.lock"] = 112,
    ["bundleconfig.json"] = 113,
    ["bunfig.toml"] = 114,
    ["ccmod.json"] = 1021,
    changelogging = 990,
    ["chisel-slices.json"] = 222,
    ["chrome-extension-locales-messages.json"] = 203,
    ["chutzpah.json"] = 204,
    cibuildwheel = 132,
    ["clang-format (.clang-format)"] = 899,
    ["clang-tidy"] = 183,
    clangd = 182,
    clib = 184,
    ["cloud-init: cloud-config userdata"] = 186,
    ["cloud-sdk-pipeline-configuration"] = 206,
    ["cloudbuild.json"] = 207,
    cloudify = 185,
    codemagic = 187,
    ["coffeelint.json"] = 224,
    ["commands.json"] = 199,
    ["commitlint (.commitlintrc)"] = 839,
    ["committed.toml"] = 225,
    ["compile_commands.json"] = 198,
    ["compilerconfig.json"] = 197,
    ["completely.yml"] = 936,
    ["component-detection-manifest.json"] = 228,
    ["component.json"] = 227,
    ["composer.json"] = 226,
    ["conda-forge"] = 135,
    ["config.yaml"] = 605,
    ["contentmanifest.json"] = 205,
    ["contribute.json"] = 229,
    ["cosmos.config.json"] = 201,
    ["crowdin.yml"] = 230,
    ["ctfd-setup configuration file"] = 1030,
    ["custom-elements.json"] = 950,
    ["cypress.json"] = 234,
    ["datalogic-scan2deploy-android"] = 244,
    ["datalogic-scan2deploy-ce"] = 245,
    ["dbt Dependencies"] = 150,
    ["dbt Packages"] = 152,
    ["dbt Project"] = 151,
    ["dbt Selectors"] = 153,
    ["dbt YAML files"] = 154,
    ["ddev-global"] = 246,
    ["ddev-project"] = 247,
    ["debugsettings.json"] = 248,
    ["dependabot-v2.json"] = 251,
    ["dependabot.json"] = 250,
    ["deployed-cli"] = 892,
    ["devcontainer.json"] = 189,
    devinit = 844,
    ["devspace.yaml"] = 915,
    djlint = 845,
    ["docker bake"] = 256,
    ["docker sequencer"] = 257,
    ["docker-compose.yml"] = 843,
    ["dockerd.json"] = 255,
    ["dotnet Release Index manifest"] = 268,
    ["dotnet-tools.json"] = 269,
    ["dotnetcli.host.json"] = 270,
    ["dprint.json"] = 271,
    ["drone.json"] = 272,
    ["dss-2.0.0.json"] = 274,
    ["dstack configuration"] = 275,
    ["dtool dataset metadata"] = 1025,
    ["dvc.yaml"] = 276,
    ["ecosystem.json"] = 281,
    eksctl = 282,
    ["electron-builder configuration file"] = 288,
    ["epr-manifest.json"] = 287,
    ["evcc.yaml"] = 289,
    ["ezd task runner"] = 299,
    ["fabric.mod.json"] = 301,
    ["first-timers-bot"] = 308,
    ["flagd flag configuration"] = 79,
    ["fly.io Configuration"] = 80,
    fulibWorkflows = 874,
    ["function.json"] = 319,
    ["gRPC API Gateway & OpenAPI Config"] = 7,
    ["gematik health care insurance list"] = 1036,
    ["gematik health care patient list"] = 1033,
    ["gematik health care provider institution list"] = 1035,
    ["gematik health care provider list"] = 1034,
    ["gematik tiger test environment configuration"] = 1037,
    ["gitlab-ci"] = 336,
    ["global.json"] = 352,
    ["go-feature-flag Flag Configuration"] = 355,
    ["haxelib.json"] = 370,
    helmfile = 831,
    helmwave = 832,
    ["host-meta.json"] = 376,
    ...
    ["ide.host.json"] = 383,
    ["ifstate.conf"] = 384,
    ["imageoptimizer.json"] = 385,
    ["importmap.json"] = 388,
    ["ioBroker Configuration"] = 390,
    ["ioBroker JSON UI"] = 391,
    ["ioBroker Package manifest"] = 392,
    ["ize.toml"] = 927,
    ["jsconfig.json"] = 416,
    ["jscpd Configuration"] = 912,
    jsdoc = 827,
    ["k3d.yaml"] = 417,
    ["k9s aliases.yaml"] = 419,
    ["k9s cluster-config.yaml"] = 421,
    ["k9s config.yaml"] = 420,
    ["k9s hotkeys.yaml"] = 422,
    ["k9s plugins.yaml"] = 423,
    ["k9s skin.yaml"] = 424,
    ["k9s views.yaml"] = 425,
    ["kontinuous-config.yaml"] = 435,
    ["kontinuous-values.yaml"] = 434,
    ["kustomization.yaml"] = 437,
    ["label-commenter-config.yml"] = 438,
    ["latexindent configuration"] = 73,
    ["launchsettings.json"] = 439,
    lazydocker = 949,
    lazygit = 948,
    ["lego.json"] = 441,
    ["lerna.json"] = 442,
    ["lgtm.yml"] = 443,
    ["liblab.config.json"] = 444,
    ["libman.json"] = 445,
    ["license-report-config.json"] = 446,
    ["linkinator.config.json"] = 448,
    ["lint-staged (.lintstagedrc)"] = 806,
    ["local.settings.json"] = 453,
    ["localazy.json"] = 454,
    ["lotus.yaml"] = 452,
    ["lsdlschema.json"] = 455,
    ["markdown-link-check"] = 870,
    maturin = 871,
    mboats = 878,
    ["micro-settings.json"] = 942,
    ["mimetypes.json"] = 467,
    ["mirrord config"] = 807,
    mise = 808,
    ["mkdocs.yml"] = 487,
    ["monospace.yml"] = 490,
    ["moon.yml"] = 1022,
    ["mprocs Configuration file"] = 994,
    ["mrdocs.yml"] = 488,
    ["mta.yaml"] = 809,
    ["mtad.yaml"] = 810,
    ["mycode.json"] = 497,
    nFPM = 501,
    ["napari plugin manifest"] = 498,
    neoload = 822,
    ["nest-cli"] = 504,
    ["ninjs (News in JSON)"] = 503,
    ["nitro.json"] = 821,
    ["nixd configuration"] = 967,
    ["nlu.json"] = 505,
    ["nodemon.json"] = 507,
    ["noodl config"] = 877,
    ["notebook.mod.json"] = 508,
    now = 817,
    ["npm-badges"] = 511,
    ["nswag.json"] = 515,
    ntangle = 517,
    ["nuclei-template.yaml"] = 512,
    ["nuget-project.json"] = 513,
    ["ocelot.json"] = 519,
    ["omnisharp.json"] = 523,
    ["openapi.json"] = 524,
    ["openfin.json"] = 531,
    ...
    ["ops.yaml"] = 528,
    ["package.json"] = 551,
    ["package.manifest"] = 552,
    ["partial-black.json"] = 103,
    ["pathfinder.yml"] = 555,
    ["pattern.json"] = 558,
    ["petstore-v1.0"] = 922,
    pgap_yaml_input_reader = 557,
    ["pixi.toml"] = 559,
    ["plagiarize-me.yaml"] = 563,
    ["plagiarize.yaml"] = 562,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1026,
    ["podbard.yaml"] = 565,
    ["portman.json"] = 566,
    ["prefect.toml"] = 574,
    ["prettierrc.json"] = 575,
    ["prisma.yml"] = 576,
    ["project-1.0.0-beta3.json"] = 585,
    ["project-1.0.0-beta4.json"] = 586,
    ["project-1.0.0-beta5.json"] = 587,
    ["project-1.0.0-beta6.json"] = 588,
    ["project-1.0.0-beta8.json"] = 589,
    ["project-1.0.0-rc1.json"] = 590,
    ["project-1.0.0-rc2.json"] = 591,
    ["project.json"] = 584,
    ["project.owasp.yaml"] = 592,
    ["prometheus.json"] = 593,
    ["prometheus.rules.json"] = 594,
    ["prometheus.rules.test.json"] = 595,
    ["proxies.json"] = 596,
    ["publiccode.yml"] = 597,
    ["pubspec.yaml"] = 598,
    ["pyrseas-0.8.json"] = 601,
    pytest = 610,
    ["quilt.mod.json"] = 943,
    ["rc3 auth"] = 614,
    ["rc3 collection"] = 615,
    ...
    ["registry.yaml"] = 35,
    ["release drafter"] = 823,
    ["release-please-config.json"] = 624,
    ["release-please-manifest.json"] = 625,
    ["release-plz.toml"] = 626,
    ["renv.lock"] = 635,
    ["rivet.yaml"] = 966,
    rockcraft = 637,
    runny = 638,
    ...
    samt = 641,
    samtrc = 642,
    ["sarif-1.0.0.json"] = 644,
    ["sarif-2.0.0.json"] = 645,
    ["sarif-2.1.0"] = 655,
    ["sarif-2.1.0-rtm.2"] = 646,
    ["sarif-2.1.0-rtm.3"] = 648,
    ["sarif-2.1.0-rtm.4"] = 650,
    ["sarif-2.1.0-rtm.5"] = 652,
    ["sarif-2.1.0-rtm.6"] = 653,
    ["sarif-external-property-file-2.1.0"] = 656,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 647,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 649,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 651,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 654,
    ["scalingo.json configuration"] = 657,
    ["schema.org - Action"] = 659,
    ["schema.org - ContactPoint"] = 660,
    ["schema.org - Place"] = 661,
    ["schema.org - Thing"] = 662,
    ["secrethub.yml"] = 945,
    ["semantic-release"] = 668,
    ["servicehub.config.json"] = 801,
    ["servicehub.service.json"] = 800,
    ["settings.job"] = 671,
    ["sfdx-hardis configuration"] = 673,
    ["shard.yml"] = 982,
    ["size-limit configuration"] = 678,
    ["skaffold.yaml"] = 868,
    ["skyuxconfig.json"] = 680,
    snapcraft = 681,
    ["snowflake-config"] = 682,
    ["snowflake-connections"] = 683,
    ["spicepod.yaml"] = 1001,
    ["sqlc configuration"] = 696,
    ["stripe-app-local.json"] = 705,
    ["stripe-app.json"] = 704,
    swcrc = 853,
    ["task.json"] = 714,
    taskcat = 818,
    ["template.json"] = 719,
    ["templatsources.json"] = 720,
    ["theme.json"] = 723,
    ["tizen_workspace.json"] = 724,
    tldr = 725,
    tmuxinator = 804,
    ["transcend.yml"] = 735,
    ["tree-sitter grammar.json"] = 360,
    ["trime.yaml"] = 736,
    ["trunk.yaml"] = 738,
    ["ts-force-config.json"] = 743,
    ["tsconfig.json"] = 739,
    ["tsd.json"] = 740,
    ["tsdoc.json"] = 741,
    ["tsdrc.json"] = 742,
    ...
    v8r = 784,
    vcluster = 988,
    ["vcpkg configuration file"] = 194,
    ["vcpkg manifest file"] = 193,
    ["vega-lite.json"] = 766,
    ["vega.json"] = 765,
    ["venvironment-basic.yaml"] = 769,
    ["venvironment.yaml"] = 768,
    version = 1045,
    ["version.json"] = 771,
    ["vhwdebugger-binding.yaml"] = 773,
    ["vim-addon-info"] = 774,
    ["vs-2017.3.host.json"] = 776,
    ["vs-nesting.json"] = 777,
    ["vsls.json"] = 775,
    ["vss-extension.json"] = 781,
    vtcfg = 1051,
    ["vtesttree.yaml"] = 782,
    ["vtestunit.yaml"] = 783,
    ["warp-keysets.json"] = 951,
    ["warp-themes.json"] = 952,
    ["warp-workflows.json"] = 953,
    ["webhint.io"] = 908,
    ["webjobpublishsettings.json"] = 788,
    ["webjobs-list.json"] = 787,
    ["well-known-fursona"] = 989,
    ["xs-app.json"] = 813,
    ["xunit.runner.json"] = 799,
    yamllint = 841,
    zuul = 824,
    ["Žinoma"] = 834
  },
