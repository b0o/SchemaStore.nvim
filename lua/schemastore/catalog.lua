...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 180,
    [".cryproj (generic)"] = 620,
    [".cryproj engine-5.2"] = 615,
    [".cryproj engine-5.3"] = 616,
    [".cryproj engine-5.4"] = 617,
    [".cryproj engine-5.5"] = 618,
    [".cryproj engine-dev"] = 619,
    [".csscomb.json"] = 182,
    [".csslintrc"] = 183,
    [".es6importsorterrc.json"] = 751,
    [".eslintrc"] = 232,
    [".esmrc.json"] = 224,
    [".ffizer.yaml"] = 236,
    [".htmlhintrc"] = 289,
    ...
    [".mtaext"] = 629,
    [".nodehawkrc"] = 392,
    [".npmpackagejsonlintrc"] = 395,
    [".phraseapp.yml"] = 440,
    [".pmbot.yml"] = 429,
    [".postcssrc"] = 435,
    [".powerpages-web-template-manifest"] = 437,
    [".pre-commit-config.yml"] = 438,
    [".pre-commit-hooks.yml"] = 439,
    [".putout.json"] = 459,
    [".rehyperc"] = 471,
    [".remarkrc"] = 473,
    [".sprite files"] = 528,
    ...
    ["<div>RIOTS' studio configuration"] = 599,
    ["@factorial/drupal-breakpoints-css"] = 6,
    ["A micro editor config"] = 351,
    ["API Builder"] = 661,
    ["AVA Configuration"] = 720,
    ["AWS CDK cdk.json"] = 164,
    ["AWS CloudFormation"] = 165,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 166,
    ["AWS SAM CLI Samconfig"] = 167,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 13,
    ["Airplane task"] = 14,
    ["Alacritty Configuration"] = 693,
    ["All Contributors configuration file"] = 750,
    ...
    ["Azure Pipelines"] = 60,
    ["Azure Static Web Apps CLI configuration file"] = 531,
    ["Azure Static Web Apps configuration file"] = 530,
    ["BX CI"] = 96,
    ["Better Code Hub"] = 665,
    ["Better Scripts"] = 97,
    Bigconfig = 77,
    BizTalkServerApplicationSchema = 635,
    Bleep = 98,
    ...
    ["Butane Config"] = 705,
    ["CICS TS region tagging"] = 714,
    ["CICS TS resource import"] = 715,
    ["CICS TS resource model"] = 716,
    ["CICS TS resource overrides"] = 717,
    ["CMake Presets"] = 99,
    ["CNC Codes"] = 109,
    ...
    Cheatsheets = 702,
    ["Chrome Extension"] = 157,
    ["CircleCI config.yml"] = 134,
    ["Citation File Format"] = 169,
    CityJSON = 107,
    ["Code Climate"] = 135,
    CodeCV = 58,
    ["CodeShip Pro services configuration files"] = 146,
    ["CodeShip Pro steps configuration files"] = 147,
    ["Codecov configuration files"] = 145,
    Codux = 143,
    ["Cog config file"] = 110,
    ["Commandbox Box.json"] = 111,
    ["Commandbox Server.json"] = 112,
    ["Common Catalog Data"] = 155,
    ["Common types for all schemas"] = 1,
    Conjure = 108,
    ["Container Structure Test"] = 648,
    Containerlab = 673,
    ["Crowdsec collection config"] = 176,
    ["Crowdsec parser config"] = 177,
    ["Crowdsec scenario config"] = 178,
    ["DWP Exchange - catalogue entry"] = 221,
    ["DWP Exchange - gateway"] = 219,
    ["DWP Exchange - meta"] = 220,
    ["Dart build configuration"] = 184,
    ["Dart test config"] = 185,
    ["DashLord configuration"] = 186,
    ["Data Contract Specification"] = 187,
    ["Databricks Asset Bundles"] = 771,
    ["Datadog Service Definition"] = 329,
    ["Datahub Ingestion Recipe"] = 721,
    ["Dein Config"] = 114,
    Deno = 193,
    ["Deployer Recipe"] = 196,
    ["Deta Spacefile"] = 115,
    ...
    Devfile = 218,
    ["Discord Webhook"] = 198,
    ["Dolittle Artifacts"] = 202,
    ["Dolittle Bounded Context Configuration"] = 203,
    ["Dolittle Event Horizons Configuration"] = 204,
    ["Dolittle Resources Configuration"] = 205,
    ["Dolittle Server Configuration"] = 206,
    ["Dolittle Tenant Map Configuration"] = 208,
    ["Dolittle Tenants Configuration"] = 207,
    ["Dolittle Topology"] = 209,
    ["Drupal Breakpoints"] = 118,
    ["Drupal Config"] = 129,
    ["Drupal Info"] = 119,
    ["Drupal Layouts"] = 120,
    ["Drupal Libraries"] = 121,
    ["Drupal Links Action"] = 122,
    ["Drupal Links Contextual"] = 123,
    ["Drupal Links Menu"] = 124,
    ["Drupal Links Task"] = 125,
    ["Drupal Migration"] = 126,
    ["Drupal Permissions"] = 127,
    ["Drupal Routing"] = 128,
    ["Drupal Services"] = 130,
    ["Drush site aliases"] = 214,
    ["Embrace Config"] = 732,
    Endurica = 774,
    ["Error pages"] = 227,
    Esquio = 225,
    ["Estuary Flow Catalog"] = 711,
    ["Expo SDK"] = 230,
    ["F-Droid Data metadata"] = 235,
    ["Facets - FSDL - Application"] = 233,
    ["FasterCI Configuration"] = 61,
    FiQuS = 239,
    Firebase = 237,
    ["Fossa configuration file"] = 246,
    ["Fossa's fossa-deps file"] = 247,
    ["Foundry VTT - Base package Manifest"] = 241,
    ["Foundry VTT - Module Manifest"] = 242,
    ["Foundry VTT - System Data Template"] = 245,
    ["Foundry VTT - System Manifest"] = 243,
    ["Foundry VTT - World Manifest"] = 244,
    ["Foxx Manifest"] = 62,
    ["Freifunk.de Community API"] = 65,
    ["Frogbot Config"] = 66,
    ["G2P Mapping Configuration"] = 251,
    ["GCP Blueprint Metadata"] = 254,
    Gaspar = 252,
    ["GatewayCore API Gateway"] = 253,
    ["GeoJSON.json latest"] = 709,
    GherKing = 713,
    ["GitHub Action"] = 258,
    ["GitHub Discussion"] = 259,
    ["GitHub Funding"] = 260,
    ["GitHub Issue Template configuration"] = 262,
    ["GitHub Workflow"] = 263,
    ["GitHub Workflow Template Properties"] = 264,
    ["GitHub issue forms"] = 261,
    GitVersion = 257,
    ["Gitpod Configuration"] = 266,
    ["Global Privacy Control"] = 255,
    Goblet = 770,
    ["Google Chrome Related Website Sets"] = 238,
    ["Google Cloud Workflows"] = 163,
    Goreleaser = 270,
    ["Goreleaser Pro"] = 271,
    Goss = 272,
    ["Gradle Build Cache Node"] = 663,
    ["Gradle Enterprise"] = 662,
    ["Grafana 5.x Dashboard"] = 273,
    ["GraphQL Code Generator"] = 276,
    ["GraphQL Config"] = 275,
    ["GraphQL Mesh"] = 274,
    ["Grunt JSHint task"] = 280,
    ["Grunt Watch task"] = 281,
    ["Grunt base task"] = 282,
    ["Grunt clean task"] = 278,
    ["Grunt copy task"] = 277,
    ["Grunt cssmin task"] = 279,
    HEMTT = 632,
    Hadolint = 644,
    Hammerkit = 672,
    ["Hardware Sentry Configuration"] = 725,
    Hatch = 645,
    Hayson = 284,
    ["Haystack Pipeline"] = 285,
    ["Hazelcast 5 Configuration"] = 286,
    ["Helm Chart.lock"] = 132,
    ["Helm Chart.yaml"] = 131,
    ["Helm Unittest Test Suite"] = 133,
    Hugo = 701,
    ["IBM Zapp document"] = 291,
    ["IBM zCodeFormatSettings"] = 292,
    ["IMG Catapult PSP"] = 297,
    Istanbul = 728,
    ["JDownloader2 crawler multi-rules"] = 307,
    ["JDownloader2 crawler single-rules"] = 306,
    ["JFrog Applications Config"] = 308,
    ["JFrog File Spec"] = 309,
    ["JFrog Pipelines YML DSL"] = 734,
    ["JMeter DSL cli config"] = 310,
    JReleaser = 312,
    ["JSON Document Transform"] = 319,
    ["JSON Feed"] = 320,
    ["JSON Resume"] = 479,
    ["JSON Schema Draft 2020-12"] = 611,
    ["JSON Schema Draft 4"] = 608,
    ["JSON Schema Draft 7"] = 609,
    ["JSON Schema Draft 7 (unofficial strict)"] = 772,
    ["JSON Schema Draft 8 (2019-09)"] = 610,
    ["JSON-API"] = 318,
    ["JSON-e templates"] = 670,
    ["JSON-stat 2.0"] = 605,
    JSONPatch = 322,
    Jasmine = 302,
    Jekyll = 303,
    ["Jenkins X Pipelines"] = 304,
    ["Jenkins X Requirements"] = 305,
    ["Jovo Language Models"] = 311,
    ["KIMMDY config file"] = 327,
    ["KSP-AVC"] = 606,
    ["KSP-CKAN"] = 607,
    ["Karakum configuration file"] = 248,
    Kas = 325,
    ["Keycloak REST API"] = 742,
    ["Knative Functions - func.yaml"] = 249,
    ["KoDE/CI build.yaml"] = 730,
    ["Kong DBLess config"] = 731,
    KrakenD = 328,
    LOOBin = 346,
    Lefthook = 336,
    ["Liferay client-extension.yaml"] = 342,
    ["LinkML Metamodel"] = 344,
    Liquibase = 677,
    ["Liquibase Flow File"] = 678,
    ["Lively Properties"] = 345,
    ["Lobe AI Agent"] = 59,
    ["MLOS Configs"] = 378,
    ["MS2Rescore Configuration"] = 380,
    Markdownlint = 681,
    ["Mason Registry"] = 683,
    ["MegaLinter configuration"] = 352,
    ["MegaLinter descriptor"] = 353,
    Melange = 778,
    ["Meltano plugin discovery definition"] = 355,
    ["Meltano project definition"] = 354,
    ["Microsoft Band Web Tile"] = 356,
    ["Minecraft Custom Main Menu Mod"] = 779,
    ["Minecraft Data Pack Advancement"] = 358,
    ["Minecraft Data Pack Biome"] = 359,
    ["Minecraft Data Pack Configured Carver"] = 360,
    ["Minecraft Data Pack Damage Type"] = 361,
    ["Minecraft Data Pack Dimension"] = 363,
    ["Minecraft Data Pack Dimension Type"] = 362,
    ["Minecraft Data Pack Item Modifier"] = 364,
    ["Minecraft Data Pack Loot Table"] = 365,
    ["Minecraft Data Pack Metadata"] = 366,
    ["Minecraft Data Pack Predicate"] = 367,
    ["Minecraft Data Pack Recipe"] = 368,
    ["Minecraft Data Pack Tag"] = 369,
    ["Minecraft Data Pack Template Pool"] = 370,
    ["Minecraft Data Pack Trim Material"] = 375,
    ["Minecraft Data Pack Trim Pattern"] = 376,
    ["Minecraft Resource Pack Lang"] = 371,
    ["Minecraft Resource Pack Particle"] = 372,
    ["Minecraft Resource Pack Texture Mcmeta"] = 374,
    ["Minecraft Resourcepack Sounds"] = 373,
    ["MkDocs Configuration 1.0"] = 377,
    ["MongoDB Atlas Search Index Definition"] = 729,
    ["Monika Configuration"] = 727,
    ["Motif config"] = 628,
    ["NOX Framework (Service)"] = 394,
    ["Netin Diagnostic System Template"] = 687,
    ["Netlify config"] = 385,
    ["Network-as-Code Data Model"] = 386,
    ["Nightwatch.js"] = 387,
    ["ONe's changelog entry"] = 410,
    ["ONe's service descriptor"] = 409,
    ["OSS Review Toolkit configuration"] = 417,
    ["OSS Review Toolkit curation"] = 418,
    ["OSS Review Toolkit package configuration"] = 419,
    ["OSS Review Toolkit repository configuration"] = 420,
    ["OSS Review Toolkit resolutions"] = 421,
    Opctl = 631,
    ["OpenRewrite Resource"] = 412,
    ["OpenUtau character yaml"] = 406,
    ["OpenUtau ustx"] = 407,
    ["OpenWeather Current Weather API"] = 669,
    ["OpenWeather Road Risk API"] = 668,
    ["Ory Hydra configuration"] = 290,
    ["Ory Keto configuration"] = 330,
    ["Ory Kratos configuration"] = 416,
    ["Ory Oathkeeper configuration"] = 401,
    ["Outblocks App configuration"] = 414,
    ["Outblocks database table"] = 415,
    ["Outblocks project configuration"] = 413,
    Packer = 424,
    Pantsbuild = 749,
    ["Paper paper-plugin.yml"] = 425,
    ["Pipeline component"] = 679,
    ["PocketMine plugin.yml"] = 430,
    Poetry = 431,
    ["Postman collection"] = 436,
    ["Problem object RFC9457"] = 776,
    ["Problem package generators"] = 443,
    Pterodactyl = 724,
    ["Pull Request Labeler"] = 458,
    Pulumi = 464,
    PyProject = 465,
    Pyright = 466,
    Qgoda = 467,
    Qodana = 698,
    ["Quali Torque Blueprint Spec 2"] = 722,
    ["QueryFirst config file"] = 745,
    ["RKE Cluster Configuration JSON"] = 676,
    ["RKE Cluster Configuration YAML"] = 675,
    ["Rancher Fleet"] = 461,
    Ray = 643,
    ["Read the Docs"] = 463,
    ["Red-DiscordBot Cog"] = 468,
    ["Red-DiscordBot Cog Repo"] = 469,
    ["Red-DiscordBot Trivia"] = 470,
    RenderCV = 481,
    Renovate = 480,
    ["Replit config"] = 474,
    RoadRunner = 482,
    ...
    ["Rust Project"] = 478,
    ["Rust toolchain"] = 484,
    ["SIL Kit Participant Configuration"] = 516,
    ["SIL Kit Registry Configuration"] = 517,
    SWADL = 542,
    ["Safebox Config"] = 735,
    ["Sapphire CLI Config"] = 487,
    ["SauceCTL Configuration"] = 684,
    ["Schema Catalog"] = 501,
    ["Scoop manifest"] = 506,
    ["Semantic Data Fabric (SDF) file"] = 507,
    ["Semgrep Rule"] = 509,
    ["Serenity Code Generator (Sergen)"] = 510,
    ["Serverless Framework Configuration"] = 692,
    ["Serverless Workflow"] = 694,
    ["Settings.paf"] = 512,
    Setuptools = 513,
    ["Shopware 6 Configuration"] = 695,
    ["Shopware CLI Extension Store Configuration"] = 696,
    ["Shopware CLI Project Store Configuration"] = 697,
    ["Sigrid scope configuration file"] = 515,
    ["Slack app manifest"] = 519,
    Solidarity = 522,
    ["Solution filters"] = 523,
    ["Source Maps v3"] = 524,
    Sourcery = 525,
    SpecIF = 526,
    ["Sponge Mixin configuration"] = 527,
    StackBlitz = 532,
    ["StackHawk Scanner Configuration"] = 691,
    Stale = 533,
    ["Starlake Data Pipeline"] = 666,
    Starship = 534,
    ["Statamic Blueprint"] = 535,
    ["Stella configuration file"] = 536,
    ["StrmPrivacy Data Connector"] = 739,
    ["StrmPrivacy Data Contract"] = 740,
    ["StrmPrivacy SimpleSchema"] = 737,
    ["StrmPrivacy Stream"] = 738,
    ["StrmPrivacy batch job configuration file"] = 736,
    ["Stryker Mutator"] = 539,
    ["StyleCop Analyzers Configuration"] = 540,
    ["Sublime Syntax"] = 741,
    ["Swagger API 2.0"] = 543,
    TSON = 568,
    TSTyche = 569,
    Talhelper = 545,
    ["Talisman configuration"] = 546,
    ["Taskfile config"] = 671,
    Taurus = 547,
    ["TestEnvironment.json"] = 556,
    ["TextMate Grammar"] = 555,
    ["Tier.run pricing.json"] = 550,
    Tikibase = 551,
    ["Traefik v2"] = 559,
    ["Traefik v2 File Provider"] = 560,
    TunnelHub = 775,
    Turborepo = 557,
    Tye = 699,
    ["UET BuildConfig.json"] = 746,
    ["UI5 Manifest"] = 577,
    ["UNCORS configuration"] = 581,
    ["UTAM Page Object"] = 580,
    ["Ubuntu Server Autoinstall"] = 575,
    ["Uniswap Token List"] = 654,
    ["Unreal Engine Uplugin"] = 747,
    ["Unreal Engine Uproject"] = 748,
    ["Updatecli Compose"] = 706,
    ["Updatecli Policy Manifest"] = 707,
    ["Updatecli Policy Metadata"] = 708,
    Uplift = 744,
    ["User Journey Map"] = 674,
    V2Ray = 712,
    ["VSCode Code Snippets"] = 151,
    ["VSIX CLI publishing"] = 594,
    ["Vela Pipeline Configuration"] = 584,
    Vercel = 150,
    Visivo = 773,
    ["Web App Manifest"] = 601,
    ["Web types"] = 604,
    WebExtensions = 600,
    ["Webman package recipe"] = 718,
    ["Windows Package Manager Installer Manifest"] = 651,
    ["Windows Package Manager Locale Manifest"] = 652,
    ["Windows Package Manager Singleton Manifest"] = 650,
    ["Woodpecker pipeline config"] = 686,
    ["Xstate Machine"] = 704,
    ["Yippee-Ki-JSON configuration YML"] = 656,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 15,
    apko = 777,
    ...
    ["bamboo-spec"] = 71,
    ["base-04"] = 2,
    ["bashly-settings.yml"] = 755,
    ["bashly-strings.yml"] = 756,
    ["bashly.yml"] = 754,
    ["batect.yml"] = 70,
    ...
    ["chisel-slices.json"] = 168,
    ["chrome-extension-locales-messages.json"] = 158,
    ["chutzpah.json"] = 159,
    cibuildwheel = 106,
    clangd = 138,
    clib = 139,
    ["cloud-init: cloud-config userdata"] = 141,
    ["cloud-sdk-pipeline-configuration"] = 161,
    ["cloudbuild.json"] = 162,
    cloudify = 140,
    codemagic = 142,
    ["coffeelint.json"] = 170,
    ["commands.json"] = 154,
    ["compile_commands.json"] = 153,
    ["compilerconfig.json"] = 152,
    ["completely.yml"] = 752,
    ["component-detection-manifest.json"] = 173,
    ["component.json"] = 172,
    ["composer.json"] = 171,
    ["config.yaml"] = 462,
    ["contentmanifest.json"] = 160,
    ["contribute.json"] = 174,
    ["cosmos.config.json"] = 156,
    ["crowdin.yml"] = 175,
    cspell = 181,
    ["custom-elements.json"] = 766,
    ["cypress.json"] = 179,
    ["datalogic-scan2deploy-android"] = 188,
    ["datalogic-scan2deploy-ce"] = 189,
    ["dbt Project"] = 113,
    ["ddev-global"] = 190,
    ["ddev-project"] = 191,
    ["debugsettings.json"] = 192,
    ["dependabot-v2.json"] = 195,
    ["dependabot.json"] = 194,
    ["deployed-cli"] = 703,
    ["detekt.yml"] = 197,
    ["devcontainer.json"] = 144,
    devinit = 658,
    ["devspace.yaml"] = 726,
    djlint = 659,
    ["docfx.json"] = 201,
    ["docker sequencer"] = 200,
    ["docker-compose.yml"] = 657,
    ["dockerd.json"] = 199,
    ["dotnet Release Index manifest"] = 210,
    ["dotnetcli.host.json"] = 211,
    ["dprint.json"] = 212,
    ["drone.json"] = 213,
    ["dss-2.0.0.json"] = 215,
    ["dstack configuration"] = 216,
    ["dvc.yaml"] = 217,
    ["ecosystem.json"] = 222,
    eksctl = 223,
    ["electron-builder configuration file"] = 228,
    ["epr-manifest.json"] = 226,
    ["evcc.yaml"] = 229,
    ["ezd task runner"] = 231,
    ["fabric.mod.json"] = 234,
    ["first-timers-bot"] = 240,
    ...
    ["gitlab-ci"] = 265,
    ["global.json"] = 267,
    ["go-feature-flag Flag Configuration"] = 269,
    ["golangci-lint Configuration"] = 268,
    ["haxelib.json"] = 283,
    helmfile = 646,
    helmwave = 647,
    ["host-meta.json"] = 288,
    ...
    ["ide.host.json"] = 293,
    ["ifstate.conf"] = 294,
    ["imageoptimizer.json"] = 295,
    ["importmap.json"] = 298,
    ["ioBroker Configuration"] = 299,
    ["ioBroker JSON UI"] = 300,
    ["ioBroker Package manifest"] = 301,
    ["ize.toml"] = 743,
    ["jsconfig.json"] = 323,
    ["jscpd Configuration"] = 723,
    jsdoc = 642,
    ["k3d.yaml"] = 324,
    ["k9s plugin.yml"] = 326,
    ["kontinuous-config.yaml"] = 332,
    ["kontinuous-values.yaml"] = 331,
    ["kustomization.yaml"] = 333,
    ["label-commenter-config.yml"] = 334,
    ["launchsettings.json"] = 335,
    lazydocker = 765,
    lazygit = 764,
    ["lego.json"] = 337,
    ["lerna.json"] = 338,
    ["lgtm.yml"] = 339,
    ["libman.json"] = 340,
    ["license-report-config.json"] = 341,
    ["linkinator.config.json"] = 343,
    ["local.settings.json"] = 348,
    ["localazy.json"] = 349,
    ["lotus.yaml"] = 347,
    ["lsdlschema.json"] = 350,
    ["madness.yml"] = 753,
    ["markdown-lint-check"] = 682,
    mboats = 689,
    ["micro-settings.json"] = 758,
    ["mimetypes.json"] = 357,
    ["mirrord config"] = 625,
    ["monospace.yml"] = 379,
    ["mta.yaml"] = 626,
    ["mtad.yaml"] = 627,
    ["mycode.json"] = 383,
    ["napari plugin manifest"] = 384,
    neoload = 637,
    ["nest-cli"] = 390,
    ["ninjs (News in JSON) 1.3"] = 389,
    ["ninjs (News in JSON) 2.0"] = 388,
    ["nlu.json"] = 391,
    ["nodemon.json"] = 393,
    ["noodl config"] = 688,
    now = 633,
    ...
    ["nswag.json"] = 399,
    ntangle = 400,
    ["nuclei-template.yaml"] = 397,
    ["nuget-project.json"] = 398,
    ["ocelot.json"] = 402,
    ["omnisharp.json"] = 403,
    ["openapi.json"] = 404,
    ["openfin.json"] = 411,
    ...
    ["ops.yaml"] = 408,
    ["package.json"] = 422,
    ["package.manifest"] = 423,
    ["pathfinder.yml"] = 426,
    ["pattern.json"] = 428,
    ["petstore-v1.0"] = 733,
    pgap_yaml_input_reader = 427,
    ["plagiarize-me.yaml"] = 433,
    ["plagiarize.yaml"] = 432,
    ["portman.json"] = 434,
    ["prettierrc.json"] = 441,
    ["prisma.yml"] = 442,
    ["project-1.0.0-beta3.json"] = 445,
    ["project-1.0.0-beta4.json"] = 446,
    ["project-1.0.0-beta5.json"] = 447,
    ["project-1.0.0-beta6.json"] = 448,
    ["project-1.0.0-beta8.json"] = 449,
    ["project-1.0.0-rc1.json"] = 450,
    ["project-1.0.0-rc2.json"] = 451,
    ["project.json"] = 444,
    ["prometheus.json"] = 452,
    ["prometheus.rules.json"] = 453,
    ["prometheus.rules.test.json"] = 454,
    ["proxies.json"] = 455,
    ["publiccode.yml"] = 456,
    ["pubspec.yaml"] = 457,
    ["pyrseas-0.8.json"] = 460,
    ["quilt.mod.json"] = 759,
    ["release drafter"] = 638,
    ["release-plz.toml"] = 472,
    rtx = 476,
    rustfmt = 483,
    samt = 485,
    samtrc = 486,
    ["sarif-1.0.0.json"] = 488,
    ["sarif-2.0.0.json"] = 489,
    ["sarif-2.1.0"] = 499,
    ["sarif-2.1.0-rtm.2"] = 490,
    ["sarif-2.1.0-rtm.3"] = 492,
    ["sarif-2.1.0-rtm.4"] = 494,
    ["sarif-2.1.0-rtm.5"] = 496,
    ["sarif-2.1.0-rtm.6"] = 497,
    ["sarif-external-property-file-2.1.0"] = 500,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 491,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 493,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 495,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 498,
    ["schema.org - Action"] = 502,
    ["schema.org - ContactPoint"] = 503,
    ["schema.org - Place"] = 504,
    ["schema.org - Thing"] = 505,
    ["scikit-build"] = 690,
    ["secrethub.yml"] = 761,
    ["semantic-release"] = 508,
    ["servicehub.config.json"] = 614,
    ["servicehub.service.json"] = 613,
    ["settings.job"] = 511,
    ["sfdx-hardis configuration"] = 514,
    ["size-limit configuration"] = 518,
    ["skaffold.yaml"] = 680,
    ["skyuxconfig.json"] = 520,
    snapcraft = 521,
    ["sqlc configuration"] = 529,
    ["stripe-app-local.json"] = 538,
    ["stripe-app.json"] = 537,
    swcrc = 667,
    syntax = 763,
    ["task.json"] = 544,
    taskcat = 634,
    ["template.json"] = 548,
    ["templatsources.json"] = 549,
    ["theme.json"] = 552,
    ["tizen_workspace.json"] = 553,
    tldr = 554,
    tmuxinator = 622,
    ["transcend.yml"] = 561,
    ["trunk.yaml"] = 562,
    ["ts-force-config.json"] = 566,
    ["tsconfig.json"] = 563,
    ["tsd.json"] = 564,
    ["tsdrc.json"] = 565,
    ["tslint.json"] = 567,
    ...
    ["typingsrc.json"] = 574,
    ["typo3.json"] = 572,
    ["ui5-workspace.yaml"] = 579,
    ["ui5.yaml"] = 578,
    unist = 700,
    ["up.json"] = 576,
    v8r = 598,
    ["vcpkg configuration file"] = 149,
    ["vcpkg manifest file"] = 148,
    ["vega-lite.json"] = 583,
    ["vega.json"] = 582,
    ["venvironment-basic.yaml"] = 586,
    ["venvironment.yaml"] = 585,
    ["version.json"] = 587,
    ["vim-addon-info"] = 588,
    ["vs-2017.3.host.json"] = 590,
    ["vs-nesting.json"] = 591,
    ["vsls.json"] = 589,
    ["vss-extension.json"] = 595,
    ["vtesttree.yaml"] = 596,
    ["vtestunit.yaml"] = 597,
    ["warp-keysets.json"] = 767,
    ["warp-themes.json"] = 768,
    ["warp-workflows.json"] = 769,
    ["webhint.io"] = 719,
    ["webjobpublishsettings.json"] = 603,
    ["webjobs-list.json"] = 602,
    ["xs-app.json"] = 630,
    ["xunit.runner.json"] = 612,
    yamllint = 655,
    zuul = 639,
    ["Žinoma"] = 649
  },
