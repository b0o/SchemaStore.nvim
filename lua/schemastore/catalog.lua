...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 113,
    [".cryproj (generic)"] = 431,
    [".cryproj engine-5.2"] = 426,
    [".cryproj engine-5.3"] = 427,
    [".cryproj engine-5.4"] = 428,
    [".cryproj engine-5.5"] = 429,
    [".cryproj engine-dev"] = 430,
    [".csscomb.json"] = 115,
    [".csslintrc"] = 116,
    [".eslintrc"] = 155,
    [".esmrc.json"] = 148,
    ...
    [".mtaext"] = 437,
    [".nodehawkrc"] = 268,
    [".npmpackagejsonlintrc"] = 270,
    [".phraseapp.yml"] = 302,
    [".pmbot.yml"] = 294,
    [".postcssrc"] = 299,
    [".pre-commit-config.yml"] = 300,
    [".pre-commit-hooks.yml"] = 301,
    [".putout.json"] = 319,
    [".rehyperc"] = 324,
    [".remarkrc"] = 325,
    [".sprite files"] = 361,
    ...
    [".vsext"] = 407,
    [".yarnrc.yml"] = 469,
    ["<div>RIOTS' studio configuration"] = 410,
    ["API Builder"] = 466,
    ...
    ["Azure Pipelines"] = 40,
    ["Azure Static Web Apps CLI configuration file"] = 363,
    ["Azure Static Web Apps configuration file"] = 362,
    ["BX CI"] = 68,
    ["Better Code Hub"] = 471,
    BizTalkServerApplicationSchema = 443,
    ...
    ["Container Structure Test"] = 454,
    Containerlab = 479,
    ["Dart build configuration"] = 117,
    ["Dart test config"] = 118,
    ["DashLord configuration"] = 119,
    ["Datadog Service Catalog Definition"] = 226,
    ["Datahub Ingestion Recipe Schema"] = 519,
    Deno = 123,
    ["Deployer Recipe"] = 126,
    Devfile = 145,
    ["Discord Webhook"] = 128,
    ["Dolittle Artifacts"] = 131,
    ["Dolittle Bounded Context Configuration"] = 132,
    ["Dolittle Event Horizons Configuration"] = 133,
    ["Dolittle Resources Configuration"] = 134,
    ["Dolittle Server Configuration"] = 135,
    ["Dolittle Tenant Map Configuration"] = 137,
    ["Dolittle Tenants Configuration"] = 136,
    ["Dolittle Topology"] = 138,
    ["Drush site aliases"] = 142,
    ["Error pages"] = 151,
    Esquio = 149,
    ["Estuary Flow Catalog Schema"] = 509,
    ["Expo SDK"] = 154,
    ["F-Droid Data metadata"] = 158,
    ["Facets - FSDL - Application"] = 156,
    ["Fossa configuration file"] = 163,
    ["Fossa's fossa-deps file"] = 164,
    ["Foundry VTT - Manifest"] = 161,
    ["Foundry VTT - Template"] = 162,
    ["Foxx Manifest"] = 41,
    ["GatewayCore API Gateway"] = 167,
    ["GeoJSON.json latest"] = 507,
    GherKing = 511,
    ["GitHub Action"] = 171,
    ["GitHub Funding"] = 172,
    ["GitHub Issue Template configuration"] = 174,
    ["GitHub Workflow"] = 175,
    ["GitHub Workflow Template Properties"] = 176,
    ["GitHub issue forms"] = 173,
    GitVersion = 170,
    ["Gitpod Configuration"] = 178,
    ["Global Privacy Control"] = 168,
    ["Google Cloud Workflows"] = 101,
    Goreleaser = 181,
    ["Goreleaser Pro"] = 182,
    ["Gradle Build Cache Node"] = 468,
    ["Gradle Enterprise"] = 467,
    ["Grafana 5.x Dashboard"] = 183,
    ["GraphQL Code Generator"] = 186,
    ["GraphQL Config"] = 185,
    ["GraphQL Mesh"] = 184,
    ["Grunt JSHint task"] = 190,
    ["Grunt Watch task"] = 191,
    ["Grunt base task"] = 192,
    ["Grunt clean task"] = 188,
    ["Grunt copy task"] = 187,
    ["Grunt cssmin task"] = 189,
    HEMTT = 440,
    Hadolint = 452,
    ["Hammerkit YAML Schema"] = 478,
    ["Hardware Sentry Configuration"] = 523,
    Hayson = 194,
    ["Haystack Pipeline"] = 195,
    ["Hazelcast 5 Configuration"] = 196,
    ["Helm Chart.lock"] = 79,
    ["Helm Chart.yaml"] = 78,
    Hugo = 501,
    ["JFrog File Spec"] = 211,
    ...
    ["JSON Feed"] = 220,
    ["JSON Resume"] = 327,
    ["JSON Schema Draft 2020-12"] = 422,
    ["JSON Schema Draft 4"] = 419,
    ["JSON Schema Draft 7"] = 420,
    ["JSON Schema Draft 8"] = 421,
    ...
    ["JSON-API"] = 218,
    ["JSON-e templates"] = 476,
    ["JSON-stat 2.0"] = 416,
    JSONPatch = 222,
    Jasmine = 207,
    Jekyll = 208,
    ["Jenkins X Pipelines"] = 209,
    ["Jenkins X Requirements"] = 210,
    ["Jovo Language Models"] = 212,
    ["KSP-AVC"] = 417,
    ["KSP-CKAN"] = 418,
    KrakenD = 225,
    ["LinkML Metamodel"] = 236,
    Liquibase = 483,
    Markdownlint = 486,
    ["MegaLinter configuration"] = 240,
    ["MegaLinter descriptor"] = 241,
    ["Meltano plugin discovery definition"] = 243,
    ["Meltano project definition"] = 242,
    ["Microsoft Band Web Tile"] = 244,
    ["Minecraft Data Pack Advancement"] = 246,
    ["Minecraft Data Pack Biome"] = 247,
    ["Minecraft Data Pack Configured Carver"] = 248,
    ["Minecraft Data Pack Dimension"] = 250,
    ["Minecraft Data Pack Dimension Type"] = 249,
    ["Minecraft Data Pack Item Modifier"] = 251,
    ["Minecraft Data Pack Loot Table"] = 252,
    ["Minecraft Data Pack Metadata"] = 253,
    ["Minecraft Data Pack Predicate"] = 254,
    ...
    ["Nightwatch.js"] = 263,
    ["OSS Review Toolkit curation"] = 285,
    ["OSS Review Toolkit package configuration"] = 286,
    ["OSS Review Toolkit repository configuration"] = 287,
    ["OSS Review Toolkit resolutions"] = 288,
    Opctl = 439,
    ["OpenWeather Current Weather API"] = 475,
    ["OpenWeather Road Risk API"] = 474,
    ["Ory Hydra configuration"] = 200,
    ["Ory Keto configuration"] = 227,
    ["Ory Kratos configuration"] = 284,
    ["Ory Oathkeeper configuration"] = 275,
    ["Outblocks App configuration"] = 282,
    ["Outblocks database table"] = 283,
    ["Outblocks project configuration"] = 281,
    Packer = 291,
    ["Pipeline component"] = 484,
    ["PocketMine plugin.yml"] = 295,
    Pterodactyl = 522,
    ["Pull Request Labeler"] = 318,
    Qodana = 498,
    ...
    Ray = 451,
    ["Read the Docs"] = 321,
    ["Red-DiscordBot Cog"] = 322,
    ["Red-DiscordBot Cog Repo"] = 323,
    Renovate = 328,
    RoadRunner = 329,
    SWADL = 373,
    ["Sapphire CLI Config"] = 330,
    ...
    ["Source Maps v3"] = 358,
    SpecIF = 359,
    ["Sponge Mixin configuration"] = 360,
    ["StackHawk Scanner Configuration"] = 493,
    ["StackHead CLI config"] = 364,
    ["StackHead module configuration"] = 365,
    ["StackHead project definition"] = 366,
    Stale = 367,
    Starship = 368,
    ["Statamic Blueprint"] = 369,
    ["Stryker Mutator"] = 370,
    ["StyleCop Analyzers Configuration"] = 371,
    ["Swagger API 2.0"] = 374,
    ["Taskfile YAML Schema"] = 477,
    Taurus = 375,
    ["TestEnvironment.json"] = 381,
    Tikibase = 378,
    ["Traefik v2"] = 383,
    ["Traefik v2 File Provider"] = 384,
    Tye = 499,
    ["UI5 Manifest"] = 396,
    ["Ubuntu Server Autoinstall"] = 394,
    ["Uniswap Token List"] = 460,
    Updatecli = 506,
    ["User Journey Map YAML Schema"] = 480,
    V2Ray = 510,
    ["VSCode Code Snippets"] = 91,
    ["VSIX CLI publishing"] = 408,
    ["Vela Pipeline Configuration"] = 400,
    Vercel = 90,
    ["Web App Manifest"] = 412,
    ["Web types"] = 415,
    WebExtensions = 411,
    ["Webman package recipe"] = 516,
    ["Windows Package Manager Installer Manifest"] = 457,
    ["Windows Package Manager Locale Manifest"] = 458,
    ["Windows Package Manager Singleton Manifest"] = 456,
    ["Woodpecker pipeline config"] = 489,
    ["Xstate Machine Schema"] = 504,
    ["Yippee-Ki-JSON configuration YML"] = 462,
    ["angular.json"] = 8,
    ...
    cspell = 114,
    ["cypress.json"] = 112,
    ["datalogic-scan2deploy-android"] = 120,
    ["datalogic-scan2deploy-ce"] = 121,
    ["debugsettings.json"] = 122,
    ["dependabot-v2.json"] = 125,
    ["dependabot.json"] = 124,
    ["deployed-cli"] = 503,
    ["detekt.yml"] = 127,
    devinit = 464,
    ...
    ["dockerd.json"] = 129,
    ["dotnet Release Index manifest"] = 139,
    ["dotnetcli.host.json"] = 140,
    ["drone.json"] = 141,
    ["dss-2.0.0.json"] = 143,
    ["dvc.yaml"] = 144,
    ["ecosystem.json"] = 146,
    eksctl = 147,
    ["electron-builder configuration file."] = 152,
    ["epr-manifest.json"] = 150,
    ["evcc.yaml"] = 153,
    ["fabric.mod.json"] = 157,
    ["first-timers-bot"] = 160,
    fulibWorkflows = 488,
    ["func.yaml"] = 165,
    ["function.json"] = 166,
    ["geojson.json"] = 169,
    ["gitlab-ci"] = 177,
    ["global.json"] = 179,
    ["golangci-lint Configuration"] = 180,
    ["haxelib.json"] = 193,
    helmfile = 453,
    ["host-meta.json"] = 198,
    ["host.json"] = 197,
    ...
    huskyrc = 433,
    ["ide.host.json"] = 201,
    ["imageoptimizer.json"] = 202,
    ["importmap.json"] = 204,
    ["ioBroker JSON UI"] = 205,
    ["ioBroker Package manifest"] = 206,
    ["jsconfig.json"] = 223,
    ["jscpd Configuration Schema"] = 521,
    jsdoc = 450,
    ["k3d.yaml"] = 224,
    ["kustomization.yaml"] = 228,
    ["label-commenter-config.yml"] = 229,
    ["launchsettings.json"] = 230,
    ["lerna.json"] = 231,
    ["lgtm.yml"] = 232,
    ["libman.json"] = 233,
    ["license-report-config.json"] = 234,
    ["linkinator.config.json"] = 235,
    ["local.settings.json"] = 237,
    ["localazy.json"] = 238,
    ["lsdlschema.json"] = 239,
    mboats = 492,
    ["mimetypes.json"] = 245,
    ...
    ["mtad.yaml"] = 436,
    ["mycode.json"] = 260,
    ["napari plugin manifest"] = 261,
    neoload = 445,
    ["nest-cli"] = 266,
    ["ninjs (News in JSON) 1.3"] = 265,
    ["ninjs (News in JSON) 2.0"] = 264,
    ["nlu.json"] = 267,
    ["nodemon.json"] = 269,
    ...
    ["nswag.json"] = 273,
    ntangle = 274,
    ["nuclei-template.yaml"] = 271,
    ["nuget-project.json"] = 272,
    ["ocelot.json"] = 276,
    ["omnisharp.json"] = 277,
    ["openapi.json"] = 278,
    ["openfin.json"] = 280,
    ["openrpc.json"] = 279,
    ["package.json"] = 289,
    ["package.manifest"] = 290,
    ["pattern.json"] = 293,
    pgap_yaml_input_reader = 292,
    ["plagiarize-me.yaml"] = 297,
    ["plagiarize.yaml"] = 296,
    ["portman.json"] = 298,
    ["prettierrc.json"] = 303,
    ["prisma.yml"] = 304,
    ["project-1.0.0-beta3.json"] = 306,
    ["project-1.0.0-beta4.json"] = 307,
    ["project-1.0.0-beta5.json"] = 308,
    ["project-1.0.0-beta6.json"] = 309,
    ["project-1.0.0-beta8.json"] = 310,
    ["project-1.0.0-rc1.json"] = 311,
    ["project-1.0.0-rc2.json"] = 312,
    ["project.json"] = 305,
    ["prometheus.json"] = 313,
    ["prometheus.rules.json"] = 314,
    ["proxies.json"] = 315,
    ["publiccode.yml"] = 316,
    ["pubspec.yaml"] = 317,
    ["pyrseas-0.8.json"] = 320,
    ["release drafter"] = 446,
    ["sarif-1.0.0.json"] = 331,
    ["sarif-2.0.0.json"] = 332,
    ["sarif-2.1.0"] = 341,
    ["sarif-2.1.0-rtm.2"] = 333,
    ["sarif-2.1.0-rtm.3"] = 335,
    ["sarif-2.1.0-rtm.4"] = 337,
    ["sarif-2.1.0-rtm.5"] = 339,
    ["sarif-external-property-file-2.1.0"] = 342,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 334,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 336,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 338,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 340,
    ["schema.org - Action"] = 344,
    ["schema.org - ContactPoint"] = 345,
    ["schema.org - Place"] = 346,
    ["schema.org - Thing"] = 347,
    ["semantic-release"] = 349,
    ["servicehub.config.json"] = 425,
    ["servicehub.service.json"] = 424,
    ["settings.job"] = 351,
    ["sfdx-hardis configuration"] = 353,
    ["size-limit configuration"] = 354,
    ["skaffold.yaml"] = 485,
    ["skyuxconfig.json"] = 355,
    snapcraft = 356,
    swcrc = 473,
    taskcat = 442,
    ["template.json"] = 376,
    ["templatsources.json"] = 377,
    ["theme.json"] = 379,
    tmLanguage = 380,
    ["trunk.yaml schema"] = 385,
    ["ts-force-config.json"] = 389,
    ["tsconfig.json"] = 386,
    ["tsd.json"] = 387,
    ["tsdrc.json"] = 388,
    ["tslint.json"] = 390,
    ...
    ["version.json"] = 401,
    ["vim-addon-info"] = 402,
    ["vs-2017.3.host.json"] = 404,
    ["vs-nesting.json"] = 405,
    ["vsls.json"] = 403,
    ["vss-extension.json"] = 409,
    ["webhint.io"] = 517,
    ["webjobpublishsettings.json"] = 414,
    ["webjobs-list.json"] = 413,
    ["xs-app.json"] = 438,
    ["xunit.runner.json"] = 423,
    yamllint = 461,
    zuul = 447,
    ["Žinoma"] = 455
  },
