...
M.json = {
  ...
  index = {
    ...
    ABCSupplyPlan = 14,
    AIConfig = 15,
    ["AMX Muse Program Descriptor"] = 984,
    ["API Builder"] = 804,
    ["AVA Configuration"] = 864,
    ...
    ["Adobe UXP Manifest"] = 924,
    ["Aerleon Network & Service Definitions"] = 9,
    ["Aerleon Policy"] = 10,
    ["Airlock Microgateway"] = 16,
    ["Alacritty Configuration"] = 836,
    ["All Contributors configuration file"] = 889,
    ...
    ["Application list for a WinUtil"] = 967,
    ArchitectFX = 971,
    ["Argo Events"] = 29,
    ["Argo Workflows"] = 30,
    AssemblyScript = 33,
    ...
    ["Azure Pipelines"] = 66,
    ["Azure Static Web Apps CLI configuration file"] = 664,
    ["Azure Static Web Apps configuration file"] = 663,
    ["BOSH Deploy Config"] = 90,
    ["BX CI"] = 108,
    ["Bashly (bashly.yml)"] = 893,
    ["Bashly Settings (bashly-settings.yml)"] = 894,
    ["Better Code Hub"] = 808,
    ["Better Scripts"] = 109,
    Bigconfig = 83,
    ["Biome Formatter Config"] = 53,
    ["Bitmovin Encoding Template"] = 977,
    BizTalkServerApplicationSchema = 777,
    Bleep = 110,
    ...
    ["Butane Config"] = 849,
    ["CGS Card Game Specification (cgs.json)"] = 929,
    ["CICS TS region tagging"] = 858,
    ["CICS TS resource import"] = 859,
    ["CICS TS resource model"] = 860,
    ["CICS TS resource overrides"] = 861,
    ["CMake Presets"] = 111,
    ["CNC Codes"] = 126,
    ["CRS WAF test file"] = 957,
    ["CRS WAF test platform overrides file"] = 958,
    ...
    ["Chamaleon environment"] = 981,
    ["Chamaleon properties"] = 982,
    ["Chamaleon template"] = 980,
    Changesets = 208,
    Cheatsheets = 846,
    ...
    CityJSON = 122,
    ["Clawject config"] = 131,
    ["Cloud Foundry Application Manifest"] = 940,
    ["Cloud Run Spec v1"] = 962,
    ...
    Concord = 956,
    ["Configu .cfgu files"] = 945,
    ["Configu .configu file"] = 946,
    Conjure = 125,
    ["Container Structure Test"] = 791,
    Containerlab = 816,
    ["Crowdsec collection config"] = 217,
    ["Crowdsec parser config"] = 218,
    ["Crowdsec scenario config"] = 219,
    ["CumulusCI Config"] = 130,
    ["Custom Machinery Machine"] = 930,
    ["Custom Machinery Recipe"] = 931,
    ...
    ["DonateCaseBetterCasino menu"] = 985,
    ...
    ["Dynamic Bash Aliases (.aliases)"] = 901,
    ["EAS config"] = 283,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 890,
    ["EasyVCR .NET"] = 284,
    ["Eidolon Resource"] = 972,
    ...
    ["Goreleaser Pro"] = 342,
    Goss = 343,
    ["Gradle Build Cache Node"] = 806,
    ["Gradle Enterprise"] = 805,
    ...
    Hadolint = 787,
    Hammerkit = 815,
    ["Hardware Sentry Configuration"] = 869,
    Hatch = 788,
    Hayson = 356,
    ...
    ["JFrog File Spec"] = 385,
    ["JFrog Pipelines YML DSL"] = 878,
    ["JMeter DSL cli config"] = 386,
    JReleaser = 388,
    ["JSON Document Transform"] = 396,
    ["JSON Feed"] = 397,
    ["JSON Resume"] = 603,
    ["JSON Schema Draft 2020-12"] = 757,
    ["JSON Schema Draft 4"] = 754,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 911,
    ["JSON Schema Draft 7"] = 755,
    ["JSON Schema Draft 7 (unofficial strict)"] = 912,
    ["JSON Schema Draft 8 (2019-09)"] = 756,
    ["JSON-API"] = 395,
    ["JSON-e templates"] = 813,
    ["JSON-stat 2.0"] = 750,
    JSONPatch = 399,
    ...
    ["Metadata for a Cinnamon spice"] = 965,
    ["Metatype Configuration"] = 447,
    ["MetricsHub Configuration"] = 448,
    ["MetricsHub Connector Configuration"] = 449,
    ["Micro Editor Syntax"] = 902,
    ["Microsoft Band Web Tile"] = 450,
    ["Microsoft RulesEngine workflow rules"] = 953,
    ["Microsoft RulesEngine workflow rules list"] = 954,
    ["Minecraft Custom Main Menu Mod"] = 919,
    ...
    ["MongoDB Atlas Search Index Definition"] = 873,
    ["Monika Configuration"] = 871,
    ["Monoweave Configuration"] = 475,
    ["Motif config"] = 770,
    ["NOX Framework (Service)"] = 492,
    ["Netin Diagnostic System Template"] = 831,
    ["Netlify config"] = 483,
    ...
    ["OpenUtau ustx"] = 510,
    ["OpenWeather Current Weather API"] = 812,
    ["OpenWeather Road Risk API"] = 811,
    ...
    ["Pipeline component"] = 823,
    ["Plex Prerolls"] = 546,
    ["PocketMine plugin.yml"] = 543,
    ["Postman collection"] = 550,
    ["Preset list for a WinUtil"] = 968,
    ["Problem object RFC9457"] = 916,
    ...
    Qgoda = 585,
    Qodana = 841,
    ["Qt Creator workspace file"] = 947,
    ["Quali Torque Blueprint Spec 2"] = 866,
    ["QueryFirst config file"] = 884,
    ["RKE Cluster Configuration JSON"] = 820,
    ["RKE Cluster Configuration YAML"] = 819,
    RadioHound = 577,
    ["Rancher Fleet"] = 579,
    ["Rattler-build"] = 586,
    Ray = 786,
    ...
    ["Render Blueprints"] = 818,
    RenderCV = 605,
    Renovate = 604,
    ["Replit config"] = 599,
    RoadRunner = 607,
    ["Rudder techniques"] = 922,
    Ruff = 601,
    ["Rust Project"] = 602,
    ["Rust toolchain"] = 611,
    ...
    ["SauceCTL Configuration"] = 828,
    ["Schema Catalog"] = 628,
    ["Scoop manifest"] = 633,
    ["Semantic Data Fabric (SDF) file"] = 637,
    ["Semgrep Rule"] = 639,
    ["Serenity Code Generator (Sergen)"] = 640,
    ["Serverless Framework Configuration"] = 835,
    ["Serverless Workflow"] = 837,
    ["Settings for a Cinnamon spice"] = 964,
    ["Settings.paf"] = 642,
    ["Shopware 6 Configuration"] = 838,
    ["Shopware CLI Extension Store Configuration"] = 839,
    ["Shopware CLI Project Store Configuration"] = 840,
    ["Sigma Detection Rule"] = 644,
    ["Sigrid scope configuration file"] = 645,
    ["SkyPilot Task JSON"] = 923,
    ...
    SpecIF = 659,
    ["Sponge Mixin configuration"] = 660,
    StackBlitz = 665,
    ["StackHawk Scanner Configuration"] = 834,
    Stale = 666,
    ["Starlake Data Pipeline"] = 809,
    Starship = 667,
    ["Statamic Blueprint"] = 668,
    ["Stella configuration file"] = 669,
    ["Stryker Mutator"] = 672,
    ["StyleCop Analyzers Configuration"] = 673,
    ["Stylelint (.stylelintrc)"] = 674,
    ["Sublime Syntax"] = 880,
    ["Subsquid squid manifest"] = 925,
    ["Swagger API 2.0"] = 676,
    ["Synadia Connect Component"] = 677,
    TSON = 708,
    TSTyche = 709,
    ["Tab data for a LinUtil"] = 970,
    ["Tab list for a LinUtil"] = 969,
    Talhelper = 679,
    ["Talisman configuration"] = 680,
    ["Taskfile config"] = 814,
    Taurus = 681,
    Tauticord = 682,
    ["TestEnvironment.json"] = 691,
    ["TextMate Grammar"] = 690,
    ["Tier.run pricing.json"] = 685,
    Tikibase = 686,
    ["Traefik v2"] = 694,
    ["Traefik v2 File Provider"] = 695,
    ["Traefik v3"] = 696,
    ...
    Tycho = 960,
    Tye = 842,
    ["UET BuildConfig.json"] = 885,
    ["UI5 Manifest"] = 718,
    ["UNCORS configuration"] = 722,
    ["UTAM Page Object"] = 721,
    ["Ubuntu Server Autoinstall"] = 716,
    ["Uniswap Token List"] = 797,
    ["Unreal Engine Uplugin"] = 886,
    ["Unreal Engine Uproject"] = 887,
    ["Updatecli Compose"] = 850,
    ["Updatecli Policy Manifest"] = 851,
    ["Updatecli Policy Metadata"] = 852,
    Uplift = 883,
    ["User Journey Map"] = 817,
    V2Ray = 856,
    ["VSCode Code Snippets"] = 183,
    ["VSIX CLI publishing"] = 739,
    ["Vela Pipeline Configuration"] = 726,
    Vercel = 182,
    ["Version Bumper config"] = 729,
    Visivo = 913,
    ["Waku Config"] = 973,
    ["Web App Manifest"] = 745,
    ["Web types"] = 748,
    WebExtensions = 744,
    ["Webman package recipe"] = 862,
    ["Windows Package Manager Installer Manifest"] = 794,
    ["Windows Package Manager Locale Manifest"] = 795,
    ["Windows Package Manager Singleton Manifest"] = 793,
    ["WireMock stub mapping"] = 976,
    ["Woodpecker pipeline config"] = 830,
    ["Wrangler CLI"] = 749,
    ["Xstate Machine"] = 848,
    ["Yandex Workflow Language"] = 966,
    ["Yarn Config (.yarnrc.yml)"] = 807,
    ["Yippee-Ki-JSON configuration YML"] = 799,
    ["YouTrack App"] = 963,
    ["aerleon.yml"] = 8,
    ["angular.json"] = 17,
    apko = 917,
    ...
    ["behat.yml"] = 92,
    ["bigquery-table"] = 82,
    ["bioimageio resource description"] = 933,
    ...
    ["crowdin.yml"] = 216,
    ["ctfd-setup configuration file"] = 983,
    ["custom-elements.json"] = 905,
    ["cypress.json"] = 220,
    ...
    ["gematik health care insurance list"] = 989,
    ["gematik health care patient list"] = 986,
    ["gematik health care provider institution list"] = 988,
    ["gematik health care provider list"] = 987,
    ["gematik tiger test environment configuration"] = 990,
    ["gitlab-ci"] = 322,
    ["global.json"] = 337,
    ...
    ["lint-staged (.lintstagedrc)"] = 765,
    ["local.settings.json"] = 437,
    ["localazy.json"] = 438,
    ["lotus.yaml"] = 436,
    ["lsdlschema.json"] = 439,
    ["markdown-link-check"] = 826,
    mboats = 833,
    ["micro-settings.json"] = 897,
    ["mimetypes.json"] = 451,
    ["mirrord config"] = 766,
    mise = 767,
    ["mkdocs.yml"] = 471,
    ...
    ["plagiarize.yaml"] = 544,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 979,
    ["podbard.yaml"] = 547,
    ["portman.json"] = 548,
    ["prefect.toml"] = 556,
    ["prettierrc.json"] = 557,
    ...
    ["servicehub.config.json"] = 760,
    ["servicehub.service.json"] = 759,
    ["settings.job"] = 641,
    ...
    snapcraft = 651,
    ["spicepod.yaml"] = 955,
    ["sqlc configuration"] = 662,
    ["stripe-app-local.json"] = 671,
    ["stripe-app.json"] = 670,
    swcrc = 810,
    ["task.json"] = 678,
    taskcat = 776,
    ["template.json"] = 683,
    ["templatsources.json"] = 684,
    ["theme.json"] = 687,
    ["tizen_workspace.json"] = 688,
    tldr = 689,
    tmuxinator = 763,
    ["transcend.yml"] = 698,
    ...
    ["vega-lite.json"] = 725,
    ["vega.json"] = 724,
    ["venvironment-basic.yaml"] = 728,
    ["venvironment.yaml"] = 727,
    ["version.json"] = 730,
    ["vhwdebugger-binding.yaml"] = 732,
    ["vim-addon-info"] = 733,
    ["vs-2017.3.host.json"] = 735,
    ["vs-nesting.json"] = 736,
    ["vsls.json"] = 734,
    ["vss-extension.json"] = 740,
    ["vtesttree.yaml"] = 741,
    ["vtestunit.yaml"] = 742,
    ["warp-keysets.json"] = 906,
    ["warp-themes.json"] = 907,
    ["warp-workflows.json"] = 908,
    ["webhint.io"] = 863,
    ["webjobpublishsettings.json"] = 747,
    ["webjobs-list.json"] = 746,
    ["well-known-fursona"] = 943,
    ["xs-app.json"] = 772,
    ["xunit.runner.json"] = 758,
    yamllint = 798,
    ["zerops.io import file"] = 952,
    ["zerops.yml"] = 951,
    zuul = 782,
    ["Žinoma"] = 792
  },
