...
M.json = {
  ...
  index = {
    ...
    [".creatomic"] = 153,
    [".cryproj (generic)"] = 513,
    [".cryproj engine-5.2"] = 508,
    [".cryproj engine-5.3"] = 509,
    [".cryproj engine-5.4"] = 510,
    [".cryproj engine-5.5"] = 511,
    [".cryproj engine-dev"] = 512,
    [".csscomb.json"] = 155,
    [".csslintrc"] = 156,
    [".eslintrc"] = 201,
    [".esmrc.json"] = 193,
    ...
    [".mtaext"] = 522,
    [".nodehawkrc"] = 324,
    [".npmpackagejsonlintrc"] = 327,
    [".phraseapp.yml"] = 362,
    [".pmbot.yml"] = 354,
    [".postcssrc"] = 359,
    [".pre-commit-config.yml"] = 360,
    [".pre-commit-hooks.yml"] = 361,
    [".putout.json"] = 379,
    [".rehyperc"] = 387,
    [".remarkrc"] = 388,
    [".sprite files"] = 433,
    ...
    [".vsext"] = 488,
    [".yarnrc.yml"] = 554,
    ["<div>RIOTS' studio configuration"] = 492,
    ["@factorial/drupal-breakpoints-css"] = 5,
    ["A micro editor config schema"] = 292,
    ["API Builder"] = 551,
    ["AVA Configuration Schema"] = 607,
    ["AWS CDK cdk.json"] = 141,
    ["AWS CloudFormation"] = 142,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 143,
    ["Airlock Microgateway"] = 9,
    ["Airplane task"] = 10,
    ["Alacritty Configuration Schema"] = 582,
    ["All Contributors configuration file"] = 634,
    ...
    ["Azure Pipelines"] = 48,
    ["Azure Static Web Apps CLI configuration file"] = 435,
    ["Azure Static Web Apps configuration file"] = 434,
    ["BX CI"] = 83,
    ["Better Code Hub"] = 556,
    ["Better Scripts"] = 84,
    BizTalkServerApplicationSchema = 528,
    ...
    ["Butane Config"] = 594,
    ["CICS TS region tagging"] = 601,
    ["CICS TS resource import"] = 602,
    ["CICS TS resource model"] = 603,
    ["CICS TS resource overrides"] = 604,
    ["CMake Presets"] = 85,
    ...
    ["Datadog Service Definition"] = 275,
    ["Datahub Ingestion Recipe Schema"] = 608,
    ...
    ["Embrace Config Schema"] = 619,
    ["Error pages"] = 196,
    Esquio = 194,
    ["Estuary Flow Catalog Schema"] = 598,
    ["Expo SDK"] = 199,
    ...
    Goreleaser = 227,
    ["Goreleaser Pro"] = 228,
    ["Gradle Build Cache Node"] = 553,
    ["Gradle Enterprise"] = 552,
    ...
    Hadolint = 537,
    Hammerkit = 563,
    ["Hardware Sentry Configuration"] = 612,
    Hayson = 240,
    ...
    ["JFrog File Spec"] = 260,
    ["JFrog Pipelines YML DSL"] = 621,
    ["JSON Document Transform"] = 268,
    ["JSON Feed"] = 269,
    ["JSON Resume"] = 393,
    ["JSON Schema Draft 2020-12"] = 504,
    ["JSON Schema Draft 4"] = 501,
    ["JSON Schema Draft 7"] = 502,
    ["JSON Schema Draft 8"] = 503,
    ...
    ["Jovo Language Models"] = 261,
    ["KSP-AVC"] = 499,
    ["KSP-CKAN"] = 500,
    ["Keycloak REST API"] = 627,
    ["Knative Functions - func.yaml"] = 211,
    ["KoDE/CI build.yaml"] = 617,
    ["Kong DBLess Schema"] = 618,
    KrakenD = 274,
    ["LinkML Metamodel"] = 287,
    Liquibase = 568,
    ["Liquibase Flow File"] = 569,
    ["Lively Properties"] = 288,
    Markdownlint = 572,
    ["MegaLinter configuration"] = 293,
    ["MegaLinter descriptor"] = 294,
    ["Meltano plugin discovery definition"] = 296,
    ["Meltano project definition"] = 295,
    ["Microsoft Band Web Tile"] = 297,
    ["Minecraft Data Pack Advancement"] = 299,
    ["Minecraft Data Pack Biome"] = 300,
    ["Minecraft Data Pack Configured Carver"] = 301,
    ["Minecraft Data Pack Damage Type"] = 302,
    ["Minecraft Data Pack Dimension"] = 304,
    ["Minecraft Data Pack Dimension Type"] = 303,
    ["Minecraft Data Pack Item Modifier"] = 305,
    ["Minecraft Data Pack Loot Table"] = 306,
    ["Minecraft Data Pack Metadata"] = 307,
    ["Minecraft Data Pack Predicate"] = 308,
    ["Minecraft Data Pack Recipe"] = 309,
    ["Minecraft Data Pack Tag"] = 310,
    ["Minecraft Data Pack Template Pool"] = 311,
    ["Minecraft Resourcepack Sounds"] = 312,
    ["MkDocs Configuration 1.0"] = 313,
    ["MongoDB Atlas Search Index Definition Schema"] = 616,
    ["Monika Configuration Schema"] = 614,
    ["Motif config"] = 521,
    ["NOX Framework (Service)"] = 326,
    ["Netin Diagnostic System Template"] = 577,
    ["Netlify config schema"] = 318,
    ["Nightwatch.js"] = 319,
    ["OSS Review Toolkit configuration"] = 344,
    ["OSS Review Toolkit curation"] = 345,
    ["OSS Review Toolkit package configuration"] = 346,
    ["OSS Review Toolkit repository configuration"] = 347,
    ["OSS Review Toolkit resolutions"] = 348,
    Opctl = 524,
    ["OpenRewrite Resource"] = 339,
    ["OpenWeather Current Weather API"] = 560,
    ["OpenWeather Road Risk API"] = 559,
    ["Ory Hydra configuration"] = 246,
    ["Ory Keto configuration"] = 276,
    ["Ory Kratos configuration"] = 343,
    ["Ory Oathkeeper configuration"] = 333,
    ["Outblocks App configuration"] = 341,
    ["Outblocks database table"] = 342,
    ["Outblocks project configuration"] = 340,
    Packer = 351,
    Pantsbuild = 633,
    ["Pipeline component"] = 570,
    ["PocketMine plugin.yml"] = 355,
    Pterodactyl = 611,
    ["Pull Request Labeler"] = 378,
    Pulumi = 383,
    PyProject = 384,
    Qodana = 587,
    ["Quali Torque Blueprint Spec 2"] = 609,
    ["QueryFirst config file"] = 630,
    ["RKE Cluster Configuration JSON Schema"] = 567,
    ["RKE Cluster Configuration YAML Schema"] = 566,
    ["Rancher Fleet"] = 381,
    Ray = 536,
    ["Read the Docs"] = 382,
    ["Red-DiscordBot Cog"] = 385,
    ["Red-DiscordBot Cog Repo"] = 386,
    Renovate = 394,
    ["Replit schema"] = 389,
    RoadRunner = 395,
    Ruff = 391,
    ["Rust Project"] = 392,
    ["Rust toolchain"] = 397,
    ["SIL Kit Participant Configuration"] = 423,
    SWADL = 444,
    ["Sapphire CLI Config"] = 398,
    ["SauceCTL Configuration"] = 574,
    ["Schema Catalog"] = 411,
    ["Scoop manifest"] = 416,
    ["Semgrep Rule"] = 418,
    ["Serenity Code Generator (Sergen)"] = 419,
    ["Serverless Framework Configuration"] = 581,
    ["Serverless Workflow Schema"] = 583,
    ["Settings.paf"] = 421,
    ["Shopware 6 Configuration"] = 584,
    ["Shopware CLI Extension Store Configuration"] = 585,
    ["Shopware CLI Project Store Configuration"] = 586,
    Solidarity = 427,
    ["Solution filters"] = 428,
    ["Source Maps v3"] = 429,
    Sourcery = 430,
    SpecIF = 431,
    ["Sponge Mixin configuration"] = 432,
    ["StackHawk Scanner Configuration"] = 580,
    Stale = 436,
    Starship = 437,
    ["Statamic Blueprint"] = 438,
    ["StrmPrivacy Data Connector"] = 625,
    ["StrmPrivacy Data Contract"] = 626,
    ["StrmPrivacy SimpleSchema"] = 623,
    ["StrmPrivacy Stream"] = 624,
    ["StrmPrivacy batch job configuration file"] = 622,
    ["Stryker Mutator"] = 441,
    ["StyleCop Analyzers Configuration"] = 442,
    ["Swagger API 2.0"] = 445,
    TSON = 466,
    ["Talisman configuration"] = 446,
    ["Taskfile YAML Schema"] = 562,
    Taurus = 447,
    ["TestEnvironment.json"] = 455,
    ["Tier.run pricing.json"] = 450,
    Tikibase = 451,
    ["Traefik v2"] = 458,
    ["Traefik v2 File Provider"] = 459,
    Turborepo = 456,
    Tye = 588,
    ["UI5 Manifest"] = 473,
    ["UTAM Page Object"] = 476,
    ["Ubuntu Server Autoinstall"] = 471,
    ["Uniswap Token List"] = 545,
    ["Unreal Engine Uplugin"] = 631,
    ["Unreal Engine Uproject"] = 632,
    Updatecli = 595,
    Uplift = 629,
    ["User Journey Map YAML Schema"] = 565,
    V2Ray = 599,
    ["VSCode Code Snippets"] = 129,
    ["VSIX CLI publishing"] = 489,
    ["Vela Pipeline Configuration"] = 479,
    Vercel = 128,
    ["Web App Manifest"] = 494,
    ["Web types"] = 497,
    WebExtensions = 493,
    ["Webman package recipe"] = 605,
    ["Windows Package Manager Installer Manifest"] = 542,
    ["Windows Package Manager Locale Manifest"] = 543,
    ["Windows Package Manager Singleton Manifest"] = 541,
    ["Woodpecker pipeline config"] = 576,
    ["Xstate Machine Schema"] = 593,
    ["Yippee-Ki-JSON configuration YML"] = 547,
    ["angular.json"] = 11,
    ...
    ["ize.toml"] = 628,
    ["jsconfig.json"] = 272,
    ["jscpd Configuration Schema"] = 610,
    jsdoc = 535,
    ["k3d.yaml"] = 273,
    ["kontinuous-values.yaml"] = 277,
    ["kustomization.yaml"] = 278,
    ["label-commenter-config.yml"] = 279,
    ["launchsettings.json"] = 280,
    ["lego.json"] = 281,
    ["lerna.json"] = 282,
    ["lgtm.yml"] = 283,
    ["libman.json"] = 284,
    ["license-report-config.json"] = 285,
    ["linkinator.config.json"] = 286,
    ["local.settings.json"] = 289,
    ["localazy.json"] = 290,
    ["lsdlschema.json"] = 291,
    ["markdown-lint-check"] = 573,
    mboats = 579,
    ["mimetypes.json"] = 298,
    ["mirrord-schema"] = 518,
    ["mta.yaml"] = 519,
    ["mtad.yaml"] = 520,
    ["mycode.json"] = 316,
    ["napari plugin manifest"] = 317,
    neoload = 530,
    ["nest-cli"] = 322,
    ["ninjs (News in JSON) 1.3"] = 321,
    ["ninjs (News in JSON) 2.0"] = 320,
    ["nlu.json"] = 323,
    ["nodemon.json"] = 325,
    ["noodl.schema.json"] = 578,
    now = 526,
    ["npm-badges"] = 328,
    ["nswag.json"] = 331,
    ntangle = 332,
    ["nuclei-template.yaml"] = 329,
    ["nuget-project.json"] = 330,
    ["ocelot.json"] = 334,
    ["omnisharp.json"] = 335,
    ["openapi.json"] = 336,
    ["openfin.json"] = 338,
    ["openrpc.json"] = 337,
    ["package.json"] = 349,
    ["package.manifest"] = 350,
    ["pattern.json"] = 353,
    ["petstore-v1.0"] = 620,
    pgap_yaml_input_reader = 352,
    ["plagiarize-me.yaml"] = 357,
    ["plagiarize.yaml"] = 356,
    ["portman.json"] = 358,
    ["prettierrc.json"] = 363,
    ["prisma.yml"] = 364,
    ["project-1.0.0-beta3.json"] = 366,
    ["project-1.0.0-beta4.json"] = 367,
    ["project-1.0.0-beta5.json"] = 368,
    ["project-1.0.0-beta6.json"] = 369,
    ["project-1.0.0-beta8.json"] = 370,
    ["project-1.0.0-rc1.json"] = 371,
    ["project-1.0.0-rc2.json"] = 372,
    ["project.json"] = 365,
    ["prometheus.json"] = 373,
    ["prometheus.rules.json"] = 374,
    ["proxies.json"] = 375,
    ["publiccode.yml"] = 376,
    ["pubspec.yaml"] = 377,
    ["pyrseas-0.8.json"] = 380,
    ["release drafter"] = 531,
    rustfmt = 396,
    ["sarif-1.0.0.json"] = 399,
    ["sarif-2.0.0.json"] = 400,
    ["sarif-2.1.0"] = 409,
    ["sarif-2.1.0-rtm.2"] = 401,
    ["sarif-2.1.0-rtm.3"] = 403,
    ["sarif-2.1.0-rtm.4"] = 405,
    ["sarif-2.1.0-rtm.5"] = 407,
    ["sarif-external-property-file-2.1.0"] = 410,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 402,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 404,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 406,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 408,
    ["schema.org - Action"] = 412,
    ["schema.org - ContactPoint"] = 413,
    ["schema.org - Place"] = 414,
    ["schema.org - Thing"] = 415,
    ["semantic-release"] = 417,
    ["servicehub.config.json"] = 507,
    ["servicehub.service.json"] = 506,
    ["settings.job"] = 420,
    ["sfdx-hardis configuration"] = 422,
    ["size-limit configuration"] = 424,
    ["skaffold.yaml"] = 571,
    ["skyuxconfig.json"] = 425,
    snapcraft = 426,
    ["stripe-app-local.json"] = 440,
    ["stripe-app.json"] = 439,
    swcrc = 558,
    taskcat = 527,
    ["template.json"] = 448,
    ["templatsources.json"] = 449,
    ["theme.json"] = 452,
    ["tizen_workspace.json"] = 453,
    tmLanguage = 454,
    tmuxinator = 515,
    ["trunk.yaml schema"] = 460,
    ["ts-force-config.json"] = 464,
    ["tsconfig.json"] = 461,
    ["tsd.json"] = 462,
    ["tsdrc.json"] = 463,
    ["tslint.json"] = 465,
    ...
    ["vega-lite.json"] = 478,
    ["vega.json"] = 477,
    ["venvironment-basic.yaml"] = 481,
    ["venvironment.yaml"] = 480,
    ["version.json"] = 482,
    ["vim-addon-info"] = 483,
    ["vs-2017.3.host.json"] = 485,
    ["vs-nesting.json"] = 486,
    ["vsls.json"] = 484,
    ["vss-extension.json"] = 490,
    ["webhint.io"] = 606,
    ["webjobpublishsettings.json"] = 496,
    ["webjobs-list.json"] = 495,
    ["xs-app.json"] = 523,
    ["xunit.runner.json"] = 505,
    yamllint = 546,
    zuul = 532,
    ["Žinoma"] = 540
  },
